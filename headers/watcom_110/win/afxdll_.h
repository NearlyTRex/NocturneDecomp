...
extern AFX_APPDATA_MODULE* AFXDLL_EXPORT AFXAPI AfxGetBaseModuleContext();
extern AFX_APPDATA_MODULE* AFXDLL_EXPORT AFXAPI AfxGetCurrentModuleContext();

extern AFX_APPDATA* AFXDLL_EXPORT _AfxGetAppData();
...
extern AFX_APPDATA_MODULE* AFXDLL_EXPORT AFXAPI AfxPushModuleContext(AFX_APPDATA_MODULE* psIn);
extern void AFXAPI AFXDLL_EXPORT AfxPopModuleContext(AFX_APPDATA_MODULE* psIn,
	BOOL bCopy = FALSE);
...
class AFX_CLASS_EXPORT AFX_MAINTAIN_STATE
{
private:
...
extern "C" int AFXDLL_EXPORT PASCAL AfxWinMain(HINSTANCE, HINSTANCE, LPSTR, int);
