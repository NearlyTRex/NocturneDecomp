...
class AFX_CLASS_EXPORT COleDataObject
{
// Constructors
public:
	COleDataObject();
...
#ifdef __WATCOMC__
    typedef COleClientItem::XOleClientSite COleClientItem__XOleClientSite;
    typedef COleServerItem::XOleObject COleServerItem__XOleObject;
#endif
...
protected:
	...
	friend class COleClientItem;
#ifdef __WATCOMC__
	friend class COleClientItem__XOleClientSite;
	friend class COleServerItem__XOleObject;
#else
...
void AFXDLL_EXPORT AFXAPI AfxOleSetEditMenu(COleClientItem* pClient, CMenu* pMenu,
	UINT iMenuItem, UINT nIDVerbMin, UINT nIDVerbMax = 0, UINT nIDConvert = 0);

#ifdef _DEBUG
// Mapping SCODEs to readable text
LPCSTR AFXDLL_EXPORT AFXAPI AfxGetFullScodeString(SCODE sc);
LPCSTR AFXDLL_EXPORT AFXAPI AfxGetScodeString(SCODE sc);
LPCSTR AFXDLL_EXPORT AFXAPI AfxGetScodeRangeString(SCODE sc);
LPCSTR AFXDLL_EXPORT AFXAPI AfxGetSeverityString(SCODE sc);
LPCSTR AFXDLL_EXPORT AFXAPI AfxGetFacilityString(SCODE sc);

// Mapping IIDs to readable text
LPCSTR AFXDLL_EXPORT AFXAPI AfxGetIIDString(REFIID iid);
#endif
