...
HBITMAP AFXDLL_EXPORT AFXAPI AfxLoadSysColorBitmap(HINSTANCE hInst, HRSRC hRsrc);
...
#pragma pack(1)
struct AFX_CLASS_EXPORT NEAR_STRUCT_TYPE PIC
{
	BYTE    picType;
	union
	{
...
HPIC AFXDLL_EXPORT AFXAPI AfxSetPict(HPIC hPic, const PIC FAR* lpPic);
void AFXDLL_EXPORT AFXAPI AfxGetPict(HPIC hPic, LPPIC lpPic);
void AFXDLL_EXPORT AFXAPI AfxReferencePict(HPIC hPic, BOOL bReference);
...
class AFX_CLASS_EXPORT CRectTracker
{
public:
// Constructors
	CRectTracker();
...
struct AFX_CLASS_EXPORT CPrintInfo // Printing information structure
{
	CPrintInfo();
	~CPrintInfo();
...
struct AFX_CLASS_EXPORT CPrintPreviewState   // Print Preview context/state
{
...
struct AFX_CLASS_EXPORT CCreateContext   // Creation information structure
