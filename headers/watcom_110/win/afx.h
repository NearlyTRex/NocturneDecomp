...
#ifdef __WATCOMC__
#ifndef _M_I86LM
#error Microsoft Foundation Classes must be large model
#endif
#endif
...
#pragma warning 387 4	// exression only useful for side-effects
...
extern "C"
{
void AFXDLL_EXPORT CDECL AfxTrace(LPCSTR pszFormat, ...);
void AFXDLL_EXPORT AFXAPI AfxAssertFailedLine(LPCSTR lpszFileName, int nLine);
void AFXDLL_EXPORT AFXAPI AfxAssertValidObject(const CObject* pOb,
				LPCSTR lpszFileName, int nLine);
void AFXDLL_EXPORT AFXAPI AfxDump(const CObject* pOb); // Dump an object from CodeView
}
...
struct AFX_CLASS_EXPORT CRuntimeClass
{
// Attributes
...
#else
class AFX_CLASS_EXPORT CObject
#endif
{
public:
...
#else
struct AFX_CLASS_EXPORT AFX_CLASSINIT
#endif
...
#if defined(_DOS) && defined(__WATCOMC__)
#include <setjmp.h>
#else
...
BOOL AFXDLL_EXPORT AFXAPI AfxCatchProc(CRuntimeClass* pClass);
void AFXDLL_EXPORT AFXAPI AfxThrow(CException* pException, BOOL bShared);
void AFXDLL_EXPORT AFXAPI AfxThrowLast();
void AFXDLL_EXPORT AFXAPI AfxTryCleanupProc();
...
struct AFX_STACK_DATA AFX_EXCEPTION_LINK
{
	...
	{
	    	#if defined(_DOS) && defined(__WATCOMC__)
		jmp_buf m_jumpBuf; // arg for Catch/Throw (nType = 0)
	    	#else
		int m_jumpBuf[_AFX_JBLEN]; // arg for Catch/Throw (nType = 0)
		#endif
		struct AFX_CLASS_EXPORT
		{
...
struct AFX_CLASS_EXPORT AFX_EXCEPTION_CONTEXT
{
...
void AFXDLL_EXPORT AFXAPI AfxAbort();
...
void AFXDLL_EXPORT AFXAPI AfxThrowMemoryException();
void AFXDLL_EXPORT AFXAPI AfxThrowNotSupportedException();
void AFXDLL_EXPORT AFXAPI AfxThrowArchiveException(int cause);
void AFXDLL_EXPORT AFXAPI AfxThrowFileException(int cause, LONG lOsError = -1);
...
class AFX_CLASS_EXPORT CString
{
public:
...
// Compare helpers
BOOL AFXDLL_EXPORT AFXAPI operator==(const CString& s1, const CString& s2);
BOOL AFXDLL_EXPORT AFXAPI operator==(const CString& s1, const char* s2);
BOOL AFXDLL_EXPORT AFXAPI operator==(const char* s1, const CString& s2);
BOOL AFXDLL_EXPORT AFXAPI operator!=(const CString& s1, const CString& s2);
BOOL AFXDLL_EXPORT AFXAPI operator!=(const CString& s1, const char* s2);
BOOL AFXDLL_EXPORT AFXAPI operator!=(const char* s1, const CString& s2);
BOOL AFXDLL_EXPORT AFXAPI operator<(const CString& s1, const CString& s2);
...
class AFX_CLASS_EXPORT CTimeSpan
{
public:
...
struct AFX_CLASS_EXPORT CFileStatus
{
...
extern "C" BOOL AFXDLL_EXPORT AFXAPI AfxIsValidAddress(const void FAR* lp,
			UINT nBytes, BOOL bReadWrite = TRUE);
#ifdef _NEARDATA
BOOL AFXAPI AfxIsValidAddress(const void NEAR* np, UINT nBytes,
			BOOL bReadWrite = TRUE);
#endif
extern "C" BOOL AFXDLL_EXPORT AFXAPI AfxIsValidString(LPCSTR lpsz, int nLength = -1);
#ifdef _NEARDATA
...
BOOL AFXDLL_EXPORT AFXAPI AfxIsMemoryBlock(const void* p, UINT nBytes,
			LONG* plRequestNumber = NULL);

// Return TRUE if memory is sane or print out what is wrong
BOOL AFXDLL_EXPORT AFXAPI AfxCheckMemory();
...
extern "C" BOOL AFXDLL_EXPORT AFXAPI AfxDiagnosticInit(void);

// turn on/off tracking for a short while
BOOL AFXDLL_EXPORT AFXAPI AfxEnableMemoryTracking(BOOL bTrack);
...
AFX_ALLOC_HOOK AFXDLL_EXPORT AFXAPI AfxSetAllocHook(AFX_ALLOC_HOOK pfnAllocHook);
...
struct AFX_CLASS_EXPORT CMemoryState
{
// Attributes
	enum blockUsage
	{
...
void AFXDLL_EXPORT AFXAPI AfxDoForAllObjects(void (*pfn)(CObject* pObject,
			void* pContext), void* pContext);
void AFXDLL_EXPORT AFXAPI AfxDoForAllClasses(void (*pfn)(const CRuntimeClass* pClass,
			void* pContext), void* pContext);
...
class AFX_CLASS_EXPORT CArchive
{
public:
// Flag values
...
class AFX_CLASS_EXPORT CDumpContext
{
public:
