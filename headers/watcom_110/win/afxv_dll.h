...
#define AFX_EXPORT  __export                // WATCOM has no GEf
#define AFX_CLASS_EXPORT __export __cdecl   // WATCOM has no GEf
#define AFXDLL_EXPORT __export              // WATCOM has no GEf
#define AFXDLL_FUNC __export __cdecl	    // WATCOM has no GEF
#else
