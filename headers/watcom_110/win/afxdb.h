...
void AFXDLL_EXPORT AFXAPI AfxThrowDBException(RETCODE nRetCode, CDatabase* pdb,
	HSTMT hstmt);
...
class AFX_CLASS_EXPORT AFX_STACK_DATA CFieldExchange
{
// Attributes
public:
	enum RFX_Operation
...
// text data
void AFXDLL_EXPORT AFXAPI RFX_Text(CFieldExchange* pFX, const char *szName, CString& value,
	// Default max length for char and varchar, default datasource type
	int nMaxLength = 255, int nColumnType = SQL_VARCHAR);

// boolean data
void AFXDLL_EXPORT AFXAPI RFX_Bool(CFieldExchange* pFX, const char *szName, BOOL& value);

// integer data
void AFXDLL_EXPORT AFXAPI RFX_Long(CFieldExchange* pFX, const char *szName, long& value);
void AFXDLL_EXPORT AFXAPI RFX_Int(CFieldExchange* pFX, const char *szName, int& value);
void AFXDLL_EXPORT AFXAPI RFX_Single(CFieldExchange* pFX, const char *szName, float& value);
void AFXDLL_EXPORT AFXAPI RFX_Double(CFieldExchange* pFX, const char *szName, double& value);

// date and time
void AFXDLL_EXPORT AFXAPI RFX_Date(CFieldExchange* pFX, const char *szName, CTime& value);

// Binary data
void AFXDLL_EXPORT AFXAPI RFX_Binary(CFieldExchange* pFX, const char *szName, CByteArray& value,
	// Default max length is for binary and varbinary
	int nMaxLength = 255);
void AFXDLL_EXPORT AFXAPI RFX_Byte(CFieldExchange* pFX, const char *szName, BYTE& value);
void AFXDLL_EXPORT AFXAPI RFX_LongBinary(CFieldExchange* pFX, const char *szName, CLongBinary& value);
...
void AFXDLL_EXPORT AFXAPI DDX_FieldText(CDataExchange* pDX, int nIDC, BYTE& value, CRecordset* pRecordset);
void AFXDLL_EXPORT AFXAPI DDX_FieldText(CDataExchange* pDX, int nIDC, int& value, CRecordset* pRecordset);
void AFXDLL_EXPORT AFXAPI DDX_FieldText(CDataExchange* pDX, int nIDC, UINT& value, CRecordset* pRecordset);
void AFXDLL_EXPORT AFXAPI DDX_FieldText(CDataExchange* pDX, int nIDC, long& value, CRecordset* pRecordset);
void AFXDLL_EXPORT AFXAPI DDX_FieldText(CDataExchange* pDX, int nIDC, DWORD& value, CRecordset* pRecordset);
void AFXDLL_EXPORT AFXAPI DDX_FieldText(CDataExchange* pDX, int nIDC, CString& value, CRecordset* pRecordset);
void AFXDLL_EXPORT AFXAPI DDX_FieldText(CDataExchange* pDX, int nIDC, double& value, CRecordset* pRecordset);
void AFXDLL_EXPORT AFXAPI DDX_FieldText(CDataExchange* pDX, int nIDC, float& value, CRecordset* pRecordset);

// special control types
void AFXDLL_EXPORT AFXAPI DDX_FieldCheck(CDataExchange* pDX, int nIDC, int& value, CRecordset* pRecordset);
void AFXDLL_EXPORT AFXAPI DDX_FieldRadio(CDataExchange* pDX, int nIDC, int& value, CRecordset* pRecordset);
void AFXDLL_EXPORT AFXAPI DDX_FieldLBString(CDataExchange* pDX, int nIDC, CString& value, CRecordset* pRecordset);
void AFXDLL_EXPORT AFXAPI DDX_FieldCBString(CDataExchange* pDX, int nIDC, CString& value, CRecordset* pRecordset);
#if (WINVER >= 0x030a)
void AFXDLL_EXPORT AFXAPI DDX_FieldLBStringExact(CDataExchange* pDX, int nIDC, CString& value, CRecordset* pRecordset);
void AFXDLL_EXPORT AFXAPI DDX_FieldCBStringExact(CDataExchange* pDX, int nIDC, CString& value, CRecordset* pRecordset);
#endif
...
struct AFX_CLASS_EXPORT CRecordsetStatus
{
...
struct AFX_CLASS_EXPORT CFieldInfo
{
	// For ID'ing field
