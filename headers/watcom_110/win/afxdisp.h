...
#define BEGIN_INTERFACE_PART(localClass, iface) \
	class AFX_CLASS_EXPORT FAR_STRUCT_TYPE X##localClass : public iface \
	{ \
	public: \
...
#define BEGIN_INTERFACE_MAP(theClass, theBase) \
	...
	AFX_INTERFACEMAP /*__WATCOMC__ BASED_CODE*/ theClass::interfaceMap = \
		{ &(theBase::interfaceMap), theClass::_interfaceEntries, }; \
	AFX_INTERFACEMAP_ENTRY /*__WATCOMC__ BASED_CODE*/ theClass::_interfaceEntries[] = \
	{
...
void AFXDLL_EXPORT AFXAPI AfxThrowOleException(SCODE sc);
void AFXDLL_EXPORT AFXAPI AfxThrowOleException(HRESULT hr);
...
void AFXDLL_EXPORT AFXAPI AfxThrowOleDispatchException(WORD wCode, LPCSTR lpszDescription,
	UINT nHelpID = 0);
void AFXDLL_EXPORT AFXAPI AfxThrowOleDispatchException(WORD wCode, UINT nDescriptionID,
	UINT nHelpID = -1);
...
#define BEGIN_DISPATCH_MAP(theClass, baseClass) \
	...
	AFX_DISPMAP /*__WATCOMC__ BASED_CODE*/ theClass::dispatchMap = \
		{ &(baseClass::dispatchMap), theClass::_dispatchEntries }; \
	AFX_DISPMAP_ENTRY /*__WATCOMC__ BASED_CODE*/ theClass::_dispatchEntries[] = \
	{
...
BOOL AFXDLL_EXPORT AFXAPI AfxOleRegisterServerClass(
...
BOOL AFXDLL_EXPORT AFXAPI AfxOleRegisterHelper(LPCSTR FAR* rglpszRegister,
	LPCSTR FAR* rglpszSymbols, int nSymbols, BOOL bReplace);

/////////////////////////////////////////////////////////////////////////////
// Init & Term helpers

BOOL AFXDLL_EXPORT AFXAPI AfxOleInit();
void AFXDLL_EXPORT CALLBACK AfxOleTerm();

/////////////////////////////////////////////////////////////////////////////
// Global functions (may be overridden by replacing module OLELOCK?.CPP)

void AFXDLL_EXPORT AFXAPI AfxOleOnReleaseAllObjects();
BOOL AFXDLL_EXPORT AFXAPI AfxOleCanExitApp();
void AFXDLL_EXPORT AFXAPI AfxOleLockApp();
void AFXDLL_EXPORT AFXAPI AfxOleUnlockApp();

void AFXDLL_EXPORT AFXAPI AfxOleSetUserCtrl(BOOL bUserCtrl);
BOOL AFXDLL_EXPORT AFXAPI AfxOleGetUserCtrl();
