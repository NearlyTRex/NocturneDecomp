...
void* CObject::operator new[](size_t nSize, LPCSTR pFileName, int nLine)
{
	return CObject::operator new( nSize, pFileName, nLine );
}
#endif
...
#ifdef __WATCOMC__
extern "C"
void __far* malloc(size_t nSize ) { return _fmalloc( nSize ); }
extern "C"
void __far* _fmalloc(size_t nSize)
#else
extern "C"
...
#ifdef __WATCOMC__
extern "C"
void free( void __far *p ) { _ffree( p ); }
extern "C"
...
#ifdef __WATCOMC__
extern "C"
void __far* realloc(void __far *pOld, size_t nSize ) {
    return _frealloc( pOld, nSize );
}
extern "C"
void __far* _frealloc(void __far* pOld, size_t nSize)
#else
extern "C"
