...
class AFX_CLASS_EXPORT CSize : public tagSIZE
{
public:
...
class AFX_CLASS_EXPORT CPoint : public tagPOINT
{
public:
...
class AFX_CLASS_EXPORT CRect : public tagRECT
{
public:
...
#ifdef _DEBUG
// Diagnostic Output
CDumpContext& AFXDLL_EXPORT AFXAPI operator<<(CDumpContext& dc, SIZE size);
CDumpContext& AFXDLL_EXPORT AFXAPI operator<<(CDumpContext& dc, POINT point);
CDumpContext& AFXDLL_EXPORT AFXAPI operator<<(CDumpContext& dc, const RECT& rect);
#endif //_DEBUG

// Serialization
CArchive& AFXDLL_EXPORT AFXAPI operator<<(CArchive& ar, SIZE size);
CArchive& AFXDLL_EXPORT AFXAPI operator<<(CArchive& ar, POINT point);
CArchive& AFXDLL_EXPORT AFXAPI operator<<(CArchive& ar, const RECT& rect);
CArchive& AFXDLL_EXPORT AFXAPI operator>>(CArchive& ar, SIZE& size);
CArchive& AFXDLL_EXPORT AFXAPI operator>>(CArchive& ar, POINT& point);
CArchive& AFXDLL_EXPORT AFXAPI operator>>(CArchive& ar, RECT& rect);
...
void AFXDLL_EXPORT AFXAPI AfxThrowResourceException();
void AFXDLL_EXPORT AFXAPI AfxThrowUserException();
...
private: \
	static AFX_MSGMAP_ENTRY /*__WATCOMC__ BASED_CODE*/ _messageEntries[]; \
protected: \
...
#define BEGIN_MESSAGE_MAP(theClass, baseClass) \
	...
	AFX_MSGMAP_ENTRY /*__WATCOMC__ BASED_CODE*/ theClass::_messageEntries[] = \
	{
...
class AFX_CLASS_EXPORT AFX_STACK_DATA CDataExchange
{
// Attributes
public:
...
private: \
	static AFX_INTERFACEMAP_ENTRY /*__WATCOMC__ BASED_CODE*/ _interfaceEntries[]; \
protected: \
	static AFX_INTERFACEMAP /*__WATCOMC__ BASED_CODE*/ interfaceMap; \
...
private: \
	static AFX_DISPMAP_ENTRY /*__WATCOMC__ BASED_CODE*/ _dispatchEntries[]; \
protected: \
	static AFX_DISPMAP /*__WATCOMC__ BASED_CODE*/ dispatchMap; \
...
#ifdef __WATCOMC__
struct FAR_STRUCT_TYPE IDispatch;
#else
...
#ifdef __WATCOMC__
struct FAR_STRUCT_TYPE IUnknown;
#else
struct FAR IUnknown;
#endif
...
class AFX_CLASS_EXPORT CCmdUI        // simple helper class
{
public:
// Attributes
	UINT m_nID;
...
#ifdef __WATCOMC__
#define AFX_MSG_CALL AFX_CLASS_EXPORT
#else
#ifndef AFX_MSG_CALL
...
// CWnd dialog data support (always inline to avoid duplicate definitions)
inline void CWnd::DoDataExchange(CDataExchange*)
	{ } // default does nothing

// helpers for registering your own WNDCLASSes
const char* AFXDLL_EXPORT AFXAPI AfxRegisterWndClass(UINT nClassStyle,
...
extern BOOL AFXDLL_EXPORT AFXAPI AfxWinInit(HINSTANCE, HINSTANCE, LPSTR, int);
extern void AFXDLL_EXPORT AFXAPI AfxWinTerm();
}

// Global Windows state data helper functions (inlines)
CWinApp* AFXDLL_EXPORT AFXAPI AfxGetApp();
CWnd* AFXDLL_EXPORT AFXAPI AfxGetMainWnd();
HINSTANCE AFXDLL_EXPORT AFXAPI AfxGetInstanceHandle();
HINSTANCE AFXDLL_EXPORT AFXAPI AfxGetResourceHandle();
void AFXDLL_EXPORT AFXAPI AfxSetResourceHandle(HINSTANCE hInstResource);
const char* AFXDLL_EXPORT AFXAPI AfxGetAppName();

// access to message filter in CWinApp
class COleMessageFilter;        // see AFXOLE.H for more information
COleMessageFilter* AFXDLL_EXPORT AFXAPI AfxOleGetMessageFilter();
...
void AFXDLL_EXPORT AFXAPI AfxFormatString1(CString& rString, UINT nIDS, LPCSTR lpsz1);
void AFXDLL_EXPORT AFXAPI AfxFormatString2(CString& rString, UINT nIDS,
				LPCSTR lpsz1, LPCSTR lpsz2);
int AFXDLL_EXPORT AFXAPI AfxMessageBox(LPCSTR lpszText, UINT nType = MB_OK,
				UINT nIDHelp = 0);
int AFXDLL_EXPORT AFXAPI AfxMessageBox(UINT nIDPrompt, UINT nType = MB_OK,
				UINT nIDHelp = (UINT)-1);

// Implementation string helpers
void AFXDLL_EXPORT AFXAPI AfxFormatStrings(CString& rString, UINT nIDS,
				LPCSTR FAR* rglpsz, int nString);
void AFXDLL_EXPORT AFXAPI AfxFormatStrings(CString& rString, LPCSTR lpszFormat,
				LPCSTR FAR* rglpsz, int nString);
BOOL AFXDLL_EXPORT AFXAPI AfxExtractSubString(CString& rString, LPCSTR lpszFullString,
...
BOOL AFXDLL_EXPORT AFXAPI AfxUnlockTempMaps();
