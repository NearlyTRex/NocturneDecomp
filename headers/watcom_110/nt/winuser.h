...
#ifdef UNICODE
#ifdef __cplusplus
inline int wvsprintf( LPWSTR __a, LPCWSTR __b, va_list __c ) {
    return wvsprintfW(__a,__b,__c[0]);
}
#else
#define wvsprintf(__a,__b,__c)  wvsprintfW(__a,__b,__c[0])
#endif
#else
#ifdef __cplusplus
...
#else
#define wvsprintf(__a,__b,__c)  wvsprintfA(__a,__b,__c[0])
#endif
#endif // !UNICODE
#else
