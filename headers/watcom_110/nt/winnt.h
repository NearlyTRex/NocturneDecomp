...
//
#if defined(UNICODE) || defined(_UNICODE) // r_winnt
...
//
// Calculate the byte offset of a field __id in a structure of type __typ.
//

#ifdef __cplusplus
#define FIELD_OFFSET(__typ,__id) __offsetof(__typ,__id)
#else
#define FIELD_OFFSET(__typ,__id) ((size_t)&(((__typ*)0)->__id))
#endif
