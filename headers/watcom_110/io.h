...
_WCRTLINK extern long _findfirst( char *__filespec,
				  struct _finddata_t *__fileinfo );
_WCRTLINK extern long _wfindfirst( wchar_t *__filespec,
...
#ifdef __WATCOM_INT64__
_WCRTLINK extern long	    _findfirsti64( char *__filespec,
					   struct _finddatai64_t *__fileinfo );
_WCRTLINK extern long	    _wfindfirsti64( wchar_t *__filespec,
