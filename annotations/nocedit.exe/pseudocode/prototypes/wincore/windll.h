...
// Address: 005b4031
void __cdecl renderMMXPerspectiveScanline32(STexturedVertex *left_vertex,STexturedVertex *right_vertex,int scanline_y);

// Original: wincore_windll.cpp_renderMMXPerspectiveScanline16_FUN_005b4823
// Address: 005b4823
void __cdecl renderMMXPerspectiveScanline16(STexturedVertex *left_vertex,STexturedVertex *right_vertex,int scanline_y);

// Original: wincore_windll.cpp_renderPerspectiveCorrectScanline32_FUN_005b50ec
// Address: 005b50ec
void __cdecl renderPerspectiveCorrectScanline32(STexturedVertex *left_vertex,STexturedVertex *right_vertex,int scanline_y);

// Original: wincore_windll.cpp_renderPerspectiveCorrectScanline16_FUN_005b5322
// Address: 005b5322
void __cdecl renderPerspectiveCorrectScanline16(STexturedVertex *left_vertex,STexturedVertex *right_vertex,int scanline_y);
