...
// Address: 00502420
char CKeys::getKeyState(CKeys * this, int keyCode);

// Original: engine_keys.cpp_CKeys_getAndClearKeyState_FUN_00502430
// Address: 00502430
char CKeys::getAndClearKeyState(CKeys * this, int keyCode);
