...
// Address: 00551b70
void setMaxViewportScanline1200(void);

// Original: engine_prim.c_setMaxViewportScanline_FUN_00551b80
// Address: 00551b80
void setMaxViewportScanline(int max);
...
// Address: 00551ba0
void setupBasicSoftwareEdge(SRenderVertex * start_vertex, SRenderVertex * end_vertex);

// Original: engine_prim.c_setupSoftwareEdgeWithZMode_FUN_00551d60
// Address: 00551d60
void setupSoftwareEdgeWithZMode(SRenderVertex * start_vertex, SRenderVertex * end_vertex);

// Original: engine_prim.c_findEdgeInBuffer_FUN_00551f70
// Address: 00551f70
SSoftwareEdge * findEdgeInBuffer(int y_value, SSoftwareEdge * edge_ptr);
...
// Address: 00552210
int getTriangleWindingFromIndices(STriangleIndices * triangle);

// Original: engine_prim.c_getTriangleWindingFromIndices_FUN_00552300
// Address: 00552300
int getTriangleWindingFromIndices(STriangleIndices * triangle_indices);
...
// Address: 00552f70
void setupAdvancedSoftwareEdge(SRenderVertex * start_vertex, SRenderVertex * end_vertex);

// Original: engine_prim.c_setupColoredSoftwareEdge_FUN_00553190
// Address: 00553190
void setupColoredSoftwareEdge(SRenderVertex * vertex0, SRenderVertex * vertex1);

// Original: engine_prim.c_findEdgeInTable_FUN_00553410
// Address: 00553410
SSoftwareEdge * findEdgeInTable(int scanline, SSoftwareEdge * target_edge);
