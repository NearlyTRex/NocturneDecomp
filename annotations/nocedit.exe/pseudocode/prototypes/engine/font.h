...
// Address: 004ccdd0
int __cdecl CBitFont::clipCharacter(int *bitmap_offset,int *left_x,int *top_y,int *right_x,int *bottom_y,int bitmap_width);
...
// Address: 004cda80
int __cdecl CBitFont::drawTextLeft(CBitFont *this_ptr,char *text_string,int x_pos,int y_pos,int color_mode,int color_value);

// Original: engine_font.cpp_CBitFont_drawTextRight_FUN_004cdbf0
// Address: 004cdbf0
int __cdecl CBitFont::drawTextRight(CBitFont *this_ptr,char *text_string,int x_pos,int y_pos,int color_mode,int color_value);

// Original: engine_font.cpp_CBitFont_drawTextFV_FUN_004cdc20
// Address: 004cdc20
int __cdecl CBitFont::drawTextFV(CBitFont *this_ptr,int x_pos,int y_pos,int color_mode,int color_value,char *format_string ,...);

// Original: engine_font.cpp_CBitFont_drawTextF_FUN_004cdc70
// Address: 004cdc70
int __cdecl CBitFont::drawTextF(CBitFont *this_ptr,int x_pos,int y_pos,int color_mode,int color_value,char *format_string ,...);

// Original: engine_font.cpp_CBitFont_drawTextRight_FUN_004cdce0
// Address: 004cdce0
int __cdecl CBitFont::drawTextRight(CBitFont *this_ptr,int right_edge_x,int y_pos,int color_mode,int color_value, char *text_string);

// Original: engine_font.cpp_CBitFont_printfRight_FUN_004cdd20
// Address: 004cdd20
void __cdecl CBitFont::printfRight(CBitFont *font_ptr,int x,int y,int color,char *format,...);
...
// Address: 004cdde0
int __cdecl CBitFont::drawTextCenter(CBitFont *this_ptr,int center_x,int y_pos,int color_mode,int color_value, char *text_string);

// Original: engine_font.cpp_CBitFont_drawTextCenterFV_FUN_004cde20
// Address: 004cde20
int __cdecl CBitFont::drawTextCenterFV(CBitFont *this_ptr,int x_pos,int y_pos,int color_mode,int color_value,char *format_string ,...);
...
// Address: 004cdee0
int __cdecl CBitFont::drawTextCenterInBounds(CBitFont *this_ptr,int left_x,int right_x,int y_pos,int color_mode,int color_value, char *text_string);

// Original: engine_font.cpp_CBitFont_drawTextCenterInBoundsFV_FUN_004cdf30
// Address: 004cdf30
int __cdecl CBitFont::drawTextCenterInBoundsFV(CBitFont *this_ptr,int left_x,int right_x,int y_pos,int color_mode,int color_value, char *format_string,...);
...
// Address: 004cdff0
int __cdecl CBitFont::drawTextCenterInClip(CBitFont *this_ptr,int y_pos,int color_mode,int color_value,char *text_string);

// Original: engine_font.cpp_CBitFont_printfCenterInClip_FUN_004ce050
// Address: 004ce050
void __cdecl CBitFont::printfCenterInClip(CBitFont *this_ptr,int x,int y,int color,char *format,...);

// Original: engine_font.cpp_CBitFont_drawTextCenterInClipF_FUN_004ce090
// Address: 004ce090
int __cdecl CBitFont::drawTextCenterInClipF(CBitFont *this_ptr,int y_pos,int color_mode,int color_value,char *format_string, va_list_t *args);
...
// Address: 004ce2d0
void __cdecl CBitFont::render3DCharacter(CBitFont *this_ptr,int character_code,int x_pos,int y_pos,int z_pos,int width,int height, int color_mode);

// Original: engine_font.cpp_CBitFont_drawCharacter_FUN_004ce7a0
// Address: 004ce7a0
int __cdecl CBitFont::drawCharacter(CBitFont *this_ptr,int character_code,int x_pos,int y_pos,int color_mode,int color_value);
