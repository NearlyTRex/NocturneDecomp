...
// Address: 006012c0
int heapCheckWrapper(void * heap_state_ptr);

// Original: crt_heap.c_heapWalk_FUN_006012d0
// Address: 006012d0
int heapWalk(HeapState * heap_state_ptr, Heap * heap_ptr);

// Original: crt_heap.c_heapCheck_FUN_00601374
// Address: 00601374
int heapCheck(void * heap_state_ptr);

// Original: crt_heap.c_InternalHeapAlloc_FUN_00601bc0
// Address: 00601bc0
void * InternalHeapAlloc(ulong size);

// Original: crt_heap.c_ValidateHeapIntegrity_FUN_00601ce0
// Address: 00601ce0
void ValidateHeapIntegrity(void * ptr);
