...
// Address: 0060f960
HANDLE create::thread_with_sync(LPVOID thread_param, SIZE_T stack_size_hint, LPVOID sync_param, HANDLE * out_thread_handle);

// Original: crt_thread.c_exit_thread_FUN_0060fa58
// Address: 0060fa58
undefined exit::thread();
