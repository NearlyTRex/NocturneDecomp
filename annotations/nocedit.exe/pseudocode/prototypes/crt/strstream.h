...
// Address: 005ff445
void __cdecl ostrstream::destructor_thunk_from_ios(ios *this_ptr,int dtor_flags);
...
// Address: 005ff5b2
void __cdecl istrstream::destructor_thunk_from_ios(ios *this_ptr,int dtor_flags);
