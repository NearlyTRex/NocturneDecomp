...
// Address: 004eebc0
FILE * __cdecl openFileWithExtension(char *base_filename,char *file_extension,char *open_mode);
...
// Address: 004eee80
void __cdecl CGround::ctor(CGround *this_ptr,int width,int height);
