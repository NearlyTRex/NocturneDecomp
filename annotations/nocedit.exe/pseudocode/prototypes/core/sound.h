...
// Address: 005b17d0
void filterSoundFilesByPattern(char * wildcard_pattern);
...
// Address: 005b1ed0
void CSound::findRandomSoundFile(CSound * this_ptr, char * out_result, char * wildcard_pattern);
...
// Address: 005b3aa0
uint CSound::playActorNonPositionalSoundWithDelay(CSound * this_ptr, CDemonActor * actor, char * sound_name, float delay);

// Original: core_sound.cpp_CSound_playActorPositionalSoundWithDelay_FUN_005b3ae0
// Address: 005b3ae0
uint CSound::playActorPositionalSoundWithDelay(CSound * this_ptr, CDemonActor * actor, char * sound_name, CVector3f * position, float delay);
...
// Address: 005b3b80
void CSound::isSoundPlaying(CSound * this_ptr, uint sfx_handle);

// Original: core_sound.cpp_CSound_killSound_FUN_005b3b90
// Address: 005b3b90
void CSound::killSound(CSound * this_ptr, uint sfx_handle);

// Original: core_sound.cpp_CSound_getSoundDuration_FUN_005b3ba0
// Address: 005b3ba0
float CSound::getSoundDuration(CSound * this_ptr, char * sound_name);

// Original: core_sound.cpp_CSound_getReverbPresetCount_FUN_005b3c60
// Address: 005b3c60
int CSound::getReverbPresetCount(CSound * this_ptr);

// Original: core_sound.cpp_CSound_getSoundModeName_FUN_005b3c70
// Address: 005b3c70
char * CSound::getSoundModeName(CSound * this_ptr, int sound_mode_index);
...
// Address: 005b3dc0
void CSound::setVolumeFade(CSound * this_ptr, float target_volume, float fade_time);

// Original: core_sound.cpp_editSoundName_FUN_005b3de0
// Address: 005b3de0
void editSoundName(char * prompt_text, char * output_buffer);
...
// Address: 005b3e50
void freeTrainNoises(STrainNoise * * array);
