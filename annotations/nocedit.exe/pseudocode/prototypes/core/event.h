...
// Address: 004aaa70
void __cdecl CEventList(CEventList *this_ptr);
...
// Address: 004aac00
int __cdecl CEventList(CEventList *this_ptr);

// Original: core_event.cpp_CEventList_FUN_004aacc0
// Address: 004aacc0
CDemonActor * __cdecl CEventList(CEventList *this_ptr);

// Original: core_event.cpp_CEventList_FUN_004adc10
// Address: 004adc10
int __cdecl CEventList(CEventList *this_ptr,char *str);
...
// Address: 004b05a0
void __cdecl CEventList::setTimerEvent(CEventList *this_ptr);

// Original: core_event.cpp_CEventList_setCounter_FUN_004b0720
// Address: 004b0720
void __cdecl CEventList::setCounter(CEventList *this_ptr);
...
// Address: 004b0c80
void __cdecl CEventList::setSfxHandle(CEventList *this_ptr);
...
// Address: 004b0fc0
int __cdecl CEventList::loadState(CEventList *this_ptr);
...
// Address: 004b19d0
void __cdecl FUN_004b19d0(void);
...
// Address: 004b1a78
void __cdecl FUN_004b1a78(void);
