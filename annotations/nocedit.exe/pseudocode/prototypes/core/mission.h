...
// Address: 00522c80
void __cdecl CDemonMission::clearMaybe(CDemonMission *this_ptr);
...
// Address: 00522e30
void __cdecl CDemonMission::save(CDemonMission *this_ptr);

// Original: core_mission.cpp_CDemonMission_readMissionFile_FUN_00522eb0
// Address: 00522eb0
void __cdecl CDemonMission::readMissionFile(CDemonMission *this_ptr);

// Original: core_mission.cpp_CDemonMission_getNextLoadedInventoryActor_FUN_00523520
// Address: 00523520
void __cdecl CDemonMission::getNextLoadedInventoryActor(CDemonMission *this_ptr);
...
// Address: 00523600
void __cdecl CDemonMission::writeFile(CDemonMission *this_ptr);
...
// Address: 00523be0
void __cdecl CDemonMission::setupActorMaybe(CDemonMission *this_ptr,CDemonActor *actor_ptr);
...
// Address: 00524030
char * __cdecl CDemonMission(CDemonMission *this_ptr);
...
// Address: 005240a0
void __cdecl CDemonMission::markActorToDelete(CDemonMission *this_ptr);
...
// Address: 00524700
void __cdecl CDemonMission::initNewActorMaybe(CDemonMission *this_ptr);
...
// Address: 00524920
int __cdecl CDemonMission::createOneHero(CDemonMission *this_ptr);
...
// Address: 00524c20
void __cdecl FUN_00524c20(void);
