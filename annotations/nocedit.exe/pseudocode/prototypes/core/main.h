...
// Address: 00508250
void drawCenteredText(char * text, int y_pos, int color);

// Original: core_main.c_waitWithSkip_FUN_005082a0
// Address: 005082a0
void waitWithSkip(int duration_ms);
