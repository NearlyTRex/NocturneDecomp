...
// Original: core_svetlana.cpp_CSvetlana_FUN_005d9260
// Address: 005d9260
void __cdecl CSvetlana(CSvetlana *this_ptr);

// Original: core_svetlana.cpp_CSvetlana_FUN_005d9970
// Address: 005d9970
void __cdecl CSvetlana(CSvetlana *this_ptr);

// Original: core_svetlana.cpp_CSvetlana_FUN_005d9a10
// Address: 005d9a10
void __cdecl CSvetlana(CSvetlana *this_ptr);
...
// Original: core_svetlana.cpp_CSvetlana_FUN_005d9ec0
// Address: 005d9ec0
int __cdecl CSvetlana(CSvetlana *this_ptr);

// Original: core_svetlana.cpp_CSvetlana_FUN_005d9ed0
// Address: 005d9ed0
int __cdecl CSvetlana(CSvetlana *this_ptr);

// Original: core_svetlana.cpp_CSvetlana_FUN_005d9ee0
// Address: 005d9ee0
void __cdecl CSvetlana(CSvetlana *this_ptr);
