...
// Address: 0052cd50
void CMotionList::ctor(CMotionList * this_ptr);

// Original: core_motion.cpp_CMotionList_load_FUN_0052cd70
// Address: 0052cd70
void CMotionList::load(CMotionList * this_ptr, FILE * file_handle);

// Original: core_motion.cpp_CMotionList_save_FUN_0052d170
// Address: 0052d170
void CMotionList::save(CMotionList * this_ptr, FILE * file_handle);

// Original: core_motion.cpp_CMotionList_findMotionIndex_FUN_0052d460
// Address: 0052d460
int CMotionList::findMotionIndex(CMotionList * this_ptr);

// Original: core_motion.cpp_CMotionList_findStateIndex_FUN_0052d4f0
// Address: 0052d4f0
int CMotionList::findStateIndex(CMotionList * this_ptr);

// Original: core_motion.cpp_CMotionController_ctor_FUN_0052d570
// Address: 0052d570
CMotionController * CMotionController::ctor(CMotionController * this_ptr);

// Original: core_motion.cpp_CMotionController_dtor_FUN_0052d5a0
// Address: 0052d5a0
CMotionController * CMotionController::dtor(CMotionController * this_ptr, uint d1);
...
// Address: 0052e5d0
void CMotionController::load(CMotionController * this_ptr, FILE * file_handle);
