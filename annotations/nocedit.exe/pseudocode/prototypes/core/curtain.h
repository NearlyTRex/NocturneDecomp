...
// Address: 0044bab0
SCurtainVertex * __cdecl SCurtainVertex::dtor(SCurtainVertex *this_ptr);
...
// Original: core_curtain.cpp_freeCurtainVertices_FUN_0044bad0
// Address: 0044bad0
SCurtainVertex * __cdecl freeCurtainVertices(SCurtainVertex *objs);
