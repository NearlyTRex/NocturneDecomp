...
// Address: 004127a0
CDemonActorType * CBackgroundActor::getActorType(CBackgroundActor * this_ptr);
...
// Address: 00412860
void CBackgroundActor(CBackgroundActor * this_ptr);

// Original: core_backgnd.cpp_CBackgroundActor_FUN_004128d0
// Address: 004128d0
int CBackgroundActor(CBackgroundActor * this_ptr);
...
// Address: 00412990
void CBackgroundActor::serialize(CBackgroundActor * this_ptr);
...
// Address: 00412ad0
CBackgroundActor * CBackgroundActor::dtor(CBackgroundActor * this_ptr, uint d1, uint d2);
