...
// Points to CKeyFramedModelInstance at offset 0x158 in CMansionPuzzleCircle
...
struct CMansionPuzzleCircle_ptr_344 {
    ...
    CMansionPuzzleCircle* adj() const { return (CMansionPuzzleCircle*)((char*)_raw - offsetof(CMansionPuzzleCircle, panel_model)); }
