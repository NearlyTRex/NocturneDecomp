...
// Adjusted pointer: CHiram_ptr_12060
// Points to CHiram at offset 0x2f1c in CHiram
// 32-bit pointer to CHiram
struct CHiram_ptr_12060 {
    void *_raw;
    typedef CHiram base_type;
    CHiram_ptr_12060() : _raw(0) {}
    ...
    CHiram* adj() const { return (CHiram*)((char*)_raw - 12060); }
