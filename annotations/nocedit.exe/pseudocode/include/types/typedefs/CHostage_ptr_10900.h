...
// Adjusted pointer: CHostage_ptr_10900
// Points to CHostage at offset 0x2a94 in CHostage
// 32-bit pointer to CHostage
struct CHostage_ptr_10900 {
    void *_raw;
    typedef CHostage base_type;
    CHostage_ptr_10900() : _raw(0) {}
    ...
    CHostage* adj() const { return (CHostage*)((char*)_raw - 10900); }
