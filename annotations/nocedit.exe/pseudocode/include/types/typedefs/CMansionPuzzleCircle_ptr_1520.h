...
// Points to SPanel at offset 0x5f0 in CMansionPuzzleCircle
...
struct CMansionPuzzleCircle_ptr_1520 {
    ...
    CMansionPuzzleCircle* adj() const { return (CMansionPuzzleCircle*)((char*)_raw - offsetof(CMansionPuzzleCircle, panels)); }
