...
// Adjusted pointer: CLarva_ptr_12060
// Points to CLarva at offset 0x2f1c in CLarva
// 32-bit pointer to CLarva
struct CLarva_ptr_12060 {
    void *_raw;
    typedef CLarva base_type;
    CLarva_ptr_12060() : _raw(0) {}
    ...
    CLarva* adj() const { return (CLarva*)((char*)_raw - 12060); }
