...
// Adjusted pointer: CZombie_ptr_10900
// Points to CZombie at offset 0x2a94 in CZombie
// 32-bit pointer to CZombie
struct CZombie_ptr_10900 {
    void *_raw;
    typedef CZombie base_type;
    CZombie_ptr_10900() : _raw(0) {}
    ...
    CZombie* adj() const { return (CZombie*)((char*)_raw - 10900); }
