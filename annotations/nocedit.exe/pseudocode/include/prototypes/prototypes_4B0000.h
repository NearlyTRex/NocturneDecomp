...
undefined __unknown core_event_cpp_FUN_004b0f90();
...
undefined __unknown core_event_cpp_FUN_004b1670();
...
undefined __unknown core_event_cpp_FUN_004b1890();
undefined __unknown core_event_cpp_FUN_004b18e0();
undefined __unknown core_event_cpp_FUN_004b1930();
undefined __unknown core_event_cpp_FUN_004b1970();
undefined __unknown core_event_cpp_FUN_004b1980();
undefined __unknown core_event_cpp_FUN_004b19a1();
undefined __unknown core_event_cpp_FUN_004b19b1();
undefined __unknown core_event_cpp_FUN_004b19c1();
void __cdecl core_event_cpp_FUN_004b19d0(void);
undefined __unknown core_event_cpp_FUN_004b1a49();
undefined __unknown core_event_cpp_FUN_004b1a59();
void __cdecl core_event_cpp_FUN_004b1a78(void);
undefined __unknown core_event_cpp_FUN_004b1b1c();
undefined __unknown core_event_cpp_FUN_004b1b31();
undefined __unknown core_event_cpp_FUN_004b1b41();
undefined __unknown core_event_cpp_FUN_004b1b54();
undefined __unknown core_event_cpp_FUN_004b1b5c();
...
char * __cdecl engine_fileio_cpp_copyFileWithProgress_FUN_004b2030(FILE * source_file, FILE * dest_file, char * source_filename, char * dest_filename, int file_size_bytes);
...
int __cdecl engine_fileio_cpp_readTimestampFile_FUN_004b23a0(FILE * file, STimestampRecord * * records, int * count);
...
int __cdecl engine_fileio_cpp_CCheckOutList_write_FUN_004b2eb0(CCheckOutList * this_ptr, FILE * * file_handle);
...
int __cdecl engine_fileio_cpp_extractFileWithTimestamp_FUN_004b7d50(FILE * source_file, char * dest_filename, char * name_or_offset, int file_size, int file_offset, int checksum, int timestamp);
...
int __cdecl engine_fileio_cpp_CFileManager_checkOutAndExtractPod_FUN_004ba740(CFileManager * this_ptr, CCheckOutItem * checkout_item, FILE * optional_pod_file);
...
void __cdecl engine_fileio_cpp_synchronizeFilesToDirectory_FUN_004bc650(FILE * file_list_output, char * source_directory, char * file_pattern, char * dest_directory);
void __cdecl engine_fileio_cpp_writeArtFileEntries_FUN_004bc9f0(char * filename, FILE * * raw_file, FILE * * act_file);
...
void __cdecl core_fileman_cpp_refreshSoundDirectory_FUN_004be590(FILE * file_list_output, char * source_directory);
CDemonActorType * __cdecl core_filmreel_cpp_staticInit_FUN_004be620(void);
undefined __unknown core_filmreel_cpp_FUN_004be670();
undefined __unknown core_filmreel_cpp_FUN_004be6a0();
CFilmReel * __cdecl core_filmreel_cpp_ctor_FUN_004be6b0(CFilmReel * this_ptr);
undefined __unknown core_filmreel_cpp_FUN_004be720();
undefined __unknown core_filmreel_cpp_FUN_004be7b0();
...
undefined __unknown core_filmreel_cpp_FUN_004be8f0();
undefined __unknown core_filmreel_cpp_FUN_004be910();
undefined __unknown core_filmreel_cpp_FUN_004be960();
undefined __unknown core_filmreel_cpp_FUN_004be9b0();
undefined __unknown core_filmreel_cpp_FUN_004bea00();
undefined __unknown core_filmreel_cpp_NewClass_FUN_004bea30();
CFilmProjector * __cdecl core_filmreel_cpp_ctor_FUN_004bea40(CFilmProjector * this_ptr);
undefined __unknown core_filmreel_cpp_FUN_004beb00();
undefined __unknown core_filmreel_cpp_CFilmProjector_load_FUN_004beb40();
undefined __unknown core_filmreel_cpp_FUN_004becd0();
undefined __unknown core_filmreel_cpp_FUN_004bed00();
undefined __unknown core_filmreel_cpp_serialize_FUN_004bede0();
undefined __unknown core_filmreel_cpp_CFilmReel_FUN_004bee30();
CFilmReel * __cdecl core_filmreel_cpp_dtor_FUN_004bee80(CFilmReel * this_ptr, uint d1, uint d2);
CFilmProjector * __cdecl core_filmreel_cpp_dtor_FUN_004beed0(CFilmProjector * this_ptr, uint d1, uint d2);
void __cdecl core_fire_cpp_staticInit_FUN_004bef20(void);
undefined __unknown core_fire_cpp_FUN_004bf1a0();
...
void __cdecl core_fire_cpp_CBulletHole_ctor_FUN_004bf7f0(CBulletHole * this_ptr, CVector3f * hit_position, CVector3f * surface_normal, CDemonActor * hit_actor);
