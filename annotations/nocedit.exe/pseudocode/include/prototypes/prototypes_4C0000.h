...
float * __cdecl core_flies_cpp_CFlies_FUN_004cc820(CFlies *this_ptr);
...
int __cdecl engine_font_cpp_CBitFont_drawTextF_FUN_004cdc70 (CBitFont *this_ptr,int x_pos,int y_pos,int color_mode,int color_value,char *format_string ,va_list_t args);
...
int __cdecl engine_font_cpp_CBitFont_drawTextCenterFV_FUN_004cde20 (CBitFont *this_ptr,int x,int y,int color_mode,int color_value,char *format_string,...);
...
int __cdecl engine_font_cpp_CBitFont_drawTextCenterInBoundsFV_FUN_004cdf30 (CBitFont *this_ptr,int left_x,int right_x,int y,int color_mode,int color_value, char *format_string,...);
