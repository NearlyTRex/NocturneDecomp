...
CRainDrop * __cdecl core_fire_cpp_CRainDrop_arrdtor256_FUN_004c97d0(CRainDrop *this_ptr,uint flags);
CPopcorn * __cdecl core_fire_cpp_CPopcorn_arrdtor256_FUN_004c97f0(CPopcorn *this_ptr,uint flags);
CShell * __cdecl core_fire_cpp_CShell_arrdtor50_FUN_004c9810(CShell *this_ptr,uint flags);
CTrail * __cdecl core_fire_cpp_CTrail_arrdtor100_FUN_004c9830(CTrail *this_ptr,uint flags);
CLightningBolt * __cdecl core_fire_cpp_CLightningBolt_arrdtor10_FUN_004c9850(CLightningBolt *this_ptr,uint flags);
CGunFlame * __cdecl core_fire_cpp_CGunFlame_arrdtor500_FUN_004c9870(CGunFlame *this_ptr,uint flags);
CCrater * __cdecl core_fire_cpp_CCrater_arrdtor20_FUN_004c9890(CCrater *this_ptr,uint flags);
CToss * __cdecl core_fire_cpp_CToss_arrdtor20_FUN_004c98b0(CToss *this_ptr,uint flags);
CExplosion * __cdecl core_fire_cpp_CExplosion_arrdtor10_FUN_004c98d0(CExplosion *this_ptr,uint flags);
CLaserBeam * __cdecl core_fire_cpp_CLaserBeam_arrdtor64_FUN_004c98f0(CLaserBeam *this_ptr,uint flags);
CRock * __cdecl core_fire_cpp_CRock_arrdtor64_FUN_004c9910(CRock *this_ptr,uint flags);
CFireball * __cdecl core_fire_cpp_CFireball_arrdtor64_FUN_004c9930(CFireball *this_ptr,uint flags);
...
CMuzzleFlash * __cdecl core_fire_cpp_CMuzzleFlash_arrdtor20_FUN_004c9990(CMuzzleFlash *this_ptr,uint flags);
CSpark * __cdecl core_fire_cpp_CSpark_arrdtor256_FUN_004c99b0(CSpark *this_ptr,uint flags);
CStake * __cdecl core_fire_cpp_CStake_arrdtor256_FUN_004c99d0(CStake *this_ptr,uint flags);
CBulletHole * __cdecl core_fire_cpp_CBulletHole_arrdtor256_FUN_004c99f0(CBulletHole *this_ptr,uint flags);
CSmokeParticle * __cdecl core_fire_cpp_CSmokeParticle_arrdtor2048_FUN_004c9a10(CSmokeParticle *this_ptr,uint flags);
...
CFlameCan * __cdecl core_flamecan_cpp_factoryFuncFlameCan_FUN_004cb120(void);
...
CFlameThrower * __cdecl core_flamegun_cpp_factoryFuncFlameThrower_FUN_004cb840(void);
...
CFlashlight * __cdecl core_flashlit_cpp_factoryFuncFlashlight_FUN_004cbb80(void);
...
SFly * __cdecl core_flies_cpp_SFly_arrdtor200_FUN_004ccd60(SFly *objs,uint flags);
