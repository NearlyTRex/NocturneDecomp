...
CVector3f * __cdecl core_dtrace_cpp_freeVectors_FUN_0049a410(CVector3f *objs);
...
float __cdecl core_dynamite_cpp_CDynamite_FUN_0049cee0(CDynamite *this_ptr);
void __cdecl core_dynamite_cpp_CDynamite_FUN_0049cf10(CDynamite *this_ptr);
