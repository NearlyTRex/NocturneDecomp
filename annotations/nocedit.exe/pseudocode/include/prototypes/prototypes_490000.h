...
CVector3f * __cdecl core_dtrace_cpp_CVector3f_arrdtor20000_FUN_0049a410(CVector3f *this_ptr,uint flags);
...
void __cdecl core_dynamite_cpp_CDynamite_renderAimBeam_FUN_0049cf10(CDynamite *this_ptr);
