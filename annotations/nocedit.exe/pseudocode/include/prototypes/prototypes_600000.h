...
time_t __cdecl crt_time_c_time_FUN_006001f0(time_t *optional_output);
_tm * __cdecl crt_time_c_localtime_r_FUN_00600230(time_t *timer,_tm *result);
_tm * __cdecl crt_time_c_localtime_FUN_00600288(time_t *timer);
void __cdecl crt_stdio_c_formatTwoDigits_FUN_006002a0(char *buffer,int value);
uint __cdecl crt_time_c_strftime_FUN_006002d4 (char *dest_buffer,uint buffer_size,char *format_string,_tm *time_ptr);
...
int __cdecl crt_io_c_stat_thunk_00600c18(char *filename,_stat *file_info);
...
int __cdecl crt_heap_c__heapwalk_FUN_006012c0(void *heap_state_ptr);
...
char * __watcallStack crt_time_c_asctime_FUN_00601768(_tm *timeptr);
...
_FILE * crt_unknown_c_MultipleDoNothingCalls_FUN_00601a94 (undefined4 param_1,undefined4 param_2,undefined4 unaff_EBX,undefined4 param_4, _FILE *param_5);
_FILE * __cdecl crt_stdio_c_fopenThreadSafe_FUN_00601b14(char *filename,char *mode,_FILE **output_file_ptr);
...
void crt_memory_c___memfill_FUN_00603b00(void *dest,uint replicated_value,uint count);
void crt_memory_c___stosd_FUN_00603b37(void *dest,uint replicated_value,uint dword_count);
