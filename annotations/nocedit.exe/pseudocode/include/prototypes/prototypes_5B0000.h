...
int __cdecl engine_special_cpp_selectTexture_FUN_005b72c0(SMRGLTextureBasic *texture_info);
int __cdecl engine_special_cpp_updateTexture_FUN_005b7300(SMRGLTextureBasic *texture_info);
int __cdecl engine_special_cpp_selectTextureFromPalette_FUN_005b7340(SMRGLTextureBasic *tex,SRGBColorPalette *palette_data);
int __cdecl engine_special_cpp_updateTextureFromPalette_FUN_005b7380(SMRGLTextureBasic *tex,SRGBColorPalette *palette_data);
...
CSpike * __cdecl core_spike_cpp_factoryFuncSpike_FUN_005b81e0(void);
...
CStranger * __cdecl core_stranger_cpp_factoryFuncStranger_FUN_005bb0e0(void);
