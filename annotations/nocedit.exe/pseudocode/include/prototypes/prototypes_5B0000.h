...
void __cdecl wincore_windll_cpp_clearZBufferNative_FUN_005b3ed4(void);
...
int __cdecl wincore_windll_cpp_setMipMapLevel_FUN_005b7440(int mipmap_level);
...
int __cdecl wincore_windll_cpp_lockTexture_FUN_005b7e30(int texture_id);
