...
int __cdecl core_spline_cpp_FUN_005b9270(void);
float * __cdecl core_spline_cpp_FUN_005b92d0(void);
float __cdecl core_spline_cpp_FUN_005b93f0(void);
int __cdecl core_spline_cpp_FUN_005b9430(void);
...
float * __cdecl core_stranger_cpp_CStranger_FUN_005be490(void);
