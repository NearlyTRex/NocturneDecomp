...
int __cdecl core_chain_cpp_passthroughInt1_FUN_00431330(int value);
int __cdecl core_chain_cpp_passthroughInt2_FUN_00431340(int value);
...
SChainVertex * __cdecl core_chain_cpp_SChainVertex_arrdtor20_FUN_004313f0(SChainVertex *objs,uint flags);
...
void __cdecl core_cloth_cpp_CCloth_process_FUN_0043ab80(CCloth *this_ptr,CVector3f *position,CVector3f *euler,float delta_time,float floor_y ,CDeformableModelInstance *model_ptr);
...
CVector3f * __cdecl core_cloth_cpp_CVector3f_arrdtor3_FUN_0043e460(CVector3f *this_ptr,uint flags);
SClothVertex * __cdecl core_cloth_cpp_SClothVertex_arrdtor800_FUN_0043e480(SClothVertex *objs,uint flags);
SClothBone * __cdecl core_cloth_cpp_SClothBone_arrdtor50_FUN_0043e4a0(SClothBone *objs,uint flags);
