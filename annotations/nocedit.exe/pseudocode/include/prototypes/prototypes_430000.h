...
int __cdecl core_chain_cpp_passthroughInt_FUN_00431330(int value);
int __cdecl core_chain_cpp_passthroughInt_FUN_00431340(int value);
...
float __cdecl core_cloth_cpp_dotProduct_FUN_0043e320(CVector3f *a,CVector3f *b);
