...
CAlphaBitmap * __cdecl core_moon_cpp_freeAlphaBitmaps_FUN_0052a470(CAlphaBitmap *objs);
...
CVector3f * __cdecl core_morph_cpp_freeVectors_FUN_0052cc90(CVector3f *objs);
SMorphControlPoint * __cdecl core_morph_cpp_freeMorphControlPoints_FUN_0052ccb0(SMorphControlPoint *objs);
CDeformableModelInstance * __cdecl core_morph_cpp_freeDeformableModelInstances_FUN_0052ccd0(CDeformableModelInstance *objs);
