...
void __cdecl core_lightgun_cpp_CLightGun_renderAimBeam_FUN_005066b0(CLightGun *this_ptr);
...
void __cdecl core_main_c_displayErrorAndQuit_FUN_00506f10(char *format,...) __attribute__((format(printf, 1, 2)));
...
int __cdecl core_manpuz_cpp_CMansionPuzzleCircle_customGetFloorHeight_FUN_005097d0(CMansionPuzzleCircle *this_ptr,CVector3f *position,float search_radius,float *out_floor_height);
...
SPanel * __cdecl core_manpuz_cpp_SPanel_arrdtor12_FUN_0050ba90(SPanel *objs,uint flags);
SGem * __cdecl core_manpuz_cpp_SGem_arrdtor12_FUN_0050bab0(SGem *objs,uint flags);
SReflector * __cdecl core_manpuz_cpp_SReflector_arrdtor2_FUN_0050bad0(SReflector *objs,uint flags);
...
void __cdecl core_melee_cpp_CMelee_renderAimBeam_FUN_0050eaa0(CMelee *this_ptr);
...
void * __cdecl shape_memdbg_cpp_debugAllocTracked2_FUN_0050f1f0(int size,char *filename,int line_number);
void __cdecl shape_memdbg_cpp_debugFreeChecked_FUN_0050f210(void *ptr);
