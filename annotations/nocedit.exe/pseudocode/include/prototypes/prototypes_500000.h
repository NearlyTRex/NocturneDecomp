...
void * __cdecl shape_memdbg_cpp_debugAllocTracked_FUN_0050f1b0(int size,char *filename,int line_number);
void * __cdecl shape_memdbg_cpp_debugAlloc_FUN_0050f1d0(int size);
void * __cdecl shape_memdbg_cpp_debugAllocTracked_FUN_0050f1f0(int size,char *filename,int line_number);
