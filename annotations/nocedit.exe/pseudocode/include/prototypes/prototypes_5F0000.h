...
undefined __unknown core_werewolf_cpp_FUN_005f11a0();
undefined __unknown core_werewolf_cpp_FUN_005f11e0();
undefined __unknown core_werewolf_cpp_FUN_005f1230();
...
undefined __unknown core_werewolf_cpp_FUN_005f1ac0();
undefined __unknown core_werewolf_cpp_FUN_005f1db0();
int __cdecl core_werewolf_cpp_CWerewolf_FUN_005f1df0(CWerewolf * this_ptr);
undefined __unknown core_werewolf_cpp_FUN_005f1e40();
undefined __unknown core_werewolf_cpp_FUN_005f2010();
undefined __unknown core_werewolf_cpp_FUN_005f2070();
void __cdecl core_werewolf_cpp_CWerewolf_FUN_005f20d0(CWerewolf * this_ptr);
undefined __unknown core_werewolf_cpp_FUN_005f21e0();
void __cdecl core_werewolf_cpp_CWerewolf_FUN_005f21f0(CWerewolf * this_ptr);
CWerewolf * __cdecl core_werewolf_cpp_CWerewolf_dtor_FUN_005f2220(CWerewolf * this_ptr, uint d1, uint d2, uint d3, uint d4, uint d5, uint d6, uint d7, uint d8);
...
CWinFont * __cdecl engine_winfont_cpp_CWinFont_dtor_FUN_005f2390(CWinFont * this_ptr, uint d1, uint d2, uint d3);
...
undefined __unknown wincore_winrun_cpp_addWindowsMessageHook_FUN_005f3100();
...
CVector3f * __cdecl core_xform_cpp_matrixToEulerAngles_FUN_005f5690(CVector3f * euler_out, CMatrix3x3f * matrix_ptr);
CVector3f * __cdecl core_xform_cpp_matrixToEulerAnglesZYX_FUN_005f5bd0(CVector3f * euler_out, CMatrix3x3f * matrix_ptr);
void __cdecl core_xform_cpp_getTranslation_FUN_005f6110(CVector3f * output_vector, CMatrix3x4f * input_matrix);
CVector3f * __cdecl core_xform_cpp_invertAndGetTranslation_FUN_005f6140(CVector3f * output_vector, CMatrix3x4f * input_matrix);
...
CMatrix3x4f * __stack_esi core_xform_cpp_inverse_FUN_005f6210(CMatrix3x4f * output_matrix, CMatrix3x4f * input_matrix);
...
void __stack_esi core_xform_cpp_buildRotationX_FUN_005f6c40(CMatrix3x4f * output_matrix, float angle_radians);
void __stack_esi core_xform_cpp_buildRotationY_FUN_005f6cc0(CMatrix3x4f * output_matrix, float angle_radians);
void __stack_esi core_xform_cpp_buildRotationZ_FUN_005f6d40(CMatrix3x4f * output_matrix, float angle_radians);
void __stack_esi core_xform_cpp_buildTranslationMatrix_FUN_005f6dc0(CMatrix3x4f * output_matrix, CVector3f * translation);
void __stack_esi core_xform_cpp_buildUniformScaleMatrix_FUN_005f6e20(CMatrix3x4f * output_matrix, float scale_factor);
void __stack_esi core_xform_cpp_buildScaleMatrix_FUN_005f6e80(CMatrix3x4f * output_matrix, CVector3f * scale_vector);
CMatrix3x4f * __stack_esi core_xform_cpp_buildXFlipMatrix_FUN_005f6ee0(CMatrix3x4f * matrix_out, float x_offset);
CMatrix3x4f * __stack_esi core_xform_cpp_buildYFlipMatrix_FUN_005f6f40(CMatrix3x4f * matrix_out, float y_offset);
CMatrix3x4f * __stack_esi core_xform_cpp_buildZFlipMatrix_FUN_005f6fa0(CMatrix3x4f * matrix_out, float z_offset);
CMatrix3x4f * __stack2_esi core_xform_cpp_buildMirrorTransform_FUN_005f7000(CMatrix3x4f * matrix_out, CVector3f * axis_vector, float distance);
void __stack3_esi core_xform_cpp_lerpMatrix3x4_FUN_005f7140(CMatrix3x4f * matrix_a, CMatrix3x4f * matrix_b, float t, CMatrix3x4f * output);
void __cdecl core_xform_cpp_quaternionToMatrix3x3_FUN_005f7280(CMatrix3x3f * matrix_ptr, CQuaternion4f * quat_ptr);
CMatrix3x4f * __stack_esi core_xform_cpp_quaternionToMatrix3x4_FUN_005f73e0(CMatrix3x4f * matrix_out, CQuaternion4f * quat_ptr);
CQuaternion4f * __stack_esi core_xform_cpp_matrixToQuaternion_FUN_005f7420(CMatrix3x3f * matrix_ptr, CQuaternion4f * quat_out);
void __stack_esi core_xform_cpp_negateFirstComponent_FUN_005f75e0(CQuaternion4f * output_vector, CQuaternion4f * input_vector);
void __cdecl core_xform_cpp_setIdentityQuaternion_FUN_005f7620(CQuaternion4f * quaternion);
CQuaternion4f * __stack2_esi core_xform_cpp_multiplyQuaternion_FUN_005f7640(CQuaternion4f * result_out, CQuaternion4f * quat1_ptr, CQuaternion4f * quat2_ptr);
...
void __cdecl core_xform_cpp_quaternionToAxisAngle_FUN_005f7730(CQuaternion4f * quat_ptr, float * angle_out, CVector3f * axis_out);
CQuaternion4f * __stack3_esi core_xform_cpp_slerpQuaternion_FUN_005f77e0(CQuaternion4f * quat1_ptr, CQuaternion4f * quat2_ptr, float t, CQuaternion4f * result_out);
void __stack_esi core_xform_cpp_quaternionFromAngleX_FUN_005f79b0(float angle_radians, CQuaternion4f * quat_ptr);
void __stack_esi core_xform_cpp_quaternionFromAngleY_FUN_005f79f0(float angle_radians, CQuaternion4f * quat_ptr);
void __stack_esi core_xform_cpp_quaternionFromAngleZ_FUN_005f7a30(float angle_radians, CQuaternion4f * quat_ptr);
void __stack2_esi core_xform_cpp_quaternionFromAxisAngle_FUN_005f7a70(float angle_radians, CVector3f * axis_ptr, CQuaternion4f * quat_ptr);
CVector3f * __cdecl core_xform_cpp_quaternionToEulerAngles_FUN_005f7ac0(CVector3f * euler_out, CQuaternion4f * quat_ptr);
CVector3f * __cdecl core_xform_cpp_quaternionToEulerAnglesZYX_FUN_005f7af0(CVector3f * euler_out, CQuaternion4f * quat_ptr);
...
undefined __unknown core_zombie_cpp_FUN_005f8cc0();
undefined __unknown core_zombie_cpp_FUN_005f8d30();
undefined __unknown core_zombie_cpp_FUN_005f8da0();
undefined __unknown core_zombie_cpp_CZombie_FUN_005f8e50();
undefined __unknown core_zombie_cpp_FUN_005f8fa0();
...
undefined __unknown core_zombie_cpp_CZombie_FUN_005fbda0();
undefined __unknown core_zombie_cpp_CZombie_FUN_005fbde0();
...
undefined __unknown core_zombie_cpp_CZombie_FUN_005fc120();
undefined __unknown core_zombie_cpp_CZombie_FUN_005fc220();
undefined __unknown core_zombie_cpp_CZombie_FUN_005fc4f0();
int __cdecl core_zombie_cpp_CZombie_FUN_005fc720(CZombie * this_ptr);
undefined __unknown core_zombie_cpp_CZombie_FUN_005fc920();
undefined __unknown core_zombie_cpp_CZombie_FUN_005fc960();
undefined __unknown core_zombie_cpp_CZombie_FUN_005fc970();
int __cdecl core_zombie_cpp_CZombie_FUN_005fc9e0(CZombie * this_ptr);
undefined __unknown core_zombie_cpp_CZombie_FUN_005fca10();
void __cdecl core_zombie_cpp_CZombie_FUN_005fca80(CZombie * this_ptr);
undefined __unknown core_zombie_cpp_CZombie_FUN_005fcb70();
...
undefined __unknown core_zombie_cpp_FUN_005fcd10();
undefined __unknown core_zombie_cpp_FUN_005fcd20();
undefined __unknown core_zombie_cpp_FUN_005fce40();
undefined __unknown core_zombie_cpp_FUN_005fcf80();
...
int __cdecl crt_memory_c_freeTypeArray_FUN_005feee9(void * * obj_array, int obj_count, WatcomTypeInfo * type_info);
...
undefined __unknown crt_unknown_c_FUN_005ff0d0();
...
ofstream * __cdecl crt_fstream_cpp_ofstream_dtor_FUN_005ff7bc(ofstream * this_ptr, uint d1, uint d2, uint d3, uint d4);
void * __cdecl crt_fstream_cpp_ifstream_dtor_FUN_005ff856(ifstream * this_ptr, uint d1, uint d2, uint d3, uint d4);
...
void __watcallRegister crt_stack_c_check_stack_target_FUN_005ffa03(void * target_stack_ptr);
...
FILE * __cdecl crt_stdio_c_stream_write_internal_FUN_005ffcb3(FILE * stream, void * buffer, SIZE_T count);
