...
void wincore_winrun_cpp_addWindowsMessageHook_FUN_005f3100 (undefined4 param_1,undefined4 param_2,undefined4 unaff_EBX,undefined4 param_4, WNDPROC param_5);
...
bool core_zombie_cpp_CZombie_FUN_005fc960(void);
...
int __cdecl crt_stdio_c_fprintf_FUN_005fe6d0(_FILE *file,char *format,...);
...
int __cdecl crt_stdio_c_fscanf_FUN_005fe7c0(_FILE *file,char *format,...);
...
int __cdecl crt_memory_c___arrfini_FUN_005feee9(void **obj_array,int obj_count,WatcomTypeInfo *type_info);
...
int __cdecl crt_stdio_c_fgetc_outptr_FUN_005ff245(_FILE *stream,uchar *output_byte);
int __cdecl crt_stdio_c_fputc_FUN_005ff2d7(_FILE *stream,int character);
