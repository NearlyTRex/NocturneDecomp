...
istream * __cdecl crt_stdio_c_istream_get_FUN_005ff245(istream *this_ptr,char *c);
ostream * __cdecl crt_stdio_c_ostream_put_FUN_005ff2d7(ostream *this_ptr,int character);
