...
void __cdecl engine_ncursfx_cpp_CMouse_FUN_00544500(CMouse *this_ptr);
...
void __cdecl engine_ncursfx_cpp_CMouse_FUN_005445a0(CMouse *this_ptr);
void __cdecl engine_ncursfx_cpp_CMouse_FUN_005445c0(CMouse *this_ptr);
CAlphaBitmap * __cdecl engine_ncursfx_cpp_freeBitmap_FUN_00544730(CAlphaBitmap *objs);
CAlphaBitmap * __cdecl engine_ncursfx_cpp_freeSkullBitmaps_FUN_00544750(CAlphaBitmap *objs);
