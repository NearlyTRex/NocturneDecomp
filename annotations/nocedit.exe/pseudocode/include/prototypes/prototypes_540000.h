...
CAlphaBitmap * __cdecl engine_ncursfx_cpp_CAlphaBitmap_arrdtor2_FUN_00544750(CAlphaBitmap *this_ptr,uint flags);
...
CPathMap * __cdecl core_path_cpp_CPathMap_arrdtor_FUN_00548c30(CPathMap *this_ptr,uint flags);
