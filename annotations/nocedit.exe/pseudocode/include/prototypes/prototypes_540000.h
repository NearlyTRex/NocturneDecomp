...
void __cdecl core_netgame_cpp_FUN_00540550(void);
...
void __cdecl core_netgame_cpp_CNetGame_send_FUN_005411c0(void);
void __cdecl core_netgame_cpp_CNetGame_FUN_00541230(void);
int __cdecl core_netgame_cpp_CNetGame_FUN_00541260(void);
int __cdecl core_netgame_cpp_CNetGame_addPlayer_FUN_005412b0(void);
int __cdecl core_netgame_cpp_FUN_00541390(void);
...
void __cdecl core_netgame_cpp_CNetGame_removePlayer_FUN_00542b00(void);
...
void __cdecl core_netgame_cpp_CNetGame_FUN_00543930(void);
void __cdecl core_netgame_cpp_CNetGame_sendSimFrameAck_FUN_00543970(void);
bool __cdecl core_netgame_cpp_FUN_00543ab0(void);
int __cdecl core_netgame_cpp_FUN_00543ad0(void);
void __cdecl core_netgame_cpp_FUN_00543b00(void);
void __cdecl core_netgame_cpp_FUN_00543b20(void);
void __cdecl core_netgame_cpp_FUN_00543b30(void);
void __cdecl core_netgame_cpp_FUN_00543b40(void);
void __cdecl core_netgame_cpp_FUN_00543b50(void);
void __cdecl core_netgame_cpp_FUN_00543b60(void);
void __cdecl core_netgame_cpp_FUN_00543b70(void);
void __cdecl core_netgame_cpp_FUN_00543b80(void);
void __cdecl core_netgame_cpp_FUN_00543b90(void);
void __cdecl core_netgame_cpp_FUN_00543ba0(void);
...
int __cdecl core_netgame_cpp_CNetGame_FUN_00543e20(void);
...
void __cdecl core_passngr_cpp_FUN_00545ef0(void);
int __cdecl core_passngr_cpp_FUN_005460c0(void);
void __cdecl core_passngr_cpp_CPassenger_load_FUN_00546190(void);
void __cdecl core_passngr_cpp_FUN_00546270(void);
void __cdecl core_passngr_cpp_FUN_005462f0(void);
...
void __cdecl core_pendulum_cpp_FUN_005495c0(void);
bool __cdecl core_pendulum_cpp_FUN_00549aa0(void);
void __cdecl core_pendulum_cpp_FUN_00549b90(void);
void __cdecl core_pendulum_cpp_FUN_0054a180(void);
int __cdecl core_pendulum_cpp_FUN_0054a2f0(void);
float * __cdecl core_pendulum_cpp_FUN_0054a360(void);
void __cdecl core_pendulum_cpp_CPendulum_load_FUN_0054a3b0(void);
int __cdecl core_pendulum_cpp_FUN_0054a550(void);
int __cdecl core_pendulum_cpp_FUN_0054a590(void);
void __cdecl core_pendulum_cpp_FUN_0054a5a0(void);
int __cdecl core_pendulum_cpp_FUN_0054a5e0(void);
void __cdecl core_pendulum_cpp_FUN_0054a5f0(void);
void __cdecl core_pendulum_cpp_FUN_0054a790(void);
...
CPackedBitmap * __cdecl cockpit_pkbitmap_cpp_parsePBGFile_FUN_0054b9b0 (CPackedBitmapSet *bitmap_set,_FILE *file_handle,int param3,int param4, int selected_bitmap_index);
...
int __cdecl cockpit_pkbmpset_cpp_FUN_0054c7a0(void);
int __cdecl cockpit_pkbmpset_cpp_FUN_0054c7b0(void);
void __cdecl cockpit_pkbmpset_cpp_FUN_0054c7c0(void);
void __cdecl cockpit_pkbmpset_cpp_FUN_0054c7d0(void);
...
void __cdecl core_platfrm_cpp_CPlatform_LoadCourseSomething_FUN_0054ca20(void);
void __cdecl core_platfrm_cpp_FUN_0054cab0(void);
void __cdecl core_platfrm_cpp_FUN_0054cc30(void);
void __cdecl core_platfrm_cpp_FUN_0054d690(void);
int __cdecl core_platfrm_cpp_FUN_0054d720(void);
void __cdecl core_platfrm_cpp_FUN_0054d9b0(void);
float * __cdecl core_platfrm_cpp_FUN_0054db70(void);
void __cdecl core_platfrm_cpp_CPlatform_load_FUN_0054dbc0(void);
int __cdecl core_platfrm_cpp_FUN_0054df80(void);
int __cdecl core_platfrm_cpp_FUN_0054e180(void);
int __cdecl core_platfrm_cpp_FUN_0054e1a0(void);
int __cdecl core_platfrm_cpp_FUN_0054e1c0(void);
int __cdecl core_platfrm_cpp_FUN_0054e1d0(void);
void __cdecl core_platfrm_cpp_CPlatform_attachActor_FUN_0054e1e0(void);
void __cdecl core_platfrm_cpp_FUN_0054e2e0(void);
void __cdecl core_platfrm_cpp_FUN_0054e320(void);
void __cdecl core_platfrm_cpp_FUN_0054e400(void);
int __cdecl core_platfrm_cpp_FUN_0054e480(void);
void __cdecl core_platfrm_cpp_FUN_0054e4e0(void);
int __cdecl core_platfrm_cpp_FUN_0054e530(void);
void __cdecl core_platfrm_cpp_FUN_0054e700(void);
int __cdecl core_platfrm_cpp_FUN_0054e760(void);
void __cdecl core_platfrm_cpp_FUN_0054e7d0(void);
void __cdecl core_platfrm_cpp_FUN_0054ea00(void);
void __cdecl core_platfrm_cpp_FUN_0054f060(void);
