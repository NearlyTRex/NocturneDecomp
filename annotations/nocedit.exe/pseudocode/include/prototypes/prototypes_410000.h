...
void __cdecl core_ammobox_cpp_CAmmoBox_openBox_FUN_00411690(CAmmoBox *this_ptr,float open_pct);
...
void __cdecl core_batman_cpp_CBatman_pickRandomMovementState_FUN_004167f0(CBatman *this_ptr);
