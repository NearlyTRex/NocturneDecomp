...
inline void engine_dosio_cpp_addGetFileInfoHook_FUN_00481710(T_func0 handler) {
    engine_dosio_cpp_addGetFileInfoHook_FUN_00481710((FileSearchHandlerFunc *)handler);
}
...
_FILE * __cdecl engine_dosio_cpp_getFile_FUN_00481a50(char *directory,char *filename,char *mode);
...
CFileFinder * __cdecl engine_dosio_cpp_CFileFinder_ctor_FUN_00481c30(CFileFinder *this_ptr);
CFileFinder * __cdecl engine_dosio_cpp_CFileFinder_dtor_FUN_00481c50(CFileFinder *this_ptr,uint flags);
int __cdecl engine_dosio_cpp_CFileFinder_openSearch_FUN_00481c70(CFileFinder *this_ptr,char *search_pattern);
...
void __cdecl cockpit_drawsurf_cpp_setColorRed_FUN_004873b0(void);
void __cdecl cockpit_drawsurf_cpp_setColorGreen_FUN_004873d0(void);
void __cdecl cockpit_drawsurf_cpp_setColorBlue_FUN_004873f0(void);
void __cdecl cockpit_drawsurf_cpp_setColorYellow_FUN_00487410(void);
...
void __cdecl cockpit_drawsurf_cpp_setColorGray_FUN_00487480(void);
void __cdecl cockpit_drawsurf_cpp_setColorLightGray_FUN_004874a0(void);
...
void __cdecl cockpit_drawsurf_cpp_CDrawSurface_drawTextRightAlignedVariantPrintf_FUN_00489520(CDrawSurface *this_ptr,int x,int y,char *format,...) __attribute__((format(printf, 4, 5)));
...
void __cdecl cockpit_drawsurf_cpp_CDrawSurface_drawTextCenteredPrintf_FUN_004895f0(CDrawSurface *this_ptr,int x,int y,char *format,...) __attribute__((format(printf, 4, 5)));
...
void __cdecl cockpit_drawsurf_cpp_CDrawSurface_drawTextRightAlignedVCenteredPrintf_FUN_004896c0(CDrawSurface *this_ptr,int x,int y,char *format,...) __attribute__((format(printf, 4, 5)));
...
void __cdecl cockpit_drawsurf_cpp_CDrawSurface_drawTextCenteredBothPrintf_FUN_00489790(CDrawSurface *this_ptr,int x,int y,char *format,...) __attribute__((format(printf, 4, 5)));
...
void __cdecl cockpit_drawsurf_cpp_CDrawSurface_drawTextCenteredInBoundsPrintf_FUN_00489860(CDrawSurface *this_ptr,int x,int y,int width,char *format,...) __attribute__((format(printf, 5, 6)));
...
void __cdecl cockpit_drawsurf_cpp_CDrawSurface_drawTextCenteredInAreaPrintf_FUN_00489940(CDrawSurface *this_ptr,int x,int y,int height,char *format,...) __attribute__((format(printf, 5, 6)));
...
void __cdecl cockpit_drawsurf_cpp_CDrawSurface_drawTextCenteredInAreaWithWidthPrintf_FUN_00489a30(CDrawSurface *this_ptr,int x,int width,int y,int height,char *format,...) __attribute__((format(printf, 6, 7)));
...
void __cdecl cockpit_drawsurf_cpp_CDrawSurface_drawTextCenteredFullWidthPrintf_FUN_00489af0(CDrawSurface *this_ptr,int y,char *format,...) __attribute__((format(printf, 3, 4)));
...
void __cdecl cockpit_drawsurf_cpp_CDrawSurface_drawTextCenteredFullHeightPrintf_FUN_00489bb0(CDrawSurface *this_ptr,int x,char *format,...) __attribute__((format(printf, 3, 4)));
void __cdecl cockpit_drawsurf_cpp_CDrawSurface_drawTextCenteredFullSurface_FUN_00489c20(CDrawSurface *this_ptr,char *text);
void __cdecl cockpit_drawsurf_cpp_CDrawSurface_drawTextCenteredFullSurfacePrintf_FUN_00489c40(CDrawSurface *this_ptr,char *format,...) __attribute__((format(printf, 2, 3)));
...
int __cdecl engine_drender_cpp_CDemonRenderer_renderDepthProfiledDirect_FUN_0048ab50(CDemonRenderer *this_ptr,SMRGLHeaderPrimitive *prim);
...
void __cdecl engine_drender_cpp_CDemonRenderer_renderTexturedDirect_FUN_0048ae10(CDemonRenderer *this_ptr,SMRGLHeaderPrimitive *prim,int render_flags);
...
void __cdecl engine_drender_cpp_CDemonRenderer_renderAlphaBlendedDirect_FUN_0048b150(CDemonRenderer *this_ptr,SMRGLHeaderPrimitive *prim);
...
void __cdecl engine_drender_cpp_CDemonRenderer_renderFullEffectsDirect_FUN_0048b650(CDemonRenderer *this_ptr,SMRGLHeaderPrimitive *prim);
...
void __cdecl engine_drender_cpp_CDemonRenderer_renderDestReadBlendDirect_FUN_0048b890(CDemonRenderer *this_ptr,SMRGLHeaderPrimitive *prim);
void __cdecl engine_drender_cpp_CDemonRenderer_renderDestReadBlendPoly_FUN_0048b970(CDemonRenderer *this_ptr,SMRGLPrimitivePoly *poly);
...
void __cdecl engine_drender_cpp_CDemonRenderer_renderBlendedDirect_FUN_0048bcf0(CDemonRenderer *this_ptr,SMRGLHeaderPrimitive *prim);
...
void __cdecl engine_drender_cpp_CDemonRenderer_renderOverlayDirect_FUN_0048bf10(CDemonRenderer *this_ptr,SMRGLHeaderPrimitive *prim);
void __cdecl engine_drender_cpp_CDemonRenderer_renderOverlayPoly_FUN_0048bfe0(CDemonRenderer *this_ptr,SMRGLPrimitivePoly *poly);
...
int __cdecl engine_drender_cpp_CDemonRenderer_isShadowPass_FUN_0048cae0(CDemonRenderer *this_ptr);
