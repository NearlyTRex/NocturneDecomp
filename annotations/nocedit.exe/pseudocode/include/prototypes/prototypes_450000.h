...
void __cdecl core_dcamera_cpp_loadCameraFog_FUN_00453e50(SFog * fog, FILE * file_handle, int file_version);
...
void __cdecl core_dcube_cpp_CDemonCubeTriangle_readFromFile_FUN_004551d0(CDemonCubeTriangle * this_ptr, FILE * file_handle, CVector3f * vertex_buffer_base);
void __cdecl core_dcube_cpp_CDemonCubeTriangle_writeToFile_FUN_00455250(CDemonCubeTriangle * this_ptr, FILE * file_handle, CVector3f * vertex_buffer_base);
...
void __cdecl shape_design_c_writeSpatialTree_FUN_0045a200(STreeNode * node, FILE * output_file, int node_index);
void __cdecl shape_design_c_writePolygonModel_FUN_0045a320(int polygon_index, FILE * output_file, float scale_factor);
...
undefined __unknown shape_design_c_createPolygonFromVertexList_FUN_0045cc80();
undefined __unknown shape_design_c_doNothing_FUN_0045ce00();
...
undefined __unknown shape_design_c_showPolygonDetailsList_FUN_0045d9c0();
undefined __unknown shape_design_c_showModelPartsList_FUN_0045dbe0();
undefined __unknown shape_design_c_deleteSinglePolygon_FUN_0045dcc0();
undefined __unknown shape_design_c_deletePolygonRange_FUN_0045dd70();
undefined __unknown shape_design_c_selectModelPart_FUN_0045de80();
undefined __unknown shape_design_c_createQuadPolygon_FUN_0045df60();
undefined __unknown shape_design_c_createReversedQuadPolygon_FUN_0045e040();
undefined __unknown shape_design_c_createRotationalSweepGeometry_FUN_0045e070();
undefined __unknown shape_design_c_createBoxPrimitive_FUN_0045e520();
undefined __unknown shape_design_c_centerVerticesAroundPoint_FUN_0045ea90();
undefined __unknown shape_design_c_translateAllVerticesAlongAxis_FUN_0045ec90();
