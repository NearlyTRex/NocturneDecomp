...
int __cdecl core_ghoul_cpp_CGhoul_FUN_004e82d0(CGhoul *this_ptr);
CVector3f * __cdecl core_ghoul_cpp_CGhoul_FUN_004e84a0(CGhoul *this_ptr);
...
int __cdecl core_gore_cpp_CGore_FUN_004ee290(CGore *this_ptr);
...
CBloodPool * __cdecl core_gore_cpp_CBloodPool_dtor_FUN_004ee3c0(CBloodPool *this_ptr);
CBloodSplat * __cdecl core_gore_cpp_CBloodSplat_ctor_FUN_004ee3d0(CBloodSplat *this_ptr);
CBloodSplat * __cdecl core_gore_cpp_CBloodSplat_dtor_FUN_004ee3e0(CBloodSplat *this_ptr);
CBloodParticle * __cdecl core_gore_cpp_CBloodParticle_ctor_FUN_004ee3f0(CBloodParticle *this_ptr);
CBloodParticle * __cdecl core_gore_cpp_CBloodParticle_dtor_FUN_004ee410(CBloodParticle *this_ptr);
