...
void __cdecl engine_2d_c_drawTextRightAlignedWrapper_FUN_004021f0(int x_pos, int y_pos, char * text);
void __cdecl engine_2d_c_drawTextRightAlignedFormatted_FUN_00402210(int x_pos, int y_pos, char * format_string, ...);
void __cdecl engine_2d_c_drawTextCenteredAt_FUN_00402280(char * text, int x_pos, int y_pos);
void __cdecl engine_2d_c_drawTextCenteredAtWrapper_FUN_004022c0(int x_pos, int y_pos, char * text);
void __cdecl engine_2d_c_drawTextCenteredAtFormatted_FUN_004022e0(int x_pos, int y_pos, char * format_string, ...);
void __cdecl engine_2d_c_drawTextCentered_FUN_00402350(char * text, int left_x, int right_x, int y_pos);
void __cdecl engine_2d_c_drawTextCenteredReordered_FUN_00402390(int left_x, int right_x, int y_pos, char * text);
void __cdecl engine_2d_c_drawTextCenteredFormatted_FUN_004023c0(int left_x, int right_x, int y_pos, char * format_string, ...);
void __cdecl engine_2d_c_drawTextColor_FUN_00402430(char * text, int x_pos, int y_pos);
void __cdecl engine_2d_c_drawTextColorWrapper_FUN_004024a0(int x_pos, int y_pos, char * text);
void __cdecl engine_2d_c_drawTextColorFormatted_FUN_004024c0(int x_pos, int y_pos, char * format_string, ...);
void __cdecl engine_2d_c_drawTextRightAlignedColor_FUN_00402530(char * text, int y_pos, int right_x);
void __cdecl engine_2d_c_drawTextRightAlignedColorWrapper_FUN_00402560(int y_pos, int right_x, char * text);
void __cdecl engine_2d_c_drawTextRightAlignedColorFormatted_FUN_00402580(int y_pos, int right_x, char * format_string, ...);
void __cdecl engine_2d_c_drawTextCenteredAtColor_FUN_004025f0(char * text, int center_x, int y_pos);
void __cdecl engine_2d_c_drawTextCenteredAtColorWrapper_FUN_00402630(int center_x, int y_pos, char * text);
void __cdecl engine_2d_c_drawTextCenteredAtColorFormatted_FUN_00402650(int center_x, int y_pos, char * format_string, ...);
...
void __cdecl engine_2d_c_drawTextCenteredColorFormatted_FUN_00402730(int left_x, int right_x, int y_pos, char * format_string, ...);
