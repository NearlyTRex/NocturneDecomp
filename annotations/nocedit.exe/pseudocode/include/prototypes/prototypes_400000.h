...
undefined __unknown crt_unknown_c_BaseStart_FUN_00401000();
...
void __cdecl engine_2d_c_drawTextMultiline_FUN_00401cf0(char * text, int x_start, int y_start, int y_max);
...
void __cdecl engine_2d_c_drawTextMultilineColor_FUN_00401f40(char * text, int x_start, int y_start, int y_max, int color);
...
void __cdecl engine_2d_c_drawTextRightAlignedFormatted_FUN_00402210(char * format_string, int y_pos, int right_x, ...);
...
void __cdecl engine_2d_c_drawTextCenteredAtFormatted_FUN_004022e0(char * format_string, int center_x, int y_pos, ...);
void __cdecl engine_2d_c_drawTextCentered_FUN_00402350(char * text, int left_x, int right_x, int y_pos);
void __cdecl engine_2d_c_drawTextCenteredReordered_FUN_00402390(char * text, int left_x, int right_x, int y_pos);
void __cdecl engine_2d_c_drawTextCenteredFormatted_FUN_004023c0(char * format_string, int left_x, int right_x, int y_pos, ...);
...
void __cdecl engine_2d_c_drawTextColorFormatted_FUN_004024c0(char * format_string, int x_pos, int y_pos, ...);
void __cdecl engine_2d_c_drawTextRightAlignedColor_FUN_00402530(char * text, int y_pos, int right_x);
void __cdecl engine_2d_c_drawTextRightAlignedColorWrapper_FUN_00402560(char * text, int y_pos, int right_x);
void __cdecl engine_2d_c_drawTextRightAlignedColorFormatted_FUN_00402580(char * format_string, int y_pos, int right_x, ...);
void __cdecl engine_2d_c_drawTextCenteredAtColor_FUN_004025f0(char * text, int center_x, int y_pos);
void __cdecl engine_2d_c_drawTextCenteredAtColorWrapper_FUN_00402630(char * text, int center_x, int y_pos);
void __cdecl engine_2d_c_drawTextCenteredAtColorFormatted_FUN_00402650(char * format_string, int center_x, int y_pos, ...);
void __cdecl engine_2d_c_drawTextCenteredColor_FUN_004026c0(char * text, int left_x, int right_x, int y_pos);
void __cdecl engine_2d_c_drawTextCenteredXYColor_FUN_00402700(int left_x, int right_x, int y_pos, char * text);
void __cdecl engine_2d_c_drawTextCenteredColorFormatted_FUN_00402730(char * format_string, int left_x, int right_x, int y_pos, ...);
...
void __cdecl engine_2d_c_doNothing_FUN_00402860(void);
...
undefined __unknown engine_2d_c_draw320x200SizeDot_FUN_00402a8e();
byte __cdecl engine_2d_c_computeOutcode_FUN_00402c10(int x, int y, int x_min, int y_min, int x_max, int y_max);
...
SMRGLHeaderExtended * __cdecl engine_3d_c_processTextureCoordinates_FUN_00403a80(SMRGLHeaderPrimitive * polygon_info);
...
SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonTextureNormalized_FUN_00403f20(SMRGLHeaderPrimitive * polygon_info);
void * __cdecl engine_3d_c_renderOverlayTextureEnable_FUN_00404020(SMRGLHeaderPrimitive * polygon_info);
...
SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonUVMappedComplex_FUN_00404d50(SMRGLHeaderPrimitive * polygon_info);
...
SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonUVTextureEnable_FUN_00405350(SMRGLHeaderPrimitive * polygon_info);
SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonUVTextureNormalized_FUN_00405430(SMRGLHeaderPrimitive * polygon_info);
SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonUVVertexLitNormalized_FUN_00405510(SMRGLHeaderPrimitive * polygon_info);
...
SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonEnginePlaneMaskedEffect_FUN_00405690(SMRGLHeaderPrimitive * polygon_info);
...
SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonUVWrappedAdvanced_FUN_004058d0(SMRGLHeaderPrimitive * polygon_info);
SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonDepthWriteTextured_FUN_00405960(SMRGLHeaderPrimitive * polygon_info);
SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonUVTextureEnable_FUN_00405a00(SMRGLHeaderPrimitive * polygon_info);
SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonUVVertexLit_FUN_00405aa0(SMRGLHeaderPrimitive * polygon_info);
...
SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonTextureWrappedStandard_FUN_00405ce0(SMRGLHeaderPrimitive * polygon_info);
SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonDepthWriteTexturedLit_FUN_00405d80(SMRGLHeaderPrimitive * polygon_info);
SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonDepthWriteTexturedAdvanced_FUN_00405e20(SMRGLHeaderPrimitive * polygon_info);
SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonTexturedBasic_FUN_00405ec0(SMRGLHeaderPrimitive * polygon_info);
SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonOverlayTextured_FUN_00405f60(SMRGLHeaderPrimitive * polygon_info);
SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonDepthWriteTexturedLit_FUN_00406000(SMRGLHeaderPrimitive * polygon_info);
SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonTexturePerspectiveCorrect_FUN_004060a0(SMRGLHeaderPrimitive * polygon_info);
SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonTextureWrappedLit_FUN_00406150(SMRGLHeaderPrimitive * polygon_info);
SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonUVTextureNormalized_FUN_004061f0(SMRGLHeaderPrimitive * polygon_info);
...
SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonLastPixelMode_FUN_004066d0(SMRGLHeaderPrimitive * polygon_info);
SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonPerspectiveAlphaSpecial_FUN_004067a0(SMRGLHeaderPrimitive * polygon_info);
...
SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonEngineDepthLit_FUN_00406be0(SMRGLHeaderPrimitive * polygon_info);
...
SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonEngineAPIPremiumMultiState_FUN_004070c0(SMRGLHeaderPrimitive * polygon_info);
SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonEngineAPIPremiumMultiState_FUN_00407290(SMRGLHeaderPrimitive * polygon_info);
...
void __cdecl core_actor_cpp_serializeOrientation_FUN_0040b3e0(COrientation * orient_ptr, char * property_name);
void __cdecl core_actor_cpp_serializeLocation_FUN_0040b480(CLocation * location_ptr, char * property_name);
void __cdecl core_actor_cpp_serializeQuaternion_FUN_0040b520(CQuaternion4f * quat_ptr, char * property_type);
void __cdecl core_actor_cpp_serializeString_FUN_0040b5c0(char * * string_buffer, char * property_type);
void __cdecl core_actor_cpp_serializeLocalizedString_FUN_0040b6e0(char * * string_buffer, char * localization_key);
...
void __cdecl core_actor_cpp_serializeKeyframedModelInstance_FUN_0040b8f0(CKeyFramedModelInstance * model_ptr, char * property_name);
void __cdecl core_actor_cpp_serializedDeformableModelInstance_FUN_0040b970(CDeformableModelInstance * model_ptr, char * property_name);
void __cdecl core_actor_cpp_serializeMotionState_FUN_0040b9f0(CMotionController * motion_controller, char * property_name);
...
void __cdecl core_actor_cpp_serializeClothList_FUN_0040be60(CClothList * cloth_list, char * property_name);
...
int __cdecl core_actor_cpp_CDemonActor_processFootstepAtOffset_FUN_0040c8f0(CDemonActor * this_ptr, CVector3f * u1, float offset);
int __cdecl core_actor_cpp_CDemonActor_handleFootstep_FUN_0040ca10(CDemonActor * this_ptr, CVector3f * position, int surface_type, float unknown);
...
undefined __unknown core_actor_cpp_CActorPropertyList_FUN_0040e770();
undefined __unknown core_actor_cpp_CActorPropertyList_FUN_0040e850();
undefined __unknown core_actor_cpp_CActorPropertyList_FUN_0040e9c0();
undefined __unknown core_actor_cpp_CActorProperty_FUN_0040ea50();
undefined __unknown core_actor_cpp_FUN_0040ee30();
undefined __unknown core_actor_cpp_FUN_0040ee50();
int __cdecl core_actor_cpp_CActorProperty_editInteractive_FUN_0040eed0(CActorProperty * this_ptr, CDemonActor * actor);
undefined __unknown core_actor_cpp_FUN_0040fffe();
