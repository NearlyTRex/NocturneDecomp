...
const float g_SoundDivisorConstant = 4f;
const float g_SoundReferenceDistanceConstant = 20f;
const float FLOAT_00663160 = 10000f;
const float FLOAT_00663164 = 2f;
const float FLOAT_00663310 = 0.25f;
const float FLOAT_00663314 = 0.25f;
const float FLOAT_00663318 = 1f;
