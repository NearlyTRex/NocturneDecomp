...
;                               FUNCTION
; *****************************************************************************
; __cdecl void cockpit_drawsurf.cpp_CDrawSurface_drawTextCenteredFullSurface_FUN_00489c20(CDrawSurface * this_ptr, char * text)
;
; Parameters:
...
;   core_script.cpp_CScript_RelatedToSubtitles_FUN_00559d80 at 00559f6d
;
; Called Functions:
...
section .text
    ...
    PUSH ECX                            ; 00489c35
    PUSH EDX                            ; 00489c36
    CALL cockpit_drawsurf.cpp_CDrawSurface_drawTextCenteredInAreaWithWidth_FUN_004899c0 ; 00489c37 | void cockpit_drawsurf.cpp_CDrawSurface_drawTextCenteredInAreaWithWidth_FUN_004899c0(CDrawSurface * this_ptr, int x, int y, int width, ...)
