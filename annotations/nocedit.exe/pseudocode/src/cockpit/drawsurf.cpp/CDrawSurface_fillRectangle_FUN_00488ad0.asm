...
section .text
    ...
    PUSH EDI                            ; 00488b34
    INC ESI                             ; 00488b35
    CALL cockpit_drawsurf.cpp_CDrawSurface_drawHorizontalLineWithEffect_FUN_00487630 ; 00488b36 | void cockpit_drawsurf.cpp_CDrawSurface_drawHorizontalLineWithEffect_FUN_00487630(int start_x, int end_x, int y)
        ;   XREF to: 00487630 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00488b3b
    CMP ESI,EBP                         ; 00488b3e
    JLE 0x00488b32                      ; 00488b40 | LAB_00488b32
    ...
    MOV EDX,dword ptr [ESP]             ; 00488b62
        ;   Label: LAB_00488b62
    PUSH EDX                            ; 00488b65
    MOV ECX,dword ptr [0x02c6d550]      ; 00488b66 | int g_CurrentDrawColor
    MOV EAX,dword ptr [EBX + 0x2cf6a9c] ; 00488b6c | void *[1024] g_ScreenBufferArray
    PUSH ECX                            ; 00488b72
    ADD EAX,EDI                         ; 00488b73
    PUSH EAX                            ; 00488b75
    ADD EBX,0x4                         ; 00488b76
    INC ESI                             ; 00488b79
    CALL crt_memory.c_memset_FUN_005fde40 ; 00488b7a | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
        ;   XREF to: 005fde40 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00488b7f
    CMP EBX,EBP                         ; 00488b82
    JLE 0x00488b62                      ; 00488b84 | LAB_00488b62
    ...
    MOV dword ptr [ESP + 0x8],EDX       ; 00488b8e
        ;   Label: LAB_00488b8e
    MOV EAX,dword ptr [EBP + 0x2cf6a9c] ; 00488b92 | void *[1024] g_ScreenBufferArray
        ;   Label: LAB_00488b92
    MOV dword ptr [ESP + 0x10],EAX      ; 00488b98
    MOV EAX,EDI                         ; 00488b9c
    CMP EDI,EBX                         ; 00488b9e
    JG 0x00488bbe                       ; 00488ba0 | LAB_00488bbe
    ...
    ADD EDX,0x2                         ; 00488bab
        ;   Label: LAB_00488bab
    MOV CX,word ptr [0x02c6d550]        ; 00488bae | int g_CurrentDrawColor
    INC EAX                             ; 00488bb5
    MOV word ptr [EDX + -0x2],CX        ; 00488bb6
    CMP EAX,EBX                         ; 00488bba
    JLE 0x00488bab                      ; 00488bbc | LAB_00488bab
    ...
    JG 0x00488b50                       ; 00488bc8 | LAB_00488b50
        ;   XREF to: 00488b50 (CONDITIONAL_JUMP)
    JMP 0x00488b92                      ; 00488bca | LAB_00488b92
        ;   XREF to: 00488b92 (UNCONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x4],EDX       ; 00488bcc
        ;   Label: LAB_00488bcc
    MOV EAX,dword ptr [EBP + 0x2cf6a9c] ; 00488bd0 | void *[1024] g_ScreenBufferArray
        ;   Label: LAB_00488bd0
    MOV EDX,EDI                         ; 00488bd6
    MOV dword ptr [ESP + 0xc],EAX       ; 00488bd8
    CMP EDI,EBX                         ; 00488bdc
    JG 0x00488bfe                       ; 00488bde | LAB_00488bfe
    ...
    ADD EAX,0x4                         ; 00488bed
        ;   Label: LAB_00488bed
    MOV ECX,dword ptr [0x02c6d550]      ; 00488bf0 | int g_CurrentDrawColor
    INC EDX                             ; 00488bf6
    MOV dword ptr [EAX + -0x4],ECX      ; 00488bf7
    CMP EDX,EBX                         ; 00488bfa
    JLE 0x00488bed                      ; 00488bfc | LAB_00488bed
    ...
    JG 0x00488b50                       ; 00488c08 | LAB_00488b50
        ;   XREF to: 00488b50 (CONDITIONAL_JUMP)
    JMP 0x00488bd0                      ; 00488c0e | LAB_00488bd0
        ;   XREF to: 00488bd0 (UNCONDITIONAL_JUMP)
    LEA EDX,[EBP*0x4 + 0x0]             ; 00488c10
        ;   Label: LAB_00488c10
    MOV EAX,[0x0067939c]                ; 00488c17 | int g_BitsPerPixel
    LEA EBP,[ESI*0x4 + 0x0]             ; 00488c1c
    CMP EAX,0x10                        ; 00488c23
    JNC 0x00488c33                      ; 00488c26 | LAB_00488c33
        ;   XREF to: 00488c33 (CONDITIONAL_JUMP)
    CMP EAX,0x8                         ; 00488c28
    JZ 0x00488b58                       ; 00488c2b | LAB_00488b58
        ;   XREF to: 00488b58 (CONDITIONAL_JUMP)
    JMP 0x00488c3e                      ; 00488c31 | LAB_00488c3e
        ;   XREF to: 00488c3e (UNCONDITIONAL_JUMP)
    JBE 0x00488b8e                      ; 00488c33 | LAB_00488b8e
        ;   Label: LAB_00488c33
        ;   XREF to: 00488b8e (CONDITIONAL_JUMP)
    CMP EAX,0x20                        ; 00488c39
    JZ 0x00488bcc                       ; 00488c3c | LAB_00488bcc
        ;   XREF to: 00488bcc (CONDITIONAL_JUMP)
    MOV EDX,0x621e46                    ; 00488c3e | = "..\\cockpit\\drawsurf.cpp" | s_cockpit_drawsurf_cpp_00621e46 = ..\cockpit\drawsurf.cpp
        ;   Label: LAB_00488c3e
    MOV ECX,0x524                       ; 00488c43
    PUSH 0x621e5e                       ; 00488c48 | = "Invalid bitsPerPixel!" | s_Invalid_bitsPerPixel_00621e5e = Invalid bitsPerPixel!
    MOV dword ptr [0x02f0ca48],EDX      ; 00488c4d | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 00488c53 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00488c59 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
