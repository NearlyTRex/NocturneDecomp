...
section .text
    ...
    MOV EDX,dword ptr [0x02c6d558]      ; 00489ca7 | g_CurrentFont
    TEST EDX,EDX                        ; 00489cad
    JZ 0x00489cbf                       ; 00489caf
        ;   XREF to: 00489cbf (CONDITIONAL_JUMP)  ; LAB_00489cbf
    PUSH EAX                            ; 00489cb1
    PUSH EDX                            ; 00489cb2
    ...
    PUSH EAX                            ; 00489cca
    CALL engine_2d.c_getStringWidth_FUN_004018a0 ; 00489ccb
