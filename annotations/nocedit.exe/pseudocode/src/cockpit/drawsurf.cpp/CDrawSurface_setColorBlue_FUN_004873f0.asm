...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl cockpit_drawsurf_cpp_CDrawSurface_setColorBlue_FUN_004873f0(void)
;
;
; Called Functions:
...
section .text
    ...
    PUSH 0x0                            ; 004873f5
    PUSH 0x0                            ; 004873f7
    CALL cockpit_drawsurf.cpp_CDrawSurface_setColorRGB_FUN_00487220 ; 004873f9
