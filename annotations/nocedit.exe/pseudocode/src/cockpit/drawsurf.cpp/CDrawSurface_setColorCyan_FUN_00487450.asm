...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl cockpit_drawsurf_cpp_CDrawSurface_setColorCyan_FUN_00487450(void)
;
;
; Called Functions:
...
section .text
    ...
    PUSH 0xff                           ; 00487455
    PUSH 0x0                            ; 0048745a
    CALL cockpit_drawsurf.cpp_CDrawSurface_setColorRGB_FUN_00487220 ; 0048745c
