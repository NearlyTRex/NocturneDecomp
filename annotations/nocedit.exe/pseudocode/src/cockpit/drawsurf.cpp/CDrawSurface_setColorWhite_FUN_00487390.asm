...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl cockpit_drawsurf_cpp_CDrawSurface_setColorWhite_FUN_00487390(void)
;
;
; Called Functions:
...
section .text
    ...
    PUSH 0xff                           ; 00487395
    PUSH 0xff                           ; 0048739a
    CALL cockpit_drawsurf.cpp_CDrawSurface_setColorRGB_FUN_00487220 ; 0048739f
