...
;                               FUNCTION
; *****************************************************************************
; __cdecl char cockpit_drawsurf.cpp_computeCohenSutherlandOutcode_FUN_00487de0(int point_x, int point_y, int clip_left, int clip_top, int clip_right, int clip_bottom)
;
; Parameters:
