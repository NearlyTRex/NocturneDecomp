...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl cockpit_drawsurf_cpp_CDrawSurface_setColorMagenta_FUN_00487430(void)
;
;
; Called Functions:
...
section .text
    ...
    PUSH 0x0                            ; 00487435
    PUSH 0xff                           ; 00487437
    CALL cockpit_drawsurf.cpp_CDrawSurface_setColorRGB_FUN_00487220 ; 0048743c
