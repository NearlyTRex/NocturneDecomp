...
;                               FUNCTION
; *****************************************************************************
; __cdecl CDrawSurface * __cdecl cockpit_drawsurf_cpp_CDrawSurface_ctor_FUN_00486e70(CDrawSurface *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00486e70
        ;   Label: cockpit_drawsurf.cpp_CDrawSurface_ctor_FUN_00486e70
