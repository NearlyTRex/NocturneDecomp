...
;                               FUNCTION
; *****************************************************************************
; __cdecl void cockpit_drawsurf.cpp_CDrawSurface_drawClosedPolyline_FUN_00489090(CDrawSurface * this_ptr, int point_count, CVector2i * points)
;
; Parameters:
...
section .text
    ...
    JLE 0x004890d0                      ; 004890a2 | LAB_004890d0
    ...
    CALL cockpit_drawsurf.cpp_CDrawSurface_drawClippedLine_FUN_00487990 ; 004890c0 | void cockpit_drawsurf.cpp_CDrawSurface_drawClippedLine_FUN_00487990(CDrawSurface * this_ptr, int x1, int y1, int x2, ...)
        ;   XREF to: 00487990 (UNCONDITIONAL_CALL)
    MOV EAX,EBX                         ; 004890c5
    INC EBX                             ; 004890c7
    ADD ESP,0x14                        ; 004890c8
    CMP EBX,EDI                         ; 004890cb
    JL 0x004890a7                       ; 004890cd | LAB_004890a7
