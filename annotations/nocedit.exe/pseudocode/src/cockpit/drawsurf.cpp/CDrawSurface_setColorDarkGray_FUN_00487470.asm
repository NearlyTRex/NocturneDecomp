...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl cockpit_drawsurf_cpp_CDrawSurface_setColorDarkGray_FUN_00487470(void)
;
;
; Called Functions:
...
section .text
    ...
    PUSH 0x40                           ; 00487472
    PUSH 0x40                           ; 00487474
    CALL cockpit_drawsurf.cpp_CDrawSurface_setColorRGB_FUN_00487220 ; 00487476
