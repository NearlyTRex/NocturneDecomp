...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl cockpit_drawsurf_cpp_CDrawSurface_fillPoly_FUN_00488cd0 (CDrawSurface *this_ptr,int vertex_count,SPoint2i *vertices)
;
; Parameters:
...
section .text
    ...
    JL 0x00488f5b                       ; 00488ce4
        ;   XREF to: 00488f5b (CONDITIONAL_JUMP)  ; LAB_00488f5b
    ...
    JLE 0x00488d95                      ; 00488cff
        ;   XREF to: 00488d95 (CONDITIONAL_JUMP)  ; LAB_00488d95
    MOV EAX,dword ptr [ESP + 0xe8]      ; 00488d05
    MOV EDI,0x2c6d2d0                   ; 00488d0c | g_GlobalEdgeTable
    ...
    JNZ 0x00488f66                      ; 00488d62
        ;   XREF to: 00488f66 (CONDITIONAL_JUMP)  ; LAB_00488f66
    ...
    JL 0x00488d18                       ; 00488d93
        ;   XREF to: 00488d18 (CONDITIONAL_JUMP)  ; LAB_00488d18
    MOV ECX,dword ptr [ESP + 0xbc]      ; 00488d95
        ;   Label: LAB_00488d95
    CMP ECX,0x2                         ; 00488d9c
    JL 0x00488f5b                       ; 00488d9f
        ;   XREF to: 00488f5b (CONDITIONAL_JUMP)  ; LAB_00488f5b
    LEA EBX,[ECX + -0x1]                ; 00488da5
    TEST EBX,EBX                        ; 00488da8
    JLE 0x00488e01                      ; 00488daa
        ;   XREF to: 00488e01 (CONDITIONAL_JUMP)  ; LAB_00488e01
    JLE 0x00488dfc                      ; 00488dac
        ;   XREF to: 00488dfc (CONDITIONAL_JUMP)  ; LAB_00488dfc
        ;   Label: LAB_00488dac
    MOV ECX,EBX                         ; 00488dae
    XOR EAX,EAX                         ; 00488db0
    SHL ECX,0x4                         ; 00488db2
    MOV EDI,dword ptr [EAX + 0x2c6d2e0] ; 00488db5 | g_GlobalEdgeTable[1].x_start | g_GlobalEdgeTable[2].x_start
        ;   Label: LAB_00488db5
    CMP EDI,dword ptr [EAX + 0x2c6d2d0] ; 00488dbb | g_GlobalEdgeTable | g_GlobalEdgeTable[1].x_start
    JGE 0x00488df5                      ; 00488dc1
        ;   XREF to: 00488df5 (CONDITIONAL_JUMP)  ; LAB_00488df5
    LEA EDI,[ESP + 0xa0]                ; 00488dc3
    LEA ESI,[EAX + 0x2c6d2d0]           ; 00488dca | g_GlobalEdgeTable
    MOVSD ES:EDI,ESI                    ; 00488dd0 | g_GlobalEdgeTable | g_GlobalEdgeTable[1].x_start
    MOVSD ES:EDI,ESI                    ; 00488dd1 | g_GlobalEdgeTable[0].y_start | g_GlobalEdgeTable[1].y_start
    MOVSD ES:EDI,ESI                    ; 00488dd2 | g_GlobalEdgeTable[0].x_fixed_point | g_GlobalEdgeTable[1].x_fixed_point
    MOVSD ES:EDI,ESI                    ; 00488dd3 | g_GlobalEdgeTable[0].x_increment | g_GlobalEdgeTable[1].x_increment
    LEA EDI,[EAX + 0x2c6d2d0]           ; 00488dd4 | g_GlobalEdgeTable
    LEA ESI,[EAX + 0x2c6d2e0]           ; 00488dda | g_GlobalEdgeTable[1].x_start
    MOVSD ES:EDI,ESI                    ; 00488de0 | g_GlobalEdgeTable[1].x_start
    MOVSD ES:EDI,ESI                    ; 00488de1 | g_GlobalEdgeTable[1].y_start | g_GlobalEdgeTable[0].y_start
    MOVSD ES:EDI,ESI                    ; 00488de2 | g_GlobalEdgeTable[1].x_fixed_point | g_GlobalEdgeTable[0].x_fixed_point
    MOVSD ES:EDI,ESI                    ; 00488de3 | g_GlobalEdgeTable[1].x_increment | g_GlobalEdgeTable[0].x_increment
    ...
    JL 0x00488db5                       ; 00488dfa
        ;   XREF to: 00488db5 (CONDITIONAL_JUMP)  ; LAB_00488db5
    DEC EBX                             ; 00488dfc
        ;   Label: LAB_00488dfc
    TEST EBX,EBX                        ; 00488dfd
    JG 0x00488dac                       ; 00488dff
        ;   XREF to: 00488dac (CONDITIONAL_JUMP)  ; LAB_00488dac
    MOV ESI,dword ptr [ESP + 0xbc]      ; 00488e01
        ;   Label: LAB_00488e01
    MOV EAX,[0x02c6d2d0]                ; 00488e08 | g_GlobalEdgeTable
    XOR EDI,EDI                         ; 00488e0d
    XOR EBP,EBP                         ; 00488e0f
    MOV dword ptr [ESP + 0xc8],EAX      ; 00488e11
    TEST ESI,ESI                        ; 00488e18
    JLE 0x00488f5b                      ; 00488e1a
        ;   XREF to: 00488f5b (CONDITIONAL_JUMP)  ; LAB_00488f5b
    ...
    CMP EBP,dword ptr [ESP + 0xbc]      ; 00488e2c
        ;   Label: LAB_00488e2c
    JL 0x00489048                       ; 00488e33
        ;   XREF to: 00489048 (CONDITIONAL_JUMP)  ; LAB_00489048
    ...
    JLE 0x00488e8a                      ; 00488e53
        ;   XREF to: 00488e8a (CONDITIONAL_JUMP)  ; LAB_00488e8a
    ...
    JLE 0x00488e83                      ; 00488e6e
        ;   XREF to: 00488e83 (CONDITIONAL_JUMP)  ; LAB_00488e83
    ...
    JL 0x00488e55                       ; 00488e88
        ;   XREF to: 00488e55 (CONDITIONAL_JUMP)  ; LAB_00488e55
    TEST ESI,ESI                        ; 00488e8a
        ;   Label: LAB_00488e8a
    JNZ 0x00488e43                      ; 00488e8c
        ;   XREF to: 00488e43 (CONDITIONAL_JUMP)  ; LAB_00488e43
    CMP EDI,0x1                         ; 00488e8e
    JLE 0x00488eee                      ; 00488e91
        ;   XREF to: 00488eee (CONDITIONAL_JUMP)  ; LAB_00488eee
    ...
    CALL cockpit_drawsurf.cpp_CDrawSurface_drawHorizontalLine_FUN_00488110 ; 00488ee2
    ...
    JL 0x00488e9f                       ; 00488eec
        ;   XREF to: 00488e9f (CONDITIONAL_JUMP)  ; LAB_00488e9f
    ...
    JLE 0x00488f46                      ; 00488f01
        ;   XREF to: 00488f46 (CONDITIONAL_JUMP)  ; LAB_00488f46
    XOR ESI,ESI                         ; 00488f03
    MOV EAX,dword ptr [ESP + ESI*0x1]   ; 00488f05
        ;   Label: LAB_00488f05
    SHL EAX,0x4                         ; 00488f08
    ADD EAX,0x2c6d2d0                   ; 00488f0b | g_GlobalEdgeTable
    ...
    JL 0x0048907d                       ; 00488f1d
        ;   XREF to: 0048907d (CONDITIONAL_JUMP)  ; LAB_0048907d
    DEC EDI                             ; 00488f23
    ...
    PUSH EAX                            ; 00488f39
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 00488f3a
        ;   XREF to: 005fe5e0 (UNCONDITIONAL_CALL)  ; void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
    ADD ESP,0xc                         ; 00488f3f
    CMP EBX,EDI                         ; 00488f42
        ;   Label: LAB_00488f42
    JL 0x00488f05                       ; 00488f44
        ;   XREF to: 00488f05 (CONDITIONAL_JUMP)  ; LAB_00488f05
    TEST EDI,EDI                        ; 00488f46
        ;   Label: LAB_00488f46
    JG 0x00488e2c                       ; 00488f48
        ;   XREF to: 00488e2c (CONDITIONAL_JUMP)  ; LAB_00488e2c
    CMP EBP,dword ptr [ESP + 0xbc]      ; 00488f4e
    JL 0x00488e20                       ; 00488f55
        ;   XREF to: 00488e20 (CONDITIONAL_JUMP)  ; LAB_00488e20
    ...
    POP EBX                             ; 00488f64
    RET                                 ; 00488f65
    JLE 0x00488f7e                      ; 00488f66
        ;   XREF to: 00488f7e (CONDITIONAL_JUMP)  ; LAB_00488f7e
        ;   Label: LAB_00488f66
    ...
    JL 0x00488d68                       ; 00488f88
        ;   XREF to: 00488d68 (CONDITIONAL_JUMP)  ; LAB_00488d68
    CMP ESI,dword ptr [EAX + 0x1c]      ; 00488f8e
    JG 0x00488d68                       ; 00488f91
        ;   XREF to: 00488d68 (CONDITIONAL_JUMP)  ; LAB_00488d68
    CMP dword ptr [ESP + 0xbc],0x28     ; 00488f97
    JL 0x00488fc3                       ; 00488f9f
        ;   XREF to: 00488fc3 (CONDITIONAL_JUMP)  ; LAB_00488fc3
    MOV EAX,0x621e74                    ; 00488fa1 | = "..\\cockpit\\drawsurf.cpp"
    MOV EDX,0x578                       ; 00488fa6
    PUSH 0x621e8c                       ; 00488fab | = "CDrawSurface::fillPoly - too many edges!"
    MOV [0x02f0ca48],EAX                ; 00488fb0 | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 00488fb5 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00488fbb
    ...
    MOV dword ptr [EDI],ESI             ; 00488fef | g_GlobalEdgeTable
    IMUL EDX                            ; 00488ff1
    IDIV EBX                            ; 00488ff3
    MOV dword ptr [ECX + 0xc],EAX       ; 00488ff5 | g_GlobalEdgeTable[0].x_increment
    MOV EDX,dword ptr [ESP + 0xe0]      ; 00488ff8
    MOV EAX,dword ptr [ECX]             ; 00488fff | g_GlobalEdgeTable
    MOV EBX,dword ptr [EDX + 0x14]      ; 00489001
    ADD EDI,0x10                        ; 00489004
    CMP EAX,EBX                         ; 00489007
    JGE 0x0048902b                      ; 00489009
        ;   XREF to: 0048902b (CONDITIONAL_JUMP)  ; LAB_0048902b
    MOV EAX,EBX                         ; 0048900b
    MOV ESI,dword ptr [ECX]             ; 0048900d | g_GlobalEdgeTable
    ...
    MOV dword ptr [ECX],EAX             ; 00489029 | g_GlobalEdgeTable
    ...
    JLE 0x00488d68                      ; 0048903a
        ;   XREF to: 00488d68 (CONDITIONAL_JUMP)  ; LAB_00488d68
    MOV dword ptr [ECX + 0x4],EBX       ; 00489040 | g_GlobalEdgeTable[0].y_start
    JMP 0x00488d68                      ; 00489043
        ;   XREF to: 00488d68 (UNCONDITIONAL_JUMP)  ; LAB_00488d68
    MOV EAX,dword ptr [ESP + 0xc4]      ; 00489048
        ;   Label: LAB_00489048
    MOV ECX,dword ptr [ESP + 0xc8]      ; 0048904f
    CMP ECX,dword ptr [EAX + 0x2c6d2d0] ; 00489056 | g_GlobalEdgeTable
    JL 0x00488e39                       ; 0048905c
        ;   XREF to: 00488e39 (CONDITIONAL_JUMP)  ; LAB_00488e39
    ...
    JMP 0x00488e2c                      ; 00489078
        ;   XREF to: 00488e2c (UNCONDITIONAL_JUMP)  ; LAB_00488e2c
    ...
    JMP 0x00488f42                      ; 00489089
        ;   XREF to: 00488f42 (UNCONDITIONAL_JUMP)  ; LAB_00488f42
