...
;                               FUNCTION
; *****************************************************************************
; __cdecl void cockpit_drawsurf.cpp_CDrawSurface_drawVerticalLine_FUN_00488230(CDrawSurface * this_ptr, int x, int start_y, int end_y)
;
; Parameters:
...
section .text
    ...
    JNZ 0x004883b6                      ; 0048829c | LAB_004883b6
        ;   XREF to: 004883b6 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x0067939c]      ; 004882a2 | int g_BitsPerPixel
    CMP ECX,0x10                        ; 004882a8
    JNC 0x0048833e                      ; 004882ab | LAB_0048833e
        ;   XREF to: 0048833e (CONDITIONAL_JUMP)
    CMP ECX,0x8                         ; 004882b1
    JNZ 0x00488313                      ; 004882b4 | LAB_00488313
        ;   XREF to: 00488313 (CONDITIONAL_JUMP)
    MOV EDI,EBX                         ; 004882b6
    MOV CL,byte ptr [0x02c6d550]        ; 004882b8 | int g_CurrentDrawColor
        ;   Label: LAB_004882b8
    MOV EBX,dword ptr [EDX + 0x2cf6a9c] ; 004882be | void *[1024] g_ScreenBufferArray
    ADD EDX,0x4                         ; 004882c4
    INC EAX                             ; 004882c7
    MOV byte ptr [ESI + EBX*0x1],CL     ; 004882c8
    CMP EDX,EDI                         ; 004882cb
    JLE 0x004882b8                      ; 004882cd | LAB_004882b8
    ...
    MOV ESI,EBX                         ; 004882d8
        ;   Label: LAB_004882d8
    MOV BX,word ptr [0x02c6d550]        ; 004882da | int g_CurrentDrawColor
        ;   Label: LAB_004882da
    MOV ECX,dword ptr [EDX + 0x2cf6a9c] ; 004882e1 | void *[1024] g_ScreenBufferArray
    ADD EDX,0x4                         ; 004882e7
    INC EAX                             ; 004882ea
    MOV word ptr [ECX + EDI*0x1],BX     ; 004882eb
    CMP EDX,ESI                         ; 004882ef
    JLE 0x004882da                      ; 004882f1 | LAB_004882da
        ;   XREF to: 004882da (CONDITIONAL_JUMP)
    JMP 0x004882d0                      ; 004882f3 | LAB_004882d0
        ;   XREF to: 004882d0 (UNCONDITIONAL_JUMP)
    MOV EDI,dword ptr [ESP]             ; 004882f5
        ;   Label: LAB_004882f5
    MOV ESI,EBX                         ; 004882f8
    MOV EBX,dword ptr [0x02c6d550]      ; 004882fa | int g_CurrentDrawColor
        ;   Label: LAB_004882fa
    MOV ECX,dword ptr [EDX + 0x2cf6a9c] ; 00488300 | void *[1024] g_ScreenBufferArray
    ADD EDX,0x4                         ; 00488306
    INC EAX                             ; 00488309
    MOV dword ptr [ECX + EDI*0x1],EBX   ; 0048830a
    CMP EDX,ESI                         ; 0048830d
    JLE 0x004882fa                      ; 0048830f | LAB_004882fa
        ;   XREF to: 004882fa (CONDITIONAL_JUMP)
    JMP 0x004882d0                      ; 00488311 | LAB_004882d0
        ;   XREF to: 004882d0 (UNCONDITIONAL_JUMP)
    MOV ECX,0x621ddd                    ; 00488313 | = "..\\cockpit\\drawsurf.cpp" | s_cockpit_drawsurf_cpp_00621ddd = ..\cockpit\drawsurf.cpp
        ;   Label: LAB_00488313
    MOV EBX,0x3db                       ; 00488318
    PUSH 0x621df5                       ; 0048831d | = "Invalid bitsPerPixel!" | s_Invalid_bitsPerPixel_00621df5 = Invalid bitsPerPixel!
    MOV dword ptr [0x02f0ca48],ECX      ; 00488322 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 00488328 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0048832e | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    POP EBX                             ; 0048833c
    RET                                 ; 0048833d
    JBE 0x004882d8                      ; 0048833e | LAB_004882d8
        ;   Label: LAB_0048833e
        ;   XREF to: 004882d8 (CONDITIONAL_JUMP)
    CMP ECX,0x20                        ; 00488340
    JZ 0x004882f5                       ; 00488343 | LAB_004882f5
        ;   XREF to: 004882f5 (CONDITIONAL_JUMP)
    JMP 0x00488313                      ; 00488345 | LAB_00488313
        ;   XREF to: 00488313 (UNCONDITIONAL_JUMP)
    MOV EBP,EDI                         ; 00488347
        ;   Label: LAB_00488347
    MOV EDI,EBX                         ; 00488349
    MOV EBX,dword ptr [EDX + 0x2cf6a9c] ; 0048834b | void *[1024] g_ScreenBufferArray
        ;   Label: LAB_0048834b
    XOR ESI,ESI                         ; 00488351
    MOV CL,byte ptr [0x02c6d560]        ; 00488353 | int g_OriginalColorValue
    MOV SI,word ptr [EBX + EBP*0x1]     ; 00488359
    SHR ESI,CL                          ; 0048835d
    MOV ECX,dword ptr [0x02c6d570]      ; 0048835f | int g_PackedPixelColor
    ADD EDX,0x4                         ; 00488365
    AND ESI,ECX                         ; 00488368
    INC EAX                             ; 0048836a
    MOV word ptr [EBX + EBP*0x1],SI     ; 0048836b
    CMP EDX,EDI                         ; 0048836f
    JLE 0x0048834b                      ; 00488371 | LAB_0048834b
    ...
    MOV ESI,dword ptr [EDX + 0x2cf6a9c] ; 00488388 | void *[1024] g_ScreenBufferArray
        ;   Label: LAB_00488388
    ADD ESI,EBP                         ; 0048838e
    MOV CL,byte ptr [0x02c6d560]        ; 00488390 | int g_OriginalColorValue
    MOV EBX,dword ptr [ESI]             ; 00488396
    SHR EBX,CL                          ; 00488398
    MOV ECX,EBX                         ; 0048839a
    MOV EBX,dword ptr [0x02c6d570]      ; 0048839c | int g_PackedPixelColor
    ADD EDX,0x4                         ; 004883a2
    AND ECX,EBX                         ; 004883a5
    INC EAX                             ; 004883a7
    MOV dword ptr [ESI],ECX             ; 004883a8
    CMP EDX,EDI                         ; 004883aa
    JLE 0x00488388                      ; 004883ac | LAB_00488388
    ...
    POP EBX                             ; 004883b4
    RET                                 ; 004883b5
    MOV ECX,dword ptr [0x0067939c]      ; 004883b6 | int g_BitsPerPixel
        ;   Label: LAB_004883b6
    CMP ECX,0x10                        ; 004883bc
    JNC 0x004883cc                      ; 004883bf | LAB_004883cc
        ;   XREF to: 004883cc (CONDITIONAL_JUMP)
    CMP ECX,0x8                         ; 004883c1
    JZ 0x004882d0                       ; 004883c4 | LAB_004882d0
        ;   XREF to: 004882d0 (CONDITIONAL_JUMP)
    JMP 0x004883d7                      ; 004883ca | LAB_004883d7
        ;   XREF to: 004883d7 (UNCONDITIONAL_JUMP)
    JBE 0x00488347                      ; 004883cc | LAB_00488347
        ;   Label: LAB_004883cc
        ;   XREF to: 00488347 (CONDITIONAL_JUMP)
    CMP ECX,0x20                        ; 004883d2
    JZ 0x0048837b                       ; 004883d5 | LAB_0048837b
        ;   XREF to: 0048837b (CONDITIONAL_JUMP)
    MOV EAX,0x621e0b                    ; 004883d7 | = "..\\cockpit\\drawsurf.cpp" | s_cockpit_drawsurf_cpp_00621e0b = ..\cockpit\drawsurf.cpp
        ;   Label: LAB_004883d7
    MOV EDX,0x3fb                       ; 004883dc
    PUSH 0x621e23                       ; 004883e1 | = "Invalid bitsPerPixel!" | s_Invalid_bitsPerPixel_00621e23 = Invalid bitsPerPixel!
    MOV [0x02f0ca48],EAX                ; 004883e6 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 004883eb | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004883f1 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
