      ...
      if (g_UseRGBConversion != 0) {
        if ((uint)g_BitsPerPixel < 0x10) {
          ...
          if ((uint)g_BitsPerPixel < 0x11) {
            do {
              ((ushort *)g_ScreenBufferArray[iVar3])[iVar5] =
                   ((ushort *)g_ScreenBufferArray[iVar3])[iVar5] >>
          ...
          if (g_BitsPerPixel == 0x20) {
            do {
              puVar6 = &((uint *)g_ScreenBufferArray[iVar3])[iVar5];
              iVar3 = iVar3 + 1;
...
LAB_00488313:
        ...
        do {
          ((byte *)g_ScreenBufferArray[iVar3])[iVar5] = (byte)g_CurrentDrawColor;
          iVar3 = iVar3 + 1;
        } while (iVar3 <= iVar4);
      }
      else if ((uint)g_BitsPerPixel < 0x11) {
        do {
          ((ushort *)g_ScreenBufferArray[iVar3])[iVar5] = (ushort)g_CurrentDrawColor;
          iVar3 = iVar3 + 1;
        } while (iVar3 <= iVar4);
      }
      else {
        ...
        do {
          ((int *)g_ScreenBufferArray[iVar3])[iVar5] = g_CurrentDrawColor;
          iVar3 = iVar3 + 1;
        } while (iVar3 <= iVar4);
      }
    }
