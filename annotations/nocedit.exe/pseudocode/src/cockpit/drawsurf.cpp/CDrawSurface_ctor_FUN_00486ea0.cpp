...
// Convention: __cdecl
// Signature: CDrawSurface * __cdecl cockpit_drawsurf_cpp_CDrawSurface_ctor_FUN_00486ea0(CDrawSurface *this_ptr,int x,int y,int width,int height,CDrawSurface *parent_surface)
