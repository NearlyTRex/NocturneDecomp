...
// Convention: __cdecl
// Signature: void __cdecl cockpit_drawsurf_cpp_CDrawSurface_drawTextRightAlignedVariantWrapper_FUN_004894f0(CDrawSurface *this_ptr,int x,int y,char *text)
...
{
  cockpit_drawsurf_cpp_CDrawSurface_drawTextRightAlignedVariant_FUN_004894c0(this_ptr,text,x,y);
  return;
}
