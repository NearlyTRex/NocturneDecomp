...
;                               FUNCTION
; *****************************************************************************
; __cdecl void cockpit_drawsurf.cpp_CDrawSurface_drawCircle_FUN_00487730(CDrawSurface * this_ptr, int center_x, int center_y, int radius)
;
; Parameters:
...
section .text
    ...
    JLE 0x00487794                      ; 0048773a | LAB_00487794
    ...
    JLE 0x00487799                      ; 00487785 | LAB_00487799
    ...
    JLE 0x00487799                      ; 00487792 | LAB_00487799
        ;   XREF to: 00487799 (CONDITIONAL_JUMP)
    POP EBP                             ; 00487794
        ;   Label: LAB_00487794
    POP EDI                             ; 00487795
    ...
    CALL cockpit_drawsurf.cpp_CDrawSurface_drawRectangleOutline_FUN_004878e0 ; 004877d3 | void cockpit_drawsurf.cpp_CDrawSurface_drawRectangleOutline_FUN_004878e0(CDrawSurface * this_ptr, int x, int y, int width, ...)
        ;   XREF to: 004878e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 004877d8
    TEST EBP,EBP                        ; 004877db
    JLE 0x00487794                      ; 004877dd | LAB_00487794
        ;   XREF to: 00487794 (CONDITIONAL_JUMP)
    ...
    JL 0x00487815                       ; 004877ea | LAB_00487815
    ...
    PUSH ECX                            ; 00487806
    CALL cockpit_drawsurf.cpp_CDrawSurface_drawRectangleOutline_FUN_004878e0 ; 00487807 | void cockpit_drawsurf.cpp_CDrawSurface_drawRectangleOutline_FUN_004878e0(CDrawSurface * this_ptr, int x, int y, int width, ...)
        ;   XREF to: 004878e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0048780c
    CMP ESI,EBX                         ; 0048780f
    JGE 0x00487794                      ; 00487811 | LAB_00487794
        ;   XREF to: 00487794 (CONDITIONAL_JUMP)
    JMP 0x004877e4                      ; 00487813 | LAB_004877e4
        ;   XREF to: 004877e4 (UNCONDITIONAL_JUMP)
    ADD EDI,EBP                         ; 00487815
        ;   Label: LAB_00487815
    JMP 0x004877f6                      ; 00487817 | LAB_004877f6
