...
;                               FUNCTION
; *****************************************************************************
; __cdecl int cockpit_drawsurf.cpp_CDrawSurface_clipLine_FUN_00487e20(CDrawSurface * this_ptr, int * x1, int * y1, int * x2, int * y2, int clip_left, int clip_top, int clip_right, int clip_bottom)
;
; Parameters:
...
section .text
    ...
    CMP dword ptr [ESP + 0x38],0x64     ; 00487ef3
        ;   Label: LAB_00487ef3
    JZ 0x004880d3                       ; 00487ef8 | LAB_004880d3
    ...
    JZ 0x00487fc8                       ; 00487f33 | LAB_00487fc8
        ;   XREF to: 00487fc8 (CONDITIONAL_JUMP)
    TEST ESI,ESI                        ; 00487f39
    JZ 0x00487f5d                       ; 00487f3b | LAB_00487f5d
    ...
    CMP dword ptr [ESP + 0x44],0x0      ; 00487f61
        ;   Label: LAB_00487f61
    JZ 0x0048805e                       ; 00487f66 | LAB_0048805e
    ...
    MOV EDX,dword ptr [ESP + 0x78]      ; 00488021
        ;   Label: LAB_00488021
    JMP 0x00487f61                      ; 00488025 | LAB_00487f61
        ;   XREF to: 00487f61 (UNCONDITIONAL_JUMP)
    TEST BL,0x8                         ; 0048802a
        ;   Label: LAB_0048802a
    JZ 0x00487f61                       ; 0048802d | LAB_00487f61
        ;   XREF to: 00487f61 (CONDITIONAL_JUMP)
    TEST ECX,ECX                        ; 00488033
    JZ 0x00488055                       ; 00488035 | LAB_00488055
    ...
    MOV EDX,dword ptr [ESP + 0x70]      ; 00488055
        ;   Label: LAB_00488055
    JMP 0x00487f61                      ; 00488059 | LAB_00487f61
        ;   XREF to: 00487f61 (UNCONDITIONAL_JUMP)
    ...
    JLE 0x00488099                      ; 00488092 | LAB_00488099
    ...
    JL 0x00487ec9                       ; 004880c8 | LAB_00487ec9
        ;   XREF to: 00487ec9 (CONDITIONAL_JUMP)
    JMP 0x00487ef3                      ; 004880ce | LAB_00487ef3
        ;   XREF to: 00487ef3 (UNCONDITIONAL_JUMP)
    MOV EBP,0x621d6e                    ; 004880d3 | = "..\\cockpit\\drawsurf.cpp" | s_cockpit_drawsurf_cpp_00621d6e = ..\cockpit\drawsurf.cpp
        ;   Label: LAB_004880d3
    MOV EAX,0x369                       ; 004880d8
    PUSH 0x621d86                       ; 004880dd | = "2d line clipping exceeded max iterations" | s_s_2d_line_clipping_excee_00621d86 = 2d line clipping exceeded max iterations
    MOV dword ptr [0x02f0ca48],EBP      ; 004880e2 | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 004880e8 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004880ed | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
