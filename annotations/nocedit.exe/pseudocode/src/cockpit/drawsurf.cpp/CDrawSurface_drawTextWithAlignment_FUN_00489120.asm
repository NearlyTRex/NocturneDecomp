...
section .text
    ...
    MOV EDX,dword ptr [0x02d02558]      ; 0048914d | g_ClipLeft
    MOV dword ptr [ESP + 0x4],EDX       ; 00489153
    MOV EDX,dword ptr [0x02d02560]      ; 00489157 | g_ClipRight
    MOV dword ptr [ESP + 0x14],EDX      ; 0048915d
    MOV EDX,dword ptr [0x02d0255c]      ; 00489161 | g_ClipTop
    MOV dword ptr [ESP + 0x8],EDX       ; 00489167
    MOV EDX,dword ptr [0x02d02564]      ; 0048916b | g_ClipBottom
    MOV dword ptr [ESP + 0x10],EDX      ; 00489171
    MOV EDX,dword ptr [EAX + 0x10]      ; 00489175
    MOV dword ptr [0x02d02558],EDX      ; 00489178 | g_ClipLeft
    MOV EDX,dword ptr [EAX + 0x18]      ; 0048917e
    MOV dword ptr [0x02d02560],EDX      ; 00489181 | g_ClipRight
    MOV EDX,dword ptr [EAX + 0x14]      ; 00489187
    MOV EAX,dword ptr [EAX + 0x1c]      ; 0048918a
    MOV [0x02d02564],EAX                ; 0048918d | g_ClipBottom
    ...
    MOV EAX,[0x02c6d558]                ; 004891a1 | g_CurrentFont
    MOV dword ptr [0x02d0255c],EDX      ; 004891a6 | g_ClipTop
    TEST EAX,EAX                        ; 004891ac
    JZ 0x004893ab                       ; 004891ae
        ;   XREF to: 004893ab (CONDITIONAL_JUMP)  ; LAB_004893ab
    CALL engine_font.cpp_getDefaultTextColor_FUN_004ce220 ; 004891b4
        ;   XREF to: 004ce220 (UNCONDITIONAL_CALL)  ; int engine_font.cpp_getDefaultTextColor_FUN_004ce220()
    MOV ECX,dword ptr [0x02c6d550]      ; 004891b9 | g_CurrentDrawColor
    PUSH ECX                            ; 004891bf
    MOV dword ptr [ESP + 0x4],EAX       ; 004891c0
    CALL engine_font.cpp_setDefaultTextColor_FUN_004ce230 ; 004891c4
        ;   XREF to: 004ce230 (UNCONDITIONAL_CALL)  ; void engine_font.cpp_setDefaultTextColor_FUN_004ce230(int text_color)
    ADD ESP,0x4                         ; 004891c9
    CMP dword ptr [ESP + 0x4c],0x7      ; 004891cc
    JA 0x004891f3                       ; 004891d1
        ;   XREF to: 004891f3 (CONDITIONAL_JUMP)  ; default
    MOV EAX,dword ptr [ESP + 0x1c]      ; 004891d3
    JMP dword ptr [EAX + 0x4890d4]      ; 004891d7 | caseD_0 | caseD_1 | caseD_2
        ;   Label: switchD
    PUSH EDI                            ; 004891dd
        ;   Label: caseD_0
    PUSH -0x1                           ; 004891de
    ...
    MOV EAX,dword ptr [ESP]             ; 004891f3
        ;   Label: default
    PUSH EAX                            ; 004891f6
    CALL engine_font.cpp_setDefaultTextColor_FUN_004ce230 ; 004891f7
        ;   XREF to: 004ce230 (UNCONDITIONAL_CALL)  ; void engine_font.cpp_setDefaultTextColor_FUN_004ce230(int text_color)
    ADD ESP,0x4                         ; 004891fc
        ;   Label: LAB_004891fc
    MOV EAX,dword ptr [ESP + 0x4]       ; 004891ff
    MOV [0x02d02558],EAX                ; 00489203 | g_ClipLeft
    MOV EAX,dword ptr [ESP + 0x14]      ; 00489208
    MOV [0x02d02560],EAX                ; 0048920c | g_ClipRight
    MOV EAX,dword ptr [ESP + 0x8]       ; 00489211
    MOV [0x02d0255c],EAX                ; 00489215 | g_ClipTop
    MOV EAX,dword ptr [ESP + 0x10]      ; 0048921a
    MOV [0x02d02564],EAX                ; 0048921e | g_ClipBottom
    ...
    PUSH EBX                            ; 00489271
    PUSH ESI                            ; 00489272
    JMP 0x004891ea                      ; 00489273
        ;   XREF to: 004891ea (UNCONDITIONAL_JUMP)  ; LAB_004891ea
    MOV EBP,dword ptr [0x02c6d558]      ; 00489278 | g_CurrentFont
        ;   Label: caseD_4
    ...
    ADD EBX,EBP                         ; 004892c1
        ;   Label: caseD_6
    MOV EBP,dword ptr [0x02c6d558]      ; 004892c3 | g_CurrentFont
    ...
    PUSH EAX                            ; 004892e2
    PUSH ESI                            ; 004892e3
    JMP 0x004891ea                      ; 004892e4
        ;   XREF to: 004891ea (UNCONDITIONAL_JUMP)  ; LAB_004891ea
    ADD EBX,EBP                         ; 004892e9
        ;   Label: caseD_7
    MOV EBP,dword ptr [0x02c6d558]      ; 004892eb | g_CurrentFont
    INC EBX                             ; 004892f1
    ...
    MOV EAX,dword ptr [ESP + 0x18]      ; 00489341
        ;   Label: default
    PUSH EAX                            ; 00489345
    CALL engine_2d.c_setTextColor_FUN_00402840 ; 00489346
    ...
    PUSH EDX                            ; 00489352
    CALL engine_2d.c_setTextWrapEnabled_FUN_00402800 ; 00489353
        ;   XREF to: 00402800 (UNCONDITIONAL_CALL)  ; void engine_2d.c_setTextWrapEnabled_FUN_00402800(int enabled)
    JMP 0x004891fc                      ; 00489358
        ;   XREF to: 004891fc (UNCONDITIONAL_JUMP)  ; LAB_004891fc
    ...
    PUSH EAX                            ; 00489389
    JMP 0x00489337                      ; 0048938a
        ;   XREF to: 00489337 (UNCONDITIONAL_JUMP)  ; LAB_00489337
    ...
    JMP 0x00489341                      ; 004893a9
        ;   XREF to: 00489341 (UNCONDITIONAL_JUMP)  ; default
    CALL engine_2d.c_getTextWrapEnabled_FUN_004027f0 ; 004893ab
        ;   XREF to: 004027f0 (UNCONDITIONAL_CALL)  ; int engine_2d.c_getTextWrapEnabled_FUN_004027f0()
        ;   Label: LAB_004893ab
    MOV dword ptr [ESP + 0xc],EAX       ; 004893b0
    CALL engine_2d.c_getTextColor_FUN_00402830 ; 004893b4
        ;   XREF to: 00402830 (UNCONDITIONAL_CALL)  ; int engine_2d.c_getTextColor_FUN_00402830()
    MOV dword ptr [ESP + 0x18],EAX      ; 004893b9
    CALL engine_2d.c_disableTextWrap_FUN_00402820 ; 004893bd
        ;   XREF to: 00402820 (UNCONDITIONAL_CALL)  ; void engine_2d.c_disableTextWrap_FUN_00402820()
    MOV EDX,dword ptr [0x02c6d554]      ; 004893c2 | g_PaletteColorIndex
    PUSH EDX                            ; 004893c8
    CALL engine_2d.c_setTextColor_FUN_00402840 ; 004893c9
        ;   XREF to: 00402840 (UNCONDITIONAL_CALL)  ; void engine_2d.c_setTextColor_FUN_00402840(int color)
    ADD ESP,0x4                         ; 004893ce
    CMP dword ptr [ESP + 0x4c],0x7      ; 004893d1
    JA 0x00489341                       ; 004893d6
        ;   XREF to: 00489341 (CONDITIONAL_JUMP)  ; default
    MOV EAX,dword ptr [ESP + 0x1c]      ; 004893dc
    JMP dword ptr [EAX + 0x4890f4]      ; 004893e0 | caseD_1 | caseD_2 | caseD_3
        ;   Label: switchD
