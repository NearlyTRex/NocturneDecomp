...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl cockpit_drawsurf_cpp_CDrawSurface_drawTextCenteredInAreaWrapper_FUN_00489910 (CDrawSurface *this_ptr,int x,int y,int height,char *text)
;
; Parameters:
