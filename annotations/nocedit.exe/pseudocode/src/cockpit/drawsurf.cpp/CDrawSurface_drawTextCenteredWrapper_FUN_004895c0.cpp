...
// Convention: __cdecl
// Signature: void __cdecl cockpit_drawsurf_cpp_CDrawSurface_drawTextCenteredWrapper_FUN_004895c0(CDrawSurface *this_ptr,int x,int y,char *text)
...
{
  cockpit_drawsurf_cpp_CDrawSurface_drawTextCentered_FUN_00489590(this_ptr,text,x,y);
  return;
}
