...
section .text
    ...
    XOR EDX,EDX                         ; 004876ca
        ;   Label: LAB_004876ca
    MOV CL,byte ptr [0x02c6d560]        ; 004876cc | int g_OriginalColorValue
    MOV DX,word ptr [EAX]               ; 004876d2
    SHR EDX,CL                          ; 004876d5
    AND EDX,EDI                         ; 004876d7
    MOV word ptr [EAX],DX               ; 004876d9
    MOV dword ptr [0x02c6d570],EDI      ; 004876dc | int g_PackedPixelColor
    POP EDI                             ; 004876e2
    POP ESI                             ; 004876e3
    POP EBX                             ; 004876e4
    RET                                 ; 004876e5
    CMP ECX,0x20                        ; 004876e6
        ;   Label: LAB_004876e6
    JNZ 0x004876c0                      ; 004876e9 | LAB_004876c0
        ;   XREF to: 004876c0 (CONDITIONAL_JUMP)
    LEA EAX,[EDX*0x4 + 0x0]             ; 004876eb
    MOV ECX,dword ptr [EBX + 0x2cf6a9c] ; 004876f2 | void *[1024] g_ScreenBufferArray
    MOV EBX,EDX                         ; 004876f8
    ADD EAX,ECX                         ; 004876fa
    CMP EDX,ESI                         ; 004876fc
    JG 0x004876c0                       ; 004876fe | LAB_004876c0
        ;   XREF to: 004876c0 (CONDITIONAL_JUMP)
    MOV CL,byte ptr [0x02c6d560]        ; 00487700 | int g_OriginalColorValue
        ;   Label: LAB_00487700
    ...
    JLE 0x00487700                      ; 00487715 | LAB_00487700
        ;   XREF to: 00487700 (CONDITIONAL_JUMP)
    MOV dword ptr [0x02c6d570],EDI      ; 00487717 | int g_PackedPixelColor
    POP EDI                             ; 0048771d
    POP ESI                             ; 0048771e
    POP EBX                             ; 0048771f
    RET                                 ; 00487720
