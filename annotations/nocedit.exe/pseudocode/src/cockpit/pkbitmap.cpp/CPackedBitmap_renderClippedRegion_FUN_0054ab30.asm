...
section .text
    ...
    JZ 0x0054ab4b                       ; 0054ab43 | LAB_0054ab4b
        ;   XREF to: 0054ab4b (CONDITIONAL_JUMP)
    CMP dword ptr [EAX + 0x14],0x0      ; 0054ab45
    JNZ 0x0054ab53                      ; 0054ab49 | LAB_0054ab53
    ...
    MOV ESI,dword ptr [0x0067939c]      ; 0054ab5b | int g_BitsPerPixel
    ...
    CALL cockpit_ckptutil.c_getColorConversionFunction_FUN_00431760 ; 0054ab76 | ColorConversionFunc * cockpit_ckptutil.c_getColorConversionFunction_FUN_00431760()
    ...
    JLE 0x0054ac0c                      ; 0054abe6 | LAB_0054ac0c
    ...
    JG 0x0054ab4b                       ; 0054ac04 | LAB_0054ab4b
        ;   XREF to: 0054ab4b (CONDITIONAL_JUMP)
    JMP 0x0054aba0                      ; 0054ac0a | LAB_0054aba0
    ...
    JGE 0x0054ac2d                      ; 0054ac25 | LAB_0054ac2d
        ;   XREF to: 0054ac2d (CONDITIONAL_JUMP)
    CMP EBX,dword ptr [ESP + 0x18]      ; 0054ac27
    JMP 0x0054abda                      ; 0054ac2b | LAB_0054abda
        ;   XREF to: 0054abda (UNCONDITIONAL_JUMP)
    CMP EAX,EDX                         ; 0054ac2d
        ;   Label: LAB_0054ac2d
    JL 0x0054ac5f                       ; 0054ac2f | LAB_0054ac5f
        ;   XREF to: 0054ac5f (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x0067939c]      ; 0054ac31 | int g_BitsPerPixel
        ;   Label: LAB_0054ac31
    ...
    JLE 0x0054ac6b                      ; 0054ac4d | LAB_0054ac6b
    ...
    JMP 0x0054abe8                      ; 0054ac5d | LAB_0054abe8
    ...
    JMP 0x0054ac31                      ; 0054ac69 | LAB_0054ac31
    ...
    JMP 0x0054ac31                      ; 0054aca1 | LAB_0054ac31
        ;   XREF to: 0054ac31 (UNCONDITIONAL_JUMP)
