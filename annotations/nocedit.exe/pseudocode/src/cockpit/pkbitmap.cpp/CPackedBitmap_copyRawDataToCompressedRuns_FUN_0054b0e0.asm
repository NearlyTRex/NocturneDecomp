...
;                               FUNCTION
; *****************************************************************************
; __cdecl void cockpit_pkbitmap.cpp_CPackedBitmap_copyRawDataToCompressedRuns_FUN_0054b0e0(CPackedBitmap * this_ptr, uchar * raw_bitmap_data, int row_stride)
;
; Parameters:
...
section .text
    ...
    JZ 0x0054b177                       ; 0054b0f0 | LAB_0054b177
    ...
    JNC 0x0054b14c                      ; 0054b11e | LAB_0054b14c
    ...
    JC 0x0054b120                       ; 0054b14a | LAB_0054b120
    ...
    JL 0x0054b0ff                       ; 0054b16d | LAB_0054b0ff
    ...
    JMP 0x0054b0f6                      ; 0054b182 | LAB_0054b0f6
