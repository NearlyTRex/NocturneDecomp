...
;                               FUNCTION
; *****************************************************************************
; __cdecl void cockpit_pkbitmap.cpp_CPackedBitmap_reloadFromBitmapFile_FUN_0054b000(CPackedBitmap * this_ptr, char * filename, int width, int height, int transparency_color, int stride, int apply_palette_flag)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0054b00c
    CALL cockpit_pkbitmap.cpp_CPackedBitmap_free_FUN_0054a8e0 ; 0054b00d | void cockpit_pkbitmap.cpp_CPackedBitmap_free_FUN_0054a8e0(CPackedBitmap * this_ptr)
        ;   XREF to: 0054a8e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0054b012
    MOV EDX,dword ptr [ESP + 0x18]      ; 0054b015
    PUSH EDX                            ; 0054b019
    PUSH EBX                            ; 0054b01a
    CALL cockpit_pkbitmap.cpp_CPackedBitmap_setFilename_FUN_0054a990 ; 0054b01b | void cockpit_pkbitmap.cpp_CPackedBitmap_setFilename_FUN_0054a990(CPackedBitmap * this_ptr, char * filename)
    ...
    PUSH 0x0                            ; 0054b02b
    PUSH EBX                            ; 0054b02d
    CALL cockpit_ckptutil.c_readBitmapFile_FUN_00431870 ; 0054b02e | void * cockpit_ckptutil.c_readBitmapFile_FUN_00431870(char * filename, void * buffer, int size)
    ...
    CALL cockpit_pkbitmap.cpp_CPackedBitmap_load_FUN_0054b190 ; 0054b046 | void cockpit_pkbitmap.cpp_CPackedBitmap_load_FUN_0054b190(CPackedBitmap * this_ptr, uchar * bitmap_data, int width, int height, ...)
        ;   XREF to: 0054b190 (UNCONDITIONAL_CALL)
    ADD ESP,0x18                        ; 0054b04b
    PUSH 0x2fb                          ; 0054b04e
    PUSH 0x63ef51                       ; 0054b053 | = "..\\cockpit\\pkbitmap.cpp" | s_cockpit_pkbitmap_cpp_0063ef51 = ..\cockpit\pkbitmap.cpp
    PUSH ESI                            ; 0054b058
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 0054b059 | void shape_memdbg.cpp_debugFree_FUN_0050f460(void * ptr, char * filename, int line_number)
        ;   XREF to: 0050f460 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0054b05e
    CMP dword ptr [ESP + 0x28],0x0      ; 0054b061
    JNZ 0x0054b06d                      ; 0054b066 | LAB_0054b06d
    ...
    PUSH EBX                            ; 0054b06d
        ;   Label: LAB_0054b06d
    CALL cockpit_pkbitmap.cpp_CPackedBitmap_applyPalette_FUN_0054b4a0 ; 0054b06e | void cockpit_pkbitmap.cpp_CPackedBitmap_applyPalette_FUN_0054b4a0(CPackedBitmap * this_ptr)
