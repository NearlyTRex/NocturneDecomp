...
section .text
    ...
    CALL cockpit_pkbitmap.cpp_parsePBGFile_FUN_0054b9b0 ; 0054bb8f
        ;   XREF to: 0054b9b0 (UNCONDITIONAL_CALL)  ; CPackedBitmap * cockpit_pkbitmap.cpp_parsePBGFile_FUN_0054b9b0(CPackedBitmapSet * bitmap_set_ptr, _FILE * file_handle, int frames_per_bitmap, int skip_data_load, ...)
