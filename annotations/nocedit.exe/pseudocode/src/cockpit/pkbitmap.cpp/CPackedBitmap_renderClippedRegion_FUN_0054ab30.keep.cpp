  ...
  if ((this_ptr->row_offsets != (int *)0x0) && (this_ptr->packed_data != (ushort *)0x0)) {
    ...
    do {
      puVar9 = (ushort *)((char *)this_ptr->packed_data +
                          this_ptr->row_offsets[local_20]);
      puVar7 = (ushort *)((char *)this_ptr->packed_data +
                          this_ptr->row_offsets[local_20 + 1]);
      screen_row = (char *)g_ScreenBufferArray[local_24];
      do {
      ...
      while (dest_buffer = (void *)(screen_row + (int)(g_BitsPerPixel * uVar3) / 8 + iVar4 / 8),
            iVar10 <= clip_right) {
