...
;                               FUNCTION
; *****************************************************************************
; __cdecl void cockpit_pkbitmap.cpp_CPackedBitmap_load_FUN_0054b190(CPackedBitmap * this_ptr, uchar * bitmap_data, int width, int height, int stride_bytes, uchar transparency_color)
;
; Parameters:
...
section .text
    ...
    PUSH EBP                            ; 0054b1a1
    CALL cockpit_pkbitmap.cpp_CPackedBitmap_free_FUN_0054a8e0 ; 0054b1a2 | void cockpit_pkbitmap.cpp_CPackedBitmap_free_FUN_0054a8e0(CPackedBitmap * this_ptr)
    ...
    JNZ 0x0054b1d3                      ; 0054b1c7 | LAB_0054b1d3
    ...
    PUSH 0x378                          ; 0054b1d6
    INC EAX                             ; 0054b1db
    PUSH 0x63ef81                       ; 0054b1dc | = "..\\cockpit\\pkbitmap.cpp" | s_cockpit_pkbitmap_cpp_0063ef81 = ..\cockpit\pkbitmap.cpp
    SHL EAX,0x2                         ; 0054b1e1
    PUSH EAX                            ; 0054b1e4
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1f0 ; 0054b1e5 | void * shape_memdbg.cpp_debugAlloc_FUN_0050f1f0(int size, char * filename, int line_number)
        ;   XREF to: 0050f1f0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0054b1ea
    MOV dword ptr [EBP + 0x20],EAX      ; 0054b1ed
    TEST EAX,EAX                        ; 0054b1f0
    JZ 0x0054b39d                       ; 0054b1f2 | LAB_0054b39d
    ...
    JZ 0x0054b3c5                       ; 0054b260 | LAB_0054b3c5
    ...
    JLE 0x0054b315                      ; 0054b2a5 | LAB_0054b315
        ;   XREF to: 0054b315 (CONDITIONAL_JUMP)
    PUSH 0x3ac                          ; 0054b2a7
    PUSH 0x63eff6                       ; 0054b2ac | = "..\\cockpit\\pkbitmap.cpp" | s_cockpit_pkbitmap_cpp_0063eff6 = ..\cockpit\pkbitmap.cpp
    ADD EAX,0x4000                      ; 0054b2b1
    PUSH EAX                            ; 0054b2b6
    MOV dword ptr [ESP + 0x148],EAX     ; 0054b2b7
    MOV EAX,dword ptr [EBP + 0x14]      ; 0054b2be
    PUSH EAX                            ; 0054b2c1
    CALL shape_memdbg.cpp_debugRealloc_FUN_0050f540 ; 0054b2c2 | void * shape_memdbg.cpp_debugRealloc_FUN_0050f540(void * ptr, int new_size, char * filename, int line_number)
        ;   XREF to: 0050f540 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0054b2c7
    MOV dword ptr [EBP + 0x14],EAX      ; 0054b2ca
    TEST EAX,EAX                        ; 0054b2cd
    JNZ 0x0054b315                      ; 0054b2cf | LAB_0054b315
        ;   XREF to: 0054b315 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 0054b2e0
    PUSH EBP                            ; 0054b2e1
    PUSH 0x63f00e                       ; 0054b2e2 | = "Out of memory packing file \"%s\" on ..." | s_Out_of_memory_packing_fi_0063f00e = Out of memory packing file "%s" on row %u trying to get %u bytes
    LEA EAX,[ESP + 0x10]                ; 0054b2e7
    PUSH EAX                            ; 0054b2eb
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0054b2ec | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    MOV EDX,0x63f04f                    ; 0054b2f1 | = "..\\cockpit\\pkbitmap.cpp" | s_cockpit_pkbitmap_cpp_0063f04f = ..\cockpit\pkbitmap.cpp
    ADD ESP,0x14                        ; 0054b2f6
    MOV EAX,ESP                         ; 0054b2f9
    MOV ECX,0x3b2                       ; 0054b2fb
    PUSH EAX                            ; 0054b300
    MOV dword ptr [0x02f0ca48],EDX      ; 0054b301 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 0054b307 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0054b30d | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    CMP EBX,dword ptr [EBP + 0x18]      ; 0054b358
        ;   Label: LAB_0054b358
    JL 0x0054b24a                       ; 0054b35b | LAB_0054b24a
    ...
    JMP 0x0054b21f                      ; 0054b398 | LAB_0054b21f
        ;   XREF to: 0054b21f (UNCONDITIONAL_JUMP)
    MOV EBX,0x63ef99                    ; 0054b39d | = "..\\cockpit\\pkbitmap.cpp" | s_cockpit_pkbitmap_cpp_0063ef99 = ..\cockpit\pkbitmap.cpp
        ;   Label: LAB_0054b39d
    MOV ESI,0x37a                       ; 0054b3a2
    PUSH 0x63efb1                       ; 0054b3a7 | = "Unable to allocate memory for rowOffs..." | s_Unable_to_allocate_memor_0063efb1 = Unable to allocate memory for rowOffset table in CPackedBitmap::load
    MOV dword ptr [0x02f0ca48],EBX      ; 0054b3ac | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 0054b3b2 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0054b3b8 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0054b3bd
    JMP 0x0054b1f8                      ; 0054b3c0 | LAB_0054b1f8
        ;   XREF to: 0054b1f8 (UNCONDITIONAL_JUMP)
    INC EBX                             ; 0054b3c5
        ;   Label: LAB_0054b3c5
    JMP 0x0054b358                      ; 0054b3c6 | LAB_0054b358
        ;   XREF to: 0054b358 (UNCONDITIONAL_JUMP)
    PUSH 0x3d6                          ; 0054b3c8
        ;   Label: LAB_0054b3c8
    PUSH 0x63f067                       ; 0054b3cd | = "..\\cockpit\\pkbitmap.cpp" | s_cockpit_pkbitmap_cpp_0063f067 = ..\cockpit\pkbitmap.cpp
    PUSH ESI                            ; 0054b3d2
    MOV EAX,dword ptr [EBP + 0x14]      ; 0054b3d3
    PUSH EAX                            ; 0054b3d6
    CALL shape_memdbg.cpp_debugRealloc_FUN_0050f540 ; 0054b3d7 | void * shape_memdbg.cpp_debugRealloc_FUN_0050f540(void * ptr, int new_size, char * filename, int line_number)
        ;   XREF to: 0050f540 (UNCONDITIONAL_CALL)
