...
section .text
    ...
    JZ 0x0054ad91                       ; 0054acd0 | LAB_0054ad91
        ;   XREF to: 0054ad91 (CONDITIONAL_JUMP)
    CMP dword ptr [ECX + 0x14],0x0      ; 0054acd6
    JZ 0x0054ad91                       ; 0054acda | LAB_0054ad91
        ;   XREF to: 0054ad91 (CONDITIONAL_JUMP)
    MOV EBP,dword ptr [0x02d02558]      ; 0054ace0 | int g_ClipLeft
    CMP EBX,EBP                         ; 0054ace6
    JGE 0x0054acf4                      ; 0054ace8 | LAB_0054acf4
        ;   XREF to: 0054acf4 (CONDITIONAL_JUMP)
    SUB EBP,EBX                         ; 0054acea
    MOV EBX,dword ptr [0x02d02558]      ; 0054acec | int g_ClipLeft
    ADD EDX,EBP                         ; 0054acf2
    MOV EBP,dword ptr [0x02d0255c]      ; 0054acf4 | int g_ClipTop
        ;   Label: LAB_0054acf4
    CMP ESI,EBP                         ; 0054acfa
    JGE 0x0054ad08                      ; 0054acfc | LAB_0054ad08
        ;   XREF to: 0054ad08 (CONDITIONAL_JUMP)
    SUB EBP,ESI                         ; 0054acfe
    MOV ESI,dword ptr [0x02d0255c]      ; 0054ad00 | int g_ClipTop
    ADD EAX,EBP                         ; 0054ad06
    MOV EBP,dword ptr [ESP + 0x28]      ; 0054ad08
        ;   Label: LAB_0054ad08
    ADD EBP,EBX                         ; 0054ad0c
    SUB EBP,EDX                         ; 0054ad0e
    CMP EBP,dword ptr [0x02d02560]      ; 0054ad10 | int g_ClipRight
    JLE 0x0054ad26                      ; 0054ad16 | LAB_0054ad26
        ;   XREF to: 0054ad26 (CONDITIONAL_JUMP)
    MOV EBP,dword ptr [0x02d02560]      ; 0054ad18 | int g_ClipRight
    ...
    CMP EBP,dword ptr [0x02d02564]      ; 0054ad2b | int g_ClipBottom
    JLE 0x0054ad3d                      ; 0054ad31 | LAB_0054ad3d
        ;   XREF to: 0054ad3d (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [0x02d02564]      ; 0054ad33 | int g_ClipBottom
    SUB EDI,ESI                         ; 0054ad39
    ADD EDI,EAX                         ; 0054ad3b
    MOV EBP,dword ptr [ESP + 0x28]      ; 0054ad3d
        ;   Label: LAB_0054ad3d
    CMP EDX,EBP                         ; 0054ad41
    JG 0x0054ad91                       ; 0054ad43 | LAB_0054ad91
        ;   XREF to: 0054ad91 (CONDITIONAL_JUMP)
    CMP EAX,EDI                         ; 0054ad45
    JG 0x0054ad91                       ; 0054ad47 | LAB_0054ad91
        ;   XREF to: 0054ad91 (CONDITIONAL_JUMP)
    TEST EBP,EBP                        ; 0054ad49
    JLE 0x0054ad91                      ; 0054ad4b | LAB_0054ad91
        ;   XREF to: 0054ad91 (CONDITIONAL_JUMP)
    TEST EDI,EDI                        ; 0054ad4d
    JLE 0x0054ad91                      ; 0054ad4f | LAB_0054ad91
        ;   XREF to: 0054ad91 (CONDITIONAL_JUMP)
    CMP EDX,dword ptr [ECX + 0x18]      ; 0054ad51
    JGE 0x0054ad91                      ; 0054ad54 | LAB_0054ad91
        ;   XREF to: 0054ad91 (CONDITIONAL_JUMP)
    CMP EAX,dword ptr [ECX + 0x1c]      ; 0054ad56
    JGE 0x0054ad91                      ; 0054ad59 | LAB_0054ad91
        ;   XREF to: 0054ad91 (CONDITIONAL_JUMP)
    TEST EDX,EDX                        ; 0054ad5b
    JL 0x0054ad96                       ; 0054ad5d | LAB_0054ad96
        ;   XREF to: 0054ad96 (CONDITIONAL_JUMP)
    TEST EAX,EAX                        ; 0054ad5f
        ;   Label: LAB_0054ad5f
    JL 0x0054ad9c                       ; 0054ad61 | LAB_0054ad9c
        ;   XREF to: 0054ad9c (CONDITIONAL_JUMP)
    MOV EBP,dword ptr [ESP + 0x28]      ; 0054ad63
        ;   Label: LAB_0054ad63
    CMP EBP,dword ptr [ECX + 0x18]      ; 0054ad67
    JL 0x0054ad74                       ; 0054ad6a | LAB_0054ad74
    ...
    JL 0x0054ad7e                       ; 0054ad79 | LAB_0054ad7e
    ...
    PUSH EBX                            ; 0054ad87
    PUSH ECX                            ; 0054ad88
    CALL cockpit_pkbitmap.cpp_CPackedBitmap_renderClippedRegion_FUN_0054ab30 ; 0054ad89 | void cockpit_pkbitmap.cpp_CPackedBitmap_renderClippedRegion_FUN_0054ab30(CPackedBitmap * this_ptr, int dest_x, int dest_y, int clip_left, ...)
