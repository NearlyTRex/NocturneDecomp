...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl cockpit_pkbitmap_cpp_CPackedBitmap_freePackedData_FUN_0054a940(CPackedBitmap *this_ptr)
;
; Parameters:
...
section .text
    ...
    JNZ 0x0054a94e                      ; 0054a94a
        ;   XREF to: 0054a94e (CONDITIONAL_JUMP)  ; LAB_0054a94e
    POP EBX                             ; 0054a94c
    RET                                 ; 0054a94d
    PUSH 0xa4                           ; 0054a94e
        ;   Label: LAB_0054a94e
    PUSH 0x63eee8                       ; 0054a953 | = "..\\cockpit\\pkbitmap.cpp"
    PUSH EDX                            ; 0054a958
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 0054a959
