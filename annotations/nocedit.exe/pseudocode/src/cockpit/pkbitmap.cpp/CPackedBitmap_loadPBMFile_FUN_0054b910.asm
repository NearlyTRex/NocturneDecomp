...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl cockpit_pkbitmap_cpp_CPackedBitmap_loadPBMFile_FUN_0054b910 (CPackedBitmap *this_ptr,int post_load_processing)
;
; Parameters:
...
section .text
    ...
    MOV EAX,dword ptr [ESP + 0x4]       ; 0054b910
        ;   Label: cockpit_pkbitmap.cpp_CPackedBitmap_loadPBMFile_FUN_0054b910
