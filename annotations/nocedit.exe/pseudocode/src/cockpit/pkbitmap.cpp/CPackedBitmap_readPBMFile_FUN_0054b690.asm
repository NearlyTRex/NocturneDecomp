...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl cockpit_pkbitmap_cpp_CPackedBitmap_readPBMFile_FUN_0054b690(CPackedBitmap *this_ptr,_FILE *file_handle,int skip_data_load)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0054b69f
    CALL cockpit_pkbitmap.cpp_CPackedBitmap_free_FUN_0054a8e0 ; 0054b6a0
    ...
    PUSH EAX                            ; 0054b6b1
    CALL crt_stdio.c_fread_FUN_005fd990 ; 0054b6b2
    ...
    JNZ 0x0054b71f                      ; 0054b6bd
        ;   XREF to: 0054b71f (CONDITIONAL_JUMP)  ; LAB_0054b71f
    MOV ECX,0x4                         ; 0054b6bf
    MOV EDI,0x680c9c                    ; 0054b6c4 | = "PBM\032PBG\032"
    MOV ESI,ESP                         ; 0054b6c9
    XOR EAX,EAX                         ; 0054b6cb
    CMPSB.REPE ES:EDI,ESI               ; 0054b6cd | = "PBM\032PBG\032" | s_BM_PBG_00680c9d
    JZ 0x0054b6d6                       ; 0054b6cf
        ;   XREF to: 0054b6d6 (CONDITIONAL_JUMP)  ; LAB_0054b6d6
    SBB EAX,EAX                         ; 0054b6d1
    SBB EAX,-0x1                        ; 0054b6d3
    TEST EAX,EAX                        ; 0054b6d6
        ;   Label: LAB_0054b6d6
    JZ 0x0054b743                       ; 0054b6d8
        ;   XREF to: 0054b743 (CONDITIONAL_JUMP)  ; LAB_0054b743
    MOV EDX,0x63f161                    ; 0054b6da | = "..\\cockpit\\pkbitmap.cpp"
        ;   Label: LAB_0054b6da
    MOV ECX,0x4ae                       ; 0054b6df
    PUSH 0x63f179                       ; 0054b6e4 | = "Corrupt data detected reading PBM."
    MOV dword ptr [0x02f0ca48],EDX      ; 0054b6e9 | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 0054b6ef | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0054b6f5
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ADD ESP,0x4                         ; 0054b6fa
    MOV ESI,0x63f19c                    ; 0054b6fd | = "..\\cockpit\\pkbitmap.cpp"
        ;   Label: LAB_0054b6fd
    MOV EDI,0x4af                       ; 0054b702
    PUSH 0x63f1b4                       ; 0054b707 | = "Out of memory reading PBM"
    MOV dword ptr [0x02f0ca48],ESI      ; 0054b70c | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 0054b712 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0054b718
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    JMP 0x0054b6a5                      ; 0054b71d
        ;   XREF to: 0054b6a5 (UNCONDITIONAL_JUMP)  ; LAB_0054b6a5
    MOV EDI,0x63f11b                    ; 0054b71f | = "..\\cockpit\\pkbitmap.cpp"
        ;   Label: LAB_0054b71f
    MOV EAX,0x4ad                       ; 0054b724
    PUSH 0x63f133                       ; 0054b729 | = "IO error reading PBM (possibly corrup..."
    MOV dword ptr [0x02f0ca48],EDI      ; 0054b72e | g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 0054b734 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0054b739
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ADD ESP,0x4                         ; 0054b73e
    JMP 0x0054b6da                      ; 0054b741
        ;   XREF to: 0054b6da (UNCONDITIONAL_JUMP)  ; LAB_0054b6da
    MOV EDX,dword ptr [ESP + 0x4]       ; 0054b743
        ;   Label: LAB_0054b743
    CMP EDX,0x1                         ; 0054b747
    JC 0x0054b6da                       ; 0054b74a
        ;   XREF to: 0054b6da (CONDITIONAL_JUMP)  ; LAB_0054b6da
    CMP dword ptr [ESP + 0x8],0x1       ; 0054b74c
    JC 0x0054b6da                       ; 0054b751
        ;   XREF to: 0054b6da (CONDITIONAL_JUMP)  ; LAB_0054b6da
    ...
    PUSH EAX                            ; 0054b7a4
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1f0 ; 0054b7a5
    ...
    JZ 0x0054b6fd                       ; 0054b7b2
        ;   XREF to: 0054b6fd (CONDITIONAL_JUMP)  ; LAB_0054b6fd
    ...
    JNZ 0x0054b847                      ; 0054b809
        ;   XREF to: 0054b847 (CONDITIONAL_JUMP)  ; LAB_0054b847
    PUSH 0x4de                          ; 0054b80b
    PUSH 0x63f1e6                       ; 0054b810 | = "..\\cockpit\\pkbitmap.cpp"
    PUSH ESI                            ; 0054b815
    CALL shape_memdbg.cpp_debugMalloc_FUN_0050f250 ; 0054b816
    ...
    JZ 0x0054b6fd                       ; 0054b823
        ;   XREF to: 0054b6fd (CONDITIONAL_JUMP)  ; LAB_0054b6fd
    PUSH EBP                            ; 0054b829
    PUSH 0x1                            ; 0054b82a
    PUSH ESI                            ; 0054b82c
    PUSH EAX                            ; 0054b82d
    CALL crt_stdio.c_fread_FUN_005fd990 ; 0054b82e
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)  ; SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, _FILE * file)
    ADD ESP,0x10                        ; 0054b833
    CMP EAX,0x1                         ; 0054b836
    JNZ 0x0054b71f                      ; 0054b839
        ;   XREF to: 0054b71f (CONDITIONAL_JUMP)  ; LAB_0054b71f
    ...
    PUSH ESI                            ; 0054b849
    PUSH EBP                            ; 0054b84a
    CALL crt_stdio.c_fseek_FUN_005ffacc ; 0054b84b
