...
;   cockpit_pkbitmap.cpp_CPackedBitmap_parsePBGFile_FUN_0054b9b0
...
section .text
    ...
    PUSH EBX                            ; 0054bb40
        ;   Label: cockpit_pkbitmap.cpp_CPackedBitmap_loadPBGFile_FUN_0054bb40
    PUSH ESI                            ; 0054bb41
    PUSH EDI                            ; 0054bb42
    PUSH EBP                            ; 0054bb43
    ...
    PUSH EBX                            ; 0054bb8d
    PUSH EDI                            ; 0054bb8e
    CALL cockpit_pkbitmap.cpp_CPackedBitmap_parsePBGFile_FUN_0054b9b0 ; 0054bb8f
        ;   XREF to: 0054b9b0 (UNCONDITIONAL_CALL)  ; CPackedBitmap * cockpit_pkbitmap.cpp_CPackedBitmap_parsePBGFile_FUN_0054b9b0(CPackedBitmap * this_ptr, _FILE * file_handle, int param3, int param4, ...)
