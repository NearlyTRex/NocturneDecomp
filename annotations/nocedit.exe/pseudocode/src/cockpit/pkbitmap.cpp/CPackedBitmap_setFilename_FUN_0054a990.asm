...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl cockpit_pkbitmap_cpp_CPackedBitmap_setFilename_FUN_0054a990(CPackedBitmap *this_ptr,char *filename)
;
; Parameters:
...
section .text
    ...
    PUSH ECX                            ; 0054a99b
    CALL crt_string.c__strncpy_FUN_00600f40 ; 0054a99c
