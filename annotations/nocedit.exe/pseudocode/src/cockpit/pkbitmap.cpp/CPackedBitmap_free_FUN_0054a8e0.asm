...
;                               FUNCTION
; *****************************************************************************
; __cdecl void cockpit_pkbitmap.cpp_CPackedBitmap_free_FUN_0054a8e0(CPackedBitmap * this_ptr)
;
; Parameters:
...
section .text
    ...
    JNZ 0x0054a91f                      ; 0054a8ed | LAB_0054a91f
        ;   XREF to: 0054a91f (CONDITIONAL_JUMP)
    MOV ESI,0x63eed0                    ; 0054a8ef | = "..\\cockpit\\pkbitmap.cpp" | s_cockpit_pkbitmap_cpp_0063eed0 = ..\cockpit\pkbitmap.cpp
        ;   Label: LAB_0054a8ef
    MOV EBP,dword ptr [EBX + 0x20]      ; 0054a8f4
    MOV EDI,0x99                        ; 0054a8f7
    PUSH EBP                            ; 0054a8fc
    MOV dword ptr [0x0067d20c],ESI      ; 0054a8fd | char * g_CurrentDebugFilename
    MOV dword ptr [0x02f0d944],EDI      ; 0054a903 | int g_CurrentDebugLine
    CALL crt_memory.c_free_FUN_005fe659 ; 0054a909 | void crt_memory.c_free_FUN_005fe659(void * ptr)
        ;   XREF to: 005fe659 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0054a90e
    PUSH EBX                            ; 0054a911
    CALL cockpit_pkbitmap.cpp_CPackedBitmap_reset_FUN_0054a8b0 ; 0054a912 | void cockpit_pkbitmap.cpp_CPackedBitmap_reset_FUN_0054a8b0(CPackedBitmap * this_ptr)
    ...
    PUSH 0x98                           ; 0054a91f
        ;   Label: LAB_0054a91f
    PUSH 0x63eeb8                       ; 0054a924 | = "..\\cockpit\\pkbitmap.cpp" | s_cockpit_pkbitmap_cpp_0063eeb8 = ..\cockpit\pkbitmap.cpp
    PUSH EDX                            ; 0054a929
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 0054a92a | void shape_memdbg.cpp_debugFree_FUN_0050f460(void * ptr, char * filename, int line_number)
        ;   XREF to: 0050f460 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0054a92f
    JMP 0x0054a8ef                      ; 0054a932 | LAB_0054a8ef
