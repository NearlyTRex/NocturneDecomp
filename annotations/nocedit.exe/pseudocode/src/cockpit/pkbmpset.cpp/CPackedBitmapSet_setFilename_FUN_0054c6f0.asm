...
;                               FUNCTION
; *****************************************************************************
; __cdecl void cockpit_pkbmpset.cpp_CPackedBitmapSet_setFilename_FUN_0054c6f0(CPackedBitmapSet * this_ptr, char * filename)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 0054c6fe
    CALL crt_string.c_strncpy_FUN_00600f40 ; 0054c6ff | char * crt_string.c_strncpy_FUN_00600f40(char * dest, char * src, SIZE_T count)
