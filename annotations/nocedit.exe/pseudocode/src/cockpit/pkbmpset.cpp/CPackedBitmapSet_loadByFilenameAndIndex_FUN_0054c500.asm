...
;                               FUNCTION
; *****************************************************************************
; __cdecl void cockpit_pkbmpset.cpp_CPackedBitmapSet_loadByFilenameAndIndex_FUN_0054c500(CPackedBitmapSet * this_ptr, char * filename, int bitmap_index)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 0054c52a
    INC EBX                             ; 0054c52b
    CALL cockpit_pkbitmap.cpp_CPackedBitmap_loadByFileExtension_FUN_0054b4b0 ; 0054c52c | void cockpit_pkbitmap.cpp_CPackedBitmap_loadByFileExtension_FUN_0054b4b0(CPackedBitmap * this_ptr, int processing_flags)
    ...
    JL 0x0054c524                       ; 0054c53b | LAB_0054c524
    ...
    PUSH EAX                            ; 0054c557
    CALL cockpit_pkbitmap.cpp_CPackedBitmap_loadByFileExtension_FUN_0054b4b0 ; 0054c558 | void cockpit_pkbitmap.cpp_CPackedBitmap_loadByFileExtension_FUN_0054b4b0(CPackedBitmap * this_ptr, int processing_flags)
        ;   XREF to: 0054b4b0 (UNCONDITIONAL_CALL)
    ...
    MOV AL,byte ptr [ESI]               ; 0054c56a
        ;   Label: LAB_0054c56a
    CMP AL,DL                           ; 0054c56c
    JZ 0x0054c582                       ; 0054c56e | LAB_0054c582
        ;   XREF to: 0054c582 (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 0054c570
    JZ 0x0054c580                       ; 0054c572 | LAB_0054c580
        ;   XREF to: 0054c580 (CONDITIONAL_JUMP)
    INC ESI                             ; 0054c574
    MOV AL,byte ptr [ESI]               ; 0054c575
    CMP AL,DL                           ; 0054c577
    JZ 0x0054c582                       ; 0054c579 | LAB_0054c582
        ;   XREF to: 0054c582 (CONDITIONAL_JUMP)
    INC ESI                             ; 0054c57b
    CMP AL,0x0                          ; 0054c57c
    JNZ 0x0054c56a                      ; 0054c57e | LAB_0054c56a
        ;   XREF to: 0054c56a (CONDITIONAL_JUMP)
    SUB ESI,ESI                         ; 0054c580
        ;   Label: LAB_0054c580
    TEST ESI,ESI                        ; 0054c582
        ;   Label: LAB_0054c582
    JZ 0x0054c540                       ; 0054c584 | LAB_0054c540
        ;   XREF to: 0054c540 (CONDITIONAL_JUMP)
    PUSH 0x63f74c                       ; 0054c586 | = ".raw" | s_raw_0063f74c = .raw
    PUSH ESI                            ; 0054c58b
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 0054c58c | int crt_string.c_stricmp_FUN_005fe7f0(char * str1, char * str2)
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0054c591
    TEST EAX,EAX                        ; 0054c594
    JZ 0x0054c5ba                       ; 0054c596 | LAB_0054c5ba
        ;   XREF to: 0054c5ba (CONDITIONAL_JUMP)
    PUSH 0x63f751                       ; 0054c598 | = ".pbg" | s_pbg_0063f751 = .pbg
    PUSH ESI                            ; 0054c59d
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 0054c59e | int crt_string.c_stricmp_FUN_005fe7f0(char * str1, char * str2)
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0054c5a3
    TEST EAX,EAX                        ; 0054c5a6
    JNZ 0x0054c540                      ; 0054c5a8 | LAB_0054c540
        ;   XREF to: 0054c540 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 0054c5aa
    PUSH EBP                            ; 0054c5ab
    PUSH EDI                            ; 0054c5ac
    CALL cockpit_pkbmpset.cpp_CPackedBitmapSet_reloadStoredPBGFile_FUN_0054c4d0 ; 0054c5ad | void cockpit_pkbmpset.cpp_CPackedBitmapSet_reloadStoredPBGFile_FUN_0054c4d0(CPackedBitmapSet * this_ptr, char * pbg_filename)
    ...
    PUSH EBP                            ; 0054c5bb
    PUSH EDI                            ; 0054c5bc
    CALL cockpit_pkbmpset.cpp_CPackedBitmapSet_reload_FUN_0054c1e0 ; 0054c5bd | void cockpit_pkbmpset.cpp_CPackedBitmapSet_reload_FUN_0054c1e0(CPackedBitmapSet * this_ptr)
