...
;                               FUNCTION
; *****************************************************************************
; __cdecl int cockpit_pkbmpset.cpp_CPackedBitmapSet_getTotalMemoryUsage_FUN_0054c6a0(CPackedBitmapSet * this_ptr)
;
; Parameters:
...
section .text
    ...
    JLE 0x0054c6db                      ; 0054c6ba | LAB_0054c6db
    ...
    PUSH EAX                            ; 0054c6c4
    INC EBX                             ; 0054c6c5
    CALL cockpit_pkbitmap.cpp_CPackedBitmap_getTotalMemoryUsage_FUN_0054a970 ; 0054c6c6 | int cockpit_pkbitmap.cpp_CPackedBitmap_getTotalMemoryUsage_FUN_0054a970(CPackedBitmap * this_ptr)
    ...
    JL 0x0054c6bf                       ; 0054c6d8 | LAB_0054c6bf
