...
;                               FUNCTION
; *****************************************************************************
; __cdecl void cockpit_ckptutil.c_generateScrollHeightMap_FUN_00432df0(void * bitmap_data, int end_x, int start_x, int bitmap_height, int * height_output, int num_height_rows, int transparency_color)
;
; Parameters:
...
section .text
    ...
    JZ 0x00432fad                       ; 00432e0b | LAB_00432fad
    ...
    JG 0x00432fb4                       ; 00432e1d | LAB_00432fb4
        ;   XREF to: 00432fb4 (CONDITIONAL_JUMP)
    PUSH 0x3fc                          ; 00432e23
        ;   Label: LAB_00432e23
    PUSH 0x617afb                       ; 00432e28 | = "..\\cockpit\\ckptutil.c" | s_cockpit_ckptutil_c_00617afb = ..\cockpit\ckptutil.c
    LEA EAX,[EBP*0x4 + 0x0]             ; 00432e2d
    PUSH EAX                            ; 00432e34
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1f0 ; 00432e35 | void * shape_memdbg.cpp_debugAlloc_FUN_0050f1f0(int size, char * filename, int line_number)
        ;   XREF to: 0050f1f0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00432e3a
    MOV dword ptr [ESP + 0x20],EAX      ; 00432e3d
    TEST EAX,EAX                        ; 00432e41
    JZ 0x00432fdc                       ; 00432e43 | LAB_00432fdc
        ;   XREF to: 00432fdc (CONDITIONAL_JUMP)
    XOR ESI,ESI                         ; 00432e49
        ;   Label: LAB_00432e49
    MOV dword ptr [ESP + 0x1c],ESI      ; 00432e4b
    TEST EBP,EBP                        ; 00432e4f
    JLE 0x00432eae                      ; 00432e51 | LAB_00432eae
    ...
    JL 0x00432e9e                       ; 00432e98 | LAB_00432e9e
    ...
    JL 0x00432e71                       ; 00432eac | LAB_00432e71
    ...
    JLE 0x00432f89                      ; 00432ec7 | LAB_00432f89
    ...
    JL 0x00432f36                       ; 00432f45 | LAB_00432f36
    ...
    JL 0x00432f5b                       ; 00432f69 | LAB_00432f5b
    ...
    JL 0x00432f0a                       ; 00432f87 | LAB_00432f0a
        ;   XREF to: 00432f0a (CONDITIONAL_JUMP)
    MOV ECX,0x617b4f                    ; 00432f89 | = "..\\cockpit\\ckptutil.c" | s_cockpit_ckptutil_c_00617b4f = ..\cockpit\ckptutil.c
        ;   Label: LAB_00432f89
    MOV ESI,dword ptr [ESP + 0x20]      ; 00432f8e
    MOV EBX,0x439                       ; 00432f92
    PUSH ESI                            ; 00432f97
    MOV dword ptr [0x0067d20c],ECX      ; 00432f98 | char * g_CurrentDebugFilename
    MOV dword ptr [0x02f0d944],EBX      ; 00432f9e | int g_CurrentDebugLine
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 00432fa4 | void shape_memdbg.cpp_debugFree_FUN_0050f210(void * ptr)
    ...
    POP EBX                             ; 00432fb2
    RET                                 ; 00432fb3
    MOV ECX,0x617aca                    ; 00432fb4 | = "..\\cockpit\\ckptutil.c" | s_cockpit_ckptutil_c_00617aca = ..\cockpit\ckptutil.c
        ;   Label: LAB_00432fb4
    MOV ESI,0x3f8                       ; 00432fb9
    PUSH 0x617ae0                       ; 00432fbe | = "Invalid height array size." | s_Invalid_height_array_siz_00617ae0 = Invalid height array size.
    MOV dword ptr [0x02f0ca48],ECX      ; 00432fc3 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 00432fc9 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00432fcf | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00432fd4
    JMP 0x00432e23                      ; 00432fd7 | LAB_00432e23
        ;   XREF to: 00432e23 (UNCONDITIONAL_JUMP)
    MOV EAX,0x617b11                    ; 00432fdc | = "..\\cockpit\\ckptutil.c" | s_cockpit_ckptutil_c_00617b11 = ..\cockpit\ckptutil.c
        ;   Label: LAB_00432fdc
    MOV EDX,0x3fe                       ; 00432fe1
    PUSH 0x617b27                       ; 00432fe6 | = "No room for scroll bitmap height table." | s_No_room_for_scroll_bitma_00617b27 = No room for scroll bitmap height table.
    MOV [0x02f0ca48],EAX                ; 00432feb | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 00432ff0 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00432ff6 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00432ffb
    JMP 0x00432e49                      ; 00432ffe | LAB_00432e49
        ;   XREF to: 00432e49 (UNCONDITIONAL_JUMP)
    DEC EAX                             ; 00433003
        ;   Label: LAB_00433003
    SUB EDX,EBX                         ; 00433004
    TEST EAX,EAX                        ; 00433006
    JGE 0x00432e7f                      ; 00433008 | LAB_00432e7f
        ;   XREF to: 00432e7f (CONDITIONAL_JUMP)
    JMP 0x00432e8b                      ; 0043300e | LAB_00432e8b
        ;   XREF to: 00432e8b (UNCONDITIONAL_JUMP)
    DEC EDX                             ; 00433013
        ;   Label: LAB_00433013
    SUB EAX,EBX                         ; 00433014
    TEST EDX,EDX                        ; 00433016
    JGE 0x00432f1c                      ; 00433018 | LAB_00432f1c
        ;   XREF to: 00432f1c (CONDITIONAL_JUMP)
    JMP 0x00432f28                      ; 0043301e | LAB_00432f28
