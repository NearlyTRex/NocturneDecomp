...
;                               FUNCTION
; *****************************************************************************
; __cdecl void cockpit_ckptutil.c_expandIndexedToRGB_FUN_004314fa(void * output_buffer, void * input_buffer, int pixel_count)
;
; Parameters:
...
section .text
    ...
    MOVZX EAX,byte ptr [ESI]            ; 0043150f
        ;   Label: LAB_0043150f
    INC ESI                             ; 00431512
    MOV EAX,dword ptr [EAX*0x4 + 0x2d01924] ; 00431513 | uint[256] g_Hardware32BitPalette
    MOV dword ptr [EDI],EAX             ; 0043151a
    ADD EDI,0x4                         ; 0043151c
    DEC ECX                             ; 0043151f
    JG 0x0043150f                       ; 00431520 | LAB_0043150f
