...
section .text
    ...
    CMP EAX,dword ptr [0x02d02558]      ; 00433f65 | int g_ClipLeft
    JL 0x00434199                       ; 00433f6b | LAB_00434199
        ;   XREF to: 00434199 (CONDITIONAL_JUMP)
    CMP EAX,dword ptr [0x02d02560]      ; 00433f71 | int g_ClipRight
    JG 0x00434199                       ; 00433f77 | LAB_00434199
        ;   XREF to: 00434199 (CONDITIONAL_JUMP)
    CMP ESI,dword ptr [0x02d0255c]      ; 00433f7d | int g_ClipTop
    JL 0x00434199                       ; 00433f83 | LAB_00434199
        ;   XREF to: 00434199 (CONDITIONAL_JUMP)
    CMP ESI,dword ptr [0x02d02564]      ; 00433f89 | int g_ClipBottom
    JG 0x00434199                       ; 00433f8f | LAB_00434199
        ;   XREF to: 00434199 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x0067939c]      ; 00433f95 | int g_BitsPerPixel
    CMP ECX,0x8                         ; 00433f9b
    JZ 0x00434199                       ; 00433f9e | LAB_00434199
        ;   XREF to: 00434199 (CONDITIONAL_JUMP)
    LEA EDX,[ESI*0x4 + 0x0]             ; 00433fa4
    CMP ECX,0x10                        ; 00433fab
    JZ 0x004341a0                       ; 00433fae | LAB_004341a0
        ;   XREF to: 004341a0 (CONDITIONAL_JUMP)
    LEA EBX,[EAX*0x4 + 0x0]             ; 00433fb4
    MOV EDX,dword ptr [EDX + 0x2cf6a9c] ; 00433fbb | void *[1024] g_ScreenBufferArray
    ADD EBX,EDX                         ; 00433fc1
    MOV CL,byte ptr [0x02d01f24]        ; 00433fc3 | int g_RedBitPosition
    ...
    MOV CL,byte ptr [0x02d01f30]        ; 00433fe1 | int g_GreenBitPosition
    ...
    MOV CL,byte ptr [0x02d01f3c]        ; 00434006 | int g_BlueBitPosition
    ...
    CMP dword ptr [0x0067939c],0x10     ; 00434035 | int g_BitsPerPixel
    JNZ 0x0043422e                      ; 0043403c | LAB_0043422e
        ;   XREF to: 0043422e (CONDITIONAL_JUMP)
    MOV DX,word ptr [EDI*0x2 + 0x2d01d24] ; 00434042 | ushort[256] g_Hardware16BitPalette
    AND EDX,0xffff                      ; 0043404a
    MOV CL,byte ptr [0x02d01f24]        ; 00434050 | int g_RedBitPosition
    MOV EBX,EDX                         ; 00434056
    SHR EBX,CL                          ; 00434058
    MOV CL,byte ptr [0x02d01f2c]        ; 0043405a | int g_RedBitCount
    SHL EBX,CL                          ; 00434060
    MOV ECX,EBX                         ; 00434062
    AND ECX,0xff                        ; 00434064
    MOV EDI,EDX                         ; 0043406a
    MOV dword ptr [ESP + 0x8],ECX       ; 0043406c
    MOV CL,byte ptr [0x02d01f30]        ; 00434070 | int g_GreenBitPosition
    SHR EDI,CL                          ; 00434076
    MOV CL,byte ptr [0x02d01f38]        ; 00434078 | int g_GreenBitCount
    SHL EDI,CL                          ; 0043407e
    MOV CL,byte ptr [0x02d01f3c]        ; 00434080 | int g_BlueBitPosition
    SHR EDX,CL                          ; 00434086
    MOV CL,byte ptr [0x02d01f44]        ; 00434088 | int g_BlueBitCount
    SHL EDX,CL                          ; 0043408e
    ...
    MOV EDI,dword ptr [0x0067939c]      ; 004340da | int g_BitsPerPixel
    ...
    JNZ 0x0043426e                      ; 00434113 | LAB_0043426e
        ;   XREF to: 0043426e (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x4]           ; 00434119
    FLD float ptr [ESP]                 ; 0043411d
    FLD float ptr [ESP + 0xc]           ; 00434120
    MOV CL,byte ptr [0x02d01f2c]        ; 00434124 | int g_RedBitCount
    FXCH ST2                            ; 0043412a
    CALL crt_math.c_round_FUN_005fe6b0  ; 0043412c | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH                                ; 00434131
    CALL crt_math.c_round_FUN_005fe6b0  ; 00434133 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH ST2                            ; 00434138
    CALL crt_math.c_round_FUN_005fe6b0  ; 0043413a | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH                                ; 0043413f
    ...
    SHR EDI,CL                          ; 00434157
    MOV CL,byte ptr [0x02d01f38]        ; 00434159 | int g_GreenBitCount
    MOV EBX,dword ptr [ESP + 0x18]      ; 0043415f
    SHR EDX,CL                          ; 00434163
    MOV CL,byte ptr [0x02d01f44]        ; 00434165 | int g_BlueBitCount
    SHR EBX,CL                          ; 0043416b
    LEA ECX,[EAX + EAX*0x1]             ; 0043416d
    MOV EAX,dword ptr [ESI + 0x2cf6a9c] ; 00434170 | void *[1024] g_ScreenBufferArray
    MOV ESI,EDI                         ; 00434176
    ADD EAX,ECX                         ; 00434178
    MOV CL,byte ptr [0x02d01f24]        ; 0043417a | int g_RedBitPosition
    SHL ESI,CL                          ; 00434180
    MOV CL,byte ptr [0x02d01f30]        ; 00434182 | int g_GreenBitPosition
    SHL EDX,CL                          ; 00434188
    MOV CL,byte ptr [0x02d01f3c]        ; 0043418a | int g_BlueBitPosition
    OR EDX,ESI                          ; 00434190
    SHL EBX,CL                          ; 00434192
    OR EDX,EBX                          ; 00434194
    ...
    POP EBX                             ; 0043419e
    RET                                 ; 0043419f
    MOV EDX,dword ptr [EDX + 0x2cf6a9c] ; 004341a0 | void *[1024] g_ScreenBufferArray
        ;   Label: LAB_004341a0
    MOV DX,word ptr [EDX + EAX*0x2]     ; 004341a6
    AND EDX,0xffff                      ; 004341aa
    MOV CL,byte ptr [0x02d01f24]        ; 004341b0 | int g_RedBitPosition
    MOV EBX,EDX                         ; 004341b6
    SHR EBX,CL                          ; 004341b8
    MOV CL,byte ptr [0x02d01f2c]        ; 004341ba | int g_RedBitCount
    SHL EBX,CL                          ; 004341c0
    ...
    MOV CL,byte ptr [0x02d01f30]        ; 004341d6 | int g_GreenBitPosition
    MOV EBX,EDX                         ; 004341dc
    FLD float ptr [EBP + 0x1c]          ; 004341de
    FXCH                                ; 004341e1
    FMUL ST1                            ; 004341e3
    SHR EBX,CL                          ; 004341e5
    MOV CL,byte ptr [0x02d01f38]        ; 004341e7 | int g_GreenBitCount
    SHL EBX,CL                          ; 004341ed
    ...
    MOV CL,byte ptr [0x02d01f3c]        ; 00434203 | int g_BlueBitPosition
    FMUL ST2                            ; 00434209
    SHR EDX,CL                          ; 0043420b
    MOV CL,byte ptr [0x02d01f44]        ; 0043420d | int g_BlueBitCount
    SHL EDX,CL                          ; 00434213
    ...
    JMP 0x00434026                      ; 00434229 | LAB_00434026
        ;   XREF to: 00434026 (UNCONDITIONAL_JUMP)
    LEA EBX,[EDI*0x4 + 0x0]             ; 0043422e
        ;   Label: LAB_0043422e
    MOV CL,byte ptr [0x02d01f24]        ; 00434235 | int g_RedBitPosition
    MOV EDX,dword ptr [EBX + 0x2d01924] ; 0043423b | uint[256] g_Hardware32BitPalette
    SHR EDX,CL                          ; 00434241
    MOV EDI,dword ptr [EBX + 0x2d01924] ; 00434243 | uint[256] g_Hardware32BitPalette
    AND EDX,0xff                        ; 00434249
    MOV CL,byte ptr [0x02d01f30]        ; 0043424f | int g_GreenBitPosition
    MOV dword ptr [ESP + 0x8],EDX       ; 00434255
    SHR EDI,CL                          ; 00434259
    MOV CL,byte ptr [0x02d01f3c]        ; 0043425b | int g_BlueBitPosition
    MOV EDX,dword ptr [EBX + 0x2d01924] ; 00434261 | uint[256] g_Hardware32BitPalette
    SHR EDX,CL                          ; 00434267
    JMP 0x00434090                      ; 00434269 | LAB_00434090
    ...
    MOV CL,byte ptr [0x02d01f24]        ; 00434279 | int g_RedBitPosition
    FXCH ST2                            ; 0043427f
    CALL crt_math.c_round_FUN_005fe6b0  ; 00434281 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH                                ; 00434286
    CALL crt_math.c_round_FUN_005fe6b0  ; 00434288 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH ST2                            ; 0043428d
    CALL crt_math.c_round_FUN_005fe6b0  ; 0043428f | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    SHL EBX,CL                          ; 004342b3
    MOV EDX,dword ptr [ESI + 0x2cf6a9c] ; 004342b5 | void *[1024] g_ScreenBufferArray
    MOV CL,byte ptr [0x02d01f30]        ; 004342bb | int g_GreenBitPosition
    ADD EDX,EAX                         ; 004342c1
    MOV EAX,dword ptr [ESP + 0x28]      ; 004342c3
    MOV EDI,dword ptr [ESP + 0x20]      ; 004342c7
    SHL EAX,CL                          ; 004342cb
    MOV CL,byte ptr [0x02d01f3c]        ; 004342cd | int g_BlueBitPosition
    OR EAX,EBX                          ; 004342d3
    SHL EDI,CL                          ; 004342d5
    OR EAX,EDI                          ; 004342d7
