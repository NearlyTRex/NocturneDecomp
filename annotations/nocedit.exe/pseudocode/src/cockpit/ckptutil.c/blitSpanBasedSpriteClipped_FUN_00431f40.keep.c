...

{
  ...
  if (sprite_data != (void *)0x0) {
    ...
    if (g_BitsPerPixel == 8) {
      local_18 = (byte *)g_ScreenBufferArray[src_y + screen_y] + screen_x;
      if (screen_y < height) {
        do {
          iVar9 = 0;
          while (piVar3 = (int *)((char *)span_data + local_30), iVar9 < *piVar3) {
            ...
            if (((iVar3 < iVar6) && (iVar3 = iVar6, iVar5 < iVar6)) ||
              ...
              (*pCVar2)(local_18 + iVar3 - src_x, p_sprite + iVar3, (iVar5 - iVar3) + 1);
            }
            iVar9 = iVar9 + 1;
          }
      ...
      local_1c = (ushort *)g_ScreenBufferArray[src_y + screen_y] + screen_x;
      if (screen_y < height) {
        local_2c = local_30;
        do {
          iVar10 = 0;
          while (piVar1 = (int *)((char *)span_data + local_2c), iVar10 < *piVar1) {
            ...
            if (((iVar4 < iVar6) && (iVar4 = iVar6, iVar2 < iVar6)) ||
              ...
              (*pCVar2)(local_1c + iVar4 - src_x, p_sprite + iVar4, (iVar2 - iVar4) + 1);
            }
            iVar10 = iVar10 + 1;
          }
