...
section .text
    ...
    JNZ 0x00432a48                      ; 00432a34 | LAB_00432a48
    ...
    POP EBX                             ; 00432a46
    RET                                 ; 00432a47
    CALL cockpit_ckptutil.c_getColorConversionFunction_FUN_00431760 ; 00432a48 | ColorConversionFunc * cockpit_ckptutil.c_getColorConversionFunction_FUN_00431760()
        ;   Label: LAB_00432a48
        ;   XREF to: 00431760 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [0x0067939c]      ; 00432a4d | int g_BitsPerPixel
    MOV dword ptr [ESP + 0x8],EAX       ; 00432a53
    LEA EAX,[ESI*0x4 + 0x0]             ; 00432a57
    CMP ECX,0x8                         ; 00432a5e
    JNZ 0x00432aa1                      ; 00432a61 | LAB_00432aa1
        ;   XREF to: 00432aa1 (CONDITIONAL_JUMP)
    MOV EBX,ESI                         ; 00432a63
    CMP ESI,EBP                         ; 00432a65
    JGE 0x00432a40                      ; 00432a67 | LAB_00432a40
        ;   XREF to: 00432a40 (CONDITIONAL_JUMP)
    MOV ESI,EAX                         ; 00432a69
    MOV EAX,[0x00679394]                ; 00432a6b | int g_WindowWidth
        ;   Label: LAB_00432a6b
    ...
    MOV EAX,dword ptr [ESI + 0x2cf6a9c] ; 00432a80 | void *[1024] g_ScreenBufferArray
    PUSH EDX                            ; 00432a86
    ...
    JL 0x00432a6b                       ; 00432a97 | LAB_00432a6b
    ...
    JGE 0x00432a40                      ; 00432aa5 | LAB_00432a40
        ;   XREF to: 00432a40 (CONDITIONAL_JUMP)
    LEA EDX,[EDI + EDI*0x1]             ; 00432aa7
    MOV ESI,EAX                         ; 00432aaa
    MOV dword ptr [ESP],EDX             ; 00432aac
    MOV EAX,[0x00679394]                ; 00432aaf | int g_WindowWidth
        ;   Label: LAB_00432aaf
    ...
    MOV EDX,dword ptr [ESI + 0x2cf6a9c] ; 00432ac2 | void *[1024] g_ScreenBufferArray
    ...
    JL 0x00432aaf                       ; 00432ade | LAB_00432aaf
