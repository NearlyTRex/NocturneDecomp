...

{
  ...
  ptr = (uchar *)shape_memdbg_cpp_debugMalloc_FUN_0050f250(iVar3,"..\\cockpit\\ckptutil.c",2055);
  if (ptr == (uchar *)0x0) {
    _sprintf(local_78,"Unable to allocate %u bytes for temporary rotated bitmap.",iVar3);
    g_CurrentLineNumber = 2058;
  ...
  shape_memdbg_cpp_debugFree_FUN_0050f460(ptr,"..\\cockpit\\ckptutil.c",2091);
  return;
}
