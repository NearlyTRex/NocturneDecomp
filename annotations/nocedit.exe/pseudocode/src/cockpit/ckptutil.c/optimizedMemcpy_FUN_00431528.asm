...
;                               FUNCTION
; *****************************************************************************
; __cdecl void cockpit_ckptutil.c_optimizedMemcpy_FUN_00431528(void * dest_buffer, void * src_buffer, int byte_count)
;
; Parameters:
...
section .text
    ...
    JZ 0x00431573                       ; 0043153f | LAB_00431573
    ...
    JGE 0x00431551                      ; 0043154c | LAB_00431551
    ...
    JGE 0x004315d0                      ; 004315f5 | LAB_004315d0
    ...
    CMP EDX,0x0                         ; 004315fe
        ;   Label: LAB_004315fe
    JZ 0x0043161a                       ; 00431601 | LAB_0043161a
        ;   XREF to: 0043161a (CONDITIONAL_JUMP)
    MOV EBX,EDX                         ; 00431603
    NOP                                 ; 00431605
    SHR EBX,0x2                         ; 00431606
    JZ 0x00431616                       ; 00431609 | LAB_00431616
