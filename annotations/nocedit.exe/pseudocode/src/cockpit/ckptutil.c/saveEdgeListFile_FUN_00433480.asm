...
section .text
    ...
    JZ 0x00433584                       ; 00433494 | LAB_00433584
        ;   XREF to: 00433584 (CONDITIONAL_JUMP)
    PUSH 0x617d4a                       ; 0043349a | = "wt" | s_wt_00617d4a = wt
        ;   Label: LAB_0043349a
    PUSH ESI                            ; 0043349f
    PUSH 0x617d4d                       ; 004334a0 | = "art" | s_art_00617d4d = art
    CALL engine_dosio.c_getFile_FUN_00481a50 ; 004334a5 | FILE * engine_dosio.c_getFile_FUN_00481a50(char * directory, char * filename, char * mode)
        ;   XREF to: 00481a50 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004334aa
    MOV EDI,EAX                         ; 004334ad
    TEST EAX,EAX                        ; 004334af
    JNZ 0x004334e6                      ; 004334b1 | LAB_004334e6
        ;   XREF to: 004334e6 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 004334b3
    PUSH 0x617d51                       ; 004334b4 | = "Could not create output file (%s)." | s_Could_not_create_output__00617d51 = Could not create output file (%s).
    LEA EAX,[ESP + 0x8]                 ; 004334b9
    PUSH EAX                            ; 004334bd
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 004334be | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    MOV EAX,0x507                       ; 004334c3
    ADD ESP,0xc                         ; 004334c8
    MOV [0x02f0ca4c],EAX                ; 004334cb | int g_CurrentLineNumber
    MOV EAX,ESP                         ; 004334d0
    MOV EBP,0x617d74                    ; 004334d2 | = "..\\cockpit\\ckptutil.c" | s_cockpit_ckptutil_c_00617d74 = ..\cockpit\ckptutil.c
    PUSH EAX                            ; 004334d7
    MOV dword ptr [0x02f0ca48],EBP      ; 004334d8 | char * g_CurrentFilename
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004334de | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    PUSH EDI                            ; 004334ec
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 004334ed | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004334f2
    TEST EBX,EBX                        ; 004334f5
    JLE 0x004335ce                      ; 004334f7 | LAB_004335ce
    ...
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00433522 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JGE 0x004335ac                      ; 00433539 | LAB_004335ac
    ...
    CWDE                                ; 0043356e
    PUSH EAX                            ; 0043356f
    PUSH 0x617d92                       ; 00433570 | = "%3d %3d %3d %3d %d\n" | s_s_3d_3d_3d_3d_d_00617d92 = %3d %3d %3d %3d %d

    PUSH EDI                            ; 00433575
    ADD ESI,0x8                         ; 00433576
    INC EBX                             ; 00433579
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0043357a | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x1c                        ; 0043357f
    JMP 0x00433530                      ; 00433582 | LAB_00433530
        ;   XREF to: 00433530 (UNCONDITIONAL_JUMP)
    MOV ECX,0x617d1a                    ; 00433584 | = "..\\cockpit\\ckptutil.c" | s_cockpit_ckptutil_c_00617d1a = ..\cockpit\ckptutil.c
        ;   Label: LAB_00433584
    MOV EDI,0x500                       ; 00433589
    PUSH 0x617d30                       ; 0043358e | = "Edge list array is empty!" | s_Edge_list_array_is_empty_00617d30 = Edge list array is empty!
    MOV dword ptr [0x02f0ca48],ECX      ; 00433593 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 00433599 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0043359f | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004335a4
    JMP 0x0043349a                      ; 004335a7 | LAB_0043349a
    ...
    JL 0x00433512                       ; 004335c8 | LAB_00433512
        ;   XREF to: 00433512 (CONDITIONAL_JUMP)
    PUSH 0x522                          ; 004335ce
        ;   Label: LAB_004335ce
    PUSH 0x617da6                       ; 004335d3 | = "..\\cockpit\\ckptutil.c" | s_cockpit_ckptutil_c_00617da6 = ..\cockpit\ckptutil.c
    PUSH EDI                            ; 004335d8
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 004335d9 | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
