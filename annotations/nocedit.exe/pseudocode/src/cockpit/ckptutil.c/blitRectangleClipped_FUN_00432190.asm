...
section .text
    ...
    MOV EAX,[0x02d02560]                ; 0043219f | int g_ClipRight
    SUB EAX,EBP                         ; 004321a4
    MOV EDX,dword ptr [0x02cf6a9c]      ; 004321a6 | void *[1024] g_ScreenBufferArray
    MOV dword ptr [ESP],EAX             ; 004321ac
    MOV EAX,[0x02cf6aa0]                ; 004321af | g_ScreenBufferArray[1]
    MOV ESI,dword ptr [0x02d02558]      ; 004321b4 | int g_ClipLeft
    SUB EAX,EDX                         ; 004321ba
    SUB ESI,EBP                         ; 004321bc
    MOV dword ptr [ESP + 0x14],EAX      ; 004321be
    TEST EBX,EBX                        ; 004321c2
    JNZ 0x004321d8                      ; 004321c4 | LAB_004321d8
    ...
    JLE 0x004321d0                      ; 00432223 | LAB_004321d0
        ;   XREF to: 004321d0 (CONDITIONAL_JUMP)
    ...
    JL 0x0043222c                       ; 00432253 | LAB_0043222c
    ...
    POP EBX                             ; 0043225b
    RET                                 ; 0043225c
    MOV EDI,dword ptr [ECX + 0x2cf6a9c] ; 0043225d | void *[1024] g_ScreenBufferArray
        ;   Label: LAB_0043225d
    ...
    JLE 0x004321d0                      ; 004322a3 | LAB_004321d0
        ;   XREF to: 004321d0 (CONDITIONAL_JUMP)
    ...
    JL 0x004322c2                       ; 004322ec | LAB_004322c2
