...
section .text
    ...
    JZ 0x00432880                       ; 00432875
        ;   XREF to: 00432880 (CONDITIONAL_JUMP)  ; LAB_00432880
    TEST EBX,EBX                        ; 00432877
    JNZ 0x00432888                      ; 00432879
        ;   XREF to: 00432888 (CONDITIONAL_JUMP)  ; LAB_00432888
    ...
    POP EBX                             ; 00432886
    RET                                 ; 00432887
    CALL cockpit_ckptutil.c_getOptimizedMemcpyFunction_FUN_00431780 ; 00432888
    ...
    JL 0x004328ab                       ; 004328c4
        ;   XREF to: 004328ab (CONDITIONAL_JUMP)  ; LAB_004328ab
