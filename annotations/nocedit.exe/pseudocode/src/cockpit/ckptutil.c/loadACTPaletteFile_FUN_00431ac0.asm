...
section .text
    ...
    CMP AL,0x0                          ; 00431ae0
    JZ 0x00431af4                       ; 00431ae2 | LAB_00431af4
    ...
    CMP AL,0x0                          ; 00431af0
    JNZ 0x00431adc                      ; 00431af2 | LAB_00431adc
    ...
    MOV AL,byte ptr [ESI]               ; 00431af7
        ;   Label: LAB_00431af7
    CMP AL,DL                           ; 00431af9
    JZ 0x00431b0f                       ; 00431afb | LAB_00431b0f
        ;   XREF to: 00431b0f (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 00431afd
    JZ 0x00431b0d                       ; 00431aff | LAB_00431b0d
        ;   XREF to: 00431b0d (CONDITIONAL_JUMP)
    INC ESI                             ; 00431b01
    MOV AL,byte ptr [ESI]               ; 00431b02
    CMP AL,DL                           ; 00431b04
    JZ 0x00431b0f                       ; 00431b06 | LAB_00431b0f
        ;   XREF to: 00431b0f (CONDITIONAL_JUMP)
    INC ESI                             ; 00431b08
    CMP AL,0x0                          ; 00431b09
    JNZ 0x00431af7                      ; 00431b0b | LAB_00431af7
    ...
    JNZ 0x00431b33                      ; 00431b13 | LAB_00431b33
    ...
    MOV AL,byte ptr [ESI]               ; 00431b19
        ;   Label: LAB_00431b19
    CMP AL,DL                           ; 00431b1b
    JZ 0x00431b31                       ; 00431b1d | LAB_00431b31
        ;   XREF to: 00431b31 (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 00431b1f
    JZ 0x00431b2f                       ; 00431b21 | LAB_00431b2f
        ;   XREF to: 00431b2f (CONDITIONAL_JUMP)
    INC ESI                             ; 00431b23
    MOV AL,byte ptr [ESI]               ; 00431b24
    CMP AL,DL                           ; 00431b26
    JZ 0x00431b31                       ; 00431b28 | LAB_00431b31
        ;   XREF to: 00431b31 (CONDITIONAL_JUMP)
    INC ESI                             ; 00431b2a
    CMP AL,0x0                          ; 00431b2b
    JNZ 0x00431b19                      ; 00431b2d | LAB_00431b19
        ;   XREF to: 00431b19 (CONDITIONAL_JUMP)
    SUB ESI,ESI                         ; 00431b2f
        ;   Label: LAB_00431b2f
    MOV EDI,ESI                         ; 00431b31
        ;   Label: LAB_00431b31
    MOV ESI,0x617a80                    ; 00431b33 | = ".ACT" | s_ACT_00617a80 = .ACT
        ;   Label: LAB_00431b33
    PUSH EDI                            ; 00431b38
    MOV AL,byte ptr [ESI]               ; 00431b39 | = ".ACT" | s_ACT_00617a80 = .ACT
        ;   Label: LAB_00431b39
    MOV byte ptr [EDI],AL               ; 00431b3b
    CMP AL,0x0                          ; 00431b3d
    JZ 0x00431b51                       ; 00431b3f | LAB_00431b51
        ;   XREF to: 00431b51 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 00431b41 | s_ACT_00617a81
    ADD ESI,0x2                         ; 00431b44
    MOV byte ptr [EDI + 0x1],AL         ; 00431b47
    ADD EDI,0x2                         ; 00431b4a
    CMP AL,0x0                          ; 00431b4d
    JNZ 0x00431b39                      ; 00431b4f | LAB_00431b39
        ;   XREF to: 00431b39 (CONDITIONAL_JUMP)
    POP EDI                             ; 00431b51
        ;   Label: LAB_00431b51
    PUSH 0x617a85                       ; 00431b52 | = "rb" | s_rb_00617a85 = rb
    LEA EAX,[ESP + 0x4]                 ; 00431b57
    PUSH EAX                            ; 00431b5b
    PUSH 0x617a88                       ; 00431b5c | = "art" | s_art_00617a88 = art
    CALL engine_dosio.c_getFile_FUN_00481a50 ; 00431b61 | FILE * engine_dosio.c_getFile_FUN_00481a50(char * directory, char * filename, char * mode)
        ;   XREF to: 00481a50 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00431b66
    MOV ESI,EAX                         ; 00431b69
    TEST EAX,EAX                        ; 00431b6b
    JZ 0x00431bda                       ; 00431b6d | LAB_00431bda
        ;   XREF to: 00431bda (CONDITIONAL_JUMP)
    PUSH EAX                            ; 00431b6f
    PUSH 0x3                            ; 00431b70
    PUSH 0x100                          ; 00431b72
    PUSH EBX                            ; 00431b77
    CALL crt_stdio.c_fread_FUN_005fd990 ; 00431b78 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00431b7d
    CMP EAX,0x3                         ; 00431b80
    JZ 0x00431bbd                       ; 00431b83 | LAB_00431bbd
        ;   XREF to: 00431bbd (CONDITIONAL_JUMP)
    MOV EAX,ESP                         ; 00431b85
    PUSH EAX                            ; 00431b87
    PUSH 0x617a8c                       ; 00431b88 | = "Error reading %s." | s_Error_reading_s_00617a8c = Error reading %s.
    LEA EAX,[ESP + 0x58]                ; 00431b8d
    PUSH EAX                            ; 00431b91
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 00431b92 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    MOV EDX,0x617a9e                    ; 00431b97 | = "..\\cockpit\\ckptutil.c" | s_cockpit_ckptutil_c_00617a9e = ..\cockpit\ckptutil.c
    ADD ESP,0xc                         ; 00431b9c
    LEA EAX,[ESP + 0x50]                ; 00431b9f
    MOV ECX,0x13d                       ; 00431ba3
    PUSH EAX                            ; 00431ba8
    MOV dword ptr [0x02f0ca48],EDX      ; 00431ba9 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 00431baf | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00431bb5 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00431bba
    PUSH 0x140                          ; 00431bbd
        ;   Label: LAB_00431bbd
    PUSH 0x617ab4                       ; 00431bc2 | = "..\\cockpit\\ckptutil.c" | s_cockpit_ckptutil_c_00617ab4 = ..\cockpit\ckptutil.c
    PUSH ESI                            ; 00431bc7
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 00431bc8 | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
    ...
    MOV ECX,0x300                       ; 00431bda
        ;   Label: LAB_00431bda
    MOV ESI,0x2d02248                   ; 00431bdf | uchar[768] g_DefaultPalette
    MOV EDI,EBX                         ; 00431be4
    PUSH EDI                            ; 00431be6
    MOV EAX,ECX                         ; 00431be7
    SHR ECX,0x2                         ; 00431be9
    MOVSD.REP ES:EDI,ESI                ; 00431bec | uchar[768] g_DefaultPalette
    MOV CL,AL                           ; 00431bee
    AND CL,0x3                          ; 00431bf0
    MOVSB.REP ES:EDI,ESI                ; 00431bf3 | UCHAR_ARRAY_02d0224c
    POP EDI                             ; 00431bf5
