...
;                               FUNCTION
; *****************************************************************************
; __cdecl void cockpit_ckptutil.c_blitUnifiedSprite_FUN_00432300(void * sprite_data, void * span_data, int dest_x, int dest_y, int width, int height)
;
; Parameters:
...
section .text
    ...
    MOV EBX,dword ptr [0x02d02560]      ; 0043230f | int g_ClipRight
    MOV EAX,[0x02cf6aa0]                ; 00432315 | g_ScreenBufferArray[1]
    MOV EDI,dword ptr [0x02cf6a9c]      ; 0043231a | void *[1024] g_ScreenBufferArray
    MOV ESI,dword ptr [0x02d02558]      ; 00432320 | int g_ClipLeft
    SUB EBX,EDX                         ; 00432326
    SUB EAX,EDI                         ; 00432328
    SUB ESI,EDX                         ; 0043232a
    MOV dword ptr [ESP + 0xc],EAX       ; 0043232c
    TEST EBP,EBP                        ; 00432330
    JNZ 0x0043233c                      ; 00432332 | LAB_0043233c
    ...
    POP EBX                             ; 0043233a
    RET                                 ; 0043233b
    CALL cockpit_ckptutil.c_getColorConversionFunction_FUN_00431760 ; 0043233c | ColorConversionFunc * cockpit_ckptutil.c_getColorConversionFunction_FUN_00431760()
        ;   Label: LAB_0043233c
    ...
    CMP dword ptr [ESP + 0x44],0x0      ; 0043238a
        ;   Label: LAB_0043238a
    JZ 0x004323fa                       ; 0043238f | LAB_004323fa
    ...
    JGE 0x004323c2                      ; 004323a7 | LAB_004323c2
    ...
    JGE 0x00432414                      ; 004323b6 | LAB_00432414
        ;   XREF to: 00432414 (CONDITIONAL_JUMP)
    CMP EDX,ESI                         ; 004323b8
    JGE 0x00432412                      ; 004323ba | LAB_00432412
        ;   XREF to: 00432412 (CONDITIONAL_JUMP)
    INC EDI                             ; 004323bc
        ;   Label: LAB_004323bc
    ADD EBP,0x4                         ; 004323bd
    JMP 0x0043239d                      ; 004323c0 | LAB_0043239d
    ...
    JGE 0x00432334                      ; 004323f2 | LAB_00432334
        ;   XREF to: 00432334 (CONDITIONAL_JUMP)
    JMP 0x0043238a                      ; 004323f8 | LAB_0043238a
    ...
    JMP 0x0043239d                      ; 00432439 | LAB_0043239d
        ;   XREF to: 0043239d (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x48]      ; 0043243e
        ;   Label: LAB_0043243e
    MOV EDX,dword ptr [EBP + 0x2cf6a9c] ; 00432442 | void *[1024] g_ScreenBufferArray
    ...
    JLE 0x00432334                      ; 00432467 | LAB_00432334
        ;   XREF to: 00432334 (CONDITIONAL_JUMP)
    ...
    CMP dword ptr [ESP + 0x44],0x0      ; 0043247c
        ;   Label: LAB_0043247c
    JZ 0x004324eb                       ; 00432481 | LAB_004324eb
    ...
    JGE 0x004324b4                      ; 00432499 | LAB_004324b4
    ...
    JGE 0x00432505                      ; 004324a8 | LAB_00432505
        ;   XREF to: 00432505 (CONDITIONAL_JUMP)
    CMP EDX,ESI                         ; 004324aa
    JGE 0x00432503                      ; 004324ac | LAB_00432503
        ;   XREF to: 00432503 (CONDITIONAL_JUMP)
    INC EDI                             ; 004324ae
        ;   Label: LAB_004324ae
    ADD EBP,0x4                         ; 004324af
    JMP 0x0043248f                      ; 004324b2 | LAB_0043248f
    ...
    JGE 0x00432334                      ; 004324e3 | LAB_00432334
        ;   XREF to: 00432334 (CONDITIONAL_JUMP)
    JMP 0x0043247c                      ; 004324e9 | LAB_0043247c
    ...
    JMP 0x0043248f                      ; 0043252c | LAB_0043248f
        ;   XREF to: 0043248f (UNCONDITIONAL_JUMP)
