...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl cockpit_ckptutil_c_drawClippedEdges_FUN_004335f0(SEdge *edges,int count,int x_offset,int y_offset)
;
; Parameters:
...
section .text
    ...
    MOV dword ptr [0x02d02570],EDX      ; 00433602 | g_ActiveRenderColor
    TEST ECX,ECX                        ; 00433608
    JLE 0x004336cd                      ; 0043360a
        ;   XREF to: 004336cd (CONDITIONAL_JUMP)  ; LAB_004336cd
    MOV EBX,dword ptr [ESP + 0x18]      ; 00433610
    MOV AX,word ptr [EBX]               ; 00433614
        ;   Label: LAB_00433614
    MOV EBP,dword ptr [ESP + 0x20]      ; 00433617
    MOVSX ECX,AX                        ; 0043361b
    MOV EAX,[0x02d02558]                ; 0043361e | g_ClipLeft
    ADD ECX,EBP                         ; 00433623
    CMP ECX,EAX                         ; 00433625
    JGE 0x0043362b                      ; 00433627
        ;   XREF to: 0043362b (CONDITIONAL_JUMP)  ; LAB_0043362b
    MOV ECX,EAX                         ; 00433629
    MOV EDX,dword ptr [0x02d02560]      ; 0043362b | g_ClipRight
        ;   Label: LAB_0043362b
    CMP ECX,EDX                         ; 00433631
    JL 0x00433637                       ; 00433633
        ;   XREF to: 00433637 (CONDITIONAL_JUMP)  ; LAB_00433637
    MOV ECX,EDX                         ; 00433635
    MOV AX,word ptr [EBX + 0x2]         ; 00433637
        ;   Label: LAB_00433637
    MOV ESI,dword ptr [ESP + 0x24]      ; 0043363b
    MOVSX EDX,AX                        ; 0043363f
    MOV EBP,dword ptr [0x02d0255c]      ; 00433642 | g_ClipTop
    ADD EDX,ESI                         ; 00433648
    CMP EDX,EBP                         ; 0043364a
    JGE 0x00433650                      ; 0043364c
        ;   XREF to: 00433650 (CONDITIONAL_JUMP)  ; LAB_00433650
    MOV EDX,EBP                         ; 0043364e
    MOV EAX,[0x02d02564]                ; 00433650 | g_ClipBottom
        ;   Label: LAB_00433650
    CMP EDX,EAX                         ; 00433655
    JL 0x0043365b                       ; 00433657
        ;   XREF to: 0043365b (CONDITIONAL_JUMP)  ; LAB_0043365b
    MOV EDX,EAX                         ; 00433659
    MOV AX,word ptr [EBX + 0x4]         ; 0043365b
        ;   Label: LAB_0043365b
    MOV EBP,dword ptr [ESP + 0x20]      ; 0043365f
    MOVSX ESI,AX                        ; 00433663
    MOV EAX,[0x02d02558]                ; 00433666 | g_ClipLeft
    ADD ESI,EBP                         ; 0043366b
    CMP ESI,EAX                         ; 0043366d
    JGE 0x00433673                      ; 0043366f
        ;   XREF to: 00433673 (CONDITIONAL_JUMP)  ; LAB_00433673
    MOV ESI,EAX                         ; 00433671
    MOV EBP,dword ptr [0x02d02560]      ; 00433673 | g_ClipRight
        ;   Label: LAB_00433673
    CMP ESI,EBP                         ; 00433679
    JL 0x0043367f                       ; 0043367b
        ;   XREF to: 0043367f (CONDITIONAL_JUMP)  ; LAB_0043367f
    ...
    MOV EBP,dword ptr [0x02d0255c]      ; 00433699 | g_ClipTop
    CMP EAX,EBP                         ; 0043369f
    JGE 0x004336a5                      ; 004336a1
        ;   XREF to: 004336a5 (CONDITIONAL_JUMP)  ; LAB_004336a5
    MOV EAX,EBP                         ; 004336a3
    MOV EBP,dword ptr [0x02d02564]      ; 004336a5 | g_ClipBottom
        ;   Label: LAB_004336a5
    CMP EAX,EBP                         ; 004336ab
    JL 0x004336b1                       ; 004336ad
        ;   XREF to: 004336b1 (CONDITIONAL_JUMP)  ; LAB_004336b1
    ...
    PUSH EDX                            ; 004336b3
    PUSH ECX                            ; 004336b4
    CALL engine_2d.c_drawLine_FUN_004011b0 ; 004336b5
    ...
    JL 0x00433614                       ; 004336c7
        ;   XREF to: 00433614 (CONDITIONAL_JUMP)  ; LAB_00433614
