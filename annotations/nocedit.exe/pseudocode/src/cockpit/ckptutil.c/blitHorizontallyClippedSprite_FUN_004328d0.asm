...
section .text
    ...
    INC EAX                             ; 004328e9
    MOV EDX,dword ptr [0x02cf6a9c]      ; 004328ea | g_ScreenBufferArray
    ...
    JNZ 0x00432918                      ; 00432901
        ;   XREF to: 00432918 (CONDITIONAL_JUMP)  ; LAB_00432918
    ...
    POP EBX                             ; 00432916
    RET                                 ; 00432917
    CALL cockpit_ckptutil.c_getColorConversionFunction_FUN_00431760 ; 00432918
    ...
    MOV EAX,[0x00679394]                ; 00432928 | g_WindowWidth
    ...
    MOV EDX,dword ptr [0x0067939c]      ; 0043293d | g_BitsPerPixel
    ...
    JNZ 0x0043299c                      ; 00432955
        ;   XREF to: 0043299c (CONDITIONAL_JUMP)  ; LAB_0043299c
    MOV EDI,dword ptr [EAX + 0x2cf6a9c] ; 00432957 | g_ScreenBufferArray
    ADD EDI,ESI                         ; 0043295d
    MOV ESI,dword ptr [ESP + 0x34]      ; 0043295f
    MOV dword ptr [ESP + 0x8],ECX       ; 00432963
    CMP ECX,ESI                         ; 00432967
    JLE 0x00432910                      ; 00432969
        ;   XREF to: 00432910 (CONDITIONAL_JUMP)  ; LAB_00432910
    ...
    JL 0x0043296b                       ; 00432992
        ;   XREF to: 0043296b (CONDITIONAL_JUMP)  ; LAB_0043296b
    ...
    POP EBX                             ; 0043299a
    RET                                 ; 0043299b
    MOV EDI,dword ptr [EAX + 0x2cf6a9c] ; 0043299c | g_ScreenBufferArray
        ;   Label: LAB_0043299c
    ...
    JL 0x004329da                       ; 00432a01
        ;   XREF to: 004329da (CONDITIONAL_JUMP)  ; LAB_004329da
