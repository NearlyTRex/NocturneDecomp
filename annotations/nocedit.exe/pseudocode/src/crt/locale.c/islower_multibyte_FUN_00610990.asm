...
;                               FUNCTION
; *****************************************************************************
; __watcallStack int crt_locale.c_islower_multibyte_FUN_00610990(wchar_t character)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00610995
    CALL crt_locale.c_ismultibyte_FUN_00610a20 ; 00610996 | int crt_locale.c_ismultibyte_FUN_00610a20(wchar_t character)
        ;   XREF to: 00610a20 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0061099b
    TEST EAX,EAX                        ; 0061099e
    JZ 0x006109bd                       ; 006109a0 | LAB_006109bd
        ;   XREF to: 006109bd (CONDITIONAL_JUMP)
    CMP EBX,0x8281                      ; 006109a2
    JC 0x006109b9                       ; 006109a8 | LAB_006109b9
        ;   XREF to: 006109b9 (CONDITIONAL_JUMP)
    CMP EBX,0x829a                      ; 006109aa
    JA 0x006109b9                       ; 006109b0 | LAB_006109b9
        ;   XREF to: 006109b9 (CONDITIONAL_JUMP)
    ...
    MOV AL,byte ptr [EAX + 0x6849c4]    ; 006109c6 | char[256] g_CharacterClassificationTable
