...
section .text
    ...
    CMP dword ptr [0x03f9c020],0x0      ; 00610a74 | int g_MultibyteLocaleActive
    JZ 0x00610aa6                       ; 00610a7b | LAB_00610aa6
        ;   XREF to: 00610aa6 (CONDITIONAL_JUMP)
    CMP dword ptr [0x00685570],0x3a4    ; 00610a7d | uint g_CodePage
    JZ 0x00610a93                       ; 00610a87 | LAB_00610a93
        ;   XREF to: 00610a93 (CONDITIONAL_JUMP)
    TEST EAX,EAX                        ; 00610a89
    JZ 0x00610aa8                       ; 00610a8b | LAB_00610aa8
        ;   XREF to: 00610aa8 (CONDITIONAL_JUMP)
    MOV EAX,0x1                         ; 00610a8d
    RET                                 ; 00610a92
    AND EAX,0xff                        ; 00610a93
        ;   Label: LAB_00610a93
    MOV AL,byte ptr [EAX + 0x68562d]    ; 00610a98 | char[256] g_ShiftJIS_TrailByteTable
    AND AL,0x8                          ; 00610a9e
