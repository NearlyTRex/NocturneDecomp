...
section .text
    ...
    CMP dword ptr [0x03f9c020],0x0      ; 00610a24 | int g_MultibyteLocaleActive
    JZ 0x00610a60                       ; 00610a2b | LAB_00610a60
        ;   XREF to: 00610a60 (CONDITIONAL_JUMP)
    MOV EAX,EDX                         ; 00610a2d
    SHR EAX,0x8                         ; 00610a2f
    AND EAX,0xff                        ; 00610a32
    MOV AL,byte ptr [EAX + 0x3f9c031]   ; 00610a37 | char[256] g_LeadByteTable
    AND AL,0x1                          ; 00610a3d
    AND EAX,0xff                        ; 00610a3f
    JZ 0x00610a60                       ; 00610a44 | LAB_00610a60
        ;   XREF to: 00610a60 (CONDITIONAL_JUMP)
    MOV EAX,EDX                         ; 00610a46
    AND EAX,0xff                        ; 00610a48
    PUSH EAX                            ; 00610a4d
    CALL crt_locale.c_istrailbyte_FUN_00610a70 ; 00610a4e | int crt_locale.c_istrailbyte_FUN_00610a70(uchar byte_value)
        ;   XREF to: 00610a70 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00610a53
    TEST EAX,EAX                        ; 00610a56
    JZ 0x00610a60                       ; 00610a58 | LAB_00610a60
        ;   XREF to: 00610a60 (CONDITIONAL_JUMP)
