...
section .text
    ...
    PUSH EBX                            ; 0060ffb5
    CALL crt_locale.c_islower_multibyte_FUN_00610990 ; 0060ffb6 | int crt_locale.c_islower_multibyte_FUN_00610990(wchar_t character)
        ;   XREF to: 00610990 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060ffbb
    TEST EAX,EAX                        ; 0060ffbe
    JZ 0x0060ffc7                       ; 0060ffc0 | LAB_0060ffc7
