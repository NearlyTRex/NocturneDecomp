...
section .text
    ...
    CALL dword ptr CS:[0x6115c8]        ; 0060a570 | GetVersion * PTR_GetVersion_006115c8
    SHR EAX,0x10                        ; 0060a577
    AND EAX,0xffff                      ; 0060a57a
    CMP AX,0x8000                       ; 0060a57f
    JNC 0x0060a594                      ; 0060a583 | LAB_0060a594
        ;   XREF to: 0060a594 (CONDITIONAL_JUMP)
    PUSH EBP                            ; 0060a585
    PUSH ESI                            ; 0060a586
    PUSH EDI                            ; 0060a587
    CALL dword ptr CS:[0x6115b0]        ; 0060a588 | GetModuleFileNameW * PTR_GetModuleFileNameW_006115b0
    POP EBP                             ; 0060a58f
    POP EDI                             ; 0060a590
    POP ESI                             ; 0060a591
    POP EBX                             ; 0060a592
    ...
    PUSH 0x208                          ; 0060a594
        ;   Label: LAB_0060a594
    CALL crt_memory.c_malloc_FUN_00601bb0 ; 0060a599 | void * crt_memory.c_malloc_FUN_00601bb0(ulong size)
        ;   XREF to: 00601bb0 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 0060a59e
    ADD ESP,0x4                         ; 0060a5a0
    TEST EAX,EAX                        ; 0060a5a3
    JZ 0x0060a5ff                       ; 0060a5a5 | LAB_0060a5ff
        ;   XREF to: 0060a5ff (CONDITIONAL_JUMP)
    PUSH 0x208                          ; 0060a5a7
    PUSH EAX                            ; 0060a5ac
    PUSH EDI                            ; 0060a5ad
    CALL dword ptr CS:[0x6115ac]        ; 0060a5ae | GetModuleFileNameA * GetModuleFileNameA
    TEST EAX,EAX                        ; 0060a5b5
    JNZ 0x0060a5c9                      ; 0060a5b7 | LAB_0060a5c9
        ;   XREF to: 0060a5c9 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 0060a5b9
    CALL crt_memory.c_free_FUN_00601cd0 ; 0060a5ba | void crt_memory.c_free_FUN_00601cd0(void * ptr)
    ...
    PUSH 0x1                            ; 0060a5ce
    PUSH 0x1                            ; 0060a5d0
    CALL dword ptr CS:[0x6115f4]        ; 0060a5d2 | MultiByteToWideChar * PTR_MultiByteToWideChar_006115f4
    PUSH EBX                            ; 0060a5d9
    MOV EDI,EAX                         ; 0060a5da
    CALL crt_memory.c_free_FUN_00601cd0 ; 0060a5dc | void crt_memory.c_free_FUN_00601cd0(void * ptr)
        ;   XREF to: 00601cd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060a5e1
    TEST EDI,EDI                        ; 0060a5e4
    JNZ 0x0060a5ef                      ; 0060a5e6 | LAB_0060a5ef
    ...
    CALL crt_string.c_wcslen_FUN_0060cd30 ; 0060a5f7 | ulong crt_string.c_wcslen_FUN_0060cd30(LPWSTR str)
