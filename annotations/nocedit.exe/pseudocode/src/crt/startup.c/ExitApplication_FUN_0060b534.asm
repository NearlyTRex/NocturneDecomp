...
section .text
    ...
    CALL dword ptr [0x00685478]         ; 0060b534 | void * PTR_crt_exit.c_ExitHookStub_FUN_0060b530_00685478
        ;   Label: crt_startup.c_ExitApplication_FUN_0060b534
    CMP byte ptr [0x03f9b220],0x0       ; 0060b53a | int g_EmergencyExitFlag
    JNZ 0x0060b552                      ; 0060b541 | LAB_0060b552
        ;   XREF to: 0060b552 (CONDITIONAL_JUMP)
    MOV EDX,0xff                        ; 0060b543
    MOV EAX,0x10                        ; 0060b548
    CALL crt_exit.c_ProcessExitHandlers_FUN_0060ac88 ; 0060b54d | void crt_exit.c_ProcessExitHandlers_FUN_0060ac88(uchar min_priority, uchar max_priority)
        ;   XREF to: 0060ac88 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [ESP + 0x4]       ; 0060b552
        ;   Label: LAB_0060b552
    PUSH EDX                            ; 0060b556
    CALL crt_exit.c_FinalExitHandler_FUN_0060b560 ; 0060b557 | void crt_exit.c_FinalExitHandler_FUN_0060b560(int exit_code)
