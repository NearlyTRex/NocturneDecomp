...
;                               FUNCTION
; *****************************************************************************
; __cdecl void crt_thread.c_InitializeThreadContext_FUN_0060ccf0(ThreadData * pThreadData)
;
; Parameters:
...
section .text
    ...
    JZ 0x0060cd18                       ; 0060ccf7 | LAB_0060cd18
        ;   XREF to: 0060cd18 (CONDITIONAL_JUMP)
    PUSH 0x0                            ; 0060ccf9
    PUSH EBX                            ; 0060ccfb
    MOV dword ptr [EBX + 0xc],0x1       ; 0060ccfc
    CALL crt_memory.c_GetMemoryBounds_FUN_0060a6a0 ; 0060cd03 | void crt_memory.c_GetMemoryBounds_FUN_0060a6a0(ThreadData * pStackBound, uint * pHeapBound)
        ;   XREF to: 0060a6a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0060cd08
    CALL dword ptr CS:[0x611584]        ; 0060cd0b | GetCurrentThreadId * PTR_GetCurrentThreadId_00611584
