...
section .text
    ...
    JNZ 0x0060a26c                      ; 0060a243 | LAB_0060a26c
        ;   XREF to: 0060a26c (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x006854f8]      ; 0060a245 | DWORD g_RuntimeBufferSize
    PUSH EDX                            ; 0060a24b
    PUSH 0x1                            ; 0060a24c
    CALL crt_memory.c_calloc_FUN_0060ca90 ; 0060a24e | void * crt_memory.c_calloc_FUN_0060ca90(ulong count, ulong size)
        ;   XREF to: 0060ca90 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0060a253
    MOV EBX,EAX                         ; 0060a256
    TEST EAX,EAX                        ; 0060a258
    JZ 0x0060a26c                       ; 0060a25a | LAB_0060a26c
        ;   XREF to: 0060a26c (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x006854f8]      ; 0060a25c | DWORD g_RuntimeBufferSize
    MOV byte ptr [EAX + 0x52],0x1       ; 0060a262
    MOV dword ptr [EAX + 0xf0],EDX      ; 0060a266
    PUSH EBX                            ; 0060a26c
        ;   Label: LAB_0060a26c
    CALL crt_thread.c_InitializeThreadContext_FUN_0060ccf0 ; 0060a26d | void crt_thread.c_InitializeThreadContext_FUN_0060ccf0(ThreadData * pThreadData)
