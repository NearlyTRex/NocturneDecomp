...
;                               FUNCTION
; *****************************************************************************
; __cdecl void crt_exception.c_installExceptionHandler_FUN_0060aba8(ExceptionFrame * pExceptionFrame)
;
;
; XREF[2]:
...
section .text
    ...
    CALL dword ptr [0x00684ee4]         ; 0060abad | GET_TLS_FUNC * PTR_crt_thread.c_GetTLS_FUN_0060242c_00684ee4
    MOV dword ptr [EAX + 0x54],EBX      ; 0060abb3
    XOR EAX,EAX                         ; 0060abb6
    MOV EAX,dword ptr FS:[EAX]          ; 0060abb8
    MOV EBX,EAX                         ; 0060abbb
    CALL dword ptr [0x00684ee4]         ; 0060abbd | GET_TLS_FUNC * PTR_crt_thread.c_GetTLS_FUN_0060242c_00684ee4
    MOV EAX,dword ptr [EAX + 0x54]      ; 0060abc3
    MOV dword ptr [EAX],EBX             ; 0060abc6
    CALL dword ptr [0x00684ee4]         ; 0060abc8 | GET_TLS_FUNC * PTR_crt_thread.c_GetTLS_FUN_0060242c_00684ee4
    MOV EAX,dword ptr [EAX + 0x54]      ; 0060abce
    MOV dword ptr [EAX + 0x4],0x60a9d8  ; 0060abd1
    CALL dword ptr [0x00684ee4]         ; 0060abd8 | GET_TLS_FUNC * PTR_crt_thread.c_GetTLS_FUN_0060242c_00684ee4
    ...
    CALL dword ptr CS:[0x611640]        ; 0060abeb | SetUnhandledExceptionFilter * PTR_SetUnhandledExceptionFilter_00611640
    POP EBX                             ; 0060abf2
    RET                                 ; 0060abf3
