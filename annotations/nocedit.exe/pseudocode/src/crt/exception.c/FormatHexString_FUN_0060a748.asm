...
section .text
    ...
    TEST CL,CL                          ; 0060a756
    JZ 0x0060a762                       ; 0060a758 | LAB_0060a762
        ;   XREF to: 0060a762 (CONDITIONAL_JUMP)
    MOV CH,byte ptr [EAX + 0x1]         ; 0060a75a
        ;   Label: LAB_0060a75a
    INC EAX                             ; 0060a75d
    TEST CH,CH                          ; 0060a75e
    JNZ 0x0060a75a                      ; 0060a760 | LAB_0060a75a
