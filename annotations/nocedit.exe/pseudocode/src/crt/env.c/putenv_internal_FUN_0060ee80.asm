...
;                               FUNCTION
; *****************************************************************************
; __cdecl int crt_env.c_putenv_internal_FUN_0060ee80(char * envstr)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 0060eed5
    CALL crt_memory.c_malloc_FUN_00601bb0 ; 0060eed6 | void * crt_memory.c_malloc_FUN_00601bb0(ulong size)
    ...
    JNZ 0x0060eef5                      ; 0060eee6 | LAB_0060eef5
    ...
    CALL crt_unknown.c_FUN_0060fa90     ; 0060ef1d | undefined crt_unknown.c_FUN_0060fa90()
        ;   XREF to: 0060fa90 (UNCONDITIONAL_CALL)
    MOV EBP,EAX                         ; 0060ef22
    ADD ESP,0x4                         ; 0060ef24
    TEST EAX,EAX                        ; 0060ef27
    JZ 0x0060ef6f                       ; 0060ef29 | LAB_0060ef6f
        ;   XREF to: 0060ef6f (CONDITIONAL_JUMP)
    INC EAX                             ; 0060ef2b
    PUSH EAX                            ; 0060ef2c
    CALL crt_memory.c_malloc_FUN_00601bb0 ; 0060ef2d | void * crt_memory.c_malloc_FUN_00601bb0(ulong size)
        ;   XREF to: 00601bb0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060ef32
    MOV EDX,EAX                         ; 0060ef35
    MOV dword ptr [ESP + 0xc],EAX       ; 0060ef37
    TEST EAX,EAX                        ; 0060ef3b
    JNZ 0x0060ef4f                      ; 0060ef3d | LAB_0060ef4f
        ;   XREF to: 0060ef4f (CONDITIONAL_JUMP)
    PUSH EBX                            ; 0060ef3f
    CALL crt_memory.c_free_FUN_00601cd0 ; 0060ef40 | void crt_memory.c_free_FUN_00601cd0(void * ptr)
        ;   XREF to: 00601cd0 (UNCONDITIONAL_CALL)
    MOV EAX,0xffffffff                  ; 0060ef45
    JMP 0x0060f041                      ; 0060ef4a | LAB_0060f041
    ...
    JMP 0x0060ef73                      ; 0060ef6d | LAB_0060ef73
    ...
    PUSH EDX                            ; 0060ef7c
    CALL dword ptr CS:[0x61161c]        ; 0060ef7d | SetEnvironmentVariableA * PTR_SetEnvironmentVariableA_0061161c
    MOV ECX,dword ptr [ESP + 0x8]       ; 0060ef84
    PUSH ECX                            ; 0060ef88
    MOV EBX,EAX                         ; 0060ef89
    CALL crt_memory.c_free_FUN_00601cd0 ; 0060ef8b | void crt_memory.c_free_FUN_00601cd0(void * ptr)
        ;   XREF to: 00601cd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060ef90
    MOV ESI,dword ptr [ESP + 0xc]       ; 0060ef93
    PUSH ESI                            ; 0060ef97
    CALL crt_memory.c_free_FUN_00601cd0 ; 0060ef98 | void crt_memory.c_free_FUN_00601cd0(void * ptr)
        ;   XREF to: 00601cd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060ef9d
    TEST EBX,EBX                        ; 0060efa0
    JNZ 0x0060efb1                      ; 0060efa2 | LAB_0060efb1
    ...
    MOV EDI,dword ptr [ESP + 0x28]      ; 0060efb1
        ;   Label: LAB_0060efb1
    PUSH EDI                            ; 0060efb5
    CALL crt_env.c_updateEnvironTable_FUN_0060f04c ; 0060efb6 | int crt_env.c_updateEnvironTable_FUN_0060f04c(char * envstr)
        ;   XREF to: 0060f04c (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060efbb
    TEST EAX,EAX                        ; 0060efbe
    JZ 0x0060efcf                       ; 0060efc0 | LAB_0060efcf
    ...
    POP EBX                             ; 0060efcd
    RET                                 ; 0060efce
    CMP dword ptr [0x03f9b868],0x0      ; 0060efcf | int g_EnvironInitialized
        ;   Label: LAB_0060efcf
    JZ 0x0060f044                       ; 0060efd6 | LAB_0060f044
        ;   XREF to: 0060f044 (CONDITIONAL_JUMP)
    PUSH EDI                            ; 0060efd8
    CALL crt_unknown.c_FUN_0060fa90     ; 0060efd9 | undefined crt_unknown.c_FUN_0060fa90()
        ;   XREF to: 0060fa90 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0060efeb
    CALL crt_memory.c_malloc_FUN_00601bb0 ; 0060efec | void * crt_memory.c_malloc_FUN_00601bb0(ulong size)
        ;   XREF to: 00601bb0 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 0060eff1
    ADD ESP,0x4                         ; 0060eff3
    TEST EAX,EAX                        ; 0060eff6
    JNZ 0x0060f011                      ; 0060eff8 | LAB_0060f011
        ;   XREF to: 0060f011 (CONDITIONAL_JUMP)
    PUSH 0x5                            ; 0060effa
    CALL crt_errno.c_convertWindowsErrorToErrno_FUN_00608390 ; 0060effc | int crt_errno.c_convertWindowsErrorToErrno_FUN_00608390(DWORD windows_error)
    ...
    PUSH EDI                            ; 0060f016
    PUSH EAX                            ; 0060f017
    CALL crt_unknown.c_FUN_0060fac0     ; 0060f018 | undefined crt_unknown.c_FUN_0060fac0()
        ;   XREF to: 0060fac0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0060f01d
    CMP EAX,-0x1                        ; 0060f020
    JNZ 0x0060f03b                      ; 0060f023 | LAB_0060f03b
        ;   XREF to: 0060f03b (CONDITIONAL_JUMP)
    PUSH EBX                            ; 0060f025
    CALL crt_memory.c_free_FUN_00601cd0 ; 0060f026 | void crt_memory.c_free_FUN_00601cd0(void * ptr)
        ;   XREF to: 00601cd0 (UNCONDITIONAL_CALL)
    ...
    PUSH EBX                            ; 0060f03b
        ;   Label: LAB_0060f03b
    CALL crt_unknown.c_FUN_0060fcf4     ; 0060f03c | undefined crt_unknown.c_FUN_0060fcf4()
