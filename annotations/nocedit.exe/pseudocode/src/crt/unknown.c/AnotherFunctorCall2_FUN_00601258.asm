...
section .text
    ...
    PUSH EBX                            ; 00601267
    CALL crt_memory.c_dispatchObjectArrayConstructor_FUN_00601200 ; 00601268 | void * crt_memory.c_dispatchObjectArrayConstructor_FUN_00601200(void * array_ptr, int element_count, WatcomTypeInfo * type_info)
