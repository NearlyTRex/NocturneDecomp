...
section .text
    ...
    PUSH EDI                            ; 00600992
    PUSH EBP                            ; 00600993
    MOV ECX,dword ptr [0x00684ed4]      ; 00600994 | Heap * g_MainHeap
    XOR EBX,EBX                         ; 0060099a
    TEST ECX,ECX                        ; 0060099c
    JZ 0x00600a55                       ; 0060099e | LAB_00600a55
    ...
    JZ 0x006009e0                       ; 006009d4 | LAB_006009e0
    ...
    JZ 0x00600a13                       ; 00600a07 | LAB_00600a13
    ...
    TEST byte ptr [EBP],0x1             ; 00600a13
        ;   Label: LAB_00600a13
    JZ 0x00600a23                       ; 00600a17 | LAB_00600a23
    ...
    JNC 0x00600a36                      ; 00600a2a | LAB_00600a36
