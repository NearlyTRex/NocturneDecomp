...
;                               FUNCTION
; *****************************************************************************
; unknown undefined crt_unknown.c_FUN_0060fa90()
;
;
; XREF[2]:
...
section .text
    ...
    PUSH EBX                            ; 0060fa98
        ;   Label: LAB_0060fa98
    CALL crt_string.c_mbstring_termination_check_FUN_0060b630 ; 0060fa99 | int crt_string.c_mbstring_termination_check_FUN_0060b630(char * str)
        ;   XREF to: 0060b630 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060fa9e
    TEST EAX,EAX                        ; 0060faa1
    JNZ 0x0060fab3                      ; 0060faa3 | LAB_0060fab3
        ;   XREF to: 0060fab3 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 0060faa5
    CALL crt_string.c_mbtowc_next_FUN_00605a70 ; 0060faa6 | char * crt_string.c_mbtowc_next_FUN_00605a70(char * str)
        ;   XREF to: 00605a70 (UNCONDITIONAL_CALL)
    INC ESI                             ; 0060faab
    ADD ESP,0x4                         ; 0060faac
    MOV EBX,EAX                         ; 0060faaf
    JMP 0x0060fa98                      ; 0060fab1 | LAB_0060fa98
