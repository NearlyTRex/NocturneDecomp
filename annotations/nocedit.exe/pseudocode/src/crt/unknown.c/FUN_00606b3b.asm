...
;                               FUNCTION
; *****************************************************************************
; unknown undefined crt_unknown.c_FUN_00606b3b()
;
; Parameters:
...
section .text
    ...
    CALL crt_math.c_ieee754_divide_FUN_00606960 ; 00606b4a | float10 crt_math.c_ieee754_divide_FUN_00606960(float10 dividend, float10 divisor)
