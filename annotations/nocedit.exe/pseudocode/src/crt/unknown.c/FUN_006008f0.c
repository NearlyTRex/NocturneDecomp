// Name: crt_unknown.c_FUN_006008f0
// Address: 006008f0
// Address Range: [[006008f0, 00600930]]
// Convention: unknown
// Signature: undefined crt_unknown.c_FUN_006008f0()
// Cross-references:
//   shape_design.c_FUN_0046e6f0 (0046e6f0) at 0046e6fc [UNCONDITIONAL_CALL]
// Globals:
...
int crt_unknown_c_FUN_006008f0(void)

{
  ...
  for (pHVar2 = g_MainHeap; pHVar2 != (Heap *)0x0; pHVar2 = pHVar2->next_heap_block) {
    for (piVar1 = (int *)pHVar2[3].heap_base; (Heap **)piVar1 != &pHVar2[2].next_heap_block;
        piVar1 = (int *)piVar1[2]) {
      iVar3 = iVar3 + (*piVar1 - 4U & 0xfffffff8);
    }
  }
...
// Assembly code:
// 006008f0: PUSH EBX
//   Label: crt_unknown.c_FUN_006008f0
// 006008f1: PUSH ESI
