...
;                               FUNCTION
; *****************************************************************************
; unknown undefined crt_unknown.c_FUN_0060af5d()
;
; Local Variables:
...
section .text
    ...
    JNZ 0x0060afa9                      ; 0060af84 | LAB_0060afa9
        ;   XREF to: 0060afa9 (CONDITIONAL_JUMP)
    TEST ESI,ESI                        ; 0060af86
    JNZ 0x0060af8f                      ; 0060af88 | LAB_0060af8f
        ;   XREF to: 0060af8f (CONDITIONAL_JUMP)
    ...
    JMP 0x0060afc8                      ; 0060afa7 | LAB_0060afc8
        ;   XREF to: 0060afc8 (UNCONDITIONAL_JUMP)
    CMP EAX,0x45                        ; 0060afa9
        ;   Label: LAB_0060afa9
    JNZ 0x0060afbb                      ; 0060afac | LAB_0060afbb
        ;   XREF to: 0060afbb (CONDITIONAL_JUMP)
    MOV ECX,0x1                         ; 0060afae
    MOV dword ptr [EBP + -0x44],ECX     ; 0060afb3
    MOV dword ptr [EBP + -0x48],ECX     ; 0060afb6
    JMP 0x0060afc8                      ; 0060afb9 | LAB_0060afc8
        ;   XREF to: 0060afc8 (UNCONDITIONAL_JUMP)
    ...
    TEST byte ptr [EBX + 0x1e],0x1      ; 0060afc8
        ;   Label: LAB_0060afc8
    JZ 0x0060afd2                       ; 0060afcc | LAB_0060afd2
        ;   XREF to: 0060afd2 (CONDITIONAL_JUMP)
    ...
    JNZ 0x0060affb                      ; 0060aff4 | LAB_0060affb
        ;   XREF to: 0060affb (CONDITIONAL_JUMP)
    ...
    CALL crt_unknown.c_FUN_00603dc8     ; 0060b00f | undefined crt_unknown.c_FUN_00603dc8()
    ...
    JGE 0x0060b045                      ; 0060b034 | LAB_0060b045
        ;   XREF to: 0060b045 (CONDITIONAL_JUMP)
    ...
    JMP 0x0060b06e                      ; 0060b043 | LAB_0060b06e
        ;   XREF to: 0060b06e (UNCONDITIONAL_JUMP)
    MOV CH,byte ptr [EBX + 0x1e]        ; 0060b045
        ;   Label: LAB_0060b045
    TEST CH,0x4                         ; 0060b048
    JZ 0x0060b05c                       ; 0060b04b | LAB_0060b05c
        ;   XREF to: 0060b05c (CONDITIONAL_JUMP)
    ...
    JMP 0x0060b06e                      ; 0060b05a | LAB_0060b06e
        ;   XREF to: 0060b06e (UNCONDITIONAL_JUMP)
    TEST CH,0x2                         ; 0060b05c
        ;   Label: LAB_0060b05c
    JZ 0x0060b06e                       ; 0060b05f | LAB_0060b06e
        ;   XREF to: 0060b06e (CONDITIONAL_JUMP)
