...
;                               FUNCTION
; *****************************************************************************
; unknown undefined crt_unknown.c_FUN_0060e0b9()
;
; Local Variables:
...
;
; XREF[1]:
;   crt_unknown.c_staticInit_FUN_0060be80 at 0060bec7
;
; Referenced Globals:
...
section .text
    ...
    JNZ 0x0060e0c4                      ; 0060e0bb | LAB_0060e0c4
        ;   XREF to: 0060e0c4 (CONDITIONAL_JUMP)
    ADD EDX,EDX                         ; 0060e0bd
    JNZ 0x0060e0c2                      ; 0060e0bf | LAB_0060e0c2
    ...
    OR EBX,EBX                          ; 0060e0c4
        ;   Label: LAB_0060e0c4
    JNZ 0x0060e0d3                      ; 0060e0c6 | LAB_0060e0d3
        ;   XREF to: 0060e0d3 (CONDITIONAL_JUMP)
    ADD ECX,ECX                         ; 0060e0c8
    JNZ 0x0060e0d1                      ; 0060e0ca | LAB_0060e0d1
    ...
    RCR ECX,0x1                         ; 0060e0d1
        ;   Label: LAB_0060e0d1
    CMP byte ptr [0x00684acd],0x0       ; 0060e0d3 | undefined1 DAT_00684acd
        ;   Label: LAB_0060e0d3
    JZ 0x0060e0eb                       ; 0060e0da | LAB_0060e0eb
    ...
    JMP 0x0060df2e                      ; 0060e0e6 | LAB_0060df2e
    ...
    OR DI,DI                            ; 0060e11f
    JNZ 0x0060e134                      ; 0060e122 | LAB_0060e134
    ...
    JZ 0x0060e126                       ; 0060e132 | LAB_0060e126
        ;   XREF to: 0060e126 (CONDITIONAL_JUMP)
    OR EDX,0x100000                     ; 0060e134
        ;   Label: LAB_0060e134
    OR CX,CX                            ; 0060e13a
    JNZ 0x0060e14f                      ; 0060e13d | LAB_0060e14f
    ...
    CMP CX,-0x35                        ; 0060e170
        ;   Label: LAB_0060e170
    JGE 0x0060e17e                      ; 0060e174 | LAB_0060e17e
    ...
    TEST EDX,0x200000                   ; 0060e1cf
        ;   Label: LAB_0060e1cf
    JZ 0x0060e1e8                       ; 0060e1d5 | LAB_0060e1e8
    ...
    JZ 0x0060e24c                       ; 0060e1e4 | LAB_0060e24c
        ;   XREF to: 0060e24c (CONDITIONAL_JUMP)
    JMP 0x0060e1cf                      ; 0060e1e6 | LAB_0060e1cf
        ;   XREF to: 0060e1cf (UNCONDITIONAL_JUMP)
    ADD EBX,EBX                         ; 0060e1e8
        ;   Label: LAB_0060e1e8
    JNC 0x0060e216                      ; 0060e1ea | LAB_0060e216
        ;   XREF to: 0060e216 (CONDITIONAL_JUMP)
    JNZ 0x0060e1fb                      ; 0060e1ec | LAB_0060e1fb
        ;   XREF to: 0060e1fb (CONDITIONAL_JUMP)
    OR ESI,ESI                          ; 0060e1ee
    SETNZ BL                            ; 0060e1f0
    SHR EBX,0x1                         ; 0060e1f3
    JC 0x0060e1fb                       ; 0060e1f5 | LAB_0060e1fb
        ;   XREF to: 0060e1fb (CONDITIONAL_JUMP)
    ...
    JZ 0x0060e216                       ; 0060e207 | LAB_0060e216
        ;   XREF to: 0060e216 (CONDITIONAL_JUMP)
    SHR EDX,0x1                         ; 0060e209
    RCR EAX,0x1                         ; 0060e20b
    INC CX                              ; 0060e20d
    CMP CX,0x7ff                        ; 0060e20f
    JZ 0x0060e24c                       ; 0060e214 | LAB_0060e24c
        ;   XREF to: 0060e24c (CONDITIONAL_JUMP)
    OR CX,CX                            ; 0060e216
        ;   Label: LAB_0060e216
    JG 0x0060e231                       ; 0060e219 | LAB_0060e231
        ;   XREF to: 0060e231 (CONDITIONAL_JUMP)
    JNZ 0x0060e221                      ; 0060e21b | LAB_0060e221
        ;   XREF to: 0060e221 (CONDITIONAL_JUMP)
    MOV CL,0x1                          ; 0060e21d
    JMP 0x0060e226                      ; 0060e21f | LAB_0060e226
