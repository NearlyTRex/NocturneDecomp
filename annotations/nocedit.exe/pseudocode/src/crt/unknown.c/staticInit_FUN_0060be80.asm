...
;                               FUNCTION
; *****************************************************************************
; unknown undefined crt_unknown.c_staticInit_FUN_0060be80()
;
; Local Variables:
...
section .text
    ...
    CMP byte ptr [0x00684acd],0x3       ; 0060bea3 | undefined1 DAT_00684acd
    JC 0x0060bef5                       ; 0060beaa | LAB_0060bef5
    ...
    CALL crt_unknown.c_FUN_0060dcf6     ; 0060bebb | undefined crt_unknown.c_FUN_0060dcf6()
        ;   XREF to: 0060dcf6 (UNCONDITIONAL_CALL)
    MOV EBX,dword ptr [ESP]             ; 0060bec0
    MOV ECX,dword ptr [ESP + 0x4]       ; 0060bec3
    CALL crt_unknown.c_FUN_0060e0b9     ; 0060bec7 | undefined crt_unknown.c_FUN_0060e0b9()
    ...
    CALL crt_unknown.c_FUN_0060defc     ; 0060bed8 | undefined crt_unknown.c_FUN_0060defc()
        ;   XREF to: 0060defc (UNCONDITIONAL_CALL)
    MOV EBX,0xe2308c3a                  ; 0060bedd
    MOV ECX,0x3e45798e                  ; 0060bee2
    CALL crt_unknown.c_FUN_0060e256     ; 0060bee7 | undefined crt_unknown.c_FUN_0060e256()
        ;   XREF to: 0060e256 (UNCONDITIONAL_CALL)
    JLE 0x0060bef5                      ; 0060beec | LAB_0060bef5
        ;   XREF to: 0060bef5 (CONDITIONAL_JUMP)
    OR byte ptr [0x00685060],0x1        ; 0060beee | byte g_UseSoftwareMath
