...
;                               FUNCTION
; *****************************************************************************
; unknown undefined crt_unknown.c_FUN_00606d9f()
;
; Parameters:
...
section .text
    ...
    CALL crt_math.c_ieee754_divide_FUN_00606960 ; 00606da8 | float10 crt_math.c_ieee754_divide_FUN_00606960(float10 dividend, float10 divisor)
