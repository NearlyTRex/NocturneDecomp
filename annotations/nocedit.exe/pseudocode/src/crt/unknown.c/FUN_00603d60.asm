...
;                               FUNCTION
; *****************************************************************************
; unknown undefined crt_unknown.c_FUN_00603d60()
;
;
; XREF[2]:
...
section .text
    ...
    PUSH ESI                            ; 00603da4
    CALL crt_unknown.c_CondCallDoNothing_FUN_00603ccc ; 00603da5 | undefined crt_unknown.c_CondCallDoNothing_FUN_00603ccc()
        ;   XREF to: 00603ccc (UNCONDITIONAL_CALL)
