...
// Convention: unknown
// Signature: void crt_unknown_c_FUN_00604478(int *param_1,undefined4 *param_2,uint param_3,int param_4,undefined4 *param_5)

#include "nocturne.h"

void FUN_00604478(int *param_1,uint *param_2,uint param_3,int param_4,uint *param_5)

{
  ...
  iVar1 = param_1[1];
  if (iVar1 < 1) {
    local_18 = *param_1 + iVar1;
  }
  else {
    local_18 = (*param_1 - iVar1) + 1;
  }
  ...
  if ((int)local_14 < 1) {
    ...
    *(byte *)param_5 = 0x30;
    ...
    if ((int)local_14 < param_1[1]) {
      count = param_1[1] - local_14;
      memset((byte *)((int)param_5 + local_14),0x30,count);
      local_14 = local_14 + count;
    }
  }
  param_1[6] = local_14;
  uVar6 = local_14;
