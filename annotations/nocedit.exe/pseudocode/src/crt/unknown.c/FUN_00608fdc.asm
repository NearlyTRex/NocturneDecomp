...
;                               FUNCTION
; *****************************************************************************
; unknown undefined crt_unknown.c_FUN_00608fdc()
;
;
; XREF[1]:
...
section .text
    ...
    MOV EDI,0x684cc4                    ; 00608ff1 | FILE * g_StaticFilePoolStart
    ADD EAX,EAX                         ; 00608ff6
    ADD EDI,EAX                         ; 00608ff8
    MOV EAX,[0x03f9b200]                ; 00608ffa | FileListNode * g_AllocatedListHead
    XOR EBX,EBX                         ; 00608fff
    TEST EAX,EAX                        ; 00609001
    JZ 0x0060903a                       ; 00609003 | LAB_0060903a
    ...
    PUSH EAX                            ; 0060902a
    INC EBX                             ; 0060902b
    CALL crt_stdio.c_closeAndDeallocateFile_FUN_00601ee4 ; 0060902c | int crt_stdio.c_closeAndDeallocateFile_FUN_00601ee4(FILE * file_handle, int close_flags)
        ;   XREF to: 00601ee4 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00609031
    MOV EAX,ESI                         ; 00609034
        ;   Label: LAB_00609034
    TEST ESI,ESI                        ; 00609036
    JNZ 0x00609005                      ; 00609038 | LAB_00609005
