...
;                               FUNCTION
; *****************************************************************************
; unknown uint crt_unknown_c_FUN_00600a64(byte *param_1)
;
;
; XREF[1]:
...
section .text
    ...
    JNZ 0x00600a93                      ; 00600a8c
        ;   XREF to: 00600a93 (CONDITIONAL_JUMP)  ; LAB_00600a93
    CMP ECX,dword ptr [EAX + 0x8]       ; 00600a8e
    JZ 0x00600a9c                       ; 00600a91
        ;   XREF to: 00600a9c (CONDITIONAL_JUMP)  ; LAB_00600a9c
    ...
    JNZ 0x00600ab0                      ; 00600aa7
        ;   XREF to: 00600ab0 (CONDITIONAL_JUMP)  ; LAB_00600ab0
    MOV EBP,dword ptr [EBX + 0x8]       ; 00600aa9
    CMP EAX,EBP                         ; 00600aac
    JZ 0x00600ab9                       ; 00600aae
        ;   XREF to: 00600ab9 (CONDITIONAL_JUMP)  ; LAB_00600ab9
    ...
    CMP EDI,EDI                         ; 00600ab9
        ;   Label: LAB_00600ab9
    JNZ 0x00600ac1                      ; 00600abb
        ;   XREF to: 00600ac1 (CONDITIONAL_JUMP)  ; LAB_00600ac1
    CMP EBP,EBP                         ; 00600abd
    JZ 0x00600aca                       ; 00600abf
        ;   XREF to: 00600aca (CONDITIONAL_JUMP)  ; LAB_00600aca
