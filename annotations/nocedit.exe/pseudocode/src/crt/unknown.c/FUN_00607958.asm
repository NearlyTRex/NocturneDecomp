...
section .text
    ...
    POP EBX                             ; 00607980
    RET                                 ; 00607981
    JL 0x006079ab                       ; 00607982 | LAB_006079ab
        ;   Label: LAB_00607982
    ...
    PUSH EBP                            ; 00607988
    PUSH EAX                            ; 00607989
    CALL crt_unknown.c_FUN_00607858     ; 0060798a | undefined crt_unknown.c_FUN_00607858()
        ;   XREF to: 00607858 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0060798f
    PUSH EBP                            ; 00607992
    PUSH ESI                            ; 00607993
    MOV EBX,EAX                         ; 00607994
    CALL crt_unknown.c_FUN_00607858     ; 00607996 | undefined crt_unknown.c_FUN_00607858()
        ;   XREF to: 00607858 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0060799b
    CMP EBX,EAX                         ; 0060799e
    JLE 0x006079ab                      ; 006079a0 | LAB_006079ab
        ;   XREF to: 006079ab (CONDITIONAL_JUMP)
