...
section .text
    ...
    PUSH EBX                            ; 0060e5db
        ;   Label: LAB_0060e5db
    CALL crt_string.c_mbstring_termination_check_FUN_0060b630 ; 0060e5dc | int crt_string.c_mbstring_termination_check_FUN_0060b630(char * str)
        ;   XREF to: 0060b630 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060e5e1
    TEST EAX,EAX                        ; 0060e5e4
    JNZ 0x0060e62f                      ; 0060e5e6 | LAB_0060e62f
        ;   XREF to: 0060e62f (CONDITIONAL_JUMP)
    PUSH EBX                            ; 0060e5e8
    CALL crt_string.c_mbtowc_peek_FUN_006059e0 ; 0060e5e9 | wchar_t crt_string.c_mbtowc_peek_FUN_006059e0(char * str)
        ;   XREF to: 006059e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060e5ee
    PUSH EAX                            ; 0060e5f1
    CALL crt_locale.c_toupper_multibyte_FUN_0060f300 ; 0060e5f2 | wchar_t crt_locale.c_toupper_multibyte_FUN_0060f300(char * mb_char, char * output_buffer)
        ;   XREF to: 0060f300 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060e5f7
    MOV EDX,ESP                         ; 0060e5fa
    PUSH EDX                            ; 0060e5fc
    PUSH EAX                            ; 0060e5fd
    CALL crt_locale.c_wchar_to_bytes_FUN_00605a20 ; 0060e5fe | void crt_locale.c_wchar_to_bytes_FUN_00605a20(wchar_t character, char * output_buffer)
        ;   XREF to: 00605a20 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0060e603
    MOV EAX,ESP                         ; 0060e606
    PUSH EAX                            ; 0060e608
    CALL crt_locale.c_mblen_FUN_00605a40 ; 0060e609 | int crt_locale.c_mblen_FUN_00605a40(char * mb_string)
    ...
    PUSH EAX                            ; 0060e618
    PUSH EBX                            ; 0060e619
    CALL crt_mbstring.c_copyMbChar_FUN_0060e590 ; 0060e61a | void crt_mbstring.c_copyMbChar_FUN_0060e590(char * dest, char * src)
        ;   XREF to: 0060e590 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0060e61f
    PUSH EBX                            ; 0060e622
    CALL crt_string.c_mbtowc_next_FUN_00605a70 ; 0060e623 | char * crt_string.c_mbtowc_next_FUN_00605a70(char * str)
        ;   XREF to: 00605a70 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 0060e628
    ADD ESP,0x4                         ; 0060e62a
    JMP 0x0060e5db                      ; 0060e62d | LAB_0060e5db
