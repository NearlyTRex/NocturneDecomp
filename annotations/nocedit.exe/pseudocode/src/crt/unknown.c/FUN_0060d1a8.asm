...
section .text
    ...
    CALL dword ptr [0x00684ee4]         ; 0060d1b1 | GET_TLS_FUNC * PTR_crt_thread.c_GetTLS_FUN_0060242c_00684ee4
        ;   Label: LAB_0060d1b1
    ...
    MOVSD ES:EDI,ESI                    ; 0060d1ca | g_GlobalSignalHandlers[2]
    MOVSD ES:EDI,ESI                    ; 0060d1cb | g_GlobalSignalHandlers[3]
    CMP EBX,0x68                        ; 0060d1cc
    JNZ 0x0060d1b1                      ; 0060d1cf | LAB_0060d1b1
        ;   XREF to: 0060d1b1 (CONDITIONAL_JUMP)
    MOV EDX,0x60cefc                    ; 0060d1d1 | LAB_0060cefc
    MOV EBX,0x60d128                    ; 0060d1d6
    MOV dword ptr [0x006853f0],EDX      ; 0060d1db | EXCEPTION_FILTER_FUNC * g_UserExceptionFilter
    MOV dword ptr [0x006853f4],EBX      ; 0060d1e1 | EXCEPTION_CLEANUP_FUNC * g_ExceptionCleanup
    POP ES                              ; 0060d1e7
    POP EDI                             ; 0060d1e8
    POP ESI                             ; 0060d1e9
    POP EBX                             ; 0060d1ea
