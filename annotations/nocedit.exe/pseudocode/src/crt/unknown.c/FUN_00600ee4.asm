...
;                               FUNCTION
; *****************************************************************************
; unknown undefined crt_unknown.c_FUN_00600ee4()
;
;
; XREF[2]:
...
section .text
    ...
    PUSH 0x1                            ; 00600ee9
    PUSH EBX                            ; 00600eeb
    CALL crt_stdio.c_stream_valid_FUN_00608cd1 ; 00600eec | int crt_stdio.c_stream_valid_FUN_00608cd1(FILE * stream, int operation_type)
        ;   XREF to: 00608cd1 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00600ef1
    TEST EAX,EAX                        ; 00600ef4
    JNZ 0x00600efc                      ; 00600ef6 | LAB_00600efc
    ...
    JNZ 0x00600ef8                      ; 00600f1b | LAB_00600ef8
    ...
    PUSH EAX                            ; 00600f26
    CALL crt_stdio.c_reportStreamError_FUN_00606020 ; 00600f27 | void crt_stdio.c_reportStreamError_FUN_00606020(FileEmbeddedData * embedded_data, uint error_flags)
