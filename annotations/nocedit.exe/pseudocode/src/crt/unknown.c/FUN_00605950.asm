...
;                               FUNCTION
; *****************************************************************************
; unknown undefined crt_unknown.c_FUN_00605950()
;
;
; XREF[1]:
...
section .text
    ...
    CALL crt_stdio.c_FlushFilesByMask_FUN_0060595c ; 00605952 | int crt_stdio.c_FlushFilesByMask_FUN_0060595c(uint file_mode_mask)
