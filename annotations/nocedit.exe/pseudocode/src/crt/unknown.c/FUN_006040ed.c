...

{
  ...
  uVar1 = (ushort)CONCAT31 /* combine 2-byte values */(unaff_retaddr,(char)((uint3)unaff_retaddr >> 8));
  if (9 < (byte)unaff_retaddr) {
    uVar1 = CONCAT11 /* combine 2-byte values */((char)((ushort)unaff_retaddr % 10),(char)((ushort)unaff_retaddr / 10));
  }
