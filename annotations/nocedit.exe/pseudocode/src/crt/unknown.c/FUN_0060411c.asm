...
section .text
    ...
    TEST EDX,EDX                        ; 0060418d
        ;   Label: LAB_0060418d
    JL 0x006041f9                       ; 0060418f | LAB_006041f9
        ;   XREF to: 006041f9 (CONDITIONAL_JUMP)
    CMP EDX,EDI                         ; 00604195
    JLE 0x0060419b                      ; 00604197 | LAB_0060419b
    ...
    DEC EBX                             ; 006041d9
    CMP CL,CH                           ; 006041da
    JNZ 0x006041e1                      ; 006041dc | LAB_006041e1
        ;   XREF to: 006041e1 (CONDITIONAL_JUMP)
    DEC EDX                             ; 006041de
    JMP 0x006041d6                      ; 006041df | LAB_006041d6
        ;   XREF to: 006041d6 (UNCONDITIONAL_JUMP)
    CMP CH,0x39                         ; 006041e1
        ;   Label: LAB_006041e1
    JNZ 0x006041ec                      ; 006041e4 | LAB_006041ec
    ...
    TEST EBX,EBX                        ; 006041ec
        ;   Label: LAB_006041ec
    JGE 0x006041f9                      ; 006041ee | LAB_006041f9
        ;   XREF to: 006041f9 (CONDITIONAL_JUMP)
    ...
    TEST EDX,EDX                        ; 006041f9
        ;   Label: LAB_006041f9
    JG 0x00604218                       ; 006041fb | LAB_00604218
    ...
    PUSH EAX                            ; 00604240
    PUSH ESI                            ; 00604241
    CALL crt_unknown.c_FUN_00604267     ; 00604242 | undefined crt_unknown.c_FUN_00604267()
        ;   XREF to: 00604267 (UNCONDITIONAL_CALL)
    JMP 0x00604259                      ; 00604247 | LAB_00604259
    ...
    PUSH EAX                            ; 00604252
    PUSH ESI                            ; 00604253
    CALL crt_unknown.c_FUN_00604478     ; 00604254 | undefined crt_unknown.c_FUN_00604478()
    ...
    JMP 0x00603d56                      ; 00604262 | LAB_00603d56
