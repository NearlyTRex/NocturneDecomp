...
;                               FUNCTION
; *****************************************************************************
; unknown undefined crt_unknown.c_FUN_0060fcf4()
;
; Local Variables:
...
section .text
    ...
    CMP word ptr [EAX + 0x2],0x0        ; 0060fd48
        ;   Label: LAB_0060fd48
    SETZ AL                             ; 0060fd4d
    MOV EBX,dword ptr [0x03f9b868]      ; 0060fd50 | int g_EnvironInitialized
    MOVZX ESI,AL                        ; 0060fd56
    TEST EBX,EBX                        ; 0060fd59
    JNZ 0x0060fd9a                      ; 0060fd5b | LAB_0060fd9a
        ;   XREF to: 0060fd9a (CONDITIONAL_JUMP)
    TEST ESI,ESI                        ; 0060fd5d
    JNZ 0x0060fe88                      ; 0060fd5f | LAB_0060fe88
        ;   XREF to: 0060fe88 (CONDITIONAL_JUMP)
    PUSH 0x9                            ; 0060fd65
    CALL crt_memory.c_malloc_FUN_00601bb0 ; 0060fd67 | void * crt_memory.c_malloc_FUN_00601bb0(ulong size)
        ;   XREF to: 00601bb0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060fd6c
    MOV EBX,EAX                         ; 0060fd6f
    TEST EAX,EAX                        ; 0060fd71
    JNZ 0x0060fd82                      ; 0060fd73 | LAB_0060fd82
    ...
    POP EBX                             ; 0060fd80
    RET                                 ; 0060fd81
    MOV [0x03f9b868],EAX                ; 0060fd82 | int g_EnvironInitialized
        ;   Label: LAB_0060fd82
    ADD EAX,0x8                         ; 0060fd87
    MOV dword ptr [EAX + -0x8],ESI      ; 0060fd8a
    MOV dword ptr [EAX + -0x4],ESI      ; 0060fd8d
    MOV [0x03f9b860],EAX                ; 0060fd90 | char * * g_EnvironStringArea
    JMP 0x0060fe70                      ; 0060fd95 | LAB_0060fe70
        ;   XREF to: 0060fe70 (UNCONDITIONAL_JUMP)
    PUSH ESI                            ; 0060fd9a
        ;   Label: LAB_0060fd9a
    MOV ECX,dword ptr [ESP + 0x20]      ; 0060fd9b
    PUSH ECX                            ; 0060fd9f
    CALL crt_unknown.c_FUN_0060fe94     ; 0060fda0 | undefined crt_unknown.c_FUN_0060fe94()
        ;   XREF to: 0060fe94 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0060fda5
    TEST ESI,ESI                        ; 0060fda8
    JNZ 0x0060fe88                      ; 0060fdaa | LAB_0060fe88
        ;   XREF to: 0060fe88 (CONDITIONAL_JUMP)
    TEST EAX,EAX                        ; 0060fdb0
    JG 0x0060fe6d                       ; 0060fdb2 | LAB_0060fe6d
    ...
    MOV EDI,dword ptr [0x03f9b860]      ; 0060fdd0 | char * * g_EnvironStringArea
    ADD EAX,EBP                         ; 0060fdd6
    TEST EDI,EDI                        ; 0060fdd8
    JNZ 0x0060fe27                      ; 0060fdda | LAB_0060fe27
        ;   XREF to: 0060fe27 (CONDITIONAL_JUMP)
    PUSH EAX                            ; 0060fddc
    CALL crt_memory.c_malloc_FUN_00601bb0 ; 0060fddd | void * crt_memory.c_malloc_FUN_00601bb0(ulong size)
        ;   XREF to: 00601bb0 (UNCONDITIONAL_CALL)
    MOV EDI,EAX                         ; 0060fde2
    ADD ESP,0x4                         ; 0060fde4
    MOV EBX,EAX                         ; 0060fde7
    TEST EAX,EAX                        ; 0060fde9
    JNZ 0x0060fdfa                      ; 0060fdeb | LAB_0060fdfa
    ...
    MOV ECX,dword ptr [ESP]             ; 0060fdfa
        ;   Label: LAB_0060fdfa
    PUSH ECX                            ; 0060fdfd
    MOV EAX,[0x03f9b868]                ; 0060fdfe | int g_EnvironInitialized
    PUSH EAX                            ; 0060fe03
    PUSH EDI                            ; 0060fe04
    CALL crt_string.c_memcpy_FUN_0060cd60 ; 0060fe05 | void * crt_string.c_memcpy_FUN_0060cd60(void * dest, void * src, SIZE_T count)
    ...
    PUSH EDI                            ; 0060fe16
    MOV dword ptr [0x03f9b860],EDI      ; 0060fe17 | char * * g_EnvironStringArea
    CALL crt_memory.c_memset_FUN_005fde40 ; 0060fe1d | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
        ;   XREF to: 005fde40 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0060fe22
    JMP 0x0060fe5d                      ; 0060fe25 | LAB_0060fe5d
        ;   XREF to: 0060fe5d (UNCONDITIONAL_JUMP)
    PUSH EAX                            ; 0060fe27
        ;   Label: LAB_0060fe27
    PUSH EBX                            ; 0060fe28
    CALL crt_memory.c_realloc_FUN_00601df0 ; 0060fe29 | void * crt_memory.c_realloc_FUN_00601df0(void * ptr, ulong new_size)
        ;   XREF to: 00601df0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0060fe2e
    MOV EBX,EAX                         ; 0060fe31
    TEST EAX,EAX                        ; 0060fe33
    JNZ 0x0060fe44                      ; 0060fe35 | LAB_0060fe44
    ...
    PUSH ESI                            ; 0060fe44
        ;   Label: LAB_0060fe44
    MOV EDX,dword ptr [0x03f9b860]      ; 0060fe45 | char * * g_EnvironStringArea
    PUSH EDX                            ; 0060fe4b
    ADD EBP,EAX                         ; 0060fe4c
    PUSH EBP                            ; 0060fe4e
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 0060fe4f | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
        ;   XREF to: 005fe5e0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0060fe54
    MOV dword ptr [0x03f9b860],EBP      ; 0060fe57 | char * * g_EnvironStringArea
    MOV dword ptr [EBX + ESI*0x4 + 0x4],0x0 ; 0060fe5d
        ;   Label: LAB_0060fe5d
    MOV dword ptr [0x03f9b868],EBX      ; 0060fe65 | int g_EnvironInitialized
    JMP 0x0060fe70                      ; 0060fe6b | LAB_0060fe70
        ;   XREF to: 0060fe70 (UNCONDITIONAL_JUMP)
    ...
    MOV EAX,[0x03f9b860]                ; 0060fe7f | char * * g_EnvironStringArea
