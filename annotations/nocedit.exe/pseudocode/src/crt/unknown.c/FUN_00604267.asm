...
;                               FUNCTION
; *****************************************************************************
; unknown undefined crt_unknown.c_FUN_00604267()
;
; Local Variables:
...
section .text
    ...
    JGE 0x006042ad                      ; 006042a6 | LAB_006042ad
        ;   XREF to: 006042ad (CONDITIONAL_JUMP)
    ...
    JG 0x00604355                       ; 006042b2 | LAB_00604355
        ;   XREF to: 00604355 (CONDITIONAL_JUMP)
    TEST byte ptr [EDX + 0x8],0x8       ; 006042b8
    JNZ 0x006042e1                      ; 006042bc | LAB_006042e1
    ...
    JG 0x006042d6                       ; 006042ce | LAB_006042d6
        ;   XREF to: 006042d6 (CONDITIONAL_JUMP)
    TEST byte ptr [EDX + 0x8],0x10      ; 006042d0
    JZ 0x006042e1                       ; 006042d4 | LAB_006042e1
        ;   XREF to: 006042e1 (CONDITIONAL_JUMP)
    ...
    JLE 0x006042fa                      ; 006042ee | LAB_006042fa
    ...
    JGE 0x0060431c                      ; 00604317 | LAB_0060431c
    ...
    MOV ESI,dword ptr [EBP + -0x10]     ; 006043b5
        ;   Label: LAB_006043b5
    JMP 0x0060434d                      ; 006043b8 | LAB_0060434d
