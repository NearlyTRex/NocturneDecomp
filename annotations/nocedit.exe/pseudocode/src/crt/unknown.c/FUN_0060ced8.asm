...
;                               FUNCTION
; *****************************************************************************
; unknown undefined crt_unknown.c_FUN_0060ced8()
;
;
; XREF[1]:
...
section .text
    ...
    JZ 0x0060cee7                       ; 0060cee0 | LAB_0060cee7
        ;   XREF to: 0060cee7 (CONDITIONAL_JUMP)
    CMP EBX,0x4                         ; 0060cee2
    JNZ 0x0060cef0                      ; 0060cee5 | LAB_0060cef0
        ;   XREF to: 0060cef0 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX*0x8 + 0x685508] ; 0060cee7 | g_GlobalSignalHandlers[1]
        ;   Label: LAB_0060cee7
    POP EBX                             ; 0060ceee
    RET                                 ; 0060ceef
    CALL dword ptr [0x00684ee4]         ; 0060cef0 | GET_TLS_FUNC * PTR_crt_thread.c_GetTLS_FUN_0060242c_00684ee4
        ;   Label: LAB_0060cef0
