...
section .text
    ...
    JS 0x0060e282                       ; 0060e274 | LAB_0060e282
        ;   XREF to: 0060e282 (CONDITIONAL_JUMP)
    CMP EDX,ECX                         ; 0060e276
    JNZ 0x0060e27c                      ; 0060e278 | LAB_0060e27c
        ;   XREF to: 0060e27c (CONDITIONAL_JUMP)
    CMP EAX,EBX                         ; 0060e27a
    JZ 0x0060e28a                       ; 0060e27c | LAB_0060e28a
        ;   Label: LAB_0060e27c
