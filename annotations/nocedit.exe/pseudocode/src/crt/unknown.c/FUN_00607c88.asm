...
;                               FUNCTION
; *****************************************************************************
; unknown undefined crt_unknown.c_FUN_00607c88()
;
;
; XREF[1]:
...
section .text
    ...
    JL 0x00607cb3                       ; 00607c9d | LAB_00607cb3
        ;   XREF to: 00607cb3 (CONDITIONAL_JUMP)
    JNZ 0x00607cb8                      ; 00607c9f | LAB_00607cb8
    ...
    JL 0x00607cb3                       ; 00607ca9 | LAB_00607cb3
        ;   XREF to: 00607cb3 (CONDITIONAL_JUMP)
    JNZ 0x00607cb8                      ; 00607cab | LAB_00607cb8
        ;   XREF to: 00607cb8 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [EBX]             ; 00607cad
    CMP EBX,dword ptr [EDX]             ; 00607caf
    JGE 0x00607cb8                      ; 00607cb1 | LAB_00607cb8
        ;   XREF to: 00607cb8 (CONDITIONAL_JUMP)
