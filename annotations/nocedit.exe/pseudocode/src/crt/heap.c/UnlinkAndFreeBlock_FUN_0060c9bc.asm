...
section .text
    ...
    CALL crt_heap.c_VirtualFreeBlock_FUN_0060c95c ; 0060c9c9 | int crt_heap.c_VirtualFreeBlock_FUN_0060c95c(HeapBlock * block)
        ;   XREF to: 0060c95c (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060c9ce
    TEST EAX,EAX                        ; 0060c9d1
    JNZ 0x0060c9eb                      ; 0060c9d3 | LAB_0060c9eb
        ;   XREF to: 0060c9eb (CONDITIONAL_JUMP)
    TEST ESI,ESI                        ; 0060c9d5
    JNZ 0x0060c9e1                      ; 0060c9d7 | LAB_0060c9e1
        ;   XREF to: 0060c9e1 (CONDITIONAL_JUMP)
    MOV dword ptr [0x00684ed4],EBX      ; 0060c9d9 | Heap * g_MainHeap
    JMP 0x0060c9e4                      ; 0060c9df | LAB_0060c9e4
        ;   XREF to: 0060c9e4 (UNCONDITIONAL_JUMP)
    MOV dword ptr [ESI + 0x8],EBX       ; 0060c9e1
        ;   Label: LAB_0060c9e1
    TEST EBX,EBX                        ; 0060c9e4
        ;   Label: LAB_0060c9e4
    JZ 0x0060c9eb                       ; 0060c9e6 | LAB_0060c9eb
        ;   XREF to: 0060c9eb (CONDITIONAL_JUMP)
