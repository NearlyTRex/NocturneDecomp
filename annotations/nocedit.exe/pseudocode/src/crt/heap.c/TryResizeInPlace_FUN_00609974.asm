...
section .text
    ...
    CALL dword ptr [0x00684f00]         ; 00609978 | void * PTR_crt_sync.c_EnterCriticalSection_FUN_00602434_00684f00
    ...
    PUSH EBX                            ; 0060998a
    MOV EAX,0x684ed4                    ; 0060998b | Heap * g_MainHeap
    MOV DX,DS                           ; 00609990
    XOR EAX,EAX                         ; 00609992
    MOV AX,DX                           ; 00609994
    PUSH EAX                            ; 00609997
    CALL crt_heap.c_ResizeBlockInPlace_FUN_006097b8 ; 00609998 | int crt_heap.c_ResizeBlockInPlace_FUN_006097b8(ushort segment, void * ptr, ulong new_size, ulong * pExtraNeeded)
        ;   XREF to: 006097b8 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0060999d
    TEST EAX,EAX                        ; 006099a0
    JNZ 0x006099b1                      ; 006099a2 | LAB_006099b1
        ;   XREF to: 006099b1 (CONDITIONAL_JUMP)
    CALL dword ptr [0x00684f08]         ; 006099a4 | void * PTR_crt_sync.c_ExitCriticalSection_FUN_00602434_00684f08
    MOV EAX,EBX                         ; 006099aa
    ADD ESP,0x4                         ; 006099ac
    POP EBX                             ; 006099af
    RET                                 ; 006099b0
    CALL dword ptr [0x00684f08]         ; 006099b1 | void * PTR_crt_sync.c_ExitCriticalSection_FUN_00602434_00684f08
        ;   Label: LAB_006099b1
