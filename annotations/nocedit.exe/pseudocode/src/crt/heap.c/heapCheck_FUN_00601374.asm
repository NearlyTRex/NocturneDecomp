...
;                               FUNCTION
; *****************************************************************************
; __cdecl int crt_heap.c_heapCheck_FUN_00601374(void * heap_state_ptr)
;
; Parameters:
...
section .text
    ...
    CALL dword ptr [0x00684f00]         ; 00601375 | void * PTR_crt_sync.c_EnterCriticalSection_FUN_00602434_00684f00
    MOV EDX,dword ptr [0x00684ed4]      ; 0060137b | Heap * g_MainHeap
    PUSH EDX                            ; 00601381
    MOV EBX,dword ptr [ESP + 0xc]       ; 00601382
    PUSH EBX                            ; 00601386
    CALL crt_heap.c_heapWalk_FUN_006012d0 ; 00601387 | int crt_heap.c_heapWalk_FUN_006012d0(HeapState * heap_state_ptr, Heap * heap_ptr)
        ;   XREF to: 006012d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0060138c
    MOV EBX,EAX                         ; 0060138f
    CALL dword ptr [0x00684f08]         ; 00601391 | void * PTR_crt_sync.c_ExitCriticalSection_FUN_00602434_00684f08
