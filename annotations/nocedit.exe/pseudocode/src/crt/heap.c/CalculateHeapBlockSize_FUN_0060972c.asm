...
section .text
    ...
    JNZ 0x0060973c                      ; 00609739 | LAB_0060973c
    ...
    JNC 0x00609748                      ; 00609743 | LAB_00609748
        ;   XREF to: 00609748 (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 00609745
    RET                                 ; 00609747
    MOV ECX,dword ptr [0x006854f4]      ; 00609748 | int g_HeapFlags
        ;   Label: LAB_00609748
    CMP EAX,ECX                         ; 0060974e
    JNC 0x00609756                      ; 00609750 | LAB_00609756
    ...
    JNC 0x00609764                      ; 0060975f | LAB_00609764
