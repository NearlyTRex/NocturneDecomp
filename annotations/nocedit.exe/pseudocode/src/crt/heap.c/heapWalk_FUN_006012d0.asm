...
;                               FUNCTION
; *****************************************************************************
; __cdecl int crt_heap.c_heapWalk_FUN_006012d0(HeapState * heap_state_ptr, Heap * heap_ptr)
;
; Parameters:
...
;   crt_watcom.c_heapchk_FUN_00600ad0 at 00600b1d
;
; Referenced Globals:
...
section .text
    ...
    JNZ 0x006012e6                      ; 006012dc | LAB_006012e6
    ...
    JA 0x00601324                       ; 0060131a | LAB_00601324
    ...
    JMP 0x00601326                      ; 0060134d | LAB_00601326
        ;   XREF to: 00601326 (UNCONDITIONAL_JUMP)
    ...
    JZ 0x0060136e                       ; 00601365 | LAB_0060136e
