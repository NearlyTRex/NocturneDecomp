...
section .text
    ...
    PUSH ESI                            ; 00609669
    PUSH EDI                            ; 0060966a
    CMP dword ptr [0x006854f0],0x0      ; 0060966b | undefined4 DAT_006854f0
    JNZ 0x0060967a                      ; 00609672 | LAB_0060967a
    ...
    POP EBX                             ; 00609678
    RET                                 ; 00609679
    CMP dword ptr [0x00684fd0],-0x2     ; 0060967a | undefined4 DAT_00684fd0
        ;   Label: LAB_0060967a
    JNZ 0x00609689                      ; 00609681 | LAB_00609689
    ...
    LEA EAX,[ESP + 0x10]                ; 00609689
        ;   Label: LAB_00609689
    PUSH EAX                            ; 0060968d
    CALL crt_heap.c_CalculateHeapBlockSize_FUN_0060972c ; 0060968e | int crt_heap.c_CalculateHeapBlockSize_FUN_0060972c(uint * pSize)
        ;   XREF to: 0060972c (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00609693
    TEST EAX,EAX                        ; 00609696
    JZ 0x00609713                       ; 00609698 | LAB_00609713
    ...
    JNC 0x006096dd                      ; 006096d5 | LAB_006096dd
    ...
    CALL crt_heap.c_InsertHeapBlockInOrder_FUN_006095f0 ; 006096e0 | HeapBlock * crt_heap.c_InsertHeapBlockInOrder_FUN_006095f0(HeapBlock * new_block)
    ...
    CALL crt_heap.c_ValidateHeapIntegrity_FUN_00601ce0 ; 00609706 | void crt_heap.c_ValidateHeapIntegrity_FUN_00601ce0(void * ptr)
