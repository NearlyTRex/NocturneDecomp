...
section .text
    ...
    JBE 0x00609909                      ; 006097ee | LAB_00609909
    ...
    JNZ 0x00609813                      ; 00609807 | LAB_00609813
        ;   XREF to: 00609813 (CONDITIONAL_JUMP)
    MOV EAX,0x2                         ; 00609809
    JMP 0x0060996a                      ; 0060980e | LAB_0060996a
        ;   XREF to: 0060996a (UNCONDITIONAL_JUMP)
    TEST DI,0x1                         ; 00609813
        ;   Label: LAB_00609813
    JNZ 0x006098fc                      ; 00609818 | LAB_006098fc
    ...
    JC 0x0060987f                       ; 0060986e | LAB_0060987f
    ...
    JNC 0x006098b6                      ; 0060987d | LAB_006098b6
    ...
    JC 0x006098ef                       ; 006098af | LAB_006098ef
        ;   XREF to: 006098ef (CONDITIONAL_JUMP)
    JMP 0x00609968                      ; 006098b1 | LAB_00609968
    ...
    JMP 0x00609968                      ; 006098ea | LAB_00609968
        ;   XREF to: 00609968 (UNCONDITIONAL_JUMP)
    ...
    JMP 0x00609801                      ; 006098f7 | LAB_00609801
    ...
    JC 0x00609968                       ; 0060990e | LAB_00609968
    ...
    PUSH EAX                            ; 0060995f
    CALL crt_heap.c_ValidateHeapIntegrity_FUN_00601ce0 ; 00609960 | void crt_heap.c_ValidateHeapIntegrity_FUN_00601ce0(void * ptr)
