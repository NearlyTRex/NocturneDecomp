...
section .text
    ...
    PUSH ESI                            ; 0060c921
    CALL dword ptr [0x00684f00]         ; 0060c922 | void * PTR_crt_sync.c_EnterCriticalSection_FUN_00602434_00684f00
    MOV EAX,[0x00684ed4]                ; 0060c928 | Heap * g_MainHeap
    TEST EAX,EAX                        ; 0060c92d
    JZ 0x0060c951                       ; 0060c92f | LAB_0060c951
    ...
    JNZ 0x0060c94b                      ; 0060c940 | LAB_0060c94b
        ;   XREF to: 0060c94b (CONDITIONAL_JUMP)
    PUSH EAX                            ; 0060c942
    CALL crt_heap.c_UnlinkAndFreeBlock_FUN_0060c9bc ; 0060c943 | void crt_heap.c_UnlinkAndFreeBlock_FUN_0060c9bc(HeapBlock * block)
        ;   XREF to: 0060c9bc (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060c948
    MOV EAX,EBX                         ; 0060c94b
        ;   Label: LAB_0060c94b
    TEST EBX,EBX                        ; 0060c94d
    JNZ 0x0060c931                      ; 0060c94f | LAB_0060c931
        ;   XREF to: 0060c931 (CONDITIONAL_JUMP)
    CALL dword ptr [0x00684f08]         ; 0060c951 | void * PTR_crt_sync.c_ExitCriticalSection_FUN_00602434_00684f08
        ;   Label: LAB_0060c951
