...
;                               FUNCTION
; *****************************************************************************
; __cdecl int crt_stdio.c_scanf_char_FUN_00604d54(scanf_state_t * state, va_list_t * args)
;
; Parameters:
...
section .text
    ...
    JZ 0x00604da0                       ; 00604d6a | LAB_00604da0
        ;   XREF to: 00604da0 (CONDITIONAL_JUMP)
    TEST DL,0x4                         ; 00604d6c
    JZ 0x00604d7d                       ; 00604d6f | LAB_00604d7d
    ...
    JMP 0x00604da0                      ; 00604d7b | LAB_00604da0
        ;   XREF to: 00604da0 (UNCONDITIONAL_JUMP)
    TEST DL,0x8                         ; 00604d7d
        ;   Label: LAB_00604d7d
    JZ 0x00604d92                       ; 00604d80 | LAB_00604d92
    ...
    JMP 0x00604da0                      ; 00604d90 | LAB_00604da0
        ;   XREF to: 00604da0 (UNCONDITIONAL_JUMP)
    ...
    JNZ 0x00604daf                      ; 00604da8 | LAB_00604daf
        ;   XREF to: 00604daf (CONDITIONAL_JUMP)
    MOV EDI,0x1                         ; 00604daa
    TEST EDI,EDI                        ; 00604daf
        ;   Label: LAB_00604daf
    JLE 0x00604e3e                      ; 00604db1 | LAB_00604e3e
        ;   XREF to: 00604e3e (CONDITIONAL_JUMP)
    PUSH ESI                            ; 00604db7
    CALL crt_stdio.c_scanf_getc_wrapper_FUN_00604930 ; 00604db8 | int crt_stdio.c_scanf_getc_wrapper_FUN_00604930(scanf_state_t * state)
        ;   XREF to: 00604930 (UNCONDITIONAL_CALL)
    MOV CL,byte ptr [ESI + 0x10]        ; 00604dbd
    ADD ESP,0x4                         ; 00604dc0
    TEST CL,0x2                         ; 00604dc3
    JNZ 0x00604e3e                      ; 00604dc6 | LAB_00604e3e
        ;   XREF to: 00604e3e (CONDITIONAL_JUMP)
    INC EBP                             ; 00604dcc
    DEC EDI                             ; 00604dcd
    TEST CL,0x1                         ; 00604dce
    JZ 0x00604daf                       ; 00604dd1 | LAB_00604daf
        ;   XREF to: 00604daf (CONDITIONAL_JUMP)
    TEST CL,0x20                        ; 00604dd3
    JZ 0x00604e34                       ; 00604dd6 | LAB_00604e34
        ;   XREF to: 00604e34 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x03f9c020]      ; 00604dd8 | int g_MultibyteLocaleActive
    MOV byte ptr [ESP + 0x4],AL         ; 00604dde
    TEST EDX,EDX                        ; 00604de2
    JZ 0x00604e07                       ; 00604de4 | LAB_00604e07
        ;   XREF to: 00604e07 (CONDITIONAL_JUMP)
    AND EAX,0xff                        ; 00604de6
    MOV AL,byte ptr [EAX + 0x3f9c031]   ; 00604deb | char[256] g_LeadByteTable
    AND AL,0x1                          ; 00604df1
    AND EAX,0xff                        ; 00604df3
    JZ 0x00604e07                       ; 00604df8 | LAB_00604e07
        ;   XREF to: 00604e07 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 00604dfa
    CALL crt_stdio.c_scanf_getc_wrapper_FUN_00604930 ; 00604dfb | int crt_stdio.c_scanf_getc_wrapper_FUN_00604930(scanf_state_t * state)
        ;   XREF to: 00604930 (UNCONDITIONAL_CALL)
