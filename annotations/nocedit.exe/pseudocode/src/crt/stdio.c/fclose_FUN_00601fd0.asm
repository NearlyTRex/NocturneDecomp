...
;
; XREF[2]:
;   crt_stdio.c_closeAndDeallocateFile_FUN_00601ee4 at 00601eef
...
section .text
    ...
    JNZ 0x00601ff1                      ; 00601fe5 | LAB_00601ff1
        ;   XREF to: 00601ff1 (CONDITIONAL_JUMP)
    MOV EAX,0xffffffff                  ; 00601fe7
    JMP 0x006020b7                      ; 00601fec | LAB_006020b7
        ;   XREF to: 006020b7 (UNCONDITIONAL_JUMP)
    MOV AH,byte ptr [EBX + 0xd]         ; 00601ff1
        ;   Label: LAB_00601ff1
    XOR ESI,ESI                         ; 00601ff4
    TEST AH,0x10                        ; 00601ff6
    JZ 0x00602006                       ; 00601ff9 | LAB_00602006
        ;   XREF to: 00602006 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 00601ffb
    CALL crt_stdio.c_fflushInternal_FUN_006039d0 ; 00601ffc | int crt_stdio.c_fflushInternal_FUN_006039d0(FILE * file_handle)
    ...
    MOV ECX,dword ptr [EBX + 0x10]      ; 00602006
        ;   Label: LAB_00602006
    PUSH ECX                            ; 00602009
    CALL dword ptr [0x00684ee8]         ; 0060200a | ENTER_CRITICAL_SECTION_BY_INDEX_FUNC * PTR_crt_sync.c_EnterCriticalSection_FUN_00602434_00684ee8
    ADD ESP,0x4                         ; 00602010
    PUSH EBX                            ; 00602013
    CALL crt_stdio.c_ftell_FUN_00601560 ; 00602014 | long crt_stdio.c_ftell_FUN_00601560(FILE * file_handle)
        ;   XREF to: 00601560 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00602019
    CMP EAX,-0x1                        ; 0060201c
    JZ 0x00602030                       ; 0060201f | LAB_00602030
        ;   XREF to: 00602030 (CONDITIONAL_JUMP)
    PUSH 0x0                            ; 00602021
    PUSH EAX                            ; 00602023
    MOV EDI,dword ptr [EBX + 0x10]      ; 00602024
    PUSH EDI                            ; 00602027
    CALL crt_stdio.c_lseek_FUN_00606690 ; 00602028 | int crt_stdio.c_lseek_FUN_00606690(int file_handle_index, long distance_to_move, int move_method)
        ;   XREF to: 00606690 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0060202d
    CMP dword ptr [ESP + 0x12c],0x0     ; 00602030
        ;   Label: LAB_00602030
    JZ 0x00602048                       ; 00602038 | LAB_00602048
        ;   XREF to: 00602048 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0x10]      ; 0060203a
    PUSH EAX                            ; 0060203d
    CALL crt_io.c_close_FUN_00609bd0    ; 0060203e | int crt_io.c_close_FUN_00609bd0(int fd)
        ;   XREF to: 00609bd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00602043
    OR ESI,EAX                          ; 00602046
    TEST byte ptr [EBX + 0xc],0x8       ; 00602048
        ;   Label: LAB_00602048
    JZ 0x00602067                       ; 0060204c | LAB_00602067
        ;   XREF to: 00602067 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0x8]       ; 0060204e
    MOV EDX,dword ptr [EAX + 0x8]       ; 00602051
    PUSH EDX                            ; 00602054
    CALL crt_memory.c_free_FUN_00601cd0 ; 00602055 | void crt_memory.c_free_FUN_00601cd0(void * ptr)
    ...
    TEST byte ptr [EBX + 0xd],0x8       ; 00602067
        ;   Label: LAB_00602067
    JZ 0x00602091                       ; 0060206b | LAB_00602091
    ...
    PUSH EAX                            ; 0060207d
    CALL crt_io.c_generateTempFilename_FUN_00601f1c ; 0060207e | void crt_io.c_generateTempFilename_FUN_00601f1c(char * buffer, int file_handle)
        ;   XREF to: 00601f1c (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00602083
    MOV EAX,ESP                         ; 00602086
    PUSH EAX                            ; 00602088
    CALL crt_io.c_deleteFile_FUN_005ff9d0 ; 00602089 | int crt_io.c_deleteFile_FUN_005ff9d0(char * filename)
        ;   XREF to: 005ff9d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060208e
    MOV ECX,dword ptr [EBX + 0x10]      ; 00602091
        ;   Label: LAB_00602091
    PUSH ECX                            ; 00602094
    CALL dword ptr [0x00684eec]         ; 00602095 | EXIT_CRITICAL_SECTION_BY_INDEX_FUNC * PTR_crt_sync.c_ExitCriticalSection_FUN_00602434_00684eec
    ADD ESP,0x4                         ; 0060209b
    CMP dword ptr [ESP + 0x12c],0x0     ; 0060209e
    JZ 0x006020b5                       ; 006020a6 | LAB_006020b5
        ;   XREF to: 006020b5 (CONDITIONAL_JUMP)
    MOV EBP,dword ptr [EBX + 0x10]      ; 006020a8
    PUSH EBP                            ; 006020ab
    CALL dword ptr [0x00684ef4]         ; 006020ac | INVALIDATE_HANDLE_FUNC * PTR_crt_sync.c_InvalidateHandle_FUN_00602448_00684ef4
