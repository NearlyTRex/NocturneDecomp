...
section .text
    ...
    JZ 0x00604e6b                       ; 00604e62 | LAB_00604e6b
        ;   XREF to: 00604e6b (CONDITIONAL_JUMP)
    MOV byte ptr [ESP + 0x8],0x2        ; 00604e64
    JMP 0x00604e73                      ; 00604e69 | LAB_00604e73
    ...
    JZ 0x00604eaf                       ; 00604e79 | LAB_00604eaf
        ;   XREF to: 00604eaf (CONDITIONAL_JUMP)
    TEST CH,0x4                         ; 00604e7b
    JZ 0x00604e8c                       ; 00604e7e | LAB_00604e8c
    ...
    JMP 0x00604eaf                      ; 00604e8a | LAB_00604eaf
        ;   XREF to: 00604eaf (UNCONDITIONAL_JUMP)
    TEST CH,0x8                         ; 00604e8c
        ;   Label: LAB_00604e8c
    JZ 0x00604ea1                       ; 00604e8f | LAB_00604ea1
    ...
    JMP 0x00604eaf                      ; 00604e9f | LAB_00604eaf
        ;   XREF to: 00604eaf (UNCONDITIONAL_JUMP)
    ...
    PUSH ESI                            ; 00604eb1
        ;   Label: LAB_00604eb1
    CALL crt_stdio.c_scanf_getc_wrapper_FUN_00604930 ; 00604eb2 | int crt_stdio.c_scanf_getc_wrapper_FUN_00604930(scanf_state_t * state)
        ;   XREF to: 00604930 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00604eb7
    MOV EBX,EAX                         ; 00604eba
    INC AL                              ; 00604ebc
    AND EAX,0xff                        ; 00604ebe
    TEST byte ptr [EAX + 0x6849c4],0x2  ; 00604ec3 | char[256] g_CharacterClassificationTable
    JZ 0x00604ecf                       ; 00604eca | LAB_00604ecf
        ;   XREF to: 00604ecf (CONDITIONAL_JUMP)
    INC EBP                             ; 00604ecc
    JMP 0x00604eb1                      ; 00604ecd | LAB_00604eb1
        ;   XREF to: 00604eb1 (UNCONDITIONAL_JUMP)
    TEST byte ptr [ESI + 0x10],0x2      ; 00604ecf
        ;   Label: LAB_00604ecf
    JZ 0x00604edc                       ; 00604ed3 | LAB_00604edc
        ;   XREF to: 00604edc (CONDITIONAL_JUMP)
    XOR EBP,EBP                         ; 00604ed5
    JMP 0x00604f88                      ; 00604ed7 | LAB_00604f88
    ...
    JZ 0x00604f7e                       ; 00604ee7 | LAB_00604f7e
        ;   XREF to: 00604f7e (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x10]        ; 00604eed
        ;   Label: LAB_00604eed
    INC EBP                             ; 00604ef0
    TEST AL,0x1                         ; 00604ef1
    JZ 0x00604f5a                       ; 00604ef3 | LAB_00604f5a
        ;   XREF to: 00604f5a (CONDITIONAL_JUMP)
    CMP byte ptr [ESP + 0x8],0x1        ; 00604ef5
    JNZ 0x00604f01                      ; 00604efa | LAB_00604f01
        ;   XREF to: 00604f01 (CONDITIONAL_JUMP)
    MOV byte ptr ES:[EDI],BL            ; 00604efc
    JMP 0x00604f52                      ; 00604eff | LAB_00604f52
        ;   XREF to: 00604f52 (UNCONDITIONAL_JUMP)
    MOV EAX,[0x03f9c020]                ; 00604f01 | int g_MultibyteLocaleActive
        ;   Label: LAB_00604f01
    MOV byte ptr [ESP + 0x4],BL         ; 00604f06
    TEST EAX,EAX                        ; 00604f0a
    JZ 0x00604f2e                       ; 00604f0c | LAB_00604f2e
        ;   XREF to: 00604f2e (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 00604f0e
    MOV AL,BL                           ; 00604f10
    MOV AL,byte ptr [EAX + 0x3f9c031]   ; 00604f12 | char[256] g_LeadByteTable
    AND AL,0x1                          ; 00604f18
    AND EAX,0xff                        ; 00604f1a
    JZ 0x00604f2e                       ; 00604f1f | LAB_00604f2e
        ;   XREF to: 00604f2e (CONDITIONAL_JUMP)
    PUSH ESI                            ; 00604f21
    CALL crt_stdio.c_scanf_getc_wrapper_FUN_00604930 ; 00604f22 | int crt_stdio.c_scanf_getc_wrapper_FUN_00604930(scanf_state_t * state)
        ;   XREF to: 00604930 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00604f39
    CALL crt_locale.c_mbtowc_FUN_0060b1c0 ; 00604f3a | int crt_locale.c_mbtowc_FUN_0060b1c0(wchar_t * wide_char, char * mb_string, SIZE_T max_bytes)
        ;   XREF to: 0060b1c0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00604f3f
    CMP EAX,-0x1                        ; 00604f42
    JNZ 0x00604f4b                      ; 00604f45 | LAB_00604f4b
        ;   XREF to: 00604f4b (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 00604f47
    JMP 0x00604fa7                      ; 00604f49 | LAB_00604fa7
    ...
    PUSH ESI                            ; 00604f5a
        ;   Label: LAB_00604f5a
    CALL crt_stdio.c_scanf_getc_with_width_FUN_00605918 ; 00604f5b | int crt_stdio.c_scanf_getc_with_width_FUN_00605918(scanf_state_t * state)
        ;   XREF to: 00605918 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00604f60
    MOV EBX,EAX                         ; 00604f63
    CMP EAX,-0x1                        ; 00604f65
    JZ 0x00604f88                       ; 00604f68 | LAB_00604f88
        ;   XREF to: 00604f88 (CONDITIONAL_JUMP)
    INC AL                              ; 00604f6a
    AND EAX,0xff                        ; 00604f6c
    TEST byte ptr [EAX + 0x6849c4],0x2  ; 00604f71 | char[256] g_CharacterClassificationTable
    JZ 0x00604eed                       ; 00604f78 | LAB_00604eed
        ;   XREF to: 00604eed (CONDITIONAL_JUMP)
    PUSH ESI                            ; 00604f7e
        ;   Label: LAB_00604f7e
    PUSH EBX                            ; 00604f7f
    CALL crt_stdio.c_scanf_ungetc_wrapper_FUN_0060493c ; 00604f80 | int crt_stdio.c_scanf_ungetc_wrapper_FUN_0060493c(int character, scanf_state_t * state)
        ;   XREF to: 0060493c (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00604f85
    TEST byte ptr [ESI + 0x10],0x1      ; 00604f88
        ;   Label: LAB_00604f88
    JZ 0x00604fa5                       ; 00604f8c | LAB_00604fa5
        ;   XREF to: 00604fa5 (CONDITIONAL_JUMP)
    TEST EBP,EBP                        ; 00604f8e
    JLE 0x00604fa5                      ; 00604f90 | LAB_00604fa5
        ;   XREF to: 00604fa5 (CONDITIONAL_JUMP)
    CMP byte ptr [ESP + 0x8],0x1        ; 00604f92
    JNZ 0x00604f9f                      ; 00604f97 | LAB_00604f9f
        ;   XREF to: 00604f9f (CONDITIONAL_JUMP)
    MOV byte ptr ES:[EDI],0x0           ; 00604f99
    JMP 0x00604fa5                      ; 00604f9d | LAB_00604fa5
