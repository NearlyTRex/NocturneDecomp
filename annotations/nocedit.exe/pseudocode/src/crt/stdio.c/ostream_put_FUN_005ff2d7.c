// Name: crt_stdio.c_ostream_put_FUN_005ff2d7
// Address: 005ff2d7
// Address Range: [[005ff2d7, 005ff383]]
// Convention: __cdecl
// Signature: ostream * __cdecl crt_stdio_c_ostream_put_FUN_005ff2d7(ostream *this_ptr,int character)

#include "nocturne.h"

ostream * __cdecl ostream_put(ostream *this_ptr,int character)
