...
section .text
    ...
    PUSH 0xb                            ; 006090b4
    CALL crt_errno.c_setErrno_FUN_00602790 ; 006090b6
    ...
    JMP 0x006092d9                      ; 006090c3
        ;   XREF to: 006092d9 (UNCONDITIONAL_JUMP)  ; LAB_006092d9
    ...
    CMP dword ptr [0x0068528c],0x0      ; 0060911c | DAT_0068528c
    JZ 0x00609164                       ; 00609123
    ...
    CALL dword ptr [0x0068528c]         ; 00609156 | DAT_0068528c
    ADD ESP,0xc                         ; 0060915c
    JMP 0x00609286                      ; 0060915f
        ;   XREF to: 00609286 (UNCONDITIONAL_JUMP)  ; LAB_00609286
    MOV DL,byte ptr [ESP + 0x30]        ; 00609164
        ;   Label: LAB_00609164
    TEST DL,0x20                        ; 00609168
    JZ 0x006091cf                       ; 0060916b
        ;   XREF to: 006091cf (CONDITIONAL_JUMP)  ; LAB_006091cf
    ...
    JZ 0x006091a5                       ; 00609197
        ;   XREF to: 006091a5 (CONDITIONAL_JUMP)  ; LAB_006091a5
    TEST byte ptr [ESP + 0x14],0x80     ; 00609199
    JNZ 0x006091a5                      ; 0060919e
        ;   XREF to: 006091a5 (CONDITIONAL_JUMP)  ; LAB_006091a5
    MOV EBP,0x1                         ; 006091a0
    TEST byte ptr [ESP + 0x31],0x4      ; 006091a5
        ;   Label: LAB_006091a5
    JZ 0x006091b5                       ; 006091aa
        ;   XREF to: 006091b5 (CONDITIONAL_JUMP)  ; LAB_006091b5
    MOV EBX,0x1                         ; 006091ac
    MOV EAX,EBX                         ; 006091b1
    JMP 0x006091e0                      ; 006091b3
        ;   XREF to: 006091e0 (UNCONDITIONAL_JUMP)  ; LAB_006091e0
    TEST byte ptr [ESP + 0x30],0x40     ; 006091b5
        ;   Label: LAB_006091b5
    JZ 0x006091c8                       ; 006091ba
        ;   XREF to: 006091c8 (CONDITIONAL_JUMP)  ; LAB_006091c8
    MOV EBX,0x2                         ; 006091bc
    MOV EAX,0x1                         ; 006091c1
    JMP 0x006091e0                      ; 006091c6
        ;   XREF to: 006091e0 (UNCONDITIONAL_JUMP)  ; LAB_006091e0
    MOV EBX,0x4                         ; 006091c8
        ;   Label: LAB_006091c8
    JMP 0x006091db                      ; 006091cd
        ;   XREF to: 006091db (UNCONDITIONAL_JUMP)  ; LAB_006091db
    TEST DL,0x40                        ; 006091cf
        ;   Label: LAB_006091cf
    JZ 0x006091db                       ; 006091d2
        ;   XREF to: 006091db (CONDITIONAL_JUMP)  ; LAB_006091db
    MOV EAX,0x5                         ; 006091d4
    JMP 0x006091e0                      ; 006091d9
        ;   XREF to: 006091e0 (UNCONDITIONAL_JUMP)  ; LAB_006091e0
    ...
    JZ 0x0060922b                       ; 0060920b
        ;   XREF to: 0060922b (CONDITIONAL_JUMP)  ; LAB_0060922b
    PUSH 0x0                            ; 0060920d
    PUSH EBP                            ; 0060920f
    PUSH EBX                            ; 00609210
    PUSH 0x0                            ; 00609211
    ...
    PUSH EDI                            ; 0060923d
        ;   Label: LAB_0060923d
    CALL dword ptr [0x00684ef0]         ; 0060923e | PTR_crt_sync.c_RegisterHandle_FUN_00602438_00684ef0
    XOR EBX,EBX                         ; 00609244
    MOV EDX,dword ptr [0x00685214]      ; 00609246 | g_MaxHandleCount
    ...
    PUSH EAX                            ; 00609274
        ;   Label: LAB_00609274
    CALL crt_io.c_IsSpecialDevice_FUN_0060c270 ; 00609275
    ...
    JZ 0x00609286                       ; 0060927f
        ;   XREF to: 00609286 (CONDITIONAL_JUMP)  ; LAB_00609286
    MOV EBX,0x2000                      ; 00609281
    CMP ESI,0x2                         ; 00609286
        ;   Label: LAB_00609286
    JNZ 0x00609290                      ; 00609289
        ;   XREF to: 00609290 (CONDITIONAL_JUMP)  ; LAB_00609290
    OR BL,0x3                           ; 0060928b
    JMP 0x006092a1                      ; 0060928e
        ;   XREF to: 006092a1 (UNCONDITIONAL_JUMP)  ; LAB_006092a1
    TEST ESI,ESI                        ; 00609290
        ;   Label: LAB_00609290
    JNZ 0x00609299                      ; 00609292
        ;   XREF to: 00609299 (CONDITIONAL_JUMP)  ; LAB_00609299
    OR BL,0x1                           ; 00609294
    JMP 0x006092a1                      ; 00609297
        ;   XREF to: 006092a1 (UNCONDITIONAL_JUMP)  ; LAB_006092a1
    CMP ESI,0x1                         ; 00609299
        ;   Label: LAB_00609299
    JNZ 0x006092a1                      ; 0060929c
        ;   XREF to: 006092a1 (CONDITIONAL_JUMP)  ; LAB_006092a1
    OR BL,0x2                           ; 0060929e
    TEST byte ptr [ESP + 0x30],0x10     ; 006092a1
        ;   Label: LAB_006092a1
    JZ 0x006092ab                       ; 006092a6
        ;   XREF to: 006092ab (CONDITIONAL_JUMP)  ; LAB_006092ab
    OR BL,0x80                          ; 006092a8
    ...
    JZ 0x006092bf                       ; 006092b6
        ;   XREF to: 006092bf (CONDITIONAL_JUMP)  ; LAB_006092bf
    TEST DL,0x2                         ; 006092b8
    JZ 0x006092cd                       ; 006092bb
