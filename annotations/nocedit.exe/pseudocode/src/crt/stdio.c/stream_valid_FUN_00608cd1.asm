...
;                               FUNCTION
; *****************************************************************************
; __watcallStack int crt_stdio.c_stream_valid_FUN_00608cd1(FILE * stream, int operation_type)
;
; Parameters:
...
section .text
    ...
    JZ 0x00608cfb                       ; 00608cda | LAB_00608cfb
    ...
    JNZ 0x00608d09                      ; 00608ce6 | LAB_00608d09
    ...
    JNZ 0x00608d09                      ; 00608cf3 | LAB_00608d09
        ;   XREF to: 00608d09 (CONDITIONAL_JUMP)
    ...
    JZ 0x00608cdc                       ; 00608d07 | LAB_00608cdc
    ...
    PUSH EBX                            ; 00608d0e
    PUSH EAX                            ; 00608d0f
    CALL crt_stdio.c_stream_setup_FUN_00605f20 ; 00608d10 | int crt_stdio.c_stream_setup_FUN_00605f20(FILE * stream, int operation_type)
