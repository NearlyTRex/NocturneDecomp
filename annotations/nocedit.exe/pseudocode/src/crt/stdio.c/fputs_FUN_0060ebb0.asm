...
;                               FUNCTION
; *****************************************************************************
; __cdecl int crt_stdio.c_fputs_FUN_0060ebb0(char * str, FILE * file)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 0060ebc2
    CALL dword ptr [0x00684ee8]         ; 0060ebc3 | ENTER_CRITICAL_SECTION_BY_INDEX_FUNC * PTR_crt_sync.c_EnterCriticalSection_FUN_00602434_00684ee8
    MOV EAX,dword ptr [ESI + 0x8]       ; 0060ebc9
    MOV ECX,dword ptr [EAX + 0x8]       ; 0060ebcc
    ADD ESP,0x4                         ; 0060ebcf
    TEST ECX,ECX                        ; 0060ebd2
    JNZ 0x0060ebdf                      ; 0060ebd4 | LAB_0060ebdf
        ;   XREF to: 0060ebdf (CONDITIONAL_JUMP)
    PUSH ESI                            ; 0060ebd6
    CALL crt_stdio.c_InitializeFileBuffer_FUN_006027e0 ; 0060ebd7 | void crt_stdio.c_InitializeFileBuffer_FUN_006027e0(FILE * file)
    ...
    JZ 0x0060ebfe                       ; 0060ebe7 | LAB_0060ebfe
    ...
    JZ 0x0060ec1d                       ; 0060ec09 | LAB_0060ec1d
        ;   XREF to: 0060ec1d (CONDITIONAL_JUMP)
    PUSH ESI                            ; 0060ec0b
    PUSH EAX                            ; 0060ec0c
    INC EBX                             ; 0060ec0d
    CALL crt_stdio.c_fputc_FUN_006007a0 ; 0060ec0e | int crt_stdio.c_fputc_FUN_006007a0(int character, FILE * file)
        ;   XREF to: 006007a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0060ec13
    CMP EAX,-0x1                        ; 0060ec16
    JNZ 0x0060ec03                      ; 0060ec19 | LAB_0060ec03
        ;   XREF to: 0060ec03 (CONDITIONAL_JUMP)
    MOV EDI,EAX                         ; 0060ec1b
    TEST EBP,EBP                        ; 0060ec1d
        ;   Label: LAB_0060ec1d
    JZ 0x0060ec41                       ; 0060ec1f | LAB_0060ec41
    ...
    JNZ 0x0060ec41                      ; 0060ec34 | LAB_0060ec41
        ;   XREF to: 0060ec41 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 0060ec36
    CALL crt_stdio.c_fflushInternal_FUN_006039d0 ; 0060ec37 | int crt_stdio.c_fflushInternal_FUN_006039d0(FILE * file_handle)
        ;   XREF to: 006039d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060ec3c
    MOV EDI,EAX                         ; 0060ec3f
    TEST EDI,EDI                        ; 0060ec41
        ;   Label: LAB_0060ec41
    JNZ 0x0060ec4c                      ; 0060ec43 | LAB_0060ec4c
    ...
    MOV EBP,dword ptr [ESI + 0x10]      ; 0060ec4c
        ;   Label: LAB_0060ec4c
    PUSH EBP                            ; 0060ec4f
    CALL dword ptr [0x00684eec]         ; 0060ec50 | EXIT_CRITICAL_SECTION_BY_INDEX_FUNC * PTR_crt_sync.c_ExitCriticalSection_FUN_00602434_00684eec
