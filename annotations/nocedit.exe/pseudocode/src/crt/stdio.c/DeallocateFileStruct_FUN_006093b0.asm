...
section .text
    ...
    MOV EDX,0x3f9b200                   ; 006093b5 | FileListNode * g_AllocatedListHead
    MOV EAX,dword ptr [EDX]             ; 006093ba | FileListNode * g_AllocatedListHead
        ;   Label: LAB_006093ba
    TEST EAX,EAX                        ; 006093bc
    JZ 0x006093e5                       ; 006093be | LAB_006093e5
        ;   XREF to: 006093e5 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [EAX + 0x4]       ; 006093c0
    CMP EBX,ECX                         ; 006093c3
    JZ 0x006093cb                       ; 006093c5 | LAB_006093cb
        ;   XREF to: 006093cb (CONDITIONAL_JUMP)
    MOV EDX,EAX                         ; 006093c7
    JMP 0x006093ba                      ; 006093c9 | LAB_006093ba
    ...
    MOV dword ptr [EDX],EBX             ; 006093d6 | FileListNode * g_AllocatedListHead
    MOV EDX,dword ptr [0x03f9b204]      ; 006093d8 | undefined4 g_FreeListHeadPointer
    MOV [0x03f9b204],EAX                ; 006093de | undefined4 g_FreeListHeadPointer
