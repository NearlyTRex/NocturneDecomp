...
section .text
    ...
    MOV EAX,dword ptr [ESP + 0x40]      ; 0060549b
        ;   Label: LAB_0060549b
    PUSH EAX                            ; 0060549f
    CALL crt_stdio.c_scanf_getc_wrapper_FUN_00604930 ; 006054a0
    ...
    TEST byte ptr [EBX + 0x6849c4],0x2  ; 006054b8 | g_CharacterClassificationTable
    JZ 0x006054c7                       ; 006054bf
        ;   XREF to: 006054c7 (CONDITIONAL_JUMP)  ; LAB_006054c7
    INC dword ptr [ESP + 0x20]          ; 006054c1
    JMP 0x0060549b                      ; 006054c5
        ;   XREF to: 0060549b (UNCONDITIONAL_JUMP)  ; LAB_0060549b
    MOV EDX,dword ptr [ESP + 0x40]      ; 006054c7
        ;   Label: LAB_006054c7
    TEST byte ptr [EDX + 0x10],0x2      ; 006054cb
    JNZ 0x00605798                      ; 006054cf
        ;   XREF to: 00605798 (CONDITIONAL_JUMP)  ; LAB_00605798
    MOV EBX,dword ptr [EDX + 0xc]       ; 006054d5
    LEA ESI,[EBX + -0x1]                ; 006054d8
    MOV dword ptr [EDX + 0xc],ESI       ; 006054db
    TEST EBX,EBX                        ; 006054de
    JZ 0x00605786                       ; 006054e0
        ;   XREF to: 00605786 (CONDITIONAL_JUMP)  ; LAB_00605786
    MOV EBX,0x2b                        ; 006054e6
    MOV ECX,dword ptr [ESP + 0x4c]      ; 006054eb
    MOV dword ptr [ESP + 0x1c],EBX      ; 006054ef
    TEST ECX,ECX                        ; 006054f3
    JZ 0x0060552b                       ; 006054f5
        ;   XREF to: 0060552b (CONDITIONAL_JUMP)  ; LAB_0060552b
    CMP EAX,EBX                         ; 006054f7
    JZ 0x00605500                       ; 006054f9
        ;   XREF to: 00605500 (CONDITIONAL_JUMP)  ; LAB_00605500
    CMP EAX,0x2d                        ; 006054fb
    JNZ 0x0060552b                      ; 006054fe
        ;   XREF to: 0060552b (CONDITIONAL_JUMP)  ; LAB_0060552b
    ...
    CALL crt_stdio.c_scanf_getc_with_width_FUN_00605918 ; 00605516
    ...
    JZ 0x00605798                       ; 00605525
        ;   XREF to: 00605798 (CONDITIONAL_JUMP)  ; LAB_00605798
    TEST EDI,EDI                        ; 0060552b
        ;   Label: LAB_0060552b
    JNZ 0x006055a2                      ; 0060552d
        ;   XREF to: 006055a2 (CONDITIONAL_JUMP)  ; LAB_006055a2
    CMP dword ptr [ESP + 0x18],0x30     ; 00605533
    JNZ 0x0060559b                      ; 00605538
        ;   XREF to: 0060559b (CONDITIONAL_JUMP)  ; LAB_0060559b
    MOV EAX,dword ptr [ESP + 0x40]      ; 0060553a
    PUSH EAX                            ; 0060553e
    CALL crt_stdio.c_scanf_getc_with_width_FUN_00605918 ; 0060553f
        ;   XREF to: 00605918 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_scanf_getc_with_width_FUN_00605918(scanf_state_t * state)
    ADD ESP,0x4                         ; 00605544
    MOV EBP,0x1                         ; 00605547
    MOV dword ptr [ESP + 0x18],EAX      ; 0060554c
    CMP EAX,-0x1                        ; 00605550
    JZ 0x00605798                       ; 00605553
        ;   XREF to: 00605798 (CONDITIONAL_JUMP)  ; LAB_00605798
    CMP EAX,0x78                        ; 00605559
    JZ 0x00605563                       ; 0060555c
        ;   XREF to: 00605563 (CONDITIONAL_JUMP)  ; LAB_00605563
    CMP EAX,0x58                        ; 0060555e
    JNZ 0x00605594                      ; 00605561
        ;   XREF to: 00605594 (CONDITIONAL_JUMP)  ; LAB_00605594
    MOV EDX,dword ptr [ESP + 0x40]      ; 00605563
        ;   Label: LAB_00605563
    MOV EBX,dword ptr [ESP + 0x20]      ; 00605567
    PUSH EDX                            ; 0060556b
    ADD EBX,0x2                         ; 0060556c
    CALL crt_stdio.c_scanf_getc_with_width_FUN_00605918 ; 0060556f
        ;   XREF to: 00605918 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_scanf_getc_with_width_FUN_00605918(scanf_state_t * state)
    ...
    JZ 0x00605798                       ; 00605584
        ;   XREF to: 00605798 (CONDITIONAL_JUMP)  ; LAB_00605798
    MOV EDI,0x10                        ; 0060558a
    JMP 0x006055fe                      ; 0060558f
        ;   XREF to: 006055fe (UNCONDITIONAL_JUMP)  ; LAB_006055fe
    MOV EDI,0x8                         ; 00605594
        ;   Label: LAB_00605594
    JMP 0x006055fe                      ; 00605599
        ;   XREF to: 006055fe (UNCONDITIONAL_JUMP)  ; LAB_006055fe
    MOV EDI,0xa                         ; 0060559b
        ;   Label: LAB_0060559b
    JMP 0x006055fe                      ; 006055a0
        ;   XREF to: 006055fe (UNCONDITIONAL_JUMP)  ; LAB_006055fe
    CMP EDI,0x10                        ; 006055a2
        ;   Label: LAB_006055a2
    JNZ 0x006055fe                      ; 006055a5
        ;   XREF to: 006055fe (CONDITIONAL_JUMP)  ; LAB_006055fe
    CMP dword ptr [ESP + 0x18],0x30     ; 006055a7
    JNZ 0x006055fe                      ; 006055ac
        ;   XREF to: 006055fe (CONDITIONAL_JUMP)  ; LAB_006055fe
    MOV EBX,dword ptr [ESP + 0x40]      ; 006055ae
    PUSH EBX                            ; 006055b2
    CALL crt_stdio.c_scanf_getc_with_width_FUN_00605918 ; 006055b3
        ;   XREF to: 00605918 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_scanf_getc_with_width_FUN_00605918(scanf_state_t * state)
    ADD ESP,0x4                         ; 006055b8
    MOV EBP,0x1                         ; 006055bb
    MOV dword ptr [ESP + 0x18],EAX      ; 006055c0
    CMP EAX,-0x1                        ; 006055c4
    JZ 0x00605798                       ; 006055c7
        ;   XREF to: 00605798 (CONDITIONAL_JUMP)  ; LAB_00605798
    CMP EAX,0x78                        ; 006055cd
    JZ 0x006055d7                       ; 006055d0
        ;   XREF to: 006055d7 (CONDITIONAL_JUMP)  ; LAB_006055d7
    CMP EAX,0x58                        ; 006055d2
    JNZ 0x006055fe                      ; 006055d5
        ;   XREF to: 006055fe (CONDITIONAL_JUMP)  ; LAB_006055fe
    ...
    CALL crt_stdio.c_scanf_getc_with_width_FUN_00605918 ; 006055e3
        ;   XREF to: 00605918 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_scanf_getc_with_width_FUN_00605918(scanf_state_t * state)
    ...
    JZ 0x00605798                       ; 006055f8
        ;   XREF to: 00605798 (CONDITIONAL_JUMP)  ; LAB_00605798
    MOV EAX,dword ptr [ESP + 0x40]      ; 006055fe
        ;   Label: LAB_006055fe
    TEST byte ptr [EAX + 0x10],0x40     ; 00605602
    JZ 0x0060570d                       ; 00605606
        ;   XREF to: 0060570d (CONDITIONAL_JUMP)  ; LAB_0060570d
    ...
    MOV ECX,dword ptr [ESP + 0x18]      ; 00605616
        ;   Label: LAB_00605616
    PUSH ECX                            ; 0060561a
    CALL crt_stdio.c_char_to_digit_FUN_006058e8 ; 0060561b
        ;   XREF to: 006058e8 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_char_to_digit_FUN_006058e8(int ch)
    ADD ESP,0x4                         ; 00605620
    CMP EAX,EDI                         ; 00605623
    JGE 0x00605685                      ; 00605625
        ;   XREF to: 00605685 (CONDITIONAL_JUMP)  ; LAB_00605685
    ...
    CALL crt_math.c_multiply64_FUN_0060b2b8 ; 00605643
        ;   XREF to: 0060b2b8 (UNCONDITIONAL_CALL)  ; ulonglong crt_math.c_multiply64_FUN_0060b2b8(ulonglong a, ulonglong b)
    ...
    PUSH EAX                            ; 0060566c
    CALL crt_stdio.c_scanf_getc_with_width_FUN_00605918 ; 0060566d
        ;   XREF to: 00605918 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_scanf_getc_with_width_FUN_00605918(scanf_state_t * state)
    ADD ESP,0x4                         ; 00605672
    INC EBP                             ; 00605675
    MOV dword ptr [ESP + 0x18],EAX      ; 00605676
    CMP EAX,-0x1                        ; 0060567a
    JZ 0x00605798                       ; 0060567d
        ;   XREF to: 00605798 (CONDITIONAL_JUMP)  ; LAB_00605798
    JMP 0x00605616                      ; 00605683
        ;   XREF to: 00605616 (UNCONDITIONAL_JUMP)  ; LAB_00605616
    CMP dword ptr [ESP + 0x18],0x3a     ; 00605685
        ;   Label: LAB_00605685
    JNZ 0x00605786                      ; 0060568a
        ;   XREF to: 00605786 (CONDITIONAL_JUMP)  ; LAB_00605786
    MOV EAX,dword ptr [ESP + 0x40]      ; 00605690
    TEST byte ptr [EAX + 0x10],0x80     ; 00605694
    JZ 0x00605786                       ; 00605698
        ;   XREF to: 00605786 (CONDITIONAL_JUMP)  ; LAB_00605786
    MOV EBX,dword ptr [ESP + 0x40]      ; 0060569e
        ;   Label: LAB_0060569e
    PUSH EBX                            ; 006056a2
    CALL crt_stdio.c_scanf_getc_with_width_FUN_00605918 ; 006056a3
        ;   XREF to: 00605918 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_scanf_getc_with_width_FUN_00605918(scanf_state_t * state)
    ADD ESP,0x4                         ; 006056a8
    INC EBP                             ; 006056ab
    MOV dword ptr [ESP + 0x18],EAX      ; 006056ac
    CMP EAX,-0x1                        ; 006056b0
    JZ 0x00605798                       ; 006056b3
        ;   XREF to: 00605798 (CONDITIONAL_JUMP)  ; LAB_00605798
    PUSH EAX                            ; 006056b9
    CALL crt_stdio.c_char_to_digit_FUN_006058e8 ; 006056ba
        ;   XREF to: 006058e8 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_char_to_digit_FUN_006058e8(int ch)
    ADD ESP,0x4                         ; 006056bf
    CMP EAX,EDI                         ; 006056c2
    JGE 0x00605786                      ; 006056c4
        ;   XREF to: 00605786 (CONDITIONAL_JUMP)  ; LAB_00605786
    ...
    CALL crt_math.c_multiply64_FUN_0060b2b8 ; 006056e6
        ;   XREF to: 0060b2b8 (UNCONDITIONAL_CALL)  ; ulonglong crt_math.c_multiply64_FUN_0060b2b8(ulonglong a, ulonglong b)
    ...
    JMP 0x0060569e                      ; 0060570b
        ;   XREF to: 0060569e (UNCONDITIONAL_JUMP)  ; LAB_0060569e
    MOV ESI,dword ptr [ESP + 0x18]      ; 0060570d
        ;   Label: LAB_0060570d
    PUSH ESI                            ; 00605711
    CALL crt_stdio.c_char_to_digit_FUN_006058e8 ; 00605712
        ;   XREF to: 006058e8 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_char_to_digit_FUN_006058e8(int ch)
    ADD ESP,0x4                         ; 00605717
    CMP EAX,EDI                         ; 0060571a
    JGE 0x00605744                      ; 0060571c
        ;   XREF to: 00605744 (CONDITIONAL_JUMP)  ; LAB_00605744
    ...
    JZ 0x0060584c                       ; 006057a0
        ;   XREF to: 0060584c (CONDITIONAL_JUMP)  ; LAB_0060584c
    CMP dword ptr [ESP + 0x1c],0x2d     ; 006057a6
    JNZ 0x006057d4                      ; 006057ab
        ;   XREF to: 006057d4 (CONDITIONAL_JUMP)  ; LAB_006057d4
    ...
    JNZ 0x006057ce                      ; 006057c7
        ;   XREF to: 006057ce (CONDITIONAL_JUMP)  ; LAB_006057ce
    LEA EAX,[EBX + 0x1]                 ; 006057c9
    JMP 0x006057d0                      ; 006057cc
    ...
    TEST EBP,EBP                        ; 006057d4
        ;   Label: LAB_006057d4
    JLE 0x006058da                      ; 006057d6
        ;   XREF to: 006058da (CONDITIONAL_JUMP)  ; LAB_006058da
    ...
    JZ 0x006058da                       ; 006057ec
        ;   XREF to: 006058da (CONDITIONAL_JUMP)  ; LAB_006058da
    TEST DL,0x4                         ; 006057f2
    JZ 0x0060580b                       ; 006057f5
        ;   XREF to: 0060580b (CONDITIONAL_JUMP)  ; LAB_0060580b
    ...
    JMP 0x0060583b                      ; 00605809
        ;   XREF to: 0060583b (UNCONDITIONAL_JUMP)  ; LAB_0060583b
    TEST DL,0x8                         ; 0060580b
        ;   Label: LAB_0060580b
    JZ 0x0060582b                       ; 0060580e
        ;   XREF to: 0060582b (CONDITIONAL_JUMP)  ; LAB_0060582b
    ...
    JMP 0x006058da                      ; 00605826
        ;   XREF to: 006058da (UNCONDITIONAL_JUMP)  ; LAB_006058da
    ...
    CMP dword ptr [ESP + 0x1c],0x2d     ; 0060584c
        ;   Label: LAB_0060584c
    JNZ 0x00605857                      ; 00605851
        ;   XREF to: 00605857 (CONDITIONAL_JUMP)  ; LAB_00605857
    NEG dword ptr [ESP + 0x24]          ; 00605853
    TEST EBP,EBP                        ; 00605857
        ;   Label: LAB_00605857
    JLE 0x006058da                      ; 00605859
        ;   XREF to: 006058da (CONDITIONAL_JUMP)  ; LAB_006058da
    ...
    JZ 0x006058da                       ; 0060586f
        ;   XREF to: 006058da (CONDITIONAL_JUMP)  ; LAB_006058da
    TEST DH,0x4                         ; 00605871
    JZ 0x00605886                       ; 00605874
        ;   XREF to: 00605886 (CONDITIONAL_JUMP)  ; LAB_00605886
    ...
    JMP 0x006058b1                      ; 00605884
        ;   XREF to: 006058b1 (UNCONDITIONAL_JUMP)  ; LAB_006058b1
    TEST DH,0x8                         ; 00605886
        ;   Label: LAB_00605886
    JZ 0x0060589f                       ; 00605889
        ;   XREF to: 0060589f (CONDITIONAL_JUMP)  ; LAB_0060589f
    ...
    JZ 0x006058d0                       ; 006058bb
        ;   XREF to: 006058d0 (CONDITIONAL_JUMP)  ; LAB_006058d0
