...
section .text
    ...
    JNZ 0x00608f11                      ; 00608ee9
        ;   XREF to: 00608f11 (CONDITIONAL_JUMP)  ; LAB_00608f11
    MOV EDX,dword ptr [EBX + 0x10]      ; 00608eeb
    PUSH EDX                            ; 00608eee
    CALL crt_io.c_IsSpecialDevice_FUN_0060c270 ; 00608eef
