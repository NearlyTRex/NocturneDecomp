...
section .text
    ...
    JNZ 0x00602fba                      ; 00602f90 | LAB_00602fba
        ;   XREF to: 00602fba (CONDITIONAL_JUMP)
    MOV CX,word ptr ES:[EBX]            ; 00602f92
        ;   Label: LAB_00602f92
    TEST CX,CX                          ; 00602f96
    JZ 0x00602fea                       ; 00602f99 | LAB_00602fea
    ...
    CALL crt_stdio.c_WideCharToSingleByte_FUN_0060acf0 ; 00602fa9 | int crt_stdio.c_WideCharToSingleByte_FUN_0060acf0(wchar_t wide_char, char * output_buffer)
        ;   XREF to: 0060acf0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00602fae
    CMP EAX,-0x1                        ; 00602fb1
    JZ 0x00602f92                       ; 00602fb4 | LAB_00602f92
        ;   XREF to: 00602f92 (CONDITIONAL_JUMP)
    ADD ESI,EAX                         ; 00602fb6
    JMP 0x00602f92                      ; 00602fb8 | LAB_00602f92
        ;   XREF to: 00602f92 (UNCONDITIONAL_JUMP)
    MOV DX,word ptr ES:[EBX]            ; 00602fba
        ;   Label: LAB_00602fba
    TEST DX,DX                          ; 00602fbe
    JZ 0x00602fe6                       ; 00602fc1 | LAB_00602fe6
        ;   XREF to: 00602fe6 (CONDITIONAL_JUMP)
    CMP ESI,EDI                         ; 00602fc3
    JG 0x00602fe6                       ; 00602fc5 | LAB_00602fe6
        ;   XREF to: 00602fe6 (CONDITIONAL_JUMP)
    ...
    CALL crt_stdio.c_WideCharToSingleByte_FUN_0060acf0 ; 00602fd5 | int crt_stdio.c_WideCharToSingleByte_FUN_0060acf0(wchar_t wide_char, char * output_buffer)
        ;   XREF to: 0060acf0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00602fda
    CMP EAX,-0x1                        ; 00602fdd
    JZ 0x00602fba                       ; 00602fe0 | LAB_00602fba
        ;   XREF to: 00602fba (CONDITIONAL_JUMP)
    ADD ESI,EAX                         ; 00602fe2
    JMP 0x00602fba                      ; 00602fe4 | LAB_00602fba
        ;   XREF to: 00602fba (UNCONDITIONAL_JUMP)
    CMP ESI,EDI                         ; 00602fe6
        ;   Label: LAB_00602fe6
    JG 0x00602fee                       ; 00602fe8 | LAB_00602fee
        ;   XREF to: 00602fee (CONDITIONAL_JUMP)
    MOV EAX,ESI                         ; 00602fea
        ;   Label: LAB_00602fea
    JMP 0x00602ff0                      ; 00602fec | LAB_00602ff0
