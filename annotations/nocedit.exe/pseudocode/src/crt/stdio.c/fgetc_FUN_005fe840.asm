...
;                               FUNCTION
; *****************************************************************************
; __watcallStack int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
;
; Parameters:
...
;   core_actor.cpp_serializeClothList_FUN_0040be60 at 0040be80
;   core_actor.cpp_serializeDescription_FUN_0040b290 at 0040b2ab
;   core_actor.cpp_serializeMotionState_FUN_0040b9f0 at 0040ba0b
;   core_actor.cpp_serializePartStatus_FUN_0040bae0 at 0040bb03
;   core_actor.cpp_serializeRules_FUN_0040c000 at 0040c0c2
;   core_actor.cpp_serializeSimBox_FUN_0040bd70 at 0040bd8b
;   core_actor.cpp_serializeString_FUN_0040b5c0 at 0040b5e0
...
section .text
    ...
    JMP 0x005fe8ba                      ; 005fe897 | LAB_005fe8ba
    ...
    JGE 0x005fe8b1                      ; 005fe8a2 | LAB_005fe8b1
        ;   XREF to: 005fe8b1 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 005fe8a4
    CALL crt_stdio.c_FillBufferAndGetChar_FUN_005fe910 ; 005fe8a5 | int crt_stdio.c_FillBufferAndGetChar_FUN_005fe910(FILE * file)
        ;   XREF to: 005fe910 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005fe8aa
    MOV ESI,EAX                         ; 005fe8ad
    JMP 0x005fe8ba                      ; 005fe8af | LAB_005fe8ba
        ;   XREF to: 005fe8ba (UNCONDITIONAL_JUMP)
    ...
    TEST byte ptr [EBX + 0xc],0x40      ; 005fe8ba
        ;   Label: LAB_005fe8ba
    JNZ 0x005fe8fa                      ; 005fe8be | LAB_005fe8fa
        ;   XREF to: 005fe8fa (CONDITIONAL_JUMP)
    CMP ESI,0xd                         ; 005fe8c0
    JNZ 0x005fe8e7                      ; 005fe8c3 | LAB_005fe8e7
    ...
    JGE 0x005fe8dd                      ; 005fe8ce | LAB_005fe8dd
        ;   XREF to: 005fe8dd (CONDITIONAL_JUMP)
    PUSH EBX                            ; 005fe8d0
    CALL crt_stdio.c_FillBufferAndGetChar_FUN_005fe910 ; 005fe8d1 | int crt_stdio.c_FillBufferAndGetChar_FUN_005fe910(FILE * file)
        ;   XREF to: 005fe910 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005fe8d6
    MOV ESI,EAX                         ; 005fe8d9
    JMP 0x005fe8e7                      ; 005fe8db | LAB_005fe8e7
    ...
    CMP ESI,0x1a                        ; 005fe8e7
        ;   Label: LAB_005fe8e7
    JNZ 0x005fe8fa                      ; 005fe8ea | LAB_005fe8fa
        ;   XREF to: 005fe8fa (CONDITIONAL_JUMP)
    ...
    MOV EDI,dword ptr [EBX + 0x10]      ; 005fe8fa
        ;   Label: LAB_005fe8fa
    PUSH EDI                            ; 005fe8fd
    CALL dword ptr [0x00684eec]         ; 005fe8fe | EXIT_CRITICAL_SECTION_BY_INDEX_FUNC * PTR_crt_sync.c_ExitCriticalSection_FUN_00602434_00684eec
        ;   Label: LAB_005fe8fe
