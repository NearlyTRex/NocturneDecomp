...
;                               FUNCTION
; *****************************************************************************
; __cdecl SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
;
; Parameters:
...
;   cockpit_pkbitmap.cpp_parsePBGFile_FUN_0054b9b0 at 0054b9c9
...
section .text
    ...
    PUSH EDX                            ; 005fd9a2
    CALL dword ptr [0x00684ee8]         ; 005fd9a3 | ENTER_CRITICAL_SECTION_BY_INDEX_FUNC * PTR_crt_sync.c_EnterCriticalSection_FUN_00602434_00684ee8
    MOV AH,byte ptr [EBX + 0xc]         ; 005fd9a9
    ADD ESP,0x4                         ; 005fd9ac
    TEST AH,0x1                         ; 005fd9af
    JNZ 0x005fd9d6                      ; 005fd9b2 | LAB_005fd9d6
        ;   XREF to: 005fd9d6 (CONDITIONAL_JUMP)
    PUSH 0x4                            ; 005fd9b4
    CALL crt_errno.c_setErrno_FUN_00602790 ; 005fd9b6 | void crt_errno.c_setErrno_FUN_00602790(int error_code)
    ...
    PUSH EDX                            ; 005fd9c5
    CALL dword ptr [0x00684eec]         ; 005fd9c6 | EXIT_CRITICAL_SECTION_BY_INDEX_FUNC * PTR_crt_sync.c_ExitCriticalSection_FUN_00602434_00684eec
    ADD ESP,0x4                         ; 005fd9cc
    XOR EAX,EAX                         ; 005fd9cf
    JMP 0x005fdb7f                      ; 005fd9d1 | LAB_005fdb7f
        ;   XREF to: 005fdb7f (UNCONDITIONAL_JUMP)
    IMUL ESI,dword ptr [ESP + 0x1c]     ; 005fd9d6
        ;   Label: LAB_005fd9d6
    TEST ESI,ESI                        ; 005fd9db
    JNZ 0x005fd9f6                      ; 005fd9dd | LAB_005fd9f6
        ;   XREF to: 005fd9f6 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0x10]      ; 005fd9df
    PUSH EAX                            ; 005fd9e2
    CALL dword ptr [0x00684eec]         ; 005fd9e3 | EXIT_CRITICAL_SECTION_BY_INDEX_FUNC * PTR_crt_sync.c_ExitCriticalSection_FUN_00602434_00684eec
    ...
    JNZ 0x005fda08                      ; 005fd9fd | LAB_005fda08
        ;   XREF to: 005fda08 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 005fd9ff
    CALL crt_stdio.c_InitializeFileBuffer_FUN_006027e0 ; 005fda00 | void crt_stdio.c_InitializeFileBuffer_FUN_006027e0(FILE * file)
    ...
    JNZ 0x005fda9f                      ; 005fda90 | LAB_005fda9f
        ;   XREF to: 005fda9f (CONDITIONAL_JUMP)
    CMP EBP,0x200                       ; 005fda92
    JBE 0x005fda9f                      ; 005fda98 | LAB_005fda9f
        ;   XREF to: 005fda9f (CONDITIONAL_JUMP)
    XOR AL,AL                           ; 005fda9a
    ...
    PUSH EAX                            ; 005fdaa8
    CALL crt_stdio.c_ReadFileWithDeviceAbstraction_FUN_00602880 ; 005fdaa9 | int crt_stdio.c_ReadFileWithDeviceAbstraction_FUN_00602880(int file_handle_index, void * buffer, int bytes_to_read)
        ;   XREF to: 00602880 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005fdaae
    CMP EAX,-0x1                        ; 005fdab1
    JNZ 0x005fdabf                      ; 005fdab4 | LAB_005fdabf
        ;   XREF to: 005fdabf (CONDITIONAL_JUMP)
    OR byte ptr [EBX + 0xc],0x20        ; 005fdab6
    JMP 0x005fdb69                      ; 005fdaba | LAB_005fdb69
        ;   XREF to: 005fdb69 (UNCONDITIONAL_JUMP)
    TEST EAX,EAX                        ; 005fdabf
        ;   Label: LAB_005fdabf
    JNZ 0x005fdacc                      ; 005fdac1 | LAB_005fdacc
        ;   XREF to: 005fdacc (CONDITIONAL_JUMP)
    OR byte ptr [EBX + 0xc],0x10        ; 005fdac3
    JMP 0x005fdb69                      ; 005fdac7 | LAB_005fdb69
        ;   XREF to: 005fdb69 (UNCONDITIONAL_JUMP)
    ...
    JMP 0x005fda1b                      ; 005fdadd | LAB_005fda1b
        ;   XREF to: 005fda1b (UNCONDITIONAL_JUMP)
    PUSH EBX                            ; 005fdae2
        ;   Label: LAB_005fdae2
    CALL crt_stdio.c_FillInputBuffer_FUN_005fe940 ; 005fdae3 | int crt_stdio.c_FillInputBuffer_FUN_005fe940(FILE * file)
        ;   XREF to: 005fe940 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005fdae8
    TEST EAX,EAX                        ; 005fdaeb
    JZ 0x005fdb69                       ; 005fdaed | LAB_005fdb69
        ;   XREF to: 005fdb69 (CONDITIONAL_JUMP)
    JMP 0x005fda1b                      ; 005fdaf3 | LAB_005fda1b
        ;   XREF to: 005fda1b (UNCONDITIONAL_JUMP)
    ...
    CMP EDI,dword ptr [EBX + 0x4]       ; 005fdb00
        ;   Label: LAB_005fdb00
    JNZ 0x005fdb12                      ; 005fdb03 | LAB_005fdb12
        ;   XREF to: 005fdb12 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 005fdb05
    CALL crt_stdio.c_FillInputBuffer_FUN_005fe940 ; 005fdb06 | int crt_stdio.c_FillInputBuffer_FUN_005fe940(FILE * file)
        ;   XREF to: 005fe940 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005fdb0b
    TEST EAX,EAX                        ; 005fdb0e
    JZ 0x005fdb69                       ; 005fdb10 | LAB_005fdb69
        ;   XREF to: 005fdb69 (CONDITIONAL_JUMP)
    ...
    JNZ 0x005fdb4f                      ; 005fdb2a | LAB_005fdb4f
        ;   XREF to: 005fdb4f (CONDITIONAL_JUMP)
    CMP EDI,dword ptr [EBX + 0x4]       ; 005fdb2c
    JNZ 0x005fdb3e                      ; 005fdb2f | LAB_005fdb3e
        ;   XREF to: 005fdb3e (CONDITIONAL_JUMP)
    PUSH EBX                            ; 005fdb31
    CALL crt_stdio.c_FillInputBuffer_FUN_005fe940 ; 005fdb32 | int crt_stdio.c_FillInputBuffer_FUN_005fe940(FILE * file)
        ;   XREF to: 005fe940 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005fdb37
    TEST EAX,EAX                        ; 005fdb3a
    JZ 0x005fdb69                       ; 005fdb3c | LAB_005fdb69
        ;   XREF to: 005fdb69 (CONDITIONAL_JUMP)
    ...
    CMP EAX,0x1a                        ; 005fdb4f
        ;   Label: LAB_005fdb4f
    JNZ 0x005fdb5a                      ; 005fdb52 | LAB_005fdb5a
        ;   XREF to: 005fdb5a (CONDITIONAL_JUMP)
    OR byte ptr [EBX + 0xc],0x10        ; 005fdb54
    JMP 0x005fdb69                      ; 005fdb58 | LAB_005fdb69
        ;   XREF to: 005fdb69 (UNCONDITIONAL_JUMP)
    ...
    JNZ 0x005fdb00                      ; 005fdb67 | LAB_005fdb00
        ;   XREF to: 005fdb00 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [EBX + 0x10]      ; 005fdb69
        ;   Label: LAB_005fdb69
    PUSH ESI                            ; 005fdb6c
    CALL dword ptr [0x00684eec]         ; 005fdb6d | EXIT_CRITICAL_SECTION_BY_INDEX_FUNC * PTR_crt_sync.c_ExitCriticalSection_FUN_00602434_00684eec
