...
;                               FUNCTION
; *****************************************************************************
; __cdecl void crt_stdio.c_InitializeFileBuffer_FUN_006027e0(FILE * file)
;
; Parameters:
...
section .text
    ...
    MOV ECX,dword ptr [EBX + 0x14]      ; 0060281c
        ;   Label: LAB_0060281c
    PUSH ECX                            ; 0060281f
    CALL crt_memory.c_malloc_FUN_00601bb0 ; 00602820 | void * crt_memory.c_malloc_FUN_00601bb0(ulong size)
    ...
    JNZ 0x0060285b                      ; 00602836 | LAB_0060285b
    ...
    JMP 0x0060285f                      ; 00602859 | LAB_0060285f
