...
;                               FUNCTION
; *****************************************************************************
; __cdecl int crt_stdio.c_fputc_FUN_005ff2d7(FILE * stream, int character)
;
; Parameters:
...
section .text
    ...
    JNZ 0x005ff355                      ; 005ff2ed | LAB_005ff355
    ...
    JNC 0x005ff36c                      ; 005ff31f | LAB_005ff36c
    ...
    CMP EAX,-0x1                        ; 005ff330
        ;   Label: LAB_005ff330
    JNZ 0x005ff347                      ; 005ff333 | LAB_005ff347
    ...
    PUSH EAX                            ; 005ff33e
    CALL crt_stdio.c_reportStreamError_FUN_00606020 ; 005ff33f | void crt_stdio.c_reportStreamError_FUN_00606020(FileEmbeddedData * embedded_data, uint error_flags)
    ...
    JNZ 0x005ff379                      ; 005ff353 | LAB_005ff379
    ...
    PUSH EAX                            ; 005ff35d
        ;   Label: LAB_005ff35d
    CALL crt_stdio.c_prepare_stream_for_write_FUN_00606055 ; 005ff35e | bool crt_stdio.c_prepare_stream_for_write_FUN_00606055(FILE * stream)
        ;   XREF to: 00606055 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005ff363
    TEST EAX,EAX                        ; 005ff366
    JNZ 0x005ff305                      ; 005ff368 | LAB_005ff305
        ;   XREF to: 005ff305 (CONDITIONAL_JUMP)
    JMP 0x005ff355                      ; 005ff36a | LAB_005ff355
    ...
    JMP 0x005ff330                      ; 005ff377 | LAB_005ff330
        ;   XREF to: 005ff330 (UNCONDITIONAL_JUMP)
    PUSH EBX                            ; 005ff379
        ;   Label: LAB_005ff379
    CALL crt_stdio.c_stream_flush_FUN_006060bb ; 005ff37a | FILE * crt_stdio.c_stream_flush_FUN_006060bb(FILE * stream)
        ;   XREF to: 006060bb (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005ff37f
    JMP 0x005ff355                      ; 005ff382 | LAB_005ff355
        ;   XREF to: 005ff355 (UNCONDITIONAL_JUMP)
