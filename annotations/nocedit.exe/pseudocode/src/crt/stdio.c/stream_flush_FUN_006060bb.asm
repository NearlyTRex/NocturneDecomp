...
;   crt_stdio.c_stream_write_internal_FUN_005ffcb3 at 005ffd6b
;
; Called Functions:
...
section .text
    ...
    JZ 0x006060d0                       ; 006060ca | LAB_006060d0
    ...
    JNZ 0x006060cc                      ; 006060e6 | LAB_006060cc
    ...
    PUSH EAX                            ; 006060f1
    CALL crt_stdio.c_reportStreamError_FUN_00606020 ; 006060f2 | void crt_stdio.c_reportStreamError_FUN_00606020(FileEmbeddedData * embedded_data, uint error_flags)
