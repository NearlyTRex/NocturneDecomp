...
;                               FUNCTION
; *****************************************************************************
; __cdecl int crt_stdio.c_fflush_FUN_00601540(FILE * stream)
;
; Parameters:
...
section .text
    ...
    JNZ 0x00601550                      ; 00601546 | LAB_00601550
        ;   XREF to: 00601550 (CONDITIONAL_JUMP)
    CALL crt_unknown.c_FUN_00605950     ; 00601548 | undefined crt_unknown.c_FUN_00605950()
        ;   XREF to: 00605950 (UNCONDITIONAL_CALL)
    XOR EAX,EAX                         ; 0060154d
    RET                                 ; 0060154f
    PUSH EAX                            ; 00601550
        ;   Label: LAB_00601550
    CALL crt_stdio.c_fflushInternal_FUN_006039d0 ; 00601551 | int crt_stdio.c_fflushInternal_FUN_006039d0(FILE * file_handle)
