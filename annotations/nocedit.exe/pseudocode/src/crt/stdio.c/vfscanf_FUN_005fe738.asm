...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl crt_stdio_c_vfscanf_FUN_005fe738(_FILE *file,char *format,va_list_t args)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 005fe746
    CALL dword ptr [0x00684ee8]         ; 005fe747 | PTR_crt_sync.c_EnterCriticalSection_FUN_00602434_00684ee8
    MOV EAX,dword ptr [EBX + 0x8]       ; 005fe74d
    MOV ECX,dword ptr [EAX + 0xc]       ; 005fe750
    ADD ESP,0x4                         ; 005fe753
    CMP ECX,0x1                         ; 005fe756
    JZ 0x005fe777                       ; 005fe759
        ;   XREF to: 005fe777 (CONDITIONAL_JUMP)  ; LAB_005fe777
    TEST ECX,ECX                        ; 005fe75b
    JZ 0x005fe770                       ; 005fe75d
        ;   XREF to: 005fe770 (CONDITIONAL_JUMP)  ; LAB_005fe770
    MOV EDI,dword ptr [EBX + 0x10]      ; 005fe75f
    PUSH EDI                            ; 005fe762
    CALL dword ptr [0x00684eec]         ; 005fe763 | PTR_crt_sync.c_ExitCriticalSection_FUN_00602434_00684eec
    ADD ESP,0x4                         ; 005fe769
    XOR EAX,EAX                         ; 005fe76c
    JMP 0x005fe7b5                      ; 005fe76e
        ;   XREF to: 005fe7b5 (UNCONDITIONAL_JUMP)  ; LAB_005fe7b5
    ...
    CALL dword ptr [0x00684eec]         ; 005fe7aa | PTR_crt_sync.c_ExitCriticalSection_FUN_00602434_00684eec
