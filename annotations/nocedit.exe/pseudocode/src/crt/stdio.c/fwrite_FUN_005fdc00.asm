...
;                               FUNCTION
; *****************************************************************************
; __watcallStack SIZE_T crt_stdio.c_fwrite_FUN_005fdc00(void * ptr, SIZE_T size, SIZE_T count, FILE * file)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 005fdc12
    CALL dword ptr [0x00684ee8]         ; 005fdc13 | ENTER_CRITICAL_SECTION_BY_INDEX_FUNC * PTR_crt_sync.c_EnterCriticalSection_FUN_00602434_00684ee8
    MOV AH,byte ptr [EBX + 0xc]         ; 005fdc19
    ADD ESP,0x4                         ; 005fdc1c
    TEST AH,0x2                         ; 005fdc1f
    JNZ 0x005fdc4b                      ; 005fdc22 | LAB_005fdc4b
        ;   XREF to: 005fdc4b (CONDITIONAL_JUMP)
    PUSH 0x4                            ; 005fdc24
    CALL crt_errno.c_setErrno_FUN_00602790 ; 005fdc26 | void crt_errno.c_setErrno_FUN_00602790(int error_code)
    ...
    CALL dword ptr [0x00684eec]         ; 005fdc3b | EXIT_CRITICAL_SECTION_BY_INDEX_FUNC * PTR_crt_sync.c_ExitCriticalSection_FUN_00602434_00684eec
    ADD ESP,0x4                         ; 005fdc41
    XOR EAX,EAX                         ; 005fdc44
    JMP 0x005fde31                      ; 005fdc46 | LAB_005fde31
        ;   XREF to: 005fde31 (UNCONDITIONAL_JUMP)
    IMUL EDI,dword ptr [ESP + 0x28]     ; 005fdc4b
        ;   Label: LAB_005fdc4b
    TEST EDI,EDI                        ; 005fdc50
    JNZ 0x005fdc6b                      ; 005fdc52 | LAB_005fdc6b
        ;   XREF to: 005fdc6b (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0x10]      ; 005fdc54
    PUSH EAX                            ; 005fdc57
    CALL dword ptr [0x00684eec]         ; 005fdc58 | EXIT_CRITICAL_SECTION_BY_INDEX_FUNC * PTR_crt_sync.c_ExitCriticalSection_FUN_00602434_00684eec
    ...
    JNZ 0x005fdc7d                      ; 005fdc72 | LAB_005fdc7d
        ;   XREF to: 005fdc7d (CONDITIONAL_JUMP)
    PUSH EBX                            ; 005fdc74
    CALL crt_stdio.c_InitializeFileBuffer_FUN_006027e0 ; 005fdc75 | void crt_stdio.c_InitializeFileBuffer_FUN_006027e0(FILE * file)
    ...
    PUSH EDI                            ; 005fdcc7
    CALL crt_stdio.c_write_FUN_006038c0 ; 005fdcc8 | int crt_stdio.c_write_FUN_006038c0(int file_handle_index, void * buffer, int bytes_to_write)
        ;   XREF to: 006038c0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005fdccd
    MOV EBP,EAX                         ; 005fdcd0
    CMP EAX,-0x1                        ; 005fdcd2
    JZ 0x005fdcec                       ; 005fdcd5 | LAB_005fdcec
        ;   XREF to: 005fdcec (CONDITIONAL_JUMP)
    TEST EAX,EAX                        ; 005fdcd7
    JNZ 0x005fdd50                      ; 005fdcd9 | LAB_005fdd50
        ;   XREF to: 005fdd50 (CONDITIONAL_JUMP)
    CALL dword ptr [0x00684ee4]         ; 005fdcdf | GET_TLS_FUNC * PTR_crt_thread.c_GetTLS_FUN_0060242c_00684ee4
    MOV dword ptr [EAX + 0x4],0xc       ; 005fdce5
    OR byte ptr [EBX + 0xc],0x20        ; 005fdcec
        ;   Label: LAB_005fdcec
    JMP 0x005fdd50                      ; 005fdcf0 | LAB_005fdd50
    ...
    JBE 0x005fdd04                      ; 005fdd00 | LAB_005fdd04
    ...
    JZ 0x005fdd47                       ; 005fdd3f | LAB_005fdd47
        ;   XREF to: 005fdd47 (CONDITIONAL_JUMP)
    TEST byte ptr [EBX + 0xd],0x4       ; 005fdd41
    JZ 0x005fdd50                       ; 005fdd45 | LAB_005fdd50
        ;   XREF to: 005fdd50 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 005fdd47
        ;   Label: LAB_005fdd47
    CALL crt_stdio.c_fflushInternal_FUN_006039d0 ; 005fdd48 | int crt_stdio.c_fflushInternal_FUN_006039d0(FILE * file_handle)
    ...
    PUSH EAX                            ; 005fddbc
    INC EBP                             ; 005fddbd
    CALL crt_stdio.c_fputc_FUN_006007a0 ; 005fddbe | int crt_stdio.c_fputc_FUN_006007a0(int character, FILE * file)
        ;   XREF to: 006007a0 (UNCONDITIONAL_CALL)
    MOV DL,byte ptr [EBX + 0xc]         ; 005fddc3
    ADD ESP,0x8                         ; 005fddc6
    TEST DL,0x30                        ; 005fddc9
    JNZ 0x005fdddb                      ; 005fddcc | LAB_005fdddb
    ...
    JNZ 0x005fddb6                      ; 005fddd9 | LAB_005fddb6
    ...
    JZ 0x005fde03                       ; 005fdde7 | LAB_005fde03
        ;   XREF to: 005fde03 (CONDITIONAL_JUMP)
    ...
    CALL crt_stdio.c_fflushInternal_FUN_006039d0 ; 005fddfb | int crt_stdio.c_fflushInternal_FUN_006039d0(FILE * file_handle)
        ;   XREF to: 006039d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005fde00
    TEST byte ptr [EBX + 0xc],0x20      ; 005fde03
        ;   Label: LAB_005fde03
    JZ 0x005fde0f                       ; 005fde07 | LAB_005fde0f
    ...
    CALL dword ptr [0x00684eec]         ; 005fde1e | EXIT_CRITICAL_SECTION_BY_INDEX_FUNC * PTR_crt_sync.c_ExitCriticalSection_FUN_00602434_00684eec
