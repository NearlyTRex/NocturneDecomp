...
;                               FUNCTION
; *****************************************************************************
; __watcallStack int crt_stdio.c_FillInputBuffer_FUN_005fe940(FILE * file)
;
; Parameters:
...
section .text
    ...
    JNZ 0x005fe95a                      ; 005fe94f | LAB_005fe95a
        ;   XREF to: 005fe95a (CONDITIONAL_JUMP)
    PUSH EBX                            ; 005fe951
    CALL crt_stdio.c_InitializeFileBuffer_FUN_006027e0 ; 005fe952 | void crt_stdio.c_InitializeFileBuffer_FUN_006027e0(FILE * file)
        ;   XREF to: 006027e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005fe957
    MOV AH,byte ptr [EBX + 0xd]         ; 005fe95a
        ;   Label: LAB_005fe95a
    TEST AH,0x20                        ; 005fe95d
    JZ 0x005fe974                       ; 005fe960 | LAB_005fe974
        ;   XREF to: 005fe974 (CONDITIONAL_JUMP)
    TEST AH,0x6                         ; 005fe962
    JZ 0x005fe974                       ; 005fe965 | LAB_005fe974
        ;   XREF to: 005fe974 (CONDITIONAL_JUMP)
    PUSH 0x2000                         ; 005fe967
    CALL crt_stdio.c_FlushFilesByMask_FUN_0060595c ; 005fe96c | int crt_stdio.c_FlushFilesByMask_FUN_0060595c(uint file_mode_mask)
    ...
    JNZ 0x005fe9b7                      ; 005fe992 | LAB_005fe9b7
        ;   XREF to: 005fe9b7 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [EBX + 0x10]      ; 005fe994
    TEST ECX,ECX                        ; 005fe997
    JNZ 0x005fe9b7                      ; 005fe999 | LAB_005fe9b7
        ;   XREF to: 005fe9b7 (CONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0x4],ECX       ; 005fe99b
    CALL crt_stdio.c_SetupConsoleInputMode_FUN_006059b0 ; 005fe99e | undefined crt_stdio.c_SetupConsoleInputMode_FUN_006059b0()
        ;   XREF to: 006059b0 (UNCONDITIONAL_CALL)
    MOV EDX,EAX                         ; 005fe9a3
    CMP EAX,-0x1                        ; 005fe9a5
    JZ 0x005fe9da                       ; 005fe9a8 | LAB_005fe9da
    ...
    PUSH EDI                            ; 005fe9ce
    CALL crt_stdio.c_ReadFileWithDeviceAbstraction_FUN_00602880 ; 005fe9cf | int crt_stdio.c_ReadFileWithDeviceAbstraction_FUN_00602880(int file_handle_index, void * buffer, int bytes_to_read)
    ...
    JG 0x005fe9ff                       ; 005fe9df | LAB_005fe9ff
        ;   XREF to: 005fe9ff (CONDITIONAL_JUMP)
    JNZ 0x005fe9ef                      ; 005fe9e1 | LAB_005fe9ef
