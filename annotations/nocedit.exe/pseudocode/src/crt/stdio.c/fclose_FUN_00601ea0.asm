...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl crt_stdio_c_fclose_FUN_00601ea0(_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00601ea0
        ;   Label: crt_stdio.c_fclose_FUN_00601ea0
    ...
    PUSH 0x1                            ; 00601ed4
    PUSH EBX                            ; 00601ed6
    CALL crt_stdio.c___CClose_FUN_00601ee4 ; 00601ed7
