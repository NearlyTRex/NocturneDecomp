...
section .text
    ...
    PUSH ESI                            ; 00604d20
        ;   Label: LAB_00604d20
    CALL crt_stdio.c_scanf_getc_wrapper_FUN_00604930 ; 00604d21 | int crt_stdio.c_scanf_getc_wrapper_FUN_00604930(scanf_state_t * state)
        ;   XREF to: 00604930 (UNCONDITIONAL_CALL)
    MOV EDX,EAX                         ; 00604d26
    ADD ESP,0x4                         ; 00604d28
    INC DL                              ; 00604d2b
    AND EDX,0xff                        ; 00604d2d
    TEST byte ptr [EDX + 0x6849c4],0x2  ; 00604d33 | char[256] g_CharacterClassificationTable
    JZ 0x00604d3f                       ; 00604d3a | LAB_00604d3f
        ;   XREF to: 00604d3f (CONDITIONAL_JUMP)
    INC EBX                             ; 00604d3c
    JMP 0x00604d20                      ; 00604d3d | LAB_00604d20
        ;   XREF to: 00604d20 (UNCONDITIONAL_JUMP)
    TEST byte ptr [ESI + 0x10],0x2      ; 00604d3f
        ;   Label: LAB_00604d3f
    JNZ 0x00604d4f                      ; 00604d43 | LAB_00604d4f
        ;   XREF to: 00604d4f (CONDITIONAL_JUMP)
    PUSH ESI                            ; 00604d45
    PUSH EAX                            ; 00604d46
    CALL crt_stdio.c_scanf_ungetc_wrapper_FUN_0060493c ; 00604d47 | int crt_stdio.c_scanf_ungetc_wrapper_FUN_0060493c(int character, scanf_state_t * state)
