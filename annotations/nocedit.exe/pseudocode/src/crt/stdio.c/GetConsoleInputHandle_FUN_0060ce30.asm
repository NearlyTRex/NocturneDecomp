...
;                               FUNCTION
; *****************************************************************************
; __watcallRegister HANDLE __watcallRegister crt_stdio_c_GetConsoleInputHandle_FUN_0060ce30(void)
;
;
; XREF[1]:
...
section .text
    ...
    CALL crt_stdio.c_InitializeConsoleHandles_FUN_0060cdbc ; 0060ce30
    ...
    MOV EAX,[0x006854fc]                ; 0060ce35 | g_ConsoleInputHandle
    RET                                 ; 0060ce3a
