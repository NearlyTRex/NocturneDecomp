...
section .text
    ...
    CALL dword ptr [0x00684ef8]         ; 00605963 | PTR_crt_sync.c_EnterCriticalSection_FUN_00602434_00684ef8
    MOV EBX,dword ptr [0x03f9b200]      ; 00605969 | g_AllocatedListHead
    XOR ESI,ESI                         ; 0060596f
    TEST EBX,EBX                        ; 00605971
    JZ 0x00605995                       ; 00605973
        ;   XREF to: 00605995 (CONDITIONAL_JUMP)  ; LAB_00605995
    MOV EAX,dword ptr [EBX + 0x4]       ; 00605975
        ;   Label: LAB_00605975
    TEST dword ptr [EAX + 0xc],EDI      ; 00605978
    JZ 0x0060598f                       ; 0060597b
        ;   XREF to: 0060598f (CONDITIONAL_JUMP)  ; LAB_0060598f
    MOV DL,byte ptr [EAX + 0xd]         ; 0060597d
    INC ESI                             ; 00605980
    TEST DL,0x10                        ; 00605981
    JZ 0x0060598f                       ; 00605984
        ;   XREF to: 0060598f (CONDITIONAL_JUMP)  ; LAB_0060598f
    PUSH EAX                            ; 00605986
    ...
    JNZ 0x00605975                      ; 00605993
        ;   XREF to: 00605975 (CONDITIONAL_JUMP)  ; LAB_00605975
    CALL dword ptr [0x00684efc]         ; 00605995 | PTR_crt_sync.c_ExitCriticalSection_FUN_00602434_00684efc
        ;   Label: LAB_00605995
