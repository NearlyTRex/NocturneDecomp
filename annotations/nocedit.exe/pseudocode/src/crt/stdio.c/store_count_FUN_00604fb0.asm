...
section .text
    ...
    JZ 0x00605015                       ; 00604fc6
        ;   XREF to: 00605015 (CONDITIONAL_JUMP)  ; LAB_00605015
    TEST CL,0x4                         ; 00604fc8
    JZ 0x00604fd9                       ; 00604fcb
        ;   XREF to: 00604fd9 (CONDITIONAL_JUMP)  ; LAB_00604fd9
    MOV EDI,dword ptr [EAX]             ; 00604fcd
    ADD EDI,0x8                         ; 00604fcf
    MOV dword ptr [EAX],EDI             ; 00604fd2
    LES EAX,[EDI + -0x8]                ; 00604fd4
    JMP 0x00604ffe                      ; 00604fd7
        ;   XREF to: 00604ffe (UNCONDITIONAL_JUMP)  ; LAB_00604ffe
    TEST CL,0x8                         ; 00604fd9
        ;   Label: LAB_00604fd9
    JZ 0x00604fee                       ; 00604fdc
        ;   XREF to: 00604fee (CONDITIONAL_JUMP)  ; LAB_00604fee
    ...
    JZ 0x0060500f                       ; 00605004
        ;   XREF to: 0060500f (CONDITIONAL_JUMP)  ; LAB_0060500f
