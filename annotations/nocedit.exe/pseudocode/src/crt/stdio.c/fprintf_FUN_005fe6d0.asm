...
;                               FUNCTION
; *****************************************************************************
; __cdecl int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format, ...)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005fe6e7
    CALL crt_stdio.c_vfprintf_FUN_00604850 ; 005fe6e8 | int crt_stdio.c_vfprintf_FUN_00604850(FILE * file, char * format, va_list_t args)
