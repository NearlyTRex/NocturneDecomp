...
section .text
    ...
    CALL dword ptr [0x00684ee8]         ; 006039e1 | ENTER_CRITICAL_SECTION_BY_INDEX_FUNC * PTR_crt_sync.c_EnterCriticalSection_FUN_00602434_00684ee8
    MOV AH,byte ptr [EBX + 0xd]         ; 006039e7
    ADD ESP,0x4                         ; 006039ea
    TEST AH,0x10                        ; 006039ed
    JZ 0x00603a76                       ; 006039f0 | LAB_00603a76
    ...
    JZ 0x00603ab1                       ; 00603a03 | LAB_00603ab1
    ...
    JZ 0x00603ab1                       ; 00603a11 | LAB_00603ab1
        ;   XREF to: 00603ab1 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [EBX + 0x4]       ; 00603a17
    MOV EBP,EAX                         ; 00603a1a
    TEST ESI,ESI                        ; 00603a1c
    JZ 0x00603ab1                       ; 00603a1e | LAB_00603ab1
        ;   XREF to: 00603ab1 (CONDITIONAL_JUMP)
    TEST EDI,EDI                        ; 00603a24
        ;   Label: LAB_00603a24
    JNZ 0x00603ab1                      ; 00603a26 | LAB_00603ab1
        ;   XREF to: 00603ab1 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 00603a2c
    PUSH EBP                            ; 00603a2d
    MOV EAX,dword ptr [EBX + 0x10]      ; 00603a2e
    PUSH EAX                            ; 00603a31
    CALL crt_stdio.c_write_FUN_006038c0 ; 00603a32 | int crt_stdio.c_write_FUN_006038c0(int file_handle_index, void * buffer, int bytes_to_write)
        ;   XREF to: 006038c0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00603a37
    MOV dword ptr [ESP],EAX             ; 00603a3a
    CMP EAX,-0x1                        ; 00603a3d
    JNZ 0x00603a4f                      ; 00603a40 | LAB_00603a4f
        ;   XREF to: 00603a4f (CONDITIONAL_JUMP)
    MOV DL,byte ptr [EBX + 0xc]         ; 00603a42
    OR DL,0x20                          ; 00603a45
    MOV EDI,EAX                         ; 00603a48
    MOV byte ptr [EBX + 0xc],DL         ; 00603a4a
    JMP 0x00603a6b                      ; 00603a4d | LAB_00603a6b
        ;   XREF to: 00603a6b (UNCONDITIONAL_JUMP)
    TEST EAX,EAX                        ; 00603a4f
        ;   Label: LAB_00603a4f
    JNZ 0x00603a6b                      ; 00603a51 | LAB_00603a6b
        ;   XREF to: 00603a6b (CONDITIONAL_JUMP)
    PUSH 0xc                            ; 00603a53
    CALL crt_errno.c_setErrno_FUN_00602790 ; 00603a55 | void crt_errno.c_setErrno_FUN_00602790(int error_code)
    ...
    PUSH ESI                            ; 00603a98
    CALL crt_stdio.c_lseek_FUN_00606690 ; 00603a99 | int crt_stdio.c_lseek_FUN_00606690(int file_handle_index, long distance_to_move, int move_method)
        ;   XREF to: 00606690 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00603a9e
    CMP EAX,-0x1                        ; 00603aa1
        ;   Label: LAB_00603aa1
    JNZ 0x00603ab1                      ; 00603aa4 | LAB_00603ab1
        ;   XREF to: 00603ab1 (CONDITIONAL_JUMP)
    ...
    JNZ 0x00603ae0                      ; 00603ac2 | LAB_00603ae0
        ;   XREF to: 00603ae0 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0x8]       ; 00603ac4
    TEST byte ptr [EAX + 0x10],0x1      ; 00603ac7
    JZ 0x00603ae0                       ; 00603acb | LAB_00603ae0
        ;   XREF to: 00603ae0 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [EBX + 0x10]      ; 00603acd
    PUSH EDX                            ; 00603ad0
    CALL crt_stdio.c_flushFileBuffers_FUN_0060af00 ; 00603ad1 | int crt_stdio.c_flushFileBuffers_FUN_0060af00(int file_handle_index)
        ;   XREF to: 0060af00 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00603ad6
    CMP EAX,-0x1                        ; 00603ad9
    JNZ 0x00603ae0                      ; 00603adc | LAB_00603ae0
        ;   XREF to: 00603ae0 (CONDITIONAL_JUMP)
    MOV EDI,EAX                         ; 00603ade
    MOV ECX,dword ptr [EBX + 0x10]      ; 00603ae0
        ;   Label: LAB_00603ae0
    PUSH ECX                            ; 00603ae3
    CALL dword ptr [0x00684eec]         ; 00603ae4 | EXIT_CRITICAL_SECTION_BY_INDEX_FUNC * PTR_crt_sync.c_ExitCriticalSection_FUN_00602434_00684eec
