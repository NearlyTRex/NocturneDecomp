...
;                               FUNCTION
; *****************************************************************************
; __cdecl int crt_stdio.c_char_to_digit_FUN_006058e8(int ch)
;
; Parameters:
; int              Stack[0x4]:4   ch
;
...
section .text
    ...
    JL 0x006058fa                       ; 006058ef | LAB_006058fa
        ;   XREF to: 006058fa (CONDITIONAL_JUMP)
    CMP EAX,0x39                        ; 006058f1
    JG 0x006058fa                       ; 006058f4 | LAB_006058fa
        ;   XREF to: 006058fa (CONDITIONAL_JUMP)
    SUB EAX,0x30                        ; 006058f6
    RET                                 ; 006058f9
    PUSH EAX                            ; 006058fa
        ;   Label: LAB_006058fa
    CALL crt_ctype.c_tolower_FUN_005feb30 ; 006058fb | int crt_ctype.c_tolower_FUN_005feb30(int character)
        ;   XREF to: 005feb30 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00605900
    CMP EAX,0x61                        ; 00605903
    JL 0x00605911                       ; 00605906 | LAB_00605911
        ;   XREF to: 00605911 (CONDITIONAL_JUMP)
    CMP EAX,0x66                        ; 00605908
    JG 0x00605911                       ; 0060590b | LAB_00605911
        ;   XREF to: 00605911 (CONDITIONAL_JUMP)
