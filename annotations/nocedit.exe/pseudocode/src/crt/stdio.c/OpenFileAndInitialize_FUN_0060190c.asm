...
;                               FUNCTION
; *****************************************************************************
; __cdecl FILE * crt_stdio.c_OpenFileAndInitialize_FUN_0060190c(char * filename, char mode_char, int parsed_mode_flags, int stage1_result, int additional_flags, FILE * file_struct)
;
; Parameters:
...
section .text
    ...
    PUSH EBP                            ; 00601962
    JMP 0x006019a1                      ; 00601963 | LAB_006019a1
    ...
    JZ 0x00601980                       ; 0060197a | LAB_00601980
        ;   XREF to: 00601980 (CONDITIONAL_JUMP)
    OR AL,0x10                          ; 0060197c
    JMP 0x00601982                      ; 0060197e | LAB_00601982
        ;   XREF to: 00601982 (UNCONDITIONAL_JUMP)
    OR AL,0x40                          ; 00601980
        ;   Label: LAB_00601980
    TEST byte ptr [ESP + 0x1c],0x40     ; 00601982
        ;   Label: LAB_00601982
    JZ 0x0060198e                       ; 00601987 | LAB_0060198e
        ;   XREF to: 0060198e (CONDITIONAL_JUMP)
    OR AH,0x2                           ; 00601989
    JMP 0x00601991                      ; 0060198c | LAB_00601991
    ...
    PUSH ESI                            ; 006019a0
    CALL crt_stdio.c_CreateFileVariadic_FUN_00609074 ; 006019a1 | int crt_stdio.c_CreateFileVariadic_FUN_00609074(char * filename, int access_mode, int share_mode)
        ;   Label: LAB_006019a1
    ...
    JNZ 0x006019c2                      ; 006019b0 | LAB_006019c2
        ;   XREF to: 006019c2 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 006019b2
    CALL crt_stdio.c_DeallocateFileStruct_FUN_006093b0 ; 006019b3 | void crt_stdio.c_DeallocateFileStruct_FUN_006093b0(FILE * file_struct)
    ...
    JZ 0x00601a0e                       ; 006019ff | LAB_00601a0e
        ;   XREF to: 00601a0e (CONDITIONAL_JUMP)
    PUSH 0x2                            ; 00601a01
    PUSH 0x0                            ; 00601a03
    PUSH EBX                            ; 00601a05
    CALL crt_stdio.c_fseek_FUN_005ffacc ; 00601a06 | int crt_stdio.c_fseek_FUN_005ffacc(FILE * file, long offset, int whence)
        ;   XREF to: 005ffacc (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00601a0b
    PUSH EBX                            ; 00601a0e
        ;   Label: LAB_00601a0e
    CALL crt_stdio.c_DetectDeviceAndSetBuffering_FUN_00608ee0 ; 00601a0f | void crt_stdio.c_DetectDeviceAndSetBuffering_FUN_00608ee0(FILE * file)
