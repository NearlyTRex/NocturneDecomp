...
;                               FUNCTION
; *****************************************************************************
; __cdecl char * crt_stdio.c_ParseFormatFlags_FUN_00602edc(char * format, FormatSpec * spec_info)
;
; Parameters:
...
section .text
    ...
    JNZ 0x00602ef8                      ; 00602f40 | LAB_00602ef8
        ;   XREF to: 00602ef8 (CONDITIONAL_JUMP)
    OR byte ptr [EAX + 0x1e],0x8        ; 00602f42
    JMP 0x00602f3a                      ; 00602f46 | LAB_00602f3a
        ;   XREF to: 00602f3a (UNCONDITIONAL_JUMP)
