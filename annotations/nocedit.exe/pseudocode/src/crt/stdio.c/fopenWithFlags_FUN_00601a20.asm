...
;                               FUNCTION
; *****************************************************************************
; __cdecl FILE * crt_stdio.c_fopenWithFlags_FUN_00601a20(char * filename, char * mode, int flags)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 00601a2d
    CALL crt_stdio.c_OpenModeStringParser_FUN_006017d0 ; 00601a2e | int crt_stdio.c_OpenModeStringParser_FUN_006017d0(char * mode_string, char * output_flags)
        ;   XREF to: 006017d0 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 00601a33
    ADD ESP,0x8                         ; 00601a35
    TEST EAX,EAX                        ; 00601a38
    JZ 0x00601a72                       ; 00601a3a | LAB_00601a72
        ;   XREF to: 00601a72 (CONDITIONAL_JUMP)
    PUSH 0x0                            ; 00601a3c
    CALL crt_stdio.c_AllocateFileStruct_FUN_006092f0 ; 00601a3e | FILE * crt_stdio.c_AllocateFileStruct_FUN_006092f0(int unused_param)
        ;   XREF to: 006092f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00601a43
    MOV EDX,EAX                         ; 00601a46
    TEST EAX,EAX                        ; 00601a48
    JZ 0x00601a70                       ; 00601a4a | LAB_00601a70
    ...
    PUSH EDI                            ; 00601a65
    CALL crt_stdio.c_OpenFileAndInitialize_FUN_0060190c ; 00601a66 | FILE * crt_stdio.c_OpenFileAndInitialize_FUN_0060190c(char * filename, char mode_char, int parsed_mode_flags, int stage1_result, ...)
