...
section .text
    ...
    PUSH EBP                            ; 0060518f
        ;   Label: LAB_0060518f
    CALL crt_stdio.c_scanf_getc_wrapper_FUN_00604930 ; 00605190 | int crt_stdio.c_scanf_getc_wrapper_FUN_00604930(scanf_state_t * state)
    ...
    TEST byte ptr [ECX + 0x6849c4],0x2  ; 006051a4 | char[256] g_CharacterClassificationTable
    JZ 0x006051b3                       ; 006051ab | LAB_006051b3
        ;   XREF to: 006051b3 (CONDITIONAL_JUMP)
    INC dword ptr [ESP + 0x5c]          ; 006051ad
    JMP 0x0060518f                      ; 006051b1 | LAB_0060518f
        ;   XREF to: 0060518f (UNCONDITIONAL_JUMP)
    TEST byte ptr [EBP + 0x10],0x2      ; 006051b3
        ;   Label: LAB_006051b3
    JNZ 0x006053ad                      ; 006051b7 | LAB_006053ad
    ...
    CALL crt_stdio.c_scanf_getc_with_width_FUN_00605918 ; 006051e5 | int crt_stdio.c_scanf_getc_with_width_FUN_00605918(scanf_state_t * state)
        ;   XREF to: 00605918 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 006051ea
    MOV EBX,EAX                         ; 006051ed
    CMP EAX,-0x1                        ; 006051ef
    JZ 0x006053ad                       ; 006051f2 | LAB_006053ad
        ;   XREF to: 006053ad (CONDITIONAL_JUMP)
    MOV AL,BL                           ; 006051f8
        ;   Label: LAB_006051f8
    INC AL                              ; 006051fa
    AND EAX,0xff                        ; 006051fc
    TEST byte ptr [EAX + 0x6849c4],0x20 ; 00605201 | char[256] g_CharacterClassificationTable
    JNZ 0x00605213                      ; 00605208 | LAB_00605213
        ;   XREF to: 00605213 (CONDITIONAL_JUMP)
    CMP EBX,0x2e                        ; 0060520a
    JNZ 0x006053a3                      ; 0060520d | LAB_006053a3
        ;   XREF to: 006053a3 (CONDITIONAL_JUMP)
    ...
    TEST byte ptr [EAX + 0x6849c4],0x20 ; 00605226 | char[256] g_CharacterClassificationTable
    JZ 0x00605275                       ; 0060522d | LAB_00605275
    ...
    JZ 0x00605250                       ; 0060523f | LAB_00605250
    ...
    PUSH EBP                            ; 00605250
        ;   Label: LAB_00605250
    INC EDI                             ; 00605251
    CALL crt_stdio.c_scanf_getc_with_width_FUN_00605918 ; 00605252 | int crt_stdio.c_scanf_getc_with_width_FUN_00605918(scanf_state_t * state)
        ;   XREF to: 00605918 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00605257
    MOV EBX,EAX                         ; 0060525a
    CMP EAX,-0x1                        ; 0060525c
    JZ 0x006053ad                       ; 0060525f | LAB_006053ad
        ;   XREF to: 006053ad (CONDITIONAL_JUMP)
    INC AL                              ; 00605265
    AND EAX,0xff                        ; 00605267
    TEST byte ptr [EAX + 0x6849c4],0x20 ; 0060526c | char[256] g_CharacterClassificationTable
    JNZ 0x00605237                      ; 00605273 | LAB_00605237
        ;   XREF to: 00605237 (CONDITIONAL_JUMP)
    CMP EBX,0x2e                        ; 00605275
        ;   Label: LAB_00605275
    JNZ 0x0060531f                      ; 00605278 | LAB_0060531f
        ;   XREF to: 0060531f (CONDITIONAL_JUMP)
    PUSH EBP                            ; 0060527e
    MOV byte ptr [ESI],BL               ; 0060527f
    INC ESI                             ; 00605281
    CALL crt_stdio.c_scanf_getc_with_width_FUN_00605918 ; 00605282 | int crt_stdio.c_scanf_getc_with_width_FUN_00605918(scanf_state_t * state)
        ;   XREF to: 00605918 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00605287
    MOV EBX,EAX                         ; 0060528a
    CMP EAX,-0x1                        ; 0060528c
    JZ 0x006053ad                       ; 0060528f | LAB_006053ad
        ;   XREF to: 006053ad (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x58],0x0      ; 00605295
    JNZ 0x006052b2                      ; 0060529a | LAB_006052b2
        ;   XREF to: 006052b2 (CONDITIONAL_JUMP)
    MOV AL,BL                           ; 0060529c
    INC AL                              ; 0060529e
    AND EAX,0xff                        ; 006052a0
    TEST byte ptr [EAX + 0x6849c4],0x20 ; 006052a5 | char[256] g_CharacterClassificationTable
    JZ 0x006053a3                       ; 006052ac | LAB_006053a3
        ;   XREF to: 006053a3 (CONDITIONAL_JUMP)
    INC EDI                             ; 006052b2
        ;   Label: LAB_006052b2
    MOV AL,BL                           ; 006052b3
    ...
    TEST byte ptr [EAX + 0x6849c4],0x20 ; 006052bc | char[256] g_CharacterClassificationTable
    JZ 0x006052d9                       ; 006052c3 | LAB_006052d9
        ;   XREF to: 006052d9 (CONDITIONAL_JUMP)
    PUSH EBP                            ; 006052c5
    INC EDI                             ; 006052c6
    MOV byte ptr [ESI],BL               ; 006052c7
    INC ESI                             ; 006052c9
    CALL crt_stdio.c_scanf_getc_with_width_FUN_00605918 ; 006052ca | int crt_stdio.c_scanf_getc_with_width_FUN_00605918(scanf_state_t * state)
        ;   XREF to: 00605918 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 006052cf
    MOV EBX,EAX                         ; 006052d2
    CMP EAX,-0x1                        ; 006052d4
    JNZ 0x006052b3                      ; 006052d7 | LAB_006052b3
        ;   XREF to: 006052b3 (CONDITIONAL_JUMP)
    TEST byte ptr [EBP + 0x10],0x10     ; 006052d9
        ;   Label: LAB_006052d9
    JZ 0x00605316                       ; 006052dd | LAB_00605316
    ...
    JZ 0x0060530d                       ; 006052ed | LAB_0060530d
    ...
    JMP 0x006052e7                      ; 0060530b | LAB_006052e7
    ...
    CMP EBX,-0x1                        ; 00605316
        ;   Label: LAB_00605316
    JZ 0x006053ad                       ; 00605319 | LAB_006053ad
        ;   XREF to: 006053ad (CONDITIONAL_JUMP)
    TEST byte ptr [EBP + 0x10],0x10     ; 0060531f
        ;   Label: LAB_0060531f
    JNZ 0x006053a3                      ; 00605323 | LAB_006053a3
        ;   XREF to: 006053a3 (CONDITIONAL_JUMP)
    CMP EBX,0x65                        ; 00605329
    JZ 0x00605337                       ; 0060532c | LAB_00605337
        ;   XREF to: 00605337 (CONDITIONAL_JUMP)
    CMP EBX,0x45                        ; 0060532e
    JNZ 0x006053a3                      ; 00605331 | LAB_006053a3
        ;   XREF to: 006053a3 (CONDITIONAL_JUMP)
    PUSH EBP                            ; 00605337
        ;   Label: LAB_00605337
    INC EDI                             ; 00605338
    ...
    INC ESI                             ; 0060533b
    CALL crt_stdio.c_scanf_getc_with_width_FUN_00605918 ; 0060533c | int crt_stdio.c_scanf_getc_with_width_FUN_00605918(scanf_state_t * state)
        ;   XREF to: 00605918 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00605341
    MOV EBX,EAX                         ; 00605344
    CMP EAX,-0x1                        ; 00605346
    JZ 0x006053ad                       ; 00605349 | LAB_006053ad
        ;   XREF to: 006053ad (CONDITIONAL_JUMP)
    CMP EAX,0x2b                        ; 0060534b
    JZ 0x00605355                       ; 0060534e | LAB_00605355
        ;   XREF to: 00605355 (CONDITIONAL_JUMP)
    CMP EAX,0x2d                        ; 00605350
    JNZ 0x00605369                      ; 00605353 | LAB_00605369
    ...
    INC ESI                             ; 00605359
    CALL crt_stdio.c_scanf_getc_with_width_FUN_00605918 ; 0060535a | int crt_stdio.c_scanf_getc_with_width_FUN_00605918(scanf_state_t * state)
        ;   XREF to: 00605918 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060535f
    MOV EBX,EAX                         ; 00605362
    CMP EAX,-0x1                        ; 00605364
    JZ 0x006053ad                       ; 00605367 | LAB_006053ad
        ;   XREF to: 006053ad (CONDITIONAL_JUMP)
    MOV AL,BL                           ; 00605369
        ;   Label: LAB_00605369
    INC AL                              ; 0060536b
    AND EAX,0xff                        ; 0060536d
    TEST byte ptr [EAX + 0x6849c4],0x20 ; 00605372 | char[256] g_CharacterClassificationTable
    JNZ 0x0060537f                      ; 00605379 | LAB_0060537f
        ;   XREF to: 0060537f (CONDITIONAL_JUMP)
    XOR EDI,EDI                         ; 0060537b
    JMP 0x006053a3                      ; 0060537d | LAB_006053a3
    ...
    INC ESI                             ; 00605383
    CALL crt_stdio.c_scanf_getc_with_width_FUN_00605918 ; 00605384 | int crt_stdio.c_scanf_getc_with_width_FUN_00605918(scanf_state_t * state)
        ;   XREF to: 00605918 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00605389
    MOV EBX,EAX                         ; 0060538c
    CMP EAX,-0x1                        ; 0060538e
    JZ 0x006053ad                       ; 00605391 | LAB_006053ad
        ;   XREF to: 006053ad (CONDITIONAL_JUMP)
    INC AL                              ; 00605393
    AND EAX,0xff                        ; 00605395
    TEST byte ptr [EAX + 0x6849c4],0x20 ; 0060539a | char[256] g_CharacterClassificationTable
    JNZ 0x0060537f                      ; 006053a1 | LAB_0060537f
        ;   XREF to: 0060537f (CONDITIONAL_JUMP)
    PUSH EBP                            ; 006053a3
        ;   Label: LAB_006053a3
    PUSH EBX                            ; 006053a4
    CALL crt_stdio.c_scanf_ungetc_wrapper_FUN_0060493c ; 006053a5 | int crt_stdio.c_scanf_ungetc_wrapper_FUN_0060493c(int character, scanf_state_t * state)
        ;   XREF to: 0060493c (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 006053aa
    TEST EDI,EDI                        ; 006053ad
        ;   Label: LAB_006053ad
    JLE 0x00605470                      ; 006053af | LAB_00605470
        ;   XREF to: 00605470 (CONDITIONAL_JUMP)
    ADD EDI,dword ptr [ESP + 0x5c]      ; 006053b5
    TEST byte ptr [EBP + 0x10],0x1      ; 006053b9
    JZ 0x00605470                       ; 006053bd | LAB_00605470
        ;   XREF to: 00605470 (CONDITIONAL_JUMP)
    MOV byte ptr [ESI],0x0              ; 006053c3
    TEST byte ptr [EBP + 0x10],0x10     ; 006053c6
    JZ 0x006053d8                       ; 006053ca | LAB_006053d8
        ;   XREF to: 006053d8 (CONDITIONAL_JUMP)
    CMP byte ptr [ESP],0x2d             ; 006053cc
    JNZ 0x006053eb                      ; 006053d0 | LAB_006053eb
        ;   XREF to: 006053eb (CONDITIONAL_JUMP)
    NEG dword ptr [ESP + 0x64]          ; 006053d2
    JMP 0x006053eb                      ; 006053d6 | LAB_006053eb
    ...
    PUSH EAX                            ; 006053e1
    CALL dword ptr [0x00685410]         ; 006053e2 | STRTOD_FUNC * PTR_crt_stdio.c_ReportFloatingPointNotLoaded_FUN_0060ad30_00685410
    ADD ESP,0x8                         ; 006053e8
    MOV CH,byte ptr [EBP + 0x10]        ; 006053eb
        ;   Label: LAB_006053eb
    TEST CH,0x4                         ; 006053ee
    JZ 0x00605406                       ; 006053f1 | LAB_00605406
    ...
    JMP 0x00605437                      ; 00605404 | LAB_00605437
        ;   XREF to: 00605437 (UNCONDITIONAL_JUMP)
    TEST CH,0x8                         ; 00605406
        ;   Label: LAB_00605406
    JZ 0x00605422                       ; 00605409 | LAB_00605422
    ...
    JMP 0x00605437                      ; 00605420 | LAB_00605437
        ;   XREF to: 00605437 (UNCONDITIONAL_JUMP)
    ...
    JMP 0x00605470                      ; 0060545e | LAB_00605470
