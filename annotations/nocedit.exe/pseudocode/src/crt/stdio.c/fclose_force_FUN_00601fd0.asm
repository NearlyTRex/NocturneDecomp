...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl crt_stdio_c_fclose_force_FUN_00601fd0(FILE *file_handle,int force_close_flag)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 0060207d
    CALL crt_io.c_generateTempFilename_FUN_00601f1c ; 0060207e
        ;   XREF to: 00601f1c (UNCONDITIONAL_CALL)  ; void crt_io.c_generateTempFilename_FUN_00601f1c(char * buffer, int file_handle)
    ADD ESP,0x8                         ; 00602083
    MOV EAX,ESP                         ; 00602086
    PUSH EAX                            ; 00602088
    CALL crt_io.c_deleteFile_FUN_005ff9d0 ; 00602089
