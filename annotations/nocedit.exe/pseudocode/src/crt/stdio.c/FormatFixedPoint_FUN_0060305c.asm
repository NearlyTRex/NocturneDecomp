...
section .text
    ...
    JGE 0x00603081                      ; 00603074 | LAB_00603081
    ...
    CMP dword ptr [ESI + 0x8],-0x1      ; 00603081
        ;   Label: LAB_00603081
    JNZ 0x0060308e                      ; 00603085 | LAB_0060308e
    ...
    PUSH EAX                            ; 00603098
    CALL crt_stdio.c_IntegerToString_FUN_00607d18 ; 00603099 | char * crt_stdio.c_IntegerToString_FUN_00607d18(int value, char * buffer, int base)
        ;   XREF to: 00607d18 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0060309e
    MOV AH,byte ptr [EBX]               ; 006030a1
    MOV ECX,EBX                         ; 006030a3
    TEST AH,AH                          ; 006030a5
    JZ 0x006030b1                       ; 006030a7 | LAB_006030b1
        ;   XREF to: 006030b1 (CONDITIONAL_JUMP)
    MOV DL,byte ptr [EBX + 0x1]         ; 006030a9
        ;   Label: LAB_006030a9
    INC EBX                             ; 006030ac
    TEST DL,DL                          ; 006030ad
    JNZ 0x006030a9                      ; 006030af | LAB_006030a9
        ;   XREF to: 006030a9 (CONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0x8],0x0       ; 006030b1
        ;   Label: LAB_006030b1
    JZ 0x006030e9                       ; 006030b5 | LAB_006030e9
    ...
    JLE 0x006030e6                      ; 006030c2 | LAB_006030e6
    ...
    MOV byte ptr [EBX],0x30             ; 00603152
        ;   Label: LAB_00603152
    JMP 0x006030f4                      ; 00603155 | LAB_006030f4
