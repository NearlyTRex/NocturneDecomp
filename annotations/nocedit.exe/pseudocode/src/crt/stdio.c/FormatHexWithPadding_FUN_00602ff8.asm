...
;                               FUNCTION
; *****************************************************************************
; __cdecl void crt_stdio.c_FormatHexWithPadding_FUN_00602ff8(int value, char * buffer, int width)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 00603007
    CALL crt_stdio.c_IntegerToString_FUN_00607d18 ; 00603008 | char * crt_stdio.c_IntegerToString_FUN_00607d18(int value, char * buffer, int base)
    ...
    JZ 0x00603040                       ; 00603029 | LAB_00603040
