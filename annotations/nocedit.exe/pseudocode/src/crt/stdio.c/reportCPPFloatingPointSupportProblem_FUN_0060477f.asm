...
section .text
    ...
    PUSH 0x658ffc                       ; 00604781 | = "C++ floating-point support not loaded..." | s_C_floating_point_support_00658ffc = C++ floating-point support not loaded

    CALL crt_startup.c_HandleRuntimeError_FUN_00606660 ; 00604786 | void crt_startup.c_HandleRuntimeError_FUN_00606660(char * error_message, int error_level)
