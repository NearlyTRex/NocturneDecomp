...
;                               FUNCTION
; *****************************************************************************
; __cdecl char * crt_stdio.c_IntegerToString_FUN_00607d18(int value, char * buffer, int base)
;
; Parameters:
...
section .text
    ...
    JNZ 0x00607d38                      ; 00607d2a | LAB_00607d38
        ;   XREF to: 00607d38 (CONDITIONAL_JUMP)
    TEST EAX,EAX                        ; 00607d2c
    JGE 0x00607d38                      ; 00607d2e | LAB_00607d38
        ;   XREF to: 00607d38 (CONDITIONAL_JUMP)
    NEG EAX                             ; 00607d30
    ...
    PUSH EDX                            ; 00607d39
    PUSH EAX                            ; 00607d3a
    CALL crt_stdlib.c_itoa_FUN_00607cc0 ; 00607d3b | char * crt_stdlib.c_itoa_FUN_00607cc0(int value, char * buffer, int base)
