...
section .text
    ...
    PUSH ESI                            ; 006092f1
    PUSH EDI                            ; 006092f2
    CALL dword ptr [0x00684ef8]         ; 006092f3 | ENTER_THREAD_CRITICAL_SECTION_FUNC * PTR_crt_sync.c_EnterCriticalSection_FUN_00602434_00684ef8
    MOV ESI,dword ptr [0x03f9b204]      ; 006092f9 | undefined4 g_FreeListHeadPointer
    TEST ESI,ESI                        ; 006092ff
    JZ 0x0060931c                       ; 00609301 | LAB_0060931c
    ...
    MOV [0x03f9b204],EAX                ; 00609311 | undefined4 g_FreeListHeadPointer
    OR DI,0x3                           ; 00609316
    JMP 0x00609369                      ; 0060931a | LAB_00609369
        ;   XREF to: 00609369 (UNCONDITIONAL_JUMP)
    MOV EBX,0x684cc4                    ; 0060931c | FILE * g_StaticFilePoolStart
        ;   Label: LAB_0060931c
    CMP EBX,0x684ecc                    ; 00609321 | g_StaticFilePoolEnd
    JNC 0x00609351                      ; 00609327 | LAB_00609351
        ;   XREF to: 00609351 (CONDITIONAL_JUMP)
    TEST byte ptr [EBX + 0xc],0x3       ; 00609329 | undefined4 DAT_00684cd0 | DAT_00684cea = 0x2
        ;   Label: LAB_00609329
    JNZ 0x00609346                      ; 0060932d | LAB_00609346
        ;   XREF to: 00609346 (CONDITIONAL_JUMP)
    PUSH 0x1d                           ; 0060932f
    CALL crt_memory.c_malloc_FUN_00601bb0 ; 00609331 | void * crt_memory.c_malloc_FUN_00601bb0(ulong size)
        ;   XREF to: 00601bb0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00609336
    MOV ESI,EAX                         ; 00609339
    TEST EAX,EAX                        ; 0060933b
    JZ 0x00609398                       ; 0060933d | LAB_00609398
        ;   XREF to: 00609398 (CONDITIONAL_JUMP)
    MOV EDI,0x3                         ; 0060933f
    JMP 0x00609369                      ; 00609344 | LAB_00609369
        ;   XREF to: 00609369 (UNCONDITIONAL_JUMP)
    ADD EBX,0x1a                        ; 00609346 | DAT_00684cde
        ;   Label: LAB_00609346
    CMP EBX,0x684ecc                    ; 00609349 | g_StaticFilePoolEnd
    JC 0x00609329                       ; 0060934f | LAB_00609329
        ;   XREF to: 00609329 (CONDITIONAL_JUMP)
    PUSH 0x37                           ; 00609351
        ;   Label: LAB_00609351
    MOV EDI,0x4003                      ; 00609353
    CALL crt_memory.c_malloc_FUN_00601bb0 ; 00609358 | void * crt_memory.c_malloc_FUN_00601bb0(ulong size)
        ;   XREF to: 00601bb0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060935d
    MOV ESI,EAX                         ; 00609360
    TEST EAX,EAX                        ; 00609362
    JZ 0x00609398                       ; 00609364 | LAB_00609398
        ;   XREF to: 00609398 (CONDITIONAL_JUMP)
    LEA EBX,[EAX + 0x1d]                ; 00609366
    PUSH 0x1a                           ; 00609369
        ;   Label: LAB_00609369
    PUSH 0x0                            ; 0060936b
    PUSH EBX                            ; 0060936d | FILE * g_StaticFilePoolStart
    CALL crt_memory.c_memset_FUN_005fde40 ; 0060936e | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
        ;   XREF to: 005fde40 (UNCONDITIONAL_CALL)
    MOV dword ptr [EBX + 0xc],EDI       ; 00609373
    MOV EAX,[0x03f9b200]                ; 00609376 | FileListNode * g_AllocatedListHead
    MOV dword ptr [ESI + 0x4],EBX       ; 0060937b
    ADD ESP,0xc                         ; 0060937e
    MOV dword ptr [EBX + 0x8],ESI       ; 00609381
    MOV dword ptr [0x03f9b200],ESI      ; 00609384 | FileListNode * g_AllocatedListHead
    MOV dword ptr [ESI],EAX             ; 0060938a
    CALL dword ptr [0x00684efc]         ; 0060938c | EXIT_THREAD_CRITICAL_SECTION_FUNC * PTR_crt_sync.c_ExitCriticalSection_FUN_00602434_00684efc
    ...
    PUSH 0x5                            ; 00609398
        ;   Label: LAB_00609398
    CALL crt_errno.c_setErrno_FUN_00602790 ; 0060939a | void crt_errno.c_setErrno_FUN_00602790(int error_code)
        ;   XREF to: 00602790 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060939f
    CALL dword ptr [0x00684efc]         ; 006093a2 | EXIT_THREAD_CRITICAL_SECTION_FUNC * PTR_crt_sync.c_ExitCriticalSection_FUN_00602434_00684efc
