...
;
; XREF[2]:
;   crt_stdio.c_fputc_FUN_005ff2d7 at 005ff35e
...
section .text
    ...
    JNZ 0x00606088                      ; 00606065 | LAB_00606088
    ...
    JNZ 0x00606093                      ; 00606073 | LAB_00606093
    ...
    PUSH EAX                            ; 00606088
        ;   Label: LAB_00606088
    CALL crt_stdio.c_stream_flush_FUN_006060bb ; 00606089 | FILE * crt_stdio.c_stream_flush_FUN_006060bb(FILE * stream)
        ;   XREF to: 006060bb (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060608e
    JMP 0x00606067                      ; 00606091 | LAB_00606067
        ;   XREF to: 00606067 (UNCONDITIONAL_JUMP)
    PUSH 0x1                            ; 00606093
        ;   Label: LAB_00606093
    CALL crt_stdio.c_get_standard_file_handle_FUN_0060b7a0 ; 00606095 | FILE * crt_stdio.c_get_standard_file_handle_FUN_0060b7a0(int fd)
        ;   XREF to: 0060b7a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060609a
    PUSH EAX                            ; 0060609d
    CALL crt_stdio.c_fflushInternal_FUN_006039d0 ; 0060609e | int crt_stdio.c_fflushInternal_FUN_006039d0(FILE * file_handle)
        ;   XREF to: 006039d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 006060a3
    PUSH 0x2                            ; 006060a6
    CALL crt_stdio.c_get_standard_file_handle_FUN_0060b7a0 ; 006060a8 | FILE * crt_stdio.c_get_standard_file_handle_FUN_0060b7a0(int fd)
        ;   XREF to: 0060b7a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 006060ad
    PUSH EAX                            ; 006060b0
    CALL crt_stdio.c_fflushInternal_FUN_006039d0 ; 006060b1 | int crt_stdio.c_fflushInternal_FUN_006039d0(FILE * file_handle)
        ;   XREF to: 006039d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 006060b6
    JMP 0x00606075                      ; 006060b9 | LAB_00606075
