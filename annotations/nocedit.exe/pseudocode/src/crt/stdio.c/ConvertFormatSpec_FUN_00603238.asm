...
section .text
    ...
    JC 0x006032a1                       ; 00603281 | LAB_006032a1
        ;   XREF to: 006032a1 (CONDITIONAL_JUMP)
    JBE 0x0060330e                      ; 00603283 | LAB_0060330e
        ;   XREF to: 0060330e (CONDITIONAL_JUMP)
    CMP AL,0x75                         ; 00603289
    JC 0x00603298                       ; 0060328b | LAB_00603298
        ;   XREF to: 00603298 (CONDITIONAL_JUMP)
    JBE 0x006032b4                      ; 0060328d | LAB_006032b4
        ;   XREF to: 006032b4 (CONDITIONAL_JUMP)
    CMP AL,0x78                         ; 0060328f
    JZ 0x006032b4                       ; 00603291 | LAB_006032b4
        ;   XREF to: 006032b4 (CONDITIONAL_JUMP)
    JMP 0x006033d5                      ; 00603293 | LAB_006033d5
        ;   XREF to: 006033d5 (UNCONDITIONAL_JUMP)
    CMP AL,0x6f                         ; 00603298
        ;   Label: LAB_00603298
    JZ 0x006032b4                       ; 0060329a | LAB_006032b4
        ;   XREF to: 006032b4 (CONDITIONAL_JUMP)
    JMP 0x006033d5                      ; 0060329c | LAB_006033d5
        ;   XREF to: 006033d5 (UNCONDITIONAL_JUMP)
    CMP AL,0x58                         ; 006032a1
        ;   Label: LAB_006032a1
    JC 0x006033d5                       ; 006032a3 | LAB_006033d5
        ;   XREF to: 006033d5 (CONDITIONAL_JUMP)
    JBE 0x006032b4                      ; 006032a9 | LAB_006032b4
        ;   XREF to: 006032b4 (CONDITIONAL_JUMP)
    CMP AL,0x64                         ; 006032ab
    JZ 0x0060330e                       ; 006032ad | LAB_0060330e
        ;   XREF to: 0060330e (CONDITIONAL_JUMP)
    JMP 0x006033d5                      ; 006032af | LAB_006033d5
        ;   XREF to: 006033d5 (UNCONDITIONAL_JUMP)
    TEST byte ptr [EBX + 0x1f],0x1      ; 006032b4
        ;   Label: LAB_006032b4
    JZ 0x006032da                       ; 006032b8 | LAB_006032da
    ...
    JMP 0x006033d5                      ; 006032d5 | LAB_006033d5
        ;   XREF to: 006033d5 (UNCONDITIONAL_JUMP)
    TEST byte ptr [EBX + 0x1e],0x20     ; 006032da
        ;   Label: LAB_006032da
    JZ 0x006032ef                       ; 006032de | LAB_006032ef
    ...
    JMP 0x006033d5                      ; 006032ea | LAB_006033d5
        ;   XREF to: 006033d5 (UNCONDITIONAL_JUMP)
    ...
    JZ 0x006033d5                       ; 006032fd | LAB_006033d5
        ;   XREF to: 006033d5 (CONDITIONAL_JUMP)
    AND ECX,0xffff                      ; 00603303
    JMP 0x006033d5                      ; 00603309 | LAB_006033d5
        ;   XREF to: 006033d5 (UNCONDITIONAL_JUMP)
    TEST byte ptr [EBX + 0x1f],0x1      ; 0060330e
        ;   Label: LAB_0060330e
    JZ 0x00603331                       ; 00603312 | LAB_00603331
    ...
    JMP 0x00603357                      ; 0060332f | LAB_00603357
        ;   XREF to: 00603357 (UNCONDITIONAL_JUMP)
    TEST byte ptr [EBX + 0x1e],0x20     ; 00603331
        ;   Label: LAB_00603331
    JZ 0x00603343                       ; 00603335 | LAB_00603343
    ...
    JMP 0x00603357                      ; 00603341 | LAB_00603357
        ;   XREF to: 00603357 (UNCONDITIONAL_JUMP)
    ...
    JZ 0x006033a8                       ; 00603381 | LAB_006033a8
    ...
    JMP 0x006033d5                      ; 006033c1 | LAB_006033d5
        ;   XREF to: 006033d5 (UNCONDITIONAL_JUMP)
    TEST AH,0x2                         ; 006033c3
        ;   Label: LAB_006033c3
    JZ 0x006033d5                       ; 006033c6 | LAB_006033d5
        ;   XREF to: 006033d5 (CONDITIONAL_JUMP)
    ...
    JC 0x00603442                       ; 006033df | LAB_00603442
        ;   XREF to: 00603442 (CONDITIONAL_JUMP)
    JBE 0x00603627                      ; 006033e1 | LAB_00603627
        ;   XREF to: 00603627 (CONDITIONAL_JUMP)
    CMP AL,0x6f                         ; 006033e7
    JC 0x00603423                       ; 006033e9 | LAB_00603423
        ;   XREF to: 00603423 (CONDITIONAL_JUMP)
    JBE 0x00603607                      ; 006033eb | LAB_00603607
        ;   XREF to: 00603607 (CONDITIONAL_JUMP)
    CMP AL,0x73                         ; 006033f1
    JC 0x00603416                       ; 006033f3 | LAB_00603416
        ;   XREF to: 00603416 (CONDITIONAL_JUMP)
    JBE 0x006034f3                      ; 006033f5 | LAB_006034f3
        ;   XREF to: 006034f3 (CONDITIONAL_JUMP)
    CMP AL,0x75                         ; 006033fb
    JC 0x0060387a                       ; 006033fd | LAB_0060387a
        ;   XREF to: 0060387a (CONDITIONAL_JUMP)
    JBE 0x00603627                      ; 00603403 | LAB_00603627
        ;   XREF to: 00603627 (CONDITIONAL_JUMP)
    CMP AL,0x78                         ; 00603409
    JZ 0x006035c5                       ; 0060340b | LAB_006035c5
        ;   XREF to: 006035c5 (CONDITIONAL_JUMP)
    JMP 0x0060387a                      ; 00603411 | LAB_0060387a
        ;   XREF to: 0060387a (UNCONDITIONAL_JUMP)
    CMP AL,0x70                         ; 00603416
        ;   Label: LAB_00603416
    JZ 0x00603702                       ; 00603418 | LAB_00603702
        ;   XREF to: 00603702 (CONDITIONAL_JUMP)
    JMP 0x0060387a                      ; 0060341e | LAB_0060387a
        ;   XREF to: 0060387a (UNCONDITIONAL_JUMP)
    CMP AL,0x66                         ; 00603423
        ;   Label: LAB_00603423
    JC 0x006034c9                       ; 00603425 | LAB_006034c9
        ;   XREF to: 006034c9 (CONDITIONAL_JUMP)
    JBE 0x00603493                      ; 0060342b | LAB_00603493
        ;   XREF to: 00603493 (CONDITIONAL_JUMP)
    CMP AL,0x67                         ; 0060342d
    JBE 0x006034c9                      ; 0060342f | LAB_006034c9
        ;   XREF to: 006034c9 (CONDITIONAL_JUMP)
    CMP AL,0x69                         ; 00603435
    JZ 0x00603627                       ; 00603437 | LAB_00603627
        ;   XREF to: 00603627 (CONDITIONAL_JUMP)
    JMP 0x0060387a                      ; 0060343d | LAB_0060387a
        ;   XREF to: 0060387a (UNCONDITIONAL_JUMP)
    CMP AL,0x47                         ; 00603442
        ;   Label: LAB_00603442
    JC 0x0060347e                       ; 00603444 | LAB_0060347e
        ;   XREF to: 0060347e (CONDITIONAL_JUMP)
    JBE 0x006034c9                      ; 00603446 | LAB_006034c9
        ;   XREF to: 006034c9 (CONDITIONAL_JUMP)
    CMP AL,0x53                         ; 0060344c
    JC 0x00603471                       ; 0060344e | LAB_00603471
        ;   XREF to: 00603471 (CONDITIONAL_JUMP)
    JBE 0x006034f3                      ; 00603450 | LAB_006034f3
        ;   XREF to: 006034f3 (CONDITIONAL_JUMP)
    CMP AL,0x58                         ; 00603456
    JC 0x0060387a                       ; 00603458 | LAB_0060387a
        ;   XREF to: 0060387a (CONDITIONAL_JUMP)
    JBE 0x006035c5                      ; 0060345e | LAB_006035c5
        ;   XREF to: 006035c5 (CONDITIONAL_JUMP)
    CMP AL,0x63                         ; 00603464
    JZ 0x0060379a                       ; 00603466 | LAB_0060379a
        ;   XREF to: 0060379a (CONDITIONAL_JUMP)
    JMP 0x0060387a                      ; 0060346c | LAB_0060387a
        ;   XREF to: 0060387a (UNCONDITIONAL_JUMP)
    CMP AL,0x50                         ; 00603471
        ;   Label: LAB_00603471
    JZ 0x00603702                       ; 00603473 | LAB_00603702
        ;   XREF to: 00603702 (CONDITIONAL_JUMP)
    JMP 0x0060387a                      ; 00603479 | LAB_0060387a
        ;   XREF to: 0060387a (UNCONDITIONAL_JUMP)
    CMP AL,0x45                         ; 0060347e
        ;   Label: LAB_0060347e
    JC 0x00603486                       ; 00603480 | LAB_00603486
        ;   XREF to: 00603486 (CONDITIONAL_JUMP)
    JBE 0x006034c9                      ; 00603482 | LAB_006034c9
        ;   XREF to: 006034c9 (CONDITIONAL_JUMP)
    JMP 0x00603493                      ; 00603484 | LAB_00603493
        ;   XREF to: 00603493 (UNCONDITIONAL_JUMP)
    CMP AL,0x43                         ; 00603486
        ;   Label: LAB_00603486
    JZ 0x00603831                       ; 00603488 | LAB_00603831
        ;   XREF to: 00603831 (CONDITIONAL_JUMP)
    JMP 0x0060387a                      ; 0060348e | LAB_0060387a
        ;   XREF to: 0060387a (UNCONDITIONAL_JUMP)
    TEST byte ptr [EBX + 0x1e],0x10     ; 00603493
        ;   Label: LAB_00603493
    JZ 0x006034c9                       ; 00603497 | LAB_006034c9
        ;   XREF to: 006034c9 (CONDITIONAL_JUMP)
    ...
    PUSH ECX                            ; 006034a4
    PUSH ESI                            ; 006034a5
    CALL crt_stdio.c_FormatFixedPoint_FUN_0060305c ; 006034a6 | void crt_stdio.c_FormatFixedPoint_FUN_0060305c(char * buffer, int fixed_point_value, FormatSpec * spec_info)
    ...
    PUSH EAX                            ; 006034b7
    PUSH ESI                            ; 006034b8
    CALL crt_string.c_strlen_far_FUN_00602f4c ; 006034b9 | int crt_string.c_strlen_far_FUN_00602f4c(char * string_offset, ushort segment, int max_length)
        ;   XREF to: 00602f4c (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 006034be
    MOV dword ptr [EBX + 0x28],EAX      ; 006034c1
    JMP 0x0060388d                      ; 006034c4 | LAB_0060388d
        ;   XREF to: 0060388d (UNCONDITIONAL_JUMP)
    PUSH EBX                            ; 006034c9
        ;   Label: LAB_006034c9
    PUSH EDX                            ; 006034ca
    PUSH ESI                            ; 006034cb
    CALL crt_stdio.c_FloatingPointStub_FUN_00603160 ; 006034cc | void crt_stdio.c_FloatingPointStub_FUN_00603160(char * buffer, va_list_t * args, FormatSpec * spec_info)
        ;   XREF to: 00603160 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 006034d1
    PUSH EBX                            ; 006034d4
    CALL crt_stdio.c_CalculateZeroPadding_FUN_0060317c ; 006034d5 | void crt_stdio.c_CalculateZeroPadding_FUN_0060317c(FormatSpec * spec_info)
    ...
    JZ 0x0060351d                       ; 006034fc | LAB_0060351d
    ...
    JZ 0x00603546                       ; 0060352e | LAB_00603546
        ;   XREF to: 00603546 (CONDITIONAL_JUMP)
    JMP 0x00603540                      ; 00603530 | LAB_00603540
    ...
    JZ 0x00603546                       ; 0060353e | LAB_00603546
        ;   XREF to: 00603546 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 00603565
    PUSH EDI                            ; 00603566
    CALL crt_stdio.c_WideStringToMultiByteLen_FUN_00602f7c ; 00603567 | int crt_stdio.c_WideStringToMultiByteLen_FUN_00602f7c(wchar_t * wide_string_offset, ushort segment, int max_chars)
        ;   XREF to: 00602f7c (UNCONDITIONAL_CALL)
    JMP 0x0060359a                      ; 0060356c | LAB_0060359a
        ;   XREF to: 0060359a (UNCONDITIONAL_JUMP)
    TEST byte ptr [EBX + 0x1e],0x20     ; 0060356e
        ;   Label: LAB_0060356e
    JZ 0x00603588                       ; 00603572 | LAB_00603588
    ...
    PUSH EAX                            ; 0060357f
    PUSH EDI                            ; 00603580
    CALL crt_stdio.c_WideStringToMultiByteLen_FUN_00602f7c ; 00603581 | int crt_stdio.c_WideStringToMultiByteLen_FUN_00602f7c(wchar_t * wide_string_offset, ushort segment, int max_chars)
        ;   XREF to: 00602f7c (UNCONDITIONAL_CALL)
    JMP 0x0060359a                      ; 00603586 | LAB_0060359a
        ;   XREF to: 0060359a (UNCONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 00603593
    PUSH EDI                            ; 00603594
    CALL crt_string.c_strlen_far_FUN_00602f4c ; 00603595 | int crt_string.c_strlen_far_FUN_00602f4c(char * string_offset, ushort segment, int max_length)
        ;   XREF to: 00602f4c (UNCONDITIONAL_CALL)
    ...
    JL 0x0060388d                       ; 006035a5 | LAB_0060388d
        ;   XREF to: 0060388d (CONDITIONAL_JUMP)
    CMP EAX,ESI                         ; 006035ab
    JLE 0x0060388d                      ; 006035ad | LAB_0060388d
        ;   XREF to: 0060388d (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 0060369f
    PUSH ECX                            ; 006036a0
    CALL crt_stdlib.c_utoa_FUN_0060ae50 ; 006036a1 | char * crt_stdlib.c_utoa_FUN_0060ae50(uint value, char * buffer, int base)
        ;   XREF to: 0060ae50 (UNCONDITIONAL_CALL)
    MOV DH,byte ptr [EBX + 0x15]        ; 006036a6
    ADD ESP,0xc                         ; 006036a9
    CMP DH,0x58                         ; 006036ac
    JNZ 0x006036ba                      ; 006036af | LAB_006036ba
        ;   XREF to: 006036ba (CONDITIONAL_JUMP)
    PUSH ESI                            ; 006036b1
    CALL crt_string.c_strupr_FUN_0060389c ; 006036b2 | char * crt_string.c_strupr_FUN_0060389c(char * string)
        ;   XREF to: 0060389c (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 006036c3
    PUSH EDI                            ; 006036c4
    CALL crt_string.c_strlen_far_FUN_00602f4c ; 006036c5 | int crt_string.c_strlen_far_FUN_00602f4c(char * string_offset, ushort segment, int max_length)
        ;   XREF to: 00602f4c (UNCONDITIONAL_CALL)
    ...
    JGE 0x006036e0                      ; 006036d7 | LAB_006036e0
    ...
    CMP dword ptr [EBX + 0x8],-0x1      ; 006036e0
        ;   Label: LAB_006036e0
    JNZ 0x0060388d                      ; 006036e4 | LAB_0060388d
        ;   XREF to: 0060388d (CONDITIONAL_JUMP)
    PUSH EBX                            ; 006036ea
    CALL crt_stdio.c_CalculateZeroPadding_FUN_0060317c ; 006036eb | void crt_stdio.c_CalculateZeroPadding_FUN_0060317c(FormatSpec * spec_info)
        ;   XREF to: 0060317c (UNCONDITIONAL_CALL)
    ...
    JZ 0x0060375a                       ; 00603732 | LAB_0060375a
    ...
    PUSH EAX                            ; 00603744
    CALL crt_stdio.c_FormatHexWithPadding_FUN_00602ff8 ; 00603745 | void crt_stdio.c_FormatHexWithPadding_FUN_00602ff8(int value, char * buffer, int width)
    ...
    JMP 0x0060375e                      ; 00603758 | LAB_0060375e
        ;   XREF to: 0060375e (UNCONDITIONAL_JUMP)
    PUSH 0x8                            ; 0060375a
        ;   Label: LAB_0060375a
    PUSH ESI                            ; 0060375c
    PUSH EBP                            ; 0060375d
    CALL crt_stdio.c_FormatHexWithPadding_FUN_00602ff8 ; 0060375e | void crt_stdio.c_FormatHexWithPadding_FUN_00602ff8(int value, char * buffer, int width)
        ;   Label: LAB_0060375e
        ;   XREF to: 00602ff8 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00603763
    CMP byte ptr [EBX + 0x15],0x50      ; 00603766
    JNZ 0x00603775                      ; 0060376a | LAB_00603775
        ;   XREF to: 00603775 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 0060376c
    CALL crt_string.c_strupr_FUN_0060389c ; 0060376d | char * crt_string.c_strupr_FUN_0060389c(char * string)
        ;   XREF to: 0060389c (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0060377e
    PUSH EDI                            ; 0060377f
    CALL crt_string.c_strlen_far_FUN_00602f4c ; 00603780 | int crt_string.c_strlen_far_FUN_00602f4c(char * string_offset, ushort segment, int max_length)
        ;   XREF to: 00602f4c (UNCONDITIONAL_CALL)
    ...
    JZ 0x00603816                       ; 006037a7 | LAB_00603816
    ...
    PUSH EAX                            ; 006037be
    CALL crt_stdio.c_WideCharToSingleByte_FUN_0060acf0 ; 006037bf | int crt_stdio.c_WideCharToSingleByte_FUN_0060acf0(wchar_t wide_char, char * output_buffer)
        ;   XREF to: 0060acf0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 006037c4
    CMP EAX,-0x1                        ; 006037c7
    JZ 0x0060388d                       ; 006037ca | LAB_0060388d
        ;   XREF to: 0060388d (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESP + 0x8]         ; 006037d0
    MOV EBP,dword ptr [0x03f9c020]      ; 006037d4 | int g_MultibyteLocaleActive
    MOV byte ptr [ESI],AL               ; 006037da
    TEST EBP,EBP                        ; 006037dc
    JZ 0x0060388d                       ; 006037de | LAB_0060388d
        ;   XREF to: 0060388d (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 006037e4
    MOV AL,byte ptr [ESP + 0x8]         ; 006037e6
    MOV AL,byte ptr [EAX + 0x3f9c031]   ; 006037ea | char[256] g_LeadByteTable
    AND AL,0x1                          ; 006037f0
    AND EAX,0xff                        ; 006037f2
    JZ 0x0060388d                       ; 006037f7 | LAB_0060388d
        ;   XREF to: 0060388d (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 00603841
    PUSH ESI                            ; 00603842
    CALL crt_stdio.c_WideCharToSingleByte_FUN_0060acf0 ; 00603843 | int crt_stdio.c_WideCharToSingleByte_FUN_0060acf0(wchar_t wide_char, char * output_buffer)
        ;   XREF to: 0060acf0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00603848
    MOV EDX,EAX                         ; 0060384b
    CMP EAX,-0x1                        ; 0060384d
    JZ 0x00603864                       ; 00603850 | LAB_00603864
