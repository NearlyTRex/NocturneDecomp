...
;                               FUNCTION
; *****************************************************************************
; __cdecl void * crt_memory.c_calloc_FUN_0060ca90(ulong count, ulong size)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0060ca9a
    CALL crt_memory.c_malloc_FUN_00601bb0 ; 0060ca9b | void * crt_memory.c_malloc_FUN_00601bb0(ulong size)
        ;   XREF to: 00601bb0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060caa0
    TEST EAX,EAX                        ; 0060caa3
    JZ 0x0060cab3                       ; 0060caa5 | LAB_0060cab3
        ;   XREF to: 0060cab3 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 0060caa7
    PUSH 0x0                            ; 0060caa8
    PUSH EAX                            ; 0060caaa
    CALL crt_memory.c_memset_FUN_005fde40 ; 0060caab | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
