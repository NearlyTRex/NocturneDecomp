...
;                               FUNCTION
; *****************************************************************************
; __cdecl void * crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
;
; Parameters:
...
;   core_baron.cpp_FUN_004136b0 at 0041382c
...
section .text
    ...
    CMP EBP,dword ptr [ESP]             ; 005fe68d
        ;   Label: LAB_005fe68d
    JA 0x005fe69e                       ; 005fe690 | LAB_005fe69e
    ...
    JMP 0x005fe68d                      ; 005fe6ad | LAB_005fe68d
