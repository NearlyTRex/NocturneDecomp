...
;                               FUNCTION
; *****************************************************************************
; __cdecl void * __cdecl crt_memory_c_constructTypedObjectArray_FUN_00601232 (void *dest,int element_count,WatcomTypeInfo *type_info)
;
; Parameters:
...
;
; XREF[1]:
;   crt_memory.c_constructTypedObjectArray_FUN_00601272 at 00601282
;
; Called Functions:
