...
section .text
    ...
    CALL crt_memory.c_BulkDwordFill_FUN_00603b37 ; 00603b17
        ;   XREF to: 00603b37 (UNCONDITIONAL_CALL)  ; void crt_memory.c_BulkDwordFill_FUN_00603b37(void * dest, uint replicated_value, uint dword_count)
    POP ECX                             ; 00603b1c
