...
;                               FUNCTION
; *****************************************************************************
; __watcallRegister void crt_memory.c_OptimizedMemFill_FUN_00603b00(void * dest, uint replicated_value, uint count)
;
;
; XREF[1]:
...
section .text
    ...
    JZ 0x00603b30                       ; 00603b02 | LAB_00603b30
        ;   XREF to: 00603b30 (CONDITIONAL_JUMP)
    CMP byte ptr [EAX],DL               ; 00603b04
    TEST AL,0x3                         ; 00603b06
        ;   Label: LAB_00603b06
    JZ 0x00603b13                       ; 00603b08 | LAB_00603b13
        ;   XREF to: 00603b13 (CONDITIONAL_JUMP)
    MOV byte ptr [EAX],DL               ; 00603b0a
    INC EAX                             ; 00603b0c
    ROR EDX,0x8                         ; 00603b0d
    DEC ECX                             ; 00603b10
    JNZ 0x00603b06                      ; 00603b11 | LAB_00603b06
        ;   XREF to: 00603b06 (CONDITIONAL_JUMP)
    PUSH ECX                            ; 00603b13
        ;   Label: LAB_00603b13
    SHR ECX,0x2                         ; 00603b14
    CALL crt_memory.c_BulkDwordFill_FUN_00603b37 ; 00603b17 | void crt_memory.c_BulkDwordFill_FUN_00603b37(void * dest, uint replicated_value, uint dword_count)
        ;   XREF to: 00603b37 (UNCONDITIONAL_CALL)
    POP ECX                             ; 00603b1c
    AND ECX,0x3                         ; 00603b1d
    JZ 0x00603b30                       ; 00603b20 | LAB_00603b30
        ;   XREF to: 00603b30 (CONDITIONAL_JUMP)
    MOV byte ptr [EAX],DL               ; 00603b22
    DEC ECX                             ; 00603b24
    JZ 0x00603b30                       ; 00603b25 | LAB_00603b30
        ;   XREF to: 00603b30 (CONDITIONAL_JUMP)
    MOV byte ptr [EAX + 0x1],DH         ; 00603b27
    DEC ECX                             ; 00603b2a
    JZ 0x00603b30                       ; 00603b2b | LAB_00603b30
        ;   XREF to: 00603b30 (CONDITIONAL_JUMP)
