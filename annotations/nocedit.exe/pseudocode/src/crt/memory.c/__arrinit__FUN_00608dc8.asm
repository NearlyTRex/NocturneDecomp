...
;                               FUNCTION
; *****************************************************************************
; __cdecl void * __cdecl crt_memory_c___arrinit__FUN_00608dc8(void *array_start,int element_count,WatcomTypeInfo *type_info)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00608dc8
        ;   Label: crt_memory.c___arrinit__FUN_00608dc8
    PUSH ESI                            ; 00608dc9
    PUSH EDI                            ; 00608dca
    PUSH EBP                            ; 00608dcb
