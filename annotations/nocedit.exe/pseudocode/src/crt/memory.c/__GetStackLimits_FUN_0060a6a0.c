// Name: crt_memory.c___GetStackLimits_FUN_0060a6a0
// Address: 0060a6a0
// Address Range: [[0060a6a0, 0060a708]]
// Convention: __cdecl
// Signature: void __cdecl crt_memory_c___GetStackLimits_FUN_0060a6a0(ThreadData *pStackBound,uint *pHeapBound)
