...
;                               FUNCTION
; *****************************************************************************
; __watcallRegister void crt_memory_c___stosd_FUN_00603b37(void *dest,uint replicated_value,uint dword_count)
;
;
; XREF[1]:
;   crt_memory.c___memfill_FUN_00603b00 at 00603b17
;
; *****************************************************************************
...
section .text
    ...
    OR ECX,ECX                          ; 00603b37
        ;   Label: crt_memory.c___stosd_FUN_00603b37
