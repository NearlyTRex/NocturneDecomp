...
;                               FUNCTION
; *****************************************************************************
; __cdecl void * __cdecl crt_memory_c___arrinit_dispatch_FUN_00601200 (void *array_ptr,int element_count,WatcomTypeInfo *type_info)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x4]       ; 00601200
        ;   Label: crt_memory.c___arrinit_dispatch_FUN_00601200
    ...
    PUSH ECX                            ; 0060121f
    PUSH EDX                            ; 00601220
    CALL EAX                            ; 00601221 | void * crt_memory.c___arrinit__FUN_00608dc8(void * array_start, int element_count, WatcomTypeInfo * type_info)
