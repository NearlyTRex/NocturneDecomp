...
;                               FUNCTION
; *****************************************************************************
; __cdecl void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
;
; Parameters:
...
;   core_bodypart.cpp_FUN_0041a050 at 0041a3fe
;   ... and 128 more
;
; Called Functions:
...
section .text
    ...
    MOV DL,DH                           ; 005fde57
    CALL crt_memory.c_OptimizedMemFill_FUN_00603b00 ; 005fde59 | void crt_memory.c_OptimizedMemFill_FUN_00603b00(void * dest, uint replicated_value, uint count)
