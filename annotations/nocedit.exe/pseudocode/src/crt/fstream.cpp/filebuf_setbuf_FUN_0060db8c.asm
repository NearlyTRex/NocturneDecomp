...
section .text
    ...
    PUSH EBX                            ; 0060dbb2
        ;   Label: LAB_0060dbb2
    CALL crt_iostream.cpp_setBuffer_FUN_0060d6a8 ; 0060dbb3 | void crt_iostream.cpp_setBuffer_FUN_0060d6a8(streambuf * this_ptr, void * new_buffer, void * buffer_end, int ownership_flag)
    ...
    PUSH 0x0                            ; 0060dbdb
    PUSH EBX                            ; 0060dbdd
    CALL crt_iostream.cpp_setBuffer_FUN_0060d6a8 ; 0060dbde | void crt_iostream.cpp_setBuffer_FUN_0060d6a8(streambuf * this_ptr, void * new_buffer, void * buffer_end, int ownership_flag)
        ;   XREF to: 0060d6a8 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0060dbe3
    JMP 0x0060dbbf                      ; 0060dbe6 | LAB_0060dbbf
