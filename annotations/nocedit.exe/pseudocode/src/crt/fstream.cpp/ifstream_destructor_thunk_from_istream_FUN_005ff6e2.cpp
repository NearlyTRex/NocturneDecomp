...
// Convention: __cdecl
// Signature: void __cdecl crt_fstream_cpp_ifstream_destructor_thunk_from_istream_FUN_005ff6e2(_istream *this_ptr,int dtor_flags)
...
{
  crt_fstream_cpp_ifstream_dtor_FUN_005ff856(&this_ptr[-2]._ios.__i_lock,dtor_flags);
  return;
}
