...
;                               FUNCTION
; *****************************************************************************
; __cdecl int crt_fstream.cpp_filebuf_open_FUN_00608c15(filebuf * this_ptr, char * filename, int mode, int permissions)
;
; Parameters:
...
section .text
    ...
    PUSH ESI                            ; 00608c74
    CALL crt_fstream.cpp_convertModesAndOpenFile_FUN_0060c340 ; 00608c75 | int crt_fstream.cpp_convertModesAndOpenFile_FUN_0060c340(char * filename, int * iostream_mode, int permissions)
        ;   XREF to: 0060c340 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00608c7a
    MOV dword ptr [EBX + 0x2c],EAX      ; 00608c7d
    TEST EAX,EAX                        ; 00608c80
    JL 0x00608cc8                       ; 00608c82 | LAB_00608cc8
    ...
    JZ 0x00608cae                       ; 00608c99 | LAB_00608cae
