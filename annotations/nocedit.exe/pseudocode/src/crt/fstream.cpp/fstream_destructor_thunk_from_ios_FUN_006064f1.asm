...
section .text
    ...
    PUSH EAX                            ; 006064ff
    CALL crt_fstream.cpp_fstreambase_dtor_FUN_00606509 ; 00606500 | fstreambase * crt_fstream.cpp_fstreambase_dtor_FUN_00606509(fstreambase * this_ptr, uint d1, uint d2, uint d3)
