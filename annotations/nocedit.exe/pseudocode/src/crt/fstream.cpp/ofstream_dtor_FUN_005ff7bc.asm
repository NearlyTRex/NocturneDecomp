...
;                               FUNCTION
; *****************************************************************************
; ofstream * __cdecl crt_fstream.cpp_ofstream_dtor_FUN_005ff7bc(void * this_ptr,uint flags)
;
; Parameters:
...
section .text
    ...
    PUSH 0x65bcd0                       ; 005ff820 | g_OFStreamTypeInfo
        ;   Label: LAB_005ff820
    PUSH EBX                            ; 005ff825
    CALL crt_memory.c___vec_delete_FUN_005fe632 ; 005ff826
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c___vec_delete_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 005ff82b
    PUSH EAX                            ; 005ff82e
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 005ff82f
