...
section .text
    ...
    JNZ 0x005ff820                      ; 005ff7c6 | LAB_005ff820
    ...
    MOV dword ptr [EBX + 0x40],0x665cd4 ; 005ff7d3 | void * g_OFStream_FStreamBaseDestructor
    PUSH 0x1                            ; 005ff7da
    MOV EAX,dword ptr [EBX]             ; 005ff7dc
    MOV dword ptr [EBX + 0x48],0x665cdc ; 005ff7de | void * g_OFStream_OStream
    ADD EBX,0x44                        ; 005ff7e5
    MOV EAX,dword ptr [EAX + 0x4]       ; 005ff7e8
    PUSH EBX                            ; 005ff7eb
    MOV dword ptr [EBX + EAX*0x1 + -0x1c],0x665ce4 ; 005ff7ec | void * g_OFStream_IOS
    CALL crt_iostream.cpp_ostream_dtor_FUN_00606231 ; 005ff7f4 | ostream * crt_iostream.cpp_ostream_dtor_FUN_00606231(ostream * this_ptr, uint d1, uint d2)
        ;   XREF to: 00606231 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005ff7f9
    PUSH 0x1                            ; 005ff7fc
    LEA EBX,[EAX + -0x44]               ; 005ff7fe
    PUSH EBX                            ; 005ff801
    CALL crt_fstream.cpp_fstreambase_dtor_FUN_00606509 ; 005ff802 | fstreambase * crt_fstream.cpp_fstreambase_dtor_FUN_00606509(fstreambase * this_ptr, uint d1, uint d2, uint d3)
    ...
    JZ 0x005ff83b                       ; 005ff813 | LAB_005ff83b
        ;   XREF to: 005ff83b (CONDITIONAL_JUMP)
    TEST byte ptr [ESP + 0xc],0x2       ; 005ff815
        ;   Label: LAB_005ff815
    JNZ 0x005ff84e                      ; 005ff81a | LAB_005ff84e
        ;   XREF to: 005ff84e (CONDITIONAL_JUMP)
    MOV EAX,EBX                         ; 005ff81c
    POP EBX                             ; 005ff81e
    RET                                 ; 005ff81f
    PUSH 0x65bcd0                       ; 005ff820 | WatcomTypeInfo g_OFStreamTypeInfo
        ;   Label: LAB_005ff820
    PUSH EBX                            ; 005ff825
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 005ff826 | void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005ff82b
    PUSH EAX                            ; 005ff82e
    CALL crt_memory.c_free_FUN_005fe659 ; 005ff82f | void crt_memory.c_free_FUN_005fe659(void * ptr)
    ...
    PUSH EAX                            ; 005ff840
    CALL crt_iostream.cpp_ios_dtor_FUN_0060632c ; 005ff841 | ios * crt_iostream.cpp_ios_dtor_FUN_0060632c(ios * this_ptr, uint d1, uint d2)
        ;   XREF to: 0060632c (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005ff846
    LEA EBX,[EAX + -0x50]               ; 005ff849
    JMP 0x005ff815                      ; 005ff84c | LAB_005ff815
        ;   XREF to: 005ff815 (UNCONDITIONAL_JUMP)
    PUSH EBX                            ; 005ff84e
        ;   Label: LAB_005ff84e
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 005ff84f | void shape_memdbg.cpp_debugFree_FUN_0050f210(void * ptr)
        ;   XREF to: 0050f210 (UNCONDITIONAL_CALL)
    JMP 0x005ff834                      ; 005ff854 | LAB_005ff834
