...
;                               FUNCTION
; *****************************************************************************
; __cdecl fstreambase * crt_fstream.cpp_fstreambase_ctor_FUN_0060658f(fstreambase * this_ptr, uint c1)
;
; Parameters:
...
section .text
    ...
    JZ 0x006065e1                       ; 00606599 | LAB_006065e1
        ;   XREF to: 006065e1 (CONDITIONAL_JUMP)
    ADD EBX,0x4                         ; 0060659b
        ;   Label: LAB_0060659b
    PUSH EBX                            ; 0060659e
    CALL crt_fstream.cpp_filebuf_ctor_FUN_0060bddd ; 0060659f | filebuf * crt_fstream.cpp_filebuf_ctor_FUN_0060bddd(filebuf * this_ptr)
    ...
    MOV dword ptr [EBX + 0x40],0x665ed4 ; 006065b4 | void * g_FStreamBase_Destructor
    MOV EAX,dword ptr [EAX + 0x4]       ; 006065bb
    ADD ESP,0x4                         ; 006065be
    MOV dword ptr [EBX + EAX*0x1 + 0x28],0x665edc ; 006065c1 | void * g_FStreamBase_IOSDestructor
    ...
    PUSH EAX                            ; 006065d4
    CALL crt_iostream.cpp_streambuf_initBuffer_FUN_0060b815 ; 006065d5 | void crt_iostream.cpp_streambuf_initBuffer_FUN_0060b815(streambuf * this_ptr, char * buffer_ptr, int buffer_size, char * put_start)
        ;   XREF to: 0060b8da (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 006065da
    MOV EAX,EBX                         ; 006065dd
    POP EBX                             ; 006065df
    RET                                 ; 006065e0
    MOV dword ptr [EBX],0x665ec8        ; 006065e1 | WatcomVirtualBaseDescriptor g_FStreamBase_VirtualBaseLayout
        ;   Label: LAB_006065e1
    ADD EBX,0x48                        ; 006065e7
    PUSH EBX                            ; 006065ea
    CALL crt_iostream.cpp_ios_ctor_FUN_006061fc ; 006065eb | ios * crt_iostream.cpp_ios_ctor_FUN_006061fc(ios * this_ptr)
        ;   XREF to: 006061fc (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 006065f0
    LEA EBX,[EAX + -0x48]               ; 006065f3
    JMP 0x0060659b                      ; 006065f6 | LAB_0060659b
