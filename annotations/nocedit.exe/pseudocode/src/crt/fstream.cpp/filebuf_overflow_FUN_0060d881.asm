...
section .text
    ...
    JG 0x0060d8cb                       ; 0060d895
        ;   XREF to: 0060d8cb (CONDITIONAL_JUMP)  ; LAB_0060d8cb
    ...
    JNZ 0x0060d9b7                      ; 0060d8b1
        ;   XREF to: 0060d9b7 (CONDITIONAL_JUMP)  ; LAB_0060d9b7
    JZ 0x0060d8df                       ; 0060d8b7
        ;   XREF to: 0060d8df (CONDITIONAL_JUMP)  ; LAB_0060d8df
    MOV EAX,dword ptr [EBX + 0x4]       ; 0060d8b9
        ;   Label: LAB_0060d8b9
    TEST EAX,EAX                        ; 0060d8bc
    JNZ 0x0060d924                      ; 0060d8be
        ;   XREF to: 0060d924 (CONDITIONAL_JUMP)  ; LAB_0060d924
    CMP dword ptr [EBP + 0x18],-0x1     ; 0060d8c0
    JNZ 0x0060d8fb                      ; 0060d8c4
        ;   XREF to: 0060d8fb (CONDITIONAL_JUMP)  ; LAB_0060d8fb
    JMP 0x0060d9b0                      ; 0060d8c6
        ;   XREF to: 0060d9b0 (UNCONDITIONAL_JUMP)  ; LAB_0060d9b0
    PUSH EBX                            ; 0060d8cb
        ;   Label: LAB_0060d8cb
    ...
    JNZ 0x0060d8ac                      ; 0060d8d8
        ;   XREF to: 0060d8ac (CONDITIONAL_JUMP)  ; LAB_0060d8ac
    JMP 0x0060d9b0                      ; 0060d8da
        ;   XREF to: 0060d9b0 (UNCONDITIONAL_JUMP)  ; LAB_0060d9b0
    MOV EAX,dword ptr [EBX + 0x24]      ; 0060d8df
        ;   Label: LAB_0060d8df
    AND EAX,0x1                         ; 0060d8e2
    JNZ 0x0060d8b9                      ; 0060d8e5
        ;   XREF to: 0060d8b9 (CONDITIONAL_JUMP)  ; LAB_0060d8b9
    PUSH EBX                            ; 0060d8e7
    MOV EAX,dword ptr [EBX + 0x28]      ; 0060d8e8
    CALL dword ptr [EAX + 0x28]         ; 0060d8eb
    ADD ESP,0x4                         ; 0060d8ee
    CMP EAX,-0x1                        ; 0060d8f1
    JNZ 0x0060d8b9                      ; 0060d8f4
        ;   XREF to: 0060d8b9 (CONDITIONAL_JUMP)  ; LAB_0060d8b9
    JMP 0x0060d9b0                      ; 0060d8f6
        ;   XREF to: 0060d9b0 (UNCONDITIONAL_JUMP)  ; LAB_0060d9b0
    ...
    PUSH EAX                            ; 0060d90a
    CALL crt_io.c_write_FUN_006084ec    ; 0060d90b
    ...
    TEST byte ptr [EBX + 0x30],0x8      ; 0060d930
        ;   Label: LAB_0060d930
    JNZ 0x0060d9ca                      ; 0060d934
        ;   XREF to: 0060d9ca (CONDITIONAL_JUMP)  ; LAB_0060d9ca
    CMP dword ptr [EBP + 0x18],-0x1     ; 0060d93a
        ;   Label: LAB_0060d93a
    JNZ 0x0060d9f6                      ; 0060d93e
        ;   XREF to: 0060d9f6 (CONDITIONAL_JUMP)  ; LAB_0060d9f6
    ...
    TEST ESI,ESI                        ; 0060d94e
        ;   Label: LAB_0060d94e
    JBE 0x0060d981                      ; 0060d950
        ;   XREF to: 0060d981 (CONDITIONAL_JUMP)  ; LAB_0060d981
    CMP ESI,0x7fffffff                  ; 0060d952
    JBE 0x0060da1d                      ; 0060d958
        ;   XREF to: 0060da1d (CONDITIONAL_JUMP)  ; LAB_0060da1d
    ...
    PUSH EAX                            ; 0060d96b
    CALL crt_io.c_write_FUN_006084ec    ; 0060d96c
        ;   XREF to: 006084ec (UNCONDITIONAL_CALL)  ; int crt_io.c_write_FUN_006084ec(int fd, void * buffer, SIZE_T count)
    ADD ESP,0xc                         ; 0060d971
    CMP EAX,-0x1                        ; 0060d974
    JZ 0x0060d9b0                       ; 0060d977
        ;   XREF to: 0060d9b0 (CONDITIONAL_JUMP)  ; LAB_0060d9b0
    TEST EAX,EAX                        ; 0060d979
    JNZ 0x0060da24                      ; 0060d97b
        ;   XREF to: 0060da24 (CONDITIONAL_JUMP)  ; LAB_0060da24
    CMP dword ptr [EBP + 0x18],-0x1     ; 0060d981
        ;   Label: LAB_0060d981
    JZ 0x0060d999                       ; 0060d985
        ;   XREF to: 0060d999 (CONDITIONAL_JUMP)  ; LAB_0060d999
    MOV EAX,dword ptr [EBX + 0x20]      ; 0060d987
    MOV EDX,dword ptr [EBX + 0x1c]      ; 0060d98a
    CMP EAX,EDX                         ; 0060d98d
    JNC 0x0060d9ab                      ; 0060d98f
        ;   XREF to: 0060d9ab (CONDITIONAL_JUMP)  ; LAB_0060d9ab
    ...
    TEST byte ptr [EBX + 0x30],0x8      ; 0060d999
        ;   Label: LAB_0060d999
    JNZ 0x0060da64                      ; 0060d99d
        ;   XREF to: 0060da64 (CONDITIONAL_JUMP)  ; LAB_0060da64
    TEST ESI,ESI                        ; 0060d9a3
        ;   Label: LAB_0060d9a3
    JZ 0x0060da80                       ; 0060d9a5
        ;   XREF to: 0060da80 (CONDITIONAL_JUMP)  ; LAB_0060da80
    ...
    JA 0x0060d930                       ; 0060d9bf
        ;   XREF to: 0060d930 (CONDITIONAL_JUMP)  ; LAB_0060d930
    JMP 0x0060d924                      ; 0060d9c5
        ;   XREF to: 0060d924 (UNCONDITIONAL_JUMP)  ; LAB_0060d924
    MOV EAX,dword ptr [EBX + 0x2c]      ; 0060d9ca
        ;   Label: LAB_0060d9ca
    PUSH EAX                            ; 0060d9cd
    CALL crt_io.c_tell_FUN_00606720     ; 0060d9ce
    ...
    JL 0x0060d9ab                       ; 0060d9da
        ;   XREF to: 0060d9ab (CONDITIONAL_JUMP)  ; LAB_0060d9ab
    PUSH 0x2                            ; 0060d9dc
    PUSH 0x0                            ; 0060d9de
    MOV EAX,dword ptr [EBX + 0x2c]      ; 0060d9e0
    PUSH EAX                            ; 0060d9e3
    CALL crt_stdio.c_lseek_FUN_00606690 ; 0060d9e4
    ...
    JGE 0x0060d93a                      ; 0060d9ee
        ;   XREF to: 0060d93a (CONDITIONAL_JUMP)  ; LAB_0060d93a
    JMP 0x0060d9ab                      ; 0060d9f4
        ;   XREF to: 0060d9ab (UNCONDITIONAL_JUMP)  ; LAB_0060d9ab
    MOV EAX,dword ptr [EBX + 0x20]      ; 0060d9f6
        ;   Label: LAB_0060d9f6
    MOV EDX,dword ptr [EBX + 0x1c]      ; 0060d9f9
    CMP EAX,EDX                         ; 0060d9fc
    JNC 0x0060d944                      ; 0060d9fe
        ;   XREF to: 0060d944 (CONDITIONAL_JUMP)  ; LAB_0060d944
    ...
    JMP 0x0060d944                      ; 0060da18
        ;   XREF to: 0060d944 (UNCONDITIONAL_JUMP)  ; LAB_0060d944
    MOV EAX,ESI                         ; 0060da1d
        ;   Label: LAB_0060da1d
    JMP 0x0060d963                      ; 0060da1f
        ;   XREF to: 0060d963 (UNCONDITIONAL_JUMP)  ; LAB_0060d963
    SUB ESI,EAX                         ; 0060da24
        ;   Label: LAB_0060da24
    TEST ESI,ESI                        ; 0060da26
    JA 0x0060da3b                       ; 0060da28
        ;   XREF to: 0060da3b (CONDITIONAL_JUMP)  ; LAB_0060da3b
    ...
    JMP 0x0060d94e                      ; 0060da36
        ;   XREF to: 0060d94e (UNCONDITIONAL_JUMP)  ; LAB_0060d94e
    ...
    PUSH EAX                            ; 0060da41
    PUSH EDX                            ; 0060da42
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 0060da43
    ...
    PUSH EAX                            ; 0060da6a
    CALL crt_stdio.c_lseek_FUN_00606690 ; 0060da6b
        ;   XREF to: 00606690 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_lseek_FUN_00606690(int file_handle_index, long distance_to_move, int move_method)
    ADD ESP,0xc                         ; 0060da70
    TEST EAX,EAX                        ; 0060da73
    JGE 0x0060d9a3                      ; 0060da75
        ;   XREF to: 0060d9a3 (CONDITIONAL_JUMP)  ; LAB_0060d9a3
    JMP 0x0060d9ab                      ; 0060da7b
        ;   XREF to: 0060d9ab (UNCONDITIONAL_JUMP)  ; LAB_0060d9ab
    XOR EAX,EAX                         ; 0060da80
        ;   Label: LAB_0060da80
    JMP 0x0060d9b0                      ; 0060da82
        ;   XREF to: 0060d9b0 (UNCONDITIONAL_JUMP)  ; LAB_0060d9b0
