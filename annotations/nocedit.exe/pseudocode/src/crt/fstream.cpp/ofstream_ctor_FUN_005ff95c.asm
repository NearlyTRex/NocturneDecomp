...
;                               FUNCTION
; *****************************************************************************
; __cdecl ofstream * crt_fstream.cpp_ofstream_ctor_FUN_005ff95c(ofstream * this_ptr, int c1)
;
; Parameters:
...
section .text
    ...
    JZ 0x005ff9aa                       ; 005ff965 | LAB_005ff9aa
        ;   XREF to: 005ff9aa (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 005ff967
        ;   Label: LAB_005ff967
    PUSH EAX                            ; 005ff969
    CALL crt_fstream.cpp_fstreambase_ctor_FUN_0060658f ; 005ff96a | fstreambase * crt_fstream.cpp_fstreambase_ctor_FUN_0060658f(fstreambase * this_ptr, uint c1)
        ;   XREF to: 0060658f (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005ff96f
    PUSH 0x1                            ; 005ff972
    ADD EAX,0x44                        ; 005ff974
    PUSH EAX                            ; 005ff977
    CALL crt_iostream.cpp_ostream_ctor_FUN_006061a2 ; 005ff978 | ostream * crt_iostream.cpp_ostream_ctor_FUN_006061a2(ostream * this_ptr, uint c1)
    ...
    MOV dword ptr [EAX + 0x40],0x665cd4 ; 005ff98b | void * g_OFStream_FStreamBaseDestructor
    MOV EDX,dword ptr [EAX]             ; 005ff992
    MOV dword ptr [EAX + 0x48],0x665cdc ; 005ff994 | void * g_OFStream_OStream
    MOV EDX,dword ptr [EDX + 0x4]       ; 005ff99b
    ADD ESP,0x8                         ; 005ff99e
    MOV dword ptr [EDX + EAX*0x1 + 0x28],0x665ce4 ; 005ff9a1 | void * g_OFStream_IOS
    RET                                 ; 005ff9a9
    MOV dword ptr [EAX],0x665cc0        ; 005ff9aa | WatcomVirtualBaseDescriptor g_OFStream_VirtualBaseLayout
        ;   Label: LAB_005ff9aa
    ADD EAX,0x50                        ; 005ff9b0
    PUSH EAX                            ; 005ff9b3
    MOV dword ptr [EAX + -0xc],0x665cc8 ; 005ff9b4 | WatcomVirtualBaseDescriptor g_OFStream_OStreamSubobjectLayout
    CALL crt_iostream.cpp_ios_ctor_FUN_006061fc ; 005ff9bb | ios * crt_iostream.cpp_ios_ctor_FUN_006061fc(ios * this_ptr)
        ;   XREF to: 006061fc (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005ff9c0
    SUB EAX,0x50                        ; 005ff9c3
    JMP 0x005ff967                      ; 005ff9c6 | LAB_005ff967
