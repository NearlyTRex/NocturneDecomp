...
;
; Called Functions:
;   crt_fstream.cpp_fstreambase_ctor_FUN_00606456
...
section .text
    ...
    MOV EAX,dword ptr [ESP + 0x4]       ; 005ff710
        ;   Label: crt_fstream.cpp_ofstream_ctor_FUN_005ff710
    ...
    PUSH 0x1                            ; 005ff72d
    PUSH EAX                            ; 005ff72f
    CALL crt_fstream.cpp_fstreambase_ctor_FUN_00606456 ; 005ff730
        ;   XREF to: 00606456 (UNCONDITIONAL_CALL)  ; void crt_fstream.cpp_fstreambase_ctor_FUN_00606456(fstreambase * this_ptr, int ctor_flags, int fd, int mode, ...)
