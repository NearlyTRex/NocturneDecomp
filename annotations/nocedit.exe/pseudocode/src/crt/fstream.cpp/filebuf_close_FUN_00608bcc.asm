...
section .text
    ...
    JNZ 0x00608bdf                      ; 00608bd8
        ;   XREF to: 00608bdf (CONDITIONAL_JUMP)  ; LAB_00608bdf
    ...
    CALL crt_io.c_close_handle_safe_FUN_0060c2e0 ; 00608bff
        ;   XREF to: 0060c2e0 (UNCONDITIONAL_CALL)  ; int crt_io.c_close_handle_safe_FUN_0060c2e0(int handle_index)
    ADD ESP,0x4                         ; 00608c04
    TEST EAX,EAX                        ; 00608c07
    JNZ 0x00608bda                      ; 00608c09
        ;   XREF to: 00608bda (CONDITIONAL_JUMP)  ; LAB_00608bda
    CMP ESI,-0x1                        ; 00608c0b
    JZ 0x00608bdc                       ; 00608c0e
        ;   XREF to: 00608bdc (CONDITIONAL_JUMP)  ; LAB_00608bdc
