...
section .text
    ...
    PUSH EAX                            ; 0060dc1e
    CALL crt_stdio.c_lseek_FUN_00606690 ; 0060dc1f | int crt_stdio.c_lseek_FUN_00606690(int file_handle_index, long distance_to_move, int move_method)
    ...
    JNZ 0x0060dc0b                      ; 0060dc3b | LAB_0060dc0b
    ...
    MOV EAX,0x1                         ; 0060dc41
        ;   Label: LAB_0060dc41
    JMP 0x0060dc16                      ; 0060dc46 | LAB_0060dc16
        ;   XREF to: 0060dc16 (UNCONDITIONAL_JUMP)
    MOV EAX,ESI                         ; 0060dc48
        ;   Label: LAB_0060dc48
    JMP 0x0060dc16                      ; 0060dc4a | LAB_0060dc16
        ;   XREF to: 0060dc16 (UNCONDITIONAL_JUMP)
    ...
    POP EBX                             ; 0060dc53
    RET                                 ; 0060dc54
    JBE 0x0060dc41                      ; 0060dc55 | LAB_0060dc41
        ;   Label: LAB_0060dc55
        ;   XREF to: 0060dc41 (CONDITIONAL_JUMP)
    CMP ESI,0x2                         ; 0060dc57
    JZ 0x0060dc48                       ; 0060dc5a | LAB_0060dc48
        ;   XREF to: 0060dc48 (CONDITIONAL_JUMP)
    JMP 0x0060dc4c                      ; 0060dc5c | LAB_0060dc4c
