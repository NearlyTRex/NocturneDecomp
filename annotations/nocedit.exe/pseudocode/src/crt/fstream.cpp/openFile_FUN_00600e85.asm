...
;                               FUNCTION
; *****************************************************************************
; __cdecl void crt_fstream.cpp_openFile_FUN_00600e85(ifstream * stream_obj, char * filename, int open_mode, SIZE_T buffer_size)
;
; Parameters:
...
section .text
    ...
    JZ 0x00600ece                       ; 00600e99 | LAB_00600ece
    ...
    PUSH EDI                            ; 00600ea9
    PUSH EDX                            ; 00600eaa
    CALL crt_fstream.cpp_filebuf_open_FUN_00608c15 ; 00600eab | int crt_fstream.cpp_filebuf_open_FUN_00608c15(filebuf * this_ptr, char * filename, int mode, int permissions)
        ;   XREF to: 00608c15 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00600eb0
    TEST EAX,EAX                        ; 00600eb3
    JNZ 0x00600ed3                      ; 00600eb5 | LAB_00600ed3
    ...
    PUSH EBX                            ; 00600ec0
    CALL crt_stdio.c_reportStreamError_FUN_00606020 ; 00600ec1 | void crt_stdio.c_reportStreamError_FUN_00606020(FileEmbeddedData * embedded_data, uint error_flags)
        ;   Label: LAB_00600ec1
    ...
    PUSH 0x2                            ; 00600ece
        ;   Label: LAB_00600ece
    PUSH EAX                            ; 00600ed0
    JMP 0x00600ec1                      ; 00600ed1 | LAB_00600ec1
    ...
    PUSH EBX                            ; 00600edc
    CALL crt_stdio.c_clear_and_preserve_state_FUN_00600e64 ; 00600edd | uint crt_stdio.c_clear_and_preserve_state_FUN_00600e64(FileEmbeddedData * embedded_data, uint error_code)
        ;   XREF to: 00600e64 (UNCONDITIONAL_CALL)
    JMP 0x00600ec6                      ; 00600ee2 | LAB_00600ec6
