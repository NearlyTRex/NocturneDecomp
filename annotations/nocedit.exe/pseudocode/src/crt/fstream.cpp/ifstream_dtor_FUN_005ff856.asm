...
;                               FUNCTION
; *****************************************************************************
; __cdecl void * crt_fstream.cpp_ifstream_dtor_FUN_005ff856(ifstream * this_ptr, uint d1, uint d2, uint d3, uint d4)
;
; Parameters:
...
section .text
    ...
    JNZ 0x005ff8ba                      ; 005ff860 | LAB_005ff8ba
    ...
    MOV dword ptr [EBX + 0x40],0x665c68 ; 005ff86d | void * g_IFStream_FStreamBaseDestructor
    PUSH 0x1                            ; 005ff874
    MOV EAX,dword ptr [EBX]             ; 005ff876
    MOV dword ptr [EBX + 0x4c],0x665c70 ; 005ff878 | void * g_IFStream_IStreamDestructor
    ADD EBX,0x44                        ; 005ff87f
    MOV EAX,dword ptr [EAX + 0x4]       ; 005ff882
    PUSH EBX                            ; 005ff885
    MOV dword ptr [EBX + EAX*0x1 + -0x1c],0x665c78 ; 005ff886 | void * g_IFStream_IOSDestructor
    CALL crt_iostream.cpp_istream_dtor_FUN_006063e1 ; 005ff88e | istream * crt_iostream.cpp_istream_dtor_FUN_006063e1(istream * this_ptr, uint d1, uint d2)
        ;   XREF to: 006063e1 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005ff893
    PUSH 0x1                            ; 005ff896
    LEA EBX,[EAX + -0x44]               ; 005ff898
    PUSH EBX                            ; 005ff89b
    CALL crt_fstream.cpp_fstreambase_dtor_FUN_00606509 ; 005ff89c | fstreambase * crt_fstream.cpp_fstreambase_dtor_FUN_00606509(fstreambase * this_ptr, uint d1, uint d2, uint d3)
    ...
    JZ 0x005ff8d5                       ; 005ff8ad | LAB_005ff8d5
        ;   XREF to: 005ff8d5 (CONDITIONAL_JUMP)
    TEST byte ptr [ESP + 0xc],0x2       ; 005ff8af
        ;   Label: LAB_005ff8af
    JNZ 0x005ff8e8                      ; 005ff8b4 | LAB_005ff8e8
        ;   XREF to: 005ff8e8 (CONDITIONAL_JUMP)
    MOV EAX,EBX                         ; 005ff8b6
    POP EBX                             ; 005ff8b8
    RET                                 ; 005ff8b9
    PUSH 0x65bcb0                       ; 005ff8ba | WatcomTypeInfo g_IFStreamTypeInfo
        ;   Label: LAB_005ff8ba
    PUSH EBX                            ; 005ff8bf
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 005ff8c0 | void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005ff8c5
    PUSH EAX                            ; 005ff8c8
    CALL crt_memory.c_free_FUN_005fe659 ; 005ff8c9 | void crt_memory.c_free_FUN_005fe659(void * ptr)
    ...
    PUSH EAX                            ; 005ff8da
    CALL crt_iostream.cpp_ios_dtor_FUN_0060632c ; 005ff8db | ios * crt_iostream.cpp_ios_dtor_FUN_0060632c(ios * this_ptr, uint d1, uint d2)
        ;   XREF to: 0060632c (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005ff8e0
    LEA EBX,[EAX + -0x54]               ; 005ff8e3
    JMP 0x005ff8af                      ; 005ff8e6 | LAB_005ff8af
        ;   XREF to: 005ff8af (UNCONDITIONAL_JUMP)
    PUSH EBX                            ; 005ff8e8
        ;   Label: LAB_005ff8e8
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 005ff8e9 | void shape_memdbg.cpp_debugFree_FUN_0050f210(void * ptr)
        ;   XREF to: 0050f210 (UNCONDITIONAL_CALL)
    JMP 0x005ff8ce                      ; 005ff8ee | LAB_005ff8ce
