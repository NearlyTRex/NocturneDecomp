...
;                               FUNCTION
; *****************************************************************************
; __cdecl void crt_fstream.cpp_ifstream_constructor_FUN_005ff664(ifstream * this_ptr, int ctor_flags, int fd, char * buffer, int buffer_len)
;
; Parameters:
...
section .text
    ...
    JZ 0x005ff6c4                       ; 005ff66d | LAB_005ff6c4
    ...
    PUSH 0x1                            ; 005ff681
    PUSH EAX                            ; 005ff683
    CALL crt_fstream.cpp_fstreambase_constructor_FUN_00606456 ; 005ff684 | void crt_fstream.cpp_fstreambase_constructor_FUN_00606456(fstreambase * this_ptr, int ctor_flags, int fd, int mode, ...)
        ;   XREF to: 00606456 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 005ff689
    PUSH 0x1                            ; 005ff68c
    ADD EAX,0x44                        ; 005ff68e
    PUSH EAX                            ; 005ff691
    CALL crt_iostream.cpp_istream_ctor_FUN_00606376 ; 005ff692 | istream * crt_iostream.cpp_istream_ctor_FUN_00606376(istream * this_ptr, uint c1)
    ...
    MOV dword ptr [EAX + 0x40],0x665c68 ; 005ff6a5 | void * g_IFStream_FStreamBaseDestructor
    MOV EDX,dword ptr [EAX]             ; 005ff6ac
    MOV dword ptr [EAX + 0x4c],0x665c70 ; 005ff6ae | void * g_IFStream_IStreamDestructor
    MOV EDX,dword ptr [EDX + 0x4]       ; 005ff6b5
    ADD ESP,0x8                         ; 005ff6b8
    MOV dword ptr [EDX + EAX*0x1 + 0x28],0x665c78 ; 005ff6bb | void * g_IFStream_IOSDestructor
    RET                                 ; 005ff6c3
    MOV dword ptr [EAX],0x665c54        ; 005ff6c4 | WatcomVirtualBaseDescriptor g_IFStream_LayoutInfo
        ;   Label: LAB_005ff6c4
    ADD EAX,0x54                        ; 005ff6ca
    PUSH EAX                            ; 005ff6cd
    MOV dword ptr [EAX + -0x10],0x665c5c ; 005ff6ce | WatcomVirtualBaseDescriptor g_IFStream_IStreamSubobjectLayout
    CALL crt_iostream.cpp_ios_ctor_FUN_006061fc ; 005ff6d5 | ios * crt_iostream.cpp_ios_ctor_FUN_006061fc(ios * this_ptr)
        ;   XREF to: 006061fc (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005ff6da
    SUB EAX,0x54                        ; 005ff6dd
    JMP 0x005ff66f                      ; 005ff6e0 | LAB_005ff66f
