...
section .text
    ...
    CALL crt_fstream.cpp_filebuf_dtor_FUN_0060bdf9 ; 0060653a
        ;   XREF to: 0060bdf9 (UNCONDITIONAL_CALL)  ; filebuf * crt_fstream.cpp_filebuf_dtor_FUN_0060bdf9(filebuf * this_ptr, uint flags)
    ...
    PUSH 0x665f10                       ; 00606559 | g_FStreamBaseTypeInfo
        ;   Label: LAB_00606559
    PUSH EBX                            ; 0060655e
    CALL crt_memory.c___vec_delete_FUN_005fe632 ; 0060655f
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void crt_memory.c___vec_delete_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 00606564
    PUSH EAX                            ; 00606567
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 00606568
    ...
    PUSH EBX                            ; 00606587
        ;   Label: LAB_00606587
    CALL shape_memdbg.cpp_debugFreeChecked_FUN_0050f210 ; 00606588
