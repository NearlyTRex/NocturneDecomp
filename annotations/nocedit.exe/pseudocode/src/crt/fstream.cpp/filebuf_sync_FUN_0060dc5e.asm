...
;                               FUNCTION
; *****************************************************************************
; __watcallStack int crt_fstream.cpp_filebuf_sync_FUN_0060dc5e(filebuf * this_ptr)
;
; Parameters:
...
section .text
    ...
    JNZ 0x0060dca1                      ; 0060dc6b | LAB_0060dca1
    ...
    JZ 0x0060dcb2                       ; 0060dc75 | LAB_0060dcb2
        ;   XREF to: 0060dcb2 (CONDITIONAL_JUMP)
    TEST byte ptr [EBX + 0x30],0x80     ; 0060dc77
    JZ 0x0060dcb7                       ; 0060dc7b | LAB_0060dcb7
    ...
    JMP 0x0060dc88                      ; 0060dc9f | LAB_0060dc88
    ...
    JZ 0x0060dcb4                       ; 0060dcb0 | LAB_0060dcb4
    ...
    PUSH EAX                            ; 0060dcc6
    CALL crt_stdio.c_lseek_FUN_00606690 ; 0060dcc7 | int crt_stdio.c_lseek_FUN_00606690(int file_handle_index, long distance_to_move, int move_method)
        ;   XREF to: 00606690 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0060dccc
    TEST EAX,EAX                        ; 0060dccf
    JL 0x0060dced                       ; 0060dcd1 | LAB_0060dced
