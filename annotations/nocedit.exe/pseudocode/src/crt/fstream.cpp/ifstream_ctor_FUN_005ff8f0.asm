...
;                               FUNCTION
; *****************************************************************************
; __cdecl ifstream * crt_fstream.cpp_ifstream_ctor_FUN_005ff8f0(ifstream * this_ptr, int c1)
;
; Parameters:
...
section .text
    ...
    JZ 0x005ff93e                       ; 005ff8f9 | LAB_005ff93e
        ;   XREF to: 005ff93e (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 005ff8fb
        ;   Label: LAB_005ff8fb
    PUSH EAX                            ; 005ff8fd
    CALL crt_fstream.cpp_fstreambase_ctor_FUN_0060658f ; 005ff8fe | fstreambase * crt_fstream.cpp_fstreambase_ctor_FUN_0060658f(fstreambase * this_ptr, uint c1)
        ;   XREF to: 0060658f (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005ff903
    PUSH 0x1                            ; 005ff906
    ADD EAX,0x44                        ; 005ff908
    PUSH EAX                            ; 005ff90b
    CALL crt_iostream.cpp_istream_ctor_FUN_00606376 ; 005ff90c | istream * crt_iostream.cpp_istream_ctor_FUN_00606376(istream * this_ptr, uint c1)
    ...
    MOV dword ptr [EAX + 0x40],0x665c68 ; 005ff91f | void * g_IFStream_FStreamBaseDestructor
    MOV EDX,dword ptr [EAX]             ; 005ff926
    MOV dword ptr [EAX + 0x4c],0x665c70 ; 005ff928 | void * g_IFStream_IStreamDestructor
    MOV EDX,dword ptr [EDX + 0x4]       ; 005ff92f
    ADD ESP,0x8                         ; 005ff932
    MOV dword ptr [EDX + EAX*0x1 + 0x28],0x665c78 ; 005ff935 | void * g_IFStream_IOSDestructor
    RET                                 ; 005ff93d
    MOV dword ptr [EAX],0x665c54        ; 005ff93e | WatcomVirtualBaseDescriptor g_IFStream_LayoutInfo
        ;   Label: LAB_005ff93e
    ADD EAX,0x54                        ; 005ff944
    PUSH EAX                            ; 005ff947
    MOV dword ptr [EAX + -0x10],0x665c5c ; 005ff948 | WatcomVirtualBaseDescriptor g_IFStream_IStreamSubobjectLayout
    CALL crt_iostream.cpp_ios_ctor_FUN_006061fc ; 005ff94f | ios * crt_iostream.cpp_ios_ctor_FUN_006061fc(ios * this_ptr)
        ;   XREF to: 006061fc (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005ff954
    SUB EAX,0x54                        ; 005ff957
    JMP 0x005ff8fb                      ; 005ff95a | LAB_005ff8fb
