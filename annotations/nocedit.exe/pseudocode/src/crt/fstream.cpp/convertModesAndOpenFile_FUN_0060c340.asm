...
;                               FUNCTION
; *****************************************************************************
; __cdecl int crt_fstream.cpp_convertModesAndOpenFile_FUN_0060c340(char * filename, int * iostream_mode, int permissions)
;
; Parameters:
...
section .text
    ...
    TEST AL,0x40                        ; 0060c3a0
        ;   Label: LAB_0060c3a0
    JZ 0x0060c3cc                       ; 0060c3a2 | LAB_0060c3cc
        ;   XREF to: 0060c3cc (CONDITIONAL_JUMP)
    MOV EAX,EBX                         ; 0060c3a4
    OR AL,0x20                          ; 0060c3a6
    TEST EAX,EAX                        ; 0060c3a8
    JZ 0x0060c3cc                       ; 0060c3aa | LAB_0060c3cc
        ;   XREF to: 0060c3cc (CONDITIONAL_JUMP)
    MOV EAX,ESP                         ; 0060c3ac
    PUSH EAX                            ; 0060c3ae
    MOV EDX,dword ptr [ESP + 0x58]      ; 0060c3af
    PUSH EDX                            ; 0060c3b3
    CALL crt_io.c_stat_FUN_00607e64     ; 0060c3b4 | int crt_io.c_stat_FUN_00607e64(char * filename, stat * file_info)
        ;   XREF to: 00607e64 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0060c3b9
    CMP EAX,-0x1                        ; 0060c3bc
    JZ 0x0060c3cc                       ; 0060c3bf | LAB_0060c3cc
        ;   XREF to: 0060c3cc (CONDITIONAL_JUMP)
    ...
    JC 0x0060c3f2                       ; 0060c3dc | LAB_0060c3f2
        ;   XREF to: 0060c3f2 (CONDITIONAL_JUMP)
    JBE 0x0060c400                      ; 0060c3de | LAB_0060c400
        ;   XREF to: 0060c400 (CONDITIONAL_JUMP)
    CMP EAX,0x3000                      ; 0060c3e0
    JC 0x0060c413                       ; 0060c3e5 | LAB_0060c413
        ;   XREF to: 0060c413 (CONDITIONAL_JUMP)
    JBE 0x0060c407                      ; 0060c3e7 | LAB_0060c407
        ;   XREF to: 0060c407 (CONDITIONAL_JUMP)
    CMP EAX,0x4000                      ; 0060c3e9
    JZ 0x0060c40e                       ; 0060c3ee | LAB_0060c40e
        ;   XREF to: 0060c40e (CONDITIONAL_JUMP)
    JMP 0x0060c413                      ; 0060c3f0 | LAB_0060c413
        ;   XREF to: 0060c413 (UNCONDITIONAL_JUMP)
    CMP EAX,0x1000                      ; 0060c3f2
        ;   Label: LAB_0060c3f2
    JNZ 0x0060c413                      ; 0060c3f7 | LAB_0060c413
        ;   XREF to: 0060c413 (CONDITIONAL_JUMP)
    MOV EDX,0x20                        ; 0060c3f9
    JMP 0x0060c413                      ; 0060c3fe | LAB_0060c413
        ;   XREF to: 0060c413 (UNCONDITIONAL_JUMP)
    MOV EDX,0x30                        ; 0060c400
        ;   Label: LAB_0060c400
    JMP 0x0060c413                      ; 0060c405 | LAB_0060c413
        ;   XREF to: 0060c413 (UNCONDITIONAL_JUMP)
    MOV EDX,0x40                        ; 0060c407
        ;   Label: LAB_0060c407
    JMP 0x0060c413                      ; 0060c40c | LAB_0060c413
        ;   XREF to: 0060c413 (UNCONDITIONAL_JUMP)
    ...
    PUSH ESI                            ; 0060c423
    CALL crt_stdio.c_CreateFileVariadic_FUN_00609074 ; 0060c424 | int crt_stdio.c_CreateFileVariadic_FUN_00609074(char * filename, int access_mode, int share_mode)
