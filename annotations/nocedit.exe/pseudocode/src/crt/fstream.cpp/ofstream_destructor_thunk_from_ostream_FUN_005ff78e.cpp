...
// Convention: __cdecl
// Signature: void __cdecl crt_fstream_cpp_ofstream_destructor_thunk_from_ostream_FUN_005ff78e(_ostream *this_ptr,int dtor_flags)
...
{
  crt_fstream_cpp_ofstream_dtor_FUN_005ff7bc(&this_ptr[-2]._ios.__fill_character,dtor_flags);
  return;
}
