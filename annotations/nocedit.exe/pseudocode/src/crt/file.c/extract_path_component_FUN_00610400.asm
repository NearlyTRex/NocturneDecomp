...
;                               FUNCTION
; *****************************************************************************
; __cdecl char * crt_file.c_extract_path_component_FUN_00610400(char * * component_ptr, char * buffer, char * source, char * buffer_end)
;
; Parameters:
...
section .text
    ...
    JZ 0x0061045a                       ; 00610411 | LAB_0061045a
    ...
    JC 0x00610428                       ; 00610421 | LAB_00610428
        ;   XREF to: 00610428 (CONDITIONAL_JUMP)
    MOV ESI,0x106                       ; 00610423
    PUSH ESI                            ; 00610428
        ;   Label: LAB_00610428
    PUSH EDI                            ; 00610429
    CALL crt_string.c_mbstrnlen_FUN_00605e50 ; 0061042a | int crt_string.c_mbstrnlen_FUN_00605e50(char * str, int max_bytes)
    ...
    CALL crt_string.c_mbstrncpy_FUN_00605e90 ; 00610437 | char * crt_string.c_mbstrncpy_FUN_00605e90(char * dest, char * src, int char_count)
        ;   XREF to: 00605e90 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0061043c
    PUSH ESI                            ; 0061043f
    PUSH EBX                            ; 00610440
    CALL crt_string.c_mbstrnbytes_FUN_00605ec0 ; 00610441 | int crt_string.c_mbstrnbytes_FUN_00605ec0(char * str, int char_count)
        ;   XREF to: 00605ec0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00610446
    PUSH ESI                            ; 00610449
    PUSH EBX                            ; 0061044a
    MOV byte ptr [EBX + EAX*0x1],0x0    ; 0061044b
    CALL crt_string.c_mbstrnbytes_FUN_00605ec0 ; 0061044f | int crt_string.c_mbstrnbytes_FUN_00605ec0(char * str, int char_count)
        ;   XREF to: 00605ec0 (UNCONDITIONAL_CALL)
