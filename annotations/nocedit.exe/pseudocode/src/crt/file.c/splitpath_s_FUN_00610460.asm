...
section .text
    ...
    PUSH EDI                            ; 006104bc
    PUSH ESI                            ; 006104bd
    CALL crt_file.c_extract_path_component_FUN_00610400 ; 006104be | char * crt_file.c_extract_path_component_FUN_00610400(char * * component_ptr, char * buffer, char * source, char * buffer_end)
        ;   XREF to: 00610400 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 006104c3
    MOV dword ptr [ESP + 0x1c],EAX      ; 006104c6
    JMP 0x00610511                      ; 006104ca | LAB_00610511
        ;   XREF to: 00610511 (UNCONDITIONAL_JUMP)
    CMP byte ptr [EBX],0x0              ; 006104cc
        ;   Label: LAB_006104cc
    JZ 0x006104fd                       ; 006104cf | LAB_006104fd
        ;   XREF to: 006104fd (CONDITIONAL_JUMP)
    CMP byte ptr [EBX + 0x1],0x3a       ; 006104d1
    JNZ 0x006104fd                      ; 006104d5 | LAB_006104fd
        ;   XREF to: 006104fd (CONDITIONAL_JUMP)
    TEST ESI,ESI                        ; 006104d7
    JZ 0x006104f8                       ; 006104d9 | LAB_006104f8
    ...
    ADD EBX,0x2                         ; 006104f8
        ;   Label: LAB_006104f8
    JMP 0x00610511                      ; 006104fb | LAB_00610511
        ;   XREF to: 00610511 (UNCONDITIONAL_JUMP)
    TEST ESI,ESI                        ; 006104fd
        ;   Label: LAB_006104fd
    JZ 0x00610511                       ; 006104ff | LAB_00610511
    ...
    PUSH EBX                            ; 00610518
        ;   Label: LAB_00610518
    CALL crt_string.c_mbtowc_peek_FUN_006059e0 ; 00610519 | wchar_t crt_string.c_mbtowc_peek_FUN_006059e0(char * str)
        ;   XREF to: 006059e0 (UNCONDITIONAL_CALL)
    MOV ESI,EAX                         ; 0061051e
    ADD ESP,0x4                         ; 00610520
    TEST EAX,EAX                        ; 00610523
    JZ 0x0061054a                       ; 00610525 | LAB_0061054a
        ;   XREF to: 0061054a (CONDITIONAL_JUMP)
    CMP EAX,0x2e                        ; 00610527
    JNZ 0x00610531                      ; 0061052a | LAB_00610531
        ;   XREF to: 00610531 (CONDITIONAL_JUMP)
    MOV EDI,EBX                         ; 0061052c
    INC EBX                             ; 0061052e
    JMP 0x00610518                      ; 0061052f | LAB_00610518
        ;   XREF to: 00610518 (UNCONDITIONAL_JUMP)
    PUSH EBX                            ; 00610531
        ;   Label: LAB_00610531
    CALL crt_string.c_mbtowc_next_FUN_00605a70 ; 00610532 | char * crt_string.c_mbtowc_next_FUN_00605a70(char * str)
        ;   XREF to: 00605a70 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00610537
    MOV EBX,EAX                         ; 0061053a
    CMP ESI,0x5c                        ; 0061053c
    JZ 0x00610546                       ; 0061053f | LAB_00610546
        ;   XREF to: 00610546 (CONDITIONAL_JUMP)
    CMP ESI,0x2f                        ; 00610541
    JNZ 0x00610518                      ; 00610544 | LAB_00610518
        ;   XREF to: 00610518 (CONDITIONAL_JUMP)
    MOV EBP,EBX                         ; 00610546
        ;   Label: LAB_00610546
    JMP 0x00610516                      ; 00610548 | LAB_00610516
    ...
    PUSH ECX                            ; 00610559
    CALL crt_file.c_extract_path_component_FUN_00610400 ; 0061055a | char * crt_file.c_extract_path_component_FUN_00610400(char * * component_ptr, char * buffer, char * source, char * buffer_end)
        ;   XREF to: 00610400 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0061055f
    MOV dword ptr [ESP + 0x1c],EAX      ; 00610562
    TEST EDI,EDI                        ; 00610566
    JNZ 0x0061056c                      ; 00610568 | LAB_0061056c
    ...
    PUSH EBP                            ; 00610577
    CALL crt_file.c_extract_path_component_FUN_00610400 ; 00610578 | char * crt_file.c_extract_path_component_FUN_00610400(char * * component_ptr, char * buffer, char * source, char * buffer_end)
        ;   XREF to: 00610400 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00610587
    CALL crt_file.c_extract_path_component_FUN_00610400 ; 00610588 | char * crt_file.c_extract_path_component_FUN_00610400(char * * component_ptr, char * buffer, char * source, char * buffer_end)
        ;   XREF to: 00610400 (UNCONDITIONAL_CALL)
