...
;                               FUNCTION
; *****************************************************************************
; __cdecl DWORD __cdecl crt_file_c_setReadonlyAttribute_FUN_00600c30(char *filename,DWORD file_attributes)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 00600c35
    CALL crt_file.c_get_file_attributes_FUN_006082e0 ; 00600c36
        ;   XREF to: 006082e0 (UNCONDITIONAL_CALL)  ; DWORD crt_file.c_get_file_attributes_FUN_006082e0(char * filename)
    ADD ESP,0x4                         ; 00600c3b
    CMP EAX,-0x1                        ; 00600c3e
    JNZ 0x00600c4a                      ; 00600c41
        ;   XREF to: 00600c4a (CONDITIONAL_JUMP)  ; LAB_00600c4a
    CALL crt_errno.c_getLastErrorAndSetErrno_FUN_006083fc ; 00600c43
    ...
    CALL crt_errno.c_getLastErrorAndSetErrno_FUN_006083fc ; 00600c68
        ;   XREF to: 006083fc (UNCONDITIONAL_CALL)  ; DWORD crt_errno.c_getLastErrorAndSetErrno_FUN_006083fc()
    POP EBX                             ; 00600c6d
    RET                                 ; 00600c6e
