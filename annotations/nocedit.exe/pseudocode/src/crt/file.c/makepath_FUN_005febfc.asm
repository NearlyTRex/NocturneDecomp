...
;   core_msnedit.cpp_CheckWorldMountedAndSave_FUN_0053d190 at 0053d1dd
...
section .text
    ...
    CMP AL,0x0                          ; 005fec35
    JZ 0x005fec49                       ; 005fec37 | LAB_005fec49
    ...
    CMP AL,0x0                          ; 005fec45
    JNZ 0x005fec31                      ; 005fec47 | LAB_005fec31
    ...
    JMP 0x005fec6a                      ; 005fec5e | LAB_005fec6a
    ...
    JZ 0x005fed01                       ; 005fec73 | LAB_005fed01
        ;   XREF to: 005fed01 (CONDITIONAL_JUMP)
    CMP byte ptr [ESI],0x0              ; 005fec79
    JZ 0x005fed01                       ; 005fec7c | LAB_005fed01
        ;   XREF to: 005fed01 (CONDITIONAL_JUMP)
    ...
    PUSH EDI                            ; 005fec89
    CALL crt_string.c_mbtowc_peek_FUN_006059e0 ; 005fec8a | wchar_t crt_string.c_mbtowc_peek_FUN_006059e0(char * str)
        ;   XREF to: 006059e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005fec8f
    PUSH EAX                            ; 005fec92
    CALL crt_file.c_normalize_path_separator_FUN_005febe0 ; 005fec93 | wchar_t crt_file.c_normalize_path_separator_FUN_005febe0(wchar_t ch, wchar_t * preferred_separator)
        ;   XREF to: 005febe0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005fec98
    PUSH EBX                            ; 005fec9b
    PUSH EAX                            ; 005fec9c
    CALL crt_locale.c_wchar_to_bytes_FUN_00605a20 ; 005fec9d | void crt_locale.c_wchar_to_bytes_FUN_00605a20(wchar_t character, char * output_buffer)
        ;   XREF to: 00605a20 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005feca2
    PUSH EBX                            ; 005feca5
    CALL crt_locale.c_mblen_FUN_00605a40 ; 005feca6 | int crt_locale.c_mblen_FUN_00605a40(char * mb_string)
        ;   XREF to: 00605a40 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005fecab
    PUSH EBX                            ; 005fecae
    MOV byte ptr [EBX + EAX*0x1],0x0    ; 005fecaf
    CALL crt_string.c_mbtowc_next_FUN_00605a70 ; 005fecb3 | char * crt_string.c_mbtowc_next_FUN_00605a70(char * str)
        ;   XREF to: 00605a70 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005fecb8
    PUSH EDI                            ; 005fecbb
    MOV EBX,EAX                         ; 005fecbc
    CALL crt_string.c_mbtowc_next_FUN_00605a70 ; 005fecbe | char * crt_string.c_mbtowc_next_FUN_00605a70(char * str)
        ;   XREF to: 00605a70 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005fecc3
    MOV DH,byte ptr [EAX]               ; 005fecc6
    MOV dword ptr [ESP + 0x24],EAX      ; 005fecc8
    TEST DH,DH                          ; 005feccc
    JNZ 0x005fec82                      ; 005fecce | LAB_005fec82
        ;   XREF to: 005fec82 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP],0x0             ; 005fecd0
    JNZ 0x005fecdd                      ; 005fecd4 | LAB_005fecdd
    ...
    PUSH ESI                            ; 005fece2
    CALL crt_string.c_mb_get_last_char_FUN_00605aa0 ; 005fece3 | char * crt_string.c_mb_get_last_char_FUN_00605aa0(char * start, char * end)
    ...
    JNZ 0x005fecfc                      ; 005fecf7 | LAB_005fecfc
        ;   XREF to: 005fecfc (CONDITIONAL_JUMP)
    DEC EBX                             ; 005fecf9
    JMP 0x005fed01                      ; 005fecfa | LAB_005fed01
    ...
    CMP dword ptr [ESP],0x0             ; 005fed01
        ;   Label: LAB_005fed01
    JNZ 0x005fed0e                      ; 005fed05 | LAB_005fed0e
    ...
    JZ 0x005fed96                       ; 005fed17 | LAB_005fed96
        ;   XREF to: 005fed96 (CONDITIONAL_JUMP)
    PUSH ECX                            ; 005fed1d
    CALL crt_string.c_mbtowc_peek_FUN_006059e0 ; 005fed1e | wchar_t crt_string.c_mbtowc_peek_FUN_006059e0(char * str)
        ;   XREF to: 006059e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005fed23
    MOV EDX,ESP                         ; 005fed26
    PUSH EDX                            ; 005fed28
    PUSH EAX                            ; 005fed29
    CALL crt_file.c_normalize_path_separator_FUN_005febe0 ; 005fed2a | wchar_t crt_file.c_normalize_path_separator_FUN_005febe0(wchar_t ch, wchar_t * preferred_separator)
        ;   XREF to: 005febe0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005fed2f
    MOV EDX,dword ptr [ESP]             ; 005fed32
    CMP EAX,EDX                         ; 005fed35
    JZ 0x005fed43                       ; 005fed37 | LAB_005fed43
        ;   XREF to: 005fed43 (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 005fed39
    MOV AL,byte ptr [EBX]               ; 005fed3b
    CMP EAX,EDX                         ; 005fed3d
    JNZ 0x005fed43                      ; 005fed3f | LAB_005fed43
        ;   XREF to: 005fed43 (CONDITIONAL_JUMP)
    MOV EBX,ESI                         ; 005fed41
    MOV EAX,dword ptr [ESP + 0x28]      ; 005fed43
        ;   Label: LAB_005fed43
    CMP byte ptr [EAX],0x0              ; 005fed47
    JZ 0x005feda3                       ; 005fed4a | LAB_005feda3
        ;   XREF to: 005feda3 (CONDITIONAL_JUMP)
    MOV EAX,ESP                         ; 005fed4c
    PUSH EAX                            ; 005fed4e
    MOV ESI,dword ptr [ESP + 0x2c]      ; 005fed4f
    PUSH ESI                            ; 005fed53
    CALL crt_string.c_mbtowc_peek_FUN_006059e0 ; 005fed54 | wchar_t crt_string.c_mbtowc_peek_FUN_006059e0(char * str)
        ;   XREF to: 006059e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005fed59
    PUSH EAX                            ; 005fed5c
    CALL crt_file.c_normalize_path_separator_FUN_005febe0 ; 005fed5d | wchar_t crt_file.c_normalize_path_separator_FUN_005febe0(wchar_t ch, wchar_t * preferred_separator)
        ;   XREF to: 005febe0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005fed62
    PUSH EBX                            ; 005fed65
    PUSH EAX                            ; 005fed66
    CALL crt_locale.c_wchar_to_bytes_FUN_00605a20 ; 005fed67 | void crt_locale.c_wchar_to_bytes_FUN_00605a20(wchar_t character, char * output_buffer)
        ;   XREF to: 00605a20 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005fed6c
    PUSH EBX                            ; 005fed6f
    CALL crt_locale.c_mblen_FUN_00605a40 ; 005fed70 | int crt_locale.c_mblen_FUN_00605a40(char * mb_string)
        ;   XREF to: 00605a40 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005fed75
    PUSH EBX                            ; 005fed78
    MOV byte ptr [EBX + EAX*0x1],0x0    ; 005fed79
    CALL crt_string.c_mbtowc_next_FUN_00605a70 ; 005fed7d | char * crt_string.c_mbtowc_next_FUN_00605a70(char * str)
        ;   XREF to: 00605a70 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005fed82
    PUSH ESI                            ; 005fed85
    MOV EBX,EAX                         ; 005fed86
    CALL crt_string.c_mbtowc_next_FUN_00605a70 ; 005fed88 | char * crt_string.c_mbtowc_next_FUN_00605a70(char * str)
        ;   XREF to: 00605a70 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005fed8d
    MOV dword ptr [ESP + 0x28],EAX      ; 005fed90
    JMP 0x005fed43                      ; 005fed94 | LAB_005fed43
    ...
    JNZ 0x005feda3                      ; 005fed9f | LAB_005feda3
        ;   XREF to: 005feda3 (CONDITIONAL_JUMP)
    MOV EBX,ESI                         ; 005feda1
    TEST EBP,EBP                        ; 005feda3
        ;   Label: LAB_005feda3
    JZ 0x005fedc5                       ; 005feda5 | LAB_005fedc5
        ;   XREF to: 005fedc5 (CONDITIONAL_JUMP)
    MOV CH,byte ptr [EBP]               ; 005feda7
    TEST CH,CH                          ; 005fedaa
    JZ 0x005fedc5                       ; 005fedac | LAB_005fedc5
        ;   XREF to: 005fedc5 (CONDITIONAL_JUMP)
    CMP CH,0x2e                         ; 005fedae
    JZ 0x005fedb7                       ; 005fedb1 | LAB_005fedb7
    ...
    MOV AH,byte ptr [EBP]               ; 005fedb7
        ;   Label: LAB_005fedb7
    TEST AH,AH                          ; 005fedba
    JZ 0x005fedc5                       ; 005fedbc | LAB_005fedc5
        ;   XREF to: 005fedc5 (CONDITIONAL_JUMP)
    INC EBX                             ; 005fedbe
    INC EBP                             ; 005fedbf
    MOV byte ptr [EBX + -0x1],AH        ; 005fedc0
    JMP 0x005fedb7                      ; 005fedc3 | LAB_005fedb7
