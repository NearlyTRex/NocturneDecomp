...
;                               FUNCTION
; *****************************************************************************
; __watcallRegister LPVOID crt_tls.c_create_thread_local_data_FUN_0060cac0(void)
;
;
; XREF[1]:
...
section .text
    ...
    PUSH EBX                            ; 0060cac3
    CALL crt_tls.c_initialize_thread_tls_data_FUN_0060a2d8 ; 0060cac4 | BOOL crt_tls.c_initialize_thread_tls_data_FUN_0060a2d8(void * init_param)
        ;   XREF to: 0060a2d8 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060cac9
    TEST EAX,EAX                        ; 0060cacc
    JZ 0x0060cae0                       ; 0060cace | LAB_0060cae0
        ;   XREF to: 0060cae0 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x00684ee0]      ; 0060cad0 | DWORD g_TLSIndex
    PUSH EDX                            ; 0060cad6
    CALL dword ptr CS:[0x611654]        ; 0060cad7 | TlsGetValue * PTR_TlsGetValue_00611654
    MOV EBX,EAX                         ; 0060cade
    TEST EBX,EBX                        ; 0060cae0
        ;   Label: LAB_0060cae0
    JNZ 0x0060caf3                      ; 0060cae2 | LAB_0060caf3
        ;   XREF to: 0060caf3 (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 0060cae4
    PUSH 0x659620                       ; 0060cae6 | = "Thread has no thread-specific data\r\n" | s_Thread_has_no_thread_spe_00659620 = Thread has no thread-specific data

    CALL crt_startup.c_HandleRuntimeError_FUN_00606660 ; 0060caeb | void crt_startup.c_HandleRuntimeError_FUN_00606660(char * error_message, int error_level)
