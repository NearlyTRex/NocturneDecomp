...
;                               FUNCTION
; *****************************************************************************
; __cdecl void crt_tls.c_enter_critical_section_by_index_FUN_0060a10c(int sectionIndex)
;
; Parameters:
...
section .text
    ...
    ADD EAX,0x3f9b8c0                   ; 0060a116 | void * g_TlsDataBase
    PUSH EAX                            ; 0060a11b
    CALL crt_sync.c_enter_reentrant_critical_section_FUN_0060a060 ; 0060a11c | void crt_sync.c_enter_reentrant_critical_section_FUN_0060a060(ReentrantCriticalSection * rcs)
