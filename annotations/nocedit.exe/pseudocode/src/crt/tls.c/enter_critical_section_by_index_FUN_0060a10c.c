...
// Convention: __cdecl
// Signature: void __cdecl crt_tls_c_enter_critical_section_by_index_FUN_0060a10c(int sectionIndex)

#include "nocturne.h"

void __cdecl enter_critical_section_by_index(int sectionIndex)
