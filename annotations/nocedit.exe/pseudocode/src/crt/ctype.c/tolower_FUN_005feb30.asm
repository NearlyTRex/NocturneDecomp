...
;                               FUNCTION
; *****************************************************************************
; __cdecl int crt_ctype.c_tolower_FUN_005feb30(int character)
;
; Parameters:
...
;   crt_io.c_stat_FUN_00607e64 at 00607fd1
...
section .text
    ...
    JL 0x005feb41                       ; 005feb37 | LAB_005feb41
        ;   XREF to: 005feb41 (CONDITIONAL_JUMP)
    CMP EAX,0x5a                        ; 005feb39
    JG 0x005feb41                       ; 005feb3c | LAB_005feb41
        ;   XREF to: 005feb41 (CONDITIONAL_JUMP)
