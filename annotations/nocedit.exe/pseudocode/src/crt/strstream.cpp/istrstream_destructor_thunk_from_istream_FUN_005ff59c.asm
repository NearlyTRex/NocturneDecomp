...
;                               FUNCTION
; *****************************************************************************
; __cdecl void crt_strstream.cpp_istrstream_destructor_thunk_from_istream_FUN_005ff59c(istream * this_ptr, int dtor_flags)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 005ff5a8
    CALL crt_strstream.cpp_istrstream_dtor_FUN_005ff5ca ; 005ff5a9 | istrstream * crt_strstream.cpp_istrstream_dtor_FUN_005ff5ca(istrstream * this_ptr, int d1)
