...
// Convention: __cdecl
// Signature: void __cdecl crt_strstream_cpp_istrstream_destructor_thunk_from_istream_FUN_005ff59c(_istream *this_ptr,int dtor_flags)
...
{
  crt_strstream_cpp_istrstream_dtor_FUN_005ff5ca(&this_ptr[-2]._ios.__fill_character,dtor_flags);
  return;
}
