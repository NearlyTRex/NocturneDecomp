...
section .text
    ...
    PUSH EDX                            ; 0060bbfd
    CALL crt_iostream.cpp_streambuf_constructor_FUN_0060b7c2 ; 0060bbfe | streambuf * crt_iostream.cpp_streambuf_constructor_FUN_0060b7c2(streambuf * this_ptr)
    ...
    MOV dword ptr [EAX + 0x28],0x665d34 ; 0060bc0f | strstreambuf_vtable g_StrstreambufVTable
    CALL crt_strstream.cpp_strstreambuf_init_FUN_0060b815 ; 0060bc16 | void crt_strstream.cpp_strstreambuf_init_FUN_0060b815(strstreambuf * this_ptr, char * buffer_ptr, int buffer_size, char * put_start)
