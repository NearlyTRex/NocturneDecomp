...
;                               FUNCTION
; *****************************************************************************
; __cdecl istrstream * __cdecl crt_strstream_cpp_istrstream_dtor_FUN_005ff5ca(istrstream *this_ptr,int d1)
;
; Parameters:
...
section .text
    ...
    PUSH 0x65bc90                       ; 005ff62e | g_IStrStreamTypeInfo
        ;   Label: LAB_005ff62e
    PUSH EBX                            ; 005ff633
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 005ff634
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 005ff639
    PUSH EAX                            ; 005ff63c
    CALL crt_memory.c_free_FUN_005fe659 ; 005ff63d
    ...
    PUSH EBX                            ; 005ff65c
        ;   Label: LAB_005ff65c
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 005ff65d
