...
;                               FUNCTION
; *****************************************************************************
; __cdecl ostrstream * crt_strstream.cpp_ostrstream_dtor_FUN_005ff48a(ostrstream * this_ptr, int d1)
;
; Parameters:
...
section .text
    ...
    JNZ 0x005ff4ee                      ; 005ff494 | LAB_005ff4ee
    ...
    MOV dword ptr [EBX + 0x44],0x665b7c ; 005ff4a1 | void * PTR_FUN_00665b7c
    PUSH 0x1                            ; 005ff4a8
    MOV EAX,dword ptr [EBX]             ; 005ff4aa
    MOV dword ptr [EBX + 0x4c],0x665b84 ; 005ff4ac | void * PTR_LAB_00665b84
    ADD EBX,0x48                        ; 005ff4b3
    MOV EAX,dword ptr [EAX + 0x4]       ; 005ff4b6
    PUSH EBX                            ; 005ff4b9
    MOV dword ptr [EBX + EAX*0x1 + -0x20],0x665b8c ; 005ff4ba | void * PTR_FUN_00665b8c
    CALL crt_iostream.cpp_ostream_dtor_FUN_00606231 ; 005ff4c2 | ostream * crt_iostream.cpp_ostream_dtor_FUN_00606231(ostream * this_ptr, uint d1, uint d2)
        ;   XREF to: 00606231 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005ff4c7
    PUSH 0x1                            ; 005ff4ca
    LEA EBX,[EAX + -0x48]               ; 005ff4cc
    PUSH EBX                            ; 005ff4cf
    CALL crt_strstream.cpp_strstreambase_dtor_FUN_006062a6 ; 005ff4d0 | strstreambase * crt_strstream.cpp_strstreambase_dtor_FUN_006062a6(strstreambase * this_ptr, uint d1, uint d2, uint d3)
    ...
    JZ 0x005ff509                       ; 005ff4e1 | LAB_005ff509
        ;   XREF to: 005ff509 (CONDITIONAL_JUMP)
    TEST byte ptr [ESP + 0xc],0x2       ; 005ff4e3
        ;   Label: LAB_005ff4e3
    JNZ 0x005ff51c                      ; 005ff4e8 | LAB_005ff51c
        ;   XREF to: 005ff51c (CONDITIONAL_JUMP)
    MOV EAX,EBX                         ; 005ff4ea
    POP EBX                             ; 005ff4ec
    RET                                 ; 005ff4ed
    PUSH 0x65bc70                       ; 005ff4ee | WatcomTypeInfo g_OStrStreamTypeInfo
        ;   Label: LAB_005ff4ee
    PUSH EBX                            ; 005ff4f3
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 005ff4f4 | void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005ff4f9
    PUSH EAX                            ; 005ff4fc
    CALL crt_memory.c_free_FUN_005fe659 ; 005ff4fd | void crt_memory.c_free_FUN_005fe659(void * ptr)
    ...
    PUSH EAX                            ; 005ff50e
    CALL crt_iostream.cpp_ios_dtor_FUN_0060632c ; 005ff50f | ios * crt_iostream.cpp_ios_dtor_FUN_0060632c(ios * this_ptr, uint d1, uint d2)
        ;   XREF to: 0060632c (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005ff514
    LEA EBX,[EAX + -0x54]               ; 005ff517
    JMP 0x005ff4e3                      ; 005ff51a | LAB_005ff4e3
        ;   XREF to: 005ff4e3 (UNCONDITIONAL_JUMP)
    PUSH EBX                            ; 005ff51c
        ;   Label: LAB_005ff51c
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 005ff51d | void shape_memdbg.cpp_debugFree_FUN_0050f210(void * ptr)
        ;   XREF to: 0050f210 (UNCONDITIONAL_CALL)
    JMP 0x005ff502                      ; 005ff522 | LAB_005ff502
