...
;                               FUNCTION
; *****************************************************************************
; __cdecl void crt_strstream.cpp_ostrstream_destructor_thunk_from_ostream_FUN_005ff42f(ostream * this_ptr, int dtor_flags)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 005ff43b
    CALL crt_strstream.cpp_ostrstream_dtor_FUN_005ff48a ; 005ff43c | ostrstream * crt_strstream.cpp_ostrstream_dtor_FUN_005ff48a(ostrstream * this_ptr, int d1)
