...
// Convention: __cdecl
// Signature: _ostrstream * __cdecl crt_strstream_cpp_ostrstream_ctor_FUN_005ff384(void *this_ptr,int flags,char *buffer,int buffer_size,int mode)
...

{
  ...
  psVar5 = crt_strstream_cpp_strstreambase_ctor_FUN_006060fe(this_ptr,1,buffer,buffer_size,pcVar4);
  p_Var6 = crt_iostream_cpp_ostream_ctor_FUN_006061a2((_ostream *)&psVar5->_ios,1);
  ppvVar1 = &p_Var6[-2]._ios.__xalloc_list;
  *(int *)((int)ppvVar1 + *(int *)((int)*ppvVar1 + 4) + -4) = *(int *)((int)*ppvVar1 + 4);
  p_Var6[-1]._ios.cleanup_vtable = &PTR_FUN_00665b7c;
  pvVar3 = *ppvVar1;
  (p_Var6->_ostream_core).destructor_vtable = (WatcomThunkedDestructor *)&PTR_LAB_00665b84;
  *(void ***)((int)(&p_Var6->_ios + -1) + *(int *)((int)pvVar3 + 4)) = &PTR_FUN_00665b8c;
