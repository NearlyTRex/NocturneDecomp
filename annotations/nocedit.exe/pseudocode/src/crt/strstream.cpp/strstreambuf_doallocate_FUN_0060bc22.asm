...
;                               FUNCTION
; *****************************************************************************
; __watcallStack int __watcallStack crt_strstream_cpp_strstreambuf_doallocate_FUN_0060bc22(strstreambuf *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EDI                            ; 0060bc71
    CALL shape_memdbg.cpp_malloc_FUN_006021da ; 0060bc72
    ...
    PUSH ECX                            ; 0060bd14
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 0060bd15
