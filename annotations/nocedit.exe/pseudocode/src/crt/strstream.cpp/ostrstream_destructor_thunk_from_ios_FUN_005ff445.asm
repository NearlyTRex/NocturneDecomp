...
;                               FUNCTION
; *****************************************************************************
; __cdecl void crt_strstream.cpp_ostrstream_destructor_thunk_from_ios_FUN_005ff445(ios * this_ptr, int dtor_flags)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 005ff453
    CALL crt_strstream.cpp_ostrstream_dtor_FUN_005ff48a ; 005ff454 | ostrstream * crt_strstream.cpp_ostrstream_dtor_FUN_005ff48a(ostrstream * this_ptr, int d1)
