...
// Convention: __cdecl
// Signature: ostrstream * __cdecl crt_strstream_cpp_ostrstream_dtor_FUN_005ff48a(ostrstream *this_ptr,uint flags)
  ...
  if ((flags & 4) == 0) {
    ...
    *(void ***)((this_ptr->_ios).padding + pWVar2->offset_to_vbase + -0x49) = &PTR_FUN_00665b8c;
    poVar3 = crt_iostream_cpp_ostream_dtor_FUN_00606231
                       ((ostream *)&(this_ptr->_ostream_core).destructor_vtable,1);
    this_ptr = (ostrstream *)
               crt_strstream_cpp_strstreambase_dtor_FUN_006062a6
                         ((strstreambase *)&poVar3[-2]._ios.__xalloc_list,1);
    if ((flags & 1) == 0) {
      piVar4 = crt_iostream_cpp_ios_dtor_FUN_0060632c((ios *)&(this_ptr->_ios).__tied_stream,1);
