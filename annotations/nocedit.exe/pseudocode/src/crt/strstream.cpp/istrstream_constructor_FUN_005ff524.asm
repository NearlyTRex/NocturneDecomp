...
section .text
    ...
    JZ 0x005ff57e                       ; 005ff52d | LAB_005ff57e
    ...
    PUSH 0x1                            ; 005ff53b
    PUSH EAX                            ; 005ff53d
    CALL crt_strstream.cpp_strstreambase_constructor_FUN_006060fe ; 005ff53e | strstreambase * crt_strstream.cpp_strstreambase_constructor_FUN_006060fe(strstreambase * this_ptr, int ctor_flags, char * buffer, int size, ...)
        ;   XREF to: 006060fe (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 005ff543
    PUSH 0x1                            ; 005ff546
    ADD EAX,0x48                        ; 005ff548
    PUSH EAX                            ; 005ff54b
    CALL crt_iostream.cpp_istream_ctor_FUN_00606376 ; 005ff54c | istream * crt_iostream.cpp_istream_ctor_FUN_00606376(istream * this_ptr, uint c1)
    ...
    MOV dword ptr [EAX + 0x44],0x665bf4 ; 005ff55f | WatcomThunkedDestructor PTR_FUN_00665bf4
    MOV EDX,dword ptr [EAX]             ; 005ff566
    MOV dword ptr [EAX + 0x50],0x665bfc ; 005ff568 | WatcomThunkedDestructor PTR_FUN_00665bfc
    MOV EDX,dword ptr [EDX + 0x4]       ; 005ff56f
    ADD ESP,0x8                         ; 005ff572
    MOV dword ptr [EDX + EAX*0x1 + 0x28],0x665c04 ; 005ff575 | WatcomThunkedDestructorDirect PTR_FUN_00665c04
    RET                                 ; 005ff57d
    MOV dword ptr [EAX],0x665be0        ; 005ff57e | WatcomVirtualBaseDescriptor g_IstrstreamLayoutInfo
        ;   Label: LAB_005ff57e
    ADD EAX,0x58                        ; 005ff584
    PUSH EAX                            ; 005ff587
    MOV dword ptr [EAX + -0x10],0x665be8 ; 005ff588 | int g_Istrstream_IstreamLastReadLength
    CALL crt_iostream.cpp_ios_ctor_FUN_006061fc ; 005ff58f | ios * crt_iostream.cpp_ios_ctor_FUN_006061fc(ios * this_ptr)
        ;   XREF to: 006061fc (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005ff594
    SUB EAX,0x58                        ; 005ff597
    JMP 0x005ff52f                      ; 005ff59a | LAB_005ff52f
