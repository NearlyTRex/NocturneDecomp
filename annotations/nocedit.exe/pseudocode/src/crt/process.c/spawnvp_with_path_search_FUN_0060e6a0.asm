...
;                               FUNCTION
; *****************************************************************************
; __cdecl int crt_process.c_spawnvp_with_path_search_FUN_0060e6a0(int mode, char * program, char * * argv)
;
; Parameters:
...
section .text
    ...
    CALL crt_stack.c_stack_probe_FUN_005ff9f3 ; 0060e6a5 | uint crt_stack.c_stack_probe_FUN_005ff9f3(uint stack_size)
    ...
    PUSH ECX                            ; 0060e6d3
    CALL crt_process.c_spawnvp_FUN_0060f39c ; 0060e6d4 | int crt_process.c_spawnvp_FUN_0060f39c(int mode, char * cmdname, char * * argv)
        ;   XREF to: 0060f39c (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0060e6d9
    MOV EDI,EAX                         ; 0060e6dc
    CMP EAX,-0x1                        ; 0060e6de
    JNZ 0x0060e83b                      ; 0060e6e1 | LAB_0060e83b
        ;   XREF to: 0060e83b (CONDITIONAL_JUMP)
    CALL dword ptr [0x00684ee4]         ; 0060e6e7 | GET_TLS_FUNC * PTR_crt_thread.c_GetTLS_FUN_0060242c_00684ee4
    CMP dword ptr [EAX + 0x4],0x1       ; 0060e6ed
    JZ 0x0060e703                       ; 0060e6f1 | LAB_0060e703
        ;   XREF to: 0060e703 (CONDITIONAL_JUMP)
    CALL dword ptr [0x00684ee4]         ; 0060e6f3 | GET_TLS_FUNC * PTR_crt_thread.c_GetTLS_FUN_0060242c_00684ee4
    CMP dword ptr [EAX + 0x4],0x9       ; 0060e6f9
    JNZ 0x0060e83b                      ; 0060e6fd | LAB_0060e83b
        ;   XREF to: 0060e83b (CONDITIONAL_JUMP)
    MOV AH,byte ptr [EBP]               ; 0060e703
        ;   Label: LAB_0060e703
    CMP AH,0x5c                         ; 0060e706
    JZ 0x0060e83b                       ; 0060e709 | LAB_0060e83b
        ;   XREF to: 0060e83b (CONDITIONAL_JUMP)
    TEST AH,AH                          ; 0060e70f
    JZ 0x0060e83b                       ; 0060e711 | LAB_0060e83b
        ;   XREF to: 0060e83b (CONDITIONAL_JUMP)
    CMP byte ptr [EBP + 0x1],0x3a       ; 0060e717
    JZ 0x0060e83b                       ; 0060e71b | LAB_0060e83b
        ;   XREF to: 0060e83b (CONDITIONAL_JUMP)
    PUSH 0x659750                       ; 0060e721 | = "PATH" | s_PATH_00659750 = PATH
    CALL crt_env.c_getenv_FUN_006013f0  ; 0060e726 | char * crt_env.c_getenv_FUN_006013f0(char * name)
        ;   XREF to: 006013f0 (UNCONDITIONAL_CALL)
    MOV ESI,EAX                         ; 0060e72b
    ADD ESP,0x4                         ; 0060e72d
    MOV EBX,EAX                         ; 0060e730
    TEST EAX,EAX                        ; 0060e732
    JZ 0x0060e83b                       ; 0060e734 | LAB_0060e83b
        ;   XREF to: 0060e83b (CONDITIONAL_JUMP)
    PUSH EBP                            ; 0060e73a
    CALL crt_string.c_strlen_FUN_0060f870 ; 0060e73b | int crt_string.c_strlen_FUN_0060f870(char * str)
    ...
    TEST CL,CL                          ; 0060e74d
    JZ 0x0060e83b                       ; 0060e74f | LAB_0060e83b
        ;   XREF to: 0060e83b (CONDITIONAL_JUMP)
    ...
    PUSH 0x3b                           ; 0060e76a
        ;   Label: LAB_0060e76a
    PUSH EBX                            ; 0060e76c
    CALL crt_string.c_strchr_FUN_0060f890 ; 0060e76d | char * crt_string.c_strchr_FUN_0060f890(char * str, int ch)
        ;   XREF to: 0060f890 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0060e772
    MOV ESI,EAX                         ; 0060e775
    TEST EAX,EAX                        ; 0060e777
    JNZ 0x0060e787                      ; 0060e779 | LAB_0060e787
        ;   XREF to: 0060e787 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 0060e77b
    CALL crt_string.c_strlen_FUN_0060f870 ; 0060e77c | int crt_string.c_strlen_FUN_0060f870(char * str)
        ;   XREF to: 0060f870 (UNCONDITIONAL_CALL)
    ...
    JBE 0x0060e7b4                      ; 0060e794 | LAB_0060e7b4
        ;   XREF to: 0060e7b4 (CONDITIONAL_JUMP)
    PUSH 0x2                            ; 0060e796
    CALL crt_errno.c_setErrno_FUN_00602790 ; 0060e798 | void crt_errno.c_setErrno_FUN_00602790(int error_code)
        ;   XREF to: 00602790 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060e79d
    PUSH 0xa                            ; 0060e7a0
    CALL crt_errno.c_SetWindowsError_FUN_006027c8 ; 0060e7a2 | void crt_errno.c_SetWindowsError_FUN_006027c8(DWORD windows_error_code)
        ;   XREF to: 006027c8 (UNCONDITIONAL_CALL)
    MOV EAX,0xffffffff                  ; 0060e7a7
    ADD ESP,0x4                         ; 0060e7ac
    JMP 0x0060e83d                      ; 0060e7af | LAB_0060e83d
    ...
    CALL crt_string.c_memcpy_FUN_0060cd60 ; 0060e7c1 | void * crt_string.c_memcpy_FUN_0060cd60(void * dest, void * src, SIZE_T count)
        ;   XREF to: 0060cd60 (UNCONDITIONAL_CALL)
    MOV AL,byte ptr [EBX + -0x1]        ; 0060e7c6
    ADD ESP,0xc                         ; 0060e7c9
    CMP AL,0x5c                         ; 0060e7cc
    JZ 0x0060e7d4                       ; 0060e7ce | LAB_0060e7d4
    ...
    PUSH EBP                            ; 0060e7dc
    PUSH EBX                            ; 0060e7dd
    CALL crt_string.c_memcpy_FUN_0060cd60 ; 0060e7de | void * crt_string.c_memcpy_FUN_0060cd60(void * dest, void * src, SIZE_T count)
        ;   XREF to: 0060cd60 (UNCONDITIONAL_CALL)
    ...
    PUSH EDI                            ; 0060e802
    CALL crt_process.c_spawnvp_FUN_0060f39c ; 0060e803 | int crt_process.c_spawnvp_FUN_0060f39c(int mode, char * cmdname, char * * argv)
        ;   XREF to: 0060f39c (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0060e808
    MOV EDI,EAX                         ; 0060e80b
    CMP EAX,-0x1                        ; 0060e80d
    JNZ 0x0060e83b                      ; 0060e810 | LAB_0060e83b
        ;   XREF to: 0060e83b (CONDITIONAL_JUMP)
    CALL dword ptr [0x00684ee4]         ; 0060e812 | GET_TLS_FUNC * PTR_crt_thread.c_GetTLS_FUN_0060242c_00684ee4
    CMP dword ptr [EAX + 0x4],0x1       ; 0060e818
    JZ 0x0060e82a                       ; 0060e81c | LAB_0060e82a
        ;   XREF to: 0060e82a (CONDITIONAL_JUMP)
    CALL dword ptr [0x00684ee4]         ; 0060e81e | GET_TLS_FUNC * PTR_crt_thread.c_GetTLS_FUN_0060242c_00684ee4
    CMP dword ptr [EAX + 0x4],0x9       ; 0060e824
    JNZ 0x0060e83b                      ; 0060e828 | LAB_0060e83b
        ;   XREF to: 0060e83b (CONDITIONAL_JUMP)
    CMP byte ptr [ESI],0x3b             ; 0060e82a
        ;   Label: LAB_0060e82a
    JNZ 0x0060e83b                      ; 0060e82d | LAB_0060e83b
        ;   XREF to: 0060e83b (CONDITIONAL_JUMP)
    LEA EBX,[ESI + 0x1]                 ; 0060e82f
    CMP byte ptr [EBX],0x0              ; 0060e832
    JNZ 0x0060e76a                      ; 0060e835 | LAB_0060e76a
