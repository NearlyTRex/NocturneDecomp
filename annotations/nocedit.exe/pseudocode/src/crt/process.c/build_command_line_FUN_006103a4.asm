...
;                               FUNCTION
; *****************************************************************************
; __cdecl void crt_process.c_build_command_line_FUN_006103a4(char * program_name, char * * argv, char * buffer, int skip_program_name)
;
; Parameters:
...
section .text
    ...
    JNZ 0x006103c8                      ; 006103b4 | LAB_006103c8
        ;   XREF to: 006103c8 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [ESP + 0x10]      ; 006103b6
    PUSH ECX                            ; 006103ba
    PUSH EAX                            ; 006103bb
    CALL crt_string.c_strcpy_advance_FUN_00610240 ; 006103bc | char * crt_string.c_strcpy_advance_FUN_00610240(char * dest, char * src)
    ...
    CALL crt_string.c_strcpy_advance_FUN_00610240 ; 006103de | char * crt_string.c_strcpy_advance_FUN_00610240(char * dest, char * src)
        ;   XREF to: 00610240 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [EBX]             ; 006103e3
    ADD ESP,0x8                         ; 006103e5
    TEST EDX,EDX                        ; 006103e8
    JZ 0x006103f2                       ; 006103ea | LAB_006103f2
        ;   XREF to: 006103f2 (CONDITIONAL_JUMP)
    MOV byte ptr [EAX],0x20             ; 006103ec
    INC EAX                             ; 006103ef
    JMP 0x006103d7                      ; 006103f0 | LAB_006103d7
