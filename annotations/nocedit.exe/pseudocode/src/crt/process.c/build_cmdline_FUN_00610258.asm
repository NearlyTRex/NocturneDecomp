...
section .text
    ...
    JNZ 0x00610271                      ; 00610269 | LAB_00610271
        ;   XREF to: 00610271 (CONDITIONAL_JUMP)
    MOV EBP,dword ptr [0x03f9b864]      ; 0061026b | char * * g_EnvironmentBlock
    XOR EDI,EDI                         ; 00610271
        ;   Label: LAB_00610271
    TEST EBP,EBP                        ; 00610273
    JZ 0x00610297                       ; 00610275 | LAB_00610297
        ;   XREF to: 00610297 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [EBP]             ; 00610277
    MOV EBX,EBP                         ; 0061027a
    TEST EDX,EDX                        ; 0061027c
    JZ 0x00610297                       ; 0061027e | LAB_00610297
        ;   XREF to: 00610297 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [EBX]             ; 00610280
        ;   Label: LAB_00610280
    PUSH ECX                            ; 00610282
    CALL crt_string.c_strlen_FUN_0060f870 ; 00610283 | int crt_string.c_strlen_FUN_0060f870(char * str)
    ...
    JNZ 0x00610280                      ; 00610295 | LAB_00610280
        ;   XREF to: 00610280 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [ESP + 0x30]      ; 00610297
        ;   Label: LAB_00610297
    INC EDI                             ; 0061029b
    TEST EDX,EDX                        ; 0061029c
    JZ 0x006102b0                       ; 0061029e | LAB_006102b0
        ;   XREF to: 006102b0 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [ESI]             ; 006102a0
    PUSH EBX                            ; 006102a2
    CALL crt_string.c_strlen_FUN_0060f870 ; 006102a3 | int crt_string.c_strlen_FUN_0060f870(char * str)
        ;   XREF to: 0060f870 (UNCONDITIONAL_CALL)
    ...
    MOV EAX,[0x006854f4]                ; 006102b8 | int g_HeapFlags
    PUSH EDI                            ; 006102bd
    MOV dword ptr [ESP + 0x4],EAX       ; 006102be
    MOV dword ptr [0x006854f4],ECX      ; 006102c2 | int g_HeapFlags
    CALL crt_heap.c_InternalHeapAlloc_FUN_00601bc0 ; 006102c8 | void * crt_heap.c_InternalHeapAlloc_FUN_00601bc0(ulong size)
        ;   XREF to: 00601bc0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 006102cd
    TEST EAX,EAX                        ; 006102d0
    JNZ 0x00610307                      ; 006102d2 | LAB_00610307
        ;   XREF to: 00610307 (CONDITIONAL_JUMP)
    PUSH EDI                            ; 006102d4
    CALL crt_memory.c_malloc_FUN_00601bb0 ; 006102d5 | void * crt_memory.c_malloc_FUN_00601bb0(ulong size)
        ;   XREF to: 00601bb0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 006102da
    TEST EAX,EAX                        ; 006102dd
    JNZ 0x00610307                      ; 006102df | LAB_00610307
        ;   XREF to: 00610307 (CONDITIONAL_JUMP)
    PUSH 0x5                            ; 006102e1
    CALL crt_errno.c_setErrno_FUN_00602790 ; 006102e3 | void crt_errno.c_setErrno_FUN_00602790(int error_code)
        ;   XREF to: 00602790 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 006102e8
    PUSH 0x8                            ; 006102eb
    CALL crt_errno.c_SetWindowsError_FUN_006027c8 ; 006102ed | void crt_errno.c_SetWindowsError_FUN_006027c8(DWORD windows_error_code)
        ;   XREF to: 006027c8 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 006102f2
    MOV EAX,dword ptr [ESP]             ; 006102f5
    MOV [0x006854f4],EAX                ; 006102f8 | int g_HeapFlags
    MOV EAX,0xffffffff                  ; 006102fd
    JMP 0x0061039b                      ; 00610302 | LAB_0061039b
        ;   XREF to: 0061039b (UNCONDITIONAL_JUMP)
    MOV EBX,dword ptr [ESP]             ; 00610307
        ;   Label: LAB_00610307
    MOV dword ptr [0x006854f4],EBX      ; 0061030a | int g_HeapFlags
    ...
    CALL crt_string.c_strcpy_advance_FUN_00610240 ; 0061033a | char * crt_string.c_strcpy_advance_FUN_00610240(char * dest, char * src)
        ;   XREF to: 00610240 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0061033f
    MOV EBP,dword ptr [EBX]             ; 00610342
    INC EAX                             ; 00610344
    TEST EBP,EBP                        ; 00610345
    JNZ 0x00610333                      ; 00610347 | LAB_00610333
    ...
    JZ 0x00610364                       ; 00610353 | LAB_00610364
        ;   XREF to: 00610364 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [ESI]             ; 00610355
    PUSH EBX                            ; 00610357
    ADD EAX,0x2                         ; 00610358
    PUSH EAX                            ; 0061035b
    CALL crt_string.c_strcpy_FUN_00610760 ; 0061035c | char * crt_string.c_strcpy_FUN_00610760(char * dest, char * src)
    ...
    JZ 0x0061038a                       ; 0061036a | LAB_0061038a
        ;   XREF to: 0061038a (CONDITIONAL_JUMP)
    ADD ESI,0x4                         ; 0061036c
    JMP 0x00610384                      ; 0061036f | LAB_00610384
        ;   XREF to: 00610384 (UNCONDITIONAL_JUMP)
    TEST EBX,EBX                        ; 00610371
        ;   Label: LAB_00610371
    JZ 0x00610376                       ; 00610373 | LAB_00610376
        ;   XREF to: 00610376 (CONDITIONAL_JUMP)
    INC EBX                             ; 00610375
    PUSH EAX                            ; 00610376
        ;   Label: LAB_00610376
    CALL crt_string.c_strlen_FUN_0060f870 ; 00610377 | int crt_string.c_strlen_FUN_0060f870(char * str)
        ;   XREF to: 0060f870 (UNCONDITIONAL_CALL)
    ...
    JNZ 0x00610371                      ; 00610388 | LAB_00610371
