...

{
  ...
  _RTL_CRITICAL_SECTION local_c4 [4];
  char *local_58;
  char *local_54;
  char *local_50;
  char *local_4c;
  ...
  (*PTR_crt_thread_c_EnterCriticalSection_FUN_0060b180_00685464)(local_c4);
...
LAB_0060f687:
  ...
  pcVar5 = crt_env_c_getenv_FUN_006013f0("COMSPEC");
  iVar8 = crt_process_c_execvp_FUN_00610790(mode,pcVar5,in_stack_fffffeca,in_stack_fffffece);
LAB_0060f80e:
  if (local_20 != 0) {
    crt_memory_c_free_FUN_00601cd0(in_stack_00000010);
    crt_memory_c_free_FUN_00601cd0(local_1c);
  ...
  crt_memory_c_free_FUN_00601cd0(local_38);
  (*PTR_crt_thread_c_ExitCriticalSection_FUN_0060b180_00685468)(local_c4);
  return iVar8;
}
