...
section .text
    ...
    MOV ESI,dword ptr [0x00685214]      ; 0060ffd8 | uint g_MaxHandleCount
    LEA EBX,[ESI*0x8 + 0x0]             ; 0060ffde
    SUB EBX,ESI                         ; 0060ffe5
    SHL EBX,0x2                         ; 0060ffe7
    MOV EDI,0x659790                    ; 0060ffea | = "C_FILE_INFO=" | s_C_FILE_INFO_00659790 = C_FILE_INFO=
    ...
    SCASB.REPNE ES:EDI                  ; 0060fffb | = "C_FILE_INFO=" | s_C_FILE_INFO_00659790 = C_FILE_INFO=
    NOT ECX                             ; 0060fffd
    DEC ECX                             ; 0060ffff
    POP ES                              ; 00610000
    ...
    INC EBX                             ; 00610003
    PUSH EBX                            ; 00610004
    CALL crt_memory.c_malloc_FUN_00601bb0 ; 00610005 | void * crt_memory.c_malloc_FUN_00601bb0(ulong size)
    ...
    JNZ 0x0061001e                      ; 00610015 | LAB_0061001e
        ;   XREF to: 0061001e (CONDITIONAL_JUMP)
    XOR ESI,ESI                         ; 00610017
    JMP 0x006101e3                      ; 00610019 | LAB_006101e3
        ;   XREF to: 006101e3 (UNCONDITIONAL_JUMP)
    MOV AX,DS                           ; 0061001e
        ;   Label: LAB_0061001e
    MOV ES,AX                           ; 00610020
    MOV ESI,0x659790                    ; 00610022 | = "C_FILE_INFO=" | s_C_FILE_INFO_00659790 = C_FILE_INFO=
    XOR EBX,EBX                         ; 00610027
    MOV EDX,dword ptr [0x00685214]      ; 00610029 | uint g_MaxHandleCount
    MOVSD ES:EDI,ESI                    ; 0061002f | = "C_FILE_INFO=" | s_C_FILE_INFO_00659790 = C_FILE_INFO=
    ...
    JBE 0x006101df                      ; 00610035 | LAB_006101df
        ;   XREF to: 006101df (CONDITIONAL_JUMP)
    PUSH EBX                            ; 0061003b
        ;   Label: LAB_0061003b
    CALL crt_io.c_getFileTypeFlags_FUN_006088b0 ; 0061003c | uint crt_io.c_getFileTypeFlags_FUN_006088b0(int file_handle_index)
        ;   XREF to: 006088b0 (UNCONDITIONAL_CALL)
    MOV EBP,EAX                         ; 00610041
    ADD ESP,0x4                         ; 00610043
    TEST EBP,0x4000                     ; 00610046
    JZ 0x006101d0                       ; 0061004c | LAB_006101d0
        ;   XREF to: 006101d0 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 00610052
    CALL crt_io.c_get_handle_FUN_006109f0 ; 00610053 | undefined crt_io.c_get_handle_FUN_006109f0(int fd)
    ...
    CALL crt_stdio.c_IntegerToString_FUN_00607d18 ; 0061006d | char * crt_stdio.c_IntegerToString_FUN_00607d18(int value, char * buffer, int base)
    ...
    CMP AL,0x0                          ; 0061008b
    JZ 0x0061009f                       ; 0061008d | LAB_0061009f
    ...
    CMP AL,0x0                          ; 0061009b
    JNZ 0x00610087                      ; 0061009d | LAB_00610087
        ;   XREF to: 00610087 (CONDITIONAL_JUMP)
    POP EDI                             ; 0061009f
        ;   Label: LAB_0061009f
    POP ES                              ; 006100a0
    MOV ESI,0x6597a0                    ; 006100a1 | char g_ColonChar
    ...
    DEC EDI                             ; 006100b3
    MOV AL,byte ptr [ESI]               ; 006100b4 | char g_ColonChar | DAT_006597a2 = 0x0
        ;   Label: LAB_006100b4
    MOV byte ptr [EDI],AL               ; 006100b6
    CMP AL,0x0                          ; 006100b8
    JZ 0x006100cc                       ; 006100ba | LAB_006100cc
        ;   XREF to: 006100cc (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 006100bc | undefined1 DAT_006597a1 | DAT_006597a3 = 0x0
    ADD ESI,0x2                         ; 006100bf
    MOV byte ptr [EDI + 0x1],AL         ; 006100c2
    ADD EDI,0x2                         ; 006100c5
    CMP AL,0x0                          ; 006100c8
    JNZ 0x006100b4                      ; 006100ca | LAB_006100b4
    ...
    PUSH ESI                            ; 006100d9
    CALL crt_stdio.c_IntegerToString_FUN_00607d18 ; 006100da | char * crt_stdio.c_IntegerToString_FUN_00607d18(int value, char * buffer, int base)
        ;   XREF to: 00607d18 (UNCONDITIONAL_CALL)
    ...
    CMP AL,0x0                          ; 006100f8
    JZ 0x0061010c                       ; 006100fa | LAB_0061010c
    ...
    CMP AL,0x0                          ; 00610108
    JNZ 0x006100f4                      ; 0061010a | LAB_006100f4
        ;   XREF to: 006100f4 (CONDITIONAL_JUMP)
    POP EDI                             ; 0061010c
        ;   Label: LAB_0061010c
    POP ES                              ; 0061010d
    MOV ESI,0x6597a0                    ; 0061010e | char g_ColonChar
    ...
    DEC EDI                             ; 00610120
    MOV AL,byte ptr [ESI]               ; 00610121 | char g_ColonChar | DAT_006597a2 = 0x0
        ;   Label: LAB_00610121
    MOV byte ptr [EDI],AL               ; 00610123
    CMP AL,0x0                          ; 00610125
    JZ 0x00610139                       ; 00610127 | LAB_00610139
        ;   XREF to: 00610139 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 00610129 | undefined1 DAT_006597a1 | DAT_006597a3 = 0x0
    ADD ESI,0x2                         ; 0061012c
    MOV byte ptr [EDI + 0x1],AL         ; 0061012f
    ADD EDI,0x2                         ; 00610132
    CMP AL,0x0                          ; 00610135
    JNZ 0x00610121                      ; 00610137 | LAB_00610121
    ...
    PUSH ESI                            ; 00610141
    PUSH EBP                            ; 00610142
    CALL crt_stdio.c_IntegerToString_FUN_00607d18 ; 00610143 | char * crt_stdio.c_IntegerToString_FUN_00607d18(int value, char * buffer, int base)
        ;   XREF to: 00607d18 (UNCONDITIONAL_CALL)
    ...
    CMP AL,0x0                          ; 00610161
    JZ 0x00610175                       ; 00610163 | LAB_00610175
    ...
    CMP AL,0x0                          ; 00610171
    JNZ 0x0061015d                      ; 00610173 | LAB_0061015d
        ;   XREF to: 0061015d (CONDITIONAL_JUMP)
    POP EDI                             ; 00610175
        ;   Label: LAB_00610175
    POP ES                              ; 00610176
    MOV ESI,0x6597a4                    ; 00610177 | char g_AsteriskChar
    ...
    DEC EDI                             ; 00610189
    MOV AL,byte ptr [ESI]               ; 0061018a | char g_AsteriskChar | DAT_006597a6 = 0x0
        ;   Label: LAB_0061018a
    MOV byte ptr [EDI],AL               ; 0061018c
    CMP AL,0x0                          ; 0061018e
    JZ 0x006101a2                       ; 00610190 | LAB_006101a2
        ;   XREF to: 006101a2 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 00610192 | undefined1 DAT_006597a5 | DAT_006597a7 = 0x0
    ADD ESI,0x2                         ; 00610195
    MOV byte ptr [EDI + 0x1],AL         ; 00610198
    ADD EDI,0x2                         ; 0061019b
    CMP AL,0x0                          ; 0061019e
    JNZ 0x0061018a                      ; 006101a0 | LAB_0061018a
    ...
    CMP AL,0x0                          ; 006101ba
    JZ 0x006101ce                       ; 006101bc | LAB_006101ce
    ...
    CMP AL,0x0                          ; 006101ca
    JNZ 0x006101b6                      ; 006101cc | LAB_006101b6
        ;   XREF to: 006101b6 (CONDITIONAL_JUMP)
    POP EDI                             ; 006101ce
        ;   Label: LAB_006101ce
    POP ES                              ; 006101cf
    MOV ECX,dword ptr [0x00685214]      ; 006101d0 | uint g_MaxHandleCount
        ;   Label: LAB_006101d0
    INC EBX                             ; 006101d6
    CMP EBX,ECX                         ; 006101d7
    JC 0x0061003b                       ; 006101d9 | LAB_0061003b
