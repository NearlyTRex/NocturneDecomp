...
section .text
    ...
    JNZ 0x00606420                      ; 006063eb | LAB_00606420
    ...
    MOV dword ptr [EBX + 0x8],0x665e74  ; 006063fa | WatcomThunkedDestructor PTR_unk_OtherFreeMemory2_FUN_006063e1_00665e74
    MOV EAX,dword ptr [EAX + 0x4]       ; 00606401
    MOV DL,byte ptr [ESP + 0xc]         ; 00606404
    MOV dword ptr [EBX + EAX*0x1 + 0x28],0x665e7c ; 00606408 | void * PTR_FUN_00665e7c
    TEST DL,0x1                         ; 00606410
    JZ 0x0060643b                       ; 00606413 | LAB_0060643b
        ;   XREF to: 0060643b (CONDITIONAL_JUMP)
    TEST byte ptr [ESP + 0xc],0x2       ; 00606415
        ;   Label: LAB_00606415
    JNZ 0x0060644e                      ; 0060641a | LAB_0060644e
        ;   XREF to: 0060644e (CONDITIONAL_JUMP)
    MOV EAX,EBX                         ; 0060641c
    POP EBX                             ; 0060641e
    RET                                 ; 0060641f
    PUSH 0x665eb0                       ; 00606420 | WatcomTypeInfo g_IStreamTypeInfo
        ;   Label: LAB_00606420
    PUSH EBX                            ; 00606425
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 00606426 | void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0060642b
    PUSH EAX                            ; 0060642e
    CALL crt_memory.c_free_FUN_005fe659 ; 0060642f | void crt_memory.c_free_FUN_005fe659(void * ptr)
    ...
    PUSH EBX                            ; 00606440
    CALL crt_iostream.cpp_ios_dtor_FUN_0060632c ; 00606441 | ios * crt_iostream.cpp_ios_dtor_FUN_0060632c(ios * this_ptr, uint d1, uint d2)
        ;   XREF to: 0060632c (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00606446
    LEA EBX,[EAX + -0x10]               ; 00606449
    JMP 0x00606415                      ; 0060644c | LAB_00606415
        ;   XREF to: 00606415 (UNCONDITIONAL_JUMP)
    PUSH EBX                            ; 0060644e
        ;   Label: LAB_0060644e
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 0060644f | void shape_memdbg.cpp_debugFree_FUN_0050f210(void * ptr)
        ;   XREF to: 0050f210 (UNCONDITIONAL_CALL)
    JMP 0x00606434                      ; 00606454 | LAB_00606434
