...
;                               FUNCTION
; *****************************************************************************
; __watcallStack streambuf * crt_iostream.cpp_streambuf_destructor_FUN_0060d64f(streambuf * this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV dword ptr [EBX + 0x28],0x665f70 ; 0060d657 | streambuf_vtable g_StreambufVTable
    TEST AH,0x2                         ; 0060d65e
    JNZ 0x0060d667                      ; 0060d661 | LAB_0060d667
    ...
    MOV EDX,dword ptr [EBX + 0x4]       ; 0060d667
        ;   Label: LAB_0060d667
    PUSH EDX                            ; 0060d66a
    CALL crt_iostream.cpp_freeBuffer_FUN_0060d7a0 ; 0060d66b | void crt_iostream.cpp_freeBuffer_FUN_0060d7a0(void * buffer)
