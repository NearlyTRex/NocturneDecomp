...
;                               FUNCTION
; *****************************************************************************
; __cdecl void crt_iostream.cpp_istream_destructor_thunk_from_ios_FUN_006063c9(ios * this_ptr, int dtor_flags)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 006063d7
    CALL crt_iostream.cpp_istream_dtor_FUN_006063e1 ; 006063d8 | istream * crt_iostream.cpp_istream_dtor_FUN_006063e1(istream * this_ptr, uint d1, uint d2)
