...
;                               FUNCTION
; *****************************************************************************
; __cdecl istream * crt_iostream.cpp_istream_ctor_FUN_00606376(istream * this_ptr, uint c1)
;
; Parameters:
...
section .text
    ...
    JZ 0x006063b2                       ; 0060637f | LAB_006063b2
    ...
    MOV dword ptr [EAX + 0x8],0x665e74  ; 0060638e | WatcomThunkedDestructor PTR_unk_OtherFreeMemory2_FUN_006063e1_00665e74
    MOV EDX,dword ptr [EDX + 0x4]       ; 00606395
    MOV dword ptr [EDX + EAX*0x1 + 0x28],0x665e7c ; 00606398 | void * PTR_FUN_00665e7c
    ...
    RET                                 ; 006063b1
    MOV dword ptr [EAX],0x665e68        ; 006063b2 | WatcomInheritanceLayout DAT_00665e68
        ;   Label: LAB_006063b2
    ADD EAX,0x10                        ; 006063b8
    PUSH EAX                            ; 006063bb
    CALL crt_iostream.cpp_ios_ctor_FUN_006061fc ; 006063bc | ios * crt_iostream.cpp_ios_ctor_FUN_006061fc(ios * this_ptr)
        ;   XREF to: 006061fc (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 006063c1
    SUB EAX,0x10                        ; 006063c4
    JMP 0x00606381                      ; 006063c7 | LAB_00606381
