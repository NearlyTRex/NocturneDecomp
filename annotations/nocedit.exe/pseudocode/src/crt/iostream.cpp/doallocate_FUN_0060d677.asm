...
section .text
    ...
    CALL crt_iostream.cpp_streambuf_allocBuffer_FUN_0060d790 ; 0060d67c | void * crt_iostream.cpp_streambuf_allocBuffer_FUN_0060d790(uint size)
        ;   XREF to: 0060d790 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060d681
    TEST EAX,EAX                        ; 0060d684
    JNZ 0x0060d68e                      ; 0060d686 | LAB_0060d68e
    ...
    PUSH EDX                            ; 0060d69c
    CALL crt_iostream.cpp_setBuffer_FUN_0060d6a8 ; 0060d69d | void crt_iostream.cpp_setBuffer_FUN_0060d6a8(streambuf * this_ptr, void * new_buffer, void * buffer_end, int ownership_flag)
