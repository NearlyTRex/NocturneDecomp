...
;                               FUNCTION
; *****************************************************************************
; __watcallStack streambuf * crt_iostream.cpp_streambuf_setbuf_FUN_0060d5ff(streambuf * this_ptr, void * buffer_start, int buffer_size)
;
; Parameters:
...
section .text
    ...
    JNZ 0x0060d633                      ; 0060d611 | LAB_0060d633
        ;   XREF to: 0060d633 (CONDITIONAL_JUMP)
    TEST ECX,ECX                        ; 0060d613
    JZ 0x0060d637                       ; 0060d615 | LAB_0060d637
        ;   XREF to: 0060d637 (CONDITIONAL_JUMP)
    TEST EDX,EDX                        ; 0060d617
    JLE 0x0060d637                      ; 0060d619 | LAB_0060d637
        ;   XREF to: 0060d637 (CONDITIONAL_JUMP)
    CMP EDX,0x4                         ; 0060d61b
    JLE 0x0060d63f                      ; 0060d61e | LAB_0060d63f
    ...
    PUSH EBX                            ; 0060d626
        ;   Label: LAB_0060d626
    CALL crt_iostream.cpp_setBuffer_FUN_0060d6a8 ; 0060d627 | void crt_iostream.cpp_setBuffer_FUN_0060d6a8(streambuf * this_ptr, void * new_buffer, void * buffer_end, int ownership_flag)
    ...
    PUSH 0x0                            ; 0060d639
    PUSH 0x0                            ; 0060d63b
    JMP 0x0060d626                      ; 0060d63d | LAB_0060d626
    ...
    PUSH EAX                            ; 0060d641
    PUSH EBX                            ; 0060d642
    CALL crt_iostream.cpp_setBuffer_FUN_0060d6a8 ; 0060d643 | void crt_iostream.cpp_setBuffer_FUN_0060d6a8(streambuf * this_ptr, void * new_buffer, void * buffer_end, int ownership_flag)
        ;   XREF to: 0060d6a8 (UNCONDITIONAL_CALL)
