...
;                               FUNCTION
; *****************************************************************************
; __cdecl ios * __cdecl crt_iostream_cpp_ios_dtor_FUN_0060632c(ios *this_ptr,uint d1,uint d2)
;
; Parameters:
...
section .text
    ...
    PUSH 0x665e50                       ; 00606353 | g_IOSTypeInfo
        ;   Label: LAB_00606353
    PUSH EBX                            ; 00606358
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 00606359
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 0060635e
    PUSH EAX                            ; 00606361
    CALL crt_memory.c_free_FUN_005fe659 ; 00606362
