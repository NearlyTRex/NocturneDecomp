...
;                               FUNCTION
; *****************************************************************************
; __cdecl void crt_iostream.cpp_ostream_destructor_thunk_FUN_006061e4(ios * this_ptr, int dtor_flags)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 006061f2
    CALL crt_iostream.cpp_ostream_dtor_FUN_00606231 ; 006061f3 | ostream * crt_iostream.cpp_ostream_dtor_FUN_00606231(ostream * this_ptr, uint d1, uint d2)
