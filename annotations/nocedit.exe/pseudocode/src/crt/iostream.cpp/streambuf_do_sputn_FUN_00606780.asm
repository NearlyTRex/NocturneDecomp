...
;                               FUNCTION
; *****************************************************************************
; __watcallStack int crt_iostream.cpp_streambuf_do_sputn_FUN_00606780(streambuf * buffer, void * input_buffer, SIZE_T bytes_to_write)
;
; Parameters:
; streambuf *      Stack[0x4]:4   buffer
; void *           Stack[0x8]:4   input_buffer
; typedef SIZE_T ULONG_PTR Stack[0xc]:4   bytes_to_write
; Local Variables:
...
section .text
    ...
    JMP 0x00606794                      ; 006067ec | LAB_00606794
    ...
    JZ 0x00606827                       ; 0060681e | LAB_00606827
        ;   XREF to: 00606827 (CONDITIONAL_JUMP)
    MOV EDX,0x1                         ; 00606820
    JMP 0x006067d8                      ; 00606825 | LAB_006067d8
