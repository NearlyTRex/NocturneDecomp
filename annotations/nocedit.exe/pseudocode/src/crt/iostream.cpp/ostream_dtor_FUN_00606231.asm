...
;                               FUNCTION
; *****************************************************************************
; __cdecl ostream * crt_iostream.cpp_ostream_dtor_FUN_00606231(ostream * this_ptr, uint d1, uint d2)
;
; Parameters:
...
section .text
    ...
    JNZ 0x00606270                      ; 0060623b | LAB_00606270
    ...
    MOV dword ptr [EBX + 0x4],0x665dc4  ; 0060624a | void * g_OStream_Destructor
    MOV EAX,dword ptr [EAX + 0x4]       ; 00606251
    MOV DL,byte ptr [ESP + 0xc]         ; 00606254
    MOV dword ptr [EBX + EAX*0x1 + 0x28],0x665dcc ; 00606258 | void * g_OStream_IOSDestructor
    TEST DL,0x1                         ; 00606260
    JZ 0x0060628b                       ; 00606263 | LAB_0060628b
        ;   XREF to: 0060628b (CONDITIONAL_JUMP)
    TEST byte ptr [ESP + 0xc],0x2       ; 00606265
        ;   Label: LAB_00606265
    JNZ 0x0060629e                      ; 0060626a | LAB_0060629e
        ;   XREF to: 0060629e (CONDITIONAL_JUMP)
    MOV EAX,EBX                         ; 0060626c
    POP EBX                             ; 0060626e
    RET                                 ; 0060626f
    PUSH 0x665e10                       ; 00606270 | WatcomTypeInfo g_OStreamTypeInfo
        ;   Label: LAB_00606270
    PUSH EBX                            ; 00606275
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 00606276 | void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0060627b
    PUSH EAX                            ; 0060627e
    CALL crt_memory.c_free_FUN_005fe659 ; 0060627f | void crt_memory.c_free_FUN_005fe659(void * ptr)
    ...
    PUSH EBX                            ; 00606290
    CALL crt_iostream.cpp_ios_dtor_FUN_0060632c ; 00606291 | ios * crt_iostream.cpp_ios_dtor_FUN_0060632c(ios * this_ptr, uint d1, uint d2)
        ;   XREF to: 0060632c (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00606296
    LEA EBX,[EAX + -0xc]                ; 00606299
    JMP 0x00606265                      ; 0060629c | LAB_00606265
        ;   XREF to: 00606265 (UNCONDITIONAL_JUMP)
    PUSH EBX                            ; 0060629e
        ;   Label: LAB_0060629e
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 0060629f | void shape_memdbg.cpp_debugFree_FUN_0050f210(void * ptr)
        ;   XREF to: 0050f210 (UNCONDITIONAL_CALL)
    JMP 0x00606284                      ; 006062a4 | LAB_00606284
