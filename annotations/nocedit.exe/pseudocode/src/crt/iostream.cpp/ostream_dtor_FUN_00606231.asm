...
;                               FUNCTION
; *****************************************************************************
; __cdecl ostream * __cdecl crt_iostream_cpp_ostream_dtor_FUN_00606231(ostream *this_ptr,uint flags)
;
; Parameters:
...
section .text
    ...
    PUSH 0x665e10                       ; 00606270 | g_OStreamTypeInfo
        ;   Label: LAB_00606270
    PUSH EBX                            ; 00606275
    CALL crt_memory.c___vec_delete_FUN_005fe632 ; 00606276
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c___vec_delete_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 0060627b
    PUSH EAX                            ; 0060627e
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 0060627f
