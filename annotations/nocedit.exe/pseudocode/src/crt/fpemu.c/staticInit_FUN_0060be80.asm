...
section .text
    ...
    CALL crt_math.c_dmul_FUN_0060e0b9   ; 0060bec7 | double crt_math.c_dmul_FUN_0060e0b9(double a, double b)
    ...
    CALL crt_math.c_dadd_FUN_0060defc   ; 0060bed8 | double crt_math.c_dadd_FUN_0060defc(double a, double b)
    ...
    JLE 0x0060bef5                      ; 0060beec | LAB_0060bef5
        ;   XREF to: 0060bef5 (CONDITIONAL_JUMP)
    OR byte ptr [0x00685060],0x1        ; 0060beee | int g_UseSoftwareMath
