...

{
  ...
  if (2 < DAT_00684acd) {
    ...
    dVar4 = crt_math_c_dmul_FUN_0060e0b9(dVar4,-2.000000486383214);
    dVar4 = crt_math_c_dadd_FUN_0060defc((double)CONCAT44 /* combine 2-byte values */(unaff_retaddr,unaff_EBX),dVar4);
