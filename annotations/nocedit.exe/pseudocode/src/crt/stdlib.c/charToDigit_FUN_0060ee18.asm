...
section .text
    ...
    JC 0x0060ee2d                       ; 0060ee1e | LAB_0060ee2d
        ;   XREF to: 0060ee2d (CONDITIONAL_JUMP)
    CMP AL,0x39                         ; 0060ee20
    JA 0x0060ee2d                       ; 0060ee22 | LAB_0060ee2d
        ;   XREF to: 0060ee2d (CONDITIONAL_JUMP)
    ...
    AND EAX,0xff                        ; 0060ee2d
        ;   Label: LAB_0060ee2d
    PUSH EAX                            ; 0060ee32
    CALL crt_ctype.c_tolower_FUN_005feb30 ; 0060ee33 | int crt_ctype.c_tolower_FUN_005feb30(int character)
        ;   XREF to: 005feb30 (UNCONDITIONAL_CALL)
    MOV EDX,EAX                         ; 0060ee38
    ADD ESP,0x4                         ; 0060ee3a
    CMP AL,0x61                         ; 0060ee3d
    JC 0x0060ee4d                       ; 0060ee3f | LAB_0060ee4d
        ;   XREF to: 0060ee4d (CONDITIONAL_JUMP)
    CMP AL,0x69                         ; 0060ee41
    JA 0x0060ee4d                       ; 0060ee43 | LAB_0060ee4d
        ;   XREF to: 0060ee4d (CONDITIONAL_JUMP)
    ...
    CMP AL,0x6a                         ; 0060ee4d
        ;   Label: LAB_0060ee4d
    JC 0x0060ee5e                       ; 0060ee4f | LAB_0060ee5e
        ;   XREF to: 0060ee5e (CONDITIONAL_JUMP)
    CMP AL,0x72                         ; 0060ee51
    JA 0x0060ee5e                       ; 0060ee53 | LAB_0060ee5e
        ;   XREF to: 0060ee5e (CONDITIONAL_JUMP)
    ...
    CMP AL,0x73                         ; 0060ee5e
        ;   Label: LAB_0060ee5e
    JC 0x0060ee6f                       ; 0060ee60 | LAB_0060ee6f
        ;   XREF to: 0060ee6f (CONDITIONAL_JUMP)
    CMP AL,0x7a                         ; 0060ee62
    JA 0x0060ee6f                       ; 0060ee64 | LAB_0060ee6f
        ;   XREF to: 0060ee6f (CONDITIONAL_JUMP)
