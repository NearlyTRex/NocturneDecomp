...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl crt_stdlib_c__qsort_FUN_005fdf38(void *base,SIZE_T num,SIZE_T size,QSORT_COMPARATOR compar)
;
; Parameters:
...
;   shape_cramtex.cpp_CCramTex_runInteractiveAtlasGeneration_FUN_00446160 at 0044625a
...
section .text
    ...
    PUSH EBX                            ; 005fdf38
        ;   Label: crt_stdlib.c__qsort_FUN_005fdf38
    PUSH ESI                            ; 005fdf39
    PUSH EDI                            ; 005fdf3a
    PUSH ES                             ; 005fdf3b
    PUSH FS                             ; 005fdf3c
