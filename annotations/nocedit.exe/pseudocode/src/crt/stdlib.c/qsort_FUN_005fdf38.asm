...
;                               FUNCTION
; *****************************************************************************
; __watcallStack void crt_stdlib.c_qsort_FUN_005fdf38(void * base, SIZE_T num, SIZE_T size, QSORT_COMPARATOR compar)
;
; Parameters:
...
;
; XREF[10]:
;   core_script.cpp_FUN_00567630 at 005676c1
...
section .text
    ...
    JZ 0x005fdf77                       ; 005fdf6e | LAB_005fdf77
        ;   XREF to: 005fdf77 (CONDITIONAL_JUMP)
    MOV EAX,0x2                         ; 005fdf70
    JMP 0x005fdf82                      ; 005fdf75 | LAB_005fdf82
    ...
    JBE 0x005fe0ec                      ; 005fdfb7 | LAB_005fe0ec
        ;   XREF to: 005fe0ec (CONDITIONAL_JUMP)
    CMP EBX,0x10                        ; 005fdfbd
    JNC 0x005fe122                      ; 005fdfc0 | LAB_005fe122
    ...
    JLE 0x005fe0ec                      ; 005fdfd6 | LAB_005fe0ec
        ;   XREF to: 005fe0ec (CONDITIONAL_JUMP)
    ...
    JNC 0x005fe0cd                      ; 005fe00f | LAB_005fe0cd
    ...
    JA 0x005fe085                       ; 005fe02c | LAB_005fe085
        ;   XREF to: 005fe085 (CONDITIONAL_JUMP)
    JMP 0x005fe0a7                      ; 005fe02e | LAB_005fe0a7
        ;   XREF to: 005fe0a7 (UNCONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x134],0x0     ; 005fe033
        ;   Label: LAB_005fe033
    JZ 0x005fe04d                       ; 005fe03b | LAB_005fe04d
        ;   XREF to: 005fe04d (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [ESP + 0x14c]     ; 005fe03d
    MOV ECX,EBP                         ; 005fe044
    CALL crt_stdlib.c_memory_swap_FUN_005fdf10 ; 005fe046 | void crt_stdlib.c_memory_swap_FUN_005fdf10(void * ptr1, void * ptr2, SIZE_T bytes)
        ;   XREF to: 005fdf10 (UNCONDITIONAL_CALL)
    JMP 0x005fe063                      ; 005fe04b | LAB_005fe063
    ...
    JBE 0x005fe0a7                      ; 005fe083 | LAB_005fe0a7
    ...
    JG 0x005fe033                       ; 005fe0a5 | LAB_005fe033
    ...
    JC 0x005fe015                       ; 005fe0c7 | LAB_005fe015
    ...
    JMP 0x005fdfad                      ; 005fe11d | LAB_005fdfad
    ...
    JBE 0x005fe20c                      ; 005fe135 | LAB_005fe20c
    ...
    JBE 0x005fe1f0                      ; 005fe162 | LAB_005fe1f0
    ...
    PUSH EAX                            ; 005fe1a4
    CALL crt_stdlib.c_median_of_3_FUN_005fdea0 ; 005fe1a5 | void * crt_stdlib.c_median_of_3_FUN_005fdea0(void * a, void * b, void * c, QSORT_COMPARATOR compar)
    ...
    PUSH EDI                            ; 005fe1c3
    CALL crt_stdlib.c_median_of_3_FUN_005fdea0 ; 005fe1c4 | void * crt_stdlib.c_median_of_3_FUN_005fdea0(void * a, void * b, void * c, QSORT_COMPARATOR compar)
        ;   XREF to: 005fdea0 (UNCONDITIONAL_CALL)
    ...
    PUSH EBX                            ; 005fe1e5
    CALL crt_stdlib.c_median_of_3_FUN_005fdea0 ; 005fe1e6 | void * crt_stdlib.c_median_of_3_FUN_005fdea0(void * a, void * b, void * c, QSORT_COMPARATOR compar)
        ;   XREF to: 005fdea0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDX                            ; 005fe201
    CALL crt_stdlib.c_median_of_3_FUN_005fdea0 ; 005fe202 | void * crt_stdlib.c_median_of_3_FUN_005fdea0(void * a, void * b, void * c, QSORT_COMPARATOR compar)
        ;   XREF to: 005fdea0 (UNCONDITIONAL_CALL)
    ...
    JZ 0x005fe243                       ; 005fe215 | LAB_005fe243
        ;   XREF to: 005fe243 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x124]     ; 005fe217
    MOV dword ptr [ESP + 0x128],EAX     ; 005fe21e
    JZ 0x005fe232                       ; 005fe225 | LAB_005fe232
        ;   XREF to: 005fe232 (CONDITIONAL_JUMP)
    MOV ECX,EBP                         ; 005fe227
    MOV ESI,EAX                         ; 005fe229
    CALL crt_stdlib.c_memory_swap_FUN_005fdf10 ; 005fe22b | void crt_stdlib.c_memory_swap_FUN_005fdf10(void * ptr1, void * ptr2, SIZE_T bytes)
        ;   XREF to: 005fdf10 (UNCONDITIONAL_CALL)
    JMP 0x005fe25a                      ; 005fe230 | LAB_005fe25a
    ...
    JMP 0x005fe25a                      ; 005fe241 | LAB_005fe25a
        ;   XREF to: 005fe25a (UNCONDITIONAL_JUMP)
    ...
    CMP dword ptr [ESP + 0x148],0x0     ; 005fe29f
        ;   Label: LAB_005fe29f
    JZ 0x005fe33d                       ; 005fe2a7 | LAB_005fe33d
    ...
    JG 0x005fe33d                       ; 005fe2c9 | LAB_005fe33d
        ;   XREF to: 005fe33d (CONDITIONAL_JUMP)
    JNZ 0x005fe319                      ; 005fe2cb | LAB_005fe319
        ;   XREF to: 005fe319 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x134],0x0     ; 005fe2cd
    JZ 0x005fe2ee                       ; 005fe2d5 | LAB_005fe2ee
    ...
    CALL crt_stdlib.c_memory_swap_FUN_005fdf10 ; 005fe2e7 | void crt_stdlib.c_memory_swap_FUN_005fdf10(void * ptr1, void * ptr2, SIZE_T bytes)
        ;   XREF to: 005fdf10 (UNCONDITIONAL_CALL)
    JMP 0x005fe312                      ; 005fe2ec | LAB_005fe312
    ...
    JMP 0x005fe29f                      ; 005fe338 | LAB_005fe29f
        ;   XREF to: 005fe29f (UNCONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x148],0x0     ; 005fe33d
        ;   Label: LAB_005fe33d
    JZ 0x005fe3db                       ; 005fe345 | LAB_005fe3db
    ...
    JL 0x005fe3db                       ; 005fe367 | LAB_005fe3db
        ;   XREF to: 005fe3db (CONDITIONAL_JUMP)
    JNZ 0x005fe3b7                      ; 005fe369 | LAB_005fe3b7
        ;   XREF to: 005fe3b7 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x134],0x0     ; 005fe36b
    JZ 0x005fe38c                       ; 005fe373 | LAB_005fe38c
    ...
    CALL crt_stdlib.c_memory_swap_FUN_005fdf10 ; 005fe385 | void crt_stdlib.c_memory_swap_FUN_005fdf10(void * ptr1, void * ptr2, SIZE_T bytes)
        ;   XREF to: 005fdf10 (UNCONDITIONAL_CALL)
    JMP 0x005fe3b0                      ; 005fe38a | LAB_005fe3b0
    ...
    CALL crt_stdlib.c_memory_swap_FUN_005fdf10 ; 005fe403 | void crt_stdlib.c_memory_swap_FUN_005fdf10(void * ptr1, void * ptr2, SIZE_T bytes)
        ;   XREF to: 005fdf10 (UNCONDITIONAL_CALL)
    JMP 0x005fe42e                      ; 005fe408 | LAB_005fe42e
    ...
    JZ 0x005fe46e                       ; 005fe44d | LAB_005fe46e
        ;   XREF to: 005fe46e (CONDITIONAL_JUMP)
    ...
    JMP 0x005fe29f                      ; 005fe469 | LAB_005fe29f
        ;   XREF to: 005fe29f (UNCONDITIONAL_JUMP)
    ...
    JZ 0x005fe4d8                       ; 005fe4cb | LAB_005fe4d8
    ...
    DEC ECX                             ; 005fe4d5
    JNZ 0x005fe4cd                      ; 005fe4d6 | LAB_005fe4cd
        ;   XREF to: 005fe4cd (CONDITIONAL_JUMP)
    AND DL,0x3                          ; 005fe4d8
        ;   Label: LAB_005fe4d8
    JZ 0x005fe4e6                       ; 005fe4db | LAB_005fe4e6
    ...
    INC ESI                             ; 005fe4e2
    DEC EDX                             ; 005fe4e3
    JNZ 0x005fe4dd                      ; 005fe4e4 | LAB_005fe4dd
    ...
    JZ 0x005fe532                       ; 005fe525 | LAB_005fe532
    ...
    DEC ECX                             ; 005fe52f
    JNZ 0x005fe527                      ; 005fe530 | LAB_005fe527
        ;   XREF to: 005fe527 (CONDITIONAL_JUMP)
    AND DL,0x3                          ; 005fe532
        ;   Label: LAB_005fe532
    JZ 0x005fe540                       ; 005fe535 | LAB_005fe540
    ...
    INC ESI                             ; 005fe53c
    DEC EDX                             ; 005fe53d
    JNZ 0x005fe537                      ; 005fe53e | LAB_005fe537
    ...
    JC 0x005fe590                       ; 005fe576 | LAB_005fe590
    ...
    JMP 0x005fe5bc                      ; 005fe58e | LAB_005fe5bc
        ;   XREF to: 005fe5bc (UNCONDITIONAL_JUMP)
    CMP EBX,EBP                         ; 005fe590
        ;   Label: LAB_005fe590
    JBE 0x005fe0ec                      ; 005fe592 | LAB_005fe0ec
        ;   XREF to: 005fe0ec (CONDITIONAL_JUMP)
    ...
    JMP 0x005fdfad                      ; 005fe5ca | LAB_005fdfad
        ;   XREF to: 005fdfad (UNCONDITIONAL_JUMP)
