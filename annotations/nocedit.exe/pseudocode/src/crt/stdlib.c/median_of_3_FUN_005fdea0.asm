...
section .text
    ...
    JLE 0x005fdee0                      ; 005fdec2 | LAB_005fdee0
    ...
    JLE 0x005fdeeb                      ; 005fdecd | LAB_005fdeeb
    ...
    JLE 0x005fdefe                      ; 005fdedc | LAB_005fdefe
        ;   XREF to: 005fdefe (CONDITIONAL_JUMP)
    JMP 0x005fdf02                      ; 005fdede | LAB_005fdf02
    ...
    JL 0x005fdeef                       ; 005fdee9 | LAB_005fdeef
        ;   XREF to: 005fdeef (CONDITIONAL_JUMP)
    MOV EAX,EBP                         ; 005fdeeb
        ;   Label: LAB_005fdeeb
    JMP 0x005fdf06                      ; 005fdeed | LAB_005fdf06
    ...
    JLE 0x005fdf02                      ; 005fdefc | LAB_005fdf02
        ;   XREF to: 005fdf02 (CONDITIONAL_JUMP)
    MOV EAX,ESI                         ; 005fdefe
        ;   Label: LAB_005fdefe
    JMP 0x005fdf06                      ; 005fdf00 | LAB_005fdf06
        ;   XREF to: 005fdf06 (UNCONDITIONAL_JUMP)
