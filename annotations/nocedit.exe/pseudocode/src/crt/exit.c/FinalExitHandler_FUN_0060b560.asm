...
;                               FUNCTION
; *****************************************************************************
; __cdecl void crt_exit.c_FinalExitHandler_FUN_0060b560(int exit_code)
;
; Parameters:
...
section .text
    ...
    CALL dword ptr [0x00685478]         ; 0060b561 | void * PTR_crt_exit.c_ExitHookStub_FUN_0060b530_00685478
    CALL dword ptr [0x0068547c]         ; 0060b567 | void * PTR_crt_exit.c_ExitHookStub_FUN_0060b530_0068547c
    CMP dword ptr [0x006852c4],0x0      ; 0060b56d | undefined4 DAT_006852c4
    JZ 0x0060b57c                       ; 0060b574 | LAB_0060b57c
        ;   XREF to: 0060b57c (CONDITIONAL_JUMP)
    CALL dword ptr [0x006852c4]         ; 0060b576 | undefined4 DAT_006852c4
