...
section .text
    ...
    JBE 0x0060cf30                      ; 0060cf27 | LAB_0060cf30
        ;   XREF to: 0060cf30 (CONDITIONAL_JUMP)
    CMP EAX,0x1                         ; 0060cf29
    JZ 0x0060cf4c                       ; 0060cf2c | LAB_0060cf4c
        ;   XREF to: 0060cf4c (CONDITIONAL_JUMP)
    JMP 0x0060cf70                      ; 0060cf2e | LAB_0060cf70
        ;   XREF to: 0060cf70 (UNCONDITIONAL_JUMP)
    PUSH 0x4                            ; 0060cf30
        ;   Label: LAB_0060cf30
    CALL crt_signal.c_getSignalHandler_FUN_0060ceb4 ; 0060cf32 | SIGNAL_HANDLER crt_signal.c_getSignalHandler_FUN_0060ceb4(int signal_number)
        ;   XREF to: 0060ceb4 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060cf37
    MOV EBX,EAX                         ; 0060cf3a
    TEST EAX,EAX                        ; 0060cf3c
    JZ 0x0060cf7b                       ; 0060cf3e | LAB_0060cf7b
        ;   XREF to: 0060cf7b (CONDITIONAL_JUMP)
    PUSH 0x4                            ; 0060cf40
    CALL crt_signal.c_processSignal_FUN_0060d128 ; 0060cf42 | int crt_signal.c_processSignal_FUN_0060d128(int signal_number)
        ;   XREF to: 0060d128 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060cf47
    JMP 0x0060cf66                      ; 0060cf4a | LAB_0060cf66
        ;   XREF to: 0060cf66 (UNCONDITIONAL_JUMP)
    PUSH 0x7                            ; 0060cf4c
        ;   Label: LAB_0060cf4c
    CALL crt_signal.c_getSignalHandler_FUN_0060ceb4 ; 0060cf4e | SIGNAL_HANDLER crt_signal.c_getSignalHandler_FUN_0060ceb4(int signal_number)
        ;   XREF to: 0060ceb4 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060cf53
    MOV EBX,EAX                         ; 0060cf56
    TEST EAX,EAX                        ; 0060cf58
    JZ 0x0060cf7b                       ; 0060cf5a | LAB_0060cf7b
        ;   XREF to: 0060cf7b (CONDITIONAL_JUMP)
    PUSH 0x7                            ; 0060cf5c
    CALL crt_signal.c_processSignal_FUN_0060d128 ; 0060cf5e | int crt_signal.c_processSignal_FUN_0060d128(int signal_number)
        ;   XREF to: 0060d128 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060cf63
    CMP EBX,0x2                         ; 0060cf66
        ;   Label: LAB_0060cf66
    JZ 0x0060cf70                       ; 0060cf69 | LAB_0060cf70
        ;   XREF to: 0060cf70 (CONDITIONAL_JUMP)
    CMP EBX,0x3                         ; 0060cf6b
    JNZ 0x0060cf76                      ; 0060cf6e | LAB_0060cf76
