...
;                               FUNCTION
; *****************************************************************************
; __watcallStack int crt_signal.c_processSignal_FUN_0060d128(int signal_number)
;
; Parameters:
...
section .text
    ...
    PUSH ESI                            ; 0060d12e
    CALL crt_signal.c_getSignalHandler_FUN_0060ceb4 ; 0060d12f | SIGNAL_HANDLER crt_signal.c_getSignalHandler_FUN_0060ceb4(int signal_number)
        ;   XREF to: 0060ceb4 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060d134
    LEA EDX,[ESI + -0x1]                ; 0060d137
    MOV EBX,EAX                         ; 0060d13a
    CMP EDX,0xb                         ; 0060d13c
    JA 0x0060d198                       ; 0060d13f | default
        ;   XREF to: 0060d198 (CONDITIONAL_JUMP)
    JMP dword ptr CS:[EDX*0x4 + 0x60d0f8] ; 0060d141 | void * switchdataD_0060d0f8
        ;   Label: switchD
    PUSH 0x8c                           ; 0060d149
        ;   Label: caseD_2
    CALL crt_signal.c_raiseFPE_FUN_0060d028 ; 0060d14e | int crt_signal.c_raiseFPE_FUN_0060d028(int fpe_code)
    ...
    CMP EAX,0x2                         ; 0060d15b
        ;   Label: caseD_1
    JNZ 0x0060d165                      ; 0060d15e | caseD_b
        ;   XREF to: 0060d165 (CONDITIONAL_JUMP)
    CALL crt_startup.c_reportAbnormalTermination_FUN_00601628 ; 0060d160 | void crt_startup.c_reportAbnormalTermination_FUN_00601628()
        ;   XREF to: 00601628 (UNCONDITIONAL_CALL)
    CMP EBX,0x1                         ; 0060d165
        ;   Label: caseD_c
    JZ 0x0060d185                       ; 0060d168 | LAB_0060d185
        ;   XREF to: 0060d185 (CONDITIONAL_JUMP)
    CMP EBX,0x2                         ; 0060d16a
    JZ 0x0060d185                       ; 0060d16d | LAB_0060d185
        ;   XREF to: 0060d185 (CONDITIONAL_JUMP)
    CMP EBX,0x3                         ; 0060d16f
    JZ 0x0060d185                       ; 0060d172 | LAB_0060d185
        ;   XREF to: 0060d185 (CONDITIONAL_JUMP)
    PUSH 0x2                            ; 0060d174
    PUSH ESI                            ; 0060d176
    CALL crt_signal.c_setSignalHandler_FUN_0060ce60 ; 0060d177 | SIGNAL_HANDLER crt_signal.c_setSignalHandler_FUN_0060ce60(int signal_number, SIGNAL_HANDLER new_handler)
        ;   XREF to: 0060ce60 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0060d17c
    PUSH ESI                            ; 0060d17f
    CALL EBX                            ; 0060d180
    ADD ESP,0x4                         ; 0060d182
    CALL crt_unknown.c_FUN_0060cf80     ; 0060d185 | undefined crt_unknown.c_FUN_0060cf80()
        ;   Label: LAB_0060d185
        ;   XREF to: 0060cf80 (UNCONDITIONAL_CALL)
    TEST EAX,EAX                        ; 0060d18a
    JNZ 0x0060d1a0                      ; 0060d18c | LAB_0060d1a0
        ;   XREF to: 0060d1a0 (CONDITIONAL_JUMP)
    CALL crt_signal.c_unregisterConsoleHandler_FUN_0060cfe4 ; 0060d18e | undefined crt_signal.c_unregisterConsoleHandler_FUN_0060cfe4()
