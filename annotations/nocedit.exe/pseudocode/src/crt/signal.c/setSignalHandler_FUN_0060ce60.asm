...
section .text
    ...
    JZ 0x0060ce70                       ; 0060ce69 | LAB_0060ce70
        ;   XREF to: 0060ce70 (CONDITIONAL_JUMP)
    CMP EBX,0x4                         ; 0060ce6b
    JNZ 0x0060ce8c                      ; 0060ce6e | LAB_0060ce8c
        ;   XREF to: 0060ce8c (CONDITIONAL_JUMP)
    LEA EAX,[EBX*0x8 + 0x0]             ; 0060ce70
        ;   Label: LAB_0060ce70
    MOV ESI,dword ptr [ESP + 0x10]      ; 0060ce77
    MOV EBX,dword ptr [EAX + 0x685504]  ; 0060ce7b | SIGNAL_HANDLER[16] g_GlobalSignalHandlers
    MOV dword ptr [EAX + 0x685504],ESI  ; 0060ce81 | SIGNAL_HANDLER[16] g_GlobalSignalHandlers
    ...
    LEA ESI,[EBX*0x8 + 0x0]             ; 0060ce8c
        ;   Label: LAB_0060ce8c
    CALL dword ptr [0x00684ee4]         ; 0060ce93 | GET_TLS_FUNC * PTR_crt_thread.c_GetTLS_FUN_0060242c_00684ee4
    MOV EBX,dword ptr [ESI + EAX*0x1 + 0x58] ; 0060ce99
    CALL dword ptr [0x00684ee4]         ; 0060ce9d | GET_TLS_FUNC * PTR_crt_thread.c_GetTLS_FUN_0060242c_00684ee4
