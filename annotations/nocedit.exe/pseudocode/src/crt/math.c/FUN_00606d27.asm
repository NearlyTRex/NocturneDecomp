...
;                               FUNCTION
; *****************************************************************************
; unknown undefined crt_math.c_FUN_00606d27()
;
; Parameters:
...
section .text
    ...
    FSTP extended double ptr [ESP + 0xc] ; 00606d27
        ;   Label: crt_math.c_FUN_00606d27
    FXCH ST4                            ; 00606d2b
    FLD ST0                             ; 00606d2d
    FSTP extended double ptr [ESP]      ; 00606d2f
    FSTP extended double ptr [ESP + 0x20] ; 00606d32
    CALL crt_math.c_fdiv_FUN_00606960   ; 00606d36 | float10 crt_math.c_fdiv_FUN_00606960(float10 dividend, float10 divisor)
