...
section .text
    ...
    SAHF                                ; 005ffd88
    JNZ 0x005ffdae                      ; 005ffd89
        ;   XREF to: 005ffdae (CONDITIONAL_JUMP)  ; LAB_005ffdae
    MOV AL,0x0                          ; 005ffd8b
    FSTP ST0                            ; 005ffd8d
        ;   Label: LAB_005ffd8d
    ...
    CALL crt_math.c_math_domain_error_FUN_00606832 ; 005ffd98
        ;   XREF to: 00606832 (UNCONDITIONAL_CALL)  ; double crt_math.c_math_domain_error_FUN_00606832(double x, double y, uchar error_type)
    ...
    WAIT                                ; 005ffda8
    JMP 0x005ffea7                      ; 005ffda9
        ;   XREF to: 005ffea7 (UNCONDITIONAL_JUMP)  ; LAB_005ffea7
    FLD ST1                             ; 005ffdae
        ;   Label: LAB_005ffdae
    FRNDINT                             ; 005ffdb0
    FCOMP ST2                           ; 005ffdb2
    ...
    JNC 0x005ffdf9                      ; 005ffdbc
        ;   XREF to: 005ffdf9 (CONDITIONAL_JUMP)  ; LAB_005ffdf9
    MOV AL,0x1                          ; 005ffdbe
    SAHF                                ; 005ffdc0
    JNZ 0x005ffd8d                      ; 005ffdc1
        ;   XREF to: 005ffd8d (CONDITIONAL_JUMP)  ; LAB_005ffd8d
    MOV AX,0x2                          ; 005ffdc3
    ...
    SAHF                                ; 005ffdda
    MOV AH,0x0                          ; 005ffddb
    JP 0x005ffdf0                       ; 005ffddd
        ;   XREF to: 005ffdf0 (CONDITIONAL_JUMP)  ; LAB_005ffdf0
    FTST                                ; 005ffddf
    ...
    FSTP ST0                            ; 005ffdf3
    FSTP ST0                            ; 005ffdf5
    JMP 0x005ffe01                      ; 005ffdf7
        ;   XREF to: 005ffe01 (UNCONDITIONAL_JUMP)  ; LAB_005ffe01
    SAHF                                ; 005ffdf9
        ;   Label: LAB_005ffdf9
    JZ 0x005ffe01                       ; 005ffdfa
        ;   XREF to: 005ffe01 (CONDITIONAL_JUMP)  ; LAB_005ffe01
    JMP 0x005ffe88                      ; 005ffdfc
        ;   XREF to: 005ffe88 (UNCONDITIONAL_JUMP)  ; LAB_005ffe88
    FLD ST1                             ; 005ffe01
        ;   Label: LAB_005ffe01
    ...
    JNC 0x005ffe88                      ; 005ffe17
        ;   XREF to: 005ffe88 (CONDITIONAL_JUMP)  ; LAB_005ffe88
    FLD ST1                             ; 005ffe19
    FISTP dword ptr [EBP + -0x4]        ; 005ffe1b
    WAIT                                ; 005ffe1e
    MOV AX,word ptr [EBP + -0x2]        ; 005ffe1f
    OR AX,AX                            ; 005ffe23
    JNZ 0x005ffe33                      ; 005ffe26
        ;   XREF to: 005ffe33 (CONDITIONAL_JUMP)  ; LAB_005ffe33
    MOV AX,word ptr [EBP + -0x4]        ; 005ffe28
    CALL crt_math.c_integer_power_FUN_005ffeb2 ; 005ffe2c
        ;   XREF to: 005ffeb2 (UNCONDITIONAL_CALL)  ; float10 crt_math.c_integer_power_FUN_005ffeb2(float10 base, ushort exponent)
    JMP 0x005ffe5e                      ; 005ffe31
        ;   XREF to: 005ffe5e (UNCONDITIONAL_JUMP)  ; LAB_005ffe5e
    INC AX                              ; 005ffe33
        ;   Label: LAB_005ffe33
    JNZ 0x005ffe88                      ; 005ffe35
        ;   XREF to: 005ffe88 (CONDITIONAL_JUMP)  ; LAB_005ffe88
    OR AX,word ptr [EBP + -0x4]         ; 005ffe37
    JZ 0x005ffe88                       ; 005ffe3b
        ;   XREF to: 005ffe88 (CONDITIONAL_JUMP)  ; LAB_005ffe88
    NEG AX                              ; 005ffe3d
    CALL crt_math.c_integer_power_FUN_005ffeb2 ; 005ffe40
        ;   XREF to: 005ffeb2 (UNCONDITIONAL_CALL)  ; float10 crt_math.c_integer_power_FUN_005ffeb2(float10 base, ushort exponent)
    FLD1                                ; 005ffe45
    TEST byte ptr [0x00685060],0x1      ; 005ffe47 | g_UseSoftwareMath
    JNZ 0x005ffe54                      ; 005ffe4e
        ;   XREF to: 005ffe54 (CONDITIONAL_JUMP)  ; LAB_005ffe54
    FDIVRP                              ; 005ffe50
    JMP 0x005ffe5e                      ; 005ffe52
        ;   XREF to: 005ffe5e (UNCONDITIONAL_JUMP)  ; LAB_005ffe5e
    ...
    JNZ 0x005ffe84                      ; 005ffe6e
        ;   XREF to: 005ffe84 (CONDITIONAL_JUMP)  ; LAB_005ffe84
    MOV AX,word ptr [EBP + -0x2]        ; 005ffe70
    SHL AX,0x1                          ; 005ffe74
    CMP AX,0xffe0                       ; 005ffe77
    JNZ 0x005ffe84                      ; 005ffe7b
        ;   XREF to: 005ffe84 (CONDITIONAL_JUMP)  ; LAB_005ffe84
    MOV AL,0x2                          ; 005ffe7d
        ;   Label: LAB_005ffe7d
    JMP 0x005ffd8d                      ; 005ffe7f
        ;   XREF to: 005ffd8d (UNCONDITIONAL_JUMP)  ; LAB_005ffd8d
    FSTP ST1                            ; 005ffe84
        ;   Label: LAB_005ffe84
    JMP 0x005ffea7                      ; 005ffe86
        ;   XREF to: 005ffea7 (UNCONDITIONAL_JUMP)  ; LAB_005ffea7
    FLDLN2                              ; 005ffe88
        ;   Label: LAB_005ffe88
    FMUL ST2                            ; 005ffe8a
    ...
    FYL2X                               ; 005ffe90
    MOV AL,0x7                          ; 005ffe92
    CALL crt_math.c_exp_FUN_006068e2    ; 005ffe94
        ;   XREF to: 006068e2 (UNCONDITIONAL_CALL)  ; float10 crt_math.c_exp_FUN_006068e2(float10 x)
    CMP AL,0x0                          ; 005ffe99
    JNZ 0x005ffe7d                      ; 005ffe9b
        ;   XREF to: 005ffe7d (CONDITIONAL_JUMP)  ; LAB_005ffe7d
    MOV AH,byte ptr [EBP + -0x7]        ; 005ffe9d
    SAHF                                ; 005ffea0
    JNC 0x005ffea5                      ; 005ffea1
        ;   XREF to: 005ffea5 (CONDITIONAL_JUMP)  ; LAB_005ffea5
    FCHS                                ; 005ffea3
    FSTP ST1                            ; 005ffea5
        ;   Label: LAB_005ffea5
