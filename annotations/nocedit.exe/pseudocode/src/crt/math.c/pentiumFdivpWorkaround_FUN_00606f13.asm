...
;                               FUNCTION
; *****************************************************************************
; __fpustack float10 crt_math.c_pentiumFdivpWorkaround_FUN_00606f13(float10 dividend, float10 divisor)
;
; Local Variables:
...
section .text
    ...
    CALL crt_math.c_ieee754_divide_FUN_00606960 ; 00606f1d | float10 crt_math.c_ieee754_divide_FUN_00606960(float10 dividend, float10 divisor)
