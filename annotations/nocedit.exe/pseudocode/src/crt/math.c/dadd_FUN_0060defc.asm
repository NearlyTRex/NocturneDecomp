...
;                               FUNCTION
; *****************************************************************************
; __watcallRegister double __watcallRegister crt_math_c_dadd_FUN_0060defc(double a,double b)
;
; Local Variables:
...
section .text
    ...
    OR EBX,EBX                          ; 0060df02
    JNZ 0x0060df0c                      ; 0060df04
        ;   XREF to: 0060df0c (CONDITIONAL_JUMP)  ; LAB_0060df0c
    ADD ECX,ECX                         ; 0060df06
    JZ 0x0060df18                       ; 0060df08
        ;   XREF to: 0060df18 (CONDITIONAL_JUMP)  ; LAB_0060df18
    RCR ECX,0x1                         ; 0060df0a
    OR EAX,EAX                          ; 0060df0c
        ;   Label: LAB_0060df0c
    JNZ 0x0060df1b                      ; 0060df0e
        ;   XREF to: 0060df1b (CONDITIONAL_JUMP)  ; LAB_0060df1b
    ADD EDX,EDX                         ; 0060df10
    JNZ 0x0060df19                      ; 0060df12
        ;   XREF to: 0060df19 (CONDITIONAL_JUMP)  ; LAB_0060df19
    ...
    JNZ 0x0060df44                      ; 0060df3e
        ;   XREF to: 0060df44 (CONDITIONAL_JUMP)  ; LAB_0060df44
    ...
    OR DI,DI                            ; 0060df7b
    JZ 0x0060df86                       ; 0060df7e
        ;   XREF to: 0060df86 (CONDITIONAL_JUMP)  ; LAB_0060df86
    OR EDX,0x100000                     ; 0060df80
    OR CX,CX                            ; 0060df86
        ;   Label: LAB_0060df86
    JZ 0x0060df91                       ; 0060df89
        ;   XREF to: 0060df91 (CONDITIONAL_JUMP)  ; LAB_0060df91
    ...
    SUB CX,DI                           ; 0060df99
    JZ 0x0060dfcd                       ; 0060df9c
        ;   XREF to: 0060dfcd (CONDITIONAL_JUMP)  ; LAB_0060dfcd
    JNC 0x0060dfa8                      ; 0060df9e
        ;   XREF to: 0060dfa8 (CONDITIONAL_JUMP)  ; LAB_0060dfa8
    ...
    OR ECX,ECX                          ; 0060dfcd
        ;   Label: LAB_0060dfcd
    JNS 0x0060dfde                      ; 0060dfcf
        ;   XREF to: 0060dfde (CONDITIONAL_JUMP)  ; LAB_0060dfde
    NEG ESI                             ; 0060dfd1
    NEG EBX                             ; 0060dfd3
    ...
    SUB EDI,EDI                         ; 0060dfde
        ;   Label: LAB_0060dfde
    CMP CL,0x0                          ; 0060dfe0
    JZ 0x0060e008                       ; 0060dfe3
        ;   XREF to: 0060e008 (CONDITIONAL_JUMP)  ; LAB_0060e008
    PUSH EBX                            ; 0060dfe5
    SUB EBX,EBX                         ; 0060dfe6
    CMP CL,0x20                         ; 0060dfe8
    JC 0x0060dffa                       ; 0060dfeb
        ;   XREF to: 0060dffa (CONDITIONAL_JUMP)  ; LAB_0060dffa
    OR EAX,EAX                          ; 0060dfed
    SETNZ BL                            ; 0060dfef
    ...
    JNS 0x0060e031                      ; 0060e00c
        ;   XREF to: 0060e031 (CONDITIONAL_JUMP)  ; LAB_0060e031
    CMP CL,0x35                         ; 0060e00e
    JC 0x0060e024                       ; 0060e011
        ;   XREF to: 0060e024 (CONDITIONAL_JUMP)  ; LAB_0060e024
    ...
    MOV EBX,EAX                         ; 0060e031
        ;   Label: LAB_0060e031
    OR EBX,EDX                          ; 0060e033
    JZ 0x0060e0a1                       ; 0060e035
        ;   XREF to: 0060e0a1 (CONDITIONAL_JUMP)  ; LAB_0060e0a1
    OR BP,BP                            ; 0060e037
    JZ 0x0060e0a5                       ; 0060e03a
        ;   XREF to: 0060e0a5 (CONDITIONAL_JUMP)  ; LAB_0060e0a5
    TEST EDX,0x7fe00000                 ; 0060e03c
        ;   Label: LAB_0060e03c
    JNZ 0x0060e04e                      ; 0060e042
        ;   XREF to: 0060e04e (CONDITIONAL_JUMP)  ; LAB_0060e04e
    DEC BP                              ; 0060e044
    JZ 0x0060e0a5                       ; 0060e046
        ;   XREF to: 0060e0a5 (CONDITIONAL_JUMP)  ; LAB_0060e0a5
    ADD EAX,EAX                         ; 0060e048
    ADC EDX,EDX                         ; 0060e04a
    JMP 0x0060e03c                      ; 0060e04c
        ;   XREF to: 0060e03c (UNCONDITIONAL_JUMP)  ; LAB_0060e03c
    TEST EDX,0x400000                   ; 0060e04e | IMAGE_DOS_HEADER_00400000
        ;   Label: LAB_0060e04e
    JZ 0x0060e066                       ; 0060e054
        ;   XREF to: 0060e066 (CONDITIONAL_JUMP)  ; LAB_0060e066
    SHR EDX,0x1                         ; 0060e056
    RCR EAX,0x1                         ; 0060e058
    ADC EDI,0x0                         ; 0060e05a
    INC BP                              ; 0060e05d
    CMP BP,0x7ff                        ; 0060e05f
    JZ 0x0060e0af                       ; 0060e064
        ;   XREF to: 0060e0af (CONDITIONAL_JUMP)  ; LAB_0060e0af
    SHR EDX,0x1                         ; 0060e066
        ;   Label: LAB_0060e066
    RCR EAX,0x1                         ; 0060e068
    JNC 0x0060e090                      ; 0060e06a
        ;   XREF to: 0060e090 (CONDITIONAL_JUMP)  ; LAB_0060e090
    OR EDI,EDI                          ; 0060e06c
    SETNZ BL                            ; 0060e06e
    OR EBX,EAX                          ; 0060e071
