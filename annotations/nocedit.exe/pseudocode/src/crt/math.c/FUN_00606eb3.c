...
// Convention: unknown
// Signature: undefined crt_math.c_FUN_00606eb3()

#include "nocturne.h"

unkbyte10 crt_math_c_FUN_00606eb3(void)

{
  ...
  return CONCAT64 /* combine 2-byte values */(uStack00000020,in_stack_0000001c);
}
