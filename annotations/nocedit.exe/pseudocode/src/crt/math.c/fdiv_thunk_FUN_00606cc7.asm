...
;                               FUNCTION
; *****************************************************************************
; __fpu_thunk float10 crt_math.c_fdiv_thunk_FUN_00606cc7(void)
;
; Parameters:
...
section .text
    ...
    CALL crt_math.c_fdiv_FUN_00606960   ; 00606cd8 | float10 crt_math.c_fdiv_FUN_00606960(float10 dividend, float10 divisor)
