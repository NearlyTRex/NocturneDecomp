...

{
  ...
  uVar14 = SUB84 /* extract 2-byte value */(b,0);
  uVar13 = (uint)((ulonglong)a >> 0x20);
  uVar15 = SUB84 /* extract 2-byte value */(a,0);
  if (uVar15 == 0) {
  ...
  if (DAT_00684acd != '\0') {
    dVar21 = (double)CONCAT44 /* combine 2-byte values */(uVar13,uVar15) * (double)CONCAT44 /* combine 2-byte values */(uVar10,uVar14);
  ...
  if ((short)uVar18 == 0) {
    uVar11 = CONCAT22 /* combine 2-byte values */(uVar9,1);
    do {
  ...
  uVar18 = CONCAT22 /* combine 2-byte values */((short)(uVar11 >> 0x10),uVar9);
  ...
  uVar6 = (ulonglong)uVar13 * (ulonglong)uVar16 +
          CONCAT44 /* combine 2-byte values */((uint)CARRY4((uint)((ulonglong)lVar2 >> 0x20),(uint)CARRY4(uVar10,(uint)lVar2)) +
    ...
    if ((uVar6 & 0x20000000000000) == 0) {
      if (CARRY4(uVar15,uVar15)) {
        ...
        if ((uVar8 & 0x20000000000000) != 0) {
          uVar6 = CONCAT44 /* combine 2-byte values */((uint)(uVar8 >> 0x21),
      ...
      if (sVar17 < 1) {
        ...
        uVar6 = CONCAT44 /* combine 2-byte values */(uVar15 >> bVar5 | 0 << 0x20 - bVar5,
                         (uint)uVar6 >> bVar4 | uVar15 << 0x20 - bVar4);
        uVar18 = uVar18 & 0xffff0000;
      }
      return (double)CONCAT44 /* combine 2-byte values */((uint)(uVar6 >> 0x20) & 0xfffff |
                              (uVar18 << 0x15) >> 1 | (uint)CARRY4(uVar18,uVar18) << 0x1f,(int)uVar6
                             );
    }
    uVar8 = uVar6 & 1;
    uVar6 = CONCAT44 /* combine 2-byte values */((uint)(uVar6 >> 0x21),
