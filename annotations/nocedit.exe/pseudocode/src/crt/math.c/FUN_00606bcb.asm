...
;                               FUNCTION
; *****************************************************************************
; unknown undefined crt_math.c_FUN_00606bcb()
;
; Parameters:
...
section .text
    ...
    CALL crt_math.c_fdiv_FUN_00606960   ; 00606bd4 | float10 crt_math.c_fdiv_FUN_00606960(float10 dividend, float10 divisor)
