...
;                               FUNCTION
; *****************************************************************************
; __fpustack float10 crt_math.c_sqrt_FUN_0060710c(float10 value_to_sqrt, float10 original_value)
;
; Local Variables:
...
section .text
    ...
    WAIT                                ; 0060713d
    MOV AL,0x1                          ; 0060713e
    JMP 0x00607146                      ; 00607140 | LAB_00607146
