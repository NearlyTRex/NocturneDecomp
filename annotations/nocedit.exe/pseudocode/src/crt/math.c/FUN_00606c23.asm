...
;                               FUNCTION
; *****************************************************************************
; unknown undefined crt_math.c_FUN_00606c23()
;
; Parameters:
...
section .text
    ...
    FXCH ST3                            ; 00606c23
        ;   Label: crt_math.c_FUN_00606c23
    FSTP extended double ptr [ESP + 0xc] ; 00606c25
    FXCH ST2                            ; 00606c29
    FLD ST0                             ; 00606c2b
    FSTP extended double ptr [ESP]      ; 00606c2d
    FSTP extended double ptr [ESP + 0x20] ; 00606c30
    CALL crt_math.c_fdiv_FUN_00606960   ; 00606c34 | float10 crt_math.c_fdiv_FUN_00606960(float10 dividend, float10 divisor)
