// Name: crt_math.c_fdiv_thunk_FUN_00606cfb
// Address: 00606cfb
// Address Range: [[00606cfb, 00606d12]]
// Convention: __fpu_thunk
// Signature: float10 __fpu_thunk crt_math_c_fdiv_thunk_FUN_00606cfb(void)
...

{
  ...
  local_res0 = (ulonglong)in_ST4;
  uStack00000008 = (ushort)((unkuint10)in_ST4 >> 0x40);
