...
;                               FUNCTION
; *****************************************************************************
; __watcallRegister float10 crt_math.c_atan2_pi_half_plus_epilogue_FUN_0060c608(void)
;
;
; Referenced Globals:
...
section .text
    ...
    FLD extended double ptr [0x0068750e] ; 0060c608 | float10 g_HalfCalculatedPi
