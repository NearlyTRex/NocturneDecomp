...
section .text
    ...
    CMP DL,0x1                          ; 0060c035
    JC 0x0060c06b                       ; 0060c038 | LAB_0060c06b
        ;   XREF to: 0060c06b (CONDITIONAL_JUMP)
    CMP DL,0x3                          ; 0060c03a
    JBE 0x0060c046                      ; 0060c03d | LAB_0060c046
        ;   XREF to: 0060c046 (CONDITIONAL_JUMP)
    CMP DL,0x4                          ; 0060c03f
    JZ 0x0060c057                       ; 0060c042 | LAB_0060c057
        ;   XREF to: 0060c057 (CONDITIONAL_JUMP)
    JMP 0x0060c06b                      ; 0060c044 | LAB_0060c06b
    ...
    OR BH,0x20                          ; 0060c051
    PUSH EBX                            ; 0060c054
    JMP 0x0060c08d                      ; 0060c055 | LAB_0060c08d
    ...
    OR CH,0x81                          ; 0060c071
    CMP DL,0x6                          ; 0060c074
    JNZ 0x0060c088                      ; 0060c077 | LAB_0060c088
        ;   XREF to: 0060c088 (CONDITIONAL_JUMP)
    FLDZ                                ; 0060c079
    FCOMP double ptr [EBP + 0x8]        ; 0060c07b
    FNSTSW AX                           ; 0060c07e
    SAHF                                ; 0060c080
    JBE 0x0060c088                      ; 0060c081 | LAB_0060c088
        ;   XREF to: 0060c088 (CONDITIONAL_JUMP)
    OR BH,0x11                          ; 0060c083
    ...
    PUSH EBX                            ; 0060c08b
    PUSH ECX                            ; 0060c08c
    CALL crt_math.c_set_math_errno_FUN_0060befa ; 0060c08d | double crt_math.c_set_math_errno_FUN_0060befa(int errorFlags, double * valuePtr)
        ;   Label: LAB_0060c08d
