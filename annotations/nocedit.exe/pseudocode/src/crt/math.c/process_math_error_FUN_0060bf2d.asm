...
section .text
    ...
    JMP 0x0060c000                      ; 0060bfcb | LAB_0060c000
        ;   XREF to: 0060c000 (UNCONDITIONAL_JUMP)
    TEST DH,0x40                        ; 0060bfcd
        ;   Label: LAB_0060bfcd
    JZ 0x0060bfe1                       ; 0060bfd0 | LAB_0060bfe1
    ...
    JMP 0x0060c000                      ; 0060bfdf | LAB_0060c000
        ;   XREF to: 0060c000 (UNCONDITIONAL_JUMP)
    TEST DH,0x80                        ; 0060bfe1
        ;   Label: LAB_0060bfe1
    JZ 0x0060bff5                       ; 0060bfe4 | LAB_0060bff5
        ;   XREF to: 0060bff5 (CONDITIONAL_JUMP)
    MOV EAX,[0x00665f30]                ; 0060bfe6 | double g_PositiveInfinity
    MOV dword ptr [EBP + -0x20],EAX     ; 0060bfeb
    MOV EAX,[0x00665f34]                ; 0060bfee | g_PositiveInfinity+4
    JMP 0x0060bffd                      ; 0060bff3 | LAB_0060bffd
    ...
    LEA EAX,[EBP + -0x38]               ; 0060c000
        ;   Label: LAB_0060c000
    PUSH EAX                            ; 0060c003
    CALL crt_math.c_report_math_error_FUN_0060e2e5 ; 0060c004 | double crt_math.c_report_math_error_FUN_0060e2e5(MathErrorContext * errorCtx)
