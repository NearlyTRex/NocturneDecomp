...
section .text
    ...
    CALL crt_stdio.c_get_standard_file_handle_FUN_0060b7a0 ; 0060e29e
        ;   XREF to: 0060b7a0 (UNCONDITIONAL_CALL)  ; FILE * crt_stdio.c_get_standard_file_handle_FUN_0060b7a0(int fd)
    ...
    CALL crt_stdio.c_fputs_FUN_0060ebb0 ; 0060e2b4
        ;   XREF to: 0060ebb0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fputs_FUN_0060ebb0(char * str, FILE * file)
