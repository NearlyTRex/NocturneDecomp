...
section .text
    ...
    PUSH 0x3f9b8b0                      ; 0060a19c | ReentrantCriticalSection g_GlobalThreadCriticalSection
        ;   Label: crt_sync.c_enter_global_thread_critical_section_FUN_0060a19c
    CALL crt_sync.c_enter_reentrant_critical_section_FUN_0060a060 ; 0060a1a1 | void crt_sync.c_enter_reentrant_critical_section_FUN_0060a060(ReentrantCriticalSection * rcs)
