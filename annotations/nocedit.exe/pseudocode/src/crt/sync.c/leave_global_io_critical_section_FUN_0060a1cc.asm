...
section .text
    ...
    PUSH 0x3f9bfe0                      ; 0060a1cc | ReentrantCriticalSection g_GlobalIoCriticalSection
        ;   Label: crt_sync.c_leave_global_io_critical_section_FUN_0060a1cc
    CALL crt_sync.c_leave_reentrant_critical_section_FUN_0060a0c4 ; 0060a1d1 | void crt_sync.c_leave_reentrant_critical_section_FUN_0060a0c4(ReentrantCriticalSection * rcs)
