...
section .text
    ...
    PUSH 0x3f9b8a0                      ; 0060a0fc | ReentrantCriticalSection g_GlobalSystemCriticalSection
        ;   Label: crt_sync.c_leave_global_critical_section_FUN_0060a0fc
    CALL crt_sync.c_leave_reentrant_critical_section_FUN_0060a0c4 ; 0060a101 | void crt_sync.c_leave_reentrant_critical_section_FUN_0060a0c4(ReentrantCriticalSection * rcs)
