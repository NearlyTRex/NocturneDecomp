...
section .text
    ...
    PUSH EBX                            ; 00600cf0
        ;   Label: crt_io.c_chsize_FUN_00600cf0
    PUSH ESI                            ; 00600cf1
    PUSH EDI                            ; 00600cf2
    PUSH EBP                            ; 00600cf3
    ...
    CALL crt_errno.c___set_errno_FUN_006083fc ; 00600d81
    ...
    CALL crt_errno.c___set_errno_FUN_006083fc ; 00600da7
        ;   XREF to: 006083fc (UNCONDITIONAL_CALL)  ; DWORD crt_errno.c___set_errno_FUN_006083fc()
    ...
    CALL crt_errno.c___set_errno_FUN_006083fc ; 00600df5
        ;   XREF to: 006083fc (UNCONDITIONAL_CALL)  ; DWORD crt_errno.c___set_errno_FUN_006083fc()
