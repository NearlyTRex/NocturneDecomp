...
section .text
    ...
    CALL crt_time.c_filetime_to_time_t_FUN_00609da0 ; 006022c2 | time_t crt_time.c_filetime_to_time_t_FUN_00609da0(FILETIME * filetime)
        ;   XREF to: 00609da0 (UNCONDITIONAL_CALL)
    ...
    CMP AL,0x0                          ; 006022db
    JZ 0x006022ef                       ; 006022dd | LAB_006022ef
    ...
    CMP AL,0x0                          ; 006022eb
    JNZ 0x006022d7                      ; 006022ed | LAB_006022d7
