...
;
; XREF[1]:
;   crt_stdio.c_fclose_force_FUN_00601fd0 at 0060207e
;
; Called Functions:
...
section .text
    ...
    CALL crt_process.c_getpid_FUN_006099c0 ; 00601f24
        ;   XREF to: 006099c0 (UNCONDITIONAL_CALL)  ; undefined crt_process.c_getpid_FUN_006099c0()
    MOV EBP,EAX                         ; 00601f29
    SHR EBP,0x10                        ; 00601f2b
    MOV EDI,EBX                         ; 00601f2e
    OR EBP,EAX                          ; 00601f30
    CALL crt_io.c_getTempDirectory_FUN_00609afc ; 00601f32
        ;   XREF to: 00609afc (UNCONDITIONAL_CALL)  ; undefined crt_io.c_getTempDirectory_FUN_00609afc()
    ...
    CMP AL,0x0                          ; 00601f3e
    JZ 0x00601f52                       ; 00601f40
        ;   XREF to: 00601f52 (CONDITIONAL_JUMP)  ; LAB_00601f52
    MOV AL,byte ptr [ESI + 0x1]         ; 00601f42
    ADD ESI,0x2                         ; 00601f45
    MOV byte ptr [EDI + 0x1],AL         ; 00601f48
    ADD EDI,0x2                         ; 00601f4b
    CMP AL,0x0                          ; 00601f4e
    JNZ 0x00601f3a                      ; 00601f50
        ;   XREF to: 00601f3a (CONDITIONAL_JUMP)  ; LAB_00601f3a
    POP EDI                             ; 00601f52
        ;   Label: LAB_00601f52
    PUSH ES                             ; 00601f53
    MOV AX,DS                           ; 00601f54
    ...
    CALL crt_string.c_hexDigitToChar_FUN_00601f0c ; 00601f78
        ;   XREF to: 00601f0c (UNCONDITIONAL_CALL)  ; char crt_string.c_hexDigitToChar_FUN_00601f0c(int digit)
    ADD ESP,0x4                         ; 00601f7d
    MOV byte ptr [EBX + 0x1],AL         ; 00601f80
    CMP EBX,ESI                         ; 00601f83
    JNZ 0x00601f6e                      ; 00601f85
        ;   XREF to: 00601f6e (CONDITIONAL_JUMP)  ; LAB_00601f6e
    MOV EAX,dword ptr [ESP + 0x18]      ; 00601f87
    SAR EAX,0x4                         ; 00601f8b
    AND EAX,0xf                         ; 00601f8e
    PUSH EAX                            ; 00601f91
    MOV byte ptr [EDI + 0x5],0x5f       ; 00601f92
    CALL crt_string.c_hexDigitToChar_FUN_00601f0c ; 00601f96
        ;   XREF to: 00601f0c (UNCONDITIONAL_CALL)  ; char crt_string.c_hexDigitToChar_FUN_00601f0c(int digit)
    ...
    PUSH EAX                            ; 00601fa8
    CALL crt_string.c_hexDigitToChar_FUN_00601f0c ; 00601fa9
        ;   XREF to: 00601f0c (UNCONDITIONAL_CALL)  ; char crt_string.c_hexDigitToChar_FUN_00601f0c(int digit)
