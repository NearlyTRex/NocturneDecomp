...
section .text
    ...
    CALL dword ptr [0x00684f18]         ; 00608af9 | ENTER_THREAD_CRITICAL_SECTION_FUNC * PTR_crt_sync.c_EnterCriticalSection_FUN_00602434_00684f18
    TEST EBX,EBX                        ; 00608aff
    JLE 0x00608b18                      ; 00608b01 | LAB_00608b18
        ;   XREF to: 00608b18 (CONDITIONAL_JUMP)
    CMP EBX,dword ptr [0x00685270]      ; 00608b03 | undefined4 g_CurrentHandleCount
    JGE 0x00608b18                      ; 00608b09 | LAB_00608b18
        ;   XREF to: 00608b18 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x0068526c]      ; 00608b0b | SIOControlBlock * g_IOControlBlock
    MOV dword ptr [EDX + EBX*0x4],0x0   ; 00608b11
    CALL dword ptr [0x00684f1c]         ; 00608b18 | EXIT_THREAD_CRITICAL_SECTION_FUNC * PTR_crt_sync.c_ExitCriticalSection_FUN_00602434_00684f1c
        ;   Label: LAB_00608b18
    POP EBX                             ; 00608b1e
    RET                                 ; 00608b1f
