...
;                               FUNCTION
; *****************************************************************************
; __watcallStack int crt_io.c_check_file_access_FUN_0060c9f0(char * filename, int access_mode)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 0060c9f4
    CALL dword ptr CS:[0x611594]        ; 0060c9f5 | GetFileAttributesA * PTR_GetFileAttributesA_00611594
    CMP EAX,-0x1                        ; 0060c9fc
    JZ 0x006083fc                       ; 0060c9ff
        ;   XREF to: 006083fc (CONDITIONAL_JUMP)
    TEST byte ptr [ESP + 0x8],0x2       ; 0060ca05
    JZ 0x0060ca1b                       ; 0060ca0a | LAB_0060ca1b
        ;   XREF to: 0060ca1b (CONDITIONAL_JUMP)
    TEST AL,0x1                         ; 0060ca0c
    JZ 0x0060ca1b                       ; 0060ca0e | LAB_0060ca1b
        ;   XREF to: 0060ca1b (CONDITIONAL_JUMP)
    PUSH 0x5                            ; 0060ca10
    CALL crt_errno.c_convertWindowsErrorToErrno_FUN_00608390 ; 0060ca12 | int crt_errno.c_convertWindowsErrorToErrno_FUN_00608390(DWORD windows_error)
