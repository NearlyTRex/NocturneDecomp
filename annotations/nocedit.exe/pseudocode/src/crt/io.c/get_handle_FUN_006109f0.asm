...
;                               FUNCTION
; *****************************************************************************
; __cdecl undefined crt_io.c_get_handle_FUN_006109f0(int fd)
;
; Parameters:
; int              Stack[0x4]:4   fd
;
...
section .text
    ...
    JL 0x00610a00                       ; 006109f6 | LAB_00610a00
        ;   XREF to: 00610a00 (CONDITIONAL_JUMP)
    CMP EAX,dword ptr [0x00685214]      ; 006109f8 | uint g_MaxHandleCount
    JBE 0x00610a10                      ; 006109fe | LAB_00610a10
        ;   XREF to: 00610a10 (CONDITIONAL_JUMP)
    PUSH 0x4                            ; 00610a00
        ;   Label: LAB_00610a00
    CALL crt_errno.c_setErrno_FUN_00602790 ; 00610a02 | void crt_errno.c_setErrno_FUN_00602790(int error_code)
    ...
    LEA EDX,[EAX*0x4 + 0x0]             ; 00610a10
        ;   Label: LAB_00610a10
    MOV EAX,[0x0068526c]                ; 00610a17 | SIOControlBlock * g_IOControlBlock
