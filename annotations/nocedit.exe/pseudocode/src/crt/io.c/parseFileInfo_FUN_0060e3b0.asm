...
section .text
    ...
    PUSH 0x659734                       ; 0060e3b7 | = "C_FILE_INFO" | s_C_FILE_INFO_00659734 = C_FILE_INFO
    CALL crt_env.c_getenv_FUN_006013f0  ; 0060e3bc | char * crt_env.c_getenv_FUN_006013f0(char * name)
        ;   XREF to: 006013f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060e3c1
    MOV EBX,EAX                         ; 0060e3c4
    TEST EAX,EAX                        ; 0060e3c6
    JZ 0x0060e4e6                       ; 0060e3c8 | LAB_0060e4e6
        ;   XREF to: 0060e4e6 (CONDITIONAL_JUMP)
    CMP byte ptr [EBX],0x0              ; 0060e3ce
        ;   Label: LAB_0060e3ce
    JZ 0x0060e4d9                       ; 0060e3d1 | LAB_0060e4d9
    ...
    MOV AL,byte ptr [ESI]               ; 0060e3db
        ;   Label: LAB_0060e3db
    CMP AL,DL                           ; 0060e3dd
    JZ 0x0060e3f3                       ; 0060e3df | LAB_0060e3f3
        ;   XREF to: 0060e3f3 (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 0060e3e1
    JZ 0x0060e3f1                       ; 0060e3e3 | LAB_0060e3f1
        ;   XREF to: 0060e3f1 (CONDITIONAL_JUMP)
    INC ESI                             ; 0060e3e5
    MOV AL,byte ptr [ESI]               ; 0060e3e6
    CMP AL,DL                           ; 0060e3e8
    JZ 0x0060e3f3                       ; 0060e3ea | LAB_0060e3f3
        ;   XREF to: 0060e3f3 (CONDITIONAL_JUMP)
    INC ESI                             ; 0060e3ec
    CMP AL,0x0                          ; 0060e3ed
    JNZ 0x0060e3db                      ; 0060e3ef | LAB_0060e3db
    ...
    PUSH EBX                            ; 0060e3fd
    CALL crt_string.c_strncpy_FUN_00600f40 ; 0060e3fe | char * crt_string.c_strncpy_FUN_00600f40(char * dest, char * src, SIZE_T count)
    ...
    CALL crt_stdlib.c_strtol_FUN_0060edfc ; 0060e418 | long crt_stdlib.c_strtol_FUN_0060edfc(char * str, char * * endptr, int base)
    ...
    MOV AL,byte ptr [ESI]               ; 0060e426
        ;   Label: LAB_0060e426
    CMP AL,DL                           ; 0060e428
    JZ 0x0060e43e                       ; 0060e42a | LAB_0060e43e
        ;   XREF to: 0060e43e (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 0060e42c
    JZ 0x0060e43c                       ; 0060e42e | LAB_0060e43c
        ;   XREF to: 0060e43c (CONDITIONAL_JUMP)
    INC ESI                             ; 0060e430
    MOV AL,byte ptr [ESI]               ; 0060e431
    CMP AL,DL                           ; 0060e433
    JZ 0x0060e43e                       ; 0060e435 | LAB_0060e43e
        ;   XREF to: 0060e43e (CONDITIONAL_JUMP)
    INC ESI                             ; 0060e437
    CMP AL,0x0                          ; 0060e438
    JNZ 0x0060e426                      ; 0060e43a | LAB_0060e426
    ...
    PUSH EBX                            ; 0060e448
    CALL crt_string.c_strncpy_FUN_00600f40 ; 0060e449 | char * crt_string.c_strncpy_FUN_00600f40(char * dest, char * src, SIZE_T count)
        ;   XREF to: 00600f40 (UNCONDITIONAL_CALL)
    ...
    CALL crt_stdlib.c_strtol_FUN_0060edfc ; 0060e463 | long crt_stdlib.c_strtol_FUN_0060edfc(char * str, char * * endptr, int base)
        ;   XREF to: 0060edfc (UNCONDITIONAL_CALL)
    ...
    MOV AL,byte ptr [ESI]               ; 0060e473
        ;   Label: LAB_0060e473
    CMP AL,DL                           ; 0060e475
    JZ 0x0060e48b                       ; 0060e477 | LAB_0060e48b
        ;   XREF to: 0060e48b (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 0060e479
    JZ 0x0060e489                       ; 0060e47b | LAB_0060e489
        ;   XREF to: 0060e489 (CONDITIONAL_JUMP)
    INC ESI                             ; 0060e47d
    MOV AL,byte ptr [ESI]               ; 0060e47e
    CMP AL,DL                           ; 0060e480
    JZ 0x0060e48b                       ; 0060e482 | LAB_0060e48b
        ;   XREF to: 0060e48b (CONDITIONAL_JUMP)
    INC ESI                             ; 0060e484
    CMP AL,0x0                          ; 0060e485
    JNZ 0x0060e473                      ; 0060e487 | LAB_0060e473
    ...
    PUSH EBX                            ; 0060e495
    CALL crt_string.c_strncpy_FUN_00600f40 ; 0060e496 | char * crt_string.c_strncpy_FUN_00600f40(char * dest, char * src, SIZE_T count)
        ;   XREF to: 00600f40 (UNCONDITIONAL_CALL)
    ...
    PUSH EBX                            ; 0060e4ac
    CALL crt_stdlib.c_strtol_FUN_0060edfc ; 0060e4ad | long crt_stdlib.c_strtol_FUN_0060edfc(char * str, char * * endptr, int base)
        ;   XREF to: 0060edfc (UNCONDITIONAL_CALL)
    ...
    CALL crt_unknown.c_SetStdHandleToSomething_FUN_00608a1c ; 0060e4bd | undefined crt_unknown.c_SetStdHandleToSomething_FUN_00608a1c()
        ;   XREF to: 00608a1c (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0060e4c2
    PUSH EBX                            ; 0060e4c5
    PUSH EBP                            ; 0060e4c6
    LEA ESI,[EDI + 0x1]                 ; 0060e4c7
    CALL crt_io.c_setFileDescriptorFlags_FUN_00608908 ; 0060e4ca | void crt_io.c_setFileDescriptorFlags_FUN_00608908(int file_handle_index, uint flags)
        ;   XREF to: 00608908 (UNCONDITIONAL_CALL)
    MOV EBX,ESI                         ; 0060e4cf
    ADD ESP,0x8                         ; 0060e4d1
    JMP 0x0060e3ce                      ; 0060e4d4 | LAB_0060e3ce
        ;   XREF to: 0060e3ce (UNCONDITIONAL_JUMP)
    PUSH 0x659740                       ; 0060e4d9 | = "C_FILE_INFO=" | s_C_FILE_INFO_00659740 = C_FILE_INFO=
        ;   Label: LAB_0060e4d9
    CALL crt_env.c_putenv_internal_FUN_0060ee80 ; 0060e4de | int crt_env.c_putenv_internal_FUN_0060ee80(char * envstr)
