...
;                               FUNCTION
; *****************************************************************************
; __cdecl int crt_io.c_stat_FUN_00607e64(char * filename, stat * file_info)
;
; Parameters:
...
section .text
    ...
    TEST AH,AH                          ; 00607e80
    JZ 0x00607e96                       ; 00607e82 | LAB_00607e96
        ;   XREF to: 00607e96 (CONDITIONAL_JUMP)
    PUSH 0x65906c                       ; 00607e84 | = "*?" | s_anon_0065906c = *?
    PUSH ESI                            ; 00607e89
    CALL crt_string.c_strpbrk_FUN_0060c190 ; 00607e8a | char * crt_string.c_strpbrk_FUN_0060c190(char * str, char * char_set)
        ;   XREF to: 0060c190 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00607e8f
    TEST EAX,EAX                        ; 00607e92
    JZ 0x00607eaa                       ; 00607e94 | LAB_00607eaa
        ;   XREF to: 00607eaa (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 00607e96
        ;   Label: LAB_00607e96
    CALL crt_errno.c_setErrno_FUN_00602790 ; 00607e98 | void crt_errno.c_setErrno_FUN_00602790(int error_code)
        ;   XREF to: 00602790 (UNCONDITIONAL_CALL)
    MOV EAX,0xffffffff                  ; 00607e9d
    ADD ESP,0x4                         ; 00607ea2
    JMP 0x00608155                      ; 00607ea5 | LAB_00608155
        ;   XREF to: 00608155 (UNCONDITIONAL_JUMP)
    PUSH 0x104                          ; 00607eaa
        ;   Label: LAB_00607eaa
    LEA EAX,[ESP + 0x248]               ; 00607eaf
    PUSH EAX                            ; 00607eb6
    CALL crt_io.c_getcwd_FUN_00608d20   ; 00607eb7 | char * crt_io.c_getcwd_FUN_00608d20(char * buffer, SIZE_T size)
    ...
    LEA EAX,[ESP + 0x244]               ; 00607f5b
        ;   Label: LAB_00607f5b
    PUSH EAX                            ; 00607f62
    CALL crt_io.c_chdir_FUN_006012a0    ; 00607f63 | int crt_io.c_chdir_FUN_006012a0(char * path)
        ;   XREF to: 006012a0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00607f76
    CALL crt_memory.c_memset_FUN_005fde40 ; 00607f77 | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
        ;   XREF to: 005fde40 (UNCONDITIONAL_CALL)
    MOV EDX,0x10                        ; 00607f7c
    ADD ESP,0xc                         ; 00607f81
    MOV dword ptr [ESP],EDX             ; 00607f84
    JMP 0x00607fb1                      ; 00607f87 | LAB_00607fb1
        ;   XREF to: 00607fb1 (UNCONDITIONAL_JUMP)
    MOV EAX,ESP                         ; 00607f89
        ;   Label: LAB_00607f89
    PUSH EAX                            ; 00607f8b
    PUSH ESI                            ; 00607f8c
    CALL dword ptr CS:[0x61154c]        ; 00607f8d | FindFirstFileA * PTR_FindFirstFileA_0061154c
    CMP EAX,-0x1                        ; 00607f94
    JNZ 0x00607fa9                      ; 00607f97 | LAB_00607fa9
        ;   XREF to: 00607fa9 (CONDITIONAL_JUMP)
    CALL crt_errno.c_getLastErrorAndSetErrno_FUN_006083fc ; 00607f99 | DWORD crt_errno.c_getLastErrorAndSetErrno_FUN_006083fc()
    ...
    PUSH EAX                            ; 00607fa9
        ;   Label: LAB_00607fa9
    CALL dword ptr CS:[0x611548]        ; 00607faa | FindClose * PTR_FindClose_00611548
    PUSH ESI                            ; 00607fb1
        ;   Label: LAB_00607fb1
    CALL crt_string.c_mbtowc_next_FUN_00605a70 ; 00607fb2 | char * crt_string.c_mbtowc_next_FUN_00605a70(char * str)
        ;   XREF to: 00605a70 (UNCONDITIONAL_CALL)
    MOV DL,byte ptr [EAX]               ; 00607fb7
    ADD ESP,0x4                         ; 00607fb9
    CMP DL,0x3a                         ; 00607fbc
    JNZ 0x00607fc7                      ; 00607fbf | LAB_00607fc7
        ;   XREF to: 00607fc7 (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 00607fc1
    MOV AL,byte ptr [ESI]               ; 00607fc3
    JMP 0x00607fd0                      ; 00607fc5 | LAB_00607fd0
    ...
    PUSH EAX                            ; 00607fd0
        ;   Label: LAB_00607fd0
    CALL crt_ctype.c_tolower_FUN_005feb30 ; 00607fd1 | int crt_ctype.c_tolower_FUN_005feb30(int character)
    ...
    PUSH ESI                            ; 00607ff6
    CALL crt_io.c_analyze_file_type_FUN_00607d50 ; 00607ff7 | uint crt_io.c_analyze_file_type_FUN_00607d50(uint open_flags, char * filename)
    ...
    PUSH EAX                            ; 00608017
    CALL crt_time.c_filetime_to_dos_datetime_FUN_00609cb0 ; 00608018 | void crt_time.c_filetime_to_dos_datetime_FUN_00609cb0(FILETIME * filetime, WORD * dos_date, WORD * dos_time)
    ...
    PUSH EAX                            ; 00608035
    CALL crt_time.c_dos_datetime_to_time_t_FUN_0060c1e0 ; 00608036 | time_t crt_time.c_dos_datetime_to_time_t_FUN_0060c1e0(WORD dos_date, WORD dos_time)
    ...
    PUSH EAX                            ; 00608055
    CALL crt_time.c_filetime_to_dos_datetime_FUN_00609cb0 ; 00608056 | void crt_time.c_filetime_to_dos_datetime_FUN_00609cb0(FILETIME * filetime, WORD * dos_date, WORD * dos_time)
        ;   XREF to: 00609cb0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0060805b
    MOV EAX,dword ptr [ESP + 0x350]     ; 0060805e
    CMP AX,word ptr [ESP + 0x348]       ; 00608065
    JNZ 0x00608085                      ; 0060806d | LAB_00608085
        ;   XREF to: 00608085 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x34c]     ; 0060806f
    CMP AX,word ptr [ESP + 0x354]       ; 00608076
    JNZ 0x00608085                      ; 0060807e | LAB_00608085
        ;   XREF to: 00608085 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0x1e]      ; 00608080
    JMP 0x006080a3                      ; 00608083 | LAB_006080a3
    ...
    PUSH EAX                            ; 0060809a
    CALL crt_time.c_dos_datetime_to_time_t_FUN_0060c1e0 ; 0060809b | time_t crt_time.c_dos_datetime_to_time_t_FUN_0060c1e0(WORD dos_date, WORD dos_time)
        ;   XREF to: 0060c1e0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 006080ba
    CALL crt_time.c_filetime_to_dos_datetime_FUN_00609cb0 ; 006080bb | void crt_time.c_filetime_to_dos_datetime_FUN_00609cb0(FILETIME * filetime, WORD * dos_date, WORD * dos_time)
        ;   XREF to: 00609cb0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 006080c0
    MOV EAX,dword ptr [ESP + 0x350]     ; 006080c3
    CMP AX,word ptr [ESP + 0x348]       ; 006080ca
    JNZ 0x006080ea                      ; 006080d2 | LAB_006080ea
        ;   XREF to: 006080ea (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x34c]     ; 006080d4
    CMP AX,word ptr [ESP + 0x354]       ; 006080db
    JNZ 0x006080ea                      ; 006080e3 | LAB_006080ea
        ;   XREF to: 006080ea (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0x1e]      ; 006080e5
    JMP 0x00608108                      ; 006080e8 | LAB_00608108
    ...
    PUSH EAX                            ; 006080ff
    CALL crt_time.c_dos_datetime_to_time_t_FUN_0060c1e0 ; 00608100 | time_t crt_time.c_dos_datetime_to_time_t_FUN_0060c1e0(WORD dos_date, WORD dos_time)
        ;   XREF to: 0060c1e0 (UNCONDITIONAL_CALL)
    ...
    CALL crt_string.c_strncpy_FUN_00600f40 ; 0060814b | char * crt_string.c_strncpy_FUN_00600f40(char * dest, char * src, SIZE_T count)
