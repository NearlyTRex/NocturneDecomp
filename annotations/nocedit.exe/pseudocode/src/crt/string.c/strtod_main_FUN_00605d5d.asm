...
section .text
    ...
    PUSH EBX                            ; 00605d71
    CALL crt_string.c_parseFloatString_FUN_00605b9b ; 00605d72 | int crt_string.c_parseFloatString_FUN_00605b9b(char * str, void * result, char * * endptr)
        ;   XREF to: 00605b9b (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 00605d77
    ADD ESP,0xc                         ; 00605d79
    TEST EAX,EAX                        ; 00605d7c
    JNZ 0x00605d8b                      ; 00605d7e | LAB_00605d8b
        ;   XREF to: 00605d8b (CONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x24],EAX     ; 00605d80
    MOV dword ptr [EBP + -0x20],EAX     ; 00605d83
        ;   Label: LAB_00605d83
    JMP 0x00605e38                      ; 00605d86 | LAB_00605e38
    ...
    JL 0x00605dc7                       ; 00605d9b | LAB_00605dc7
        ;   XREF to: 00605dc7 (CONDITIONAL_JUMP)
    CALL crt_math.c_set_range_error_errno_FUN_006027ac ; 00605d9d | void crt_math.c_set_range_error_errno_FUN_006027ac()
        ;   XREF to: 006027ac (UNCONDITIONAL_CALL)
    TEST byte ptr [EBP + -0x27],0x80    ; 00605da2
    JZ 0x00605db8                       ; 00605da6 | LAB_00605db8
        ;   XREF to: 00605db8 (CONDITIONAL_JUMP)
    FLD double ptr [0x00665f30]         ; 00605da8 | double g_PositiveInfinity
    FCHS                                ; 00605dae
    FSTP double ptr [EBP + -0x24]       ; 00605db0
    JMP 0x00605e38                      ; 00605db3 | LAB_00605e38
        ;   XREF to: 00605e38 (UNCONDITIONAL_JUMP)
    MOV EAX,[0x00665f30]                ; 00605db8 | double g_PositiveInfinity
        ;   Label: LAB_00605db8
    MOV dword ptr [EBP + -0x24],EAX     ; 00605dbd
    MOV EAX,[0x00665f34]                ; 00605dc0 | g_PositiveInfinity+4
    JMP 0x00605d83                      ; 00605dc5 | LAB_00605d83
        ;   XREF to: 00605d83 (UNCONDITIONAL_JUMP)
    CMP EAX,0x3bcd                      ; 00605dc7
        ;   Label: LAB_00605dc7
    JGE 0x00605e10                      ; 00605dcc | LAB_00605e10
        ;   XREF to: 00605e10 (CONDITIONAL_JUMP)
    CMP EAX,-0x34                       ; 00605dce
    JGE 0x00605de2                      ; 00605dd1 | LAB_00605de2
        ;   XREF to: 00605de2 (CONDITIONAL_JUMP)
    XOR EDI,EDI                         ; 00605dd3
    CALL crt_math.c_set_range_error_errno_FUN_006027ac ; 00605dd5 | void crt_math.c_set_range_error_errno_FUN_006027ac()
        ;   XREF to: 006027ac (UNCONDITIONAL_CALL)
    MOV dword ptr [EBP + -0x24],EDI     ; 00605dda
    MOV dword ptr [EBP + -0x20],EDI     ; 00605ddd
    JMP 0x00605e38                      ; 00605de0 | LAB_00605e38
        ;   XREF to: 00605e38 (UNCONDITIONAL_JUMP)
    ...
    JZ 0x00605e33                       ; 00605e1d | LAB_00605e33
        ;   XREF to: 00605e33 (CONDITIONAL_JUMP)
    ...
    JNZ 0x00605e38                      ; 00605e31 | LAB_00605e38
        ;   XREF to: 00605e38 (CONDITIONAL_JUMP)
    CALL crt_math.c_set_range_error_errno_FUN_006027ac ; 00605e33 | void crt_math.c_set_range_error_errno_FUN_006027ac()
        ;   Label: LAB_00605e33
        ;   XREF to: 006027ac (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EBP + -0x24]     ; 00605e38
        ;   Label: LAB_00605e38
    MOV EDX,dword ptr [EBP + -0x20]     ; 00605e3b
    JMP 0x00605d55                      ; 00605e3e | LAB_00605d55
