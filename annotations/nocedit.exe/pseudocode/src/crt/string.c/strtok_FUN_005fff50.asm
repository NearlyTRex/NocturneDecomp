...
section .text
    ...
    JNZ 0x005fff71                      ; 005fff5b | LAB_005fff71
        ;   XREF to: 005fff71 (CONDITIONAL_JUMP)
    CALL dword ptr [0x00684ee4]         ; 005fff5d | GET_TLS_FUNC * PTR_crt_thread.c_GetTLS_FUN_0060242c_00684ee4
    MOV ESI,dword ptr [EAX + 0x10]      ; 005fff63
    TEST ESI,ESI                        ; 005fff66
    JNZ 0x005fff71                      ; 005fff68 | LAB_005fff71
        ;   XREF to: 005fff71 (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 005fff6a
    JMP 0x005ffffc                      ; 005fff6c | LAB_005ffffc
    ...
    PUSH EAX                            ; 005fff7a
    CALL crt_unknown.c_FUN_00607080     ; 005fff7b | undefined crt_unknown.c_FUN_00607080()
        ;   XREF to: 00607080 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005fff80
    JMP 0x005fffa5                      ; 005fff83 | LAB_005fffa5
    ...
    JZ 0x005fffad                       ; 005fffa2 | LAB_005fffad
    ...
    JNZ 0x005fff85                      ; 005fffab | LAB_005fff85
        ;   XREF to: 005fff85 (CONDITIONAL_JUMP)
    TEST EAX,EAX                        ; 005fffad
        ;   Label: LAB_005fffad
    JZ 0x005ffffc                       ; 005fffaf | LAB_005ffffc
        ;   XREF to: 005ffffc (CONDITIONAL_JUMP)
    MOV EBX,ESI                         ; 005fffb1
    JMP 0x005fffe5                      ; 005fffb3 | LAB_005fffe5
    ...
    JZ 0x005fffe4                       ; 005fffd3 | LAB_005fffe4
        ;   XREF to: 005fffe4 (CONDITIONAL_JUMP)
    MOV byte ptr [EBX],0x0              ; 005fffd5
    INC EBX                             ; 005fffd8
    CALL dword ptr [0x00684ee4]         ; 005fffd9 | GET_TLS_FUNC * PTR_crt_thread.c_GetTLS_FUN_0060242c_00684ee4
    MOV dword ptr [EAX + 0x10],EBX      ; 005fffdf
    JMP 0x005ffffa                      ; 005fffe2 | LAB_005ffffa
    ...
    JNZ 0x005fffb5                      ; 005fffeb | LAB_005fffb5
        ;   XREF to: 005fffb5 (CONDITIONAL_JUMP)
    CALL dword ptr [0x00684ee4]         ; 005fffed | GET_TLS_FUNC * PTR_crt_thread.c_GetTLS_FUN_0060242c_00684ee4
