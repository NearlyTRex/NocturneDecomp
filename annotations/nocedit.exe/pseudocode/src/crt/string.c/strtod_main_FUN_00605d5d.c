...
LAB_00605d83:
  ...
  if (uVar6 < 0x3bcd) {
    ...
    local_28 = (double)(float10)CONCAT19 /* combine 2-byte values */(bStack_2b,CONCAT18 /* combine 2-byte values */(uStack_2c,CONCAT44 /* combine 2-byte values */(uStack_30,local_34)))
    ;
