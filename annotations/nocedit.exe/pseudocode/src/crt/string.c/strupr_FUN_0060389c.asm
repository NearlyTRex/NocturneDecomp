...
;                               FUNCTION
; *****************************************************************************
; __cdecl char * __cdecl crt_string_c_strupr_FUN_0060389c(char *string)
;
; Parameters:
...
section .text
    ...
    JZ 0x006038bd                       ; 006038a4
        ;   XREF to: 006038bd (CONDITIONAL_JUMP)  ; LAB_006038bd
    XOR EAX,EAX                         ; 006038a6
        ;   Label: LAB_006038a6
    MOV AL,byte ptr [EBX]               ; 006038a8
    PUSH EAX                            ; 006038aa
    INC EBX                             ; 006038ab
    CALL crt_ctype.c_toupper_FUN_005ff9e0 ; 006038ac
    ...
    TEST DL,DL                          ; 006038b9
    JNZ 0x006038a6                      ; 006038bb
        ;   XREF to: 006038a6 (CONDITIONAL_JUMP)  ; LAB_006038a6
    POP EBX                             ; 006038bd
        ;   Label: LAB_006038bd
    RET                                 ; 006038be
