...
;                               FUNCTION
; *****************************************************************************
; __watcallStack int crt_string.c_strcmp_FUN_005fef20(char * str1, char * str2)
;
; Parameters:
...
section .text
    ...
    JZ 0x005fef31                       ; 005fef9b | LAB_005fef31
    ...
    CMP AL,CL                           ; 005fefa3
        ;   Label: LAB_005fefa3
    JNZ 0x005fefc4                      ; 005fefa5 | LAB_005fefc4
        ;   XREF to: 005fefc4 (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 005fefa7
    JZ 0x005fef9d                       ; 005fefa9 | LAB_005fef9d
        ;   XREF to: 005fef9d (CONDITIONAL_JUMP)
    CMP AH,CH                           ; 005fefab
    JNZ 0x005fefc4                      ; 005fefad | LAB_005fefc4
        ;   XREF to: 005fefc4 (CONDITIONAL_JUMP)
    CMP AH,0x0                          ; 005fefaf
    JZ 0x005fef9d                       ; 005fefb2 | LAB_005fef9d
        ;   XREF to: 005fef9d (CONDITIONAL_JUMP)
    SHR EAX,0x10                        ; 005fefb4
    SHR ECX,0x10                        ; 005fefb7
    CMP AL,CL                           ; 005fefba
    JNZ 0x005fefc4                      ; 005fefbc | LAB_005fefc4
        ;   XREF to: 005fefc4 (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 005fefbe
    JZ 0x005fef9d                       ; 005fefc0 | LAB_005fef9d
        ;   XREF to: 005fef9d (CONDITIONAL_JUMP)
    CMP AH,CH                           ; 005fefc2
