...
;                               FUNCTION
; *****************************************************************************
; __watcallStack void crt_string.c_strncpy_safe_FUN_005ff130(char * dest, char * src, int length, int maxlen)
;
; Parameters:
...
section .text
    ...
    JZ 0x005ff175                       ; 005ff140 | LAB_005ff175
        ;   XREF to: 005ff175 (CONDITIONAL_JUMP)
    CMP EAX,EBX                         ; 005ff142
    JLE 0x005ff148                      ; 005ff144 | LAB_005ff148
    ...
    PUSH EDX                            ; 005ff14d
    CALL crt_string.c_mbstrnlen_FUN_00605e50 ; 005ff14e | int crt_string.c_mbstrnlen_FUN_00605e50(char * str, int max_bytes)
    ...
    CALL crt_string.c_mbstrncpy_FUN_00605e90 ; 005ff15f | char * crt_string.c_mbstrncpy_FUN_00605e90(char * dest, char * src, int char_count)
        ;   XREF to: 00605e90 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005ff164
    PUSH EBX                            ; 005ff167
    PUSH ESI                            ; 005ff168
    CALL crt_string.c_mbstrnbytes_FUN_00605ec0 ; 005ff169 | int crt_string.c_mbstrnbytes_FUN_00605ec0(char * str, int char_count)
