...
section .text
    ...
    JZ 0x00605bbb                       ; 00605baf | LAB_00605bbb
        ;   XREF to: 00605bbb (CONDITIONAL_JUMP)
    CMP DL,0x9                          ; 00605bb1
    JC 0x00605bbe                       ; 00605bb4 | LAB_00605bbe
        ;   XREF to: 00605bbe (CONDITIONAL_JUMP)
    CMP DL,0xd                          ; 00605bb6
    JA 0x00605bbe                       ; 00605bb9 | LAB_00605bbe
        ;   XREF to: 00605bbe (CONDITIONAL_JUMP)
    INC EAX                             ; 00605bbb
        ;   Label: LAB_00605bbb
    JMP 0x00605baa                      ; 00605bbc | LAB_00605baa
    ...
    JNZ 0x00605bcf                      ; 00605bc9 | LAB_00605bcf
        ;   XREF to: 00605bcf (CONDITIONAL_JUMP)
    MOV EAX,EBX                         ; 00605bcb
    JMP 0x00605bdb                      ; 00605bcd | LAB_00605bdb
        ;   XREF to: 00605bdb (UNCONDITIONAL_JUMP)
    CMP DL,0x2d                         ; 00605bcf
        ;   Label: LAB_00605bcf
    JNZ 0x00605bdb                      ; 00605bd2 | LAB_00605bdb
    ...
    JNZ 0x00605c53                      ; 00605c4d | LAB_00605c53
        ;   XREF to: 00605c53 (CONDITIONAL_JUMP)
    MOV EAX,EDX                         ; 00605c4f
    JMP 0x00605c63                      ; 00605c51 | LAB_00605c63
        ;   XREF to: 00605c63 (UNCONDITIONAL_JUMP)
    CMP CL,0x2d                         ; 00605c53
        ;   Label: LAB_00605c53
    JNZ 0x00605c63                      ; 00605c56 | LAB_00605c63
    ...
    JC 0x00605c96                       ; 00605c6c | LAB_00605c96
        ;   XREF to: 00605c96 (CONDITIONAL_JUMP)
    CMP DL,0x39                         ; 00605c6e
    JA 0x00605c96                       ; 00605c71 | LAB_00605c96
        ;   XREF to: 00605c96 (CONDITIONAL_JUMP)
    CMP ESI,0x3e8                       ; 00605c73
    JGE 0x00605c8a                      ; 00605c79 | LAB_00605c8a
    ...
    JZ 0x00605cb9                       ; 00605cb2 | LAB_00605cb9
    ...
    JLE 0x00605cca                      ; 00605cbe | LAB_00605cca
    ...
    TEST EBX,EBX                        ; 00605cca
        ;   Label: LAB_00605cca
    JLE 0x00605cd9                      ; 00605ccc | LAB_00605cd9
        ;   XREF to: 00605cd9 (CONDITIONAL_JUMP)
    CMP byte ptr [EBX + EBP*0x1 + -0x3d],0x30 ; 00605cce
    JNZ 0x00605cd9                      ; 00605cd3 | LAB_00605cd9
        ;   XREF to: 00605cd9 (CONDITIONAL_JUMP)
    INC ESI                             ; 00605cd5
    DEC EBX                             ; 00605cd6
    JMP 0x00605cca                      ; 00605cd7 | LAB_00605cca
        ;   XREF to: 00605cca (UNCONDITIONAL_JUMP)
    TEST EBX,EBX                        ; 00605cd9
        ;   Label: LAB_00605cd9
    JNZ 0x00605cef                      ; 00605cdb | LAB_00605cef
    ...
    JMP 0x00605d55                      ; 00605ced | LAB_00605d55
    ...
    CALL crt_unknown.c_FUN_0060b586     ; 00605cfb | undefined crt_unknown.c_FUN_0060b586()
        ;   XREF to: 0060b586 (UNCONDITIONAL_CALL)
    TEST ESI,ESI                        ; 00605d00
    JZ 0x00605d11                       ; 00605d02 | LAB_00605d11
        ;   XREF to: 00605d11 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 00605d04
    LEA EAX,[EBP + -0x28]               ; 00605d05
    PUSH EAX                            ; 00605d08
    CALL crt_unknown.c_FUN_00603d60     ; 00605d09 | undefined crt_unknown.c_FUN_00603d60()
        ;   XREF to: 00603d60 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00605d0e
    TEST byte ptr [EBP + -0x10],0x1     ; 00605d11
        ;   Label: LAB_00605d11
    JZ 0x00605d1b                       ; 00605d15 | LAB_00605d1b
    ...
    JLE 0x00605d42                      ; 00605d39 | LAB_00605d42
        ;   XREF to: 00605d42 (CONDITIONAL_JUMP)
    MOV EAX,0x3                         ; 00605d3b
    JMP 0x00605d55                      ; 00605d40 | LAB_00605d55
        ;   XREF to: 00605d55 (UNCONDITIONAL_JUMP)
    CMP EAX,0xfffffecc                  ; 00605d42
        ;   Label: LAB_00605d42
    JGE 0x00605d50                      ; 00605d47 | LAB_00605d50
        ;   XREF to: 00605d50 (CONDITIONAL_JUMP)
    MOV EAX,0x2                         ; 00605d49
    JMP 0x00605d55                      ; 00605d4e | LAB_00605d55
        ;   XREF to: 00605d55 (UNCONDITIONAL_JUMP)
