...
;                               FUNCTION
; *****************************************************************************
; __cdecl char * crt_string.c_char_in_set_FUN_0060e340(char * charset, wchar_t wc)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 0060e34f
    CALL crt_locale.c_wchar_to_bytes_FUN_00605a20 ; 0060e350 | void crt_locale.c_wchar_to_bytes_FUN_00605a20(wchar_t character, char * output_buffer)
        ;   XREF to: 00605a20 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0060e355
    MOV EAX,ESP                         ; 0060e358
    PUSH EAX                            ; 0060e35a
    CALL crt_locale.c_mblen_FUN_00605a40 ; 0060e35b | int crt_locale.c_mblen_FUN_00605a40(char * mb_string)
    ...
    PUSH EBX                            ; 0060e368
        ;   Label: LAB_0060e368
    CALL crt_string.c_mbstring_termination_check_FUN_0060b630 ; 0060e369 | int crt_string.c_mbstring_termination_check_FUN_0060b630(char * str)
        ;   XREF to: 0060b630 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060e36e
    TEST EAX,EAX                        ; 0060e371
    JNZ 0x0060e392                      ; 0060e373 | LAB_0060e392
        ;   XREF to: 0060e392 (CONDITIONAL_JUMP)
    MOV EAX,ESP                         ; 0060e375
    PUSH EAX                            ; 0060e377
    PUSH EBX                            ; 0060e378
    CALL crt_string.c_mbcmp_FUN_0060e640 ; 0060e379 | int crt_string.c_mbcmp_FUN_0060e640(char * str1, char * str2)
        ;   XREF to: 0060e640 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0060e37e
    TEST EAX,EAX                        ; 0060e381
    JZ 0x0060e392                       ; 0060e383 | LAB_0060e392
        ;   XREF to: 0060e392 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 0060e385
    CALL crt_string.c_mbtowc_next_FUN_00605a70 ; 0060e386 | char * crt_string.c_mbtowc_next_FUN_00605a70(char * str)
        ;   XREF to: 00605a70 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 0060e38b
    ADD ESP,0x4                         ; 0060e38d
    JMP 0x0060e368                      ; 0060e390 | LAB_0060e368
        ;   XREF to: 0060e368 (UNCONDITIONAL_JUMP)
    PUSH EBX                            ; 0060e392
        ;   Label: LAB_0060e392
    CALL crt_string.c_mbstring_termination_check_FUN_0060b630 ; 0060e393 | int crt_string.c_mbstring_termination_check_FUN_0060b630(char * str)
        ;   XREF to: 0060b630 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060e398
    TEST EAX,EAX                        ; 0060e39b
    JZ 0x0060e3a8                       ; 0060e39d | LAB_0060e3a8
        ;   XREF to: 0060e3a8 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x10],0x0      ; 0060e39f
    JZ 0x0060e3a8                       ; 0060e3a4 | LAB_0060e3a8
        ;   XREF to: 0060e3a8 (CONDITIONAL_JUMP)
