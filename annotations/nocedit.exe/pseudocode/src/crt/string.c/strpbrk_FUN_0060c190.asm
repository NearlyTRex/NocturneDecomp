...
section .text
    ...
    PUSH EBX                            ; 0060c19a
        ;   Label: LAB_0060c19a
    CALL crt_string.c_mbstring_termination_check_FUN_0060b630 ; 0060c19b | int crt_string.c_mbstring_termination_check_FUN_0060b630(char * str)
        ;   XREF to: 0060b630 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060c1a0
    TEST EAX,EAX                        ; 0060c1a3
    JNZ 0x0060c1d0                      ; 0060c1a5 | LAB_0060c1d0
        ;   XREF to: 0060c1d0 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 0060c1a7
    CALL crt_string.c_mbtowc_peek_FUN_006059e0 ; 0060c1a8 | wchar_t crt_string.c_mbtowc_peek_FUN_006059e0(char * str)
        ;   XREF to: 006059e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060c1ad
    PUSH EAX                            ; 0060c1b0
    PUSH ESI                            ; 0060c1b1
    CALL crt_string.c_char_in_set_FUN_0060e340 ; 0060c1b2 | char * crt_string.c_char_in_set_FUN_0060e340(char * charset, wchar_t wc)
        ;   XREF to: 0060e340 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0060c1b7
    TEST EAX,EAX                        ; 0060c1ba
    JZ 0x0060c1c3                       ; 0060c1bc | LAB_0060c1c3
    ...
    PUSH EBX                            ; 0060c1c3
        ;   Label: LAB_0060c1c3
    CALL crt_string.c_mbtowc_next_FUN_00605a70 ; 0060c1c4 | char * crt_string.c_mbtowc_next_FUN_00605a70(char * str)
        ;   XREF to: 00605a70 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0060c1c9
    MOV EBX,EAX                         ; 0060c1cc
    JMP 0x0060c19a                      ; 0060c1ce | LAB_0060c19a
