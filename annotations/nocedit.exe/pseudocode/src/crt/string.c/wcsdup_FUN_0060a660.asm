...
;                               FUNCTION
; *****************************************************************************
; __watcallRegister WCHAR * crt_string_c_wcsdup_FUN_0060a660(WCHAR *str)
;
;
; XREF[1]:
...
section .text
    ...
    PUSH EDX                            ; 0060a666
    CALL crt_string.c_wcslen_FUN_0060cd30 ; 0060a667
    ...
    PUSH ESI                            ; 0060a677
    CALL crt_memory.c_malloc_FUN_00601bb0 ; 0060a678
    ...
    JZ 0x0060a695                       ; 0060a684
        ;   XREF to: 0060a695 (CONDITIONAL_JUMP)  ; LAB_0060a695
    PUSH ESI                            ; 0060a686
    MOV ECX,dword ptr [ESP + 0x10]      ; 0060a687
    PUSH ECX                            ; 0060a68b
    PUSH EAX                            ; 0060a68c
    CALL crt_string.c_memcpy_FUN_0060cd60 ; 0060a68d
