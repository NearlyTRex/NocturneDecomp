...
;                               FUNCTION
; *****************************************************************************
; __cdecl double __cdecl crt_string_c__strtod_FUN_005ff0f3(char *str)
;
; Parameters:
...
;   core_setedit.cpp_CDemonSet_FUN_00580730 at 00580da3
...
section .text
    ...
    PUSH EBP                            ; 005ff0f3
        ;   Label: crt_string.c__strtod_FUN_005ff0f3
