...
;                               FUNCTION
; *****************************************************************************
; __watcallStack char * __watcallStack crt_string_c_mbstrncpy_core_FUN_0060b670(char *dest,char *src,int count)
;
; Parameters:
...
section .text
    ...
    JNZ 0x0060b707                      ; 0060b6f3
        ;   XREF to: 0060b707 (CONDITIONAL_JUMP)  ; LAB_0060b707
    MOV AL,DL                           ; 0060b6f5
    INC AL                              ; 0060b6f7
    AND EAX,0xff                        ; 0060b6f9
    TEST byte ptr [EAX + 0x6849c4],0x2  ; 0060b6fe | g_CharacterClassificationTable
    JNZ 0x0060b70b                      ; 0060b705
        ;   XREF to: 0060b70b (CONDITIONAL_JUMP)  ; LAB_0060b70b
    ...
    PUSH EBX                            ; 0060b70b
        ;   Label: LAB_0060b70b
    CALL crt_unknown.c_FUN_0060d576     ; 0060b70c
        ;   XREF to: 0060d576 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_0060d576()
    ADD ESP,0x4                         ; 0060b711
    JMP 0x0060b6dc                      ; 0060b714
        ;   XREF to: 0060b6dc (UNCONDITIONAL_JUMP)  ; LAB_0060b6dc
