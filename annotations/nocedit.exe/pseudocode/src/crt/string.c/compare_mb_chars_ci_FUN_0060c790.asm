...
section .text
    ...
    PUSH EAX                            ; 0060c79e
    CALL crt_mbstring.c_copyMbChar_FUN_0060e590 ; 0060c79f
    ...
    PUSH EBX                            ; 0060c7ab
    CALL crt_locale.c_mblen_FUN_00605a40 ; 0060c7ac
    ...
    PUSH EAX                            ; 0060c7c3
    CALL crt_mbstring.c_copyMbChar_FUN_0060e590 ; 0060c7c4
        ;   XREF to: 0060e590 (UNCONDITIONAL_CALL)  ; void crt_mbstring.c_copyMbChar_FUN_0060e590(char * dest, char * src)
    ADD ESP,0x8                         ; 0060c7c9
    MOV ESI,dword ptr [ESP + 0x18]      ; 0060c7cc
    PUSH ESI                            ; 0060c7d0
    CALL crt_locale.c_mblen_FUN_00605a40 ; 0060c7d1
        ;   XREF to: 00605a40 (UNCONDITIONAL_CALL)  ; int crt_locale.c_mblen_FUN_00605a40(char * mb_string)
    ...
    PUSH EAX                            ; 0060c7e2
    CALL crt_unknown.c_SomethingWithUppercaseCharacterConvert_FUN_0060e5d0 ; 0060c7e3
        ;   XREF to: 0060e5d0 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_SomethingWithUppercaseCharacterConvert_FUN_0060e5d0()
    ADD ESP,0x4                         ; 0060c7e8
    MOV EAX,ESP                         ; 0060c7eb
    PUSH EAX                            ; 0060c7ed
    CALL crt_unknown.c_SomethingWithUppercaseCharacterConvert_FUN_0060e5d0 ; 0060c7ee
        ;   XREF to: 0060e5d0 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_SomethingWithUppercaseCharacterConvert_FUN_0060e5d0()
    ...
    PUSH EAX                            ; 0060c7fd
    CALL crt_string.c_mbcmp_FUN_0060e640 ; 0060c7fe
