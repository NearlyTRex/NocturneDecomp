...
;                               FUNCTION
; *****************************************************************************
; __watcallStack int __watcallStack crt_string_c_mbstrnbytes_FUN_00605ec0(char *str,int char_count)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00605ecd
        ;   Label: LAB_00605ecd
    CALL crt_string.c_mbstring_termination_check_FUN_0060b630 ; 00605ece
    ...
    JNZ 0x00605f1a                      ; 00605ed8
        ;   XREF to: 00605f1a (CONDITIONAL_JUMP)  ; LAB_00605f1a
    TEST EDI,EDI                        ; 00605eda
    JBE 0x00605f1a                      ; 00605edc
        ;   XREF to: 00605f1a (CONDITIONAL_JUMP)  ; LAB_00605f1a
    CMP dword ptr [0x03f9c020],0x0      ; 00605ede | g_MultibyteLocaleActive
    JZ 0x00605f0b                       ; 00605ee5
        ;   XREF to: 00605f0b (CONDITIONAL_JUMP)  ; LAB_00605f0b
    MOV AL,byte ptr [EBX]               ; 00605ee7
    MOV AL,byte ptr [EAX + 0x3f9c031]   ; 00605ee9 | g_LeadByteTable
    AND AL,0x1                          ; 00605eef
    AND EAX,0xff                        ; 00605ef1
    JZ 0x00605f0b                       ; 00605ef6
        ;   XREF to: 00605f0b (CONDITIONAL_JUMP)  ; LAB_00605f0b
    CMP byte ptr [EBX + 0x1],0x0        ; 00605ef8
    JZ 0x00605f1a                       ; 00605efc
        ;   XREF to: 00605f1a (CONDITIONAL_JUMP)  ; LAB_00605f1a
    PUSH EBX                            ; 00605efe
    CALL crt_locale.c_mblen_FUN_00605a40 ; 00605eff
    ...
    JMP 0x00605f0c                      ; 00605f09
        ;   XREF to: 00605f0c (UNCONDITIONAL_JUMP)  ; LAB_00605f0c
    INC ESI                             ; 00605f0b
        ;   Label: LAB_00605f0b
    PUSH EBX                            ; 00605f0c
        ;   Label: LAB_00605f0c
    CALL crt_string.c_mbtowc_next_FUN_00605a70 ; 00605f0d
    ...
    JMP 0x00605ecd                      ; 00605f18
        ;   XREF to: 00605ecd (UNCONDITIONAL_JUMP)  ; LAB_00605ecd
