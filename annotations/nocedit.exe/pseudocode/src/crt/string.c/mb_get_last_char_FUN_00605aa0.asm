...
section .text
    ...
    JA 0x00605b02                       ; 00605ae7 | LAB_00605b02
        ;   XREF to: 00605b02 (CONDITIONAL_JUMP)
    TEST ESI,ESI                        ; 00605ae9
    JZ 0x00605b02                       ; 00605aeb | LAB_00605b02
        ;   XREF to: 00605b02 (CONDITIONAL_JUMP)
    XOR EDX,EDX                         ; 00605aed
    MOV DL,byte ptr [EAX]               ; 00605aef
    MOV DL,byte ptr [EDX + 0x3f9c031]   ; 00605af1 | char[256] g_LeadByteTable
    AND DL,0x1                          ; 00605af7
    AND EDX,0xff                        ; 00605afa
    JNZ 0x00605ae4                      ; 00605b00 | LAB_00605ae4
        ;   XREF to: 00605ae4 (CONDITIONAL_JUMP)
    ...
    MOV EAX,EDX                         ; 00605b17
        ;   Label: LAB_00605b17
    MOV dword ptr [0x03f9c020],ESI      ; 00605b19 | int g_MultibyteLocaleActive
    POP EDI                             ; 00605b1f
    POP ESI                             ; 00605b20
    POP EBX                             ; 00605b21
    RET                                 ; 00605b22
