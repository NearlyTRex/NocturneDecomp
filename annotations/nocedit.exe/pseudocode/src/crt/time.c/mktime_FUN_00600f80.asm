...
;                               FUNCTION
; *****************************************************************************
; __cdecl time_t crt_time.c_mktime_FUN_00600f80(tm * timeptr)
;
; Parameters:
...
;   crt_time.c_time_with_rounding_FUN_006001f0 at 00600210
...
section .text
    ...
    LEA EAX,[ESI + 0x76c]               ; 00600fe4
        ;   Label: LAB_00600fe4
    PUSH EAX                            ; 00600fea
    CALL crt_time.c_is_leap_year_FUN_00607820 ; 00600feb | int crt_time.c_is_leap_year_FUN_00607820(int year)
        ;   XREF to: 00607820 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00600ff0
    TEST EAX,EAX                        ; 00600ff3
    JZ 0x00600ffc                       ; 00600ff5 | LAB_00600ffc
        ;   XREF to: 00600ffc (CONDITIONAL_JUMP)
    MOV EBP,0x665f52                    ; 00600ff7 | short g_DaysInMonth_Leap
    ...
    MOVSX EAX,word ptr [EBP + EBX*0x2]  ; 00601050 | short g_DaysInMonth_Leap | g_DaysInMonth_Normal = 0x0
    ...
    PUSH EBX                            ; 00601091
    PUSH ESI                            ; 00601092
    CALL crt_time.c_gmtime_r_FUN_00607690 ; 00601093 | undefined crt_time.c_gmtime_r_FUN_00607690(time_t days, time_t seconds, time_t timezone_offset, undefined1 result)
        ;   XREF to: 00607690 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00601098
    CALL crt_time.c_tzset_FUN_006072f8  ; 0060109b | void crt_time.c_tzset_FUN_006072f8()
        ;   XREF to: 006072f8 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [0x006851c8]      ; 006010a0 | int g_TimezoneOffset
    MOV EBP,dword ptr [EDI + 0x20]      ; 006010a6
    ADD EBX,ECX                         ; 006010a9
    TEST EBP,EBP                        ; 006010ab
    JGE 0x006010b8                      ; 006010ad | LAB_006010b8
        ;   XREF to: 006010b8 (CONDITIONAL_JUMP)
    PUSH EDI                            ; 006010af
    CALL crt_time.c_determine_dst_status_FUN_006079b4 ; 006010b0 | int crt_time.c_determine_dst_status_FUN_006079b4(tm * timeptr)
        ;   XREF to: 006079b4 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 006010b5
    CMP dword ptr [EDI + 0x20],0x0      ; 006010b8
        ;   Label: LAB_006010b8
    JLE 0x006010c4                      ; 006010bc | LAB_006010c4
        ;   XREF to: 006010c4 (CONDITIONAL_JUMP)
    SUB EBX,dword ptr [0x006851d0]      ; 006010be | int g_DaylightSavingOffset
    TEST EBX,EBX                        ; 006010c4
        ;   Label: LAB_006010c4
    JGE 0x006010d1                      ; 006010c6 | LAB_006010d1
        ;   XREF to: 006010d1 (CONDITIONAL_JUMP)
    DEC ESI                             ; 006010c8
    ADD EBX,0x15180                     ; 006010c9
    JMP 0x006010c4                      ; 006010cf | LAB_006010c4
        ;   XREF to: 006010c4 (UNCONDITIONAL_JUMP)
    CMP ESI,0x63de                      ; 006010d1
        ;   Label: LAB_006010d1
    JGE 0x006010e6                      ; 006010d7 | LAB_006010e6
    ...
    POP EBX                             ; 006010e4
    RET                                 ; 006010e5
    JNZ 0x00601109                      ; 006010e6 | LAB_00601109
        ;   Label: LAB_006010e6
        ;   XREF to: 00601109 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x006851c8]      ; 006010e8 | int g_TimezoneOffset
    SUB EBX,0x15180                     ; 006010ee
    TEST ECX,ECX                        ; 006010f4
    JLE 0x006010fc                      ; 006010f6 | LAB_006010fc
        ;   XREF to: 006010fc (CONDITIONAL_JUMP)
    TEST EBX,EBX                        ; 006010f8
    JGE 0x00601129                      ; 006010fa | LAB_00601129
