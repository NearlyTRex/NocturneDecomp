...
;                               FUNCTION
; *****************************************************************************
; __cdecl uint crt_time.c_strftime_FUN_006002d4(char * dest_buffer, uint buffer_size, char * format_string, tm * time_ptr)
;
; Parameters:
...
section .text
    ...
    MOV AH,byte ptr [EBP]               ; 0060030a | = "%a %b %d, %Y" | s_a_b_d_H_M_S_Y_00658bd0 = %a %b %d %H:%M:%S %Y | s_m_d_y_00658be8 = %m/%d/%y
        ;   Label: LAB_0060030a
    MOV ESI,ESP                         ; 0060030d
    TEST AH,AH                          ; 0060030f
    JNZ 0x00600330                      ; 00600311 | LAB_00600330
        ;   XREF to: 00600330 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [ESP + 0x8c]      ; 00600313
    TEST EDI,EDI                        ; 0060031a
    JZ 0x0060072f                       ; 0060031c | LAB_0060072f
        ;   XREF to: 0060072f (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 00600322
    LEA EBP,[EDI + 0x1]                 ; 00600324
    MOV dword ptr [ESP + 0x8c],EAX      ; 00600327
    JMP 0x0060030a                      ; 0060032e | LAB_0060030a
        ;   XREF to: 0060030a (UNCONDITIONAL_JUMP)
    CMP AH,0x25                         ; 00600330
        ;   Label: LAB_00600330
    JZ 0x00600345                       ; 00600333 | LAB_00600345
        ;   XREF to: 00600345 (CONDITIONAL_JUMP)
    MOV AL,AH                           ; 00600335
    MOV byte ptr [ESP],AH               ; 00600337
    XOR AL,AH                           ; 0060033a
    MOV byte ptr [ESP + 0x1],AL         ; 0060033c
    JMP 0x006006c0                      ; 00600340 | LAB_006006c0
        ;   XREF to: 006006c0 (UNCONDITIONAL_JUMP)
    MOV AL,byte ptr [EBP + 0x1]         ; 00600345
        ;   Label: LAB_00600345
    INC EBP                             ; 00600348
    CMP AL,0x61                         ; 00600349
    JC 0x006003f1                       ; 0060034b | LAB_006003f1
        ;   XREF to: 006003f1 (CONDITIONAL_JUMP)
    JBE 0x00600481                      ; 00600351 | LAB_00600481
        ;   XREF to: 00600481 (CONDITIONAL_JUMP)
    CMP AL,0x6e                         ; 00600357
    JC 0x006003aa                       ; 00600359 | LAB_006003aa
        ;   XREF to: 006003aa (CONDITIONAL_JUMP)
    JBE 0x00600571                      ; 0060035b | LAB_00600571
        ;   XREF to: 00600571 (CONDITIONAL_JUMP)
    CMP AL,0x77                         ; 00600361
    JC 0x00600386                       ; 00600363 | LAB_00600386
        ;   XREF to: 00600386 (CONDITIONAL_JUMP)
    JBE 0x006005ef                      ; 00600365 | LAB_006005ef
        ;   XREF to: 006005ef (CONDITIONAL_JUMP)
    CMP AL,0x79                         ; 0060036b
    JC 0x00600648                       ; 0060036d | LAB_00600648
        ;   XREF to: 00600648 (CONDITIONAL_JUMP)
    JBE 0x0060066a                      ; 00600373 | LAB_0060066a
        ;   XREF to: 0060066a (CONDITIONAL_JUMP)
    CMP AL,0x7a                         ; 00600379
    JZ 0x006006a3                       ; 0060037b | LAB_006006a3
        ;   XREF to: 006006a3 (CONDITIONAL_JUMP)
    JMP 0x006006b4                      ; 00600381 | LAB_006006b4
        ;   XREF to: 006006b4 (UNCONDITIONAL_JUMP)
    CMP AL,0x72                         ; 00600386
        ;   Label: LAB_00600386
    JC 0x0060039d                       ; 00600388 | LAB_0060039d
        ;   XREF to: 0060039d (CONDITIONAL_JUMP)
    JBE 0x0060057b                      ; 0060038a | LAB_0060057b
        ;   XREF to: 0060057b (CONDITIONAL_JUMP)
    CMP AL,0x74                         ; 00600390
    JZ 0x006005bb                       ; 00600392 | LAB_006005bb
        ;   XREF to: 006005bb (CONDITIONAL_JUMP)
    JMP 0x006006b4                      ; 00600398 | LAB_006006b4
        ;   XREF to: 006006b4 (UNCONDITIONAL_JUMP)
    CMP AL,0x70                         ; 0060039d
        ;   Label: LAB_0060039d
    JZ 0x0060058c                       ; 0060039f | LAB_0060058c
        ;   XREF to: 0060058c (CONDITIONAL_JUMP)
    JMP 0x006006b4                      ; 006003a5 | LAB_006006b4
        ;   XREF to: 006006b4 (UNCONDITIONAL_JUMP)
    CMP AL,0x64                         ; 006003aa
        ;   Label: LAB_006003aa
    JC 0x006003d8                       ; 006003ac | LAB_006003d8
        ;   XREF to: 006003d8 (CONDITIONAL_JUMP)
    JBE 0x006004c2                      ; 006003ae | LAB_006004c2
        ;   XREF to: 006004c2 (CONDITIONAL_JUMP)
    CMP AL,0x6a                         ; 006003b4
    JC 0x006003cb                       ; 006003b6 | LAB_006003cb
        ;   XREF to: 006003cb (CONDITIONAL_JUMP)
    JBE 0x00600526                      ; 006003b8 | LAB_00600526
        ;   XREF to: 00600526 (CONDITIONAL_JUMP)
    CMP AL,0x6d                         ; 006003be
    JZ 0x00600544                       ; 006003c0 | LAB_00600544
        ;   XREF to: 00600544 (CONDITIONAL_JUMP)
    JMP 0x006006b4                      ; 006003c6 | LAB_006006b4
        ;   XREF to: 006006b4 (UNCONDITIONAL_JUMP)
    CMP AL,0x68                         ; 006003cb
        ;   Label: LAB_006003cb
    JZ 0x006004a2                       ; 006003cd | LAB_006004a2
        ;   XREF to: 006004a2 (CONDITIONAL_JUMP)
    JMP 0x006006b4                      ; 006003d3 | LAB_006006b4
        ;   XREF to: 006006b4 (UNCONDITIONAL_JUMP)
    CMP AL,0x62                         ; 006003d8
        ;   Label: LAB_006003d8
    JBE 0x006004a2                      ; 006003da | LAB_006004a2
        ;   XREF to: 006004a2 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x8c],EBP      ; 006003e0
    MOV EBP,0x658bd0                    ; 006003e7 | = "%a %b %d %H:%M:%S %Y" | s_a_b_d_H_M_S_Y_00658bd0 = %a %b %d %H:%M:%S %Y
    JMP 0x0060030a                      ; 006003ec | LAB_0060030a
        ;   XREF to: 0060030a (UNCONDITIONAL_JUMP)
    CMP AL,0x4d                         ; 006003f1
        ;   Label: LAB_006003f1
    JC 0x00600444                       ; 006003f3 | LAB_00600444
        ;   XREF to: 00600444 (CONDITIONAL_JUMP)
    JBE 0x0060055b                      ; 006003f5 | LAB_0060055b
        ;   XREF to: 0060055b (CONDITIONAL_JUMP)
    CMP AL,0x57                         ; 006003fb
    JC 0x00600420                       ; 006003fd | LAB_00600420
        ;   XREF to: 00600420 (CONDITIONAL_JUMP)
    JBE 0x00600602                      ; 006003ff | LAB_00600602
        ;   XREF to: 00600602 (CONDITIONAL_JUMP)
    CMP AL,0x59                         ; 00600405
    JC 0x00600659                       ; 00600407 | LAB_00600659
        ;   XREF to: 00600659 (CONDITIONAL_JUMP)
    JBE 0x00600689                      ; 0060040d | LAB_00600689
        ;   XREF to: 00600689 (CONDITIONAL_JUMP)
    CMP AL,0x5a                         ; 00600413
    JZ 0x006006a3                       ; 00600415 | LAB_006006a3
        ;   XREF to: 006006a3 (CONDITIONAL_JUMP)
    JMP 0x006006b4                      ; 0060041b | LAB_006006b4
        ;   XREF to: 006006b4 (UNCONDITIONAL_JUMP)
    CMP AL,0x54                         ; 00600420
        ;   Label: LAB_00600420
    JC 0x00600437                       ; 00600422 | LAB_00600437
        ;   XREF to: 00600437 (CONDITIONAL_JUMP)
    JBE 0x00600659                      ; 00600424 | LAB_00600659
        ;   XREF to: 00600659 (CONDITIONAL_JUMP)
    CMP AL,0x55                         ; 0060042a
    JZ 0x006005c5                       ; 0060042c | LAB_006005c5
        ;   XREF to: 006005c5 (CONDITIONAL_JUMP)
    JMP 0x006006b4                      ; 00600432 | LAB_006006b4
        ;   XREF to: 006006b4 (UNCONDITIONAL_JUMP)
    CMP AL,0x53                         ; 00600437
        ;   Label: LAB_00600437
    JZ 0x006005a6                       ; 00600439 | LAB_006005a6
        ;   XREF to: 006005a6 (CONDITIONAL_JUMP)
    JMP 0x006006b4                      ; 0060043f | LAB_006006b4
        ;   XREF to: 006006b4 (UNCONDITIONAL_JUMP)
    CMP AL,0x42                         ; 00600444
        ;   Label: LAB_00600444
    JC 0x0060046a                       ; 00600446 | LAB_0060046a
        ;   XREF to: 0060046a (CONDITIONAL_JUMP)
    JBE 0x006004b3                      ; 00600448 | LAB_006004b3
        ;   XREF to: 006004b3 (CONDITIONAL_JUMP)
    CMP AL,0x48                         ; 0060044a
    JC 0x00600461                       ; 0060044c | LAB_00600461
        ;   XREF to: 00600461 (CONDITIONAL_JUMP)
    JBE 0x006004e9                      ; 0060044e | LAB_006004e9
        ;   XREF to: 006004e9 (CONDITIONAL_JUMP)
    CMP AL,0x49                         ; 00600454
    JZ 0x006004ff                       ; 00600456 | LAB_006004ff
        ;   XREF to: 006004ff (CONDITIONAL_JUMP)
    JMP 0x006006b4                      ; 0060045c | LAB_006006b4
        ;   XREF to: 006006b4 (UNCONDITIONAL_JUMP)
    CMP AL,0x44                         ; 00600461
        ;   Label: LAB_00600461
    JZ 0x006004d8                       ; 00600463 | LAB_006004d8
        ;   XREF to: 006004d8 (CONDITIONAL_JUMP)
    JMP 0x006006b4                      ; 00600465 | LAB_006006b4
        ;   XREF to: 006006b4 (UNCONDITIONAL_JUMP)
    CMP AL,AH                           ; 0060046a
        ;   Label: LAB_0060046a
    JC 0x006006b4                       ; 0060046c | LAB_006006b4
        ;   XREF to: 006006b4 (CONDITIONAL_JUMP)
    JBE 0x006006b4                      ; 00600472 | LAB_006006b4
        ;   XREF to: 006006b4 (CONDITIONAL_JUMP)
    CMP AL,0x41                         ; 00600478
    JZ 0x00600493                       ; 0060047a | LAB_00600493
        ;   XREF to: 00600493 (CONDITIONAL_JUMP)
    JMP 0x006006b4                      ; 0060047c | LAB_006006b4
        ;   XREF to: 006006b4 (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0x18]      ; 00600481
        ;   Label: LAB_00600481
    MOV ESI,0x684b44                    ; 00600484 | char[7][4] g_WeekdayNamesShort
    SHL EAX,0x2                         ; 00600489
    ADD ESI,EAX                         ; 0060048c
    JMP 0x006006c0                      ; 0060048e | LAB_006006c0
        ;   XREF to: 006006c0 (UNCONDITIONAL_JUMP)
    MOV ESI,dword ptr [EBX + 0x18]      ; 00600493
        ;   Label: LAB_00600493
    MOV ESI,dword ptr [ESI*0x4 + 0x684b60] ; 00600496 | char *[7] g_WeekdayNamesLong
    JMP 0x006006c0                      ; 0060049d | LAB_006006c0
        ;   XREF to: 006006c0 (UNCONDITIONAL_JUMP)
    MOV ESI,dword ptr [EBX + 0x10]      ; 006004a2
        ;   Label: LAB_006004a2
    SHL ESI,0x2                         ; 006004a5
    ADD ESI,0x684b7c                    ; 006004a8 | char[12][4] g_MonthNamesShort
    JMP 0x006006c0                      ; 006004ae | LAB_006006c0
        ;   XREF to: 006006c0 (UNCONDITIONAL_JUMP)
    MOV ESI,dword ptr [EBX + 0x10]      ; 006004b3
        ;   Label: LAB_006004b3
    MOV ESI,dword ptr [ESI*0x4 + 0x684bac] ; 006004b6 | char *[12] g_MonthNamesLong
    JMP 0x006006c0                      ; 006004bd | LAB_006006c0
        ;   XREF to: 006006c0 (UNCONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 006004ca
    CALL crt_stdio.c_formatTwoDigits_FUN_006002a0 ; 006004cb | void crt_stdio.c_formatTwoDigits_FUN_006002a0(char * buffer, int value)
        ;   XREF to: 006002a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 006004d0
    JMP 0x006006c0                      ; 006004d3 | LAB_006006c0
        ;   XREF to: 006006c0 (UNCONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x8c],EBP      ; 006004d8
        ;   Label: LAB_006004d8
    MOV EBP,0x658be8                    ; 006004df | = "%m/%d/%y" | s_m_d_y_00658be8 = %m/%d/%y
    JMP 0x0060030a                      ; 006004e4 | LAB_0060030a
        ;   XREF to: 0060030a (UNCONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 006004f1
    CALL crt_stdio.c_formatTwoDigits_FUN_006002a0 ; 006004f2 | void crt_stdio.c_formatTwoDigits_FUN_006002a0(char * buffer, int value)
        ;   XREF to: 006002a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 006004f7
    JMP 0x006006c0                      ; 006004fa | LAB_006006c0
        ;   XREF to: 006006c0 (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0x8]       ; 006004ff
        ;   Label: LAB_006004ff
    CMP EAX,0xc                         ; 00600502
    JLE 0x0060050a                      ; 00600505 | LAB_0060050a
        ;   XREF to: 0060050a (CONDITIONAL_JUMP)
    SUB EAX,0xc                         ; 00600507
    TEST EAX,EAX                        ; 0060050a
        ;   Label: LAB_0060050a
    JNZ 0x00600513                      ; 0060050c | LAB_00600513
    ...
    PUSH EAX                            ; 00600518
    CALL crt_stdio.c_formatTwoDigits_FUN_006002a0 ; 00600519 | void crt_stdio.c_formatTwoDigits_FUN_006002a0(char * buffer, int value)
        ;   XREF to: 006002a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0060051e
    JMP 0x006006c0                      ; 00600521 | LAB_006006c0
        ;   XREF to: 006006c0 (UNCONDITIONAL_JUMP)
    PUSH 0xa                            ; 00600526
        ;   Label: LAB_00600526
    ...
    PUSH EAX                            ; 00600533
    CALL crt_stdio.c_IntegerToString_FUN_00607d18 ; 00600534 | char * crt_stdio.c_IntegerToString_FUN_00607d18(int value, char * buffer, int base)
        ;   XREF to: 00607d18 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00600539
    DEC byte ptr [ESP]                  ; 0060053c
    JMP 0x006006c0                      ; 0060053f | LAB_006006c0
        ;   XREF to: 006006c0 (UNCONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 0060054d
    CALL crt_stdio.c_formatTwoDigits_FUN_006002a0 ; 0060054e | void crt_stdio.c_formatTwoDigits_FUN_006002a0(char * buffer, int value)
        ;   XREF to: 006002a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00600553
    JMP 0x006006c0                      ; 00600556 | LAB_006006c0
        ;   XREF to: 006006c0 (UNCONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 00600563
    CALL crt_stdio.c_formatTwoDigits_FUN_006002a0 ; 00600564 | void crt_stdio.c_formatTwoDigits_FUN_006002a0(char * buffer, int value)
        ;   XREF to: 006002a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00600569
    JMP 0x006006c0                      ; 0060056c | LAB_006006c0
        ;   XREF to: 006006c0 (UNCONDITIONAL_JUMP)
    MOV ESI,0x658bf4                    ; 00600571 | undefined1 DAT_00658bf4
        ;   Label: LAB_00600571
    JMP 0x006006c0                      ; 00600576 | LAB_006006c0
        ;   XREF to: 006006c0 (UNCONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x8c],EBP      ; 0060057b
        ;   Label: LAB_0060057b
    MOV EBP,0x658bf8                    ; 00600582 | = "%I:%M:%S %p" | s_I_M_S_p_00658bf8 = %I:%M:%S %p
    JMP 0x0060030a                      ; 00600587 | LAB_0060030a
        ;   XREF to: 0060030a (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x8],0xc       ; 0060058c
        ;   Label: LAB_0060058c
    JGE 0x0060059c                      ; 00600590 | LAB_0060059c
        ;   XREF to: 0060059c (CONDITIONAL_JUMP)
    MOV ESI,0x658c04                    ; 00600592 | undefined1 DAT_00658c04
    JMP 0x006006c0                      ; 00600597 | LAB_006006c0
        ;   XREF to: 006006c0 (UNCONDITIONAL_JUMP)
    MOV ESI,0x658c08                    ; 0060059c | undefined1 DAT_00658c08
        ;   Label: LAB_0060059c
    JMP 0x006006c0                      ; 006005a1 | LAB_006006c0
        ;   XREF to: 006006c0 (UNCONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 006005ad
    CALL crt_stdio.c_formatTwoDigits_FUN_006002a0 ; 006005ae | void crt_stdio.c_formatTwoDigits_FUN_006002a0(char * buffer, int value)
        ;   XREF to: 006002a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 006005b3
    JMP 0x006006c0                      ; 006005b6 | LAB_006006c0
        ;   XREF to: 006006c0 (UNCONDITIONAL_JUMP)
    MOV ESI,0x658c0c                    ; 006005bb | undefined1 DAT_00658c0c
        ;   Label: LAB_006005bb
    JMP 0x006006c0                      ; 006005c0 | LAB_006006c0
        ;   XREF to: 006006c0 (UNCONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 006005e1
    CALL crt_stdio.c_formatTwoDigits_FUN_006002a0 ; 006005e2 | void crt_stdio.c_formatTwoDigits_FUN_006002a0(char * buffer, int value)
        ;   XREF to: 006002a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 006005e7
    JMP 0x006006c0                      ; 006005ea | LAB_006006c0
        ;   XREF to: 006006c0 (UNCONDITIONAL_JUMP)
    ...
    JMP 0x006006c0                      ; 006005fd | LAB_006006c0
        ;   XREF to: 006006c0 (UNCONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 0060063a
    CALL crt_stdio.c_formatTwoDigits_FUN_006002a0 ; 0060063b | void crt_stdio.c_formatTwoDigits_FUN_006002a0(char * buffer, int value)
        ;   XREF to: 006002a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00600640
    JMP 0x006006c0                      ; 00600643 | LAB_006006c0
        ;   XREF to: 006006c0 (UNCONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x8c],EBP      ; 00600648
        ;   Label: LAB_00600648
    MOV EBP,0x658c10                    ; 0060064f | = "%a %b %d, %Y" | s_a_b_d_Y_00658c10 = %a %b %d, %Y
    JMP 0x0060030a                      ; 00600654 | LAB_0060030a
        ;   XREF to: 0060030a (UNCONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x8c],EBP      ; 00600659
        ;   Label: LAB_00600659
    MOV EBP,0x658c20                    ; 00600660 | = "%H:%M:%S" | s_H_M_S_00658c20 = %H:%M:%S
    JMP 0x0060030a                      ; 00600665 | LAB_0060030a
        ;   XREF to: 0060030a (UNCONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 0060067e
    CALL crt_stdio.c_formatTwoDigits_FUN_006002a0 ; 0060067f | void crt_stdio.c_formatTwoDigits_FUN_006002a0(char * buffer, int value)
        ;   XREF to: 006002a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00600684
    JMP 0x006006c0                      ; 00600687 | LAB_006006c0
        ;   XREF to: 006006c0 (UNCONDITIONAL_JUMP)
    PUSH 0xa                            ; 00600689
        ;   Label: LAB_00600689
    ...
    PUSH EAX                            ; 00600698
    CALL crt_stdio.c_IntegerToString_FUN_00607d18 ; 00600699 | char * crt_stdio.c_IntegerToString_FUN_00607d18(int value, char * buffer, int base)
        ;   XREF to: 00607d18 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0060069e
    JMP 0x006006c0                      ; 006006a1 | LAB_006006c0
        ;   XREF to: 006006c0 (UNCONDITIONAL_JUMP)
    CALL crt_time.c_tzset_FUN_006072f8  ; 006006a3 | void crt_time.c_tzset_FUN_006072f8()
        ;   Label: LAB_006006a3
        ;   XREF to: 006072f8 (UNCONDITIONAL_CALL)
    MOV ESI,dword ptr [EBX + 0x20]      ; 006006a8
    MOV ESI,dword ptr [ESI*0x4 + 0x6851c0] ; 006006ab | void * PTR_s_EST_006851c0
    JMP 0x006006c0                      ; 006006b2 | LAB_006006c0
        ;   XREF to: 006006c0 (UNCONDITIONAL_JUMP)
    ...
    SCASB.REPNE ES:EDI                  ; 006006cd | undefined1 DAT_00658c0c | DAT_00658bf4 = 0xa | DAT_00658c04 = 0x41
    NOT ECX                             ; 006006cf
    DEC ECX                             ; 006006d1
    POP ES                              ; 006006d2
    ...
    JBE 0x006006e2                      ; 006006de | LAB_006006e2
    ...
    JMP 0x0060030a                      ; 0060072a | LAB_0060030a
        ;   XREF to: 0060030a (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x84]      ; 0060072f
        ;   Label: LAB_0060072f
    CMP EAX,dword ptr [ESP + 0xa8]      ; 00600736
    JNC 0x00600756                      ; 0060073d | LAB_00600756
    ...
    JMP 0x00600758                      ; 00600754 | LAB_00600758
