...
;                               FUNCTION
; *****************************************************************************
; __cdecl time_t __cdecl crt_time_c_time_FUN_006001f0(time_t *optional_output)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 006001f0
        ;   Label: crt_time.c_time_FUN_006001f0
    ...
    MOV EAX,ESP                         ; 0060020d
        ;   Label: LAB_0060020d
    PUSH EAX                            ; 0060020f
    CALL crt_time.c__mktime_FUN_00600f80 ; 00600210
