...
section .text
    ...
    JNZ 0x00607854                      ; 00607828
        ;   XREF to: 00607854 (CONDITIONAL_JUMP)  ; LAB_00607854
    MOV ECX,0x64                        ; 0060782a
    MOV EAX,EBX                         ; 0060782f
    XOR EDX,EDX                         ; 00607831
    DIV ECX                             ; 00607833
    TEST EDX,EDX                        ; 00607835
    JZ 0x00607840                       ; 00607837
        ;   XREF to: 00607840 (CONDITIONAL_JUMP)  ; LAB_00607840
