// Name: crt_time.c__strftime_FUN_006002d4
// Address: 006002d4
// Address Range: [[006002d4, 00600762]]
// Convention: __cdecl
// Signature: uint __cdecl crt_time_c__strftime_FUN_006002d4(char *dest_buffer,uint buffer_size,char *format_string,_tm *time_ptr)
...
LAB_006004a2:
      ...
      pacVar6 = (char (*) [4])&INT_00658bf4;
    }
    else if (bVar2 < 0x77) {
      if (bVar2 < 0x72) {
        if (bVar2 != 0x70) goto LAB_006006b4;
        if (time_ptr->tm_hour < 0xc) {
          pacVar6 = (char (*) [4])&INT_00658c04;
        }
        else {
          pacVar6 = (char (*) [4])&INT_00658c08;
        }
      }
      else {
        if (bVar2 < 0x73) {
