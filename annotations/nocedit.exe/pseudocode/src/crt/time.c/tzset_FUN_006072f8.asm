...
section .text
    ...
    MOV AH,byte ptr [0x006851d4]        ; 00607204 | byte g_TimezoneInitFlags
    TEST AH,0x1                         ; 0060720a
    JZ 0x00607218                       ; 0060720d | LAB_00607218
        ;   XREF to: 00607218 (CONDITIONAL_JUMP)
    TEST AH,0x2                         ; 0060720f
    JNZ 0x006072ed                      ; 00607212 | LAB_006072ed
        ;   XREF to: 006072ed (CONDITIONAL_JUMP)
    MOV DH,byte ptr [0x006851d4]        ; 00607218 | byte g_TimezoneInitFlags
        ;   Label: LAB_00607218
    MOV EAX,ESP                         ; 0060721e
    OR DH,0x2                           ; 00607220
    PUSH EAX                            ; 00607223
    MOV byte ptr [0x006851d4],DH        ; 00607224 | byte g_TimezoneInitFlags
    CALL dword ptr CS:[0x6115c4]        ; 0060722a | GetTimeZoneInformation * PTR_GetTimeZoneInformation_006115c4
    CMP EAX,0x1                         ; 00607231
    JC 0x006072ed                       ; 00607234 | LAB_006072ed
        ;   XREF to: 006072ed (CONDITIONAL_JUMP)
    JBE 0x00607271                      ; 0060723a | LAB_00607271
        ;   XREF to: 00607271 (CONDITIONAL_JUMP)
    CMP EAX,0x2                         ; 0060723c
    JNZ 0x006072ed                      ; 0060723f | LAB_006072ed
        ;   XREF to: 006072ed (CONDITIONAL_JUMP)
    MOV dword ptr [0x006851cc],0x1      ; 00607245 | int g_DaylightSavingActive
    ...
    MOV [0x006851d0],EAX                ; 00607262 | int g_DaylightSavingOffset
    NEG EBX                             ; 00607267
    MOV dword ptr [0x006851d0],EBX      ; 00607269 | int g_DaylightSavingOffset
    JMP 0x00607279                      ; 0060726f | LAB_00607279
        ;   XREF to: 00607279 (UNCONDITIONAL_JUMP)
    XOR ECX,ECX                         ; 00607271
        ;   Label: LAB_00607271
    MOV dword ptr [0x006851cc],ECX      ; 00607273 | int g_DaylightSavingActive
    ...
    PUSH 0x80                           ; 0060728c
    MOV [0x006851c8],EAX                ; 00607291 | int g_TimezoneOffset
    LEA EAX,[ESP + 0x8]                 ; 00607296
    PUSH EAX                            ; 0060729a
    PUSH 0x6850bc                       ; 0060729b | = "EST" | s_EST_006850bc = EST
    CALL crt_string.c_wcstombs_FUN_0060c0c0 ; 006072a0 | int crt_string.c_wcstombs_FUN_0060c0c0(char * dest, wchar_t * src, SIZE_T dest_size)
        ;   XREF to: 0060c0c0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 006072a5
    CMP EAX,-0x1                        ; 006072a8
    JNZ 0x006072b7                      ; 006072ab | LAB_006072b7
        ;   XREF to: 006072b7 (CONDITIONAL_JUMP)
    XOR BH,BH                           ; 006072ad
    MOV byte ptr [0x006850bc],BH        ; 006072af | = "EST" | s_EST_006850bc = EST
    JMP 0x006072bf                      ; 006072b5 | LAB_006072bf
    ...
    PUSH EAX                            ; 006072c8
    PUSH 0x68513d                       ; 006072c9 | = "EDT" | s_EDT_0068513d = EDT
    CALL crt_string.c_wcstombs_FUN_0060c0c0 ; 006072ce | int crt_string.c_wcstombs_FUN_0060c0c0(char * dest, wchar_t * src, SIZE_T dest_size)
        ;   XREF to: 0060c0c0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 006072d3
    CMP EAX,-0x1                        ; 006072d6
    JNZ 0x006072e5                      ; 006072d9 | LAB_006072e5
        ;   XREF to: 006072e5 (CONDITIONAL_JUMP)
    XOR CH,CH                           ; 006072db
    MOV byte ptr [0x0068513d],CH        ; 006072dd | = "EDT" | s_EDT_0068513d = EDT
    JMP 0x006072ed                      ; 006072e3 | LAB_006072ed
    ...
    POP EBX                             ; 006072f4
    RET                                 ; 006072f5
    PUSH 0x659058                       ; 006072f8 | = "TZ" | s_TZ_00659058 = TZ
        ;   Label: crt_time.c_tzset_FUN_006072f8
    CALL crt_env.c_getenv_FUN_006013f0  ; 006072fd | char * crt_env.c_getenv_FUN_006013f0(char * name)
        ;   XREF to: 006013f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00607302
    TEST EAX,EAX                        ; 00607305
    JZ 0x006071fc                       ; 00607307 | LAB_006071fc
        ;   XREF to: 006071fc (CONDITIONAL_JUMP)
    PUSH EAX                            ; 0060730d
    CALL crt_time.c_parse_tz_string_FUN_0060756c ; 0060730e | void crt_time.c_parse_tz_string_FUN_0060756c(char * tz_string)
