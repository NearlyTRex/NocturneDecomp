...
;                               FUNCTION
; *****************************************************************************
; __watcallStack char * crt_time.c_asctimeFormat_FUN_00601678(tm * timeptr, char * buffer)
;
; Parameters:
...
section .text
    ...
    MOV DL,byte ptr [EAX + 0x684cac]    ; 0060168a | char[7] g_WeekdayInitial
    MOV byte ptr [EBX],DL               ; 00601690
    MOV DL,byte ptr [EAX + 0x684cb3]    ; 00601692 | char[7] g_WeekdaySecondInitial
    MOV byte ptr [EBX + 0x1],DL         ; 00601698
    MOV AL,byte ptr [EAX + 0x684cba]    ; 0060169b | char[7] g_WeekdayThirdInitial
    MOV byte ptr [EBX + 0x3],0x20       ; 006016a1
    MOV byte ptr [EBX + 0x2],AL         ; 006016a5
    MOV EAX,dword ptr [ESI + 0x10]      ; 006016a8
    MOV DL,byte ptr [EAX + 0x684c88]    ; 006016ab | char[12] g_MonthInitial
    MOV byte ptr [EBX + 0x4],DL         ; 006016b1
    MOV DL,byte ptr [EAX + 0x684c94]    ; 006016b4 | char[12] g_MonthSecondInitial
    MOV byte ptr [EBX + 0x5],DL         ; 006016ba
    MOV AL,byte ptr [EAX + 0x684ca0]    ; 006016bd | char[12] g_MonthThirdInitial
    ...
    PUSH EDX                            ; 006016d0
    CALL crt_time.c_formatTwoDigits_FUN_00601640 ; 006016d1 | void crt_time.c_formatTwoDigits_FUN_00601640(int number, int position, char * buffer)
        ;   XREF to: 00601640 (UNCONDITIONAL_CALL)
    MOV AH,byte ptr [EBX + 0x8]         ; 006016d6
    ADD ESP,0xc                         ; 006016d9
    CMP AH,0x30                         ; 006016dc
    JNZ 0x006016e5                      ; 006016df | LAB_006016e5
    ...
    PUSH ECX                            ; 006016ef
    CALL crt_time.c_formatTwoDigits_FUN_00601640 ; 006016f0 | void crt_time.c_formatTwoDigits_FUN_00601640(int number, int position, char * buffer)
        ;   XREF to: 00601640 (UNCONDITIONAL_CALL)
    ...
    PUSH EDI                            ; 00601702
    CALL crt_time.c_formatTwoDigits_FUN_00601640 ; 00601703 | void crt_time.c_formatTwoDigits_FUN_00601640(int number, int position, char * buffer)
        ;   XREF to: 00601640 (UNCONDITIONAL_CALL)
    ...
    PUSH EBP                            ; 00601714
    CALL crt_time.c_formatTwoDigits_FUN_00601640 ; 00601715 | void crt_time.c_formatTwoDigits_FUN_00601640(int number, int position, char * buffer)
        ;   XREF to: 00601640 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0060173d
    CALL crt_time.c_formatTwoDigits_FUN_00601640 ; 0060173e | void crt_time.c_formatTwoDigits_FUN_00601640(int number, int position, char * buffer)
        ;   XREF to: 00601640 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0060174d
    CALL crt_time.c_formatTwoDigits_FUN_00601640 ; 0060174e | void crt_time.c_formatTwoDigits_FUN_00601640(int number, int position, char * buffer)
        ;   XREF to: 00601640 (UNCONDITIONAL_CALL)
