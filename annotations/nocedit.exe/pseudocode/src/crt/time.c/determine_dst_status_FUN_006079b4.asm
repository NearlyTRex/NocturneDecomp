...
section .text
    ...
    MOV EAX,[0x006851c4]                ; 006079bf | = "EDT" | void * PTR_s_EDT_006851c4 | s_EDT_0068513d = EDT
    MOV DL,byte ptr [EAX]               ; 006079c4 | = "EDT" | s_EDT_0068513d = EDT
    XOR ESI,ESI                         ; 006079c6
    TEST DL,DL                          ; 006079c8
    JZ 0x00607c7b                       ; 006079ca | LAB_00607c7b
        ;   XREF to: 00607c7b (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [EBX + 0x14]      ; 006079d0
    PUSH EDX                            ; 006079d3
    PUSH 0x685098                       ; 006079d4 | int g_DstTransitionSecond
    PUSH 0x685074                       ; 006079d9 | dst_rule g_DstStartRule
    CALL crt_unknown.c_FUN_00607958     ; 006079de | undefined crt_unknown.c_FUN_00607958()
        ;   XREF to: 00607958 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 006079e3
    MOV dword ptr [ESP + 0x10],EAX      ; 006079e6
    TEST EAX,EAX                        ; 006079ea
    JZ 0x006079fa                       ; 006079ec | LAB_006079fa
        ;   XREF to: 006079fa (CONDITIONAL_JUMP)
    MOV EBP,0x685098                    ; 006079ee | int g_DstTransitionSecond
    MOV EDI,0x685074                    ; 006079f3 | dst_rule g_DstStartRule
    JMP 0x00607a04                      ; 006079f8 | LAB_00607a04
        ;   XREF to: 00607a04 (UNCONDITIONAL_JUMP)
    MOV EBP,0x685074                    ; 006079fa | dst_rule g_DstStartRule
        ;   Label: LAB_006079fa
    MOV EDI,0x685098                    ; 006079ff | int g_DstTransitionSecond
    ...
    PUSH EAX                            ; 00607a13
    CALL crt_time.c_is_leap_year_FUN_00607820 ; 00607a14 | int crt_time.c_is_leap_year_FUN_00607820(int year)
    ...
    JZ 0x00607a36                       ; 00607a26 | LAB_00607a36
        ;   XREF to: 00607a36 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [EAX + 0x665f52]  ; 00607a28 | short g_DaysInMonth_Leap
    MOV EAX,dword ptr [EAX + 0x665f50]  ; 00607a2e | DAT_00665f50
    JMP 0x00607a42                      ; 00607a34 | LAB_00607a42
        ;   XREF to: 00607a42 (UNCONDITIONAL_JUMP)
    MOV EDX,dword ptr [EAX + 0x665f38]  ; 00607a36 | short g_DaysInMonth_Normal
        ;   Label: LAB_00607a36
    ...
    MOV EAX,dword ptr [EBP + 0x20]      ; 00607a50 | undefined4 DAT_006850b8
    MOV dword ptr [ESP + 0x4],ECX       ; 00607a53
    TEST EAX,EAX                        ; 00607a57
    JNZ 0x00607afd                      ; 00607a59 | LAB_00607afd
        ;   XREF to: 00607afd (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x14]      ; 00607a5f
    MOV ECX,dword ptr [EBP + 0x10]      ; 00607a63 | undefined4 DAT_006850a8
    CMP EAX,ECX                         ; 00607a66
    JLE 0x00607a74                      ; 00607a68 | LAB_00607a74
        ;   XREF to: 00607a74 (CONDITIONAL_JUMP)
    MOV ESI,0x1                         ; 00607a6a
    JMP 0x00607b4e                      ; 00607a6f | LAB_00607b4e
        ;   XREF to: 00607b4e (UNCONDITIONAL_JUMP)
    JNZ 0x00607b4e                      ; 00607a74 | LAB_00607b4e
        ;   Label: LAB_00607a74
        ;   XREF to: 00607b4e (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [EBX + 0x18]      ; 00607a7a
    MOV ECX,dword ptr [EBP + 0x18]      ; 00607a7d | undefined4 DAT_006850b0
    ...
    MOV EAX,dword ptr [EBP + 0x18]      ; 00607aa0 | undefined4 DAT_006850b0
    ...
    MOV EDX,dword ptr [EBP + 0xc]       ; 00607ab2 | undefined4 DAT_006850a4
    CMP EDX,0x5                         ; 00607ab5
    JNZ 0x00607adf                      ; 00607ab8 | LAB_00607adf
    ...
    JGE 0x00607b4e                      ; 00607ac7 | LAB_00607b4e
        ;   XREF to: 00607b4e (CONDITIONAL_JUMP)
    MOV ESI,0x1                         ; 00607acd
    CMP ECX,EAX                         ; 00607ad2
    JG 0x00607b4e                       ; 00607ad4 | LAB_00607b4e
        ;   XREF to: 00607b4e (CONDITIONAL_JUMP)
    JMP 0x00607b55                      ; 00607ada | LAB_00607b55
    ...
    JG 0x00607b4e                       ; 00607af0 | LAB_00607b4e
        ;   XREF to: 00607b4e (CONDITIONAL_JUMP)
    MOV ESI,0x1                         ; 00607af2
    CMP ECX,EAX                         ; 00607af7
    JGE 0x00607b4e                      ; 00607af9 | LAB_00607b4e
        ;   XREF to: 00607b4e (CONDITIONAL_JUMP)
    JMP 0x00607b55                      ; 00607afb | LAB_00607b55
        ;   XREF to: 00607b55 (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + 0x1c]      ; 00607afd | undefined4 DAT_006850b4
        ;   Label: LAB_00607afd
    MOV EDX,dword ptr [EBP + 0x20]      ; 00607b00 | undefined4 DAT_006850b8
    MOV dword ptr [ESP + 0x18],EAX      ; 00607b03
    CMP EDX,0x1                         ; 00607b07
    JNZ 0x00607b3c                      ; 00607b0a | LAB_00607b3c
        ;   XREF to: 00607b3c (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0x14]      ; 00607b0c
    ADD EAX,0x76c                       ; 00607b0f
    PUSH EAX                            ; 00607b14
    CALL crt_time.c_is_leap_year_FUN_00607820 ; 00607b15 | int crt_time.c_is_leap_year_FUN_00607820(int year)
        ;   XREF to: 00607820 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00607b1a
    TEST EAX,EAX                        ; 00607b1d
    JZ 0x00607b38                       ; 00607b1f | LAB_00607b38
        ;   XREF to: 00607b38 (CONDITIONAL_JUMP)
    MOV EAX,[0x00665f3a]                ; 00607b21 | undefined4 DAT_00665f3a
    MOV ECX,dword ptr [ESP + 0x18]      ; 00607b26
    SAR EAX,0x10                        ; 00607b2a
    CMP EAX,ECX                         ; 00607b2d
    JGE 0x00607b38                      ; 00607b2f | LAB_00607b38
        ;   XREF to: 00607b38 (CONDITIONAL_JUMP)
    ...
    JL 0x00607b4e                       ; 00607b45 | LAB_00607b4e
        ;   XREF to: 00607b4e (CONDITIONAL_JUMP)
    MOV ESI,0x1                         ; 00607b47
    JZ 0x00607b55                       ; 00607b4c | LAB_00607b55
        ;   XREF to: 00607b55 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x4],0x0       ; 00607b4e
        ;   Label: LAB_00607b4e
    JZ 0x00607b6c                       ; 00607b53 | LAB_00607b6c
        ;   XREF to: 00607b6c (CONDITIONAL_JUMP)
    PUSH EBP                            ; 00607b55 | int g_DstTransitionSecond
        ;   Label: LAB_00607b55
    PUSH EBX                            ; 00607b56
    CALL crt_unknown.c_FUN_00607c88     ; 00607b57 | undefined crt_unknown.c_FUN_00607c88()
    ...
    JLE 0x00607ba5                      ; 00607b9c | LAB_00607ba5
        ;   XREF to: 00607ba5 (CONDITIONAL_JUMP)
    XOR ESI,ESI                         ; 00607b9e
    JMP 0x00607c5d                      ; 00607ba0 | LAB_00607c5d
        ;   XREF to: 00607c5d (UNCONDITIONAL_JUMP)
    JNZ 0x00607c5d                      ; 00607ba5 | LAB_00607c5d
        ;   Label: LAB_00607ba5
    ...
    JGE 0x00607c1f                      ; 00607c16 | LAB_00607c1f
        ;   XREF to: 00607c1f (CONDITIONAL_JUMP)
    MOV ESI,0x1                         ; 00607c18
    JMP 0x00607c5d                      ; 00607c1d | LAB_00607c5d
        ;   XREF to: 00607c5d (UNCONDITIONAL_JUMP)
    CMP EDX,EAX                         ; 00607c1f
        ;   Label: LAB_00607c1f
    JGE 0x00607c5d                      ; 00607c21 | LAB_00607c5d
        ;   XREF to: 00607c5d (CONDITIONAL_JUMP)
    JMP 0x00607c63                      ; 00607c23 | LAB_00607c63
        ;   XREF to: 00607c63 (UNCONDITIONAL_JUMP)
    MOV EBP,dword ptr [EDI + 0x1c]      ; 00607c25 | DAT_00685090
        ;   Label: LAB_00607c25
    CMP EAX,0x1                         ; 00607c28
    JNZ 0x00607c50                      ; 00607c2b | LAB_00607c50
        ;   XREF to: 00607c50 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0x14]      ; 00607c2d
    ADD EAX,0x76c                       ; 00607c30
    PUSH EAX                            ; 00607c35
    CALL crt_time.c_is_leap_year_FUN_00607820 ; 00607c36 | int crt_time.c_is_leap_year_FUN_00607820(int year)
        ;   XREF to: 00607820 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00607c3b
    TEST EAX,EAX                        ; 00607c3e
    JZ 0x00607c4f                       ; 00607c40 | LAB_00607c4f
        ;   XREF to: 00607c4f (CONDITIONAL_JUMP)
    MOV EAX,[0x00665f3a]                ; 00607c42 | undefined4 DAT_00665f3a
    SAR EAX,0x10                        ; 00607c47
    CMP EBP,EAX                         ; 00607c4a
    JLE 0x00607c4f                      ; 00607c4c | LAB_00607c4f
        ;   XREF to: 00607c4f (CONDITIONAL_JUMP)
    INC EBP                             ; 00607c4e
    DEC EBP                             ; 00607c4f
        ;   Label: LAB_00607c4f
    ...
    JG 0x00607c5d                       ; 00607c55 | LAB_00607c5d
        ;   XREF to: 00607c5d (CONDITIONAL_JUMP)
    XOR ESI,ESI                         ; 00607c57
    CMP EBP,ECX                         ; 00607c59
    JZ 0x00607c63                       ; 00607c5b | LAB_00607c63
        ;   XREF to: 00607c63 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP],0x0             ; 00607c5d
        ;   Label: LAB_00607c5d
    JZ 0x00607c6f                       ; 00607c61 | LAB_00607c6f
        ;   XREF to: 00607c6f (CONDITIONAL_JUMP)
    PUSH EDI                            ; 00607c63 | dst_rule g_DstStartRule
        ;   Label: LAB_00607c63
    PUSH EBX                            ; 00607c64
    CALL crt_unknown.c_FUN_00607c88     ; 00607c65 | undefined crt_unknown.c_FUN_00607c88()
        ;   XREF to: 00607c88 (UNCONDITIONAL_CALL)
    ...
    JZ 0x00607c7b                       ; 00607c75 | LAB_00607c7b
        ;   XREF to: 00607c7b (CONDITIONAL_JUMP)
