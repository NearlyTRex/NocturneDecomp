...
;                               FUNCTION
; *****************************************************************************
; __watcallStack char * __watcallStack crt_time_c_asctime_FUN_00601768(_tm *timeptr)
;
; Parameters:
...
section .text
    ...
    CALL crt_time.c_asctimeFormat_FUN_00601678 ; 00601777
        ;   XREF to: 00601678 (UNCONDITIONAL_CALL)  ; char * crt_time.c_asctimeFormat_FUN_00601678(_tm * timeptr, char * buffer)
