...
;                               FUNCTION
; *****************************************************************************
; __watcallStack char * crt_time.c_asctime_FUN_00601768(tm * timeptr)
;
; Parameters:
...
section .text
    ...
    CALL dword ptr [0x00684ee4]         ; 00601768 | GET_TLS_FUNC * PTR_crt_thread.c_GetTLS_FUN_0060242c_00684ee4
        ;   Label: crt_time.c_asctime_FUN_00601768
    ADD EAX,0x38                        ; 0060176e
    PUSH EAX                            ; 00601771
    MOV EDX,dword ptr [ESP + 0x8]       ; 00601772
    PUSH EDX                            ; 00601776
    CALL crt_time.c_asctimeFormat_FUN_00601678 ; 00601777 | char * crt_time.c_asctimeFormat_FUN_00601678(tm * timeptr, char * buffer)
