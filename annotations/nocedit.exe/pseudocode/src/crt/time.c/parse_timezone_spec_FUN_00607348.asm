...
;                               FUNCTION
; *****************************************************************************
; __cdecl char * crt_time.c_parse_timezone_spec_FUN_00607348(char * tz_string, char * name_buffer, int * offset_seconds)
;
; Parameters:
...
section .text
    ...
    JNZ 0x00607359                      ; 00607356 | LAB_00607359
    ...
    MOV DL,byte ptr [EBX]               ; 0060735b
        ;   Label: LAB_0060735b
    TEST DL,DL                          ; 0060735d
    JZ 0x0060737d                       ; 0060735f | LAB_0060737d
        ;   XREF to: 0060737d (CONDITIONAL_JUMP)
    CMP DL,0x2c                         ; 00607361
    JZ 0x0060737d                       ; 00607364 | LAB_0060737d
        ;   XREF to: 0060737d (CONDITIONAL_JUMP)
    CMP DL,0x2d                         ; 00607366
    JZ 0x0060737d                       ; 00607369 | LAB_0060737d
        ;   XREF to: 0060737d (CONDITIONAL_JUMP)
    CMP DL,0x2b                         ; 0060736b
    JZ 0x0060737d                       ; 0060736e | LAB_0060737d
        ;   XREF to: 0060737d (CONDITIONAL_JUMP)
    CMP DL,0x30                         ; 00607370
    JC 0x0060737a                       ; 00607373 | LAB_0060737a
        ;   XREF to: 0060737a (CONDITIONAL_JUMP)
    CMP DL,0x39                         ; 00607375
    JBE 0x0060737d                      ; 00607378 | LAB_0060737d
        ;   XREF to: 0060737d (CONDITIONAL_JUMP)
    INC EBX                             ; 0060737a
        ;   Label: LAB_0060737a
    JMP 0x0060735b                      ; 0060737b | LAB_0060735b
        ;   XREF to: 0060735b (UNCONDITIONAL_JUMP)
    MOV EBP,EBX                         ; 0060737d
        ;   Label: LAB_0060737d
    SUB EBP,ESI                         ; 0060737f
    CMP EBP,0x80                        ; 00607381
    JLE 0x0060738e                      ; 00607387 | LAB_0060738e
    ...
    JNZ 0x006073c1                      ; 006073b8 | LAB_006073c1
        ;   XREF to: 006073c1 (CONDITIONAL_JUMP)
    MOV ESI,0x1                         ; 006073ba
    JMP 0x006073c6                      ; 006073bf | LAB_006073c6
        ;   XREF to: 006073c6 (UNCONDITIONAL_JUMP)
    CMP DL,0x2b                         ; 006073c1
        ;   Label: LAB_006073c1
    JNZ 0x006073c8                      ; 006073c4 | LAB_006073c8
    ...
    JC 0x00607459                       ; 006073cc | LAB_00607459
        ;   XREF to: 00607459 (CONDITIONAL_JUMP)
    CMP AL,0x39                         ; 006073d2
    JA 0x00607459                       ; 006073d4 | LAB_00607459
        ;   XREF to: 00607459 (CONDITIONAL_JUMP)
    ...
    CALL crt_string.c_parse_uint_FUN_00607318 ; 006073ee | char * crt_string.c_parse_uint_FUN_00607318(char * str, int * result)
    ...
    JNZ 0x00607426                      ; 006073fd | LAB_00607426
        ;   XREF to: 00607426 (CONDITIONAL_JUMP)
    LEA EBX,[ESP + 0x4]                 ; 006073ff
    PUSH EBX                            ; 00607403
    INC EAX                             ; 00607404
    PUSH EAX                            ; 00607405
    CALL crt_string.c_parse_uint_FUN_00607318 ; 00607406 | char * crt_string.c_parse_uint_FUN_00607318(char * str, int * result)
        ;   XREF to: 00607318 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0060740b
    MOV DH,byte ptr [EAX]               ; 0060740e
    MOV EBX,EAX                         ; 00607410
    CMP DH,0x3a                         ; 00607412
    JNZ 0x00607426                      ; 00607415 | LAB_00607426
        ;   XREF to: 00607426 (CONDITIONAL_JUMP)
    MOV EBX,ESP                         ; 00607417
    PUSH EBX                            ; 00607419
    INC EAX                             ; 0060741a
    PUSH EAX                            ; 0060741b
    CALL crt_string.c_parse_uint_FUN_00607318 ; 0060741c | char * crt_string.c_parse_uint_FUN_00607318(char * str, int * result)
        ;   XREF to: 00607318 (UNCONDITIONAL_CALL)
    ...
    JZ 0x00607459                       ; 00607451 | LAB_00607459
        ;   XREF to: 00607459 (CONDITIONAL_JUMP)
