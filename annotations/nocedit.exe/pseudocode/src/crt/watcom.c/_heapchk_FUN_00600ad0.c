// Name: crt_watcom.c__heapchk_FUN_00600ad0
// Address: 00600ad0
// Address Range: [[00600ad0, 00600b93]]
// Convention: __cdecl
// Signature: int __cdecl crt_watcom_c__heapchk_FUN_00600ad0(void)
  ...
  if (iVar1 == 0) {
    ...
    while( true ) {
      ...
      if (HStack_18.allocation_status == 1) {
        iVar1 = FUN_00600a64(HStack_18.current_block_ptr);
        if (iVar1 != 0) break;
