...
;                               FUNCTION
; *****************************************************************************
; unknown undefined crt_watcom.c_memmax_FUN_00600940()
;
;
; XREF[1]:
...
section .text
    ...
    PUSH ESI                            ; 00600941
    CALL dword ptr [0x00684f00]         ; 00600942 | void * PTR_crt_sync.c_EnterCriticalSection_FUN_00602434_00684f00
    MOV ESI,dword ptr [0x00684ed4]      ; 00600948 | Heap * g_MainHeap
    XOR EBX,EBX                         ; 0060094e
    TEST ESI,ESI                        ; 00600950
    JZ 0x0060097a                       ; 00600952 | LAB_0060097a
        ;   XREF to: 0060097a (CONDITIONAL_JUMP)
    LEA ECX,[ESI + 0x20]                ; 00600954
        ;   Label: LAB_00600954
    MOV EAX,dword ptr [ESI + 0x28]      ; 00600957
    CMP EAX,ECX                         ; 0060095a
    JZ 0x00600973                       ; 0060095c | LAB_00600973
