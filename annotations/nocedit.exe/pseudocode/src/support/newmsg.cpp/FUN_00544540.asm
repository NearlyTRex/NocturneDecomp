...
section .text
    ...
    MOV ECX,dword ptr [0x02cf6a94]      ; 00544540 | int g_MouseButtonFlags
    ...
    JZ 0x0054458b                       ; 00544550 | LAB_0054458b
