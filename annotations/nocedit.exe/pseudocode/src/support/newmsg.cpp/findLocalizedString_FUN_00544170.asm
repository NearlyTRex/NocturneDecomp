...
section .text
    ...
    JLE 0x0054418b                      ; 00544182 | LAB_0054418b
    ...
    MOV ECX,dword ptr [ESI + 0x2fa8cdc] ; 0054419f | char *[500] g_MessageKeys
    PUSH ECX                            ; 005441a5
    PUSH EDI                            ; 005441a6
    CALL crt_string.c_strcmp_FUN_005fef20 ; 005441a7 | int crt_string.c_strcmp_FUN_005fef20(char * str1, char * str2)
        ;   XREF to: 005fef20 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005441ac
    TEST EAX,EAX                        ; 005441af
    JL 0x005441c0                       ; 005441b1 | LAB_005441c0
        ;   XREF to: 005441c0 (CONDITIONAL_JUMP)
    JG 0x005441d1                       ; 005441b3 | LAB_005441d1
        ;   XREF to: 005441d1 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESI + 0x2fa94ac] ; 005441b5 | char *[500] g_MessageTexts
    POP EBP                             ; 005441bb
    POP EDI                             ; 005441bc
    POP ESI                             ; 005441bd
    POP EBX                             ; 005441be
    ...
    PUSH EBP                            ; 005441c2
    PUSH EDI                            ; 005441c3
    CALL support_newmsg.cpp_findLocalizedString_FUN_00544170 ; 005441c4 | char * support_newmsg.cpp_findLocalizedString_FUN_00544170(char * key, int lower_bound, int upper_bound)
    ...
    PUSH EBX                            ; 005441d7
    PUSH EDI                            ; 005441d8
    CALL support_newmsg.cpp_findLocalizedString_FUN_00544170 ; 005441d9 | char * support_newmsg.cpp_findLocalizedString_FUN_00544170(char * key, int lower_bound, int upper_bound)
        ;   XREF to: 00544170 (UNCONDITIONAL_CALL)
