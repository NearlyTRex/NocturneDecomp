...
section .text
    ...
    PUSH 0x8                            ; 00544389
    PUSH EAX                            ; 0054438b
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 0054438c
    ...
    PUSH EAX                            ; 005443a0
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 005443a1
        ;   XREF to: 005fe667 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
    ...
    PUSH EAX                            ; 005443b5
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 005443b6
        ;   XREF to: 005fe667 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
