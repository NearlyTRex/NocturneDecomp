...
section .text
    ...
    PUSH EAX                            ; 005443eb
    CALL support_newmsg.cpp_freeSkullBitmaps_FUN_00544750 ; 005443ec | void support_newmsg.cpp_freeSkullBitmaps_FUN_00544750(CAlphaBitmap * bitmap)
        ;   XREF to: 00544750 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005443f1
    PUSH 0x0                            ; 005443f4
    SUB EAX,0x8c                        ; 005443f6
    PUSH EAX                            ; 005443fb
    CALL support_newmsg.cpp_freeBitmap_FUN_00544730 ; 005443fc | void support_newmsg.cpp_freeBitmap_FUN_00544730(CAlphaBitmap * * objs)
        ;   XREF to: 00544730 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00544401
    PUSH 0x0                            ; 00544404
    SUB EAX,0xa0                        ; 00544406
    PUSH EAX                            ; 0054440b
    CALL core_menu.cpp_freeBitmaps_FUN_00514f50 ; 0054440c | void core_menu.cpp_freeBitmaps_FUN_00514f50(CAlphaBitmap * * array)
