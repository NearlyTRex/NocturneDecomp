...
section .text
    ...
    CALL support_newmsg.cpp_freeSkullBitmaps_FUN_00544750 ; 005443ec
        ;   XREF to: 00544750 (UNCONDITIONAL_CALL)  ; CAlphaBitmap * support_newmsg.cpp_freeSkullBitmaps_FUN_00544750(CAlphaBitmap * objs)
    ADD ESP,0x8                         ; 005443f1
    PUSH 0x0                            ; 005443f4
    SUB EAX,0x8c                        ; 005443f6
    PUSH EAX                            ; 005443fb
    CALL support_newmsg.cpp_freeBitmap_FUN_00544730 ; 005443fc
        ;   XREF to: 00544730 (UNCONDITIONAL_CALL)  ; CAlphaBitmap * support_newmsg.cpp_freeBitmap_FUN_00544730(CAlphaBitmap * objs)
