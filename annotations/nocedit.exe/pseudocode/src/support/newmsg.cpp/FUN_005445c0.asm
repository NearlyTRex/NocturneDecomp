...
section .text
    ...
    MOV EDX,dword ptr [0x02cf6a90]      ; 005445c6 | int g_MouseY
    MOV EAX,[0x02cf6a8c]                ; 005445cc | int g_MouseX
    MOV ECX,dword ptr [EBX + 0x25c]     ; 005445d1
    SUB EDX,0xc                         ; 005445d7
    SUB EAX,0xd                         ; 005445da
    CMP ECX,0x1                         ; 005445dd
    JZ 0x00544674                       ; 005445e0 | LAB_00544674
        ;   XREF to: 00544674 (CONDITIONAL_JUMP)
    CMP ECX,0x2                         ; 005445e6
    JNZ 0x005446a4                      ; 005445e9 | LAB_005446a4
    ...
    PUSH EAX                            ; 0054461b
        ;   Label: LAB_0054461b
    CALL engine_alphabit.cpp_CAlphaBitmap_display_FUN_00410950 ; 0054461c | void engine_alphabit.cpp_CAlphaBitmap_display_FUN_00410950(CAlphaBitmap * this_ptr, int x, int y, int alpha)
        ;   Label: LAB_0054461c
        ;   XREF to: 00410950 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00544621
    MOV EDI,dword ptr [EBX + 0x25c]     ; 00544624
    TEST EDI,EDI                        ; 0054462a
    JZ 0x00544671                       ; 0054462c | LAB_00544671
        ;   XREF to: 00544671 (CONDITIONAL_JUMP)
    CMP EDI,0x2                         ; 0054462e
    JNZ 0x005446b1                      ; 00544631 | LAB_005446b1
        ;   XREF to: 005446b1 (CONDITIONAL_JUMP)
    MOV EAX,[0x02cf6a80]                ; 00544637 | int g_GlobalDeltaTimeInt
        ;   Label: LAB_00544637
    ...
    JMP 0x0054461b                      ; 0054469f | LAB_0054461b
    ...
    PUSH EAX                            ; 005446aa
    PUSH EBX                            ; 005446ab
    JMP 0x0054461c                      ; 005446ac | LAB_0054461c
        ;   XREF to: 0054461c (UNCONDITIONAL_JUMP)
    PUSH 0x1                            ; 005446b1
        ;   Label: LAB_005446b1
    CALL engine_3d.c_setBlendMode_FUN_00406dd0 ; 005446b3 | void engine_3d.c_setBlendMode_FUN_00406dd0(int blend_mode)
        ;   XREF to: 00406dd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005446b8
    MOV EAX,[0x02cf6a90]                ; 005446bb | int g_MouseY
    PUSH 0x8000                         ; 005446c0
    SUB EAX,0xc                         ; 005446c5
    PUSH EAX                            ; 005446c8
    MOV EAX,[0x02cf6a8c]                ; 005446c9 | int g_MouseX
    ...
    PUSH EAX                            ; 005446f7
    CALL engine_alphabit.cpp_CAlphaBitmap_display_FUN_00410950 ; 005446f8 | void engine_alphabit.cpp_CAlphaBitmap_display_FUN_00410950(CAlphaBitmap * this_ptr, int x, int y, int alpha)
        ;   XREF to: 00410950 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 005446fd
    PUSH 0x0                            ; 00544700
    CALL engine_3d.c_setBlendMode_FUN_00406dd0 ; 00544702 | void engine_3d.c_setBlendMode_FUN_00406dd0(int blend_mode)
        ;   XREF to: 00406dd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00544707
    JMP 0x00544637                      ; 0054470a | LAB_00544637
