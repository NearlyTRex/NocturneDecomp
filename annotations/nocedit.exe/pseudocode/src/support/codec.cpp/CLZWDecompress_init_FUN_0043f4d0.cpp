...
// Convention: __cdecl
// Signature: void __cdecl support_codec_cpp_CLZWDecompress_init_FUN_0043f4d0(CLZWDecompress *this_ptr)
...

{
  ...
  support_codec_cpp_resetBitBuffer_FUN_0043e510(&(this_ptr->lzw_dict).bit_state);
