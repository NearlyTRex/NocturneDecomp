...
section .text
    ...
    PUSH EBX                            ; 0043f0d0
        ;   Label: support_codec.cpp_CLZWDictionary_readCodeFromBuffer_FUN_0043f0d0
    PUSH ESI                            ; 0043f0d1
    PUSH EDI                            ; 0043f0d2
    PUSH EBP                            ; 0043f0d3
    ...
    CALL support_codec.cpp_extractBitsFromBuffer_FUN_0043e840 ; 0043f109
        ;   XREF to: 0043e840 (UNCONDITIONAL_CALL)  ; int support_codec.cpp_extractBitsFromBuffer_FUN_0043e840(SBitBuffer * bit_state, int bit_count, char * * output_pos, int * bytes_remaining)
