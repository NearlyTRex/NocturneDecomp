...
;                               FUNCTION
; *****************************************************************************
; __cdecl int support_codec.cpp_CLZWCompress_process_FUN_0043f360(CLZWCompress * this_ptr, FILE * input_file, int byte_count, FILE * output_file)
;
; Parameters:
...
section .text
    ...
    PUSH ECX                            ; 0043f3b0
    CALL crt_stdio.c_fgetc_FUN_005ff245 ; 0043f3b1 | int crt_stdio.c_fgetc_FUN_005ff245(FILE * stream, uchar * output_byte)
