...
section .text
    ...
    JNZ 0x0043f747                      ; 0043f71a | LAB_0043f747
        ;   XREF to: 0043f747 (CONDITIONAL_JUMP)
    PUSH 0x0                            ; 0043f71c
    ADD EBX,0x4                         ; 0043f71e
    PUSH EBX                            ; 0043f721
    CALL support_codec.cpp_CLZWDictionary_dtor_FUN_0043edf0 ; 0043f722 | CLZWDictionary * support_codec.cpp_CLZWDictionary_dtor_FUN_0043edf0(CLZWDictionary * this_ptr)
        ;   XREF to: 0043edf0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0043f727
    PUSH 0x1                            ; 0043f72a
    LEA EBX,[EAX + -0x4]                ; 0043f72c
    PUSH EBX                            ; 0043f72f
    CALL support_codec.cpp_CCodec_dtor_FUN_0043e9b0 ; 0043f730 | CCodec * support_codec.cpp_CCodec_dtor_FUN_0043e9b0(CCodec * this_ptr, int d1)
    ...
    JNZ 0x0043f762                      ; 0043f741 | LAB_0043f762
        ;   XREF to: 0043f762 (CONDITIONAL_JUMP)
    MOV EAX,EBX                         ; 0043f743
    POP EBX                             ; 0043f745
    RET                                 ; 0043f746
    PUSH 0x65bd10                       ; 0043f747 | WatcomTypeInfo g_CLZWCompressTypeInfo
        ;   Label: LAB_0043f747
    PUSH EBX                            ; 0043f74c
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 0043f74d | void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0043f752
    PUSH EAX                            ; 0043f755
    CALL crt_memory.c_free_FUN_005fe659 ; 0043f756 | void crt_memory.c_free_FUN_005fe659(void * ptr)
    ...
    PUSH EAX                            ; 0043f762
        ;   Label: LAB_0043f762
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 0043f763 | void shape_memdbg.cpp_debugFree_FUN_0050f210(void * ptr)
