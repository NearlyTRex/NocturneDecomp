...
;                               FUNCTION
; *****************************************************************************
; __cdecl int support_codec.cpp_CCodec_finalizeBuffer_FUN_0043ed50(CCodec * this_ptr, char * buffer_ptr, int * buffer_size_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 0043ed73
    CALL crt_strstream.cpp_ostrstream_ctor_FUN_005ff384 ; 0043ed74 | ostrstream * crt_strstream.cpp_ostrstream_ctor_FUN_005ff384(ostrstream * this_ptr, int flags, char * buffer, int buffer_size, ...)
    ...
    PUSH EAX                            ; 0043ed9e
    CALL crt_strstream.cpp_ostrstream_tellp_FUN_005ff45d ; 0043ed9f | int crt_strstream.cpp_ostrstream_tellp_FUN_005ff45d(ostrstream * this_ptr)
    ...
    CALL crt_strstream.cpp_ostrstream_dtor_FUN_005ff48a ; 0043edb4 | ostrstream * crt_strstream.cpp_ostrstream_dtor_FUN_005ff48a(ostrstream * this_ptr, int d1)
