...
section .text
    ...
    JNZ 0x0043f6e7                      ; 0043f6ba | LAB_0043f6e7
        ;   XREF to: 0043f6e7 (CONDITIONAL_JUMP)
    PUSH 0x0                            ; 0043f6bc
    ADD EBX,0x4                         ; 0043f6be
    PUSH EBX                            ; 0043f6c1
    CALL support_codec.cpp_CLZWDictionary_dtor_FUN_0043edf0 ; 0043f6c2 | CLZWDictionary * support_codec.cpp_CLZWDictionary_dtor_FUN_0043edf0(CLZWDictionary * this_ptr)
        ;   XREF to: 0043edf0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0043f6c7
    PUSH 0x1                            ; 0043f6ca
    LEA EBX,[EAX + -0x4]                ; 0043f6cc
    PUSH EBX                            ; 0043f6cf
    CALL support_codec.cpp_CCodec_dtor_FUN_0043e9b0 ; 0043f6d0 | CCodec * support_codec.cpp_CCodec_dtor_FUN_0043e9b0(CCodec * this_ptr, int d1)
    ...
    JNZ 0x0043f702                      ; 0043f6e1 | LAB_0043f702
        ;   XREF to: 0043f702 (CONDITIONAL_JUMP)
    MOV EAX,EBX                         ; 0043f6e3
    POP EBX                             ; 0043f6e5
    RET                                 ; 0043f6e6
    PUSH 0x65bcf0                       ; 0043f6e7 | WatcomTypeInfo g_CLZWDecompressTypeInfo
        ;   Label: LAB_0043f6e7
    PUSH EBX                            ; 0043f6ec
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 0043f6ed | void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0043f6f2
    PUSH EAX                            ; 0043f6f5
    CALL crt_memory.c_free_FUN_005fe659 ; 0043f6f6 | void crt_memory.c_free_FUN_005fe659(void * ptr)
    ...
    PUSH EAX                            ; 0043f702
        ;   Label: LAB_0043f702
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 0043f703 | void shape_memdbg.cpp_debugFree_FUN_0050f210(void * ptr)
