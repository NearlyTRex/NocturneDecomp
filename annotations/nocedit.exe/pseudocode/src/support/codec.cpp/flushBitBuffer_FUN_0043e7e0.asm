...
section .text
    ...
    JL 0x0043e817                       ; 0043e7ef | LAB_0043e817
    ...
    PUSH EAX                            ; 0043e7f7
    PUSH ESI                            ; 0043e7f8
    CALL crt_stdio.c_fputc_FUN_005ff2d7 ; 0043e7f9 | int crt_stdio.c_fputc_FUN_005ff2d7(FILE * stream, int character)
    ...
    JGE 0x0043e7f2                      ; 0043e814 | LAB_0043e7f2
        ;   XREF to: 0043e7f2 (CONDITIONAL_JUMP)
    POP EDI                             ; 0043e816
    CMP dword ptr [EBX],0x0             ; 0043e817
        ;   Label: LAB_0043e817
    JG 0x0043e81f                       ; 0043e81a | LAB_0043e81f
    ...
    PUSH EAX                            ; 0043e824
    PUSH ESI                            ; 0043e825
    CALL crt_stdio.c_fputc_FUN_005ff2d7 ; 0043e826 | int crt_stdio.c_fputc_FUN_005ff2d7(FILE * stream, int character)
        ;   XREF to: 005ff2d7 (UNCONDITIONAL_CALL)
