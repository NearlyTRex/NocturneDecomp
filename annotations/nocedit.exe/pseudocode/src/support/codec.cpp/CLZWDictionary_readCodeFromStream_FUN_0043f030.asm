...
section .text
    ...
    CALL support_codec.cpp_readBitsFromStream_FUN_0043e530 ; 0043f069
        ;   XREF to: 0043e530 (UNCONDITIONAL_CALL)  ; int support_codec.cpp_readBitsFromStream_FUN_0043e530(SBitBuffer * bit_buffer, int bit_count, _istream * istream, int * bytes_remaining)
