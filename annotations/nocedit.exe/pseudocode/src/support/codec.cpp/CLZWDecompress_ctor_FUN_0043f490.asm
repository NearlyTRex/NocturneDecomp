...
;                               FUNCTION
; *****************************************************************************
; __cdecl CLZWDecompress * __cdecl support_codec_cpp_CLZWDecompress_ctor_FUN_0043f490 (CLZWDecompress *this_ptr,int buffer_size,int initial_bits)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 0043f494
    CALL support_codec.cpp_CCodec_ctor_FUN_0043e9a0 ; 0043f495
    ...
    PUSH EAX                            ; 0043f4a0
    CALL support_codec.cpp_CLZWDictionary_ctor_FUN_0043edd0 ; 0043f4a1
    ...
    MOV dword ptr [EAX],0x65bc24        ; 0043f4b0 | g_CLZWDecompressVTable
