...
section .text
    ...
    JL 0x0043f633                       ; 0043f5f2 | LAB_0043f633
    ...
    PUSH ESI                            ; 0043f600
    CALL support_codec.cpp_CLZWDictionary_decodeCodeToBuffer_FUN_0043f270 ; 0043f601 | int support_codec.cpp_CLZWDictionary_decodeCodeToBuffer_FUN_0043f270(CLZWDictionary * this_ptr, int code, char * * buffer_ptr_ptr)
        ;   XREF to: 0043f270 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [EBX + 0x28]      ; 0043f606
    ADD ESP,0xc                         ; 0043f609
    TEST EDX,EDX                        ; 0043f60c
    JL 0x0043f626                       ; 0043f60e | LAB_0043f626
        ;   XREF to: 0043f626 (CONDITIONAL_JUMP)
    PUSH EDX                            ; 0043f610
    PUSH EAX                            ; 0043f611
    PUSH ESI                            ; 0043f612
    CALL support_codec.cpp_CLZWDictionary_addNode_FUN_0043ef90 ; 0043f613 | int support_codec.cpp_CLZWDictionary_addNode_FUN_0043ef90(CLZWDictionary * this_ptr, int code, int parent_index)
        ;   XREF to: 0043ef90 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0043f618
    TEST EAX,EAX                        ; 0043f61b
    JZ 0x0043f626                       ; 0043f61d | LAB_0043f626
        ;   XREF to: 0043f626 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 0043f644
    CALL support_codec.cpp_CLZWDictionary_writeCodeToStream_FUN_0043f0d0 ; 0043f645 | int support_codec.cpp_CLZWDictionary_writeCodeToStream_FUN_0043f0d0(CLZWDictionary * this_ptr, SBitBuffer * bit_buffer, byte * output_stream, int * bytes_remaining, ...)
        ;   XREF to: 0043f0d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0043f64a
    MOV dword ptr [EBX + 0x2c],EAX      ; 0043f64d
    TEST EAX,EAX                        ; 0043f650
    JGE 0x0043f5f4                      ; 0043f652 | LAB_0043f5f4
    ...
    JNZ 0x0043f675                      ; 0043f666 | LAB_0043f675
    ...
    JNZ 0x0043f668                      ; 0043f686 | LAB_0043f668
