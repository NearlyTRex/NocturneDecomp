...
section .text
    ...
    PUSH EDX                            ; 005e1709
    PUSH EBX                            ; 005e170a
    CALL support_trisock.cpp_parseIPComponents_FUN_005e1800 ; 005e170b
        ;   XREF to: 005e1800 (UNCONDITIONAL_CALL)  ; int support_trisock.cpp_parseIPComponents_FUN_005e1800(uint * result_ptr, char * dotted_decimal_string)
    ADD ESP,0x8                         ; 005e1710
    TEST EAX,EAX                        ; 005e1713
    JZ 0x005e171b                       ; 005e1715
        ;   XREF to: 005e171b (CONDITIONAL_JUMP)  ; LAB_005e171b
    ...
    PUSH EDI                            ; 005e1721
    MOV ECX,0x65646a                    ; 005e1722 | = "..\\support\\trisock.cpp"
    MOV ESI,0x36                        ; 005e1727
    PUSH 0x656481                       ; 005e172c | = "Invalid dotted decimal string: %s"
    MOV dword ptr [0x02f0ca48],ECX      ; 005e1731 | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 005e1737 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005e173d
