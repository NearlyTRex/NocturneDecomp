...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl support_trisock_cpp_bindAndInvalidateSocket_FUN_005e1d20(SSocketContext *socket_ctx)
;
; Parameters:
...
;   core_netgame.cpp_initializeNetwork_FUN_0053fbc0 at 0053fbe2
