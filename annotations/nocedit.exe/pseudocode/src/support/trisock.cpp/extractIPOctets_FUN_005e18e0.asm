...
section .text
    ...
    JNZ 0x005e1918                      ; 005e18ef | LAB_005e1918
        ;   XREF to: 005e1918 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x10],0x0      ; 005e18f1
        ;   Label: LAB_005e18f1
    JZ 0x005e1903                       ; 005e18f6 | LAB_005e1903
    ...
    TEST ECX,ECX                        ; 005e1903
        ;   Label: LAB_005e1903
    JZ 0x005e190e                       ; 005e1905 | LAB_005e190e
    ...
    JNZ 0x005e1920                      ; 005e1914 | LAB_005e1920
    ...
    JMP 0x005e18f1                      ; 005e191e | LAB_005e18f1
