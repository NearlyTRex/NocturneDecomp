...
;                               FUNCTION
; *****************************************************************************
; __cdecl SOCKADDR_IN * __cdecl support_trisock_cpp_convertSockAddr_FUN_005e1960(SOCKADDR_IN *dest_addr,SOCKADDR *src_addr)
;
; Parameters:
...
section .text
    ...
    JNZ 0x005e19a0                      ; 005e1971
        ;   XREF to: 005e19a0 (CONDITIONAL_JUMP)  ; LAB_005e19a0
    XOR EAX,EAX                         ; 005e1973
        ;   Label: LAB_005e1973
    MOV AX,word ptr [ESI + 0x2]         ; 005e1975
    PUSH EAX                            ; 005e1979
    CALL crt_wsock32.c_ntohs            ; 005e197a
        ;   XREF to: 00610f34 (UNCONDITIONAL_CALL)  ; ushort crt_wsock32.c_ntohs(ushort netshort)
    MOV word ptr [EBX + 0x4],AX         ; 005e197f
    LEA EAX,[ESI + 0x4]                 ; 005e1983
    PUSH EAX                            ; 005e1986
    LEA EAX,[ESP + 0x4]                 ; 005e1987
    PUSH EAX                            ; 005e198b
    CALL support_trisock.cpp_copyIPAddress_FUN_005e16f0 ; 005e198c
        ;   XREF to: 005e16f0 (UNCONDITIONAL_CALL)  ; uint * support_trisock.cpp_copyIPAddress_FUN_005e16f0(uint * dest_ip, uint * src_ip)
    ...
    POP EBX                             ; 005e199e
    RET                                 ; 005e199f
    MOV EDX,0x6564f4                    ; 005e19a0 | = "..\\support\\trisock.cpp"
        ;   Label: LAB_005e19a0
    MOV ECX,0xa5                        ; 005e19a5
    PUSH 0x65650b                       ; 005e19aa | = "sockaddr is not of AF_INET family!"
    MOV dword ptr [0x02f0ca48],EDX      ; 005e19af | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 005e19b5 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005e19bb
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ADD ESP,0x4                         ; 005e19c0
    JMP 0x005e1973                      ; 005e19c3
        ;   XREF to: 005e1973 (UNCONDITIONAL_JUMP)  ; LAB_005e1973
