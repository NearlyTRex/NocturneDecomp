...
;                               FUNCTION
; *****************************************************************************
; __cdecl int support_trisock.cpp_performSocketOperation_FUN_005e1ca0(SSocketContext * socket_ctx, char * buffer, int length, SNetworkAddr * dest_addr)
;
; Parameters:
...
section .text
    ...
    JNZ 0x005e1cd5                      ; 005e1cac | LAB_005e1cd5
    ...
    PUSH EBX                            ; 005e1cc0
    CALL crt_wsock32.c_send             ; 005e1cc1 | int crt_wsock32.c_send(SOCKET s, char * buf, int len, int flags)
    ...
    CALL support_trisock.cpp_buildSockaddrIn_FUN_005e19d0 ; 005e1cde | SOCKADDR_IN * support_trisock.cpp_buildSockaddrIn_FUN_005e19d0(SNetworkAddr * net_addr, SOCKADDR_IN * dest_buffer)
    ...
    PUSH EBP                            ; 005e1d07
    CALL crt_wsock32.c_sendto           ; 005e1d08 | int crt_wsock32.c_sendto(SOCKET s, char * buf, int len, int flags, ...)
