...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl support_trisock_cpp_createSocket_FUN_005e1b10(SSocketContext *socket_ctx)
;
; Parameters:
...
section .text
    ...
    CALL crt_wsock32.c_shutdown         ; 005e1b24
        ;   XREF to: 00610f28 (UNCONDITIONAL_CALL)  ; int crt_wsock32.c_shutdown(SOCKET s, int how)
