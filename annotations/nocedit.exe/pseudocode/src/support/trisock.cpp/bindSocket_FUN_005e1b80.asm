...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl support_trisock_cpp_bindSocket_FUN_005e1b80(uint16_t port,SOCKET *socket_handle)
;
; Parameters:
...
;
; XREF[1]:
;   core_netgame.cpp_initializeNetwork_FUN_0053fbc0 at 0053fc14
;
; Called Functions:
;   crt_wsock32.c_bind
;   crt_wsock32.c_htons
