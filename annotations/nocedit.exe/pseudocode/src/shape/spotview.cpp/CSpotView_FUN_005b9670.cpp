...

{
  ...
  pcVar1 = this_ptr->unk;
  this_ptr = *(CSpotView **)(this_ptr->unk + 0x2c);
  ...
  if (((uint)in_stack_00000008 & 2) != 0) {
    ...
    if (iVar2 != 0) {
      *(float *)(this_ptr_00->unk + 0x28) = *(float *)(this_ptr_00->unk + 0x28) + in_stack_00000008;
    }
    iVar2 = (*g_CKeysPtr->vtable->getKeyState)(g_CKeysPtr,0x53);
    if (iVar2 != 0) {
      *(float *)(this_ptr_00->unk + 0x28) = *(float *)(this_ptr_00->unk + 0x28) - in_stack_00000010;
    }
    iVar2 = (*g_CKeysPtr->vtable->getKeyState)(g_CKeysPtr,0x35);
    if (iVar2 != 0) {
      *(float *)(this_ptr_00->unk + 0x28) = *(float *)(this_ptr_00->unk + 0x28) + in_stack_00000018;
    }
    this_ptr = (CSpotView *)0x37;
    fVar3 = 8.411417e-39;
    iVar2 = (*g_CKeysPtr->vtable->getKeyState)(g_CKeysPtr,0x37);
    if (iVar2 != 0) {
      *(float *)(this_ptr_00->unk + 0x28) = *(float *)(this_ptr_00->unk + 0x28) - in_stack_00000020;
    }
  }
  if (((uint)in_stack_00000008 & 1) != 0) {
    iVar2 = (*g_CKeysPtr->vtable->getKeyState)(g_CKeysPtr,0x4a);
    if (iVar2 != 0) {
      *(float *)(this_ptr_00->unk + 0x24) = *(float *)(this_ptr_00->unk + 0x24) + in_stack_00000008;
    }
    iVar2 = (*g_CKeysPtr->vtable->getKeyState)(g_CKeysPtr,0x4e);
    if (iVar2 != 0) {
      *(float *)(this_ptr_00->unk + 0x24) = *(float *)(this_ptr_00->unk + 0x24) - in_stack_00000010;
    }
  }
  if (((uint)in_stack_00000008 & 8) != 0) {
    iVar2 = (*g_CKeysPtr->vtable->getKeyState)(g_CKeysPtr,0x4b);
    if (iVar2 != 0) {
      *(float *)(this_ptr_00->unk + 0x30) = *(float *)(this_ptr_00->unk + 0x30) - in_stack_0000000c;
    }
    iVar2 = (*g_CKeysPtr->vtable->getKeyState)(g_CKeysPtr,0x4d);
    if (iVar2 != 0) {
      *(float *)(this_ptr_00->unk + 0x30) = *(float *)(this_ptr_00->unk + 0x30) + in_stack_00000014;
    }
    iVar2 = (*g_CKeysPtr->vtable->getKeyState)(g_CKeysPtr,0x10);
    if (iVar2 != 0) {
      *(float *)(this_ptr_00->unk + 0x34) = *(float *)(this_ptr_00->unk + 0x34) + in_stack_0000001c;
    }
    this_ptr = (CSpotView *)0x1e;
    fVar3 = 8.411684e-39;
    iVar2 = (*g_CKeysPtr->vtable->getKeyState)(g_CKeysPtr,0x1e);
    if (iVar2 != 0) {
      *(float *)(this_ptr_00->unk + 0x34) = *(float *)(this_ptr_00->unk + 0x34) - in_stack_00000024;
    }
  }
  if (((uint)in_stack_00000008 & 4) != 0) {
    iVar2 = (*g_CKeysPtr->vtable->getKeyState)(g_CKeysPtr,0x48);
    if (iVar2 != 0) {
      *(float *)(this_ptr_00->unk + 0x2c) = *(float *)(this_ptr_00->unk + 0x2c) - fVar3;
    }
    iVar2 = (*g_CKeysPtr->vtable->getKeyState)(g_CKeysPtr,0x50);
    if (iVar2 != 0) {
      *(float *)(this_ptr_00->unk + 0x2c) = *(float *)(this_ptr_00->unk + 0x2c) + (float)this_ptr;
    }
  }
  if (((uint)in_stack_00000008 & 0x10) != 0) {
    iVar2 = (*g_CKeysPtr->vtable->getAndClearKeyState)(g_CKeysPtr,0xd);
    if (iVar2 != 0) {
      *(float *)(this_ptr_00->unk + 0x38) = *(float *)(this_ptr_00->unk + 0x38) / (float)this_ptr;
    }
    iVar2 = (*g_CKeysPtr->vtable->getAndClearKeyState)(g_CKeysPtr,0xc);
    if (iVar2 != 0) {
      *(float *)(this_ptr_00->unk + 0x38) = *(float *)(this_ptr_00->unk + 0x38) * in_stack_0000000c;
    }
  }
