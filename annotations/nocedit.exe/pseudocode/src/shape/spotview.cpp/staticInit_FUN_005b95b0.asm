...
section .text
    ...
    PUSH 0x3f6b9e0                      ; 005b95b0 | CSpotView g_CSpotViewInstance
        ;   Label: shape_spotview.cpp_staticInit_FUN_005b95b0
    CALL shape_spotview.cpp_CSpotView_ctor_FUN_005b95c0 ; 005b95b5 | CSpotView * shape_spotview.cpp_CSpotView_ctor_FUN_005b95c0(CSpotView * this_ptr)
