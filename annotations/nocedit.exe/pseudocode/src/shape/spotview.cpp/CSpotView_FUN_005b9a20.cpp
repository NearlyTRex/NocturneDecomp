...

{
  ...
  local_20.x = *(float *)(this_ptr->field0_0x0 + 0x30);
  local_20.y = *(float *)(this_ptr->field0_0x0 + 0x34);
  local_20.z = -*(float *)(this_ptr->field0_0x0 + 0x2c);
  local_14 = local_20.z;
  local_10 = local_20.x;
  local_c = local_20.y;
  pCVar1 = core_dirmat_cpp_CMatrix3x3f_transformVector_FUN_00471fd0(&local_6c,&local_2c,&local_20);
  local_44.x = (int)(*(float *)(this_ptr->field0_0x0 + 0x18) + pCVar1->x);
