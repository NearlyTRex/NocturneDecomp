...
section .text
    ...
    CALL crt_stack.c_stack_probe_FUN_005ff9f3 ; 00447595
    ...
    CMP dword ptr [0x0084a898],0x0      ; 004475a1 | g_CramFillGaps
    JZ 0x00447850                       ; 004475a8
        ;   XREF to: 00447850 (CONDITIONAL_JUMP)  ; LAB_00447850
    MOV ECX,dword ptr [0x0084a854]      ; 004475ae | g_CramTextureCount
        ;   Label: LAB_004475ae
    ...
    JLE 0x0044761f                      ; 00447616
        ;   XREF to: 0044761f (CONDITIONAL_JUMP)  ; LAB_0044761f
    MOV EDI,0x1                         ; 00447618
    JMP 0x004475cc                      ; 0044761d
        ;   XREF to: 004475cc (UNCONDITIONAL_JUMP)  ; LAB_004475cc
    ...
    TEST EDI,EDI                        ; 00447635
        ;   Label: LAB_00447635
    JNZ 0x004475ae                      ; 00447637
        ;   XREF to: 004475ae (CONDITIONAL_JUMP)  ; LAB_004475ae
    MOV dword ptr [ESP + 0x8],EDI       ; 0044763d
    MOV ECX,dword ptr [0x0084a854]      ; 00447641 | g_CramTextureCount
        ;   Label: LAB_00447641
    ...
    TEST EBP,EBP                        ; 004476fb
        ;   Label: LAB_004476fb
    JNZ 0x00447889                      ; 004476fd
        ;   XREF to: 00447889 (CONDITIONAL_JUMP)  ; LAB_00447889
    XOR EAX,EAX                         ; 00447703
        ;   Label: LAB_00447703
    MOV dword ptr [ESP + 0xc],EAX       ; 00447705
    TEST byte ptr [ESP + 0xc],0x1       ; 00447709
        ;   Label: LAB_00447709
    JZ 0x004478a0                       ; 0044770e
        ;   XREF to: 004478a0 (CONDITIONAL_JUMP)  ; LAB_004478a0
    MOV EDI,0xffffffff                  ; 00447714
    MOV EAX,[0x0084a854]                ; 00447719 | g_CramTextureCount
    MOV EBP,EDI                         ; 0044771e
    DEC EAX                             ; 00447720
    MOV ESI,EAX                         ; 00447721
        ;   Label: LAB_00447721
    CMP EAX,EDI                         ; 00447723
    JZ 0x004477a0                       ; 00447725
        ;   XREF to: 004477a0 (CONDITIONAL_JUMP)  ; LAB_004477a0
    ...
    JL 0x00447709                       ; 004477ac
        ;   XREF to: 00447709 (CONDITIONAL_JUMP)  ; LAB_00447709
    MOV EDI,dword ptr [0x0084a854]      ; 004477b2 | g_CramTextureCount
    ...
    MOV EBP,dword ptr [0x0084a854]      ; 00447807 | g_CramTextureCount
    INC ESI                             ; 0044780d
    ADD EDI,0x4c                        ; 0044780e
    CMP ESI,EBP                         ; 00447811
    JL 0x004477c3                       ; 00447813
        ;   XREF to: 004477c3 (CONDITIONAL_JUMP)  ; LAB_004477c3
    MOV EAX,[0x0084a854]                ; 00447815 | g_CramTextureCount
        ;   Label: LAB_00447815
    ...
    JL 0x00447641                       ; 00447895
        ;   XREF to: 00447641 (CONDITIONAL_JUMP)  ; LAB_00447641
    JMP 0x00447703                      ; 0044789b
        ;   XREF to: 00447703 (UNCONDITIONAL_JUMP)  ; LAB_00447703
    MOV EBP,0x1                         ; 004478a0
        ;   Label: LAB_004478a0
    MOV EDI,dword ptr [0x0084a854]      ; 004478a5 | g_CramTextureCount
    XOR EAX,EAX                         ; 004478ab
    JMP 0x00447721                      ; 004478ad
        ;   XREF to: 00447721 (UNCONDITIONAL_JUMP)  ; LAB_00447721
