...
;                               FUNCTION
; *****************************************************************************
; __cdecl int shape_cramtex.cpp_findLeftmostOverlappingX_FUN_00447a10(SCramWorkingEntry * bounds_entry)
;
; Parameters:
...
section .text
    ...
    CALL crt_stack.c_stack_probe_FUN_005ff9f3 ; 00447a15 | uint crt_stack.c_stack_probe_FUN_005ff9f3(uint stack_size)
        ;   XREF to: 005ff9f3 (UNCONDITIONAL_CALL)
    PUSH EBX                            ; 00447a1a
    PUSH ESI                            ; 00447a1b
    PUSH EDI                            ; 00447a1c
    PUSH EBP                            ; 00447a1d
    MOV EDI,dword ptr [0x0084a854]      ; 00447a1e | uint g_CramTextureCount
    MOV EDX,dword ptr [ESP + 0x14]      ; 00447a24
    MOV EBX,dword ptr [0x0084a884]      ; 00447a28 | int g_CramCurrentAcceptableSize
    XOR ECX,ECX                         ; 00447a2e
    TEST EDI,EDI                        ; 00447a30
    JLE 0x00447a68                      ; 00447a32 | LAB_00447a68
        ;   XREF to: 00447a68 (CONDITIONAL_JUMP)
    MOV EAX,0x83c1dc                    ; 00447a34 | SCramWorkingEntry[1] g_CramSortedTextureEntries
    ...
    JL 0x00447a39                       ; 00447a66 | LAB_00447a39
        ;   XREF to: 00447a39 (CONDITIONAL_JUMP)
    MOV EAX,EBX                         ; 00447a68
        ;   Label: LAB_00447a68
    MOV dword ptr [0x0084a854],EDI      ; 00447a6a | uint g_CramTextureCount
    POP EBP                             ; 00447a70
    POP EDI                             ; 00447a71
    POP ESI                             ; 00447a72
    POP EBX                             ; 00447a73
