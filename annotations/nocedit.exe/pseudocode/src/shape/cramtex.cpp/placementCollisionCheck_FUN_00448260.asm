...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_cramtex.cpp_placementCollisionCheck_FUN_00448260(int layer_id, int start_x, int start_y, int width, int height)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [0x0084a860]      ; 0044826f | int g_CramRectangleCount
    TEST EDX,EDX                        ; 00448275
    JLE 0x004482ac                      ; 00448277 | LAB_004482ac
    ...
    CMP EDI,dword ptr [EAX + 0x840c14]  ; 00448289 | SCramRectangle[50] g_CramRectangles
        ;   Label: LAB_00448289
    JNZ 0x004482a5                      ; 0044828f | LAB_004482a5
        ;   XREF to: 004482a5 (CONDITIONAL_JUMP)
    CMP EBX,dword ptr [EAX + 0x840c18]  ; 00448291 | DAT_00840c18
    JNZ 0x004482a5                      ; 00448297 | LAB_004482a5
        ;   XREF to: 004482a5 (CONDITIONAL_JUMP)
    CMP ECX,dword ptr [EAX + 0x840c1c]  ; 00448299 | DAT_00840c1c
    JZ 0x00448322                       ; 0044829f | LAB_00448322
        ;   XREF to: 00448322 (CONDITIONAL_JUMP)
    ADD EAX,0x28                        ; 004482a5
        ;   Label: LAB_004482a5
    CMP EAX,EDX                         ; 004482a8
    JL 0x00448289                       ; 004482aa | LAB_00448289
        ;   XREF to: 00448289 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x0084a860]      ; 004482ac | int g_CramRectangleCount
        ;   Label: LAB_004482ac
    LEA EAX,[EDX*0x4 + 0x0]             ; 004482b2
    ADD EAX,EDX                         ; 004482b9
    SHL EAX,0x3                         ; 004482bb
    XOR ESI,ESI                         ; 004482be
    ADD EAX,0x840c14                    ; 004482c0 | SCramRectangle[50] g_CramRectangles
    MOV dword ptr [ESP],ESI             ; 004482c5
    MOV dword ptr [ESP + 0x4],EAX       ; 004482c8
    CMP dword ptr [ESP],0x0             ; 004482cc
        ;   Label: LAB_004482cc
    JZ 0x0044832a                       ; 004482d0 | LAB_0044832a
        ;   XREF to: 0044832a (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [0x0084a868]      ; 004482d2 | int g_CramMinPlacementX
    MOV EDI,dword ptr [0x0084a86c]      ; 004482d8 | int g_CramMinPlacementY
    ADD ESI,ECX                         ; 004482de
        ;   Label: LAB_004482de
    ADD EDI,EBX                         ; 004482e0
    MOV EDX,dword ptr [0x0084a85c]      ; 004482e2 | int g_CramPlacedTextureCount
    DEC EDX                             ; 004482e8
    TEST EDX,EDX                        ; 004482e9
    JL 0x00448312                       ; 004482eb | LAB_00448312
        ;   XREF to: 00448312 (CONDITIONAL_JUMP)
    IMUL EAX,EDX,0x4c                   ; 004482ed
    ADD EAX,0x83c1dc                    ; 004482f0 | SCramWorkingEntry[1] g_CramSortedTextureEntries
    MOV EBP,dword ptr [EAX + 0x10]      ; 004482f5 | g_CramSortedTextureEntries[0].assigned_map_number
        ;   Label: LAB_004482f5
    CMP EBP,dword ptr [ESP + 0x1c]      ; 004482f8
    JNZ 0x00448338                      ; 004482fc | LAB_00448338
        ;   XREF to: 00448338 (CONDITIONAL_JUMP)
    CMP EBX,dword ptr [EAX + 0x24]      ; 004482fe | g_CramSortedTextureEntries[0].working_top
    JGE 0x00448338                      ; 00448301 | LAB_00448338
        ;   XREF to: 00448338 (CONDITIONAL_JUMP)
    CMP ECX,dword ptr [EAX + 0x28]      ; 00448303 | g_CramSortedTextureEntries[0].working_width
    JGE 0x00448338                      ; 00448306 | LAB_00448338
        ;   XREF to: 00448338 (CONDITIONAL_JUMP)
    CMP EDI,dword ptr [EAX + 0x1c]      ; 00448308 | g_CramSortedTextureEntries[0].placement_bottom
    JLE 0x00448338                      ; 0044830b | LAB_00448338
        ;   XREF to: 00448338 (CONDITIONAL_JUMP)
    CMP ESI,dword ptr [EAX + 0x20]      ; 0044830d | g_CramSortedTextureEntries[0].working_right
    JLE 0x00448338                      ; 00448310 | LAB_00448338
        ;   XREF to: 00448338 (CONDITIONAL_JUMP)
    TEST EDX,EDX                        ; 00448312
        ;   Label: LAB_00448312
    JL 0x00448342                       ; 00448314 | LAB_00448342
    ...
    JLE 0x004482cc                      ; 00448320 | LAB_004482cc
    ...
    POP EBX                             ; 00448328
    RET                                 ; 00448329
    MOV ESI,dword ptr [0x0084a86c]      ; 0044832a | int g_CramMinPlacementY
        ;   Label: LAB_0044832a
    MOV EDI,dword ptr [0x0084a868]      ; 00448330 | int g_CramMinPlacementX
    JMP 0x004482de                      ; 00448336 | LAB_004482de
        ;   XREF to: 004482de (UNCONDITIONAL_JUMP)
    DEC EDX                             ; 00448338
        ;   Label: LAB_00448338
    SUB EAX,0x4c                        ; 00448339
    TEST EDX,EDX                        ; 0044833c
    JGE 0x004482f5                      ; 0044833e | LAB_004482f5
        ;   XREF to: 004482f5 (CONDITIONAL_JUMP)
    JMP 0x00448312                      ; 00448340 | LAB_00448312
    ...
    MOV dword ptr [EDX],EAX             ; 00448358 | SCramRectangle[50] g_CramRectangles
    ...
    MOV EDX,dword ptr [0x0084a860]      ; 0044836f | int g_CramRectangleCount
    INC EDX                             ; 00448375
    MOV dword ptr [ESP + 0x4],EAX       ; 00448376
    MOV dword ptr [0x0084a860],EDX      ; 0044837a | int g_CramRectangleCount
    JMP 0x00448316                      ; 00448380 | LAB_00448316
