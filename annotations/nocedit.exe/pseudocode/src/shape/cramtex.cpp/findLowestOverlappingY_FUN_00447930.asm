...
;                               FUNCTION
; *****************************************************************************
; __cdecl int shape_cramtex.cpp_findLowestOverlappingY_FUN_00447930(SCramWorkingEntry * bounds_entry)
;
; Parameters:
...
;   shape_cramtex.cpp_runInteractiveAtlasGeneration_FUN_00446160 at 0044667c
;
; Referenced Globals:
...
section .text
    ...
    CALL crt_stack.c_stack_probe_FUN_005ff9f3 ; 00447935 | uint crt_stack.c_stack_probe_FUN_005ff9f3(uint stack_size)
        ;   XREF to: 005ff9f3 (UNCONDITIONAL_CALL)
    PUSH EBX                            ; 0044793a
    PUSH ESI                            ; 0044793b
    PUSH EDI                            ; 0044793c
    PUSH EBP                            ; 0044793d
    MOV EDI,dword ptr [0x0084a854]      ; 0044793e | uint g_CramTextureCount
    MOV EDX,dword ptr [ESP + 0x14]      ; 00447944
    MOV EBX,dword ptr [0x0084a884]      ; 00447948 | int g_CramCurrentAcceptableSize
    XOR ECX,ECX                         ; 0044794e
    TEST EDI,EDI                        ; 00447950
    JLE 0x00447988                      ; 00447952 | LAB_00447988
        ;   XREF to: 00447988 (CONDITIONAL_JUMP)
    MOV EAX,0x83c1dc                    ; 00447954 | SCramWorkingEntry[1] g_CramSortedTextureEntries
    ...
    JL 0x00447959                       ; 00447986 | LAB_00447959
        ;   XREF to: 00447959 (CONDITIONAL_JUMP)
    MOV EAX,EBX                         ; 00447988
        ;   Label: LAB_00447988
    MOV dword ptr [0x0084a854],EDI      ; 0044798a | uint g_CramTextureCount
    POP EBP                             ; 00447990
    POP EDI                             ; 00447991
    POP ESI                             ; 00447992
    POP EBX                             ; 00447993
