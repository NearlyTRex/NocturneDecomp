...
section .text
    ...
    CALL crt_stack.c_stack_probe_FUN_005ff9f3 ; 00447c25 | uint crt_stack.c_stack_probe_FUN_005ff9f3(uint stack_size)
    ...
    JZ 0x00447e4f                       ; 00447c3e | LAB_00447e4f
        ;   XREF to: 00447e4f (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [0x0084a890]      ; 00447c44 | int g_CramMapNumber
    CMP ESI,dword ptr [EBX + 0x2c]      ; 00447c4a
    JNZ 0x00447e47                      ; 00447c4d | LAB_00447e47
    ...
    MOV ECX,dword ptr [0x0084a884]      ; 00447c75 | int g_CramCurrentAcceptableSize
    ...
    IDIV dword ptr [0x0084a884]         ; 00447c99 | int g_CramCurrentAcceptableSize
    ...
    IDIV dword ptr [0x0084a884]         ; 00447cb8 | int g_CramCurrentAcceptableSize
    ...
    IDIV dword ptr [0x0084a884]         ; 00447cd5 | int g_CramCurrentAcceptableSize
    ...
    PUSH EAX                            ; 00447cf0
    PUSH ECX                            ; 00447cf1
    CALL engine_2d.c_fillRectColor_FUN_00403170 ; 00447cf2 | void engine_2d.c_fillRectColor_FUN_00403170(int x1, int y1, int x2, int y2, ...)
        ;   XREF to: 00403170 (UNCONDITIONAL_CALL)
    MOV EAX,[0x0084a880]                ; 00447cf7 | int g_CramPaddingCalculation
    ...
    MOV EDI,dword ptr [0x0084a884]      ; 00447d22 | int g_CramCurrentAcceptableSize
    ...
    MOV ESI,dword ptr [0x0084a884]      ; 00447d3d | int g_CramCurrentAcceptableSize
    ...
    IDIV dword ptr [0x0084a884]         ; 00447d61 | int g_CramCurrentAcceptableSize
    ...
    IDIV dword ptr [0x0084a884]         ; 00447d7e | int g_CramCurrentAcceptableSize
    ...
    CALL engine_2d.c_fillRectColor_FUN_00403170 ; 00447d98 | void engine_2d.c_fillRectColor_FUN_00403170(int x1, int y1, int x2, int y2, ...)
        ;   XREF to: 00403170 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 00447d9d
    CMP dword ptr [ESP + 0x38],0x0      ; 00447da0
    JZ 0x00447e47                       ; 00447da5 | LAB_00447e47
        ;   XREF to: 00447e47 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x44],0x0      ; 00447dab
    JZ 0x00447e6f                       ; 00447daf | LAB_00447e6f
        ;   XREF to: 00447e6f (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0x4]       ; 00447db5
    MOV EDX,dword ptr [EBX + 0x30]      ; 00447db8
        ;   Label: LAB_00447db8
    MOV ECX,dword ptr [0x0084a880]      ; 00447dbb | int g_CramPaddingCalculation
    ADD EAX,EDX                         ; 00447dc1
    ADD ECX,EAX                         ; 00447dc3
    MOV EAX,[0x0084a880]                ; 00447dc5 | int g_CramPaddingCalculation
    ...
    JZ 0x00447e76                       ; 00447ddd | LAB_00447e76
        ;   XREF to: 00447e76 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX]             ; 00447de3
    MOV EDX,dword ptr [EBX + 0x34]      ; 00447de5
        ;   Label: LAB_00447de5
    MOV ECX,dword ptr [0x0084a880]      ; 00447de8 | int g_CramPaddingCalculation
    ADD EAX,EDX                         ; 00447dee
    ADD ECX,EAX                         ; 00447df0
    MOV EAX,[0x0084a880]                ; 00447df2 | int g_CramPaddingCalculation
    ...
    MOV EBX,dword ptr [0x0084a884]      ; 00447e0f | int g_CramCurrentAcceptableSize
    ...
    PUSH ESI                            ; 00447e3d
    PUSH EDI                            ; 00447e3e
    CALL engine_2d.c_fillRectColor_FUN_00403170 ; 00447e3f | void engine_2d.c_fillRectColor_FUN_00403170(int x1, int y1, int x2, int y2, ...)
        ;   XREF to: 00403170 (UNCONDITIONAL_CALL)
    ...
    POP EBX                             ; 00447e4d
    RET                                 ; 00447e4e
    MOV ECX,dword ptr [0x0084a890]      ; 00447e4f | int g_CramMapNumber
        ;   Label: LAB_00447e4f
    CMP ECX,dword ptr [EBX + 0x10]      ; 00447e55
    JNZ 0x00447e47                      ; 00447e58 | LAB_00447e47
        ;   XREF to: 00447e47 (CONDITIONAL_JUMP)
