...
;                               FUNCTION
; *****************************************************************************
; __cdecl double shape_cramtex.cpp_calculateAtlasEfficiency_FUN_00447e80(void)
;
; Local Variables:
...
section .text
    ...
    CALL crt_stack.c_stack_probe_FUN_005ff9f3 ; 00447e85 | uint crt_stack.c_stack_probe_FUN_005ff9f3(uint stack_size)
    ...
    MOV EDX,dword ptr [0x0084a854]      ; 00447e96 | uint g_CramTextureCount
    XOR ECX,ECX                         ; 00447e9c
    XOR EBX,EBX                         ; 00447e9e
    TEST EDX,EDX                        ; 00447ea0
    JLE 0x00447ee0                      ; 00447ea2 | LAB_00447ee0
        ;   XREF to: 00447ee0 (CONDITIONAL_JUMP)
    MOV EAX,0x83c1dc                    ; 00447ea4 | SCramWorkingEntry[1] g_CramSortedTextureEntries
    ...
    MOV EDI,dword ptr [0x0084a880]      ; 00447eaf | int g_CramPaddingCalculation
    ...
    SUB EDX,dword ptr [0x0084a880]      ; 00447ebf | int g_CramPaddingCalculation
    IMUL EDX,ESI                        ; 00447ec5
    INC ECX                             ; 00447ec8
    ADD EBX,EDX                         ; 00447ec9
    MOV EDX,dword ptr [0x0084a854]      ; 00447ecb | uint g_CramTextureCount
    ADD EAX,0x4c                        ; 00447ed1
    CMP ECX,EDX                         ; 00447ed4
    JL 0x00447ea9                       ; 00447ed6 | LAB_00447ea9
        ;   XREF to: 00447ea9 (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 00447ed8 | undefined4 DAT_0083c228
    MOV EDX,EDX                         ; 00447ede
    MOV EAX,[0x0084a884]                ; 00447ee0 | int g_CramCurrentAcceptableSize
        ;   Label: LAB_00447ee0
    IMUL EAX,EAX                        ; 00447ee5
    MOV ESI,dword ptr [0x0084a858]      ; 00447ee8 | int g_CramTotalMaps
    ...
    FMUL double ptr [0x00619a2a]        ; 00447f01 | double g_CramPercentMultiplier
    FDIVRP                              ; 00447f07
