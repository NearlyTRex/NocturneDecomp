...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl shape_cramtex_cpp_addTextureEntry_FUN_00446100(SCramWorkingEntry *texture_entry)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 00446126
    CALL shape_cramtex.cpp_runInteractiveAtlasGeneration_FUN_00446160 ; 00446127
