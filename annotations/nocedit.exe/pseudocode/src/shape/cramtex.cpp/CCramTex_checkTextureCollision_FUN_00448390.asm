...
section .text
    ...
    PUSH EBX                            ; 00448390
        ;   Label: shape_cramtex.cpp_CCramTex_checkTextureCollision_FUN_00448390
    PUSH ESI                            ; 00448391
    PUSH EDI                            ; 00448392
    PUSH EBP                            ; 00448393
