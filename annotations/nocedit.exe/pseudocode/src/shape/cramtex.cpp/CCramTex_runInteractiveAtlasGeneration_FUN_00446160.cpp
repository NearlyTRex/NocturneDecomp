...
int __cdecl
shape_cramtex_cpp_CCramTex_runInteractiveAtlasGeneration_FUN_00446160(CCramTex *this_ptr)
...
LAB_00446547:
            ...
            if (iVar21 < iVar18) {
              ...
              if (-1 < iVar21) {
                pCVar10 = g_CramSortedTextureEntries + iVar21;
                do {
      ...
      if (0 < (int)local_a8) {
        do {
          ...
          *(int *)(iVar18 + 0x24) =
          ...
          piVar15 = piVar15 + 1;
        } while (iVar21 < (int)local_a8);
      }
      _qsort
                (pCVar19,local_a8,4,shape_cramtex_cpp_qsortRectanglesByActiveFlag_FUN_00446140);
    }
    iVar21 = 0;
    pCVar10 = pCVar19;
    if (0 < (int)local_a8) {
      do {
        iVar18 = iVar21 + 5;
        iVar21 = iVar21 + 1;
        *(int *)(pCVar10->width + 0x24) = iVar18;
        pCVar10 = (CCramTex *)&pCVar10->height;
      } while (iVar21 < (int)local_a8);
    }
          ...
          if ((*(int *)(in_stack_00000004 + 0x24) < g_CramBestSolutionMetric1) &&
            ...
            if (*(int *)(in_stack_00000004 + 0x28) <= g_CramBestSolutionMetric2) {
              ...
              if (-1 < iVar18) {
                ...
                do {
                  if (((pCVar10->assigned_map_number == *(int *)(in_stack_00000004 + 0x10)) &&
                      (pCVar10->working_top <= *(int *)(in_stack_00000004 + 0x24))) &&
                     ((*(int *)(in_stack_00000004 + 0x28) < pCVar10->working_width &&
              ...
              if (local_80 < *(int *)(in_stack_00000004 + 0x24)) {
                ...
                if (-1 < local_30) {
                  ...
                  do {
                    ...
                    if ((((iVar18 == local_50->assigned_map_number) &&
                         (local_50->working_top <= *(int *)(in_stack_00000004 + 0x24))) &&
                        (iVar22 = *(int *)(in_stack_00000004 + 0x28),
                        iVar22 < local_50->working_width)) && (local_80 < local_50->working_top)) {
                      ...
                      do {
                        ...
                        if (-1 < iVar16) {
                          ...
                          do {
                            if (((pCVar10->assigned_map_number == iVar18) &&
                               ...
                               ((iVar22 < pCVar10->working_width &&
                                ((pCVar10->placement_bottom < iVar14 + iVar12 &&
                                 (pCVar10->working_right < iVar17 + iVar22)))))) break;
                            iVar16 = iVar16 + -1;
                            pCVar10 = pCVar10 + -1;
                          } while (-1 < iVar16);
                        }
                        if (iVar16 < 0) {
                          ...
                          local_54->top = iVar12;
                          local_54->right = iVar22;
                          local_54->bottom = iVar14 + iVar12;
                          local_54->orientation = local_78;
                          local_54->max_dimension = iVar17 + iVar22;
...
LAB_00446d87:
                ...
                if (0 < g_CramRectangleCount) {
                  ...
                  do {
                    if (((iVar18 == *(int *)((int)&g_CramRectangles[0].left + iVar12)) &&
                        (local_80 == *(int *)((int)&g_CramRectangles[0].top + iVar12))) &&
                ...
                do {
                  ...
                  if (-1 < iVar17) {
                    ...
                    do {
                      if (((pCVar10->assigned_map_number == iVar18) &&
                          (local_80 < pCVar10->working_top)) &&
                         ((iVar22 < pCVar10->working_width &&
                          ((pCVar10->placement_bottom < iVar14 + local_80 &&
                           (pCVar10->working_right < iVar12 + iVar22)))))) break;
                      iVar17 = iVar17 + -1;
                      pCVar10 = pCVar10 + -1;
                    } while (-1 < iVar17);
                  }
                  if (iVar17 < 0) {
                    ...
                    local_4c->right = iVar22;
                    local_4c->max_dimension = iVar12 + iVar22;
                    local_4c->orientation = local_70;
                    local_4c->bottom = iVar14 + local_80;
                    g_CramRectangleCount = g_CramRectangleCount + 1;
                    local_4c = local_4c + 1;
                  }
                  local_70 = local_70 + 1;
...
LAB_00446df8:
            if (*(int *)(in_stack_00000004 + 0x28) <= g_CramBestSolutionMetric2) {
              ...
              if (-1 < iVar18) {
                ...
                do {
                  if ((((pCVar10->assigned_map_number == *(int *)(in_stack_00000004 + 0x10)) &&
                       (pCVar10->working_width <= *(int *)(in_stack_00000004 + 0x28))) &&
                      (*(int *)(in_stack_00000004 + 0x24) < pCVar10->working_top)) &&
              ...
              if (local_6c < *(int *)(in_stack_00000004 + 0x28)) {
                ...
                if (-1 < local_24) {
                  ...
                  do {
                    ...
                    if (((iVar18 == local_44->assigned_map_number) &&
                        (local_44->working_width <= *(int *)(in_stack_00000004 + 0x28))) &&
                       ((iVar22 = *(int *)(in_stack_00000004 + 0x24), iVar22 < local_44->working_top
                      ...
                      do {
                        ...
                        if (-1 < iVar16) {
                          ...
                          do {
                            if (((pCVar10->assigned_map_number == iVar18) &&
                                (iVar22 < pCVar10->working_top)) &&
                               ((iVar12 < pCVar10->working_width &&
                                ((pCVar10->placement_bottom < iVar14 + iVar22 &&
                        ...
                        if (iVar16 < 0) {
                          ...
                          local_48->top = iVar22;
                          local_48->right = iVar12;
                          local_48->bottom = iVar14 + iVar22;
                          local_48->orientation = local_64;
                          local_48->max_dimension = iVar17 + iVar12;
                          g_CramRectangleCount = g_CramRectangleCount + 1;
                          local_48 = local_48 + 1;
                        }
                        local_64 = local_64 + 1;
...
LAB_00446f25:
                ...
                if (0 < g_CramRectangleCount) {
                  ...
                  do {
                    if (((iVar18 == *(int *)((int)&g_CramRectangles[0].left + iVar12)) &&
                       ...
                       (local_6c == *(int *)((int)&g_CramRectangles[0].right + iVar12)))
                    goto LAB_00446f96;
                    iVar12 = iVar12 + 0x28;
                  } while (iVar12 < g_CramRectangleCount * 0x28);
                }
                ...
                do {
                  ...
                  if (iVar17 < 0) {
                    ...
                    local_40->max_dimension = iVar12 + local_6c;
                    local_40->orientation = local_5c;
                    local_40->bottom = iVar14 + iVar22;
                    g_CramRectangleCount = g_CramRectangleCount + 1;
                    local_40 = local_40 + 1;
                  }
                  local_5c = local_5c + 1;
...
LAB_00446f96:
            ...
            iVar18 = shape_cramtex_cpp_CCramTex_runInteractiveAtlasGeneration_FUN_00446160(pCVar19);
            if (0 < iVar18) {
              iVar18 = iVar18 + -1;
            }
...
LAB_00447500:
          ...
          local_88 = local_88 + 1;
          local_3c = (CCramTex *)&local_3c->height;
        } while (local_88 < (int)local_a8);
      }
    }
    else {
      puVar24 = (uint *)pCVar19->width;
      *(uint *)(in_stack_00000004 + 0x10) = *puVar24;
      *(uint *)(in_stack_00000004 + 0x40) = puVar24[5];
      *(uint *)(in_stack_00000004 + 0x1c) = puVar24[1];
      *(uint *)(in_stack_00000004 + 0x20) = puVar24[2];
      ...
      *(int *)(in_stack_00000004 + 0x28) =
      ...
      if (iVar18 < g_CramBestSolutionMetric1) {
        ...
        if (g_CramFillGaps != 0) {
          do {
            ...
            if (0 < (int)g_CramTextureCount) {
              ...
              do {
                while( true ) {
                  ...
                  if ((local_58->final_bottom < g_CramCurrentAcceptableSize) &&
                     (iVar18 = shape_cramtex_cpp_CCramTex_findLowestOverlappingY_FUN_00447930
                                         (pCVar19), g_CramCurrentAcceptableSize <= iVar18)) {
                    iVar21 = iVar18 - local_58->final_bottom;
                    local_58->final_bottom = local_58->final_bottom + iVar21;
                    local_58->final_top = local_58->final_top + iVar21;
                  }
                  if ((local_58->final_right < g_CramCurrentAcceptableSize) &&
                     (iVar18 = shape_cramtex_cpp_CCramTex_findLeftmostOverlappingX_FUN_00447a10
                                         (pCVar19), g_CramCurrentAcceptableSize <= iVar18)) {
                    iVar21 = iVar18 - local_58->final_right;
                    local_58->final_left = local_58->final_left + iVar21;
                    local_58->final_right = local_58->final_right + iVar21;
                  }
                  if (iVar21 < 1) break;
                  bVar23 = true;
                }
                local_58 = local_58 + 1;
                local_9c = local_9c + 1;
              } while (local_9c < (int)g_CramTextureCount);
            }
          } while (bVar23);
          local_98 = 0;
          do {
            ...
            if (0 < (int)g_CramTextureCount) {
              pCVar10 = g_CramSortedTextureEntries;
              do {
                iVar22 = shape_cramtex_cpp_CCramTex_findRightmostOverlappingX_FUN_004479a0(pCVar19);
                iVar18 = pCVar10->final_left;
                iVar12 = shape_cramtex_cpp_CCramTex_findLeftmostOverlappingX_FUN_00447a10(pCVar19);
                iVar18 = ((iVar22 - iVar18) + (iVar12 - pCVar10->final_right)) / 2;
                if (iVar18 != 0) {
                  bVar23 = true;
                  pCVar10->final_left = pCVar10->final_left + iVar18;
                  pCVar10->final_right = pCVar10->final_right + iVar18;
                }
                iVar22 = shape_cramtex_cpp_CCramTex_findHighestOverlappingY_FUN_004478c0(pCVar19);
                iVar18 = pCVar10->final_top;
                iVar12 = shape_cramtex_cpp_CCramTex_findLowestOverlappingY_FUN_00447930(pCVar19);
                iVar18 = ((iVar22 - iVar18) + (iVar12 - pCVar10->final_bottom)) / 2;
                if (iVar18 != 0) {
                  bVar23 = true;
          ...
          } while ((bVar23) && (local_98 = local_98 + 1, local_98 < 10));
          local_38 = 0;
          do {
            if ((local_38 & 1) == 0) {
              uVar13 = 0;
            ...
            for (; uVar13 != uVar25; uVar13 = uVar13 + local_8c) {
              iVar21 = shape_cramtex_cpp_CCramTex_findRightmostOverlappingX_FUN_004479a0(pCVar19);
              g_CramSortedTextureEntries[uVar13].final_left =
                   (g_CramSortedTextureEntries[uVar13].final_left + iVar21) / 2;
              iVar21 = shape_cramtex_cpp_CCramTex_findHighestOverlappingY_FUN_004478c0(pCVar19);
              g_CramSortedTextureEntries[uVar13].final_top =
                   (g_CramSortedTextureEntries[uVar13].final_top + iVar21) / 2;
              iVar21 = shape_cramtex_cpp_CCramTex_findLeftmostOverlappingX_FUN_00447a10(pCVar19);
              g_CramSortedTextureEntries[uVar13].final_right =
                   (iVar21 + g_CramSortedTextureEntries[uVar13].final_right + 1) / 2;
              iVar21 = shape_cramtex_cpp_CCramTex_findLowestOverlappingY_FUN_00447930(pCVar19);
          ...
          if (0 < (int)g_CramTextureCount) {
            ...
            do {
              do {
                iVar18 = shape_cramtex_cpp_CCramTex_findHighestOverlappingY_FUN_004478c0(pCVar19);
                iVar18 = pCVar10->final_top - iVar18;
                pCVar10->final_bottom = pCVar10->final_bottom - iVar18;
                pCVar10->final_top = pCVar10->final_top - iVar18;
                iVar18 = shape_cramtex_cpp_CCramTex_findRightmostOverlappingX_FUN_004479a0(pCVar19);
          ...
          if (0 < (int)g_CramTextureCount) {
            pCVar10 = g_CramSortedTextureEntries;
            do {
              iVar18 = shape_cramtex_cpp_CCramTex_findLeftmostOverlappingX_FUN_00447a10(pCVar19);
              iVar21 = iVar21 + 1;
              pCVar10->final_right = iVar18;
              iVar18 = shape_cramtex_cpp_CCramTex_findLowestOverlappingY_FUN_00447930(pCVar19);
              uVar13 = g_CramTextureCount;
              pCVar10->final_bottom = iVar18;
              pCVar10 = pCVar10 + 1;
...
joined_r0x00446b0b:
        ...
        if (p_Var11 != (_FILE *)0x0) {
          ...
          if (0 < (int)g_CramTextureCount) {
            pCVar19 = g_CramSortedTextureEntries;
            iVar21 = 0;
            do {
              piVar15 = &pCVar19->rotation_applied;
              piVar1 = &pCVar19->final_bottom;
              piVar2 = &pCVar19->final_right;
              piVar3 = &pCVar19->final_top;
              piVar4 = &pCVar19->final_left;
              piVar5 = &pCVar19->working_map_id;
              piVar6 = &pCVar19->height;
              piVar7 = &pCVar19->width;
              pCVar19 = pCVar19 + 1;
              iVar18 = iVar21 + 1;
          ...
          if (0 < (int)g_CramTextureCount) {
            ...
            do {
              piVar15 = &pCVar19->rotation_applied;
              piVar1 = &pCVar19->working_width;
              piVar2 = &pCVar19->working_top;
              piVar3 = &pCVar19->working_right;
              piVar4 = &pCVar19->placement_bottom;
              piVar5 = &pCVar19->assigned_map_number;
              piVar6 = &pCVar19->height;
              piVar7 = &pCVar19->width;
              pCVar19 = pCVar19 + 1;
              iVar18 = iVar21 + 1;
