...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl shape_cramtex_cpp_renderAllTexturesAndRectangles_FUN_00447ab0 (int x,int y,int width,int height,int render_mode)
;
; Parameters:
; int              Stack[0x8]:4   x
; int              Stack[0xc]:4   y
...
section .text
    ...
    INC EBX                             ; 00447b26
    CALL shape_cramtex.cpp_renderTextureEntry_FUN_00447c20 ; 00447b27
