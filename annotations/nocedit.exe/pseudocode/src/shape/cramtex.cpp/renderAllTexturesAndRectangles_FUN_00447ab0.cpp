...
// Convention: __cdecl
// Signature: void __cdecl shape_cramtex_cpp_renderAllTexturesAndRectangles_FUN_00447ab0 (int x,int y,int width,int height,int render_mode)
    ...
    if (0 < (int)uVar1) {
      do {
        ...
        shape_cramtex_cpp_renderTextureEntry_FUN_00447c20
                  (in_stack_00000004,x,y,width,height,in_stack_ffffffe8);
      } while (iVar3 < (int)uVar1);
    }
    if ((in_stack_00000004 == (SCramWorkingEntry *)0x0) && (iVar3 = 0, 0 < g_CramRectangleCount)) {
      iVar2 = width - x;
