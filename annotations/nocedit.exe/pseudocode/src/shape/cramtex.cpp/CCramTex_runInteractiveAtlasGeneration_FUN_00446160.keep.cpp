                  ...
                  do {
                    ...
                    if ((((iVar32 == local_50->assigned_map_number) &&
                      ...
                      if (0 < g_CramRectangleCount) {
                        iVar13 = 0;
                        do {
                          if (((iVar32 == g_CramRectangles[iVar13].map_id) &&
                              (iVar23 == g_CramRectangles[iVar13].start_x)) &&
                             (iVar22 == g_CramRectangles[iVar13].start_y))
                          goto LAB_00446d87;
                          iVar13 = iVar13 + 1;
                        } while (iVar13 < g_CramRectangleCount);
                      }
                      local_78 = 0;
...
LAB_00446d87:
                ...
                if (0 < g_CramRectangleCount) {
                  iVar23 = 0;
                  do {
                    if (((iVar32 == g_CramRectangles[iVar23].map_id) &&
                        (local_80 == g_CramRectangles[iVar23].start_x)) &&
                       (iVar22 == g_CramRectangles[iVar23].start_y))
                    goto LAB_00446df8;
                    iVar23 = iVar23 + 1;
                  } while (iVar23 < g_CramRectangleCount);
                }
                  ...
                  do {
                    ...
                    if (((iVar32 == local_44->assigned_map_number) &&
                      ...
                      if (0 < g_CramRectangleCount) {
                        iVar25 = 0;
                        do {
                          if (((iVar32 == g_CramRectangles[iVar25].map_id) &&
                              (iVar22 == g_CramRectangles[iVar25].start_x)) &&
                             (iVar23 == g_CramRectangles[iVar25].start_y))
                          goto LAB_00446f25;
                          iVar25 = iVar25 + 1;
...
LAB_00446f25:
                ...
                if (0 < g_CramRectangleCount) {
                  ...
                  do {
                    if (((iVar32 == g_CramRectangles[iVar23].map_id) &&
                        (iVar22 == g_CramRectangles[iVar23].start_x)) &&
                       (local_6c == g_CramRectangles[iVar23].start_y))
                    goto LAB_00446f96;
                    iVar23 = iVar23 + 1;
                  } while (iVar23 < g_CramRectangleCount);
                }
...
LAB_00447500:
      ...
      if (iVar18 < g_CramBestSolutionMetric1) {
        ...
        g_CramBestSolutionMetric1 = iVar29 / 4;
...
joined_r0x00446b0b:
        ...
        if (1 < g_CramPlacedTextureCount) {
          do {
            if ((g_CramBestSolutionMetric1 <= g_CramSortedTextureEntries[iVar29].working_top) ||
               (g_CramBestSolutionMetric1 <= g_CramSortedTextureEntries[iVar29].working_width)) {
              g_CramCandidateWriteCursor = ppSVar18;
              g_CramPlacedTextureCount = g_CramPlacedTextureCount + -1;
              return g_CramPlacedTextureCount - iVar29;
            }
            iVar29 = iVar29 + 1;
          } while (iVar29 < g_CramPlacedTextureCount);
        }
      }
      else {
        p_Var19 = shape_memdbg_cpp_openFile_FUN_0050f7a0
