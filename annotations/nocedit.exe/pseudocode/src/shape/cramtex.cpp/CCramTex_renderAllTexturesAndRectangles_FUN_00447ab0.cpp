...

{
  ...
  if (g_CramVisualizationFlag != 0) {
    ...
    iVar3 = g_CramPlacedTextureCount;
    if (this_ptr != (CCramTex *)0x0) {
      iVar3 = g_CramTextureCount;
    }
    iVar1 = 0;
    if (0 < iVar3) {
      ...
      do {
        ...
        shape_cramtex_cpp_CCramTex_renderTextureEntry_FUN_00447c20
                  (this_ptr_00,(int)this_ptr,x,y,width,height);
      ...
      do {
        if ((g_CramMapNumber == pSVar2->left) && (-1 < pSVar2->active_flag)) {
          ...
          if ((iVar1 < width) && (y_00 < height)) {
            ...
            engine_2d_c_plotPixel_FUN_00401140(iVar1 + 1,y_00);
            engine_2d_c_plotPixel_FUN_00401140(iVar1,y_00 + 1);
          }
        }
        iVar3 = iVar3 + 1;
        pSVar2 = pSVar2 + 1;
