...

{
  ...
  do {
    ...
    if (0 < g_CramRectangleCount) {
      iVar16 = 0;
      do {
        if (((g_CramRectangles[iVar16].map_id == 0) &&
            (g_CramRectangles[iVar16].start_x == 0)) &&
           (g_CramSortedTextureEntries[0].padded_height ==
            g_CramRectangles[iVar16].start_y)) goto LAB_00445b8a;
        iVar16 = iVar16 + 1;
      } while (iVar16 < g_CramRectangleCount);
    }
    local_34 = 0;
      ...
      do {
        if (((g_CramRectangles[iVar17].map_id == 0) &&
           ...
           (g_CramSortedTextureEntries[0].working_right ==
            g_CramRectangles[iVar17].start_y)) goto LAB_00445bd9;
        iVar17 = iVar17 + 1;
        ...
        if (0 < g_CramRectangleCount) {
          ...
          do {
            if (((local_14 == g_CramRectangles[iVar11].map_id) &&
               ...
               (g_CramRectangles[iVar11].start_y == 0)) goto LAB_00445c34;
            iVar11 = iVar11 + 1;
