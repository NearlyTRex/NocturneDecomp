...
;   shape_cramtex.cpp_runInteractiveAtlasGeneration_FUN_00446160 at 0044677b
;
; Referenced Globals:
...
section .text
    ...
    CALL crt_stack.c_stack_probe_FUN_005ff9f3 ; 004478c5 | uint crt_stack.c_stack_probe_FUN_005ff9f3(uint stack_size)
        ;   XREF to: 005ff9f3 (UNCONDITIONAL_CALL)
    PUSH EBX                            ; 004478ca
    PUSH ESI                            ; 004478cb
    PUSH EDI                            ; 004478cc
    PUSH EBP                            ; 004478cd
    MOV EDI,dword ptr [0x0084a854]      ; 004478ce | uint g_CramTextureCount
    MOV EDX,dword ptr [ESP + 0x14]      ; 004478d4
    XOR ECX,ECX                         ; 004478d8
    XOR EBX,EBX                         ; 004478da
    TEST EDI,EDI                        ; 004478dc
    JLE 0x00447914                      ; 004478de | LAB_00447914
        ;   XREF to: 00447914 (CONDITIONAL_JUMP)
    MOV EAX,0x83c1dc                    ; 004478e0 | SCramWorkingEntry[1] g_CramSortedTextureEntries
    ...
    JL 0x004478e5                       ; 00447912 | LAB_004478e5
        ;   XREF to: 004478e5 (CONDITIONAL_JUMP)
    MOV EAX,EBX                         ; 00447914
        ;   Label: LAB_00447914
    MOV dword ptr [0x0084a854],EDI      ; 00447916 | uint g_CramTextureCount
    POP EBP                             ; 0044791c
    POP EDI                             ; 0044791d
    POP ESI                             ; 0044791e
    POP EBX                             ; 0044791f
