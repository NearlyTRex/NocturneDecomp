...
section .text
    ...
    MOV ECX,dword ptr [0x02f0d938]      ; 0050eef0 | SMemHead * g_MemoryListHead
    ...
    JNZ 0x0050ef0f                      ; 0050ef02 | LAB_0050ef0f
        ;   XREF to: 0050ef0f (CONDITIONAL_JUMP)
    MOV [0x02f0d938],EAX                ; 0050ef04 | SMemHead * g_MemoryListHead
    MOV dword ptr [EAX + 0x4],ECX       ; 0050ef09
    MOV ECX,EAX                         ; 0050ef0c
    RET                                 ; 0050ef0e
    MOV dword ptr [ECX],EAX             ; 0050ef0f
        ;   Label: LAB_0050ef0f
    MOV [0x02f0d938],EAX                ; 0050ef11 | SMemHead * g_MemoryListHead
