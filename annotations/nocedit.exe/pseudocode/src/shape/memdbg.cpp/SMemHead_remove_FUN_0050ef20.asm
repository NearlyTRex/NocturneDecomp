...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_memdbg.cpp_SMemHead_remove_FUN_0050ef20(SMemHead * header)
;
; Parameters:
...
section .text
    ...
    JNZ 0x0050ef79                      ; 0050ef2a | LAB_0050ef79
        ;   XREF to: 0050ef79 (CONDITIONAL_JUMP)
    CMP EBX,dword ptr [0x02f0d938]      ; 0050ef2c | SMemHead * g_MemoryListHead
    JZ 0x0050ef5b                       ; 0050ef32 | LAB_0050ef5b
        ;   XREF to: 0050ef5b (CONDITIONAL_JUMP)
    PUSH EDI                            ; 0050ef34
    PUSH ESI                            ; 0050ef35
    MOV ESI,0x635df7                    ; 0050ef36 | = "..\\shape\\memdbg.cpp" | s_shape_memdbg_cpp_00635df7 = ..\shape\memdbg.cpp
    MOV EDI,0x8b                        ; 0050ef3b
    PUSH 0x635e0b                       ; 0050ef40 | = "SMemHead::remove - list corruption!" | s_SMemHead_remove_list_cor_00635e0b = SMemHead::remove - list corruption!
    MOV dword ptr [0x02f0ca48],ESI      ; 0050ef45 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 0050ef4b | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0050ef51 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    MOV EAX,dword ptr [EBX + 0x4]       ; 0050ef5b
        ;   Label: LAB_0050ef5b
    MOV [0x02f0d938],EAX                ; 0050ef5e | SMemHead * g_MemoryListHead
    MOV EBP,dword ptr [EBX + 0x4]       ; 0050ef63
        ;   Label: LAB_0050ef63
    TEST EBP,EBP                        ; 0050ef66
    JNZ 0x0050ef81                      ; 0050ef68 | LAB_0050ef81
    ...
    JMP 0x0050ef63                      ; 0050ef7f | LAB_0050ef63
