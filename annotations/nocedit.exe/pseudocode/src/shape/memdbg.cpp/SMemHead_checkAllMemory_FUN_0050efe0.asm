...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_memdbg.cpp_SMemHead_checkAllMemory_FUN_0050efe0(char * filename, int context)
;
; Parameters:
...
section .text
    ...
    MOV EBX,dword ptr [0x02f0d938]      ; 0050efeb | SMemHead * g_MemoryListHead
    TEST EBX,EBX                        ; 0050eff1
    JZ 0x0050f010                       ; 0050eff3 | LAB_0050f010
        ;   XREF to: 0050f010 (CONDITIONAL_JUMP)
    PUSH EDI                            ; 0050eff5
        ;   Label: LAB_0050eff5
    PUSH ESI                            ; 0050eff6
    PUSH EBX                            ; 0050eff7
    CALL shape_memdbg.cpp_SMemHead_checkMemory_FUN_0050f020 ; 0050eff8 | void shape_memdbg.cpp_SMemHead_checkMemory_FUN_0050f020(SMemHead * header, char * filename, int line_number)
        ;   XREF to: 0050f020 (UNCONDITIONAL_CALL)
    MOV EBX,dword ptr [EBX + 0x4]       ; 0050effd
    ADD ESP,0xc                         ; 0050f000
    TEST EBX,EBX                        ; 0050f003
    JNZ 0x0050eff5                      ; 0050f005 | LAB_0050eff5
        ;   XREF to: 0050eff5 (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 0050f007
    LEA EDX,[EDX]                       ; 0050f00d
    MOV dword ptr [0x02f0d940],EDI      ; 0050f010 | void * g_DebugContext
        ;   Label: LAB_0050f010
    MOV dword ptr [0x0067d1fc],ESI      ; 0050f016 | void * PTR_s_none_00636540_0067d1fc
    POP EDI                             ; 0050f01c
    POP ESI                             ; 0050f01d
    POP EBX                             ; 0050f01e
    RET                                 ; 0050f01f
