...
section .text
    ...
    CMP dword ptr [0x02f0ca50],0x0      ; 0050f360 | BOOL g_RecursiveCallFlag
    JNZ 0x0050f38b                      ; 0050f367 | LAB_0050f38b
        ;   XREF to: 0050f38b (CONDITIONAL_JUMP)
    CMP dword ptr [0x02f0d93c],0x0      ; 0050f369 | HANDLE g_FileMutex
    JNZ 0x0050f37c                      ; 0050f370 | LAB_0050f37c
        ;   XREF to: 0050f37c (CONDITIONAL_JUMP)
    CALL wincore_winrun.cpp_createMutex_FUN_005f3fe0 ; 0050f372 | HANDLE wincore_winrun.cpp_createMutex_FUN_005f3fe0()
        ;   XREF to: 005f3fe0 (UNCONDITIONAL_CALL)
    MOV [0x02f0d93c],EAX                ; 0050f377 | HANDLE g_FileMutex
    MOV EBP,dword ptr [0x02f0d93c]      ; 0050f37c | HANDLE g_FileMutex
        ;   Label: LAB_0050f37c
    PUSH EBP                            ; 0050f382
    CALL wincore_winrun.cpp_waitForMutex_FUN_005f3ff0 ; 0050f383 | int wincore_winrun.cpp_waitForMutex_FUN_005f3ff0(HANDLE mutex_handle)
    ...
    PUSH EBX                            ; 0050f395
    PUSH 0x636078                       ; 0050f396 | = "debugCalloc(%d, %d, %s, %d)" | s_debugCalloc_d_d_s_d_00636078 = debugCalloc(%d, %d, %s, %d)
    CALL shape_memdbg.cpp_traceMemory_FUN_0050f150 ; 0050f39b | void shape_memdbg.cpp_traceMemory_FUN_0050f150(char * format)
        ;   XREF to: 0050f150 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0050f3a0
    TEST ESI,ESI                        ; 0050f3a3
    JZ 0x0050f3dc                       ; 0050f3a5 | LAB_0050f3dc
        ;   XREF to: 0050f3dc (CONDITIONAL_JUMP)
    LEA EAX,[ESI + 0x2c]                ; 0050f3a7
    PUSH EAX                            ; 0050f3aa
    CALL crt_memory.c_malloc_FUN_00601bb0 ; 0050f3ab | void * crt_memory.c_malloc_FUN_00601bb0(ulong size)
        ;   XREF to: 00601bb0 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 0050f3b0
    ADD ESP,0x4                         ; 0050f3b2
    TEST EAX,EAX                        ; 0050f3b5
    JNZ 0x0050f3ff                      ; 0050f3b7 | LAB_0050f3ff
        ;   XREF to: 0050f3ff (CONDITIONAL_JUMP)
    PUSH 0x6360a4                       ; 0050f3b9 | = "   !!FAILED!!" | s_FAILED_006360a4 =    !!FAILED!!
    CALL shape_memdbg.cpp_traceMemory_FUN_0050f150 ; 0050f3be | void shape_memdbg.cpp_traceMemory_FUN_0050f150(char * format)
        ;   XREF to: 0050f150 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0050f3c3
    MOV ECX,dword ptr [0x02f0d93c]      ; 0050f3c6 | HANDLE g_FileMutex
    PUSH ECX                            ; 0050f3cc
    CALL wincore_winrun.cpp_releaseMutex_FUN_005f4050 ; 0050f3cd | void wincore_winrun.cpp_releaseMutex_FUN_005f4050(HANDLE mutex_handle)
    ...
    POP EBX                             ; 0050f3da
    RET                                 ; 0050f3db
    PUSH 0x636094                       ; 0050f3dc | = "   Returns NULL" | s_Returns_NULL_00636094 =    Returns NULL
        ;   Label: LAB_0050f3dc
    CALL shape_memdbg.cpp_traceMemory_FUN_0050f150 ; 0050f3e1 | void shape_memdbg.cpp_traceMemory_FUN_0050f150(char * format)
        ;   XREF to: 0050f150 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0050f3e6
    MOV EBX,dword ptr [0x02f0d93c]      ; 0050f3e9 | HANDLE g_FileMutex
    PUSH EBX                            ; 0050f3ef
    CALL wincore_winrun.cpp_releaseMutex_FUN_005f4050 ; 0050f3f0 | void wincore_winrun.cpp_releaseMutex_FUN_005f4050(HANDLE mutex_handle)
        ;   XREF to: 005f4050 (UNCONDITIONAL_CALL)
    ...
    CALL shape_memdbg.cpp_SMemHead_recordSourceFile_FUN_0050eea0 ; 0050f404 | void shape_memdbg.cpp_SMemHead_recordSourceFile_FUN_0050eea0(SMemHead * header, char * source_filename)
    ...
    CALL shape_memdbg.cpp_SMemHead_add_FUN_0050eef0 ; 0050f428 | void shape_memdbg.cpp_SMemHead_add_FUN_0050eef0(SMemHead * header)
        ;   XREF to: 0050eef0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0050f42d
    PUSH ESI                            ; 0050f430
    PUSH 0x0                            ; 0050f431
    PUSH EDI                            ; 0050f433
    CALL crt_memory.c_memset_FUN_005fde40 ; 0050f434 | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
        ;   XREF to: 005fde40 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0050f439
    PUSH EDI                            ; 0050f43c
    PUSH 0x6360b2                       ; 0050f43d | = "   Returns %08X" | s_Returns_08X_006360b2 =    Returns %08X
    CALL shape_memdbg.cpp_traceMemory_FUN_0050f150 ; 0050f442 | void shape_memdbg.cpp_traceMemory_FUN_0050f150(char * format)
        ;   XREF to: 0050f150 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0050f447
    MOV EDX,dword ptr [0x02f0d93c]      ; 0050f44a | HANDLE g_FileMutex
    PUSH EDX                            ; 0050f450
    CALL wincore_winrun.cpp_releaseMutex_FUN_005f4050 ; 0050f451 | void wincore_winrun.cpp_releaseMutex_FUN_005f4050(HANDLE mutex_handle)
        ;   XREF to: 005f4050 (UNCONDITIONAL_CALL)
