...
section .text
    ...
    CMP dword ptr [0x02f0ca50],0x0      ; 0050f258 | BOOL g_RecursiveCallFlag
    JNZ 0x0050f283                      ; 0050f25f | LAB_0050f283
        ;   XREF to: 0050f283 (CONDITIONAL_JUMP)
    CMP dword ptr [0x02f0d93c],0x0      ; 0050f261 | HANDLE g_FileMutex
    JNZ 0x0050f274                      ; 0050f268 | LAB_0050f274
        ;   XREF to: 0050f274 (CONDITIONAL_JUMP)
    CALL wincore_winrun.cpp_createMutex_FUN_005f3fe0 ; 0050f26a | HANDLE wincore_winrun.cpp_createMutex_FUN_005f3fe0()
        ;   XREF to: 005f3fe0 (UNCONDITIONAL_CALL)
    MOV [0x02f0d93c],EAX                ; 0050f26f | HANDLE g_FileMutex
    MOV EBX,dword ptr [0x02f0d93c]      ; 0050f274 | HANDLE g_FileMutex
        ;   Label: LAB_0050f274
    PUSH EBX                            ; 0050f27a
    CALL wincore_winrun.cpp_waitForMutex_FUN_005f3ff0 ; 0050f27b | int wincore_winrun.cpp_waitForMutex_FUN_005f3ff0(HANDLE mutex_handle)
    ...
    PUSH EBP                            ; 0050f28c
    PUSH ESI                            ; 0050f28d
    PUSH 0x636032                       ; 0050f28e | = "debugMalloc(%d, %s, %d)" | s_debugMalloc_d_s_d_00636032 = debugMalloc(%d, %s, %d)
    CALL shape_memdbg.cpp_traceMemory_FUN_0050f150 ; 0050f293 | void shape_memdbg.cpp_traceMemory_FUN_0050f150(char * format)
        ;   XREF to: 0050f150 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0050f298
    TEST ESI,ESI                        ; 0050f29b
    JZ 0x0050f2d4                       ; 0050f29d | LAB_0050f2d4
        ;   XREF to: 0050f2d4 (CONDITIONAL_JUMP)
    LEA EAX,[ESI + 0x2c]                ; 0050f29f
    PUSH EAX                            ; 0050f2a2
    CALL crt_memory.c_malloc_FUN_00601bb0 ; 0050f2a3 | void * crt_memory.c_malloc_FUN_00601bb0(ulong size)
        ;   XREF to: 00601bb0 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 0050f2a8
    ADD ESP,0x4                         ; 0050f2aa
    TEST EAX,EAX                        ; 0050f2ad
    JNZ 0x0050f2f7                      ; 0050f2af | LAB_0050f2f7
        ;   XREF to: 0050f2f7 (CONDITIONAL_JUMP)
    PUSH 0x63605a                       ; 0050f2b1 | = "   !!FAILED!!" | s_FAILED_0063605a =    !!FAILED!!
    CALL shape_memdbg.cpp_traceMemory_FUN_0050f150 ; 0050f2b6 | void shape_memdbg.cpp_traceMemory_FUN_0050f150(char * format)
        ;   XREF to: 0050f150 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0050f2bb
    MOV ECX,dword ptr [0x02f0d93c]      ; 0050f2be | HANDLE g_FileMutex
    PUSH ECX                            ; 0050f2c4
    CALL wincore_winrun.cpp_releaseMutex_FUN_005f4050 ; 0050f2c5 | void wincore_winrun.cpp_releaseMutex_FUN_005f4050(HANDLE mutex_handle)
    ...
    POP EBX                             ; 0050f2d2
    RET                                 ; 0050f2d3
    PUSH 0x63604a                       ; 0050f2d4 | = "   Returns NULL" | s_Returns_NULL_0063604a =    Returns NULL
        ;   Label: LAB_0050f2d4
    CALL shape_memdbg.cpp_traceMemory_FUN_0050f150 ; 0050f2d9 | void shape_memdbg.cpp_traceMemory_FUN_0050f150(char * format)
        ;   XREF to: 0050f150 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0050f2de
    MOV EBX,dword ptr [0x02f0d93c]      ; 0050f2e1 | HANDLE g_FileMutex
    PUSH EBX                            ; 0050f2e7
    CALL wincore_winrun.cpp_releaseMutex_FUN_005f4050 ; 0050f2e8 | void wincore_winrun.cpp_releaseMutex_FUN_005f4050(HANDLE mutex_handle)
        ;   XREF to: 005f4050 (UNCONDITIONAL_CALL)
    ...
    CALL shape_memdbg.cpp_SMemHead_recordSourceFile_FUN_0050eea0 ; 0050f2fc | void shape_memdbg.cpp_SMemHead_recordSourceFile_FUN_0050eea0(SMemHead * header, char * source_filename)
    ...
    CALL shape_memdbg.cpp_SMemHead_add_FUN_0050eef0 ; 0050f31c | void shape_memdbg.cpp_SMemHead_add_FUN_0050eef0(SMemHead * header)
        ;   XREF to: 0050eef0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0050f321
    PUSH ESI                            ; 0050f324
    PUSH 0x636068                       ; 0050f325 | = "   Returns %08X" | s_Returns_08X_00636068 =    Returns %08X
    CALL shape_memdbg.cpp_traceMemory_FUN_0050f150 ; 0050f32a | void shape_memdbg.cpp_traceMemory_FUN_0050f150(char * format)
        ;   XREF to: 0050f150 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0050f32f
    MOV EDX,dword ptr [0x02f0d93c]      ; 0050f332 | HANDLE g_FileMutex
    PUSH EDX                            ; 0050f338
    CALL wincore_winrun.cpp_releaseMutex_FUN_005f4050 ; 0050f339 | void wincore_winrun.cpp_releaseMutex_FUN_005f4050(HANDLE mutex_handle)
        ;   XREF to: 005f4050 (UNCONDITIONAL_CALL)
