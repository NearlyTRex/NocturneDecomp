...
;                               FUNCTION
; *****************************************************************************
; __cdecl CLeakChecker * shape_memdbg.cpp_CLeakChecker_ctor_FUN_0050fba0(CLeakChecker * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH 0x6363d9                       ; 0050fba3 | = "ags" | s_ags_006363d9 = ags
    LEA EAX,[ESP + 0x4]                 ; 0050fba8
    PUSH EAX                            ; 0050fbac
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0050fbad | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
