...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_memdbg.cpp_SMemHead_recordSourceFile_FUN_0050eea0(SMemHead * header, char * source_filename)
;
; Parameters:
...
section .text
    ...
    JNZ 0x0050eed3                      ; 0050eeae | LAB_0050eed3
        ;   XREF to: 0050eed3 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 0050eeb0
    MOV ESI,0x635ded                    ; 0050eeb1 | = "(unknown)" | s_unknown_00635ded = (unknown)
    PUSH EDI                            ; 0050eeb6
    MOV AL,byte ptr [ESI]               ; 0050eeb7 | = "(unknown)" | s_unknown_00635ded = (unknown)
        ;   Label: LAB_0050eeb7
    MOV byte ptr [EDI],AL               ; 0050eeb9
    CMP AL,0x0                          ; 0050eebb
    JZ 0x0050eecf                       ; 0050eebd | LAB_0050eecf
        ;   XREF to: 0050eecf (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0050eebf | s_unknown)_00635dee
    ADD ESI,0x2                         ; 0050eec2
    MOV byte ptr [EDI + 0x1],AL         ; 0050eec5
    ADD EDI,0x2                         ; 0050eec8
    CMP AL,0x0                          ; 0050eecb
    JNZ 0x0050eeb7                      ; 0050eecd | LAB_0050eeb7
    ...
    PUSH 0x0                            ; 0050eed8
    PUSH EAX                            ; 0050eeda
    CALL crt_string.c_splitpath_FUN_005ff178 ; 0050eedb | void crt_string.c_splitpath_FUN_005ff178(char * path, char * drive, char * dir, char * fname, ...)
