...
// Convention: __cdecl
// Signature: void __cdecl shape_design_c_showShapeEditorMenu_FUN_0046f290(void)
...

{
  ...
  g_ModelCount = 8;
  g_EditorBackgroundColors[0] = 0;
  g_EditorBackgroundColors[1] = 0xff;
  g_EditorBackgroundColors[2] = 0xf8;
  g_EditorBackgroundColors[3] = 3;
  g_EditorBackgroundColors[4] = 2;
  g_EditorBackgroundColors[5] = 0xfc;
  g_EditorBackgroundColors[6] = 4;
  g_EditorBackgroundColors[7] = 1;
  g_EditorColorIndices[0] = 7;
  g_EditorColorIndices[1] = 0xf8;
  g_EditorColorIndices[2] = 0xff;
  g_EditorColorIndices[3] = 0xff;
  g_EditorColorIndices[4] = 0xff;
