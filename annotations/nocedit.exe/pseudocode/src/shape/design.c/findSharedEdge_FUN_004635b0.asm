...
section .text
    ...
    JNZ 0x004636db                      ; 004635c2 | LAB_004636db
    ...
    JNZ 0x004635e3                      ; 004635d3 | LAB_004635e3
    ...
    JZ 0x004635e5                       ; 004635e1 | LAB_004635e5
        ;   XREF to: 004635e5 (CONDITIONAL_JUMP)
    JMP 0x004635fa                      ; 004635e3 | LAB_004635fa
        ;   Label: LAB_004635e3
    ...
    JMP 0x004637f1                      ; 004635f5 | LAB_004637f1
        ;   XREF to: 004637f1 (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBP + 0x1c],0x3      ; 004635fa
        ;   Label: LAB_004635fa
    JNZ 0x0046366c                      ; 004635fe | LAB_0046366c
    ...
    JNZ 0x0046361e                      ; 00463610 | LAB_0046361e
    ...
    JZ 0x00463620                       ; 0046361c | LAB_00463620
        ;   XREF to: 00463620 (CONDITIONAL_JUMP)
    JMP 0x00463635                      ; 0046361e | LAB_00463635
        ;   Label: LAB_0046361e
    ...
    JMP 0x004637f1                      ; 00463630 | LAB_004637f1
        ;   XREF to: 004637f1 (UNCONDITIONAL_JUMP)
    ...
    JNZ 0x00463650                      ; 00463640 | LAB_00463650
    ...
    JZ 0x00463652                       ; 0046364e | LAB_00463652
        ;   XREF to: 00463652 (CONDITIONAL_JUMP)
    JMP 0x00463667                      ; 00463650 | LAB_00463667
        ;   Label: LAB_00463650
    ...
    JMP 0x004637f1                      ; 00463662 | LAB_004637f1
        ;   XREF to: 004637f1 (UNCONDITIONAL_JUMP)
    JMP 0x004636d6                      ; 00463667 | LAB_004636d6
        ;   Label: LAB_00463667
        ;   XREF to: 004636d6 (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBP + 0x1c],0x4      ; 0046366c
        ;   Label: LAB_0046366c
    JNZ 0x004636d6                      ; 00463670 | LAB_004636d6
    ...
    JNZ 0x0046368c                      ; 0046367e | LAB_0046368c
    ...
    JZ 0x0046368e                       ; 0046368a | LAB_0046368e
        ;   XREF to: 0046368e (CONDITIONAL_JUMP)
    JMP 0x004636a3                      ; 0046368c | LAB_004636a3
        ;   Label: LAB_0046368c
    ...
    JMP 0x004637f1                      ; 0046369e | LAB_004637f1
        ;   XREF to: 004637f1 (UNCONDITIONAL_JUMP)
    ...
    JNZ 0x004636bf                      ; 004636af | LAB_004636bf
    ...
    JZ 0x004636c1                       ; 004636bd | LAB_004636c1
        ;   XREF to: 004636c1 (CONDITIONAL_JUMP)
    JMP 0x004636d6                      ; 004636bf | LAB_004636d6
        ;   Label: LAB_004636bf
        ;   XREF to: 004636d6 (UNCONDITIONAL_JUMP)
    ...
    JMP 0x004637f1                      ; 004636d1 | LAB_004637f1
        ;   XREF to: 004637f1 (UNCONDITIONAL_JUMP)
    JMP 0x004637ea                      ; 004636d6 | default
        ;   Label: LAB_004636d6
    ...
    JMP 0x004637d8                      ; 004636e3 | LAB_004637d8
    ...
    JNZ 0x00463703                      ; 004636f3 | LAB_00463703
    ...
    JZ 0x00463705                       ; 00463701 | LAB_00463705
        ;   XREF to: 00463705 (CONDITIONAL_JUMP)
    JMP 0x00463711                      ; 00463703 | LAB_00463711
        ;   Label: LAB_00463703
        ;   XREF to: 00463711 (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x4],0x1      ; 00463705
        ;   Label: LAB_00463705
    JMP 0x004637f1                      ; 0046370c | LAB_004637f1
        ;   XREF to: 004637f1 (UNCONDITIONAL_JUMP)
    JMP 0x004637ea                      ; 00463711 | default
        ;   Label: LAB_00463711
        ;   XREF to: 004637ea (UNCONDITIONAL_JUMP)
    ...
    JNZ 0x00463730                      ; 00463722 | LAB_00463730
    ...
    JZ 0x00463732                       ; 0046372e | LAB_00463732
        ;   XREF to: 00463732 (CONDITIONAL_JUMP)
    JMP 0x0046373e                      ; 00463730 | LAB_0046373e
        ;   Label: LAB_00463730
        ;   XREF to: 0046373e (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x4],0x1      ; 00463732
        ;   Label: LAB_00463732
    JMP 0x004637f1                      ; 00463739 | LAB_004637f1
        ;   XREF to: 004637f1 (UNCONDITIONAL_JUMP)
    JMP 0x004637ea                      ; 0046373e | default
        ;   Label: LAB_0046373e
        ;   XREF to: 004637ea (UNCONDITIONAL_JUMP)
    ...
    JNZ 0x0046375e                      ; 0046374e | LAB_0046375e
    ...
    JZ 0x00463760                       ; 0046375c | LAB_00463760
        ;   XREF to: 00463760 (CONDITIONAL_JUMP)
    JMP 0x0046376c                      ; 0046375e | LAB_0046376c
        ;   Label: LAB_0046375e
        ;   XREF to: 0046376c (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x4],0x1      ; 00463760
        ;   Label: LAB_00463760
    JMP 0x004637f1                      ; 00463767 | LAB_004637f1
        ;   XREF to: 004637f1 (UNCONDITIONAL_JUMP)
    JMP 0x004637ea                      ; 0046376c | default
        ;   Label: LAB_0046376c
        ;   XREF to: 004637ea (UNCONDITIONAL_JUMP)
    ...
    JNZ 0x0046378b                      ; 0046377d | LAB_0046378b
    ...
    JZ 0x0046378d                       ; 00463789 | LAB_0046378d
        ;   XREF to: 0046378d (CONDITIONAL_JUMP)
    JMP 0x00463796                      ; 0046378b | LAB_00463796
        ;   Label: LAB_0046378b
        ;   XREF to: 00463796 (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x4],0x1      ; 0046378d
        ;   Label: LAB_0046378d
    JMP 0x004637f1                      ; 00463794 | LAB_004637f1
        ;   XREF to: 004637f1 (UNCONDITIONAL_JUMP)
    JMP 0x004637ea                      ; 00463796 | default
        ;   Label: LAB_00463796
        ;   XREF to: 004637ea (UNCONDITIONAL_JUMP)
    ...
    JNZ 0x004637b4                      ; 004637a4 | LAB_004637b4
    ...
    JZ 0x004637b6                       ; 004637b2 | LAB_004637b6
        ;   XREF to: 004637b6 (CONDITIONAL_JUMP)
    JMP 0x004637bf                      ; 004637b4 | LAB_004637bf
        ;   Label: LAB_004637b4
        ;   XREF to: 004637bf (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x4],0x1      ; 004637b6
        ;   Label: LAB_004637b6
    JMP 0x004637f1                      ; 004637bd | LAB_004637f1
        ;   XREF to: 004637f1 (UNCONDITIONAL_JUMP)
    JMP 0x004637ea                      ; 004637bf | default
        ;   Label: LAB_004637bf
        ;   XREF to: 004637ea (UNCONDITIONAL_JUMP)
    JMP 0x004637ea                      ; 004637c1 | default
        ;   Label: LAB_004637c1
        ;   XREF to: 004637ea (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0x8],0x4      ; 004637d8
        ;   Label: LAB_004637d8
    JA 0x004637c1                       ; 004637dc | LAB_004637c1
        ;   XREF to: 004637c1 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + -0x8]      ; 004637de
    SHL EAX,0x2                         ; 004637e1
    JMP dword ptr [EAX + 0x4637c4]      ; 004637e4 | void * switchdataD_004637c4
        ;   Label: switchD
