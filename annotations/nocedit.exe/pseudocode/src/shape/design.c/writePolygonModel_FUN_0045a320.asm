...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_design.c_writePolygonModel_FUN_0045a320(int polygon_index, FILE * output_file, float scale_factor)
;
; Parameters:
...
section .text
    ...
    MOV EDX,0x16e9910                   ; 0045a333 | SShapeEditorPolygon[20000] g_ModelPolygonData
    ADD EAX,EDX                         ; 0045a338
    PUSH EAX                            ; 0045a33a
    CALL shape_design.c_calculatePolygonNormal_FUN_0045caa0 ; 0045a33b | void shape_design.c_calculatePolygonNormal_FUN_0045caa0(SShapeEditorPolygon * polygon)
    ...
    FMUL float ptr [0x0061ae5e]         ; 0045a350 | float FLOAT_0061ae5e
    CALL crt_math.c_round_FUN_005fe6b0  ; 0045a356 | double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    FMUL float ptr [0x0061ae5e]         ; 0045a36b | float FLOAT_0061ae5e
    CALL crt_math.c_round_FUN_005fe6b0  ; 0045a371 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    FMUL float ptr [0x0061ae5e]         ; 0045a386 | float FLOAT_0061ae5e
    CALL crt_math.c_round_FUN_005fe6b0  ; 0045a38c | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    FMUL double ptr [0x0061ae66]        ; 0045a3a1 | double DOUBLE_0061ae66
    FMUL double ptr [0x0061ae6e]        ; 0045a3a7 | double DOUBLE_0061ae6e
    FLD float ptr [EBP + 0x1c]          ; 0045a3ad
    FMULP                               ; 0045a3b0
    CALL crt_math.c_round_FUN_005fe6b0  ; 0045a3b2 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [EBP + -0x8]        ; 0045a3b7
    IMUL EAX,dword ptr [EBP + 0x14],0x184 ; 0045a3ba
    CMP dword ptr [EAX + 0x16e9910],0x1 ; 0045a3c1 | SShapeEditorPolygon[20000] g_ModelPolygonData
    JNZ 0x0045a4a3                      ; 0045a3c8 | LAB_0045a4a3
        ;   XREF to: 0045a4a3 (CONDITIONAL_JUMP)
    IMUL EDX,dword ptr [EBP + 0x14],0x184 ; 0045a3ce
    MOV EAX,[0x01626368]                ; 0045a3d5 | int g_EditorColorIndex
    CMP EAX,dword ptr [EDX + 0x16e9a8c] ; 0045a3da | DAT_016e9a8c
    JZ 0x0045a413                       ; 0045a3e0 | LAB_0045a413
    ...
    MOV EAX,0x61ae76                    ; 0045a3ef | = "\tCOLOR\t%d\n" | s_COLOR_d_0061ae76 = 	COLOR	%d

    PUSH EAX                            ; 0045a3f4 | = "\tCOLOR\t%d\n" | s_COLOR_d_0061ae76 = 	COLOR	%d

    MOV EAX,dword ptr [EBP + 0x18]      ; 0045a3f5
    PUSH EAX                            ; 0045a3f8
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0045a3f9 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    MOV [0x01626368],EAX                ; 0045a40e | int g_EditorColorIndex
    ...
    MOV EAX,0x61ae81                    ; 0045a430 | = "\tFACET%d\t%d,%d,%d,%d" | s_FACET_d_d_d_d_d_0061ae81 = 	FACET%d	%d,%d,%d,%d
    PUSH EAX                            ; 0045a435 | = "\tFACET%d\t%d,%d,%d,%d" | s_FACET_d_d_d_d_d_0061ae81 = 	FACET%d	%d,%d,%d,%d
    MOV EAX,dword ptr [EBP + 0x18]      ; 0045a436
    PUSH EAX                            ; 0045a439
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0045a43a | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x1c                        ; 0045a43f
    MOV dword ptr [EBP + -0x4],0x0      ; 0045a442
    JMP 0x0045a451                      ; 0045a449 | LAB_0045a451
    ...
    JGE 0x0045a48c                      ; 0045a461 | LAB_0045a48c
    ...
    MOV EAX,0x61ae96                    ; 0045a478 | = ",%d" | s_d_0061ae96 = ,%d
    PUSH EAX                            ; 0045a47d | = ",%d" | s_d_0061ae96 = ,%d
    MOV EAX,dword ptr [EBP + 0x18]      ; 0045a47e
    PUSH EAX                            ; 0045a481
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0045a482 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0045a487
    JMP 0x0045a44b                      ; 0045a48a | LAB_0045a44b
    ...
    PUSH EAX                            ; 0045a495
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0045a496 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0045a49b
    JMP 0x0045a5fb                      ; 0045a49e | LAB_0045a5fb
        ;   XREF to: 0045a5fb (UNCONDITIONAL_JUMP)
    IMUL EDX,dword ptr [EBP + 0x14],0x184 ; 0045a4a3
        ;   Label: LAB_0045a4a3
    MOV EAX,0x16e9910                   ; 0045a4aa | SShapeEditorPolygon[20000] g_ModelPolygonData
    ADD EAX,EDX                         ; 0045a4af
    ADD EAX,0x4                         ; 0045a4b1
    PUSH EAX                            ; 0045a4b4
    MOV EAX,0x1626370                   ; 0045a4b5 | char[80] g_TempTextureName
    PUSH EAX                            ; 0045a4ba | char[80] g_TempTextureName
    CALL crt_string.c_strcmp_FUN_005fef20 ; 0045a4bb | int crt_string.c_strcmp_FUN_005fef20(char * str1, char * str2)
        ;   XREF to: 005fef20 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0045a4c0
    TEST EAX,EAX                        ; 0045a4c3
    JZ 0x0045a50f                       ; 0045a4c5 | LAB_0045a50f
        ;   XREF to: 0045a50f (CONDITIONAL_JUMP)
    IMUL ESI,dword ptr [EBP + 0x14],0x184 ; 0045a4c7
    MOV EDI,0x16e9910                   ; 0045a4ce | SShapeEditorPolygon[20000] g_ModelPolygonData
    ADD ESI,EDI                         ; 0045a4d3
    ADD ESI,0x4                         ; 0045a4d5
    MOV EDI,0x1626370                   ; 0045a4d8 | char[80] g_TempTextureName
    PUSH EDI                            ; 0045a4dd | char[80] g_TempTextureName
    MOV AL,byte ptr [ESI]               ; 0045a4de | DAT_016e9914
        ;   Label: LAB_0045a4de
    MOV byte ptr [EDI],AL               ; 0045a4e0 | char[80] g_TempTextureName
    CMP AL,0x0                          ; 0045a4e2
    JZ 0x0045a4f6                       ; 0045a4e4 | LAB_0045a4f6
        ;   XREF to: 0045a4f6 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0045a4e6 | DAT_016e9915
    ADD ESI,0x2                         ; 0045a4e9
    MOV byte ptr [EDI + 0x1],AL         ; 0045a4ec | DAT_01626371
    ADD EDI,0x2                         ; 0045a4ef
    CMP AL,0x0                          ; 0045a4f2
    JNZ 0x0045a4de                      ; 0045a4f4 | LAB_0045a4de
        ;   XREF to: 0045a4de (CONDITIONAL_JUMP)
    POP EDI                             ; 0045a4f6
        ;   Label: LAB_0045a4f6
    MOV ESI,0x1626370                   ; 0045a4f7 | char[80] g_TempTextureName
    PUSH ESI                            ; 0045a4fc | char[80] g_TempTextureName
    MOV ESI,0x61ae9c                    ; 0045a4fd | = "\tTEXTURE\t'%s'\n" | s_TEXTURE_s_0061ae9c = 	TEXTURE	'%s'

    PUSH ESI                            ; 0045a502 | = "\tTEXTURE\t'%s'\n" | s_TEXTURE_s_0061ae9c = 	TEXTURE	'%s'

    MOV ESI,dword ptr [EBP + 0x18]      ; 0045a503
    PUSH ESI                            ; 0045a506
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0045a507 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    MOV EAX,0x61aeab                    ; 0045a52c | = "\tFACET%dTMAP\t%d,%d,%d,%d" | s_FACET_dTMAP_d_d_d_d_0061aeab = 	FACET%dTMAP	%d,%d,%d,%d
    PUSH EAX                            ; 0045a531 | = "\tFACET%dTMAP\t%d,%d,%d,%d" | s_FACET_dTMAP_d_d_d_d_0061aeab = 	FACET%dTMAP	%d,%d,%d,%d
    MOV EAX,dword ptr [EBP + 0x18]      ; 0045a532
    PUSH EAX                            ; 0045a535
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0045a536 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x1c                        ; 0045a53b
    MOV dword ptr [EBP + -0x4],0x0      ; 0045a53e
    JMP 0x0045a54d                      ; 0045a545 | LAB_0045a54d
    ...
    JGE 0x0045a5e9                      ; 0045a55d | LAB_0045a5e9
    ...
    MOV EAX,0x61aec4                    ; 0045a578 | = ",%d" | s_d_0061aec4 = ,%d
    PUSH EAX                            ; 0045a57d | = ",%d" | s_d_0061aec4 = ,%d
    MOV EAX,dword ptr [EBP + 0x18]      ; 0045a57e
    PUSH EAX                            ; 0045a581
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0045a582 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    MOV EAX,0x61aec8                    ; 0045a5a5 | = ",%f" | s_f_0061aec8 = ,%f
    PUSH EAX                            ; 0045a5aa | = ",%f" | s_f_0061aec8 = ,%f
    MOV EAX,dword ptr [EBP + 0x18]      ; 0045a5ab
    PUSH EAX                            ; 0045a5ae
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0045a5af | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    MOV EAX,0x61aecc                    ; 0045a5d2 | = ",%f" | s_f_0061aecc = ,%f
    PUSH EAX                            ; 0045a5d7 | = ",%f" | s_f_0061aecc = ,%f
    MOV EAX,dword ptr [EBP + 0x18]      ; 0045a5d8
    PUSH EAX                            ; 0045a5db
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0045a5dc | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0045a5e1
    JMP 0x0045a547                      ; 0045a5e4 | LAB_0045a547
    ...
    PUSH EAX                            ; 0045a5f2
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0045a5f3 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
