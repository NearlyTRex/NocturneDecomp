...
LAB_00462e72:
      ...
      dVar3 = shape_design_c_calculateVertexAngle_FUN_00462050
                        ((int)local_58[local_3c[6] - 2],(int)local_58[local_3c[6] - 1],
                         (int)local_58[0]);
      ...
      if ((int)local_3c[3] < 4) {
        ...
        dVar3 = shape_design_c_calculateVertexAngle_FUN_00462050
                          ((int)local_58[0],(int)local_58[1],(int)local_58[2]);
        if (170 < dVar3) {
        ...
        for (local_3c[4] = polygon2_index; (int)local_3c[4] < g_PolygonCount + -1;
            local_3c[4] = local_3c[4] + 1) {
          g_ModelPolygonData[local_3c[4]] = g_ModelPolygonData[local_3c[4] + 1];
        }
