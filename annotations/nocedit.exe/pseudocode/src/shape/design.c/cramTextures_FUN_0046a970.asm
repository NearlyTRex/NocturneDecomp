...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_design.c_cramTextures_FUN_0046a970(char * texture_filename, int min_u, int min_v, int max_u, int max_v)
;
; Parameters:
...
section .text
    ...
    CMP AL,0x0                          ; 0046a98a
    JZ 0x0046a99e                       ; 0046a98c | LAB_0046a99e
    ...
    CMP AL,0x0                          ; 0046a99a
    JNZ 0x0046a986                      ; 0046a99c | LAB_0046a986
    ...
    MOV AL,byte ptr [ESI]               ; 0046a9aa
        ;   Label: LAB_0046a9aa
    CMP AL,DL                           ; 0046a9ac
    JZ 0x0046a9c2                       ; 0046a9ae | LAB_0046a9c2
        ;   XREF to: 0046a9c2 (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 0046a9b0
    JZ 0x0046a9c0                       ; 0046a9b2 | LAB_0046a9c0
        ;   XREF to: 0046a9c0 (CONDITIONAL_JUMP)
    INC ESI                             ; 0046a9b4
    MOV AL,byte ptr [ESI]               ; 0046a9b5
    CMP AL,DL                           ; 0046a9b7
    JZ 0x0046a9c2                       ; 0046a9b9 | LAB_0046a9c2
        ;   XREF to: 0046a9c2 (CONDITIONAL_JUMP)
    INC ESI                             ; 0046a9bb
    CMP AL,0x0                          ; 0046a9bc
    JNZ 0x0046a9aa                      ; 0046a9be | LAB_0046a9aa
    ...
    JNZ 0x0046a9ee                      ; 0046a9c9 | LAB_0046a9ee
    ...
    MOV EAX,dword ptr [EBP + -0x4]      ; 0046aa1f
        ;   Label: LAB_0046aa1f
    CMP EAX,dword ptr [0x01e8d260]      ; 0046aa22 | int g_TextureProcessedCount
    JGE 0x0046aae6                      ; 0046aa28 | LAB_0046aae6
        ;   XREF to: 0046aae6 (CONDITIONAL_JUMP)
    LEA EAX,[EBP + 0xfffffef4]          ; 0046aa2e
    PUSH EAX                            ; 0046aa34
    IMUL EAX,dword ptr [EBP + -0x4],0x250 ; 0046aa35
    MOV EDX,0x1e8d264                   ; 0046aa3c | STextureAtlasEntry[250] g_TextureAtlasEntries
    ADD EAX,EDX                         ; 0046aa41
    PUSH EAX                            ; 0046aa43
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 0046aa44 | int crt_string.c_stricmp_FUN_005fe7f0(char * str1, char * str2)
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0046aa49
    TEST EAX,EAX                        ; 0046aa4c
    JNZ 0x0046aae1                      ; 0046aa4e | LAB_0046aae1
    ...
    JGE 0x0046aa76                      ; 0046aa64 | LAB_0046aa76
    ...
    JLE 0x0046aa98                      ; 0046aa86 | LAB_0046aa98
    ...
    JGE 0x0046aaba                      ; 0046aaa8 | LAB_0046aaba
    ...
    JLE 0x0046aadc                      ; 0046aaca | LAB_0046aadc
    ...
    JMP 0x0046abe6                      ; 0046aadc | LAB_0046abe6
        ;   Label: LAB_0046aadc
        ;   XREF to: 0046abe6 (UNCONDITIONAL_JUMP)
    JMP 0x0046aa19                      ; 0046aae1 | LAB_0046aa19
        ;   Label: LAB_0046aae1
        ;   XREF to: 0046aa19 (UNCONDITIONAL_JUMP)
    CMP dword ptr [0x01e8d260],0xfa     ; 0046aae6 | int g_TextureProcessedCount
        ;   Label: LAB_0046aae6
    JL 0x0046ab2f                       ; 0046aaf0 | LAB_0046ab2f
        ;   XREF to: 0046ab2f (CONDITIONAL_JUMP)
    PUSH 0xfa                           ; 0046aaf2
    MOV EAX,0x61d258                    ; 0046aaf7 | = "Too many textures to cram, max is %d" | s_Too_many_textures_to_cra_0061d258 = Too many textures to cram, max is %d
    PUSH EAX                            ; 0046aafc | = "Too many textures to cram, max is %d" | s_Too_many_textures_to_cra_0061d258 = Too many textures to cram, max is %d
    LEA EAX,[EBP + 0xfffffe2c]          ; 0046aafd
    PUSH EAX                            ; 0046ab03
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0046ab04 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0046ab09
    MOV dword ptr [0x02f0ca48],0x61d27d ; 0046ab0c | char * g_CurrentFilename | = "..\\shape\\design.c" | s_shape_design_c_0061d27d = ..\shape\design.c
    MOV dword ptr [0x02f0ca4c],0x26f8   ; 0046ab16 | int g_CurrentLineNumber
    LEA EAX,[EBP + 0xfffffe2c]          ; 0046ab20
    PUSH EAX                            ; 0046ab26
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0046ab27 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0046ab2c
    LEA ESI,[EBP + 0xfffffef4]          ; 0046ab2f
        ;   Label: LAB_0046ab2f
    IMUL EDI,dword ptr [0x01e8d260],0x250 ; 0046ab35 | int g_TextureProcessedCount
    MOV EAX,0x1e8d264                   ; 0046ab3f | STextureAtlasEntry[250] g_TextureAtlasEntries
    ADD EDI,EAX                         ; 0046ab44
    PUSH EDI                            ; 0046ab46
    MOV AL,byte ptr [ESI]               ; 0046ab47
        ;   Label: LAB_0046ab47
    MOV byte ptr [EDI],AL               ; 0046ab49 | STextureAtlasEntry[250] g_TextureAtlasEntries
    CMP AL,0x0                          ; 0046ab4b
    JZ 0x0046ab5f                       ; 0046ab4d | LAB_0046ab5f
        ;   XREF to: 0046ab5f (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0046ab4f
    ADD ESI,0x2                         ; 0046ab52
    MOV byte ptr [EDI + 0x1],AL         ; 0046ab55 | DAT_01e8d265
    ADD EDI,0x2                         ; 0046ab58
    CMP AL,0x0                          ; 0046ab5b
    JNZ 0x0046ab47                      ; 0046ab5d | LAB_0046ab47
        ;   XREF to: 0046ab47 (CONDITIONAL_JUMP)
    POP EDI                             ; 0046ab5f
        ;   Label: LAB_0046ab5f
    MOV ESI,dword ptr [EBP + 0x14]      ; 0046ab60
    IMUL EAX,dword ptr [0x01e8d260],0x250 ; 0046ab63 | int g_TextureProcessedCount
    MOV EDI,0x1e8d264                   ; 0046ab6d | STextureAtlasEntry[250] g_TextureAtlasEntries
    ADD EAX,EDI                         ; 0046ab72
    LEA EDI,[EAX + 0x100]               ; 0046ab74
    PUSH EDI                            ; 0046ab7a
    MOV AL,byte ptr [ESI]               ; 0046ab7b
        ;   Label: LAB_0046ab7b
    MOV byte ptr [EDI],AL               ; 0046ab7d | DAT_01e8d364
    CMP AL,0x0                          ; 0046ab7f
    JZ 0x0046ab93                       ; 0046ab81 | LAB_0046ab93
        ;   XREF to: 0046ab93 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0046ab83
    ADD ESI,0x2                         ; 0046ab86
    MOV byte ptr [EDI + 0x1],AL         ; 0046ab89 | DAT_01e8d365
    ADD EDI,0x2                         ; 0046ab8c
    CMP AL,0x0                          ; 0046ab8f
    JNZ 0x0046ab7b                      ; 0046ab91 | LAB_0046ab7b
        ;   XREF to: 0046ab7b (CONDITIONAL_JUMP)
    POP EDI                             ; 0046ab93
        ;   Label: LAB_0046ab93
    IMUL ESI,dword ptr [0x01e8d260],0x250 ; 0046ab94 | int g_TextureProcessedCount
    MOV EAX,dword ptr [EBP + 0x18]      ; 0046ab9e
    MOV dword ptr [ESI + 0x1e8d4a4],EAX ; 0046aba1 | DAT_01e8d4a4
    IMUL ESI,dword ptr [0x01e8d260],0x250 ; 0046aba7 | int g_TextureProcessedCount
    MOV EAX,dword ptr [EBP + 0x1c]      ; 0046abb1
    MOV dword ptr [ESI + 0x1e8d4a8],EAX ; 0046abb4 | DAT_01e8d4a8
    IMUL ESI,dword ptr [0x01e8d260],0x250 ; 0046abba | int g_TextureProcessedCount
    MOV EAX,dword ptr [EBP + 0x20]      ; 0046abc4
    MOV dword ptr [ESI + 0x1e8d4ac],EAX ; 0046abc7 | DAT_01e8d4ac
    IMUL ESI,dword ptr [0x01e8d260],0x250 ; 0046abcd | int g_TextureProcessedCount
    MOV EAX,dword ptr [EBP + 0x24]      ; 0046abd7
    MOV dword ptr [ESI + 0x1e8d4b0],EAX ; 0046abda | DAT_01e8d4b0
    INC dword ptr [0x01e8d260]          ; 0046abe0 | int g_TextureProcessedCount
