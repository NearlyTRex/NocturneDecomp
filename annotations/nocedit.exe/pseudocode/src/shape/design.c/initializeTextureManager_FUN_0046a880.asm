...
;   core_skeledit.cpp_CDeformableModel_buildFromPosFile_FUN_0058c190 at 0058cb84
;   core_skeledit.cpp_CDeformableModel_cramModelTexture_FUN_0058de70 at 0058de86
