...
section .text
    ...
    JMP 0x004671fb                      ; 004671f3 | LAB_004671fb
    ...
    MOV EAX,dword ptr [EBP + -0xc]      ; 004671fb
        ;   Label: LAB_004671fb
    CMP EAX,dword ptr [0x016e990c]      ; 004671fe | int g_PolygonCount
    JGE 0x00467327                      ; 00467204 | LAB_00467327
    ...
    JMP 0x00467229                      ; 00467221 | LAB_00467229
    ...
    JLE 0x00467322                      ; 00467239 | LAB_00467322
    ...
    MOV EAX,0x16e9910                   ; 00467253 | SShapeEditorPolygon[20000] g_ModelPolygonData
    ...
    MOV EAX,0x16e9910                   ; 0046726c | SShapeEditorPolygon[20000] g_ModelPolygonData
    ...
    PUSH EAX                            ; 00467280
    CALL shape_design.c_swapDWords_FUN_00462130 ; 00467281 | void shape_design.c_swapDWords_FUN_00462130(uint * value1_ptr, uint * value2_ptr)
    ...
    MOV EDX,0x16e9910                   ; 0046729d | SShapeEditorPolygon[20000] g_ModelPolygonData
    ...
    MOV EDX,0x16e9910                   ; 004672b6 | SShapeEditorPolygon[20000] g_ModelPolygonData
    ...
    PUSH EAX                            ; 004672ca
    CALL shape_design.c_swapFloats_FUN_00462160 ; 004672cb | void shape_design.c_swapFloats_FUN_00462160(float * value1_ptr, float * value2_ptr)
    ...
    MOV EDX,0x16e9910                   ; 004672e7 | SShapeEditorPolygon[20000] g_ModelPolygonData
    ...
    MOV EDX,0x16e9910                   ; 00467300 | SShapeEditorPolygon[20000] g_ModelPolygonData
    ...
    PUSH EAX                            ; 00467314
    CALL shape_design.c_swapFloats_FUN_00462160 ; 00467315 | void shape_design.c_swapFloats_FUN_00462160(float * value1_ptr, float * value2_ptr)
        ;   XREF to: 00462160 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0046731a
    JMP 0x00467223                      ; 0046731d | LAB_00467223
        ;   XREF to: 00467223 (UNCONDITIONAL_JUMP)
    JMP 0x004671f5                      ; 00467322 | LAB_004671f5
        ;   Label: LAB_00467322
        ;   XREF to: 004671f5 (UNCONDITIONAL_JUMP)
    CALL wincore_windll.cpp_clearScreen_FUN_005b3e70 ; 00467327 | void wincore_windll.cpp_clearScreen_FUN_005b3e70()
        ;   Label: LAB_00467327
        ;   XREF to: 005b3e70 (UNCONDITIONAL_CALL)
    PUSH 0x0                            ; 0046732c
    PUSH 0x0                            ; 0046732e
    MOV EAX,0x61c93c                    ; 00467330 | = "Model turned inside out.  Hit a key..." | s_Model_turned_inside_out__0061c93c = Model turned inside out.  Hit a key...
    PUSH EAX                            ; 00467335 | = "Model turned inside out.  Hit a key..." | s_Model_turned_inside_out__0061c93c = Model turned inside out.  Hit a key...
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 00467336 | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0046733b
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 0046733e | void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20()
        ;   XREF to: 005eda20 (UNCONDITIONAL_CALL)
    CALL wincore_winrun.cpp_getNextKeypress_FUN_005f2e90 ; 00467343 | int wincore_winrun.cpp_getNextKeypress_FUN_005f2e90()
