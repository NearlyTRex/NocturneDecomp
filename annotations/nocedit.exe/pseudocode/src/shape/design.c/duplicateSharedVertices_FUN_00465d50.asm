...
section .text
    ...
    JMP 0x00465d6b                      ; 00465d63 | LAB_00465d6b
    ...
    JGE 0x00465e88                      ; 00465d7b | LAB_00465e88
    ...
    MOV dword ptr [EBP + -0x18],0x16e9910 ; 00465da0 | SShapeEditorPolygon[20000] g_ModelPolygonData
    MOV dword ptr [EBP + -0x10],0x0     ; 00465da7
    JMP 0x00465dc0                      ; 00465dae | LAB_00465dc0
    ...
    JGE 0x00465e11                      ; 00465dee | LAB_00465e11
        ;   XREF to: 00465e11 (CONDITIONAL_JUMP)
    ...
    JNZ 0x00465e0f                      ; 00465e04 | LAB_00465e0f
        ;   XREF to: 00465e0f (CONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x4],0x1      ; 00465e06
    JMP 0x00465e13                      ; 00465e0d | LAB_00465e13
        ;   XREF to: 00465e13 (UNCONDITIONAL_JUMP)
    JMP 0x00465ddc                      ; 00465e0f | LAB_00465ddc
        ;   Label: LAB_00465e0f
        ;   XREF to: 00465ddc (UNCONDITIONAL_JUMP)
    JMP 0x00465db0                      ; 00465e11 | LAB_00465db0
        ;   Label: LAB_00465e11
        ;   XREF to: 00465db0 (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0x4],0x0      ; 00465e13
        ;   Label: LAB_00465e13
    JZ 0x00465e83                       ; 00465e17 | LAB_00465e83
        ;   XREF to: 00465e83 (CONDITIONAL_JUMP)
    CMP dword ptr [0x01626408],0x4e20   ; 00465e19 | int g_VertexCount
    JL 0x00465e47                       ; 00465e23 | LAB_00465e47
        ;   XREF to: 00465e47 (CONDITIONAL_JUMP)
    MOV dword ptr [0x02f0ca48],0x61c666 ; 00465e25 | char * g_CurrentFilename | = "..\\shape\\design.c" | s_shape_design_c_0061c666 = ..\shape\design.c
    MOV dword ptr [0x02f0ca4c],0x1d5a   ; 00465e2f | int g_CurrentLineNumber
    MOV EAX,0x61c678                    ; 00465e39 | = "Cannot add any more points!" | s_Cannot_add_any_more_poin_0061c678 = Cannot add any more points!
    PUSH EAX                            ; 00465e3e | = "Cannot add any more points!" | s_Cannot_add_any_more_poin_0061c678 = Cannot add any more points!
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00465e3f | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00465e44
    IMUL ESI,dword ptr [EBP + -0x8],0x14 ; 00465e47
        ;   Label: LAB_00465e47
    IMUL EDI,dword ptr [0x01626408],0x14 ; 00465e4b | int g_VertexCount
    LEA EDI,[EDI + 0x162640c]           ; 00465e52 | SVertexData[20000] g_LoadedVertices
    LEA ESI,[ESI + 0x162640c]           ; 00465e58 | SVertexData[20000] g_LoadedVertices
    MOVSD ES:EDI,ESI                    ; 00465e5e | SVertexData[20000] g_LoadedVertices
    ...
    MOV EAX,[0x01626408]                ; 00465e72 | int g_VertexCount
    MOV dword ptr [ESI + 0x16e99c8],EAX ; 00465e77 | DAT_016e99c8
    INC dword ptr [0x01626408]          ; 00465e7d | int g_VertexCount
    JMP 0x00465d65                      ; 00465e83 | LAB_00465d65
        ;   Label: LAB_00465e83
