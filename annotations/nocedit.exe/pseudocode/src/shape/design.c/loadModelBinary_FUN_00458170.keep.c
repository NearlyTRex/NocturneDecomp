...

{
  ...
  if (local_38 == (_FILE *)0x0) {
    ...
    _sprintf(local_160,"loadBinary: Unable to read binary file: (%s)",filename);
      ...
      if (local_18 < 0x14) {
        if (local_18 < 6) {
          if (local_18 < 3) {
            ...
            g_VertexCount = local_6c[2];
            for (local_2c = 0; local_2c < local_6c[2]; local_2c = local_2c + 1) {
              _fread(local_78,1,0xc,local_38);
              g_LoadedVertices[local_2c].vertex.x =
                   ((float)local_78[0] * (float)0.00390625) / local_20;
              g_LoadedVertices[local_2c].vertex.y =
                   ((float)local_78[1] * (float)0.00390625) / local_20;
              g_LoadedVertices[local_2c].vertex.z =
                   ((float)local_78[2] * (float)0.00390625) / local_20;
            }
...
LAB_00458378:
          ...
          g_ModelPolygonData[g_PolygonCount].vertex_indices_count = local_a8[1];
          shape_design_c_calculatePolygonNormal_FUN_0045caa0(g_ModelPolygonData + g_PolygonCount);
          strcpy(g_ModelPolygonData[g_PolygonCount].texture_name,g_TempTextureName);
          g_ModelPolygonData[g_PolygonCount].material_id = local_24;
          _fread(g_ModelPolygonData[g_PolygonCount].vertex_indices,local_a8[1],4,local_38);
          for (local_2c = 0; local_2c < (int)g_ModelPolygonData[g_PolygonCount].vertex_indices_count
            ...
            g_ModelPolygonData[g_PolygonCount].vertex_indices[0] =
                 g_ModelPolygonData[g_PolygonCount].vertex_indices[0] - local_6c[1];
          }
          ...
          strcpy(g_TempTextureName,local_90 + 8);
        }
      }
      else if (local_18 < 0x15) {
        _fread(local_48,1,8,local_38);
        local_20 = (float)local_48[1] * (float)1.52587890625e-05;
      }
      else {
        if (local_18 < 0x1b) {
          if (local_18 < 0x18) {
...
LAB_004584f3:
        ...
        strcpy(g_ModelPolygonData[g_PolygonCount].texture_name,g_TempTextureName);
        g_ModelPolygonData[g_PolygonCount].material_id = local_24;
        for (local_28 = 0; local_28 < (int)local_a8[1]; local_28 = local_28 + 1) {
          _fread(&g_ModelPolygonData[g_PolygonCount].vertex_indices[local_28],1,4,local_38);
          g_ModelPolygonData[g_PolygonCount].vertex_indices[local_28] =
               g_ModelPolygonData[g_PolygonCount].vertex_indices[local_28] - local_6c[1];
