...
section .text
    ...
    JMP 0x0046e6cb                      ; 0046e6c3 | LAB_0046e6cb
    ...
    MOV EAX,dword ptr [EBP + -0x4]      ; 0046e6cb
        ;   Label: LAB_0046e6cb
    CMP EAX,dword ptr [0x016e990c]      ; 0046e6ce | int g_PolygonCount
    JGE 0x0046e6e6                      ; 0046e6d4 | LAB_0046e6e6
    ...
    JMP 0x0046e6c5                      ; 0046e6e4 | LAB_0046e6c5
