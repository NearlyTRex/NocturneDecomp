...
;
; Local Variables:
; char[80]         Stack[-0xc4]:80  local_c4
; int[2]           Stack[-0x74]:8  local_74
; undefined1[4]    Stack[-0x6c]:4  local_6c
; undefined1[4]    Stack[-0x68]:4  local_68
; undefined1[4]    Stack[-0x64]:4  local_64
; undefined1[4]    Stack[-0x60]:4  local_60
; undefined1[4]    Stack[-0x5c]:4  local_5c
; undefined1[4]    Stack[-0x58]:4  local_58
...
;
; XREF[1]:
;   shape_design.c_showFacetPartEditor_FUN_0045f1d0 at 00460820
;
; Referenced Globals:
...
section .text
    ...
    CALL shape_design.c_createReversedQuadPolygon_FUN_0045e040 ; 0045e471
        ;   XREF to: 0045e040 (UNCONDITIONAL_CALL)  ; void shape_design.c_createReversedQuadPolygon_FUN_0045e040(uint vertex0, uint vertex1, uint vertex2, uint vertex3)
