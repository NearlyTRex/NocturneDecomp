...
;                               FUNCTION
; *****************************************************************************
; unknown undefined shape_design.c_centerVerticesAroundPoint_FUN_0045ea90()
;
; Local Variables:
...
section .text
    ...
    CALL wincore_windll.cpp_clearScreen_FUN_005b3e70 ; 0045ea9c | void wincore_windll.cpp_clearScreen_FUN_005b3e70()
        ;   XREF to: 005b3e70 (UNCONDITIONAL_CALL)
    MOV ECX,0x61b5be                    ; 0045eaa1 | = "Bias around what point? (or -1 for us..." | s_Bias_around_what_point_o_0061b5be = Bias around what point? (or -1 for user-defined) :
    PUSH ECX                            ; 0045eaa6 | = "Bias around what point? (or -1 for us..." | s_Bias_around_what_point_o_0061b5be = Bias around what point? (or -1 for user-defined) :
    PUSH 0x0                            ; 0045eaa7
    PUSH 0x0                            ; 0045eaa9
    PUSH 0xa                            ; 0045eaab
    LEA ECX,[EBP + -0x44]               ; 0045eaad
    PUSH ECX                            ; 0045eab0
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 0045eab1 | int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
    ...
    JNZ 0x0045eacf                      ; 0045eac8 | LAB_0045eacf
        ;   XREF to: 0045eacf (CONDITIONAL_JUMP)
    JMP 0x0045ec87                      ; 0045eaca | LAB_0045ec87
        ;   XREF to: 0045ec87 (UNCONDITIONAL_JUMP)
    LEA EAX,[EBP + -0x44]               ; 0045eacf
        ;   Label: LAB_0045eacf
    PUSH EAX                            ; 0045ead2
    CALL crt_stdlib.c_atoi_FUN_005ffef0 ; 0045ead3 | int crt_stdlib.c_atoi_FUN_005ffef0(char * string_ptr)
    ...
    JL 0x0045eaef                       ; 0045eae2 | LAB_0045eaef
        ;   XREF to: 0045eaef (CONDITIONAL_JUMP)
    MOV EAX,[0x01626408]                ; 0045eae4 | int g_VertexCount
    DEC EAX                             ; 0045eae9
    CMP EAX,dword ptr [EBP + -0x1c]     ; 0045eaea
    JGE 0x0045eb10                      ; 0045eaed | LAB_0045eb10
        ;   XREF to: 0045eb10 (CONDITIONAL_JUMP)
    PUSH 0x16                           ; 0045eaef
        ;   Label: LAB_0045eaef
    PUSH 0x0                            ; 0045eaf1
    MOV EAX,0x61b5f2                    ; 0045eaf3 | = "Invalid point." | s_Invalid_point_0061b5f2 = Invalid point.
    PUSH EAX                            ; 0045eaf8 | = "Invalid point." | s_Invalid_point_0061b5f2 = Invalid point.
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 0045eaf9 | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0045eafe
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 0045eb01 | void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20()
        ;   XREF to: 005eda20 (UNCONDITIONAL_CALL)
    CALL wincore_winrun.cpp_getNextKeypress_FUN_005f2e90 ; 0045eb06 | int wincore_winrun.cpp_getNextKeypress_FUN_005f2e90()
        ;   XREF to: 005f2e90 (UNCONDITIONAL_CALL)
    JMP 0x0045ec87                      ; 0045eb0b | LAB_0045ec87
        ;   XREF to: 0045ec87 (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0x1c],-0x1    ; 0045eb10
        ;   Label: LAB_0045eb10
    JNZ 0x0045eb70                      ; 0045eb14 | LAB_0045eb70
        ;   XREF to: 0045eb70 (CONDITIONAL_JUMP)
    MOV ECX,0x61b601                    ; 0045eb16 | = "Enter point : " | s_Enter_point_0061b601 = Enter point :
    PUSH ECX                            ; 0045eb1b | = "Enter point : " | s_Enter_point_0061b601 = Enter point :
    PUSH 0xb                            ; 0045eb1c
    PUSH 0x0                            ; 0045eb1e
    PUSH 0x32                           ; 0045eb20
    LEA ECX,[EBP + -0x44]               ; 0045eb22
    PUSH ECX                            ; 0045eb25
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 0045eb26 | int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
        ;   XREF to: 004032c0 (UNCONDITIONAL_CALL)
    ...
    JNZ 0x0045eb44                      ; 0045eb3d | LAB_0045eb44
        ;   XREF to: 0045eb44 (CONDITIONAL_JUMP)
    JMP 0x0045ec87                      ; 0045eb3f | LAB_0045ec87
        ;   XREF to: 0045ec87 (UNCONDITIONAL_JUMP)
    LEA EAX,[EBP + -0x44]               ; 0045eb44
        ;   Label: LAB_0045eb44
    PUSH EAX                            ; 0045eb47
    CALL crt_string.c_strtod_FUN_005ff0f3 ; 0045eb48 | double crt_string.c_strtod_FUN_005ff0f3(char * str)
    ...
    JMP 0x0045eb97                      ; 0045eb6e | LAB_0045eb97
        ;   XREF to: 0045eb97 (UNCONDITIONAL_JUMP)
    IMUL EAX,dword ptr [EBP + -0x1c],0x14 ; 0045eb70
        ;   Label: LAB_0045eb70
    MOV EAX,dword ptr [EAX + 0x162640c] ; 0045eb74 | SVertexData[20000] g_LoadedVertices
    ...
    PUSH 0x16                           ; 0045eb97
        ;   Label: LAB_0045eb97
    PUSH 0x0                            ; 0045eb99
    MOV EAX,0x61b610                    ; 0045eb9b | = "Which axis to use - X, Y, or Z? : " | s_Which_axis_to_use_X_Y_or_0061b610 = Which axis to use - X, Y, or Z? :
    PUSH EAX                            ; 0045eba0 | = "Which axis to use - X, Y, or Z? : " | s_Which_axis_to_use_X_Y_or_0061b610 = Which axis to use - X, Y, or Z? :
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 0045eba1 | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0045eba6
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 0045eba9 | void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20()
        ;   XREF to: 005eda20 (UNCONDITIONAL_CALL)
    CALL wincore_winrun.cpp_getNextKeypress_FUN_005f2e90 ; 0045ebae | int wincore_winrun.cpp_getNextKeypress_FUN_005f2e90()
        ;   XREF to: 005f2e90 (UNCONDITIONAL_CALL)
    AND EAX,0xff                        ; 0045ebb3
    PUSH EAX                            ; 0045ebb8
    CALL crt_ctype.c_toupper_FUN_005ff9e0 ; 0045ebb9 | int crt_ctype.c_toupper_FUN_005ff9e0(int c)
    ...
    JMP 0x0045ec67                      ; 0045ebca | LAB_0045ec67
        ;   XREF to: 0045ec67 (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x4],0x0      ; 0045ebcf
        ;   Label: LAB_0045ebcf
    JMP 0x0045ebde                      ; 0045ebd6 | LAB_0045ebde
    ...
    MOV EAX,dword ptr [EBP + -0x4]      ; 0045ebde
        ;   Label: LAB_0045ebde
    CMP EAX,dword ptr [0x01626408]      ; 0045ebe1 | int g_VertexCount
    JGE 0x0045ebfe                      ; 0045ebe7 | LAB_0045ebfe
        ;   XREF to: 0045ebfe (CONDITIONAL_JUMP)
    IMUL EAX,dword ptr [EBP + -0x4],0x14 ; 0045ebe9
    FLD float ptr [EAX + 0x162640c]     ; 0045ebed | SVertexData[20000] g_LoadedVertices
    FSUB float ptr [EBP + -0x18]        ; 0045ebf3
    FSTP float ptr [EAX + 0x162640c]    ; 0045ebf6 | SVertexData[20000] g_LoadedVertices
    JMP 0x0045ebd8                      ; 0045ebfc | LAB_0045ebd8
        ;   XREF to: 0045ebd8 (UNCONDITIONAL_JUMP)
    JMP 0x0045ec87                      ; 0045ebfe | LAB_0045ec87
        ;   Label: LAB_0045ebfe
        ;   XREF to: 0045ec87 (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x4],0x0      ; 0045ec03
        ;   Label: LAB_0045ec03
    JMP 0x0045ec12                      ; 0045ec0a | LAB_0045ec12
    ...
    MOV EAX,dword ptr [EBP + -0x4]      ; 0045ec12
        ;   Label: LAB_0045ec12
    CMP EAX,dword ptr [0x01626408]      ; 0045ec15 | int g_VertexCount
    JGE 0x0045ec32                      ; 0045ec1b | LAB_0045ec32
    ...
    JMP 0x0045ec0c                      ; 0045ec30 | LAB_0045ec0c
        ;   XREF to: 0045ec0c (UNCONDITIONAL_JUMP)
    JMP 0x0045ec87                      ; 0045ec32 | LAB_0045ec87
        ;   Label: LAB_0045ec32
        ;   XREF to: 0045ec87 (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x4],0x0      ; 0045ec34
        ;   Label: LAB_0045ec34
    JMP 0x0045ec43                      ; 0045ec3b | LAB_0045ec43
    ...
    MOV EAX,dword ptr [EBP + -0x4]      ; 0045ec43
        ;   Label: LAB_0045ec43
    CMP EAX,dword ptr [0x01626408]      ; 0045ec46 | int g_VertexCount
    JGE 0x0045ec63                      ; 0045ec4c | LAB_0045ec63
