...
section .text
    ...
    JMP 0x00463a42                      ; 00463a3a | LAB_00463a42
    ...
    LEA EDI,[ESI + 0x16e9910]           ; 00463b01 | SShapeEditorPolygon[20000] g_ModelPolygonData
    LEA ESI,[EAX + 0x16e9910]           ; 00463b07 | SShapeEditorPolygon[20000] g_ModelPolygonData
    MOVSD.REP ES:EDI,ESI                ; 00463b0d | SShapeEditorPolygon[20000] g_ModelPolygonData
    JMP 0x00463ada                      ; 00463b0f | LAB_00463ada
        ;   XREF to: 00463ada (UNCONDITIONAL_JUMP)
    DEC dword ptr [0x016e990c]          ; 00463b11 | int g_PolygonCount
        ;   Label: LAB_00463b11
    CMP dword ptr [0x016e990c],0x0      ; 00463b17 | int g_PolygonCount
    JLE 0x00463b25                      ; 00463b1e | LAB_00463b25
        ;   XREF to: 00463b25 (CONDITIONAL_JUMP)
    JMP 0x00463a2c                      ; 00463b20 | LAB_00463a2c
