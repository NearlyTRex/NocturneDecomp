...
section .text
    ...
    MOV EAX,[0x016e990c]                ; 0046ed5c | int g_PolygonCount
    MOV dword ptr [EBP + -0x4],EAX      ; 0046ed61
    MOV dword ptr [EBP + -0x8],0x0      ; 0046ed64
    JMP 0x0046ed73                      ; 0046ed6b | LAB_0046ed73
    ...
    JGE 0x0046f285                      ; 0046ed79 | LAB_0046f285
        ;   XREF to: 0046f285 (CONDITIONAL_JUMP)
    IMUL EAX,dword ptr [EBP + -0x8],0x184 ; 0046ed7f
    MOV EDX,0x16e9910                   ; 0046ed86 | SShapeEditorPolygon[20000] g_ModelPolygonData
    ...
    JZ 0x0046edbe                       ; 0046ed9a | LAB_0046edbe
        ;   XREF to: 0046edbe (CONDITIONAL_JUMP)
    MOV dword ptr [0x02f0ca48],0x61e0b2 ; 0046ed9c | char * g_CurrentFilename | = "..\\shape\\design.c" | s_shape_design_c_0061e0b2 = ..\shape\design.c
    MOV dword ptr [0x02f0ca4c],0x2dac   ; 0046eda6 | int g_CurrentLineNumber
    MOV EAX,0x61e0c4                    ; 0046edb0 | = "Not 3 faces" | s_Not_3_faces_0061e0c4 = Not 3 faces
    PUSH EAX                            ; 0046edb5 | = "Not 3 faces" | s_Not_3_faces_0061e0c4 = Not 3 faces
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0046edb6 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0046edbb
    IMUL EAX,dword ptr [0x016e990c],0x184 ; 0046edbe | int g_PolygonCount
        ;   Label: LAB_0046edbe
    MOV EDX,0x16e9910                   ; 0046edc8 | SShapeEditorPolygon[20000] g_ModelPolygonData
    ...
    FLD float ptr [EDX + 0x162640c]     ; 0046edfe | SVertexData[20000] g_LoadedVertices
    FSUB float ptr [EAX + 0x162640c]    ; 0046ee04 | SVertexData[20000] g_LoadedVertices
    ...
    FLD float ptr [EAX + 0x162640c]     ; 0046ee43 | SVertexData[20000] g_LoadedVertices
    FSUB float ptr [EDX + 0x162640c]    ; 0046ee49 | SVertexData[20000] g_LoadedVertices
    ...
    FLD float ptr [EDX + 0x162640c]     ; 0046ee88 | SVertexData[20000] g_LoadedVertices
    FSUB float ptr [EAX + 0x162640c]    ; 0046ee8e | SVertexData[20000] g_LoadedVertices
    ...
    FNSTSW AX                           ; 0046ef1c
    SAHF                                ; 0046ef1e
    JBE 0x0046ef2c                      ; 0046ef1f | LAB_0046ef2c
        ;   XREF to: 0046ef2c (CONDITIONAL_JUMP)
    FLD float ptr [EBP + -0x14]         ; 0046ef21
    FCOMP float ptr [EBP + -0xc]        ; 0046ef24
    FNSTSW AX                           ; 0046ef27
    SAHF                                ; 0046ef29
    JA 0x0046ef31                       ; 0046ef2a | LAB_0046ef31
        ;   XREF to: 0046ef31 (CONDITIONAL_JUMP)
    JMP 0x0046f048                      ; 0046ef2c | LAB_0046f048
        ;   Label: LAB_0046ef2c
        ;   XREF to: 0046f048 (UNCONDITIONAL_JUMP)
    IMUL EDX,dword ptr [EBP + -0x44],0x14 ; 0046ef31
        ;   Label: LAB_0046ef31
    IMUL EAX,dword ptr [EBP + -0x40],0x14 ; 0046ef35
    FLD float ptr [EDX + 0x162640c]     ; 0046ef39 | SVertexData[20000] g_LoadedVertices
    FADD float ptr [EAX + 0x162640c]    ; 0046ef3f | SVertexData[20000] g_LoadedVertices
    FMUL double ptr [0x0061e0d6]        ; 0046ef45 | double DOUBLE_0061e0d6
    IMUL EAX,dword ptr [0x01626408],0x14 ; 0046ef4b | int g_VertexCount
    FSTP float ptr [EAX + 0x162640c]    ; 0046ef52 | SVertexData[20000] g_LoadedVertices
    ...
    FMUL double ptr [0x0061e0d6]        ; 0046ef6c | double DOUBLE_0061e0d6
    IMUL EAX,dword ptr [0x01626408],0x14 ; 0046ef72 | int g_VertexCount
    ...
    FMUL double ptr [0x0061e0d6]        ; 0046ef93 | double DOUBLE_0061e0d6
    IMUL EAX,dword ptr [0x01626408],0x14 ; 0046ef99 | int g_VertexCount
    ...
    FMUL double ptr [0x0061e0d6]        ; 0046efb8 | double DOUBLE_0061e0d6
    ...
    FMUL double ptr [0x0061e0d6]        ; 0046efd3 | double DOUBLE_0061e0d6
    ...
    MOVSD.REP ES:EDI,ESI                ; 0046efe7 | SShapeEditorPolygon[20000] g_ModelPolygonData
    MOV EDX,dword ptr [0x01626408]      ; 0046efe9 | int g_VertexCount
    ...
    MOV EDX,dword ptr [0x01626408]      ; 0046f010 | int g_VertexCount
    ...
    INC dword ptr [0x01626408]          ; 0046f037 | int g_VertexCount
    INC dword ptr [0x016e990c]          ; 0046f03d | int g_PolygonCount
    JMP 0x0046f280                      ; 0046f043 | LAB_0046f280
    ...
    FNSTSW AX                           ; 0046f04e
    SAHF                                ; 0046f050
    JBE 0x0046f16e                      ; 0046f051 | LAB_0046f16e
        ;   XREF to: 0046f16e (CONDITIONAL_JUMP)
    IMUL EDX,dword ptr [EBP + -0x40],0x14 ; 0046f057
    IMUL EAX,dword ptr [EBP + -0x3c],0x14 ; 0046f05b
    FLD float ptr [EDX + 0x162640c]     ; 0046f05f | SVertexData[20000] g_LoadedVertices
    FADD float ptr [EAX + 0x162640c]    ; 0046f065 | SVertexData[20000] g_LoadedVertices
    FMUL double ptr [0x0061e0de]        ; 0046f06b | double DOUBLE_0061e0de
    IMUL EAX,dword ptr [0x01626408],0x14 ; 0046f071 | int g_VertexCount
    FSTP float ptr [EAX + 0x162640c]    ; 0046f078 | SVertexData[20000] g_LoadedVertices
    ...
    FMUL double ptr [0x0061e0de]        ; 0046f092 | double DOUBLE_0061e0de
    IMUL EAX,dword ptr [0x01626408],0x14 ; 0046f098 | int g_VertexCount
    ...
    FMUL double ptr [0x0061e0de]        ; 0046f0b9 | double DOUBLE_0061e0de
    IMUL EAX,dword ptr [0x01626408],0x14 ; 0046f0bf | int g_VertexCount
    ...
    FMUL double ptr [0x0061e0de]        ; 0046f0de | double DOUBLE_0061e0de
    ...
    FMUL double ptr [0x0061e0de]        ; 0046f0f9 | double DOUBLE_0061e0de
    ...
    MOVSD.REP ES:EDI,ESI                ; 0046f10d | SShapeEditorPolygon[20000] g_ModelPolygonData
    MOV EDX,dword ptr [0x01626408]      ; 0046f10f | int g_VertexCount
    ...
    MOV EDX,dword ptr [0x01626408]      ; 0046f136 | int g_VertexCount
    ...
    INC dword ptr [0x01626408]          ; 0046f15d | int g_VertexCount
    INC dword ptr [0x016e990c]          ; 0046f163 | int g_PolygonCount
    JMP 0x0046f280                      ; 0046f169 | LAB_0046f280
        ;   XREF to: 0046f280 (UNCONDITIONAL_JUMP)
    IMUL EDX,dword ptr [EBP + -0x3c],0x14 ; 0046f16e
        ;   Label: LAB_0046f16e
    IMUL EAX,dword ptr [EBP + -0x44],0x14 ; 0046f172
    FLD float ptr [EDX + 0x162640c]     ; 0046f176 | SVertexData[20000] g_LoadedVertices
    FADD float ptr [EAX + 0x162640c]    ; 0046f17c | SVertexData[20000] g_LoadedVertices
    FMUL double ptr [0x0061e0e6]        ; 0046f182 | double DOUBLE_0061e0e6
    IMUL EAX,dword ptr [0x01626408],0x14 ; 0046f188 | int g_VertexCount
    FSTP float ptr [EAX + 0x162640c]    ; 0046f18f | SVertexData[20000] g_LoadedVertices
    ...
    FMUL double ptr [0x0061e0e6]        ; 0046f1a9 | double DOUBLE_0061e0e6
    IMUL EAX,dword ptr [0x01626408],0x14 ; 0046f1af | int g_VertexCount
    ...
    FMUL double ptr [0x0061e0e6]        ; 0046f1d0 | double DOUBLE_0061e0e6
    IMUL EAX,dword ptr [0x01626408],0x14 ; 0046f1d6 | int g_VertexCount
    ...
    FMUL double ptr [0x0061e0e6]        ; 0046f1f5 | double DOUBLE_0061e0e6
    ...
    FMUL double ptr [0x0061e0e6]        ; 0046f210 | double DOUBLE_0061e0e6
    ...
    MOVSD.REP ES:EDI,ESI                ; 0046f224 | SShapeEditorPolygon[20000] g_ModelPolygonData
    MOV EDX,dword ptr [0x01626408]      ; 0046f226 | int g_VertexCount
    ...
    MOV EDX,dword ptr [0x01626408]      ; 0046f24d | int g_VertexCount
    ...
    INC dword ptr [0x01626408]          ; 0046f274 | int g_VertexCount
    INC dword ptr [0x016e990c]          ; 0046f27a | int g_PolygonCount
    JMP 0x0046ed6d                      ; 0046f280 | LAB_0046ed6d
        ;   Label: LAB_0046f280
