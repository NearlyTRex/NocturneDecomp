...
section .text
    ...
    JMP 0x0045f09b                      ; 0045f093 | LAB_0045f09b
    ...
    MOV EAX,dword ptr [EBP + -0x8]      ; 0045f09b
        ;   Label: LAB_0045f09b
    CMP EAX,dword ptr [0x016e990c]      ; 0045f09e | int g_PolygonCount
    JGE 0x0045f1bd                      ; 0045f0a4 | LAB_0045f1bd
        ;   XREF to: 0045f1bd (CONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x4],0x0      ; 0045f0aa
    JMP 0x0045f0b9                      ; 0045f0b1 | LAB_0045f0b9
    ...
    JGE 0x0045f1b8                      ; 0045f0c9 | LAB_0045f1b8
    ...
    FMUL double ptr [0x0061b6de]        ; 0045f102 | double g_UVScaleFactorPrimary
    FMUL double ptr [0x0061b6e6]        ; 0045f108 | double g_UVScaleFactorSecondary
    FADD double ptr [0x0061b6ee]        ; 0045f10e | double g_UVOffsetBase
    FSTP float ptr [EBP + -0x10]        ; 0045f114
    FLD float ptr [EBP + -0xc]          ; 0045f117
    FMUL double ptr [0x0061b6de]        ; 0045f11a | double g_UVScaleFactorPrimary
    FMUL double ptr [0x0061b6e6]        ; 0045f120 | double g_UVScaleFactorSecondary
    FADD double ptr [0x0061b6ee]        ; 0045f126 | double g_UVOffsetBase
    FSTP float ptr [EBP + -0xc]         ; 0045f12c
    FLD float ptr [EBP + -0x10]         ; 0045f12f
    FCOMP double ptr [0x0061b6ee]       ; 0045f132 | double g_UVOffsetBase
    FNSTSW AX                           ; 0045f138
    SAHF                                ; 0045f13a
    JNC 0x0045f144                      ; 0045f13b | LAB_0045f144
        ;   XREF to: 0045f144 (CONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x10],0x40800000 ; 0045f13d
    FLD float ptr [EBP + -0x10]         ; 0045f144
        ;   Label: LAB_0045f144
    FCOMP double ptr [0x0061b6f6]       ; 0045f147 | double g_UVClampMinU
    FNSTSW AX                           ; 0045f14d
    SAHF                                ; 0045f14f
    JBE 0x0045f159                      ; 0045f150 | LAB_0045f159
        ;   XREF to: 0045f159 (CONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x10],0x437c0000 ; 0045f152
    FLD float ptr [EBP + -0xc]          ; 0045f159
        ;   Label: LAB_0045f159
    FCOMP double ptr [0x0061b6fe]       ; 0045f15c | double g_UVClampMinV
    FNSTSW AX                           ; 0045f162
    SAHF                                ; 0045f164
    JNC 0x0045f16e                      ; 0045f165 | LAB_0045f16e
        ;   XREF to: 0045f16e (CONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0xc],0x40800000 ; 0045f167
    FLD float ptr [EBP + -0xc]          ; 0045f16e
        ;   Label: LAB_0045f16e
    FCOMP double ptr [0x0061b706]       ; 0045f171 | double g_UVClampMaxV
    FNSTSW AX                           ; 0045f177
    SAHF                                ; 0045f179
    JBE 0x0045f183                      ; 0045f17a | LAB_0045f183
    ...
    JMP 0x0045f0b3                      ; 0045f1b3 | LAB_0045f0b3
        ;   XREF to: 0045f0b3 (UNCONDITIONAL_JUMP)
    JMP 0x0045f095                      ; 0045f1b8 | LAB_0045f095
        ;   Label: LAB_0045f1b8
