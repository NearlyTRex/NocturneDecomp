...
section .text
    ...
    MOV AL,byte ptr [ESI]               ; 0046a1c8 | = "?" | s_art_0061d196
        ;   Label: LAB_0046a1c8
    MOV byte ptr [EDI],AL               ; 0046a1ca | g_LoadedModelName | s__0066edaa
    CMP AL,0x0                          ; 0046a1cc
    ...
    MOV byte ptr [EDI + 0x1],AL         ; 0046a1d6 | s__0066eda9 | DAT_0066edab
    ...
    FLD float ptr [EAX + 0x16e9a08]     ; 0046a2f0 | DAT_016e9a0c | DAT_016e9a10
    ...
    FLD float ptr [EAX + 0x16e9a48]     ; 0046a32b | DAT_016e9a4c | DAT_016e9a50
    ...
    PUSH EDI                            ; 0046a5a3
    MOV AL,byte ptr [ESI]               ; 0046a5a4 | DAT_016e9914 | DAT_016e9916
        ;   Label: LAB_0046a5a4
    MOV byte ptr [EDI],AL               ; 0046a5a6 | DAT_016e9964 | DAT_016e9966
    CMP AL,0x0                          ; 0046a5a8
    JZ 0x0046a5bc                       ; 0046a5aa
        ;   XREF to: 0046a5bc (CONDITIONAL_JUMP)  ; LAB_0046a5bc
    MOV AL,byte ptr [ESI + 0x1]         ; 0046a5ac | DAT_016e9915 | DAT_016e9917
    ADD ESI,0x2                         ; 0046a5af
    MOV byte ptr [EDI + 0x1],AL         ; 0046a5b2 | DAT_016e9965 | DAT_016e9967
    ...
    DEC ECX                             ; 0046a63c
    MOV AL,0x0                          ; 0046a63d
    SCASB.REPNE ES:EDI                  ; 0046a63f | g_LoadedModelName | s__0066eda9
    DEC EDI                             ; 0046a641
    MOV AL,byte ptr [ESI]               ; 0046a642 | = ".MDL" | DAT_0061d22b
        ;   Label: LAB_0046a642
    MOV byte ptr [EDI],AL               ; 0046a644 | g_LoadedModelName | s__0066eda9 | s__0066edaa
    CMP AL,0x0                          ; 0046a646
    ...
    MOV byte ptr [EDI + 0x1],AL         ; 0046a650 | s__0066eda9 | s__0066edaa | DAT_0066edab
    ...
    PUSH EDI                            ; 0046a670
    MOV AL,byte ptr [ESI]               ; 0046a671 | g_CurrentModelFilename | DAT_01eb176a
        ;   Label: LAB_0046a671
    MOV byte ptr [EDI],AL               ; 0046a673
    CMP AL,0x0                          ; 0046a675
    JZ 0x0046a689                       ; 0046a677
        ;   XREF to: 0046a689 (CONDITIONAL_JUMP)  ; LAB_0046a689
    MOV AL,byte ptr [ESI + 0x1]         ; 0046a679 | DAT_01eb1769 | DAT_01eb176b
    ...
    SCASB.REPNE ES:EDI                  ; 0046a70f | g_LoadedModelName | s__0066eda9
    NOT ECX                             ; 0046a711
    DEC ECX                             ; 0046a713
    ...
    MOV AL,byte ptr [ESI]               ; 0046a747 | g_LoadedModelName | s__0066edaa
        ;   Label: LAB_0046a747
    CMP AL,DL                           ; 0046a749
    ...
    INC ESI                             ; 0046a751
    MOV AL,byte ptr [ESI]               ; 0046a752 | s__0066eda9 | DAT_0066edab
    CMP AL,DL                           ; 0046a754
    ...
    SCASB.REPNE ES:EDI                  ; 0046a76d | g_LoadedModelName | s__0066eda9
    NOT ECX                             ; 0046a76f
    DEC ECX                             ; 0046a771
    ...
    DEC ECX                             ; 0046a786
    MOV AL,0x0                          ; 0046a787
    SCASB.REPNE ES:EDI                  ; 0046a789 | g_LoadedModelName | s__0066eda9
    DEC EDI                             ; 0046a78b
    MOV AL,byte ptr [ESI]               ; 0046a78c | = ".MDL" | DAT_0061d24b
        ;   Label: LAB_0046a78c
    MOV byte ptr [EDI],AL               ; 0046a78e | g_LoadedModelName | s__0066eda9 | s__0066edaa
    CMP AL,0x0                          ; 0046a790
    ...
    MOV byte ptr [EDI + 0x1],AL         ; 0046a79a | s__0066eda9 | s__0066edaa | DAT_0066edab
    ...
    MOV AL,byte ptr [ESI]               ; 0046a7e7 | g_LoadedModelName | s__0066edaa
        ;   Label: LAB_0046a7e7
    CMP AL,DL                           ; 0046a7e9
    ...
    INC ESI                             ; 0046a7f1
    MOV AL,byte ptr [ESI]               ; 0046a7f2 | s__0066eda9 | DAT_0066edab
    CMP AL,DL                           ; 0046a7f4
    ...
    SCASB.REPNE ES:EDI                  ; 0046a80d | g_LoadedModelName | s__0066eda9
    NOT ECX                             ; 0046a80f
    DEC ECX                             ; 0046a811
    ...
    DEC ECX                             ; 0046a826
    MOV AL,0x0                          ; 0046a827
    SCASB.REPNE ES:EDI                  ; 0046a829 | g_LoadedModelName | s__0066eda9
    DEC EDI                             ; 0046a82b
    MOV AL,byte ptr [ESI]               ; 0046a82c | = ".MDL" | DAT_0061d250
        ;   Label: LAB_0046a82c
    MOV byte ptr [EDI],AL               ; 0046a82e | g_LoadedModelName | s__0066eda9 | s__0066edaa
    CMP AL,0x0                          ; 0046a830
    ...
    MOV byte ptr [EDI + 0x1],AL         ; 0046a83a | s__0066eda9 | s__0066edaa | DAT_0066edab
