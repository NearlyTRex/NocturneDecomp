...
section .text
    ...
    PUSH ECX                            ; 00465eb0
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 00465eb1
    ...
    JNZ 0x00465ecf                      ; 00465ec8
        ;   XREF to: 00465ecf (CONDITIONAL_JUMP)  ; LAB_00465ecf
    JMP 0x00466032                      ; 00465eca
        ;   XREF to: 00466032 (UNCONDITIONAL_JUMP)  ; LAB_00466032
    LEA EAX,[EBP + -0xc]                ; 00465ecf
        ;   Label: LAB_00465ecf
    PUSH EAX                            ; 00465ed2
    LEA EAX,[EBP + -0x10]               ; 00465ed3
    PUSH EAX                            ; 00465ed6
    MOV EAX,0x61c6bb                    ; 00465ed7 | = "%d,%d"
    PUSH EAX                            ; 00465edc | = "%d,%d"
    LEA EAX,[EBP + -0x60]               ; 00465edd
    PUSH EAX                            ; 00465ee0
    CALL crt_stdio.c_sscanf_FUN_0060013c ; 00465ee1
    ...
    JZ 0x00465ef7                       ; 00465ef0
        ;   XREF to: 00465ef7 (CONDITIONAL_JUMP)  ; LAB_00465ef7
    JMP 0x00466032                      ; 00465ef2
        ;   XREF to: 00466032 (UNCONDITIONAL_JUMP)  ; LAB_00466032
    CMP dword ptr [EBP + -0x10],0x0     ; 00465ef7
        ;   Label: LAB_00465ef7
    JL 0x00465f03                       ; 00465efb
        ;   XREF to: 00465f03 (CONDITIONAL_JUMP)  ; LAB_00465f03
    CMP dword ptr [EBP + -0xc],0x0      ; 00465efd
    JGE 0x00465f05                      ; 00465f01
        ;   XREF to: 00465f05 (CONDITIONAL_JUMP)  ; LAB_00465f05
    JMP 0x00465f10                      ; 00465f03
        ;   XREF to: 00465f10 (UNCONDITIONAL_JUMP)  ; LAB_00465f10
        ;   Label: LAB_00465f03
    MOV EAX,[0x01626408]                ; 00465f05 | g_VertexCount
        ;   Label: LAB_00465f05
    DEC EAX                             ; 00465f0a
    CMP EAX,dword ptr [EBP + -0x10]     ; 00465f0b
    JGE 0x00465f12                      ; 00465f0e
        ;   XREF to: 00465f12 (CONDITIONAL_JUMP)  ; LAB_00465f12
    JMP 0x00465f1d                      ; 00465f10
        ;   XREF to: 00465f1d (UNCONDITIONAL_JUMP)  ; LAB_00465f1d
        ;   Label: LAB_00465f10
    MOV EAX,[0x01626408]                ; 00465f12 | g_VertexCount
        ;   Label: LAB_00465f12
    DEC EAX                             ; 00465f17
    CMP EAX,dword ptr [EBP + -0xc]      ; 00465f18
    JGE 0x00465f3e                      ; 00465f1b
        ;   XREF to: 00465f3e (CONDITIONAL_JUMP)  ; LAB_00465f3e
    PUSH 0x16                           ; 00465f1d
        ;   Label: LAB_00465f1d
    PUSH 0x0                            ; 00465f1f
    ...
    JMP 0x00465f8a                      ; 00465f86
        ;   XREF to: 00465f8a (UNCONDITIONAL_JUMP)  ; LAB_00465f8a
    JMP 0x00465f4e                      ; 00465f88
        ;   XREF to: 00465f4e (UNCONDITIONAL_JUMP)  ; LAB_00465f4e
        ;   Label: LAB_00465f88
    CMP dword ptr [EBP + -0x4],-0x1     ; 00465f8a
        ;   Label: LAB_00465f8a
    JNZ 0x00465fb1                      ; 00465f8e
        ;   XREF to: 00465fb1 (CONDITIONAL_JUMP)  ; LAB_00465fb1
    PUSH 0x16                           ; 00465f90
    PUSH 0x0                            ; 00465f92
    ...
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 00465fa2
        ;   XREF to: 005eda20 (UNCONDITIONAL_CALL)  ; void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20()
    CALL wincore_winrun.cpp_getNextKeypress_FUN_005f2e90 ; 00465fa7
        ;   XREF to: 005f2e90 (UNCONDITIONAL_CALL)  ; int wincore_winrun.cpp_getNextKeypress_FUN_005f2e90()
    JMP 0x00466032                      ; 00465fac
        ;   XREF to: 00466032 (UNCONDITIONAL_JUMP)  ; LAB_00466032
    IMUL EDX,dword ptr [EBP + -0x10],0x14 ; 00465fb1
        ;   Label: LAB_00465fb1
    IMUL EAX,dword ptr [EBP + -0xc],0x14 ; 00465fb5
    FLD float ptr [EDX + 0x162640c]     ; 00465fb9 | g_LoadedVertices
    FSUB float ptr [EAX + 0x162640c]    ; 00465fbf | g_LoadedVertices
    FABS                                ; 00465fc5
    FLD float ptr [EBP + 0x18]          ; 00465fc7
    FCOMPP                              ; 00465fca
    FNSTSW AX                           ; 00465fcc
    SAHF                                ; 00465fce
    JBE 0x00465ff1                      ; 00465fcf
    ...
    FNSTSW AX                           ; 00465fec
    SAHF                                ; 00465fee
    JA 0x00465ff3                       ; 00465fef
        ;   XREF to: 00465ff3 (CONDITIONAL_JUMP)  ; LAB_00465ff3
    JMP 0x00466013                      ; 00465ff1
        ;   XREF to: 00466013 (UNCONDITIONAL_JUMP)  ; LAB_00466013
        ;   Label: LAB_00465ff1
    ...
    FNSTSW AX                           ; 0046600e
    SAHF                                ; 00466010
    JA 0x00466015                       ; 00466011
        ;   XREF to: 00466015 (CONDITIONAL_JUMP)  ; LAB_00466015
    JMP 0x00466032                      ; 00466013
        ;   XREF to: 00466032 (UNCONDITIONAL_JUMP)  ; LAB_00466032
        ;   Label: LAB_00466013
