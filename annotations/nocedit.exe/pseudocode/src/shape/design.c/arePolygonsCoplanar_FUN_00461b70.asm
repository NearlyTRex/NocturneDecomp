...
;                               FUNCTION
; *****************************************************************************
; __cdecl int shape_design.c_arePolygonsCoplanar_FUN_00461b70(SShapeEditorPolygon * polygon1_ptr, SShapeEditorPolygon * polygon2_ptr, float scale_factor, int tolerance)
;
; Parameters:
...
section .text
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 00461b88 | double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 00461b9c | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 00461bb0 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 00461bc4 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 00461bd8 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 00461bec | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    JGE 0x00461c14                      ; 00461c02 | LAB_00461c14
    ...
    JL 0x00461c16                       ; 00461c12 | LAB_00461c16
        ;   XREF to: 00461c16 (CONDITIONAL_JUMP)
    JMP 0x00461c26                      ; 00461c14 | LAB_00461c26
        ;   Label: LAB_00461c14
    ...
    JL 0x00461c28                       ; 00461c24 | LAB_00461c28
        ;   XREF to: 00461c28 (CONDITIONAL_JUMP)
    JMP 0x00461c31                      ; 00461c26 | LAB_00461c31
        ;   Label: LAB_00461c26
        ;   XREF to: 00461c31 (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x1c],0x1     ; 00461c28
        ;   Label: LAB_00461c28
    JMP 0x00461c38                      ; 00461c2f | LAB_00461c38
