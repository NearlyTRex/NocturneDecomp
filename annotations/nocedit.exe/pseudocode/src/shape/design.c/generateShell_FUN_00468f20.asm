...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl shape_design_c_generateShell_FUN_00468f20(void)
;
; Local Variables:
...
section .text
    ...
    MOV dword ptr [0x016e990c],0x0      ; 00468f2c | g_PolygonCount
    MOV dword ptr [0x01626408],0x0      ; 00468f36 | g_VertexCount
    MOV ECX,0x61ce96                    ; 00468f40 | = "Enter in size in heading : "
    PUSH ECX                            ; 00468f45 | = "Enter in size in heading : "
    PUSH 0x0                            ; 00468f46
    PUSH 0x0                            ; 00468f48
    PUSH 0xa                            ; 00468f4a
    LEA ECX,[EBP + -0x78]               ; 00468f4c
    PUSH ECX                            ; 00468f4f
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 00468f50
    ...
    JNZ 0x00468f6e                      ; 00468f67
        ;   XREF to: 00468f6e (CONDITIONAL_JUMP)  ; LAB_00468f6e
    JMP 0x00469135                      ; 00468f69
        ;   XREF to: 00469135 (UNCONDITIONAL_JUMP)  ; LAB_00469135
    LEA EAX,[EBP + -0x78]               ; 00468f6e
        ;   Label: LAB_00468f6e
    PUSH EAX                            ; 00468f71
    CALL crt_stdlib.c_atoi_FUN_005ffef0 ; 00468f72
    ...
    FDIVR double ptr [0x0061cece]       ; 00468f80 | g_HalfCircleDegrees_1
    FSTP float ptr [EBP + -0x8]         ; 00468f86
    MOV EAX,0x61ceb2                    ; 00468f89 | = "Enter in size in pitch : "
    PUSH EAX                            ; 00468f8e | = "Enter in size in pitch : "
    PUSH 0xb                            ; 00468f8f
    PUSH 0x0                            ; 00468f91
    PUSH 0xa                            ; 00468f93
    LEA EAX,[EBP + -0x78]               ; 00468f95
    PUSH EAX                            ; 00468f98
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 00468f99
        ;   XREF to: 004032c0 (UNCONDITIONAL_CALL)  ; int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
    ...
    JNZ 0x00468fb7                      ; 00468fb0
        ;   XREF to: 00468fb7 (CONDITIONAL_JUMP)  ; LAB_00468fb7
    JMP 0x00469135                      ; 00468fb2
        ;   XREF to: 00469135 (UNCONDITIONAL_JUMP)  ; LAB_00469135
    LEA EAX,[EBP + -0x78]               ; 00468fb7
        ;   Label: LAB_00468fb7
    PUSH EAX                            ; 00468fba
    CALL crt_stdlib.c_atoi_FUN_005ffef0 ; 00468fbb
        ;   XREF to: 005ffef0 (UNCONDITIONAL_CALL)  ; int crt_stdlib.c_atoi_FUN_005ffef0(char * string_ptr)
    ADD ESP,0x4                         ; 00468fc0
    MOV dword ptr [EBP + -0x20],EAX     ; 00468fc3
    FILD dword ptr [EBP + -0x20]        ; 00468fc6
    FDIVR double ptr [0x0061ceee]       ; 00468fc9 | g_HalfCircleDegrees_2
    FSTP float ptr [EBP + -0x4]         ; 00468fcf
    MOV EAX,0x61ced6                    ; 00468fd2 | = "Enter in radius : "
    PUSH EAX                            ; 00468fd7 | = "Enter in radius : "
    PUSH 0x16                           ; 00468fd8
    PUSH 0x0                            ; 00468fda
    PUSH 0xa                            ; 00468fdc
    LEA EAX,[EBP + -0x78]               ; 00468fde
    PUSH EAX                            ; 00468fe1
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 00468fe2
        ;   XREF to: 004032c0 (UNCONDITIONAL_CALL)  ; int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
    ...
    JNZ 0x00469000                      ; 00468ff9
        ;   XREF to: 00469000 (CONDITIONAL_JUMP)  ; LAB_00469000
    JMP 0x00469135                      ; 00468ffb
        ;   XREF to: 00469135 (UNCONDITIONAL_JUMP)  ; LAB_00469135
    LEA EAX,[EBP + -0x78]               ; 00469000
        ;   Label: LAB_00469000
    PUSH EAX                            ; 00469003
    CALL crt_string.c__strtod_FUN_005ff0f3 ; 00469004
    ...
    JMP 0x00469027                      ; 0046901f
        ;   XREF to: 00469027 (UNCONDITIONAL_JUMP)  ; LAB_00469027
    ...
    JG 0x00469135                       ; 0046902d
        ;   XREF to: 00469135 (CONDITIONAL_JUMP)  ; LAB_00469135
    MOV dword ptr [EBP + -0x1c],0x0     ; 00469033
    JMP 0x00469042                      ; 0046903a
        ;   XREF to: 00469042 (UNCONDITIONAL_JUMP)  ; LAB_00469042
    ...
    JGE 0x00469130                      ; 00469048
        ;   XREF to: 00469130 (CONDITIONAL_JUMP)  ; LAB_00469130
    MOV EAX,[0x01626408]                ; 0046904e | g_VertexCount
    ...
    FSUBR double ptr [0x0061cef6]       ; 0046906b | g_RightAngleDegrees
    ...
    CALL shape_design.c_addVertexFromSphericalCoordsHalfSphere_FUN_00468c40 ; 0046908f
        ;   XREF to: 00468c40 (UNCONDITIONAL_CALL)  ; void shape_design.c_addVertexFromSphericalCoordsHalfSphere_FUN_00468c40(float latitude_degrees, float longitude_degrees, float radius)
    ...
    CALL shape_design.c_addVertexFromSphericalCoordsHalfSphere_FUN_00468c40 ; 004690b5
        ;   XREF to: 00468c40 (UNCONDITIONAL_CALL)  ; void shape_design.c_addVertexFromSphericalCoordsHalfSphere_FUN_00468c40(float latitude_degrees, float longitude_degrees, float radius)
    ...
    CALL shape_design.c_addVertexFromSphericalCoordsHalfSphere_FUN_00468c40 ; 004690de
        ;   XREF to: 00468c40 (UNCONDITIONAL_CALL)  ; void shape_design.c_addVertexFromSphericalCoordsHalfSphere_FUN_00468c40(float latitude_degrees, float longitude_degrees, float radius)
    ...
    CALL shape_design.c_addVertexFromSphericalCoordsHalfSphere_FUN_00468c40 ; 00469104
        ;   XREF to: 00468c40 (UNCONDITIONAL_CALL)  ; void shape_design.c_addVertexFromSphericalCoordsHalfSphere_FUN_00468c40(float latitude_degrees, float longitude_degrees, float radius)
    ...
    PUSH EAX                            ; 00469122
    CALL shape_design.c_addQuadPolygonHalfSphere_FUN_00468d20 ; 00469123
        ;   XREF to: 00468d20 (UNCONDITIONAL_CALL)  ; void shape_design.c_addQuadPolygonHalfSphere_FUN_00468d20(int vertex_index_1, int vertex_index_2, int vertex_index_3, int vertex_index_4)
    ADD ESP,0x10                        ; 00469128
    JMP 0x0046903c                      ; 0046912b
        ;   XREF to: 0046903c (UNCONDITIONAL_JUMP)  ; LAB_0046903c
    JMP 0x00469021                      ; 00469130
        ;   XREF to: 00469021 (UNCONDITIONAL_JUMP)  ; LAB_00469021
        ;   Label: LAB_00469130
