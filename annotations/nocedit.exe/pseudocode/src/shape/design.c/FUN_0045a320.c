// Name: shape_design.c_FUN_0045a320
// Address: 0045a320
// Address Range: [[0045a320, 0045a601]]
// Convention: unknown
// Signature: undefined shape_design.c_FUN_0045a320()
// Globals:
...

{
  ...
  shape_design_c_calculatePolygonNormal_FUN_0045caa0(g_ModelPolygonData + param_5);
  fVar4 = (float10)g_ModelPolygonData[param_5].normal.x * (float10)FLOAT_0061ae5e;
  dVar5 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44(extraout_EDX,param_5 * 0x184));
  iVar11 = (int)ROUND(fVar4);
  fVar4 = (float10)g_ModelPolygonData[param_5].normal.y * (float10)FLOAT_0061ae5e;
  dVar5 = crt_math_c_round_FUN_005fe6b0
                    ((double)CONCAT44((int)((ulonglong)dVar5 >> 0x20),param_5 * 0x184));
  iVar6 = (int)ROUND(fVar4);
  fVar4 = (float10)g_ModelPolygonData[param_5].normal.z * (float10)FLOAT_0061ae5e;
  dVar5 = crt_math_c_round_FUN_005fe6b0
                    ((double)CONCAT44((int)((ulonglong)dVar5 >> 0x20),param_5 * 0x184));
  pFVar7 = (FILE *)(int)ROUND(fVar4);
  fVar4 = (float10)param_7 *
          (float10)g_ModelPolygonData[param_5].plane_distance * (float10)DOUBLE_0061ae66 *
          (float10)DOUBLE_0061ae6e;
  crt_math_c_round_FUN_005fe6b0((double)CONCAT44((int)((ulonglong)dVar5 >> 0x20),param_5 * 0x184));
  pcVar9 = (char *)(int)ROUND(fVar4);
  if (g_ModelPolygonData[param_5].polygon_type == 1) {
    if (g_EditorColorIndex != g_ModelPolygonData[param_5].material_id) {
      pcVar9 = "\tCOLOR\t%d\n";
      iVar6 = 0x45a3fe;
      pFVar7 = param_6;
      crt_stdio_c_fprintf_FUN_005fe6d0
                (param_6,"\tCOLOR\t%d\n",g_ModelPolygonData[param_5].material_id);
      g_EditorColorIndex = g_ModelPolygonData[param_5].material_id;
    }
    crt_stdio_c_fprintf_FUN_005fe6d0
              (param_6,"\tFACET%d\t%d,%d,%d,%d",g_ModelPolygonData[param_5].vertex_indices_count,
               iVar11,iVar6,pFVar7,pcVar9);
    puVar10 = (undefined1 *)0x0;
    while ((int)puVar10 < (int)g_ModelPolygonData[param_5].vertex_indices_count) {
      pFVar7 = param_6;
      crt_stdio_c_fprintf_FUN_005fe6d0
                (param_6,",%d",g_ModelPolygonData[param_5].vertex_indices[(int)puVar10]);
      puVar10 = (undefined1 *)((int)&pFVar7->_ptr + 1);
    }
    crt_stdio_c_fprintf_FUN_005fe6d0(param_6,&DAT_0061ae9a);
  }
  else {
    pcVar9 = g_TempTextureName;
    uVar8 = 0x45a4c0;
    iVar2 = crt_string_c_strcmp_FUN_005fef20
                      (g_TempTextureName,g_ModelPolygonData[param_5].texture_name);
    if (iVar2 != 0) {
      pcVar9 = g_ModelPolygonData[param_5].texture_name;
      ...
      uVar8 = 0x45a50c;
      pcVar9 = (char *)param_6;
      crt_stdio_c_fprintf_FUN_005fe6d0(param_6,"\tTEXTURE\t'%s'\n",g_TempTextureName);
    }
    crt_stdio_c_fprintf_FUN_005fe6d0
              (param_6,"\tFACET%dTMAP\t%d,%d,%d,%d",
               g_ModelPolygonData[param_5].vertex_indices_count,iVar11,iVar6,uVar8,pcVar9);
    for (iVar11 = 0; iVar11 < (int)g_ModelPolygonData[param_5].vertex_indices_count;
        iVar11 = iVar11 + 1) {
      iVar6 = 0x45a587;
      crt_stdio_c_fprintf_FUN_005fe6d0
                (param_6,",%d",g_ModelPolygonData[param_5].vertex_indices[iVar11]);
      iVar11 = 0x45a5b4;
      crt_stdio_c_fprintf_FUN_005fe6d0
                (param_6,",%f",
                 SUB84((double)(float)g_ModelPolygonData[param_5].vertex_indices[iVar6 + 0x10],0),
                 (int)((ulonglong)
                       (double)(float)g_ModelPolygonData[param_5].vertex_indices[iVar6 + 0x10] >>
                      0x20));
      unaff_EBX = SUB84((double)g_ModelPolygonData[param_5].uv_coordinates[iVar11],0);
      crt_stdio_c_fprintf_FUN_005fe6d0(param_6,",%f",unaff_EBX);
    }
    crt_stdio_c_fprintf_FUN_005fe6d0(param_6,&DAT_0061aed0,unaff_EBX);
  }
  return;
}
...
// Assembly code:
// 0045a320: PUSH EBX
//   Label: shape_design.c_FUN_0045a320
// 0045a321: PUSH ESI
// 0045a322: PUSH EDI
// 0045a323: PUSH EBP
