...
;                               FUNCTION
; *****************************************************************************
; __cdecl uint shape_design.c_mergeTrianglesIntoQuad_FUN_00462190(int first_polygon_index, int second_polygon_index)
;
; Parameters:
...
section .text
    ...
    JMP 0x004621b2                      ; 004621aa | LAB_004621b2
    ...
    CMP dword ptr [EBP + -0xc],0x3      ; 004621b2
        ;   Label: LAB_004621b2
    JGE 0x00462235                      ; 004621b6 | LAB_00462235
        ;   XREF to: 00462235 (CONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x8],0x0      ; 004621bc
    JMP 0x004621cb                      ; 004621c3 | LAB_004621cb
    ...
    CMP dword ptr [EBP + -0x8],0x3      ; 004621cb
        ;   Label: LAB_004621cb
    JGE 0x00462230                      ; 004621cf | LAB_00462230
    ...
    JNZ 0x0046222e                      ; 004621fc | LAB_0046222e
    ...
    JLE 0x0046222e                      ; 00462227 | LAB_0046222e
        ;   XREF to: 0046222e (CONDITIONAL_JUMP)
    JMP 0x00462b61                      ; 00462229 | LAB_00462b61
        ;   XREF to: 00462b61 (UNCONDITIONAL_JUMP)
    JMP 0x004621c5                      ; 0046222e | LAB_004621c5
        ;   Label: LAB_0046222e
        ;   XREF to: 004621c5 (UNCONDITIONAL_JUMP)
    JMP 0x004621ac                      ; 00462230 | LAB_004621ac
        ;   Label: LAB_00462230
        ;   XREF to: 004621ac (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0xc],0x0      ; 00462235
        ;   Label: LAB_00462235
    JMP 0x00462244                      ; 0046223c | LAB_00462244
    ...
    CMP dword ptr [EBP + -0xc],0x3      ; 00462244
        ;   Label: LAB_00462244
    JGE 0x004622a9                      ; 00462248 | LAB_004622a9
    ...
    JMP 0x0046223e                      ; 004622a7 | LAB_0046223e
        ;   XREF to: 0046223e (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0xc],0x0      ; 004622a9
        ;   Label: LAB_004622a9
    JMP 0x004622b8                      ; 004622b0 | LAB_004622b8
    ...
    CMP dword ptr [EBP + -0xc],0x3      ; 004622b8
        ;   Label: LAB_004622b8
    JGE 0x00462320                      ; 004622bc | LAB_00462320
    ...
    JMP 0x004622b2                      ; 0046231e | LAB_004622b2
        ;   Label: LAB_0046231e
        ;   XREF to: 004622b2 (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0xc],0x0      ; 00462320
        ;   Label: LAB_00462320
    JMP 0x0046232f                      ; 00462327 | LAB_0046232f
    ...
    CMP dword ptr [EBP + -0xc],0x4      ; 0046232f
        ;   Label: LAB_0046232f
    JGE 0x004623f2                      ; 00462333 | LAB_004623f2
    ...
    JNZ 0x00462361                      ; 00462350 | LAB_00462361
    ...
    JZ 0x00462381                       ; 0046235f | LAB_00462381
    ...
    JNZ 0x0046237f                      ; 0046236e | LAB_0046237f
    ...
    JZ 0x00462381                       ; 0046237d | LAB_00462381
        ;   XREF to: 00462381 (CONDITIONAL_JUMP)
    JMP 0x004623ed                      ; 0046237f | LAB_004623ed
        ;   Label: LAB_0046237f
    ...
    PUSH EAX                            ; 004623a2
    CALL shape_design.c_swapDWords_FUN_00462130 ; 004623a3 | void shape_design.c_swapDWords_FUN_00462130(uint * value1_ptr, uint * value2_ptr)
    ...
    PUSH EAX                            ; 004623c2
    CALL shape_design.c_swapFloats_FUN_00462160 ; 004623c3 | void shape_design.c_swapFloats_FUN_00462160(float * value1_ptr, float * value2_ptr)
    ...
    PUSH EAX                            ; 004623e2
    CALL shape_design.c_swapFloats_FUN_00462160 ; 004623e3 | void shape_design.c_swapFloats_FUN_00462160(float * value1_ptr, float * value2_ptr)
        ;   XREF to: 00462160 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004623e8
    JMP 0x004623f2                      ; 004623eb | LAB_004623f2
        ;   XREF to: 004623f2 (UNCONDITIONAL_JUMP)
    JMP 0x00462329                      ; 004623ed | LAB_00462329
        ;   Label: LAB_004623ed
        ;   XREF to: 00462329 (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBP + 0xfffffecc],0x4 ; 004623f2
        ;   Label: LAB_004623f2
    MOV dword ptr [EBP + -0xc],0x0      ; 004623fc
    JMP 0x0046240b                      ; 00462403 | LAB_0046240b
    ...
    JGE 0x0046242f                      ; 00462414 | LAB_0046242f
    ...
    JMP 0x00462405                      ; 0046242d | LAB_00462405
        ;   XREF to: 00462405 (UNCONDITIONAL_JUMP)
    LEA EAX,[EBP + 0xfffffe28]          ; 0046242f
        ;   Label: LAB_0046242f
    PUSH EAX                            ; 00462435
    CALL shape_design.c_calculatePolygonAngularArea_FUN_00461ee0 ; 00462436 | double shape_design.c_calculatePolygonAngularArea_FUN_00461ee0(SShapeEditorPolygon * polygon_ptr)
    ...
    FCOMP double ptr [0x0061bfce]       ; 00462450 | double g_MinPolygonAreaThreshold
    FNSTSW AX                           ; 00462456
    SAHF                                ; 00462458
    JNC 0x00462460                      ; 00462459 | LAB_00462460
        ;   XREF to: 00462460 (CONDITIONAL_JUMP)
    JMP 0x00462b61                      ; 0046245b | LAB_00462b61
        ;   XREF to: 00462b61 (UNCONDITIONAL_JUMP)
    IMUL EAX,dword ptr [EBP + 0x14],0x184 ; 00462460
        ;   Label: LAB_00462460
    MOV EDX,0x16e9910                   ; 00462467 | SShapeEditorPolygon[20000] g_ModelPolygonData
    ADD EAX,EDX                         ; 0046246c
    PUSH EAX                            ; 0046246e
    CALL shape_design.c_calculatePolygonNormal_FUN_0045caa0 ; 0046246f | void shape_design.c_calculatePolygonNormal_FUN_0045caa0(SShapeEditorPolygon * polygon)
    ...
    JMP 0x00462497                      ; 0046248f | LAB_00462497
    ...
    JGE 0x00462508                      ; 004624a7 | LAB_00462508
    ...
    JMP 0x00462586                      ; 0046257e | LAB_00462586
    ...
    JGE 0x004625f7                      ; 00462596 | LAB_004625f7
    ...
    JGE 0x00462634                      ; 00462619 | LAB_00462634
    ...
    JMP 0x0046260a                      ; 00462632 | LAB_0046260a
        ;   XREF to: 0046260a (UNCONDITIONAL_JUMP)
    LEA EAX,[EBP + 0xfffffe28]          ; 00462634
        ;   Label: LAB_00462634
    PUSH EAX                            ; 0046263a
    CALL shape_design.c_calculatePolygonNormal_FUN_0045caa0 ; 0046263b | void shape_design.c_calculatePolygonNormal_FUN_0045caa0(SShapeEditorPolygon * polygon)
        ;   XREF to: 0045caa0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00462640
    JMP 0x00462791                      ; 00462643 | LAB_00462791
    ...
    PUSH EAX                            ; 0046265c
    CALL shape_design.c_calculateVertexAngle_FUN_00462050 ; 0046265d | double shape_design.c_calculateVertexAngle_FUN_00462050(int vertex1_index, int vertex2_index, int vertex3_index)
    ...
    FCOMP double ptr [0x0061bfd6]       ; 00462677 | double g_FirstAngleThreshold
    FNSTSW AX                           ; 0046267d
    SAHF                                ; 0046267f
    JBE 0x00462791                      ; 00462680 | LAB_00462791
    ...
    PUSH EAX                            ; 004626b6
    CALL shape_design.c_calculatePolygonNormal_FUN_0045caa0 ; 004626b7 | void shape_design.c_calculatePolygonNormal_FUN_0045caa0(SShapeEditorPolygon * polygon)
        ;   XREF to: 0045caa0 (UNCONDITIONAL_CALL)
    ...
    FLD double ptr [0x0061bfde]         ; 00462791 | double g_AngleForCosineCalc
        ;   Label: LAB_00462791
    FCOS                                ; 00462797
    SUB ESP,0x8                         ; 00462799
    FSTP double ptr [ESP]               ; 0046279c
    IMUL EDX,dword ptr [EBP + 0x14],0x184 ; 0046279f
    MOV EAX,0x16e9910                   ; 004627a6 | SShapeEditorPolygon[20000] g_ModelPolygonData
    ADD EAX,EDX                         ; 004627ab
    PUSH EAX                            ; 004627ad
    LEA EAX,[EBP + 0xfffffe28]          ; 004627ae
    PUSH EAX                            ; 004627b4
    CALL shape_design.c_validatePolygonNormals_FUN_00461d80 ; 004627b5 | int shape_design.c_validatePolygonNormals_FUN_00461d80(SShapeEditorPolygon * polygon1, SShapeEditorPolygon * polygon2, double cos_tolerance)
        ;   XREF to: 00461d80 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004627ba
    TEST EAX,EAX                        ; 004627bd
    JNZ 0x00462b1c                      ; 004627bf | LAB_00462b1c
    ...
    JMP 0x004627e7                      ; 004627df | LAB_004627e7
    ...
    JGE 0x00462879                      ; 004627f0 | LAB_00462879
    ...
    JMP 0x004627e1                      ; 00462874 | LAB_004627e1
        ;   XREF to: 004627e1 (UNCONDITIONAL_JUMP)
    IMUL EAX,dword ptr [EBP + 0x14],0x184 ; 00462879
        ;   Label: LAB_00462879
    MOV EDX,0x16e9910                   ; 00462880 | SShapeEditorPolygon[20000] g_ModelPolygonData
    ADD EAX,EDX                         ; 00462885
    PUSH EAX                            ; 00462887
    CALL shape_design.c_calculatePolygonNormal_FUN_0045caa0 ; 00462888 | void shape_design.c_calculatePolygonNormal_FUN_0045caa0(SShapeEditorPolygon * polygon)
        ;   XREF to: 0045caa0 (UNCONDITIONAL_CALL)
    ...
    JNZ 0x004628b6                      ; 004628a1 | LAB_004628b6
    ...
    JZ 0x004628b8                       ; 004628b4 | LAB_004628b8
        ;   XREF to: 004628b8 (CONDITIONAL_JUMP)
    JMP 0x004628cb                      ; 004628b6 | LAB_004628cb
        ;   Label: LAB_004628b6
    ...
    JZ 0x004628d0                       ; 004628c9 | LAB_004628d0
        ;   XREF to: 004628d0 (CONDITIONAL_JUMP)
    JMP 0x00462982                      ; 004628cb | LAB_00462982
        ;   Label: LAB_004628cb
    ...
    JMP 0x00462b1c                      ; 0046297d | LAB_00462b1c
    ...
    CALL shape_design.c_calculateVertexAngle_FUN_00462050 ; 004629a9 | double shape_design.c_calculateVertexAngle_FUN_00462050(int vertex1_index, int vertex2_index, int vertex3_index)
        ;   XREF to: 00462050 (UNCONDITIONAL_CALL)
    MOV dword ptr [EBP + 0xfffffe20],EAX ; 004629ae
    MOV dword ptr [EBP + 0xfffffe24],EDX ; 004629b4 | SShapeEditorPolygon[20000] g_ModelPolygonData
    FLD double ptr [EBP + 0xfffffe20]   ; 004629ba
    ADD ESP,0xc                         ; 004629c0
    FCOMP double ptr [0x0061bfe6]       ; 004629c3 | double DOUBLE_0061bfe6
    FNSTSW AX                           ; 004629c9
    SAHF                                ; 004629cb
    JBE 0x00462b1c                      ; 004629cc | LAB_00462b1c
        ;   XREF to: 00462b1c (CONDITIONAL_JUMP)
    ...
    LEA EDI,[ESI + 0x16e9910]           ; 00462b4b | SShapeEditorPolygon[20000] g_ModelPolygonData
    LEA ESI,[EAX + 0x16e9910]           ; 00462b51 | SShapeEditorPolygon[20000] g_ModelPolygonData
    MOVSD.REP ES:EDI,ESI                ; 00462b57 | SShapeEditorPolygon[20000] g_ModelPolygonData
    JMP 0x00462b24                      ; 00462b59 | LAB_00462b24
        ;   XREF to: 00462b24 (UNCONDITIONAL_JUMP)
    DEC dword ptr [0x016e990c]          ; 00462b5b | int g_PolygonCount
        ;   Label: LAB_00462b5b
