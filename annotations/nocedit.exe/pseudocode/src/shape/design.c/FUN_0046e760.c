// Name: shape_design.c_FUN_0046e760
// Address: 0046e760
// Address Range: [[0046e760, 0046e7d6] [0046e7e8, 0046e800]]
// Convention: unknown
// Signature: undefined shape_design.c_FUN_0046e760()
// Globals:
...
// Function calls:
//   crt_unknown.c_FUN_00600ad0
//   engine_2d.c_drawText_FUN_00401fd0

#include "nocturne.h"

void shape_design_c_FUN_0046e760(void)

{
  undefined4 uVar1;
  int in_stack_00000004;
  
  uVar1 = crt_unknown_c_FUN_00600ad0();
  switch(uVar1) {
  case 0:
    engine_2d_c_drawText_FUN_00401fd0("OK - heap is good",0,in_stack_00000004 * 0xb);
    break;
  case 1:
    engine_2d_c_drawText_FUN_00401fd0("OK - heap is empty",0,in_stack_00000004 * 0xb);
    break;
  case 2:
    engine_2d_c_drawText_FUN_00401fd0("ERROR - heap is damaged",0,in_stack_00000004 * 0xb);
    break;
  case 3:
    engine_2d_c_drawText_FUN_00401fd0("ERROR - bad node in heap",0,in_stack_00000004 * 0xb);
  }
  return;
}
...
// Assembly code:
// 0046e760: PUSH EBX
//   Label: shape_design.c_FUN_0046e760
// 0046e761: PUSH ESI
// 0046e762: PUSH EDI
// 0046e763: PUSH EBP
// 0046e764: MOV EBP,ESP
// 0046e766: SUB ESP,0x54
// 0046e76c: CALL crt_unknown.c_FUN_00600ad0
