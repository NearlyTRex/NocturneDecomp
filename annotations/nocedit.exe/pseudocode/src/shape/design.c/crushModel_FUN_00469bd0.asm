...
section .text
    ...
    JMP 0x00469bf2                      ; 00469bea | LAB_00469bf2
    ...
    MOV EAX,dword ptr [EBP + -0x8]      ; 00469bf2
        ;   Label: LAB_00469bf2
    CMP EAX,dword ptr [0x01626408]      ; 00469bf5 | int g_VertexCount
    JGE 0x00469c1e                      ; 00469bfb | LAB_00469c1e
    ...
    FNSTSW AX                           ; 00469c0a
    SAHF                                ; 00469c0c
    JNC 0x00469c1c                      ; 00469c0d | LAB_00469c1c
    ...
    JMP 0x00469bec                      ; 00469c1c | LAB_00469bec
        ;   Label: LAB_00469c1c
        ;   XREF to: 00469bec (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x8],0x0      ; 00469c1e
        ;   Label: LAB_00469c1e
    JMP 0x00469c2d                      ; 00469c25 | LAB_00469c2d
    ...
    MOV EAX,dword ptr [EBP + -0x8]      ; 00469c2d
        ;   Label: LAB_00469c2d
    CMP EAX,dword ptr [0x01626408]      ; 00469c30 | int g_VertexCount
    JGE 0x00469c47                      ; 00469c36 | LAB_00469c47
    ...
    JMP 0x00469c27                      ; 00469c45 | LAB_00469c27
        ;   XREF to: 00469c27 (UNCONDITIONAL_JUMP)
    CALL wincore_windll.cpp_clearScreen_FUN_005b3e70 ; 00469c47 | void wincore_windll.cpp_clearScreen_FUN_005b3e70()
        ;   Label: LAB_00469c47
        ;   XREF to: 005b3e70 (UNCONDITIONAL_CALL)
    PUSH 0x0                            ; 00469c4c
    PUSH 0x0                            ; 00469c4e
    MOV EAX,0x61d090                    ; 00469c50 | = "Model crushed.  Hit a key..." | s_Model_crushed_Hit_a_key_0061d090 = Model crushed.  Hit a key...
    PUSH EAX                            ; 00469c55 | = "Model crushed.  Hit a key..." | s_Model_crushed_Hit_a_key_0061d090 = Model crushed.  Hit a key...
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 00469c56 | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00469c5b
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 00469c5e | void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20()
        ;   XREF to: 005eda20 (UNCONDITIONAL_CALL)
    CALL wincore_winrun.cpp_getNextKeypress_FUN_005f2e90 ; 00469c63 | int wincore_winrun.cpp_getNextKeypress_FUN_005f2e90()
