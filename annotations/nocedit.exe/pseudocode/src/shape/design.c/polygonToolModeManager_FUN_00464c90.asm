...
section .text
    ...
    MOV EAX,0x61c3e2                    ; 00464c9c | s_EmptyChar_0061c3e2
    ...
    JNZ 0x00464cc0                      ; 00464cb2
        ;   XREF to: 00464cc0 (CONDITIONAL_JUMP)  ; LAB_00464cc0
    MOV dword ptr [EBP + -0x8],0xffffffff ; 00464cb4
    JMP 0x0046514d                      ; 00464cbb
        ;   XREF to: 0046514d (UNCONDITIONAL_JUMP)  ; LAB_0046514d
    CMP byte ptr [0x02d03eca],0x0       ; 00464cc0 | CHAR_ARRAY_02d03eca
        ;   Label: LAB_00464cc0
    JZ 0x00464cd2                       ; 00464cc7
        ;   XREF to: 00464cd2 (CONDITIONAL_JUMP)  ; LAB_00464cd2
    CMP byte ptr [0x02d03ec2],0x0       ; 00464cc9 | CHAR_ARRAY_02d03ec2
    JNZ 0x00464cd4                      ; 00464cd0
        ;   XREF to: 00464cd4 (CONDITIONAL_JUMP)  ; LAB_00464cd4
    JMP 0x00464d3f                      ; 00464cd2
        ;   XREF to: 00464d3f (UNCONDITIONAL_JUMP)  ; LAB_00464d3f
        ;   Label: LAB_00464cd2
    MOV byte ptr [0x02d03eca],0x0       ; 00464cd4 | CHAR_ARRAY_02d03eca
        ;   Label: LAB_00464cd4
    XOR byte ptr [0x015c4880],0x1       ; 00464cdb | g_ToolModeEnabled
    CMP dword ptr [0x015c4880],0x0      ; 00464ce2 | g_ToolModeEnabled
    JZ 0x00464d29                       ; 00464ce9
        ;   XREF to: 00464d29 (CONDITIONAL_JUMP)  ; LAB_00464d29
    MOV ESI,dword ptr [0x01626408]      ; 00464ceb | g_VertexCount
    MOV dword ptr [0x015c4884],ESI      ; 00464cf1 | g_SavedVertexCount
    MOV ESI,dword ptr [0x016e990c]      ; 00464cf7 | g_PolygonCount
    MOV dword ptr [0x015c4888],ESI      ; 00464cfd | g_SavedPolygonCount
    ...
    MOV AL,byte ptr [ESI + 0x1]         ; 00464d16 | g_LoadedModelName+1 | g_LoadedModelName+3
    ADD ESI,0x2                         ; 00464d19
    MOV byte ptr [EDI + 0x1],AL         ; 00464d1c | g_SavedModelName+1 | g_SavedModelName+3
    ADD EDI,0x2                         ; 00464d1f
    CMP AL,0x0                          ; 00464d22
    JNZ 0x00464d0e                      ; 00464d24
        ;   XREF to: 00464d0e (CONDITIONAL_JUMP)  ; LAB_00464d0e
    POP EDI                             ; 00464d26
        ;   Label: LAB_00464d26
    JMP 0x00464d3f                      ; 00464d27
        ;   XREF to: 00464d3f (UNCONDITIONAL_JUMP)  ; LAB_00464d3f
    MOV dword ptr [0x01e528bc],0xffffffff ; 00464d29 | g_SecondaryPolygonIndex
        ;   Label: LAB_00464d29
    MOV dword ptr [EBP + -0x8],0xffffffff ; 00464d33
    JMP 0x0046514d                      ; 00464d3a
        ;   XREF to: 0046514d (UNCONDITIONAL_JUMP)  ; LAB_0046514d
    CMP dword ptr [0x015c4880],0x0      ; 00464d3f | g_ToolModeEnabled
        ;   Label: LAB_00464d3f
    JZ 0x00464d7e                       ; 00464d46
        ;   XREF to: 00464d7e (CONDITIONAL_JUMP)  ; LAB_00464d7e
    MOV EAX,0x66eda8                    ; 00464d48 | g_LoadedModelName
    ...
    JNZ 0x00464d6d                      ; 00464d5e
        ;   XREF to: 00464d6d (CONDITIONAL_JUMP)  ; LAB_00464d6d
    MOV EAX,[0x01626408]                ; 00464d60 | g_VertexCount
    CMP EAX,dword ptr [0x015c4884]      ; 00464d65 | g_SavedVertexCount
    JLE 0x00464d6f                      ; 00464d6b
        ;   XREF to: 00464d6f (CONDITIONAL_JUMP)  ; LAB_00464d6f
    JMP 0x00464d7c                      ; 00464d6d
        ;   XREF to: 00464d7c (UNCONDITIONAL_JUMP)  ; LAB_00464d7c
        ;   Label: LAB_00464d6d
    MOV EAX,[0x016e990c]                ; 00464d6f | g_PolygonCount
        ;   Label: LAB_00464d6f
    CMP EAX,dword ptr [0x015c4888]      ; 00464d74 | g_SavedPolygonCount
    JLE 0x00464d7e                      ; 00464d7a
        ;   XREF to: 00464d7e (CONDITIONAL_JUMP)  ; LAB_00464d7e
    JMP 0x00464d80                      ; 00464d7c
        ;   XREF to: 00464d80 (UNCONDITIONAL_JUMP)  ; LAB_00464d80
        ;   Label: LAB_00464d7c
    JMP 0x00464da0                      ; 00464d7e
        ;   XREF to: 00464da0 (UNCONDITIONAL_JUMP)  ; LAB_00464da0
        ;   Label: LAB_00464d7e
    MOV dword ptr [0x015c4880],0x0      ; 00464d80 | g_ToolModeEnabled
        ;   Label: LAB_00464d80
    MOV dword ptr [0x01e528bc],0xffffffff ; 00464d8a | g_SecondaryPolygonIndex
    MOV dword ptr [EBP + -0x8],0xffffffff ; 00464d94
    JMP 0x0046514d                      ; 00464d9b
        ;   XREF to: 0046514d (UNCONDITIONAL_JUMP)  ; LAB_0046514d
    CMP dword ptr [0x015c4880],0x0      ; 00464da0 | g_ToolModeEnabled
        ;   Label: LAB_00464da0
    JNZ 0x00464db4                      ; 00464da7
        ;   XREF to: 00464db4 (CONDITIONAL_JUMP)  ; LAB_00464db4
    MOV EAX,dword ptr [EBP + 0x14]      ; 00464da9
    MOV dword ptr [EBP + -0x8],EAX      ; 00464dac
    JMP 0x0046514d                      ; 00464daf
        ;   XREF to: 0046514d (UNCONDITIONAL_JUMP)  ; LAB_0046514d
    CALL shape_design.c_findClosestPolygonToMouse_FUN_00466250 ; 00464db4
    ...
    JZ 0x00464dce                       ; 00464dc3
        ;   XREF to: 00464dce (CONDITIONAL_JUMP)  ; LAB_00464dce
    CMP byte ptr [0x02d03ec2],0x0       ; 00464dc5 | CHAR_ARRAY_02d03ec2
    JZ 0x00464dd0                       ; 00464dcc
        ;   XREF to: 00464dd0 (CONDITIONAL_JUMP)  ; LAB_00464dd0
    JMP 0x00464df0                      ; 00464dce
        ;   XREF to: 00464df0 (UNCONDITIONAL_JUMP)  ; LAB_00464df0
        ;   Label: LAB_00464dce
    MOV byte ptr [0x02d03eca],0x0       ; 00464dd0 | CHAR_ARRAY_02d03eca
        ;   Label: LAB_00464dd0
    INC dword ptr [0x015c48b8]          ; 00464dd7 | g_PolygonToolMode
    CMP dword ptr [0x015c48b8],0x5      ; 00464ddd | g_PolygonToolMode
    JLE 0x00464df0                      ; 00464de4
        ;   XREF to: 00464df0 (CONDITIONAL_JUMP)  ; LAB_00464df0
    MOV dword ptr [0x015c48b8],0x0      ; 00464de6 | g_PolygonToolMode
    MOV EAX,[0x015c48b8]                ; 00464df0 | g_PolygonToolMode
        ;   Label: LAB_00464df0
    MOV dword ptr [EBP + 0xffffff54],EAX ; 00464df5
    JMP 0x00464e3c                      ; 00464dfb
        ;   XREF to: 00464e3c (UNCONDITIONAL_JUMP)  ; LAB_00464e3c
    MOV dword ptr [EBP + -0x4],0x3e4ccccd ; 00464dfd
        ;   Label: caseD_1
    JMP 0x00464e61                      ; 00464e04
        ;   XREF to: 00464e61 (UNCONDITIONAL_JUMP)  ; default
    MOV dword ptr [EBP + -0x4],0x3c23d70a ; 00464e06
        ;   Label: caseD_2
    JMP 0x00464e61                      ; 00464e0d
        ;   XREF to: 00464e61 (UNCONDITIONAL_JUMP)  ; default
    JMP 0x00464e61                      ; 00464e0f
        ;   XREF to: 00464e61 (UNCONDITIONAL_JUMP)  ; default
        ;   Label: caseD_3
    MOV dword ptr [EBP + -0x4],0x3c23d70a ; 00464e11
        ;   Label: caseD_4
    JMP 0x00464e61                      ; 00464e18
        ;   XREF to: 00464e61 (UNCONDITIONAL_JUMP)  ; default
    MOV dword ptr [EBP + -0x4],0x3c23d70a ; 00464e1a
        ;   Label: caseD_5
    JMP 0x00464e61                      ; 00464e21
        ;   XREF to: 00464e61 (UNCONDITIONAL_JUMP)  ; default
    JMP 0x00464e61                      ; 00464e23
        ;   XREF to: 00464e61 (UNCONDITIONAL_JUMP)  ; default
        ;   Label: LAB_00464e23
    ...
    JA 0x00464e23                       ; 00464e50
        ;   XREF to: 00464e23 (CONDITIONAL_JUMP)  ; LAB_00464e23
    MOV EAX,dword ptr [EBP + 0xffffff50] ; 00464e52
    SHL EAX,0x2                         ; 00464e58
    JMP dword ptr [EAX + 0x464e28]      ; 00464e5b | caseD_1 | caseD_2 | caseD_3
        ;   Label: switchD
    PUSH 0x1                            ; 00464e61
        ;   Label: default
    CALL shape_design.c_detectMouseButtonClick_FUN_00464870 ; 00464e63
    ...
    JZ 0x00464f58                       ; 00464e6d
        ;   XREF to: 00464f58 (CONDITIONAL_JUMP)  ; LAB_00464f58
    CMP dword ptr [0x015c48b8],0x0      ; 00464e73 | g_PolygonToolMode
    ...
    MOV EAX,[0x015c48b8]                ; 00464e8b | g_PolygonToolMode
        ;   Label: LAB_00464e8b
    MOV dword ptr [EBP + 0xffffff4c],EAX ; 00464e90
    JMP 0x00464f20                      ; 00464e96
        ;   XREF to: 00464f20 (UNCONDITIONAL_JUMP)  ; LAB_00464f20
    ...
    PUSH EAX                            ; 00464ea7
    CALL shape_design.c_polygonMergerSelectAndProcess_FUN_00465160 ; 00464ea8
        ;   XREF to: 00465160 (UNCONDITIONAL_CALL)  ; void shape_design.c_polygonMergerSelectAndProcess_FUN_00465160(int polygon_index, float tolerance)
    ADD ESP,0x8                         ; 00464ead
    JMP 0x00464f45                      ; 00464eb0
        ;   XREF to: 00464f45 (UNCONDITIONAL_JUMP)  ; default
    ...
    PUSH EAX                            ; 00464ec1
    CALL shape_design.c_weldNearbyVertices_FUN_00465c50 ; 00464ec2
        ;   XREF to: 00465c50 (UNCONDITIONAL_CALL)  ; void shape_design.c_weldNearbyVertices_FUN_00465c50(int polygon_index, float tolerance)
    ADD ESP,0x8                         ; 00464ec7
    JMP 0x00464f45                      ; 00464eca
        ;   XREF to: 00464f45 (UNCONDITIONAL_JUMP)  ; default
    MOV EAX,dword ptr [EBP + 0x14]      ; 00464ecf
        ;   Label: caseD_3
    PUSH EAX                            ; 00464ed2
    CALL shape_design.c_duplicateSharedVertices_FUN_00465d50 ; 00464ed3
        ;   XREF to: 00465d50 (UNCONDITIONAL_CALL)  ; void shape_design.c_duplicateSharedVertices_FUN_00465d50(int polygon_index)
    ADD ESP,0x4                         ; 00464ed8
    JMP 0x00464f45                      ; 00464edb
        ;   XREF to: 00464f45 (UNCONDITIONAL_JUMP)  ; default
    ...
    PUSH EAX                            ; 00464ee9
    CALL shape_design.c_interactiveWeldVertices_FUN_00465e90 ; 00464eea
        ;   XREF to: 00465e90 (UNCONDITIONAL_CALL)  ; void shape_design.c_interactiveWeldVertices_FUN_00465e90(int polygon_index, float tolerance)
    ADD ESP,0x8                         ; 00464eef
    JMP 0x00464f45                      ; 00464ef2
        ;   XREF to: 00464f45 (UNCONDITIONAL_JUMP)  ; default
    FLD float ptr [EBP + -0x4]          ; 00464ef4
        ;   Label: caseD_5
    SUB ESP,0x4                         ; 00464ef7
    FSTP float ptr [ESP]                ; 00464efa
    CALL shape_design.c_interactiveGlobalWeld_FUN_00466040 ; 00464efd
        ;   XREF to: 00466040 (UNCONDITIONAL_CALL)  ; void shape_design.c_interactiveGlobalWeld_FUN_00466040(float tolerance)
    ADD ESP,0x4                         ; 00464f02
    JMP 0x00464f45                      ; 00464f05
        ;   XREF to: 00464f45 (UNCONDITIONAL_JUMP)  ; default
    JMP 0x00464f45                      ; 00464f07
        ;   XREF to: 00464f45 (UNCONDITIONAL_JUMP)  ; default
        ;   Label: LAB_00464f07
    ...
    JA 0x00464f07                       ; 00464f34
        ;   XREF to: 00464f07 (CONDITIONAL_JUMP)  ; LAB_00464f07
    MOV EAX,dword ptr [EBP + 0xffffff48] ; 00464f36
    SHL EAX,0x2                         ; 00464f3c
    JMP dword ptr [EAX + 0x464f0c]      ; 00464f3f | caseD_1 | caseD_2 | caseD_3
        ;   Label: switchD
    CMP dword ptr [0x015c48b8],0x0      ; 00464f45 | g_PolygonToolMode
        ;   Label: default
    JZ 0x00464f58                       ; 00464f4c
        ;   XREF to: 00464f58 (CONDITIONAL_JUMP)  ; LAB_00464f58
    ...
    CMP AL,0x0                          ; 00464f78
    JNZ 0x00464f64                      ; 00464f7a
        ;   XREF to: 00464f64 (CONDITIONAL_JUMP)  ; LAB_00464f64
    POP EDI                             ; 00464f7c
        ;   Label: LAB_00464f7c
    ...
    CMP AL,0x0                          ; 00464f8a
    JZ 0x00464f9e                       ; 00464f8c
        ;   XREF to: 00464f9e (CONDITIONAL_JUMP)  ; LAB_00464f9e
    MOV AL,byte ptr [ESI + 0x1]         ; 00464f8e | = " - Polygon merger (tol = %4.2f degs)" | s_Polygon_merger_(tol_=_%4.2f_degs_0061c401
    ADD ESI,0x2                         ; 00464f91
    MOV byte ptr [EDI + 0x1],AL         ; 00464f94
    ADD EDI,0x2                         ; 00464f97
    CMP AL,0x0                          ; 00464f9a
    JNZ 0x00464f86                      ; 00464f9c
        ;   XREF to: 00464f86 (CONDITIONAL_JUMP)  ; LAB_00464f86
    POP EDI                             ; 00464f9e
        ;   Label: LAB_00464f9e
    MOV EAX,[0x015c48b8]                ; 00464f9f | g_PolygonToolMode
    MOV dword ptr [EBP + 0xffffff44],EAX ; 00464fa4
    JMP 0x00465058                      ; 00464faa
        ;   XREF to: 00465058 (UNCONDITIONAL_JUMP)  ; LAB_00465058
    FLD float ptr [EBP + -0x4]          ; 00464faf
        ;   Label: caseD_1
    SUB ESP,0x8                         ; 00464fb2
    FSTP double ptr [ESP]               ; 00464fb5
    MOV EAX,0x61c3ff                    ; 00464fb8 | = " - Polygon merger (tol = %4.2f degs)"
    ...
    MOV EAX,0x61c424                    ; 00464fd8 | = " - Polygon attacher (tol = %4.2f units)"
    ...
    JMP 0x0046507d                      ; 00464fea
        ;   XREF to: 0046507d (UNCONDITIONAL_JUMP)  ; default
    MOV EAX,0x61c44c                    ; 00464fef | = " - Polygon detacher"
        ;   Label: caseD_3
    ...
    MOV EAX,0x61c460                    ; 0046500f | = " - Polygon vertex welder (tol = %4.2f..."
    ...
    MOV EAX,0x61c48d                    ; 0046502c | = " - Vertex welder (tol = %4.2f units)"
    ...
    JA 0x00465040                       ; 0046506c
        ;   XREF to: 00465040 (CONDITIONAL_JUMP)  ; LAB_00465040
    MOV EAX,dword ptr [EBP + 0xffffff40] ; 0046506e
    SHL EAX,0x2                         ; 00465074
    JMP dword ptr [EAX + 0x465044]      ; 00465077 | caseD_1 | caseD_2 | caseD_3
        ;   Label: switchD
    ...
    CMP AL,0x0                          ; 00465093
    JZ 0x004650a7                       ; 00465095
        ;   XREF to: 004650a7 (CONDITIONAL_JUMP)  ; LAB_004650a7
    MOV AL,byte ptr [ESI + 0x1]         ; 00465097
    ADD ESI,0x2                         ; 0046509a
    MOV byte ptr [EDI + 0x1],AL         ; 0046509d
    ADD EDI,0x2                         ; 004650a0
    CMP AL,0x0                          ; 004650a3
    JNZ 0x0046508f                      ; 004650a5
        ;   XREF to: 0046508f (CONDITIONAL_JUMP)  ; LAB_0046508f
    POP EDI                             ; 004650a7
        ;   Label: LAB_004650a7
    MOV ESI,dword ptr [0x00679398]      ; 004650a8 | g_WindowHeight
    ...
    JNZ 0x004650d5                      ; 004650ca
        ;   XREF to: 004650d5 (CONDITIONAL_JUMP)  ; LAB_004650d5
    CMP dword ptr [0x01e528bc],-0x1     ; 004650cc | g_SecondaryPolygonIndex
    JNZ 0x004650d7                      ; 004650d3
        ;   XREF to: 004650d7 (CONDITIONAL_JUMP)  ; LAB_004650d7
    JMP 0x00465147                      ; 004650d5
        ;   XREF to: 00465147 (UNCONDITIONAL_JUMP)  ; LAB_00465147
        ;   Label: LAB_004650d5
    IMUL EAX,dword ptr [EBP + 0x14],0x184 ; 004650d7
        ;   Label: LAB_004650d7
    MOV EDX,0x16e9910                   ; 004650de | g_ModelPolygonData
    ADD EAX,EDX                         ; 004650e3
    PUSH EAX                            ; 004650e5
    IMUL EAX,dword ptr [0x01e528bc],0x184 ; 004650e6 | g_SecondaryPolygonIndex
    MOV EDX,0x16e9910                   ; 004650f0 | g_ModelPolygonData
    ADD EAX,EDX                         ; 004650f5
    PUSH EAX                            ; 004650f7
    CALL shape_design.c_calculateAngleBetweenPolygonNormals_FUN_00461cb0 ; 004650f8
    ...
    MOV dword ptr [EBP + 0xffffff3c],EDX ; 00465103 | g_ModelPolygonData
    FLD double ptr [EBP + 0xffffff38]   ; 00465109
    ADD ESP,0x8                         ; 0046510f
    SUB ESP,0x8                         ; 00465112
    FSTP double ptr [ESP]               ; 00465115
    MOV EAX,0x61c4b2                    ; 00465118 | = "Angle between polygon normals : %8.6lf"
