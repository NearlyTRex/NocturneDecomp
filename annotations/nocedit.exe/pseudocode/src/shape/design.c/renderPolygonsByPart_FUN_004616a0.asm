...
section .text
    ...
    JMP 0x004616bb                      ; 004616b3
        ;   XREF to: 004616bb (UNCONDITIONAL_JUMP)  ; LAB_004616bb
    MOV EAX,dword ptr [EBP + -0x4]      ; 004616b5
        ;   Label: LAB_004616b5
    INC dword ptr [EBP + -0x4]          ; 004616b8
    MOV EAX,dword ptr [EBP + -0x4]      ; 004616bb
        ;   Label: LAB_004616bb
    CMP EAX,dword ptr [0x016e990c]      ; 004616be | g_PolygonCount
    ...
    PUSH EAX                            ; 004616db
    CALL shape_design.c_renderSinglePolygon_FUN_0045ce20 ; 004616dc
    ...
    JMP 0x004616b5                      ; 004616e4
        ;   XREF to: 004616b5 (UNCONDITIONAL_JUMP)  ; LAB_004616b5
        ;   Label: LAB_004616e4
