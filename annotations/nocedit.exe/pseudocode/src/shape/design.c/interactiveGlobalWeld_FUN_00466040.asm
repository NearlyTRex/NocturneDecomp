...
;   undefined4 g_ModelPolygonData[1].polygon_type
;
; Called Functions:
...
section .text
    ...
    CALL wincore_windll.cpp_clearScreen_FUN_005b3e70 ; 0046604c
        ;   XREF to: 005b3e70 (UNCONDITIONAL_CALL)  ; void wincore_windll.cpp_clearScreen_FUN_005b3e70()
    MOV ECX,0x61c6e6                    ; 00466051 | = "Enter weld point : "
    PUSH ECX                            ; 00466056 | = "Enter weld point : "
    PUSH 0x0                            ; 00466057
    PUSH 0x0                            ; 00466059
    PUSH 0x32                           ; 0046605b
    LEA ECX,[EBP + -0x60]               ; 0046605d
    PUSH ECX                            ; 00466060
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 00466061
    ...
    JNZ 0x0046607f                      ; 00466078
        ;   XREF to: 0046607f (CONDITIONAL_JUMP)  ; LAB_0046607f
    JMP 0x004661c3                      ; 0046607a
        ;   XREF to: 004661c3 (UNCONDITIONAL_JUMP)  ; LAB_004661c3
    LEA EAX,[EBP + -0x60]               ; 0046607f
        ;   Label: LAB_0046607f
    PUSH EAX                            ; 00466082
    CALL crt_stdlib.c_atoi_FUN_005ffef0 ; 00466083
    ...
    JL 0x0046609f                       ; 00466092
        ;   XREF to: 0046609f (CONDITIONAL_JUMP)  ; LAB_0046609f
    MOV EAX,[0x01626408]                ; 00466094 | g_VertexCount
    DEC EAX                             ; 00466099
    CMP EAX,dword ptr [EBP + -0x4]      ; 0046609a
    JGE 0x004660c0                      ; 0046609d
        ;   XREF to: 004660c0 (CONDITIONAL_JUMP)  ; LAB_004660c0
    PUSH 0x16                           ; 0046609f
        ;   Label: LAB_0046609f
    PUSH 0x0                            ; 004660a1
    ...
    CALL wincore_winrun.cpp_getNextKeypress_FUN_005f2e90 ; 004660b6
        ;   XREF to: 005f2e90 (UNCONDITIONAL_CALL)  ; int wincore_winrun.cpp_getNextKeypress_FUN_005f2e90()
    JMP 0x004661c3                      ; 004660bb
        ;   XREF to: 004661c3 (UNCONDITIONAL_JUMP)  ; LAB_004661c3
    MOV dword ptr [EBP + -0x10],0x0     ; 004660c0
        ;   Label: LAB_004660c0
    JMP 0x004660cf                      ; 004660c7
        ;   XREF to: 004660cf (UNCONDITIONAL_JUMP)  ; LAB_004660cf
    MOV EAX,dword ptr [EBP + -0x10]     ; 004660c9
        ;   Label: LAB_004660c9
    INC dword ptr [EBP + -0x10]         ; 004660cc
    MOV EAX,dword ptr [EBP + -0x10]     ; 004660cf
        ;   Label: LAB_004660cf
    CMP EAX,dword ptr [0x01626408]      ; 004660d2 | g_VertexCount
    JGE 0x004661be                      ; 004660d8
        ;   XREF to: 004661be (CONDITIONAL_JUMP)  ; LAB_004661be
    IMUL EDX,dword ptr [EBP + -0x4],0x14 ; 004660de
    IMUL EAX,dword ptr [EBP + -0x10],0x14 ; 004660e2
    FLD float ptr [EDX + 0x162640c]     ; 004660e6 | g_LoadedVertices
    FSUB float ptr [EAX + 0x162640c]    ; 004660ec | g_LoadedVertices
    FABS                                ; 004660f2
    FLD float ptr [EBP + 0x14]          ; 004660f4
    FCOMPP                              ; 004660f7
    FNSTSW AX                           ; 004660f9
    SAHF                                ; 004660fb
    JBE 0x0046611e                      ; 004660fc
        ;   XREF to: 0046611e (CONDITIONAL_JUMP)  ; LAB_0046611e
    IMUL EDX,dword ptr [EBP + -0x4],0x14 ; 004660fe
    IMUL EAX,dword ptr [EBP + -0x10],0x14 ; 00466102
    FLD float ptr [EDX + 0x1626410]     ; 00466106 | g_LoadedVertices[0].vertex.y
    FSUB float ptr [EAX + 0x1626410]    ; 0046610c | g_LoadedVertices[0].vertex.y
    FABS                                ; 00466112
    FLD float ptr [EBP + 0x14]          ; 00466114
    FCOMPP                              ; 00466117
    FNSTSW AX                           ; 00466119
    SAHF                                ; 0046611b
    JA 0x00466120                       ; 0046611c
        ;   XREF to: 00466120 (CONDITIONAL_JUMP)  ; LAB_00466120
    JMP 0x00466140                      ; 0046611e
        ;   XREF to: 00466140 (UNCONDITIONAL_JUMP)  ; LAB_00466140
        ;   Label: LAB_0046611e
    ...
    FNSTSW AX                           ; 0046613b
    SAHF                                ; 0046613d
    JA 0x00466145                       ; 0046613e
        ;   XREF to: 00466145 (CONDITIONAL_JUMP)  ; LAB_00466145
    JMP 0x004661b9                      ; 00466140
        ;   XREF to: 004661b9 (UNCONDITIONAL_JUMP)  ; LAB_004661b9
        ;   Label: LAB_00466140
    MOV dword ptr [EBP + -0x64],0x16e9910 ; 00466145 | g_ModelPolygonData
        ;   Label: LAB_00466145
    MOV dword ptr [EBP + -0xc],0x0      ; 0046614c
    JMP 0x00466165                      ; 00466153
        ;   XREF to: 00466165 (UNCONDITIONAL_JUMP)  ; LAB_00466165
    MOV EAX,dword ptr [EBP + -0xc]      ; 00466155
        ;   Label: LAB_00466155
    INC dword ptr [EBP + -0xc]          ; 00466158
    MOV EAX,dword ptr [EBP + -0x64]     ; 0046615b
    ADD dword ptr [EBP + -0x64],0x184   ; 0046615e | g_ModelPolygonData[1].polygon_type
    MOV EAX,dword ptr [EBP + -0xc]      ; 00466165
        ;   Label: LAB_00466165
    CMP EAX,dword ptr [0x016e990c]      ; 00466168 | g_PolygonCount
    JGE 0x004661b9                      ; 0046616e
        ;   XREF to: 004661b9 (CONDITIONAL_JUMP)  ; LAB_004661b9
    MOV dword ptr [EBP + -0x8],0x0      ; 00466170
    JMP 0x0046617f                      ; 00466177
        ;   XREF to: 0046617f (UNCONDITIONAL_JUMP)  ; LAB_0046617f
    ...
    CMP EAX,dword ptr [EDX + 0xa4]      ; 00466185 | g_ModelPolygonData[0].vertex_indices_count
    JGE 0x004661b7                      ; 0046618b
        ;   XREF to: 004661b7 (CONDITIONAL_JUMP)  ; LAB_004661b7
    MOV EAX,dword ptr [EBP + -0x8]      ; 0046618d
    SHL EAX,0x2                         ; 00466190
    ADD EAX,dword ptr [EBP + -0x64]     ; 00466193
    MOV EAX,dword ptr [EAX + 0xb8]      ; 00466196 | g_ModelPolygonData[0].vertex_indices[0]
    CMP EAX,dword ptr [EBP + -0x10]     ; 0046619c
    JNZ 0x004661b5                      ; 0046619f
        ;   XREF to: 004661b5 (CONDITIONAL_JUMP)  ; LAB_004661b5
    ...
    MOV dword ptr [EDX + 0xb8],EAX      ; 004661af | g_ModelPolygonData[0].vertex_indices[0]
    JMP 0x00466179                      ; 004661b5
        ;   XREF to: 00466179 (UNCONDITIONAL_JUMP)  ; LAB_00466179
        ;   Label: LAB_004661b5
    JMP 0x00466155                      ; 004661b7
        ;   XREF to: 00466155 (UNCONDITIONAL_JUMP)  ; LAB_00466155
        ;   Label: LAB_004661b7
    JMP 0x004660c9                      ; 004661b9
        ;   XREF to: 004660c9 (UNCONDITIONAL_JUMP)  ; LAB_004660c9
        ;   Label: LAB_004661b9
    CALL shape_design.c_removeUnusedVertices_FUN_00463830 ; 004661be
