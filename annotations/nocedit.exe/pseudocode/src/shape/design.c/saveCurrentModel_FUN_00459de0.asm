...
section .text
    ...
    CALL wincore_windll.cpp_clearScreen_FUN_005b3e70 ; 00459dec | void wincore_windll.cpp_clearScreen_FUN_005b3e70()
        ;   XREF to: 005b3e70 (UNCONDITIONAL_CALL)
    MOV EDX,0x61ad80                    ; 00459df1 | = "Model name to save : " | s_Model_name_to_save_0061ad80 = Model name to save :
    PUSH EDX                            ; 00459df6 | = "Model name to save : " | s_Model_name_to_save_0061ad80 = Model name to save :
    PUSH 0x0                            ; 00459df7
    PUSH 0x0                            ; 00459df9
    PUSH 0x28                           ; 00459dfb
    LEA EDX,[EBP + -0x50]               ; 00459dfd
    PUSH EDX                            ; 00459e00
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 00459e01 | int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
    ...
    MOV AL,byte ptr [ESI]               ; 00459e11
        ;   Label: LAB_00459e11
    CMP AL,DL                           ; 00459e13
    JZ 0x00459e29                       ; 00459e15 | LAB_00459e29
        ;   XREF to: 00459e29 (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 00459e17
    JZ 0x00459e27                       ; 00459e19 | LAB_00459e27
        ;   XREF to: 00459e27 (CONDITIONAL_JUMP)
    INC ESI                             ; 00459e1b
    MOV AL,byte ptr [ESI]               ; 00459e1c
    CMP AL,DL                           ; 00459e1e
    JZ 0x00459e29                       ; 00459e20 | LAB_00459e29
        ;   XREF to: 00459e29 (CONDITIONAL_JUMP)
    INC ESI                             ; 00459e22
    CMP AL,0x0                          ; 00459e23
    JNZ 0x00459e11                      ; 00459e25 | LAB_00459e11
        ;   XREF to: 00459e11 (CONDITIONAL_JUMP)
    SUB ESI,ESI                         ; 00459e27
        ;   Label: LAB_00459e27
    TEST ESI,ESI                        ; 00459e29
        ;   Label: LAB_00459e29
    JNZ 0x00459e3f                      ; 00459e2b | LAB_00459e3f
    ...
    JBE 0x00459e41                      ; 00459e3d | LAB_00459e41
        ;   XREF to: 00459e41 (CONDITIONAL_JUMP)
    JMP 0x00459e6b                      ; 00459e3f | LAB_00459e6b
        ;   Label: LAB_00459e3f
        ;   XREF to: 00459e6b (UNCONDITIONAL_JUMP)
    MOV ESI,0x61ad96                    ; 00459e41 | = ".MDL" | s_MDL_0061ad96 = .MDL
        ;   Label: LAB_00459e41
    ...
    DEC EDI                             ; 00459e51
    MOV AL,byte ptr [ESI]               ; 00459e52 | = ".MDL" | s_MDL_0061ad96 = .MDL
        ;   Label: LAB_00459e52
    MOV byte ptr [EDI],AL               ; 00459e54
    CMP AL,0x0                          ; 00459e56
    JZ 0x00459e6a                       ; 00459e58 | LAB_00459e6a
        ;   XREF to: 00459e6a (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 00459e5a | DAT_0061ad97
    ADD ESI,0x2                         ; 00459e5d
    MOV byte ptr [EDI + 0x1],AL         ; 00459e60
    ADD EDI,0x2                         ; 00459e63
    CMP AL,0x0                          ; 00459e66
    JNZ 0x00459e52                      ; 00459e68 | LAB_00459e52
    ...
    LEA EAX,[EBP + -0x50]               ; 00459e6b
        ;   Label: LAB_00459e6b
    PUSH EAX                            ; 00459e6e
    CALL shape_design.c_exportModelToMDL_FUN_00459e80 ; 00459e6f | void shape_design.c_exportModelToMDL_FUN_00459e80(char * mdl_filename)
