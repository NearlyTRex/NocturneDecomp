...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_design.c_vertexReducer_FUN_00467850(float tolerance, float angle_tolerance, int display_progress)
;
; Parameters:
...
section .text
    ...
    MOV EAX,[0x01626408]                ; 0046785c | int g_VertexCount
    MOV dword ptr [EBP + -0x14],EAX     ; 00467861
    MOV dword ptr [EBP + -0x10],0x0     ; 00467864
    MOV EAX,[0x016e990c]                ; 0046786b | int g_PolygonCount
    MOV dword ptr [EBP + -0xc],EAX      ; 00467870
    CMP dword ptr [0x01626408],0x1      ; 00467873 | int g_VertexCount
    JGE 0x00467881                      ; 0046787a | LAB_00467881
        ;   XREF to: 00467881 (CONDITIONAL_JUMP)
    JMP 0x00467e5e                      ; 0046787c | LAB_00467e5e
        ;   XREF to: 00467e5e (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBP + 0x1c],0x0      ; 00467881
        ;   Label: LAB_00467881
    JLE 0x004678b3                      ; 00467885 | LAB_004678b3
        ;   XREF to: 004678b3 (CONDITIONAL_JUMP)
    CALL wincore_windll.cpp_clearScreen_FUN_005b3e70 ; 00467887 | void wincore_windll.cpp_clearScreen_FUN_005b3e70()
        ;   XREF to: 005b3e70 (UNCONDITIONAL_CALL)
    MOV EAX,0x61ca0d                    ; 0046788c | = "Enter tolerance [.1] : " | s_Enter_tolerance_1_0061ca0d = Enter tolerance [.1] :
    PUSH EAX                            ; 00467891 | = "Enter tolerance [.1] : " | s_Enter_tolerance_1_0061ca0d = Enter tolerance [.1] :
    PUSH 0x0                            ; 00467892
    PUSH 0x0                            ; 00467894
    PUSH 0x14                           ; 00467896
    LEA EAX,[EBP + 0xfffffedc]          ; 00467898
    PUSH EAX                            ; 0046789e
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 0046789f | int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
        ;   XREF to: 004032c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 004678a4
    CMP EAX,0x1b                        ; 004678a7
    JNZ 0x004678b1                      ; 004678aa | LAB_004678b1
        ;   XREF to: 004678b1 (CONDITIONAL_JUMP)
    JMP 0x00467e5e                      ; 004678ac | LAB_00467e5e
        ;   XREF to: 00467e5e (UNCONDITIONAL_JUMP)
    JMP 0x004678ba                      ; 004678b1 | LAB_004678ba
        ;   Label: LAB_004678b1
    ...
    JZ 0x004678f2                       ; 004678cc | LAB_004678f2
        ;   XREF to: 004678f2 (CONDITIONAL_JUMP)
    LEA EAX,[EBP + 0xfffffedc]          ; 004678ce
    PUSH EAX                            ; 004678d4
    CALL crt_string.c_strtod_FUN_005ff0f3 ; 004678d5 | double crt_string.c_strtod_FUN_005ff0f3(char * str)
    ...
    CMP dword ptr [EBP + 0x1c],0x0      ; 004678f2
        ;   Label: LAB_004678f2
    JLE 0x00467996                      ; 004678f6 | LAB_00467996
        ;   XREF to: 00467996 (CONDITIONAL_JUMP)
    MOV EAX,0x61ca25                    ; 004678fc | = "Check normals? [n] : " | s_Check_normals_n_0061ca25 = Check normals? [n] :
    PUSH EAX                            ; 00467901 | = "Check normals? [n] : " | s_Check_normals_n_0061ca25 = Check normals? [n] :
    PUSH 0x16                           ; 00467902
    PUSH 0x0                            ; 00467904
    PUSH 0x14                           ; 00467906
    LEA EAX,[EBP + 0xfffffedc]          ; 00467908
    PUSH EAX                            ; 0046790e
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 0046790f | int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
        ;   XREF to: 004032c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 00467914
    XOR EAX,EAX                         ; 00467917
    MOV AL,byte ptr [EBP + 0xfffffedc]  ; 00467919
    PUSH EAX                            ; 0046791f
    CALL crt_ctype.c_toupper_FUN_005ff9e0 ; 00467920 | int crt_ctype.c_toupper_FUN_005ff9e0(int c)
        ;   XREF to: 005ff9e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00467925
    CMP EAX,0x59                        ; 00467928
    JNZ 0x00467934                      ; 0046792b | LAB_00467934
        ;   XREF to: 00467934 (CONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x10],0x1     ; 0046792d
    CMP dword ptr [EBP + -0x10],0x1     ; 00467934
        ;   Label: LAB_00467934
    JNZ 0x00467994                      ; 00467938 | LAB_00467994
        ;   XREF to: 00467994 (CONDITIONAL_JUMP)
    MOV ECX,0x61ca3b                    ; 0046793a | = "Enter angle tolerance [90.0] : " | s_Enter_angle_tolerance_90_0061ca3b = Enter angle tolerance [90.0] :
    PUSH ECX                            ; 0046793f | = "Enter angle tolerance [90.0] : " | s_Enter_angle_tolerance_90_0061ca3b = Enter angle tolerance [90.0] :
    PUSH 0x2c                           ; 00467940
    PUSH 0x0                            ; 00467942
    PUSH 0x14                           ; 00467944
    LEA ECX,[EBP + 0xfffffedc]          ; 00467946
    PUSH ECX                            ; 0046794c
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 0046794d | int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
        ;   XREF to: 004032c0 (UNCONDITIONAL_CALL)
    ...
    JZ 0x00467994                       ; 0046796e | LAB_00467994
        ;   XREF to: 00467994 (CONDITIONAL_JUMP)
    LEA EAX,[EBP + 0xfffffedc]          ; 00467970
    PUSH EAX                            ; 00467976
    CALL crt_string.c_strtod_FUN_005ff0f3 ; 00467977 | double crt_string.c_strtod_FUN_005ff0f3(char * str)
        ;   XREF to: 005ff0f3 (UNCONDITIONAL_CALL)
    ...
    JMP 0x004679a9                      ; 00467994 | LAB_004679a9
        ;   Label: LAB_00467994
    ...
    FNSTSW AX                           ; 0046799d
    SAHF                                ; 0046799f
    JA 0x004679a9                       ; 004679a0 | LAB_004679a9
        ;   XREF to: 004679a9 (CONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x10],0x1     ; 004679a2
    CMP dword ptr [EBP + 0x1c],0x0      ; 004679a9
        ;   Label: LAB_004679a9
    JL 0x004679cb                       ; 004679ad | LAB_004679cb
        ;   XREF to: 004679cb (CONDITIONAL_JUMP)
    CALL wincore_windll.cpp_clearScreen_FUN_005b3e70 ; 004679af | void wincore_windll.cpp_clearScreen_FUN_005b3e70()
        ;   XREF to: 005b3e70 (UNCONDITIONAL_CALL)
    PUSH 0x0                            ; 004679b4
    PUSH 0x0                            ; 004679b6
    MOV EAX,0x61ca5b                    ; 004679b8 | = "Scanning vertices..." | s_Scanning_vertices_0061ca5b = Scanning vertices...
    PUSH EAX                            ; 004679bd | = "Scanning vertices..." | s_Scanning_vertices_0061ca5b = Scanning vertices...
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 004679be | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004679c3
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 004679c6 | void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20()
        ;   XREF to: 005eda20 (UNCONDITIONAL_CALL)
    MOV EAX,[0x01626408]                ; 004679cb | int g_VertexCount
        ;   Label: LAB_004679cb
    MOV dword ptr [EBP + -0x18],EAX     ; 004679d0
    PUSH 0x20b8                         ; 004679d3
    MOV EAX,0x61ca70                    ; 004679d8 | = "..\\shape\\design.c" | s_shape_design_c_0061ca70 = ..\shape\design.c
    PUSH EAX                            ; 004679dd | = "..\\shape\\design.c" | s_shape_design_c_0061ca70 = ..\shape\design.c
    MOV EAX,[0x01626408]                ; 004679de | int g_VertexCount
    SHL EAX,0x3                         ; 004679e3
    PUSH EAX                            ; 004679e6
    CALL shape_memdbg.cpp_debugMalloc_FUN_0050f250 ; 004679e7 | void * shape_memdbg.cpp_debugMalloc_FUN_0050f250(int size, char * filename, int line_number)
        ;   XREF to: 0050f250 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004679ec
    MOV dword ptr [EBP + -0x8],EAX      ; 004679ef
    CMP dword ptr [EBP + -0x8],0x0      ; 004679f2
    JNZ 0x00467a1e                      ; 004679f6 | LAB_00467a1e
        ;   XREF to: 00467a1e (CONDITIONAL_JUMP)
    CALL wincore_windll.cpp_clearScreen_FUN_005b3e70 ; 004679f8 | void wincore_windll.cpp_clearScreen_FUN_005b3e70()
        ;   XREF to: 005b3e70 (UNCONDITIONAL_CALL)
    PUSH 0x0                            ; 004679fd
    PUSH 0x0                            ; 004679ff
    MOV EAX,0x61ca82                    ; 00467a01 | = "ERROR: Can't allocate memory for vert..." | s_ERROR_Can_t_allocate_mem_0061ca82 = ERROR: Can't allocate memory for vertex reducer array.
    PUSH EAX                            ; 00467a06 | = "ERROR: Can't allocate memory for vert..." | s_ERROR_Can_t_allocate_mem_0061ca82 = ERROR: Can't allocate memory for vertex reducer array.
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 00467a07 | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00467a0c
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 00467a0f | void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20()
        ;   XREF to: 005eda20 (UNCONDITIONAL_CALL)
    CALL wincore_winrun.cpp_getNextKeypress_FUN_005f2e90 ; 00467a14 | int wincore_winrun.cpp_getNextKeypress_FUN_005f2e90()
        ;   XREF to: 005f2e90 (UNCONDITIONAL_CALL)
    JMP 0x00467e5e                      ; 00467a19 | LAB_00467e5e
        ;   XREF to: 00467e5e (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x24],0x0     ; 00467a1e
        ;   Label: LAB_00467a1e
    JMP 0x00467a2a                      ; 00467a25 | LAB_00467a2a
        ;   XREF to: 00467a2a (UNCONDITIONAL_JUMP)
    INC dword ptr [EBP + -0x24]         ; 00467a27
        ;   Label: LAB_00467a27
    MOV EAX,dword ptr [EBP + -0x24]     ; 00467a2a
        ;   Label: LAB_00467a2a
    CMP EAX,dword ptr [0x01626408]      ; 00467a2d | int g_VertexCount
    JGE 0x00467a58                      ; 00467a33 | LAB_00467a58
    ...
    JMP 0x00467a27                      ; 00467a56 | LAB_00467a27
        ;   XREF to: 00467a27 (UNCONDITIONAL_JUMP)
    MOV EAX,0x4676f0                    ; 00467a58
        ;   Label: LAB_00467a58
    PUSH EAX                            ; 00467a5d
    PUSH 0x8                            ; 00467a5e
    PUSH dword ptr [0x01626408]         ; 00467a60 | int g_VertexCount
    MOV EAX,dword ptr [EBP + -0x8]      ; 00467a66
    PUSH EAX                            ; 00467a69
    CALL crt_stdlib.c_qsort_FUN_005fdf38 ; 00467a6a | void crt_stdlib.c_qsort_FUN_005fdf38(void * base, SIZE_T num, SIZE_T size, QSORT_COMPARATOR compar)
        ;   XREF to: 005fdf38 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00467a6f
    CMP dword ptr [EBP + -0x10],0x0     ; 00467a72
    JZ 0x00467b40                       ; 00467a76 | LAB_00467b40
        ;   XREF to: 00467b40 (CONDITIONAL_JUMP)
    PUSH 0x20dc                         ; 00467a7c
    MOV EAX,0x61cab9                    ; 00467a81 | = "..\\shape\\design.c" | s_shape_design_c_0061cab9 = ..\shape\design.c
    PUSH EAX                            ; 00467a86 | = "..\\shape\\design.c" | s_shape_design_c_0061cab9 = ..\shape\design.c
    MOV EAX,[0x01626408]                ; 00467a87 | int g_VertexCount
    SHL EAX,0x2                         ; 00467a8c
    PUSH EAX                            ; 00467a8f
    CALL shape_memdbg.cpp_debugMalloc_FUN_0050f250 ; 00467a90 | void * shape_memdbg.cpp_debugMalloc_FUN_0050f250(int size, char * filename, int line_number)
        ;   XREF to: 0050f250 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00467a95
    MOV dword ptr [EBP + -0x4],EAX      ; 00467a98
    CMP dword ptr [EBP + -0x4],0x0      ; 00467a9b
    JNZ 0x00467ade                      ; 00467a9f | LAB_00467ade
        ;   XREF to: 00467ade (CONDITIONAL_JUMP)
    PUSH 0x20de                         ; 00467aa1
    MOV EAX,0x61cacb                    ; 00467aa6 | = "..\\shape\\design.c" | s_shape_design_c_0061cacb = ..\shape\design.c
    PUSH EAX                            ; 00467aab | = "..\\shape\\design.c" | s_shape_design_c_0061cacb = ..\shape\design.c
    MOV EAX,dword ptr [EBP + -0x8]      ; 00467aac
    PUSH EAX                            ; 00467aaf
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 00467ab0 | void shape_memdbg.cpp_debugFree_FUN_0050f460(void * ptr, char * filename, int line_number)
        ;   XREF to: 0050f460 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00467ab5
    CALL wincore_windll.cpp_clearScreen_FUN_005b3e70 ; 00467ab8 | void wincore_windll.cpp_clearScreen_FUN_005b3e70()
        ;   XREF to: 005b3e70 (UNCONDITIONAL_CALL)
    PUSH 0x0                            ; 00467abd
    PUSH 0x0                            ; 00467abf
    MOV EAX,0x61cadd                    ; 00467ac1 | = "ERROR: Can't allocate memory for vert..." | s_ERROR_Can_t_allocate_mem_0061cadd = ERROR: Can't allocate memory for vertex reducer array.
    PUSH EAX                            ; 00467ac6 | = "ERROR: Can't allocate memory for vert..." | s_ERROR_Can_t_allocate_mem_0061cadd = ERROR: Can't allocate memory for vertex reducer array.
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 00467ac7 | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00467acc
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 00467acf | void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20()
        ;   XREF to: 005eda20 (UNCONDITIONAL_CALL)
    CALL wincore_winrun.cpp_getNextKeypress_FUN_005f2e90 ; 00467ad4 | int wincore_winrun.cpp_getNextKeypress_FUN_005f2e90()
        ;   XREF to: 005f2e90 (UNCONDITIONAL_CALL)
    JMP 0x00467e5e                      ; 00467ad9 | LAB_00467e5e
        ;   XREF to: 00467e5e (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x24],0x0     ; 00467ade
        ;   Label: LAB_00467ade
    JMP 0x00467aea                      ; 00467ae5 | LAB_00467aea
        ;   XREF to: 00467aea (UNCONDITIONAL_JUMP)
    INC dword ptr [EBP + -0x24]         ; 00467ae7
        ;   Label: LAB_00467ae7
    MOV EAX,dword ptr [EBP + -0x24]     ; 00467aea
        ;   Label: LAB_00467aea
    CMP EAX,dword ptr [0x016e990c]      ; 00467aed | int g_PolygonCount
    JGE 0x00467b40                      ; 00467af3 | LAB_00467b40
        ;   XREF to: 00467b40 (CONDITIONAL_JUMP)
    IMUL EAX,dword ptr [EBP + -0x24],0x184 ; 00467af5
    MOV EDX,0x16e9910                   ; 00467afc | SShapeEditorPolygon[20000] g_ModelPolygonData
    ADD EDX,EAX                         ; 00467b01
    MOV dword ptr [EBP + -0x1c],EDX     ; 00467b03
    MOV dword ptr [EBP + -0x20],0x0     ; 00467b06
    JMP 0x00467b12                      ; 00467b0d | LAB_00467b12
    ...
    JGE 0x00467b3e                      ; 00467b1e | LAB_00467b3e
    ...
    JZ 0x00467b80                       ; 00467b79 | LAB_00467b80
        ;   XREF to: 00467b80 (CONDITIONAL_JUMP)
    JMP 0x00467cf0                      ; 00467b7b | LAB_00467cf0
    ...
    MOV EDX,0x162640c                   ; 00467b8c | SVertexData[20000] g_LoadedVertices
    ...
    JMP 0x00467ba8                      ; 00467ba0 | LAB_00467ba8
    ...
    MOV EAX,dword ptr [EBP + -0x20]     ; 00467ba8
        ;   Label: LAB_00467ba8
    CMP EAX,dword ptr [0x01626408]      ; 00467bab | int g_VertexCount
    JGE 0x00467cf0                      ; 00467bb1 | LAB_00467cf0
    ...
    JZ 0x00467bd9                       ; 00467bd2 | LAB_00467bd9
        ;   XREF to: 00467bd9 (CONDITIONAL_JUMP)
    JMP 0x00467ceb                      ; 00467bd4 | LAB_00467ceb
    ...
    MOV EDX,0x162640c                   ; 00467be5 | SVertexData[20000] g_LoadedVertices
    ADD EDX,EAX                         ; 00467bea
    MOV dword ptr [EBP + 0xfffffecc],EDX ; 00467bec
    MOV EAX,dword ptr [EBP + 0xfffffed0] ; 00467bf2
    FLD float ptr [EAX]                 ; 00467bf8 | SVertexData[20000] g_LoadedVertices
    FADD float ptr [EBP + 0x14]         ; 00467bfa
    MOV EAX,dword ptr [EBP + 0xfffffecc] ; 00467bfd
    FCOMP float ptr [EAX]               ; 00467c03 | SVertexData[20000] g_LoadedVertices
    FNSTSW AX                           ; 00467c05
    SAHF                                ; 00467c07
    JNC 0x00467c0f                      ; 00467c08 | LAB_00467c0f
        ;   XREF to: 00467c0f (CONDITIONAL_JUMP)
    JMP 0x00467cf0                      ; 00467c0a | LAB_00467cf0
        ;   XREF to: 00467cf0 (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + 0xfffffed0] ; 00467c0f
        ;   Label: LAB_00467c0f
    FLD float ptr [EAX]                 ; 00467c15 | SVertexData[20000] g_LoadedVertices
    MOV EAX,dword ptr [EBP + 0xfffffecc] ; 00467c17
    FSUB float ptr [EAX]                ; 00467c1d | SVertexData[20000] g_LoadedVertices
    FABS                                ; 00467c1f
    FLD float ptr [EBP + 0x14]          ; 00467c21
    FCOMPP                              ; 00467c24
    FNSTSW AX                           ; 00467c26
    SAHF                                ; 00467c28
    JBE 0x00467c49                      ; 00467c29 | LAB_00467c49
    ...
    FNSTSW AX                           ; 00467c44
    SAHF                                ; 00467c46
    JA 0x00467c4b                       ; 00467c47 | LAB_00467c4b
        ;   XREF to: 00467c4b (CONDITIONAL_JUMP)
    JMP 0x00467c69                      ; 00467c49 | LAB_00467c69
        ;   Label: LAB_00467c49
    ...
    FNSTSW AX                           ; 00467c64
    SAHF                                ; 00467c66
    JA 0x00467c6b                       ; 00467c67 | LAB_00467c6b
        ;   XREF to: 00467c6b (CONDITIONAL_JUMP)
    JMP 0x00467cce                      ; 00467c69 | LAB_00467cce
        ;   Label: LAB_00467c69
        ;   XREF to: 00467cce (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0x10],0x0     ; 00467c6b
        ;   Label: LAB_00467c6b
    JZ 0x00467ccc                       ; 00467c6f | LAB_00467ccc
        ;   XREF to: 00467ccc (CONDITIONAL_JUMP)
    FLD float ptr [EBP + 0x18]          ; 00467c71
    FMUL double ptr [0x0061cb16]        ; 00467c74 | double g_VertexReducerDegreesToRadiansConversion
    FCOS                                ; 00467c7a
    ...
    MOV EDX,0x16e9910                   ; 00467c99 | SShapeEditorPolygon[20000] g_ModelPolygonData
    ...
    MOV EDX,0x16e9910                   ; 00467cb8 | SShapeEditorPolygon[20000] g_ModelPolygonData
    ADD EAX,EDX                         ; 00467cbd
    PUSH EAX                            ; 00467cbf
    CALL shape_design.c_validatePolygonNormals_FUN_00461d80 ; 00467cc0 | int shape_design.c_validatePolygonNormals_FUN_00461d80(SShapeEditorPolygon * polygon1, SShapeEditorPolygon * polygon2, double cos_tolerance)
        ;   XREF to: 00461d80 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00467cc5
    TEST EAX,EAX                        ; 00467cc8
    JZ 0x00467cce                       ; 00467cca | LAB_00467cce
        ;   XREF to: 00467cce (CONDITIONAL_JUMP)
    JMP 0x00467cd0                      ; 00467ccc | LAB_00467cd0
        ;   Label: LAB_00467ccc
        ;   XREF to: 00467cd0 (UNCONDITIONAL_JUMP)
    JMP 0x00467ceb                      ; 00467cce | LAB_00467ceb
        ;   Label: LAB_00467cce
        ;   XREF to: 00467ceb (UNCONDITIONAL_JUMP)
    ...
    JMP 0x00467ba2                      ; 00467ceb | LAB_00467ba2
        ;   Label: LAB_00467ceb
        ;   XREF to: 00467ba2 (UNCONDITIONAL_JUMP)
    JMP 0x00467b49                      ; 00467cf0 | LAB_00467b49
        ;   Label: LAB_00467cf0
    ...
    PUSH EAX                            ; 00467cfa
    PUSH 0x8                            ; 00467cfb
    PUSH dword ptr [0x01626408]         ; 00467cfd | int g_VertexCount
    MOV EAX,dword ptr [EBP + -0x8]      ; 00467d03
    PUSH EAX                            ; 00467d06
    CALL crt_stdlib.c_qsort_FUN_005fdf38 ; 00467d07 | void crt_stdlib.c_qsort_FUN_005fdf38(void * base, SIZE_T num, SIZE_T size, QSORT_COMPARATOR compar)
        ;   XREF to: 005fdf38 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00467d0c
    MOV dword ptr [EBP + -0x24],0x0     ; 00467d0f
    JMP 0x00467d1b                      ; 00467d16 | LAB_00467d1b
        ;   XREF to: 00467d1b (UNCONDITIONAL_JUMP)
    INC dword ptr [EBP + -0x24]         ; 00467d18
        ;   Label: LAB_00467d18
    MOV EAX,dword ptr [EBP + -0x24]     ; 00467d1b
        ;   Label: LAB_00467d1b
    CMP EAX,dword ptr [0x016e990c]      ; 00467d1e | int g_PolygonCount
    JGE 0x00467d80                      ; 00467d24 | LAB_00467d80
        ;   XREF to: 00467d80 (CONDITIONAL_JUMP)
    IMUL EAX,dword ptr [EBP + -0x24],0x184 ; 00467d26
    MOV EDX,0x16e9910                   ; 00467d2d | SShapeEditorPolygon[20000] g_ModelPolygonData
    ADD EDX,EAX                         ; 00467d32
    MOV dword ptr [EBP + -0x1c],EDX     ; 00467d34
    MOV dword ptr [EBP + -0x20],0x0     ; 00467d37
    JMP 0x00467d43                      ; 00467d3e | LAB_00467d43
    ...
    JGE 0x00467d7e                      ; 00467d4f | LAB_00467d7e
    ...
    JMP 0x00467d40                      ; 00467d7c | LAB_00467d40
        ;   XREF to: 00467d40 (UNCONDITIONAL_JUMP)
    JMP 0x00467d18                      ; 00467d7e | LAB_00467d18
        ;   Label: LAB_00467d7e
        ;   XREF to: 00467d18 (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0x10],0x0     ; 00467d80
        ;   Label: LAB_00467d80
    JZ 0x00467d9d                       ; 00467d84 | LAB_00467d9d
        ;   XREF to: 00467d9d (CONDITIONAL_JUMP)
    PUSH 0x2138                         ; 00467d86
    MOV EAX,0x61cb1e                    ; 00467d8b | = "..\\shape\\design.c" | s_shape_design_c_0061cb1e = ..\shape\design.c
    PUSH EAX                            ; 00467d90 | = "..\\shape\\design.c" | s_shape_design_c_0061cb1e = ..\shape\design.c
    MOV EAX,dword ptr [EBP + -0x4]      ; 00467d91
    PUSH EAX                            ; 00467d94
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 00467d95 | void shape_memdbg.cpp_debugFree_FUN_0050f460(void * ptr, char * filename, int line_number)
        ;   XREF to: 0050f460 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00467d9a
    PUSH 0x213c                         ; 00467d9d
        ;   Label: LAB_00467d9d
    MOV EAX,0x61cb30                    ; 00467da2 | = "..\\shape\\design.c" | s_shape_design_c_0061cb30 = ..\shape\design.c
    PUSH EAX                            ; 00467da7 | = "..\\shape\\design.c" | s_shape_design_c_0061cb30 = ..\shape\design.c
    MOV EAX,dword ptr [EBP + -0x8]      ; 00467da8
    PUSH EAX                            ; 00467dab
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 00467dac | void shape_memdbg.cpp_debugFree_FUN_0050f460(void * ptr, char * filename, int line_number)
        ;   XREF to: 0050f460 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00467db1
    CALL shape_design.c_removeUnusedVertices_FUN_00463830 ; 00467db4 | void shape_design.c_removeUnusedVertices_FUN_00463830()
        ;   XREF to: 00463830 (UNCONDITIONAL_CALL)
    MOV EAX,[0x01626408]                ; 00467db9 | int g_VertexCount
    CMP EAX,dword ptr [EBP + -0x18]     ; 00467dbe
    JZ 0x00467dc8                       ; 00467dc1 | LAB_00467dc8
        ;   XREF to: 00467dc8 (CONDITIONAL_JUMP)
    JMP 0x004679cb                      ; 00467dc3 | LAB_004679cb
        ;   XREF to: 004679cb (UNCONDITIONAL_JUMP)
    CALL shape_design.c_removeDegenerateTriangles_FUN_00463a20 ; 00467dc8 | void shape_design.c_removeDegenerateTriangles_FUN_00463a20()
        ;   Label: LAB_00467dc8
        ;   XREF to: 00463a20 (UNCONDITIONAL_CALL)
    INC dword ptr [0x01e528a4]          ; 00467dcd | int g_VertexOptimizationPasses
    MOV EAX,dword ptr [EBP + -0xc]      ; 00467dd3
    SUB EAX,dword ptr [0x016e990c]      ; 00467dd6 | int g_PolygonCount
    PUSH EAX                            ; 00467ddc
    PUSH dword ptr [0x01e528a4]         ; 00467ddd | int g_VertexOptimizationPasses
    PUSH dword ptr [0x01626408]         ; 00467de3 | int g_VertexCount
    MOV EAX,dword ptr [EBP + -0x14]     ; 00467de9
    PUSH EAX                            ; 00467dec
    MOV EAX,0x61cb42                    ; 00467ded | = "Original vertices: %d    New total: %..." | s_Original_vertices_d_New__0061cb42 = Original vertices: %d    New total: %d

    %d                                  ; Total passes

    %d                                  ; Polys removed
    PUSH EAX                            ; 00467df2 | = "Original vertices: %d    New total: %..." | s_Original_vertices_d_New__0061cb42 = Original vertices: %d    New total: %d
    ...
    PUSH EAX                            ; 00467df9
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 00467dfa | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x18                        ; 00467dff
    CMP dword ptr [EBP + 0x1c],0x0      ; 00467e02
    JLE 0x00467e35                      ; 00467e06 | LAB_00467e35
        ;   XREF to: 00467e35 (CONDITIONAL_JUMP)
    MOV ESI,0x61cb8e                    ; 00467e08 | = "\n\nHit a key..." | s_Hit_a_key_0061cb8e =
    ...
    CMP AL,0x0                          ; 00467e20
    JZ 0x00467e34                       ; 00467e22 | LAB_00467e34
        ;   XREF to: 00467e34 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 00467e24 | s_Hit_a_key..._0061cb8f
    ADD ESI,0x2                         ; 00467e27
    MOV byte ptr [EDI + 0x1],AL         ; 00467e2a
    ADD EDI,0x2                         ; 00467e2d
    CMP AL,0x0                          ; 00467e30
    JNZ 0x00467e1c                      ; 00467e32 | LAB_00467e1c
        ;   XREF to: 00467e1c (CONDITIONAL_JUMP)
    POP EDI                             ; 00467e34
        ;   Label: LAB_00467e34
    CMP dword ptr [EBP + 0x1c],0x0      ; 00467e35
        ;   Label: LAB_00467e35
    JL 0x00467e53                       ; 00467e39 | LAB_00467e53
        ;   XREF to: 00467e53 (CONDITIONAL_JUMP)
    PUSH 0x0                            ; 00467e3b
    PUSH 0x0                            ; 00467e3d
    LEA EAX,[EBP + 0xfffffedc]          ; 00467e3f
    PUSH EAX                            ; 00467e45
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 00467e46 | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00467e4b
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 00467e4e | void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20()
        ;   XREF to: 005eda20 (UNCONDITIONAL_CALL)
    CMP dword ptr [EBP + 0x1c],0x0      ; 00467e53
        ;   Label: LAB_00467e53
    JLE 0x00467e5e                      ; 00467e57 | LAB_00467e5e
        ;   XREF to: 00467e5e (CONDITIONAL_JUMP)
    CALL wincore_winrun.cpp_getNextKeypress_FUN_005f2e90 ; 00467e59 | int wincore_winrun.cpp_getNextKeypress_FUN_005f2e90()
        ;   XREF to: 005f2e90 (UNCONDITIONAL_CALL)
