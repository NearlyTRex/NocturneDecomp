...

{
  ...
  if (bVar1) {
    ...
    crt_stdio_c_sprintf_FUN_005fdbd0
              ((char *)local_68,"ERROR: Too many vertices! (npoints:%d > %d)",g_VertexCount);
    engine_2d_c_drawText_FUN_00401fd0((char *)local_68,0,0);
    crt_stdio_c_sprintf_FUN_005fdbd0((char *)local_68,"vertexList[] in 2d.c only supports %d vertices",local_14);
    engine_2d_c_drawText_FUN_00401fd0((char *)local_68,0,0x16);
