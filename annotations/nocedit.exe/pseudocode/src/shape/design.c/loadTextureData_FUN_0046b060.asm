...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_design.c_loadTextureData_FUN_0046b060(STextureLoadConfig * config_ptr, void * rgb_buffer, void * alpha_buffer, int atlas_width, int atlas_height)
;
; Parameters:
...
section .text
    ...
    CMP dword ptr [0x01eb1484],0x0      ; 0046b06c | int g_TextureManagerMode
    JZ 0x0046b092                       ; 0046b073 | LAB_0046b092
        ;   XREF to: 0046b092 (CONDITIONAL_JUMP)
    MOV EAX,0x61d29e                    ; 0046b075 | = "rb" | s_rb_0061d29e = rb
    PUSH EAX                            ; 0046b07a | = "rb" | s_rb_0061d29e = rb
    MOV EAX,dword ptr [EBP + 0x14]      ; 0046b07b
    PUSH EAX                            ; 0046b07e
    MOV EAX,0x61d2a1                    ; 0046b07f | = "art" | s_art_0061d2a1 = art
    PUSH EAX                            ; 0046b084 | = "art" | s_art_0061d2a1 = art
    CALL engine_dosio.c_getFile_FUN_00481a50 ; 0046b085 | FILE * engine_dosio.c_getFile_FUN_00481a50(char * directory, char * filename, char * mode)
        ;   XREF to: 00481a50 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0046b08a
    MOV dword ptr [EBP + -0xc],EAX      ; 0046b08d
    JMP 0x0046b0b4                      ; 0046b090 | LAB_0046b0b4
        ;   XREF to: 0046b0b4 (UNCONDITIONAL_JUMP)
    PUSH 0x27a2                         ; 0046b092
        ;   Label: LAB_0046b092
    MOV EAX,0x61d2a5                    ; 0046b097 | = "..\\shape\\design.c" | s_shape_design_c_0061d2a5 = ..\shape\design.c
    PUSH EAX                            ; 0046b09c | = "..\\shape\\design.c" | s_shape_design_c_0061d2a5 = ..\shape\design.c
    MOV EAX,0x61d2b7                    ; 0046b09d | = "rb" | s_rb_0061d2b7 = rb
    PUSH EAX                            ; 0046b0a2 | = "rb" | s_rb_0061d2b7 = rb
    PUSH 0x0                            ; 0046b0a3
    MOV EAX,dword ptr [EBP + 0x14]      ; 0046b0a5
    PUSH EAX                            ; 0046b0a8
    CALL shape_memdbg.cpp_openFile_FUN_0050f7a0 ; 0046b0a9 | FILE * shape_memdbg.cpp_openFile_FUN_0050f7a0(char * filename, char * directory, char * mode, char * source_file, ...)
        ;   XREF to: 0050f7a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0046b0ae
    MOV dword ptr [EBP + -0xc],EAX      ; 0046b0b1
    CMP dword ptr [EBP + -0xc],0x0      ; 0046b0b4
        ;   Label: LAB_0046b0b4
    JNZ 0x0046b0dc                      ; 0046b0b8 | LAB_0046b0dc
        ;   XREF to: 0046b0dc (CONDITIONAL_JUMP)
    MOV dword ptr [0x02f0ca48],0x61d2ba ; 0046b0ba | char * g_CurrentFilename | = "..\\shape\\design.c" | s_shape_design_c_0061d2ba = ..\shape\design.c
    MOV dword ptr [0x02f0ca4c],0x27a4   ; 0046b0c4 | int g_CurrentLineNumber
    MOV EAX,0x61d2cc                    ; 0046b0ce | = "Unable to load input" | s_Unable_to_load_input_0061d2cc = Unable to load input
    PUSH EAX                            ; 0046b0d3 | = "Unable to load input" | s_Unable_to_load_input_0061d2cc = Unable to load input
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0046b0d4 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    PUSH EAX                            ; 0046b0e3
    CALL crt_stdio.c_fseek_FUN_005ffacc ; 0046b0e4 | int crt_stdio.c_fseek_FUN_005ffacc(FILE * file, long offset, int whence)
        ;   XREF to: 005ffacc (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0046b0e9
    MOV EAX,dword ptr [EBP + -0xc]      ; 0046b0ec
    PUSH EAX                            ; 0046b0ef
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 0046b0f0 | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
    ...
    MOV EAX,0x61d2e1                    ; 0046b119 | = "..\\shape\\design.c" | s_shape_design_c_0061d2e1 = ..\shape\design.c
    PUSH EAX                            ; 0046b11e | = "..\\shape\\design.c" | s_shape_design_c_0061d2e1 = ..\shape\design.c
    MOV EAX,dword ptr [EBP + -0x10]     ; 0046b11f
    PUSH EAX                            ; 0046b122
    CALL shape_memdbg.cpp_debugMalloc_FUN_0050f250 ; 0046b123 | void * shape_memdbg.cpp_debugMalloc_FUN_0050f250(int size, char * filename, int line_number)
        ;   XREF to: 0050f250 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0046b128
    MOV dword ptr [EBP + -0x18],EAX     ; 0046b12b
    PUSH 0x27ae                         ; 0046b12e
    MOV EAX,0x61d2f3                    ; 0046b133 | = "..\\shape\\design.c" | s_shape_design_c_0061d2f3 = ..\shape\design.c
    PUSH EAX                            ; 0046b138 | = "..\\shape\\design.c" | s_shape_design_c_0061d2f3 = ..\shape\design.c
    ...
    PUSH EAX                            ; 0046b14c
    CALL shape_memdbg.cpp_debugMalloc_FUN_0050f250 ; 0046b14d | void * shape_memdbg.cpp_debugMalloc_FUN_0050f250(int size, char * filename, int line_number)
        ;   XREF to: 0050f250 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0046b152
    MOV dword ptr [EBP + -0x14],EAX     ; 0046b155
    CMP dword ptr [EBP + -0x18],0x0     ; 0046b158
    JZ 0x0046b164                       ; 0046b15c | LAB_0046b164
        ;   XREF to: 0046b164 (CONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0x14],0x0     ; 0046b15e
    JNZ 0x0046b186                      ; 0046b162 | LAB_0046b186
        ;   XREF to: 0046b186 (CONDITIONAL_JUMP)
    MOV dword ptr [0x02f0ca48],0x61d305 ; 0046b164 | char * g_CurrentFilename | = "..\\shape\\design.c" | s_shape_design_c_0061d305 = ..\shape\design.c
        ;   Label: LAB_0046b164
    MOV dword ptr [0x02f0ca4c],0x27af   ; 0046b16e | int g_CurrentLineNumber
    MOV EAX,0x61d317                    ; 0046b178 | = "Out of mem!" | s_Out_of_mem_0061d317 = Out of mem!
    PUSH EAX                            ; 0046b17d | = "Out of mem!" | s_Out_of_mem_0061d317 = Out of mem!
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0046b17e | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ...
    JZ 0x0046b1f3                       ; 0046b19c | LAB_0046b1f3
        ;   XREF to: 0046b1f3 (CONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x2c],0x0     ; 0046b19e
    JMP 0x0046b1aa                      ; 0046b1a5 | LAB_0046b1aa
    ...
    JGE 0x0046b1f1                      ; 0046b1b6 | LAB_0046b1f1
    ...
    PUSH EAX                            ; 0046b1e6
    CALL shape_design.c_readPixelRowFromFile_FUN_0046abf0 ; 0046b1e7 | void shape_design.c_readPixelRowFromFile_FUN_0046abf0(FILE * file_handle, byte * rgb_buffer, byte * alpha_buffer, int pixel_count, ...)
        ;   XREF to: 0046abf0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0046b1ec
    JMP 0x0046b1a7                      ; 0046b1ef | LAB_0046b1a7
        ;   XREF to: 0046b1a7 (UNCONDITIONAL_JUMP)
    JMP 0x0046b245                      ; 0046b1f1 | LAB_0046b245
        ;   Label: LAB_0046b1f1
    ...
    PUSH EAX                            ; 0046b23a
    CALL shape_design.c_readPixelRowFromFile_FUN_0046abf0 ; 0046b23b | void shape_design.c_readPixelRowFromFile_FUN_0046abf0(FILE * file_handle, byte * rgb_buffer, byte * alpha_buffer, int pixel_count, ...)
        ;   XREF to: 0046abf0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0046b240
    JMP 0x0046b202                      ; 0046b243 | LAB_0046b202
        ;   XREF to: 0046b202 (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + -0xc]      ; 0046b245
        ;   Label: LAB_0046b245
    TEST byte ptr [EAX + 0xc],0x20      ; 0046b248
    JZ 0x0046b2a1                       ; 0046b24c | LAB_0046b2a1
        ;   XREF to: 0046b2a1 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + 0x14]      ; 0046b24e
    PUSH EAX                            ; 0046b251
    MOV EAX,0x61d323                    ; 0046b252 | = "Unable to read file (%s)." | s_Unable_to_read_file_s_0061d323 = Unable to read file (%s).
    PUSH EAX                            ; 0046b257 | = "Unable to read file (%s)." | s_Unable_to_read_file_s_0061d323 = Unable to read file (%s).
    LEA EAX,[EBP + 0xfffffec8]          ; 0046b258
    PUSH EAX                            ; 0046b25e
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0046b25f | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0046b264
    PUSH 0x27c2                         ; 0046b267
    MOV EAX,0x61d33d                    ; 0046b26c | = "..\\shape\\design.c" | s_shape_design_c_0061d33d = ..\shape\design.c
    PUSH EAX                            ; 0046b271 | = "..\\shape\\design.c" | s_shape_design_c_0061d33d = ..\shape\design.c
    MOV EAX,dword ptr [EBP + -0xc]      ; 0046b272
    PUSH EAX                            ; 0046b275
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 0046b276 | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
        ;   XREF to: 0050f9b0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0046b27b
    MOV dword ptr [0x02f0ca48],0x61d34f ; 0046b27e | char * g_CurrentFilename | = "..\\shape\\design.c" | s_shape_design_c_0061d34f = ..\shape\design.c
    MOV dword ptr [0x02f0ca4c],0x27c3   ; 0046b288 | int g_CurrentLineNumber
    LEA EAX,[EBP + 0xfffffec8]          ; 0046b292
    PUSH EAX                            ; 0046b298
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0046b299 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0046b29e
    PUSH 0x27c5                         ; 0046b2a1
        ;   Label: LAB_0046b2a1
    MOV EAX,0x61d361                    ; 0046b2a6 | = "..\\shape\\design.c" | s_shape_design_c_0061d361 = ..\shape\design.c
    PUSH EAX                            ; 0046b2ab | = "..\\shape\\design.c" | s_shape_design_c_0061d361 = ..\shape\design.c
    MOV EAX,dword ptr [EBP + -0xc]      ; 0046b2ac
    PUSH EAX                            ; 0046b2af
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 0046b2b0 | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
        ;   XREF to: 0050f9b0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0046b2b5
    MOV dword ptr [EBP + -0x34],0x0     ; 0046b2b8
    JMP 0x0046b2c4                      ; 0046b2bf | LAB_0046b2c4
    ...
    JLE 0x0046b2eb                      ; 0046b2da | LAB_0046b2eb
    ...
    JZ 0x0046b2e9                       ; 0046b2e5 | LAB_0046b2e9
        ;   XREF to: 0046b2e9 (CONDITIONAL_JUMP)
    JMP 0x0046b2eb                      ; 0046b2e7 | LAB_0046b2eb
        ;   XREF to: 0046b2eb (UNCONDITIONAL_JUMP)
    JMP 0x0046b2c1                      ; 0046b2e9 | LAB_0046b2c1
        ;   Label: LAB_0046b2e9
    ...
    JG 0x0046b328                       ; 0046b301 | LAB_0046b328
    ...
    PUSH EAX                            ; 0046b31f
    CALL crt_memory.c_memset_FUN_005fde40 ; 0046b320 | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
        ;   XREF to: 005fde40 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0046b325
    MOV EAX,dword ptr [EBP + 0x14]      ; 0046b328
        ;   Label: LAB_0046b328
    FILD dword ptr [EAX + 0x220]        ; 0046b32b
    FILD dword ptr [0x01eb1760]         ; 0046b331 | int g_TextureAtlasDimension
    FMULP                               ; 0046b337
    FILD dword ptr [EBP + 0x24]         ; 0046b339
    FDIVP                               ; 0046b33c
    FADD double ptr [0x0061d376]        ; 0046b33e | double g_CoordinateRoundingOffset
    CALL crt_math.c_round_FUN_005fe6b0  ; 0046b344 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [EBP + -0x28]       ; 0046b349
    MOV EAX,dword ptr [EBP + 0x14]      ; 0046b34c
    FILD dword ptr [EAX + 0x224]        ; 0046b34f
    FILD dword ptr [0x01eb1760]         ; 0046b355 | int g_TextureAtlasDimension
    FMULP                               ; 0046b35b
    FILD dword ptr [EBP + 0x28]         ; 0046b35d
    FDIVP                               ; 0046b360
    FADD double ptr [0x0061d376]        ; 0046b362 | double g_CoordinateRoundingOffset
    CALL crt_math.c_round_FUN_005fe6b0  ; 0046b368 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    FILD dword ptr [0x01eb1760]         ; 0046b391 | int g_TextureAtlasDimension
    FMULP                               ; 0046b397
    FILD dword ptr [EBP + 0x24]         ; 0046b399
    FDIVP                               ; 0046b39c
    FADD double ptr [0x0061d376]        ; 0046b39e | double g_CoordinateRoundingOffset
    CALL crt_math.c_round_FUN_005fe6b0  ; 0046b3a4 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [EBP + -0x20]       ; 0046b3a9
    MOV EAX,dword ptr [EBP + 0x14]      ; 0046b3ac
    FILD dword ptr [EAX + 0x21c]        ; 0046b3af
    FILD dword ptr [0x01eb1760]         ; 0046b3b5 | int g_TextureAtlasDimension
    FMULP                               ; 0046b3bb
    FILD dword ptr [EBP + 0x28]         ; 0046b3bd
    FDIVP                               ; 0046b3c0
    FADD double ptr [0x0061d376]        ; 0046b3c2 | double g_CoordinateRoundingOffset
    CALL crt_math.c_round_FUN_005fe6b0  ; 0046b3c8 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [EBP + -0x1c]       ; 0046b3cd
    MOV EAX,[0x01eb1760]                ; 0046b3d0 | int g_TextureAtlasDimension
    DEC EAX                             ; 0046b3d5
    CMP EAX,dword ptr [EBP + -0x20]     ; 0046b3d6
    JGE 0x0046b3e4                      ; 0046b3d9 | LAB_0046b3e4
        ;   XREF to: 0046b3e4 (CONDITIONAL_JUMP)
    MOV EAX,[0x01eb1760]                ; 0046b3db | int g_TextureAtlasDimension
    DEC EAX                             ; 0046b3e0
    MOV dword ptr [EBP + -0x20],EAX     ; 0046b3e1
    MOV EAX,[0x01eb1760]                ; 0046b3e4 | int g_TextureAtlasDimension
        ;   Label: LAB_0046b3e4
    DEC EAX                             ; 0046b3e9
    CMP EAX,dword ptr [EBP + -0x1c]     ; 0046b3ea
    JGE 0x0046b3f8                      ; 0046b3ed | LAB_0046b3f8
        ;   XREF to: 0046b3f8 (CONDITIONAL_JUMP)
    MOV EAX,[0x01eb1760]                ; 0046b3ef | int g_TextureAtlasDimension
    DEC EAX                             ; 0046b3f4
    ...
    JMP 0x0046b41f                      ; 0046b417 | LAB_0046b41f
    ...
    JGE 0x0046b6a5                      ; 0046b425 | LAB_0046b6a5
        ;   XREF to: 0046b6a5 (CONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x30],0x0     ; 0046b42b
    JMP 0x0046b43a                      ; 0046b432 | LAB_0046b43a
    ...
    JGE 0x0046b6a0                      ; 0046b440 | LAB_0046b6a0
    ...
    FADDP                               ; 0046b477
    FMUL double ptr [0x0061d37e]        ; 0046b479 | double g_TextureScalingFactor
    ...
    FADDP                               ; 0046b4c1
    FMUL double ptr [0x0061d37e]        ; 0046b4c3 | double g_TextureScalingFactor
    ...
    FADDP                               ; 0046b51a
    FMUL double ptr [0x0061d37e]        ; 0046b51c | double g_TextureScalingFactor
    ...
    FADDP                               ; 0046b573
    FMUL double ptr [0x0061d37e]        ; 0046b575 | double g_TextureScalingFactor
    ...
    PUSH EAX                            ; 0046b5f1
    CALL shape_design.c_sampleAndFilterPixel_FUN_0046ae20 ; 0046b5f2 | void shape_design.c_sampleAndFilterPixel_FUN_0046ae20(void * rgb_buffer, void * alpha_buffer, int col_coord, int row_coord, ...)
    ...
    JMP 0x0046b646                      ; 0046b623 | LAB_0046b646
    ...
    IMUL EAX,dword ptr [0x01eb1760]     ; 0046b637 | int g_TextureAtlasDimension
    ...
    JMP 0x0046b434                      ; 0046b69b | LAB_0046b434
        ;   XREF to: 0046b434 (UNCONDITIONAL_JUMP)
    JMP 0x0046b419                      ; 0046b6a0 | LAB_0046b419
        ;   Label: LAB_0046b6a0
        ;   XREF to: 0046b419 (UNCONDITIONAL_JUMP)
    PUSH 0x2818                         ; 0046b6a5
        ;   Label: LAB_0046b6a5
    MOV EAX,0x61d386                    ; 0046b6aa | = "..\\shape\\design.c" | s_shape_design_c_0061d386 = ..\shape\design.c
    PUSH EAX                            ; 0046b6af | = "..\\shape\\design.c" | s_shape_design_c_0061d386 = ..\shape\design.c
    MOV EAX,dword ptr [EBP + -0x18]     ; 0046b6b0
    PUSH EAX                            ; 0046b6b3
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 0046b6b4 | void shape_memdbg.cpp_debugFree_FUN_0050f460(void * ptr, char * filename, int line_number)
        ;   XREF to: 0050f460 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0046b6b9
    PUSH 0x2819                         ; 0046b6bc
    MOV EAX,0x61d398                    ; 0046b6c1 | = "..\\shape\\design.c" | s_shape_design_c_0061d398 = ..\shape\design.c
    PUSH EAX                            ; 0046b6c6 | = "..\\shape\\design.c" | s_shape_design_c_0061d398 = ..\shape\design.c
    MOV EAX,dword ptr [EBP + -0x14]     ; 0046b6c7
    PUSH EAX                            ; 0046b6ca
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 0046b6cb | void shape_memdbg.cpp_debugFree_FUN_0050f460(void * ptr, char * filename, int line_number)
        ;   XREF to: 0050f460 (UNCONDITIONAL_CALL)
