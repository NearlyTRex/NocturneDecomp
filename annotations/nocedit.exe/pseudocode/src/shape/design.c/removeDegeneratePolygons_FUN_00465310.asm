...
section .text
    ...
    MOV dword ptr [EBP + -0x14],0x0     ; 0046531c
        ;   Label: LAB_0046531c
    JMP 0x0046532b                      ; 00465323 | LAB_0046532b
    ...
    MOV EAX,dword ptr [EBP + -0x14]     ; 0046532b
        ;   Label: LAB_0046532b
    CMP EAX,dword ptr [0x016e990c]      ; 0046532e | int g_PolygonCount
    JGE 0x004654cf                      ; 00465334 | LAB_004654cf
    ...
    JMP 0x00465360                      ; 00465358 | LAB_00465360
    ...
    JGE 0x004653c7                      ; 0046537e | LAB_004653c7
    ...
    JNZ 0x004653c5                      ; 004653ab | LAB_004653c5
    ...
    JGE 0x004654ca                      ; 004653e8 | LAB_004654ca
        ;   XREF to: 004654ca (CONDITIONAL_JUMP)
    ...
    JLE 0x00465450                      ; 00465421 | LAB_00465450
    ...
    JMP 0x00465414                      ; 0046544e | LAB_00465414
    ...
    LEA EDI,[ESI + 0x16e9910]           ; 004654aa | SShapeEditorPolygon[20000] g_ModelPolygonData
    LEA ESI,[EAX + 0x16e9910]           ; 004654b0 | SShapeEditorPolygon[20000] g_ModelPolygonData
    MOVSD.REP ES:EDI,ESI                ; 004654b6 | SShapeEditorPolygon[20000] g_ModelPolygonData
    JMP 0x00465483                      ; 004654b8 | LAB_00465483
        ;   XREF to: 00465483 (UNCONDITIONAL_JUMP)
    DEC dword ptr [0x016e990c]          ; 004654ba | int g_PolygonCount
        ;   Label: LAB_004654ba
    JMP 0x0046531c                      ; 004654c0 | LAB_0046531c
        ;   Label: LAB_004654c0
        ;   XREF to: 0046531c (UNCONDITIONAL_JUMP)
    JMP 0x004653dc                      ; 004654c5 | LAB_004653dc
        ;   Label: LAB_004654c5
        ;   XREF to: 004653dc (UNCONDITIONAL_JUMP)
    JMP 0x00465325                      ; 004654ca | LAB_00465325
        ;   Label: LAB_004654ca
