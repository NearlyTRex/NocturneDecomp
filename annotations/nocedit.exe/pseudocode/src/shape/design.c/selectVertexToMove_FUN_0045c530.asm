...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_design.c_selectVertexToMove_FUN_0045c530(void)
;
; Local Variables:
...
section .text
    ...
    MOV ECX,0x61b325                    ; 0045c53c | = "Point to move : " | s_Point_to_move_0061b325 = Point to move :
    PUSH ECX                            ; 0045c541 | = "Point to move : " | s_Point_to_move_0061b325 = Point to move :
    PUSH 0xb                            ; 0045c542
    PUSH 0x0                            ; 0045c544
    PUSH 0x13                           ; 0045c546
    LEA ECX,[EBP + -0x18]               ; 0045c548
    PUSH ECX                            ; 0045c54b
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 0045c54c | int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
    ...
    JZ 0x0045c57b                       ; 0045c56a | LAB_0045c57b
        ;   XREF to: 0045c57b (CONDITIONAL_JUMP)
    LEA EAX,[EBP + -0x18]               ; 0045c56c
    PUSH EAX                            ; 0045c56f
    CALL crt_stdlib.c_atoi_FUN_005ffef0 ; 0045c570 | int crt_stdlib.c_atoi_FUN_005ffef0(char * string_ptr)
    ...
    CMP dword ptr [EBP + -0x4],0x0      ; 0045c57b
        ;   Label: LAB_0045c57b
    JL 0x0045c58c                       ; 0045c57f | LAB_0045c58c
        ;   XREF to: 0045c58c (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + -0x4]      ; 0045c581
    CMP EAX,dword ptr [0x01626408]      ; 0045c584 | int g_VertexCount
    JL 0x0045c58e                       ; 0045c58a | LAB_0045c58e
        ;   XREF to: 0045c58e (CONDITIONAL_JUMP)
    JMP 0x0045c5a0                      ; 0045c58c | LAB_0045c5a0
        ;   Label: LAB_0045c58c
        ;   XREF to: 0045c5a0 (UNCONDITIONAL_JUMP)
    MOV dword ptr [0x01e528b0],0x1      ; 0045c58e | int g_PointEditorMode
        ;   Label: LAB_0045c58e
    MOV EAX,dword ptr [EBP + -0x4]      ; 0045c598
    MOV [0x01e528b4],EAX                ; 0045c59b | int g_SelectedPointIndex
