...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl shape_design_c_configureSinglePassPolygonReduction_FUN_00465560(int ui_mode)
;
; Parameters:
...
section .text
    ...
    MOV EAX,[0x016e990c]                ; 0046556c | g_PolygonCount
    ...
    PUSH EAX                            ; 00465595
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 00465596
    ...
    JMP 0x004655a4                      ; 0046559e
        ;   XREF to: 004655a4 (UNCONDITIONAL_JUMP)  ; LAB_004655a4
    ...
    CMP dword ptr [EBP + 0x14],0x0      ; 004655d4
        ;   Label: LAB_004655d4
    JLE 0x0046560c                      ; 004655d8
        ;   XREF to: 0046560c (CONDITIONAL_JUMP)  ; LAB_0046560c
    MOV EAX,0x61c52a                    ; 004655da | = "Ignore different part names? [y] : "
    PUSH EAX                            ; 004655df | = "Ignore different part names? [y] : "
    PUSH 0x16                           ; 004655e0
    PUSH 0x0                            ; 004655e2
    PUSH 0x14                           ; 004655e4
    LEA EAX,[EBP + -0x64]               ; 004655e6
    PUSH EAX                            ; 004655e9
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 004655ea
        ;   XREF to: 004032c0 (UNCONDITIONAL_CALL)  ; int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
    ADD ESP,0x14                        ; 004655ef
    XOR EAX,EAX                         ; 004655f2
    MOV AL,byte ptr [EBP + -0x64]       ; 004655f4
    PUSH EAX                            ; 004655f7
    CALL crt_ctype.c_toupper_FUN_005ff9e0 ; 004655f8
        ;   XREF to: 005ff9e0 (UNCONDITIONAL_CALL)  ; int crt_ctype.c_toupper_FUN_005ff9e0(int c)
    ADD ESP,0x4                         ; 004655fd
    CMP EAX,0x4e                        ; 00465600
    JNZ 0x0046560c                      ; 00465603
        ;   XREF to: 0046560c (CONDITIONAL_JUMP)  ; LAB_0046560c
    ...
    FLD float ptr [EBP + -0x4]          ; 0046562e
        ;   Label: LAB_0046562e
    FMUL double ptr [0x0061c566]        ; 00465631 | g_SinglePassDegreesToRadiansConversion
    FCOS                                ; 00465637
    FSTP float ptr [EBP + -0x4]         ; 00465639
    MOV EAX,dword ptr [EBP + -0xc]      ; 0046563c
    PUSH EAX                            ; 0046563f
    CALL shape_design.c_removeDuplicatePolygons_FUN_004651b0 ; 00465640
    ...
    CALL shape_design.c_removeDegeneratePolygons_FUN_00465310 ; 00465648
    ...
    JMP 0x0046565c                      ; 00465654
        ;   XREF to: 0046565c (UNCONDITIONAL_JUMP)  ; LAB_0046565c
    MOV EAX,dword ptr [EBP + -0x8]      ; 00465656
        ;   Label: LAB_00465656
    INC dword ptr [EBP + -0x8]          ; 00465659
    MOV EAX,[0x016e990c]                ; 0046565c | g_PolygonCount
        ;   Label: LAB_0046565c
    DEC EAX                             ; 00465661
    CMP EAX,dword ptr [EBP + -0x8]      ; 00465662
    JLE 0x00465774                      ; 00465665
        ;   XREF to: 00465774 (CONDITIONAL_JUMP)  ; LAB_00465774
    ...
    MOV EAX,0x16e9910                   ; 004656ac | g_ModelPolygonData
    ADD EAX,EDX                         ; 004656b1
    PUSH EAX                            ; 004656b3
    IMUL EDX,dword ptr [EBP + -0x8],0x184 ; 004656b4
    MOV EAX,0x16e9910                   ; 004656bb | g_ModelPolygonData
    ADD EAX,EDX                         ; 004656c0
    PUSH EAX                            ; 004656c2
    CALL shape_design.c_validatePolygonNormals_FUN_00461d80 ; 004656c3
    ...
    JZ 0x00465707                       ; 004656cd
        ;   XREF to: 00465707 (CONDITIONAL_JUMP)  ; LAB_00465707
    PUSH 0x3                            ; 004656cf
    PUSH 0x3                            ; 004656d1
    IMUL EDX,dword ptr [EBP + -0x14],0x184 ; 004656d3
    MOV EAX,0x16e9910                   ; 004656da | g_ModelPolygonData
    ADD EAX,EDX                         ; 004656df
    ADD EAX,0xb8                        ; 004656e1
    PUSH EAX                            ; 004656e6
    IMUL EDX,dword ptr [EBP + -0x8],0x184 ; 004656e7
    MOV EAX,0x16e9910                   ; 004656ee | g_ModelPolygonData
    ADD EAX,EDX                         ; 004656f3
    ADD EAX,0xb8                        ; 004656f5
    PUSH EAX                            ; 004656fa
    CALL shape_design.c_findVertexMatches_FUN_00461ae0 ; 004656fb
    ...
    JNZ 0x00465709                      ; 00465705
        ;   XREF to: 00465709 (CONDITIONAL_JUMP)  ; LAB_00465709
    JMP 0x00465739                      ; 00465707
        ;   XREF to: 00465739 (UNCONDITIONAL_JUMP)  ; LAB_00465739
        ;   Label: LAB_00465707
    IMUL EDX,dword ptr [EBP + -0x14],0x184 ; 00465709
        ;   Label: LAB_00465709
    MOV EAX,0x16e9910                   ; 00465710 | g_ModelPolygonData
    ADD EAX,EDX                         ; 00465715
    ADD EAX,0x54                        ; 00465717
    PUSH EAX                            ; 0046571a
    IMUL EDX,dword ptr [EBP + -0x8],0x184 ; 0046571b
    MOV EAX,0x16e9910                   ; 00465722 | g_ModelPolygonData
    ADD EAX,EDX                         ; 00465727
    ADD EAX,0x54                        ; 00465729
    PUSH EAX                            ; 0046572c
    CALL crt_string.c_strcmp_FUN_005fef20 ; 0046572d
        ;   XREF to: 005fef20 (UNCONDITIONAL_CALL)  ; int crt_string.c_strcmp_FUN_005fef20(char * str1, char * str2)
    ADD ESP,0x8                         ; 00465732
    TEST EAX,EAX                        ; 00465735
    JZ 0x0046573b                       ; 00465737
        ;   XREF to: 0046573b (CONDITIONAL_JUMP)  ; LAB_0046573b
    JMP 0x0046576f                      ; 00465739
        ;   XREF to: 0046576f (UNCONDITIONAL_JUMP)  ; LAB_0046576f
        ;   Label: LAB_00465739
    CMP dword ptr [EBP + -0xc],0x0      ; 0046573b
        ;   Label: LAB_0046573b
    JZ 0x0046575f                       ; 0046573f
    ...
    PUSH EAX                            ; 00465766
    CALL shape_design.c_mergeTrianglesIntoQuad_FUN_00462190 ; 00465767
    ...
    JMP 0x00465656                      ; 0046576f
        ;   XREF to: 00465656 (UNCONDITIONAL_JUMP)  ; LAB_00465656
        ;   Label: LAB_0046576f
    MOV EAX,dword ptr [EBP + -0xc]      ; 00465774
        ;   Label: LAB_00465774
    PUSH EAX                            ; 00465777
    CALL shape_design.c_removeDuplicatePolygons_FUN_004651b0 ; 00465778
        ;   XREF to: 004651b0 (UNCONDITIONAL_CALL)  ; void shape_design.c_removeDuplicatePolygons_FUN_004651b0(int respect_part_assignments)
    ADD ESP,0x4                         ; 0046577d
    CALL shape_design.c_removeDegeneratePolygons_FUN_00465310 ; 00465780
        ;   XREF to: 00465310 (UNCONDITIONAL_CALL)  ; void shape_design.c_removeDegeneratePolygons_FUN_00465310()
    CALL shape_design.c_removeUnusedVertices_FUN_00463830 ; 00465785
        ;   XREF to: 00463830 (UNCONDITIONAL_CALL)  ; void shape_design.c_removeUnusedVertices_FUN_00463830()
    INC dword ptr [0x01e528a8]          ; 0046578a | g_PolygonOptimizationPasses
    PUSH dword ptr [0x01e528a8]         ; 00465790 | g_PolygonOptimizationPasses
    PUSH dword ptr [0x016e990c]         ; 00465796 | g_PolygonCount
    MOV EAX,dword ptr [EBP + -0x10]     ; 0046579c
    PUSH EAX                            ; 0046579f
    MOV EAX,0x61c56e                    ; 004657a0 | = "Original polygons: %d    New total: %..."
    ...
    JLE 0x004657e2                      ; 004657b6
        ;   XREF to: 004657e2 (CONDITIONAL_JUMP)  ; LAB_004657e2
    ...
    DEC EDI                             ; 004657c8
    MOV AL,byte ptr [ESI]               ; 004657c9 | = "\n\nHit a key..." | s_Hit_a_key..._0061c5a9
        ;   Label: LAB_004657c9
    MOV byte ptr [EDI],AL               ; 004657cb
    CMP AL,0x0                          ; 004657cd
    JZ 0x004657e1                       ; 004657cf
        ;   XREF to: 004657e1 (CONDITIONAL_JUMP)  ; LAB_004657e1
    MOV AL,byte ptr [ESI + 0x1]         ; 004657d1 | s_Hit_a_key..._0061c5a8 | s_it_a_key..._0061c5aa
    ADD ESI,0x2                         ; 004657d4
    MOV byte ptr [EDI + 0x1],AL         ; 004657d7
    ADD EDI,0x2                         ; 004657da
    CMP AL,0x0                          ; 004657dd
    JNZ 0x004657c9                      ; 004657df
        ;   XREF to: 004657c9 (CONDITIONAL_JUMP)  ; LAB_004657c9
    POP EDI                             ; 004657e1
        ;   Label: LAB_004657e1
    CMP dword ptr [EBP + 0x14],0x0      ; 004657e2
        ;   Label: LAB_004657e2
    JL 0x004657fd                       ; 004657e6
        ;   XREF to: 004657fd (CONDITIONAL_JUMP)  ; LAB_004657fd
    PUSH 0x0                            ; 004657e8
    PUSH 0x0                            ; 004657ea
    ...
    CMP dword ptr [EBP + 0x14],0x0      ; 004657fd
        ;   Label: LAB_004657fd
    JLE 0x00465808                      ; 00465801
        ;   XREF to: 00465808 (CONDITIONAL_JUMP)  ; LAB_00465808
    CALL wincore_winrun.cpp_getNextKeypress_FUN_005f2e90 ; 00465803
