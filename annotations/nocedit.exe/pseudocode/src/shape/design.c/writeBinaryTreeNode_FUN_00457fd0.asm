...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_design.c_writeBinaryTreeNode_FUN_00457fd0(STreeNode * node, FILE * file, int depth)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 00457ffe
    MOV EAX,0x61a882                    ; 00457fff | = "%d,%d,%d\n" | s_d_d_d_0061a882 = %d,%d,%d

    PUSH EAX                            ; 00458004 | = "%d,%d,%d\n" | s_d_d_d_0061a882 = %d,%d,%d

    MOV EAX,dword ptr [EBP + 0x18]      ; 00458005
    PUSH EAX                            ; 00458008
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00458009 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0045800e
    JMP 0x0045808f                      ; 00458011 | LAB_0045808f
    ...
    PUSH EAX                            ; 0045804c
    MOV EAX,0x61a88c                    ; 0045804d | = "%d,%d,%f,%f,%f,%f\n" | s_d_d_f_f_f_f_0061a88c = %d,%d,%f,%f,%f,%f

    PUSH EAX                            ; 00458052 | = "%d,%d,%f,%f,%f,%f\n" | s_d_d_f_f_f_f_0061a88c = %d,%d,%f,%f,%f,%f

    MOV EAX,dword ptr [EBP + 0x18]      ; 00458053
    PUSH EAX                            ; 00458056
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00458057 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    CALL shape_design.c_writeBinaryTreeNode_FUN_00457fd0 ; 0045806e | void shape_design.c_writeBinaryTreeNode_FUN_00457fd0(STreeNode * node, FILE * file, int depth)
    ...
    CALL shape_design.c_writeBinaryTreeNode_FUN_00457fd0 ; 00458087 | void shape_design.c_writeBinaryTreeNode_FUN_00457fd0(STreeNode * node, FILE * file, int depth)
        ;   XREF to: 00457fd0 (UNCONDITIONAL_CALL)
