...
section .text
    ...
    CALL wincore_windll.cpp_clearScreen_FUN_005b3e70 ; 00466e5a | void wincore_windll.cpp_clearScreen_FUN_005b3e70()
        ;   XREF to: 005b3e70 (UNCONDITIONAL_CALL)
    MOV ECX,0x61c842                    ; 00466e5f | = "Enter X distance in feet (,min,max fo..." | s_Enter_X_distance_in_feet_0061c842 = Enter X distance in feet (,min,max for user-defined min/max points) :
    PUSH ECX                            ; 00466e64 | = "Enter X distance in feet (,min,max fo..." | s_Enter_X_distance_in_feet_0061c842 = Enter X distance in feet (,min,max for user-defined min/max points) :
    PUSH 0x16                           ; 00466e65
    PUSH 0x0                            ; 00466e67
    PUSH 0x14                           ; 00466e69
    LEA ECX,[EBP + -0x6c]               ; 00466e6b
    PUSH ECX                            ; 00466e6e
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 00466e6f | int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
    ...
    JNZ 0x00466e8d                      ; 00466e86 | LAB_00466e8d
        ;   XREF to: 00466e8d (CONDITIONAL_JUMP)
    JMP 0x00466ffa                      ; 00466e88 | LAB_00466ffa
    ...
    PUSH EAX                            ; 00466e98
    MOV EAX,0x61c889                    ; 00466e99 | = "%f,%d,%d" | s_f_d_d_0061c889 = %f,%d,%d
    PUSH EAX                            ; 00466e9e | = "%f,%d,%d" | s_f_d_d_0061c889 = %f,%d,%d
    LEA EAX,[EBP + -0x6c]               ; 00466e9f
    PUSH EAX                            ; 00466ea2
    CALL crt_stdio.c_sscanf_FUN_0060013c ; 00466ea3 | int crt_stdio.c_sscanf_FUN_0060013c(char * str, char * format)
    ...
    JLE 0x00466f42                      ; 00466eb2 | LAB_00466f42
        ;   XREF to: 00466f42 (CONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0x1c],0x3     ; 00466eb8
    JZ 0x00466edf                       ; 00466ebc | LAB_00466edf
        ;   XREF to: 00466edf (CONDITIONAL_JUMP)
    PUSH 0x2c                           ; 00466ebe
    PUSH 0x0                            ; 00466ec0
    MOV EAX,0x61c892                    ; 00466ec2 | = "Need distance and two points." | s_Need_distance_and_two_po_0061c892 = Need distance and two points.
    PUSH EAX                            ; 00466ec7 | = "Need distance and two points." | s_Need_distance_and_two_po_0061c892 = Need distance and two points.
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 00466ec8 | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00466ecd
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 00466ed0 | void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20()
        ;   XREF to: 005eda20 (UNCONDITIONAL_CALL)
    CALL wincore_winrun.cpp_getNextKeypress_FUN_005f2e90 ; 00466ed5 | int wincore_winrun.cpp_getNextKeypress_FUN_005f2e90()
        ;   XREF to: 005f2e90 (UNCONDITIONAL_CALL)
    JMP 0x00466ffa                      ; 00466eda | LAB_00466ffa
        ;   XREF to: 00466ffa (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0x14],0x0     ; 00466edf
        ;   Label: LAB_00466edf
    JL 0x00466eeb                       ; 00466ee3 | LAB_00466eeb
        ;   XREF to: 00466eeb (CONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0x18],0x0     ; 00466ee5
    JGE 0x00466eed                      ; 00466ee9 | LAB_00466eed
        ;   XREF to: 00466eed (CONDITIONAL_JUMP)
    JMP 0x00466ef8                      ; 00466eeb | LAB_00466ef8
        ;   Label: LAB_00466eeb
        ;   XREF to: 00466ef8 (UNCONDITIONAL_JUMP)
    MOV EAX,[0x01626408]                ; 00466eed | int g_VertexCount
        ;   Label: LAB_00466eed
    DEC EAX                             ; 00466ef2
    CMP EAX,dword ptr [EBP + -0x14]     ; 00466ef3
    JGE 0x00466efa                      ; 00466ef6 | LAB_00466efa
        ;   XREF to: 00466efa (CONDITIONAL_JUMP)
    JMP 0x00466f05                      ; 00466ef8 | LAB_00466f05
        ;   Label: LAB_00466ef8
        ;   XREF to: 00466f05 (UNCONDITIONAL_JUMP)
    MOV EAX,[0x01626408]                ; 00466efa | int g_VertexCount
        ;   Label: LAB_00466efa
    DEC EAX                             ; 00466eff
    CMP EAX,dword ptr [EBP + -0x18]     ; 00466f00
    JGE 0x00466f26                      ; 00466f03 | LAB_00466f26
        ;   XREF to: 00466f26 (CONDITIONAL_JUMP)
    PUSH 0x2c                           ; 00466f05
        ;   Label: LAB_00466f05
    PUSH 0x0                            ; 00466f07
    MOV EAX,0x61c8b0                    ; 00466f09 | = "Invalid point." | s_Invalid_point_0061c8b0 = Invalid point.
    PUSH EAX                            ; 00466f0e | = "Invalid point." | s_Invalid_point_0061c8b0 = Invalid point.
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 00466f0f | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00466f14
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 00466f17 | void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20()
        ;   XREF to: 005eda20 (UNCONDITIONAL_CALL)
    CALL wincore_winrun.cpp_getNextKeypress_FUN_005f2e90 ; 00466f1c | int wincore_winrun.cpp_getNextKeypress_FUN_005f2e90()
        ;   XREF to: 005f2e90 (UNCONDITIONAL_CALL)
    JMP 0x00466ffa                      ; 00466f21 | LAB_00466ffa
        ;   XREF to: 00466ffa (UNCONDITIONAL_JUMP)
    IMUL EAX,dword ptr [EBP + -0x18],0x14 ; 00466f26
        ;   Label: LAB_00466f26
    MOV EAX,dword ptr [EAX + 0x162640c] ; 00466f2a | SVertexData[20000] g_LoadedVertices
    MOV dword ptr [EBP + -0x4],EAX      ; 00466f30
    IMUL EAX,dword ptr [EBP + -0x14],0x14 ; 00466f33
    MOV EAX,dword ptr [EAX + 0x162640c] ; 00466f37 | SVertexData[20000] g_LoadedVertices
    MOV dword ptr [EBP + -0x8],EAX      ; 00466f3d
    JMP 0x00466f8d                      ; 00466f40 | LAB_00466f8d
        ;   XREF to: 00466f8d (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x1c],0x0     ; 00466f42
        ;   Label: LAB_00466f42
    JMP 0x00466f51                      ; 00466f49 | LAB_00466f51
    ...
    MOV EAX,dword ptr [EBP + -0x1c]     ; 00466f51
        ;   Label: LAB_00466f51
    CMP EAX,dword ptr [0x01626408]      ; 00466f54 | int g_VertexCount
    JGE 0x00466f8d                      ; 00466f5a | LAB_00466f8d
        ;   XREF to: 00466f8d (CONDITIONAL_JUMP)
    IMUL EAX,dword ptr [EBP + -0x1c],0x14 ; 00466f5c
    MOV EAX,dword ptr [EAX + 0x162640c] ; 00466f60 | SVertexData[20000] g_LoadedVertices
    MOV dword ptr [EBP + -0xc],EAX      ; 00466f66
    FLD float ptr [EBP + -0xc]          ; 00466f69
    FCOMP float ptr [EBP + -0x4]        ; 00466f6c
    FNSTSW AX                           ; 00466f6f
    SAHF                                ; 00466f71
    JBE 0x00466f7a                      ; 00466f72 | LAB_00466f7a
    ...
    JMP 0x00466fa8                      ; 00466fa0 | LAB_00466fa8
    ...
    MOV EAX,dword ptr [EBP + -0x1c]     ; 00466fa8
        ;   Label: LAB_00466fa8
    CMP EAX,dword ptr [0x01626408]      ; 00466fab | int g_VertexCount
    JGE 0x00466ffa                      ; 00466fb1 | LAB_00466ffa
        ;   XREF to: 00466ffa (CONDITIONAL_JUMP)
    IMUL EAX,dword ptr [EBP + -0x1c],0x14 ; 00466fb3
    FLD float ptr [EAX + 0x162640c]     ; 00466fb7 | SVertexData[20000] g_LoadedVertices
    FMUL float ptr [EBP + -0x10]        ; 00466fbd
    IMUL EAX,dword ptr [EBP + -0x1c],0x14 ; 00466fc0
    FSTP float ptr [EAX + 0x162640c]    ; 00466fc4 | SVertexData[20000] g_LoadedVertices
    ...
    JMP 0x00466fa2                      ; 00466ff8 | LAB_00466fa2
