...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_design.c_sizeModelToYFeet_FUN_00467010(void)
;
; Local Variables:
...
section .text
    ...
    CALL wincore_windll.cpp_clearScreen_FUN_005b3e70 ; 0046702a | void wincore_windll.cpp_clearScreen_FUN_005b3e70()
        ;   XREF to: 005b3e70 (UNCONDITIONAL_CALL)
    MOV ECX,0x61c8bf                    ; 0046702f | = "Enter Y distance in feet (,min,max fo..." | s_Enter_Y_distance_in_feet_0061c8bf = Enter Y distance in feet (,min,max for user-defined min/max points) :
    PUSH ECX                            ; 00467034 | = "Enter Y distance in feet (,min,max fo..." | s_Enter_Y_distance_in_feet_0061c8bf = Enter Y distance in feet (,min,max for user-defined min/max points) :
    PUSH 0x16                           ; 00467035
    PUSH 0x0                            ; 00467037
    PUSH 0x14                           ; 00467039
    LEA ECX,[EBP + -0x6c]               ; 0046703b
    PUSH ECX                            ; 0046703e
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 0046703f | int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
    ...
    JNZ 0x0046705d                      ; 00467056 | LAB_0046705d
        ;   XREF to: 0046705d (CONDITIONAL_JUMP)
    JMP 0x004671ca                      ; 00467058 | LAB_004671ca
    ...
    PUSH EAX                            ; 00467068
    MOV EAX,0x61c906                    ; 00467069 | = "%f,%d,%d" | s_f_d_d_0061c906 = %f,%d,%d
    PUSH EAX                            ; 0046706e | = "%f,%d,%d" | s_f_d_d_0061c906 = %f,%d,%d
    LEA EAX,[EBP + -0x6c]               ; 0046706f
    PUSH EAX                            ; 00467072
    CALL crt_stdio.c_sscanf_FUN_0060013c ; 00467073 | int crt_stdio.c_sscanf_FUN_0060013c(char * str, char * format)
    ...
    JLE 0x00467112                      ; 00467082 | LAB_00467112
        ;   XREF to: 00467112 (CONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0x1c],0x3     ; 00467088
    JZ 0x004670af                       ; 0046708c | LAB_004670af
        ;   XREF to: 004670af (CONDITIONAL_JUMP)
    PUSH 0x2c                           ; 0046708e
    PUSH 0x0                            ; 00467090
    MOV EAX,0x61c90f                    ; 00467092 | = "Need distance and two points." | s_Need_distance_and_two_po_0061c90f = Need distance and two points.
    PUSH EAX                            ; 00467097 | = "Need distance and two points." | s_Need_distance_and_two_po_0061c90f = Need distance and two points.
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 00467098 | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0046709d
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 004670a0 | void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20()
        ;   XREF to: 005eda20 (UNCONDITIONAL_CALL)
    CALL wincore_winrun.cpp_getNextKeypress_FUN_005f2e90 ; 004670a5 | int wincore_winrun.cpp_getNextKeypress_FUN_005f2e90()
        ;   XREF to: 005f2e90 (UNCONDITIONAL_CALL)
    JMP 0x004671ca                      ; 004670aa | LAB_004671ca
        ;   XREF to: 004671ca (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0x14],0x0     ; 004670af
        ;   Label: LAB_004670af
    JL 0x004670bb                       ; 004670b3 | LAB_004670bb
        ;   XREF to: 004670bb (CONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0x18],0x0     ; 004670b5
    JGE 0x004670bd                      ; 004670b9 | LAB_004670bd
        ;   XREF to: 004670bd (CONDITIONAL_JUMP)
    JMP 0x004670c8                      ; 004670bb | LAB_004670c8
        ;   Label: LAB_004670bb
        ;   XREF to: 004670c8 (UNCONDITIONAL_JUMP)
    MOV EAX,[0x01626408]                ; 004670bd | int g_VertexCount
        ;   Label: LAB_004670bd
    DEC EAX                             ; 004670c2
    CMP EAX,dword ptr [EBP + -0x14]     ; 004670c3
    JGE 0x004670ca                      ; 004670c6 | LAB_004670ca
        ;   XREF to: 004670ca (CONDITIONAL_JUMP)
    JMP 0x004670d5                      ; 004670c8 | LAB_004670d5
        ;   Label: LAB_004670c8
        ;   XREF to: 004670d5 (UNCONDITIONAL_JUMP)
    MOV EAX,[0x01626408]                ; 004670ca | int g_VertexCount
        ;   Label: LAB_004670ca
    DEC EAX                             ; 004670cf
    CMP EAX,dword ptr [EBP + -0x18]     ; 004670d0
    JGE 0x004670f6                      ; 004670d3 | LAB_004670f6
        ;   XREF to: 004670f6 (CONDITIONAL_JUMP)
    PUSH 0x2c                           ; 004670d5
        ;   Label: LAB_004670d5
    PUSH 0x0                            ; 004670d7
    MOV EAX,0x61c92d                    ; 004670d9 | = "Invalid point." | s_Invalid_point_0061c92d = Invalid point.
    PUSH EAX                            ; 004670de | = "Invalid point." | s_Invalid_point_0061c92d = Invalid point.
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 004670df | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004670e4
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 004670e7 | void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20()
        ;   XREF to: 005eda20 (UNCONDITIONAL_CALL)
    CALL wincore_winrun.cpp_getNextKeypress_FUN_005f2e90 ; 004670ec | int wincore_winrun.cpp_getNextKeypress_FUN_005f2e90()
        ;   XREF to: 005f2e90 (UNCONDITIONAL_CALL)
    JMP 0x004671ca                      ; 004670f1 | LAB_004671ca
        ;   XREF to: 004671ca (UNCONDITIONAL_JUMP)
    ...
    JMP 0x0046715d                      ; 00467110 | LAB_0046715d
        ;   XREF to: 0046715d (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x1c],0x0     ; 00467112
        ;   Label: LAB_00467112
    JMP 0x00467121                      ; 00467119 | LAB_00467121
    ...
    MOV EAX,dword ptr [EBP + -0x1c]     ; 00467121
        ;   Label: LAB_00467121
    CMP EAX,dword ptr [0x01626408]      ; 00467124 | int g_VertexCount
    JGE 0x0046715d                      ; 0046712a | LAB_0046715d
    ...
    FNSTSW AX                           ; 0046713f
    SAHF                                ; 00467141
    JBE 0x0046714a                      ; 00467142 | LAB_0046714a
    ...
    JMP 0x00467178                      ; 00467170 | LAB_00467178
    ...
    MOV EAX,dword ptr [EBP + -0x1c]     ; 00467178
        ;   Label: LAB_00467178
    CMP EAX,dword ptr [0x01626408]      ; 0046717b | int g_VertexCount
    JGE 0x004671ca                      ; 00467181 | LAB_004671ca
        ;   XREF to: 004671ca (CONDITIONAL_JUMP)
    IMUL EAX,dword ptr [EBP + -0x1c],0x14 ; 00467183
    FLD float ptr [EAX + 0x162640c]     ; 00467187 | SVertexData[20000] g_LoadedVertices
    FMUL float ptr [EBP + -0x10]        ; 0046718d
    IMUL EAX,dword ptr [EBP + -0x1c],0x14 ; 00467190
    FSTP float ptr [EAX + 0x162640c]    ; 00467194 | SVertexData[20000] g_LoadedVertices
    ...
    JMP 0x00467172                      ; 004671c8 | LAB_00467172
