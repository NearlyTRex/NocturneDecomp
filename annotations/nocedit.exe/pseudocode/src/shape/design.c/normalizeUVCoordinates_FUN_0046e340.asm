...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_design.c_normalizeUVCoordinates_FUN_0046e340(void)
;
; Local Variables:
...
section .text
    ...
    JMP 0x0046e358                      ; 0046e353 | LAB_0046e358
        ;   XREF to: 0046e358 (UNCONDITIONAL_JUMP)
    INC dword ptr [EBP + -0x8]          ; 0046e355
        ;   Label: LAB_0046e355
    MOV EAX,dword ptr [EBP + -0x8]      ; 0046e358
        ;   Label: LAB_0046e358
    CMP EAX,dword ptr [0x016e990c]      ; 0046e35b | int g_PolygonCount
    JGE 0x0046e4c2                      ; 0046e361 | LAB_0046e4c2
    ...
    JMP 0x0046e381                      ; 0046e37c | LAB_0046e381
    ...
    CMP EAX,dword ptr [EDX + 0x16e99b4] ; 0046e38b | DAT_016e99b4
    JGE 0x0046e402                      ; 0046e391 | LAB_0046e402
    ...
    FLD float ptr [EAX + 0x16e9a08]     ; 0046e3a2 | DAT_016e9a08
    FCOMP float ptr [EBP + -0x14]       ; 0046e3a8
    FNSTSW AX                           ; 0046e3ab
    SAHF                                ; 0046e3ad
    JNC 0x0046e3c8                      ; 0046e3ae | LAB_0046e3c8
    ...
    MOV EAX,dword ptr [EAX + 0x16e9a08] ; 0046e3bf | DAT_016e9a08
    ...
    FLD float ptr [EAX + 0x16e9a48]     ; 0046e3d7 | DAT_016e9a48
    FCOMP float ptr [EBP + -0x10]       ; 0046e3dd
    FNSTSW AX                           ; 0046e3e0
    SAHF                                ; 0046e3e2
    JNC 0x0046e3fd                      ; 0046e3e3 | LAB_0046e3fd
    ...
    MOV EAX,dword ptr [EAX + 0x16e9a48] ; 0046e3f4 | DAT_016e9a48
    MOV dword ptr [EBP + -0x10],EAX     ; 0046e3fa
    JMP 0x0046e37e                      ; 0046e3fd | LAB_0046e37e
        ;   Label: LAB_0046e3fd
    ...
    FMUL double ptr [0x0061de66]        ; 0046e40f | double g_UvNormalizationFactor
    SUB ESP,0x8                         ; 0046e415
    FSTP double ptr [ESP]               ; 0046e418
    CALL crt_math.c_floor_FUN_005feb90  ; 0046e41b | double crt_math.c_floor_FUN_005feb90(double input_value)
    ...
    FMUL double ptr [0x0061de6e]        ; 0046e42c | double g_UvOffsetMultiplier
    FSTP float ptr [EBP + -0x14]        ; 0046e432
    FLD float ptr [EBP + -0x10]         ; 0046e435
    FADD float ptr [EBP + -0xc]         ; 0046e438
    FMUL double ptr [0x0061de66]        ; 0046e43b | double g_UvNormalizationFactor
    SUB ESP,0x8                         ; 0046e441
    FSTP double ptr [ESP]               ; 0046e444
    CALL crt_math.c_floor_FUN_005feb90  ; 0046e447 | double crt_math.c_floor_FUN_005feb90(double input_value)
        ;   XREF to: 005feb90 (UNCONDITIONAL_CALL)
    ...
    FMUL double ptr [0x0061de6e]        ; 0046e458 | double g_UvOffsetMultiplier
    FSTP float ptr [EBP + -0x10]        ; 0046e45e
    MOV dword ptr [EBP + -0x4],0x0      ; 0046e461
    JMP 0x0046e46d                      ; 0046e468 | LAB_0046e46d
    ...
    CMP EAX,dword ptr [EDX + 0x16e99b4] ; 0046e477 | DAT_016e99b4
    JGE 0x0046e4bd                      ; 0046e47d | LAB_0046e4bd
    ...
    FLD float ptr [EAX + 0x16e9a08]     ; 0046e48e | DAT_016e9a08
    FSUB float ptr [EBP + -0x14]        ; 0046e494
    FSTP float ptr [EAX + 0x16e9a08]    ; 0046e497 | DAT_016e9a08
    IMUL EAX,dword ptr [EBP + -0x8],0x184 ; 0046e49d
    MOV EDX,dword ptr [EBP + -0x4]      ; 0046e4a4
    SHL EDX,0x2                         ; 0046e4a7
    ADD EAX,EDX                         ; 0046e4aa
    FLD float ptr [EAX + 0x16e9a48]     ; 0046e4ac | DAT_016e9a48
    FSUB float ptr [EBP + -0x10]        ; 0046e4b2
    FSTP float ptr [EAX + 0x16e9a48]    ; 0046e4b5 | DAT_016e9a48
    JMP 0x0046e46a                      ; 0046e4bb | LAB_0046e46a
        ;   XREF to: 0046e46a (UNCONDITIONAL_JUMP)
    JMP 0x0046e355                      ; 0046e4bd | LAB_0046e355
        ;   Label: LAB_0046e4bd
