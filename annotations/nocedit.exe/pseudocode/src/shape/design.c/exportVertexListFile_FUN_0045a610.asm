...
section .text
    ...
    MOV EAX,0x61aed2                    ; 0045a61c | = "wt" | s_wt_0061aed2 = wt
    PUSH EAX                            ; 0045a621 | = "wt" | s_wt_0061aed2 = wt
    MOV EAX,0x61aed5                    ; 0045a622 | = "input.lst" | s_input_lst_0061aed5 = input.lst
    PUSH EAX                            ; 0045a627 | = "input.lst" | s_input_lst_0061aed5 = input.lst
    MOV EAX,0x61aedf                    ; 0045a628 | = "models" | s_models_0061aedf = models
    PUSH EAX                            ; 0045a62d | = "models" | s_models_0061aedf = models
    CALL engine_dosio.c_getFile_FUN_00481a50 ; 0045a62e | FILE * engine_dosio.c_getFile_FUN_00481a50(char * directory, char * filename, char * mode)
        ;   XREF to: 00481a50 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0045a633
    MOV dword ptr [EBP + -0x4],EAX      ; 0045a636
    CMP dword ptr [EBP + -0x4],0x0      ; 0045a639
    JNZ 0x0045a661                      ; 0045a63d | LAB_0045a661
        ;   XREF to: 0045a661 (CONDITIONAL_JUMP)
    MOV dword ptr [0x02f0ca48],0x61aee6 ; 0045a63f | char * g_CurrentFilename | = "..\\shape\\design.c" | s_shape_design_c_0061aee6 = ..\shape\design.c
    MOV dword ptr [0x02f0ca4c],0x6ca    ; 0045a649 | int g_CurrentLineNumber
    MOV EAX,0x61aef8                    ; 0045a653 | = "Unable to open input.lst" | s_Unable_to_open_input_lst_0061aef8 = Unable to open input.lst
    PUSH EAX                            ; 0045a658 | = "Unable to open input.lst" | s_Unable_to_open_input_lst_0061aef8 = Unable to open input.lst
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0045a659 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0045a65e
    PUSH dword ptr [0x01626408]         ; 0045a661 | int g_VertexCount
        ;   Label: LAB_0045a661
    ...
    PUSH EAX                            ; 0045a670
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0045a671 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0045a676
    MOV dword ptr [EBP + -0xc],0x0      ; 0045a679
    JMP 0x0045a688                      ; 0045a680 | LAB_0045a688
    ...
    MOV EAX,dword ptr [EBP + -0xc]      ; 0045a688
        ;   Label: LAB_0045a688
    CMP EAX,dword ptr [0x01626408]      ; 0045a68b | int g_VertexCount
    JGE 0x0045a6d7                      ; 0045a691 | LAB_0045a6d7
    ...
    FLD float ptr [EAX + 0x162640c]     ; 0045a6b7 | SVertexData[20000] g_LoadedVertices
    SUB ESP,0x8                         ; 0045a6bd
    FSTP double ptr [ESP]               ; 0045a6c0
    MOV EAX,0x61af15                    ; 0045a6c3 | = "%f,%f,%f\n" | s_f_f_f_0061af15 = %f,%f,%f

    PUSH EAX                            ; 0045a6c8 | = "%f,%f,%f\n" | s_f_f_f_0061af15 = %f,%f,%f

    MOV EAX,dword ptr [EBP + -0x4]      ; 0045a6c9
    PUSH EAX                            ; 0045a6cc
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0045a6cd | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x20                        ; 0045a6d2
    JMP 0x0045a682                      ; 0045a6d5 | LAB_0045a682
        ;   XREF to: 0045a682 (UNCONDITIONAL_JUMP)
    PUSH dword ptr [0x016e990c]         ; 0045a6d7 | int g_PolygonCount
        ;   Label: LAB_0045a6d7
    ...
    PUSH EAX                            ; 0045a6e6
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0045a6e7 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0045a6ec
    MOV dword ptr [EBP + -0xc],0x0      ; 0045a6ef
    JMP 0x0045a6fe                      ; 0045a6f6 | LAB_0045a6fe
    ...
    MOV EAX,dword ptr [EBP + -0xc]      ; 0045a6fe
        ;   Label: LAB_0045a6fe
    CMP EAX,dword ptr [0x016e990c]      ; 0045a701 | int g_PolygonCount
    JGE 0x0045a78d                      ; 0045a707 | LAB_0045a78d
    ...
    MOV EAX,0x61af23                    ; 0045a71a | = "%d" | s_d_0061af23 = %d
    PUSH EAX                            ; 0045a71f | = "%d" | s_d_0061af23 = %d
    MOV EAX,dword ptr [EBP + -0x4]      ; 0045a720
    PUSH EAX                            ; 0045a723
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0045a724 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0045a729
    MOV dword ptr [EBP + -0x8],0x0      ; 0045a72c
    JMP 0x0045a73b                      ; 0045a733 | LAB_0045a73b
    ...
    JGE 0x0045a776                      ; 0045a74b | LAB_0045a776
    ...
    MOV EAX,0x61af26                    ; 0045a762 | = ",%d" | s_d_0061af26 = ,%d
    PUSH EAX                            ; 0045a767 | = ",%d" | s_d_0061af26 = ,%d
    MOV EAX,dword ptr [EBP + -0x4]      ; 0045a768
    PUSH EAX                            ; 0045a76b
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0045a76c | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0045a771
    JMP 0x0045a735                      ; 0045a774 | LAB_0045a735
    ...
    PUSH EAX                            ; 0045a77f
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0045a780 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0045a785
    JMP 0x0045a6f8                      ; 0045a788 | LAB_0045a6f8
        ;   XREF to: 0045a6f8 (UNCONDITIONAL_JUMP)
    PUSH 0x6d8                          ; 0045a78d
        ;   Label: LAB_0045a78d
    MOV EAX,0x61af2c                    ; 0045a792 | = "..\\shape\\design.c" | s_shape_design_c_0061af2c = ..\shape\design.c
    PUSH EAX                            ; 0045a797 | = "..\\shape\\design.c" | s_shape_design_c_0061af2c = ..\shape\design.c
    MOV EAX,dword ptr [EBP + -0x4]      ; 0045a798
    PUSH EAX                            ; 0045a79b
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 0045a79c | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
