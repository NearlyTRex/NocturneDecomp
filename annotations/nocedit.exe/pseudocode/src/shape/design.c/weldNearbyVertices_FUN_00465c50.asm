...
section .text
    ...
    JMP 0x00465c6b                      ; 00465c63 | LAB_00465c6b
    ...
    JGE 0x00465d3d                      ; 00465c7b | LAB_00465d3d
    ...
    JMP 0x00465ca8                      ; 00465ca0 | LAB_00465ca8
    ...
    MOV EAX,dword ptr [EBP + -0x8]      ; 00465ca8
        ;   Label: LAB_00465ca8
    CMP EAX,dword ptr [0x01626408]      ; 00465cab | int g_VertexCount
    JGE 0x00465d38                      ; 00465cb1 | LAB_00465d38
        ;   XREF to: 00465d38 (CONDITIONAL_JUMP)
    IMUL EDX,dword ptr [EBP + -0x4],0x14 ; 00465cb7
    IMUL EAX,dword ptr [EBP + -0x8],0x14 ; 00465cbb
    FLD float ptr [EDX + 0x162640c]     ; 00465cbf | SVertexData[20000] g_LoadedVertices
    FSUB float ptr [EAX + 0x162640c]    ; 00465cc5 | SVertexData[20000] g_LoadedVertices
    FABS                                ; 00465ccb
    FLD float ptr [EBP + 0x18]          ; 00465ccd
    FCOMPP                              ; 00465cd0
    FNSTSW AX                           ; 00465cd2
    SAHF                                ; 00465cd4
    JBE 0x00465cf7                      ; 00465cd5 | LAB_00465cf7
    ...
    FNSTSW AX                           ; 00465cf2
    SAHF                                ; 00465cf4
    JA 0x00465cf9                       ; 00465cf5 | LAB_00465cf9
        ;   XREF to: 00465cf9 (CONDITIONAL_JUMP)
    JMP 0x00465d19                      ; 00465cf7 | LAB_00465d19
        ;   Label: LAB_00465cf7
    ...
    FNSTSW AX                           ; 00465d14
    SAHF                                ; 00465d16
    JA 0x00465d1b                       ; 00465d17 | LAB_00465d1b
        ;   XREF to: 00465d1b (CONDITIONAL_JUMP)
    JMP 0x00465d33                      ; 00465d19 | LAB_00465d33
        ;   Label: LAB_00465d19
    ...
    JMP 0x00465ca2                      ; 00465d33 | LAB_00465ca2
        ;   Label: LAB_00465d33
        ;   XREF to: 00465ca2 (UNCONDITIONAL_JUMP)
    JMP 0x00465c65                      ; 00465d38 | LAB_00465c65
        ;   Label: LAB_00465d38
        ;   XREF to: 00465c65 (UNCONDITIONAL_JUMP)
    CALL shape_design.c_removeUnusedVertices_FUN_00463830 ; 00465d3d | void shape_design.c_removeUnusedVertices_FUN_00463830()
        ;   Label: LAB_00465d3d
