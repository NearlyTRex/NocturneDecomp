...
section .text
    ...
    CALL wincore_windll.cpp_clearScreen_FUN_005b3e70 ; 00466c8a | void wincore_windll.cpp_clearScreen_FUN_005b3e70()
        ;   XREF to: 005b3e70 (UNCONDITIONAL_CALL)
    MOV ECX,0x61c7c5                    ; 00466c8f | = "Enter Z distance in feet (,min,max fo..." | s_Enter_Z_distance_in_feet_0061c7c5 = Enter Z distance in feet (,min,max for user-defined min/max points) :
    PUSH ECX                            ; 00466c94 | = "Enter Z distance in feet (,min,max fo..." | s_Enter_Z_distance_in_feet_0061c7c5 = Enter Z distance in feet (,min,max for user-defined min/max points) :
    PUSH 0x16                           ; 00466c95
    PUSH 0x0                            ; 00466c97
    PUSH 0x14                           ; 00466c99
    LEA ECX,[EBP + -0x6c]               ; 00466c9b
    PUSH ECX                            ; 00466c9e
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 00466c9f | int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
    ...
    JNZ 0x00466cbd                      ; 00466cb6 | LAB_00466cbd
        ;   XREF to: 00466cbd (CONDITIONAL_JUMP)
    JMP 0x00466e2a                      ; 00466cb8 | LAB_00466e2a
    ...
    PUSH EAX                            ; 00466cc8
    MOV EAX,0x61c80c                    ; 00466cc9 | = "%f,%d,%d" | s_f_d_d_0061c80c = %f,%d,%d
    PUSH EAX                            ; 00466cce | = "%f,%d,%d" | s_f_d_d_0061c80c = %f,%d,%d
    LEA EAX,[EBP + -0x6c]               ; 00466ccf
    PUSH EAX                            ; 00466cd2
    CALL crt_stdio.c_sscanf_FUN_0060013c ; 00466cd3 | int crt_stdio.c_sscanf_FUN_0060013c(char * str, char * format)
    ...
    JLE 0x00466d72                      ; 00466ce2 | LAB_00466d72
        ;   XREF to: 00466d72 (CONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0x1c],0x3     ; 00466ce8
    JZ 0x00466d0f                       ; 00466cec | LAB_00466d0f
        ;   XREF to: 00466d0f (CONDITIONAL_JUMP)
    PUSH 0x2c                           ; 00466cee
    PUSH 0x0                            ; 00466cf0
    MOV EAX,0x61c815                    ; 00466cf2 | = "Need distance and two points." | s_Need_distance_and_two_po_0061c815 = Need distance and two points.
    PUSH EAX                            ; 00466cf7 | = "Need distance and two points." | s_Need_distance_and_two_po_0061c815 = Need distance and two points.
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 00466cf8 | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00466cfd
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 00466d00 | void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20()
        ;   XREF to: 005eda20 (UNCONDITIONAL_CALL)
    CALL wincore_winrun.cpp_getNextKeypress_FUN_005f2e90 ; 00466d05 | int wincore_winrun.cpp_getNextKeypress_FUN_005f2e90()
        ;   XREF to: 005f2e90 (UNCONDITIONAL_CALL)
    JMP 0x00466e2a                      ; 00466d0a | LAB_00466e2a
        ;   XREF to: 00466e2a (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0x14],0x0     ; 00466d0f
        ;   Label: LAB_00466d0f
    JL 0x00466d1b                       ; 00466d13 | LAB_00466d1b
        ;   XREF to: 00466d1b (CONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0x18],0x0     ; 00466d15
    JGE 0x00466d1d                      ; 00466d19 | LAB_00466d1d
        ;   XREF to: 00466d1d (CONDITIONAL_JUMP)
    JMP 0x00466d28                      ; 00466d1b | LAB_00466d28
        ;   Label: LAB_00466d1b
        ;   XREF to: 00466d28 (UNCONDITIONAL_JUMP)
    MOV EAX,[0x01626408]                ; 00466d1d | int g_VertexCount
        ;   Label: LAB_00466d1d
    DEC EAX                             ; 00466d22
    CMP EAX,dword ptr [EBP + -0x14]     ; 00466d23
    JGE 0x00466d2a                      ; 00466d26 | LAB_00466d2a
        ;   XREF to: 00466d2a (CONDITIONAL_JUMP)
    JMP 0x00466d35                      ; 00466d28 | LAB_00466d35
        ;   Label: LAB_00466d28
        ;   XREF to: 00466d35 (UNCONDITIONAL_JUMP)
    MOV EAX,[0x01626408]                ; 00466d2a | int g_VertexCount
        ;   Label: LAB_00466d2a
    DEC EAX                             ; 00466d2f
    CMP EAX,dword ptr [EBP + -0x18]     ; 00466d30
    JGE 0x00466d56                      ; 00466d33 | LAB_00466d56
        ;   XREF to: 00466d56 (CONDITIONAL_JUMP)
    PUSH 0x2c                           ; 00466d35
        ;   Label: LAB_00466d35
    PUSH 0x0                            ; 00466d37
    MOV EAX,0x61c833                    ; 00466d39 | = "Invalid point." | s_Invalid_point_0061c833 = Invalid point.
    PUSH EAX                            ; 00466d3e | = "Invalid point." | s_Invalid_point_0061c833 = Invalid point.
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 00466d3f | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00466d44
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 00466d47 | void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20()
        ;   XREF to: 005eda20 (UNCONDITIONAL_CALL)
    CALL wincore_winrun.cpp_getNextKeypress_FUN_005f2e90 ; 00466d4c | int wincore_winrun.cpp_getNextKeypress_FUN_005f2e90()
        ;   XREF to: 005f2e90 (UNCONDITIONAL_CALL)
    JMP 0x00466e2a                      ; 00466d51 | LAB_00466e2a
        ;   XREF to: 00466e2a (UNCONDITIONAL_JUMP)
    ...
    JMP 0x00466dbd                      ; 00466d70 | LAB_00466dbd
        ;   XREF to: 00466dbd (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x1c],0x0     ; 00466d72
        ;   Label: LAB_00466d72
    JMP 0x00466d81                      ; 00466d79 | LAB_00466d81
    ...
    MOV EAX,dword ptr [EBP + -0x1c]     ; 00466d81
        ;   Label: LAB_00466d81
    CMP EAX,dword ptr [0x01626408]      ; 00466d84 | int g_VertexCount
    JGE 0x00466dbd                      ; 00466d8a | LAB_00466dbd
    ...
    FNSTSW AX                           ; 00466d9f
    SAHF                                ; 00466da1
    JBE 0x00466daa                      ; 00466da2 | LAB_00466daa
    ...
    JMP 0x00466dd8                      ; 00466dd0 | LAB_00466dd8
    ...
    MOV EAX,dword ptr [EBP + -0x1c]     ; 00466dd8
        ;   Label: LAB_00466dd8
    CMP EAX,dword ptr [0x01626408]      ; 00466ddb | int g_VertexCount
    JGE 0x00466e2a                      ; 00466de1 | LAB_00466e2a
        ;   XREF to: 00466e2a (CONDITIONAL_JUMP)
    IMUL EAX,dword ptr [EBP + -0x1c],0x14 ; 00466de3
    FLD float ptr [EAX + 0x162640c]     ; 00466de7 | SVertexData[20000] g_LoadedVertices
    FMUL float ptr [EBP + -0x10]        ; 00466ded
    IMUL EAX,dword ptr [EBP + -0x1c],0x14 ; 00466df0
    FSTP float ptr [EAX + 0x162640c]    ; 00466df4 | SVertexData[20000] g_LoadedVertices
    ...
    JMP 0x00466dd2                      ; 00466e28 | LAB_00466dd2
