...
section .text
    ...
    JMP 0x0045bb28                      ; 0045ba74 | LAB_0045bb28
    ...
    MOV dword ptr [0x02d052b8],0x0      ; 0045ba8e | int g_RelativeX
    MOV EAX,[0x01626344]                ; 0045ba98 | int g_ZoomLevel
    SHL EAX,0x4                         ; 0045ba9d
    MOV [0x02d052bc],EAX                ; 0045baa0 | int g_RelativeY
    MOV dword ptr [0x02d052c0],0x0      ; 0045baa5 | int g_RelativeZ
    JMP 0x0045bb48                      ; 0045baaf | LAB_0045bb48
    ...
    MOV EAX,[0x01626344]                ; 0045bac9 | int g_ZoomLevel
    SHL EAX,0x4                         ; 0045bace
    MOV [0x02d052b8],EAX                ; 0045bad1 | int g_RelativeX
    MOV dword ptr [0x02d052bc],0x0      ; 0045bad6 | int g_RelativeY
    MOV dword ptr [0x02d052c0],0x0      ; 0045bae0 | int g_RelativeZ
    JMP 0x0045bb48                      ; 0045baea | LAB_0045bb48
        ;   XREF to: 0045bb48 (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x10],0x0     ; 0045baec
        ;   Label: LAB_0045baec
    MOV dword ptr [EBP + -0xc],0x0      ; 0045baf3
    MOV dword ptr [EBP + -0x8],0x0      ; 0045bafa
    MOV dword ptr [0x02d052b8],0x0      ; 0045bb01 | int g_RelativeX
    MOV dword ptr [0x02d052bc],0x0      ; 0045bb0b | int g_RelativeY
    MOV EAX,[0x01626344]                ; 0045bb15 | int g_ZoomLevel
    NEG EAX                             ; 0045bb1a
    SHL EAX,0x4                         ; 0045bb1c
    MOV [0x02d052c0],EAX                ; 0045bb1f | int g_RelativeZ
    JMP 0x0045bb48                      ; 0045bb24 | LAB_0045bb48
        ;   XREF to: 0045bb48 (UNCONDITIONAL_JUMP)
    JMP 0x0045bb48                      ; 0045bb26 | LAB_0045bb48
        ;   Label: LAB_0045bb26
        ;   XREF to: 0045bb48 (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0x4],0x1      ; 0045bb28
        ;   Label: LAB_0045bb28
    JC 0x0045bb3c                       ; 0045bb2c | LAB_0045bb3c
        ;   XREF to: 0045bb3c (CONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0x4],0x1      ; 0045bb2e
    JBE 0x0045bab4                      ; 0045bb32 | LAB_0045bab4
        ;   XREF to: 0045bab4 (CONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0x4],0x2      ; 0045bb34
    JZ 0x0045baec                       ; 0045bb38 | LAB_0045baec
        ;   XREF to: 0045baec (CONDITIONAL_JUMP)
    JMP 0x0045bb26                      ; 0045bb3a | LAB_0045bb26
        ;   XREF to: 0045bb26 (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0x4],0x0      ; 0045bb3c
        ;   Label: LAB_0045bb3c
    JZ 0x0045ba79                       ; 0045bb40 | LAB_0045ba79
        ;   XREF to: 0045ba79 (CONDITIONAL_JUMP)
    JMP 0x0045bb26                      ; 0045bb46 | LAB_0045bb26
        ;   XREF to: 0045bb26 (UNCONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 0045bb53
    CALL engine_matrix.c_buildRotationMatrix_FUN_0050c920 ; 0045bb54 | void engine_matrix.c_buildRotationMatrix_FUN_0050c920(ushort pitch, ushort yaw, ushort roll)
