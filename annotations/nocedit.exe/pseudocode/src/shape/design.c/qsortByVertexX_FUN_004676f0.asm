...
;                               FUNCTION
; *****************************************************************************
; __cdecl int shape_design.c_qsortByVertexX_FUN_004676f0(SVertexPair * a, SVertexPair * b)
;
; Parameters:
...
section .text
    ...
    JNZ 0x00467710                      ; 00467702 | LAB_00467710
        ;   XREF to: 00467710 (CONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x14],0x0     ; 00467704
    JMP 0x004677ad                      ; 0046770b | LAB_004677ad
    ...
    FNSTSW AX                           ; 00467754
    SAHF                                ; 00467756
    JBE 0x00467762                      ; 00467757 | LAB_00467762
        ;   XREF to: 00467762 (CONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x14],0x1     ; 00467759
    JMP 0x004677ad                      ; 00467760 | LAB_004677ad
        ;   XREF to: 004677ad (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + -0x10]     ; 00467762
        ;   Label: LAB_00467762
    CMP EAX,dword ptr [EBP + -0xc]      ; 00467765
    JGE 0x00467773                      ; 00467768 | LAB_00467773
        ;   XREF to: 00467773 (CONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x14],0xffffffff ; 0046776a
    JMP 0x004677ad                      ; 00467771 | LAB_004677ad
        ;   XREF to: 004677ad (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + -0x10]     ; 00467773
        ;   Label: LAB_00467773
    CMP EAX,dword ptr [EBP + -0xc]      ; 00467776
    JLE 0x00467784                      ; 00467779 | LAB_00467784
        ;   XREF to: 00467784 (CONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x14],0x1     ; 0046777b
    JMP 0x004677ad                      ; 00467782 | LAB_004677ad
        ;   XREF to: 004677ad (UNCONDITIONAL_JUMP)
    MOV dword ptr [0x02f0ca48],0x61c9d1 ; 00467784 | char * g_CurrentFilename | = "..\\shape\\design.c" | s_shape_design_c_0061c9d1 = ..\shape\design.c
        ;   Label: LAB_00467784
    MOV dword ptr [0x02f0ca4c],0x2062   ; 0046778e | int g_CurrentLineNumber
    MOV EAX,0x61c9e3                    ; 00467798 | = "Hell froze." | s_Hell_froze_0061c9e3 = Hell froze.
    PUSH EAX                            ; 0046779d | = "Hell froze." | s_Hell_froze_0061c9e3 = Hell froze.
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0046779e | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
