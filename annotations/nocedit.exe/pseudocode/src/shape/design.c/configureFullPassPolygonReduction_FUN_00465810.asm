...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_design.c_configureFullPassPolygonReduction_FUN_00465810(int ui_mode)
;
; Parameters:
...
section .text
    ...
    MOV EAX,[0x016e990c]                ; 0046581c | int g_PolygonCount
    MOV dword ptr [EBP + -0xc],EAX      ; 00465821
    MOV dword ptr [EBP + -0x8],0x0      ; 00465824
    CMP dword ptr [EBP + 0x14],0x0      ; 0046582b
    JLE 0x00465850                      ; 0046582f | LAB_00465850
        ;   XREF to: 00465850 (CONDITIONAL_JUMP)
    CALL wincore_windll.cpp_clearScreen_FUN_005b3e70 ; 00465831 | void wincore_windll.cpp_clearScreen_FUN_005b3e70()
        ;   XREF to: 005b3e70 (UNCONDITIONAL_CALL)
    MOV EAX,0x61c5b6                    ; 00465836 | = "Enter tolerance angle [8.5] : " | s_Enter_tolerance_angle_8__0061c5b6 = Enter tolerance angle [8.5] :
    PUSH EAX                            ; 0046583b | = "Enter tolerance angle [8.5] : " | s_Enter_tolerance_angle_8__0061c5b6 = Enter tolerance angle [8.5] :
    PUSH 0x0                            ; 0046583c
    PUSH 0x0                            ; 0046583e
    PUSH 0x14                           ; 00465840
    LEA EAX,[EBP + -0x5c]               ; 00465842
    PUSH EAX                            ; 00465845
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 00465846 | int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
        ;   XREF to: 004032c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0046584b
    JMP 0x00465854                      ; 0046584e | LAB_00465854
    ...
    JZ 0x00465884                       ; 0046586a | LAB_00465884
        ;   XREF to: 00465884 (CONDITIONAL_JUMP)
    LEA EAX,[EBP + -0x5c]               ; 0046586c
    PUSH EAX                            ; 0046586f
    CALL crt_string.c_strtod_FUN_005ff0f3 ; 00465870 | double crt_string.c_strtod_FUN_005ff0f3(char * str)
    ...
    CMP dword ptr [EBP + 0x14],0x0      ; 00465884
        ;   Label: LAB_00465884
    JLE 0x004658bc                      ; 00465888 | LAB_004658bc
        ;   XREF to: 004658bc (CONDITIONAL_JUMP)
    MOV EAX,0x61c5d5                    ; 0046588a | = "Ignore different part names? [y] : " | s_Ignore_different_part_na_0061c5d5 = Ignore different part names? [y] :
    PUSH EAX                            ; 0046588f | = "Ignore different part names? [y] : " | s_Ignore_different_part_na_0061c5d5 = Ignore different part names? [y] :
    PUSH 0x16                           ; 00465890
    PUSH 0x0                            ; 00465892
    PUSH 0x14                           ; 00465894
    LEA EAX,[EBP + -0x5c]               ; 00465896
    PUSH EAX                            ; 00465899
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 0046589a | int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
        ;   XREF to: 004032c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0046589f
    XOR EAX,EAX                         ; 004658a2
    MOV AL,byte ptr [EBP + -0x5c]       ; 004658a4
    PUSH EAX                            ; 004658a7
    CALL crt_ctype.c_toupper_FUN_005ff9e0 ; 004658a8 | int crt_ctype.c_toupper_FUN_005ff9e0(int c)
        ;   XREF to: 005ff9e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004658ad
    CMP EAX,0x4e                        ; 004658b0
    JNZ 0x004658bc                      ; 004658b3 | LAB_004658bc
        ;   XREF to: 004658bc (CONDITIONAL_JUMP)
    ...
    CALL shape_design.c_optimizePolygonMesh_FUN_004658e0 ; 004658cd | void shape_design.c_optimizePolygonMesh_FUN_004658e0(float angle_tolerance, int strict_mode, int display_progress)
