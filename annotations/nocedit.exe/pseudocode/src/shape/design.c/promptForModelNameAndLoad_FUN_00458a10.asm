...
;                               FUNCTION
; *****************************************************************************
; __cdecl int shape_design.c_promptForModelNameAndLoad_FUN_00458a10(void)
;
; Local Variables:
...
section .text
    ...
    CALL wincore_windll.cpp_clearScreen_FUN_005b3e70 ; 00458a1c | void wincore_windll.cpp_clearScreen_FUN_005b3e70()
        ;   XREF to: 005b3e70 (UNCONDITIONAL_CALL)
    MOV EDX,0x61a9b6                    ; 00458a21 | = "Model name to load : " | s_Model_name_to_load_0061a9b6 = Model name to load :
    PUSH EDX                            ; 00458a26 | = "Model name to load : " | s_Model_name_to_load_0061a9b6 = Model name to load :
    PUSH 0x0                            ; 00458a27
    PUSH 0x0                            ; 00458a29
    PUSH 0x28                           ; 00458a2b
    LEA EDX,[EBP + -0x54]               ; 00458a2d
    PUSH EDX                            ; 00458a30
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 00458a31 | int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
    ...
    MOV AL,byte ptr [ESI]               ; 00458a41
        ;   Label: LAB_00458a41
    CMP AL,DL                           ; 00458a43
    JZ 0x00458a59                       ; 00458a45 | LAB_00458a59
        ;   XREF to: 00458a59 (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 00458a47
    JZ 0x00458a57                       ; 00458a49 | LAB_00458a57
        ;   XREF to: 00458a57 (CONDITIONAL_JUMP)
    INC ESI                             ; 00458a4b
    MOV AL,byte ptr [ESI]               ; 00458a4c
    CMP AL,DL                           ; 00458a4e
    JZ 0x00458a59                       ; 00458a50 | LAB_00458a59
        ;   XREF to: 00458a59 (CONDITIONAL_JUMP)
    INC ESI                             ; 00458a52
    CMP AL,0x0                          ; 00458a53
    JNZ 0x00458a41                      ; 00458a55 | LAB_00458a41
        ;   XREF to: 00458a41 (CONDITIONAL_JUMP)
    SUB ESI,ESI                         ; 00458a57
        ;   Label: LAB_00458a57
    TEST ESI,ESI                        ; 00458a59
        ;   Label: LAB_00458a59
    JNZ 0x00458a6f                      ; 00458a5b | LAB_00458a6f
    ...
    JBE 0x00458a71                      ; 00458a6d | LAB_00458a71
        ;   XREF to: 00458a71 (CONDITIONAL_JUMP)
    JMP 0x00458a9b                      ; 00458a6f | LAB_00458a9b
        ;   Label: LAB_00458a6f
        ;   XREF to: 00458a9b (UNCONDITIONAL_JUMP)
    MOV ESI,0x61a9cc                    ; 00458a71 | = ".MDL" | s_MDL_0061a9cc = .MDL
        ;   Label: LAB_00458a71
    ...
    DEC EDI                             ; 00458a81
    MOV AL,byte ptr [ESI]               ; 00458a82 | = ".MDL" | s_MDL_0061a9cc = .MDL
        ;   Label: LAB_00458a82
    MOV byte ptr [EDI],AL               ; 00458a84
    CMP AL,0x0                          ; 00458a86
    JZ 0x00458a9a                       ; 00458a88 | LAB_00458a9a
        ;   XREF to: 00458a9a (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 00458a8a | DAT_0061a9cd
    ADD ESI,0x2                         ; 00458a8d
    MOV byte ptr [EDI + 0x1],AL         ; 00458a90
    ADD EDI,0x2                         ; 00458a93
    CMP AL,0x0                          ; 00458a96
    JNZ 0x00458a82                      ; 00458a98 | LAB_00458a82
    ...
    LEA EAX,[EBP + -0x54]               ; 00458a9b
        ;   Label: LAB_00458a9b
    PUSH EAX                            ; 00458a9e
    CALL shape_design.c_loadModelFile_FUN_00458ac0 ; 00458a9f | int shape_design.c_loadModelFile_FUN_00458ac0(char * filename)
