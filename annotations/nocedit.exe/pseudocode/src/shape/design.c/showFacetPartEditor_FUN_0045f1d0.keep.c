  ...
  if (iVar4 == 0) {
    ...
    do {
      ...
      if (g_CurrentPartIndex == -1) {
        ...
        _sprintf(local_b8,"Current part : %s",g_ModelPartNames[g_CurrentPartIndex].name);
      }
      ...
      _sprintf(local_b8," : %d",g_VertexCount);
      ...
      _sprintf(local_b8," : %d",g_PolygonCount);
      ...
      _sprintf(local_b8," : %d",g_PartsCount);
      engine_2d_c_drawTextColor_FUN_00402430(local_b8,g_WindowWidth / 2 + 10 + iVar12,0x16);
      _sprintf
                (local_b8,"Zoom : %4.2f  FOV : %4.1f",65536.0 / (double)g_ProjectionScale,
                 90.0);
      ...
      if (g_LoadedModelName[0] == '\0') {
        ...
        _sprintf(local_b8,"%s",g_LoadedModelName);
      }
      ...
      if (g_SelectedPolygonIndex == -1) {
        ...
        _sprintf(local_b8,"Selected polygon : %d",g_SelectedPolygonIndex);
      }
      ...
      if (g_SelectedPolygonIndex != -1) {
        ...
        _sprintf
                  (local_b8,"Part number : %d (%s)",
                   ...
                   g_ModelPartNames[g_ModelPolygonData[g_SelectedPolygonIndex].part_assignment].name[0] != '\0' ?
                   g_ModelPartNames[g_ModelPolygonData[g_SelectedPolygonIndex].part_assignment].name : "no name");
        engine_2d_c_drawTextColor_FUN_00402430
        ...
        if (g_ModelPolygonData[g_SelectedPolygonIndex].lightmap_name[0] == '\0') {
          _sprintf(local_b8,"Texture : %s",
                   g_ModelPolygonData[g_SelectedPolygonIndex].texture_name[0] != '\0' ?
                   g_ModelPolygonData[g_SelectedPolygonIndex].texture_name : "none");
        }
        else {
          _sprintf
                    (local_b8,"Texture : %s (%s)",
                     g_ModelPolygonData[g_SelectedPolygonIndex].lightmap_name,
                     g_ModelPolygonData[g_SelectedPolygonIndex].texture_name);
        }
        engine_2d_c_drawTextColor_FUN_00402430
        ...
        if (g_ShowVertexCoordinates != 0) {
          ...
          for (local_44 = 0;
            ...
            _sprintf(local_b8,"%03d : %+011.6f %+011.6f %+011.6f",
                     g_ModelPolygonData[g_SelectedPolygonIndex].vertex_indices[local_44],
                     (double)g_LoadedVertices[g_ModelPolygonData[g_SelectedPolygonIndex].vertex_indices[local_44]].vertex.x,
                     (double)g_LoadedVertices[g_ModelPolygonData[g_SelectedPolygonIndex].vertex_indices[local_44]].vertex.y,
                     (double)g_LoadedVertices[g_ModelPolygonData[g_SelectedPolygonIndex].vertex_indices[local_44]].vertex.z);
            engine_2d_c_drawTextColor_FUN_00402430
                      (local_b8,g_WindowWidth / 2 + 10,g_WindowHeight + (0xb - local_44) * -0xb);
          }
        }
