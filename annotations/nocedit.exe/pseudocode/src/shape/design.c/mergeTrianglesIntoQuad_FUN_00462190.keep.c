...
LAB_004623f2:
      ...
      if (dVar9 >= 359.5) {
        ...
        if (iVar3 == 0) {
          uVar1 = g_ModelPolygonData[first_polygon_index].vertex_indices_count;
          for (local_28[3] = 0; (int)local_28[3] < (int)uVar1; local_28[3] = local_28[3] + 1) {
            g_ModelPolygonData[first_polygon_index].vertex_indices[local_28[3]] =
                 local_3c[(uVar1 - 1) - local_28[3]];
            g_ModelPolygonData[first_polygon_index].uv_u[local_28[3]] =
                 local_64[(uVar1 - 1) - local_28[3]];
            g_ModelPolygonData[first_polygon_index].uv_v[local_28[3]] =
                 local_50[(uVar1 - 1) - local_28[3]];
          }
          ...
          if (((ABS(g_ModelPolygonData[first_polygon_index].normal.x) == 0.0) &&
            ...
            dVar3 = shape_design_c_calculateVertexAngle_FUN_00462050
                              (g_ModelPolygonData[first_polygon_index].vertex_indices[0],
                               ...
                               g_ModelPolygonData[first_polygon_index].vertex_indices[2]);
            if (170 < dVar3) {
              uVar1 = g_ModelPolygonData[first_polygon_index].vertex_indices[0];
              ...
              g_ModelPolygonData[first_polygon_index].uv_v[2] =
                   g_ModelPolygonData[first_polygon_index].uv_v[3];
              g_ModelPolygonData[first_polygon_index].vertex_indices[3] = uVar1;
