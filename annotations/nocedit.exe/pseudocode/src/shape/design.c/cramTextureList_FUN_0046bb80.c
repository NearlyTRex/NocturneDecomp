...
LAB_0046c2ae:
  ...
  do {
    ...
    if (iVar4 != -2) {
      g_TextureAtlasDimension = atoi((char *)local_154);
    }
      ...
      *(ushort *)(acStack_84 + ((uint)bVar12 * -4 + (uint)bVar12 * -4) * 2) =
      ...
      if (cram_config == (SCramConfig *)0x0) {
        ...
        while( true ) {
          ...
          iVar4 = toupper((uint)local_a24[0]);
          if (iVar4 != 0x59) break;
