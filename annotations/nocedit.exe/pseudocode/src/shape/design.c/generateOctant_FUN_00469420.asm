...
section .text
    ...
    MOV dword ptr [0x016e990c],0x0      ; 0046942c | g_PolygonCount
    MOV dword ptr [0x01626408],0x0      ; 00469436 | g_VertexCount
    MOV ECX,0x61cf2e                    ; 00469440 | = "Enter in size in heading : "
    PUSH ECX                            ; 00469445 | = "Enter in size in heading : "
    PUSH 0x0                            ; 00469446
    PUSH 0x0                            ; 00469448
    PUSH 0xa                            ; 0046944a
    LEA ECX,[EBP + -0x7c]               ; 0046944c
    PUSH ECX                            ; 0046944f
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 00469450
    ...
    JNZ 0x0046946e                      ; 00469467
        ;   XREF to: 0046946e (CONDITIONAL_JUMP)  ; LAB_0046946e
    JMP 0x00469681                      ; 00469469
        ;   XREF to: 00469681 (UNCONDITIONAL_JUMP)  ; LAB_00469681
    LEA EAX,[EBP + -0x7c]               ; 0046946e
        ;   Label: LAB_0046946e
    PUSH EAX                            ; 00469471
    CALL crt_stdlib.c_atoi_FUN_005ffef0 ; 00469472
    ...
    FDIVR double ptr [0x0061cf66]       ; 00469480 | g_AngleConstant90Degrees1
    FSTP float ptr [EBP + -0xc]         ; 00469486
    MOV EAX,0x61cf4a                    ; 00469489 | = "Enter in size in pitch : "
    PUSH EAX                            ; 0046948e | = "Enter in size in pitch : "
    PUSH 0xb                            ; 0046948f
    PUSH 0x0                            ; 00469491
    PUSH 0xa                            ; 00469493
    LEA EAX,[EBP + -0x7c]               ; 00469495
    PUSH EAX                            ; 00469498
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 00469499
        ;   XREF to: 004032c0 (UNCONDITIONAL_CALL)  ; int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
    ...
    JNZ 0x004694b7                      ; 004694b0
        ;   XREF to: 004694b7 (CONDITIONAL_JUMP)  ; LAB_004694b7
    JMP 0x00469681                      ; 004694b2
        ;   XREF to: 00469681 (UNCONDITIONAL_JUMP)  ; LAB_00469681
    LEA EAX,[EBP + -0x7c]               ; 004694b7
        ;   Label: LAB_004694b7
    PUSH EAX                            ; 004694ba
    CALL crt_stdlib.c_atoi_FUN_005ffef0 ; 004694bb
        ;   XREF to: 005ffef0 (UNCONDITIONAL_CALL)  ; int crt_stdlib.c_atoi_FUN_005ffef0(char * string_ptr)
    ADD ESP,0x4                         ; 004694c0
    MOV dword ptr [EBP + -0x24],EAX     ; 004694c3
    FILD dword ptr [EBP + -0x24]        ; 004694c6
    FDIVR double ptr [0x0061cf86]       ; 004694c9 | g_AngleConstant90Degrees2
    FSTP float ptr [EBP + -0x8]         ; 004694cf
    MOV EAX,0x61cf6e                    ; 004694d2 | = "Enter in radius : "
    PUSH EAX                            ; 004694d7 | = "Enter in radius : "
    PUSH 0x16                           ; 004694d8
    PUSH 0x0                            ; 004694da
    PUSH 0xa                            ; 004694dc
    LEA EAX,[EBP + -0x7c]               ; 004694de
    PUSH EAX                            ; 004694e1
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 004694e2
        ;   XREF to: 004032c0 (UNCONDITIONAL_CALL)  ; int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
    ...
    JNZ 0x00469500                      ; 004694f9
        ;   XREF to: 00469500 (CONDITIONAL_JUMP)  ; LAB_00469500
    JMP 0x00469681                      ; 004694fb
        ;   XREF to: 00469681 (UNCONDITIONAL_JUMP)  ; LAB_00469681
    LEA EAX,[EBP + -0x7c]               ; 00469500
        ;   Label: LAB_00469500
    PUSH EAX                            ; 00469503
    CALL crt_string.c__strtod_FUN_005ff0f3 ; 00469504
    ...
    JMP 0x0046952d                      ; 00469525
        ;   XREF to: 0046952d (UNCONDITIONAL_JUMP)  ; LAB_0046952d
    MOV EAX,dword ptr [EBP + -0x4]      ; 00469527
        ;   Label: LAB_00469527
    INC dword ptr [EBP + -0x4]          ; 0046952a
    CMP dword ptr [EBP + -0x4],0x8      ; 0046952d
        ;   Label: LAB_0046952d
    JGE 0x00469681                      ; 00469531
        ;   XREF to: 00469681 (CONDITIONAL_JUMP)  ; LAB_00469681
    MOV dword ptr [EBP + -0x1c],0x0     ; 00469537
    JMP 0x00469546                      ; 0046953e
        ;   XREF to: 00469546 (UNCONDITIONAL_JUMP)  ; LAB_00469546
    ...
    JG 0x00469654                       ; 0046954c
        ;   XREF to: 00469654 (CONDITIONAL_JUMP)  ; LAB_00469654
    MOV dword ptr [EBP + -0x20],0x0     ; 00469552
    JMP 0x00469561                      ; 00469559
        ;   XREF to: 00469561 (UNCONDITIONAL_JUMP)  ; LAB_00469561
    ...
    JGE 0x0046964f                      ; 00469567
        ;   XREF to: 0046964f (CONDITIONAL_JUMP)  ; LAB_0046964f
    MOV EAX,[0x01626408]                ; 0046956d | g_VertexCount
    ...
    FSUBR double ptr [0x0061cf8e]       ; 0046958a | g_AngleConstant90Degrees3
    ...
    CALL shape_design.c_addVertexFromSphericalCoordsOctant_FUN_00469140 ; 004695ae
        ;   XREF to: 00469140 (UNCONDITIONAL_CALL)  ; void shape_design.c_addVertexFromSphericalCoordsOctant_FUN_00469140(float heading_angle, float pitch_angle, float radius)
    ...
    CALL shape_design.c_addVertexFromSphericalCoordsOctant_FUN_00469140 ; 004695d4
        ;   XREF to: 00469140 (UNCONDITIONAL_CALL)  ; void shape_design.c_addVertexFromSphericalCoordsOctant_FUN_00469140(float heading_angle, float pitch_angle, float radius)
    ...
    CALL shape_design.c_addVertexFromSphericalCoordsOctant_FUN_00469140 ; 004695fd
        ;   XREF to: 00469140 (UNCONDITIONAL_CALL)  ; void shape_design.c_addVertexFromSphericalCoordsOctant_FUN_00469140(float heading_angle, float pitch_angle, float radius)
    ...
    CALL shape_design.c_addVertexFromSphericalCoordsOctant_FUN_00469140 ; 00469623
        ;   XREF to: 00469140 (UNCONDITIONAL_CALL)  ; void shape_design.c_addVertexFromSphericalCoordsOctant_FUN_00469140(float heading_angle, float pitch_angle, float radius)
    ...
    PUSH EAX                            ; 00469641
    CALL shape_design.c_addQuadPolygonOctant_FUN_00469220 ; 00469642
        ;   XREF to: 00469220 (UNCONDITIONAL_CALL)  ; void shape_design.c_addQuadPolygonOctant_FUN_00469220(uint vertex_index_1, uint vertex_index_2, uint vertex_index_3, uint vertex_index_4)
    ADD ESP,0x10                        ; 00469647
    JMP 0x0046955b                      ; 0046964a
        ;   XREF to: 0046955b (UNCONDITIONAL_JUMP)  ; LAB_0046955b
    JMP 0x00469540                      ; 0046964f
        ;   XREF to: 00469540 (UNCONDITIONAL_JUMP)  ; LAB_00469540
        ;   Label: LAB_0046964f
    CMP dword ptr [EBP + -0x4],0x7      ; 00469654
        ;   Label: LAB_00469654
    JZ 0x0046967c                       ; 00469658
    ...
    PUSH dword ptr [EAX + 0x66eef8]     ; 0046966e | g_OctantRotationAngles
    CALL shape_design.c_realignObject_FUN_0045ee70 ; 00469674
    ...
    JMP 0x00469527                      ; 0046967c
        ;   XREF to: 00469527 (UNCONDITIONAL_JUMP)  ; LAB_00469527
        ;   Label: LAB_0046967c
