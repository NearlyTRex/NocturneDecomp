...
section .text
    ...
    JMP 0x0046667f                      ; 00466677 | LAB_0046667f
    ...
    MOV EAX,dword ptr [EBP + -0xc]      ; 0046667f
        ;   Label: LAB_0046667f
    CMP EAX,dword ptr [0x01626408]      ; 00466682 | int g_VertexCount
    JGE 0x00466744                      ; 00466688 | LAB_00466744
        ;   XREF to: 00466744 (CONDITIONAL_JUMP)
    IMUL EAX,dword ptr [EBP + -0xc],0x14 ; 0046668e
    FLD float ptr [EAX + 0x162640c]     ; 00466692 | SVertexData[20000] g_LoadedVertices
    ...
    FNSTSW AX                           ; 004666bb
    SAHF                                ; 004666bd
    JBE 0x004666cc                      ; 004666be | LAB_004666cc
    ...
    FNSTSW AX                           ; 004666d2
    SAHF                                ; 004666d4
    JNC 0x004666e3                      ; 004666d5 | LAB_004666e3
    ...
    FNSTSW AX                           ; 004666e9
    SAHF                                ; 004666eb
    JBE 0x004666fa                      ; 004666ec | LAB_004666fa
    ...
    FNSTSW AX                           ; 00466700
    SAHF                                ; 00466702
    JNC 0x00466711                      ; 00466703 | LAB_00466711
    ...
    FNSTSW AX                           ; 00466717
    SAHF                                ; 00466719
    JBE 0x00466728                      ; 0046671a | LAB_00466728
    ...
    FNSTSW AX                           ; 0046672e
    SAHF                                ; 00466730
    JNC 0x0046673f                      ; 00466731 | LAB_0046673f
    ...
    JMP 0x00466679                      ; 0046673f | LAB_00466679
        ;   Label: LAB_0046673f
        ;   XREF to: 00466679 (UNCONDITIONAL_JUMP)
    CALL wincore_windll.cpp_clearScreen_FUN_005b3e70 ; 00466744 | void wincore_windll.cpp_clearScreen_FUN_005b3e70()
        ;   Label: LAB_00466744
        ;   XREF to: 005b3e70 (UNCONDITIONAL_CALL)
    MOV EAX,0x61c725                    ; 00466749 | = "Press <Enter> or enter min,max points : " | s_Press_Enter_or_enter_min_0061c725 = Press <Enter> or enter min,max points :
    PUSH EAX                            ; 0046674e | = "Press <Enter> or enter min,max points : " | s_Press_Enter_or_enter_min_0061c725 = Press <Enter> or enter min,max points :
    PUSH 0x0                            ; 0046674f
    PUSH 0x0                            ; 00466751
    PUSH 0x14                           ; 00466753
    LEA EAX,[EBP + 0xffffff58]          ; 00466755
    PUSH EAX                            ; 0046675b
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 0046675c | int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
        ;   XREF to: 004032c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 00466761
    CMP EAX,0x1b                        ; 00466764
    JNZ 0x0046676e                      ; 00466767 | LAB_0046676e
        ;   XREF to: 0046676e (CONDITIONAL_JUMP)
    JMP 0x00466a21                      ; 00466769 | LAB_00466a21
    ...
    PUSH EAX                            ; 00466775
    MOV EAX,0x61c74e                    ; 00466776 | = "%d,%d" | s_d_d_0061c74e = %d,%d
    PUSH EAX                            ; 0046677b | = "%d,%d" | s_d_d_0061c74e = %d,%d
    LEA EAX,[EBP + 0xffffff58]          ; 0046677c
    PUSH EAX                            ; 00466782
    CALL crt_stdio.c_sscanf_FUN_0060013c ; 00466783 | int crt_stdio.c_sscanf_FUN_0060013c(char * str, char * format)
    ...
    JLE 0x004668bf                      ; 00466792 | LAB_004668bf
        ;   XREF to: 004668bf (CONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0xc],0x2      ; 00466798
    JZ 0x004667bf                       ; 0046679c | LAB_004667bf
        ;   XREF to: 004667bf (CONDITIONAL_JUMP)
    PUSH 0x16                           ; 0046679e
    PUSH 0x0                            ; 004667a0
    MOV EAX,0x61c754                    ; 004667a2 | = "Need two points." | s_Need_two_points_0061c754 = Need two points.
    PUSH EAX                            ; 004667a7 | = "Need two points." | s_Need_two_points_0061c754 = Need two points.
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 004667a8 | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004667ad
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 004667b0 | void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20()
        ;   XREF to: 005eda20 (UNCONDITIONAL_CALL)
    CALL wincore_winrun.cpp_getNextKeypress_FUN_005f2e90 ; 004667b5 | int wincore_winrun.cpp_getNextKeypress_FUN_005f2e90()
        ;   XREF to: 005f2e90 (UNCONDITIONAL_CALL)
    JMP 0x00466a21                      ; 004667ba | LAB_00466a21
        ;   XREF to: 00466a21 (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0x4],0x0      ; 004667bf
        ;   Label: LAB_004667bf
    JL 0x004667cb                       ; 004667c3 | LAB_004667cb
        ;   XREF to: 004667cb (CONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0x10],0x0     ; 004667c5
    JGE 0x004667cd                      ; 004667c9 | LAB_004667cd
        ;   XREF to: 004667cd (CONDITIONAL_JUMP)
    JMP 0x004667d8                      ; 004667cb | LAB_004667d8
        ;   Label: LAB_004667cb
        ;   XREF to: 004667d8 (UNCONDITIONAL_JUMP)
    MOV EAX,[0x01626408]                ; 004667cd | int g_VertexCount
        ;   Label: LAB_004667cd
    DEC EAX                             ; 004667d2
    CMP EAX,dword ptr [EBP + -0x4]      ; 004667d3
    JGE 0x004667da                      ; 004667d6 | LAB_004667da
        ;   XREF to: 004667da (CONDITIONAL_JUMP)
    JMP 0x004667e5                      ; 004667d8 | LAB_004667e5
        ;   Label: LAB_004667d8
        ;   XREF to: 004667e5 (UNCONDITIONAL_JUMP)
    MOV EAX,[0x01626408]                ; 004667da | int g_VertexCount
        ;   Label: LAB_004667da
    DEC EAX                             ; 004667df
    CMP EAX,dword ptr [EBP + -0x10]     ; 004667e0
    JGE 0x00466806                      ; 004667e3 | LAB_00466806
        ;   XREF to: 00466806 (CONDITIONAL_JUMP)
    PUSH 0x16                           ; 004667e5
        ;   Label: LAB_004667e5
    PUSH 0x0                            ; 004667e7
    MOV EAX,0x61c765                    ; 004667e9 | = "Invalid point." | s_Invalid_point_0061c765 = Invalid point.
    PUSH EAX                            ; 004667ee | = "Invalid point." | s_Invalid_point_0061c765 = Invalid point.
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 004667ef | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004667f4
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 004667f7 | void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20()
        ;   XREF to: 005eda20 (UNCONDITIONAL_CALL)
    CALL wincore_winrun.cpp_getNextKeypress_FUN_005f2e90 ; 004667fc | int wincore_winrun.cpp_getNextKeypress_FUN_005f2e90()
        ;   XREF to: 005f2e90 (UNCONDITIONAL_CALL)
    JMP 0x00466a21                      ; 00466801 | LAB_00466a21
        ;   XREF to: 00466a21 (UNCONDITIONAL_JUMP)
    PUSH 0x16                           ; 00466806
        ;   Label: LAB_00466806
    PUSH 0x0                            ; 00466808
    MOV EAX,0x61c774                    ; 0046680a | = "Which axis to center - X, Y, or Z? : " | s_Which_axis_to_center_X_Y_0061c774 = Which axis to center - X, Y, or Z? :
    PUSH EAX                            ; 0046680f | = "Which axis to center - X, Y, or Z? : " | s_Which_axis_to_center_X_Y_0061c774 = Which axis to center - X, Y, or Z? :
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 00466810 | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00466815
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 00466818 | void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20()
        ;   XREF to: 005eda20 (UNCONDITIONAL_CALL)
    CALL wincore_winrun.cpp_getNextKeypress_FUN_005f2e90 ; 0046681d | int wincore_winrun.cpp_getNextKeypress_FUN_005f2e90()
        ;   XREF to: 005f2e90 (UNCONDITIONAL_CALL)
    AND EAX,0xff                        ; 00466822
    PUSH EAX                            ; 00466827
    CALL crt_ctype.c_toupper_FUN_005ff9e0 ; 00466828 | int crt_ctype.c_toupper_FUN_005ff9e0(int c)
    ...
    JMP 0x00466897                      ; 0046683c | LAB_00466897
        ;   XREF to: 00466897 (UNCONDITIONAL_JUMP)
    IMUL EAX,dword ptr [EBP + -0x10],0x14 ; 0046683e
        ;   Label: LAB_0046683e
    FLD float ptr [EAX + 0x162640c]     ; 00466842 | SVertexData[20000] g_LoadedVertices
    FSTP double ptr [EBP + -0x28]       ; 00466848
    IMUL EAX,dword ptr [EBP + -0x4],0x14 ; 0046684b
    FLD float ptr [EAX + 0x162640c]     ; 0046684f | SVertexData[20000] g_LoadedVertices
    FSTP double ptr [EBP + -0x58]       ; 00466855
    JMP 0x004668bf                      ; 00466858 | LAB_004668bf
    ...
    JMP 0x004668bf                      ; 00466877 | LAB_004668bf
        ;   XREF to: 004668bf (UNCONDITIONAL_JUMP)
    ...
    JMP 0x004668f8                      ; 004668f0 | LAB_004668f8
    ...
    MOV EAX,dword ptr [EBP + -0xc]      ; 004668f8
        ;   Label: LAB_004668f8
    CMP EAX,dword ptr [0x01626408]      ; 004668fb | int g_VertexCount
    JGE 0x00466935                      ; 00466901 | LAB_00466935
        ;   XREF to: 00466935 (CONDITIONAL_JUMP)
    IMUL EAX,dword ptr [EBP + -0xc],0x14 ; 00466903
    FLD float ptr [EAX + 0x162640c]     ; 00466907 | SVertexData[20000] g_LoadedVertices
    ...
    MOV EAX,dword ptr [EBP + -0xc]      ; 00466968
        ;   Label: LAB_00466968
    CMP EAX,dword ptr [0x01626408]      ; 0046696b | int g_VertexCount
    JGE 0x00466a21                      ; 00466971 | LAB_00466a21
    ...
    FMUL double ptr [0x0061c79e]        ; 00466981 | double g_CenteringFactor
    FADD double ptr [EBP + -0x58]       ; 00466987
    FLD float ptr [EAX + 0x162640c]     ; 0046698a | SVertexData[20000] g_LoadedVertices
    ...
    FSTP float ptr [EAX + 0x162640c]    ; 004669a8 | SVertexData[20000] g_LoadedVertices
    IMUL EAX,dword ptr [EBP + -0xc],0x14 ; 004669ae
    FLD double ptr [EBP + -0x20]        ; 004669b2
    FSUB double ptr [EBP + -0x50]       ; 004669b5
    FMUL double ptr [0x0061c79e]        ; 004669b8 | double g_CenteringFactor
    ...
    FMUL double ptr [0x0061c79e]        ; 004669ef | double g_CenteringFactor
    ...
    JMP 0x00466962                      ; 00466a1c | LAB_00466962
