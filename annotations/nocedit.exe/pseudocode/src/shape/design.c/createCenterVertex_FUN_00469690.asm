...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_design.c_createCenterVertex_FUN_00469690(void)
;
; Local Variables:
...
section .text
    ...
    CALL wincore_windll.cpp_clearScreen_FUN_005b3e70 ; 0046969c | void wincore_windll.cpp_clearScreen_FUN_005b3e70()
        ;   XREF to: 005b3e70 (UNCONDITIONAL_CALL)
    MOV ECX,0x61cf96                    ; 004696a1 | = "Enter # of vertices to use : " | s_Enter_of_vertices_to_use_0061cf96 = Enter # of vertices to use :
    PUSH ECX                            ; 004696a6 | = "Enter # of vertices to use : " | s_Enter_of_vertices_to_use_0061cf96 = Enter # of vertices to use :
    PUSH 0x0                            ; 004696a7
    PUSH 0x0                            ; 004696a9
    PUSH 0xa                            ; 004696ab
    LEA ECX,[EBP + 0xffffff74]          ; 004696ad
    PUSH ECX                            ; 004696b3
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 004696b4 | int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
    ...
    JNZ 0x004696d5                      ; 004696ce | LAB_004696d5
        ;   XREF to: 004696d5 (CONDITIONAL_JUMP)
    JMP 0x00469843                      ; 004696d0 | LAB_00469843
        ;   XREF to: 00469843 (UNCONDITIONAL_JUMP)
    LEA EAX,[EBP + 0xffffff74]          ; 004696d5
        ;   Label: LAB_004696d5
    PUSH EAX                            ; 004696db
    CALL crt_stdlib.c_atoi_FUN_005ffef0 ; 004696dc | int crt_stdlib.c_atoi_FUN_005ffef0(char * string_ptr)
    ...
    JL 0x004696f3                       ; 004696eb | LAB_004696f3
        ;   XREF to: 004696f3 (CONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0x8],0x8      ; 004696ed
    JLE 0x004696f8                      ; 004696f1 | LAB_004696f8
        ;   XREF to: 004696f8 (CONDITIONAL_JUMP)
    JMP 0x00469843                      ; 004696f3 | LAB_00469843
        ;   Label: LAB_004696f3
        ;   XREF to: 00469843 (UNCONDITIONAL_JUMP)
    ...
    JMP 0x00469723                      ; 0046971b | LAB_00469723
    ...
    JGE 0x004697c6                      ; 00469729 | LAB_004697c6
        ;   XREF to: 004697c6 (CONDITIONAL_JUMP)
    MOV ECX,0x61cfb4                    ; 0046972f | = "Enter vertex # : " | s_Enter_vertex_0061cfb4 = Enter vertex # :
    PUSH ECX                            ; 00469734 | = "Enter vertex # : " | s_Enter_vertex_0061cfb4 = Enter vertex # :
    ...
    PUSH ECX                            ; 00469743
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 00469744 | int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
        ;   XREF to: 004032c0 (UNCONDITIONAL_CALL)
    ...
    JNZ 0x00469765                      ; 0046975e | LAB_00469765
        ;   XREF to: 00469765 (CONDITIONAL_JUMP)
    JMP 0x00469843                      ; 00469760 | LAB_00469843
        ;   XREF to: 00469843 (UNCONDITIONAL_JUMP)
    LEA EAX,[EBP + 0xffffff74]          ; 00469765
        ;   Label: LAB_00469765
    PUSH EAX                            ; 0046976b
    CALL crt_stdlib.c_atoi_FUN_005ffef0 ; 0046976c | int crt_stdlib.c_atoi_FUN_005ffef0(char * string_ptr)
        ;   XREF to: 005ffef0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00469771
    MOV dword ptr [EBP + -0x1c],EAX     ; 00469774
    CMP dword ptr [EBP + -0x1c],0x0     ; 00469777
    JL 0x00469788                       ; 0046977b | LAB_00469788
        ;   XREF to: 00469788 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + -0x1c]     ; 0046977d
    CMP EAX,dword ptr [0x01626408]      ; 00469780 | int g_VertexCount
    JL 0x0046978d                       ; 00469786 | LAB_0046978d
        ;   XREF to: 0046978d (CONDITIONAL_JUMP)
    JMP 0x00469843                      ; 00469788 | LAB_00469843
        ;   Label: LAB_00469788
        ;   XREF to: 00469843 (UNCONDITIONAL_JUMP)
    IMUL EAX,dword ptr [EBP + -0x1c],0x14 ; 0046978d
        ;   Label: LAB_0046978d
    FLD float ptr [EBP + -0x14]         ; 00469791
    FADD float ptr [EAX + 0x162640c]    ; 00469794 | SVertexData[20000] g_LoadedVertices
    ...
    JMP 0x0046971d                      ; 004697c1 | LAB_0046971d
        ;   XREF to: 0046971d (UNCONDITIONAL_JUMP)
    FILD dword ptr [EBP + -0x8]         ; 004697c6
        ;   Label: LAB_004697c6
    FDIVR float ptr [EBP + -0x14]       ; 004697c9
    IMUL EAX,dword ptr [0x01626408],0x14 ; 004697cc | int g_VertexCount
    FSTP float ptr [EAX + 0x162640c]    ; 004697d3 | SVertexData[20000] g_LoadedVertices
    FILD dword ptr [EBP + -0x8]         ; 004697d9
    FDIVR float ptr [EBP + -0x10]       ; 004697dc
    IMUL EAX,dword ptr [0x01626408],0x14 ; 004697df | int g_VertexCount
    FSTP float ptr [EAX + 0x1626410]    ; 004697e6 | DAT_01626410
    FILD dword ptr [EBP + -0x8]         ; 004697ec
    FDIVR float ptr [EBP + -0xc]        ; 004697ef
    IMUL EAX,dword ptr [0x01626408],0x14 ; 004697f2 | int g_VertexCount
    FSTP float ptr [EAX + 0x1626414]    ; 004697f9 | g_LoadedVertices[0].vertex.z
    ADD dword ptr [EBP + -0x18],0xb     ; 004697ff
    PUSH dword ptr [0x01626408]         ; 00469803 | int g_VertexCount
    MOV EAX,0x61cfc6                    ; 00469809 | = "New vertex created : %d.  Press a key..." | s_New_vertex_created_d_Pre_0061cfc6 = New vertex created : %d.  Press a key...
    PUSH EAX                            ; 0046980e | = "New vertex created : %d.  Press a key..." | s_New_vertex_created_d_Pre_0061cfc6 = New vertex created : %d.  Press a key...
    LEA EAX,[EBP + 0xffffff74]          ; 0046980f
    PUSH EAX                            ; 00469815
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 00469816 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH EAX                            ; 0046982a
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 0046982b | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00469830
    CALL engine_2d.c_clearInputAndWait_FUN_00403260 ; 00469833 | void engine_2d.c_clearInputAndWait_FUN_00403260()
        ;   XREF to: 00403260 (UNCONDITIONAL_CALL)
    CALL wincore_winrun.cpp_getNextKeypress_FUN_005f2e90 ; 00469838 | int wincore_winrun.cpp_getNextKeypress_FUN_005f2e90()
        ;   XREF to: 005f2e90 (UNCONDITIONAL_CALL)
    INC dword ptr [0x01626408]          ; 0046983d | int g_VertexCount
