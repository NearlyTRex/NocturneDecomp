...
;                               FUNCTION
; *****************************************************************************
; unknown undefined shape_design.c_selectModelPart_FUN_0045de80()
;
; Local Variables:
...
section .text
    ...
    MOV ECX,0x61b4a2                    ; 0045de8c | = "Part name : " | s_Part_name_0061b4a2 = Part name :
    PUSH ECX                            ; 0045de91 | = "Part name : " | s_Part_name_0061b4a2 = Part name :
    PUSH 0xb                            ; 0045de92
    PUSH 0x0                            ; 0045de94
    PUSH 0x13                           ; 0045de96
    LEA ECX,[EBP + -0x1c]               ; 0045de98
    PUSH ECX                            ; 0045de9b
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 0045de9c | int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
    ...
    MOV EAX,dword ptr [EBP + -0x8]      ; 0045decf
        ;   Label: LAB_0045decf
    CMP EAX,dword ptr [0x01e528a0]      ; 0045ded2 | int g_PartsCount
    JGE 0x0045df00                      ; 0045ded8 | LAB_0045df00
        ;   XREF to: 0045df00 (CONDITIONAL_JUMP)
    IMUL EDX,dword ptr [EBP + -0x8],0x14 ; 0045deda
    MOV EAX,0x1e50190                   ; 0045dede | SModelPartName[500] g_ModelPartNames
    ADD EAX,EDX                         ; 0045dee3
    PUSH EAX                            ; 0045dee5
    LEA EAX,[EBP + -0x1c]               ; 0045dee6
    PUSH EAX                            ; 0045dee9
    CALL crt_string.c_strcmp_FUN_005fef20 ; 0045deea | int crt_string.c_strcmp_FUN_005fef20(char * str1, char * str2)
        ;   XREF to: 005fef20 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0045deef
    TEST EAX,EAX                        ; 0045def2
    JNZ 0x0045defe                      ; 0045def4 | LAB_0045defe
        ;   XREF to: 0045defe (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + -0x8]      ; 0045def6
    MOV dword ptr [EBP + -0x4],EAX      ; 0045def9
    JMP 0x0045df00                      ; 0045defc | LAB_0045df00
        ;   XREF to: 0045df00 (UNCONDITIONAL_JUMP)
    JMP 0x0045dec9                      ; 0045defe | LAB_0045dec9
        ;   Label: LAB_0045defe
        ;   XREF to: 0045dec9 (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0x4],-0x1     ; 0045df00
        ;   Label: LAB_0045df00
    JZ 0x0045df10                       ; 0045df04 | LAB_0045df10
        ;   XREF to: 0045df10 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + -0x4]      ; 0045df06
    MOV [0x01e6614c],EAX                ; 0045df09 | int g_CurrentPartIndex
    JMP 0x0045df4d                      ; 0045df0e | LAB_0045df4d
        ;   XREF to: 0045df4d (UNCONDITIONAL_JUMP)
    LEA ESI,[EBP + -0x1c]               ; 0045df10
        ;   Label: LAB_0045df10
    IMUL EAX,dword ptr [0x01e528a0],0x14 ; 0045df13 | int g_PartsCount
    MOV EDI,0x1e50190                   ; 0045df1a | SModelPartName[500] g_ModelPartNames
    ADD EDI,EAX                         ; 0045df1f
    PUSH EDI                            ; 0045df21
    MOV AL,byte ptr [ESI]               ; 0045df22
        ;   Label: LAB_0045df22
    MOV byte ptr [EDI],AL               ; 0045df24 | SModelPartName[500] g_ModelPartNames
    CMP AL,0x0                          ; 0045df26
    JZ 0x0045df3a                       ; 0045df28 | LAB_0045df3a
        ;   XREF to: 0045df3a (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0045df2a
    ADD ESI,0x2                         ; 0045df2d
    MOV byte ptr [EDI + 0x1],AL         ; 0045df30 | DAT_01e50191
    ADD EDI,0x2                         ; 0045df33
    CMP AL,0x0                          ; 0045df36
    JNZ 0x0045df22                      ; 0045df38 | LAB_0045df22
        ;   XREF to: 0045df22 (CONDITIONAL_JUMP)
    POP EDI                             ; 0045df3a
        ;   Label: LAB_0045df3a
    MOV ESI,dword ptr [0x01e528a0]      ; 0045df3b | int g_PartsCount
    MOV dword ptr [0x01e6614c],ESI      ; 0045df41 | int g_CurrentPartIndex
    INC dword ptr [0x01e528a0]          ; 0045df47 | int g_PartsCount
