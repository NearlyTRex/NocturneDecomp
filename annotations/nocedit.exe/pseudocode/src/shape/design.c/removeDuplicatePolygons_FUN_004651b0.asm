...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_design.c_removeDuplicatePolygons_FUN_004651b0(int respect_part_assignments)
;
; Parameters:
...
section .text
    ...
    JMP 0x004651cb                      ; 004651c3 | LAB_004651cb
    ...
    MOV EAX,dword ptr [EBP + -0x10]     ; 004651cb
        ;   Label: LAB_004651cb
    CMP EAX,dword ptr [0x016e990c]      ; 004651ce | int g_PolygonCount
    JGE 0x00465303                      ; 004651d4 | LAB_00465303
    ...
    MOV EAX,dword ptr [EBP + -0x14]     ; 004651e1
        ;   Label: LAB_004651e1
    CMP EAX,dword ptr [0x016e990c]      ; 004651e4 | int g_PolygonCount
    JGE 0x004652fe                      ; 004651ea | LAB_004652fe
    ...
    JGE 0x0046529d                      ; 00465266 | LAB_0046529d
    ...
    LEA EDI,[ESI + 0x16e9910]           ; 004652de | SShapeEditorPolygon[20000] g_ModelPolygonData
    LEA ESI,[EAX + 0x16e9910]           ; 004652e4 | SShapeEditorPolygon[20000] g_ModelPolygonData
    MOVSD.REP ES:EDI,ESI                ; 004652ea | SShapeEditorPolygon[20000] g_ModelPolygonData
    JMP 0x004652b7                      ; 004652ec | LAB_004652b7
        ;   XREF to: 004652b7 (UNCONDITIONAL_JUMP)
    DEC dword ptr [0x016e990c]          ; 004652ee | int g_PolygonCount
        ;   Label: LAB_004652ee
    JMP 0x004652f9                      ; 004652f4 | LAB_004652f9
        ;   XREF to: 004652f9 (UNCONDITIONAL_JUMP)
    INC dword ptr [EBP + -0x14]         ; 004652f6
        ;   Label: LAB_004652f6
    JMP 0x004651e1                      ; 004652f9 | LAB_004651e1
        ;   Label: LAB_004652f9
        ;   XREF to: 004651e1 (UNCONDITIONAL_JUMP)
    JMP 0x004651c5                      ; 004652fe | LAB_004651c5
        ;   Label: LAB_004652fe
