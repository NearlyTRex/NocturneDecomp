...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl shape_design_c_showPolygonDetailsList_FUN_0045d9c0(void)
;
; Local Variables:
...
section .text
    ...
    CALL engine_2d.c_clearInputAndWait_FUN_00403260 ; 0045d9cc
        ;   XREF to: 00403260 (UNCONDITIONAL_CALL)  ; void engine_2d.c_clearInputAndWait_FUN_00403260()
    MOV dword ptr [EBP + -0xc],0x0      ; 0045d9d1
    JMP 0x0045d9f2                      ; 0045d9d8
        ;   XREF to: 0045d9f2 (UNCONDITIONAL_JUMP)  ; LAB_0045d9f2
    MOV ECX,0xb                         ; 0045d9da
        ;   Label: LAB_0045d9da
    MOV EAX,[0x00679398]                ; 0045d9df | g_WindowHeight
    MOV EDX,dword ptr [0x00679398]      ; 0045d9e4 | g_WindowHeight
    ...
    JMP 0x0045da1b                      ; 0045da13
        ;   XREF to: 0045da1b (UNCONDITIONAL_JUMP)  ; LAB_0045da1b
    MOV EAX,dword ptr [EBP + -0x8]      ; 0045da15
        ;   Label: LAB_0045da15
    INC dword ptr [EBP + -0x8]          ; 0045da18
    MOV ECX,0xb                         ; 0045da1b
        ;   Label: LAB_0045da1b
    MOV EAX,[0x00679398]                ; 0045da20 | g_WindowHeight
    MOV EDX,dword ptr [0x00679398]      ; 0045da25 | g_WindowHeight
    SAR EDX,0x1f                        ; 0045da2b
    IDIV ECX                            ; 0045da2e
    ADD EAX,dword ptr [EBP + -0xc]      ; 0045da30
    CMP EAX,dword ptr [EBP + -0x8]      ; 0045da33
    JLE 0x0045dbc2                      ; 0045da36
        ;   XREF to: 0045dbc2 (CONDITIONAL_JUMP)  ; LAB_0045dbc2
    CMP dword ptr [0x01e66158],0x0      ; 0045da3c | g_WireframeMode
    JZ 0x0045da4e                       ; 0045da43
        ;   XREF to: 0045da4e (CONDITIONAL_JUMP)  ; LAB_0045da4e
    CMP dword ptr [0x01e6614c],-0x1     ; 0045da45 | g_CurrentPartIndex
    JNZ 0x0045da50                      ; 0045da4c
        ;   XREF to: 0045da50 (CONDITIONAL_JUMP)  ; LAB_0045da50
    JMP 0x0045da6a                      ; 0045da4e
        ;   XREF to: 0045da6a (UNCONDITIONAL_JUMP)  ; LAB_0045da6a
        ;   Label: LAB_0045da4e
    ...
    JMP 0x0045dbbd                      ; 0045da65
        ;   XREF to: 0045dbbd (UNCONDITIONAL_JUMP)  ; LAB_0045dbbd
    MOV EAX,dword ptr [EBP + -0x8]      ; 0045da6a
        ;   Label: LAB_0045da6a
    CMP EAX,dword ptr [0x016e990c]      ; 0045da6d | g_PolygonCount
    JGE 0x0045dbbd                      ; 0045da73
        ;   XREF to: 0045dbbd (CONDITIONAL_JUMP)  ; LAB_0045dbbd
    MOV EAX,dword ptr [EBP + -0x8]      ; 0045da79
    PUSH EAX                            ; 0045da7c
    MOV EAX,0x61b416                    ; 0045da7d | = "Poly %d :"
    ...
    JMP 0x0045daa1                      ; 0045da99
        ;   XREF to: 0045daa1 (UNCONDITIONAL_JUMP)  ; LAB_0045daa1
    ...
    CMP AL,0x0                          ; 0045daf0
    JZ 0x0045db04                       ; 0045daf2
        ;   XREF to: 0045db04 (CONDITIONAL_JUMP)  ; LAB_0045db04
    MOV AL,byte ptr [ESI + 0x1]         ; 0045daf4
    ADD ESI,0x2                         ; 0045daf7
    MOV byte ptr [EDI + 0x1],AL         ; 0045dafa
    ADD EDI,0x2                         ; 0045dafd
    CMP AL,0x0                          ; 0045db00
    JNZ 0x0045daec                      ; 0045db02
        ;   XREF to: 0045daec (CONDITIONAL_JUMP)  ; LAB_0045daec
    POP EDI                             ; 0045db04
        ;   Label: LAB_0045db04
    JMP 0x0045da9b                      ; 0045db05
    ...
    PUSH ESI                            ; 0045db1c
    MOV ESI,0x61b424                    ; 0045db1d | = " Part : %s"
    ...
    CMP AL,0x0                          ; 0045db45
    JZ 0x0045db59                       ; 0045db47
        ;   XREF to: 0045db59 (CONDITIONAL_JUMP)  ; LAB_0045db59
    MOV AL,byte ptr [ESI + 0x1]         ; 0045db49
    ADD ESI,0x2                         ; 0045db4c
    MOV byte ptr [EDI + 0x1],AL         ; 0045db4f
    ADD EDI,0x2                         ; 0045db52
    CMP AL,0x0                          ; 0045db55
    JNZ 0x0045db41                      ; 0045db57
        ;   XREF to: 0045db41 (CONDITIONAL_JUMP)  ; LAB_0045db41
    POP EDI                             ; 0045db59
        ;   Label: LAB_0045db59
    ...
    CMP AL,0x0                          ; 0045db8f
    JZ 0x0045dba3                       ; 0045db91
        ;   XREF to: 0045dba3 (CONDITIONAL_JUMP)  ; LAB_0045dba3
    MOV AL,byte ptr [ESI + 0x1]         ; 0045db93
    ADD ESI,0x2                         ; 0045db96
    MOV byte ptr [EDI + 0x1],AL         ; 0045db99
    ADD EDI,0x2                         ; 0045db9c
    CMP AL,0x0                          ; 0045db9f
    JNZ 0x0045db8b                      ; 0045dba1
        ;   XREF to: 0045db8b (CONDITIONAL_JUMP)  ; LAB_0045db8b
    POP EDI                             ; 0045dba3
        ;   Label: LAB_0045dba3
    ...
    JMP 0x0045da15                      ; 0045dbbd
        ;   XREF to: 0045da15 (UNCONDITIONAL_JUMP)  ; LAB_0045da15
        ;   Label: LAB_0045dbbd
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 0045dbc2
        ;   XREF to: 005eda20 (UNCONDITIONAL_CALL)  ; void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20()
        ;   Label: LAB_0045dbc2
    CALL wincore_winrun.cpp_getNextKeypress_FUN_005f2e90 ; 0045dbc7
        ;   XREF to: 005f2e90 (UNCONDITIONAL_CALL)  ; int wincore_winrun.cpp_getNextKeypress_FUN_005f2e90()
    JMP 0x0045d9da                      ; 0045dbcc
        ;   XREF to: 0045d9da (UNCONDITIONAL_JUMP)  ; LAB_0045d9da
    CALL engine_2d.c_clearInputAndWait_FUN_00403260 ; 0045dbd1
        ;   XREF to: 00403260 (UNCONDITIONAL_CALL)  ; void engine_2d.c_clearInputAndWait_FUN_00403260()
        ;   Label: LAB_0045dbd1
