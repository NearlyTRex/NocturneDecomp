...
;
; Local Variables:
; char[84]         Stack[-0x88]:84  local_88
...
;
; XREF[1]:
;   shape_design.c_showFacetPartEditor_FUN_0045f1d0 at 0046097b
;
; Referenced Globals:
...
section .text
    ...
    CALL engine_special.cpp_clearScreen_FUN_005b3e70 ; 0045e52c
        ;   XREF to: 005b3e70 (UNCONDITIONAL_CALL)  ; void engine_special.cpp_clearScreen_FUN_005b3e70()
    CALL engine_2d.c_clearInputAndWait_FUN_00403260 ; 0045e531
    ...
    MOV ECX,0x61b54e                    ; 0045e54b | = "Enter in X,Y,Z box dimentions : "
    PUSH ECX                            ; 0045e550 | = "Enter in X,Y,Z box dimentions : "
    PUSH 0x0                            ; 0045e551
    PUSH 0x0                            ; 0045e553
    PUSH 0x4f                           ; 0045e555
    LEA ECX,[EBP + -0x78]               ; 0045e557
    PUSH ECX                            ; 0045e55a
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 0045e55b
    ...
    JNZ 0x0045e579                      ; 0045e572
        ;   XREF to: 0045e579 (CONDITIONAL_JUMP)  ; LAB_0045e579
    JMP 0x0045ea82                      ; 0045e574
        ;   XREF to: 0045ea82 (UNCONDITIONAL_JUMP)  ; LAB_0045ea82
    ...
    PUSH EAX                            ; 0045e584
    MOV EAX,0x61b56f                    ; 0045e585 | = "%f,%f,%f"
    PUSH EAX                            ; 0045e58a | = "%f,%f,%f"
    LEA EAX,[EBP + -0x78]               ; 0045e58b
    PUSH EAX                            ; 0045e58e
    CALL crt_stdio.c_sscanf_FUN_0060013c ; 0045e58f
    ...
    FNSTSW AX                           ; 0045e59e
    SAHF                                ; 0045e5a0
    JNC 0x0045e5af                      ; 0045e5a1
        ;   XREF to: 0045e5af (CONDITIONAL_JUMP)  ; LAB_0045e5af
    FLD float ptr [EBP + -0x1c]         ; 0045e5a3
    FLDZ                                ; 0045e5a6
    FCOMPP                              ; 0045e5a8
    FNSTSW AX                           ; 0045e5aa
    SAHF                                ; 0045e5ac
    JC 0x0045e5b1                       ; 0045e5ad
        ;   XREF to: 0045e5b1 (CONDITIONAL_JUMP)  ; LAB_0045e5b1
    JMP 0x0045e5bd                      ; 0045e5af
        ;   XREF to: 0045e5bd (UNCONDITIONAL_JUMP)  ; LAB_0045e5bd
        ;   Label: LAB_0045e5af
    ...
    FNSTSW AX                           ; 0045e5b8
    SAHF                                ; 0045e5ba
    JC 0x0045e5c2                       ; 0045e5bb
        ;   XREF to: 0045e5c2 (CONDITIONAL_JUMP)  ; LAB_0045e5c2
    JMP 0x0045ea82                      ; 0045e5bd
        ;   XREF to: 0045ea82 (UNCONDITIONAL_JUMP)  ; LAB_0045ea82
        ;   Label: LAB_0045e5bd
    MOV ECX,0x61b578                    ; 0045e5c2 | = "Enter in X,Y,Z box center : "
        ;   Label: LAB_0045e5c2
    PUSH ECX                            ; 0045e5c7 | = "Enter in X,Y,Z box center : "
    PUSH 0xb                            ; 0045e5c8
    PUSH 0x0                            ; 0045e5ca
    PUSH 0x4f                           ; 0045e5cc
    LEA ECX,[EBP + -0x78]               ; 0045e5ce
    PUSH ECX                            ; 0045e5d1
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 0045e5d2
        ;   XREF to: 004032c0 (UNCONDITIONAL_CALL)  ; int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
    ...
    JNZ 0x0045e5f0                      ; 0045e5e9
        ;   XREF to: 0045e5f0 (CONDITIONAL_JUMP)  ; LAB_0045e5f0
    JMP 0x0045ea82                      ; 0045e5eb
        ;   XREF to: 0045ea82 (UNCONDITIONAL_JUMP)  ; LAB_0045ea82
    ...
    PUSH EAX                            ; 0045e5fb
    MOV EAX,0x61b595                    ; 0045e5fc | = "%f,%f,%f"
    PUSH EAX                            ; 0045e601 | = "%f,%f,%f"
    LEA EAX,[EBP + -0x78]               ; 0045e602
    PUSH EAX                            ; 0045e605
    CALL crt_stdio.c_sscanf_FUN_0060013c ; 0045e606
        ;   XREF to: 0060013c (UNCONDITIONAL_CALL)  ; int crt_stdio.c_sscanf_FUN_0060013c(char * str, char * format)
    ADD ESP,0x14                        ; 0045e60b
    MOV dword ptr [EBP + -0x24],EAX     ; 0045e60e
    CMP dword ptr [EBP + -0x24],0x3     ; 0045e611
    JZ 0x0045e61c                       ; 0045e615
        ;   XREF to: 0045e61c (CONDITIONAL_JUMP)  ; LAB_0045e61c
    JMP 0x0045ea82                      ; 0045e617
        ;   XREF to: 0045ea82 (UNCONDITIONAL_JUMP)  ; LAB_0045ea82
    PUSH 0x16                           ; 0045e61c
        ;   Label: LAB_0045e61c
    PUSH 0x0                            ; 0045e61e
    ...
    MOV EAX,[0x01626408]                ; 0045e649 | g_VertexCount
    MOV dword ptr [EBP + -0x4],EAX      ; 0045e64e
    ADD dword ptr [0x01626408],0x8      ; 0045e651 | g_VertexCount
    FLD float ptr [EBP + -0x20]         ; 0045e658
    FMUL float ptr [0x0061b5ba]         ; 0045e65b | g_BoxScaleFactor
    FADD float ptr [EBP + -0x14]        ; 0045e661
    IMUL EAX,dword ptr [EBP + -0x4],0x14 ; 0045e664
    FSTP float ptr [EAX + 0x162640c]    ; 0045e668 | g_LoadedVertices
    ...
    FMUL float ptr [0x0061b5ba]         ; 0045e69d | g_BoxScaleFactor
    FSUBR float ptr [EBP + -0x14]       ; 0045e6a3
    MOV EAX,dword ptr [EBP + -0x4]      ; 0045e6a6
    INC EAX                             ; 0045e6a9
    IMUL EAX,EAX,0x14                   ; 0045e6aa
    FSTP float ptr [EAX + 0x162640c]    ; 0045e6ad | g_LoadedVertices
    FLD float ptr [EBP + -0x1c]         ; 0045e6b3
    FMUL float ptr [0x0061b5ba]         ; 0045e6b6 | g_BoxScaleFactor
    ...
    FMUL float ptr [0x0061b5ba]         ; 0045e6e8 | g_BoxScaleFactor
    FSUBR float ptr [EBP + -0x14]       ; 0045e6ee
    MOV EAX,dword ptr [EBP + -0x4]      ; 0045e6f1
    ADD EAX,0x2                         ; 0045e6f4
    IMUL EAX,EAX,0x14                   ; 0045e6f7
    FSTP float ptr [EAX + 0x162640c]    ; 0045e6fa | g_LoadedVertices
    FLD float ptr [EBP + -0x1c]         ; 0045e700
    FMUL float ptr [0x0061b5ba]         ; 0045e703 | g_BoxScaleFactor
    ...
    FMUL float ptr [0x0061b5ba]         ; 0045e739 | g_BoxScaleFactor
    FADD float ptr [EBP + -0x14]        ; 0045e73f
    MOV EAX,dword ptr [EBP + -0x4]      ; 0045e742
    ADD EAX,0x3                         ; 0045e745
    IMUL EAX,EAX,0x14                   ; 0045e748
    FSTP float ptr [EAX + 0x162640c]    ; 0045e74b | g_LoadedVertices
    FLD float ptr [EBP + -0x1c]         ; 0045e751
    FMUL float ptr [0x0061b5ba]         ; 0045e754 | g_BoxScaleFactor
    ...
    FMUL float ptr [0x0061b5ba]         ; 0045e78a | g_BoxScaleFactor
    FADD float ptr [EBP + -0x14]        ; 0045e790
    MOV EAX,dword ptr [EBP + -0x4]      ; 0045e793
    ADD EAX,0x4                         ; 0045e796
    IMUL EAX,EAX,0x14                   ; 0045e799
    FSTP float ptr [EAX + 0x162640c]    ; 0045e79c | g_LoadedVertices
    FLD float ptr [EBP + -0x1c]         ; 0045e7a2
    FMUL float ptr [0x0061b5ba]         ; 0045e7a5 | g_BoxScaleFactor
    ...
    FMUL float ptr [0x0061b5ba]         ; 0045e7db | g_BoxScaleFactor
    FSUBR float ptr [EBP + -0x14]       ; 0045e7e1
    MOV EAX,dword ptr [EBP + -0x4]      ; 0045e7e4
    ADD EAX,0x5                         ; 0045e7e7
    IMUL EAX,EAX,0x14                   ; 0045e7ea
    FSTP float ptr [EAX + 0x162640c]    ; 0045e7ed | g_LoadedVertices
    FLD float ptr [EBP + -0x1c]         ; 0045e7f3
    FMUL float ptr [0x0061b5ba]         ; 0045e7f6 | g_BoxScaleFactor
    ...
    FMUL float ptr [0x0061b5ba]         ; 0045e82c | g_BoxScaleFactor
    FSUBR float ptr [EBP + -0x14]       ; 0045e832
    MOV EAX,dword ptr [EBP + -0x4]      ; 0045e835
    ADD EAX,0x6                         ; 0045e838
    IMUL EAX,EAX,0x14                   ; 0045e83b
    FSTP float ptr [EAX + 0x162640c]    ; 0045e83e | g_LoadedVertices
    FLD float ptr [EBP + -0x1c]         ; 0045e844
    FMUL float ptr [0x0061b5ba]         ; 0045e847 | g_BoxScaleFactor
    ...
    FMUL float ptr [0x0061b5ba]         ; 0045e87d | g_BoxScaleFactor
    FADD float ptr [EBP + -0x14]        ; 0045e883
    MOV EAX,dword ptr [EBP + -0x4]      ; 0045e886
    ADD EAX,0x7                         ; 0045e889
    IMUL EAX,EAX,0x14                   ; 0045e88c
    FSTP float ptr [EAX + 0x162640c]    ; 0045e88f | g_LoadedVertices
    FLD float ptr [EBP + -0x1c]         ; 0045e895
    FMUL float ptr [0x0061b5ba]         ; 0045e898 | g_BoxScaleFactor
    ...
    JZ 0x0045e8db                       ; 0045e8cf
        ;   XREF to: 0045e8db (CONDITIONAL_JUMP)  ; LAB_0045e8db
    CMP dword ptr [EBP + -0x8],0x49     ; 0045e8d1
    JNZ 0x0045e9a4                      ; 0045e8d5
        ;   XREF to: 0045e9a4 (CONDITIONAL_JUMP)  ; LAB_0045e9a4
    ...
    CMP dword ptr [EBP + -0x8],0x42     ; 0045e9a4
        ;   Label: LAB_0045e9a4
    JZ 0x0045e9b4                       ; 0045e9a8
        ;   XREF to: 0045e9b4 (CONDITIONAL_JUMP)  ; LAB_0045e9b4
    CMP dword ptr [EBP + -0x8],0x4f     ; 0045e9aa
    JNZ 0x0045ea7d                      ; 0045e9ae
        ;   XREF to: 0045ea7d (CONDITIONAL_JUMP)  ; LAB_0045ea7d
