...
section .text
    ...
    FILD dword ptr [0x00679394]         ; 0045bd1e | int g_WindowWidth
    FMUL double ptr [0x0061b2ee]        ; 0045bd24 | double g_WindowAspectRatioMultiplier
    FILD dword ptr [0x00679398]         ; 0045bd2a | int g_WindowHeight
    FDIVP                               ; 0045bd30
    FMUL double ptr [0x0061b2f6]        ; 0045bd32 | double g_WindowAspectRatioCorrection
    FSTP float ptr [EBP + -0x18]        ; 0045bd38
    MOV EAX,dword ptr [EBP + 0x10]      ; 0045bd3b
    FILD dword ptr [EAX]                ; 0045bd3e
    FILD dword ptr [0x00679394]         ; 0045bd40 | int g_WindowWidth
    FMUL double ptr [0x0061b2fe]        ; 0045bd46 | double g_WindowViewportCenterOffset
    FSUBP                               ; 0045bd4c
    FILD dword ptr [0x00679394]         ; 0045bd4e | int g_WindowWidth
    FMUL double ptr [0x0061b2fe]        ; 0045bd54 | double g_WindowViewportCenterOffset
    FDIVP                               ; 0045bd5a
    FSTP float ptr [EBP + -0x14]        ; 0045bd5c
    MOV EAX,dword ptr [EBP + 0x10]      ; 0045bd5f
    FILD dword ptr [EAX + 0x4]          ; 0045bd62
    FILD dword ptr [0x00679398]         ; 0045bd65 | int g_WindowHeight
    FMUL double ptr [0x0061b2fe]        ; 0045bd6b | double g_WindowViewportCenterOffset
    FSUBP                               ; 0045bd71
    FCHS                                ; 0045bd73
    FILD dword ptr [0x00679398]         ; 0045bd75 | int g_WindowHeight
    FMUL double ptr [0x0061b2fe]        ; 0045bd7b | double g_WindowViewportCenterOffset
    FDIVP                               ; 0045bd81
    FSTP float ptr [EBP + -0x10]        ; 0045bd83
    FILD dword ptr [0x01626344]         ; 0045bd86 | int g_ZoomLevel
    FMUL float ptr [EBP + -0x14]        ; 0045bd8c
    FMUL float ptr [0x0061b306]         ; 0045bd8f | float g_WindowWorldScaleFactor
    FMUL float ptr [EBP + -0x18]        ; 0045bd95
    FSTP float ptr [EBP + -0x14]        ; 0045bd98
    FILD dword ptr [0x01626344]         ; 0045bd9b | int g_ZoomLevel
    FMUL float ptr [EBP + -0x10]        ; 0045bda1
    FMUL float ptr [0x0061b306]         ; 0045bda4 | float g_WindowWorldScaleFactor
    FSTP float ptr [EBP + -0x10]        ; 0045bdaa
    MOV EAX,[0x01626360]                ; 0045bdad | int g_StoredWorldYCoordinate
    ...
    JMP 0x0045be1f                      ; 0045bde9 | LAB_0045be1f
        ;   XREF to: 0045be1f (UNCONDITIONAL_JUMP)
    ...
    MOV EAX,[0x01626360]                ; 0045bdf7 | int g_StoredWorldYCoordinate
    MOV dword ptr [EBP + -0x24],EAX     ; 0045bdfc
    JMP 0x0045be1f                      ; 0045bdff | LAB_0045be1f
        ;   XREF to: 0045be1f (UNCONDITIONAL_JUMP)
    JMP 0x0045be1f                      ; 0045be01 | LAB_0045be1f
        ;   Label: LAB_0045be01
        ;   XREF to: 0045be1f (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0x4],0x1      ; 0045be03
        ;   Label: LAB_0045be03
    JC 0x0045be17                       ; 0045be07 | LAB_0045be17
        ;   XREF to: 0045be17 (CONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0x4],0x1      ; 0045be09
    JBE 0x0045bdd5                      ; 0045be0d | LAB_0045bdd5
        ;   XREF to: 0045bdd5 (CONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0x4],0x2      ; 0045be0f
    JZ 0x0045bdeb                       ; 0045be13 | LAB_0045bdeb
        ;   XREF to: 0045bdeb (CONDITIONAL_JUMP)
    JMP 0x0045be01                      ; 0045be15 | LAB_0045be01
        ;   XREF to: 0045be01 (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0x4],0x0      ; 0045be17
        ;   Label: LAB_0045be17
    JZ 0x0045bdbf                       ; 0045be1b | LAB_0045bdbf
        ;   XREF to: 0045bdbf (CONDITIONAL_JUMP)
    JMP 0x0045be01                      ; 0045be1d | LAB_0045be01
        ;   XREF to: 0045be01 (UNCONDITIONAL_JUMP)
