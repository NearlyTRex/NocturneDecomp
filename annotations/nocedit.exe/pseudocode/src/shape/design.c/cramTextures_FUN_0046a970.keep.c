...

{
  ...
  strcpy(local_11c,texture_filename);
  local_18 = strchr(local_11c,'.');
  if (local_18 == (char *)0x0) {
    local_18 = strchr(local_11c,'\0');
  }
  strcpy(local_18,".TGA");
  ...
  strcpy(g_TextureAtlasEntries[g_TextureProcessedCount].original_filename,texture_filename);
