...

{
  ...
  fVar10 = (float10)fptan((float10)60.0 * (float10)3.1415926535000001 * (float10)0.0055555555555555497
                          * (float10)0.5);
  local_28 = (float)(((float10)g_WindowWidth * (float10)0.5) / fVar10);
  fVar10 = (float10)fptan((float10)60.0 * (float10)3.1415926535000001 * (float10)0.0055555555555555497
                          * (float10)0.5);
  local_14 = (float)(((float10)g_WindowHeight * (float10)0.5) / fVar10);
  local_20 = (local_28 / ((float)g_WindowWidth * (float)0.5)) *
             (float)65536;
  local_48 = (local_14 / ((float)g_WindowHeight * (float)0.5)) *
             (float)65536;
  iVar5 = shape_design_c_checkVertexCountLimit_FUN_00460a10();
  if (iVar5 == 0) {
    local_58 = 0;
    local_3c = 0;
    local_38 = 0;
    ...
    local_1c = 0;
    local_40 = -0x10000;
    local_24 = g_ProjectionScale;
    g_ProjectionScale = 0x10000;
    local_34 = engine_2d_c_getTextColor_FUN_00402830();
    ...
    do {
      ...
      if (g_WireframeMode != 0) {
        dVar11 = crt_math_c_round_FUN_005fe6b0((double)local_20);
        iVar5 = (int)ROUND(dVar11);
        dVar11 = crt_math_c_round_FUN_005fe6b0((double)local_48);
        iVar1 = (int)ROUND(dVar11);
        g_TransformMatrix.m[0].x =
             (uint)((longlong)iVar5 * (longlong)g_TransformMatrix.m[0].x) >> 0x10 |
             (int)((ulonglong)((longlong)iVar5 * (longlong)g_TransformMatrix.m[0].x) >> 0x20) <<
             0x10;
        g_TransformMatrix.m[1].x =
             (uint)((longlong)iVar5 * (longlong)g_TransformMatrix.m[1].x) >> 0x10 |
             (int)((ulonglong)((longlong)iVar5 * (longlong)g_TransformMatrix.m[1].x) >> 0x20) <<
             0x10;
        g_TransformMatrix.m[2].x =
             (uint)((longlong)iVar5 * (longlong)g_TransformMatrix.m[2].x) >> 0x10 |
             (int)((ulonglong)((longlong)iVar5 * (longlong)g_TransformMatrix.m[2].x) >> 0x20) <<
             0x10;
      ...
      iVar5 = g_WindowWidth >> 0x1f;
      if (g_GouraudShadingEnabled == 1) {
        engine_2d_c_drawTextColor_FUN_00402430
                  ("Gouraud : on",
                   ((int)((g_WindowWidth + iVar5 * -4) - (uint)(iVar5 << 1 < 0)) >> 2) + 0x19,
                   g_WindowHeight + -0x16);
      }
      else {
        engine_2d_c_drawTextColor_FUN_00402430
      ...
      local_44 = engine_2d_c_getStringWidth_FUN_004018a0("Gouraud : off   ");
      iVar5 = g_WindowWidth >> 0x1f;
      ...
      if (g_CurrentPartIndex == -1) {
        ...
        crt_stdio_c_sprintf_FUN_005fdbd0
                  (&stack0xffffff48,"Current part : %s",g_ModelPartNames + g_CurrentPartIndex)
        ;
      }
      ...
      crt_stdio_c_sprintf_FUN_005fdbd0(&stack0xffffff48," : %d",g_VertexCount);
      ...
      crt_stdio_c_sprintf_FUN_005fdbd0(&stack0xffffff48," : %d",g_PolygonCount);
      ...
      crt_stdio_c_sprintf_FUN_005fdbd0(&stack0xffffff48," : %d",g_PartsCount);
      engine_2d_c_drawTextColor_FUN_00402430
      ...
      if (g_WireframeMode == 0) {
        ...
        _local_d8 = (double)local_2c;
      }
      dVar11 = _local_d8;
      uVar2 = (ulonglong)_local_d8 >> 0x20;
      local_d8 = SUB84 /* extract 2-byte value */(dVar11,0);
      crt_stdio_c_sprintf_FUN_005fdbd0
                (&stack0xffffff48,"Zoom : %4.2f  FOV : %4.1f",
                 65536 / (double)g_ProjectionScale,local_d8,(int)uVar2);
      ...
      if (g_LoadedModelName[0] == '\0') {
        ...
        crt_stdio_c_sprintf_FUN_005fdbd0(&stack0xffffff48,"%s",g_LoadedModelName);
      }
      ...
      crt_stdio_c_sprintf_FUN_005fdbd0
                (&stack0xffffff48,"X: %0.4f Y: %0.4f Z: %0.4f",
                 ...
                 SUB84 /* extract 2-byte value */((double)local_40 * 1.52587890625e-05,0),
                 (int)((ulonglong)((double)local_40 * 1.52587890625e-05) >> 0x20));
      engine_2d_c_drawTextColor_FUN_00402430
                (&stack0xffffff48,
                 ((int)((g_WindowWidth + (g_WindowWidth >> 0x1f) * -4) -
      ...
      if (g_SelectedPolygonIndex == -1) {
        ...
        crt_stdio_c_sprintf_FUN_005fdbd0
                  (&stack0xffffff48,"Selected polygon : %d",g_SelectedPolygonIndex);
      }
      ...
      if (g_SelectedPolygonIndex != -1) {
        ...
        crt_stdio_c_sprintf_FUN_005fdbd0
                  (&stack0xffffff48,"V order : %3d %3d %3d   N : %d",
                   ...
                   g_ModelPolygonData[g_SelectedPolygonIndex].vertex_indices_count);
        engine_2d_c_drawTextColor_FUN_00402430
                  (&stack0xffffff48,g_WindowWidth / 2 + 10,g_WindowHeight + -0x16);
        dVar11 = (double)g_ModelPolygonData[g_SelectedPolygonIndex].normal.z;
        crt_stdio_c_sprintf_FUN_005fdbd0
                  (&stack0xffffff48,"Normal : %6.2f %6.2f %6.2f",
                   (double)g_ModelPolygonData[g_SelectedPolygonIndex].normal.x,
                   (double)g_ModelPolygonData[g_SelectedPolygonIndex].normal.y,SUB84 /* extract 2-byte value */(dVar11,0),
                   (int)((ulonglong)dVar11 >> 0x20));
        engine_2d_c_drawTextColor_FUN_00402430
                  (&stack0xffffff48,g_WindowWidth / 2 + 10,g_WindowHeight + -0xb);
        dVar11 = shape_design_c_calculatePolygonAngularArea_FUN_00461ee0
                           (g_ModelPolygonData + g_SelectedPolygonIndex);
        uVar12 = (uint)((ulonglong)dVar11 >> 0x20);
        crt_stdio_c_sprintf_FUN_005fdbd0
                  (&stack0xffffff48,"Angle sum : %10.6lf",SUB84 /* extract 2-byte value */(dVar11,0),uVar12);
        engine_2d_c_drawTextColor_FUN_00402430
                  (&stack0xffffff48,g_WindowWidth / 2 + 10,g_WindowHeight + -0x21);
        if (g_ModelPartNames[g_ModelPolygonData[g_SelectedPolygonIndex].part_assignment].name[0] ==
            '\0') {
          pcVar6 = "no name";
        }
        else {
          pcVar6 = g_ModelPartNames[g_ModelPolygonData[g_SelectedPolygonIndex].part_assignment].name
          ;
        }
        crt_stdio_c_sprintf_FUN_005fdbd0
                  (&stack0xffffff48,"Part number : %d (%s)",
                   g_ModelPolygonData[g_SelectedPolygonIndex].part_assignment,pcVar6);
        engine_2d_c_drawTextColor_FUN_00402430
                  (&stack0xffffff48,g_WindowWidth / 2 + 10,g_WindowHeight + -0x37);
        if (g_ModelPolygonData[g_SelectedPolygonIndex].lightmap_name[0] == '\0') {
          if (g_ModelPolygonData[g_SelectedPolygonIndex].texture_name[0] == '\0') {
            pcVar6 = "none";
          }
          else {
            pcVar6 = (char *)(g_SelectedPolygonIndex * 0x184 + 0x16e9914);
          }
          crt_stdio_c_sprintf_FUN_005fdbd0(&stack0xffffff48,"Texture : %s",pcVar6,uVar12);
        }
        else {
          crt_stdio_c_sprintf_FUN_005fdbd0
                    (&stack0xffffff48,"Texture : %s (%s)",
                     g_SelectedPolygonIndex * 0x184 + 0x16e9964,
                     g_SelectedPolygonIndex * 0x184 + 0x16e9914);
        }
        engine_2d_c_drawTextColor_FUN_00402430
        ...
        if (g_ShowUVCoordinates != 0) {
          ...
          for (local_44 = 0;
              ...
              local_44 = local_44 + 1) {
            dVar11 = (double)(g_ModelPolygonData[g_SelectedPolygonIndex].uv_v[local_44] *
                             (float)0.00390625);
            crt_stdio_c_sprintf_FUN_005fdbd0
                      (&stack0xffffff48,"%03d : %010.6f %010.6f / %08.6f %08.6f",
                       ...
                       (double)(g_ModelPolygonData[g_SelectedPolygonIndex].uv_u[local_44] *
                               (float)0.00390625),SUB84 /* extract 2-byte value */(dVar11,0),
                       (int)((ulonglong)dVar11 >> 0x20));
            engine_2d_c_drawTextColor_FUN_00402430
      ...
      if ((g_KeyboardState[0x31] != '\0') && (g_SelectedPolygonIndex != -1)) {
        ...
        pSVar7 = g_ModelPolygonData + g_SelectedPolygonIndex;
        pSVar8 = g_ModelPolygonData + g_PolygonCount;
        for (iVar5 = 0x61; iVar5 != 0; iVar5 = iVar5 + -1) {
          pSVar8->polygon_type = pSVar7->polygon_type;
          pSVar7 = (SShapeEditorPolygon *)((int)pSVar7 + ((uint)bVar9 * -2 + 1) * 4);
          pSVar8 = (SShapeEditorPolygon *)((int)pSVar8 + ((uint)bVar9 * -2 + 1) * 4);
        }
        local_50 = g_ModelPolygonData[g_PolygonCount].vertex_indices_count;
        for (local_44 = 0; local_44 < (int)local_50; local_44 = local_44 + 1) {
          g_ModelPolygonData[g_PolygonCount].vertex_indices[local_44] =
               *(uint *)((int)g_ModelPolygonData +
                        g_SelectedPolygonIndex * 0x184 + (local_50 - local_44) * 4 + 0xb4);
          g_ModelPolygonData[g_PolygonCount].uv_u[local_44] =
               *(float *)((int)g_ModelPolygonData +
                         g_SelectedPolygonIndex * 0x184 + (local_50 - local_44) * 4 + 0xf4);
          g_ModelPolygonData[g_PolygonCount].uv_v[local_44] =
               *(float *)((int)g_ModelPolygonData +
                         g_SelectedPolygonIndex * 0x184 + (local_50 - local_44) * 4 + 0x134);
        }
      ...
      if ((g_KeyboardState[0x20] != '\0') && (0 < g_PolygonCount)) {
        ...
        if (g_SelectedPolygonIndex == -1) {
          ...
          for (local_44 = g_SelectedPolygonIndex; local_44 < g_PolygonCount + -1;
              local_44 = local_44 + 1) {
            pSVar7 = g_ModelPolygonData + local_44 + 1;
            pSVar8 = g_ModelPolygonData + local_44;
            for (iVar5 = 0x61; iVar5 != 0; iVar5 = iVar5 + -1) {
              pSVar8->polygon_type = pSVar7->polygon_type;
              pSVar7 = (SShapeEditorPolygon *)((int)pSVar7 + ((uint)bVar9 * -2 + 1) * 4);
              pSVar8 = (SShapeEditorPolygon *)((int)pSVar8 + ((uint)bVar9 * -2 + 1) * 4);
      ...
      g_GlobalDeltaTimeInt = (local_44 - local_18) / 0x12;
      local_18 = local_44;
    } while (g_KeyboardState[1] == '\0');
    engine_2d_c_reinitializeGraphicsSystem_FUN_005ed4b0();
    engine_2d_c_clearInputAndWait_FUN_00403260();
    g_ProjectionScale = local_24;
    engine_2d_c_setTextColor_FUN_00402840(local_34);
  }
  return;
}
