...
section .text
    ...
    JMP 0x0046dfdb                      ; 0046dfd3 | LAB_0046dfdb
    ...
    MOV EAX,dword ptr [EBP + -0x4]      ; 0046dfdb
        ;   Label: LAB_0046dfdb
    CMP EAX,dword ptr [0x01e8d260]      ; 0046dfde | int g_TextureProcessedCount
    JGE 0x0046e014                      ; 0046dfe4 | LAB_0046e014
        ;   XREF to: 0046e014 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + 0x14]      ; 0046dfe6
    PUSH EAX                            ; 0046dfe9
    IMUL EAX,dword ptr [EBP + -0x4],0x250 ; 0046dfea
    MOV EDX,0x1e8d264                   ; 0046dff1 | STextureAtlasEntry[250] g_TextureAtlasEntries
    ADD EAX,EDX                         ; 0046dff6
    ADD EAX,0x100                       ; 0046dff8
    PUSH EAX                            ; 0046dffd
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 0046dffe | int crt_string.c_stricmp_FUN_005fe7f0(char * str1, char * str2)
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0046e003
    TEST EAX,EAX                        ; 0046e006
    JNZ 0x0046e012                      ; 0046e008 | LAB_0046e012
        ;   XREF to: 0046e012 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + -0x4]      ; 0046e00a
    MOV dword ptr [EBP + -0x8],EAX      ; 0046e00d
    JMP 0x0046e01b                      ; 0046e010 | LAB_0046e01b
        ;   XREF to: 0046e01b (UNCONDITIONAL_JUMP)
    JMP 0x0046dfd5                      ; 0046e012 | LAB_0046dfd5
        ;   Label: LAB_0046e012
