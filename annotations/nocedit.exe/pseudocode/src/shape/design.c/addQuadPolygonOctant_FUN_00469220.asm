...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_design.c_addQuadPolygonOctant_FUN_00469220(uint vertex_index_1, uint vertex_index_2, uint vertex_index_3, uint vertex_index_4)
;
; Parameters:
...
section .text
    ...
    IMUL EAX,dword ptr [0x016e990c],0x184 ; 0046922c | int g_PolygonCount
    MOV EDX,0x16e9910                   ; 00469236 | SShapeEditorPolygon[20000] g_ModelPolygonData
    ADD EDX,EAX                         ; 0046923b
    MOV dword ptr [EBP + -0x4],EDX      ; 0046923d
    INC dword ptr [0x016e990c]          ; 00469240 | int g_PolygonCount
    MOV EAX,dword ptr [EBP + -0x4]      ; 00469246
    MOV dword ptr [EAX],0x2             ; 00469249 | SShapeEditorPolygon[20000] g_ModelPolygonData
    MOV EAX,0x61cf16                    ; 0046924f | = "rustplat.raw" | s_rustplat_raw_0061cf16 = rustplat.raw
    PUSH EAX                            ; 00469254 | = "rustplat.raw" | s_rustplat_raw_0061cf16 = rustplat.raw
    MOV EAX,dword ptr [EBP + -0x4]      ; 00469255
    ADD EAX,0x4                         ; 00469258
    PUSH EAX                            ; 0046925b
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0046925c | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    FMUL double ptr [0x0061cf26]        ; 004692ab | double g_UvScaleConstant256
    ...
    FMUL double ptr [0x0061cf26]        ; 004692c4 | double g_UvScaleConstant256
    ...
    FMUL double ptr [0x0061cf26]        ; 004692dd | double g_UvScaleConstant256
    ...
    FMUL double ptr [0x0061cf26]        ; 004692f6 | double g_UvScaleConstant256
    ...
    FMUL double ptr [0x0061cf26]        ; 0046930f | double g_UvScaleConstant256
    ...
    FMUL double ptr [0x0061cf26]        ; 00469328 | double g_UvScaleConstant256
    ...
    FMUL double ptr [0x0061cf26]        ; 00469341 | double g_UvScaleConstant256
    ...
    CMP dword ptr [EBP + -0x8],0x4      ; 00469378
        ;   Label: LAB_00469378
    JGE 0x00469413                      ; 0046937c | LAB_00469413
    ...
    JMP 0x00469372                      ; 0046940e | LAB_00469372
