...
section .text
    ...
    CMP dword ptr [EBP + 0x18],0x0      ; 0045936c
        ;   Label: LAB_0045936c
    JLE 0x00459399                      ; 00459370
        ;   XREF to: 00459399 (CONDITIONAL_JUMP)  ; LAB_00459399
    ...
    JGE 0x00459389                      ; 00459385
        ;   XREF to: 00459389 (CONDITIONAL_JUMP)  ; LAB_00459389
    JMP 0x00459399                      ; 00459387
        ;   XREF to: 00459399 (UNCONDITIONAL_JUMP)  ; LAB_00459399
    CMP dword ptr [EBP + -0x4],0xa      ; 00459389
        ;   Label: LAB_00459389
    JNZ 0x00459391                      ; 0045938d
        ;   XREF to: 00459391 (CONDITIONAL_JUMP)  ; LAB_00459391
    JMP 0x00459393                      ; 0045938f
        ;   XREF to: 00459393 (UNCONDITIONAL_JUMP)  ; LAB_00459393
    JMP 0x00459372                      ; 00459391
        ;   XREF to: 00459372 (UNCONDITIONAL_JUMP)  ; LAB_00459372
        ;   Label: LAB_00459391
    ADD dword ptr [EBP + 0x18],-0x1     ; 00459393
        ;   Label: LAB_00459393
    JMP 0x0045936c                      ; 00459397
        ;   XREF to: 0045936c (UNCONDITIONAL_JUMP)  ; LAB_0045936c
