...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_design.c_quantizePaletteColors_FUN_0046b770(byte * image_data, int pixel_count, int stride, byte * palette_data, int mode_flag, char * bit_mask)
;
; Parameters:
...
section .text
    ...
    JMP 0x0046b79b                      ; 0046b796 | LAB_0046b79b
    ...
    JGE 0x0046b98b                      ; 0046b7a1 | LAB_0046b98b
    ...
    JGE 0x0046b978                      ; 0046b7ba | LAB_0046b978
    ...
    JZ 0x0046b978                       ; 0046b7e7 | LAB_0046b978
        ;   XREF to: 0046b978 (CONDITIONAL_JUMP)
    ...
    FSQRT                               ; 0046b844
    FMUL double ptr [0x0061d3ae]        ; 0046b846 | double g_ColorMagnitudeWeightOriginal
    ...
    FSQRT                               ; 0046b8d9
    FMUL double ptr [0x0061d3b6]        ; 0046b8db | double g_ColorMagnitudeWeightPalette
    ...
    FMUL double ptr [0x0061d3be]        ; 0046b915 | double g_RedChannelWeight
    ...
    FMUL double ptr [0x0061d3c6]        ; 0046b928 | double g_GreenChannelWeight
    FADDP                               ; 0046b92e
    ...
    FMUL double ptr [0x0061d3ce]        ; 0046b93d | double g_BlueChannelWeight
    FADDP                               ; 0046b943
    FLD float ptr [EBP + -0x34]         ; 0046b945
    FMUL float ptr [EBP + -0x34]        ; 0046b948
    FMUL double ptr [0x0061d3d6]        ; 0046b94b | double g_MagnitudeDifferenceWeight
    FADDP                               ; 0046b951
    ...
    FNSTSW AX                           ; 0046b95c
    SAHF                                ; 0046b95e
    JNC 0x0046b96d                      ; 0046b95f | LAB_0046b96d
    ...
    JMP 0x0046b865                      ; 0046b96d | LAB_0046b865
        ;   Label: LAB_0046b96d
    ...
    JMP 0x0046b798                      ; 0046b986 | LAB_0046b798
