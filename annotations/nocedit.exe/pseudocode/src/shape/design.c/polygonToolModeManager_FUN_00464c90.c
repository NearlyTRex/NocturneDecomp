  ...
  if (iVar2 == 0) {
    ...
    if ((g_ToolModeEnabled == 0) ||
      ...
      if (g_ToolModeEnabled == 0) {
        ...
        iVar2 = shape_design_c_findClosestPolygonToMouse_FUN_00466250();
        if ((g_KeyboardState[0x32] != '\0') && (g_KeyboardState[0x2a] == '\0')) {
          g_KeyboardState[0x32] = '\0';
        ...
        if (iVar3 != 0) {
          ...
          switch(g_PolygonToolMode) {
          case 1:
            shape_design_c_polygonMergerSelectAndProcess_FUN_00465160(iVar2,local_14);
            break;
          case 2:
            shape_design_c_weldNearbyVertices_FUN_00465c50(iVar2,local_14);
            break;
          case 3:
            shape_design_c_duplicateSharedVertices_FUN_00465d50(iVar2);
            break;
          case 4:
            shape_design_c_interactiveWeldVertices_FUN_00465e90(iVar2,local_14);
            break;
          case 5:
        ...
        if ((g_PolygonToolMode == 1) && (g_SecondaryPolygonIndex != -1)) {
          dVar8 = shape_design_c_calculateAngleBetweenPolygonNormals_FUN_00461cb0
                            (g_ModelPolygonData + g_SecondaryPolygonIndex,g_ModelPolygonData + iVar2
                            );
