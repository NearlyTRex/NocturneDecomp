...
;                               FUNCTION
; *****************************************************************************
; __cdecl double shape_design.c_clampedArccos_FUN_00461c50(double dot_product)
;
; Parameters:
...
section .text
    ...
    FCOMP double ptr [0x0061bfae]       ; 00461c5f | double g_ArccosDomainMin
    FNSTSW AX                           ; 00461c65
    SAHF                                ; 00461c67
    JA 0x00461c7a                       ; 00461c68 | LAB_00461c7a
        ;   XREF to: 00461c7a (CONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x8],0x54524550 ; 00461c6a
    MOV dword ptr [EBP + -0x4],0x400921fb ; 00461c71
    JMP 0x00461c9f                      ; 00461c78 | LAB_00461c9f
    ...
    FNSTSW AX                           ; 00461c7f
    SAHF                                ; 00461c81
    JA 0x00461c94                       ; 00461c82 | LAB_00461c94
        ;   XREF to: 00461c94 (CONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x8],0x0      ; 00461c84
    MOV dword ptr [EBP + -0x4],0x0      ; 00461c8b
    JMP 0x00461c9f                      ; 00461c92 | LAB_00461c9f
        ;   XREF to: 00461c9f (UNCONDITIONAL_JUMP)
    FLD double ptr [EBP + 0x14]         ; 00461c94
        ;   Label: LAB_00461c94
    CALL crt_math.c_acos_FUN_00600162   ; 00461c97 | double crt_math.c_acos_FUN_00600162(double x)
