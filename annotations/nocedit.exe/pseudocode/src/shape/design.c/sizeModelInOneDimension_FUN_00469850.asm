...
; float[4]         Stack[-0x20]:16  local_20
;
; XREF[1]:
...
section .text
    ...
    JMP 0x00469895                      ; 0046988d
        ;   XREF to: 00469895 (UNCONDITIONAL_JUMP)  ; LAB_00469895
    MOV EAX,dword ptr [EBP + -0x44]     ; 0046988f
        ;   Label: LAB_0046988f
    INC dword ptr [EBP + -0x44]         ; 00469892
    MOV EAX,dword ptr [EBP + -0x44]     ; 00469895
        ;   Label: LAB_00469895
    CMP EAX,dword ptr [0x01626408]      ; 00469898 | g_VertexCount
    JGE 0x00469936                      ; 0046989e
        ;   XREF to: 00469936 (CONDITIONAL_JUMP)  ; LAB_00469936
    IMUL EAX,dword ptr [EBP + -0x44],0x14 ; 004698a4
    MOV EAX,dword ptr [EAX + 0x162640c] ; 004698a8 | g_LoadedVertices
    MOV dword ptr [EBP + -0x34],EAX     ; 004698ae
    FLD float ptr [EBP + -0x34]         ; 004698b1
    FCOMP float ptr [EBP + -0x1c]       ; 004698b4
    FNSTSW AX                           ; 004698b7
    SAHF                                ; 004698b9
    JBE 0x004698c2                      ; 004698ba
        ;   XREF to: 004698c2 (CONDITIONAL_JUMP)  ; LAB_004698c2
    ...
    FNSTSW AX                           ; 004698c8
    SAHF                                ; 004698ca
    JNC 0x004698d3                      ; 004698cb
        ;   XREF to: 004698d3 (CONDITIONAL_JUMP)  ; LAB_004698d3
    ...
    FNSTSW AX                           ; 004698e6
    SAHF                                ; 004698e8
    JBE 0x004698f1                      ; 004698e9
        ;   XREF to: 004698f1 (CONDITIONAL_JUMP)  ; LAB_004698f1
    ...
    FNSTSW AX                           ; 004698f7
    SAHF                                ; 004698f9
    JNC 0x00469902                      ; 004698fa
        ;   XREF to: 00469902 (CONDITIONAL_JUMP)  ; LAB_00469902
    ...
    FNSTSW AX                           ; 00469915
    SAHF                                ; 00469917
    JBE 0x00469920                      ; 00469918
        ;   XREF to: 00469920 (CONDITIONAL_JUMP)  ; LAB_00469920
    ...
    FNSTSW AX                           ; 00469926
    SAHF                                ; 00469928
    JNC 0x00469931                      ; 00469929
        ;   XREF to: 00469931 (CONDITIONAL_JUMP)  ; LAB_00469931
    ...
    PUSH 0x0                            ; 0046993b
    PUSH 0x0                            ; 0046993d
    MOV EAX,0x61cfef                    ; 0046993f | = "Enter axis to size - X, Y, or Z : "
    PUSH EAX                            ; 00469944 | = "Enter axis to size - X, Y, or Z : "
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 00469945
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)  ; void engine_2d.c_drawText_FUN_00401fd0(char * text, int x, int y)
    ADD ESP,0xc                         ; 0046994a
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 0046994d
        ;   XREF to: 005eda20 (UNCONDITIONAL_CALL)  ; void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20()
    CALL engine_2d.c_clearInputAndWait_FUN_00403260 ; 00469952
        ;   XREF to: 00403260 (UNCONDITIONAL_CALL)  ; void engine_2d.c_clearInputAndWait_FUN_00403260()
    CALL wincore_winrun.cpp_getNextKeypress_FUN_005f2e90 ; 00469957
        ;   XREF to: 005f2e90 (UNCONDITIONAL_CALL)  ; int wincore_winrun.cpp_getNextKeypress_FUN_005f2e90()
    AND EAX,0xff                        ; 0046995c
    PUSH EAX                            ; 00469961
    CALL crt_ctype.c_toupper_FUN_005ff9e0 ; 00469962
    ...
    JL 0x00469979                       ; 00469971
        ;   XREF to: 00469979 (CONDITIONAL_JUMP)  ; LAB_00469979
    CMP dword ptr [EBP + -0x38],0x5a    ; 00469973
    JLE 0x0046997e                      ; 00469977
        ;   XREF to: 0046997e (CONDITIONAL_JUMP)  ; LAB_0046997e
    JMP 0x00469bbb                      ; 00469979
        ;   XREF to: 00469bbb (UNCONDITIONAL_JUMP)  ; LAB_00469bbb
        ;   Label: LAB_00469979
    MOV ECX,dword ptr [EBP + -0x38]     ; 0046997e
        ;   Label: LAB_0046997e
    PUSH ECX                            ; 00469981
    MOV ECX,0x61d012                    ; 00469982 | = "Enter %c distance in feet (,min,max f..."
    ...
    PUSH ECX                            ; 004699aa
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 004699ab
    ...
    JNZ 0x004699cc                      ; 004699c5
        ;   XREF to: 004699cc (CONDITIONAL_JUMP)  ; LAB_004699cc
    JMP 0x00469bbb                      ; 004699c7
        ;   XREF to: 00469bbb (UNCONDITIONAL_JUMP)  ; LAB_00469bbb
    ...
    PUSH EAX                            ; 004699d7
    MOV EAX,0x61d05a                    ; 004699d8 | = "%f,%d,%d"
    PUSH EAX                            ; 004699dd | = "%f,%d,%d"
    LEA EAX,[EBP + 0xffffff6c]          ; 004699de
    PUSH EAX                            ; 004699e4
    CALL crt_stdio.c_sscanf_FUN_0060013c ; 004699e5
    ...
    JLE 0x00469af4                      ; 004699f4
        ;   XREF to: 00469af4 (CONDITIONAL_JUMP)  ; LAB_00469af4
    CMP dword ptr [EBP + -0x44],0x3     ; 004699fa
    JZ 0x00469a21                       ; 004699fe
        ;   XREF to: 00469a21 (CONDITIONAL_JUMP)  ; LAB_00469a21
    PUSH 0x2c                           ; 00469a00
    PUSH 0x0                            ; 00469a02
    MOV EAX,0x61d063                    ; 00469a04 | = "Need distance and two points."
    PUSH EAX                            ; 00469a09 | = "Need distance and two points."
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 00469a0a
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)  ; void engine_2d.c_drawText_FUN_00401fd0(char * text, int x, int y)
    ADD ESP,0xc                         ; 00469a0f
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 00469a12
        ;   XREF to: 005eda20 (UNCONDITIONAL_CALL)  ; void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20()
    CALL wincore_winrun.cpp_getNextKeypress_FUN_005f2e90 ; 00469a17
        ;   XREF to: 005f2e90 (UNCONDITIONAL_CALL)  ; int wincore_winrun.cpp_getNextKeypress_FUN_005f2e90()
    JMP 0x00469bbb                      ; 00469a1c
        ;   XREF to: 00469bbb (UNCONDITIONAL_JUMP)  ; LAB_00469bbb
    CMP dword ptr [EBP + -0x3c],0x0     ; 00469a21
        ;   Label: LAB_00469a21
    JL 0x00469a2d                       ; 00469a25
        ;   XREF to: 00469a2d (CONDITIONAL_JUMP)  ; LAB_00469a2d
    CMP dword ptr [EBP + -0x40],0x0     ; 00469a27
    JGE 0x00469a2f                      ; 00469a2b
        ;   XREF to: 00469a2f (CONDITIONAL_JUMP)  ; LAB_00469a2f
    JMP 0x00469a3a                      ; 00469a2d
        ;   XREF to: 00469a3a (UNCONDITIONAL_JUMP)  ; LAB_00469a3a
        ;   Label: LAB_00469a2d
    MOV EAX,[0x01626408]                ; 00469a2f | g_VertexCount
        ;   Label: LAB_00469a2f
    DEC EAX                             ; 00469a34
    CMP EAX,dword ptr [EBP + -0x3c]     ; 00469a35
    JGE 0x00469a3c                      ; 00469a38
        ;   XREF to: 00469a3c (CONDITIONAL_JUMP)  ; LAB_00469a3c
    JMP 0x00469a47                      ; 00469a3a
        ;   XREF to: 00469a47 (UNCONDITIONAL_JUMP)  ; LAB_00469a47
        ;   Label: LAB_00469a3a
    MOV EAX,[0x01626408]                ; 00469a3c | g_VertexCount
        ;   Label: LAB_00469a3c
    DEC EAX                             ; 00469a41
    CMP EAX,dword ptr [EBP + -0x40]     ; 00469a42
    JGE 0x00469a68                      ; 00469a45
        ;   XREF to: 00469a68 (CONDITIONAL_JUMP)  ; LAB_00469a68
    PUSH 0x2c                           ; 00469a47
        ;   Label: LAB_00469a47
    PUSH 0x0                            ; 00469a49
    MOV EAX,0x61d081                    ; 00469a4b | = "Invalid point."
    PUSH EAX                            ; 00469a50 | = "Invalid point."
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 00469a51
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)  ; void engine_2d.c_drawText_FUN_00401fd0(char * text, int x, int y)
    ADD ESP,0xc                         ; 00469a56
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 00469a59
        ;   XREF to: 005eda20 (UNCONDITIONAL_CALL)  ; void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20()
    CALL wincore_winrun.cpp_getNextKeypress_FUN_005f2e90 ; 00469a5e
        ;   XREF to: 005f2e90 (UNCONDITIONAL_CALL)  ; int wincore_winrun.cpp_getNextKeypress_FUN_005f2e90()
    JMP 0x00469bbb                      ; 00469a63
        ;   XREF to: 00469bbb (UNCONDITIONAL_JUMP)  ; LAB_00469bbb
    MOV EAX,dword ptr [EBP + -0x38]     ; 00469a68
        ;   Label: LAB_00469a68
    MOV dword ptr [EBP + 0xffffff18],EAX ; 00469a6b
    JMP 0x00469acc                      ; 00469a71
        ;   XREF to: 00469acc (UNCONDITIONAL_JUMP)  ; LAB_00469acc
    IMUL EAX,dword ptr [EBP + -0x40],0x14 ; 00469a73
        ;   Label: LAB_00469a73
    MOV EAX,dword ptr [EAX + 0x162640c] ; 00469a77 | g_LoadedVertices
    MOV dword ptr [EBP + -0x1c],EAX     ; 00469a7d
    IMUL EAX,dword ptr [EBP + -0x3c],0x14 ; 00469a80
    MOV EAX,dword ptr [EAX + 0x162640c] ; 00469a84 | g_LoadedVertices
    MOV dword ptr [EBP + -0x28],EAX     ; 00469a8a
    JMP 0x00469af4                      ; 00469a8d
    ...
    JMP 0x00469af4                      ; 00469ac8
        ;   XREF to: 00469af4 (UNCONDITIONAL_JUMP)  ; LAB_00469af4
    JMP 0x00469af4                      ; 00469aca
        ;   XREF to: 00469af4 (UNCONDITIONAL_JUMP)  ; LAB_00469af4
        ;   Label: LAB_00469aca
    CMP dword ptr [EBP + 0xffffff18],0x59 ; 00469acc
        ;   Label: LAB_00469acc
    JC 0x00469ae9                       ; 00469ad3
        ;   XREF to: 00469ae9 (CONDITIONAL_JUMP)  ; LAB_00469ae9
    CMP dword ptr [EBP + 0xffffff18],0x59 ; 00469ad5
    JBE 0x00469a92                      ; 00469adc
        ;   XREF to: 00469a92 (CONDITIONAL_JUMP)  ; LAB_00469a92
    CMP dword ptr [EBP + 0xffffff18],0x5a ; 00469ade
    JZ 0x00469aae                       ; 00469ae5
        ;   XREF to: 00469aae (CONDITIONAL_JUMP)  ; LAB_00469aae
    JMP 0x00469aca                      ; 00469ae7
        ;   XREF to: 00469aca (UNCONDITIONAL_JUMP)  ; LAB_00469aca
    CMP dword ptr [EBP + 0xffffff18],0x58 ; 00469ae9
        ;   Label: LAB_00469ae9
    JZ 0x00469a73                       ; 00469af0
        ;   XREF to: 00469a73 (CONDITIONAL_JUMP)  ; LAB_00469a73
    JMP 0x00469aca                      ; 00469af2
        ;   XREF to: 00469aca (UNCONDITIONAL_JUMP)  ; LAB_00469aca
    ...
    JMP 0x00469b27                      ; 00469b1f
        ;   XREF to: 00469b27 (UNCONDITIONAL_JUMP)  ; LAB_00469b27
    MOV EAX,dword ptr [EBP + -0x44]     ; 00469b21
        ;   Label: LAB_00469b21
    INC dword ptr [EBP + -0x44]         ; 00469b24
    MOV EAX,dword ptr [EBP + -0x44]     ; 00469b27
        ;   Label: LAB_00469b27
    CMP EAX,dword ptr [0x01626408]      ; 00469b2a | g_VertexCount
    JGE 0x00469bbb                      ; 00469b30
        ;   XREF to: 00469bbb (CONDITIONAL_JUMP)  ; LAB_00469bbb
    MOV EAX,dword ptr [EBP + -0x38]     ; 00469b36
    MOV dword ptr [EBP + 0xffffff14],EAX ; 00469b39
    JMP 0x00469b8e                      ; 00469b3f
        ;   XREF to: 00469b8e (UNCONDITIONAL_JUMP)  ; LAB_00469b8e
    IMUL EAX,dword ptr [EBP + -0x44],0x14 ; 00469b41
        ;   Label: LAB_00469b41
    FLD float ptr [EAX + 0x162640c]     ; 00469b45 | g_LoadedVertices
    FMUL float ptr [EBP + -0xc]         ; 00469b4b
    IMUL EAX,dword ptr [EBP + -0x44],0x14 ; 00469b4e
    FSTP float ptr [EAX + 0x162640c]    ; 00469b52 | g_LoadedVertices
    JMP 0x00469bb6                      ; 00469b58
    ...
    JMP 0x00469bb6                      ; 00469b8a
        ;   XREF to: 00469bb6 (UNCONDITIONAL_JUMP)  ; LAB_00469bb6
    JMP 0x00469bb6                      ; 00469b8c
        ;   XREF to: 00469bb6 (UNCONDITIONAL_JUMP)  ; LAB_00469bb6
        ;   Label: LAB_00469b8c
    CMP dword ptr [EBP + 0xffffff14],0x59 ; 00469b8e
        ;   Label: LAB_00469b8e
    JC 0x00469bab                       ; 00469b95
        ;   XREF to: 00469bab (CONDITIONAL_JUMP)  ; LAB_00469bab
    CMP dword ptr [EBP + 0xffffff14],0x59 ; 00469b97
    JBE 0x00469b5a                      ; 00469b9e
        ;   XREF to: 00469b5a (CONDITIONAL_JUMP)  ; LAB_00469b5a
    CMP dword ptr [EBP + 0xffffff14],0x5a ; 00469ba0
    JZ 0x00469b73                       ; 00469ba7
        ;   XREF to: 00469b73 (CONDITIONAL_JUMP)  ; LAB_00469b73
    JMP 0x00469b8c                      ; 00469ba9
        ;   XREF to: 00469b8c (UNCONDITIONAL_JUMP)  ; LAB_00469b8c
    CMP dword ptr [EBP + 0xffffff14],0x58 ; 00469bab
        ;   Label: LAB_00469bab
    JZ 0x00469b41                       ; 00469bb2
        ;   XREF to: 00469b41 (CONDITIONAL_JUMP)  ; LAB_00469b41
    JMP 0x00469b8c                      ; 00469bb4
        ;   XREF to: 00469b8c (UNCONDITIONAL_JUMP)  ; LAB_00469b8c
    JMP 0x00469b21                      ; 00469bb6
        ;   XREF to: 00469b21 (UNCONDITIONAL_JUMP)  ; LAB_00469b21
        ;   Label: LAB_00469bb6
