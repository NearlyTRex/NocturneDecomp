...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_design.c_renderSinglePolygonWithColorOverlay_FUN_0045d1d0(int polygon_index, int * color_value)
;
; Parameters:
...
section .text
    ...
    CMP dword ptr [0x01e66158],0x0      ; 0045d1dc | int g_WireframeMode
    JZ 0x0045d1ee                       ; 0045d1e3 | LAB_0045d1ee
        ;   XREF to: 0045d1ee (CONDITIONAL_JUMP)
    CMP dword ptr [0x01e6614c],-0x1     ; 0045d1e5 | int g_CurrentPartIndex
    JNZ 0x0045d1f0                      ; 0045d1ec | LAB_0045d1f0
        ;   XREF to: 0045d1f0 (CONDITIONAL_JUMP)
    JMP 0x0045d20a                      ; 0045d1ee | LAB_0045d20a
        ;   Label: LAB_0045d1ee
    ...
    CMP EAX,dword ptr [0x01e6614c]      ; 0045d1fd | int g_CurrentPartIndex
    JZ 0x0045d20a                       ; 0045d203 | LAB_0045d20a
        ;   XREF to: 0045d20a (CONDITIONAL_JUMP)
    JMP 0x0045d2f5                      ; 0045d205 | LAB_0045d2f5
    ...
    FMUL float ptr [0x0061b3fe]         ; 0045d227 | float g_OverlayNormalScale
    CALL crt_math.c_round_FUN_005fe6b0  ; 0045d22d | double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    FMUL float ptr [0x0061b3fe]         ; 0045d242 | float g_OverlayNormalScale
    CALL crt_math.c_round_FUN_005fe6b0  ; 0045d248 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    FMUL float ptr [0x0061b3fe]         ; 0045d25d | float g_OverlayNormalScale
    CALL crt_math.c_round_FUN_005fe6b0  ; 0045d263 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    FMUL float ptr [0x0061b3fe]         ; 0045d278 | float g_OverlayNormalScale
    FMUL float ptr [0x0061b402]         ; 0045d27e | float g_OverlayPlaneDistanceScale
    CALL crt_math.c_round_FUN_005fe6b0  ; 0045d284 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [EBP + -0x48]       ; 0045d289
    MOV dword ptr [EBP + -0x4],0x0      ; 0045d28c
    JMP 0x0045d29b                      ; 0045d293 | LAB_0045d29b
    ...
    JGE 0x0045d2ce                      ; 0045d2ab | LAB_0045d2ce
    ...
    JMP 0x0045d295                      ; 0045d2cc | LAB_0045d295
        ;   XREF to: 0045d295 (UNCONDITIONAL_JUMP)
    CMP dword ptr [0x01e528c4],0x0      ; 0045d2ce | int g_AntiAliasingEnabled
        ;   Label: LAB_0045d2ce
    JNZ 0x0045d2e5                      ; 0045d2d5 | LAB_0045d2e5
        ;   XREF to: 0045d2e5 (CONDITIONAL_JUMP)
    LEA EAX,[EBP + -0x5c]               ; 0045d2d7
    PUSH EAX                            ; 0045d2da
    CALL shape_design.c_renderPolygonWireframe_FUN_0045d300 ; 0045d2db | void shape_design.c_renderPolygonWireframe_FUN_0045d300(SMRGLHeaderPrimitive * polygon_data)
        ;   XREF to: 0045d300 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0045d2e0
    JMP 0x0045d2f5                      ; 0045d2e3 | LAB_0045d2f5
        ;   XREF to: 0045d2f5 (UNCONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 0045d2ec
    CALL shape_design.c_renderPolygonWireframeAntialiased_FUN_0045d470 ; 0045d2ed | void shape_design.c_renderPolygonWireframeAntialiased_FUN_0045d470(SMRGLHeaderPrimitive * polygon_data, int line_color)
