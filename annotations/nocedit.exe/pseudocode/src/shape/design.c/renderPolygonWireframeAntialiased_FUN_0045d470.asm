...
section .text
    ...
    PUSH EAX                            ; 0045d48b
    CALL engine_3d.c_isVisiblePlane_FUN_00403950 ; 0045d48c | int engine_3d.c_isVisiblePlane_FUN_00403950(SClipPlane * plane)
        ;   XREF to: 00403950 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0045d491
    TEST EAX,EAX                        ; 0045d494
    JZ 0x0045d5c1                       ; 0045d496 | LAB_0045d5c1
        ;   XREF to: 0045d5c1 (CONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x8],0x0      ; 0045d49c
    JMP 0x0045d4ab                      ; 0045d4a3 | LAB_0045d4ab
    ...
    JLE 0x0045d543                      ; 0045d4b5 | LAB_0045d543
    ...
    MOV EDI,0x69ffb4                    ; 0045d4cc | int[12] g_AALineVertex1
    LEA ESI,[ESI + 0x688014]            ; 0045d4d1 | SRenderVertex[16] g_RenderVertexBuffer
    MOVSD.REP ES:EDI,ESI                ; 0045d4d7 | int[12] g_AALineVertex1 | SRenderVertex[16] g_RenderVertexBuffer
    ...
    MOV EDI,0x69ffe4                    ; 0045d4eb | int[12] g_AALineVertex2
    LEA ESI,[ESI + 0x688014]            ; 0045d4f0 | SRenderVertex[16] g_RenderVertexBuffer
    MOVSD.REP ES:EDI,ESI                ; 0045d4f6 | int[12] g_AALineVertex2 | SRenderVertex[16] g_RenderVertexBuffer
    TEST byte ptr [0x0069ffc7],0x80     ; 0045d4f8 | DAT_0069ffc4+3
    JZ 0x0045d503                       ; 0045d4ff | LAB_0045d503
        ;   XREF to: 0045d503 (CONDITIONAL_JUMP)
    JMP 0x0045d53e                      ; 0045d501 | LAB_0045d53e
        ;   XREF to: 0045d53e (UNCONDITIONAL_JUMP)
    TEST byte ptr [0x0069fff7],0x80     ; 0045d503 | DAT_0069fff4+3
        ;   Label: LAB_0045d503
    JZ 0x0045d50e                       ; 0045d50a | LAB_0045d50e
        ;   XREF to: 0045d50e (CONDITIONAL_JUMP)
    JMP 0x0045d53e                      ; 0045d50c | LAB_0045d53e
        ;   XREF to: 0045d53e (UNCONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 0045d535
    CALL cockpit_ckptutil.c_drawLineAA_FUN_00433c90 ; 0045d536 | void cockpit_ckptutil.c_drawLineAA_FUN_00433c90(int x0, int y0, int x1, int y1, ...)
        ;   XREF to: 00433c90 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0045d53b
    JMP 0x0045d4a5                      ; 0045d53e | LAB_0045d4a5
        ;   Label: LAB_0045d53e
    ...
    MOV EDI,0x69ffb4                    ; 0045d558 | int[12] g_AALineVertex1
    LEA ESI,[ESI + 0x688014]            ; 0045d55d | SRenderVertex[16] g_RenderVertexBuffer
    MOVSD.REP ES:EDI,ESI                ; 0045d563 | int[12] g_AALineVertex1 | SRenderVertex[16] g_RenderVertexBuffer
    MOV EAX,dword ptr [EBP + -0x4]      ; 0045d565
    IMUL ESI,dword ptr [EAX],0x30       ; 0045d568
    MOV ECX,0xc                         ; 0045d56b
    MOV EDI,0x69ffe4                    ; 0045d570 | int[12] g_AALineVertex2
    LEA ESI,[ESI + 0x688014]            ; 0045d575 | SRenderVertex[16] g_RenderVertexBuffer
    MOVSD.REP ES:EDI,ESI                ; 0045d57b | int[12] g_AALineVertex2 | SRenderVertex[16] g_RenderVertexBuffer
    TEST byte ptr [0x0069ffc7],0x80     ; 0045d57d | DAT_0069ffc4+3
    JNZ 0x0045d58f                      ; 0045d584 | LAB_0045d58f
        ;   XREF to: 0045d58f (CONDITIONAL_JUMP)
    TEST byte ptr [0x0069fff7],0x80     ; 0045d586 | DAT_0069fff4+3
    JZ 0x0045d591                       ; 0045d58d | LAB_0045d591
        ;   XREF to: 0045d591 (CONDITIONAL_JUMP)
    JMP 0x0045d5c1                      ; 0045d58f | LAB_0045d5c1
        ;   Label: LAB_0045d58f
    ...
    PUSH EAX                            ; 0045d5b8
    CALL cockpit_ckptutil.c_drawLineAA_FUN_00433c90 ; 0045d5b9 | void cockpit_ckptutil.c_drawLineAA_FUN_00433c90(int x0, int y0, int x1, int y1, ...)
        ;   XREF to: 00433c90 (UNCONDITIONAL_CALL)
