...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_design.c_renderPolygonVerticesWithLabels_FUN_0045c2f0(int polygon_index)
;
; Parameters:
...
section .text
    ...
    JZ 0x0045c30e                       ; 0045c303 | LAB_0045c30e
        ;   XREF to: 0045c30e (CONDITIONAL_JUMP)
    CMP byte ptr [0x02d03eb5],0x0       ; 0045c305 | CHAR_ARRAY_02d03eb5
    JNZ 0x0045c310                      ; 0045c30c | LAB_0045c310
        ;   XREF to: 0045c310 (CONDITIONAL_JUMP)
    JMP 0x0045c31e                      ; 0045c30e | LAB_0045c31e
        ;   Label: LAB_0045c30e
        ;   XREF to: 0045c31e (UNCONDITIONAL_JUMP)
    MOV byte ptr [0x02d03ec7],0x0       ; 0045c310 | CHAR_ARRAY_02d03ec7
        ;   Label: LAB_0045c310
    XOR byte ptr [0x015c4830],0x1       ; 0045c317 | int g_PolygonVertexDisplayEnabled
    CMP dword ptr [0x015c4830],0x0      ; 0045c31e | int g_PolygonVertexDisplayEnabled
        ;   Label: LAB_0045c31e
    JNZ 0x0045c32c                      ; 0045c325 | LAB_0045c32c
        ;   XREF to: 0045c32c (CONDITIONAL_JUMP)
    JMP 0x0045c4df                      ; 0045c327 | LAB_0045c4df
        ;   XREF to: 0045c4df (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBP + 0x14],0x0      ; 0045c32c
        ;   Label: LAB_0045c32c
    JL 0x0045c33d                       ; 0045c330 | LAB_0045c33d
        ;   XREF to: 0045c33d (CONDITIONAL_JUMP)
    MOV EAX,[0x016e990c]                ; 0045c332 | int g_PolygonCount
    DEC EAX                             ; 0045c337
    CMP EAX,dword ptr [EBP + 0x14]      ; 0045c338
    JGE 0x0045c342                      ; 0045c33b | LAB_0045c342
        ;   XREF to: 0045c342 (CONDITIONAL_JUMP)
    JMP 0x0045c4df                      ; 0045c33d | LAB_0045c4df
        ;   Label: LAB_0045c33d
        ;   XREF to: 0045c4df (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x10],0x0     ; 0045c342
        ;   Label: LAB_0045c342
    JMP 0x0045c351                      ; 0045c349 | LAB_0045c351
    ...
    JGE 0x0045c3d8                      ; 0045c361 | LAB_0045c3d8
    ...
    FLD float ptr [EAX + 0x162640c]     ; 0045c37f | SVertexData[20000] g_LoadedVertices
    FMUL float ptr [0x0061b31e]         ; 0045c385 | float g_PolygonVertexDisplayScale
    CALL crt_math.c_round_FUN_005fe6b0  ; 0045c38b | double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    FMUL float ptr [0x0061b31e]         ; 0045c39d | float g_PolygonVertexDisplayScale
    CALL crt_math.c_round_FUN_005fe6b0  ; 0045c3a3 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    FMUL float ptr [0x0061b31e]         ; 0045c3b5 | float g_PolygonVertexDisplayScale
    CALL crt_math.c_round_FUN_005fe6b0  ; 0045c3bb | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0045c3ca
    CALL engine_matrix.c_transformToCache_FUN_0050cd70 ; 0045c3cb | void engine_matrix.c_transformToCache_FUN_0050cd70(int cacheIndex, CVector3i * inputPoint)
        ;   XREF to: 0050cd70 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0045c3d0
    JMP 0x0045c34b                      ; 0045c3d3 | LAB_0045c34b
        ;   XREF to: 0045c34b (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x10],0x0     ; 0045c3d8
        ;   Label: LAB_0045c3d8
    JMP 0x0045c3e7                      ; 0045c3df | LAB_0045c3e7
    ...
    JGE 0x0045c4df                      ; 0045c3f7 | LAB_0045c4df
        ;   XREF to: 0045c4df (CONDITIONAL_JUMP)
    MOV dword ptr [0x02d02570],0x7      ; 0045c3fd | int g_ActiveRenderColor
    ...
    JZ 0x0045c439                       ; 0045c432 | LAB_0045c439
        ;   XREF to: 0045c439 (CONDITIONAL_JUMP)
    JMP 0x0045c4da                      ; 0045c434 | LAB_0045c4da
        ;   XREF to: 0045c4da (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + -0xc]      ; 0045c439
        ;   Label: LAB_0045c439
    CMP EAX,dword ptr [0x00679394]      ; 0045c43c | int g_WindowWidth
    JNC 0x0045c44f                      ; 0045c442 | LAB_0045c44f
        ;   XREF to: 0045c44f (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + -0x8]      ; 0045c444
    CMP EAX,dword ptr [0x00679398]      ; 0045c447 | int g_WindowHeight
    JC 0x0045c451                       ; 0045c44d | LAB_0045c451
        ;   XREF to: 0045c451 (CONDITIONAL_JUMP)
    JMP 0x0045c45e                      ; 0045c44f | LAB_0045c45e
        ;   Label: LAB_0045c44f
    ...
    JG 0x0045c460                       ; 0045c45c | LAB_0045c460
        ;   XREF to: 0045c460 (CONDITIONAL_JUMP)
    JMP 0x0045c470                      ; 0045c45e | LAB_0045c470
        ;   Label: LAB_0045c45e
    ...
    PUSH EAX                            ; 0045c467
    CALL engine_2d.c_plotPixel_FUN_00401140 ; 0045c468 | void engine_2d.c_plotPixel_FUN_00401140(int x, int y)
        ;   XREF to: 00401140 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0045c46d
    MOV EAX,dword ptr [EBP + -0xc]      ; 0045c470
        ;   Label: LAB_0045c470
    ADD EAX,0x8                         ; 0045c473
    CMP EAX,dword ptr [0x00679394]      ; 0045c476 | int g_WindowWidth
    JNC 0x0045c48c                      ; 0045c47c | LAB_0045c48c
        ;   XREF to: 0045c48c (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + -0x8]      ; 0045c47e
    ADD EAX,0xc                         ; 0045c481
    CMP EAX,dword ptr [0x00679398]      ; 0045c484 | int g_WindowHeight
    JC 0x0045c48e                       ; 0045c48a | LAB_0045c48e
        ;   XREF to: 0045c48e (CONDITIONAL_JUMP)
    JMP 0x0045c49b                      ; 0045c48c | LAB_0045c49b
        ;   Label: LAB_0045c48c
    ...
    JG 0x0045c49d                       ; 0045c499 | LAB_0045c49d
        ;   XREF to: 0045c49d (CONDITIONAL_JUMP)
    JMP 0x0045c4da                      ; 0045c49b | LAB_0045c4da
        ;   Label: LAB_0045c49b
        ;   XREF to: 0045c4da (UNCONDITIONAL_JUMP)
    ...
    MOV EAX,0x61b322                    ; 0045c4b2 | = "%d" | s_d_0061b322 = %d
    PUSH EAX                            ; 0045c4b7 | = "%d" | s_d_0061b322 = %d
    LEA EAX,[EBP + -0x6c]               ; 0045c4b8
    PUSH EAX                            ; 0045c4bb
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0045c4bc | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH EAX                            ; 0045c4d1
    CALL engine_2d.c_drawTextColor_FUN_00402430 ; 0045c4d2 | void engine_2d.c_drawTextColor_FUN_00402430(char * text, int x_pos, int y_pos)
        ;   XREF to: 00402430 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0045c4d7
    JMP 0x0045c3e1                      ; 0045c4da | LAB_0045c3e1
        ;   Label: LAB_0045c4da
