...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_design.c_configureSpatialSplittingPlane_FUN_004617c0(STreeNode * node)
;
; Parameters:
...
section .text
    ...
    MOV EAX,0x61bf06                    ; 004617cc | = "Connecting part : " | s_Connecting_part_0061bf06 = Connecting part :
    PUSH EAX                            ; 004617d1 | = "Connecting part : " | s_Connecting_part_0061bf06 = Connecting part :
    PUSH 0x0                            ; 004617d2
    PUSH 0x0                            ; 004617d4
    PUSH 0x13                           ; 004617d6
    LEA EAX,[EBP + -0x80]               ; 004617d8
    PUSH EAX                            ; 004617db
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 004617dc | int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
        ;   XREF to: 004032c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 004617e1
    MOV dword ptr [EBP + -0x18],0x0     ; 004617e4
    JMP 0x004617f3                      ; 004617eb | LAB_004617f3
    ...
    JBE 0x00461823                      ; 00461803 | LAB_00461823
    ...
    PUSH EAX                            ; 00461811
    CALL crt_ctype.c_toupper_FUN_005ff9e0 ; 00461812 | int crt_ctype.c_toupper_FUN_005ff9e0(int c)
    ...
    MOV EAX,dword ptr [EBP + -0x18]     ; 00461839
        ;   Label: LAB_00461839
    CMP EAX,dword ptr [0x01e528a0]      ; 0046183c | int g_PartsCount
    JGE 0x0046186a                      ; 00461842 | LAB_0046186a
        ;   XREF to: 0046186a (CONDITIONAL_JUMP)
    IMUL EDX,dword ptr [EBP + -0x18],0x14 ; 00461844
    MOV EAX,0x1e50190                   ; 00461848 | SModelPartName[500] g_ModelPartNames
    ADD EAX,EDX                         ; 0046184d
    PUSH EAX                            ; 0046184f
    LEA EAX,[EBP + -0x80]               ; 00461850
    PUSH EAX                            ; 00461853
    CALL crt_string.c_strcmp_FUN_005fef20 ; 00461854 | int crt_string.c_strcmp_FUN_005fef20(char * str1, char * str2)
        ;   XREF to: 005fef20 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00461859
    TEST EAX,EAX                        ; 0046185c
    JNZ 0x00461868                      ; 0046185e | LAB_00461868
        ;   XREF to: 00461868 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + -0x18]     ; 00461860
    MOV dword ptr [EBP + -0x8],EAX      ; 00461863
    JMP 0x0046186a                      ; 00461866 | LAB_0046186a
        ;   XREF to: 0046186a (UNCONDITIONAL_JUMP)
    JMP 0x00461833                      ; 00461868 | LAB_00461833
        ;   Label: LAB_00461868
        ;   XREF to: 00461833 (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0x8],-0x1     ; 0046186a
        ;   Label: LAB_0046186a
    JZ 0x00461a93                       ; 0046186e | LAB_00461a93
        ;   XREF to: 00461a93 (CONDITIONAL_JUMP)
    PUSH 0xb                            ; 00461874
    PUSH 0x0                            ; 00461876
    MOV EAX,0x61bf19                    ; 00461878 | = "Separation Method : (P)oint list (X) ..." | s_Separation_Method_P_oint_0061bf19 = Separation Method : (P)oint list (X) (Y) (Z)
    PUSH EAX                            ; 0046187d | = "Separation Method : (P)oint list (X) ..." | s_Separation_Method_P_oint_0061bf19 = Separation Method : (P)oint list (X) (Y) (Z)
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 0046187e | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00461883
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 00461886 | void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20()
        ;   XREF to: 005eda20 (UNCONDITIONAL_CALL)
    CALL wincore_winrun.cpp_getNextKeypress_FUN_005f2e90 ; 0046188b | int wincore_winrun.cpp_getNextKeypress_FUN_005f2e90()
        ;   XREF to: 005f2e90 (UNCONDITIONAL_CALL)
    AND EAX,0xff                        ; 00461890
    PUSH EAX                            ; 00461895
    CALL crt_ctype.c_toupper_FUN_005ff9e0 ; 00461896 | int crt_ctype.c_toupper_FUN_005ff9e0(int c)
        ;   XREF to: 005ff9e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0046189b
    MOV dword ptr [EBP + -0x18],EAX     ; 0046189e
    CMP dword ptr [EBP + -0x18],0x50    ; 004618a1
    JNZ 0x0046193e                      ; 004618a5 | LAB_0046193e
        ;   XREF to: 0046193e (CONDITIONAL_JUMP)
    MOV EAX,0x61bf46                    ; 004618ab | = "Enter in 3 points : " | s_Enter_in_3_points_0061bf46 = Enter in 3 points :
    PUSH EAX                            ; 004618b0 | = "Enter in 3 points : " | s_Enter_in_3_points_0061bf46 = Enter in 3 points :
    PUSH 0x16                           ; 004618b1
    PUSH 0x0                            ; 004618b3
    PUSH 0x46                           ; 004618b5
    LEA EAX,[EBP + -0x80]               ; 004618b7
    PUSH EAX                            ; 004618ba
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 004618bb | int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
        ;   XREF to: 004032c0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 004618ce
    MOV EAX,0x61bf5b                    ; 004618cf | = "%d,%d,%d" | s_d_d_d_0061bf5b = %d,%d,%d
    PUSH EAX                            ; 004618d4 | = "%d,%d,%d" | s_d_d_d_0061bf5b = %d,%d,%d
    LEA EAX,[EBP + -0x80]               ; 004618d5
    PUSH EAX                            ; 004618d8
    CALL crt_stdio.c_sscanf_FUN_0060013c ; 004618d9 | int crt_stdio.c_sscanf_FUN_0060013c(char * str, char * format)
    ...
    PUSH EAX                            ; 0046190c
    CALL shape_design.c_calculatePolygonNormal_FUN_0045caa0 ; 0046190d | void shape_design.c_calculatePolygonNormal_FUN_0045caa0(SShapeEditorPolygon * polygon)
    ...
    JMP 0x004619f5                      ; 00461939 | LAB_004619f5
        ;   XREF to: 004619f5 (UNCONDITIONAL_JUMP)
    MOV EAX,0x61bf64                    ; 0046193e | = "Enter in point number : " | s_Enter_in_point_number_0061bf64 = Enter in point number :
        ;   Label: LAB_0046193e
    PUSH EAX                            ; 00461943 | = "Enter in point number : " | s_Enter_in_point_number_0061bf64 = Enter in point number :
    PUSH 0x16                           ; 00461944
    PUSH 0x0                            ; 00461946
    PUSH 0x28                           ; 00461948
    LEA EAX,[EBP + -0x80]               ; 0046194a
    PUSH EAX                            ; 0046194d
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 0046194e | int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
        ;   XREF to: 004032c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 00461953
    LEA EAX,[EBP + -0x80]               ; 00461956
    PUSH EAX                            ; 00461959
    CALL crt_stdlib.c_atoi_FUN_005ffef0 ; 0046195a | int crt_stdlib.c_atoi_FUN_005ffef0(char * string_ptr)
    ...
    JMP 0x004619f5                      ; 004619b3 | LAB_004619f5
        ;   XREF to: 004619f5 (UNCONDITIONAL_JUMP)
    ...
    JMP 0x004619f5                      ; 004619c9 | LAB_004619f5
        ;   XREF to: 004619f5 (UNCONDITIONAL_JUMP)
    JMP 0x004619f5                      ; 004619cb | LAB_004619f5
        ;   Label: LAB_004619cb
        ;   XREF to: 004619f5 (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBP + 0xfffffdf8],0x59 ; 004619cd
        ;   Label: LAB_004619cd
    JC 0x004619ea                       ; 004619d4 | LAB_004619ea
        ;   XREF to: 004619ea (CONDITIONAL_JUMP)
    CMP dword ptr [EBP + 0xfffffdf8],0x59 ; 004619d6
    JBE 0x0046199f                      ; 004619dd | LAB_0046199f
        ;   XREF to: 0046199f (CONDITIONAL_JUMP)
    CMP dword ptr [EBP + 0xfffffdf8],0x5a ; 004619df
    JZ 0x004619b5                       ; 004619e6 | LAB_004619b5
        ;   XREF to: 004619b5 (CONDITIONAL_JUMP)
    JMP 0x004619cb                      ; 004619e8 | LAB_004619cb
        ;   XREF to: 004619cb (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBP + 0xfffffdf8],0x58 ; 004619ea
        ;   Label: LAB_004619ea
    JZ 0x00461989                       ; 004619f1 | LAB_00461989
        ;   XREF to: 00461989 (CONDITIONAL_JUMP)
    JMP 0x004619cb                      ; 004619f3 | LAB_004619cb
        ;   XREF to: 004619cb (UNCONDITIONAL_JUMP)
    CALL shape_design.c_allocateSpatialTreeNode_FUN_00457ed0 ; 004619f5 | STreeNode * shape_design.c_allocateSpatialTreeNode_FUN_00457ed0()
        ;   Label: LAB_004619f5
    ...
    CALL shape_design.c_allocateSpatialTreeNode_FUN_00457ed0 ; 00461a26 | STreeNode * shape_design.c_allocateSpatialTreeNode_FUN_00457ed0()
        ;   XREF to: 00457ed0 (UNCONDITIONAL_CALL)
