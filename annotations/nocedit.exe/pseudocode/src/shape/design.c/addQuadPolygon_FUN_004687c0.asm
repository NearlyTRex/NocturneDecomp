...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl shape_design_c_addQuadPolygon_FUN_004687c0 (int vertex_index_0,int vertex_index_1,int vertex_index_2,int vertex_index_3)
;
; Parameters:
...
section .text
    ...
    MOV dword ptr [EDX + 0xb8],EAX      ; 00468817 | DAT_016e99c8
    MOV EAX,dword ptr [EBP + 0x18]      ; 0046881d
    MOV EDX,dword ptr [EBP + -0x4]      ; 00468820
    MOV dword ptr [EDX + 0xbc],EAX      ; 00468823 | DAT_016e99cc
    MOV EAX,dword ptr [EBP + 0x1c]      ; 00468829
    MOV EDX,dword ptr [EBP + -0x4]      ; 0046882c
    MOV dword ptr [EDX + 0xc0],EAX      ; 0046882f | DAT_016e99d0
