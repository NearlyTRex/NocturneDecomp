...
section .text
    ...
    CALL wincore_windll.cpp_clearScreen_FUN_005b3e70 ; 00467f3c | void wincore_windll.cpp_clearScreen_FUN_005b3e70()
        ;   XREF to: 005b3e70 (UNCONDITIONAL_CALL)
    MOV ECX,0x61cbba                    ; 00467f41 | = "Enter X,Y,Z scales : " | s_Enter_X_Y_Z_scales_0061cbba = Enter X,Y,Z scales :
    PUSH ECX                            ; 00467f46 | = "Enter X,Y,Z scales : " | s_Enter_X_Y_Z_scales_0061cbba = Enter X,Y,Z scales :
    PUSH 0x0                            ; 00467f47
    PUSH 0x0                            ; 00467f49
    PUSH 0x32                           ; 00467f4b
    LEA ECX,[EBP + -0x60]               ; 00467f4d
    PUSH ECX                            ; 00467f50
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 00467f51 | int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
    ...
    JNZ 0x00467f6f                      ; 00467f68 | LAB_00467f6f
        ;   XREF to: 00467f6f (CONDITIONAL_JUMP)
    JMP 0x00467fed                      ; 00467f6a | LAB_00467fed
    ...
    PUSH EAX                            ; 00467f7a
    MOV EAX,0x61cbd0                    ; 00467f7b | = "%f,%f,%f" | s_f_f_f_0061cbd0 = %f,%f,%f
    PUSH EAX                            ; 00467f80 | = "%f,%f,%f" | s_f_f_f_0061cbd0 = %f,%f,%f
    LEA EAX,[EBP + -0x60]               ; 00467f81
    PUSH EAX                            ; 00467f84
    CALL crt_stdio.c_sscanf_FUN_0060013c ; 00467f85 | int crt_stdio.c_sscanf_FUN_0060013c(char * str, char * format)
    ...
    JZ 0x00467f98                       ; 00467f94 | LAB_00467f98
        ;   XREF to: 00467f98 (CONDITIONAL_JUMP)
    JMP 0x00467fed                      ; 00467f96 | LAB_00467fed
        ;   XREF to: 00467fed (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x10],0x0     ; 00467f98
        ;   Label: LAB_00467f98
    JMP 0x00467fa7                      ; 00467f9f | LAB_00467fa7
    ...
    MOV EAX,dword ptr [EBP + -0x10]     ; 00467fa7
        ;   Label: LAB_00467fa7
    CMP EAX,dword ptr [0x01626408]      ; 00467faa | int g_VertexCount
    JGE 0x00467fed                      ; 00467fb0 | LAB_00467fed
        ;   XREF to: 00467fed (CONDITIONAL_JUMP)
    IMUL EAX,dword ptr [EBP + -0x10],0x14 ; 00467fb2
    FLD float ptr [EAX + 0x162640c]     ; 00467fb6 | SVertexData[20000] g_LoadedVertices
    FMUL float ptr [EBP + -0xc]         ; 00467fbc
    FSTP float ptr [EAX + 0x162640c]    ; 00467fbf | SVertexData[20000] g_LoadedVertices
    IMUL EAX,dword ptr [EBP + -0x10],0x14 ; 00467fc5
    FLD float ptr [EAX + 0x1626410]     ; 00467fc9 | DAT_01626410
    FMUL float ptr [EBP + -0x8]         ; 00467fcf
    FSTP float ptr [EAX + 0x1626410]    ; 00467fd2 | DAT_01626410
    ...
    JMP 0x00467fa1                      ; 00467feb | LAB_00467fa1
