...
section .text
    ...
    CMP dword ptr [0x016e990c],0x0      ; 0046625c | int g_PolygonCount
    JNZ 0x00466271                      ; 00466263 | LAB_00466271
        ;   XREF to: 00466271 (CONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x40],0xffffffff ; 00466265
    JMP 0x00466603                      ; 0046626c | LAB_00466603
        ;   XREF to: 00466603 (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x3c],0x0     ; 00466271
        ;   Label: LAB_00466271
    JMP 0x00466280                      ; 00466278 | LAB_00466280
    ...
    MOV EAX,dword ptr [EBP + -0x3c]     ; 00466280
        ;   Label: LAB_00466280
    CMP EAX,dword ptr [0x01626408]      ; 00466283 | int g_VertexCount
    JGE 0x004662f1                      ; 00466289 | LAB_004662f1
        ;   XREF to: 004662f1 (CONDITIONAL_JUMP)
    IMUL EAX,dword ptr [EBP + -0x3c],0x14 ; 0046628b
    FLD float ptr [EAX + 0x162640c]     ; 0046628f | SVertexData[20000] g_LoadedVertices
    FMUL float ptr [0x0061c70a]         ; 00466295 | float g_MouseWorldToScreenScale
    CALL crt_math.c_round_FUN_005fe6b0  ; 0046629b | double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    FMUL float ptr [0x0061c70a]         ; 004662b0 | float g_MouseWorldToScreenScale
    CALL crt_math.c_round_FUN_005fe6b0  ; 004662b6 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    FMUL float ptr [0x0061c70a]         ; 004662cb | float g_MouseWorldToScreenScale
    CALL crt_math.c_round_FUN_005fe6b0  ; 004662d1 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 004662e6
    CALL engine_matrix.c_transformToCache_FUN_0050cd70 ; 004662e7 | void engine_matrix.c_transformToCache_FUN_0050cd70(int cacheIndex, CVector3i * inputPoint)
        ;   XREF to: 0050cd70 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004662ec
    JMP 0x0046627a                      ; 004662ef | LAB_0046627a
        ;   XREF to: 0046627a (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x3c],0x0     ; 004662f1
        ;   Label: LAB_004662f1
    JMP 0x00466300                      ; 004662f8 | LAB_00466300
    ...
    MOV EAX,dword ptr [EBP + -0x3c]     ; 00466300
        ;   Label: LAB_00466300
    CMP EAX,dword ptr [0x016e990c]      ; 00466303 | int g_PolygonCount
    JGE 0x0046646f                      ; 00466309 | LAB_0046646f
    ...
    JMP 0x0046632b                      ; 00466323 | LAB_0046632b
    ...
    JGE 0x00466365                      ; 0046633b | LAB_00466365
    ...
    JGE 0x004663de                      ; 004663b8 | LAB_004663de
    ...
    JMP 0x004663a2                      ; 004663dc | LAB_004663a2
    ...
    MOV dword ptr [ECX + 0x15c48c4],EAX ; 004663f8 | SPolygonScreenData[20000] g_PolygonScreenCache
    MOV dword ptr [EBP + -0x20],0x0     ; 004663fe
    MOV dword ptr [EBP + -0x2c],0x0     ; 00466405
    JMP 0x00466414                      ; 0046640c | LAB_00466414
    ...
    JGE 0x0046644a                      ; 00466424 | LAB_0046644a
    ...
    JMP 0x0046640e                      ; 00466448 | LAB_0046640e
    ...
    JMP 0x004662fa                      ; 0046646a | LAB_004662fa
        ;   Label: LAB_0046646a
    ...
    JMP 0x0046649e                      ; 00466496 | LAB_0046649e
    ...
    MOV EAX,dword ptr [EBP + -0x3c]     ; 0046649e
        ;   Label: LAB_0046649e
    CMP EAX,dword ptr [0x016e990c]      ; 004664a1 | int g_PolygonCount
    JGE 0x004665af                      ; 004664a7 | LAB_004665af
    ...
    MOV EAX,[0x02cf6a8c]                ; 004664b7 | int g_MouseX
    SUB EAX,dword ptr [EDX + 0x15c48c4] ; 004664bc | SPolygonScreenData[20000] g_PolygonScreenCache
    MOV dword ptr [EBP + -0x34],EAX     ; 004664c2
    IMUL EDX,dword ptr [EBP + -0x3c],0x14 ; 004664c5
    MOV EAX,[0x02cf6a90]                ; 004664c9 | int g_MouseY
    ...
    FMUL float ptr [0x0061c70e]         ; 004664f7 | float g_MouseNormalToFixedPoint
    CALL crt_math.c_round_FUN_005fe6b0  ; 004664fd | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    FMUL float ptr [0x0061c70e]         ; 00466515 | float g_MouseNormalToFixedPoint
    CALL crt_math.c_round_FUN_005fe6b0  ; 0046651b | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    FMUL float ptr [0x0061c70e]         ; 00466533 | float g_MouseNormalToFixedPoint
    CALL crt_math.c_round_FUN_005fe6b0  ; 00466539 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    FMUL float ptr [0x0061c70e]         ; 00466551 | float g_MouseNormalToFixedPoint
    FMUL float ptr [0x0061c712]         ; 00466557 | float g_MousePlaneDistanceScale
    CALL crt_math.c_round_FUN_005fe6b0  ; 0046655d | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [EBP + 0xffffff2c]  ; 00466562
    MOV EAX,dword ptr [EBP + -0x8]      ; 00466568
    CMP EAX,dword ptr [EBP + -0x4]      ; 0046656b
    JGE 0x00466583                      ; 0046656e | LAB_00466583
        ;   XREF to: 00466583 (CONDITIONAL_JUMP)
    LEA EAX,[EBP + 0xffffff20]          ; 00466570
    PUSH EAX                            ; 00466576
    CALL engine_3d.c_isVisiblePlane_FUN_00403950 ; 00466577 | int engine_3d.c_isVisiblePlane_FUN_00403950(SClipPlane * plane)
        ;   XREF to: 00403950 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0046657c
    TEST EAX,EAX                        ; 0046657f
    JNZ 0x00466585                      ; 00466581 | LAB_00466585
        ;   XREF to: 00466585 (CONDITIONAL_JUMP)
    JMP 0x004665aa                      ; 00466583 | LAB_004665aa
        ;   Label: LAB_00466583
    ...
    JMP 0x00466498                      ; 004665aa | LAB_00466498
        ;   Label: LAB_004665aa
    ...
    PUSH dword ptr [0x02cf6a90]         ; 004665c2 | int g_MouseY
    PUSH dword ptr [0x02cf6a8c]         ; 004665c8 | int g_MouseX
    MOV EAX,0x61c716                    ; 004665ce | = "mX: %d  mY: %d" | s_mX_d_mY_d_0061c716 = mX: %d  mY: %d
    PUSH EAX                            ; 004665d3 | = "mX: %d  mY: %d" | s_mX_d_mY_d_0061c716 = mX: %d  mY: %d
    LEA EAX,[EBP + 0xffffff70]          ; 004665d4
    PUSH EAX                            ; 004665da
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 004665db | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004665e0
    MOV EAX,[0x00679398]                ; 004665e3 | int g_WindowHeight
    SUB EAX,0x37                        ; 004665e8
    PUSH EAX                            ; 004665eb
    PUSH 0x0                            ; 004665ec
    LEA EAX,[EBP + 0xffffff70]          ; 004665ee
    PUSH EAX                            ; 004665f4
    CALL engine_2d.c_drawTextColor_FUN_00402430 ; 004665f5 | void engine_2d.c_drawTextColor_FUN_00402430(char * text, int x_pos, int y_pos)
