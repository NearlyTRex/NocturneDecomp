...

{
  ...
  g_ModelPolygonData[iVar1].uv_u[0] = g_LoadedVertices[vertex_index_1].u * (float)256;
  g_ModelPolygonData[iVar1].uv_v[0] = g_LoadedVertices[vertex_index_1].v * (float)256;
  g_ModelPolygonData[iVar1].uv_u[1] = g_LoadedVertices[vertex_index_2].u * (float)256;
  g_ModelPolygonData[iVar1].uv_v[1] = g_LoadedVertices[vertex_index_2].v * (float)256;
  g_ModelPolygonData[iVar1].uv_u[2] = g_LoadedVertices[vertex_index_3].u * (float)256;
  g_ModelPolygonData[iVar1].uv_v[2] = g_LoadedVertices[vertex_index_3].v * (float)256;
  g_ModelPolygonData[iVar1].uv_u[3] = g_LoadedVertices[vertex_index_4].u * (float)256;
  g_ModelPolygonData[iVar1].uv_v[3] = g_LoadedVertices[vertex_index_4].v * (float)256;
