  ...
  if (iVar2 == 1) {
    ...
    iVar2 = crt_stdio_c_fscanf_FUN_005fe7c0
                      (local_34,"%d,%d,%d,%d,%d,%d,%d\n",local_30 + 2,&g_PolygonCount,&g_VertexCount
                       ,&g_PartsCount,local_24,local_20);
    if (iVar2 == 7) {
      ...
      if (0 < local_30[2]) {
        ...
        for (local_40 = 0; (int)local_40 < local_30[2]; local_40 = local_40 + 1) {
          pcVar5 = crt_stdio_c_fgets_FUN_005fefd0((char *)&local_9e0,0x104,local_34);
          if (pcVar5 == (char *)0x0) goto LAB_00459478;
          pcVar5 = (char *)&local_9e0;
          do {
            pcVar4 = pcVar5;
            if (*pcVar5 == '\n') goto LAB_0045976f;
            if (*pcVar5 == '\0') break;
...
LAB_00459796:
          ...
          crt_string_c_splitpath_FUN_005ff178
                    ((char *)&local_9e0,(char *)0x0,(char *)0x0,
      ...
      for (local_40 = 0; (int)local_40 < g_PartsCount; local_40 = local_40 + 1) {
        for (local_18 = 0; local_18 < local_8d8[local_40]; local_18 = local_18 + 1) {
          ...
          if ((int)puVar8 < 0) {
            ...
            pcVar3 = (char *)((int)puVar8 * 0x50 + (int)local_38);
            pcVar5 = local_14->lightmap_name;
            do {
              cVar1 = *pcVar3;
              *pcVar5 = cVar1;
              if (cVar1 == '\0') break;
            ...
            pcVar4 = (char *)((int)puVar8 * 0x50 + (int)local_38);
            pcVar3 = local_14->texture_name;
            pcVar5 = pcVar3;
            do {
              cVar1 = *pcVar4;
              *pcVar5 = cVar1;
