...
// Convention: __cdecl
// Signature: void __cdecl shape_design_c_sizeModelToYFeet_FUN_00467010(void)
...

{
  ...
  engine_2d_c_getInputWithPrompt_FUN_004032c0
            (local_7c,0x14,0,0x16,"Enter Y distance in feet (,min,max for user-defined min/max points) : ");
  iVar3 = -1;
  pcVar4 = local_7c;
  do {
    if (iVar3 == 0) break;
