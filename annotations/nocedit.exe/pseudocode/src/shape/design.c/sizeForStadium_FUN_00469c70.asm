...
;
; Local Variables:
; char[160]        Stack[-0xe8]:160  local_e8
...
section .text
    ...
    PUSH ECX                            ; 00469c93
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 00469c94
    ...
    JNZ 0x00469cb5                      ; 00469cae
        ;   XREF to: 00469cb5 (CONDITIONAL_JUMP)  ; LAB_00469cb5
    JMP 0x00469ed7                      ; 00469cb0
        ;   XREF to: 00469ed7 (UNCONDITIONAL_JUMP)  ; LAB_00469ed7
    LEA EAX,[EBP + 0xffffff28]          ; 00469cb5
        ;   Label: LAB_00469cb5
    PUSH EAX                            ; 00469cbb
    CALL crt_stdlib.c_atoi_FUN_005ffef0 ; 00469cbc
    ...
    MOV EAX,0x61d0c1                    ; 00469cc7 | = "Enter in Z point : "
    PUSH EAX                            ; 00469ccc | = "Enter in Z point : "
    PUSH 0xb                            ; 00469ccd
    PUSH 0x0                            ; 00469ccf
    PUSH 0x14                           ; 00469cd1
    LEA EAX,[EBP + 0xffffff28]          ; 00469cd3
    PUSH EAX                            ; 00469cd9
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 00469cda
        ;   XREF to: 004032c0 (UNCONDITIONAL_CALL)  ; int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
    ...
    JNZ 0x00469cfb                      ; 00469cf4
        ;   XREF to: 00469cfb (CONDITIONAL_JUMP)  ; LAB_00469cfb
    JMP 0x00469ed7                      ; 00469cf6
        ;   XREF to: 00469ed7 (UNCONDITIONAL_JUMP)  ; LAB_00469ed7
    LEA EAX,[EBP + 0xffffff28]          ; 00469cfb
        ;   Label: LAB_00469cfb
    PUSH EAX                            ; 00469d01
    CALL crt_stdlib.c_atoi_FUN_005ffef0 ; 00469d02
        ;   XREF to: 005ffef0 (UNCONDITIONAL_CALL)  ; int crt_stdlib.c_atoi_FUN_005ffef0(char * string_ptr)
    ADD ESP,0x4                         ; 00469d07
    MOV dword ptr [EBP + -0xc],EAX      ; 00469d0a
    MOV EAX,0x61d0d5                    ; 00469d0d | = "Enter in X size : "
    PUSH EAX                            ; 00469d12 | = "Enter in X size : "
    PUSH 0x16                           ; 00469d13
    PUSH 0x0                            ; 00469d15
    PUSH 0x14                           ; 00469d17
    LEA EAX,[EBP + 0xffffff28]          ; 00469d19
    PUSH EAX                            ; 00469d1f
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 00469d20
        ;   XREF to: 004032c0 (UNCONDITIONAL_CALL)  ; int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
    ...
    JNZ 0x00469d41                      ; 00469d3a
        ;   XREF to: 00469d41 (CONDITIONAL_JUMP)  ; LAB_00469d41
    JMP 0x00469ed7                      ; 00469d3c
        ;   XREF to: 00469ed7 (UNCONDITIONAL_JUMP)  ; LAB_00469ed7
    ...
    MOV ECX,0x61d0e8                    ; 00469d65 | = "Enter in Z size : "
    PUSH ECX                            ; 00469d6a | = "Enter in Z size : "
    PUSH 0x21                           ; 00469d6b
    PUSH 0x0                            ; 00469d6d
    PUSH 0x14                           ; 00469d6f
    LEA ECX,[EBP + 0xffffff28]          ; 00469d71
    PUSH ECX                            ; 00469d77
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 00469d78
        ;   XREF to: 004032c0 (UNCONDITIONAL_CALL)  ; int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
    ...
    JNZ 0x00469d99                      ; 00469d92
        ;   XREF to: 00469d99 (CONDITIONAL_JUMP)  ; LAB_00469d99
    JMP 0x00469ed7                      ; 00469d94
        ;   XREF to: 00469ed7 (UNCONDITIONAL_JUMP)  ; LAB_00469ed7
    ...
    JMP 0x00469de8                      ; 00469de0
        ;   XREF to: 00469de8 (UNCONDITIONAL_JUMP)  ; LAB_00469de8
    MOV EAX,dword ptr [EBP + -0x38]     ; 00469de2
        ;   Label: LAB_00469de2
    INC dword ptr [EBP + -0x38]         ; 00469de5
    MOV EAX,dword ptr [EBP + -0x38]     ; 00469de8
        ;   Label: LAB_00469de8
    CMP EAX,dword ptr [0x01626408]      ; 00469deb | g_VertexCount
    JGE 0x00469e53                      ; 00469df1
        ;   XREF to: 00469e53 (CONDITIONAL_JUMP)  ; LAB_00469e53
    IMUL EAX,dword ptr [EBP + -0x38],0x14 ; 00469df3
    MOV EAX,dword ptr [EAX + 0x162640c] ; 00469df7 | g_LoadedVertices
    MOV dword ptr [EBP + -0x24],EAX     ; 00469dfd
    FLD float ptr [EBP + -0x24]         ; 00469e00
    FCOMP float ptr [EBP + -0x30]       ; 00469e03
    FNSTSW AX                           ; 00469e06
    SAHF                                ; 00469e08
    JBE 0x00469e11                      ; 00469e09
        ;   XREF to: 00469e11 (CONDITIONAL_JUMP)  ; LAB_00469e11
    ...
    FNSTSW AX                           ; 00469e17
    SAHF                                ; 00469e19
    JNC 0x00469e22                      ; 00469e1a
        ;   XREF to: 00469e22 (CONDITIONAL_JUMP)  ; LAB_00469e22
    ...
    FNSTSW AX                           ; 00469e35
    SAHF                                ; 00469e37
    JBE 0x00469e40                      ; 00469e38
        ;   XREF to: 00469e40 (CONDITIONAL_JUMP)  ; LAB_00469e40
    ...
    FNSTSW AX                           ; 00469e46
    SAHF                                ; 00469e48
    JNC 0x00469e51                      ; 00469e49
        ;   XREF to: 00469e51 (CONDITIONAL_JUMP)  ; LAB_00469e51
    MOV EAX,dword ptr [EBP + -0x20]     ; 00469e4b
    MOV dword ptr [EBP + -0x2c],EAX     ; 00469e4e
    JMP 0x00469de2                      ; 00469e51
        ;   XREF to: 00469de2 (UNCONDITIONAL_JUMP)  ; LAB_00469de2
        ;   Label: LAB_00469e51
    IMUL EAX,dword ptr [EBP + -0x10],0x14 ; 00469e53
        ;   Label: LAB_00469e53
    FLD float ptr [EBP + -0x8]          ; 00469e57
    FDIV float ptr [EAX + 0x162640c]    ; 00469e5a | g_LoadedVertices
    ...
    FMUL double ptr [0x0061d0fe]        ; 00469e79 | g_YAxisScaleModifier
    FSTP float ptr [EBP + -0x14]        ; 00469e7f
    MOV dword ptr [EBP + -0x38],0x0     ; 00469e82
    JMP 0x00469e91                      ; 00469e89
        ;   XREF to: 00469e91 (UNCONDITIONAL_JUMP)  ; LAB_00469e91
    MOV EAX,dword ptr [EBP + -0x38]     ; 00469e8b
        ;   Label: LAB_00469e8b
    INC dword ptr [EBP + -0x38]         ; 00469e8e
    MOV EAX,dword ptr [EBP + -0x38]     ; 00469e91
        ;   Label: LAB_00469e91
    CMP EAX,dword ptr [0x01626408]      ; 00469e94 | g_VertexCount
    JGE 0x00469ed7                      ; 00469e9a
        ;   XREF to: 00469ed7 (CONDITIONAL_JUMP)  ; LAB_00469ed7
    IMUL EAX,dword ptr [EBP + -0x38],0x14 ; 00469e9c
    FLD float ptr [EAX + 0x162640c]     ; 00469ea0 | g_LoadedVertices
    ...
    JMP 0x00469e8b                      ; 00469ed5
        ;   XREF to: 00469e8b (UNCONDITIONAL_JUMP)  ; LAB_00469e8b
