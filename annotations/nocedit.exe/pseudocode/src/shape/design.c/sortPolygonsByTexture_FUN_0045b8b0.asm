...
section .text
    ...
    MOV EAX,[0x016e990c]                ; 0045b8bc | g_PolygonCount
    DEC EAX                             ; 0045b8c1
    MOV dword ptr [EBP + -0x8],EAX      ; 0045b8c2
    JMP 0x0045b8cb                      ; 0045b8c5
        ;   XREF to: 0045b8cb (UNCONDITIONAL_JUMP)  ; LAB_0045b8cb
    ADD dword ptr [EBP + -0x8],-0x1     ; 0045b8c7
        ;   Label: LAB_0045b8c7
    CMP dword ptr [EBP + -0x8],0x0      ; 0045b8cb
        ;   Label: LAB_0045b8cb
    JL 0x0045b97f                       ; 0045b8cf
        ;   XREF to: 0045b97f (CONDITIONAL_JUMP)  ; LAB_0045b97f
    MOV dword ptr [EBP + -0x4],0x0      ; 0045b8d5
    JMP 0x0045b8e1                      ; 0045b8dc
        ;   XREF to: 0045b8e1 (UNCONDITIONAL_JUMP)  ; LAB_0045b8e1
    INC dword ptr [EBP + -0x4]          ; 0045b8de
        ;   Label: LAB_0045b8de
    MOV EAX,dword ptr [EBP + -0x4]      ; 0045b8e1
        ;   Label: LAB_0045b8e1
    CMP EAX,dword ptr [EBP + -0x8]      ; 0045b8e4
    JGE 0x0045b97a                      ; 0045b8e7
        ;   XREF to: 0045b97a (CONDITIONAL_JUMP)  ; LAB_0045b97a
    MOV EAX,dword ptr [EBP + -0x4]      ; 0045b8ed
    INC EAX                             ; 0045b8f0
    IMUL EAX,EAX,0x184                  ; 0045b8f1
    MOV EDX,0x16e9910                   ; 0045b8f7 | g_ModelPolygonData
    ADD EAX,EDX                         ; 0045b8fc
    PUSH EAX                            ; 0045b8fe
    IMUL EAX,dword ptr [EBP + -0x4],0x184 ; 0045b8ff
    MOV EDX,0x16e9910                   ; 0045b906 | g_ModelPolygonData
    ADD EAX,EDX                         ; 0045b90b
    PUSH EAX                            ; 0045b90d
    CALL shape_design.c_polygonTextureNameComparator_FUN_0045b850 ; 0045b90e
        ;   XREF to: 0045b850 (UNCONDITIONAL_CALL)  ; int shape_design.c_polygonTextureNameComparator_FUN_0045b850(SShapeEditorPolygon * polygon1, SShapeEditorPolygon * polygon2)
    ADD ESP,0x8                         ; 0045b913
    TEST EAX,EAX                        ; 0045b916
    JLE 0x0045b975                      ; 0045b918
        ;   XREF to: 0045b975 (CONDITIONAL_JUMP)  ; LAB_0045b975
    ...
    JMP 0x0045b8de                      ; 0045b975
        ...
        ;   Label: LAB_0045b975
    JMP 0x0045b8c7                      ; 0045b97a
        ;   XREF to: 0045b8c7 (UNCONDITIONAL_JUMP)  ; LAB_0045b8c7
        ;   Label: LAB_0045b97a
