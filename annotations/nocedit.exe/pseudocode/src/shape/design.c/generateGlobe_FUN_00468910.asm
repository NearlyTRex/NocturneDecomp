...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_design.c_generateGlobe_FUN_00468910(void)
;
; Local Variables:
...
section .text
    ...
    MOV dword ptr [0x016e990c],0x0      ; 0046891c | int g_PolygonCount
    MOV dword ptr [0x01626408],0x0      ; 00468926 | int g_VertexCount
    MOV ECX,0x61cdf6                    ; 00468930 | = "Enter in size in heading : " | s_Enter_in_size_in_heading_0061cdf6 = Enter in size in heading :
    PUSH ECX                            ; 00468935 | = "Enter in size in heading : " | s_Enter_in_size_in_heading_0061cdf6 = Enter in size in heading :
    PUSH 0x0                            ; 00468936
    PUSH 0x0                            ; 00468938
    PUSH 0xa                            ; 0046893a
    LEA ECX,[EBP + -0x78]               ; 0046893c
    PUSH ECX                            ; 0046893f
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 00468940 | int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
    ...
    JNZ 0x0046895e                      ; 00468957 | LAB_0046895e
        ;   XREF to: 0046895e (CONDITIONAL_JUMP)
    JMP 0x00468c35                      ; 00468959 | LAB_00468c35
        ;   XREF to: 00468c35 (UNCONDITIONAL_JUMP)
    LEA EAX,[EBP + -0x78]               ; 0046895e
        ;   Label: LAB_0046895e
    PUSH EAX                            ; 00468961
    CALL crt_stdlib.c_atoi_FUN_005ffef0 ; 00468962 | int crt_stdlib.c_atoi_FUN_005ffef0(char * string_ptr)
    ...
    FDIVR double ptr [0x0061ce2e]       ; 00468970 | double g_FullCircleDegrees
    FSTP float ptr [EBP + -0x8]         ; 00468976
    MOV EAX,0x61ce12                    ; 00468979 | = "Enter in size in pitch : " | s_Enter_in_size_in_pitch_0061ce12 = Enter in size in pitch :
    PUSH EAX                            ; 0046897e | = "Enter in size in pitch : " | s_Enter_in_size_in_pitch_0061ce12 = Enter in size in pitch :
    PUSH 0xb                            ; 0046897f
    PUSH 0x0                            ; 00468981
    PUSH 0xa                            ; 00468983
    LEA EAX,[EBP + -0x78]               ; 00468985
    PUSH EAX                            ; 00468988
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 00468989 | int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
        ;   XREF to: 004032c0 (UNCONDITIONAL_CALL)
    ...
    JNZ 0x004689a7                      ; 004689a0 | LAB_004689a7
        ;   XREF to: 004689a7 (CONDITIONAL_JUMP)
    JMP 0x00468c35                      ; 004689a2 | LAB_00468c35
        ;   XREF to: 00468c35 (UNCONDITIONAL_JUMP)
    LEA EAX,[EBP + -0x78]               ; 004689a7
        ;   Label: LAB_004689a7
    PUSH EAX                            ; 004689aa
    CALL crt_stdlib.c_atoi_FUN_005ffef0 ; 004689ab | int crt_stdlib.c_atoi_FUN_005ffef0(char * string_ptr)
        ;   XREF to: 005ffef0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004689b0
    MOV dword ptr [EBP + -0x20],EAX     ; 004689b3
    FILD dword ptr [EBP + -0x20]        ; 004689b6
    FDIVR double ptr [0x0061ce4e]       ; 004689b9 | double g_HalfCircleDegrees
    FSTP float ptr [EBP + -0x4]         ; 004689bf
    MOV EAX,0x61ce36                    ; 004689c2 | = "Enter in radius : " | s_Enter_in_radius_0061ce36 = Enter in radius :
    PUSH EAX                            ; 004689c7 | = "Enter in radius : " | s_Enter_in_radius_0061ce36 = Enter in radius :
    PUSH 0x16                           ; 004689c8
    PUSH 0x0                            ; 004689ca
    PUSH 0xa                            ; 004689cc
    LEA EAX,[EBP + -0x78]               ; 004689ce
    PUSH EAX                            ; 004689d1
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 004689d2 | int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
        ;   XREF to: 004032c0 (UNCONDITIONAL_CALL)
    ...
    JNZ 0x004689f0                      ; 004689e9 | LAB_004689f0
        ;   XREF to: 004689f0 (CONDITIONAL_JUMP)
    JMP 0x00468c35                      ; 004689eb | LAB_00468c35
        ;   XREF to: 00468c35 (UNCONDITIONAL_JUMP)
    LEA EAX,[EBP + -0x78]               ; 004689f0
        ;   Label: LAB_004689f0
    PUSH EAX                            ; 004689f3
    CALL crt_string.c_strtod_FUN_005ff0f3 ; 004689f4 | double crt_string.c_strtod_FUN_005ff0f3(char * str)
    ...
    JMP 0x00468a17                      ; 00468a0f | LAB_00468a17
    ...
    JG 0x00468c35                       ; 00468a1d | LAB_00468c35
        ;   XREF to: 00468c35 (CONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x1c],0x0     ; 00468a23
    JMP 0x00468a32                      ; 00468a2a | LAB_00468a32
    ...
    JLE 0x00468b2a                      ; 00468a42 | LAB_00468b2a
        ;   XREF to: 00468b2a (CONDITIONAL_JUMP)
    MOV EAX,[0x01626408]                ; 00468a48 | int g_VertexCount
    ...
    FSUBR double ptr [0x0061ce56]       ; 00468a65 | double g_RightAngleDegrees_1
    ...
    CALL shape_design.c_addVertexFromSphericalCoords_FUN_004686e0 ; 00468a89 | void shape_design.c_addVertexFromSphericalCoords_FUN_004686e0(float latitude_degrees, float longitude_degrees, float radius)
    ...
    CALL shape_design.c_addVertexFromSphericalCoords_FUN_004686e0 ; 00468aaf | void shape_design.c_addVertexFromSphericalCoords_FUN_004686e0(float latitude_degrees, float longitude_degrees, float radius)
        ;   XREF to: 004686e0 (UNCONDITIONAL_CALL)
    ...
    CALL shape_design.c_addVertexFromSphericalCoords_FUN_004686e0 ; 00468ad8 | void shape_design.c_addVertexFromSphericalCoords_FUN_004686e0(float latitude_degrees, float longitude_degrees, float radius)
        ;   XREF to: 004686e0 (UNCONDITIONAL_CALL)
    ...
    CALL shape_design.c_addVertexFromSphericalCoords_FUN_004686e0 ; 00468afe | void shape_design.c_addVertexFromSphericalCoords_FUN_004686e0(float latitude_degrees, float longitude_degrees, float radius)
        ;   XREF to: 004686e0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00468b1c
    CALL shape_design.c_addQuadPolygon_FUN_004687c0 ; 00468b1d | void shape_design.c_addQuadPolygon_FUN_004687c0(int vertex_index_0, int vertex_index_1, int vertex_index_2, int vertex_index_3)
        ;   XREF to: 004687c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00468b22
    JMP 0x00468a2c                      ; 00468b25 | LAB_00468a2c
    ...
    JMP 0x00468b42                      ; 00468b3a | LAB_00468b42
    ...
    JGE 0x00468c30                      ; 00468b48 | LAB_00468c30
        ;   XREF to: 00468c30 (CONDITIONAL_JUMP)
    MOV EAX,[0x01626408]                ; 00468b4e | int g_VertexCount
    ...
    FSUBR double ptr [0x0061ce5e]       ; 00468b6b | double g_RightAngleDegrees_2
    ...
    CALL shape_design.c_addVertexFromSphericalCoords_FUN_004686e0 ; 00468b8f | void shape_design.c_addVertexFromSphericalCoords_FUN_004686e0(float latitude_degrees, float longitude_degrees, float radius)
        ;   XREF to: 004686e0 (UNCONDITIONAL_CALL)
    ...
    CALL shape_design.c_addVertexFromSphericalCoords_FUN_004686e0 ; 00468bb5 | void shape_design.c_addVertexFromSphericalCoords_FUN_004686e0(float latitude_degrees, float longitude_degrees, float radius)
        ;   XREF to: 004686e0 (UNCONDITIONAL_CALL)
    ...
    CALL shape_design.c_addVertexFromSphericalCoords_FUN_004686e0 ; 00468bde | void shape_design.c_addVertexFromSphericalCoords_FUN_004686e0(float latitude_degrees, float longitude_degrees, float radius)
        ;   XREF to: 004686e0 (UNCONDITIONAL_CALL)
    ...
    CALL shape_design.c_addVertexFromSphericalCoords_FUN_004686e0 ; 00468c04 | void shape_design.c_addVertexFromSphericalCoords_FUN_004686e0(float latitude_degrees, float longitude_degrees, float radius)
        ;   XREF to: 004686e0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00468c22
    CALL shape_design.c_addQuadPolygon_FUN_004687c0 ; 00468c23 | void shape_design.c_addQuadPolygon_FUN_004687c0(int vertex_index_0, int vertex_index_1, int vertex_index_2, int vertex_index_3)
        ;   XREF to: 004687c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00468c28
    JMP 0x00468b3c                      ; 00468c2b | LAB_00468b3c
        ;   XREF to: 00468b3c (UNCONDITIONAL_JUMP)
    JMP 0x00468a11                      ; 00468c30 | LAB_00468a11
        ;   Label: LAB_00468c30
