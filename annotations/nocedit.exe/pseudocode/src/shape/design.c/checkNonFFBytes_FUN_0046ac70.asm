...
;                               FUNCTION
; *****************************************************************************
; __cdecl int shape_design.c_checkNonFFBytes_FUN_0046ac70(char * buffer_ptr, int buffer_length)
;
; Parameters:
...
section .text
    ...
    JMP 0x0046ac88                      ; 0046ac83 | LAB_0046ac88
    ...
    JGE 0x0046aca6                      ; 0046ac8e | LAB_0046aca6
    ...
    JZ 0x0046aca4                       ; 0046ac99 | LAB_0046aca4
        ;   XREF to: 0046aca4 (CONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x8],0x1      ; 0046ac9b
    JMP 0x0046acad                      ; 0046aca2 | LAB_0046acad
        ;   XREF to: 0046acad (UNCONDITIONAL_JUMP)
    JMP 0x0046ac85                      ; 0046aca4 | LAB_0046ac85
        ;   Label: LAB_0046aca4
