  ...
  if (local_1c == (_FILE *)0x0) {
    ...
    for (local_28 = 0; local_28 < g_PolygonCount; local_28 = local_28 + 1) {
      ...
      if (g_ModelPolygonData[local_28].polygon_type == 1) {
        ...
        if (iVar4 != 0) {
          strcpy(g_TempTextureName,g_ModelPolygonData[local_28].texture_name);
          strcpy(local_90,g_TempTextureName);
          local_94 = 0;
          local_98 = 0xd;
        ...
        if (export_format == 0) {
          ...
          _fwrite(&local_80,1,0x18,local_1c);
          for (local_24 = 0; local_24 < (int)local_7c; local_24 = local_24 + 1) {
            _fwrite(&g_ModelPolygonData[local_28].vertex_indices[local_24],1,4,local_1c);
