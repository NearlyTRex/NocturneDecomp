...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_design.c_scaleModel_FUN_00467e70(void)
;
; Local Variables:
...
section .text
    ...
    CALL engine_2d.c_clearInputAndWait_FUN_00403260 ; 00467e7c | void engine_2d.c_clearInputAndWait_FUN_00403260()
        ;   XREF to: 00403260 (UNCONDITIONAL_CALL)
    CALL wincore_windll.cpp_clearScreen_FUN_005b3e70 ; 00467e81 | void wincore_windll.cpp_clearScreen_FUN_005b3e70()
        ;   XREF to: 005b3e70 (UNCONDITIONAL_CALL)
    MOV ECX,0x61cb9d                    ; 00467e86 | = "Enter in scale multiplier : " | s_Enter_in_scale_multiplie_0061cb9d = Enter in scale multiplier :
    PUSH ECX                            ; 00467e8b | = "Enter in scale multiplier : " | s_Enter_in_scale_multiplie_0061cb9d = Enter in scale multiplier :
    PUSH 0x0                            ; 00467e8c
    PUSH 0x0                            ; 00467e8e
    PUSH 0x14                           ; 00467e90
    LEA ECX,[EBP + -0x58]               ; 00467e92
    PUSH ECX                            ; 00467e95
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 00467e96 | int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
    ...
    JNZ 0x00467eb1                      ; 00467ead | LAB_00467eb1
        ;   XREF to: 00467eb1 (CONDITIONAL_JUMP)
    JMP 0x00467f1e                      ; 00467eaf | LAB_00467f1e
        ;   XREF to: 00467f1e (UNCONDITIONAL_JUMP)
    LEA EAX,[EBP + -0x58]               ; 00467eb1
        ;   Label: LAB_00467eb1
    PUSH EAX                            ; 00467eb4
    CALL crt_string.c_strtod_FUN_005ff0f3 ; 00467eb5 | double crt_string.c_strtod_FUN_005ff0f3(char * str)
    ...
    JMP 0x00467ed8                      ; 00467ed0 | LAB_00467ed8
    ...
    MOV EAX,dword ptr [EBP + -0x8]      ; 00467ed8
        ;   Label: LAB_00467ed8
    CMP EAX,dword ptr [0x01626408]      ; 00467edb | int g_VertexCount
    JGE 0x00467f1e                      ; 00467ee1 | LAB_00467f1e
        ;   XREF to: 00467f1e (CONDITIONAL_JUMP)
    IMUL EAX,dword ptr [EBP + -0x8],0x14 ; 00467ee3
    FLD float ptr [EAX + 0x162640c]     ; 00467ee7 | SVertexData[20000] g_LoadedVertices
    FMUL float ptr [EBP + -0x4]         ; 00467eed
    FSTP float ptr [EAX + 0x162640c]    ; 00467ef0 | SVertexData[20000] g_LoadedVertices
    ...
    JMP 0x00467ed2                      ; 00467f1c | LAB_00467ed2
