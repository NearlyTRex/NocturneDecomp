...
section .text
    ...
    MOV byte ptr [0x02d03ebe],0x0       ; 0045b9b0 | CHAR_ARRAY_02d03ebe
        ;   Label: LAB_0045b9b0
    CALL engine_special.cpp_clearScreen_FUN_005b3e70 ; 0045b9b7
    ...
    MOV byte ptr [0x02d03eb7],0x0       ; 0045b9e9 | CHAR_ARRAY_02d03eb7
        ;   Label: LAB_0045b9e9
    CALL engine_special.cpp_clearScreen_FUN_005b3e70 ; 0045b9f0
        ;   XREF to: 005b3e70 (UNCONDITIONAL_CALL)  ; void engine_special.cpp_clearScreen_FUN_005b3e70()
    ...
    MOV byte ptr [0x02d03ea9],0x0       ; 0045ba0e | CHAR_ARRAY_02d03ea9
        ;   Label: LAB_0045ba0e
    CALL engine_special.cpp_clearScreen_FUN_005b3e70 ; 0045ba15
        ;   XREF to: 005b3e70 (UNCONDITIONAL_CALL)  ; void engine_special.cpp_clearScreen_FUN_005b3e70()
    PUSH 0x0                            ; 0045ba1a
    ...
    MOV byte ptr [0x02d03ec8],0x0       ; 0045ba38 | CHAR_ARRAY_02d03ec8
        ;   Label: LAB_0045ba38
    CALL engine_special.cpp_clearScreen_FUN_005b3e70 ; 0045ba3f
        ;   XREF to: 005b3e70 (UNCONDITIONAL_CALL)  ; void engine_special.cpp_clearScreen_FUN_005b3e70()
