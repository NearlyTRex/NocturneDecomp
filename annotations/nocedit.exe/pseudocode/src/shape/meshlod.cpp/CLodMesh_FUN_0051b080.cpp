// Name: shape_meshlod.cpp_CLodMesh_FUN_0051b080
// Address: 0051b080
// Address Range: [[0051b080, 0051b2a2]]
// Convention: __cdecl
// Signature: void shape_meshlod.cpp_CLodMesh_FUN_0051b080(CLodMesh * this_ptr)
// Cross-references:
...

{
  ...
  if (0 < in_stack_00000008->vertex_count) {
    ...
    iVar2 = 0;
    do {
      *(undefined4 *)(in_stack_0000000c->vertex_data->field0_0x0 + iVar2) =
           *(undefined4 *)((int)&g_LoadedVertices[0].vertex.x + iVar6);
      *(undefined4 *)(in_stack_0000000c->vertex_data->field0_0x0 + iVar2 + 4) =
           *(undefined4 *)((int)&g_LoadedVertices[0].vertex.y + iVar6);
      *(undefined4 *)(in_stack_0000000c->vertex_data->field0_0x0 + iVar2 + 8) =
           *(undefined4 *)((int)&g_LoadedVertices[0].vertex.z + iVar6);
      iVar2 = iVar2 + 0x4c4;
      iVar5 = iVar5 + 1;
      iVar6 = iVar6 + 0x14;
    } while (iVar5 < in_stack_0000000c->vertex_count);
  }
  ...
  if (0 < iVar5) {
    do {
      ...
      if (2 < (int)g_ModelPolygonData[local_14].vertex_indices_count) {
        do {
          iVar6 = iVar6 + 1;
          pcVar3 = in_stack_0000000c->triangle_data->field0_0x0 + iVar4;
          iVar4 = iVar4 + 0x8c;
          ...
          *(uint *)(pcVar3 + 0x1c) = g_ModelPolygonData[local_14].vertex_indices[0x10];
  ...
  in_stack_0000000c->field6_0x18 = 2;
  in_stack_0000000c->field7_0x1c = 2;
  in_stack_0000000c->field8_0x20 = 0;
  shape_meshlod_cpp_CLodMesh_FUN_0051b330(in_stack_0000000c);
  return;
}
...
// Assembly code:
// 0051b080: PUSH EBX
//   Label: shape_meshlod.cpp_CLodMesh_FUN_0051b080
// 0051b081: PUSH ESI
// 0051b082: PUSH EDI
// 0051b083: PUSH EBP
...
// 0051b27b: CALL shape_meshlod.cpp_CLodMesh_FUN_0051b330
