...
// Convention: __cdecl
// Signature: void shape_meshlod.cpp_CLodMesh_eqSave_FUN_0051d0e0(CLodMesh * this_ptr, FILE * file_handle)
// Cross-references:
//   shape_meshlod.cpp_CLodMesh_initializeLodGeneration_FUN_00516d50 (00516d50) at 00516ded [UNCONDITIONAL_CALL]
// Globals:
...

{
  ...
  if (file_handle != (FILE *)0x0) {
    ...
    if (0 < this_ptr->edge_count) {
      dVar1 = g_InfiniteCollapseCost * DOUBLE_006380cd;
      iVar4 = 0;
      do {
        puVar2 = (undefined4 *)((int)this_ptr->edges_ptr->adjacent_tri_indices + iVar4 + -0x28);
