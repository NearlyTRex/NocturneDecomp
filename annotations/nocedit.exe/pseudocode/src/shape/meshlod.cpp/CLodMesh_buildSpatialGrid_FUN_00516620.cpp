...
// Cross-references:
//   shape_meshlod.cpp_CLodMesh_initializeLodGeneration_FUN_00516d50 (00516d50) at 00516da9 [UNCONDITIONAL_CALL]
// Globals:
...

{
  ...
  local_24 = 0;
  do {
    local_3c = (float)(int)pcVar13 * (float)DOUBLE_006375fd + (float)DOUBLE_00637605;
    iVar14 = 0;
    fVar2 = local_3c + (float)DOUBLE_006375fd;
    fVar3 = (float)DOUBLE_0063760d;
    local_20 = local_24;
    do {
      local_38 = (float)iVar14 * (float)DOUBLE_006375fd + (float)DOUBLE_00637605;
      local_64 = 0;
      fVar4 = local_38 + (float)DOUBLE_006375fd;
      fVar5 = (float)DOUBLE_0063760d;
      local_1c = local_20;
      do {
        local_34 = (float)local_64 * (float)DOUBLE_006375fd + (float)DOUBLE_00637605;
        fVar6 = local_34 + (float)DOUBLE_006375fd;
        fVar7 = (float)DOUBLE_0063760d;
