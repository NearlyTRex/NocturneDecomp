...
section .text
    ...
    JGE 0x00516557                      ; 00516532 | LAB_00516557
    ...
    CALL core_box.cpp_CBoundingBox3D_expand_FUN_00420240 ; 00516548 | void core_box.cpp_CBoundingBox3D_expand_FUN_00420240(CBoundingBox3D * this_ptr, CVector3f * point)
        ;   XREF to: 00420240 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [EDI]             ; 0051654d
    ADD ESP,0x8                         ; 0051654f
    CMP EBX,ECX                         ; 00516552
    JL 0x0051653a                       ; 00516554 | LAB_0051653a
    ...
    JMP 0x00516514                      ; 0051656e | LAB_00516514
