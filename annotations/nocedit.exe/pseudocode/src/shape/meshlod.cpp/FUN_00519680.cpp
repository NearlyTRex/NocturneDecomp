// Name: shape_meshlod.cpp_FUN_00519680
// Address: 00519680
// Address Range: [[00519680, 0051970e]]
// Convention: unknown
// Signature: undefined shape_meshlod.cpp_FUN_00519680()
// Cross-references:
//   shape_meshlod.cpp_FUN_00516ba0 (00516ba0) at 00516bdd [UNCONDITIONAL_CALL]
// Globals:
...
int shape_meshlod_cpp_FUN_00519680(void)

{
  ...
  if (0 < *(int *)(in_stack_00000004 + 0x44)) {
    iVar3 = 0;
    do {
      iVar1 = *(int *)(in_stack_00000004 + 0x48) + iVar3;
      if (*(int *)(iVar1 + 0x14) == 0) {
        if (*(int *)(iVar1 + 0x20) != 0) {
          shape_meshlod_cpp_NeighboringFacesEdgesCheck_FUN_00518910();
        }
        iVar1 = *(int *)(in_stack_00000004 + 0x48) + iVar3;
        if (*(double *)(iVar1 + 8) < (double)CONCAT44(uStack_1c,local_20)) {
...
// Assembly code:
// 00519680: PUSH EBX
//   Label: shape_meshlod.cpp_FUN_00519680
// 00519681: PUSH ESI
// 00519682: PUSH EDI
// 00519683: PUSH EBP
...
// 005196e2: PUSH EBX
// 005196e3: PUSH ESI
// 005196e4: CALL shape_meshlod.cpp_NeighboringFacesEdgesCheck_FUN_00518910
