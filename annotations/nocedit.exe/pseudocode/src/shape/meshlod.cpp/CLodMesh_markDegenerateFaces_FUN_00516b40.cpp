...
// Convention: __cdecl
// Signature: void shape_meshlod.cpp_CLodMesh_markDegenerateFaces_FUN_00516b40(CLodMesh * this_ptr)
// Cross-references:
//   shape_meshlod.cpp_CLodMesh_getLOD_FUN_0051b920 (0051b920) at 0051b9e3 [UNCONDITIONAL_CALL]
//   shape_meshlod.cpp_CLodMesh_postprocessMesh_FUN_0051b330 (0051b330) at 0051b38f [UNCONDITIONAL_CALL]
    ...
    do {
      ...
      if (*(int *)((int)pCVar1->edge_perpendiculars + iVar6 + -0x14) == 0) {
        ...
        if (((iVar3 == iVar2) ||
           ...
           (iVar2 == iVar4)) {
          *(undefined4 *)((int)pCVar1->edge_perpendiculars + iVar6 + -0x14) = 1;
        }
      }
      iVar5 = iVar5 + 1;
      iVar6 = iVar6 + 0x8c;
