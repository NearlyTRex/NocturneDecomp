// Name: shape_meshlod.cpp_FUN_00516000
// Address: 00516000
// Address Range: [[00516000, 0051641d]]
// Convention: unknown
// Signature: undefined shape_meshlod.cpp_FUN_00516000()
// Cross-references:
//   shape_meshlod.cpp_FUN_00517630 (00517630) at 005181d5 [UNCONDITIONAL_CALL]
//   shape_meshlod.cpp_FUN_00519710 (00519710) at 0051972c [UNCONDITIONAL_CALL]
//   shape_meshlod.cpp_FUN_0051cdf0 (0051cdf0) at 0051d01d [UNCONDITIONAL_CALL]
// Globals:
...
/* Signature: undefined1 shape_meshlod.cpp_FUN_00516000(undefined4 param_1, undefined4 param_2,
   undefined4 param_3) */

void shape_meshlod_cpp_FUN_00516000(void)

{
  ...
  local_4c = *(int *)(in_stack_00000004 + 0x48) + in_stack_00000008 * 0xf0;
  if (in_stack_0000000c == 0) {
    if (*(int *)(local_4c + 0x18) < 2) {
      *(undefined4 *)(local_4c + 0x18) = 0;
    }
  }
  else {
    *(undefined4 *)(local_4c + 0x18) = 0;
    *(undefined4 *)(local_4c + 0x1c) = 0;
  }
  if (*(int *)(local_4c + 0x24) < 2) {
    *(undefined4 *)(local_4c + 0x1c) = 2;
    return;
  }
  if (*(int *)(local_4c + 0x18) < 2) {
    iVar5 = *(int *)(in_stack_00000004 + 0xc);
    local_40 = iVar5 + *(int *)(local_4c + 0x28) * 0x8c;
    if ((DAT_02f33330 == 0) && (local_48 = 1, iVar1 = local_4c, 1 < *(int *)(local_4c + 0x24))) {
      do {
        iVar4 = 0;
        iVar3 = in_stack_00000004;
        if (0 < *(int *)(in_stack_00000004 + 0x18)) {
          do {
            if ((*(int *)(iVar3 + 0x24) != 0) &&
               (*(int *)(local_40 + iVar4 * 4) !=
                *(int *)(*(int *)(iVar1 + 0x2c) * 0x8c + iVar5 + iVar4 * 4))) {
              *(undefined4 *)(local_4c + 0x18) = 1;
              return;
            }
            iVar4 = iVar4 + 1;
            iVar3 = iVar3 + 4;
          } while (iVar4 < *(int *)(in_stack_00000004 + 0x18));
        }
        local_48 = local_48 + 1;
        iVar1 = iVar1 + 4;
        local_50 = iVar5;
      } while (local_48 < *(int *)(local_4c + 0x24));
    }
    if ((in_stack_0000000c != 0) &&
       (local_44 = 0, local_2c = local_4c, 0 < *(int *)(local_4c + 0x24))) {
      do {
        local_28 = *(int *)(local_4c + 0x28);
        local_30 = *(int *)(in_stack_00000004 + 0xc) + local_28 * 0x8c;
        local_34 = local_44 + 1;
        if (local_34 < *(int *)(local_2c + 0x24)) {
          local_3c = (float *)(local_30 + 0x44);
          local_38 = local_34 * 4 + local_2c;
          do {
            local_1c = *(int *)(local_38 + 0x28);
            iVar5 = local_1c * 0x8c + *(int *)(in_stack_00000004 + 0xc);
            fVar2 = local_3c[2] * *(float *)(iVar5 + 0x4c) +
                    *local_3c * *(float *)(iVar5 + 0x44) + local_3c[1] * *(float *)(iVar5 + 0x48);
            if (*(int *)(local_2c + 0x1c) < 2) {
              if (fVar2 <= (float)DOUBLE_00637525) {
                *(undefined4 *)(local_2c + 0x1c) = 1;
              }
              if (fVar2 <= (float)DOUBLE_0063752d) {
                *(undefined4 *)(local_2c + 0x1c) = 2;
              }
            }
            if (((DAT_02f33330 == 0) && (*(int *)(in_stack_00000004 + 0x24) != 0)) &&
               (*(int *)(local_2c + 0x18) < 2)) {
              iStack_14 = shape_meshlod_cpp_FUN_00515e90();
              iVar1 = shape_meshlod_cpp_FUN_00515e90();
              fVar2 = (float)shape_meshlod_cpp_FUN_00515e90();
              iVar4 = 0;
              iVar3 = shape_meshlod_cpp_FUN_00515e90();
              iVar1 = local_20 + iVar1 * 8;
              iStack_14 = iVar5 + iVar3 * 8;
              iVar3 = unaff_ESI * 8 + local_20;
              iVar5 = iVar5 + local_50 * 8;
              do {
                if (((float)DOUBLE_00637535 <
                     ABS(*(float *)(iVar3 + 0x1c) - *(float *)(iVar5 + 0x1c))) ||
                   ((float)DOUBLE_00637535 <
                    ABS(*(float *)(iVar1 + iVar4 * 4 + 0x1c) -
                        *(float *)(iVar4 * 4 + iStack_14 + 0x1c)))) {
                  *(undefined4 *)(local_1c + 0x18) = 2;
                  break;
                }
                shape_meshlod_cpp_FUN_00517530();
                shape_meshlod_cpp_FUN_00517530();
                if (fVar2 * local_60 + local_5c * fStack_68 + local_58 * fStack_64 <=
                    SQRT(local_60 * local_60 + fStack_68 * fStack_68 + fStack_64 * fStack_64) *
                    SQRT(fVar2 * fVar2 + local_5c * local_5c + local_58 * local_58) *
                    (float)&local_44 * (float)DOUBLE_0063751d) {
                  *(undefined4 *)(iStack_14 + 0x18) = 2;
                  break;
                }
                iVar3 = iVar3 + 4;
                iVar4 = iVar4 + 1;
            ...
            local_38 = local_38 + 4;
            local_34 = local_34 + 1;
          } while (local_34 < *(int *)(local_2c + 0x24));
        }
        local_4c = local_4c + 4;
        local_44 = local_44 + 1;
      } while (local_44 < *(int *)(local_2c + 0x24));
    }
  }
  return;
}
...
// Assembly code:
// 00516000: PUSH EBX
//   Label: shape_meshlod.cpp_FUN_00516000
// 00516001: PUSH ESI
// 00516002: PUSH EDI
// 00516003: PUSH EBP
...
//   XREF to: Stack[0x4] (READ)
// 00516212: PUSH EDX
// 00516213: CALL shape_meshlod.cpp_FUN_00517530
...
//   XREF to: Stack[0x4] (READ)
// 0051622e: PUSH EAX
// 0051622f: CALL shape_meshlod.cpp_FUN_00517530
//   XREF to: 00517530 (UNCONDITIONAL_CALL)
...
//   XREF to: Stack[-0x30] (READ)
// 0051637c: PUSH EDI
// 0051637d: CALL shape_meshlod.cpp_FUN_00515e90
...
// 00516390: PUSH EDX
// 00516391: PUSH EDI
// 00516392: CALL shape_meshlod.cpp_FUN_00515e90
//   XREF to: 00515e90 (UNCONDITIONAL_CALL)
...
// 005163a2: PUSH EBX
// 005163a3: PUSH ESI
// 005163a4: CALL shape_meshlod.cpp_FUN_00515e90
//   XREF to: 00515e90 (UNCONDITIONAL_CALL)
...
// 005163be: CALL shape_meshlod.cpp_FUN_00515e90
//   XREF to: 00515e90 (UNCONDITIONAL_CALL)
