...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_meshlod.cpp_CLodMesh_createOrigSamplePoints_FUN_00517000(CLodMesh * this_ptr)
;
; Parameters:
...
section .text
    ...
    JZ 0x0051711a                       ; 0051700f | LAB_0051711a
    ...
    PUSH 0x637724                       ; 0051703c | = "..\\shape\\meshlod.cpp" | s_shape_meshlod_cpp_00637724 = ..\shape\meshlod.cpp
    ADD EAX,0x4                         ; 00517041
    PUSH EAX                            ; 00517044
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1f0 ; 00517045 | void * shape_memdbg.cpp_debugAlloc_FUN_0050f1f0(int size, char * filename, int line_number)
        ;   XREF to: 0050f1f0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0051704a
    TEST EAX,EAX                        ; 0051704d
    JZ 0x00517057                       ; 0051704f | LAB_00517057
    ...
    JZ 0x00517142                       ; 0051705c | LAB_00517142
    ...
    JL 0x00517169                       ; 00517077 | LAB_00517169
    ...
    JL 0x005171bc                       ; 0051709b | LAB_005171bc
    ...
    JGE 0x00517282                      ; 005170c5 | LAB_00517282
    ...
    CALL shape_meshlod.cpp_CLodMesh_computeFaceCentroid_FUN_00518870 ; 005170e0 | CVector3f * shape_meshlod.cpp_CLodMesh_computeFaceCentroid_FUN_00518870(CLodMesh * this_ptr, CVector3f * out_centroid, CLodFace * face)
        ;   XREF to: 00518870 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005170e5
    CMP EDI,EAX                         ; 005170e8
    JNZ 0x0051726d                      ; 005170ea | LAB_0051726d
    ...
    CALL shape_meshlod.cpp_CLodMesh_findClosestFaceToSamplePoint_FUN_00518300 ; 005170ff | void shape_meshlod.cpp_CLodMesh_findClosestFaceToSamplePoint_FUN_00518300(CLodMesh * this_ptr, int sample_point_index)
    ...
    JMP 0x005170b7                      ; 00517118 | LAB_005170b7
        ;   XREF to: 005170b7 (UNCONDITIONAL_JUMP)
    MOV ECX,0x6376c3                    ; 0051711a | = "..\\shape\\meshlod.cpp" | s_shape_meshlod_cpp_006376c3 = ..\shape\meshlod.cpp
        ;   Label: LAB_0051711a
    MOV ESI,0x56f                       ; 0051711f
    PUSH 0x6376d8                       ; 00517124 | = "Can't call LodMesh::createOrigSampleP..." | s_Can_t_call_LodMesh_creat_006376d8 = Can't call LodMesh::createOrigSamplePoints unless we have an original mesh!
    MOV dword ptr [0x02f0ca48],ECX      ; 00517129 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 0051712f | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00517135 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0051713a
    JMP 0x00517015                      ; 0051713d | LAB_00517015
        ;   XREF to: 00517015 (UNCONDITIONAL_JUMP)
    MOV EAX,0x637739                    ; 00517142 | = "..\\shape\\meshlod.cpp" | s_shape_meshlod_cpp_00637739 = ..\shape\meshlod.cpp
        ;   Label: LAB_00517142
    MOV EDX,0x578                       ; 00517147
    PUSH 0x63774e                       ; 0051714c | = "Out of memory!" | s_Out_of_memory_0063774e = Out of memory!
    MOV [0x02f0ca48],EAX                ; 00517151 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 00517156 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0051715c | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00517161
    JMP 0x00517062                      ; 00517164 | LAB_00517062
    ...
    JZ 0x0051718b                       ; 00517179 | LAB_0051718b
    ...
    CALL shape_meshlod.cpp_CLodMesh_findClosestFaceToSamplePoint_FUN_00518300 ; 0051719a | void shape_meshlod.cpp_CLodMesh_findClosestFaceToSamplePoint_FUN_00518300(CLodMesh * this_ptr, int sample_point_index)
        ;   XREF to: 00518300 (UNCONDITIONAL_CALL)
    ...
    JMP 0x0051706e                      ; 005171b7 | LAB_0051706e
    ...
    FDIV float ptr [0x0063777d]         ; 005171f0 | float FLOAT_0063777d
    ...
    FXCH                                ; 00517206
    FLD float ptr [0x00637779]          ; 00517208 | float FLOAT_00637779
    FXCH                                ; 0051720e
    FMUL ST1                            ; 00517210
    FXCH ST2                            ; 00517212
    ...
    JZ 0x00517240                       ; 0051722b | LAB_00517240
    ...
    CALL shape_meshlod.cpp_CLodMesh_findClosestFaceToSamplePoint_FUN_00518300 ; 0051724a | void shape_meshlod.cpp_CLodMesh_findClosestFaceToSamplePoint_FUN_00518300(CLodMesh * this_ptr, int sample_point_index)
        ;   XREF to: 00518300 (UNCONDITIONAL_CALL)
    ...
    JMP 0x00517091                      ; 00517268 | LAB_00517091
    ...
    JMP 0x005170f0                      ; 0051727d | LAB_005170f0
        ;   XREF to: 005170f0 (UNCONDITIONAL_JUMP)
    CMP ESI,dword ptr [EBX + 0x5c]      ; 00517282
        ;   Label: LAB_00517282
    JNZ 0x0051728f                      ; 00517285 | LAB_0051728f
    ...
    POP EBX                             ; 0051728d
    RET                                 ; 0051728e
    MOV EBP,0x63775d                    ; 0051728f | = "..\\shape\\meshlod.cpp" | s_shape_meshlod_cpp_0063775d = ..\shape\meshlod.cpp
        ;   Label: LAB_0051728f
    MOV EAX,0x5c8                       ; 00517294
    PUSH 0x637772                       ; 00517299 | = "Bug!" | s_Bug_00637772 = Bug!
    MOV dword ptr [0x02f0ca48],EBP      ; 0051729e | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 005172a4 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005172a9 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
