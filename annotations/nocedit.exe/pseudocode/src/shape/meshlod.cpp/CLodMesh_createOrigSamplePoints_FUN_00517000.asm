...
; CLodVert *       Stack[-0x14]:4  local_14
;
; XREF[2]:
;   shape_meshlod.cpp_CLodMesh_initializeFromPrecomputedData_FUN_0051b8a0 at 0051b8f9
...
section .text
    ...
    PUSH EAX                            ; 00517044
    CALL shape_memdbg.cpp_debugAllocTracked2_FUN_0050f1f0 ; 00517045
