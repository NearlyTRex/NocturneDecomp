...
section .text
    ...
    JLE 0x005197ee                      ; 005197d1 | LAB_005197ee
    ...
    JZ 0x005197f7                       ; 005197de | LAB_005197f7
    ...
    JL 0x005197d5                       ; 005197ec | LAB_005197d5
        ;   XREF to: 005197d5 (CONDITIONAL_JUMP)
    TEST EBP,EBP                        ; 005197ee
        ;   Label: LAB_005197ee
    JG 0x00519808                       ; 005197f0 | LAB_00519808
    ...
    PUSH EAX                            ; 005197f7
        ;   Label: LAB_005197f7
    PUSH EDI                            ; 005197f8
    CALL shape_meshlod.cpp_CLodMesh_validateFace_FUN_00519830 ; 005197f9 | int shape_meshlod.cpp_CLodMesh_validateFace_FUN_00519830(CLodMesh * this_ptr, CLodFace * face)
        ;   XREF to: 00519830 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005197fe
    TEST EAX,EAX                        ; 00519801
    JNZ 0x005197e0                      ; 00519803 | LAB_005197e0
        ;   XREF to: 005197e0 (CONDITIONAL_JUMP)
    INC EBP                             ; 00519805
    JMP 0x005197e0                      ; 00519806 | LAB_005197e0
        ;   XREF to: 005197e0 (UNCONDITIONAL_JUMP)
    PUSH EBP                            ; 00519808
        ;   Label: LAB_00519808
    PUSH 0x637a16                       ; 00519809 | = "WARNING - encountered %d invalid face..." | s_WARNING_encountered_d_in_00637a16 = WARNING - encountered %d invalid faces, which were deleted!
    MOV EBX,dword ptr [0x00678a60]      ; 0051980e | CEditorTools * g_CEditorToolsPtr
    PUSH EBX                            ; 00519814 | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_showError_FUN_0049e740 ; 00519815 | void shape_edittool.cpp_CEditorTools_showError_FUN_0049e740(CEditorTools * this_ptr, char * format)
