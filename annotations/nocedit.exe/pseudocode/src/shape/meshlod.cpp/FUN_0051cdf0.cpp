// Name: shape_meshlod.cpp_FUN_0051cdf0
// Address: 0051cdf0
// Address Range: [[0051cdf0, 0051d0d5]]
// Convention: unknown
// Signature: undefined shape_meshlod.cpp_FUN_0051cdf0()
// Cross-references:
//   shape_meshlod.cpp_FUN_005173f0 (005173f0) at 005174ea [UNCONDITIONAL_CALL]
//   shape_meshlod.cpp_FUN_0051b8a0 (0051b8a0) at 0051b903 [UNCONDITIONAL_CALL]
// Globals:
...

{
  ...
  pvVar2 = shape_memdbg_cpp_debugCalloc_FUN_0050f350
                     (local_34,0xf0,"..\\shape\\meshlod.cpp",0x13e4);
  if (pvVar2 == (void *)0x0) {
    g_CurrentFilename = "..\\shape\\meshlod.cpp";
    g_CurrentLineNumber = 0x13e5;
    core_main_c_displayErrorAndQuit_FUN_00506f10("Out of memory!");
  }
  if (pvVar2 != *(void **)(in_stack_00000004 + 0x44)) {
    iStack_14 = 0;
  }
  local_18 = 0;
  if (0 < (int)pvVar2) {
...
LAB_0051d075:
      ...
      if (iStack_14 != 0) {
        if (*(int *)(*(int *)(in_stack_00000004 + 0x48) + iVar7) != *piVar3) {
          iStack_14 = 0;
        }
        if (piVar3[1] != *(int *)(*(int *)(in_stack_00000004 + 0x48) + iVar7 + 4)) {
          iStack_14 = 0;
        }
      }
  ...
  if (iStack_14 == 0) {
    ...
    iVar7 = *(int *)(in_stack_00000004 + 0x44);
    iVar4 = 0;
    pvVar2 = local_28;
    if (0 < iVar7) {
      do {
        iVar5 = iVar4 * 0xf0;
        iVar7 = *(int *)(in_stack_00000004 + 0x48);
        *(undefined4 *)(iVar7 + 8 + iVar5) = *(undefined4 *)((int)pvVar2 + 8);
        *(undefined4 *)(iVar7 + 0xc + iVar5) = *(undefined4 *)((int)pvVar2 + 0xc);
        *(undefined4 *)(*(int *)(in_stack_00000004 + 0x48) + 0x10 + iVar5) =
             *(undefined4 *)((int)pvVar2 + 0x10);
        *(undefined4 *)(*(int *)(in_stack_00000004 + 0x48) + 0x20 + iVar5) = 0;
        iVar4 = iVar4 + 1;
        iVar7 = *(int *)(in_stack_00000004 + 0x44);
        pvVar2 = (void *)((int)pvVar2 + 0xf0);
      } while (iVar4 < iVar7);
    }
    uVar6 = CONCAT44(iVar7,iVar4);
    iVar7 = 0;
    if (0 < *(int *)(in_stack_00000004 + 0x44)) {
      do {
        uVar6 = shape_meshlod_cpp_FUN_00516000((int)uVar6,(int)((ulonglong)uVar6 >> 0x20));
        iVar7 = iVar7 + 1;
      } while (iVar7 < *(int *)(in_stack_00000004 + 0x44));
    }
  }
...
// Assembly code:
// 0051cdf0: PUSH EBX
//   Label: shape_meshlod.cpp_FUN_0051cdf0
// 0051cdf1: PUSH ESI
// 0051cdf2: PUSH EDI
// 0051cdf3: PUSH EBP
...
// 0051d01b: PUSH EBX
// 0051d01c: PUSH EDI
// 0051d01d: CALL shape_meshlod.cpp_FUN_00516000
...
// 0051d0c8: PUSH EDI
// 0051d0c9: CALL shape_meshlod.cpp_FUN_00519710
