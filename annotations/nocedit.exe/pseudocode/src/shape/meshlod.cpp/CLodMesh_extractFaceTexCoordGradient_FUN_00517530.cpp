...

{
  ...
  if ((CLodVert *)&local_2c != pCVar3) {
    local_2c = (pCVar3->position).x;
    local_28 = (pCVar3->position).y;
    local_24 = (pCVar3->position).z;
  }
  pCVar3 = this_ptr->vertex_data + pCVar1[tri_index].vertex_idx_2;
  if ((CLodVert *)&local_20 != pCVar3) {
    local_20 = (pCVar3->position).x;
    local_1c = (pCVar3->position).y;
    local_18 = (pCVar3->position).z;
  }
