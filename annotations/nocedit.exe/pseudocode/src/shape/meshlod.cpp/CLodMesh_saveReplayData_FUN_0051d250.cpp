...
// Cross-references:
//   shape_meshlod.cpp_CLodMesh_generateLOD_FUN_00516ba0 (00516ba0) at 00516d2f [UNCONDITIONAL_CALL]
// Globals:
    ...
    if (0 < this_ptr->lod_level_count) {
      ...
      do {
        ...
        crt_stdio_c_fprintf_FUN_005fe6d0
                   ...
                   *(undefined4 *)((int)pCVar1->adjacent_tri_indices + iVar6),
                   *(undefined4 *)((int)pCVar1->adjacent_tri_indices + iVar5),
                   *(undefined4 *)((int)pCVar1->adjacent_tri_indices + iVar4),
                   *(undefined4 *)((int)pCVar1->adjacent_tri_indices + iVar3),
