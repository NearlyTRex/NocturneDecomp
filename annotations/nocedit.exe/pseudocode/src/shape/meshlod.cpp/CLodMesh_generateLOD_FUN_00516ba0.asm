...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_meshlod.cpp_CLodMesh_generateLOD_FUN_00516ba0(CLodMesh * this_ptr, int target_tri_count, uint display_mode)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00516baf
    CALL shape_meshlod.cpp_CLodMesh_initializeLodGeneration_FUN_00516d50 ; 00516bb0 | void shape_meshlod.cpp_CLodMesh_initializeLodGeneration_FUN_00516d50(CLodMesh * this_ptr)
        ;   XREF to: 00516d50 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00516bb5
    CALL wincore_winrun.cpp_getTime_FUN_005f2dc0 ; 00516bb8 | int wincore_winrun.cpp_getTime_FUN_005f2dc0()
    ...
    PUSH EBX                            ; 00516bc6
        ;   Label: LAB_00516bc6
    CALL shape_meshlod.cpp_CLodMesh_countUnprocessedFaces_FUN_005164d0 ; 00516bc7 | int shape_meshlod.cpp_CLodMesh_countUnprocessedFaces_FUN_005164d0(CLodMesh * this_ptr)
    ...
    JLE 0x00516d2a                      ; 00516bd6 | LAB_00516d2a
        ;   XREF to: 00516d2a (CONDITIONAL_JUMP)
    PUSH EBX                            ; 00516bdc
    CALL shape_meshlod.cpp_CLodMesh_findMinimumCostEdge_FUN_00519680 ; 00516bdd | int shape_meshlod.cpp_CLodMesh_findMinimumCostEdge_FUN_00519680(CLodMesh * this_ptr)
        ;   XREF to: 00519680 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00516be2
    TEST EAX,EAX                        ; 00516be5
    JL 0x00516d2a                       ; 00516be7 | LAB_00516d2a
        ;   XREF to: 00516d2a (CONDITIONAL_JUMP)
    IMUL EAX,EAX,0xf0                   ; 00516bed
    FLD float ptr [ESP]                 ; 00516bf3
    CALL crt_math.c_round_FUN_005fe6b0  ; 00516bf6 | double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    IDIV ECX                            ; 00516c1e
    PUSH EAX                            ; 00516c20
    PUSH 0x637615                       ; 00516c21 | = "Mesh degredation in progress...%d:%02..." | s_Mesh_degredation_in_prog_00637615 = Mesh degredation in progress...%d:%02d elapsed
    PUSH 0x2f31258                      ; 00516c26 | char[400] g_LodMeshProgressBuffer
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 00516c2b | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00516c30
    CMP dword ptr [ESP + 0x14],0x5      ; 00516c33
    JLE 0x00516cbc                      ; 00516c38 | LAB_00516cbc
    ...
    JLE 0x00516cbc                      ; 00516c49 | LAB_00516cbc
        ;   XREF to: 00516cbc (CONDITIONAL_JUMP)
    ...
    FDIVP                               ; 00516c63
    CALL crt_math.c_round_FUN_005fe6b0  ; 00516c65 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x10]        ; 00516c6a
    MOV ECX,dword ptr [ESP + 0x10]      ; 00516c6e
    TEST ECX,ECX                        ; 00516c72
    JLE 0x00516cbc                      ; 00516c74 | LAB_00516cbc
        ;   XREF to: 00516cbc (CONDITIONAL_JUMP)
    ...
    IDIV ESI                            ; 00516c8c
    PUSH EAX                            ; 00516c8e
    PUSH 0x637644                       ; 00516c8f | = ", est %d:%02d remaining" | s_est_d_02d_remaining_00637644 = , est %d:%02d remaining
    MOV ESI,0x2f31258                   ; 00516c94 | char[400] g_LodMeshProgressBuffer
    XOR DL,DL                           ; 00516c99
    MOV AL,byte ptr [ESI]               ; 00516c9b | char[400] g_LodMeshProgressBuffer
        ;   Label: LAB_00516c9b
    CMP AL,DL                           ; 00516c9d
    JZ 0x00516cb3                       ; 00516c9f | LAB_00516cb3
        ;   XREF to: 00516cb3 (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 00516ca1
    JZ 0x00516cb1                       ; 00516ca3 | LAB_00516cb1
        ;   XREF to: 00516cb1 (CONDITIONAL_JUMP)
    INC ESI                             ; 00516ca5
    MOV AL,byte ptr [ESI]               ; 00516ca6 | CHAR_ARRAY_02f31259
    CMP AL,DL                           ; 00516ca8
    JZ 0x00516cb3                       ; 00516caa | LAB_00516cb3
        ;   XREF to: 00516cb3 (CONDITIONAL_JUMP)
    INC ESI                             ; 00516cac
    CMP AL,0x0                          ; 00516cad
    JNZ 0x00516c9b                      ; 00516caf | LAB_00516c9b
        ;   XREF to: 00516c9b (CONDITIONAL_JUMP)
    SUB ESI,ESI                         ; 00516cb1
        ;   Label: LAB_00516cb1
    PUSH ESI                            ; 00516cb3 | CHAR_ARRAY_02f3125b
        ;   Label: LAB_00516cb3
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 00516cb4 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ...
    PUSH 0x0                            ; 00516cc0
    PUSH EBX                            ; 00516cc2
    CALL shape_meshlod.cpp_CLodMesh_previewLodGeneration_FUN_0051d520 ; 00516cc3 | int shape_meshlod.cpp_CLodMesh_previewLodGeneration_FUN_0051d520(CLodMesh * this_ptr, int pause_flag, int render_mode)
        ;   XREF to: 0051d520 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00516cc8
    TEST EAX,EAX                        ; 00516ccb
    JZ 0x00516d2a                       ; 00516ccd | LAB_00516d2a
        ;   XREF to: 00516d2a (CONDITIONAL_JUMP)
    ...
    PUSH EDX                            ; 00516cd8
    PUSH EBX                            ; 00516cd9
    CALL shape_meshlod.cpp_CLodMesh_collapseEdge_FUN_00517630 ; 00516cda | void shape_meshlod.cpp_CLodMesh_collapseEdge_FUN_00517630(CLodMesh * this_ptr, int vertex_idx_1, int vertex_idx_2, float collapse_weight)
        ;   XREF to: 00517630 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00516cdf
    PUSH EDI                            ; 00516ce2
    PUSH EBX                            ; 00516ce3
    CALL shape_meshlod.cpp_CLodMesh_recordEdgeCollapse_FUN_0051d4a0 ; 00516ce4 | void shape_meshlod.cpp_CLodMesh_recordEdgeCollapse_FUN_0051d4a0(CLodMesh * this_ptr, CLodEdge * edge_data)
        ;   XREF to: 0051d4a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00516ce9
    CALL wincore_winrun.cpp_getTime_FUN_005f2dc0 ; 00516cec | int wincore_winrun.cpp_getTime_FUN_005f2dc0()
        ;   XREF to: 005f2dc0 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [ESP + 0xc]       ; 00516cf1
    MOV EDX,EAX                         ; 00516cf5
    SUB EAX,ECX                         ; 00516cf7
    TEST EAX,EAX                        ; 00516cf9
    JL 0x00516d26                       ; 00516cfb | LAB_00516d26
        ;   XREF to: 00516d26 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x18],EAX      ; 00516cfd
        ;   Label: LAB_00516cfd
    FILD dword ptr [ESP + 0x18]         ; 00516d01
    FMUL double ptr [0x0063765d]        ; 00516d05 | double DOUBLE_0063765d
    FMUL double ptr [0x00637665]        ; 00516d0b | double DOUBLE_00637665
    ...
    JMP 0x00516bc6                      ; 00516d21 | LAB_00516bc6
        ;   XREF to: 00516bc6 (UNCONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 00516d26
        ;   Label: LAB_00516d26
    JMP 0x00516cfd                      ; 00516d28 | LAB_00516cfd
        ;   XREF to: 00516cfd (UNCONDITIONAL_JUMP)
    MOV ESI,dword ptr [EBX + 0x38]      ; 00516d2a
        ;   Label: LAB_00516d2a
    PUSH ESI                            ; 00516d2d
    PUSH EBX                            ; 00516d2e
    CALL shape_meshlod.cpp_CLodMesh_saveReplayData_FUN_0051d250 ; 00516d2f | void shape_meshlod.cpp_CLodMesh_saveReplayData_FUN_0051d250(CLodMesh * this_ptr, FILE * file_handle)
        ;   XREF to: 0051d250 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00516d34
    PUSH EBX                            ; 00516d37
    CALL shape_meshlod.cpp_CLodMesh_closePrecomputeFile_FUN_0051b870 ; 00516d38 | void shape_meshlod.cpp_CLodMesh_closePrecomputeFile_FUN_0051b870(CLodMesh * this_ptr)
