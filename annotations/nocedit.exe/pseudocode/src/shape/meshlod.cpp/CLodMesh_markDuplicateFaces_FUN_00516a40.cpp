...
//   shape_meshlod.cpp_CLodMesh_postprocessMesh_FUN_0051b330 (0051b330) at 0051b398 [UNCONDITIONAL_CALL]
        ...
        do {
          ...
          if (*(int *)((int)pCVar1->edge_perpendiculars + local_20 + -0x14) == 0) {
            ...
            do {
              ...
              if (iVar4 == 3) {
                *(undefined4 *)((int)pCVar1->edge_perpendiculars + local_20 + -0x14) = 1;
                break;
              }
              iVar5 = iVar5 + 1;
            } while (iVar5 < 3);
