...
// Convention: __cdecl
// Signature: void shape_meshlod.cpp_CLodMesh_gridSave_FUN_0051d420(CLodMesh * this_ptr, FILE * file_handle)
// Cross-references:
//   shape_meshlod.cpp_CLodMesh_initializeLodGeneration_FUN_00516d50 (00516d50) at 00516db9 [UNCONDITIONAL_CALL]
// Globals:
...

{
  ...
  if (file_handle != (FILE *)0x0) {
    ...
    do {
      puVar1 = (undefined4 *)((int)this_ptr->spatial_grid_ptr->cell_start_indices[0][0] + iVar2);
      iVar2 = iVar2 + 4;
      crt_stdio_c_fprintf_FUN_005fe6d0(file_handle,"%d\n",*puVar1);
    } while (iVar2 != 0x4004);
    iVar3 = 0;
    for (iVar2 = 0; iVar2 < this_ptr->spatial_grid_ptr->triangle_count; iVar2 = iVar2 + 1) {
      puVar1 = (undefined4 *)(iVar3 + (int)this_ptr->spatial_grid_data);
      iVar3 = iVar3 + 4;
      crt_stdio_c_fprintf_FUN_005fe6d0(file_handle,"%d\n",*puVar1);
    }
  }
