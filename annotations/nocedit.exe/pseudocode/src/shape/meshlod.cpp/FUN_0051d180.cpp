// Name: shape_meshlod.cpp_FUN_0051d180
// Address: 0051d180
// Address Range: [[0051d180, 0051d24c]]
// Convention: unknown
// Signature: undefined shape_meshlod.cpp_FUN_0051d180()
// Cross-references:
...
void shape_meshlod_cpp_FUN_0051d180
...

{
  ...
  pvVar1 = shape_memdbg_cpp_debugCalloc_FUN_0050f350
                     (*(SIZE_T *)(param_5 + 0x4c),0xf0,"..\\shape\\meshlod.cpp",0x1446);
  *(void **)(param_5 + 0x50) = pvVar1;
  if (pvVar1 == (void *)0x0) {
    g_CurrentFilename = "..\\shape\\meshlod.cpp";
    g_CurrentLineNumber = 0x1447;
    core_main_c_displayErrorAndQuit_FUN_00506f10("Out of memory!",unaff_EBX);
  }
  iVar4 = 0;
  if (0 < *(int *)(param_5 + 0x4c)) {
    iVar3 = 0;
    do {
      iVar2 = *(int *)(param_5 + 0x50) + iVar3;
      iVar4 = iVar4 + 1;
      iVar3 = iVar3 + 0xf0;
      crt_stdio_c_fscanf_FUN_005fe7c0
                (param_6,"%d,%d,%lg,%g\n",iVar2,iVar2 + 4,iVar2 + 8,iVar2 + 0x10);
    } while (iVar4 < *(int *)(param_5 + 0x4c));
  }
  return;
}
...
// Assembly code:
// 0051d180: PUSH EBX
//   Label: shape_meshlod.cpp_FUN_0051d180
// 0051d181: PUSH ESI
// 0051d182: PUSH EDI
// 0051d183: PUSH EBP
