// Name: shape_meshlod.cpp_FUN_00516ba0
// Address: 00516ba0
// Address Range: [[00516ba0, 00516d46]]
// Convention: unknown
// Signature: undefined shape_meshlod.cpp_FUN_00516ba0()
// Cross-references:
...
//   shape_meshlod.cpp_FUN_00516d50
//   shape_meshlod.cpp_FUN_00517630
//   shape_meshlod.cpp_FUN_00519680
//   shape_meshlod.cpp_FUN_0051d250
//   shape_meshlod.cpp_FUN_0051d4a0
...
void shape_meshlod_cpp_FUN_00516ba0
...

{
  ...
  shape_meshlod_cpp_FUN_00516d50();
  iVar2 = wincore_winrun_cpp_getTime_FUN_005f2dc0();
  while (iVar3 = shape_meshlod_cpp_FUN_005164d0(), param_6 < iVar3) {
    uVar6 = shape_meshlod_cpp_FUN_00519680();
    if ((int)uVar6 < 0) break;
    fVar5 = (float10)in_stack_ffffffe0;
    dVar7 = crt_math_c_round_FUN_005fe6b0
                      ((double)CONCAT44((int)((ulonglong)uVar6 >> 0x20),(int)uVar6 * 0xf0));
    iVar1 = *(int *)(param_5 + 0x48);
    iVar2 = crt_stdio_c_sprintf_FUN_005fdbd0
                      (&DAT_02f31258,"Mesh degredation in progress...%d:%02d elapsed",(int)ROUND(fVar5) / 0x3c,
                       (int)ROUND(fVar5) % 0x3c,iVar2);
    if ((5 < unaff_EBX) && (iVar2 = *(int *)(*(int *)(param_5 + 0x34) + 8) - iVar3, 10 < iVar2)) {
      fVar5 = ((float10)(iVar3 - param_6) * (float10)in_stack_ffffffe8) / (float10)iVar2;
      dVar8 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44(param_6,iVar2));
      iVar2 = SUB84(dVar8,0);
...
LAB_00516cb3:
    ...
    iVar2 = shape_meshlod_cpp_FUN_0051d520(iVar2);
    if (iVar2 == 0) break;
    in_stack_ffffffe8 = *(float *)(iVar1 + SUB84(dVar7,0));
    in_stack_ffffffe0 = 7.477731e-39;
    iVar2 = param_5;
    shape_meshlod_cpp_FUN_00517630();
    shape_meshlod_cpp_FUN_0051d4a0();
    wincore_winrun_cpp_getTime_FUN_005f2dc0();
  }
  shape_meshlod_cpp_FUN_0051d250();
...
// Assembly code:
// 00516ba0: PUSH EBX
//   Label: shape_meshlod.cpp_FUN_00516ba0
// 00516ba1: PUSH ESI
// 00516ba2: PUSH EDI
// 00516ba3: PUSH EBP
...
// 00516baf: PUSH EBX
// 00516bb0: CALL shape_meshlod.cpp_FUN_00516d50
...
// 00516bc6: PUSH EBX
//   Label: LAB_00516bc6
// 00516bc7: CALL shape_meshlod.cpp_FUN_005164d0
...
// 00516bdc: PUSH EBX
// 00516bdd: CALL shape_meshlod.cpp_FUN_00519680
...
// 00516cd8: PUSH EDX
// 00516cd9: PUSH EBX
// 00516cda: CALL shape_meshlod.cpp_FUN_00517630
//   XREF to: 00517630 (UNCONDITIONAL_CALL)
// 00516cdf: ADD ESP,0x10
// 00516ce2: PUSH EDI
// 00516ce3: PUSH EBX
// 00516ce4: CALL shape_meshlod.cpp_FUN_0051d4a0
...
// 00516d2d: PUSH ESI
// 00516d2e: PUSH EBX
// 00516d2f: CALL shape_meshlod.cpp_FUN_0051d250
//   XREF to: 0051d250 (UNCONDITIONAL_CALL)
// 00516d34: ADD ESP,0x8
// 00516d37: PUSH EBX
// 00516d38: CALL shape_meshlod.cpp_TryingToCloseFileMaybe_FUN_0051b870
