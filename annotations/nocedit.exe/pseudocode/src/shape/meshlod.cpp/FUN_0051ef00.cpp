// Name: shape_meshlod.cpp_FUN_0051ef00
// Address: 0051ef00
// Address Range: [[0051ef00, 0051ef1a]]
// Convention: __cdecl
// Signature: SLodFace * shape_meshlod.cpp_FUN_0051ef00(SLodFace * this_ptr)
// Globals:
...
SLodFace * __cdecl shape_meshlod_cpp_FUN_0051ef00(SLodFace *this_ptr)

{
  void *pvVar1;
  
  pvVar1 = crt_memory_c_constructObjectArray_DefaultCtor_FUN_005fe667
                     (this_ptr->field0_0x0 + 0x54,3,&g_CVectorTypeInfo);
  return (SLodFace *)((int)pvVar1 + -0x54);
}


// Assembly code:
// 0051ef00: MOV EAX,dword ptr [ESP + 0x4]
//   Label: shape_meshlod.cpp_FUN_0051ef00
