...
//   shape_meshlod.cpp_CLodMesh_postprocessMesh_FUN_0051b330 (0051b330) at 0051b3c7 [UNCONDITIONAL_CALL]
  ...
  if (0 < this_ptr->vertex_count) {
    ...
    do {
      ...
      if (*(int *)((int)pCVar1->adjacent_edge_indices + iVar4 + -8) == 0) {
        *(undefined4 *)((int)pCVar1->adjacent_edge_indices + iVar4 + -8) = 0xffffffff;
      }
      else {
