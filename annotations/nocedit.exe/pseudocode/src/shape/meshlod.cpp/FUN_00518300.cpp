// Name: shape_meshlod.cpp_FUN_00518300
// Address: 00518300
// Address Range: [[00518300, 005183d2]]
// Convention: unknown
// Signature: undefined shape_meshlod.cpp_FUN_00518300()
// Cross-references:
//   shape_meshlod.cpp_FUN_00517000 (00517000) at 005170ff [UNCONDITIONAL_CALL]
//   shape_meshlod.cpp_FUN_00517630 (00517630) at 005182a7 [UNCONDITIONAL_CALL]
// Globals:
...
void shape_meshlod_cpp_FUN_00518300(void)

{
  ...
  iVar1 = *(int *)(in_stack_00000004 + 0x60) + in_stack_00000008 * 0x1c;
  *(undefined4 *)(iVar1 + 0x10) = 0x39a08ce9;
  *(undefined4 *)(iVar1 + 0x14) = 0x46293e59;
  *(undefined4 *)(iVar1 + 0xc) = 0xffffffff;
  iVar2 = 0;
  if (0 < *(int *)(in_stack_00000004 + 8)) {
    local_18 = 0;
    do {
      if (*(int *)(*(int *)(in_stack_00000004 + 0xc) + local_18 + 0x40) == 0) {
        dVar3 = (double)shape_meshlod_cpp_FUN_0051a400();
        if (dVar3 < *(double *)(iVar1 + 0x10)) {
          *(int *)(iVar1 + 0xc) = iVar2;
...
// Assembly code:
// 00518300: PUSH EBX
//   Label: shape_meshlod.cpp_FUN_00518300
// 00518301: PUSH ESI
// 00518302: PUSH EDI
// 00518303: PUSH EBP
