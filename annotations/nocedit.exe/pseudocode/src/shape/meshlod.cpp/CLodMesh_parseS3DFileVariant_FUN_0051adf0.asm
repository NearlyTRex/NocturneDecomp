...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_meshlod.cpp_CLodMesh_parseS3DFileVariant_FUN_0051adf0(CLodMesh * this_ptr, FILE * file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBP                            ; 0051ae0f
        ;   Label: LAB_0051ae0f
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 0051ae10 | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0051ae15
    TEST EAX,EAX                        ; 0051ae18
    JL 0x0051ae26                       ; 0051ae1a | LAB_0051ae26
        ;   XREF to: 0051ae26 (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 0051ae1c
    JNZ 0x0051ae0f                      ; 0051ae1f | LAB_0051ae0f
        ;   XREF to: 0051ae0f (CONDITIONAL_JUMP)
    DEC EBX                             ; 0051ae21
    TEST EBX,EBX                        ; 0051ae22
    JG 0x0051ae0f                       ; 0051ae24 | LAB_0051ae0f
        ;   XREF to: 0051ae0f (CONDITIONAL_JUMP)
    ...
    PUSH EBP                            ; 0051ae2d
        ;   Label: LAB_0051ae2d
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 0051ae2e | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0051ae33
    TEST EAX,EAX                        ; 0051ae36
    JL 0x0051ae44                       ; 0051ae38 | LAB_0051ae44
        ;   XREF to: 0051ae44 (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 0051ae3a
    JNZ 0x0051ae2d                      ; 0051ae3d | LAB_0051ae2d
        ;   XREF to: 0051ae2d (CONDITIONAL_JUMP)
    DEC EBX                             ; 0051ae3f
    TEST EBX,EBX                        ; 0051ae40
    JG 0x0051ae2d                       ; 0051ae42 | LAB_0051ae2d
        ;   XREF to: 0051ae2d (CONDITIONAL_JUMP)
    ...
    PUSH EDI                            ; 0051ae51
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0051ae52 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
    ...
    JLE 0x0051ae8f                      ; 0051ae76 | LAB_0051ae8f
        ;   XREF to: 0051ae8f (CONDITIONAL_JUMP)
    PUSH EBX                            ; 0051ae78
        ;   Label: LAB_0051ae78
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 0051ae79 | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0051ae7e
    TEST EAX,EAX                        ; 0051ae81
    JL 0x0051ae8f                       ; 0051ae83 | LAB_0051ae8f
        ;   XREF to: 0051ae8f (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 0051ae85
    JNZ 0x0051ae78                      ; 0051ae88 | LAB_0051ae78
        ;   XREF to: 0051ae78 (CONDITIONAL_JUMP)
    DEC EBP                             ; 0051ae8a
    TEST EBP,EBP                        ; 0051ae8b
    JG 0x0051ae78                       ; 0051ae8d | LAB_0051ae78
        ;   XREF to: 0051ae78 (CONDITIONAL_JUMP)
    ...
    PUSH EBP                            ; 0051ae96
        ;   Label: LAB_0051ae96
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 0051ae97 | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0051ae9c
    TEST EAX,EAX                        ; 0051ae9f
    JL 0x0051aead                       ; 0051aea1 | LAB_0051aead
        ;   XREF to: 0051aead (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 0051aea3
    JNZ 0x0051ae96                      ; 0051aea6 | LAB_0051ae96
        ;   XREF to: 0051ae96 (CONDITIONAL_JUMP)
    DEC EBX                             ; 0051aea8
    TEST EBX,EBX                        ; 0051aea9
    JG 0x0051ae96                       ; 0051aeab | LAB_0051ae96
        ;   XREF to: 0051ae96 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 0051aec4
    PUSH 0x637c6e                       ; 0051aec5 | = "%d,%d,%d\n" | s_d_d_d_00637c6e = %d,%d,%d

    PUSH EDI                            ; 0051aeca
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0051aecb | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ...
    CALL shape_meshlod.cpp_CLodMesh_allocate_FUN_00515ac0 ; 0051aef3 | void shape_meshlod.cpp_CLodMesh_allocate_FUN_00515ac0(CLodMesh * this_ptr, int vertex_count, int tri_count, int submesh_count)
        ;   XREF to: 00515ac0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0051aef8
    PUSH EBP                            ; 0051aefb
        ;   Label: LAB_0051aefb
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 0051aefc | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0051af01
    TEST EAX,EAX                        ; 0051af04
    JL 0x0051af12                       ; 0051af06 | LAB_0051af12
        ;   XREF to: 0051af12 (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 0051af08
    JNZ 0x0051aefb                      ; 0051af0b | LAB_0051aefb
        ;   XREF to: 0051aefb (CONDITIONAL_JUMP)
    DEC EBX                             ; 0051af0d
    TEST EBX,EBX                        ; 0051af0e
    JG 0x0051aefb                       ; 0051af10 | LAB_0051aefb
        ;   XREF to: 0051aefb (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESI + 0x10]      ; 0051af12
        ;   Label: LAB_0051af12
    XOR EBP,EBP                         ; 0051af15
    TEST EAX,EAX                        ; 0051af17
    JLE 0x0051af80                      ; 0051af19 | LAB_0051af80
    ...
    PUSH EDI                            ; 0051af25
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0051af26 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0051af40
    CALL crt_string.c_splitpath_FUN_005ff178 ; 0051af41 | void crt_string.c_splitpath_FUN_005ff178(char * path, char * drive, char * dir, char * fname, ...)
        ;   XREF to: 005ff178 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0051af46
    PUSH 0x637c7f                       ; 0051af49 | = "raw" | s_raw_00637c7f = raw
    ...
    CALL crt_file.c_makepath_FUN_005febfc ; 0051af67 | void crt_file.c_makepath_FUN_005febfc(char * path_buffer, char * drive, char * directory, char * filename, ...)
        ;   XREF to: 005febfc (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [ESI + 0x10]      ; 0051af6c
    ADD ESP,0x14                        ; 0051af6f
    CMP EBP,EDX                         ; 0051af72
    JL 0x0051af1d                       ; 0051af74 | LAB_0051af1d
    ...
    PUSH EBP                            ; 0051af87
        ;   Label: LAB_0051af87
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 0051af88 | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0051af8d
    TEST EAX,EAX                        ; 0051af90
    JL 0x0051af9e                       ; 0051af92 | LAB_0051af9e
        ;   XREF to: 0051af9e (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 0051af94
    JNZ 0x0051af87                      ; 0051af97 | LAB_0051af87
        ;   XREF to: 0051af87 (CONDITIONAL_JUMP)
    DEC EBX                             ; 0051af99
    TEST EBX,EBX                        ; 0051af9a
    JG 0x0051af87                       ; 0051af9c | LAB_0051af87
        ;   XREF to: 0051af87 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [ESI + 0x8]       ; 0051af9e
        ;   Label: LAB_0051af9e
    XOR EBP,EBP                         ; 0051afa1
    TEST ECX,ECX                        ; 0051afa3
    JLE 0x0051aff0                      ; 0051afa5 | LAB_0051aff0
    ...
    PUSH EDX                            ; 0051afd1
    PUSH EAX                            ; 0051afd2
    PUSH 0x637c83                       ; 0051afd3 | = "%d, %d,%f,%f, %d,%f,%f, %d,%f,%f\n" | s_d_d_f_f_d_f_f_d_f_f_00637c83 = %d, %d,%f,%f, %d,%f,%f, %d,%f,%f

    PUSH EDI                            ; 0051afd8
    INC EBP                             ; 0051afd9
    ADD EBX,0x8c                        ; 0051afda
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0051afe0 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [ESI + 0x8]       ; 0051afe5
    ADD ESP,0x30                        ; 0051afe8
    CMP EBP,EAX                         ; 0051afeb
    JL 0x0051afa9                       ; 0051afed | LAB_0051afa9
    ...
    PUSH EBP                            ; 0051aff7
        ;   Label: LAB_0051aff7
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 0051aff8 | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0051affd
    TEST EAX,EAX                        ; 0051b000
    JL 0x0051b00e                       ; 0051b002 | LAB_0051b00e
        ;   XREF to: 0051b00e (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 0051b004
    JNZ 0x0051aff7                      ; 0051b007 | LAB_0051aff7
        ;   XREF to: 0051aff7 (CONDITIONAL_JUMP)
    DEC EBX                             ; 0051b009
    TEST EBX,EBX                        ; 0051b00a
    JG 0x0051aff7                       ; 0051b00c | LAB_0051aff7
        ;   XREF to: 0051aff7 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [ESI]             ; 0051b00e
        ;   Label: LAB_0051b00e
    XOR EBP,EBP                         ; 0051b010
    TEST EDX,EDX                        ; 0051b012
    JLE 0x0051b050                      ; 0051b014 | LAB_0051b050
    ...
    PUSH EDX                            ; 0051b024
    PUSH EAX                            ; 0051b025
    PUSH 0x637ca5                       ; 0051b026 | = "%f,%f,%f\n" | s_f_f_f_00637ca5 = %f,%f,%f

    PUSH EDI                            ; 0051b02b
    INC EBP                             ; 0051b02c
    ADD EBX,0x4c4                       ; 0051b02d
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0051b033 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [ESI]             ; 0051b038
    ADD ESP,0x14                        ; 0051b03a
    CMP EBP,ECX                         ; 0051b03d
    JL 0x0051b018                       ; 0051b03f | LAB_0051b018
    ...
    CALL shape_meshlod.cpp_CLodMesh_postprocessMesh_FUN_0051b330 ; 0051b066 | void shape_meshlod.cpp_CLodMesh_postprocessMesh_FUN_0051b330(CLodMesh * this_ptr)
