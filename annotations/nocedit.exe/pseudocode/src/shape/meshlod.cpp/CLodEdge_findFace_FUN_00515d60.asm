...
;                               FUNCTION
; *****************************************************************************
; __cdecl int shape_meshlod.cpp_CLodEdge_findFace_FUN_00515d60(CLodEdge * this_ptr, int tri_index)
;
; Parameters:
