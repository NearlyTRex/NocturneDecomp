...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_meshlod.cpp_CLodMesh_recordEdgeCollapse_FUN_0051d4a0(CLodMesh * this_ptr, CLodEdge * edge_data)
;
; Parameters:
...
section .text
    ...
    PUSH 0x638207                       ; 0051d4bc | = "..\\shape\\meshlod.cpp" | s_shape_meshlod_cpp_00638207 = ..\shape\meshlod.cpp
    SUB EAX,EDX                         ; 0051d4c1
    PUSH EAX                            ; 0051d4c3
    MOV ECX,dword ptr [EBX + 0x50]      ; 0051d4c4
    PUSH ECX                            ; 0051d4c7
    CALL shape_memdbg.cpp_debugRealloc_FUN_0050f540 ; 0051d4c8 | void * shape_memdbg.cpp_debugRealloc_FUN_0050f540(void * ptr, int new_size, char * filename, int line_number)
        ;   XREF to: 0050f540 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0051d4cd
    MOV dword ptr [EBX + 0x50],EAX      ; 0051d4d0
    TEST EAX,EAX                        ; 0051d4d3
    JZ 0x0051d4fa                       ; 0051d4d5 | LAB_0051d4fa
    ...
    POP EBX                             ; 0051d4f8
    RET                                 ; 0051d4f9
    MOV EDI,0x63821c                    ; 0051d4fa | = "..\\shape\\meshlod.cpp" | s_shape_meshlod_cpp_0063821c = ..\shape\meshlod.cpp
        ;   Label: LAB_0051d4fa
    MOV EBP,0x14a5                      ; 0051d4ff
    PUSH 0x638231                       ; 0051d504 | = "out of memory" | s_out_of_memory_00638231 = out of memory
    MOV dword ptr [0x02f0ca48],EDI      ; 0051d509 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBP      ; 0051d50f | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0051d515 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0051d51a
    JMP 0x0051d4d7                      ; 0051d51d | LAB_0051d4d7
