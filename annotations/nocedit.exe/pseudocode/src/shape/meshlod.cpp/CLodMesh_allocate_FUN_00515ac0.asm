...
section .text
    ...
    PUSH EBX                            ; 00515ac8
    CALL shape_meshlod.cpp_CLodMesh_free_FUN_00515970 ; 00515ac9
    ...
    PUSH 0x63740a                       ; 00515ae3 | = "..\\shape\\meshlod.cpp"
    ...
    CALL shape_memdbg.cpp_debugCalloc_FUN_0050f350 ; 00515afe
    ...
    PUSH 0x232                          ; 00515b06
    PUSH 0x63741f                       ; 00515b0b | = "..\\shape\\meshlod.cpp"
    PUSH 0x8c                           ; 00515b10
    MOV ECX,dword ptr [EBX + 0x40]      ; 00515b15
    PUSH ECX                            ; 00515b18
    MOV dword ptr [EBX + 0x4],EAX       ; 00515b19
    CALL shape_memdbg.cpp_debugCalloc_FUN_0050f350 ; 00515b1c
        ;   XREF to: 0050f350 (UNCONDITIONAL_CALL)  ; void * shape_memdbg.cpp_debugCalloc_FUN_0050f350(SIZE_T count, SIZE_T size, char * filename, int line_number)
    ADD ESP,0x10                        ; 00515b21
    PUSH 0x233                          ; 00515b24
    PUSH 0x637434                       ; 00515b29 | = "..\\shape\\meshlod.cpp"
    PUSH 0x48                           ; 00515b2e
    MOV ESI,dword ptr [EBX + 0x10]      ; 00515b30
    PUSH ESI                            ; 00515b33
    MOV dword ptr [EBX + 0xc],EAX       ; 00515b34
    CALL shape_memdbg.cpp_debugCalloc_FUN_0050f350 ; 00515b37
        ;   XREF to: 0050f350 (UNCONDITIONAL_CALL)  ; void * shape_memdbg.cpp_debugCalloc_FUN_0050f350(SIZE_T count, SIZE_T size, char * filename, int line_number)
    ADD ESP,0x10                        ; 00515b3c
    MOV EDI,dword ptr [EBX + 0x3c]      ; 00515b3f
    MOV dword ptr [EBX + 0x14],EAX      ; 00515b42
    TEST EDI,EDI                        ; 00515b45
    JLE 0x00515b4f                      ; 00515b47
        ;   XREF to: 00515b4f (CONDITIONAL_JUMP)  ; LAB_00515b4f
    CMP dword ptr [EBX + 0x4],0x0       ; 00515b49
    JZ 0x00515b6c                       ; 00515b4d
        ;   XREF to: 00515b6c (CONDITIONAL_JUMP)  ; LAB_00515b6c
    CMP dword ptr [EBX + 0x40],0x0      ; 00515b4f
        ;   Label: LAB_00515b4f
    JLE 0x00515b5b                      ; 00515b53
        ;   XREF to: 00515b5b (CONDITIONAL_JUMP)  ; LAB_00515b5b
    CMP dword ptr [EBX + 0xc],0x0       ; 00515b55
    JZ 0x00515b6c                       ; 00515b59
        ;   XREF to: 00515b6c (CONDITIONAL_JUMP)  ; LAB_00515b6c
    CMP dword ptr [EBX + 0x10],0x0      ; 00515b5b
        ;   Label: LAB_00515b5b
    JLE 0x00515b67                      ; 00515b5f
        ;   XREF to: 00515b67 (CONDITIONAL_JUMP)  ; LAB_00515b67
    CMP dword ptr [EBX + 0x14],0x0      ; 00515b61
    JZ 0x00515b6c                       ; 00515b65
        ;   XREF to: 00515b6c (CONDITIONAL_JUMP)  ; LAB_00515b6c
    POP EBP                             ; 00515b67
        ;   Label: LAB_00515b67
    POP EDI                             ; 00515b68
    ...
    POP EBX                             ; 00515b6a
    RET                                 ; 00515b6b
    MOV EDI,0x637449                    ; 00515b6c | = "..\\shape\\meshlod.cpp"
        ;   Label: LAB_00515b6c
    MOV EBP,0x23a                       ; 00515b71
    PUSH 0x63745e                       ; 00515b76 | = "No mem!"
    MOV dword ptr [0x02f0ca48],EDI      ; 00515b7b | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBP      ; 00515b81 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00515b87
