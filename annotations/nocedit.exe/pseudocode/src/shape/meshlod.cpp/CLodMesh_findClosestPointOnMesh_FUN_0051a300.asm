...
;                               FUNCTION
; *****************************************************************************
; __cdecl CVector3f * shape_meshlod.cpp_CLodMesh_findClosestPointOnMesh_FUN_0051a300(CLodMesh * this_ptr, CVector3f * output_closest_point, CVector3f * target_point)
;
; Parameters:
...
section .text
    ...
    JLE 0x0051a35c                      ; 0051a331 | LAB_0051a35c
    ...
    JZ 0x0051a365                       ; 0051a33f | LAB_0051a365
    ...
    JL 0x0051a333                       ; 0051a35a | LAB_0051a333
    ...
    PUSH ECX                            ; 0051a36f
    CALL shape_meshlod.cpp_CLodMesh_computeClosestPointOnTriangle_FUN_0051a6b0 ; 0051a370 | CVector3f * shape_meshlod.cpp_CLodMesh_computeClosestPointOnTriangle_FUN_0051a6b0(CLodMesh * this_ptr, CVector3f * output_point, CVector3f * target_point, CLodFace * triangle_ptr)
    ...
    FNSTSW AX                           ; 0051a3a1
    SAHF                                ; 0051a3a3
    JNC 0x0051a341                      ; 0051a3a4 | LAB_0051a341
    ...
    JZ 0x0051a341                       ; 0051a3bb | LAB_0051a341
        ;   XREF to: 0051a341 (CONDITIONAL_JUMP)
    ...
    JMP 0x0051a341                      ; 0051a3d1 | LAB_0051a341
