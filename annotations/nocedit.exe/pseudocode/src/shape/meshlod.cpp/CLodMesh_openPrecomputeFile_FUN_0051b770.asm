...
;                               FUNCTION
; *****************************************************************************
; __cdecl FILE * shape_meshlod.cpp_CLodMesh_openPrecomputeFile_FUN_0051b770(CLodMesh * this_ptr, char * mode)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 0051b797
    PUSH 0x67d3a0                       ; 0051b798 | = "meshlod" | s_meshlod_0067d3a0 = meshlod
    CALL crt_string.c_splitpath_FUN_005ff178 ; 0051b79d | void crt_string.c_splitpath_FUN_005ff178(char * path, char * drive, char * dir, char * fname, ...)
    ...
    PUSH EAX                            ; 0051b7c6
    CALL crt_file.c_makepath_FUN_005febfc ; 0051b7c7 | void crt_file.c_makepath_FUN_005febfc(char * path_buffer, char * drive, char * directory, char * filename, ...)
    ...
    CALL shape_meshlod.cpp_CLodMesh_computeMeshCRC32_FUN_0051c6f0 ; 0051b7e8 | void shape_meshlod.cpp_CLodMesh_computeMeshCRC32_FUN_0051c6f0(CLodMesh * this_ptr, uint * out_crc)
        ;   XREF to: 0051c6f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0051b7ed
    MOV EBX,dword ptr [ESP + 0x504]     ; 0051b7f0
    PUSH EBX                            ; 0051b7f7
    PUSH 0x637d25                       ; 0051b7f8 | = "%08X" | s_s_08X_00637d25 = %08X
    LEA EAX,[ESP + 0x20c]               ; 0051b7fd
    PUSH EAX                            ; 0051b804
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0051b805 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0051b80a
    PUSH 0x637d2a                       ; 0051b80d | = "lod" | s_lod_00637d2a = lod
    ...
    PUSH EAX                            ; 0051b82e
    CALL crt_file.c_makepath_FUN_005febfc ; 0051b82f | void crt_file.c_makepath_FUN_005febfc(char * path_buffer, char * drive, char * directory, char * filename, ...)
        ;   XREF to: 005febfc (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0051b834
    PUSH 0x1239                         ; 0051b837
    PUSH 0x637d2e                       ; 0051b83c | = "..\\shape\\meshlod.cpp" | s_shape_meshlod_cpp_00637d2e = ..\shape\meshlod.cpp
    MOV ESI,dword ptr [ESP + 0x524]     ; 0051b841
    PUSH ESI                            ; 0051b848
    PUSH 0x0                            ; 0051b849
    LEA EAX,[ESP + 0x10]                ; 0051b84b
    PUSH EAX                            ; 0051b84f
    CALL shape_memdbg.cpp_openFile_FUN_0050f7a0 ; 0051b850 | FILE * shape_memdbg.cpp_openFile_FUN_0050f7a0(char * filename, char * directory, char * mode, char * source_file, ...)
