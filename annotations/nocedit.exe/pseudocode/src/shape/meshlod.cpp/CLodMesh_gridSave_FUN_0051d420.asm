...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_meshlod.cpp_CLodMesh_gridSave_FUN_0051d420(CLodMesh * this_ptr, FILE * file_handle)
;
; Parameters:
...
section .text
    ...
    JNZ 0x0051d435                      ; 0051d42e | LAB_0051d435
    ...
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0051d43f | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0051d457 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0051d45c
    CMP EBX,0x4004                      ; 0051d45f
    JNZ 0x0051d447                      ; 0051d465 | LAB_0051d447
    ...
    JGE 0x0051d430                      ; 0051d474 | LAB_0051d430
    ...
    INC EBX                             ; 0051d486
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0051d487 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0051d48c
    JMP 0x0051d46b                      ; 0051d48f | LAB_0051d46b
