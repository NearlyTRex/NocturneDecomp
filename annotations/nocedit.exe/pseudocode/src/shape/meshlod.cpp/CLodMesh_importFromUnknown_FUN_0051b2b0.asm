...
section .text
    ...
    MOV EDX,0x637caf                    ; 0051b2b0 | = "..\\shape\\meshlod.cpp"
        ;   Label: shape_meshlod.cpp_CLodMesh_importFromUnknown_FUN_0051b2b0
    MOV ECX,0x1180                      ; 0051b2b5
    PUSH 0x637cc4                       ; 0051b2ba | = "Write me!"
    MOV dword ptr [0x02f0ca48],EDX      ; 0051b2bf | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 0051b2c5 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0051b2cb
