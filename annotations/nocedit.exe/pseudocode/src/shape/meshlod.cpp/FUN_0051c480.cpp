// Name: shape_meshlod.cpp_FUN_0051c480
// Address: 0051c480
// Address Range: [[0051c480, 0051c535]]
// Convention: unknown
// Signature: undefined shape_meshlod.cpp_FUN_0051c480()

#include "nocturne.h"

void shape_meshlod_cpp_FUN_0051c480(void)

{
  ...
  do {
    while( true ) {
      *in_stack_00000004 = *in_stack_00000004 ^ (uint)*pbVar1 << 0x18;
    ...
    pbVar1 = pbVar1 + 1;
    iVar3 = iVar3 + -1;
    *in_stack_00000004 = uVar2 * 2 ^ 0x4c11db7;
  } while (0 < iVar3);
  return;
}
...
// Assembly code:
// 0051c480: PUSH EBX
//   Label: shape_meshlod.cpp_FUN_0051c480
// 0051c481: PUSH ESI
// 0051c482: PUSH EDI
// 0051c483: PUSH EBP
