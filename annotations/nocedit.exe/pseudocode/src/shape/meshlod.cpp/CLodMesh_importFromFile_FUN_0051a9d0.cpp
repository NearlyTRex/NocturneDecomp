...
// Convention: __cdecl
// Signature: void __cdecl shape_meshlod_cpp_CLodMesh_importFromFile_FUN_0051a9d0(CLodMesh *this_ptr,char *filename)
...

{
  ...
  file_handle = shape_memdbg_cpp_openFile_FUN_0050f7a0
                          (filename,(char *)0x0,"rt","..\\shape\\meshlod.cpp",4194);
  if (file_handle == (_FILE *)0x0) {
    g_CurrentFilename = "..\\shape\\meshlod.cpp";
    g_CurrentLineNumber = 4195;
  ...
  shape_memdbg_cpp_closeFile_FUN_0050f9b0(file_handle,"..\\shape\\meshlod.cpp",4203);
  return;
}
