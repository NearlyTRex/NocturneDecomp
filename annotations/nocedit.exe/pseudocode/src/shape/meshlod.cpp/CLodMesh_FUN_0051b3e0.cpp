// Name: shape_meshlod.cpp_CLodMesh_FUN_0051b3e0
// Address: 0051b3e0
// Address Range: [[0051b3e0, 0051b568]]
// Convention: __cdecl
// Signature: void shape_meshlod.cpp_CLodMesh_FUN_0051b3e0(CLodMesh * this_ptr)
// Cross-references:
//   shape_meshlod.cpp_CLodMesh_FUN_0051b330 (0051b330) at 0051b3c7 [UNCONDITIONAL_CALL]
//   shape_meshlod.cpp_CLodMesh_getLOD_FUN_0051b920 (0051b920) at 0051b9d1 [UNCONDITIONAL_CALL]

#include "nocturne.h"

void __cdecl shape_meshlod_cpp_CLodMesh_FUN_0051b3e0(CLodMesh *this_ptr)

{
  ...
  if (0 < this_ptr->vertex_count) {
    iVar2 = 0;
    do {
      *(undefined4 *)((int)this_ptr->vertex_data->adjacent_edge_indices + iVar2 + -8) = 0;
      iVar3 = iVar3 + 1;
      iVar2 = iVar2 + 0x4c4;
  ...
  if (0 < this_ptr->tri_count) {
    do {
      if (*(int *)(this_ptr->triangle_data->field10_0x50 + iVar3 + -0x10) == 0) {
        iVar2 = 0;
        do {
          iVar4 = iVar2 + iVar3;
          iVar2 = iVar2 + 4;
          pSVar1 = this_ptr->vertex_data +
                   *(int *)(this_ptr->triangle_data->field4_0x1c + iVar4 + -0xc);
          pSVar1->field0_0x0[0x3f4] = '\x01';
          pSVar1->field0_0x0[0x3f5] = '\0';
          pSVar1->field0_0x0[0x3f6] = '\0';
          pSVar1->field0_0x0[0x3f7] = '\0';
        } while (iVar2 != 0xc);
      }
      iVar3 = iVar3 + 0x8c;
      local_18 = local_18 + 1;
  ...
  if (0 < this_ptr->vertex_count) {
    ...
    do {
      pSVar1 = this_ptr->vertex_data;
      if (*(int *)((int)pSVar1->adjacent_edge_indices + iVar4 + -8) == 0) {
        *(undefined4 *)((int)pSVar1->adjacent_edge_indices + iVar4 + -8) = 0xffffffff;
      }
      else {
        *(int *)((int)pSVar1->adjacent_edge_indices + iVar4 + -8) = iVar3;
        iVar3 = iVar3 + 1;
      }
      iVar2 = iVar2 + 1;
      iVar4 = iVar4 + 0x4c4;
  ...
  if (0 < this_ptr->tri_count) {
    ...
    do {
      if (*(int *)(this_ptr->triangle_data->field10_0x50 + iVar3 + -0x10) == 0) {
        ...
        do {
          iVar4 = iVar2 + 4;
          *(undefined4 *)(this_ptr->triangle_data->field4_0x1c + iVar2 + iVar3 + -0xc) =
               *(undefined4 *)
                (this_ptr->vertex_data
                 [*(int *)(this_ptr->triangle_data->field4_0x1c + iVar2 + iVar3 + -0xc)].field0_0x0
                + 0x3f4);
          iVar2 = iVar4;
        } while (iVar4 != 0xc);
      }
  ...
  if (0 < this_ptr->vertex_count) {
    ...
    local_1c = 0;
    do {
      pcVar5 = this_ptr->vertex_data->field0_0x0 + local_1c;
      if (-1 < *(int *)(pcVar5 + 0x3f4)) {
        if (iVar3 < iVar2) {
          pcVar6 = this_ptr->vertex_data->field0_0x0 + local_20;
...
// Assembly code:
// 0051b3e0: PUSH EBX
//   Label: shape_meshlod.cpp_CLodMesh_FUN_0051b3e0
// 0051b3e1: PUSH ESI
// 0051b3e2: PUSH EDI
// 0051b3e3: PUSH EBP
