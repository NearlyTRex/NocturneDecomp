// Name: shape_meshlod.cpp_FUN_00515ba0
// Address: 00515ba0
// Address Range: [[00515ba0, 00515c98]]
// Convention: unknown
// Signature: undefined shape_meshlod.cpp_FUN_00515ba0()
// Cross-references:
//   shape_meshlod.cpp_FUN_00516d50 (00516d50) at 00516dc2 [UNCONDITIONAL_CALL]
//   shape_meshlod.cpp_FUN_0051b8a0 (0051b8a0) at 0051b8e4 [UNCONDITIONAL_CALL]
//   shape_meshlod.cpp_LodMesh_getLOD_FUN_0051b920 (0051b920) at 0051b94d [UNCONDITIONAL_CALL]
// Function calls:
...
undefined8 shape_meshlod_cpp_FUN_00515ba0(void)

{
  ...
  if (0 < iVar3) {
    iVar3 = 0;
    do {
      *(undefined4 *)(iVar3 + 0x3f8 + in_stack_00000004[1]) = 0;
      local_1c = local_1c + 1;
      iVar3 = iVar3 + 0x4c4;
  ...
  if (0 < in_stack_00000004[2]) {
    local_1c = 0;
    do {
      iVar3 = local_1c + in_stack_00000004[3];
      if (*(int *)(iVar3 + 0x40) == 0) {
        iVar4 = 0;
        do {
          uVar1 = shape_meshlod_cpp_MemoryAdjacentThing_FUN_00515ec0();
          iVar2 = iVar4 + -1;
          if (iVar2 < 0) {
            iVar2 = 2;
          }
          *(undefined4 *)(iVar2 * 4 + iVar3 + 0x34) = uVar1;
          local_1c = local_18;
          iVar4 = iVar4 + 1;
  ...
  return CONCAT44(iVar3,local_1c);
}


// Assembly code:
// 00515ba0: PUSH EBX
//   Label: shape_meshlod.cpp_FUN_00515ba0
// 00515ba1: PUSH ESI
// 00515ba2: PUSH EDI
// 00515ba3: PUSH EBP
...
// 00515c2b: PUSH EAX
// 00515c2c: PUSH EDI
// 00515c2d: CALL shape_meshlod.cpp_MemoryAdjacentThing_FUN_00515ec0
