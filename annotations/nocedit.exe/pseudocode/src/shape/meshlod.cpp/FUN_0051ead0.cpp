// Name: shape_meshlod.cpp_FUN_0051ead0
// Address: 0051ead0
// Address Range: [[0051ead0, 0051ecc9]]
// Convention: unknown
// Signature: undefined shape_meshlod.cpp_FUN_0051ead0()
// Cross-references:
...
//   undefined1 DAT_02f31248
//   undefined1 DAT_02f31249
//   undefined1 DAT_02f3124a
//   undefined1 DAT_02f3124b
// Function calls:
...

{
  ...
  if (0 < iVar3) {
    local_20 = 0;
    do {
      local_18 = (int *)(local_20 + *(int *)(in_stack_00000004 + 0xc));
      if (local_18[0x10] == 0) {
        atlas_texture_index = (int *)*local_18;
        if ((-1 < (int)atlas_texture_index) && (in_stack_00000008 != 0)) {
          atlas_texture_index =
               (int *)shape_design_c_findTextureByFilename_FUN_0046dfc0
                                ((char *)(*(int *)(in_stack_00000004 + 0x14) +
                                          (int)atlas_texture_index * 0x48 + 8));
          ...
          if (atlas_texture_index != local_1c) {
            if (in_stack_00000010 == 0) {
              texture = (SMRGLTextureBasic *)
                        ((int)atlas_texture_index * 0x48 + *(int *)(in_stack_0000000c + 0x14));
            }
            else {
              ...
              texture = (SMRGLTextureBasic *)&DAT_02f31240;
            }
    ...
    } while ((int)local_1c < *(int *)(in_stack_00000004 + 8));
  }
  return;
}
...
// Assembly code:
// 0051ead0: PUSH EBX
//   Label: shape_meshlod.cpp_FUN_0051ead0
// 0051ead1: PUSH ESI
// 0051ead2: PUSH EDI
// 0051ead3: PUSH EBP
