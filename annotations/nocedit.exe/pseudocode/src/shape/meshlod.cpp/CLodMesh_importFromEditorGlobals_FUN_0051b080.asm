...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_meshlod.cpp_CLodMesh_importFromEditorGlobals_FUN_0051b080(CLodMesh * this_ptr)
;
; Parameters:
...
section .text
    ...
    CALL shape_meshlod.cpp_CLodMesh_free_FUN_00515970 ; 0051b090 | void shape_meshlod.cpp_CLodMesh_free_FUN_00515970(CLodMesh * this_ptr)
        ;   XREF to: 00515970 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [0x016e990c]      ; 0051b095 | int g_PolygonCount
    ADD ESP,0x4                         ; 0051b09b
    TEST ECX,ECX                        ; 0051b09e
    JLE 0x0051b0e1                      ; 0051b0a0 | LAB_0051b0e1
        ;   XREF to: 0051b0e1 (CONDITIONAL_JUMP)
    XOR EBX,EBX                         ; 0051b0a2
    MOV EAX,dword ptr [EBX + 0x16e99b4] ; 0051b0a4 | DAT_016e99b4
        ;   Label: LAB_0051b0a4
    SUB EAX,0x2                         ; 0051b0aa
    ADD EDI,EAX                         ; 0051b0ad
    CMP byte ptr [EBX + 0x16e9914],0x0  ; 0051b0af | DAT_016e9914
    JZ 0x0051b0d0                       ; 0051b0b6 | LAB_0051b0d0
        ;   XREF to: 0051b0d0 (CONDITIONAL_JUMP)
    MOV EAX,0x16e9910                   ; 0051b0b8 | SShapeEditorPolygon[20000] g_ModelPolygonData
    ADD EAX,EBX                         ; 0051b0bd
    ADD EAX,0x4                         ; 0051b0bf | DAT_016e9914
    PUSH EAX                            ; 0051b0c2 | DAT_016e9914
    MOV EBP,dword ptr [ESP + 0x28]      ; 0051b0c3
    PUSH EBP                            ; 0051b0c7
    CALL shape_meshlod.cpp_CLodMesh_findOrAddSubmesh_FUN_00518790 ; 0051b0c8 | int shape_meshlod.cpp_CLodMesh_findOrAddSubmesh_FUN_00518790(CLodMesh * this_ptr, char * texture_filename)
        ;   XREF to: 00518790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0051b0cd
    MOV EBP,dword ptr [0x016e990c]      ; 0051b0d0 | int g_PolygonCount
        ;   Label: LAB_0051b0d0
    INC ESI                             ; 0051b0d6
    ADD EBX,0x184                       ; 0051b0d7
    CMP ESI,EBP                         ; 0051b0dd
    JL 0x0051b0a4                       ; 0051b0df | LAB_0051b0a4
    ...
    PUSH EDX                            ; 0051b0e8
    PUSH EDI                            ; 0051b0e9
    MOV ECX,dword ptr [0x01626408]      ; 0051b0ea | int g_VertexCount
    PUSH ECX                            ; 0051b0f0
    PUSH EAX                            ; 0051b0f1
    MOV EBX,EAX                         ; 0051b0f2
    CALL shape_meshlod.cpp_CLodMesh_allocate_FUN_00515ac0 ; 0051b0f4 | void shape_meshlod.cpp_CLodMesh_allocate_FUN_00515ac0(CLodMesh * this_ptr, int vertex_count, int tri_count, int submesh_count)
    ...
    JLE 0x0051b150                      ; 0051b104 | LAB_0051b150
    ...
    JL 0x0051b10a                       ; 0051b14e | LAB_0051b10a
        ;   XREF to: 0051b10a (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x24]      ; 0051b150
        ;   Label: LAB_0051b150
    XOR ECX,ECX                         ; 0051b154
    MOV ESI,dword ptr [0x016e990c]      ; 0051b156 | int g_PolygonCount
    ...
    JLE 0x0051b261                      ; 0051b16d | LAB_0051b261
    ...
    JLE 0x0051b24a                      ; 0051b197 | LAB_0051b24a
        ;   XREF to: 0051b24a (CONDITIONAL_JUMP)
    MOV EAX,0x16e9910                   ; 0051b19d | SShapeEditorPolygon[20000] g_ModelPolygonData
    ...
    TEST DL,DL                          ; 0051b1c8
    JNZ 0x0051b28b                      ; 0051b1ca | LAB_0051b28b
    ...
    MOV EAX,dword ptr [ESI + 0x16e99c4] ; 0051b1fa | DAT_016e99cc
    MOV dword ptr [EBX + 0x14],EAX      ; 0051b200
    MOV EAX,dword ptr [ESI + 0x16e9a04] ; 0051b203 | DAT_016e9a0c
    MOV dword ptr [EBX + 0x24],EAX      ; 0051b209
    MOV EAX,dword ptr [ESI + 0x16e9a44] ; 0051b20c | DAT_016e9a4c
    MOV dword ptr [EBX + 0x28],EAX      ; 0051b212
    MOV EAX,dword ptr [ESI + 0x16e99c8] ; 0051b215 | DAT_016e99d0
    ...
    JL 0x0051b1aa                       ; 0051b244 | LAB_0051b1aa
        ;   XREF to: 0051b1aa (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [ESP + 0x4]       ; 0051b24a
        ;   Label: LAB_0051b24a
    INC EDI                             ; 0051b24e
    MOV EBP,dword ptr [0x016e990c]      ; 0051b24f | int g_PolygonCount
    MOV dword ptr [ESP + 0x4],EDI       ; 0051b255
    CMP EDI,EBP                         ; 0051b259
    JL 0x0051b173                       ; 0051b25b | LAB_0051b173
    ...
    CALL shape_meshlod.cpp_CLodMesh_postprocessMesh_FUN_0051b330 ; 0051b27b | void shape_meshlod.cpp_CLodMesh_postprocessMesh_FUN_0051b330(CLodMesh * this_ptr)
    ...
    PUSH EDX                            ; 0051b293
    CALL shape_meshlod.cpp_CLodMesh_findOrAddSubmesh_FUN_00518790 ; 0051b294 | int shape_meshlod.cpp_CLodMesh_findOrAddSubmesh_FUN_00518790(CLodMesh * this_ptr, char * texture_filename)
        ;   XREF to: 00518790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0051b299
    MOV dword ptr [EBX],EAX             ; 0051b29c
    JMP 0x0051b1d6                      ; 0051b29e | LAB_0051b1d6
