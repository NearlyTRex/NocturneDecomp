// Name: shape_meshlod.cpp_CLodMesh_FUN_0051adf0
// Address: 0051adf0
// Address Range: [[0051adf0, 0051b078]]
// Convention: __cdecl
// Signature: void shape_meshlod.cpp_CLodMesh_FUN_0051adf0(CLodMesh * this_ptr)
// Cross-references:
//   shape_meshlod.cpp_FUN_0051ad60 (0051ad60) at 0051ada2 [UNCONDITIONAL_CALL]
// Globals:
...
void __cdecl shape_meshlod_cpp_CLodMesh_FUN_0051adf0(CLodMesh *this_ptr)

{
  ...
  crt_stdio_c_fscanf_FUN_005fe7c0(in_stack_00000008,"%d,%*d\n",local_1c);
  for (iVar4 = local_18 * 5 + 2; 0 < iVar4; iVar4 = iVar4 + -1) {
    do {
      iVar2 = crt_stdio_c_fgetc_FUN_005fe840(in_stack_00000008);
      if (iVar2 < 0) goto LAB_0051ae8f;
    } while (iVar2 != 10);
  }
LAB_0051ae8f:
  iVar4 = 1;
  ...
  if (0 < this_ptr->submesh_count) {
    ...
    do {
      ...
      crt_file_c_makepath_FUN_005febfc
                ((char *)((int)this_ptr->submesh_data + iVar1),(char *)0x0,(char *)0x0,acStack_110,
                 "raw");
  ...
  if (0 < this_ptr->tri_count) {
    iVar2 = 0;
    do {
      pcVar3 = this_ptr->triangle_data->field0_0x0 + iVar2;
      iVar4 = iVar4 + 1;
      iVar2 = iVar2 + 0x8c;
      crt_stdio_c_fscanf_FUN_005fe7c0
                (in_stack_00000008,"%d, %d,%f,%f, %d,%f,%f, %d,%f,%f\n","%d, %d,%f,%f, %d,%f,%f, %d,%f,%f\n",
                 pcVar3,pcVar3 + 0x10,pcVar3 + 0x1c,pcVar3 + 0x20,pcVar3 + 0x14,pcVar3 + 0x24,
                 pcVar3 + 0x28,pcVar3 + 0x18);
  ...
  if (0 < this_ptr->vertex_count) {
    iVar2 = 0;
    do {
      pcVar3 = this_ptr->vertex_data->field0_0x0 + iVar2;
      iVar4 = iVar4 + 1;
      iVar2 = iVar2 + 0x4c4;
      crt_stdio_c_fscanf_FUN_005fe7c0(in_stack_00000008,"%f,%f,%f\n","%f,%f,%f\n",pcVar3);
    } while (iVar4 < this_ptr->vertex_count);
  }
  this_ptr->field6_0x18 = 1;
  this_ptr->field7_0x1c = 2;
  this_ptr->field8_0x20 = 0;
  shape_meshlod_cpp_CLodMesh_FUN_0051b330(this_ptr);
  return;
}
...
// Assembly code:
// 0051adf0: PUSH EBX
//   Label: shape_meshlod.cpp_CLodMesh_FUN_0051adf0
// 0051adf1: PUSH ESI
// 0051adf2: PUSH EDI
// 0051adf3: PUSH EBP
...
// 0051b066: CALL shape_meshlod.cpp_CLodMesh_FUN_0051b330
