...
// Cross-references:
//   shape_meshlod.cpp_CLodMesh_computeAllEdgeCollapseCosts_FUN_00519710 (00519710) at 0051975f [UNCONDITIONAL_CALL]
//   shape_meshlod.cpp_CLodMesh_findMinimumCostEdge_FUN_00519680 (00519680) at 005196e4 [UNCONDITIONAL_CALL]
// Globals:
...
//   float g_SamplePointWeight = 0.75
//   CEditorTools g_CEditorToolsPtr
//   char* g_CurrentFilename
//   int g_CurrentLineNumber
//   int[200] g_MaxNeighborVerts
//   undefined4 DAT_02f2a1b4
//   CLodFace[200] g_TempNeighborFaces
...

{
  ...
  local_58->collapse_cost = g_InfiniteCollapseCost;
  ...
  if (iVar3 == edge_index) {
    ...
    local_78 = (double)CONCAT44(iVar3,(undefined4)local_78);
...
LAB_0051919d:
      ...
      do {
        if ((g_LodReplayMode != 0) ||
          ...
          iVar11 = local_44[1];
          local_54 = (int *)((float)local_50 * FLOAT_006379d5);
          ...
          if (0.0 < fVar4) {
            ...
            if (0 < local_28) {
              ...
              do {
                ...
                pCVar8 = this_ptr->vertex_data + *local_44;
                local_c0.x = ((pCVar8->position).x + (pCVar9->position).x) / FLOAT_006379dd;
                local_c0.y = ((pCVar8->position).y + (pCVar9->position).y) * FLOAT_006379d9;
                local_c0.z = ((pCVar8->position).z + (pCVar9->position).z) * FLOAT_006379d9;
            ...
            in_stack_fffffeec = (double)((g_SamplePointWeight * 1e+10) / (float)g_SamplePointCount);
            ...
            if (0 < g_SamplePointCount) {
              ...
              } while (SBORROW4(iVar11,g_SamplePointCount * 8) !=
          ...
          if (iVar3 <= iVar11) {
            if ((0 < this_ptr->sample_point_count) && (g_SamplePointWeight < 1.0)) {
              local_ec = 0;
              local_2c = 0;
              fVar4 = 0.0;
                ...
                do {
                  ...
                  if (g_LodTempFaceStamp ==
                      ...
                      do {
                        local_78 = shape_meshlod_cpp_CLodMesh_computePointToFaceDistance_FUN_0051a400
                                             (local_20,(SLodSamplePoint *)pCVar12,
                                              SUB84(in_stack_fffffeec,0));
                        if (local_78 < (double)CONCAT44(local_100,uStack_104)) {
                          local_f4 = SUB84(local_78,0);
                          uStack_104 = local_f4;
                          local_f0 = (undefined4)((ulonglong)local_78 >> 0x20);
                          local_100 = local_f0;
                        }
                        iVar11 = iVar11 + 1;
                        pCVar12 = pCVar12 + 1;
                    ...
                    fVar4 = (float)local_20->active_attribute_count *
                            (float)(double)CONCAT44(local_100,uStack_104) + fVar4;
                  }
              ...
              if (0 < local_ec) {
                local_fc = (double)(((1.0 - g_SamplePointWeight) * fVar4 * 1e+10) / (float)local_ec
                                   + (float)local_fc);
              }
            }
...
// 00518958: CALL shape_meshlod.cpp_CLodMesh_validateEdgeCollapse_FUN_00518490
...
// 00518978: PUSH ESI
// 00518979: PUSH EBX
// 0051897a: CALL shape_meshlod.cpp_CLodMesh_checkEdgeCollapseAngle_FUN_00519480
...
//   XREF to: Stack[0x4] (READ)
// 0051899a: PUSH EDI
// 0051899b: CALL shape_meshlod.cpp_CLodMesh_checkEdgeCollapseAngle_FUN_00519480
//   XREF to: 00519480 (UNCONDITIONAL_CALL)
...
//   XREF to: Stack[0x4] (READ)
// 00518de6: PUSH EDX
// 00518de7: CALL shape_meshlod.cpp_CLodMesh_computeFaceCentroid_FUN_00518870
...
// 00518f21: CALL shape_meshlod.cpp_CLodMesh_computeSamplePointDistances_FUN_00519b50
...
//   XREF to: Stack[0x4] (READ)
// 0051926a: PUSH ECX
// 0051926b: CALL shape_meshlod.cpp_CLodMesh_validateFace_FUN_00519830
...
//   XREF to: Stack[0x4] (READ)
// 00519407: PUSH ECX
// 00519408: CALL shape_meshlod.cpp_CLodMesh_computePointToFaceDistance_FUN_0051a400
