...

{
  ...
  iVar2 = shape_meshlod_cpp_CLodMesh_validateEdgeCollapse_FUN_00518490
                    (this_ptr,local_58->vertex_idx_1,local_58->vertex_idx_2,in_stack_fffffed8);
  if (iVar2 == edge_index) {
    fVar3 = (float)shape_meshlod_cpp_CLodMesh_checkEdgeCollapseAngle_FUN_00519480
                             (this_ptr,edge_index,*local_64);
    CStack_94.z = fVar3;
    iVar2 = shape_meshlod_cpp_CLodMesh_checkEdgeCollapseAngle_FUN_00519480
                      (this_ptr,edge_index,*(int *)(local_60 + 4));
    uStack_88 = (double)CONCAT44 /* combine 2-byte values */(iVar2,(uint)uStack_88);
    if ((fVar3 == 0.0) || (iVar2 == 0)) {
      local_40 = 0;
      iVar2 = 0;
...
LAB_0051919d:
      ...
      do {
        if ((g_LodReplayMode != 0) ||
          ...
          iStack_14 = local_60;
          iVar10 = local_54[1];
          local_64 = (int *)((float)local_60 * 0.25f);
          local_6c = 1.0 - (float)local_64;
          pCVar6 = this_ptr->vertex_data;
          local_ac = pCVar6[iVar10].position.x * (float)local_64;
          local_a8 = pCVar6[iVar10].position.y * (float)local_64;
          local_a4 = pCVar6[iVar10].position.z * (float)local_64;
          pCVar6 = this_ptr->vertex_data + *local_54;
          ...
          if (0.0 < fVar3) {
            ...
            if (*(double *)(local_54 + 2) < uStack_10c) goto LAB_00518f71;
          }
          iVar10 = 0;
          pCVar5 = local_78;
          if (0 < iVar2) {
          ...
          if (iVar2 <= iVar10) {
            if ((0 < this_ptr->sample_point_count) && (0.75f < 1.0)) {
                ...
                do {
                  ...
                  if (g_LodTempFaceStamp ==
                    ...
                    if (0 < iVar2) {
                      pCVar11 = g_TempNeighborFaces;
                      do {
                        uStack_88 = shape_meshlod_cpp_CLodMesh_computePointToFaceDistance_FUN_0051a400
                                              (local_30,(SLodSamplePoint *)pCVar11,
                                               SUB84 /* extract 2-byte value */(in_stack_fffffedc,0));
                        if (uStack_88 < (double)CONCAT44 /* combine 2-byte values */(local_110,uStack_114)) {
                          uStack_104 = SUB84 /* extract 2-byte value */(uStack_88,0);
                          uStack_114 = uStack_104;
                          local_100 = (uint)((ulonglong)uStack_88 >> 0x20);
                          local_110 = local_100;
                        }
                        iVar10 = iVar10 + 1;
                        pCVar11 = pCVar11 + 1;
                    ...
                    local_fc = local_fc + 1;
                    fVar3 = (float)local_30->active_attribute_count *
                            (float)(double)CONCAT44 /* combine 2-byte values */(local_110,uStack_114) + fVar3;
                  }
              ...
              if (0 < local_fc) {
                uStack_10c = (double)(((1.0 - 0.75f) * fVar3 * 1e+10) /
                                      (float)local_fc + (float)uStack_10c);
              }
            }
            if (uStack_10c < *(double *)(local_54 + 2)) {
              local_54[2] = (int)uStack_10c;
              local_54[3] = uStack_10c._4_4_;
              local_54[4] = (int)local_64;
            }
          }
        }
LAB_00518f71:
