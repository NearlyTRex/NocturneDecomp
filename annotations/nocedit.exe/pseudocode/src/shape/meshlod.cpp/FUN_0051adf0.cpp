// Name: shape_meshlod.cpp_FUN_0051adf0
// Address: 0051adf0
// Address Range: [[0051adf0, 0051b078]]
// Convention: unknown
// Signature: undefined shape_meshlod.cpp_FUN_0051adf0()
// Cross-references:
...
/* Signature: undefined1 shape_meshlod.cpp_FUN_0051adf0(undefined4 param_1, undefined4 param_2) */

void shape_meshlod_cpp_FUN_0051adf0(void)
...
LAB_0051ae8f:
  ...
  if (0 < in_stack_00000004[4]) {
    ...
    do {
      ...
      unaff_ESI = 0;
      iVar2 = in_stack_00000004[5] + iVar1;
      iVar3 = iVar3 + 1;
      iVar1 = iVar1 + 0x48;
      crt_file_c_makepath_FUN_005febfc
                ((char *)(iVar2 + 8),(char *)0x0,(char *)0x0,acStack_110,"raw");
    } while (iVar3 < in_stack_00000004[4]);
  }
  iVar3 = 1;
  do {
    iVar1 = crt_stdio_c_fgetc_FUN_005fe840(in_stack_00000008);
    ...
    do {
      ...
      crt_stdio_c_fscanf_FUN_005fe7c0
                (in_stack_00000008,"%d, %d,%f,%f, %d,%f,%f, %d,%f,%f\n","%d, %d,%f,%f, %d,%f,%f, %d,%f,%f\n",
                 iVar2,iVar2 + 0x10,iVar2 + 0x1c,iVar2 + 0x20,iVar2 + 0x14,iVar2 + 0x24,iVar2 + 0x28
                 ,iVar2 + 0x18);
    } while (iVar3 < in_stack_00000004[2]);
  }
  iVar3 = 1;
  do {
    iVar1 = crt_stdio_c_fgetc_FUN_005fe840(in_stack_00000008);
  ...
  if (0 < *in_stack_00000004) {
    iVar2 = 0;
    do {
      iVar1 = in_stack_00000004[1] + iVar2;
      iVar3 = iVar3 + 1;
      iVar2 = iVar2 + 0x4c4;
  ...
  shape_meshlod_cpp_FUN_0051b330(iVar1);
  return;
}
...
// Assembly code:
// 0051adf0: PUSH EBX
//   Label: shape_meshlod.cpp_FUN_0051adf0
// 0051adf1: PUSH ESI
// 0051adf2: PUSH EDI
// 0051adf3: PUSH EBP
...
// 0051aef3: CALL shape_meshlod.cpp_CallocSomething1_FUN_00515ac0
...
// 0051b066: CALL shape_meshlod.cpp_FUN_0051b330
