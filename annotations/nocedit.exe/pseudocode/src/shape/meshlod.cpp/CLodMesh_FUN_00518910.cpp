// Name: shape_meshlod.cpp_CLodMesh_FUN_00518910
// Address: 00518910
// Address Range: [[00518910, 00519470]]
// Convention: __cdecl
// Signature: void shape_meshlod.cpp_CLodMesh_FUN_00518910(CLodMesh * this_ptr)
// Cross-references:
//   shape_meshlod.cpp_CLodMesh_FUN_00519680 (00519680) at 005196e4 [UNCONDITIONAL_CALL]
//   shape_meshlod.cpp_CLodMesh_FUN_00519710 (00519710) at 0051975f [UNCONDITIONAL_CALL]
// Globals:
...
//   shape_meshlod.cpp_CLodMesh_FUN_00518490
//   shape_meshlod.cpp_CLodMesh_FUN_00519480
...
void __cdecl shape_meshlod_cpp_CLodMesh_FUN_00518910(CLodMesh *this_ptr)

{
  ...
  *(undefined8 *)local_58->field2_0x8 = _DAT_00661388;
  ...
  if (iVar9 == in_stack_00000008) {
    ...
    local_7c = iVar9;
    local_78._4_4_ = shape_meshlod_cpp_CLodMesh_FUN_00519480(this_ptr);
    if ((iVar9 == 0) || (local_78._4_4_ == 0)) {
      local_30 = 0;
      iVar9 = 0;
      if ((DAT_02f31230 & 1) == 0) {
      ...
      local_58 = (SLodEdge *)0x0;
      do {
        iStack_14 = local_44[1];
        iVar17 = *local_44;
        if (local_58 == (SLodEdge *)0x1) {
          iStack_14 = *local_44;
          iVar17 = local_44[1];
        }
        local_3c = 0;
        ...
        local_34 = 0;
        while( true ) {
          dVar20 = (double)CONCAT44(local_78._4_4_,(undefined4)local_78);
          pSVar13 = this_ptr->vertex_data;
          if (*(int *)((int)pSVar13->adjacent_edge_indices + local_4c + -4) <= local_3c) break;
          iVar22 = *(int *)((int)pSVar13->adjacent_edge_indices + local_34 + local_4c);
          local_1c = this_ptr->edges_ptr + iVar22;
          if (iVar22 != in_stack_00000008) {
            if (199 < local_28) {
            ...
            if (iVar17 == local_1c->vertex_idx_1) {
              iVar22 = local_1c->vertex_idx_2;
            }
            else {
              iVar22 = local_1c->vertex_idx_1;
            }
            *(int *)((int)&DAT_02f2a1b0 + local_24) = iVar22;
            local_24 = local_24 + 4;
            local_28 = local_28 + 1;
            iVar22 = 0;
            if (0 < local_1c->adjacent_tri_count) {
              ...
              do {
                iVar8 = DAT_02f33334;
                iVar12 = pSVar21->adjacent_tri_indices[0];
                ...
                if (DAT_02f33334 != *(int *)(pSVar2[iVar12].field10_0x50 + 0x34)) {
                  ...
                  *(int *)(pSVar2[iVar12].field10_0x50 + 0x34) = iVar8;
                  if (((iVar3 != iStack_14) && (iStack_14 != pSVar2[iVar12].vertex_idx_1)) &&
                    ...
                    *(int *)(DAT_02f2a4d0[0].field5_0x1c + iVar10 + -0xc) = iVar17;
                    if (iVar17 == pSVar2[iVar12].vertex_idx_0) {
                      *(int *)(DAT_02f2a4d0[0].field5_0x1c + iVar10 + -8) =
                           pSVar2[iVar12].vertex_idx_1;
                      iVar12 = pSVar2[iVar12].vertex_idx_2;
LAB_0051919d:
                      *(int *)(DAT_02f2a4d0[0].field5_0x1c + iVar10 + -4) = iVar12;
                    }
                    else {
                      if (iVar17 == pSVar2[iVar12].vertex_idx_1) {
                        *(int *)(DAT_02f2a4d0[0].field5_0x1c + iVar10 + -8) =
                             pSVar2[iVar12].vertex_idx_2;
                        iVar12 = pSVar2[iVar12].vertex_idx_0;
                        goto LAB_0051919d;
                      }
                      if (iVar17 == pSVar2[iVar12].vertex_idx_2) {
                        *(int *)(DAT_02f2a4d0[0].field5_0x1c + iVar10 + -8) =
                             pSVar2[iVar12].vertex_idx_0;
                        iVar12 = pSVar2[iVar12].vertex_idx_1;
                        goto LAB_0051919d;
                      }
                      g_CurrentFilename = "..\\shape\\meshlod.cpp";
                    ...
                    iVar19 = iVar10 + 0x8c;
                    iVar9 = iVar9 + 1;
                    *(int *)((int)(DAT_02f2a4d0[0].vertices + 4) + iVar10) = local_18;
                  }
                }
                pSVar21 = (SLodEdge *)&pSVar21->vertex_idx_2;
                iVar22 = iVar22 + 1;
                iVar10 = iVar19;
              } while (iVar22 < local_1c->adjacent_tri_count);
            }
          }
          local_3c = local_3c + 1;
          local_34 = local_34 + 4;
        }
        local_58 = (SLodEdge *)((int)local_58 + 1);
      } while ((int)local_58 < 2);
      pSVar13 = pSVar13 + *local_44;
      fStack_90 = *(float *)pSVar13->field0_0x0;
      local_8c = *(float *)(pSVar13->field0_0x0 + 4);
      fStack_88 = *(float *)(pSVar13->field0_0x0 + 8);
      local_60 = local_28 << 2;
      local_68 = &DAT_02f2a4d0[0].field10_0x44;
      local_50 = 0;
      ...
      do {
        if ((DAT_02f33330 != 0) ||
          ...
          pSVar13 = this_ptr->vertex_data;
          local_9c = *(float *)pSVar13[iVar17].field0_0x0 * local_54;
          local_98 = *(float *)(pSVar13[iVar17].field0_0x0 + 4) * local_54;
          fStack_94 = *(float *)(pSVar13[iVar17].field0_0x0 + 8) * local_54;
          pSVar13 = this_ptr->vertex_data + *local_44;
          *(float *)pSVar13->field0_0x0 = fStack_90 * local_5c + local_9c;
          fVar4 = _DAT_0067d398;
          *(float *)(pSVar13->field0_0x0 + 4) = local_8c * local_5c + local_98;
          *(float *)(pSVar13->field0_0x0 + 8) = fStack_88 * local_5c + fStack_94;
          local_fc = 0.0;
          local_78 = dVar20;
          if (0.0 < fVar4) {
            pSVar13 = this_ptr->vertex_data + *local_44;
            DAT_02f313ec = 1;
            if (pSVar13 != (SLodVert *)CVector3f_ARRAY_02f313f0) {
              CVector3f_ARRAY_02f313f0[0].x = *(float *)pSVar13->field0_0x0;
              CVector3f_ARRAY_02f313f0[0].z = *(float *)((int)pSVar13->field0_0x0 + 8);
              CVector3f_ARRAY_02f313f0[0].y = *(float *)((int)pSVar13->field0_0x0 + 4);
            }
            if (0 < local_28) {
              iVar17 = 0;
              local_48 = local_60;
              do {
                iVar22 = DAT_02f313ec;
                pSVar14 = this_ptr->vertex_data + *(int *)((int)&DAT_02f2a1b0 + iVar17);
                pSVar13 = this_ptr->vertex_data + *local_44;
                local_c0.x = (*(float *)pSVar13->field0_0x0 + *(float *)pSVar14->field0_0x0) /
                             FLOAT_006379dd;
                local_c0.y = (*(float *)(pSVar13->field0_0x0 + 4) +
                             *(float *)(pSVar14->field0_0x0 + 4)) * FLOAT_006379d9;
                local_c0.z = (*(float *)(pSVar13->field0_0x0 + 8) +
                             *(float *)(pSVar14->field0_0x0 + 8)) * FLOAT_006379d9;
                iVar10 = DAT_02f313ec + 1;
                pCVar11 = CVector3f_ARRAY_02f313f0 + DAT_02f313ec;
                DAT_02f313ec = iVar10;
                if (pCVar11 != &local_c0) {
                  pCVar11->x = local_c0.x;
                  CVector3f_ARRAY_02f313f0[iVar22].y = local_c0.y;
                  CVector3f_ARRAY_02f313f0[iVar22].z = local_c0.z;
                }
                iVar17 = iVar17 + 4;
            ...
            if (0 < iVar9) {
              do {
                local_78 = dVar20;
                pCVar11 = (CVector3f *)shape_meshlod_cpp_FUN_00518870();
                iVar17 = DAT_02f313ec;
                iVar22 = DAT_02f313ec + 1;
                pCVar15 = CVector3f_ARRAY_02f313f0 + DAT_02f313ec;
                DAT_02f313ec = iVar22;
                if (pCVar15 != pCVar11) {
                  pCVar15->x = pCVar11->x;
                  CVector3f_ARRAY_02f313f0[iVar17].y = pCVar11->y;
                  CVector3f_ARRAY_02f313f0[iVar17].z = pCVar11->z;
                }
                local_30 = local_30 + 1;
                dVar20 = local_78;
            ...
            if (DAT_0067d394 != 0) {
              ...
              if (1 < DAT_02f313ec) {
                iVar22 = DAT_02f313ec * 0xc;
                pCVar11 = local_64;
                do {
                  local_b4 = CVector3f_ARRAY_02f313f0[0].x + pCVar11->x;
                  local_a8 = local_b4 / FLOAT_006379dd;
                  local_b0 = CVector3f_ARRAY_02f313f0[0].y + pCVar11->y;
                  local_ac = CVector3f_ARRAY_02f313f0[0].z + pCVar11->z;
                  local_a4 = local_b0 * FLOAT_006379d9;
                  local_a0 = local_ac * FLOAT_006379d9;
                  local_40 = local_40 + 1;
                  pfVar18 = (float *)((int)&CVector3f_ARRAY_02f313f0[0].x + iVar22);
                  if (pfVar18 != &local_a8) {
                    *pfVar18 = local_a8;
                    *(float *)((int)&CVector3f_ARRAY_02f313f0[0].y + iVar22) = local_a4;
                    *(float *)((int)&CVector3f_ARRAY_02f313f0[0].z + iVar22) = local_a0;
                  }
                  iVar17 = iVar17 + 1;
                  pCVar11 = pCVar11 + 1;
                  iVar22 = iVar22 + 0xc;
            ...
            fVar4 = _DAT_0067d398 * 1e+10;
            fVar5 = (float)DAT_02f313ec;
            ...
            if (0 < DAT_02f313ec) {
              ...
              do {
                ...
                iVar17 = iVar17 + 8;
                local_fc = *pdVar1 * (double)(fVar4 / fVar5) + local_fc;
          ...
          if (iVar9 <= iVar17) {
            if ((0 < this_ptr->sample_point_count) && (_DAT_0067d398 < 1.0)) {
              local_ec = 0;
              local_2c = 0;
              fVar4 = 0.0;
                ...
                do {
                  ...
                  if (DAT_02f33338 ==
                    ...
                    if (0 < iVar9) {
                      do {
                        local_78 = dVar20;
                        dVar20 = (double)shape_meshlod_cpp_FUN_0051a400();
                        dVar6 = dVar7;
                        if (dVar20 < dVar7) {
                          dVar6 = dVar20;
                        }
                    ...
                    local_ec = local_ec + 1;
                    fVar4 = *(float *)(local_20 + 0x18) * (float)dVar6 + fVar4;
                  }
              ...
              if (0 < local_ec) {
                local_fc = (double)(((1.0 - _DAT_0067d398) * fVar4 * 1e+10) / (float)local_ec +
                                   (float)local_fc);
              }
            }
...
LAB_00518f71:
        ...
        if (4 < local_50) {
          pSVar13 = this_ptr->vertex_data + *local_44;
          *(float *)pSVar13->field0_0x0 = fStack_90;
          *(float *)(pSVar13->field0_0x0 + 4) = local_8c;
          *(float *)(pSVar13->field0_0x0 + 8) = fStack_88;
          return;
        }
      } while( true );
    }
...
// Assembly code:
// 00518910: PUSH EBX
//   Label: shape_meshlod.cpp_CLodMesh_FUN_00518910
// 00518911: PUSH ESI
// 00518912: PUSH EDI
// 00518913: PUSH EBP
...
// 00518958: CALL shape_meshlod.cpp_CLodMesh_FUN_00518490
...
// 00518978: PUSH ESI
// 00518979: PUSH EBX
// 0051897a: CALL shape_meshlod.cpp_CLodMesh_FUN_00519480
...
//   XREF to: Stack[0x4] (READ)
// 0051899a: PUSH EDI
// 0051899b: CALL shape_meshlod.cpp_CLodMesh_FUN_00519480
//   XREF to: 00519480 (UNCONDITIONAL_CALL)
