...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl shape_meshlod_cpp_CLodMesh_computeSamplePointDistances_FUN_00519b50(CLodMesh *this_ptr,double max_search_radius)
;
; Parameters:
...
section .text
    ...
    CMP dword ptr [0x02f313ec],0x190    ; 00519b5c | g_SamplePointCount
    JG 0x00519fa4                       ; 00519b66
        ;   XREF to: 00519fa4 (CONDITIONAL_JUMP)  ; LAB_00519fa4
    MOV EAX,ESP                         ; 00519b6c
        ;   Label: LAB_00519b6c
    CMP EAX,0x2f313f0                   ; 00519b6e | g_SamplePointArray
    JZ 0x00519b8f                       ; 00519b73
        ;   XREF to: 00519b8f (CONDITIONAL_JUMP)  ; LAB_00519b8f
    MOV EAX,[0x02f313f0]                ; 00519b75 | g_SamplePointArray
    ...
    LEA EAX,[ESP + 0xc]                 ; 00519b8f
        ;   Label: LAB_00519b8f
    CMP EAX,0x2f313f0                   ; 00519b93 | g_SamplePointArray
    JZ 0x00519bb5                       ; 00519b98
        ;   XREF to: 00519bb5 (CONDITIONAL_JUMP)  ; LAB_00519bb5
    MOV EAX,[0x02f313f0]                ; 00519b9a | g_SamplePointArray
    ...
    MOV ESI,dword ptr [0x02f313ec]      ; 00519bb5 | g_SamplePointCount
        ;   Label: LAB_00519bb5
    XOR EDI,EDI                         ; 00519bbb
    TEST ESI,ESI                        ; 00519bbd
    JLE 0x00519c00                      ; 00519bbf
        ;   XREF to: 00519c00 (CONDITIONAL_JUMP)  ; LAB_00519c00
    MOV ESI,0x2f313f0                   ; 00519bc1 | g_SamplePointArray
    ...
    JL 0x00519bc8                       ; 00519bf8
        ;   XREF to: 00519bc8 (CONDITIONAL_JUMP)  ; LAB_00519bc8
    LEA EAX,[EAX]                       ; 00519bfa
    FLD float ptr [ESP]                 ; 00519c00
        ;   Label: LAB_00519c00
    FADD float ptr [ESP + 0xc]          ; 00519c03
    FST float ptr [ESP + 0x3c]          ; 00519c07
    FLD float ptr [0x00637a8d]          ; 00519c0b | FLOAT_00637a8d
    FXCH                                ; 00519c11
    FMUL ST1                            ; 00519c13
    ...
    FLD double ptr [0x00637a95]         ; 00519c41 | DOUBLE_00637a95
    FLD float ptr [ESP + 0x18]          ; 00519c47
    FADD ST0,ST1                        ; 00519c4b
    FXCH ST2                            ; 00519c4d
    FADD ST0,ST1                        ; 00519c4f
    FXCH ST2                            ; 00519c51
    FLD double ptr [0x00637a9d]         ; 00519c53 | DOUBLE_00637a9d
    FXCH                                ; 00519c59
    FMUL ST1                            ; 00519c5b
    FXCH ST3                            ; 00519c5d
    FMUL ST1                            ; 00519c5f
    MOV EBX,dword ptr [0x02f33334]      ; 00519c61 | g_LodGenerationStamp
    FXCH ST4                            ; 00519c67
    FST float ptr [ESP + 0x20]          ; 00519c69
    FADDP ST2,ST0                       ; 00519c6d
    INC EBX                             ; 00519c6f
    FMULP                               ; 00519c70
    MOV dword ptr [0x02f33334],EBX      ; 00519c72 | g_LodGenerationStamp
    FXCH                                ; 00519c78
    CALL crt_math.c_round_FUN_005fe6b0  ; 00519c7a
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    FXCH ST2                            ; 00519c7f
    CALL crt_math.c_round_FUN_005fe6b0  ; 00519c81
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    FXCH                                ; 00519c86
    CALL crt_math.c_round_FUN_005fe6b0  ; 00519c88
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    FXCH ST2                            ; 00519c8d
    ...
    JL 0x00519cac                       ; 00519ca1
        ;   XREF to: 00519cac (CONDITIONAL_JUMP)  ; LAB_00519cac
    CMP ESI,0x10                        ; 00519ca3
    JL 0x00519fcc                       ; 00519ca6
        ;   XREF to: 00519fcc (CONDITIONAL_JUMP)  ; LAB_00519fcc
    ...
    JL 0x0051a00a                       ; 00519cbe
        ;   XREF to: 0051a00a (CONDITIONAL_JUMP)  ; LAB_0051a00a
    ...
    JL 0x00519cdf                       ; 00519cd5
        ;   XREF to: 00519cdf (CONDITIONAL_JUMP)  ; LAB_00519cdf
    ...
    JL 0x0051a011                       ; 00519cef
        ;   XREF to: 0051a011 (CONDITIONAL_JUMP)  ; LAB_0051a011
    ...
    JL 0x00519d10                       ; 00519d06
        ;   XREF to: 00519d10 (CONDITIONAL_JUMP)  ; LAB_00519d10
    ...
    PUSH EAX                            ; 00519d65
    INC EBX                             ; 00519d66
    CALL shape_meshlod.cpp_CLodMesh_processGridCell_FUN_0051a030 ; 00519d67
        ;   XREF to: 0051a030 (UNCONDITIONAL_CALL)  ; void shape_meshlod.cpp_CLodMesh_processGridCell_FUN_0051a030(CLodMesh * this_ptr, int grid_x, int grid_y, int grid_z)
    ADD ESP,0x10                        ; 00519d6c
    CMP EBX,EDI                         ; 00519d6f
    JLE 0x00519d58                      ; 00519d71
        ;   XREF to: 00519d58 (CONDITIONAL_JUMP)  ; LAB_00519d58
    MOV EAX,dword ptr [ESP + 0x70]      ; 00519d73
        ;   Label: LAB_00519d73
    INC ESI                             ; 00519d77
    CMP ESI,EAX                         ; 00519d78
    JLE 0x00519d50                      ; 00519d7a
        ;   XREF to: 00519d50 (CONDITIONAL_JUMP)  ; LAB_00519d50
    ...
    JLE 0x00519d44                      ; 00519d8b
        ;   XREF to: 00519d44 (CONDITIONAL_JUMP)  ; LAB_00519d44
    MOV EAX,ESP                         ; 00519d8d
        ;   Label: LAB_00519d8d
    CMP EAX,0x2f313f0                   ; 00519d8f | g_SamplePointArray
    JZ 0x00519db0                       ; 00519d94
        ;   XREF to: 00519db0 (CONDITIONAL_JUMP)  ; LAB_00519db0
    MOV EAX,[0x02f313f0]                ; 00519d96 | g_SamplePointArray
    ...
    LEA EAX,[ESP + 0xc]                 ; 00519db0
        ;   Label: LAB_00519db0
    CMP EAX,0x2f313f0                   ; 00519db4 | g_SamplePointArray
    JZ 0x00519dd6                       ; 00519db9
        ;   XREF to: 00519dd6 (CONDITIONAL_JUMP)  ; LAB_00519dd6
    MOV EAX,[0x02f313f0]                ; 00519dbb | g_SamplePointArray
    ...
    MOV ECX,dword ptr [0x02f313ec]      ; 00519dd6 | g_SamplePointCount
        ;   Label: LAB_00519dd6
    XOR EDI,EDI                         ; 00519ddc
    TEST ECX,ECX                        ; 00519dde
    JLE 0x00519e7f                      ; 00519de0
    ...
    CALL core_box.cpp_CBoundingBox3D_expand_FUN_00420240 ; 00519e37
        ;   XREF to: 00420240 (UNCONDITIONAL_CALL)  ; void core_box.cpp_CBoundingBox3D_expand_FUN_00420240(CBoundingBox3D * this_ptr, CVector3f * point)
    FLD float ptr [EBX + -0xc]          ; 00519e3c | g_SamplePointArray
    ...
    CALL core_box.cpp_CBoundingBox3D_expand_FUN_00420240 ; 00519e6a
        ;   XREF to: 00420240 (UNCONDITIONAL_CALL)  ; void core_box.cpp_CBoundingBox3D_expand_FUN_00420240(CBoundingBox3D * this_ptr, CVector3f * point)
    MOV EAX,[0x02f313ec]                ; 00519e6f | g_SamplePointCount
    ADD ESP,0x8                         ; 00519e74
    CMP EDI,EAX                         ; 00519e77
    JL 0x00519ded                       ; 00519e79
        ;   XREF to: 00519ded (CONDITIONAL_JUMP)  ; LAB_00519ded
    FLD float ptr [ESP]                 ; 00519e7f
        ;   Label: LAB_00519e7f
    FADD double ptr [0x00637a95]        ; 00519e82 | DOUBLE_00637a95
    FMUL double ptr [0x00637a9d]        ; 00519e88 | DOUBLE_00637a9d
    MOV EAX,dword ptr [ESP + 0x5c]      ; 00519e8e
    CALL crt_math.c_round_FUN_005fe6b0  ; 00519e92
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    JLE 0x00519eaf                      ; 00519eab
        ;   XREF to: 00519eaf (CONDITIONAL_JUMP)  ; LAB_00519eaf
    MOV EBX,EAX                         ; 00519ead
    FLD float ptr [ESP + 0x4]           ; 00519eaf
        ;   Label: LAB_00519eaf
    FADD double ptr [0x00637a95]        ; 00519eb3 | DOUBLE_00637a95
    FMUL double ptr [0x00637a9d]        ; 00519eb9 | DOUBLE_00637a9d
    MOV EAX,dword ptr [ESP + 0x58]      ; 00519ebf
    CALL crt_math.c_round_FUN_005fe6b0  ; 00519ec3
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    JLE 0x00519edb                      ; 00519ed7
        ;   XREF to: 00519edb (CONDITIONAL_JUMP)  ; LAB_00519edb
    MOV EBX,EAX                         ; 00519ed9
    FLD float ptr [ESP + 0x8]           ; 00519edb
        ;   Label: LAB_00519edb
    FADD double ptr [0x00637a95]        ; 00519edf | DOUBLE_00637a95
    FMUL double ptr [0x00637a9d]        ; 00519ee5 | DOUBLE_00637a9d
    MOV EAX,dword ptr [ESP + 0x60]      ; 00519eeb
    CALL crt_math.c_round_FUN_005fe6b0  ; 00519eef
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    JLE 0x00519f07                      ; 00519f03
        ;   XREF to: 00519f07 (CONDITIONAL_JUMP)  ; LAB_00519f07
    MOV EBX,EAX                         ; 00519f05
    FLD float ptr [ESP + 0xc]           ; 00519f07
        ;   Label: LAB_00519f07
    FADD double ptr [0x00637a95]        ; 00519f0b | DOUBLE_00637a95
    FMUL double ptr [0x00637a9d]        ; 00519f11 | DOUBLE_00637a9d
    MOV EAX,dword ptr [ESP + 0x5c]      ; 00519f17
    CALL crt_math.c_round_FUN_005fe6b0  ; 00519f1b
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    JLE 0x00519f33                      ; 00519f2f
        ;   XREF to: 00519f33 (CONDITIONAL_JUMP)  ; LAB_00519f33
    MOV EBX,EAX                         ; 00519f31
    FLD float ptr [ESP + 0x10]          ; 00519f33
        ;   Label: LAB_00519f33
    FADD double ptr [0x00637a95]        ; 00519f37 | DOUBLE_00637a95
    FMUL double ptr [0x00637a9d]        ; 00519f3d | DOUBLE_00637a9d
    MOV EAX,dword ptr [ESP + 0x58]      ; 00519f43
    CALL crt_math.c_round_FUN_005fe6b0  ; 00519f47
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    JLE 0x00519f5f                      ; 00519f5b
        ;   XREF to: 00519f5f (CONDITIONAL_JUMP)  ; LAB_00519f5f
    MOV EBX,EAX                         ; 00519f5d
    FLD float ptr [ESP + 0x14]          ; 00519f5f
        ;   Label: LAB_00519f5f
    FADD double ptr [0x00637a95]        ; 00519f63 | DOUBLE_00637a95
    FMUL double ptr [0x00637a9d]        ; 00519f69 | DOUBLE_00637a9d
    MOV EAX,dword ptr [ESP + 0x60]      ; 00519f6f
    CALL crt_math.c_round_FUN_005fe6b0  ; 00519f73
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    JLE 0x00519f8b                      ; 00519f87
        ;   XREF to: 00519f8b (CONDITIONAL_JUMP)  ; LAB_00519f8b
    MOV EBX,EAX                         ; 00519f89
    MOV ESI,dword ptr [ESP + 0x64]      ; 00519f8b
        ;   Label: LAB_00519f8b
    INC EBX                             ; 00519f8f
    CMP EBX,ESI                         ; 00519f90
    JL 0x00519afe                       ; 00519f92
        ;   XREF to: 00519afe (CONDITIONAL_JUMP)  ; LAB_00519afe
    LEA EDI,[ESI + 0x1]                 ; 00519f98
    MOV dword ptr [ESP + 0x64],EDI      ; 00519f9b
    JMP 0x00519cb4                      ; 00519f9f
        ;   XREF to: 00519cb4 (UNCONDITIONAL_JUMP)  ; LAB_00519cb4
    MOV ECX,0x637a5d                    ; 00519fa4 | = "..\\shape\\meshlod.cpp"
        ;   Label: LAB_00519fa4
    MOV EBX,0xd78                       ; 00519fa9
    PUSH 0x637a72                       ; 00519fae | = "Too many sample points!"
    MOV dword ptr [0x02f0ca48],ECX      ; 00519fb3 | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 00519fb9 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00519fbf
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ADD ESP,0x4                         ; 00519fc4
    JMP 0x00519b6c                      ; 00519fc7
        ;   XREF to: 00519b6c (UNCONDITIONAL_JUMP)  ; LAB_00519b6c
    MOV EAX,dword ptr [ESP + 0x58]      ; 00519fcc
        ;   Label: LAB_00519fcc
    TEST EAX,EAX                        ; 00519fd0
    JL 0x00519cac                       ; 00519fd2
        ;   XREF to: 00519cac (CONDITIONAL_JUMP)  ; LAB_00519cac
    CMP EAX,0x10                        ; 00519fd8
    JGE 0x00519cac                      ; 00519fdb
        ;   XREF to: 00519cac (CONDITIONAL_JUMP)  ; LAB_00519cac
    MOV ECX,dword ptr [ESP + 0x60]      ; 00519fe1
    TEST ECX,ECX                        ; 00519fe5
    JL 0x00519cac                       ; 00519fe7
        ;   XREF to: 00519cac (CONDITIONAL_JUMP)  ; LAB_00519cac
    CMP ECX,0x10                        ; 00519fed
    JGE 0x00519cac                      ; 00519ff0
        ;   XREF to: 00519cac (CONDITIONAL_JUMP)  ; LAB_00519cac
    PUSH ECX                            ; 00519ff6
    PUSH EAX                            ; 00519ff7
    PUSH ESI                            ; 00519ff8
    ...
    PUSH EDX                            ; 00519ffc
    CALL shape_meshlod.cpp_CLodMesh_processGridCell_FUN_0051a030 ; 00519ffd
        ;   XREF to: 0051a030 (UNCONDITIONAL_CALL)  ; void shape_meshlod.cpp_CLodMesh_processGridCell_FUN_0051a030(CLodMesh * this_ptr, int grid_x, int grid_y, int grid_z)
    ADD ESP,0x10                        ; 0051a002
    JMP 0x00519cac                      ; 0051a005
        ;   XREF to: 00519cac (UNCONDITIONAL_JUMP)  ; LAB_00519cac
    XOR EAX,EAX                         ; 0051a00a
        ;   Label: LAB_0051a00a
    JMP 0x00519cc4                      ; 0051a00c
        ;   XREF to: 00519cc4 (UNCONDITIONAL_JUMP)  ; LAB_00519cc4
    XOR ESI,ESI                         ; 0051a011
        ;   Label: LAB_0051a011
    MOV dword ptr [ESP + 0x6c],ESI      ; 0051a013
    JMP 0x00519cf5                      ; 0051a017
        ;   XREF to: 00519cf5 (UNCONDITIONAL_JUMP)  ; LAB_00519cf5
    XOR EDX,EDX                         ; 0051a01c
        ;   Label: LAB_0051a01c
    MOV dword ptr [ESP + 0x74],EDX      ; 0051a01e
    JMP 0x00519d26                      ; 0051a022
        ;   XREF to: 00519d26 (UNCONDITIONAL_JUMP)  ; LAB_00519d26
