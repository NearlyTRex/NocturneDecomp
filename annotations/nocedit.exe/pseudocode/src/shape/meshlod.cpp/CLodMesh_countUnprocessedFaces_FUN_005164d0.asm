...
;                               FUNCTION
; *****************************************************************************
; __cdecl int shape_meshlod.cpp_CLodMesh_countUnprocessedFaces_FUN_005164d0(CLodMesh * this_ptr)
;
; Parameters:
...
section .text
    ...
    JL 0x005164e4                       ; 005164f6 | LAB_005164e4
    ...
    INC ECX                             ; 005164fd
        ;   Label: LAB_005164fd
    JMP 0x005164ea                      ; 005164fe | LAB_005164ea
