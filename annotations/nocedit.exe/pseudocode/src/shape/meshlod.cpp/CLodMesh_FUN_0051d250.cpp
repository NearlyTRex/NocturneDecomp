// Name: shape_meshlod.cpp_CLodMesh_FUN_0051d250
// Address: 0051d250
// Address Range: [[0051d250, 0051d2c1]]
// Convention: __cdecl
// Signature: void shape_meshlod.cpp_CLodMesh_FUN_0051d250(CLodMesh * this_ptr)
// Cross-references:
//   shape_meshlod.cpp_CLodMesh_FUN_00516ba0 (00516ba0) at 00516d2f [UNCONDITIONAL_CALL]
// Globals:
...
void __cdecl shape_meshlod_cpp_CLodMesh_FUN_0051d250(CLodMesh *this_ptr)

{
  ...
  if (in_stack_00000008 != (FILE *)0x0) {
    ...
    if (0 < this_ptr->lod_level_count) {
      iVar8 = 0;
      do {
        pvVar6 = this_ptr->lod_levels_ptr;
        iVar2 = iVar8 + 0x10;
        iVar3 = iVar8 + 0xc;
        iVar4 = iVar8 + 8;
        iVar5 = iVar8 + 4;
        puVar1 = (undefined4 *)(iVar8 + (int)pvVar6);
        iVar8 = iVar8 + 0xf0;
        iVar7 = iVar7 + 1;
        crt_stdio_c_fprintf_FUN_005fe6d0
                  (in_stack_00000008,"%d,%d,%lg,%g\n",*puVar1,
                   *(undefined4 *)(iVar5 + (int)pvVar6),*(undefined4 *)(iVar4 + (int)pvVar6),
                   *(undefined4 *)(iVar3 + (int)pvVar6),(double)*(float *)(iVar2 + (int)pvVar6));
...
// Assembly code:
// 0051d250: PUSH EBX
//   Label: shape_meshlod.cpp_CLodMesh_FUN_0051d250
// 0051d251: PUSH EDI
// 0051d252: PUSH EBP
