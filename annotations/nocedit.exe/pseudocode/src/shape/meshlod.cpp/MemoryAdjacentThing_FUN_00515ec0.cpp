// Name: shape_meshlod.cpp_MemoryAdjacentThing_FUN_00515ec0
// Address: 00515ec0
// Address Range: [[00515ec0, 00515ffe]]
// Convention: unknown
// Signature: undefined shape_meshlod.cpp_MemoryAdjacentThing_FUN_00515ec0()
// Cross-references:
//   shape_meshlod.cpp_FUN_00515ba0 (00515ba0) at 00515c2d [UNCONDITIONAL_CALL]
//   shape_meshlod.cpp_FUN_00517630 (00517630) at 00517655 [UNCONDITIONAL_CALL]
//   shape_meshlod.cpp_FUN_00518490 (00518490) at 005184ac [UNCONDITIONAL_CALL]
// Globals:
...
/* Signature: undefined1 shape_meshlod.cpp_MemoryAdjacentThing(undefined4 param_1, undefined4
   param_2, undefined4 param_3, undefined4 param_4) */

int shape_meshlod_cpp_MemoryAdjacentThing_FUN_00515ec0(void)

{
  ...
  if (0 < *(int *)(in_stack_00000004 + 0x44)) {
    piVar1 = *(int **)(in_stack_00000004 + 0x48);
    do {
      if (((piVar1[5] == 0) && (iVar4 == *piVar1)) && (in_stack_0000000c == piVar1[1])) {
        return iVar3;
      }
      iVar3 = iVar3 + 1;
      piVar1 = piVar1 + 0x3c;
  ...
  pvVar2 = shape_memdbg_cpp_debugRealloc_FUN_0050f540
                     (*(void **)(in_stack_00000004 + 0x48),
                      (*(int *)(in_stack_00000004 + 0x44) + 1) * 0xf0,"..\\shape\\meshlod.cpp",
                      0x325);
  *(void **)(in_stack_00000004 + 0x48) = pvVar2;
  if (pvVar2 == (void *)0x0) {
    g_CurrentFilename = "..\\shape\\meshlod.cpp";
    g_CurrentLineNumber = 0x326;
    core_main_c_displayErrorAndQuit_FUN_00506f10("Out of memory");
  }
  *(int *)(*(int *)(in_stack_00000004 + 0x48) + *(int *)(in_stack_00000004 + 0x44) * 0xf0) = iVar4;
  *(int *)(*(int *)(in_stack_00000004 + 0x48) + 4 + *(int *)(in_stack_00000004 + 0x44) * 0xf0) =
       in_stack_0000000c;
  *(undefined4 *)
   (*(int *)(in_stack_00000004 + 0x44) * 0xf0 + 0x14 + *(int *)(in_stack_00000004 + 0x48)) = 0;
  *(undefined4 *)
   (*(int *)(in_stack_00000004 + 0x48) + 0x24 + *(int *)(in_stack_00000004 + 0x44) * 0xf0) = 0;
  shape_meshlod_cpp_AdjacentEdgesCheck_FUN_00515d90();
  shape_meshlod_cpp_AdjacentEdgesCheck_FUN_00515d90();
  iVar4 = *(int *)(in_stack_00000004 + 0x44);
  *(int *)(in_stack_00000004 + 0x44) = iVar4 + 1;
  return iVar4;
}
...
// Assembly code:
// 00515ec0: PUSH EBX
//   Label: shape_meshlod.cpp_MemoryAdjacentThing_FUN_00515ec0
// 00515ec1: PUSH ESI
// 00515ec2: PUSH EDI
// 00515ec3: PUSH EBP
...
// 00515fd6: PUSH EAX
// 00515fd7: CALL shape_meshlod.cpp_AdjacentEdgesCheck_FUN_00515d90
...
// 00515fe8: PUSH EAX
// 00515fe9: CALL shape_meshlod.cpp_AdjacentEdgesCheck_FUN_00515d90
//   XREF to: 00515d90 (UNCONDITIONAL_CALL)
