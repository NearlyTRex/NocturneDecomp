...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_meshlod.cpp_CLodMesh_parseS3DFile_FUN_0051aa60(CLodMesh * this_ptr, FILE * file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBP                            ; 0051aa7f
        ;   Label: LAB_0051aa7f
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 0051aa80 | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0051aa85
    TEST EAX,EAX                        ; 0051aa88
    JL 0x0051aa96                       ; 0051aa8a | LAB_0051aa96
        ;   XREF to: 0051aa96 (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 0051aa8c
    JNZ 0x0051aa7f                      ; 0051aa8f | LAB_0051aa7f
        ;   XREF to: 0051aa7f (CONDITIONAL_JUMP)
    DEC EDI                             ; 0051aa91
    TEST EDI,EDI                        ; 0051aa92
    JG 0x0051aa7f                       ; 0051aa94 | LAB_0051aa7f
        ;   XREF to: 0051aa7f (CONDITIONAL_JUMP)
    ...
    PUSH EBX                            ; 0051aaa3
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0051aaa4 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0051aaa9
    CMP EAX,0x1                         ; 0051aaac
    JZ 0x0051aad4                       ; 0051aaaf | LAB_0051aad4
        ;   XREF to: 0051aad4 (CONDITIONAL_JUMP)
    MOV EDX,0x637b34                    ; 0051aab1 | = "..\\shape\\meshlod.cpp" | s_shape_meshlod_cpp_00637b34 = ..\shape\meshlod.cpp
        ;   Label: LAB_0051aab1
    MOV ECX,0x1080                      ; 0051aab6
    PUSH 0x637b49                       ; 0051aabb | = "Corruption in S3D detected!" | s_Corruption_in_S3D_detect_00637b49 = Corruption in S3D detected!
    MOV dword ptr [0x02f0ca48],EDX      ; 0051aac0 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 0051aac6 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0051aacc | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0051aad1
    MOV EDI,dword ptr [ESP + 0x204]     ; 0051aad4
        ;   Label: LAB_0051aad4
    CMP EDI,0x66                        ; 0051aadb
    JGE 0x0051abc1                      ; 0051aade | LAB_0051abc1
        ;   XREF to: 0051abc1 (CONDITIONAL_JUMP)
    PUSH 0x67                           ; 0051aae4
        ;   Label: LAB_0051aae4
    MOV ECX,dword ptr [ESP + 0x208]     ; 0051aae6
    PUSH ECX                            ; 0051aaed
    MOV EAX,0x637b65                    ; 0051aaee | = "..\\shape\\meshlod.cpp" | s_shape_meshlod_cpp_00637b65 = ..\shape\meshlod.cpp
    MOV EDX,0x1084                      ; 0051aaf3
    PUSH 0x637b7a                       ; 0051aaf8 | = "Can't import S3D file version %d, I c..." | s_Can_t_import_S3D_file_ve_00637b7a = Can't import S3D file version %d, I can only do up to version %d.
    MOV [0x02f0ca48],EAX                ; 0051aafd | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 0051ab02 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0051ab08 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ...
    PUSH EBP                            ; 0051ab17
        ;   Label: LAB_0051ab17
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 0051ab18 | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0051ab1d
    TEST EAX,EAX                        ; 0051ab20
    JL 0x0051ab2e                       ; 0051ab22 | LAB_0051ab2e
        ;   XREF to: 0051ab2e (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 0051ab24
    JNZ 0x0051ab17                      ; 0051ab27 | LAB_0051ab17
        ;   XREF to: 0051ab17 (CONDITIONAL_JUMP)
    DEC EDI                             ; 0051ab29
    TEST EDI,EDI                        ; 0051ab2a
    JG 0x0051ab17                       ; 0051ab2c | LAB_0051ab17
        ;   XREF to: 0051ab17 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 0051ab65
    PUSH 0x637bbc                       ; 0051ab66 | = "%d,%d,%d,%d,%d,%d,%d\n" | s_d_d_d_d_d_d_d_00637bbc = %d,%d,%d,%d,%d,%d,%d

    PUSH EBX                            ; 0051ab6b
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0051ab6c | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x24                        ; 0051ab71
    CMP EAX,0x7                         ; 0051ab74
    JNZ 0x0051aab1                      ; 0051ab77 | LAB_0051aab1
    ...
    PUSH EAX                            ; 0051ab94
    PUSH ESI                            ; 0051ab95
    CALL shape_meshlod.cpp_CLodMesh_allocate_FUN_00515ac0 ; 0051ab96 | void shape_meshlod.cpp_CLodMesh_allocate_FUN_00515ac0(CLodMesh * this_ptr, int vertex_count, int tri_count, int submesh_count)
    ...
    TEST EDI,EDI                        ; 0051aba8
        ;   Label: LAB_0051aba8
    JLE 0x0051abcf                      ; 0051abaa | LAB_0051abcf
        ;   XREF to: 0051abcf (CONDITIONAL_JUMP)
    PUSH EBP                            ; 0051abac
        ;   Label: LAB_0051abac
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 0051abad | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0051abb2
    TEST EAX,EAX                        ; 0051abb5
    JL 0x0051abcf                       ; 0051abb7 | LAB_0051abcf
        ;   XREF to: 0051abcf (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 0051abb9
    JNZ 0x0051abac                      ; 0051abbc | LAB_0051abac
        ;   XREF to: 0051abac (CONDITIONAL_JUMP)
    DEC EDI                             ; 0051abbe
    JMP 0x0051aba8                      ; 0051abbf | LAB_0051aba8
        ;   XREF to: 0051aba8 (UNCONDITIONAL_JUMP)
    CMP EDI,0x67                        ; 0051abc1
        ;   Label: LAB_0051abc1
    JG 0x0051aae4                       ; 0051abc4 | LAB_0051aae4
        ;   XREF to: 0051aae4 (CONDITIONAL_JUMP)
    JMP 0x0051ab10                      ; 0051abca | LAB_0051ab10
    ...
    PUSH EBP                            ; 0051abd6
        ;   Label: LAB_0051abd6
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 0051abd7 | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0051abdc
    TEST EAX,EAX                        ; 0051abdf
    JL 0x0051abed                       ; 0051abe1 | LAB_0051abed
        ;   XREF to: 0051abed (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 0051abe3
    JNZ 0x0051abd6                      ; 0051abe6 | LAB_0051abd6
        ;   XREF to: 0051abd6 (CONDITIONAL_JUMP)
    DEC EDI                             ; 0051abe8
    TEST EDI,EDI                        ; 0051abe9
    JG 0x0051abd6                       ; 0051abeb | LAB_0051abd6
        ;   XREF to: 0051abd6 (CONDITIONAL_JUMP)
    XOR EDI,EDI                         ; 0051abed
        ;   Label: LAB_0051abed
    CMP EDI,dword ptr [ESI + 0x10]      ; 0051abef
        ;   Label: LAB_0051abef
    JGE 0x0051ac5a                      ; 0051abf2 | LAB_0051ac5a
    ...
    PUSH EBX                            ; 0051abfc
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0051abfd | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0051ac02
    CMP EAX,0x1                         ; 0051ac05
    JNZ 0x0051aab1                      ; 0051ac08 | LAB_0051aab1
        ;   XREF to: 0051aab1 (CONDITIONAL_JUMP)
    PUSH 0x0                            ; 0051ac0e
    ...
    PUSH EAX                            ; 0051ac20
    CALL crt_string.c_splitpath_FUN_005ff178 ; 0051ac21 | void crt_string.c_splitpath_FUN_005ff178(char * path, char * drive, char * dir, char * fname, ...)
        ;   XREF to: 005ff178 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0051ac26
    PUSH 0x637bd9                       ; 0051ac29 | = "raw" | s_raw_00637bd9 = raw
    ...
    PUSH EAX                            ; 0051ac4e
    INC EDI                             ; 0051ac4f
    CALL crt_file.c_makepath_FUN_005febfc ; 0051ac50 | void crt_file.c_makepath_FUN_005febfc(char * path_buffer, char * drive, char * directory, char * filename, ...)
        ;   XREF to: 005febfc (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0051ac55
    JMP 0x0051abef                      ; 0051ac58 | LAB_0051abef
    ...
    PUSH EBP                            ; 0051ac61
        ;   Label: LAB_0051ac61
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 0051ac62 | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0051ac67
    TEST EAX,EAX                        ; 0051ac6a
    JL 0x0051ac78                       ; 0051ac6c | LAB_0051ac78
        ;   XREF to: 0051ac78 (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 0051ac6e
    JNZ 0x0051ac61                      ; 0051ac71 | LAB_0051ac61
        ;   XREF to: 0051ac61 (CONDITIONAL_JUMP)
    DEC EDI                             ; 0051ac73
    TEST EDI,EDI                        ; 0051ac74
    JG 0x0051ac61                       ; 0051ac76 | LAB_0051ac61
        ;   XREF to: 0051ac61 (CONDITIONAL_JUMP)
    XOR EDI,EDI                         ; 0051ac78
        ;   Label: LAB_0051ac78
    CMP EDI,dword ptr [ESI + 0x8]       ; 0051ac7a
        ;   Label: LAB_0051ac7a
    JGE 0x0051acd8                      ; 0051ac7d | LAB_0051acd8
    ...
    PUSH EDX                            ; 0051acbc
    PUSH EAX                            ; 0051acbd
    PUSH 0x637bdd                       ; 0051acbe | = "%d, %d,%f,%f, %d,%f,%f, %d,%f,%f\n" | s_d_d_f_f_d_f_f_d_f_f_00637bdd = %d, %d,%f,%f, %d,%f,%f, %d,%f,%f

    PUSH EBX                            ; 0051acc3
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0051acc4 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x30                        ; 0051acc9
    CMP EAX,0xa                         ; 0051accc
    JNZ 0x0051aab1                      ; 0051accf | LAB_0051aab1
        ;   XREF to: 0051aab1 (CONDITIONAL_JUMP)
    INC EDI                             ; 0051acd5
    JMP 0x0051ac7a                      ; 0051acd6 | LAB_0051ac7a
    ...
    PUSH EBP                            ; 0051acdf
        ;   Label: LAB_0051acdf
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 0051ace0 | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0051ace5
    TEST EAX,EAX                        ; 0051ace8
    JL 0x0051acf6                       ; 0051acea | LAB_0051acf6
        ;   XREF to: 0051acf6 (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 0051acec
    JNZ 0x0051acdf                      ; 0051acef | LAB_0051acdf
        ;   XREF to: 0051acdf (CONDITIONAL_JUMP)
    DEC EDI                             ; 0051acf1
    TEST EDI,EDI                        ; 0051acf2
    JG 0x0051acdf                       ; 0051acf4 | LAB_0051acdf
        ;   XREF to: 0051acdf (CONDITIONAL_JUMP)
    XOR EDI,EDI                         ; 0051acf6
        ;   Label: LAB_0051acf6
    CMP EDI,dword ptr [ESI]             ; 0051acf8
        ;   Label: LAB_0051acf8
    JL 0x0051ad25                       ; 0051acfa | LAB_0051ad25
    ...
    CALL shape_meshlod.cpp_CLodMesh_postprocessMesh_FUN_0051b330 ; 0051ad12 | void shape_meshlod.cpp_CLodMesh_postprocessMesh_FUN_0051b330(CLodMesh * this_ptr)
    ...
    PUSH EDX                            ; 0051ad37
    PUSH EAX                            ; 0051ad38
    PUSH 0x637bff                       ; 0051ad39 | = "%f,%f,%f\n" | s_f_f_f_00637bff = %f,%f,%f

    PUSH EBX                            ; 0051ad3e
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0051ad3f | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0051ad44
    CMP EAX,0x3                         ; 0051ad47
    JNZ 0x0051aab1                      ; 0051ad4a | LAB_0051aab1
        ;   XREF to: 0051aab1 (CONDITIONAL_JUMP)
    INC EDI                             ; 0051ad50
    JMP 0x0051acf8                      ; 0051ad51 | LAB_0051acf8
