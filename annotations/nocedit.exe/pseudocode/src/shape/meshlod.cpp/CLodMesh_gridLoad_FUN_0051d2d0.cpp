...
// Convention: __cdecl
// Signature: void shape_meshlod.cpp_CLodMesh_gridLoad_FUN_0051d2d0(CLodMesh * this_ptr)
// Cross-references:
//   shape_meshlod.cpp_CLodMesh_FUN_0051b8a0 (0051b8a0) at 0051b8db [UNCONDITIONAL_CALL]
// Globals:
...
void __cdecl shape_meshlod_cpp_CLodMesh_gridLoad_FUN_0051d2d0(CLodMesh *this_ptr)

{
  ...
  pvVar1 = shape_memdbg_cpp_debugRealloc_FUN_0050f540
                     (this_ptr->field18_0x54,0x4004,"..\\shape\\meshlod.cpp",0x146f);
  this_ptr->field18_0x54 = pvVar1;
  if (pvVar1 == (void *)0x0) {
  ...
  pvVar1 = shape_memdbg_cpp_debugRealloc_FUN_0050f540
                     (this_ptr->field19_0x58,*(int *)((int)this_ptr->field18_0x54 + 0x4000) << 2,
                      "..\\shape\\meshlod.cpp",0x147a);
  this_ptr->field19_0x58 = pvVar1;
  if (pvVar1 == (void *)0x0) {
    g_CurrentFilename = "..\\shape\\meshlod.cpp";
    g_CurrentLineNumber = 0x147b;
    core_main_c_displayErrorAndQuit_FUN_00506f10("Out of memory!");
  }
  for (iVar2 = 0; iVar2 < *(int *)((int)this_ptr->field18_0x54 + 0x4000); iVar2 = iVar2 + 1) {
    crt_stdio_c_fscanf_FUN_005fe7c0(in_stack_00000008,"%d\n");
  }
  return;
}
