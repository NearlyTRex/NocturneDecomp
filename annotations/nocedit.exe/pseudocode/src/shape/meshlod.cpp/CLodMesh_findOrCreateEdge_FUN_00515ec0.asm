...
section .text
    ...
    JLE 0x00515eda                      ; 00515ed2 | LAB_00515eda
    ...
    JL 0x00515ee6                       ; 00515ef7 | LAB_00515ee6
        ;   XREF to: 00515ee6 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x20],0x0      ; 00515ef9
        ;   Label: LAB_00515ef9
    JNZ 0x00515f1a                      ; 00515efe | LAB_00515f1a
    ...
    CMP ESI,dword ptr [EAX]             ; 00515f0a
        ;   Label: LAB_00515f0a
    JNZ 0x00515eec                      ; 00515f0c | LAB_00515eec
        ;   XREF to: 00515eec (CONDITIONAL_JUMP)
    CMP EDI,dword ptr [EAX + 0x4]       ; 00515f0e
    JNZ 0x00515eec                      ; 00515f11 | LAB_00515eec
        ;   XREF to: 00515eec (CONDITIONAL_JUMP)
    ...
    PUSH 0x6374e0                       ; 00515f2b | = "..\\shape\\meshlod.cpp" | s_shape_meshlod_cpp_006374e0 = ..\shape\meshlod.cpp
    SUB EAX,EDX                         ; 00515f30
    PUSH EAX                            ; 00515f32
    MOV EDX,dword ptr [EBX + 0x48]      ; 00515f33
    PUSH EDX                            ; 00515f36
    CALL shape_memdbg.cpp_debugRealloc_FUN_0050f540 ; 00515f37 | void * shape_memdbg.cpp_debugRealloc_FUN_0050f540(void * ptr, int new_size, char * filename, int line_number)
        ;   XREF to: 0050f540 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00515f3c
    MOV dword ptr [EBX + 0x48],EAX      ; 00515f3f
    TEST EAX,EAX                        ; 00515f42
    JNZ 0x00515f68                      ; 00515f44 | LAB_00515f68
        ;   XREF to: 00515f68 (CONDITIONAL_JUMP)
    MOV EBP,0x6374f5                    ; 00515f46 | = "..\\shape\\meshlod.cpp" | s_shape_meshlod_cpp_006374f5 = ..\shape\meshlod.cpp
    MOV EAX,0x326                       ; 00515f4b
    PUSH 0x63750a                       ; 00515f50 | = "Out of memory" | s_Out_of_memory_0063750a = Out of memory
    MOV dword ptr [0x02f0ca48],EBP      ; 00515f55 | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 00515f5b | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00515f60 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    PUSH EAX                            ; 00515fd6
    CALL shape_meshlod.cpp_CLodVert_addAdjacentEdge_FUN_00515d90 ; 00515fd7 | void shape_meshlod.cpp_CLodVert_addAdjacentEdge_FUN_00515d90(CLodVert * this_ptr, int edge_index)
    ...
    PUSH EAX                            ; 00515fe8
    CALL shape_meshlod.cpp_CLodVert_addAdjacentEdge_FUN_00515d90 ; 00515fe9 | void shape_meshlod.cpp_CLodVert_addAdjacentEdge_FUN_00515d90(CLodVert * this_ptr, int edge_index)
        ;   XREF to: 00515d90 (UNCONDITIONAL_CALL)
