...
// Cross-references:
//   shape_meshlod.cpp_CLodMesh_generateLOD_FUN_00516ba0 (00516ba0) at 00516cda [UNCONDITIONAL_CALL]
//   shape_meshlod.cpp_CLodMesh_getLOD_FUN_0051b920 (0051b920) at 0051b995 [UNCONDITIONAL_CALL]
//   shape_meshlod.cpp_CLodMesh_replayLodGeneration_FUN_005173f0 (005173f0) at 00517489 [UNCONDITIONAL_CALL]
// Globals:
  ...
  *(undefined4 *)(local_a8 + 0x24) = 0;
  if (0 < local_a4) {
    ...
    do {
      ...
      iVar5 = iVar8 + 0x10;
      *(undefined4 *)((int)aiStack_4d8 + iVar8 + 4) = 1;
  ...
  if (0 < iVar8) {
    ...
    do {
      iVar9 = iVar4 + 4;
      *(undefined4 *)((int)afStack_1b8 + iVar4) =
           *(undefined4 *)((int)this_ptr->vertex_data[vertex_idx_2].adjacent_edge_indices + iVar4);
      iVar4 = iVar9;
    } while (SBORROW4(iVar9,iVar8 * 4) != iVar9 + iVar8 * -4 < 0);
  }
  if (0 < iVar8) {
    local_18 = 0;
    local_14 = iVar8 << 2;
  ...
  while (0 < *(int *)((int)local_50[4].adjacent_tri_indices +
    ...
    while( true ) {
      ...
      if (*(int *)((int)pCVar10->adjacent_edge_indices + (int)(local_40->attribute_indices + -1)) <=
          iVar8) break;
      puVar2 = (undefined1 *)(iVar4 + (int)local_40->attribute_indices);
      iVar4 = iVar4 + 4;
      iVar8 = iVar8 + 1;
...
// 00517763: PUSH EAX
// 00517764: CALL shape_meshlod.cpp_CLodVert_removeEdge_FUN_00515e00
...
// 00517780: PUSH EAX
// 00517781: CALL shape_meshlod.cpp_CLodVert_removeEdge_FUN_00515e00
//   XREF to: 00515e00 (UNCONDITIONAL_CALL)
...
// 00517acd: PUSH EAX
// 00517ace: PUSH EBX
// 00517acf: CALL shape_meshlod.cpp_CLodMesh_removeEdgeFromFace_FUN_005183e0
...
// 00517b85: PUSH ECX
// 00517b86: PUSH EBX
// 00517b87: CALL shape_meshlod.cpp_CLodMesh_extractFaceTexCoordGradient_FUN_00517530
...
// 00517da3: PUSH ECX
// 00517da4: PUSH EBX
// 00517da5: CALL shape_meshlod.cpp_CLodMesh_extractFaceTexCoordGradient_FUN_00517530
//   XREF to: 00517530 (UNCONDITIONAL_CALL)
...
// 00517f90: CALL shape_meshlod.cpp_CLodMesh_removeEdgeFromFace_FUN_005183e0
//   XREF to: 005183e0 (UNCONDITIONAL_CALL)
...
// 00517fb9: PUSH EAX
// 00517fba: CALL shape_meshlod.cpp_CLodEdge_addAdjacentFace_FUN_00515ca0
...
// 005180e3: PUSH EDX
// 005180e4: PUSH EBX
// 005180e5: CALL shape_meshlod.cpp_CLodMesh_getOtherVertexOnEdge_FUN_0051a980
...
// 005181bc: PUSH EAX
// 005181bd: CALL shape_meshlod.cpp_CLodVert_addAdjacentEdge_FUN_00515d90
...
// 0051827a: CALL shape_meshlod.cpp_CLodMesh_validateFace_FUN_00519830
...
//   Label: LAB_005182a5
// 005182a6: PUSH EBX
// 005182a7: CALL shape_meshlod.cpp_CLodMesh_findClosestFaceToSamplePoint_FUN_00518300
...
// 005182ce: PUSH ECX
// 005182cf: PUSH EAX
// 005182d0: CALL shape_meshlod.cpp_CLodFace_findVertexIndex_FUN_00515e90
