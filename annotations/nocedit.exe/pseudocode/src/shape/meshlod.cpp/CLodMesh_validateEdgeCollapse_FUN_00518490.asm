...
;                               FUNCTION
; *****************************************************************************
; __cdecl int shape_meshlod.cpp_CLodMesh_validateEdgeCollapse_FUN_00518490(CLodMesh * this_ptr, int vertex_idx_1, int vertex_idx_2, int vertex_idx_3)
;
; Parameters:
...
section .text
    ...
    PUSH EBP                            ; 005184aa
    PUSH EDI                            ; 005184ab
    CALL shape_meshlod.cpp_CLodMesh_findOrCreateEdge_FUN_00515ec0 ; 005184ac | int shape_meshlod.cpp_CLodMesh_findOrCreateEdge_FUN_00515ec0(CLodMesh * this_ptr, int vertex_idx_1, int vertex_idx_2, int create_if_missing)
        ;   XREF to: 00515ec0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 005184b1
    MOV dword ptr [ESP + 0x24],EAX      ; 005184b4
    TEST EAX,EAX                        ; 005184b8
    JL 0x0051851c                       ; 005184ba | LAB_0051851c
    ...
    JNZ 0x0051851c                      ; 005184d4 | LAB_0051851c
        ;   XREF to: 0051851c (CONDITIONAL_JUMP)
    CMP dword ptr [EDX + 0x24],0x2      ; 005184d6
    JL 0x0051851c                       ; 005184da | LAB_0051851c
        ;   XREF to: 0051851c (CONDITIONAL_JUMP)
    ...
    JGE 0x00518591                      ; 005184fd | LAB_00518591
        ;   XREF to: 00518591 (CONDITIONAL_JUMP)
    PUSH EDX                            ; 00518503
    PUSH EBP                            ; 00518504
    PUSH EDI                            ; 00518505
    CALL shape_meshlod.cpp_CLodMesh_getOtherVertexOnEdge_FUN_0051a980 ; 00518506 | int shape_meshlod.cpp_CLodMesh_getOtherVertexOnEdge_FUN_0051a980(CLodMesh * this_ptr, int vertex_index, int edge_array_index)
        ;   XREF to: 0051a980 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0051850b
    MOV EBX,dword ptr [ESP + 0x44]      ; 0051850e
    CMP EAX,EBX                         ; 00518512
    JNZ 0x00518529                      ; 00518514 | LAB_00518529
        ;   XREF to: 00518529 (CONDITIONAL_JUMP)
    INC dword ptr [ESP + 0x1c]          ; 00518516
        ;   Label: LAB_00518516
    JMP 0x005184ea                      ; 0051851a | LAB_005184ea
    ...
    PUSH EAX                            ; 0051852c
    PUSH EDI                            ; 0051852d
    CALL shape_meshlod.cpp_CLodMesh_findOrCreateEdge_FUN_00515ec0 ; 0051852e | int shape_meshlod.cpp_CLodMesh_findOrCreateEdge_FUN_00515ec0(CLodMesh * this_ptr, int vertex_idx_1, int vertex_idx_2, int create_if_missing)
        ;   XREF to: 00515ec0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00518533
    TEST EAX,EAX                        ; 00518536
    JL 0x00518516                       ; 00518538 | LAB_00518516
    ...
    JGE 0x0051857d                      ; 0051855a | LAB_0051857d
    ...
    PUSH EAX                            ; 0051856a
    CALL shape_meshlod.cpp_CLodFace_findVertexIndex_FUN_00515e90 ; 0051856b | int shape_meshlod.cpp_CLodFace_findVertexIndex_FUN_00515e90(CLodFace * this_ptr, int vertex_index)
        ;   XREF to: 00515e90 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00518570
    TEST EAX,EAX                        ; 00518573
    JGE 0x00518516                      ; 00518575 | LAB_00518516
        ;   XREF to: 00518516 (CONDITIONAL_JUMP)
    INC EBX                             ; 00518577
    ADD ESI,0x4                         ; 00518578
    JMP 0x0051854e                      ; 0051857b | LAB_0051854e
        ;   XREF to: 0051854e (UNCONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x18],0x0      ; 0051857d
        ;   Label: LAB_0051857d
    JNZ 0x00518516                      ; 00518582 | LAB_00518516
        ;   XREF to: 00518516 (CONDITIONAL_JUMP)
    ...
    PUSH EBP                            ; 00518591
        ;   Label: LAB_00518591
    PUSH EDI                            ; 00518592
    CALL shape_meshlod.cpp_CLodMesh_hasVertexBoundaryEdge_FUN_00518740 ; 00518593 | int shape_meshlod.cpp_CLodMesh_hasVertexBoundaryEdge_FUN_00518740(CLodMesh * this_ptr, int vertex_idx)
        ;   XREF to: 00518740 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00518598
    TEST EAX,EAX                        ; 0051859b
    JNZ 0x005186d2                      ; 0051859d | LAB_005186d2
        ;   XREF to: 005186d2 (CONDITIONAL_JUMP)
    CMP dword ptr [0x02f33330],0x0      ; 005185a3 | int g_LodReplayMode
        ;   Label: LAB_005185a3
    JNZ 0x00518729                      ; 005185aa | LAB_00518729
    ...
    JLE 0x0051866e                      ; 005185c7 | LAB_0051866e
    ...
    JL 0x0051862a                       ; 00518626 | LAB_0051862a
    ...
    JZ 0x00518647                       ; 0051863b | LAB_00518647
        ;   XREF to: 00518647 (CONDITIONAL_JUMP)
    CMP dword ptr [EAX + 0x18],0x0      ; 0051863d
    JNZ 0x0051851c                      ; 00518641 | LAB_0051851c
        ;   XREF to: 0051851c (CONDITIONAL_JUMP)
    CMP dword ptr [EDX + 0x18],0x1      ; 00518647
        ;   Label: LAB_00518647
    JG 0x0051851c                       ; 0051864b | LAB_0051851c
        ;   XREF to: 0051851c (CONDITIONAL_JUMP)
    CMP dword ptr [EAX + 0x18],0x1      ; 00518651
    JG 0x0051851c                       ; 00518655 | LAB_0051851c
        ;   XREF to: 0051851c (CONDITIONAL_JUMP)
    ...
    JL 0x005185d8                       ; 00518668 | LAB_005185d8
        ;   XREF to: 005185d8 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [ESP + 0x8]       ; 0051866e
        ;   Label: LAB_0051866e
    PUSH ESI                            ; 00518672
    PUSH EDI                            ; 00518673
    CALL shape_meshlod.cpp_CLodMesh_countNonCollapsibleEdgesForVertex_FUN_00516420 ; 00518674 | int shape_meshlod.cpp_CLodMesh_countNonCollapsibleEdgesForVertex_FUN_00516420(CLodMesh * this_ptr, int vertex_index)
    ...
    CALL shape_meshlod.cpp_CLodMesh_countNonCollapsibleEdgesForVertex_FUN_00516420 ; 00518686 | int shape_meshlod.cpp_CLodMesh_countNonCollapsibleEdgesForVertex_FUN_00516420(CLodMesh * this_ptr, int vertex_index)
        ;   XREF to: 00516420 (UNCONDITIONAL_CALL)
    ...
    JZ 0x0051871b                       ; 00518699 | LAB_0051871b
        ;   XREF to: 0051871b (CONDITIONAL_JUMP)
    CMP EBX,0x3                         ; 0051869f
    JL 0x005186ad                       ; 005186a2 | LAB_005186ad
        ;   XREF to: 005186ad (CONDITIONAL_JUMP)
    CMP EAX,0x3                         ; 005186a4
    JGE 0x0051851c                      ; 005186a7 | LAB_0051851c
        ;   XREF to: 0051851c (CONDITIONAL_JUMP)
    CMP ESI,0x1                         ; 005186ad
        ;   Label: LAB_005186ad
    JNZ 0x005186bb                      ; 005186b0 | LAB_005186bb
        ;   XREF to: 005186bb (CONDITIONAL_JUMP)
    CMP EDX,0x2                         ; 005186b2
    JNZ 0x0051851c                      ; 005186b5 | LAB_0051851c
        ;   XREF to: 0051851c (CONDITIONAL_JUMP)
    CMP EDX,0x1                         ; 005186bb
        ;   Label: LAB_005186bb
    JNZ 0x00518729                      ; 005186be | LAB_00518729
        ;   XREF to: 00518729 (CONDITIONAL_JUMP)
    CMP ESI,0x2                         ; 005186c0
    JZ 0x00518729                       ; 005186c3 | LAB_00518729
        ;   XREF to: 00518729 (CONDITIONAL_JUMP)
    ...
    PUSH EBX                            ; 005186d6
    PUSH EDI                            ; 005186d7
    CALL shape_meshlod.cpp_CLodMesh_hasVertexBoundaryEdge_FUN_00518740 ; 005186d8 | int shape_meshlod.cpp_CLodMesh_hasVertexBoundaryEdge_FUN_00518740(CLodMesh * this_ptr, int vertex_idx)
        ;   XREF to: 00518740 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005186dd
    TEST EAX,EAX                        ; 005186e0
    JZ 0x005185a3                       ; 005186e2 | LAB_005185a3
    ...
    JL 0x005185a3                       ; 005186fe | LAB_005185a3
        ;   XREF to: 005185a3 (CONDITIONAL_JUMP)
    ...
    MOV EDX,0x2                         ; 00518711
        ;   Label: LAB_00518711
    JMP 0x0051860d                      ; 00518716 | LAB_0051860d
        ;   XREF to: 0051860d (UNCONDITIONAL_JUMP)
    CMP EAX,0x1                         ; 0051871b
        ;   Label: LAB_0051871b
    JL 0x00518729                       ; 0051871e | LAB_00518729
        ;   XREF to: 00518729 (CONDITIONAL_JUMP)
    CMP EBX,0x1                         ; 00518720
    JGE 0x0051851c                      ; 00518723 | LAB_0051851c
        ;   XREF to: 0051851c (CONDITIONAL_JUMP)
