// Name: shape_meshlod.cpp_CLodMesh_FUN_0051aa60
// Address: 0051aa60
// Address Range: [[0051aa60, 0051ad52]]
// Convention: __cdecl
// Signature: void shape_meshlod.cpp_CLodMesh_FUN_0051aa60(CLodMesh * this_ptr)
// Cross-references:
...
void __cdecl shape_meshlod_cpp_CLodMesh_FUN_0051aa60(CLodMesh *this_ptr)

{
  ...
  iVar4 = crt_stdio_c_fscanf_FUN_005fe7c0(in_stack_00000008,"%d\n",local_2c);
...
LAB_0051abcf:
    ...
    for (iVar4 = 0; iVar4 < this_ptr->submesh_count; iVar4 = iVar4 + 1) {
      ...
      crt_file_c_makepath_FUN_005febfc
                ((char *)((int)this_ptr->submesh_data + iVar4 * 0x48 + 8),(char *)0x0,(char *)0x0,
                 acStack_114,"raw");
    }
    iVar4 = 1;
    do {
    ...
    for (iVar4 = 0; iVar4 < this_ptr->tri_count; iVar4 = iVar4 + 1) {
      pSVar2 = this_ptr->triangle_data + iVar4;
      iVar1 = crt_stdio_c_fscanf_FUN_005fe7c0
                        (in_stack_00000008,"%d, %d,%f,%f, %d,%f,%f, %d,%f,%f\n",pSVar2,
                         &pSVar2->vertex_idx_0,pSVar2->field4_0x1c,pSVar2->field4_0x1c + 4,
                         &pSVar2->vertex_idx_1,pSVar2->field4_0x1c + 8,pSVar2->field4_0x1c + 0xc,
                         &pSVar2->vertex_idx_2,pSVar2->field4_0x1c + 0x10,pSVar2->field4_0x1c + 0x14
                        );
    ...
    while( true ) {
      ...
      pSVar3 = this_ptr->vertex_data + iVar4;
      iVar1 = crt_stdio_c_fscanf_FUN_005fe7c0
                        (in_stack_00000008,"%f,%f,%f\n",pSVar3,pSVar3->field0_0x0 + 4,
                         pSVar3->field0_0x0 + 8);
      if (iVar1 != 3) break;
      iVar4 = iVar4 + 1;
    }
...
// Assembly code:
// 0051aa60: PUSH EBX
//   Label: shape_meshlod.cpp_CLodMesh_FUN_0051aa60
// 0051aa61: PUSH ESI
// 0051aa62: PUSH EDI
// 0051aa63: PUSH EBP
...
// 0051ab94: PUSH EAX
// 0051ab95: PUSH ESI
// 0051ab96: CALL shape_meshlod.cpp_CLodMesh_allocate_FUN_00515ac0
...
// 0051ad12: CALL shape_meshlod.cpp_CLodMesh_FUN_0051b330
