...
// Cross-references:
//   shape_meshlod.cpp_CLodMesh_generateLOD_FUN_00516ba0 (00516ba0) at 00516bdd [UNCONDITIONAL_CALL]
// Globals:
...

{
  ...
  edge_index = 0;
  local_20 = g_InfiniteCollapseCost._0_4_;
  local_18 = -1;
  uStack_1c = g_InfiniteCollapseCost._4_4_;
    ...
    do {
      if (*(int *)((int)this_ptr->edges_ptr->adjacent_tri_indices + iVar2 + -0x14) == 0) {
        ...
        if (*(double *)((int)pCVar1->adjacent_tri_indices + iVar2 + -0x20) <
          ...
          local_20 = *(undefined4 *)((int)pCVar1->adjacent_tri_indices + iVar2 + -0x20);
          uStack_1c = *(undefined4 *)((int)pCVar1->adjacent_tri_indices + iVar2 + -0x1c);
          local_18 = edge_index;
        }
      }
...
// 005196e2: PUSH EBX
// 005196e3: PUSH ESI
// 005196e4: CALL shape_meshlod.cpp_CLodMesh_computeEdgeCollapseCost_FUN_00518910
