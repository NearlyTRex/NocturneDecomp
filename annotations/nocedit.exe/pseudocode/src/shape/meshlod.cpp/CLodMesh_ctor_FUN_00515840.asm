...
;                               FUNCTION
; *****************************************************************************
; __cdecl CLodMesh * shape_meshlod.cpp_CLodMesh_ctor_FUN_00515840(CLodMesh * this_ptr)
;
; Parameters:
; CLodMesh *       Stack[0x4]:4   this_ptr
;
; XREF[4]:
;   core_skeledit.cpp_FUN_0058c190 at 0058c52e
...
section .text
    ...
    PUSH EBX                            ; 00515845
    CALL shape_meshlod.cpp_CLodMesh_init_FUN_00515880 ; 00515846 | void shape_meshlod.cpp_CLodMesh_init_FUN_00515880(CLodMesh * this_ptr)
