...
section .text
    ...
    JLE 0x00515185                      ; 0051516c | LAB_00515185
        ;   XREF to: 00515185 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 0051516e
        ;   Label: LAB_0051516e
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 0051516f | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00515174
    TEST EAX,EAX                        ; 00515177
    JL 0x00515185                       ; 00515179 | LAB_00515185
        ;   XREF to: 00515185 (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 0051517b
    JNZ 0x0051516e                      ; 0051517e | LAB_0051516e
        ;   XREF to: 0051516e (CONDITIONAL_JUMP)
    DEC ESI                             ; 00515180
    TEST ESI,ESI                        ; 00515181
    JG 0x0051516e                       ; 00515183 | LAB_0051516e
        ;   XREF to: 0051516e (CONDITIONAL_JUMP)
    POP ESI                             ; 00515185
        ;   Label: LAB_00515185
    POP EBX                             ; 00515186
