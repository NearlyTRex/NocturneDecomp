    ...
    do {
      ...
      if ((piVar5[0x10] == 0) && (-1 < *piVar5)) {
        ...
        if (iVar3 < 0) {
          ...
          core_main_c_displayErrorAndQuit_FUN_00506f10("LodMesh::fixupAfterCram - texture %s not found in cram list.",this_ptr->lod_textures[*piVar5].textures[0].texture_name);
        }
