...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_meshlod.cpp_CLodMesh_drawVertexIndexLabel_FUN_0051ecd0(CLodMesh * this_ptr, int vertex_index)
;
; Parameters:
...
section .text
    ...
    MOV EAX,[0x006703ec]                ; 0051ecde | CDemonRenderer * g_CDemonRendererPtr
    SUB EDX,ECX                         ; 0051ece3
    MOV EAX,dword ptr [EAX]             ; 0051ece5 | CDemonRenderer g_CDemonRendererInstance
    SHL EDX,0x4                         ; 0051ece7
    ADD EAX,EDX                         ; 0051ecea
    TEST byte ptr [EAX + 0x13],0x80     ; 0051ecec
    JZ 0x0051ecf6                       ; 0051ecf0 | LAB_0051ecf6
    ...
    PUSH 0x63852d                       ; 0051ecfc | = "%d" | s_d_0063852d = %d
    MOV ESI,dword ptr [EAX + 0x14]      ; 0051ed01
    LEA EAX,[ESP + 0x10]                ; 0051ed04
    PUSH EAX                            ; 0051ed08
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0051ed09 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH EAX                            ; 0051ed1d
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 0051ed1e | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
