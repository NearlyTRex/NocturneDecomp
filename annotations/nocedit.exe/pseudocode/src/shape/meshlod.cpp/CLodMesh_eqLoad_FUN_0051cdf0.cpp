...

{
  ...
  local_30 = shape_memdbg_cpp_debugCalloc_FUN_0050f350
  ...
  if (local_34 != this_ptr->edge_count) {
    local_1c = 0;
  }
  local_20 = 0;
  if (0 < (int)local_34) {
    ...
    dVar2 = (double)CONCAT44 /* combine 2-byte values */(9.9999999999999997e+34._4_4_,9.9999999999999997e+34._0_4_) *
            0.94999999999999996;
    local_24 = (int)local_30 + 8;
    local_18 = 0;
    local_2c = (int)local_30 + 0x10;
    do {
      piStack_14 = (int *)((int)local_30 + local_18);
      iVar3 = crt_stdio_c_fscanf_FUN_005fe7c0
                        (file_handle,"%d,%d,%lf,%f\n",piStack_14,local_28,local_24,local_2c);
      if (*(double *)(piStack_14 + 2) <= dVar2) {
LAB_0051d075:
        if (iVar3 != 4) {
          g_CurrentFilename = "..\\shape\\meshlod.cpp";
        ...
        piStack_14[2] = 9.9999999999999997e+34._0_4_;
        piStack_14[3] = 9.9999999999999997e+34._4_4_;
        piStack_14[4] = 0;
      ...
      if (local_1c != 0) {
        if (*(int *)((int)this_ptr->edges_ptr->adjacent_tri_indices + local_18 + -0x28) !=
            *piStack_14) {
          local_1c = 0;
        }
        if (piStack_14[1] !=
            *(int *)((int)this_ptr->edges_ptr->adjacent_tri_indices + local_18 + -0x24)) {
          local_1c = 0;
        }
      }
  ...
  shape_memdbg_cpp_debugFree_FUN_0050f460(local_30,"..\\shape\\meshlod.cpp",0x141f);
  return;
}
