// Name: shape_meshlod.cpp_CLodMesh_FUN_005173f0
// Address: 005173f0
// Address Range: [[005173f0, 0051752b]]
// Convention: __cdecl
// Signature: void shape_meshlod.cpp_CLodMesh_FUN_005173f0(CLodMesh * this_ptr)
// Globals:
...
//   shape_meshlod.cpp_CLodMesh_FUN_0051d180

#include "nocturne.h"

void __cdecl shape_meshlod_cpp_CLodMesh_FUN_005173f0(CLodMesh *this_ptr)

{
  ...
  *(undefined4 *)(&stack0xffffffe4 + (uint)bVar2 * -8) =
       *(undefined4 *)("replay.txt" + (uint)bVar2 * -8 + 4);
  *(undefined2 *)(&stack0xffffffe8 + (uint)bVar2 * -8 + (uint)bVar2 * -8) =
       *(undefined2 *)("replay.txt" + (uint)bVar2 * -8 + (uint)bVar2 * -8 + 8);
  *(char *)((int)(&stack0xffffffe8 + (uint)bVar2 * -8 + (uint)bVar2 * -8) +
           ((uint)bVar2 * -2 + 1) * 2) =
       ("replay.txt" + (uint)bVar2 * -8 + (uint)bVar2 * -8 + 8)[((uint)bVar2 * -2 + 1) * 2]
  ;
  file_ptr = shape_memdbg_cpp_openFile_FUN_0050f7a0(filename,directory,mode,source_file,iVar3);
  if (file_ptr == (FILE *)0x0) {
    shape_edittool_cpp_CEditorTools_showError_FUN_0049e740
              (g_CEditorToolsPtr,"Can't open %s");
    return;
  }
  shape_meshlod_cpp_CLodMesh_FUN_0051d180(this_ptr);
  iVar1 = 0;
  ...
  if (0 < this_ptr->lod_level_count) {
    do {
      ...
      shape_edittool_cpp_CEditorTools_updatePercentage_FUN_004a0530
                (g_CEditorToolsPtr,(float)iVar1,(float)this_ptr->lod_level_count);
      iVar3 = iVar1;
    } while (iVar1 < this_ptr->lod_level_count);
  }
  DAT_02f33330 = iVar3;
  shape_edittool_cpp_CEditorTools_restoreWindowAndCleanup_FUN_004a0dd0(g_CEditorToolsPtr);
  shape_meshlod_cpp_CLodMesh_eqLoad_FUN_0051cdf0(this_ptr);
  shape_memdbg_cpp_closeFile_FUN_0050f9b0(file_ptr,"..\\shape\\meshlod.cpp",0x60b);
  return;
}
...
// Assembly code:
// 005173f0: PUSH EBX
//   Label: shape_meshlod.cpp_CLodMesh_FUN_005173f0
// 005173f1: PUSH ESI
// 005173f2: PUSH EDI
// 005173f3: PUSH EBP
...
// 005173fb: PUSH EBX
// 005173fc: CALL shape_meshlod.cpp_CLodMesh_FUN_00516d50
...
// 0051743a: PUSH EAX
// 0051743b: PUSH EBX
// 0051743c: CALL shape_meshlod.cpp_CLodMesh_FUN_0051d180
...
// 00517487: PUSH EBX
// 00517488: INC ESI
// 00517489: CALL shape_meshlod.cpp_CLodMesh_FUN_00517630
