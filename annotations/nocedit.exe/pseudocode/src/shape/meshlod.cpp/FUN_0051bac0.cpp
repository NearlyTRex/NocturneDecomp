// Name: shape_meshlod.cpp_FUN_0051bac0
// Address: 0051bac0
// Address Range: [[0051bac0, 0051bcbf]]
// Convention: unknown
// Signature: undefined shape_meshlod.cpp_FUN_0051bac0()
// Cross-references:
...

{
  ...
  if (0 < *(int *)(in_stack_00000004 + 8)) {
    local_20 = 0;
    do {
      piVar5 = (int *)(*(int *)(in_stack_00000004 + 0xc) + local_20);
...
// Assembly code:
// 0051bac0: PUSH EBX
//   Label: shape_meshlod.cpp_FUN_0051bac0
// 0051bac1: PUSH ESI
// 0051bac2: PUSH EDI
// 0051bac3: PUSH EBP
