...
section .text
    ...
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0051ce16 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0051ce1b
    PUSH 0x13e4                         ; 0051ce1e
    PUSH 0x637fd8                       ; 0051ce23 | = "..\\shape\\meshlod.cpp" | s_shape_meshlod_cpp_00637fd8 = ..\shape\meshlod.cpp
    PUSH 0xf0                           ; 0051ce28
    MOV EBX,dword ptr [ESP + 0x14]      ; 0051ce2d
    PUSH EBX                            ; 0051ce31
    CALL shape_memdbg.cpp_debugCalloc_FUN_0050f350 ; 0051ce32 | void * shape_memdbg.cpp_debugCalloc_FUN_0050f350(SIZE_T count, SIZE_T size, char * filename, int line_number)
        ;   XREF to: 0050f350 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0051ce37
    MOV dword ptr [ESP + 0xc],EAX       ; 0051ce3a
    TEST EAX,EAX                        ; 0051ce3e
    JZ 0x0051d04e                       ; 0051ce40 | LAB_0051d04e
        ;   XREF to: 0051d04e (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x8]       ; 0051ce46
        ;   Label: LAB_0051ce46
    CMP EAX,dword ptr [EDI + 0x44]      ; 0051ce4a
    JZ 0x0051ce55                       ; 0051ce4d | LAB_0051ce55
    ...
    JLE 0x0051cfb1                      ; 0051ce61 | LAB_0051cfb1
        ;   XREF to: 0051cfb1 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0xc]       ; 0051ce67
    FLD double ptr [0x00661388]         ; 0051ce6b | double g_InfiniteCollapseCost
    ADD EAX,0x4                         ; 0051ce71
    FMUL double ptr [0x006380ad]        ; 0051ce74 | double DOUBLE_006380ad
    ...
    PUSH ECX                            ; 0051cebc
    PUSH 0x638011                       ; 0051cebd | = "%d,%d,%lf,%f\n" | s_d_d_lf_f_00638011 = %d,%d,%lf,%f

    MOV EBX,dword ptr [EBP + 0x18]      ; 0051cec2
    PUSH EBX                            ; 0051cec5
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0051cec6 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ...
    FNSTSW AX                           ; 0051cedc
    SAHF                                ; 0051cede
    JBE 0x0051d075                      ; 0051cedf | LAB_0051d075
        ;   XREF to: 0051d075 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x28]      ; 0051cee5
    MOV ECX,dword ptr [0x00661388]      ; 0051cee9 | double g_InfiniteCollapseCost
    ...
    JNZ 0x0051d075                      ; 0051cf05 | LAB_0051d075
        ;   XREF to: 0051d075 (CONDITIONAL_JUMP)
    MOV EBX,0x1                         ; 0051cf0b
    MOV ESI,dword ptr [EBP + 0x18]      ; 0051cf10
    PUSH ESI                            ; 0051cf13
        ;   Label: LAB_0051cf13
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 0051cf14 | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0051cf19
    TEST EAX,EAX                        ; 0051cf1c
    JL 0x0051cf2a                       ; 0051cf1e | LAB_0051cf2a
        ;   XREF to: 0051cf2a (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 0051cf20
    JNZ 0x0051cf13                      ; 0051cf23 | LAB_0051cf13
        ;   XREF to: 0051cf13 (CONDITIONAL_JUMP)
    DEC EBX                             ; 0051cf25
    TEST EBX,EBX                        ; 0051cf26
    JG 0x0051cf13                       ; 0051cf28 | LAB_0051cf13
        ;   XREF to: 0051cf13 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x20],0x0      ; 0051cf2a
        ;   Label: LAB_0051cf2a
    JZ 0x0051cf65                       ; 0051cf2f | LAB_0051cf65
    ...
    JZ 0x0051cf4a                       ; 0051cf42 | LAB_0051cf4a
    ...
    JZ 0x0051cf65                       ; 0051cf5d | LAB_0051cf65
        ;   XREF to: 0051cf65 (CONDITIONAL_JUMP)
    ...
    JL 0x0051cfc9                       ; 0051d001 | LAB_0051cfc9
    ...
    JLE 0x0051d030                      ; 0051d017 | LAB_0051d030
        ;   XREF to: 0051d030 (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 0051d019
        ;   Label: LAB_0051d019
    PUSH EBX                            ; 0051d01b
    PUSH EDI                            ; 0051d01c
    CALL shape_meshlod.cpp_CLodMesh_evaluateEdgeCollapse_FUN_00516000 ; 0051d01d | void shape_meshlod.cpp_CLodMesh_evaluateEdgeCollapse_FUN_00516000(CLodMesh * this_ptr, int edge_index, int full_check)
        ;   XREF to: 00516000 (UNCONDITIONAL_CALL)
    INC EBX                             ; 0051d022
    MOV ESI,dword ptr [EDI + 0x44]      ; 0051d023
    ADD ESP,0xc                         ; 0051d026
    CMP EBX,ESI                         ; 0051d029
    JL 0x0051d019                       ; 0051d02b | LAB_0051d019
        ;   XREF to: 0051d019 (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 0051d02d
    PUSH 0x141f                         ; 0051d030
        ;   Label: LAB_0051d030
    PUSH 0x638098                       ; 0051d035 | = "..\\shape\\meshlod.cpp" | s_shape_meshlod_cpp_00638098 = ..\shape\meshlod.cpp
    MOV ESI,dword ptr [ESP + 0x14]      ; 0051d03a
    PUSH ESI                            ; 0051d03e
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 0051d03f | void shape_memdbg.cpp_debugFree_FUN_0050f460(void * ptr, char * filename, int line_number)
    ...
    POP EBX                             ; 0051d04c
    RET                                 ; 0051d04d
    MOV ESI,0x637fed                    ; 0051d04e | = "..\\shape\\meshlod.cpp" | s_shape_meshlod_cpp_00637fed = ..\shape\meshlod.cpp
        ;   Label: LAB_0051d04e
    MOV EAX,0x13e5                      ; 0051d053
    PUSH 0x638002                       ; 0051d058 | = "Out of memory!" | s_Out_of_memory_00638002 = Out of memory!
    MOV dword ptr [0x02f0ca48],ESI      ; 0051d05d | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 0051d063 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0051d068 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0051d06d
    JMP 0x0051ce46                      ; 0051d070 | LAB_0051ce46
        ;   XREF to: 0051ce46 (UNCONDITIONAL_JUMP)
    CMP EDX,0x4                         ; 0051d075
        ;   Label: LAB_0051d075
    JZ 0x0051cf2a                       ; 0051d078 | LAB_0051cf2a
        ;   XREF to: 0051cf2a (CONDITIONAL_JUMP)
    MOV ESI,0x63801f                    ; 0051d07e | = "..\\shape\\meshlod.cpp" | s_shape_meshlod_cpp_0063801f = ..\shape\meshlod.cpp
    MOV EAX,0x13fa                      ; 0051d083
    PUSH 0x638034                       ; 0051d088 | = "LodMesh::eqLoad - file is corrupt." | s_LodMesh_eqLoad_file_is_c_00638034 = LodMesh::eqLoad - file is corrupt.
    MOV dword ptr [0x02f0ca48],ESI      ; 0051d08d | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 0051d093 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0051d098 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0051d09d
    JMP 0x0051cf2a                      ; 0051d0a0 | LAB_0051cf2a
        ;   XREF to: 0051cf2a (UNCONDITIONAL_JUMP)
    MOV EBX,0x638057                    ; 0051d0a5 | = "..\\shape\\meshlod.cpp" | s_shape_meshlod_cpp_00638057 = ..\shape\meshlod.cpp
        ;   Label: LAB_0051d0a5
    MOV ESI,0x1419                      ; 0051d0aa
    PUSH 0x63806c                       ; 0051d0af | = "LodMesh::eqLoad - EQ is not not up to..." | s_LodMesh_eqLoad_EQ_is_not_0063806c = LodMesh::eqLoad - EQ is not not up to date.
    MOV dword ptr [0x02f0ca48],EBX      ; 0051d0b4 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 0051d0ba | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0051d0c0 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0051d0c5
    PUSH EDI                            ; 0051d0c8
    CALL shape_meshlod.cpp_CLodMesh_computeAllEdgeCollapseCosts_FUN_00519710 ; 0051d0c9 | void shape_meshlod.cpp_CLodMesh_computeAllEdgeCollapseCosts_FUN_00519710(CLodMesh * this_ptr)
        ;   XREF to: 00519710 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0051d0ce
    JMP 0x0051d030                      ; 0051d0d1 | LAB_0051d030
