// Name: shape_meshlod.cpp_FUN_0051d2d0
// Address: 0051d2d0
// Address Range: [[0051d2d0, 0051d419]]
// Convention: unknown
// Signature: undefined shape_meshlod.cpp_FUN_0051d2d0()
// Cross-references:
//   shape_meshlod.cpp_FUN_0051b8a0 (0051b8a0) at 0051b8db [UNCONDITIONAL_CALL]
// Globals:
...
void shape_meshlod_cpp_FUN_0051d2d0(void)

{
  ...
  pvVar1 = shape_memdbg_cpp_debugRealloc_FUN_0050f540
                     (*(void **)(in_stack_00000004 + 0x54),0x4004,"..\\shape\\meshlod.cpp",
                      0x146f);
  *(void **)(in_stack_00000004 + 0x54) = pvVar1;
  if (pvVar1 == (void *)0x0) {
  ...
  pvVar1 = shape_memdbg_cpp_debugRealloc_FUN_0050f540
                     (*(void **)(in_stack_00000004 + 0x58),
                      *(int *)(*(int *)(in_stack_00000004 + 0x54) + 0x4000) << 2,
                      "..\\shape\\meshlod.cpp",0x147a);
  *(void **)(in_stack_00000004 + 0x58) = pvVar1;
  if (pvVar1 == (void *)0x0) {
    g_CurrentFilename = "..\\shape\\meshlod.cpp";
...
// Assembly code:
// 0051d2d0: PUSH EBX
//   Label: shape_meshlod.cpp_FUN_0051d2d0
// 0051d2d1: PUSH ESI
// 0051d2d2: PUSH EDI
// 0051d2d3: PUSH EBP
