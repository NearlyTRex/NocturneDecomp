...
// Cross-references:
//   shape_meshlod.cpp_CLodMesh_computeEdgeCollapseCost_FUN_00518910 (00518910) at 00518f21 [UNCONDITIONAL_CALL]
// Globals:
...

{
  ...
  if (0 < g_SamplePointCount) {
    ...
    do {
      *(undefined4 *)((int)g_SampleDistances + iVar4) = 0;
      iVar7 = iVar7 + 1;
      *(undefined4 *)((int)g_SampleDistances + iVar4 + 4) = 0x3ff00000;
  ...
  fVar9 = (float10)DOUBLE_00637a95;
  fVar11 = (float10)DOUBLE_00637a9d;
  ...
  dVar14 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44(in_EDX,pCVar1));
  ...
  while( true ) {
    ...
    fVar9 = ((float10)local_7c.min.x + (float10)DOUBLE_00637a95) * (float10)DOUBLE_00637a9d;
    dVar14 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44(uVar2,local_20));
    local_24 = (int)ROUND(fVar9);
    uVar2 = SUB84(dVar14,0) - local_24;
    ...
    fVar9 = ((float10)local_7c.min.z + (float10)DOUBLE_00637a95) * (float10)DOUBLE_00637a9d;
    local_7c.min.x = 7.495635e-39;
    dVar14 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44(uVar3,local_20));
    local_20 = (int)ROUND(fVar9);
    uVar2 = SUB84(dVar14,0) - local_20;
    uVar3 = (int)uVar2 >> 0x1f;
    iVar4 = (uVar2 ^ uVar3) - uVar3;
    if (iVar7 < iVar4) {
      iVar7 = iVar4;
    }
    fVar9 = ((float10)local_7c.max.y + (float10)DOUBLE_00637a95) * (float10)DOUBLE_00637a9d;
    local_7c.min.y = 7.495697e-39;
    dVar14 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44(uVar3,uStack_14));
    local_1c = (int)ROUND(fVar9);
    uVar2 = SUB84(dVar14,0) - local_1c;
    uVar3 = (int)uVar2 >> 0x1f;
    iVar4 = (uVar2 ^ uVar3) - uVar3;
    if (iVar7 < iVar4) {
      iVar7 = iVar4;
    }
    fVar9 = ((float10)local_64 + (float10)DOUBLE_00637a95) * (float10)DOUBLE_00637a9d;
    local_7c.min.z = 7.495758e-39;
    dVar14 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44(uVar3,uStack_14));
    local_18 = (int)ROUND(fVar9);
    uVar2 = SUB84(dVar14,0) - local_18;
    uVar3 = (int)uVar2 >> 0x1f;
    iVar4 = (uVar2 ^ uVar3) - uVar3;
    if (iVar7 < iVar4) {
      iVar7 = iVar4;
    }
    fVar9 = ((float10)local_5c + (float10)DOUBLE_00637a95) * (float10)DOUBLE_00637a9d;
    local_7c.max.x = 7.49582e-39;
    dVar14 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44(uVar3,uStack_14));
    uStack_14 = (uint)ROUND(fVar9);
    uVar2 = SUB84(dVar14,0) - uStack_14;
    uVar3 = (int)uVar2 >> 0x1f;
    iVar4 = (uVar2 ^ uVar3) - uVar3;
    if (iVar7 < iVar4) {
      iVar7 = iVar4;
    }
    fVar9 = ((float10)local_54 + (float10)DOUBLE_00637a95) * (float10)DOUBLE_00637a9d;
    local_7c.max.y = 7.495882e-39;
    dVar14 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44(uVar3,iVar6));
    uVar3 = SUB84(dVar14,0) - (int)ROUND(fVar9);
...
// 00519d65: PUSH EAX
// 00519d66: INC EBX
// 00519d67: CALL shape_meshlod.cpp_CLodMesh_processGridCell_FUN_0051a030
...
//   XREF to: Stack[0x4] (READ)
// 00519ffc: PUSH EDX
// 00519ffd: CALL shape_meshlod.cpp_CLodMesh_processGridCell_FUN_0051a030
//   XREF to: 0051a030 (UNCONDITIONAL_CALL)
