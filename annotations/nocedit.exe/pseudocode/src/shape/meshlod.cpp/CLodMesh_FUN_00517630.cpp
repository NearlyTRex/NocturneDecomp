// Name: shape_meshlod.cpp_CLodMesh_FUN_00517630
// Address: 00517630
// Address Range: [[00517630, 005182f0]]
// Convention: __cdecl
// Signature: void shape_meshlod.cpp_CLodMesh_FUN_00517630(CLodMesh * this_ptr)
// Cross-references:
//   shape_meshlod.cpp_CLodMesh_FUN_00516ba0 (00516ba0) at 00516cda [UNCONDITIONAL_CALL]
//   shape_meshlod.cpp_CLodMesh_FUN_005173f0 (005173f0) at 00517489 [UNCONDITIONAL_CALL]
//   shape_meshlod.cpp_CLodMesh_getLOD_FUN_0051b920 (0051b920) at 0051b995 [UNCONDITIONAL_CALL]
// Globals:
...
//   shape_meshlod.cpp_CLodMesh_removeEdgeFromTriangle_FUN_005183e0
...
void __cdecl shape_meshlod_cpp_CLodMesh_FUN_00517630(CLodMesh *this_ptr)

{
  ...
  pSVar9 = this_ptr->vertex_data;
  local_f0.y = *(float *)pSVar9[in_stack_0000000c].field0_0x0 * in_stack_00000010;
  local_f0.z = *(float *)(pSVar9[in_stack_0000000c].field0_0x0 + 4) * in_stack_00000010;
  local_e4 = *(float *)(pSVar9[in_stack_0000000c].field0_0x0 + 8) * in_stack_00000010;
  local_d8 = 1.0 - in_stack_00000010;
  pSVar9 = this_ptr->vertex_data;
  local_e0 = *(float *)pSVar9[in_stack_00000008].field0_0x0 * local_d8;
  local_dc = *(float *)(pSVar9[in_stack_00000008].field0_0x0 + 4) * local_d8;
  local_d8 = *(float *)(pSVar9[in_stack_00000008].field0_0x0 + 8) * local_d8;
  ...
  *(undefined4 *)(local_a8 + 0x14) = 1;
  if (0 < *(int *)(local_a8 + 0x24)) {
    ...
    do {
      ...
      local_9c = this_ptr->triangle_data + *(int *)(local_38 + 0x28);
      iVar7 = 0;
      if (0 < local_a4) {
        iVar3 = 0;
        do {
          if (*(int *)((int)aiStack_4d8 + iVar3) == *(int *)local_9c->field0_0x0) break;
          iVar3 = iVar3 + 0x10;
          iVar7 = iVar7 + 1;
        } while (iVar3 < local_a4 * 0x10);
      }
      if (local_a4 <= iVar7) {
        iVar3 = *(int *)local_9c->field0_0x0;
        aiStack_4d8[iVar7 * 4 + 1] = 0;
        afStack_4d0[iVar7 * 4] = 0.0;
        afStack_4d0[iVar7 * 4 + 1] = 0.0;
        aiStack_4d8[iVar7 * 4] = iVar3;
        local_a4 = local_a4 + 1;
      }
      aiStack_4d8[iVar7 * 4 + 1] = aiStack_4d8[iVar7 * 4 + 1] + 1;
      local_40 = local_9c;
      local_3c = (SLodTriangle *)(local_9c->field0_0x0 + 0xc);
      pSVar6 = local_9c;
      do {
        pSVar2 = local_40;
        fVar1 = fStack_4dc;
        if ((pSVar6->vertex_idx_0 == in_stack_00000008) ||
           (fVar1 = in_stack_fffffb20, pSVar6->vertex_idx_0 == in_stack_0000000c)) {
          afStack_4d0[iVar7 * 4] = *(float *)local_40->field4_0x1c * fVar1 + afStack_4d0[iVar7 * 4];
          afStack_4d0[iVar7 * 4 + 1] =
               fVar1 * *(float *)(pSVar2->field4_0x1c + 4) + afStack_4d0[iVar7 * 4 + 1];
        }
        if (pSVar6->edge_idx_0 != local_ac) {
          shape_meshlod_cpp_CLodMesh_removeEdgeFromTriangle_FUN_005183e0
                    (this_ptr,local_a0,pSVar6->edge_idx_0);
        }
        pSVar6 = (SLodTriangle *)(pSVar6->field0_0x0 + 4);
        local_40 = (SLodTriangle *)(local_40->field0_0x0 + 8);
      } while (pSVar6 != local_3c);
  ...
  *(undefined4 *)(local_a8 + 0x24) = 0;
  if (0 < local_a4) {
    ...
    iVar7 = 0;
    do {
      iVar8 = *(int *)((int)aiStack_4d8 + iVar7 + 4);
      fVar1 = *(float *)((int)afStack_4d0 + iVar7);
      iVar5 = *(int *)((int)aiStack_4d8 + iVar7 + 4);
      iVar4 = iVar7 + 0x10;
      *(undefined4 *)((int)aiStack_4d8 + iVar7 + 4) = 1;
      *(float *)((int)afStack_4d0 + iVar7) = fVar1 / (float)iVar8;
      *(float *)((int)afStack_4d0 + iVar7 + 4) =
           *(float *)((int)afStack_4d0 + iVar7 + 4) / (float)iVar5;
      iVar7 = iVar4;
    } while (iVar4 < iVar3);
  }
  ...
  if (0.0 < in_stack_fffffb20) {
    ...
    for (iVar7 = 0;
        iVar7 < *(int *)((int)this_ptr->vertex_data->adjacent_edge_indices + local_4c + -4);
        iVar7 = iVar7 + 1) {
      ...
      if (0 < local_98->adjacent_tri_count) {
        ...
        do {
          ...
          pSVar6 = this_ptr->triangle_data + local_30->adjacent_tri_indices[0];
          if (DAT_02f33334 != *(int *)(pSVar6->field10_0x50 + 0x34)) {
            iVar3 = pSVar6->vertex_idx_0;
            *(int *)(pSVar6->field10_0x50 + 0x34) = DAT_02f33334;
            iVar8 = 0;
            pSVar2 = pSVar6;
            while (iVar3 != in_stack_00000008) {
              iVar8 = iVar8 + 1;
              if (2 < iVar8) break;
              iVar3 = pSVar2->vertex_idx_1;
              pSVar2 = (SLodTriangle *)(pSVar2->field0_0x0 + 4);
            }
            iVar3 = 0;
            if (0 < local_a4) {
              iVar5 = 0;
              local_34 = local_a4 << 4;
              do {
                if (*(int *)((int)aiStack_4d8 + iVar5) == *(int *)pSVar6->field0_0x0) break;
                iVar5 = iVar5 + 0x10;
                iVar3 = iVar3 + 1;
              } while (iVar5 < local_a4 << 4);
            }
            if (iVar3 < local_a4) {
              *(float *)(pSVar6->field4_0x1c + iVar8 * 8) = afStack_4d0[iVar3 * 4];
              *(float *)(pSVar6->field4_0x1c + iVar8 * 8 + 4) = afStack_4d0[iVar3 * 4 + 1];
              iVar3 = 2;
            }
            else {
              iVar3 = 0;
            }
            pcVar11 = pSVar6->field0_0x0 + iVar3 * 4 + iVar8 * 8;
            for (; iVar3 < this_ptr->field7_0x1c; iVar3 = iVar3 + 1) {
              shape_meshlod_cpp_CLodMesh_extractTriangleTexCoordGradient_FUN_00517530
                        (this_ptr,local_90,iVar3,&local_f0,&local_8c);
              *(float *)(pcVar11 + 0x1c) =
          ...
          local_94 = local_94 + 1;
          local_30 = (SLodEdge *)&local_30->vertex_idx_2;
  ...
  if (0.0 < fStack_4dc) {
    ...
    for (iVar7 = 0;
        iVar7 < *(int *)((int)this_ptr->vertex_data->adjacent_edge_indices + local_48 + -4);
        iVar7 = iVar7 + 1) {
      ...
      if (0 < local_88->adjacent_tri_count) {
        ...
        do {
          ...
          pSVar6 = this_ptr->triangle_data + local_24->adjacent_tri_indices[0];
          if (DAT_02f33334 != *(int *)(pSVar6->field10_0x50 + 0x34)) {
            iVar3 = pSVar6->vertex_idx_0;
            *(int *)(pSVar6->field10_0x50 + 0x34) = DAT_02f33334;
            iVar8 = 0;
            ...
            for (; iVar3 < this_ptr->field7_0x1c; iVar3 = iVar3 + 1) {
              shape_meshlod_cpp_CLodMesh_extractTriangleTexCoordGradient_FUN_00517530
                        (this_ptr,local_80,iVar3,&local_cc,&local_7c);
              *(float *)(pcVar11 + 0x1c) =
          ...
          local_84 = local_84 + 1;
          local_24 = (SLodEdge *)&local_24->vertex_idx_2;
        } while (local_84 < local_88->adjacent_tri_count);
      }
      local_20 = local_20 + 4;
    }
  }
  iVar7 = this_ptr->vertex_data[in_stack_0000000c].adjacent_edge_count;
  if (0 < iVar7) {
    iVar3 = 0;
    do {
      iVar8 = iVar3 + 4;
      *(undefined4 *)((int)afStack_1b8 + iVar3) =
           *(undefined4 *)
            ((int)this_ptr->vertex_data[in_stack_0000000c].adjacent_edge_indices + iVar3);
      iVar3 = iVar8;
    } while (SBORROW4(iVar8,iVar7 * 4) != iVar8 + iVar7 * -4 < 0);
  }
  if (0 < iVar7) {
    local_18 = 0;
    local_14 = iVar7 << 2;
    ...
    do {
      ...
      pSVar12 = this_ptr->edges_ptr + (int)local_78;
      iVar7 = 0;
      pSVar10 = pSVar12;
      if (0 < pSVar12->adjacent_tri_count) {
        do {
          local_1c = pSVar10;
          pSVar6 = this_ptr->triangle_data + local_1c->adjacent_tri_indices[0];
          pcVar11 = pSVar6->field0_0x0;
          do {
            if (pSVar6->vertex_idx_0 == in_stack_0000000c) {
              pSVar6->vertex_idx_0 = in_stack_00000008;
            }
            pSVar6 = (SLodTriangle *)(pSVar6->field0_0x0 + 4);
          } while (pSVar6 != (SLodTriangle *)(pcVar11 + 0xc));
          iVar7 = iVar7 + 1;
          local_1c = (SLodEdge *)&local_1c->vertex_idx_2;
          pSVar10 = local_1c;
        } while (iVar7 < pSVar12->adjacent_tri_count);
      }
      local_74 = -1;
      if (pSVar12->vertex_idx_1 == in_stack_0000000c) {
        local_74 = shape_meshlod_cpp_CLodMesh_findOrCreateEdge_FUN_00515ec0
                             (this_ptr,in_stack_00000008,pSVar12->vertex_idx_2,0);
        if (local_74 < 0) {
          pSVar12->vertex_idx_1 = in_stack_00000008;
        }
      }
      else if (in_stack_0000000c == pSVar12->vertex_idx_2) {
        local_74 = shape_meshlod_cpp_CLodMesh_findOrCreateEdge_FUN_00515ec0
                             (this_ptr,pSVar12->vertex_idx_1,in_stack_00000008,0);
        if (local_74 < 0) {
          pSVar12->vertex_idx_2 = in_stack_00000008;
        }
      }
      else {
        g_CurrentFilename = "..\\shape\\meshlod.cpp";
      ...
      if (local_74 < 0) {
        if (pSVar12->vertex_idx_2 < pSVar12->vertex_idx_1) {
          iVar7 = pSVar12->vertex_idx_1;
          pSVar12->vertex_idx_1 = pSVar12->vertex_idx_2;
          pSVar12->vertex_idx_2 = iVar7;
        }
        shape_meshlod_cpp_addAdjacentEdgeToVertex_FUN_00515d90
                  ((SLodVert *)(this_ptr->vertex_data->field0_0x0 + local_68),(int)local_78);
        iVar7 = local_6c;
      }
      else {
        iVar3 = pSVar12->adjacent_tri_count;
        iVar8 = local_74 * 0xf0;
        iVar7 = local_6c;
        while (local_6c = iVar8, 0 < iVar3) {
          in_stack_fffffb20 = (float)pSVar12->adjacent_tri_indices[0];
          local_70 = this_ptr->triangle_data + (int)in_stack_fffffb20;
          shape_meshlod_cpp_CLodMesh_removeEdgeFromTriangle_FUN_005183e0
                    (this_ptr,(int)in_stack_fffffb20,(int)local_78);
          *(SLodTriangle **)(extraout_EAX * 4 + local_6c + 0x34) = local_70;
          shape_meshlod_cpp_addAdjacentTriangleToEdge_FUN_00515ca0
                    ((SLodEdge *)(this_ptr->edges_ptr->field2_0x8 + local_68 + -8),
  ...
  this_ptr->vertex_data[in_stack_0000000c].adjacent_edge_count = 0;
  local_64 = in_stack_00000008 * 0x4c4;
  pSVar9 = this_ptr->vertex_data + in_stack_00000008;
  *(float *)pSVar9->field0_0x0 = local_c0;
  *(float *)(pSVar9->field0_0x0 + 4) = local_bc;
  *(float *)(pSVar9->field0_0x0 + 8) = local_b8;
  iVar7 = 0;
  if (0 < this_ptr->field8_0x20) {
    iVar3 = 0;
    do {
      pSVar9 = this_ptr->vertex_data;
      iVar7 = iVar7 + 1;
      *(float *)(pSVar9[in_stack_00000008].field0_0x0 + iVar3 + 0xc) =
           *(float *)(pSVar9[in_stack_0000000c].field0_0x0 + iVar3 + 0xc) * in_stack_fffffb20 +
           *(float *)(pSVar9[in_stack_00000008].field0_0x0 + iVar3 + 0xc) * fStack_4dc;
      iVar3 = iVar3 + 4;
      local_60 = local_64;
      local_5c = in_stack_0000000c * 0x4c4;
    } while (iVar7 < this_ptr->field8_0x20);
  }
  local_50 = (SLodEdge *)(in_stack_00000008 * 0x4c4);
  DAT_02f33334 = DAT_02f33334 + 1;
  while (0 < *(int *)((int)local_50[4].adjacent_tri_indices +
                     (int)(this_ptr->vertex_data->field0_0x0 + 0x10))) {
    iVar7 = shape_meshlod_cpp_FUN_0051a980();
    local_40 = (SLodTriangle *)(iVar7 * 0x4c4);
    iVar7 = 0;
    iVar3 = 0;
    while( true ) {
      pSVar9 = this_ptr->vertex_data;
      if (*(int *)((int)pSVar9->adjacent_edge_indices + (int)(local_40->field0_0x0 + -4)) <= iVar7)
      break;
      pcVar11 = local_40->field0_0x0 + iVar3;
      iVar3 = iVar3 + 4;
      iVar7 = iVar7 + 1;
      this_ptr->edges_ptr[*(int *)((int)pSVar9->adjacent_edge_indices + (int)pcVar11)].field6_0x20 =
           1;
    }
    local_54 = *(int *)((int)pSVar9->adjacent_edge_indices + local_4c);
    pSVar10 = this_ptr->edges_ptr + local_54;
    iVar7 = 0;
    local_50 = pSVar10;
    if (0 < pSVar10->adjacent_tri_count) {
      do {
        if (DAT_02f33334 !=
            *(int *)(this_ptr->triangle_data[pSVar10->adjacent_tri_indices[0]].field10_0x50 + 0x34))
        {
          *(int *)(this_ptr->triangle_data[pSVar10->adjacent_tri_indices[0]].field10_0x50 + 0x34) =
               DAT_02f33334;
        ...
        iVar7 = iVar7 + 1;
        pSVar10 = (SLodEdge *)&pSVar10->vertex_idx_2;
      } while (iVar7 < local_50->adjacent_tri_count);
    }
  ...
  if (0 < this_ptr->sample_point_count) {
    iVar3 = 0;
    do {
      if ((this_ptr->triangle_data[*(int *)(iVar3 + 0xc + (int)this_ptr->sample_points_ptr)].
           processed_flag != 0) ||
         (iVar8 = shape_meshlod_cpp_findVertexIndexInTriangle_FUN_00515e90
                            (this_ptr->triangle_data +
                             *(int *)(iVar3 + 0xc + (int)this_ptr->sample_points_ptr),
                             in_stack_00000008), -1 < iVar8)) {
        shape_meshlod_cpp_CLodMesh_FUN_00518300(this_ptr);
      }
      iVar7 = iVar7 + 1;
      iVar3 = iVar3 + 0x1c;
    } while (iVar7 < this_ptr->sample_point_count);
  }
  if (local_b0 == (SLodEdge *)0x0) {
    return;
  }
  return;
}
...
// Assembly code:
// 00517630: PUSH EBX
//   Label: shape_meshlod.cpp_CLodMesh_FUN_00517630
// 00517631: PUSH ESI
// 00517632: PUSH EDI
// 00517633: PUSH EBP
...
// 00517655: CALL shape_meshlod.cpp_CLodMesh_findOrCreateEdge_FUN_00515ec0
...
// 00517763: PUSH EAX
// 00517764: CALL shape_meshlod.cpp_removeEdgeFromVertex_FUN_00515e00
...
// 00517780: PUSH EAX
// 00517781: CALL shape_meshlod.cpp_removeEdgeFromVertex_FUN_00515e00
//   XREF to: 00515e00 (UNCONDITIONAL_CALL)
...
// 00517acd: PUSH EAX
// 00517ace: PUSH EBX
// 00517acf: CALL shape_meshlod.cpp_CLodMesh_removeEdgeFromTriangle_FUN_005183e0
...
// 00517b85: PUSH ECX
// 00517b86: PUSH EBX
// 00517b87: CALL shape_meshlod.cpp_CLodMesh_extractTriangleTexCoordGradient_FUN_00517530
...
// 00517da3: PUSH ECX
// 00517da4: PUSH EBX
// 00517da5: CALL shape_meshlod.cpp_CLodMesh_extractTriangleTexCoordGradient_FUN_00517530
//   XREF to: 00517530 (UNCONDITIONAL_CALL)
...
// 00517f11: PUSH ESI
// 00517f12: PUSH EBX
// 00517f13: CALL shape_meshlod.cpp_CLodMesh_findOrCreateEdge_FUN_00515ec0
//   XREF to: 00515ec0 (UNCONDITIONAL_CALL)
...
// 00517f90: CALL shape_meshlod.cpp_CLodMesh_removeEdgeFromTriangle_FUN_005183e0
//   XREF to: 005183e0 (UNCONDITIONAL_CALL)
...
// 00517fb9: PUSH EAX
// 00517fba: CALL shape_meshlod.cpp_addAdjacentTriangleToEdge_FUN_00515ca0
...
// 0051814a: PUSH EDX
// 0051814b: PUSH EBX
// 0051814c: CALL shape_meshlod.cpp_CLodMesh_findOrCreateEdge_FUN_00515ec0
//   XREF to: 00515ec0 (UNCONDITIONAL_CALL)
...
// 005181bc: PUSH EAX
// 005181bd: CALL shape_meshlod.cpp_addAdjacentEdgeToVertex_FUN_00515d90
...
// 005181d3: PUSH ECX
// 005181d4: PUSH EBX
// 005181d5: CALL shape_meshlod.cpp_CLodMesh_evaluateEdgeCollapse_FUN_00516000
...
//   Label: LAB_005182a5
// 005182a6: PUSH EBX
// 005182a7: CALL shape_meshlod.cpp_CLodMesh_FUN_00518300
...
// 005182ce: PUSH ECX
// 005182cf: PUSH EAX
// 005182d0: CALL shape_meshlod.cpp_findVertexIndexInTriangle_FUN_00515e90
