...
section .text
    ...
    JGE 0x00515cbb                      ; 00515ca9
        ;   XREF to: 00515cbb (CONDITIONAL_JUMP)  ; LAB_00515cbb
    ...
    PUSH EDI                            ; 00515cbb
        ;   Label: LAB_00515cbb
    PUSH ESI                            ; 00515cbc
    PUSH 0x637466                       ; 00515cbd | = "Too many adj faces!"
    MOV ECX,dword ptr [0x00678a60]      ; 00515cc2 | g_CEditorToolsPtr
    PUSH ECX                            ; 00515cc8 | g_CEditorToolsInstance
    CALL shape_edittool.cpp_CEditorTools_showError_FUN_0049e740 ; 00515cc9
        ;   XREF to: 0049e740 (UNCONDITIONAL_CALL)  ; void shape_edittool.cpp_CEditorTools_showError_FUN_0049e740(CEditorTools * this_ptr, char * format)
    ADD ESP,0x8                         ; 00515cce
    MOV ESI,0x63747a                    ; 00515cd1 | = "..\\shape\\meshlod.cpp"
    MOV EDI,0x281                       ; 00515cd6
    PUSH 0x63748f                       ; 00515cdb | = "Too many adj faces!"
    MOV dword ptr [0x02f0ca48],ESI      ; 00515ce0 | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 00515ce6 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00515cec
