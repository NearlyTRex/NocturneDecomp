...
// Convention: __cdecl
// Signature: void shape_meshlod.cpp_CLodMesh_compactFaces_FUN_0051b570(CLodMesh * this_ptr)
// Cross-references:
//   shape_meshlod.cpp_CLodMesh_getLOD_FUN_0051b920 (0051b920) at 0051ba4b [UNCONDITIONAL_CALL]
//   shape_meshlod.cpp_CLodMesh_postprocessMesh_FUN_0051b330 (0051b330) at 0051b3be [UNCONDITIONAL_CALL]
// Function calls:
...

{
  ...
  if (0 < this_ptr->tri_count) {
    ...
    do {
      ...
      if (*(int *)((int)pCVar1->edge_perpendiculars + iVar5 + -0x14) == 0) {
        ...
        *(undefined4 *)((int)pCVar1->edge_perpendiculars + iVar5 + -0x14) = 0xffffffff;
      }
      iVar3 = iVar3 + 1;
      iVar5 = iVar5 + 0x8c;
  ...
  if (0 < this_ptr->tri_count) {
    ...
    local_24 = 0;
    do {
      puVar2 = (undefined4 *)((int)this_ptr->tri_data->attribute_indices + local_24);
      if (-1 < (int)puVar2[0x10]) {
        if (local_20 < local_14) {
          puVar4 = (undefined4 *)((int)this_ptr->tri_data->attribute_indices + local_18);
        ...
        local_20 = local_20 + 1;
        *(undefined4 *)((int)this_ptr->tri_data->edge_perpendiculars + local_18 + -0x14) = 0;
