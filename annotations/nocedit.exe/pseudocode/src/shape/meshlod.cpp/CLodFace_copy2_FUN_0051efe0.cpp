...
// Convention: __cdecl
// Signature: CLodFace * shape_meshlod.cpp_CLodFace_copy2_FUN_0051efe0(CLodFace * destination, CLodFace * source)
// Function calls:
...

{
  ...
  puVar5 = (undefined4 *)((int)destination + (uint)bVar6 * -8 + 0x7c);
  puVar3 = (undefined4 *)((int)source + (uint)bVar6 * -8 + 0x7c);
