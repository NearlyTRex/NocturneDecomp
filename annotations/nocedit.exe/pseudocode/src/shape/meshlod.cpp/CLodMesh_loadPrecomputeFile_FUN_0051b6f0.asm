...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl shape_meshlod_cpp_CLodMesh_loadPrecomputeFile_FUN_0051b6f0(CLodMesh *this_ptr)
;
; Parameters:
...
section .text
    ...
    JNZ 0x0051b707                      ; 0051b704
        ;   XREF to: 0051b707 (CONDITIONAL_JUMP)  ; LAB_0051b707
    RET                                 ; 0051b706
    PUSH 0x1210                         ; 0051b707
        ;   Label: LAB_0051b707
    PUSH 0x637cf8                       ; 0051b70c | = "..\\shape\\meshlod.cpp"
    PUSH EAX                            ; 0051b711
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 0051b712
