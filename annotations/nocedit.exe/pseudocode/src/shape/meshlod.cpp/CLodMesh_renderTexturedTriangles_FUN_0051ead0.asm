...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_meshlod.cpp_CLodMesh_renderTexturedTriangles_FUN_0051ead0(CLodMesh * this_ptr, int enable_texture_lookup, int use_atlas_mode)
;
; Parameters:
...
section .text
    ...
    JLE 0x0051eb4a                      ; 0051eb08 | LAB_0051eb4a
    ...
    JZ 0x0051eb52                       ; 0051eb24 | LAB_0051eb52
    ...
    JL 0x0051eb0e                       ; 0051eb48 | LAB_0051eb0e
    ...
    JL 0x0051eb66                       ; 0051eb56 | LAB_0051eb66
        ;   XREF to: 0051eb66 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x80],0x0      ; 0051eb58
    JNZ 0x0051ec67                      ; 0051eb60 | LAB_0051ec67
    ...
    JL 0x0051ebab                       ; 0051eb8c | LAB_0051ebab
        ;   XREF to: 0051ebab (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x80],0x0      ; 0051eb8e
    JZ 0x0051ebab                       ; 0051eb96 | LAB_0051ebab
        ;   XREF to: 0051ebab (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 0051eba1
    PUSH EBP                            ; 0051eba2
    CALL shape_design.c_fixupCramUV_FUN_0046e090 ; 0051eba3 | void shape_design.c_fixupCramUV_FUN_0046e090(int atlas_texture_index, float * u_coord, float * v_coord)
        ;   XREF to: 0046e090 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0051eba8
    FLD float ptr [0x00638529]          ; 0051ebab | float FLOAT_00638529
        ;   Label: LAB_0051ebab
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 0051ebc7 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH                                ; 0051ebcc
    CALL crt_math.c_round_FUN_005fe6b0  ; 0051ebce | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH                                ; 0051ebd3
    ...
    JNZ 0x0051eb75                      ; 0051ebf2 | LAB_0051eb75
        ;   XREF to: 0051eb75 (CONDITIONAL_JUMP)
    TEST EBP,EBP                        ; 0051ebf4
    JL 0x0051ec95                       ; 0051ebf6 | LAB_0051ec95
        ;   XREF to: 0051ec95 (CONDITIONAL_JUMP)
    CMP EBP,dword ptr [ESP + 0x54]      ; 0051ebfc
    JZ 0x0051ec50                       ; 0051ec00 | LAB_0051ec50
        ;   XREF to: 0051ec50 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x80],0x0      ; 0051ec02
    JZ 0x0051ec86                       ; 0051ec0a | LAB_0051ec86
        ;   XREF to: 0051ec86 (CONDITIONAL_JUMP)
    PUSH EBP                            ; 0051ec0c
    CALL shape_design.c_getAtlasMapIndex_FUN_0046e030 ; 0051ec0d | int shape_design.c_getAtlasMapIndex_FUN_0046e030(int texture_entry_index)
        ;   XREF to: 0046e030 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0051ec12
    PUSH EAX                            ; 0051ec15
    CALL shape_design.c_getTextureName_FUN_0046e060 ; 0051ec16 | char * shape_design.c_getTextureName_FUN_0046e060(int texture_index)
    ...
    MOV AL,byte ptr [ESI]               ; 0051ec26
        ;   Label: LAB_0051ec26
    MOV byte ptr [EDI],AL               ; 0051ec28 | DAT_02f31248
    CMP AL,0x0                          ; 0051ec2a
    JZ 0x0051ec3e                       ; 0051ec2c | LAB_0051ec3e
        ;   XREF to: 0051ec3e (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0051ec2e
    ADD ESI,0x2                         ; 0051ec31
    MOV byte ptr [EDI + 0x1],AL         ; 0051ec34 | DAT_02f31249
    ADD EDI,0x2                         ; 0051ec37
    CMP AL,0x0                          ; 0051ec3a
    JNZ 0x0051ec26                      ; 0051ec3c | LAB_0051ec26
        ;   XREF to: 0051ec26 (CONDITIONAL_JUMP)
    POP EDI                             ; 0051ec3e
        ;   Label: LAB_0051ec3e
    PUSH 0x2f31240                      ; 0051ec3f | SMRGLTextureBasic g_TempTextureDescriptor
    CALL engine_texture.cpp_ensureTextureLoaded_FUN_005dd800 ; 0051ec44 | SMRGLHeaderExtended * engine_texture.cpp_ensureTextureLoaded_FUN_005dd800(SMRGLTextureBasic * texture)
        ;   Label: LAB_0051ec44
    ...
    MOV EAX,ESP                         ; 0051ec50
        ;   Label: LAB_0051ec50
    PUSH EAX                            ; 0051ec52
    MOV EDX,dword ptr [0x006703ec]      ; 0051ec53 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH EDX                            ; 0051ec59 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_renderPremium_FUN_0048b1e0 ; 0051ec5a | void engine_drender.cpp_CDemonRenderer_renderPremium_FUN_0048b1e0(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * polygon_info)
        ;   XREF to: 0048b1e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0051ec5f
    JMP 0x0051eb26                      ; 0051ec62 | LAB_0051eb26
    ...
    PUSH EAX                            ; 0051ec76
    CALL shape_design.c_findTextureByFilename_FUN_0046dfc0 ; 0051ec77 | int shape_design.c_findTextureByFilename_FUN_0046dfc0(char * filename)
        ;   XREF to: 0046dfc0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0051ec7c
    MOV EBP,EAX                         ; 0051ec7f
    JMP 0x0051eb66                      ; 0051ec81 | LAB_0051eb66
    ...
    PUSH EAX                            ; 0051ec92
    JMP 0x0051ec44                      ; 0051ec93 | LAB_0051ec44
    ...
    NEG EAX                             ; 0051eca1
    PUSH EAX                            ; 0051eca3
    MOV EBX,dword ptr [0x006703ec]      ; 0051eca4 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH EBX                            ; 0051ecaa | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_setCurrentPolygonColor_FUN_0048c960 ; 0051ecab | void engine_drender.cpp_CDemonRenderer_setCurrentPolygonColor_FUN_0048c960(CDemonRenderer * this_ptr, int color)
        ;   XREF to: 0048c960 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0051ecb0
    MOV EAX,ESP                         ; 0051ecb3
    PUSH EAX                            ; 0051ecb5
    MOV ESI,dword ptr [0x006703ec]      ; 0051ecb6 | CDemonRenderer * g_CDemonRendererPtr
    PUSH ESI                            ; 0051ecbc | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_renderBasicTexturedVariant_FUN_0048a8a0 ; 0051ecbd | void engine_drender.cpp_CDemonRenderer_renderBasicTexturedVariant_FUN_0048a8a0(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * polygon_info)
        ;   XREF to: 0048a8a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0051ecc2
    JMP 0x0051eb26                      ; 0051ecc5 | LAB_0051eb26
        ;   XREF to: 0051eb26 (UNCONDITIONAL_JUMP)
