...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_meshlod.cpp_CLodMesh_renderWireframe_FUN_0051e770(CLodMesh * this_ptr)
;
; Parameters:
...
section .text
    ...
    JLE 0x0051e81f                      ; 0051e786 | LAB_0051e81f
    ...
    JNZ 0x0051e7fb                      ; 0051e7a4 | LAB_0051e7fb
    ...
    JL 0x0051e7b6                       ; 0051e7b2 | LAB_0051e7b6
    ...
    MOV EAX,[0x006703ec]                ; 0051e7c3 | CDemonRenderer * g_CDemonRendererPtr
    SUB ESP,0x30                        ; 0051e7c8
    MOV ECX,0xc                         ; 0051e7cb
    MOV EAX,dword ptr [EAX]             ; 0051e7d0 | CDemonRenderer g_CDemonRendererInstance
    ...
    CALL engine_3d.c_clipAndDrawLine2D_FUN_00407d70 ; 0051e7ee | void engine_3d.c_clipAndDrawLine2D_FUN_00407d70(SRenderVertex * vertex1, SRenderVertex * vertex2)
        ;   XREF to: 00407d70 (UNCONDITIONAL_CALL)
    ADD ESP,0x60                        ; 0051e7f3
    CMP EBX,0x3                         ; 0051e7f6
    JL 0x0051e7ac                       ; 0051e7f9 | LAB_0051e7ac
    ...
    JL 0x0051e78f                       ; 0051e819 | LAB_0051e78f
