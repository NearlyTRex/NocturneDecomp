...
section .text
    ...
    PUSH 0x43f                          ; 0051662f
    PUSH 0x63753d                       ; 00516634 | = "..\\shape\\meshlod.cpp" | s_shape_meshlod_cpp_0063753d = ..\shape\meshlod.cpp
    PUSH 0x4004                         ; 00516639
    MOV ECX,dword ptr [EBX + 0x54]      ; 0051663e
    XOR EDX,EDX                         ; 00516641
    PUSH ECX                            ; 00516643
    MOV dword ptr [ESP + 0x64],EDX      ; 00516644
    CALL shape_memdbg.cpp_debugRealloc_FUN_0050f540 ; 00516648 | void * shape_memdbg.cpp_debugRealloc_FUN_0050f540(void * ptr, int new_size, char * filename, int line_number)
        ;   XREF to: 0050f540 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0051664d
    MOV dword ptr [EBX + 0x54],EAX      ; 00516650
    TEST EAX,EAX                        ; 00516653
    JZ 0x0051690c                       ; 00516655 | LAB_0051690c
        ;   XREF to: 0051690c (CONDITIONAL_JUMP)
    PUSH 0x637576                       ; 0051665b | = "Creating quick-grid" | s_Creating_quick_grid_00637576 = Creating quick-grid
        ;   Label: LAB_0051665b
    MOV EDX,dword ptr [0x00678a60]      ; 00516660 | CEditorTools * g_CEditorToolsPtr
    PUSH EDX                            ; 00516666 | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_showCenteredProgressDialog_FUN_004a0430 ; 00516667 | void shape_edittool.cpp_CEditorTools_showCenteredProgressDialog_FUN_004a0430(CEditorTools * this_ptr, char * message_text)
    ...
    FLD double ptr [0x006375fd]         ; 0051667f | double DOUBLE_006375fd
    FILD dword ptr [ESP + 0x64]         ; 00516685
    FMUL ST1                            ; 00516689
    XOR EDI,EDI                         ; 0051668b
    FADD double ptr [0x00637605]        ; 0051668d | double DOUBLE_00637605
    MOV dword ptr [ESP + 0x4],EDI       ; 00516693
    FST float ptr [ESP + 0x30]          ; 00516697
    FADDP                               ; 0051669b
    MOV EAX,dword ptr [ESP + 0x48]      ; 0051669d
    FADD double ptr [0x0063760d]        ; 005166a1 | double DOUBLE_0063760d
    ...
    FLD double ptr [0x006375fd]         ; 005166b7 | double DOUBLE_006375fd
    FILD dword ptr [ESP + 0x64]         ; 005166bd
    FMUL ST1                            ; 005166c1
    XOR EAX,EAX                         ; 005166c3
    FADD double ptr [0x00637605]        ; 005166c5 | double DOUBLE_00637605
    MOV dword ptr [ESP + 0x8],EAX       ; 005166cb
    FST float ptr [ESP + 0x34]          ; 005166cf
    FADDP                               ; 005166d3
    MOV EAX,dword ptr [ESP + 0x4c]      ; 005166d5
    FADD double ptr [0x0063760d]        ; 005166d9 | double DOUBLE_0063760d
    ...
    FLD double ptr [0x006375fd]         ; 005166ef | double DOUBLE_006375fd
    FILD dword ptr [ESP + 0x64]         ; 005166f5
    FMUL ST1                            ; 005166f9
    FADD double ptr [0x00637605]        ; 005166fb | double DOUBLE_00637605
    FST float ptr [ESP + 0x38]          ; 00516701
    FADDP                               ; 00516705
    FADD double ptr [0x0063760d]        ; 00516707 | double DOUBLE_0063760d
    ...
    JLE 0x00516862                      ; 00516727 | LAB_00516862
    ...
    JZ 0x00516774                       ; 0051675e | LAB_00516774
    ...
    JNZ 0x00516933                      ; 0051677e | LAB_00516933
    ...
    FNSTSW AX                           ; 005167b6
    SAHF                                ; 005167b8
    JNC 0x005167c3                      ; 005167b9 | LAB_005167c3
    ...
    FNSTSW AX                           ; 005167cb
    SAHF                                ; 005167cd
    JBE 0x005167d8                      ; 005167ce | LAB_005167d8
    ...
    FNSTSW AX                           ; 005167e0
    SAHF                                ; 005167e2
    JNC 0x005167ed                      ; 005167e3 | LAB_005167ed
    ...
    FNSTSW AX                           ; 005167f5
    SAHF                                ; 005167f7
    JBE 0x00516802                      ; 005167f8 | LAB_00516802
    ...
    FNSTSW AX                           ; 0051680a
    SAHF                                ; 0051680c
    JNC 0x00516817                      ; 0051680d | LAB_00516817
    ...
    FNSTSW AX                           ; 0051681f
    SAHF                                ; 00516821
    JBE 0x0051682c                      ; 00516822 | LAB_0051682c
    ...
    JL 0x00516743                       ; 0051685c | LAB_00516743
    ...
    JL 0x005166e7                       ; 00516879 | LAB_005166e7
    ...
    JL 0x005166af                       ; 00516896 | LAB_005166af
    ...
    MOV ECX,dword ptr [0x00678a60]      ; 005168b0 | CEditorTools * g_CEditorToolsPtr
    FSTP float ptr [ESP]                ; 005168b6
    PUSH ECX                            ; 005168b9 | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_updatePercentage_FUN_004a0530 ; 005168ba | void shape_edittool.cpp_CEditorTools_updatePercentage_FUN_004a0530(CEditorTools * this_ptr, float progress_min, float progress_max)
    ...
    MOV EDX,dword ptr [0x00678a60]      ; 005168f6 | CEditorTools * g_CEditorToolsPtr
    PUSH EDX                            ; 005168fc | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_restoreWindowAndCleanup_FUN_004a0dd0 ; 005168fd | void shape_edittool.cpp_CEditorTools_restoreWindowAndCleanup_FUN_004a0dd0(CEditorTools * this_ptr)
    ...
    POP EBX                             ; 0051690a
    RET                                 ; 0051690b
    MOV EDI,0x637552                    ; 0051690c | = "..\\shape\\meshlod.cpp" | s_shape_meshlod_cpp_00637552 = ..\shape\meshlod.cpp
        ;   Label: LAB_0051690c
    MOV EAX,0x440                       ; 00516911
    PUSH 0x637567                       ; 00516916 | = "Out of memory!" | s_Out_of_memory_00637567 = Out of memory!
    MOV dword ptr [0x02f0ca48],EDI      ; 0051691b | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 00516921 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00516926 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0051692b
    JMP 0x0051665b                      ; 0051692e | LAB_0051665b
    ...
    JMP 0x00516784                      ; 0051694b | LAB_00516784
    ...
    FNSTSW AX                           ; 00516958
    SAHF                                ; 0051695a
    JC 0x00516848                       ; 0051695b | LAB_00516848
        ;   XREF to: 00516848 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x1c]          ; 00516961
    FCOMP float ptr [ESP + 0x10]        ; 00516965
    FNSTSW AX                           ; 00516969
    SAHF                                ; 0051696b
    JA 0x00516848                       ; 0051696c | LAB_00516848
        ;   XREF to: 00516848 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x28]          ; 00516972
    FCOMP float ptr [ESP + 0x34]        ; 00516976
    FNSTSW AX                           ; 0051697a
    SAHF                                ; 0051697c
    JC 0x00516848                       ; 0051697d | LAB_00516848
        ;   XREF to: 00516848 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x20]          ; 00516983
    FCOMP float ptr [ESP + 0x14]        ; 00516987
    FNSTSW AX                           ; 0051698b
    SAHF                                ; 0051698d
    JA 0x00516848                       ; 0051698e | LAB_00516848
        ;   XREF to: 00516848 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x2c]          ; 00516994
    FCOMP float ptr [ESP + 0x38]        ; 00516998
    FNSTSW AX                           ; 0051699c
    SAHF                                ; 0051699e
    JC 0x00516848                       ; 0051699f | LAB_00516848
        ;   XREF to: 00516848 (CONDITIONAL_JUMP)
    PUSH 0x464                          ; 005169a5
    PUSH 0x63758a                       ; 005169aa | = "..\\shape\\meshlod.cpp" | s_shape_meshlod_cpp_0063758a = ..\shape\meshlod.cpp
    MOV ESI,dword ptr [ESP + 0x64]      ; 005169af
    PUSH ESI                            ; 005169b3
    MOV EAX,dword ptr [EBX + 0x58]      ; 005169b4
    PUSH EAX                            ; 005169b7
    CALL shape_memdbg.cpp_debugRealloc_FUN_0050f540 ; 005169b8 | void * shape_memdbg.cpp_debugRealloc_FUN_0050f540(void * ptr, int new_size, char * filename, int line_number)
        ;   XREF to: 0050f540 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 005169bd
    MOV dword ptr [EBX + 0x58],EAX      ; 005169c0
    TEST EAX,EAX                        ; 005169c3
    JNZ 0x005169ea                      ; 005169c5 | LAB_005169ea
        ;   XREF to: 005169ea (CONDITIONAL_JUMP)
    MOV ECX,0x63759f                    ; 005169c7 | = "..\\shape\\meshlod.cpp" | s_shape_meshlod_cpp_0063759f = ..\shape\meshlod.cpp
    MOV ESI,0x465                       ; 005169cc
    PUSH 0x6375b4                       ; 005169d1 | = "Out of memory creating gridList" | s_Out_of_memory_creating_g_006375b4 = Out of memory creating gridList
    MOV dword ptr [0x02f0ca48],ECX      ; 005169d6 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 005169dc | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005169e2 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ...
    JMP 0x00516848                      ; 00516a10 | LAB_00516848
        ;   XREF to: 00516848 (UNCONDITIONAL_JUMP)
    MOV ECX,0x6375d4                    ; 00516a15 | = "..\\shape\\meshlod.cpp" | s_shape_meshlod_cpp_006375d4 = ..\shape\meshlod.cpp
        ;   Label: LAB_00516a15
    MOV ESI,0x46d                       ; 00516a1a
    PUSH 0x6375e9                       ; 00516a1f | = "Bug creating grid!" | s_Bug_creating_grid_006375e9 = Bug creating grid!
    MOV dword ptr [0x02f0ca48],ECX      ; 00516a24 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 00516a2a | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00516a30 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00516a35
    JMP 0x005168e9                      ; 00516a38 | LAB_005168e9
