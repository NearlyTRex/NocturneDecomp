// Name: shape_meshlod.cpp_FUN_00518490
// Address: 00518490
// Address Range: [[00518490, 00518734]]
// Convention: unknown
// Signature: undefined shape_meshlod.cpp_FUN_00518490()
// Cross-references:
//   shape_meshlod.cpp_NeighboringFacesEdgesCheck_FUN_00518910 (00518910) at 00518958 [UNCONDITIONAL_CALL]
// Globals:
...
/* Signature: undefined1 shape_meshlod.cpp_FUN_00518490(undefined4 param_1, undefined4 param_2,
   undefined4 param_3) */

int shape_meshlod_cpp_FUN_00518490(void)

{
  ...
  iVar1 = shape_meshlod_cpp_MemoryAdjacentThing_FUN_00515ec0();
  if (iVar1 < 0) {
    return -1;
  }
  iVar1 = *(int *)(in_stack_00000004 + 0x48) + iVar1 * 0xf0;
  if (*(int *)(iVar1 + 0x14) != 0) {
    return -1;
  }
  if (*(int *)(iVar1 + 0x24) < 2) {
  ...
  for (local_18 = 0;
      local_18 < *(int *)(*(int *)(in_stack_00000004 + 4) + in_stack_00000008 * 0x4c4 + 0x3f8);
      local_18 = local_18 + 1) {
    iVar1 = shape_meshlod_cpp_FUN_0051a980();
    if ((iVar1 != in_stack_00000014) &&
       (iVar1 = shape_meshlod_cpp_MemoryAdjacentThing_FUN_00515ec0(), -1 < iVar1)) {
      iVar5 = 0;
      while( true ) {
        if (*(int *)(*(int *)(in_stack_00000004 + 0x48) + iVar1 * 0xf0 + 0x24) <= iVar5) {
          return -1;
        }
        iVar2 = shape_meshlod_cpp_FUN_00515e90();
        if (-1 < iVar2) break;
        iVar5 = iVar5 + 1;
      }
    }
  }
  iVar1 = shape_meshlod_cpp_FUN_00518740();
  if (((iVar1 != 0) && (iVar1 = shape_meshlod_cpp_FUN_00518740(), iVar1 != 0)) &&
     (1 < *(int *)(*(int *)(in_stack_00000004 + 0x48) + 0x24 + unaff_ESI * 0xf0))) {
    return -1;
  }
  if (DAT_02f33330 != 0) {
    return unaff_ESI;
  ...
  if (0 < *(int *)(local_18 + 0x24)) {
    iVar5 = local_18;
    do {
      iVar6 = *(int *)(iVar5 + 0x28) * 0x8c + *(int *)(in_stack_00000004 + 0xc);
      iVar3 = 0;
      ...
      iVar3 = iVar3 + 1;
      iVar2 = *(int *)(in_stack_00000004 + 0x48) + *(int *)(iVar6 + 0x34 + iVar2 * 4) * 0xf0;
      if (2 < iVar3) {
        iVar3 = 0;
      }
      iVar4 = *(int *)(iVar6 + 0x34 + iVar3 * 4) * 0xf0 + *(int *)(in_stack_00000004 + 0x48);
      if ((*(int *)(iVar2 + 0x18) != 0) && (*(int *)(iVar4 + 0x18) != 0)) {
        return -1;
      }
      if (1 < *(int *)(iVar2 + 0x18)) {
        return -1;
...
LAB_0051865b:
      iVar1 = iVar1 + 1;
      iVar5 = iVar5 + 4;
    } while (iVar1 < *(int *)(local_18 + 0x24));
  }
  iVar1 = shape_meshlod_cpp_FUN_00516420();
  ...
  else if (((iVar1 < 3) || (iVar5 < 3)) && ((iVar1 != 1 || (iVar5 == 2)))) {
    if (iVar5 != 1) {
      return unaff_ESI;
    }
    if (iVar1 == 2) {
...
// Assembly code:
// 00518490: PUSH EBX
//   Label: shape_meshlod.cpp_FUN_00518490
// 00518491: PUSH ESI
// 00518492: PUSH EDI
// 00518493: PUSH EBP
...
// 005184aa: PUSH EBP
// 005184ab: PUSH EDI
// 005184ac: CALL shape_meshlod.cpp_MemoryAdjacentThing_FUN_00515ec0
...
// 0051852c: PUSH EAX
// 0051852d: PUSH EDI
// 0051852e: CALL shape_meshlod.cpp_MemoryAdjacentThing_FUN_00515ec0
//   XREF to: 00515ec0 (UNCONDITIONAL_CALL)
