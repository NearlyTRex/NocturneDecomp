...
section .text
    ...
    PUSH EBX                            ; 00515865
    CALL shape_meshlod.cpp_CLodMesh_init_FUN_00515880 ; 00515866 | void shape_meshlod.cpp_CLodMesh_init_FUN_00515880(CLodMesh * this_ptr)
        ;   XREF to: 00515880 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0051586b
    MOV EDX,dword ptr [ESP + 0xc]       ; 0051586e
    PUSH EDX                            ; 00515872
    PUSH EBX                            ; 00515873
    CALL shape_meshlod.cpp_CLodMesh_copyFrom_FUN_0051a8c0 ; 00515874 | CLodMesh * shape_meshlod.cpp_CLodMesh_copyFrom_FUN_0051a8c0(CLodMesh * this_ptr, CLodMesh * source_mesh)
