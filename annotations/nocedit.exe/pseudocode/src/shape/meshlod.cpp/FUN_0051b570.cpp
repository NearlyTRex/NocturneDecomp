// Name: shape_meshlod.cpp_FUN_0051b570
// Address: 0051b570
// Address Range: [[0051b570, 0051b6ee]]
// Convention: unknown
// Signature: undefined shape_meshlod.cpp_FUN_0051b570()
// Cross-references:
//   shape_meshlod.cpp_FUN_0051b330 (0051b330) at 0051b3be [UNCONDITIONAL_CALL]
//   shape_meshlod.cpp_LodMesh_getLOD_FUN_0051b920 (0051b920) at 0051ba4b [UNCONDITIONAL_CALL]
// Function calls:
//   crt_unknown.c_FUN_006020c2

#include "nocturne.h"

/* Signature: undefined1 shape_meshlod.cpp_FUN_0051b570(undefined4 param_1) */

void shape_meshlod_cpp_FUN_0051b570(void)

{
  ...
  if (0 < *(int *)(in_stack_00000004 + 8)) {
    iVar5 = 0;
    do {
      iVar1 = *(int *)(in_stack_00000004 + 0xc) + iVar5;
      if (*(int *)(iVar1 + 0x40) == 0) {
        *(int *)(iVar1 + 0x40) = local_1c;
        local_1c = local_1c + 1;
      }
      else {
  ...
  if (0 < *(int *)(in_stack_00000004 + 8)) {
    ...
    local_24 = 0;
    do {
      puVar2 = (undefined4 *)(local_24 + *(int *)(in_stack_00000004 + 0xc));
      if (-1 < (int)puVar2[0x10]) {
        if (local_20 < local_14) {
          puVar4 = (undefined4 *)(*(int *)(in_stack_00000004 + 0xc) + local_18);
        ...
        local_20 = local_20 + 1;
        iVar3 = *(int *)(in_stack_00000004 + 0xc) + local_18;
        local_18 = local_18 + 0x8c;
        *(undefined4 *)(iVar3 + 0x40) = 0;
      }
      local_24 = local_24 + 0x8c;
      local_14 = local_14 + 1;
    } while (local_14 < *(int *)(in_stack_00000004 + 8));
  }
  *(int *)(in_stack_00000004 + 8) = local_1c;
  return;
}
...
// Assembly code:
// 0051b570: PUSH EBX
//   Label: shape_meshlod.cpp_FUN_0051b570
// 0051b571: PUSH ESI
// 0051b572: PUSH EDI
// 0051b573: PUSH EBP
...
// 0051b6c1: CALL crt_unknown.c_FUN_006020c2
