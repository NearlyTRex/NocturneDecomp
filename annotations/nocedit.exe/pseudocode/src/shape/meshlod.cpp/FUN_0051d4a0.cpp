// Name: shape_meshlod.cpp_FUN_0051d4a0
// Address: 0051d4a0
// Address Range: [[0051d4a0, 0051d51e]]
// Convention: unknown
// Signature: undefined shape_meshlod.cpp_FUN_0051d4a0()
// Cross-references:
//   shape_meshlod.cpp_FUN_00516ba0 (00516ba0) at 00516ce4 [UNCONDITIONAL_CALL]
// Globals:
...
void shape_meshlod_cpp_FUN_0051d4a0(void)

{
  ...
  bVar4 = 0;
  iVar2 = *(int *)(in_stack_00000004 + 0x4c) + 1;
  *(int *)(in_stack_00000004 + 0x4c) = iVar2;
  pvVar1 = shape_memdbg_cpp_debugRealloc_FUN_0050f540
                     (*(void **)(in_stack_00000004 + 0x50),iVar2 * 0xf0,"..\\shape\\meshlod.cpp"
                      ,0x14a4);
  *(void **)(in_stack_00000004 + 0x50) = pvVar1;
  if (pvVar1 == (void *)0x0) {
  ...
  puVar3 = (undefined4 *)
           (*(int *)(in_stack_00000004 + 0x50) + (*(int *)(in_stack_00000004 + 0x4c) + -1) * 0xf0);
...
// Assembly code:
// 0051d4a0: PUSH EBX
//   Label: shape_meshlod.cpp_FUN_0051d4a0
// 0051d4a1: PUSH ESI
// 0051d4a2: PUSH EDI
// 0051d4a3: PUSH EBP
