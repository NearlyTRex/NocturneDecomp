...
section .text
    ...
    PUSH 0x661390                       ; 0051f0c0 | WatcomTypeInfo g_LodFaceTypeInfo
        ;   Label: shape_meshlod.cpp_freeLodFaces_FUN_0051f0c0
    PUSH 0xc8                           ; 0051f0c5
    MOV EDX,dword ptr [ESP + 0xc]       ; 0051f0ca
    PUSH EDX                            ; 0051f0ce
    CALL crt_memory.c_freeTypeArray_FUN_005feee9 ; 0051f0cf | int crt_memory.c_freeTypeArray_FUN_005feee9(void * * obj_array, int obj_count, WatcomTypeInfo * type_info)
