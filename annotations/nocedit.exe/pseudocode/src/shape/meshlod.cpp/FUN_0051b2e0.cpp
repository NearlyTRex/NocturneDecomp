// Name: shape_meshlod.cpp_FUN_0051b2e0
// Address: 0051b2e0
...

{
  ...
  pfVar1 = (float *)(in_stack_00000004 + 0x70);
  fVar2 = in_stack_0000000c[1];
  fVar3 = *pfVar1;
  fVar4 = in_stack_0000000c[2];
  fVar5 = *pfVar1;
  *in_stack_00000008 = *in_stack_0000000c / *pfVar1 - *(float *)(in_stack_00000004 + 100);
  in_stack_00000008[1] = fVar2 / fVar3 - *(float *)(in_stack_00000004 + 0x68);
  in_stack_00000008[2] = fVar4 / fVar5 - *(float *)(in_stack_00000004 + 0x6c);
...
// Assembly code:
// 0051b2e0: PUSH EBX
//   Label: shape_meshlod.cpp_FUN_0051b2e0
