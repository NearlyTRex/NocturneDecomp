...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl shape_meshlod_cpp_CLodMesh_transformVerticesForPreview_FUN_0051e6b0(CLodMesh *this_ptr)
;
; Parameters:
...
section .text
    ...
    JLE 0x0051e767                      ; 0051e6be
        ;   XREF to: 0051e767 (CONDITIONAL_JUMP)  ; LAB_0051e767
    PUSH EDI                            ; 0051e6c4
    PUSH ESI                            ; 0051e6c5
    PUSH EBX                            ; 0051e6c6
    ...
    CALL shape_meshlod.cpp_CLodMesh_worldToNormalizedSpace_FUN_0051b2e0 ; 0051e6e3
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 0051e6ef | g_CDemonRendererPtr2
    FLD float ptr [EAX]                 ; 0051e6f5
    FMUL float ptr [0x0066136c]         ; 0051e6f7 | FLOAT_0066136c
    FISTP dword ptr [EBX]               ; 0051e6fd
    FLD float ptr [EAX + 0x4]           ; 0051e6ff
    FMUL float ptr [0x0066136c]         ; 0051e702 | FLOAT_0066136c
    FISTP dword ptr [EBX + 0x4]         ; 0051e708
    FLD float ptr [EAX + 0x8]           ; 0051e70b
    FMUL float ptr [0x0066136c]         ; 0051e70e | FLOAT_0066136c
    FISTP dword ptr [EBX + 0x8]         ; 0051e714
    LEA EAX,[ESP + 0xc]                 ; 0051e717
    PUSH EAX                            ; 0051e71b
    MOV EAX,dword ptr [EDX]             ; 0051e71c | g_CDemonRendererInstance
    ADD EAX,ESI                         ; 0051e71e
    PUSH EAX                            ; 0051e720
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 0051e721
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    MOV EAX,[0x006703ec]                ; 0051e726 | g_CDemonRendererPtr2
    MOV EDX,dword ptr [EAX]             ; 0051e72b | g_CDemonRendererInstance
    MOV dword ptr [EDX + ESI*0x1 + 0x20],0xffff ; 0051e72d
    MOV EDX,dword ptr [EAX]             ; 0051e735 | g_CDemonRendererInstance
    MOV dword ptr [EDX + ESI*0x1 + 0x24],0xffff ; 0051e737
    MOV EAX,dword ptr [EAX]             ; 0051e73f | g_CDemonRendererInstance
    ...
    JL 0x0051e6cb                       ; 0051e75e
        ;   XREF to: 0051e6cb (CONDITIONAL_JUMP)  ; LAB_0051e6cb
    POP EBX                             ; 0051e764
    POP ESI                             ; 0051e765
    POP EDI                             ; 0051e766
