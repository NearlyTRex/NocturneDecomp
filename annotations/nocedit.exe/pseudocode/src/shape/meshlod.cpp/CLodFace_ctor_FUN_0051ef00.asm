...
section .text
    ...
    PUSH 0x6598c0                       ; 0051ef04 | WatcomTypeInfo g_CVectorTypeInfo
    PUSH 0x3                            ; 0051ef09
    ADD EAX,0x54                        ; 0051ef0b
    PUSH EAX                            ; 0051ef0e
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 0051ef0f | void * crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
