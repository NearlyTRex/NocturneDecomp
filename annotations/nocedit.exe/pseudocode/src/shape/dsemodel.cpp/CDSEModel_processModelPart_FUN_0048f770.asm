...
section .text
    ...
    MOV EAX,dword ptr [EBP + -0x8]      ; 0048f7cf
        ;   Label: LAB_0048f7cf
    CMP EAX,dword ptr [0x016e990c]      ; 0048f7d2 | int g_PolygonCount
    JGE 0x0048f823                      ; 0048f7d8 | LAB_0048f823
    ...
    JZ 0x0048f7ee                       ; 0048f7ea | LAB_0048f7ee
        ;   XREF to: 0048f7ee (CONDITIONAL_JUMP)
    JMP 0x0048f821                      ; 0048f7ec | LAB_0048f821
    ...
    LEA ESI,[ESI + 0x16e9910]           ; 0048f810 | SShapeEditorPolygon[20000] g_ModelPolygonData
    MOVSD.REP ES:EDI,ESI                ; 0048f816 | SShapeEditorPolygon[20000] g_ModelPolygonData
    MOV EAX,dword ptr [EBP + 0x14]      ; 0048f818
    INC dword ptr [EAX + 0x186a4]       ; 0048f81b
    JMP 0x0048f7c9                      ; 0048f821 | LAB_0048f7c9
        ;   Label: LAB_0048f821
        ;   XREF to: 0048f7c9 (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x8],0x0      ; 0048f823
        ;   Label: LAB_0048f823
    JMP 0x0048f832                      ; 0048f82a | LAB_0048f832
    ...
    JGE 0x0048f890                      ; 0048f83e | LAB_0048f890
        ;   XREF to: 0048f890 (CONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x4],0x0      ; 0048f840
    JMP 0x0048f84f                      ; 0048f847 | LAB_0048f84f
    ...
    JGE 0x0048f88e                      ; 0048f864 | LAB_0048f88e
    ...
    PUSH EAX                            ; 0048f883
    CALL shape_dsemodel.cpp_CDSEModel_logVertex_FUN_0048f660 ; 0048f884 | void shape_dsemodel.cpp_CDSEModel_logVertex_FUN_0048f660(CDSEModel * this_ptr, int vertex_id)
        ;   XREF to: 0048f660 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0048f889
    JMP 0x0048f849                      ; 0048f88c | LAB_0048f849
        ;   XREF to: 0048f849 (UNCONDITIONAL_JUMP)
    JMP 0x0048f82c                      ; 0048f88e | LAB_0048f82c
        ;   Label: LAB_0048f88e
        ;   XREF to: 0048f82c (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x8],0x0      ; 0048f890
        ;   Label: LAB_0048f890
    JMP 0x0048f89f                      ; 0048f897 | LAB_0048f89f
    ...
    JGE 0x0048f915                      ; 0048f8ab | LAB_0048f915
        ;   XREF to: 0048f915 (CONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x4],0x0      ; 0048f8ad
    JMP 0x0048f8bc                      ; 0048f8b4 | LAB_0048f8bc
    ...
    JGE 0x0048f913                      ; 0048f8d1 | LAB_0048f913
    ...
    PUSH EAX                            ; 0048f8ee
    CALL shape_dsemodel.cpp_CDSEModel_convertVertex_FUN_0048f6f0 ; 0048f8ef | int shape_dsemodel.cpp_CDSEModel_convertVertex_FUN_0048f6f0(CDSEModel * this_ptr, int vertex_id)
    ...
    JMP 0x0048f8b6                      ; 0048f911 | LAB_0048f8b6
        ;   XREF to: 0048f8b6 (UNCONDITIONAL_JUMP)
    JMP 0x0048f899                      ; 0048f913 | LAB_0048f899
        ;   Label: LAB_0048f913
        ;   XREF to: 0048f899 (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x8],0x0      ; 0048f915
        ;   Label: LAB_0048f915
    JMP 0x0048f924                      ; 0048f91c | LAB_0048f924
    ...
    JGE 0x0048f952                      ; 0048f92c | LAB_0048f952
        ;   XREF to: 0048f952 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + -0x8]      ; 0048f92e
    SHL EAX,0x2                         ; 0048f931
    IMUL ESI,dword ptr [EAX + 0x2c9b328],0x14 ; 0048f934 | int[5000] g_VertexIdRegistry
    IMUL EAX,dword ptr [EBP + -0x8],0x14 ; 0048f93b
    ADD EAX,dword ptr [EBP + 0x14]      ; 0048f93f
    LEA EDI,[EAX + 0x4]                 ; 0048f942
    LEA ESI,[ESI + 0x162640c]           ; 0048f945 | SVertexData[20000] g_LoadedVertices
    MOVSD ES:EDI,ESI                    ; 0048f94b | SVertexData[20000] g_LoadedVertices
    ...
    JMP 0x0048f91e                      ; 0048f950 | LAB_0048f91e
