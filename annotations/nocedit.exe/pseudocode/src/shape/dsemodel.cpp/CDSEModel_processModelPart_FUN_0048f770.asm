...
section .text
    ...
    PUSH EDI                            ; 0048f7a6
    MOV AL,byte ptr [ESI]               ; 0048f7a7 | g_ModelPartNames | g_ModelPartNames[0].name[2]
        ;   Label: LAB_0048f7a7
    MOV byte ptr [EDI],AL               ; 0048f7a9
    CMP AL,0x0                          ; 0048f7ab
    JZ 0x0048f7bf                       ; 0048f7ad
        ;   XREF to: 0048f7bf (CONDITIONAL_JUMP)  ; LAB_0048f7bf
    MOV AL,byte ptr [ESI + 0x1]         ; 0048f7af | g_ModelPartNames[0].name[1] | g_ModelPartNames[0].name[3]
    ...
    MOV EAX,dword ptr [EAX + 0x16e9a88] ; 0048f7e1 | g_ModelPolygonData[0].part_assignment
    ...
    MOVSD.REP ES:EDI,ESI                ; 0048f816 | g_ModelPolygonData | g_ModelPolygonData[0].texture_name[0]
    ...
    JMP 0x00604def                      ; 0048f945
        ;   XREF to: 00604def (UNCONDITIONAL_JUMP)  ; LAB_00604def
    MOVSD ES:EDI,ESI                    ; 0048f94f | g_LoadedVertices[0].v
        ;   Label: LAB_0048f94f
    ...
    POP EBX                             ; 0048f957
    RET                                 ; 0048f958
    LEA ESI,[ESI + 0x162640c]           ; 00604def
        ;   Label: LAB_00604def
    MOV ECX,dword ptr [ESI]             ; 00604df5
    MOV dword ptr [EDI],ECX             ; 00604df7
    MOV ECX,dword ptr [ESI + 0x4]       ; 00604df9
    MOV dword ptr [EDI + 0x4],ECX       ; 00604dfc
    MOV ECX,dword ptr [ESI + 0x8]       ; 00604dff
    MOV dword ptr [EDI + 0x8],ECX       ; 00604e02
    MOV ECX,dword ptr [ESI + 0xc]       ; 00604e05
    MOV dword ptr [EDI + 0xc],ECX       ; 00604e08
    ADD ESI,0x10                        ; 00604e0b
    ADD EDI,0x10                        ; 00604e0e
    JMP 0x0048f94f                      ; 00604e11
        ;   XREF to: 0048f94f (UNCONDITIONAL_JUMP)  ; LAB_0048f94f
