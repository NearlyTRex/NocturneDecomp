...
section .text
    ...
    JMP 0x0048f70b                      ; 0048f703 | LAB_0048f70b
    ...
    JGE 0x0048f730                      ; 0048f713 | LAB_0048f730
        ;   XREF to: 0048f730 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + -0x4]      ; 0048f715
    SHL EAX,0x2                         ; 0048f718
    MOV EAX,dword ptr [EAX + 0x2c9b328] ; 0048f71b | int[5000] g_VertexIdRegistry
    CMP EAX,dword ptr [EBP + 0x18]      ; 0048f721
    JNZ 0x0048f72e                      ; 0048f724 | LAB_0048f72e
        ;   XREF to: 0048f72e (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + -0x4]      ; 0048f726
    MOV dword ptr [EBP + -0x8],EAX      ; 0048f729
    JMP 0x0048f759                      ; 0048f72c | LAB_0048f759
        ;   XREF to: 0048f759 (UNCONDITIONAL_JUMP)
    JMP 0x0048f705                      ; 0048f72e | LAB_0048f705
        ;   Label: LAB_0048f72e
        ;   XREF to: 0048f705 (UNCONDITIONAL_JUMP)
    MOV dword ptr [0x02f0ca48],0x6224b9 ; 0048f730 | char * g_CurrentFilename | = "..\\shape\\dsemodel.cpp" | s_shape_dsemodel_cpp_006224b9 = ..\shape\dsemodel.cpp
        ;   Label: LAB_0048f730
    MOV dword ptr [0x02f0ca4c],0x5a     ; 0048f73a | int g_CurrentLineNumber
    MOV EAX,0x6224cf                    ; 0048f744 | = "CDSEModel::convertVertex - Vertex not..." | s_CDSEModel_convertVertex__006224cf = CDSEModel::convertVertex - Vertex not found
    PUSH EAX                            ; 0048f749 | = "CDSEModel::convertVertex - Vertex not..." | s_CDSEModel_convertVertex__006224cf = CDSEModel::convertVertex - Vertex not found
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0048f74a | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
