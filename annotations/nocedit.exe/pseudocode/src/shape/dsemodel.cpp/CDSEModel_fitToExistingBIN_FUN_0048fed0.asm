...
;                               FUNCTION
; *****************************************************************************
; __cdecl int shape_dsemodel.cpp_CDSEModel_fitToExistingBIN_FUN_0048fed0(CDSEModel * this_ptr, char * filename)
;
; Parameters:
...
section .text
    ...
    MOV EAX,0x62250a                    ; 0048fedc | = "rb" | s_rb_0062250a = rb
    PUSH EAX                            ; 0048fee1 | = "rb" | s_rb_0062250a = rb
    MOV EAX,dword ptr [EBP + 0x18]      ; 0048fee2
    PUSH EAX                            ; 0048fee5
    MOV EAX,0x62250d                    ; 0048fee6 | = "models" | s_models_0062250d = models
    PUSH EAX                            ; 0048feeb | = "models" | s_models_0062250d = models
    CALL engine_dosio.c_getFile_FUN_00481a50 ; 0048feec | FILE * engine_dosio.c_getFile_FUN_00481a50(char * directory, char * filename, char * mode)
        ;   XREF to: 00481a50 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0048fef1
    MOV dword ptr [EBP + -0x14],EAX     ; 0048fef4
    CMP dword ptr [EBP + -0x14],0x0     ; 0048fef7
    JNZ 0x0048ff09                      ; 0048fefb | LAB_0048ff09
        ;   XREF to: 0048ff09 (CONDITIONAL_JUMP)
    MOV dword ptr [EBP + -0x18],0x0     ; 0048fefd
    JMP 0x0049000d                      ; 0048ff04 | LAB_0049000d
        ;   XREF to: 0049000d (UNCONDITIONAL_JUMP)
    PUSH 0x180                          ; 0048ff09
        ;   Label: LAB_0048ff09
    MOV EAX,0x622514                    ; 0048ff0e | = "..\\shape\\dsemodel.cpp" | s_shape_dsemodel_cpp_00622514 = ..\shape\dsemodel.cpp
    PUSH EAX                            ; 0048ff13 | = "..\\shape\\dsemodel.cpp" | s_shape_dsemodel_cpp_00622514 = ..\shape\dsemodel.cpp
    MOV EAX,dword ptr [EBP + -0x14]     ; 0048ff14
    PUSH EAX                            ; 0048ff17
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 0048ff18 | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
        ;   XREF to: 0050f9b0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0048ff1d
    MOV EAX,dword ptr [EBP + 0x18]      ; 0048ff20
    PUSH EAX                            ; 0048ff23
    CALL engine_model.c_loadModelFile_FUN_00527ec0 ; 0048ff24 | SMRGLHeaderExtended * engine_model.c_loadModelFile_FUN_00527ec0(char * filename)
    ...
    CALL engine_model.c_getMRGLBounds_FUN_00528140 ; 0048ff39 | void engine_model.c_getMRGLBounds_FUN_00528140(SMRGLHeaderExtended * header, SMRGLModelBounds * output)
    ...
    FMUL double ptr [0x0062252a]        ; 0048ff70 | double g_ModelScalingNormalizationFactor
    ...
    FMUL double ptr [0x0062252a]        ; 0048ff8b | double g_ModelScalingNormalizationFactor
    ...
    FMUL double ptr [0x0062252a]        ; 0048ffa6 | double g_ModelScalingNormalizationFactor
    FSTP float ptr [EBP + -0x4]         ; 0048ffac
    MOV EAX,dword ptr [EBP + 0x14]      ; 0048ffaf
    PUSH EAX                            ; 0048ffb2
    CALL shape_dsemodel.cpp_CDSEModel_centerModel_FUN_0048fa50 ; 0048ffb3 | void shape_dsemodel.cpp_CDSEModel_centerModel_FUN_0048fa50(CDSEModel * this_ptr)
    ...
    PUSH EAX                            ; 0048ffc7
    CALL shape_dsemodel.cpp_CDSEModel_scaleX_FUN_0048fd70 ; 0048ffc8 | void shape_dsemodel.cpp_CDSEModel_scaleX_FUN_0048fd70(CDSEModel * this_ptr, float scale_factor)
    ...
    PUSH EAX                            ; 0048ffdc
    CALL shape_dsemodel.cpp_CDSEModel_scaleY_FUN_0048fe20 ; 0048ffdd | void shape_dsemodel.cpp_CDSEModel_scaleY_FUN_0048fe20(CDSEModel * this_ptr, float scale_factor)
    ...
    PUSH EAX                            ; 0048fff1
    CALL shape_dsemodel.cpp_CDSEModel_scaleZ_FUN_0048fcc0 ; 0048fff2 | void shape_dsemodel.cpp_CDSEModel_scaleZ_FUN_0048fcc0(CDSEModel * this_ptr, float scale_factor)
        ;   XREF to: 0048fcc0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0048fff7
    MOV EAX,dword ptr [EBP + -0x10]     ; 0048fffa
    PUSH EAX                            ; 0048fffd
    CALL engine_model.c_freeMRGLData_FUN_005280b0 ; 0048fffe | void engine_model.c_freeMRGLData_FUN_005280b0(SMRGLHeaderExtended * modelStruct)
