  ...
  if (pvVar7 != (void *)0x0) {
    ...
    do {
      ...
      for (iVar10 = 0; iVar10 < (int)(uint)uVar4; iVar10 = iVar10 + 1) {
        pvVar7 = this_ptr->scanline_buffer;
        bVar1 = *(byte *)(iVar11 + (int)pvVar7);
        bVar2 = *(byte *)(iVar11 + 1 + (int)pvVar7);
        bVar3 = *(byte *)(iVar11 + 2 + (int)pvVar7);
        local_28 = (byte)
      ...
      if (this_ptr->progress_callback != (CColorQuantizer_ProgressCallback *)0x0) {
        iVar11 = (*this_ptr->progress_callback)("Phase 1",(int)uVar5,local_30);
        if (iVar11 != 0) {
          return 0;
        }
      }
