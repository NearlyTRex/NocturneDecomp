...

{
  ...
  for (iVar15 = this_ptr->boxes[box_index].start_index * 4; iVar15 < iVar10 * 4; iVar15 = iVar15 + 4
    ...
    uVar13 = (iVar2 >> 0x10) - (uint)*(byte *)(iVar15 + 1 + (int)this_ptr->pixel_data);
    ...
    uVar13 = (iVar3 >> 0x10) - (uint)*(byte *)(iVar15 + 2 + (int)this_ptr->pixel_data);
    uVar14 = (int)uVar13 >> 0x1f;
    ...
    uVar13 = (iVar4 >> 0x10) - (uint)*(byte *)(iVar15 + 3 + (int)this_ptr->pixel_data);
    uVar14 = (int)uVar13 >> 0x1f;
