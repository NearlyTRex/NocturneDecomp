...

{
  ...
  do {
    ...
    if ((int)uVar6 <= local_14) {
      ...
      pCVar4 = pCVar4->palette;
      pcVar9 = this_ptr->output_region;
      pCVar3 = pCVar4;
      for (iVar2 = 0xc0; iVar2 != 0; iVar2 = iVar2 + -1) {
        *(uint *)pCVar3->field0_0x0 = *(uint *)pcVar9;
        pcVar9 = pcVar9 + (uint)bVar11 * -8 + 4;
        pCVar3 = (CBitmap *)((int)pCVar3 + (uint)bVar11 * -8 + 4);
      }
      for (iVar2 = 0; iVar2 != 0; iVar2 = iVar2 + -1) {
        pCVar3->field0_0x0[0] = *pcVar9;
        pcVar9 = pcVar9 + (uint)bVar11 * -2 + 1;
        pCVar3 = (CBitmap *)((int)pCVar3 + (uint)bVar11 * -2 + 1);
      }
    ...
    for (uVar6 = (uint)(uVar1 >> 2); uVar6 != 0; uVar6 = uVar6 - 1) {
      *(uint *)pCVar3->field0_0x0 = *(uint *)puVar8;
      puVar8 = puVar8 + (uint)bVar11 * -8 + 4;
      pCVar3 = (CBitmap *)((int)pCVar3 + (uint)bVar11 * -8 + 4);
    }
    for (uVar6 = (byte)uVar1 & 0xffffff03; uVar6 != 0; uVar6 = uVar6 - 1) {
      pCVar3->field0_0x0[0] = *puVar8;
      puVar8 = puVar8 + (uint)bVar11 * -2 + 1;
      pCVar3 = (CBitmap *)((int)pCVar3 + (uint)bVar11 * -2 + 1);
    }
    local_14 = local_14 + 1;
    pCVar3 = (CBitmap *)(pCVar4->field0_0x0 + (ushort)(*bitmap_ptr)->width);
    local_18 = local_18 + 4;
  } while( true );
}
