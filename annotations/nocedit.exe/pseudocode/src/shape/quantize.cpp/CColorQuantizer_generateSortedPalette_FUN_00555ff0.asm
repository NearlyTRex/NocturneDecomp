...
;                               FUNCTION
; *****************************************************************************
; __cdecl int shape_quantize.cpp_CColorQuantizer_generateSortedPalette_FUN_00555ff0(CColorQuantizer * this_ptr, uchar * output_buffer)
;
; Parameters:
...
section .text
    ...
    JLE 0x00556096                      ; 00556005 | LAB_00556096
        ;   XREF to: 00556096 (CONDITIONAL_JUMP)
    FLD double ptr [0x00640d93]         ; 0055600b | double DOUBLE_00640d93
    FLD double ptr [0x00640d8b]         ; 00556011 | double DOUBLE_00640d8b
    MOV EAX,EBX                         ; 00556017
    MOV EDX,EBX                         ; 00556019
    FLD double ptr [0x00640d83]         ; 0055601b | double DOUBLE_00640d83
    ...
    JL 0x00556021                       ; 0055608e | LAB_00556021
    ...
    JLE 0x005560d5                      ; 005560a0 | LAB_005560d5
    ...
    FLD float ptr [EDX + 0x1030]        ; 005560e7
        ;   Label: LAB_005560e7
    CALL crt_math.c_round_FUN_005fe6b0  ; 005560ed | double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 00556106 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 0055611c | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    JL 0x005560e7                       ; 00556138 | LAB_005560e7
    ...
    JMP 0x005560a6                      ; 00556174 | LAB_005560a6
        ;   XREF to: 005560a6 (UNCONDITIONAL_JUMP)
