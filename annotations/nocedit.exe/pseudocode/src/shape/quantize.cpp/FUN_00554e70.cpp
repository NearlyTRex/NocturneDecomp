// Name: shape_quantize.cpp_FUN_00554e70
// Address: 00554e70
// Address Range: [[00554e70, 00554fef]]
// Convention: unknown
// Signature: undefined shape_quantize.cpp_FUN_00554e70()
// Cross-references:
//   shape_quantize.cpp_FUN_00555a40 (00555a40) at 00555c68 [UNCONDITIONAL_CALL]
// Function calls:
//   shape_quantize.cpp_FUN_00554ff0
//   shape_quantize.cpp_FUN_00555090

#include "nocturne.h"

/* Signature: undefined1 shape_quantize.cpp_FUN_00554e70(undefined4 param_1, undefined4 param_2,
   undefined4 param_3) */

void shape_quantize_cpp_FUN_00554e70(void)

{
  ...
  iVar5 = in_stack_00000004 + in_stack_00000008 * 0x28;
  iVar4 = *(int *)(iVar5 + 0x2050);
  iVar5 = *(int *)(iVar5 + 0x2054) + iVar4 + -1;
  local_20 = (undefined4 *)(*(int *)(in_stack_00000004 + 4) + iVar4 * 4);
  puVar3 = (undefined4 *)(*(int *)(in_stack_00000004 + 4) + iVar5 * 4);
  if (iVar4 < iVar5) {
    do {
      shape_quantize_cpp_FUN_00554ff0();
      fVar2 = (float)shape_quantize_cpp_FUN_00554ff0();
      if (fVar2 < local_24) {
        for (; iVar4 < iVar5; iVar5 = iVar5 + -1) {
          shape_quantize_cpp_FUN_00554ff0();
          fVar2 = (float)shape_quantize_cpp_FUN_00554ff0();
          if (local_24 <= fVar2) break;
          puVar3 = puVar3 + -1;
        }
        uVar1 = *local_20;
        *local_20 = *puVar3;
  ...
  iVar4 = in_stack_00000004 + in_stack_0000000c * 0x28;
  *(int *)(iVar4 + 0x2050) = iVar5;
  *(int *)(iVar4 + 0x2054) =
       *(int *)(in_stack_00000004 + 0x2054 + in_stack_00000008 * 0x28) -
       (iVar5 - *(int *)(in_stack_00000004 + 0x2050 + in_stack_00000008 * 0x28));
  *(int *)(in_stack_00000004 + 0x2054 + in_stack_00000008 * 0x28) =
       iVar5 - *(int *)(in_stack_00000004 + 0x2050 + in_stack_00000008 * 0x28);
...
// Assembly code:
// 00554e70: PUSH EBX
//   Label: shape_quantize.cpp_FUN_00554e70
// 00554e71: PUSH ESI
// 00554e72: PUSH EDI
// 00554e73: PUSH EBP
...
// 00554eeb: PUSH EAX
// 00554eec: PUSH EDI
// 00554eed: CALL shape_quantize.cpp_FUN_00554ff0
...
// 00554f02: PUSH ECX
// 00554f03: PUSH EDI
// 00554f04: CALL shape_quantize.cpp_FUN_00554ff0
//   XREF to: 00554ff0 (UNCONDITIONAL_CALL)
...
// 00554f25: PUSH EAX
// 00554f26: PUSH EDI
// 00554f27: CALL shape_quantize.cpp_FUN_00554ff0
//   XREF to: 00554ff0 (UNCONDITIONAL_CALL)
...
// 00554f38: PUSH EDX
// 00554f39: PUSH EDI
// 00554f3a: CALL shape_quantize.cpp_FUN_00554ff0
//   XREF to: 00554ff0 (UNCONDITIONAL_CALL)
...
// 00554fd0: PUSH ESI
// 00554fd1: PUSH EDI
// 00554fd2: CALL shape_quantize.cpp_FUN_00555090
...
// 00554fde: PUSH EBP
// 00554fdf: PUSH EDI
// 00554fe0: CALL shape_quantize.cpp_FUN_00555090
//   XREF to: 00555090 (UNCONDITIONAL_CALL)
