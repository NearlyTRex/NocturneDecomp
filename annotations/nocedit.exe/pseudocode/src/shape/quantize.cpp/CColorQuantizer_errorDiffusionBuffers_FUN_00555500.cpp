...

{
  ...
  count = num_entries * 8;
  pfVar1 = (float *)shape_memdbg_cpp_debugAlloc_FUN_0050f1f0(count,"..\\shape\\quantize.cpp",0x28d);
  this_ptr->error_buffer_r = pfVar1;
  if (pfVar1 != (float *)0x0) {
    pfVar1 = (float *)shape_memdbg_cpp_debugAlloc_FUN_0050f1f0(count,"..\\shape\\quantize.cpp",0x290);
    this_ptr->error_buffer_g = pfVar1;
    if (pfVar1 != (float *)0x0) {
      pfVar1 = (float *)shape_memdbg_cpp_debugAlloc_FUN_0050f1f0(count,"..\\shape\\quantize.cpp",0x293);
      this_ptr->error_buffer_b = pfVar1;
      if (pfVar1 != (float *)0x0) {
        pfVar1 = (float *)shape_memdbg_cpp_debugAlloc_FUN_0050f1f0(count,"..\\shape\\quantize.cpp",0x296)
        ;
