...
section .text
    ...
    PUSH 0x640ab5                       ; 00556d42 | = "..\\shape\\quantize.cpp" | s_shape_quantize_cpp_00640ab5 = ..\shape\quantize.cpp
    MOV EDX,dword ptr [ESP + 0xc]       ; 00556d47
    PUSH EDX                            ; 00556d4b
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 00556d4c | void shape_memdbg.cpp_debugFree_FUN_0050f460(void * ptr, char * filename, int line_number)
