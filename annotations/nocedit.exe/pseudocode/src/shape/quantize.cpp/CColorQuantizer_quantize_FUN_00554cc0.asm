...
section .text
    ...
    JZ 0x00554ce8                       ; 00554ccc
        ;   XREF to: 00554ce8 (CONDITIONAL_JUMP)  ; LAB_00554ce8
    PUSH 0x0                            ; 00554cce
    PUSH EBX                            ; 00554cd0
    CALL shape_quantize.cpp_CColorQuantizer_computeBoxStatistics_FUN_00555090 ; 00554cd1
    ...
    PUSH EBX                            ; 00554cd9
    CALL shape_quantize.cpp_CColorQuantizer_reduceColors_FUN_00555a40 ; 00554cda
        ;   XREF to: 00555a40 (UNCONDITIONAL_CALL)  ; int shape_quantize.cpp_CColorQuantizer_reduceColors_FUN_00555a40(CColorQuantizer * this_ptr)
    ADD ESP,0x4                         ; 00554cdf
    TEST EAX,EAX                        ; 00554ce2
    JNZ 0x00554d0f                      ; 00554ce4
        ;   XREF to: 00554d0f (CONDITIONAL_JUMP)  ; LAB_00554d0f
    POP EBX                             ; 00554ce6
    RET                                 ; 00554ce7
    MOV ECX,0x640a73                    ; 00554ce8 | = "..\\shape\\quantize.cpp"
        ;   Label: LAB_00554ce8
    MOV EBX,0x61                        ; 00554ced
    PUSH 0x640ba3                       ; 00554cf2 | = "Nothing to quantize."
    MOV dword ptr [0x02f0ca48],ECX      ; 00554cf7 | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 00554cfd | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00554d03
    ...
    PUSH 0x79                           ; 00554d0f
        ;   Label: LAB_00554d0f
    PUSH 0x640ab5                       ; 00554d11 | = "..\\shape\\quantize.cpp"
    MOV EAX,dword ptr [EBX + 0x4]       ; 00554d16
    PUSH EAX                            ; 00554d19
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 00554d1a
