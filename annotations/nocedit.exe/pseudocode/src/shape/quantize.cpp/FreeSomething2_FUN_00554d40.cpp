// Name: shape_quantize.cpp_FreeSomething2_FUN_00554d40
// Address: 00554d40
// Address Range: [[00554d40, 00554e6b]]
// Convention: unknown
// Signature: undefined shape_quantize.cpp_FreeSomething2_FUN_00554d40()
// Cross-references:
//   shape_quantize.cpp_FreeAndAllocate_ThenQuantize_FUN_005563d0 (005563d0) at 0055642a [UNCONDITIONAL_CALL]
// Globals:
...
/* Signature: undefined1 shape_quantize.cpp_FreeSomething2(undefined4 param_1) */

void shape_quantize_cpp_FreeSomething2_FUN_00554d40(void)

{
  ...
  if ((void *)in_stack_00000004[4] != (void *)0x0) {
    ...
    crt_memory_c_free_FUN_005fe659((void *)in_stack_00000004[4]);
  }
  if ((void *)in_stack_00000004[5] != (void *)0x0) {
    g_CurrentDebugFilename = "..\\shape\\quantize.cpp";
    g_CurrentDebugLine = 500;
    crt_memory_c_free_FUN_005fe659((void *)in_stack_00000004[5]);
  }
  if ((void *)in_stack_00000004[6] != (void *)0x0) {
    g_CurrentDebugFilename = "..\\shape\\quantize.cpp";
    g_CurrentDebugLine = 0x1f5;
    crt_memory_c_free_FUN_005fe659((void *)in_stack_00000004[6]);
  }
  if ((void *)in_stack_00000004[7] != (void *)0x0) {
    g_CurrentDebugFilename = "..\\shape\\quantize.cpp";
    g_CurrentDebugLine = 0x1f6;
    crt_memory_c_free_FUN_005fe659((void *)in_stack_00000004[7]);
  }
  if ((void *)in_stack_00000004[2] != (void *)0x0) {
    g_CurrentDebugFilename = "..\\shape\\quantize.cpp";
    g_CurrentDebugLine = 0x1f7;
    crt_memory_c_free_FUN_005fe659((void *)in_stack_00000004[2]);
  }
  if ((void *)in_stack_00000004[3] != (void *)0x0) {
    shape_memdbg_cpp_debugFree_FUN_0050f460
              ((void *)in_stack_00000004[3],"..\\shape\\quantize.cpp",0x79);
  }
  if ((void *)in_stack_00000004[1] != (void *)0x0) {
    shape_memdbg_cpp_debugFree_FUN_0050f460
              ((void *)in_stack_00000004[1],"..\\shape\\quantize.cpp",0x79);
  }
  uVar1 = *in_stack_00000004;
  uVar2 = in_stack_00000004[0x12d0];
  crt_memory_c_memset_FUN_005fde40(in_stack_00000004,0,0x4b44);
  in_stack_00000004[0x12cd] = 0xffffffff;
  *in_stack_00000004 = uVar1;
  in_stack_00000004[0x12d0] = uVar2;
  return;
}
...
// Assembly code:
// 00554d40: PUSH EBX
//   Label: shape_quantize.cpp_FreeSomething2_FUN_00554d40
// 00554d41: PUSH ESI
// 00554d42: PUSH EDI
// 00554d43: PUSH EBP
