...

{
  ...
  while( true ) {
    ...
    break;
    local_48 = 0;
    local_5c = this_ptr->boxes[0].weighted_variance;
    iVar3 = 1;
    local_4c = this_ptr->boxes[0].final_metric;
    pCVar2 = this_ptr;
    if (0 < local_44) {
      do {
        if (local_5c < pCVar2->boxes[1].weighted_variance) {
          local_5c = pCVar2->boxes[1].weighted_variance;
    ...
    if (local_4c == this_ptr->boxes[local_48].red_variance) {
      ...
      iVar7 = this_ptr->boxes[local_48].pixel_count;
      iVar6 = iVar4 - this_ptr->boxes[local_48].start_index;
      ...
      shape_quantize_cpp_CColorQuantizer_splitBox_FUN_00554e70(this_ptr,local_48,iVar3);
    }
