...
;                               FUNCTION
; *****************************************************************************
; __cdecl CColorQuantizer * shape_quantize.cpp_CColorQuantizer_ctor_FUN_00554900(CColorQuantizer * this_ptr)
;
; Parameters:
...
section .text
    ...
    CALL crt_stack.c_stack_probe_FUN_005ff9f3 ; 00554905 | uint crt_stack.c_stack_probe_FUN_005ff9f3(uint stack_size)
    ...
    PUSH 0x0                            ; 00554914
    PUSH EBX                            ; 00554916
    CALL crt_memory.c_memset_FUN_005fde40 ; 00554917 | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
