// Name: shape_quantize.cpp_ColorQuantizationMaybe_FUN_00556490
// Address: 00556490
// Address Range: [[00556490, 005568e1]]
// Convention: unknown
// Signature: undefined shape_quantize.cpp_ColorQuantizationMaybe_FUN_00556490()
// Cross-references:
...
//   shape_quantize.cpp_CallFreeAndAllocateThenQuantize_FUN_00556470
//   shape_quantize.cpp_FreeSomething1_FUN_00554940
//   shape_quantize.cpp_FreeSomething1_FUN_00556c20
//   shape_quantize.cpp_FUN_00554900
//   wincore_wddvmem.cpp_swapBuffers_FUN_005eda20

#include "nocturne.h"

/* Signature: undefined1 shape_quantize.cpp_ColorQuantizationMaybe(undefined4 param_1, undefined4
   param_2, undefined4 param_3, undefined4 param_4, undefined4 param_5, undefined4 param_6,
   undefined4 param_7, undefined4 param_8) */

int shape_quantize_cpp_ColorQuantizationMaybe_FUN_00556490(void)

{
  ...
  bVar7 = 0;
  DAT_03106158 = in_stack_0000001c;
  pvVar1 = shape_memdbg_cpp_debugAlloc_FUN_0050f1b0(0x28,"..\\shape\\quantize.cpp",0x3ec);
  if (pvVar1 != (void *)0x0) {
    pvVar1 = (void *)shape_quantize_cpp_AllocateMemForSomething_FUN_00556a00();
  }
  if (pvVar1 == (void *)0x0) {
  ...
  if (in_stack_00000018 < 0x10) {
    if (7 < in_stack_00000018) {
      if (in_stack_00000018 < 9) {
        unaff_ESI = 1;
        goto LAB_00556524;
      }
      if (in_stack_00000018 == 0xf) goto LAB_00556829;
    }
  }
  else {
...
LAB_00556829:
    ...
    if (0x17 < in_stack_00000018) {
      if (in_stack_00000018 < 0x19) {
        unaff_ESI = 3;
        goto LAB_00556524;
      }
      if (in_stack_00000018 == 0x20) {
        unaff_ESI = 4;
        goto LAB_00556524;
      }
    }
...
LAB_00556524:
  uVar4 = in_stack_00000018 * in_stack_0000001c * unaff_ESI;
  puVar2 = (undefined4 *)**(undefined4 **)((int)pvVar1 + 0x20);
  for (uVar5 = uVar4 >> 2; uVar5 != 0; uVar5 = uVar5 - 1) {
    *puVar2 = *in_stack_00000004;
    in_stack_00000004 = in_stack_00000004 + (uint)bVar7 * -2 + 1;
    puVar2 = puVar2 + (uint)bVar7 * -2 + 1;
  }
  for (uVar4 = uVar4 & 3; uVar4 != 0; uVar4 = uVar4 - 1) {
    *(undefined1 *)puVar2 = *(undefined1 *)in_stack_00000004;
    in_stack_00000004 = (undefined4 *)((int)in_stack_00000004 + (uint)bVar7 * -2 + 1);
    puVar2 = (undefined4 *)((int)puVar2 + (uint)bVar7 * -2 + 1);
  }
  if (in_stack_00000028 != 0) {
    crt_stdio_c_sprintf_FUN_005fdbd0(&stack0xffffff2c,"%d-bit color                                                                  ");
    engine_2d_c_drawText_FUN_00401fd0(&stack0xffffff28,0,in_stack_00000020 * 0xb);
  }
  puVar2 = (undefined4 *)
           shape_memdbg_cpp_debugAlloc_FUN_0050f1b0(0x4b44,"..\\shape\\quantize.cpp",0x417);
  if (puVar2 != (undefined4 *)0x0) {
    puVar2 = (undefined4 *)shape_quantize_cpp_FUN_00554900();
  }
  if (puVar2 == (undefined4 *)0x0) {
    g_CurrentFilename = "..\\shape\\quantize.cpp";
  ...
  if (in_stack_00000030 != 0) {
    engine_2d_c_drawText_FUN_00401fd0
              ("Performing color quantization...",0,(in_stack_0000002c + 2) * 0xb);
    wincore_wddvmem_cpp_swapBuffers_FUN_005eda20();
  }
  engine_2d_c_clearInputAndWait_FUN_00403260();
  *puVar2 = 0;
  iVar3 = shape_quantize_cpp_CallFreeAndAllocateThenQuantize_FUN_00556470();
  if (iVar3 != 0) {
    ...
    *in_stack_00000034 = pvVar1;
    ...
    puVar2 = (undefined4 *)**(undefined4 **)(in_stack_0000001c + 0x20);
    puVar6 = (undefined4 *)*in_stack_00000038;
    ...
    *in_stack_00000040 = pvVar1;
    ...
    puVar2 = *(undefined4 **)(in_stack_00000024 + 0x24);
    puVar6 = (undefined4 *)*in_stack_00000044;
    ...
    pvVar1 = (void *)shape_quantize_cpp_FreeSomething1_FUN_00554940();
    shape_memdbg_cpp_debugFree_FUN_0050f210(pvVar1);
    g_CurrentDebugFilename = "..\\shape\\quantize.cpp";
    g_CurrentDebugLine = 0x444;
    if (in_stack_0000002c != 0) {
      pvVar1 = (void *)shape_quantize_cpp_FreeSomething1_FUN_00556c20();
      shape_memdbg_cpp_debugFree_FUN_0050f210(pvVar1);
    }
    iVar3 = 1;
  }
...
// Assembly code:
// 00556490: PUSH EBX
//   Label: shape_quantize.cpp_ColorQuantizationMaybe_FUN_00556490
// 00556491: PUSH ESI
// 00556492: PUSH EDI
// 00556493: PUSH EBP
...
// 005565b1: PUSH EAX
// 005565b2: CALL shape_quantize.cpp_FUN_00554900
...
// 00556610: CALL shape_quantize.cpp_CallFreeAndAllocateThenQuantize_FUN_00556470
...
// 00556768: CALL shape_quantize.cpp_FreeSomething1_FUN_00554940
...
// 00556799: PUSH 0x0
// 0055679b: PUSH EDX
// 0055679c: CALL shape_quantize.cpp_FreeSomething1_FUN_00556c20
...
// 005567d7: PUSH ECX
// 005567d8: PUSH EAX
// 005567d9: CALL shape_quantize.cpp_AllocateMemForSomething_FUN_00556a00
