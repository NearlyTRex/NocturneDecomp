...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_quantize.cpp_CColorQuantizer_mapScanlineToPalette_FUN_005556f0(CColorQuantizer * this_ptr, uchar * src_pixels, uchar * dest_indices, short start_x, short end_x, short num_palette_entries)
;
; Parameters:
...
section .text
    ...
    CALL shape_quantize.cpp_getAbsoluteValue_FUN_00556df0 ; 00555715 | int shape_quantize.cpp_getAbsoluteValue_FUN_00556df0(int value)
    ...
    JNZ 0x005557d1                      ; 00555750 | LAB_005557d1
    ...
    JL 0x00555a26                       ; 00555770 | LAB_00555a26
    ...
    JLE 0x005557bd                      ; 00555797 | LAB_005557bd
    ...
    JLE 0x00555888                      ; 0055584e | LAB_00555888
    ...
    FNSTSW AX                           ; 005558b4
    SAHF                                ; 005558b6
    JBE 0x00555994                      ; 005558b7 | LAB_00555994
    ...
    FNSTSW AX                           ; 005558d3
    SAHF                                ; 005558d5
    JBE 0x005559b4                      ; 005558d6 | LAB_005559b4
    ...
    FNSTSW AX                           ; 005558f2
    SAHF                                ; 005558f4
    JBE 0x005559d4                      ; 005558f5 | LAB_005559d4
    ...
    FNSTSW AX                           ; 0055590f
    SAHF                                ; 00555911
    JBE 0x005559f4                      ; 00555912 | LAB_005559f4
    ...
    INC ECX                             ; 00555a20
    JMP 0x0055592d                      ; 00555a21 | LAB_0055592d
        ;   XREF to: 0055592d (UNCONDITIONAL_JUMP)
