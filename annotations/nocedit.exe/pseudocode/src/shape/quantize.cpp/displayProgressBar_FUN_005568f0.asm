...
;                               FUNCTION
; *****************************************************************************
; __cdecl int shape_quantize.cpp_displayProgressBar_FUN_005568f0(char * label, int total_count, int current_index)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 00556919
    FMUL double ptr [0x006410cb]        ; 0055691a | double DOUBLE_006410cb
    PUSH 0x641092                       ; 00556920 | = "\r%s [                    ]\r" | s_s_00641092 = %s [                    ]
    LEA EAX,[ESP + 0x8]                 ; 00556925
    LEA ESI,[ESP + 0x8]                 ; 00556929
    PUSH EAX                            ; 0055692d
    CALL crt_math.c_round_FUN_005fe6b0  ; 0055692e | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x70]        ; 00556933
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 00556937 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    MOV AL,byte ptr [ESI]               ; 00556945
        ;   Label: LAB_00556945
    CMP AL,DL                           ; 00556947
    JZ 0x0055695d                       ; 00556949 | LAB_0055695d
        ;   XREF to: 0055695d (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 0055694b
    JZ 0x0055695b                       ; 0055694d | LAB_0055695b
        ;   XREF to: 0055695b (CONDITIONAL_JUMP)
    INC ESI                             ; 0055694f
    MOV AL,byte ptr [ESI]               ; 00556950
    CMP AL,DL                           ; 00556952
    JZ 0x0055695d                       ; 00556954 | LAB_0055695d
        ;   XREF to: 0055695d (CONDITIONAL_JUMP)
    INC ESI                             ; 00556956
    CMP AL,0x0                          ; 00556957
    JNZ 0x00556945                      ; 00556959 | LAB_00556945
    ...
    INC ESI                             ; 00556960
    PUSH ESI                            ; 00556961
    CALL crt_memory.c_memset_FUN_005fde40 ; 00556962 | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
        ;   XREF to: 005fde40 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [0x03106158]      ; 00556967 | int g_QuantizeCurrentLineNumber
    ...
    PUSH EAX                            ; 00556988
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 00556989 | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0055698e
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 00556991 | void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20()
        ;   XREF to: 005eda20 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [ESP + 0x80]      ; 00556996
    MOV EBX,dword ptr [ESP + 0x84]      ; 0055699d
    DEC EAX                             ; 005569a4
    CMP EAX,EBX                         ; 005569a5
    JZ 0x005569b1                       ; 005569a7 | LAB_005569b1
    ...
    PUSH EAX                            ; 005569bf
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005569c0 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [0x03106158]      ; 005569c5 | int g_QuantizeCurrentLineNumber
    ...
    PUSH EAX                            ; 005569e6
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 005569e7 | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005569ec
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 005569ef | void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20()
        ;   XREF to: 005eda20 (UNCONDITIONAL_CALL)
