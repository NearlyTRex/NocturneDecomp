...
;                               FUNCTION
; *****************************************************************************
; __cdecl int shape_quantize.cpp_CColorQuantizer_importBitmap_FUN_00554a50(CColorQuantizer * this_ptr, CBitmap * bitmap)
;
; Parameters:
...
section .text
    ...
    JZ 0x00554a8b                       ; 00554a7d | LAB_00554a8b
    ...
    PUSH 0x640a9f                       ; 00554aa3 | = "..\\shape\\quantize.cpp" | s_shape_quantize_cpp_00640a9f = ..\shape\quantize.cpp
    ADD EAX,EDI                         ; 00554aa8
    PUSH EAX                            ; 00554aaa
    MOV EDX,dword ptr [EBX + 0x4]       ; 00554aab
    PUSH EDX                            ; 00554aae
    CALL shape_memdbg.cpp_debugRealloc_FUN_0050f540 ; 00554aaf | void * shape_memdbg.cpp_debugRealloc_FUN_0050f540(void * ptr, int new_size, char * filename, int line_number)
        ;   XREF to: 0050f540 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00554ab4
    TEST EAX,EAX                        ; 00554ab7
    JZ 0x00554b2c                       ; 00554ab9 | LAB_00554b2c
    ...
    PUSH 0x640a9f                       ; 00554ad0 | = "..\\shape\\quantize.cpp" | s_shape_quantize_cpp_00640a9f = ..\shape\quantize.cpp
    MOV AX,SI                           ; 00554ad5
    PUSH EAX                            ; 00554ad8
    MOV EDX,dword ptr [EBX + 0xc]       ; 00554ad9
    PUSH EDX                            ; 00554adc
    CALL shape_memdbg.cpp_debugRealloc_FUN_0050f540 ; 00554add | void * shape_memdbg.cpp_debugRealloc_FUN_0050f540(void * ptr, int new_size, char * filename, int line_number)
        ;   XREF to: 0050f540 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00554ae2
    TEST EAX,EAX                        ; 00554ae5
    JZ 0x00554b5b                       ; 00554ae7 | LAB_00554b5b
    ...
    JG 0x00554ba1                       ; 00554b01 | LAB_00554ba1
    ...
    POP EBX                             ; 00554b2a
    RET                                 ; 00554b2b
    MOV EDX,0x640a73                    ; 00554b2c | = "..\\shape\\quantize.cpp" | s_shape_quantize_cpp_00640a73 = ..\shape\quantize.cpp
        ;   Label: LAB_00554b2c
    MOV ECX,0x61                        ; 00554b31
    PUSH 0x640b39                       ; 00554b36 | = "Unable to allocate memory for Pix array." | s_Unable_to_allocate_memor_00640b39 = Unable to allocate memory for Pix array.
    XOR EDI,EDI                         ; 00554b3b
    MOV dword ptr [0x02f0ca48],EDX      ; 00554b3d | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 00554b43 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00554b49 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    POP EBX                             ; 00554b59
    RET                                 ; 00554b5a
    MOV EDX,0x640a73                    ; 00554b5b | = "..\\shape\\quantize.cpp" | s_shape_quantize_cpp_00640a73 = ..\shape\quantize.cpp
        ;   Label: LAB_00554b5b
    MOV ECX,0x61                        ; 00554b60
    PUSH 0x640b62                       ; 00554b65 | = "Unable to allocate memory for scanlin..." | s_Unable_to_allocate_memor_00640b62 = Unable to allocate memory for scanline array.
    XOR EDI,EDI                         ; 00554b6a
    MOV dword ptr [0x02f0ca48],EDX      ; 00554b6c | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 00554b72 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00554b78 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ...
    JMP 0x00554af5                      ; 00554b9c | LAB_00554af5
    ...
    JGE 0x00554c7e                      ; 00554bd3 | LAB_00554c7e
    ...
    FSQRT                               ; 00554c10
    FMUL double ptr [0x00640b9b]        ; 00554c12 | double DOUBLE_00640b9b
    CALL crt_math.c_round_FUN_005fe6b0  ; 00554c18 | double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    JMP 0x00554bca                      ; 00554c79 | LAB_00554bca
        ;   XREF to: 00554bca (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBX],0x0             ; 00554c7e
        ;   Label: LAB_00554c7e
    JZ 0x00554b8a                       ; 00554c81 | LAB_00554b8a
    ...
    PUSH EAX                            ; 00554c92
    PUSH 0x640b90                       ; 00554c93 | = "Phase 1" | s_Phase_1_00640b90 = Phase 1
    CALL dword ptr [EBX]                ; 00554c98
    ADD ESP,0xc                         ; 00554c9a
    TEST EAX,EAX                        ; 00554c9d
    JZ 0x00554b8a                       ; 00554c9f | LAB_00554b8a
        ;   XREF to: 00554b8a (CONDITIONAL_JUMP)
