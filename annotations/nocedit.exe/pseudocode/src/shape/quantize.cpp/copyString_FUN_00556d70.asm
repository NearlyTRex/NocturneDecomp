...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_quantize.cpp_copyString_FUN_00556d70(char * dest, char * src)
;
; Parameters:
...
section .text
    ...
    PUSH ECX                            ; 00556d7b
    CALL crt_string.c_strncpy_FUN_00600f40 ; 00556d7c | char * crt_string.c_strncpy_FUN_00600f40(char * dest, char * src, SIZE_T count)
