...
;                               FUNCTION
; *****************************************************************************
; __cdecl int shape_quantize.cpp_CColorQuantizer_reduceColors_FUN_00555a40(CColorQuantizer * this_ptr)
;
; Parameters:
...
section .text
    ...
    JLE 0x00555fd9                      ; 00555a62 | LAB_00555fd9
        ;   XREF to: 00555fd9 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX],0x0             ; 00555a68
    JNZ 0x00555b38                      ; 00555a6b | LAB_00555b38
    ...
    JL 0x00555acb                       ; 00555a95 | LAB_00555acb
    ...
    FNSTSW AX                           ; 00555aa7
    SAHF                                ; 00555aa9
    JBE 0x00555ac3                      ; 00555aaa | LAB_00555ac3
    ...
    JLE 0x00555a9e                      ; 00555ac9 | LAB_00555a9e
    ...
    FNSTSW AX                           ; 00555ad2
    SAHF                                ; 00555ad4
    JNC 0x00555fd9                      ; 00555ad5 | LAB_00555fd9
        ;   XREF to: 00555fd9 (CONDITIONAL_JUMP)
    ...
    JLE 0x00555bfe                      ; 00555b7b | LAB_00555bfe
    ...
    JLE 0x00555be6                      ; 00555ba2 | LAB_00555be6
    ...
    CMP ESI,EAX                         ; 00555bb6
        ;   Label: LAB_00555bb6
    JGE 0x00555bd0                      ; 00555bb8 | LAB_00555bd0
    ...
    JLE 0x00555bd0                      ; 00555bc8 | LAB_00555bd0
        ;   XREF to: 00555bd0 (CONDITIONAL_JUMP)
    DEC EDX                             ; 00555bca
    SUB EAX,0x4                         ; 00555bcb
    JMP 0x00555bb6                      ; 00555bce | LAB_00555bb6
    ...
    JG 0x00555b8c                       ; 00555bfc | LAB_00555b8c
    ...
    CALL shape_quantize.cpp_CColorQuantizer_computeBoxStatistics_FUN_00555090 ; 00555c44 | void shape_quantize.cpp_CColorQuantizer_computeBoxStatistics_FUN_00555090(CColorQuantizer * this_ptr, int box_index)
        ;   XREF to: 00555090 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00555c49
    PUSH EDI                            ; 00555c4c
    PUSH EBX                            ; 00555c4d
    CALL shape_quantize.cpp_CColorQuantizer_computeBoxStatistics_FUN_00555090 ; 00555c4e | void shape_quantize.cpp_CColorQuantizer_computeBoxStatistics_FUN_00555090(CColorQuantizer * this_ptr, int box_index)
        ;   XREF to: 00555090 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 00555c66
    PUSH EBX                            ; 00555c67
    CALL shape_quantize.cpp_CColorQuantizer_splitBox_FUN_00554e70 ; 00555c68 | void shape_quantize.cpp_CColorQuantizer_splitBox_FUN_00554e70(CColorQuantizer * this_ptr, int source_box_index, int dest_box_index)
        ;   XREF to: 00554e70 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00555c6d
    JMP 0x00555a55                      ; 00555c70 | LAB_00555a55
        ;   XREF to: 00555a55 (UNCONDITIONAL_JUMP)
    ...
    JLE 0x00555d21                      ; 00555c9c | LAB_00555d21
    ...
    JLE 0x00555d09                      ; 00555cc4 | LAB_00555d09
    ...
    CMP ESI,EAX                         ; 00555cd8
        ;   Label: LAB_00555cd8
    JGE 0x00555cf3                      ; 00555cda | LAB_00555cf3
    ...
    JLE 0x00555cf3                      ; 00555ceb | LAB_00555cf3
        ;   XREF to: 00555cf3 (CONDITIONAL_JUMP)
    DEC EDX                             ; 00555ced
    SUB EAX,0x4                         ; 00555cee
    JMP 0x00555cd8                      ; 00555cf1 | LAB_00555cd8
    ...
    JG 0x00555cad                       ; 00555d1f | LAB_00555cad
    ...
    CALL shape_quantize.cpp_CColorQuantizer_computeBoxStatistics_FUN_00555090 ; 00555d67 | void shape_quantize.cpp_CColorQuantizer_computeBoxStatistics_FUN_00555090(CColorQuantizer * this_ptr, int box_index)
        ;   XREF to: 00555090 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00555d6c
    PUSH EDI                            ; 00555d6f
    PUSH EBX                            ; 00555d70
    CALL shape_quantize.cpp_CColorQuantizer_computeBoxStatistics_FUN_00555090 ; 00555d71 | void shape_quantize.cpp_CColorQuantizer_computeBoxStatistics_FUN_00555090(CColorQuantizer * this_ptr, int box_index)
        ;   XREF to: 00555090 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 00555d89
    PUSH EBX                            ; 00555d8a
    CALL shape_quantize.cpp_CColorQuantizer_splitBox_FUN_00554e70 ; 00555d8b | void shape_quantize.cpp_CColorQuantizer_splitBox_FUN_00554e70(CColorQuantizer * this_ptr, int source_box_index, int dest_box_index)
        ;   XREF to: 00554e70 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00555d90
    JMP 0x00555a55                      ; 00555d93 | LAB_00555a55
        ;   XREF to: 00555a55 (UNCONDITIONAL_JUMP)
    ...
    JLE 0x00555e43                      ; 00555dbe | LAB_00555e43
    ...
    JLE 0x00555e2b                      ; 00555de6 | LAB_00555e2b
    ...
    CMP ESI,EAX                         ; 00555dfa
        ;   Label: LAB_00555dfa
    JGE 0x00555e15                      ; 00555dfc | LAB_00555e15
    ...
    JLE 0x00555e15                      ; 00555e0d | LAB_00555e15
        ;   XREF to: 00555e15 (CONDITIONAL_JUMP)
    DEC EDX                             ; 00555e0f
    SUB EAX,0x4                         ; 00555e10
    JMP 0x00555dfa                      ; 00555e13 | LAB_00555dfa
    ...
    JG 0x00555dcf                       ; 00555e41 | LAB_00555dcf
    ...
    PUSH EAX                            ; 00555e87
    PUSH EBX                            ; 00555e88
    CALL shape_quantize.cpp_CColorQuantizer_computeBoxStatistics_FUN_00555090 ; 00555e89 | void shape_quantize.cpp_CColorQuantizer_computeBoxStatistics_FUN_00555090(CColorQuantizer * this_ptr, int box_index)
        ;   XREF to: 00555090 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00555e8e
    PUSH EDI                            ; 00555e91
    PUSH EBX                            ; 00555e92
    CALL shape_quantize.cpp_CColorQuantizer_computeBoxStatistics_FUN_00555090 ; 00555e93 | void shape_quantize.cpp_CColorQuantizer_computeBoxStatistics_FUN_00555090(CColorQuantizer * this_ptr, int box_index)
        ;   XREF to: 00555090 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 00555eab
    PUSH EBX                            ; 00555eac
    CALL shape_quantize.cpp_CColorQuantizer_splitBox_FUN_00554e70 ; 00555ead | void shape_quantize.cpp_CColorQuantizer_splitBox_FUN_00554e70(CColorQuantizer * this_ptr, int source_box_index, int dest_box_index)
        ;   XREF to: 00554e70 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00555eb2
    JMP 0x00555a55                      ; 00555eb5 | LAB_00555a55
        ;   XREF to: 00555a55 (UNCONDITIONAL_JUMP)
    ...
    JLE 0x00555f66                      ; 00555ee1 | LAB_00555f66
    ...
    JLE 0x00555f4e                      ; 00555f09 | LAB_00555f4e
    ...
    CMP ESI,EAX                         ; 00555f1d
        ;   Label: LAB_00555f1d
    JGE 0x00555f38                      ; 00555f1f | LAB_00555f38
    ...
    JLE 0x00555f38                      ; 00555f30 | LAB_00555f38
        ;   XREF to: 00555f38 (CONDITIONAL_JUMP)
    DEC EDX                             ; 00555f32
    SUB EAX,0x4                         ; 00555f33
    JMP 0x00555f1d                      ; 00555f36 | LAB_00555f1d
    ...
    JG 0x00555ef2                       ; 00555f64 | LAB_00555ef2
    ...
    PUSH EAX                            ; 00555fa2
    PUSH EBX                            ; 00555fa3
    CALL shape_quantize.cpp_CColorQuantizer_computeBoxStatistics_FUN_00555090 ; 00555fa4 | void shape_quantize.cpp_CColorQuantizer_computeBoxStatistics_FUN_00555090(CColorQuantizer * this_ptr, int box_index)
        ;   XREF to: 00555090 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00555fa9
    MOV EDX,dword ptr [ESP + 0x18]      ; 00555fac
    PUSH EDX                            ; 00555fb0
    PUSH EBX                            ; 00555fb1
    CALL shape_quantize.cpp_CColorQuantizer_computeBoxStatistics_FUN_00555090 ; 00555fb2 | void shape_quantize.cpp_CColorQuantizer_computeBoxStatistics_FUN_00555090(CColorQuantizer * this_ptr, int box_index)
        ;   XREF to: 00555090 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 00555fca
    PUSH EBX                            ; 00555fcb
    CALL shape_quantize.cpp_CColorQuantizer_splitBox_FUN_00554e70 ; 00555fcc | void shape_quantize.cpp_CColorQuantizer_splitBox_FUN_00554e70(CColorQuantizer * this_ptr, int source_box_index, int dest_box_index)
        ;   XREF to: 00554e70 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00555fd1
    JMP 0x00555a55                      ; 00555fd4 | LAB_00555a55
        ;   XREF to: 00555a55 (UNCONDITIONAL_JUMP)
