...
section .text
    ...
    CALL shape_memdbg.cpp_debugAllocTracked1_FUN_0050f1b0 ; 005564c0
    ...
    CALL shape_memdbg.cpp_debugAllocTracked1_FUN_0050f1b0 ; 005565a5
        ;   XREF to: 0050f1b0 (UNCONDITIONAL_CALL)  ; void * shape_memdbg.cpp_debugAllocTracked1_FUN_0050f1b0(int size, char * filename, int line_number)
    ...
    CALL shape_memdbg.cpp_debugFreeChecked_FUN_0050f210 ; 00556776
    ...
    PUSH EAX                            ; 005567a4
    CALL shape_memdbg.cpp_debugFreeChecked_FUN_0050f210 ; 005567a5
        ;   XREF to: 0050f210 (UNCONDITIONAL_CALL)  ; void shape_memdbg.cpp_debugFreeChecked_FUN_0050f210(void * ptr)
