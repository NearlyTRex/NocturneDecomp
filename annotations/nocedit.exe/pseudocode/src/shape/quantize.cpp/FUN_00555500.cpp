// Name: shape_quantize.cpp_FUN_00555500
// Address: 00555500
// Address Range: [[00555500, 005556e7]]
// Convention: unknown
// Signature: undefined shape_quantize.cpp_FUN_00555500()
// Cross-references:
//   shape_quantize.cpp_FUN_00556180 (00556180) at 0055619c [UNCONDITIONAL_CALL]
// Globals:
...
/* Signature: undefined1 shape_quantize.cpp_FUN_00555500(undefined4 param_1, undefined4 param_2) */

undefined1 * shape_quantize_cpp_FUN_00555500(void)

{
  ...
  *(undefined4 *)(in_stack_00000004 + 0x20) = 0;
  if (*(void **)(in_stack_00000004 + 0x10) != (void *)0x0) {
    g_CurrentDebugFilename = "..\\shape\\quantize.cpp";
    g_CurrentDebugLine = 0x287;
    crt_memory_c_free_FUN_005fe659(*(void **)(in_stack_00000004 + 0x10));
  }
  if (*(void **)(in_stack_00000004 + 0x14) != (void *)0x0) {
    g_CurrentDebugFilename = "..\\shape\\quantize.cpp";
    g_CurrentDebugLine = 0x288;
    crt_memory_c_free_FUN_005fe659(*(void **)(in_stack_00000004 + 0x14));
  }
  if (*(void **)(in_stack_00000004 + 0x18) != (void *)0x0) {
    g_CurrentDebugFilename = "..\\shape\\quantize.cpp";
    g_CurrentDebugLine = 0x289;
    crt_memory_c_free_FUN_005fe659(*(void **)(in_stack_00000004 + 0x18));
  }
  ...
  if (*(void **)(in_stack_00000004 + 8) != (void *)0x0) {
    g_CurrentDebugFilename = "..\\shape\\quantize.cpp";
    g_CurrentDebugLine = 0x28b;
    crt_memory_c_free_FUN_005fe659(*(void **)(in_stack_00000004 + 8));
  }
  count = in_stack_00000008 * 8;
  puVar1 = (undefined1 *)
           shape_memdbg_cpp_debugAlloc_FUN_0050f1f0(count,"..\\shape\\quantize.cpp",0x28d);
  *(undefined1 **)(in_stack_00000004 + 0x10) = puVar1;
  if (puVar1 != (undefined1 *)0x0) {
    puVar1 = (undefined1 *)
             shape_memdbg_cpp_debugAlloc_FUN_0050f1f0(count,"..\\shape\\quantize.cpp",0x290);
    *(undefined1 **)(in_stack_00000004 + 0x14) = puVar1;
    if (puVar1 != (undefined1 *)0x0) {
      puVar1 = (undefined1 *)
               shape_memdbg_cpp_debugAlloc_FUN_0050f1f0(count,"..\\shape\\quantize.cpp",0x293);
      *(undefined1 **)(in_stack_00000004 + 0x18) = puVar1;
      if (puVar1 != (undefined1 *)0x0) {
        puVar1 = (undefined1 *)
                 shape_memdbg_cpp_debugAlloc_FUN_0050f1f0(count,"..\\shape\\quantize.cpp",0x296)
        ;
        *(undefined1 **)(in_stack_00000004 + 0x1c) = puVar1;
        if (puVar1 != (undefined1 *)0x0) {
          puVar1 = (undefined1 *)
                   shape_memdbg_cpp_debugAlloc_FUN_0050f1f0
                             (in_stack_00000008,"..\\shape\\quantize.cpp",0x299);
          *(undefined1 **)(in_stack_00000004 + 8) = puVar1;
          if (puVar1 != (undefined1 *)0x0) {
            crt_memory_c_memset_FUN_005fde40(*(void **)(in_stack_00000004 + 0x10),0,count);
            crt_memory_c_memset_FUN_005fde40(*(void **)(in_stack_00000004 + 0x14),0,count);
            crt_memory_c_memset_FUN_005fde40(*(void **)(in_stack_00000004 + 0x18),0,count);
            crt_memory_c_memset_FUN_005fde40(*(void **)(in_stack_00000004 + 0x1c),0,count);
            crt_memory_c_memset_FUN_005fde40(*(void **)(in_stack_00000004 + 8),0,in_stack_00000008);
            *(undefined4 *)(in_stack_00000004 + 0x4b30) = 0;
            *(undefined4 *)(in_stack_00000004 + 0x4b34) = 0xffffffff;
            return &DAT_00000001;
          }
        }
      }
...
// Assembly code:
// 00555500: PUSH EBX
//   Label: shape_quantize.cpp_FUN_00555500
// 00555501: PUSH ESI
// 00555502: PUSH EDI
// 00555503: PUSH EBP
