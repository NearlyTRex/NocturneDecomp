...
;                               FUNCTION
; *****************************************************************************
; __cdecl int shape_quantize.cpp_CColorQuantizer_quantizeBitmaps_FUN_005563d0(CColorQuantizer * this_ptr, int bitmap_count, CBitmap * * bitmap_array)
;
; Parameters:
...
section .text
    ...
    PUSH EDI                            ; 005563dc
    CALL shape_quantize.cpp_CColorQuantizer_reset_FUN_00554d40 ; 005563dd | CColorQuantizer * shape_quantize.cpp_CColorQuantizer_reset_FUN_00554d40(CColorQuantizer * this_ptr)
        ;   XREF to: 00554d40 (UNCONDITIONAL_CALL)
    XOR ESI,ESI                         ; 005563e2
    ADD ESP,0x4                         ; 005563e4
    TEST EBP,EBP                        ; 005563e7
    JLE 0x00556401                      ; 005563e9 | LAB_00556401
    ...
    JZ 0x0055643c                       ; 005563f7 | LAB_0055643c
        ;   XREF to: 0055643c (CONDITIONAL_JUMP)
    INC ESI                             ; 005563f9
        ;   Label: LAB_005563f9
    ADD EBX,0x4                         ; 005563fa
    CMP ESI,EBP                         ; 005563fd
    JL 0x005563ef                       ; 005563ff | LAB_005563ef
        ;   XREF to: 005563ef (CONDITIONAL_JUMP)
    PUSH EDI                            ; 00556401
        ;   Label: LAB_00556401
    CALL shape_quantize.cpp_CColorQuantizer_quantize_FUN_00554cc0 ; 00556402 | int shape_quantize.cpp_CColorQuantizer_quantize_FUN_00554cc0(CColorQuantizer * this_ptr)
        ;   XREF to: 00554cc0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00556407
    TEST EAX,EAX                        ; 0055640a
    JZ 0x00556437                       ; 0055640c | LAB_00556437
        ;   XREF to: 00556437 (CONDITIONAL_JUMP)
    XOR ESI,ESI                         ; 0055640e
    TEST EBP,EBP                        ; 00556410
    JLE 0x00556429                      ; 00556412 | LAB_00556429
    ...
    JZ 0x0055644f                       ; 0055641f | LAB_0055644f
        ;   XREF to: 0055644f (CONDITIONAL_JUMP)
    INC ESI                             ; 00556421
        ;   Label: LAB_00556421
    ADD EBX,0x4                         ; 00556422
    CMP ESI,EBP                         ; 00556425
    JL 0x00556418                       ; 00556427 | LAB_00556418
        ;   XREF to: 00556418 (CONDITIONAL_JUMP)
    PUSH EDI                            ; 00556429
        ;   Label: LAB_00556429
    CALL shape_quantize.cpp_CColorQuantizer_reset_FUN_00554d40 ; 0055642a | CColorQuantizer * shape_quantize.cpp_CColorQuantizer_reset_FUN_00554d40(CColorQuantizer * this_ptr)
        ;   XREF to: 00554d40 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0055643c
        ;   Label: LAB_0055643c
    PUSH EDI                            ; 0055643d
    CALL shape_quantize.cpp_CColorQuantizer_importBitmap_FUN_00554a50 ; 0055643e | int shape_quantize.cpp_CColorQuantizer_importBitmap_FUN_00554a50(CColorQuantizer * this_ptr, CBitmap * bitmap)
        ;   XREF to: 00554a50 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00556443
    TEST EAX,EAX                        ; 00556446
    JNZ 0x005563f9                      ; 00556448 | LAB_005563f9
    ...
    PUSH EBX                            ; 0055644f
        ;   Label: LAB_0055644f
    PUSH EDI                            ; 00556450
    CALL shape_quantize.cpp_CColorQuantizer_applyQuantization_FUN_00556180 ; 00556451 | int shape_quantize.cpp_CColorQuantizer_applyQuantization_FUN_00556180(CColorQuantizer * this_ptr, CBitmap * * bitmap_ptr)
        ;   XREF to: 00556180 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00556456
    TEST EAX,EAX                        ; 00556459
    JNZ 0x00556421                      ; 0055645b | LAB_00556421
