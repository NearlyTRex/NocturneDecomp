// Name: shape_superopt.cpp_FUN_005d7000
// Address: 005d7000
// Address Range: [[005d7000, 005d70c5]]
// Convention: unknown
// Signature: undefined shape_superopt.cpp_FUN_005d7000()
// Cross-references:
...
/* Signature: undefined1 shape_superopt.cpp_FUN_005d7000(undefined4 param_1) */

void shape_superopt_cpp_FUN_005d7000(void)

{
  ...
  if (*(int *)(in_stack_00000004 + 0x38) != 0) {
    ...
    do {
      ...
      if (*(int *)(iVar1 + *(int *)(in_stack_00000004 + 0x3c)) != 0) {
        ptr = (void *)shape_superopt_cpp_FUN_005c79d0();
        shape_memdbg_cpp_debugFree_FUN_0050f210(ptr);
      }
      uVar2 = uVar2 + 1;
      iVar1 = iVar1 + 4;
    } while (uVar2 < *(uint *)(in_stack_00000004 + 0x38));
  }
  if (*(void **)(in_stack_00000004 + 0x3c) != (void *)0x0) {
    crt_memory_c_free_FUN_00601cd0(*(void **)(in_stack_00000004 + 0x3c));
  }
  *(undefined4 *)(in_stack_00000004 + 0x3c) = 0;
  *(undefined4 *)(in_stack_00000004 + 0x38) = 0;
  (**(code **)(*(int *)(in_stack_00000004 + 0x40) + 4))();
  (**(code **)(*(int *)(in_stack_00000004 + 0x40) + 0xc))();
  (**(code **)(*(int *)(in_stack_00000004 + 0x40) + 0x14))();
  (**(code **)(*(int *)(in_stack_00000004 + 0x40) + 0x1c))();
  return;
}
...
// Assembly code:
// 005d7000: PUSH EBX
//   Label: shape_superopt.cpp_FUN_005d7000
// 005d7001: PUSH ESI
// 005d7002: PUSH EDI
// 005d7003: PUSH EBP
...
// 005d7008: PUSH ESI
// 005d7009: CALL shape_superopt.cpp_FUN_005d2600
