...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl shape_superopt_cpp_FUN_005c8b50(void)
;
; Local Variables:
...
;
; XREF[1]:
;   shape_superopt.cpp_FUN_005c84c0 at 005c8554
;
; Called Functions:
...
section .text
    ...
    CALL shape_superopt.cpp_FUN_005ca590 ; 005c8cff
    ...
    PUSH ECX                            ; 005c8d1b
    PUSH EBX                            ; 005c8d1c
    CALL shape_superopt.cpp_FUN_005ca590 ; 005c8d1d
        ;   XREF to: 005ca590 (UNCONDITIONAL_CALL)  ; int shape_superopt.cpp_FUN_005ca590()
    ...
    CALL shape_superopt.cpp_FUN_005c9100 ; 005c8d99
        ;   XREF to: 005c9100 (UNCONDITIONAL_CALL)  ; int shape_superopt.cpp_FUN_005c9100()
