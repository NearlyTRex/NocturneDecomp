...
section .text
    ...
    JMP 0x005d581e                      ; 005d5853 | LAB_005d581e
    ...
    JBE 0x005d58f2                      ; 005d5880 | LAB_005d58f2
    ...
    JNZ 0x005d58ce                      ; 005d58a8 | LAB_005d58ce
    ...
    FNSTSW AX                           ; 005d58c5
    SAHF                                ; 005d58c7
    JNC 0x005d5984                      ; 005d58c8 | LAB_005d5984
    ...
    JC 0x005d58a0                       ; 005d58f0 | LAB_005d58a0
    ...
    JBE 0x005d594e                      ; 005d5906 | LAB_005d594e
        ;   XREF to: 005d594e (CONDITIONAL_JUMP)
    TEST byte ptr [EDI + 0x61],0x20     ; 005d5908
        ;   Label: LAB_005d5908
    JZ 0x005d5938                       ; 005d590c | LAB_005d5938
    ...
    JBE 0x005d5938                      ; 005d591e | LAB_005d5938
        ;   XREF to: 005d5938 (CONDITIONAL_JUMP)
    TEST byte ptr [EBX + 0x61],0x20     ; 005d5920
        ;   Label: LAB_005d5920
    JZ 0x005d5b57                       ; 005d5924 | LAB_005d5b57
    ...
    JC 0x005d5920                       ; 005d5936 | LAB_005d5920
    ...
    JC 0x005d5908                       ; 005d594c | LAB_005d5908
    ...
    CALL shape_superopt.cpp_projectPointOntoPlane_FUN_005d63d0 ; 005d59f9 | CVector3d * shape_superopt.cpp_projectPointOntoPlane_FUN_005d63d0(CVector3d * point, CVector3d * plane_point, CVector3d * plane_normal)
    ...
    JZ 0x005d592a                       ; 005d5b64 | LAB_005d592a
