...
// Convention: __cdecl
// Signature: void __cdecl shape_superopt_cpp_COptimize_addComplexPolygon_FUN_005d76e0(COptimize *this_ptr,CComplexPolygon *polygon)
  ...
  if (ppCVar2 != (CComplexPolygon **)0x0) {
    if (polygon == (CComplexPolygon *)0x0) {
      ...
      if (this_ptr_00 != (CComplexPolygon *)0x0) {
        polygon = shape_superopt_cpp_CComplexPolygon_ctor_FUN_005c79a0(this_ptr_00);
      }
      if (polygon == (CComplexPolygon *)0x0) {
        return;
      }
