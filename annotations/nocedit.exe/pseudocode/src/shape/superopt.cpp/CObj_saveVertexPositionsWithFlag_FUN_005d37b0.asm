...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_superopt.cpp_CObj_saveVertexPositionsWithFlag_FUN_005d37b0(CObj * this_ptr, uint flag_mask)
;
; Parameters:
...
section .text
    ...
    JC 0x005d37d0                       ; 005d37e9 | LAB_005d37d0
    ...
    JBE 0x005d3812                      ; 005d37f6 | LAB_005d3812
    ...
    JC 0x005d37fa                       ; 005d3856 | LAB_005d37fa
        ;   XREF to: 005d37fa (CONDITIONAL_JUMP)
    POP EBP                             ; 005d3858
    POP EDI                             ; 005d3859
    POP ESI                             ; 005d385a
