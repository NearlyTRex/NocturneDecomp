// Name: shape_superopt.cpp_CObj_FUN_005d2c40
// Address: 005d2c40
// Address Range: [[005d2c40, 005d2dc6]]
// Convention: __cdecl
// Signature: uint * shape_superopt.cpp_CObj_FUN_005d2c40(CObj * this_ptr)

#include "nocturne.h"

uint * __cdecl shape_superopt_cpp_CObj_FUN_005d2c40(CObj *this_ptr)

{
  ...
  bVar7 = 0;
  pCVar1 = (CObj *)(**(code **)((int)this_ptr->vtable + 4))();
  if (pCVar1 != (CObj *)0x0) {
    uStack_18 = 0;
    pCVar1 = this_ptr;
    ...
    if (this_ptr->field0_0x0 != 0) {
      do {
        ...
        *(CObj **)((int)pdVar3 + 0x14) = pCStack_64;
...
// Assembly code:
// 005d2c40: PUSH EBX
//   Label: shape_superopt.cpp_CObj_FUN_005d2c40
// 005d2c41: PUSH ESI
// 005d2c42: PUSH EDI
// 005d2c43: PUSH EBP
