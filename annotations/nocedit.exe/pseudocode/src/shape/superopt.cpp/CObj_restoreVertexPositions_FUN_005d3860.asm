...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_superopt.cpp_CObj_restoreVertexPositions_FUN_005d3860(CObj * this_ptr)
;
; Parameters:
...
section .text
    ...
    JBE 0x005d38a7                      ; 005d386b | LAB_005d38a7
    ...
    JC 0x005d3871                       ; 005d38a3 | LAB_005d3871
