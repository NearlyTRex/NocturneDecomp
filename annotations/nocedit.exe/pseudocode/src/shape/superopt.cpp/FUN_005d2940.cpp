// Name: shape_superopt.cpp_FUN_005d2940
// Address: 005d2940
// Address Range: [[005d2940, 005d2ab6]]
// Convention: unknown
// Signature: undefined shape_superopt.cpp_FUN_005d2940()

#include "nocturne.h"

/* Signature: undefined1 shape_superopt.cpp_FUN_005d2940(undefined4 param_1, undefined4 param_2,
   undefined4 param_3) */

uint * shape_superopt_cpp_FUN_005d2940(void)

{
  ...
  pdVar6 = (double *)in_stack_00000004[1];
  if (*in_stack_00000004 != 0) {
    do {
      local_90 = *(undefined4 *)in_stack_00000008;
      dVar1 = *in_stack_00000008;
      uStack_8c = *(undefined4 *)((int)in_stack_00000008 + 4);
      local_88 = *(undefined4 *)(in_stack_00000008 + 1);
      dVar2 = in_stack_00000008[1];
      uStack_84 = *(undefined4 *)((int)in_stack_00000008 + 0xc);
      local_78 = *pdVar6 - *in_stack_0000000c;
      local_70 = pdVar6[1] - in_stack_0000000c[1];
      local_80 = *(undefined4 *)(in_stack_00000008 + 2);
      local_68 = pdVar6[2] - in_stack_0000000c[2];
      uStack_7c = *(undefined4 *)((int)in_stack_00000008 + 0x14);
      ...
      local_a8 = local_c0 + *in_stack_0000000c;
      local_a0 = local_b8 + in_stack_0000000c[1];
      local_98 = local_b0 + in_stack_0000000c[2];
      pdVar7 = &local_a8;
      puVar9 = local_30;
      for (iVar5 = 6; iVar5 != 0; iVar5 = iVar5 + -1) {
      ...
      *(undefined4 *)pdVar6 = local_30[0];
      *(undefined4 *)((int)pdVar6 + 4) = local_30[1];
      *(undefined4 *)(pdVar6 + 1) = local_30[2];
      *(undefined4 *)((int)pdVar6 + 0xc) = local_30[3];
      *(undefined4 *)(pdVar6 + 2) = local_20;
      *(uint **)((int)pdVar6 + 0x14) = local_1c;
      local_18 = local_18 + 1;
      puVar4 = local_1c;
      pdVar6 = pdVar6 + 7;
...
// Assembly code:
// 005d2940: PUSH EBX
//   Label: shape_superopt.cpp_FUN_005d2940
// 005d2941: PUSH ESI
// 005d2942: PUSH EDI
// 005d2943: PUSH EBP
