...
// Convention: __cdecl
// Signature: int __cdecl shape_superopt_cpp_EdgeListCheckPlusFreesLarge_FUN_005c84c0(void)
  ...
  if (*(int *)(in_stack_00000004 + 0x2c) != 0) {
    ...
    if (*(int *)(in_stack_00000004 + 0x2c) != 0) {
      ...
      while( true ) {
        ...
        iVar4 = shape_superopt_cpp_ComplexEdgeListSplit_UnevenCheck_FUN_005ca590();
        puVar3 = local_24;
...
LAB_005c8a6e:
          ...
          *(int *)(in_stack_00000004 + 0x2c) = local_28;
          iVar4 = shape_superopt_cpp_EdgeListCheckPlusFreesLarge_FUN_005c84c0();
          if (iVar4 == 0) {
            shape_memdbg_cpp_free_FUN_005fe659(local_20);
            shape_memdbg_cpp_free_FUN_005fe659(local_24);
            return 0;
