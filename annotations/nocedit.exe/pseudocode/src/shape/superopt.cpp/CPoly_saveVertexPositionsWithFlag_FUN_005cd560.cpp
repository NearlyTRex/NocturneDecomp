...
// Convention: __cdecl
// Signature: void shape_superopt.cpp_CPoly_saveVertexPositionsWithFlag_FUN_005cd560(CPoly * this_ptr, uint flag_mask)

#include "nocturne.h"

void __cdecl
shape_superopt_cpp_CPoly_saveVertexPositionsWithFlag_FUN_005cd560(CPoly *this_ptr,uint flag_mask)

{
  ...
  if ((pCVar1->state_flags & flag_mask) == flag_mask) {
    *(undefined4 *)&(pCVar1->orig_position).x = *(undefined4 *)&(pCVar1->position).x;
    *(undefined4 *)((int)&(pCVar1->orig_position).x + 4) =
         *(undefined4 *)((int)&(pCVar1->position).x + 4);
    *(undefined4 *)&(pCVar1->orig_position).y = *(undefined4 *)&(pCVar1->position).y;
    *(undefined4 *)((int)&(pCVar1->orig_position).y + 4) =
         *(undefined4 *)((int)&(pCVar1->position).y + 4);
    *(undefined4 *)&(pCVar1->orig_position).z = *(undefined4 *)&(pCVar1->position).z;
  ...
  *(undefined4 *)&(pCVar2->orig_position).x = *(undefined4 *)&(pCVar2->position).x;
  *(undefined4 *)((int)&(pCVar2->orig_position).x + 4) =
       *(undefined4 *)((int)&(pCVar2->position).x + 4);
  *(undefined4 *)&(pCVar2->orig_position).y = *(undefined4 *)&(pCVar2->position).y;
  *(undefined4 *)((int)&(pCVar2->orig_position).y + 4) =
       *(undefined4 *)((int)&(pCVar2->position).y + 4);
  *(undefined4 *)&(pCVar2->orig_position).z = *(undefined4 *)&(pCVar2->position).z;
