...
section .text
    ...
    PUSH EBX                            ; 005d77a0
        ;   Label: shape_superopt.cpp_optimizeCubeTriList_FUN_005d77a0
    PUSH ESI                            ; 005d77a1
    PUSH EDI                            ; 005d77a2
    PUSH EBP                            ; 005d77a3
    ...
    CALL shape_design.c_removeDegeneratePolygons_FUN_00465310 ; 005d77af
        ;   XREF to: 00465310 (UNCONDITIONAL_CALL)  ; void shape_design.c_removeDegeneratePolygons_FUN_00465310()
    CMP dword ptr [0x016e990c],0x1      ; 005d77b4 | g_PolygonCount
    JL 0x005d77c6                       ; 005d77bb
        ;   XREF to: 005d77c6 (CONDITIONAL_JUMP)  ; LAB_005d77c6
    CMP dword ptr [0x01626408],0x1      ; 005d77bd | g_VertexCount
    JGE 0x005d77cd                      ; 005d77c4
        ;   XREF to: 005d77cd (CONDITIONAL_JUMP)  ; LAB_005d77cd
    ...
    POP EBX                             ; 005d77cb
    RET                                 ; 005d77cc
    MOV EBX,dword ptr [0x03f6bbe4]      ; 005d77cd | INT_03f6bbe4
        ;   Label: LAB_005d77cd
    PUSH EBX                            ; 005d77d3
    ...
    PUSH 0x6547ea                       ; 005d77f0 | = "wt"
    PUSH 0x0                            ; 005d77f5
    LEA EAX,[ESP + 0x78]                ; 005d77f7
    PUSH EAX                            ; 005d77fb
    XOR EDI,EDI                         ; 005d77fc
    CALL shape_memdbg.cpp_openFile_FUN_0050f7a0 ; 005d77fe
        ;   XREF to: 0050f7a0 (UNCONDITIONAL_CALL)  ; _FILE * shape_memdbg.cpp_openFile_FUN_0050f7a0(char * filename, char * directory, char * mode, char * source_file, ...)
    ADD ESP,0x14                        ; 005d7803
    MOV ESI,dword ptr [0x016e990c]      ; 005d7806 | g_PolygonCount
    MOV dword ptr [ESP + 0x14c],EAX     ; 005d780c
    TEST ESI,ESI                        ; 005d7813
    JLE 0x005d7840                      ; 005d7815
        ;   XREF to: 005d7840 (CONDITIONAL_JUMP)  ; LAB_005d7840
    ...
    MOV EDX,dword ptr [EAX + 0x16e99b4] ; 005d782a | g_ModelPolygonData[0].vertex_indices_count | g_ModelPolygonData[1].vertex_indices_count
        ;   Label: LAB_005d782a
    SUB EDX,0x2                         ; 005d7830
    ADD EAX,0x184                       ; 005d7833
    ADD EDI,EDX                         ; 005d7838
    CMP EAX,EBX                         ; 005d783a
    JL 0x005d782a                       ; 005d783c
        ;   XREF to: 005d782a (CONDITIONAL_JUMP)  ; LAB_005d782a
    MOV EAX,EAX                         ; 005d783e
    MOV EAX,dword ptr [ESP + 0x14c]     ; 005d7840
        ;   Label: LAB_005d7840
    TEST EAX,EAX                        ; 005d7847
    JZ 0x005d7876                       ; 005d7849
        ;   XREF to: 005d7876 (CONDITIONAL_JUMP)  ; LAB_005d7876
    PUSH 0x6547ed                       ; 005d784b | = "// npoint, ntri\n"
    PUSH EAX                            ; 005d7850
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 005d7851
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(_FILE * file, char * format)
    ADD ESP,0x8                         ; 005d7856
    PUSH EDI                            ; 005d7859
    MOV ECX,dword ptr [0x01626408]      ; 005d785a | g_VertexCount
    PUSH ECX                            ; 005d7860
    PUSH 0x6547fe                       ; 005d7861 | = "%d %d\n"
    MOV EBX,dword ptr [ESP + 0x158]     ; 005d7866
    PUSH EBX                            ; 005d786d
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 005d786e
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(_FILE * file, char * format)
    ...
    PUSH EAX                            ; 005d7899
    CALL shape_superopt.cpp_CObj_init_FUN_005d22d0 ; 005d789a
    ...
    JZ 0x005d78bb                       ; 005d78ab
        ;   XREF to: 005d78bb (CONDITIONAL_JUMP)  ; LAB_005d78bb
    PUSH 0x654805                       ; 005d78ad | = "// pointList\n"
    PUSH EDI                            ; 005d78b2
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 005d78b3
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(_FILE * file, char * format)
    ADD ESP,0x8                         ; 005d78b8
    MOV EDX,dword ptr [0x01626408]      ; 005d78bb | g_VertexCount
        ;   Label: LAB_005d78bb
    XOR EDI,EDI                         ; 005d78c1
    TEST EDX,EDX                        ; 005d78c3
    JLE 0x005d794f                      ; 005d78c5
        ;   XREF to: 005d794f (CONDITIONAL_JUMP)  ; LAB_005d794f
    XOR EBX,EBX                         ; 005d78cb
    XOR ESI,ESI                         ; 005d78cd
    MOV EAX,dword ptr [ESP + 0x114]     ; 005d78cf
        ;   Label: LAB_005d78cf
    FLD float ptr [EBX + 0x162640c]     ; 005d78d6 | g_LoadedVertices | g_LoadedVertices[1].vertex.x
    MOV ECX,dword ptr [ESP + 0x14c]     ; 005d78dc
    FSTP double ptr [ESI + EAX*0x1]     ; 005d78e3
    MOV EAX,dword ptr [ESP + 0x114]     ; 005d78e6
    FLD float ptr [EBX + 0x1626410]     ; 005d78ed | g_LoadedVertices[0].vertex.y | g_LoadedVertices[1].vertex.y
    FSTP double ptr [ESI + EAX*0x1 + 0x8] ; 005d78f3
    MOV EAX,dword ptr [ESP + 0x114]     ; 005d78f7
    FLD float ptr [EBX + 0x1626414]     ; 005d78fe | g_LoadedVertices[0].vertex.z | g_LoadedVertices[1].vertex.z
    FSTP double ptr [ESI + EAX*0x1 + 0x10] ; 005d7904
    TEST ECX,ECX                        ; 005d7908
    JZ 0x005d793e                       ; 005d790a
        ;   XREF to: 005d793e (CONDITIONAL_JUMP)  ; LAB_005d793e
    SUB ESP,0x8                         ; 005d790c
    FLD float ptr [EBX + 0x1626414]     ; 005d790f | g_LoadedVertices[0].vertex.z | g_LoadedVertices[1].vertex.z
    FSTP double ptr [ESP]               ; 005d7915
    SUB ESP,0x8                         ; 005d7918
    FLD float ptr [EBX + 0x1626410]     ; 005d791b | g_LoadedVertices[0].vertex.y | g_LoadedVertices[1].vertex.y
    FSTP double ptr [ESP]               ; 005d7921
    SUB ESP,0x8                         ; 005d7924
    FLD float ptr [EBX + 0x162640c]     ; 005d7927 | g_LoadedVertices
    FSTP double ptr [ESP]               ; 005d792d
    PUSH 0x654813                       ; 005d7930 | = "%g %g %g\n"
    PUSH ECX                            ; 005d7935
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 005d7936
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(_FILE * file, char * format)
    ADD ESP,0x20                        ; 005d793b
    MOV ECX,dword ptr [0x01626408]      ; 005d793e | g_VertexCount
        ;   Label: LAB_005d793e
    ADD ESI,0x38                        ; 005d7944
    INC EDI                             ; 005d7947
    ADD EBX,0x14                        ; 005d7948
    CMP EDI,ECX                         ; 005d794b
    JL 0x005d78cf                       ; 005d794d
        ;   XREF to: 005d78cf (CONDITIONAL_JUMP)  ; LAB_005d78cf
    MOV EBX,dword ptr [ESP + 0x14c]     ; 005d794f
        ;   Label: LAB_005d794f
    TEST EBX,EBX                        ; 005d7956
    JZ 0x005d7968                       ; 005d7958
        ;   XREF to: 005d7968 (CONDITIONAL_JUMP)  ; LAB_005d7968
    PUSH 0x65481d                       ; 005d795a | = "// triList\n"
    PUSH EBX                            ; 005d795f
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 005d7960
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(_FILE * file, char * format)
    ADD ESP,0x8                         ; 005d7965
    XOR EDI,EDI                         ; 005d7968
        ;   Label: LAB_005d7968
    MOV EDX,dword ptr [0x016e990c]      ; 005d796a | g_PolygonCount
    MOV dword ptr [ESP + 0x138],EDI     ; 005d7970
    MOV dword ptr [ESP + 0x148],EDI     ; 005d7977
    TEST EDX,EDX                        ; 005d797e
    JLE 0x005d7c12                      ; 005d7980
        ;   XREF to: 005d7c12 (CONDITIONAL_JUMP)  ; LAB_005d7c12
    MOV EAX,0x16e9910                   ; 005d7986 | g_ModelPolygonData
    ADD EAX,0x4                         ; 005d798b
    MOV dword ptr [ESP + 0x140],EDI     ; 005d798e
    MOV dword ptr [ESP + 0x13c],EAX     ; 005d7995 | g_ModelPolygonData[0].texture_name[0]
    PUSH 0x0                            ; 005d799c
        ;   Label: LAB_005d799c
    LEA EAX,[ESP + 0x4]                 ; 005d799e
    PUSH EAX                            ; 005d79a2
    CALL shape_superopt.cpp_CPoly_ctor_FUN_005cc620 ; 005d79a3
    ...
    MOV EAX,dword ptr [EAX + 0x16e99c8] ; 005d79bc | g_ModelPolygonData[0].vertex_indices[0]
    MOV dword ptr [ESP + 0x4],EAX       ; 005d79c2
    MOV EAX,dword ptr [ESP + 0x140]     ; 005d79c6
    FLD double ptr [0x0065487a]         ; 005d79cd | DOUBLE_0065487a
    FLD float ptr [EAX + 0x16e9a08]     ; 005d79d3 | g_ModelPolygonData[0].uv_u[0]
    FMUL ST1                            ; 005d79d9
    FLD float ptr [EAX + 0x16e9a48]     ; 005d79db | g_ModelPolygonData[0].uv_v[0]
    FMULP ST2                           ; 005d79e1
    ...
    PUSH EDI                            ; 005d7a06 | g_ModelPolygonData[0].texture_name[0]
        ;   Label: LAB_005d7a06
    PUSH ESI                            ; 005d7a07 | g_TriListTextureNames | g_TriListTextureNames[1][0]
    ...
    JNZ 0x005d7d57                      ; 005d7a12
        ;   XREF to: 005d7d57 (CONDITIONAL_JUMP)  ; LAB_005d7d57
    MOV EAX,EBX                         ; 005d7a18
    MOV EDX,EAX                         ; 005d7a1a
        ;   Label: LAB_005d7a1a
    TEST EAX,EAX                        ; 005d7a1c
    JL 0x005d7d73                       ; 005d7a1e
        ;   XREF to: 005d7d73 (CONDITIONAL_JUMP)  ; LAB_005d7d73
    ...
    CMP dword ptr [EAX + 0x16e99b4],0x2 ; 005d7a5d | g_ModelPolygonData[0].vertex_indices_count
    JLE 0x005d7bbe                      ; 005d7a64
        ;   XREF to: 005d7bbe (CONDITIONAL_JUMP)  ; LAB_005d7bbe
    FLD double ptr [0x0065487a]         ; 005d7a6a | DOUBLE_0065487a
        ;   Label: LAB_005d7a6a
    FLD float ptr [EBX + 0x16e9a04]     ; 005d7a70 | g_ModelPolygonData[0].uv_u[1] | g_ModelPolygonData[0].uv_u[2]
    FMUL ST1                            ; 005d7a76
    FLD float ptr [EBX + 0x16e9a44]     ; 005d7a78 | g_ModelPolygonData[0].uv_v[1] | g_ModelPolygonData[0].uv_v[2]
    FMUL ST2                            ; 005d7a7e
    FLD float ptr [EBX + 0x16e9a08]     ; 005d7a80 | g_ModelPolygonData[0].uv_u[2] | g_ModelPolygonData[0].uv_u[3]
    FMUL ST3                            ; 005d7a86
    FLD float ptr [EBX + 0x16e9a48]     ; 005d7a88 | g_ModelPolygonData[0].uv_v[2] | g_ModelPolygonData[0].uv_v[3]
    FMULP ST4                           ; 005d7a8e
    MOV EAX,dword ptr [EBX + 0x16e99c4] ; 005d7a90 | g_ModelPolygonData[0].vertex_indices[1] | g_ModelPolygonData[0].vertex_indices[2]
    ...
    MOV EAX,dword ptr [EBX + 0x16e99c8] ; 005d7aaf | g_ModelPolygonData[0].vertex_indices[2] | g_ModelPolygonData[0].vertex_indices[3]
    FSTP double ptr [ESP + 0x38]        ; 005d7ab5
    MOV dword ptr [ESP + 0xc],EAX       ; 005d7ab9
    TEST ESI,ESI                        ; 005d7abd
    JZ 0x005d7ada                       ; 005d7abf
        ;   XREF to: 005d7ada (CONDITIONAL_JUMP)  ; LAB_005d7ada
    PUSH EAX                            ; 005d7ac1
    ...
    PUSH ESI                            ; 005d7ad1
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 005d7ad2
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(_FILE * file, char * format)
    ADD ESP,0x14                        ; 005d7ad7
    MOV EAX,ESP                         ; 005d7ada
        ;   Label: LAB_005d7ada
    PUSH EAX                            ; 005d7adc
    CALL shape_superopt.cpp_CPoly_computeNormal_FUN_005cd7d0 ; 005d7add
        ;   XREF to: 005cd7d0 (UNCONDITIONAL_CALL)  ; void shape_superopt.cpp_CPoly_computeNormal_FUN_005cd7d0(CPoly * this_ptr)
    ...
    JMP 0x0060cb4a                      ; 005d7b20
        ;   XREF to: 0060cb4a (UNCONDITIONAL_JUMP)  ; LAB_0060cb4a
    CALL crt_memory.c___arr_op_FUN_006020c2 ; 005d7b27
    ...
    MOV ECX,dword ptr [EDX + 0x16e99b4] ; 005d7ba9 | g_ModelPolygonData[0].vertex_indices_count
    MOV dword ptr [ESP + 0x154],EDI     ; 005d7baf
    CMP EAX,ECX                         ; 005d7bb6
    JL 0x005d7a6a                       ; 005d7bb8
        ;   XREF to: 005d7a6a (CONDITIONAL_JUMP)  ; LAB_005d7a6a
    PUSH 0x0                            ; 005d7bbe
        ;   Label: LAB_005d7bbe
    ...
    ADD EDX,0x184                       ; 005d7be8 | g_ModelPolygonData[1].texture_name[0]
    ADD ECX,0x184                       ; 005d7bee
    INC EBX                             ; 005d7bf4
    MOV dword ptr [ESP + 0x13c],EDX     ; 005d7bf5 | g_ModelPolygonData[1].texture_name[0]
    MOV dword ptr [ESP + 0x140],ECX     ; 005d7bfc
    MOV dword ptr [ESP + 0x138],EBX     ; 005d7c03
    CMP EBX,ESI                         ; 005d7c0a
    JL 0x005d799c                       ; 005d7c0c
        ;   XREF to: 005d799c (CONDITIONAL_JUMP)  ; LAB_005d799c
    MOV EDI,dword ptr [ESP + 0x14c]     ; 005d7c12
        ;   Label: LAB_005d7c12
    TEST EDI,EDI                        ; 005d7c19
    JZ 0x005d7c30                       ; 005d7c1b
        ;   XREF to: 005d7c30 (CONDITIONAL_JUMP)  ; LAB_005d7c30
    PUSH 0x2571                         ; 005d7c1d
    PUSH 0x65485c                       ; 005d7c22 | = "..\\shape\\superopt.cpp"
    PUSH EDI                            ; 005d7c27
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 005d7c28
        ;   XREF to: 0050f9b0 (UNCONDITIONAL_CALL)  ; int shape_memdbg.cpp_closeFile_FUN_0050f9b0(_FILE * file_ptr, char * source_file, int line_number)
    ADD ESP,0xc                         ; 005d7c2d
    LEA EAX,[ESP + 0xcc]                ; 005d7c30
        ;   Label: LAB_005d7c30
    PUSH EAX                            ; 005d7c37
    CALL shape_superopt.cpp_COptimize_ctor_FUN_005d6f90 ; 005d7c38
        ;   XREF to: 005d6f90 (UNCONDITIONAL_CALL)  ; COptimize * shape_superopt.cpp_COptimize_ctor_FUN_005d6f90(COptimize * this_ptr)
    FLD double ptr [0x00654872]         ; 005d7c3d | DOUBLE_00654872
    FCOS                                ; 005d7c43
    ...
    CALL shape_superopt.cpp_COptimize_setWeldThreshold_FUN_005d70d0 ; 005d7c65
        ;   XREF to: 005d70d0 (UNCONDITIONAL_CALL)  ; void shape_superopt.cpp_COptimize_setWeldThreshold_FUN_005d70d0(COptimize * this_ptr, double threshold)
    ...
    PUSH EAX                            ; 005d7c84
    CALL shape_superopt.cpp_COptimize_setCoplanarAngleThreshold_FUN_005d7120 ; 005d7c85
        ;   XREF to: 005d7120 (UNCONDITIONAL_CALL)  ; void shape_superopt.cpp_COptimize_setCoplanarAngleThreshold_FUN_005d7120(COptimize * this_ptr, double threshold)
    ADD ESP,0xc                         ; 005d7c8a
    PUSH 0x3f847ae1                     ; 005d7c8d
    PUSH 0x47ae147b                     ; 005d7c92
    LEA EAX,[ESP + 0xd4]                ; 005d7c97
    PUSH EAX                            ; 005d7c9e
    CALL shape_superopt.cpp_COptimize_setCoplanarDistanceThreshold_FUN_005d7170 ; 005d7c9f
        ;   XREF to: 005d7170 (UNCONDITIONAL_CALL)  ; void shape_superopt.cpp_COptimize_setCoplanarDistanceThreshold_FUN_005d7170(COptimize * this_ptr, double threshold)
    ADD ESP,0xc                         ; 005d7ca4
    PUSH 0x4                            ; 005d7ca7
    LEA EAX,[ESP + 0xd0]                ; 005d7ca9
    PUSH EAX                            ; 005d7cb0
    CALL shape_superopt.cpp_COptimize_setMaxPolygonSides_FUN_005d71c0 ; 005d7cb1
        ;   XREF to: 005d71c0 (UNCONDITIONAL_CALL)  ; void shape_superopt.cpp_COptimize_setMaxPolygonSides_FUN_005d71c0(COptimize * this_ptr, int max_sides)
    ...
    PUSH EAX                            ; 005d7cca
    CALL shape_superopt.cpp_COptimize_setGeometry_FUN_005d71e0 ; 005d7ccb
        ;   XREF to: 005d71e0 (UNCONDITIONAL_CALL)  ; int shape_superopt.cpp_COptimize_setGeometry_FUN_005d71e0(COptimize * this_ptr, CObj * objects, uint object_count)
    ADD ESP,0xc                         ; 005d7cd0
    LEA EAX,[ESP + 0xcc]                ; 005d7cd3
    PUSH EAX                            ; 005d7cda
    CALL shape_superopt.cpp_COptimize_optimize_FUN_005d7290 ; 005d7cdb
        ;   XREF to: 005d7290 (UNCONDITIONAL_CALL)  ; int shape_superopt.cpp_COptimize_optimize_FUN_005d7290(COptimize * this_ptr)
    ADD ESP,0x4                         ; 005d7ce0
    TEST EAX,EAX                        ; 005d7ce3
    JZ 0x005d7dda                       ; 005d7ce5
        ;   XREF to: 005d7dda (CONDITIONAL_JUMP)  ; LAB_005d7dda
    LEA EAX,[ESP + 0xcc]                ; 005d7ceb
    PUSH EAX                            ; 005d7cf2
    CALL shape_superopt.cpp_COptimize_exportOptimizeGeometry_FUN_005d7e00 ; 005d7cf3
        ;   XREF to: 005d7e00 (UNCONDITIONAL_CALL)  ; void shape_superopt.cpp_COptimize_exportOptimizeGeometry_FUN_005d7e00(COptimize * this_ptr)
    ...
    PUSH EAX                            ; 005d7d13
    CALL crt_stdio.c_remove_FUN_005ff9d0 ; 005d7d14
    ...
    LEA EAX,[ESP + 0x110]               ; 005d7d1c
        ;   Label: LAB_005d7d1c
    PUSH EAX                            ; 005d7d23
    CALL shape_superopt.cpp_CObj_free_FUN_005d2600 ; 005d7d24
    ...
    JL 0x005d7a06                       ; 005d7d63
        ;   XREF to: 005d7a06 (CONDITIONAL_JUMP)  ; LAB_005d7a06
    ...
    MOV EBX,0x654829                    ; 005d7d7c | = "..\\shape\\superopt.cpp"
    MOV ESI,0x255b                      ; 005d7d81
    PUSH 0x65483f                       ; 005d7d86 | = "Too many textures!"
    MOV dword ptr [0x02f0ca48],EBX      ; 005d7d8b | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 005d7d91 | g_CurrentLineNumber
    ...
    PUSH EDI                            ; 005d7db5
    MOV AL,byte ptr [ESI]               ; 005d7db6 | g_ModelPolygonData[0].texture_name[0] | g_ModelPolygonData[0].texture_name[2]
        ;   Label: LAB_005d7db6
    MOV byte ptr [EDI],AL               ; 005d7db8 | g_TriListTextureNames | g_TriListTextureNames[0][2]
    CMP AL,0x0                          ; 005d7dba
    JZ 0x005d7dce                       ; 005d7dbc
        ;   XREF to: 005d7dce (CONDITIONAL_JUMP)  ; LAB_005d7dce
    MOV AL,byte ptr [ESI + 0x1]         ; 005d7dbe | g_ModelPolygonData[0].texture_name[1] | g_ModelPolygonData[0].texture_name[3]
    ADD ESI,0x2                         ; 005d7dc1
    MOV byte ptr [EDI + 0x1],AL         ; 005d7dc4 | g_TriListTextureNames[0][1] | g_TriListTextureNames[0][3]
    ADD EDI,0x2                         ; 005d7dc7
    CMP AL,0x0                          ; 005d7dca
    JNZ 0x005d7db6                      ; 005d7dcc
    ...
    CALL shape_design.c_optimizePolygonMesh_FUN_004658e0 ; 005d7de2
    ...
    MOV EBX,dword ptr [0x03f6bbe4]      ; 005d7de7 | INT_03f6bbe4
    INC EBX                             ; 005d7ded
    ADD ESP,0xc                         ; 005d7dee
    MOV dword ptr [0x03f6bbe4],EBX      ; 005d7df1 | INT_03f6bbe4
    JMP 0x005d7d1c                      ; 005d7df7
        ;   XREF to: 005d7d1c (UNCONDITIONAL_JUMP)  ; LAB_005d7d1c
    LEA EDI,[EDI + 0x4]                 ; 0060cb4a
        ;   Label: LAB_0060cb4a
    PUSH EAX                            ; 0060cb4d
    MOV ECX,dword ptr [ESI]             ; 0060cb4e
    MOV dword ptr [EDI],ECX             ; 0060cb50
    MOV ECX,dword ptr [ESI + 0x4]       ; 0060cb52
    MOV dword ptr [EDI + 0x4],ECX       ; 0060cb55
    MOV ECX,dword ptr [ESI + 0x8]       ; 0060cb58
    MOV dword ptr [EDI + 0x8],ECX       ; 0060cb5b
    ADD ESI,0xc                         ; 0060cb5e
    ADD EDI,0xc                         ; 0060cb61
    JMP 0x005d7b27                      ; 0060cb64
        ;   XREF to: 005d7b27 (UNCONDITIONAL_JUMP)  ; LAB_005d7b27
