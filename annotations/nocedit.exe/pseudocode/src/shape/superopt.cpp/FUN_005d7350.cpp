// Name: shape_superopt.cpp_FUN_005d7350
// Address: 005d7350
// Address Range: [[005d7350, 005d745f]]
// Convention: unknown
// Signature: undefined shape_superopt.cpp_FUN_005d7350()
// Globals:
...
/* Signature: undefined1 shape_superopt.cpp_FUN_005d7350(undefined4 param_1) */

undefined4 shape_superopt_cpp_FUN_005d7350(void)

{
  ...
  do {
    ...
    if (*(int *)(in_stack_00000004 + 8) != 0) {
      ...
      do {
        if ((*(byte *)(iVar3 + 0x61) & 0x80) == 0) break;
        uVar5 = uVar5 + 1;
        iVar3 = iVar3 + 0x68;
      } while (uVar5 < *(uint *)(in_stack_00000004 + 8));
    }
    if (uVar5 == *(uint *)(in_stack_00000004 + 8)) {
      return 1;
    }
    iVar3 = (**(code **)(*(int *)(in_stack_00000004 + 0x40) + 0x38))();
    if (iVar3 == 0) {
      shape_superopt_cpp_SomethingAboutLogTXTCreate_FUN_005c7910();
      return 0;
    }
    uVar5 = 0;
    (**(code **)(*(int *)(in_stack_00000004 + 0x40) + 0x30))();
    if (*(int *)(in_stack_00000004 + 8) != 0) {
      iVar3 = 0;
      do {
        iVar4 = *(int *)(in_stack_00000004 + 0xc) + iVar3;
        if ((*(byte *)(iVar4 + 0x61) & 0x20) != 0) {
          iVar2 = shape_superopt_cpp_FUN_005c7a90();
          if (iVar2 == 0) {
            shape_superopt_cpp_SomethingAboutLogTXTCreate_FUN_005c7910();
            return 0;
          }
          bVar1 = *(byte *)(iVar4 + 0x61);
          *(byte *)(iVar4 + 0x61) = bVar1 | 0x80;
          *(byte *)(iVar4 + 0x61) = bVar1 & 0xdf | 0x80;
        }
        uVar5 = uVar5 + 1;
        iVar3 = iVar3 + 0x68;
      } while (uVar5 < *(uint *)(in_stack_00000004 + 8));
    }
    iVar3 = shape_superopt_cpp_FUN_005c7b20();
    if (iVar3 == 0) {
      shape_superopt_cpp_SomethingAboutLogTXTCreate_FUN_005c7910();
      return 0;
    }
...
// Assembly code:
// 005d7350: PUSH EBX
//   Label: shape_superopt.cpp_FUN_005d7350
// 005d7351: PUSH ESI
// 005d7352: PUSH EDI
// 005d7353: PUSH EBP
...
// 005d7360: PUSH EDI
// 005d7361: CALL shape_superopt.cpp_FUN_005d35e0
...
// 005d7420: CALL shape_superopt.cpp_SomethingAboutLogTXTCreate_FUN_005c7910
...
// 005d7437: CALL shape_superopt.cpp_SomethingAboutLogTXTCreate_FUN_005c7910
//   XREF to: 005c7910 (UNCONDITIONAL_CALL)
...
// 005d744e: CALL shape_superopt.cpp_SomethingAboutLogTXTCreate_FUN_005c7910
//   XREF to: 005c7910 (UNCONDITIONAL_CALL)
