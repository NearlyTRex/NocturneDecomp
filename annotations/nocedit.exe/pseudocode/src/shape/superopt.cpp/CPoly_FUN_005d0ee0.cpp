// Name: shape_superopt.cpp_CPoly_FUN_005d0ee0
// Address: 005d0ee0
// Address Range: [[005d0ee0, 005d122b]]
// Convention: __cdecl
// Signature: int shape_superopt.cpp_CPoly_FUN_005d0ee0(CPoly * this_ptr)
// Globals:
//   double DOUBLE_00654312 = 0.00390625

#include "nocturne.h"

int __cdecl shape_superopt_cpp_CPoly_FUN_005d0ee0(CPoly *this_ptr)

{
  ...
  if (((((((*piVar1 != *(int *)(in_stack_00000008 + 8)) || (*piVar2 != this_ptr->vertex_idx_1)) ||
         (dVar3 = *(double *)(in_stack_00000008 + 0x20) - pCVar6->x,
         dVar4 = *(double *)(in_stack_00000008 + 0x28) - this_ptr->uv_coords[0].y,
         DOUBLE_00654312 <= SQRT(dVar4 * dVar4 + dVar3 * dVar3))) ||
        (dVar3 = *pdVar5 - this_ptr->uv_coords[1].x,
        dVar4 = *(double *)(in_stack_00000008 + 0x18) - this_ptr->uv_coords[1].y,
        DOUBLE_00654312 <= SQRT(dVar4 * dVar4 + dVar3 * dVar3))) &&
       (((*(int *)(in_stack_00000008 + 0xc) != *piVar1 ||
         (*(int *)(in_stack_00000008 + 8) != this_ptr->vertex_idx_1)) ||
        ((dVar3 = *(double *)(in_stack_00000008 + 0x30) - pCVar6->x,
         dVar4 = *(double *)(in_stack_00000008 + 0x38) - this_ptr->uv_coords[0].y,
         0.00390625 <= SQRT(dVar4 * dVar4 + dVar3 * dVar3) ||
         (dVar3 = *(double *)(in_stack_00000008 + 0x20) - this_ptr->uv_coords[1].x,
         dVar4 = *(double *)(in_stack_00000008 + 0x28) - this_ptr->uv_coords[1].y,
         0.00390625 <= SQRT(dVar4 * dVar4 + dVar3 * dVar3))))))) &&
      ((((((*piVar2 != *piVar1 || (*(int *)(in_stack_00000008 + 0xc) != this_ptr->vertex_idx_1)) ||
          ((dVar3 = *pdVar5 - pCVar6->x,
           dVar4 = *(double *)(in_stack_00000008 + 0x18) - this_ptr->uv_coords[0].y,
           0.00390625 <= SQRT(dVar4 * dVar4 + dVar3 * dVar3) ||
           (dVar3 = *(double *)(in_stack_00000008 + 0x30) - this_ptr->uv_coords[1].x,
           dVar4 = *(double *)(in_stack_00000008 + 0x38) - this_ptr->uv_coords[1].y,
           0.00390625 <= SQRT(dVar4 * dVar4 + dVar3 * dVar3))))) &&
         (((((*(int *)(in_stack_00000008 + 0xc) != this_ptr->vertex_idx_1 ||
            ...
            dVar4 = *(double *)(in_stack_00000008 + 0x38) - this_ptr->uv_coords[1].y,
            0.00390625 <= SQRT(dVar4 * dVar4 + dVar3 * dVar3))) ||
           (dVar3 = *(double *)(in_stack_00000008 + 0x20) - this_ptr->uv_coords[2].x,
           dVar4 = *(double *)(in_stack_00000008 + 0x28) - this_ptr->uv_coords[2].y,
           0.00390625 <= SQRT(dVar4 * dVar4 + dVar3 * dVar3))) &&
          (((*piVar2 != this_ptr->vertex_idx_1 ||
           ...
           ((dVar3 = *pdVar5 - this_ptr->uv_coords[1].x,
            dVar4 = *(double *)(in_stack_00000008 + 0x18) - this_ptr->uv_coords[1].y,
            0.00390625 <= SQRT(dVar4 * dVar4 + dVar3 * dVar3) ||
            (dVar3 = *(double *)(in_stack_00000008 + 0x30) - this_ptr->uv_coords[2].x,
            dVar4 = *(double *)(in_stack_00000008 + 0x38) - this_ptr->uv_coords[2].y,
            0.00390625 <= SQRT(dVar4 * dVar4 + dVar3 * dVar3))))))))) &&
        (((*(int *)(in_stack_00000008 + 8) != this_ptr->vertex_idx_1 ||
         ...
         ((dVar3 = *(double *)(in_stack_00000008 + 0x20) - this_ptr->uv_coords[1].x,
          dVar4 = *(double *)(in_stack_00000008 + 0x28) - this_ptr->uv_coords[1].y,
          0.00390625 <= SQRT(dVar4 * dVar4 + dVar3 * dVar3) ||
          (dVar3 = *pdVar5 - this_ptr->uv_coords[2].x,
          dVar4 = *(double *)(in_stack_00000008 + 0x18) - this_ptr->uv_coords[2].y,
          0.00390625 <= SQRT(dVar4 * dVar4 + dVar3 * dVar3))))))) &&
...
// Assembly code:
// 005d0ee0: PUSH EBX
//   Label: shape_superopt.cpp_CPoly_FUN_005d0ee0
// 005d0ee1: PUSH ESI
// 005d0ee2: PUSH EDI
// 005d0ee3: PUSH EBP
