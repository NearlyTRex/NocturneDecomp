...
; CVector3d *      Stack[0x8]:4   output_normal
; SExpandedEdge *  Stack[0xc]:4   edges
...
;
; XREF[1]:
;   shape_superopt.cpp_CComplexPolygon_isConvex_FUN_005cb3a0 at 005cb3c0
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 005cbb40
        ;   Label: shape_superopt.cpp_CComplexPolygon_computeWindingNormal_FUN_005cbb40
    PUSH ESI                            ; 005cbb41
    PUSH EDI                            ; 005cbb42
    PUSH EBP                            ; 005cbb43
