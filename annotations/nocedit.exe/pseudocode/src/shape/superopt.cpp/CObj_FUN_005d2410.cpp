// Name: shape_superopt.cpp_CObj_FUN_005d2410
// Address: 005d2410
// Address Range: [[005d2410, 005d24fe]]
// Convention: __cdecl
// Signature: int shape_superopt.cpp_CObj_FUN_005d2410(CObj * this_ptr)
// Globals:
...
int __cdecl shape_superopt_cpp_CObj_FUN_005d2410(CObj *this_ptr)
  ...
  if (pCVar1 != (CPoly *)0x0) {
    ...
    for (local_10 = this_ptr->count; uVar4 = this_ptr->count + in_stack_00000008, local_10 < uVar4;
      ...
      for (iVar2 = 0; iVar2 != 0; iVar2 = iVar2 + -1) {
        *(undefined1 *)puVar5 = *(undefined1 *)&pCVar1->parent_obj;
...
// Assembly code:
// 005d2410: PUSH EBX
//   Label: shape_superopt.cpp_CObj_FUN_005d2410
// 005d2411: PUSH ESI
// 005d2412: PUSH EBP
...
// 005d24cb: CALL shape_superopt.cpp_logToFile_FUN_005c7910
