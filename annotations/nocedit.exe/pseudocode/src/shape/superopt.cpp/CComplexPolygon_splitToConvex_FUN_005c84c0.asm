...
; double           Stack[-0xf4]:8  local_f4
; double           Stack[-0xec]:8  local_ec
; double           Stack[-0xe4]:8  local_e4
...
;   shape_superopt.cpp_CComplexPolygon_findBestSplitEdge_FUN_005c8e70
;   shape_superopt.cpp_CComplexPolygon_findReflexVertex_FUN_005c8b50
;   shape_superopt.cpp_CComplexPolygon_processEdgeSubLoops_FUN_005c91e0
...
section .text
    ...
    PUSH EBX                            ; 005c84c0
        ;   Label: shape_superopt.cpp_CComplexPolygon_splitToConvex_FUN_005c84c0
    PUSH ESI                            ; 005c84c1
    PUSH EDI                            ; 005c84c2
    PUSH EBP                            ; 005c84c3
    ...
    PUSH ECX                            ; 005c84ef
    PUSH EBX                            ; 005c84f0
    CALL shape_superopt.cpp_CComplexPolygon_processEdgeSubLoops_FUN_005c91e0 ; 005c84f1
        ;   XREF to: 005c91e0 (UNCONDITIONAL_CALL)  ; int shape_superopt.cpp_CComplexPolygon_processEdgeSubLoops_FUN_005c91e0(CComplexPolygon * this_ptr, SExpandedEdge * edges, int * edge_count_ptr)
    ...
    PUSH EAX                            ; 005c8510
    CALL shape_memdbg.cpp_malloc_FUN_006021da ; 005c8511
    ...
    PUSH EAX                            ; 005c8531
    CALL shape_memdbg.cpp_malloc_FUN_006021da ; 005c8532
        ;   XREF to: 006021da (UNCONDITIONAL_CALL)  ; void * shape_memdbg.cpp_malloc_FUN_006021da(SIZE_T size)
    ...
    CALL shape_superopt.cpp_CComplexPolygon_splitEdgesByPlane_FUN_005c9aa0 ; 005c86b7
    ...
    PUSH EAX                            ; 005c86dd
    PUSH EBX                            ; 005c86de
    CALL shape_superopt.cpp_CComplexPolygon_closeSplitBoundary_FUN_005ca590 ; 005c86df
    ...
    PUSH ESI                            ; 005c86f8
    PUSH EBX                            ; 005c86f9
    CALL shape_superopt.cpp_CComplexPolygon_closeSplitBoundary_FUN_005ca590 ; 005c86fa
        ;   XREF to: 005ca590 (UNCONDITIONAL_CALL)  ; int shape_superopt.cpp_CComplexPolygon_closeSplitBoundary_FUN_005ca590(CComplexPolygon * this_ptr, SExpandedEdge * edges, int * edge_count_ptr, int is_secondary)
    ...
    PUSH EDX                            ; 005c8711
    PUSH EBX                            ; 005c8712
    CALL shape_superopt.cpp_CComplexPolygon_processEdgeSubLoops_FUN_005c91e0 ; 005c8713
        ;   XREF to: 005c91e0 (UNCONDITIONAL_CALL)  ; int shape_superopt.cpp_CComplexPolygon_processEdgeSubLoops_FUN_005c91e0(CComplexPolygon * this_ptr, SExpandedEdge * edges, int * edge_count_ptr)
    ...
    PUSH ESI                            ; 005c8727
    PUSH EBX                            ; 005c8728
    CALL shape_superopt.cpp_CComplexPolygon_processEdgeSubLoops_FUN_005c91e0 ; 005c8729
        ;   XREF to: 005c91e0 (UNCONDITIONAL_CALL)  ; int shape_superopt.cpp_CComplexPolygon_processEdgeSubLoops_FUN_005c91e0(CComplexPolygon * this_ptr, SExpandedEdge * edges, int * edge_count_ptr)
    ...
    PUSH EDI                            ; 005c8782
        ;   Label: LAB_005c8782
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 005c8783
    ...
    CALL shape_superopt.cpp_CComplexPolygon_splitEdgesByPlane_FUN_005c9aa0 ; 005c890d
        ;   XREF to: 005c9aa0 (UNCONDITIONAL_CALL)  ; void shape_superopt.cpp_CComplexPolygon_splitEdgesByPlane_FUN_005c9aa0(CComplexPolygon * this_ptr, CVector3d * plane_normal, CVector3d * plane_point, SExpandedEdge * buf_a, ...)
    ...
    PUSH EAX                            ; 005c8933
    PUSH EBX                            ; 005c8934
    CALL shape_superopt.cpp_CComplexPolygon_closeSplitBoundary_FUN_005ca590 ; 005c8935
        ;   XREF to: 005ca590 (UNCONDITIONAL_CALL)  ; int shape_superopt.cpp_CComplexPolygon_closeSplitBoundary_FUN_005ca590(CComplexPolygon * this_ptr, SExpandedEdge * edges, int * edge_count_ptr, int is_secondary)
    ...
    PUSH ESI                            ; 005c894e
    PUSH EBX                            ; 005c894f
    CALL shape_superopt.cpp_CComplexPolygon_closeSplitBoundary_FUN_005ca590 ; 005c8950
        ;   XREF to: 005ca590 (UNCONDITIONAL_CALL)  ; int shape_superopt.cpp_CComplexPolygon_closeSplitBoundary_FUN_005ca590(CComplexPolygon * this_ptr, SExpandedEdge * edges, int * edge_count_ptr, int is_secondary)
    ...
    CALL shape_superopt.cpp_CComplexPolygon_splitToConvex_FUN_005c84c0 ; 005c899e
        ;   XREF to: 005c84c0 (UNCONDITIONAL_CALL)  ; int shape_superopt.cpp_CComplexPolygon_splitToConvex_FUN_005c84c0(CComplexPolygon * this_ptr)
    ...
    CALL shape_superopt.cpp_CComplexPolygon_splitToConvex_FUN_005c84c0 ; 005c89da
        ;   XREF to: 005c84c0 (UNCONDITIONAL_CALL)  ; int shape_superopt.cpp_CComplexPolygon_splitToConvex_FUN_005c84c0(CComplexPolygon * this_ptr)
    ...
    MOV EBX,dword ptr [EBP + 0x6e]      ; 005c89e6
        ;   Label: LAB_005c89e6
    PUSH EBX                            ; 005c89e9
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 005c89ea
        ;   XREF to: 005fe659 (UNCONDITIONAL_CALL)  ; void shape_memdbg.cpp_free_FUN_005fe659(void * ptr)
    ADD ESP,0x4                         ; 005c89ef
    MOV ESI,dword ptr [EBP + 0x6a]      ; 005c89f2
    PUSH ESI                            ; 005c89f5
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 005c89f6
        ;   XREF to: 005fe659 (UNCONDITIONAL_CALL)  ; void shape_memdbg.cpp_free_FUN_005fe659(void * ptr)
    ...
    MOV EBX,dword ptr [EBP + 0x6e]      ; 005c8a0b
        ;   Label: LAB_005c8a0b
    PUSH EBX                            ; 005c8a0e
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 005c8a0f
        ;   XREF to: 005fe659 (UNCONDITIONAL_CALL)  ; void shape_memdbg.cpp_free_FUN_005fe659(void * ptr)
    ADD ESP,0x4                         ; 005c8a14
    PUSH EDI                            ; 005c8a17
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 005c8a18
        ;   XREF to: 005fe659 (UNCONDITIONAL_CALL)  ; void shape_memdbg.cpp_free_FUN_005fe659(void * ptr)
    ...
    MOV EBX,dword ptr [EBP + 0x6e]      ; 005c8a2a
        ;   Label: LAB_005c8a2a
    PUSH EBX                            ; 005c8a2d
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 005c8a2e
        ;   XREF to: 005fe659 (UNCONDITIONAL_CALL)  ; void shape_memdbg.cpp_free_FUN_005fe659(void * ptr)
    ADD ESP,0x4                         ; 005c8a33
    MOV ESI,dword ptr [EBP + 0x6a]      ; 005c8a36
    PUSH ESI                            ; 005c8a39
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 005c8a3a
        ;   XREF to: 005fe659 (UNCONDITIONAL_CALL)  ; void shape_memdbg.cpp_free_FUN_005fe659(void * ptr)
    ...
    MOV EDX,dword ptr [EBP + 0x6e]      ; 005c8a4c
        ;   Label: LAB_005c8a4c
    PUSH EDX                            ; 005c8a4f
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 005c8a50
        ;   XREF to: 005fe659 (UNCONDITIONAL_CALL)  ; void shape_memdbg.cpp_free_FUN_005fe659(void * ptr)
    ADD ESP,0x4                         ; 005c8a55
    MOV ECX,dword ptr [EBP + 0x6a]      ; 005c8a58
    PUSH ECX                            ; 005c8a5b
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 005c8a5c
        ;   XREF to: 005fe659 (UNCONDITIONAL_CALL)  ; void shape_memdbg.cpp_free_FUN_005fe659(void * ptr)
    ...
    MOV EDI,dword ptr [EBP + 0x6e]      ; 005c8a6e
        ;   Label: LAB_005c8a6e
    PUSH EDI                            ; 005c8a71
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 005c8a72
        ;   XREF to: 005fe659 (UNCONDITIONAL_CALL)  ; void shape_memdbg.cpp_free_FUN_005fe659(void * ptr)
    ADD ESP,0x4                         ; 005c8a77
    PUSH ESI                            ; 005c8a7a
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 005c8a7b
        ;   XREF to: 005fe659 (UNCONDITIONAL_CALL)  ; void shape_memdbg.cpp_free_FUN_005fe659(void * ptr)
    ...
    MOV EDI,dword ptr [EBP + 0x6e]      ; 005c8a8d
        ;   Label: LAB_005c8a8d
    PUSH EDI                            ; 005c8a90
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 005c8a91
        ;   XREF to: 005fe659 (UNCONDITIONAL_CALL)  ; void shape_memdbg.cpp_free_FUN_005fe659(void * ptr)
    ADD ESP,0x4                         ; 005c8a96
    MOV EAX,dword ptr [EBP + 0x6a]      ; 005c8a99
    PUSH EAX                            ; 005c8a9c
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 005c8a9d
        ;   XREF to: 005fe659 (UNCONDITIONAL_CALL)  ; void shape_memdbg.cpp_free_FUN_005fe659(void * ptr)
    ...
    MOV ECX,dword ptr [EBP + 0x6e]      ; 005c8aaf
        ;   Label: LAB_005c8aaf
    PUSH ECX                            ; 005c8ab2
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 005c8ab3
        ;   XREF to: 005fe659 (UNCONDITIONAL_CALL)  ; void shape_memdbg.cpp_free_FUN_005fe659(void * ptr)
    ADD ESP,0x4                         ; 005c8ab8
    MOV EBX,dword ptr [EBP + 0x6a]      ; 005c8abb
    PUSH EBX                            ; 005c8abe
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 005c8abf
        ;   XREF to: 005fe659 (UNCONDITIONAL_CALL)  ; void shape_memdbg.cpp_free_FUN_005fe659(void * ptr)
    ...
    MOV ECX,dword ptr [EBP + 0x6e]      ; 005c8ad1
        ;   Label: LAB_005c8ad1
    PUSH ECX                            ; 005c8ad4
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 005c8ad5
        ;   XREF to: 005fe659 (UNCONDITIONAL_CALL)  ; void shape_memdbg.cpp_free_FUN_005fe659(void * ptr)
    ADD ESP,0x4                         ; 005c8ada
    PUSH ESI                            ; 005c8add
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 005c8ade
        ;   XREF to: 005fe659 (UNCONDITIONAL_CALL)  ; void shape_memdbg.cpp_free_FUN_005fe659(void * ptr)
    ...
    MOV EAX,dword ptr [EBP + 0x6e]      ; 005c8aff
        ;   Label: LAB_005c8aff
    PUSH EAX                            ; 005c8b02
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 005c8b03
        ;   XREF to: 005fe659 (UNCONDITIONAL_CALL)  ; void shape_memdbg.cpp_free_FUN_005fe659(void * ptr)
    ADD ESP,0x4                         ; 005c8b08
    MOV EDX,dword ptr [EBP + 0x6a]      ; 005c8b0b
    PUSH EDX                            ; 005c8b0e
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 005c8b0f
        ;   XREF to: 005fe659 (UNCONDITIONAL_CALL)  ; void shape_memdbg.cpp_free_FUN_005fe659(void * ptr)
