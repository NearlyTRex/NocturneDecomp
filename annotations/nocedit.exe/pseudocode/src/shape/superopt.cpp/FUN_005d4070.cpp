// Name: shape_superopt.cpp_FUN_005d4070
// Address: 005d4070
// Address Range: [[005d4070, 005d4101]]
// Convention: unknown
// Signature: undefined shape_superopt.cpp_FUN_005d4070()

#include "nocturne.h"

/* Signature: undefined1 shape_superopt.cpp_FUN_005d4070(undefined4 param_1) */

undefined4 shape_superopt_cpp_FUN_005d4070(void)
  ...
  if (*(int *)(in_stack_00000004 + 8) != 0) {
    do {
      ...
      if (*(int *)(in_stack_00000004 + 8) != 0) {
        iVar3 = 0;
        do {
          iVar1 = (**(code **)(*(int *)(*(int *)(in_stack_00000004 + 0xc) + iVar3 + 100) + 0x70))();
          if ((iVar1 != 0) && (iVar2 = iVar2 + 1, iVar2 == 3)) break;
          uVar4 = uVar4 + 1;
          iVar3 = iVar3 + 0x68;
        } while (uVar4 < *(uint *)(in_stack_00000004 + 8));
      }
      if (iVar2 != 3) {
        return 0;
      }
      local_18 = local_18 + 1;
    } while (local_18 < *(uint *)(in_stack_00000004 + 8));
  }
  return 1;
}
...
// Assembly code:
// 005d4070: PUSH EBX
//   Label: shape_superopt.cpp_FUN_005d4070
// 005d4071: PUSH ESI
// 005d4072: PUSH EDI
// 005d4073: PUSH EBP
