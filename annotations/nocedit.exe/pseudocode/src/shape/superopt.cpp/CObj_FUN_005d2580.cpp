// Name: shape_superopt.cpp_CObj_FUN_005d2580
// Address: 005d2580
// Address Range: [[005d2580, 005d25f8]]
// Convention: __cdecl
// Signature: int shape_superopt.cpp_CObj_FUN_005d2580(CObj * this_ptr)
// Globals:
...
int __cdecl shape_superopt_cpp_CObj_FUN_005d2580(CObj *this_ptr)

{
  ...
  pvVar1 = crt_memory_c_realloc_FUN_00601df0
                     (this_ptr->vertex_data,(this_ptr->field0_0x0 + in_stack_00000008) * 0x38);
  if (pvVar1 != (void *)0x0) {
    this_ptr->vertex_data = pvVar1;
    crt_memory_c_memset_FUN_005fde40
              ((void *)((int)this_ptr->vertex_data + this_ptr->field0_0x0 * 0x38),0,
               in_stack_00000008 * 0x38);
    this_ptr->field0_0x0 = this_ptr->field0_0x0 + in_stack_00000008;
    return 1;
  }
...
// Assembly code:
// 005d2580: PUSH EBX
//   Label: shape_superopt.cpp_CObj_FUN_005d2580
// 005d2581: PUSH ESI
