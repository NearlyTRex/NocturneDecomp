// Name: shape_superopt.cpp_FUN_005cd1a0
// Address: 005cd1a0
// Address Range: [[005cd1a0, 005cd21f]]
// Convention: unknown
// Signature: undefined shape_superopt.cpp_FUN_005cd1a0()

#include "nocturne.h"

/* Signature: undefined1 shape_superopt.cpp_FUN_005cd1a0(undefined4 param_1, undefined4 param_2) */

void shape_superopt_cpp_FUN_005cd1a0(void)

{
  ...
  iVar1 = iVar2 + in_stack_00000004[1] * 0x38;
  uVar3 = ~in_stack_00000008;
  *(uint *)(iVar1 + 0x30) =
       ~(*(uint *)(iVar1 + 0x30) & in_stack_00000008) & in_stack_00000008 |
       *(uint *)(iVar1 + 0x30) & uVar3;
  iVar1 = iVar2 + in_stack_00000004[2] * 0x38;
  *(uint *)(iVar1 + 0x30) =
       ~(*(uint *)(iVar1 + 0x30) & in_stack_00000008) & in_stack_00000008 |
       *(uint *)(iVar1 + 0x30) & uVar3;
  iVar2 = iVar2 + in_stack_00000004[3] * 0x38;
  *(uint *)(iVar2 + 0x30) =
       ~(*(uint *)(iVar2 + 0x30) & in_stack_00000008) & in_stack_00000008 |
...
// Assembly code:
// 005cd1a0: PUSH EBX
//   Label: shape_superopt.cpp_FUN_005cd1a0
// 005cd1a1: PUSH ESI
// 005cd1a2: PUSH EDI
// 005cd1a3: PUSH EBP
