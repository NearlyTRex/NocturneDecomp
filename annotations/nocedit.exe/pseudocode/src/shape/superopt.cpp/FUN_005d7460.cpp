// Name: shape_superopt.cpp_FUN_005d7460
// Address: 005d7460
// Address Range: [[005d7460, 005d7688]]
// Convention: unknown
// Signature: undefined shape_superopt.cpp_FUN_005d7460()

#include "nocturne.h"

/* Signature: undefined1 shape_superopt.cpp_FUN_005d7460(undefined4 param_1, undefined4 param_2,
   undefined4 param_3) */

void shape_superopt_cpp_FUN_005d7460(void)

{
  ...
  *(byte *)(in_stack_00000008 + 0x61) = *(byte *)(in_stack_00000008 + 0x61) | 0x20;
  dVar1 = *(double *)(in_stack_00000004 + 0x24);
  do {
    local_30 = 0;
    bVar4 = true;
          ...
          if (*(int *)(in_stack_0000000c + 8) != 0) {
            ...
            do {
              ...
              if ((((*(byte *)(iVar7 + 0x61) & 0xa0) == 0) &&
                ...
                if ((dStack_40 <= *(double *)(in_stack_00000004 + 0x2c)) &&
...
// Assembly code:
// 005d7460: PUSH EBX
//   Label: shape_superopt.cpp_FUN_005d7460
// 005d7461: PUSH ESI
// 005d7462: PUSH EDI
// 005d7463: PUSH EBP
