// Name: shape_superopt.cpp_FUN_005d5de0
// Address: 005d5de0
// Address Range: [[005d5de0, 005d5e50]]
// Convention: unknown
// Signature: undefined shape_superopt.cpp_FUN_005d5de0()
// Function calls:
//   shape_superopt.cpp_FUN_005d5bb0
//   shape_superopt.cpp_FUN_005d5e60

#include "nocturne.h"

undefined4 shape_superopt_cpp_FUN_005d5de0(void)

{
  ...
  iVar1 = shape_superopt_cpp_FUN_005d5e60();
  if ((iVar1 == 0) && (iVar1 = shape_superopt_cpp_FUN_005d5e60(), iVar1 == 0)) {
    uVar2 = 0;
    if (in_stack_00000008 != 0) {
      do {
        iVar1 = shape_superopt_cpp_FUN_005d5bb0();
        if (iVar1 != 0) {
          return 1;
        }
        uVar2 = uVar2 + 1;
      } while (uVar2 < in_stack_00000008);
    }
    return 0;
  }
  return 1;
...
// Assembly code:
// 005d5de0: PUSH EBX
//   Label: shape_superopt.cpp_FUN_005d5de0
// 005d5de1: PUSH ESI
// 005d5de2: PUSH EDI
// 005d5de3: PUSH EBP
...
// 005d5df5: PUSH EDI
// 005d5df6: PUSH EBX
// 005d5df7: CALL shape_superopt.cpp_FUN_005d5e60
...
// 005d5e0e: PUSH EDI
// 005d5e0f: PUSH EBX
// 005d5e10: CALL shape_superopt.cpp_FUN_005d5e60
//   XREF to: 005d5e60 (UNCONDITIONAL_CALL)
...
// 005d5e32: PUSH EBX
// 005d5e33: PUSH EAX
// 005d5e34: CALL shape_superopt.cpp_FUN_005d5bb0
