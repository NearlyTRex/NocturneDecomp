// Name: shape_superopt.cpp_CObj_FUN_005d2f50
// Address: 005d2f50
// Address Range: [[005d2f50, 005d3013]]
// Convention: __cdecl
// Signature: int shape_superopt.cpp_CObj_FUN_005d2f50(CObj * this_ptr)
// Function calls:
...
int __cdecl shape_superopt_cpp_CObj_FUN_005d2f50(CObj *this_ptr)

{
  ...
  if ((uint)this_ptr->count <= in_stack_00000008) {
    return 0;
  }
  uVar1 = this_ptr->count - 1;
  this_ptr->count = uVar1;
  if (in_stack_00000008 < uVar1) {
    crt_string_c_memmove_FUN_005fe5e0
              (this_ptr->poly_array + in_stack_00000008,this_ptr->poly_array + in_stack_00000008 + 1
               ,(uVar1 - in_stack_00000008) * 0x68);
  }
  if (this_ptr->count != 0) {
    pCVar2 = (CPoly *)crt_memory_c_realloc_FUN_00601df0(this_ptr->poly_array,this_ptr->count * 0x68)
    ;
    if (pCVar2 != (CPoly *)0x0) {
...
// Assembly code:
// 005d2f50: PUSH EBX
//   Label: shape_superopt.cpp_CObj_FUN_005d2f50
// 005d2f51: PUSH ESI
// 005d2f52: PUSH EBP
