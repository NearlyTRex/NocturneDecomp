...
;                               FUNCTION
; *****************************************************************************
; __cdecl double shape_superopt.cpp_getSignedTriangleArea2D_FUN_005d6640(CVector2d * p1, CVector2d * p2, CVector2d * p3)
;
; Parameters:
...
section .text
    ...
    FNSTSW AX                           ; 005d6678
    SAHF                                ; 005d667a
    JBE 0x005d66aa                      ; 005d667b | LAB_005d66aa
    ...
    FLD double ptr [ESP]                ; 005d6686
        ;   Label: LAB_005d6686
    FCOMP double ptr [0x00654552]       ; 005d6689 | double DOUBLE_00654552
    FNSTSW AX                           ; 005d668f
    SAHF                                ; 005d6691
    JNC 0x005d66bb                      ; 005d6692 | LAB_005d66bb
    ...
    JMP 0x005d6686                      ; 005d66b9 | LAB_005d6686
