...
section .text
    ...
    PUSH EBX                            ; 005d7000
        ;   Label: shape_superopt.cpp_COptimize_cleanup_FUN_005d7000
    PUSH ESI                            ; 005d7001
    PUSH EDI                            ; 005d7002
    PUSH EBP                            ; 005d7003
    ...
    PUSH EBP                            ; 005d7022
    CALL shape_superopt.cpp_CComplexPolygon_free_FUN_005c79f0 ; 005d7023
    ...
    PUSH 0x0                            ; 005d70a2
        ;   Label: LAB_005d70a2
    PUSH EAX                            ; 005d70a4
    CALL shape_superopt.cpp_CComplexPolygon_dtor_FUN_005c79d0 ; 005d70a5
