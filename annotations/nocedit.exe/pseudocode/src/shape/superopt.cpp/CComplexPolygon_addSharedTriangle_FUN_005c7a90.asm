...
; CPoly *          Stack[0x8]:4   poly
;
; XREF[1]:
;   shape_superopt.cpp_COptimize_optimizeComplex_FUN_005d7350 at 005d73df
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 005c7a90
        ;   Label: shape_superopt.cpp_CComplexPolygon_addSharedTriangle_FUN_005c7a90
    PUSH ESI                            ; 005c7a91
    PUSH EBP                            ; 005c7a92
