...
;
; XREF[1]:
;   shape_superopt.cpp_TriListSomething_FUN_005d77a0 at 005d7cf3
;
; Referenced Globals:
...
section .text
    ...
    PUSH EDX                            ; 005d7e0e
    PUSH 0x16e9910                      ; 005d7e0f | SShapeEditorPolygon[20000] g_ModelPolygonData
    MOV dword ptr [0x016e990c],EDX      ; 005d7e14 | int g_PolygonCount
    MOV dword ptr [0x01626408],EDX      ; 005d7e1a | int g_VertexCount
    CALL crt_memory.c_memset_FUN_005fde40 ; 005d7e20 | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
        ;   XREF to: 005fde40 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005d7e25
    PUSH 0x61a80                        ; 005d7e28
    PUSH 0x0                            ; 005d7e2d
    PUSH 0x162640c                      ; 005d7e2f | SVertexData[20000] g_LoadedVertices
    CALL crt_memory.c_memset_FUN_005fde40 ; 005d7e34 | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
        ;   XREF to: 005fde40 (UNCONDITIONAL_CALL)
    ...
    JBE 0x005d80dc                      ; 005d7e4b | LAB_005d80dc
    ...
    PUSH EAX                            ; 005d7e66
    PUSH EBX                            ; 005d7e67
    CALL shape_superopt.cpp_FUN_005cbec0 ; 005d7e68 | undefined shape_superopt.cpp_FUN_005cbec0()
        ;   XREF to: 005cbec0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005d7e6d
    PUSH EBX                            ; 005d7e70
    MOV ESI,EAX                         ; 005d7e71
    CALL shape_superopt.cpp_FUN_005cbf00 ; 005d7e73 | undefined shape_superopt.cpp_FUN_005cbf00()
    ...
    JBE 0x005d80b9                      ; 005d7e94 | LAB_005d80b9
    ...
    MOV EAX,[0x01626408]                ; 005d7eb7 | int g_VertexCount
    ADD EAX,EDI                         ; 005d7ebc
    CMP EAX,0x4e20                      ; 005d7ebe
    JBE 0x005d7ee7                      ; 005d7ec3 | LAB_005d7ee7
        ;   XREF to: 005d7ee7 (CONDITIONAL_JUMP)
    MOV EBP,0x654882                    ; 005d7ec5 | = "..\\shape\\superopt.cpp" | s_shape_superopt_cpp_00654882 = ..\shape\superopt.cpp
    MOV EAX,0x25b3                      ; 005d7eca
    PUSH 0x654898                       ; 005d7ecf | = "Too many points!" | s_Too_many_points_00654898 = Too many points!
    MOV dword ptr [0x02f0ca48],EBP      ; 005d7ed4 | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 005d7eda | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005d7edf | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    JBE 0x005d7f28                      ; 005d7eef | LAB_005d7f28
        ;   XREF to: 005d7f28 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [ESP + 0x28]      ; 005d7ef1
    MOV EDI,dword ptr [0x01626408]      ; 005d7ef5 | int g_VertexCount
    ...
    INC ECX                             ; 005d7f08
    FSTP float ptr [EAX + 0x162640c]    ; 005d7f09 | SVertexData[20000] g_LoadedVertices
    ADD EAX,0x14                        ; 005d7f0f
    FLD double ptr [EDX + -0x48]        ; 005d7f12
    FSTP float ptr [EAX + 0x16263fc]    ; 005d7f15 | DAT_01626410
    FLD double ptr [EDX + -0x40]        ; 005d7f1b
    FSTP float ptr [EAX + 0x1626400]    ; 005d7f1e | g_LoadedVertices[0].vertex.z
    CMP ECX,EBX                         ; 005d7f24
    JC 0x005d7f02                       ; 005d7f26 | LAB_005d7f02
    ...
    CMP EBP,dword ptr [ESP + 0x20]      ; 005d7f43
        ;   Label: LAB_005d7f43
    JC 0x005d7f4d                       ; 005d7f47 | LAB_005d7f4d
        ;   XREF to: 005d7f4d (CONDITIONAL_JUMP)
    MOV EBP,dword ptr [ESP + 0x1c]      ; 005d7f49
    CMP dword ptr [0x016e990c],0x4e20   ; 005d7f4d | int g_PolygonCount
        ;   Label: LAB_005d7f4d
    JL 0x005d7f7c                       ; 005d7f57 | LAB_005d7f7c
        ;   XREF to: 005d7f7c (CONDITIONAL_JUMP)
    MOV ECX,0x6548a9                    ; 005d7f59 | = "..\\shape\\superopt.cpp" | s_shape_superopt_cpp_006548a9 = ..\shape\superopt.cpp
    MOV EBX,0x25c1                      ; 005d7f5e
    PUSH 0x6548bf                       ; 005d7f63 | = "Too many polys!" | s_Too_many_polys_006548bf = Too many polys!
    MOV dword ptr [0x02f0ca48],ECX      ; 005d7f68 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 005d7f6e | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005d7f74 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005d7f79
    IMUL EAX,dword ptr [0x016e990c],0x184 ; 005d7f7c | int g_PolygonCount
        ;   Label: LAB_005d7f7c
    MOV EDI,0x1                         ; 005d7f86
    XOR EDX,EDX                         ; 005d7f8b
    MOV dword ptr [EAX + 0x16e9910],EDI ; 005d7f8d | SShapeEditorPolygon[20000] g_ModelPolygonData
    MOV dword ptr [EAX + 0x16e9a88],EDX ; 005d7f93 | DAT_016e9a88
    ADD EAX,0x16e9910                   ; 005d7f99 | SShapeEditorPolygon[20000] g_ModelPolygonData
    MOV ESI,dword ptr [ESP + 0x18]      ; 005d7f9e
    LEA EDI,[EAX + 0x4]                 ; 005d7fa2 | DAT_016e9914
    PUSH EDI                            ; 005d7fa5 | DAT_016e9914
    MOV AL,byte ptr [ESI]               ; 005d7fa6 | DAT_03f6bbf0
        ;   Label: LAB_005d7fa6
    MOV byte ptr [EDI],AL               ; 005d7fa8 | DAT_016e9914
    CMP AL,0x0                          ; 005d7faa
    JZ 0x005d7fbe                       ; 005d7fac | LAB_005d7fbe
        ;   XREF to: 005d7fbe (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 005d7fae | DAT_03f6bbf1
    ADD ESI,0x2                         ; 005d7fb1
    MOV byte ptr [EDI + 0x1],AL         ; 005d7fb4 | DAT_016e9915
    ADD EDI,0x2                         ; 005d7fb7
    CMP AL,0x0                          ; 005d7fba
    JNZ 0x005d7fa6                      ; 005d7fbc | LAB_005d7fa6
        ;   XREF to: 005d7fa6 (CONDITIONAL_JUMP)
    POP EDI                             ; 005d7fbe
        ;   Label: LAB_005d7fbe
    IMUL EAX,dword ptr [0x016e990c],0x184 ; 005d7fbf | int g_PolygonCount
    ADD EAX,0x16e9910                   ; 005d7fc9 | SShapeEditorPolygon[20000] g_ModelPolygonData
    MOV ESI,dword ptr [ESP + 0x18]      ; 005d7fce
    LEA EDI,[EAX + 0x54]                ; 005d7fd2 | DAT_016e9964
    PUSH EDI                            ; 005d7fd5 | DAT_016e9964
    MOV AL,byte ptr [ESI]               ; 005d7fd6 | DAT_03f6bbf0
        ;   Label: LAB_005d7fd6
    MOV byte ptr [EDI],AL               ; 005d7fd8 | DAT_016e9964
    CMP AL,0x0                          ; 005d7fda
    JZ 0x005d7fee                       ; 005d7fdc | LAB_005d7fee
        ;   XREF to: 005d7fee (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 005d7fde | DAT_03f6bbf1
    ADD ESI,0x2                         ; 005d7fe1
    MOV byte ptr [EDI + 0x1],AL         ; 005d7fe4 | DAT_016e9965
    ADD EDI,0x2                         ; 005d7fe7
    CMP AL,0x0                          ; 005d7fea
    JNZ 0x005d7fd6                      ; 005d7fec | LAB_005d7fd6
        ;   XREF to: 005d7fd6 (CONDITIONAL_JUMP)
    POP EDI                             ; 005d7fee
        ;   Label: LAB_005d7fee
    IMUL EAX,dword ptr [0x016e990c],0x184 ; 005d7fef | int g_PolygonCount
    MOV EDX,dword ptr [0x01626408]      ; 005d7ff9 | int g_VertexCount
    MOV dword ptr [EAX + 0x16e99c8],EDX ; 005d7fff | DAT_016e99c8
    MOV EDX,dword ptr [ESP + 0x28]      ; 005d8005
    FLD double ptr [0x006548d2]         ; 005d8009 | double DOUBLE_006548d2
    ...
    MOV ECX,dword ptr [0x01626408]      ; 005d802a | int g_VertexCount
    ...
    MOV ESI,dword ptr [0x01626408]      ; 005d8041 | int g_VertexCount
    FSTP float ptr [EAX + 0x16e9a44]    ; 005d8047 | DAT_016e9a48
    ADD ESI,EBP                         ; 005d804d
    MOV ECX,EDI                         ; 005d804f
    CMP EDI,ESI                         ; 005d8051
    JG 0x005d8085                       ; 005d8053 | LAB_005d8085
        ;   XREF to: 005d8085 (CONDITIONAL_JUMP)
    FLD double ptr [0x006548d2]         ; 005d8055 | double DOUBLE_006548d2
    MOV dword ptr [EAX + 0x16e99c8],ECX ; 005d805b | DAT_016e99cc
        ;   Label: LAB_005d805b
    FLD double ptr [EDX + 0x40]         ; 005d8061
    FMUL ST1                            ; 005d8064
    FSTP float ptr [EAX + 0x16e9a08]    ; 005d8066 | DAT_016e9a0c
    ...
    INC ECX                             ; 005d8078
    FSTP float ptr [EAX + 0x16e9a44]    ; 005d8079 | DAT_016e9a4c
    CMP ECX,ESI                         ; 005d807f
    JLE 0x005d805b                      ; 005d8081 | LAB_005d805b
    ...
    MOV EBX,dword ptr [0x016e990c]      ; 005d808f | int g_PolygonCount
    INC EBX                             ; 005d8095
    MOV ESI,dword ptr [ESP + 0x1c]      ; 005d8096
    MOV dword ptr [0x016e990c],EBX      ; 005d809a | int g_PolygonCount
    CMP EBP,ESI                         ; 005d80a0
    JNC 0x005d80e9                      ; 005d80a2 | LAB_005d80e9
    ...
    JMP 0x005d7f43                      ; 005d80b4 | LAB_005d7f43
    ...
    JC 0x005d7e55                       ; 005d80d6 | LAB_005d7e55
        ;   XREF to: 005d7e55 (CONDITIONAL_JUMP)
    CALL shape_design.c_calculateVertexNormals_FUN_0045be40 ; 005d80dc | void shape_design.c_calculateVertexNormals_FUN_0045be40()
        ;   Label: LAB_005d80dc
    ...
    MOV EDX,dword ptr [0x01626408]      ; 005d80f8 | int g_VertexCount
    ADD ECX,0x8                         ; 005d80fe
    ADD EDX,EAX                         ; 005d8101
    INC EBX                             ; 005d8103
    MOV dword ptr [0x01626408],EDX      ; 005d8104 | int g_VertexCount
    MOV dword ptr [ESP + 0x10],ECX      ; 005d810a
    MOV dword ptr [ESP + 0xc],EBX       ; 005d810e
    CMP EBX,ESI                         ; 005d8112
    JNC 0x005d80b9                      ; 005d8114 | LAB_005d80b9
        ;   XREF to: 005d80b9 (CONDITIONAL_JUMP)
    JMP 0x005d7e9e                      ; 005d8116 | LAB_005d7e9e
