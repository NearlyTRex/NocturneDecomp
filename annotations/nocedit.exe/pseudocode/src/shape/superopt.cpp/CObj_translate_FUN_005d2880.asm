...
section .text
    ...
    JC 0x005d28a4                       ; 005d28c4
        ;   XREF to: 005d28a4 (CONDITIONAL_JUMP)  ; LAB_005d28a4
    POP EDI                             ; 005d28c6
    POP ESI                             ; 005d28c7
        ;   Label: LAB_005d28c7
    POP EBX                             ; 005d28c8
