...
;
; XREF[3]:
;   shape_superopt.cpp_CComplexPolygon_dtor_FUN_005c79d0 at 005c79d6
;   shape_superopt.cpp_CComplexPolygon_splitByDimensions_FUN_005c9500 at 005c984b
;   shape_superopt.cpp_COptimize_cleanup_FUN_005d7000 at 005d7023
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 005c79f0
        ;   Label: shape_superopt.cpp_CComplexPolygon_free_FUN_005c79f0
    PUSH ESI                            ; 005c79f1
    PUSH EDI                            ; 005c79f2
    PUSH EBP                            ; 005c79f3
    ...
    INC EBX                             ; 005c7a22
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 005c7a23
    ...
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 005c7a60
        ;   XREF to: 005fe659 (UNCONDITIONAL_CALL)  ; void shape_memdbg.cpp_free_FUN_005fe659(void * ptr)
