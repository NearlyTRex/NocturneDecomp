// Name: shape_superopt.cpp_FUN_005cd6f0
// Address: 005cd6f0
// Address Range: [[005cd6f0, 005cd7c0]]
// Convention: unknown
// Signature: undefined shape_superopt.cpp_FUN_005cd6f0()

#include "nocturne.h"

/* Signature: undefined1 shape_superopt.cpp_FUN_005cd6f0(undefined4 param_1, undefined4 param_2) */

void shape_superopt_cpp_FUN_005cd6f0(void)

{
  ...
  puVar2 = (undefined4 *)(in_stack_00000004[1] * 0x38 + iVar1);
  ...
  puVar2 = (undefined4 *)(in_stack_00000004[2] * 0x38 + iVar1);
  if ((puVar2[0xd] & in_stack_00000008) == in_stack_00000008) {
    *puVar2 = puVar2[6];
    puVar2[1] = puVar2[7];
    puVar2[2] = puVar2[8];
  ...
  puVar2 = (undefined4 *)(in_stack_00000004[3] * 0x38 + iVar1);
  if ((puVar2[0xd] & in_stack_00000008) != in_stack_00000008) {
    return;
  }
  *puVar2 = puVar2[6];
...
// Assembly code:
// 005cd6f0: PUSH EBX
//   Label: shape_superopt.cpp_FUN_005cd6f0
// 005cd6f1: PUSH ESI
// 005cd6f2: PUSH EDI
