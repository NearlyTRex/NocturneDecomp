// Name: shape_superopt.cpp_CObj_FUN_005d3280
// Address: 005d3280
// Address Range: [[005d3280, 005d32d9]]
// Convention: __cdecl
// Signature: void shape_superopt.cpp_CObj_FUN_005d3280(CObj * this_ptr)

#include "nocturne.h"

void __cdecl shape_superopt_cpp_CObj_FUN_005d3280(CObj *this_ptr)

{
  ...
  if (this_ptr->field0_0x0 != 0) {
    do {
      if ((*(uint *)(uVar2 * 0x38 + 0x34 + (int)this_ptr->vertex_data) & in_stack_00000008) ==
          in_stack_00000008) {
...
// Assembly code:
// 005d3280: PUSH EBX
//   Label: shape_superopt.cpp_CObj_FUN_005d3280
// 005d3281: PUSH ESI
// 005d3282: PUSH EDI
