// Name: shape_superopt.cpp_CPoly_FUN_005cd220
// Address: 005cd220
// Address Range: [[005cd220, 005cd2ac]]
// Convention: __cdecl
// Signature: void shape_superopt.cpp_CPoly_FUN_005cd220(CPoly * this_ptr)

#include "nocturne.h"

void __cdecl shape_superopt_cpp_CPoly_FUN_005cd220(CPoly *this_ptr)

{
  ...
  *puVar1 = *puVar1 & in_stack_0000000c;
  puVar1 = (uint *)((int)pvVar2 + this_ptr->vertex_idx_2 * 0x38 + 0x34);
  *puVar1 = *puVar1 | in_stack_00000008;
  uVar3 = this_ptr->field8_0x60 & in_stack_0000000c;
  this_ptr->field8_0x60 = uVar3;
  this_ptr->field8_0x60 = uVar3 | in_stack_00000008;
  return;
}
...
// Assembly code:
// 005cd220: PUSH EBX
//   Label: shape_superopt.cpp_CPoly_FUN_005cd220
// 005cd221: PUSH ESI
// 005cd222: PUSH EDI
