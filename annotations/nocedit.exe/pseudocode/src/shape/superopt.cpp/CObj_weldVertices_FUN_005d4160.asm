...
section .text
    ...
    JA 0x005d4255                       ; 005d41af | LAB_005d4255
    ...
    JZ 0x005d428a                       ; 005d4200 | LAB_005d428a
    ...
    JC 0x005d41ce                       ; 005d422d | LAB_005d41ce
        ;   XREF to: 005d41ce (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [ESP + 0xe0]      ; 005d422f
        ;   Label: LAB_005d422f
    PUSH EDI                            ; 005d4236
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 005d4237 | void shape_memdbg.cpp_debugFree_FUN_0050f210(void * ptr)
        ;   XREF to: 0050f210 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005d423c
    CMP dword ptr [EBP + 0x20],0x0      ; 005d423f
    JNZ 0x005d44b3                      ; 005d4243 | LAB_005d44b3
    ...
    PUSH 0x4                            ; 005d4255
        ;   Label: LAB_005d4255
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1d0 ; 005d4257 | void * shape_memdbg.cpp_debugAlloc_FUN_0050f1d0(int size)
        ;   XREF to: 0050f1d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005d425c
    MOV dword ptr [ESP + 0xe0],EAX      ; 005d425f
    JMP 0x005d41b5                      ; 005d4266 | LAB_005d41b5
        ;   XREF to: 005d41b5 (UNCONDITIONAL_JUMP)
    MOV ESI,dword ptr [ESP + 0xe8]      ; 005d426b
        ;   Label: LAB_005d426b
    PUSH ESI                            ; 005d4272
    PUSH 0x654468                       ; 005d4273 | = "Welding vertices (%d removed so far)" | s_Welding_vertices_d_remov_00654468 = Welding vertices (%d removed so far)
    LEA EAX,[ESP + 0x10]                ; 005d4278
    PUSH EAX                            ; 005d427c
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005d427d | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005d4282
    JMP 0x005d41e6                      ; 005d4285 | LAB_005d41e6
    ...
    JNC 0x005d4206                      ; 005d431e | LAB_005d4206
    ...
    JZ 0x005d4359                       ; 005d4341 | LAB_005d4359
    ...
    JNC 0x005d4206                      ; 005d4351 | LAB_005d4206
        ;   XREF to: 005d4206 (CONDITIONAL_JUMP)
    JMP 0x005d432e                      ; 005d4357 | LAB_005d432e
    ...
    JNZ 0x005d4416                      ; 005d4366 | LAB_005d4416
        ;   XREF to: 005d4416 (CONDITIONAL_JUMP)
    TEST EAX,EAX                        ; 005d436c
    JNZ 0x005d4416                      ; 005d436e | LAB_005d4416
        ;   XREF to: 005d4416 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 005d437f
    SAHF                                ; 005d4381
    JNZ 0x005d4343                      ; 005d4382 | LAB_005d4343
    ...
    FNSTSW AX                           ; 005d4391
    SAHF                                ; 005d4393
    JNZ 0x005d4343                      ; 005d4394 | LAB_005d4343
        ;   XREF to: 005d4343 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 005d43a3
    SAHF                                ; 005d43a5
    JNZ 0x005d4343                      ; 005d43a6 | LAB_005d4343
        ;   XREF to: 005d4343 (CONDITIONAL_JUMP)
    ...
    JBE 0x005d43f9                      ; 005d43b2 | LAB_005d43f9
    ...
    JNZ 0x005d43cd                      ; 005d43c1 | LAB_005d43cd
    ...
    CMP EDX,dword ptr [EAX + 0x8]       ; 005d43cd
        ;   Label: LAB_005d43cd
    JNZ 0x005d43dc                      ; 005d43d0 | LAB_005d43dc
    ...
    CMP EDX,dword ptr [EAX + 0xc]       ; 005d43dc
        ;   Label: LAB_005d43dc
    JNZ 0x005d43eb                      ; 005d43df | LAB_005d43eb
    ...
    JC 0x005d43b6                       ; 005d43f7 | LAB_005d43b6
    ...
    JMP 0x005d4343                      ; 005d4411 | LAB_005d4343
    ...
    FNSTSW AX                           ; 005d44a5
    SAHF                                ; 005d44a7
    JA 0x005d4343                       ; 005d44a8 | LAB_005d4343
        ;   XREF to: 005d4343 (CONDITIONAL_JUMP)
    JMP 0x005d43a8                      ; 005d44ae | LAB_005d43a8
