...
;                               FUNCTION
; *****************************************************************************
; unknown undefined shape_superopt.cpp_FUN_005cb3a0()
;
; Local Variables:
...
;
; XREF[2]:
;   shape_superopt.cpp_FUN_005c8b50 at 005c8d67
;   shape_superopt.cpp_FUN_005c91e0 at 005c92b4
;
; Called Functions:
...
section .text
    ...
    PUSH EAX                            ; 005cb3be
    PUSH EBX                            ; 005cb3bf
    CALL shape_superopt.cpp_FUN_005cbb40 ; 005cb3c0 | undefined shape_superopt.cpp_FUN_005cbb40()
    ...
    FNSTSW AX                           ; 005cb3e7
    SAHF                                ; 005cb3e9
    JA 0x005cb62c                       ; 005cb3ea | LAB_005cb62c
        ;   XREF to: 005cb62c (CONDITIONAL_JUMP)
    FLDZ                                ; 005cb3f0
    FCOMP double ptr [EBX + 0x14]       ; 005cb3f2
    FNSTSW AX                           ; 005cb3f5
    SAHF                                ; 005cb3f7
    JBE 0x005cb635                      ; 005cb3f8 | LAB_005cb635
    ...
    FNSTSW AX                           ; 005cb41c
    SAHF                                ; 005cb41e
    JA 0x005cb648                       ; 005cb41f | LAB_005cb648
    ...
    FNSTSW AX                           ; 005cb448
    SAHF                                ; 005cb44a
    JA 0x005cb656                       ; 005cb44b | LAB_005cb656
    ...
    JBE 0x005cb620                      ; 005cb4d2 | LAB_005cb620
    ...
    CMP dword ptr [ESP + 0x164],0x0     ; 005cb4e2
        ;   Label: LAB_005cb4e2
    JNZ 0x005cb672                      ; 005cb4ea | LAB_005cb672
        ;   XREF to: 005cb672 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x168],0x0     ; 005cb4f0
    JZ 0x005cb756                       ; 005cb4f8 | LAB_005cb756
    ...
    JC 0x005cb5f0                       ; 005cb601 | LAB_005cb5f0
    ...
    JC 0x005cb4e2                       ; 005cb61a | LAB_005cb4e2
    ...
    JMP 0x005cb5dd                      ; 005cb751 | LAB_005cb5dd
    ...
    JMP 0x005cb5dd                      ; 005cb835 | LAB_005cb5dd
        ;   XREF to: 005cb5dd (UNCONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x164],0x0     ; 005cb83a
        ;   Label: LAB_005cb83a
    JZ 0x005cb9bf                       ; 005cb842 | LAB_005cb9bf
    ...
    PUSH EAX                            ; 005cb90d
    CALL shape_superopt.cpp_getSignedTriangleArea2D_FUN_005d6640 ; 005cb90e | double shape_superopt.cpp_getSignedTriangleArea2D_FUN_005d6640(CVector2d * p1, CVector2d * p2, CVector2d * p3)
    ...
    CALL shape_superopt.cpp_getSignedTriangleArea2D_FUN_005d6640 ; 005cb93e | double shape_superopt.cpp_getSignedTriangleArea2D_FUN_005d6640(CVector2d * p1, CVector2d * p2, CVector2d * p3)
        ;   XREF to: 005d6640 (UNCONDITIONAL_CALL)
    ...
    FNSTSW AX                           ; 005cb98a
    SAHF                                ; 005cb98c
    JBE 0x005cb999                      ; 005cb98d | LAB_005cb999
        ;   XREF to: 005cb999 (CONDITIONAL_JUMP)
    FLDZ                                ; 005cb98f
    FCOMP double ptr [ESP]              ; 005cb991
    FNSTSW AX                           ; 005cb994
    SAHF                                ; 005cb996
    JC 0x005cb9b6                       ; 005cb997 | LAB_005cb9b6
        ;   XREF to: 005cb9b6 (CONDITIONAL_JUMP)
    FLDZ                                ; 005cb999
        ;   Label: LAB_005cb999
    ...
    FNSTSW AX                           ; 005cb99f
    SAHF                                ; 005cb9a1
    JNC 0x005cb5f8                      ; 005cb9a2 | LAB_005cb5f8
        ;   XREF to: 005cb5f8 (CONDITIONAL_JUMP)
    FLDZ                                ; 005cb9a8
    FCOMP double ptr [ESP]              ; 005cb9aa
    FNSTSW AX                           ; 005cb9ad
    SAHF                                ; 005cb9af
    JBE 0x005cb5f8                      ; 005cb9b0 | LAB_005cb5f8
        ;   XREF to: 005cb5f8 (CONDITIONAL_JUMP)
    ...
    CMP dword ptr [ESP + 0x168],0x0     ; 005cb9bf
        ;   Label: LAB_005cb9bf
    JZ 0x005cba82                       ; 005cb9c7 | LAB_005cba82
    ...
    JMP 0x005cb8f8                      ; 005cba7d | LAB_005cb8f8
    ...
    JMP 0x005cb8f8                      ; 005cbb32 | LAB_005cb8f8
        ;   XREF to: 005cb8f8 (UNCONDITIONAL_JUMP)
