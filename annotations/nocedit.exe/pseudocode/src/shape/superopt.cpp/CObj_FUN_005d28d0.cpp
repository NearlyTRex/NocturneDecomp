// Name: shape_superopt.cpp_CObj_FUN_005d28d0
// Address: 005d28d0
// Address Range: [[005d28d0, 005d2937]]
// Convention: __cdecl
// Signature: void shape_superopt.cpp_CObj_FUN_005d28d0(CObj * this_ptr)

#include "nocturne.h"

void __cdecl shape_superopt_cpp_CObj_FUN_005d28d0(CObj *this_ptr)
      ...
      do {
        while ((*(uint *)((int)pdVar2 + 0x34) & in_stack_00000008) == in_stack_00000008) {
          *pdVar2 = *in_stack_0000000c + *pdVar2;
          ...
          uVar3 = uVar3 + 1;
          pdVar2 = pdVar2 + 7;
          if ((uint)this_ptr->field0_0x0 <= uVar3) {
            return;
          }
        }
        uVar3 = uVar3 + 1;
...
// Assembly code:
// 005d28d0: PUSH EBX
//   Label: shape_superopt.cpp_CObj_FUN_005d28d0
// 005d28d1: PUSH ESI
// 005d28d2: PUSH EDI
// 005d28d3: PUSH EBP
