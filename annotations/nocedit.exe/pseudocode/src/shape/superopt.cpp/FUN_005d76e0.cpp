// Name: shape_superopt.cpp_FUN_005d76e0
// Address: 005d76e0
// Address Range: [[005d76e0, 005d7743]]
// Convention: unknown
// Signature: undefined shape_superopt.cpp_FUN_005d76e0()
// Function calls:
...
/* Signature: undefined1 shape_superopt.cpp_FUN_005d76e0(undefined4 param_1, undefined4 param_2) */

void shape_superopt_cpp_FUN_005d76e0(void)

{
  ...
  pvVar2 = crt_memory_c_realloc_FUN_00601df0
                     (*(void **)(in_stack_00000004 + 0x3c),
                      (*(int *)(in_stack_00000004 + 0x38) + 1) * 4);
  if (pvVar2 != (void *)0x0) {
    ...
    iVar1 = *(int *)(in_stack_00000004 + 0x38);
    *(void **)(in_stack_00000004 + 0x3c) = pvVar2;
    *(int *)(in_stack_00000004 + 0x38) = iVar1 + 1;
    *(void **)(*(int *)(in_stack_00000004 + 0x3c) + iVar1 * 4) = in_stack_0000000c;
  }
  return;
}
...
// Assembly code:
// 005d76e0: PUSH EBX
//   Label: shape_superopt.cpp_FUN_005d76e0
// 005d76e1: PUSH ESI
