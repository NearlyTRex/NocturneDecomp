...
;
; Called Functions:
;   shape_superopt.cpp_CComplexPolygon_splitToConvex_FUN_005c84c0
...
section .text
    ...
    PUSH EBX                            ; 005d7690
        ;   Label: shape_superopt.cpp_COptimize_splitToConvex_FUN_005d7690
    PUSH ESI                            ; 005d7691
    PUSH EDI                            ; 005d7692
    PUSH EBP                            ; 005d7693
    ...
    PUSH EBP                            ; 005d76a9
    CALL shape_superopt.cpp_CComplexPolygon_splitToConvex_FUN_005c84c0 ; 005d76aa
