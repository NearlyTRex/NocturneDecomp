...
;
; XREF[1]:
;   shape_superopt.cpp_CComplexPolygon_processEdgeSubLoops_FUN_005c91e0 at 005c9304
;
; Called Functions:
;   crt_memory.c_realloc_FUN_00601df0
;   shape_memdbg.cpp_malloc_FUN_006021da
;   shape_superopt.cpp_CComplexPolygon_isEdgeChainClosed_FUN_005cbf20
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 005cbe20
        ;   Label: shape_superopt.cpp_CComplexPolygon_storeEdgeSubChain_FUN_005cbe20
    PUSH ESI                            ; 005cbe21
    PUSH EBP                            ; 005cbe22
    ...
    PUSH ECX                            ; 005cbe30
    PUSH EBX                            ; 005cbe31
    CALL shape_superopt.cpp_CComplexPolygon_isEdgeChainClosed_FUN_005cbf20 ; 005cbe32
        ;   XREF to: 005cbf20 (UNCONDITIONAL_CALL)  ; int shape_superopt.cpp_CComplexPolygon_isEdgeChainClosed_FUN_005cbf20(CComplexPolygon * this_ptr, SExpandedEdge * edges, int edge_count)
