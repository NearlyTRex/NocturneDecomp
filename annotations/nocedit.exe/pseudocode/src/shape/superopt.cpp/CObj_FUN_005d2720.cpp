// Name: shape_superopt.cpp_CObj_FUN_005d2720
// Address: 005d2720
// Address Range: [[005d2720, 005d2871]]
// Convention: __cdecl
// Signature: ulonglong shape_superopt.cpp_CObj_FUN_005d2720(CObj * this_ptr)
// Cross-references:
...
ulonglong __cdecl shape_superopt_cpp_CObj_FUN_005d2720(CObj *this_ptr)

{
  ...
  if ((this_ptr->count != 0) && (iVar3 = (**(code **)(in_stack_00000004[6] + 0x10))(), iVar3 == 0))
  {
    shape_superopt_cpp_logToFile_FUN_005c7910("Unable to add polygons to object");
    return (ulonglong)extraout_EDX_00 << 0x20;
  }
  puVar5 = (undefined4 *)this_ptr->vertex_data;
  puVar6 = (undefined4 *)(in_stack_00000004[1] + iVar2 * 0x38);
  for (uVar4 = (uint)(this_ptr->field0_0x0 * 0x38) >> 2; uVar4 != 0; uVar4 = uVar4 - 1) {
    *puVar6 = *puVar5;
...
// Assembly code:
// 005d2720: PUSH EBX
//   Label: shape_superopt.cpp_CObj_FUN_005d2720
// 005d2721: PUSH EDI
// 005d2722: PUSH EBP
