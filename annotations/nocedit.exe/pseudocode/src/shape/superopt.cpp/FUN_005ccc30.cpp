// Name: shape_superopt.cpp_FUN_005ccc30
// Address: 005ccc30
// Address Range: [[005ccc30, 005cd0aa]]
// Convention: unknown
// Signature: undefined shape_superopt.cpp_FUN_005ccc30()

#include "nocturne.h"

/* Signature: undefined1 shape_superopt.cpp_FUN_005ccc30(undefined4 param_1, undefined4 param_2,
   undefined4 param_3) */

void shape_superopt_cpp_FUN_005ccc30(void)

{
  ...
  local_20 = *(int *)(*in_stack_00000004 + 4);
  local_18 = (double *)(*(int *)(*in_stack_00000004 + 4) + in_stack_00000004[1] * 0x38);
  ...
  local_98 = in_stack_00000008[2] * local_148 +
             *in_stack_00000008 * local_158 + in_stack_00000008[1] * local_150;
  local_90 = in_stack_00000008[5] * local_148 +
             in_stack_00000008[3] * local_158 + in_stack_00000008[4] * local_150;
  local_88 = in_stack_00000008[8] * local_148 +
             in_stack_00000008[6] * local_158 + in_stack_00000008[7] * local_150;
  pdVar2 = &local_98;
  pdVar3 = &local_140;
  for (iVar1 = 6; iVar1 != 0; iVar1 = iVar1 + -1) {
    *(undefined4 *)pdVar3 = *(undefined4 *)pdVar2;
  ...
  local_50 = local_140 + *in_stack_0000000c;
  local_48 = local_138 + in_stack_0000000c[1];
  local_40 = local_130 + in_stack_0000000c[2];
  pdVar2 = &local_50;
  puVar4 = local_128;
  for (iVar1 = 6; iVar1 != 0; iVar1 = iVar1 + -1) {
  ...
  *(undefined4 *)((int)local_18 + 0x14) = local_114;
  local_18 = (double *)(local_20 + in_stack_00000004[2] * 0x38);
  ...
  local_1d0 = in_stack_00000008[2] * local_a0 +
              *in_stack_00000008 * local_b0 + in_stack_00000008[1] * local_a8;
  local_1c8 = in_stack_00000008[5] * local_a0 +
              in_stack_00000008[3] * local_b0 + in_stack_00000008[4] * local_a8;
  local_1c0 = in_stack_00000008[8] * local_a0 +
              in_stack_00000008[6] * local_b0 + in_stack_00000008[7] * local_a8;
  pdVar2 = &local_1d0;
  pdVar3 = &local_110;
  for (iVar1 = 6; iVar1 != 0; iVar1 = iVar1 + -1) {
    *(undefined4 *)pdVar3 = *(undefined4 *)pdVar2;
  ...
  local_c8 = local_110 + *in_stack_0000000c;
  local_c0 = local_108 + in_stack_0000000c[1];
  local_b8 = local_100 + in_stack_0000000c[2];
  pdVar2 = &local_c8;
  puVar4 = local_e0;
  for (iVar1 = 6; iVar1 != 0; iVar1 = iVar1 + -1) {
    *puVar4 = *(undefined4 *)pdVar2;
  ...
  *(undefined4 *)((int)local_18 + 0x14) = local_cc;
  local_1c = (double *)(local_20 + in_stack_00000004[3] * 0x38);
  ...
  local_f8 = in_stack_00000008[2] * local_70 +
             *in_stack_00000008 * local_80 + in_stack_00000008[1] * local_78;
  local_f0 = in_stack_00000008[5] * local_70 +
             in_stack_00000008[3] * local_80 + in_stack_00000008[4] * local_78;
  local_e8 = in_stack_00000008[8] * local_70 +
             in_stack_00000008[6] * local_80 + in_stack_00000008[7] * local_78;
  pdVar2 = &local_f8;
  pdVar3 = &local_188;
  for (iVar1 = 6; iVar1 != 0; iVar1 = iVar1 + -1) {
    *(undefined4 *)pdVar3 = *(undefined4 *)pdVar2;
  ...
  local_38 = local_188 + *in_stack_0000000c;
  local_30 = local_180 + in_stack_0000000c[1];
  local_28 = local_178 + in_stack_0000000c[2];
  pdVar2 = &local_38;
  puVar4 = local_1a0;
  for (iVar1 = 6; iVar1 != 0; iVar1 = iVar1 + -1) {
    *puVar4 = *(undefined4 *)pdVar2;
...
// Assembly code:
// 005ccc30: PUSH EBX
//   Label: shape_superopt.cpp_FUN_005ccc30
// 005ccc31: PUSH ESI
// 005ccc32: PUSH EDI
// 005ccc33: PUSH EBP
