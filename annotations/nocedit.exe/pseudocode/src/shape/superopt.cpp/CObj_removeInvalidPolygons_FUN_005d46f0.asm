...
section .text
    ...
    JA 0x005d4759                       ; 005d4706 | LAB_005d4759
    ...
    JZ 0x005d477c                       ; 005d4733 | LAB_005d477c
        ;   XREF to: 005d477c (CONDITIONAL_JUMP)
    INC EBX                             ; 005d4735
        ;   Label: LAB_005d4735
    CMP EBX,dword ptr [ESI + 0x8]       ; 005d4736
    JC 0x005d4713                       ; 005d4739 | LAB_005d4713
        ;   XREF to: 005d4713 (CONDITIONAL_JUMP)
    PUSH EBP                            ; 005d473b
        ;   Label: LAB_005d473b
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 005d473c | void shape_memdbg.cpp_debugFree_FUN_0050f210(void * ptr)
    ...
    PUSH 0x4                            ; 005d4759
        ;   Label: LAB_005d4759
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1d0 ; 005d475b | void * shape_memdbg.cpp_debugAlloc_FUN_0050f1d0(int size)
        ;   XREF to: 0050f1d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005d4760
    MOV EBP,EAX                         ; 005d4763
    JMP 0x005d4708                      ; 005d4765 | LAB_005d4708
        ;   XREF to: 005d4708 (UNCONDITIONAL_JUMP)
    PUSH EDI                            ; 005d4767
        ;   Label: LAB_005d4767
    PUSH 0x6544ce                       ; 005d4768 | = "Deleting invalid polygons (%d deleted..." | s_Deleting_invalid_polygon_006544ce = Deleting invalid polygons (%d deleted so far)
    LEA EAX,[ESP + 0x8]                 ; 005d476d
    PUSH EAX                            ; 005d4771
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005d4772 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005d4777
    JMP 0x005d471c                      ; 005d477a | LAB_005d471c
    ...
    JZ 0x005d478f                       ; 005d478a | LAB_005d478f
        ;   XREF to: 005d478f (CONDITIONAL_JUMP)
    INC EDI                             ; 005d478c
    JMP 0x005d4735                      ; 005d478d | LAB_005d4735
        ;   XREF to: 005d4735 (UNCONDITIONAL_JUMP)
    PUSH EBP                            ; 005d478f
        ;   Label: LAB_005d478f
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 005d4790 | void shape_memdbg.cpp_debugFree_FUN_0050f210(void * ptr)
        ;   XREF to: 0050f210 (UNCONDITIONAL_CALL)
