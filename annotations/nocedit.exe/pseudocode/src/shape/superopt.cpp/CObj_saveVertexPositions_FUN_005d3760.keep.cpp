...
// Convention: __cdecl
// Signature: void __cdecl shape_superopt_cpp_CObj_saveVertexPositions_FUN_005d3760(CObj *this_ptr)
...

{
  ...
  if (this_ptr->vertex_count != 0) {
    do {
      this_ptr->vertex_data[uVar2].orig_position = this_ptr->vertex_data[uVar2].position;
      uVar2 = uVar2 + 1;
