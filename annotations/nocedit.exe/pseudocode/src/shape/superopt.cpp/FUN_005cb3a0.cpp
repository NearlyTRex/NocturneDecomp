...

{
  ...
  if (in_stack_0000000c != 0) {
    ...
    do {
      if (local_18 == 0) {
        if (iStack_14 == 0) {
          local_5c = *(undefined4 *)(local_1c + 0x10);
          local_58 = *(undefined4 *)(local_1c + 0x14);
          local_b4 = *(undefined4 *)(local_1c + 0x18);
          local_b0 = *(undefined4 *)(local_1c + 0x1c);
          local_110._12_4_ = *(undefined4 *)(local_1c + 0x28);
          local_100._0_4_ = *(undefined4 *)(local_1c + 0x2c);
          local_100._4_4_ = *(undefined4 *)(local_1c + 0x30);
          local_100._8_4_ = *(undefined4 *)(local_1c + 0x34);
          ...
          local_bc = *(undefined4 *)(local_1c + 0x10);
          local_b8 = *(undefined4 *)(local_1c + 0x14);
          local_34 = *(int *)(local_1c + 0x20);
          local_30 = *(undefined4 *)(local_1c + 0x24);
          local_110._12_4_ = *(undefined4 *)(local_1c + 0x28);
          local_100._0_4_ = *(undefined4 *)(local_1c + 0x2c);
          local_100._4_4_ = *(undefined4 *)(local_1c + 0x38);
          local_100._8_4_ = *(undefined4 *)(local_1c + 0x3c);
        ...
        local_e4 = *(undefined4 *)(local_1c + 0x18);
        local_e0 = *(undefined4 *)(local_1c + 0x1c);
        local_94 = *(undefined4 *)(local_1c + 0x20);
        local_90 = *(undefined4 *)(local_1c + 0x24);
        local_110._12_4_ = *(undefined4 *)(local_1c + 0x30);
        local_100._0_4_ = *(undefined4 *)(local_1c + 0x34);
        local_100._4_4_ = *(undefined4 *)(local_1c + 0x38);
        local_100._8_4_ = *(undefined4 *)(local_1c + 0x3c);
      ...
      if (in_stack_0000000c != 0) {
        do {
          if (uVar3 != uVar4) {
            if (local_18 == 0) {
              if (iStack_14 == 0) {
                local_100._12_4_ = *(undefined4 *)(iVar2 + 0x10);
                local_f0 = *(undefined4 *)(iVar2 + 0x14);
                local_ec = *(undefined4 *)(iVar2 + 0x18);
                local_e8 = *(undefined4 *)(iVar2 + 0x1c);
                local_4c = *(undefined4 *)(iVar2 + 0x28);
                local_110._0_4_ = *(undefined4 *)(iVar2 + 0x2c);
                local_110._4_4_ = *(undefined4 *)(iVar2 + 0x30);
                local_110._8_4_ = *(undefined4 *)(iVar2 + 0x34);
                ...
                local_100._12_4_ = *(undefined4 *)(iVar2 + 0x10);
                local_f0 = *(undefined4 *)(iVar2 + 0x14);
                local_ec = *(undefined4 *)(iVar2 + 0x20);
                local_e8 = *(undefined4 *)(iVar2 + 0x24);
                local_6c = *(undefined4 *)(iVar2 + 0x28);
                local_110._0_4_ = *(undefined4 *)(iVar2 + 0x2c);
                local_110._4_4_ = *(undefined4 *)(iVar2 + 0x38);
                local_110._8_4_ = *(undefined4 *)(iVar2 + 0x3c);
              ...
              local_100._12_4_ = *(undefined4 *)(iVar2 + 0x18);
              local_f0 = *(undefined4 *)(iVar2 + 0x1c);
              local_ec = *(undefined4 *)(iVar2 + 0x20);
              local_e8 = *(undefined4 *)(iVar2 + 0x24);
              local_d4 = *(undefined4 *)(iVar2 + 0x30);
              local_110._0_4_ = *(undefined4 *)(iVar2 + 0x34);
              local_110._4_4_ = *(undefined4 *)(iVar2 + 0x38);
              local_110._8_4_ = *(undefined4 *)(iVar2 + 0x3c);
              local_dc = local_ec;
              local_d8 = local_e8;
            ...
            local_30 = (undefined4)((ulonglong)dVar5 >> 0x20);
            if ((((((local_138 & 0x7fffffff) == 0) && (iVar1 == 0)) &&
                 (((ulonglong)dVar5 & 0x7fffffff00000000) == 0)) && (local_34 == 0)) ||
               ((((double)CONCAT44(local_138,iVar1) < 0.0 && (0.0 < dVar5)) ||
                ((0.0 < (double)CONCAT44(local_138,iVar1) && (dVar5 < 0.0)))))) {
              return 0;
            }
          }
          uVar3 = uVar3 + 1;
...
// 005cb90d: PUSH EAX
// 005cb90e: CALL shape_superopt.cpp_getSignedTriangleArea2D_FUN_005d6640
...
// 005cb93e: CALL shape_superopt.cpp_getSignedTriangleArea2D_FUN_005d6640
//   XREF to: 005d6640 (UNCONDITIONAL_CALL)
