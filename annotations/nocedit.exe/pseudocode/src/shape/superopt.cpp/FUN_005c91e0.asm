...
;                               FUNCTION
; *****************************************************************************
; unknown undefined shape_superopt.cpp_FUN_005c91e0()
;
; Local Variables:
...
section .text
    ...
    PUSH EBX                            ; 005c91f9
    CALL shape_superopt.cpp_FUN_005c8280 ; 005c91fa | undefined shape_superopt.cpp_FUN_005c8280()
        ;   XREF to: 005c8280 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005c91ff
    TEST EAX,EAX                        ; 005c9202
    JNZ 0x005c9211                      ; 005c9204 | LAB_005c9211
    ...
    PUSH EDI                            ; 005c9215
    PUSH EBX                            ; 005c9216
    CALL shape_superopt.cpp_FUN_005c9340 ; 005c9217 | undefined shape_superopt.cpp_FUN_005c9340()
        ;   XREF to: 005c9340 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [ESI]             ; 005c921c
    ADD ESP,0xc                         ; 005c921e
    TEST EDX,EDX                        ; 005c9221
    JZ 0x005c9283                       ; 005c9223 | LAB_005c9283
    ...
    JNC 0x005c9272                      ; 005c923c | LAB_005c9272
    ...
    FADDP                               ; 005c9263
    FSQRT                               ; 005c9265
    FCOMP double ptr [0x0065422a]       ; 005c9267 | double DOUBLE_0065422a
    FNSTSW AX                           ; 005c926d
    SAHF                                ; 005c926f
    JNC 0x005c9291                      ; 005c9270 | LAB_005c9291
        ;   XREF to: 005c9291 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [ESI]             ; 005c9272
        ;   Label: LAB_005c9272
    CMP ECX,EDX                         ; 005c9274
    JNZ 0x005c929d                      ; 005c9276 | LAB_005c929d
    ...
    JC 0x005c9249                       ; 005c9299 | LAB_005c9249
        ;   XREF to: 005c9249 (CONDITIONAL_JUMP)
    JMP 0x005c9272                      ; 005c929b | LAB_005c9272
    ...
    CALL shape_superopt.cpp_FUN_005cb3a0 ; 005c92b4 | undefined shape_superopt.cpp_FUN_005cb3a0()
        ;   XREF to: 005cb3a0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005c92b9
    TEST EAX,EAX                        ; 005c92bc
    JZ 0x005c92e2                       ; 005c92be | LAB_005c92e2
    ...
    PUSH EDX                            ; 005c9303
    CALL shape_superopt.cpp_CondCallDebugMallocUnknownString_FUN_005cbe20 ; 005c9304 | undefined shape_superopt.cpp_CondCallDebugMallocUnknownString_FUN_005cbe20()
        ;   XREF to: 005cbe20 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005c9309
    TEST EAX,EAX                        ; 005c930c
    JZ 0x005c9206                       ; 005c930e | LAB_005c9206
    ...
    PUSH EAX                            ; 005c9328
    PUSH ECX                            ; 005c9329
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 005c932a | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
        ;   XREF to: 005fe5e0 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [ESI]             ; 005c932f
    SUB EDX,EBX                         ; 005c9331
    ADD ESP,0xc                         ; 005c9333
    MOV dword ptr [ESI],EDX             ; 005c9336
    JMP 0x005c92e4                      ; 005c9338 | LAB_005c92e4
