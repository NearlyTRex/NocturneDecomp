  ...
  if (this_ptr->vertex_count != 0) {
    ...
    do {
      ...
      if ((*(byte *)((int)pdVar4 + 0x35) & 0x80) == 0) {
        ...
        dStack_5c = *pdVar4 - dVar2;
        dStack_54 = pdVar4[1] - dVar2;
        dStack_4c = pdVar4[2] - dVar2;
        pdVar7 = &dStack_5c;
        pdVar8 = &dStack_a4;
        ...
        dStack_8c = *pdVar4 + dVar2;
        dStack_84 = pdVar4[1] + dVar2;
        dStack_7c = pdVar4[2] + dVar2;
        pdVar7 = &dStack_8c;
        pdVar8 = &dStack_74;
        for (iVar3 = 6; iVar3 != 0; iVar3 = iVar3 + -1) {
          *(undefined4 *)pdVar8 = *(undefined4 *)pdVar7;
...
LAB_005d43a8:
                  ...
                  if (this_ptr->poly_count != 0) {
                    ...
                    do {
                      ...
                      if (uVar5 == *(uint *)((int)pCVar1->uv_coords + iVar3 + -0xc)) {
                        *(uint *)((int)pCVar1->uv_coords + iVar3 + -0xc) = uStack_18;
                      }
                      if (uVar5 == *(uint *)((int)pCVar1->uv_coords + iVar3 + -8)) {
                        *(uint *)((int)pCVar1->uv_coords + iVar3 + -8) = uStack_18;
                      }
                      if (uVar5 == *(uint *)((int)pCVar1->uv_coords + iVar3 + -4)) {
                        *(uint *)((int)pCVar1->uv_coords + iVar3 + -4) = uStack_18;
                      }
                      uVar6 = uVar6 + 1;
                      iVar3 = iVar3 + 0x68;
              ...
              else if (((dStack_a4 <= *pdVar4) &&
                       ((((*pdVar4 <= dStack_74 && (dStack_9c <= pdVar4[1])) &&
                         (pdVar4[1] <= dStack_6c)) &&
                        ((dStack_94 <= pdVar4[2] && (pdVar4[2] <= dStack_64)))))) &&
                      (SQRT((pdVar4[2] - pdStack_1c[2]) * (pdVar4[2] - pdStack_1c[2]) +
                            (pdVar4[1] - pdStack_1c[1]) * (pdVar4[1] - pdStack_1c[1]) +
                            (*pdVar4 - *pdStack_1c) * (*pdVar4 - *pdStack_1c)) <=
