...
section .text
    ...
    JNZ 0x005cd104                      ; 005cd0d4
        ;   XREF to: 005cd104 (CONDITIONAL_JUMP)  ; LAB_005cd104
    ...
    JZ 0x005cd109                       ; 005cd102
        ;   XREF to: 005cd109 (CONDITIONAL_JUMP)  ; LAB_005cd109
