// Name: shape_superopt.cpp_FUN_005d0d30
// Address: 005d0d30
// Address Range: [[005d0d30, 005d0e1e]]
// Convention: unknown
// Signature: undefined shape_superopt.cpp_FUN_005d0d30()
// Globals:
//   undefined4 DAT_0065430a

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Signature: undefined1 shape_superopt.cpp_FUN_005d0d30(undefined4 param_1) */

void shape_superopt_cpp_FUN_005d0d30(void)

{
  ...
  local_10 = (double *)(iVar2 + in_stack_00000004[3] * 0x38);
  pdVar3 = (double *)(iVar2 + in_stack_00000004[2] * 0x38);
  iVar1 = in_stack_00000004[1] * 0x38;
  local_40 = *(double *)(iVar2 + iVar1) + *pdVar3;
  local_38 = *(double *)(iVar2 + 8 + iVar1) + pdVar3[1];
  local_30 = *(double *)(iVar2 + 0x10 + iVar1) + pdVar3[2];
  pdVar3 = &local_40;
  pdVar4 = &local_58;
  ...
  local_70 = local_28 * _DAT_0065430a;
  local_68 = local_20 * _DAT_0065430a;
  local_60 = local_18 * _DAT_0065430a;
  pdVar3 = &local_70;
  for (iVar2 = 6; iVar2 != 0; iVar2 = iVar2 + -1) {
...
// Assembly code:
// 005d0d30: PUSH EBX
//   Label: shape_superopt.cpp_FUN_005d0d30
// 005d0d31: PUSH EDI
// 005d0d32: PUSH EBP
