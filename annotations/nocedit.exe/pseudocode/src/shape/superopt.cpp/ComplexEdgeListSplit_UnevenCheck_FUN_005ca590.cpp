...

{
  ...
  dVar8 = (double)CONCAT44 /* combine 2-byte values */(uStack_30c,local_310);
  bVar17 = 0;
  local_20 = 0;
  ...
  if (*in_stack_0000000c != 0) {
    ...
    do {
      ...
      if ((*(int *)(iVar10 + 8) == 0) || (*(int *)(iVar10 + 0xc) == 0)) {
        ...
        local_308 = SUB84 /* extract 2-byte value */(dVar2,0);
...
LAB_005ca66d:
          ...
          dVar3 = dVar8;
          if ((double)CONCAT44 /* combine 2-byte values */(uStack_314,local_318) < dVar2) goto LAB_005ca66d;
        }
  ...
  if ((local_20 & 1) == 0) {
    ...
    if (1 < local_20) {
      ...
      do {
        ...
        dVar3 = (double)CONCAT44 /* combine 2-byte values */(uStack_244,local_248) - (double)CONCAT44 /* combine 2-byte values */(uStack_1cc,local_1d0);
        dVar5 = (double)CONCAT44 /* combine 2-byte values */(uStack_23c,local_240) - (double)CONCAT44 /* combine 2-byte values */(uStack_1c4,local_1c8);
        dVar4 = (double)CONCAT44 /* combine 2-byte values */(uStack_234,local_238) - (double)CONCAT44 /* combine 2-byte values */(uStack_1bc,local_1c0);
    ...
    if (local_20 != 0) {
      ...
      do {
        ...
        dVar3 = (double)CONCAT44 /* combine 2-byte values */(uStack_154,local_158) - (double)CONCAT44 /* combine 2-byte values */(uStack_1e4,local_1e8);
        dVar5 = (double)CONCAT44 /* combine 2-byte values */(uStack_14c,local_150) - (double)CONCAT44 /* combine 2-byte values */(uStack_1dc,local_1e0);
        dVar4 = (double)CONCAT44 /* combine 2-byte values */(uStack_144,local_148) - (double)CONCAT44 /* combine 2-byte values */(uStack_1d4,local_1d8);
        dVar3 = SQRT(dVar4 * dVar4 + dVar5 * dVar5 + dVar3 * dVar3);
        if (dVar2 < dVar3) {
          local_1b8 = local_1e8;
    ...
    local_200 = (double)CONCAT44 /* combine 2-byte values */(uStack_1b4,local_1b8) - (double)CONCAT44 /* combine 2-byte values */(uStack_154,local_158);
    local_1f8 = (double)CONCAT44 /* combine 2-byte values */(uStack_1ac,local_1b0) - (double)CONCAT44 /* combine 2-byte values */(uStack_14c,local_150);
    local_1f0 = (double)CONCAT44 /* combine 2-byte values */(uStack_1a4,local_1a8) - (double)CONCAT44 /* combine 2-byte values */(uStack_144,local_148);
    pdVar14 = &local_200;
    pdVar16 = &local_1a0;
    ...
    dVar2 = ((double)CONCAT44 /* combine 2-byte values */(uStack_314,local_318) * 10) /
    ...
    local_128 = (double)CONCAT44 /* combine 2-byte values */(uStack_1b4,local_1b8) + local_1a0 * dVar2;
    local_120 = (double)CONCAT44 /* combine 2-byte values */(uStack_1ac,local_1b0) + local_198 * dVar2;
    local_118 = (double)CONCAT44 /* combine 2-byte values */(uStack_1a4,local_1a8) + local_190 * dVar2;
    pdVar14 = &local_128;
    pdVar16 = &local_278;
    for (iVar15 = 6; iVar15 != 0; iVar15 = iVar15 + -1) {
      *(uint *)pdVar16 = *(uint *)pdVar14;
    ...
    do {
      ...
      if (local_1c < local_1c + local_28) {
        do {
          ...
          local_290 = (double)CONCAT44 /* combine 2-byte values */(uStack_2bc,local_2c0) - local_2a8;
          local_288 = (double)CONCAT44 /* combine 2-byte values */(uStack_2b4,local_2b8) - local_2a0;
          local_280 = (double)CONCAT44 /* combine 2-byte values */(uVar12,local_2b0) - local_298;
          pdVar14 = &local_290;
          pdVar16 = &local_230;
          for (iVar15 = 6; iVar15 != 0; iVar15 = iVar15 + -1) {
            *(uint *)pdVar16 = *(uint *)pdVar14;
          ...
          local_218 = (double)CONCAT44 /* combine 2-byte values */(uStack_f4,local_f8) - local_2d8;
          local_210 = (double)CONCAT44 /* combine 2-byte values */(uStack_ec,local_f0) - local_2d0;
          local_208 = (double)CONCAT44 /* combine 2-byte values */(uStack_e4,local_e8) - local_2c8;
          pdVar14 = &local_218;
          pdVar16 = &local_188;
          for (iVar15 = 6; iVar15 != 0; iVar15 = iVar15 + -1) {
            *(uint *)pdVar16 = *(uint *)pdVar14;
    ...
    if (*(int *)(*local_1c * 0x60 + in_stack_00000008 + 0xc) == 0) {
      if (local_20 != 0) {
        ...
        do {
          ...
          dVar8 = (double)CONCAT44 /* combine 2-byte values */(uStack_16c,local_170) - (double)CONCAT44 /* combine 2-byte values */(uStack_25c,local_260);
          dVar3 = (double)CONCAT44 /* combine 2-byte values */(uStack_164,local_168) - (double)CONCAT44 /* combine 2-byte values */(uStack_254,local_258);
          dVar2 = (double)CONCAT44 /* combine 2-byte values */(uStack_15c,local_160) - (double)CONCAT44 /* combine 2-byte values */(uStack_24c,local_250);
