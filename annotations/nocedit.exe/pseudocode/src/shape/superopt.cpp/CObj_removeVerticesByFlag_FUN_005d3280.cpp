...
// Convention: __cdecl
// Signature: void shape_superopt.cpp_CObj_removeVerticesByFlag_FUN_005d3280(CObj * this_ptr, uint flag_mask)
...

{
  ...
  if (this_ptr->vertex_count != 0) {
    do {
      if ((this_ptr->vertex_data[index].flags & flag_mask) == flag_mask) {
