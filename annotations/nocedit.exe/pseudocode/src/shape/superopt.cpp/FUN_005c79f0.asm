...
section .text
    ...
    JNZ 0x005c7a74                      ; 005c7a03 | LAB_005c7a74
    ...
    JBE 0x005c7a40                      ; 005c7a13 | LAB_005c7a40
    ...
    INC EBX                             ; 005c7a22
    CALL crt_memory.c_free_FUN_005fe659 ; 005c7a23 | void crt_memory.c_free_FUN_005fe659(void * ptr)
        ;   XREF to: 005fe659 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EDI + 0x8]       ; 005c7a28
    ADD ESP,0x4                         ; 005c7a2b
    CMP EBX,EAX                         ; 005c7a2e
    JC 0x005c7a17                       ; 005c7a30 | LAB_005c7a17
    ...
    JNZ 0x005c7a7f                      ; 005c7a4c | LAB_005c7a7f
    ...
    CALL crt_memory.c_free_FUN_005fe659 ; 005c7a60 | void crt_memory.c_free_FUN_005fe659(void * ptr)
        ;   XREF to: 005fe659 (UNCONDITIONAL_CALL)
    ...
    PUSH EDX                            ; 005c7a74
        ;   Label: LAB_005c7a74
    CALL crt_memory.c_free_FUN_00601cd0 ; 005c7a75 | void crt_memory.c_free_FUN_00601cd0(void * ptr)
        ;   XREF to: 00601cd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005c7a7a
    JMP 0x005c7a05                      ; 005c7a7d | LAB_005c7a05
        ;   XREF to: 005c7a05 (UNCONDITIONAL_JUMP)
    PUSH EDX                            ; 005c7a7f
        ;   Label: LAB_005c7a7f
    CALL crt_memory.c_free_FUN_00601cd0 ; 005c7a80 | void crt_memory.c_free_FUN_00601cd0(void * ptr)
        ;   XREF to: 00601cd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005c7a85
    JMP 0x005c7a4e                      ; 005c7a88 | LAB_005c7a4e
