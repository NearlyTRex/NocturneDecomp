// Name: shape_superopt.cpp_CPoly_FUN_005d12d0
// Address: 005d12d0
// Address Range: [[005d12d0, 005d1386]]
// Convention: __cdecl
// Signature: int shape_superopt.cpp_CPoly_FUN_005d12d0(CPoly * this_ptr)

#include "nocturne.h"

int __cdecl shape_superopt_cpp_CPoly_FUN_005d12d0(CPoly *this_ptr)

{
  ...
  if ((((((this_ptr->vertex_idx_0 != *(int *)(in_stack_00000008 + 4)) ||
       ...
       ((*(int *)(in_stack_00000008 + 0xc) != *piVar1 || (*piVar2 != this_ptr->vertex_idx_1)))) &&
      ((*(int *)(in_stack_00000008 + 8) != this_ptr->vertex_idx_1 ||
     ...
     (((((*(int *)(in_stack_00000008 + 0xc) != this_ptr->vertex_idx_1 ||
       ...
       ((*(int *)(in_stack_00000008 + 0xc) != this_ptr->vertex_idx_2 || (*piVar2 != *piVar1)))) &&
      (((*piVar2 != this_ptr->vertex_idx_2 || (*(int *)(in_stack_00000008 + 8) != *piVar1)) &&
       ((*(int *)(in_stack_00000008 + 8) != this_ptr->vertex_idx_2 ||
...
// Assembly code:
// 005d12d0: PUSH EBX
//   Label: shape_superopt.cpp_CPoly_FUN_005d12d0
// 005d12d1: PUSH ESI
// 005d12d2: PUSH EDI
// 005d12d3: PUSH EBP
