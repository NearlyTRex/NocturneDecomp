// Name: shape_superopt.cpp_FUN_005d1ff0
// Address: 005d1ff0
// Address Range: [[005d1ff0, 005d2224]]
// Convention: unknown
// Signature: undefined shape_superopt.cpp_FUN_005d1ff0()
// Globals:
//   undefined4 DAT_0065431a
//   undefined4 DAT_00654322

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Signature: undefined1 shape_superopt.cpp_FUN_005d1ff0(undefined4 param_1) */

undefined4 shape_superopt_cpp_FUN_005d1ff0(void)

{
  ...
  if (((iVar4 != in_stack_00000004[2]) && (iVar1 = in_stack_00000004[3], iVar4 != iVar1)) &&
     (in_stack_00000004[2] != iVar1)) {
    iVar4 = iVar4 * 0x38;
    iVar2 = *(int *)(*in_stack_00000004 + 4);
    iVar1 = iVar1 * 0x38;
    local_68 = *(double *)(iVar2 + iVar1) - *(double *)(iVar2 + iVar4);
    local_60 = *(double *)(iVar2 + 8 + iVar1) - *(double *)(iVar2 + 8 + iVar4);
    local_58 = *(double *)(iVar2 + 0x10 + iVar1) - *(double *)(iVar2 + 0x10 + iVar4);
    pdVar5 = &local_68;
    pdVar6 = &local_50;
    for (iVar4 = 6; iVar4 != 0; iVar4 = iVar4 + -1) {
      *(undefined4 *)pdVar6 = *(undefined4 *)pdVar5;
      pdVar5 = (double *)((int)pdVar5 + 4);
      pdVar6 = (double *)((int)pdVar6 + 4);
    }
    dVar3 = 1.0 / SQRT(local_40 * local_40 + local_50 * local_50 + local_48 * local_48);
    local_b0 = local_50 * dVar3;
    local_a8 = local_48 * dVar3;
    local_a0 = local_40 * dVar3;
    pdVar5 = (double *)(iVar2 + in_stack_00000004[1] * 0x38);
    iVar4 = in_stack_00000004[2] * 0x38;
    local_c8 = *(double *)(iVar2 + iVar4) - *pdVar5;
    local_c0 = *(double *)(iVar2 + 8 + iVar4) - pdVar5[1];
    local_b8 = *(double *)(iVar2 + 0x10 + iVar4) - pdVar5[2];
    pdVar5 = &local_c8;
    pdVar6 = &local_80;
    for (iVar4 = 6; iVar4 != 0; iVar4 = iVar4 + -1) {
      *(undefined4 *)pdVar6 = *(undefined4 *)pdVar5;
    ...
    local_e0 = local_50 * dVar3 * local_98 + local_48 * dVar3 * local_90 +
               local_40 * dVar3 * local_88;
    if (local_e0 < 0.0) {
      local_e0 = -local_e0;
    }
    if (local_e0 <= _DAT_0065431a) {
      (**(code **)(in_stack_00000004[0x19] + 0x44))();
      dVar3 = SQRT(*(double *)(in_stack_00000004 + 0x14) * *(double *)(in_stack_00000004 + 0x14) +
                   *(double *)(in_stack_00000004 + 0x10) * *(double *)(in_stack_00000004 + 0x10) +
                   *(double *)(in_stack_00000004 + 0x12) * *(double *)(in_stack_00000004 + 0x12));
      if ((_DAT_0065431a <= dVar3) && (dVar3 <= _DAT_00654322)) {
        return 1;
      }
    }
  }
...
// Assembly code:
// 005d1ff0: PUSH EBX
//   Label: shape_superopt.cpp_FUN_005d1ff0
// 005d1ff1: PUSH ESI
// 005d1ff2: PUSH EDI
// 005d1ff3: PUSH EBP
