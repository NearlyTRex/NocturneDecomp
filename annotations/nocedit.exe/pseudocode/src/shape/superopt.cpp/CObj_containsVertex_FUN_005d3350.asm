...
;                               FUNCTION
; *****************************************************************************
; __cdecl int shape_superopt.cpp_CObj_containsVertex_FUN_005d3350(CObj * this_ptr, CVert * vertex_ptr)
;
; Parameters:
...
section .text
    ...
    JC 0x005d332c                       ; 005d335b | LAB_005d332c
    ...
    JBE 0x005d332c                      ; 005d3376 | LAB_005d332c
        ;   XREF to: 005d332c (CONDITIONAL_JUMP)
