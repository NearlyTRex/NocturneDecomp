...

{
  ...
  if (this_ptr->expanded_edge_count != 0) {
    ...
    do {
      ...
      local_1d8 = dVar1 + local_118 + local_1e0;
      ...
      if ((((((ulonglong)local_1d8 & 0x7fffffff00000000) != 0) || (local_1d8._0_4_ != 0)) ||
        ...
        pdVar6 = &local_1d0;
        pdVar7 = &local_1b8;
        for (iVar4 = 6; pdVar2 = local_2c, iVar4 != 0; iVar4 = iVar4 + -1) {
          *(uint *)pdVar7 = *(uint *)pdVar6;
          pdVar6 = (double *)((int)pdVar6 + 4);
          pdVar7 = (double *)((int)pdVar7 + 4);
        }
        ...
        pdVar6 = (double *)(piVar5 + 0x10);
        local_40 = (double *)(piVar5 + 0x14);
        local_90 = *pdVar6 - *local_40;
        ...
        if ((local_3c == 1) || (local_24 == 1)) {
          if ((local_3c == -1) || (local_30 == -1)) {
            ...
            pdVar6 = (double *)(piVar5 + 10);
            pdVar7 = (double *)(piVar5 + 4);
            if (local_3c == -1) {
              ...
              (pSVar3->start_pos).x = *pdVar7;
              (pSVar3->start_pos).y = *(double *)(piVar5 + 6);
              (pSVar3->start_pos).z = *(double *)(piVar5 + 8);
              (pSVar3->end_pos).x = *pdVar6;
              (pSVar3->end_pos).y = *(double *)(piVar5 + 0xc);
              (pSVar3->end_pos).z = *(double *)(piVar5 + 0xe);
              pSVar3->start_uv[0] = *local_38;
              pSVar3->start_uv[1] = *(double *)(piVar5 + 0x12);
              pSVar3->end_uv[0] = *local_34;
              pSVar3->end_uv[1] = *(double *)(piVar5 + 0x16);
              iVar4 = *count_a;
              *(uint *)&buf_a[iVar4].end_pos.x = local_f8[0];
              *(uint *)((int)&buf_a[iVar4].end_pos.x + 4) = local_f8[1];
              *(uint *)&buf_a[iVar4].end_pos.y = local_f8[2];
              *(uint *)((int)&buf_a[iVar4].end_pos.y + 4) = local_f8[3];
              *(uint *)&buf_a[iVar4].end_pos.z = local_e8;
              *(uint *)((int)&buf_a[iVar4].end_pos.z + 4) = local_e4;
              iVar4 = *count_a;
              buf_a[iVar4].end_uv[0] = local_80;
              buf_a[iVar4].end_uv[1] = local_78;
              buf_a[*count_a].start_side = -1;
              buf_a[*count_a].end_side = 0;
              *count_a = *count_a + 1;
              local_18 = *count_b * 0x60;
              pSVar3 = buf_b + *count_b;
              pSVar3->start_vertex_index = *piVar5;
              pSVar3->end_vertex_index = piVar5[1];
              pSVar3->start_side = piVar5[2];
              pSVar3->end_side = piVar5[3];
              *(int *)&(pSVar3->start_pos).x = *(int *)pdVar7;
              *(int *)((int)&(pSVar3->start_pos).x + 4) = piVar5[5];
              *(int *)&(pSVar3->start_pos).y = piVar5[6];
              *(int *)((int)&(pSVar3->start_pos).y + 4) = piVar5[7];
              *(int *)&(pSVar3->start_pos).z = piVar5[8];
              *(int *)((int)&(pSVar3->start_pos).z + 4) = piVar5[9];
              *(int *)&(pSVar3->end_pos).x = *(int *)pdVar6;
              *(int *)((int)&(pSVar3->end_pos).x + 4) = piVar5[0xb];
              *(int *)&(pSVar3->end_pos).y = piVar5[0xc];
              *(int *)((int)&(pSVar3->end_pos).y + 4) = piVar5[0xd];
              *(int *)&(pSVar3->end_pos).z = piVar5[0xe];
              *(int *)((int)&(pSVar3->end_pos).z + 4) = piVar5[0xf];
              *(int *)pSVar3->start_uv = *(int *)local_38;
              *(int *)((int)pSVar3->start_uv + 4) = piVar5[0x11];
              *(int *)(pSVar3->start_uv + 1) = piVar5[0x12];
              *(int *)((int)pSVar3->start_uv + 0xc) = piVar5[0x13];
              *(int *)pSVar3->end_uv = *(int *)local_34;
              *(int *)((int)pSVar3->end_uv + 4) = piVar5[0x15];
              *(int *)(pSVar3->end_uv + 1) = piVar5[0x16];
              *(int *)((int)pSVar3->end_uv + 0xc) = piVar5[0x17];
              iVar4 = *count_b;
              *(uint *)&buf_b[iVar4].start_pos.x = local_f8[0];
              *(uint *)((int)&buf_b[iVar4].start_pos.x + 4) = local_f8[1];
              *(uint *)&buf_b[iVar4].start_pos.y = local_f8[2];
              *(uint *)((int)&buf_b[iVar4].start_pos.y + 4) = local_f8[3];
              *(uint *)&buf_b[iVar4].start_pos.z = local_e8;
              *(uint *)((int)&buf_b[iVar4].start_pos.z + 4) = local_e4;
              iVar4 = *count_b;
              buf_b[iVar4].start_uv[0] = local_80;
              buf_b[iVar4].start_uv[1] = local_78;
              ...
              *count_b = *count_b + 1;
              ...
              pSVar3->end_uv[1] = *(double *)(piVar5 + 0x16);
              iVar4 = *count_b;
              *(uint *)&buf_b[iVar4].end_pos.x = local_f8[0];
              *(uint *)((int)&buf_b[iVar4].end_pos.x + 4) = local_f8[1];
              *(uint *)&buf_b[iVar4].end_pos.y = local_f8[2];
              *(uint *)((int)&buf_b[iVar4].end_pos.y + 4) = local_f8[3];
              *(uint *)&buf_b[iVar4].end_pos.z = local_e8;
              *(uint *)((int)&buf_b[iVar4].end_pos.z + 4) = local_e4;
              iVar4 = *count_b;
              buf_b[iVar4].end_uv[0] = local_80;
              buf_b[iVar4].end_uv[1] = local_78;
              ...
              *(int *)((int)pSVar3->end_uv + 0xc) = piVar5[0x17];
              iVar4 = *count_a;
              *(uint *)&buf_a[iVar4].start_pos.x = local_f8[0];
              *(uint *)((int)&buf_a[iVar4].start_pos.x + 4) = local_f8[1];
              *(uint *)&buf_a[iVar4].start_pos.y = local_f8[2];
              *(uint *)((int)&buf_a[iVar4].start_pos.y + 4) = local_f8[3];
              *(uint *)&buf_a[iVar4].start_pos.z = local_e8;
              *(uint *)((int)&buf_a[iVar4].start_pos.z + 4) = local_e4;
              iVar4 = *count_a;
              buf_a[iVar4].start_uv[0] = local_80;
              buf_a[iVar4].start_uv[1] = local_78;
            ...
            pSVar3->start_side = piVar5[2];
            pSVar3->end_side = piVar5[3];
            (pSVar3->start_pos).x = *(double *)(piVar5 + 4);
            (pSVar3->start_pos).y = *(double *)(piVar5 + 6);
            (pSVar3->start_pos).z = *(double *)(piVar5 + 8);
            (pSVar3->end_pos).x = *(double *)(piVar5 + 10);
            (pSVar3->end_pos).y = *(double *)(piVar5 + 0xc);
            (pSVar3->end_pos).z = *(double *)(piVar5 + 0xe);
            pSVar3->start_uv[0] = *(double *)(piVar5 + 0x10);
            pSVar3->start_uv[1] = *(double *)(piVar5 + 0x12);
            *(int *)pSVar3->end_uv = piVar5[0x14];
            *(int *)((int)pSVar3->end_uv + 4) = piVar5[0x15];
            *(int *)(pSVar3->end_uv + 1) = piVar5[0x16];
            *(int *)((int)pSVar3->end_uv + 0xc) = piVar5[0x17];
          ...
          *(uint *)pSVar3->start_uv = *(uint *)pdVar6;
          *(int *)((int)pSVar3->start_uv + 4) = piVar5[0x11];
          *(int *)(pSVar3->start_uv + 1) = piVar5[0x12];
          *(int *)((int)pSVar3->start_uv + 0xc) = piVar5[0x13];
