...
; CComplexPolygon * Stack[0x8]:4   polygon
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 005d76e0
        ;   Label: shape_superopt.cpp_COptimize_addComplexPolygon_FUN_005d76e0
    PUSH ESI                            ; 005d76e1
    ...
    PUSH EAX                            ; 005d7730
    CALL shape_superopt.cpp_CComplexPolygon_ctor_FUN_005c79a0 ; 005d7731
