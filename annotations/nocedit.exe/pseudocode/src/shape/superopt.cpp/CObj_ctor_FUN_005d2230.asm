...
;                               FUNCTION
; *****************************************************************************
; __cdecl CObj * shape_superopt.cpp_CObj_ctor_FUN_005d2230(CObj * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005d2235
    MOV dword ptr [EBX + 0x18],0x663b64 ; 005d2236 | CObj_vtable g_CObjVTable
    CALL shape_superopt.cpp_CObj_reset_FUN_005d2280 ; 005d223d | void shape_superopt.cpp_CObj_reset_FUN_005d2280(CObj * this_ptr)
    ...
    PUSH ECX                            ; 005d224e
    PUSH EBX                            ; 005d224f
    CALL shape_superopt.cpp_CObj_init_FUN_005d22d0 ; 005d2250 | int shape_superopt.cpp_CObj_init_FUN_005d22d0(CObj * this_ptr, int poly_count, int vertex_count)
