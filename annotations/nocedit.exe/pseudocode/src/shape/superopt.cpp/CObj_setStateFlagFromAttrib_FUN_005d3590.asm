...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_superopt.cpp_CObj_setStateFlagFromAttrib_FUN_005d3590(CObj * this_ptr, uint flag_to_set, uint attrib_mask)
;
; Parameters:
...
section .text
    ...
    JC 0x005d35ab                       ; 005d35bf | LAB_005d35ab
