...

{
  ...
  if ((dVar5 < dVar4) || (dVar5 < local_1b0)) {
    if ((dVar4 < dVar5) || (dVar4 < local_1b0)) {
      if (0.0 <= (this_ptr->normal).z) {
        ...
        local_138 = *(undefined4 *)&pCVar2[iVar1].position.x;
        local_1a4.x._0_4_ = *(undefined4 *)((int)&pCVar2[iVar1].position.x + 4);
        local_1a4.x._4_4_ = *(undefined4 *)&pCVar2[iVar1].position.y;
        local_1a4.y._0_4_ = *(undefined4 *)((int)&pCVar2[iVar1].position.y + 4);
        iVar1 = this_ptr->vertex_idx_1;
        local_178.x._0_4_ = *(undefined4 *)&pCVar2[iVar1].position.x;
        local_178.x._4_4_ = *(undefined4 *)((int)&pCVar2[iVar1].position.x + 4);
        local_178.y._0_4_ = *(undefined4 *)&pCVar2[iVar1].position.y;
        local_178.y._4_4_ = *(undefined4 *)((int)&pCVar2[iVar1].position.y + 4);
        iVar1 = this_ptr->vertex_idx_2;
        local_1a4.y._4_4_ = *(undefined4 *)&pCVar2[iVar1].position.x;
        local_194 = *(undefined4 *)((int)&pCVar2[iVar1].position.x + 4);
        local_190._0_4_ = *(undefined4 *)&pCVar2[iVar1].position.y;
        local_190._4_4_ = *(undefined4 *)((int)&pCVar2[iVar1].position.y + 4);
        ...
        local_158 = *(undefined4 *)&(pCVar2->position).x;
        local_1a4.x._0_4_ = *(undefined4 *)((int)&(pCVar2->position).x + 4);
        local_1a4.x._4_4_ = *(undefined4 *)&(pCVar2->position).y;
        local_1a4.y._0_4_ = *(undefined4 *)((int)&(pCVar2->position).y + 4);
      ...
      local_190._8_4_ = *(undefined4 *)&point->x;
      local_184._0_4_ = *(undefined4 *)((int)&point->x + 4);
      local_184._4_4_ = *(undefined4 *)&point->y;
      local_17c = *(undefined4 *)((int)&point->y + 4);
      ...
      if ((this_ptr->normal).y <= 0.0) {
        iVar1 = this_ptr->vertex_idx_0;
        local_58 = *(undefined4 *)&pCVar2[iVar1].position.x;
        local_1a4.x._0_4_ = *(undefined4 *)((int)&pCVar2[iVar1].position.x + 4);
        local_1a4.x._4_4_ = *(undefined4 *)&pCVar2[iVar1].position.z;
        local_1a4.y._0_4_ = *(undefined4 *)((int)&pCVar2[iVar1].position.z + 4);
        iVar1 = this_ptr->vertex_idx_1;
        local_178.x._0_4_ = *(undefined4 *)&pCVar2[iVar1].position.x;
        local_178.x._4_4_ = *(undefined4 *)((int)&pCVar2[iVar1].position.x + 4);
        local_178.y._0_4_ = *(undefined4 *)&pCVar2[iVar1].position.z;
        local_178.y._4_4_ = *(undefined4 *)((int)&pCVar2[iVar1].position.z + 4);
        pCVar2 = pCVar2 + this_ptr->vertex_idx_2;
        local_1a4.y._4_4_ = *(undefined4 *)&(pCVar2->position).x;
        local_194 = *(undefined4 *)((int)&(pCVar2->position).x + 4);
        local_190._0_4_ = *(undefined4 *)&(pCVar2->position).z;
        local_190._4_4_ = *(undefined4 *)((int)&(pCVar2->position).z + 4);
        ...
        local_1a4.y._4_4_ = *(undefined4 *)&pCVar2[iVar1].position.x;
        local_194 = *(undefined4 *)((int)&pCVar2[iVar1].position.x + 4);
        local_190._0_4_ = *(undefined4 *)&pCVar2[iVar1].position.z;
        local_190._4_4_ = *(undefined4 *)((int)&pCVar2[iVar1].position.z + 4);
        iVar1 = this_ptr->vertex_idx_1;
        local_178.x._0_4_ = *(undefined4 *)&pCVar2[iVar1].position.x;
        local_178.x._4_4_ = *(undefined4 *)((int)&pCVar2[iVar1].position.x + 4);
        local_178.y._0_4_ = *(undefined4 *)&pCVar2[iVar1].position.z;
        local_178.y._4_4_ = *(undefined4 *)((int)&pCVar2[iVar1].position.z + 4);
        pCVar2 = pCVar2 + this_ptr->vertex_idx_2;
        local_70 = *(undefined4 *)&(pCVar2->position).x;
        local_1a4.x._0_4_ = *(undefined4 *)((int)&(pCVar2->position).x + 4);
        local_1a4.x._4_4_ = *(undefined4 *)&(pCVar2->position).z;
        local_1a4.y._0_4_ = *(undefined4 *)((int)&(pCVar2->position).z + 4);
      ...
      local_190._8_4_ = *(undefined4 *)&point->x;
      local_184._0_4_ = *(undefined4 *)((int)&point->x + 4);
      local_184._4_4_ = *(undefined4 *)&point[1].x;
      local_17c = *(undefined4 *)((int)&point[1].x + 4);
    ...
    if (0.0 <= (this_ptr->normal).x) {
      iVar1 = this_ptr->vertex_idx_0;
      local_50 = *(undefined4 *)&pCVar2[iVar1].position.y;
      local_1a4.x._0_4_ = *(undefined4 *)((int)&pCVar2[iVar1].position.y + 4);
      local_1a4.x._4_4_ = *(undefined4 *)&pCVar2[iVar1].position.z;
      local_1a4.y._0_4_ = *(undefined4 *)((int)&pCVar2[iVar1].position.z + 4);
      iVar1 = this_ptr->vertex_idx_1;
      local_178.x._0_4_ = *(undefined4 *)&pCVar2[iVar1].position.y;
      local_178.x._4_4_ = *(undefined4 *)((int)&pCVar2[iVar1].position.y + 4);
      local_178.y._0_4_ = *(undefined4 *)&pCVar2[iVar1].position.z;
      local_178.y._4_4_ = *(undefined4 *)((int)&pCVar2[iVar1].position.z + 4);
      iVar1 = this_ptr->vertex_idx_2;
      local_1a4.y._4_4_ = *(undefined4 *)&pCVar2[iVar1].position.y;
      local_194 = *(undefined4 *)((int)&pCVar2[iVar1].position.y + 4);
      local_190._0_4_ = *(undefined4 *)&pCVar2[iVar1].position.z;
      local_190._4_4_ = *(undefined4 *)((int)&pCVar2[iVar1].position.z + 4);
      ...
      local_178.y._4_4_ = *(undefined4 *)((int)&pCVar2[iVar1].position.z + 4);
      iVar1 = this_ptr->vertex_idx_2;
      local_130 = *(undefined4 *)&pCVar2[iVar1].position.y;
      local_1a4.x._0_4_ = *(undefined4 *)((int)&pCVar2[iVar1].position.y + 4);
      local_1a4.x._4_4_ = *(undefined4 *)&pCVar2[iVar1].position.z;
      local_1a4.y._0_4_ = *(undefined4 *)((int)&pCVar2[iVar1].position.z + 4);
    ...
    local_190._8_4_ = *(undefined4 *)&point->y;
    local_184._0_4_ = *(undefined4 *)((int)&point->y + 4);
    local_184._4_4_ = *(undefined4 *)&point[1].x;
    local_17c = *(undefined4 *)((int)&point[1].x + 4);
  ...
  dVar3 = shape_superopt_cpp_getSignedTriangleArea2D_FUN_005d6640
                    (&local_178,(CVector2d *)(local_190 + 8),SUB84(dVar4,0));
  uStack_14 = SUB84(dVar3,0);
  uStack_10 = (undefined4)((ulonglong)dVar3 >> 0x20);
  if (dVar3 <= 0.0) {
    ...
    uStack_10 = SUB84(dVar4,0);
    if (dVar4 <= 0.0) {
      dVar5 = shape_superopt_cpp_getSignedTriangleArea2D_FUN_005d6640
                        ((CVector2d *)local_190,(CVector2d *)(local_184 + 4),SUB84(dVar5,0));
      if (dVar5 <= 0.0) {
        return 1;
      }
    }
...
// 005d0587: PUSH EAX
// 005d0588: CALL shape_superopt.cpp_getSignedTriangleArea2D_FUN_005d6640
...
//   XREF to: Stack[-0x178] (DATA)
// 005d0c64: PUSH EAX
// 005d0c65: CALL shape_superopt.cpp_getSignedTriangleArea2D_FUN_005d6640
//   XREF to: 005d6640 (UNCONDITIONAL_CALL)
...
//   XREF to: Stack[-0x1a8] (DATA)
// 005d0c9d: PUSH EAX
// 005d0c9e: CALL shape_superopt.cpp_getSignedTriangleArea2D_FUN_005d6640
//   XREF to: 005d6640 (UNCONDITIONAL_CALL)
