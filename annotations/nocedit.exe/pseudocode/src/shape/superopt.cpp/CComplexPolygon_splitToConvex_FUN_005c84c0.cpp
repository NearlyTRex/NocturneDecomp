  ...
  if (this_ptr->expanded_edge_count != 0) {
    ...
    if (this_ptr->expanded_edge_count != 0) {
      ...
      while( true ) {
        ...
        if (iVar6 == 0) break;
        puVar9 = (uint *)(iVar6 + 0x10);
        pCVar12 = &local_114;
        for (iVar4 = 6; iVar4 != 0; iVar4 = iVar4 + -1) {
          *(uint *)&pCVar12->x = *puVar9;
          puVar9 = puVar9 + (uint)bVar10 * -2 + 1;
          pCVar12 = (CVector3d *)((int)pCVar12 + (uint)bVar10 * -8 + 4);
        }
        local_fc = *(double *)(iVar6 + 0x28) - *(double *)(iVar6 + 0x10);
        local_f4 = *(double *)(iVar6 + 0x30) - *(double *)(iVar6 + 0x18);
        local_ec = *(double *)(iVar6 + 0x38) - *(double *)(iVar6 + 0x20);
        pdVar10 = &local_fc;
        puVar9 = &local_84;
      ...
      local_e4 = *(double *)(iVar6 + 0x28) - *(double *)(iVar6 + 0x10);
      local_dc = *(double *)(iVar6 + 0x30) - *(double *)(iVar6 + 0x18);
      local_d4 = *(double *)(iVar6 + 0x38) - *(double *)(iVar6 + 0x20);
      pdVar7 = &local_e4;
      puVar9 = &local_54;
      for (iVar6 = 6; iVar6 != 0; iVar6 = iVar6 + -1) {
