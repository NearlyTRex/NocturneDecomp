...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_superopt.cpp_CObj_free_FUN_005d2600(CObj * this_ptr)
;
; Parameters:
...
section .text
    ...
    JNZ 0x005d2625                      ; 005d260b | LAB_005d2625
    ...
    JNZ 0x005d2630                      ; 005d2619 | LAB_005d2630
    ...
    PUSH EDX                            ; 005d2625
        ;   Label: LAB_005d2625
    CALL crt_memory.c_free_FUN_00601cd0 ; 005d2626 | void crt_memory.c_free_FUN_00601cd0(void * ptr)
        ;   XREF to: 00601cd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005d262b
    JMP 0x005d260d                      ; 005d262e | LAB_005d260d
        ;   XREF to: 005d260d (UNCONDITIONAL_JUMP)
    PUSH ESI                            ; 005d2630
        ;   Label: LAB_005d2630
    CALL crt_memory.c_free_FUN_00601cd0 ; 005d2631 | void crt_memory.c_free_FUN_00601cd0(void * ptr)
        ;   XREF to: 00601cd0 (UNCONDITIONAL_CALL)
