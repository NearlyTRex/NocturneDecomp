...
;                               FUNCTION
; *****************************************************************************
; __cdecl int shape_superopt.cpp_CObj_removePolygon_FUN_005d2f50(CObj * this_ptr, uint index)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 005d2f8c
    CALL crt_memory.c_realloc_FUN_00601df0 ; 005d2f8d | void * crt_memory.c_realloc_FUN_00601df0(void * ptr, ulong new_size)
        ;   XREF to: 00601df0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005d2f92
    TEST EAX,EAX                        ; 005d2f95
    JZ 0x005d2fa1                       ; 005d2f97 | LAB_005d2fa1
    ...
    PUSH EAX                            ; 005d2fee
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 005d2fef | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
        ;   XREF to: 005fe5e0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005d2ff4
    JMP 0x005d2f6c                      ; 005d2ff7 | LAB_005d2f6c
        ;   XREF to: 005d2f6c (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0xc]       ; 005d2ffc
        ;   Label: LAB_005d2ffc
    PUSH EAX                            ; 005d2fff
    CALL crt_memory.c_free_FUN_00601cd0 ; 005d3000 | void crt_memory.c_free_FUN_00601cd0(void * ptr)
