// Name: shape_superopt.cpp_FUN_005d5800
// Address: 005d5800
// Address Range: [[005d5800, 005d5baf]]
// Convention: unknown
// Signature: undefined shape_superopt.cpp_FUN_005d5800()
// Function calls:
...
/* Signature: undefined1 shape_superopt.cpp_FUN_005d5800(undefined4 param_1, undefined8 param_2,
   undefined4 param_3) */

undefined4 shape_superopt_cpp_FUN_005d5800(void)

{
  ...
  if (in_stack_00000010 == 0) {
    if (*(int *)(in_stack_00000004 + 8) == 0) {
      ...
      (**(code **)(*(int *)(in_stack_00000004 + 0x18) + 0x84))();
      uVar2 = (**(code **)(*(int *)(in_stack_00000004 + 0x18) + 0xd8))();
    }
    return uVar2;
  }
  *(byte *)(in_stack_00000010 + 0x61) = *(byte *)(in_stack_00000010 + 0x61) | 0x20;
  local_18 = *(int *)(in_stack_00000004 + 0xc);
  local_20 = 0;
  if (*(int *)(in_stack_00000004 + 8) != 0) {
    local_24 = (double *)(in_stack_00000010 + 0x40);
    pdVar6 = (double *)(local_18 + 0x40);
    piVar9 = (int *)(local_18 + 4);
    piVar4 = (int *)(in_stack_00000010 + 4);
    do {
      if (((*(byte *)(local_18 + 0x61) & 0x20) == 0) &&
         (1.0 - (double)CONCAT44(in_stack_0000000c,in_stack_00000008) <=
          pdVar6[2] * *(double *)(in_stack_00000010 + 0x50) +
          *pdVar6 * *local_24 + pdVar6[1] * *(double *)(in_stack_00000010 + 0x48))) {
        local_28 = 0xffffffff;
        if ((((*piVar9 == *(int *)(in_stack_00000010 + 8)) && (piVar9[1] == *piVar4)) ||
            ((*piVar9 == *(int *)(in_stack_00000010 + 0xc) &&
             (piVar9[1] == *(int *)(in_stack_00000010 + 8))))) ||
           ((*piVar9 == *piVar4 && (piVar9[1] == *(int *)(in_stack_00000010 + 0xc))))) {
          local_28 = 2;
LAB_005d59af:
          puVar1 = (undefined4 *)
                   (*(int *)(in_stack_00000004 + 4) + *(int *)(local_28 * 4 + local_18 + 4) * 0x38);
          local_14 = (undefined8 *)(in_stack_00000010 + 0x40);
          ...
          *puVar1 = local_58;
          ...
          puVar1[4] = local_48;
          puVar1[5] = local_44;
          *(undefined8 *)(local_18 + 0x40) = *local_14;
          *(undefined4 *)(local_18 + 0x48) = *(undefined4 *)(local_14 + 1);
          *(undefined4 *)(local_18 + 0x4c) = *(undefined4 *)((int)local_14 + 0xc);
          *(undefined4 *)(local_18 + 0x50) = *(undefined4 *)(local_14 + 2);
          *(undefined4 *)(local_18 + 0x54) = *(undefined4 *)((int)local_14 + 0x14);
          uVar2 = (**(code **)(*(int *)(in_stack_00000004 + 0x18) + 0xd8))();
          return uVar2;
        }
        ...
        if ((piVar9[1] == *piVar4) && (piVar9[2] == *(int *)(in_stack_00000010 + 0xc))) {
          local_28 = 0;
          goto LAB_005d59af;
        }
        if ((piVar9[1] == *(int *)(in_stack_00000010 + 8)) && (piVar9[2] == *piVar4)) {
          local_28 = 0;
          goto LAB_005d59af;
        }
        if ((piVar9[2] == *piVar4) && (*piVar9 == *(int *)(in_stack_00000010 + 0xc))) {
          local_28 = 1;
          goto LAB_005d59af;
        }
        if ((piVar9[2] == *(int *)(in_stack_00000010 + 8)) && (*piVar9 == *piVar4)) {
          local_28 = 1;
          goto LAB_005d59af;
        }
      ...
      piVar9 = piVar9 + 0x1a;
      local_20 = local_20 + 1;
    } while (local_20 < *(uint *)(in_stack_00000004 + 8));
  }
  local_1c = 0;
  iVar10 = *(int *)(in_stack_00000004 + 0xc);
  if (*(int *)(in_stack_00000004 + 8) != 0) {
    do {
      if ((*(byte *)(iVar10 + 0x61) & 0x20) != 0) {
        uVar7 = 0;
        iVar5 = *(int *)(in_stack_00000004 + 0xc);
        if (*(int *)(in_stack_00000004 + 8) != 0) {
          do {
            if (((*(byte *)(iVar5 + 0x61) & 0x20) == 0) &&
               (iVar3 = (**(code **)(*(int *)(iVar10 + 100) + 0x70))(), iVar3 != 0)) {
              uVar2 = (**(code **)(*(int *)(in_stack_00000004 + 0x18) + 0xd8))();
              return uVar2;
            }
            uVar7 = uVar7 + 1;
            iVar5 = iVar5 + 0x68;
          } while (uVar7 < *(uint *)(in_stack_00000004 + 8));
        }
      }
      iVar10 = iVar10 + 0x68;
      local_1c = local_1c + 1;
...
// Assembly code:
// 005d5800: PUSH EBX
//   Label: shape_superopt.cpp_FUN_005d5800
// 005d5801: PUSH ESI
// 005d5802: PUSH EDI
// 005d5803: PUSH EBP
