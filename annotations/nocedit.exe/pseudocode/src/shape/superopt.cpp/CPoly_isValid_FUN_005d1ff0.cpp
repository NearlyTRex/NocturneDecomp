...

{
  ...
  if (((iVar7 != this_ptr->vertex_idx_1) && (iVar5 = this_ptr->vertex_idx_2, iVar7 != iVar5)) &&
    ...
    local_c8._4_4_ = (undefined4)((ulonglong)dVar3 >> 0x20);
    local_c0._0_4_ = SUB84(dVar4,0);
    local_c0._4_4_ = (undefined4)((ulonglong)dVar4 >> 0x20);
    local_b8 = pCVar6[iVar7].position.z - (pCVar1->position).z;
    puVar9 = &local_c8;
    pdVar8 = &local_80;
    for (iVar7 = 6; iVar7 != 0; iVar7 = iVar7 + -1) {
      *(undefined4 *)pdVar8 = *(undefined4 *)puVar9;
