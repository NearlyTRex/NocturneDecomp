// Name: shape_superopt.cpp_FUN_005d3440
// Address: 005d3440
// Address Range: [[005d3440, 005d34c7]]
// Convention: unknown
// Signature: undefined shape_superopt.cpp_FUN_005d3440()

#include "nocturne.h"

/* Signature: undefined1 shape_superopt.cpp_FUN_005d3440(undefined4 param_1, undefined4 param_2,
   undefined4 param_3) */

void shape_superopt_cpp_FUN_005d3440(void)

{
  ...
  if (*in_stack_00000004 != 0) {
    do {
      uVar2 = *(uint *)(uVar1 + 0x34) & in_stack_0000000c;
      *(uint *)(uVar1 + 0x34) = uVar2;
      *(uint *)(uVar1 + 0x34) = uVar2 | in_stack_00000008;
      uVar3 = uVar3 + 1;
      uVar1 = uVar1 + 0x38;
  ...
  if (in_stack_00000004[2] != 0) {
    do {
      uVar3 = uVar3 + 1;
      (**(code **)(*(int *)(uVar1 + 100) + 0x20))();
      uVar1 = uVar1 + 0x68;
    } while (uVar3 < in_stack_00000004[2]);
  }
  uVar1 = in_stack_00000004[4];
  in_stack_00000004[4] = uVar1 & in_stack_0000000c;
  in_stack_00000004[4] = uVar1 & in_stack_0000000c | in_stack_00000008;
  return;
}
...
// Assembly code:
// 005d3440: PUSH EBX
//   Label: shape_superopt.cpp_FUN_005d3440
// 005d3441: PUSH ESI
// 005d3442: PUSH EDI
// 005d3443: PUSH EBP
