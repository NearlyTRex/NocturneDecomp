...
;                               FUNCTION
; *****************************************************************************
; unknown undefined shape_superopt.cpp_FUN_005c8160()
;
; Local Variables:
...
section .text
    ...
    JBE 0x005c8190                      ; 005c8182 | LAB_005c8190
    ...
    TEST EAX,EAX                        ; 005c818c
        ;   Label: LAB_005c818c
    JNZ 0x005c819c                      ; 005c818e | LAB_005c819c
        ;   XREF to: 005c819c (CONDITIONAL_JUMP)
    TEST EAX,EAX                        ; 005c8190
        ;   Label: LAB_005c8190
    JZ 0x005c8172                       ; 005c8192 | LAB_005c8172
    ...
    JNC 0x005c8250                      ; 005c81b9 | LAB_005c8250
    ...
    TEST EAX,EAX                        ; 005c81e6
        ;   Label: LAB_005c81e6
    JZ 0x005c8250                       ; 005c81e8 | LAB_005c8250
        ;   XREF to: 005c8250 (CONDITIONAL_JUMP)
    ...
    JNZ 0x005c8242                      ; 005c81f9 | LAB_005c8242
        ;   XREF to: 005c8242 (CONDITIONAL_JUMP)
    CMP EDX,dword ptr [ESP + 0xc]       ; 005c81fb
    JNZ 0x005c8242                      ; 005c81ff | LAB_005c8242
        ;   XREF to: 005c8242 (CONDITIONAL_JUMP)
    ...
    PUSH EBP                            ; 005c820b
    PUSH ESI                            ; 005c820c
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 005c820d | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
    ...
    PUSH EAX                            ; 005c8230
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 005c8231 | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
        ;   XREF to: 005fe5e0 (UNCONDITIONAL_CALL)
    ...
    JC 0x005c81e6                       ; 005c824e | LAB_005c81e6
    ...
    JC 0x005c818c                       ; 005c8269 | LAB_005c818c
        ;   XREF to: 005c818c (CONDITIONAL_JUMP)
    JMP 0x005c8190                      ; 005c826f | LAB_005c8190
