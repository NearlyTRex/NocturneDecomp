...

{
  ...
  *(undefined4 *)((int)&out_max->x + 4) = *(undefined4 *)((int)&(pCVar1->position).x + 4);
  ...
  if ((pCVar2->position).x < out_min->x) {
    ...
    *(undefined4 *)((int)&out_min->x + 4) = *(undefined4 *)((int)&(pCVar2->position).x + 4);
  }
  if ((pCVar2->position).y < out_min->y) {
    *(undefined4 *)&out_min->y = *(undefined4 *)&(pCVar2->position).y;
    *(undefined4 *)((int)&out_min->y + 4) = *(undefined4 *)((int)&(pCVar2->position).y + 4);
  }
  if ((pCVar2->position).z < out_min->z) {
    *(undefined4 *)&out_min->z = *(undefined4 *)&(pCVar2->position).z;
    *(undefined4 *)((int)&out_min->z + 4) = *(undefined4 *)((int)&(pCVar2->position).z + 4);
  }
  if (out_max->x < (pCVar2->position).x) {
    *(undefined4 *)&out_max->x = *(undefined4 *)&(pCVar2->position).x;
    *(undefined4 *)((int)&out_max->x + 4) = *(undefined4 *)((int)&(pCVar2->position).x + 4);
  }
  if (out_max->y < (pCVar2->position).y) {
    *(undefined4 *)&out_max->y = *(undefined4 *)&(pCVar2->position).y;
    *(undefined4 *)((int)&out_max->y + 4) = *(undefined4 *)((int)&(pCVar2->position).y + 4);
  }
  if (out_max->z < (pCVar2->position).z) {
    *(undefined4 *)&out_max->z = *(undefined4 *)&(pCVar2->position).z;
    *(undefined4 *)((int)&out_max->z + 4) = *(undefined4 *)((int)&(pCVar2->position).z + 4);
  }
  if ((pCVar4->position).x < out_min->x) {
    *(undefined4 *)&out_min->x = *(undefined4 *)&(pCVar4->position).x;
    *(undefined4 *)((int)&out_min->x + 4) = *(undefined4 *)((int)&(pCVar4->position).x + 4);
  }
  if ((pCVar4->position).y < out_min->y) {
    *(undefined4 *)&out_min->y = *(undefined4 *)&(pCVar4->position).y;
    *(undefined4 *)((int)&out_min->y + 4) = *(undefined4 *)((int)&(pCVar4->position).y + 4);
  }
  if ((pCVar4->position).z < out_min->z) {
    *(undefined4 *)&out_min->z = *(undefined4 *)&(pCVar4->position).z;
    *(undefined4 *)((int)&out_min->z + 4) = *(undefined4 *)((int)&(pCVar4->position).z + 4);
  }
  if (out_max->x < (pCVar4->position).x) {
    *(undefined4 *)&out_max->x = *(undefined4 *)&(pCVar4->position).x;
    *(undefined4 *)((int)&out_max->x + 4) = *(undefined4 *)((int)&(pCVar4->position).x + 4);
  }
  if (out_max->y < (pCVar4->position).y) {
    *(undefined4 *)&out_max->y = *(undefined4 *)&(pCVar4->position).y;
    *(undefined4 *)((int)&out_max->y + 4) = *(undefined4 *)((int)&(pCVar4->position).y + 4);
  }
  if ((pCVar4->position).z <= out_max->z) {
    return;
  }
  *(undefined4 *)&out_max->z = *(undefined4 *)&(pCVar4->position).z;
  *(undefined4 *)((int)&out_max->z + 4) = *(undefined4 *)((int)&(pCVar4->position).z + 4);
  return;
}
