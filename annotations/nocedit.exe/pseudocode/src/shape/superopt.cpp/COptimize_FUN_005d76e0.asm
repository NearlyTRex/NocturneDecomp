...
section .text
    ...
    PUSH 0x34                           ; 005d7722
        ;   Label: LAB_005d7722
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1d0 ; 005d7724 | void * shape_memdbg.cpp_debugAlloc_FUN_0050f1d0(int size)
        ;   XREF to: 0050f1d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005d7729
    TEST EAX,EAX                        ; 005d772c
    JZ 0x005d7739                       ; 005d772e | LAB_005d7739
        ;   XREF to: 005d7739 (CONDITIONAL_JUMP)
    PUSH EAX                            ; 005d7730
    CALL shape_superopt.cpp_FUN_005c79a0 ; 005d7731 | undefined shape_superopt.cpp_FUN_005c79a0()
    ...
    JNZ 0x005d7708                      ; 005d773f | LAB_005d7708
