// Name: shape_superopt.cpp_FUN_005d3400
// Address: 005d3400
// Address Range: [[005d3400, 005d3433]]
// Convention: unknown
// Signature: undefined shape_superopt.cpp_FUN_005d3400()

#include "nocturne.h"

/* Signature: undefined1 shape_superopt.cpp_FUN_005d3400(undefined4 param_1, undefined4 param_2) */

undefined4 shape_superopt_cpp_FUN_005d3400(void)

{
  ...
  if ((*(uint *)(in_stack_00000004 + 0xc) <= in_stack_00000008) &&
     (in_stack_00000008 <
      (uint)(*(int *)(in_stack_00000004 + 0xc) + *(int *)(in_stack_00000004 + 8) * 0x68))) {
    return 1;
  }
  return 0;
}
...
//   Label: shape_superopt.cpp_FUN_005d3400
