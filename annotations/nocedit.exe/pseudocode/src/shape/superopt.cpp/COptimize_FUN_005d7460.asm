...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_superopt.cpp_COptimize_FUN_005d7460(COptimize * this_ptr)
;
; Parameters:
...
section .text
    ...
    JBE 0x005d74d2                      ; 005d7496 | LAB_005d74d2
    ...
    JZ 0x005d74e0                       ; 005d74b2 | LAB_005d74e0
    ...
    JC 0x005d749c                       ; 005d74d0 | LAB_005d749c
        ;   XREF to: 005d749c (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x30],0x0      ; 005d74d2
        ;   Label: LAB_005d74d2
    JZ 0x005d747f                       ; 005d74d7 | LAB_005d747f
    ...
    TEST DH,0x20                        ; 005d74e0
        ;   Label: LAB_005d74e0
    JZ 0x005d74b4                       ; 005d74e3 | LAB_005d74b4
    ...
    JBE 0x005d74b4                      ; 005d7510 | LAB_005d74b4
        ;   XREF to: 005d74b4 (CONDITIONAL_JUMP)
    ...
    JZ 0x005d7555                       ; 005d752d | LAB_005d7555
    ...
    JNC 0x005d74b4                      ; 005d754d | LAB_005d74b4
        ;   XREF to: 005d74b4 (CONDITIONAL_JUMP)
    JMP 0x005d751d                      ; 005d7553 | LAB_005d751d
    ...
    JNZ 0x005d752f                      ; 005d755f | LAB_005d752f
    ...
    FNSTSW AX                           ; 005d7580
    SAHF                                ; 005d7582
    JC 0x005d752f                       ; 005d7583 | LAB_005d752f
        ;   XREF to: 005d752f (CONDITIONAL_JUMP)
    PUSH EBX                            ; 005d7585
    ...
    FNSTSW AX                           ; 005d75ac
    SAHF                                ; 005d75ae
    JA 0x005d7644                       ; 005d75af | LAB_005d7644
    ...
    FNSTSW AX                           ; 005d75ce
    SAHF                                ; 005d75d0
    JA 0x005d752f                       ; 005d75d1 | LAB_005d752f
        ;   XREF to: 005d752f (CONDITIONAL_JUMP)
    PUSH EBX                            ; 005d75d7
    ...
    JZ 0x005d7652                       ; 005d7614 | LAB_005d7652
    ...
    JNZ 0x005d7624                      ; 005d7664 | LAB_005d7624
        ;   XREF to: 005d7624 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 005d7666
    ...
    JNZ 0x005d7624                      ; 005d7673 | LAB_005d7624
        ;   XREF to: 005d7624 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 005d7675
    ...
    JNZ 0x005d7624                      ; 005d7685 | LAB_005d7624
        ;   XREF to: 005d7624 (CONDITIONAL_JUMP)
    JMP 0x005d7616                      ; 005d7687 | LAB_005d7616
