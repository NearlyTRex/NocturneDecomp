// Name: shape_superopt.cpp_CObj_FUN_005d2650
// Address: 005d2650
// Address Range: [[005d2650, 005d2715]]
// Convention: __cdecl
// Signature: int shape_superopt.cpp_CObj_FUN_005d2650(CObj * this_ptr)
// Cross-references:
...
int __cdecl shape_superopt_cpp_CObj_FUN_005d2650(CObj *this_ptr)

{
  ...
  (**this_ptr->vtable)();
  iVar2 = (**(code **)((int)this_ptr->vtable + 8))();
  if (iVar2 == 0) {
  ...
  for (uVar3 = (uint)(this_ptr->field0_0x0 * 0x38) >> 2; uVar3 != 0; uVar3 = uVar3 - 1) {
    *puVar5 = *puVar4;
  ...
  this_ptr->field4_0x10 = *(int *)(in_stack_00000008 + 0x10);
  return 1;
}
...
// Assembly code:
// 005d2650: PUSH EBX
//   Label: shape_superopt.cpp_CObj_FUN_005d2650
// 005d2651: PUSH EBP
