// Name: shape_superopt.cpp_FUN_005cd7d0
// Address: 005cd7d0
// Address Range: [[005cd7d0, 005cdfdf]]
// Convention: unknown
// Signature: undefined shape_superopt.cpp_FUN_005cd7d0()
// Cross-references:
//   shape_superopt.cpp_TriListSomething_FUN_005d77a0 (005d77a0) at 005d7add [UNCONDITIONAL_CALL]

#include "nocturne.h"

/* Signature: undefined1 shape_superopt.cpp_FUN_005cd7d0(undefined4 param_1) */

void shape_superopt_cpp_FUN_005cd7d0(void)

{
  ...
  pdVar6 = (double *)(iVar4 + in_stack_00000004[1] * 0x38);
  pdVar8 = (double *)(iVar4 + in_stack_00000004[2] * 0x38);
  local_158 = *pdVar8 - *pdVar6;
  local_150 = pdVar8[1] - pdVar6[1];
  local_18 = (double *)(iVar4 + in_stack_00000004[3] * 0x38);
  local_148 = pdVar8[2] - pdVar6[2];
  pdVar5 = &local_158;
  pdVar7 = &local_248;
  for (iVar4 = 6; iVar4 != 0; iVar4 = iVar4 + -1) {
    *(undefined4 *)pdVar7 = *(undefined4 *)pdVar5;
  ...
  local_278 = *local_18 - *pdVar8;
  local_270 = local_18[1] - pdVar8[1];
  local_268 = local_18[2] - pdVar8[2];
  pdVar5 = &local_278;
  pdVar7 = &local_188;
  for (iVar4 = 6; iVar4 != 0; iVar4 = iVar4 + -1) {
    *(undefined4 *)pdVar7 = *(undefined4 *)pdVar5;
  ...
  if (local_2d8 < 1.0) {
    ...
    *(double *)(in_stack_00000004 + 0x10) = local_1e8;
    *(double *)(in_stack_00000004 + 0x12) = local_1e0;
    *(double *)(in_stack_00000004 + 0x14) = local_1d8;
  }
  local_110 = *local_18 - *pdVar8;
  local_108 = local_18[1] - pdVar8[1];
  local_100 = local_18[2] - pdVar8[2];
  pdVar5 = &local_110;
  pdVar7 = &local_170;
  for (iVar4 = 6; iVar4 != 0; iVar4 = iVar4 + -1) {
    *(undefined4 *)pdVar7 = *(undefined4 *)pdVar5;
  ...
  local_1d0 = *pdVar6 - *local_18;
  local_1c8 = pdVar6[1] - local_18[1];
  local_1c0 = pdVar6[2] - local_18[2];
  pdVar5 = &local_1d0;
  pdVar7 = &local_200;
  for (iVar4 = 6; iVar4 != 0; iVar4 = iVar4 + -1) {
    *(undefined4 *)pdVar7 = *(undefined4 *)pdVar5;
  ...
  if (local_2e8 < (double)CONCAT44(uStack_2ec,local_2f0)) {
    ...
    *(double *)(in_stack_00000004 + 0x10) = local_b0;
    *(double *)(in_stack_00000004 + 0x12) = local_a8;
    *(double *)(in_stack_00000004 + 0x14) = local_a0;
  }
  local_140 = *pdVar6 - *local_18;
  local_138 = pdVar6[1] - local_18[1];
  local_130 = pdVar6[2] - local_18[2];
  pdVar5 = &local_140;
  pdVar7 = &local_230;
  for (iVar4 = 6; iVar4 != 0; iVar4 = iVar4 + -1) {
    *(undefined4 *)pdVar7 = *(undefined4 *)pdVar5;
  ...
  local_e0 = *pdVar8 - *pdVar6;
  local_d8 = pdVar8[1] - pdVar6[1];
  local_d0 = pdVar8[2] - pdVar6[2];
  pdVar6 = &local_e0;
  pdVar8 = &local_290;
  for (iVar4 = 6; iVar4 != 0; iVar4 = iVar4 + -1) {
  ...
  if (local_2a8 < (double)CONCAT44(uStack_2ec,local_2f0)) {
    *(double *)(in_stack_00000004 + 0x10) = local_210 * dVar3 - local_208 * dVar2;
    *(double *)(in_stack_00000004 + 0x12) = local_208 * dVar1 - local_218 * dVar3;
    *(double *)(in_stack_00000004 + 0x14) = local_218 * dVar2 - local_210 * dVar1;
  }
  dVar1 = 1.0 / SQRT(*(double *)(in_stack_00000004 + 0x14) * *(double *)(in_stack_00000004 + 0x14) +
                     *(double *)(in_stack_00000004 + 0x10) * *(double *)(in_stack_00000004 + 0x10) +
                     *(double *)(in_stack_00000004 + 0x12) * *(double *)(in_stack_00000004 + 0x12));
  *(double *)(in_stack_00000004 + 0x10) = *(double *)(in_stack_00000004 + 0x10) * dVar1;
  *(double *)(in_stack_00000004 + 0x12) = *(double *)(in_stack_00000004 + 0x12) * dVar1;
  *(double *)(in_stack_00000004 + 0x14) = *(double *)(in_stack_00000004 + 0x14) * dVar1;
  return;
}
...
// Assembly code:
// 005cd7d0: PUSH EBX
//   Label: shape_superopt.cpp_FUN_005cd7d0
// 005cd7d1: PUSH ESI
// 005cd7d2: PUSH EDI
// 005cd7d3: PUSH EBP
