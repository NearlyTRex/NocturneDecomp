...
; CObj *           Stack[0x8]:4   objects
; uint             Stack[0xc]:4   object_count
;
; XREF[1]:
;   shape_superopt.cpp_optimizeCubeTriList_FUN_005d77a0 at 005d7ccb
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 005d71e0
        ;   Label: shape_superopt.cpp_COptimize_setGeometry_FUN_005d71e0
    PUSH ESI                            ; 005d71e1
    PUSH EDI                            ; 005d71e2
    PUSH EBP                            ; 005d71e3
