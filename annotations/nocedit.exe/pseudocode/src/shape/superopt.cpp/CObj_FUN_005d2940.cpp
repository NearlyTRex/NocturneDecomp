// Name: shape_superopt.cpp_CObj_FUN_005d2940
// Address: 005d2940
// Address Range: [[005d2940, 005d2ab6]]
// Convention: __cdecl
// Signature: uint * shape_superopt.cpp_CObj_FUN_005d2940(CObj * this_ptr)

#include "nocturne.h"

uint * __cdecl shape_superopt_cpp_CObj_FUN_005d2940(CObj *this_ptr)

{
  ...
  local_18 = 0;
  pCVar4 = this_ptr;
  pdVar6 = (double *)this_ptr->vertex_data;
  if (this_ptr->field0_0x0 != 0) {
    do {
      ...
      *(CObj **)((int)pdVar6 + 0x14) = local_1c;
      local_18 = local_18 + 1;
      pCVar4 = local_1c;
      pdVar6 = pdVar6 + 7;
    } while (local_18 < (uint)this_ptr->field0_0x0);
  }
  return (uint *)pCVar4;
}
...
// Assembly code:
// 005d2940: PUSH EBX
//   Label: shape_superopt.cpp_CObj_FUN_005d2940
// 005d2941: PUSH ESI
// 005d2942: PUSH EDI
// 005d2943: PUSH EBP
