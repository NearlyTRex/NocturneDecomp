...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_superopt.cpp_CObj_restoreVertexPositionsWithFlag_FUN_005d38b0(CObj * this_ptr, uint flag_mask)
;
; Parameters:
...
section .text
    ...
    JC 0x005d38d0                       ; 005d38e9 | LAB_005d38d0
    ...
    JBE 0x005d3912                      ; 005d38f6 | LAB_005d3912
    ...
    JC 0x005d38fa                       ; 005d3956 | LAB_005d38fa
        ;   XREF to: 005d38fa (CONDITIONAL_JUMP)
    POP EBP                             ; 005d3958
    POP EDI                             ; 005d3959
    POP ESI                             ; 005d395a
