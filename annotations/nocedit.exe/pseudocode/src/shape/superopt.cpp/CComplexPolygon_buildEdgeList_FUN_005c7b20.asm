...
;
; XREF[1]:
;   shape_superopt.cpp_COptimize_optimizeComplex_FUN_005d7350 at 005d740b
;
; Called Functions:
;   shape_memdbg.cpp_free_FUN_005fe659
;   shape_memdbg.cpp_malloc_FUN_006021da
;   shape_superopt.cpp_CComplexPolygon_mergeAdjacentEdges_FUN_005c7dc0
;   shape_superopt.cpp_CComplexPolygon_orderEdgesIntoChain_FUN_005c8280
;   shape_superopt.cpp_CComplexPolygon_removedSharedEdges_FUN_005c8160
;
; *****************************************************************************
...
section .text
    ...
    PUSH ESI                            ; 005c7b20
        ;   Label: shape_superopt.cpp_CComplexPolygon_buildEdgeList_FUN_005c7b20
    PUSH EDI                            ; 005c7b21
    PUSH EBP                            ; 005c7b22
    ...
    PUSH EAX                            ; 005c7b5d
    CALL shape_memdbg.cpp_malloc_FUN_006021da ; 005c7b5e
    ...
    MOV EDI,dword ptr [ESP + 0x18]      ; 005c7d68
        ;   Label: LAB_005c7d68
    PUSH EDI                            ; 005c7d6c
    CALL shape_superopt.cpp_CComplexPolygon_removedSharedEdges_FUN_005c8160 ; 005c7d6d
        ;   XREF to: 005c8160 (UNCONDITIONAL_CALL)  ; void shape_superopt.cpp_CComplexPolygon_removedSharedEdges_FUN_005c8160(CComplexPolygon * this_ptr)
    ADD ESP,0x4                         ; 005c7d72
    PUSH EDI                            ; 005c7d75
    CALL shape_superopt.cpp_CComplexPolygon_mergeAdjacentEdges_FUN_005c7dc0 ; 005c7d76
        ;   XREF to: 005c7dc0 (UNCONDITIONAL_CALL)  ; void shape_superopt.cpp_CComplexPolygon_mergeAdjacentEdges_FUN_005c7dc0(CComplexPolygon * this_ptr)
    ...
    PUSH ECX                            ; 005c7d85
    PUSH EDI                            ; 005c7d86
    CALL shape_superopt.cpp_CComplexPolygon_orderEdgesIntoChain_FUN_005c8280 ; 005c7d87
    ...
    MOV ESI,dword ptr [EDI + 0x30]      ; 005c7d9f
        ;   Label: LAB_005c7d9f
    PUSH ESI                            ; 005c7da2
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 005c7da3
