// Name: shape_superopt.cpp_FUN_005d2720
// Address: 005d2720
// Address Range: [[005d2720, 005d2871]]
// Convention: unknown
// Signature: undefined shape_superopt.cpp_FUN_005d2720()
// Cross-references:
//   shape_superopt.cpp_setGeometry_CopyMergeObject_FUN_005d71e0 (005d71e0) at 005d722a [UNCONDITIONAL_CALL]
// Globals:
...
/* Signature: undefined1 shape_superopt.cpp_FUN_005d2720(undefined4 param_1, undefined4 param_2) */

longlong shape_superopt_cpp_FUN_005d2720(void)

{
  ...
  if ((*in_stack_00000008 != 0) &&
     (iVar3 = (**(code **)(in_stack_00000004[6] + 0x18))(), iVar3 == 0)) {
    shape_superopt_cpp_SomethingAboutLogTXTCreate_FUN_005c7910();
    return (ulonglong)extraout_EDX << 0x20;
  }
  if ((in_stack_00000008[2] != 0) &&
     (iVar3 = (**(code **)(in_stack_00000004[6] + 0x10))(), iVar3 == 0)) {
    shape_superopt_cpp_SomethingAboutLogTXTCreate_FUN_005c7910();
    return (ulonglong)extraout_EDX_00 << 0x20;
  }
  puVar5 = (undefined4 *)in_stack_00000008[1];
  puVar6 = (undefined4 *)(in_stack_00000004[1] + iVar2 * 0x38);
  for (uVar4 = (uint)(*in_stack_00000008 * 0x38) >> 2; uVar4 != 0; uVar4 = uVar4 - 1) {
    *puVar6 = *puVar5;
  ...
  uVar4 = in_stack_00000004[2];
  if (local_10 < uVar4) {
    iVar3 = local_10 * 0x68;
    do {
      (**(code **)(*(int *)(in_stack_00000004[3] + iVar3 + 100) + 4))();
      piVar1 = (int *)(iVar3 + 4 + in_stack_00000004[3]);
      *piVar1 = *piVar1 + iVar2;
      piVar1 = (int *)(iVar3 + 8 + in_stack_00000004[3]);
      *piVar1 = *piVar1 + iVar2;
      *(int *)(iVar3 + 0xc + in_stack_00000004[3]) =
           *(int *)(iVar3 + 0xc + in_stack_00000004[3]) + iVar2;
      local_10 = local_10 + 1;
      uVar4 = in_stack_00000004[2];
      iVar3 = iVar3 + 0x68;
...
// Assembly code:
// 005d2720: PUSH EBX
//   Label: shape_superopt.cpp_FUN_005d2720
// 005d2721: PUSH EDI
// 005d2722: PUSH EBP
...
// 005d284b: CALL shape_superopt.cpp_SomethingAboutLogTXTCreate_FUN_005c7910
...
// 005d2861: CALL shape_superopt.cpp_SomethingAboutLogTXTCreate_FUN_005c7910
//   XREF to: 005c7910 (UNCONDITIONAL_CALL)
