// Name: shape_superopt.cpp_CObj_FUN_005d37b0
// Address: 005d37b0
// Address Range: [[005d37b0, 005d385c]]
// Convention: __cdecl
// Signature: void * shape_superopt.cpp_CObj_FUN_005d37b0(CObj * this_ptr)

#include "nocturne.h"

void * __cdecl shape_superopt_cpp_CObj_FUN_005d37b0(CObj *this_ptr)

{
  ...
  if (puVar2 == in_stack_00000008) {
    pvVar3 = (void *)(*(code *)this_ptr->vtable->field36_0x90)();
    return pvVar3;
  }
  uVar4 = 0;
...
// Assembly code:
// 005d37b0: PUSH EBX
//   Label: shape_superopt.cpp_CObj_FUN_005d37b0
// 005d37b1: PUSH ESI
// 005d37b2: PUSH EDI
// 005d37b3: PUSH EBP
