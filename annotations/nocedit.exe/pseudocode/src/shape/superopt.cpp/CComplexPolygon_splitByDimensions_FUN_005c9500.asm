...
;   shape_superopt.cpp_CComplexPolygon_ctor_FUN_005c79a0
...
section .text
    ...
    PUSH EBX                            ; 005c9500
        ;   Label: shape_superopt.cpp_CComplexPolygon_splitByDimensions_FUN_005c9500
    PUSH ESI                            ; 005c9501
    PUSH EDI                            ; 005c9502
    PUSH EBP                            ; 005c9503
    ...
    CALL shape_superopt.cpp_CComplexPolygon_splitEdgesByPlane_FUN_005c9aa0 ; 005c976c
    ...
    PUSH EAX                            ; 005c97fd
    CALL shape_superopt.cpp_CComplexPolygon_ctor_FUN_005c79a0 ; 005c97fe
        ;   XREF to: 005c79a0 (UNCONDITIONAL_CALL)  ; CComplexPolygon * shape_superopt.cpp_CComplexPolygon_ctor_FUN_005c79a0(CComplexPolygon * this_ptr)
    ...
    CALL shape_superopt.cpp_CComplexPolygon_free_FUN_005c79f0 ; 005c984b
    ...
    PUSH ESI                            ; 005c9a16
    PUSH EBX                            ; 005c9a17
    CALL shape_superopt.cpp_CComplexPolygon_closeSplitBoundary_FUN_005ca590 ; 005c9a18
    ...
    PUSH EDX                            ; 005c9a2d
    PUSH EBX                            ; 005c9a2e
    CALL shape_superopt.cpp_CComplexPolygon_closeSplitBoundary_FUN_005ca590 ; 005c9a2f
        ;   XREF to: 005ca590 (UNCONDITIONAL_CALL)  ; int shape_superopt.cpp_CComplexPolygon_closeSplitBoundary_FUN_005ca590(CComplexPolygon * this_ptr, SExpandedEdge * edges, int * edge_count_ptr, int is_secondary)
