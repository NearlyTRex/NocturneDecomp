...
;
; Called Functions:
;   shape_superopt.cpp_CComplexPolygon_addSharedTriangle_FUN_005c7a90
;   shape_superopt.cpp_CComplexPolygon_buildEdgeList_FUN_005c7b20
...
section .text
    ...
    PUSH EBX                            ; 005d7350
        ;   Label: shape_superopt.cpp_COptimize_optimizeComplex_FUN_005d7350
    PUSH ESI                            ; 005d7351
    PUSH EDI                            ; 005d7352
    PUSH EBP                            ; 005d7353
    ...
    PUSH ECX                            ; 005d73de
    CALL shape_superopt.cpp_CComplexPolygon_addSharedTriangle_FUN_005c7a90 ; 005d73df
        ;   XREF to: 005c7a90 (UNCONDITIONAL_CALL)  ; int shape_superopt.cpp_CComplexPolygon_addSharedTriangle_FUN_005c7a90(CComplexPolygon * this_ptr, CPoly * poly)
    ...
    MOV EDX,dword ptr [ESP]             ; 005d7407
        ;   Label: LAB_005d7407
    PUSH EDX                            ; 005d740a
    CALL shape_superopt.cpp_CComplexPolygon_buildEdgeList_FUN_005c7b20 ; 005d740b
        ;   XREF to: 005c7b20 (UNCONDITIONAL_CALL)  ; int shape_superopt.cpp_CComplexPolygon_buildEdgeList_FUN_005c7b20(CComplexPolygon * this_ptr)
