// Name: shape_superopt.cpp_FUN_005d3960
// Address: 005d3960
// Address Range: [[005d3960, 005d3da1]]
// Convention: unknown
// Signature: undefined shape_superopt.cpp_FUN_005d3960()
// Function calls:
...
/* Signature: undefined1 shape_superopt.cpp_FUN_005d3960(undefined4 param_1, undefined4 param_2) */

void shape_superopt_cpp_FUN_005d3960(void)

{
  ...
  local_68 = (void *)0x0;
  iVar11 = *(int *)(in_stack_00000004 + 0xc);
  if (2000 < *(uint *)(in_stack_00000004 + 8)) {
    local_68 = shape_memdbg_cpp_debugAlloc_FUN_0050f1d0(4);
  }
  uVar14 = 0;
  if (*(int *)(in_stack_00000004 + 8) != 0) {
    do {
      (**(code **)(*(int *)(iVar11 + 100) + 0x44))();
      if (in_stack_00000008 != 0) {
        *(undefined4 *)(iVar11 + 0x58) = 7;
      }
      uVar14 = uVar14 + 1;
      iVar11 = iVar11 + 0x68;
    } while (uVar14 < *(uint *)(in_stack_00000004 + 8));
  }
  if (in_stack_00000008 != 0) {
    local_54 = *(int *)(in_stack_00000004 + 0xc);
    local_5c = 0;
    if (*(int *)(in_stack_00000004 + 8) != 0) {
      local_64 = 0x68;
      pdStack_60 = (double *)(local_54 + 0x40);
      local_58 = (uint *)(local_54 + 0x58);
      do {
        if ((*local_58 & 0x38) != 0x38) {
          iVar12 = local_64 + *(int *)(in_stack_00000004 + 0xc);
          iVar11 = *(int *)(local_54 + 4);
          iVar1 = *(int *)(local_54 + 8);
          iVar2 = *(int *)(local_54 + 0xc);
          uStack_2c = local_5c + 1;
          if (uStack_2c < *(uint *)(in_stack_00000004 + 8)) {
            puVar13 = (uint *)(iVar12 + 0x58);
            pdStack_1c = (double *)(iVar12 + 0x40);
            piVar15 = (int *)(iVar12 + 4);
            do {
              if (((*puVar13 & 0x38) != 0x38) &&
                 (0.9999 <= pdStack_60[2] * pdStack_1c[2] +
                            *pdStack_60 * *pdStack_1c + pdStack_60[1] * pdStack_1c[1])) {
                uVar14 = (uint)(iVar11 == *piVar15) * 2;
                uVar3 = (uint)(iVar1 == *piVar15) << 2;
                uVar4 = (uint)(iVar2 == *piVar15) << 3;
                uVar5 = (uint)(iVar11 == piVar15[1]) << 4;
                uVar6 = (uint)(iVar1 == piVar15[1]) << 5;
                uVar7 = (uint)(iVar2 == piVar15[1]) << 6;
                uVar16 = (uint)(iVar11 == piVar15[2]) << 7;
                uVar8 = (uint)(iVar1 == piVar15[2]) << 8;
                uVar9 = (uint)(iVar2 == piVar15[2]) << 9;
                if ((uVar3 | uVar5) == 0x14) {
                ...
                else if ((uVar16 | uVar6) == 0xa0) {
                  *(byte *)local_58 = (byte)*local_58 & 0xf6;
                  *(byte *)local_58 = (byte)*local_58 | 8;
                  *(byte *)puVar13 = (byte)*puVar13 & 0xed;
                  *(byte *)puVar13 = (byte)*puVar13 | 0x10;
                }
                else if ((uVar14 | uVar8) == 0x102) {
                  *(byte *)local_58 = (byte)*local_58 & 0xf6;
                  *(byte *)local_58 = (byte)*local_58 | 8;
                  *(byte *)puVar13 = (byte)*puVar13 & 0xdb;
                  *(byte *)puVar13 = (byte)*puVar13 | 0x20;
                }
                if ((uVar7 | uVar8) == 0x140) {
                  *(byte *)local_58 = (byte)*local_58 & 0xed;
                  *(byte *)local_58 = (byte)*local_58 | 0x10;
                  *(byte *)puVar13 = (byte)*puVar13 & 0xed;
                  *(byte *)puVar13 = (byte)*puVar13 | 0x10;
                }
                else if ((uVar9 | uVar3) == 0x204) {
                  *(byte *)local_58 = (byte)*local_58 & 0xed;
                  *(byte *)local_58 = (byte)*local_58 | 0x10;
                  *(byte *)puVar13 = (byte)*puVar13 & 0xdb;
                  *(byte *)puVar13 = (byte)*puVar13 | 0x20;
                }
                else if ((uVar4 | uVar6) == 0x28) {
                  *(byte *)local_58 = (byte)*local_58 & 0xed;
                  *(byte *)local_58 = (byte)*local_58 | 0x10;
                  *(byte *)puVar13 = (byte)*puVar13 & 0xf6;
                  *(byte *)puVar13 = (byte)*puVar13 | 8;
                }
                if ((uVar16 | uVar4) == 0x88) {
                  bVar10 = (byte)*local_58 & 0xdb;
                  *(byte *)local_58 = bVar10;
                  *(byte *)local_58 = bVar10 | 0x20;
                  bVar10 = (byte)*puVar13 & 0xdb;
                  *(byte *)puVar13 = bVar10;
                  *(byte *)puVar13 = bVar10 | 0x20;
                }
                else if ((uVar7 | uVar14) == 0x42) {
                  bVar10 = (byte)*local_58 & 0xdb;
                  *(byte *)local_58 = bVar10;
                  *(byte *)local_58 = bVar10 | 0x20;
                  bVar10 = (byte)*puVar13 & 0xf6;
                  *(byte *)puVar13 = bVar10;
                  *(byte *)puVar13 = bVar10 | 8;
                }
                else if ((uVar9 | uVar5) == 0x210) {
                  bVar10 = (byte)*local_58 & 0xdb;
                  *(byte *)local_58 = bVar10;
                  *(byte *)local_58 = bVar10 | 0x20;
                  bVar10 = (byte)*puVar13 & 0xed;
                  *(byte *)puVar13 = bVar10;
                  *(byte *)puVar13 = bVar10 | 0x10;
                }
              }
            ...
            } while (uStack_2c < *(uint *)(in_stack_00000004 + 8));
          }
        }
        local_64 = local_64 + 0x68;
        pdStack_60 = pdStack_60 + 0xd;
        *local_58 = *local_58 & 7;
        local_54 = local_54 + 0x68;
        local_5c = local_5c + 1;
        local_58 = local_58 + 0x1a;
      } while (local_5c < *(uint *)(in_stack_00000004 + 8));
    }
  }
...
// Assembly code:
// 005d3960: PUSH EBX
//   Label: shape_superopt.cpp_FUN_005d3960
// 005d3961: PUSH ESI
// 005d3962: PUSH EDI
// 005d3963: PUSH EBP
