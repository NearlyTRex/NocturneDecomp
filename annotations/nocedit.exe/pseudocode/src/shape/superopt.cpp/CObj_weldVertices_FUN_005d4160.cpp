    ...
    do {
      if ((pvStack_20 != (void *)0x0) && ((char)uVar10 == '\0')) {
        crt_stdio_c_sprintf_FUN_005fdbd0
                  (acStack_f8,"Welding vertices (%d removed so far)",
                   "Welding vertices (%d removed so far)",iStack_18);
      }
      pdVar4 = (double *)((int)&(this_ptr->vertex_data->position).x + iStack_1c);
      pdStack_14 = pdVar4;
      if ((*(byte *)((int)pdVar4 + 0x35) & 0x80) == 0) {
        dVar2 = (double)CONCAT44 /* combine 2-byte values */(uStack_fc,in_stack_ffffff00);
        ...
        *(byte *)((int)pdVar4 + 0x35) = *(byte *)((int)pdVar4 + 0x35) | 0x80;
        ...
        if (uVar5 < (uint)this_ptr->vertex_count) {
          ...
          do {
            ...
            if ((*(byte *)((int)pdVar4 + 0x35) & 0x80) == 0) {
              if (((uStack_fc & 0x7fffffff) == 0) && (in_stack_ffffff00 == 0)) {
...
LAB_005d43a8:
                  ...
                  *(byte *)((int)pdVar4 + 0x35) = *(byte *)((int)pdVar4 + 0x35) | 0x80;
                      ...
                      (SQRT((pdVar4[2] - pdStack_14[2]) * (pdVar4[2] - pdStack_14[2]) +
                       ...
                       (double)CONCAT44 /* combine 2-byte values */(uStack_fc,in_stack_ffffff00))) goto LAB_005d43a8;
            }
