// Name: shape_superopt.cpp_CObj_FUN_005d30f0
// Address: 005d30f0
// Address Range: [[005d30f0, 005d3136]]
// Convention: __cdecl
// Signature: int shape_superopt.cpp_CObj_FUN_005d30f0(CObj * this_ptr)

#include "nocturne.h"

int __cdecl shape_superopt_cpp_CObj_FUN_005d30f0(CObj *this_ptr)

{
  ...
  if (this_ptr->count != 0) {
    do {
      if ((this_ptr->poly_array[uVar2].field8_0x60 & in_stack_00000008) == in_stack_00000008) {
        uVar2 = uVar2 - 1;
...
// Assembly code:
// 005d30f0: PUSH EBX
//   Label: shape_superopt.cpp_CObj_FUN_005d30f0
// 005d30f1: PUSH ESI
// 005d30f2: PUSH EDI
