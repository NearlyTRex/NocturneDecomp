// Name: shape_superopt.cpp_CObj_FUN_005d22d0
// Address: 005d22d0
...
int __cdecl shape_superopt_cpp_CObj_FUN_005d22d0(CObj *this_ptr)

{
  ...
  if (in_stack_00000008 != 0) {
    iVar1 = (**(code **)((int)this_ptr->vtable + 0xc))();
    if (iVar1 == 0) {
      return 0;
    }
  }
  if (in_stack_0000000c != 0) {
    iVar1 = (**(code **)((int)this_ptr->vtable + 0x14))();
    if (iVar1 == 0) {
      return 0;
    }
  }
...
// Assembly code:
// 005d22d0: PUSH EBX
//   Label: shape_superopt.cpp_CObj_FUN_005d22d0
// 005d22d1: PUSH ESI
