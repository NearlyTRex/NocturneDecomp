...
section .text
    ...
    MOV EDX,dword ptr [0x03f6bbe8]      ; 005d7757 | undefined4 DAT_03f6bbe8
    XOR EBX,EBX                         ; 005d775d
    TEST EDX,EDX                        ; 005d775f
    JLE 0x005d7784                      ; 005d7761 | LAB_005d7784
        ;   XREF to: 005d7784 (CONDITIONAL_JUMP)
    MOV ESI,0x3f6bbf0                   ; 005d7763 | DAT_03f6bbf0
    PUSH EDI                            ; 005d7768
        ;   Label: LAB_005d7768
    PUSH ESI                            ; 005d7769 | DAT_03f6bbf0
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 005d776a | int crt_string.c_stricmp_FUN_005fe7f0(char * str1, char * str2)
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005d776f
    TEST EAX,EAX                        ; 005d7772
    JZ 0x005d778d                       ; 005d7774 | LAB_005d778d
        ;   XREF to: 005d778d (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x03f6bbe8]      ; 005d7776 | undefined4 DAT_03f6bbe8
    INC EBX                             ; 005d777c
    ADD ESI,0x50                        ; 005d777d
    CMP EBX,ECX                         ; 005d7780
    JL 0x005d7768                       ; 005d7782 | LAB_005d7768
