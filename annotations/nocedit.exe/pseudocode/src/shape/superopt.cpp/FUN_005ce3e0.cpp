// Name: shape_superopt.cpp_FUN_005ce3e0
// Address: 005ce3e0
// Address Range: [[005ce3e0, 005ce57d]]
// Convention: unknown
// Signature: undefined shape_superopt.cpp_FUN_005ce3e0()

#include "nocturne.h"

/* Signature: undefined1 shape_superopt.cpp_FUN_005ce3e0(undefined4 param_1, undefined4 param_2,
   undefined4 param_3) */

void shape_superopt_cpp_FUN_005ce3e0(void)

{
  ...
  pdVar4 = (double *)(iVar2 + in_stack_00000004[1] * 0x38);
  pdVar1 = (double *)(iVar2 + in_stack_00000004[2] * 0x38);
  iVar3 = in_stack_00000004[3];
  ...
  *(undefined4 *)((int)in_stack_0000000c + 4) = *(undefined4 *)((int)pdVar4 + 4);
  ...
  pdVar4 = (double *)(iVar3 * 0x38 + iVar2);
...
// Assembly code:
// 005ce3e0: PUSH EBX
//   Label: shape_superopt.cpp_FUN_005ce3e0
// 005ce3e1: PUSH ESI
// 005ce3e2: PUSH EDI
// 005ce3e3: PUSH EBP
