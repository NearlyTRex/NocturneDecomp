...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_superopt.cpp_CObj_projectPlanarUVsWithFlag_FUN_005d3e80(CObj * this_ptr, CVector2d * uv_scale, uint flag_mask)
;
; Parameters:
...
section .text
    ...
    JC 0x005d3e98                       ; 005d3ec9 | LAB_005d3e98
        ;   XREF to: 005d3e98 (CONDITIONAL_JUMP)
    POP EBP                             ; 005d3ecb
    POP EDI                             ; 005d3ecc
    POP ESI                             ; 005d3ecd
