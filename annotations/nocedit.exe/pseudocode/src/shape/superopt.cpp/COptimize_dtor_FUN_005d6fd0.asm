...
section .text
    ...
    PUSH EBX                            ; 005d6fd5
    MOV dword ptr [EBX + 0x40],0x663c44 ; 005d6fd6 | COptimize_vtable g_COptimizeVTable
    CALL shape_superopt.cpp_COptimize_FUN_005d7000 ; 005d6fdd | void shape_superopt.cpp_COptimize_FUN_005d7000(COptimize * this_ptr)
        ;   XREF to: 005d7000 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005d6fe2
    PUSH 0x0                            ; 005d6fe5
    PUSH EBX                            ; 005d6fe7
    CALL shape_superopt.cpp_CObj_dtor_FUN_005d2260 ; 005d6fe8 | CObj * shape_superopt.cpp_CObj_dtor_FUN_005d2260(CObj * this_ptr)
