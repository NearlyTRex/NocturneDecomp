    ...
    do {
      ...
      if (((__BITCAST_DOUBLE(CONCAT44(uStack_4c,local_50)) <= test_point->y) &&
        ...
        if ((test_point->x < __BITCAST_DOUBLE(CONCAT44(uStack_54,local_58))) ||
          ...
          dVar4 = __BITCAST_DOUBLE(CONCAT44(uStack_44,local_48)) - __BITCAST_DOUBLE(CONCAT44(uStack_54,local_58));
          dVar5 = __BITCAST_DOUBLE(CONCAT44(uStack_3c,local_40)) - __BITCAST_DOUBLE(CONCAT44(uStack_4c,local_50));
          local_38 = SUB84(__BITCAST_UINT64(dVar4),0);
          local_30 = SUB84(__BITCAST_UINT64(dVar5),0);
          local_60 = 0.0;
