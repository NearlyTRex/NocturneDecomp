...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_superopt.cpp_CObj_flipAllPolyNormals_FUN_005d3db0(CObj * this_ptr)
;
; Parameters:
...
section .text
    ...
    JBE 0x005d3de0                      ; 005d3dc1 | LAB_005d3de0
    ...
    JC 0x005d3dc3                       ; 005d3dd6 | LAB_005d3dc3
