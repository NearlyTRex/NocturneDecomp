...

{
  ...
  if ((((((double)CONCAT44(CStack_390.x._4_4_,CStack_390.x._0_4_) <=
          (double)CONCAT44(uStack_2b4,uStack_2b8)) &&
        ((double)CONCAT44(uStack_494,uStack_498) <= (double)CONCAT44(uStack_41c,uStack_420))) &&
       ((double)CONCAT44(CStack_390.y._4_4_,CStack_390.y._0_4_) <=
        (double)CONCAT44(uStack_2ac,uStack_2b0))) &&
      (((double)CONCAT44(uStack_48c,uStack_490) <= in_stack_fffffbe8 &&
       ((double)CONCAT44(CStack_390.z._4_4_,CStack_390.z._0_4_) <= dStack_2a8)))) &&
     ((double)CONCAT44(uStack_484,uStack_488) <= in_stack_fffffbf0)) {
    ...
    uStack_4cc = (double)CONCAT44(*(undefined4 *)&(pCVar6->position).x,(undefined4)uStack_4cc);
    uStack_4c4._0_4_ = *(undefined4 *)((int)&(pCVar6->position).x + 4);
    uStack_4c4._4_4_ = *(undefined4 *)&(pCVar6->position).y;
    uStack_4bc._0_4_ = *(undefined4 *)((int)&(pCVar6->position).y + 4);
    uStack_4bc._4_4_ = *(undefined4 *)&(pCVar6->position).z;
    CStack_4b4.x._0_4_ = *(undefined4 *)((int)&(pCVar6->position).z + 4);
    pCVar6 = pCVar1 + this_ptr->vertex_idx_1;
    CStack_4b4.x._4_4_ = *(undefined4 *)&(pCVar6->position).x;
    CStack_4b4.y._0_4_ = *(undefined4 *)((int)&(pCVar6->position).x + 4);
    CStack_4b4.y._4_4_ = *(undefined4 *)&(pCVar6->position).y;
    CStack_4b4.z._0_4_ = *(undefined4 *)((int)&(pCVar6->position).y + 4);
    CStack_4b4.z._4_4_ = *(undefined4 *)&(pCVar6->position).z;
    uStack_49c = *(undefined4 *)((int)&(pCVar6->position).z + 4);
    pCVar1 = pCVar1 + this_ptr->vertex_idx_2;
    uStack_498 = *(undefined4 *)&(pCVar1->position).x;
    uStack_494 = *(undefined4 *)((int)&(pCVar1->position).x + 4);
    uStack_490 = *(undefined4 *)&(pCVar1->position).y;
    uStack_48c = *(undefined4 *)((int)&(pCVar1->position).y + 4);
    uStack_488 = *(undefined4 *)&(pCVar1->position).z;
    uStack_484 = *(undefined4 *)((int)&(pCVar1->position).z + 4);
    crt_memory_c_constructObjectArray_DefaultCtor_FUN_005fe667(local_458 + 8,5,&g_CP2DTypeInfo);
    local_458._12_4_ = *(undefined4 *)&this_ptr->uv_coords[0].x;
    local_458._16_4_ = *(undefined4 *)((int)&this_ptr->uv_coords[0].x + 4);
    uStack_444._0_4_ = *(undefined4 *)&this_ptr->uv_coords[0].y;
    uStack_444._4_4_ = *(undefined4 *)((int)&this_ptr->uv_coords[0].y + 4);
    uStack_43c = *(undefined4 *)&this_ptr->uv_coords[1].x;
    uStack_438 = *(undefined4 *)((int)&this_ptr->uv_coords[1].x + 4);
    uStack_434 = *(undefined4 *)&this_ptr->uv_coords[1].y;
    uStack_430 = *(undefined4 *)((int)&this_ptr->uv_coords[1].y + 4);
    uStack_42c = *(undefined4 *)&this_ptr->uv_coords[2].x;
    uStack_428 = *(undefined4 *)((int)&this_ptr->uv_coords[2].x + 4);
    uStack_424 = *(undefined4 *)&this_ptr->uv_coords[2].y;
    uStack_420 = *(undefined4 *)((int)&this_ptr->uv_coords[2].y + 4);
    pCVar6 = other_poly->parent_obj->vertex_data + other_poly->vertex_idx_0;
    pdVar8 = &dStack_204;
    for (iVar3 = 6; iVar3 != 0; iVar3 = iVar3 + -1) {
      *(undefined4 *)pdVar8 = *(undefined4 *)&(pCVar6->position).x;
      pCVar6 = (CVert *)((int)pCVar6 + ((uint)bVar12 * -2 + 1) * 4);
      pdVar8 = (double *)((int)pdVar8 + (uint)bVar12 * -8 + 4);
    }
    pCVar11 = &other_poly->normal;
    uStack_fc = *(undefined4 *)&pCVar11->x;
    uStack_f8 = *(undefined4 *)((int)&(other_poly->normal).x + 4);
    pdVar8 = &(other_poly->normal).y;
    uStack_f4 = *(undefined4 *)pdVar8;
    uStack_f0 = *(undefined4 *)((int)&(other_poly->normal).y + 4);
    pdVar10 = &(other_poly->normal).z;
    dVar2 = *pdVar10;
    uStack_ec = *(undefined4 *)pdVar10;
    uStack_e8 = *(undefined4 *)((int)&(other_poly->normal).z + 4);
    dStack_294 = dStack_204 * pCVar11->x;
    dStack_28c = dStack_1fc * *pdVar8;
    dStack_284 = dStack_1f4 * *pdVar10;
    auStack_3cc = (undefined1  [8])
                  (pCVar11->x * (double)CONCAT44(uStack_4c4._4_4_,(undefined4)uStack_4c4));
    dStack_3c4 = *pdVar8 * (double)CONCAT44(uStack_4bc._4_4_,(undefined4)uStack_4bc);
    dStack_3bc = *pdVar10 * (double)CONCAT44(CStack_4b4.x._4_4_,CStack_4b4.x._0_4_);
    dStack_1bc = pCVar11->x * (double)CONCAT44(CStack_4b4.y._4_4_,CStack_4b4.y._0_4_);
    dStack_1b4 = *pdVar8 * (double)CONCAT44(CStack_4b4.z._4_4_,CStack_4b4.z._0_4_);
    dStack_1ac = *pdVar10 * (double)CONCAT44(uStack_498,uStack_49c);
    dStack_1a4 = pCVar11->x * (double)CONCAT44(uStack_490,uStack_494);
    dStack_19c = *pdVar8 * (double)CONCAT44(uStack_488,uStack_48c);
    pdVar8 = &dStack_294;
    pdVar10 = &dStack_12c;
    for (iVar3 = 6; iVar3 != 0; iVar3 = iVar3 + -1) {
      *(undefined4 *)pdVar10 = *(undefined4 *)pdVar8;
      pdVar8 = (double *)((int)pdVar8 + (uint)bVar12 * -8 + 4);
      pdVar10 = (double *)((int)pdVar10 + (uint)bVar12 * -8 + 4);
    }
    dStack_194 = dVar2 * (double)CONCAT44(uStack_480,uStack_484);
    puVar7 = (undefined4 *)auStack_3cc;
    pdVar8 = &dStack_27c;
    for (iVar3 = 6; iVar3 != 0; iVar3 = iVar3 + -1) {
      *(undefined4 *)pdVar8 = *puVar7;
    ...
    if ((dStack_2dc < DOUBLE_006542e2) && (DOUBLE_006542ea <= dStack_2dc)) {
      dStack_2dc = 0.0;
    }
    if ((CStack_2d4.x < DOUBLE_006542e2) && (DOUBLE_006542ea < CStack_2d4.x)) {
      CStack_2d4.x = 0.0;
    }
    if ((CStack_2d4.y < DOUBLE_006542e2) && (DOUBLE_006542ea <= CStack_2d4.y)) {
      CStack_2d4.y = 0.0;
    }
    if ((((dStack_2dc < 0.0) || (CStack_2d4.x < 0.0)) || (CStack_2d4.y < 0.0)) &&
      ...
      if (((((ulonglong)dStack_2dc & 0x7fffffff00000000) != 0) || (dStack_2dc._0_4_ != 0)) &&
        ...
        pCVar11 = &CStack_36c;
        for (iVar3 = 6; iVar3 != 0; iVar3 = iVar3 + -1) {
          *(undefined4 *)&pCVar11->x = *(undefined4 *)pdVar8;
          pdVar8 = (double *)((int)pdVar8 + (uint)bVar12 * -8 + 4);
        ...
        pdVar8 = &dStack_21c;
        puVar7 = (undefined4 *)((int)&CStack_390.y + 4);
        for (iVar3 = 6; iVar3 != 0; iVar3 = iVar3 + -1) {
          *puVar7 = *(undefined4 *)pdVar8;
          pdVar8 = (double *)((int)pdVar8 + (uint)bVar12 * -8 + 4);
          puVar7 = puVar7 + (uint)bVar12 * -2 + 1;
        }
        dStack_3fc = *pdStack0000007c - (double)CONCAT44(CStack_390.z._0_4_,CStack_390.y._4_4_);
        dStack_3f4 = (double)(&uStack_4bc)[iStack00000054 * 3] -
                     (double)CONCAT44(uStack_378,CStack_390.z._4_4_);
        ...
        uStack_6c._0_4_ = SUB84(*pdStack000000fc - *pdStack000000f8,0);
        uStack_9c = (undefined4)uStack_6c;
        (&uStack_98)[(uint)bVar12 * -2] = *(undefined4 *)((int)&uStack_6c + (uint)bVar12 * -8 + 4);
        *(undefined4 *)(&dStack_94 + (-(uint)bVar12 - (uint)bVar12)) =
             *(undefined4 *)(&dStack_64 + (-(uint)bVar12 - (uint)bVar12));
        *(undefined4 *)
        ...
        this_ptr = SUB84((double)CONCAT44(uStack_98,uStack_9c) * dVar2,0);
        pCStack_ac = this_ptr;
        ...
        *(CPolyIntersectResult **)
        ...
        dStack_2c = *pdStack000000fc - (double)CONCAT44(uStack_a8,pCStack_ac);
        dStack_24 = (double)(&uStack_444)[iStack00000054 * 2] - dStack_a4;
        pdStack00000068 = (double *)&uStack_41c;
        *(undefined4 *)(&stack0xfffffff8 + (uint)bVar12 * -8) = (&uStack_28)[(uint)bVar12 * -2];
        *(undefined4 *)(&stack0xfffffffc + (uint)bVar12 * -8 + (uint)bVar12 * -8) =
             *(undefined4 *)(&dStack_24 + (-(uint)bVar12 - (uint)bVar12));
        *(undefined4 *)
        ...
        dStack_44 = (double)(&uStack_444)[iStack000000c4 * 2] -
                    (double)(&uStack_444)[iStack000000cc * 2];
        uStack_4c._0_4_ = SUB84(*pdStack00000064 - *pdStack000000f8,0);
        uStack_5c = (undefined4)uStack_4c;
        (&uStack_58)[(uint)bVar12 * -2] = *(undefined4 *)((int)&uStack_4c + (uint)bVar12 * -8 + 4);
        *(undefined4 *)(&dStack_54 + (-(uint)bVar12 - (uint)bVar12)) =
             *(undefined4 *)(&dStack_44 + (-(uint)bVar12 - (uint)bVar12));
        *(undefined4 *)
         ((int)(&dStack_54 + (-(uint)bVar12 - (uint)bVar12)) + ((uint)bVar12 * -2 + 1) * 4) =
             *(undefined4 *)
              ((int)(&dStack_44 + (-(uint)bVar12 - (uint)bVar12)) + ((uint)bVar12 * -2 + 1) * 4);
        uStack_3c = (double)CONCAT44(uStack_58,uStack_5c) * dVar2;
        dStack_34 = dStack_54 * dVar2;
        uStack_8c = (undefined4)uStack_3c;
        (&uStack_88)[(uint)bVar12 * -2] = *(undefined4 *)((int)&uStack_3c + (uint)bVar12 * -8 + 4);
        *(undefined4 *)(&dStack_84 + (-(uint)bVar12 - (uint)bVar12)) =
             *(undefined4 *)(&dStack_34 + (-(uint)bVar12 - (uint)bVar12));
        *(undefined4 *)
         ((int)(&dStack_84 + (-(uint)bVar12 - (uint)bVar12)) + ((uint)bVar12 * -2 + 1) * 4) =
             *(undefined4 *)
              ((int)(&dStack_34 + (-(uint)bVar12 - (uint)bVar12)) + ((uint)bVar12 * -2 + 1) * 4);
        uStack_cc = *pdStack00000064 - (double)CONCAT44(uStack_88,uStack_8c);
        dStack_c4 = (double)(&uStack_444)[iStack000000c4 * 2] - dStack_84;
        uStack00000044 = (undefined4)uStack_cc;
        (&stack0x00000048)[(uint)bVar12 * -2] =
             *(undefined4 *)((int)&uStack_cc + (uint)bVar12 * -8 + 4);
        (&stack0x0000004c)[(uint)bVar12 * -2 + (uint)bVar12 * -2] =
             *(undefined4 *)(&dStack_c4 + (-(uint)bVar12 - (uint)bVar12));
        ...
        *(undefined4 *)pdVar8 = (undefined4)uStack_cc;
        *(undefined4 *)(local_458 + iVar3 + 0x10) = in_stack_00000048;
        *(undefined4 *)(&uStack_444 + iStack0000006c * 2) = in_stack_0000004c;
        *(undefined4 *)((int)&uStack_444 + iVar3 + 4) = in_stack_00000050;
        ...
        if (0.0 < *(double *)((int)&dStack_2dc + iStack00000078)) {
          ...
          pCStack000000ec->x = (double)CONCAT44(uStack_478,uStack_47c);
          (dest->poly1).vertices[1].y = (double)CONCAT44(uStack_470,uStack_474);
          (dest->poly1).vertices[1].z = (double)CONCAT44(uStack_468,uStack_46c);
          pCStack000000c0->x = *pdStack00000068;
          (dest->poly1).uvs[1].y = pdStack00000068[1];
          pCStack000000d4->x = (double)CONCAT44(uStack_460,uStack_464);
          (dest->poly1).vertices[2].y = (double)CONCAT44(local_458._0_4_,uStack_45c);
          (dest->poly1).vertices[2].z = (double)CONCAT44(local_458._8_4_,local_458._4_4_);
          pCStack000000bc->x = *pdVar8;
          (dest->poly1).uvs[2].y = (double)(&uStack_444)[iStack0000006c * 2];
          (dest->poly2).vertex_count = 4;
          pCVar11->x = (double)CONCAT44(uStack_478,uStack_47c);
          (dest->poly2).vertices[0].y = (double)CONCAT44(uStack_470,uStack_474);
          (dest->poly2).vertices[0].z = (double)CONCAT44(uStack_468,uStack_46c);
          ...
          *(undefined4 *)&(dest->poly2).vertices[3].x = uStack_464;
          *(undefined4 *)((int)&(dest->poly2).vertices[3].x + 4) = uStack_460;
          *(undefined4 *)&(dest->poly2).vertices[3].y = uStack_45c;
          *(undefined4 *)((int)&(dest->poly2).vertices[3].y + 4) = local_458._0_4_;
          *(undefined4 *)&(dest->poly2).vertices[3].z = local_458._4_4_;
          *(undefined4 *)((int)&(dest->poly2).vertices[3].z + 4) = local_458._8_4_;
          *(undefined4 *)&(dest->poly2).uvs[3].x = *(undefined4 *)pdVar8;
          *(undefined4 *)((int)&(dest->poly2).uvs[3].x + 4) =
               *(undefined4 *)(local_458 + iVar3 + 0x10);
          *(undefined4 *)&(dest->poly2).uvs[3].y = *(undefined4 *)(&uStack_444 + iStack0000006c * 2)
          ;
          *(undefined4 *)((int)&(dest->poly2).uvs[3].y + 4) =
               *(undefined4 *)((int)&uStack_444 + iVar3 + 4);
          return 1;
        }
        (dest->poly1).vertex_count = 4;
        pCStack0000005c->x = (double)CONCAT44(uStack_478,uStack_47c);
        (dest->poly1).vertices[0].y = (double)CONCAT44(uStack_470,uStack_474);
        (dest->poly1).vertices[0].z = (double)CONCAT44(uStack_468,uStack_46c);
        ...
        (dest->poly1).vertices[3].x = (double)CONCAT44(uStack_460,uStack_464);
        (dest->poly1).vertices[3].y = (double)CONCAT44(local_458._0_4_,uStack_45c);
        (dest->poly1).vertices[3].z = (double)CONCAT44(local_458._8_4_,local_458._4_4_);
        (dest->poly1).uvs[3].x = *pdVar8;
        (dest->poly1).uvs[3].y = (double)(&uStack_444)[iStack0000006c * 2];
        (dest->poly2).vertex_count = 3;
        *(undefined4 *)&pCVar11->x = *(undefined4 *)pdStack00000084;
        *(undefined4 *)((int)&(dest->poly2).vertices[0].x + 4) =
             *(undefined4 *)((int)pdStack00000084 + 4);
        *(undefined4 *)&(dest->poly2).vertices[0].y = *(undefined4 *)(pdStack00000084 + 1);
        *(undefined4 *)((int)&(dest->poly2).vertices[0].y + 4) =
             *(undefined4 *)((int)pdStack00000084 + 0xc);
        (dest->poly2).vertices[0].z = pdStack00000084[2];
        pCStack00000090->x = *pdStack000000f8;
        (dest->poly2).uvs[0].y = pdStack000000f8[1];
        *(undefined4 *)&pCStack000000dc->x = uStack_47c;
        *(undefined4 *)((int)&(dest->poly2).vertices[1].x + 4) = uStack_478;
        *(undefined4 *)&(dest->poly2).vertices[1].y = uStack_474;
        *(undefined4 *)((int)&(dest->poly2).vertices[1].y + 4) = uStack_470;
        *(undefined4 *)&(dest->poly2).vertices[1].z = uStack_46c;
        *(undefined4 *)((int)&(dest->poly2).vertices[1].z + 4) = uStack_468;
        pCStack0000009c->x = *pdStack00000068;
        (dest->poly2).uvs[1].y = pdStack00000068[1];
        *(undefined4 *)&pCStack000000d8->x = uStack_464;
        *(undefined4 *)((int)&(dest->poly2).vertices[2].x + 4) = uStack_460;
        *(undefined4 *)&(dest->poly2).vertices[2].y = uStack_45c;
        *(undefined4 *)((int)&(dest->poly2).vertices[2].y + 4) = local_458._0_4_;
        *(undefined4 *)&(dest->poly2).vertices[2].z = local_458._4_4_;
        *(undefined4 *)((int)&(dest->poly2).vertices[2].z + 4) = local_458._8_4_;
        *(undefined4 *)&pCStack000000a4->x = *(undefined4 *)pdVar8;
        *(undefined4 *)((int)&(dest->poly2).uvs[2].x + 4) =
             *(undefined4 *)(local_458 + iVar3 + 0x10);
        *(undefined4 *)&(dest->poly2).uvs[2].y = *(undefined4 *)(&uStack_444 + iStack0000006c * 2);
        *(undefined4 *)((int)&(dest->poly2).uvs[2].y + 4) =
             *(undefined4 *)((int)&uStack_444 + iVar3 + 4);
        return 1;
      }
      iStack00000074 = 3;
      ...
      dStack_16c = (double)CONCAT44(CStack_390.x._0_4_,uStack_394) * dVar2;
      dStack_164 = (double)CONCAT44(CStack_390.y._0_4_,CStack_390.x._4_4_) * dVar2;
      pdVar8 = &dStack_174;
      pdVar10 = &dStack_144;
      for (iVar3 = 6; iVar3 != 0; iVar3 = iVar3 + -1) {
        *(undefined4 *)pdVar10 = *(undefined4 *)pdVar8;
      ...
      uStack00000014 = (undefined4)uStack_bc;
      (&stack0x00000018)[(uint)bVar12 * -2] =
           *(undefined4 *)((int)&uStack_bc + (uint)bVar12 * -8 + 4);
      *(undefined4 *)(&stack0x0000001c + (-(uint)bVar12 - (uint)bVar12)) =
           *(undefined4 *)(&dStack_b4 + (-(uint)bVar12 - (uint)bVar12));
      *(undefined4 *)
       ((int)(&stack0x0000001c + (-(uint)bVar12 - (uint)bVar12)) + ((uint)bVar12 * -2 + 1) * 4) =
           *(undefined4 *)
            ((int)(&dStack_b4 + (-(uint)bVar12 - (uint)bVar12)) + ((uint)bVar12 * -2 + 1) * 4);
      _uStack00000034 = (double)CONCAT44(in_stack_00000018,(undefined4)uStack_bc) * dVar2;
      dStack0000003c = in_stack_0000001c * dVar2;
      uStack_7c = uStack00000034;
      (&uStack_78)[(uint)bVar12 * -2] = *(undefined4 *)(&stack0x00000038 + (uint)bVar12 * -8);
      *(undefined4 *)(&dStack_74 + (-(uint)bVar12 - (uint)bVar12)) =
           *(undefined4 *)((int)&stack0x0000003c + (uint)bVar12 * -8 + (uint)bVar12 * -8);
      *(undefined4 *)
       ((int)(&dStack_74 + (-(uint)bVar12 - (uint)bVar12)) + ((uint)bVar12 * -2 + 1) * 4) =
           ((undefined4 *)((int)&stack0x0000003c + (uint)bVar12 * -8 + (uint)bVar12 * -8))
           [(uint)bVar12 * -2 + 1];
      _uStack00000024 = *pdStack00000100 - (double)CONCAT44(uStack_78,uStack_7c);
      dStack0000002c = pdStack00000100[1] - dStack_74;
      uStack_1c = uStack00000024;
      auStack_18[(uint)bVar12 * -2] = *(undefined4 *)(&stack0x00000028 + (uint)bVar12 * -8);
      auStack_18[(uint)bVar12 * -2 + (uint)bVar12 * -2 + 1] =
           *(undefined4 *)((int)&stack0x0000002c + (uint)bVar12 * -8 + (uint)bVar12 * -8);
      (auStack_18 + (uint)bVar12 * -2 + (uint)bVar12 * -2 + 1)[(uint)bVar12 * -2 + 1] =
           ((undefined4 *)((int)&stack0x0000002c + (uint)bVar12 * -8 + (uint)bVar12 * -8))
           [(uint)bVar12 * -2 + 1];
      iVar4 = iStack00000074 * 0x10;
      pdVar10 = (double *)(local_458 + iVar4 + 0xc);
      *(undefined4 *)pdVar10 = uStack_1c;
      *(undefined4 *)(local_458 + iVar4 + 0x10) = auStack_18[0];
      *(undefined4 *)(&uStack_444 + iStack00000074 * 2) = auStack_18[1];
      *(undefined4 *)((int)&uStack_444 + iVar4 + 4) = unaff_EBP;
      ...
      if (0.0 < *(double *)((int)&dStack_2dc + iStack0000008c)) {
        ...
        pCStack000000e4->x = (double)CONCAT44(uStack_478,uStack_47c);
        (dest->poly1).vertices[2].y = (double)CONCAT44(uStack_470,uStack_474);
        (dest->poly1).vertices[2].z = (double)CONCAT44(uStack_468,uStack_46c);
        pCStack00000098->x = *pdVar10;
        (dest->poly1).uvs[2].y = (double)(&uStack_444)[iStack00000074 * 2];
        (dest->poly2).vertex_count = 3;
        *(undefined4 *)&pCStack000000f4->x = *(undefined4 *)pdVar8;
        *(undefined4 *)((int)&(dest->poly2).vertices[0].x + 4) =
             *(undefined4 *)((int)&uStack_4c4 + iVar3 + 4);
        *(undefined4 *)&(dest->poly2).vertices[0].y =
             *(undefined4 *)(&uStack_4bc + iStack000000b0 * 3);
        *(undefined4 *)((int)&(dest->poly2).vertices[0].y + 4) =
             *(undefined4 *)((int)&uStack_4bc + iVar3 + 4);
        *(undefined4 *)&(dest->poly2).vertices[0].z =
             *(undefined4 *)&(&CStack_4b4)[iStack000000b0].x;
        *(undefined4 *)((int)&(dest->poly2).vertices[0].z + 4) =
             *(undefined4 *)((int)&(&CStack_4b4)[iStack000000b0].x + 4);
        *(undefined4 *)&pCStack00000094->x = *(undefined4 *)pdVar9;
        *(undefined4 *)((int)&(dest->poly2).uvs[0].x + 4) =
             *(undefined4 *)(local_458 + iVar5 + 0x10);
        *(undefined4 *)&(dest->poly2).uvs[0].y = *(undefined4 *)(&uStack_444 + iStack000000b0 * 2);
        *(undefined4 *)((int)&(dest->poly2).uvs[0].y + 4) =
             *(undefined4 *)((int)&uStack_444 + iVar5 + 4);
        *(undefined4 *)&pCStack00000060->x = uStack_47c;
        *(undefined4 *)((int)&(dest->poly2).vertices[1].x + 4) = uStack_478;
        *(undefined4 *)&(dest->poly2).vertices[1].y = uStack_474;
        *(undefined4 *)((int)&(dest->poly2).vertices[1].y + 4) = uStack_470;
        *(undefined4 *)&(dest->poly2).vertices[1].z = uStack_46c;
        *(undefined4 *)((int)&(dest->poly2).vertices[1].z + 4) = uStack_468;
        *(undefined4 *)&pCStack000000b4->x = *(undefined4 *)pdVar10;
        *(undefined4 *)((int)&(dest->poly2).uvs[1].x + 4) =
             *(undefined4 *)(local_458 + iVar4 + 0x10);
        *(undefined4 *)&(dest->poly2).uvs[1].y = *(undefined4 *)(&uStack_444 + iStack00000074 * 2);
        *(undefined4 *)((int)&(dest->poly2).uvs[1].y + 4) =
             *(undefined4 *)((int)&uStack_444 + iVar4 + 4);
      ...
      pCStack000000f0->x = (double)CONCAT44(uStack_478,uStack_47c);
      (dest->poly2).vertices[2].y = (double)CONCAT44(uStack_470,uStack_474);
      (dest->poly2).vertices[2].z = (double)CONCAT44(uStack_468,uStack_46c);
      pCStack000000a0->x = *pdVar10;
      (dest->poly2).uvs[2].y = (double)(&uStack_444)[iStack00000074 * 2];
      (dest->poly1).vertex_count = 3;
      *(undefined4 *)&pCStack00000058->x = *(undefined4 *)pdVar8;
      *(undefined4 *)((int)&(dest->poly1).vertices[0].x + 4) =
           *(undefined4 *)((int)&uStack_4c4 + iVar3 + 4);
      *(undefined4 *)&(dest->poly1).vertices[0].y =
           *(undefined4 *)(&uStack_4bc + iStack000000b0 * 3);
      *(undefined4 *)((int)&(dest->poly1).vertices[0].y + 4) =
           *(undefined4 *)((int)&uStack_4bc + iVar3 + 4);
      *(undefined4 *)&(dest->poly1).vertices[0].z = *(undefined4 *)&(&CStack_4b4)[iStack000000b0].x;
      *(undefined4 *)((int)&(dest->poly1).vertices[0].z + 4) =
           *(undefined4 *)((int)&(&CStack_4b4)[iStack000000b0].x + 4);
      *(undefined4 *)&pCStack000000ac->x = *(undefined4 *)pdVar9;
      *(undefined4 *)((int)&(dest->poly1).uvs[0].x + 4) = *(undefined4 *)(local_458 + iVar5 + 0x10);
      *(undefined4 *)&(dest->poly1).uvs[0].y = *(undefined4 *)(&uStack_444 + iStack000000b0 * 2);
      *(undefined4 *)((int)&(dest->poly1).uvs[0].y + 4) =
           *(undefined4 *)((int)&uStack_444 + iVar5 + 4);
      *(undefined4 *)&pCStack000000e0->x = uStack_47c;
      *(undefined4 *)((int)&(dest->poly1).vertices[1].x + 4) = uStack_478;
      *(undefined4 *)&(dest->poly1).vertices[1].y = uStack_474;
      *(undefined4 *)((int)&(dest->poly1).vertices[1].y + 4) = uStack_470;
      *(undefined4 *)&(dest->poly1).vertices[1].z = uStack_46c;
      *(undefined4 *)((int)&(dest->poly1).vertices[1].z + 4) = uStack_468;
      *(undefined4 *)&pCStack000000a8->x = *(undefined4 *)pdVar10;
      *(undefined4 *)((int)&(dest->poly1).uvs[1].x + 4) = *(undefined4 *)(local_458 + iVar4 + 0x10);
      *(undefined4 *)&(dest->poly1).uvs[1].y = *(undefined4 *)(&uStack_444 + iStack00000074 * 2);
      *(undefined4 *)((int)&(dest->poly1).uvs[1].y + 4) =
           *(undefined4 *)((int)&uStack_444 + iVar4 + 4);
