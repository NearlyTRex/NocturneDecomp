...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_superopt.cpp_CObj_scale_FUN_005d2940(CObj * this_ptr, CVector3d * scale, CVector3d * pivot)
;
; Parameters:
...
section .text
    ...
    JBE 0x005d2ab0                      ; 005d2968 | LAB_005d2ab0
    ...
    JC 0x005d296e                       ; 005d2aa7 | LAB_005d296e
