// Name: shape_superopt.cpp_FUN_005d38b0
// Address: 005d38b0
// Address Range: [[005d38b0, 005d395c]]
// Convention: unknown
// Signature: undefined shape_superopt.cpp_FUN_005d38b0()

#include "nocturne.h"

/* Signature: undefined1 shape_superopt.cpp_FUN_005d38b0(undefined4 param_1, undefined4 param_2) */

undefined4 * shape_superopt_cpp_FUN_005d38b0(void)

{
  ...
  if (puVar1 == in_stack_00000008) {
    puVar1 = (undefined4 *)(**(code **)(in_stack_00000004[6] + 0x98))();
    return puVar1;
  }
  uVar3 = 0;
  if (in_stack_00000004[2] != 0) {
    ...
    do {
      ...
      uVar3 = uVar3 + 1;
      iVar4 = iVar4 + 0x68;
      puVar1 = (undefined4 *)(**(code **)(*(int *)(iVar2 + 100) + 0x40))();
...
// Assembly code:
// 005d38b0: PUSH EBX
//   Label: shape_superopt.cpp_FUN_005d38b0
// 005d38b1: PUSH ESI
// 005d38b2: PUSH EDI
// 005d38b3: PUSH EBP
