...
;                               FUNCTION
; *****************************************************************************
; __cdecl int shape_superopt.cpp_CObj_removeVertex_FUN_005d3140(CObj * this_ptr, uint index)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 005d317e
    CALL crt_memory.c_realloc_FUN_00601df0 ; 005d317f | void * crt_memory.c_realloc_FUN_00601df0(void * ptr, ulong new_size)
        ;   XREF to: 00601df0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005d3184
    TEST EAX,EAX                        ; 005d3187
    JZ 0x005d31d5                       ; 005d3189 | LAB_005d31d5
    ...
    JBE 0x005d31cf                      ; 005d3196 | LAB_005d31cf
    ...
    JNC 0x005d31c4                      ; 005d31bc | LAB_005d31c4
    ...
    JC 0x005d319a                       ; 005d31cd | LAB_005d319a
    ...
    PUSH ECX                            ; 005d3211
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 005d3212 | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
        ;   XREF to: 005fe5e0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005d3217
    JMP 0x005d3162                      ; 005d321a | LAB_005d3162
        ;   XREF to: 005d3162 (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESI + 0x4]       ; 005d321f
        ;   Label: LAB_005d321f
    PUSH EAX                            ; 005d3222
    CALL crt_memory.c_free_FUN_00601cd0 ; 005d3223 | void crt_memory.c_free_FUN_00601cd0(void * ptr)
    ...
    JMP 0x005d31aa                      ; 005d323d | LAB_005d31aa
