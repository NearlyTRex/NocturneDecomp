// Name: shape_superopt.cpp_FUN_005d34d0
// Address: 005d34d0
// Address Range: [[005d34d0, 005d3583]]
// Convention: unknown
// Signature: undefined shape_superopt.cpp_FUN_005d34d0()

#include "nocturne.h"

/* Signature: undefined1 shape_superopt.cpp_FUN_005d34d0(undefined4 param_1, undefined4 param_2,
   undefined4 param_3) */

void shape_superopt_cpp_FUN_005d34d0(void)

{
  ...
  if (*in_stack_00000004 != 0) {
    do {
      if ((*(uint *)(uVar2 + 0x34) & in_stack_0000000c) == in_stack_0000000c) {
        *(uint *)(uVar2 + 0x34) = *(uint *)(uVar2 + 0x34) | in_stack_00000008;
      }
      else {
        *(uint *)(uVar2 + 0x34) = *(uint *)(uVar2 + 0x34) & ~in_stack_00000008;
      }
  ...
  if (in_stack_00000004[2] != 0) {
    do {
      (**(code **)(*(int *)(uVar2 + 100) + 0x20))();
      uVar1 = uVar1 + 1;
      uVar2 = uVar2 + 0x68;
    } while (uVar1 < in_stack_00000004[2]);
  }
  if ((in_stack_00000004[4] & in_stack_0000000c) == in_stack_0000000c) {
...
// Assembly code:
// 005d34d0: PUSH EBX
//   Label: shape_superopt.cpp_FUN_005d34d0
// 005d34d1: PUSH ESI
// 005d34d2: PUSH EDI
// 005d34d3: PUSH EBP
