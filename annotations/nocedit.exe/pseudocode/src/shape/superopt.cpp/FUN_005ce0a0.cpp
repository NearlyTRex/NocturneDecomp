// Name: shape_superopt.cpp_FUN_005ce0a0
// Address: 005ce0a0
// Address Range: [[005ce0a0, 005ce3bb]]
// Convention: unknown
// Signature: undefined shape_superopt.cpp_FUN_005ce0a0()
// Globals:
//   undefined4 DAT_006542da

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Signature: undefined1 shape_superopt.cpp_FUN_005ce0a0(undefined4 param_1, undefined4 param_2) */

void shape_superopt_cpp_FUN_005ce0a0(void)

{
  ...
  dVar4 = _DAT_006542da;
  if (0.0 <= in_stack_00000004[10]) {
    local_70 = in_stack_00000004[10];
  }
  else {
    local_70 = -in_stack_00000004[10];
  }
  if (in_stack_00000004[9] < 0.0) {
    local_80 = -in_stack_00000004[9];
  }
  else {
    local_80 = in_stack_00000004[9];
  }
  if (in_stack_00000004[8] < 0.0) {
    local_78 = -in_stack_00000004[8];
  }
  else {
    local_78 = in_stack_00000004[8];
  }
  ...
  if ((local_80 <= local_78) && (local_70 <= local_78)) {
    pdVar6 = (double *)((int)in_stack_00000004 + 0xc);
    pdVar2 = in_stack_00000004;
    do {
      pdVar5 = pdVar2 + 2;
      iVar7 = *(int *)((int)in_stack_00000004 + 4) * 0x38;
      *pdVar5 = *(double *)(iVar7 + 0x10 + iVar1) * *in_stack_00000008 *
                (double)((ulonglong)local_84 << 0x20);
      dVar3 = -*(double *)(iVar7 + 8 + iVar1) * in_stack_00000008[1];
      pdVar2[3] = dVar3;
      in_stack_00000004 = (double *)((int)in_stack_00000004 + 4);
      *pdVar5 = *pdVar5 * dVar4;
      pdVar2[3] = dVar3 * dVar4;
      pdVar2 = pdVar5;
    } while (in_stack_00000004 != pdVar6);
    return;
  }
  if ((local_78 <= local_80) && (local_70 <= local_80)) {
    ...
    do {
      pdVar5 = pdVar2 + 2;
      iVar7 = *(int *)((int)in_stack_00000004 + 4) * 0x38;
      *pdVar5 = *(double *)(iVar7 + iVar1) * *in_stack_00000008;
      dVar3 = -*(double *)(iVar7 + 0x10 + iVar1) * in_stack_00000008[1] *
              (double)((ulonglong)local_64 << 0x20);
      pdVar2[3] = dVar3;
      in_stack_00000004 = (double *)((int)in_stack_00000004 + 4);
      *pdVar5 = *pdVar5 * dVar4;
      pdVar2[3] = dVar3 * dVar4;
  ...
  do {
    ...
    iVar7 = *(int *)((int)in_stack_00000004 + 4) * 0x38;
    *pdVar5 = -*(double *)(iVar7 + iVar1) * *in_stack_00000008 *
              (double)((ulonglong)local_5c << 0x20);
    dVar3 = -*(double *)(iVar7 + 8 + iVar1) * in_stack_00000008[1];
    pdVar2[3] = dVar3;
    in_stack_00000004 = (double *)((int)in_stack_00000004 + 4);
    *pdVar5 = *pdVar5 * dVar4;
...
// Assembly code:
// 005ce0a0: PUSH EBX
//   Label: shape_superopt.cpp_FUN_005ce0a0
// 005ce0a1: PUSH ESI
// 005ce0a2: PUSH EDI
// 005ce0a3: PUSH EBP
