...
section .text
    ...
    PUSH EDI                            ; 005d7360
    CALL shape_superopt.cpp_CObj_clearStateFlags_FUN_005d35e0 ; 005d7361 | void shape_superopt.cpp_CObj_clearStateFlags_FUN_005d35e0(CObj * this_ptr, uint mask)
    ...
    JZ 0x005d7432                       ; 005d73a9 | LAB_005d7432
    ...
    JBE 0x005d7407                      ; 005d73ca | LAB_005d7407
    ...
    JZ 0x005d73fc                       ; 005d73d7 | LAB_005d73fc
        ;   XREF to: 005d73fc (CONDITIONAL_JUMP)
    PUSH EBX                            ; 005d73d9
    MOV ECX,dword ptr [ESP + 0x4]       ; 005d73da
    PUSH ECX                            ; 005d73de
    CALL shape_superopt.cpp_FUN_005c7a90 ; 005d73df | int shape_superopt.cpp_FUN_005c7a90()
        ;   XREF to: 005c7a90 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005d73e4
    TEST EAX,EAX                        ; 005d73e7
    JZ 0x005d7449                       ; 005d73e9 | LAB_005d7449
    ...
    JC 0x005d73ce                       ; 005d7405 | LAB_005d73ce
        ;   XREF to: 005d73ce (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [ESP]             ; 005d7407
        ;   Label: LAB_005d7407
    PUSH EDX                            ; 005d740a
    CALL shape_superopt.cpp_FUN_005c7b20 ; 005d740b | undefined shape_superopt.cpp_FUN_005c7b20()
        ;   XREF to: 005c7b20 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005d7410
    TEST EAX,EAX                        ; 005d7413
    JNZ 0x005d7369                      ; 005d7415 | LAB_005d7369
        ;   XREF to: 005d7369 (CONDITIONAL_JUMP)
    PUSH 0x654749                       ; 005d741b | = "Unable to build complex polygon edge ..." | s_Unable_to_build_complex__00654749 = Unable to build complex polygon edge list
    CALL shape_superopt.cpp_logToFile_FUN_005c7910 ; 005d7420 | void shape_superopt.cpp_logToFile_FUN_005c7910(char * format)
    ...
    POP EBX                             ; 005d7430
    RET                                 ; 005d7431
    PUSH 0x6546f3                       ; 005d7432 | = "Unable to add polygon for complex pass" | s_Unable_to_add_polygon_fo_006546f3 = Unable to add polygon for complex pass
        ;   Label: LAB_005d7432
    CALL shape_superopt.cpp_logToFile_FUN_005c7910 ; 005d7437 | void shape_superopt.cpp_logToFile_FUN_005c7910(char * format)
        ;   XREF to: 005c7910 (UNCONDITIONAL_CALL)
    ...
    POP EBX                             ; 005d7447
    RET                                 ; 005d7448
    PUSH 0x65471a                       ; 005d7449 | = "Unable to add shared triangle for com..." | s_Unable_to_add_shared_tri_0065471a = Unable to add shared triangle for complex pass
        ;   Label: LAB_005d7449
    CALL shape_superopt.cpp_logToFile_FUN_005c7910 ; 005d744e | void shape_superopt.cpp_logToFile_FUN_005c7910(char * format)
        ;   XREF to: 005c7910 (UNCONDITIONAL_CALL)
