...

{
  ...
  pCVar1 = (CVert *)realloc
                     (this_ptr->vertex_data,(this_ptr->vertex_count + add_count) * sizeof(CVert));
  if (pCVar1 != (CVert *)0x0) {
    this_ptr->vertex_data = pCVar1;
    memset
              (this_ptr->vertex_data + this_ptr->vertex_count,0,add_count * sizeof(*this_ptr->vertex_data));
