...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl shape_superopt_cpp_CPoly_setVertexStateFlagIfCondition_FUN_005cd2b0 (CPoly *this_ptr,uint flag_to_set,uint condition_mask)
;
; Parameters:
...
section .text
    ...
    JZ 0x005cd324                       ; 005cd2db
        ;   XREF to: 005cd324 (CONDITIONAL_JUMP)  ; LAB_005cd324
    ...
    JNZ 0x005cd329                      ; 005cd2ff
        ;   XREF to: 005cd329 (CONDITIONAL_JUMP)  ; LAB_005cd329
    ...
    JNZ 0x005cd337                      ; 005cd31a
        ;   XREF to: 005cd337 (CONDITIONAL_JUMP)  ; LAB_005cd337
    ...
    OR dword ptr [EAX + 0x34],ECX       ; 005cd324
        ;   Label: LAB_005cd324
    JMP 0x005cd2e9                      ; 005cd327
        ;   XREF to: 005cd2e9 (UNCONDITIONAL_JUMP)  ; LAB_005cd2e9
    ...
    JMP 0x005cd304                      ; 005cd335
        ;   XREF to: 005cd304 (UNCONDITIONAL_JUMP)  ; LAB_005cd304
    NOT ECX                             ; 005cd337
        ;   Label: LAB_005cd337
