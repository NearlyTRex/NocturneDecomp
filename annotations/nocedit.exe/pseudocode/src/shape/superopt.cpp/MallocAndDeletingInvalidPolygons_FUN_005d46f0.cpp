// Name: shape_superopt.cpp_MallocAndDeletingInvalidPolygons_FUN_005d46f0
// Address: 005d46f0
// Address Range: [[005d46f0, 005d47a1]]
// Convention: unknown
// Signature: undefined shape_superopt.cpp_MallocAndDeletingInvalidPolygons_FUN_005d46f0()
// Cross-references:
//   shape_superopt.cpp_ReduceDatabaseVerticesPolygonsJunctions_FUN_005d7290 (005d7290) at 005d72ad [UNCONDITIONAL_CALL]
// Globals:
...
/* Signature: undefined1 shape_superopt.cpp_MallocAndDeletingInvalidPolygons(undefined4 param_1) */

undefined4 shape_superopt_cpp_MallocAndDeletingInvalidPolygons_FUN_005d46f0(void)

{
  ...
  ptr = (void *)0x0;
  if (1000 < *(uint *)(in_stack_00000004 + 8)) {
  ...
  if (*(int *)(in_stack_00000004 + 8) != 0) {
    do {
      if ((ptr != (void *)0x0) && ((char)uVar3 == '\0')) {
        crt_stdio_c_sprintf_FUN_005fdbd0(local_6c,"Deleting invalid polygons (%d deleted so far)",iVar4);
      }
      iVar1 = (**(code **)(*(int *)(uVar3 * 0x68 + *(int *)(in_stack_00000004 + 0xc) + 100) + 0x88))
                        ();
      if (iVar1 == 0) {
        uVar3 = uVar3 - 1;
  ...
  shape_memdbg_cpp_debugFree_FUN_0050f210(ptr);
  uVar2 = (**(code **)(*(int *)(in_stack_00000004 + 0x18) + 0xcc))();
  return uVar2;
}
...
// Assembly code:
// 005d46f0: PUSH EBX
//   Label: shape_superopt.cpp_MallocAndDeletingInvalidPolygons_FUN_005d46f0
// 005d46f1: PUSH ESI
// 005d46f2: PUSH EDI
// 005d46f3: PUSH EBP
