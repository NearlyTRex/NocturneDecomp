// Name: shape_superopt.cpp_FUN_005d1230
// Address: 005d1230
// Address Range: [[005d1230, 005d12c3]]
// Convention: unknown
// Signature: undefined shape_superopt.cpp_FUN_005d1230()

#include "nocturne.h"

/* Signature: undefined1 shape_superopt.cpp_FUN_005d1230(undefined4 param_1, undefined4 param_2) */

undefined4 shape_superopt_cpp_FUN_005d1230(void)

{
  ...
  bVar5 = 0;
  local_14 = *(int *)(in_stack_00000004 + 100);
  ...
  iVar1 = (**(code **)(iVar1 + 100))();
  if (iVar1 == 0) {
    local_14 = *(int *)(in_stack_00000008 + 100);
    (**(code **)(*(int *)(in_stack_00000004 + 100) + 0x6c))();
    iVar1 = local_14;
    puVar3 = auStack_5c;
    puVar4 = auStack_2c;
    for (iVar2 = 6; iVar2 != 0; iVar2 = iVar2 + -1) {
...
// Assembly code:
// 005d1230: PUSH EBX
//   Label: shape_superopt.cpp_FUN_005d1230
// 005d1231: PUSH ESI
// 005d1232: PUSH EDI
// 005d1233: PUSH EBP
