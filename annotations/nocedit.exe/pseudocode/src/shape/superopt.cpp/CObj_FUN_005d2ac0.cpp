// Name: shape_superopt.cpp_CObj_FUN_005d2ac0
// Address: 005d2ac0
// Address Range: [[005d2ac0, 005d2c38]]
// Convention: __cdecl
// Signature: void shape_superopt.cpp_CObj_FUN_005d2ac0(CObj * this_ptr)

#include "nocturne.h"

void __cdecl shape_superopt_cpp_CObj_FUN_005d2ac0(CObj *this_ptr)

{
  ...
  local_18 = 0;
  pdVar3 = (double *)this_ptr->vertex_data;
  if (this_ptr->field0_0x0 != 0) {
    do {
      if ((*(uint *)((int)pdVar3 + 0x34) & in_stack_00000008) == in_stack_00000008) {
        local_60 = *in_stack_0000000c;
        uStack_5c = in_stack_0000000c[1];
        local_58 = in_stack_0000000c[2];
        uStack_54 = in_stack_0000000c[3];
        local_c0 = *pdVar3 - *in_stack_00000010;
        local_b8 = pdVar3[1] - in_stack_00000010[1];
        local_50 = in_stack_0000000c[4];
        local_b0 = pdVar3[2] - in_stack_00000010[2];
        uVar1 = in_stack_0000000c[5];
        pdVar4 = &local_c0;
        pdVar5 = &local_a8;
        ...
        local_30 = local_78 + *in_stack_00000010;
        local_28 = local_70 + in_stack_00000010[1];
        local_20 = local_68 + in_stack_00000010[2];
        pdVar4 = &local_30;
        puVar6 = local_48;
        for (iVar2 = 6; iVar2 != 0; iVar2 = iVar2 + -1) {
        ...
        *(undefined4 *)pdVar3 = local_48[0];
        *(undefined4 *)((int)pdVar3 + 4) = local_48[1];
        *(undefined4 *)(pdVar3 + 1) = local_48[2];
        *(undefined4 *)((int)pdVar3 + 0xc) = local_48[3];
        *(undefined4 *)(pdVar3 + 2) = local_38;
        *(undefined4 *)((int)pdVar3 + 0x14) = local_34;
      }
      pdVar3 = pdVar3 + 7;
      local_18 = local_18 + 1;
...
// Assembly code:
// 005d2ac0: PUSH EBX
//   Label: shape_superopt.cpp_CObj_FUN_005d2ac0
// 005d2ac1: PUSH ESI
// 005d2ac2: PUSH EDI
// 005d2ac3: PUSH EBP
