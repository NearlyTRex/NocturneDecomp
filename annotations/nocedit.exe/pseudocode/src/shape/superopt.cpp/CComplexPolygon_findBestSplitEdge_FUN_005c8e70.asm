...
; Local Variables:
; CVector3d        Stack[-0xe4]:24  local_e4
...
section .text
    ...
    PUSH EBX                            ; 005c8e70
        ;   Label: shape_superopt.cpp_CComplexPolygon_findBestSplitEdge_FUN_005c8e70
    PUSH ESI                            ; 005c8e71
    PUSH EDI                            ; 005c8e72
    PUSH EBP                            ; 005c8e73
    ...
    CALL shape_superopt.cpp_CComplexPolygon_splitEdgesByPlane_FUN_005c9aa0 ; 005c8fcf
    ...
    CALL shape_superopt.cpp_CComplexPolygon_closeSplitBoundary_FUN_005ca590 ; 005c901e
    ...
    PUSH ECX                            ; 005c903a
    PUSH EBX                            ; 005c903b
    CALL shape_superopt.cpp_CComplexPolygon_closeSplitBoundary_FUN_005ca590 ; 005c903c
        ;   XREF to: 005ca590 (UNCONDITIONAL_CALL)  ; int shape_superopt.cpp_CComplexPolygon_closeSplitBoundary_FUN_005ca590(CComplexPolygon * this_ptr, SExpandedEdge * edges, int * edge_count_ptr, int is_secondary)
    ...
    PUSH EDI                            ; 005c9062
    PUSH EBX                            ; 005c9063
    CALL shape_superopt.cpp_CComplexPolygon_computeArea_FUN_005c9100 ; 005c9064
    ...
    PUSH EDX                            ; 005c90a5
    PUSH EBX                            ; 005c90a6
    CALL shape_superopt.cpp_CComplexPolygon_computeArea_FUN_005c9100 ; 005c90a7
        ;   XREF to: 005c9100 (UNCONDITIONAL_CALL)  ; double shape_superopt.cpp_CComplexPolygon_computeArea_FUN_005c9100(CComplexPolygon * this_ptr, SExpandedEdge * edges, int edge_count)
