  ...
  if (this_ptr->poly_count != 0) {
    do {
      ...
      if ((pCVar15->position).x <= (pCVar1->position).x) {
        local_264 = *(undefined4 *)&(pCVar15->position).x;
        uVar11 = *(undefined4 *)((int)&(pCVar15->position).x + 4);
      }
      else {
        local_264 = *(undefined4 *)&(pCVar1->position).x;
        uVar11 = *(undefined4 *)((int)&(pCVar1->position).x + 4);
      }
      if ((((CVert *)this_ptr)->position).x <= (double)CONCAT44(uVar11,local_264)) {
      ...
      local_1f4 = (double)CONCAT44(local_258,iStack_25c) + DOUBLE_0065452a;
      if ((pCVar15->position).y <= (pCVar1->position).y) {
        local_2a4 = *(undefined4 *)&(pCVar15->position).y;
        pCVar13 = pCVar15;
      }
      else {
        local_2a4 = *(undefined4 *)&(pCVar1->position).y;
        pCVar13 = pCVar1;
      }
      local_2a0 = *(undefined4 *)((int)&(pCVar13->position).y + 4);
      if ((((CVert *)this_ptr)->position).y <= (double)CONCAT44(local_2a0,local_2a4)) {
      ...
      local_204 = (double)CONCAT44(pCVar12,iStack_23c) + DOUBLE_0065452a;
      if ((pCVar15->position).z <= (pCVar1->position).z) {
        local_274 = *(undefined4 *)&(pCVar15->position).z;
        pCVar13 = pCVar15;
      }
      else {
        local_274 = *(undefined4 *)&(pCVar1->position).z;
        pCVar13 = pCVar1;
      }
      uVar11 = *(undefined4 *)((int)&(pCVar13->position).z + 4);
      if ((((CVert *)this_ptr)->position).z <= (double)CONCAT44(uVar11,local_274)) {
        local_218._4_4_ = *(undefined4 *)&(((CVert *)this_ptr)->position).z;
      ...
      local_20c = (double)CONCAT44(local_210,local_218._4_4_) + DOUBLE_0065452a;
      if ((pCVar1->position).x <= (pCVar15->position).x) {
        uStack_27c = *(undefined4 *)&(pCVar15->position).x;
        pCVar13 = pCVar15;
      }
      else {
        uStack_27c = *(undefined4 *)&(pCVar1->position).x;
        pCVar13 = pCVar1;
      }
      if ((double)CONCAT44(*(undefined4 *)((int)&(pCVar13->position).x + 4),uStack_27c) <=
      ...
      dVar2 = (double)CONCAT44(pCVar13,iStack_24c) + DOUBLE_00654532;
      if ((pCVar1->position).y <= (pCVar15->position).y) {
        uStack_2b4 = *(undefined4 *)&(pCVar15->position).y;
        pCVar14 = pCVar15;
      }
      else {
        uStack_2b4 = *(undefined4 *)&(pCVar1->position).y;
        pCVar14 = pCVar1;
      }
      local_2b0 = *(undefined4 *)((int)&(pCVar14->position).y + 4);
      if ((double)CONCAT44(local_2b0,uStack_2b4) <= (((CVert *)this_ptr)->position).y) {
      ...
      if ((pCVar1->position).z <= (pCVar15->position).z) {
        uStack_294 = *(undefined4 *)&(pCVar15->position).z;
        pCVar14 = pCVar15;
      }
      else {
        uStack_294 = *(undefined4 *)&(pCVar1->position).z;
        pCVar14 = pCVar1;
      }
      if ((double)CONCAT44(*(undefined4 *)((int)&(pCVar14->position).z + 4),uStack_294) <=
      ...
      pvVar19 = (void *)0x0;
      local_1fc = (undefined1  [8])((double)CONCAT44(local_2b8,iStack_2bc) + DOUBLE_00654532);
      if (*(int *)&(((CVert *)this_ptr)->position).x != 0) {
        ...
        do {
          if (((pvVar19 != local_4c) && (pvVar19 != local_48)) && (pvVar19 != local_50)) {
            ...
            puVar23 = (undefined4 *)auStack_130;
            for (iVar18 = 6; iVar18 != 0; iVar18 = iVar18 + -1) {
              *puVar23 = *puVar21;
              puVar21 = puVar21 + (uint)bVar24 * -2 + 1;
              puVar23 = puVar23 + (uint)bVar24 * -2 + 1;
            }
            if (((((double)CONCAT44(pCVar12,iStack_23c) <=
                   (double)CONCAT44(auStack_130._4_4_,auStack_130._0_4_)) &&
                 ((double)CONCAT44(auStack_130._4_4_,auStack_130._0_4_) <=
                  (double)CONCAT44(local_2b0,uStack_2b4))) &&
                (((double)CONCAT44(pCVar13,iStack_24c) <=
                  (double)CONCAT44(auStack_128._4_4_,auStack_128._0_4_) &&
                 (((double)CONCAT44(auStack_128._4_4_,auStack_128._0_4_) <=
                   (double)CONCAT44(uVar11,local_274) &&
                  ((double)CONCAT44(local_250,iStack_254) <=
                   (double)CONCAT44(auStack_128._12_4_,auStack_128._8_4_))))))) &&
               ((double)CONCAT44(auStack_128._12_4_,auStack_128._8_4_) <=
                (double)CONCAT44(local_240,iStack_244))) {
              ...
              if (iVar18 == 0) {
                ...
                pCVar10 = local_30;
                local_268 = (undefined4)((ulonglong)dVar2 >> 0x20);
                if (iVar18 == 0) {
                  iVar18 = shape_superopt_cpp_isPointOnLineSegment_FUN_005d6c10
                                     ((CVector3d *)auStack_128,local_3c,local_30);
                  if (iVar18 == 0) goto LAB_005d4d06;
                  local_13c = *(undefined4 *)&local_38->x;
                  uStack_138 = *(undefined4 *)((int)&local_38->x + 4);
                  local_134 = *(undefined4 *)&local_38->y;
                  auStack_130._0_4_ = *(undefined4 *)((int)&local_38->y + 4);
                  auStack_130._4_4_ = *(undefined4 *)&local_38->z;
                  auStack_128._0_4_ = *(undefined4 *)((int)&local_38->z + 4);
                  uStack_154 = *(undefined4 *)&pCVar10->x;
                  uStack_150 = *(undefined4 *)((int)&pCVar10->x + 4);
                  uStack_14c = *(undefined4 *)&pCVar10->y;
                  uStack_148 = *(undefined4 *)((int)&pCVar10->y + 4);
                  uStack_144 = *(undefined4 *)&pCVar10->z;
                  uStack_140 = *(undefined4 *)((int)&pCVar10->z + 4);
                  ...
                  local_264 = *local_54;
                  uStack_158 = *(undefined4 *)&local_3c->x;
                  uStack_154 = *(undefined4 *)((int)&local_3c->x + 4);
                  uStack_150 = *(undefined4 *)&local_3c->y;
                  uStack_14c = *(undefined4 *)((int)&local_3c->y + 4);
                  uStack_148 = *(undefined4 *)&local_3c->z;
                  uStack_144 = *(undefined4 *)((int)&local_3c->z + 4);
                  local_258 = *(CVert **)(iStack_58 + 4);
                  puStack_64 = (undefined4 *)0x0;
                  puStack_5c = (undefined4 *)&DAT_00000002;
                }
              }
              else {
                uStack_60 = 1;
                ...
                uStack_15c = *(undefined4 *)&local_38->x;
                uStack_158 = *(undefined4 *)((int)&local_38->x + 4);
                uStack_154 = *(undefined4 *)&local_38->y;
                uStack_150 = *(undefined4 *)((int)&local_38->y + 4);
                uStack_14c = *(undefined4 *)&local_38->z;
                uStack_148 = *(undefined4 *)((int)&local_38->z + 4);
                uStack_68 = 2;
              }
              puStack_64 = (undefined4 *)((int)puStack_64 + -1);
              if ((int)puStack_64 < 1) {
              ...
              pCVar10 = local_40;
              dVar2 = (double)CONCAT44(uStack_148,uStack_14c) -
                      (double)CONCAT44(auStack_130._0_4_,local_134);
              dVar7 = (double)CONCAT44(uStack_140,uStack_144) -
                      (double)CONCAT44(auStack_128._0_4_,auStack_130._4_4_);
              local_20c = (double)CONCAT44(*(undefined4 *)
                                            ((int)&local_40->x + (int)local_50 * 4 + 4),pvVar19);
              dVar6 = (double)CONCAT44(uStack_138,local_13c) -
                      (double)CONCAT44(auStack_128._8_4_,auStack_128._4_4_);
              local_204._0_4_ = *(undefined4 *)((int)&local_40->x + iStack_58 * 4 + 4);
              *(void **)((int)&local_40->x + (int)local_50 * 4 + 4) = pvVar19;
              dVar3 = (double)CONCAT44(auStack_128._16_4_,auStack_128._12_4_) -
                      (double)CONCAT44(auStack_130._0_4_,local_134);
              dVar4 = (double)auStack_128._20_8_ -
                      (double)CONCAT44(auStack_128._0_4_,auStack_130._4_4_);
              dVar5 = local_10c - (double)CONCAT44(auStack_128._8_4_,auStack_128._4_4_);
              local_104 = (double)CONCAT44(iStack_24c,local_250) -
                          (double)CONCAT44(iStack_254,local_258);
              dVar8 = (double)CONCAT44(uStack_2dc,in_stack_fffffd20);
              dVar9 = local_104;
              local_fc = (double)CONCAT44(local_264,local_268) - dVar8;
              local_d4 = (undefined4)local_104;
              (&uStack_d0)[(uint)bVar24 * -2] =
                   *(undefined4 *)((int)&local_104 + (uint)bVar24 * -8 + 4);
              local_104 = dVar9;
              *(undefined4 *)(&local_cc + (-(uint)bVar24 - (uint)bVar24)) =
                   *(undefined4 *)(&local_fc + (-(uint)bVar24 - (uint)bVar24));
              *(undefined4 *)
              ...
              local_b4 = (double)CONCAT44(uStack_d0,local_d4) * dVar2;
              dVar3 = local_b4;
              local_ac[0] = local_cc * dVar2;
              auStack_f0[3] = (undefined4)local_b4;
              local_b4 = dVar3;
              auStack_f0[(uint)bVar24 * -2 + 4] =
                   *(undefined4 *)((int)&local_b4 + (uint)bVar24 * -8 + 4);
              *(undefined4 *)(&local_dc + (-(uint)bVar24 - (uint)bVar24)) =
                   *(undefined4 *)(local_ac + (-(uint)bVar24 - (uint)bVar24));
              *(undefined4 *)
               ((int)(&local_dc + (-(uint)bVar24 - (uint)bVar24)) + ((uint)bVar24 * -2 + 1) * 4) =
                   *(undefined4 *)
                    ((int)(local_ac + (-(uint)bVar24 - (uint)bVar24)) + ((uint)bVar24 * -2 + 1) * 4)
              ;
              local_c4 = (double)CONCAT44(iStack_254,local_258) +
                         (double)CONCAT44(local_e0,auStack_f0[3]);
              dVar2 = local_c4;
              local_bc = dVar8 + local_dc;
              local_f4 = (undefined4)local_c4;
              local_c4 = dVar2;
              auStack_f0[(uint)bVar24 * -2] =
                   *(undefined4 *)((int)&local_c4 + (uint)bVar24 * -8 + 4);
              auStack_f0[(uint)bVar24 * -2 + (uint)bVar24 * -2 + 1] =
                   *(undefined4 *)(&local_bc + (-(uint)bVar24 - (uint)bVar24));
              (auStack_f0 + (uint)bVar24 * -2 + (uint)bVar24 * -2 + 1)[(uint)bVar24 * -2 + 1] =
                   *(undefined4 *)
                    ((int)(&local_bc + (-(uint)bVar24 - (uint)bVar24)) + ((uint)bVar24 * -2 + 1) * 4
                    );
              local_204 = (double)CONCAT44(local_f4,(undefined4)local_204);
              local_1fc._4_4_ = auStack_f0[1];
              local_1fc._0_4_ = auStack_f0[0];
              pdVar20 = &pCVar10->z + (int)local_50 * 2;
              local_1f4 = (double)CONCAT44(*(undefined4 *)pdVar20,auStack_f0[2]);
              ...
              *(undefined4 *)pdVar20 = local_f4;
              *(undefined4 *)((int)pdVar20 + 4) = auStack_f0[0];
              *(undefined4 *)(pdVar20 + 1) = auStack_f0[1];
              *(undefined4 *)((int)pdVar20 + 0xc) = auStack_f0[2];
...
//   XREF to: Stack[-0x10c] (DATA)
// 005d507b: PUSH EAX
// 005d507c: CALL shape_superopt.cpp_isPointOnLineSegment_FUN_005d6c10
...
//   XREF to: Stack[-0x10c] (DATA)
// 005d54e4: PUSH EAX
// 005d54e5: CALL shape_superopt.cpp_isPointOnLineSegment_FUN_005d6c10
//   XREF to: 005d6c10 (UNCONDITIONAL_CALL)
...
//   XREF to: Stack[-0x10c] (DATA)
// 005d5669: PUSH EAX
// 005d566a: CALL shape_superopt.cpp_isPointOnLineSegment_FUN_005d6c10
//   XREF to: 005d6c10 (UNCONDITIONAL_CALL)
