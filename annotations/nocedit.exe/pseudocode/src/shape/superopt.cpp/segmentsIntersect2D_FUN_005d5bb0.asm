...
;                               FUNCTION
; *****************************************************************************
; __cdecl int shape_superopt.cpp_segmentsIntersect2D_FUN_005d5bb0(CVector2d * point_a, CVector2d * point_b, CVector2d * point_c, CVector2d * point_d)
;
; Parameters:
...
section .text
    ...
    FNSTSW AX                           ; 005d5c9d
    SAHF                                ; 005d5c9f
    JA 0x005d5da9                       ; 005d5ca0 | LAB_005d5da9
    ...
    FLD double ptr [ESP + 0x10]         ; 005d5cb6
        ;   Label: LAB_005d5cb6
    FCOMP double ptr [0x0065453a]       ; 005d5cba | double DOUBLE_0065453a
    FNSTSW AX                           ; 005d5cc0
    SAHF                                ; 005d5cc2
    JC 0x005d5da1                       ; 005d5cc3 | LAB_005d5da1
        ;   XREF to: 005d5da1 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 005d5d19
    SAHF                                ; 005d5d1b
    JA 0x005d5db8                       ; 005d5d1c | LAB_005d5db8
    ...
    FLD double ptr [ESP + 0x8]          ; 005d5d32
        ;   Label: LAB_005d5d32
    FCOMP double ptr [0x0065453a]       ; 005d5d36 | double DOUBLE_0065453a
    FNSTSW AX                           ; 005d5d3c
    SAHF                                ; 005d5d3e
    JC 0x005d5da1                       ; 005d5d3f | LAB_005d5da1
        ;   XREF to: 005d5da1 (CONDITIONAL_JUMP)
    FLDZ                                ; 005d5d41
    FCOMP double ptr [ESP + 0x20]       ; 005d5d43
    FNSTSW AX                           ; 005d5d47
    SAHF                                ; 005d5d49
    JA 0x005d5dc7                       ; 005d5d4a | LAB_005d5dc7
    ...
    FLD double ptr [ESP]                ; 005d5d5f
        ;   Label: LAB_005d5d5f
    FCOMP double ptr [0x0065453a]       ; 005d5d62 | double DOUBLE_0065453a
    FNSTSW AX                           ; 005d5d68
    SAHF                                ; 005d5d6a
    JC 0x005d5da1                       ; 005d5d6b | LAB_005d5da1
        ;   XREF to: 005d5da1 (CONDITIONAL_JUMP)
    FLDZ                                ; 005d5d6d
    FCOMP double ptr [ESP + 0x28]       ; 005d5d6f
    FNSTSW AX                           ; 005d5d73
    SAHF                                ; 005d5d75
    JA 0x005d5da1                       ; 005d5d76 | LAB_005d5da1
        ;   XREF to: 005d5da1 (CONDITIONAL_JUMP)
    FLDZ                                ; 005d5d78
    FCOMP double ptr [ESP + 0x20]       ; 005d5d7a
    FNSTSW AX                           ; 005d5d7e
    SAHF                                ; 005d5d80
    JA 0x005d5da1                       ; 005d5d81 | LAB_005d5da1
        ;   XREF to: 005d5da1 (CONDITIONAL_JUMP)
    FLD double ptr [ESP + 0x28]         ; 005d5d83
    FCOMP double ptr [0x00654542]       ; 005d5d87 | double DOUBLE_00654542
    FNSTSW AX                           ; 005d5d8d
    SAHF                                ; 005d5d8f
    JA 0x005d5da1                       ; 005d5d90 | LAB_005d5da1
        ;   XREF to: 005d5da1 (CONDITIONAL_JUMP)
    FLD double ptr [ESP + 0x20]         ; 005d5d92
    FCOMP double ptr [0x00654542]       ; 005d5d96 | double DOUBLE_00654542
    FNSTSW AX                           ; 005d5d9c
    SAHF                                ; 005d5d9e
    JBE 0x005d5dd2                      ; 005d5d9f | LAB_005d5dd2
