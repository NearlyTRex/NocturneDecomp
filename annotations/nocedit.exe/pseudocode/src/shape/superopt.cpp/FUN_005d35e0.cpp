// Name: shape_superopt.cpp_FUN_005d35e0
// Address: 005d35e0
// Address Range: [[005d35e0, 005d3649]]
// Convention: unknown
// Signature: undefined shape_superopt.cpp_FUN_005d35e0()
// Cross-references:
//   shape_superopt.cpp_FUN_005d7350 (005d7350) at 005d7361 [UNCONDITIONAL_CALL]
//   shape_superopt.cpp_ReduceDatabaseVerticesPolygonsJunctions_FUN_005d7290 (005d7290) at 005d72cb [UNCONDITIONAL_CALL]

#include "nocturne.h"

/* Signature: undefined1 shape_superopt.cpp_FUN_005d35e0(undefined4 param_1, undefined4 param_2) */

uint shape_superopt_cpp_FUN_005d35e0(uint param_1)

{
  ...
  if (in_stack_00000004[2] != 0) {
    do {
      uVar2 = uVar2 + 1;
      param_1 = (**(code **)(*(int *)(uVar1 + 100) + 0x2c))();
      uVar1 = uVar1 + 0x68;
    } while (uVar2 < in_stack_00000004[2]);
  }
  in_stack_00000004[4] = in_stack_00000004[4] & ~in_stack_00000008;
  return param_1;
}
...
// Assembly code:
// 005d35e0: PUSH EBX
//   Label: shape_superopt.cpp_FUN_005d35e0
// 005d35e1: PUSH ESI
// 005d35e2: PUSH EDI
// 005d35e3: PUSH EBP
