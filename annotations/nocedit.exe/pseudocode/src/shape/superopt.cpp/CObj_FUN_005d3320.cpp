// Name: shape_superopt.cpp_CObj_FUN_005d3320
// Address: 005d3320
// Address Range: [[005d3320, 005d3340]]
// Convention: __cdecl
// Signature: int shape_superopt.cpp_CObj_FUN_005d3320(CObj * this_ptr)

#include "nocturne.h"

int __cdecl shape_superopt_cpp_CObj_FUN_005d3320(CObj *this_ptr)

{
  ...
  return (int)(in_stack_00000008 * 0x38 + (int)this_ptr->vertex_data);
}


// Assembly code:
// 005d3320: MOV ECX,dword ptr [ESP + 0x4]
//   Label: shape_superopt.cpp_CObj_FUN_005d3320
