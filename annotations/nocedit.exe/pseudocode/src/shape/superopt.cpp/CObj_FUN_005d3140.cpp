// Name: shape_superopt.cpp_CObj_FUN_005d3140
// Address: 005d3140
// Address Range: [[005d3140, 005d3241]]
// Convention: __cdecl
// Signature: int shape_superopt.cpp_CObj_FUN_005d3140(CObj * this_ptr)
// Function calls:
...
int __cdecl shape_superopt_cpp_CObj_FUN_005d3140(CObj *this_ptr)

{
  ...
  if ((uint)this_ptr->field0_0x0 <= in_stack_00000008) {
    return 0;
  }
  uVar5 = this_ptr->field0_0x0 - 1;
  this_ptr->field0_0x0 = uVar5;
  if (in_stack_00000008 < uVar5) {
    crt_string_c_memmove_FUN_005fe5e0
              ((void *)((int)this_ptr->vertex_data + in_stack_00000008 * 0x38),
               (void *)((in_stack_00000008 + 1) * 0x38 + (int)this_ptr->vertex_data),
               (uVar5 - in_stack_00000008) * 0x38);
  }
  if (this_ptr->field0_0x0 != 0) {
    puVar3 = (undefined1 *)
             crt_memory_c_realloc_FUN_00601df0(this_ptr->vertex_data,this_ptr->field0_0x0 * 0x38);
    if (puVar3 != (undefined1 *)0x0) {
      uVar5 = 0;
      this_ptr->vertex_data = puVar3;
      if (this_ptr->count != 0) {
        iVar4 = 0;
        do {
...
// Assembly code:
// 005d3140: PUSH EBX
//   Label: shape_superopt.cpp_CObj_FUN_005d3140
// 005d3141: PUSH ESI
// 005d3142: PUSH EBP
