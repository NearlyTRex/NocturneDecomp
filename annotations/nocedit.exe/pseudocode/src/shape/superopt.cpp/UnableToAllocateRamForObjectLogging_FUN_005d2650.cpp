// Name: shape_superopt.cpp_UnableToAllocateRamForObjectLogging_FUN_005d2650
// Address: 005d2650
// Address Range: [[005d2650, 005d2715]]
// Convention: unknown
// Signature: undefined shape_superopt.cpp_UnableToAllocateRamForObjectLogging_FUN_005d2650()
// Cross-references:
//   shape_superopt.cpp_setGeometry_CopyMergeObject_FUN_005d71e0 (005d71e0) at 005d71fa [UNCONDITIONAL_CALL]
// Globals:
...
/* Signature: undefined1 shape_superopt.cpp_UnableToAllocateRamForObjectLogging(undefined4 param_1)
    */

undefined4 shape_superopt_cpp_UnableToAllocateRamForObjectLogging_FUN_005d2650(void)

{
  ...
  bVar6 = 0;
  (**(code **)(in_stack_00000004[6] + 0x1c))();
  (**(code **)in_stack_00000004[6])();
  iVar1 = (**(code **)(in_stack_00000004[6] + 8))();
  if (iVar1 == 0) {
    shape_superopt_cpp_SomethingAboutLogTXTCreate_FUN_005c7910();
    return 0;
  }
  puVar4 = *(undefined4 **)(in_stack_00000008 + 4);
  puVar5 = (undefined4 *)in_stack_00000004[1];
  for (uVar3 = (uint)(*in_stack_00000004 * 0x38) >> 2; uVar3 != 0; uVar3 = uVar3 - 1) {
    *puVar5 = *puVar4;
  ...
  if (in_stack_00000004[2] != 0) {
    iVar1 = 0;
    do {
      iVar2 = in_stack_00000004[3] + iVar1;
      uVar3 = uVar3 + 1;
      iVar1 = iVar1 + 0x68;
      (**(code **)(*(int *)(iVar2 + 100) + 4))();
    } while (uVar3 < (uint)in_stack_00000004[2]);
  }
  in_stack_00000004[4] = *(int *)(in_stack_00000008 + 0x10);
  return 1;
}
...
// Assembly code:
// 005d2650: PUSH EBX
//   Label: shape_superopt.cpp_UnableToAllocateRamForObjectLogging_FUN_005d2650
// 005d2651: PUSH EBP
...
// 005d2709: CALL shape_superopt.cpp_SomethingAboutLogTXTCreate_FUN_005c7910
