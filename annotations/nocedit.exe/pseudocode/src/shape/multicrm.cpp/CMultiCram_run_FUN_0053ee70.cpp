...

{
  ...
  for (local_1c = 0; (int)local_1c < this_ptr->model_count; local_1c = local_1c + 1) {
    ...
    _sprintf
              (local_11c,"Found model : %s",this_ptr->models[local_1c]->model_name);
  ...
  for (local_1c = 0; (int)local_1c < this_ptr->model_count; local_1c = local_1c + 1) {
    _sprintf
              (local_11c,"%s.bin",this_ptr->models[local_1c]->model_name);
    iVar2 = shape_dsemodel_cpp_CDSEModel_fitToExistingBIN_FUN_0048fed0
                      (this_ptr->models[local_1c],local_11c);
    if (iVar2 == 0) {
      _sprintf
                (local_11c,"%s is a new model.",this_ptr->models[local_1c]->model_name);
    }
    else {
      _sprintf
                (local_11c,"Sizing %s to existing .BIN file",
    ...
    _sprintf
              (local_11c,"%s.mdl",this_ptr->models[local_1c]->model_name);
    ...
    for (local_18 = 0x61; local_18 < 0x7b; local_18 = local_18 + 1) {
      _sprintf
                (local_11c,"%s%c.bin",this_ptr->models[local_1c]->model_name,local_18);
      ...
      if (file_ptr != (_FILE *)0x0) {
        ...
        shape_dsemodel_cpp_CDSEModel_fitToExistingBIN_FUN_0048fed0
                  (this_ptr->models[local_1c],local_11c);
        _sprintf
                  (local_11c,"Found clone of different size : %s%c",
        ...
        shape_dsemodel_cpp_CDSEModel_load_FUN_0048f960(this_ptr->models[local_1c]);
        _sprintf
                  (local_11c,"%s%c.mdl",this_ptr->models[local_1c]->model_name,local_18);
        shape_design_c_exportModelToMDL_FUN_00459e80(local_11c);
        _sprintf
                  (local_11c,"%s%c.bin",this_ptr->models[local_1c]->model_name,local_18);
        shape_design_c_exportModelToBIN_FUN_0045aa80(local_11c,0x4e,0x35,1,0x59);
