...
;                               FUNCTION
; *****************************************************************************
; __cdecl CStrList * shape_edittool.cpp_CStrList_copy_FUN_004a2a90(CStrList * this_ptr, CStrList * other)
;
; Parameters:
...
section .text
    ...
    MOV dword ptr [EBX + 0xc],0x65d474  ; 004a2a99 | CStrList_vtable g_CStrListVTable
    PUSH EDX                            ; 004a2aa0
    MOV dword ptr [EBX],0x0             ; 004a2aa1
    PUSH EBX                            ; 004a2aa7
    MOV dword ptr [EBX + 0x8],0x0       ; 004a2aa8
    CALL shape_edittool.cpp_CStrList_copyFrom_FUN_004a2ac0 ; 004a2aaf | CStrList * shape_edittool.cpp_CStrList_copyFrom_FUN_004a2ac0(CStrList * dest_ptr, CStrList * source_ptr)
