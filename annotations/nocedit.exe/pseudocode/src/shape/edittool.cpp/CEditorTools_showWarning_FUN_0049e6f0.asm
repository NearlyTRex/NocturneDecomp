...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_edittool.cpp_CEditorTools_showWarning_FUN_0049e6f0(CEditorTools * this_ptr, char * format, ...)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 0049e702
    PUSH 0x2cef130                      ; 0049e703 | char[1024] g_DialogMessageBuffer
    CALL crt_stdio.c_vsprintf_FUN_005fdba8 ; 0049e708 | int crt_stdio.c_vsprintf_FUN_005fdba8(char * buffer, char * format, va_list_t * args)
        ;   XREF to: 005fdba8 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0049e70d
    MOV EBX,dword ptr [0x02cf2a90]      ; 0049e710 | HWND g_DialogParentWindow
    PUSH EBX                            ; 0049e716
    PUSH 0x2cef130                      ; 0049e717 | char[1024] g_DialogMessageBuffer
    XOR ECX,ECX                         ; 0049e71c
    PUSH 0x623010                       ; 0049e71e | = "Warning" | s_Warning_00623010 = Warning
    MOV dword ptr [ESP + 0xc],ECX       ; 0049e723
    CALL shape_edittool.cpp_drawSingleButtonPrompt_FUN_0049e130 ; 0049e727 | void shape_edittool.cpp_drawSingleButtonPrompt_FUN_0049e130(char * title, char * message, int color)
