...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl shape_edittool_cpp_CPickList_setCancelButtonText_FUN_004a3d90(CPickList *this_ptr,char *text)
;
; Parameters:
...
;   core_setedit.cpp_CDemonSet_BuildingThumbnailImages_FUN_00576da0 at 00576f8f
