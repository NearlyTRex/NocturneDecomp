...
section .text
    ...
    JNZ 0x004a3d33                      ; 004a3d27 | LAB_004a3d33
    ...
    JC 0x004a3d68                       ; 004a3d43 | LAB_004a3d68
        ;   XREF to: 004a3d68 (CONDITIONAL_JUMP)
    MOV EDX,0x6239f5                    ; 004a3d45 | = "..\\shape\\edittool.cpp" | s_shape_edittool_cpp_006239f5 = ..\shape\edittool.cpp
    MOV ECX,0xd78                       ; 004a3d4a
    PUSH 0x623a0b                       ; 004a3d4f | = "CPickList::setOkButtonText - too long!" | s_CPickList_setOkButtonTex_00623a0b = CPickList::setOkButtonText - too long!
    MOV dword ptr [0x02f0ca48],EDX      ; 004a3d54 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 004a3d5a | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004a3d60 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    CMP AL,0x0                          ; 004a3d74
    JZ 0x004a3d88                       ; 004a3d76 | LAB_004a3d88
    ...
    CMP AL,0x0                          ; 004a3d84
    JNZ 0x004a3d70                      ; 004a3d86 | LAB_004a3d70
