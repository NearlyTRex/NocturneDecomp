...
section .text
    ...
    CMP dword ptr [0x02cf1cd0],0x0      ; 004a089c | g_EditorFont
    JNZ 0x004a08c8                      ; 004a08a3
        ;   XREF to: 004a08c8 (CONDITIONAL_JUMP)  ; LAB_004a08c8
    MOV ECX,0x622eae                    ; 004a08a5 | = "..\\shape\\edittool.cpp"
    MOV EBX,0x8d                        ; 004a08aa
    PUSH 0x622ec4                       ; 004a08af | = "gEdFont must be set by the application."
    MOV dword ptr [0x02f0ca48],ECX      ; 004a08b4 | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 004a08ba | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004a08c0
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ADD ESP,0x4                         ; 004a08c5
    MOV EAX,[0x02cf1cd0]                ; 004a08c8 | g_EditorFont
        ;   Label: LAB_004a08c8
    PUSH 0x6a                           ; 004a08cd
    ...
    JNZ 0x004a0941                      ; 004a08eb
        ;   XREF to: 004a0941 (CONDITIONAL_JUMP)  ; LAB_004a0941
    MOV EDX,dword ptr [0x00679394]      ; 004a08ed | g_WindowWidth
        ;   Label: LAB_004a08ed
    ...
    MOV EDX,dword ptr [0x00679398]      ; 004a0902 | g_WindowHeight
    ...
    PUSH EBP                            ; 004a0919
    MOV EBX,dword ptr [0x00679398]      ; 004a091a | g_WindowHeight
    PUSH ESI                            ; 004a0920
    SUB EBX,EAX                         ; 004a0921
    MOV EDX,dword ptr [0x00679394]      ; 004a0923 | g_WindowWidth
    PUSH EBX                            ; 004a0929
    ...
    PUSH EAX                            ; 004a0933
    CALL shape_edittool.cpp_CEditorTools_createModalWindow_FUN_004a0970 ; 004a0934
        ;   XREF to: 004a0970 (UNCONDITIONAL_CALL)  ; void shape_edittool.cpp_CEditorTools_createModalWindow_FUN_004a0970(CEditorTools * this_ptr, int left, int top, int right, ...)
    ...
    POP EBX                             ; 004a093f
    RET                                 ; 004a0940
    MOV EAX,[0x02cf1cd0]                ; 004a0941 | g_EditorFont
        ;   Label: LAB_004a0941
    PUSH ESI                            ; 004a0946
    MOV EDX,dword ptr [EAX + 0x25e8]    ; 004a0947
    PUSH EAX                            ; 004a094d
    LEA EBX,[EDX + EDX*0x1]             ; 004a094e
    CALL engine_font.cpp_CBitFont_getTextWidth_FUN_004cfe80 ; 004a0951
    ...
    JGE 0x004a08ed                      ; 004a095d
        ;   XREF to: 004a08ed (CONDITIONAL_JUMP)  ; LAB_004a08ed
    MOV EDI,EAX                         ; 004a095f
    JMP 0x004a08ed                      ; 004a0961
        ;   XREF to: 004a08ed (UNCONDITIONAL_JUMP)  ; LAB_004a08ed
