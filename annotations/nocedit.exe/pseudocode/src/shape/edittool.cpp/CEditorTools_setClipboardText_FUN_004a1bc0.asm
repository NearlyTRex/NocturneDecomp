...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_edittool.cpp_CEditorTools_setClipboardText_FUN_004a1bc0(CEditorTools * this_ptr, char * text_data)
;
; Parameters:
...
section .text
    ...
    JNZ 0x004a1bd3                      ; 004a1bc9 | LAB_004a1bd3
        ;   XREF to: 004a1bd3 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x18],0x623594 ; 004a1bcb | char s_EmptyChar_00623594
    MOV EDI,dword ptr [ESP + 0x18]      ; 004a1bd3
        ;   Label: LAB_004a1bd3
    SUB ECX,ECX                         ; 004a1bd7
    DEC ECX                             ; 004a1bd9
    XOR EAX,EAX                         ; 004a1bda
    SCASB.REPNE ES:EDI                  ; 004a1bdc | char s_EmptyChar_00623594 | = "..\\shape\\edittool.cpp"
    NOT ECX                             ; 004a1bde
    DEC ECX                             ; 004a1be0
    MOV ESI,dword ptr [0x03f98468]      ; 004a1be1 | HWND g_MainWindowHandle
    PUSH ESI                            ; 004a1be7
    LEA EBX,[ECX + 0x1]                 ; 004a1be8
    CALL dword ptr CS:[0x6114cc]        ; 004a1beb | OpenClipboard * OpenClipboard
    TEST EAX,EAX                        ; 004a1bf2
    JZ 0x004a1c46                       ; 004a1bf4 | LAB_004a1c46
        ;   XREF to: 004a1c46 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 004a1bf6
    PUSH 0x2002                         ; 004a1bf7
    CALL dword ptr CS:[0x6115cc]        ; 004a1bfc | GlobalAlloc * GlobalAlloc
    MOV EBP,EAX                         ; 004a1c03
    TEST EAX,EAX                        ; 004a1c05
    JZ 0x004a1c3f                       ; 004a1c07 | LAB_004a1c3f
        ;   XREF to: 004a1c3f (CONDITIONAL_JUMP)
    PUSH EAX                            ; 004a1c09
    CALL dword ptr CS:[0x6115d4]        ; 004a1c0a | GlobalLock * GlobalLock
    TEST EAX,EAX                        ; 004a1c11
    JZ 0x004a1c6e                       ; 004a1c13 | LAB_004a1c6e
        ;   XREF to: 004a1c6e (CONDITIONAL_JUMP)
    ...
    POP EDI                             ; 004a1c2c
    PUSH EBP                            ; 004a1c2d
    CALL dword ptr CS:[0x6115dc]        ; 004a1c2e | GlobalUnlock * GlobalUnlock
    PUSH EBP                            ; 004a1c35
    PUSH 0x1                            ; 004a1c36
    CALL dword ptr CS:[0x6114dc]        ; 004a1c38 | SetClipboardData * SetClipboardData
    CALL dword ptr CS:[0x611490]        ; 004a1c3f | CloseClipboard * CloseClipboard
        ;   Label: LAB_004a1c3f
    PUSH 0x99f                          ; 004a1c46
        ;   Label: LAB_004a1c46
    PUSH 0x623595                       ; 004a1c4b | = "..\\shape\\edittool.cpp" | s_shape_edittool_cpp_00623595 = ..\shape\edittool.cpp
    PUSH EBX                            ; 004a1c50
    MOV EDI,dword ptr [0x02cf1cd8]      ; 004a1c51 | char * g_ClipboardBackupText
    PUSH EDI                            ; 004a1c57
    CALL shape_memdbg.cpp_debugRealloc_FUN_0050f540 ; 004a1c58 | void * shape_memdbg.cpp_debugRealloc_FUN_0050f540(void * ptr, int new_size, char * filename, int line_number)
        ;   XREF to: 0050f540 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004a1c5d
    MOV [0x02cf1cd8],EAX                ; 004a1c60 | char * g_ClipboardBackupText
    TEST EAX,EAX                        ; 004a1c65
    JNZ 0x004a1c78                      ; 004a1c67 | LAB_004a1c78
        ;   XREF to: 004a1c78 (CONDITIONAL_JUMP)
    POP EBP                             ; 004a1c69
    POP EDI                             ; 004a1c6a
    POP ESI                             ; 004a1c6b
    POP EBX                             ; 004a1c6c
    ...
    PUSH EBP                            ; 004a1c6e
        ;   Label: LAB_004a1c6e
    CALL dword ptr CS:[0x6115d0]        ; 004a1c6f | GlobalFree * GlobalFree
    JMP 0x004a1c3f                      ; 004a1c76 | LAB_004a1c3f
        ;   XREF to: 004a1c3f (UNCONDITIONAL_JUMP)
