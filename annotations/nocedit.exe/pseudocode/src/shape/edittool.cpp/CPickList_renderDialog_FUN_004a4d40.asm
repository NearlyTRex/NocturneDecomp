...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_edittool.cpp_CPickList_renderDialog_FUN_004a4d40(CPickList * this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [0x00678a60]      ; 004a4d4a | CEditorTools g_CEditorToolsPtr | CEditorTools * g_CEditorToolsPtr
    PUSH EDX                            ; 004a4d50 | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_paintCurrentWindow_FUN_004a0f80 ; 004a4d51 | void shape_edittool.cpp_CEditorTools_paintCurrentWindow_FUN_004a0f80(CEditorTools * this_ptr)
        ;   XREF to: 004a0f80 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004a4d56
    PUSH 0x1                            ; 004a4d59
    MOV ECX,dword ptr [0x00678a60]      ; 004a4d5b | CEditorTools g_CEditorToolsPtr | CEditorTools * g_CEditorToolsPtr
    PUSH ECX                            ; 004a4d61 | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_drawWindowSeparator_FUN_004a1230 ; 004a4d62 | void shape_edittool.cpp_CEditorTools_drawWindowSeparator_FUN_004a1230(CEditorTools * editor_tools, int line_position)
        ;   XREF to: 004a1230 (UNCONDITIONAL_CALL)
    MOV EAX,[0x02d02558]                ; 004a4d67 | int g_ClipLeft
    ...
    JLE 0x004a4ec6                      ; 004a4da2 | LAB_004a4ec6
        ;   XREF to: 004a4ec6 (CONDITIONAL_JUMP)
    MOV EAX,[0x02d0255c]                ; 004a4da8 | int g_ClipTop
        ;   Label: LAB_004a4da8
    ...
    JLE 0x004a4de4                      ; 004a4dcc | LAB_004a4de4
    ...
    JL 0x004a4ff2                       ; 004a4dde | LAB_004a4ff2
        ;   XREF to: 004a4ff2 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x12c],0x0     ; 004a4de4
        ;   Label: LAB_004a4de4
    JLE 0x004a4e85                      ; 004a4dec | LAB_004a4e85
        ;   XREF to: 004a4e85 (CONDITIONAL_JUMP)
    MOV EAX,[0x02cf2ad8]                ; 004a4df2 | int g_HighlightColor2
    MOV EBP,dword ptr [0x02d02570]      ; 004a4df7 | int g_ActiveRenderColor
    MOV [0x02d02570],EAX                ; 004a4dfd | int g_ActiveRenderColor
    CALL shape_edittool.cpp_calculateGridHeight_FUN_004a64b0 ; 004a4e02 | int shape_edittool.cpp_calculateGridHeight_FUN_004a64b0()
        ;   XREF to: 004a64b0 (UNCONDITIONAL_CALL)
    MOV EDI,EAX                         ; 004a4e07
    MOV EAX,[0x00679398]                ; 004a4e09 | int g_WindowHeight
    ...
    JNZ 0x004a51b0                      ; 004a4e2a | LAB_004a51b0
    ...
    PUSH 0x0                            ; 004a4e3a
    CALL shape_edittool.cpp_calculateButtonHeight_FUN_004a6970 ; 004a4e3c | int shape_edittool.cpp_calculateButtonHeight_FUN_004a6970(char * button_text)
    ...
    JNZ 0x004a51ba                      ; 004a4e54 | LAB_004a51ba
        ;   XREF to: 004a51ba (CONDITIONAL_JUMP)
    MOV EAX,EDI                         ; 004a4e5a
    MOV EDX,dword ptr [0x02d02564]      ; 004a4e5c | int g_ClipBottom
        ;   Label: LAB_004a4e5c
    ...
    PUSH ESI                            ; 004a4e6e
    MOV EDI,dword ptr [0x02d0255c]      ; 004a4e6f | int g_ClipTop
    PUSH EDI                            ; 004a4e75
    PUSH ESI                            ; 004a4e76
    CALL engine_2d.c_drawLine_FUN_004011b0 ; 004a4e77 | void engine_2d.c_drawLine_FUN_004011b0(int x1, int y1, int x2, int y2)
        ;   XREF to: 004011b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004a4e7c
    MOV dword ptr [0x02d02570],EBP      ; 004a4e7f | int g_ActiveRenderColor
    ...
    JL 0x004a4da8                       ; 004a4ec0 | LAB_004a4da8
    ...
    JNZ 0x004a51c1                      ; 004a4ee3 | LAB_004a51c1
    ...
    CALL shape_edittool.cpp_CEdScrollBar_render_FUN_004a5c10 ; 004a4f11 | void shape_edittool.cpp_CEdScrollBar_render_FUN_004a5c10(CEdScrollBar * this_ptr)
        ;   Label: LAB_004a4f11
    ...
    JZ 0x004a4f4b                       ; 004a4f24 | LAB_004a4f4b
    ...
    PUSH EAX                            ; 004a4f42
    CALL shape_edittool.cpp_CEdButton_paint_FUN_004a65e0 ; 004a4f43 | void shape_edittool.cpp_CEdButton_paint_FUN_004a65e0(CEdButton * this_ptr, int draw_border_flag)
    ...
    JZ 0x004a4f80                       ; 004a4f59 | LAB_004a4f80
    ...
    PUSH EAX                            ; 004a4f77
    CALL shape_edittool.cpp_CEdButton_paint_FUN_004a65e0 ; 004a4f78 | void shape_edittool.cpp_CEdButton_paint_FUN_004a65e0(CEdButton * this_ptr, int draw_border_flag)
        ;   XREF to: 004a65e0 (UNCONDITIONAL_CALL)
    ...
    JZ 0x004a5216                       ; 004a4f8c | LAB_004a5216
    ...
    JL 0x004a4dce                       ; 004a4fe7 | LAB_004a4dce
        ;   XREF to: 004a4dce (CONDITIONAL_JUMP)
    JMP 0x004a4de4                      ; 004a4fed | LAB_004a4de4
        ;   XREF to: 004a4de4 (UNCONDITIONAL_JUMP)
    CMP EAX,dword ptr [EDX + 0x17c]     ; 004a4ff2
        ;   Label: LAB_004a4ff2
    JNZ 0x004a507b                      ; 004a4ff8 | LAB_004a507b
    ...
    JZ 0x004a517d                       ; 004a5028 | LAB_004a517d
        ;   XREF to: 004a517d (CONDITIONAL_JUMP)
    MOV EAX,[0x02cf2ad4]                ; 004a502e | int g_HighlightColor1
    PUSH EAX                            ; 004a5033
        ;   Label: LAB_004a5033
    PUSH EDI                            ; 004a5034
    PUSH ESI                            ; 004a5035
    ...
    PUSH EAX                            ; 004a5045
    CALL engine_2d.c_fillRectColor_FUN_00403170 ; 004a5046 | void engine_2d.c_fillRectColor_FUN_00403170(int x1, int y1, int x2, int y2, ...)
    ...
    JNZ 0x004a507b                      ; 004a505c | LAB_004a507b
        ;   XREF to: 004a507b (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 004a505e
    PUSH EDI                            ; 004a5060
    PUSH ESI                            ; 004a5061
    ...
    PUSH ESI                            ; 004a506c
    MOV dword ptr [0x02d02570],ECX      ; 004a506d | int g_ActiveRenderColor
    CALL shape_edittool.cpp_drawDashedLine_FUN_0049d290 ; 004a5073 | void shape_edittool.cpp_drawDashedLine_FUN_0049d290(int x1, int y1, int x2, int y2, ...)
    ...
    CALL shape_edittool.cpp_CStrList_getStringAt_FUN_004a2f70 ; 004a5094 | char * shape_edittool.cpp_CStrList_getStringAt_FUN_004a2f70(CStrList * this_ptr, int index)
    ...
    MOV EAX,[0x02cf2ac8]                ; 004a50ba | int g_EnabledTextColor
    PUSH EDX                            ; 004a50bf
    MOV dword ptr [ESP + 0x144],EAX     ; 004a50c0
    CALL shape_edittool.cpp_CPickList_isItemEnabled_FUN_004a54e0 ; 004a50c7 | int shape_edittool.cpp_CPickList_isItemEnabled_FUN_004a54e0(CPickList * this_ptr, int item_index)
        ;   XREF to: 004a54e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004a50cc
    TEST EAX,EAX                        ; 004a50cf
    JZ 0x004a5187                       ; 004a50d1 | LAB_004a5187
    ...
    CMP BL,BH                           ; 004a50f2
    JZ 0x004a51a9                       ; 004a50f4 | LAB_004a51a9
        ;   XREF to: 004a51a9 (CONDITIONAL_JUMP)
    MOV BH,byte ptr [EAX]               ; 004a50fa
        ;   Label: LAB_004a50fa
    LEA ECX,[EAX + 0x1]                 ; 004a50fc
    CMP BH,0x9                          ; 004a50ff
    JNZ 0x004a5198                      ; 004a5102 | LAB_004a5198
        ;   XREF to: 004a5198 (CONDITIONAL_JUMP)
    MOV ESI,ECX                         ; 004a5108
    MOV byte ptr [EDX],BL               ; 004a510a
        ;   Label: LAB_004a510a
    PUSH 0xffff                         ; 004a510c
    CALL engine_3d.c_setRenderAlpha_FUN_00406d80 ; 004a5111 | void engine_3d.c_setRenderAlpha_FUN_00406d80(int alpha_color_value)
    ...
    PUSH EAX                            ; 004a5137
    MOV ECX,dword ptr [0x02cf1cd0]      ; 004a5138 | CBitFont * g_EditorFont
    PUSH ECX                            ; 004a513e
    MOV EDI,ESI                         ; 004a513f
    ADD EBP,0x4                         ; 004a5141
    CALL engine_font.cpp_CBitFont_drawTextLeft_FUN_004cda80 ; 004a5144 | int engine_font.cpp_CBitFont_drawTextLeft_FUN_004cda80(CBitFont * this_ptr, char * text_string, int x_pos, int y_pos, ...)
    ...
    CMP BL,CL                           ; 004a5170
    JZ 0x004a4f9d                       ; 004a5172 | LAB_004a4f9d
        ;   XREF to: 004a4f9d (CONDITIONAL_JUMP)
    JMP 0x004a50ec                      ; 004a5178 | LAB_004a50ec
        ;   XREF to: 004a50ec (UNCONDITIONAL_JUMP)
    MOV EAX,[0x02cf2ad0]                ; 004a517d | int g_SelectionHighlightColor
        ;   Label: LAB_004a517d
    JMP 0x004a5033                      ; 004a5182 | LAB_004a5033
        ;   XREF to: 004a5033 (UNCONDITIONAL_JUMP)
    MOV EAX,[0x02cf2acc]                ; 004a5187 | int g_BackgroundColor1
        ;   Label: LAB_004a5187
    MOV dword ptr [ESP + 0x13c],EAX     ; 004a518c
    JMP 0x004a50d7                      ; 004a5193 | LAB_004a50d7
    ...
    JMP 0x004a4f11                      ; 004a5211 | LAB_004a4f11
        ;   XREF to: 004a4f11 (UNCONDITIONAL_JUMP)
    PUSH EBX                            ; 004a5216
        ;   Label: LAB_004a5216
    MOV ESI,dword ptr [0x00678a60]      ; 004a5217 | CEditorTools * g_CEditorToolsPtr
    PUSH ESI                            ; 004a521d | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_setMousePointerType_FUN_004a1380 ; 004a521e | void shape_edittool.cpp_CEditorTools_setMousePointerType_FUN_004a1380(CEditorTools * this_ptr, bool use_clipping)
