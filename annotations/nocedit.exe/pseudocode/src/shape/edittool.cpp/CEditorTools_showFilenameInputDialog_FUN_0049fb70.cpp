...

{
  ...
  uint uVar5;
  char *pcVar9;
  CInputString *pCVar10;
  CInputString *pCVar6;
  CInputString *pCVar7;
  char *pcVar8;
  char *pcVar11;
  CInputString *pCVar12;
  byte bVar9;
  char local_360 [520];
  ...
  do {
    ...
    if (*directory_path != '\0') {
      ...
      do {
        ...
        if (iVar3 == 0) break;
        iVar3 = iVar3 + -1;
        pcVar11 = pcVar9 + (uint)bVar9 * -2 + 1;
        cVar2 = *pcVar9;
        pcVar9 = pcVar11;
      } while (cVar2 != '\0');
      pcVar11 = pcVar11 + -1;
      pcVar9 = directory_path;
      do {
        cVar2 = *pcVar9;
        *pcVar11 = cVar2;
        if (cVar2 == '\0') break;
...
LAB_0049fea7:
        if (pCVar7 == (CInputString *)0x0) {
          if (*file_extension != '.') {
            ...
            do {
              ...
              if (iVar4 == 0) break;
              iVar4 = iVar4 + -1;
              pCVar12 = (CInputString *)((int)pCVar10 + (uint)bVar9 * -2 + 1);
              pcVar11 = pCVar10->string_data;
              pCVar10 = pCVar12;
            } while (*pcVar11 != '\0');
            pcVar11 = (char *)((int)&pCVar12[-1].mask_mode + 3);
            do {
              cVar2 = *pcVar9;
              *pcVar11 = cVar2;
              if (cVar2 == '\0') break;
          ...
          do {
            ...
            iVar7 = iVar7 + -1;
            pCVar12 = (CInputString *)((int)pCVar10 + (uint)bVar9 * -2 + 1);
            pcVar9 = pCVar10->string_data;
            pCVar10 = pCVar12;
          } while (*pcVar9 != '\0');
          pcVar11 = (char *)((int)&pCVar12[-1].mask_mode + 3);
          pcVar9 = file_extension;
          do {
            cVar2 = *pcVar9;
            *pcVar11 = cVar2;
            if (cVar2 == '\0') break;
          ...
          do {
            ...
            uVar5 = uVar5 - 1;
            pcVar9 = pCVar10->string_data;
            pCVar10 = (CInputString *)((int)pCVar10 + (uint)bVar9 * -2 + 1);
          } while (*pcVar9 != '\0');
  ...
  pCVar10 = &local_158;
  do {
    cVar2 = pCVar10->string_data[0];
    *output_buffer = cVar2;
    if (cVar2 == '\0') break;
    cVar2 = pCVar10->string_data[1];
    pCVar10 = (CInputString *)(pCVar10->string_data + 2);
