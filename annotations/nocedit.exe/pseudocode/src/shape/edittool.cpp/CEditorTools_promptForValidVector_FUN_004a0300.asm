...
section .text
    ...
    JNZ 0x004a033c                      ; 004a0317 | LAB_004a033c
    ...
    PUSH ESI                            ; 004a0327
    PUSH EBX                            ; 004a0328
    CALL shape_edittool.cpp_CEditorTools_showTextInputDialog_FUN_004a03d0 ; 004a0329 | int shape_edittool.cpp_CEditorTools_showTextInputDialog_FUN_004a03d0(CEditorTools * this_ptr, char * prompt_text, char * input_buffer, int buffer_size, ...)
        ;   XREF to: 004a03d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 004a032e
    TEST EAX,EAX                        ; 004a0331
    JNZ 0x004a036a                      ; 004a0333 | LAB_004a036a
    ...
    PUSH 0x6232b5                       ; 004a0356 | = "%g,%g,%g" | s_g_g_g_006232b5 = %g,%g,%g
    LEA EAX,[ESP + 0x1c]                ; 004a035b
    PUSH EAX                            ; 004a035f
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 004a0360 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x20                        ; 004a0365
    JMP 0x004a031e                      ; 004a0368 | LAB_004a031e
    ...
    PUSH EAX                            ; 004a0378
    PUSH 0x6232be                       ; 004a0379 | = "%f%*[ ,]%f%*[ ,]%f" | s_f_f_f_006232be = %f%*[ ,]%f%*[ ,]%f
    LEA EAX,[ESP + 0x10]                ; 004a037e
    PUSH EAX                            ; 004a0382
    CALL crt_stdio.c_sscanf_FUN_0060013c ; 004a0383 | int crt_stdio.c_sscanf_FUN_0060013c(char * str, char * format)
        ;   XREF to: 0060013c (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 004a0388
    CMP EAX,0x3                         ; 004a038b
    JNZ 0x004a03b8                      ; 004a038e | LAB_004a03b8
        ;   XREF to: 004a03b8 (CONDITIONAL_JUMP)
    LEA EAX,[ESP + 0x28]                ; 004a0390
    CMP EDI,EAX                         ; 004a0394
    JZ 0x004a03ac                       ; 004a0396 | LAB_004a03ac
    ...
    POP EBX                             ; 004a03b6
    RET                                 ; 004a03b7
    PUSH 0x6232d1                       ; 004a03b8 | = "Please enter a valid vector." | s_Please_enter_a_valid_vec_006232d1 = Please enter a valid vector.
        ;   Label: LAB_004a03b8
    PUSH EBX                            ; 004a03bd
    CALL shape_edittool.cpp_CEditorTools_showError_FUN_0049e740 ; 004a03be | void shape_edittool.cpp_CEditorTools_showError_FUN_0049e740(CEditorTools * this_ptr, char * format)
        ;   XREF to: 0049e740 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004a03c3
    JMP 0x004a031e                      ; 004a03c6 | LAB_004a031e
        ;   XREF to: 004a031e (UNCONDITIONAL_JUMP)
