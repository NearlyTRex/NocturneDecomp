...
;                               FUNCTION
; *****************************************************************************
; __cdecl CStrList * __cdecl shape_edittool_cpp_CStrList_dtor_FUN_004a2a40(CStrList *this_ptr,uint d1,uint d2)
;
; Parameters:
...
section .text
    ...
    PUSH 0x65d4f0                       ; 004a2a67 | g_CStrListTypeInfo
        ;   Label: LAB_004a2a67
    PUSH EBX                            ; 004a2a6c
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 004a2a6d
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 004a2a72
    PUSH EAX                            ; 004a2a75
    CALL crt_memory.c_free_FUN_005fe659 ; 004a2a76
    ...
    PUSH EBX                            ; 004a2a82
        ;   Label: LAB_004a2a82
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 004a2a83
