...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_edittool.cpp_CEdButton_setBoundsAndText_FUN_004a6590(CEdButton * this_ptr, int left, int top, int right, int bottom, char * button_text)
;
; Parameters:
...
section .text
    ...
    CMP AL,0x0                          ; 004a65a2
    JZ 0x004a65b6                       ; 004a65a4 | LAB_004a65b6
    ...
    CMP AL,0x0                          ; 004a65b2
    JNZ 0x004a659e                      ; 004a65b4 | LAB_004a659e
