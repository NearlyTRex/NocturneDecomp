...
section .text
    ...
    MOV EAX,[0x02cf2aec]                ; 004a59b4 | g_InsetColor
    MOV [0x02d02570],EAX                ; 004a59b9 | g_ActiveRenderColor
    TEST EDI,EDI                        ; 004a59be
    JNZ 0x004a5a25                      ; 004a59c0
        ;   XREF to: 004a5a25 (CONDITIONAL_JUMP)  ; LAB_004a5a25
    ...
    JNZ 0x004a5a7c                      ; 004a59ee
        ;   XREF to: 004a5a7c (CONDITIONAL_JUMP)  ; LAB_004a5a7c
    MOV EDX,dword ptr [ESP + 0x18]      ; 004a59f4
    ADD EDX,EAX                         ; 004a59f8
    INC EDX                             ; 004a59fa
    ADD ESI,EDX                         ; 004a59fb
    TEST EAX,EAX                        ; 004a59fd
    JLE 0x004a5a20                      ; 004a59ff
        ;   XREF to: 004a5a20 (CONDITIONAL_JUMP)  ; LAB_004a5a20
    ...
    PUSH EDI                            ; 004a5a05
    INC EBX                             ; 004a5a06
    CALL engine_2d.c_drawHLine_FUN_00402ee0 ; 004a5a07
    ...
    JL 0x004a5a03                       ; 004a5a13
        ;   XREF to: 004a5a03 (CONDITIONAL_JUMP)  ; LAB_004a5a03
    ...
    CMP EDI,0x1                         ; 004a5a25
        ;   Label: LAB_004a5a25
    JZ 0x004a59c2                       ; 004a5a28
        ;   XREF to: 004a59c2 (CONDITIONAL_JUMP)  ; LAB_004a59c2
    ...
    JNZ 0x004a5aa3                      ; 004a5a55
        ;   XREF to: 004a5aa3 (CONDITIONAL_JUMP)  ; LAB_004a5aa3
    ADD EBP,EAX                         ; 004a5a57
    INC EBP                             ; 004a5a59
    LEA EDI,[ESI + EBP*0x1]             ; 004a5a5a
    TEST EAX,EAX                        ; 004a5a5d
    JLE 0x004a5a20                      ; 004a5a5f
        ;   XREF to: 004a5a20 (CONDITIONAL_JUMP)  ; LAB_004a5a20
    ...
    PUSH EDI                            ; 004a5a67
    INC EBX                             ; 004a5a68
    CALL engine_2d.c_drawVLine_FUN_00402ff0 ; 004a5a69
    ...
    PUSH ESI                            ; 004a5a8e
    INC EBX                             ; 004a5a8f
    CALL engine_2d.c_drawHLine_FUN_00402ee0 ; 004a5a90
        ;   XREF to: 00402ee0 (UNCONDITIONAL_CALL)  ; void engine_2d.c_drawHLine_FUN_00402ee0(int x1, int y, int x2)
    DEC EDI                             ; 004a5a95
    ADD ESP,0xc                         ; 004a5a96
    DEC ESI                             ; 004a5a99
    CMP EBX,EBP                         ; 004a5a9a
    JL 0x004a5a8c                       ; 004a5a9c
        ;   XREF to: 004a5a8c (CONDITIONAL_JUMP)  ; LAB_004a5a8c
    POP EBP                             ; 004a5a9e
    POP EDI                             ; 004a5a9f
    POP ESI                             ; 004a5aa0
    POP EBX                             ; 004a5aa1
    ...
    PUSH EDI                            ; 004a5abd
    INC EBX                             ; 004a5abe
    CALL engine_2d.c_drawVLine_FUN_00402ff0 ; 004a5abf
        ;   XREF to: 00402ff0 (UNCONDITIONAL_CALL)  ; void engine_2d.c_drawVLine_FUN_00402ff0(int x, int y1, int y2)
    DEC ESI                             ; 004a5ac4
    ADD ESP,0xc                         ; 004a5ac5
    DEC EDI                             ; 004a5ac8
    CMP EBX,EBP                         ; 004a5ac9
    JL 0x004a5abb                       ; 004a5acb
        ;   XREF to: 004a5abb (CONDITIONAL_JUMP)  ; LAB_004a5abb
    POP EBP                             ; 004a5acd
    POP EDI                             ; 004a5ace
    POP ESI                             ; 004a5acf
    POP EBX                             ; 004a5ad0
