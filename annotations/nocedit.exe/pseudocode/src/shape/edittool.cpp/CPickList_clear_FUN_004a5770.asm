...
section .text
    ...
    JNZ 0x004a57aa                      ; 004a577e | LAB_004a57aa
    ...
    JNZ 0x004a57c9                      ; 004a5792 | LAB_004a57c9
        ;   XREF to: 004a57c9 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 004a5794
        ;   Label: LAB_004a5794
    MOV dword ptr [EBX + 0x19c],0x0     ; 004a5795
    CALL shape_edittool.cpp_CStrList_clear_FUN_004a2b10 ; 004a579f | void shape_edittool.cpp_CStrList_clear_FUN_004a2b10(CStrList * this_ptr)
    ...
    PUSH 0x1080                         ; 004a57aa
        ;   Label: LAB_004a57aa
    PUSH 0x623d8c                       ; 004a57af | = "..\\shape\\edittool.cpp" | s_shape_edittool_cpp_00623d8c = ..\shape\edittool.cpp
    PUSH EDX                            ; 004a57b4
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 004a57b5 | void shape_memdbg.cpp_debugFree_FUN_0050f460(void * ptr, char * filename, int line_number)
        ;   XREF to: 0050f460 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004a57ba
    MOV dword ptr [EBX + 0x198],0x0     ; 004a57bd
    JMP 0x004a5780                      ; 004a57c7 | LAB_004a5780
        ;   XREF to: 004a5780 (UNCONDITIONAL_JUMP)
    PUSH 0x1085                         ; 004a57c9
        ;   Label: LAB_004a57c9
    PUSH 0x623da2                       ; 004a57ce | = "..\\shape\\edittool.cpp" | s_shape_edittool_cpp_00623da2 = ..\shape\edittool.cpp
    PUSH ESI                            ; 004a57d3
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 004a57d4 | void shape_memdbg.cpp_debugFree_FUN_0050f460(void * ptr, char * filename, int line_number)
        ;   XREF to: 0050f460 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004a57d9
    MOV dword ptr [EBX + 0x1a0],0x0     ; 004a57dc
    JMP 0x004a5794                      ; 004a57e6 | LAB_004a5794
