...
;                               FUNCTION
; *****************************************************************************
; __cdecl CVector3f * __cdecl shape_edittool_cpp_CVector3f_arrdtor_FUN_004a6f50(CVector3f *objs,uint flags)
;
; Parameters:
...
section .text
    ...
    PUSH 0x6598c0                       ; 004a6f50 | g_CVectorTypeInfo
        ;   Label: shape_edittool.cpp_CVector3f_arrdtor_FUN_004a6f50
    PUSH 0x8                            ; 004a6f55
