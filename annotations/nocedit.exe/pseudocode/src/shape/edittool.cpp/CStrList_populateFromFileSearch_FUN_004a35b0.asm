...
section .text
    ...
    JZ 0x004a377d                       ; 004a35d1 | LAB_004a377d
        ;   XREF to: 004a377d (CONDITIONAL_JUMP)
    CMP byte ptr [ESI],0x0              ; 004a35d7
    JZ 0x004a377d                       ; 004a35da | LAB_004a377d
        ;   XREF to: 004a377d (CONDITIONAL_JUMP)
    PUSH EDI                            ; 004a35e0
    PUSH ESI                            ; 004a35e1
    PUSH 0x6239df                       ; 004a35e2 | = "%s\\%s" | s_s_s_006239df = %s\%s
    LEA ECX,[ESP + 0x540]               ; 004a35e7
    PUSH ECX                            ; 004a35ee
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 004a35ef | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004a35f4
    MOV EDX,dword ptr [0x00680cdc]      ; 004a35f7 | CDemonPod g_CDemonPodInstance | CDemonPod * g_CDemonPodPtr
        ;   Label: LAB_004a35f7
    TEST EDX,EDX                        ; 004a35fd
    JZ 0x004a36e1                       ; 004a35ff | LAB_004a36e1
        ;   XREF to: 004a36e1 (CONDITIONAL_JUMP)
    MOV ECX,ESP                         ; 004a3605
    PUSH ECX                            ; 004a3607
    LEA ECX,[ESP + 0x538]               ; 004a3608
    PUSH ECX                            ; 004a360f
    PUSH EDX                            ; 004a3610 | CDemonPod g_CDemonPodInstance
    CALL engine_pod.cpp_CPod_initSearch_FUN_00550ea0 ; 004a3611 | void engine_pod.cpp_CPod_initSearch_FUN_00550ea0(CPod * this_ptr, char * search_pattern, CPodSearchContext * search_context)
        ;   XREF to: 00550ea0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004a3616
    CMP byte ptr [ESP],0x0              ; 004a3619
    JZ 0x004a36e1                       ; 004a361d | LAB_004a36e1
        ;   XREF to: 004a36e1 (CONDITIONAL_JUMP)
    ...
    PUSH ECX                            ; 004a363b
    CALL engine_dosio.c_splitPath_FUN_00481f20 ; 004a363c | void engine_dosio.c_splitPath_FUN_00481f20(char * full_path, char * drive, char * directory, char * filename, ...)
        ;   XREF to: 00481f20 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 004a3641
    CMP byte ptr [ESP + 0x634],0x2e     ; 004a3644
    JNZ 0x004a3678                      ; 004a364c | LAB_004a3678
    ...
    PUSH ECX                            ; 004a366f
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 004a3670 | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
    ...
    PUSH ECX                            ; 004a3693
    CALL engine_dosio.c_makePath_FUN_00481f50 ; 004a3694 | void engine_dosio.c_makePath_FUN_00481f50(char * full_path, char * drive, char * directory, char * filename, ...)
    ...
    PUSH ECX                            ; 004a36bb
    PUSH EBX                            ; 004a36bc
    CALL shape_edittool.cpp_CStrList_insertSortedFileRecord_FUN_004a3360 ; 004a36bd | void shape_edittool.cpp_CStrList_insertSortedFileRecord_FUN_004a3360(CStrList * this_ptr, char * search_key, char * file_path, int file_size)
        ;   XREF to: 004a3360 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 004a36c2
    MOV ECX,ESP                         ; 004a36c5
    PUSH ECX                            ; 004a36c7
    MOV EBP,dword ptr [0x00680cdc]      ; 004a36c8 | CDemonPod * g_CDemonPodPtr
    PUSH EBP                            ; 004a36ce | CDemonPod g_CDemonPodInstance
    CALL engine_pod.cpp_CPod_getNextSearchResult_FUN_00550ef0 ; 004a36cf | int engine_pod.cpp_CPod_getNextSearchResult_FUN_00550ef0(CPod * this_ptr, CPodSearchContext * search_context)
        ;   XREF to: 00550ef0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004a36d4
    CMP byte ptr [ESP],0x0              ; 004a36d7
    JNZ 0x004a3623                      ; 004a36db | LAB_004a3623
        ;   XREF to: 004a3623 (CONDITIONAL_JUMP)
    LEA ECX,[ESP + 0x31c]               ; 004a36e1
        ;   Label: LAB_004a36e1
    PUSH ECX                            ; 004a36e8
    CALL engine_dosio.c_CFileFinder_ctor_FUN_00481c30 ; 004a36e9 | CFileFinder * engine_dosio.c_CFileFinder_ctor_FUN_00481c30(CFileFinder * this_ptr)
    ...
    PUSH ECX                            ; 004a3700
    CALL engine_dosio.c_CFileFinder_openSearch_FUN_00481c70 ; 004a3701 | int engine_dosio.c_CFileFinder_openSearch_FUN_00481c70(CFileFinder * this_ptr, char * search_pattern)
        ;   XREF to: 00481c70 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004a3706
    CMP byte ptr [ESP + 0x31c],0x0      ; 004a3709
    JZ 0x004a3750                       ; 004a3711 | LAB_004a3750
    ...
    PUSH ECX                            ; 004a372c
    PUSH EBX                            ; 004a372d
    CALL shape_edittool.cpp_CStrList_insertSortedFileRecord_FUN_004a3360 ; 004a372e | void shape_edittool.cpp_CStrList_insertSortedFileRecord_FUN_004a3360(CStrList * this_ptr, char * search_key, char * file_path, int file_size)
        ;   XREF to: 004a3360 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 004a3733
    LEA ECX,[ESP + 0x31c]               ; 004a3736
    PUSH ECX                            ; 004a373d
    CALL engine_dosio.c_CFileFinder_findNext_FUN_00481cf0 ; 004a373e | int engine_dosio.c_CFileFinder_findNext_FUN_00481cf0(CFileFinder * this_ptr)
        ;   XREF to: 00481cf0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004a3743
    CMP byte ptr [ESP + 0x31c],0x0      ; 004a3746
    JNZ 0x004a3713                      ; 004a374e | LAB_004a3713
        ;   XREF to: 004a3713 (CONDITIONAL_JUMP)
    LEA ECX,[ESP + 0x31c]               ; 004a3750
        ;   Label: LAB_004a3750
    PUSH ECX                            ; 004a3757
    CALL engine_dosio.c_CFileFinder_closeSearch_FUN_00481d70 ; 004a3758 | void engine_dosio.c_CFileFinder_closeSearch_FUN_00481d70(CFileFinder * this_ptr)
        ;   XREF to: 00481d70 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004a375d
    PUSH 0x0                            ; 004a3760
    LEA ECX,[ESP + 0x320]               ; 004a3762
    PUSH ECX                            ; 004a3769
    CALL engine_dosio.c_CFileFinder_dtor_FUN_00481c50 ; 004a376a | CFileFinder * engine_dosio.c_CFileFinder_dtor_FUN_00481c50(CFileFinder * this_ptr, uint d1)
    ...
    CMP AL,0x0                          ; 004a378b
    JZ 0x004a379f                       ; 004a378d | LAB_004a379f
    ...
    CMP AL,0x0                          ; 004a379b
    JNZ 0x004a3787                      ; 004a379d | LAB_004a3787
        ;   XREF to: 004a3787 (CONDITIONAL_JUMP)
    POP EDI                             ; 004a379f
        ;   Label: LAB_004a379f
    JMP 0x004a35f7                      ; 004a37a0 | LAB_004a35f7
