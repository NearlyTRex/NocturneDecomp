...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl shape_edittool_cpp_CEdButton_wasClicked_FUN_004a6830(CEdButton *this_ptr)
;
; Parameters:
...
section .text
    ...
    JZ 0x004a686e                       ; 004a683e
        ;   XREF to: 004a686e (CONDITIONAL_JUMP)  ; LAB_004a686e
    XOR EDX,EDX                         ; 004a6840
        ;   Label: LAB_004a6840
    CMP ECX,EAX                         ; 004a6842
        ;   Label: LAB_004a6842
    JNZ 0x004a68a5                      ; 004a6844
        ;   XREF to: 004a68a5 (CONDITIONAL_JUMP)  ; LAB_004a68a5
    MOV BH,byte ptr [0x02cf6a94]        ; 004a6846 | g_MouseButtonFlags
    MOV dword ptr [EAX + 0x18],EDX      ; 004a684c
    TEST BH,0x1                         ; 004a684f
    JNZ 0x004a68a1                      ; 004a6852
        ;   XREF to: 004a68a1 (CONDITIONAL_JUMP)  ; LAB_004a68a1
    XOR ECX,EAX                         ; 004a6854
    TEST EDX,EDX                        ; 004a6856
    JZ 0x004a68a1                       ; 004a6858
        ;   XREF to: 004a68a1 (CONDITIONAL_JUMP)  ; LAB_004a68a1
    ...
    POP EBX                             ; 004a686c
    RET                                 ; 004a686d
    MOV EDX,dword ptr [0x02cf6a8c]      ; 004a686e | g_MouseX
        ;   Label: LAB_004a686e
    CMP EDX,dword ptr [EAX + 0x8]       ; 004a6874
    JL 0x004a6840                       ; 004a6877
        ;   XREF to: 004a6840 (CONDITIONAL_JUMP)  ; LAB_004a6840
    MOV EDX,dword ptr [0x02cf6a90]      ; 004a6879 | g_MouseY
    CMP EDX,dword ptr [EAX + 0xc]       ; 004a687f
    JL 0x004a6840                       ; 004a6882
        ;   XREF to: 004a6840 (CONDITIONAL_JUMP)  ; LAB_004a6840
    MOV EDX,dword ptr [0x02cf6a8c]      ; 004a6884 | g_MouseX
    CMP EDX,dword ptr [EAX + 0x10]      ; 004a688a
    JGE 0x004a6840                      ; 004a688d
        ;   XREF to: 004a6840 (CONDITIONAL_JUMP)  ; LAB_004a6840
    MOV EDX,dword ptr [0x02cf6a90]      ; 004a688f | g_MouseY
    CMP EDX,dword ptr [EAX + 0x14]      ; 004a6895
    JGE 0x004a6840                      ; 004a6898
        ;   XREF to: 004a6840 (CONDITIONAL_JUMP)  ; LAB_004a6840
    MOV EDX,0x1                         ; 004a689a
    JMP 0x004a6842                      ; 004a689f
        ;   XREF to: 004a6842 (UNCONDITIONAL_JUMP)  ; LAB_004a6842
    XOR EAX,EAX                         ; 004a68a1
        ;   Label: LAB_004a68a1
    JMP 0x004a6866                      ; 004a68a3
        ;   XREF to: 004a6866 (UNCONDITIONAL_JUMP)  ; LAB_004a6866
    TEST ECX,ECX                        ; 004a68a5
        ;   Label: LAB_004a68a5
    JNZ 0x004a68b6                      ; 004a68a7
        ;   XREF to: 004a68b6 (CONDITIONAL_JUMP)  ; LAB_004a68b6
    TEST byte ptr [0x02cf6a94],0x1      ; 004a68a9 | g_MouseButtonFlags
    JZ 0x004a68b6                       ; 004a68b0
        ;   XREF to: 004a68b6 (CONDITIONAL_JUMP)  ; LAB_004a68b6
    TEST EDX,EDX                        ; 004a68b2
    JNZ 0x004a68c0                      ; 004a68b4
