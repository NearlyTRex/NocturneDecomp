...
;                               FUNCTION
; *****************************************************************************
; __cdecl int shape_edittool.cpp_CEditorTools_showTextInputDialog_FUN_004a03d0(CEditorTools * this_ptr, char * prompt_text, char * input_buffer, int buffer_size, int dialog_flags)
;
; Parameters:
...
;   core_game.cpp_FUN_004e2fc0 at 004e2feb
;   core_msnedit.cpp_CDemonMission_showEditorMenu_FUN_005381e0 at 00538b3e
;   core_msnedit.cpp_DeleteActors_FUN_0053df90 at 0053e1a3
;   core_msnedit.cpp_DuplicateActorCheckMaybe_FUN_0053bd80 at 0053c024
;   ... and 29 more
;
; Called Functions:
...
section .text
    ...
    PUSH ESI                            ; 004a03e7
    CALL shape_edittool.cpp_showTextInputDialog_FUN_0049db10 ; 004a03e8 | int shape_edittool.cpp_showTextInputDialog_FUN_0049db10(int dialog_mode, char * prompt_text, char * input_buffer, int buffer_size, ...)
