...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_edittool.cpp_CEditorTools_updatePercentage_FUN_004a0530(CEditorTools * this_ptr, float progress_min, float progress_max)
;
; Parameters:
...
;   core_msnedit.cpp_FUN_0053eb40 at 0053ec01
...
section .text
    ...
    CMP dword ptr [0x02cf1cdc],0x1      ; 004a053c | int g_WindowStackCount
    JL 0x004a0865                       ; 004a0543 | LAB_004a0865
    ...
    FNSTSW AX                           ; 004a0556
    SAHF                                ; 004a0558
    JNC 0x004a0585                      ; 004a0559 | LAB_004a0585
    ...
    FNSTSW AX                           ; 004a0562
    SAHF                                ; 004a0564
    JBE 0x004a056a                      ; 004a0565 | LAB_004a056a
    ...
    FNSTSW AX                           ; 004a0570
    SAHF                                ; 004a0572
    JBE 0x004a057b                      ; 004a0573 | LAB_004a057b
    ...
    FLD float ptr [ESP + 0xc]           ; 004a0585
        ;   Label: LAB_004a0585
    FMUL double ptr [0x0062337e]        ; 004a0589 | double g_PercentageMultiplier
    FADD double ptr [0x00623386]        ; 004a058f | double g_RoundingOffset
    CALL crt_math.c_round_FUN_005fe6b0  ; 004a0595 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x24]        ; 004a059a
    CALL wincore_winrun.cpp_getTime_FUN_005f2dc0 ; 004a059e | int wincore_winrun.cpp_getTime_FUN_005f2dc0()
        ;   XREF to: 005f2dc0 (UNCONDITIONAL_CALL)
    MOV ESI,dword ptr [0x02cf1cdc]      ; 004a05a3 | int g_WindowStackCount
    ...
    JNZ 0x004a05dd                      ; 004a05c9 | LAB_004a05dd
    ...
    JL 0x004a085e                       ; 004a05d7 | LAB_004a085e
        ;   XREF to: 004a085e (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [EBP + 0x14]      ; 004a05dd
        ;   Label: LAB_004a05dd
    PUSH EBX                            ; 004a05e0
    CALL shape_edittool.cpp_CEditorTools_paintCurrentWindow_FUN_004a0f80 ; 004a05e1 | void shape_edittool.cpp_CEditorTools_paintCurrentWindow_FUN_004a0f80(CEditorTools * this_ptr)
        ;   XREF to: 004a0f80 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004a05e6
    PUSH 0xffff                         ; 004a05e9
    CALL engine_3d.c_setRenderAlpha_FUN_00406d80 ; 004a05ee | void engine_3d.c_setRenderAlpha_FUN_00406d80(int alpha_color_value)
        ;   XREF to: 00406d80 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004a05f3
    MOV ESI,dword ptr [ESP + 0x24]      ; 004a05f6
    PUSH ESI                            ; 004a05fa
    PUSH 0x62333b                       ; 004a05fb | = "%d%% complete" | s_d_complete_0062333b = %d%% complete
    PUSH -0x1                           ; 004a0600
    MOV EDI,dword ptr [0x02cf2aa8]      ; 004a0602 | int g_WindowStatusTextColor
    PUSH EDI                            ; 004a0608
    MOV EAX,[0x02d0255c]                ; 004a0609 | int g_ClipTop
    PUSH EAX                            ; 004a060e
    MOV EDX,dword ptr [0x02d02560]      ; 004a060f | int g_ClipRight
    PUSH EDX                            ; 004a0615
    MOV ECX,dword ptr [0x02d02558]      ; 004a0616 | int g_ClipLeft
    PUSH ECX                            ; 004a061c
    MOV EBX,dword ptr [0x02cf1cd0]      ; 004a061d | CBitFont * g_EditorFont
    PUSH EBX                            ; 004a0623
    CALL engine_font.cpp_CBitFont_drawTextCenterInBoundsFV_FUN_004cdf30 ; 004a0624 | int engine_font.cpp_CBitFont_drawTextCenterInBoundsFV_FUN_004cdf30(CBitFont * this_ptr, int left_x, int right_x, int y_pos, ...)
        ;   XREF to: 004cdf30 (UNCONDITIONAL_CALL)
    MOV EAX,[0x02cf266c]                ; 004a0629 | int g_FontCharacterWidth
    MOV EDI,dword ptr [0x02d0255c]      ; 004a062e | int g_ClipTop
    ADD EAX,EAX                         ; 004a0634
    ADD EAX,EDI                         ; 004a0636
    LEA EDI,[EAX + 0x1]                 ; 004a0638
    MOV EAX,[0x02cf266c]                ; 004a063b | int g_FontCharacterWidth
    MOV EDX,dword ptr [0x02d0255c]      ; 004a0640 | int g_ClipTop
    SHL EAX,0x2                         ; 004a0646
    ADD ESP,0x20                        ; 004a0649
    ADD EAX,EDX                         ; 004a064c
    MOV ECX,dword ptr [0x02cf2abc]      ; 004a064e | int g_ProgressBarBorderColor
    DEC EAX                             ; 004a0654
    PUSH ECX                            ; 004a0655
    MOV dword ptr [ESP + 0x24],EAX      ; 004a0656
    MOV EAX,[0x02cf2ab4]                ; 004a065a | int g_ProgressBarBackgroundColor
    PUSH EAX                            ; 004a065f
    MOV EDX,dword ptr [ESP + 0x28]      ; 004a0660
    MOV ESI,dword ptr [0x02d02560]      ; 004a0664 | int g_ClipRight
    PUSH EDX                            ; 004a066a
    DEC ESI                             ; 004a066b
    PUSH ESI                            ; 004a066c
    MOV EBX,dword ptr [0x02d02558]      ; 004a066d | int g_ClipLeft
    PUSH EDI                            ; 004a0673
    INC EBX                             ; 004a0674
    PUSH EBX                            ; 004a0675
    CALL engine_2d.c_fillRectWithBorder_FUN_00403200 ; 004a0676 | void engine_2d.c_fillRectWithBorder_FUN_00403200(int x1, int y1, int x2, int y2, ...)
        ;   XREF to: 00403200 (UNCONDITIONAL_CALL)
    MOV EAX,[0x02d02570]                ; 004a067b | int g_ActiveRenderColor
    ADD ESP,0x18                        ; 004a0680
    MOV dword ptr [ESP + 0x14],EAX      ; 004a0683
    MOV EAX,[0x02cf2ac0]                ; 004a0687 | int g_ProgressBarTextColor
    PUSH ESI                            ; 004a068c
    MOV [0x02d02570],EAX                ; 004a068d | int g_ActiveRenderColor
    ...
    CALL engine_2d.c_drawHLine_FUN_00402ee0 ; 004a06a2 | void engine_2d.c_drawHLine_FUN_00402ee0(int x1, int y, int x2)
    ...
    PUSH EAX                            ; 004a06b8
    CALL engine_2d.c_drawVLine_FUN_00402ff0 ; 004a06b9 | void engine_2d.c_drawVLine_FUN_00402ff0(int x, int y1, int y2)
        ;   XREF to: 00402ff0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004a06be
    MOV EAX,dword ptr [ESP + 0x14]      ; 004a06c1
    MOV [0x02d02570],EAX                ; 004a06c5 | int g_ActiveRenderColor
    ...
    FADD double ptr [0x00623386]        ; 004a06db | double g_RoundingOffset
    CALL crt_math.c_round_FUN_005fe6b0  ; 004a06e1 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x2c]        ; 004a06e6
    MOV EAX,dword ptr [ESP + 0x2c]      ; 004a06ea
    ADD EAX,EBX                         ; 004a06ee
    CMP EAX,EBX                         ; 004a06f0
    JLE 0x004a0712                      ; 004a06f2 | LAB_004a0712
        ;   XREF to: 004a0712 (CONDITIONAL_JUMP)
    CMP EAX,ESI                         ; 004a06f4
    JL 0x004a06fb                       ; 004a06f6 | LAB_004a06fb
        ;   XREF to: 004a06fb (CONDITIONAL_JUMP)
    LEA EAX,[ESI + -0x1]                ; 004a06f8
    MOV EDX,dword ptr [0x02cf2ab8]      ; 004a06fb | int g_ProgressBarFillColor
        ;   Label: LAB_004a06fb
    PUSH EDX                            ; 004a0701
    ...
    PUSH EDI                            ; 004a0708
    PUSH EBX                            ; 004a0709
    CALL engine_2d.c_fillRectColor_FUN_00403170 ; 004a070a | void engine_2d.c_fillRectColor_FUN_00403170(int x1, int y1, int x2, int y2, ...)
        ;   XREF to: 00403170 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 004a070f
    CMP dword ptr [ESP + 0x24],0x0      ; 004a0712
        ;   Label: LAB_004a0712
    JLE 0x004a082e                      ; 004a0717 | LAB_004a082e
        ;   XREF to: 004a082e (CONDITIONAL_JUMP)
    MOV EAX,[0x02cf1cdc]                ; 004a071d | int g_WindowStackCount
    ...
    FMUL double ptr [0x0062338e]        ; 004a0748 | double g_TimeScalingFactor
    FST float ptr [ESP + 0x8]           ; 004a074e
    FST double ptr [ESP]                ; 004a0752
    FCOMP double ptr [0x00623396]       ; 004a0755 | double g_TimeDisplayThreshold
    FNSTSW AX                           ; 004a075b
    SAHF                                ; 004a075d
    JBE 0x004a082e                      ; 004a075e | LAB_004a082e
        ;   XREF to: 004a082e (CONDITIONAL_JUMP)
    ...
    FDIVRP                              ; 004a0770
    FADD double ptr [0x00623386]        ; 004a0772 | double g_RoundingOffset
    CALL crt_math.c_round_FUN_005fe6b0  ; 004a0778 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x28]        ; 004a077d
    MOV EDI,dword ptr [ESP + 0x28]      ; 004a0781
    TEST EDI,EDI                        ; 004a0785
    JLE 0x004a082e                      ; 004a0787 | LAB_004a082e
        ;   XREF to: 004a082e (CONDITIONAL_JUMP)
    ...
    FADD double ptr [0x00623386]        ; 004a07a9 | double g_RoundingOffset
    CALL crt_math.c_round_FUN_005fe6b0  ; 004a07af | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    CALL engine_3d.c_setRenderAlpha_FUN_00406d80 ; 004a07e2 | void engine_3d.c_setRenderAlpha_FUN_00406d80(int alpha_color_value)
        ;   XREF to: 00406d80 (UNCONDITIONAL_CALL)
    ...
    PUSH EDX                            ; 004a07f4
    PUSH EBX                            ; 004a07f5
    PUSH 0x623349                       ; 004a07f6 | = "%d:%02d elapsed, approximately %d:%02..." | s_d_02d_elapsed_approximat_00623349 = %d:%02d elapsed, approximately %d:%02d remaining
    MOV ECX,dword ptr [0x02cf2aa8]      ; 004a07fb | int g_WindowStatusTextColor
    PUSH -0x1                           ; 004a0801
    MOV EAX,[0x02d02564]                ; 004a0803 | int g_ClipBottom
    MOV EBX,dword ptr [0x02cf266c]      ; 004a0808 | int g_FontCharacterWidth
    PUSH ECX                            ; 004a080e
    SUB EAX,EBX                         ; 004a080f
    PUSH EAX                            ; 004a0811
    MOV ESI,dword ptr [0x02d02560]      ; 004a0812 | int g_ClipRight
    PUSH ESI                            ; 004a0818
    MOV EDI,dword ptr [0x02d02558]      ; 004a0819 | int g_ClipLeft
    PUSH EDI                            ; 004a081f
    MOV EAX,[0x02cf1cd0]                ; 004a0820 | CBitFont * g_EditorFont
    PUSH EAX                            ; 004a0825
    CALL engine_font.cpp_CBitFont_drawTextCenterInBoundsFV_FUN_004cdf30 ; 004a0826 | int engine_font.cpp_CBitFont_drawTextCenterInBoundsFV_FUN_004cdf30(CBitFont * this_ptr, int left_x, int right_x, int y_pos, ...)
        ;   XREF to: 004cdf30 (UNCONDITIONAL_CALL)
    ADD ESP,0x2c                        ; 004a082b
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 004a082e | void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20()
        ;   Label: LAB_004a082e
        ;   XREF to: 005eda20 (UNCONDITIONAL_CALL)
    MOV EAX,[0x02cf1cdc]                ; 004a0833 | int g_WindowStackCount
    ...
    POP EBX                             ; 004a0863
    RET                                 ; 004a0864
    MOV ECX,0x6232ee                    ; 004a0865 | = "..\\shape\\edittool.cpp" | s_shape_edittool_cpp_006232ee = ..\shape\edittool.cpp
        ;   Label: LAB_004a0865
    MOV EBX,0x742                       ; 004a086a
    PUSH 0x623304                       ; 004a086f | = "CEditorTools::updatePercentageWindow ..." | s_CEditorTools_updatePerce_00623304 = CEditorTools::updatePercentageWindow - no window open!
    MOV dword ptr [0x02f0ca48],ECX      ; 004a0874 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 004a087a | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004a0880 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004a0885
    JMP 0x004a0549                      ; 004a0888 | LAB_004a0549
