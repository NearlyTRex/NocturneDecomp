...
section .text
    ...
    FMUL float ptr [0x0065d44c]         ; 004a28ae | float g_WorldToScreenScale2
    FISTP dword ptr [EBX]               ; 004a28b4
    FLD float ptr [EAX + 0x4]           ; 004a28b6
    FMUL float ptr [0x0065d44c]         ; 004a28b9 | float g_WorldToScreenScale2
    FISTP dword ptr [EBX + 0x4]         ; 004a28bf
    FLD float ptr [EAX + 0x8]           ; 004a28c2
    FMUL float ptr [0x0065d44c]         ; 004a28c5 | float g_WorldToScreenScale2
    FISTP dword ptr [EBX + 0x8]         ; 004a28cb
    LEA EBX,[ESP + 0x30]                ; 004a28ce
    PUSH EBX                            ; 004a28d2
    LEA EBX,[ESP + 0x4]                 ; 004a28d3
    PUSH EBX                            ; 004a28d7
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 004a28d8 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004a28dd
    TEST byte ptr [ESP + 0x13],0x80     ; 004a28e0
    JZ 0x004a28ec                       ; 004a28e5 | LAB_004a28ec
    ...
    PUSH ECX                            ; 004a2905
    CALL shape_edittool.cpp_CEditorTools_drawPixelLine_FUN_004a2660 ; 004a2906 | void shape_edittool.cpp_CEditorTools_drawPixelLine_FUN_004a2660(CEditorTools * this_ptr, int start_x, int start_y, int length)
