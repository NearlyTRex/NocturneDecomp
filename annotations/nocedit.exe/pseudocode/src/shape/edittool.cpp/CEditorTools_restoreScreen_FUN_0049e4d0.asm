...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_edittool.cpp_CEditorTools_restoreScreen_FUN_0049e4d0(CEditorTools * this_ptr)
;
; Parameters:
...
section .text
    ...
    CMP dword ptr [0x02d03e94],0x0      ; 0049e4d7 | int g_UseExternalRenderer
    JZ 0x0049e579                       ; 0049e4de | LAB_0049e579
        ;   XREF to: 0049e579 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 0049e4e4
    PUSH EBX                            ; 0049e4e5
    MOV ECX,dword ptr [0x00679398]      ; 0049e4e6 | int g_WindowHeight
    TEST ECX,ECX                        ; 0049e4ec
    JLE 0x0049e510                      ; 0049e4ee | LAB_0049e510
        ;   XREF to: 0049e510 (CONDITIONAL_JUMP)
    LEA EBX,[ECX*0x4 + 0x0]             ; 0049e4f0
    XOR EAX,EAX                         ; 0049e4f7
    ADD EAX,0x4                         ; 0049e4f9
        ;   Label: LAB_0049e4f9
    MOV EDX,dword ptr [EAX + 0x2cf6a98] ; 0049e4fc | void *[1024] g_ScreenBufferArray
    MOV dword ptr [ESP + EAX*0x1 + 0x4],EDX ; 0049e502
    CMP EAX,EBX                         ; 0049e506
    JL 0x0049e4f9                       ; 0049e508 | LAB_0049e4f9
        ;   XREF to: 0049e4f9 (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 0049e50a
    CALL wincore_windll.cpp_lockFrame_FUN_005b7210 ; 0049e510 | int wincore_windll.cpp_lockFrame_FUN_005b7210()
        ;   Label: LAB_0049e510
        ;   XREF to: 005b7210 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [0x00679394]      ; 0049e515 | int g_WindowWidth
    MOV EBX,dword ptr [0x0067939c]      ; 0049e51b | int g_BitsPerPixel
    ...
    MOV ESI,dword ptr [0x00679398]      ; 0049e531 | int g_WindowHeight
    XOR EBX,EBX                         ; 0049e537
    MOV EBP,EAX                         ; 0049e539
    TEST ESI,ESI                        ; 0049e53b
    JLE 0x0049e56d                      ; 0049e53d | LAB_0049e56d
    ...
    MOV EDI,dword ptr [EDX + 0x2cf6a9c] ; 0049e548 | void *[1024] g_ScreenBufferArray
    PUSH EDI                            ; 0049e54e
    ...
    POP EDI                             ; 0049e55d
    INC EBX                             ; 0049e55e
    MOV EDI,dword ptr [0x00679398]      ; 0049e55f | int g_WindowHeight
    ADD EDX,0x4                         ; 0049e565
    CMP EBX,EDI                         ; 0049e568
    JL 0x0049e542                       ; 0049e56a | LAB_0049e542
        ;   XREF to: 0049e542 (CONDITIONAL_JUMP)
    POP EDI                             ; 0049e56c
    PUSH 0x1                            ; 0049e56d
        ;   Label: LAB_0049e56d
    CALL wincore_windll.cpp_unlockFrame_FUN_005b7250 ; 0049e56f | void wincore_windll.cpp_unlockFrame_FUN_005b7250(int clear_lock_flag)
