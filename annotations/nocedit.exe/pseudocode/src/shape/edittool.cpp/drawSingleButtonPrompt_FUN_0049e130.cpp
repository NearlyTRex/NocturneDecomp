...

{
  ...
  iVar4 = engine_font_cpp_CBitFont_getCharWidth_FUN_004cff40(g_EditorFont,message);
  shape_edittool_cpp_CEditorTools_createCenteredModal_FUN_004a0890
            (g_CEditorToolsPtr,(int)(message + g_FontCharacterHeight * 4),
             iVar4 + g_FontCharacterWidth * 2 + iVar2,in_stack_00000020,0);
  shape_edittool_cpp_calculateButtonWidth_FUN_004a68e0("Cancel");
  iVar1 = shape_edittool_cpp_calculateButtonHeight_FUN_004a6970((char *)0x0);
  iVar1 = (g_ClipBottom - iVar1) + 1;
  ...
  shape_edittool_cpp_CEdButton_setBoundsAndText_FUN_004a6590
            ((CEdButton *)&iStack_dc,iVar1,color,iVar1 + in_stack_00000010 + -1,g_ClipBottom,
             "OK");
  iStack_dc = 0x49e2de;
  engine_2d_c_clearInputAndWait_FUN_00403260();
  while( true ) {
    iVar1 = wincore_winrun_cpp_wasKeyPressed_FUN_005f2f00();
    if ((iVar1 != 0) ||
       (iVar1 = shape_edittool_cpp_CEdButton_wasClicked_FUN_004a6830((CEdButton *)&stack0xffffff30),
       iVar1 != 0)) break;
    ...
    engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80
              (g_EditorFont,message,((g_ClipLeft + g_ClipRight) - iVar3) / 2,
               (((g_ClipTop + g_ClipBottom) - iVar4) - iVar2) / 2,in_stack_00000054,-1);
