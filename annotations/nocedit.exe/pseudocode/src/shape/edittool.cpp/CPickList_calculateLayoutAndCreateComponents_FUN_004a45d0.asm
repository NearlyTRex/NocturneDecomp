...
section .text
    ...
    PUSH 0x28                           ; 004a45da
    MOV EAX,[0x02cf266c]                ; 004a45dc | int g_FontCharacterWidth
    ...
    CALL crt_memory.c_memset_FUN_005fde40 ; 004a4606 | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
    ...
    JLE 0x004a46fb                      ; 004a4622 | LAB_004a46fb
    ...
    PUSH EBP                            ; 004a4637
    CALL shape_edittool.cpp_CStrList_getStringAt_FUN_004a2f70 ; 004a4638 | char * shape_edittool.cpp_CStrList_getStringAt_FUN_004a2f70(CStrList * this_ptr, int index)
    ...
    PUSH EAX                            ; 004a466d
    MOV EAX,[0x02cf1cd0]                ; 004a466e | CBitFont * g_EditorFont
    PUSH EAX                            ; 004a4673
    CALL engine_font.cpp_CBitFont_getTextWidth_FUN_004cfe80 ; 004a4674 | int engine_font.cpp_CBitFont_getTextWidth_FUN_004cfe80(CBitFont * this_ptr, char * text)
        ;   XREF to: 004cfe80 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [ESI + 0x10]      ; 004a4679
    ADD ESP,0x8                         ; 004a467c
    CMP EAX,EDX                         ; 004a467f
    JLE 0x004a4686                      ; 004a4681 | LAB_004a4686
    ...
    CMP BL,CL                           ; 004a468c
    JZ 0x004a46cc                       ; 004a468e | LAB_004a46cc
        ;   XREF to: 004a46cc (CONDITIONAL_JUMP)
    CMP EBP,0xa                         ; 004a4694
    JL 0x004a464d                       ; 004a4697 | LAB_004a464d
        ;   XREF to: 004a464d (CONDITIONAL_JUMP)
    MOV EAX,0x623a7e                    ; 004a4699 | = "..\\shape\\edittool.cpp" | s_shape_edittool_cpp_00623a7e = ..\shape\edittool.cpp
    MOV EDX,0xed6                       ; 004a469e
    PUSH 0x623a94                       ; 004a46a3 | = "Too many picklist columns!" | s_Too_many_picklist_column_00623a94 = Too many picklist columns!
    MOV [0x02f0ca48],EAX                ; 004a46a8 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 004a46ad | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004a46b3 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004a46b8
    JMP 0x004a464d                      ; 004a46bb | LAB_004a464d
    ...
    JL 0x004a4628                       ; 004a46f5 | LAB_004a4628
    ...
    JGE 0x004a4732                      ; 004a4716 | LAB_004a4732
        ;   XREF to: 004a4732 (CONDITIONAL_JUMP)
    MOV EAX,[0x00679394]                ; 004a4718 | int g_WindowWidth
    ...
    JMP 0x004a4709                      ; 004a4730 | LAB_004a4709
    ...
    JLE 0x004a4770                      ; 004a474a | LAB_004a4770
    ...
    JL 0x004a4753                       ; 004a476d | LAB_004a4753
    ...
    MOV EDX,dword ptr [0x02cf266c]      ; 004a4794 | int g_FontCharacterWidth
    MOV EAX,[0x00679398]                ; 004a479a | int g_WindowHeight
    ...
    JGE 0x004a47d4                      ; 004a47c8 | LAB_004a47d4
    ...
    JGE 0x004a47f2                      ; 004a47ea | LAB_004a47f2
        ;   XREF to: 004a47f2 (CONDITIONAL_JUMP)
    MOV dword ptr [EDX + 0x188],ECX     ; 004a47ec
    MOV EDX,dword ptr [0x00679394]      ; 004a47f2 | int g_WindowWidth
        ;   Label: LAB_004a47f2
    ...
    JGE 0x004a483e                      ; 004a4832 | LAB_004a483e
    ...
    JGE 0x004a487b                      ; 004a4873 | LAB_004a487b
    ...
    JLE 0x004a4898                      ; 004a4887 | LAB_004a4898
    ...
    JGE 0x004a48d6                      ; 004a48c1 | LAB_004a48d6
        ;   XREF to: 004a48d6 (CONDITIONAL_JUMP)
    CMP ECX,0x1                         ; 004a48c3
    JLE 0x004a4cd9                      ; 004a48c6 | LAB_004a4cd9
    ...
    CALL shape_edittool.cpp_calculateGridWidth_FUN_004a6490 ; 004a4906 | int shape_edittool.cpp_calculateGridWidth_FUN_004a6490()
        ;   XREF to: 004a6490 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 004a490b
    MOV dword ptr [ESP + 0x130],EAX     ; 004a490d
    CALL shape_edittool.cpp_calculateGridHeight_FUN_004a64b0 ; 004a4914 | int shape_edittool.cpp_calculateGridHeight_FUN_004a64b0()
    ...
    JNZ 0x004a4ce8                      ; 004a4930 | LAB_004a4ce8
        ;   XREF to: 004a4ce8 (CONDITIONAL_JUMP)
    ADD EBP,EBX                         ; 004a4936
    MOV EAX,[0x00679394]                ; 004a4938 | int g_WindowWidth
        ;   Label: LAB_004a4938
    ...
    MOV EAX,[0x00679398]                ; 004a4951 | int g_WindowHeight
    ...
    TEST DL,DL                          ; 004a498c
    JZ 0x004a49aa                       ; 004a498e | LAB_004a49aa
        ;   XREF to: 004a49aa (CONDITIONAL_JUMP)
    ADD EAX,0x44                        ; 004a4990
    PUSH EAX                            ; 004a4993
    CALL shape_edittool.cpp_calculateButtonWidth_FUN_004a68e0 ; 004a4994 | int shape_edittool.cpp_calculateButtonWidth_FUN_004a68e0(char * button_text)
    ...
    JZ 0x004a49d5                       ; 004a49b8 | LAB_004a49d5
        ;   XREF to: 004a49d5 (CONDITIONAL_JUMP)
    ADD EAX,0xa8                        ; 004a49ba
    PUSH EAX                            ; 004a49bf
    CALL shape_edittool.cpp_calculateButtonWidth_FUN_004a68e0 ; 004a49c0 | int shape_edittool.cpp_calculateButtonWidth_FUN_004a68e0(char * button_text)
        ;   XREF to: 004a68e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004a49c5
    CMP EAX,EDI                         ; 004a49c8
    JLE 0x004a49ce                      ; 004a49ca | LAB_004a49ce
    ...
    CMP dword ptr [ESP + 0x148],0x0     ; 004a49d5
        ;   Label: LAB_004a49d5
    JLE 0x004a4a5d                      ; 004a49dd | LAB_004a4a5d
        ;   XREF to: 004a4a5d (CONDITIONAL_JUMP)
    PUSH 0x623aaf                       ; 004a49e3 | = "Cancel" | s_Cancel_00623aaf = Cancel
    CALL shape_edittool.cpp_calculateButtonWidth_FUN_004a68e0 ; 004a49e8 | int shape_edittool.cpp_calculateButtonWidth_FUN_004a68e0(char * button_text)
        ;   XREF to: 004a68e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004a49ed
    CMP EAX,EDI                         ; 004a49f0
    JLE 0x004a49f6                      ; 004a49f2 | LAB_004a49f6
        ;   XREF to: 004a49f6 (CONDITIONAL_JUMP)
    MOV EDI,EAX                         ; 004a49f4
    PUSH 0x0                            ; 004a49f6
        ;   Label: LAB_004a49f6
    CALL shape_edittool.cpp_calculateButtonHeight_FUN_004a6970 ; 004a49f8 | int shape_edittool.cpp_calculateButtonHeight_FUN_004a6970(char * button_text)
    ...
    JNZ 0x004a4a4e                      ; 004a4a45 | LAB_004a4a4e
    ...
    JGE 0x004a4a5b                      ; 004a4a57 | LAB_004a4a5b
    ...
    PUSH ESI                            ; 004a4a6d
    PUSH EBP                            ; 004a4a6e
    MOV ESI,dword ptr [0x00678a60]      ; 004a4a6f | CEditorTools * g_CEditorToolsPtr
    PUSH ESI                            ; 004a4a75 | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_createCenteredModal_FUN_004a0890 ; 004a4a76 | void shape_edittool.cpp_CEditorTools_createCenteredModal_FUN_004a0890(CEditorTools * this_ptr, int min_width, int min_height, char * text_content, ...)
        ;   XREF to: 004a0890 (UNCONDITIONAL_CALL)
    MOV EAX,[0x02d02560]                ; 004a4a7b | int g_ClipRight
    SUB EAX,dword ptr [0x02d02558]      ; 004a4a80 | int g_ClipLeft
    LEA EBP,[EAX + 0x1]                 ; 004a4a86
    MOV EDX,dword ptr [0x02d0255c]      ; 004a4a89 | int g_ClipTop
    MOV EAX,[0x02d02564]                ; 004a4a8f | int g_ClipBottom
    ...
    JNZ 0x004a4cf8                      ; 004a4ab8 | LAB_004a4cf8
        ;   XREF to: 004a4cf8 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [ESP + 0x130]     ; 004a4abe
    MOV EDX,dword ptr [0x02d02564]      ; 004a4ac5 | int g_ClipBottom
    SUB EBP,ECX                         ; 004a4acb
    SUB EDX,dword ptr [ESP + 0x144]     ; 004a4acd
    SUB EDX,dword ptr [ESP + 0x138]     ; 004a4ad4
    PUSH EDX                            ; 004a4adb
    MOV EDX,dword ptr [0x02d02560]      ; 004a4adc | int g_ClipRight
    PUSH EDX                            ; 004a4ae2
    MOV ECX,dword ptr [0x02d0255c]      ; 004a4ae3 | int g_ClipTop
    PUSH ECX                            ; 004a4ae9
    ...
    PUSH EDX                            ; 004a4af2
        ;   Label: LAB_004a4af2
    PUSH EAX                            ; 004a4af3
    CALL shape_edittool.cpp_CEdScrollBar_setPosition_FUN_004a5b60 ; 004a4af4 | void shape_edittool.cpp_CEdScrollBar_setPosition_FUN_004a5b60(CEdScrollBar * this_ptr, int left_pos, int top_pos, int right_pos, ...)
        ;   XREF to: 004a5b60 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 004a4af9
    CMP dword ptr [ESP + 0x148],0x0     ; 004a4afc
        ;   Label: LAB_004a4afc
    JLE 0x004a4bd7                      ; 004a4b04 | LAB_004a4bd7
        ;   XREF to: 004a4bd7 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [ESP + 0x144]     ; 004a4b0a
    MOV EAX,[0x02d02564]                ; 004a4b11 | int g_ClipBottom
    ...
    PUSH EAX                            ; 004a4b71
    CALL shape_edittool.cpp_CEdButton_setBoundsAndText_FUN_004a6590 ; 004a4b72 | void shape_edittool.cpp_CEdButton_setBoundsAndText_FUN_004a6590(CEdButton * this_ptr, int left, int top, int right, ...)
    ...
    JZ 0x004a4bd5                       ; 004a4b88 | LAB_004a4bd5
    ...
    MOV EAX,[0x02d02560]                ; 004a4ba6 | int g_ClipRight
    ...
    PUSH EAX                            ; 004a4bcc
    CALL shape_edittool.cpp_CEdButton_setBoundsAndText_FUN_004a6590 ; 004a4bcd | void shape_edittool.cpp_CEdButton_setBoundsAndText_FUN_004a6590(CEdButton * this_ptr, int left, int top, int right, ...)
        ;   XREF to: 004a6590 (UNCONDITIONAL_CALL)
    ...
    JGE 0x004a4c45                      ; 004a4c3d | LAB_004a4c45
    ...
    JGE 0x004a4c5f                      ; 004a4c53 | LAB_004a4c5f
    ...
    CALL engine_2d.c_clearInputAndWait_FUN_00403260 ; 004a4ca6 | void engine_2d.c_clearInputAndWait_FUN_00403260()
        ;   XREF to: 00403260 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [ESP + 0x164]     ; 004a4cab
    MOV EBX,0xffffffff                  ; 004a4cb2
    MOV byte ptr [EAX + 0x10c],0x0      ; 004a4cb7
    MOV dword ptr [0x02cf2afc],EBX      ; 004a4cbe | int g_LastClickItemIndex
    ...
    MOV dword ptr [EDX + 0x1d8],0x1     ; 004a4cd9
        ;   Label: LAB_004a4cd9
    JMP 0x004a48d6                      ; 004a4ce3 | LAB_004a48d6
        ;   XREF to: 004a48d6 (UNCONDITIONAL_JUMP)
    CMP EDI,0x2                         ; 004a4ce8
        ;   Label: LAB_004a4ce8
    JNZ 0x004a4938                      ; 004a4ceb | LAB_004a4938
        ;   XREF to: 004a4938 (CONDITIONAL_JUMP)
    ADD ESI,EAX                         ; 004a4cf1
    JMP 0x004a4938                      ; 004a4cf3 | LAB_004a4938
        ;   XREF to: 004a4938 (UNCONDITIONAL_JUMP)
    CMP ECX,0x2                         ; 004a4cf8
        ;   Label: LAB_004a4cf8
    JNZ 0x004a4afc                      ; 004a4cfb | LAB_004a4afc
        ;   XREF to: 004a4afc (CONDITIONAL_JUMP)
    SUB ESI,dword ptr [ESP + 0x134]     ; 004a4d01
    MOV EDX,dword ptr [0x02d02564]      ; 004a4d08 | int g_ClipBottom
    SUB EDX,EBX                         ; 004a4d0e
    PUSH EDX                            ; 004a4d10
    MOV ECX,dword ptr [0x02d02560]      ; 004a4d11 | int g_ClipRight
    MOV EDX,dword ptr [0x02d02564]      ; 004a4d17 | int g_ClipBottom
    PUSH ECX                            ; 004a4d1d
    SUB EDX,dword ptr [ESP + 0x13c]     ; 004a4d1e
    SUB EDX,EBX                         ; 004a4d25
    INC EDX                             ; 004a4d27
    PUSH EDX                            ; 004a4d28
    MOV EDX,dword ptr [0x02d02558]      ; 004a4d29 | int g_ClipLeft
    JMP 0x004a4af2                      ; 004a4d2f | LAB_004a4af2
