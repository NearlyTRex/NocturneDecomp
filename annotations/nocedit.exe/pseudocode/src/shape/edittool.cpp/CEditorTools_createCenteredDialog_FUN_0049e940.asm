...
;
; XREF[4]:
;   core_skeledit.cpp_CDeformableModel_buildFromPosFile_FUN_0058c190 at 0058d20f
;   core_skeledit.cpp_onLodGenerationComplete_FUN_00589b10 at 00589b3f
...
section .text
    ...
    CALL engine_font.cpp_CBitFont_getCharHeight_FUN_004d01d0 ; 0049e95f
