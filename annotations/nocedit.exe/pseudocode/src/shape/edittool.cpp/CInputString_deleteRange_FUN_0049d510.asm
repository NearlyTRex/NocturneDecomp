...
section .text
    ...
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 0049d546 | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
    ...
    JLE 0x0049d56c                      ; 0049d564 | LAB_0049d56c
    ...
    XOR EDI,EDI                         ; 0049d579
        ;   Label: LAB_0049d579
    JMP 0x0049d523                      ; 0049d57b | LAB_0049d523
