...
section .text
    ...
    MOV dword ptr [0x02cf2a7c],ECX      ; 0049e03a | g_WindowBorderHighlightColor
    MOV dword ptr [0x02cf2a80],ECX      ; 0049e040 | g_WindowBorderShadowColor
    MOV dword ptr [0x02cf2a88],EDX      ; 0049e046 | g_TitleBarFillColor
    MOV dword ptr [0x02cf2a78],EDX      ; 0049e04c | g_WindowContentColor
    MOV dword ptr [0x02cf2a84],ESI      ; 0049e052 | g_TitleBarColor
    MOV dword ptr [0x02cf2a8c],EBP      ; 0049e058 | g_WindowFontColor
    MOV dword ptr [0x02cf2a90],EBP      ; 0049e05e | g_WarningTextColor
    MOV dword ptr [0x02cf2a94],EBP      ; 0049e064 | g_ErrorTextColor
    ...
    MOV dword ptr [0x02cf2aac],EBP      ; 0049e084 | g_DialogTextColor
    ...
    MOV dword ptr [0x02cf2ab0],EDX      ; 0049e0ca | g_ActiveItemTextColor
    MOV dword ptr [0x02cf2ad4],EBX      ; 0049e0d0 | g_ConfirmedSelectionColor
    MOV dword ptr [0x02cf2ad8],ESI      ; 0049e0d6 | g_PickListSeparatorColor
    MOV dword ptr [0x02cf2adc],EDI      ; 0049e0dc | g_ShadowColor
    MOV dword ptr [0x02cf2ae0],ESI      ; 0049e0e2 | g_ScrollBarHighlightColor
    ...
    MOV dword ptr [0x02cf2acc],EDX      ; 0049e100 | g_DisabledTextColor
    MOV dword ptr [0x02cf2af4],ESI      ; 0049e106 | g_BorderBackgroundColor
