...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl shape_edittool_cpp_calculateButtonHeight_FUN_004a6970(char *button_text)
;
; Parameters:
...
section .text
    ...
    CALL engine_font.cpp_CBitFont_getCharWidth_FUN_004d01d0 ; 004a69b8
    ...
    PUSH EDI                            ; 004a69f2
    CALL engine_font.cpp_CBitFont_getCharWidth_FUN_004cff40 ; 004a69f3
