...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_edittool.cpp_CEdButton_paint_FUN_004a65e0(CEdButton * this_ptr, int draw_border_flag)
;
; Parameters:
...
section .text
    ...
    MOV ESI,dword ptr [0x02d0255c]      ; 004a6600 | int g_ClipTop
    PUSH EAX                            ; 004a6606
    MOV [0x02d0255c],EAX                ; 004a6607 | int g_ClipTop
    MOV EAX,dword ptr [EBX + 0x8]       ; 004a660c
    PUSH EAX                            ; 004a660f
    CALL shape_edittool.cpp_draw3DBorder_FUN_004a58f0 ; 004a6610 | void shape_edittool.cpp_draw3DBorder_FUN_004a58f0(int left, int top, int width, int height, ...)
        ;   XREF to: 004a58f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 004a6615
    MOV dword ptr [0x02d0255c],ESI      ; 004a6618 | int g_ClipTop
    LEA ESI,[EBX + 0x1c]                ; 004a661e
    PUSH ESI                            ; 004a6621
    MOV EDX,dword ptr [0x02cf1cd0]      ; 004a6622 | CBitFont * g_EditorFont
    PUSH EDX                            ; 004a6628
    CALL engine_font.cpp_CBitFont_getTextWidth_FUN_004cfe80 ; 004a6629 | int engine_font.cpp_CBitFont_getTextWidth_FUN_004cfe80(CBitFont * this_ptr, char * text)
        ;   XREF to: 004cfe80 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004a662e
    PUSH ESI                            ; 004a6631
    MOV ECX,dword ptr [0x02cf1cd0]      ; 004a6632 | CBitFont * g_EditorFont
    PUSH ECX                            ; 004a6638
    MOV EBP,EAX                         ; 004a6639
    CALL engine_font.cpp_CBitFont_getCharWidth_FUN_004cff40 ; 004a663b | int engine_font.cpp_CBitFont_getCharWidth_FUN_004cff40(CBitFont * this_ptr, char * text_string)
        ;   XREF to: 004cff40 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004a6640
    PUSH 0x41                           ; 004a6643
    MOV EDI,EAX                         ; 004a6645
    MOV EAX,[0x02cf1cd0]                ; 004a6647 | CBitFont * g_EditorFont
    PUSH EAX                            ; 004a664c
    CALL engine_font.cpp_CBitFont_getCharXAdvance_FUN_004d0200 ; 004a664d | int engine_font.cpp_CBitFont_getCharXAdvance_FUN_004d0200(CBitFont * this_ptr, int char_code)
    ...
    PUSH -0x1                           ; 004a6680
    MOV EDI,dword ptr [0x02cf2ae8]      ; 004a6682 | int g_UITextColor
    ...
    MOV EDX,dword ptr [0x02cf1cd0]      ; 004a6698 | CBitFont * g_EditorFont
    PUSH EDX                            ; 004a669e
    CALL engine_font.cpp_CBitFont_drawTextLeft_FUN_004cda80 ; 004a669f | int engine_font.cpp_CBitFont_drawTextLeft_FUN_004cda80(CBitFont * this_ptr, char * text_string, int x_pos, int y_pos, ...)
        ;   XREF to: 004cda80 (UNCONDITIONAL_CALL)
    ADD ESP,0x18                        ; 004a66a4
    MOV EAX,[0x02cf2ae8]                ; 004a66a7 | int g_UITextColor
    MOV ECX,dword ptr [ESP + 0xe4]      ; 004a66ac
    MOV [0x02d02570],EAX                ; 004a66b3 | int g_ActiveRenderColor
    TEST ECX,ECX                        ; 004a66b8
    JNZ 0x004a6702                      ; 004a66ba | LAB_004a6702
    ...
    CMP AL,0x0                          ; 004a66c6
    JZ 0x004a66da                       ; 004a66c8 | LAB_004a66da
    ...
    CMP AL,0x0                          ; 004a66d6
    JNZ 0x004a66c2                      ; 004a66d8 | LAB_004a66c2
    ...
    PUSH EAX                            ; 004a671f
    CALL shape_edittool.cpp_drawDashedLine_FUN_0049d290 ; 004a6720 | void shape_edittool.cpp_drawDashedLine_FUN_0049d290(int x1, int y1, int x2, int y2, ...)
        ;   XREF to: 0049d290 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 004a6725
    JMP 0x004a66bc                      ; 004a6728 | LAB_004a66bc
        ;   XREF to: 004a66bc (UNCONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 004a672a
        ;   Label: LAB_004a672a
    MOV AL,byte ptr [EBX + 0x4]         ; 004a672c
    PUSH EAX                            ; 004a672f
    CALL crt_ctype.c_toupper_FUN_005ff9e0 ; 004a6730 | int crt_ctype.c_toupper_FUN_005ff9e0(int c)
        ;   XREF to: 005ff9e0 (UNCONDITIONAL_CALL)
    ...
    MOV AL,byte ptr [ESI]               ; 004a673c
        ;   Label: LAB_004a673c
    CMP AL,DL                           ; 004a673e
    JZ 0x004a6754                       ; 004a6740 | LAB_004a6754
        ;   XREF to: 004a6754 (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 004a6742
    JZ 0x004a6752                       ; 004a6744 | LAB_004a6752
        ;   XREF to: 004a6752 (CONDITIONAL_JUMP)
    INC ESI                             ; 004a6746
    MOV AL,byte ptr [ESI]               ; 004a6747
    CMP AL,DL                           ; 004a6749
    JZ 0x004a6754                       ; 004a674b | LAB_004a6754
        ;   XREF to: 004a6754 (CONDITIONAL_JUMP)
    INC ESI                             ; 004a674d
    CMP AL,0x0                          ; 004a674e
    JNZ 0x004a673c                      ; 004a6750 | LAB_004a673c
    ...
    JNZ 0x004a6765                      ; 004a6758 | LAB_004a6765
    ...
    CMP AL,0x0                          ; 004a676f
    JZ 0x004a6783                       ; 004a6771 | LAB_004a6783
    ...
    CMP AL,0x0                          ; 004a677f
    JNZ 0x004a676b                      ; 004a6781 | LAB_004a676b
        ;   XREF to: 004a676b (CONDITIONAL_JUMP)
    POP EDI                             ; 004a6783
        ;   Label: LAB_004a6783
    MOV EAX,ESP                         ; 004a6784
    PUSH EAX                            ; 004a6786
    MOV ESI,dword ptr [0x02cf1cd0]      ; 004a6787 | CBitFont * g_EditorFont
    PUSH ESI                            ; 004a678d
    MOV byte ptr [EDX],0x0              ; 004a678e
    CALL engine_font.cpp_CBitFont_getTextWidth_FUN_004cfe80 ; 004a6791 | int engine_font.cpp_CBitFont_getTextWidth_FUN_004cfe80(CBitFont * this_ptr, char * text)
        ;   XREF to: 004cfe80 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [0x02cf1cd0]      ; 004a6796 | CBitFont * g_EditorFont
    ...
    CALL crt_ctype.c_toupper_FUN_005ff9e0 ; 004a67b2 | int crt_ctype.c_toupper_FUN_005ff9e0(int c)
        ;   XREF to: 005ff9e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004a67b7
    CMP EAX,ESI                         ; 004a67ba
    JNZ 0x004a6823                      ; 004a67bc | LAB_004a6823
        ;   XREF to: 004a6823 (CONDITIONAL_JUMP)
    XOR EAX,ESI                         ; 004a67be
    PUSH 0x41                           ; 004a67c0
        ;   Label: LAB_004a67c0
    MOV EDI,dword ptr [0x02cf1cd0]      ; 004a67c2 | CBitFont * g_EditorFont
    PUSH EDI                            ; 004a67c8
    ADD EBP,EAX                         ; 004a67c9
    CALL engine_font.cpp_CBitFont_getCharWidth_FUN_004d01d0 ; 004a67cb | int engine_font.cpp_CBitFont_getCharWidth_FUN_004d01d0(CBitFont * this_ptr, int char_code)
        ;   XREF to: 004d01d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004a67d0
    INC EAX                             ; 004a67d3
    MOV EDX,dword ptr [ESP + 0xc8]      ; 004a67d4
    ADD EDX,EAX                         ; 004a67db
    MOV EAX,[0x02cf2ae8]                ; 004a67dd | int g_UITextColor
    MOV [0x02d02570],EAX                ; 004a67e2 | int g_ActiveRenderColor
    XOR EAX,EAX                         ; 004a67e7
    MOV AL,byte ptr [EBX + 0x4]         ; 004a67e9
    PUSH EAX                            ; 004a67ec
    MOV ECX,dword ptr [0x02cf1cd0]      ; 004a67ed | CBitFont * g_EditorFont
    PUSH ECX                            ; 004a67f3
    MOV dword ptr [ESP + 0xd0],EDX      ; 004a67f4
    CALL engine_font.cpp_CBitFont_getCharWidth_FUN_004d01a0 ; 004a67fb | int engine_font.cpp_CBitFont_getCharWidth_FUN_004d01a0(CBitFont * font, int char_code)
    ...
    PUSH EBX                            ; 004a680e
    PUSH EBP                            ; 004a680f
    CALL engine_2d.c_drawHLine_FUN_00402ee0 ; 004a6810 | void engine_2d.c_drawHLine_FUN_00402ee0(int x1, int y, int x2)
    ...
    MOV EAX,EDI                         ; 004a6823
        ;   Label: LAB_004a6823
    JMP 0x004a67c0                      ; 004a6825 | LAB_004a67c0
