...
section .text
    ...
    FMUL float ptr [0x0065d44c]         ; 004a1ea0 | float g_WorldToScreenScale2
    FISTP dword ptr [EBX]               ; 004a1ea6
    FLD float ptr [EAX + 0x4]           ; 004a1ea8
    FMUL float ptr [0x0065d44c]         ; 004a1eab | float g_WorldToScreenScale2
    FISTP dword ptr [EBX + 0x4]         ; 004a1eb1
    FLD float ptr [EAX + 0x8]           ; 004a1eb4
    FMUL float ptr [0x0065d44c]         ; 004a1eb7 | float g_WorldToScreenScale2
    FISTP dword ptr [EBX + 0x8]         ; 004a1ebd
    MOV EBX,ESP                         ; 004a1ec0
    PUSH EBX                            ; 004a1ec2
    CALL engine_3d.c_processCameraRelativePoint_FUN_004037e0 ; 004a1ec3 | SMRGLHeaderExtended * engine_3d.c_processCameraRelativePoint_FUN_004037e0(CQuaternion4f * input_point)
    ...
    FMUL float ptr [0x0065d45c]         ; 004a1ed5 | float g_LabelOffsetScale
    FISTP dword ptr [EBX]               ; 004a1edb
    FLD float ptr [EAX + 0x8]           ; 004a1edd
    FMUL float ptr [0x0065d45c]         ; 004a1ee0 | float g_LabelOffsetScale
    FISTP dword ptr [EBX + 0x4]         ; 004a1ee6
    FLD float ptr [EAX + 0x4]           ; 004a1ee9
    FMUL float ptr [0x0065d45c]         ; 004a1eec | float g_LabelOffsetScale
    ...
    PUSH EBX                            ; 004a1f09
    CALL engine_matrix.c_matrixPushAndTransform_FUN_0050cee0 ; 004a1f0a | void engine_matrix.c_matrixPushAndTransform_FUN_0050cee0(ushort rotX, ushort rotY, ushort rotZ, int translateX, ...)
    ...
    PUSH EDI                            ; 004a1f1f
    CALL shape_edittool.cpp_CEditorTools_draw3DAxisLabels_FUN_004a1ca0 ; 004a1f20 | void shape_edittool.cpp_CEditorTools_draw3DAxisLabels_FUN_004a1ca0(CEditorTools * this_ptr, float scale_factor, int text_color)
        ;   XREF to: 004a1ca0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004a1f25
    CALL engine_matrix.c_pop_FUN_0050d720 ; 004a1f28 | void engine_matrix.c_pop_FUN_0050d720()
