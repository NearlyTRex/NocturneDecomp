...
;                               FUNCTION
; *****************************************************************************
; __cdecl int shape_edittool.cpp_CStrList_findByFirstField_FUN_004a3070(CStrList * this_ptr, char * search_field)
;
; Parameters:
...
;
; XREF[2]:
;   core_msnedit.cpp_FUN_0053c730 at 0053c82f
...
section .text
    ...
    TEST BL,BL                          ; 004a3092
    JZ 0x004a309b                       ; 004a3094 | LAB_004a309b
        ;   XREF to: 004a309b (CONDITIONAL_JUMP)
    CMP byte ptr [EAX],0x9              ; 004a3096
        ;   Label: LAB_004a3096
    JNZ 0x004a30ef                      ; 004a3099 | LAB_004a30ef
    ...
    JLE 0x004a30e0                      ; 004a30a4 | LAB_004a30e0
        ;   XREF to: 004a30e0 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 004a30a6
        ;   Label: LAB_004a30a6
    PUSH EDI                            ; 004a30a7
    CALL shape_edittool.cpp_CStrList_getStringAt_FUN_004a2f70 ; 004a30a8 | char * shape_edittool.cpp_CStrList_getStringAt_FUN_004a2f70(CStrList * this_ptr, int index)
        ;   XREF to: 004a2f70 (UNCONDITIONAL_CALL)
    LEA EDX,[ESP + 0x8]                 ; 004a30ad
    MOV BL,byte ptr [EAX]               ; 004a30b1
    ADD ESP,0x8                         ; 004a30b3
    TEST BL,BL                          ; 004a30b6
    JZ 0x004a30bf                       ; 004a30b8 | LAB_004a30bf
        ;   XREF to: 004a30bf (CONDITIONAL_JUMP)
    CMP byte ptr [EAX],0x9              ; 004a30ba
        ;   Label: LAB_004a30ba
    JNZ 0x004a30fd                      ; 004a30bd | LAB_004a30fd
    ...
    PUSH EAX                            ; 004a30ce
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 004a30cf | int crt_string.c_stricmp_FUN_005fe7f0(char * str1, char * str2)
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004a30d4
    TEST EAX,EAX                        ; 004a30d7
    JZ 0x004a310b                       ; 004a30d9 | LAB_004a310b
        ;   XREF to: 004a310b (CONDITIONAL_JUMP)
    INC ESI                             ; 004a30db
    CMP ESI,dword ptr [EDI]             ; 004a30dc
    JL 0x004a30a6                       ; 004a30de | LAB_004a30a6
    ...
    INC EDX                             ; 004a30f6
    TEST BH,BH                          ; 004a30f7
    JNZ 0x004a3096                      ; 004a30f9 | LAB_004a3096
        ;   XREF to: 004a3096 (CONDITIONAL_JUMP)
    JMP 0x004a309b                      ; 004a30fb | LAB_004a309b
    ...
    INC EDX                             ; 004a3104
    TEST BH,BH                          ; 004a3105
    JNZ 0x004a30ba                      ; 004a3107 | LAB_004a30ba
        ;   XREF to: 004a30ba (CONDITIONAL_JUMP)
    JMP 0x004a30bf                      ; 004a3109 | LAB_004a30bf
