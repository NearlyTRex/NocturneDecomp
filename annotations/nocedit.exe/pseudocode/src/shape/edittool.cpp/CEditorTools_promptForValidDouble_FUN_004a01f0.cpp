...

{
  ...
  while( true ) {
    while( true ) {
      ...
      iVar1 = crt_stdio_c_sscanf_FUN_0060013c(acStack_2c,"%lf");
      if (iVar1 == 1) break;
    ...
    if ((_enable_range_check == 0) ||
       ((local_40 <= (double)CONCAT44 /* combine 2-byte values */(uStack_44,&uStack_44) &&
        ((double)CONCAT44 /* combine 2-byte values */(uStack_44,&uStack_44) <= local_38)))) break;
    shape_edittool_cpp_CEditorTools_showError_FUN_0049e740
