...

{
  ...
  g_WindowStack[iVar2].saved_projection.half_width_fixed = g_Projection.half_width_fixed;
  g_WindowStack[iVar2].saved_projection.neg_half_height_fixed = g_Projection.neg_half_height_fixed;
  g_WindowStack[iVar2].saved_projection.center_x_fixed = g_Projection.center_x_fixed;
  g_WindowStack[iVar2].saved_projection.center_y_fixed = g_Projection.center_y_fixed;
