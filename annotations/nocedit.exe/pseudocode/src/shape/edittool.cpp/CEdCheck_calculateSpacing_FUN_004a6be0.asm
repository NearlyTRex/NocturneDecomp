...
;                               FUNCTION
; *****************************************************************************
; __cdecl int shape_edittool.cpp_CEdCheck_calculateSpacing_FUN_004a6be0(CEdCheck * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 004a6be4
    CALL shape_edittool.cpp_CEdCheck_calculateScaledWidth_FUN_004a6b70 ; 004a6be5 | int shape_edittool.cpp_CEdCheck_calculateScaledWidth_FUN_004a6b70(CEdCheck * this_ptr)
