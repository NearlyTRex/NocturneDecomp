...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl shape_edittool_cpp_CStrList_removeAt_FUN_004a2de0(CStrList *this_ptr,int index)
;
; Parameters:
...
;
; XREF[8]:
;   core_msnedit.cpp_DeleteActors_FUN_0053df90 at 0053e0b3
;   core_msnedit.cpp_HideActors_FUN_0053dcf0 at 0053de02
