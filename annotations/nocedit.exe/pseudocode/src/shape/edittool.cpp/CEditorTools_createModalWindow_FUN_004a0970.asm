...
section .text
    ...
    CMP dword ptr [0x02cf1cd0],0x0      ; 004a097b | CBitFont * g_EditorFont
    JZ 0x004a0d76                       ; 004a0982 | LAB_004a0d76
        ;   XREF to: 004a0d76 (CONDITIONAL_JUMP)
    MOV EAX,[0x02cf1cd0]                ; 004a0988 | CBitFont * g_EditorFont
        ;   Label: LAB_004a0988
    PUSH 0x6a                           ; 004a098d
    MOV EDX,dword ptr [EAX + 0x3168]    ; 004a098f
    PUSH EAX                            ; 004a0995
    MOV dword ptr [0x02cf2668],EDX      ; 004a0996 | int g_FontCharacterHeight
    CALL engine_font.cpp_CBitFont_getCharWidth_FUN_004d01d0 ; 004a099c | int engine_font.cpp_CBitFont_getCharWidth_FUN_004d01d0(CBitFont * this_ptr, int char_code)
        ;   XREF to: 004d01d0 (UNCONDITIONAL_CALL)
    MOV ESI,dword ptr [0x02cf1cdc]      ; 004a09a1 | int g_WindowStackCount
    ADD ESP,0x8                         ; 004a09a7
    MOV [0x02cf266c],EAX                ; 004a09aa | int g_FontCharacterWidth
    CMP ESI,0x5                         ; 004a09af
    JL 0x004a09d6                       ; 004a09b2 | LAB_004a09d6
        ;   XREF to: 004a09d6 (CONDITIONAL_JUMP)
    MOV EBP,0x62339e                    ; 004a09b4 | = "..\\shape\\edittool.cpp" | s_shape_edittool_cpp_0062339e = ..\shape\edittool.cpp
    MOV EAX,0x7b8                       ; 004a09b9
    PUSH 0x6233b4                       ; 004a09be | = "Can't open another window!" | s_Can_t_open_another_windo_006233b4 = Can't open another window!
    MOV dword ptr [0x02f0ca48],EBP      ; 004a09c3 | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 004a09c9 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004a09ce | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004a09d3
    MOV EDX,dword ptr [0x02cf1cdc]      ; 004a09d6 | int g_WindowStackCount
        ;   Label: LAB_004a09d6
    ...
    MOV EBX,0x2cf1ce0                   ; 004a09e8 | SWindow[5] g_WindowStack
    SHL EAX,0x3                         ; 004a09ed
    ADD EBX,EAX                         ; 004a09f0
    MOV EAX,[0x00679394]                ; 004a09f2 | int g_WindowWidth
    ...
    MOV EAX,[0x00679398]                ; 004a0a08 | int g_WindowHeight
    ...
    MOV EDX,dword ptr [0x02cf1cdc]      ; 004a0a25 | int g_WindowStackCount
    MOV dword ptr [ESP],EAX             ; 004a0a2b
    INC EDX                             ; 004a0a2e
    MOV EAX,dword ptr [ESP + 0x8]       ; 004a0a2f
    MOV dword ptr [0x02cf1cdc],EDX      ; 004a0a33 | int g_WindowStackCount
    ...
    JL 0x004a0d9e                       ; 004a0a61 | LAB_004a0d9e
        ;   XREF to: 004a0d9e (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x38]      ; 004a0a67
        ;   Label: LAB_004a0a67
    MOV EBP,dword ptr [0x00679394]      ; 004a0a6b | int g_WindowWidth
    CMP EAX,EBP                         ; 004a0a71
    JLE 0x004a0a79                      ; 004a0a73 | LAB_004a0a79
    ...
    JZ 0x004a0b64                       ; 004a0a85 | LAB_004a0b64
    ...
    PUSH 0xc8                           ; 004a0a9e
    PUSH 0x14                           ; 004a0aa3
    PUSH 0x2cf0d30                      ; 004a0aa5 | char[200] g_TextWrapBuffer
    PUSH EDI                            ; 004a0aaa
    MOV ESI,dword ptr [0x02cf1cd0]      ; 004a0aab | CBitFont * g_EditorFont
    PUSH ESI                            ; 004a0ab1
    LEA EBP,[EBX + 0x38]                ; 004a0ab2
    CALL engine_font.cpp_CBitFont_wrapText_FUN_004d0010 ; 004a0ab5 | int engine_font.cpp_CBitFont_wrapText_FUN_004d0010(CBitFont * this_ptr, char * source_text, char * dest_buffer, int max_lines, ...)
    ...
    JLE 0x004a0af0                      ; 004a0ac5 | LAB_004a0af0
        ;   XREF to: 004a0af0 (CONDITIONAL_JUMP)
    MOV EDI,0x2cf0d30                   ; 004a0ac7 | char[200] g_TextWrapBuffer
    PUSH EDI                            ; 004a0acc | char[200] g_TextWrapBuffer
        ;   Label: LAB_004a0acc
    PUSH 0x6233cf                       ; 004a0acd | = "%s\n" | s_s_006233cf = %s

    PUSH EBP                            ; 004a0ad2
    INC ESI                             ; 004a0ad3
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 004a0ad4 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    JL 0x004a0acc                       ; 004a0aea | LAB_004a0acc
        ;   XREF to: 004a0acc (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 004a0aec
    CMP dword ptr [ESP + 0xc],0x0       ; 004a0af0
        ;   Label: LAB_004a0af0
    JLE 0x004a0b64                      ; 004a0af5 | LAB_004a0b64
        ;   XREF to: 004a0b64 (CONDITIONAL_JUMP)
    LEA EAX,[EBX + 0x38]                ; 004a0af7
    PUSH EAX                            ; 004a0afa
    MOV ECX,dword ptr [0x02cf1cd0]      ; 004a0afb | CBitFont * g_EditorFont
    DEC EBP                             ; 004a0b01
    PUSH ECX                            ; 004a0b02
    MOV byte ptr [EBP],0x0              ; 004a0b03 | DAT_02cf1d17
    CALL engine_font.cpp_CBitFont_getCharWidth_FUN_004cff40 ; 004a0b07 | int engine_font.cpp_CBitFont_getCharWidth_FUN_004cff40(CBitFont * this_ptr, char * text_string)
        ;   XREF to: 004cff40 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004a0b0c
    MOV EDX,dword ptr [0x02cf266c]      ; 004a0b0f | int g_FontCharacterWidth
    PUSH 0x6233d3                       ; 004a0b15 | = "j" | s_j_006233d3 = j
    MOV ESI,dword ptr [0x02cf1cd0]      ; 004a0b1a | CBitFont * g_EditorFont
    ADD EDX,EAX                         ; 004a0b20
    PUSH ESI                            ; 004a0b22
    MOV dword ptr [ESP + 0xc],EDX       ; 004a0b23
    CALL engine_font.cpp_CBitFont_getCharWidth_FUN_004cff40 ; 004a0b27 | int engine_font.cpp_CBitFont_getCharWidth_FUN_004cff40(CBitFont * this_ptr, char * text_string)
        ;   XREF to: 004cff40 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004a0b2c
    MOV EDI,dword ptr [0x02cf266c]      ; 004a0b2f | int g_FontCharacterWidth
    MOV EBP,dword ptr [ESP + 0x4]       ; 004a0b35
    ADD EAX,EDI                         ; 004a0b39
    CMP EAX,EBP                         ; 004a0b3b
    JLE 0x004a0b43                      ; 004a0b3d | LAB_004a0b43
    ...
    CMP dword ptr [ESP + 0x34],0x0      ; 004a0b64
        ;   Label: LAB_004a0b64
    JL 0x004a0da9                       ; 004a0b69 | LAB_004a0da9
        ;   XREF to: 004a0da9 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x3c]      ; 004a0b6f
        ;   Label: LAB_004a0b6f
    MOV EBP,dword ptr [0x00679398]      ; 004a0b73 | int g_WindowHeight
    CMP EAX,EBP                         ; 004a0b79
    JLE 0x004a0b81                      ; 004a0b7b | LAB_004a0b81
        ;   XREF to: 004a0b81 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x3c],EBP      ; 004a0b7d
    TEST byte ptr [ESP + 0x44],0x1      ; 004a0b81
        ;   Label: LAB_004a0b81
    JNZ 0x004a0db4                      ; 004a0b86 | LAB_004a0db4
        ;   XREF to: 004a0db4 (CONDITIONAL_JUMP)
    CMP dword ptr [0x02cf1cdc],0x1      ; 004a0b8c | int g_WindowStackCount
    JNZ 0x004a0ba2                      ; 004a0b93 | LAB_004a0ba2
        ;   XREF to: 004a0ba2 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [ESP + 0x2c]      ; 004a0b95
    PUSH EDX                            ; 004a0b99
    CALL shape_edittool.cpp_CEditorTools_backupScreen_FUN_0049e410 ; 004a0b9a | void shape_edittool.cpp_CEditorTools_backupScreen_FUN_0049e410(CEditorTools * this_ptr)
        ;   XREF to: 0049e410 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004a0b9f
    MOV EAX,[0x00679394]                ; 004a0ba2 | int g_WindowWidth
        ;   Label: LAB_004a0ba2
    MOV dword ptr [EBX + 0x1d4],EAX     ; 004a0ba7 | DAT_02cf1eb4
    MOV ECX,dword ptr [0x0067939c]      ; 004a0bad | int g_BitsPerPixel
    MOV EDX,dword ptr [EBX + 0x1d4]     ; 004a0bb3 | DAT_02cf1eb4
    IMUL EDX,ECX                        ; 004a0bb9
    MOV EAX,[0x00679398]                ; 004a0bbc | int g_WindowHeight
    ...
    PUSH 0x807                          ; 004a0be5
    PUSH 0x6233d5                       ; 004a0bea | = "..\\shape\\edittool.cpp" | s_shape_edittool_cpp_006233d5 = ..\shape\edittool.cpp
    MOV dword ptr [EBX + 0x1cc],0x0     ; 004a0bef | DAT_02cf1eac
    PUSH EAX                            ; 004a0bf9
    MOV dword ptr [EBX + 0x1d0],0x0     ; 004a0bfa | DAT_02cf1eb0
    CALL shape_memdbg.cpp_debugMalloc_FUN_0050f250 ; 004a0c04 | void * shape_memdbg.cpp_debugMalloc_FUN_0050f250(int size, char * filename, int line_number)
        ;   XREF to: 0050f250 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004a0c09
    MOV dword ptr [EBX + 0x1c8],EAX     ; 004a0c0c | DAT_02cf1ea8
    TEST EAX,EAX                        ; 004a0c12
    JNZ 0x004a0c38                      ; 004a0c14 | LAB_004a0c38
        ;   XREF to: 004a0c38 (CONDITIONAL_JUMP)
    MOV EBP,0x6233eb                    ; 004a0c16 | = "..\\shape\\edittool.cpp" | s_shape_edittool_cpp_006233eb = ..\shape\edittool.cpp
    MOV EAX,0x809                       ; 004a0c1b
    PUSH 0x623401                       ; 004a0c20 | = "Out of memory to open editor window." | s_Out_of_memory_to_open_ed_00623401 = Out of memory to open editor window.
    MOV dword ptr [0x02f0ca48],EBP      ; 004a0c25 | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 004a0c2b | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004a0c30 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ...
    JLE 0x004a0cb0                      ; 004a0c4c | LAB_004a0cb0
        ;   XREF to: 004a0cb0 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x0067939c]      ; 004a0c4e | int g_BitsPerPixel
        ;   Label: LAB_004a0c4e
    ...
    MOV ESI,dword ptr [ESI + 0x2cf6a9c] ; 004a0c7d | void *[1024] g_ScreenBufferArray
    ...
    JL 0x004a0c4e                       ; 004a0cad | LAB_004a0c4e
        ;   XREF to: 004a0c4e (CONDITIONAL_JUMP)
    NOP                                 ; 004a0caf
    MOV EAX,[0x02d02558]                ; 004a0cb0 | int g_ClipLeft
        ;   Label: LAB_004a0cb0
    MOV dword ptr [EBX + 0x10],EAX      ; 004a0cb5 | DAT_02cf1cf0
    MOV EAX,[0x02d0255c]                ; 004a0cb8 | int g_ClipTop
    MOV dword ptr [EBX + 0x14],EAX      ; 004a0cbd | DAT_02cf1cf4
    MOV EAX,[0x02d02560]                ; 004a0cc0 | int g_ClipRight
    MOV dword ptr [EBX + 0x18],EAX      ; 004a0cc5 | DAT_02cf1cf8
    MOV EAX,[0x02d02564]                ; 004a0cc8 | int g_ClipBottom
    MOV dword ptr [EBX + 0x1c],EAX      ; 004a0ccd | DAT_02cf1cfc
    MOV EAX,[0x02d02548]                ; 004a0cd0 | int g_ViewportCenterXFixed
    MOV dword ptr [EBX + 0x20],EAX      ; 004a0cd5 | DAT_02cf1d00
    MOV EAX,[0x02d0254c]                ; 004a0cd8 | int g_ViewportCenterYFixed
    MOV dword ptr [EBX + 0x24],EAX      ; 004a0cdd | DAT_02cf1d04
    MOV EAX,[0x02d02550]                ; 004a0ce0 | int g_ViewportRightFixed
    MOV dword ptr [EBX + 0x28],EAX      ; 004a0ce5 | DAT_02cf1d08
    MOV EAX,[0x02d02554]                ; 004a0ce8 | int g_ViewportBottomFixed
    MOV dword ptr [EBX + 0x2c],EAX      ; 004a0ced | DAT_02cf1d0c
    MOV EAX,[0x02d02568]                ; 004a0cf0 | int g_ViewportWidth
    MOV dword ptr [EBX + 0x30],EAX      ; 004a0cf5 | DAT_02cf1d10
    MOV EAX,[0x02d0256c]                ; 004a0cf8 | int g_ViewportHeight
    MOV dword ptr [EBX + 0x34],EAX      ; 004a0cfd | DAT_02cf1d14
    MOV EAX,dword ptr [ESP + 0x30]      ; 004a0d00
    MOV dword ptr [EBX],EAX             ; 004a0d04 | SWindow[5] g_WindowStack
    ...
    CALL engine_2d.c_setupViewportAndClipping_FUN_00401800 ; 004a0d66 | void engine_2d.c_setupViewportAndClipping_FUN_00401800(int left, int top, int right, int bottom)
    ...
    POP EBX                             ; 004a0d74
    RET                                 ; 004a0d75
    MOV ECX,0x622eae                    ; 004a0d76 | = "..\\shape\\edittool.cpp" | s_shape_edittool_cpp_00622eae = ..\shape\edittool.cpp
        ;   Label: LAB_004a0d76
    MOV EBX,0x8d                        ; 004a0d7b
    PUSH 0x622ec4                       ; 004a0d80 | = "gEdFont must be set by the application." | s_gEdFont_must_be_set_by_t_00622ec4 = gEdFont must be set by the application.
    MOV dword ptr [0x02f0ca48],ECX      ; 004a0d85 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 004a0d8b | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004a0d91 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004a0d96
    JMP 0x004a0988                      ; 004a0d99 | LAB_004a0988
        ;   XREF to: 004a0988 (UNCONDITIONAL_JUMP)
    XOR ESI,ESI                         ; 004a0d9e
        ;   Label: LAB_004a0d9e
    MOV dword ptr [ESP + 0x30],ESI      ; 004a0da0
    JMP 0x004a0a67                      ; 004a0da4 | LAB_004a0a67
        ;   XREF to: 004a0a67 (UNCONDITIONAL_JUMP)
    XOR EDI,EDI                         ; 004a0da9
        ;   Label: LAB_004a0da9
    MOV dword ptr [ESP + 0x34],EDI      ; 004a0dab
    JMP 0x004a0b6f                      ; 004a0daf | LAB_004a0b6f
        ;   XREF to: 004a0b6f (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0x1c8],0x0     ; 004a0db4 | DAT_02cf1ea8
        ;   Label: LAB_004a0db4
    JMP 0x004a0cb0                      ; 004a0dbe | LAB_004a0cb0
