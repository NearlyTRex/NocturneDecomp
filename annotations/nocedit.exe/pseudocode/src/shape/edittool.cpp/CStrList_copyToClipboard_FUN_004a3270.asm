...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl shape_edittool_cpp_CStrList_copyToClipboard_FUN_004a3270(CStrList *this_ptr)
;
; Parameters:
...
section .text
    ...
    JLE 0x004a32b0                      ; 004a3283
        ;   XREF to: 004a32b0 (CONDITIONAL_JUMP)  ; LAB_004a32b0
    PUSH ESI                            ; 004a3285
        ;   Label: LAB_004a3285
    PUSH EBX                            ; 004a3286
    CALL shape_edittool.cpp_CStrList_getStringAt_FUN_004a2f70 ; 004a3287
    ...
    JL 0x004a3285                       ; 004a32a1
        ;   XREF to: 004a3285 (CONDITIONAL_JUMP)  ; LAB_004a3285
    ...
    JNZ 0x004a32f2                      ; 004a32c9
        ;   XREF to: 004a32f2 (CONDITIONAL_JUMP)  ; LAB_004a32f2
    PUSH EBP                            ; 004a32cb
    MOV EBP,dword ptr [EBX]             ; 004a32cc
    PUSH EBP                            ; 004a32ce
    MOV ESI,0x62393e                    ; 004a32cf | = "..\\shape\\edittool.cpp"
    MOV EDI,0xc51                       ; 004a32d4
    PUSH 0x623954                       ; 004a32d9 | = "CStrList::copyToClipboard - out of me..."
    MOV dword ptr [0x02f0ca48],ESI      ; 004a32de | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 004a32e4 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004a32ea
    ...
    JLE 0x004a3320                      ; 004a32fb
        ;   XREF to: 004a3320 (CONDITIONAL_JUMP)  ; LAB_004a3320
    PUSH ESI                            ; 004a32fd
        ;   Label: LAB_004a32fd
    PUSH EBX                            ; 004a32fe
    CALL shape_edittool.cpp_CStrList_getStringAt_FUN_004a2f70 ; 004a32ff
        ;   XREF to: 004a2f70 (UNCONDITIONAL_CALL)  ; char * shape_edittool.cpp_CStrList_getStringAt_FUN_004a2f70(CStrList * this_ptr, int index)
    ...
    JL 0x004a32fd                       ; 004a331d
        ;   XREF to: 004a32fd (CONDITIONAL_JUMP)  ; LAB_004a32fd
    NOP                                 ; 004a331f
    ...
    MOV ESI,0x623999                    ; 004a3336 | = "..\\shape\\edittool.cpp"
