...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_edittool.cpp_CEditorTools_backupScreen_FUN_0049e410(CEditorTools * this_ptr)
;
; Parameters:
...
section .text
    ...
    CMP dword ptr [0x02d03e94],0x0      ; 0049e417 | int g_UseExternalRenderer
    JZ 0x0049e4b9                       ; 0049e41e | LAB_0049e4b9
        ;   XREF to: 0049e4b9 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 0049e424
    PUSH EBX                            ; 0049e425
    MOV ECX,dword ptr [0x00679398]      ; 0049e426 | int g_WindowHeight
    TEST ECX,ECX                        ; 0049e42c
    JLE 0x0049e450                      ; 0049e42e | LAB_0049e450
        ;   XREF to: 0049e450 (CONDITIONAL_JUMP)
    LEA EBX,[ECX*0x4 + 0x0]             ; 0049e430
    XOR EAX,EAX                         ; 0049e437
    ADD EAX,0x4                         ; 0049e439
        ;   Label: LAB_0049e439
    MOV EDX,dword ptr [EAX + 0x2cf6a98] ; 0049e43c | void *[1024] g_ScreenBufferArray
    MOV dword ptr [ESP + EAX*0x1 + 0x4],EDX ; 0049e442
    CMP EAX,EBX                         ; 0049e446
    JL 0x0049e439                       ; 0049e448 | LAB_0049e439
        ;   XREF to: 0049e439 (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 0049e44a
    CALL wincore_windll.cpp_lockFrame_FUN_005b7210 ; 0049e450 | int wincore_windll.cpp_lockFrame_FUN_005b7210()
        ;   Label: LAB_0049e450
        ;   XREF to: 005b7210 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [0x00679394]      ; 0049e455 | int g_WindowWidth
    MOV EBX,dword ptr [0x0067939c]      ; 0049e45b | int g_BitsPerPixel
    ...
    MOV ESI,dword ptr [0x00679398]      ; 0049e471 | int g_WindowHeight
    XOR EBX,EBX                         ; 0049e477
    MOV EBP,EAX                         ; 0049e479
    TEST ESI,ESI                        ; 0049e47b
    JLE 0x0049e4ad                      ; 0049e47d | LAB_0049e4ad
        ;   XREF to: 0049e4ad (CONDITIONAL_JUMP)
    PUSH EDI                            ; 0049e47f
    XOR EDX,EDX                         ; 0049e480
    MOV ECX,EBP                         ; 0049e482
        ;   Label: LAB_0049e482
    MOV ESI,dword ptr [EDX + 0x2cf6a9c] ; 0049e484 | void *[1024] g_ScreenBufferArray
    ...
    POP EDI                             ; 0049e49d
    INC EBX                             ; 0049e49e
    MOV EDI,dword ptr [0x00679398]      ; 0049e49f | int g_WindowHeight
    ADD EDX,0x4                         ; 0049e4a5
    CMP EBX,EDI                         ; 0049e4a8
    JL 0x0049e482                       ; 0049e4aa | LAB_0049e482
        ;   XREF to: 0049e482 (CONDITIONAL_JUMP)
    POP EDI                             ; 0049e4ac
    PUSH 0x1                            ; 0049e4ad
        ;   Label: LAB_0049e4ad
    CALL wincore_windll.cpp_unlockFrame_FUN_005b7250 ; 0049e4af | void wincore_windll.cpp_unlockFrame_FUN_005b7250(int clear_lock_flag)
