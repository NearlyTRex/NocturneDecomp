...
;                               FUNCTION
; *****************************************************************************
; __cdecl char * shape_edittool.cpp_extractTabDelimitedField_FUN_0049d250(char * source_str, char * dest_buffer)
;
; Parameters:
...
section .text
    ...
    TEST BL,BL                          ; 0049d272
    JNZ 0x0049d25f                      ; 0049d274 | LAB_0049d25f
