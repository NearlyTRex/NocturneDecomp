...
;                               FUNCTION
; *****************************************************************************
; __cdecl CEdScrollBar * __cdecl shape_edittool_cpp_CEdScrollBar_dtor_FUN_004a5b20(CEdScrollBar *this_ptr)
;
; Parameters:
...
;   core_msnedit.cpp_MasterEditorKeysHelpScreen_FUN_00535e70 at 00536baa
