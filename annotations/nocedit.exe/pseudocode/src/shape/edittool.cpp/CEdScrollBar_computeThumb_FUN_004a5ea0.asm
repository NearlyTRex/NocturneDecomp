...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_edittool.cpp_CEdScrollBar_computeThumb_FUN_004a5ea0(CEdScrollBar * this_ptr)
;
; Parameters:
...
section .text
    ...
    JZ 0x004a5f91                       ; 004a5ee5 | LAB_004a5f91
    ...
    JGE 0x004a5f2d                      ; 004a5f28 | LAB_004a5f2d
    ...
    JLE 0x004a5f4c                      ; 004a5f3a | LAB_004a5f4c
    ...
    JG 0x004a5fa0                       ; 004a5f52 | LAB_004a5fa0
    ...
    POP EBX                             ; 004a5f68
    RET                                 ; 004a5f69
    MOV EBP,0x623f5a                    ; 004a5f6a | = "..\\shape\\edittool.cpp" | s_shape_edittool_cpp_00623f5a = ..\shape\edittool.cpp
        ;   Label: LAB_004a5f6a
    MOV EAX,0x115a                      ; 004a5f6f
    PUSH 0x623f70                       ; 004a5f74 | = "CEdScrollBar::computeThumb - invalid ..." | s_CEdScrollBar_computeThum_00623f70 = CEdScrollBar::computeThumb - invalid dimensions
    MOV dword ptr [0x02f0ca48],EBP      ; 004a5f79 | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 004a5f7f | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004a5f84 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004a5f89
    JMP 0x004a5ece                      ; 004a5f8c | LAB_004a5ece
    ...
    JMP 0x004a5ef5                      ; 004a5f9b | LAB_004a5ef5
