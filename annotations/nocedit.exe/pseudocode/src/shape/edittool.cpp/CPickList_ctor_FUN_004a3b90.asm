...
;                               FUNCTION
; *****************************************************************************
; __cdecl CPickList * shape_edittool.cpp_CPickList_ctor_FUN_004a3b90(CPickList * this_ptr)
;
; Parameters:
...
;   core_frankgen.cpp_FUN_004d2770 at 004d2781
...
section .text
    ...
    PUSH EBX                            ; 004a3b97
    CALL shape_edittool.cpp_CStrList_ctor_FUN_004a2a20 ; 004a3b98 | CStrList * shape_edittool.cpp_CStrList_ctor_FUN_004a2a20(CStrList * this_ptr)
        ;   XREF to: 004a2a20 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004a3b9d
    ADD EAX,0x1a4                       ; 004a3ba0
    PUSH EAX                            ; 004a3ba5
    CALL shape_edittool.cpp_CEdScrollBar_ctor_FUN_004a5ae0 ; 004a3ba6 | CEdScrollBar * shape_edittool.cpp_CEdScrollBar_ctor_FUN_004a5ae0(CEdScrollBar * this_ptr)
        ;   XREF to: 004a5ae0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004a3bab
    ADD EAX,0x38                        ; 004a3bae
    PUSH EAX                            ; 004a3bb1
    CALL shape_edittool.cpp_CEdButton_ctor_FUN_004a64e0 ; 004a3bb2 | CEdButton * shape_edittool.cpp_CEdButton_ctor_FUN_004a64e0(CEdButton * this_ptr)
        ;   XREF to: 004a64e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004a3bb7
    ADD EAX,0xe4                        ; 004a3bba
    PUSH EAX                            ; 004a3bbf
    CALL shape_edittool.cpp_CEdButton_ctor_FUN_004a64e0 ; 004a3bc0 | CEdButton * shape_edittool.cpp_CEdButton_ctor_FUN_004a64e0(CEdButton * this_ptr)
        ;   XREF to: 004a64e0 (UNCONDITIONAL_CALL)
    LEA EBX,[EAX + 0xfffffd40]          ; 004a3bc5
    MOV dword ptr [EBX + 0xc],0x65d494  ; 004a3bcb | CStrList_vtable g_CPickListVTable
    ...
    PUSH 0x6239eb                       ; 004a3c07 | = "OK" | s_OK_006239eb = OK
    MOV dword ptr [EBX + 0x1a0],0x0     ; 004a3c0c
    CALL support_newmsg.cpp_getLocalizedString_FUN_005441f0 ; 004a3c16 | char * support_newmsg.cpp_getLocalizedString_FUN_005441f0(char * key)
    ...
    CMP AL,0x0                          ; 004a3c28
    JZ 0x004a3c3c                       ; 004a3c2a | LAB_004a3c3c
    ...
    CMP AL,0x0                          ; 004a3c38
    JNZ 0x004a3c24                      ; 004a3c3a | LAB_004a3c24
        ;   XREF to: 004a3c24 (CONDITIONAL_JUMP)
    POP EDI                             ; 004a3c3c
        ;   Label: LAB_004a3c3c
    PUSH 0x6239ee                       ; 004a3c3d | = "Cancel" | s_Cancel_006239ee = Cancel
    CALL support_newmsg.cpp_getLocalizedString_FUN_005441f0 ; 004a3c42 | char * support_newmsg.cpp_getLocalizedString_FUN_005441f0(char * key)
        ;   XREF to: 005441f0 (UNCONDITIONAL_CALL)
    ...
    CMP AL,0x0                          ; 004a3c57
    JZ 0x004a3c6b                       ; 004a3c59 | LAB_004a3c6b
    ...
    CMP AL,0x0                          ; 004a3c67
    JNZ 0x004a3c53                      ; 004a3c69 | LAB_004a3c53
