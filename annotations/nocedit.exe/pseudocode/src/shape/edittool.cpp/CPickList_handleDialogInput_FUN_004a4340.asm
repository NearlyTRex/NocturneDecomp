...
;                               FUNCTION
; *****************************************************************************
; __cdecl int shape_edittool.cpp_CPickList_handleDialogInput_FUN_004a4340(CPickList * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004a434f
    CALL shape_edittool.cpp_CPickList_validateScrollBounds_FUN_004a5240 ; 004a4350 | void shape_edittool.cpp_CPickList_validateScrollBounds_FUN_004a5240(CPickList * this_ptr)
        ;   XREF to: 004a5240 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [EBX + 0x170]     ; 004a4355
    ADD ESP,0x4                         ; 004a435b
    TEST EDX,EDX                        ; 004a435e
    JZ 0x004a4380                       ; 004a4360 | LAB_004a4380
        ;   XREF to: 004a4380 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [EBX + 0x17c]     ; 004a4362
    PUSH ECX                            ; 004a4368
    PUSH EBX                            ; 004a4369
    CALL shape_edittool.cpp_CPickList_isItemEnabled_FUN_004a54e0 ; 004a436a | int shape_edittool.cpp_CPickList_isItemEnabled_FUN_004a54e0(CPickList * this_ptr, int item_index)
        ;   XREF to: 004a54e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004a436f
    TEST EAX,EAX                        ; 004a4372
    JNZ 0x004a4520                      ; 004a4374 | LAB_004a4520
    ...
    JL 0x004a452d                       ; 004a438c | LAB_004a452d
        ;   XREF to: 004a452d (CONDITIONAL_JUMP)
    PUSH EBX                            ; 004a4392
    CALL shape_edittool.cpp_CPickList_validateScrollBounds_FUN_004a5240 ; 004a4393 | void shape_edittool.cpp_CPickList_validateScrollBounds_FUN_004a5240(CPickList * this_ptr)
        ;   XREF to: 004a5240 (UNCONDITIONAL_CALL)
    MOV ESI,dword ptr [EBX + 0x40]      ; 004a4398
    ADD ESP,0x4                         ; 004a439b
    TEST ESI,ESI                        ; 004a439e
    JNZ 0x004a4514                      ; 004a43a0 | LAB_004a4514
        ;   XREF to: 004a4514 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [EBX + 0x1d8]     ; 004a43a6
    LEA ECX,[EBX + 0x1a4]               ; 004a43ac
    CMP EDI,0x1                         ; 004a43b2
    JNZ 0x004a4539                      ; 004a43b5 | LAB_004a4539
    ...
    CALL shape_edittool.cpp_CEdScrollBar_handleInput_FUN_004a5fc0 ; 004a43dc | void shape_edittool.cpp_CEdScrollBar_handleInput_FUN_004a5fc0(CEdScrollBar * this_ptr)
    ...
    JG 0x004a4418                       ; 004a440f | LAB_004a4418
    ...
    JLE 0x004a442c                      ; 004a4424 | LAB_004a442c
        ;   XREF to: 004a442c (CONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0x17c],EDX     ; 004a4426
    CMP byte ptr [EBX + 0x44],0x0       ; 004a442c
        ;   Label: LAB_004a442c
    JZ 0x004a4469                       ; 004a4430 | LAB_004a4469
        ;   XREF to: 004a4469 (CONDITIONAL_JUMP)
    LEA EAX,[EBX + 0x1dc]               ; 004a4432
    PUSH EAX                            ; 004a4438
    CALL shape_edittool.cpp_CEdButton_wasClicked_FUN_004a6830 ; 004a4439 | int shape_edittool.cpp_CEdButton_wasClicked_FUN_004a6830(CEdButton * this_ptr)
        ;   XREF to: 004a6830 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004a443e
    TEST EAX,EAX                        ; 004a4441
    JZ 0x004a444f                       ; 004a4443 | LAB_004a444f
        ;   XREF to: 004a444f (CONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0x170],0x1     ; 004a4445
    MOV ECX,dword ptr [0x02cf2b00]      ; 004a444f | CEdButton * g_ActiveButton
        ;   Label: LAB_004a444f
    LEA EAX,[EBX + 0x1dc]               ; 004a4455
    CMP EAX,ECX                         ; 004a445b
    JNZ 0x004a4469                      ; 004a445d | LAB_004a4469
        ;   XREF to: 004a4469 (CONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0x3a4],0x0     ; 004a445f
    CMP byte ptr [EBX + 0xa8],0x0       ; 004a4469
        ;   Label: LAB_004a4469
    JNZ 0x004a4599                      ; 004a4470 | LAB_004a4599
        ;   XREF to: 004a4599 (CONDITIONAL_JUMP)
    TEST byte ptr [0x02cf6a94],0x1      ; 004a4476 | int g_MouseButtonFlags
        ;   Label: LAB_004a4476
    JZ 0x004a4514                       ; 004a447d | LAB_004a4514
        ;   XREF to: 004a4514 (CONDITIONAL_JUMP)
    CMP dword ptr [0x02cf2b00],0x0      ; 004a4483 | CEdButton * g_ActiveButton
    JNZ 0x004a4514                      ; 004a448a | LAB_004a4514
        ;   XREF to: 004a4514 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x02cf6a90]      ; 004a4490 | int g_MouseY
    PUSH EDX                            ; 004a4496
    MOV ECX,dword ptr [0x02cf6a8c]      ; 004a4497 | int g_MouseX
    PUSH ECX                            ; 004a449d
    PUSH EBX                            ; 004a449e
    CALL shape_edittool.cpp_CPickList_getItemAtMousePosition_FUN_004a53a0 ; 004a449f | int shape_edittool.cpp_CPickList_getItemAtMousePosition_FUN_004a53a0(CPickList * this_ptr, int mouse_x, int mouse_y)
        ;   XREF to: 004a53a0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004a44a4
    MOV ESI,EAX                         ; 004a44a7
    TEST EAX,EAX                        ; 004a44a9
    JL 0x004a450e                       ; 004a44ab | LAB_004a450e
        ;   XREF to: 004a450e (CONDITIONAL_JUMP)
    MOV CL,byte ptr [0x02cf6a94]        ; 004a44ad | int g_MouseButtonFlags
    MOV dword ptr [EBX + 0x3a4],0xffffffff ; 004a44b3
    AND CL,0xfe                         ; 004a44bd
    MOV dword ptr [EBX + 0x17c],EAX     ; 004a44c0
    MOV byte ptr [0x02cf6a94],CL        ; 004a44c6 | int g_MouseButtonFlags
    CALL wincore_winrun.cpp_getTime_FUN_005f2dc0 ; 004a44cc | int wincore_winrun.cpp_getTime_FUN_005f2dc0()
        ;   XREF to: 005f2dc0 (UNCONDITIONAL_CALL)
    MOV EDI,dword ptr [0x02cf2af8]      ; 004a44d1 | int g_LastClickTimestamp
    MOV EDX,EAX                         ; 004a44d7
    SUB EAX,EDI                         ; 004a44d9
    TEST EAX,EAX                        ; 004a44db
    JLE 0x004a4508                      ; 004a44dd | LAB_004a4508
        ;   XREF to: 004a4508 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP],EAX             ; 004a44df
    FILD dword ptr [ESP]                ; 004a44e2
    FCOMP double ptr [0x00623a76]       ; 004a44e5 | double DOUBLE_00623a76
    FNSTSW AX                           ; 004a44eb
    SAHF                                ; 004a44ed
    JNC 0x004a4508                      ; 004a44ee | LAB_004a4508
        ;   XREF to: 004a4508 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x02cf2afc]      ; 004a44f0 | int g_LastClickItemIndex
    CMP ECX,dword ptr [EBX + 0x17c]     ; 004a44f6
    JNZ 0x004a4508                      ; 004a44fc | LAB_004a4508
        ;   XREF to: 004a4508 (CONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0x170],0x1     ; 004a44fe
    MOV dword ptr [0x02cf2af8],EDX      ; 004a4508 | int g_LastClickTimestamp
        ;   Label: LAB_004a4508
    MOV dword ptr [0x02cf2afc],ESI      ; 004a450e | int g_LastClickItemIndex
        ;   Label: LAB_004a450e
    ...
    CMP EDI,0x2                         ; 004a4539
        ;   Label: LAB_004a4539
    JNZ 0x004a43f0                      ; 004a453c | LAB_004a43f0
    ...
    CALL shape_edittool.cpp_CEdScrollBar_handleInput_FUN_004a5fc0 ; 004a4582 | void shape_edittool.cpp_CEdScrollBar_handleInput_FUN_004a5fc0(CEdScrollBar * this_ptr)
        ;   XREF to: 004a5fc0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EBX + 0x1a4]     ; 004a4587
    IMUL EAX,dword ptr [EBX + 0x188]    ; 004a458d
    JMP 0x004a43e7                      ; 004a4594 | LAB_004a43e7
        ;   XREF to: 004a43e7 (UNCONDITIONAL_JUMP)
    LEA ESI,[EBX + 0x2c0]               ; 004a4599
        ;   Label: LAB_004a4599
    PUSH ESI                            ; 004a459f
    CALL shape_edittool.cpp_CEdButton_wasClicked_FUN_004a6830 ; 004a45a0 | int shape_edittool.cpp_CEdButton_wasClicked_FUN_004a6830(CEdButton * this_ptr)
        ;   XREF to: 004a6830 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004a45a5
    TEST EAX,EAX                        ; 004a45a8
    JNZ 0x004a452d                      ; 004a45aa | LAB_004a452d
        ;   XREF to: 004a452d (CONDITIONAL_JUMP)
    CMP ESI,dword ptr [0x02cf2b00]      ; 004a45ac | CEdButton * g_ActiveButton
    JNZ 0x004a4476                      ; 004a45b2 | LAB_004a4476
        ;   XREF to: 004a4476 (CONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0x3a4],0x1     ; 004a45b8
    JMP 0x004a4476                      ; 004a45c2 | LAB_004a4476
