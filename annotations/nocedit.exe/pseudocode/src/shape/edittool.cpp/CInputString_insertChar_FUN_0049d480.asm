...
section .text
    ...
    PUSH EAX                            ; 0049d4c5
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 0049d4c6 | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
    ...
    JNZ 0x0049d4f0                      ; 0049d4e1 | LAB_0049d4f0
