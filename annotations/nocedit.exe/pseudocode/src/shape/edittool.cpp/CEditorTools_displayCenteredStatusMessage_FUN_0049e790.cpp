...
// Convention: __cdecl
// Signature: void __cdecl shape_edittool_cpp_CEditorTools_displayCenteredStatusMessage_FUN_0049e790 (CEditorTools *this_ptr,char *message)
...

{
  ...
  vsprintf(g_StatusMessageBuffer,message,&local_14);
