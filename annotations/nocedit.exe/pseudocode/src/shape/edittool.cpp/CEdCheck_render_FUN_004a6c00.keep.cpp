...
#else
  iVar3 = nocturne_ui_text_height(g_EditorFont,this_ptr->checkbox_text,
...
#else
  nocturne_ui_draw_text(g_EditorFont,this_ptr->checkbox_text,iVar4 + iVar8,iVar7,iVar5,
                        color_value,nocturne_ui_editor_scale());
#endif
