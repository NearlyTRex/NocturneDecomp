...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_edittool.cpp_CEditorTools_showCenteredProgressDialog_FUN_004a0430(CEditorTools * this_ptr, char * message_text)
;
; Parameters:
...
section .text
    ...
    CMP dword ptr [0x02cf1cd0],0x0      ; 004a0438 | CBitFont * g_EditorFont
    JNZ 0x004a0464                      ; 004a043f | LAB_004a0464
        ;   XREF to: 004a0464 (CONDITIONAL_JUMP)
    MOV ECX,0x622eae                    ; 004a0441 | = "..\\shape\\edittool.cpp" | s_shape_edittool_cpp_00622eae = ..\shape\edittool.cpp
    MOV EBX,0x8d                        ; 004a0446
    PUSH 0x622ec4                       ; 004a044b | = "gEdFont must be set by the application." | s_gEdFont_must_be_set_by_t_00622ec4 = gEdFont must be set by the application.
    MOV dword ptr [0x02f0ca48],ECX      ; 004a0450 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 004a0456 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004a045c | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004a0461
    MOV EAX,[0x02cf1cd0]                ; 004a0464 | CBitFont * g_EditorFont
        ;   Label: LAB_004a0464
    PUSH 0x6a                           ; 004a0469
    MOV EBX,dword ptr [EAX + 0x3168]    ; 004a046b
    PUSH EAX                            ; 004a0471
    MOV dword ptr [0x02cf2668],EBX      ; 004a0472 | int g_FontCharacterHeight
    CALL engine_font.cpp_CBitFont_getCharWidth_FUN_004d01d0 ; 004a0478 | int engine_font.cpp_CBitFont_getCharWidth_FUN_004d01d0(CBitFont * this_ptr, int char_code)
        ;   XREF to: 004d01d0 (UNCONDITIONAL_CALL)
    MOV [0x02cf266c],EAX                ; 004a047d | int g_FontCharacterWidth
    MOV EAX,[0x00679394]                ; 004a0482 | int g_WindowWidth
    ...
    JNZ 0x004a0502                      ; 004a0497 | LAB_004a0502
        ;   XREF to: 004a0502 (CONDITIONAL_JUMP)
    PUSH 0x0                            ; 004a0499
        ;   Label: LAB_004a0499
    PUSH ESI                            ; 004a049b
    MOV ESI,dword ptr [0x02cf266c]      ; 004a049c | int g_FontCharacterWidth
    ...
    PUSH EAX                            ; 004a04b3
    CALL shape_edittool.cpp_CEditorTools_createCenteredModal_FUN_004a0890 ; 004a04b4 | void shape_edittool.cpp_CEditorTools_createCenteredModal_FUN_004a0890(CEditorTools * this_ptr, int min_width, int min_height, char * text_content, ...)
        ;   XREF to: 004a0890 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 004a04b9
    CALL wincore_winrun.cpp_getTime_FUN_005f2dc0 ; 004a04bc | int wincore_winrun.cpp_getTime_FUN_005f2dc0()
        ;   XREF to: 005f2dc0 (UNCONDITIONAL_CALL)
    MOV EBX,dword ptr [0x02cf1cdc]      ; 004a04c1 | int g_WindowStackCount
    DEC EBX                             ; 004a04c7
    ...
    CALL shape_edittool.cpp_CEditorTools_updatePercentage_FUN_004a0530 ; 004a04f5 | void shape_edittool.cpp_CEditorTools_updatePercentage_FUN_004a0530(CEditorTools * this_ptr, float progress_min, float progress_max)
    ...
    PUSH ESI                            ; 004a0502
        ;   Label: LAB_004a0502
    MOV EDI,dword ptr [0x02cf1cd0]      ; 004a0503 | CBitFont * g_EditorFont
    PUSH EDI                            ; 004a0509
    CALL engine_font.cpp_CBitFont_getTextWidth_FUN_004cfe80 ; 004a050a | int engine_font.cpp_CBitFont_getTextWidth_FUN_004cfe80(CBitFont * this_ptr, char * text)
        ;   XREF to: 004cfe80 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004a050f
    CMP EBX,EAX                         ; 004a0512
    JGE 0x004a0499                      ; 004a0514 | LAB_004a0499
        ;   XREF to: 004a0499 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 004a0516
    MOV EBP,dword ptr [0x02cf1cd0]      ; 004a0517 | CBitFont * g_EditorFont
    PUSH EBP                            ; 004a051d
    CALL engine_font.cpp_CBitFont_getTextWidth_FUN_004cfe80 ; 004a051e | int engine_font.cpp_CBitFont_getTextWidth_FUN_004cfe80(CBitFont * this_ptr, char * text)
        ;   XREF to: 004cfe80 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004a0523
    MOV EBX,EAX                         ; 004a0526
    JMP 0x004a0499                      ; 004a0528 | LAB_004a0499
