...
section .text
    ...
    JL 0x004a2bd4                       ; 004a2bce | LAB_004a2bd4
        ;   XREF to: 004a2bd4 (CONDITIONAL_JUMP)
    CMP EBP,dword ptr [EBX]             ; 004a2bd0
    JLE 0x004a2bf7                      ; 004a2bd2 | LAB_004a2bf7
        ;   XREF to: 004a2bf7 (CONDITIONAL_JUMP)
    MOV ECX,0x6236a2                    ; 004a2bd4 | = "..\\shape\\edittool.cpp" | s_shape_edittool_cpp_006236a2 = ..\shape\edittool.cpp
        ;   Label: LAB_004a2bd4
    MOV ESI,0xb32                       ; 004a2bd9
    PUSH 0x6236b8                       ; 004a2bde | = "CStrList::insert - invalid index" | s_CStrList_insert_invalid__006236b8 = CStrList::insert - invalid index
    MOV dword ptr [0x02f0ca48],ECX      ; 004a2be3 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 004a2be9 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004a2bef | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    JLE 0x004a2c10                      ; 004a2c01 | LAB_004a2c10
        ;   XREF to: 004a2c10 (CONDITIONAL_JUMP)
    LEA EAX,[EDI + 0x14]                ; 004a2c03
    PUSH EAX                            ; 004a2c06
    PUSH EBX                            ; 004a2c07
    CALL shape_edittool.cpp_CStrList_allocate_FUN_004a2cc0 ; 004a2c08 | void shape_edittool.cpp_CStrList_allocate_FUN_004a2cc0(CStrList * this_ptr, int new_capacity)
    ...
    PUSH EAX                            ; 004a2c2e
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 004a2c2f | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
        ;   XREF to: 005fe5e0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004a2c34
    PUSH 0xb3f                          ; 004a2c37
    PUSH 0x6236d9                       ; 004a2c3c | = "..\\shape\\edittool.cpp" | s_shape_edittool_cpp_006236d9 = ..\shape\edittool.cpp
    ...
    INC ECX                             ; 004a2c4f
    PUSH ECX                            ; 004a2c50
    CALL shape_memdbg.cpp_debugMalloc_FUN_0050f250 ; 004a2c51 | void * shape_memdbg.cpp_debugMalloc_FUN_0050f250(int size, char * filename, int line_number)
    ...
    JZ 0x004a2c92                       ; 004a2c67 | LAB_004a2c92
    ...
    CMP AL,0x0                          ; 004a2c78
    JZ 0x004a2c8c                       ; 004a2c7a | LAB_004a2c8c
    ...
    CMP AL,0x0                          ; 004a2c88
    JNZ 0x004a2c74                      ; 004a2c8a | LAB_004a2c74
    ...
    POP EBX                             ; 004a2c90
    RET                                 ; 004a2c91
    MOV ESI,0x6236ef                    ; 004a2c92 | = "..\\shape\\edittool.cpp" | s_shape_edittool_cpp_006236ef = ..\shape\edittool.cpp
        ;   Label: LAB_004a2c92
    MOV EDI,0xb40                       ; 004a2c97
    PUSH 0x623705                       ; 004a2c9c | = "CStrList::insert - out of memory" | s_CStrList_insert_out_of_m_00623705 = CStrList::insert - out of memory
    MOV dword ptr [0x02f0ca48],ESI      ; 004a2ca1 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 004a2ca7 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004a2cad | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004a2cb2
    JMP 0x004a2c69                      ; 004a2cb5 | LAB_004a2c69
