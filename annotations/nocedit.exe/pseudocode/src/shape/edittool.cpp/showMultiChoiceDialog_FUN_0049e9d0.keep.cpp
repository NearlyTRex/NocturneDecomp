...

{
  ...
  pvVar3 = shape_memdbg_cpp_debugAllocTracked2_FUN_0050f1f0
                     (iVar2 * (int)sizeof(CEdButton) + 4,"..\\shape\\edittool.cpp",1042);
  ...
  if (0 < iVar2) {
    do {
      ...
      strcpy(local_150,pcVar4);
      pcVar14 = strchr(local_150,'^');
      if (pcVar14 != (char *)0x0) {
        pcVar15 = pcVar14 + 1;
...
#else
  iVar6 = nocturne_ui_text_width(g_EditorFont,(char *)str_list,nocturne_ui_editor_scale());
#endif
  if (iVar6 < iVar12) {
    iVar6 = iVar12;
  }
