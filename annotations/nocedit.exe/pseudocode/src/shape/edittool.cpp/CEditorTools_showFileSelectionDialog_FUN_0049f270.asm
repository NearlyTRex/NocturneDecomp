...
section .text
    ...
    PUSH EAX                            ; 0049f283
    CALL shape_edittool.cpp_CPickList_ctor_FUN_004a3b90 ; 0049f284 | CPickList * shape_edittool.cpp_CPickList_ctor_FUN_004a3b90(CPickList * this_ptr)
    ...
    PUSH EAX                            ; 0049f2a0
    CALL shape_edittool.cpp_CStrList_populateFromFileSearch_FUN_004a35b0 ; 0049f2a1 | void shape_edittool.cpp_CStrList_populateFromFileSearch_FUN_004a35b0(CStrList * this_ptr, char * directory_path, char * file_pattern)
        ;   XREF to: 004a35b0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0049f2a6
    CMP dword ptr [ESP],0x1             ; 0049f2a9
    JL 0x0049f3d7                       ; 0049f2ad | LAB_0049f3d7
        ;   XREF to: 0049f3d7 (CONDITIONAL_JUMP)
    MOV EAX,ESP                         ; 0049f2b3
    PUSH EAX                            ; 0049f2b5
    CALL shape_edittool.cpp_CStrList_sort_FUN_004a2ec0 ; 0049f2b6 | void shape_edittool.cpp_CStrList_sort_FUN_004a2ec0(CStrList * this_ptr)
    ...
    PUSH EAX                            ; 0049f2e7
    CALL shape_edittool.cpp_CStrList_getFieldAt_FUN_004a2f80 ; 0049f2e8 | void shape_edittool.cpp_CStrList_getFieldAt_FUN_004a2f80(CStrList * this_ptr, int string_index, char * output_buffer, int field_number)
    ...
    PUSH EAX                            ; 0049f2ff
    CALL shape_edittool.cpp_CStrList_getFieldAt_FUN_004a2f80 ; 0049f300 | void shape_edittool.cpp_CStrList_getFieldAt_FUN_004a2f80(CStrList * this_ptr, int string_index, char * output_buffer, int field_number)
        ;   XREF to: 004a2f80 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0049f323
    CALL engine_dosio.c_makePath_FUN_00481f50 ; 0049f324 | void engine_dosio.c_makePath_FUN_00481f50(char * full_path, char * drive, char * directory, char * filename, ...)
        ;   XREF to: 00481f50 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0049f329
    PUSH ESI                            ; 0049f32c
    LEA EAX,[ESP + 0x7ac]               ; 0049f32d
    PUSH EAX                            ; 0049f334
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 0049f335 | int crt_string.c_stricmp_FUN_005fe7f0(char * str1, char * str2)
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0049f33a
    TEST EAX,EAX                        ; 0049f33d
    JNZ 0x0049f3ff                      ; 0049f33f | LAB_0049f3ff
    ...
    PUSH EAX                            ; 0049f356
    CALL shape_edittool.cpp_CPickList_displayChoicesAndWaitForInput_FUN_004a3e20 ; 0049f357 | int shape_edittool.cpp_CPickList_displayChoicesAndWaitForInput_FUN_004a3e20(CPickList * this_ptr, char * dialog_title, int config_param1, int config_param2)
        ;   XREF to: 004a3e20 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 0049f35c
    ADD ESP,0x10                        ; 0049f35e
    TEST EAX,EAX                        ; 0049f361
    JL 0x0049f410                       ; 0049f363 | LAB_0049f410
    ...
    PUSH EAX                            ; 0049f378
    CALL shape_edittool.cpp_CStrList_getFieldAt_FUN_004a2f80 ; 0049f379 | void shape_edittool.cpp_CStrList_getFieldAt_FUN_004a2f80(CStrList * this_ptr, int string_index, char * output_buffer, int field_number)
        ;   XREF to: 004a2f80 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0049f390
    CALL shape_edittool.cpp_CStrList_getFieldAt_FUN_004a2f80 ; 0049f391 | void shape_edittool.cpp_CStrList_getFieldAt_FUN_004a2f80(CStrList * this_ptr, int string_index, char * output_buffer, int field_number)
        ;   XREF to: 004a2f80 (UNCONDITIONAL_CALL)
    ...
    PUSH 0x0                            ; 0049f3ab
    PUSH ESI                            ; 0049f3ad
    CALL engine_dosio.c_makePath_FUN_00481f50 ; 0049f3ae | void engine_dosio.c_makePath_FUN_00481f50(char * full_path, char * drive, char * directory, char * filename, ...)
        ;   XREF to: 00481f50 (UNCONDITIONAL_CALL)
    ...
    CALL shape_edittool.cpp_CPickList_dtor_FUN_004a3c80 ; 0049f3c2 | CPickList * shape_edittool.cpp_CPickList_dtor_FUN_004a3c80(CPickList * this_ptr, uint d1, uint d2, uint d3, ...)
        ;   Label: LAB_0049f3c2
    ...
    POP EBX                             ; 0049f3d5
    RET                                 ; 0049f3d6
    PUSH 0x6230e2                       ; 0049f3d7 | = "No files found" | s_No_files_found_006230e2 = No files found
        ;   Label: LAB_0049f3d7
    CALL support_newmsg.cpp_getLocalizedString_FUN_005441f0 ; 0049f3dc | char * support_newmsg.cpp_getLocalizedString_FUN_005441f0(char * key)
        ;   XREF to: 005441f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0049f3e1
    PUSH EAX                            ; 0049f3e4
    MOV EAX,dword ptr [ESP + 0x8c4]     ; 0049f3e5
    PUSH EAX                            ; 0049f3ec
    CALL shape_edittool.cpp_CEditorTools_showError_FUN_0049e740 ; 0049f3ed | void shape_edittool.cpp_CEditorTools_showError_FUN_0049e740(CEditorTools * this_ptr, char * format)
    ...
    PUSH EAX                            ; 0049f418
    JMP 0x0049f3c2                      ; 0049f419 | LAB_0049f3c2
        ;   XREF to: 0049f3c2 (UNCONDITIONAL_JUMP)
