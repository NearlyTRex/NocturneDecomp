...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl shape_edittool_cpp_CEdCheck_calculateScaledWidth_FUN_004a6b70(CEdCheck *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 004a6b75
    CALL shape_edittool.cpp_CEdCheck_calculateBaseWidth_FUN_004a6bb0 ; 004a6b76
        ;   XREF to: 004a6bb0 (UNCONDITIONAL_CALL)  ; int shape_edittool.cpp_CEdCheck_calculateBaseWidth_FUN_004a6bb0(CEdCheck * this_ptr)
    IMUL EAX,dword ptr [0x00679394]     ; 004a6b7b | g_WindowWidth
    ...
    MOV EBX,dword ptr [0x00679398]      ; 004a6b9a | g_WindowHeight
