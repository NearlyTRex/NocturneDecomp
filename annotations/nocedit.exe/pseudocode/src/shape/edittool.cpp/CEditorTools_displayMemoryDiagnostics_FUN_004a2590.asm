...
section .text
    ...
    MOV EAX,ESP                         ; 004a25ac
        ;   Label: LAB_004a25ac
    PUSH EAX                            ; 004a25ae
    CALL crt_heap.c_heapCheckWrapper_FUN_006012c0 ; 004a25af | int crt_heap.c_heapCheckWrapper_FUN_006012c0(void * heap_state_ptr)
        ;   XREF to: 006012c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004a25b4
    TEST EAX,EAX                        ; 004a25b7
    JZ 0x004a25f5                       ; 004a25b9 | LAB_004a25f5
        ;   XREF to: 004a25f5 (CONDITIONAL_JUMP)
    DEC EAX                             ; 004a25bb
    CMP EAX,0x4                         ; 004a25bc
    JA 0x004a2650                       ; 004a25bf | caseD_3
        ;   XREF to: 004a2650 (CONDITIONAL_JUMP)
    JMP dword ptr [EAX*0x4 + 0x4a257c]  ; 004a25c5 | void * switchdataD_004a257c
        ;   Label: switchD
    MOV ESI,0x6235f5                    ; 004a25cc | = "Heap is empty." | s_Heap_is_empty_006235f5 = Heap is empty.
        ;   Label: caseD_1
    MOV EDI,dword ptr [EBP + 0x18]      ; 004a25d1
        ;   Label: LAB_004a25d1
    PUSH EDI                            ; 004a25d4
    MOV AL,byte ptr [ESI]               ; 004a25d5 | = "Heap is empty." | s_Heap_is_empty_006235f5 = Heap is empty. | s_Memory_corruption_detect_00623604 = Memory corruption detected!
        ;   Label: LAB_004a25d5
    MOV byte ptr [EDI],AL               ; 004a25d7
    CMP AL,0x0                          ; 004a25d9
    JZ 0x004a25ed                       ; 004a25db | LAB_004a25ed
        ;   XREF to: 004a25ed (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 004a25dd | s_eap_is_empty._006235f6
    ADD ESI,0x2                         ; 004a25e0
    MOV byte ptr [EDI + 0x1],AL         ; 004a25e3
    ADD EDI,0x2                         ; 004a25e6
    CMP AL,0x0                          ; 004a25e9
    JNZ 0x004a25d5                      ; 004a25eb | LAB_004a25d5
    ...
    FLD double ptr [0x00623626]         ; 004a261e | double g_BytesToKilobytesScale
    FXCH                                ; 004a2624
    FMUL ST1                            ; 004a2626
    ...
    PUSH EBX                            ; 004a2637
    PUSH 0x6235d2                       ; 004a2638 | = "Blocks: %d Total: %.1fk Max: %.1fk" | s_Blocks_d_Total_1fk_Max_1_006235d2 = Blocks: %d Total: %.1fk Max: %.1fk
    MOV ECX,dword ptr [EBP + 0x18]      ; 004a263d
    PUSH ECX                            ; 004a2640
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 004a2641 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    POP EBX                             ; 004a264e
    RET                                 ; 004a264f
    MOV ESI,0x623604                    ; 004a2650 | = "Memory corruption detected!" | s_Memory_corruption_detect_00623604 = Memory corruption detected!
        ;   Label: caseD_5
    JMP 0x004a25d1                      ; 004a2655 | LAB_004a25d1
