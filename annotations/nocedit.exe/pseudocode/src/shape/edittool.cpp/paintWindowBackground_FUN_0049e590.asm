...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_edittool.cpp_paintWindowBackground_FUN_0049e590(void)
;
; Local Variables:
...
section .text
    ...
    CMP dword ptr [0x02cf1cdc],0x1      ; 0049e597 | int g_WindowStackCount
    JL 0x0049e678                       ; 0049e59e | LAB_0049e678
        ;   XREF to: 0049e678 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x02cf1cdc]      ; 0049e5a4 | int g_WindowStackCount
        ;   Label: LAB_0049e5a4
    DEC EDX                             ; 0049e5aa
    ...
    MOV EDX,0x2cf1ce0                   ; 0049e5b7 | SWindow[5] g_WindowStack
    ...
    JZ 0x0049e670                       ; 0049e5cd | LAB_0049e670
        ;   XREF to: 0049e670 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [0x0067939c]      ; 0049e5d3 | int g_BitsPerPixel
    ...
    JLE 0x0049e670                      ; 0049e600 | LAB_0049e670
        ;   XREF to: 0049e670 (CONDITIONAL_JUMP)
    ...
    MOV EAX,[0x0067939c]                ; 0049e61f | int g_BitsPerPixel
    ...
    MOV EDI,dword ptr [EDI + 0x2cf6a9c] ; 0049e637 | void *[1024] g_ScreenBufferArray
    ...
    JL 0x0049e602                       ; 0049e663 | LAB_0049e602
    ...
    POP EBX                             ; 0049e676
    RET                                 ; 0049e677
    MOV ECX,0x622fbb                    ; 0049e678 | = "..\\shape\\edittool.cpp" | s_shape_edittool_cpp_00622fbb = ..\shape\edittool.cpp
        ;   Label: LAB_0049e678
    MOV EBX,0x36e                       ; 0049e67d
    PUSH 0x622fd1                       ; 0049e682 | = "paintWindowBackground called but no w..." | s_paintWindowBackground_ca_00622fd1 = paintWindowBackground called but no window was opened!
    MOV dword ptr [0x02f0ca48],ECX      ; 0049e687 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 0049e68d | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0049e693 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0049e698
    JMP 0x0049e5a4                      ; 0049e69b | LAB_0049e5a4
