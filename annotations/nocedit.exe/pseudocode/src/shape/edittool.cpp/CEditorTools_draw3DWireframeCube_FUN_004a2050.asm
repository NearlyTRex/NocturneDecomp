...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_edittool.cpp_CEditorTools_draw3DWireframeCube_FUN_004a2050(CEditorTools * this_ptr, CVector3f * corner1, CVector3f * corner2, int color_value)
;
; Parameters:
...
section .text
    ...
    PUSH 0x6598c0                       ; 004a2068 | WatcomTypeInfo g_CVectorTypeInfo
    PUSH 0x8                            ; 004a206d
    LEA EAX,[ESP + 0x8]                 ; 004a206f
    PUSH EAX                            ; 004a2073
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 004a2074 | void * crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
    ...
    JNZ 0x004a24fb                      ; 004a2096 | LAB_004a24fb
    ...
    JZ 0x004a2503                       ; 004a20b3 | LAB_004a2503
    ...
    JL 0x004a24e5                       ; 004a20d5 | LAB_004a24e5
    ...
    MOV [0x02d02570],EAX                ; 004a20ed | int g_ActiveRenderColor
    ...
    FMUL float ptr [0x0065d44c]         ; 004a210d | float g_WorldToScreenScale2
    FISTP dword ptr [EBX]               ; 004a2113
    FLD float ptr [EAX + 0x4]           ; 004a2115
    FMUL float ptr [0x0065d44c]         ; 004a2118 | float g_WorldToScreenScale2
    FISTP dword ptr [EBX + 0x4]         ; 004a211e
    FLD float ptr [EAX + 0x8]           ; 004a2121
    FMUL float ptr [0x0065d44c]         ; 004a2124 | float g_WorldToScreenScale2
    FISTP dword ptr [EBX + 0x8]         ; 004a212a
    LEA EAX,[ESP + 0x84]                ; 004a212d
    PUSH EAX                            ; 004a2134
    PUSH 0x0                            ; 004a2135
    CALL engine_matrix.c_transformToCache_FUN_0050cd70 ; 004a2137 | void engine_matrix.c_transformToCache_FUN_0050cd70(int cacheIndex, CVector3i * inputPoint)
        ;   XREF to: 0050cd70 (UNCONDITIONAL_CALL)
    FLD float ptr [ESI]                 ; 004a213c
    FMUL float ptr [0x006235c6]         ; 004a213e | float g_CubeEdgeScale1
    ADD ESP,0x8                         ; 004a2144
    FSTP float ptr [ESP + 0xa8]         ; 004a2147
    FLD float ptr [ESI + 0x4]           ; 004a214e
    FMUL float ptr [0x006235c6]         ; 004a2151 | float g_CubeEdgeScale1
    FSTP float ptr [ESP + 0xac]         ; 004a2157
    FLD float ptr [ESI + 0x8]           ; 004a215e
    FMUL float ptr [0x006235c6]         ; 004a2161 | float g_CubeEdgeScale1
    FSTP float ptr [ESP + 0xb0]         ; 004a2167
    FLD float ptr [EBP]                 ; 004a216e
    FMUL float ptr [0x006235ca]         ; 004a2171 | float g_CubeEdgeScale2
    FSTP float ptr [ESP + 0xd8]         ; 004a2177
    FLD float ptr [EBP + 0x4]           ; 004a217e
    FMUL float ptr [0x006235ca]         ; 004a2181 | float g_CubeEdgeScale2
    FSTP float ptr [ESP + 0xdc]         ; 004a2187
    FLD float ptr [EBP + 0x8]           ; 004a218e
    FMUL float ptr [0x006235ca]         ; 004a2191 | float g_CubeEdgeScale2
    ...
    FMUL float ptr [0x0065d44c]         ; 004a21ec | float g_WorldToScreenScale2
    FISTP dword ptr [EBX]               ; 004a21f2
    FLD float ptr [EAX + 0x4]           ; 004a21f4
    FMUL float ptr [0x0065d44c]         ; 004a21f7 | float g_WorldToScreenScale2
    FISTP dword ptr [EBX + 0x4]         ; 004a21fd
    FLD float ptr [EAX + 0x8]           ; 004a2200
    FMUL float ptr [0x0065d44c]         ; 004a2203 | float g_WorldToScreenScale2
    FISTP dword ptr [EBX + 0x8]         ; 004a2209
    LEA EAX,[ESP + 0x84]                ; 004a220c
    PUSH EAX                            ; 004a2213
    PUSH 0x1                            ; 004a2214
    CALL engine_matrix.c_transformToCache_FUN_0050cd70 ; 004a2216 | void engine_matrix.c_transformToCache_FUN_0050cd70(int cacheIndex, CVector3i * inputPoint)
        ;   XREF to: 0050cd70 (UNCONDITIONAL_CALL)
    ...
    MOVSD.REP ES:EDI,ESI                ; 004a222d | DAT_00688044
    SUB ESP,0x30                        ; 004a222f
    MOV ECX,0xc                         ; 004a2232
    MOV ESI,0x688014                    ; 004a2237 | SRenderVertex[16] g_RenderVertexBuffer
    MOV EDI,ESP                         ; 004a223c
    MOVSD.REP ES:EDI,ESI                ; 004a223e | SRenderVertex[16] g_RenderVertexBuffer
    CALL engine_3d.c_clipAndDrawLine2D_FUN_00407d70 ; 004a2240 | void engine_3d.c_clipAndDrawLine2D_FUN_00407d70(SRenderVertex * vertex1, SRenderVertex * vertex2)
    ...
    FMUL float ptr [0x0065d44c]         ; 004a2262 | float g_WorldToScreenScale2
    FISTP dword ptr [EBX]               ; 004a2268
    FLD float ptr [EAX + 0x4]           ; 004a226a
    FMUL float ptr [0x0065d44c]         ; 004a226d | float g_WorldToScreenScale2
    FISTP dword ptr [EBX + 0x4]         ; 004a2273
    FLD float ptr [EAX + 0x8]           ; 004a2276
    FMUL float ptr [0x0065d44c]         ; 004a2279 | float g_WorldToScreenScale2
    FISTP dword ptr [EBX + 0x8]         ; 004a227f
    LEA EAX,[ESP + 0x60]                ; 004a2282
    PUSH EAX                            ; 004a2286
    PUSH 0x0                            ; 004a2287
    CALL engine_matrix.c_transformToCache_FUN_0050cd70 ; 004a2289 | void engine_matrix.c_transformToCache_FUN_0050cd70(int cacheIndex, CVector3i * inputPoint)
        ;   XREF to: 0050cd70 (UNCONDITIONAL_CALL)
    FLD float ptr [ESI]                 ; 004a228e
    FMUL float ptr [0x006235c6]         ; 004a2290 | float g_CubeEdgeScale1
    ADD ESP,0x8                         ; 004a2296
    FSTP float ptr [ESP + 0x78]         ; 004a2299
    FLD float ptr [ESI + 0x4]           ; 004a229d
    FMUL float ptr [0x006235c6]         ; 004a22a0 | float g_CubeEdgeScale1
    FSTP float ptr [ESP + 0x7c]         ; 004a22a6
    FLD float ptr [ESI + 0x8]           ; 004a22aa
    FMUL float ptr [0x006235c6]         ; 004a22ad | float g_CubeEdgeScale1
    FSTP float ptr [ESP + 0x80]         ; 004a22b3
    FLD float ptr [EBP]                 ; 004a22ba
    FMUL float ptr [0x006235ca]         ; 004a22bd | float g_CubeEdgeScale2
    FSTP float ptr [ESP + 0x9c]         ; 004a22c3
    FLD float ptr [EBP + 0x4]           ; 004a22ca
    FMUL float ptr [0x006235ca]         ; 004a22cd | float g_CubeEdgeScale2
    FSTP float ptr [ESP + 0xa0]         ; 004a22d3
    FLD float ptr [EBP + 0x8]           ; 004a22da
    FMUL float ptr [0x006235ca]         ; 004a22dd | float g_CubeEdgeScale2
    ...
    FMUL float ptr [0x0065d44c]         ; 004a232f | float g_WorldToScreenScale2
    FISTP dword ptr [EBX]               ; 004a2335
    FLD float ptr [EAX + 0x4]           ; 004a2337
    FMUL float ptr [0x0065d44c]         ; 004a233a | float g_WorldToScreenScale2
    FISTP dword ptr [EBX + 0x4]         ; 004a2340
    FLD float ptr [EAX + 0x8]           ; 004a2343
    FMUL float ptr [0x0065d44c]         ; 004a2346 | float g_WorldToScreenScale2
    FISTP dword ptr [EBX + 0x8]         ; 004a234c
    LEA EAX,[ESP + 0x60]                ; 004a234f
    PUSH EAX                            ; 004a2353
    PUSH 0x1                            ; 004a2354
    CALL engine_matrix.c_transformToCache_FUN_0050cd70 ; 004a2356 | void engine_matrix.c_transformToCache_FUN_0050cd70(int cacheIndex, CVector3i * inputPoint)
        ;   XREF to: 0050cd70 (UNCONDITIONAL_CALL)
    ...
    MOVSD.REP ES:EDI,ESI                ; 004a236d | DAT_00688044
    SUB ESP,0x30                        ; 004a236f
    MOV ECX,0xc                         ; 004a2372
    MOV ESI,0x688014                    ; 004a2377 | SRenderVertex[16] g_RenderVertexBuffer
    MOV EDI,ESP                         ; 004a237c
    MOVSD.REP ES:EDI,ESI                ; 004a237e | SRenderVertex[16] g_RenderVertexBuffer
    CALL engine_3d.c_clipAndDrawLine2D_FUN_00407d70 ; 004a2380 | void engine_3d.c_clipAndDrawLine2D_FUN_00407d70(SRenderVertex * vertex1, SRenderVertex * vertex2)
        ;   XREF to: 00407d70 (UNCONDITIONAL_CALL)
    ...
    FMUL float ptr [0x0065d44c]         ; 004a23a3 | float g_WorldToScreenScale2
    FISTP dword ptr [EBX]               ; 004a23a9
    FLD float ptr [EAX + 0x4]           ; 004a23ab
    FMUL float ptr [0x0065d44c]         ; 004a23ae | float g_WorldToScreenScale2
    FISTP dword ptr [EBX + 0x4]         ; 004a23b4
    FLD float ptr [EAX + 0x8]           ; 004a23b7
    FMUL float ptr [0x0065d44c]         ; 004a23ba | float g_WorldToScreenScale2
    FISTP dword ptr [EBX + 0x8]         ; 004a23c0
    LEA EAX,[ESP + 0xc0]                ; 004a23c3
    PUSH EAX                            ; 004a23ca
    PUSH 0x0                            ; 004a23cb
    CALL engine_matrix.c_transformToCache_FUN_0050cd70 ; 004a23cd | void engine_matrix.c_transformToCache_FUN_0050cd70(int cacheIndex, CVector3i * inputPoint)
        ;   XREF to: 0050cd70 (UNCONDITIONAL_CALL)
    FLD float ptr [0x006235c6]          ; 004a23d2 | float g_CubeEdgeScale1
    ...
    FLD float ptr [0x006235ca]          ; 004a23fc | float g_CubeEdgeScale2
    ...
    FMUL float ptr [0x0065d44c]         ; 004a2463 | float g_WorldToScreenScale2
    FISTP dword ptr [EBX]               ; 004a2469
    FLD float ptr [EAX + 0x4]           ; 004a246b
    FMUL float ptr [0x0065d44c]         ; 004a246e | float g_WorldToScreenScale2
    FISTP dword ptr [EBX + 0x4]         ; 004a2474
    FLD float ptr [EAX + 0x8]           ; 004a2477
    FMUL float ptr [0x0065d44c]         ; 004a247a | float g_WorldToScreenScale2
    FISTP dword ptr [EBX + 0x8]         ; 004a2480
    LEA EAX,[ESP + 0xc0]                ; 004a2483
    PUSH EAX                            ; 004a248a
    PUSH 0x1                            ; 004a248b
    CALL engine_matrix.c_transformToCache_FUN_0050cd70 ; 004a248d | void engine_matrix.c_transformToCache_FUN_0050cd70(int cacheIndex, CVector3i * inputPoint)
        ;   XREF to: 0050cd70 (UNCONDITIONAL_CALL)
    ...
    MOVSD.REP ES:EDI,ESI                ; 004a24a4 | DAT_00688044
    SUB ESP,0x30                        ; 004a24a6
    MOV ECX,0xc                         ; 004a24a9
    MOV ESI,0x688014                    ; 004a24ae | SRenderVertex[16] g_RenderVertexBuffer
    MOV EDI,ESP                         ; 004a24b3
    MOVSD.REP ES:EDI,ESI                ; 004a24b5 | SRenderVertex[16] g_RenderVertexBuffer
    CALL engine_3d.c_clipAndDrawLine2D_FUN_00407d70 ; 004a24b7 | void engine_3d.c_clipAndDrawLine2D_FUN_00407d70(SRenderVertex * vertex1, SRenderVertex * vertex2)
        ;   XREF to: 00407d70 (UNCONDITIONAL_CALL)
    ...
    JL 0x004a20f2                       ; 004a24d4 | LAB_004a20f2
