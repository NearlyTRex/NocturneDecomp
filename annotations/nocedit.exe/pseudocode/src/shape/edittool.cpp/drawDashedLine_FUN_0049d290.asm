...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_edittool.cpp_drawDashedLine_FUN_0049d290(int x1, int y1, int x2, int y2, int dash_length)
;
; Parameters:
; int              Stack[0x4]:4   x1
; int              Stack[0x8]:4   y1
...
section .text
    ...
    JGE 0x0049d2fc                      ; 0049d2ce | LAB_0049d2fc
    ...
    JGE 0x0049d2f2                      ; 0049d2e6 | LAB_0049d2f2
        ;   XREF to: 0049d2f2 (CONDITIONAL_JUMP)
    PUSH EBP                            ; 0049d2e8
    PUSH EDI                            ; 0049d2e9
    CALL engine_2d.c_plotPixel_FUN_00401140 ; 0049d2ea | void engine_2d.c_plotPixel_FUN_00401140(int x, int y)
    ...
    JGE 0x0049d32c                      ; 0049d31c | LAB_0049d32c
        ;   XREF to: 0049d32c (CONDITIONAL_JUMP)
    PUSH EDI                            ; 0049d31e
    MOV EAX,dword ptr [ESP + 0x30]      ; 0049d31f
    PUSH EAX                            ; 0049d323
    CALL engine_2d.c_plotPixel_FUN_00401140 ; 0049d324 | void engine_2d.c_plotPixel_FUN_00401140(int x, int y)
        ;   XREF to: 00401140 (UNCONDITIONAL_CALL)
    ...
    JL 0x0049d30d                       ; 0049d334 | LAB_0049d30d
    ...
    JLE 0x0049d370                      ; 0049d340 | LAB_0049d370
    ...
    JGE 0x0049d366                      ; 0049d356 | LAB_0049d366
        ;   XREF to: 0049d366 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x30]      ; 0049d358
    PUSH EAX                            ; 0049d35c
    PUSH EDI                            ; 0049d35d
    CALL engine_2d.c_plotPixel_FUN_00401140 ; 0049d35e | void engine_2d.c_plotPixel_FUN_00401140(int x, int y)
        ;   XREF to: 00401140 (UNCONDITIONAL_CALL)
    ...
    JL 0x0049d3ab                       ; 0049d38e | LAB_0049d3ab
        ;   XREF to: 0049d3ab (CONDITIONAL_JUMP)
    DEC EDI                             ; 0049d390
    INC EBX                             ; 0049d391
    CMP EDI,EBP                         ; 0049d392
    JG 0x0049d37f                       ; 0049d394 | LAB_0049d37f
    ...
    JMP 0x0049d2af                      ; 0049d3a6 | LAB_0049d2af
        ;   XREF to: 0049d2af (UNCONDITIONAL_JUMP)
    PUSH EDI                            ; 0049d3ab
        ;   Label: LAB_0049d3ab
    MOV EAX,dword ptr [ESP + 0x28]      ; 0049d3ac
    PUSH EAX                            ; 0049d3b0
    CALL engine_2d.c_plotPixel_FUN_00401140 ; 0049d3b1 | void engine_2d.c_plotPixel_FUN_00401140(int x, int y)
        ;   XREF to: 00401140 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0049d3b6
    DEC EDI                             ; 0049d3b9
    INC EBX                             ; 0049d3ba
    CMP EDI,EBP                         ; 0049d3bb
    JG 0x0049d37f                       ; 0049d3bd | LAB_0049d37f
        ;   XREF to: 0049d37f (CONDITIONAL_JUMP)
