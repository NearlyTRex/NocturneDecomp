...
section .text
    ...
    MOV ESI,0x623fa1                    ; 004a6a70 | s_EmptyChar_00623fa1
    ...
    PUSH EDI                            ; 004a6a86
    MOV AL,byte ptr [ESI]               ; 004a6a87 | s_EmptyChar_00623fa1 | s_ElephantGun_00623fa3
        ;   Label: LAB_004a6a87
    ...
    CALL engine_font.cpp_CBitFont_getCharHeight_FUN_004d01d0 ; 004a6abd
    ...
    CALL engine_font.cpp_CBitFont_getTextHeight_FUN_004cff40 ; 004a6ad5
