...
;                               FUNCTION
; *****************************************************************************
; __cdecl void shape_edittool.cpp_CStrList_clear_FUN_004a2b10(CStrList * this_ptr)
;
; Parameters:
...
section .text
    ...
    JZ 0x004a2b68                       ; 004a2b1a | LAB_004a2b68
    ...
    JLE 0x004a2b50                      ; 004a2b24 | LAB_004a2b50
    ...
    JZ 0x004a2b46                       ; 004a2b31 | LAB_004a2b46
        ;   XREF to: 004a2b46 (CONDITIONAL_JUMP)
    PUSH 0xb0b                          ; 004a2b33
    PUSH 0x623676                       ; 004a2b38 | = "..\\shape\\edittool.cpp" | s_shape_edittool_cpp_00623676 = ..\shape\edittool.cpp
    PUSH EDX                            ; 004a2b3d
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 004a2b3e | void shape_memdbg.cpp_debugFree_FUN_0050f460(void * ptr, char * filename, int line_number)
    ...
    JL 0x004a2b28                       ; 004a2b4e | LAB_004a2b28
        ;   XREF to: 004a2b28 (CONDITIONAL_JUMP)
    PUSH 0xb0d                          ; 004a2b50
        ;   Label: LAB_004a2b50
    PUSH 0x62368c                       ; 004a2b55 | = "..\\shape\\edittool.cpp" | s_shape_edittool_cpp_0062368c = ..\shape\edittool.cpp
    MOV EAX,dword ptr [EDI + 0x8]       ; 004a2b5a
    PUSH EAX                            ; 004a2b5d
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 004a2b5e | void shape_memdbg.cpp_debugFree_FUN_0050f460(void * ptr, char * filename, int line_number)
        ;   XREF to: 0050f460 (UNCONDITIONAL_CALL)
