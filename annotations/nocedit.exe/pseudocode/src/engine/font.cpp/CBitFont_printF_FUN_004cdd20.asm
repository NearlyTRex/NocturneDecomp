...
;
; Called Functions:
;   engine_font.cpp_CBitFont_printFV_FUN_004cdd70
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 004cdd20
        ;   Label: engine_font.cpp_CBitFont_printF_FUN_004cdd20
    PUSH ESI                            ; 004cdd21
    PUSH EDI                            ; 004cdd22
    PUSH EBP                            ; 004cdd23
    ...
    PUSH EBP                            ; 004cdd4e
    CALL engine_font.cpp_CBitFont_printFV_FUN_004cdd70 ; 004cdd4f
        ;   XREF to: 004cdd70 (UNCONDITIONAL_CALL)  ; void engine_font.cpp_CBitFont_printFV_FUN_004cdd70(CBitFont * this_ptr, int x, int y, int color_mode, ...)
