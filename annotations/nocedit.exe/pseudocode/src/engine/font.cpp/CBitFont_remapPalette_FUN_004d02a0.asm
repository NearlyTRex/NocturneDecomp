...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_font.cpp_CBitFont_remapPalette_FUN_004d02a0(CBitFont * this_ptr)
;
; Parameters:
...
section .text
    ...
    JLE 0x004d0377                      ; 004d02b5 | LAB_004d0377
    ...
    MOV EAX,[0x0067939c]                ; 004d02e8 | int g_BitsPerPixel
        ;   Label: LAB_004d02e8
    ...
    JNC 0x004d0440                      ; 004d0306 | LAB_004d0440
        ;   XREF to: 004d0440 (CONDITIONAL_JUMP)
    CMP EAX,0x8                         ; 004d030c
    JNZ 0x004d044b                      ; 004d030f | LAB_004d044b
    ...
    JNZ 0x004d02e8                      ; 004d0334 | LAB_004d02e8
    ...
    JL 0x004d02d0                       ; 004d0371 | LAB_004d02d0
    ...
    JMP 0x004d0315                      ; 004d03ef | LAB_004d0315
        ;   XREF to: 004d0315 (UNCONDITIONAL_JUMP)
    CMP EAX,EAX                         ; 004d03f4
        ;   Label: LAB_004d03f4
    JNZ 0x004d0425                      ; 004d03f6 | LAB_004d0425
        ;   XREF to: 004d0425 (CONDITIONAL_JUMP)
    MOV CL,byte ptr [0x02d01f24]        ; 004d03f8 | int g_RedBitPosition
    SHL ESI,CL                          ; 004d03fe
    MOV CL,byte ptr [0x02d01f30]        ; 004d0400 | int g_GreenBitPosition
    SHL EDI,CL                          ; 004d0406
    MOV CL,byte ptr [0x02d01f3c]        ; 004d0408 | int g_BlueBitPosition
    SHL EBX,CL                          ; 004d040e
    OR ESI,EDI                          ; 004d0410
    ...
    JMP 0x004d0315                      ; 004d0420 | LAB_004d0315
        ;   XREF to: 004d0315 (UNCONDITIONAL_JUMP)
    ...
    JMP 0x004d0315                      ; 004d043b | LAB_004d0315
        ;   XREF to: 004d0315 (UNCONDITIONAL_JUMP)
    JBE 0x004d037f                      ; 004d0440 | LAB_004d037f
        ;   Label: LAB_004d0440
        ;   XREF to: 004d037f (CONDITIONAL_JUMP)
    CMP EAX,0x20                        ; 004d0446
    JZ 0x004d03f4                       ; 004d0449 | LAB_004d03f4
        ;   XREF to: 004d03f4 (CONDITIONAL_JUMP)
    MOV EAX,0x62a721                    ; 004d044b | = "..\\engine\\font.cpp" | s_engine_font_cpp_0062a721 = ..\engine\font.cpp
        ;   Label: LAB_004d044b
    MOV EDX,0x686                       ; 004d0450
    PUSH 0x62a734                       ; 004d0455 | = "CBitFont::remapPalette - Invalid bits..." | s_CBitFont_remapPalette_In_0062a734 = CBitFont::remapPalette - Invalid bitsPerPixel
    MOV [0x02f0ca48],EAX                ; 004d045a | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 004d045f | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004d0465 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004d046a
    JMP 0x004d0315                      ; 004d046d | LAB_004d0315
        ;   XREF to: 004d0315 (UNCONDITIONAL_JUMP)
