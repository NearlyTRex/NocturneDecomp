...
;                               FUNCTION
; *****************************************************************************
; __cdecl int engine_font.cpp_CBitFont_getCharWidth_FUN_004cff40(CBitFont * this_ptr, char * text_string)
;
; Parameters:
...
section .text
    ...
    MOV AL,byte ptr [ESI]               ; 004cff84
        ;   Label: LAB_004cff84
    CMP AL,DL                           ; 004cff86
    JZ 0x004cff9c                       ; 004cff88 | LAB_004cff9c
        ;   XREF to: 004cff9c (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 004cff8a
    JZ 0x004cff9a                       ; 004cff8c | LAB_004cff9a
        ;   XREF to: 004cff9a (CONDITIONAL_JUMP)
    INC ESI                             ; 004cff8e
    MOV AL,byte ptr [ESI]               ; 004cff8f
    CMP AL,DL                           ; 004cff91
    JZ 0x004cff9c                       ; 004cff93 | LAB_004cff9c
        ;   XREF to: 004cff9c (CONDITIONAL_JUMP)
    INC ESI                             ; 004cff95
    CMP AL,0x0                          ; 004cff96
    JNZ 0x004cff84                      ; 004cff98 | LAB_004cff84
    ...
    JNZ 0x004cff73                      ; 004cffa0 | LAB_004cff73
    ...
    MOV AL,byte ptr [ESI]               ; 004cffac
        ;   Label: LAB_004cffac
    CMP AL,DL                           ; 004cffae
    JZ 0x004cffc4                       ; 004cffb0 | LAB_004cffc4
        ;   XREF to: 004cffc4 (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 004cffb2
    JZ 0x004cffc2                       ; 004cffb4 | LAB_004cffc2
        ;   XREF to: 004cffc2 (CONDITIONAL_JUMP)
    INC ESI                             ; 004cffb6
    MOV AL,byte ptr [ESI]               ; 004cffb7
    CMP AL,DL                           ; 004cffb9
    JZ 0x004cffc4                       ; 004cffbb | LAB_004cffc4
        ;   XREF to: 004cffc4 (CONDITIONAL_JUMP)
    INC ESI                             ; 004cffbd
    CMP AL,0x0                          ; 004cffbe
    JNZ 0x004cffac                      ; 004cffc0 | LAB_004cffac
        ;   XREF to: 004cffac (CONDITIONAL_JUMP)
    SUB ESI,ESI                         ; 004cffc2
        ;   Label: LAB_004cffc2
    TEST ESI,ESI                        ; 004cffc4
        ;   Label: LAB_004cffc4
    JNZ 0x004cff54                      ; 004cffc6 | LAB_004cff54
    ...
    PUSH EAX                            ; 004cffe0
    PUSH EDI                            ; 004cffe1
    CALL engine_font.cpp_CBitFont_getCharWidth_FUN_004d01d0 ; 004cffe2 | int engine_font.cpp_CBitFont_getCharWidth_FUN_004d01d0(CBitFont * this_ptr, int char_code)
        ;   XREF to: 004d01d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004cffe7
    CMP EAX,ESI                         ; 004cffea
    JLE 0x004cfffe                      ; 004cffec | LAB_004cfffe
        ;   XREF to: 004cfffe (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 004cffee
    MOV AL,byte ptr [EBX]               ; 004cfff0
    PUSH EAX                            ; 004cfff2
    PUSH EDI                            ; 004cfff3
    CALL engine_font.cpp_CBitFont_getCharWidth_FUN_004d01d0 ; 004cfff4 | int engine_font.cpp_CBitFont_getCharWidth_FUN_004d01d0(CBitFont * this_ptr, int char_code)
        ;   XREF to: 004d01d0 (UNCONDITIONAL_CALL)
    ...
    INC EBX                             ; 004d0001
    TEST DL,DL                          ; 004d0002
    JNZ 0x004cff60                      ; 004d0004 | LAB_004cff60
