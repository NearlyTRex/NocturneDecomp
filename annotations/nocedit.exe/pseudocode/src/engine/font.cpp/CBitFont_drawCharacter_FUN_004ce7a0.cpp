  ...
  if (g_BitsPerPixel == 8) {
    if (color_mode == -1) {
      ...
      if (y <= local_cc) {
        iVar11 = y * 4;
        do {
          puVar8 = (uchar *)(*(int *)((int)g_ScreenBufferArray + iVar11) + x);
      ...
      if (y <= local_cc) {
        iVar11 = y * 4;
        do {
          puVar9 = (byte *)(*(int *)((int)g_ScreenBufferArray + iVar11) + x);
          for (iVar1 = x; iVar1 <= local_d0; iVar1 = iVar1 + 1) {
            if ((uint)*local_d4 != this_ptr->load_flags) {
      ...
      if (y <= local_cc) {
        iVar11 = y * 4;
        do {
          puVar2 = (byte *)(*(int *)((int)g_ScreenBufferArray + iVar11) + x);
          for (iVar1 = x; iVar1 <= local_d0; iVar1 = iVar1 + 1) {
            if ((uint)*local_d4 != this_ptr->load_flags) {
    ...
    if (g_BitsPerPixel == 0x10) {
      if (color_mode == -1) {
        if (this_ptr->is_initialized == 0) {
          if (y <= local_cc) {
            iVar11 = y * 4;
            do {
              puVar5 = (ushort *)(*(int *)((int)g_ScreenBufferArray + iVar11) + x * 2);
              for (iVar1 = x; iVar1 <= local_d0; iVar1 = iVar1 + 1) {
                if ((uint)*local_d4 != this_ptr->load_flags) {
        ...
        if (this_ptr->is_initialized == 0) {
          if (y <= local_cc) {
            iVar11 = y * 4;
            do {
              puVar10 = (ushort *)(*(int *)((int)g_ScreenBufferArray + iVar11) + x * 2);
              for (iVar1 = x; iVar1 <= local_d0; iVar1 = iVar1 + 1) {
                if ((uint)*local_d4 != this_ptr->load_flags) {
          ...
          if (y <= local_cc) {
            local_2c = y << 2;
            do {
              puVar10 = (ushort *)(x * 2 + *(int *)((int)g_ScreenBufferArray + local_2c));
              for (iVar11 = x; iVar11 <= local_d0; iVar11 = iVar11 + 1) {
                iVar1 = g_CurrentAlphaValue *
        ...
        if (this_ptr->is_initialized == 0) {
          if (y <= local_cc) {
            iVar11 = y * 4;
            do {
              puVar7 = (ushort *)(x * 2 + *(int *)((int)g_ScreenBufferArray + iVar11));
              for (iVar1 = x; iVar1 <= local_d0; iVar1 = iVar1 + 1) {
                if ((uint)*local_d4 != this_ptr->load_flags) {
          ...
          if (y <= local_cc) {
            local_30 = y << 2;
            do {
              puVar10 = (ushort *)(*(int *)((int)g_ScreenBufferArray + local_30) + x * 2);
              for (iVar11 = x; iVar11 <= local_d0; iVar11 = iVar11 + 1) {
                iVar1 = g_CurrentAlphaValue *
                        (uint)(byte)this_ptr->palette_data[(uint)*local_d4 * 3 + local_c8 * 0x300];
                iVar4 = iVar1 >> 0x1f;
        ...
        if (this_ptr->is_initialized == 0) {
          for (; y <= local_cc; y = y + 1) {
            puVar10 = (ushort *)(x * 2 + *(int *)((int)g_ScreenBufferArray + iVar11));
            for (iVar1 = x; iVar1 <= local_d0; iVar1 = iVar1 + 1) {
              if ((uint)*local_d4 != this_ptr->load_flags) {
                *puVar10 = uVar1;
              }
          ...
          if (y <= local_cc) {
            local_34 = y << 2;
            do {
              puVar10 = (ushort *)(*(int *)((int)g_ScreenBufferArray + local_34) + x * 2);
              for (iVar11 = x; iVar11 <= local_d0; iVar11 = iVar11 + 1) {
                iVar1 = g_CurrentAlphaValue *
                        (uint)(byte)this_ptr->palette_data[(uint)*local_d4 * 3 + local_c8 * 0x300];
                iVar4 = iVar1 >> 0x1f;
      ...
      if (color_mode == -1) {
        if (this_ptr->is_initialized == 0) {
          for (; y <= local_cc; y = y + 1) {
            puVar12 = (uint *)(*(int *)((int)g_ScreenBufferArray + iVar11) + x * 4);
            for (iVar1 = x; iVar1 <= local_d0; iVar1 = iVar1 + 1) {
              if ((uint)*local_d4 != this_ptr->load_flags) {
          ...
          if (y <= local_cc) {
            do {
              engine_font_cpp_drawAlphaBlendedPixels_FUN_004ce240
                        ((uint *)(*(int *)((int)g_ScreenBufferArray + iVar11) + x * 4),local_d4,
        ...
        if (this_ptr->is_initialized == 0) {
          for (; y <= local_cc; y = y + 1) {
            piVar6 = (int *)(x * 4 + *(int *)((int)g_ScreenBufferArray + iVar11));
            for (iVar1 = x; iVar1 <= local_d0; iVar1 = iVar1 + 1) {
              if ((uint)*local_d4 != this_ptr->load_flags) {
          ...
          if (y <= local_cc) {
            do {
              engine_font_cpp_drawAlphaBlendedPixels_FUN_004ce240
                        ((uint *)(x * 4 + *(int *)((int)g_ScreenBufferArray + iVar11)),local_d4,
        ...
        if (this_ptr->is_initialized == 0) {
          for (; y <= local_cc; y = y + 1) {
            piVar8 = (int *)(x * 4 + *(int *)((int)g_ScreenBufferArray + iVar11));
            for (iVar1 = x; iVar1 <= local_d0; iVar1 = iVar1 + 1) {
              if ((uint)*local_d4 != this_ptr->load_flags) {
        ...
        if (this_ptr->is_initialized == 0) {
          for (; y <= local_cc; y = y + 1) {
            puVar3 = (uint *)(*(int *)((int)g_ScreenBufferArray + iVar11) + x * 4);
            for (iVar1 = x; iVar1 <= local_d0; iVar1 = iVar1 + 1) {
              if ((uint)*local_d4 != this_ptr->load_flags) {
                *puVar3 = uVar5;
              }
