...
section .text
    ...
    PUSH 0x62a582                       ; 004cd2d0 | = "rt" | s_rt_0062a582 = rt
    MOV EDX,dword ptr [ESP + 0x238]     ; 004cd2d5
    PUSH EDX                            ; 004cd2dc
    PUSH 0x62a585                       ; 004cd2dd | = "art" | s_art_0062a585 = art
    CALL engine_dosio.c_getFile_FUN_00481a50 ; 004cd2e2 | FILE * engine_dosio.c_getFile_FUN_00481a50(char * directory, char * filename, char * mode)
        ;   XREF to: 00481a50 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 004cd2e7
    ADD ESP,0xc                         ; 004cd2e9
    TEST EAX,EAX                        ; 004cd2ec
    JNZ 0x004cd2fa                      ; 004cd2ee | LAB_004cd2fa
    ...
    PUSH EAX                            ; 004cd308
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 004cd309 | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
    ...
    PUSH EBX                            ; 004cd31b
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004cd31c | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
    ...
    PUSH EAX                            ; 004cd331
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 004cd332 | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    PUSH EBX                            ; 004cd34f
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004cd350 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 004cd365
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 004cd366 | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    PUSH EBX                            ; 004cd383
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004cd384 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 004cd399
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 004cd39a | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    PUSH EBX                            ; 004cd3af
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004cd3b0 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 004cd3c5
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 004cd3c6 | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    PUSH EBX                            ; 004cd3db
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004cd3dc | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 004cd3f1
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 004cd3f2 | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    PUSH EBX                            ; 004cd40f
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004cd410 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004cd415
    PUSH 0x159                          ; 004cd418
    PUSH 0x62a5aa                       ; 004cd41d | = "..\\engine\\font.cpp" | s_engine_font_cpp_0062a5aa = ..\engine\font.cpp
    PUSH EBX                            ; 004cd422
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 004cd423 | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
        ;   XREF to: 0050f9b0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004cd428
    CMP dword ptr [ESP + 0x20c],0x20    ; 004cd42b
    JZ 0x004cd49d                       ; 004cd433 | LAB_004cd49d
    ...
    PUSH EAX                            ; 004cd461
    PUSH ESI                            ; 004cd462
    CALL engine_font.cpp_CBitFont_loadNewBitmap_FUN_004cd280 ; 004cd463 | void engine_font.cpp_CBitFont_loadNewBitmap_FUN_004cd280(CBitFont * this_ptr, char * filename, int width, int height, ...)
    ...
    CMP dword ptr [ESP + 0x210],0xff    ; 004cd49d
        ;   Label: LAB_004cd49d
    JNZ 0x004cd435                      ; 004cd4a8 | LAB_004cd435
    ...
    PUSH EAX                            ; 004cd4c6
    PUSH ESI                            ; 004cd4c7
    CALL engine_font.cpp_CBitFont_openFontFile_FUN_004ccfc0 ; 004cd4c8 | void engine_font.cpp_CBitFont_openFontFile_FUN_004ccfc0(CBitFont * this_ptr, char * filename, int width, int height, ...)
        ;   XREF to: 004ccfc0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 004cd4cd
    JMP 0x004cd46b                      ; 004cd4d0 | LAB_004cd46b
