...
;                               FUNCTION
; *****************************************************************************
; int __cdecl engine_font_cpp_CBitFont_drawTextF_FUN_004cdc20(CBitFont *this_ptr,int x,int y,int color_mode,int color_value,char *format_string,... )
;
; Parameters:
...
;
; Called Functions:
;   engine_font.cpp_CBitFont_drawTextFV_FUN_004cdc70
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 004cdc20
        ;   Label: engine_font.cpp_CBitFont_drawTextF_FUN_004cdc20
    PUSH ESI                            ; 004cdc21
    PUSH EDI                            ; 004cdc22
    PUSH EBP                            ; 004cdc23
    ...
    PUSH EBP                            ; 004cdc4e
    CALL engine_font.cpp_CBitFont_drawTextFV_FUN_004cdc70 ; 004cdc4f
        ;   XREF to: 004cdc70 (UNCONDITIONAL_CALL)  ; int engine_font.cpp_CBitFont_drawTextFV_FUN_004cdc70(CBitFont * this_ptr, int x_pos, int y_pos, int color_mode, ...)
