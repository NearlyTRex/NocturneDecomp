...
;                               FUNCTION
; *****************************************************************************
; __cdecl CBitFont * engine_font.cpp_CBitFont_ctor_FUN_004cce90(CBitFont * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004cce95
    CALL engine_font.cpp_CBitFont_reset_FUN_004cced0 ; 004cce96 | void engine_font.cpp_CBitFont_reset_FUN_004cced0(CBitFont * this_ptr)
