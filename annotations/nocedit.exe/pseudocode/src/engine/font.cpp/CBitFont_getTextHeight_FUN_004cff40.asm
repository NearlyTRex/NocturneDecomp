...
section .text
    ...
    PUSH EBX                            ; 004cff40
        ;   Label: engine_font.cpp_CBitFont_getTextHeight_FUN_004cff40
    PUSH ESI                            ; 004cff41
    PUSH EDI                            ; 004cff42
    ...
    PUSH EAX                            ; 004cffe0
    PUSH EDI                            ; 004cffe1
    CALL engine_font.cpp_CBitFont_getCharHeight_FUN_004d01d0 ; 004cffe2
    ...
    PUSH EAX                            ; 004cfff2
    PUSH EDI                            ; 004cfff3
    CALL engine_font.cpp_CBitFont_getCharHeight_FUN_004d01d0 ; 004cfff4
        ;   XREF to: 004d01d0 (UNCONDITIONAL_CALL)  ; int engine_font.cpp_CBitFont_getCharHeight_FUN_004d01d0(CBitFont * this_ptr, int char_code)
