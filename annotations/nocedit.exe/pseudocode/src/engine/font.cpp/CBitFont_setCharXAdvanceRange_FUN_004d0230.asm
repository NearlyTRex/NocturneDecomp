...
section .text
    ...
    JLE 0x004d0269                      ; 004d0275 | LAB_004d0269
    ...
    XOR EAX,EAX                         ; 004d0282
        ;   Label: LAB_004d0282
    JMP 0x004d024b                      ; 004d0284 | LAB_004d024b
