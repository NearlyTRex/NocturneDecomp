...
;                               FUNCTION
; *****************************************************************************
; __cdecl int engine_font.cpp_CBitFont_drawCharacter_FUN_004ce7a0(CBitFont * this_ptr, int character_code, int x_pos, int y_pos, int color_mode, int color_value)
;
; Parameters:
...
section .text
    ...
    JL 0x004ce9b0                       ; 004ce7c1 | LAB_004ce9b0
        ;   XREF to: 004ce9b0 (CONDITIONAL_JUMP)
    CMP EDI,0x100                       ; 004ce7c7
    JGE 0x004ce9b0                      ; 004ce7cd | LAB_004ce9b0
        ;   XREF to: 004ce9b0 (CONDITIONAL_JUMP)
    ...
    JZ 0x004ce9bf                       ; 004ce7ec | LAB_004ce9bf
        ;   XREF to: 004ce9bf (CONDITIONAL_JUMP)
    CMP ECX,-0x1                        ; 004ce7f2
    JNZ 0x004ce9ce                      ; 004ce7f5 | LAB_004ce9ce
    ...
    JNZ 0x004cea00                      ; 004ce85f | LAB_004cea00
        ;   XREF to: 004cea00 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0xe4]      ; 004ce865
    MOV EBP,dword ptr [0x02d02558]      ; 004ce86c | int g_ClipLeft
    MOV ECX,dword ptr [EDX + 0x2568]    ; 004ce872
    MOV EDX,dword ptr [EDX + 0x2968]    ; 004ce878
    CMP EAX,EBP                         ; 004ce87e
    JL 0x004ce9a0                       ; 004ce880 | LAB_004ce9a0
        ;   XREF to: 004ce9a0 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0xe8]      ; 004ce886
    CMP EAX,dword ptr [0x02d0255c]      ; 004ce88d | int g_ClipTop
    JL 0x004ce9a0                       ; 004ce893 | LAB_004ce9a0
        ;   XREF to: 004ce9a0 (CONDITIONAL_JUMP)
    MOV EAX,[0x02d02560]                ; 004ce899 | int g_ClipRight
    INC EAX                             ; 004ce89e
    SUB EAX,ECX                         ; 004ce89f
    CMP EAX,dword ptr [ESP + 0xe4]      ; 004ce8a1
    JL 0x004ce9a0                       ; 004ce8a8 | LAB_004ce9a0
        ;   XREF to: 004ce9a0 (CONDITIONAL_JUMP)
    MOV EAX,[0x02d02564]                ; 004ce8ae | int g_ClipBottom
    INC EAX                             ; 004ce8b3
    MOV EBP,dword ptr [ESP + 0xe8]      ; 004ce8b4
    SUB EAX,EDX                         ; 004ce8bb
    CMP EAX,EBP                         ; 004ce8bd
    JL 0x004ce9a0                       ; 004ce8bf | LAB_004ce9a0
        ;   XREF to: 004ce9a0 (CONDITIONAL_JUMP)
    ...
    JZ 0x004ce8ee                       ; 004ce8df | LAB_004ce8ee
        ;   XREF to: 004ce8ee (CONDITIONAL_JUMP)
    CMP dword ptr [0x02d03e94],0x0      ; 004ce8e1 | int g_UseExternalRenderer
    JNZ 0x004cea40                      ; 004ce8e8 | LAB_004cea40
        ;   XREF to: 004cea40 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [0x0067939c]      ; 004ce8ee | int g_BitsPerPixel
        ;   Label: LAB_004ce8ee
    CMP EDI,0x8                         ; 004ce8f4
    JNZ 0x004cec40                      ; 004ce8f7 | LAB_004cec40
        ;   XREF to: 004cec40 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [ESP + 0xec]      ; 004ce8fd
    CMP ECX,-0x1                        ; 004ce904
    JNZ 0x004cea7c                      ; 004ce907 | LAB_004cea7c
    ...
    JZ 0x004ce95f                       ; 004ce955 | LAB_004ce95f
    ...
    JLE 0x004ce944                      ; 004ce970 | LAB_004ce944
    ...
    JLE 0x004ce92b                      ; 004ce996 | LAB_004ce92b
    ...
    PUSH EDI                            ; 004ce9f1
    PUSH EBX                            ; 004ce9f2
    CALL engine_font.cpp_CBitFont_drawCharacter_FUN_004ce7a0 ; 004ce9f3 | int engine_font.cpp_CBitFont_drawCharacter_FUN_004ce7a0(CBitFont * this_ptr, int character_code, int x_pos, int y_pos, ...)
        ;   XREF to: 004ce7a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x18                        ; 004ce9f8
    JMP 0x004ce7fb                      ; 004ce9fb | LAB_004ce7fb
    ...
    PUSH EAX                            ; 004cea1f
    CALL engine_font.cpp_CBitFont_clipCharacter_FUN_004ccdd0 ; 004cea20 | int engine_font.cpp_CBitFont_clipCharacter_FUN_004ccdd0(int * bitmap_offset, int * left_x, int * top_y, int * right_x, ...)
        ;   XREF to: 004ccdd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x18                        ; 004cea25
    TEST EAX,EAX                        ; 004cea28
    JZ 0x004ce8c5                       ; 004cea2a | LAB_004ce8c5
    ...
    PUSH EDI                            ; 004cea62
    PUSH EBX                            ; 004cea63
    CALL engine_font.cpp_CBitFont_render3DCharacter_FUN_004ce2d0 ; 004cea64 | void engine_font.cpp_CBitFont_render3DCharacter_FUN_004ce2d0(CBitFont * this_ptr, int character_code, int x_pos, int y_pos, ...)
    ...
    CMP ECX,-0x2                        ; 004cea7c
        ;   Label: LAB_004cea7c
    JNZ 0x004ceb15                      ; 004cea7f | LAB_004ceb15
    ...
    JZ 0x004cead6                       ; 004ceacd | LAB_004cead6
        ;   XREF to: 004cead6 (CONDITIONAL_JUMP)
    MOV AL,[0x02d7b410]                 ; 004ceacf | undefined1 DAT_02d7b410
    ...
    JLE 0x004ceabc                      ; 004ceae7 | LAB_004ceabc
    ...
    JG 0x004ce9a0                       ; 004ceb0d | LAB_004ce9a0
        ;   XREF to: 004ce9a0 (CONDITIONAL_JUMP)
    JMP 0x004ceaa3                      ; 004ceb13 | LAB_004ceaa3
        ;   XREF to: 004ceaa3 (UNCONDITIONAL_JUMP)
    CMP ECX,-0x3                        ; 004ceb15
        ;   Label: LAB_004ceb15
    JNZ 0x004cebae                      ; 004ceb18 | LAB_004cebae
    ...
    JZ 0x004ceb6f                       ; 004ceb66 | LAB_004ceb6f
        ;   XREF to: 004ceb6f (CONDITIONAL_JUMP)
    MOV AL,[0x02d7b424]                 ; 004ceb68 | int g_DefaultTextColor
    ...
    JLE 0x004ceb55                      ; 004ceb80 | LAB_004ceb55
    ...
    JG 0x004ce9a0                       ; 004ceba6 | LAB_004ce9a0
        ;   XREF to: 004ce9a0 (CONDITIONAL_JUMP)
    JMP 0x004ceb3c                      ; 004cebac | LAB_004ceb3c
    ...
    JZ 0x004cec01                       ; 004cebf6 | LAB_004cec01
    ...
    JLE 0x004cebe5                      ; 004cec12 | LAB_004cebe5
    ...
    JG 0x004ce9a0                       ; 004cec81 | LAB_004ce9a0
        ;   XREF to: 004ce9a0 (CONDITIONAL_JUMP)
    ...
    MOV EBX,dword ptr [EBX + 0x2cf6a9c] ; 004cecc7 | void *[1024] g_ScreenBufferArray
    ...
    JG 0x004ceef7                       ; 004cece2 | LAB_004ceef7
    ...
    MOV EDX,dword ptr [0x006793b4]      ; 004ced03 | int g_CurrentAlphaValue
    ...
    JZ 0x004ceed6                       ; 004ced20 | LAB_004ceed6
    ...
    MOV EBP,dword ptr [0x00682748]      ; 004ced32 | uint g_RedMask16
    MOV dword ptr [ESP + 0xc0],EDX      ; 004ced38
    MOV EDX,dword ptr [EDI + 0xd64]     ; 004ced3f
    MOV CL,byte ptr [0x02d01f24]        ; 004ced45 | int g_RedBitPosition
    AND EDX,EBP                         ; 004ced4b
    SHR EDX,CL                          ; 004ced4d
    MOV CL,byte ptr [0x02d01f2c]        ; 004ced4f | int g_RedBitCount
    MOV ESI,dword ptr [EDI + 0xd64]     ; 004ced55
    SHL EDX,CL                          ; 004ced5b
    AND ESI,dword ptr [0x00682750]      ; 004ced5d | uint g_GreenMask16
    MOV CL,byte ptr [0x02d01f30]        ; 004ced63 | int g_GreenBitPosition
    SHR ESI,CL                          ; 004ced69
    MOV CL,byte ptr [0x02d01f38]        ; 004ced6b | int g_GreenBitCount
    SHL ESI,CL                          ; 004ced71
    AND ESI,0xff                        ; 004ced73
    IMUL ESI,EAX                        ; 004ced79
    MOV EBP,dword ptr [EDI + 0xd64]     ; 004ced7c
    AND EBP,dword ptr [0x00682758]      ; 004ced82 | uint g_BlueMask16
    MOV CL,byte ptr [0x02d01f3c]        ; 004ced88 | int g_BlueBitPosition
    SHR EBP,CL                          ; 004ced8e
    MOV CL,byte ptr [0x02d01f44]        ; 004ced90 | int g_BlueBitCount
    SHL EBP,CL                          ; 004ced96
    ...
    MOV ECX,dword ptr [0x00682748]      ; 004cedb5 | uint g_RedMask16
    AND ECX,EDX                         ; 004cedbb
    MOV dword ptr [ESP + 0x98],ECX      ; 004cedbd
    MOV EDI,dword ptr [ESP + 0x98]      ; 004cedc4
    MOV CL,byte ptr [0x02d01f24]        ; 004cedcb | int g_RedBitPosition
    SHR EDI,CL                          ; 004cedd1
    MOV CL,byte ptr [0x02d01f2c]        ; 004cedd3 | int g_RedBitCount
    SHL EDI,CL                          ; 004cedd9
    MOV ECX,EDI                         ; 004ceddb
    AND ECX,0xff                        ; 004ceddd
    MOV dword ptr [ESP + 0x38],ECX      ; 004cede3
    MOV ECX,dword ptr [0x00682750]      ; 004cede7 | uint g_GreenMask16
    AND ECX,EDX                         ; 004ceded
    MOV dword ptr [ESP + 0x98],ECX      ; 004cedef
    MOV EDI,dword ptr [ESP + 0x98]      ; 004cedf6
    MOV CL,byte ptr [0x02d01f30]        ; 004cedfd | int g_GreenBitPosition
    SHR EDI,CL                          ; 004cee03
    MOV CL,byte ptr [0x02d01f38]        ; 004cee05 | int g_GreenBitCount
    SHL EDI,CL                          ; 004cee0b
    MOV ECX,dword ptr [0x00682758]      ; 004cee0d | uint g_BlueMask16
    AND ECX,EDX                         ; 004cee13
    MOV dword ptr [ESP + 0x98],ECX      ; 004cee15
    MOV EDX,dword ptr [ESP + 0x98]      ; 004cee1c
    MOV CL,byte ptr [0x02d01f3c]        ; 004cee23 | int g_BlueBitPosition
    SHR EDX,CL                          ; 004cee29
    MOV CL,byte ptr [0x02d01f44]        ; 004cee2b | int g_BlueBitCount
    SHL EDX,CL                          ; 004cee31
    ...
    MOV ESI,dword ptr [0x02d01f28]      ; 004cee81 | int g_RedScaleFactor
    XOR EDX,EDX                         ; 004cee87
    DIV ESI                             ; 004cee89
    MOV EDI,dword ptr [0x02d01f34]      ; 004cee8b | int g_GreenScaleFactor
    ...
    DIV dword ptr [0x02d01f40]          ; 004ceeab | int g_BlueScaleFactor
    MOV CL,byte ptr [0x02d01f24]        ; 004ceeb1 | int g_RedBitPosition
    SHL ESI,CL                          ; 004ceeb7
    MOV CL,byte ptr [0x02d01f30]        ; 004ceeb9 | int g_GreenBitPosition
    MOV EDI,EAX                         ; 004ceebf
    MOV EAX,dword ptr [ESP + 0x44]      ; 004ceec1
    SHL EAX,CL                          ; 004ceec5
    MOV CL,byte ptr [0x02d01f3c]        ; 004ceec7 | int g_BlueBitPosition
    OR EAX,ESI                          ; 004ceecd
    SHL EDI,CL                          ; 004ceecf
    OR EAX,EDI                          ; 004ceed1
    ...
    JLE 0x004cece8                      ; 004ceef1 | LAB_004cece8
    ...
    JG 0x004ce9a0                       ; 004cef25 | LAB_004ce9a0
        ;   XREF to: 004ce9a0 (CONDITIONAL_JUMP)
    JMP 0x004cecb9                      ; 004cef2b | LAB_004cecb9
    ...
    JG 0x004ce9a0                       ; 004cef3d | LAB_004ce9a0
        ;   XREF to: 004ce9a0 (CONDITIONAL_JUMP)
    ...
    JZ 0x004cef8f                       ; 004cef82 | LAB_004cef8f
    ...
    JLE 0x004cef71                      ; 004cefa2 | LAB_004cef71
    ...
    JG 0x004ce9a0                       ; 004cefbc | LAB_004ce9a0
        ;   XREF to: 004ce9a0 (CONDITIONAL_JUMP)
    JMP 0x004cef53                      ; 004cefc2 | LAB_004cef53
        ;   XREF to: 004cef53 (UNCONDITIONAL_JUMP)
    CMP ESI,-0x2                        ; 004cefc4
        ;   Label: LAB_004cefc4
    JNZ 0x004cf30a                      ; 004cefc7 | LAB_004cf30a
        ;   XREF to: 004cf30a (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x1d64],0x0    ; 004cefcd
    JZ 0x004cf27f                       ; 004cefd4 | LAB_004cf27f
    ...
    JG 0x004ce9a0                       ; 004cefeb | LAB_004ce9a0
        ;   XREF to: 004ce9a0 (CONDITIONAL_JUMP)
    ...
    MOV EAX,dword ptr [EAX + 0x2cf6a9c] ; 004cf023 | void *[1024] g_ScreenBufferArray
    ...
    JG 0x004cf246                       ; 004cf03e | LAB_004cf246
    ...
    MOV EDX,dword ptr [0x006793b4]      ; 004cf05e | int g_CurrentAlphaValue
    ...
    JZ 0x004cf225                       ; 004cf07b | LAB_004cf225
        ;   XREF to: 004cf225 (CONDITIONAL_JUMP)
    MOV DX,word ptr [EBX]               ; 004cf081
    MOV dword ptr [ESP + 0xbc],EDX      ; 004cf084
    XOR EDX,EDX                         ; 004cf08b
    MOV ESI,dword ptr [0x00682748]      ; 004cf08d | uint g_RedMask16
    MOV DX,word ptr [0x02d7b412]        ; 004cf093 | ushort g_ShadowColor16
    MOV CL,byte ptr [0x02d01f24]        ; 004cf09a | int g_RedBitPosition
    AND ESI,EDX                         ; 004cf0a0
    SHR ESI,CL                          ; 004cf0a2
    MOV CL,byte ptr [0x02d01f2c]        ; 004cf0a4 | int g_RedBitCount
    SHL ESI,CL                          ; 004cf0aa
    AND ESI,0xff                        ; 004cf0ac
    MOV dword ptr [ESP + 0x54],ESI      ; 004cf0b2
    MOV ESI,dword ptr [0x00682750]      ; 004cf0b6 | uint g_GreenMask16
    MOV CL,byte ptr [0x02d01f30]        ; 004cf0bc | int g_GreenBitPosition
    AND ESI,EDX                         ; 004cf0c2
    MOV EDI,dword ptr [0x00682758]      ; 004cf0c4 | uint g_BlueMask16
    SHR ESI,CL                          ; 004cf0ca
    MOV CL,byte ptr [0x02d01f38]        ; 004cf0cc | int g_GreenBitCount
    AND EDI,EDX                         ; 004cf0d2
    SHL ESI,CL                          ; 004cf0d4
    MOV CL,byte ptr [0x02d01f3c]        ; 004cf0d6 | int g_BlueBitPosition
    XOR EDX,EDX                         ; 004cf0dc
    SHR EDI,CL                          ; 004cf0de
    MOV CL,byte ptr [0x02d01f44]        ; 004cf0e0 | int g_BlueBitCount
    MOV DX,word ptr [ESP + 0xbc]        ; 004cf0e6
    SHL EDI,CL                          ; 004cf0ee
    MOV ECX,dword ptr [0x00682748]      ; 004cf0f0 | uint g_RedMask16
    AND ECX,EDX                         ; 004cf0f6
    MOV dword ptr [ESP + 0x98],ECX      ; 004cf0f8
    MOV EBP,dword ptr [ESP + 0x98]      ; 004cf0ff
    MOV CL,byte ptr [0x02d01f24]        ; 004cf106 | int g_RedBitPosition
    SHR EBP,CL                          ; 004cf10c
    MOV CL,byte ptr [0x02d01f2c]        ; 004cf10e | int g_RedBitCount
    SHL EBP,CL                          ; 004cf114
    MOV ECX,EBP                         ; 004cf116
    AND ECX,0xff                        ; 004cf118
    MOV dword ptr [ESP + 0x58],ECX      ; 004cf11e
    MOV ECX,dword ptr [0x00682750]      ; 004cf122 | uint g_GreenMask16
    AND ECX,EDX                         ; 004cf128
    MOV dword ptr [ESP + 0x98],ECX      ; 004cf12a
    MOV EBP,dword ptr [ESP + 0x98]      ; 004cf131
    MOV CL,byte ptr [0x02d01f30]        ; 004cf138 | int g_GreenBitPosition
    SHR EBP,CL                          ; 004cf13e
    MOV CL,byte ptr [0x02d01f38]        ; 004cf140 | int g_GreenBitCount
    SHL EBP,CL                          ; 004cf146
    MOV ECX,dword ptr [0x00682758]      ; 004cf148 | uint g_BlueMask16
    AND ECX,EDX                         ; 004cf14e
    MOV dword ptr [ESP + 0x98],ECX      ; 004cf150
    MOV EDX,dword ptr [ESP + 0x98]      ; 004cf157
    MOV CL,byte ptr [0x02d01f3c]        ; 004cf15e | int g_BlueBitPosition
    SHR EDX,CL                          ; 004cf164
    MOV CL,byte ptr [0x02d01f44]        ; 004cf166 | int g_BlueBitCount
    SHL EDX,CL                          ; 004cf16c
    ...
    MOV ESI,dword ptr [0x02d01f28]      ; 004cf1c7 | int g_RedScaleFactor
    ...
    MOV EDI,dword ptr [0x02d01f34]      ; 004cf1dd | int g_GreenScaleFactor
    ...
    DIV dword ptr [0x02d01f40]          ; 004cf1fa | int g_BlueScaleFactor
    MOV CL,byte ptr [0x02d01f24]        ; 004cf200 | int g_RedBitPosition
    SHL ESI,CL                          ; 004cf206
    MOV CL,byte ptr [0x02d01f30]        ; 004cf208 | int g_GreenBitPosition
    MOV EDI,EAX                         ; 004cf20e
    MOV EAX,dword ptr [ESP + 0x60]      ; 004cf210
    SHL EAX,CL                          ; 004cf214
    MOV CL,byte ptr [0x02d01f3c]        ; 004cf216 | int g_BlueBitPosition
    OR EAX,ESI                          ; 004cf21c
    SHL EDI,CL                          ; 004cf21e
    OR EAX,EDI                          ; 004cf220
    ...
    JLE 0x004cf044                      ; 004cf240 | LAB_004cf044
    ...
    JG 0x004ce9a0                       ; 004cf274 | LAB_004ce9a0
        ;   XREF to: 004ce9a0 (CONDITIONAL_JUMP)
    JMP 0x004cf015                      ; 004cf27a | LAB_004cf015
    ...
    JZ 0x004cf2d5                       ; 004cf2ca | LAB_004cf2d5
        ;   XREF to: 004cf2d5 (CONDITIONAL_JUMP)
    MOV AX,[0x02d7b412]                 ; 004cf2cc | ushort g_ShadowColor16
    ...
    JLE 0x004cf2b9                      ; 004cf2e8 | LAB_004cf2b9
    ...
    JG 0x004ce9a0                       ; 004cf302 | LAB_004ce9a0
        ;   XREF to: 004ce9a0 (CONDITIONAL_JUMP)
    JMP 0x004cf299                      ; 004cf308 | LAB_004cf299
        ;   XREF to: 004cf299 (UNCONDITIONAL_JUMP)
    CMP ESI,-0x3                        ; 004cf30a
        ;   Label: LAB_004cf30a
    JNZ 0x004cf638                      ; 004cf30d | LAB_004cf638
        ;   XREF to: 004cf638 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x1d64],0x0    ; 004cf313
    JZ 0x004cf5ad                       ; 004cf31a | LAB_004cf5ad
    ...
    JG 0x004ce9a0                       ; 004cf331 | LAB_004ce9a0
        ;   XREF to: 004ce9a0 (CONDITIONAL_JUMP)
    ...
    MOV EBX,dword ptr [EBX + 0x2cf6a9c] ; 004cf369 | void *[1024] g_ScreenBufferArray
    ...
    JG 0x004cf574                       ; 004cf384 | LAB_004cf574
    ...
    MOV EDX,dword ptr [0x006793b4]      ; 004cf3a4 | int g_CurrentAlphaValue
    ...
    JZ 0x004cf553                       ; 004cf3c1 | LAB_004cf553
        ;   XREF to: 004cf553 (CONDITIONAL_JUMP)
    MOV EBP,dword ptr [0x02d7b424]      ; 004cf3c7 | int g_DefaultTextColor
    MOV ESI,dword ptr [0x00682748]      ; 004cf3cd | uint g_RedMask16
    MOV CL,byte ptr [0x02d01f24]        ; 004cf3d3 | int g_RedBitPosition
    AND EBP,ESI                         ; 004cf3d9
    SHR EBP,CL                          ; 004cf3db
    MOV CL,byte ptr [0x02d01f2c]        ; 004cf3dd | int g_RedBitCount
    SHL EBP,CL                          ; 004cf3e3
    AND EBP,0xff                        ; 004cf3e5
    IMUL EBP,EAX                        ; 004cf3eb
    MOV DX,word ptr [EBX]               ; 004cf3ee
    MOV EDI,dword ptr [0x00682750]      ; 004cf3f1 | uint g_GreenMask16
    MOV dword ptr [ESP + 0xc4],EDX      ; 004cf3f7
    MOV EDX,dword ptr [0x02d7b424]      ; 004cf3fe | int g_DefaultTextColor
    AND EDI,EDX                         ; 004cf404
    MOV CL,byte ptr [0x02d01f30]        ; 004cf406 | int g_GreenBitPosition
    SHR EDI,CL                          ; 004cf40c
    MOV CL,byte ptr [0x02d01f38]        ; 004cf40e | int g_GreenBitCount
    SHL EDI,CL                          ; 004cf414
    AND EDI,0xff                        ; 004cf416
    IMUL EDI,EAX                        ; 004cf41c
    MOV ESI,EDX                         ; 004cf41f
    AND ESI,dword ptr [0x00682758]      ; 004cf421 | uint g_BlueMask16
    MOV CL,byte ptr [0x02d01f3c]        ; 004cf427 | int g_BlueBitPosition
    SHR ESI,CL                          ; 004cf42d
    MOV CL,byte ptr [0x02d01f44]        ; 004cf42f | int g_BlueBitCount
    SHL ESI,CL                          ; 004cf435
    AND ESI,0xff                        ; 004cf437
    IMUL ESI,EAX                        ; 004cf43d
    XOR EDX,EDX                         ; 004cf440
    MOV DX,word ptr [ESP + 0xc4]        ; 004cf442
    MOV ECX,dword ptr [0x00682748]      ; 004cf44a | uint g_RedMask16
    MOV dword ptr [ESP + 0x98],EDX      ; 004cf450
    AND EDX,ECX                         ; 004cf457
    MOV CL,byte ptr [0x02d01f24]        ; 004cf459 | int g_RedBitPosition
    SHR EDX,CL                          ; 004cf45f
    MOV CL,byte ptr [0x02d01f2c]        ; 004cf461 | int g_RedBitCount
    SHL EDX,CL                          ; 004cf467
    MOV ECX,EDX                         ; 004cf469
    AND ECX,0xff                        ; 004cf46b
    MOV EDX,dword ptr [ESP + 0x98]      ; 004cf471
    MOV dword ptr [ESP + 0x70],ECX      ; 004cf478
    AND EDX,dword ptr [0x00682750]      ; 004cf47c | uint g_GreenMask16
    MOV CL,byte ptr [0x02d01f30]        ; 004cf482 | int g_GreenBitPosition
    SHR EDX,CL                          ; 004cf488
    MOV CL,byte ptr [0x02d01f38]        ; 004cf48a | int g_GreenBitCount
    SHL EDX,CL                          ; 004cf490
    MOV ECX,EDX                         ; 004cf492
    AND ECX,0xff                        ; 004cf494
    MOV EDX,dword ptr [ESP + 0x98]      ; 004cf49a
    MOV dword ptr [ESP + 0x74],ECX      ; 004cf4a1
    AND EDX,dword ptr [0x00682758]      ; 004cf4a5 | uint g_BlueMask16
    MOV CL,byte ptr [0x02d01f3c]        ; 004cf4ab | int g_BlueBitPosition
    SHR EDX,CL                          ; 004cf4b1
    MOV CL,byte ptr [0x02d01f44]        ; 004cf4b3 | int g_BlueBitCount
    SHL EDX,CL                          ; 004cf4b9
    ...
    DIV dword ptr [0x02d01f28]          ; 004cf4fe | int g_RedScaleFactor
    MOV ECX,EDI                         ; 004cf504
    MOV EDI,dword ptr [0x02d01f34]      ; 004cf506 | int g_GreenScaleFactor
    SHR ECX,0x8                         ; 004cf50c
    MOV ESI,EAX                         ; 004cf50f
    XOR EDX,EDX                         ; 004cf511
    MOV EAX,ECX                         ; 004cf513
    DIV EDI                             ; 004cf515
    MOV EBP,dword ptr [0x02d01f40]      ; 004cf517 | int g_BlueScaleFactor
    MOV EDI,EAX                         ; 004cf51d
    XOR EDX,EDX                         ; 004cf51f
    MOV EAX,dword ptr [ESP + 0x98]      ; 004cf521
    DIV EBP                             ; 004cf528
    MOV CL,byte ptr [0x02d01f24]        ; 004cf52a | int g_RedBitPosition
    MOV dword ptr [ESP + 0x7c],EAX      ; 004cf530
    MOV EAX,ESI                         ; 004cf534
    SHL EAX,CL                          ; 004cf536
    MOV CL,byte ptr [0x02d01f30]        ; 004cf538 | int g_GreenBitPosition
    MOV EDX,dword ptr [ESP + 0x7c]      ; 004cf53e
    SHL EDI,CL                          ; 004cf542
    MOV CL,byte ptr [0x02d01f3c]        ; 004cf544 | int g_BlueBitPosition
    OR EAX,EDI                          ; 004cf54a
    SHL EDX,CL                          ; 004cf54c
    OR EAX,EDX                          ; 004cf54e
    ...
    JLE 0x004cf38a                      ; 004cf56e | LAB_004cf38a
    ...
    JG 0x004ce9a0                       ; 004cf5a2 | LAB_004ce9a0
        ;   XREF to: 004ce9a0 (CONDITIONAL_JUMP)
    JMP 0x004cf35b                      ; 004cf5a8 | LAB_004cf35b
    ...
    JZ 0x004cf603                       ; 004cf5f8 | LAB_004cf603
        ;   XREF to: 004cf603 (CONDITIONAL_JUMP)
    MOV AX,[0x02d7b424]                 ; 004cf5fa | int g_DefaultTextColor
    ...
    JLE 0x004cf5e7                      ; 004cf616 | LAB_004cf5e7
    ...
    JG 0x004ce9a0                       ; 004cf630 | LAB_004ce9a0
        ;   XREF to: 004ce9a0 (CONDITIONAL_JUMP)
    JMP 0x004cf5c7                      ; 004cf636 | LAB_004cf5c7
        ;   XREF to: 004cf5c7 (UNCONDITIONAL_JUMP)
    MOV AX,word ptr [ESI*0x2 + 0x2d01020] ; 004cf638 | ushort[256] g_ColorTable16
        ;   Label: LAB_004cf638
    MOV dword ptr [ESP + 0xb8],EAX      ; 004cf640
    CMP dword ptr [EBX + 0x1d64],0x0    ; 004cf647
    JZ 0x004cf925                       ; 004cf64e | LAB_004cf925
    ...
    JG 0x004ce9a0                       ; 004cf668 | LAB_004ce9a0
        ;   XREF to: 004ce9a0 (CONDITIONAL_JUMP)
    ...
    MOV EBX,dword ptr [EBX + 0x2cf6a9c] ; 004cf6a6 | void *[1024] g_ScreenBufferArray
    ...
    JG 0x004cf8e6                       ; 004cf6c4 | LAB_004cf8e6
    ...
    MOV EDX,dword ptr [0x006793b4]      ; 004cf6e7 | int g_CurrentAlphaValue
    ...
    JZ 0x004cf8bf                       ; 004cf704 | LAB_004cf8bf
        ;   XREF to: 004cf8bf (CONDITIONAL_JUMP)
    XOR ESI,ESI                         ; 004cf70a
    MOV EDI,dword ptr [0x00682748]      ; 004cf70c | uint g_RedMask16
    MOV SI,word ptr [ESP + 0xb8]        ; 004cf712
    MOV CL,byte ptr [0x02d01f24]        ; 004cf71a | int g_RedBitPosition
    AND EDI,ESI                         ; 004cf720
    SHR EDI,CL                          ; 004cf722
    MOV CL,byte ptr [0x02d01f2c]        ; 004cf724 | int g_RedBitCount
    SHL EDI,CL                          ; 004cf72a
    AND EDI,0xff                        ; 004cf72c
    IMUL EDI,EAX                        ; 004cf732
    MOV DX,word ptr [EBX]               ; 004cf735
    MOV dword ptr [ESP + 0xb4],EDX      ; 004cf738
    MOV EDX,dword ptr [0x00682750]      ; 004cf73f | uint g_GreenMask16
    AND EDX,ESI                         ; 004cf745
    MOV CL,byte ptr [0x02d01f30]        ; 004cf747 | int g_GreenBitPosition
    SHR EDX,CL                          ; 004cf74d
    MOV CL,byte ptr [0x02d01f38]        ; 004cf74f | int g_GreenBitCount
    SHL EDX,CL                          ; 004cf755
    AND EDX,0xff                        ; 004cf757
    IMUL EDX,EAX                        ; 004cf75d
    AND ESI,dword ptr [0x00682758]      ; 004cf760 | uint g_BlueMask16
    MOV CL,byte ptr [0x02d01f3c]        ; 004cf766 | int g_BlueBitPosition
    SHR ESI,CL                          ; 004cf76c
    MOV CL,byte ptr [0x02d01f44]        ; 004cf76e | int g_BlueBitCount
    SHL ESI,CL                          ; 004cf774
    AND ESI,0xff                        ; 004cf776
    MOV dword ptr [ESP + 0x8c],ESI      ; 004cf77c
    XOR ESI,ESI                         ; 004cf783
    MOV ECX,dword ptr [0x00682748]      ; 004cf785 | uint g_RedMask16
    ...
    MOV CL,byte ptr [0x02d01f24]        ; 004cf7a3 | int g_RedBitPosition
    SHR EBP,CL                          ; 004cf7a9
    MOV CL,byte ptr [0x02d01f2c]        ; 004cf7ab | int g_RedBitCount
    SHL EBP,CL                          ; 004cf7b1
    MOV ECX,EBP                         ; 004cf7b3
    AND ECX,0xff                        ; 004cf7b5
    MOV dword ptr [ESP + 0x90],ECX      ; 004cf7bb
    MOV ECX,dword ptr [0x00682750]      ; 004cf7c2 | uint g_GreenMask16
    AND ECX,ESI                         ; 004cf7c8
    MOV dword ptr [ESP + 0x98],ECX      ; 004cf7ca
    MOV EBP,dword ptr [ESP + 0x98]      ; 004cf7d1
    MOV CL,byte ptr [0x02d01f30]        ; 004cf7d8 | int g_GreenBitPosition
    SHR EBP,CL                          ; 004cf7de
    MOV CL,byte ptr [0x02d01f38]        ; 004cf7e0 | int g_GreenBitCount
    SHL EBP,CL                          ; 004cf7e6
    MOV ECX,dword ptr [0x00682758]      ; 004cf7e8 | uint g_BlueMask16
    AND ECX,ESI                         ; 004cf7ee
    MOV dword ptr [ESP + 0x98],ECX      ; 004cf7f0
    MOV ESI,dword ptr [ESP + 0x98]      ; 004cf7f7
    MOV CL,byte ptr [0x02d01f3c]        ; 004cf7fe | int g_BlueBitPosition
    SHR ESI,CL                          ; 004cf804
    MOV CL,byte ptr [0x02d01f44]        ; 004cf806 | int g_BlueBitCount
    SHL ESI,CL                          ; 004cf80c
    ...
    MOV ESI,dword ptr [0x02d01f28]      ; 004cf85f | int g_RedScaleFactor
    MOV dword ptr [ESP + 0x9c],EAX      ; 004cf865
    DIV ESI                             ; 004cf86c
    SHR EBP,0x8                         ; 004cf86e
    MOV EDI,dword ptr [0x02d01f34]      ; 004cf871 | int g_GreenScaleFactor
    MOV dword ptr [ESP + 0x9c],EAX      ; 004cf877
    XOR EDX,EDX                         ; 004cf87e
    MOV EAX,EBP                         ; 004cf880
    DIV EDI                             ; 004cf882
    SHR ECX,0x8                         ; 004cf884
    MOV EBP,dword ptr [0x02d01f40]      ; 004cf887 | int g_BlueScaleFactor
    MOV EDI,EAX                         ; 004cf88d
    XOR EDX,EDX                         ; 004cf88f
    MOV EAX,ECX                         ; 004cf891
    DIV EBP                             ; 004cf893
    MOV CL,byte ptr [0x02d01f24]        ; 004cf895 | int g_RedBitPosition
    MOV EDX,dword ptr [ESP + 0x9c]      ; 004cf89b
    MOV ESI,EAX                         ; 004cf8a2
    MOV EAX,EDI                         ; 004cf8a4
    SHL EDX,CL                          ; 004cf8a6
    MOV CL,byte ptr [0x02d01f30]        ; 004cf8a8 | int g_GreenBitPosition
    SHL EAX,CL                          ; 004cf8ae
    MOV CL,byte ptr [0x02d01f3c]        ; 004cf8b0 | int g_BlueBitPosition
    OR EAX,EDX                          ; 004cf8b6
    SHL ESI,CL                          ; 004cf8b8
    OR EAX,ESI                          ; 004cf8ba
    ...
    JLE 0x004cf6ca                      ; 004cf8e0 | LAB_004cf6ca
    ...
    JG 0x004ce9a0                       ; 004cf91a | LAB_004ce9a0
        ;   XREF to: 004ce9a0 (CONDITIONAL_JUMP)
    JMP 0x004cf698                      ; 004cf920 | LAB_004cf698
    ...
    JZ 0x004cf977                       ; 004cf96b | LAB_004cf977
    ...
    JLE 0x004cf95a                      ; 004cf98a | LAB_004cf95a
    ...
    JG 0x004ce9a0                       ; 004cf9a4 | LAB_004ce9a0
        ;   XREF to: 004ce9a0 (CONDITIONAL_JUMP)
    JMP 0x004cf93a                      ; 004cf9aa | LAB_004cf93a
        ;   XREF to: 004cf93a (UNCONDITIONAL_JUMP)
    CMP EDI,0x20                        ; 004cf9ac
        ;   Label: LAB_004cf9ac
    JNZ 0x004ce9a0                      ; 004cf9af | LAB_004ce9a0
        ;   XREF to: 004ce9a0 (CONDITIONAL_JUMP)
    ...
    JG 0x004ce9a0                       ; 004cf9f2 | LAB_004ce9a0
        ;   XREF to: 004ce9a0 (CONDITIONAL_JUMP)
    MOV EBX,EDX                         ; 004cf9f8
    MOV EAX,dword ptr [ESP + 0xe4]      ; 004cf9fa
        ;   Label: LAB_004cf9fa
    MOV EDX,dword ptr [EBX + 0x2cf6a9c] ; 004cfa01 | void *[1024] g_ScreenBufferArray
    ...
    PUSH EAX                            ; 004cfa31
    PUSH EDX                            ; 004cfa32
    CALL engine_font.cpp_drawAlphaBlendedPixels_FUN_004ce240 ; 004cfa33 | void engine_font.cpp_drawAlphaBlendedPixels_FUN_004ce240(uint * dest_buffer, uchar * src_indices, uint * color_table, int pixel_count, ...)
    ...
    JLE 0x004cf9fa                      ; 004cfa66 | LAB_004cf9fa
    ...
    JZ 0x004cfac8                       ; 004cfabd | LAB_004cfac8
    ...
    JLE 0x004cfaac                      ; 004cfadb | LAB_004cfaac
    ...
    JG 0x004ce9a0                       ; 004cfaf5 | LAB_004ce9a0
        ;   XREF to: 004ce9a0 (CONDITIONAL_JUMP)
    JMP 0x004cfa8d                      ; 004cfafb | LAB_004cfa8d
        ;   XREF to: 004cfa8d (UNCONDITIONAL_JUMP)
    CMP ECX,-0x2                        ; 004cfafd
        ;   Label: LAB_004cfafd
    JNZ 0x004cfc25                      ; 004cfb00 | LAB_004cfc25
        ;   XREF to: 004cfc25 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x1d64],0x0    ; 004cfb06
    JZ 0x004cfba0                       ; 004cfb0d | LAB_004cfba0
    ...
    PUSH EAX                            ; 004cfb57
    PUSH EDX                            ; 004cfb58
    CALL engine_font.cpp_drawAlphaBlendedPixels_FUN_004ce240 ; 004cfb59 | void engine_font.cpp_drawAlphaBlendedPixels_FUN_004ce240(uint * dest_buffer, uchar * src_indices, uint * color_table, int pixel_count, ...)
        ;   XREF to: 004ce240 (UNCONDITIONAL_CALL)
    ...
    JLE 0x004cfb2a                      ; 004cfb8e | LAB_004cfb2a
    ...
    JZ 0x004cfbf0                       ; 004cfbe7 | LAB_004cfbf0
        ;   XREF to: 004cfbf0 (CONDITIONAL_JUMP)
    MOV EAX,[0x02d7b414]                ; 004cfbe9 | int g_ShadowColor32
    ...
    JLE 0x004cfbd6                      ; 004cfc03 | LAB_004cfbd6
    ...
    JG 0x004ce9a0                       ; 004cfc1d | LAB_004ce9a0
        ;   XREF to: 004ce9a0 (CONDITIONAL_JUMP)
    JMP 0x004cfbb5                      ; 004cfc23 | LAB_004cfbb5
        ;   XREF to: 004cfbb5 (UNCONDITIONAL_JUMP)
    CMP ECX,-0x3                        ; 004cfc25
        ;   Label: LAB_004cfc25
    JNZ 0x004cfd4d                      ; 004cfc28 | LAB_004cfd4d
        ;   XREF to: 004cfd4d (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x1d64],0x0    ; 004cfc2e
    JZ 0x004cfcc8                       ; 004cfc35 | LAB_004cfcc8
    ...
    PUSH EBP                            ; 004cfc7f
    PUSH EDX                            ; 004cfc80
    CALL engine_font.cpp_drawAlphaBlendedPixels_FUN_004ce240 ; 004cfc81 | void engine_font.cpp_drawAlphaBlendedPixels_FUN_004ce240(uint * dest_buffer, uchar * src_indices, uint * color_table, int pixel_count, ...)
        ;   XREF to: 004ce240 (UNCONDITIONAL_CALL)
    ...
    JLE 0x004cfc52                      ; 004cfcb6 | LAB_004cfc52
    ...
    JZ 0x004cfd18                       ; 004cfd0f | LAB_004cfd18
        ;   XREF to: 004cfd18 (CONDITIONAL_JUMP)
    MOV EAX,[0x02d7b424]                ; 004cfd11 | int g_DefaultTextColor
    ...
    JLE 0x004cfcfe                      ; 004cfd2b | LAB_004cfcfe
    ...
    JG 0x004ce9a0                       ; 004cfd45 | LAB_004ce9a0
        ;   XREF to: 004ce9a0 (CONDITIONAL_JUMP)
    JMP 0x004cfcdd                      ; 004cfd4b | LAB_004cfcdd
        ;   XREF to: 004cfcdd (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0x1d64]    ; 004cfd4d
        ;   Label: LAB_004cfd4d
    MOV ESI,dword ptr [ECX*0x4 + 0x2d01220] ; 004cfd53 | uint[256] g_ColorTable32
    TEST EAX,EAX                        ; 004cfd5a
    JZ 0x004cfde5                       ; 004cfd5c | LAB_004cfde5
    ...
    JG 0x004ce9a0                       ; 004cfd6f | LAB_004ce9a0
        ;   XREF to: 004ce9a0 (CONDITIONAL_JUMP)
    MOV EBX,EDX                         ; 004cfd75
    MOV EDX,dword ptr [ESP + 0xe4]      ; 004cfd77
        ;   Label: LAB_004cfd77
    MOV EAX,dword ptr [EBX + 0x2cf6a9c] ; 004cfd7e | void *[1024] g_ScreenBufferArray
    ...
    PUSH EAX                            ; 004cfd9e
    PUSH EDX                            ; 004cfd9f
    CALL engine_font.cpp_drawAlphaBlendedPixels_FUN_004ce240 ; 004cfda0 | void engine_font.cpp_drawAlphaBlendedPixels_FUN_004ce240(uint * dest_buffer, uchar * src_indices, uint * color_table, int pixel_count, ...)
        ;   XREF to: 004ce240 (UNCONDITIONAL_CALL)
    ...
    JLE 0x004cfd77                      ; 004cfdd3 | LAB_004cfd77
    ...
    JZ 0x004cfe37                       ; 004cfe33 | LAB_004cfe37
    ...
    JLE 0x004cfe22                      ; 004cfe4a | LAB_004cfe22
    ...
    JG 0x004ce9a0                       ; 004cfe72 | LAB_004ce9a0
        ;   XREF to: 004ce9a0 (CONDITIONAL_JUMP)
    JMP 0x004cfe01                      ; 004cfe78 | LAB_004cfe01
