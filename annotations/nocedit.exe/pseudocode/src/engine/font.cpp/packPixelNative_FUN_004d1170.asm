...
;                               FUNCTION
; *****************************************************************************
; __cdecl uint engine_font.cpp_packPixelNative_FUN_004d1170(int red, int green, int blue)
;
; Parameters:
; int              Stack[0x4]:4   red
...
section .text
    ...
    CMP dword ptr [0x0067939c],0x20     ; 004d1178 | int g_BitsPerPixel
    JNZ 0x004d11a6                      ; 004d117f | LAB_004d11a6
        ;   XREF to: 004d11a6 (CONDITIONAL_JUMP)
    MOV CL,byte ptr [0x02d01f24]        ; 004d1181 | int g_RedBitPosition
    SHL EAX,CL                          ; 004d1187
    MOV CL,byte ptr [0x02d01f30]        ; 004d1189 | int g_GreenBitPosition
    SHL EDX,CL                          ; 004d118f
    MOV CL,byte ptr [0x02d01f3c]        ; 004d1191 | int g_BlueBitPosition
    OR EAX,EDX                          ; 004d1197
