...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl engine_font_cpp_CBitFont_drawText_FUN_004cda80(CBitFont *this_ptr,char *text,int x,int y,int color_mode,int color_value)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004cda80
        ;   Label: engine_font.cpp_CBitFont_drawText_FUN_004cda80
    PUSH ESI                            ; 004cda81
    PUSH EDI                            ; 004cda82
    PUSH EBP                            ; 004cda83
    ...
    CALL engine_palette.cpp_CFont_drawText_FUN_00544ed0 ; 004cdaf6
        ;   XREF to: 00544ed0 (UNCONDITIONAL_CALL)  ; int engine_palette.cpp_CFont_drawText_FUN_00544ed0(CFont * this_ptr, char * text, int x, int y, ...)
    ...
    CALL engine_font.cpp_CBitFont_drawText_FUN_004cda80 ; 004cdb21
