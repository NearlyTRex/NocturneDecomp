...
section .text
    ...
    PUSH EBP                            ; 004cde4e
    CALL engine_font.cpp_CBitFont_drawTextCenterF_FUN_004cde70 ; 004cde4f | int engine_font.cpp_CBitFont_drawTextCenterF_FUN_004cde70(CBitFont * this_ptr, int center_x, int y_pos, int color_mode, ...)
