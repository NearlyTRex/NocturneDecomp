...
;
; Called Functions:
;   engine_font.cpp_CBitFont_drawTextCenterFV_FUN_004cde70
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 004cde20
        ;   Label: engine_font.cpp_CBitFont_drawTextCenterF_FUN_004cde20
    PUSH ESI                            ; 004cde21
    PUSH EDI                            ; 004cde22
    PUSH EBP                            ; 004cde23
    ...
    PUSH EBP                            ; 004cde4e
    CALL engine_font.cpp_CBitFont_drawTextCenterFV_FUN_004cde70 ; 004cde4f
        ;   XREF to: 004cde70 (UNCONDITIONAL_CALL)  ; int engine_font.cpp_CBitFont_drawTextCenterFV_FUN_004cde70(CBitFont * this_ptr, int center_x, int y_pos, int color_mode, ...)
