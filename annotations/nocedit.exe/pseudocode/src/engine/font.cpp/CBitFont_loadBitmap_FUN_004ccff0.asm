...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl engine_font_cpp_CBitFont_loadBitmap_FUN_004ccff0 (CBitFont *this_ptr,char *filename,int width,int height,int first_char)
;
; Parameters:
...
section .text
    ...
    JGE 0x004cd256                      ; 004cd00b
        ;   XREF to: 004cd256 (CONDITIONAL_JUMP)  ; LAB_004cd256
    ...
    CMP AL,0x0                          ; 004cd02c
    JZ 0x004cd040                       ; 004cd02e
        ;   XREF to: 004cd040 (CONDITIONAL_JUMP)  ; LAB_004cd040
    MOV AL,byte ptr [ESI + 0x1]         ; 004cd030
    ADD ESI,0x2                         ; 004cd033
    MOV byte ptr [EDI + 0x1],AL         ; 004cd036
    ADD EDI,0x2                         ; 004cd039
    CMP AL,0x0                          ; 004cd03c
    JNZ 0x004cd028                      ; 004cd03e
        ;   XREF to: 004cd028 (CONDITIONAL_JUMP)  ; LAB_004cd028
    POP EDI                             ; 004cd040
        ;   Label: LAB_004cd040
    ...
    PUSH EAX                            ; 004cd051
    CALL crt_string.c_strupr_FUN_00600770 ; 004cd052
    ...
    PUSH 0x62a4da                       ; 004cd070 | = "art"
    MOV dword ptr [EBX + EAX*0x4 + 0x154],EDX ; 004cd075
    CALL engine_dosio.c_getFileSize_FUN_00481880 ; 004cd07c
    ...
    JGE 0x004cd0bb                      ; 004cd086
        ;   XREF to: 004cd0bb (CONDITIONAL_JUMP)  ; LAB_004cd0bb
    PUSH EBP                            ; 004cd088
    ...
    PUSH EAX                            ; 004cd0ac
    MOV dword ptr [0x02f0ca4c],EDX      ; 004cd0ad | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004cd0b3
    ...
    JNZ 0x004cd117                      ; 004cd0e2
        ;   XREF to: 004cd117 (CONDITIONAL_JUMP)  ; LAB_004cd117
    PUSH EBP                            ; 004cd0e4
    ...
    MOV EDI,0x62a551                    ; 004cd103 | = "..\\engine\\font.cpp"
    PUSH EAX                            ; 004cd108
    MOV dword ptr [0x02f0ca48],EDI      ; 004cd109 | g_CurrentFilename
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004cd10f
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    PUSH EDX                            ; 004cd121
    PUSH EBP                            ; 004cd122
    CALL cockpit_ckptutil.c_readBitmapFile_FUN_00431870 ; 004cd123
    ...
    PUSH 0x0                            ; 004cd13d
    PUSH EBP                            ; 004cd13f
    CALL engine_dosio.c_splitPath_FUN_00481f20 ; 004cd140
    ...
    PUSH EAX                            ; 004cd166
    CALL engine_dosio.c_makePath_FUN_00481f50 ; 004cd167
    ...
    PUSH 0x62a568                       ; 004cd16f | = "rb"
    LEA EAX,[ESP + 0x130]               ; 004cd174
    PUSH EAX                            ; 004cd17b
    PUSH 0x62a56b                       ; 004cd17c | = "art"
    CALL engine_dosio.c_getFile_FUN_00481a50 ; 004cd181
        ;   XREF to: 00481a50 (UNCONDITIONAL_CALL)  ; FILE * engine_dosio.c_getFile_FUN_00481a50(char * directory, char * filename, char * mode)
    ADD ESP,0xc                         ; 004cd186
    MOV EDI,EAX                         ; 004cd189
    TEST EAX,EAX                        ; 004cd18b
    JZ 0x004cd219                       ; 004cd18d
        ;   XREF to: 004cd219 (CONDITIONAL_JUMP)  ; LAB_004cd219
    XOR ESI,ESI                         ; 004cd193
    PUSH EDI                            ; 004cd195
        ;   Label: LAB_004cd195
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 004cd196
    ...
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 004cd1b8
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
    ...
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 004cd1da
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
    ...
    JNZ 0x004cd195                      ; 004cd204
        ;   XREF to: 004cd195 (CONDITIONAL_JUMP)  ; LAB_004cd195
    PUSH 0x10a                          ; 004cd206
    PUSH 0x62a56f                       ; 004cd20b | = "..\\engine\\font.cpp"
    PUSH EDI                            ; 004cd210
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 004cd211
    ...
    CALL engine_font.cpp_CBitFont_remapPalette_FUN_004d02a0 ; 004cd243
    ...
    POP EBX                             ; 004cd254
    RET                                 ; 004cd255
    MOV ECX,0x62a4b6                    ; 004cd256 | = "..\\engine\\font.cpp"
        ;   Label: LAB_004cd256
    MOV ESI,0xd6                        ; 004cd25b
    PUSH 0x62a4c9                       ; 004cd260 | = "Too many bitmaps"
    MOV dword ptr [0x02f0ca48],ECX      ; 004cd265 | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 004cd26b | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004cd271
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ADD ESP,0x4                         ; 004cd276
    JMP 0x004cd011                      ; 004cd279
        ;   XREF to: 004cd011 (UNCONDITIONAL_JUMP)  ; LAB_004cd011
