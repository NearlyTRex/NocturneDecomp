...
;
; Called Functions:
;   engine_font.cpp_CBitFont_drawTextCenterInBoundsFV_FUN_004cdf80
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 004cdf30
        ;   Label: engine_font.cpp_CBitFont_drawTextCenterInBoundsF_FUN_004cdf30
    PUSH ESI                            ; 004cdf31
    PUSH EDI                            ; 004cdf32
    PUSH EBP                            ; 004cdf33
    ...
    PUSH EAX                            ; 004cdf63
    CALL engine_font.cpp_CBitFont_drawTextCenterInBoundsFV_FUN_004cdf80 ; 004cdf64
        ;   XREF to: 004cdf80 (UNCONDITIONAL_CALL)  ; int engine_font.cpp_CBitFont_drawTextCenterInBoundsFV_FUN_004cdf80(CBitFont * this_ptr, int left_x, int right_x, int y_pos, ...)
