...
;   engine_font.cpp_CBitFont_drawTextFV_FUN_004cdc70 at 004cdcc2
...
section .text
    ...
    PUSH EBX                            ; 004cdbf0
        ;   Label: engine_font.cpp_CBitFont_drawTextWrapper_FUN_004cdbf0
    PUSH ESI                            ; 004cdbf1
    PUSH EDI                            ; 004cdbf2
    PUSH EBP                            ; 004cdbf3
    ...
    PUSH EBP                            ; 004cdc11
    CALL engine_font.cpp_CBitFont_drawText_FUN_004cda80 ; 004cdc12
