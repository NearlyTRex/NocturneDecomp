...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl engine_font_cpp_CBitFont_getCharWidth_FUN_004d01a0(CBitFont *font,int char_code)
;
; Parameters:
...
;   core_script.cpp_CScript_initEditorLayout_FUN_00566660 at 00566679
...
section .text
    ...
    JL 0x004d01af                       ; 004d01a6
        ;   XREF to: 004d01af (CONDITIONAL_JUMP)  ; LAB_004d01af
    CMP EAX,0x100                       ; 004d01a8
    JL 0x004d01b2                       ; 004d01ad
        ;   XREF to: 004d01b2 (CONDITIONAL_JUMP)  ; LAB_004d01b2
