...

{
  ...
  do {
    ...
    if ((uint)screen_width < this_ptr->char_spacing + iVar6 + this_ptr->max_char_width + 1U) {
      if ((uint)(this_ptr->max_char_height + iVar5) < (uint)screen_height) {
        ...
        g_ActiveRenderColor = 4;
        iVar2 = engine_font_cpp_CBitFont_getCharHeight_FUN_004d01d0(this_ptr,0xc5);
        iVar2 = iVar2 + iVar5;
        iVar6 = iVar1;
  ...
  if ((uint)(this_ptr->max_char_height + iVar5) < (uint)screen_height) {
    ...
    g_ActiveRenderColor = 4;
    iVar6 = engine_font_cpp_CBitFont_getCharHeight_FUN_004d01d0(this_ptr,0xc5);
    iVar6 = iVar6 + iVar5;
    iVar1 = iVar3;
    iVar2 = engine_font_cpp_CBitFont_getCharHeight_FUN_004d01d0(this_ptr,0xc5);
  ...
  if ((uint)(this_ptr->max_char_height + iVar5) < (uint)screen_height) {
    ...
    g_ActiveRenderColor = 4;
    iVar4 = engine_font_cpp_CBitFont_getCharHeight_FUN_004d01d0(this_ptr,0xc5);
    iVar4 = iVar4 + iVar5;
    iVar1 = iVar2;
    iVar6 = engine_font_cpp_CBitFont_getCharHeight_FUN_004d01d0(this_ptr,0xc5);
  ...
  iVar1 = engine_font_cpp_CBitFont_getCharYOffset_FUN_004d0200(this_ptr,0xff);
  iVar4 = engine_font_cpp_CBitFont_getCharHeight_FUN_004d01d0(this_ptr,0xff);
  iVar6 = engine_font_cpp_CBitFont_getCharWidth_FUN_004d01a0(this_ptr,0xff);
  engine_font_cpp_CBitFont_drawTextF_FUN_004cdc20
            (this_ptr,(uint)screen_width >> 1,iVar5,1,6,&s_MaxChar_0062a8ad,iVar6,iVar4,iVar1);
  return;
}
