...
;                               FUNCTION
; *****************************************************************************
; __cdecl int engine_font.cpp_CBitFont_drawTextCenterInClipF_FUN_004ce090(CBitFont * this_ptr, int y_pos, int color_mode, int color_value, char * format_string, va_list_t * args)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 004ce0ae
    CALL crt_stdio.c_vsprintf_FUN_005fdba8 ; 004ce0af | int crt_stdio.c_vsprintf_FUN_005fdba8(char * buffer, char * format, va_list_t * args)
    ...
    PUSH EBP                            ; 004ce0d9
    CALL engine_font.cpp_CBitFont_drawTextCenterInClip_FUN_004cdff0 ; 004ce0da | int engine_font.cpp_CBitFont_drawTextCenterInClip_FUN_004cdff0(CBitFont * this_ptr, int y_pos, int color_mode, int color_value, ...)
