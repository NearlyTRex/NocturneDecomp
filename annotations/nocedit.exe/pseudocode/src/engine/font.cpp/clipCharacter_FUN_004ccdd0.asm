...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl engine_font_cpp_clipCharacter_FUN_004ccdd0 (int *bitmap_offset,int *left_x,int *top_y,int *right_x,int *bottom_y,int bitmap_width)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004ccdd0
        ;   Label: engine_font.cpp_clipCharacter_FUN_004ccdd0
    PUSH ESI                            ; 004ccdd1
    PUSH EDI                            ; 004ccdd2
    PUSH EBP                            ; 004ccdd3
    MOV ESI,dword ptr [0x02d0255c]      ; 004ccdd4 | g_ClipTop
    MOV EDI,dword ptr [0x02d02558]      ; 004ccdda | g_ClipLeft
    ...
    JGE 0x004cce0c                      ; 004ccdf4
        ;   XREF to: 004cce0c (CONDITIONAL_JUMP)  ; LAB_004cce0c
    MOV EAX,dword ptr [ESP + 0x20]      ; 004ccdf6
    MOV EAX,dword ptr [EAX]             ; 004ccdfa
    CMP EAX,EDI                         ; 004ccdfc
    JL 0x004cce6d                       ; 004ccdfe
        ;   XREF to: 004cce6d (CONDITIONAL_JUMP)  ; LAB_004cce6d
    ...
    CMP EAX,dword ptr [0x02d02560]      ; 004cce12 | g_ClipRight
    JLE 0x004cce2e                      ; 004cce18
        ;   XREF to: 004cce2e (CONDITIONAL_JUMP)  ; LAB_004cce2e
    MOV EAX,dword ptr [ECX]             ; 004cce1a
    MOV ECX,dword ptr [0x02d02560]      ; 004cce1c | g_ClipRight
    CMP EAX,ECX                         ; 004cce22
    JG 0x004cce6d                       ; 004cce24
        ;   XREF to: 004cce6d (CONDITIONAL_JUMP)  ; LAB_004cce6d
    ...
    JGE 0x004cce48                      ; 004cce32
        ;   XREF to: 004cce48 (CONDITIONAL_JUMP)  ; LAB_004cce48
    MOV EAX,dword ptr [EBP]             ; 004cce34
    CMP EAX,ESI                         ; 004cce37
    JL 0x004cce6d                       ; 004cce39
        ;   XREF to: 004cce6d (CONDITIONAL_JUMP)  ; LAB_004cce6d
    ...
    MOV EBX,dword ptr [0x02d02564]      ; 004cce48 | g_ClipBottom
        ;   Label: LAB_004cce48
    CMP EBX,dword ptr [EBP]             ; 004cce4e
    JGE 0x004cce5a                      ; 004cce51
        ;   XREF to: 004cce5a (CONDITIONAL_JUMP)  ; LAB_004cce5a
    CMP EBX,dword ptr [EDX]             ; 004cce53
    JL 0x004cce6d                       ; 004cce55
        ;   XREF to: 004cce6d (CONDITIONAL_JUMP)  ; LAB_004cce6d
    MOV dword ptr [EBP],EBX             ; 004cce57
    XOR EAX,EAX                         ; 004cce5a
        ;   Label: LAB_004cce5a
    MOV dword ptr [0x02d02558],EDI      ; 004cce5c | g_ClipLeft
    MOV dword ptr [0x02d0255c],ESI      ; 004cce62 | g_ClipTop
    POP EBP                             ; 004cce68
    POP EDI                             ; 004cce69
    POP ESI                             ; 004cce6a
    POP EBX                             ; 004cce6b
    ...
    MOV EAX,0x1                         ; 004cce6d
        ;   Label: LAB_004cce6d
    MOV dword ptr [0x02d02558],EDI      ; 004cce72 | g_ClipLeft
    MOV dword ptr [0x02d0255c],ESI      ; 004cce78 | g_ClipTop
    POP EBP                             ; 004cce7e
    POP EDI                             ; 004cce7f
    POP ESI                             ; 004cce80
    POP EBX                             ; 004cce81
