...
;
; XREF[1]:
;   engine_font.cpp_CBitFont_printCenterFV_FUN_004ce090 at 004ce0da
;
; Referenced Globals:
;   int g_ClipLeft
;   int g_ClipRight
...
section .text
    ...
    PUSH EDX                            ; 004ce00c
    MOV EDI,dword ptr [0x02d02560]      ; 004ce00d | g_ClipRight
    MOV EBX,dword ptr [0x02d02558]      ; 004ce013 | g_ClipLeft
    PUSH EBP                            ; 004ce019
    ADD EBX,EDI                         ; 004ce01a
    CALL engine_font.cpp_CBitFont_getTextWidth_FUN_004cfe80 ; 004ce01c
