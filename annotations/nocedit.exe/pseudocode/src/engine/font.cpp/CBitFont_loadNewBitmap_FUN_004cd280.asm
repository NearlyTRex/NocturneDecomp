...
section .text
    ...
    PUSH EBX                            ; 004cd287
    CALL engine_font.cpp_CBitFont_free_FUN_004cd4e0 ; 004cd288
    ...
    CALL engine_font.cpp_CBitFont_loadBitmap_FUN_004ccff0 ; 004cd2af
        ;   XREF to: 004ccff0 (UNCONDITIONAL_CALL)  ; void engine_font.cpp_CBitFont_loadBitmap_FUN_004ccff0(CBitFont * this_ptr, char * filename, int width, int height, ...)
