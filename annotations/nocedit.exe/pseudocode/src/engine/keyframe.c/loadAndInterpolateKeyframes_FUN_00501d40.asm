...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_keyframe.c_loadAndInterpolateKeyframes_FUN_00501d40(SMRGLKeyframeModel * keyframe_model)
;
; Parameters:
...
section .text
    ...
    JZ 0x00501e8e                       ; 00501d4f | LAB_00501e8e
        ;   XREF to: 00501e8e (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x1c]      ; 00501d55
        ;   Label: LAB_00501d55
    MOV ECX,dword ptr [EAX + 0x14]      ; 00501d59
    PUSH ECX                            ; 00501d5c
    CALL engine_model.c_getMRGLSize_FUN_00528700 ; 00501d5d | int engine_model.c_getMRGLSize_FUN_00528700(SMRGLHeaderExtended * header)
    ...
    PUSH EAX                            ; 00501d70
    CALL engine_model.c_getMRGLSize_FUN_00528700 ; 00501d71 | int engine_model.c_getMRGLSize_FUN_00528700(SMRGLHeaderExtended * header)
        ;   XREF to: 00528700 (UNCONDITIONAL_CALL)
    ...
    JLE 0x00501db8                      ; 00501d86 | LAB_00501db8
        ;   XREF to: 00501db8 (CONDITIONAL_JUMP)
    LEA EDI,[EAX + 0x18]                ; 00501d88
    MOV EBX,EAX                         ; 00501d8b
    CMP dword ptr [EBX + 0x118],0x0     ; 00501d8d
        ;   Label: LAB_00501d8d
    JNZ 0x00501da6                      ; 00501d94 | LAB_00501da6
        ;   XREF to: 00501da6 (CONDITIONAL_JUMP)
    PUSH EBP                            ; 00501d96
    PUSH EDI                            ; 00501d97
    CALL engine_model.c_loadModelChunk_FUN_00528970 ; 00501d98 | SMRGLHeaderExtended * engine_model.c_loadModelChunk_FUN_00528970(char * filename, int model_size)
    ...
    JL 0x00501d8d                       ; 00501db6 | LAB_00501d8d
    ...
    JLE 0x00501e3f                      ; 00501dcd | LAB_00501e3f
    ...
    JZ 0x00501e05                       ; 00501de0 | LAB_00501e05
        ;   XREF to: 00501e05 (CONDITIONAL_JUMP)
    MOV EDX,0x630ca8                    ; 00501de2 | = "..\\engine\\keyframe.c" | s_engine_keyframe_c_00630ca8 = ..\engine\keyframe.c
    MOV ECX,0xfd                        ; 00501de7
    PUSH 0x630cbd                       ; 00501dec | = "Bad key frame" | s_Bad_key_frame_00630cbd = Bad key frame
    MOV dword ptr [0x02f0ca48],EDX      ; 00501df1 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 00501df7 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00501dfd | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00501e02
    MOV EDX,dword ptr [EDI + 0x8]       ; 00501e05
        ;   Label: LAB_00501e05
    CMP EDX,dword ptr [EBP + 0x8]       ; 00501e08
    JZ 0x00501e30                       ; 00501e0b | LAB_00501e30
        ;   XREF to: 00501e30 (CONDITIONAL_JUMP)
    MOV ECX,0x630ccb                    ; 00501e0d | = "..\\engine\\keyframe.c" | s_engine_keyframe_c_00630ccb = ..\engine\keyframe.c
    MOV EDI,0xfe                        ; 00501e12
    PUSH 0x630ce0                       ; 00501e17 | = "Key frame vertex mismatch" | s_Key_frame_vertex_mismatc_00630ce0 = Key frame vertex mismatch
    MOV dword ptr [0x02f0ca48],ECX      ; 00501e1c | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 00501e22 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00501e28 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ...
    JL 0x00501dd1                       ; 00501e3d | LAB_00501dd1
    ...
    JLE 0x00501e86                      ; 00501e58 | LAB_00501e86
    ...
    JNZ 0x00501ea6                      ; 00501e6d | LAB_00501ea6
    ...
    JL 0x00501e5c                       ; 00501e84 | LAB_00501e5c
    ...
    ADD EAX,0x18                        ; 00501e8e
        ;   Label: LAB_00501e8e
    PUSH EAX                            ; 00501e91
    CALL engine_model.c_loadModelFile_FUN_00527ec0 ; 00501e92 | SMRGLHeaderExtended * engine_model.c_loadModelFile_FUN_00527ec0(char * filename)
    ...
    JMP 0x00501d55                      ; 00501ea1 | LAB_00501d55
    ...
    JC 0x00501ec3                       ; 00501ebc | LAB_00501ec3
    ...
    JLE 0x00501e6f                      ; 00501eea | LAB_00501e6f
    ...
    JGE 0x00501e6f                      ; 00501f1d | LAB_00501e6f
        ;   XREF to: 00501e6f (CONDITIONAL_JUMP)
    JMP 0x00501eec                      ; 00501f23 | LAB_00501eec
