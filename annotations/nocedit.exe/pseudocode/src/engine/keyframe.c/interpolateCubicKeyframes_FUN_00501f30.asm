...
;                               FUNCTION
; *****************************************************************************
; __cdecl SMRGLHeaderExtended * __cdecl engine_keyframe_c_interpolateCubicKeyframes_FUN_00501f30(SMRGLHeaderExtended *header)
;
; Parameters:
...
section .text
    ...
    JZ 0x005022c8                       ; 00501f43
        ;   XREF to: 005022c8 (CONDITIONAL_JUMP)  ; LAB_005022c8
    ...
    JC 0x00501f70                       ; 00501f69
        ;   XREF to: 00501f70 (CONDITIONAL_JUMP)  ; LAB_00501f70
    ...
    MOV EDX,dword ptr [0x02cf6a84]      ; 00501f7c | g_AnimationTimerValue
    ...
    JL 0x00501fab                       ; 00501fa7
        ;   XREF to: 00501fab (CONDITIONAL_JUMP)  ; LAB_00501fab
    ...
    JL 0x00501fc2                       ; 00501fba
        ;   XREF to: 00501fc2 (CONDITIONAL_JUMP)  ; LAB_00501fc2
    XOR EDI,EDI                         ; 00501fbc
    MOV dword ptr [ESP + 0x24],EDI      ; 00501fbe
    LEA EDI,[EBX + -0x1]                ; 00501fc2
        ;   Label: LAB_00501fc2
    TEST EDI,EDI                        ; 00501fc5
    JL 0x005022d6                       ; 00501fc7
        ;   XREF to: 005022d6 (CONDITIONAL_JUMP)  ; LAB_005022d6
    ...
    JZ 0x00502003                       ; 00501fdf
        ;   XREF to: 00502003 (CONDITIONAL_JUMP)  ; LAB_00502003
    MOV ECX,0x630cfa                    ; 00501fe1 | = "..\\engine\\keyframe.c"
    MOV EAX,0x16b                       ; 00501fe6
    PUSH 0x630d0f                       ; 00501feb | = "Bad keyframe 1"
    MOV dword ptr [0x02f0ca48],ECX      ; 00501ff0 | g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 00501ff6 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00501ffb
    ...
    FMUL double ptr [0x00630d48]        ; 0050203f | g_SplineNormalizer
    FLD ST0                             ; 00502045
    FMUL ST1                            ; 00502047
    FLD ST0                             ; 00502049
    FMUL ST2                            ; 0050204b
    FLD ST1                             ; 0050204d
    FMUL float ptr [0x00630d68]         ; 0050204f | g_SplineCoeff_T2_W3
    FLD ST1                             ; 00502055
    FMUL float ptr [0x00630d50]         ; 00502057 | g_SplineCoeff_T3_W0
    FLD ST2                             ; 0050205d
    FMUL float ptr [0x00630d60]         ; 0050205f | g_SplineCoeff_T3_W2
    FLD ST3                             ; 00502065
    FXCH ST2                            ; 00502067
    FADD ST0,ST5                        ; 00502069
    FXCH ST2                            ; 0050206b
    FMUL float ptr [0x00630d6c]         ; 0050206d | g_SplineCoeff_T3_W3
    FXCH ST6                            ; 00502073
    FMUL float ptr [0x00630d54]         ; 00502075 | g_SplineCoeff_T1_W0
    FXCH ST4                            ; 0050207b
    FMUL float ptr [0x00630d54]         ; 0050207d | g_SplineCoeff_T1_W0
    FXCH ST4                            ; 00502083
    FSTP float ptr [ESP + 0x2c]         ; 00502085
    FXCH                                ; 00502089
    FSUB float ptr [ESP + 0x2c]         ; 0050208b
    FLD ST4                             ; 0050208f
    FMUL float ptr [0x00630d54]         ; 00502091 | g_SplineCoeff_T1_W0
    FXCH                                ; 00502097
    FMUL double ptr [0x00630d58]        ; 00502099 | g_SplineCoeff_Scale
    FXCH                                ; 0050209f
    FSUBP ST4,ST0                       ; 005020a1
    FXCH ST4                            ; 005020a3
    FMUL float ptr [0x00630d64]         ; 005020a5 | g_SplineCoeff_T2_W2
    FXCH ST3                            ; 005020ab
    FMUL double ptr [0x00630d58]        ; 005020ad | g_SplineCoeff_Scale
    FXCH ST3                            ; 005020b3
    FADDP                               ; 005020b5
    FXCH ST4                            ; 005020b7
    FADDP                               ; 005020b9
    ...
    FXCH ST3                            ; 005020c3
    FMUL double ptr [0x00630d58]        ; 005020c5 | g_SplineCoeff_Scale
    FXCH ST3                            ; 005020cb
    FMUL double ptr [0x00630d58]        ; 005020cd | g_SplineCoeff_Scale
    ...
    FXCH                                ; 005020fa
    CALL crt_math.c_round_FUN_005fe6b0  ; 005020fc
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    FISTP dword ptr [ESP + 0x1c]        ; 00502101
    FXCH                                ; 00502105
    CALL crt_math.c_round_FUN_005fe6b0  ; 00502107
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    FXCH ST2                            ; 0050210c
    CALL crt_math.c_round_FUN_005fe6b0  ; 0050210e
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    FXCH                                ; 00502113
    CALL crt_math.c_round_FUN_005fe6b0  ; 00502115
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    FXCH ST2                            ; 0050211a
    ...
    JLE 0x00502267                      ; 0050212a
        ;   XREF to: 00502267 (CONDITIONAL_JUMP)  ; LAB_00502267
    ...
    JL 0x00502130                       ; 00502261
        ;   XREF to: 00502130 (CONDITIONAL_JUMP)  ; LAB_00502130
    MOV ESI,dword ptr [ECX]             ; 00502267
        ;   Label: LAB_00502267
    MOV EBX,ECX                         ; 00502269
    CMP ESI,0x17                        ; 0050226b
    JNZ 0x005022e2                      ; 0050226e
        ;   XREF to: 005022e2 (CONDITIONAL_JUMP)  ; LAB_005022e2
    ...
    JC 0x00502293                       ; 00502281
        ;   XREF to: 00502293 (CONDITIONAL_JUMP)  ; LAB_00502293
    JA 0x00502315                       ; 00502283
        ;   XREF to: 00502315 (CONDITIONAL_JUMP)  ; LAB_00502315
    PUSH EBX                            ; 00502289
    PUSH ESI                            ; 0050228a
    CALL engine_keyframe.c_calculateSurfaceNormal_FUN_00501bc0 ; 0050228b
    ...
    PUSH EBX                            ; 00502293
        ;   Label: LAB_00502293
    CALL engine_model.c_getMRGLSize_FUN_00528700 ; 00502294
    ...
    JNZ 0x0050227c                      ; 005022a8
        ;   XREF to: 0050227c (CONDITIONAL_JUMP)  ; LAB_0050227c
    MOV EAX,dword ptr [EBP + 0x14]      ; 005022aa
    MOV ECX,dword ptr [EAX + 0x14]      ; 005022ad
    PUSH ECX                            ; 005022b0
    CALL engine_3d.c_dispatchMRGLBlockChain_FUN_00407890 ; 005022b1
    ...
    PUSH EAX                            ; 005022c8
        ;   Label: LAB_005022c8
    CALL engine_keyframe.c_loadAndInterpolateKeyframes_FUN_00501d40 ; 005022c9
    ...
    JMP 0x00501f49                      ; 005022d1
        ;   XREF to: 00501f49 (UNCONDITIONAL_JUMP)  ; LAB_00501f49
    MOV EDI,dword ptr [EBP + 0x14]      ; 005022d6
        ;   Label: LAB_005022d6
    MOV EDI,dword ptr [EDI + 0x8]       ; 005022d9
    DEC EDI                             ; 005022dc
    JMP 0x00501fcd                      ; 005022dd
        ;   XREF to: 00501fcd (UNCONDITIONAL_JUMP)  ; LAB_00501fcd
    MOV EDI,0x630d1e                    ; 005022e2 | = "..\\engine\\keyframe.c"
        ;   Label: LAB_005022e2
    MOV EAX,0x1a6                       ; 005022e7
    PUSH 0x630d33                       ; 005022ec | = "ZBP not found!"
    MOV dword ptr [0x02f0ca48],EDI      ; 005022f1 | g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 005022f7 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005022fc
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ADD ESP,0x4                         ; 00502301
    JMP 0x00502270                      ; 00502304
        ;   XREF to: 00502270 (UNCONDITIONAL_JUMP)  ; LAB_00502270
    PUSH EBX                            ; 00502309
        ;   Label: LAB_00502309
    PUSH ESI                            ; 0050230a
    CALL engine_keyframe.c_calculatePackedSurfaceNormal_FUN_00501a00 ; 0050230b
    ...
    JMP 0x00502290                      ; 00502310
        ;   XREF to: 00502290 (UNCONDITIONAL_JUMP)  ; LAB_00502290
    CMP ECX,0x19                        ; 00502315
        ;   Label: LAB_00502315
    JZ 0x00502309                       ; 00502318
        ;   XREF to: 00502309 (CONDITIONAL_JUMP)  ; LAB_00502309
    JMP 0x00502293                      ; 0050231a
        ;   XREF to: 00502293 (UNCONDITIONAL_JUMP)  ; LAB_00502293
