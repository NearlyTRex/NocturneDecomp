...

{
  ...
  piVar18 = (int *)((&header[0x17].base.count)[local_18] + 0x14);
  ...
  if (0 < iVar5) {
    do {
      *piVar14 = ((uint)((longlong)iVar20 * (longlong)*piVar19) >> 0x10 |
                 ...
                 ((uint)((longlong)local_30 * (longlong)*piVar18) >> 0x10 |
                 (int)((ulonglong)((longlong)local_30 * (longlong)*piVar18) >> 0x20) << 0x10);
      piVar14[1] = ((uint)((longlong)iVar20 * (longlong)piVar19[1]) >> 0x10 |
                   ...
                   ((uint)((longlong)iVar4 * (longlong)local_24[1]) >> 0x10 |
                   (int)((ulonglong)((longlong)iVar4 * (longlong)local_24[1]) >> 0x20) << 0x10) +
                   ((uint)((longlong)local_30 * (longlong)piVar18[1]) >> 0x10 |
                   (int)((ulonglong)((longlong)local_30 * (longlong)piVar18[1]) >> 0x20) << 0x10);
      piVar1 = piVar19 + 2;
      piVar2 = piVar17 + 2;
      piVar19 = piVar19 + 3;
      piVar17 = piVar17 + 3;
      ...
      piVar14[2] = ((uint)((longlong)iVar20 * (longlong)*piVar1) >> 0x10 |
                   ...
                   ((uint)((longlong)iVar4 * (longlong)local_24[2]) >> 0x10 |
                   (int)((ulonglong)((longlong)iVar4 * (longlong)local_24[2]) >> 0x20) << 0x10) +
                   ((uint)((longlong)local_30 * (longlong)*piVar3) >> 0x10 |
                   (int)((ulonglong)((longlong)local_30 * (longlong)*piVar3) >> 0x20) << 0x10);
      local_28 = local_28 + 1;
      local_24 = local_24 + 3;
      piVar14 = piVar13;
    } while (local_28 < *(int *)(uVar15 + 8));
  }
  if (*piVar13 != 0x17) {
    g_CurrentFilename = "..\\engine\\keyframe.c";
