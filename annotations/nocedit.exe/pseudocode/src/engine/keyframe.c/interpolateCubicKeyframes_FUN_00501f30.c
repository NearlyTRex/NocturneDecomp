...

{
  ...
  piVar13 = (int *)((&header[0x17].base.count)[local_18] + 0x14);
  ...
  if (0 < extraout_EDX) {
    do {
      *piVar8 = ((uint)((longlong)iVar15 * (longlong)*piVar14) >> 0x10 |
                ...
                ((uint)((longlong)local_30 * (longlong)*piVar13) >> 0x10 |
                (int)((ulonglong)((longlong)local_30 * (longlong)*piVar13) >> 0x20) << 0x10);
      piVar8[1] = ((uint)((longlong)iVar15 * (longlong)piVar14[1]) >> 0x10 |
                  ...
                  ((uint)((longlong)local_30 * (longlong)piVar13[1]) >> 0x10 |
                  (int)((ulonglong)((longlong)local_30 * (longlong)piVar13[1]) >> 0x20) << 0x10);
      piVar1 = piVar14 + 2;
      piVar2 = piVar12 + 2;
      piVar14 = piVar14 + 3;
      piVar12 = piVar12 + 3;
