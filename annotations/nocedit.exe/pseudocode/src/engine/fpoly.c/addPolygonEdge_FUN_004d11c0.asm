...
section .text
    ...
    PUSH EBX                            ; 004d11c0
        ;   Label: engine_fpoly.c_addPolygonEdge_FUN_004d11c0
    PUSH ESI                            ; 004d11c1
    PUSH EDI                            ; 004d11c2
    PUSH EBP                            ; 004d11c3
    ...
    MOV dword ptr [ECX + 0x4],EAX       ; 004d1212 | g_HardwareEdgeTable[0].y_max
    ...
    MOV EAX,dword ptr [ESI + 0x10]      ; 004d122c
        ;   Label: LAB_004d122c
    MOV dword ptr [ECX + 0x8],EAX       ; 004d122f | g_HardwareEdgeTable[0].x_current
    MOV EAX,dword ptr [ESI + 0x18]      ; 004d1232
    MOV dword ptr [ECX + 0x18],EAX      ; 004d1235 | g_HardwareEdgeTable[0].u_current
    MOV EAX,dword ptr [ESI + 0x1c]      ; 004d1238
    MOV dword ptr [ECX + 0x20],EAX      ; 004d123b | g_HardwareEdgeTable[0].v_current
    ...
    MOV dword ptr [ECX + 0xc],EAX       ; 004d1264 | g_HardwareEdgeTable[0].x_gradient
    ...
    MOV dword ptr [ECX + 0x1c],EAX      ; 004d1277 | g_HardwareEdgeTable[0].u_gradient
    ...
    MOV dword ptr [ECX + 0x24],EAX      ; 004d128c | g_HardwareEdgeTable[0].v_gradient
    MOV EBX,dword ptr [ESI + 0x14]      ; 004d128f
    AND EBX,0xffff                      ; 004d1292
    XOR BX,0xffff                       ; 004d1298
    MOV EDX,dword ptr [ECX + 0xc]       ; 004d129c | g_HardwareEdgeTable[0].x_gradient
    MOV EAX,EBX                         ; 004d129f
    IMUL EDX                            ; 004d12a1
    SHRD EAX,EDX,0x10                   ; 004d12a3
    MOV ESI,dword ptr [ECX + 0x8]       ; 004d12a7 | g_HardwareEdgeTable[0].x_current
    MOV EDX,dword ptr [ECX + 0x1c]      ; 004d12aa | g_HardwareEdgeTable[0].u_gradient
    ADD ESI,EAX                         ; 004d12ad
    MOV EAX,EBX                         ; 004d12af
    MOV dword ptr [ECX + 0x8],ESI       ; 004d12b1 | g_HardwareEdgeTable[0].x_current
    IMUL EDX                            ; 004d12b4
    SHRD EAX,EDX,0x10                   ; 004d12b6
    MOV EDI,dword ptr [ECX + 0x18]      ; 004d12ba | g_HardwareEdgeTable[0].u_current
    MOV EDX,dword ptr [ECX + 0x24]      ; 004d12bd | g_HardwareEdgeTable[0].v_gradient
    ADD EDI,EAX                         ; 004d12c0
    MOV EAX,EBX                         ; 004d12c2
    MOV dword ptr [ECX + 0x18],EDI      ; 004d12c4 | g_HardwareEdgeTable[0].u_current
    IMUL EDX                            ; 004d12c7
    SHRD EAX,EDX,0x10                   ; 004d12c9
    MOV EBP,dword ptr [ECX + 0x20]      ; 004d12cd | g_HardwareEdgeTable[0].v_current
    ADD EBP,EAX                         ; 004d12d0
    MOV EAX,[0x02d7b428]                ; 004d12d2 | g_EdgeCount
    INC EAX                             ; 004d12d7
    MOV dword ptr [ECX + 0x20],EBP      ; 004d12d8 | g_HardwareEdgeTable[0].v_current
