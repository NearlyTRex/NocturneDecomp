...
section .text
    ...
    PUSH 0x153                          ; 004b264d
        ;   Label: LAB_004b264d
    PUSH 0x626129                       ; 004b2652 | = "..\\engine\\fileio.cpp" | s_engine_fileio_cpp_00626129 = ..\engine\fileio.cpp
    PUSH 0x6261e5                       ; 004b2657 | = "rt" | s_rt_006261e5 = rt
    PUSH 0x0                            ; 004b265c
    PUSH EDI                            ; 004b265e
    CALL shape_memdbg.cpp_openFile_FUN_0050f7a0 ; 004b265f | FILE * shape_memdbg.cpp_openFile_FUN_0050f7a0(char * filename, char * directory, char * mode, char * source_file, ...)
        ;   XREF to: 0050f7a0 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 004b2664
    ADD ESP,0x14                        ; 004b2666
    TEST EAX,EAX                        ; 004b2669
    JNZ 0x004b2740                      ; 004b266b | LAB_004b2740
        ;   XREF to: 004b2740 (CONDITIONAL_JUMP)
    CALL crt_errno.c_errno_FUN_00601450 ; 004b2671 | undefined crt_errno.c_errno_FUN_00601450()
        ;   XREF to: 00601450 (UNCONDITIONAL_CALL)
    CMP dword ptr [EAX],0x6             ; 004b2676
    JZ 0x004b2725                       ; 004b2679 | LAB_004b2725
    ...
    JZ 0x004b2757                       ; 004b2686 | LAB_004b2757
    ...
    CALL engine_fileio.cpp_readTimestampFile_FUN_004b23a0 ; 004b26a6 | int engine_fileio.cpp_readTimestampFile_FUN_004b23a0(FILE * file, STimestampRecord * * records, int * count)
    ...
    JZ 0x004b26cf                       ; 004b26b5 | LAB_004b26cf
        ;   XREF to: 004b26cf (CONDITIONAL_JUMP)
    PUSH 0xc4                           ; 004b26b7
    PUSH 0x62604b                       ; 004b26bc | = "..\\engine\\fileio.cpp" | s_engine_fileio_cpp_0062604b = ..\engine\fileio.cpp
    PUSH EBP                            ; 004b26c1
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 004b26c2 | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
    ...
    JL 0x004b26e4                       ; 004b26f8 | LAB_004b26e4
        ;   XREF to: 004b26e4 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [ESP + 0x4]       ; 004b26fa
        ;   Label: LAB_004b26fa
    TEST EBX,EBX                        ; 004b26fe
    JZ 0x004b271b                       ; 004b2700 | LAB_004b271b
        ;   XREF to: 004b271b (CONDITIONAL_JUMP)
    PUSH 0x201                          ; 004b2702
    PUSH 0x6261e8                       ; 004b2707 | = "..\\engine\\fileio.cpp" | s_engine_fileio_cpp_006261e8 = ..\engine\fileio.cpp
    PUSH EBX                            ; 004b270c
    XOR EBP,EBP                         ; 004b270d
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 004b270f | void shape_memdbg.cpp_debugFree_FUN_0050f460(void * ptr, char * filename, int line_number)
    ...
    PUSH 0x1f4                          ; 004b2725
        ;   Label: LAB_004b2725
    INC ESI                             ; 004b272a
    CALL dword ptr CS:[0x611644]        ; 004b272b | Sleep * Sleep
    CMP ESI,0xa                         ; 004b2732
    JL 0x004b264d                       ; 004b2735 | LAB_004b264d
        ;   XREF to: 004b264d (CONDITIONAL_JUMP)
    JMP 0x004b267f                      ; 004b273b | LAB_004b267f
    ...
    PUSH 0x0                            ; 004b2747
    PUSH EAX                            ; 004b2749
    CALL crt_stdio.c_setvbuf_FUN_00601490 ; 004b274a | int crt_stdio.c_setvbuf_FUN_00601490(FILE * stream_ptr, char * buffer_ptr, int buffer_mode, SIZE_T buffer_size)
        ;   XREF to: 00601490 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004b274f
    JMP 0x004b2681                      ; 004b2752 | LAB_004b2681
