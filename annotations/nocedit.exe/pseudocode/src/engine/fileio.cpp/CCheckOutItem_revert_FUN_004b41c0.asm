...
section .text
    ...
    PUSH 0x626a5d                       ; 004b41ce | = "*" | s_anon_00626a5d = *
    PUSH 0x626a5f                       ; 004b41d3 | = "Select file to undo check out" | s_Select_file_to_undo_chec_00626a5f = Select file to undo check out
    LEA EAX,[ESP + 0x8]                 ; 004b41d8
    PUSH EAX                            ; 004b41dc
    MOV EDX,dword ptr [ESP + 0x11c]     ; 004b41dd
    PUSH EDX                            ; 004b41e4
    PUSH EBX                            ; 004b41e5
    CALL engine_fileio.cpp_CCheckOutItem_selectCheckedOutFile_FUN_004b3f50 ; 004b41e6 | int engine_fileio.cpp_CCheckOutItem_selectCheckedOutFile_FUN_004b3f50(CCheckOutItem * this_ptr, char * filename_out, char * out_buffer, char * wildcard_pattern, ...)
        ;   XREF to: 004b3f50 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 004b41eb
    TEST EAX,EAX                        ; 004b41ee
    JNZ 0x004b41fa                      ; 004b41f0 | LAB_004b41fa
    ...
    PUSH EAX                            ; 004b41fc
    PUSH EBX                            ; 004b41fd
    CALL engine_fileio.cpp_CCheckOutItem_removeCheckOutBookkeeping_FUN_004b35a0 ; 004b41fe | int engine_fileio.cpp_CCheckOutItem_removeCheckOutBookkeeping_FUN_004b35a0(CCheckOutItem * this_ptr, void * unused_param)
        ;   XREF to: 004b35a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004b4203
    TEST EAX,EAX                        ; 004b4206
    JZ 0x004b41f2                       ; 004b4208 | LAB_004b41f2
        ;   XREF to: 004b41f2 (CONDITIONAL_JUMP)
    MOV EAX,ESP                         ; 004b420a
    PUSH EAX                            ; 004b420c
    PUSH EBX                            ; 004b420d
    CALL engine_fileio.cpp_getLatestFileFromRepository_FUN_004b3220 ; 004b420e | int engine_fileio.cpp_getLatestFileFromRepository_FUN_004b3220(char * base_directory, char * filename)
