...

{
  ...
  if (0 < local_a08.file_count) {
    do {
      ...
      if (iVar3 == 0) {
        sprintf(local_1208,"%s\tNo local file",&local_234);
        ...
        local_20 = local_20 + 1;
               ...
               local_234.timestamp) {
        sprintf(local_1208,"%s\tLocal file is newer",&local_234);
        shape_edittool_cpp_CStrList_add_FUN_004a2b80(&local_5dc.base,local_1208);
        local_10 = local_10 + 1;
      }
      else if (local_234.timestamp <
               *(int *)((int)&(local_a08.directory_entries)->timestamp + iVar2) - 2U) {
        sprintf(local_1208,"%s\tLocal file is older",&local_234);
        shape_edittool_cpp_CStrList_add_FUN_004a2b80(&local_5dc.base,local_1208);
        local_18 = local_18 + 1;
      }
      else if (local_234.file_size == *(uint *)((int)&(local_a08.directory_entries)->size + iVar2))
      {
        sprintf(local_1208,"%s\tsame",&local_234);
        shape_edittool_cpp_CStrList_add_FUN_004a2b80(&local_5dc.base,local_1208);
        local_14 = local_14 + 1;
      }
      else {
        sprintf(local_1208,"%s\tLocal file has different size",&local_234);
        shape_edittool_cpp_CStrList_add_FUN_004a2b80(&local_5dc.base,local_1208);
        local_1c = local_1c + 1;
      }
      iVar4 = iVar4 + 1;
  ...
  iVar4 = sprintf(local_1208 + iVar2,"-----------------------\n");
  pcVar5 = local_1208 + iVar2 + iVar4;
  if (0 < local_14) {
    iVar2 = sprintf(pcVar5,"%d files in sync with local files\n",local_14);
    pcVar5 = pcVar5 + iVar2;
  }
  if (0 < local_20) {
    iVar2 = sprintf(pcVar5,"%d files in pod don't exist locally\n",local_20);
    pcVar5 = pcVar5 + iVar2;
  }
  if (0 < local_10) {
    iVar2 = sprintf(pcVar5,"%d files with local file newer than file in pod\n",local_10);
    pcVar5 = pcVar5 + iVar2;
  }
  if (0 < local_18) {
    iVar2 = sprintf(pcVar5,"%d files with local file older than file in pod\n",local_18);
    pcVar5 = pcVar5 + iVar2;
  }
  if (0 < local_1c) {
    iVar2 = sprintf(pcVar5,"%d sizeMismatch\n",local_1c);
    pcVar5 = pcVar5 + iVar2;
  }
  iVar2 = sprintf(pcVar5,"-----------------------\n");
  sprintf
