...
LAB_004b39fc:
  ...
  do {
    stream_ptr = shape_memdbg_cpp_openFile_FUN_0050f7a0
                           (local_228,(char *)0x0,"r+t","..\\engine\\fileio.cpp",339)
    ;
...
LAB_004b3ae9:
    ...
    if (iVar3 == 0) {
      if (local_1c != (_FILE *)0x0) {
        shape_memdbg_cpp_closeFile_FUN_0050f9b0(local_1c,"..\\engine\\fileio.cpp",196);
        local_1c = (_FILE *)0x0;
        goto LAB_004b3b18;
      }
    }
      ...
      iVar3 = engine_fileio_cpp_CCheckOutList_findEntry_FUN_004b2e60(&local_24,filename);
      if (iVar3 < 0) {
        strcpy(local_390.name,filename);
        strcpy(local_390.value,g_VersionControlSession.primary_username);
