...
section .text
    ...
    PUSH 0x6275b1                       ; 004b53ee | = "ART\\%s\n" | s_ART_s_006275b1 = ART\%s

    MOV EDX,dword ptr [EAX]             ; 004b53f3
    PUSH EDX                            ; 004b53f5
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 004b53f6 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    CMP AL,0x0                          ; 004b5407
    JZ 0x004b541b                       ; 004b5409 | LAB_004b541b
    ...
    CMP AL,0x0                          ; 004b5417
    JNZ 0x004b5403                      ; 004b5419 | LAB_004b5403
    ...
    MOV AL,byte ptr [ESI]               ; 004b541e
        ;   Label: LAB_004b541e
    CMP AL,DL                           ; 004b5420
    JZ 0x004b5436                       ; 004b5422 | LAB_004b5436
        ;   XREF to: 004b5436 (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 004b5424
    JZ 0x004b5434                       ; 004b5426 | LAB_004b5434
        ;   XREF to: 004b5434 (CONDITIONAL_JUMP)
    INC ESI                             ; 004b5428
    MOV AL,byte ptr [ESI]               ; 004b5429
    CMP AL,DL                           ; 004b542b
    JZ 0x004b5436                       ; 004b542d | LAB_004b5436
        ;   XREF to: 004b5436 (CONDITIONAL_JUMP)
    INC ESI                             ; 004b542f
    CMP AL,0x0                          ; 004b5430
    JNZ 0x004b541e                      ; 004b5432 | LAB_004b541e
    ...
    JNZ 0x004b5461                      ; 004b543a | LAB_004b5461
        ;   XREF to: 004b5461 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 004b543c
    MOV ECX,0x6275b9                    ; 004b543d | = "..\\engine\\fileio.cpp" | s_engine_fileio_cpp_006275b9 = ..\engine\fileio.cpp
    MOV EBX,0x6e0                       ; 004b5442
    PUSH 0x6275ce                       ; 004b5447 | = "fileManger::extractTexture - Extensio..." | s_fileManger_extractTextur_006275ce = fileManger::extractTexture - Extension not found
    MOV dword ptr [0x02f0ca48],ECX      ; 004b544c | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 004b5452 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004b5458 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004b545d
    POP EBX                             ; 004b5460
    MOV ESI,0x6275ff                    ; 004b5461 | = ".ACT" | s_ACT_006275ff = .ACT
        ;   Label: LAB_004b5461
    PUSH EDI                            ; 004b5466
    MOV AL,byte ptr [ESI]               ; 004b5467 | = ".ACT" | s_ACT_006275ff = .ACT
        ;   Label: LAB_004b5467
    MOV byte ptr [EDI],AL               ; 004b5469
    CMP AL,0x0                          ; 004b546b
    JZ 0x004b547f                       ; 004b546d | LAB_004b547f
        ;   XREF to: 004b547f (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 004b546f | s_ACT_00627600
    ADD ESI,0x2                         ; 004b5472
    MOV byte ptr [EDI + 0x1],AL         ; 004b5475
    ADD EDI,0x2                         ; 004b5478
    CMP AL,0x0                          ; 004b547b
    JNZ 0x004b5467                      ; 004b547d | LAB_004b5467
        ;   XREF to: 004b5467 (CONDITIONAL_JUMP)
    POP EDI                             ; 004b547f
        ;   Label: LAB_004b547f
    PUSH 0x627604                       ; 004b5480 | = "rb" | s_rb_00627604 = rb
    LEA EAX,[ESP + 0x4]                 ; 004b5485
    PUSH EAX                            ; 004b5489
    PUSH 0x627607                       ; 004b548a | = "art" | s_art_00627607 = art
    CALL engine_dosio.c_getFile_FUN_00481a50 ; 004b548f | FILE * engine_dosio.c_getFile_FUN_00481a50(char * directory, char * filename, char * mode)
        ;   XREF to: 00481a50 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004b5494
    TEST EAX,EAX                        ; 004b5497
    JNZ 0x004b54a1                      ; 004b5499 | LAB_004b54a1
    ...
    PUSH 0x6e7                          ; 004b54a1
        ;   Label: LAB_004b54a1
    PUSH 0x62760b                       ; 004b54a6 | = "..\\engine\\fileio.cpp" | s_engine_fileio_cpp_0062760b = ..\engine\fileio.cpp
    PUSH EAX                            ; 004b54ab
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 004b54ac | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
        ;   XREF to: 0050f9b0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004b54b1
    MOV EAX,ESP                         ; 004b54b4
    PUSH EAX                            ; 004b54b6
    MOV EAX,dword ptr [ESP + 0x60]      ; 004b54b7
    PUSH 0x627620                       ; 004b54bb | = "ART\\%s\n" | s_ART_s_00627620 = ART\%s

    MOV ESI,dword ptr [EAX]             ; 004b54c0
    PUSH ESI                            ; 004b54c2
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 004b54c3 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
