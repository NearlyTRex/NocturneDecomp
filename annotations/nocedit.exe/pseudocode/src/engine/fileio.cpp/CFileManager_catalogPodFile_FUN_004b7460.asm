...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_fileio.cpp_CFileManager_catalogPodFile_FUN_004b7460(CFileManager * this_ptr, char * pod_filename)
;
; Parameters:
...
section .text
    ...
    JNZ 0x004b74a4                      ; 004b7472 | LAB_004b74a4
        ;   XREF to: 004b74a4 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 004b7474
    LEA EAX,[ESP + 0x7d8]               ; 004b7475
    PUSH EAX                            ; 004b747c
    PUSH 0x627d97                       ; 004b747d | = "*.pod" | s_pod_00627d97 = *.pod
    PUSH 0x627d9d                       ; 004b7482 | = "Select POD file to catalog" | s_Select_POD_file_to_catal_00627d9d = Select POD file to catalog
    MOV EDX,dword ptr [0x00678a60]      ; 004b7487 | CEditorTools g_CEditorToolsPtr | CEditorTools * g_CEditorToolsPtr
    PUSH EDX                            ; 004b748d | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_showDirectoryBrowser_FUN_0049f420 ; 004b748e | bool shape_edittool.cpp_CEditorTools_showDirectoryBrowser_FUN_0049f420(CEditorTools * this_ptr, char * file_pattern, bool include_files, char * initial_path)
        ;   XREF to: 0049f420 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 004b7493
    TEST EAX,EAX                        ; 004b7496
    JNZ 0x004b74c5                      ; 004b7498 | LAB_004b74c5
    ...
    CMP AL,0x0                          ; 004b74b0
    JZ 0x004b74c4                       ; 004b74b2 | LAB_004b74c4
    ...
    CMP AL,0x0                          ; 004b74c0
    JNZ 0x004b74ac                      ; 004b74c2 | LAB_004b74ac
    ...
    MOV EAX,ESP                         ; 004b74c5
        ;   Label: LAB_004b74c5
    PUSH EAX                            ; 004b74c7
    CALL engine_pod.cpp_CPodFile_ctor_FUN_0054f5a0 ; 004b74c8 | CPodFile * engine_pod.cpp_CPodFile_ctor_FUN_0054f5a0(CPodFile * this_ptr)
    ...
    PUSH EAX                            ; 004b74dc
    CALL engine_pod.cpp_CPodFile_mountFromFile_FUN_0054f650 ; 004b74dd | int engine_pod.cpp_CPodFile_mountFromFile_FUN_0054f650(CPodFile * this_ptr, char * pod_filename)
        ;   XREF to: 0054f650 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004b74e2
    TEST EAX,EAX                        ; 004b74e5
    JZ 0x004b768f                       ; 004b74e7 | LAB_004b768f
        ;   XREF to: 004b768f (CONDITIONAL_JUMP)
    PUSH EBX                            ; 004b74ed
    LEA EAX,[ESP + 0x430]               ; 004b74ee
    PUSH EAX                            ; 004b74f5
    CALL shape_edittool.cpp_CPickList_ctor_FUN_004a3b90 ; 004b74f6 | CPickList * shape_edittool.cpp_CPickList_ctor_FUN_004a3b90(CPickList * this_ptr)
        ;   XREF to: 004a3b90 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004b74fb
    PUSH 0x1                            ; 004b74fe
    LEA EAX,[ESP + 0x434]               ; 004b7500
    PUSH EAX                            ; 004b7507
    CALL shape_edittool.cpp_CPickList_setSelectedResult_FUN_004a3e10 ; 004b7508 | void shape_edittool.cpp_CPickList_setSelectedResult_FUN_004a3e10(CPickList * this_ptr, int result_value)
    ...
    JLE 0x004b762d                      ; 004b751b | LAB_004b762d
    ...
    PUSH EAX                            ; 004b752f
    CALL crt_time.c_localtime_FUN_00600288 ; 004b7530 | tm * crt_time.c_localtime_FUN_00600288(time_t * timer)
        ;   XREF to: 00600288 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004b7535
    PUSH EAX                            ; 004b7538
    PUSH 0x627dd9                       ; 004b7539 | = "%m/%d/%y %I:%M:%S %p" | s_m_d_y_I_M_S_p_00627dd9 = %m/%d/%y %I:%M:%S %p
    PUSH 0x1e                           ; 004b753e
    LEA EAX,[ESP + 0xce4]               ; 004b7540
    PUSH EAX                            ; 004b7547
    CALL crt_time.c_strftime_FUN_006002d4 ; 004b7548 | uint crt_time.c_strftime_FUN_006002d4(char * dest_buffer, uint buffer_size, char * format_string, tm * time_ptr)
    ...
    PUSH EDX                            ; 004b7574
    CALL engine_dosio.c_splitPath_FUN_00481f20 ; 004b7575 | void engine_dosio.c_splitPath_FUN_00481f20(char * full_path, char * drive, char * directory, char * filename, ...)
        ;   XREF to: 00481f20 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 004b757a
    CMP byte ptr [ESP + 0x9d8],0x2e     ; 004b757d
    JNZ 0x004b75b1                      ; 004b7585 | LAB_004b75b1
    ...
    PUSH EAX                            ; 004b75a8
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 004b75a9 | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
    ...
    PUSH EAX                            ; 004b75dc
    PUSH 0x627dee                       ; 004b75dd | = "%s\t%s\t%s\t%d\t%s" | s_s_s_s_d_s_00627dee = %s	%s	%s	%d	%s
    LEA EAX,[ESP + 0x7f0]               ; 004b75e2
    PUSH EAX                            ; 004b75e9
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 004b75ea | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x1c                        ; 004b75ef
    LEA EAX,[ESP + 0x7d8]               ; 004b75f2
    PUSH EAX                            ; 004b75f9
    CALL crt_string.c_strupr_FUN_00600770 ; 004b75fa | char * crt_string.c_strupr_FUN_00600770(char * string)
    ...
    PUSH EAX                            ; 004b7611
    CALL shape_edittool.cpp_CStrList_add_FUN_004a2b80 ; 004b7612 | void shape_edittool.cpp_CStrList_add_FUN_004a2b80(CStrList * this_ptr, char * string_data)
    ...
    JL 0x004b7523                       ; 004b7627 | LAB_004b7523
        ;   XREF to: 004b7523 (CONDITIONAL_JUMP)
    LEA EAX,[ESP + 0x8]                 ; 004b762d
        ;   Label: LAB_004b762d
    PUSH EAX                            ; 004b7631
    PUSH 0x627dfd                       ; 004b7632 | = "Contents of pod file:\n%s" | s_Contents_of_pod_file_s_00627dfd = Contents of pod file:
        ; %s
    LEA EAX,[ESP + 0x7e0]               ; 004b7637
    PUSH EAX                            ; 004b763e
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 004b763f | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 004b765a
    CALL shape_edittool.cpp_CPickList_displayChoicesAndWaitForInput_FUN_004a3e20 ; 004b765b | int shape_edittool.cpp_CPickList_displayChoicesAndWaitForInput_FUN_004a3e20(CPickList * this_ptr, char * dialog_title, int config_param1, int config_param2)
        ;   XREF to: 004a3e20 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004b7660
    PUSH 0x0                            ; 004b7663
    LEA EAX,[ESP + 0x434]               ; 004b7665
    PUSH EAX                            ; 004b766c
    CALL shape_edittool.cpp_CPickList_dtor_FUN_004a3c80 ; 004b766d | CPickList * shape_edittool.cpp_CPickList_dtor_FUN_004a3c80(CPickList * this_ptr, uint d1, uint d2, uint d3, ...)
        ;   XREF to: 004a3c80 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004b7672
    PUSH 0x0                            ; 004b7675
    LEA EAX,[ESP + 0x8]                 ; 004b7677
    PUSH EAX                            ; 004b767b
    CALL engine_pod.cpp_CPodFile_dtor_FUN_0054f610 ; 004b767c | CPodFile * engine_pod.cpp_CPodFile_dtor_FUN_0054f610(CPodFile * this_ptr)
    ...
    LEA EAX,[ESP + 0x7d4]               ; 004b768f
        ;   Label: LAB_004b768f
    PUSH EAX                            ; 004b7696
    PUSH 0x627db8                       ; 004b7697 | = "Can't mount %s to catalog files!" | s_Can_t_mount_s_to_catalog_00627db8 = Can't mount %s to catalog files!
    MOV ECX,dword ptr [0x00678a60]      ; 004b769c | CEditorTools g_CEditorToolsPtr | CEditorTools * g_CEditorToolsPtr
    PUSH ECX                            ; 004b76a2 | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_showError_FUN_0049e740 ; 004b76a3 | void shape_edittool.cpp_CEditorTools_showError_FUN_0049e740(CEditorTools * this_ptr, char * format)
        ;   XREF to: 0049e740 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004b76a8
    PUSH 0x0                            ; 004b76ab
    LEA EAX,[ESP + 0x4]                 ; 004b76ad
    PUSH EAX                            ; 004b76b1
    CALL engine_pod.cpp_CPodFile_dtor_FUN_0054f610 ; 004b76b2 | CPodFile * engine_pod.cpp_CPodFile_dtor_FUN_0054f610(CPodFile * this_ptr)
        ;   XREF to: 0054f610 (UNCONDITIONAL_CALL)
