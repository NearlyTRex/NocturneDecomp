...
LAB_004ba895:
  ...
  if (((int)uVar4 < 0) || ((uVar4 & 8) != 0)) {
    ...
    _sprintf(&stack0xfffff964,"A writable copy of %s exists.  Replace it?",local_340)
    ;
    iVar4 = engine_fileio_cpp_showOverwriteConfirmationDialog_FUN_004b2f90
                      (&stack0xfffff964,&g_VersionControlSession.overwrite_writeable_choice);
  }
  if (0 < iVar4) {
    local_18 = -1;
...
LAB_004ba93f:
      ...
      engine_dosio_cpp_ensureTrailingSlash_FUN_00481f80
                (g_VersionControlDirectory,local_14,local_138);
...
LAB_004baa2c:
          ...
          if (iVar4 == 0) {
            if (local_20 != (CStrList_vtable *)0x0) {
              shape_memdbg_cpp_closeFile_FUN_0050f9b0
                        ((_FILE *)local_20,"..\\engine\\fileio.cpp",196);
              local_20 = (CStrList_vtable *)0x0;
            }
            shape_edittool_cpp_CEditorTools_showError_FUN_0049e740
      ...
      shape_memdbg_cpp_closeFile_FUN_0050f9b0((_FILE *)local_20,"..\\engine\\fileio.cpp",196);
      local_20 = (CStrList_vtable *)0x0;
    }
    else {
      shape_edittool_cpp_CEditorTools_displayCenteredStatusMessage_FUN_0049e790
