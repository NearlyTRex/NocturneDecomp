...
#include "nocturne.h"
typedef struct CFileManager_managePodFiles_Ctx {
    CFileManager *this_ptr;
    char *pod_directory_path;
    char cVar1;
    int iVar2;
    char *pcVar3;
    int iVar4;
    ...
    int local_18;
    char local_14[4];
} CFileManager_managePodFiles_Ctx;

// Chunk return codes for cross-boundary gotos
// 0 = normal continuation
#define GOTO_LAB_004b901b 1
#define GOTO_LAB_004b994d 2
#define GOTO_LAB_004b9978 3

// Chunk: check_iVar2_0_check_0_0 (lines 59-322 of original)
static int CFileManager_managePodFiles_check_iVar2_0_check_0_0(CFileManager_managePodFiles_Ctx *ctx) {
    ...
    SFoundFileInfo *&pSVar14 = ctx->pSVar14;
    CPodFile &local_1b38 = ctx->local_1b38;
    SFoundFileInfo &local_fbc = ctx->local_fbc;
    SFoundFileInfo &local_da8 = ctx->local_da8;
    SFoundFileInfo &local_b94 = ctx->local_b94;
    CStrList &local_94 = ctx->local_94;
    CStrList &local_84 = ctx->local_84;
    CCheckOutList &local_74 = ctx->local_74;
    int &local_68 = ctx->local_68;
    int &local_64 = ctx->local_64;
    int &local_48 = ctx->local_48;
    void *&local_44 = ctx->local_44;
    int &local_40 = ctx->local_40;
    char *&local_34 = ctx->local_34;
    char *&local_30 = ctx->local_30;
...
// Chunk: check_iVar2_0_check_0_1 (lines 324-400 of original)
static int CFileManager_managePodFiles_check_iVar2_0_check_0_1(CFileManager_managePodFiles_Ctx *ctx) {
    ...
    auto &local_494 = ctx->local_494;
    auto &local_394 = ctx->local_394;
    auto &local_294 = ctx->local_294;
    auto &local_194 = ctx->local_194;
    CStrList &local_84 = ctx->local_84;
    int &local_48 = ctx->local_48;
    void *&local_44 = ctx->local_44;
    char *&local_3c = ctx->local_3c;
...
// Chunk: check_iVar2_0_check_0_2 (lines 406-431 of original)
static int CFileManager_managePodFiles_check_iVar2_0_check_0_2(CFileManager_managePodFiles_Ctx *ctx) {
    int &iVar2 = ctx->iVar2;
    void *&pvVar10 = ctx->pvVar10;
    char *&pcVar12 = ctx->pcVar12;
    char *&pcVar13 = ctx->pcVar13;
    auto &local_2338 = ctx->local_2338;
    CPickList &local_170c = ctx->local_170c;
    int &local_48 = ctx->local_48;
...
// Chunk: check_iVar2_0_check_iVar2_3 (lines 440-584 of original)
static int CFileManager_managePodFiles_check_iVar2_0_check_iVar2_3(CFileManager_managePodFiles_Ctx *ctx) {
    CFileManager *&this_ptr = ctx->this_ptr;
    int &iVar2 = ctx->iVar2;
    int &iVar4 = ctx->iVar4;
    int &iVar6 = ctx->iVar6;
    ...
    char *&pcVar13 = ctx->pcVar13;
    auto &local_2338 = ctx->local_2338;
    CPickList &local_1364 = ctx->local_1364;
    void *&local_44 = ctx->local_44;
...
LAB_004b9590:
        ...
        while (iVar9 = shape_edittool_cpp_CPickList_displayChoicesAndWaitForInput_FUN_004a3e20
          ...
          if (iVar4 != 0) {
            iVar4 = 0;
            iVar6 = 0;
            return GOTO_LAB_004b994d;
          }
          engine_fileio_cpp_CFileManager_compareLocalVsPod_FUN_004b82a0
                    (this_ptr,(char *)((int)pvVar10 + iVar2 * 0x39c + 0x204));
        }
        return GOTO_LAB_004b9978;
    return 0;
}

// Chunk: check_iVar2_0_check_0_4 (lines 589-771 of original)
static int CFileManager_managePodFiles_check_iVar2_0_check_0_4(CFileManager_managePodFiles_Ctx *ctx) {
    CFileManager *&this_ptr = ctx->this_ptr;
    int &iVar2 = ctx->iVar2;
    uint &uVar5 = ctx->uVar5;
    _FILE *&stream_ptr = ctx->stream_ptr;
    _FILE *&dest_file = ctx->dest_file;
    int *&piVar8 = ctx->piVar8;
    int &iVar9 = ctx->iVar9;
    void *&pvVar10 = ctx->pvVar10;
    char *&pcVar12 = ctx->pcVar12;
    char *&pcVar13 = ctx->pcVar13;
    auto &local_980 = ctx->local_980;
    auto &local_78c = ctx->local_78c;
    CStrList &local_94 = ctx->local_94;
    CStrList &local_84 = ctx->local_84;
    ...
    int &local_48 = ctx->local_48;
    void *&local_44 = ctx->local_44;
    uint &local_38 = ctx->local_38;
    char *&local_24 = ctx->local_24;
          ...
          if (iVar2 == 0) {
            ...
            if ((iVar2 == 4) || (iVar2 == 5)) {
              ...
              if (g_VersionControlDirectory[0] == '\0') {
                ...
                local_38 = engine_dosio_c_getFileSizeWithFinder_FUN_00481960((char *)0x0,pcVar12);
...
// Chunk: check_iVar2_0_else_5 (lines 780-812 of original)
...
{
  CFileManager_managePodFiles_Ctx _ctx_storage = {};
  CFileManager_managePodFiles_Ctx *ctx = &_ctx_storage;
  ctx->this_ptr = this_ptr;
  ctx->pod_directory_path = pod_directory_path;
  ...
  // param pod_directory_path aliased into ctx above
  ...
  if (iVar2 != 0) {
    ...
    if ((iVar2 != 0) &&
      ...
      local_64 = 0;
    if (0 < local_48) {
      int _rc = CFileManager_managePodFiles_check_iVar2_0_check_0_0(ctx);
      if (_rc == GOTO_LAB_004b901b) goto LAB_004b901b;
    }
      shape_edittool_cpp_CEditorTools_restoreWindowAndCleanup_FUN_004a0dd0(g_CEditorToolsPtr);
      local_1c = 0;
    if (0 < local_84.item_count) {
      CFileManager_managePodFiles_check_iVar2_0_check_0_1(ctx);
    }
      local_60 = 0;
LAB_004b8d5b:
      ...
      pvVar10 = local_44;
    if (0 < local_48) {
      CFileManager_managePodFiles_check_iVar2_0_check_0_2(ctx);
    }
    ...
    if (iVar2 < local_170c.base.item_count + -1) {
      int _rc = CFileManager_managePodFiles_check_iVar2_0_check_iVar2_3(ctx);
      if (_rc == GOTO_LAB_004b994d) goto LAB_004b994d;
      if (_rc == GOTO_LAB_004b9978) goto LAB_004b9978;
    }
      shape_edittool_cpp_CPickList_dtor_FUN_004a3c80(&local_170c,0);
      local_20 = 0;
    ...
    if (0 < local_48) {
      CFileManager_managePodFiles_check_iVar2_0_check_0_4(ctx);
    }
      ...
      CFileManager_managePodFiles_check_iVar2_0_else_5(ctx);
    }
      do {
        cVar1 = *pcVar13;
        *pcVar12 = cVar1;
