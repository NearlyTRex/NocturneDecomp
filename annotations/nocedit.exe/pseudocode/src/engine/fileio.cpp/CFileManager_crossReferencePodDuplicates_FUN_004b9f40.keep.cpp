...

{
  ...
  pvVar2 = shape_memdbg_cpp_debugAllocTracked2_FUN_0050f1f0
                     (local_50.item_count * (int)sizeof(CPodFile) + 4,"..\\engine\\fileio.cpp",3638);
    ...
    do {
      ...
      if (0 < local_40->file_count) {
        ...
        do {
          iVar5 = 0;
          bVar3 = true;
          pcVar8 = local_40->directory_entries[local_38].name;
          pCVar5 = object_ptr;
          do {
              if ((iVar5 != local_1c) &&
                ...
                if (bVar3) {
                  ...
                  _sprintf(local_154,"%s\t%s\t%08X",pcVar8,local_40->filename,
                             local_40->directory_entries[local_38].checksum
                            );
