  ...
  if (iVar2 != 0) {
    ...
    if ((iVar2 != 0) &&
      ...
      local_44 = (SPodManageRecord *)shape_memdbg_cpp_debugMalloc_FUN_0050f250
                           (local_94.item_count * sizeof(SPodManageRecord),"..\\engine\\fileio.cpp",3086);
      ...
      if (0 < local_94.item_count) {
        do {
          ...
          if (iVar2 == 0) {
            ...
            shape_edittool_cpp_CEditorTools_showError_FUN_0049e740
                      (g_CEditorToolsPtr,"Can't mount %s to check status",local_fbc.found_path);
...
LAB_004b8d5b:
      ...
      if (0 < local_48) {
        do {
          _sprintf
                    (local_2338,"%s\t%s\t%s",filename->base_name,filename->status_description,
