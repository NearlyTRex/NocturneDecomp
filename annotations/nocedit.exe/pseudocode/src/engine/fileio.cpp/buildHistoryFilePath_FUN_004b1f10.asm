...
section .text
    ...
    CMP byte ptr [0x02d12ac8],0x0       ; 004b1f20 | g_VersionControlDirectory
    JZ 0x004b1fb7                       ; 004b1f27
        ;   XREF to: 004b1fb7 (CONDITIONAL_JUMP)  ; LAB_004b1fb7
    ...
    PUSH ESI                            ; 004b1f5e
    PUSH 0x2d12ac8                      ; 004b1f5f | g_VersionControlDirectory
    CALL engine_dosio.cpp_ensureTrailingSlash_FUN_00481f80 ; 004b1f64
    ...
    PUSH ESI                            ; 004b1f7f
    PUSH EDI                            ; 004b1f80
    CALL engine_dosio.cpp_makePath_FUN_00481f50 ; 004b1f81
    ...
    CMP AL,0x0                          ; 004b1f98
    JZ 0x004b1fac                       ; 004b1f9a
        ;   XREF to: 004b1fac (CONDITIONAL_JUMP)  ; LAB_004b1fac
    MOV AL,byte ptr [ESI + 0x1]         ; 004b1f9c
    ADD ESI,0x2                         ; 004b1f9f
    MOV byte ptr [EDI + 0x1],AL         ; 004b1fa2
    ADD EDI,0x2                         ; 004b1fa5
    CMP AL,0x0                          ; 004b1fa8
    JNZ 0x004b1f94                      ; 004b1faa
        ;   XREF to: 004b1f94 (CONDITIONAL_JUMP)  ; LAB_004b1f94
    POP EDI                             ; 004b1fac
        ;   Label: LAB_004b1fac
    ...
    POP EBX                             ; 004b1fb5
    RET                                 ; 004b1fb6
    MOV EDX,0x6260a3                    ; 004b1fb7 | = "..\\engine\\fileio.cpp"
        ;   Label: LAB_004b1fb7
    MOV ECX,0xe7                        ; 004b1fbc
    PUSH 0x6260b8                       ; 004b1fc1 | = "versionControlDirectory not set!"
    MOV dword ptr [0x02f0ca48],EDX      ; 004b1fc6 | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 004b1fcc | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004b1fd2
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ADD ESP,0x4                         ; 004b1fd7
    JMP 0x004b1f2d                      ; 004b1fda
        ;   XREF to: 004b1f2d (UNCONDITIONAL_JUMP)  ; LAB_004b1f2d
