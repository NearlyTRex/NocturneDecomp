...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl engine_fileio_cpp_CCheckOutItem_removeCheckOutBookkeeping_FUN_004b35a0 (CCheckOutItem *this_ptr,void *unused_param)
;
; Parameters:
...
section .text
    ...
    PUSH 0x1f4                          ; 004b376e
    INC ESI                             ; 004b3773
    CALL dword ptr CS:[0x611644]        ; 004b3774 | g_SleepFunc
