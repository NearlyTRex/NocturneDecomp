...

{
  ...
  iVar3 = engine_pod_cpp_CPodFile_mountFromFile_FUN_0054f650(&local_2600,local_77c);
  if (iVar3 == 0) {
  ...
  if (iVar3 == 0) {
    shape_edittool_cpp_CEditorTools_showError_FUN_0049e740
              (g_CEditorToolsPtr,"Error accessing %s.  File not checked in.",local_12b4.found_path);
    goto LAB_004bb1fa;
  }
  ...
  if (iVar3 == 0) {
    shape_edittool_cpp_CEditorTools_showError_FUN_0049e740
              (g_CEditorToolsPtr,"Error accessing %s.  File not checked in.",local_16dc.found_path);
    goto LAB_004bb1fa;
  }
  if (((local_12b4.file_size == local_16dc.file_size) &&
      (local_12b4.timestamp < local_16dc.timestamp + 2)) &&
     (local_16dc.timestamp < local_12b4.timestamp + 2)) {
  ...
  local_44 = (_FILE *)shape_edittool_cpp_CEditorTools_showYesNoDialog_FUN_0049f0f0
                                (g_CEditorToolsPtr,"Keep %s checked out after updating to network?",local_12b4.found_path);
  pcVar9 = local_3c;
...
LAB_004bb723:
  ...
  p_Var3 = shape_memdbg_cpp_openFile_FUN_0050f7a0
                     (local_880,(char *)0x0,"wb","..\\engine\\fileio.cpp",1425);
  local_38 = p_Var3;
  if (local_40 == (_FILE *)0x0) {
    pcVar9 = local_880;
    pcVar14 = "Can't create %s.\nGet Fletch.";
LAB_004bb83f:
    shape_edittool_cpp_CEditorTools_showError_FUN_0049e740(g_CEditorToolsPtr,pcVar14,pcVar9);
  }
  else {
    shape_edittool_cpp_CEditorTools_displayCenteredStatusMessage_FUN_0049e790
    ...
    if (local_40 != (_FILE *)0x0) {
      shape_memdbg_cpp_closeFile_FUN_0050f9b0(local_40,"..\\engine\\fileio.cpp",196);
      local_40 = (_FILE *)0x0;
    }
    if (local_38 != (_FILE *)0x0) {
      shape_memdbg_cpp_closeFile_FUN_0050f9b0(local_38,"..\\engine\\fileio.cpp",196);
      local_38 = (_FILE *)0x0;
    }
    if (pcVar9 != (char *)0x0) {
      pcVar14 = "%s\nGet Fletch.";
    ...
    if (local_44 == (_FILE *)0x0) {
      ...
      do {
        p_Var6 = shape_memdbg_cpp_openFile_FUN_0050f7a0
                           (local_678,(char *)0x0,"r+t","..\\engine\\fileio.cpp",339)
        ;
        if (p_Var6 != (_FILE *)0x0) {
...
LAB_004bbc40:
      ...
      if (iVar3 != 0) {
        ...
        if (local_54 != (_FILE *)0x0) {
          shape_memdbg_cpp_closeFile_FUN_0050f9b0(local_54,"..\\engine\\fileio.cpp",196);
          local_54 = (_FILE *)0x0;
        }
        shape_edittool_cpp_CEditorTools_showError_FUN_0049e740
...
LAB_004bba53:
      ...
      while( true ) {
        ...
        if (iVar3 == 1) {
          _sprintf
                    (local_d1c,"Waiting for %s to become available.\nPress ESC to cancel check in.",local_16dc.found_path);
      ...
      iVar3 = engine_dosio_cpp_copyFileTimestamp_FUN_00481910
                        (local_16dc.found_path,local_12b4.timestamp);
      if (iVar3 == 0) {
        if (local_54 != (_FILE *)0x0) {
          shape_memdbg_cpp_closeFile_FUN_0050f9b0(local_54,"..\\engine\\fileio.cpp",196);
          local_54 = (_FILE *)0x0;
                ...
                if (iVar3 != 0) {
                  ...
                  if (((-1 < iVar3) &&
                    ...
                    shape_edittool_cpp_CEditorTools_showWarning_FUN_0049e6f0
                              (g_CEditorToolsPtr,"Error marking local file %s as read only.\n(But your check-in did complete to the network successfully.)",local_12b4.found_path);
                  }
                  engine_fileio_cpp_CCheckOutList_reset_FUN_004b2860(&local_60);
LAB_004bb492:
          ...
          if (local_34 != (_FILE *)0x0) {
            shape_memdbg_cpp_closeFile_FUN_0050f9b0(local_34,"..\\engine\\fileio.cpp",196);
            local_34 = (_FILE *)0x0;
          }
          shape_edittool_cpp_CEditorTools_showError_FUN_0049e740
