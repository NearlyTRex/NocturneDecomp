...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl engine_fileio_cpp_CFileManager_removeAuditRecords_FUN_004bd190 (CFileManager *this_ptr,char *pod_file_path)
;
; Parameters:
...
section .text
    ...
    CALL crt_time.c_mktime_FUN_00600f80 ; 004bd3ab
