...
section .text
    ...
    MOV AL,byte ptr [ESI]               ; 004bc5e4
        ;   Label: LAB_004bc5e4
    MOV byte ptr [EDI],AL               ; 004bc5e6 | g_VersionControlSession.network_username[0]
    CMP AL,0x0                          ; 004bc5e8
    JZ 0x004bc5fc                       ; 004bc5ea | LAB_004bc5fc
        ;   XREF to: 004bc5fc (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 004bc5ec
    ADD ESI,0x2                         ; 004bc5ef
    MOV byte ptr [EDI + 0x1],AL         ; 004bc5f2 | g_VersionControlSession.network_username[1]
    ADD EDI,0x2                         ; 004bc5f5
    CMP AL,0x0                          ; 004bc5f8
    JNZ 0x004bc5e4                      ; 004bc5fa | LAB_004bc5e4
    ...
    MOV AL,byte ptr [ESI]               ; 004bc605
        ;   Label: LAB_004bc605
    MOV byte ptr [EDI],AL               ; 004bc607 | g_VersionControlSession.password[0]
    CMP AL,0x0                          ; 004bc609
    JZ 0x004bc61d                       ; 004bc60b | LAB_004bc61d
        ;   XREF to: 004bc61d (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 004bc60d
    ADD ESI,0x2                         ; 004bc610
    MOV byte ptr [EDI + 0x1],AL         ; 004bc613 | g_VersionControlSession.password[1]
    ADD EDI,0x2                         ; 004bc616
    CMP AL,0x0                          ; 004bc619
    JNZ 0x004bc605                      ; 004bc61b | LAB_004bc605
    ...
    MOV AL,byte ptr [ESI]               ; 004bc626
        ;   Label: LAB_004bc626
    MOV byte ptr [EDI],AL               ; 004bc628 | g_VersionControlSession.domain[0]
    CMP AL,0x0                          ; 004bc62a
    JZ 0x004bc63e                       ; 004bc62c | LAB_004bc63e
        ;   XREF to: 004bc63e (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 004bc62e
    ADD ESI,0x2                         ; 004bc631
    MOV byte ptr [EDI + 0x1],AL         ; 004bc634 | g_VersionControlSession.domain[1]
    ADD EDI,0x2                         ; 004bc637
    CMP AL,0x0                          ; 004bc63a
    JNZ 0x004bc626                      ; 004bc63c | LAB_004bc626
