...
section .text
    ...
    CALL crt_stdio.c_fseek_FUN_005ffacc ; 004b23cd | int crt_stdio.c_fseek_FUN_005ffacc(FILE * file, long offset, int whence)
    ...
    MOV EAX,dword ptr [ESP + 0x564]     ; 004b23e2
        ;   Label: LAB_004b23e2
    PUSH 0x626169                       ; 004b23e9 | = " " | s_anon_00626169 =
    MOV EDI,dword ptr [EAX]             ; 004b23ee
    PUSH EDI                            ; 004b23f0
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004b23f1 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
    ...
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 004b2411 | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004b2416
    CMP EAX,EDI                         ; 004b2419
    JZ 0x004b24cb                       ; 004b241b | LAB_004b24cb
    ...
    JZ 0x004b2620                       ; 004b242e | LAB_004b2620
        ;   XREF to: 004b2620 (CONDITIONAL_JUMP)
    PUSH 0xc4                           ; 004b2434
    PUSH 0x62604b                       ; 004b2439 | = "..\\engine\\fileio.cpp" | s_engine_fileio_cpp_0062604b = ..\engine\fileio.cpp
    PUSH EAX                            ; 004b243e
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 004b243f | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
        ;   XREF to: 0050f9b0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004b2444
    MOV EBP,dword ptr [ESP + 0x570]     ; 004b2447
    PUSH EBP                            ; 004b244e
    MOV EAX,dword ptr [ESP + 0x568]     ; 004b244f
    PUSH 0x62616b                       ; 004b2456 | = "Error reading %s" | s_Error_reading_s_0062616b = Error reading %s
    MOV dword ptr [EAX],0x0             ; 004b245b
    MOV EAX,[0x00678a60]                ; 004b2461 | CEditorTools * g_CEditorToolsPtr
    PUSH EAX                            ; 004b2466 | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_showError_FUN_0049e740 ; 004b2467 | void shape_edittool.cpp_CEditorTools_showError_FUN_0049e740(CEditorTools * this_ptr, char * format)
    ...
    JZ 0x004b249c                       ; 004b247a | LAB_004b249c
        ;   XREF to: 004b249c (CONDITIONAL_JUMP)
    PUSH 0xc4                           ; 004b247c
    PUSH 0x62604b                       ; 004b2481 | = "..\\engine\\fileio.cpp" | s_engine_fileio_cpp_0062604b = ..\engine\fileio.cpp
    PUSH EDX                            ; 004b2486
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 004b2487 | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
        ;   XREF to: 0050f9b0 (UNCONDITIONAL_CALL)
    ...
    JZ 0x004b24bb                       ; 004b24a0 | LAB_004b24bb
        ;   XREF to: 004b24bb (CONDITIONAL_JUMP)
    PUSH 0x1ae                          ; 004b24a2
    PUSH 0x62617c                       ; 004b24a7 | = "..\\engine\\fileio.cpp" | s_engine_fileio_cpp_0062617c = ..\engine\fileio.cpp
    PUSH ESI                            ; 004b24ac
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 004b24ad | void shape_memdbg.cpp_debugFree_FUN_0050f460(void * ptr, char * filename, int line_number)
    ...
    PUSH EAX                            ; 004b24d2
    PUSH EDI                            ; 004b24d3
    CALL engine_fileio.cpp_parseTimestampRecord_FUN_004b2270 ; 004b24d4 | int engine_fileio.cpp_parseTimestampRecord_FUN_004b2270(char * input_string, STimestampRecord * output_record)
        ;   XREF to: 004b2270 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004b24d9
    TEST EAX,EAX                        ; 004b24dc
    JNZ 0x004b2535                      ; 004b24de | LAB_004b2535
        ;   XREF to: 004b2535 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x564]     ; 004b24e0
    MOV ECX,dword ptr [EAX]             ; 004b24e7
    TEST ECX,ECX                        ; 004b24e9
    JZ 0x004b250d                       ; 004b24eb | LAB_004b250d
        ;   XREF to: 004b250d (CONDITIONAL_JUMP)
    PUSH 0xc4                           ; 004b24ed
    PUSH 0x62604b                       ; 004b24f2 | = "..\\engine\\fileio.cpp" | s_engine_fileio_cpp_0062604b = ..\engine\fileio.cpp
    PUSH ECX                            ; 004b24f7
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 004b24f8 | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
        ;   XREF to: 0050f9b0 (UNCONDITIONAL_CALL)
    ...
    PUSH EBP                            ; 004b251c
    PUSH 0x626191                       ; 004b251d | = "Error parsing %s, record %d" | s_Error_parsing_s_record_d_00626191 = Error parsing %s, record %d
    MOV EAX,[0x00678a60]                ; 004b2522 | CEditorTools * g_CEditorToolsPtr
    PUSH EAX                            ; 004b2527 | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_showError_FUN_0049e740 ; 004b2528 | void shape_edittool.cpp_CEditorTools_showError_FUN_0049e740(CEditorTools * this_ptr, char * format)
        ;   XREF to: 0049e740 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004b252d
    JMP 0x004b246f                      ; 004b2530 | LAB_004b246f
    ...
    CMP AL,0x0                          ; 004b2548
    JZ 0x004b255c                       ; 004b254a | LAB_004b255c
    ...
    CMP AL,0x0                          ; 004b2558
    JNZ 0x004b2544                      ; 004b255a | LAB_004b2544
        ;   XREF to: 004b2544 (CONDITIONAL_JUMP)
    POP EDI                             ; 004b255c
        ;   Label: LAB_004b255c
    PUSH 0x1c2                          ; 004b255d
    PUSH 0x6261ad                       ; 004b2562 | = "..\\engine\\fileio.cpp" | s_engine_fileio_cpp_006261ad = ..\engine\fileio.cpp
    PUSH EBP                            ; 004b2567
    MOV EDX,dword ptr [EBX]             ; 004b2568
    PUSH EDX                            ; 004b256a
    CALL shape_memdbg.cpp_debugRealloc_FUN_0050f540 ; 004b256b | void * shape_memdbg.cpp_debugRealloc_FUN_0050f540(void * ptr, int new_size, char * filename, int line_number)
        ;   XREF to: 0050f540 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004b2570
    MOV dword ptr [EBX],EAX             ; 004b2573
    TEST EAX,EAX                        ; 004b2575
    JNZ 0x004b25da                      ; 004b2577 | LAB_004b25da
        ;   XREF to: 004b25da (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x564]     ; 004b2579
    MOV EDX,dword ptr [EAX]             ; 004b2580
    TEST EDX,EDX                        ; 004b2582
    JZ 0x004b25a6                       ; 004b2584 | LAB_004b25a6
        ;   XREF to: 004b25a6 (CONDITIONAL_JUMP)
    PUSH 0xc4                           ; 004b2586
    PUSH 0x62604b                       ; 004b258b | = "..\\engine\\fileio.cpp" | s_engine_fileio_cpp_0062604b = ..\engine\fileio.cpp
    PUSH EDX                            ; 004b2590
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 004b2591 | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
        ;   XREF to: 0050f9b0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 004b25b5
    PUSH 0x6261c2                       ; 004b25b6 | = "Out of memory reading %s record %d" | s_Out_of_memory_reading_s__006261c2 = Out of memory reading %s record %d
    MOV EDI,dword ptr [0x00678a60]      ; 004b25bb | CEditorTools * g_CEditorToolsPtr
    PUSH EDI                            ; 004b25c1 | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_showError_FUN_0049e740 ; 004b25c2 | void shape_edittool.cpp_CEditorTools_showError_FUN_0049e740(CEditorTools * this_ptr, char * format)
        ;   XREF to: 0049e740 (UNCONDITIONAL_CALL)
    ...
    JMP 0x004b23e2                      ; 004b261b | LAB_004b23e2
