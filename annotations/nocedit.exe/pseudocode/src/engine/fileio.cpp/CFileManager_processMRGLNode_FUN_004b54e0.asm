...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_fileio.cpp_CFileManager_processMRGLNode_FUN_004b54e0(CFileManager * this_ptr, SMRGLHeaderExtended * mrgl_node)
;
; Parameters:
...
section .text
    ...
    JZ 0x004b5584                       ; 004b54f8 | LAB_004b5584
        ;   XREF to: 004b5584 (CONDITIONAL_JUMP)
    CMP EDX,0x26                        ; 004b54fe
    JZ 0x004b55d8                       ; 004b5501 | LAB_004b55d8
    ...
    PUSH EAX                            ; 004b552f
    PUSH EDI                            ; 004b5530
    CALL engine_fileio.cpp_CFileManager_extractTexture_FUN_004b53e0 ; 004b5531 | void engine_fileio.cpp_CFileManager_extractTexture_FUN_004b53e0(CFileManager * this_ptr, char * texture_filename)
        ;   XREF to: 004b53e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004b5536
    MOV EAX,dword ptr [ESP + 0x4]       ; 004b5539
        ;   Label: LAB_004b5539
    CMP dword ptr [EAX],0x1d            ; 004b553d
    JNZ 0x004b5565                      ; 004b5540 | LAB_004b5565
    ...
    JLE 0x004b5565                      ; 004b554e | LAB_004b5565
        ;   XREF to: 004b5565 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 004b5550
        ;   Label: LAB_004b5550
    PUSH EDI                            ; 004b5551
    INC ESI                             ; 004b5552
    CALL engine_fileio.cpp_CFileManager_extractTexture_FUN_004b53e0 ; 004b5553 | void engine_fileio.cpp_CFileManager_extractTexture_FUN_004b53e0(CFileManager * this_ptr, char * texture_filename)
        ;   XREF to: 004b53e0 (UNCONDITIONAL_CALL)
    ADD EBX,0x20                        ; 004b5558
    MOV EAX,dword ptr [EBP + 0x8]       ; 004b555b
    ADD ESP,0x8                         ; 004b555e
    CMP ESI,EAX                         ; 004b5561
    JL 0x004b5550                       ; 004b5563 | LAB_004b5550
        ;   XREF to: 004b5550 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [ESP + 0x4]       ; 004b5565
        ;   Label: LAB_004b5565
    PUSH EDX                            ; 004b5569
    CALL engine_model.c_getMRGLSize_FUN_00528700 ; 004b556a | int engine_model.c_getMRGLSize_FUN_00528700(SMRGLHeaderExtended * header)
    ...
    JMP 0x004b5510                      ; 004b5582 | LAB_004b5510
    ...
    JLE 0x004b55d0                      ; 004b558e | LAB_004b55d0
        ;   XREF to: 004b55d0 (CONDITIONAL_JUMP)
    LEA EBX,[EAX + 0x18]                ; 004b5590
    PUSH EBX                            ; 004b5593
        ;   Label: LAB_004b5593
    CALL engine_model.c_loadModelFile_FUN_00527ec0 ; 004b5594 | SMRGLHeaderExtended * engine_model.c_loadModelFile_FUN_00527ec0(char * filename)
        ;   XREF to: 00527ec0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004b5599
    PUSH EBX                            ; 004b559c
    PUSH 0x627628                       ; 004b559d | = "MODELS\\%s\n" | s_MODELS_s_00627628 = MODELS\%s

    MOV EDX,dword ptr [EDI]             ; 004b55a2
    PUSH EDX                            ; 004b55a4
    MOV ESI,EAX                         ; 004b55a5
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 004b55a7 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004b55ac
    PUSH ESI                            ; 004b55af
    PUSH EDI                            ; 004b55b0
    CALL engine_fileio.cpp_CFileManager_processMRGLNode_FUN_004b54e0 ; 004b55b1 | void engine_fileio.cpp_CFileManager_processMRGLNode_FUN_004b54e0(CFileManager * this_ptr, SMRGLHeaderExtended * mrgl_node)
        ;   XREF to: 004b54e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004b55b6
    PUSH ESI                            ; 004b55b9
    CALL engine_model.c_freeMRGLData_FUN_005280b0 ; 004b55ba | void engine_model.c_freeMRGLData_FUN_005280b0(SMRGLHeaderExtended * modelStruct)
    ...
    JL 0x004b5593                       ; 004b55ce | LAB_004b5593
    ...
    JLE 0x004b5510                      ; 004b55e1 | LAB_004b5510
    ...
    PUSH EDI                            ; 004b55eb
    INC EBP                             ; 004b55ec
    CALL engine_fileio.cpp_CFileManager_extractTexture_FUN_004b53e0 ; 004b55ed | void engine_fileio.cpp_CFileManager_extractTexture_FUN_004b53e0(CFileManager * this_ptr, char * texture_filename)
        ;   XREF to: 004b53e0 (UNCONDITIONAL_CALL)
    ADD EBX,0x18                        ; 004b55f2
    MOV EAX,dword ptr [ESI + 0x18]      ; 004b55f5
    ADD ESP,0x8                         ; 004b55f8
    CMP EBP,EAX                         ; 004b55fb
    JL 0x004b55ea                       ; 004b55fd | LAB_004b55ea
        ;   XREF to: 004b55ea (CONDITIONAL_JUMP)
    JMP 0x004b5510                      ; 004b55ff | LAB_004b5510
        ;   XREF to: 004b5510 (UNCONDITIONAL_JUMP)
