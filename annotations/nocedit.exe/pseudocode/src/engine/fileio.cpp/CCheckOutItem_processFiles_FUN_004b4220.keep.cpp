...

{
  ...
  iVar4 = engine_dosio_cpp_findFileNormally_FUN_004817c0(&local_e0c);
  if (iVar4 == 0) {
    shape_edittool_cpp_CEditorTools_showError_FUN_0049e740
              (g_CEditorToolsPtr,"Error accessing %s.  File not checked in.",local_e0c.found_path);
    return 0;
  }
  ...
  if (iVar4 == 0) {
    shape_edittool_cpp_CEditorTools_showError_FUN_0049e740
              (g_CEditorToolsPtr,"Error accessing %s.  File not checked in.",local_1020.found_path);
    return 0;
  }
  if (((local_e0c.file_size == local_1020.file_size) &&
      (local_e0c.timestamp < local_1020.timestamp + 2)) &&
     (local_1020.timestamp < local_e0c.timestamp + 2)) {
    ...
    if (iVar4 == 0) {
      ...
      if ((iVar4 == 0) ||
         (iVar4 = engine_fileio_cpp_CCheckOutItem_removeCheckOutBookkeeping_FUN_004b35a0
                            (this_ptr,local_658), iVar4 == 0)) {
        iVar4 = 0;
      }
      else {
        iVar4 = engine_fileio_cpp_getLatestFileFromRepository_FUN_004b3220(this_ptr->name,local_658)
        ;
      }
      shape_edittool_cpp_CPickList_dtor_FUN_004a3c80(&local_13c8,0);
      return iVar4;
  ...
  engine_dosio_cpp_ensureTrailingSlash_FUN_00481f80(g_VersionControlDirectory,local_1c,local_150);
  engine_dosio_cpp_makePath_FUN_00481f50(local_964,local_1c,local_150,(char *)0x0,(char *)0x0);
...
LAB_004b4ad9:
        ...
        iVar4 = engine_fileio_cpp_CCheckOutList_parse_FUN_004b2a60(&local_50,&local_48);
        if (iVar4 != 0) {
...
LAB_004b4980:
        ...
        iVar4 = 0;
        while( true ) {
          engine_dosio_cpp_setFileAttributes_FUN_004819f0(local_1020.found_path,0);
          ...
          if (iVar4 == 1) {
            _sprintf
                      (local_bf8,"Waiting for %s to become available.\nPress ESC to cancel check in.",local_1020.found_path);
...
LAB_004b4d50:
            ...
            if (p_Var6 != (_FILE *)0x0) {
              ...
              _fprintf(p_Var6,"%4d: %04d/%02d/%02d %02d:%02d:%02d \"%s\"\n",local_3c + 1,
                         ...
                         p_Var5->tm_min,p_Var5->tm_sec,g_VersionControlSession.primary_username);
              _fflush(p_Var6);
              if ((p_Var6->_flag & 0x20) == 0) {
                ...
                iVar4 = engine_fileio_cpp_CCheckOutList_remove_FUN_004b2d70(&local_50,local_40);
                if (iVar4 == 0) {
                  if (local_48 != (_FILE *)0x0) {
                  ...
                  iVar4 = engine_fileio_cpp_CCheckOutList_write_FUN_004b2eb0(&local_50,&local_48);
                  if (iVar4 != 0) {
                    if (local_48 != (_FILE *)0x0) {
                      shape_memdbg_cpp_closeFile_FUN_0050f9b0
                                (local_48,"..\\engine\\fileio.cpp",0xc4);
                    ...
                    if (((-1 < iVar4) &&
                        (iVar7 = engine_dosio_cpp_setFileAttributes_FUN_004819f0
                                           (local_e0c.found_path,(byte)iVar4 | 8), iVar7 == 0)) ||
                       (iVar4 < 0)) {
                      shape_edittool_cpp_CEditorTools_showWarning_FUN_0049e6f0
                                (g_CEditorToolsPtr,"Error marking local file %s as read only.\n(But your check-in did complete to the network successfully.)",local_e0c.found_path);
                    }
                    engine_fileio_cpp_CCheckOutList_reset_FUN_004b2860(&local_50);
                    return 1;
                  }
