...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl engine_fileio_cpp_CFileManager_managePodFiles_FUN_004b86b0 (CFileManager *this_ptr,char *pod_directory_path)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004b99db
    CALL crt_io.c_deleteFile_FUN_005ff9d0 ; 004b99dc
    ...
    JMP 0x004b8f32                      ; 004b9c3e
        ;   XREF to: 004b8f32 (UNCONDITIONAL_JUMP)  ; LAB_004b8f32
    CALL crt_errno.c_errno_FUN_00601450 ; 004b9c43
