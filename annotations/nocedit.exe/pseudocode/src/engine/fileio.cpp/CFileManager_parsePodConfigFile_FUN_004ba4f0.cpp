...

{
  ...
  file = shape_memdbg_cpp_openFile_FUN_0050f7a0
                   ("pod.ini",(char *)0x0,"rt","..\\engine\\fileio.cpp",3708)
  ;
  if (file == (_FILE *)0x0) {
    return;
  }
  ...
  shape_memdbg_cpp_closeFile_FUN_0050f9b0(file,"..\\engine\\fileio.cpp",3721);
  return;
}
