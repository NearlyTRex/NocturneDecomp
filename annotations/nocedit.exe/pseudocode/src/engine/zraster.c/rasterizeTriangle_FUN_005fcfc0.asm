...
section .text
    ...
    PUSH EBX                            ; 005fcfc0
        ;   Label: engine_zraster.c_rasterizeTriangle_FUN_005fcfc0
    PUSH ESI                            ; 005fcfc1
    PUSH EDI                            ; 005fcfc2
    PUSH EBP                            ; 005fcfc3
    ...
    MOV EDX,dword ptr [0x02d02548]      ; 005fd03c | g_Projection
        ;   Label: LAB_005fd03c
    MOV EBX,dword ptr [ECX + 0x8]       ; 005fd042
    MOV EAX,dword ptr [ECX]             ; 005fd045
    IMUL EDX                            ; 005fd047
    IDIV EBX                            ; 005fd049
    MOV EDX,dword ptr [0x02d02550]      ; 005fd04b | g_Projection.center_x_fixed
    ADD EAX,EDX                         ; 005fd051
    MOV EBX,dword ptr [ECX + 0x8]       ; 005fd053
    MOV dword ptr [ECX + 0x10],EAX      ; 005fd056
    MOV EDX,dword ptr [0x02d0254c]      ; 005fd059 | g_Projection.neg_half_height_fixed
    MOV EAX,dword ptr [ECX + 0x4]       ; 005fd05f
    IMUL EDX                            ; 005fd062
    IDIV EBX                            ; 005fd064
    MOV EDX,dword ptr [0x02d02554]      ; 005fd066 | g_Projection.center_y_fixed
