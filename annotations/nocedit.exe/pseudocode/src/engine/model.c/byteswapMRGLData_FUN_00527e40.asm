...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_model.c_byteswapMRGLData_FUN_00527e40(SMRGLHeaderExtended * mrgl_data, int data_size)
;
; Parameters:
...
section .text
    ...
    JLE 0x00527e80                      ; 00527e4d | LAB_00527e80
        ;   XREF to: 00527e80 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 00527e4f
        ;   Label: LAB_00527e4f
    CALL engine_model.c_getMRGLSize_FUN_00528700 ; 00527e50 | int engine_model.c_getMRGLSize_FUN_00528700(SMRGLHeaderExtended * header)
    ...
    POP EBX                             ; 00527e82
    RET                                 ; 00527e83
    MOV EDX,0x639a84                    ; 00527e84 | = "..\\engine\\model.c" | s_engine_model_c_00639a84 = ..\engine\model.c
        ;   Label: caseD_3f
    MOV ECX,0xce                        ; 00527e89
    PUSH 0x639a96                       ; 00527e8e | = "Need a new byteswap!" | s_Need_a_new_byteswap_00639a96 = Need a new byteswap!
    MOV dword ptr [0x02f0ca48],EDX      ; 00527e93 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 00527e99 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00527e9f | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00527ea4
    SUB EDI,ESI                         ; 00527ea7
    ADD EBX,ESI                         ; 00527ea9
    TEST EDI,EDI                        ; 00527eab
    JG 0x00527e4f                       ; 00527ead | LAB_00527e4f
        ;   XREF to: 00527e4f (CONDITIONAL_JUMP)
    POP EDI                             ; 00527eaf
    POP ESI                             ; 00527eb0
    POP EBX                             ; 00527eb1
