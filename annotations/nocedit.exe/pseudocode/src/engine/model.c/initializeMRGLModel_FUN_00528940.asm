...
section .text
    ...
    JNZ 0x00528961                      ; 00528948 | LAB_00528961
        ;   XREF to: 00528961 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 0052894a
    CALL engine_keyframe.c_loadAndInterpolateKeyframes_FUN_00501d40 ; 0052894b | void engine_keyframe.c_loadAndInterpolateKeyframes_FUN_00501d40(SMRGLKeyframeModel * keyframe_model)
        ;   XREF to: 00501d40 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00528950
    MOV ECX,dword ptr [EBX + 0x14]      ; 00528953
    PUSH ECX                            ; 00528956
    CALL engine_model.c_loadMRGLTextures_FUN_00528870 ; 00528957 | void engine_model.c_loadMRGLTextures_FUN_00528870(SMRGLHeaderExtended * block)
    ...
    PUSH EBX                            ; 00528961
        ;   Label: LAB_00528961
    CALL engine_model.c_loadMRGLTextures_FUN_00528870 ; 00528962 | void engine_model.c_loadMRGLTextures_FUN_00528870(SMRGLHeaderExtended * block)
        ;   XREF to: 00528870 (UNCONDITIONAL_CALL)
