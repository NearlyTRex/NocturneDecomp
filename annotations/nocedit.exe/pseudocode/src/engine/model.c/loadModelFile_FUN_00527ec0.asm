...
;   engine_palette.cpp_CPaletteManager_scanTextures_FUN_00545060 at 00545108
...
section .text
    ...
    MOV AL,byte ptr [ESI]               ; 00527ece
        ;   Label: LAB_00527ece
    CMP AL,DL                           ; 00527ed0
    JZ 0x00527ee6                       ; 00527ed2
        ;   XREF to: 00527ee6 (CONDITIONAL_JUMP)  ; LAB_00527ee6
    CMP AL,0x0                          ; 00527ed4
    JZ 0x00527ee4                       ; 00527ed6
        ;   XREF to: 00527ee4 (CONDITIONAL_JUMP)  ; LAB_00527ee4
    INC ESI                             ; 00527ed8
    MOV AL,byte ptr [ESI]               ; 00527ed9
    CMP AL,DL                           ; 00527edb
    JZ 0x00527ee6                       ; 00527edd
        ;   XREF to: 00527ee6 (CONDITIONAL_JUMP)  ; LAB_00527ee6
    INC ESI                             ; 00527edf
    CMP AL,0x0                          ; 00527ee0
    JNZ 0x00527ece                      ; 00527ee2
        ;   XREF to: 00527ece (CONDITIONAL_JUMP)  ; LAB_00527ece
    SUB ESI,ESI                         ; 00527ee4
        ;   Label: LAB_00527ee4
    TEST ESI,ESI                        ; 00527ee6
        ;   Label: LAB_00527ee6
    JNZ 0x0052807b                      ; 00527ee8
        ;   XREF to: 0052807b (CONDITIONAL_JUMP)  ; LAB_0052807b
    PUSH EDI                            ; 00527eee
        ;   Label: LAB_00527eee
    PUSH EBX                            ; 00527eef
    PUSH 0x639aab                       ; 00527ef0 | = "models"
    CALL engine_dosio.cpp_getFileSize_FUN_00481880 ; 00527ef5
    ...
    JNZ 0x00527f39                      ; 00527f01
        ;   XREF to: 00527f39 (CONDITIONAL_JUMP)  ; LAB_00527f39
    PUSH EBX                            ; 00527f03
    ...
    PUSH EAX                            ; 00527f24
    MOV dword ptr [0x02f0ca48],EDX      ; 00527f25 | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 00527f2b | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00527f31
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ADD ESP,0x4                         ; 00527f36
    PUSH 0x639ae0                       ; 00527f39 | = "rb"
        ;   Label: LAB_00527f39
    PUSH EBX                            ; 00527f3e
    PUSH 0x639ae3                       ; 00527f3f | = "models"
    CALL engine_dosio.cpp_getFile_FUN_00481a50 ; 00527f44
        ;   XREF to: 00481a50 (UNCONDITIONAL_CALL)  ; _FILE * engine_dosio.cpp_getFile_FUN_00481a50(char * directory, char * filename, char * mode) | s_t_00639a2e
    ADD ESP,0xc                         ; 00527f49
    MOV EBP,EAX                         ; 00527f4c
    TEST EAX,EAX                        ; 00527f4e
    JNZ 0x00527f87                      ; 00527f50
        ;   XREF to: 00527f87 (CONDITIONAL_JUMP)  ; LAB_00527f87
    PUSH EBX                            ; 00527f52
    ...
    MOV ESI,0x639b03                    ; 00527f73 | = "..\\engine\\model.c"
    PUSH EAX                            ; 00527f78
    MOV dword ptr [0x02f0ca48],ESI      ; 00527f79 | g_CurrentFilename
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00527f7f
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ADD ESP,0x4                         ; 00527f84
    PUSH 0xf8                           ; 00527f87
        ;   Label: LAB_00527f87
    PUSH 0x639b15                       ; 00527f8c | = "..\\engine\\model.c"
    PUSH EDI                            ; 00527f91
    CALL shape_memdbg.cpp_debugMalloc_FUN_0050f250 ; 00527f92
    ...
    JNZ 0x00527fd6                      ; 00527f9e
        ;   XREF to: 00527fd6 (CONDITIONAL_JUMP)  ; LAB_00527fd6
    PUSH EBX                            ; 00527fa0
    ...
    PUSH EAX                            ; 00527fc1
    MOV dword ptr [0x02f0ca48],EDX      ; 00527fc2 | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 00527fc8 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00527fce
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    JZ 0x0052801c                       ; 00527fe5
        ;   XREF to: 0052801c (CONDITIONAL_JUMP)  ; LAB_0052801c
    PUSH EBX                            ; 00527fe7
    ...
    MOV EDI,0x639b6b                    ; 00528008 | = "..\\engine\\model.c"
    PUSH EAX                            ; 0052800d
    MOV dword ptr [0x02f0ca48],EDI      ; 0052800e | g_CurrentFilename
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00528014
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    JZ 0x00528071                       ; 00528034
        ;   XREF to: 00528071 (CONDITIONAL_JUMP)  ; LAB_00528071
    CMP AH,0x20                         ; 00528036
    JZ 0x00528071                       ; 00528039
        ;   XREF to: 00528071 (CONDITIONAL_JUMP)  ; LAB_00528071
    PUSH EBX                            ; 0052803b
    ...
    PUSH EAX                            ; 0052805c
    MOV dword ptr [0x02f0ca48],EDX      ; 0052805d | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 00528063 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00528069
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    PUSH EAX                            ; 00528080
    CALL crt_ctype.c_toupper_FUN_005ff9e0 ; 00528081
