...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_model.c_loadMRGLTextures_FUN_00528870(SMRGLHeaderExtended * block)
;
; Parameters:
...
section .text
    ...
    JZ 0x005288c9                       ; 00528880 | LAB_005288c9
        ;   XREF to: 005288c9 (CONDITIONAL_JUMP)
    MOV EAX,EBX                         ; 00528882
    MOV dword ptr [ESP + 0x18],EBX      ; 00528884
    TEST EDX,EDX                        ; 00528888
    JZ 0x005288c1                       ; 0052888a | LAB_005288c1
        ;   XREF to: 005288c1 (CONDITIONAL_JUMP)
    MOV EBP,dword ptr [EAX]             ; 0052888c
        ;   Label: LAB_0052888c
    CMP EBP,0xd                         ; 0052888e
    JZ 0x00528898                       ; 00528891 | LAB_00528898
        ;   XREF to: 00528898 (CONDITIONAL_JUMP)
    CMP EBP,0x40                        ; 00528893
    JNZ 0x005288d4                      ; 00528896 | LAB_005288d4
        ;   XREF to: 005288d4 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [ESP + 0x18]      ; 00528898
        ;   Label: LAB_00528898
    PUSH ESI                            ; 0052889c
    CALL engine_texture.cpp_ensureTextureLoaded_FUN_005dd800 ; 0052889d | SMRGLHeaderExtended * engine_texture.cpp_ensureTextureLoaded_FUN_005dd800(SMRGLTextureBasic * texture)
        ;   XREF to: 005dd800 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005288a2
    MOV EBX,dword ptr [ESP + 0x18]      ; 005288a5
        ;   Label: LAB_005288a5
    PUSH EBX                            ; 005288a9
    CALL engine_model.c_getMRGLSize_FUN_00528700 ; 005288aa | int engine_model.c_getMRGLSize_FUN_00528700(SMRGLHeaderExtended * header)
    ...
    JNZ 0x0052888c                      ; 005288bf | LAB_0052888c
    ...
    PUSH EBX                            ; 005288c9
        ;   Label: LAB_005288c9
    CALL engine_boss.c_modelStructNotSupported_FUN_0041dc20 ; 005288ca | SMRGLHeaderExtended * engine_boss.c_modelStructNotSupported_FUN_0041dc20(SMRGLHeaderExtended * header)
        ;   XREF to: 0041dc20 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005288cf
    JMP 0x005288c1                      ; 005288d2 | LAB_005288c1
        ;   XREF to: 005288c1 (UNCONDITIONAL_JUMP)
    CMP EBP,0x1d                        ; 005288d4
        ;   Label: LAB_005288d4
    JNZ 0x005288a5                      ; 005288d7 | LAB_005288a5
    ...
    JLE 0x005288a5                      ; 005288e8 | LAB_005288a5
        ;   XREF to: 005288a5 (CONDITIONAL_JUMP)
    ...
    CMP AL,0x0                          ; 005288fe
    JZ 0x00528912                       ; 00528900 | LAB_00528912
    ...
    CMP AL,0x0                          ; 0052890e
    JNZ 0x005288fa                      ; 00528910 | LAB_005288fa
        ;   XREF to: 005288fa (CONDITIONAL_JUMP)
    POP EDI                             ; 00528912
        ;   Label: LAB_00528912
    MOV EDI,ESP                         ; 00528913
    PUSH EDI                            ; 00528915
    CALL engine_texture.cpp_ensureTextureLoaded_FUN_005dd800 ; 00528916 | SMRGLHeaderExtended * engine_texture.cpp_ensureTextureLoaded_FUN_005dd800(SMRGLTextureBasic * texture)
        ;   XREF to: 005dd800 (UNCONDITIONAL_CALL)
    ...
    JL 0x005288ed                       ; 0052892b | LAB_005288ed
        ;   XREF to: 005288ed (CONDITIONAL_JUMP)
    JMP 0x005288a5                      ; 0052892d | LAB_005288a5
