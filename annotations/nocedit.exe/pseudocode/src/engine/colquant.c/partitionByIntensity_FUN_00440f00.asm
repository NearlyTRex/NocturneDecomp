...
;
; XREF[1]:
;   engine_colquant.c_quantizeColors_FUN_004406c0 at 00440956
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 00440f00
        ;   Label: engine_colquant.c_partitionByIntensity_FUN_00440f00
    PUSH ESI                            ; 00440f01
    PUSH EDI                            ; 00440f02
    PUSH EBP                            ; 00440f03
    ...
    JLE 0x00440fb4                      ; 00440f34
        ;   XREF to: 00440fb4 (CONDITIONAL_JUMP)  ; LAB_00440fb4
    ...
    JG 0x00440f40                       ; 00440fb2
        ;   XREF to: 00440f40 (CONDITIONAL_JUMP)  ; LAB_00440f40
    ...
    PUSH EDX                            ; 00440ffa
    PUSH EBX                            ; 00440ffb
    CALL engine_colquant.c_computeBoxStatistics_FUN_00441260 ; 00440ffc
    ...
    PUSH ECX                            ; 00441008
    PUSH EBX                            ; 00441009
    CALL engine_colquant.c_computeBoxStatistics_FUN_00441260 ; 0044100a
        ;   XREF to: 00441260 (UNCONDITIONAL_CALL)  ; void engine_colquant.c_computeBoxStatistics_FUN_00441260(SColorQuantMapper * workspace, int box_index)
    ...
    PUSH EDI                            ; 00441022
    PUSH EBX                            ; 00441023
    CALL engine_colquant.c_refinePartitionByDistance_FUN_00441110 ; 00441024
