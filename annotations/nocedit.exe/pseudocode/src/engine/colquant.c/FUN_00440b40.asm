...
;                               FUNCTION
; *****************************************************************************
; unknown undefined engine_colquant.c_FUN_00440b40()
;
; Local Variables:
...
section .text
    ...
    JLE 0x00440bf2                      ; 00440b74 | LAB_00440bf2
    ...
    JLE 0x00440bdc                      ; 00440b94 | LAB_00440bdc
    ...
    CMP ESI,EAX                         ; 00440ba4
        ;   Label: LAB_00440ba4
    JGE 0x00440bc1                      ; 00440ba6 | LAB_00440bc1
    ...
    JLE 0x00440bc1                      ; 00440bb9 | LAB_00440bc1
        ;   XREF to: 00440bc1 (CONDITIONAL_JUMP)
    DEC EDX                             ; 00440bbb
    SUB EAX,0x4                         ; 00440bbc
    JMP 0x00440ba4                      ; 00440bbf | LAB_00440ba4
    ...
    JG 0x00440b80                       ; 00440bf0 | LAB_00440b80
    ...
    PUSH EDX                            ; 00440c38
    PUSH EBX                            ; 00440c39
    CALL engine_colquant.c_FUN_00441260 ; 00440c3a | undefined engine_colquant.c_FUN_00441260()
        ;   XREF to: 00441260 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00440c3f
    MOV ECX,dword ptr [ESP + 0x24]      ; 00440c42
    PUSH ECX                            ; 00440c46
    PUSH EBX                            ; 00440c47
    CALL engine_colquant.c_FUN_00441260 ; 00440c48 | undefined engine_colquant.c_FUN_00441260()
        ;   XREF to: 00441260 (UNCONDITIONAL_CALL)
    ...
    PUSH EDI                            ; 00440c60
    PUSH EBX                            ; 00440c61
    CALL engine_colquant.c_FUN_00441110 ; 00440c62 | undefined engine_colquant.c_FUN_00441110()
