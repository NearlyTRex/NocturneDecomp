...

{
  ...
  avg_intensity = (int)workspace->boxes[box_index].avg_intensity;
  iVar5 = local_14 + workspace->boxes[box_index].count + -1;
  if (local_14 < iVar5) {
    local_18 = local_14 << 2;
    do {
      if (avg_intensity < (int)(uint)(byte)workspace->color_data[local_18 + 3]) {
        iVar3 = iVar5 * 4;
        while ((local_14 * 4 < iVar3 &&
               (avg_intensity < (int)(uint)(byte)workspace->color_data[iVar3 + 3]))) {
          iVar5 = iVar5 + -1;
          iVar3 = iVar3 + -4;
        }
