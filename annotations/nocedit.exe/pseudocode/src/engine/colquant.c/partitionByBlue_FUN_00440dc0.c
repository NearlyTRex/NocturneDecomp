...
// Convention: __cdecl
// Signature: void __cdecl engine_colquant_c_partitionByBlue_FUN_00440dc0(SColorQuantWorkspace *workspace,int box_index,int new_box_index)
...

{
  ...
  if (local_14 < iVar5) {
    local_18 = local_14 << 2;
    do {
      if (iVar2 >> 0x10 < (int)(uint)(byte)workspace->color_data[local_18 + 2]) {
        iVar3 = iVar5 * 4;
        while ((local_14 * 4 < iVar3 &&
               (iVar2 >> 0x10 < (int)(uint)(byte)workspace->color_data[iVar3 + 2]))) {
          iVar5 = iVar5 + -1;
          iVar3 = iVar3 + -4;
        }
