...
;
; XREF[2]:
;   engine_special.cpp_initializeExternalRenderer_FUN_005b5ec0 at 005b5f1f
;   engine_special.cpp_loadExternalRenderer_FUN_005b6750 at 005b67e0
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 005b7f90
        ;   Label: engine_special.cpp_CExternalRenderer_ctor_FUN_005b7f90
