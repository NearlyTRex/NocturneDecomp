// Name: engine_special.cpp_renderPerspectiveCorrectScanline16_FUN_005b5322
// Address: 005b5322
// MANUAL RECONSTRUCTION
// Address Range: [[005b5322, 005b555b]]
// Convention: __edi_esi_ebx
// Signature: void __edi_esi_ebx engine_special_cpp_renderPerspectiveCorrectScanline16_FUN_005b5322(SSoftwareEdge *left_vertex,SSoftwareEdge *right_vertex,int scanline_y)
...

{
  ...
  if (iVar4 != 0 && uVar3 <= uVar6 >> 0x10) {
    g_CurrentScreenPtr = (int *)((char *)g_ScreenBufferArray[scanline_y] + uVar3 * 2);
