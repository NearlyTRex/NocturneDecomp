...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x8]       ; 005b8120
        ;   Label: engine_special.cpp_CExternalRenderer_switchRenderer_FUN_005b8120
    MOV EAX,dword ptr [ESP + 0x4]       ; 005b8124
    PUSH EDX                            ; 005b8128
    ADD EAX,0x1dc8                      ; 005b8129
    PUSH EAX                            ; 005b812e
    CALL engine_special.cpp_switchRenderer_FUN_005b8140 ; 005b812f
        ;   XREF to: 005b8140 (UNCONDITIONAL_CALL)  ; int engine_special.cpp_switchRenderer_FUN_005b8140(char * new_dll_name, int renderer_handle)
