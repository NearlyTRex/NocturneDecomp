...
section .text
    ...
    PUSH EBP                            ; 005b7c30
        ;   Label: engine_special.cpp_presentToExternalRenderer_FUN_005b7c30
    ...
    CALL engine_special.cpp_lockFrame_FUN_005b7210 ; 005b7c87
    ...
    PUSH 0x0                            ; 005b7cd0
        ;   Label: LAB_005b7cd0
    CALL engine_special.cpp_unlockFrame_FUN_005b7250 ; 005b7cd2
