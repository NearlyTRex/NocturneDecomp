...
;
; XREF[2]:
;   engine_special.cpp_initializeExternalRenderer_FUN_005b5ec0 at 005b5f34
;   engine_special.cpp_loadExternalRenderer_FUN_005b6750 at 005b67f5
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 005b7fe0
        ;   Label: engine_special.cpp_CExternalRenderer_validate_FUN_005b7fe0
    PUSH ESI                            ; 005b7fe1
    PUSH EDI                            ; 005b7fe2
    ...
    JZ 0x005b80f8                       ; 005b7ff6
        ;   XREF to: 005b80f8 (CONDITIONAL_JUMP)  ; LAB_005b80f8
    MOV DX,word ptr [EDI + 0x204]       ; 005b7ffc
    CMP DX,word ptr [ESI + 0x204]       ; 005b8003
    JNZ 0x005b80fe                      ; 005b800a
        ;   XREF to: 005b80fe (CONDITIONAL_JUMP)  ; LAB_005b80fe
    MOV EAX,0x1                         ; 005b8010
        ;   Label: LAB_005b8010
    MOV EBX,EAX                         ; 005b8015
        ;   Label: LAB_005b8015
    TEST EAX,EAX                        ; 005b8017
    JZ 0x005b8031                       ; 005b8019
        ;   XREF to: 005b8031 (CONDITIONAL_JUMP)  ; LAB_005b8031
    MOV EAX,dword ptr [EDI + 0x208]     ; 005b801b
    MOV EDX,dword ptr [ESI + 0x208]     ; 005b8021
    NOT EAX                             ; 005b8027
    AND EAX,EDX                         ; 005b8029
    JNZ 0x005b810f                      ; 005b802b
        ;   XREF to: 005b810f (CONDITIONAL_JUMP)  ; LAB_005b810f
    TEST EBX,EBX                        ; 005b8031
        ;   Label: LAB_005b8031
    JZ 0x005b808f                       ; 005b8033
        ;   XREF to: 005b808f (CONDITIONAL_JUMP)  ; LAB_005b808f
    CMP word ptr [ESI + 0x200],0x0      ; 005b8035
    JZ 0x005b8060                       ; 005b803d
        ;   XREF to: 005b8060 (CONDITIONAL_JUMP)  ; LAB_005b8060
    ...
    TEST EBX,EBX                        ; 005b8060
        ;   Label: LAB_005b8060
    JZ 0x005b808f                       ; 005b8062
        ;   XREF to: 005b808f (CONDITIONAL_JUMP)  ; LAB_005b808f
    CMP word ptr [ESI + 0x202],0x0      ; 005b8064
    JZ 0x005b808f                       ; 005b806c
        ;   XREF to: 005b808f (CONDITIONAL_JUMP)  ; LAB_005b808f
    ...
    TEST EBX,EBX                        ; 005b808f
        ;   Label: LAB_005b808f
    JZ 0x005b80bb                       ; 005b8091
        ;   XREF to: 005b80bb (CONDITIONAL_JUMP)  ; LAB_005b80bb
    CMP byte ptr [ESI + 0x100],0x0      ; 005b8093
    JZ 0x005b80bb                       ; 005b809a
        ;   XREF to: 005b80bb (CONDITIONAL_JUMP)  ; LAB_005b80bb
    ...
    JGE 0x005b80f8                      ; 005b80f2
        ;   XREF to: 005b80f8 (CONDITIONAL_JUMP)  ; LAB_005b80f8
    TEST ESI,ESI                        ; 005b80f4
    JNZ 0x005b80d2                      ; 005b80f6
        ;   XREF to: 005b80d2 (CONDITIONAL_JUMP)  ; LAB_005b80d2
    ...
    CMP DX,-0x1                         ; 005b80fe
        ;   Label: LAB_005b80fe
    JZ 0x005b8010                       ; 005b8102
        ;   XREF to: 005b8010 (CONDITIONAL_JUMP)  ; LAB_005b8010
    XOR EAX,EAX                         ; 005b8108
    JMP 0x005b8015                      ; 005b810a
        ;   XREF to: 005b8015 (UNCONDITIONAL_JUMP)  ; LAB_005b8015
