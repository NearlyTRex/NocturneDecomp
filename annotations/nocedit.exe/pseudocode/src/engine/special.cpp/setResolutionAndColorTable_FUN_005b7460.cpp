// Name: engine_special.cpp_setResolutionAndColorTable_FUN_005b7460
// Address: 005b7460
// Address Range: [[005b7460, 005b7578]]
// Convention: __cdecl
// Signature: int __cdecl engine_special_cpp_setResolutionAndColorTable_FUN_005b7460(int width,int height,int bits_per_pixel)
...

{
  ...
  if ((g_LoadedExternalDLLRenderer == 0) &&
     (iVar4 = engine_special_cpp_loadExternalRenderer_FUN_005b6750(g_StoredWindowHandle), iVar4 == 0
     )) {
    return 0;
  }
