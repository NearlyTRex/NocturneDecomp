...
section .text
    ...
    PUSH ESI                            ; 005b8140
        ;   Label: engine_special.cpp_switchRenderer_FUN_005b8140
    PUSH EDI                            ; 005b8141
    CALL engine_special.cpp_kill_FUN_005b71e0 ; 005b8142
    ...
    MOV AL,byte ptr [ESI]               ; 005b815a
        ;   Label: LAB_005b815a
    MOV byte ptr [EDI],AL               ; 005b815c | g_RendererDllPath | s_id3d_dll_00684012
    CMP AL,0x0                          ; 005b815e
    JZ 0x005b8172                       ; 005b8160
        ;   XREF to: 005b8172 (CONDITIONAL_JUMP)  ; LAB_005b8172
    MOV AL,byte ptr [ESI + 0x1]         ; 005b8162
    ADD ESI,0x2                         ; 005b8165
    MOV byte ptr [EDI + 0x1],AL         ; 005b8168 | g_RendererDllPath+1 | s_d3d.dll_00684013
    ...
    PUSH EDX                            ; 005b8179
    CALL engine_special.cpp_loadExternalRenderer_FUN_005b6750 ; 005b817a
