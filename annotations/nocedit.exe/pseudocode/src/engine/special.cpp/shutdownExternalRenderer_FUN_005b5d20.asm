...
;
; XREF[3]:
;   engine_special.cpp_initializeExternalRenderer_FUN_005b5ec0 at 005b66f3
;   engine_special.cpp_kill_FUN_005b71e0 at 005b71f5
;   engine_special.cpp_loadExternalRenderer_FUN_005b6750 at 005b6fa1
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 005b5d20
        ;   Label: engine_special.cpp_shutdownExternalRenderer_FUN_005b5d20
    PUSH EBP                            ; 005b5d21
