...
;   core_course.cpp_CCourse_preview_FUN_00443bc0 at 00443cca
...
section .text
    ...
    PUSH ESI                            ; 005b3e70
        ;   Label: engine_special.cpp_clearScreen_FUN_005b3e70
    PUSH EDI                            ; 005b3e71
    ...
    CALL engine_special.cpp_clear_FUN_005b7a30 ; 005b3e7b
