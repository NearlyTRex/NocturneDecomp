// Name: engine_special.cpp_renderMMXPerspectiveScanline16_FUN_005b4823
// Address: 005b4823
// MANUAL RECONSTRUCTION
// Address Range: [[005b4823, 005b507e] [005b5085, 005b50eb]]
// Convention: __edi_esi_ebx
// Signature: void __edi_esi_ebx engine_special_cpp_renderMMXPerspectiveScanline16_FUN_005b4823(SSoftwareEdge *left_vertex,SSoftwareEdge *right_vertex,int scanline_y)
...

{
  ...
  // Perspective: start = (u_current << 24) / depth_current per vertex, then delta
  ...
  // Vertex alpha tracks alpha_current.
  ...
  if ((g_RenderStateFlags.dword & RENDER_COLOR_FROM_VERTEX) != 0) {
    ...
    // Red from red_current, green from color_current, blue from blue_current — all >> 1.
