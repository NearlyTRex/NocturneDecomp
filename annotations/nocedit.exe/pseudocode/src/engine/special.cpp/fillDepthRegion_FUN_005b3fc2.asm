...
;
; Called Functions:
;   engine_special.cpp_clearZBox_FUN_005b7c00
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBP                            ; 005b3fc2
        ;   Label: engine_special.cpp_fillDepthRegion_FUN_005b3fc2
    ...
    CALL engine_special.cpp_clearZBox_FUN_005b7c00 ; 005b3fdc
        ;   XREF to: 005b7c00 (UNCONDITIONAL_CALL)  ; int engine_special.cpp_clearZBox_FUN_005b7c00(int left, int right, int top, int bottom)
    POP EAX                             ; 005b3fe1
    POP EAX                             ; 005b3fe2
    POP EAX                             ; 005b3fe3
    POP EAX                             ; 005b3fe4
