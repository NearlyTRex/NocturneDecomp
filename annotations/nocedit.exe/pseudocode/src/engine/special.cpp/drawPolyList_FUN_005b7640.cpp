// Name: engine_special.cpp_drawPolyList_FUN_005b7640
// Address: 005b7640
...

{
  ...
  if (g_APIDLL_drawPolyList != (APIDLL_drawPolyList *)0x0) {
    iVar1 = (*g_APIDLL_drawPolyList)(vertex_buffer,polygons,polygon_count,render_flags);
    return iVar1;
  }
  iVar2 = 0;
  if (0 < polygon_count) {
    do {
      pSVar1 = (SMRGLPrimitiveTriangle *)*polygons;
