...
section .text
    ...
    CMP dword ptr [0x00772a7c],0x1      ; 00552162 | int g_CullingMode
    JNZ 0x005521d3                      ; 00552169 | LAB_005521d3
    ...
    JGE 0x005521c3                      ; 005521bc | LAB_005521c3
    ...
    JMP 0x00552197                      ; 005521ff | LAB_00552197
