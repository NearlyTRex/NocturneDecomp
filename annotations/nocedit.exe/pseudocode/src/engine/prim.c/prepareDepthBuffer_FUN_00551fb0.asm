...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl engine_prim_c_prepareDepthBuffer_FUN_00551fb0(SRenderVertex *vertices,int vertex_count)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [0x02d0529c]      ; 00551fba | g_ProcessorType
    TEST EDX,EDX                        ; 00551fc0
    JZ 0x00551fef                       ; 00551fc2
        ;   XREF to: 00551fef (CONDITIONAL_JUMP)  ; LAB_00551fef
    XOR EDX,EDX                         ; 00551fc4
    TEST EBX,EBX                        ; 00551fc6
    JLE 0x00551fe0                      ; 00551fc8
        ;   XREF to: 00551fe0 (CONDITIONAL_JUMP)  ; LAB_00551fe0
    MOV ECX,dword ptr [EAX + 0x8]       ; 00551fca
        ;   Label: LAB_00551fca
    TEST ECX,ECX                        ; 00551fcd
    JNZ 0x00551fe3                      ; 00551fcf
        ;   XREF to: 00551fe3 (CONDITIONAL_JUMP)  ; LAB_00551fe3
    MOV dword ptr [EAX + 0x8],0x7fffffff ; 00551fd1
    INC EDX                             ; 00551fd8
        ;   Label: LAB_00551fd8
    ADD EAX,0x30                        ; 00551fd9
    CMP EDX,EBX                         ; 00551fdc
    JL 0x00551fca                       ; 00551fde
        ;   XREF to: 00551fca (CONDITIONAL_JUMP)  ; LAB_00551fca
    POP ESI                             ; 00551fe0
        ;   Label: LAB_00551fe0
    POP EBX                             ; 00551fe1
    RET                                 ; 00551fe2
    ...
    JMP 0x00551fd8                      ; 00551fed
        ;   XREF to: 00551fd8 (UNCONDITIONAL_JUMP)  ; LAB_00551fd8
    TEST EBX,EBX                        ; 00551fef
        ;   Label: LAB_00551fef
    JLE 0x00551fe0                      ; 00551ff1
        ;   XREF to: 00551fe0 (CONDITIONAL_JUMP)  ; LAB_00551fe0
    MOV ECX,dword ptr [EAX + 0x8]       ; 00551ff3
        ;   Label: LAB_00551ff3
    SAR ECX,0x4                         ; 00551ff6
    TEST ECX,ECX                        ; 00551ff9
    JNZ 0x0055200e                      ; 00551ffb
        ;   XREF to: 0055200e (CONDITIONAL_JUMP)  ; LAB_0055200e
    MOV dword ptr [EAX + 0x8],0x7fffffff ; 00551ffd
    INC EDX                             ; 00552004
    ADD EAX,0x30                        ; 00552005
    CMP EDX,EBX                         ; 00552008
    JGE 0x00551fe0                      ; 0055200a
        ;   XREF to: 00551fe0 (CONDITIONAL_JUMP)  ; LAB_00551fe0
    JMP 0x00551ff3                      ; 0055200c
        ;   XREF to: 00551ff3 (UNCONDITIONAL_JUMP)  ; LAB_00551ff3
    ...
    JGE 0x00551fe0                      ; 0055201a
        ;   XREF to: 00551fe0 (CONDITIONAL_JUMP)  ; LAB_00551fe0
    JMP 0x00551ff3                      ; 0055201c
        ;   XREF to: 00551ff3 (UNCONDITIONAL_JUMP)  ; LAB_00551ff3
