...
section .text
    ...
    PUSH ESI                            ; 00551f71
    MOV EBX,dword ptr [0x030e5228]      ; 00551f72 | int g_SoftwareEdgeCount
    MOV ECX,dword ptr [ESP + 0xc]       ; 00551f78
    MOV ESI,dword ptr [ESP + 0x10]      ; 00551f7c
    MOV EAX,0x30e522c                   ; 00551f80 | SSoftwareEdge[16] g_SoftwareEdgeBuffer
    XOR EDX,EDX                         ; 00551f85
    TEST EBX,EBX                        ; 00551f87
    JLE 0x00551f9b                      ; 00551f89 | LAB_00551f9b
        ;   XREF to: 00551f9b (CONDITIONAL_JUMP)
    CMP ECX,dword ptr [EAX]             ; 00551f8b | SSoftwareEdge[16] g_SoftwareEdgeBuffer
        ;   Label: LAB_00551f8b
    JNZ 0x00551f93                      ; 00551f8d | LAB_00551f93
        ;   XREF to: 00551f93 (CONDITIONAL_JUMP)
    CMP EAX,ESI                         ; 00551f8f
    JNZ 0x00551f9d                      ; 00551f91 | LAB_00551f9d
        ;   XREF to: 00551f9d (CONDITIONAL_JUMP)
    INC EDX                             ; 00551f93
        ;   Label: LAB_00551f93
    ADD EAX,0x48                        ; 00551f94 | DAT_030e5274
    CMP EDX,EBX                         ; 00551f97
    JL 0x00551f8b                       ; 00551f99 | LAB_00551f8b
        ;   XREF to: 00551f8b (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 00551f9b
        ;   Label: LAB_00551f9b
    MOV dword ptr [0x030e5228],EBX      ; 00551f9d | int g_SoftwareEdgeCount
        ;   Label: LAB_00551f9d
    POP ESI                             ; 00551fa3
    POP EBX                             ; 00551fa4
    RET                                 ; 00551fa5
