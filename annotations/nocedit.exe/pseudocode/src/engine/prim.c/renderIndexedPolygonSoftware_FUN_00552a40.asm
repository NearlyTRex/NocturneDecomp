...
section .text
    ...
    CMP dword ptr [0x00772a7c],0x0      ; 00552a47 | int g_CullingMode
    JZ 0x00552aad                       ; 00552a4e | LAB_00552aad
        ;   XREF to: 00552aad (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [ESP + 0x6c]      ; 00552a50
    CMP ECX,0x3                         ; 00552a54
    JLE 0x00552b2c                      ; 00552a57 | LAB_00552b2c
    ...
    JLE 0x00552aa5                      ; 00552a6a | LAB_00552aa5
        ;   XREF to: 00552aa5 (CONDITIONAL_JUMP)
    IMUL EAX,dword ptr [EBX + 0x8],0x30 ; 00552a6c
        ;   Label: LAB_00552a6c
    ADD EAX,0x688014                    ; 00552a70 | SRenderVertex[16] g_RenderVertexBuffer
    MOV ECX,dword ptr [EBX + 0x4]       ; 00552a75
    PUSH EAX                            ; 00552a78
    IMUL EAX,ECX,0x30                   ; 00552a79
    ADD EAX,0x688014                    ; 00552a7c | SRenderVertex[16] g_RenderVertexBuffer
    MOV EDX,dword ptr [EBX]             ; 00552a81
    PUSH EAX                            ; 00552a83
    IMUL EAX,EDX,0x30                   ; 00552a84
    ADD EAX,0x688014                    ; 00552a87 | SRenderVertex[16] g_RenderVertexBuffer
    PUSH EAX                            ; 00552a8c
    CALL engine_prim.c_calculateTriangleWindingOrder_FUN_00552150 ; 00552a8d | int engine_prim.c_calculateTriangleWindingOrder_FUN_00552150(SRenderVertex * v0, SRenderVertex * v1, SRenderVertex * v2)
        ;   XREF to: 00552150 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00552a92
    TEST EAX,EAX                        ; 00552a95
    JZ 0x00552b26                       ; 00552a97 | LAB_00552b26
        ;   XREF to: 00552b26 (CONDITIONAL_JUMP)
    INC ESI                             ; 00552a9d
        ;   Label: LAB_00552a9d
    ADD EBX,0x4                         ; 00552a9e
    CMP ESI,EBP                         ; 00552aa1
    JL 0x00552a6c                       ; 00552aa3 | LAB_00552a6c
        ;   XREF to: 00552a6c (CONDITIONAL_JUMP)
    CMP EDI,EBP                         ; 00552aa5
        ;   Label: LAB_00552aa5
    JZ 0x00552b1e                       ; 00552aa7 | LAB_00552b1e
        ;   XREF to: 00552b1e (CONDITIONAL_JUMP)
    CMP dword ptr [0x02d03e94],0x0      ; 00552aad | int g_UseExternalRenderer
        ;   Label: LAB_00552aad
    JZ 0x00552b8e                       ; 00552ab4 | LAB_00552b8e
        ;   XREF to: 00552b8e (CONDITIONAL_JUMP)
    CMP dword ptr [0x00772a74],0x0      ; 00552aba | int g_TexturesDisabled
    JNZ 0x00552b8e                      ; 00552ac1 | LAB_00552b8e
        ;   XREF to: 00552b8e (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [ESP + 0x6c]      ; 00552ac7
    XOR EAX,EAX                         ; 00552acb
    TEST EBX,EBX                        ; 00552acd
    JLE 0x00552af0                      ; 00552acf | LAB_00552af0
    ...
    IMUL EDX,dword ptr [ECX],0x30       ; 00552ad9
        ;   Label: LAB_00552ad9
    INC EAX                             ; 00552adc
    ADD EDX,0x688014                    ; 00552add | SRenderVertex[16] g_RenderVertexBuffer
    ADD ECX,0x4                         ; 00552ae3
    MOV dword ptr [ESP + EAX*0x4 + -0x4],EDX ; 00552ae6
    CMP EAX,ESI                         ; 00552aea
    JL 0x00552ad9                       ; 00552aec | LAB_00552ad9
        ;   XREF to: 00552ad9 (CONDITIONAL_JUMP)
    MOV EAX,EAX                         ; 00552aee
    MOV EAX,dword ptr [ESP + 0x6c]      ; 00552af0
        ;   Label: LAB_00552af0
    MOV EDI,dword ptr [0x030e56b8]      ; 00552af4 | int g_RenderedTriangleCount
    MOV EBP,dword ptr [0x02d052a0]      ; 00552afa | int g_RenderStateFlags
    ...
    PUSH EAX                            ; 00552b0f
    MOV dword ptr [0x030e56b8],EDI      ; 00552b10 | int g_RenderedTriangleCount
    CALL wincore_windll.cpp_drawPolygon2_FUN_005b7610 ; 00552b16 | int wincore_windll.cpp_drawPolygon2_FUN_005b7610(SRenderVertex * * vertex_array, int vertex_count, int render_flags)
    ...
    INC EDI                             ; 00552b26
        ;   Label: LAB_00552b26
    JMP 0x00552a9d                      ; 00552b27 | LAB_00552a9d
    ...
    ADD EAX,0x688014                    ; 00552b43 | SRenderVertex[16] g_RenderVertexBuffer
    ...
    ADD EAX,0x688014                    ; 00552b5c | SRenderVertex[16] g_RenderVertexBuffer
    MOV EDX,dword ptr [EDX]             ; 00552b61
    PUSH EAX                            ; 00552b63
    LEA EAX,[EDX*0x4 + 0x0]             ; 00552b64
    SUB EAX,EDX                         ; 00552b6b
    SHL EAX,0x4                         ; 00552b6d
    ADD EAX,0x688014                    ; 00552b70 | SRenderVertex[16] g_RenderVertexBuffer
    PUSH EAX                            ; 00552b75
    CALL engine_prim.c_calculateTriangleWindingOrder_FUN_00552150 ; 00552b76 | int engine_prim.c_calculateTriangleWindingOrder_FUN_00552150(SRenderVertex * v0, SRenderVertex * v1, SRenderVertex * v2)
        ;   XREF to: 00552150 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00552b7b
    TEST EAX,EAX                        ; 00552b7e
    JNZ 0x00552aad                      ; 00552b80 | LAB_00552aad
        ;   XREF to: 00552aad (CONDITIONAL_JUMP)
    ...
    MOV EDX,dword ptr [0x030e56b8]      ; 00552b99 | int g_RenderedTriangleCount
    MOV dword ptr [0x030e56b0],EDI      ; 00552b9f | int g_SoftwareMaxScanline
    MOV dword ptr [0x030e5228],EDI      ; 00552ba5 | int g_SoftwareEdgeCount
    MOV dword ptr [ESP + 0x48],EDI      ; 00552bab
    INC EDX                             ; 00552baf
    MOV dword ptr [0x030e56ac],ESI      ; 00552bb0 | int g_SoftwareMinScanline
    MOV dword ptr [0x030e56b8],EDX      ; 00552bb6 | int g_RenderedTriangleCount
    TEST ECX,ECX                        ; 00552bbc
    JLE 0x00552c29                      ; 00552bbe | LAB_00552c29
    ...
    JL 0x00552bd7                       ; 00552bd3 | LAB_00552bd7
    ...
    ADD EBP,0x688014                    ; 00552bea | SRenderVertex[16] g_RenderVertexBuffer
    ADD EAX,0x688014                    ; 00552bf0 | SRenderVertex[16] g_RenderVertexBuffer
    ...
    JNZ 0x00552d58                      ; 00552c07 | LAB_00552d58
    ...
    JL 0x00552bc8                       ; 00552c27 | LAB_00552bc8
        ;   XREF to: 00552bc8 (CONDITIONAL_JUMP)
    PUSH 0x0                            ; 00552c29
        ;   Label: LAB_00552c29
    MOV EAX,[0x030e56ac]                ; 00552c2b | int g_SoftwareMinScanline
    PUSH EAX                            ; 00552c30
    CALL engine_prim.c_findEdgeInBuffer_FUN_00551f70 ; 00552c31 | SSoftwareEdge * engine_prim.c_findEdgeInBuffer_FUN_00551f70(int y_value, SSoftwareEdge * edge_ptr)
        ;   XREF to: 00551f70 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00552c36
    MOV EBP,EAX                         ; 00552c39
    TEST EAX,EAX                        ; 00552c3b
    JZ 0x00552b1e                       ; 00552c3d | LAB_00552b1e
        ;   XREF to: 00552b1e (CONDITIONAL_JUMP)
    PUSH EAX                            ; 00552c43
    MOV EDX,dword ptr [0x030e56ac]      ; 00552c44 | int g_SoftwareMinScanline
    PUSH EDX                            ; 00552c4a
    CALL engine_prim.c_findEdgeInBuffer_FUN_00551f70 ; 00552c4b | SSoftwareEdge * engine_prim.c_findEdgeInBuffer_FUN_00551f70(int y_value, SSoftwareEdge * edge_ptr)
        ;   XREF to: 00551f70 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00552c50
    MOV dword ptr [ESP + 0x50],EAX      ; 00552c53
    TEST EAX,EAX                        ; 00552c57
    JZ 0x00552b1e                       ; 00552c59 | LAB_00552b1e
        ;   XREF to: 00552b1e (CONDITIONAL_JUMP)
    MOV EAX,[0x030e56ac]                ; 00552c5f | int g_SoftwareMinScanline
    MOV ECX,dword ptr [0x00680cf4]      ; 00552c64 | int g_MaxViewportScanline
    MOV dword ptr [ESP + 0x4c],EAX      ; 00552c6a
    CMP EAX,ECX                         ; 00552c6e
    JGE 0x00552b1e                      ; 00552c70 | LAB_00552b1e
        ;   Label: LAB_00552c70
        ;   XREF to: 00552b1e (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x4c]      ; 00552c76
    CMP EAX,dword ptr [EBP + 0x4]       ; 00552c7a
    JGE 0x00552f3f                      ; 00552c7d | LAB_00552f3f
    ...
    JL 0x00552cac                       ; 00552c8e | LAB_00552cac
        ;   XREF to: 00552cac (CONDITIONAL_JUMP)
    PUSH EBP                            ; 00552c90
    PUSH EAX                            ; 00552c91
    MOV dword ptr [EDX],0xffffffff      ; 00552c92
    CALL engine_prim.c_findEdgeInBuffer_FUN_00551f70 ; 00552c98 | SSoftwareEdge * engine_prim.c_findEdgeInBuffer_FUN_00551f70(int y_value, SSoftwareEdge * edge_ptr)
        ;   XREF to: 00551f70 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00552c9d
    MOV dword ptr [ESP + 0x50],EAX      ; 00552ca0
    TEST EAX,EAX                        ; 00552ca4
    JZ 0x00552b1e                       ; 00552ca6 | LAB_00552b1e
        ;   XREF to: 00552b1e (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [ESP + 0x50]      ; 00552cac
        ;   Label: LAB_00552cac
    MOV EBX,dword ptr [ESP + 0x4c]      ; 00552cb0
    MOV ESI,EBP                         ; 00552cb4
    CALL wincore_windll.cpp_renderScanline_FUN_005b5710 ; 00552cb6 | void wincore_windll.cpp_renderScanline_FUN_005b5710(void * left_data, void * right_data, int scanline_y)
    ...
    MOV EDX,dword ptr [0x00680cf4]      ; 00552d47 | int g_MaxViewportScanline
    MOV dword ptr [ESP + 0x4c],EDI      ; 00552d4d
    CMP EDI,EDX                         ; 00552d51
    JMP 0x00552c70                      ; 00552d53 | LAB_00552c70
    ...
    JLE 0x00552d6a                      ; 00552d5e | LAB_00552d6a
    ...
    IMUL EBP,dword ptr [0x030e5228],0x48 ; 00552d6a | int g_SoftwareEdgeCount
        ;   Label: LAB_00552d6a
    ADD EBP,0x30e522c                   ; 00552d71 | SSoftwareEdge[16] g_SoftwareEdgeBuffer
    MOV dword ptr [EBP],ECX             ; 00552d77 | SSoftwareEdge[16] g_SoftwareEdgeBuffer
    MOV EDX,dword ptr [0x030e56ac]      ; 00552d7a | int g_SoftwareMinScanline
    MOV dword ptr [EBP + 0x4],ESI       ; 00552d80 | DAT_030e5230
    CMP ECX,EDX                         ; 00552d83
    JGE 0x00552d8d                      ; 00552d85 | LAB_00552d8d
        ;   XREF to: 00552d8d (CONDITIONAL_JUMP)
    MOV dword ptr [0x030e56ac],ECX      ; 00552d87 | int g_SoftwareMinScanline
    CMP ESI,dword ptr [0x030e56b0]      ; 00552d8d | int g_SoftwareMaxScanline
        ;   Label: LAB_00552d8d
    JLE 0x00552d9b                      ; 00552d93 | LAB_00552d9b
        ;   XREF to: 00552d9b (CONDITIONAL_JUMP)
    MOV dword ptr [0x030e56b0],ESI      ; 00552d95 | int g_SoftwareMaxScanline
    ...
    JNC 0x00552ef3                      ; 00552da9 | LAB_00552ef3
    ...
    MOV EAX,dword ptr [EDI + 0x20]      ; 00552e4b | g_RenderVertexBuffer[0].light
    MOV EDX,dword ptr [EBX + 0x20]      ; 00552e4e | g_RenderVertexBuffer[0].light
    ...
    MOV EAX,dword ptr [EBX + 0x20]      ; 00552e72 | g_RenderVertexBuffer[0].light
    ADD EAX,EDX                         ; 00552e75
    MOV dword ptr [EBP + 0x10],EAX      ; 00552e77 | DAT_030e523c
    MOV EAX,dword ptr [EDI + 0x2c]      ; 00552e7a | g_RenderVertexBuffer[0].w_recip
    MOV EDX,dword ptr [EBX + 0x2c]      ; 00552e7d | g_RenderVertexBuffer[0].w_recip
    ...
    MOV EAX,dword ptr [EBX + 0x2c]      ; 00552ea1 | g_RenderVertexBuffer[0].w_recip
    ADD EAX,EDX                         ; 00552ea4
    MOV dword ptr [EBP + 0x30],EAX      ; 00552ea6 | DAT_030e525c
    CMP dword ptr [0x02d052a4],0x1      ; 00552ea9 | int g_RenderStateFlag2
    JNZ 0x00552f0b                      ; 00552eb0 | LAB_00552f0b
        ;   XREF to: 00552f0b (CONDITIONAL_JUMP)
    CMP dword ptr [0x02d0529c],0x0      ; 00552eb2 | int g_ProcessorType
    JZ 0x00552f03                       ; 00552eb9 | LAB_00552f03
    ...
    INC dword ptr [0x030e5228]          ; 00552ee8 | int g_SoftwareEdgeCount
    JMP 0x00552c0d                      ; 00552eee | LAB_00552c0d
    ...
    JMP 0x00552db1                      ; 00552efe | LAB_00552db1
    ...
    JMP 0x00552ecc                      ; 00552f09 | LAB_00552ecc
    ...
    INC dword ptr [0x030e5228]          ; 00552f34 | int g_SoftwareEdgeCount
    JMP 0x00552c0d                      ; 00552f3a | LAB_00552c0d
        ;   XREF to: 00552c0d (UNCONDITIONAL_JUMP)
    ...
    CALL engine_prim.c_findEdgeInBuffer_FUN_00551f70 ; 00552f4c | SSoftwareEdge * engine_prim.c_findEdgeInBuffer_FUN_00551f70(int y_value, SSoftwareEdge * edge_ptr)
        ;   XREF to: 00551f70 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00552f51
    MOV EBP,EAX                         ; 00552f54
    TEST EAX,EAX                        ; 00552f56
    JZ 0x00552b1e                       ; 00552f58 | LAB_00552b1e
        ;   XREF to: 00552b1e (CONDITIONAL_JUMP)
    JMP 0x00552c83                      ; 00552f5e | LAB_00552c83
