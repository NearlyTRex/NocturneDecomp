...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_prim.c_renderScanlinePolygon_FUN_00553470(SRenderVertex * vertices, int vertex_count)
;
; Parameters:
...
section .text
    ...
    CMP dword ptr [0x006793bc],0x0      ; 00553477 | uint g_VertexProcessingEnabled
    JZ 0x005534e7                       ; 0055347e | LAB_005534e7
    ...
    JLE 0x005534e7                      ; 0055348c | LAB_005534e7
        ;   XREF to: 005534e7 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [ESP + 0x2c]      ; 0055348e
    TEST byte ptr [ECX + 0x13],0x80     ; 00553492
        ;   Label: LAB_00553492
    JZ 0x005534df                       ; 00553496 | LAB_005534df
    ...
    MOV EDX,dword ptr [0x02d02548]      ; 005534aa | int g_ViewportCenterXFixed
    MOV EBX,dword ptr [ECX + 0x8]       ; 005534b0
    MOV EAX,dword ptr [ECX]             ; 005534b3
    IMUL EDX                            ; 005534b5
    IDIV EBX                            ; 005534b7
    MOV EDX,dword ptr [0x02d02550]      ; 005534b9 | int g_ViewportRightFixed
    ADD EAX,EDX                         ; 005534bf
    MOV EBX,dword ptr [ECX + 0x8]       ; 005534c1
    MOV dword ptr [ECX + 0x10],EAX      ; 005534c4
    MOV EDX,dword ptr [0x02d0254c]      ; 005534c7 | int g_ViewportCenterYFixed
    MOV EAX,dword ptr [ECX + 0x4]       ; 005534cd
    IMUL EDX                            ; 005534d0
    IDIV EBX                            ; 005534d2
    MOV EDX,dword ptr [0x02d02554]      ; 005534d4 | int g_ViewportBottomFixed
    ...
    JL 0x00553492                       ; 005534e5 | LAB_00553492
        ;   XREF to: 00553492 (CONDITIONAL_JUMP)
    CMP dword ptr [0x00772a7c],0x0      ; 005534e7 | int g_CullingMode
        ;   Label: LAB_005534e7
    JZ 0x0055354c                       ; 005534ee | LAB_0055354c
    ...
    JLE 0x00553718                      ; 00553505 | LAB_00553718
    ...
    JLE 0x00553542                      ; 0055351a | LAB_00553542
    ...
    PUSH EAX                            ; 00553522
    CALL engine_prim.c_calculateTriangleWindingOrder_FUN_00552150 ; 00553523 | int engine_prim.c_calculateTriangleWindingOrder_FUN_00552150(SRenderVertex * v0, SRenderVertex * v1, SRenderVertex * v2)
        ;   XREF to: 00552150 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00553528
    TEST EAX,EAX                        ; 0055352b
    JZ 0x00553712                       ; 0055352d | LAB_00553712
    ...
    JL 0x0055351c                       ; 00553540 | LAB_0055351c
        ;   XREF to: 0055351c (CONDITIONAL_JUMP)
    CMP EBP,dword ptr [ESP + 0x4]       ; 00553542
        ;   Label: LAB_00553542
    JZ 0x0055370a                       ; 00553546 | LAB_0055370a
        ;   XREF to: 0055370a (CONDITIONAL_JUMP)
    CMP dword ptr [0x02d03e94],0x0      ; 0055354c | int g_UseExternalRenderer
        ;   Label: LAB_0055354c
    JZ 0x00553562                       ; 00553553 | LAB_00553562
        ;   XREF to: 00553562 (CONDITIONAL_JUMP)
    CMP dword ptr [0x00772a74],0x0      ; 00553555 | int g_TexturesDisabled
    JZ 0x00553737                       ; 0055355c | LAB_00553737
        ;   XREF to: 00553737 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [0x030e56b8]      ; 00553562 | int g_RenderedTriangleCount
        ;   Label: LAB_00553562
    INC EBX                             ; 00553568
    MOV EAX,[0x02d052a4]                ; 00553569 | int g_RenderStateFlag2
    MOV dword ptr [0x030e56b8],EBX      ; 0055356e | int g_RenderedTriangleCount
    CMP EAX,0x6                         ; 00553574
    JA 0x00553580                       ; 00553577 | caseD_0
        ;   XREF to: 00553580 (CONDITIONAL_JUMP)
    JMP dword ptr [EAX*0x4 + 0x553448]  ; 00553579 | void * switchdataD_00553448
        ;   Label: switchD
    MOV EAX,0x4b0                       ; 00553580
        ;   Label: caseD_4
    XOR EDX,EDX                         ; 00553585
    MOV ESI,dword ptr [ESP + 0x2c]      ; 00553587
    MOV dword ptr [0x030e5b44],EDX      ; 0055358b | int g_MaxScanline
    MOV dword ptr [0x030e56bc],EDX      ; 00553591 | int g_ActiveEdgeCount
    MOV dword ptr [ESP + 0x8],EDX       ; 00553597
    MOV [0x030e5b40],EAX                ; 0055359b | int g_MinScanline
    TEST ESI,ESI                        ; 005535a0
    JLE 0x005535ee                      ; 005535a2 | LAB_005535ee
    ...
    JL 0x005535b3                       ; 005535af | LAB_005535b3
    ...
    JNZ 0x005537dc                      ; 005535d7 | LAB_005537dc
    ...
    JL 0x005535a4                       ; 005535ec | LAB_005535a4
        ;   XREF to: 005535a4 (CONDITIONAL_JUMP)
    MOV EAX,0x30e56c0                   ; 005535ee | SSoftwareEdge[16] g_SoftwareEdgeTable
        ;   Label: LAB_005535ee
    MOV ESI,dword ptr [0x030e56bc]      ; 005535f3 | int g_ActiveEdgeCount
    MOV EBX,dword ptr [0x030e5b40]      ; 005535f9 | int g_MinScanline
    XOR ECX,ECX                         ; 005535ff
    TEST ESI,ESI                        ; 00553601
    JLE 0x005539ca                      ; 00553603 | LAB_005539ca
        ;   XREF to: 005539ca (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x030e56bc]      ; 00553609 | int g_ActiveEdgeCount
    CMP EBX,dword ptr [EAX]             ; 0055360f | SSoftwareEdge[16] g_SoftwareEdgeTable
        ;   Label: LAB_0055360f
    JNZ 0x005539be                      ; 00553611 | LAB_005539be
        ;   XREF to: 005539be (CONDITIONAL_JUMP)
    TEST EAX,EAX                        ; 00553617
    JZ 0x005539be                       ; 00553619 | LAB_005539be
        ;   XREF to: 005539be (CONDITIONAL_JUMP)
    MOV EBP,EAX                         ; 0055361f
        ;   Label: LAB_0055361f
    TEST EAX,EAX                        ; 00553621
    JZ 0x0055370a                       ; 00553623 | LAB_0055370a
        ;   XREF to: 0055370a (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [0x030e56bc]      ; 00553629 | int g_ActiveEdgeCount
    MOV EBX,dword ptr [0x030e5b40]      ; 0055362f | int g_MinScanline
    MOV ECX,EAX                         ; 00553635 | SSoftwareEdge[16] g_SoftwareEdgeTable
    XOR EDX,EDX                         ; 00553637
    MOV EAX,0x30e56c0                   ; 00553639 | SSoftwareEdge[16] g_SoftwareEdgeTable
    TEST EDI,EDI                        ; 0055363e
    JLE 0x005539dd                      ; 00553640 | LAB_005539dd
        ;   XREF to: 005539dd (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [0x030e56bc]      ; 00553646 | int g_ActiveEdgeCount
    CMP EBX,dword ptr [EAX]             ; 0055364c | SSoftwareEdge[16] g_SoftwareEdgeTable
        ;   Label: LAB_0055364c
    JNZ 0x005539d1                      ; 0055364e | LAB_005539d1
        ;   XREF to: 005539d1 (CONDITIONAL_JUMP)
    CMP EAX,ECX                         ; 00553654
    JZ 0x005539d1                       ; 00553656 | LAB_005539d1
        ;   XREF to: 005539d1 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x10],EAX      ; 0055365c | SSoftwareEdge[16] g_SoftwareEdgeTable
        ;   Label: LAB_0055365c
    TEST EAX,EAX                        ; 00553660
    JZ 0x0055370a                       ; 00553662 | LAB_0055370a
        ;   XREF to: 0055370a (CONDITIONAL_JUMP)
    MOV EAX,[0x030e5b40]                ; 00553668 | int g_MinScanline
    ...
    JL 0x005536b8                       ; 00553678 | LAB_005536b8
        ;   XREF to: 005536b8 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [ESP + 0x10]      ; 0055367a
    MOV ESI,dword ptr [0x030e56bc]      ; 0055367e | int g_ActiveEdgeCount
    MOV ECX,EAX                         ; 00553684
    MOV dword ptr [EBP],0xffffffff      ; 00553686 | SSoftwareEdge[16] g_SoftwareEdgeTable
    XOR EDX,EDX                         ; 0055368d
    MOV EAX,0x30e56c0                   ; 0055368f | SSoftwareEdge[16] g_SoftwareEdgeTable
    TEST ESI,ESI                        ; 00553694
    JLE 0x005539f0                      ; 00553696 | LAB_005539f0
        ;   XREF to: 005539f0 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [0x030e56bc]      ; 0055369c | int g_ActiveEdgeCount
    CMP ECX,dword ptr [EAX]             ; 005536a2 | SSoftwareEdge[16] g_SoftwareEdgeTable
        ;   Label: LAB_005536a2
    JNZ 0x005539e4                      ; 005536a4 | LAB_005539e4
        ;   XREF to: 005539e4 (CONDITIONAL_JUMP)
    CMP EAX,EBX                         ; 005536aa
    JZ 0x005539e4                       ; 005536ac | LAB_005539e4
        ;   XREF to: 005539e4 (CONDITIONAL_JUMP)
    MOV EBP,EAX                         ; 005536b2
        ;   Label: LAB_005536b2
    TEST EAX,EAX                        ; 005536b4
    JZ 0x0055370a                       ; 005536b6 | LAB_0055370a
        ;   XREF to: 0055370a (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [ESP + 0x10]      ; 005536b8 | SSoftwareEdge[16] g_SoftwareEdgeTable
        ;   Label: LAB_005536b8
    MOV EAX,dword ptr [ESP + 0xc]       ; 005536bc
    CMP EAX,dword ptr [EDX + 0x4]       ; 005536c0 | g_SoftwareEdgeTable[0].y_max
    JL 0x00553a15                       ; 005536c3 | LAB_00553a15
        ;   XREF to: 00553a15 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [0x030e56bc]      ; 005536c9 | int g_ActiveEdgeCount
    MOV EBX,EAX                         ; 005536cf
    MOV ECX,EBP                         ; 005536d1 | SSoftwareEdge[16] g_SoftwareEdgeTable
    MOV dword ptr [EDX],0xffffffff      ; 005536d3 | SSoftwareEdge[16] g_SoftwareEdgeTable
    MOV EAX,0x30e56c0                   ; 005536d9 | SSoftwareEdge[16] g_SoftwareEdgeTable
    XOR EDX,EDX                         ; 005536de
    TEST ESI,ESI                        ; 005536e0
    JLE 0x00553a03                      ; 005536e2 | LAB_00553a03
        ;   XREF to: 00553a03 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [0x030e56bc]      ; 005536e8 | int g_ActiveEdgeCount
    CMP EBX,dword ptr [EAX]             ; 005536ee | SSoftwareEdge[16] g_SoftwareEdgeTable
        ;   Label: LAB_005536ee
    JNZ 0x005539f7                      ; 005536f0 | LAB_005539f7
        ;   XREF to: 005539f7 (CONDITIONAL_JUMP)
    CMP EAX,ECX                         ; 005536f6
    JZ 0x005539f7                       ; 005536f8 | LAB_005539f7
        ;   XREF to: 005539f7 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x10],EAX      ; 005536fe | g_SoftwareEdgeTable[1].y_min
    TEST EAX,EAX                        ; 00553702
    JNZ 0x00553a15                      ; 00553704 | LAB_00553a15
        ;   XREF to: 00553a15 (CONDITIONAL_JUMP)
    ...
    INC EBP                             ; 00553712
        ;   Label: LAB_00553712
    JMP 0x00553533                      ; 00553713 | LAB_00553533
    ...
    PUSH ECX                            ; 0055371e
    CALL engine_prim.c_calculateTriangleWindingOrder_FUN_00552150 ; 0055371f | int engine_prim.c_calculateTriangleWindingOrder_FUN_00552150(SRenderVertex * v0, SRenderVertex * v1, SRenderVertex * v2)
        ;   XREF to: 00552150 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00553724
    TEST EAX,EAX                        ; 00553727
    JNZ 0x0055354c                      ; 00553729 | LAB_0055354c
        ;   XREF to: 0055354c (CONDITIONAL_JUMP)
    ...
    POP EBX                             ; 00553735
    RET                                 ; 00553736
    MOV EDI,dword ptr [0x02d052a0]      ; 00553737 | int g_RenderStateFlags
        ;   Label: LAB_00553737
    PUSH EDI                            ; 0055373d
    ...
    PUSH EAX                            ; 00553747
    CALL wincore_windll.cpp_drawPolygon_FUN_005b75e0 ; 00553748 | int wincore_windll.cpp_drawPolygon_FUN_005b75e0(SRenderVertex * vertices, int vertex_count, int render_flags)
        ;   XREF to: 005b75e0 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [0x030e56b8]      ; 0055374d | int g_RenderedTriangleCount
    LEA EAX,[EBP + -0x2]                ; 00553753
    ADD EDX,EAX                         ; 00553756
    ADD ESP,0xc                         ; 00553758
    MOV dword ptr [0x030e56b8],EDX      ; 0055375b | int g_RenderedTriangleCount
    ...
    PUSH EBP                            ; 00553772
    CALL engine_prim.c_prepareDepthBuffer_FUN_00551fb0 ; 00553773 | void engine_prim.c_prepareDepthBuffer_FUN_00551fb0(SRenderVertex * vertices, int vertex_count)
        ;   XREF to: 00551fb0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00553778
    JMP 0x00553580                      ; 0055377b | caseD_0
    ...
    PUSH ESI                            ; 00553789
    CALL engine_prim.c_normalizeTextureCoords_FUN_00552020 ; 0055378a | void engine_prim.c_normalizeTextureCoords_FUN_00552020(SRenderVertex * vertices, int vertex_count)
        ;   XREF to: 00552020 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0055378f
    JMP 0x00553580                      ; 00553792 | caseD_0
        ;   XREF to: 00553580 (UNCONDITIONAL_JUMP)
    ...
    PUSH ECX                            ; 005537a0
    CALL engine_prim.c_adjustNearPlaneTextureCoords_FUN_005520a0 ; 005537a1 | void engine_prim.c_adjustNearPlaneTextureCoords_FUN_005520a0(SRenderVertex * vertices, int vertex_count)
        ;   XREF to: 005520a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005537a6
    JMP 0x00553580                      ; 005537a9 | caseD_0
        ;   XREF to: 00553580 (UNCONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 005537b7
    CALL engine_prim.c_normalizeTextureCoords_FUN_00552020 ; 005537b8 | void engine_prim.c_normalizeTextureCoords_FUN_00552020(SRenderVertex * vertices, int vertex_count)
        ;   XREF to: 00552020 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005537bd
    JMP 0x00553580                      ; 005537c0 | caseD_0
        ;   XREF to: 00553580 (UNCONDITIONAL_JUMP)
    ...
    PUSH EDI                            ; 005537ce
    CALL engine_prim.c_replaceWWithDepth_FUN_00552110 ; 005537cf | void engine_prim.c_replaceWWithDepth_FUN_00552110(SRenderVertex * vertices, int vertex_count)
        ;   XREF to: 00552110 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005537d4
    JMP 0x00553580                      ; 005537d7 | caseD_0
        ;   XREF to: 00553580 (UNCONDITIONAL_JUMP)
    MOV EBP,dword ptr [ESI + 0x14]      ; 005537dc
        ;   Label: LAB_005537dc
    CMP EBP,dword ptr [ECX + 0x14]      ; 005537df
    JLE 0x005537ee                      ; 005537e2 | LAB_005537ee
    ...
    IMUL EBP,dword ptr [0x030e56bc],0x48 ; 005537ee | int g_ActiveEdgeCount
        ;   Label: LAB_005537ee
    ADD EBP,0x30e56c0                   ; 005537f5 | SSoftwareEdge[16] g_SoftwareEdgeTable
    MOV dword ptr [EBP],EDX             ; 005537fb | SSoftwareEdge[16] g_SoftwareEdgeTable
    MOV ESI,dword ptr [0x030e5b40]      ; 005537fe | int g_MinScanline
    MOV dword ptr [EBP + 0x4],EAX       ; 00553804 | g_SoftwareEdgeTable[0].y_max
    CMP EDX,ESI                         ; 00553807
    JGE 0x00553811                      ; 00553809 | LAB_00553811
        ;   XREF to: 00553811 (CONDITIONAL_JUMP)
    MOV dword ptr [0x030e5b40],EDX      ; 0055380b | int g_MinScanline
    CMP EAX,dword ptr [0x030e5b44]      ; 00553811 | int g_MaxScanline
        ;   Label: LAB_00553811
    JLE 0x0055381e                      ; 00553817 | LAB_0055381e
        ;   XREF to: 0055381e (CONDITIONAL_JUMP)
    MOV [0x030e5b44],EAX                ; 00553819 | int g_MaxScanline
    MOV ESI,dword ptr [EBX + 0x14]      ; 0055381e
        ;   Label: LAB_0055381e
    MOV ECX,dword ptr [EDI + 0x14]      ; 00553821
    SUB ECX,ESI                         ; 00553824
    CMP ECX,0x10000                     ; 00553826
    JNC 0x005539ae                      ; 0055382c | LAB_005539ae
    ...
    INC dword ptr [0x030e56bc]          ; 005539a3 | int g_ActiveEdgeCount
    JMP 0x005535dd                      ; 005539a9 | LAB_005535dd
    ...
    CALL wincore_windll.cpp_renderScanline_FUN_005b5710 ; 00553a1f | void wincore_windll.cpp_renderScanline_FUN_005b5710(void * left_data, void * right_data, int scanline_y)
    ...
    JMP 0x00553671                      ; 00553ae5 | LAB_00553671
