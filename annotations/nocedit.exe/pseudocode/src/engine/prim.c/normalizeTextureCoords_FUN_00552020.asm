...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_prim.c_normalizeTextureCoords_FUN_00552020(SRenderVertex * vertices, int vertex_count)
;
; Parameters:
...
;
; XREF[4]:
;   engine_3d.c_rasterizePolygon_FUN_005fd4e0 at 005fd782
...
section .text
    ...
    JL 0x00552052                       ; 00552098 | LAB_00552052
        ;   XREF to: 00552052 (CONDITIONAL_JUMP)
    POP EBP                             ; 0055209a
    POP EDI                             ; 0055209b
    POP ESI                             ; 0055209c
