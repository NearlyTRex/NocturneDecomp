...
section .text
    ...
    CMP dword ptr [0x006793bc],0x0      ; 00552517 | uint g_VertexProcessingEnabled
    JZ 0x00552587                       ; 0055251e | LAB_00552587
    ...
    JLE 0x00552587                      ; 0055252c | LAB_00552587
        ;   XREF to: 00552587 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [ESP + 0x2c]      ; 0055252e
    TEST byte ptr [ECX + 0x13],0x80     ; 00552532
        ;   Label: LAB_00552532
    JZ 0x0055257f                       ; 00552536 | LAB_0055257f
    ...
    MOV EDX,dword ptr [0x02d02548]      ; 0055254a | int g_ViewportCenterXFixed
    MOV EBX,dword ptr [ECX + 0x8]       ; 00552550
    MOV EAX,dword ptr [ECX]             ; 00552553
    IMUL EDX                            ; 00552555
    IDIV EBX                            ; 00552557
    MOV EDX,dword ptr [0x02d02550]      ; 00552559 | int g_ViewportRightFixed
    ADD EAX,EDX                         ; 0055255f
    MOV EBX,dword ptr [ECX + 0x8]       ; 00552561
    MOV dword ptr [ECX + 0x10],EAX      ; 00552564
    MOV EDX,dword ptr [0x02d0254c]      ; 00552567 | int g_ViewportCenterYFixed
    MOV EAX,dword ptr [ECX + 0x4]       ; 0055256d
    IMUL EDX                            ; 00552570
    IDIV EBX                            ; 00552572
    MOV EDX,dword ptr [0x02d02554]      ; 00552574 | int g_ViewportBottomFixed
    ...
    JL 0x00552532                       ; 00552585 | LAB_00552532
        ;   XREF to: 00552532 (CONDITIONAL_JUMP)
    CMP dword ptr [0x00772a7c],0x0      ; 00552587 | int g_CullingMode
        ;   Label: LAB_00552587
    JZ 0x005525ec                       ; 0055258e | LAB_005525ec
    ...
    JLE 0x005526b9                      ; 005525a5 | LAB_005526b9
    ...
    JLE 0x005525e2                      ; 005525ba | LAB_005525e2
    ...
    PUSH EAX                            ; 005525c2
    CALL engine_prim.c_calculateTriangleWindingOrder_FUN_00552150 ; 005525c3 | int engine_prim.c_calculateTriangleWindingOrder_FUN_00552150(SRenderVertex * v0, SRenderVertex * v1, SRenderVertex * v2)
        ;   XREF to: 00552150 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005525c8
    TEST EAX,EAX                        ; 005525cb
    JZ 0x005526b3                       ; 005525cd | LAB_005526b3
    ...
    JL 0x005525bc                       ; 005525e0 | LAB_005525bc
        ;   XREF to: 005525bc (CONDITIONAL_JUMP)
    CMP EBP,dword ptr [ESP + 0x4]       ; 005525e2
        ;   Label: LAB_005525e2
    JZ 0x005526ab                       ; 005525e6 | LAB_005526ab
        ;   XREF to: 005526ab (CONDITIONAL_JUMP)
    CMP dword ptr [0x02d03e94],0x0      ; 005525ec | int g_UseExternalRenderer
        ;   Label: LAB_005525ec
    JZ 0x00552602                       ; 005525f3 | LAB_00552602
        ;   XREF to: 00552602 (CONDITIONAL_JUMP)
    CMP dword ptr [0x00772a74],0x0      ; 005525f5 | int g_TexturesDisabled
    JZ 0x005526d8                       ; 005525fc | LAB_005526d8
        ;   XREF to: 005526d8 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [0x030e56b8]      ; 00552602 | int g_RenderedTriangleCount
        ;   Label: LAB_00552602
    INC EBX                             ; 00552608
    MOV EAX,[0x02d052a4]                ; 00552609 | int g_RenderStateFlag2
    MOV dword ptr [0x030e56b8],EBX      ; 0055260e | int g_RenderedTriangleCount
    CMP EAX,0x6                         ; 00552614
    JA 0x00552620                       ; 00552617 | caseD_0
        ;   XREF to: 00552620 (CONDITIONAL_JUMP)
    JMP dword ptr [EAX*0x4 + 0x5524e8]  ; 00552619 | void * switchdataD_005524e8
        ;   Label: switchD
    MOV EAX,0x4b0                       ; 00552620
        ;   Label: caseD_4
    XOR EDX,EDX                         ; 00552625
    MOV ESI,dword ptr [ESP + 0x2c]      ; 00552627
    MOV dword ptr [0x030e56b0],EDX      ; 0055262b | int g_SoftwareMaxScanline
    MOV dword ptr [0x030e5228],EDX      ; 00552631 | int g_SoftwareEdgeCount
    MOV dword ptr [ESP + 0x8],EDX       ; 00552637
    MOV [0x030e56ac],EAX                ; 0055263b | int g_SoftwareMinScanline
    TEST ESI,ESI                        ; 00552640
    JLE 0x00552690                      ; 00552642 | LAB_00552690
    ...
    JL 0x00552653                       ; 0055264f | LAB_00552653
    ...
    JNZ 0x00552781                      ; 00552679 | LAB_00552781
    ...
    JL 0x00552644                       ; 0055268e | LAB_00552644
        ;   XREF to: 00552644 (CONDITIONAL_JUMP)
    PUSH 0x0                            ; 00552690
        ;   Label: LAB_00552690
    MOV ESI,dword ptr [0x030e56ac]      ; 00552692 | int g_SoftwareMinScanline
    PUSH ESI                            ; 00552698
    CALL engine_prim.c_findEdgeInBuffer_FUN_00551f70 ; 00552699 | SSoftwareEdge * engine_prim.c_findEdgeInBuffer_FUN_00551f70(int y_value, SSoftwareEdge * edge_ptr)
        ;   XREF to: 00551f70 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0055269e
    MOV EBP,EAX                         ; 005526a1
    TEST EAX,EAX                        ; 005526a3
    JNZ 0x005528f8                      ; 005526a5 | LAB_005528f8
    ...
    INC EBP                             ; 005526b3
        ;   Label: LAB_005526b3
    JMP 0x005525d3                      ; 005526b4 | LAB_005525d3
    ...
    PUSH ECX                            ; 005526bf
    CALL engine_prim.c_calculateTriangleWindingOrder_FUN_00552150 ; 005526c0 | int engine_prim.c_calculateTriangleWindingOrder_FUN_00552150(SRenderVertex * v0, SRenderVertex * v1, SRenderVertex * v2)
        ;   XREF to: 00552150 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005526c5
    TEST EAX,EAX                        ; 005526c8
    JNZ 0x005525ec                      ; 005526ca | LAB_005525ec
        ;   XREF to: 005525ec (CONDITIONAL_JUMP)
    ...
    MOV EAX,dword ptr [ESP + 0x2c]      ; 005526d8
        ;   Label: LAB_005526d8
    MOV EDI,dword ptr [0x030e56b8]      ; 005526dc | int g_RenderedTriangleCount
    MOV EBP,dword ptr [0x02d052a0]      ; 005526e2 | int g_RenderStateFlags
    ...
    PUSH EDX                            ; 005526f7
    MOV dword ptr [0x030e56b8],EDI      ; 005526f8 | int g_RenderedTriangleCount
    CALL wincore_windll.cpp_drawPolygon_FUN_005b75e0 ; 005526fe | int wincore_windll.cpp_drawPolygon_FUN_005b75e0(SRenderVertex * vertices, int vertex_count, int render_flags)
    ...
    PUSH EBP                            ; 00552717
    CALL engine_prim.c_prepareDepthBuffer_FUN_00551fb0 ; 00552718 | void engine_prim.c_prepareDepthBuffer_FUN_00551fb0(SRenderVertex * vertices, int vertex_count)
        ;   XREF to: 00551fb0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0055271d
    JMP 0x00552620                      ; 00552720 | caseD_0
    ...
    PUSH ESI                            ; 0055272e
    CALL engine_prim.c_normalizeTextureCoords_FUN_00552020 ; 0055272f | void engine_prim.c_normalizeTextureCoords_FUN_00552020(SRenderVertex * vertices, int vertex_count)
        ;   XREF to: 00552020 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00552734
    JMP 0x00552620                      ; 00552737 | caseD_0
        ;   XREF to: 00552620 (UNCONDITIONAL_JUMP)
    ...
    PUSH ECX                            ; 00552745
    CALL engine_prim.c_adjustNearPlaneTextureCoords_FUN_005520a0 ; 00552746 | void engine_prim.c_adjustNearPlaneTextureCoords_FUN_005520a0(SRenderVertex * vertices, int vertex_count)
        ;   XREF to: 005520a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0055274b
    JMP 0x00552620                      ; 0055274e | caseD_0
        ;   XREF to: 00552620 (UNCONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 0055275c
    CALL engine_prim.c_normalizeTextureCoords_FUN_00552020 ; 0055275d | void engine_prim.c_normalizeTextureCoords_FUN_00552020(SRenderVertex * vertices, int vertex_count)
        ;   XREF to: 00552020 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00552762
    JMP 0x00552620                      ; 00552765 | caseD_0
        ;   XREF to: 00552620 (UNCONDITIONAL_JUMP)
    ...
    PUSH EDI                            ; 00552773
    CALL engine_prim.c_replaceWWithDepth_FUN_00552110 ; 00552774 | void engine_prim.c_replaceWWithDepth_FUN_00552110(SRenderVertex * vertices, int vertex_count)
        ;   XREF to: 00552110 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00552779
    JMP 0x00552620                      ; 0055277c | caseD_0
        ;   XREF to: 00552620 (UNCONDITIONAL_JUMP)
    MOV EDX,dword ptr [EAX + 0x14]      ; 00552781
        ;   Label: LAB_00552781
    CMP EDX,dword ptr [EBP + 0x14]      ; 00552784
    JLE 0x00552793                      ; 00552787 | LAB_00552793
    ...
    IMUL EBP,dword ptr [0x030e5228],0x48 ; 00552793 | int g_SoftwareEdgeCount
        ;   Label: LAB_00552793
    ADD EBP,0x30e522c                   ; 0055279a | SSoftwareEdge[16] g_SoftwareEdgeBuffer
    MOV dword ptr [EBP],ECX             ; 005527a0 | SSoftwareEdge[16] g_SoftwareEdgeBuffer
    MOV EDX,dword ptr [0x030e56ac]      ; 005527a3 | int g_SoftwareMinScanline
    MOV dword ptr [EBP + 0x4],ESI       ; 005527a9 | DAT_030e5230
    CMP ECX,EDX                         ; 005527ac
    JGE 0x005527b6                      ; 005527ae | LAB_005527b6
        ;   XREF to: 005527b6 (CONDITIONAL_JUMP)
    MOV dword ptr [0x030e56ac],ECX      ; 005527b0 | int g_SoftwareMinScanline
    CMP ESI,dword ptr [0x030e56b0]      ; 005527b6 | int g_SoftwareMaxScanline
        ;   Label: LAB_005527b6
    JLE 0x005527c4                      ; 005527bc | LAB_005527c4
        ;   XREF to: 005527c4 (CONDITIONAL_JUMP)
    MOV dword ptr [0x030e56b0],ESI      ; 005527be | int g_SoftwareMaxScanline
    MOV ESI,dword ptr [EBX + 0x14]      ; 005527c4
        ;   Label: LAB_005527c4
    MOV ECX,dword ptr [EDI + 0x14]      ; 005527c7
    SUB ECX,ESI                         ; 005527ca
    CMP ECX,0x10000                     ; 005527cc
    JNC 0x005528e8                      ; 005527d2 | LAB_005528e8
    ...
    INC dword ptr [0x030e5228]          ; 005528dd | int g_SoftwareEdgeCount
    JMP 0x0055267f                      ; 005528e3 | LAB_0055267f
    ...
    JMP 0x005527da                      ; 005528f3 | LAB_005527da
        ;   XREF to: 005527da (UNCONDITIONAL_JUMP)
    PUSH EAX                            ; 005528f8
        ;   Label: LAB_005528f8
    MOV EDI,dword ptr [0x030e56ac]      ; 005528f9 | int g_SoftwareMinScanline
    PUSH EDI                            ; 005528ff
    CALL engine_prim.c_findEdgeInBuffer_FUN_00551f70 ; 00552900 | SSoftwareEdge * engine_prim.c_findEdgeInBuffer_FUN_00551f70(int y_value, SSoftwareEdge * edge_ptr)
        ;   XREF to: 00551f70 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00552905
    MOV dword ptr [ESP + 0x10],EAX      ; 00552908
    TEST EAX,EAX                        ; 0055290c
    JZ 0x005526ab                       ; 0055290e | LAB_005526ab
        ;   XREF to: 005526ab (CONDITIONAL_JUMP)
    MOV EAX,[0x030e56ac]                ; 00552914 | int g_SoftwareMinScanline
    MOV EDX,dword ptr [0x00680cf4]      ; 00552919 | int g_MaxViewportScanline
    MOV dword ptr [ESP + 0xc],EAX       ; 0055291f
    CMP EAX,EDX                         ; 00552923
    JGE 0x005526ab                      ; 00552925 | LAB_005526ab
        ;   Label: LAB_00552925
        ;   XREF to: 005526ab (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0xc]       ; 0055292b
    CMP EAX,dword ptr [EBP + 0x4]       ; 0055292f
    JGE 0x00552a0d                      ; 00552932 | LAB_00552a0d
    ...
    JL 0x00552961                       ; 00552943 | LAB_00552961
        ;   XREF to: 00552961 (CONDITIONAL_JUMP)
    PUSH EBP                            ; 00552945
    PUSH EAX                            ; 00552946
    MOV dword ptr [EDX],0xffffffff      ; 00552947
    CALL engine_prim.c_findEdgeInBuffer_FUN_00551f70 ; 0055294d | SSoftwareEdge * engine_prim.c_findEdgeInBuffer_FUN_00551f70(int y_value, SSoftwareEdge * edge_ptr)
        ;   XREF to: 00551f70 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00552952
    MOV dword ptr [ESP + 0x10],EAX      ; 00552955
    TEST EAX,EAX                        ; 00552959
    JZ 0x005526ab                       ; 0055295b | LAB_005526ab
        ;   XREF to: 005526ab (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [ESP + 0x10]      ; 00552961
        ;   Label: LAB_00552961
    MOV EBX,dword ptr [ESP + 0xc]       ; 00552965
    MOV ESI,EBP                         ; 00552969
    CALL wincore_windll.cpp_renderScanline_FUN_005b5710 ; 0055296b | void wincore_windll.cpp_renderScanline_FUN_005b5710(void * left_data, void * right_data, int scanline_y)
    ...
    MOV EDI,dword ptr [0x00680cf4]      ; 005529ef | int g_MaxViewportScanline
    ...
    JMP 0x00552925                      ; 00552a08 | LAB_00552925
    ...
    CALL engine_prim.c_findEdgeInBuffer_FUN_00551f70 ; 00552a1a | SSoftwareEdge * engine_prim.c_findEdgeInBuffer_FUN_00551f70(int y_value, SSoftwareEdge * edge_ptr)
        ;   XREF to: 00551f70 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00552a1f
    MOV EBP,EAX                         ; 00552a22
    TEST EAX,EAX                        ; 00552a24
    JZ 0x005526ab                       ; 00552a26 | LAB_005526ab
        ;   XREF to: 005526ab (CONDITIONAL_JUMP)
    JMP 0x00552938                      ; 00552a2c | LAB_00552938
