...
section .text
    ...
    MOV EDX,dword ptr [0x02d02548]      ; 0055254a | g_Projection
    MOV EBX,dword ptr [ECX + 0x8]       ; 00552550
    MOV EAX,dword ptr [ECX]             ; 00552553
    IMUL EDX                            ; 00552555
    IDIV EBX                            ; 00552557
    MOV EDX,dword ptr [0x02d02550]      ; 00552559 | g_Projection.center_x_fixed
    ADD EAX,EDX                         ; 0055255f
    MOV EBX,dword ptr [ECX + 0x8]       ; 00552561
    MOV dword ptr [ECX + 0x10],EAX      ; 00552564
    MOV EDX,dword ptr [0x02d0254c]      ; 00552567 | g_Projection.neg_half_height_fixed
    MOV EAX,dword ptr [ECX + 0x4]       ; 0055256d
    IMUL EDX                            ; 00552570
    IDIV EBX                            ; 00552572
    MOV EDX,dword ptr [0x02d02554]      ; 00552574 | g_Projection.center_y_fixed
    ...
    MOV dword ptr [EBP + 0x4],ESI       ; 005527a9 | g_SoftwareEdgeBuffer[0].base.y_max
    ...
    MOV dword ptr [EBP + 0xc],EAX       ; 005527fb | g_SoftwareEdgeBuffer[0].base.x_gradient
    ...
    MOV dword ptr [EBP + 0x8],EAX       ; 00552811 | g_SoftwareEdgeBuffer[0].base.x_current
    ...
    MOV dword ptr [EBP + 0x1c],EAX      ; 00552828 | g_SoftwareEdgeBuffer[0].base.u_gradient
    ...
    MOV dword ptr [EBP + 0x18],EAX      ; 0055283e | g_SoftwareEdgeBuffer[0].base.u_current
    ...
    MOV dword ptr [EBP + 0x24],EAX      ; 00552855 | g_SoftwareEdgeBuffer[0].base.v_gradient
    ...
    MOV dword ptr [EBP + 0x20],EAX      ; 0055286b | g_SoftwareEdgeBuffer[0].base.v_current
