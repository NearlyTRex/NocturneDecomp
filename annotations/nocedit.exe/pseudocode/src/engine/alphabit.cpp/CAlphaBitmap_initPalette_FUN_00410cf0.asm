...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_alphabit.cpp_CAlphaBitmap_initPalette_FUN_00410cf0(CAlphaBitmap * this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EDI,0x2d01924                   ; 00410cfb | uint[256] g_Hardware32BitPalette
    MOV ESI,dword ptr [ESI + 0x8]       ; 00410d00
    PUSH EDI                            ; 00410d03 | uint[256] g_Hardware32BitPalette
    MOV EAX,ECX                         ; 00410d04
    SHR ECX,0x2                         ; 00410d06
    MOVSD.REP ES:EDI,ESI                ; 00410d09 | uint[256] g_Hardware32BitPalette
    MOV CL,AL                           ; 00410d0b
    AND CL,0x3                          ; 00410d0d
    MOVSB.REP ES:EDI,ESI                ; 00410d10 | uint[256] g_Hardware32BitPalette
    POP EDI                             ; 00410d12
    POP EDI                             ; 00410d13
    POP ESI                             ; 00410d14
    RET                                 ; 00410d15
