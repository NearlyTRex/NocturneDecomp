...
section .text
    ...
    PUSH EAX                            ; 004106c1
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 004106c2
    ...
    CALL engine_dosio.cpp_getFile_FUN_00481a50 ; 004106d9
    ...
    PUSH EAX                            ; 00410756
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 00410757
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    CALL engine_dosio.cpp_getFile_FUN_00481a50 ; 0041076e
        ;   XREF to: 00481a50 (UNCONDITIONAL_CALL)  ; _FILE * engine_dosio.cpp_getFile_FUN_00481a50(char * directory, char * filename, char * mode)
    ...
    PUSH EAX                            ; 00410822
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 00410823
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    CALL engine_dosio.cpp_getFile_FUN_00481a50 ; 0041083a
        ;   XREF to: 00481a50 (UNCONDITIONAL_CALL)  ; _FILE * engine_dosio.cpp_getFile_FUN_00481a50(char * directory, char * filename, char * mode)
