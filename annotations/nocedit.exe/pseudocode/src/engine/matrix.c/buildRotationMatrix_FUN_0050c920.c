...
LAB_0050ca9c:
  ...
  iVar13 = ((((g_ClipRight - g_ClipLeft) * 0x280) / g_WindowWidth) * 0x30000) /
           (((g_ClipBottom - g_ClipTop) * 0x1e0) / g_WindowHeight);
  iVar12 = iVar13 >> 0x1f;
  iVar13 = (int)((iVar13 + iVar12 * -4) - (uint)(iVar12 << 1 < 0)) >> 2;
  g_TransformMatrix.m[0].x =
       (int)(((longlong)(int)((uint)lVar6 >> 0x10 | (int)((ulonglong)lVar6 >> 0x20) << 0x10) *
             (longlong)iVar13) / (longlong)g_ProjectionScale);
  ...
  g_TransformMatrix.m[2].x =
       (int)(((longlong)(int)((uint)lVar7 >> 0x10 | (int)((ulonglong)lVar7 >> 0x20) << 0x10) *
             (longlong)iVar13) / (longlong)g_ProjectionScale);
