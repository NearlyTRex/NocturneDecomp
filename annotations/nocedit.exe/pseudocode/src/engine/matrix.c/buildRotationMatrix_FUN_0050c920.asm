...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_matrix.c_buildRotationMatrix_FUN_0050c920(ushort pitch, ushort yaw, ushort roll)
;
; Parameters:
...
section .text
    ...
    PUSH EDI                            ; 0050c92e
    PUSH EBX                            ; 0050c92f
    CALL engine_matrix.c_interpolatedSin_FUN_0050c5c0 ; 0050c930 | int engine_matrix.c_interpolatedSin_FUN_0050c5c0(ushort angle)
        ;   XREF to: 0050c5c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0050c935
    PUSH EBX                            ; 0050c938
    MOV EBP,EAX                         ; 0050c939
    CALL engine_matrix.c_interpolatedCos_FUN_0050c600 ; 0050c93b | int engine_matrix.c_interpolatedCos_FUN_0050c600(ushort angle)
        ;   XREF to: 0050c600 (UNCONDITIONAL_CALL)
    MOV dword ptr [ESP + 0xc],EAX       ; 0050c940
    ADD ESP,0x4                         ; 0050c944
    PUSH ESI                            ; 0050c947
    CALL engine_matrix.c_interpolatedSin_FUN_0050c5c0 ; 0050c948 | int engine_matrix.c_interpolatedSin_FUN_0050c5c0(ushort angle)
        ;   XREF to: 0050c5c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0050c94d
    PUSH ESI                            ; 0050c950
    MOV EBX,EAX                         ; 0050c951
    CALL engine_matrix.c_interpolatedCos_FUN_0050c600 ; 0050c953 | int engine_matrix.c_interpolatedCos_FUN_0050c600(ushort angle)
        ;   XREF to: 0050c600 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0050c958
    MOV EDX,dword ptr [ESP + 0x24]      ; 0050c95b
    PUSH EDX                            ; 0050c95f
    MOV ESI,EAX                         ; 0050c960
    CALL engine_matrix.c_interpolatedSin_FUN_0050c5c0 ; 0050c962 | int engine_matrix.c_interpolatedSin_FUN_0050c5c0(ushort angle)
        ;   XREF to: 0050c5c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0050c967
    MOV ECX,dword ptr [ESP + 0x24]      ; 0050c96a
    PUSH ECX                            ; 0050c96e
    MOV EDI,EAX                         ; 0050c96f
    CALL engine_matrix.c_interpolatedCos_FUN_0050c600 ; 0050c971 | int engine_matrix.c_interpolatedCos_FUN_0050c600(ushort angle)
        ;   XREF to: 0050c600 (UNCONDITIONAL_CALL)
    ...
    MOV dword ptr [0x02d052e8],EDX      ; 0050c9a1 | CMatrix3x3i g_TransformMatrix
    ...
    MOV EAX,[0x00679398]                ; 0050ca7c | int g_WindowHeight
    CMP EAX,0xc8                        ; 0050ca81
    JC 0x0050cc26                       ; 0050ca86 | LAB_0050cc26
        ;   XREF to: 0050cc26 (CONDITIONAL_JUMP)
    JA 0x0050cc1f                       ; 0050ca8c | LAB_0050cc1f
        ;   XREF to: 0050cc1f (CONDITIONAL_JUMP)
    MOV dword ptr [0x02f0d3bc],0x15555  ; 0050ca92 | int g_PixelAspectCorrection
    MOV EAX,0x10000                     ; 0050ca9c
        ;   Label: LAB_0050ca9c
    MOV EBX,dword ptr [0x02d02548]      ; 0050caa1 | int g_ViewportCenterXFixed
    MOV EDX,dword ptr [0x02d0254c]      ; 0050caa7 | int g_ViewportCenterYFixed
    IMUL EDX                            ; 0050caad
    IDIV EBX                            ; 0050caaf
    MOV ECX,EAX                         ; 0050cab1
    MOV EDX,dword ptr [0x00679394]      ; 0050cab3 | int g_WindowWidth
    NEG ECX                             ; 0050cab9
    IMUL EDX,ECX                        ; 0050cabb
    LEA EAX,[EDX*0x4 + 0x0]             ; 0050cabe
    SUB EAX,EDX                         ; 0050cac5
    MOV ECX,dword ptr [0x00679398]      ; 0050cac7 | int g_WindowHeight
    MOV EDX,EAX                         ; 0050cacd
    SHL ECX,0x2                         ; 0050cacf
    SAR EDX,0x1f                        ; 0050cad2
    IDIV ECX                            ; 0050cad5
    MOV EDX,dword ptr [0x02d052e8]      ; 0050cad7 | CMatrix3x3i g_TransformMatrix
    MOV ECX,EAX                         ; 0050cadd
    IMUL EDX                            ; 0050cadf
    SHRD EAX,EDX,0x10                   ; 0050cae1
    MOV EDX,dword ptr [0x02d052f4]      ; 0050cae5 | g_TransformMatrix[1][0]
    MOV [0x02d052e8],EAX                ; 0050caeb | CMatrix3x3i g_TransformMatrix
    ...
    MOV ESI,dword ptr [0x02d02558]      ; 0050cb0b | int g_ClipLeft
    MOV [0x02d05300],EAX                ; 0050cb11 | g_TransformMatrix[2][0]
    MOV EAX,[0x02d02560]                ; 0050cb16 | int g_ClipRight
    SUB EAX,ESI                         ; 0050cb1b
    LEA EDX,[EAX*0x4 + 0x0]             ; 0050cb1d
    ADD EDX,EAX                         ; 0050cb24
    SHL EDX,0x7                         ; 0050cb26
    MOV EDI,dword ptr [0x00679394]      ; 0050cb29 | int g_WindowWidth
    MOV EAX,EDX                         ; 0050cb2f
    SAR EDX,0x1f                        ; 0050cb31
    IDIV EDI                            ; 0050cb34
    MOV ECX,dword ptr [0x02d02564]      ; 0050cb36 | int g_ClipBottom
    SUB ECX,dword ptr [0x02d0255c]      ; 0050cb3c | int g_ClipTop
    ...
    MOV ECX,dword ptr [0x00679398]      ; 0050cb55 | int g_WindowHeight
    ...
    MOV EBX,dword ptr [0x006793c0]      ; 0050cb7d | int g_ProjectionScale
    MOV ECX,EAX                         ; 0050cb83
    MOV EAX,[0x02d052e8]                ; 0050cb85 | CMatrix3x3i g_TransformMatrix
    MOV EDX,ECX                         ; 0050cb8a
    IMUL EDX                            ; 0050cb8c
    IDIV EBX                            ; 0050cb8e
    MOV EBX,dword ptr [0x006793c0]      ; 0050cb90 | int g_ProjectionScale
    MOV [0x02d052e8],EAX                ; 0050cb96 | CMatrix3x3i g_TransformMatrix
    MOV EDX,ECX                         ; 0050cb9b
    MOV EAX,[0x02d052ec]                ; 0050cb9d | g_TransformMatrix[0][1]
    IMUL EDX                            ; 0050cba2
    IDIV EBX                            ; 0050cba4
    MOV EBX,dword ptr [0x006793c0]      ; 0050cba6 | int g_ProjectionScale
    MOV [0x02d052ec],EAX                ; 0050cbac | g_TransformMatrix[0][1]
    MOV EDX,ECX                         ; 0050cbb1
    MOV EAX,[0x02d052f4]                ; 0050cbb3 | g_TransformMatrix[1][0]
    IMUL EDX                            ; 0050cbb8
    IDIV EBX                            ; 0050cbba
    MOV EBX,dword ptr [0x006793c0]      ; 0050cbbc | int g_ProjectionScale
    ...
    POP EDI                             ; 0050cbd7
    MOV EBX,dword ptr [0x006793c0]      ; 0050cbd8 | int g_ProjectionScale
    MOV EAX,[0x02d05300]                ; 0050cbde | g_TransformMatrix[2][0]
    MOV EDX,ECX                         ; 0050cbe3
    IMUL EDX                            ; 0050cbe5
    IDIV EBX                            ; 0050cbe7
    MOV EBX,dword ptr [0x006793c0]      ; 0050cbe9 | int g_ProjectionScale
    ...
    CALL engine_matrix.c_invertTransformMatrix_FUN_0050c640 ; 0050cc04 | void engine_matrix.c_invertTransformMatrix_FUN_0050c640()
    ...
    POP EBX                             ; 0050cc0e
    RET                                 ; 0050cc0f
    MOV dword ptr [0x02f0d3bc],0xaaaa   ; 0050cc10 | int g_PixelAspectCorrection
        ;   Label: LAB_0050cc10
    JMP 0x0050ca9c                      ; 0050cc1a | LAB_0050ca9c
        ;   XREF to: 0050ca9c (UNCONDITIONAL_JUMP)
    CMP EAX,0x190                       ; 0050cc1f
        ;   Label: LAB_0050cc1f
    JZ 0x0050cc10                       ; 0050cc24 | LAB_0050cc10
        ;   XREF to: 0050cc10 (CONDITIONAL_JUMP)
    MOV dword ptr [0x02f0d3bc],0x10000  ; 0050cc26 | int g_PixelAspectCorrection
        ;   Label: LAB_0050cc26
    JMP 0x0050ca9c                      ; 0050cc30 | LAB_0050ca9c
        ;   XREF to: 0050ca9c (UNCONDITIONAL_JUMP)
