...

{
  ...
  lVar1 = (longlong)g_TransformMatrix.m[0][2] * (longlong)(*input_coords - g_RelativeX);
  lVar2 = (longlong)g_TransformMatrix.m[1][2] * (longlong)(input_coords[1] - g_RelativeY);
  lVar3 = (longlong)g_TransformMatrix.m[2][2] * (longlong)(input_coords[2] - g_RelativeZ);
