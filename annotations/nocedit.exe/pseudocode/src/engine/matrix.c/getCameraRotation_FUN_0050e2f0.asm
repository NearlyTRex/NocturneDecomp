...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_matrix.c_getCameraRotation_FUN_0050e2f0(CVector3i * output)
;
; Local Variables:
...
section .text
    ...
    MOV EDX,dword ptr [0x02d052d0]      ; 0050e2f6 | int g_CameraRotationPitch
    MOV dword ptr [ESP],EDX             ; 0050e2fc
    MOV EDX,dword ptr [0x02d052d4]      ; 0050e2ff | int g_CameraRotationYaw
    MOV EDI,ESI                         ; 0050e305
    MOV dword ptr [ESP + 0x4],EDX       ; 0050e307
    MOV EDX,dword ptr [0x02d052d8]      ; 0050e30b | int g_CameraRotationRoll
