...

{
  ...
  g_ViewportStack_CenterX[g_ViewportStackIndex] = g_Projection.half_width_fixed;
  g_ViewportStack_CenterY[g_ViewportStackIndex] = g_Projection.neg_half_height_fixed;
  g_ViewportStack_RightFixed[g_ViewportStackIndex] = g_Projection.center_x_fixed;
  g_ViewportStack_BottomFixed[g_ViewportStackIndex] = g_Projection.center_y_fixed;
