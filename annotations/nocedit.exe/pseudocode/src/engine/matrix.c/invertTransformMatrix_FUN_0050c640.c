...

{
  ...
  fVar3 = (float)g_TransformMatrix.m[0].x * (float)g_FixedToFloat;
  fVar8 = (float)g_TransformMatrix.m[0].y * (float)g_FixedToFloat;
  fVar9 = (float)g_TransformMatrix.m[0].z * (float)g_FixedToFloat;
  fVar11 = (float)g_TransformMatrix.m[1].x * (float)g_FixedToFloat;
  fVar4 = (float)g_TransformMatrix.m[1].y * (float)g_FixedToFloat;
  fVar5 = (float)g_TransformMatrix.m[1].z * (float)g_FixedToFloat;
  fVar12 = (float)g_TransformMatrix.m[2].x * (float)g_FixedToFloat;
  fVar7 = (float)g_TransformMatrix.m[2].y * (float)g_FixedToFloat;
  fVar6 = (float)g_TransformMatrix.m[2].z * (float)g_FixedToFloat;
  ...
  dVar21 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44(in_EDX,g_TransformMatrix.m[2].z));
