...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_matrix.c_matrixPushAndTransform_FUN_0050db00(int rotation_x, int rotation_y, int rotation_z)
;
; Parameters:
...
section .text
    ...
    MOV EAX,[0x02f0d3c0]                ; 0050db07 | int g_MatrixStackIndex
    MOV EDX,dword ptr [0x02d052b8]      ; 0050db0c | int g_RelativeX
    MOV dword ptr [EAX*0x4 + 0x2f0d52c],EDX ; 0050db12 | int[10] g_MatrixStack_RelX
    MOV EDX,dword ptr [0x02d052bc]      ; 0050db19 | int g_RelativeY
    MOV dword ptr [EAX*0x4 + 0x2f0d554],EDX ; 0050db1f | int[10] g_MatrixStack_RelY
    MOV EDX,dword ptr [0x02d052c0]      ; 0050db26 | int g_RelativeZ
    MOV dword ptr [EAX*0x4 + 0x2f0d57c],EDX ; 0050db2c | int[10] g_MatrixStack_RelZ
    MOV EDX,dword ptr [0x02d052dc]      ; 0050db33 | int g_LightDirectionX
    MOV dword ptr [EAX*0x4 + 0x2f0d5a4],EDX ; 0050db39 | int[10] g_MatrixStack_Unk1
    MOV EDX,dword ptr [0x02d052e0]      ; 0050db40 | int g_LightDirectionY
    MOV dword ptr [EAX*0x4 + 0x2f0d5cc],EDX ; 0050db46 | int[10] g_MatrixStack_Unk2
    MOV EDX,dword ptr [0x02d052e4]      ; 0050db4d | int g_LightDirectionZ
    MOV dword ptr [EAX*0x4 + 0x2f0d5f4],EDX ; 0050db53 | int[10] g_MatrixStack_Unk3
    MOV EDX,dword ptr [0x02d052e8]      ; 0050db5a | CMatrix3x3i g_TransformMatrix
    MOV dword ptr [EAX*0x4 + 0x2f0d3c4],EDX ; 0050db60 | int[10] g_MatrixStack_M00
    MOV EDX,dword ptr [0x02d052ec]      ; 0050db67 | g_TransformMatrix[0][1]
    MOV dword ptr [EAX*0x4 + 0x2f0d3ec],EDX ; 0050db6d | int[10] g_MatrixStack_M01
    MOV EDX,dword ptr [0x02d052f0]      ; 0050db74 | g_TransformMatrix[0][2]
    MOV dword ptr [EAX*0x4 + 0x2f0d414],EDX ; 0050db7a | int[10] g_MatrixStack_M02
    MOV EDX,dword ptr [0x02d052f4]      ; 0050db81 | g_TransformMatrix[1][0]
    MOV dword ptr [EAX*0x4 + 0x2f0d43c],EDX ; 0050db87 | int[10] g_MatrixStack_M10
    MOV EDX,dword ptr [0x02d052f8]      ; 0050db8e | g_TransformMatrix[1][1]
    MOV dword ptr [EAX*0x4 + 0x2f0d464],EDX ; 0050db94 | int[10] g_MatrixStack_M11
    MOV EDX,dword ptr [0x02d052fc]      ; 0050db9b | g_TransformMatrix[1][2]
    MOV dword ptr [EAX*0x4 + 0x2f0d48c],EDX ; 0050dba1 | int[10] g_MatrixStack_M12
    MOV EDX,dword ptr [0x02d05300]      ; 0050dba8 | g_TransformMatrix[2][0]
    MOV dword ptr [EAX*0x4 + 0x2f0d4b4],EDX ; 0050dbae | int[10] g_MatrixStack_M20
    MOV EDX,dword ptr [0x02d05304]      ; 0050dbb5 | g_TransformMatrix[2][1]
    MOV dword ptr [EAX*0x4 + 0x2f0d4dc],EDX ; 0050dbbb | int[10] g_MatrixStack_M21
    MOV EDX,dword ptr [0x02d05308]      ; 0050dbc2 | g_TransformMatrix[2][2]
    FILD dword ptr [ESP + 0x5c]         ; 0050dbc8
    MOV dword ptr [EAX*0x4 + 0x2f0d504],EDX ; 0050dbcc | int[10] g_MatrixStack_M22
    MOV EAX,[0x02d052b8]                ; 0050dbd3 | int g_RelativeX
    FILD dword ptr [ESP + 0x54]         ; 0050dbd8
    MOV dword ptr [ESP + 0x14],EAX      ; 0050dbdc
    MOV EAX,[0x02d052bc]                ; 0050dbe0 | int g_RelativeY
    FLD ST1                             ; 0050dbe5
    MOV dword ptr [ESP + 0x18],EAX      ; 0050dbe7
    MOV EAX,[0x02d052c0]                ; 0050dbeb | int g_RelativeZ
    FXCH                                ; 0050dbf0
    MOV dword ptr [ESP + 0x1c],EAX      ; 0050dbf2
    CALL crt_math.c_atan2_FUN_006013b1  ; 0050dbf6 | float10 crt_math.c_atan2_FUN_006013b1(float10 y, float10 x)
        ;   XREF to: 006013b1 (UNCONDITIONAL_CALL)
    FLD ST1                             ; 0050dbfb
    FILD dword ptr [ESP + 0x58]         ; 0050dbfd
    CALL crt_math.c_atan2_FUN_006013b1  ; 0050dc01 | float10 crt_math.c_atan2_FUN_006013b1(float10 y, float10 x)
        ;   XREF to: 006013b1 (UNCONDITIONAL_CALL)
    FSTP ST2                            ; 0050dc06
    FXCH                                ; 0050dc08
    FCHS                                ; 0050dc0a
    FLD double ptr [0x00635b15]         ; 0050dc0c | double g_InverseTwoPi
    FXCH                                ; 0050dc12
    FMUL ST1                            ; 0050dc14
    FXCH ST2                            ; 0050dc16
    FMULP                               ; 0050dc18
    FXCH                                ; 0050dc1a
    FLD double ptr [0x00635b1d]         ; 0050dc1c | double g_FixedPointScale
    FXCH                                ; 0050dc22
    FMUL ST1                            ; 0050dc24
    FXCH ST2                            ; 0050dc26
    FMULP                               ; 0050dc28
    FXCH                                ; 0050dc2a
    CALL crt_math.c_round_FUN_005fe6b0  ; 0050dc2c | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x8]         ; 0050dc31
    MOV EDX,dword ptr [ESP + 0x8]       ; 0050dc35
    CALL crt_math.c_round_FUN_005fe6b0  ; 0050dc39 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    PUSH EDX                            ; 0050dc3e
    FISTP dword ptr [ESP + 0x14]        ; 0050dc3f
    CALL engine_matrix.c_interpolatedSin_FUN_0050c5c0 ; 0050dc43 | int engine_matrix.c_interpolatedSin_FUN_0050c5c0(ushort angle)
    ...
    PUSH ECX                            ; 0050dc53
    CALL engine_matrix.c_interpolatedCos_FUN_0050c600 ; 0050dc54 | int engine_matrix.c_interpolatedCos_FUN_0050c600(ushort angle)
        ;   XREF to: 0050c600 (UNCONDITIONAL_CALL)
    MOV dword ptr [ESP + 0x24],EAX      ; 0050dc59
    ADD ESP,0x4                         ; 0050dc5d
    PUSH 0x0                            ; 0050dc60
    CALL engine_matrix.c_interpolatedSin_FUN_0050c5c0 ; 0050dc62 | int engine_matrix.c_interpolatedSin_FUN_0050c5c0(ushort angle)
        ;   XREF to: 0050c5c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0050dc67
    PUSH 0x0                            ; 0050dc6a
    MOV EBP,EAX                         ; 0050dc6c
    CALL engine_matrix.c_interpolatedCos_FUN_0050c600 ; 0050dc6e | int engine_matrix.c_interpolatedCos_FUN_0050c600(ushort angle)
        ;   XREF to: 0050c600 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0050dc73
    MOV ESI,dword ptr [ESP + 0x10]      ; 0050dc76
    PUSH ESI                            ; 0050dc7a
    MOV EBX,EAX                         ; 0050dc7b
    CALL engine_matrix.c_interpolatedSin_FUN_0050c5c0 ; 0050dc7d | int engine_matrix.c_interpolatedSin_FUN_0050c5c0(ushort angle)
        ;   XREF to: 0050c5c0 (UNCONDITIONAL_CALL)
    MOV dword ptr [ESP + 0x38],EAX      ; 0050dc82
    ADD ESP,0x4                         ; 0050dc86
    PUSH ESI                            ; 0050dc89
    CALL engine_matrix.c_interpolatedCos_FUN_0050c600 ; 0050dc8a | int engine_matrix.c_interpolatedCos_FUN_0050c600(ushort angle)
        ;   XREF to: 0050c600 (UNCONDITIONAL_CALL)
    ...
    MOV dword ptr [0x02d052b8],EDX      ; 0050ddce | int g_RelativeX
    ...
    MOV dword ptr [0x02d052bc],EDX      ; 0050de0a | int g_RelativeY
    ...
    MOV dword ptr [0x02d052c0],EDX      ; 0050de4a | int g_RelativeZ
    MOV EDX,dword ptr [0x02f0d3c0]      ; 0050de50 | int g_MatrixStackIndex
    MOV EAX,dword ptr [ESP + 0x30]      ; 0050de56
    MOV EDX,dword ptr [EDX*0x4 + 0x2f0d5a4] ; 0050de5a | int[10] g_MatrixStack_Unk1
    IMUL EDX                            ; 0050de61
    SHRD EAX,EDX,0x10                   ; 0050de63
    MOV EDX,dword ptr [0x02f0d3c0]      ; 0050de67 | int g_MatrixStackIndex
    MOV dword ptr [ESP + 0xc],EAX       ; 0050de6d
    MOV EAX,EDI                         ; 0050de71
    MOV EDX,dword ptr [EDX*0x4 + 0x2f0d5cc] ; 0050de73 | int[10] g_MatrixStack_Unk2
    IMUL EDX                            ; 0050de7a
    SHRD EAX,EDX,0x10                   ; 0050de7c
    MOV EDX,dword ptr [ESP + 0xc]       ; 0050de80
    ADD EDX,EAX                         ; 0050de84
    MOV dword ptr [ESP + 0xc],EDX       ; 0050de86
    MOV EDX,dword ptr [0x02f0d3c0]      ; 0050de8a | int g_MatrixStackIndex
    MOV EAX,dword ptr [ESP + 0x24]      ; 0050de90
    MOV EDX,dword ptr [EDX*0x4 + 0x2f0d5f4] ; 0050de94 | int[10] g_MatrixStack_Unk3
    IMUL EDX                            ; 0050de9b
    SHRD EAX,EDX,0x10                   ; 0050de9d
    MOV EDX,dword ptr [ESP + 0xc]       ; 0050dea1
    ADD EDX,EAX                         ; 0050dea5
    MOV dword ptr [0x02d052dc],EDX      ; 0050dea7 | int g_LightDirectionX
    MOV EDX,dword ptr [0x02f0d3c0]      ; 0050dead | int g_MatrixStackIndex
    MOV EAX,dword ptr [ESP + 0x28]      ; 0050deb3
    MOV EDX,dword ptr [EDX*0x4 + 0x2f0d5a4] ; 0050deb7 | int[10] g_MatrixStack_Unk1
    IMUL EDX                            ; 0050debe
    SHRD EAX,EDX,0x10                   ; 0050dec0
    MOV EDX,dword ptr [0x02f0d3c0]      ; 0050dec4 | int g_MatrixStackIndex
    MOV dword ptr [ESP + 0xc],EAX       ; 0050deca
    MOV EAX,ESI                         ; 0050dece
    MOV EDX,dword ptr [EDX*0x4 + 0x2f0d5cc] ; 0050ded0 | int[10] g_MatrixStack_Unk2
    IMUL EDX                            ; 0050ded7
    SHRD EAX,EDX,0x10                   ; 0050ded9
    MOV EDX,dword ptr [ESP + 0xc]       ; 0050dedd
    ADD EDX,EAX                         ; 0050dee1
    MOV dword ptr [ESP + 0xc],EDX       ; 0050dee3
    MOV EDX,dword ptr [0x02f0d3c0]      ; 0050dee7 | int g_MatrixStackIndex
    MOV EAX,EBP                         ; 0050deed
    MOV EDX,dword ptr [EDX*0x4 + 0x2f0d5f4] ; 0050deef | int[10] g_MatrixStack_Unk3
    IMUL EDX                            ; 0050def6
    SHRD EAX,EDX,0x10                   ; 0050def8
    MOV EDX,dword ptr [ESP + 0xc]       ; 0050defc
    ADD EDX,EAX                         ; 0050df00
    MOV dword ptr [0x02d052e0],EDX      ; 0050df02 | int g_LightDirectionY
    MOV EDX,dword ptr [0x02f0d3c0]      ; 0050df08 | int g_MatrixStackIndex
    MOV EAX,ECX                         ; 0050df0e
    MOV EDX,dword ptr [EDX*0x4 + 0x2f0d5a4] ; 0050df10 | int[10] g_MatrixStack_Unk1
    IMUL EDX                            ; 0050df17
    SHRD EAX,EDX,0x10                   ; 0050df19
    MOV EDX,dword ptr [0x02f0d3c0]      ; 0050df1d | int g_MatrixStackIndex
    MOV dword ptr [ESP + 0xc],EAX       ; 0050df23
    MOV EAX,dword ptr [ESP + 0x3c]      ; 0050df27
    MOV EDX,dword ptr [EDX*0x4 + 0x2f0d5cc] ; 0050df2b | int[10] g_MatrixStack_Unk2
    IMUL EDX                            ; 0050df32
    SHRD EAX,EDX,0x10                   ; 0050df34
    MOV EDX,dword ptr [ESP + 0xc]       ; 0050df38
    ADD EDX,EAX                         ; 0050df3c
    MOV dword ptr [ESP + 0xc],EDX       ; 0050df3e
    MOV EDX,dword ptr [0x02f0d3c0]      ; 0050df42 | int g_MatrixStackIndex
    MOV EAX,EBX                         ; 0050df48
    MOV EDX,dword ptr [EDX*0x4 + 0x2f0d5f4] ; 0050df4a | int[10] g_MatrixStack_Unk3
    IMUL EDX                            ; 0050df51
    SHRD EAX,EDX,0x10                   ; 0050df53
    MOV EDX,dword ptr [ESP + 0xc]       ; 0050df57
    ADD EDX,EAX                         ; 0050df5b
    MOV dword ptr [0x02d052e4],EDX      ; 0050df5d | int g_LightDirectionZ
    MOV EAX,[0x02f0d3c0]                ; 0050df63 | int g_MatrixStackIndex
    MOV EDX,dword ptr [ESP + 0x30]      ; 0050df68
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d3c4] ; 0050df6c | int[10] g_MatrixStack_M00
    IMUL EDX                            ; 0050df73
    SHRD EAX,EDX,0x10                   ; 0050df75
    MOV dword ptr [ESP + 0xc],EAX       ; 0050df79
    MOV EAX,[0x02f0d3c0]                ; 0050df7d | int g_MatrixStackIndex
    MOV EDX,EDI                         ; 0050df82
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d43c] ; 0050df84 | int[10] g_MatrixStack_M10
    IMUL EDX                            ; 0050df8b
    SHRD EAX,EDX,0x10                   ; 0050df8d
    MOV EDX,dword ptr [ESP + 0xc]       ; 0050df91
    ADD EDX,EAX                         ; 0050df95
    MOV EAX,[0x02f0d3c0]                ; 0050df97 | int g_MatrixStackIndex
    MOV dword ptr [ESP + 0xc],EDX       ; 0050df9c
    MOV EDX,dword ptr [ESP + 0x24]      ; 0050dfa0
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d4b4] ; 0050dfa4 | int[10] g_MatrixStack_M20
    IMUL EDX                            ; 0050dfab
    SHRD EAX,EDX,0x10                   ; 0050dfad
    MOV EDX,dword ptr [ESP + 0xc]       ; 0050dfb1
    ADD EDX,EAX                         ; 0050dfb5
    MOV EAX,[0x02f0d3c0]                ; 0050dfb7 | int g_MatrixStackIndex
    MOV dword ptr [0x02d052e8],EDX      ; 0050dfbc | CMatrix3x3i g_TransformMatrix
    MOV EDX,dword ptr [ESP + 0x30]      ; 0050dfc2
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d3ec] ; 0050dfc6 | int[10] g_MatrixStack_M01
    IMUL EDX                            ; 0050dfcd
    SHRD EAX,EDX,0x10                   ; 0050dfcf
    MOV dword ptr [ESP + 0xc],EAX       ; 0050dfd3
    MOV EAX,[0x02f0d3c0]                ; 0050dfd7 | int g_MatrixStackIndex
    MOV EDX,EDI                         ; 0050dfdc
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d464] ; 0050dfde | int[10] g_MatrixStack_M11
    IMUL EDX                            ; 0050dfe5
    SHRD EAX,EDX,0x10                   ; 0050dfe7
    MOV EDX,dword ptr [ESP + 0xc]       ; 0050dfeb
    ADD EDX,EAX                         ; 0050dfef
    MOV EAX,[0x02f0d3c0]                ; 0050dff1 | int g_MatrixStackIndex
    MOV dword ptr [ESP + 0xc],EDX       ; 0050dff6
    MOV EDX,dword ptr [ESP + 0x24]      ; 0050dffa
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d4dc] ; 0050dffe | int[10] g_MatrixStack_M21
    IMUL EDX                            ; 0050e005
    SHRD EAX,EDX,0x10                   ; 0050e007
    MOV EDX,dword ptr [ESP + 0xc]       ; 0050e00b
    ADD EDX,EAX                         ; 0050e00f
    MOV EAX,[0x02f0d3c0]                ; 0050e011 | int g_MatrixStackIndex
    MOV dword ptr [0x02d052ec],EDX      ; 0050e016 | g_TransformMatrix[0][1]
    MOV EDX,dword ptr [ESP + 0x30]      ; 0050e01c
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d414] ; 0050e020 | int[10] g_MatrixStack_M02
    IMUL EDX                            ; 0050e027
    SHRD EAX,EDX,0x10                   ; 0050e029
    MOV dword ptr [ESP + 0xc],EAX       ; 0050e02d
    MOV EAX,[0x02f0d3c0]                ; 0050e031 | int g_MatrixStackIndex
    MOV EDX,EDI                         ; 0050e036
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d48c] ; 0050e038 | int[10] g_MatrixStack_M12
    MOV EDI,dword ptr [ESP + 0xc]       ; 0050e03f
    IMUL EDX                            ; 0050e043
    SHRD EAX,EDX,0x10                   ; 0050e045
    ADD EDI,EAX                         ; 0050e049
    MOV EAX,[0x02f0d3c0]                ; 0050e04b | int g_MatrixStackIndex
    MOV EDX,dword ptr [ESP + 0x24]      ; 0050e050
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d504] ; 0050e054 | int[10] g_MatrixStack_M22
    IMUL EDX                            ; 0050e05b
    SHRD EAX,EDX,0x10                   ; 0050e05d
    ADD EDI,EAX                         ; 0050e061
    MOV EAX,[0x02f0d3c0]                ; 0050e063 | int g_MatrixStackIndex
    MOV EDX,dword ptr [ESP + 0x28]      ; 0050e068
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d3c4] ; 0050e06c | int[10] g_MatrixStack_M00
    MOV dword ptr [0x02d052f0],EDI      ; 0050e073 | g_TransformMatrix[0][2]
    IMUL EDX                            ; 0050e079
    SHRD EAX,EDX,0x10                   ; 0050e07b
    MOV EDI,EAX                         ; 0050e07f
    MOV EAX,[0x02f0d3c0]                ; 0050e081 | int g_MatrixStackIndex
    MOV EDX,ESI                         ; 0050e086
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d43c] ; 0050e088 | int[10] g_MatrixStack_M10
    IMUL EDX                            ; 0050e08f
    SHRD EAX,EDX,0x10                   ; 0050e091
    ADD EDI,EAX                         ; 0050e095
    MOV EAX,[0x02f0d3c0]                ; 0050e097 | int g_MatrixStackIndex
    MOV EDX,EBP                         ; 0050e09c
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d4b4] ; 0050e09e | int[10] g_MatrixStack_M20
    IMUL EDX                            ; 0050e0a5
    SHRD EAX,EDX,0x10                   ; 0050e0a7
    ADD EDI,EAX                         ; 0050e0ab
    MOV dword ptr [0x02d052f4],EDI      ; 0050e0ad | g_TransformMatrix[1][0]
    MOV EAX,[0x02f0d3c0]                ; 0050e0b3 | int g_MatrixStackIndex
    MOV EDX,dword ptr [ESP + 0x28]      ; 0050e0b8
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d3ec] ; 0050e0bc | int[10] g_MatrixStack_M01
    IMUL EDX                            ; 0050e0c3
    SHRD EAX,EDX,0x10                   ; 0050e0c5
    MOV EDI,EAX                         ; 0050e0c9
    MOV EAX,[0x02f0d3c0]                ; 0050e0cb | int g_MatrixStackIndex
    MOV EDX,ESI                         ; 0050e0d0
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d464] ; 0050e0d2 | int[10] g_MatrixStack_M11
    IMUL EDX                            ; 0050e0d9
    SHRD EAX,EDX,0x10                   ; 0050e0db
    ADD EDI,EAX                         ; 0050e0df
    MOV EAX,[0x02f0d3c0]                ; 0050e0e1 | int g_MatrixStackIndex
    MOV EDX,EBP                         ; 0050e0e6
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d4dc] ; 0050e0e8 | int[10] g_MatrixStack_M21
    IMUL EDX                            ; 0050e0ef
    SHRD EAX,EDX,0x10                   ; 0050e0f1
    ADD EDI,EAX                         ; 0050e0f5
    MOV EAX,[0x02f0d3c0]                ; 0050e0f7 | int g_MatrixStackIndex
    MOV EDX,dword ptr [ESP + 0x28]      ; 0050e0fc
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d414] ; 0050e100 | int[10] g_MatrixStack_M02
    MOV dword ptr [0x02d052f8],EDI      ; 0050e107 | g_TransformMatrix[1][1]
    IMUL EDX                            ; 0050e10d
    SHRD EAX,EDX,0x10                   ; 0050e10f
    MOV EDI,EAX                         ; 0050e113
    MOV EAX,[0x02f0d3c0]                ; 0050e115 | int g_MatrixStackIndex
    MOV EDX,ESI                         ; 0050e11a
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d48c] ; 0050e11c | int[10] g_MatrixStack_M12
    IMUL EDX                            ; 0050e123
    SHRD EAX,EDX,0x10                   ; 0050e125
    ADD EDI,EAX                         ; 0050e129
    MOV EAX,[0x02f0d3c0]                ; 0050e12b | int g_MatrixStackIndex
    MOV EDX,EBP                         ; 0050e130
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d504] ; 0050e132 | int[10] g_MatrixStack_M22
    IMUL EDX                            ; 0050e139
    SHRD EAX,EDX,0x10                   ; 0050e13b
    ADD EDI,EAX                         ; 0050e13f
    MOV EAX,[0x02f0d3c0]                ; 0050e141 | int g_MatrixStackIndex
    MOV EDX,ECX                         ; 0050e146
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d3c4] ; 0050e148 | int[10] g_MatrixStack_M00
    MOV dword ptr [0x02d052fc],EDI      ; 0050e14f | g_TransformMatrix[1][2]
    IMUL EDX                            ; 0050e155
    SHRD EAX,EDX,0x10                   ; 0050e157
    MOV ESI,EAX                         ; 0050e15b
    MOV EAX,[0x02f0d3c0]                ; 0050e15d | int g_MatrixStackIndex
    MOV EDX,dword ptr [ESP + 0x3c]      ; 0050e162
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d43c] ; 0050e166 | int[10] g_MatrixStack_M10
    IMUL EDX                            ; 0050e16d
    SHRD EAX,EDX,0x10                   ; 0050e16f
    ADD ESI,EAX                         ; 0050e173
    MOV EAX,[0x02f0d3c0]                ; 0050e175 | int g_MatrixStackIndex
    MOV EDX,EBX                         ; 0050e17a
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d4b4] ; 0050e17c | int[10] g_MatrixStack_M20
    IMUL EDX                            ; 0050e183
    SHRD EAX,EDX,0x10                   ; 0050e185
    ADD ESI,EAX                         ; 0050e189
    MOV EAX,[0x02f0d3c0]                ; 0050e18b | int g_MatrixStackIndex
    MOV EDX,ECX                         ; 0050e190
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d3ec] ; 0050e192 | int[10] g_MatrixStack_M01
    MOV dword ptr [0x02d05300],ESI      ; 0050e199 | g_TransformMatrix[2][0]
    IMUL EDX                            ; 0050e19f
    SHRD EAX,EDX,0x10                   ; 0050e1a1
    MOV ESI,EAX                         ; 0050e1a5
    MOV EAX,[0x02f0d3c0]                ; 0050e1a7 | int g_MatrixStackIndex
    MOV EDX,dword ptr [ESP + 0x3c]      ; 0050e1ac
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d464] ; 0050e1b0 | int[10] g_MatrixStack_M11
    IMUL EDX                            ; 0050e1b7
    SHRD EAX,EDX,0x10                   ; 0050e1b9
    ADD ESI,EAX                         ; 0050e1bd
    MOV EAX,[0x02f0d3c0]                ; 0050e1bf | int g_MatrixStackIndex
    MOV EDX,EBX                         ; 0050e1c4
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d4dc] ; 0050e1c6 | int[10] g_MatrixStack_M21
    IMUL EDX                            ; 0050e1cd
    SHRD EAX,EDX,0x10                   ; 0050e1cf
    ADD ESI,EAX                         ; 0050e1d3
    MOV dword ptr [0x02d05304],ESI      ; 0050e1d5 | g_TransformMatrix[2][1]
    MOV EAX,[0x02f0d3c0]                ; 0050e1db | int g_MatrixStackIndex
    MOV EDX,ECX                         ; 0050e1e0
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d414] ; 0050e1e2 | int[10] g_MatrixStack_M02
    IMUL EDX                            ; 0050e1e9
    SHRD EAX,EDX,0x10                   ; 0050e1eb
    MOV ECX,EAX                         ; 0050e1ef
    MOV EAX,[0x02f0d3c0]                ; 0050e1f1 | int g_MatrixStackIndex
    MOV EDX,dword ptr [ESP + 0x3c]      ; 0050e1f6
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d48c] ; 0050e1fa | int[10] g_MatrixStack_M12
    IMUL EDX                            ; 0050e201
    SHRD EAX,EDX,0x10                   ; 0050e203
    ADD ECX,EAX                         ; 0050e207
    MOV EAX,[0x02f0d3c0]                ; 0050e209 | int g_MatrixStackIndex
    MOV EDX,EBX                         ; 0050e20e
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d504] ; 0050e210 | int[10] g_MatrixStack_M22
    IMUL EDX                            ; 0050e217
    SHRD EAX,EDX,0x10                   ; 0050e219
    MOV EDX,dword ptr [0x02f0d3c0]      ; 0050e21d | int g_MatrixStackIndex
    ADD ECX,EAX                         ; 0050e223
    INC EDX                             ; 0050e225
    MOV dword ptr [0x02d05308],ECX      ; 0050e226 | g_TransformMatrix[2][2]
    MOV dword ptr [0x02f0d3c0],EDX      ; 0050e22c | int g_MatrixStackIndex
    CMP EDX,0x9                         ; 0050e232
    JG 0x0050e23f                       ; 0050e235 | LAB_0050e23f
    ...
    POP EBX                             ; 0050e23d
    RET                                 ; 0050e23e
    MOV EBX,0x635aed                    ; 0050e23f | = "..\\engine\\matrix.c" | s_engine_matrix_c_00635aed = ..\engine\matrix.c
        ;   Label: LAB_0050e23f
    MOV ESI,0x4c9                       ; 0050e244
    PUSH 0x635b00                       ; 0050e249 | = "Matrix unbalance" | s_Matrix_unbalance_00635b00 = Matrix unbalance
    MOV dword ptr [0x02f0ca48],EBX      ; 0050e24e | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 0050e254 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0050e25a | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
