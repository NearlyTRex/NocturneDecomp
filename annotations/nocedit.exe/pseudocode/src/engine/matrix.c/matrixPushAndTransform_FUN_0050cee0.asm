...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_matrix.c_matrixPushAndTransform_FUN_0050cee0(ushort rotX, ushort rotY, ushort rotZ, int translateX, int translateY, int translateZ)
;
; Parameters:
; ushort           Stack[0x4]:2   rotX
; ushort           Stack[0x8]:2   rotY
; ushort           Stack[0xc]:2   rotZ
; int              Stack[0x10]:4   translateX
; int              Stack[0x14]:4   translateY
; int              Stack[0x18]:4   translateZ
; Local Variables:
...
section .text
    ...
    MOV EAX,[0x02f0d3c0]                ; 0050cef3 | int g_MatrixStackIndex
    MOV EDX,dword ptr [0x02d052b8]      ; 0050cef8 | int g_RelativeX
    MOV dword ptr [EAX*0x4 + 0x2f0d52c],EDX ; 0050cefe | int[10] g_MatrixStack_RelX
    MOV EDX,dword ptr [0x02d052bc]      ; 0050cf05 | int g_RelativeY
    MOV dword ptr [EAX*0x4 + 0x2f0d554],EDX ; 0050cf0b | int[10] g_MatrixStack_RelY
    MOV EDX,dword ptr [0x02d052c0]      ; 0050cf12 | int g_RelativeZ
    MOV dword ptr [EAX*0x4 + 0x2f0d57c],EDX ; 0050cf18 | int[10] g_MatrixStack_RelZ
    MOV EDX,dword ptr [0x02d052dc]      ; 0050cf1f | int g_LightDirectionX
    MOV dword ptr [EAX*0x4 + 0x2f0d5a4],EDX ; 0050cf25 | int[10] g_MatrixStack_Unk1
    MOV EDX,dword ptr [0x02d052e0]      ; 0050cf2c | int g_LightDirectionY
    MOV dword ptr [EAX*0x4 + 0x2f0d5cc],EDX ; 0050cf32 | int[10] g_MatrixStack_Unk2
    MOV EDX,dword ptr [0x02d052e4]      ; 0050cf39 | int g_LightDirectionZ
    MOV dword ptr [EAX*0x4 + 0x2f0d5f4],EDX ; 0050cf3f | int[10] g_MatrixStack_Unk3
    MOV EDX,dword ptr [0x02d052e8]      ; 0050cf46 | CMatrix3x3i g_TransformMatrix
    MOV dword ptr [EAX*0x4 + 0x2f0d3c4],EDX ; 0050cf4c | int[10] g_MatrixStack_M00
    MOV EDX,dword ptr [0x02d052ec]      ; 0050cf53 | g_TransformMatrix[0][1]
    MOV dword ptr [EAX*0x4 + 0x2f0d3ec],EDX ; 0050cf59 | int[10] g_MatrixStack_M01
    MOV EDX,dword ptr [0x02d052f0]      ; 0050cf60 | g_TransformMatrix[0][2]
    MOV dword ptr [EAX*0x4 + 0x2f0d414],EDX ; 0050cf66 | int[10] g_MatrixStack_M02
    MOV EDX,dword ptr [0x02d052f4]      ; 0050cf6d | g_TransformMatrix[1][0]
    MOV dword ptr [EAX*0x4 + 0x2f0d43c],EDX ; 0050cf73 | int[10] g_MatrixStack_M10
    MOV EDX,dword ptr [0x02d052f8]      ; 0050cf7a | g_TransformMatrix[1][1]
    MOV dword ptr [EAX*0x4 + 0x2f0d464],EDX ; 0050cf80 | int[10] g_MatrixStack_M11
    MOV EDX,dword ptr [0x02d052fc]      ; 0050cf87 | g_TransformMatrix[1][2]
    MOV dword ptr [EAX*0x4 + 0x2f0d48c],EDX ; 0050cf8d | int[10] g_MatrixStack_M12
    MOV EDX,dword ptr [0x02d05300]      ; 0050cf94 | g_TransformMatrix[2][0]
    MOV dword ptr [EAX*0x4 + 0x2f0d4b4],EDX ; 0050cf9a | int[10] g_MatrixStack_M20
    MOV EDX,dword ptr [0x02d05304]      ; 0050cfa1 | g_TransformMatrix[2][1]
    MOV dword ptr [EAX*0x4 + 0x2f0d4dc],EDX ; 0050cfa7 | int[10] g_MatrixStack_M21
    MOV EDX,dword ptr [0x02d05308]      ; 0050cfae | g_TransformMatrix[2][2]
    MOV dword ptr [EAX*0x4 + 0x2f0d504],EDX ; 0050cfb4 | int[10] g_MatrixStack_M22
    MOV EDX,dword ptr [ESP + 0x50]      ; 0050cfbb
    MOV EAX,[0x02d052b8]                ; 0050cfbf | int g_RelativeX
    SUB EAX,EDX                         ; 0050cfc4
    MOV ECX,dword ptr [ESP + 0x54]      ; 0050cfc6
    MOV dword ptr [ESP + 0x8],EAX       ; 0050cfca
    MOV EAX,[0x02d052bc]                ; 0050cfce | int g_RelativeY
    SUB EAX,ECX                         ; 0050cfd3
    MOV EBP,dword ptr [ESP + 0x58]      ; 0050cfd5
    MOV dword ptr [ESP + 0x4],EAX       ; 0050cfd9
    MOV EAX,[0x02d052c0]                ; 0050cfdd | int g_RelativeZ
    SUB EAX,EBP                         ; 0050cfe2
    MOV dword ptr [0x02f0d3b4],EBX      ; 0050cfe4 | uint g_SavedRotationY
    MOV dword ptr [ESP + 0x10],EAX      ; 0050cfea
    MOV EAX,EDI                         ; 0050cfee
    MOV dword ptr [0x02f0d3b8],ESI      ; 0050cff0 | uint g_SavedRotationZ
    OR EAX,EBX                          ; 0050cff6
    MOV dword ptr [0x02f0d3b0],EDI      ; 0050cff8 | uint g_SavedRotationX
    OR EAX,ESI                          ; 0050cffe
    JNZ 0x0050d03b                      ; 0050d000 | LAB_0050d03b
        ;   XREF to: 0050d03b (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x8]       ; 0050d002
    MOV [0x02d052b8],EAX                ; 0050d006 | int g_RelativeX
    MOV EAX,dword ptr [ESP + 0x4]       ; 0050d00b
    MOV [0x02d052bc],EAX                ; 0050d00f | int g_RelativeY
    MOV EAX,dword ptr [ESP + 0x10]      ; 0050d014
    MOV [0x02d052c0],EAX                ; 0050d018 | int g_RelativeZ
    MOV EDX,dword ptr [0x02f0d3c0]      ; 0050d01d | int g_MatrixStackIndex
        ;   Label: LAB_0050d01d
    INC EDX                             ; 0050d023
    MOV dword ptr [0x02f0d3c0],EDX      ; 0050d024 | int g_MatrixStackIndex
    CMP EDX,0x9                         ; 0050d02a
    JG 0x0050d5f5                       ; 0050d02d | LAB_0050d5f5
    ...
    PUSH EDI                            ; 0050d03b
        ;   Label: LAB_0050d03b
    CALL engine_matrix.c_interpolatedSin_FUN_0050c5c0 ; 0050d03c | int engine_matrix.c_interpolatedSin_FUN_0050c5c0(ushort angle)
        ;   XREF to: 0050c5c0 (UNCONDITIONAL_CALL)
    MOV dword ptr [ESP + 0x20],EAX      ; 0050d041
    ADD ESP,0x4                         ; 0050d045
    PUSH EDI                            ; 0050d048
    CALL engine_matrix.c_interpolatedCos_FUN_0050c600 ; 0050d049 | int engine_matrix.c_interpolatedCos_FUN_0050c600(ushort angle)
        ;   XREF to: 0050c600 (UNCONDITIONAL_CALL)
    MOV dword ptr [ESP + 0x10],EAX      ; 0050d04e
    ADD ESP,0x4                         ; 0050d052
    PUSH EBX                            ; 0050d055
    CALL engine_matrix.c_interpolatedSin_FUN_0050c5c0 ; 0050d056 | int engine_matrix.c_interpolatedSin_FUN_0050c5c0(ushort angle)
        ;   XREF to: 0050c5c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0050d05b
    PUSH EBX                            ; 0050d05e
    MOV EBP,EAX                         ; 0050d05f
    CALL engine_matrix.c_interpolatedCos_FUN_0050c600 ; 0050d061 | int engine_matrix.c_interpolatedCos_FUN_0050c600(ushort angle)
        ;   XREF to: 0050c600 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0050d066
    PUSH ESI                            ; 0050d069
    MOV EBX,EAX                         ; 0050d06a
    CALL engine_matrix.c_interpolatedSin_FUN_0050c5c0 ; 0050d06c | int engine_matrix.c_interpolatedSin_FUN_0050c5c0(ushort angle)
        ;   XREF to: 0050c5c0 (UNCONDITIONAL_CALL)
    MOV dword ptr [ESP + 0x28],EAX      ; 0050d071
    ADD ESP,0x4                         ; 0050d075
    PUSH ESI                            ; 0050d078
    CALL engine_matrix.c_interpolatedCos_FUN_0050c600 ; 0050d079 | int engine_matrix.c_interpolatedCos_FUN_0050c600(ushort angle)
        ;   XREF to: 0050c600 (UNCONDITIONAL_CALL)
    ...
    MOV dword ptr [0x02d052b8],EDX      ; 0050d1b7 | int g_RelativeX
    ...
    MOV dword ptr [0x02d052bc],EDX      ; 0050d1ef | int g_RelativeY
    ...
    MOV dword ptr [0x02d052c0],EDX      ; 0050d22b | int g_RelativeZ
    MOV EDX,dword ptr [0x02f0d3c0]      ; 0050d231 | int g_MatrixStackIndex
    MOV EAX,dword ptr [ESP + 0x18]      ; 0050d237
    MOV EDX,dword ptr [EDX*0x4 + 0x2f0d5a4] ; 0050d23b | int[10] g_MatrixStack_Unk1
    IMUL EDX                            ; 0050d242
    SHRD EAX,EDX,0x10                   ; 0050d244
    MOV EDX,dword ptr [0x02f0d3c0]      ; 0050d248 | int g_MatrixStackIndex
    MOV dword ptr [ESP],EAX             ; 0050d24e
    MOV EAX,ESI                         ; 0050d251
    MOV EDX,dword ptr [EDX*0x4 + 0x2f0d5cc] ; 0050d253 | int[10] g_MatrixStack_Unk2
    IMUL EDX                            ; 0050d25a
    SHRD EAX,EDX,0x10                   ; 0050d25c
    MOV EDX,dword ptr [ESP]             ; 0050d260
    ADD EDX,EAX                         ; 0050d263
    MOV dword ptr [ESP],EDX             ; 0050d265
    MOV EDX,dword ptr [0x02f0d3c0]      ; 0050d268 | int g_MatrixStackIndex
    MOV EAX,dword ptr [ESP + 0x2c]      ; 0050d26e
    MOV EDX,dword ptr [EDX*0x4 + 0x2f0d5f4] ; 0050d272 | int[10] g_MatrixStack_Unk3
    IMUL EDX                            ; 0050d279
    SHRD EAX,EDX,0x10                   ; 0050d27b
    MOV EDX,dword ptr [ESP]             ; 0050d27f
    ADD EDX,EAX                         ; 0050d282
    MOV dword ptr [0x02d052dc],EDX      ; 0050d284 | int g_LightDirectionX
    MOV EDX,dword ptr [0x02f0d3c0]      ; 0050d28a | int g_MatrixStackIndex
    MOV EAX,dword ptr [ESP + 0x20]      ; 0050d290
    MOV EDX,dword ptr [EDX*0x4 + 0x2f0d5a4] ; 0050d294 | int[10] g_MatrixStack_Unk1
    IMUL EDX                            ; 0050d29b
    SHRD EAX,EDX,0x10                   ; 0050d29d
    MOV EDX,dword ptr [0x02f0d3c0]      ; 0050d2a1 | int g_MatrixStackIndex
    MOV dword ptr [ESP],EAX             ; 0050d2a7
    MOV EAX,EDI                         ; 0050d2aa
    MOV EDX,dword ptr [EDX*0x4 + 0x2f0d5cc] ; 0050d2ac | int[10] g_MatrixStack_Unk2
    IMUL EDX                            ; 0050d2b3
    SHRD EAX,EDX,0x10                   ; 0050d2b5
    MOV EDX,dword ptr [ESP]             ; 0050d2b9
    ADD EDX,EAX                         ; 0050d2bc
    MOV dword ptr [ESP],EDX             ; 0050d2be
    MOV EDX,dword ptr [0x02f0d3c0]      ; 0050d2c1 | int g_MatrixStackIndex
    MOV EAX,EBP                         ; 0050d2c7
    MOV EDX,dword ptr [EDX*0x4 + 0x2f0d5f4] ; 0050d2c9 | int[10] g_MatrixStack_Unk3
    IMUL EDX                            ; 0050d2d0
    SHRD EAX,EDX,0x10                   ; 0050d2d2
    MOV EDX,dword ptr [ESP]             ; 0050d2d6
    ADD EDX,EAX                         ; 0050d2d9
    MOV dword ptr [0x02d052e0],EDX      ; 0050d2db | int g_LightDirectionY
    MOV EDX,dword ptr [0x02f0d3c0]      ; 0050d2e1 | int g_MatrixStackIndex
    MOV EAX,ECX                         ; 0050d2e7
    MOV EDX,dword ptr [EDX*0x4 + 0x2f0d5a4] ; 0050d2e9 | int[10] g_MatrixStack_Unk1
    IMUL EDX                            ; 0050d2f0
    SHRD EAX,EDX,0x10                   ; 0050d2f2
    MOV EDX,dword ptr [0x02f0d3c0]      ; 0050d2f6 | int g_MatrixStackIndex
    MOV dword ptr [ESP],EAX             ; 0050d2fc
    MOV EAX,dword ptr [ESP + 0x14]      ; 0050d2ff
    MOV EDX,dword ptr [EDX*0x4 + 0x2f0d5cc] ; 0050d303 | int[10] g_MatrixStack_Unk2
    IMUL EDX                            ; 0050d30a
    SHRD EAX,EDX,0x10                   ; 0050d30c
    MOV EDX,dword ptr [ESP]             ; 0050d310
    ADD EDX,EAX                         ; 0050d313
    MOV dword ptr [ESP],EDX             ; 0050d315
    MOV EDX,dword ptr [0x02f0d3c0]      ; 0050d318 | int g_MatrixStackIndex
    MOV EAX,EBX                         ; 0050d31e
    MOV EDX,dword ptr [EDX*0x4 + 0x2f0d5f4] ; 0050d320 | int[10] g_MatrixStack_Unk3
    IMUL EDX                            ; 0050d327
    SHRD EAX,EDX,0x10                   ; 0050d329
    MOV EDX,dword ptr [ESP]             ; 0050d32d
    ADD EDX,EAX                         ; 0050d330
    MOV dword ptr [0x02d052e4],EDX      ; 0050d332 | int g_LightDirectionZ
    MOV EAX,[0x02f0d3c0]                ; 0050d338 | int g_MatrixStackIndex
    MOV EDX,dword ptr [ESP + 0x18]      ; 0050d33d
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d3c4] ; 0050d341 | int[10] g_MatrixStack_M00
    IMUL EDX                            ; 0050d348
    SHRD EAX,EDX,0x10                   ; 0050d34a
    MOV dword ptr [ESP],EAX             ; 0050d34e
    MOV EAX,[0x02f0d3c0]                ; 0050d351 | int g_MatrixStackIndex
    MOV EDX,ESI                         ; 0050d356
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d43c] ; 0050d358 | int[10] g_MatrixStack_M10
    IMUL EDX                            ; 0050d35f
    SHRD EAX,EDX,0x10                   ; 0050d361
    MOV EDX,dword ptr [ESP]             ; 0050d365
    ADD EDX,EAX                         ; 0050d368
    MOV EAX,[0x02f0d3c0]                ; 0050d36a | int g_MatrixStackIndex
    MOV dword ptr [ESP],EDX             ; 0050d36f
    MOV EDX,dword ptr [ESP + 0x2c]      ; 0050d372
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d4b4] ; 0050d376 | int[10] g_MatrixStack_M20
    IMUL EDX                            ; 0050d37d
    SHRD EAX,EDX,0x10                   ; 0050d37f
    MOV EDX,dword ptr [ESP]             ; 0050d383
    ADD EDX,EAX                         ; 0050d386
    MOV EAX,[0x02f0d3c0]                ; 0050d388 | int g_MatrixStackIndex
    MOV dword ptr [0x02d052e8],EDX      ; 0050d38d | CMatrix3x3i g_TransformMatrix
    MOV EDX,dword ptr [ESP + 0x18]      ; 0050d393
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d3ec] ; 0050d397 | int[10] g_MatrixStack_M01
    IMUL EDX                            ; 0050d39e
    SHRD EAX,EDX,0x10                   ; 0050d3a0
    MOV dword ptr [ESP],EAX             ; 0050d3a4
    MOV EAX,[0x02f0d3c0]                ; 0050d3a7 | int g_MatrixStackIndex
    MOV EDX,ESI                         ; 0050d3ac
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d464] ; 0050d3ae | int[10] g_MatrixStack_M11
    IMUL EDX                            ; 0050d3b5
    SHRD EAX,EDX,0x10                   ; 0050d3b7
    MOV EDX,dword ptr [ESP]             ; 0050d3bb
    ADD EDX,EAX                         ; 0050d3be
    MOV EAX,[0x02f0d3c0]                ; 0050d3c0 | int g_MatrixStackIndex
    MOV dword ptr [ESP],EDX             ; 0050d3c5
    MOV EDX,dword ptr [ESP + 0x2c]      ; 0050d3c8
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d4dc] ; 0050d3cc | int[10] g_MatrixStack_M21
    IMUL EDX                            ; 0050d3d3
    SHRD EAX,EDX,0x10                   ; 0050d3d5
    MOV EDX,dword ptr [ESP]             ; 0050d3d9
    ADD EDX,EAX                         ; 0050d3dc
    MOV EAX,[0x02f0d3c0]                ; 0050d3de | int g_MatrixStackIndex
    MOV dword ptr [0x02d052ec],EDX      ; 0050d3e3 | g_TransformMatrix[0][1]
    MOV EDX,dword ptr [ESP + 0x18]      ; 0050d3e9
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d414] ; 0050d3ed | int[10] g_MatrixStack_M02
    IMUL EDX                            ; 0050d3f4
    SHRD EAX,EDX,0x10                   ; 0050d3f6
    MOV dword ptr [ESP],EAX             ; 0050d3fa
    MOV EAX,[0x02f0d3c0]                ; 0050d3fd | int g_MatrixStackIndex
    MOV EDX,ESI                         ; 0050d402
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d48c] ; 0050d404 | int[10] g_MatrixStack_M12
    MOV ESI,dword ptr [ESP]             ; 0050d40b
    IMUL EDX                            ; 0050d40e
    SHRD EAX,EDX,0x10                   ; 0050d410
    ADD ESI,EAX                         ; 0050d414
    MOV EAX,[0x02f0d3c0]                ; 0050d416 | int g_MatrixStackIndex
    MOV EDX,dword ptr [ESP + 0x2c]      ; 0050d41b
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d504] ; 0050d41f | int[10] g_MatrixStack_M22
    IMUL EDX                            ; 0050d426
    SHRD EAX,EDX,0x10                   ; 0050d428
    ADD ESI,EAX                         ; 0050d42c
    MOV EAX,[0x02f0d3c0]                ; 0050d42e | int g_MatrixStackIndex
    MOV EDX,dword ptr [ESP + 0x20]      ; 0050d433
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d3c4] ; 0050d437 | int[10] g_MatrixStack_M00
    MOV dword ptr [0x02d052f0],ESI      ; 0050d43e | g_TransformMatrix[0][2]
    IMUL EDX                            ; 0050d444
    SHRD EAX,EDX,0x10                   ; 0050d446
    MOV ESI,EAX                         ; 0050d44a
    MOV EAX,[0x02f0d3c0]                ; 0050d44c | int g_MatrixStackIndex
    MOV EDX,EDI                         ; 0050d451
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d43c] ; 0050d453 | int[10] g_MatrixStack_M10
    IMUL EDX                            ; 0050d45a
    SHRD EAX,EDX,0x10                   ; 0050d45c
    ADD ESI,EAX                         ; 0050d460
    MOV EAX,[0x02f0d3c0]                ; 0050d462 | int g_MatrixStackIndex
    MOV EDX,EBP                         ; 0050d467
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d4b4] ; 0050d469 | int[10] g_MatrixStack_M20
    IMUL EDX                            ; 0050d470
    SHRD EAX,EDX,0x10                   ; 0050d472
    ADD ESI,EAX                         ; 0050d476
    MOV dword ptr [0x02d052f4],ESI      ; 0050d478 | g_TransformMatrix[1][0]
    MOV EAX,[0x02f0d3c0]                ; 0050d47e | int g_MatrixStackIndex
    MOV EDX,dword ptr [ESP + 0x20]      ; 0050d483
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d3ec] ; 0050d487 | int[10] g_MatrixStack_M01
    IMUL EDX                            ; 0050d48e
    SHRD EAX,EDX,0x10                   ; 0050d490
    MOV ESI,EAX                         ; 0050d494
    MOV EAX,[0x02f0d3c0]                ; 0050d496 | int g_MatrixStackIndex
    MOV EDX,EDI                         ; 0050d49b
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d464] ; 0050d49d | int[10] g_MatrixStack_M11
    IMUL EDX                            ; 0050d4a4
    SHRD EAX,EDX,0x10                   ; 0050d4a6
    ADD ESI,EAX                         ; 0050d4aa
    MOV EAX,[0x02f0d3c0]                ; 0050d4ac | int g_MatrixStackIndex
    MOV EDX,EBP                         ; 0050d4b1
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d4dc] ; 0050d4b3 | int[10] g_MatrixStack_M21
    IMUL EDX                            ; 0050d4ba
    SHRD EAX,EDX,0x10                   ; 0050d4bc
    ADD ESI,EAX                         ; 0050d4c0
    MOV EAX,[0x02f0d3c0]                ; 0050d4c2 | int g_MatrixStackIndex
    MOV EDX,dword ptr [ESP + 0x20]      ; 0050d4c7
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d414] ; 0050d4cb | int[10] g_MatrixStack_M02
    MOV dword ptr [0x02d052f8],ESI      ; 0050d4d2 | g_TransformMatrix[1][1]
    IMUL EDX                            ; 0050d4d8
    SHRD EAX,EDX,0x10                   ; 0050d4da
    MOV ESI,EAX                         ; 0050d4de
    MOV EAX,[0x02f0d3c0]                ; 0050d4e0 | int g_MatrixStackIndex
    MOV EDX,EDI                         ; 0050d4e5
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d48c] ; 0050d4e7 | int[10] g_MatrixStack_M12
    IMUL EDX                            ; 0050d4ee
    SHRD EAX,EDX,0x10                   ; 0050d4f0
    ADD ESI,EAX                         ; 0050d4f4
    MOV EAX,[0x02f0d3c0]                ; 0050d4f6 | int g_MatrixStackIndex
    MOV EDX,EBP                         ; 0050d4fb
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d504] ; 0050d4fd | int[10] g_MatrixStack_M22
    IMUL EDX                            ; 0050d504
    SHRD EAX,EDX,0x10                   ; 0050d506
    ADD ESI,EAX                         ; 0050d50a
    MOV EAX,[0x02f0d3c0]                ; 0050d50c | int g_MatrixStackIndex
    MOV EDX,ECX                         ; 0050d511
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d3c4] ; 0050d513 | int[10] g_MatrixStack_M00
    MOV dword ptr [0x02d052fc],ESI      ; 0050d51a | g_TransformMatrix[1][2]
    IMUL EDX                            ; 0050d520
    SHRD EAX,EDX,0x10                   ; 0050d522
    MOV ESI,EAX                         ; 0050d526
    MOV EAX,[0x02f0d3c0]                ; 0050d528 | int g_MatrixStackIndex
    MOV EDX,dword ptr [ESP + 0x14]      ; 0050d52d
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d43c] ; 0050d531 | int[10] g_MatrixStack_M10
    IMUL EDX                            ; 0050d538
    SHRD EAX,EDX,0x10                   ; 0050d53a
    ADD ESI,EAX                         ; 0050d53e
    MOV EAX,[0x02f0d3c0]                ; 0050d540 | int g_MatrixStackIndex
    MOV EDX,EBX                         ; 0050d545
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d4b4] ; 0050d547 | int[10] g_MatrixStack_M20
    IMUL EDX                            ; 0050d54e
    SHRD EAX,EDX,0x10                   ; 0050d550
    ADD ESI,EAX                         ; 0050d554
    MOV EAX,[0x02f0d3c0]                ; 0050d556 | int g_MatrixStackIndex
    MOV EDX,ECX                         ; 0050d55b
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d3ec] ; 0050d55d | int[10] g_MatrixStack_M01
    MOV dword ptr [0x02d05300],ESI      ; 0050d564 | g_TransformMatrix[2][0]
    IMUL EDX                            ; 0050d56a
    SHRD EAX,EDX,0x10                   ; 0050d56c
    MOV ESI,EAX                         ; 0050d570
    MOV EAX,[0x02f0d3c0]                ; 0050d572 | int g_MatrixStackIndex
    MOV EDX,dword ptr [ESP + 0x14]      ; 0050d577
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d464] ; 0050d57b | int[10] g_MatrixStack_M11
    IMUL EDX                            ; 0050d582
    SHRD EAX,EDX,0x10                   ; 0050d584
    ADD ESI,EAX                         ; 0050d588
    MOV EAX,[0x02f0d3c0]                ; 0050d58a | int g_MatrixStackIndex
    MOV EDX,EBX                         ; 0050d58f
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d4dc] ; 0050d591 | int[10] g_MatrixStack_M21
    IMUL EDX                            ; 0050d598
    SHRD EAX,EDX,0x10                   ; 0050d59a
    ADD ESI,EAX                         ; 0050d59e
    MOV dword ptr [0x02d05304],ESI      ; 0050d5a0 | g_TransformMatrix[2][1]
    MOV EAX,[0x02f0d3c0]                ; 0050d5a6 | int g_MatrixStackIndex
    MOV EDX,ECX                         ; 0050d5ab
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d414] ; 0050d5ad | int[10] g_MatrixStack_M02
    IMUL EDX                            ; 0050d5b4
    SHRD EAX,EDX,0x10                   ; 0050d5b6
    MOV ECX,EAX                         ; 0050d5ba
    MOV EAX,[0x02f0d3c0]                ; 0050d5bc | int g_MatrixStackIndex
    MOV EDX,dword ptr [ESP + 0x14]      ; 0050d5c1
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d48c] ; 0050d5c5 | int[10] g_MatrixStack_M12
    IMUL EDX                            ; 0050d5cc
    SHRD EAX,EDX,0x10                   ; 0050d5ce
    ADD ECX,EAX                         ; 0050d5d2
    MOV EAX,[0x02f0d3c0]                ; 0050d5d4 | int g_MatrixStackIndex
    MOV EDX,EBX                         ; 0050d5d9
    MOV EAX,dword ptr [EAX*0x4 + 0x2f0d504] ; 0050d5db | int[10] g_MatrixStack_M22
    IMUL EDX                            ; 0050d5e2
    SHRD EAX,EDX,0x10                   ; 0050d5e4
    ADD ECX,EAX                         ; 0050d5e8
    MOV dword ptr [0x02d05308],ECX      ; 0050d5ea | g_TransformMatrix[2][2]
    JMP 0x0050d01d                      ; 0050d5f0 | LAB_0050d01d
        ;   XREF to: 0050d01d (UNCONDITIONAL_JUMP)
    MOV EBX,0x635a4d                    ; 0050d5f5 | = "..\\engine\\matrix.c" | s_engine_matrix_c_00635a4d = ..\engine\matrix.c
        ;   Label: LAB_0050d5f5
    MOV ESI,0x31f                       ; 0050d5fa
    PUSH 0x635a60                       ; 0050d5ff | = "Matrix unbalance" | s_Matrix_unbalance_00635a60 = Matrix unbalance
    MOV dword ptr [0x02f0ca48],EBX      ; 0050d604 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 0050d60a | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0050d610 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
