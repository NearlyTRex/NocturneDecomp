...
;
; XREF[3]:
;   core_mimic.cpp_CMimic_renderMirrored_FUN_005205f0 at 0052069f
;   core_mimic.cpp_mirrorXTransform_FUN_0051f130 at 0051f133
;   engine_drender.cpp_CDemonRenderer_matrixPush_FUN_0048c630 at 0048c630
;
; Referenced Globals:
