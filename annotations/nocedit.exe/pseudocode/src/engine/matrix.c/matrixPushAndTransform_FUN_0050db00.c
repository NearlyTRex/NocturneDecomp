...

{
  ...
  fVar16 = (float10)0.31830988619288902;
  fVar17 = (float10)65536f;
  dVar18 = crt_math_c_round_FUN_005fe6b0((double)(-fVar15 * fVar16 * fVar17));
  angle = (ushort)(int)ROUND(dVar18);
  crt_math_c_round_FUN_005fe6b0((double)(extraout_ST1 * fVar16 * fVar17));
  iVar3 = engine_matrix_c_interpolatedSin_FUN_0050c5c0((ushort)(int)ROUND(dVar18));
  engine_matrix_c_interpolatedCos_FUN_0050c600(angle);
