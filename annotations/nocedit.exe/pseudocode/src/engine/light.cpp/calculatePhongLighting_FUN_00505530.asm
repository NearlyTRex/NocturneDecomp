...
section .text
    ...
    MOV EDX,dword ptr [0x02d052dc]      ; 0050553f | int g_LightDirectionX
    MOV EAX,ESI                         ; 00505545
    IMUL EDX                            ; 00505547
    SHRD EAX,EDX,0x10                   ; 00505549
    MOV EDX,dword ptr [0x02d052e0]      ; 0050554d | int g_LightDirectionY
    MOV ECX,EAX                         ; 00505553
    MOV EAX,dword ptr [ESP + 0x2c]      ; 00505555
    IMUL EDX                            ; 00505559
    SHRD EAX,EDX,0x10                   ; 0050555b
    MOV EDX,dword ptr [0x02d052e4]      ; 0050555f | int g_LightDirectionZ
    ...
    JL 0x00505712                       ; 00505578 | LAB_00505712
        ;   XREF to: 00505712 (CONDITIONAL_JUMP)
    CMP EBX,0xffff                      ; 0050557e
    JLE 0x0050558b                      ; 00505584 | LAB_0050558b
        ;   XREF to: 0050558b (CONDITIONAL_JUMP)
    MOV EBX,0xffff                      ; 00505586
    MOV EDX,0xffff                      ; 0050558b
        ;   Label: LAB_0050558b
    MOV EBP,dword ptr [0x0067cfc8]      ; 00505590 | int g_AmbientLightLevel
    MOV EAX,EBX                         ; 00505596
    SUB EDX,EBP                         ; 00505598
    IMUL EDX                            ; 0050559a
    SHRD EAX,EDX,0x10                   ; 0050559c
    MOV EBX,dword ptr [0x0067cfc8]      ; 005055a0 | int g_AmbientLightLevel
    ADD EBX,EAX                         ; 005055a6
    TEST EBX,EBX                        ; 005055a8
    JL 0x00505719                       ; 005055aa | LAB_00505719
        ;   XREF to: 00505719 (CONDITIONAL_JUMP)
    CMP EBX,0xffff                      ; 005055b0
    JLE 0x005055bd                      ; 005055b6 | LAB_005055bd
        ;   XREF to: 005055bd (CONDITIONAL_JUMP)
    MOV EBX,0xffff                      ; 005055b8
    CMP dword ptr [0x0067cfcc],0x0      ; 005055bd | int g_SpecularEnabled
        ;   Label: LAB_005055bd
    JZ 0x00505720                       ; 005055c4 | LAB_00505720
    ...
    MOV EDX,dword ptr [0x02d052dc]      ; 005055d7 | int g_LightDirectionX
    MOV EAX,dword ptr [ESP + 0x2c]      ; 005055dd
    SUB EBP,EDX                         ; 005055e1
    MOV EDX,ECX                         ; 005055e3
    IMUL EDX                            ; 005055e5
    SHRD EAX,EDX,0x10                   ; 005055e7
    MOV ESI,dword ptr [0x02d052e0]      ; 005055eb | int g_LightDirectionY
    ...
    MOV EDI,dword ptr [0x02d052e4]      ; 00505603 | int g_LightDirectionZ
    ADD EAX,EAX                         ; 00505609
    SUB EAX,EDI                         ; 0050560b
    MOV EDX,dword ptr [0x02dd30a0]      ; 0050560d | CVector3i g_CachedViewPosition
    MOV dword ptr [ESP + 0x10],EAX      ; 00505613
    CMP EDX,dword ptr [0x02d052b8]      ; 00505617 | int g_RelativeX
    JZ 0x00505731                       ; 0050561d | LAB_00505731
        ;   XREF to: 00505731 (CONDITIONAL_JUMP)
    MOV EAX,[0x02d052b8]                ; 00505623 | int g_RelativeX
        ;   Label: LAB_00505623
    PUSH 0x2dd30a0                      ; 00505628 | CVector3i g_CachedViewPosition
    MOV [0x02dd30a0],EAX                ; 0050562d | CVector3i g_CachedViewPosition
    MOV EAX,[0x02d052bc]                ; 00505632 | int g_RelativeY
    LEA ESI,[ESP + 0x4]                 ; 00505637
    MOV [0x02dd30a4],EAX                ; 0050563b | g_CachedViewPosition.y
    MOV EAX,[0x02d052c0]                ; 00505640 | int g_RelativeZ
    MOV EDI,0x2dd30ac                   ; 00505645 | CVector3i g_NormalizedViewVector
    MOV [0x02dd30a8],EAX                ; 0050564a | g_CachedViewPosition.z
    CALL engine_matrix.c_normalizeVector3DFloat_FUN_0050d9f0 ; 0050564f | CVector3i * engine_matrix.c_normalizeVector3DFloat_FUN_0050d9f0(CVector3i * inputVector)
        ;   XREF to: 0050d9f0 (UNCONDITIONAL_CALL)
    LEA ESI,[ESP + 0x4]                 ; 00505654
    ADD ESP,0x4                         ; 00505658
    MOVSD ES:EDI,ESI                    ; 0050565b | CVector3i g_NormalizedViewVector
    MOVSD ES:EDI,ESI                    ; 0050565c | g_NormalizedViewVector.y
    MOVSD ES:EDI,ESI                    ; 0050565d | g_NormalizedViewVector.z
    MOV EDX,dword ptr [0x02dd30ac]      ; 0050565e | CVector3i g_NormalizedViewVector
        ;   Label: LAB_0050565e
    ...
    JL 0x0050575a                       ; 00505696 | LAB_0050575a
        ;   XREF to: 0050575a (CONDITIONAL_JUMP)
    CMP ECX,0xffff                      ; 0050569c
    JLE 0x0050575e                      ; 005056a2 | LAB_0050575e
    ...
    MOV EAX,[0x0067cfd0]                ; 005056d9 | int g_DiffuseLightMultiplier
        ;   Label: LAB_005056d9
    ...
    MOV EAX,[0x0067cfd4]                ; 005056ea | int g_SpecularLightMultiplier
    IMUL EDX                            ; 005056ef
    ...
    XOR EBX,EBX                         ; 00505712
        ;   Label: LAB_00505712
    JMP 0x0050558b                      ; 00505714 | LAB_0050558b
        ;   XREF to: 0050558b (UNCONDITIONAL_JUMP)
    XOR EBX,EBX                         ; 00505719
        ;   Label: LAB_00505719
    JMP 0x005055bd                      ; 0050571b | LAB_005055bd
        ;   XREF to: 005055bd (UNCONDITIONAL_JUMP)
    MOV EAX,[0x0067cfd0]                ; 00505720 | int g_DiffuseLightMultiplier
        ;   Label: LAB_00505720
    MOV EDX,EBX                         ; 00505725
    IMUL EDX                            ; 00505727
    SHRD EAX,EDX,0x10                   ; 00505729
    MOV EDX,EAX                         ; 0050572d
    JMP 0x005056f8                      ; 0050572f | LAB_005056f8
        ;   XREF to: 005056f8 (UNCONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x02dd30a4]      ; 00505731 | g_CachedViewPosition.y
        ;   Label: LAB_00505731
    CMP ECX,dword ptr [0x02d052bc]      ; 00505737 | int g_RelativeY
    JNZ 0x00505623                      ; 0050573d | LAB_00505623
        ;   XREF to: 00505623 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [0x02dd30a8]      ; 00505743 | g_CachedViewPosition.z
    CMP ESI,dword ptr [0x02d052c0]      ; 00505749 | int g_RelativeZ
    JNZ 0x00505623                      ; 0050574f | LAB_00505623
        ;   XREF to: 00505623 (CONDITIONAL_JUMP)
    JMP 0x0050565e                      ; 00505755 | LAB_0050565e
        ;   XREF to: 0050565e (UNCONDITIONAL_JUMP)
    MOV EDX,EBX                         ; 0050575a
        ;   Label: LAB_0050575a
    JMP 0x005056f8                      ; 0050575c | LAB_005056f8
        ;   XREF to: 005056f8 (UNCONDITIONAL_JUMP)
    CMP ECX,0xbb80                      ; 0050575e
        ;   Label: LAB_0050575e
    JG 0x005056ad                       ; 00505764 | LAB_005056ad
        ;   XREF to: 005056ad (CONDITIONAL_JUMP)
    XOR ECX,ECX                         ; 0050576a
    JMP 0x005056d9                      ; 0050576c | LAB_005056d9
