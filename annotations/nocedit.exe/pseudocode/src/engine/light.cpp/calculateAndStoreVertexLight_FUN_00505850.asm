...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_light.cpp_calculateAndStoreVertexLight_FUN_00505850(int vertex_index, CVector3i * vertex_position)
;
; Parameters:
...
section .text
    ...
    MOV dword ptr [EAX + 0x688034],ECX  ; 0050587a | g_RenderVertexBuffer[0].light
    POP EBX                             ; 00505880
    RET                                 ; 00505881
