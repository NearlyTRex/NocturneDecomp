...
section .text
    ...
    JNZ 0x0048a865                      ; 0048a82f | LAB_0048a865
        ;   XREF to: 0048a865 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x4],0x0       ; 0048a831
        ;   Label: LAB_0048a831
    JZ 0x0048a877                       ; 0048a835 | LAB_0048a877
        ;   XREF to: 0048a877 (CONDITIONAL_JUMP)
    XOR ECX,ECX                         ; 0048a837
    MOV EDX,0x49072f                    ; 0048a839
    MOV dword ptr [0x02d052a0],ECX      ; 0048a83e | int g_RenderStateFlags
    MOV dword ptr [0x02d052a4],ECX      ; 0048a844 | int g_RenderStateFlag2
    MOV dword ptr [0x02d0257c],EDX      ; 0048a84a | RenderScanlineFunc * g_ScanlineRenderFunc
    ...
    PUSH EBP                            ; 0048a857
    PUSH EBX                            ; 0048a858
    CALL engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740 ; 0048a859 | void engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740(CDemonRenderer * this_ptr, int vertex_count, int * vertex_indices)
    ...
    LEA EAX,[ESI + 0x8]                 ; 0048a865
        ;   Label: LAB_0048a865
    PUSH EAX                            ; 0048a868
    CALL engine_3d.c_isVisiblePlane_FUN_00403950 ; 0048a869 | int engine_3d.c_isVisiblePlane_FUN_00403950(SClipPlane * plane)
        ;   XREF to: 00403950 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0048a86e
    TEST EAX,EAX                        ; 0048a871
    JZ 0x0048a861                       ; 0048a873 | LAB_0048a861
        ;   XREF to: 0048a861 (CONDITIONAL_JUMP)
    JMP 0x0048a831                      ; 0048a875 | LAB_0048a831
    ...
    MOV dword ptr [0x02d052a0],EBP      ; 0048a887 | int g_RenderStateFlags
    MOV [0x02d052a4],EAX                ; 0048a88d | int g_RenderStateFlag2
    MOV dword ptr [0x02d0257c],EDI      ; 0048a892 | RenderScanlineFunc * g_ScanlineRenderFunc
    POP EDI                             ; 0048a898
    JMP 0x0048a850                      ; 0048a899 | LAB_0048a850
