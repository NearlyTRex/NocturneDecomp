...
;                               FUNCTION
; *****************************************************************************
; __cdecl int engine_drender.cpp_CDemonRenderer_depthTest_FUN_0048dc50(CDemonRenderer * this_ptr, SRenderVertex * vertex_ptr)
;
; Parameters:
...
section .text
    ...
    JNZ 0x0048dca3                      ; 0048dc81 | LAB_0048dca3
        ;   XREF to: 0048dca3 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [EDX + 0x2cf7d5c] ; 0048dc83 | uint *[1024] g_ZBufferScanlineArray
    MOV EAX,dword ptr [EDX + EAX*0x1]   ; 0048dc89
    CMP EAX,dword ptr [EBX + 0x8]       ; 0048dc8c
    JLE 0x0048dcb6                      ; 0048dc8f | LAB_0048dcb6
    ...
    PUSH 0x1                            ; 0048dc96
        ;   Label: LAB_0048dc96
    PUSH EBX                            ; 0048dc98
    CALL engine_prim.c_replaceWWithDepth_FUN_00552110 ; 0048dc99 | void engine_prim.c_replaceWWithDepth_FUN_00552110(SRenderVertex * vertices, int vertex_count)
        ;   XREF to: 00552110 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0048dc9e
    JMP 0x0048dc66                      ; 0048dca1 | LAB_0048dc66
        ;   XREF to: 0048dc66 (UNCONDITIONAL_JUMP)
    MOV EDX,dword ptr [EDX + 0x2cf6a9c] ; 0048dca3 | void *[1024] g_ScreenBufferArray
        ;   Label: LAB_0048dca3
    MOV EAX,dword ptr [EDX + EAX*0x1]   ; 0048dca9
    CMP EAX,dword ptr [EBX + 0x8]       ; 0048dcac
    JLE 0x0048dcb6                      ; 0048dcaf | LAB_0048dcb6
        ;   XREF to: 0048dcb6 (CONDITIONAL_JUMP)
