...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_drender.cpp_CDemonRenderer_renderComplexMultiFeature_FUN_0048bf10(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * polygon_info)
;
; Parameters:
...
section .text
    ...
    JNZ 0x0048bf91                      ; 0048bf20 | LAB_0048bf91
    ...
    JLE 0x0048bf50                      ; 0048bf32 | LAB_0048bf50
    ...
    JL 0x0048bf39                       ; 0048bf4c | LAB_0048bf39
        ;   XREF to: 0048bf39 (CONDITIONAL_JUMP)
    MOV EAX,EAX                         ; 0048bf4e
    TEST ECX,0x80000000                 ; 0048bf50
        ;   Label: LAB_0048bf50
    JZ 0x0048bf5d                       ; 0048bf56 | LAB_0048bf5d
        ;   XREF to: 0048bf5d (CONDITIONAL_JUMP)
    TEST CL,0x1f                        ; 0048bf58
    JNZ 0x0048bf8c                      ; 0048bf5b | LAB_0048bf8c
        ;   XREF to: 0048bf8c (CONDITIONAL_JUMP)
    CMP dword ptr [EBP + 0x4],0x0       ; 0048bf5d
        ;   Label: LAB_0048bf5d
    JZ 0x0048bfa3                       ; 0048bf61 | LAB_0048bfa3
        ;   XREF to: 0048bfa3 (CONDITIONAL_JUMP)
    XOR EDX,EDX                         ; 0048bf63
    MOV EAX,0x49072f                    ; 0048bf65
    MOV dword ptr [0x02d052a0],EDX      ; 0048bf6a | int g_RenderStateFlags
    MOV dword ptr [0x02d052a4],EDX      ; 0048bf70 | int g_RenderStateFlag2
    MOV [0x02d0257c],EAX                ; 0048bf76 | RenderScanlineFunc * g_ScanlineRenderFunc
    ...
    PUSH EBX                            ; 0048bf82
    PUSH EBP                            ; 0048bf83
    CALL engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740 ; 0048bf84 | void engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740(CDemonRenderer * this_ptr, int vertex_count, int * vertex_indices)
    ...
    LEA EAX,[ESI + 0x8]                 ; 0048bf91
        ;   Label: LAB_0048bf91
    PUSH EAX                            ; 0048bf94
    CALL engine_3d.c_isVisiblePlane_FUN_00403950 ; 0048bf95 | int engine_3d.c_isVisiblePlane_FUN_00403950(SClipPlane * plane)
        ;   XREF to: 00403950 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0048bf9a
    TEST EAX,EAX                        ; 0048bf9d
    JZ 0x0048bf8c                       ; 0048bf9f | LAB_0048bf8c
        ;   XREF to: 0048bf8c (CONDITIONAL_JUMP)
    JMP 0x0048bf26                      ; 0048bfa1 | LAB_0048bf26
        ;   XREF to: 0048bf26 (UNCONDITIONAL_JUMP)
    CMP dword ptr [0x0067939c],0x20     ; 0048bfa3 | int g_BitsPerPixel
        ;   Label: LAB_0048bfa3
    JNZ 0x0048bfcb                      ; 0048bfaa | LAB_0048bfcb
        ;   XREF to: 0048bfcb (CONDITIONAL_JUMP)
    MOV dword ptr [0x02d0257c],0x5b4031 ; 0048bfac | RenderScanlineFunc * g_ScanlineRenderFunc
    XOR EDI,EDI                         ; 0048bfb6
        ;   Label: LAB_0048bfb6
    MOV EBX,0x327                       ; 0048bfb8
    MOV dword ptr [0x02d052a4],EDI      ; 0048bfbd | int g_RenderStateFlag2
    MOV dword ptr [0x02d052a0],EBX      ; 0048bfc3 | int g_RenderStateFlags
    JMP 0x0048bf7b                      ; 0048bfc9 | LAB_0048bf7b
        ;   XREF to: 0048bf7b (UNCONDITIONAL_JUMP)
    MOV dword ptr [0x02d0257c],0x5b4823 ; 0048bfcb | RenderScanlineFunc * g_ScanlineRenderFunc
        ;   Label: LAB_0048bfcb
    JMP 0x0048bfb6                      ; 0048bfd5 | LAB_0048bfb6
