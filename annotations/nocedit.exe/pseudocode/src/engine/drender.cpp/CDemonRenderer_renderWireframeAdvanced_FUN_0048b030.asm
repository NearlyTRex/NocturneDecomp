...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_drender.cpp_CDemonRenderer_renderWireframeAdvanced_FUN_0048b030(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * primitive, int render_flags)
;
; Parameters:
...
section .text
    ...
    JZ 0x0048b101                       ; 0048b073 | LAB_0048b101
        ;   XREF to: 0048b101 (CONDITIONAL_JUMP)
    XOR EBX,EBX                         ; 0048b079
    MOV EDX,0x49072f                    ; 0048b07b
    MOV dword ptr [0x02d052a0],EBX      ; 0048b080 | int g_RenderStateFlags
    MOV dword ptr [0x02d052a4],EBX      ; 0048b086 | int g_RenderStateFlag2
    MOV dword ptr [0x02d0257c],EDX      ; 0048b08c | RenderScanlineFunc * g_ScanlineRenderFunc
    PUSH 0x2c6d5ac                      ; 0048b092 | int[16] g_VertexIndexBuffer
    PUSH 0x3                            ; 0048b097
    PUSH ECX                            ; 0048b099
    CALL engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740 ; 0048b09a | void engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740(CDemonRenderer * this_ptr, int vertex_count, int * vertex_indices)
    ...
    MOV dword ptr [ESP + 0x10],0x2cd    ; 0048b0a5
        ;   Label: LAB_0048b0a5
    JMP 0x0048b040                      ; 0048b0ad | LAB_0048b040
    ...
    PUSH EBP                            ; 0048b0b4
    PUSH ECX                            ; 0048b0b5
    CALL engine_drender.cpp_CDemonRenderer_captureFace_FUN_0048d8a0 ; 0048b0b6 | void engine_drender.cpp_CDemonRenderer_captureFace_FUN_0048d8a0(CDemonRenderer * this_ptr, STrianglePackedIndices * triangle_indices, int render_flags)
    ...
    CMP dword ptr [ECX + 0x20],0x0      ; 0048b0c0
        ;   Label: LAB_0048b0c0
    JNZ 0x0048b04d                      ; 0048b0c4 | LAB_0048b04d
    ...
    JNZ 0x0048b0cd                      ; 0048b0f8 | LAB_0048b0cd
        ;   XREF to: 0048b0cd (CONDITIONAL_JUMP)
    POP ESI                             ; 0048b0fa
    POP EDI                             ; 0048b0fb
    JMP 0x0048b04d                      ; 0048b0fc | LAB_0048b04d
        ;   XREF to: 0048b04d (UNCONDITIONAL_JUMP)
    CMP dword ptr [0x0067939c],0x20     ; 0048b101 | int g_BitsPerPixel
        ;   Label: LAB_0048b101
    JNZ 0x0048b13a                      ; 0048b108 | LAB_0048b13a
        ;   XREF to: 0048b13a (CONDITIONAL_JUMP)
    MOV dword ptr [0x02d0257c],0x5b4031 ; 0048b10a | RenderScanlineFunc * g_ScanlineRenderFunc
    MOV EAX,dword ptr [ESP + 0x14]      ; 0048b114
        ;   Label: LAB_0048b114
    MOV [0x02d052a0],EAX                ; 0048b118 | int g_RenderStateFlags
    MOV dword ptr [0x02d052a4],0x6      ; 0048b11d | int g_RenderStateFlag2
    PUSH 0x2c6d5ac                      ; 0048b127 | int[16] g_VertexIndexBuffer
    PUSH 0x3                            ; 0048b12c
    PUSH ECX                            ; 0048b12e
    CALL engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740 ; 0048b12f | void engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740(CDemonRenderer * this_ptr, int vertex_count, int * vertex_indices)
        ;   XREF to: 0048a740 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0048b134
    POP EBX                             ; 0048b137
    POP EBP                             ; 0048b138
    RET                                 ; 0048b139
    MOV dword ptr [0x02d0257c],0x5b4823 ; 0048b13a | RenderScanlineFunc * g_ScanlineRenderFunc
        ;   Label: LAB_0048b13a
    JMP 0x0048b114                      ; 0048b144 | LAB_0048b114
