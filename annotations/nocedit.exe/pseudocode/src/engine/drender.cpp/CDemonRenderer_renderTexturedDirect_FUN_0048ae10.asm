...
section .text
    ...
    PUSH EBX                            ; 0048ae10
        ;   Label: engine_drender.cpp_CDemonRenderer_renderTexturedDirect_FUN_0048ae10
    PUSH ESI                            ; 0048ae11
    PUSH EDI                            ; 0048ae12
    PUSH EBP                            ; 0048ae13
    ...
    MOV dword ptr [0x02d052a4],EBP      ; 0048ae43 | g_VertexPreprocessMode
    ...
    MOV dword ptr [0x02d052a4],ECX      ; 0048ae95 | g_VertexPreprocessMode
