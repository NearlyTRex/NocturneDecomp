...
// Convention: __cdecl
// Signature: int __cdecl engine_drender_cpp_renderTriangleSimple_FUN_004839f0(CVector3i *vertex_indices,int vertex_count)
...

{
  ...
  if ((g_CullingMode != 0) &&
     (iVar4 = engine_prim_c_calculateTriangleWindingOrder_FUN_00552150
                        (g_RenderVertexBuffer + vertex_indices->x,
                         ...
                         g_RenderVertexBuffer + vertex_indices->z), iVar4 == 0)) {
    return 0;
  }
  ...
  if ((g_UseExternalRenderer == 0) || (g_TexturesDisabled != 0)) {
        ...
        if (0 < vertex_count) {
          do {
            ...
            pCVar9 = (CVector3i *)&pCVar9->y;
              ...
              (iVar4 = 0, pCVar9 = vertex_indices, 0 < vertex_count)) {
        do {
          iVar4 = iVar4 + 1;
    ...
    if (0 < vertex_count) {
      ...
      iVar4 = g_RenderTriangleEdgeCount;
      do {
        iVar10 = local_2c + 1;
        ...
        g_RenderTriangleEdgeCount = iVar4;
        local_28 = local_20;
        if (iVar5 != iVar8) {
          iVar6 = iVar5;
          pSVar11 = local_24;
          ...
          g_EdgeInterpolationArray[iVar4].y_start = iVar6;
          iVar10 = g_RenderTriangleMinScanlineY;
          g_EdgeInterpolationArray[iVar4].y_end = iVar8;
          if (iVar6 < iVar10) {
...
LAB_00483cc8:
    ...
    if (0 < vertex_count) {
      ...
      do {
        ...
        local_74[iVar4] = g_RenderVertexBuffer + *piVar3;
        iVar4 = iVar10;
