...
section .text
    ...
    FLD double ptr [0x00622055]         ; 0048c6e8 | double g_LightDirectionalScale
    ...
    FMULP ST3                           ; 0048c6fa
    FXCH                                ; 0048c6fc
    CALL crt_math.c_round_FUN_005fe6b0  ; 0048c6fe | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH                                ; 0048c703
    CALL crt_math.c_round_FUN_005fe6b0  ; 0048c705 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH                                ; 0048c70a
    ...
    PUSH EDX                            ; 0048c71a
    CALL crt_math.c_round_FUN_005fe6b0  ; 0048c71b | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    PUSH ECX                            ; 0048c720
    FISTP dword ptr [ESP + 0xc]         ; 0048c721
    MOV EBX,dword ptr [ESP + 0xc]       ; 0048c725
    PUSH EBX                            ; 0048c729
    CALL engine_light.cpp_setDirectionalLightVector_FUN_005054d0 ; 0048c72a | void engine_light.cpp_setDirectionalLightVector_FUN_005054d0(int dir_x, int dir_y, int dir_z)
