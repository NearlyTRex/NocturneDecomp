...
section .text
    ...
    PUSH EBX                            ; 0048b730
        ;   Label: engine_drender.cpp_CDemonRenderer_renderFullEffectsPoly_FUN_0048b730
    PUSH ESI                            ; 0048b731
    PUSH EDI                            ; 0048b732
    PUSH EBP                            ; 0048b733
    ...
    MOV dword ptr [0x02d052a4],EDI      ; 0048b7b5 | g_VertexPreprocessMode
    ...
    MOV dword ptr [0x02d052a4],EBP      ; 0048b827 | g_VertexPreprocessMode
