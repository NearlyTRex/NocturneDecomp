...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_drender.cpp_CDemonRenderer_renderTexturedLitNearPlane_FUN_0048ac40(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * polygon_info)
;
; Parameters:
...
section .text
    ...
    JNZ 0x0048ad01                      ; 0048ac4f | LAB_0048ad01
    ...
    JLE 0x0048aca0                      ; 0048ac68 | LAB_0048aca0
        ;   XREF to: 0048aca0 (CONDITIONAL_JUMP)
    XOR EDX,EDX                         ; 0048ac6a
    MOV ESI,dword ptr [EAX + 0x18]      ; 0048ac6c
        ;   Label: LAB_0048ac6c
    MOV dword ptr [EDX + 0x2c6d5ac],ESI ; 0048ac6f | int[16] g_VertexIndexBuffer
    ...
    CMP dword ptr [EBX + 0x4],0x0       ; 0048acc0
        ;   Label: LAB_0048acc0
    JZ 0x0048ad61                       ; 0048acc4 | LAB_0048ad61
        ;   XREF to: 0048ad61 (CONDITIONAL_JUMP)
    XOR EDI,EDI                         ; 0048acca
    MOV ESI,0x49072f                    ; 0048accc
    MOV dword ptr [0x02d052a0],EDI      ; 0048acd1 | int g_RenderStateFlags
    MOV dword ptr [0x02d052a4],EDI      ; 0048acd7 | int g_RenderStateFlag2
    MOV dword ptr [0x02d0257c],ESI      ; 0048acdd | RenderScanlineFunc * g_ScanlineRenderFunc
    MOV EAX,dword ptr [ESP + 0x1c]      ; 0048ace3
        ;   Label: LAB_0048ace3
    PUSH 0x2c6d5ac                      ; 0048ace7 | int[16] g_VertexIndexBuffer
    MOV EDX,dword ptr [EAX + 0x4]       ; 0048acec
    PUSH EDX                            ; 0048acef
    PUSH EBX                            ; 0048acf0
    CALL engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740 ; 0048acf1 | void engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740(CDemonRenderer * this_ptr, int vertex_count, int * vertex_indices)
    ...
    PUSH EAX                            ; 0048ad08
    CALL engine_3d.c_isVisiblePlane_FUN_00403950 ; 0048ad09 | int engine_3d.c_isVisiblePlane_FUN_00403950(SClipPlane * plane)
        ;   XREF to: 00403950 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0048ad0e
    TEST EAX,EAX                        ; 0048ad11
    JZ 0x0048acf9                       ; 0048ad13 | LAB_0048acf9
        ;   XREF to: 0048acf9 (CONDITIONAL_JUMP)
    JMP 0x0048ac55                      ; 0048ad15 | LAB_0048ac55
        ;   XREF to: 0048ac55 (UNCONDITIONAL_JUMP)
    MOV EDX,dword ptr [EBX + 0x20]      ; 0048ad1a
        ;   Label: LAB_0048ad1a
    TEST EDX,EDX                        ; 0048ad1d
    JNZ 0x0048acc0                      ; 0048ad1f | LAB_0048acc0
    ...
    JLE 0x0048acc0                      ; 0048ad2c | LAB_0048acc0
        ;   XREF to: 0048acc0 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [EDX + 0x2c6d5ac] ; 0048ad2e | int[16] g_VertexIndexBuffer
        ;   Label: LAB_0048ad2e
    ...
    JL 0x0048ad2e                       ; 0048ad5a | LAB_0048ad2e
        ;   XREF to: 0048ad2e (CONDITIONAL_JUMP)
    JMP 0x0048acc0                      ; 0048ad5c | LAB_0048acc0
        ;   XREF to: 0048acc0 (UNCONDITIONAL_JUMP)
    MOV EDX,0xc1                        ; 0048ad61
        ;   Label: LAB_0048ad61
    MOV ECX,0x3                         ; 0048ad66
    MOV EAX,0x490ec0                    ; 0048ad6b
    MOV dword ptr [0x02d052a0],EDX      ; 0048ad70 | int g_RenderStateFlags
    MOV dword ptr [0x02d052a4],ECX      ; 0048ad76 | int g_RenderStateFlag2
    MOV [0x02d0257c],EAX                ; 0048ad7c | RenderScanlineFunc * g_ScanlineRenderFunc
    JMP 0x0048ace3                      ; 0048ad81 | LAB_0048ace3
