...
section .text
    ...
    PUSH EBX                            ; 0048ac40
        ;   Label: engine_drender.cpp_CDemonRenderer_renderNearPlaneTexturedPoly_FUN_0048ac40
    PUSH ESI                            ; 0048ac41
    PUSH EDI                            ; 0048ac42
    PUSH EBP                            ; 0048ac43
    ...
    MOV dword ptr [0x02d052a4],EDI      ; 0048acd7 | g_VertexPreprocessMode
    ...
    MOV dword ptr [0x02d052a4],ECX      ; 0048ad76 | g_VertexPreprocessMode
