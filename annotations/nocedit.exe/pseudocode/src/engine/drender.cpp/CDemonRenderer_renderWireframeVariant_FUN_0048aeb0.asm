...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_drender.cpp_CDemonRenderer_renderWireframeVariant_FUN_0048aeb0(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * polygon_info, int render_flags)
;
; Parameters:
...
section .text
    ...
    JLE 0x0048af10                      ; 0048aeef | LAB_0048af10
        ;   XREF to: 0048af10 (CONDITIONAL_JUMP)
    XOR EDX,EDX                         ; 0048aef1
    MOV ESI,dword ptr [EAX + 0x18]      ; 0048aef3
        ;   Label: LAB_0048aef3
    MOV dword ptr [EDX + 0x2c6d5ac],ESI ; 0048aef6 | int[16] g_VertexIndexBuffer
    ...
    JL 0x0048aef3                       ; 0048af0c | LAB_0048aef3
        ;   XREF to: 0048aef3 (CONDITIONAL_JUMP)
    MOV EAX,EAX                         ; 0048af0e
    CMP dword ptr [EBX + 0x4],0x0       ; 0048af10
        ;   Label: LAB_0048af10
    JZ 0x0048afea                       ; 0048af14 | LAB_0048afea
        ;   XREF to: 0048afea (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 0048af1a
    MOV EBP,0x49072f                    ; 0048af1c
    MOV [0x02d052a0],EAX                ; 0048af21 | int g_RenderStateFlags
    MOV [0x02d052a4],EAX                ; 0048af26 | int g_RenderStateFlag2
    MOV dword ptr [0x02d0257c],EBP      ; 0048af2b | RenderScanlineFunc * g_ScanlineRenderFunc
    MOV EAX,dword ptr [ESP + 0x1c]      ; 0048af31
        ;   Label: LAB_0048af31
    PUSH 0x2c6d5ac                      ; 0048af35 | int[16] g_VertexIndexBuffer
    MOV ECX,dword ptr [EAX + 0x4]       ; 0048af3a
    PUSH ECX                            ; 0048af3d
    PUSH EBX                            ; 0048af3e
    CALL engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740 ; 0048af3f | void engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740(CDemonRenderer * this_ptr, int vertex_count, int * vertex_indices)
    ...
    MOV dword ptr [ESP + 0x1c],0x2cd    ; 0048af4f
        ;   Label: LAB_0048af4f
    JMP 0x0048aec5                      ; 0048af57 | LAB_0048aec5
    ...
    PUSH EBP                            ; 0048af65
    PUSH EBX                            ; 0048af66
    CALL engine_drender.cpp_CDemonRenderer_processQuadPrimitive_FUN_0048d7a0 ; 0048af67 | void engine_drender.cpp_CDemonRenderer_processQuadPrimitive_FUN_0048d7a0(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * quad_primitive, int render_flags)
    ...
    PUSH EAX                            ; 0048af7d
    CALL engine_3d.c_isVisiblePlane_FUN_00403950 ; 0048af7e | int engine_3d.c_isVisiblePlane_FUN_00403950(SClipPlane * plane)
        ;   XREF to: 00403950 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0048af83
    TEST EAX,EAX                        ; 0048af86
    JZ 0x0048af48                       ; 0048af88 | LAB_0048af48
        ;   XREF to: 0048af48 (CONDITIONAL_JUMP)
    JMP 0x0048aed9                      ; 0048af8a | LAB_0048aed9
    ...
    JLE 0x0048af10                      ; 0048af9a | LAB_0048af10
        ;   XREF to: 0048af10 (CONDITIONAL_JUMP)
    ...
    JZ 0x0048afd2                       ; 0048afae | LAB_0048afd2
        ;   XREF to: 0048afd2 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [ESP + 0x4]       ; 0048afb0
        ;   Label: LAB_0048afb0
    MOV dword ptr [EDX + 0x2c6d5ac],ESI ; 0048afb4 | int[16] g_VertexIndexBuffer
    ...
    JGE 0x0048af10                      ; 0048afca | LAB_0048af10
        ;   XREF to: 0048af10 (CONDITIONAL_JUMP)
    JMP 0x0048afa2                      ; 0048afd0 | LAB_0048afa2
    ...
    JMP 0x0048afb0                      ; 0048afe8 | LAB_0048afb0
        ;   XREF to: 0048afb0 (UNCONDITIONAL_JUMP)
    CMP dword ptr [0x0067939c],0x20     ; 0048afea | int g_BitsPerPixel
        ;   Label: LAB_0048afea
    JNZ 0x0048b016                      ; 0048aff1 | LAB_0048b016
        ;   XREF to: 0048b016 (CONDITIONAL_JUMP)
    MOV dword ptr [0x02d0257c],0x5b4031 ; 0048aff3 | RenderScanlineFunc * g_ScanlineRenderFunc
    MOV EDI,0x6                         ; 0048affd
        ;   Label: LAB_0048affd
    MOV EAX,dword ptr [ESP + 0x20]      ; 0048b002
    MOV dword ptr [0x02d052a4],EDI      ; 0048b006 | int g_RenderStateFlag2
    MOV [0x02d052a0],EAX                ; 0048b00c | int g_RenderStateFlags
    JMP 0x0048af31                      ; 0048b011 | LAB_0048af31
        ;   XREF to: 0048af31 (UNCONDITIONAL_JUMP)
    MOV dword ptr [0x02d0257c],0x5b4823 ; 0048b016 | RenderScanlineFunc * g_ScanlineRenderFunc
        ;   Label: LAB_0048b016
    JMP 0x0048affd                      ; 0048b020 | LAB_0048affd
