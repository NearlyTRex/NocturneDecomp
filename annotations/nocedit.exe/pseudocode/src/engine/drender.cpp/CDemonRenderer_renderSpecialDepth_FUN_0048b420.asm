...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_drender.cpp_CDemonRenderer_renderSpecialDepth_FUN_0048b420(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * polygon_info)
;
; Parameters:
...
section .text
    ...
    JNZ 0x0048b4b1                      ; 0048b42d | LAB_0048b4b1
    ...
    JZ 0x0048b4ca                       ; 0048b43a | LAB_0048b4ca
    ...
    JLE 0x0048b470                      ; 0048b44b | LAB_0048b470
    ...
    MOV ESI,dword ptr [ECX + 0x18]      ; 0048b453
        ;   Label: LAB_0048b453
    MOV dword ptr [EDX + 0x2c6d5ac],ESI ; 0048b456 | int[16] g_VertexIndexBuffer
    ...
    JL 0x0048b453                       ; 0048b46c | LAB_0048b453
        ;   XREF to: 0048b453 (CONDITIONAL_JUMP)
    MOV EAX,EAX                         ; 0048b46e
    CMP dword ptr [EBX + 0x4],0x0       ; 0048b470
        ;   Label: LAB_0048b470
    JZ 0x0048b523                       ; 0048b474 | LAB_0048b523
        ;   XREF to: 0048b523 (CONDITIONAL_JUMP)
    XOR EBP,EBP                         ; 0048b47a
    MOV EDI,0x49072f                    ; 0048b47c
    MOV dword ptr [0x02d052a0],EBP      ; 0048b481 | int g_RenderStateFlags
    MOV dword ptr [0x02d052a4],EBP      ; 0048b487 | int g_RenderStateFlag2
    MOV dword ptr [0x02d0257c],EDI      ; 0048b48d | RenderScanlineFunc * g_ScanlineRenderFunc
    MOV EAX,dword ptr [ESP + 0x1c]      ; 0048b493
        ;   Label: LAB_0048b493
    PUSH 0x2c6d5ac                      ; 0048b497 | int[16] g_VertexIndexBuffer
    MOV EDX,dword ptr [EAX + 0x4]       ; 0048b49c
    PUSH EDX                            ; 0048b49f
    PUSH EBX                            ; 0048b4a0
    CALL engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740 ; 0048b4a1 | void engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740(CDemonRenderer * this_ptr, int vertex_count, int * vertex_indices)
    ...
    PUSH EAX                            ; 0048b4b8
    CALL engine_3d.c_isVisiblePlane_FUN_00403950 ; 0048b4b9 | int engine_3d.c_isVisiblePlane_FUN_00403950(SClipPlane * plane)
        ;   XREF to: 00403950 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0048b4be
    TEST EAX,EAX                        ; 0048b4c1
    JZ 0x0048b4ab                       ; 0048b4c3 | LAB_0048b4ab
        ;   XREF to: 0048b4ab (CONDITIONAL_JUMP)
    JMP 0x0048b433                      ; 0048b4c5 | LAB_0048b433
        ;   XREF to: 0048b433 (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x1c]      ; 0048b4ca
        ;   Label: LAB_0048b4ca
    CMP dword ptr [EAX + 0x4],0x0       ; 0048b4ce
    JLE 0x0048b470                      ; 0048b4d2 | LAB_0048b470
        ;   XREF to: 0048b470 (CONDITIONAL_JUMP)
    ...
    JZ 0x0048b4fe                       ; 0048b4de | LAB_0048b4fe
        ;   XREF to: 0048b4fe (CONDITIONAL_JUMP)
    MOV dword ptr [EDX + 0x2c6d5ac],ESI ; 0048b4e0 | int[16] g_VertexIndexBuffer
        ;   Label: LAB_0048b4e0
    ...
    JGE 0x0048b470                      ; 0048b4f6 | LAB_0048b470
        ;   XREF to: 0048b470 (CONDITIONAL_JUMP)
    JMP 0x0048b4d6                      ; 0048b4fc | LAB_0048b4d6
    ...
    JMP 0x0048b4e0                      ; 0048b521 | LAB_0048b4e0
        ;   XREF to: 0048b4e0 (UNCONDITIONAL_JUMP)
    MOV ECX,0x41                        ; 0048b523
        ;   Label: LAB_0048b523
    MOV ESI,0x6                         ; 0048b528
    MOV EDX,0x49169d                    ; 0048b52d
    MOV dword ptr [0x02d052a0],ECX      ; 0048b532 | int g_RenderStateFlags
    MOV dword ptr [0x02d052a4],ESI      ; 0048b538 | int g_RenderStateFlag2
    MOV dword ptr [0x02d0257c],EDX      ; 0048b53e | RenderScanlineFunc * g_ScanlineRenderFunc
    JMP 0x0048b493                      ; 0048b544 | LAB_0048b493
