...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_drender.cpp_CDemonRenderer_renderPremiumVariant_FUN_0048b320(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * polygon_info)
;
; Parameters:
...
section .text
    ...
    JZ 0x0048b3ae                       ; 0048b330 | LAB_0048b3ae
    ...
    MOV [0x02c6d5ac],EAX                ; 0048b346 | int[16] g_VertexIndexBuffer
    ...
    JNZ 0x0048b3eb                      ; 0048b366 | LAB_0048b3eb
        ;   XREF to: 0048b3eb (CONDITIONAL_JUMP)
    CMP dword ptr [0x0067939c],0x20     ; 0048b36c | int g_BitsPerPixel
    JNZ 0x0048b406                      ; 0048b373 | LAB_0048b406
        ;   XREF to: 0048b406 (CONDITIONAL_JUMP)
    MOV dword ptr [0x02d0257c],0x5b4031 ; 0048b379 | RenderScanlineFunc * g_ScanlineRenderFunc
    MOV EBX,0x6                         ; 0048b383
        ;   Label: LAB_0048b383
    MOV EDX,0x2cd                       ; 0048b388
    MOV dword ptr [0x02d052a4],EBX      ; 0048b38d | int g_RenderStateFlag2
    MOV dword ptr [0x02d052a0],EDX      ; 0048b393 | int g_RenderStateFlags
    PUSH 0x2c6d5ac                      ; 0048b399 | int[16] g_VertexIndexBuffer
        ;   Label: LAB_0048b399
    PUSH 0x3                            ; 0048b39e
    PUSH ECX                            ; 0048b3a0
    CALL engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740 ; 0048b3a1 | void engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740(CDemonRenderer * this_ptr, int vertex_count, int * vertex_indices)
    ...
    CMP dword ptr [ECX + 0x20],0x0      ; 0048b3ae
        ;   Label: LAB_0048b3ae
    JNZ 0x0048b340                      ; 0048b3b2 | LAB_0048b340
    ...
    JNZ 0x0048b3b9                      ; 0048b3e4 | LAB_0048b3b9
        ;   XREF to: 0048b3b9 (CONDITIONAL_JUMP)
    JMP 0x0048b340                      ; 0048b3e6 | LAB_0048b340
        ;   XREF to: 0048b340 (UNCONDITIONAL_JUMP)
    XOR EDI,EDI                         ; 0048b3eb
        ;   Label: LAB_0048b3eb
    MOV ESI,0x49072f                    ; 0048b3ed
    MOV dword ptr [0x02d052a0],EDI      ; 0048b3f2 | int g_RenderStateFlags
    MOV dword ptr [0x02d052a4],EDI      ; 0048b3f8 | int g_RenderStateFlag2
    MOV dword ptr [0x02d0257c],ESI      ; 0048b3fe | RenderScanlineFunc * g_ScanlineRenderFunc
    JMP 0x0048b399                      ; 0048b404 | LAB_0048b399
        ;   XREF to: 0048b399 (UNCONDITIONAL_JUMP)
    MOV dword ptr [0x02d0257c],0x5b4823 ; 0048b406 | RenderScanlineFunc * g_ScanlineRenderFunc
        ;   Label: LAB_0048b406
    JMP 0x0048b383                      ; 0048b410 | LAB_0048b383
