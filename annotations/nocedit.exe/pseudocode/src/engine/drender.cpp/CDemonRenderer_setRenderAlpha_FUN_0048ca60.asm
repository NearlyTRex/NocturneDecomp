...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_drender.cpp_CDemonRenderer_setRenderAlpha_FUN_0048ca60(CDemonRenderer * this_ptr, int render_alpha)
;
; Parameters:
...
;   core_boxactor.cpp_CBoxActor_FUN_00421ef0 at 00421f6e
;   core_bugs.cpp_FUN_004251b0 at 004252c3
;   core_chain.cpp_FUN_004308f0 at 004309d7
