...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_drender.cpp_CDemonRenderer_renderAlternativeDepth_FUN_0048a950(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * polygon_info)
;
; Parameters:
...
section .text
    ...
    JNZ 0x0048aa12                      ; 0048a963 | LAB_0048aa12
    ...
    JZ 0x0048a9a8                       ; 0048a99f | LAB_0048a9a8
    ...
    JL 0x0048a984                       ; 0048a9b4 | LAB_0048a984
        ;   XREF to: 0048a984 (CONDITIONAL_JUMP)
    TEST byte ptr [ESP + 0x7],0x80      ; 0048a9b6
        ;   Label: LAB_0048a9b6
    JZ 0x0048a9c4                       ; 0048a9bb | LAB_0048a9c4
        ;   XREF to: 0048a9c4 (CONDITIONAL_JUMP)
    TEST byte ptr [ESP + 0x4],0x1f      ; 0048a9bd
    JNZ 0x0048aa0a                      ; 0048a9c2 | LAB_0048aa0a
        ;   XREF to: 0048aa0a (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [EDI + 0x10]      ; 0048a9c4
        ;   Label: LAB_0048a9c4
    TEST EBX,EBX                        ; 0048a9c7
    JZ 0x0048a9d7                       ; 0048a9c9 | LAB_0048a9d7
        ;   XREF to: 0048a9d7 (CONDITIONAL_JUMP)
    CMP dword ptr [EDI + 0x4],0x0       ; 0048a9cb
    JZ 0x0048a9d7                       ; 0048a9cf | LAB_0048a9d7
        ;   XREF to: 0048a9d7 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP]             ; 0048a9d1
    MOV dword ptr [EDI + 0x10],EAX      ; 0048a9d4
    CMP dword ptr [EDI + 0x4],0x0       ; 0048a9d7
        ;   Label: LAB_0048a9d7
    JZ 0x0048aa27                       ; 0048a9db | LAB_0048aa27
        ;   XREF to: 0048aa27 (CONDITIONAL_JUMP)
    XOR EDX,EDX                         ; 0048a9dd
    MOV EAX,0x49077d                    ; 0048a9df
    MOV dword ptr [0x02d052a0],EDX      ; 0048a9e4 | int g_RenderStateFlags
    MOV dword ptr [0x02d052a4],EDX      ; 0048a9ea | int g_RenderStateFlag2
    MOV [0x02d0257c],EAX                ; 0048a9f0 | RenderScanlineFunc * g_ScanlineRenderFunc
    PUSH 0x2c6d5ac                      ; 0048a9f5 | int[16] g_VertexIndexBuffer
        ;   Label: LAB_0048a9f5
    MOV ESI,dword ptr [EBP + 0x4]       ; 0048a9fa
    PUSH ESI                            ; 0048a9fd
    PUSH EDI                            ; 0048a9fe
    CALL engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740 ; 0048a9ff | void engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740(CDemonRenderer * this_ptr, int vertex_count, int * vertex_indices)
    ...
    LEA EAX,[EBP + 0x8]                 ; 0048aa12
        ;   Label: LAB_0048aa12
    PUSH EAX                            ; 0048aa15
    CALL engine_3d.c_isVisiblePlane_FUN_00403950 ; 0048aa16 | int engine_3d.c_isVisiblePlane_FUN_00403950(SClipPlane * plane)
        ;   XREF to: 00403950 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0048aa1b
    TEST EAX,EAX                        ; 0048aa1e
    JZ 0x0048aa0a                       ; 0048aa20 | LAB_0048aa0a
        ;   XREF to: 0048aa0a (CONDITIONAL_JUMP)
    JMP 0x0048a969                      ; 0048aa22 | LAB_0048a969
        ;   XREF to: 0048a969 (UNCONDITIONAL_JUMP)
    MOV ECX,0x90                        ; 0048aa27
        ;   Label: LAB_0048aa27
    MOV ESI,0x6                         ; 0048aa2c
    MOV EDX,0x490902                    ; 0048aa31
    MOV dword ptr [0x02d052a0],ECX      ; 0048aa36 | int g_RenderStateFlags
    MOV dword ptr [0x02d052a4],ESI      ; 0048aa3c | int g_RenderStateFlag2
    MOV dword ptr [0x02d0257c],EDX      ; 0048aa42 | RenderScanlineFunc * g_ScanlineRenderFunc
    JMP 0x0048a9f5                      ; 0048aa48 | LAB_0048a9f5
