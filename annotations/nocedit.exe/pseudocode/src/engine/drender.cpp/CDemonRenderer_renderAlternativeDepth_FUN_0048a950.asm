...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl engine_drender_cpp_CDemonRenderer_renderAlternativeDepth_FUN_0048a950 (CDemonRenderer *this_ptr,SMRGLHeaderPrimitive *polygon_info)
;
; Parameters:
...
section .text
    ...
    MOV dword ptr [0x02d052a4],EDX      ; 0048a9ea | g_RenderStateFlag2
    ...
    MOV dword ptr [0x02d052a4],ESI      ; 0048aa3c | g_RenderStateFlag2
