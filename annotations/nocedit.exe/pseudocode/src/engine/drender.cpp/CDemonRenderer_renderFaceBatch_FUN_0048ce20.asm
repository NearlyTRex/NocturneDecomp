...
;                               FUNCTION
; *****************************************************************************
; __cdecl int engine_drender.cpp_CDemonRenderer_renderFaceBatch_FUN_0048ce20(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * primitive_array, int primitive_count, int render_flags)
;
; Parameters:
...
section .text
    ...
    JNZ 0x0048ce3a                      ; 0048ce33 | LAB_0048ce3a
    ...
    PUSH EAX                            ; 0048ce50
    INC EBX                             ; 0048ce51
    CALL engine_drender.cpp_CDemonRenderer_processVisiblePrimitive_FUN_0048d700 ; 0048ce52 | void engine_drender.cpp_CDemonRenderer_processVisiblePrimitive_FUN_0048d700(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * primitive, int render_flags)
        ;   XREF to: 0048d700 (UNCONDITIONAL_CALL)
    ADD ESI,0x3c                        ; 0048ce57
    ADD ESP,0xc                         ; 0048ce5a
    CMP EBX,EBP                         ; 0048ce5d
    JL 0x0048ce4a                       ; 0048ce5f | LAB_0048ce4a
    ...
    PUSH ESI                            ; 0048ce79
    PUSH EBX                            ; 0048ce7a
    CALL engine_drender.cpp_CDemonRenderer_renderTriangleFacetList_FUN_0048cf00 ; 0048ce7b | int engine_drender.cpp_CDemonRenderer_renderTriangleFacetList_FUN_0048cf00(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * primitive_array, int primitive_count, int render_flags, ...)
