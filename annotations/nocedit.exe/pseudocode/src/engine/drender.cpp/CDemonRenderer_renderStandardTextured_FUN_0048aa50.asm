...
;                               FUNCTION
; *****************************************************************************
; __cdecl int engine_drender.cpp_CDemonRenderer_renderStandardTextured_FUN_0048aa50(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * polygon_info)
;
; Parameters:
...
section .text
    ...
    MOV dword ptr [0x02c6d5a4],EDX      ; 0048aa64 | int g_RenderPixelCounter
    TEST ECX,ECX                        ; 0048aa6a
    JNZ 0x0048ab05                      ; 0048aa6c | LAB_0048ab05
    ...
    JL 0x0048aa87                       ; 0048aaae | LAB_0048aa87
        ;   XREF to: 0048aa87 (CONDITIONAL_JUMP)
    TEST byte ptr [ESP + 0x3],0x80      ; 0048aab0
        ;   Label: LAB_0048aab0
    JZ 0x0048aabd                       ; 0048aab5 | LAB_0048aabd
        ;   XREF to: 0048aabd (CONDITIONAL_JUMP)
    TEST byte ptr [ESP],0x1f            ; 0048aab7
    JNZ 0x0048ab1b                      ; 0048aabb | LAB_0048ab1b
        ;   XREF to: 0048ab1b (CONDITIONAL_JUMP)
    CMP dword ptr [EBP + 0x4],0x0       ; 0048aabd
        ;   Label: LAB_0048aabd
    JZ 0x0048ab1f                       ; 0048aac1 | LAB_0048ab1f
        ;   XREF to: 0048ab1f (CONDITIONAL_JUMP)
    MOV EBX,0x621fae                    ; 0048aac3 | = "..\\engine\\drender.cpp" | s_engine_drender_cpp_00621fae = ..\engine\drender.cpp
    MOV ESI,0x29d                       ; 0048aac8
    PUSH 0x621fc4                       ; 0048aacd | = "Can't use demonZFacetCount in shadow ..." | s_Can_t_use_demonZFacetCou_00621fc4 = Can't use demonZFacetCount in shadow mode!
    MOV dword ptr [0x02f0ca48],EBX      ; 0048aad2 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 0048aad8 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0048aade | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0048aae3
    PUSH 0x2c6d5ac                      ; 0048aae6 | int[16] g_VertexIndexBuffer
        ;   Label: LAB_0048aae6
    MOV EAX,dword ptr [EDI + 0x4]       ; 0048aaeb
    PUSH EAX                            ; 0048aaee
    PUSH EBP                            ; 0048aaef
    CALL engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740 ; 0048aaf0 | void engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740(CDemonRenderer * this_ptr, int vertex_count, int * vertex_indices)
        ;   XREF to: 0048a740 (UNCONDITIONAL_CALL)
    MOV EAX,[0x02c6d5a4]                ; 0048aaf5 | int g_RenderPixelCounter
    ...
    LEA EAX,[EDI + 0x8]                 ; 0048ab05
        ;   Label: LAB_0048ab05
    PUSH EAX                            ; 0048ab08
    CALL engine_3d.c_isVisiblePlane_FUN_00403950 ; 0048ab09 | int engine_3d.c_isVisiblePlane_FUN_00403950(SClipPlane * plane)
        ;   XREF to: 00403950 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0048ab0e
    TEST EAX,EAX                        ; 0048ab11
    JNZ 0x0048aa72                      ; 0048ab13 | LAB_0048aa72
        ;   XREF to: 0048aa72 (CONDITIONAL_JUMP)
    JMP 0x0048aafd                      ; 0048ab19 | LAB_0048aafd
        ;   XREF to: 0048aafd (UNCONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 0048ab1b
        ;   Label: LAB_0048ab1b
    JMP 0x0048aafd                      ; 0048ab1d | LAB_0048aafd
        ;   XREF to: 0048aafd (UNCONDITIONAL_JUMP)
    MOV EDX,0xc0                        ; 0048ab1f
        ;   Label: LAB_0048ab1f
    MOV ECX,0x6                         ; 0048ab24
    MOV EAX,0x490d35                    ; 0048ab29
    MOV dword ptr [0x02d052a0],EDX      ; 0048ab2e | int g_RenderStateFlags
    MOV dword ptr [0x02d052a4],ECX      ; 0048ab34 | int g_RenderStateFlag2
    MOV [0x02d0257c],EAX                ; 0048ab3a | RenderScanlineFunc * g_ScanlineRenderFunc
    JMP 0x0048aae6                      ; 0048ab3f | LAB_0048aae6
