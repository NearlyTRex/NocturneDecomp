...
section .text
    ...
    PUSH EBX                            ; 0048b1e0
        ;   Label: engine_drender.cpp_CDemonRenderer_renderAlphaBlendedPoly_FUN_0048b1e0
    PUSH EBP                            ; 0048b1e1
    ...
    MOV dword ptr [0x02d052a4],EDX      ; 0048b247 | g_VertexPreprocessMode
    ...
    MOV dword ptr [0x02d052a4],EBP      ; 0048b2ff | g_VertexPreprocessMode
