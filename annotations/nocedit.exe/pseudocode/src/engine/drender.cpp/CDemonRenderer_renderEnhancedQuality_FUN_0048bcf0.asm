...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_drender.cpp_CDemonRenderer_renderEnhancedQuality_FUN_0048bcf0(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * polygon_info)
;
; Parameters:
...
;
; XREF[13]:
;   core_chain.cpp_FUN_004308f0 at 00430e92
...
section .text
    ...
    JNZ 0x0048bd71                      ; 0048bd00 | LAB_0048bd71
    ...
    JLE 0x0048bd30                      ; 0048bd12 | LAB_0048bd30
    ...
    JL 0x0048bd19                       ; 0048bd2c | LAB_0048bd19
        ;   XREF to: 0048bd19 (CONDITIONAL_JUMP)
    MOV EAX,EAX                         ; 0048bd2e
    TEST ECX,0x80000000                 ; 0048bd30
        ;   Label: LAB_0048bd30
    JZ 0x0048bd3d                       ; 0048bd36 | LAB_0048bd3d
        ;   XREF to: 0048bd3d (CONDITIONAL_JUMP)
    TEST CL,0x1f                        ; 0048bd38
    JNZ 0x0048bd6c                      ; 0048bd3b | LAB_0048bd6c
        ;   XREF to: 0048bd6c (CONDITIONAL_JUMP)
    CMP dword ptr [EBP + 0x4],0x0       ; 0048bd3d
        ;   Label: LAB_0048bd3d
    JZ 0x0048bd83                       ; 0048bd41 | LAB_0048bd83
        ;   XREF to: 0048bd83 (CONDITIONAL_JUMP)
    XOR EDX,EDX                         ; 0048bd43
    MOV EAX,0x49072f                    ; 0048bd45
    MOV dword ptr [0x02d052a0],EDX      ; 0048bd4a | int g_RenderStateFlags
    MOV dword ptr [0x02d052a4],EDX      ; 0048bd50 | int g_RenderStateFlag2
    MOV [0x02d0257c],EAX                ; 0048bd56 | RenderScanlineFunc * g_ScanlineRenderFunc
    ...
    PUSH EBX                            ; 0048bd62
    PUSH EBP                            ; 0048bd63
    CALL engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740 ; 0048bd64 | void engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740(CDemonRenderer * this_ptr, int vertex_count, int * vertex_indices)
    ...
    LEA EAX,[ESI + 0x8]                 ; 0048bd71
        ;   Label: LAB_0048bd71
    PUSH EAX                            ; 0048bd74
    CALL engine_3d.c_isVisiblePlane_FUN_00403950 ; 0048bd75 | int engine_3d.c_isVisiblePlane_FUN_00403950(SClipPlane * plane)
        ;   XREF to: 00403950 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0048bd7a
    TEST EAX,EAX                        ; 0048bd7d
    JZ 0x0048bd6c                       ; 0048bd7f | LAB_0048bd6c
        ;   XREF to: 0048bd6c (CONDITIONAL_JUMP)
    JMP 0x0048bd06                      ; 0048bd81 | LAB_0048bd06
        ;   XREF to: 0048bd06 (UNCONDITIONAL_JUMP)
    CMP dword ptr [0x0067939c],0x20     ; 0048bd83 | int g_BitsPerPixel
        ;   Label: LAB_0048bd83
    JNZ 0x0048bdae                      ; 0048bd8a | LAB_0048bdae
        ;   XREF to: 0048bdae (CONDITIONAL_JUMP)
    MOV dword ptr [0x02d0257c],0x5b4031 ; 0048bd8c | RenderScanlineFunc * g_ScanlineRenderFunc
    MOV EDI,0x6                         ; 0048bd96
        ;   Label: LAB_0048bd96
    MOV EBX,0x267                       ; 0048bd9b
    MOV dword ptr [0x02d052a4],EDI      ; 0048bda0 | int g_RenderStateFlag2
    MOV dword ptr [0x02d052a0],EBX      ; 0048bda6 | int g_RenderStateFlags
    JMP 0x0048bd5b                      ; 0048bdac | LAB_0048bd5b
        ;   XREF to: 0048bd5b (UNCONDITIONAL_JUMP)
    MOV dword ptr [0x02d0257c],0x5b4823 ; 0048bdae | RenderScanlineFunc * g_ScanlineRenderFunc
        ;   Label: LAB_0048bdae
    JMP 0x0048bd96                      ; 0048bdb8 | LAB_0048bd96
