...
section .text
    ...
    PUSH EBX                            ; 0048bf10
        ;   Label: engine_drender.cpp_CDemonRenderer_renderOverlayDirect_FUN_0048bf10
    PUSH ESI                            ; 0048bf11
    PUSH EDI                            ; 0048bf12
    PUSH EBP                            ; 0048bf13
    ...
    MOV dword ptr [0x02d052a4],EDX      ; 0048bf70 | g_VertexPreprocessMode
    ...
    MOV dword ptr [0x02d052a4],EDI      ; 0048bfbd | g_VertexPreprocessMode
