...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_drender.cpp_CDemonRenderer_setCameraRotationFromPoint_FUN_0048c1b0(CDemonRenderer * this_ptr, CVector3i * rotation)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0048c1bf
    CALL engine_matrix.c_setCameraRotation_FUN_0050e290 ; 0048c1c0 | void engine_matrix.c_setCameraRotation_FUN_0050e290(ushort pitch, ushort yaw, ushort roll)
