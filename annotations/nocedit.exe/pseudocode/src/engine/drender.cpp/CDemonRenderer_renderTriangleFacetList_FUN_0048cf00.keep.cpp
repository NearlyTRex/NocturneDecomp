      ...
      if (g_UseExternalRenderer == 0) {
        for (; 0 < primitive_count; primitive_count = primitive_count + -1) {
          ...
          if (this_ptr->skip_uv_extraction == 0) {
            ...
            this_ptr->vertex_buffer_ptr[local_28[0]].v = primitive_array[1].surface_normal.A.i;
            this_ptr->vertex_buffer_ptr[local_28[1]].u = primitive_array[1].surface_normal.C.i;
            this_ptr->vertex_buffer_ptr[local_28[1]].v = primitive_array[1].surface_normal.D.i;
            this_ptr->vertex_buffer_ptr[local_28[2]].u = primitive_array[2].base.count;
            this_ptr->vertex_buffer_ptr[local_28[2]].v = primitive_array[2].surface_normal.A.i;
            if ((primitive_array->base).count == 4) {
              this_ptr->vertex_buffer_ptr[local_28[3]].u = primitive_array[2].surface_normal.C.i;
              this_ptr->vertex_buffer_ptr[local_28[3]].v = primitive_array[2].surface_normal.D.i;
            }
          }
