...
section .text
    ...
    PUSH EBX                            ; 0048b970
        ;   Label: engine_drender.cpp_CDemonRenderer_renderDestReadBlendPoly_FUN_0048b970
    PUSH ESI                            ; 0048b971
    PUSH EDI                            ; 0048b972
    PUSH EBP                            ; 0048b973
    ...
    MOV dword ptr [0x02d052a4],EDI      ; 0048b9f5 | g_VertexPreprocessMode
    ...
    MOV dword ptr [0x02d052a4],EBP      ; 0048ba67 | g_VertexPreprocessMode
