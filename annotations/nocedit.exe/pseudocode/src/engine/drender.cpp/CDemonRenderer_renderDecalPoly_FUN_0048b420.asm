...
section .text
    ...
    PUSH EBX                            ; 0048b420
        ;   Label: engine_drender.cpp_CDemonRenderer_renderDecalPoly_FUN_0048b420
    PUSH EBP                            ; 0048b421
    ...
    MOV dword ptr [0x02d052a4],EBP      ; 0048b487 | g_VertexPreprocessMode
    ...
    MOV dword ptr [0x02d052a4],ESI      ; 0048b538 | g_VertexPreprocessMode
