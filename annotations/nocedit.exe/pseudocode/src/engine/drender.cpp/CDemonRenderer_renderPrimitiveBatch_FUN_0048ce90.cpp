...
// Convention: __cdecl
// Signature: void __cdecl engine_drender_cpp_CDemonRenderer_renderPrimitiveBatch_FUN_0048ce90(CDemonRenderer *this_ptr,SMRGLHeaderPrimitive *primitive_array,int primitive_count,int render_flags)
...

{
  ...
  if (this_ptr->texture_capture_enabled == 0) {
    engine_drender_cpp_CDemonRenderer_renderFacetList_FUN_0048cf00
              (this_ptr,(SMRGLPrimitiveQuad *)primitive_array,primitive_count,0x48,render_flags);
    return;
  }
  iVar1 = 0;
