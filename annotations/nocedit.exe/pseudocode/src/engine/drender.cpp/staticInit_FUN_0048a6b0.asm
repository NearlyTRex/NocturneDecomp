...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl engine_drender_cpp_staticInit_FUN_0048a6b0(void)
;
;
; Referenced Globals:
...
section .text
    ...
    CALL engine_drender.cpp_CDemonRenderer_ctor_FUN_0048a6c0 ; 0048a6b5
        ;   XREF to: 0048a6c0 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_ctor_FUN_0048a6c0(CDemonRenderer * this_ptr)
