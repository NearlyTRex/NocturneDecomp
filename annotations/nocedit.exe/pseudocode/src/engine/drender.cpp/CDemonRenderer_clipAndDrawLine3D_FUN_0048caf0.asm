...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_drender.cpp_CDemonRenderer_clipAndDrawLine3D_FUN_0048caf0(CDemonRenderer * this_ptr, int vertex_index1, int vertex_index2)
;
; Parameters:
...
section .text
    ...
    MOV EAX,[0x00772a5c]                ; 0048cb01 | int g_CurrentPolygonColor
    MOV EBX,dword ptr [ESP + 0xa8]      ; 0048cb06
    MOV [0x02d02570],EAX                ; 0048cb0d | int g_ActiveRenderColor
    ...
    JNZ 0x0048cd4e                      ; 0048cb5c | LAB_0048cd4e
    ...
    JLE 0x0048cb93                      ; 0048cb6b | LAB_0048cb93
    ...
    CALL engine_clipper.c_interpolateVertexLeftClip_FUN_00435a00 ; 0048cb84 | void engine_clipper.c_interpolateVertexLeftClip_FUN_00435a00(SRenderVertex * v1, SRenderVertex * v2, SRenderVertex * output)
    ...
    JLE 0x0048cbc6                      ; 0048cb9e | LAB_0048cbc6
    ...
    CALL engine_clipper.c_interpolateVertexRightClip_FUN_00435b00 ; 0048cbb7 | void engine_clipper.c_interpolateVertexRightClip_FUN_00435b00(SRenderVertex * v1, SRenderVertex * v2, SRenderVertex * output)
    ...
    JLE 0x0048cbf6                      ; 0048cbce | LAB_0048cbf6
    ...
    CALL engine_clipper.c_interpolateVertexBottomClip_FUN_00435c00 ; 0048cbe7 | void engine_clipper.c_interpolateVertexBottomClip_FUN_00435c00(SRenderVertex * v1, SRenderVertex * v2, SRenderVertex * output)
    ...
    JLE 0x0048cc2a                      ; 0048cc02 | LAB_0048cc2a
    ...
    CALL engine_clipper.c_interpolateVertexTopClip_FUN_00435d00 ; 0048cc1b | void engine_clipper.c_interpolateVertexTopClip_FUN_00435d00(SRenderVertex * v1, SRenderVertex * v2, SRenderVertex * output)
    ...
    JLE 0x0048cc5a                      ; 0048cc32 | LAB_0048cc5a
    ...
    CALL engine_clipper.c_interpolateVertexLeftClip_FUN_00435a00 ; 0048cc4b | void engine_clipper.c_interpolateVertexLeftClip_FUN_00435a00(SRenderVertex * v1, SRenderVertex * v2, SRenderVertex * output)
        ;   XREF to: 00435a00 (UNCONDITIONAL_CALL)
    ...
    JLE 0x0048cc8e                      ; 0048cc66 | LAB_0048cc8e
    ...
    CALL engine_clipper.c_interpolateVertexRightClip_FUN_00435b00 ; 0048cc7f | void engine_clipper.c_interpolateVertexRightClip_FUN_00435b00(SRenderVertex * v1, SRenderVertex * v2, SRenderVertex * output)
        ;   XREF to: 00435b00 (UNCONDITIONAL_CALL)
    ...
    JLE 0x0048ccbe                      ; 0048cc96 | LAB_0048ccbe
    ...
    CALL engine_clipper.c_interpolateVertexBottomClip_FUN_00435c00 ; 0048ccaf | void engine_clipper.c_interpolateVertexBottomClip_FUN_00435c00(SRenderVertex * v1, SRenderVertex * v2, SRenderVertex * output)
        ;   XREF to: 00435c00 (UNCONDITIONAL_CALL)
    ...
    JLE 0x0048ccf2                      ; 0048ccca | LAB_0048ccf2
    ...
    CALL engine_clipper.c_interpolateVertexTopClip_FUN_00435d00 ; 0048cce3 | void engine_clipper.c_interpolateVertexTopClip_FUN_00435d00(SRenderVertex * v1, SRenderVertex * v2, SRenderVertex * output)
        ;   XREF to: 00435d00 (UNCONDITIONAL_CALL)
    ...
    JL 0x0048cb64                       ; 0048ccf6 | LAB_0048cb64
    ...
    TEST AL,0xff                        ; 0048cd4e
        ;   Label: LAB_0048cd4e
    JNZ 0x0048cd43                      ; 0048cd50 | LAB_0048cd43
        ;   XREF to: 0048cd43 (CONDITIONAL_JUMP)
    JMP 0x0048cb62                      ; 0048cd52 | LAB_0048cb62
    ...
    CALL engine_matrix.c_projectCachedPointUnchecked_FUN_0050ce60 ; 0048cd82 | void engine_matrix.c_projectCachedPointUnchecked_FUN_0050ce60(int cacheIndex)
        ;   XREF to: 0050ce60 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0048cd87
    PUSH 0x4e1f                         ; 0048cd8a
    CALL engine_matrix.c_projectCachedPointUnchecked_FUN_0050ce60 ; 0048cd8f | void engine_matrix.c_projectCachedPointUnchecked_FUN_0050ce60(int cacheIndex)
        ;   XREF to: 0050ce60 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0048cda1
    CALL engine_prim.c_replaceWWithDepth_FUN_00552110 ; 0048cda2 | void engine_prim.c_replaceWWithDepth_FUN_00552110(SRenderVertex * vertices, int vertex_count)
    ...
    PUSH EAX                            ; 0048cddc
    CALL engine_2d.c_drawLine3D_FUN_00401320 ; 0048cddd | void engine_2d.c_drawLine3D_FUN_00401320(int x1, int y1, uint z1, int x2, ...)
