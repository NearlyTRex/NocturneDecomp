...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_drender.cpp_CDemonRenderer_renderFaceList_FUN_0048d170(CDemonRenderer * this_ptr, SInputFace * face_array, int face_count, int render_flags)
;
; Parameters:
...
section .text
    ...
    PUSH ESI                            ; 0048d19c
    INC EBP                             ; 0048d19d
    CALL engine_drender.cpp_CDemonRenderer_captureFace_FUN_0048d8a0 ; 0048d19e | void engine_drender.cpp_CDemonRenderer_captureFace_FUN_0048d8a0(CDemonRenderer * this_ptr, STrianglePackedIndices * triangle_indices, int render_flags)
        ;   XREF to: 0048d8a0 (UNCONDITIONAL_CALL)
    ADD EBX,0x12                        ; 0048d1a3
    ADD ESP,0xc                         ; 0048d1a6
    CMP EBP,EDI                         ; 0048d1a9
    JL 0x0048d196                       ; 0048d1ab | LAB_0048d196
    ...
    PUSH ESI                            ; 0048d1d5
    INC EBP                             ; 0048d1d6
    CALL engine_drender.cpp_CDemonRenderer_renderWireframeAdvanced_FUN_0048b030 ; 0048d1d7 | void engine_drender.cpp_CDemonRenderer_renderWireframeAdvanced_FUN_0048b030(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * primitive, int render_flags)
        ;   XREF to: 0048b030 (UNCONDITIONAL_CALL)
    ADD EBX,0x12                        ; 0048d1dc
    ADD ESP,0xc                         ; 0048d1df
    CMP EBP,EDI                         ; 0048d1e2
    JL 0x0048d1cf                       ; 0048d1e4 | LAB_0048d1cf
    ...
    CMP dword ptr [ESI + 0xc],0x0       ; 0048d1ee
        ;   Label: LAB_0048d1ee
    JNZ 0x0048d1c9                      ; 0048d1f2 | LAB_0048d1c9
        ;   XREF to: 0048d1c9 (CONDITIONAL_JUMP)
    CMP dword ptr [0x00772a7c],0x0      ; 0048d1f4 | int g_CullingMode
    JZ 0x0048d1c9                       ; 0048d1fb | LAB_0048d1c9
        ;   XREF to: 0048d1c9 (CONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0x4],0x0       ; 0048d1fd
    JNZ 0x0048d30e                      ; 0048d201 | LAB_0048d30e
        ;   XREF to: 0048d30e (CONDITIONAL_JUMP)
    CMP dword ptr [0x0067939c],0x20     ; 0048d207 | int g_BitsPerPixel
    JNZ 0x0048d366                      ; 0048d20e | LAB_0048d366
        ;   XREF to: 0048d366 (CONDITIONAL_JUMP)
    MOV dword ptr [0x02d0257c],0x5b4031 ; 0048d214 | RenderScanlineFunc * g_ScanlineRenderFunc
    MOV EAX,dword ptr [ESP + 0x34]      ; 0048d21e
        ;   Label: LAB_0048d21e
    MOV EBP,0x6                         ; 0048d222
    MOV [0x02d052a0],EAX                ; 0048d227 | int g_RenderStateFlags
    MOV EAX,[0x02d03e94]                ; 0048d22c | int g_UseExternalRenderer
    MOV dword ptr [0x02d052a4],EBP      ; 0048d231 | int g_RenderStateFlag2
    TEST EAX,EAX                        ; 0048d237
    JNZ 0x0048d375                      ; 0048d239 | LAB_0048d375
        ;   XREF to: 0048d375 (CONDITIONAL_JUMP)
    TEST EDI,EDI                        ; 0048d23f
        ;   Label: LAB_0048d23f
    JLE 0x0048d1b0                      ; 0048d241 | LAB_0048d1b0
        ;   XREF to: 0048d1b0 (CONDITIONAL_JUMP)
    ...
    JNZ 0x0048d2f6                      ; 0048d268 | LAB_0048d2f6
    ...
    CALL engine_drender.cpp_renderTriangleTextured_FUN_00483370 ; 0048d301 | void engine_drender.cpp_renderTriangleTextured_FUN_00483370(int * vertex_indices, int vertex_count)
        ;   XREF to: 00483370 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0048d306
    JMP 0x0048d23f                      ; 0048d309 | LAB_0048d23f
        ;   XREF to: 0048d23f (UNCONDITIONAL_JUMP)
    MOV ECX,0x49072f                    ; 0048d30e
        ;   Label: LAB_0048d30e
    MOV [0x02d052a0],EAX                ; 0048d313 | int g_RenderStateFlags
    MOV [0x02d052a4],EAX                ; 0048d318 | int g_RenderStateFlag2
    MOV dword ptr [0x02d0257c],ECX      ; 0048d31d | RenderScanlineFunc * g_ScanlineRenderFunc
    TEST EDI,EDI                        ; 0048d323
    JLE 0x0048d1b0                      ; 0048d325 | LAB_0048d1b0
        ;   XREF to: 0048d1b0 (CONDITIONAL_JUMP)
    ...
    CALL engine_drender.cpp_renderTriangleSimple_FUN_004839f0 ; 0048d352 | void engine_drender.cpp_renderTriangleSimple_FUN_004839f0(int * vertex_indices, int vertex_count)
        ;   XREF to: 004839f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0048d357
    TEST EDI,EDI                        ; 0048d35a
    JG 0x0048d32b                       ; 0048d35c | LAB_0048d32b
    ...
    POP EBX                             ; 0048d364
    RET                                 ; 0048d365
    MOV dword ptr [0x02d0257c],0x5b4823 ; 0048d366 | RenderScanlineFunc * g_ScanlineRenderFunc
        ;   Label: LAB_0048d366
    JMP 0x0048d21e                      ; 0048d370 | LAB_0048d21e
        ;   XREF to: 0048d21e (UNCONDITIONAL_JUMP)
    XOR EBP,EBP                         ; 0048d375
        ;   Label: LAB_0048d375
    MOV dword ptr [ESP + 0x10],EBP      ; 0048d377
    TEST EDI,EDI                        ; 0048d37b
    JLE 0x0048d3dd                      ; 0048d37d | LAB_0048d3dd
        ;   XREF to: 0048d3dd (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0xc],EBP       ; 0048d37f
    PUSH EBX                            ; 0048d383
        ;   Label: LAB_0048d383
    CALL engine_prim.c_getTriangleWindingFromPackedIndices_FUN_005523f0 ; 0048d384 | int engine_prim.c_getTriangleWindingFromPackedIndices_FUN_005523f0(STrianglePackedIndices * triangle)
        ;   XREF to: 005523f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0048d389
    TEST EAX,EAX                        ; 0048d38c
    JZ 0x0048d3cd                       ; 0048d38e | LAB_0048d3cd
        ;   XREF to: 0048d3cd (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0xc]       ; 0048d390
    INC EBP                             ; 0048d394
    LEA EDX,[EAX + 0x4]                 ; 0048d395
    MOV dword ptr [EAX + 0x6703f4],EBX  ; 0048d398 | SInputFace *[2000] g_VisibleFacePointers
    MOV dword ptr [ESP + 0xc],EDX       ; 0048d39e
    CMP EBP,0x7d0                       ; 0048d3a2
    JL 0x0048d3cd                       ; 0048d3a8 | LAB_0048d3cd
        ;   XREF to: 0048d3cd (CONDITIONAL_JUMP)
    PUSH EBP                            ; 0048d3aa
    MOV ECX,0x6220ea                    ; 0048d3ab | = "..\\engine\\drender.cpp" | s_engine_drender_cpp_006220ea = ..\engine\drender.cpp
    MOV EAX,0xa30                       ; 0048d3b0
    PUSH 0x622100                       ; 0048d3b5 | = "CDemonRenderer::demonGZFacetList - To..." | s_CDemonRenderer_demonGZFa_00622100 = CDemonRenderer::demonGZFacetList - Too many visible faces at once : %d
    MOV dword ptr [0x02f0ca48],ECX      ; 0048d3ba | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 0048d3c0 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0048d3c5 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    JG 0x0048d383                       ; 0048d3db | LAB_0048d383
        ;   XREF to: 0048d383 (CONDITIONAL_JUMP)
    TEST EBP,EBP                        ; 0048d3dd
        ;   Label: LAB_0048d3dd
    JLE 0x0048d1b0                      ; 0048d3df | LAB_0048d1b0
        ;   XREF to: 0048d1b0 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x02d052a0]      ; 0048d3e5 | int g_RenderStateFlags
    PUSH EDX                            ; 0048d3eb
    PUSH EBP                            ; 0048d3ec
    PUSH 0x6703f4                       ; 0048d3ed | SInputFace *[2000] g_VisibleFacePointers
    MOV ECX,dword ptr [ESI]             ; 0048d3f2
    PUSH ECX                            ; 0048d3f4
    CALL wincore_windll.cpp_drawPolyList2_FUN_005b7780 ; 0048d3f5 | int wincore_windll.cpp_drawPolyList2_FUN_005b7780(void * vertex_buffer, void * * polygons, int polygon_count, int render_flags)
