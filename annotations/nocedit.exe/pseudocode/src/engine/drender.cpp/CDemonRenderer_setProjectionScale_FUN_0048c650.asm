...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl engine_drender_cpp_CDemonRenderer_setProjectionScale_FUN_0048c650 (CDemonRenderer *this_ptr,float field_of_view)
;
; Parameters:
...
;   core_mirror.cpp_setupMirrorCamera_FUN_00521480 at 005214a2
...
;   core_set.cpp_CDemonSet_FUN_0056c990 at 0056ccc1
;   core_set.cpp_FUN_00570af0 at 00570b14
;   ... and 2 more
;
; Referenced Globals:
