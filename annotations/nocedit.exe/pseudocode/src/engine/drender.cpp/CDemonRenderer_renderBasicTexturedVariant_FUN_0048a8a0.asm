...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_drender.cpp_CDemonRenderer_renderBasicTexturedVariant_FUN_0048a8a0(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * polygon_info)
;
; Parameters:
...
section .text
    ...
    JNZ 0x0048a916                      ; 0048a8af | LAB_0048a916
    ...
    JLE 0x0048a8e0                      ; 0048a8b9 | LAB_0048a8e0
    ...
    MOV dword ptr [ECX + 0x2c6d5a8],EBX ; 0048a8c5 | int[16] g_VertexIndexBuffer
    INC EDX                             ; 0048a8cb
    MOV EBX,dword ptr [ESI + 0x4]       ; 0048a8cc
    ADD EAX,0xc                         ; 0048a8cf
    CMP EDX,EBX                         ; 0048a8d2
    JL 0x0048a8bf                       ; 0048a8d4 | LAB_0048a8bf
        ;   XREF to: 0048a8bf (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 0048a8d6
    LEA EDX,[EDX]                       ; 0048a8dc
    CMP dword ptr [EDI + 0x4],0x0       ; 0048a8e0
        ;   Label: LAB_0048a8e0
    JZ 0x0048a928                       ; 0048a8e4 | LAB_0048a928
        ;   XREF to: 0048a928 (CONDITIONAL_JUMP)
    XOR EBP,EBP                         ; 0048a8e6
    MOV EBX,0x49072f                    ; 0048a8e8
    MOV dword ptr [0x02d052a0],EBP      ; 0048a8ed | int g_RenderStateFlags
    MOV dword ptr [0x02d052a4],EBP      ; 0048a8f3 | int g_RenderStateFlag2
    MOV dword ptr [0x02d0257c],EBX      ; 0048a8f9 | RenderScanlineFunc * g_ScanlineRenderFunc
    PUSH 0x2c6d5ac                      ; 0048a8ff | int[16] g_VertexIndexBuffer
        ;   Label: LAB_0048a8ff
    MOV EDX,dword ptr [ESI + 0x4]       ; 0048a904
    PUSH EDX                            ; 0048a907
    PUSH EDI                            ; 0048a908
    CALL engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740 ; 0048a909 | void engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740(CDemonRenderer * this_ptr, int vertex_count, int * vertex_indices)
    ...
    LEA EAX,[ESI + 0x8]                 ; 0048a916
        ;   Label: LAB_0048a916
    PUSH EAX                            ; 0048a919
    CALL engine_3d.c_isVisiblePlane_FUN_00403950 ; 0048a91a | int engine_3d.c_isVisiblePlane_FUN_00403950(SClipPlane * plane)
        ;   XREF to: 00403950 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0048a91f
    TEST EAX,EAX                        ; 0048a922
    JZ 0x0048a912                       ; 0048a924 | LAB_0048a912
        ;   XREF to: 0048a912 (CONDITIONAL_JUMP)
    JMP 0x0048a8b1                      ; 0048a926 | LAB_0048a8b1
        ;   XREF to: 0048a8b1 (UNCONDITIONAL_JUMP)
    MOV EDX,0xc0                        ; 0048a928
        ;   Label: LAB_0048a928
    MOV ECX,0x6                         ; 0048a92d
    MOV EAX,0x490a58                    ; 0048a932
    MOV dword ptr [0x02d052a0],EDX      ; 0048a937 | int g_RenderStateFlags
    MOV dword ptr [0x02d052a4],ECX      ; 0048a93d | int g_RenderStateFlag2
    MOV [0x02d0257c],EAX                ; 0048a943 | RenderScanlineFunc * g_ScanlineRenderFunc
    JMP 0x0048a8ff                      ; 0048a948 | LAB_0048a8ff
