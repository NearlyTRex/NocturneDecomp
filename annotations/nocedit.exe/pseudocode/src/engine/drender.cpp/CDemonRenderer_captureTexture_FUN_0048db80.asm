...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80(CDemonRenderer * this_ptr, SMRGLTextureBasic * texture)
;
; Parameters:
...
section .text
    ...
    PUSH ESI                            ; 0048db86
    CALL engine_texture.cpp_ensureTextureLoaded_FUN_005dd800 ; 0048db87 | SMRGLHeaderExtended * engine_texture.cpp_ensureTextureLoaded_FUN_005dd800(SMRGLTextureBasic * texture)
    ...
    JZ 0x0048dc10                       ; 0048db97 | LAB_0048dc10
        ;   XREF to: 0048dc10 (CONDITIONAL_JUMP)
    PUSH EDI                            ; 0048db99
    MOV ECX,dword ptr [0x02c6d5f0]      ; 0048db9a | int g_CaptureTextureCount
    INC ECX                             ; 0048dba0
    MOV dword ptr [0x02c6d5f0],ECX      ; 0048dba1 | int g_CaptureTextureCount
    CMP ECX,0x64                        ; 0048dba7
    JLE 0x0048dbcf                      ; 0048dbaa | LAB_0048dbcf
        ;   XREF to: 0048dbcf (CONDITIONAL_JUMP)
    MOV EDI,0x6221bf                    ; 0048dbac | = "..\\engine\\drender.cpp" | s_engine_drender_cpp_006221bf = ..\engine\drender.cpp
    MOV EBP,0xbf3                       ; 0048dbb1
    PUSH 0x6221d5                       ; 0048dbb6 | = "CDR::texture - Too many captured text..." | s_CDR_texture_Too_many_cap_006221d5 = CDR::texture - Too many captured textures
    MOV dword ptr [0x02f0ca48],EDI      ; 0048dbbb | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBP      ; 0048dbc1 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0048dbc7 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0048dbcc
    MOV EDX,dword ptr [0x02c6d5f0]      ; 0048dbcf | int g_CaptureTextureCount
        ;   Label: LAB_0048dbcf
    ...
    ADD EAX,0x2c99514                   ; 0048dbea | SMRGLTextureBasic[100] g_CapturedTextureArray
    ADD ESI,0x8                         ; 0048dbef
    LEA EDI,[EAX + 0x8]                 ; 0048dbf2
    PUSH EDI                            ; 0048dbf5
    MOV AL,byte ptr [ESI]               ; 0048dbf6
        ;   Label: LAB_0048dbf6
    MOV byte ptr [EDI],AL               ; 0048dbf8 | DAT_02c9951c
    CMP AL,0x0                          ; 0048dbfa
    JZ 0x0048dc0e                       ; 0048dbfc | LAB_0048dc0e
        ;   XREF to: 0048dc0e (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0048dbfe
    ADD ESI,0x2                         ; 0048dc01
    MOV byte ptr [EDI + 0x1],AL         ; 0048dc04 | DAT_02c9951d
    ADD EDI,0x2                         ; 0048dc07
    CMP AL,0x0                          ; 0048dc0a
    JNZ 0x0048dbf6                      ; 0048dc0c | LAB_0048dbf6
