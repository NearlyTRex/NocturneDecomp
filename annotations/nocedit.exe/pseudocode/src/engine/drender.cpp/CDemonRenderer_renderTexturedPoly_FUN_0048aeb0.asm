...
;   core_morph.cpp_CMorphModel_renderFaces_FUN_0052b160 at 0052b229
;   core_wateract.cpp_CWaterActor_renderTransparent_FUN_005eb280 at 005eb48f
;   engine_drender.cpp_CDemonRenderer_renderFacetList_FUN_0048cf00 at 0048cf27
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0048aeb0
        ;   Label: engine_drender.cpp_CDemonRenderer_renderTexturedPoly_FUN_0048aeb0
    PUSH EDI                            ; 0048aeb1
    PUSH EBP                            ; 0048aeb2
    ...
    MOV [0x02d052a4],EAX                ; 0048af26 | g_VertexPreprocessMode
    ...
    MOV dword ptr [0x02d052a4],EDI      ; 0048b006 | g_VertexPreprocessMode
