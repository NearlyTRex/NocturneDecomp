...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_drender.cpp_CDemonRenderer_renderPremium_FUN_0048b1e0(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * polygon_info)
;
; Parameters:
...
section .text
    ...
    JNZ 0x0048b270                      ; 0048b1ed | LAB_0048b270
    ...
    JZ 0x0048b289                       ; 0048b1fa | LAB_0048b289
    ...
    JLE 0x0048b230                      ; 0048b20b | LAB_0048b230
    ...
    MOV ESI,dword ptr [ECX + 0x18]      ; 0048b213
        ;   Label: LAB_0048b213
    MOV dword ptr [EAX + 0x2c6d5ac],ESI ; 0048b216 | int[16] g_VertexIndexBuffer
    ...
    JL 0x0048b213                       ; 0048b22c | LAB_0048b213
        ;   XREF to: 0048b213 (CONDITIONAL_JUMP)
    MOV EAX,EAX                         ; 0048b22e
    CMP dword ptr [EBX + 0x4],0x0       ; 0048b230
        ;   Label: LAB_0048b230
    JZ 0x0048b2e2                       ; 0048b234 | LAB_0048b2e2
        ;   XREF to: 0048b2e2 (CONDITIONAL_JUMP)
    XOR EDX,EDX                         ; 0048b23a
    MOV EAX,0x49072f                    ; 0048b23c
    MOV dword ptr [0x02d052a0],EDX      ; 0048b241 | int g_RenderStateFlags
    MOV dword ptr [0x02d052a4],EDX      ; 0048b247 | int g_RenderStateFlag2
    MOV [0x02d0257c],EAX                ; 0048b24d | RenderScanlineFunc * g_ScanlineRenderFunc
    MOV EAX,dword ptr [ESP + 0x1c]      ; 0048b252
        ;   Label: LAB_0048b252
    PUSH 0x2c6d5ac                      ; 0048b256 | int[16] g_VertexIndexBuffer
    MOV ESI,dword ptr [EAX + 0x4]       ; 0048b25b
    PUSH ESI                            ; 0048b25e
    PUSH EBX                            ; 0048b25f
    CALL engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740 ; 0048b260 | void engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740(CDemonRenderer * this_ptr, int vertex_count, int * vertex_indices)
    ...
    PUSH EAX                            ; 0048b277
    CALL engine_3d.c_isVisiblePlane_FUN_00403950 ; 0048b278 | int engine_3d.c_isVisiblePlane_FUN_00403950(SClipPlane * plane)
        ;   XREF to: 00403950 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0048b27d
    TEST EAX,EAX                        ; 0048b280
    JZ 0x0048b26a                       ; 0048b282 | LAB_0048b26a
        ;   XREF to: 0048b26a (CONDITIONAL_JUMP)
    JMP 0x0048b1f3                      ; 0048b284 | LAB_0048b1f3
        ;   XREF to: 0048b1f3 (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x1c]      ; 0048b289
        ;   Label: LAB_0048b289
    CMP dword ptr [EAX + 0x4],0x0       ; 0048b28d
    JLE 0x0048b230                      ; 0048b291 | LAB_0048b230
        ;   XREF to: 0048b230 (CONDITIONAL_JUMP)
    ...
    JZ 0x0048b2bd                       ; 0048b29d | LAB_0048b2bd
        ;   XREF to: 0048b2bd (CONDITIONAL_JUMP)
    MOV dword ptr [EDX + 0x2c6d5ac],ESI ; 0048b29f | int[16] g_VertexIndexBuffer
        ;   Label: LAB_0048b29f
    ...
    JGE 0x0048b230                      ; 0048b2b5 | LAB_0048b230
        ;   XREF to: 0048b230 (CONDITIONAL_JUMP)
    JMP 0x0048b295                      ; 0048b2bb | LAB_0048b295
    ...
    JMP 0x0048b29f                      ; 0048b2e0 | LAB_0048b29f
        ;   XREF to: 0048b29f (UNCONDITIONAL_JUMP)
    CMP dword ptr [0x0067939c],0x20     ; 0048b2e2 | int g_BitsPerPixel
        ;   Label: LAB_0048b2e2
    JNZ 0x0048b310                      ; 0048b2e9 | LAB_0048b310
        ;   XREF to: 0048b310 (CONDITIONAL_JUMP)
    MOV dword ptr [0x02d0257c],0x5b4031 ; 0048b2eb | RenderScanlineFunc * g_ScanlineRenderFunc
    MOV EBP,0x6                         ; 0048b2f5
        ;   Label: LAB_0048b2f5
    MOV EDI,0x2cd                       ; 0048b2fa
    MOV dword ptr [0x02d052a4],EBP      ; 0048b2ff | int g_RenderStateFlag2
    MOV dword ptr [0x02d052a0],EDI      ; 0048b305 | int g_RenderStateFlags
    JMP 0x0048b252                      ; 0048b30b | LAB_0048b252
        ;   XREF to: 0048b252 (UNCONDITIONAL_JUMP)
    MOV dword ptr [0x02d0257c],0x5b4823 ; 0048b310 | RenderScanlineFunc * g_ScanlineRenderFunc
        ;   Label: LAB_0048b310
    JMP 0x0048b2f5                      ; 0048b31a | LAB_0048b2f5
