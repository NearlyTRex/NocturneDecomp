...
section .text
    ...
    MOV EDX,dword ptr [0x02d02548]      ; 0048de24 | int g_ViewportCenterXFixed
    MOV dword ptr [EAX],EDX             ; 0048de2a
    MOV EDX,dword ptr [0x02d0254c]      ; 0048de2c | int g_ViewportCenterYFixed
    MOV dword ptr [EAX + 0x4],EDX       ; 0048de32
    MOV EDX,dword ptr [0x02d02550]      ; 0048de35 | int g_ViewportRightFixed
    MOV dword ptr [EAX + 0x8],EDX       ; 0048de3b
    MOV EDX,dword ptr [0x02d02554]      ; 0048de3e | int g_ViewportBottomFixed
    MOV dword ptr [EAX + 0xc],EDX       ; 0048de44
    MOV EDX,dword ptr [0x02d052c4]      ; 0048de47 | int g_CameraOriginX
    MOV dword ptr [EAX + 0x10],EDX      ; 0048de4d
    MOV EDX,dword ptr [0x02d052c8]      ; 0048de50 | int g_CameraOriginY
    MOV dword ptr [EAX + 0x14],EDX      ; 0048de56
    MOV EDX,dword ptr [0x02d052cc]      ; 0048de59 | int g_CameraOriginZ
    MOV dword ptr [EAX + 0x18],EDX      ; 0048de5f
    MOV EDX,dword ptr [0x02d052d0]      ; 0048de62 | int g_CameraRotationPitch
    MOV dword ptr [EAX + 0x1c],EDX      ; 0048de68
    MOV EDX,dword ptr [0x02d052d4]      ; 0048de6b | int g_CameraRotationYaw
    MOV dword ptr [EAX + 0x20],EDX      ; 0048de71
    MOV EDX,dword ptr [0x02d052d8]      ; 0048de74 | int g_CameraRotationRoll
    MOV dword ptr [EAX + 0x24],EDX      ; 0048de7a
    MOV EDX,dword ptr [0x02d02558]      ; 0048de7d | int g_ClipLeft
    MOV dword ptr [EAX + 0x28],EDX      ; 0048de83
    MOV EDX,dword ptr [0x02d02560]      ; 0048de86 | int g_ClipRight
    MOV dword ptr [EAX + 0x2c],EDX      ; 0048de8c
    MOV EDX,dword ptr [0x02d0255c]      ; 0048de8f | int g_ClipTop
    MOV dword ptr [EAX + 0x30],EDX      ; 0048de95
    MOV EDX,dword ptr [0x02d02564]      ; 0048de98 | int g_ClipBottom
    MOV dword ptr [EAX + 0x34],EDX      ; 0048de9e
    MOV EDX,dword ptr [0x02d052b8]      ; 0048dea1 | int g_RelativeX
    MOV dword ptr [EAX + 0x38],EDX      ; 0048dea7
    MOV EDX,dword ptr [0x02d052bc]      ; 0048deaa | int g_RelativeY
    MOV dword ptr [EAX + 0x3c],EDX      ; 0048deb0
    MOV EDX,dword ptr [0x02d052c0]      ; 0048deb3 | int g_RelativeZ
    MOV dword ptr [EAX + 0x40],EDX      ; 0048deb9
    MOV EDX,dword ptr [0x02d052e8]      ; 0048debc | CMatrix3x3i g_TransformMatrix
    ...
    MOV EDX,dword ptr [0x02f0d364]      ; 0048df0d | CMatrix3x3i g_InverseMatrix
    ...
    MOV EDX,dword ptr [0x006793c0]      ; 0048df67 | int g_ProjectionScale
