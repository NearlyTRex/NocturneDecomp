...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_drender.cpp_CDemonRenderer_renderMaximumQuality_FUN_0048bad0(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * polygon_info)
;
; Parameters:
...
section .text
    ...
    JNZ 0x0048bb51                      ; 0048bae0 | LAB_0048bb51
    ...
    JLE 0x0048bb10                      ; 0048baf2 | LAB_0048bb10
    ...
    JL 0x0048baf9                       ; 0048bb0c | LAB_0048baf9
        ;   XREF to: 0048baf9 (CONDITIONAL_JUMP)
    MOV EAX,EAX                         ; 0048bb0e
    TEST ECX,0x80000000                 ; 0048bb10
        ;   Label: LAB_0048bb10
    JZ 0x0048bb1d                       ; 0048bb16 | LAB_0048bb1d
        ;   XREF to: 0048bb1d (CONDITIONAL_JUMP)
    TEST CL,0x1f                        ; 0048bb18
    JNZ 0x0048bb4c                      ; 0048bb1b | LAB_0048bb4c
        ;   XREF to: 0048bb4c (CONDITIONAL_JUMP)
    CMP dword ptr [EBP + 0x4],0x0       ; 0048bb1d
        ;   Label: LAB_0048bb1d
    JZ 0x0048bb63                       ; 0048bb21 | LAB_0048bb63
        ;   XREF to: 0048bb63 (CONDITIONAL_JUMP)
    XOR EDX,EDX                         ; 0048bb23
    MOV EAX,0x49072f                    ; 0048bb25
    MOV dword ptr [0x02d052a0],EDX      ; 0048bb2a | int g_RenderStateFlags
    MOV dword ptr [0x02d052a4],EDX      ; 0048bb30 | int g_RenderStateFlag2
    MOV [0x02d0257c],EAX                ; 0048bb36 | RenderScanlineFunc * g_ScanlineRenderFunc
    ...
    PUSH EBX                            ; 0048bb42
    PUSH EBP                            ; 0048bb43
    CALL engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740 ; 0048bb44 | void engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740(CDemonRenderer * this_ptr, int vertex_count, int * vertex_indices)
    ...
    LEA EAX,[ESI + 0x8]                 ; 0048bb51
        ;   Label: LAB_0048bb51
    PUSH EAX                            ; 0048bb54
    CALL engine_3d.c_isVisiblePlane_FUN_00403950 ; 0048bb55 | int engine_3d.c_isVisiblePlane_FUN_00403950(SClipPlane * plane)
        ;   XREF to: 00403950 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0048bb5a
    TEST EAX,EAX                        ; 0048bb5d
    JZ 0x0048bb4c                       ; 0048bb5f | LAB_0048bb4c
        ;   XREF to: 0048bb4c (CONDITIONAL_JUMP)
    JMP 0x0048bae6                      ; 0048bb61 | LAB_0048bae6
        ;   XREF to: 0048bae6 (UNCONDITIONAL_JUMP)
    CMP dword ptr [0x0067939c],0x20     ; 0048bb63 | int g_BitsPerPixel
        ;   Label: LAB_0048bb63
    JNZ 0x0048bb8e                      ; 0048bb6a | LAB_0048bb8e
        ;   XREF to: 0048bb8e (CONDITIONAL_JUMP)
    MOV dword ptr [0x02d0257c],0x5b4031 ; 0048bb6c | RenderScanlineFunc * g_ScanlineRenderFunc
    MOV EDI,0x6                         ; 0048bb76
        ;   Label: LAB_0048bb76
    MOV EBX,0x367                       ; 0048bb7b
    MOV dword ptr [0x02d052a4],EDI      ; 0048bb80 | int g_RenderStateFlag2
    MOV dword ptr [0x02d052a0],EBX      ; 0048bb86 | int g_RenderStateFlags
    JMP 0x0048bb3b                      ; 0048bb8c | LAB_0048bb3b
        ;   XREF to: 0048bb3b (UNCONDITIONAL_JUMP)
    MOV dword ptr [0x02d0257c],0x5b4823 ; 0048bb8e | RenderScanlineFunc * g_ScanlineRenderFunc
        ;   Label: LAB_0048bb8e
    JMP 0x0048bb76                      ; 0048bb98 | LAB_0048bb76
