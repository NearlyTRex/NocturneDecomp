// Name: engine_drender.cpp_CDemonRenderer_renderOverlayDirect_FUN_0048bf10
// Address: 0048bf10
// Address Range: [[0048bf10, 0048bfd6]]
// Convention: __cdecl
// Signature: void __cdecl engine_drender_cpp_CDemonRenderer_renderOverlayDirect_FUN_0048bf10(CDemonRenderer *this_ptr,SMRGLHeaderPrimitive *prim)
  ...
  if ((this_ptr->plane_culling_enabled == 0) ||
    ...
    if (((uVar2 & 0x80000000) == 0) || ((uVar2 & 0x1f) == 0)) {
      if (this_ptr->face_count == 0) {
        ...
        g_RenderStateFlags.dword = (RENDER_TEX_ENABLE | RENDER_FORCE_SOLID_LOOP | RENDER_FOG_COLOR | RENDER_BLEND_READ_DEST | RENDER_ALPHA_FROM_VERTEX | RENDER_COLOR_FROM_VERTEX);
      }
      else {
