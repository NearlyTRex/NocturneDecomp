...

{
  ...
  local_e = (ushort)((uint)primitive[1].base.count >> 8);
  local_c = (ushort)((uint)primitive[1].surface_normal.C >> 8);
  local_a = (ushort)((uint)primitive[2].base.count >> 8);
  local_8 = (ushort)((uint)primitive[1].surface_normal.A >> 8);
  uStack_6 = (ushort)((uint)primitive[1].surface_normal.D >> 8);
