...

{
  ...
  fVar2 = (float)32768;
  fVar11 = (float10)fStack_14 * (float10)0.31830988619288902 * (float10)32768
  ;
  fVar12 = (float10)local_20.z * (float10)0.31830988619288902 *
           (float10)32768;
  ...
  dVar14 = crt_math_c_round_FUN_005fe6b0((double)(local_20.y * fVar3 * fVar2));
