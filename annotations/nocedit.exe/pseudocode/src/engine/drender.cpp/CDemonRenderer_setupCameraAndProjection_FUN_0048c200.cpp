...

{
  ...
  this_ptr->projection_reciprocal = (int)(0x100000000 / (longlong)g_ProjectionScale);
  iVar2 = g_ProjectionScale;
  iVar4 = ((iVar5 + 1) * 0x10000) / ((iVar3 - iVar6) + 1);
  this_ptr->aspect_ratio_fixed = iVar4;
  this_ptr->aspect_ratio_fixed =
       (int)((longlong)
             ((((longlong)iVar4 & 0xffffffffffffU) >> 0x10) << 0x20 |
             (longlong)iVar4 * 0x10000 & 0xffffffffU) / (longlong)iVar2);
  lVar1 = (longlong)this_ptr->projection_reciprocal * (longlong)g_TransformMatrix.m[0].x;
  g_TransformMatrix.m[0].x = (uint)lVar1 >> 0x10 | (int)((ulonglong)lVar1 >> 0x20) << 0x10;
  lVar2 = (longlong)this_ptr->projection_reciprocal * (longlong)g_TransformMatrix.m[1].x;
  g_TransformMatrix.m[1].x = (uint)lVar2 >> 0x10 | (int)((ulonglong)lVar2 >> 0x20) << 0x10;
  lVar2 = (longlong)this_ptr->projection_reciprocal * (longlong)g_TransformMatrix.m[2].x;
  g_TransformMatrix.m[2].x = (uint)lVar2 >> 0x10 | (int)((ulonglong)lVar2 >> 0x20) << 0x10;
  lVar2 = (longlong)this_ptr->aspect_ratio_fixed * (longlong)g_TransformMatrix.m[0].y;
  g_TransformMatrix.m[0].y = (uint)lVar2 >> 0x10 | (int)((ulonglong)lVar2 >> 0x20) << 0x10;
  lVar2 = (longlong)this_ptr->aspect_ratio_fixed * (longlong)g_TransformMatrix.m[1].y;
  g_TransformMatrix.m[1].y = (uint)lVar2 >> 0x10 | (int)((ulonglong)lVar2 >> 0x20) << 0x10;
  lVar2 = (longlong)this_ptr->aspect_ratio_fixed * (longlong)g_TransformMatrix.m[2].y;
