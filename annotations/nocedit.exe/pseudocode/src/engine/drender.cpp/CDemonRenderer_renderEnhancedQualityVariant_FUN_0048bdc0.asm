...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl engine_drender_cpp_CDemonRenderer_renderEnhancedQualityVariant_FUN_0048bdc0 (CDemonRenderer *this_ptr,SMRGLHeaderPrimitive *polygon_info)
;
; Parameters:
...
;
; XREF[5]:
;   core_curtain.cpp_CCurtain_FUN_0044b060 at 0044b20a
...
section .text
    ...
    MOV dword ptr [0x02d052a4],ESI      ; 0048be40 | g_RenderStateFlag2
    ...
    MOV dword ptr [0x02d052a4],EBP      ; 0048bea7 | g_RenderStateFlag2
