...
section .text
    ...
    JNZ 0x0048b7ee                      ; 0048b73f | LAB_0048b7ee
    ...
    JLE 0x0048b790                      ; 0048b758 | LAB_0048b790
        ;   XREF to: 0048b790 (CONDITIONAL_JUMP)
    XOR ECX,ECX                         ; 0048b75a
    MOV ESI,dword ptr [EAX + 0x18]      ; 0048b75c
        ;   Label: LAB_0048b75c
    MOV dword ptr [ECX + 0x2c6d5ac],ESI ; 0048b75f | int[16] g_VertexIndexBuffer
    ...
    JL 0x0048b75c                       ; 0048b786 | LAB_0048b75c
        ;   XREF to: 0048b75c (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 0048b788
    MOV EDX,EDX                         ; 0048b78e
    TEST byte ptr [ESP + 0x3],0x80      ; 0048b790
        ;   Label: LAB_0048b790
    JZ 0x0048b79d                       ; 0048b795 | LAB_0048b79d
        ;   XREF to: 0048b79d (CONDITIONAL_JUMP)
    TEST byte ptr [ESP],0x1f            ; 0048b797
    JNZ 0x0048b7e6                      ; 0048b79b | LAB_0048b7e6
        ;   XREF to: 0048b7e6 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x4],0x0       ; 0048b79d
        ;   Label: LAB_0048b79d
    JZ 0x0048b807                       ; 0048b7a1 | LAB_0048b807
        ;   XREF to: 0048b807 (CONDITIONAL_JUMP)
    MOV ESI,0x1                         ; 0048b7a3
    MOV ECX,0x4907e7                    ; 0048b7a8
    XOR EDI,EDI                         ; 0048b7ad
    MOV dword ptr [0x02d052a0],ESI      ; 0048b7af | int g_RenderStateFlags
    MOV dword ptr [0x02d052a4],EDI      ; 0048b7b5 | int g_RenderStateFlag2
    MOV dword ptr [0x02d0257c],ECX      ; 0048b7bb | RenderScanlineFunc * g_ScanlineRenderFunc
    LEA EAX,[EAX]                       ; 0048b7c1
    LEA EDX,[EDX]                       ; 0048b7c7
    LEA EAX,[EAX]                       ; 0048b7cd
    MOV EAX,dword ptr [ESP + 0x1c]      ; 0048b7d0
        ;   Label: LAB_0048b7d0
    PUSH 0x2c6d5ac                      ; 0048b7d4 | int[16] g_VertexIndexBuffer
    MOV EDX,dword ptr [EAX + 0x4]       ; 0048b7d9
    PUSH EDX                            ; 0048b7dc
    PUSH EBX                            ; 0048b7dd
    CALL engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740 ; 0048b7de | void engine_drender.cpp_CDemonRenderer_clipAndFillPoly_FUN_0048a740(CDemonRenderer * this_ptr, int vertex_count, int * vertex_indices)
    ...
    PUSH EAX                            ; 0048b7f5
    CALL engine_3d.c_isVisiblePlane_FUN_00403950 ; 0048b7f6 | int engine_3d.c_isVisiblePlane_FUN_00403950(SClipPlane * plane)
        ;   XREF to: 00403950 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0048b7fb
    TEST EAX,EAX                        ; 0048b7fe
    JZ 0x0048b7e6                       ; 0048b800 | LAB_0048b7e6
        ;   XREF to: 0048b7e6 (CONDITIONAL_JUMP)
    JMP 0x0048b745                      ; 0048b802 | LAB_0048b745
        ;   XREF to: 0048b745 (UNCONDITIONAL_JUMP)
    CMP dword ptr [0x0067939c],0x20     ; 0048b807 | int g_BitsPerPixel
        ;   Label: LAB_0048b807
    JNZ 0x0048b879                      ; 0048b80e | LAB_0048b879
        ;   XREF to: 0048b879 (CONDITIONAL_JUMP)
    MOV dword ptr [0x02d0257c],0x5b4031 ; 0048b810 | RenderScanlineFunc * g_ScanlineRenderFunc
    MOV EBP,0x6                         ; 0048b81a
        ;   Label: LAB_0048b81a
    MOV EDI,0x3e7                       ; 0048b81f
    MOV EAX,dword ptr [EBX + 0x20]      ; 0048b824
    MOV dword ptr [0x02d052a4],EBP      ; 0048b827 | int g_RenderStateFlag2
    MOV dword ptr [0x02d052a0],EDI      ; 0048b82d | int g_RenderStateFlags
    TEST EAX,EAX                        ; 0048b833
    JNZ 0x0048b7d0                      ; 0048b835 | LAB_0048b7d0
    ...
    JLE 0x0048b7d0                      ; 0048b842 | LAB_0048b7d0
        ;   XREF to: 0048b7d0 (CONDITIONAL_JUMP)
    XOR EDX,EDX                         ; 0048b844
    MOV ESI,dword ptr [EDX + 0x2c6d5ac] ; 0048b846 | int[16] g_VertexIndexBuffer
        ;   Label: LAB_0048b846
    ...
    JL 0x0048b846                       ; 0048b872 | LAB_0048b846
        ;   XREF to: 0048b846 (CONDITIONAL_JUMP)
    JMP 0x0048b7d0                      ; 0048b874 | LAB_0048b7d0
        ;   XREF to: 0048b7d0 (UNCONDITIONAL_JUMP)
    MOV dword ptr [0x02d0257c],0x5b4823 ; 0048b879 | RenderScanlineFunc * g_ScanlineRenderFunc
        ;   Label: LAB_0048b879
    JMP 0x0048b81a                      ; 0048b883 | LAB_0048b81a
