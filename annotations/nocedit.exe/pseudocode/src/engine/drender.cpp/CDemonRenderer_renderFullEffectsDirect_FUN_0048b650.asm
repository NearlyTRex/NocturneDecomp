...
section .text
    ...
    PUSH EBX                            ; 0048b650
        ;   Label: engine_drender.cpp_CDemonRenderer_renderFullEffectsDirect_FUN_0048b650
    PUSH ESI                            ; 0048b651
    PUSH EDI                            ; 0048b652
    PUSH EBP                            ; 0048b653
    ...
    MOV dword ptr [0x02d052a4],ECX      ; 0048b6b5 | g_VertexPreprocessMode
    ...
    MOV dword ptr [0x02d052a4],EDI      ; 0048b708 | g_VertexPreprocessMode
