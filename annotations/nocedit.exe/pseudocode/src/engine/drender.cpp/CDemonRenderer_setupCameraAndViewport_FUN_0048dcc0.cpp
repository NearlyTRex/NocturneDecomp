...

{
  ...
  g_TransformMatrix.m[0][0] = (camera_state->transform_matrix).m[0][0];
  g_TransformMatrix.m[0][1] = (camera_state->transform_matrix).m[0][1];
  g_TransformMatrix.m[0][2] = (camera_state->transform_matrix).m[0][2];
  g_TransformMatrix.m[1][0] = (camera_state->transform_matrix).m[1][0];
  g_TransformMatrix.m[1][1] = (camera_state->transform_matrix).m[1][1];
  g_TransformMatrix.m[1][2] = (camera_state->transform_matrix).m[1][2];
  g_TransformMatrix.m[2][0] = (camera_state->transform_matrix).m[2][0];
  g_TransformMatrix.m[2][1] = (camera_state->transform_matrix).m[2][1];
  g_TransformMatrix.m[2][2] = (camera_state->transform_matrix).m[2][2];
  g_InverseMatrix.m[0][0] = (camera_state->inverse_matrix).m[0][0];
  g_InverseMatrix.m[0][1] = (camera_state->inverse_matrix).m[0][1];
  g_InverseMatrix.m[0][2] = (camera_state->inverse_matrix).m[0][2];
  g_InverseMatrix.m[1][0] = (camera_state->inverse_matrix).m[1][0];
  g_InverseMatrix.m[1][1] = (camera_state->inverse_matrix).m[1][1];
  g_InverseMatrix.m[1][2] = (camera_state->inverse_matrix).m[1][2];
  g_InverseMatrix.m[2][0] = (camera_state->inverse_matrix).m[2][0];
  g_InverseMatrix.m[2][1] = (camera_state->inverse_matrix).m[2][1];
  g_InverseMatrix.m[2][2] = (camera_state->inverse_matrix).m[2][2];
