...
;   core_setedit.cpp_renderBackdropImage_FUN_0057ce80 at 0057d05b
...
section .text
    ...
    PUSH EAX                            ; 0048c214
    PUSH EBX                            ; 0048c215
    CALL core_dirmat.cpp_CMatrix3x3f_getEulerAngles_FUN_00472160 ; 0048c216
    ...
    FMUL double ptr [0x0062200d]        ; 0048c21d | g_FixedPointMatrixScale
    FLD float ptr [EBX + 0x4]           ; 0048c223
    FMUL double ptr [0x0062200d]        ; 0048c226 | g_FixedPointMatrixScale
    FLD float ptr [EBX + 0x8]           ; 0048c22c
    FMUL double ptr [0x0062200d]        ; 0048c22f | g_FixedPointMatrixScale
    FLD float ptr [EBX + 0xc]           ; 0048c235
    ADD ESP,0x8                         ; 0048c238
    FMUL double ptr [0x0062200d]        ; 0048c23b | g_FixedPointMatrixScale
    FLD float ptr [ESP]                 ; 0048c241
    FMUL double ptr [0x00621ffd]        ; 0048c244 | g_CameraRotationInvPi
    FLD float ptr [ESP + 0x8]           ; 0048c24a
    FMUL double ptr [0x00621ffd]        ; 0048c24e | g_CameraRotationInvPi
    FLD float ptr [ESP + 0x4]           ; 0048c254
    FMUL double ptr [0x00621ffd]        ; 0048c258 | g_CameraRotationInvPi
    FXCH ST2                            ; 0048c25e
    FMUL double ptr [0x00622005]        ; 0048c260 | g_CameraRotationFixedPoint
    FXCH                                ; 0048c266
    FMUL double ptr [0x00622005]        ; 0048c268 | g_CameraRotationFixedPoint
    FXCH ST2                            ; 0048c26e
    FMUL double ptr [0x00622005]        ; 0048c270 | g_CameraRotationFixedPoint
    FXCH ST6                            ; 0048c276
    CALL crt_math.c_round_FUN_005fe6b0  ; 0048c278
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    FISTP dword ptr [0x02d052e8]        ; 0048c27d | g_TransformMatrix
    FLD float ptr [EBX + 0x10]          ; 0048c283
    FMUL double ptr [0x0062200d]        ; 0048c286 | g_FixedPointMatrixScale
    FXCH ST5                            ; 0048c28c
    CALL crt_math.c_round_FUN_005fe6b0  ; 0048c28e
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    FISTP dword ptr [0x02d052ec]        ; 0048c293 | g_TransformMatrix[0][1]
    FLD float ptr [EBX + 0x14]          ; 0048c299
    FMUL double ptr [0x0062200d]        ; 0048c29c | g_FixedPointMatrixScale
    FXCH ST4                            ; 0048c2a2
    CALL crt_math.c_round_FUN_005fe6b0  ; 0048c2a4
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    FISTP dword ptr [0x02d052f0]        ; 0048c2a9 | g_TransformMatrix[0][2]
    FLD float ptr [EBX + 0x18]          ; 0048c2af
    FMUL double ptr [0x0062200d]        ; 0048c2b2 | g_FixedPointMatrixScale
    FXCH ST3                            ; 0048c2b8
    CALL crt_math.c_round_FUN_005fe6b0  ; 0048c2ba
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    FISTP dword ptr [0x02d052f4]        ; 0048c2bf | g_TransformMatrix[1][0]
    FLD float ptr [EBX + 0x1c]          ; 0048c2c5
    FMUL double ptr [0x0062200d]        ; 0048c2c8 | g_FixedPointMatrixScale
    FXCH ST5                            ; 0048c2ce
    CALL crt_math.c_round_FUN_005fe6b0  ; 0048c2d0
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    FISTP dword ptr [0x02d052f8]        ; 0048c2d5 | g_TransformMatrix[1][1]
    FLD float ptr [EBX + 0x20]          ; 0048c2db
    FMUL double ptr [0x0062200d]        ; 0048c2de | g_FixedPointMatrixScale
    MOV EDX,0x10000                     ; 0048c2e4
    MOV EBX,dword ptr [0x006793c0]      ; 0048c2e9 | g_ProjectionScale
    MOV EAX,EDX                         ; 0048c2ef
    FXCH ST4                            ; 0048c2f1
    CALL crt_math.c_round_FUN_005fe6b0  ; 0048c2f3
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    FXCH ST3                            ; 0048c2f8
    CALL crt_math.c_round_FUN_005fe6b0  ; 0048c2fa
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    FXCH ST5                            ; 0048c2ff
    CALL crt_math.c_round_FUN_005fe6b0  ; 0048c301
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    FXCH ST4                            ; 0048c306
    CALL crt_math.c_round_FUN_005fe6b0  ; 0048c308
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    FXCH ST3                            ; 0048c30d
    ...
    FXCH                                ; 0048c32b
    CALL crt_math.c_round_FUN_005fe6b0  ; 0048c32d
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    FXCH                                ; 0048c332
    CALL crt_math.c_round_FUN_005fe6b0  ; 0048c334
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    FXCH ST2                            ; 0048c339
    CALL crt_math.c_round_FUN_005fe6b0  ; 0048c33b
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    FXCH                                ; 0048c340
    FISTP dword ptr [0x02d052d0]        ; 0048c342 | g_CameraRotationPitch
    FXCH                                ; 0048c348
    FISTP dword ptr [0x02d052d4]        ; 0048c34a | g_CameraRotationYaw
    FISTP dword ptr [0x02d052d8]        ; 0048c350 | g_CameraRotationRoll
    IMUL EDX                            ; 0048c356
    IDIV EBX                            ; 0048c358
    MOV EDX,dword ptr [0x02d02560]      ; 0048c35a | g_ClipRight
    MOV ECX,dword ptr [0x02d02558]      ; 0048c360 | g_ClipLeft
    MOV EBX,dword ptr [0x02d02564]      ; 0048c366 | g_ClipBottom
    MOV EDI,dword ptr [0x02d0255c]      ; 0048c36c | g_ClipTop
    ...
    MOV EBX,dword ptr [0x006793c0]      ; 0048c38a | g_ProjectionScale
    MOV dword ptr [ESI + 0x28],EAX      ; 0048c390
    IMUL EDX                            ; 0048c393
    IDIV EBX                            ; 0048c395
    MOV dword ptr [ESI + 0x28],EAX      ; 0048c397
    MOV EDX,dword ptr [0x02d052e8]      ; 0048c39a | g_TransformMatrix
    MOV EAX,dword ptr [ESI + 0x24]      ; 0048c3a0
    IMUL EDX                            ; 0048c3a3
    SHRD EAX,EDX,0x10                   ; 0048c3a5
    MOV [0x02d052e8],EAX                ; 0048c3a9 | g_TransformMatrix
    ...
    CALL engine_matrix.c_invertTransformMatrix_FUN_0050c640 ; 0048c412
