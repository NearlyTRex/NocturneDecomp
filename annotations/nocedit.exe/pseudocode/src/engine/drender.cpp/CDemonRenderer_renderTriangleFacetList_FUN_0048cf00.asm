...
; int              Stack[0x14]:4   primitive_stride
; Local Variables:
...
section .text
    ...
    PUSH EBX                            ; 0048cf25
    PUSH ESI                            ; 0048cf26
    CALL engine_drender.cpp_CDemonRenderer_renderWireframeVariant_FUN_0048aeb0 ; 0048cf27 | void engine_drender.cpp_CDemonRenderer_renderWireframeVariant_FUN_0048aeb0(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * polygon_info, int render_flags)
    ...
    JL 0x0048cf20                       ; 0048cf38 | LAB_0048cf20
    ...
    CMP dword ptr [ESI + 0xc],0x0       ; 0048cf48
        ;   Label: LAB_0048cf48
    JNZ 0x0048cf1a                      ; 0048cf4c | LAB_0048cf1a
        ;   XREF to: 0048cf1a (CONDITIONAL_JUMP)
    CMP dword ptr [0x00772a7c],0x0      ; 0048cf4e | int g_CullingMode
    JZ 0x0048cf1a                       ; 0048cf55 | LAB_0048cf1a
        ;   XREF to: 0048cf1a (CONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0x4],0x0       ; 0048cf57
    JZ 0x0048cfbb                       ; 0048cf5b | LAB_0048cfbb
        ;   XREF to: 0048cfbb (CONDITIONAL_JUMP)
    MOV ESI,0x49072f                    ; 0048cf5d
    MOV dword ptr [0x02d052a0],EDX      ; 0048cf62 | int g_RenderStateFlags
    MOV dword ptr [0x02d052a4],EDX      ; 0048cf68 | int g_RenderStateFlag2
    MOV dword ptr [0x02d0257c],ESI      ; 0048cf6e | RenderScanlineFunc * g_ScanlineRenderFunc
    TEST EDI,EDI                        ; 0048cf74
    JLE 0x0048cf40                      ; 0048cf76 | LAB_0048cf40
        ;   XREF to: 0048cf40 (CONDITIONAL_JUMP)
    ...
    JNZ 0x0048cfa1                      ; 0048cf98 | LAB_0048cfa1
    ...
    CALL engine_drender.cpp_renderTriangleSimple_FUN_004839f0 ; 0048cfad | void engine_drender.cpp_renderTriangleSimple_FUN_004839f0(int * vertex_indices, int vertex_count)
        ;   XREF to: 004839f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0048cfb2
    TEST EDI,EDI                        ; 0048cfb5
    JLE 0x0048cf40                      ; 0048cfb7 | LAB_0048cf40
        ;   XREF to: 0048cf40 (CONDITIONAL_JUMP)
    JMP 0x0048cf7c                      ; 0048cfb9 | LAB_0048cf7c
        ;   XREF to: 0048cf7c (UNCONDITIONAL_JUMP)
    CMP dword ptr [0x0067939c],0x20     ; 0048cfbb | int g_BitsPerPixel
        ;   Label: LAB_0048cfbb
    JNZ 0x0048d0c0                      ; 0048cfc2 | LAB_0048d0c0
        ;   XREF to: 0048d0c0 (CONDITIONAL_JUMP)
    MOV dword ptr [0x02d0257c],0x5b4031 ; 0048cfc8 | RenderScanlineFunc * g_ScanlineRenderFunc
    MOV EAX,dword ptr [ESP + 0x3c]      ; 0048cfd2
        ;   Label: LAB_0048cfd2
    MOV [0x02d052a0],EAX                ; 0048cfd6 | int g_RenderStateFlags
    MOV EAX,0x6                         ; 0048cfdb
    MOV EDX,dword ptr [0x02d03e94]      ; 0048cfe0 | int g_UseExternalRenderer
    MOV [0x02d052a4],EAX                ; 0048cfe6 | int g_RenderStateFlag2
    TEST EDX,EDX                        ; 0048cfeb
    JNZ 0x0048d0cf                      ; 0048cfed | LAB_0048d0cf
        ;   XREF to: 0048d0cf (CONDITIONAL_JUMP)
    TEST EDI,EDI                        ; 0048cff3
        ;   Label: LAB_0048cff3
    JLE 0x0048cf40                      ; 0048cff5 | LAB_0048cf40
        ;   XREF to: 0048cf40 (CONDITIONAL_JUMP)
    ...
    JZ 0x0048d162                       ; 0048d017 | LAB_0048d162
        ;   XREF to: 0048d162 (CONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0x20],0x0      ; 0048d01d
        ;   Label: LAB_0048d01d
    JNZ 0x0048d0a3                      ; 0048d021 | LAB_0048d0a3
    ...
    JNZ 0x0048d0a3                      ; 0048d083 | LAB_0048d0a3
        ;   XREF to: 0048d0a3 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 0048d0ab
    CALL engine_drender.cpp_renderTriangleTextured_FUN_00483370 ; 0048d0ac | void engine_drender.cpp_renderTriangleTextured_FUN_00483370(int * vertex_indices, int vertex_count)
        ;   XREF to: 00483370 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0048d0b1
    MOV EBP,dword ptr [ESP + 0x38]      ; 0048d0b4
    DEC EDI                             ; 0048d0b8
    ADD EBX,EBP                         ; 0048d0b9
    JMP 0x0048cff3                      ; 0048d0bb | LAB_0048cff3
        ;   XREF to: 0048cff3 (UNCONDITIONAL_JUMP)
    MOV dword ptr [0x02d0257c],0x5b4823 ; 0048d0c0 | RenderScanlineFunc * g_ScanlineRenderFunc
        ;   Label: LAB_0048d0c0
    JMP 0x0048cfd2                      ; 0048d0ca | LAB_0048cfd2
        ;   XREF to: 0048cfd2 (UNCONDITIONAL_JUMP)
    XOR EBP,EBP                         ; 0048d0cf
        ;   Label: LAB_0048d0cf
    MOV dword ptr [ESP + 0x14],EBP      ; 0048d0d1
    TEST EDI,EDI                        ; 0048d0d5
    JLE 0x0048d13a                      ; 0048d0d7 | LAB_0048d13a
        ;   XREF to: 0048d13a (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x10],EBP      ; 0048d0d9
    PUSH EBX                            ; 0048d0dd
        ;   Label: LAB_0048d0dd
    CALL engine_prim.c_getTriangleWindingFromIndices_FUN_00552210 ; 0048d0de | int engine_prim.c_getTriangleWindingFromIndices_FUN_00552210(STriangleIndices * triangle)
        ;   XREF to: 00552210 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0048d0e3
    TEST EAX,EAX                        ; 0048d0e6
    JZ 0x0048d127                       ; 0048d0e8 | LAB_0048d127
        ;   XREF to: 0048d127 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x10]      ; 0048d0ea
    INC EBP                             ; 0048d0ee
    LEA EDX,[EAX + 0x4]                 ; 0048d0ef
    MOV dword ptr [EAX + 0x6703f4],EBX  ; 0048d0f2 | SInputFace *[2000] g_VisibleFacePointers
    MOV dword ptr [ESP + 0x10],EDX      ; 0048d0f8
    CMP EBP,0x7d0                       ; 0048d0fc
    JL 0x0048d127                       ; 0048d102 | LAB_0048d127
        ;   XREF to: 0048d127 (CONDITIONAL_JUMP)
    PUSH EBP                            ; 0048d104
    MOV ECX,0x62208d                    ; 0048d105 | = "..\\engine\\drender.cpp" | s_engine_drender_cpp_0062208d = ..\engine\drender.cpp
    MOV EAX,0x9b6                       ; 0048d10a
    PUSH 0x6220a3                       ; 0048d10f | = "CDemonRenderer::demonGZFacetList - To..." | s_CDemonRenderer_demonGZFa_006220a3 = CDemonRenderer::demonGZFacetList - Too many visible faces at once : %d
    MOV dword ptr [0x02f0ca48],ECX      ; 0048d114 | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 0048d11a | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0048d11f | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    JG 0x0048d0dd                       ; 0048d138 | LAB_0048d0dd
        ;   XREF to: 0048d0dd (CONDITIONAL_JUMP)
    TEST EBP,EBP                        ; 0048d13a
        ;   Label: LAB_0048d13a
    JLE 0x0048cf40                      ; 0048d13c | LAB_0048cf40
        ;   XREF to: 0048cf40 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [0x02d052a0]      ; 0048d142 | int g_RenderStateFlags
    PUSH EBX                            ; 0048d148
    PUSH EBP                            ; 0048d149
    PUSH 0x6703f4                       ; 0048d14a | SInputFace *[2000] g_VisibleFacePointers
    MOV EDI,dword ptr [ESI]             ; 0048d14f
    PUSH EDI                            ; 0048d151
    CALL wincore_windll.cpp_drawPolyList_FUN_005b7640 ; 0048d152 | int wincore_windll.cpp_drawPolyList_FUN_005b7640(void * vertex_buffer, void * * polygons, int polygon_count, int render_flags)
    ...
    JMP 0x0048d01d                      ; 0048d169 | LAB_0048d01d
