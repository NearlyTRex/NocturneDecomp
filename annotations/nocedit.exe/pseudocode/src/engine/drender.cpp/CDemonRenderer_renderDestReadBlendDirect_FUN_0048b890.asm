...
section .text
    ...
    PUSH EBX                            ; 0048b890
        ;   Label: engine_drender.cpp_CDemonRenderer_renderDestReadBlendDirect_FUN_0048b890
    PUSH ESI                            ; 0048b891
    PUSH EDI                            ; 0048b892
    PUSH EBP                            ; 0048b893
    ...
    MOV dword ptr [0x02d052a4],ECX      ; 0048b8f5 | g_VertexPreprocessMode
    ...
    MOV dword ptr [0x02d052a4],EDI      ; 0048b948 | g_VertexPreprocessMode
