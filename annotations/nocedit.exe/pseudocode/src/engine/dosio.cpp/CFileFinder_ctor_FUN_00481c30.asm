...
;   engine_dosio.cpp_getFileSizeWithFinder_FUN_00481960 at 0048198c
...
section .text
    ...
    PUSH EBX                            ; 00481c30
        ;   Label: engine_dosio.cpp_CFileFinder_ctor_FUN_00481c30
    MOV EBX,dword ptr [ESP + 0x8]       ; 00481c31
    PUSH EBX                            ; 00481c35
    MOV dword ptr [EBX + 0x10c],0x0     ; 00481c36
    CALL engine_dosio.cpp_CFileFinder_reset_FUN_00481db0 ; 00481c40
