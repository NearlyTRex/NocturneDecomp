...
;   engine_dosio.cpp_findFile_FUN_00481760 at 004817a1
...
section .text
    ...
    PUSH EBX                            ; 004817c0
        ;   Label: engine_dosio.cpp_findFileNormally_FUN_004817c0
    ...
    PUSH EAX                            ; 004817e6
    CALL engine_dosio.cpp_getFullPath_FUN_004820c0 ; 004817e7
