...
section .text
    ...
    SUB ESP,0x214                       ; 004818d0
        ;   Label: engine_dosio.cpp_getFileTimestamp_FUN_004818d0
    ...
    PUSH EAX                            ; 004818ea
    CALL engine_dosio.cpp_getRelativeFilePath_FUN_004816c0 ; 004818eb
    ...
    PUSH EAX                            ; 004818f5
    CALL engine_dosio.cpp_findFile_FUN_00481760 ; 004818f6
