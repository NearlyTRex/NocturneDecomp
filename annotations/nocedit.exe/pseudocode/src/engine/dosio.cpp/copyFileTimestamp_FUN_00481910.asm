...
; Local Variables:
; WatcomStat       Stack[-0x50]:70  _Stack_50
; WatcomUtimbuf    Stack[-0x8]:8  local_8
;
; XREF[7]:
...
section .text
    ...
    SUB ESP,0x50                        ; 00481910
        ;   Label: engine_dosio.cpp_copyFileTimestamp_FUN_00481910
    ...
    PUSH ECX                            ; 00481944
    CALL crt_io.c__utime_FUN_00600c1e   ; 00481945
        ;   XREF to: 00600c1e (UNCONDITIONAL_CALL)  ; int crt_io.c__utime_FUN_00600c1e(char * filename, WatcomUtimbuf * timestamps)
