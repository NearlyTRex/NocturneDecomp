...
;   engine_dosio.cpp_CFileFinder_dtor_FUN_00481c50 at 00481c56
;   engine_dosio.cpp_CFileFinder_openSearch_FUN_00481c70 at 00481c7f
...
section .text
    ...
    PUSH EBX                            ; 00481d70
        ;   Label: engine_dosio.cpp_CFileFinder_closeSearch_FUN_00481d70
    ...
    PUSH EBX                            ; 00481d7e
    CALL engine_dosio.cpp_CFileFinder_reset_FUN_00481db0 ; 00481d7f
    ...
    PUSH EBX                            ; 00481da1
    CALL engine_dosio.cpp_CFileFinder_reset_FUN_00481db0 ; 00481da2
        ;   XREF to: 00481db0 (UNCONDITIONAL_CALL)  ; void engine_dosio.cpp_CFileFinder_reset_FUN_00481db0(CFileFinder * this_ptr)
