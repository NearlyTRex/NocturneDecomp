...
;   core_msnedit.cpp_convertAllMissionFiles_FUN_00537230 at 0053724f
;   core_podmain.cpp_CDemonPod_load_FUN_005519c0 at 00551a09
;   engine_dosio.cpp_getFileSizeWithFinder_FUN_00481960 at 0048199f
...
section .text
    ...
    PUSH EBX                            ; 00481c70
        ;   Label: engine_dosio.cpp_CFileFinder_openSearch_FUN_00481c70
    SUB ESP,0x140                       ; 00481c71
    MOV EBX,dword ptr [ESP + 0x148]     ; 00481c77
    PUSH EBX                            ; 00481c7e
    CALL engine_dosio.cpp_CFileFinder_closeSearch_FUN_00481d70 ; 00481c7f
    ...
    PUSH EBX                            ; 00481cd3
        ;   Label: LAB_00481cd3
    CALL engine_dosio.cpp_CFileFinder_reset_FUN_00481db0 ; 00481cd4
