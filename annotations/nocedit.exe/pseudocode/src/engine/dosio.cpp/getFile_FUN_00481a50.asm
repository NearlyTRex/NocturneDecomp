...
section .text
    ...
    PUSH EBX                            ; 00481a50
        ;   Label: engine_dosio.cpp_getFile_FUN_00481a50
    PUSH ESI                            ; 00481a51
    PUSH EDI                            ; 00481a52
    ...
    CALL engine_dosio.cpp_getRelativeFilePath_FUN_004816c0 ; 00481a77
    ...
    MOV EAX,ESP                         ; 00481ad0
        ;   Label: LAB_00481ad0
    PUSH EAX                            ; 00481ad2
    CALL engine_dosio.cpp_findFile_FUN_00481760 ; 00481ad3
