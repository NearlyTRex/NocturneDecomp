...
;   engine_dosio.cpp_getFileSize_FUN_00481880 at 004818a6
;   engine_dosio.cpp_getFileTimestamp_FUN_004818d0 at 004818f6
;   engine_dosio.cpp_getFile_FUN_00481a50 at 00481ad3
;   engine_dosio.cpp_reopenFileStream_FUN_00481b50 at 00481bd8
...
section .text
    ...
    PUSH EBX                            ; 00481760
        ;   Label: engine_dosio.cpp_findFile_FUN_00481760
    PUSH ESI                            ; 00481761
    PUSH EDI                            ; 00481762
    PUSH EBP                            ; 00481763
    ...
    PUSH EDI                            ; 004817a0
        ;   Label: LAB_004817a0
    CALL engine_dosio.cpp_findFileNormally_FUN_004817c0 ; 004817a1
