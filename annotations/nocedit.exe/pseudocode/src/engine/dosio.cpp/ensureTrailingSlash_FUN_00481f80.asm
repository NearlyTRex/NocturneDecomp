...
section .text
    ...
    PUSH EBX                            ; 00481f80
        ;   Label: engine_dosio.cpp_ensureTrailingSlash_FUN_00481f80
    PUSH EDI                            ; 00481f81
    ...
    PUSH ECX                            ; 00481fb1
    CALL engine_dosio.cpp_splitPath_FUN_00481f20 ; 00481fb2
    ...
    PUSH 0x0                            ; 00481fcd
    PUSH EBX                            ; 00481fcf
    CALL engine_dosio.cpp_makePath_FUN_00481f50 ; 00481fd0
