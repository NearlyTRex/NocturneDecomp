...
section .text
    ...
    PUSH EBX                            ; 00481960
        ;   Label: engine_dosio.cpp_getFileSizeWithFinder_FUN_00481960
    ...
    PUSH EAX                            ; 0048197b
    CALL engine_dosio.cpp_getRelativeFilePath_FUN_004816c0 ; 0048197c
    ...
    PUSH EAX                            ; 0048198b
    CALL engine_dosio.cpp_CFileFinder_ctor_FUN_00481c30 ; 0048198c
    ...
    PUSH EAX                            ; 0048199e
    CALL engine_dosio.cpp_CFileFinder_openSearch_FUN_00481c70 ; 0048199f
    ...
    JZ 0x004819ce                       ; 004819a9
        ;   XREF to: 004819ce (CONDITIONAL_JUMP)  ; LAB_004819ce
    PUSH 0x0                            ; 004819ab
    LEA EAX,[ESP + 0x218]               ; 004819ad
    PUSH EAX                            ; 004819b4
    MOV EBX,dword ptr [ESP + 0x31c]     ; 004819b5
    CALL engine_dosio.cpp_CFileFinder_dtor_FUN_00481c50 ; 004819bc
    ...
    CALL engine_dosio.cpp_CFileFinder_dtor_FUN_00481c50 ; 004819dc
        ;   XREF to: 00481c50 (UNCONDITIONAL_CALL)  ; CFileFinder * engine_dosio.cpp_CFileFinder_dtor_FUN_00481c50(CFileFinder * this_ptr, uint flags)
