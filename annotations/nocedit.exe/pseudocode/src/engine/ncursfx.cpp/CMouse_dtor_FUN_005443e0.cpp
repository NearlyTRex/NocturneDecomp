...

{
  ...
  pCVar1 = (CMouse_ptr_300)engine_ncursfx_cpp_CAlphaBitmap_arrdtor2_FUN_00544750(this_ptr->skulls,0)
  ;
  pCVar2 = (CMouse_ptr_160)
           engine_ncursfx_cpp_CAlphaBitmap_arrdtor1_FUN_00544730(ADJ(pCVar1)->flames,0);
