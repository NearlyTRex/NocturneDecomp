...
section .text
    ...
    CMP BL,0xa                          ; 0044197a
    JZ 0x004419e3                       ; 0044197d
        ;   XREF to: 004419e3 (CONDITIONAL_JUMP)  ; LAB_004419e3
    TEST BL,BL                          ; 0044197f
    JZ 0x00441a17                       ; 00441981
        ;   XREF to: 00441a17 (CONDITIONAL_JUMP)  ; LAB_00441a17
    ...
    JGE 0x004419e0                      ; 004419bc
        ;   XREF to: 004419e0 (CONDITIONAL_JUMP)  ; LAB_004419e0
    ...
    JL 0x00441a05                       ; 004419de
        ;   XREF to: 00441a05 (CONDITIONAL_JUMP)  ; LAB_00441a05
    POP EDI                             ; 004419e0
        ;   Label: LAB_004419e0
    POP EBX                             ; 004419e1
    RET                                 ; 004419e2
    ...
    JGE 0x004419e0                      ; 00441a03
        ;   XREF to: 004419e0 (CONDITIONAL_JUMP)  ; LAB_004419e0
    PUSH EAX                            ; 00441a05
        ;   Label: LAB_00441a05
    MOV dword ptr [EAX + 0xfa8],EDX     ; 00441a06
    CALL engine_console.cpp_CConsole_scrollUp_FUN_00441a80 ; 00441a0c
        ;   XREF to: 00441a80 (UNCONDITIONAL_CALL)  ; void engine_console.cpp_CConsole_scrollUp_FUN_00441a80(CConsole * this_ptr)
