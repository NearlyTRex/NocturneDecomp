...
section .text
    ...
    JLE 0x00441bb4                      ; 00441b1f | LAB_00441bb4
    ...
    JLE 0x00441b89                      ; 00441b38 | LAB_00441b89
    ...
    TEST AL,AL                          ; 00441b4e
    JZ 0x00441b7a                       ; 00441b50 | LAB_00441b7a
    ...
    PUSH EAX                            ; 00441b71
    CALL engine_2d.c_drawString_FUN_00402080 ; 00441b72 | void engine_2d.c_drawString_FUN_00402080(char * text, int x_pos, int y_pos, int color)
    ...
    JL 0x00441b47                       ; 00441b87 | LAB_00441b47
    ...
    JL 0x00441b2e                       ; 00441bae | LAB_00441b2e
    ...
    PUSH ESI                            ; 00441bf2
    MOV dword ptr [0x02d02570],ECX      ; 00441bf3 | int g_ActiveRenderColor
    CALL engine_2d.c_drawLine_FUN_004011b0 ; 00441bf9 | void engine_2d.c_drawLine_FUN_004011b0(int x1, int y1, int x2, int y2)
    ...
    PUSH EBX                            ; 00441c04
    PUSH ESI                            ; 00441c05
    CALL engine_2d.c_drawLine_FUN_004011b0 ; 00441c06 | void engine_2d.c_drawLine_FUN_004011b0(int x1, int y1, int x2, int y2)
        ;   XREF to: 004011b0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDI                            ; 00441c11
    PUSH ESI                            ; 00441c12
    CALL engine_2d.c_drawLine_FUN_004011b0 ; 00441c13 | void engine_2d.c_drawLine_FUN_004011b0(int x1, int y1, int x2, int y2)
        ;   XREF to: 004011b0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDI                            ; 00441c1e
    PUSH EBP                            ; 00441c1f
    CALL engine_2d.c_drawLine_FUN_004011b0 ; 00441c20 | void engine_2d.c_drawLine_FUN_004011b0(int x1, int y1, int x2, int y2)
        ;   XREF to: 004011b0 (UNCONDITIONAL_CALL)
