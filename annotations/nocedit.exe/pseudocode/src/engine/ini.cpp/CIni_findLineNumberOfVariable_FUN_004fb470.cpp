...

{
  ...
  while (((stream->_flag & 0x10) == 0 &&
         (pcVar5 = crt_stdio_c_fgets_FUN_005fefd0(local_214,0xff,stream), pcVar5 != (char *)0x0))) {
    iVar4 = crt_string_c_strcmp_FUN_005fef20(local_214,local_114);
    if (iVar4 == 0) {
...
LAB_004fb4f0:
  if (((bVar1 & 0x10) != 0) ||
     (pcVar3 = crt_stdio_c_fgets_FUN_005fefd0(local_214,0xff,stream), pcVar5 = local_214,
...
LAB_004fb550:
  ...
  iVar4 = crt_string_c_strcmp_FUN_005fef20(local_214,key);
  if (iVar4 == 0) {
    bVar2 = true;
    iVar4 = crt_string_c_strcmp_FUN_005fef20(local_14 + 1,filename);
    if (iVar4 == 0) {
