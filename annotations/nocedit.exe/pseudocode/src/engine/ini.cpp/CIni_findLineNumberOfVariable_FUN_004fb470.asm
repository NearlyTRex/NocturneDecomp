...
section .text
    ...
    PUSH 0xf4                           ; 004fb47a
    PUSH 0x62fb0e                       ; 004fb47f | = "..\\engine\\ini.cpp" | s_engine_ini_cpp_0062fb0e = ..\engine\ini.cpp
    PUSH 0x62fb20                       ; 004fb484 | = "rt" | s_rt_0062fb20 = rt
    ...
    CALL shape_memdbg.cpp_openFile_FUN_0050f7a0 ; 004fb4a3 | FILE * shape_memdbg.cpp_openFile_FUN_0050f7a0(char * filename, char * directory, char * mode, char * source_file, ...)
        ;   XREF to: 0050f7a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 004fb4a8
    MOV EDI,EAX                         ; 004fb4ab
    TEST EAX,EAX                        ; 004fb4ad
    JZ 0x004fb5d3                       ; 004fb4af | LAB_004fb5d3
    ...
    PUSH EAX                            ; 004fb500
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 004fb501 | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004fb506
    TEST EAX,EAX                        ; 004fb509
    JZ 0x004fb5ab                       ; 004fb50b | LAB_004fb5ab
        ;   XREF to: 004fb5ab (CONDITIONAL_JUMP)
    MOV DL,0xa                          ; 004fb511
    ...
    MOV AL,byte ptr [ESI]               ; 004fb515
        ;   Label: LAB_004fb515
    CMP AL,DL                           ; 004fb517
    JZ 0x004fb52d                       ; 004fb519 | LAB_004fb52d
        ;   XREF to: 004fb52d (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 004fb51b
    JZ 0x004fb52b                       ; 004fb51d | LAB_004fb52b
        ;   XREF to: 004fb52b (CONDITIONAL_JUMP)
    INC ESI                             ; 004fb51f
    MOV AL,byte ptr [ESI]               ; 004fb520
    CMP AL,DL                           ; 004fb522
    JZ 0x004fb52d                       ; 004fb524 | LAB_004fb52d
        ;   XREF to: 004fb52d (CONDITIONAL_JUMP)
    INC ESI                             ; 004fb526
    CMP AL,0x0                          ; 004fb527
    JNZ 0x004fb515                      ; 004fb529 | LAB_004fb515
        ;   XREF to: 004fb515 (CONDITIONAL_JUMP)
    SUB ESI,ESI                         ; 004fb52b
        ;   Label: LAB_004fb52b
    TEST ESI,ESI                        ; 004fb52d
        ;   Label: LAB_004fb52d
    JZ 0x004fb534                       ; 004fb52f | LAB_004fb534
    ...
    MOV AL,byte ptr [ESI]               ; 004fb538
        ;   Label: LAB_004fb538
    CMP AL,DL                           ; 004fb53a
    JZ 0x004fb550                       ; 004fb53c | LAB_004fb550
        ;   XREF to: 004fb550 (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 004fb53e
    JZ 0x004fb54e                       ; 004fb540 | LAB_004fb54e
        ;   XREF to: 004fb54e (CONDITIONAL_JUMP)
    INC ESI                             ; 004fb542
    MOV AL,byte ptr [ESI]               ; 004fb543
    CMP AL,DL                           ; 004fb545
    JZ 0x004fb550                       ; 004fb547 | LAB_004fb550
        ;   XREF to: 004fb550 (CONDITIONAL_JUMP)
    INC ESI                             ; 004fb549
    CMP AL,0x0                          ; 004fb54a
    JNZ 0x004fb538                      ; 004fb54c | LAB_004fb538
    ...
    JZ 0x004fb55e                       ; 004fb559 | LAB_004fb55e
    ...
    PUSH EAX                            ; 004fb56a
    CALL crt_string.c_strcmp_FUN_005fef20 ; 004fb56b | int crt_string.c_strcmp_FUN_005fef20(char * str1, char * str2)
        ;   XREF to: 005fef20 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004fb570
    TEST EAX,EAX                        ; 004fb573
    JNZ 0x004fb639                      ; 004fb575 | LAB_004fb639
    ...
    PUSH EAX                            ; 004fb591
    CALL crt_string.c_strcmp_FUN_005fef20 ; 004fb592 | int crt_string.c_strcmp_FUN_005fef20(char * str1, char * str2)
        ;   XREF to: 005fef20 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004fb597
    TEST EAX,EAX                        ; 004fb59a
    JNZ 0x004fb5ab                      ; 004fb59c | LAB_004fb5ab
        ;   XREF to: 004fb5ab (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x218]     ; 004fb59e
    MOV dword ptr [EAX],0x0             ; 004fb5a5
    PUSH 0x154                          ; 004fb5ab
        ;   Label: LAB_004fb5ab
    PUSH 0x62fb70                       ; 004fb5b0 | = "..\\engine\\ini.cpp" | s_engine_ini_cpp_0062fb70 = ..\engine\ini.cpp
    PUSH EDI                            ; 004fb5b5
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 004fb5b6 | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
        ;   XREF to: 0050f9b0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004fb5bb
    TEST EBP,EBP                        ; 004fb5be
    JZ 0x004fb645                       ; 004fb5c0 | LAB_004fb645
    ...
    POP EBX                             ; 004fb5d1
    RET                                 ; 004fb5d2
    MOV ECX,0x62fb23                    ; 004fb5d3 | = "..\\engine\\ini.cpp" | s_engine_ini_cpp_0062fb23 = ..\engine\ini.cpp
        ;   Label: LAB_004fb5d3
    MOV ESI,0xf5                        ; 004fb5d8
    PUSH 0x62fb35                       ; 004fb5dd | = "cIni::FindLineNumberOfVariable: Unabl..." | s_cIni_FindLineNumberOfVar_0062fb35 = cIni::FindLineNumberOfVariable: Unable to open input
    MOV dword ptr [0x02f0ca48],ECX      ; 004fb5e2 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 004fb5e8 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004fb5ee | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004fb5f3
    JMP 0x004fb4b5                      ; 004fb5f6 | LAB_004fb4b5
    ...
    PUSH EAX                            ; 004fb605
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 004fb606 | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004fb60b
    TEST EAX,EAX                        ; 004fb60e
    JZ 0x004fb4e0                       ; 004fb610 | LAB_004fb4e0
        ;   XREF to: 004fb4e0 (CONDITIONAL_JUMP)
    LEA EAX,[ESP + 0x100]               ; 004fb616
    PUSH EAX                            ; 004fb61d
    LEA EAX,[ESP + 0x4]                 ; 004fb61e
    PUSH EAX                            ; 004fb622
    CALL crt_string.c_strcmp_FUN_005fef20 ; 004fb623 | int crt_string.c_strcmp_FUN_005fef20(char * str1, char * str2)
        ;   XREF to: 005fef20 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004fb628
    TEST EAX,EAX                        ; 004fb62b
    JZ 0x004fb4e8                       ; 004fb62d | LAB_004fb4e8
        ;   XREF to: 004fb4e8 (CONDITIONAL_JUMP)
    INC EBX                             ; 004fb633
    JMP 0x004fb4d2                      ; 004fb634 | LAB_004fb4d2
        ;   XREF to: 004fb4d2 (UNCONDITIONAL_JUMP)
    MOV DH,byte ptr [EDI + 0xc]         ; 004fb639
        ;   Label: LAB_004fb639
    INC EBX                             ; 004fb63c
    TEST DH,0x10                        ; 004fb63d
    JMP 0x004fb4f0                      ; 004fb640 | LAB_004fb4f0
