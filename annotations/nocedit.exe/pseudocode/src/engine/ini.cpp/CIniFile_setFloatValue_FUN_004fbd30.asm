...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_ini.cpp_CIniFile_setFloatValue_FUN_004fbd30(CIniFile * this, char * key, float value)
;
; Parameters:
...
section .text
    ...
    PUSH 0x62fd8e                       ; 004fbd3d | = "%g" | s_g_0062fd8e = %g
    LEA EAX,[ESP + 0xc]                 ; 004fbd42
    PUSH EAX                            ; 004fbd46
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 004fbd47 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH ECX                            ; 004fbd5b
    CALL engine_ini.cpp_CIniFile_setString_FUN_004fbbb0 ; 004fbd5c | void engine_ini.cpp_CIniFile_setString_FUN_004fbbb0(CIniFile * this, char * key, char * value)
