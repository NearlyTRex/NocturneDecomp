...
section .text
    ...
    PUSH 0x56                           ; 004fb25a
    PUSH 0x62faa2                       ; 004fb25c | = "..\\engine\\ini.cpp" | s_engine_ini_cpp_0062faa2 = ..\engine\ini.cpp
    PUSH 0x62fab4                       ; 004fb261 | = "rt" | s_rt_0062fab4 = rt
    XOR EDI,EDI                         ; 004fb266
    PUSH EDI                            ; 004fb268
    MOV EDX,dword ptr [ESP + 0x23c]     ; 004fb269
    PUSH EDX                            ; 004fb270
    CALL shape_memdbg.cpp_openFile_FUN_0050f7a0 ; 004fb271 | FILE * shape_memdbg.cpp_openFile_FUN_0050f7a0(char * filename, char * directory, char * mode, char * source_file, ...)
        ;   XREF to: 0050f7a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 004fb276
    MOV EBX,EAX                         ; 004fb279
    TEST EAX,EAX                        ; 004fb27b
    JZ 0x004fb326                       ; 004fb27d | LAB_004fb326
    ...
    PUSH EAX                            ; 004fb2c6
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 004fb2c7 | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004fb2cc
    TEST EAX,EAX                        ; 004fb2cf
    JNZ 0x004fb394                      ; 004fb2d1 | LAB_004fb394
        ;   XREF to: 004fb394 (CONDITIONAL_JUMP)
    PUSH 0x99                           ; 004fb2d7
        ;   Label: LAB_004fb2d7
    PUSH 0x62fafc                       ; 004fb2dc | = "..\\engine\\ini.cpp" | s_engine_ini_cpp_0062fafc = ..\engine\ini.cpp
    PUSH EBX                            ; 004fb2e1
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 004fb2e2 | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
        ;   XREF to: 0050f9b0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004fb2e7
    TEST EDI,EDI                        ; 004fb2ea
    JZ 0x004fb3dc                       ; 004fb2ec | LAB_004fb3dc
    ...
    JL 0x004fb436                       ; 004fb311 | LAB_004fb436
    ...
    POP EBX                             ; 004fb324
    RET                                 ; 004fb325
    MOV ECX,0x62fab7                    ; 004fb326 | = "..\\engine\\ini.cpp" | s_engine_ini_cpp_0062fab7 = ..\engine\ini.cpp
        ;   Label: LAB_004fb326
    MOV ESI,0x57                        ; 004fb32b
    PUSH 0x62fac9                       ; 004fb330 | = "cIni::getProfileString: Unable to ope..." | s_cIni_getProfileString_Un_0062fac9 = cIni::getProfileString: Unable to open input
    MOV dword ptr [0x02f0ca48],ECX      ; 004fb335 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 004fb33b | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004fb341 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004fb346
    JMP 0x004fb283                      ; 004fb349 | LAB_004fb283
    ...
    PUSH EAX                            ; 004fb358
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 004fb359 | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004fb35e
    TEST EAX,EAX                        ; 004fb361
    JZ 0x004fb2ae                       ; 004fb363 | LAB_004fb2ae
        ;   XREF to: 004fb2ae (CONDITIONAL_JUMP)
    LEA EAX,[ESP + 0x100]               ; 004fb369
    PUSH EAX                            ; 004fb370
    LEA EAX,[ESP + 0x4]                 ; 004fb371
    PUSH EAX                            ; 004fb375
    CALL crt_string.c_strcmp_FUN_005fef20 ; 004fb376 | int crt_string.c_strcmp_FUN_005fef20(char * str1, char * str2)
        ;   XREF to: 005fef20 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004fb37b
    TEST EAX,EAX                        ; 004fb37e
    JZ 0x004fb2b2                       ; 004fb380 | LAB_004fb2b2
        ;   XREF to: 004fb2b2 (CONDITIONAL_JUMP)
    JMP 0x004fb2a0                      ; 004fb386 | LAB_004fb2a0
        ;   XREF to: 004fb2a0 (UNCONDITIONAL_JUMP)
    TEST byte ptr [EBX + 0xc],0x10      ; 004fb38b
        ;   Label: LAB_004fb38b
    JMP 0x004fb2ba                      ; 004fb38f | LAB_004fb2ba
    ...
    MOV AL,byte ptr [ESI]               ; 004fb398
        ;   Label: LAB_004fb398
    CMP AL,DL                           ; 004fb39a
    JZ 0x004fb3b0                       ; 004fb39c | LAB_004fb3b0
        ;   XREF to: 004fb3b0 (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 004fb39e
    JZ 0x004fb3ae                       ; 004fb3a0 | LAB_004fb3ae
        ;   XREF to: 004fb3ae (CONDITIONAL_JUMP)
    INC ESI                             ; 004fb3a2
    MOV AL,byte ptr [ESI]               ; 004fb3a3
    CMP AL,DL                           ; 004fb3a5
    JZ 0x004fb3b0                       ; 004fb3a7 | LAB_004fb3b0
        ;   XREF to: 004fb3b0 (CONDITIONAL_JUMP)
    INC ESI                             ; 004fb3a9
    CMP AL,0x0                          ; 004fb3aa
    JNZ 0x004fb398                      ; 004fb3ac | LAB_004fb398
    ...
    JZ 0x004fb3b9                       ; 004fb3b4 | LAB_004fb3b9
    ...
    PUSH EAX                            ; 004fb3c5
    CALL crt_string.c_strcmp_FUN_005fef20 ; 004fb3c6 | int crt_string.c_strcmp_FUN_005fef20(char * str1, char * str2)
        ;   XREF to: 005fef20 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004fb3cb
    TEST EAX,EAX                        ; 004fb3ce
    JNZ 0x004fb38b                      ; 004fb3d0 | LAB_004fb38b
        ;   XREF to: 004fb38b (CONDITIONAL_JUMP)
    MOV EDI,0x1                         ; 004fb3d2
    JMP 0x004fb2d7                      ; 004fb3d7 | LAB_004fb2d7
    ...
    JGE 0x004fb317                      ; 004fb3f6 | LAB_004fb317
    ...
    CMP AL,0x0                          ; 004fb40f
    JZ 0x004fb423                       ; 004fb411 | LAB_004fb423
    ...
    CMP AL,0x0                          ; 004fb41f
    JNZ 0x004fb40b                      ; 004fb421 | LAB_004fb40b
    ...
    CMP AL,0x0                          ; 004fb444
    JZ 0x004fb458                       ; 004fb446 | LAB_004fb458
    ...
    CMP AL,0x0                          ; 004fb454
    JNZ 0x004fb440                      ; 004fb456 | LAB_004fb440
