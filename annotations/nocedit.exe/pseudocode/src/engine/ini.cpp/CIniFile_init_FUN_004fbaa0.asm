...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_ini.cpp_CIniFile_init_FUN_004fbaa0(char * dest, char * source)
;
; Parameters:
...
section .text
    ...
    JNZ 0x004fbab4                      ; 004fbaac | LAB_004fbab4
    ...
    CMP AL,0x0                          ; 004fbab9
    JZ 0x004fbacd                       ; 004fbabb | LAB_004fbacd
    ...
    CMP AL,0x0                          ; 004fbac9
    JNZ 0x004fbab5                      ; 004fbacb | LAB_004fbab5
