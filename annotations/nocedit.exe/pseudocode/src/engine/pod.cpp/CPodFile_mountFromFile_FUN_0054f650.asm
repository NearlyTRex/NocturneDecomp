...
; SPod3Header      Stack[-0x490]:288  local_490
; SEpdHeader       Stack[-0x370]:272  local_370
; char[256]        Stack[-0x260]:256  local_260
; SPod2Header      Stack[-0x160]:96  local_160
; SPod1Header      Stack[-0x100]:84  local_100
; SEpdDirEntry     Stack[-0xac]:80  local_ac
; SPod1DirEntry    Stack[-0x5c]:40  local_5c
; int              Stack[-0x34]:4  local_34
; char[4] *        Stack[-0x30]:4  local_30
