...
; Local Variables:
; SFoundFileInfo   Stack[-0x6a4]:532  local_6a4
; undefined1[8]    Stack[-0x490]:8  local_490
; char[84]         Stack[-0x488]:84  local_488
; char[80]         Stack[-0x434]:80  local_434
; char[80]         Stack[-0x3e4]:80  local_3e4
; int              Stack[-0x394]:4  local_394
; long             Stack[-0x390]:4  local_390
; int              Stack[-0x388]:4  local_388
; SIZE_T           Stack[-0x384]:4  local_384
; int              Stack[-0x380]:4  local_380
; int              Stack[-0x378]:4  local_378
; undefined1[4]    Stack[-0x370]:4  local_370
; char[256]        Stack[-0x36c]:256  local_36c
; int              Stack[-0x26c]:4  local_26c
; char[256]        Stack[-0x260]:256  local_260
; undefined1[8]    Stack[-0x160]:8  local_160
; char[80]         Stack[-0x158]:80  local_158
; int              Stack[-0x108]:4  local_108
; int              Stack[-0x104]:4  local_104
; int              Stack[-0x100]:4  local_100
; char[80]         Stack[-0xfc]:80  local_fc
; char[64]         Stack[-0xac]:64  local_ac
; undefined4       Stack[-0x6c]:4  local_6c
; undefined4       Stack[-0x68]:4  local_68
; undefined4       Stack[-0x60]:4  local_60
; char[32]         Stack[-0x5c]:32  local_5c
; undefined4       Stack[-0x3c]:4  local_3c
; undefined4       Stack[-0x38]:4  local_38
; int              Stack[-0x34]:4  local_34
; char             Stack[-0x30]:1  local_30
; char             Stack[-0x2f]:1  local_2f
; char             Stack[-0x2e]:1  local_2e
