...
;                               FUNCTION
; *****************************************************************************
; __cdecl int engine_pod.cpp_CPod_verifyIntegrity_FUN_00551280(CPod * this_ptr, char * pod_filename)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 00551289
    CALL engine_pod.cpp_CPodFile_ctor_FUN_0054f5a0 ; 0055128a | CPodFile * engine_pod.cpp_CPodFile_ctor_FUN_0054f5a0(CPodFile * this_ptr)
    ...
    PUSH EAX                            ; 0055129e
    CALL engine_pod.cpp_CPodFile_mountFromFile_FUN_0054f650 ; 0055129f | int engine_pod.cpp_CPodFile_mountFromFile_FUN_0054f650(CPodFile * this_ptr, char * pod_filename)
        ;   XREF to: 0054f650 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005512a4
    TEST EAX,EAX                        ; 005512a7
    JZ 0x005512d1                       ; 005512a9 | LAB_005512d1
        ;   XREF to: 005512d1 (CONDITIONAL_JUMP)
    MOV EAX,ESP                         ; 005512ab
    PUSH EAX                            ; 005512ad
    CALL engine_pod.cpp_CPodFile_verifyChecksum_FUN_00550230 ; 005512ae | int engine_pod.cpp_CPodFile_verifyChecksum_FUN_00550230(CPodFile * this_ptr)
    ...
    PUSH EAX                            ; 005512be
    CALL engine_pod.cpp_CPodFile_dtor_FUN_0054f610 ; 005512bf | CPodFile * engine_pod.cpp_CPodFile_dtor_FUN_0054f610(CPodFile * this_ptr)
    ...
    CALL engine_pod.cpp_CPodFile_dtor_FUN_0054f610 ; 005512d9 | CPodFile * engine_pod.cpp_CPodFile_dtor_FUN_0054f610(CPodFile * this_ptr)
        ;   XREF to: 0054f610 (UNCONDITIONAL_CALL)
