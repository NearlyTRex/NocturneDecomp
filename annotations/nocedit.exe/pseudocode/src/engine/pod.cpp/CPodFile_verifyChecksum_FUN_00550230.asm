...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl engine_pod_cpp_CPodFile_verifyChecksum_FUN_00550230(CPodFile *this_ptr)
;
; Parameters:
...
section .text
    ...
    JZ 0x00550404                       ; 00550245
        ;   XREF to: 00550404 (CONDITIONAL_JUMP)  ; LAB_00550404
    CMP byte ptr [EBX + 0x4],0x0        ; 0055024b
    JZ 0x00550404                       ; 0055024f
        ;   XREF to: 00550404 (CONDITIONAL_JUMP)  ; LAB_00550404
    CMP EDX,0xc8                        ; 00550255
    JZ 0x00550413                       ; 0055025b
        ;   XREF to: 00550413 (CONDITIONAL_JUMP)  ; LAB_00550413
    MOV ECX,dword ptr [EBX]             ; 00550261
        ;   Label: LAB_00550261
    MOV ESI,0xffffffff                  ; 00550263
    CMP ECX,0x1                         ; 00550268
    JNZ 0x0055053d                      ; 0055026b
        ;   XREF to: 0055053d (CONDITIONAL_JUMP)  ; LAB_0055053d
    MOV ESI,0x54                        ; 00550271
    LEA EDI,[EBX + 0x4]                 ; 00550276
        ;   Label: LAB_00550276
    PUSH EDI                            ; 00550279
    PUSH 0x6403d2                       ; 0055027a | = "Verifying CRC for %s..."
    ...
    PUSH 0x6403fc                       ; 00550298 | = "rb"
    PUSH 0x0                            ; 0055029d
    PUSH EDI                            ; 0055029f
    CALL shape_memdbg.cpp_openFile_FUN_0050f7a0 ; 005502a0
    ...
    JZ 0x00550554                       ; 005502ac
        ;   XREF to: 00550554 (CONDITIONAL_JUMP)  ; LAB_00550554
    PUSH 0x0                            ; 005502b2
    LEA EAX,[ESI + -0x4]                ; 005502b4
    PUSH EAX                            ; 005502b7
    PUSH EBX                            ; 005502b8
    CALL crt_stdio.c_fseek_FUN_005ffacc ; 005502b9
    ...
    PUSH EAX                            ; 005502cd
    CALL crt_stdio.c_fread_FUN_005fd990 ; 005502ce
    ...
    PUSH 0x2f3                          ; 005502d6
    PUSH 0x6403ff                       ; 005502db | = "..\\engine\\pod.cpp"
    PUSH EBX                            ; 005502e0
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 005502e1
    ...
    PUSH 0x640171                       ; 00550301 | = "rb"
    PUSH 0x0                            ; 00550306
    PUSH EDI                            ; 00550308
    MOV EBX,EAX                         ; 00550309
    CALL shape_memdbg.cpp_openFile_FUN_0050f7a0 ; 0055030b
        ;   XREF to: 0050f7a0 (UNCONDITIONAL_CALL)  ; FILE * shape_memdbg.cpp_openFile_FUN_0050f7a0(char * filename, char * directory, char * mode, char * source_file, ...)
    ...
    CALL crt_stdio.c_fseek_FUN_005ffacc ; 00550329
        ;   XREF to: 005ffacc (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fseek_FUN_005ffacc(FILE * file, long offset, int whence)
    ADD ESP,0xc                         ; 0055032e
    CMP EBX,0x10000                     ; 00550331
    JL 0x0055037f                       ; 00550337
        ;   XREF to: 0055037f (CONDITIONAL_JUMP)  ; LAB_0055037f
    PUSH EBP                            ; 00550339
        ;   Label: LAB_00550339
    PUSH 0x1                            ; 0055033a
    PUSH 0x10000                        ; 0055033c
    PUSH 0x30d5090                      ; 00550341 | g_FileIOBuffer
    MOV EBX,0x30d5090                   ; 00550346 | g_FileIOBuffer
    CALL crt_stdio.c_fread_FUN_005fd990 ; 0055034b
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)  ; SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
    ...
    JC 0x00550357                       ; 0055036d
        ;   XREF to: 00550357 (CONDITIONAL_JUMP)  ; LAB_00550357
    SUB EDI,0x10000                     ; 0055036f
    MOV ESI,EAX                         ; 00550375
    CMP EDI,0x10000                     ; 00550377
    JGE 0x00550339                      ; 0055037d
        ;   XREF to: 00550339 (CONDITIONAL_JUMP)  ; LAB_00550339
    PUSH EBP                            ; 0055037f
        ;   Label: LAB_0055037f
    PUSH 0x1                            ; 00550380
    PUSH EDI                            ; 00550382
    PUSH 0x30d5090                      ; 00550383 | g_FileIOBuffer
    MOV EBX,0x30d5090                   ; 00550388 | g_FileIOBuffer
    MOV EBP,ESI                         ; 0055038d
    CALL crt_stdio.c_fread_FUN_005fd990 ; 0055038f
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)  ; SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
    ADD ESP,0x10                        ; 00550394
    XOR ESI,ESI                         ; 00550397
    MOV dword ptr [ESP + 0x3b0],EDI     ; 00550399
    TEST EDI,EDI                        ; 005503a0
    JBE 0x005503d0                      ; 005503a2
        ;   XREF to: 005503d0 (CONDITIONAL_JUMP)  ; LAB_005503d0
    ...
    JC 0x005503ab                       ; 005503bf
        ;   XREF to: 005503ab (CONDITIONAL_JUMP)  ; LAB_005503ab
    LEA EAX,[EAX]                       ; 005503c1
    LEA EDX,[EDX]                       ; 005503c7
    LEA EAX,[EAX]                       ; 005503cd
    PUSH 0xfb                           ; 005503d0
        ;   Label: LAB_005503d0
    PUSH 0x640174                       ; 005503d5 | = "..\\engine\\pod.cpp"
    MOV EAX,dword ptr [ESP + 0x3b4]     ; 005503da
    PUSH EAX                            ; 005503e1
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 005503e2
        ;   XREF to: 0050f9b0 (UNCONDITIONAL_CALL)  ; int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
    ...
    POP EBX                             ; 00550411
    RET                                 ; 00550412
    PUSH 0x64035d                       ; 00550413 | = "Checking individual file CRCs"
        ;   Label: LAB_00550413
    MOV ESI,dword ptr [0x00678a60]      ; 00550418 | g_CEditorToolsPtr
    PUSH ESI                            ; 0055041e | g_CEditorToolsInstance
    CALL shape_edittool.cpp_CEditorTools_showCenteredProgressDialog_FUN_004a0430 ; 0055041f
    ...
    CALL shape_edittool.cpp_CPickList_ctor_FUN_004a3b90 ; 0055042c
        ;   XREF to: 004a3b90 (UNCONDITIONAL_CALL)  ; CPickList * shape_edittool.cpp_CPickList_ctor_FUN_004a3b90(CPickList * this_ptr)
    MOV EBP,dword ptr [EBX + 0x410]     ; 00550431
    ADD ESP,0x4                         ; 00550437
    TEST EBP,EBP                        ; 0055043a
    JLE 0x005504e2                      ; 0055043c
        ;   XREF to: 005504e2 (CONDITIONAL_JUMP)  ; LAB_005504e2
    ...
    MOV EAX,[0x00678a60]                ; 00550490 | g_CEditorToolsInstance | g_CEditorToolsPtr
    FSTP float ptr [ESP]                ; 00550495
    PUSH EAX                            ; 00550498 | g_CEditorToolsInstance
    CALL shape_edittool.cpp_CEditorTools_updatePercentage_FUN_004a0530 ; 00550499
    ...
    CALL engine_pod.cpp_CPodFile_computeFileCRC_FUN_005507f0 ; 005504a9
    ...
    JZ 0x005504d0                       ; 005504b7
        ;   XREF to: 005504d0 (CONDITIONAL_JUMP)  ; LAB_005504d0
    MOV EAX,dword ptr [EBX + 0x414]     ; 005504b9
    MOV ECX,dword ptr [ESI + EAX*0x1]   ; 005504bf
    PUSH ECX                            ; 005504c2
    LEA EAX,[ESP + 0x4]                 ; 005504c3
    PUSH EAX                            ; 005504c7
    CALL shape_edittool.cpp_CStrList_add_FUN_004a2b80 ; 005504c8
    ...
    JL 0x00550444                       ; 005504dc
        ;   XREF to: 00550444 (CONDITIONAL_JUMP)  ; LAB_00550444
    MOV EAX,[0x00678a60]                ; 005504e2 | g_CEditorToolsInstance | g_CEditorToolsPtr
        ;   Label: LAB_005504e2
    PUSH EAX                            ; 005504e7 | g_CEditorToolsInstance
    CALL shape_edittool.cpp_CEditorTools_restoreWindowAndCleanup_FUN_004a0dd0 ; 005504e8
    ...
    JNZ 0x0055050a                      ; 005504f5
        ;   XREF to: 0055050a (CONDITIONAL_JUMP)  ; LAB_0055050a
    PUSH EDX                            ; 005504f7
    LEA EAX,[ESP + 0x4]                 ; 005504f8
    PUSH EAX                            ; 005504fc
    CALL shape_edittool.cpp_CPickList_dtor_FUN_004a3c80 ; 005504fd
    ...
    JMP 0x00550261                      ; 00550505
        ;   XREF to: 00550261 (UNCONDITIONAL_JUMP)  ; LAB_00550261
    PUSH 0x0                            ; 0055050a
        ;   Label: LAB_0055050a
    PUSH -0x1                           ; 0055050c
    PUSH 0x64037b                       ; 0055050e | = "!!!CRC CHECK FAILED!! on these files:"
    LEA EAX,[ESP + 0xc]                 ; 00550513
    PUSH EAX                            ; 00550517
    CALL shape_edittool.cpp_CPickList_displayChoicesAndWaitForInput_FUN_004a3e20 ; 00550518
    ...
    PUSH EAX                            ; 00550527
    CALL shape_edittool.cpp_CPickList_dtor_FUN_004a3c80 ; 00550528
        ;   XREF to: 004a3c80 (UNCONDITIONAL_CALL)  ; CPickList * shape_edittool.cpp_CPickList_dtor_FUN_004a3c80(CPickList * this_ptr, uint d1, uint d2, uint d3, ...)
    ...
    CMP ECX,0xc8                        ; 0055053d
        ;   Label: LAB_0055053d
    JNZ 0x0055054f                      ; 00550543
        ;   XREF to: 0055054f (CONDITIONAL_JUMP)  ; LAB_0055054f
    MOV ESI,0x8                         ; 00550545
    JMP 0x00550276                      ; 0055054a
        ;   XREF to: 00550276 (UNCONDITIONAL_JUMP)  ; LAB_00550276
    CMP ECX,0x64                        ; 0055054f
        ;   Label: LAB_0055054f
    JNZ 0x00550563                      ; 00550552
        ;   XREF to: 00550563 (CONDITIONAL_JUMP)  ; LAB_00550563
    ...
    POP EBX                             ; 00550561
    RET                                 ; 00550562
    MOV EAX,0x6403a1                    ; 00550563 | = "..\\engine\\pod.cpp"
        ;   Label: LAB_00550563
    PUSH ECX                            ; 00550568
    MOV [0x02f0ca48],EAX                ; 00550569 | g_CurrentFilename
    LEA EAX,[EBX + 0x4]                 ; 0055056e
    PUSH EAX                            ; 00550571
    MOV EDX,0x2e6                       ; 00550572
    PUSH 0x6403b3                       ; 00550577 | = "Invalid pod version for %s: %d"
    MOV dword ptr [0x02f0ca4c],EDX      ; 0055057c | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00550582
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ADD ESP,0xc                         ; 00550587
    JMP 0x00550276                      ; 0055058a
        ;   XREF to: 00550276 (UNCONDITIONAL_JUMP)  ; LAB_00550276
