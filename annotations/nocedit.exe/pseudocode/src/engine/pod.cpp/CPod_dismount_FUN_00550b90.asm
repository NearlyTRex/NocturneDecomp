...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_pod.cpp_CPod_dismount_FUN_00550b90(CPod * this_ptr, char * filename)
;
; Parameters:
...
section .text
    ...
    CMP AL,0x0                          ; 00550baf
    JZ 0x00550bc3                       ; 00550bb1 | LAB_00550bc3
    ...
    CMP AL,0x0                          ; 00550bbf
    JNZ 0x00550bab                      ; 00550bc1 | LAB_00550bab
        ;   XREF to: 00550bab (CONDITIONAL_JUMP)
    POP EDI                             ; 00550bc3
        ;   Label: LAB_00550bc3
    MOV EAX,ESP                         ; 00550bc4
    PUSH EAX                            ; 00550bc6
    CALL engine_dosio.c_findFileNormally_FUN_004817c0 ; 00550bc7 | int engine_dosio.c_findFileNormally_FUN_004817c0(SFoundFileInfo * info)
        ;   XREF to: 004817c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00550bcc
    TEST EAX,EAX                        ; 00550bcf
    JZ 0x00550c02                       ; 00550bd1 | LAB_00550c02
        ;   XREF to: 00550c02 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [EBP]             ; 00550bd3
    XOR EBX,EBX                         ; 00550bd6
    TEST EDX,EDX                        ; 00550bd8
    JLE 0x00550c02                      ; 00550bda | LAB_00550c02
        ;   XREF to: 00550c02 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 00550bec
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 00550bed | int crt_string.c_stricmp_FUN_005fe7f0(char * str1, char * str2)
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00550bf2
    TEST EAX,EAX                        ; 00550bf5
    JZ 0x00550c0d                       ; 00550bf7 | LAB_00550c0d
        ;   XREF to: 00550c0d (CONDITIONAL_JUMP)
    INC EBX                             ; 00550bf9
    ADD ESI,0x4                         ; 00550bfa
    CMP EBX,dword ptr [EBP]             ; 00550bfd
    JL 0x00550bde                       ; 00550c00 | LAB_00550bde
    ...
    PUSH EBX                            ; 00550c0d
        ;   Label: LAB_00550c0d
    PUSH EBP                            ; 00550c0e
    CALL engine_pod.cpp_CPod_dismountPod_FUN_005518c0 ; 00550c0f | void engine_pod.cpp_CPod_dismountPod_FUN_005518c0(CPod * this_ptr, int index)
        ;   XREF to: 005518c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00550c14
    CMP EBX,dword ptr [EBP]             ; 00550c17
    JL 0x00550bde                       ; 00550c1a | LAB_00550bde
        ;   XREF to: 00550bde (CONDITIONAL_JUMP)
