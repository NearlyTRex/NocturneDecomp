...
;   core_msnedit.cpp_CheckWorldMountedAndSave_FUN_0053d190 at 0053d1ae
...
section .text
    ...
    CALL engine_dosio.c_getRelativeFilePath_FUN_004816c0 ; 00551318 | void engine_dosio.c_getRelativeFilePath_FUN_004816c0(char * dest_path, char * directory, char * filename)
        ;   XREF to: 004816c0 (UNCONDITIONAL_CALL)
    MOV ESI,dword ptr [EDI]             ; 0055131d
    ADD ESP,0xc                         ; 0055131f
    TEST ESI,ESI                        ; 00551322
    JLE 0x00551366                      ; 00551324 | LAB_00551366
    ...
    PUSH EAX                            ; 0055132e
    CALL engine_pod.cpp_CPodFile_findFileIndex_FUN_00550140 ; 0055132f | int engine_pod.cpp_CPodFile_findFileIndex_FUN_00550140(CPodFile * this_ptr, char * filename)
        ;   XREF to: 00550140 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00551334
    TEST EAX,EAX                        ; 00551337
    JL 0x0055135c                       ; 00551339 | LAB_0055135c
        ;   XREF to: 0055135c (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [ESP + 0x234]     ; 0055133b
    TEST EDX,EDX                        ; 00551342
    JZ 0x00551348                       ; 00551344 | LAB_00551348
    ...
    JL 0x00551328                       ; 00551364 | LAB_00551328
