...
section .text
    ...
    JL 0x0054f442                       ; 0054f3f6 | LAB_0054f442
    ...
    PUSH 0x30d5090                      ; 0054f404 | char[65536] g_FileIOBuffer
    MOV ESI,0x30d5090                   ; 0054f409 | char[65536] g_FileIOBuffer
    XOR EBX,EBX                         ; 0054f40e
    CALL crt_stdio.c_fread_FUN_005fd990 ; 0054f410 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0054f415
    MOV EAX,EBP                         ; 0054f418
    XOR EDX,EDX                         ; 0054f41a
        ;   Label: LAB_0054f41a
    MOV DL,byte ptr [ESI]               ; 0054f41c | char[65536] g_FileIOBuffer
    PUSH EDX                            ; 0054f41e
    PUSH EAX                            ; 0054f41f
    INC ESI                             ; 0054f420
    INC EBX                             ; 0054f421
    CALL engine_pod.cpp_crc32UpdateByte_FUN_0054f2e0 ; 0054f422 | uint engine_pod.cpp_crc32UpdateByte_FUN_0054f2e0(uint current_crc, uchar data_byte)
        ;   XREF to: 0054f2e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0054f427
    CMP EBX,0x10000                     ; 0054f42a
    JC 0x0054f41a                       ; 0054f430 | LAB_0054f41a
        ;   XREF to: 0054f41a (CONDITIONAL_JUMP)
    SUB EDI,0x10000                     ; 0054f432
    MOV EBP,EAX                         ; 0054f438
    CMP EDI,0x10000                     ; 0054f43a
    JGE 0x0054f3f8                      ; 0054f440 | LAB_0054f3f8
    ...
    PUSH 0x1                            ; 0054f447
    PUSH EDI                            ; 0054f449
    PUSH 0x30d5090                      ; 0054f44a | char[65536] g_FileIOBuffer
    MOV EBX,0x30d5090                   ; 0054f44f | char[65536] g_FileIOBuffer
    XOR ESI,ESI                         ; 0054f454
    CALL crt_stdio.c_fread_FUN_005fd990 ; 0054f456 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0054f45b
    MOV EAX,EBP                         ; 0054f45e
    MOV dword ptr [ESP],EDI             ; 0054f460
    TEST EDI,EDI                        ; 0054f463
    JBE 0x0054f480                      ; 0054f465 | LAB_0054f480
        ;   XREF to: 0054f480 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [ESP]             ; 0054f467
    XOR EDX,EDX                         ; 0054f46a
        ;   Label: LAB_0054f46a
    MOV DL,byte ptr [EBX]               ; 0054f46c | char[65536] g_FileIOBuffer
    PUSH EDX                            ; 0054f46e
    PUSH EAX                            ; 0054f46f
    INC EBX                             ; 0054f470
    INC ESI                             ; 0054f471
    CALL engine_pod.cpp_crc32UpdateByte_FUN_0054f2e0 ; 0054f472 | uint engine_pod.cpp_crc32UpdateByte_FUN_0054f2e0(uint current_crc, uchar data_byte)
        ;   XREF to: 0054f2e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0054f477
    CMP ESI,EDI                         ; 0054f47a
    JC 0x0054f46a                       ; 0054f47c | LAB_0054f46a
