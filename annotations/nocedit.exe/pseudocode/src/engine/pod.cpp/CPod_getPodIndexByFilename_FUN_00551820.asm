...
;                               FUNCTION
; *****************************************************************************
; __cdecl int engine_pod.cpp_CPod_getPodIndexByFilename_FUN_00551820(CPod * this_ptr, char * target_filename)
;
; Parameters:
...
section .text
    ...
    CALL engine_dosio.c_splitPath_FUN_00481f20 ; 00551849 | void engine_dosio.c_splitPath_FUN_00481f20(char * full_path, char * drive, char * directory, char * filename, ...)
        ;   XREF to: 00481f20 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [EDI]             ; 0055184e
    ADD ESP,0x14                        ; 00551850
    TEST ECX,ECX                        ; 00551853
    JLE 0x00551894                      ; 00551855 | LAB_00551894
    ...
    PUSH EAX                            ; 0055186a
    CALL engine_dosio.c_splitPath_FUN_00481f20 ; 0055186b | void engine_dosio.c_splitPath_FUN_00481f20(char * full_path, char * drive, char * directory, char * filename, ...)
        ;   XREF to: 00481f20 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0055187d
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 0055187e | int crt_string.c_stricmp_FUN_005fe7f0(char * str1, char * str2)
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00551883
    TEST EAX,EAX                        ; 00551886
    JZ 0x005518a4                       ; 00551888 | LAB_005518a4
        ;   XREF to: 005518a4 (CONDITIONAL_JUMP)
    INC EBX                             ; 0055188a
    MOV EBP,dword ptr [EDI]             ; 0055188b
    ADD ESI,0x4                         ; 0055188d
    CMP EBX,EBP                         ; 00551890
    JL 0x00551859                       ; 00551892 | LAB_00551859
