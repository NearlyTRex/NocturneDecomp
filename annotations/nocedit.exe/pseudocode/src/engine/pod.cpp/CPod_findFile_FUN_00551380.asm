...
;                               FUNCTION
; *****************************************************************************
; __cdecl int engine_pod.cpp_CPod_findFile_FUN_00551380(CPod * this_ptr, SFoundFileInfo * found_file_info)
;
; Parameters:
...
section .text
    ...
    JLE 0x005513b1                      ; 00551392 | LAB_005513b1
    ...
    PUSH EAX                            ; 0055139a
    CALL engine_pod.cpp_CPodFile_findFileIndex_FUN_00550140 ; 0055139b | int engine_pod.cpp_CPodFile_findFileIndex_FUN_00550140(CPodFile * this_ptr, char * filename)
        ;   XREF to: 00550140 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005513a0
    TEST EAX,EAX                        ; 005513a3
    JGE 0x005513b8                      ; 005513a5 | LAB_005513b8
        ;   XREF to: 005513b8 (CONDITIONAL_JUMP)
    INC ESI                             ; 005513a7
    MOV ECX,dword ptr [EDI]             ; 005513a8
    ADD EBX,0x4                         ; 005513aa
    CMP ESI,ECX                         ; 005513ad
    JL 0x00551396                       ; 005513af | LAB_00551396
    ...
    PUSH EDX                            ; 005513bd
    CALL engine_pod.cpp_CPodFile_populateFileInfo_FUN_005501b0 ; 005513be | void engine_pod.cpp_CPodFile_populateFileInfo_FUN_005501b0(CPodFile * this_ptr, int file_index, SFoundFileInfo * output_info)
