...
;                               FUNCTION
; *****************************************************************************
; __cdecl int engine_pod.cpp_findFileInPod_FUN_00551960(SFoundFileInfo * info)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [0x00680cdc]      ; 00551960 | CDemonPod * g_CDemonPodPtr
        ;   Label: engine_pod.cpp_findFileInPod_FUN_00551960
    TEST EDX,EDX                        ; 00551966
    JNZ 0x0055196d                      ; 00551968 | LAB_0055196d
    ...
    PUSH EAX                            ; 0055197a | CDemonPod g_CDemonPodInstance
