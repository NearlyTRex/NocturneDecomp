...
;                               FUNCTION
; *****************************************************************************
; __cdecl uint engine_pod.cpp_crc32UpdateByte_FUN_0054f2e0(uint current_crc, uchar data_byte)
;
; Parameters:
...
section .text
    ...
    JZ 0x0054f37f                       ; 0054f31c | LAB_0054f37f
    ...
    JZ 0x0054f383                       ; 0054f32d | LAB_0054f383
    ...
    JZ 0x0054f387                       ; 0054f33e | LAB_0054f387
    ...
    JZ 0x0054f38b                       ; 0054f34f | LAB_0054f38b
    ...
    JZ 0x0054f38f                       ; 0054f360 | LAB_0054f38f
    ...
    JZ 0x0054f393                       ; 0054f371 | LAB_0054f393
