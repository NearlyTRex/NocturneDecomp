...
section .text
    ...
    JL 0x005f2669                       ; 005f2483 | LAB_005f2669
    ...
    MOV CL,byte ptr [EAX + 0x2d01f48]   ; 005f249e | char[768] g_SourcePaletteData
    ...
    JZ 0x005f24f9                       ; 005f24c3 | LAB_005f24f9
    ...
    MOV CL,byte ptr [EAX + 0x2d01f48]   ; 005f24dd | char[768] g_SourcePaletteData
    ...
    CMP AL,0x0                          ; 005f2505
    JZ 0x005f2519                       ; 005f2507 | LAB_005f2519
    ...
    CMP AL,0x0                          ; 005f2515
    JNZ 0x005f2501                      ; 005f2517 | LAB_005f2501
    ...
    PUSH ESI                            ; 005f256a
    CALL dword ptr CS:[0x6113fc]        ; 005f256b | TextOutA * TextOutA
    MOV EAX,dword ptr [ESP]             ; 005f2572
        ;   Label: LAB_005f2572
    PUSH EAX                            ; 005f2575
    MOV EDX,dword ptr [EBX + 0x4]       ; 005f2576
    PUSH EDX                            ; 005f2579
    CALL dword ptr CS:[0x6113f8]        ; 005f257a | SetTextColor * SetTextColor
    PUSH EDI                            ; 005f2581
    PUSH EBP                            ; 005f2582
    PUSH 0x0                            ; 005f2583
    PUSH 0x0                            ; 005f2585
    ...
    PUSH ECX                            ; 005f258a
    CALL dword ptr CS:[0x6113fc]        ; 005f258b | TextOutA * TextOutA
    MOV ESI,dword ptr [ESP + 0x44]      ; 005f2592
        ;   Label: LAB_005f2592
    MOV EAX,dword ptr [EBX + 0x120]     ; 005f2596
    MOV EDI,dword ptr [0x00679394]      ; 005f259c | int g_WindowWidth
    ADD EAX,ESI                         ; 005f25a2
    CMP EAX,EDI                         ; 005f25a4
    JL 0x005f26e5                       ; 005f25a6 | LAB_005f26e5
    ...
    MOV ECX,dword ptr [0x00679398]      ; 005f25ba | int g_WindowHeight
    ADD EAX,EDX                         ; 005f25c0
    CMP EAX,ECX                         ; 005f25c2
    JL 0x005f26f0                       ; 005f25c4 | LAB_005f26f0
    ...
    JLE 0x005f25de                      ; 005f25da | LAB_005f25de
    ...
    JLE 0x005f25f0                      ; 005f25ea | LAB_005f25f0
        ;   XREF to: 005f25f0 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x10],EDX      ; 005f25ec
    CMP dword ptr [0x0067939c],0x10     ; 005f25f0 | int g_BitsPerPixel
        ;   Label: LAB_005f25f0
    JNZ 0x005f27d7                      ; 005f25f7 | LAB_005f27d7
    ...
    JLE 0x005f2647                      ; 005f2609 | LAB_005f2647
    ...
    JL 0x005f262d                       ; 005f261f | LAB_005f262d
        ;   XREF to: 005f262d (CONDITIONAL_JUMP)
    CMP EAX,dword ptr [0x00679398]      ; 005f2621 | int g_WindowHeight
    JL 0x005f26fb                       ; 005f2627 | LAB_005f26fb
    ...
    JL 0x005f2613                       ; 005f2645 | LAB_005f2613
    ...
    PUSH EAX                            ; 005f2653
    CALL crt_string.c_strcmp_FUN_005fef20 ; 005f2654 | int crt_string.c_strcmp_FUN_005fef20(char * str1, char * str2)
        ;   XREF to: 005fef20 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005f2659
    TEST EAX,EAX                        ; 005f265c
    JNZ 0x005f246b                      ; 005f265e | LAB_005f246b
        ;   XREF to: 005f246b (CONDITIONAL_JUMP)
    JMP 0x005f2592                      ; 005f2664 | LAB_005f2592
        ;   XREF to: 005f2592 (UNCONDITIONAL_JUMP)
    CALL engine_font.cpp_getDefaultTextColor_FUN_004ce220 ; 005f2669 | int engine_font.cpp_getDefaultTextColor_FUN_004ce220()
        ;   Label: LAB_005f2669
        ;   XREF to: 004ce220 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [0x0067939c]      ; 005f266e | int g_BitsPerPixel
    MOV dword ptr [ESP],EAX             ; 005f2674
    CMP EDX,0x10                        ; 005f2677
    JNZ 0x005f24bc                      ; 005f267a | LAB_005f24bc
        ;   XREF to: 005f24bc (CONDITIONAL_JUMP)
    MOV CL,byte ptr [0x02d01f24]        ; 005f2680 | int g_RedBitPosition
    MOV EDX,EAX                         ; 005f2686
    SHR EDX,CL                          ; 005f2688
    MOV CL,byte ptr [0x02d01f2c]        ; 005f268a | int g_RedBitCount
    SHL EDX,CL                          ; 005f2690
    AND EDX,0xff                        ; 005f2692
    MOV CL,byte ptr [0x02d01f30]        ; 005f2698 | int g_GreenBitPosition
    MOV ESI,EDX                         ; 005f269e
    MOV EDX,EAX                         ; 005f26a0
    SHR EDX,CL                          ; 005f26a2
    MOV CL,byte ptr [0x02d01f38]        ; 005f26a4 | int g_GreenBitCount
    SHL EDX,CL                          ; 005f26aa
    AND EDX,0xff                        ; 005f26ac
    MOV CL,byte ptr [0x02d01f3c]        ; 005f26b2 | int g_BlueBitPosition
    MOV EDI,EDX                         ; 005f26b8
    SHR EAX,CL                          ; 005f26ba
    MOV CL,byte ptr [0x02d01f44]        ; 005f26bc | int g_BlueBitCount
    ...
    JMP 0x005f24b7                      ; 005f26e0 | LAB_005f24b7
        ;   XREF to: 005f24b7 (UNCONDITIONAL_JUMP)
    MOV EBP,dword ptr [EBX + 0x120]     ; 005f26e5
        ;   Label: LAB_005f26e5
    JMP 0x005f25b0                      ; 005f26eb | LAB_005f25b0
        ;   XREF to: 005f25b0 (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0x124]     ; 005f26f0
        ;   Label: LAB_005f26f0
    JMP 0x005f25ce                      ; 005f26f6 | LAB_005f25ce
        ;   XREF to: 005f25ce (UNCONDITIONAL_JUMP)
    MOV ESI,dword ptr [EAX*0x4 + 0x2cf6a9c] ; 005f26fb | void *[1024] g_ScreenBufferArray
        ;   Label: LAB_005f26fb
    XOR EAX,EAX                         ; 005f2702
    TEST EBP,EBP                        ; 005f2704
    JLE 0x005f262d                      ; 005f2706 | LAB_005f262d
        ;   XREF to: 005f262d (CONDITIONAL_JUMP)
    ...
    JZ 0x005f27c6                       ; 005f272d | LAB_005f27c6
    ...
    MOV CL,byte ptr [0x02d01f2c]        ; 005f276b | int g_RedBitCount
    SHR EDI,CL                          ; 005f2771
    MOV CL,byte ptr [0x02d01f24]        ; 005f2773 | int g_RedBitPosition
    SHL EDI,CL                          ; 005f2779
    ...
    MOV CL,byte ptr [0x02d01f38]        ; 005f278e | int g_GreenBitCount
    SHR EDI,CL                          ; 005f2794
    MOV CL,byte ptr [0x02d01f30]        ; 005f2796 | int g_GreenBitPosition
    SHL EDI,CL                          ; 005f279c
    ...
    XOR DH,DH                           ; 005f27a7
    OR EDI,ECX                          ; 005f27a9
    MOV CL,byte ptr [0x02d01f44]        ; 005f27ab | int g_BlueBitCount
    AND EDX,0xffff                      ; 005f27b1
    SHR EDX,CL                          ; 005f27b7
    MOV CL,byte ptr [0x02d01f3c]        ; 005f27b9 | int g_BlueBitPosition
    SHL EDX,CL                          ; 005f27bf
    OR EDX,EDI                          ; 005f27c1
    ...
    JL 0x005f2803                       ; 005f27f9 | LAB_005f2803
        ;   XREF to: 005f2803 (CONDITIONAL_JUMP)
    CMP EAX,dword ptr [0x00679398]      ; 005f27fb | int g_WindowHeight
    JL 0x005f281b                       ; 005f2801 | LAB_005f281b
    ...
    JGE 0x005f2647                      ; 005f2813 | LAB_005f2647
        ;   XREF to: 005f2647 (CONDITIONAL_JUMP)
    JMP 0x005f27ed                      ; 005f2819 | LAB_005f27ed
        ;   XREF to: 005f27ed (UNCONDITIONAL_JUMP)
    MOV EDX,dword ptr [EAX*0x4 + 0x2cf6a9c] ; 005f281b | void *[1024] g_ScreenBufferArray
        ;   Label: LAB_005f281b
    XOR EAX,EAX                         ; 005f2822
    TEST EBP,EBP                        ; 005f2824
    JLE 0x005f2803                      ; 005f2826 | LAB_005f2803
        ;   XREF to: 005f2803 (CONDITIONAL_JUMP)
    ...
    JZ 0x005f2853                       ; 005f284f | LAB_005f2853
    ...
    JGE 0x005f2803                      ; 005f2859 | LAB_005f2803
        ;   XREF to: 005f2803 (CONDITIONAL_JUMP)
    JMP 0x005f2831                      ; 005f285b | LAB_005f2831
