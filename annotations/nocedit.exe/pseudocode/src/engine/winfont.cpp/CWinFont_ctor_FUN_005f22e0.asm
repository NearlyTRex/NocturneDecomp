...
section .text
    ...
    PUSH EDX                            ; 005f22e5
    CALL engine_palette.cpp_CFont_ctor_FUN_00544eb0 ; 005f22e6 | CFont * engine_palette.cpp_CFont_ctor_FUN_00544eb0(CFont * this_ptr)
    ...
    PUSH 0x0                            ; 005f22f3
    PUSH 0x0                            ; 005f22f5
    MOV dword ptr [EAX],0x665914        ; 005f22f7 | CFont_vtable g_CWinFontVTable
    PUSH 0x0                            ; 005f22fd
    ...
    NEG EAX                             ; 005f2368
    PUSH EAX                            ; 005f236a
    CALL dword ptr CS:[0x6113d4]        ; 005f236b | CreateFontA * CreateFontA
