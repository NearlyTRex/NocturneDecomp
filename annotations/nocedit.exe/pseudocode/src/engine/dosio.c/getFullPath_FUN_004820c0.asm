...
;
; XREF[3]:
;   engine_dosio.c_findFileNormally_FUN_004817c0 at 004817e7
...
section .text
    ...
    PUSH ESI                            ; 004820cf
    PUSH EDI                            ; 004820d0
    CALL crt_io.c_realpath_FUN_00601140 ; 004820d1 | char * crt_io.c_realpath_FUN_00601140(char * buffer, char * path, SIZE_T buffer_size)
        ;   XREF to: 00601140 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004820d6
    CMP EAX,EDI                         ; 004820d9
    JNZ 0x004820e5                      ; 004820db | LAB_004820e5
    ...
    CMP AL,0x0                          ; 004820ea
    JZ 0x004820fe                       ; 004820ec | LAB_004820fe
    ...
    CMP AL,0x0                          ; 004820fa
    JNZ 0x004820e6                      ; 004820fc | LAB_004820e6
