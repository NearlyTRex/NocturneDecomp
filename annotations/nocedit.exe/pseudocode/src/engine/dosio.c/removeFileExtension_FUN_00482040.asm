...
section .text
    ...
    PUSH EDX                            ; 00482046
    CALL engine_dosio.c_changeFileExtension_FUN_00482050 ; 00482047 | void engine_dosio.c_changeFileExtension_FUN_00482050(char * source_path, char * destination_buffer, char * new_extension)
