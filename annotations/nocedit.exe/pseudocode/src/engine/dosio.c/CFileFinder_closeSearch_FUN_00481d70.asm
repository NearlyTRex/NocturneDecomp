...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_dosio.c_CFileFinder_closeSearch_FUN_00481d70(CFileFinder * this_ptr)
;
; Parameters:
...
section .text
    ...
    JNZ 0x00481d89                      ; 00481d7c | LAB_00481d89
        ;   XREF to: 00481d89 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 00481d7e
    CALL engine_dosio.c_CFileFinder_reset_FUN_00481db0 ; 00481d7f | void engine_dosio.c_CFileFinder_reset_FUN_00481db0(CFileFinder * this_ptr)
    ...
    MOV ECX,dword ptr [EBX + 0x110]     ; 00481d89
        ;   Label: LAB_00481d89
    PUSH ECX                            ; 00481d8f
    CALL dword ptr CS:[0x611548]        ; 00481d90 | FindClose * PTR_FindClose_00611548
    MOV dword ptr [EBX + 0x10c],0x0     ; 00481d97
    PUSH EBX                            ; 00481da1
    CALL engine_dosio.c_CFileFinder_reset_FUN_00481db0 ; 00481da2 | void engine_dosio.c_CFileFinder_reset_FUN_00481db0(CFileFinder * this_ptr)
        ;   XREF to: 00481db0 (UNCONDITIONAL_CALL)
