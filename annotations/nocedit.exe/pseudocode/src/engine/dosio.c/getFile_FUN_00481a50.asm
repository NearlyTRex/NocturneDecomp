...
section .text
    ...
    CALL engine_dosio.c_getRelativeFilePath_FUN_004816c0 ; 00481a77 | void engine_dosio.c_getRelativeFilePath_FUN_004816c0(char * dest_path, char * directory, char * filename)
        ;   XREF to: 004816c0 (UNCONDITIONAL_CALL)
    MOV AH,byte ptr [ESI]               ; 00481a7c
    ADD ESP,0xc                         ; 00481a7e
    TEST AH,AH                          ; 00481a81
    JZ 0x00481ad0                       ; 00481a83 | LAB_00481ad0
        ;   XREF to: 00481ad0 (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 00481a85
        ;   Label: LAB_00481a85
    MOV AL,byte ptr [EBX]               ; 00481a87
    PUSH EAX                            ; 00481a89
    CALL crt_ctype.c_toupper_FUN_005ff9e0 ; 00481a8a | int crt_ctype.c_toupper_FUN_005ff9e0(int c)
        ;   XREF to: 005ff9e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00481a8f
    CMP EAX,0x57                        ; 00481a92
    JNZ 0x00481ac8                      ; 00481a95 | LAB_00481ac8
        ;   XREF to: 00481ac8 (CONDITIONAL_JUMP)
    TEST EDI,EDI                        ; 00481a97
    JZ 0x00481aa4                       ; 00481a99 | LAB_00481aa4
        ;   XREF to: 00481aa4 (CONDITIONAL_JUMP)
    PUSH EDI                            ; 00481a9b
    CALL crt_file.c_create_directory_FUN_00600e10 ; 00481a9c | int crt_file.c_create_directory_FUN_00600e10(char * path)
        ;   XREF to: 00600e10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00481aa1
    PUSH 0x198                          ; 00481aa4
        ;   Label: LAB_00481aa4
    PUSH 0x6215a8                       ; 00481aa9 | = "..\\engine\\dosio.c" | s_engine_dosio_c_006215a8 = ..\engine\dosio.c
    PUSH ESI                            ; 00481aae
    PUSH 0x0                            ; 00481aaf
    LEA EAX,[ESP + 0x10]                ; 00481ab1
    PUSH EAX                            ; 00481ab5
    CALL shape_memdbg.cpp_openFile_FUN_0050f7a0 ; 00481ab6 | FILE * shape_memdbg.cpp_openFile_FUN_0050f7a0(char * filename, char * directory, char * mode, char * source_file, ...)
    ...
    INC EBX                             ; 00481acb
    TEST DL,DL                          ; 00481acc
    JNZ 0x00481a85                      ; 00481ace | LAB_00481a85
        ;   XREF to: 00481a85 (CONDITIONAL_JUMP)
    MOV EAX,ESP                         ; 00481ad0
        ;   Label: LAB_00481ad0
    PUSH EAX                            ; 00481ad2
    CALL engine_dosio.c_findFile_FUN_00481760 ; 00481ad3 | int engine_dosio.c_findFile_FUN_00481760(SFoundFileInfo * context)
        ;   XREF to: 00481760 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00481ad8
    TEST EAX,EAX                        ; 00481adb
    JZ 0x00481abe                       ; 00481add | LAB_00481abe
        ;   XREF to: 00481abe (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [ESP + 0x208]     ; 00481adf
    TEST ECX,ECX                        ; 00481ae6
    JNZ 0x00481b2f                      ; 00481ae8 | LAB_00481b2f
        ;   XREF to: 00481b2f (CONDITIONAL_JUMP)
    PUSH 0x1ac                          ; 00481aea
    PUSH 0x6215cc                       ; 00481aef | = "..\\engine\\dosio.c" | s_engine_dosio_c_006215cc = ..\engine\dosio.c
    PUSH ESI                            ; 00481af4
    PUSH ECX                            ; 00481af5
    LEA EAX,[ESP + 0x110]               ; 00481af6
        ;   Label: LAB_00481af6
    PUSH EAX                            ; 00481afd
    CALL shape_memdbg.cpp_openFile_FUN_0050f7a0 ; 00481afe | FILE * shape_memdbg.cpp_openFile_FUN_0050f7a0(char * filename, char * directory, char * mode, char * source_file, ...)
        ;   XREF to: 0050f7a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 00481b03
    MOV EBX,EAX                         ; 00481b06
    TEST EBX,EBX                        ; 00481b08
    JZ 0x00481b41                       ; 00481b0a | LAB_00481b41
        ;   XREF to: 00481b41 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [ESP + 0x200]     ; 00481b0c
    TEST ESI,ESI                        ; 00481b13
    JZ 0x00481b23                       ; 00481b15 | LAB_00481b23
        ;   XREF to: 00481b23 (CONDITIONAL_JUMP)
    PUSH 0x0                            ; 00481b17
    PUSH ESI                            ; 00481b19
    PUSH EBX                            ; 00481b1a
    CALL crt_stdio.c_fseek_FUN_005ffacc ; 00481b1b | int crt_stdio.c_fseek_FUN_005ffacc(FILE * file, long offset, int whence)
    ...
    PUSH 0x1aa                          ; 00481b2f
        ;   Label: LAB_00481b2f
    PUSH 0x6215ba                       ; 00481b34 | = "..\\engine\\dosio.c" | s_engine_dosio_c_006215ba = ..\engine\dosio.c
    PUSH ESI                            ; 00481b39
    LEA EAX,[ESP + 0xc]                 ; 00481b3a
    PUSH EAX                            ; 00481b3e
    JMP 0x00481af6                      ; 00481b3f | LAB_00481af6
