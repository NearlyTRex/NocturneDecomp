...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_dosio.c_CFileFinder_convertStruct_FUN_00481dc0(CFileFinder * finder, LPWIN32_FIND_DATAA find_data)
;
; Parameters:
...
section .text
    ...
    PUSH 0x0                            ; 00481dd4
    PUSH EBX                            ; 00481dd6
    CALL crt_memory.c_memset_FUN_005fde40 ; 00481dd7 | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
    ...
    PUSH EAX                            ; 00481de9
    PUSH EBX                            ; 00481dea
    CALL crt_string.c_strncpy_FUN_00600f40 ; 00481deb | char * crt_string.c_strncpy_FUN_00600f40(char * dest, char * src, SIZE_T count)
    ...
    JNZ 0x00481e84                      ; 00481e02 | LAB_00481e84
        ;   XREF to: 00481e84 (CONDITIONAL_JUMP)
    TEST byte ptr [ESI],0x2             ; 00481e08
        ;   Label: LAB_00481e08
    JZ 0x00481e14                       ; 00481e0b | LAB_00481e14
        ;   XREF to: 00481e14 (CONDITIONAL_JUMP)
    OR byte ptr [EBX + 0x100],0x2       ; 00481e0d
    TEST byte ptr [ESI],0x10            ; 00481e14
        ;   Label: LAB_00481e14
    JZ 0x00481e20                       ; 00481e17 | LAB_00481e20
        ;   XREF to: 00481e20 (CONDITIONAL_JUMP)
    OR byte ptr [EBX + 0x100],0x4       ; 00481e19
    TEST byte ptr [ESI],0x1             ; 00481e20
        ;   Label: LAB_00481e20
    JZ 0x00481e2c                       ; 00481e23 | LAB_00481e2c
        ;   XREF to: 00481e2c (CONDITIONAL_JUMP)
    OR byte ptr [EBX + 0x100],0x8       ; 00481e25
    CMP dword ptr [ESI + 0x1c],0x0      ; 00481e2c
        ;   Label: LAB_00481e2c
    JZ 0x00481e90                       ; 00481e30 | LAB_00481e90
        ;   XREF to: 00481e90 (CONDITIONAL_JUMP)
    MOV EDI,0x621617                    ; 00481e32 | = "..\\engine\\dosio.c" | s_engine_dosio_c_00621617 = ..\engine\dosio.c
        ;   Label: LAB_00481e32
    MOV EBP,0x2a7                       ; 00481e37
    PUSH 0x621629                       ; 00481e3c | = "CFileFinder::convertStruct - file too..." | s_CFileFinder_convertStruc_00621629 = CFileFinder::convertStruct - file too big!
    MOV dword ptr [0x02f0ca48],EDI      ; 00481e41 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBP      ; 00481e47 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00481e4d | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    CALL dword ptr CS:[0x611540]        ; 00481e71 | FileTimeToLocalFileTime * PTR_FileTimeToLocalFileTime_00611540
    TEST EAX,EAX                        ; 00481e78
    JNZ 0x00481e9b                      ; 00481e7a | LAB_00481e9b
    ...
    PUSH EAX                            ; 00481ea4
    CALL dword ptr CS:[0x611544]        ; 00481ea5 | FileTimeToSystemTime * PTR_FileTimeToSystemTime_00611544
    TEST EAX,EAX                        ; 00481eac
    JZ 0x00481e7c                       ; 00481eae | LAB_00481e7c
    ...
    PUSH EAX                            ; 00481eff
    CALL crt_time.c_mktime_FUN_00600f80 ; 00481f00 | time_t crt_time.c_mktime_FUN_00600f80(tm * timeptr)
