// Name: engine_dosio.c_getFileSizeWithFinder_FUN_00481960
// Address: 00481960
// Address Range: [[00481960, 004819ed]]
// Convention: __cdecl
// Signature: int __cdecl engine_dosio_c_getFileSizeWithFinder_FUN_00481960(char *directory,char *filename)
