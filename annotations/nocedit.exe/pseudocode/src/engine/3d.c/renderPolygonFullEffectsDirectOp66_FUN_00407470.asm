...
section .text
    ...
    PUSH EBX                            ; 00407470
        ;   Label: engine_3d.c_renderPolygonFullEffectsDirectOp66_FUN_00407470
    PUSH ESI                            ; 00407471
    PUSH EDI                            ; 00407472
    PUSH EBP                            ; 00407473
    ...
    MOVSD.REP ES:EDI,ESI                ; 0040758f | g_RenderBufferPool[0].texture_data.base.type | g_RenderBufferPool[0].texture_data.base.count
