...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl engine_3d_c_clipAndDrawLine2D_FUN_00407d70(SRenderVertex vertex1,SRenderVertex vertex2)
;
; Parameters:
...
;   core_ladder.cpp_CLadder_FUN_00502620 at 00502845
...
section .text
    ...
    MOV EDI,0x7725b4                    ; 00407f89 | g_QuadVertex2
    MOVSD.REP ES:EDI,ESI                ; 00407f8e | g_QuadVertex2 | g_QuadVertex2_Y
    MOV ECX,0xc                         ; 00407f90
    LEA ESI,[ESP + 0x74]                ; 00407f95
    MOV EDI,0x7725e4                    ; 00407f99 | g_QuadVertex3
