...
section .text
    ...
    MOVSD.REP ES:EDI,ESI                ; 0040719c | g_RenderVertexBuffer | g_RenderVertexBuffer[0].projected_vertex.transformed_y | g_RenderVertexBuffer[1].projected_vertex.transformed_x
