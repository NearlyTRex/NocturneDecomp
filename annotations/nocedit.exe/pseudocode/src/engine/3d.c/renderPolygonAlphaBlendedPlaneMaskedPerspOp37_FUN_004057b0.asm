...
;
; XREF[1]:
;   engine_3d.c_renderPolygonAlphaBlendedDepthWritePerspOp59_FUN_00406f20 at 0040704f
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004057b0
        ;   Label: engine_3d.c_renderPolygonAlphaBlendedPlaneMaskedPerspOp37_FUN_004057b0
    PUSH ESI                            ; 004057b1
    PUSH EBP                            ; 004057b2
    ...
    MOV [0x02d052a4],EAX                ; 00405808 | g_VertexPreprocessMode
    ...
    MOV [0x02d052a4],EAX                ; 00405882 | g_VertexPreprocessMode
