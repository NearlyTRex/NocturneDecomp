...
section .text
    ...
    PUSH ESI                            ; 00406a20
        ;   Label: engine_3d.c_renderPolygonLitDetailedAmbient_FUN_00406a20
    PUSH EBP                            ; 00406a21
    ...
    MOV [0x02d052a4],EAX                ; 00406a91 | g_VertexPreprocessMode
    ...
    MOV dword ptr [EDX + 0x772a98],ESI  ; 00406aa4 | g_ProcessedVertexIndices | g_ProcessedVertexIndices[1]
