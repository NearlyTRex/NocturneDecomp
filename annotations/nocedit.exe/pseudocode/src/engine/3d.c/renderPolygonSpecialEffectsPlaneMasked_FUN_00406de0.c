...
// Convention: __cdecl
// Signature: SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonSpecialEffectsPlaneMasked_FUN_00406de0(SMRGLHeaderPrimitive *prim)
...

{
  ...
  if (g_UseExternalRenderer == 0) {
    ...
    pSVar2 = engine_3d_c_renderPolygonEnginePlaneMaskedEffect_FUN_00405690(prim);
    return pSVar2;
  }
