...
;
; XREF[1]:
;   engine_3d.c_renderPolygonAlphaBlendedDepthWritePlaneMaskedOp58_FUN_00406de0 at 00406f0c
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00405690
        ;   Label: engine_3d.c_renderPolygonAlphaBlendedPlaneMaskedOp36_FUN_00405690
    PUSH ESI                            ; 00405691
    PUSH EBP                            ; 00405692
