...
// Convention: __cdecl
// Signature: SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonExtremeQualityMode_FUN_00406b40(SMRGLHeaderPrimitive *polygon_info)
...

{
  ...
  if (iVar1 != 0) {
    ...
    g_RenderStateFlags.dword = RENDER_EXTREME_QUALITY;
