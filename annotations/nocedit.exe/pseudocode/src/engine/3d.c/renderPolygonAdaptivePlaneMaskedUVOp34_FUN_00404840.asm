...
section .text
    ...
    PUSH ESI                            ; 00404840
        ;   Label: engine_3d.c_renderPolygonAdaptivePlaneMaskedUVOp34_FUN_00404840
    PUSH EBP                            ; 00404841
    ...
    XOR EBX,EBX                         ; 00404888
        ;   Label: LAB_00404888
    MOV dword ptr [0x02d052a4],EBX      ; 0040488a | g_VertexPreprocessMode
    ...
    MOV dword ptr [ECX + 0x772a98],ESI  ; 004048ae | g_ProcessedVertexIndices | g_ProcessedVertexIndices[1]
    ...
    MOV [0x02d052a4],EAX                ; 0040493f | g_VertexPreprocessMode
    ...
    MOV dword ptr [0x02d052a4],EDX      ; 004049b5 | g_VertexPreprocessMode
    ...
    PUSH EDX                            ; 004049cf
    CALL engine_3d.c_lookupLitColor_FUN_004039c0 ; 004049d0
