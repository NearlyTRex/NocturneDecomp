...
;                               FUNCTION
; *****************************************************************************
; __cdecl SMRGLHeaderExtended * engine_3d.c_renderPolygonEngineAPIPremiumMultiState_FUN_00407290(SMRGLHeaderPrimitive * polygon_info)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 004072a1
    CALL engine_3d.c_isVisiblePlane_FUN_00403950 ; 004072a2 | int engine_3d.c_isVisiblePlane_FUN_00403950(SClipPlane * plane)
        ;   XREF to: 00403950 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004072a7
    TEST EAX,EAX                        ; 004072aa
    JZ 0x0040743f                       ; 004072ac | LAB_0040743f
        ;   XREF to: 0040743f (CONDITIONAL_JUMP)
    CMP dword ptr [0x02d05248],0x0      ; 004072b2 | BOOL g_MMXSupported
    JNZ 0x00407342                      ; 004072b9 | LAB_00407342
        ;   XREF to: 00407342 (CONDITIONAL_JUMP)
    CMP dword ptr [0x0067939c],0x20     ; 004072bf | int g_BitsPerPixel
    JNZ 0x00407336                      ; 004072c6 | LAB_00407336
        ;   XREF to: 00407336 (CONDITIONAL_JUMP)
    MOV dword ptr [0x02d0257c],0x5b50ec ; 004072c8 | RenderScanlineFunc * g_ScanlineRenderFunc
    MOV EBX,0x1e7                       ; 004072d2
        ;   Label: LAB_004072d2
    MOV EDI,0x1                         ; 004072d7
    MOV ECX,0x772a98                    ; 004072dc | int[24] g_ProcessedVertexIndices
    MOV EAX,ESI                         ; 004072e1
    MOV dword ptr [0x02d052a0],EBX      ; 004072e3 | int g_RenderStateFlags
    MOV dword ptr [0x02d052a4],EDI      ; 004072e9 | int g_RenderStateFlag2
    XOR EBX,EBX                         ; 004072ef
    MOV EDX,dword ptr [EBP + 0x4]       ; 004072f1
        ;   Label: LAB_004072f1
    LEA EDX,[EDX + EDX*0x2]             ; 004072f4
    CMP EBX,EDX                         ; 004072f7
    JGE 0x00407369                      ; 004072f9 | LAB_00407369
        ;   XREF to: 00407369 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [0x00772a60]      ; 004072fb | uint g_ProcessedVertexOffset
    MOV EDX,dword ptr [EAX]             ; 00407301
    ADD EDX,ESI                         ; 00407303
    MOV dword ptr [ECX],EDX             ; 00407305 | int[24] g_ProcessedVertexIndices
    ...
    JMP 0x004072f1                      ; 00407334 | LAB_004072f1
        ;   XREF to: 004072f1 (UNCONDITIONAL_JUMP)
    MOV dword ptr [0x02d0257c],0x5b5322 ; 00407336 | RenderScanlineFunc * g_ScanlineRenderFunc
        ;   Label: LAB_00407336
    JMP 0x004072d2                      ; 00407340 | LAB_004072d2
        ;   XREF to: 004072d2 (UNCONDITIONAL_JUMP)
    CMP dword ptr [0x0067939c],0x20     ; 00407342 | int g_BitsPerPixel
        ;   Label: LAB_00407342
    JNZ 0x0040735a                      ; 00407349 | LAB_0040735a
        ;   XREF to: 0040735a (CONDITIONAL_JUMP)
    MOV dword ptr [0x02d0257c],0x5b4031 ; 0040734b | RenderScanlineFunc * g_ScanlineRenderFunc
    JMP 0x004072d2                      ; 00407355 | LAB_004072d2
        ;   XREF to: 004072d2 (UNCONDITIONAL_JUMP)
    MOV dword ptr [0x02d0257c],0x5b4823 ; 0040735a | RenderScanlineFunc * g_ScanlineRenderFunc
        ;   Label: LAB_0040735a
    JMP 0x004072d2                      ; 00407364 | LAB_004072d2
        ;   XREF to: 004072d2 (UNCONDITIONAL_JUMP)
    CMP dword ptr [0x00772af8],0x0      ; 00407369 | int g_RenderBufferEnabled
        ;   Label: LAB_00407369
    JZ 0x0040745b                       ; 00407370 | LAB_0040745b
        ;   XREF to: 0040745b (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x00772afc]      ; 00407376 | int g_RenderBufferCount
    CMP EDX,0x9c4                       ; 0040737c
    JGE 0x0040745b                      ; 00407382 | LAB_0040745b
        ;   XREF to: 0040745b (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [EBP + 0x4]       ; 00407388
    CMP ECX,0x4                         ; 0040738b
    JG 0x0040745b                       ; 0040738e | LAB_0040745b
        ;   XREF to: 0040745b (CONDITIONAL_JUMP)
    MOV ESI,0x7fffffff                  ; 00407394
    LEA EAX,[EDX*0x8 + 0x0]             ; 00407399
    MOV EDI,dword ptr [0x00772afc]      ; 004073a0 | int g_RenderBufferCount
    ADD EAX,EDX                         ; 004073a6
    XOR EBX,EBX                         ; 004073a8
    SHL EAX,0x2                         ; 004073aa
    MOV dword ptr [ESP + 0x4],ESI       ; 004073ad
    SUB EAX,EDX                         ; 004073b1
    MOV EDX,0x772b00                    ; 004073b3 | SRenderBufferEntry[256] g_RenderBufferPool
    SHL EAX,0x3                         ; 004073b8
    INC EDI                             ; 004073bb
    ADD EDX,EAX                         ; 004073bc
    MOV dword ptr [0x00772afc],EDI      ; 004073be | int g_RenderBufferCount
    MOV dword ptr [ESP],EDX             ; 004073c4
    MOV dword ptr [EDX],ECX             ; 004073c7 | SRenderBufferEntry[256] g_RenderBufferPool
    TEST ECX,ECX                        ; 004073c9
    JLE 0x00407405                      ; 004073cb | LAB_00407405
        ;   XREF to: 00407405 (CONDITIONAL_JUMP)
    MOV EAX,EDX                         ; 004073cd
    XOR EDX,EDX                         ; 004073cf
    IMUL ESI,dword ptr [EDX + 0x772a98],0x30 ; 004073d1 | int[24] g_ProcessedVertexIndices
        ;   Label: LAB_004073d1
    LEA EDI,[EAX + 0x4]                 ; 004073d8
    MOV ECX,0xc                         ; 004073db
    LEA ESI,[ESI + 0x688014]            ; 004073e0 | SRenderVertex[16] g_RenderVertexBuffer
    MOVSD.REP ES:EDI,ESI                ; 004073e6 | SRenderVertex[16] g_RenderVertexBuffer
    MOV ESI,dword ptr [ESP + 0x4]       ; 004073e8
    MOV ECX,dword ptr [EAX + 0xc]       ; 004073ec | DAT_00772b0c
    CMP ECX,ESI                         ; 004073ef
    JGE 0x004073f7                      ; 004073f1 | LAB_004073f7
    ...
    JL 0x004073d1                       ; 00407403 | LAB_004073d1
        ;   XREF to: 004073d1 (CONDITIONAL_JUMP)
    CALL engine_texture.cpp_getCurrentTexture_FUN_005dd9c0 ; 00407405 | SMRGLTextureBasic * engine_texture.cpp_getCurrentTexture_FUN_005dd9c0()
        ;   Label: LAB_00407405
    ...
    MOV EAX,[0x006793b4]                ; 0040741d | int g_CurrentAlphaValue
    MOVSD.REP ES:EDI,ESI                ; 00407422 | DAT_00772bc4
    MOV dword ptr [EDX + 0x10c],EAX     ; 00407424 | DAT_00772c0c
    MOV EAX,[0x02d05298]                ; 0040742a | int g_BlendMode
    ...
    POP EBX                             ; 00407459
    RET                                 ; 0040745a
    PUSH 0x772a98                       ; 0040745b | int[24] g_ProcessedVertexIndices
        ;   Label: LAB_0040745b
    MOV EBX,dword ptr [EBP + 0x4]       ; 00407460
    PUSH EBX                            ; 00407463
    CALL engine_clipper.c_clipAndRasterize_FUN_004371b0 ; 00407464 | void engine_clipper.c_clipAndRasterize_FUN_004371b0(int vertex_count, int * vertex_indices)
        ;   XREF to: 004371b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00407469
    JMP 0x0040743f                      ; 0040746c | LAB_0040743f
