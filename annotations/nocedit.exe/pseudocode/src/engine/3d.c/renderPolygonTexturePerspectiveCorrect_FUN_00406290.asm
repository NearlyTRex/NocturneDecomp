...
;                               FUNCTION
; *****************************************************************************
; __cdecl SMRGLHeaderExtended * engine_3d.c_renderPolygonTexturePerspectiveCorrect_FUN_00406290(SMRGLHeaderPrimitive * polygon_info)
;
; Parameters:
...
section .text
    ...
    CALL engine_3d.c_isVisiblePlane_FUN_00403950 ; 004062a0 | int engine_3d.c_isVisiblePlane_FUN_00403950(SClipPlane * plane)
        ;   XREF to: 00403950 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004062a5
    TEST EAX,EAX                        ; 004062a8
    JZ 0x00406405                       ; 004062aa | LAB_00406405
        ;   XREF to: 00406405 (CONDITIONAL_JUMP)
    CMP dword ptr [0x02d05248],0x0      ; 004062b0 | BOOL g_MMXSupported
    JNZ 0x0040638b                      ; 004062b7 | LAB_0040638b
        ;   XREF to: 0040638b (CONDITIONAL_JUMP)
    CMP dword ptr [0x0067939c],0x20     ; 004062bd | int g_BitsPerPixel
    JNZ 0x0040637c                      ; 004062c4 | LAB_0040637c
        ;   XREF to: 0040637c (CONDITIONAL_JUMP)
    MOV dword ptr [0x02d0257c],0x5b50ec ; 004062ca | RenderScanlineFunc * g_ScanlineRenderFunc
    PUSH EDI                            ; 004062d4
        ;   Label: LAB_004062d4
    PUSH ESI                            ; 004062d5
    PUSH EBX                            ; 004062d6
    ...
    MOV dword ptr [0x02d052a0],ECX      ; 004062ea | int g_RenderStateFlags
    CALL engine_3d.c_setRenderAlpha_FUN_00406d80 ; 004062f0 | void engine_3d.c_setRenderAlpha_FUN_00406d80(int alpha_color_value)
        ;   XREF to: 00406d80 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004062f5
    MOV dword ptr [0x02d052a4],EBX      ; 004062f8 | int g_RenderStateFlag2
    ...
    MOV dword ptr [EAX + 0x688030],EDX  ; 00406374 | g_RenderVertexBuffer[0].v | DAT_00fbffff
    JMP 0x00406302                      ; 0040637a | LAB_00406302
        ;   XREF to: 00406302 (UNCONDITIONAL_JUMP)
    MOV dword ptr [0x02d0257c],0x5b5322 ; 0040637c | RenderScanlineFunc * g_ScanlineRenderFunc
        ;   Label: LAB_0040637c
    JMP 0x004062d4                      ; 00406386 | LAB_004062d4
        ;   XREF to: 004062d4 (UNCONDITIONAL_JUMP)
    CMP dword ptr [0x0067939c],0x20     ; 0040638b | int g_BitsPerPixel
        ;   Label: LAB_0040638b
    JNZ 0x004063a3                      ; 00406392 | LAB_004063a3
        ;   XREF to: 004063a3 (CONDITIONAL_JUMP)
    MOV dword ptr [0x02d0257c],0x5b4031 ; 00406394 | RenderScanlineFunc * g_ScanlineRenderFunc
    JMP 0x004062d4                      ; 0040639e | LAB_004062d4
        ;   XREF to: 004062d4 (UNCONDITIONAL_JUMP)
    MOV dword ptr [0x02d0257c],0x5b4823 ; 004063a3 | RenderScanlineFunc * g_ScanlineRenderFunc
        ;   Label: LAB_004063a3
    JMP 0x004062d4                      ; 004063ad | LAB_004062d4
        ;   XREF to: 004062d4 (UNCONDITIONAL_JUMP)
    MOV EDX,0xfbffff                    ; 004063b2 | DAT_00fbffff
        ;   Label: LAB_004063b2
    JMP 0x0040635e                      ; 004063b7 | LAB_0040635e
        ;   XREF to: 0040635e (UNCONDITIONAL_JUMP)
    CMP EAX,0x10000                     ; 004063b9
        ;   Label: LAB_004063b9
    JGE 0x004063c5                      ; 004063be | LAB_004063c5
        ;   XREF to: 004063c5 (CONDITIONAL_JUMP)
    MOV EAX,0x10000                     ; 004063c0
    CMP EDX,0x10000                     ; 004063c5
        ;   Label: LAB_004063c5
    JGE 0x004063d2                      ; 004063cb | LAB_004063d2
        ;   XREF to: 004063d2 (CONDITIONAL_JUMP)
    MOV EDX,0x10000                     ; 004063cd
    CMP EAX,0xfeffff                    ; 004063d2 | DAT_00feffff
        ;   Label: LAB_004063d2
    JLE 0x004063de                      ; 004063d7 | LAB_004063de
        ;   XREF to: 004063de (CONDITIONAL_JUMP)
    MOV EAX,0xfeffff                    ; 004063d9 | DAT_00feffff
    CMP EDX,0xfeffff                    ; 004063de | DAT_00feffff
        ;   Label: LAB_004063de
    JLE 0x0040635e                      ; 004063e4 | LAB_0040635e
        ;   XREF to: 0040635e (CONDITIONAL_JUMP)
    MOV EDX,0xfeffff                    ; 004063ea | DAT_00feffff
    JMP 0x0040635e                      ; 004063ef | LAB_0040635e
        ;   XREF to: 0040635e (UNCONDITIONAL_JUMP)
    PUSH 0x772a98                       ; 004063f4 | int[24] g_ProcessedVertexIndices
        ;   Label: LAB_004063f4
    PUSH EDI                            ; 004063f9
    CALL engine_clipper.c_clipAndRasterize_FUN_004371b0 ; 004063fa | void engine_clipper.c_clipAndRasterize_FUN_004371b0(int vertex_count, int * vertex_indices)
