...
section .text
    ...
    PUSH ESI                            ; 004d1301
    MOV EBX,dword ptr [0x02d7b428]      ; 004d1302 | int g_EdgeCount
    MOV ECX,dword ptr [ESP + 0xc]       ; 004d1308
    MOV ESI,dword ptr [ESP + 0x10]      ; 004d130c
    MOV EAX,0x2d7b42c                   ; 004d1310 | SHardwareEdge[16] g_HardwareEdgeTable
    XOR EDX,EDX                         ; 004d1315
    TEST EBX,EBX                        ; 004d1317
    JLE 0x004d132b                      ; 004d1319 | LAB_004d132b
        ;   XREF to: 004d132b (CONDITIONAL_JUMP)
    CMP ECX,dword ptr [EAX]             ; 004d131b | SHardwareEdge[16] g_HardwareEdgeTable
        ;   Label: LAB_004d131b
    JNZ 0x004d1323                      ; 004d131d | LAB_004d1323
        ;   XREF to: 004d1323 (CONDITIONAL_JUMP)
    CMP EAX,ESI                         ; 004d131f
    JNZ 0x004d132d                      ; 004d1321 | LAB_004d132d
        ;   XREF to: 004d132d (CONDITIONAL_JUMP)
    INC EDX                             ; 004d1323
        ;   Label: LAB_004d1323
    ADD EAX,0x38                        ; 004d1324 | DAT_02d7b464
    CMP EDX,EBX                         ; 004d1327
    JL 0x004d131b                       ; 004d1329 | LAB_004d131b
        ;   XREF to: 004d131b (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 004d132b
        ;   Label: LAB_004d132b
    MOV dword ptr [0x02d7b428],EBX      ; 004d132d | int g_EdgeCount
        ;   Label: LAB_004d132d
    POP ESI                             ; 004d1333
    POP EBX                             ; 004d1334
    RET                                 ; 004d1335
