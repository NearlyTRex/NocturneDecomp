...
section .text
    ...
    PUSH EBX                            ; 00403ba0
        ;   Label: engine_3d.c_renderPolygonFogColorOp6_FUN_00403ba0
    PUSH ESI                            ; 00403ba1
    PUSH EBP                            ; 00403ba2
    ...
    MOV [0x02d052a4],EAX                ; 00403bf5 | g_VertexPreprocessMode
    ...
    MOV [0x02d052a4],EAX                ; 00403c6c | g_VertexPreprocessMode
