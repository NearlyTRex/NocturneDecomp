...
;                               FUNCTION
; *****************************************************************************
; __cdecl SMRGLHeaderExtended * engine_3d.c_setVertexTextureU_FUN_00405270(SVertexBatch * vertex_batch)
;
; Parameters:
...
section .text
    ...
    JLE 0x004052a1                      ; 0040527f | LAB_004052a1
    ...
    JL 0x00405282                       ; 0040529e | LAB_00405282
