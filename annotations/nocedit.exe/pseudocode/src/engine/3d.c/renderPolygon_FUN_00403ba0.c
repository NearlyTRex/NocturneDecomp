...
// Convention: __cdecl
// Signature: SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygon_FUN_00403ba0(SMRGLHeaderPrimitive *polygon_info)
...

{
  ...
  if (iVar1 != 0) {
    if (g_AdvancedClippingEnabled == 0) {
      ...
      g_RenderStateFlags.dword = 0x204;
