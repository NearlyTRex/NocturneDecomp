...
// Convention: __cdecl
// Signature: SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonLitComplexAlpha_FUN_004052b0(SMRGLHeaderPrimitive *polygon_info)
...

{
  ...
  if (iVar1 != 0) {
    ...
    g_RenderStateFlags.dword = RENDER_LIT_COMPLEX;
