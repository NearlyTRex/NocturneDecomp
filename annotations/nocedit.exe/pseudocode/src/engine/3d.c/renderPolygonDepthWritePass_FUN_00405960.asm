...
;
; XREF[2]:
;   engine_3d.c_renderPolygonAlphaBlendedDepthWritePerspOp59_FUN_00406f20 at 00407046
;   engine_3d.c_renderPolygonAlphaBlendedDepthWritePlaneMaskedOp58_FUN_00406de0 at 00406f03
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00405960
        ;   Label: engine_3d.c_renderPolygonDepthWritePass_FUN_00405960
    PUSH ESI                            ; 00405961
    PUSH EBP                            ; 00405962
    ...
    MOV dword ptr [0x02d052a4],EBP      ; 004059ac | g_VertexPreprocessMode
