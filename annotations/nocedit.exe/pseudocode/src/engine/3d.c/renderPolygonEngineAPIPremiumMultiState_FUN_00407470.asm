...
;                               FUNCTION
; *****************************************************************************
; __cdecl SMRGLHeaderExtended * engine_3d.c_renderPolygonEngineAPIPremiumMultiState_FUN_00407470(SMRGLHeaderPrimitive * primitive)
;
; Parameters:
...
section .text
    ...
    CALL engine_3d.c_isVisiblePlane_FUN_00403950 ; 00407486 | int engine_3d.c_isVisiblePlane_FUN_00403950(SClipPlane * plane)
        ;   XREF to: 00403950 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0040748b
    TEST EAX,EAX                        ; 0040748e
    JZ 0x004075a8                       ; 00407490 | LAB_004075a8
        ;   XREF to: 004075a8 (CONDITIONAL_JUMP)
    CMP dword ptr [0x02d05248],0x0      ; 00407496 | BOOL g_MMXSupported
    JNZ 0x004075df                      ; 0040749d | LAB_004075df
        ;   XREF to: 004075df (CONDITIONAL_JUMP)
    CMP dword ptr [0x0067939c],0x20     ; 004074a3 | int g_BitsPerPixel
    JNZ 0x004075d0                      ; 004074aa | LAB_004075d0
        ;   XREF to: 004075d0 (CONDITIONAL_JUMP)
    MOV dword ptr [0x02d0257c],0x5b50ec ; 004074b0 | RenderScanlineFunc * g_ScanlineRenderFunc
    MOV ESI,0x1                         ; 004074ba
        ;   Label: LAB_004074ba
    MOV ECX,0x1e7                       ; 004074bf
    MOV EDI,dword ptr [0x00772af8]      ; 004074c4 | int g_RenderBufferEnabled
    MOV dword ptr [0x02d052a4],ESI      ; 004074ca | int g_RenderStateFlag2
    MOV dword ptr [0x02d052a0],ECX      ; 004074d0 | int g_RenderStateFlags
    TEST EDI,EDI                        ; 004074d6
    JZ 0x00407606                       ; 004074d8 | LAB_00407606
        ;   XREF to: 00407606 (CONDITIONAL_JUMP)
    MOV EBP,dword ptr [0x00772afc]      ; 004074de | int g_RenderBufferCount
    CMP EBP,0x9c4                       ; 004074e4
    JGE 0x00407606                      ; 004074ea | LAB_00407606
        ;   XREF to: 00407606 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x18]      ; 004074f0
    CMP dword ptr [EAX + 0x4],0x4       ; 004074f4
    JG 0x00407606                       ; 004074f8 | LAB_00407606
        ;   XREF to: 00407606 (CONDITIONAL_JUMP)
    LEA EAX,[EBP*0x8 + 0x0]             ; 004074fe
    ADD EAX,EBP                         ; 00407505
    SHL EAX,0x2                         ; 00407507
    SUB EAX,EBP                         ; 0040750a
    MOV EDX,0x772b00                    ; 0040750c | SRenderBufferEntry[256] g_RenderBufferPool
    SHL EAX,0x3                         ; 00407511
    MOV ESI,dword ptr [0x00772afc]      ; 00407514 | int g_RenderBufferCount
    ADD EDX,EAX                         ; 0040751a
    MOV EAX,dword ptr [ESP + 0x18]      ; 0040751c
    INC ESI                             ; 00407520
    MOV EAX,dword ptr [EAX + 0x4]       ; 00407521
    MOV dword ptr [0x00772afc],ESI      ; 00407524 | int g_RenderBufferCount
    MOV dword ptr [EDX],EAX             ; 0040752a | SRenderBufferEntry[256] g_RenderBufferPool
    ...
    JLE 0x00407572                      ; 0040753f | LAB_00407572
    ...
    LEA ESI,[ESI + 0x688014]            ; 0040754f | SRenderVertex[16] g_RenderVertexBuffer
    MOVSD.REP ES:EDI,ESI                ; 00407555 | SRenderVertex[16] g_RenderVertexBuffer
    MOV ECX,dword ptr [EAX + 0xc]       ; 00407557 | DAT_00772b0c
    CMP EBP,ECX                         ; 0040755a
    JLE 0x00407560                      ; 0040755c | LAB_00407560
    ...
    JL 0x00407544                       ; 00407570 | LAB_00407544
        ;   XREF to: 00407544 (CONDITIONAL_JUMP)
    CALL engine_texture.cpp_getCurrentTexture_FUN_005dd9c0 ; 00407572 | SMRGLTextureBasic * engine_texture.cpp_getCurrentTexture_FUN_005dd9c0()
        ;   Label: LAB_00407572
    ...
    MOV EAX,[0x006793b4]                ; 0040758a | int g_CurrentAlphaValue
    MOVSD.REP ES:EDI,ESI                ; 0040758f | DAT_00772bc4
    MOV dword ptr [EDX + 0x10c],EAX     ; 00407591 | DAT_00772c0c
    MOV dword ptr [EDX + 0x114],EBP     ; 00407597 | DAT_00772c14
    MOV EAX,[0x02d05298]                ; 0040759d | int g_BlendMode
    ...
    POP EBX                             ; 004075ce
    RET                                 ; 004075cf
    MOV dword ptr [0x02d0257c],0x5b5322 ; 004075d0 | RenderScanlineFunc * g_ScanlineRenderFunc
        ;   Label: LAB_004075d0
    JMP 0x004074ba                      ; 004075da | LAB_004074ba
        ;   XREF to: 004074ba (UNCONDITIONAL_JUMP)
    CMP dword ptr [0x0067939c],0x20     ; 004075df | int g_BitsPerPixel
        ;   Label: LAB_004075df
    JNZ 0x004075f7                      ; 004075e6 | LAB_004075f7
        ;   XREF to: 004075f7 (CONDITIONAL_JUMP)
    MOV dword ptr [0x02d0257c],0x5b4031 ; 004075e8 | RenderScanlineFunc * g_ScanlineRenderFunc
    JMP 0x004074ba                      ; 004075f2 | LAB_004074ba
        ;   XREF to: 004074ba (UNCONDITIONAL_JUMP)
    MOV dword ptr [0x02d0257c],0x5b4823 ; 004075f7 | RenderScanlineFunc * g_ScanlineRenderFunc
        ;   Label: LAB_004075f7
    JMP 0x004074ba                      ; 00407601 | LAB_004074ba
        ;   XREF to: 004074ba (UNCONDITIONAL_JUMP)
    ...
    PUSH ECX                            ; 0040760e
    CALL engine_clipper.c_clipAndRasterize_FUN_004371b0 ; 0040760f | void engine_clipper.c_clipAndRasterize_FUN_004371b0(int vertex_count, int * vertex_indices)
        ;   XREF to: 004371b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00407614
    JMP 0x004075a8                      ; 00407617 | LAB_004075a8
