...
section .text
    ...
    MOV dword ptr [0x00772a94],EDI      ; 00403855 | void * g_CurrentVertexData
    CMP EDX,0x4e20                      ; 0040385b
    JG 0x00403914                       ; 00403861 | LAB_00403914
        ;   XREF to: 00403914 (CONDITIONAL_JUMP)
    MOV dword ptr [0x006793bc],0x1      ; 00403867 | uint g_VertexProcessingEnabled
        ;   Label: LAB_00403867
    MOV ESI,dword ptr [ESP + 0x18]      ; 00403871
    MOV EDX,dword ptr [0x00772a60]      ; 00403875 | uint g_ProcessedVertexOffset
    MOV ESI,dword ptr [ESI + 0x4]       ; 0040387b
    ADD ESI,EDX                         ; 0040387e
    LEA EAX,[ESI*0x4 + 0x0]             ; 00403880
    SUB EAX,ESI                         ; 00403887
    MOV ESI,0x688014                    ; 00403889 | SRenderVertex[16] g_RenderVertexBuffer
    ...
    JLE 0x004038d2                      ; 004038a1 | LAB_004038d2
        ;   XREF to: 004038d2 (CONDITIONAL_JUMP)
    PUSH EDI                            ; 004038a3
        ;   Label: LAB_004038a3
    PUSH ESI                            ; 004038a4
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 004038a5 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    MOV EAX,[0x02d051f4]                ; 004038aa | float g_PerspectiveReciprocal
    MOV dword ptr [ESI + 0x2c],EAX      ; 004038af | g_RenderVertexBuffer[0].w_recip
    MOV AH,byte ptr [ESI + 0x13]        ; 004038b2 | DAT_00688024+3
    ADD ESP,0x8                         ; 004038b5
    TEST AH,0x80                        ; 004038b8
    JNZ 0x004038c0                      ; 004038bb | LAB_004038c0
    ...
    JL 0x004038a3                       ; 004038d0 | LAB_004038a3
        ;   XREF to: 004038a3 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [0x00772a60]      ; 004038d2 | uint g_ProcessedVertexOffset
        ;   Label: LAB_004038d2
    TEST ESI,ESI                        ; 004038d8
    JNZ 0x004038e2                      ; 004038da | LAB_004038e2
        ;   XREF to: 004038e2 (CONDITIONAL_JUMP)
    MOV dword ptr [0x00772a64],ESI      ; 004038dc | uint g_ProcessedVertexBackupOffset
    MOV ESI,dword ptr [ESP + 0x18]      ; 004038e2
        ;   Label: LAB_004038e2
    MOV EAX,dword ptr [ESP]             ; 004038e6
    MOV EBP,dword ptr [ESI + 0x8]       ; 004038e9
    CMP EAX,EBP                         ; 004038ec
    JZ 0x0040393c                       ; 004038ee | LAB_0040393c
    ...
    POP EBX                             ; 00403912
    RET                                 ; 00403913
    MOV ECX,0x6133d2                    ; 00403914 | = "..\\engine\\3d.c" | s_engine_3d_c_006133d2 = ..\engine\3d.c
        ;   Label: LAB_00403914
    MOV EBX,0x15c                       ; 00403919
    PUSH 0x6133e1                       ; 0040391e | = "vlist - too many verticies" | s_vlist_too_many_verticies_006133e1 = vlist - too many verticies
    MOV dword ptr [0x02f0ca48],ECX      ; 00403923 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 00403929 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0040392f | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00403934
    JMP 0x00403867                      ; 00403937 | LAB_00403867
        ;   XREF to: 00403867 (UNCONDITIONAL_JUMP)
    XOR EAX,EBP                         ; 0040393c
        ;   Label: LAB_0040393c
    MOV [0x006793bc],EAX                ; 0040393e | uint g_VertexProcessingEnabled
    JMP 0x004038f0                      ; 00403943 | LAB_004038f0
