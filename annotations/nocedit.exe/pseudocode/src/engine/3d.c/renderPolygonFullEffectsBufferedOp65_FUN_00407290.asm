...
;   undefined4 g_RenderBufferPool[0].texture_data.base.type
;   undefined4 g_RenderBufferPool[0].texture_data.base.count
...
section .text
    ...
    PUSH EBX                            ; 00407290
        ;   Label: engine_3d.c_renderPolygonFullEffectsBufferedOp65_FUN_00407290
    PUSH ESI                            ; 00407291
    PUSH EDI                            ; 00407292
    PUSH EBP                            ; 00407293
    ...
    MOVSD.REP ES:EDI,ESI                ; 00407422 | g_RenderBufferPool[0].texture_data.base.type | g_RenderBufferPool[0].texture_data.base.count
