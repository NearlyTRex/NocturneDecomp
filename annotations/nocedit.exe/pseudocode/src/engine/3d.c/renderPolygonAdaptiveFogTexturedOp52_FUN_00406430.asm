...
section .text
    ...
    PUSH ESI                            ; 00406430
        ;   Label: engine_3d.c_renderPolygonAdaptiveFogTexturedOp52_FUN_00406430
    PUSH EDI                            ; 00406431
    PUSH EBP                            ; 00406432
    ...
    JMP 0x00406489                      ; 0040651f
        ;   XREF to: 00406489 (UNCONDITIONAL_JUMP)  ; LAB_00406489
    CMP dword ptr [0x00772a70],0x0      ; 00406524 | INT_00772a70
        ;   Label: LAB_00406524
    ...
    PUSH EAX                            ; 00406654
    CALL engine_3d.c_lookupLitColor_FUN_004039c0 ; 00406655
