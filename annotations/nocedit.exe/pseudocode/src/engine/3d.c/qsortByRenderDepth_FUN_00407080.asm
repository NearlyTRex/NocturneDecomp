...
;                               FUNCTION
; *****************************************************************************
; __cdecl int engine_3d.c_qsortByRenderDepth_FUN_00407080(SRenderBufferEntry * * entry1_ptr, SRenderBufferEntry * * entry2_ptr)
;
; Parameters:
...
section .text
    ...
    JL 0x004070a6                       ; 0040709b | LAB_004070a6
        ;   XREF to: 004070a6 (CONDITIONAL_JUMP)
    JLE 0x004070ad                      ; 0040709d | LAB_004070ad
