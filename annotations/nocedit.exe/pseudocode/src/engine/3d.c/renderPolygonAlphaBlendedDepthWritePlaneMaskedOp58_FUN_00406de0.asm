...
;   engine_3d.c_renderPolygonAlphaBlendedPlaneMaskedOp36_FUN_00405690
...
section .text
    ...
    PUSH EBX                            ; 00406de0
        ;   Label: engine_3d.c_renderPolygonAlphaBlendedDepthWritePlaneMaskedOp58_FUN_00406de0
    ...
    MOV dword ptr [0x02d052a4],EDX      ; 00406e43 | g_VertexPreprocessMode
    ...
    MOV dword ptr [0x02d052a4],EDX      ; 00406eb9 | g_VertexPreprocessMode
    ...
    PUSH EBX                            ; 00406f02
        ;   Label: LAB_00406f02
    CALL engine_3d.c_renderPolygonDepthWritePass_FUN_00405960 ; 00406f03
    ...
    PUSH EBX                            ; 00406f0b
    CALL engine_3d.c_renderPolygonAlphaBlendedPlaneMaskedOp36_FUN_00405690 ; 00406f0c
        ;   XREF to: 00405690 (UNCONDITIONAL_CALL)  ; SMRGLHeaderExtended * engine_3d.c_renderPolygonAlphaBlendedPlaneMaskedOp36_FUN_00405690(SMRGLHeaderPrimitive * prim)
