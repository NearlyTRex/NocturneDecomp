...
;                               FUNCTION
; *****************************************************************************
; __cdecl SMRGLHeaderExtended * engine_3d.c_updateAnimatedTexture_FUN_004050c0(SAnimatedTexture * anim_texture)
;
; Parameters:
...
section .text
    ...
    MOV EAX,[0x02cf6a80]                ; 004050cb | int g_GlobalDeltaTimeInt
    ...
    JZ 0x004050fb                       ; 004050ef | LAB_004050fb
    ...
    CMP AL,0x0                          ; 00405115
    JZ 0x00405129                       ; 00405117 | LAB_00405129
    ...
    CMP AL,0x0                          ; 00405125
    JNZ 0x00405111                      ; 00405127 | LAB_00405111
        ;   XREF to: 00405111 (CONDITIONAL_JUMP)
    POP EDI                             ; 00405129
        ;   Label: LAB_00405129
    MOV EAX,ESP                         ; 0040512a
    PUSH EAX                            ; 0040512c
    CALL engine_texture.cpp_ensureTextureLoaded_FUN_005dd800 ; 0040512d | SMRGLHeaderExtended * engine_texture.cpp_ensureTextureLoaded_FUN_005dd800(SMRGLTextureBasic * texture)
        ;   XREF to: 005dd800 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EBX + 0x18]      ; 00405132
    ADD ESP,0x4                         ; 00405135
    TEST EAX,EAX                        ; 00405138
    JNZ 0x0040514f                      ; 0040513a | LAB_0040514f
