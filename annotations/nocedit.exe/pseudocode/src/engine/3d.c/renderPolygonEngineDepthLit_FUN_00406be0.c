...
// Convention: __cdecl
// Signature: SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonEngineDepthLit_FUN_00406be0(SMRGLHeaderPrimitive *polygon_info)
...

{
  ...
  if (iVar1 != 0) {
    ...
    g_RenderStateFlags.dword = RENDER_ENGINE_HIGH_QUALITY;
