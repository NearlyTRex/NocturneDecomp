...
section .text
    ...
    PUSH EBX                            ; 004066d0
        ;   Label: engine_3d.c_renderPolygonGrayscaleLitOp54_FUN_004066d0
    PUSH ESI                            ; 004066d1
    PUSH EBP                            ; 004066d2
    ...
    MOV dword ptr [0x02d052a4],EBP      ; 00406724 | g_VertexPreprocessMode
    ...
    CALL engine_3d.c_lookupLitColor_FUN_004039c0 ; 0040673f
