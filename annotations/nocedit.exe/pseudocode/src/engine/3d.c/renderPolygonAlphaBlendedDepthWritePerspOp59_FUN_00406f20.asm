...
;   engine_3d.c_renderPolygonAlphaBlendedPlaneMaskedPerspOp37_FUN_004057b0
;   engine_3d.c_renderPolygonDepthWritePass_FUN_00405960
...
section .text
    ...
    PUSH EBX                            ; 00406f20
        ;   Label: engine_3d.c_renderPolygonAlphaBlendedDepthWritePerspOp59_FUN_00406f20
    ...
    MOV dword ptr [0x02d052a4],EDX      ; 00406f83 | g_VertexPreprocessMode
    ...
    MOV dword ptr [0x02d052a4],EDX      ; 00406ffc | g_VertexPreprocessMode
    ...
    PUSH EBX                            ; 00407045
        ;   Label: LAB_00407045
    CALL engine_3d.c_renderPolygonDepthWritePass_FUN_00405960 ; 00407046
        ;   XREF to: 00405960 (UNCONDITIONAL_CALL)  ; SMRGLHeaderExtended * engine_3d.c_renderPolygonDepthWritePass_FUN_00405960(SMRGLHeaderPrimitive * prim)
    ADD ESP,0x4                         ; 0040704b
    PUSH EBX                            ; 0040704e
    CALL engine_3d.c_renderPolygonAlphaBlendedPlaneMaskedPerspOp37_FUN_004057b0 ; 0040704f
        ;   XREF to: 004057b0 (UNCONDITIONAL_CALL)  ; SMRGLHeaderExtended * engine_3d.c_renderPolygonAlphaBlendedPlaneMaskedPerspOp37_FUN_004057b0(SMRGLHeaderPrimitive * prim)
