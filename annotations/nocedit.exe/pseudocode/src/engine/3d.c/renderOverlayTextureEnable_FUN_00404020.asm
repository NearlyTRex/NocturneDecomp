...
;                               FUNCTION
; *****************************************************************************
; __cdecl void * __cdecl engine_3d_c_renderOverlayTextureEnable_FUN_00404020(SMRGLHeaderPrimitive *polygon_info)
;
; Parameters:
...
section .text
    ...
    MOV dword ptr [0x02d052a4],EDX      ; 00404061 | g_RenderStateFlag2
    ...
    MOV dword ptr [ECX],EDX             ; 0040408a | g_ProcessedVertexIndices | DAT_00772a9c
