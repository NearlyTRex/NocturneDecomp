...
section .text
    ...
    PUSH ESI                            ; 00405b50
        ;   Label: engine_3d.c_renderPolygonFogTexturedPlaneMaskedOp41_FUN_00405b50
    PUSH EDI                            ; 00405b51
    PUSH EBP                            ; 00405b52
    ...
    MOV dword ptr [EBX],EDX             ; 00405be0 | g_ProcessedVertexIndices | g_ProcessedVertexIndices[1]
    ...
    ADD EBX,0x4                         ; 00405bfc | g_ProcessedVertexIndices[1]
