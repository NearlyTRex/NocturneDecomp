...
;                               FUNCTION
; *****************************************************************************
; __cdecl SMRGLHeaderExtended * engine_3d.c_processTextureCoordinates_FUN_00403a80(SMRGLHeaderPrimitive * polygon_info)
;
; Parameters:
...
section .text
    ...
    JLE 0x00403abf                      ; 00403a8f | LAB_00403abf
    ...
    JL 0x00403a92                       ; 00403abc | LAB_00403a92
