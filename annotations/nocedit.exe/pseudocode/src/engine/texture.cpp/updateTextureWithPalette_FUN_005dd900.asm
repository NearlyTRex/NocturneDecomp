...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_texture.cpp_updateTextureWithPalette_FUN_005dd900(SMRGLTextureBasic * texture_to_load, SMRGLTextureBasic * texture_to_update)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 005dd905
    CALL engine_texture.cpp_ensureTextureLoaded_FUN_005dd800 ; 005dd906 | SMRGLHeaderExtended * engine_texture.cpp_ensureTextureLoaded_FUN_005dd800(SMRGLTextureBasic * texture)
        ;   XREF to: 005dd800 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005dd90b
    MOV ECX,dword ptr [0x02d01920]      ; 005dd90e | byte * g_CurrentPalette
    PUSH ECX                            ; 005dd914
    MOV EBX,dword ptr [ESP + 0xc]       ; 005dd915
    PUSH EBX                            ; 005dd919
    CALL wincore_windll.cpp_updateTexture_FUN_005b7380 ; 005dd91a | int wincore_windll.cpp_updateTexture_FUN_005b7380(SMRGLTextureBasic * tex, SRGBColorPalette * palette_data)
