...
;                               FUNCTION
; *****************************************************************************
; __cdecl SMRGLHeaderExtended * engine_texture.cpp_loadTextureAndGetData_FUN_005dd8c0(SMRGLTextureBasic * texture_info)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 005dd8c4
    CALL engine_texture.cpp_ensureTextureLoaded_FUN_005dd800 ; 005dd8c5 | SMRGLHeaderExtended * engine_texture.cpp_ensureTextureLoaded_FUN_005dd800(SMRGLTextureBasic * texture)
