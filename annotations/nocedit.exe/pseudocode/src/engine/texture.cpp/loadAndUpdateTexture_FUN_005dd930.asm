...
; SRGBColorPalette * Stack[0x8]:4   palette
;
; XREF[1]:
...
section .text
    ...
    PUSH EDX                            ; 005dd935
    CALL engine_texture.cpp_ensureTextureLoaded_FUN_005dd800 ; 005dd936
    ...
    PUSH EBX                            ; 005dd947
    CALL engine_special.cpp_updateTextureFromPalette_FUN_005b7380 ; 005dd948
