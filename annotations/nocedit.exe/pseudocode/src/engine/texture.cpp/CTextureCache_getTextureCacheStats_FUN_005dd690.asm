...
;                               FUNCTION
; *****************************************************************************
; __cdecl int engine_texture.cpp_CTextureCache_getTextureCacheStats_FUN_005dd690(CTextureCache * this_ptr, char * output_buffer)
;
; Parameters:
...
section .text
    ...
    JL 0x005dd6bd                       ; 005dd706 | LAB_005dd6bd
    ...
    PUSH ESI                            ; 005dd71f
    PUSH 0x655416                       ; 005dd720 | = "Total: %d, 32: %d, 64: %d, 128: %d, 2..." | s_Total_d_32_d_64_d_128_d__00655416 = Total: %d, 32: %d, 64: %d, 128: %d, 256: %d, 512: %d, 1024: %d
    MOV EDI,dword ptr [ESP + 0x40]      ; 005dd725
    PUSH EDI                            ; 005dd729
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005dd72a | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    NOP                                 ; 005dd73f
    RET                                 ; 005dd740
    PUSH 0x6553e2                       ; 005dd741 | = "Texture cache has wrapped.  Make it b..." | s_Texture_cache_has_wrappe_006553e2 = Texture cache has wrapped.  Make it bigger, please.
        ;   Label: LAB_005dd741
    MOV EAX,dword ptr [ESP + 0x24]      ; 005dd746
    PUSH EAX                            ; 005dd74a
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005dd74b | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
