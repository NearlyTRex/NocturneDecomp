...

{
  ...
  if (this_ptr->wrap_indicator == 0) {
    ...
    if (0 < this_ptr->current_texture_count) {
      do {
        if (this_ptr->texture_dimensions[iVar3] == 0x20) {
          iVar5 = iVar5 + 1;
        }
        if (this_ptr->texture_dimensions[iVar3] == 0x40) {
          iVar6 = iVar6 + 1;
        }
        if (this_ptr->texture_dimensions[iVar3] == 0x80) {
          iVar2 = iVar2 + 1;
        }
        if (this_ptr->texture_dimensions[iVar3] == 0x100) {
          local_14 = local_14 + 1;
        }
        if (this_ptr->texture_dimensions[iVar3] == 0x200) {
          iVar4 = iVar4 + 1;
        }
        if (this_ptr->texture_dimensions[iVar3] == 0x400) {
          local_18 = local_18 + 1;
        }
        iVar3 = iVar3 + 1;
