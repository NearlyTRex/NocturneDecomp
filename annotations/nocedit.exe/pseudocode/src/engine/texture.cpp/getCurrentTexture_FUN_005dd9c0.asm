...
;   undefined4 g_CurrentTexture.textures[0].texture_name[0]
;   undefined4 g_CurrentTexture.textures[0].texture_name[1]
;   undefined4 g_CurrentTexture.textures[0].texture_name[2]
...
section .text
    ...
    MOV EDI,0x3f87364                   ; 005dd9e7 | g_CurrentTexture.textures[0].texture_name[0]
    ADD ESI,EAX                         ; 005dd9ec
    MOV dword ptr [0x03f8735c],EDX      ; 005dd9ee | g_CurrentTexture
    PUSH EDI                            ; 005dd9f4 | g_CurrentTexture.textures[0].texture_name[0]
    MOV AL,byte ptr [ESI]               ; 005dd9f5
        ;   Label: LAB_005dd9f5
    MOV byte ptr [EDI],AL               ; 005dd9f7 | g_CurrentTexture.textures[0].texture_name[0] | g_CurrentTexture.textures[0].texture_name[2]
    CMP AL,0x0                          ; 005dd9f9
    JZ 0x005dda0d                       ; 005dd9fb
        ;   XREF to: 005dda0d (CONDITIONAL_JUMP)  ; LAB_005dda0d
    MOV AL,byte ptr [ESI + 0x1]         ; 005dd9fd
    ADD ESI,0x2                         ; 005dda00
    MOV byte ptr [EDI + 0x1],AL         ; 005dda03 | g_CurrentTexture.textures[0].texture_name[1] | g_CurrentTextureInfo.texture_name[3]
