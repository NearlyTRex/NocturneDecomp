...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl engine_texture_cpp_CTextureCache_freeTextures_FUN_005dcb30(CTextureCache *this_ptr)
;
; Parameters:
...
;   engine_texture.cpp_CTextureCache_reset_FUN_005dcb20 at 005dcb25
...
section .text
    ...
    PUSH EBX                            ; 005dcb30
        ;   Label: engine_texture.cpp_CTextureCache_freeTextures_FUN_005dcb30
    PUSH ESI                            ; 005dcb31
    PUSH EDI                            ; 005dcb32
    PUSH EBP                            ; 005dcb33
    ...
    JLE 0x005dcbc7                      ; 005dcb49
        ;   XREF to: 005dcbc7 (CONDITIONAL_JUMP)  ; LAB_005dcbc7
    ...
    JNZ 0x005dcbd3                      ; 005dcb69
        ;   XREF to: 005dcbd3 (CONDITIONAL_JUMP)  ; LAB_005dcbd3
    MOV ECX,dword ptr [EBX + 0x2008]    ; 005dcb6b
        ;   Label: LAB_005dcb6b
    TEST ECX,ECX                        ; 005dcb71
    JZ 0x005dcb92                       ; 005dcb73
        ;   XREF to: 005dcb92 (CONDITIONAL_JUMP)  ; LAB_005dcb92
    PUSH 0xcc                           ; 005dcb75
    PUSH 0x655158                       ; 005dcb7a | = "..\\engine\\texture.cpp"
    PUSH ECX                            ; 005dcb7f
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 005dcb80
    ...
    JZ 0x005dcbb9                       ; 005dcb9a
        ;   XREF to: 005dcbb9 (CONDITIONAL_JUMP)  ; LAB_005dcbb9
    PUSH 0xd0                           ; 005dcb9c
    PUSH 0x65516e                       ; 005dcba1 | = "..\\engine\\texture.cpp"
    PUSH EDX                            ; 005dcba6
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 005dcba7
        ;   XREF to: 0050f460 (UNCONDITIONAL_CALL)  ; void shape_memdbg.cpp_debugFree_FUN_0050f460(void * ptr, char * filename, int line_number)
    ...
    JL 0x005dcb53                       ; 005dcbc5
        ;   XREF to: 005dcb53 (CONDITIONAL_JUMP)  ; LAB_005dcb53
    ...
    PUSH 0xc8                           ; 005dcbd3
        ;   Label: LAB_005dcbd3
    PUSH 0x655142                       ; 005dcbd8 | = "..\\engine\\texture.cpp"
    PUSH EAX                            ; 005dcbdd
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 005dcbde
        ;   XREF to: 0050f460 (UNCONDITIONAL_CALL)  ; void shape_memdbg.cpp_debugFree_FUN_0050f460(void * ptr, char * filename, int line_number)
    ADD ESP,0xc                         ; 005dcbe3
    MOV dword ptr [EBX + 0x1008],0x0    ; 005dcbe6
    JMP 0x005dcb6b                      ; 005dcbf0
        ;   XREF to: 005dcb6b (UNCONDITIONAL_JUMP)  ; LAB_005dcb6b
