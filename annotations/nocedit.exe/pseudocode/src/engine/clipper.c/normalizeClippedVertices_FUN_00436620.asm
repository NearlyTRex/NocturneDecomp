...
section .text
    ...
    PUSH EDI                            ; 00436622
    PUSH EBP                            ; 00436623
    MOV ESI,dword ptr [0x00824e24]      ; 00436624 | int g_ClippedVertexCount
    XOR ECX,ECX                         ; 0043662a
    TEST ESI,ESI                        ; 0043662c
    JLE 0x0043664d                      ; 0043662e | LAB_0043664d
        ;   XREF to: 0043664d (CONDITIONAL_JUMP)
    MOV EAX,0x824e28                    ; 00436630 | SRenderVertex[16] g_ClippedVertexBuffer
    MOV EDX,dword ptr [EAX + 0x8]       ; 00436635 | g_ClippedVertexBuffer[0].projected_vertex.transformed_z
        ;   Label: LAB_00436635
    TEST EDX,EDX                        ; 00436638
    JZ 0x00436658                       ; 0043663a | LAB_00436658
        ;   XREF to: 00436658 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [EAX + 0x8]       ; 0043663c | g_ClippedVertexBuffer[0].projected_vertex.transformed_z
    CMP EBX,dword ptr [EAX]             ; 0043663f | SRenderVertex[16] g_ClippedVertexBuffer
    JGE 0x00436666                      ; 00436641 | LAB_00436666
        ;   XREF to: 00436666 (CONDITIONAL_JUMP)
    MOV dword ptr [EAX],EBX             ; 00436643 | SRenderVertex[16] g_ClippedVertexBuffer
    INC ECX                             ; 00436645
        ;   Label: LAB_00436645
    ADD EAX,0x30                        ; 00436646 | DAT_00824e58
    CMP ECX,ESI                         ; 00436649
    JL 0x00436635                       ; 0043664b | LAB_00436635
        ;   XREF to: 00436635 (CONDITIONAL_JUMP)
    MOV dword ptr [0x00824e24],ESI      ; 0043664d | int g_ClippedVertexCount
        ;   Label: LAB_0043664d
    POP EBP                             ; 00436653
    POP EDI                             ; 00436654
    POP ESI                             ; 00436655
    ...
    JMP 0x00436645                      ; 00436664 | LAB_00436645
