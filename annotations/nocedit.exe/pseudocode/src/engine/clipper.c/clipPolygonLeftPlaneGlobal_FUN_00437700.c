...

{
  ...
  if (0 < g_InputVertexCount) {
    ...
    do {
      ...
      case 0:
        pSVar4 = v1;
        pSVar2 = g_ClipperOutputBuffer + g_OutputVertexCount;
        for (iVar1 = 0xc; iVar1 != 0; iVar1 = iVar1 + -1) {
          (pSVar2->projected_vertex).transformed_x = (pSVar4->projected_vertex).transformed_x;
        ...
        for (iVar1 = 0; iVar1 != 0; iVar1 = iVar1 + -1) {
          ...
          *(char *)&(pSVar2->projected_vertex).transformed_x =
          ...
          pSVar4 = pSVar4;
          pSVar2 = (SRenderVertex *)((int)pSVar2 + (uint)bVar7 * -2 + 1);
        }
      ...
      case 2:
        ...
        for (iVar3 = 0xc; iVar3 != 0; iVar3 = iVar3 + -1) {
          ...
          pSVar6 = (SRenderVertex *)((int)pSVar6 + (uint)bVar7 * -8 + 4);
        }
        for (iVar1 = 0; iVar1 != 0; iVar1 = iVar1 + -1) {
