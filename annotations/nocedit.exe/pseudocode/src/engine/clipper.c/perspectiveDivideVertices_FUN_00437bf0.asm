...
section .text
    ...
    MOV EDX,dword ptr [EAX + 0x8]       ; 00437c05 | g_ClippedVertexBuffer[0].projected_vertex.transformed_z | g_ClippedVertexBuffer[1].projected_vertex.transformed_z
        ;   Label: LAB_00437c05
    TEST EDX,EDX                        ; 00437c08
    JZ 0x00437c28                       ; 00437c0a
        ;   XREF to: 00437c28 (CONDITIONAL_JUMP)  ; LAB_00437c28
    MOV EBX,dword ptr [EAX + 0x8]       ; 00437c0c | g_ClippedVertexBuffer[0].projected_vertex.transformed_z | g_ClippedVertexBuffer[1].projected_vertex.transformed_z
    CMP EBX,dword ptr [EAX]             ; 00437c0f | g_ClippedVertexBuffer | g_ClippedVertexBuffer[1].projected_vertex.transformed_x
    JGE 0x00437c36                      ; 00437c11
        ;   XREF to: 00437c36 (CONDITIONAL_JUMP)  ; LAB_00437c36
    MOV dword ptr [EAX],EBX             ; 00437c13 | g_ClippedVertexBuffer | g_ClippedVertexBuffer[1].projected_vertex.transformed_x
    INC ECX                             ; 00437c15
        ;   Label: LAB_00437c15
    ADD EAX,0x30                        ; 00437c16 | g_ClippedVertexBuffer[1].projected_vertex.transformed_x | g_ClippedVertexBuffer[2].projected_vertex.transformed_x
    ...
    POP EBX                             ; 00437c26
    RET                                 ; 00437c27
    MOV dword ptr [EAX + 0x8],0x1       ; 00437c28 | g_ClippedVertexBuffer[1].projected_vertex.transformed_z
        ;   Label: LAB_00437c28
    MOV dword ptr [EAX],EDX             ; 00437c2f | g_ClippedVertexBuffer[1].projected_vertex.transformed_x
    MOV dword ptr [EAX + 0x4],EDX       ; 00437c31 | g_ClippedVertexBuffer[1].projected_vertex.transformed_y
    JMP 0x00437c15                      ; 00437c34
        ;   XREF to: 00437c15 (UNCONDITIONAL_JUMP)  ; LAB_00437c15
    MOV EDX,EBX                         ; 00437c36
        ;   Label: LAB_00437c36
    MOV EDI,dword ptr [EAX]             ; 00437c38 | g_ClippedVertexBuffer[1].projected_vertex.transformed_x
    NEG EDX                             ; 00437c3a
    CMP EDX,EDI                         ; 00437c3c
    JLE 0x00437c44                      ; 00437c3e
        ;   XREF to: 00437c44 (CONDITIONAL_JUMP)  ; LAB_00437c44
    MOV dword ptr [EAX],EDX             ; 00437c40 | g_ClippedVertexBuffer[1].projected_vertex.transformed_x
    JMP 0x00437c15                      ; 00437c42
        ;   XREF to: 00437c15 (UNCONDITIONAL_JUMP)  ; LAB_00437c15
    MOV EBP,dword ptr [EAX + 0x8]       ; 00437c44 | g_ClippedVertexBuffer[1].projected_vertex.transformed_z
        ;   Label: LAB_00437c44
    MOV EBX,dword ptr [EAX + 0x4]       ; 00437c47 | g_ClippedVertexBuffer[1].projected_vertex.transformed_y
    CMP EBX,EBP                         ; 00437c4a
    JLE 0x00437c53                      ; 00437c4c
        ;   XREF to: 00437c53 (CONDITIONAL_JUMP)  ; LAB_00437c53
    MOV dword ptr [EAX + 0x4],EBP       ; 00437c4e | g_ClippedVertexBuffer[1].projected_vertex.transformed_y
    ...
    MOV dword ptr [EAX + 0x4],EDX       ; 00437c57 | g_ClippedVertexBuffer[1].projected_vertex.transformed_y
