      ...
      if (uVar11 == 0) {
        ...
        if (0 < g_InputVertexCount) {
          ...
          do {
            ...
            switch(bVar3) {
            case 0:
              g_ClipperOutputBuffer[g_OutputVertexCount] = *pSVar10;
        ...
        if (2 < g_OutputVertexCount) {
          ...
          if (0 < g_OutputVertexCount) {
            ...
            do {
              ...
              switch(bVar4) {
              case 0:
                g_ClipperWorkingBuffer[g_TempVertexCount] = *pSVar10;
          ...
          if (2 < g_TempVertexCount) {
            ...
            if (0 < g_TempVertexCount) {
              ...
              do {
                ...
                switch(bVar4) {
                case 0:
                  g_ClipperIntermediateBuffer[g_IntermediateVertexCount] = *pSVar10;
            ...
            if (2 < g_IntermediateVertexCount) {
              ...
              if (0 < g_IntermediateVertexCount) {
                ...
                do {
                  ...
                  switch(bVar4) {
                  case 0:
                    g_ClippedVertexBuffer[g_ClippedVertexCount] = *pSVar10;
