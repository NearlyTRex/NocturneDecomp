...
// Convention: __cdecl
// Signature: int __cdecl engine_clipper_c_clipPolygonLeftPlane_FUN_00435f20(SRenderVertex **input_vertices,SRenderVertex **output_vertices,int vertex_count)
  ...
  if (0 < vertex_count) {
    ...
    do {
      ...
      case 2:
        ...
        engine_clipper_c_interpolateVertexLeftClip_FUN_00435a00(v1,v2,output);
      }
      local_14 = local_14 + 1;
      local_18 = local_18 + 1;
      iVar5 = iVar4;
