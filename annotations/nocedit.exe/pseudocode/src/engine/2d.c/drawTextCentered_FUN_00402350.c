...
// Convention: __cdecl
// Signature: void __cdecl engine_2d_c_drawTextCentered_FUN_00402350(char *text,int left_x,int right_x,int y)
...

{
  ...
  engine_2d_c_drawText_FUN_00401fd0(text,(((left_x + right_x) - iVar1) + 2) / 2,y);
  return;
}
