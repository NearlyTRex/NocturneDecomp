...
section .text
    ...
    MOV ECX,dword ptr [EAX + 0x2cf7d5c] ; 004012a5 | uint *[1024] g_ZBufferScanlineArray
    ADD ECX,EDX                         ; 004012ab
    MOV EDI,dword ptr [ESP + 0x18]      ; 004012ad
    CMP EDI,dword ptr [ECX]             ; 004012b1
    JBE 0x004012e9                      ; 004012b3 | LAB_004012e9
        ;   XREF to: 004012e9 (CONDITIONAL_JUMP)
    MOV EBP,dword ptr [0x0067939c]      ; 004012b5 | int g_BitsPerPixel
    MOV dword ptr [ECX],EDI             ; 004012bb
    CMP EBP,0x8                         ; 004012bd
    JZ 0x004012ed                       ; 004012c0 | LAB_004012ed
        ;   XREF to: 004012ed (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x02d02570]      ; 004012c2 | int g_ActiveRenderColor
    AND ECX,0xff                        ; 004012c8
    CMP EBP,0x10                        ; 004012ce
    JNZ 0x00401301                      ; 004012d1 | LAB_00401301
        ;   XREF to: 00401301 (CONDITIONAL_JUMP)
    LEA EDX,[EBX + EBX*0x1]             ; 004012d3
    MOV EAX,dword ptr [EAX + 0x2cf6a9c] ; 004012d6 | void *[1024] g_ScreenBufferArray
    ADD EDX,EAX                         ; 004012dc
    MOV AX,word ptr [ECX*0x2 + 0x2d01020] ; 004012de | ushort[256] g_ColorTable16
    ...
    POP EBX                             ; 004012eb
    RET                                 ; 004012ec
    MOV EAX,dword ptr [EAX + 0x2cf6a9c] ; 004012ed | void *[1024] g_ScreenBufferArray
        ;   Label: LAB_004012ed
    LEA EDX,[EAX + EBX*0x1]             ; 004012f3
    MOV AL,[0x02d02570]                 ; 004012f6 | int g_ActiveRenderColor
    MOV byte ptr [EDX],AL               ; 004012fb
    POP EBP                             ; 004012fd
    POP EDI                             ; 004012fe
    POP EBX                             ; 004012ff
    RET                                 ; 00401300
    MOV EAX,dword ptr [EAX + 0x2cf6a9c] ; 00401301 | void *[1024] g_ScreenBufferArray
        ;   Label: LAB_00401301
    ADD EDX,EAX                         ; 00401307
    MOV EAX,dword ptr [ECX*0x4 + 0x2d01220] ; 00401309 | uint[256] g_ColorTable32
