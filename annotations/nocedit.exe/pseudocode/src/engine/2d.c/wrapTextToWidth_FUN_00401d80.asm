...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_2d.c_wrapTextToWidth_FUN_00401d80(char * input_text, int max_width, char * output_buffer)
;
; Parameters:
...
section .text
    ...
    TEST AH,AH                          ; 00401d9f
    JNZ 0x00401db8                      ; 00401da1 | LAB_00401db8
    ...
    CMP AL,0x0                          ; 00401dc4
    JZ 0x00401dd8                       ; 00401dc6 | LAB_00401dd8
    ...
    CMP AL,0x0                          ; 00401dd4
    JNZ 0x00401dc0                      ; 00401dd6 | LAB_00401dc0
        ;   XREF to: 00401dc0 (CONDITIONAL_JUMP)
    POP EDI                             ; 00401dd8
        ;   Label: LAB_00401dd8
    PUSH EDI                            ; 00401dd9
    CALL engine_2d.c_getStringWidth_FUN_004018a0 ; 00401dda | int engine_2d.c_getStringWidth_FUN_004018a0(char * text)
        ;   XREF to: 004018a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00401ddf
    CMP EAX,dword ptr [ESP + 0x11c]     ; 00401de2
    JLE 0x00401dad                      ; 00401de9 | LAB_00401dad
    ...
    MOV DL,byte ptr [EBX]               ; 00401def
        ;   Label: LAB_00401def
    TEST DL,DL                          ; 00401df1
    JZ 0x00401e0b                       ; 00401df3 | LAB_00401e0b
        ;   XREF to: 00401e0b (CONDITIONAL_JUMP)
    MOV AL,DL                           ; 00401df5
    INC AL                              ; 00401df7
    AND EAX,0xff                        ; 00401df9
    TEST byte ptr [EAX + 0x6849c4],0x2  ; 00401dfe | char[256] g_CharacterClassificationTable
    JZ 0x00401e96                       ; 00401e05 | LAB_00401e96
    ...
    CALL engine_2d.c_getStringWidth_FUN_004018a0 ; 00401e2e | int engine_2d.c_getStringWidth_FUN_004018a0(char * text)
        ;   XREF to: 004018a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00401e33
    CMP EAX,dword ptr [ESP + 0x11c]     ; 00401e36
    JLE 0x00401e65                      ; 00401e3d | LAB_00401e65
        ;   XREF to: 00401e65 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [EBX + -0x1]        ; 00401e3f
    DEC EBX                             ; 00401e42
    CMP AL,0xa                          ; 00401e43
    JZ 0x00401e55                       ; 00401e45 | LAB_00401e55
        ;   XREF to: 00401e55 (CONDITIONAL_JUMP)
    CMP byte ptr [EBX],0x20             ; 00401e47
        ;   Label: LAB_00401e47
    JZ 0x00401e55                       ; 00401e4a | LAB_00401e55
        ;   XREF to: 00401e55 (CONDITIONAL_JUMP)
    MOV DL,byte ptr [EBX + -0x1]        ; 00401e4c
    DEC EBX                             ; 00401e4f
    CMP DL,0xa                          ; 00401e50
    JNZ 0x00401e47                      ; 00401e53 | LAB_00401e47
    ...
    JNZ 0x00401def                      ; 00401e85 | LAB_00401def
    ...
    CMP DL,0xa                          ; 00401e96
        ;   Label: LAB_00401e96
    JZ 0x00401e0b                       ; 00401e99 | LAB_00401e0b
        ;   XREF to: 00401e0b (CONDITIONAL_JUMP)
    JMP 0x00401e7b                      ; 00401e9f | LAB_00401e7b
