...
;                               FUNCTION
; *****************************************************************************
; __cdecl int engine_2d.c_drawCharacter_FUN_00401610(int char_code, int x_pos, int y_pos)
;
; Parameters:
...
section .text
    ...
    MOV EBX,dword ptr [0x02d02558]      ; 0040163a | int g_ClipLeft
    MOV DL,byte ptr [EAX]               ; 00401640 | g_FontTable
    CMP ECX,EBX                         ; 00401642
    JL 0x004016eb                       ; 00401644 | LAB_004016eb
        ;   XREF to: 004016eb (CONDITIONAL_JUMP)
    CMP EDI,dword ptr [0x02d0255c]      ; 0040164a | int g_ClipTop
    JL 0x004016eb                       ; 00401650 | LAB_004016eb
        ;   XREF to: 004016eb (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x02d02560]      ; 00401656 | int g_ClipRight
    INC ECX                             ; 0040165c
    MOV EBP,dword ptr [ESP + 0x24]      ; 0040165d
    SUB ECX,EDX                         ; 00401661
    CMP ECX,EBP                         ; 00401663
    JL 0x004016eb                       ; 00401665 | LAB_004016eb
        ;   XREF to: 004016eb (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x02d02564]      ; 0040166b | int g_ClipBottom
    SUB ECX,0xa                         ; 00401671
    CMP EDI,ECX                         ; 00401674
    JG 0x004016eb                       ; 00401676 | LAB_004016eb
        ;   XREF to: 004016eb (CONDITIONAL_JUMP)
    PUSH ESI                            ; 0040167c
    MOV ECX,dword ptr [0x0067939c]      ; 0040167d | int g_BitsPerPixel
    SHL EDI,0x2                         ; 00401683
    INC EAX                             ; 00401686
    LEA EBP,[EDI + 0x2c]                ; 00401687
    CMP ECX,0x8                         ; 0040168a
    JZ 0x004016ef                       ; 0040168d | LAB_004016ef
        ;   XREF to: 004016ef (CONDITIONAL_JUMP)
    CMP ECX,0x10                        ; 0040168f
    JNZ 0x00401721                      ; 00401692 | LAB_00401721
    ...
    MOV ECX,dword ptr [EDI + 0x2cf6a9c] ; 004016aa | void *[1024] g_ScreenBufferArray
        ;   Label: LAB_004016aa
    XOR EBX,EBX                         ; 004016b0
    ADD ECX,EBP                         ; 004016b2
    TEST EDX,EDX                        ; 004016b4
    JLE 0x004016d0                      ; 004016b6 | LAB_004016d0
        ;   XREF to: 004016d0 (CONDITIONAL_JUMP)
    MOVZX ESI,byte ptr [EAX]            ; 004016b8 | DAT_00666041
        ;   Label: LAB_004016b8
    INC EAX                             ; 004016bb
    ADD ECX,0x2                         ; 004016bc
    MOV SI,word ptr [ESI*0x2 + 0x2d01020] ; 004016bf | ushort[256] g_ColorTable16
    INC EBX                             ; 004016c7
    MOV word ptr [ECX + -0x2],SI        ; 004016c8
    CMP EBX,EDX                         ; 004016cc
    JL 0x004016b8                       ; 004016ce | LAB_004016b8
        ;   XREF to: 004016b8 (CONDITIONAL_JUMP)
    ADD EDI,0x4                         ; 004016d0
        ;   Label: LAB_004016d0
    MOV word ptr [ECX],0x0              ; 004016d3
    CMP EDI,dword ptr [ESP + 0x8]       ; 004016d8
    JNZ 0x004016aa                      ; 004016dc | LAB_004016aa
    ...
    JZ 0x004016de                       ; 0040171d | LAB_004016de
        ;   XREF to: 004016de (CONDITIONAL_JUMP)
    JMP 0x004016f3                      ; 0040171f | LAB_004016f3
    ...
    MOV ESI,dword ptr [ESP + 0x4]       ; 0040172c
        ;   Label: LAB_0040172c
    MOV ECX,dword ptr [EDI + 0x2cf6a9c] ; 00401730 | void *[1024] g_ScreenBufferArray
    XOR EBX,EBX                         ; 00401736
    ADD ECX,ESI                         ; 00401738
    TEST EDX,EDX                        ; 0040173a
    JLE 0x00401754                      ; 0040173c | LAB_00401754
        ;   XREF to: 00401754 (CONDITIONAL_JUMP)
    MOVZX ESI,byte ptr [EAX]            ; 0040173e | DAT_00666041
        ;   Label: LAB_0040173e
    INC EAX                             ; 00401741
    ADD ECX,0x4                         ; 00401742
    MOV ESI,dword ptr [ESI*0x4 + 0x2d01220] ; 00401745 | uint[256] g_ColorTable32
    INC EBX                             ; 0040174c
    MOV dword ptr [ECX + -0x4],ESI      ; 0040174d
    CMP EBX,EDX                         ; 00401750
    JL 0x0040173e                       ; 00401752 | LAB_0040173e
        ;   XREF to: 0040173e (CONDITIONAL_JUMP)
    ADD EDI,0x4                         ; 00401754
        ;   Label: LAB_00401754
    MOV dword ptr [ECX],0x0             ; 00401757
    CMP EDI,EBP                         ; 0040175d
    JZ 0x004016de                       ; 0040175f | LAB_004016de
        ;   XREF to: 004016de (CONDITIONAL_JUMP)
    JMP 0x0040172c                      ; 00401765 | LAB_0040172c
