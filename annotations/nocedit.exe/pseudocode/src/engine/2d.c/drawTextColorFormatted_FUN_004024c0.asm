...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_2d.c_drawTextColorFormatted_FUN_004024c0(char * format_string, int x_pos, int y_pos, ...)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 004024ea
    CALL crt_stdio.c_vsprintf_FUN_005fdba8 ; 004024eb | int crt_stdio.c_vsprintf_FUN_005fdba8(char * buffer, char * format, va_list_t * args)
    ...
    CALL engine_2d.c_drawTextColor_FUN_00402430 ; 00402511 | void engine_2d.c_drawTextColor_FUN_00402430(char * text, int x_pos, int y_pos)
