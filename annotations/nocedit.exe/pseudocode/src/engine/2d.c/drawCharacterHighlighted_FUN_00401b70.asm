...
;                               FUNCTION
; *****************************************************************************
; __cdecl int engine_2d.c_drawCharacterHighlighted_FUN_00401b70(int char_code, int x_pos, int y_pos)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [0x02d02558]      ; 00401b98 | int g_ClipLeft
    MOVZX ESI,byte ptr [EAX]            ; 00401b9e | g_FontTable
    CMP EBP,EDX                         ; 00401ba1
    JL 0x00401c27                       ; 00401ba3 | LAB_00401c27
        ;   XREF to: 00401c27 (CONDITIONAL_JUMP)
    CMP EDI,dword ptr [0x02d0255c]      ; 00401ba9 | int g_ClipTop
    JL 0x00401c27                       ; 00401baf | LAB_00401c27
        ;   XREF to: 00401c27 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x02d02560]      ; 00401bb5 | int g_ClipRight
    INC EDX                             ; 00401bbb
    SUB EDX,ESI                         ; 00401bbc
    CMP EBP,EDX                         ; 00401bbe
    JG 0x00401c27                       ; 00401bc0 | LAB_00401c27
        ;   XREF to: 00401c27 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x02d02564]      ; 00401bc2 | int g_ClipBottom
    SUB EDX,0xa                         ; 00401bc8
    CMP EDI,EDX                         ; 00401bcb
    JG 0x00401c27                       ; 00401bcd | LAB_00401c27
        ;   XREF to: 00401c27 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 00401bcf
    MOV EBX,dword ptr [0x0067939c]      ; 00401bd0 | int g_BitsPerPixel
    SHL EDI,0x2                         ; 00401bd6
    INC EAX                             ; 00401bd9
    LEA EDX,[EDI + 0x2c]                ; 00401bda
    CMP EBX,0x8                         ; 00401bdd
    JZ 0x00401c2b                       ; 00401be0 | LAB_00401c2b
        ;   XREF to: 00401c2b (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x4],EDX       ; 00401be2
    ADD EBP,EBP                         ; 00401be6
    MOV EDX,dword ptr [EDI + 0x2cf6a9c] ; 00401be8 | void *[1024] g_ScreenBufferArray
        ;   Label: LAB_00401be8
    XOR ECX,ECX                         ; 00401bee
    ADD EDX,EBP                         ; 00401bf0
    TEST ESI,ESI                        ; 00401bf2
    JLE 0x00401c0f                      ; 00401bf4 | LAB_00401c0f
        ;   XREF to: 00401c0f (CONDITIONAL_JUMP)
    MOV BL,byte ptr [EAX]               ; 00401bf6 | DAT_00666041
        ;   Label: LAB_00401bf6
    TEST BL,BL                          ; 00401bf8
    JZ 0x00401c06                       ; 00401bfa | LAB_00401c06
    ...
    XOR EDX,EDX                         ; 00401c27
        ;   Label: LAB_00401c27
    JMP 0x00401c1e                      ; 00401c29 | LAB_00401c1e
        ;   XREF to: 00401c1e (UNCONDITIONAL_JUMP)
    MOV BH,0xff                         ; 00401c2b
        ;   Label: LAB_00401c2b
    MOV dword ptr [ESP + 0x8],EDX       ; 00401c2d
    MOV ECX,dword ptr [EDI + 0x2cf6a9c] ; 00401c31 | void *[1024] g_ScreenBufferArray
        ;   Label: LAB_00401c31
    XOR EDX,EDX                         ; 00401c37
    ADD ECX,EBP                         ; 00401c39
    TEST ESI,ESI                        ; 00401c3b
    JLE 0x00401c4e                      ; 00401c3d | LAB_00401c4e
        ;   XREF to: 00401c4e (CONDITIONAL_JUMP)
    MOV BL,byte ptr [EAX]               ; 00401c3f | DAT_00666041
        ;   Label: LAB_00401c3f
    TEST BL,BL                          ; 00401c41
    JZ 0x00401c47                       ; 00401c43 | LAB_00401c47
