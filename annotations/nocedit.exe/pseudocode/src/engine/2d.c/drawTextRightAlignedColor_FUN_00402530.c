...
// Convention: __cdecl
// Signature: void __cdecl engine_2d_c_drawTextRightAlignedColor_FUN_00402530(char *text,int x,int y)
...

{
  ...
  engine_2d_c_drawTextColor_FUN_00402430(text,(x - iVar1) + 2,y);
  return;
}
