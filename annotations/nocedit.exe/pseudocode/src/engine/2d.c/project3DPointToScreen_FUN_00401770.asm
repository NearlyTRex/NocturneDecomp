...
section .text
    ...
    MOV EDX,dword ptr [0x02d02548]      ; 0040177a | int g_ViewportCenterXFixed
    MOV EBX,ECX                         ; 00401780
    IMUL EDX                            ; 00401782
    IDIV EBX                            ; 00401784
    MOV ESI,dword ptr [0x02d02550]      ; 00401786 | int g_ViewportRightFixed
    MOV EDX,dword ptr [0x02d0254c]      ; 0040178c | int g_ViewportCenterYFixed
    MOV EBX,ECX                         ; 00401792
    ADD ESI,EAX                         ; 00401794
    MOV EAX,dword ptr [ESP + 0x10]      ; 00401796
    IMUL EDX                            ; 0040179a
    IDIV EBX                            ; 0040179c
    ADD EAX,dword ptr [0x02d02554]      ; 0040179e | int g_ViewportBottomFixed
    SAR EAX,0x10                        ; 004017a4
    PUSH EAX                            ; 004017a7
    SAR ESI,0x10                        ; 004017a8
    PUSH ESI                            ; 004017ab
    CALL engine_2d.c_plotPixel_FUN_00401140 ; 004017ac | void engine_2d.c_plotPixel_FUN_00401140(int x, int y)
