...
;                               FUNCTION
; *****************************************************************************
; __cdecl int engine_2d.c_drawCharacterMasked_FUN_00401900(int char_code, int x_pos, int y_pos)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [0x02d02558]      ; 00401928 | int g_ClipLeft
    MOVZX ESI,byte ptr [EAX]            ; 0040192e | g_FontTable
    CMP EBP,EDX                         ; 00401931
    JL 0x004019cb                       ; 00401933 | LAB_004019cb
        ;   XREF to: 004019cb (CONDITIONAL_JUMP)
    CMP EDI,dword ptr [0x02d0255c]      ; 00401939 | int g_ClipTop
    JL 0x004019cb                       ; 0040193f | LAB_004019cb
        ;   XREF to: 004019cb (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x02d02560]      ; 00401945 | int g_ClipRight
    INC EDX                             ; 0040194b
    SUB EDX,ESI                         ; 0040194c
    CMP EBP,EDX                         ; 0040194e
    JG 0x004019cb                       ; 00401950 | LAB_004019cb
        ;   XREF to: 004019cb (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x02d02564]      ; 00401956 | int g_ClipBottom
    SUB EDX,0xa                         ; 0040195c
    CMP EDI,EDX                         ; 0040195f
    JG 0x004019cb                       ; 00401961 | LAB_004019cb
        ;   XREF to: 004019cb (CONDITIONAL_JUMP)
    PUSH EBX                            ; 00401963
    MOV EBX,dword ptr [0x0067939c]      ; 00401964 | int g_BitsPerPixel
    SHL EDI,0x2                         ; 0040196a
    INC EAX                             ; 0040196d
    LEA EDX,[EDI + 0x2c]                ; 0040196e
    CMP EBX,0x8                         ; 00401971
    JZ 0x004019cf                       ; 00401974 | LAB_004019cf
    ...
    MOV ECX,dword ptr [ESP + 0x4]       ; 0040197e
        ;   Label: LAB_0040197e
    MOV EDX,dword ptr [EDI + 0x2cf6a9c] ; 00401982 | void *[1024] g_ScreenBufferArray
    ADD EDX,ECX                         ; 00401988
    XOR ECX,ECX                         ; 0040198a
    TEST ESI,ESI                        ; 0040198c
    JLE 0x004019ad                      ; 0040198e | LAB_004019ad
        ;   XREF to: 004019ad (CONDITIONAL_JUMP)
    MOV BL,byte ptr [EAX]               ; 00401990 | DAT_00666041
        ;   Label: LAB_00401990
    TEST BL,BL                          ; 00401992
    JZ 0x00401a04                       ; 00401994 | LAB_00401a04
    ...
    JL 0x00401990                       ; 004019ab | LAB_00401990
        ;   XREF to: 00401990 (CONDITIONAL_JUMP)
    MOV BX,word ptr [0x02d01020]        ; 004019ad | ushort[256] g_ColorTable16
        ;   Label: LAB_004019ad
    ADD EDI,0x4                         ; 004019b4
    MOV word ptr [EDX],BX               ; 004019b7
    CMP EDI,EBP                         ; 004019ba
    JNZ 0x0040197e                      ; 004019bc | LAB_0040197e
    ...
    XOR ECX,ECX                         ; 004019cb
        ;   Label: LAB_004019cb
    JMP 0x004019c2                      ; 004019cd | LAB_004019c2
        ;   XREF to: 004019c2 (UNCONDITIONAL_JUMP)
    MOV BH,0x2                          ; 004019cf
        ;   Label: LAB_004019cf
    MOV dword ptr [ESP + 0x8],EDX       ; 004019d1
    MOV EDX,dword ptr [EDI + 0x2cf6a9c] ; 004019d5 | void *[1024] g_ScreenBufferArray
        ;   Label: LAB_004019d5
    XOR ECX,ECX                         ; 004019db
    ADD EDX,EBP                         ; 004019dd
    TEST ESI,ESI                        ; 004019df
    JLE 0x004019f2                      ; 004019e1 | LAB_004019f2
        ;   XREF to: 004019f2 (CONDITIONAL_JUMP)
    MOV BL,byte ptr [EAX]               ; 004019e3 | DAT_00666041
        ;   Label: LAB_004019e3
    TEST BL,BL                          ; 004019e5
    JZ 0x00401a00                       ; 004019e7 | LAB_00401a00
