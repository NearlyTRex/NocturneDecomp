...
section .text
    ...
    MOV BL,byte ptr [EAX]               ; 00401990 | g_FontTable[0].bitmap[0] | g_FontTable[0].bitmap[1] | g_FontTable[0].bitmap[0][2]
        ;   Label: LAB_00401990
    TEST BL,BL                          ; 00401992
    ...
    MOV BL,byte ptr [EAX]               ; 004019e3 | g_FontTable[0].bitmap[0] | g_FontTable[0].bitmap[1] | g_FontTable[0].bitmap[0][2]
        ;   Label: LAB_004019e3
    TEST BL,BL                          ; 004019e5
