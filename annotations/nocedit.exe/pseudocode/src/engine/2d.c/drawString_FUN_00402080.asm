...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_2d.c_drawString_FUN_00402080(char * text, int x_pos, int y_pos, int color)
;
; Parameters:
...
section .text
    ...
    PUSH EBP                            ; 004020ba
    PUSH EAX                            ; 004020bb
    CALL engine_2d.c_drawCharacter_FUN_00401a10 ; 004020bc | int engine_2d.c_drawCharacter_FUN_00401a10(int char_code, int x_pos, int y_pos, int color)
    ...
    JL 0x004020a0                       ; 004020ca | LAB_004020a0
