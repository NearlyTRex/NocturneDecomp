...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_2d.c_drawTextRightAlignedColor_FUN_00402530(char * text, int y_pos, int right_x)
;
; Parameters:
...
section .text
    ...
    PUSH ECX                            ; 0040253a
    CALL engine_2d.c_getStringWidth_FUN_004018a0 ; 0040253b | int engine_2d.c_getStringWidth_FUN_004018a0(char * text)
    ...
    PUSH EBX                            ; 00402551
    CALL engine_2d.c_drawTextColor_FUN_00402430 ; 00402552 | void engine_2d.c_drawTextColor_FUN_00402430(char * text, int x_pos, int y_pos)
