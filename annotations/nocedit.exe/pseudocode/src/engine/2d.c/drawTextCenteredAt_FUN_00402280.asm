...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl engine_2d_c_drawTextCenteredAt_FUN_00402280(char *text,int x_pos,int y_pos)
;
; Parameters:
...
section .text
    ...
    PUSH ECX                            ; 0040228a
    CALL engine_2d.c_getStringWidth_FUN_004018a0 ; 0040228b
    ...
    PUSH EBX                            ; 004022aa
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 004022ab
