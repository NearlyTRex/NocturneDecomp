...
// Convention: __cdecl
// Signature: void __cdecl engine_2d_c_drawTextCenteredAtColor_FUN_004025f0(char *text,int center_x,int y_pos)
...

{
  ...
  engine_2d_c_drawTextColor_FUN_00402430(text,center_x - (iVar1 + -1) / 2,y_pos);
  return;
}
