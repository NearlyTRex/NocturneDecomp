...
section .text
    ...
    CALL engine_2d.c_drawCharacter_FUN_00401a10 ; 00401f8f | int engine_2d.c_drawCharacter_FUN_00401a10(int char_code, int x_pos, int y_pos, int color)
    ...
    JL 0x00401f64                       ; 00401fad | LAB_00401f64
    ...
    JG 0x00401faf                       ; 00401fcc | LAB_00401faf
        ;   XREF to: 00401faf (CONDITIONAL_JUMP)
    JMP 0x00401f69                      ; 00401fce | LAB_00401f69
