...
section .text
    ...
    PUSH EDX                            ; 00402cc4
    CALL engine_2d.c_computeOutcode_FUN_00402c10 ; 00402cc5 | byte engine_2d.c_computeOutcode_FUN_00402c10(int x, int y, int x_min, int y_min, ...)
    ...
    PUSH ESI                            ; 00402cee
    CALL engine_2d.c_computeOutcode_FUN_00402c10 ; 00402cef | byte engine_2d.c_computeOutcode_FUN_00402c10(int x, int y, int x_min, int y_min, ...)
        ;   XREF to: 00402c10 (UNCONDITIONAL_CALL)
    ...
    JZ 0x00402d66                       ; 00402d17 | LAB_00402d66
    ...
    JZ 0x00402d76                       ; 00402d23 | LAB_00402d76
        ;   XREF to: 00402d76 (CONDITIONAL_JUMP)
    XOR ECX,ECX                         ; 00402d25
    MOV dword ptr [ESP],ECX             ; 00402d27
    CMP dword ptr [ESP + 0x4],0x64      ; 00402d2a
        ;   Label: LAB_00402d2a
    JNZ 0x00402d54                      ; 00402d2f | LAB_00402d54
        ;   XREF to: 00402d54 (CONDITIONAL_JUMP)
    MOV ESI,0x61319f                    ; 00402d31 | = "..\\engine\\2d.c" | s_engine_2d_c_0061319f = ..\engine\2d.c
    MOV EDI,0x870                       ; 00402d36
    PUSH 0x6131ae                       ; 00402d3b | = "2d line clipping exceeded max iterations" | s_s_2d_line_clipping_excee_006131ae = 2d line clipping exceeded max iterations
    MOV dword ptr [0x02f0ca48],ESI      ; 00402d40 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 00402d46 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00402d4c | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00402d51
    CMP dword ptr [ESP],0x0             ; 00402d54
        ;   Label: LAB_00402d54
    JNZ 0x00402eb5                      ; 00402d58 | LAB_00402eb5
    ...
    CMP dword ptr [ESP + 0xc],0x0       ; 00402da5
        ;   Label: LAB_00402da5
    JZ 0x00402e74                       ; 00402daa | LAB_00402e74
    ...
    CALL engine_2d.c_computeOutcode_FUN_00402c10 ; 00402dca | byte engine_2d.c_computeOutcode_FUN_00402c10(int x, int y, int x_min, int y_min, ...)
        ;   XREF to: 00402c10 (UNCONDITIONAL_CALL)
    ADD ESP,0x18                        ; 00402dcf
    MOV EBP,EDI                         ; 00402dd2
    MOV dword ptr [ESP + 0xc],EAX       ; 00402dd4
    JMP 0x00402e9e                      ; 00402dd8 | LAB_00402e9e
        ;   XREF to: 00402e9e (UNCONDITIONAL_JUMP)
    MOV EAX,EDX                         ; 00402ddd
        ;   Label: LAB_00402ddd
    JMP 0x00402d7a                      ; 00402ddf | LAB_00402d7a
        ;   XREF to: 00402d7a (UNCONDITIONAL_JUMP)
    TEST AL,0x2                         ; 00402de1
        ;   Label: LAB_00402de1
    JZ 0x00402e0e                       ; 00402de3 | LAB_00402e0e
        ;   XREF to: 00402e0e (CONDITIONAL_JUMP)
    TEST ESI,ESI                        ; 00402de5
    JZ 0x00402e08                       ; 00402de7 | LAB_00402e08
    ...
    MOV EBX,dword ptr [ESP + 0x3c]      ; 00402e36
        ;   Label: LAB_00402e36
    JMP 0x00402da5                      ; 00402e3a | LAB_00402da5
        ;   XREF to: 00402da5 (UNCONDITIONAL_JUMP)
    TEST AL,0x8                         ; 00402e3f
        ;   Label: LAB_00402e3f
    JZ 0x00402da5                       ; 00402e41 | LAB_00402da5
        ;   XREF to: 00402da5 (CONDITIONAL_JUMP)
    TEST ECX,ECX                        ; 00402e47
    JZ 0x00402e6b                       ; 00402e49 | LAB_00402e6b
    ...
    MOV EBX,dword ptr [ESP + 0x34]      ; 00402e6b
        ;   Label: LAB_00402e6b
    JMP 0x00402da5                      ; 00402e6f | LAB_00402da5
        ;   XREF to: 00402da5 (UNCONDITIONAL_JUMP)
    ...
    CALL engine_2d.c_computeOutcode_FUN_00402c10 ; 00402e92 | byte engine_2d.c_computeOutcode_FUN_00402c10(int x, int y, int x_min, int y_min, ...)
        ;   XREF to: 00402c10 (UNCONDITIONAL_CALL)
    ...
    JL 0x00402d01                       ; 00402eaa | LAB_00402d01
        ;   XREF to: 00402d01 (CONDITIONAL_JUMP)
    JMP 0x00402d2a                      ; 00402eb0 | LAB_00402d2a
        ;   XREF to: 00402d2a (UNCONDITIONAL_JUMP)
    ...
    PUSH EBX                            ; 00402ec4
    CALL engine_2d.c_drawLine_FUN_004011b0 ; 00402ec5 | void engine_2d.c_drawLine_FUN_004011b0(int x1, int y1, int x2, int y2)
