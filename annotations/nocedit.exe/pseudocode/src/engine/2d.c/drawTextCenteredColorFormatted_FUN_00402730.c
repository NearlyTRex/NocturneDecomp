...
// Convention: __cdecl
// Signature: void __cdecl engine_2d_c_drawTextCenteredColorFormatted_FUN_00402730 (int left_x,int right_x,int y_pos,char *format_string,...)
...

{
  ...
  vsprintf(local_1010,format_string,&local_10);
