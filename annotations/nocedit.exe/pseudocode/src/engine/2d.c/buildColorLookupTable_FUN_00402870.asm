...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_2d.c_buildColorLookupTable_FUN_00402870(void)
;
; Local Variables:
...
section .text
    ...
    FLD double ptr [0x006130ec]         ; 0040287b | double g_LuminanceScaleFactor
    XOR EAX,EAX                         ; 00402881
        ;   Label: LAB_00402881
    MOV AL,byte ptr [EBX + 0x2d01f48]   ; 00402883 | char[768] g_SourcePaletteData
    MOV dword ptr [ESP + 0xc],EAX       ; 00402889
    XOR EAX,EAX                         ; 0040288d
    FILD word ptr [ESP + 0xc]           ; 0040288f
    MOV AL,byte ptr [EBX + 0x2d01f49]   ; 00402893 | CHAR_ARRAY_02d01f49
    FLD ST0                             ; 00402899
    ...
    FLD ST0                             ; 004028a7
    MOV AL,byte ptr [EBX + 0x2d01f4a]   ; 004028a9 | CHAR_ARRAY_02d01f4a
    FMULP                               ; 004028af
    ...
    FSTP float ptr [ESI + 0x772634]     ; 004028c9 | float[256] g_PaletteLuminanceCache
    CMP ESI,0x400                       ; 004028cf
    JNZ 0x00402881                      ; 004028d5 | LAB_00402881
        ;   XREF to: 00402881 (CONDITIONAL_JUMP)
    FSTP ST0                            ; 004028d7
    MOV ESI,0x2cf9020                   ; 004028d9 | uchar[32768] g_ColorCubeLookup
    ...
    CALL engine_2d.c_findBestPaletteMatch_FUN_00401460 ; 004028f2 | int engine_2d.c_findBestPaletteMatch_FUN_00401460(int red, int green, int blue, int start_index, ...)
        ;   XREF to: 00401460 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 004028f7
    MOV byte ptr [ESI + -0x1],AL        ; 004028fa | uchar[32768] g_ColorCubeLookup
    CMP EBX,0x100                       ; 004028fd
    JL 0x004028e4                       ; 00402903 | LAB_004028e4
        ;   XREF to: 004028e4 (CONDITIONAL_JUMP)
    ADD EDI,0x8                         ; 00402905
    CMP EDI,0x100                       ; 00402908
    JL 0x004028e2                       ; 0040290e | LAB_004028e2
        ;   XREF to: 004028e2 (CONDITIONAL_JUMP)
    ADD EBP,0x8                         ; 00402910
    CMP EBP,0x100                       ; 00402913
    JL 0x004028e0                       ; 00402919 | LAB_004028e0
        ;   XREF to: 004028e0 (CONDITIONAL_JUMP)
    XOR AH,AH                           ; 0040291b
    MOV byte ptr [0x02cf9020],AH        ; 0040291d | uchar[32768] g_ColorCubeLookup
