...
;                               FUNCTION
; *****************************************************************************
; __cdecl int engine_2d.c_drawCharacter_FUN_00401a10(int char_code, int x_pos, int y_pos, int color)
;
; Parameters:
...
section .text
    ...
    MOV EBX,dword ptr [0x02d02558]      ; 00401a3a | int g_ClipLeft
    MOV DL,byte ptr [EAX]               ; 00401a40 | g_FontTable
    CMP ECX,EBX                         ; 00401a42
    JL 0x00401ac2                       ; 00401a44 | LAB_00401ac2
        ;   XREF to: 00401ac2 (CONDITIONAL_JUMP)
    CMP EBP,dword ptr [0x02d0255c]      ; 00401a4a | int g_ClipTop
    JL 0x00401ac2                       ; 00401a50 | LAB_00401ac2
        ;   XREF to: 00401ac2 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x02d02560]      ; 00401a56 | int g_ClipRight
    INC ECX                             ; 00401a5c
    MOV EDI,dword ptr [ESP + 0x24]      ; 00401a5d
    SUB ECX,EDX                         ; 00401a61
    CMP ECX,EDI                         ; 00401a63
    JL 0x00401ac2                       ; 00401a65 | LAB_00401ac2
        ;   XREF to: 00401ac2 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x02d02564]      ; 00401a67 | int g_ClipBottom
    SUB ECX,0xa                         ; 00401a6d
    CMP EBP,ECX                         ; 00401a70
    JG 0x00401ac2                       ; 00401a72 | LAB_00401ac2
        ;   XREF to: 00401ac2 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 00401a74
    MOV EBX,dword ptr [0x0067939c]      ; 00401a75 | int g_BitsPerPixel
    SHL EBP,0x2                         ; 00401a7b
    INC EAX                             ; 00401a7e
    LEA ECX,[EBP + 0x2c]                ; 00401a7f
    CMP EBX,0x8                         ; 00401a82
    JNZ 0x00401ac6                      ; 00401a85 | LAB_00401ac6
        ;   XREF to: 00401ac6 (CONDITIONAL_JUMP)
    MOV EDI,ECX                         ; 00401a87
    MOV ECX,dword ptr [ESP + 0x28]      ; 00401a89
        ;   Label: LAB_00401a89
    MOV ESI,dword ptr [EBP + 0x2cf6a9c] ; 00401a8d | void *[1024] g_ScreenBufferArray
    ADD ESI,ECX                         ; 00401a93
    XOR ECX,ECX                         ; 00401a95
    TEST EDX,EDX                        ; 00401a97
    JLE 0x00401aae                      ; 00401a99 | LAB_00401aae
        ;   XREF to: 00401aae (CONDITIONAL_JUMP)
    MOV BL,byte ptr [EAX]               ; 00401a9b | DAT_00666041
        ;   Label: LAB_00401a9b
    TEST BL,BL                          ; 00401a9d
    JZ 0x00401aa7                       ; 00401a9f | LAB_00401aa7
    ...
    XOR ECX,ECX                         ; 00401ac2
        ;   Label: LAB_00401ac2
    JMP 0x00401ab9                      ; 00401ac4 | LAB_00401ab9
        ;   XREF to: 00401ab9 (UNCONDITIONAL_JUMP)
    CMP EBX,0x10                        ; 00401ac6
        ;   Label: LAB_00401ac6
    JNZ 0x00401b17                      ; 00401ac9 | LAB_00401b17
    ...
    MOV ECX,dword ptr [ESP + 0x4]       ; 00401adf
        ;   Label: LAB_00401adf
    MOV ESI,dword ptr [EBP + 0x2cf6a9c] ; 00401ae3 | void *[1024] g_ScreenBufferArray
    ADD ESI,ECX                         ; 00401ae9
    XOR ECX,ECX                         ; 00401aeb
    TEST EDX,EDX                        ; 00401aed
    JLE 0x00401b0a                      ; 00401aef | LAB_00401b0a
        ;   XREF to: 00401b0a (CONDITIONAL_JUMP)
    MOV BL,byte ptr [EAX]               ; 00401af1 | DAT_00666041
        ;   Label: LAB_00401af1
    TEST BL,BL                          ; 00401af3
    JZ 0x00401b01                       ; 00401af5 | LAB_00401b01
        ;   XREF to: 00401b01 (CONDITIONAL_JUMP)
    MOV BX,word ptr [EDI + 0x2d01020]   ; 00401af7 | ushort[256] g_ColorTable16
    ...
    MOV EBX,dword ptr [ESP + 0xc]       ; 00401b2d
        ;   Label: LAB_00401b2d
    MOV ECX,dword ptr [EBP + 0x2cf6a9c] ; 00401b31 | void *[1024] g_ScreenBufferArray
    XOR ESI,ESI                         ; 00401b37
    ADD ECX,EBX                         ; 00401b39
    TEST EDX,EDX                        ; 00401b3b
    JLE 0x00401b56                      ; 00401b3d | LAB_00401b56
        ;   XREF to: 00401b56 (CONDITIONAL_JUMP)
    MOV BL,byte ptr [EAX]               ; 00401b3f | DAT_00666041
        ;   Label: LAB_00401b3f
    TEST BL,BL                          ; 00401b41
    JZ 0x00401b4d                       ; 00401b43 | LAB_00401b4d
        ;   XREF to: 00401b4d (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [EDI + 0x2d01220] ; 00401b45 | uint[256] g_ColorTable32
