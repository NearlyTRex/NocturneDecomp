...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_2d.c_disableTextWrap_FUN_00402820(void)
;
;
; XREF[1]:
...
section .text
    ...
    CALL engine_2d.c_setTextWrapEnabled_FUN_00402800 ; 00402822 | void engine_2d.c_setTextWrapEnabled_FUN_00402800(int enabled)
