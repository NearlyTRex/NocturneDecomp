...
// Convention: __cdecl
// Signature: void __cdecl engine_2d_c_drawTextRightAlignedColorWrapper_FUN_00402560(int x,int y,char *text)
...
{
  engine_2d_c_drawTextRightAlignedColor_FUN_00402530(text,x,y);
  return;
}
