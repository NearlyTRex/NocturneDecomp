// Name: engine_2d.c_drawCharacterMaskedColor_FUN_00401a10
// Address: 00401a10
// MANUAL RECONSTRUCTION
// Address Range: [[00401a10, 00401b66]]
// Convention: __cdecl
// Signature: int __cdecl engine_2d_c_drawCharacterMaskedColor_FUN_00401a10(int char_code,int x_pos,int y_pos,int color)
...

{
  ...
  if ((((x_pos < g_ClipLeft) || (y_pos < g_ClipTop)) || ((int)((g_ClipRight + 1) - uVar5) < x_pos))
    ...
    if (g_BitsPerPixel == 8) {
      do {
        puVar7 = (byte *)g_ScreenBufferArray[iVar6 / 4] + x_pos;
        iVar2 = 0;
        if (uVar5 != 0) {
          do {
            if (*puVar1 != '\0') {
      ...
      do {
        puVar8 = (ushort *)g_ScreenBufferArray[iVar6 / 4] + x_pos;
        iVar4 = 0;
        if (uVar5 != 0) {
          do {
            if (*puVar1 != '\0') {
      ...
      do {
        iVar4 = 0;
        puVar4 = (uint *)g_ScreenBufferArray[iVar6 / 4] + x_pos;
        if (uVar5 != 0) {
          do {
            if (*puVar1 != '\0') {
