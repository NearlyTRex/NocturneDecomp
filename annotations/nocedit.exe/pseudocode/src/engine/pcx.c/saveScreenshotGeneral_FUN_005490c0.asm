...
;                               FUNCTION
; *****************************************************************************
; __cdecl void engine_pcx.c_saveScreenshotGeneral_FUN_005490c0(char * filename)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [0x0067939c]      ; 005490cf | int g_BitsPerPixel
    CMP EDX,0x10                        ; 005490d5
    JZ 0x0054927f                       ; 005490d8 | LAB_0054927f
        ;   XREF to: 0054927f (CONDITIONAL_JUMP)
    CMP EDX,0x20                        ; 005490de
    JZ 0x0054928a                       ; 005490e1 | LAB_0054928a
    ...
    CALL crt_memory.c_memset_FUN_005fde40 ; 005490fa | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
    ...
    PUSH 0xec                           ; 0054918f
        ;   Label: LAB_0054918f
    PUSH 0x63ec0c                       ; 00549194 | = "..\\engine\\pcx.c" | s_engine_pcx_c_0063ec0c = ..\engine\pcx.c
    PUSH 0x63ec1c                       ; 00549199 | = "wb" | s_wb_0063ec1c = wb
    PUSH 0x0                            ; 0054919e
    PUSH EBX                            ; 005491a0
    CALL shape_memdbg.cpp_openFile_FUN_0050f7a0 ; 005491a1 | FILE * shape_memdbg.cpp_openFile_FUN_0050f7a0(char * filename, char * directory, char * mode, char * source_file, ...)
        ;   XREF to: 0050f7a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 005491a6
    MOV EBX,EAX                         ; 005491a9
    TEST EAX,EAX                        ; 005491ab
    JNZ 0x005491d1                      ; 005491ad | LAB_005491d1
        ;   XREF to: 005491d1 (CONDITIONAL_JUMP)
    MOV EBP,0x63ec1f                    ; 005491af | = "..\\engine\\pcx.c" | s_engine_pcx_c_0063ec1f = ..\engine\pcx.c
    MOV EAX,0xed                        ; 005491b4
    PUSH 0x63ec2f                       ; 005491b9 | = "Cannot write .PCX" | s_Cannot_write_PCX_0063ec2f = Cannot write .PCX
    MOV dword ptr [0x02f0ca48],EBP      ; 005491be | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 005491c4 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005491c9 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    CALL crt_stdio.c_fwrite_FUN_005fdc00 ; 005491e0 | SIZE_T crt_stdio.c_fwrite_FUN_005fdc00(void * ptr, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fdc00 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [0x00679398]      ; 005491e5 | int g_WindowHeight
    ADD ESP,0x10                        ; 005491eb
    TEST EDX,EDX                        ; 005491ee
    JLE 0x00549229                      ; 005491f0 | LAB_00549229
        ;   XREF to: 00549229 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 005491f2
        ;   Label: LAB_005491f2
    PUSH ESI                            ; 005491f3
    CALL engine_pcx.c_writePCXScanline_FUN_00548c50 ; 005491f4 | void engine_pcx.c_writePCXScanline_FUN_00548c50(int row_index, FILE * pcx_file)
        ;   XREF to: 00548c50 (UNCONDITIONAL_CALL)
    MOV EAX,[0x00679394]                ; 005491f9 | int g_WindowWidth
    ADD ESP,0x8                         ; 005491fe
    CMP EAX,0x280                       ; 00549201
    JNZ 0x0054921e                      ; 00549206 | LAB_0054921e
        ;   XREF to: 0054921e (CONDITIONAL_JUMP)
    CMP dword ptr [0x00679398],0xf0     ; 00549208 | int g_WindowHeight
    JNZ 0x0054921e                      ; 00549212 | LAB_0054921e
        ;   XREF to: 0054921e (CONDITIONAL_JUMP)
    PUSH EBX                            ; 00549214
    PUSH ESI                            ; 00549215
    CALL engine_pcx.c_writePCXScanline_FUN_00548c50 ; 00549216 | void engine_pcx.c_writePCXScanline_FUN_00548c50(int row_index, FILE * pcx_file)
        ;   XREF to: 00548c50 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0054921b
    MOV ECX,dword ptr [0x00679398]      ; 0054921e | int g_WindowHeight
        ;   Label: LAB_0054921e
    INC ESI                             ; 00549224
    CMP ESI,ECX                         ; 00549225
    JL 0x005491f2                       ; 00549227 | LAB_005491f2
        ;   XREF to: 005491f2 (CONDITIONAL_JUMP)
    TEST byte ptr [EBX + 0xd],0x4       ; 00549229
        ;   Label: LAB_00549229
    JZ 0x00549295                       ; 0054922d | LAB_00549295
        ;   XREF to: 00549295 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 0054922f
        ;   Label: LAB_0054922f
    PUSH 0xc                            ; 00549230
    CALL crt_stdio.c_fputc_FUN_006007a0 ; 00549232 | int crt_stdio.c_fputc_FUN_006007a0(int character, FILE * file)
        ;   Label: LAB_00549232
    ...
    TEST byte ptr [EBX + 0xd],0x4       ; 0054923c
        ;   Label: LAB_0054923c
    JZ 0x005492d0                       ; 00549240 | LAB_005492d0
        ;   XREF to: 005492d0 (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 00549246
        ;   Label: LAB_00549246
    PUSH EBX                            ; 00549248
    MOV AL,byte ptr [ESI + 0x2d01f48]   ; 00549249 | char[768] g_SourcePaletteData
    PUSH EAX                            ; 0054924f
    CALL crt_stdio.c_fputc_FUN_006007a0 ; 00549250 | int crt_stdio.c_fputc_FUN_006007a0(int character, FILE * file)
        ;   Label: LAB_00549250
        ;   XREF to: 006007a0 (UNCONDITIONAL_CALL)
    ...
    JL 0x0054923c                       ; 0054925f | LAB_0054923c
        ;   XREF to: 0054923c (CONDITIONAL_JUMP)
    PUSH 0x104                          ; 00549261
    PUSH 0x63ec41                       ; 00549266 | = "..\\engine\\pcx.c" | s_engine_pcx_c_0063ec41 = ..\engine\pcx.c
    PUSH EBX                            ; 0054926b
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 0054926c | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
    ...
    PUSH EBX                            ; 0054927f
        ;   Label: LAB_0054927f
    CALL engine_pcx.c_saveScreenRaw16_FUN_00548d20 ; 00549280 | void engine_pcx.c_saveScreenRaw16_FUN_00548d20(char * filename)
        ;   XREF to: 00548d20 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00549285
    JMP 0x00549276                      ; 00549288 | LAB_00549276
        ;   XREF to: 00549276 (UNCONDITIONAL_JUMP)
    PUSH EBX                            ; 0054928a
        ;   Label: LAB_0054928a
    CALL engine_pcx.c_saveScreenRaw32_FUN_00548f00 ; 0054928b | void engine_pcx.c_saveScreenRaw32_FUN_00548f00(char * filename)
        ;   XREF to: 00548f00 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00549290
    JMP 0x00549276                      ; 00549293 | LAB_00549276
        ;   XREF to: 00549276 (UNCONDITIONAL_JUMP)
    ...
    JBE 0x0054922f                      ; 005492a0 | LAB_0054922f
    ...
    JZ 0x005492c8                       ; 005492ac | LAB_005492c8
    ...
    JMP 0x0054923a                      ; 005492c3 | LAB_0054923a
        ;   XREF to: 0054923a (UNCONDITIONAL_JUMP)
    PUSH EBX                            ; 005492c8
        ;   Label: LAB_005492c8
    PUSH 0xa                            ; 005492c9
    JMP 0x00549232                      ; 005492cb | LAB_00549232
    ...
    JMP 0x00549258                      ; 00549306 | LAB_00549258
        ;   XREF to: 00549258 (UNCONDITIONAL_JUMP)
    PUSH EBX                            ; 0054930b
        ;   Label: LAB_0054930b
    PUSH 0xa                            ; 0054930c
    JMP 0x00549250                      ; 0054930e | LAB_00549250
