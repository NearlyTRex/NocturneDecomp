...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl engine_pcx_c_writePCXScanline_FUN_00548c50(int row_index,_FILE *pcx_file)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [0x00679394]      ; 00548c5c | g_WindowWidth
    XOR EDI,EDI                         ; 00548c62
    MOV ESI,dword ptr [ESI*0x4 + 0x2cf6a9c] ; 00548c64 | g_ScreenBufferArray
    TEST EDX,EDX                        ; 00548c6b
    JLE 0x00548cae                      ; 00548c6d
        ;   XREF to: 00548cae (CONDITIONAL_JUMP)  ; LAB_00548cae
    XOR EAX,EAX                         ; 00548c6f
        ;   Label: LAB_00548c6f
    MOV AL,byte ptr [ESI]               ; 00548c71
    CMP EAX,0xc0                        ; 00548c73
    JL 0x00548c8e                       ; 00548c78
        ;   XREF to: 00548c8e (CONDITIONAL_JUMP)  ; LAB_00548c8e
    TEST byte ptr [EBX + 0xd],0x4       ; 00548c7a
    JZ 0x00548cb3                       ; 00548c7e
        ;   XREF to: 00548cb3 (CONDITIONAL_JUMP)  ; LAB_00548cb3
    PUSH EBX                            ; 00548c80
        ;   Label: LAB_00548c80
    PUSH 0xc1                           ; 00548c81
    CALL crt_stdio.c_fputc_FUN_006007a0 ; 00548c86
    ...
    TEST byte ptr [EBX + 0xd],0x4       ; 00548c8e
        ;   Label: LAB_00548c8e
    JZ 0x00548ce8                       ; 00548c92
        ;   XREF to: 00548ce8 (CONDITIONAL_JUMP)  ; LAB_00548ce8
    XOR EAX,EAX                         ; 00548c94
        ;   Label: LAB_00548c94
    PUSH EBX                            ; 00548c96
    MOV AL,byte ptr [ESI]               ; 00548c97
    PUSH EAX                            ; 00548c99
    CALL crt_stdio.c_fputc_FUN_006007a0 ; 00548c9a
        ;   XREF to: 006007a0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fputc_FUN_006007a0(int character, _FILE * file)
        ;   Label: LAB_00548c9a
    ADD ESP,0x8                         ; 00548c9f
    MOV ECX,dword ptr [0x00679394]      ; 00548ca2 | g_WindowWidth
        ;   Label: LAB_00548ca2
    INC EDI                             ; 00548ca8
    INC ESI                             ; 00548ca9
    CMP EDI,ECX                         ; 00548caa
    JL 0x00548c6f                       ; 00548cac
        ;   XREF to: 00548c6f (CONDITIONAL_JUMP)  ; LAB_00548c6f
    POP EBP                             ; 00548cae
        ;   Label: LAB_00548cae
    POP EDI                             ; 00548caf
    POP ESI                             ; 00548cb0
    ...
    JBE 0x00548c80                      ; 00548cbe
        ;   XREF to: 00548c80 (CONDITIONAL_JUMP)  ; LAB_00548c80
    MOV EAX,dword ptr [EBX]             ; 00548cc0
    MOV byte ptr [EAX],0xc1             ; 00548cc2
    MOV EAX,dword ptr [EBX]             ; 00548cc5
    CMP byte ptr [EAX],0xa              ; 00548cc7
    JZ 0x00548ce3                       ; 00548cca
        ;   XREF to: 00548ce3 (CONDITIONAL_JUMP)  ; LAB_00548ce3
    ...
    JMP 0x00548c8e                      ; 00548ce1
        ;   XREF to: 00548c8e (UNCONDITIONAL_JUMP)  ; LAB_00548c8e
    PUSH EBX                            ; 00548ce3
        ;   Label: LAB_00548ce3
    PUSH 0xa                            ; 00548ce4
    JMP 0x00548c86                      ; 00548ce6
        ;   XREF to: 00548c86 (UNCONDITIONAL_JUMP)  ; LAB_00548c86
    MOV ECX,dword ptr [EBX + 0x4]       ; 00548ce8
        ;   Label: LAB_00548ce8
    MOV EAX,dword ptr [EBX + 0x14]      ; 00548ceb
    SUB EAX,ECX                         ; 00548cee
    CMP EAX,0x1                         ; 00548cf0
    JBE 0x00548c94                      ; 00548cf3
        ;   XREF to: 00548c94 (CONDITIONAL_JUMP)  ; LAB_00548c94
    ...
    JZ 0x00548d18                       ; 00548d00
        ;   XREF to: 00548d18 (CONDITIONAL_JUMP)  ; LAB_00548d18
    ...
    JMP 0x00548ca2                      ; 00548d16
        ;   XREF to: 00548ca2 (UNCONDITIONAL_JUMP)  ; LAB_00548ca2
    PUSH EBX                            ; 00548d18
        ;   Label: LAB_00548d18
    PUSH 0xa                            ; 00548d19
    JMP 0x00548c9a                      ; 00548d1b
        ;   XREF to: 00548c9a (UNCONDITIONAL_JUMP)  ; LAB_00548c9a
