...

{
  ...
  char local_6c [80];
  int local_1c;
  SColorQuantWorkspace *local_18;
  char *local_14;
  int local_10;
  uint local_c;
  
  bVar14 = 0;
  local_18 = (SColorQuantWorkspace *)shape_memdbg_cpp_debugAlloc_FUN_0050f1b0(0x8308,"..\\engine\\palette.cpp",0xb4);
  color_count = 0;
  if (local_18 == (SColorQuantWorkspace *)0x0) {
...
LAB_005452ba:
        ...
        p_Var6 = engine_dosio_c_getFile_FUN_00481a50(pcVar12,local_6c,pcVar10);
        if (p_Var6 == (_FILE *)0x0) {
...
LAB_0054537a:
        ...
        p_Var6 = engine_dosio_c_getFile_FUN_00481a50(pcVar12,(char *)(iVar4 + local_10),pcVar10);
        if (p_Var6 == (_FILE *)0x0) {
          g_CurrentFilename = "..\\engine\\palette.cpp";
        ...
        while (0 < iVar7) {
          ...
          iVar7 = iVar7 + -1;
          if ((uint)in_stack_00000004[2] < color_count) {
            g_CurrentFilename = "..\\engine\\palette.cpp";
    ...
    pcVar10 = engine_colquant_c_quantizeColors_FUN_004406c0
                        (local_18,local_14,color_count,in_stack_0000000c);
