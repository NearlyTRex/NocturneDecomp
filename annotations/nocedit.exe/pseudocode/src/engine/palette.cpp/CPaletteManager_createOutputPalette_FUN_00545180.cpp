...

{
  ...
  if (local_14 != (void *)0x0) {
    ...
    if (0 < *in_stack_00000004) {
      ...
      do {
        pcVar11 = local_6c;
        pcVar9 = (char *)(in_stack_00000004[1] + local_10);
        do {
          cVar1 = *pcVar9;
          *pcVar11 = cVar1;
          if (cVar1 == '\0') break;
...
LAB_005452ba:
        ...
        p_Var5 = engine_dosio_c_getFile_FUN_00481a50(pcVar11,local_6c,pcVar9);
        if (p_Var5 == (_FILE *)0x0) {
          puVar10 = g_DefaultPalette;
          puVar12 = (uchar *)&DAT_02fd8d20;
          for (iVar6 = 0xc0; iVar6 != 0; iVar6 = iVar6 + -1) {
            *(uint *)puVar12 = *(uint *)puVar10;
            puVar10 = puVar10 + ((uint)bVar13 * -2 + 1) * 4;
...
LAB_00545332:
        if (pcVar9 == (char *)0x0) {
          ...
          iVar6 = in_stack_00000004[1];
          pcVar11 = &s_EmptyChar_0063e5c1;
        }
        iVar6 = engine_dosio_c_getFileSize_FUN_00481880(pcVar11,(char *)(iVar6 + local_10));
        pcVar11 = (char *)(in_stack_00000004[1] + local_10);
        do {
          pcVar9 = pcVar11;
...
LAB_0054537a:
        if (pcVar9 == (char *)0x0) {
          ...
          iVar3 = in_stack_00000004[1];
          pcVar9 = "rb";
          pcVar11 = &s_EmptyChar_0063e5cc;
        }
        p_Var5 = engine_dosio_c_getFile_FUN_00481a50(pcVar11,(char *)(iVar3 + local_10),pcVar9);
        if (p_Var5 == (_FILE *)0x0) {
          g_CurrentFilename = "..\\engine\\palette.cpp";
        ...
        pcVar11 = (char *)(uVar8 * 4 + (int)local_14);
        while (0 < iVar6) {
          ...
          if (((*(char *)((int)&DAT_02fd8d20 + iVar3) != '\0') || (local_c != 0)) || (cVar1 != '\0')
            ...
            *pcVar11 = *(char *)((int)&DAT_02fd8d20 + iVar3);
            pcVar11[1] = bVar2;
            uVar8 = uVar8 + 1;
            pcVar11[2] = cVar1;
            pcVar11 = pcVar11 + 4;
          ...
          iVar6 = iVar6 + -1;
          if ((uint)in_stack_00000004[2] < uVar8) {
            g_CurrentFilename = "..\\engine\\palette.cpp";
...
LAB_00545459:
    if (pcVar9 == (char *)0x0) {
      ...
      pcVar9 = "wb";
      pcVar11 = &DAT_0063e68c;
    }
    p_Var5 = engine_dosio_c_getFile_FUN_00481a50(pcVar11,in_stack_00000008,pcVar9);
    if (p_Var5 == (_FILE *)0x0) {
      g_CurrentFilename = "..\\engine\\palette.cpp";
