...
section .text
    ...
    PUSH 0x63e3ed                       ; 00544f1e | = "..\\engine\\palette.cpp" | s_engine_palette_cpp_0063e3ed = ..\engine\palette.cpp
    SHL EAX,0x6                         ; 00544f23
    MOV EDX,dword ptr [ESP + 0x18]      ; 00544f26
    PUSH EAX                            ; 00544f2a
    MOV dword ptr [EBX + 0x8],EDX       ; 00544f2b
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1f0 ; 00544f2e | void * shape_memdbg.cpp_debugAlloc_FUN_0050f1f0(int size, char * filename, int line_number)
        ;   XREF to: 0050f1f0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00544f33
    MOV dword ptr [EBX + 0x4],EAX       ; 00544f36
    TEST EAX,EAX                        ; 00544f39
    JZ 0x00544f47                       ; 00544f3b | LAB_00544f47
    ...
    PUSH ESI                            ; 00544f47
        ;   Label: LAB_00544f47
    MOV ECX,0x63e403                    ; 00544f48 | = "..\\engine\\palette.cpp" | s_engine_palette_cpp_0063e403 = ..\engine\palette.cpp
    MOV ESI,0x2c                        ; 00544f4d
    PUSH 0x63e419                       ; 00544f52 | = "The very same person who says not to ..." | s_The_very_same_person_who_0063e419 = The very same person who says not to allocate memory on a constructor did it here.
    MOV dword ptr [0x02f0ca48],ECX      ; 00544f57 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 00544f5d | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00544f63 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
