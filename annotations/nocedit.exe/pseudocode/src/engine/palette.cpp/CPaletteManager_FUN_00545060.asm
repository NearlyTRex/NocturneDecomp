...
section .text
    ...
    PUSH EAX                            ; 005450a6
    PUSH EDI                            ; 005450a7
    CALL engine_palette.cpp_CPaletteManager_addTexture_FUN_00544fc0 ; 005450a8 | undefined engine_palette.cpp_CPaletteManager_addTexture_FUN_00544fc0()
        ;   XREF to: 00544fc0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005450ad
    MOV EAX,dword ptr [ESP + 0x4]       ; 005450b0
        ;   Label: LAB_005450b0
    CMP dword ptr [EAX],0x1d            ; 005450b4
    JNZ 0x005450dc                      ; 005450b7 | LAB_005450dc
    ...
    JLE 0x005450dc                      ; 005450c5 | LAB_005450dc
        ;   XREF to: 005450dc (CONDITIONAL_JUMP)
    PUSH ESI                            ; 005450c7
        ;   Label: LAB_005450c7
    PUSH EDI                            ; 005450c8
    INC EBX                             ; 005450c9
    CALL engine_palette.cpp_CPaletteManager_addTexture_FUN_00544fc0 ; 005450ca | undefined engine_palette.cpp_CPaletteManager_addTexture_FUN_00544fc0()
        ;   XREF to: 00544fc0 (UNCONDITIONAL_CALL)
    ADD ESI,0x20                        ; 005450cf
    MOV ECX,dword ptr [EBP + 0x8]       ; 005450d2
    ADD ESP,0x8                         ; 005450d5
    CMP EBX,ECX                         ; 005450d8
    JL 0x005450c7                       ; 005450da | LAB_005450c7
        ;   XREF to: 005450c7 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [ESP + 0x4]       ; 005450dc
        ;   Label: LAB_005450dc
    PUSH EBX                            ; 005450e0
    CALL engine_model.c_getMRGLSize_FUN_00528700 ; 005450e1 | int engine_model.c_getMRGLSize_FUN_00528700(SMRGLHeaderExtended * header)
    ...
    JMP 0x00545087                      ; 005450f6 | LAB_00545087
    ...
    JLE 0x00545140                      ; 00545102 | LAB_00545140
        ;   XREF to: 00545140 (CONDITIONAL_JUMP)
    LEA EBP,[EBX + 0x18]                ; 00545104
    PUSH EBP                            ; 00545107
        ;   Label: LAB_00545107
    CALL engine_model.c_loadModelFile_FUN_00527ec0 ; 00545108 | SMRGLHeaderExtended * engine_model.c_loadModelFile_FUN_00527ec0(char * filename)
        ;   XREF to: 00527ec0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0054510d
    PUSH EAX                            ; 00545110
    PUSH EDI                            ; 00545111
    MOV EBX,EAX                         ; 00545112
    CALL engine_palette.cpp_CPaletteManager_FUN_00545060 ; 00545114 | SMRGLHeaderExtended * engine_palette.cpp_CPaletteManager_FUN_00545060(CPaletteManager * this_ptr, SMRGLHeaderExtended * unk)
        ;   XREF to: 00545060 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00545119
    PUSH EBX                            ; 0054511c
    CALL engine_model.c_freeMRGLData_FUN_005280b0 ; 0054511d | void engine_model.c_freeMRGLData_FUN_005280b0(SMRGLHeaderExtended * modelStruct)
    ...
    JL 0x00545107                       ; 00545131 | LAB_00545107
    ...
    JLE 0x00545140                      ; 00545151 | LAB_00545140
        ;   XREF to: 00545140 (CONDITIONAL_JUMP)
    ...
    PUSH EDI                            ; 00545157
    INC ESI                             ; 00545158
    CALL engine_palette.cpp_CPaletteManager_addTexture_FUN_00544fc0 ; 00545159 | undefined engine_palette.cpp_CPaletteManager_addTexture_FUN_00544fc0()
        ;   XREF to: 00544fc0 (UNCONDITIONAL_CALL)
    ADD EBX,0x18                        ; 0054515e
    MOV ECX,dword ptr [EBP + 0x18]      ; 00545161
    ADD ESP,0x8                         ; 00545164
    CMP ESI,ECX                         ; 00545167
    JL 0x00545156                       ; 00545169 | LAB_00545156
