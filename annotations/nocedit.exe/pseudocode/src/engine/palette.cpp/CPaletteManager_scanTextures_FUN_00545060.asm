...
section .text
    ...
    PUSH EBX                            ; 00545060
        ;   Label: engine_palette.cpp_CPaletteManager_scanTextures_FUN_00545060
    PUSH ESI                            ; 00545061
    PUSH EDI                            ; 00545062
    PUSH EBP                            ; 00545063
    ...
    CALL engine_palette.cpp_CPaletteManager_addTexture_FUN_00544fc0 ; 005450a8
        ;   XREF to: 00544fc0 (UNCONDITIONAL_CALL)  ; void engine_palette.cpp_CPaletteManager_addTexture_FUN_00544fc0(CPaletteManager * this_ptr, char * filename)
    ...
    CALL engine_palette.cpp_CPaletteManager_scanTextures_FUN_00545060 ; 00545114
        ;   XREF to: 00545060 (UNCONDITIONAL_CALL)  ; void engine_palette.cpp_CPaletteManager_scanTextures_FUN_00545060(CPaletteManager * this_ptr, SMRGLHeaderExtended * mrgl_data)
