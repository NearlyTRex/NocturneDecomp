...
section .text
    ...
    CALL sound_sndmain.cpp_lockSound_FUN_005abd30 ; 005aa3c1 | void sound_sndmain.cpp_lockSound_FUN_005abd30()
        ;   XREF to: 005abd30 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [ESP + 0x8]       ; 005aa3c6
    PUSH EDX                            ; 005aa3ca
    XOR EBX,EBX                         ; 005aa3cb
    CALL sound_sndmain.cpp_getSfxSample_FUN_005a4c80 ; 005aa3cd | CSfxSample * sound_sndmain.cpp_getSfxSample_FUN_005a4c80(char * filename)
        ;   XREF to: 005a4c80 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005aa3d2
    TEST EAX,EAX                        ; 005aa3d5
    JZ 0x005aa3de                       ; 005aa3d7 | LAB_005aa3de
        ;   XREF to: 005aa3de (CONDITIONAL_JUMP)
    MOV EBX,0x1                         ; 005aa3d9
    CALL sound_sndmain.cpp_unlockSound_FUN_005abdc0 ; 005aa3de | void sound_sndmain.cpp_unlockSound_FUN_005abdc0()
        ;   Label: LAB_005aa3de
