...
;                               FUNCTION
; *****************************************************************************
; __cdecl void sound_sndmain.cpp_convert16BitAudioSignedness_FUN_005aa7d0(short * buffer, int num_samples)
;
; Parameters:
...
section .text
    ...
    JLE 0x005aa7ef                      ; 005aa7da | LAB_005aa7ef
    ...
    JG 0x005aa7dd                       ; 005aa7ec | LAB_005aa7dd
