// Name: sound_sndmain.cpp_CSampleInfo_FUN_005a86f0
// Address: 005a86f0
// Address Range: [[005a86f0, 005a87c6]]
// Convention: __cdecl
// Signature: int sound_sndmain.cpp_CSampleInfo_FUN_005a86f0(CSampleInfo * this_ptr)
// Cross-references:
...
int __cdecl sound_sndmain_cpp_CSampleInfo_FUN_005a86f0(CSampleInfo *this_ptr)

{
  ...
  uStack0000000c = sound_sndmain_cpp_CSampleInfo_cvtPlaybackPos_FUN_005a8580(this_ptr);
  uStack00000010 = extraout_EDX;
  iVar1 = sound_sndmain_cpp_FUN_005a87d0();
  if (iVar1 == 0) {
    if ((double)CONCAT44(in_stack_00000014,uStack00000010) < 0.0) {
      _uStack0000000c = (double)(ulonglong)uStack0000000c;
    }
    else if (1.0 < (double)CONCAT44(in_stack_00000014,uStack00000010)) {
      _uStack0000000c = (double)(ulonglong)uStack0000000c;
    }
  }
  else {
    ...
    _uStack0000000c =
         (double)CONCAT44(uStack00000010,uStack0000000c) -
         (double)CONCAT44(extraout_EDX_00,extraout_EAX);
  }
  iVar1 = sound_sndmain_cpp_CSampleInfo_cvtPlaybackPos_FUN_005a8580(this_ptr);
  return iVar1;
}
...
// Assembly code:
// 005a86f0: PUSH EBX
//   Label: sound_sndmain.cpp_CSampleInfo_FUN_005a86f0
// 005a86f1: PUSH ESI
// 005a86f2: PUSH EDI
// 005a86f3: PUSH EBP
