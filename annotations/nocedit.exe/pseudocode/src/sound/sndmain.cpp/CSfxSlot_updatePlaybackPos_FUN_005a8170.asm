...
;                               FUNCTION
; *****************************************************************************
; __cdecl void sound_sndmain.cpp_CSfxSlot_updatePlaybackPos_FUN_005a8170(CSfxSlot * this_ptr, double hardware_playback_pos)
;
; Parameters:
...
section .text
    ...
    JZ 0x005a82a6                       ; 005a8183 | LAB_005a82a6
    ...
    FNSTSW AX                           ; 005a818e
    SAHF                                ; 005a8190
    JBE 0x005a82ce                      ; 005a8191 | LAB_005a82ce
        ;   XREF to: 005a82ce (CONDITIONAL_JUMP)
    MOV EDI,0x6505a2                    ; 005a8197 | = "..\\sound\\sndmain.cpp" | s_sound_sndmain_cpp_006505a2 = ..\sound\sndmain.cpp
        ;   Label: LAB_005a8197
    MOV EAX,0xbc2                       ; 005a819c
    PUSH 0x6505b7                       ; 005a81a1 | = "SfxSlot::updatePlaybackPos - invalid ..." | s_SfxSlot_updatePlaybackPo_006505b7 = SfxSlot::updatePlaybackPos - invalid buffer position
    MOV dword ptr [0x02f0ca48],EDI      ; 005a81a6 | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 005a81ac | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005a81b1 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    FNSTSW AX                           ; 005a81cc
    SAHF                                ; 005a81ce
    JBE 0x005a81e0                      ; 005a81cf | LAB_005a81e0
    ...
    FNSTSW AX                           ; 005a81e5
    SAHF                                ; 005a81e7
    JBE 0x005a82e8                      ; 005a81e8 | LAB_005a82e8
        ;   XREF to: 005a82e8 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [EBX + 0x78]      ; 005a81ee
        ;   Label: LAB_005a81ee
    PUSH ESI                            ; 005a81f1
    MOV EDI,dword ptr [ESI + 0x160]     ; 005a81f2
    MOV EDX,0x6505ec                    ; 005a81f8 | = "..\\sound\\sndmain.cpp" | s_sound_sndmain_cpp_006505ec = ..\sound\sndmain.cpp
    PUSH EDI                            ; 005a81fd
    MOV EAX,dword ptr [ESP + 0xc]       ; 005a81fe
    MOV dword ptr [0x02f0ca48],EDX      ; 005a8202 | char * g_CurrentFilename
    PUSH EAX                            ; 005a8208
    MOV EDX,dword ptr [ESP + 0xc]       ; 005a8209
    MOV ECX,0xbd0                       ; 005a820d
    PUSH EDX                            ; 005a8212
    MOV dword ptr [0x02f0ca4c],ECX      ; 005a8213 | int g_CurrentLineNumber
    ...
    PUSH EAX                            ; 005a822e
    PUSH 0x650601                       ; 005a822f | = "SfxSlot::updatePlaybackPos - stepped ..." | s_SfxSlot_updatePlaybackPo_00650601 = SfxSlot::updatePlaybackPos - stepped too much: %f-%f=%f, sample=%d (%s)
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005a8234 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ...
    FNSTSW AX                           ; 005a8245
    SAHF                                ; 005a8247
    JZ 0x005a8308                       ; 005a8248 | LAB_005a8308
    ...
    FNSTSW AX                           ; 005a825c
    SAHF                                ; 005a825e
    JBE 0x005a826f                      ; 005a825f | LAB_005a826f
    ...
    POP EBX                             ; 005a82a4
    RET                                 ; 005a82a5
    MOV ECX,0x650563                    ; 005a82a6 | = "..\\sound\\sndmain.cpp" | s_sound_sndmain_cpp_00650563 = ..\sound\sndmain.cpp
        ;   Label: LAB_005a82a6
    MOV ESI,0xbbc                       ; 005a82ab
    PUSH 0x650578                       ; 005a82b0 | = "SfxSlot::updatePlaybackPos - no sampl..." | s_SfxSlot_updatePlaybackPo_00650578 = SfxSlot::updatePlaybackPos - no samplePtr
    MOV dword ptr [0x02f0ca48],ECX      ; 005a82b5 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 005a82bb | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005a82c1 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005a82c6
    JMP 0x005a8189                      ; 005a82c9 | LAB_005a8189
    ...
    FNSTSW AX                           ; 005a82da
    SAHF                                ; 005a82dc
    JC 0x005a8197                       ; 005a82dd | LAB_005a8197
        ;   XREF to: 005a8197 (CONDITIONAL_JUMP)
    JMP 0x005a81b9                      ; 005a82e3 | LAB_005a81b9
        ;   XREF to: 005a81b9 (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0x78]      ; 005a82e8
        ;   Label: LAB_005a82e8
    FILD dword ptr [EAX + 0x160]        ; 005a82eb
    FADD double ptr [0x0065064f]        ; 005a82f1 | double DOUBLE_0065064f
    FCOMP double ptr [ESP]              ; 005a82f7
    FNSTSW AX                           ; 005a82fa
    SAHF                                ; 005a82fc
    JC 0x005a81ee                       ; 005a82fd | LAB_005a81ee
        ;   XREF to: 005a81ee (CONDITIONAL_JUMP)
    JMP 0x005a823c                      ; 005a8303 | LAB_005a823c
    ...
    FNSTSW AX                           ; 005a830e
    SAHF                                ; 005a8310
    JC 0x005a824e                       ; 005a8311 | LAB_005a824e
    ...
    JMP 0x005a8257                      ; 005a8323 | LAB_005a8257
        ;   XREF to: 005a8257 (UNCONDITIONAL_JUMP)
    PUSH EDX                            ; 005a8328
        ;   Label: LAB_005a8328
    CALL sound_sndmain.cpp_CSfxSample_getLoopMode_FUN_005a87d0 ; 005a8329 | int sound_sndmain.cpp_CSfxSample_getLoopMode_FUN_005a87d0(CSfxSample * this_ptr)
        ;   XREF to: 005a87d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005a832e
    TEST EAX,EAX                        ; 005a8331
    JNZ 0x005a8346                      ; 005a8333 | LAB_005a8346
    ...
    JMP 0x005a828d                      ; 005a8341 | LAB_005a828d
    ...
    CALL crt_math.c_floor_FUN_005feb90  ; 005a8360 | double crt_math.c_floor_FUN_005feb90(double input_value)
    ...
    JMP 0x005a828d                      ; 005a837e | LAB_005a828d
        ;   XREF to: 005a828d (UNCONDITIONAL_JUMP)
