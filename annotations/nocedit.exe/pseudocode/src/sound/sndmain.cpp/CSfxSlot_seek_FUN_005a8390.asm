...
;                               FUNCTION
; *****************************************************************************
; __cdecl void sound_sndmain.cpp_CSfxSlot_seek_FUN_005a8390(CSfxSlot * this_ptr)
;
; Parameters:
...
section .text
    ...
    JNZ 0x005a83c4                      ; 005a839f | LAB_005a83c4
        ;   XREF to: 005a83c4 (CONDITIONAL_JUMP)
    MOV ECX,0x650657                    ; 005a83a1 | = "..\\sound\\sndmain.cpp" | s_sound_sndmain_cpp_00650657 = ..\sound\sndmain.cpp
    MOV ESI,0xbfd                       ; 005a83a6
    PUSH 0x65066c                       ; 005a83ab | = "SfxSlot::seek - no sample?!" | s_SfxSlot_seek_no_sample_0065066c = SfxSlot::seek - no sample?!
    MOV dword ptr [0x02f0ca48],ECX      ; 005a83b0 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 005a83b6 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005a83bc | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    PUSH EDX                            ; 005a83d5
    CALL sound_sndmain.cpp_CSampleInfo_cvtPlaybackPos_FUN_005a8580 ; 005a83d6 | double sound_sndmain.cpp_CSampleInfo_cvtPlaybackPos_FUN_005a8580(CSampleInfo * this_ptr, double position, uint input_type, uint output_type)
    ...
    PUSH EBP                            ; 005a8403
    CALL sound_sndmain.cpp_CSampleInfo_normalizePlaybackPos_FUN_005a86f0 ; 005a8404 | double sound_sndmain.cpp_CSampleInfo_normalizePlaybackPos_FUN_005a86f0(CSampleInfo * this_ptr, double position, uint input_type, uint output_type)
    ...
    JGE 0x005a8442                      ; 005a8426 | LAB_005a8442
    ...
    FLD double ptr [EBX + 0x60]         ; 005a8442
        ;   Label: LAB_005a8442
    PUSH 0x0                            ; 005a8445
    CALL crt_math.c_round_FUN_005fe6b0  ; 005a8447 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0xc]         ; 005a844c
    MOV ECX,dword ptr [ESP + 0xc]       ; 005a8450
    PUSH ECX                            ; 005a8454
    PUSH EAX                            ; 005a8455
    CALL sound_sndmain.cpp_CSfxSample_seek_FUN_005a65a0 ; 005a8456 | void sound_sndmain.cpp_CSfxSample_seek_FUN_005a65a0(CSfxSample * this_ptr, int playback_position, int dest_buffer_offset)
