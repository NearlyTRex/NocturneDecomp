...
section .text
    ...
    JNZ 0x005aa31d                      ; 005aa305
        ;   XREF to: 005aa31d (CONDITIONAL_JUMP)  ; LAB_005aa31d
    ADD EBX,0x128                       ; 005aa307
        ;   Label: LAB_005aa307
    CMP EBX,0x4a00                      ; 005aa30d
    JNZ 0x005aa2fd                      ; 005aa313
        ;   XREF to: 005aa2fd (CONDITIONAL_JUMP)  ; LAB_005aa2fd
    CALL sound_sndmain.cpp_unlockSound_FUN_005abdc0 ; 005aa315
    ...
    JNZ 0x005aa307                      ; 005aa329
        ;   XREF to: 005aa307 (CONDITIONAL_JUMP)  ; LAB_005aa307
    MOV EAX,0x3f5daa4                   ; 005aa32b | g_SfxSlots
