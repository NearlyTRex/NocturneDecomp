...
;                               FUNCTION
; *****************************************************************************
; __cdecl int sound_sndmain.cpp_setSfxTrackedDoublePosition_FUN_005a9910(uint sfx_handle, CVector3d * position_source_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 005a9917
    CALL sound_sndmain.cpp_getSfxSlotFromHandle_FUN_005a5d00 ; 005a9918 | CSfxSlot * sound_sndmain.cpp_getSfxSlotFromHandle_FUN_005a5d00(uint sfx_handle, int check_hardware_playback)
        ;   XREF to: 005a5d00 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 005a991d
    ADD ESP,0x8                         ; 005a991f
    TEST EAX,EAX                        ; 005a9922
    JNZ 0x005a9928                      ; 005a9924 | LAB_005a9928
    ...
    CALL sound_sndmain.cpp_CSfxSlot_compute_FUN_005a7100 ; 005a993a | int sound_sndmain.cpp_CSfxSlot_compute_FUN_005a7100(CSfxSlot * this_ptr, float delta_time)
        ;   XREF to: 005a7100 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [EBX + 0x70]      ; 005a993f
    ADD ESP,0x8                         ; 005a9942
    TEST ECX,ECX                        ; 005a9945
    JZ 0x005a995f                       ; 005a9947 | LAB_005a995f
        ;   XREF to: 005a995f (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [0x03f69268]      ; 005a9949 | CSoundDevice * g_CSoundDevicePtr
    TEST ESI,ESI                        ; 005a994f
    JZ 0x005a995f                       ; 005a9951 | LAB_005a995f
        ;   XREF to: 005a995f (CONDITIONAL_JUMP)
    PUSH 0x2                            ; 005a9953
    PUSH EBX                            ; 005a9955
    ...
    CALL sound_sndmain.cpp_unlockSound_FUN_005abdc0 ; 005a995f | void sound_sndmain.cpp_unlockSound_FUN_005abdc0()
        ;   Label: LAB_005a995f
