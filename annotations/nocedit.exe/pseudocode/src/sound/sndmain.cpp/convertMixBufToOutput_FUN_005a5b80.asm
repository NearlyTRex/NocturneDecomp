...
section .text
    ...
    FCOMP double ptr [0x0064fc5f]       ; 005a5bc0 | double DOUBLE_0064fc5f
    FNSTSW AX                           ; 005a5bc6
    SAHF                                ; 005a5bc8
    JBE 0x005a5c93                      ; 005a5bc9 | LAB_005a5c93
        ;   XREF to: 005a5c93 (CONDITIONAL_JUMP)
    FLD1                                ; 005a5bcf
    FCOMP double ptr [EBP + -0x34]      ; 005a5bd1
    FNSTSW AX                           ; 005a5bd4
    SAHF                                ; 005a5bd6
    JA 0x005a5ca0                       ; 005a5bd7 | LAB_005a5ca0
    ...
    JL 0x005a5bb2                       ; 005a5c00 | LAB_005a5bb2
    ...
    JLE 0x005a5c02                      ; 005a5c13 | LAB_005a5c02
        ;   XREF to: 005a5c02 (CONDITIONAL_JUMP)
    ...
    FCOMP double ptr [0x0064fc5f]       ; 005a5c23 | double DOUBLE_0064fc5f
    FNSTSW AX                           ; 005a5c29
    SAHF                                ; 005a5c2b
    JBE 0x005a5c5d                      ; 005a5c2c | LAB_005a5c5d
        ;   XREF to: 005a5c5d (CONDITIONAL_JUMP)
    FLD1                                ; 005a5c2e
    FCOMP double ptr [EBP + -0x2c]      ; 005a5c30
    FNSTSW AX                           ; 005a5c33
    SAHF                                ; 005a5c35
    JA 0x005a5c65                       ; 005a5c36 | LAB_005a5c65
    ...
    JGE 0x005a5c02                      ; 005a5c59 | LAB_005a5c02
        ;   XREF to: 005a5c02 (CONDITIONAL_JUMP)
    JMP 0x005a5c15                      ; 005a5c5b | LAB_005a5c15
        ;   XREF to: 005a5c15 (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + -0x20]     ; 005a5c5d
        ;   Label: LAB_005a5c5d
    MOV byte ptr [EAX],0x0              ; 005a5c60
    JMP 0x005a5c3e                      ; 005a5c63 | LAB_005a5c3e
        ;   XREF to: 005a5c3e (UNCONDITIONAL_JUMP)
    FLD float ptr [EBP + -0x24]         ; 005a5c65
        ;   Label: LAB_005a5c65
    FMUL float ptr [0x0064fc5b]         ; 005a5c68 | float FLOAT_0064fc5b
    FADD float ptr [0x0064fc67]         ; 005a5c6e | float FLOAT_0064fc67
    ...
    JMP 0x005a5be5                      ; 005a5cc8 | LAB_005a5be5
        ;   XREF to: 005a5be5 (UNCONDITIONAL_JUMP)
    PUSH EAX                            ; 005a5ccd
        ;   Label: LAB_005a5ccd
    MOV EDI,0x64fc18                    ; 005a5cce | = "..\\sound\\sndmain.cpp" | s_sound_sndmain_cpp_0064fc18 = ..\sound\sndmain.cpp
    MOV EDX,0x55a                       ; 005a5cd3
    PUSH 0x64fc2d                       ; 005a5cd8 | = "convertMixBufToOutput - invalid bits: %d" | s_convertMixBufToOutput_in_0064fc2d = convertMixBufToOutput - invalid bits: %d
    MOV dword ptr [0x02f0ca48],EDI      ; 005a5cdd | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 005a5ce3 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005a5ce9 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
