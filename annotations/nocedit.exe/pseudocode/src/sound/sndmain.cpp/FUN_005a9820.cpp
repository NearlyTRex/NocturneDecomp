// Name: sound_sndmain.cpp_FUN_005a9820
// Address: 005a9820
// Address Range: [[005a9820, 005a98ab]]
// Convention: __cdecl
// Signature: int sound_sndmain.cpp_FUN_005a9820(void)
// Cross-references:
...
int __cdecl sound_sndmain_cpp_FUN_005a9820(void)

{
  ...
  *(undefined4 *)&(this_ptr->options).position.x = in_stack_0000000c;
  *(undefined4 *)((int)&(this_ptr->options).position.x + 4) = in_stack_00000010;
  *(undefined4 *)&(this_ptr->options).position.y = in_stack_00000014;
  *(undefined4 *)((int)&(this_ptr->options).position.y + 4) = in_stack_00000018;
  *(undefined4 *)&(this_ptr->options).position.z = in_stack_0000001c;
  iVar1 = 1;
...
// Assembly code:
// 005a9820: PUSH EBX
//   Label: sound_sndmain.cpp_FUN_005a9820
// 005a9821: PUSH 0x1
