...
;                               FUNCTION
; *****************************************************************************
; __cdecl void sound_sndmain.cpp_formatSfxOptionsToString_FUN_005a8d00(char * output_buffer, char * prefix_string, CSfxOptions * options, uint format_flags)
;
; Parameters:
...
section .text
    ...
    JNZ 0x005a8e55                      ; 005a8d14 | LAB_005a8e55
        ;   XREF to: 005a8e55 (CONDITIONAL_JUMP)
    MOV byte ptr [EDI],0x0              ; 005a8d1a
    TEST byte ptr [ESP + 0x20],0x1      ; 005a8d1d
        ;   Label: LAB_005a8d1d
    JZ 0x005a8d37                       ; 005a8d22 | LAB_005a8d37
        ;   XREF to: 005a8d37 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [ESI]             ; 005a8d24
    PUSH EDX                            ; 005a8d26
    PUSH 0x650900                       ; 005a8d27 | = " channel=%d%s" | s_channel_d_s_00650900 =  channel=%d%s
    PUSH EBX                            ; 005a8d2c
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005a8d2d | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005a8d32
    ADD EBX,EAX                         ; 005a8d35
    TEST byte ptr [ESP + 0x20],0x2      ; 005a8d37
        ;   Label: LAB_005a8d37
    JZ 0x005a8da0                       ; 005a8d3c | LAB_005a8da0
        ;   XREF to: 005a8da0 (CONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0x20],0x0      ; 005a8d3e
    JNZ 0x005a8d6c                      ; 005a8d42 | LAB_005a8d6c
    ...
    PUSH EDI                            ; 005a8d5b
    PUSH 0x65090e                       ; 005a8d5c | = " pos=%lg,%lg,%lg" | s_pos_lg_lg_lg_0065090e =  pos=%lg,%lg,%lg
    PUSH EBX                            ; 005a8d61
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005a8d62 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x20                        ; 005a8d67
    ADD EBX,EAX                         ; 005a8d6a
    CMP dword ptr [ESI + 0x20],0x1      ; 005a8d6c
        ;   Label: LAB_005a8d6c
    JNZ 0x005a8d86                      ; 005a8d70 | LAB_005a8d86
        ;   XREF to: 005a8d86 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESI + 0x1c]      ; 005a8d72
    PUSH EAX                            ; 005a8d75
    PUSH 0x65091f                       ; 005a8d76 | = " posPtrFloat=%p" | s_posPtrFloat_p_0065091f =  posPtrFloat=%p
    PUSH EBX                            ; 005a8d7b
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005a8d7c | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005a8d81
    ADD EBX,EAX                         ; 005a8d84
    CMP dword ptr [ESI + 0x20],0x2      ; 005a8d86
        ;   Label: LAB_005a8d86
    JNZ 0x005a8da0                      ; 005a8d8a | LAB_005a8da0
        ;   XREF to: 005a8da0 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [ESI + 0x1c]      ; 005a8d8c
    PUSH ECX                            ; 005a8d8f
    PUSH 0x65092f                       ; 005a8d90 | = " posPtrDouble=%p" | s_posPtrDouble_p_0065092f =  posPtrDouble=%p
    PUSH EBX                            ; 005a8d95
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005a8d96 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005a8d9b
    ADD EBX,EAX                         ; 005a8d9e
    TEST byte ptr [ESP + 0x20],0x4      ; 005a8da0
        ;   Label: LAB_005a8da0
    JZ 0x005a8e09                       ; 005a8da5 | LAB_005a8e09
        ;   XREF to: 005a8e09 (CONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0x40],0x0      ; 005a8da7
    JNZ 0x005a8dd5                      ; 005a8dab | LAB_005a8dd5
    ...
    PUSH EBP                            ; 005a8dc4
    PUSH 0x650940                       ; 005a8dc5 | = " vel=%lg,%lg,%lg" | s_vel_lg_lg_lg_00650940 =  vel=%lg,%lg,%lg
    PUSH EBX                            ; 005a8dca
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005a8dcb | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x20                        ; 005a8dd0
    ADD EBX,EAX                         ; 005a8dd3
    CMP dword ptr [ESI + 0x40],0x1      ; 005a8dd5
        ;   Label: LAB_005a8dd5
    JNZ 0x005a8def                      ; 005a8dd9 | LAB_005a8def
        ;   XREF to: 005a8def (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [ESI + 0x3c]      ; 005a8ddb
    PUSH EDX                            ; 005a8dde
    PUSH 0x650951                       ; 005a8ddf | = " velPtrFloat=%p" | s_velPtrFloat_p_00650951 =  velPtrFloat=%p
    PUSH EBX                            ; 005a8de4
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005a8de5 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005a8dea
    ADD EBX,EAX                         ; 005a8ded
    CMP dword ptr [ESI + 0x40],0x2      ; 005a8def
        ;   Label: LAB_005a8def
    JNZ 0x005a8e09                      ; 005a8df3 | LAB_005a8e09
        ;   XREF to: 005a8e09 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [ESI + 0x3c]      ; 005a8df5
    PUSH EDI                            ; 005a8df8
    PUSH 0x650961                       ; 005a8df9 | = " velPtrDouble=%p" | s_velPtrDouble_p_00650961 =  velPtrDouble=%p
    PUSH EBX                            ; 005a8dfe
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005a8dff | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005a8e04
    ADD EBX,EAX                         ; 005a8e07
    TEST byte ptr [ESP + 0x20],0x8      ; 005a8e09
        ;   Label: LAB_005a8e09
    JZ 0x005a8e29                       ; 005a8e0e | LAB_005a8e29
        ;   XREF to: 005a8e29 (CONDITIONAL_JUMP)
    SUB ESP,0x8                         ; 005a8e10
    FLD float ptr [ESI + 0x44]          ; 005a8e13
    FSTP double ptr [ESP]               ; 005a8e16
    PUSH 0x650972                       ; 005a8e19 | = " vol=%g" | s_vol_g_00650972 =  vol=%g
    PUSH EBX                            ; 005a8e1e
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005a8e1f | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 005a8e24
    ADD EBX,EAX                         ; 005a8e27
    TEST byte ptr [ESP + 0x20],0x10     ; 005a8e29
        ;   Label: LAB_005a8e29
    JZ 0x005a8e49                       ; 005a8e2e | LAB_005a8e49
        ;   XREF to: 005a8e49 (CONDITIONAL_JUMP)
    SUB ESP,0x8                         ; 005a8e30
    FLD float ptr [ESI + 0x48]          ; 005a8e33
    FSTP double ptr [ESP]               ; 005a8e36
    PUSH 0x65097a                       ; 005a8e39 | = " freq=%g" | s_freq_g_0065097a =  freq=%g
    PUSH EBX                            ; 005a8e3e
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005a8e3f | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 005a8e44
    ADD EBX,EAX                         ; 005a8e47
    TEST byte ptr [ESP + 0x20],0x20     ; 005a8e49
        ;   Label: LAB_005a8e49
    JNZ 0x005a8e6c                      ; 005a8e4e | LAB_005a8e6c
    ...
    PUSH EAX                            ; 005a8e55
        ;   Label: LAB_005a8e55
    PUSH 0x6508fd                       ; 005a8e56 | = "%s" | s_s_006508fd = %s
    PUSH EDI                            ; 005a8e5b
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005a8e5c | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005a8e61
    LEA EBX,[EDI + EAX*0x1]             ; 005a8e64
    JMP 0x005a8d1d                      ; 005a8e67 | LAB_005a8d1d
    ...
    PUSH EAX                            ; 005a8e73
    PUSH 0x650983                       ; 005a8e74 | = " delay=%lg" | s_delay_lg_00650983 =  delay=%lg
    PUSH EBX                            ; 005a8e79
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005a8e7a | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
