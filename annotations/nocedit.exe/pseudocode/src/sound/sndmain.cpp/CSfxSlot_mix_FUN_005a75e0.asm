...
section .text
    ...
    CMP dword ptr [0x03f6940c],0x0      ; 005a75f2 | int g_SoundLockCount
    JLE 0x005a774e                      ; 005a75f9 | LAB_005a774e
        ;   XREF to: 005a774e (CONDITIONAL_JUMP)
    CMP dword ptr [EDI + 0x74],0x0      ; 005a75ff
        ;   Label: LAB_005a75ff
    JZ 0x005a7747                       ; 005a7603 | LAB_005a7747
    ...
    JZ 0x005a7668                       ; 005a761e | LAB_005a7668
    ...
    JLE 0x005a7668                      ; 005a7648 | LAB_005a7668
        ;   XREF to: 005a7668 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 005a7659
    SAHF                                ; 005a765b
    JBE 0x005a7776                      ; 005a765c | LAB_005a7776
    ...
    PUSH EDX                            ; 005a76db
    CALL crt_memory.c_memset_FUN_005fde40 ; 005a76dc | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
    ...
    JL 0x005a7677                       ; 005a76ed | LAB_005a7677
    ...
    CMP dword ptr [EDI + 0x74],0x0      ; 005a76f9
        ;   Label: LAB_005a76f9
    JNZ 0x005a77a4                      ; 005a76fd | LAB_005a77a4
        ;   XREF to: 005a77a4 (CONDITIONAL_JUMP)
    PUSH EDI                            ; 005a7703
        ;   Label: LAB_005a7703
    CALL sound_sndmain.cpp_CSfxSlot_kill_FUN_005a7e60 ; 005a7704 | void sound_sndmain.cpp_CSfxSlot_kill_FUN_005a7e60(CSfxSlot * slot)
    ...
    JL 0x005a771d                       ; 005a7745 | LAB_005a771d
    ...
    POP EBX                             ; 005a774c
    RET                                 ; 005a774d
    MOV ECX,0x65036f                    ; 005a774e | = "..\\sound\\sndmain.cpp" | s_sound_sndmain_cpp_0065036f = ..\sound\sndmain.cpp
        ;   Label: LAB_005a774e
    MOV EBX,0xa27                       ; 005a7753
    PUSH 0x650384                       ; 005a7758 | = "SfxSlot::mix - must be locked!" | s_SfxSlot_mix_must_be_lock_00650384 = SfxSlot::mix - must be locked!
    MOV dword ptr [0x02f0ca48],ECX      ; 005a775d | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 005a7763 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005a7769 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005a776e
    JMP 0x005a75ff                      ; 005a7771 | LAB_005a75ff
        ;   XREF to: 005a75ff (UNCONDITIONAL_JUMP)
    INC EDX                             ; 005a7776
        ;   Label: LAB_005a7776
    ADD ECX,0x4                         ; 005a7777
    CMP EDX,EBX                         ; 005a777a
    JL 0x005a764f                       ; 005a777c | LAB_005a764f
        ;   XREF to: 005a764f (CONDITIONAL_JUMP)
    JMP 0x005a7668                      ; 005a7782 | LAB_005a7668
        ;   XREF to: 005a7668 (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0xe0],0x0      ; 005a7787
        ;   Label: LAB_005a7787
    JL 0x005a7682                       ; 005a778e | LAB_005a7682
        ;   XREF to: 005a7682 (CONDITIONAL_JUMP)
    JMP 0x005a768e                      ; 005a7794 | LAB_005a768e
        ;   XREF to: 005a768e (UNCONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 005a7799
        ;   Label: LAB_005a7799
    MOV dword ptr [ESP + ECX*0x1 + 0x1c],EAX ; 005a779b
    JMP 0x005a76e4                      ; 005a779f | LAB_005a76e4
        ;   XREF to: 005a76e4 (UNCONDITIONAL_JUMP)
    MOV EBX,dword ptr [EDI + 0x78]      ; 005a77a4
        ;   Label: LAB_005a77a4
    TEST EBX,EBX                        ; 005a77a7
    JZ 0x005a7703                       ; 005a77a9 | LAB_005a7703
        ;   XREF to: 005a7703 (CONDITIONAL_JUMP)
    FLDZ                                ; 005a77af
    FCOMP double ptr [EDI + 0x60]       ; 005a77b1
    FNSTSW AX                           ; 005a77b4
    SAHF                                ; 005a77b6
    JA 0x005a7703                       ; 005a77b7 | LAB_005a7703
        ;   XREF to: 005a7703 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [EBP + 0x38]      ; 005a77bd
    CMP ESI,0x1                         ; 005a77c0
    JL 0x005a770c                       ; 005a77c3 | LAB_005a770c
    ...
    FNSTSW AX                           ; 005a77e5
    SAHF                                ; 005a77e7
    JNC 0x005a770c                      ; 005a77e8 | LAB_005a770c
        ;   XREF to: 005a770c (CONDITIONAL_JUMP)
    ...
    JLE 0x005a785a                      ; 005a780c | LAB_005a785a
    ...
    CALL crt_math.c_floor_FUN_005feb90  ; 005a7828 | double crt_math.c_floor_FUN_005feb90(double input_value)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 005a783c | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x60]        ; 005a7841
    MOV EBX,dword ptr [ESP + 0x60]      ; 005a7845
    CMP ESI,EBX                         ; 005a7849
    JLE 0x005a785a                      ; 005a784b | LAB_005a785a
        ;   XREF to: 005a785a (CONDITIONAL_JUMP)
    ...
    CALL crt_math.c_floor_FUN_005feb90  ; 005a7884 | double crt_math.c_floor_FUN_005feb90(double input_value)
        ;   XREF to: 005feb90 (UNCONDITIONAL_CALL)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 005a7898 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x78]        ; 005a789d
    CMP dword ptr [ESP + 0x78],0x1      ; 005a78a1
    JGE 0x005a78f5                      ; 005a78a6 | LAB_005a78f5
    ...
    FNSTSW AX                           ; 005a78b9
    SAHF                                ; 005a78bb
    JBE 0x005a78c7                      ; 005a78bc | LAB_005a78c7
    ...
    CALL crt_math.c_floor_FUN_005feb90  ; 005a78d8 | double crt_math.c_floor_FUN_005feb90(double input_value)
        ;   XREF to: 005feb90 (UNCONDITIONAL_CALL)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 005a78ec | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    JGE 0x005a79eb                      ; 005a78ff | LAB_005a79eb
    ...
    CMP dword ptr [ESP + 0x5c],0x0      ; 005a7918
        ;   Label: LAB_005a7918
    JZ 0x005a79fe                       ; 005a791d | LAB_005a79fe
    ...
    CMP dword ptr [ESP + 0x6c],0x0      ; 005a793f
        ;   Label: LAB_005a793f
    JZ 0x005a794f                       ; 005a7944 | LAB_005a794f
    ...
    FNSTSW AX                           ; 005a7956
    SAHF                                ; 005a7958
    JC 0x005a7965                       ; 005a7959 | LAB_005a7965
    ...
    PUSH ECX                            ; 005a796e
    PUSH EDI                            ; 005a796f
    CALL sound_sndmain.cpp_CSfxSlot_updatePlaybackPos_FUN_005a8170 ; 005a7970 | void sound_sndmain.cpp_CSfxSlot_updatePlaybackPos_FUN_005a8170(CSfxSlot * this_ptr, double hardware_playback_pos)
        ;   XREF to: 005a8170 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005a7975
    CMP dword ptr [ESP + 0x70],0x0      ; 005a7978
    JZ 0x005a79b4                       ; 005a797d | LAB_005a79b4
    ...
    JL 0x005a79b4                       ; 005a79a8 | LAB_005a79b4
        ;   XREF to: 005a79b4 (CONDITIONAL_JUMP)
    ...
    JLE 0x005a76f9                      ; 005a79c7 | LAB_005a76f9
    ...
    JGE 0x005a76f9                      ; 005a79e3 | LAB_005a76f9
        ;   XREF to: 005a76f9 (CONDITIONAL_JUMP)
    JMP 0x005a79d6                      ; 005a79e9 | LAB_005a79d6
        ;   XREF to: 005a79d6 (UNCONDITIONAL_JUMP)
    JNZ 0x005a7918                      ; 005a79eb | LAB_005a7918
        ;   Label: LAB_005a79eb
        ;   XREF to: 005a7918 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x6c],0x1      ; 005a79f1
    JMP 0x005a7918                      ; 005a79f9 | LAB_005a7918
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 005a7a45 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    JLE 0x005a7ade                      ; 005a7aaf | LAB_005a7ade
    ...
    JL 0x005a7aba                       ; 005a7adc | LAB_005a7aba
    ...
    JGE 0x005a793f                      ; 005a7b02 | LAB_005a793f
        ;   XREF to: 005a793f (CONDITIONAL_JUMP)
    JMP 0x005a7a3f                      ; 005a7b08 | LAB_005a7a3f
        ;   XREF to: 005a7a3f (UNCONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x18],0x0      ; 005a7b0d
        ;   Label: LAB_005a7b0d
    JLE 0x005a793f                      ; 005a7b12 | LAB_005a793f
        ;   XREF to: 005a793f (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x84],EDX      ; 005a7b18
    XOR ESI,ESI                         ; 005a7b1f
    FLD double ptr [ESP]                ; 005a7b21
        ;   Label: LAB_005a7b21
    CALL crt_math.c_round_FUN_005fe6b0  ; 005a7b24 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    JLE 0x005a7b94                      ; 005a7b68 | LAB_005a7b94
    ...
    JL 0x005a7b75                       ; 005a7b90 | LAB_005a7b75
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 005a7bee | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    JLE 0x005a7c55                      ; 005a7c26 | LAB_005a7c55
    ...
    JL 0x005a7c31                       ; 005a7c53 | LAB_005a7c31
    ...
    JGE 0x005a793f                      ; 005a7c79 | LAB_005a793f
        ;   XREF to: 005a793f (CONDITIONAL_JUMP)
    JMP 0x005a7be8                      ; 005a7c7f | LAB_005a7be8
    ...
    PUSH EBX                            ; 005a7cac
    CALL sound_sndmain.cpp_mixResampleStereoToStereo_FUN_005a5fb0 ; 005a7cad | double sound_sndmain.cpp_mixResampleStereoToStereo_FUN_005a5fb0(short * sample_data, SStereoBuffers * channel_buffers, SStereoGains * channel_gains, double resample_position, ...)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 005a7cea | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    JLE 0x005a7d40                      ; 005a7d14 | LAB_005a7d40
    ...
    JL 0x005a7d21                       ; 005a7d3c | LAB_005a7d21
    ...
    JGE 0x005a793f                      ; 005a7d56 | LAB_005a793f
        ;   XREF to: 005a793f (CONDITIONAL_JUMP)
    JMP 0x005a7ce4                      ; 005a7d5c | LAB_005a7ce4
    ...
    PUSH EBX                            ; 005a7d86
    CALL sound_sndmain.cpp_mixResampleMonoToStereo_FUN_005a5e70 ; 005a7d87 | double sound_sndmain.cpp_mixResampleMonoToStereo_FUN_005a5e70(short * sample_data, SStereoBuffers * channel_buffers, SStereoGains * channel_gains, double resample_position, ...)
    ...
    JMP 0x005a793c                      ; 005a7d9b | LAB_005a793c
        ;   XREF to: 005a793c (UNCONDITIONAL_JUMP)
    ...
    JLE 0x005a7e39                      ; 005a7de1 | LAB_005a7e39
    ...
    JL 0x005a7de3                       ; 005a7e37 | LAB_005a7de3
    ...
    JMP 0x005a772c                      ; 005a7e4e | LAB_005a772c
