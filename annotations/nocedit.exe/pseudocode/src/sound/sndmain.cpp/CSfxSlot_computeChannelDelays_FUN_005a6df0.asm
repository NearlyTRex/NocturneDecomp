...
;                               FUNCTION
; *****************************************************************************
; __cdecl void sound_sndmain.cpp_CSfxSlot_computeChannelDelays_FUN_005a6df0(CSfxSlot * this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV ESI,dword ptr [0x00681b18]      ; 005a6dfc | int g_AudioChannelCount
    MOV EDI,dword ptr [EBP + 0x14]      ; 005a6e02
    CMP dword ptr [0x03f6940c],0x0      ; 005a6e05 | int g_SoundLockCount
    JLE 0x005a6e4d                      ; 005a6e0c | LAB_005a6e4d
        ;   XREF to: 005a6e4d (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [0x00681b18]      ; 005a6e0e | int g_AudioChannelCount
        ;   Label: LAB_005a6e0e
    CMP ESI,0x2                         ; 005a6e14
    JL 0x005a6e72                       ; 005a6e17 | LAB_005a6e72
        ;   XREF to: 005a6e72 (CONDITIONAL_JUMP)
    TEST byte ptr [EDI + 0x5c],0x1      ; 005a6e19
    JZ 0x005a6e7e                       ; 005a6e1d | LAB_005a6e7e
        ;   XREF to: 005a6e7e (CONDITIONAL_JUMP)
    XOR EDX,EDX                         ; 005a6e1f
    TEST ESI,ESI                        ; 005a6e21
    JLE 0x005a6e40                      ; 005a6e23 | LAB_005a6e40
    ...
    JL 0x005a6e27                       ; 005a6e37 | LAB_005a6e27
        ;   XREF to: 005a6e27 (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 005a6e39
    NOP                                 ; 005a6e3f
    MOV dword ptr [0x00681b18],ESI      ; 005a6e40 | int g_AudioChannelCount
        ;   Label: LAB_005a6e40
    ...
    POP EBX                             ; 005a6e4b
    RET                                 ; 005a6e4c
    MOV ECX,0x65016e                    ; 005a6e4d | = "..\\sound\\sndmain.cpp" | s_sound_sndmain_cpp_0065016e = ..\sound\sndmain.cpp
        ;   Label: LAB_005a6e4d
    MOV EBX,0x8f5                       ; 005a6e52
    PUSH 0x650183                       ; 005a6e57 | = "SfxSlot::kill - must be locked!" | s_SfxSlot_kill_must_be_loc_00650183 = SfxSlot::kill - must be locked!
    MOV dword ptr [0x02f0ca48],ECX      ; 005a6e5c | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 005a6e62 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005a6e68 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005a6e6d
    JMP 0x005a6e0e                      ; 005a6e70 | LAB_005a6e0e
        ;   XREF to: 005a6e0e (UNCONDITIONAL_JUMP)
    MOV dword ptr [EDI + 0xc0],0x0      ; 005a6e72
        ;   Label: LAB_005a6e72
    JMP 0x005a6e40                      ; 005a6e7c | LAB_005a6e40
        ;   XREF to: 005a6e40 (UNCONDITIONAL_JUMP)
    FLD double ptr [0x00681b30]         ; 005a6e7e | double DOUBLE_00681b30
        ;   Label: LAB_005a6e7e
    FDIV double ptr [0x00663140]        ; 005a6e84 | double DOUBLE_00663140
    FILD dword ptr [0x00681b1c]         ; 005a6e8a | int g_AudioSampleRate
    FMULP                               ; 005a6e90
    MOV EBX,0x1869f                     ; 005a6e92
    XOR ECX,ECX                         ; 005a6e97
    FSTP double ptr [ESP]               ; 005a6e99
    TEST ESI,ESI                        ; 005a6e9c
    JLE 0x005a6ecc                      ; 005a6e9e | LAB_005a6ecc
        ;   XREF to: 005a6ecc (CONDITIONAL_JUMP)
    MOV EDX,EDI                         ; 005a6ea0
    FLD float ptr [EDX + 0x80]          ; 005a6ea2
        ;   Label: LAB_005a6ea2
    FMUL double ptr [ESP]               ; 005a6ea8
    CALL crt_math.c_round_FUN_005fe6b0  ; 005a6eab | double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    JLE 0x005a6ec4                      ; 005a6ec0 | LAB_005a6ec4
    ...
    JL 0x005a6ed8                       ; 005a6eec | LAB_005a6ed8
        ;   XREF to: 005a6ed8 (CONDITIONAL_JUMP)
    MOV dword ptr [0x00681b18],ESI      ; 005a6eee | int g_AudioChannelCount
