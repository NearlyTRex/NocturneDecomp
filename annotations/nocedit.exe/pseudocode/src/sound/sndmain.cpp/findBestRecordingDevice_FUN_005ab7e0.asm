...
section .text
    ...
    CALL sound_sndmain.cpp_getRecordingDeviceCount_FUN_005ab720 ; 005ab7e8 | int sound_sndmain.cpp_getRecordingDeviceCount_FUN_005ab720()
        ;   XREF to: 005ab720 (UNCONDITIONAL_CALL)
    MOV ESI,EAX                         ; 005ab7ed
    CMP EAX,0x1                         ; 005ab7ef
    JL 0x005ab848                       ; 005ab7f2 | LAB_005ab848
        ;   XREF to: 005ab848 (CONDITIONAL_JUMP)
    XOR EBX,EBX                         ; 005ab7f4
    TEST EAX,EAX                        ; 005ab7f6
    JLE 0x005ab81a                      ; 005ab7f8 | LAB_005ab81a
        ;   XREF to: 005ab81a (CONDITIONAL_JUMP)
    LEA EAX,[ESP + 0x108]               ; 005ab7fa
        ;   Label: LAB_005ab7fa
    PUSH EAX                            ; 005ab801
    PUSH EBX                            ; 005ab802
    CALL sound_sndmain.cpp_getRecordingDeviceInfo_FUN_005ab780 ; 005ab803 | void sound_sndmain.cpp_getRecordingDeviceInfo_FUN_005ab780(int index, SRecordingDeviceInfo * device_info)
        ;   XREF to: 005ab780 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005ab808
    CMP dword ptr [ESP + 0x208],0x1     ; 005ab80b
    JZ 0x005ab83d                       ; 005ab813 | LAB_005ab83d
        ;   XREF to: 005ab83d (CONDITIONAL_JUMP)
    INC EBX                             ; 005ab815
    CMP EBX,ESI                         ; 005ab816
    JL 0x005ab7fa                       ; 005ab818 | LAB_005ab7fa
        ;   XREF to: 005ab7fa (CONDITIONAL_JUMP)
    XOR EBX,EBX                         ; 005ab81a
        ;   Label: LAB_005ab81a
    TEST ESI,ESI                        ; 005ab81c
    JLE 0x005ab83b                      ; 005ab81e | LAB_005ab83b
        ;   XREF to: 005ab83b (CONDITIONAL_JUMP)
    MOV EAX,ESP                         ; 005ab820
        ;   Label: LAB_005ab820
    PUSH EAX                            ; 005ab822
    PUSH EBX                            ; 005ab823
    CALL sound_sndmain.cpp_getRecordingDeviceInfo_FUN_005ab780 ; 005ab824 | void sound_sndmain.cpp_getRecordingDeviceInfo_FUN_005ab780(int index, SRecordingDeviceInfo * device_info)
        ;   XREF to: 005ab780 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005ab829
    CMP dword ptr [ESP + 0x100],0x0     ; 005ab82c
    JZ 0x005ab83d                       ; 005ab834 | LAB_005ab83d
        ;   XREF to: 005ab83d (CONDITIONAL_JUMP)
    INC EBX                             ; 005ab836
    CMP EBX,ESI                         ; 005ab837
    JL 0x005ab820                       ; 005ab839 | LAB_005ab820
