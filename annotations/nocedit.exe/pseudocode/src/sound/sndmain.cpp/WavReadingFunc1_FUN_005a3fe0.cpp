// Name: sound_sndmain.cpp_WavReadingFunc1_FUN_005a3fe0
// Address: 005a3fe0
// Address Range: [[005a3fe0, 005a439a]]
// Convention: unknown
// Signature: undefined sound_sndmain.cpp_WavReadingFunc1_FUN_005a3fe0()
// Cross-references:
...
/* Signature: undefined1 sound_sndmain.cpp_WavReadingFunc1(undefined4 param_1, undefined4 param_2,
   undefined4 param_3) */

undefined4 sound_sndmain_cpp_WavReadingFunc1_FUN_005a3fe0(void)

{
  ...
  iVar2 = crt_stdio_c_fseek_FUN_005ffacc(in_stack_00000004,*in_stack_00000008,0);
  if ((iVar2 == 0) &&
     (SVar3 = crt_stdio_c_fread_FUN_005fd990(local_14,8,1,in_stack_00000004), SVar3 == 1)) {
    if (((char)unaff_EBP == 'R') &&
       ((((char)((uint)unaff_EBP >> 8) == 'I' && ((char)((uint)unaff_EBP >> 0x10) == 'F')) &&
        ((char)((uint)unaff_EBP >> 0x18) == 'F')))) {
      SVar3 = crt_stdio_c_fread_FUN_005fd990(&stack0xffffff80,4,1,in_stack_00000004);
      if (SVar3 == 1) {
        if ((((char)in_stack_ffffff84 == 'W') && ((char)((uint)in_stack_ffffff84 >> 8) == 'A')) &&
          ...
          iVar2 = 0xc;
          do {
            iVar4 = crt_stdio_c_fseek_FUN_005ffacc(in_stack_00000004,*in_stack_00000008 + iVar2,0);
            if ((iVar4 != 0) ||
               (SVar3 = crt_stdio_c_fread_FUN_005fd990(&stack0xfffffff0,8,1,in_stack_00000004),
               SVar3 != 1)) goto LAB_005a4007;
            ...
            if ((((char)unaff_EDI == 'f') && (cVar5 == 'm')) && (cVar6 == 't')) {
              ...
              SVar3 = crt_stdio_c_fread_FUN_005fd990(local_18,10,1,in_stack_00000004);
...
LAB_005a41f8:
    iVar4 = crt_stdio_c_fseek_FUN_005ffacc(in_stack_00000004,*in_stack_00000008 + iVar2,0);
    if ((iVar4 != 0) ||
       (SVar3 = crt_stdio_c_fread_FUN_005fd990(&stack0xfffffff0,8,1,in_stack_00000004), SVar3 != 1))
    goto LAB_005a4007;
  }
  sound_sndmain_cpp_HandleSoundError_FUN_005adba0();
LAB_005a4007:
  if (in_stack_00000004 != (FILE *)0x0) {
    shape_memdbg_cpp_closeFile_FUN_0050f9b0(in_stack_00000004,"..\\sound\\sndmain.cpp",0x181);
  }
  return 0;
}
...
// Assembly code:
// 005a3fe0: PUSH EBX
//   Label: sound_sndmain.cpp_WavReadingFunc1_FUN_005a3fe0
// 005a3fe1: PUSH ESI
// 005a3fe2: PUSH EDI
// 005a3fe3: PUSH EBP
...
// 005a4051: CALL sound_sndmain.cpp_HandleSoundError_FUN_005adba0
...
//   XREF to: 0064f3f8 (DATA)
// 005a40a7: CALL sound_sndmain.cpp_HandleSoundError_FUN_005adba0
//   XREF to: 005adba0 (UNCONDITIONAL_CALL)
...
//   XREF to: 0064f3f8 (DATA)
// 005a4132: CALL sound_sndmain.cpp_HandleSoundError_FUN_005adba0
//   XREF to: 005adba0 (UNCONDITIONAL_CALL)
...
//   XREF to: 0064f3f8 (DATA)
// 005a4166: CALL sound_sndmain.cpp_HandleSoundError_FUN_005adba0
//   XREF to: 005adba0 (UNCONDITIONAL_CALL)
...
//   XREF to: 0064f3f8 (DATA)
// 005a4186: CALL sound_sndmain.cpp_HandleSoundError_FUN_005adba0
//   XREF to: 005adba0 (UNCONDITIONAL_CALL)
...
//   XREF to: 0064f3f8 (DATA)
// 005a4264: CALL sound_sndmain.cpp_HandleSoundError_FUN_005adba0
//   XREF to: 005adba0 (UNCONDITIONAL_CALL)
...
//   XREF to: 0064f3f8 (DATA)
// 005a4293: CALL sound_sndmain.cpp_HandleSoundError_FUN_005adba0
//   XREF to: 005adba0 (UNCONDITIONAL_CALL)
...
//   XREF to: 0064f3f8 (DATA)
// 005a42c4: CALL sound_sndmain.cpp_HandleSoundError_FUN_005adba0
//   XREF to: 005adba0 (UNCONDITIONAL_CALL)
...
//   XREF to: 0064f3f8 (DATA)
// 005a4311: CALL sound_sndmain.cpp_HandleSoundError_FUN_005adba0
//   XREF to: 005adba0 (UNCONDITIONAL_CALL)
