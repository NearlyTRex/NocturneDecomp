...
// Cross-references:
//   core_menu.cpp_configureSoundOptions_FUN_00511e50 (00511e50) at 005125ff [UNCONDITIONAL_CALL]
// Globals:
...

{
  ...
  if (iVar9 != g_ChannelFFTTimestamps[channel]) {
    ...
    if (1 < iVar12) {
      do {
        iVar9 = local_2c / 2;
        fVar21 = (float10)DOUBLE_00651017 / (float10)iVar9;
        fVar28 = (float10)fcos(fVar21);
        fVar22 = (float10)fsin(fVar21);
        fVar23 = (float10)DOUBLE_0065100f;
  ...
  if ((local_30 < iVar12) && (0 < local_34)) {
    ...
    return (int)(SQRT((fVar4 / (float)iVar20) / (float)iVar12) * (float)DOUBLE_0065100f);
  }
  return 0;
}
...
// 005ac44e: POP EBX
// 005ac44f: RET
// 005ac450: CALL sound_sndmain.cpp_getMixBufferCount_FUN_005ab6d0
//   Label: LAB_005ac450
...
// 005ac798: CALL sound_sndmain.cpp_getMixBufferCount_FUN_005ab6d0
//   Label: LAB_005ac798
//   XREF to: 005ab6d0 (UNCONDITIONAL_CALL)
