// Name: sound_sndmain.cpp_SfxSlot_seek_FUN_005a8390
// Address: 005a8390
// Address Range: [[005a8390, 005a8474]]
// Convention: unknown
// Signature: undefined sound_sndmain.cpp_SfxSlot_seek_FUN_005a8390()
// Cross-references:
//   sound_sndmain.cpp_startSfx_FUN_005a8e90 (005a8e90) at 005a9042 [UNCONDITIONAL_CALL]
// Globals:
//   undefined4 s_..\sound\sndmain.cpp_00650657
...
/* Signature: undefined1 sound_sndmain.cpp_SfxSlot_seek(undefined4 param_1) */

void sound_sndmain_cpp_SfxSlot_seek_FUN_005a8390(void)

{
  ...
  if (*(int *)(in_stack_00000004 + 0x78) == 0) {
    g_CurrentFilename = "MbP?..\\sound\\sndmain.cpp" + 4;
    g_CurrentLineNumber = 0xbfd;
    core_main_c_displayErrorAndQuit_FUN_00506f10("SfxSlot::seek - no sample?!");
  }
  uVar2 = sound_sndmain_cpp_SampleInfo_cvtPlaybackPos_FUN_005a8580();
  *(undefined4 *)(in_stack_00000004 + 0x68) = 0;
  *(undefined8 *)(in_stack_00000004 + 0x60) = uVar2;
  uVar2 = sound_sndmain_cpp_FUN_005a86f0();
  *(undefined8 *)(in_stack_00000004 + 0x60) = uVar2;
  iVar1 = *(int *)(*(int *)(in_stack_00000004 + 0x78) + 0x15c);
  if (iVar1 < 0) {
    *(undefined4 *)(in_stack_00000004 + 0x11c) = *(undefined4 *)(in_stack_00000004 + 0x60);
    *(undefined4 *)(in_stack_00000004 + 0x120) = *(undefined4 *)(in_stack_00000004 + 100);
    return;
  }
  fVar3 = (float10)*(double *)(in_stack_00000004 + 0x60);
  dVar4 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44(iVar1,*(int *)(in_stack_00000004 + 0x78)));
  sound_sndmain_cpp_SfxSample_seek_FUN_005a65a0
            (SUB84(dVar4,0),(int)((ulonglong)dVar4 >> 0x20),in_stack_00000004,(int)ROUND(fVar3),
             SUB84(dVar4,0),(int)ROUND(fVar3));
  *(double *)(in_stack_00000004 + 0x11c) =
       (double)*(int *)(*(int *)(in_stack_00000004 + 0x78) + 0x168);
  return;
}
...
// Assembly code:
// 005a8390: PUSH EBX
//   Label: sound_sndmain.cpp_SfxSlot_seek_FUN_005a8390
// 005a8391: PUSH ESI
// 005a8392: PUSH EDI
// 005a8393: PUSH EBP
...
// 005a83d5: PUSH EDX
// 005a83d6: CALL sound_sndmain.cpp_SampleInfo_cvtPlaybackPos_FUN_005a8580
...
// 005a8403: PUSH EBP
// 005a8404: CALL sound_sndmain.cpp_FUN_005a86f0
...
// 005a8454: PUSH ECX
// 005a8455: PUSH EAX
// 005a8456: CALL sound_sndmain.cpp_SfxSample_seek_FUN_005a65a0
