// Name: sound_sndmain.cpp_SfxSlot_updatePlaybackPos_FUN_005a8170
// Address: 005a8170
// Address Range: [[005a8170, 005a8382]]
// Convention: unknown
// Signature: undefined sound_sndmain.cpp_SfxSlot_updatePlaybackPos_FUN_005a8170()
// Cross-references:
//   sound_sndmain.cpp_PollHWPlaybackPosAndSet_FUN_005a80e0 (005a80e0) at 005a8155 [UNCONDITIONAL_CALL]
//   sound_sndmain.cpp_UnknownPlayOrUseSample_FUN_005a75e0 (005a75e0) at 005a7970 [UNCONDITIONAL_CALL]
// Globals:
...
/* Signature: undefined1 sound_sndmain.cpp_SfxSlot_updatePlaybackPos(undefined4 param_1, undefined8
   param_2) */

void sound_sndmain_cpp_SfxSlot_updatePlaybackPos_FUN_005a8170(void)

{
  ...
  if (((double)CONCAT44(in_stack_0000000c,in_stack_00000008) < 0.0) ||
     ((double)*(int *)(*(int *)(in_stack_00000004 + 0x78) + 0x160) <
  ...
  dVar1 = (double)CONCAT44(in_stack_0000000c,in_stack_00000008) -
          *(double *)(in_stack_00000004 + 0x11c);
  if (dVar1 < 0.0) {
    dVar1 = (double)*(int *)(*(int *)(in_stack_00000004 + 0x78) + 0x160) + dVar1;
  }
  local_20 = (undefined4)((ulonglong)dVar1 >> 0x20);
  uStack_24 = SUB84(dVar1,0);
  if ((dVar1 < 0.0) ||
     ((double)*(int *)(*(int *)(in_stack_00000004 + 0x78) + 0x160) + _DAT_0065064f < dVar1)) {
    g_CurrentFilename = "..\\sound\\sndmain.cpp";
    ...
    core_main_c_displayErrorAndQuit_FUN_00506f10
               ...
               *(undefined4 *)(in_stack_00000004 + 0x11c),*(undefined4 *)(in_stack_00000004 + 0x120)
               ,uStack_24,local_20,*(undefined4 *)(*(int *)(in_stack_00000004 + 0x78) + 0x160),
               *(int *)(in_stack_00000004 + 0x78));
  }
  if ((*(double *)(in_stack_00000004 + 0x60) != *(double *)(in_stack_00000004 + 0x11c)) ||
     ((double)CONCAT44(in_stack_0000000c,in_stack_00000008) < *(double *)(in_stack_00000004 + 0x60))
     ) {
    *(double *)(in_stack_00000004 + 0x60) = *(double *)(in_stack_00000004 + 0x60) + dVar1;
  }
  else {
    *(undefined4 *)(in_stack_00000004 + 0x60) = in_stack_00000008;
    *(undefined4 *)(in_stack_00000004 + 100) = in_stack_0000000c;
  }
  if (*(double *)(in_stack_00000004 + 0x60) < 0.0) {
    *(undefined4 *)(in_stack_00000004 + 0x60) = 0;
    *(undefined4 *)(in_stack_00000004 + 100) = 0;
  }
  if ((-1 < *(int *)(*(int *)(in_stack_00000004 + 0x78) + 0x110)) &&
     ((double)*(int *)(*(int *)(in_stack_00000004 + 0x78) + 0x110) <=
      *(double *)(in_stack_00000004 + 0x60))) {
    ...
    if (iVar2 == 0) {
      *(double *)(in_stack_00000004 + 0x60) =
      ...
      iVar2 = *(int *)(*(int *)(in_stack_00000004 + 0x78) + 0x110);
  ...
  *(undefined4 *)(in_stack_00000004 + 0x11c) = in_stack_00000008;
  *(undefined4 *)(in_stack_00000004 + 0x120) = in_stack_0000000c;
  return;
}
...
// Assembly code:
// 005a8170: PUSH EBX
//   Label: sound_sndmain.cpp_SfxSlot_updatePlaybackPos_FUN_005a8170
// 005a8171: PUSH ESI
// 005a8172: PUSH EDI
// 005a8173: PUSH EBP
