...
// Convention: __cdecl
// Signature: void __cdecl sound_sndmain_cpp_setAudioSampleRate_FUN_005ab2c0(int sample_rate)
...

{
  ...
  sound_sndmain_cpp_setSoundOutputMode_FUN_005ab170(bits_per_sample,channels,sample_rate);
  return;
}
