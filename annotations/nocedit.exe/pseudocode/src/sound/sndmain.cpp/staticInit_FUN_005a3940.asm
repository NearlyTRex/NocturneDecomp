...
section .text
    ...
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 005a395e
    ...
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 005a3972
        ;   XREF to: 005fe667 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
    ADD ESP,0xc                         ; 005a3977
    PUSH 0x6631c0                       ; 005a397a | g_SfxSampleTypeInfo
    PUSH 0x40                           ; 005a397f
    PUSH 0x3f6282c                      ; 005a3981 | g_SfxSamples
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 005a3986
        ;   XREF to: 005fe667 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
    ADD ESP,0xc                         ; 005a398b
    PUSH 0x681ad0                       ; 005a398e | g_SfxSamplesDestructorNode
    CALL crt_stdlib.c_atexit_FUN_005ff060 ; 005a3993
