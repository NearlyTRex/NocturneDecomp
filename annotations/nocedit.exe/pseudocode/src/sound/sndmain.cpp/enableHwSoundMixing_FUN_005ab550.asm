...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl sound_sndmain_cpp_enableHwSoundMixing_FUN_005ab550(int enable)
;
; Parameters:
...
section .text
    ...
    CALL sound_sndmain.cpp_isSoundSystemActive_FUN_005ab530 ; 005ab550
    ...
    JNZ 0x005ab563                      ; 005ab557
        ;   XREF to: 005ab563 (CONDITIONAL_JUMP)  ; LAB_005ab563
    MOV EAX,dword ptr [ESP + 0x4]       ; 005ab559
    MOV [0x00681b28],EAX                ; 005ab55d | g_HardwareMixingEnabled
    RET                                 ; 005ab562
    MOV EDX,0x650cd9                    ; 005ab563 | = "..\\sound\\sndmain.cpp"
        ;   Label: LAB_005ab563
    MOV ECX,0x135b                      ; 005ab568
    PUSH 0x650cee                       ; 005ab56d | = "enableHwSoundMixing - Can't do this w..."
    MOV dword ptr [0x02f0ca48],EDX      ; 005ab572 | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 005ab578 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005ab57e
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ADD ESP,0x4                         ; 005ab583
    MOV EAX,dword ptr [ESP + 0x4]       ; 005ab586
    MOV [0x00681b28],EAX                ; 005ab58a | g_HardwareMixingEnabled
    RET                                 ; 005ab58f
