...

{
  ...
  pCVar9 = g_SfxOptions + g_SfxLastSlot;
  pCVar17 = &local_90;
  for (iVar7 = 0x1c; iVar7 != 0; iVar7 = iVar7 + -1) {
    pCVar17 = (CSfxOptions *)((int)pCVar17 + (uint)bVar19 * -8 + 4);
    pCVar17->channel_index = pCVar9->channel_index;
    pCVar9 = (CSfxOptions *)((int)pCVar9 + ((uint)bVar19 * -2 + 1) * 4);
    pCVar17 = pCVar17;
  }
  ...
  pCVar10 = this_ptr_00;
  for (iVar7 = 0x1c; iVar7 != 0; iVar7 = iVar7 + -1) {
    pCVar13 = (CSfxOptions *)((int)pCVar13 + (uint)bVar19 * -8 + 4);
    (pCVar10->options).channel_index = pCVar13->channel_index;
    pCVar13 = pCVar13;
...
LAB_005a900a:
    if (local_18 != (CSfxSample *)0x0) {
      ...
      if ((iVar7 == 0) ||
        ...
        iVar7 = engine_dosio_c_getFileSize_FUN_00481880("sound",local_390);
        if (0 < iVar7) {
          this_ptr = (CMP3Decoder *)shape_memdbg_cpp_debugAlloc_FUN_0050f1b0
...
LAB_005a9026:
  ...
  if (pCVar12 == (CSfxSample *)0x0) {
    ...
    do {
      ...
      pCVar4 = pCVar4;
    } while (pCVar4 != (CSfxSlot *)&g_SfxSlots[uVar12].options.position_format);
