...

{
  ...
  bVar18 = 0;
  pcVar16 = &stack0xfffffc70;
  pcVar14 = &stack0xfffffc70;
  pcVar15 = &stack0xfffffc70;
  ...
  iVar3 = engine_dosio_c_getFileSize_FUN_00481880("sound",&stack0xfffffc70);
  if (iVar3 < 0x200001) {
    engine_dosio_c_splitPath_FUN_00481f20
              (&stack0xfffffc70,(char *)0x0,(char *)0x0,(char *)0x0,local_190);
    iVar3 = crt_string_c_stricmp_FUN_005fe7f0(local_190,"mp3");
    if ((iVar3 == 0) ||
       (iVar3 = crt_string_c_stricmp_FUN_005fe7f0(local_190,".mp3"), iVar3 == 0))
    goto LAB_005a8fc7;
    pCVar11 = sound_sndmain_cpp_getSfxSample_FUN_005a4c80(&stack0xfffffc70);
  }
  else {
LAB_005a8fc7:
    iVar3 = 0;
...
LAB_005a900a:
    ...
    if (local_18 != (CSfxSample *)0x0) {
      engine_dosio_c_splitPath_FUN_00481f20
                (&stack0xfffffc70,(char *)0x0,(char *)0x0,(char *)0x0,local_290);
      ...
      if ((iVar3 == 0) ||
        ...
        if (0 < iVar3) {
          ...
          sound_mp3_cpp_CMP3Decoder_openFile_FUN_00534550(local_14->mp3_data,&stack0xfffffc70);
          pCVar11 = local_14;
          pCVar20 = local_14;
          do {
            cVar2 = *pcVar14;
          ...
          pCVar11->streaming_slot_index = extraout_EAX;
...
joined_r0x005a94f6:
        ...
        if (pFVar9 != (FILE *)0x0) {
          ...
          if (iVar3 != 0) {
            ...
            dVar19 = crt_math_c_round_FUN_005fe6b0((double)fVar1);
            *(int *)(extraout_EAX_00 + 0x160) = (int)ROUND(dVar19);
            this_ptr_00->stream_read_position = 0;
            this_ptr_00->stream_write_position = 0;
            this_ptr_00->streaming_slot_index = local_90.field14_0x6c;
            iVar3 = sound_sndmain_cpp_CSfxSample_allocateHwSample_FUN_005a6170(this_ptr_00);
            pCVar11 = local_18;
...
LAB_005a9026:
  ...
  if (pCVar11 == (CSfxSample *)0x0) {
    ...
    if (iVar6 != 0) {
      sound_sndmain_cpp_CSfxSlot_compute_FUN_005a7100(this_ptr_01,0.0);
      ...
      if (uVar7 != 0) {
        ...
        if ((iVar6 == 0) ||
           (iVar6 = (*g_CSoundDevicePtr->vtable->startSfx)(g_CSoundDevicePtr,this_ptr_01),
