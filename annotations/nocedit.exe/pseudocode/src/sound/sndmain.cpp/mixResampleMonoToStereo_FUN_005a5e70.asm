...
section .text
    ...
    JGE 0x005a5e98                      ; 005a5e7d | LAB_005a5e98
    ...
    PUSH EBX                            ; 005a5e9f
    CALL crt_math.c_floor_FUN_005feb90  ; 005a5ea0 | double crt_math.c_floor_FUN_005feb90(double input_value)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 005a5eb1 | double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    FMUL double ptr [0x0064fcaf]        ; 005a5ed0 | double DOUBLE_0064fcaf
    CALL crt_math.c_round_FUN_005fe6b0  ; 005a5ed6 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 005a5eeb
    CALL crt_math.c_floor_FUN_005feb90  ; 005a5eec | double crt_math.c_floor_FUN_005feb90(double input_value)
        ;   XREF to: 005feb90 (UNCONDITIONAL_CALL)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 005a5efd | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    FMUL double ptr [0x0064fcaf]        ; 005a5f1a | double DOUBLE_0064fcaf
    CALL crt_math.c_round_FUN_005fe6b0  ; 005a5f20 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    JL 0x005a5f5f                       ; 005a5f90 | LAB_005a5f5f
    ...
    JMP 0x005a5e7f                      ; 005a5fa5 | LAB_005a5e7f
