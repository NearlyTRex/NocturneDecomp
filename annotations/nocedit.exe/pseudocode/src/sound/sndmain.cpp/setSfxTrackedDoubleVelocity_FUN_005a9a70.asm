...
section .text
    ...
    PUSH EDX                            ; 005a9a77
    CALL sound_sndmain.cpp_getSfxSlotFromHandle_FUN_005a5d00 ; 005a9a78 | CSfxSlot * sound_sndmain.cpp_getSfxSlotFromHandle_FUN_005a5d00(uint sfx_handle, int check_hardware_playback)
        ;   XREF to: 005a5d00 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 005a9a7d
    ADD ESP,0x8                         ; 005a9a7f
    TEST EAX,EAX                        ; 005a9a82
    JNZ 0x005a9a88                      ; 005a9a84 | LAB_005a9a88
    ...
    CALL sound_sndmain.cpp_CSfxSlot_compute_FUN_005a7100 ; 005a9aa0 | int sound_sndmain.cpp_CSfxSlot_compute_FUN_005a7100(CSfxSlot * this_ptr, float delta_time)
        ;   XREF to: 005a7100 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [EBX + 0x70]      ; 005a9aa5
    ADD ESP,0x8                         ; 005a9aa8
    TEST ECX,ECX                        ; 005a9aab
    JZ 0x005a9ac7                       ; 005a9aad | LAB_005a9ac7
        ;   XREF to: 005a9ac7 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [0x03f69268]      ; 005a9aaf | CSoundDevice * g_CSoundDevicePtr
    TEST EDI,EDI                        ; 005a9ab5
    JZ 0x005a9ac7                       ; 005a9ab7 | LAB_005a9ac7
        ;   XREF to: 005a9ac7 (CONDITIONAL_JUMP)
    PUSH 0x4                            ; 005a9ab9
    PUSH EBX                            ; 005a9abb
    ...
    CALL sound_sndmain.cpp_unlockSound_FUN_005abdc0 ; 005a9ac7 | void sound_sndmain.cpp_unlockSound_FUN_005abdc0()
        ;   Label: LAB_005a9ac7
