// Name: sound_sndmain.cpp_CSfxSample_FUN_005a6170
// Address: 005a6170
...

{
  ...
  if (iVar1 == 0) {
    sound_sndmain_cpp_CSfxSample_FUN_005a8550(this_ptr);
    ...
    pvVar2 = shape_memdbg_cpp_debugRealloc_FUN_0050f540
                       (this_ptr->sample_data,iVar1 * *(int *)this_ptr->field8_0x160,filename,iVar3)
    ;
    if (pvVar2 != (void *)0x0) {
    ...
    if (g_CSoundInstance != (CSound *)0x0) {
      do {
        pvVar2 = (void *)(*(code *)g_CSoundInstance->vtable->field_44)();
        ...
        do {
          ...
          if (((g_SfxSamples[iVar1].ref_count == 0) &&
              (g_SfxSamples[iVar1].buffer_id != (void *)0x0)) &&
...
// Assembly code:
// 005a6170: PUSH EBX
//   Label: sound_sndmain.cpp_CSfxSample_FUN_005a6170
// 005a6171: PUSH ESI
// 005a6172: PUSH EDI
// 005a6173: PUSH EBP
...
// 005a617b: PUSH EDX
// 005a617c: CALL sound_sndmain.cpp_CSfxSample_releaseBufferId_FUN_005a63b0
//   XREF to: 005a63b0 (UNCONDITIONAL_CALL)
// 005a6181: ADD ESP,0x4
// 005a6184: MOV ECX,dword ptr [ESP + 0x18]
//   XREF to: Stack[0x4] (READ)
// 005a6188: PUSH ECX
// 005a6189: CALL sound_sndmain.cpp_CSfxSample_freeSampleData_FUN_005a6400
...
// 005a6258: CALL sound_sndmain.cpp_CSfxSample_freeMemory_FUN_005a62c0
...
//   XREF to: Stack[0x4] (READ)
// 005a6266: PUSH EBX
// 005a6267: CALL sound_sndmain.cpp_CSfxSample_FUN_005a8550
...
// 005a6289: PUSH EBX
// 005a628a: CALL sound_sndmain.cpp_CSfxSample_FUN_005a8550
//   XREF to: 005a8550 (UNCONDITIONAL_CALL)
