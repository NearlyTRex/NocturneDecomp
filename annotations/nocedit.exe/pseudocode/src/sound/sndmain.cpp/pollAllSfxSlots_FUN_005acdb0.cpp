...
// Convention: __cdecl
// Signature: void __cdecl sound_sndmain_cpp_pollAllSfxSlots_FUN_005acdb0(void)
...

{
  ...
  this_ptr = g_SfxSlots;
  do {
    iVar2 = sound_sndmain_cpp_CSfxSlot_compute_FUN_005a7100(this_ptr,local_18);
    if (iVar2 != 0) {
      sound_sndmain_cpp_CSfxSlot_pollHwHandle_FUN_005a7fe0(this_ptr);
    }
    this_ptr = this_ptr + 1;
  } while (this_ptr != g_SfxSlots + sizeof(g_SfxSlots) / sizeof(g_SfxSlots[0]));
  return;
}
