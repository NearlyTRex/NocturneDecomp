...

{
  ...
  if ((this_ptr->playback_state != 0) && (0.0 <= (this_ptr->options).trigger_time)) {
    ...
    if (((this_ptr->options).flags & 1) == 0) {
      ...
      if (this_ptr->is_active == 1) {
        local_28 = SUB84 /* extract 2-byte value */(dVar4,0);
        engine_console_cpp_CConsole_printf_FUN_00441890
      ...
      local_50 = (dVar4 * 1 + 1116.4000000000001) / 1116.4000000000001;
      if (this_ptr->is_active == 1) {
        engine_console_cpp_CConsole_printf_FUN_00441890
      ...
      if ((double)CONCAT44 /* combine 2-byte values */(4._4_4_,4._0_4_) < local_50) {
        local_50 = (double)CONCAT44 /* combine 2-byte values */(4._4_4_,4._0_4_);
      }
      if (this_ptr->is_active == 1) {
        engine_console_cpp_CConsole_printf_FUN_00441890
