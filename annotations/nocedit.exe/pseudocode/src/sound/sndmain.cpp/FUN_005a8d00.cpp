// Name: sound_sndmain.cpp_FUN_005a8d00
// Address: 005a8d00
// Address Range: [[005a8d00, 005a8e86]]
// Convention: unknown
// Signature: undefined sound_sndmain.cpp_FUN_005a8d00()
// Globals:
...
void sound_sndmain_cpp_FUN_005a8d00(void)

{
  ...
  if (in_stack_00000008 == 0) {
    *in_stack_00000004 = '\0';
    ...
    iVar1 = crt_stdio_c_sprintf_FUN_005fdbd0(in_stack_00000004,"%s",in_stack_00000008);
    in_stack_00000004 = in_stack_00000004 + iVar1;
  }
  if ((in_stack_00000014 & 1) != 0) {
    iVar1 = crt_stdio_c_sprintf_FUN_005fdbd0(in_stack_00000004," channel=%d%s");
    in_stack_00000004 = in_stack_00000004 + iVar1;
  }
  if ((in_stack_00000014 & 2) != 0) {
    if (*(int *)(in_stack_0000000c + 0x20) == 0) {
      iVar1 = crt_stdio_c_sprintf_FUN_005fdbd0
                        (in_stack_00000004," pos=%lg,%lg,%lg",
                         *(undefined4 *)(in_stack_0000000c + 4),
                         *(undefined4 *)(in_stack_0000000c + 8),
                         *(undefined4 *)(in_stack_0000000c + 0xc),
                         *(undefined4 *)(in_stack_0000000c + 0x10),
                         *(undefined4 *)(in_stack_0000000c + 0x14));
      in_stack_00000004 = in_stack_00000004 + iVar1;
    }
    if (*(int *)(in_stack_0000000c + 0x20) == 1) {
      iVar1 = crt_stdio_c_sprintf_FUN_005fdbd0(in_stack_00000004," posPtrFloat=%p");
      in_stack_00000004 = in_stack_00000004 + iVar1;
    }
    if (*(int *)(in_stack_0000000c + 0x20) == 2) {
      iVar1 = crt_stdio_c_sprintf_FUN_005fdbd0(in_stack_00000004," posPtrDouble=%p");
      in_stack_00000004 = in_stack_00000004 + iVar1;
    }
  }
  if ((in_stack_00000014 & 4) != 0) {
    if (*(int *)(in_stack_0000000c + 0x40) == 0) {
      iVar1 = crt_stdio_c_sprintf_FUN_005fdbd0
                        (in_stack_00000004," vel=%lg,%lg,%lg",
                         *(undefined4 *)(in_stack_0000000c + 0x24),
                         *(undefined4 *)(in_stack_0000000c + 0x28),
                         *(undefined4 *)(in_stack_0000000c + 0x2c),
                         *(undefined4 *)(in_stack_0000000c + 0x30),
                         *(undefined4 *)(in_stack_0000000c + 0x34));
      in_stack_00000004 = in_stack_00000004 + iVar1;
    }
    if (*(int *)(in_stack_0000000c + 0x40) == 1) {
      iVar1 = crt_stdio_c_sprintf_FUN_005fdbd0(in_stack_00000004," velPtrFloat=%p");
      in_stack_00000004 = in_stack_00000004 + iVar1;
    }
    if (*(int *)(in_stack_0000000c + 0x40) == 2) {
      iVar1 = crt_stdio_c_sprintf_FUN_005fdbd0(in_stack_00000004," velPtrDouble=%p");
      in_stack_00000004 = in_stack_00000004 + iVar1;
    }
  }
  if ((in_stack_00000014 & 8) != 0) {
    iVar1 = crt_stdio_c_sprintf_FUN_005fdbd0
                      (in_stack_00000004," vol=%g",
                       (double)*(float *)(in_stack_0000000c + 0x44));
    in_stack_00000004 = in_stack_00000004 + iVar1;
  }
  if ((in_stack_00000014 & 0x10) != 0) {
    iVar1 = crt_stdio_c_sprintf_FUN_005fdbd0
                      (in_stack_00000004," freq=%g",
                       (double)*(float *)(in_stack_0000000c + 0x48));
    in_stack_00000004 = in_stack_00000004 + iVar1;
  }
  ...
  crt_stdio_c_sprintf_FUN_005fdbd0
            (in_stack_00000004," delay=%lg",*(undefined4 *)(in_stack_0000000c + 0x4c),
             *(undefined4 *)(in_stack_0000000c + 0x50));
  return;
}
...
// Assembly code:
// 005a8d00: PUSH EBX
//   Label: sound_sndmain.cpp_FUN_005a8d00
// 005a8d01: PUSH ESI
// 005a8d02: PUSH EDI
// 005a8d03: PUSH EBP
