...
;                               FUNCTION
; *****************************************************************************
; __cdecl int sound_sndmain.cpp_CSfxSlot_computeDistancesToSpeakers_FUN_005a6d80(CSfxSlot * this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EDI,dword ptr [0x00681b18]      ; 005a6d86 | int g_AudioChannelCount
    MOV ESI,dword ptr [ESP + 0x28]      ; 005a6d8c
    XOR EBX,EBX                         ; 005a6d90
    TEST EDI,EDI                        ; 005a6d92
    JLE 0x005a6de0                      ; 005a6d94 | LAB_005a6de0
        ;   XREF to: 005a6de0 (CONDITIONAL_JUMP)
    MOV ECX,ESI                         ; 005a6d96
    XOR EDX,EDX                         ; 005a6d98
    FLD double ptr [ESI + 0x4]          ; 005a6d9a
        ;   Label: LAB_005a6d9a
    FSUB double ptr [EDX + 0x3f69328]   ; 005a6d9d | double[8] g_VirtualSpeakerXPositions
    FMUL ST0                            ; 005a6da3
    FLD double ptr [ESI + 0xc]          ; 005a6da5
    FSUB double ptr [EDX + 0x3f69368]   ; 005a6da8 | double[8] g_VirtualSpeakerYPositions
    FMUL ST0                            ; 005a6dae
    FLD double ptr [ESI + 0x14]         ; 005a6db0
    FXCH                                ; 005a6db3
    FADDP ST2,ST0                       ; 005a6db5
    FSUB double ptr [EDX + 0x3f693a8]   ; 005a6db7 | double[8] g_VirtualSpeakerZPositions
    FMUL ST0                            ; 005a6dbd
    FADDP                               ; 005a6dbf
    FSQRT                               ; 005a6dc1
    ...
    JL 0x005a6d9a                       ; 005a6dcf | LAB_005a6d9a
        ;   XREF to: 005a6d9a (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 005a6dd1
    LEA EDX,[EDX]                       ; 005a6dd7
    LEA EAX,[EAX]                       ; 005a6ddd
    MOV dword ptr [0x00681b18],EDI      ; 005a6de0 | int g_AudioChannelCount
        ;   Label: LAB_005a6de0
