...
// Convention: __cdecl
// Signature: void __cdecl sound_sndmain_cpp_CSfxSample_freeSampleData_FUN_005a6400(CSfxSample *this_ptr)
...

{
  ...
  shape_memdbg_cpp_debugFree_FUN_0050f460(this_ptr->sample_data,"..\\sound\\sndmain.cpp",1860);
