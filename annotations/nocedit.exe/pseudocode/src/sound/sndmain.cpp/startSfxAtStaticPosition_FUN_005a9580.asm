...
;                               FUNCTION
; *****************************************************************************
; __cdecl uint sound_sndmain.cpp_startSfxAtStaticPosition_FUN_005a9580(char * filename, double pos_x, double pos_y, double pos_z)
;
; Parameters:
...
section .text
    ...
    PUSH EDI                            ; 005a9582
    PUSH EBP                            ; 005a9583
    CALL sound_sndmain.cpp_pushSfxOptions_FUN_005a8c30 ; 005a9584 | void sound_sndmain.cpp_pushSfxOptions_FUN_005a8c30()
        ;   XREF to: 005a8c30 (UNCONDITIONAL_CALL)
    PUSH 0x1                            ; 005a9589
    CALL sound_sndmain.cpp_clearNextSfxFlagBits_FUN_005a8bb0 ; 005a958b | void sound_sndmain.cpp_clearNextSfxFlagBits_FUN_005a8bb0(uint flag_mask)
    ...
    PUSH EBP                            ; 005a95b0
    CALL sound_sndmain.cpp_setNextSfxStaticPosition_FUN_005a88e0 ; 005a95b1 | void sound_sndmain.cpp_setNextSfxStaticPosition_FUN_005a88e0(double pos_x, double pos_y, double pos_z)
        ;   XREF to: 005a88e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x18                        ; 005a95b6
    MOV EAX,dword ptr [ESP + 0x14]      ; 005a95b9
    PUSH EAX                            ; 005a95bd
    CALL sound_sndmain.cpp_startSfx_FUN_005a8e90 ; 005a95be | uint sound_sndmain.cpp_startSfx_FUN_005a8e90(char * filename)
        ;   XREF to: 005a8e90 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005a95c3
    MOV EBX,EAX                         ; 005a95c6
    CALL sound_sndmain.cpp_popSfxOptions_FUN_005a8cb0 ; 005a95c8 | void sound_sndmain.cpp_popSfxOptions_FUN_005a8cb0()
