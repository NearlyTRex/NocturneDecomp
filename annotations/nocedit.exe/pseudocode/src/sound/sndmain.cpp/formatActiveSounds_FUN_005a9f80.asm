...
section .text
    ...
    PUSH EDI                            ; 005a9f82
    PUSH EBP                            ; 005a9f83
    CALL sound_sndmain.cpp_lockSound_FUN_005abd30 ; 005a9f84 | void sound_sndmain.cpp_lockSound_FUN_005abd30()
        ;   XREF to: 005abd30 (UNCONDITIONAL_CALL)
    MOV EDI,dword ptr [ESP + 0x14]      ; 005a9f89
    MOV EBX,0x3f5daa4                   ; 005a9f8d | CSfxSlot[64] g_SfxSlots
    XOR ESI,ESI                         ; 005a9f92
    CMP dword ptr [EBX + 0x78],0x0      ; 005a9f94 | DAT_03f5db1c
        ;   Label: LAB_005a9f94
    JNZ 0x005a9fb3                      ; 005a9f98 | LAB_005a9fb3
        ;   XREF to: 005a9fb3 (CONDITIONAL_JUMP)
    INC ESI                             ; 005a9f9a
        ;   Label: LAB_005a9f9a
    ADD EBX,0x128                       ; 005a9f9b | g_SfxSlots[1].status
    CMP ESI,0x40                        ; 005a9fa1
    JL 0x005a9f94                       ; 005a9fa4 | LAB_005a9f94
        ;   XREF to: 005a9f94 (CONDITIONAL_JUMP)
    CALL sound_sndmain.cpp_unlockSound_FUN_005abdc0 ; 005a9fa6 | void sound_sndmain.cpp_unlockSound_FUN_005abdc0()
    ...
    CMP dword ptr [EBX + 0x74],0x0      ; 005a9fb3 | DAT_03f5dc40
        ;   Label: LAB_005a9fb3
    JZ 0x005a9f9a                       ; 005a9fb7 | LAB_005a9f9a
        ;   XREF to: 005a9f9a (CONDITIONAL_JUMP)
    PUSH EBX                            ; 005a9fb9 | g_SfxSlots[1].status
    CALL sound_sndmain.cpp_CSfxSlot_pollHwPlaybackPos_FUN_005a80e0 ; 005a9fba | int sound_sndmain.cpp_CSfxSlot_pollHwPlaybackPos_FUN_005a80e0(CSfxSlot * this_ptr)
    ...
    PUSH EAX                            ; 005a9fd9
    PUSH ESI                            ; 005a9fda
    PUSH 0x650b33                       ; 005a9fdb | = "sfx slot %d: %s, pos %7.1f/%7.1f\n" | s_sfx_slot_d_s_pos_7_1f_7__00650b33 = sfx slot %d: %s, pos %7.1f/%7.1f

    PUSH EDI                            ; 005a9fe0
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005a9fe1 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x20                        ; 005a9fe6
    ADD EDI,EAX                         ; 005a9fe9
    JMP 0x005a9f9a                      ; 005a9feb | LAB_005a9f9a
