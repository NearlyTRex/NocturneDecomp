...

{
  ...
  __arrinit(g_SfxSlots,0x40,&g_SfxSlotTypeInfo);
  __arrinit(g_SfxOptions,8,&g_SfxOptionsTypeInfo);
  __arrinit(g_SfxSamples,0x40,&g_SfxSampleTypeInfo);
  _atexit(&g_SfxSamplesDestructorNode);
  return;
}
