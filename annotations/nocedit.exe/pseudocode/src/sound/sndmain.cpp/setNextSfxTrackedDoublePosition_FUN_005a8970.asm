...
;                               FUNCTION
; *****************************************************************************
; __cdecl void sound_sndmain.cpp_setNextSfxTrackedDoublePosition_FUN_005a8970(CVector3d * position_source_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EAX,[0x03f624a4]                ; 005a8970 | int g_SfxLastSlot
