// Name: sound_sndmain.cpp_FUN_005a9de0
// Address: 005a9de0
// Address Range: [[005a9de0, 005a9e1f]]
// Convention: unknown
// Signature: undefined sound_sndmain.cpp_FUN_005a9de0()
// Cross-references:
...
void sound_sndmain_cpp_FUN_005a9de0
               (undefined4 param_1,undefined4 param_2,undefined4 unaff_EBX,undefined4 param_4,
               int param_5,int param_6)

{
  if (param_5 < 0x21) {
    g_MaxSoundChannels = param_5;
    return;
  }
  g_CurrentFilename = "..\\sound\\sndmain.cpp";
  g_CurrentLineNumber = 0xf9b;
  core_main_c_displayErrorAndQuit_FUN_00506f10("setNumberOfSfxChannels - too many!",unaff_EBX);
  g_MaxSoundChannels = param_6;
  return;
}
...
//   Label: sound_sndmain.cpp_FUN_005a9de0
