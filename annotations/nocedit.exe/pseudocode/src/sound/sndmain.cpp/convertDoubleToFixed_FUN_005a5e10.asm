...
section .text
    ...
    PUSH ECX                            ; 005a5e1d
    CALL crt_math.c_floor_FUN_005feb90  ; 005a5e1e | double crt_math.c_floor_FUN_005feb90(double input_value)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 005a5e34 | double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    FMUL double ptr [0x0064fca7]        ; 005a5e51 | double DOUBLE_0064fca7
    MOV dword ptr [EDX],EAX             ; 005a5e57
    MOV EDX,dword ptr [ESP + 0x1c]      ; 005a5e59
    CALL crt_math.c_round_FUN_005fe6b0  ; 005a5e5d | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
