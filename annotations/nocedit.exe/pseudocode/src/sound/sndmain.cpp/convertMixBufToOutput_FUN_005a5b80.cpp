...
void sound_sndmain_cpp_convertMixBufToOutput_FUN_005a5b80(void)
...
LAB_005a5ccd:
    ...
    core_main_c_displayErrorAndQuit_FUN_00506f10
              ("convertMixBufToOutput - invalid bits: %d",in_stack_0000000c);
    return;
  }
  if (in_stack_0000000c < 9) {
    ...
    if (0 < in_stack_00000010) {
      do {
        ...
        local_30 = (undefined2 *)((int)local_30 + in_stack_00000014);
    ...
    if (in_stack_0000000c != 0x10) goto LAB_005a5ccd;
    local_14 = 0;
    if (0 < in_stack_00000010) {
      do {
        fVar1 = *in_stack_00000004;
        ...
        in_stack_00000004 = in_stack_00000004 + 1;
        local_14 = local_14 + 1;
      } while (local_14 < in_stack_00000010);
    }
  }
  return;
}
