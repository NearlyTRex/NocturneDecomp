// Name: sound_sndmain.cpp_SampleInfo_cvtPlaybackPos_FUN_005a8580
// Address: 005a8580
// Address Range: [[005a8580, 005a86e7]]
// Convention: unknown
// Signature: undefined sound_sndmain.cpp_SampleInfo_cvtPlaybackPos_FUN_005a8580()
// Cross-references:
//   sound_sndmain.cpp_FUN_005a86f0 (005a86f0) at 005a870d [UNCONDITIONAL_CALL]
//   sound_sndmain.cpp_FUN_005a9720 (005a9720) at 005a9770 [UNCONDITIONAL_CALL]
//   sound_sndmain.cpp_SfxSlot_seek_FUN_005a8390 (005a8390) at 005a83d6 [UNCONDITIONAL_CALL]
// Globals:
...
/* Signature: undefined1 sound_sndmain.cpp_SampleInfo_cvtPlaybackPos(undefined4 param_1, undefined8
   param_2, undefined4 param_3, undefined4 param_4) */

double sound_sndmain_cpp_SampleInfo_cvtPlaybackPos_FUN_005a8580(void)
  ...
  if (in_stack_00000010 != in_stack_00000014) {
    if (in_stack_00000010 != 0) {
      if (in_stack_00000010 < 2) {
        in_stack_00000008 = (double)*(int *)(in_stack_00000004 + 0x10c) * in_stack_00000008;
      }
        ...
        if (*(int *)(in_stack_00000004 + 0x110) < 1) {
          ...
          core_main_c_displayErrorAndQuit_FUN_00506f10
                    ("SampleInfo::cvtPlaybackPos - can't use relative sample position when length of %s is not known.",in_stack_00000004);
          in_stack_00000008 = (double)*(int *)(in_stack_00000004 + 0x110) * in_stack_00000008;
        }
        else {
          in_stack_00000008 = (double)*(int *)(in_stack_00000004 + 0x110) * in_stack_00000008;
        }
    ...
    if (in_stack_00000014 != 0) {
      if (in_stack_00000014 < 2) {
        in_stack_00000008 = in_stack_00000008 / (double)*(int *)(in_stack_00000004 + 0x10c);
      }
        ...
        if (*(int *)(in_stack_00000004 + 0x110) < 1) {
          ...
          core_main_c_displayErrorAndQuit_FUN_00506f10
                    ("SampleInfo::cvtPlaybackPos - can't use relative sample position when length of %s is not known.",in_stack_00000004);
          in_stack_00000008 = in_stack_00000008 / (double)*(int *)(in_stack_00000004 + 0x110);
        }
        else {
          in_stack_00000008 = in_stack_00000008 / (double)*(int *)(in_stack_00000004 + 0x110);
        }
...
// Assembly code:
// 005a8580: PUSH EBX
//   Label: sound_sndmain.cpp_SampleInfo_cvtPlaybackPos_FUN_005a8580
// 005a8581: PUSH ESI
// 005a8582: PUSH EDI
// 005a8583: PUSH EBP
