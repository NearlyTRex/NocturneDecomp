...
// Convention: __cdecl
// Signature: int __cdecl sound_sndmain_cpp_ensureSoundMemoryAvailable_FUN_005a4450(int requested_bytes)
...

{
  ...
  do {
    if (g_SfxSamples[iVar2].sample_data != (short *)0x0) {
      iVar3 = sound_sndmain_cpp_CSfxSample_getBytesPerFrame_FUN_005a8550(&g_SfxSamples[iVar2]);
      iVar4 = iVar4 + iVar3 * g_SfxSamples[iVar2].streaming_buffer_size;
    }
    iVar2 = iVar2 + 1;
  } while (iVar2 != 0x40);
LAB_005a4473:
