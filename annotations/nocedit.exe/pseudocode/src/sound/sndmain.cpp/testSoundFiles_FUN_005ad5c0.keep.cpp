...

{
  ...
  if (0 < local_34.item_count) {
    do {
      ...
      iVar2 = engine_dosio_cpp_getFileSize_FUN_00481880("sound",acStack_44c);
      if ((iVar2 < 1) &&
         (iVar1 = engine_dosio_cpp_getFileSize_FUN_00481880("sound",acStack_348), iVar1 < 1))
      {
  ...
  if (iVar1 == 0) {
    ...
    if (0 < CStack_24.item_count) {
      do {
        ...
        iVar4 = engine_dosio_cpp_findFile_FUN_00481760(&SStack_964);
        if (iVar4 == 0) {
          pcVar5 = shape_edittool_cpp_CStrList_getStringAt_FUN_004a2f70(&CStack_24,iVar1);
          ...
          iVar4 = engine_dosio_cpp_getFileSize_FUN_00481880("sound",acStack_550);
          if (-1 < iVar4) {
            _sprintf
          ...
          iVar4 = engine_dosio_cpp_findFile_FUN_00481760(&SStack_b78);
          if (iVar4 == 0) {
            _sprintf(acStack_750,"No sfx file for %s",SStack_964.found_path);
            shape_edittool_cpp_CStrList_add_FUN_004a2b80(&CStack_f20.base,acStack_750);
          }
          else if (SStack_b78.timestamp < SStack_964.timestamp) {
            _sprintf
                      (acStack_750,"%s older than %s",SStack_b78.found_path,SStack_964.found_path);
            shape_edittool_cpp_CStrList_add_FUN_004a2b80(&CStack_f20.base,acStack_750);
          }
          else {
            pcVar5 = shape_edittool_cpp_CStrList_getStringAt_FUN_004a2f70(&CStack_24,iVar1);
