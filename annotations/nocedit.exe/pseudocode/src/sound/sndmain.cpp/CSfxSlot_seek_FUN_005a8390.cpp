...

{
  ...
  dest_buffer_offset = SUB84(dVar4,0);
  pCVar1 = this_ptr->sample;
  (this_ptr->options).trigger_time = dVar4;
  iVar2 = pCVar1->streaming_slot_index;
  if (iVar2 < 0) {
    *(undefined4 *)&this_ptr->prev_hardware_playback_pos =
         *(undefined4 *)&(this_ptr->options).trigger_time;
    *(undefined4 *)((int)&this_ptr->prev_hardware_playback_pos + 4) =
         *(undefined4 *)((int)&(this_ptr->options).trigger_time + 4);
    return;
  }
  fVar3 = (float10)(this_ptr->options).trigger_time;
  dVar4 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44(iVar2,pCVar1));
  sound_sndmain_cpp_CSfxSample_seek_FUN_005a65a0
            (SUB84(dVar4,0),(int)ROUND(fVar3),dest_buffer_offset);
