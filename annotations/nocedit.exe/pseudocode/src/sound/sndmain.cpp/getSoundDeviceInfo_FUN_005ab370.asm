...
;                               FUNCTION
; *****************************************************************************
; __cdecl void sound_sndmain.cpp_getSoundDeviceInfo_FUN_005ab370(int device_id, SSoundDeviceInfo * device_info)
;
; Parameters:
...
section .text
    ...
    CALL sound_sndmain.cpp_getSoundDeviceCount_FUN_005ab2e0 ; 005ab377 | int sound_sndmain.cpp_getSoundDeviceCount_FUN_005ab2e0()
        ;   XREF to: 005ab2e0 (UNCONDITIONAL_CALL)
    TEST EBX,EBX                        ; 005ab37c
    JL 0x005ab3a8                       ; 005ab37e | LAB_005ab3a8
        ;   XREF to: 005ab3a8 (CONDITIONAL_JUMP)
    CMP EBX,EAX                         ; 005ab380
    JGE 0x005ab3a8                      ; 005ab382 | LAB_005ab3a8
        ;   XREF to: 005ab3a8 (CONDITIONAL_JUMP)
    ...
    LEA ESI,[EAX*0x8 + 0x3f689a8]       ; 005ab39b | SSoundDeviceInfo[8] g_SoundDevices
    MOVSD.REP ES:EDI,ESI                ; 005ab3a2 | SSoundDeviceInfo[8] g_SoundDevices
    POP EDI                             ; 005ab3a4
    POP ESI                             ; 005ab3a5
    POP EBX                             ; 005ab3a6
    RET                                 ; 005ab3a7
    MOV EDX,0x650c63                    ; 005ab3a8 | = "..\\sound\\sndmain.cpp" | s_sound_sndmain_cpp_00650c63 = ..\sound\sndmain.cpp
        ;   Label: LAB_005ab3a8
    MOV ECX,0x12f5                      ; 005ab3ad
    PUSH 0x650c78                       ; 005ab3b2 | = "getSoundDeviceInfo - invalid index" | s_getSoundDeviceInfo_inval_00650c78 = getSoundDeviceInfo - invalid index
    MOV dword ptr [0x02f0ca48],EDX      ; 005ab3b7 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 005ab3bd | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005ab3c3 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005ab3c8
    JMP 0x005ab384                      ; 005ab3cb | LAB_005ab384
