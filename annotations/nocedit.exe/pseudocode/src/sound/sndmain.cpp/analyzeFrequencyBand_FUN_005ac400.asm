...
;                               FUNCTION
; *****************************************************************************
; __cdecl int sound_sndmain.cpp_analyzeFrequencyBand_FUN_005ac400(int channel, float freq_start_hz, float freq_end_hz)
;
; Parameters:
...
section .text
    ...
    CMP dword ptr [EBX + 0x3f692b0],0x0 ; 005ac415 | void *[8] g_ChannelPrimaryBuffers
    JZ 0x005ac439                       ; 005ac41c | LAB_005ac439
        ;   XREF to: 005ac439 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x3f692d4],0x0 ; 005ac41e | float *[8] g_ChannelSecondaryBuffersA
    JZ 0x005ac439                       ; 005ac425 | LAB_005ac439
        ;   XREF to: 005ac439 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x3f692f4],0x0 ; 005ac427 | float *[8] g_ChannelSecondaryBuffersB
    JZ 0x005ac439                       ; 005ac42e | LAB_005ac439
        ;   XREF to: 005ac439 (CONDITIONAL_JUMP)
    CMP dword ptr [0x03f69280],0x1      ; 005ac430 | int g_MixBufferSize
    JGE 0x005ac450                      ; 005ac437 | LAB_005ac450
    ...
    POP EBX                             ; 005ac44e
    RET                                 ; 005ac44f
    CALL sound_sndmain.cpp_getMixBufferCount_FUN_005ab6d0 ; 005ac450 | int sound_sndmain.cpp_getMixBufferCount_FUN_005ab6d0()
        ;   Label: LAB_005ac450
        ;   XREF to: 005ab6d0 (UNCONDITIONAL_CALL)
    CMP EAX,dword ptr [EBX + 0x3f5d880] ; 005ac455 | int[8] g_ChannelFFTTimestamps
    JZ 0x005ac7a7                       ; 005ac45b | LAB_005ac7a7
        ;   XREF to: 005ac7a7 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [0x03f69280]      ; 005ac461 | int g_MixBufferSize
    MOV EDX,dword ptr [EBX + 0x3f692d4] ; 005ac467 | float *[8] g_ChannelSecondaryBuffersA
    MOV ECX,dword ptr [EBX + 0x3f692f4] ; 005ac46d | float *[8] g_ChannelSecondaryBuffersB
    MOV EDI,dword ptr [EBX + 0x3f692b0] ; 005ac473 | void *[8] g_ChannelPrimaryBuffers
    ...
    JLE 0x005ac4f3                      ; 005ac4da | LAB_005ac4f3
    ...
    JL 0x005ac4dc                       ; 005ac4f1 | LAB_005ac4dc
    ...
    JNZ 0x005ac957                      ; 005ac51b | LAB_005ac957
    ...
    JL 0x005ac4cb                       ; 005ac530 | LAB_005ac4cb
    ...
    JL 0x005ac798                       ; 005ac547 | LAB_005ac798
    ...
    FDIVR double ptr [0x00651017]       ; 005ac56f | double DOUBLE_00651017
    FLD ST0                             ; 005ac575
    FSINCOS                             ; 005ac577
    FXCH ST2                            ; 005ac579
    FLD double ptr [0x0065100f]         ; 005ac57b | double DOUBLE_0065100f
    FXCH                                ; 005ac581
    FMUL ST1                            ; 005ac583
    FLD ST0                             ; 005ac585
    FSIN                                ; 005ac587
    ...
    JLE 0x005ac779                      ; 005ac5e6 | LAB_005ac779
    ...
    JLE 0x005ac753                      ; 005ac633 | LAB_005ac753
    ...
    JL 0x005ac68b                       ; 005ac74b | LAB_005ac68b
    ...
    JL 0x005ac5ec                       ; 005ac773 | LAB_005ac5ec
    ...
    JLE 0x005ac54d                      ; 005ac792 | LAB_005ac54d
        ;   XREF to: 005ac54d (CONDITIONAL_JUMP)
    CALL sound_sndmain.cpp_getMixBufferCount_FUN_005ab6d0 ; 005ac798 | int sound_sndmain.cpp_getMixBufferCount_FUN_005ab6d0()
        ;   Label: LAB_005ac798
        ;   XREF to: 005ab6d0 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [EBP + 0x14]      ; 005ac79d
    MOV dword ptr [EDX*0x4 + 0x3f5d880],EAX ; 005ac7a0 | int[8] g_ChannelFFTTimestamps
    MOV EAX,[0x03f69280]                ; 005ac7a7 | int g_MixBufferSize
        ;   Label: LAB_005ac7a7
    ...
    FILD dword ptr [0x00681b1c]         ; 005ac7d7 | int g_AudioSampleRate
    FDIVP                               ; 005ac7dd
    SUB ESP,0x8                         ; 005ac7df
    FSTP double ptr [ESP]               ; 005ac7e2
    CALL crt_math.c_floor_FUN_005feb90  ; 005ac7e5 | double crt_math.c_floor_FUN_005feb90(double input_value)
    ...
    FILD dword ptr [0x00681b1c]         ; 005ac80c | int g_AudioSampleRate
    FDIVP                               ; 005ac812
    FXCH                                ; 005ac814
    CALL crt_math.c_round_FUN_005fe6b0  ; 005ac816 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x90]        ; 005ac81b
    SUB ESP,0x8                         ; 005ac822
    FSTP double ptr [ESP]               ; 005ac825
    CALL crt_math.c_floor_FUN_005feb90  ; 005ac828 | double crt_math.c_floor_FUN_005feb90(double input_value)
        ;   XREF to: 005feb90 (UNCONDITIONAL_CALL)
    ...
    JLE 0x005ac914                      ; 005ac8c4 | LAB_005ac914
        ;   XREF to: 005ac914 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + 0x14]      ; 005ac8c6
    MOV EDX,dword ptr [EAX*0x4 + 0x3f692d4] ; 005ac8c9 | float *[8] g_ChannelSecondaryBuffersA
    MOV dword ptr [ESP + 0x84],EDX      ; 005ac8d0
    MOV EDX,dword ptr [EAX*0x4 + 0x3f692f4] ; 005ac8d7 | float *[8] g_ChannelSecondaryBuffersB
    ...
    JL 0x005ac8f7                       ; 005ac90e | LAB_005ac8f7
    ...
    FDIVP                               ; 005ac934
    FSQRT                               ; 005ac936
    FMUL double ptr [0x0065100f]        ; 005ac938 | double DOUBLE_0065100f
    ...
    JMP 0x005ac521                      ; 005ac95c | LAB_005ac521
    ...
    JMP 0x005ac888                      ; 005ac981 | LAB_005ac888
