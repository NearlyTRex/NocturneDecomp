...
// Convention: __cdecl
// Signature: void sound_sndmain.cpp_FUN_005a9f80(void)
// Globals:
...
void __cdecl sound_sndmain_cpp_FUN_005a9f80(void)

{
  ...
  do {
    if ((this_ptr->sample != (CSfxSample *)0x0) && (this_ptr->playback_state != 0)) {
      sound_sndmain_cpp_CSfxSlot_pollHwHandle_FUN_005a80e0(this_ptr);
      iVar1 = crt_stdio_c_sprintf_FUN_005fdbd0
                        (in_stack_00000008,"sfx slot %d: %s, pos %7.1f/%7.1f\n",iVar2,
                         this_ptr->sample,*(undefined4 *)&(this_ptr->options).trigger_time,
...
// 005a9fba: CALL sound_sndmain.cpp_CSfxSlot_pollHwHandle_FUN_005a80e0
