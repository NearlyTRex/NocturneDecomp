// Name: sound_sndmain.cpp_FUN_005a9a00
// Address: 005a9a00
// Address Range: [[005a9a00, 005a9a61]]
// Convention: __cdecl
// Signature: undefined sound_sndmain.cpp_FUN_005a9a00()
// Cross-references:
...
int __cdecl sound_sndmain_cpp_FUN_005a9a00(uint param_1,undefined4 param_2,CVector3d *param_3)

{
  CSfxSlot *this_ptr;
  int iVar1;
  
  this_ptr = sound_sndmain_cpp_getSfxSlotFromHandle_FUN_005a5d00(param_1,1);
  if (this_ptr == (CSfxSlot *)0x0) {
    return 0;
  }
  (this_ptr->options).velocity_format = 1;
  iVar1 = 1;
  (this_ptr->options).velocity_source_ptr = param_3;
...
// Assembly code:
// 005a9a00: PUSH EBX
//   Label: sound_sndmain.cpp_FUN_005a9a00
// 005a9a01: PUSH 0x1
// 005a9a03: MOV EDX,dword ptr [ESP + 0xc]
//   XREF to: Stack[0x4] (READ)
// 005a9a07: PUSH EDX
// 005a9a08: CALL sound_sndmain.cpp_getSfxSlotFromHandle_FUN_005a5d00
