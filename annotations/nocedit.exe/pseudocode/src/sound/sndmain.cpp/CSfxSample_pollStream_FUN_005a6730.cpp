...

{
  ...
  if (-1 < iVar3) {
    ...
    pCVar13 = (CSfxSlot *)(int)ROUND(dVar11);
    if ((int)pCVar13 < 0) {
      pCVar13 = (CSfxSlot *)
                ((int)(pCVar13->options).userdata + this_ptr->streaming_buffer_size + -0x54);
    }
    if ((int)pCVar13 < iVar3) {
      iVar14 = 99999999;
      if (this_ptr->buffer_id != 0) {
        iVar14 = sound_sndmain_cpp_CSfxSample_getBytesPerFrame_FUN_005a8550(this_ptr);
        iVar14 = (int)(0x3c00 / (longlong)iVar14);
      }
      dVar11 = crt_math_c_round_FUN_005fe6b0
                         ((double)((float)(this_ptr->sample_info).sample_rate * in_stack_00000010));
      file = (CSfxSample *)(int)ROUND(dVar11);
      if ((int)extraout_EAX < (int)file) {
        file = extraout_EAX;
      }
      pCVar4 = (CSfxSlot *)((int)file - iVar3);
      while( true ) {
        if ((int)pCVar4 < 1) {
          return 1;
        }
        if ((this_ptr->stream_write_position < 0) ||
          ...
          core_main_c_displayErrorAndQuit_FUN_00506f10
                    ("nextLoadSampleDest = %d, allocLength = %d",this_ptr->stream_write_position,
                     this_ptr->streaming_buffer_size,file,uVar12,iVar3,pCVar13,iVar14);
        }
        lock_length = (CSfxSlot *)
                      (this_ptr->streaming_buffer_size - this_ptr->stream_write_position);
        if ((int)pCVar4 < (int)lock_length) {
          lock_length = pCVar4;
        }
        if ((int)pCVar13 < (int)lock_length) {
          lock_length = pCVar13;
        }
        ...
        if (-1 < iVar14) {
          if (this_ptr->stream_read_position < iVar14) {
            pCVar5 = (CSfxSlot *)(iVar14 - this_ptr->stream_read_position);
            if ((int)pCVar5 < (int)lock_length) {
              lock_length = pCVar5;
            }
          }
          else {
            iVar14 = sound_sndmain_cpp_CSfxSample_getLoopMode_FUN_005a87d0
...
LAB_005a6ab8:
        if (bVar1) {
          ...
          uVar7 = *(uint *)(*(int *)(local_1c + 0x78) + 0x104);
...
LAB_005a6adf:
            ...
            crt_memory_c_memset_FUN_005fde40(pcVar8,0x80,count);
          }
          else {
            if (uVar7 != 0x10) goto LAB_005a6adf;
            crt_memory_c_memset_FUN_005fde40(pcVar8,0,count * 2);
          }
        }
          ...
          local_14 = (CSfxSlot *)
                     crt_stdio_c_fread_FUN_005fd990(pcVar8,size,(SIZE_T)count_00,(FILE *)file);
          if ((this_ptr->file_handle->_flag & 0x20) != 0) {
            sound_sndmain_cpp_CSfxSample_releaseSoundBuffer_FUN_005a6540(this_ptr);
            pcVar8 = "Error reading %s while streaming\n";
            file = this_ptr;
            goto LAB_005a69da;
          }
        }
          ...
          sound_mp3_cpp_CMP3Decoder_read_FUN_00534a60
                    (this_ptr->mp3_data,(short *)pcVar8,(int)lock_length);
        }
        if ((iVar14 == 0) || ((int)local_14 < 1)) {
          ...
          for (uVar7 = (uint)((int)local_14 * iVar6) >> 2; uVar7 != 0; uVar7 = uVar7 - 1) {
            *(uint *)pcVar8 = *(uint *)pcVar9;
            pcVar9 = pcVar9 + ((uint)bVar10 * -2 + 1) * 4;
            pcVar8 = pcVar8 + ((uint)bVar10 * -2 + 1) * 4;
          }
          for (uVar7 = (int)local_14 * iVar6 & 3; uVar7 != 0; uVar7 = uVar7 - 1) {
            *pcVar8 = *pcVar9;
...
LAB_005a6b5d:
        ...
        pCVar4 = (CSfxSlot *)((int)pCVar4 - (int)local_14);
        iVar6 = (int)(local_14->options).userdata + this_ptr->stream_write_position + -0x54;
      ...
      pcVar8 = "Error locking %s while streaming\n";
LAB_005a69da:
      sound_sndmain_cpp_logSoundError_FUN_005adba0(pcVar8,file);
LAB_005a69e2:
