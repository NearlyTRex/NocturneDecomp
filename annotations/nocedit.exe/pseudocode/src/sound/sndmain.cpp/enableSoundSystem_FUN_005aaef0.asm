...
;                               FUNCTION
; *****************************************************************************
; __cdecl int sound_sndmain.cpp_enableSoundSystem_FUN_005aaef0(void)
;
;
; XREF[9]:
...
;   core_skeledit.cpp_FUN_0058c190 at 0058d1f4
...
section .text
    ...
    PUSH EDI                            ; 005aaef2
    PUSH EBP                            ; 005aaef3
    CALL sound_sndmain.cpp_isSoundSystemActive_FUN_005ab530 ; 005aaef4 | uint sound_sndmain.cpp_isSoundSystemActive_FUN_005ab530()
        ;   XREF to: 005ab530 (UNCONDITIONAL_CALL)
    TEST EAX,EAX                        ; 005aaef9
    JNZ 0x005aaf02                      ; 005aaefb | LAB_005aaf02
    ...
    POP EBX                             ; 005aaf00
    RET                                 ; 005aaf01
    CALL sound_sndmain.cpp_isSoundEnabled_FUN_005a96b0 ; 005aaf02 | int sound_sndmain.cpp_isSoundEnabled_FUN_005a96b0()
        ;   Label: LAB_005aaf02
        ;   XREF to: 005a96b0 (UNCONDITIONAL_CALL)
    TEST EAX,EAX                        ; 005aaf07
    JNZ 0x005aaf1e                      ; 005aaf09 | LAB_005aaf1e
        ;   XREF to: 005aaf1e (CONDITIONAL_JUMP)
    CALL sound_sndmain.cpp_isSoundBusy_FUN_005ab540 ; 005aaf0b | int sound_sndmain.cpp_isSoundBusy_FUN_005ab540()
        ;   XREF to: 005ab540 (UNCONDITIONAL_CALL)
    TEST EAX,EAX                        ; 005aaf10
    JZ 0x005aaf28                       ; 005aaf12 | LAB_005aaf28
    ...
    POP EBX                             ; 005aaf1c
    RET                                 ; 005aaf1d
    CALL sound_sndmain.cpp_resetSoundDevice_FUN_005ab130 ; 005aaf1e | int sound_sndmain.cpp_resetSoundDevice_FUN_005ab130()
        ;   Label: LAB_005aaf1e
    ...
    POP EBX                             ; 005aaf26
    RET                                 ; 005aaf27
    CALL sound_sndmain.cpp_lockSound_FUN_005abd30 ; 005aaf28 | void sound_sndmain.cpp_lockSound_FUN_005abd30()
        ;   Label: LAB_005aaf28
        ;   XREF to: 005abd30 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [0x00681b1c]      ; 005aaf2d | int g_AudioSampleRate
    PUSH EDX                            ; 005aaf33
    MOV ECX,dword ptr [0x00681b18]      ; 005aaf34 | int g_AudioChannelCount
    PUSH ECX                            ; 005aaf3a
    MOV EBX,dword ptr [0x00681b14]      ; 005aaf3b | int g_AudioBitsPerSample
    PUSH EBX                            ; 005aaf41
    CALL sound_sndmain.cpp_setSoundOutputMode_FUN_005ab170 ; 005aaf42 | int sound_sndmain.cpp_setSoundOutputMode_FUN_005ab170(int bits_per_sample, int channels, int sample_rate)
        ;   XREF to: 005ab170 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005aaf47
    TEST EAX,EAX                        ; 005aaf4a
    JZ 0x005ab119                       ; 005aaf4c | LAB_005ab119
        ;   XREF to: 005ab119 (CONDITIONAL_JUMP)
    CMP dword ptr [0x03f69284],0x0      ; 005aaf52 | int g_NumMixBuffers
    JLE 0x005aafa0                      ; 005aaf59 | LAB_005aafa0
        ;   XREF to: 005aafa0 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [0x00681b18]      ; 005aaf5b | int g_AudioChannelCount
    XOR EBX,EBX                         ; 005aaf61
    TEST EDI,EDI                        ; 005aaf63
    JLE 0x005aafa0                      ; 005aaf65 | LAB_005aafa0
        ;   XREF to: 005aafa0 (CONDITIONAL_JUMP)
    XOR ESI,ESI                         ; 005aaf67
    MOV EAX,[0x03f69280]                ; 005aaf69 | int g_MixBufferSize
        ;   Label: LAB_005aaf69
    IMUL EAX,dword ptr [0x03f69284]     ; 005aaf6e | int g_NumMixBuffers
    SHL EAX,0x2                         ; 005aaf75
    PUSH EAX                            ; 005aaf78
    PUSH 0x0                            ; 005aaf79
    MOV EAX,dword ptr [ESI + 0x3f692b0] ; 005aaf7b | void *[8] g_ChannelPrimaryBuffers
    PUSH EAX                            ; 005aaf81
    ADD ESI,0x4                         ; 005aaf82
    INC EBX                             ; 005aaf85
    CALL crt_memory.c_memset_FUN_005fde40 ; 005aaf86 | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
        ;   XREF to: 005fde40 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [0x00681b18]      ; 005aaf8b | int g_AudioChannelCount
    ADD ESP,0xc                         ; 005aaf91
    CMP EBX,EDX                         ; 005aaf94
    JL 0x005aaf69                       ; 005aaf96 | LAB_005aaf69
    ...
    MOV dword ptr [0x03f69278],ECX      ; 005aafbd | int g_MixBufferReadIndex
    PUSH EDX                            ; 005aafc3
    MOV dword ptr [0x03f6927c],ECX      ; 005aafc4 | int g_MixBufferWriteIndex
    MOV ECX,dword ptr [0x03f68834]      ; 005aafca | g_Cached3DListenerPos.x+4
    PUSH ECX                            ; 005aafd0
    MOV ESI,dword ptr [0x03f68830]      ; 005aafd1 | CVector3d g_Cached3DListenerPos
    MOV EAX,[0x03f69268]                ; 005aafd7 | CSoundDevice * g_CSoundDevicePtr
    PUSH ESI                            ; 005aafdc
    ...
    PUSH ESI                            ; 005ab008
    MOV EDI,dword ptr [0x03f68890]      ; 005ab009 | CVector3d g_Cached3DListenerOrientRight
    PUSH EDI                            ; 005ab00f
    ...
    PUSH EDI                            ; 005ab032
    MOV EBP,dword ptr [0x03f68878]      ; 005ab033 | CVector3d g_Cached3DListenerOrientUp
    PUSH EBP                            ; 005ab039
    ...
    PUSH EBP                            ; 005ab05c
    MOV EDX,dword ptr [0x03f68860]      ; 005ab05d | CVector3d g_Cached3DListenerOrientFront
    MOV EAX,[0x03f69268]                ; 005ab063 | CSoundDevice * g_CSoundDevicePtr
    PUSH EDX                            ; 005ab068
    ...
    PUSH EDX                            ; 005ab094
    MOV ECX,dword ptr [0x03f68848]      ; 005ab095 | CVector3d g_Cached3DListenerVelocity
    MOV EAX,[0x03f69268]                ; 005ab09b | CSoundDevice * g_CSoundDevicePtr
    PUSH ECX                            ; 005ab0a0
    ...
    PUSH ESI                            ; 005ab0b0
    MOV EDI,dword ptr [0x00681b30]      ; 005ab0b1 | double DOUBLE_00681b30
    MOV EAX,[0x03f69268]                ; 005ab0b7 | CSoundDevice * g_CSoundDevicePtr
    PUSH EDI                            ; 005ab0bc
    ...
    MOV EAX,[0x03f69268]                ; 005ab0cc | CSoundDevice * g_CSoundDevicePtr
    PUSH dword ptr [0x03f693ec]         ; 005ab0d1 | g_DeferredOrientRight.y
    MOV EBX,dword ptr [EAX]             ; 005ab0d7
    PUSH dword ptr [0x03f693e8]         ; 005ab0d9 | CVector3f g_DeferredOrientRight
    PUSH EAX                            ; 005ab0df
    CALL dword ptr [EBX + 0x28]         ; 005ab0e0
    ADD ESP,0x10                        ; 005ab0e3
    CALL wincore_winrun.cpp_getTime_FUN_005f2dc0 ; 005ab0e6 | int wincore_winrun.cpp_getTime_FUN_005f2dc0()
        ;   XREF to: 005f2dc0 (UNCONDITIONAL_CALL)
    MOV [0x03f69410],EAX                ; 005ab0eb | int g_SoundStartTime
    MOV EAX,[0x03f69268]                ; 005ab0f0 | CSoundDevice * g_CSoundDevicePtr
    PUSH EAX                            ; 005ab0f5
    MOV EBX,dword ptr [EAX]             ; 005ab0f6
    CALL dword ptr [EBX + 0x4]          ; 005ab0f8
    ADD ESP,0x4                         ; 005ab0fb
    TEST EAX,EAX                        ; 005ab0fe
    JZ 0x005ab119                       ; 005ab100 | LAB_005ab119
        ;   XREF to: 005ab119 (CONDITIONAL_JUMP)
    MOV EBP,0x1                         ; 005ab102
    MOV dword ptr [0x03f6926c],EBP      ; 005ab107 | int g_SoundBusyFlag
    CALL sound_sndmain.cpp_unlockSound_FUN_005abdc0 ; 005ab10d | void sound_sndmain.cpp_unlockSound_FUN_005abdc0()
    ...
    POP EBX                             ; 005ab117
    RET                                 ; 005ab118
    CALL sound_sndmain.cpp_unlockSound_FUN_005abdc0 ; 005ab119 | void sound_sndmain.cpp_unlockSound_FUN_005abdc0()
        ;   Label: LAB_005ab119
        ;   XREF to: 005abdc0 (UNCONDITIONAL_CALL)
