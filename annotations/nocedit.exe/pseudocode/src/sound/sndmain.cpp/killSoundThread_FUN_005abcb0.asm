...
section .text
    ...
    MOV ECX,dword ptr [0x03f69400]      ; 005abcbc | g_AudioThreadRunning
    XOR EBX,EBX                         ; 005abcc2
    MOV dword ptr [0x03f69404],EDX      ; 005abcc4 | g_AudioThreadShutdownFlag
    TEST ECX,ECX                        ; 005abcca
    JZ 0x005abcef                       ; 005abccc
        ;   XREF to: 005abcef (CONDITIONAL_JUMP)  ; LAB_005abcef
    PUSH 0x3f847ae1                     ; 005abcce
        ;   Label: LAB_005abcce
    PUSH 0x47ae147b                     ; 005abcd3
    INC EBX                             ; 005abcd8
    CALL wincore_winrun.cpp_sleep_FUN_005f40e0 ; 005abcd9
    ...
    JGE 0x005abcef                      ; 005abce4
        ;   XREF to: 005abcef (CONDITIONAL_JUMP)  ; LAB_005abcef
    CMP dword ptr [0x03f69400],0x0      ; 005abce6 | g_AudioThreadRunning
    JNZ 0x005abcce                      ; 005abced
        ;   XREF to: 005abcce (CONDITIONAL_JUMP)  ; LAB_005abcce
    CMP dword ptr [0x03f69400],0x0      ; 005abcef | g_AudioThreadRunning
        ;   Label: LAB_005abcef
    JNZ 0x005abd0c                      ; 005abcf6
        ;   XREF to: 005abd0c (CONDITIONAL_JUMP)  ; LAB_005abd0c
    CMP dword ptr [0x03f69400],0x0      ; 005abcf8 | g_AudioThreadRunning
    SETZ AL                             ; 005abcff
