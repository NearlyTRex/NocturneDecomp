...
;                               FUNCTION
; *****************************************************************************
; __cdecl CSfxSample * __cdecl sound_sndmain_cpp_CSfxSample_arrdtor_FUN_005ade40(CSfxSample *objs,uint flags)
;
; Parameters:
...
section .text
    ...
    PUSH 0x6631c0                       ; 005ade40 | g_SfxSampleTypeInfo
        ;   Label: sound_sndmain.cpp_CSfxSample_arrdtor_FUN_005ade40
    PUSH 0x40                           ; 005ade45
