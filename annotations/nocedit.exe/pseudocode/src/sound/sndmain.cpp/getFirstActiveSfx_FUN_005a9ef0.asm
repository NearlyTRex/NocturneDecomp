...
section .text
    ...
    CMP ECX,dword ptr [EAX + 0x3f5db1c] ; 005a9ef7 | DAT_03f5db1c
        ;   Label: LAB_005a9ef7
    JZ 0x005a9f09                       ; 005a9efd | LAB_005a9f09
        ;   XREF to: 005a9f09 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [EAX + 0x3f5db18] ; 005a9eff | g_SfxSlots[0].field7_0x74
    CMP ECX,ESI                         ; 005a9f05
    JNZ 0x005a9f1a                      ; 005a9f07 | LAB_005a9f1a
        ;   XREF to: 005a9f1a (CONDITIONAL_JUMP)
    ADD EAX,0x128                       ; 005a9f09
        ;   Label: LAB_005a9f09
    INC EDX                             ; 005a9f0e
    CMP EAX,0x4a00                      ; 005a9f0f
    JL 0x005a9ef7                       ; 005a9f14 | LAB_005a9ef7
