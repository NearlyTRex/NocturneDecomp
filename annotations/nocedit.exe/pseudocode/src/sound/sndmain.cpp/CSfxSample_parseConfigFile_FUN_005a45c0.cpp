...

{
  ...
  engine_dosio_c_splitPath_FUN_00481f20
            ((char *)this_ptr,(char *)0x0,(char *)0x0,acStack_234,(char *)0x0);
  engine_dosio_c_makePath_FUN_00481f50
            (acStack_334,(char *)0x0,(char *)0x0,acStack_234,"klp");
  iVar6 = engine_dosio_c_getFileSize_FUN_00481880("sound",acStack_334);
  if (0 < iVar6) {
    this_ptr->loop_marker_count = 1;
  ...
  engine_dosio_c_makePath_FUN_00481f50
            (acStack_134,(char *)0x0,(char *)0x0,acStack_234,"sfx");
  iVar6 = engine_dosio_c_getFileSize_FUN_00481880("sound",acStack_134);
  if ((iVar6 < 1) ||
     (local_20 = engine_dosio_c_getFile_FUN_00481a50("sound",acStack_134,"rb"),
     local_20 == (FILE *)0x0)) {
    return;
  }
  ...
  iStack_14 = 0;
  while (stream = local_20, lVar7 = crt_stdio_c_ftell_FUN_00601560(local_20), lVar7 < local_24) {
    iStack_14 = iStack_14 + 1;
    pcVar8 = crt_stdio_c_fgets_FUN_005fefd0(acStack_460,300,stream);
    if (pcVar8 == (char *)0x0) break;
    pcVar9 = crt_string_c_strstr_FUN_005fedd0(acStack_460,"//");
    pcVar8 = acStack_460;
    if (pcVar9 != (char *)0x0) {
      *pcVar9 = '\0';
    }
    ...
    pcVar9 = (char *)0x0;
joined_r0x005a47dc:
    while ((acStack_460 < pcVar9 &&
           ((g_CharacterClassificationTable[(byte)(pcVar9[-1] + 1)] & 2U) != 0))) {
      pcVar9 = pcVar9 + -1;
    }
    *pcVar9 = '\0';
    while ((g_CharacterClassificationTable[(byte)(acStack_460[0] + 1)] & 2U) != 0) {
      uVar10 = 0xffffffff;
      pcVar8 = acStack_460;
      do {
        if (uVar10 == 0) break;
      ...
      crt_string_c_memmove_FUN_005fe5e0(acStack_460,acStack_460 + 1,~uVar10 - 1);
    }
    if (acStack_460[0] != '\0') {
      ...
      if (iVar6 == 1) {
        if (local_1c != 0) {
          ...
          core_main_c_displayErrorAndQuit_FUN_00506f10
                    ("Reference distance specified in %s on line %d, then again on line %d",acStack_134,local_1c,iStack_14);
        }
        local_1c = iStack_14;
        ...
        if (fVar1 < (float)0.10000000000000001) {
          ...
          core_main_c_displayErrorAndQuit_FUN_00506f10
                    ("Reference volume distance %g is too small in %s line %d!",uStack_474,local_470,acStack_134,iStack_14)
          ;
        }
        if (local_18 == 0) {
        ...
        if (iVar6 == 1) {
          if (local_18 != 0) {
            ...
            core_main_c_displayErrorAndQuit_FUN_00506f10
                      ("Minimum distance specified in %s on line %d, then again on line %d",acStack_134,local_18,iStack_14);
          }
          local_18 = iStack_14;
          ...
          if (fVar1 < (float)0.10000000000000001) {
            ...
            core_main_c_displayErrorAndQuit_FUN_00506f10
                      ("Reference volume distance %g is too small in %s line %d!",uStack_46c,local_468,acStack_134,
                       iStack_14);
          }
        }
        else {
          ...
          if (iVar6 != 1) {
            ...
            if (iVar6 == 1) {
              if (local_1c == 0) {
                ...
                core_main_c_displayErrorAndQuit_FUN_00506f10
                          ("%s specified maxVol on line %d without first specifying reference distance",acStack_134,iStack_14);
              }
              if (local_18 != 0) {
                g_CurrentFilename = "..\\sound\\sndmain.cpp";
              ...
              if (local_464 < (float)0.001) {
                g_CurrentFilename = "..\\sound\\sndmain.cpp";
                local_478 = (uint)((ulonglong)(double)local_464 >> 0x20);
                uStack_47c = SUB84 /* extract 2-byte value */((double)local_464,0);
                g_CurrentLineNumber = 0x2a7;
                core_main_c_displayErrorAndQuit_FUN_00506f10
                          ("maxVol %g is too small in %s line %d!",uStack_47c,local_478,acStack_134,
                           iStack_14);
              }
              (this_ptr->sample_info).reference_volume_distance =
              ...
              if (iVar6 == 1) {
                if (-1 < (this_ptr->sample_info).sample_count) {
                  ...
                  core_main_c_displayErrorAndQuit_FUN_00506f10
                            ("Length for %s already known, then specified again in %s line %d",this_ptr,acStack_134,iStack_14);
                }
                if (local_34 < 1) {
                  g_CurrentLineNumber = 0x2af;
                  g_CurrentFilename = "..\\sound\\sndmain.cpp";
                  core_main_c_displayErrorAndQuit_FUN_00506f10
                            ("Invalid length %d in %s line %d",local_34,acStack_134,iStack_14);
                }
                ...
                if (iVar6 == 0) {
                  ...
                  core_main_c_displayErrorAndQuit_FUN_00506f10
                            ("Error parsing %s line %d: %s",acStack_134,iStack_14,acStack_460);
                }
              }
            }
          }
  ...
  shape_memdbg_cpp_closeFile_FUN_0050f9b0(local_20,"..\\sound\\sndmain.cpp",0x2bf);
  return;
}
