// Name: sound_sndmain.cpp_SfxSample_lock_FUN_005a6430
// Address: 005a6430
// Address Range: [[005a6430, 005a6530]]
// Convention: unknown
// Signature: undefined sound_sndmain.cpp_SfxSample_lock_FUN_005a6430()
// Cross-references:
//   sound_sndmain.cpp_ReadingOrDecodingSoundFile_FUN_005a4c80 (005a4c80) at 005a50ed [UNCONDITIONAL_CALL]
//   sound_sndmain.cpp_SfxSlot_pollStream_FUN_005a6730 (005a6730) at 005a69c2 [UNCONDITIONAL_CALL]
// Globals:
...
/* Signature: undefined1 sound_sndmain.cpp_SfxSample_lock(undefined4 param_1, undefined4 param_2,
   undefined4 param_3) */

int sound_sndmain_cpp_SfxSample_lock_FUN_005a6430(void)

{
  ...
  if (*(int *)(in_stack_00000004 + 0x158) == 0) {
    if (*(int *)(in_stack_00000004 + 0x120) == 0) {
      g_CurrentFilename = "..\\sound\\sndmain.cpp";
    ...
    iVar1 = iVar1 * in_stack_00000008 + *(int *)(in_stack_00000004 + 0x120);
  }
  else {
    if (g_CSoundInstance == (CSound *)0x0) {
      return 0;
    }
    iVar1 = (*(code *)g_CSoundInstance->vtable->field_52)();
  }
  if (iVar1 != 0) {
    *(int *)(in_stack_00000004 + 0x17c) = in_stack_0000000c;
    *(int *)(in_stack_00000004 + 0x178) = in_stack_00000008;
  }
  return iVar1;
}
...
// Assembly code:
// 005a6430: PUSH EBX
//   Label: sound_sndmain.cpp_SfxSample_lock_FUN_005a6430
// 005a6431: PUSH ESI
// 005a6432: PUSH EDI
// 005a6433: PUSH EBP
...
// 005a64b9: PUSH EBX
//   Label: LAB_005a64b9
// 005a64ba: CALL sound_sndmain.cpp_FUN_005a8550
