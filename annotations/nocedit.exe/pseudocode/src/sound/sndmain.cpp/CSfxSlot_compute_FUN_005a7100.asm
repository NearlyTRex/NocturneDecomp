...
;                               FUNCTION
; *****************************************************************************
; __cdecl int sound_sndmain.cpp_CSfxSlot_compute_FUN_005a7100(CSfxSlot * this_ptr, float delta_time)
;
; Parameters:
...
section .text
    ...
    CMP dword ptr [0x03f6940c],0x0      ; 005a710f | int g_SoundLockCount
    JLE 0x005a738a                      ; 005a7116 | LAB_005a738a
        ;   XREF to: 005a738a (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [ESI + 0x78]      ; 005a711c
        ;   Label: LAB_005a711c
    TEST EDI,EDI                        ; 005a711f
    JZ 0x005a73b2                       ; 005a7121 | LAB_005a73b2
    ...
    JNZ 0x005a714d                      ; 005a7136 | LAB_005a714d
        ;   XREF to: 005a714d (CONDITIONAL_JUMP)
    PUSH EDI                            ; 005a7138
    PUSH 0x650266                       ; 005a7139 | = "SFXDBG: sample = %s\n" | s_SFXDBG_sample_s_00650266 = SFXDBG: sample = %s

    MOV EBX,dword ptr [0x0066e8e0]      ; 005a713e | CConsole g_ConsolePtr | CConsole * g_CConsolePtr
    PUSH EBX                            ; 005a7144 | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 005a7145 | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
        ;   XREF to: 00441890 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005a714a
    CMP dword ptr [ESI + 0x74],0x0      ; 005a714d
        ;   Label: LAB_005a714d
    JZ 0x005a73bb                       ; 005a7151 | LAB_005a73bb
        ;   XREF to: 005a73bb (CONDITIONAL_JUMP)
    FLDZ                                ; 005a7157
    FCOMP double ptr [ESI + 0x60]       ; 005a7159
    FNSTSW AX                           ; 005a715c
    SAHF                                ; 005a715e
    JA 0x005a73bb                       ; 005a715f | LAB_005a73bb
        ;   XREF to: 005a73bb (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 005a716c
    SAHF                                ; 005a716e
    JNC 0x005a71c3                      ; 005a716f | LAB_005a71c3
    ...
    FNSTSW AX                           ; 005a717b
    SAHF                                ; 005a717d
    JA 0x005a71c3                       ; 005a717e | LAB_005a71c3
        ;   XREF to: 005a71c3 (CONDITIONAL_JUMP)
    FLD float ptr [ESI + 0x110]         ; 005a7180
    FCOMP float ptr [EBP + 0x18]        ; 005a7186
    FNSTSW AX                           ; 005a7189
    SAHF                                ; 005a718b
    JBE 0x005a73e5                      ; 005a718c | LAB_005a73e5
    ...
    PUSH ESI                            ; 005a71c3
        ;   Label: LAB_005a71c3
    CALL sound_sndmain.cpp_CSfxSlot_updateBoundPositionAndVelocity_FUN_005a6ce0 ; 005a71c4 | void sound_sndmain.cpp_CSfxSlot_updateBoundPositionAndVelocity_FUN_005a6ce0(CSfxSlot * this_ptr)
        ;   XREF to: 005a6ce0 (UNCONDITIONAL_CALL)
    FLD double ptr [ESI + 0x4c]         ; 005a71c9
    ADD ESP,0x4                         ; 005a71cc
    FCOMP double ptr [0x00663138]       ; 005a71cf | double DOUBLE_00663138
    FNSTSW AX                           ; 005a71d5
    SAHF                                ; 005a71d7
    JZ 0x005a73ff                       ; 005a71d8 | LAB_005a73ff
        ;   XREF to: 005a73ff (CONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0x118],0x1     ; 005a71de
        ;   Label: LAB_005a71de
    JNZ 0x005a7203                      ; 005a71e5 | LAB_005a7203
        ;   XREF to: 005a7203 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [ESI + 0x50]      ; 005a71e7
    PUSH EDI                            ; 005a71ea
    MOV EAX,dword ptr [ESI + 0x4c]      ; 005a71eb
    PUSH EAX                            ; 005a71ee
    PUSH 0x6502af                       ; 005a71ef | = "  delayRemaining = %7.2fs\n" | s_delayRemaining_7_2fs_006502af =   delayRemaining = %7.2fs

    MOV EDX,dword ptr [0x0066e8e0]      ; 005a71f4 | CConsole g_ConsolePtr | CConsole * g_CConsolePtr
    PUSH EDX                            ; 005a71fa | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 005a71fb | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
        ;   XREF to: 00441890 (UNCONDITIONAL_CALL)
    ...
    JNZ 0x005a7231                      ; 005a7212 | LAB_005a7231
        ;   XREF to: 005a7231 (CONDITIONAL_JUMP)
    SUB ESP,0x8                         ; 005a7214
    FLD float ptr [ESI + 0x7c]          ; 005a7217
    FSTP double ptr [ESP]               ; 005a721a
    PUSH 0x6502ca                       ; 005a721d | = "  freq = %5.2f\n" | s_freq_5_2f_006502ca =   freq = %5.2f

    MOV EBX,dword ptr [0x0066e8e0]      ; 005a7222 | CConsole g_ConsolePtr | CConsole * g_CConsolePtr
    PUSH EBX                            ; 005a7228 | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 005a7229 | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
        ;   XREF to: 00441890 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 005a722e
    TEST byte ptr [ESI + 0x5c],0x1      ; 005a7231
        ;   Label: LAB_005a7231
    JZ 0x005a742a                       ; 005a7235 | LAB_005a742a
        ;   XREF to: 005a742a (CONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0x118],0x1     ; 005a723b
    JNZ 0x005a7258                      ; 005a7242 | LAB_005a7258
        ;   XREF to: 005a7258 (CONDITIONAL_JUMP)
    PUSH 0x650320                       ; 005a7244 | = "  non spatialized\n" | s_non_spatialized_00650320 =   non spatialized

    MOV ECX,dword ptr [0x0066e8e0]      ; 005a7249 | CConsole g_ConsolePtr | CConsole * g_CConsolePtr
    PUSH ECX                            ; 005a724f | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 005a7250 | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
        ;   XREF to: 00441890 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005a7255
    PUSH ESI                            ; 005a7258
        ;   Label: LAB_005a7258
    CALL sound_sndmain.cpp_CSfxSlot_computeDistancesToSpeakers_FUN_005a6d80 ; 005a7259 | int sound_sndmain.cpp_CSfxSlot_computeDistancesToSpeakers_FUN_005a6d80(CSfxSlot * this_ptr)
        ;   XREF to: 005a6d80 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005a725e
    PUSH ESI                            ; 005a7261
    CALL sound_sndmain.cpp_CSfxSlot_computeChannelDelays_FUN_005a6df0 ; 005a7262 | void sound_sndmain.cpp_CSfxSlot_computeChannelDelays_FUN_005a6df0(CSfxSlot * this_ptr)
        ;   XREF to: 005a6df0 (UNCONDITIONAL_CALL)
    MOV EBX,dword ptr [ESI + 0x118]     ; 005a7267
    ADD ESP,0x4                         ; 005a726d
    CMP EBX,0x1                         ; 005a7270
    JNZ 0x005a7292                      ; 005a7273 | LAB_005a7292
        ;   XREF to: 005a7292 (CONDITIONAL_JUMP)
    SUB ESP,0x8                         ; 005a7275
    FLD float ptr [ESI + 0x44]          ; 005a7278
    FSTP double ptr [ESP]               ; 005a727b
    PUSH 0x650333                       ; 005a727e | = "  vol = %5.2f\n" | s_vol_5_2f_00650333 =   vol = %5.2f

    MOV EDI,dword ptr [0x0066e8e0]      ; 005a7283 | CConsole * g_CConsolePtr
    PUSH EDI                            ; 005a7289 | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 005a728a | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
        ;   XREF to: 00441890 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 005a728f
    PUSH ESI                            ; 005a7292
        ;   Label: LAB_005a7292
    CALL sound_sndmain.cpp_CSfxSlot_computeChannelVolumes_FUN_005a6f00 ; 005a7293 | float sound_sndmain.cpp_CSfxSlot_computeChannelVolumes_FUN_005a6f00(CSfxSlot * this_ptr)
        ;   XREF to: 005a6f00 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [ESI + 0x118]     ; 005a7298
    ADD ESP,0x4                         ; 005a729e
    CMP EAX,0x1                         ; 005a72a1
    JNZ 0x005a7300                      ; 005a72a4 | LAB_005a7300
        ;   XREF to: 005a7300 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x00681b18]      ; 005a72a6 | int g_AudioChannelCount
    XOR EBX,EBX                         ; 005a72ac
    TEST EDX,EDX                        ; 005a72ae
    JLE 0x005a7300                      ; 005a72b0 | LAB_005a7300
        ;   XREF to: 005a7300 (CONDITIONAL_JUMP)
    ...
    PUSH EBX                            ; 005a72d9
    PUSH 0x650342                       ; 005a72da | = "  channelVol[%d] = %5.2f\n" | s_channelVol_d_5_2f_00650342 =   channelVol[%d] = %5.2f

    MOV EAX,[0x0066e8e0]                ; 005a72df | CConsole g_ConsolePtr | CConsole * g_CConsolePtr
    PUSH EAX                            ; 005a72e4 | CConsole g_ConsolePtr
    ADD EDI,0x4                         ; 005a72e5
    INC EBX                             ; 005a72e8
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 005a72e9 | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
        ;   XREF to: 00441890 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [0x00681b18]      ; 005a72ee | int g_AudioChannelCount
    ADD ESP,0x14                        ; 005a72f4
    CMP EBX,EDX                         ; 005a72f7
    JL 0x005a72b4                       ; 005a72f9 | LAB_005a72b4
    ...
    FLD float ptr [ESI + 0x7c]          ; 005a7300
        ;   Label: LAB_005a7300
    FLD1                                ; 005a7303
    FDIV double ptr [0x00663150]        ; 005a7305 | double DOUBLE_00663150
    FSTP double ptr [ESP + 0x50]        ; 005a730b
    FCOMP double ptr [ESP + 0x50]       ; 005a730f
    FNSTSW AX                           ; 005a7313
    SAHF                                ; 005a7315
    JNC 0x005a731f                      ; 005a7316 | LAB_005a731f
    ...
    FLD float ptr [ESI + 0x7c]          ; 005a731f
        ;   Label: LAB_005a731f
    FCOMP double ptr [0x00663150]       ; 005a7322 | double DOUBLE_00663150
    FNSTSW AX                           ; 005a7328
    SAHF                                ; 005a732a
    JBE 0x005a7336                      ; 005a732b | LAB_005a7336
        ;   XREF to: 005a7336 (CONDITIONAL_JUMP)
    FLD double ptr [0x00663150]         ; 005a732d | double DOUBLE_00663150
    FSTP float ptr [ESI + 0x7c]         ; 005a7333
    CMP dword ptr [ESI + 0x118],0x1     ; 005a7336
        ;   Label: LAB_005a7336
    JNZ 0x005a735c                      ; 005a733d | LAB_005a735c
        ;   XREF to: 005a735c (CONDITIONAL_JUMP)
    SUB ESP,0x8                         ; 005a733f
    FLD float ptr [ESI + 0x7c]          ; 005a7342
    FSTP double ptr [ESP]               ; 005a7345
    PUSH 0x65035c                       ; 005a7348 | = "  effFreq = %5.2f\n" | s_effFreq_5_2f_0065035c =   effFreq = %5.2f

    MOV EBX,dword ptr [0x0066e8e0]      ; 005a734d | CConsole g_ConsolePtr | CConsole * g_CConsolePtr
    PUSH EBX                            ; 005a7353 | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 005a7354 | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
        ;   XREF to: 00441890 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 005a7359
    MOV EDI,dword ptr [ESP + 0x60]      ; 005a735c
        ;   Label: LAB_005a735c
    TEST EDI,EDI                        ; 005a7360
    JZ 0x005a737e                       ; 005a7362 | LAB_005a737e
        ;   XREF to: 005a737e (CONDITIONAL_JUMP)
    MOV EAX,[0x03f69268]                ; 005a7364 | CSoundDevice * g_CSoundDevicePtr
    TEST EAX,EAX                        ; 005a7369
    JZ 0x005a737e                       ; 005a736b | LAB_005a737e
        ;   XREF to: 005a737e (CONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0x70],0x0      ; 005a736d
    JZ 0x005a737e                       ; 005a7371 | LAB_005a737e
        ;   XREF to: 005a737e (CONDITIONAL_JUMP)
    PUSH EDI                            ; 005a7373
    PUSH ESI                            ; 005a7374
    ...
    POP EBX                             ; 005a7388
    RET                                 ; 005a7389
    MOV ECX,0x65022e                    ; 005a738a | = "..\\sound\\sndmain.cpp" | s_sound_sndmain_cpp_0065022e = ..\sound\sndmain.cpp
        ;   Label: LAB_005a738a
    MOV EBX,0x96a                       ; 005a738f
    PUSH 0x650243                       ; 005a7394 | = "SfxSlot::compute - must be locked!" | s_SfxSlot_compute_must_be__00650243 = SfxSlot::compute - must be locked!
    MOV dword ptr [0x02f0ca48],ECX      ; 005a7399 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 005a739f | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005a73a5 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005a73aa
    JMP 0x005a711c                      ; 005a73ad | LAB_005a711c
    ...
    MOV ECX,dword ptr [ESI + 0x78]      ; 005a73bb
        ;   Label: LAB_005a73bb
    PUSH ECX                            ; 005a73be
    PUSH 0x65027b                       ; 005a73bf | = "Killing %s in compute()\n" | s_Killing_s_in_compute_0065027b = Killing %s in compute()

    MOV EBX,dword ptr [0x0066e8e0]      ; 005a73c4 | CConsole g_ConsolePtr | CConsole * g_CConsolePtr
    PUSH EBX                            ; 005a73ca | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 005a73cb | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
        ;   XREF to: 00441890 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005a73d0
    PUSH ESI                            ; 005a73d3
        ;   Label: LAB_005a73d3
    CALL sound_sndmain.cpp_CSfxSlot_kill_FUN_005a7e60 ; 005a73d4 | void sound_sndmain.cpp_CSfxSlot_kill_FUN_005a7e60(CSfxSlot * slot)
    ...
    TEST dword ptr [ESI + 0x114],0x7fffffff ; 005a73e5
        ;   Label: LAB_005a73e5
    JNZ 0x005a73d3                      ; 005a73ef | LAB_005a73d3
        ;   XREF to: 005a73d3 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESI + 0x10c]     ; 005a73f1
    MOV dword ptr [ESI + 0x44],EAX      ; 005a73f7
    JMP 0x005a71be                      ; 005a73fa | LAB_005a71be
        ;   XREF to: 005a71be (UNCONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0x118],0x1     ; 005a73ff
        ;   Label: LAB_005a73ff
    JNZ 0x005a741c                      ; 005a7406 | LAB_005a741c
        ;   XREF to: 005a741c (CONDITIONAL_JUMP)
    PUSH 0x650294                       ; 005a7408 | = "  auto computing delay...\n" | s_auto_computing_delay_00650294 =   auto computing delay...

    MOV ECX,dword ptr [0x0066e8e0]      ; 005a740d | CConsole g_ConsolePtr | CConsole * g_CConsolePtr
    PUSH ECX                            ; 005a7413 | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 005a7414 | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
        ;   XREF to: 00441890 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005a7419
    PUSH ESI                            ; 005a741c
        ;   Label: LAB_005a741c
    CALL sound_sndmain.cpp_CSfxSlot_autoCalcDelayRemaining_FUN_005a7070 ; 005a741d | void sound_sndmain.cpp_CSfxSlot_autoCalcDelayRemaining_FUN_005a7070(CSfxSlot * this_ptr)
        ;   XREF to: 005a7070 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005a7422
    JMP 0x005a71de                      ; 005a7425 | LAB_005a71de
        ;   XREF to: 005a71de (UNCONDITIONAL_JUMP)
    FLD double ptr [ESI + 0xc]          ; 005a742a
        ;   Label: LAB_005a742a
    FLD double ptr [ESI + 0x4]          ; 005a742d
    FSUB double ptr [0x03f68830]        ; 005a7430 | CVector3d g_Cached3DListenerPos
    FXCH                                ; 005a7436
    ...
    JNZ 0x005a7498                      ; 005a7478 | LAB_005a7498
        ;   XREF to: 005a7498 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x44]      ; 005a747a
    PUSH EAX                            ; 005a747e
    MOV EDX,dword ptr [ESP + 0x44]      ; 005a747f
    PUSH EDX                            ; 005a7483
    PUSH 0x6502da                       ; 005a7484 | = "  distToEar = %7.2fs\n" | s_distToEar_7_2fs_006502da =   distToEar = %7.2fs

    MOV ECX,dword ptr [0x0066e8e0]      ; 005a7489 | CConsole g_ConsolePtr | CConsole * g_CConsolePtr
    PUSH ECX                            ; 005a748f | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 005a7490 | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
        ;   XREF to: 00441890 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 005a7495
    FLDZ                                ; 005a7498
        ;   Label: LAB_005a7498
    FLD double ptr [0x03f68848]         ; 005a749a | CVector3d g_Cached3DListenerVelocity
    ...
    FNSTSW AX                           ; 005a74ce
    SAHF                                ; 005a74d0
    JNC 0x005a75c2                      ; 005a74d1 | LAB_005a75c2
    ...
    FMUL double ptr [0x00681b30]        ; 005a74fe | double DOUBLE_00681b30
    FLD double ptr [0x00663140]         ; 005a7504 | double DOUBLE_00663140
    FXCH                                ; 005a750a
    ...
    JNZ 0x005a753d                      ; 005a751d | LAB_005a753d
        ;   XREF to: 005a753d (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [ESP + 0x1c]      ; 005a751f
    PUSH EDI                            ; 005a7523
    MOV EAX,dword ptr [ESP + 0x1c]      ; 005a7524
    PUSH EAX                            ; 005a7528
    PUSH 0x6502f0                       ; 005a7529 | = "  doppler = %5.2f\n" | s_doppler_5_2f_006502f0 =   doppler = %5.2f

    MOV EDX,dword ptr [0x0066e8e0]      ; 005a752e | CConsole g_ConsolePtr | CConsole * g_CConsolePtr
    PUSH EDX                            ; 005a7534 | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 005a7535 | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
        ;   XREF to: 00441890 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 005a753a
    FLD1                                ; 005a753d
        ;   Label: LAB_005a753d
    FDIV double ptr [0x00663148]        ; 005a753f | double DOUBLE_00663148
    ...
    FNSTSW AX                           ; 005a7553
    SAHF                                ; 005a7555
    JNC 0x005a7568                      ; 005a7556 | LAB_005a7568
    ...
    FLD double ptr [ESP + 0x18]         ; 005a7568
        ;   Label: LAB_005a7568
    FCOMP double ptr [0x00663148]       ; 005a756c | double DOUBLE_00663148
    FNSTSW AX                           ; 005a7572
    SAHF                                ; 005a7574
    JBE 0x005a7589                      ; 005a7575 | LAB_005a7589
        ;   XREF to: 005a7589 (CONDITIONAL_JUMP)
    MOV EAX,[0x00663148]                ; 005a7577 | double DOUBLE_00663148
    ...
    CMP dword ptr [ESI + 0x118],0x1     ; 005a7589
        ;   Label: LAB_005a7589
    JNZ 0x005a75af                      ; 005a7590 | LAB_005a75af
        ;   XREF to: 005a75af (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [ESP + 0x1c]      ; 005a7592
    PUSH EBX                            ; 005a7596
    MOV EDI,dword ptr [ESP + 0x1c]      ; 005a7597
    PUSH EDI                            ; 005a759b
    PUSH 0x650303                       ; 005a759c | = "  doppler (clamped) = %5.2f\n" | s_doppler_clamped_5_2f_00650303 =   doppler (clamped) = %5.2f

    MOV EAX,[0x0066e8e0]                ; 005a75a1 | CConsole g_ConsolePtr | CConsole * g_CConsolePtr
    PUSH EAX                            ; 005a75a6 | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 005a75a7 | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
        ;   XREF to: 00441890 (UNCONDITIONAL_CALL)
    ...
    JMP 0x005a7258                      ; 005a75bd | LAB_005a7258
    ...
    FADDP                               ; 005a75d5
    FSQRT                               ; 005a75d7
    JMP 0x005a74f6                      ; 005a75d9 | LAB_005a74f6
