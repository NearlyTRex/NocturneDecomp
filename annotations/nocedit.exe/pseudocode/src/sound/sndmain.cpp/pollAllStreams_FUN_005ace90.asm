...
section .text
    ...
    CALL sound_sndmain.cpp_lockSound_FUN_005abd30 ; 005ace9b
        ;   XREF to: 005abd30 (UNCONDITIONAL_CALL)  ; void sound_sndmain.cpp_lockSound_FUN_005abd30()
    FLD float ptr [0x00663164]          ; 005acea0 | FLOAT_00663164
    MOV EDX,dword ptr [EBP + 0x10]      ; 005acea6
    FST double ptr [ESP]                ; 005acea9
    FLD ST0                             ; 005aceac
    FADD double ptr [0x00651097]        ; 005aceae | DOUBLE_00651097
    FXCH                                ; 005aceb4
    FADD double ptr [0x0065109f]        ; 005aceb6 | DOUBLE_0065109f
    FXCH                                ; 005acebc
    FSTP float ptr [ESP + 0xc]          ; 005acebe
    FSTP float ptr [ESP + 0x8]          ; 005acec2
    TEST EDX,EDX                        ; 005acec6
    JNZ 0x005acefb                      ; 005acec8
        ;   XREF to: 005acefb (CONDITIONAL_JUMP)  ; LAB_005acefb
    MOV EBX,0x3f6282c                   ; 005aceca | g_SfxSamples
        ;   Label: LAB_005aceca
    LEA ESI,[EBX + 0x6000]              ; 005acecf | g_SfxSamplesEnd
    ...
    JNZ 0x005aced5                      ; 005aceee
        ;   XREF to: 005aced5 (CONDITIONAL_JUMP)  ; LAB_005aced5
    CALL sound_sndmain.cpp_unlockSound_FUN_005abdc0 ; 005acef0
    ...
    FLD double ptr [ESP]                ; 005acefb
        ;   Label: LAB_005acefb
    MOV EBX,dword ptr [0x00663164]      ; 005acefe | FLOAT_00663164
    FADD double ptr [0x006510a7]        ; 005acf04 | DOUBLE_006510a7
    MOV dword ptr [ESP + 0x8],EBX       ; 005acf0a
    FSTP float ptr [ESP + 0xc]          ; 005acf0e
    JMP 0x005aceca                      ; 005acf12
        ;   XREF to: 005aceca (UNCONDITIONAL_JUMP)  ; LAB_005aceca
