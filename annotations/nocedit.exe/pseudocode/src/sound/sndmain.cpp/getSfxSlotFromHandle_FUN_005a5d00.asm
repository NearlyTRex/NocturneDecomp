...
;                               FUNCTION
; *****************************************************************************
; __cdecl CSfxSlot * __cdecl sound_sndmain_cpp_getSfxSlotFromHandle_FUN_005a5d00(uint sfx_handle,int check_hardware_playback)
;
; Parameters:
...
section .text
    ...
    POP EBX                             ; 005a5d50
    RET                                 ; 005a5d51
    CALL sound_sndmain.cpp_lockSound_FUN_005abd30 ; 005a5d52
    ...
    JZ 0x005a5d8f                       ; 005a5d70
        ;   XREF to: 005a5d8f (CONDITIONAL_JUMP)  ; LAB_005a5d8f
    PUSH EBX                            ; 005a5d72
    ...
    JZ 0x005a5d8f                       ; 005a5d7e
        ;   XREF to: 005a5d8f (CONDITIONAL_JUMP)  ; LAB_005a5d8f
    MOV EAX,EBX                         ; 005a5d80
    POP ESI                             ; 005a5d82
    POP EBX                             ; 005a5d83
    RET                                 ; 005a5d84
    CALL sound_sndmain.cpp_unlockSound_FUN_005abdc0 ; 005a5d85
