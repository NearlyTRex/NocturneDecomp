...
section .text
    ...
    JL 0x005a8b15                       ; 005a8af7 | LAB_005a8b15
        ;   XREF to: 005a8b15 (CONDITIONAL_JUMP)
    CMP EBX,0x20                        ; 005a8af9
    JGE 0x005a8b15                      ; 005a8afc | LAB_005a8b15
        ;   XREF to: 005a8b15 (CONDITIONAL_JUMP)
    MOV EAX,[0x03f624a4]                ; 005a8afe | int g_SfxLastSlot
        ;   Label: LAB_005a8afe
    SHL EAX,0x4                         ; 005a8b03
    MOV EDX,EAX                         ; 005a8b06
    SHL EAX,0x3                         ; 005a8b08
    SUB EAX,EDX                         ; 005a8b0b
    MOV dword ptr [EAX + 0x3f624a8],EBX ; 005a8b0d | CSfxOptions[8] g_SfxOptions
    POP EBX                             ; 005a8b13
    RET                                 ; 005a8b14
    PUSH EBX                            ; 005a8b15
        ;   Label: LAB_005a8b15
    MOV EDX,0x650858                    ; 005a8b16 | = "..\\sound\\sndmain.cpp" | s_sound_sndmain_cpp_00650858 = ..\sound\sndmain.cpp
    MOV ECX,0xcf8                       ; 005a8b1b
    PUSH 0x65086d                       ; 005a8b20 | = "setNextSfxChannel - invalid channel i..." | s_setNextSfxChannel_invali_0065086d = setNextSfxChannel - invalid channel index: %d
    MOV dword ptr [0x02f0ca48],EDX      ; 005a8b25 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 005a8b2b | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005a8b31 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005a8b36
    JMP 0x005a8afe                      ; 005a8b39 | LAB_005a8afe
