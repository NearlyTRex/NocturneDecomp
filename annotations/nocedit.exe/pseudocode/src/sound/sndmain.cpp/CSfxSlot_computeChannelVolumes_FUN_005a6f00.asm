...
;                               FUNCTION
; *****************************************************************************
; __cdecl float sound_sndmain.cpp_CSfxSlot_computeChannelVolumes_FUN_005a6f00(CSfxSlot * this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV ESI,dword ptr [0x00681b18]      ; 005a6f0c | int g_AudioChannelCount
    MOV EBX,dword ptr [EBP + 0x14]      ; 005a6f12
    CMP dword ptr [0x03f6940c],0x0      ; 005a6f15 | int g_SoundLockCount
    JLE 0x005a6f9d                      ; 005a6f1c | LAB_005a6f9d
    ...
    CALL sound_sndmain.cpp_getSfxChannelVol_FUN_005a9d90 ; 005a6f42 | float sound_sndmain.cpp_getSfxChannelVol_FUN_005a9d90(int channel_index)
    ...
    JZ 0x005a6fc5                       ; 005a6f63 | LAB_005a6fc5
        ;   XREF to: 005a6fc5 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [0x00681b18]      ; 005a6f65 | int g_AudioChannelCount
    XOR EDX,EDX                         ; 005a6f6b
    TEST ESI,ESI                        ; 005a6f6d
    JLE 0x005a6f90                      ; 005a6f6f | LAB_005a6f90
    ...
    JL 0x005a6f75                       ; 005a6f81 | LAB_005a6f75
        ;   XREF to: 005a6f75 (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 005a6f83
    LEA EDX,[EDX]                       ; 005a6f89
    NOP                                 ; 005a6f8f
    MOV dword ptr [0x00681b18],ESI      ; 005a6f90 | int g_AudioChannelCount
        ;   Label: LAB_005a6f90
    ...
    POP EBX                             ; 005a6f9b
    RET                                 ; 005a6f9c
    MOV ECX,0x6501a3                    ; 005a6f9d | = "..\\sound\\sndmain.cpp" | s_sound_sndmain_cpp_006501a3 = ..\sound\sndmain.cpp
        ;   Label: LAB_005a6f9d
    MOV EDI,0x924                       ; 005a6fa2
    PUSH 0x6501b8                       ; 005a6fa7 | = "SfxSlot::kill - must be locked!" | s_SfxSlot_kill_must_be_loc_006501b8 = SfxSlot::kill - must be locked!
    MOV dword ptr [0x02f0ca48],ECX      ; 005a6fac | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 005a6fb2 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005a6fb8 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005a6fbd
    JMP 0x005a6f22                      ; 005a6fc0 | LAB_005a6f22
        ;   XREF to: 005a6f22 (UNCONDITIONAL_JUMP)
    MOV ESI,dword ptr [0x00681b18]      ; 005a6fc5 | int g_AudioChannelCount
        ;   Label: LAB_005a6fc5
    XOR ECX,ECX                         ; 005a6fcb
    TEST ESI,ESI                        ; 005a6fcd
    JLE 0x005a6f90                      ; 005a6fcf | LAB_005a6f90
        ;   XREF to: 005a6f90 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 005a7006
    SAHF                                ; 005a7008
    JC 0x005a7052                       ; 005a7009 | LAB_005a7052
    ...
    FNSTSW AX                           ; 005a7012
    SAHF                                ; 005a7014
    JBE 0x005a701e                      ; 005a7015 | LAB_005a701e
    ...
    FLD float ptr [ESP + 0x4]           ; 005a701e
        ;   Label: LAB_005a701e
    FMUL double ptr [0x006501df]        ; 005a7022 | double DOUBLE_006501df
    FLD float ptr [ESP]                 ; 005a7028
    FCOMPP                              ; 005a702b
    FNSTSW AX                           ; 005a702d
    SAHF                                ; 005a702f
    JA 0x005a705b                       ; 005a7030 | LAB_005a705b
    ...
    JGE 0x005a6f90                      ; 005a704a | LAB_005a6f90
        ;   XREF to: 005a6f90 (CONDITIONAL_JUMP)
    JMP 0x005a6fd8                      ; 005a7050 | LAB_005a6fd8
        ;   XREF to: 005a6fd8 (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x18]      ; 005a7052
        ;   Label: LAB_005a7052
    MOV dword ptr [ESP],EAX             ; 005a7056
    JMP 0x005a700b                      ; 005a7059 | LAB_005a700b
    ...
    JMP 0x005a7036                      ; 005a7066 | LAB_005a7036
