...
section .text
    ...
    CMP dword ptr [EBX*0x4 + 0x3f692b0],0x0 ; 005ac9a5 | void *[8] g_ChannelPrimaryBuffers
    JNZ 0x005aca72                      ; 005ac9ad | LAB_005aca72
        ;   XREF to: 005aca72 (CONDITIONAL_JUMP)
    TEST EDI,EDI                        ; 005ac9b3
        ;   Label: LAB_005ac9b3
    JZ 0x005ac9bd                       ; 005ac9b5 | LAB_005ac9bd
        ;   XREF to: 005ac9bd (CONDITIONAL_JUMP)
    MOV dword ptr [EDI],0x0             ; 005ac9b7
    TEST ESI,ESI                        ; 005ac9bd
        ;   Label: LAB_005ac9bd
    JZ 0x005ac9c7                       ; 005ac9bf | LAB_005ac9c7
        ;   XREF to: 005ac9c7 (CONDITIONAL_JUMP)
    MOV dword ptr [ESI],0x0             ; 005ac9c1
    XOR EAX,EAX                         ; 005ac9c7
        ;   Label: LAB_005ac9c7
    MOV EBX,dword ptr [EBX*0x4 + 0x3f692b0] ; 005ac9c9 | void *[8] g_ChannelPrimaryBuffers
    MOV dword ptr [ESP],EAX             ; 005ac9d0
    MOV dword ptr [ESP + 0x4],EAX       ; 005ac9d3
    CALL sound_sndmain.cpp_lockSound_FUN_005abd30 ; 005ac9d7 | void sound_sndmain.cpp_lockSound_FUN_005abd30()
        ;   XREF to: 005abd30 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [0x03f69280]      ; 005ac9dc | int g_MixBufferSize
    XOR EDX,EDX                         ; 005ac9e2
    TEST ECX,ECX                        ; 005ac9e4
    JLE 0x005aca20                      ; 005ac9e6 | LAB_005aca20
    ...
    FNSTSW AX                           ; 005aca09
    SAHF                                ; 005aca0b
    JBE 0x005aca16                      ; 005aca0c | LAB_005aca16
        ;   XREF to: 005aca16 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x8]       ; 005aca0e
    MOV dword ptr [ESP + 0x4],EAX       ; 005aca12
    MOV EAX,[0x03f69280]                ; 005aca16 | int g_MixBufferSize
        ;   Label: LAB_005aca16
    INC EDX                             ; 005aca1b
    CMP EDX,EAX                         ; 005aca1c
    JL 0x005ac9e8                       ; 005aca1e | LAB_005ac9e8
        ;   XREF to: 005ac9e8 (CONDITIONAL_JUMP)
    CALL sound_sndmain.cpp_unlockSound_FUN_005abdc0 ; 005aca20 | void sound_sndmain.cpp_unlockSound_FUN_005abdc0()
        ;   Label: LAB_005aca20
        ;   XREF to: 005abdc0 (UNCONDITIONAL_CALL)
    FILD dword ptr [0x03f69280]         ; 005aca25 | int g_MixBufferSize
    ...
    FNSTSW AX                           ; 005aca3d
    SAHF                                ; 005aca3f
    JNC 0x005aca4a                      ; 005aca40 | LAB_005aca4a
    ...
    POP EBX                             ; 005aca70
    RET                                 ; 005aca71
    CMP dword ptr [0x03f69280],0x1      ; 005aca72 | int g_MixBufferSize
        ;   Label: LAB_005aca72
    JL 0x005ac9b3                       ; 005aca79 | LAB_005ac9b3
        ;   XREF to: 005ac9b3 (CONDITIONAL_JUMP)
    JMP 0x005ac9c7                      ; 005aca7f | LAB_005ac9c7
