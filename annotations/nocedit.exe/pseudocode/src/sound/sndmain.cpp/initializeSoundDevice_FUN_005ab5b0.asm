...
;                               FUNCTION
; *****************************************************************************
; __cdecl int sound_sndmain.cpp_initializeSoundDevice_FUN_005ab5b0(void)
;
;
; XREF[2]:
...
section .text
    ...
    CALL sound_sndmain.cpp_closeSoundDevice_FUN_005ab660 ; 005ab5b1 | int sound_sndmain.cpp_closeSoundDevice_FUN_005ab660()
        ;   XREF to: 005ab660 (UNCONDITIONAL_CALL)
    TEST EAX,EAX                        ; 005ab5b6
    JNZ 0x005ab5bc                      ; 005ab5b8 | LAB_005ab5bc
        ;   XREF to: 005ab5bc (CONDITIONAL_JUMP)
    POP EBP                             ; 005ab5ba
    RET                                 ; 005ab5bb
    MOV EDX,dword ptr [0x00681b24]      ; 005ab5bc | int g_CurrentSoundDevice
        ;   Label: LAB_005ab5bc
    PUSH EDX                            ; 005ab5c2
    CALL sound_sndmain.cpp_selectSoundDevice_FUN_005ab4c0 ; 005ab5c3 | void sound_sndmain.cpp_selectSoundDevice_FUN_005ab4c0(int device_id)
        ;   XREF to: 005ab4c0 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [0x00681b24]      ; 005ab5c8 | int g_CurrentSoundDevice
    ADD ESP,0x4                         ; 005ab5ce
    TEST ECX,ECX                        ; 005ab5d1
    JL 0x005ab644                       ; 005ab5d3 | LAB_005ab644
    ...
    JNZ 0x005ab605                      ; 005ab5ed | LAB_005ab605
        ;   XREF to: 005ab605 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 005ab5ef
    MOV ESI,dword ptr [EAX + 0x3f68aac] ; 005ab5f0 | DAT_03f68994
    PUSH ESI                            ; 005ab5f6
    CALL sound_sndwav.cpp_getWavOutDevice_FUN_005b1510 ; 005ab5f7 | CWavOutDevice * sound_sndwav.cpp_getWavOutDevice_FUN_005b1510(UINT device_id)
        ;   XREF to: 005b1510 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005ab5fc
    MOV [0x03f69268],EAX                ; 005ab5ff | CSoundDevice * g_CSoundDevicePtr
    POP ESI                             ; 005ab604
    MOV EDX,dword ptr [0x00681b24]      ; 005ab605 | int g_CurrentSoundDevice
        ;   Label: LAB_005ab605
    ...
    JNZ 0x005ab639                      ; 005ab623 | LAB_005ab639
        ;   XREF to: 005ab639 (CONDITIONAL_JUMP)
    MOV EBP,dword ptr [EAX + 0x3f68aac] ; 005ab625 | DAT_03f68994
    PUSH EBP                            ; 005ab62b
    CALL sound_snddx.cpp_getDirectSoundDevice_FUN_005b0440 ; 005ab62c | CDirectSoundDevice * sound_snddx.cpp_getDirectSoundDevice_FUN_005b0440(UINT device_id)
        ;   XREF to: 005b0440 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005ab631
    MOV [0x03f69268],EAX                ; 005ab634 | CSoundDevice * g_CSoundDevicePtr
    MOV EAX,[0x03f69268]                ; 005ab639 | CSoundDevice * g_CSoundDevicePtr
        ;   Label: LAB_005ab639
    TEST EAX,EAX                        ; 005ab63e
    JNZ 0x005ab648                      ; 005ab640 | LAB_005ab648
    ...
    MOV [0x03f69270],EAX                ; 005ab651 | int g_HasHardware3DSound
