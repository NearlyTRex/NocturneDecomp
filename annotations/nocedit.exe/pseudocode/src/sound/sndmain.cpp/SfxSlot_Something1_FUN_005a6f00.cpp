// Name: sound_sndmain.cpp_SfxSlot_Something1_FUN_005a6f00
// Address: 005a6f00
// Address Range: [[005a6f00, 005a7067]]
// Convention: unknown
// Signature: undefined sound_sndmain.cpp_SfxSlot_Something1_FUN_005a6f00()
// Cross-references:
//   sound_sndmain.cpp_ComputingDelay_FUN_005a7100 (005a7100) at 005a7293 [UNCONDITIONAL_CALL]
// Globals:
//   TerminatedCString s_sound_sndmain_cpp_006501a3
//   TerminatedCString s_SfxSlot_kill_must_be_loc_006501b8
//   undefined4 DAT_006501df
...
/* Signature: undefined1 sound_sndmain.cpp_SfxSlot_Something1(undefined4 param_1) */

float sound_sndmain_cpp_SfxSlot_Something1_FUN_005a6f00(void)

{
  ...
  fVar2 = (float)sound_sndmain_cpp_getSfxChannelVol_FUN_005a9d90();
  fVar1 = (fVar2 * *(float *)(in_stack_00000004 + 0x44)) / local_20;
  fVar2 = (float)(uint)CONCAT11(*(byte *)(in_stack_00000004 + 0x5c),SUB41(fVar2,0));
  if ((*(byte *)(in_stack_00000004 + 0x5c) & 1) == 0) {
    iVar3 = 0;
    iVar4 = in_stack_00000004;
    if (0 < g_AudioChannels) {
      do {
        local_28 = *(float *)(iVar4 + 0x80);
        if (*(float *)(iVar4 + 0x80) < *(float *)(in_stack_00000004 + 0x104)) {
          local_28 = *(float *)(in_stack_00000004 + 0x104);
        }
        if (*(float *)(in_stack_00000004 + 0x108) < local_28) {
          local_28 = *(float *)(in_stack_00000004 + 0x108);
        }
        fVar2 = *(float *)(in_stack_00000004 + 0x100) * (float)_DAT_006501df;
        if (local_28 < fVar2 || (local_28 == fVar2) != 0) {
          local_18 = 20.0;
        }
        else {
          local_18 = *(float *)(in_stack_00000004 + 0x100) / local_28;
        }
        iVar3 = iVar3 + 1;
        *(float *)(iVar4 + 0xa0) = fVar1 * local_18;
        fVar2 = (float)(uint)(ushort)((ushort)(local_28 < fVar2) << 8 |
    ...
    if (0 < g_AudioChannels) {
      do {
        iVar4 = iVar4 + 1;
        *(float *)(in_stack_00000004 + 0xa0) = fVar1;
        fVar2 = fVar1;
...
// Assembly code:
// 005a6f00: PUSH EBX
//   Label: sound_sndmain.cpp_SfxSlot_Something1_FUN_005a6f00
// 005a6f01: PUSH ESI
// 005a6f02: PUSH EDI
// 005a6f03: PUSH EBP
