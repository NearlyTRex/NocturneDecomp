...
;                               FUNCTION
; *****************************************************************************
; __cdecl int sound_sndmain.cpp_getSfxSampleInfo_FUN_005a96e0(uint sfx_handle, CSfxSample * output_buffer)
;
; Parameters:
...
;
; XREF[3]:
;   core_event.cpp_CEventList_FUN_004b0db0 at 004b0e8e
...
section .text
    ...
    PUSH EDX                            ; 005a96e6
    CALL sound_sndmain.cpp_getSfxSlotFromHandle_FUN_005a5d00 ; 005a96e7 | CSfxSlot * sound_sndmain.cpp_getSfxSlotFromHandle_FUN_005a5d00(uint sfx_handle, int check_hardware_playback)
        ;   XREF to: 005a5d00 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005a96ec
    TEST EAX,EAX                        ; 005a96ef
    JNZ 0x005a96f4                      ; 005a96f1 | LAB_005a96f4
    ...
    CALL sound_sndmain.cpp_unlockSound_FUN_005abdc0 ; 005a9704 | void sound_sndmain.cpp_unlockSound_FUN_005abdc0()
