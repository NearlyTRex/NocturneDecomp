...

{
  ...
  if (this_ptr->playback_state != 0) {
    ...
    while (((iVar9 = mix_buffer.num_output_samples, this_ptr->playback_state != 0 &&
      ...
      uVar16 = *(undefined4 *)&this_ptr->prev_hardware_playback_pos;
      uVar17 = *(undefined4 *)((int)&this_ptr->prev_hardware_playback_pos + 4);
      local_50 = 0;
      dVar14 = crt_math_c_floor_FUN_005feb90((double)in_ST0);
      in_ST0 = (float10)dVar14;
      fVar13 = (float10)(double)CONCAT44(extraout_EDX_00,extraout_EAX_00);
      crt_math_c_round_FUN_005fe6b0((double)CONCAT44(extraout_EDX_00,extraout_EAX_00));
      dVar14 = (double)CONCAT44(uVar17,uVar16);
      local_44 = (int)ROUND(fVar13);
      if (local_44 < 1) {
        dVar14 = (double)CONCAT44(uVar17,uVar16) - dVar5;
        if (dVar14 < 0.0) {
          dVar14 = 0.0;
        }
        dVar15 = crt_math_c_floor_FUN_005feb90((double)in_ST0);
        in_ST0 = (float10)dVar15;
        fVar13 = (float10)(double)CONCAT44(extraout_EDX_01,extraout_EAX_01);
      ...
      channel_buffers = SUB84(dVar18,0);
      ...
      if (local_60 == 0) {
        ...
        if ((pCVar7->sample_info).bit_depth == 8) {
          if ((pCVar7->sample_info).num_channels == 2) {
            if (0 < iStack_a4) {
              ...
              do {
                ...
                dVar15 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44(this_ptr->sample,uVar6));
                ...
                dVar14 = dVar14 + (double)CONCAT44(uStack_ac,(int)((ulonglong)dVar18 >> 0x20));
                local_18 = local_18 + 4;
            ...
            do {
              fVar13 = (float10)dVar14;
              dVar15 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44(pCVar11,pCVar7));
          ...
          if (mix_buffer.num_channels == 2) {
            local_7c = sound_sndmain_cpp_mixResampleStereoToStereo_FUN_005a5fb0
                                 (sample_data,channel_buffers,channel_gains,
                                  (double)CONCAT44(SUB84(dVar14,0),iStack_a4),
          ...
          do {
            fVar13 = (float10)dVar14;
            dVar15 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44(pCVar11,this_ptr->sample));
            local_14 = (float)*(short *)(*(int *)(SUB84(dVar15,0) + 0x120) + (int)ROUND(fVar13) * 2)
            ;
            iVar12 = 0;
            pCVar8 = this_ptr;
...
// 005a7cac: PUSH EBX
// 005a7cad: CALL sound_sndmain.cpp_mixResampleStereoToStereo_FUN_005a5fb0
...
// 005a7d86: PUSH EBX
// 005a7d87: CALL sound_sndmain.cpp_mixResampleMonoToStereo_FUN_005a5e70
