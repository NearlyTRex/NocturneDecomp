// Name: sound_sndmain.cpp_CSfxSlot_FUN_005a6f00
// Address: 005a6f00
// Address Range: [[005a6f00, 005a7067]]
// Convention: __cdecl
// Signature: float sound_sndmain.cpp_CSfxSlot_FUN_005a6f00(CSfxSlot * this_ptr)
// Cross-references:
...
float __cdecl sound_sndmain_cpp_CSfxSlot_FUN_005a6f00(CSfxSlot *this_ptr)

{
  ...
  fVar3 = (fVar4 * *(float *)((this_ptr->options).field5_0x14 + 0x30)) / local_20;
  bVar1 = (this_ptr->options).field5_0x14[0x48];
  ...
  if ((bVar1 & 1) == 0) {
    ...
    if (0 < g_AudioChannels) {
      do {
        ...
        fVar2 = *(float *)(this_ptr->field4_0x7c + 0x8c);
        ...
        fVar2 = *(float *)(this_ptr->field4_0x7c + 0x84) * (float)DOUBLE_006501df;
        if (local_28 < fVar2 || (local_28 == fVar2) != 0) {
          local_18 = 20.0;
        }
        else {
          local_18 = *(float *)(this_ptr->field4_0x7c + 0x84) / local_28;
        }
        iVar6 = iVar6 + 1;
        *(float *)(pCVar7->field4_0x7c + 0x24) = fVar3 * local_18;
...
// Assembly code:
// 005a6f00: PUSH EBX
//   Label: sound_sndmain.cpp_CSfxSlot_FUN_005a6f00
// 005a6f01: PUSH ESI
// 005a6f02: PUSH EDI
// 005a6f03: PUSH EBP
