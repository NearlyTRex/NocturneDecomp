...
section .text
    ...
    CMP dword ptr [EBX + 0x3f6294c],0x0 ; 005a445c | DAT_03f6294c
        ;   Label: LAB_005a445c
    JNZ 0x005a44b6                      ; 005a4463 | LAB_005a44b6
        ;   XREF to: 005a44b6 (CONDITIONAL_JUMP)
    ADD EBX,0x180                       ; 005a4465
        ;   Label: LAB_005a4465
    CMP EBX,0x6000                      ; 005a446b
    JNZ 0x005a445c                      ; 005a4471 | LAB_005a445c
        ;   XREF to: 005a445c (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [0x00681b44]      ; 005a4473 | int g_MaximumSoundMemoryBudget
        ;   Label: LAB_005a4473
    LEA EAX,[ESI + EBP*0x1]             ; 005a4479
    CMP EAX,EBX                         ; 005a447c
    JLE 0x005a451c                      ; 005a447e | LAB_005a451c
        ;   XREF to: 005a451c (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x03f62828]      ; 005a4484 | int g_LastSampleAccessIndex
    XOR EBX,EBX                         ; 005a448a
    XOR EDI,EDI                         ; 005a448c
    INC EDX                             ; 005a448e
        ;   Label: LAB_005a448e
    CMP EDX,0x40                        ; 005a448f
    JL 0x005a4496                       ; 005a4492 | LAB_005a4496
        ;   XREF to: 005a4496 (CONDITIONAL_JUMP)
    MOV EDX,EDI                         ; 005a4494
    IMUL EAX,EDX,0x180                  ; 005a4496
        ;   Label: LAB_005a4496
    CMP EDI,dword ptr [EAX + 0x3f6294c] ; 005a449c | DAT_03f6294c
    JNZ 0x005a44d1                      ; 005a44a2 | LAB_005a44d1
        ;   XREF to: 005a44d1 (CONDITIONAL_JUMP)
    INC EBX                             ; 005a44a4
        ;   Label: LAB_005a44a4
    CMP EBX,0x40                        ; 005a44a5
    JL 0x005a448e                       ; 005a44a8 | LAB_005a448e
        ;   XREF to: 005a448e (CONDITIONAL_JUMP)
    CMP EBX,0x40                        ; 005a44aa
    JL 0x005a4473                       ; 005a44ad | LAB_005a4473
    ...
    POP EBX                             ; 005a44b4
    RET                                 ; 005a44b5
    MOV EDI,0x3f6282c                   ; 005a44b6 | CSfxSample[64] g_SfxSamples
        ;   Label: LAB_005a44b6
    ADD EDI,EBX                         ; 005a44bb
    PUSH EDI                            ; 005a44bd | DAT_03f629ac
    CALL sound_sndmain.cpp_CSfxSample_getBytesPerFrame_FUN_005a8550 ; 005a44be | int sound_sndmain.cpp_CSfxSample_getBytesPerFrame_FUN_005a8550(CSfxSample * this_ptr)
    ...
    JMP 0x005a4465                      ; 005a44cf | LAB_005a4465
        ;   XREF to: 005a4465 (UNCONDITIONAL_JUMP)
    CMP dword ptr [EAX + 0x3f6298c],0x1 ; 005a44d1 | DAT_03f6298c
        ;   Label: LAB_005a44d1
    JL 0x005a44a4                       ; 005a44d8 | LAB_005a44a4
        ;   XREF to: 005a44a4 (CONDITIONAL_JUMP)
    CMP EDI,dword ptr [EAX + 0x3f62980] ; 005a44da | DAT_03f62980
    JNZ 0x005a44a4                      ; 005a44e0 | LAB_005a44a4
        ;   XREF to: 005a44a4 (CONDITIONAL_JUMP)
    CMP EDI,dword ptr [EAX + 0x3f6297c] ; 005a44e2 | DAT_03f6297c
    JNZ 0x005a44a4                      ; 005a44e8 | LAB_005a44a4
        ;   XREF to: 005a44a4 (CONDITIONAL_JUMP)
    MOV EDI,0x3f6282c                   ; 005a44ea | CSfxSample[64] g_SfxSamples
    ADD EDI,EAX                         ; 005a44ef
    PUSH EDI                            ; 005a44f1 | CSfxSample[64] g_SfxSamples
    CALL sound_sndmain.cpp_CSfxSample_getBytesPerFrame_FUN_005a8550 ; 005a44f2 | int sound_sndmain.cpp_CSfxSample_getBytesPerFrame_FUN_005a8550(CSfxSample * this_ptr)
        ;   XREF to: 005a8550 (UNCONDITIONAL_CALL)
    IMUL EAX,dword ptr [EDI + 0x160]    ; 005a44f7 | DAT_03f6298c
    ADD ESP,0x4                         ; 005a44fe
    PUSH EDI                            ; 005a4501 | CSfxSample[64] g_SfxSamples
    SUB ESI,EAX                         ; 005a4502
    CALL sound_sndmain.cpp_CSfxSample_freeMemory_FUN_005a62c0 ; 005a4504 | void sound_sndmain.cpp_CSfxSample_freeMemory_FUN_005a62c0(CSfxSample * this_ptr)
        ;   XREF to: 005a62c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005a4509
    CMP EBX,0x40                        ; 005a450c
    JL 0x005a4473                       ; 005a450f | LAB_005a4473
        ;   XREF to: 005a4473 (CONDITIONAL_JUMP)
