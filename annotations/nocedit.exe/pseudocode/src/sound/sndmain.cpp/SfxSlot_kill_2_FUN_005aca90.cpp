// Name: sound_sndmain.cpp_SfxSlot_kill_2_FUN_005aca90
// Address: 005aca90
// Address Range: [[005aca90, 005acda2]]
// Convention: unknown
// Signature: undefined sound_sndmain.cpp_SfxSlot_kill_2_FUN_005aca90()
// Cross-references:
//   sound_snddx.cpp_FUN_005adff0 (005adff0) at 005ae0d7 [UNCONDITIONAL_CALL]
//   sound_snddx.cpp_waveOutWrite_FUN_005b06c0 (005b06c0) at 005b0774 [UNCONDITIONAL_CALL]
// Globals:
...
//   sound_sndmain.cpp_UnknownPlayOrUseSample_FUN_005a75e0

#include "nocturne.h"

/* Signature: undefined1 sound_sndmain.cpp_SfxSlot_kill_2(undefined4 param_1, undefined4 param_2,
   undefined4 param_3, undefined4 param_4, undefined4 param_5, undefined4 param_6) */

void sound_sndmain_cpp_SfxSlot_kill_2_FUN_005aca90(void)

{
  ...
  if (((in_stack_0000000c == (int *)g_AudioBitsPerSample) && (in_stack_00000010 == g_AudioChannels))
    ...
    local_14 = (SfxSlot *)&g_SfxLastSlot;
    for (; 0 < in_stack_0000001c; in_stack_0000001c = in_stack_0000001c - iVar3) {
      if (g_MixBufferReadIndex < 1) {
        ...
        do {
          ...
          pSVar5 = pSVar5 + 1;
        } while (pSVar5 != (SfxSlot *)&g_SfxLastSlot);
      ...
      if (0 < in_stack_00000014) {
        iVar6 = 0;
        do {
          uStackY_74 = *(undefined4 *)((int)aiStack_3c + iVar6 + 4);
          iStackY_78 = g_MixBufferWriteIndex * 4 + *(int *)((int)g_ChannelPrimaryBuffers + iVar6);
          uStackY_7c = 0x5acd06;
          sound_sndmain_cpp_convertMixBufToOutput_FUN_005a5b80();
          iVar7 = iVar6 + 4;
          *(int *)((int)aiStack_3c + iVar6 + 8) =
               *(int *)((int)aiStack_3c + iVar6 + 8) + in_stack_00000020 * iVar3;
          iVar6 = iVar7;
        } while (iVar7 < iVar2);
      }
...
// Assembly code:
// 005aca90: PUSH EBX
//   Label: sound_sndmain.cpp_SfxSlot_kill_2_FUN_005aca90
// 005aca91: PUSH ESI
// 005aca92: PUSH EDI
// 005aca93: PUSH EBP
...
// 005acc5a: CALL sound_sndmain.cpp_ComputingDelay_FUN_005a7100
...
// 005acc82: CALL sound_sndmain.cpp_UnknownPlayOrUseSample_FUN_005a75e0
