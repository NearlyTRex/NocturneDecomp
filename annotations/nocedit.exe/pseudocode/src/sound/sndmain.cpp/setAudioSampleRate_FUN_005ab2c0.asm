...
section .text
    ...
    PUSH EDX                            ; 005ab2c4
    CALL sound_sndmain.cpp_getAudioChannelCount_FUN_005ab270 ; 005ab2c5 | int sound_sndmain.cpp_getAudioChannelCount_FUN_005ab270()
        ;   XREF to: 005ab270 (UNCONDITIONAL_CALL)
    PUSH EAX                            ; 005ab2ca
    CALL sound_sndmain.cpp_getAudioBitDepth_FUN_005ab250 ; 005ab2cb | int sound_sndmain.cpp_getAudioBitDepth_FUN_005ab250()
        ;   XREF to: 005ab250 (UNCONDITIONAL_CALL)
    PUSH EAX                            ; 005ab2d0
    CALL sound_sndmain.cpp_setSoundOutputMode_FUN_005ab170 ; 005ab2d1 | int sound_sndmain.cpp_setSoundOutputMode_FUN_005ab170(int bits_per_sample, int channels, int sample_rate)
