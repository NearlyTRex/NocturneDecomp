...
;                               FUNCTION
; *****************************************************************************
; __cdecl int sound_sndmain.cpp_CSfxSample_allocateHwSample_FUN_005a6170(CSfxSample * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 005a617b
    CALL sound_sndmain.cpp_CSfxSample_releaseBufferId_FUN_005a63b0 ; 005a617c | void sound_sndmain.cpp_CSfxSample_releaseBufferId_FUN_005a63b0(CSfxSample * this_ptr)
        ;   XREF to: 005a63b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005a6181
    MOV ECX,dword ptr [ESP + 0x18]      ; 005a6184
    PUSH ECX                            ; 005a6188
    CALL sound_sndmain.cpp_CSfxSample_freeSampleData_FUN_005a6400 ; 005a6189 | void sound_sndmain.cpp_CSfxSample_freeSampleData_FUN_005a6400(CSfxSample * this_ptr)
        ;   XREF to: 005a6400 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005a618e
    CALL sound_sndmain.cpp_hasHardware3DSound_FUN_005ab5a0 ; 005a6191 | uint sound_sndmain.cpp_hasHardware3DSound_FUN_005ab5a0()
        ;   XREF to: 005ab5a0 (UNCONDITIONAL_CALL)
    TEST EAX,EAX                        ; 005a6196
    JZ 0x005a6262                       ; 005a6198 | LAB_005a6262
    ...
    MOV ECX,dword ptr [0x03f69268]      ; 005a61ae | CSoundDevice * g_CSoundDevicePtr
    ...
    JZ 0x005a6223                       ; 005a61d1 | LAB_005a6223
    ...
    PUSH EBX                            ; 005a61d9
    MOV EAX,[0x03f69268]                ; 005a61da | CSoundDevice * g_CSoundDevicePtr
    PUSH EDI                            ; 005a61df
    ...
    JNZ 0x005a6225                      ; 005a61eb | LAB_005a6225
        ;   XREF to: 005a6225 (CONDITIONAL_JUMP)
    MOV EAX,[0x03f62828]                ; 005a61ed | int g_LastSampleAccessIndex
    XOR EBX,EBX                         ; 005a61f2
    INC EAX                             ; 005a61f4
        ;   Label: LAB_005a61f4
    CMP EAX,0x40                        ; 005a61f5
    JL 0x005a61fc                       ; 005a61f8 | LAB_005a61fc
        ;   XREF to: 005a61fc (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 005a61fa
    IMUL EDX,EAX,0x180                  ; 005a61fc
        ;   Label: LAB_005a61fc
    CMP dword ptr [EDX + 0x3f62980],0x0 ; 005a6202 | DAT_03f62980
    JZ 0x005a623f                       ; 005a6209 | LAB_005a623f
        ;   XREF to: 005a623f (CONDITIONAL_JUMP)
    INC EBX                             ; 005a620b
        ;   Label: LAB_005a620b
    CMP EBX,0x40                        ; 005a620c
    JL 0x005a61f4                       ; 005a620f | LAB_005a61f4
        ;   XREF to: 005a61f4 (CONDITIONAL_JUMP)
    CMP EBX,0x40                        ; 005a6211
        ;   Label: LAB_005a6211
    JL 0x005a61d3                       ; 005a6214 | LAB_005a61d3
        ;   XREF to: 005a61d3 (CONDITIONAL_JUMP)
    PUSH 0x64fabf                       ; 005a6216 | = "allocateHwSample - failed\n" | s_allocateHwSample_failed_0064fabf = allocateHwSample - failed

    CALL sound_sndmain.cpp_logSoundError_FUN_005adba0 ; 005a621b | void sound_sndmain.cpp_logSoundError_FUN_005adba0(char * format)
    ...
    JNZ 0x005a62b3                      ; 005a6231 | LAB_005a62b3
    ...
    CMP dword ptr [EDX + 0x3f62984],0x0 ; 005a623f | DAT_03f62b04
        ;   Label: LAB_005a623f
    JZ 0x005a620b                       ; 005a6246 | LAB_005a620b
        ;   XREF to: 005a620b (CONDITIONAL_JUMP)
    CMP dword ptr [EDX + 0x3f6297c],0x0 ; 005a6248 | DAT_03f62afc
    JNZ 0x005a620b                      ; 005a624f | LAB_005a620b
        ;   XREF to: 005a620b (CONDITIONAL_JUMP)
    ADD EDX,0x3f6282c                   ; 005a6251 | CSfxSample[64] g_SfxSamples
    PUSH EDX                            ; 005a6257 | DAT_03f629ac
    CALL sound_sndmain.cpp_CSfxSample_freeMemory_FUN_005a62c0 ; 005a6258 | void sound_sndmain.cpp_CSfxSample_freeMemory_FUN_005a62c0(CSfxSample * this_ptr)
        ;   XREF to: 005a62c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005a625d
    JMP 0x005a6211                      ; 005a6260 | LAB_005a6211
        ;   XREF to: 005a6211 (UNCONDITIONAL_JUMP)
    MOV EBX,dword ptr [ESP + 0x18]      ; 005a6262
        ;   Label: LAB_005a6262
    PUSH EBX                            ; 005a6266
    CALL sound_sndmain.cpp_CSfxSample_getBytesPerFrame_FUN_005a8550 ; 005a6267 | int sound_sndmain.cpp_CSfxSample_getBytesPerFrame_FUN_005a8550(CSfxSample * this_ptr)
        ;   XREF to: 005a8550 (UNCONDITIONAL_CALL)
    IMUL EAX,dword ptr [EBX + 0x160]    ; 005a626c
    ADD ESP,0x4                         ; 005a6273
    PUSH EAX                            ; 005a6276
    CALL sound_sndmain.cpp_ensureSoundMemoryAvailable_FUN_005a4450 ; 005a6277 | int sound_sndmain.cpp_ensureSoundMemoryAvailable_FUN_005a4450(int requested_bytes)
        ;   XREF to: 005a4450 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005a627c
    PUSH 0x6fb                          ; 005a627f
    PUSH 0x64fcbf                       ; 005a6284 | = "..\\sound\\sndmain.cpp" | s_sound_sndmain_cpp_0064fcbf = ..\sound\sndmain.cpp
    PUSH EBX                            ; 005a6289
    CALL sound_sndmain.cpp_CSfxSample_getBytesPerFrame_FUN_005a8550 ; 005a628a | int sound_sndmain.cpp_CSfxSample_getBytesPerFrame_FUN_005a8550(CSfxSample * this_ptr)
        ;   XREF to: 005a8550 (UNCONDITIONAL_CALL)
    ...
    PUSH EDX                            ; 005a62a0
    CALL shape_memdbg.cpp_debugRealloc_FUN_0050f540 ; 005a62a1 | void * shape_memdbg.cpp_debugRealloc_FUN_0050f540(void * ptr, int new_size, char * filename, int line_number)
        ;   XREF to: 0050f540 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 005a62a6
    TEST EAX,EAX                        ; 005a62a9
    JZ 0x005a6237                       ; 005a62ab | LAB_005a6237
