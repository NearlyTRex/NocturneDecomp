...
section .text
    ...
    CALL sound_sndmain.cpp_stopRecordingDevice_FUN_005abb60 ; 005ab930 | int sound_sndmain.cpp_stopRecordingDevice_FUN_005abb60()
        ;   Label: sound_sndmain.cpp_releaseRecordingDevice_FUN_005ab930
        ;   XREF to: 005abb60 (UNCONDITIONAL_CALL)
    TEST EAX,EAX                        ; 005ab935
    JZ 0x005ab948                       ; 005ab937 | LAB_005ab948
        ;   XREF to: 005ab948 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x03f69c54]      ; 005ab939 | IDirectSoundCapture * g_RecordingDeviceInterface
    TEST EDX,EDX                        ; 005ab93f
    JNZ 0x005ab949                      ; 005ab941 | LAB_005ab949
    ...
    JZ 0x005ab948                       ; 005ab955 | LAB_005ab948
        ;   XREF to: 005ab948 (CONDITIONAL_JUMP)
    XOR ECX,ECX                         ; 005ab957
    MOV EAX,0x1                         ; 005ab959
    MOV dword ptr [0x03f69c54],ECX      ; 005ab95e | IDirectSoundCapture * g_RecordingDeviceInterface
    RET                                 ; 005ab964
