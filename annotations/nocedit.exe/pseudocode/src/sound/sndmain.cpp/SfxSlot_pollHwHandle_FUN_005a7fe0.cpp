// Name: sound_sndmain.cpp_SfxSlot_pollHwHandle_FUN_005a7fe0
// Address: 005a7fe0
// Address Range: [[005a7fe0, 005a80d0]]
// Convention: unknown
// Signature: undefined sound_sndmain.cpp_SfxSlot_pollHwHandle_FUN_005a7fe0()
// Cross-references:
//   sound_sndmain.cpp_SfxSlot_kill_FUN_005acdb0 (005acdb0) at 005ace03 [UNCONDITIONAL_CALL]
// Globals:
...
/* Signature: undefined1 sound_sndmain.cpp_SfxSlot_pollHwHandle(undefined4 param_1) */

void sound_sndmain_cpp_SfxSlot_pollHwHandle_FUN_005a7fe0(void)

{
  ...
  if (in_stack_00000004->dsound_buffer == (void *)0x0) {
    return;
  }
  ...
  if ((in_stack_00000004->field_20[0x48] & 1U) == 0) {
    if (*(int *)(in_stack_00000004->field_20 + 0xc) != 0) {
      uVar2 = 2;
    }
    if (*(int *)(in_stack_00000004->field_20 + 0x2c) != 0) {
      if ((uVar2 | 4) == 0) {
        return;
      }
      goto LAB_005a809a;
...
// Assembly code:
// 005a7fe0: PUSH EBX
//   Label: sound_sndmain.cpp_SfxSlot_pollHwHandle_FUN_005a7fe0
// 005a7fe1: PUSH EDI
// 005a7fe2: PUSH EBP
...
// 005a8044: PUSH EBX
//   Label: LAB_005a8044
// 005a8045: CALL sound_sndmain.cpp_SfxSlot_kill_FUN_005a7e60
...
// 005a8072: PUSH EBX
//   Label: LAB_005a8072
// 005a8073: CALL sound_sndmain.cpp_SfxSlot_kill_FUN_005a7e60
//   XREF to: 005a7e60 (UNCONDITIONAL_CALL)
...
// 005a80c4: PUSH EBX
// 005a80c5: CALL sound_sndmain.cpp_SfxSlot_kill_FUN_005a7e60
//   XREF to: 005a7e60 (UNCONDITIONAL_CALL)
