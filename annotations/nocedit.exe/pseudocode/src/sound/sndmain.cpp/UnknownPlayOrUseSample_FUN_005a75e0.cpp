// Name: sound_sndmain.cpp_UnknownPlayOrUseSample_FUN_005a75e0
// Address: 005a75e0
// Address Range: [[005a75e0, 005a7e52]]
// Convention: unknown
// Signature: undefined sound_sndmain.cpp_UnknownPlayOrUseSample_FUN_005a75e0()
// Cross-references:
//   sound_sndmain.cpp_SfxSlot_kill_2_FUN_005aca90 (005aca90) at 005acc82 [UNCONDITIONAL_CALL]
// Globals:
...
//   sound_sndmain.cpp_SfxSlot_updatePlaybackPos_FUN_005a8170

#include "nocturne.h"

/* Signature: undefined1 sound_sndmain.cpp_UnknownPlayOrUseSample(undefined4 param_1, undefined1
   param_2, undefined4 param_3, undefined1 param_4, undefined1 param_5, undefined1 param_6,
   undefined1 param_7, undefined1 param_8, undefined1 param_9, undefined4 param_10, undefined4
   param_11, undefined4 param_12) */

void sound_sndmain_cpp_UnknownPlayOrUseSample_FUN_005a75e0(void)

{
  ...
  if (in_stack_00000004->field_116 != 0) {
    ...
    if (in_stack_00000004->sample != (SfxSample *)0x0) {
      local_74[3] = 1.0 / (float)(1 << ((char)*(undefined4 *)
                                               (in_stack_00000004->sample->field1_0x4 + 0x100) + 6U
                                       & 0x1f));
      iVar7 = 0;
      pSVar6 = in_stack_00000004;
      if (0 < (int)in_stack_0000002c) {
        do {
          if (local_74[3] < *(float *)(pSVar6->field_124 + 0x24)) {
            local_60 = 0;
            break;
          }
          iVar7 = iVar7 + 1;
          pSVar6 = (SfxSlot *)&pSVar6->sample_data;
    ...
    if (0 < (int)in_stack_0000002c) {
      do {
        if ((local_60 != 0) || (*(int *)(pSVar6->field_124 + 100) < 0)) {
          *(undefined4 *)(pSVar6->field_124 + 100) = *(undefined4 *)(pSVar6->field_124 + 0x44);
        }
        iVar10 = iVar7 * 4;
        *(int *)(&stack0x00000008 + iVar10) =
             *(int *)(&stack0x00000008 + iVar10) + *(int *)(pSVar6->field_124 + 100) * 4;
        uVar4 = *(int *)(pSVar6->field_124 + 100) - *(int *)(pSVar6->field_124 + 0x44);
    ...
    local_64 = in_stack_00000004->field_124 + 0x24;
    while (((iVar7 = in_stack_00000028, in_stack_00000004->field_116 != 0 &&
            (pSVar5 = in_stack_00000004->sample, pSVar5 != (SfxSample *)0x0)) &&
           (0.0 <= *(double *)(in_stack_00000004->field_20 + 0x4c)))) {
      if ((in_stack_00000028 < 1) ||
         (dVar14 = (double)(((float)*(int *)(pSVar5->field1_0x4 + 0x108) / (float)in_stack_00000030)
                           * *(float *)in_stack_00000004->field_124),
         local_b0 = (undefined4)((ulonglong)dVar14 >> 0x20), dVar14 <= 0.0)) goto LAB_005a770c;
      iVar10 = *(int *)pSVar5->field_160;
      uStack_ac = SUB84((double)iVar10,0);
      iStack_a4 = in_stack_00000028;
      local_4c = 0;
      if (0 < *(int *)(pSVar5->field1_0x4 + 0x10c)) {
      ...
      dStack_bc = *(double *)in_stack_00000004->field_284;
      local_50 = 0;
      dVar14 = crt_math_c_floor_FUN_005feb90((double)in_ST0);
      ...
      if (local_44 < 1) {
        ...
        crt_math_c_floor_FUN_005feb90((double)fVar11);
      ...
      if (local_60 == 0) {
        pSVar5 = in_stack_00000004->sample;
        ppvVar9 = (void **)(iStack_a4 << 2);
        local_7c = uVar13;
        if (*(int *)(pSVar5->field1_0x4 + 0x100) == 8) {
          if (*(int *)(pSVar5->field1_0x4 + 0x104) == 2) {
            if (0 < iStack_a4) {
              uVar4 = 0;
              local_1c = 0;
              local_3c = ppvVar9;
              do {
                ...
                dVar14 = crt_math_c_round_FUN_005fe6b0
                                   ((double)CONCAT44(in_stack_00000004->sample,uVar4));
                local_74[2] = (float)(int)(*(byte *)(*(int *)((int)((ulonglong)dVar14 >> 0x20) +
                                                             0x120) + (int)ROUND(fVar11) * 2) - 0x80
                                          );
                local_74[3] = (float)(int)(*(byte *)((int)in_stack_00000004->sample->sample_data +
                ...
                if (0 < (int)in_stack_0000002c) {
                  do {
                    ...
                    *(float *)(*(int *)(&stack0x00000008 + iVar7) + local_18) =
                         local_74[uVar8 + 2] * *(float *)(pSVar6->field_124 + 0x24) +
                         *(float *)(*(int *)(&stack0x00000008 + iVar7) + local_18);
                    pSVar6 = (SfxSlot *)&pSVar6->sample_data;
            ...
            do {
              fVar11 = (float10)dStack_bc;
              dVar14 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44(ppvVar9,pSVar5));
              ppvVar9 = (void **)((ulonglong)dVar14 >> 0x20);
              bVar3 = *(byte *)((int)in_stack_00000004->sample->sample_data + (int)ROUND(fVar11));
              pSVar5 = (SfxSample *)0x0;
              pSVar6 = in_stack_00000004;
              if (0 < (int)in_stack_0000002c) {
                do {
                  iVar10 = (int)pSVar5 * 4;
                  pSVar5 = (SfxSample *)(pSVar5->name + 1);
                  *(float *)(*(int *)(&stack0x00000008 + iVar10) + iVar7) =
                       (float)(int)(bVar3 - 0x80) * *(float *)(pSVar6->field_124 + 0x24) +
                       *(float *)(*(int *)(&stack0x00000008 + iVar10) + iVar7);
                  ppvVar9 = &pSVar6->sample_data;
                  pSVar6 = (SfxSlot *)ppvVar9;
                } while ((int)pSVar5 < (int)in_stack_0000002c);
              }
              dStack_bc = dStack_bc + (double)CONCAT44(uStack_ac,local_b0);
              iVar7 = iVar7 + 4;
              uVar13 = local_7c;
        ...
        else if (*(int *)(pSVar5->field1_0x4 + 0x104) == 2) {
          if (in_stack_0000002c == (void **)&DAT_00000002) {
            uVar13 = sound_sndmain_cpp_FUN_005a5fb0();
          }
          else if (0 < iStack_a4) {
            uVar4 = 0;
            local_20 = 0;
            ...
            do {
              ...
              dVar14 = crt_math_c_round_FUN_005fe6b0
                                 ((double)CONCAT44(in_stack_00000004->sample,uVar4));
              local_74[0] = (float)*(short *)(*(int *)((int)((ulonglong)dVar14 >> 0x20) + 0x120) +
                                             (int)ROUND(fVar11) * 4);
              local_74[1] = (float)*(short *)((int)in_stack_00000004->sample->sample_data +
              ...
              if (0 < (int)in_stack_0000002c) {
                do {
                  ...
                  *(float *)(*(int *)(&stack0x00000008 + iVar7) + local_1c) =
                       local_74[uVar8] * *(float *)(pSVar6->field_124 + 0x24) +
                       *(float *)(*(int *)(&stack0x00000008 + iVar7) + local_1c);
                  pSVar6 = (SfxSlot *)&pSVar6->sample_data;
                } while ((int)uVar4 < (int)in_stack_0000002c);
              }
          ...
          uVar13 = sound_sndmain_cpp_FUN_005a5e70();
        }
        else if (0 < iStack_a4) {
          iVar7 = 0;
          local_30 = ppvVar9;
          do {
            fVar11 = (float10)dStack_bc;
            dVar14 = crt_math_c_round_FUN_005fe6b0
                               ((double)CONCAT44(ppvVar9,in_stack_00000004->sample));
            local_14 = (float)*(short *)(*(int *)(SUB84(dVar14,0) + 0x120) + (int)ROUND(fVar11) * 2)
            ;
            iVar10 = 0;
            pSVar6 = in_stack_00000004;
            ...
            if (0 < (int)in_stack_0000002c) {
              do {
                ...
                *(float *)(*(int *)(&stack0x00000008 + iVar2) + iVar7) =
                     local_14 * *(float *)(pSVar6->field_124 + 0x24) +
                     *(float *)(*(int *)(&stack0x00000008 + iVar2) + iVar7);
                ppvVar9 = &pSVar6->sample_data;
                pSVar6 = (SfxSlot *)ppvVar9;
      ...
      local_7c = uVar13;
      in_ST0 = (float10)sound_sndmain_cpp_SfxSlot_updatePlaybackPos_FUN_005a8170();
      if (local_48 != 0) {
        iVar10 = *(int *)(in_stack_00000004->field_284 + 8) + 1;
        iVar7 = *(int *)(in_stack_00000004->sample->field_292 +
                        *(int *)(in_stack_00000004->field_284 + 8) * 4 + 0x18);
        *(int *)(in_stack_00000004->field_284 + 8) = iVar10;
        pSVar5 = in_stack_00000004->sample;
        *(double *)(in_stack_00000004->field_20 + 0x4c) = (double)iVar7;
        if (*(int *)pSVar5->field_292 <= iVar10) {
          in_stack_00000004->field_284[8] = '\0';
          in_stack_00000004->field_284[9] = '\0';
          in_stack_00000004->field_284[10] = '\0';
          in_stack_00000004->field_284[0xb] = '\0';
        }
      }
      iVar7 = 0;
    ...
    if (0 < (int)in_stack_0000002c) {
      ...
      do {
        if (*(int *)((int)aiStack_a0 + local_48) != 0) {
          ...
          local_40 = local_58;
          iVar7 = 0;
          local_2c = (local_58 + *(int *)(in_stack_00000004->field_124 + local_48 + 0x44)) -
                     *(int *)(in_stack_00000004->field_124 + local_48 + 100);
          local_28 = local_2c * 4;
          iVar10 = 0;
          if (0 < local_28) {
            do {
          ...
          *(undefined4 *)(in_stack_00000004->field_124 + local_48 + 100) =
               *(undefined4 *)(in_stack_00000004->field_124 + local_48 + 0x44);
        }
        local_54 = local_54 + 1;
        local_48 = local_48 + 4;
...
// Assembly code:
// 005a75e0: PUSH EBX
//   Label: sound_sndmain.cpp_UnknownPlayOrUseSample_FUN_005a75e0
// 005a75e1: PUSH ESI
// 005a75e2: PUSH EDI
// 005a75e3: PUSH EBP
...
// 005a7703: PUSH EDI
//   Label: LAB_005a7703
// 005a7704: CALL sound_sndmain.cpp_SfxSlot_kill_FUN_005a7e60
...
// 005a796e: PUSH ECX
// 005a796f: PUSH EDI
// 005a7970: CALL sound_sndmain.cpp_SfxSlot_updatePlaybackPos_FUN_005a8170
