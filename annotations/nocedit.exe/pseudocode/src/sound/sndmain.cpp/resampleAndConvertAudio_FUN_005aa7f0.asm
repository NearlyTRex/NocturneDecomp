...
;                               FUNCTION
; *****************************************************************************
; __cdecl void sound_sndmain.cpp_resampleAndConvertAudio_FUN_005aa7f0(int src_bit_depth, int src_channels, int src_sample_rate, int src_signed, short * src_buffer, int dst_bit_depth, int dst_channels, int dst_sample_rate, int dst_signed, short * dst_buffer, int num_output_samples)
;
; Parameters:
...
section .text
    ...
    CMP dword ptr [ESP + 0x6c],0x0      ; 005aa872
        ;   Label: LAB_005aa872
    JZ 0x005aa883                       ; 005aa877 | LAB_005aa883
        ;   XREF to: 005aa883 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x80],0x0      ; 005aa879
    JZ 0x005aa894                       ; 005aa881 | LAB_005aa894
        ;   XREF to: 005aa894 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x6c],0x0      ; 005aa883
        ;   Label: LAB_005aa883
    JNZ 0x005aa8b0                      ; 005aa888 | LAB_005aa8b0
        ;   XREF to: 005aa8b0 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x80],0x0      ; 005aa88a
    JZ 0x005aa8b0                       ; 005aa892 | LAB_005aa8b0
        ;   XREF to: 005aa8b0 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x74],0x8      ; 005aa894
        ;   Label: LAB_005aa894
    JNZ 0x005aade4                      ; 005aa899 | LAB_005aade4
        ;   XREF to: 005aade4 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 005aa89f
    MOV EDX,dword ptr [ESP + 0x88]      ; 005aa8a0
    PUSH EDX                            ; 005aa8a7
    CALL sound_sndmain.cpp_convert8BitAudioSignedness_FUN_005aa7b0 ; 005aa8a8 | void sound_sndmain.cpp_convert8BitAudioSignedness_FUN_005aa7b0(byte * buffer, int num_bytes)
    ...
    FMUL ST1                            ; 005aa915
    CALL crt_math.c_round_FUN_005fe6b0  ; 005aa917 | double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    FMUL ST1                            ; 005aa950
    CALL crt_math.c_round_FUN_005fe6b0  ; 005aa952 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    JL 0x005aa948                       ; 005aa96e | LAB_005aa948
        ;   XREF to: 005aa948 (CONDITIONAL_JUMP)
    FSTP ST0                            ; 005aa970
    JMP 0x005aa872                      ; 005aa972 | LAB_005aa872
        ;   XREF to: 005aa872 (UNCONDITIONAL_JUMP)
    CMP ESI,0x1                         ; 005aa977
        ;   Label: LAB_005aa977
    JNZ 0x005aa9c8                      ; 005aa97a | LAB_005aa9c8
        ;   XREF to: 005aa9c8 (CONDITIONAL_JUMP)
    XOR EDX,EDX                         ; 005aa97c
    CMP EDX,EBX                         ; 005aa97e
    JGE 0x005aa872                      ; 005aa980 | LAB_005aa872
        ;   XREF to: 005aa872 (CONDITIONAL_JUMP)
    ...
    FMUL ST1                            ; 005aa994
    CALL crt_math.c_round_FUN_005fe6b0  ; 005aa996 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    JL 0x005aa98c                       ; 005aa9bf | LAB_005aa98c
        ;   XREF to: 005aa98c (CONDITIONAL_JUMP)
    FSTP ST0                            ; 005aa9c1
    JMP 0x005aa872                      ; 005aa9c3 | LAB_005aa872
        ;   XREF to: 005aa872 (UNCONDITIONAL_JUMP)
    XOR EDX,EDX                         ; 005aa9c8
        ;   Label: LAB_005aa9c8
    CMP EDX,EBX                         ; 005aa9ca
    JGE 0x005aa872                      ; 005aa9cc | LAB_005aa872
        ;   XREF to: 005aa872 (CONDITIONAL_JUMP)
    ...
    FMUL ST1                            ; 005aa9e3
    CALL crt_math.c_round_FUN_005fe6b0  ; 005aa9e5 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    FMUL ST1                            ; 005aaa3c
    CALL crt_math.c_round_FUN_005fe6b0  ; 005aaa3e | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    JL 0x005aaa34                       ; 005aaa5d | LAB_005aaa34
        ;   XREF to: 005aaa34 (CONDITIONAL_JUMP)
    FSTP ST0                            ; 005aaa5f
    JMP 0x005aa872                      ; 005aaa61 | LAB_005aa872
        ;   XREF to: 005aa872 (UNCONDITIONAL_JUMP)
    XOR ESI,ESI                         ; 005aaa66
        ;   Label: LAB_005aaa66
    CMP ESI,EBX                         ; 005aaa68
    JGE 0x005aa872                      ; 005aaa6a | LAB_005aa872
        ;   XREF to: 005aa872 (CONDITIONAL_JUMP)
    ...
    FMUL ST1                            ; 005aaa85
    CALL crt_math.c_round_FUN_005fe6b0  ; 005aaa87 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    JL 0x005aaa7d                       ; 005aaaaa | LAB_005aaa7d
        ;   XREF to: 005aaa7d (CONDITIONAL_JUMP)
    FSTP ST0                            ; 005aaaac
    JMP 0x005aa872                      ; 005aaaae | LAB_005aa872
        ;   XREF to: 005aa872 (UNCONDITIONAL_JUMP)
    CMP ESI,0x1                         ; 005aaab3
        ;   Label: LAB_005aaab3
    JNZ 0x005aab05                      ; 005aaab6 | LAB_005aab05
        ;   XREF to: 005aab05 (CONDITIONAL_JUMP)
    XOR EDX,EDX                         ; 005aaab8
    TEST EBX,EBX                        ; 005aaaba
    JLE 0x005aa872                      ; 005aaabc | LAB_005aa872
        ;   XREF to: 005aa872 (CONDITIONAL_JUMP)
    ...
    FMUL ST1                            ; 005aaad0
    CALL crt_math.c_round_FUN_005fe6b0  ; 005aaad2 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    JL 0x005aaac8                       ; 005aaafc | LAB_005aaac8
        ;   XREF to: 005aaac8 (CONDITIONAL_JUMP)
    FSTP ST0                            ; 005aaafe
    JMP 0x005aa872                      ; 005aab00 | LAB_005aa872
        ;   XREF to: 005aa872 (UNCONDITIONAL_JUMP)
    XOR ESI,ESI                         ; 005aab05
        ;   Label: LAB_005aab05
    TEST EBX,EBX                        ; 005aab07
    JLE 0x005aa872                      ; 005aab09 | LAB_005aa872
        ;   XREF to: 005aa872 (CONDITIONAL_JUMP)
    ...
    FMUL ST1                            ; 005aab1d
    CALL crt_math.c_round_FUN_005fe6b0  ; 005aab1f | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    FMUL ST1                            ; 005aab8a
    CALL crt_math.c_round_FUN_005fe6b0  ; 005aab8c | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    JL 0x005aab82                       ; 005aaba7 | LAB_005aab82
        ;   XREF to: 005aab82 (CONDITIONAL_JUMP)
    FSTP ST0                            ; 005aaba9
    JMP 0x005aa872                      ; 005aabab | LAB_005aa872
        ;   XREF to: 005aa872 (UNCONDITIONAL_JUMP)
    XOR ESI,ESI                         ; 005aabb0
        ;   Label: LAB_005aabb0
    TEST EBX,EBX                        ; 005aabb2
    JLE 0x005aa872                      ; 005aabb4 | LAB_005aa872
        ;   XREF to: 005aa872 (CONDITIONAL_JUMP)
    ...
    FMUL ST1                            ; 005aabcd
    CALL crt_math.c_round_FUN_005fe6b0  ; 005aabcf | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    JL 0x005aabc5                       ; 005aabf7 | LAB_005aabc5
        ;   XREF to: 005aabc5 (CONDITIONAL_JUMP)
    FSTP ST0                            ; 005aabf9
    JMP 0x005aa872                      ; 005aabfb | LAB_005aa872
        ;   XREF to: 005aa872 (UNCONDITIONAL_JUMP)
    CMP ESI,0x1                         ; 005aac00
        ;   Label: LAB_005aac00
    JNZ 0x005aac50                      ; 005aac03 | LAB_005aac50
        ;   XREF to: 005aac50 (CONDITIONAL_JUMP)
    XOR EDX,EDX                         ; 005aac05
    TEST EBX,EBX                        ; 005aac07
    JLE 0x005aa872                      ; 005aac09 | LAB_005aa872
        ;   XREF to: 005aa872 (CONDITIONAL_JUMP)
    ...
    FMUL ST1                            ; 005aac22
    CALL crt_math.c_round_FUN_005fe6b0  ; 005aac24 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    JL 0x005aac1a                       ; 005aac47 | LAB_005aac1a
        ;   XREF to: 005aac1a (CONDITIONAL_JUMP)
    FSTP ST0                            ; 005aac49
    JMP 0x005aa872                      ; 005aac4b | LAB_005aa872
        ;   XREF to: 005aa872 (UNCONDITIONAL_JUMP)
    XOR EDX,EDX                         ; 005aac50
        ;   Label: LAB_005aac50
    TEST EBX,EBX                        ; 005aac52
    JLE 0x005aa872                      ; 005aac54 | LAB_005aa872
        ;   XREF to: 005aa872 (CONDITIONAL_JUMP)
    ...
    FMUL ST1                            ; 005aac6d
    CALL crt_math.c_round_FUN_005fe6b0  ; 005aac6f | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    FMUL ST1                            ; 005aacda
    CALL crt_math.c_round_FUN_005fe6b0  ; 005aacdc | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    JL 0x005aacd2                       ; 005aacf7 | LAB_005aacd2
        ;   XREF to: 005aacd2 (CONDITIONAL_JUMP)
    FSTP ST0                            ; 005aacf9
    JMP 0x005aa872                      ; 005aacfb | LAB_005aa872
        ;   XREF to: 005aa872 (UNCONDITIONAL_JUMP)
    XOR ESI,ESI                         ; 005aad00
        ;   Label: LAB_005aad00
    TEST EBX,EBX                        ; 005aad02
    JLE 0x005aa872                      ; 005aad04 | LAB_005aa872
        ;   XREF to: 005aa872 (CONDITIONAL_JUMP)
    ...
    FMUL ST1                            ; 005aad1d
    CALL crt_math.c_round_FUN_005fe6b0  ; 005aad1f | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    JL 0x005aad15                       ; 005aad3e | LAB_005aad15
        ;   XREF to: 005aad15 (CONDITIONAL_JUMP)
    FSTP ST0                            ; 005aad40
    JMP 0x005aa872                      ; 005aad42 | LAB_005aa872
        ;   XREF to: 005aa872 (UNCONDITIONAL_JUMP)
    CMP ESI,0x1                         ; 005aad47
        ;   Label: LAB_005aad47
    JNZ 0x005aad99                      ; 005aad4a | LAB_005aad99
        ;   XREF to: 005aad99 (CONDITIONAL_JUMP)
    XOR EDX,EDX                         ; 005aad4c
    TEST EBX,EBX                        ; 005aad4e
    JLE 0x005aa872                      ; 005aad50 | LAB_005aa872
        ;   XREF to: 005aa872 (CONDITIONAL_JUMP)
    ...
    FMUL ST1                            ; 005aad69
    CALL crt_math.c_round_FUN_005fe6b0  ; 005aad6b | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    JL 0x005aad61                       ; 005aad90 | LAB_005aad61
        ;   XREF to: 005aad61 (CONDITIONAL_JUMP)
    FSTP ST0                            ; 005aad92
    JMP 0x005aa872                      ; 005aad94 | LAB_005aa872
        ;   XREF to: 005aa872 (UNCONDITIONAL_JUMP)
    XOR ESI,ESI                         ; 005aad99
        ;   Label: LAB_005aad99
    TEST EBX,EBX                        ; 005aad9b
    JLE 0x005aa872                      ; 005aad9d | LAB_005aa872
        ;   XREF to: 005aa872 (CONDITIONAL_JUMP)
    ...
    FMUL ST1                            ; 005aadb6
    CALL crt_math.c_round_FUN_005fe6b0  ; 005aadb8 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    JL 0x005aadae                       ; 005aaddb | LAB_005aadae
        ;   XREF to: 005aadae (CONDITIONAL_JUMP)
    FSTP ST0                            ; 005aaddd
    JMP 0x005aa872                      ; 005aaddf | LAB_005aa872
        ;   XREF to: 005aa872 (UNCONDITIONAL_JUMP)
    PUSH EBX                            ; 005aade4
        ;   Label: LAB_005aade4
    MOV EAX,dword ptr [ESP + 0x88]      ; 005aade5
    PUSH EAX                            ; 005aadec
    CALL sound_sndmain.cpp_convert16BitAudioSignedness_FUN_005aa7d0 ; 005aaded | void sound_sndmain.cpp_convert16BitAudioSignedness_FUN_005aa7d0(short * buffer, int num_samples)
