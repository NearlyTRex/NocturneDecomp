...
section .text
    ...
    MOV ECX,dword ptr [0x00681b18]      ; 005a5533 | int g_AudioChannelCount
    CMP ECX,0x2                         ; 005a5539
    JZ 0x005a558e                       ; 005a553c | LAB_005a558e
        ;   XREF to: 005a558e (CONDITIONAL_JUMP)
    TEST ECX,ECX                        ; 005a553e
    JLE 0x005a5584                      ; 005a5540 | LAB_005a5584
    ...
    FLD double ptr [0x03f68830]         ; 005a5557 | CVector3d g_Cached3DListenerPos
    FLD ST0                             ; 005a555d
        ;   Label: LAB_005a555d
    FLD ST2                             ; 005a555f
    ...
    FLD ST4                             ; 005a5564
    FXCH ST2                            ; 005a5566
    FSTP double ptr [EAX + 0x3f69320]   ; 005a5568 | double[8] g_VirtualSpeakerXPositions
    FSTP double ptr [EAX + 0x3f69360]   ; 005a556e | double[8] g_VirtualSpeakerYPositions
    FSTP double ptr [EAX + 0x3f693a0]   ; 005a5574 | double[8] g_VirtualSpeakerZPositions
    CMP EAX,EDX                         ; 005a557a
    JL 0x005a555d                       ; 005a557c | LAB_005a555d
        ;   XREF to: 005a555d (CONDITIONAL_JUMP)
    FSTP ST0                            ; 005a557e
    FSTP ST0                            ; 005a5580
    FSTP ST0                            ; 005a5582
    MOV dword ptr [0x00681b18],ECX      ; 005a5584 | int g_AudioChannelCount
        ;   Label: LAB_005a5584
    ADD ESP,0x10                        ; 005a558a
    RET                                 ; 005a558d
    FLD double ptr [0x00681b38]         ; 005a558e | double DOUBLE_00681b38
        ;   Label: LAB_005a558e
    FMUL double ptr [0x0064fab7]        ; 005a5594 | double DOUBLE_0064fab7
    FLD double ptr [0x03f68860]         ; 005a559a | CVector3d g_Cached3DListenerOrientFront
    FMUL ST1                            ; 005a55a0
    ...
    FMULP ST3                           ; 005a55b0
    FLD double ptr [0x03f68830]         ; 005a55b2 | CVector3d g_Cached3DListenerPos
    ...
    FLD double ptr [0x03f68830]         ; 005a55d0 | CVector3d g_Cached3DListenerPos
    ...
    FXCH                                ; 005a55e8
    FSTP double ptr [0x03f69328]        ; 005a55ea | double[8] g_VirtualSpeakerXPositions
    FXCH                                ; 005a55f0
    FSTP double ptr [0x03f69368]        ; 005a55f2 | double[8] g_VirtualSpeakerYPositions
    FSTP double ptr [0x03f693a8]        ; 005a55f8 | double[8] g_VirtualSpeakerZPositions
    FXCH                                ; 005a55fe
    ...
    MOV dword ptr [0x00681b18],ECX      ; 005a5612 | int g_AudioChannelCount
