...
section .text
    ...
    PUSH EDX                            ; 005a9a07
    CALL sound_sndmain.cpp_getSfxSlotFromHandle_FUN_005a5d00 ; 005a9a08 | CSfxSlot * sound_sndmain.cpp_getSfxSlotFromHandle_FUN_005a5d00(uint sfx_handle, int check_hardware_playback)
        ;   XREF to: 005a5d00 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 005a9a0d
    ADD ESP,0x8                         ; 005a9a0f
    TEST EAX,EAX                        ; 005a9a12
    JNZ 0x005a9a18                      ; 005a9a14 | LAB_005a9a18
    ...
    CALL sound_sndmain.cpp_CSfxSlot_compute_FUN_005a7100 ; 005a9a30 | int sound_sndmain.cpp_CSfxSlot_compute_FUN_005a7100(CSfxSlot * this_ptr, float delta_time)
        ;   XREF to: 005a7100 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [EBX + 0x70]      ; 005a9a35
    ADD ESP,0x8                         ; 005a9a38
    TEST ECX,ECX                        ; 005a9a3b
    JZ 0x005a9a57                       ; 005a9a3d | LAB_005a9a57
        ;   XREF to: 005a9a57 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [0x03f69268]      ; 005a9a3f | CSoundDevice * g_CSoundDevicePtr
    TEST EDI,EDI                        ; 005a9a45
    JZ 0x005a9a57                       ; 005a9a47 | LAB_005a9a57
        ;   XREF to: 005a9a57 (CONDITIONAL_JUMP)
    PUSH 0x4                            ; 005a9a49
    PUSH EBX                            ; 005a9a4b
    ...
    CALL sound_sndmain.cpp_unlockSound_FUN_005abdc0 ; 005a9a57 | void sound_sndmain.cpp_unlockSound_FUN_005abdc0()
        ;   Label: LAB_005a9a57
