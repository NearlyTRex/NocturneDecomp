...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl sound_sndmain_cpp_getActiveSfxCount_FUN_005a43a0(void)
;
;
; Referenced Globals:
...
section .text
    ...
    CMP dword ptr [0x03f6940c],0x0      ; 005a43a1 | g_SoundLockCount
    JLE 0x005a43d2                      ; 005a43a8
        ;   XREF to: 005a43d2 (CONDITIONAL_JUMP)  ; LAB_005a43d2
    ...
    JZ 0x005a43ce                       ; 005a43b6
        ;   XREF to: 005a43ce (CONDITIONAL_JUMP)  ; LAB_005a43ce
    ...
    PUSH EBX                            ; 005a43d2
        ;   Label: LAB_005a43d2
    MOV ECX,0x64f54e                    ; 005a43d3 | = "..\\sound\\sndmain.cpp"
    MOV EBX,0x1f6                       ; 005a43d8
    PUSH 0x64f563                       ; 005a43dd | = "SfxSlot::kill - must be locked!"
    MOV dword ptr [0x02f0ca48],ECX      ; 005a43e2 | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 005a43e8 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005a43ee
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ADD ESP,0x4                         ; 005a43f3
    POP EBX                             ; 005a43f6
    JMP 0x005a43aa                      ; 005a43f7
        ;   XREF to: 005a43aa (UNCONDITIONAL_JUMP)  ; LAB_005a43aa
