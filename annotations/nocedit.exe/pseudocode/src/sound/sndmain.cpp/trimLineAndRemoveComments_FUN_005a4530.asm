...
section .text
    ...
    PUSH 0x64f583                       ; 005a4537 | = "//" | s_anon_0064f583 = //
    PUSH EBX                            ; 005a453c
    CALL crt_string.c_strstr_FUN_005fedd0 ; 005a453d | char * crt_string.c_strstr_FUN_005fedd0(char * haystack_str, char * needle_str)
        ;   XREF to: 005fedd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005a4542
    TEST EAX,EAX                        ; 005a4545
    JZ 0x005a454c                       ; 005a4547 | LAB_005a454c
    ...
    MOV AL,byte ptr [ESI]               ; 005a4550
        ;   Label: LAB_005a4550
    CMP AL,DL                           ; 005a4552
    JZ 0x005a4568                       ; 005a4554 | LAB_005a4568
        ;   XREF to: 005a4568 (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 005a4556
    JZ 0x005a4566                       ; 005a4558 | LAB_005a4566
        ;   XREF to: 005a4566 (CONDITIONAL_JUMP)
    INC ESI                             ; 005a455a
    MOV AL,byte ptr [ESI]               ; 005a455b
    CMP AL,DL                           ; 005a455d
    JZ 0x005a4568                       ; 005a455f | LAB_005a4568
        ;   XREF to: 005a4568 (CONDITIONAL_JUMP)
    INC ESI                             ; 005a4561
    CMP AL,0x0                          ; 005a4562
    JNZ 0x005a4550                      ; 005a4564 | LAB_005a4550
    ...
    JBE 0x005a4582                      ; 005a456c | LAB_005a4582
        ;   XREF to: 005a4582 (CONDITIONAL_JUMP)
    MOV CL,byte ptr [EAX + -0x1]        ; 005a456e
        ;   Label: LAB_005a456e
    INC CL                              ; 005a4571
    AND ECX,0xff                        ; 005a4573
    TEST byte ptr [ECX + 0x6849c4],0x2  ; 005a4579 | char[256] g_CharacterClassificationTable
    JNZ 0x005a459e                      ; 005a4580 | LAB_005a459e
    ...
    TEST byte ptr [EAX + 0x6849c4],0x2  ; 005a4591 | char[256] g_CharacterClassificationTable
    JNZ 0x005a45a5                      ; 005a4598 | LAB_005a45a5
    ...
    JA 0x005a456e                       ; 005a45a1 | LAB_005a456e
        ;   XREF to: 005a456e (CONDITIONAL_JUMP)
    JMP 0x005a4582                      ; 005a45a3 | LAB_005a4582
    ...
    PUSH ESI                            ; 005a45b2
    PUSH EBX                            ; 005a45b3
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 005a45b4 | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
        ;   XREF to: 005fe5e0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005a45b9
    JMP 0x005a4588                      ; 005a45bc | LAB_005a4588
