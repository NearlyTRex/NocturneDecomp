...
section .text
    ...
    PUSH EDX                            ; 005a98b7
    CALL sound_sndmain.cpp_getSfxSlotFromHandle_FUN_005a5d00 ; 005a98b8 | CSfxSlot * sound_sndmain.cpp_getSfxSlotFromHandle_FUN_005a5d00(uint sfx_handle, int check_hardware_playback)
        ;   XREF to: 005a5d00 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 005a98bd
    ADD ESP,0x8                         ; 005a98bf
    TEST EAX,EAX                        ; 005a98c2
    JNZ 0x005a98c8                      ; 005a98c4 | LAB_005a98c8
    ...
    CALL sound_sndmain.cpp_CSfxSlot_compute_FUN_005a7100 ; 005a98da | int sound_sndmain.cpp_CSfxSlot_compute_FUN_005a7100(CSfxSlot * this_ptr, float delta_time)
        ;   XREF to: 005a7100 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [EBX + 0x70]      ; 005a98df
    ADD ESP,0x8                         ; 005a98e2
    TEST ECX,ECX                        ; 005a98e5
    JZ 0x005a98ff                       ; 005a98e7 | LAB_005a98ff
        ;   XREF to: 005a98ff (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [0x03f69268]      ; 005a98e9 | CSoundDevice * g_CSoundDevicePtr
    TEST ESI,ESI                        ; 005a98ef
    JZ 0x005a98ff                       ; 005a98f1 | LAB_005a98ff
        ;   XREF to: 005a98ff (CONDITIONAL_JUMP)
    PUSH 0x2                            ; 005a98f3
    PUSH EBX                            ; 005a98f5
    ...
    CALL sound_sndmain.cpp_unlockSound_FUN_005abdc0 ; 005a98ff | void sound_sndmain.cpp_unlockSound_FUN_005abdc0()
        ;   Label: LAB_005a98ff
