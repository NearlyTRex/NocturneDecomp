...
LAB_005a5242:
  ...
  if ((iVar5 == 0) ||
    ...
    fVar7 = (float10)iVar5 * (float10)2f;
    local_14->stream_read_position = 0;
    local_14->stream_write_position = 0;
    dVar8 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44 /* combine 2-byte values */(extraout_EDX,in_stack_00000020));
    local_14->streaming_buffer_size = (int)ROUND(fVar7);
    local_14->streaming_slot_index = SUB84 /* extract 2-byte value */(dVar8,0);
    ...
    local_14->stream_read_position = 0;
    local_14->stream_write_position = 0;
    dVar8 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44 /* combine 2-byte values */(extraout_EDX_00,in_stack_00000020));
    local_14->streaming_buffer_size = (int)ROUND(fVar7);
    local_14->streaming_slot_index = SUB84 /* extract 2-byte value */(dVar8,0);
    iVar5 = sound_sndmain_cpp_CSfxSample_allocateHwSample_FUN_005a6170(in_stack_ffffff08);
  }
