...
section .text
    ...
    JL 0x005a8aca                       ; 005a8aa7 | LAB_005a8aca
        ;   XREF to: 005a8aca (CONDITIONAL_JUMP)
    CMP EBX,0x2                         ; 005a8aa9
    JGE 0x005a8aca                      ; 005a8aac | LAB_005a8aca
        ;   XREF to: 005a8aca (CONDITIONAL_JUMP)
    MOV EAX,[0x03f624a4]                ; 005a8aae | int g_SfxLastSlot
        ;   Label: LAB_005a8aae
    ...
    PUSH EBX                            ; 005a8aca
        ;   Label: LAB_005a8aca
    MOV EDX,0x650812                    ; 005a8acb | = "..\\sound\\sndmain.cpp" | s_sound_sndmain_cpp_00650812 = ..\sound\sndmain.cpp
    MOV ECX,0xcf3                       ; 005a8ad0
    PUSH 0x650827                       ; 005a8ad5 | = "setNextSfxUserData - invalid user dat..." | s_setNextSfxUserData_inval_00650827 = setNextSfxUserData - invalid user data index: %d
    MOV dword ptr [0x02f0ca48],EDX      ; 005a8ada | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 005a8ae0 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005a8ae6 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005a8aeb
    JMP 0x005a8aae                      ; 005a8aee | LAB_005a8aae
