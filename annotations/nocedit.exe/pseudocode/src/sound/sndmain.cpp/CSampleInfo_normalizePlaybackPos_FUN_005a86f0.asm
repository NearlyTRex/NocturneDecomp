...
section .text
    ...
    PUSH ESI                            ; 005a870b
    PUSH EBX                            ; 005a870c
    CALL sound_sndmain.cpp_CSampleInfo_cvtPlaybackPos_FUN_005a8580 ; 005a870d | double sound_sndmain.cpp_CSampleInfo_cvtPlaybackPos_FUN_005a8580(CSampleInfo * this_ptr, double position, uint input_type, uint output_type)
    ...
    CALL sound_sndmain.cpp_CSfxSample_getLoopMode_FUN_005a87d0 ; 005a8726 | int sound_sndmain.cpp_CSfxSample_getLoopMode_FUN_005a87d0(CSfxSample * this_ptr)
        ;   XREF to: 005a87d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005a872b
    TEST EAX,EAX                        ; 005a872e
    JNZ 0x005a8793                      ; 005a8730 | LAB_005a8793
        ;   XREF to: 005a8793 (CONDITIONAL_JUMP)
    FLDZ                                ; 005a8732
    FCOMP double ptr [ESP + 0x28]       ; 005a8734
    FNSTSW AX                           ; 005a8738
    SAHF                                ; 005a873a
    JA 0x005a87bb                       ; 005a873b | LAB_005a87bb
        ;   XREF to: 005a87bb (CONDITIONAL_JUMP)
    FLD1                                ; 005a8741
    FCOMP double ptr [ESP + 0x28]       ; 005a8743
    FNSTSW AX                           ; 005a8747
    SAHF                                ; 005a8749
    JNC 0x005a875b                      ; 005a874a | LAB_005a875b
    ...
    PUSH EAX                            ; 005a876b
    PUSH EBX                            ; 005a876c
    CALL sound_sndmain.cpp_CSampleInfo_cvtPlaybackPos_FUN_005a8580 ; 005a876d | double sound_sndmain.cpp_CSampleInfo_cvtPlaybackPos_FUN_005a8580(CSampleInfo * this_ptr, double position, uint input_type, uint output_type)
        ;   XREF to: 005a8580 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 005a879c
    CALL crt_math.c_floor_FUN_005feb90  ; 005a879d | double crt_math.c_floor_FUN_005feb90(double input_value)
    ...
    JMP 0x005a875b                      ; 005a87b9 | LAB_005a875b
    ...
    JMP 0x005a875b                      ; 005a87c5 | LAB_005a875b
        ;   XREF to: 005a875b (UNCONDITIONAL_JUMP)
