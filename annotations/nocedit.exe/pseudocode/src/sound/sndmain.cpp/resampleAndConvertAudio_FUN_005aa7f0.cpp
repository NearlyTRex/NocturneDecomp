          ...
          if (src_channels == 1) {
            if (dst_channels == 1) {
              ...
              if (0 < num_output_samples) {
                do {
                  uVar1 = *(byte *)
                           ((int)ROUND(ROUND((float)iVar10 * fVar2)) + (int)src_buffer);
                  *(byte *)((int)psVar9 + 1) = uVar1;
                  iVar10 = iVar10 + 1;
                  *(byte *)psVar9 = uVar1;
                  psVar9 = psVar9 + 1;
            ...
            if (0 < num_output_samples) {
              do {
                ...
                *(char *)psVar9 = (char)src_buffer[(int)ROUND(ROUND(fVar4 * fVar2))];
                iVar10 = iVar10 + 1;
                *(byte *)((int)psVar9 + 1) =
                     *(byte *)((int)src_buffer + (int)ROUND(ROUND(fVar4 * fVar2)) * 2 + 1);
                psVar9 = psVar9 + 1;
              } while (iVar10 < num_output_samples);
            }
          }
          ...
          if (dst_channels == 1) {
            ...
            if (0 < num_output_samples) {
              do {
                fVar4 = (float)iVar10;
                iVar10 = iVar10 + 1;
                *psVar9 = (short)*(char *)((int)ROUND(ROUND(fVar4 * fVar2)) + (int)src_buffer) << 8;
                psVar9 = psVar9 + 1;
              } while (iVar10 < num_output_samples);
            }
          }
            ...
            if (0 < num_output_samples) {
              do {
                sVar4 = (short)*(char *)((int)ROUND(ROUND((float)iVar10 * fVar2)) + (int)src_buffer)
                        << 8;
                psVar9[1] = sVar4;
                iVar10 = iVar10 + 1;
                *psVar9 = sVar4;
          ...
          if (0 < num_output_samples) {
            do {
              ...
              *psVar9 = (char)src_buffer[(int)ROUND(ROUND(fVar4 * fVar2))] * 0x80 +
                        *(char *)((int)src_buffer + (int)ROUND(ROUND(fVar4 * fVar2)) * 2 + 1) * 0x80
              ;
              psVar9 = psVar9 + 1;
            } while (iVar10 < num_output_samples);
          }
          ...
          if (0 < num_output_samples) {
            do {
              ...
              *psVar9 = (short)(char)src_buffer[(int)ROUND(ROUND(fVar4 * fVar2))] << 8;
              iVar10 = iVar10 + 1;
              psVar9[1] = (short)*(char *)((int)src_buffer +
