    ...
    if (((src_sample_rate == dst_sample_rate) && (src_bit_depth == dst_bit_depth)) &&
      ...
      if (src_buffer != dst_buffer) {
        ...
        for (uVar5 = uVar4 >> 2; uVar5 != 0; uVar5 = uVar5 - 1) {
          *(undefined4 *)psVar8 = *(undefined4 *)src_buffer;
            ...
            if (dst_channels == 1) {
              ...
              if (0 < num_output_samples) {
                ...
                do {
                  ...
                  dVar12 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44(iVar6,src_buffer));
                  src_buffer = SUB84(dVar12,0);
                  iVar6 = (int)((ulonglong)dVar12 >> 0x20) + 1;
                  *(undefined1 *)psVar8 = *(undefined1 *)((int)ROUND(fVar11) + (int)src_buffer);
                  psVar8 = (short *)((int)psVar8 + 1);
              ...
              if (0 < num_output_samples) {
                ...
                do {
                  fVar11 = (float10)iVar6 * fVar10;
                  dVar12 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44(psVar8,src_buffer));
                  puVar7 = (undefined1 *)((ulonglong)dVar12 >> 0x20);
                  src_buffer = SUB84(dVar12,0);
                  psVar8 = (short *)(puVar7 + 2);
                  uVar1 = *(undefined1 *)((int)ROUND(fVar11) + (int)src_buffer);
                  puVar7[1] = uVar1;
                  iVar6 = iVar6 + 1;
                  *puVar7 = uVar1;
                } while (iVar6 < num_output_samples);
            ...
            if (0 < num_output_samples) {
              ...
              do {
                ...
                *(char *)psVar8 = (char)src_buffer[(int)ROUND(fVar11)];
                iVar6 = (int)((ulonglong)dVar12 >> 0x20) + 1;
                *(undefined1 *)((int)psVar8 + 1) =
                     *(undefined1 *)((int)src_buffer + (int)ROUND(fVar11) * 2 + 1);
                psVar8 = psVar8 + 1;
              } while (iVar6 < num_output_samples);
            }
          }
        ...
        if (src_channels == 1) {
          if (dst_channels == 1) {
            ...
            if (0 < num_output_samples) {
              ...
              do {
                ...
                src_buffer = SUB84(dVar12,0);
                psVar8 = (short *)(puVar7 + 2);
                local_14 = (undefined1)((ushort)src_buffer[(int)ROUND(fVar11)] >> 8);
                puVar7[1] = local_14;
                iVar6 = iVar6 + 1;
                *puVar7 = local_14;
              } while (iVar6 < num_output_samples);
          ...
          if (0 < num_output_samples) {
            ...
            do {
              ...
              dVar12 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44(iVar6,src_buffer));
              src_buffer = SUB84(dVar12,0);
              local_14 = (undefined1)((ushort)src_buffer[(int)ROUND(fVar11) * 2] >> 8);
              *(undefined1 *)psVar8 = local_14;
              local_14 = (undefined1)
                         ((uint)*(undefined4 *)(src_buffer + (int)ROUND(fVar11) * 2) >> 0x18);
              iVar6 = (int)((ulonglong)dVar12 >> 0x20) + 1;
              *(undefined1 *)((int)psVar8 + 1) = local_14;
              psVar8 = psVar8 + 1;
            } while (iVar6 < num_output_samples);
          }
        }
...
//   XREF to: Stack[0x28] (READ)
// 005aa8a7: PUSH EDX
// 005aa8a8: CALL sound_sndmain.cpp_convert8BitAudioSignedness_FUN_005aa7b0
...
//   XREF to: Stack[0x28] (READ)
// 005aadec: PUSH EAX
// 005aaded: CALL sound_sndmain.cpp_convert16BitAudioSignedness_FUN_005aa7d0
