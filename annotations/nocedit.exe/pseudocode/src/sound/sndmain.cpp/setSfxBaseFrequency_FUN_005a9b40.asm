...
section .text
    ...
    PUSH EDX                            ; 005a9b47
    CALL sound_sndmain.cpp_getSfxSlotFromHandle_FUN_005a5d00 ; 005a9b48 | CSfxSlot * sound_sndmain.cpp_getSfxSlotFromHandle_FUN_005a5d00(uint sfx_handle, int check_hardware_playback)
        ;   XREF to: 005a5d00 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 005a9b4d
    ADD ESP,0x8                         ; 005a9b4f
    TEST EAX,EAX                        ; 005a9b52
    JNZ 0x005a9b58                      ; 005a9b54 | LAB_005a9b58
    ...
    CALL sound_sndmain.cpp_CSfxSlot_compute_FUN_005a7100 ; 005a9b63 | int sound_sndmain.cpp_CSfxSlot_compute_FUN_005a7100(CSfxSlot * this_ptr, float delta_time)
        ;   XREF to: 005a7100 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [EBX + 0x70]      ; 005a9b68
    ADD ESP,0x8                         ; 005a9b6b
    TEST ECX,ECX                        ; 005a9b6e
    JZ 0x005a9b88                       ; 005a9b70 | LAB_005a9b88
        ;   XREF to: 005a9b88 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [0x03f69268]      ; 005a9b72 | CSoundDevice * g_CSoundDevicePtr
    TEST ESI,ESI                        ; 005a9b78
    JZ 0x005a9b88                       ; 005a9b7a | LAB_005a9b88
        ;   XREF to: 005a9b88 (CONDITIONAL_JUMP)
    PUSH 0x10                           ; 005a9b7c
    PUSH EBX                            ; 005a9b7e
    ...
    CALL sound_sndmain.cpp_unlockSound_FUN_005abdc0 ; 005a9b88 | void sound_sndmain.cpp_unlockSound_FUN_005abdc0()
        ;   Label: LAB_005a9b88
