...
section .text
    ...
    CALL sound_sndmain.cpp_hasHardware3DSound_FUN_005ab5a0 ; 005a9660 | uint sound_sndmain.cpp_hasHardware3DSound_FUN_005ab5a0()
        ;   Label: sound_sndmain.cpp_isSfxPlaying_FUN_005a9660
        ;   XREF to: 005ab5a0 (UNCONDITIONAL_CALL)
    TEST EAX,EAX                        ; 005a9665
    JZ 0x005a9688                       ; 005a9667 | LAB_005a9688
        ;   XREF to: 005a9688 (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 005a9669
    MOV ECX,dword ptr [ESP + 0x8]       ; 005a966b
    PUSH ECX                            ; 005a966f
    CALL sound_sndmain.cpp_getSfxSlotFromHandle_FUN_005a5d00 ; 005a9670 | CSfxSlot * sound_sndmain.cpp_getSfxSlotFromHandle_FUN_005a5d00(uint sfx_handle, int check_hardware_playback)
        ;   XREF to: 005a5d00 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005a9675
    TEST EAX,EAX                        ; 005a9678
    JNZ 0x005a967d                      ; 005a967a | LAB_005a967d
        ;   XREF to: 005a967d (CONDITIONAL_JUMP)
    RET                                 ; 005a967c
    CALL sound_sndmain.cpp_unlockSound_FUN_005abdc0 ; 005a967d | void sound_sndmain.cpp_unlockSound_FUN_005abdc0()
        ;   Label: LAB_005a967d
    ...
    PUSH EDX                            ; 005a968d
    CALL sound_sndmain.cpp_getSfxSlotFromHandle_FUN_005a5d00 ; 005a968e | CSfxSlot * sound_sndmain.cpp_getSfxSlotFromHandle_FUN_005a5d00(uint sfx_handle, int check_hardware_playback)
        ;   XREF to: 005a5d00 (UNCONDITIONAL_CALL)
