...
// Convention: __cdecl
// Signature: int __cdecl sound_sndmain_cpp_parseWavFile_FUN_005a3fe0 (FILE *file_handle,long *file_offset_ptr,CSfxSample *sfx_sample)
...

{
  ...
  if (iVar2 == 0) {
    SVar3 = crt_stdio_c_fread_FUN_005fd990(&local_18,8,1,file_handle);
    if (SVar3 == 1) {
      if ((((local_18 == 'R') && (local_17 == 'I')) && (local_16 == 'F')) && (local_15 == 'F')) {
        iVar2 = local_14 + 8;
        SVar3 = crt_stdio_c_fread_FUN_005fd990(&local_88,4,1,file_handle);
        if (SVar3 == 1) {
          if (((local_88 == 'W') && (local_87 == 'A')) && ((local_86 == 'V' && (local_85 == 'E'))))
          {
            iVar5 = 0xc;
            do {
              iVar4 = crt_stdio_c_fseek_FUN_005ffacc(file_handle,*file_offset_ptr + iVar5,0);
              ...
              if (((local_18 == 'f') && (local_17 == 'm')) && (local_16 == 't')) {
                ...
                SVar3 = crt_stdio_c_fread_FUN_005fd990(&local_24,10,1,file_handle);
                if (SVar3 != 1) goto LAB_005a4007;
                if ((short)local_24 != 1) {
