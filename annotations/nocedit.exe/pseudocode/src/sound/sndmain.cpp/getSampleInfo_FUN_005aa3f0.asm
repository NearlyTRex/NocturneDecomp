...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl sound_sndmain_cpp_getSampleInfo_FUN_005aa3f0(CSfxSample *out_sample)
;
; Parameters:
...
section .text
    ...
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 005aa44c
    ...
    PUSH EAX                            ; 005aa4af
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 005aa4b0
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)  ; int crt_string.c_stricmp_FUN_005fe7f0(char * str1, char * str2)
    ...
    PUSH EAX                            ; 005aa56c
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 005aa56d
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)  ; int crt_string.c_stricmp_FUN_005fe7f0(char * str1, char * str2)
