          ...
          if (((local_88 == 'W') && (local_87 == 'A')) && ((local_86 == 'V' && (local_85 == 'E'))))
          {
            ...
            do {
              ...
              if (((local_18 == 'f') && (local_17 == 'm')) && (local_16 == 't')) {
                ...
                if (((short)(local_24 >> 16) == 0) || (2 < (short)(local_24 >> 16))) {
                  _sprintf
                            (&local_88,"Invalid number of channels: %u  (must be 1 or 2)",(uint)(short)(local_24 >> 16));
                  sound_sndmain_cpp_logSoundError_FUN_005adba0
                            ("WAV file is invalid: %s\n",&local_88);
                  goto LAB_005a4007;
                }
                sVar1 = (short)(local_24 >> 16) * (short)local_20;
  ...
  while( true ) {
    ...
    if (((local_18 == 'd') && (local_17 == 'a')) && ((local_16 == 't' && (local_15 == 'a')))) {
      *file_offset_ptr = *file_offset_ptr + iVar5 + 8;
      (sfx_sample->sample_info).num_channels = (uint)(short)(local_24 >> 16);
      (sfx_sample->sample_info).sample_count =
           (int)(local_14 / (uint)(short)(local_24 >> 16) /
                ((uint)(sfx_sample->sample_info).bit_depth / 8));
