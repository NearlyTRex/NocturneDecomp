...
section .text
    ...
    PUSH EDX                            ; 005a9827
    CALL sound_sndmain.cpp_getSfxSlotFromHandle_FUN_005a5d00 ; 005a9828
    ...
    JNZ 0x005a9838                      ; 005a9834
        ;   XREF to: 005a9838 (CONDITIONAL_JUMP)  ; LAB_005a9838
    POP EBX                             ; 005a9836
    RET                                 ; 005a9837
    PUSH EDI                            ; 005a9838
        ;   Label: LAB_005a9838
    ...
    CALL sound_sndmain.cpp_CSfxSlot_compute_FUN_005a7100 ; 005a987a
    ...
    JZ 0x005a98a1                       ; 005a9887
        ;   XREF to: 005a98a1 (CONDITIONAL_JUMP)  ; LAB_005a98a1
    MOV EDI,dword ptr [0x03f69268]      ; 005a9889 | g_CSoundDevicePtr
    TEST EDI,EDI                        ; 005a988f
    JZ 0x005a98a1                       ; 005a9891
        ;   XREF to: 005a98a1 (CONDITIONAL_JUMP)  ; LAB_005a98a1
    PUSH 0x2                            ; 005a9893
    PUSH EBX                            ; 005a9895
    ...
    CALL sound_sndmain.cpp_unlockSound_FUN_005abdc0 ; 005a98a1
