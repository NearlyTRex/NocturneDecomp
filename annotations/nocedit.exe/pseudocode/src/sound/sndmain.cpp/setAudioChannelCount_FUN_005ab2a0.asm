...
section .text
    ...
    CALL sound_sndmain.cpp_getAudioSampleRate_FUN_005ab260 ; 005ab2a0 | int sound_sndmain.cpp_getAudioSampleRate_FUN_005ab260()
    ...
    PUSH EDX                            ; 005ab2aa
    CALL sound_sndmain.cpp_getAudioBitDepth_FUN_005ab250 ; 005ab2ab | int sound_sndmain.cpp_getAudioBitDepth_FUN_005ab250()
        ;   XREF to: 005ab250 (UNCONDITIONAL_CALL)
    PUSH EAX                            ; 005ab2b0
    CALL sound_sndmain.cpp_setSoundOutputMode_FUN_005ab170 ; 005ab2b1 | int sound_sndmain.cpp_setSoundOutputMode_FUN_005ab170(int bits_per_sample, int channels, int sample_rate)
