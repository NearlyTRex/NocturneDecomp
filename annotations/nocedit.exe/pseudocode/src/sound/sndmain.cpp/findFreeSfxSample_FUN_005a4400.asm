...
section .text
    ...
    MOV EDX,dword ptr [0x03f62828]      ; 005a4400 | g_LastSampleAccessIndex
        ;   Label: sound_sndmain.cpp_findFreeSfxSample_FUN_005a4400
    ...
    IMUL ECX,EDX,0x180                  ; 005a4410
        ;   Label: LAB_005a4410
    CMP dword ptr [ECX + 0x3f6297c],0x0 ; 005a4416 | g_SfxSamples[0].taken | g_SfxSamples[1].taken
    ...
    RET                                 ; 005a442d
    CMP dword ptr [ECX + 0x3f62980],0x0 ; 005a442e | g_SfxSamples[1].ref_count
        ;   Label: LAB_005a442e
    JNZ 0x005a441f                      ; 005a4435
        ;   XREF to: 005a441f (CONDITIONAL_JUMP)  ; LAB_005a441f
    MOV EAX,0x3f6282c                   ; 005a4437 | g_SfxSamples
    ADD EAX,ECX                         ; 005a443c | g_SfxSamples[1].sample_info.name[0]
