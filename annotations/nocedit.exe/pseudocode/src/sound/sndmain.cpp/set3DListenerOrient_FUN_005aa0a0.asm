...
section .text
    ...
    MOV [0x03f68860],EAX                ; 005aa0a5 | CVector3d g_Cached3DListenerOrientFront
    ...
    MOV [0x03f68878],EAX                ; 005aa0db | CVector3d g_Cached3DListenerOrientUp
    ...
    MOV [0x03f68890],EAX                ; 005aa111 | CVector3d g_Cached3DListenerOrientRight
    ...
    MOV EDX,dword ptr [0x03f69268]      ; 005aa13e | CSoundDevice * g_CSoundDevicePtr
    MOV [0x03f688a4],EAX                ; 005aa144 | g_Cached3DListenerOrientRight.z+4
    TEST EDX,EDX                        ; 005aa149
    JNZ 0x005aa14f                      ; 005aa14b | LAB_005aa14f
