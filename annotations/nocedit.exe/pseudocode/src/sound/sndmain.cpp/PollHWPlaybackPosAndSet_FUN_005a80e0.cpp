// Name: sound_sndmain.cpp_PollHWPlaybackPosAndSet_FUN_005a80e0
// Address: 005a80e0
// Address Range: [[005a80e0, 005a8167]]
// Convention: unknown
// Signature: undefined sound_sndmain.cpp_PollHWPlaybackPosAndSet_FUN_005a80e0()
// Cross-references:
...
//   sound_sndmain.cpp_SfxSlot_pollStream_FUN_005a6730 (005a6730) at 005a67e4 [UNCONDITIONAL_CALL]
// Globals:
...
/* Signature: undefined1 sound_sndmain.cpp_PollHWPlaybackPosAndSet(undefined4 param_1) */

undefined4 sound_sndmain_cpp_PollHWPlaybackPosAndSet_FUN_005a80e0(void)

{
  double dVar1;
  int in_stack_00000004;
  
  if (((*(int *)(in_stack_00000004 + 0x70) != 0) && (g_CSoundInstance != (CSound *)0x0)) &&
     (*(int *)(in_stack_00000004 + 0x78) != 0)) {
    dVar1 = (double)(*(code *)g_CSoundInstance->vtable[1].func3)();
    if (dVar1 < 0.0) {
      sound_sndmain_cpp_HandleSoundError_FUN_005adba0();
      return 0;
    }
    sound_sndmain_cpp_SfxSlot_updatePlaybackPos_FUN_005a8170();
    return 1;
  }
  return 0;
}
...
// Assembly code:
// 005a80e0: PUSH EBX
//   Label: sound_sndmain.cpp_PollHWPlaybackPosAndSet_FUN_005a80e0
// 005a80e1: PUSH EDI
// 005a80e2: PUSH EBP
...
// 005a8153: PUSH EAX
// 005a8154: PUSH EBX
// 005a8155: CALL sound_sndmain.cpp_SfxSlot_updatePlaybackPos_FUN_005a8170
