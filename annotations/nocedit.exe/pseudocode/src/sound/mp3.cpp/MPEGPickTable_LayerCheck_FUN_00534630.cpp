// Name: sound_mp3.cpp_MPEGPickTable_LayerCheck_FUN_00534630
// Address: 00534630
// Address Range: [[00534630, 005349dd]]
// Convention: unknown
// Signature: undefined sound_mp3.cpp_MPEGPickTable_LayerCheck_FUN_00534630()
// Cross-references:
//   sound_mp3.cpp_OpenAndPrepareDecoding_FUN_00534550 (00534550) at 005345af [UNCONDITIONAL_CALL]
...
/* Signature: undefined1 sound_mp3.cpp_MPEGPickTable_LayerCheck(undefined4 param_1, undefined4
   param_2, undefined4 param_3) */

void sound_mp3_cpp_MPEGPickTable_LayerCheck_FUN_00534630(void)

{
  ...
  puVar8 = (undefined4 *)(in_stack_00000008 + 0x5320);
  if ((FILE *)*puVar8 != (FILE *)0x0) {
    shape_memdbg_cpp_closeFile_FUN_0050f9b0((FILE *)*puVar8,"..\\sound\\mp3.cpp",0x20b);
    *puVar8 = 0;
  }
  if (*(void **)(in_stack_00000008 + 0x5324) != (void *)0x0) {
    shape_memdbg_cpp_debugFree_FUN_0050f460
              (*(void **)(in_stack_00000008 + 0x5324),"..\\sound\\mp3.cpp",0x210);
    *(undefined4 *)(in_stack_00000008 + 0x5324) = 0;
  }
  *puVar8 = in_stack_0000000c;
  lVar2 = crt_stdio_c_ftell_FUN_00601560(in_stack_0000000c);
  *(long *)(in_stack_00000008 + 0x5340) = lVar2;
  *(undefined4 *)(in_stack_00000008 + 0x5344) = 0x1000;
  *(int *)(in_stack_00000008 + 0x5328) = unaff_EBP;
  pvVar3 = shape_memdbg_cpp_debugMalloc_FUN_0050f250(unaff_EBP,"..\\sound\\mp3.cpp",0x1ff);
  *(void **)(in_stack_00000008 + 0x5324) = pvVar3;
  if (pvVar3 == (void *)0x0) {
    g_CurrentFilename = "..\\sound\\mp3.cpp";
    g_CurrentLineNumber = 0x200;
    core_main_c_displayErrorAndQuit_FUN_00506f10("Out of memory.  File: %s",&DAT_02f68188);
  }
  crt_stdio_c_fseek_FUN_005ffacc((FILE *)*puVar8,*(long *)(in_stack_00000008 + 0x5340),0);
  *(undefined4 *)(in_stack_00000008 + 0x5330) = 0;
  *(undefined4 *)(in_stack_00000008 + 0x5334) = 0;
  *(undefined4 *)(in_stack_00000008 + 0x532c) = 0;
  *(undefined4 *)(in_stack_00000008 + 0x5348) = *(undefined4 *)(in_stack_00000008 + 0x5344);
  *(undefined4 *)(in_stack_00000008 + 0x5338) = 0;
  *(undefined4 *)(in_stack_00000008 + 0x533c) = 0;
  if ((*(uint *)(in_stack_0000001c + 0x532c) & 7) != 0) {
    sound_mp3_cpp_ReadOrWriteBits_FUN_0052ef40();
  }
  uVar4 = sound_mp3_cpp_ReadOrWriteBits_FUN_0052ef40();
  while (((uVar4 & 0x1fff) != 0xfff && (*(int *)(in_stack_0000001c + 0x533c) == 0))) {
    uVar5 = sound_mp3_cpp_ReadOrWriteBits_FUN_0052ef40();
    uVar4 = uVar4 << 8 | uVar5;
  }
  ...
  if (local_24[1] == 2) {
    ...
    iVar1 = *local_24;
    fVar9 = (float10)*(double *)(&DAT_0067e218 + local_24[4] * 8 + iVar1 * 0x20);
    dVar10 = crt_math_c_round_FUN_005fe6b0
                       ((double)CONCAT44(*(int *)(&DAT_0067e258 +
                                                 local_24[3] * 4 + iVar1 * 0xb4 + unaff_ESI * 0x3c)
                                         / (int)((local_24[7] != 3) + 1),iVar1 * 0x20));
    iVar7 = (int)((ulonglong)dVar10 >> 0x20);
    iVar6 = (int)ROUND(fVar9);
    if (iVar1 == 1) {
      if (((iVar6 == 0x30) && (0x37 < iVar7)) || ((0x37 < iVar7 && (iVar7 < 0x51)))) {
        iVar6 = 0;
      }
      else if ((iVar6 == 0x30) || (iVar7 < 0x60)) {
        if ((iVar6 == 0x20) || (0x30 < iVar7)) {
          iVar6 = 3;
        }
        else {
          iVar6 = 2;
    ...
    if (iVar6 != *(int *)(in_stack_00000008 + 0xc)) {
      g_CurrentFilename = "..\\sound\\mp3.cpp";
  ...
  fVar9 = (float10)*(double *)(&DAT_0067e218 + local_3c * 8 + iStack_4c * 0x20) *
          (float10)_DAT_0063b2aa;
  ...
  *(int *)((int)((ulonglong)dVar10 >> 0x20) + 0x104) = unaff_ESI;
...
// Assembly code:
// 00534630: PUSH EBX
//   Label: sound_mp3.cpp_MPEGPickTable_LayerCheck_FUN_00534630
// 00534631: PUSH ESI
// 00534632: PUSH EDI
// 00534633: PUSH EBP
...
// 0053463b: PUSH EDX
// 0053463c: CALL sound_mp3.cpp_FreeSomething1_FUN_005349e0
...
//   Label: LAB_00534751
// 00534752: PUSH ESI
// 00534753: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
...
// 00534772: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
...
// 005347a3: PUSH ECX
// 005347a4: PUSH EAX
// 005347a5: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
...
// 005347c6: PUSH EAX
// 005347c7: CALL sound_mp3.cpp_ReadOrwriteMultiBits_FUN_0052f5b0
...
// 00534956: CALL sound_mp3.cpp_FUN_00534ba0
