...
;                               FUNCTION
; *****************************************************************************
; __cdecl void sound_mp3.cpp_CFileBitStream_reset_FUN_0052eca0(CFileBitStream * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH ECX                            ; 0052ecad
    CALL crt_stdio.c_fseek_FUN_005ffacc ; 0052ecae | int crt_stdio.c_fseek_FUN_005ffacc(FILE * file, long offset, int whence)
