...
// Convention: __cdecl
// Signature: void sound_mp3.cpp_CFileBitStream_readScaleFactorsSCFSI_FUN_0052f8e0(CFileBitStream * this_ptr, SMpegSubbandSCFSI * scfsi_array, SMpegSubbandAllocation * allocation_array, SMpegSubbandScalefactors * scalefactor_array, SBitAllocationTable * allocation_table)
// Cross-references:
//   sound_mp3.cpp_CMP3Decoder_decodeFrame_FUN_00534d40 (00534d40) at 005353f2 [UNCONDITIONAL_CALL]
// Globals:
...

{
  ...
  if (iVar3 < 0x20) {
    ...
    do {
      iVar5 = 0;
      if (0 < iVar1) {
        puVar7 = (undefined4 *)((int)scfsi_array->scfsi + iVar4);
        do {
          iVar5 = iVar5 + 1;
          *puVar7 = 0;
          puVar7 = puVar7 + 0x20;
    ...
    do {
      ...
      if (0 < iVar1) {
        ...
        do {
          ...
          switch(*(undefined4 *)((int)scfsi_array[iVar4].scfsi + local_24)) {
          case 0:
...
switchD_0052f9f0_default:
  ...
  if (iVar3 < 0x20) {
    ...
    do {
      iVar4 = 0;
      if (0 < iVar1) {
        puVar7 = (undefined4 *)((int)scalefactor_array->codes[0] + iVar3);
        do {
          puVar7[0x40] = 0x3f;
...
//   Label: caseD_0
// 0052f9f9: PUSH ESI
// 0052f9fa: CALL sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
// 0052f9ff: ADD ESP,0x8
// 0052fa02: PUSH 0x6
// 0052fa04: PUSH ESI
// 0052fa05: MOV dword ptr [EBX],EAX
// 0052fa07: CALL sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
// 0052fa0c: ADD ESP,0x8
// 0052fa0f: PUSH 0x6
// 0052fa11: PUSH ESI
// 0052fa12: MOV dword ptr [EBX + 0x80],EAX
// 0052fa18: CALL sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40
//   Label: LAB_0052fa18
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
...
//   Label: LAB_0052faa4
// 0052faa6: PUSH ESI
// 0052faa7: CALL sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
...
//   Label: caseD_1
// 0052faca: PUSH ESI
// 0052facb: CALL sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
...
//   Label: caseD_3
// 0052fae5: PUSH ESI
// 0052fae6: CALL sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
// 0052faeb: ADD ESP,0x8
// 0052faee: PUSH 0x6
// 0052faf0: PUSH ESI
// 0052faf1: MOV dword ptr [EBX],EAX
// 0052faf3: CALL sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
...
//   Label: caseD_2
// 0052fb0e: PUSH ESI
// 0052fb0f: CALL sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
