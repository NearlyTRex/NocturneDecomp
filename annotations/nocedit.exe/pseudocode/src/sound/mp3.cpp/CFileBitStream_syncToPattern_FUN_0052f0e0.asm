...
section .text
    ...
    JNZ 0x0052f12f                      ; 0052f100 | LAB_0052f12f
        ;   XREF to: 0052f12f (CONDITIONAL_JUMP)
    PUSH EBX                            ; 0052f102
        ;   Label: LAB_0052f102
    PUSH ESI                            ; 0052f103
    CALL sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40 ; 0052f104 | uint sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40(CFileBitStream * bitstream, int num_bits)
    ...
    PUSH EDX                            ; 0052f136
    PUSH ESI                            ; 0052f137
    CALL sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40 ; 0052f138 | uint sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40(CFileBitStream * bitstream, int num_bits)
        ;   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0052f13d
    JMP 0x0052f102                      ; 0052f140 | LAB_0052f102
        ;   XREF to: 0052f102 (UNCONDITIONAL_JUMP)
    PUSH 0x8                            ; 0052f142
        ;   Label: LAB_0052f142
    PUSH ESI                            ; 0052f144
    SHL EBX,0x8                         ; 0052f145
    CALL sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40 ; 0052f148 | uint sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40(CFileBitStream * bitstream, int num_bits)
        ;   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0052f14d
    OR EBX,EAX                          ; 0052f150
    JMP 0x0052f10e                      ; 0052f152 | LAB_0052f10e
