// Name: sound_mp3.cpp_FreeSomething1_FUN_005349e0
// Address: 005349e0
// Address Range: [[005349e0, 00534a5e]]
// Convention: unknown
// Signature: undefined sound_mp3.cpp_FreeSomething1_FUN_005349e0()
// Cross-references:
//   sound_mp3.cpp_CMP3Decoder_dtor_FUN_00534530 (00534530) at 00534536 [UNCONDITIONAL_CALL]
//   sound_mp3.cpp_MPEGPickTable_LayerCheck_FUN_00534630 (00534630) at 0053463c [UNCONDITIONAL_CALL]
...
/* Signature: undefined1 sound_mp3.cpp_FreeSomething1(undefined4 param_1) */

void sound_mp3_cpp_FreeSomething1_FUN_005349e0(void)

{
  ...
  *(undefined4 *)(in_stack_00000004 + 0x108) = 0;
  file_ptr = *(FILE **)(in_stack_00000004 + 0x5320);
  if (file_ptr == (FILE *)0x0) {
    ptr = *(void **)(in_stack_00000004 + 0x5324);
    if (ptr == (void *)0x0) {
      *in_stack_00000004 = 0;
      return;
    }
    ...
    *(undefined4 *)(in_stack_00000004 + 0x5320) = 0;
    ptr = *(void **)(in_stack_00000004 + 0x5324);
    if (ptr == (void *)0x0) {
      *in_stack_00000004 = 0;
      return;
  ...
  *(undefined4 *)(in_stack_00000004 + 0x5324) = 0;
  *in_stack_00000004 = 0;
  return;
}
...
// Assembly code:
// 005349e0: PUSH EBX
//   Label: sound_mp3.cpp_FreeSomething1_FUN_005349e0
// 005349e1: PUSH ESI
// 005349e2: PUSH EDI
