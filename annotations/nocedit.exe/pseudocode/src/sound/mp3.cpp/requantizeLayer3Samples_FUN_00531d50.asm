...
;                               FUNCTION
; *****************************************************************************
; __cdecl void sound_mp3.cpp_requantizeLayer3Samples_FUN_00531d50(SMpegSubbandQuantizedSamples * quantized_samples, SMpegSubbandSamples * output_samples, int * scalefactor_data, SMpegLayer3Granule * granule_info, int channel_index, SMpegLayer3Granule * * granule_array)
;
; Parameters:
...
section .text
    ...
    JZ 0x00531faf                       ; 00531d7b | LAB_00531faf
        ;   XREF to: 00531faf (CONDITIONAL_JUMP)
    CMP dword ptr [ECX + 0x14],0x2      ; 00531d81
    JNZ 0x00531faf                      ; 00531d85 | LAB_00531faf
        ;   XREF to: 00531faf (CONDITIONAL_JUMP)
    ...
    JZ 0x00531f85                       ; 00531da2 | LAB_00531f85
        ;   XREF to: 00531f85 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EDX + 0x67e6cc]  ; 00531da8 | DAT_0067e6cc
    MOV dword ptr [ESP + 0x5c],EAX      ; 00531dae
        ;   Label: LAB_00531dae
    MOV EDX,dword ptr [0x02f45984]      ; 00531db2 | int g_MpegRequantTablesInitialized
        ;   Label: LAB_00531db2
    TEST EDX,EDX                        ; 00531db8
    JZ 0x00531fc9                       ; 00531dba | LAB_00531fc9
    ...
    JZ 0x00532050                       ; 00531e91 | LAB_00532050
    ...
    JNZ 0x0053203f                      ; 00531ea5 | LAB_0053203f
    ...
    JNZ 0x00532094                      ; 00531ee9 | LAB_00532094
    ...
    JNZ 0x00531e60                      ; 00531f3a | LAB_00531e60
    ...
    JL 0x00531e1c                       ; 00531f78 | LAB_00531e1c
    ...
    JMP 0x00531db2                      ; 00531faa | LAB_00531db2
    ...
    MOV EAX,dword ptr [EAX*0x4 + 0x67e6cc] ; 00531fbd | DAT_0067e6cc
    JMP 0x00531dae                      ; 00531fc4 | LAB_00531dae
        ;   XREF to: 00531dae (UNCONDITIONAL_JUMP)
    XOR EBX,EBX                         ; 00531fc9
        ;   Label: LAB_00531fc9
    FLD double ptr [0x0063b04a]         ; 00531fcb | double DOUBLE_0063b04a
    MOV dword ptr [ESP + 0x64],EDX      ; 00531fd1
        ;   Label: LAB_00531fd1
    FLD ST0                             ; 00531fd5
    FILD dword ptr [ESP + 0x64]         ; 00531fd7
    CALL crt_math.c_pow_FUN_005ffd76    ; 00531fdb | float10 crt_math.c_pow_FUN_005ffd76(float10 x, float10 y)
        ;   XREF to: 005ffd76 (UNCONDITIONAL_CALL)
    ADD EBX,0x8                         ; 00531fe0
    INC EDX                             ; 00531fe3
    FSTP double ptr [EBX + 0x2f45980]   ; 00531fe4 | double[200] g_MpegRequantPowerTable
    CMP EDX,0xc8                        ; 00531fea
    JL 0x00531fd1                       ; 00531ff0 | LAB_00531fd1
        ;   XREF to: 00531fd1 (CONDITIONAL_JUMP)
    FSTP ST0                            ; 00531ff2
    XOR EDX,EDX                         ; 00531ff4
    XOR EBX,EBX                         ; 00531ff6
    FLD double ptr [0x0063b052]         ; 00531ff8 | double DOUBLE_0063b052
    FLD double ptr [0x0063b042]         ; 00531ffe | double DOUBLE_0063b042
    ...
    FMUL ST1                            ; 00532010
    FLD ST2                             ; 00532012
    CALL crt_math.c_pow_FUN_005ffd76    ; 00532014 | float10 crt_math.c_pow_FUN_005ffd76(float10 x, float10 y)
        ;   XREF to: 005ffd76 (UNCONDITIONAL_CALL)
    ADD EBX,0x8                         ; 00532019
    INC EDX                             ; 0053201c
    FSTP double ptr [EBX + 0x2f45fc0]   ; 0053201d | double[200] g_MpegRequantGainTable
    CMP EDX,0xc8                        ; 00532023
    JL 0x00532004                       ; 00532029 | LAB_00532004
        ;   XREF to: 00532004 (CONDITIONAL_JUMP)
    FSTP ST0                            ; 0053202b
    MOV EBX,0x1                         ; 0053202d
    FSTP ST0                            ; 00532032
    MOV dword ptr [0x02f45984],EBX      ; 00532034 | int g_MpegRequantTablesInitialized
    JMP 0x00531dc0                      ; 0053203a | LAB_00531dc0
        ;   XREF to: 00531dc0 (UNCONDITIONAL_JUMP)
    JGE 0x00532050                      ; 0053203f | LAB_00532050
        ;   Label: LAB_0053203f
        ;   XREF to: 00532050 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0x67e6cc]  ; 00532041 | DAT_0067e6d0
    MOV dword ptr [ESP + 0x5c],EAX      ; 00532047
    JMP 0x00531ee0                      ; 0053204b | LAB_00531ee0
        ;   XREF to: 00531ee0 (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0x67e728]  ; 00532050 | DAT_0067e72c
        ;   Label: LAB_00532050
    LEA EAX,[EAX + EAX*0x2]             ; 00532056
    MOV EDX,dword ptr [EBX + 0x67e724]  ; 00532059 | DAT_0067e728
    MOV dword ptr [ESP + 0x5c],EAX      ; 0053205f
    MOV EAX,dword ptr [EBX + 0x67e728]  ; 00532063 | DAT_0067e72c
    SUB EAX,EDX                         ; 00532069
    MOV dword ptr [ESP + 0x50],EAX      ; 0053206b
    LEA EAX,[EDX + EDX*0x2]             ; 0053206f
    JMP 0x00531edc                      ; 00532072 | LAB_00531edc
    ...
    MOV EAX,dword ptr [EAX + 0x67e6cc]  ; 00532085 | DAT_0067e6d0
    MOV dword ptr [ESP + 0x5c],EAX      ; 0053208b
    JMP 0x00531ee0                      ; 0053208f | LAB_00531ee0
        ;   XREF to: 00531ee0 (UNCONDITIONAL_JUMP)
    ...
    JLE 0x005321c7                      ; 00532102 | LAB_005321c7
    ...
    CALL crt_math.c_pow_FUN_005ffd76    ; 0053211c | float10 crt_math.c_pow_FUN_005ffd76(float10 x, float10 y)
        ;   XREF to: 005ffd76 (UNCONDITIONAL_CALL)
    ...
    JL 0x005321e5                       ; 00532137 | LAB_005321e5
    ...
    CALL crt_math.c_pow_FUN_005ffd76    ; 0053214b | float10 crt_math.c_pow_FUN_005ffd76(float10 x, float10 y)
        ;   XREF to: 005ffd76 (UNCONDITIONAL_CALL)
    ...
    JGE 0x00531ef6                      ; 00532160 | LAB_00531ef6
    ...
    JMP 0x005320fe                      ; 005321c2 | LAB_005320fe
        ;   XREF to: 005320fe (UNCONDITIONAL_JUMP)
    CMP EBX,0xffffff38                  ; 005321c7
        ;   Label: LAB_005321c7
    JLE 0x00532108                      ; 005321cd | LAB_00532108
        ;   XREF to: 00532108 (CONDITIONAL_JUMP)
    NEG EBX                             ; 005321d3
    MOV EAX,dword ptr [ESP + 0x3c]      ; 005321d5
    FLD double ptr [EBX*0x8 + 0x2f45fc8] ; 005321d9 | double[200] g_MpegRequantGainTable
    JMP 0x00532125                      ; 005321e0 | LAB_00532125
        ;   XREF to: 00532125 (UNCONDITIONAL_JUMP)
    MOV EDX,dword ptr [ESP + 0x60]      ; 005321e5
        ;   Label: LAB_005321e5
    FLD float ptr [EDX]                 ; 005321e9
    FLD ST0                             ; 005321eb
    FMUL double ptr [EAX*0x8 + 0x2f45988] ; 005321ed | double[200] g_MpegRequantPowerTable
    FSTP ST1                            ; 005321f4
    FSTP float ptr [EDX]                ; 005321f6
    JMP 0x00532158                      ; 005321f8 | LAB_00532158
