// Name: sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
// Address: 0052ef40
// Address Range: [[0052ef40, 0052f0b2]]
// Convention: unknown
// Signature: undefined sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40()
// Cross-references:
//   sound_mp3.cpp_CallReadOrWriteBits_FUN_0052f850 (0052f850) at 0052f8b7 [UNCONDITIONAL_CALL]
//   sound_mp3.cpp_FUN_0052f0e0 (0052f0e0) at 0052f104 [UNCONDITIONAL_CALL]
//   sound_mp3.cpp_FUN_0052f670 (0052f670) at 0052f6c8 [UNCONDITIONAL_CALL]
//   sound_mp3.cpp_FUN_0052f7a0 (0052f7a0) at 0052f7e4 [UNCONDITIONAL_CALL]
//   sound_mp3.cpp_FUN_0052f8e0 (0052f8e0) at 0052fae6 [UNCONDITIONAL_CALL]
//   sound_mp3.cpp_FUN_0052fb50 (0052fb50) at 0052fc24 [UNCONDITIONAL_CALL]
//   sound_mp3.cpp_FUN_0052fc50 (0052fc50) at 0052fe42 [UNCONDITIONAL_CALL]
//   sound_mp3.cpp_MPEGPickTable_LayerCheck_FUN_00534630 (00534630) at 005347a5 [UNCONDITIONAL_CALL]
//   sound_mp3.cpp_MpegLoadMaybe_FUN_00534d40 (00534d40) at 00535641 [UNCONDITIONAL_CALL]
//   sound_mp3.cpp_ReadOrwriteMultiBits_FUN_0052f5b0 (0052f5b0) at 0052f603 [UNCONDITIONAL_CALL]
//   sound_mp3.cpp_SideInfoBadCheck_FUN_005307a0 (005307a0) at 00530c41 [UNCONDITIONAL_CALL]
// Globals:
...
/* Signature: undefined1 sound_mp3.cpp_ReadOrWriteBits(undefined4 param_1, undefined4 param_2) */

uint sound_mp3_cpp_ReadOrWriteBits_FUN_0052ef40(void)

{
  ...
  if (0x20 < in_stack_00000008) {
    ...
    core_main_c_displayErrorAndQuit_FUN_00506f10
              ("Cannot read or write more than %d bits at a time.  File: %s",0x20,&DAT_02f68188,0);
  }
  in_stack_00000004[3] = in_stack_00000004[3] + in_stack_00000008;
  if (0 < in_stack_00000008) {
    do {
      if (in_stack_00000004[5] == 0) {
        in_stack_00000004[5] = 8;
        iVar2 = in_stack_00000004[4] + -1;
        in_stack_00000004[4] = iVar2;
        if ((iVar2 < 4) || (iVar2 < (int)in_stack_00000004[6])) {
          if (in_stack_00000004[6] == 0) {
            for (iVar2 = in_stack_00000004[4]; -1 < iVar2; iVar2 = iVar2 + -1) {
              *(undefined1 *)
               (in_stack_00000004[1] + ((in_stack_00000004[2] + -1) - in_stack_00000004[4]) + iVar2)
                   = *(undefined1 *)(in_stack_00000004[1] + iVar2);
            }
            iVar2 = (in_stack_00000004[2] + -2) - in_stack_00000004[4];
            if (iVar2 < 0) {
LAB_0052f051:
              ...
              do {
                while( true ) {
                  if (in_stack_00000004[6] != 0) goto LAB_0052f051;
                  SVar1 = 0;
                  if (0 < (int)in_stack_00000004[10]) {
                    buffer = (void *)(iVar2 + in_stack_00000004[1]);
                    iVar2 = iVar2 + -1;
                    SVar1 = crt_stdio_c_fread_FUN_005fd990(buffer,1,1,(FILE *)*in_stack_00000004);
                  }
                  if (SVar1 != 1) break;
...
LAB_0052ef6c:
      iVar2 = in_stack_00000004[5];
      if (in_stack_00000008 < iVar2) {
        iVar2 = in_stack_00000008;
      }
      in_stack_00000008 = in_stack_00000008 - iVar2;
      iVar2 = in_stack_00000004[5] - iVar2;
      unaff_EBP = unaff_EBP |
                  ((int)((uint)*(byte *)(in_stack_00000004[1] + in_stack_00000004[4]) &
                        *(uint *)(&DAT_0067e5e0 + in_stack_00000004[5] * 4)) >> ((byte)iVar2 & 0x1f)
                  ) << ((byte)in_stack_00000008 & 0x1f);
      in_stack_00000004[5] = iVar2;
...
// Assembly code:
// 0052ef40: PUSH EBX
//   Label: sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
// 0052ef41: PUSH ESI
// 0052ef42: PUSH EDI
// 0052ef43: PUSH EBP
