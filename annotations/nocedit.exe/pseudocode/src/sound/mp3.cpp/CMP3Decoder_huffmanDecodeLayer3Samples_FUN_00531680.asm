...
;                               FUNCTION
; *****************************************************************************
; __cdecl uint sound_mp3.cpp_CMP3Decoder_huffmanDecodeLayer3Samples_FUN_00531680(CMP3Decoder * this_ptr, float * spectral_dest, SMpegLayer3Granule * granule_info, int channel, int granule, SMpegFrame * frame, int bit_budget)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [0x02f45980]      ; 005316a1 | int g_HuffmanTablesInitialized
    TEST EDX,EDX                        ; 005316a7
    JZ 0x005318e0                       ; 005316a9 | LAB_005318e0
    ...
    JZ 0x00531b44                       ; 005316db | LAB_00531b44
        ;   XREF to: 00531b44 (CONDITIONAL_JUMP)
    CMP dword ptr [EAX + 0x2c],0x2      ; 005316e1
    JNZ 0x00531b44                      ; 005316e5 | LAB_00531b44
        ;   XREF to: 00531b44 (CONDITIONAL_JUMP)
    ...
    CALL sound_mp3.cpp_CMP3Decoder_getTotalBitsRead_FUN_0052f160 ; 00531723 | uint sound_mp3.cpp_CMP3Decoder_getTotalBitsRead_FUN_0052f160(CMP3Decoder * this_ptr)
    ...
    JC 0x00531ba0                       ; 0053174a | LAB_00531ba0
        ;   XREF to: 00531ba0 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [ESP + 0x4c]      ; 00531750
    PUSH EDX                            ; 00531754
    CALL sound_mp3.cpp_CMP3Decoder_getTotalBitsRead_FUN_0052f160 ; 00531755 | uint sound_mp3.cpp_CMP3Decoder_getTotalBitsRead_FUN_0052f160(CMP3Decoder * this_ptr)
        ;   XREF to: 0052f160 (UNCONDITIONAL_CALL)
    ...
    MOV EDX,0x2f68288                   ; 0053176c | SHuffmanTable[34] g_HuffmanTables
    ...
    PUSH EAX                            ; 005317c7
    CALL sound_mp3.cpp_CMP3Decoder_getTotalBitsRead_FUN_0052f160 ; 005317c8 | uint sound_mp3.cpp_CMP3Decoder_getTotalBitsRead_FUN_0052f160(CMP3Decoder * this_ptr)
        ;   XREF to: 0052f160 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005317cd
    CMP EAX,dword ptr [ESP + 0x34]      ; 005317d0
    JNC 0x00531c4c                      ; 005317d4 | LAB_00531c4c
        ;   XREF to: 00531c4c (CONDITIONAL_JUMP)
    CMP ESI,0x240                       ; 005317da
    JGE 0x00531c4c                      ; 005317e0 | LAB_00531c4c
        ;   XREF to: 00531c4c (CONDITIONAL_JUMP)
    ...
    PUSH EDX                            ; 00531803
    CALL sound_mp3.cpp_CMP3Decoder_huffmanDecode_FUN_0052f350 ; 00531804 | int sound_mp3.cpp_CMP3Decoder_huffmanDecode_FUN_0052f350(CMP3Decoder * this_ptr, SHuffmanTable * huffman_table, int * x_out, int * y_out, ...)
    ...
    JMP 0x005317b2                      ; 005318db | LAB_005317b2
        ;   XREF to: 005317b2 (UNCONDITIONAL_JUMP)
    MOV ECX,0x2f68288                   ; 005318e0 | SHuffmanTable[34] g_HuffmanTables
        ;   Label: LAB_005318e0
    MOV dword ptr [ESP + 0x30],EDX      ; 005318e5
    XOR EBX,EBX                         ; 005318e9
    XOR EBP,EBP                         ; 005318eb
    MOV dword ptr [ESP + 0x2c],ECX      ; 005318ed | SHuffmanTable[34] g_HuffmanTables
    PUSH EBP                            ; 005318f1
        ;   Label: LAB_005318f1
    PUSH 0x63af26                       ; 005318f2 | = "%d" | s_d_0063af26 = %d
    MOV EDI,dword ptr [ESP + 0x34]      ; 005318f7
    PUSH EDI                            ; 005318fb | SHuffmanTable[34] g_HuffmanTables
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005318fc | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00531901
    MOV EAX,dword ptr [ESP + 0x30]      ; 00531904
    MOV EAX,dword ptr [EAX + 0x680170]  ; 00531908 | SHuffmanTableSource[34] g_HuffmanTableSources
    ...
    PUSH EAX                            ; 0053195c
    PUSH 0x63af29                       ; 0053195d | = "%u" | s_u_0063af29 = %u
    PUSH EDI                            ; 00531962 | SHuffmanTable[34] g_HuffmanTables
    CALL crt_stdio.c_sscanf_FUN_0060013c ; 00531963 | int crt_stdio.c_sscanf_FUN_0060013c(char * str, char * format)
        ;   XREF to: 0060013c (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00531968
    CMP EBP,dword ptr [ESP + 0x10]      ; 0053196b
    JZ 0x0053199a                       ; 0053196f | LAB_0053199a
        ;   XREF to: 0053199a (CONDITIONAL_JUMP)
    PUSH 0x2f68188                      ; 00531971 | char[256] g_CurrentMp3Filename
    PUSH EBP                            ; 00531976
    MOV ECX,0x63af2c                    ; 00531977 | = "..\\sound\\mp3.cpp" | s_sound_mp3_cpp_0063af2c = ..\sound\mp3.cpp
    MOV ESI,0xd72                       ; 0053197c
    PUSH 0x63af3d                       ; 00531981 | = "wrong table number %u.  File: %s" | s_wrong_table_number_u_Fil_0063af3d = wrong table number %u.  File: %s
    MOV dword ptr [0x02f0ca48],ECX      ; 00531986 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 0053198c | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00531992 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    JL 0x00531a9d                       ; 005319a6 | LAB_00531a9d
        ;   XREF to: 00531a9d (CONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0x2f6829c],EAX ; 005319ac | DAT_02f6829c
    IMUL EDX,EAX,0x828                  ; 005319b2
    MOV ESI,0x2f68288                   ; 005319b8 | SHuffmanTable[34] g_HuffmanTables
    MOV EDI,0x2f68288                   ; 005319bd | SHuffmanTable[34] g_HuffmanTables
    ...
    JZ 0x00531a89                       ; 005319f9 | LAB_00531a89
        ;   XREF to: 00531a89 (CONDITIONAL_JUMP)
    PUSH 0x2f68188                      ; 005319ff | char[256] g_CurrentMp3Filename
        ;   Label: LAB_005319ff
    PUSH EBP                            ; 00531a04
    MOV EDI,0x63af5e                    ; 00531a05 | = "..\\sound\\mp3.cpp" | s_sound_mp3_cpp_0063af5e = ..\sound\mp3.cpp
    MOV EAX,0xd7d                       ; 00531a0a
    PUSH 0x63af6f                       ; 00531a0f | = "wrong table %u reference.  File: %s" | s_wrong_table_u_reference__0063af6f = wrong table %u reference.  File: %s
    MOV dword ptr [0x02f0ca48],EDI      ; 00531a14 | char * g_CurrentFilename
        ;   Label: LAB_00531a14
    MOV [0x02f0ca4c],EAX                ; 00531a1a | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00531a1f | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ...
    JL 0x005318f1                       ; 00531a4a | LAB_005318f1
        ;   XREF to: 005318f1 (CONDITIONAL_JUMP)
    JZ 0x00531a7a                       ; 00531a50 | LAB_00531a7a
        ;   XREF to: 00531a7a (CONDITIONAL_JUMP)
    PUSH 0x2f68188                      ; 00531a52 | char[256] g_CurrentMp3Filename
    MOV EDI,0x63b00c                    ; 00531a57 | = "..\\sound\\mp3.cpp" | s_sound_mp3_cpp_0063b00c = ..\sound\mp3.cpp
    MOV EBP,0xda8                       ; 00531a5c
    PUSH 0x63b01d                       ; 00531a61 | = "decoder table read error.  File: %s" | s_decoder_table_read_error_0063b01d = decoder table read error.  File: %s
    MOV dword ptr [0x02f0ca48],EDI      ; 00531a66 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBP      ; 00531a6c | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00531a72 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00531a77
    MOV dword ptr [0x02f45980],0x1      ; 00531a7a | int g_HuffmanTablesInitialized
        ;   Label: LAB_00531a7a
    JMP 0x005316af                      ; 00531a84 | LAB_005316af
    ...
    JNZ 0x005319ff                      ; 00531a95 | LAB_005319ff
        ;   XREF to: 005319ff (CONDITIONAL_JUMP)
    JMP 0x00531a27                      ; 00531a9b | LAB_00531a27
        ;   XREF to: 00531a27 (UNCONDITIONAL_JUMP)
    CMP EAX,-0x1                        ; 00531a9d
        ;   Label: LAB_00531a9d
    JNZ 0x00531b2a                      ; 00531aa0 | LAB_00531b2a
    ...
    JC 0x00531ae2                       ; 00531ab8 | LAB_00531ae2
        ;   XREF to: 00531ae2 (CONDITIONAL_JUMP)
    PUSH 0x2f68188                      ; 00531aba | char[256] g_CurrentMp3Filename
    MOV ESI,0x63af93                    ; 00531abf | = "..\\sound\\mp3.cpp" | s_sound_mp3_cpp_0063af93 = ..\sound\mp3.cpp
    MOV EDI,0xd85                       ; 00531ac4
    PUSH 0x63afa4                       ; 00531ac9 | = "MP3 Huffman tree overflow!  File: %s" | s_MP3_Huffman_tree_overflo_0063afa4 = MP3 Huffman tree overflow!  File: %s
    MOV dword ptr [0x02f0ca48],ESI      ; 00531ace | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 00531ad4 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00531ada | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ...
    JBE 0x00531a27                      ; 00531afa | LAB_00531a27
        ;   XREF to: 00531a27 (CONDITIONAL_JUMP)
    MOV EDX,EAX                         ; 00531b00
        ;   Label: LAB_00531b00
    MOV DL,byte ptr [EDX]               ; 00531b02
    INC EAX                             ; 00531b04
    MOV byte ptr [ECX + 0x2f682a8],DL   ; 00531b05 | DAT_02f682a8
    MOV EDX,EAX                         ; 00531b0b
    ADD ECX,0x2                         ; 00531b0d
    MOV DL,byte ptr [EDX]               ; 00531b10
    MOV byte ptr [ECX + 0x2f682a7],DL   ; 00531b12 | DAT_02f682a8+1
    INC ESI                             ; 00531b18
    MOV EDX,dword ptr [EDI + 0x2f68aac] ; 00531b19 | g_HuffmanTables[0].table_size
    INC EAX                             ; 00531b1f
    CMP ESI,EDX                         ; 00531b20
    JNC 0x00531a27                      ; 00531b22 | LAB_00531a27
        ;   XREF to: 00531a27 (CONDITIONAL_JUMP)
    JMP 0x00531b00                      ; 00531b28 | LAB_00531b00
        ;   XREF to: 00531b00 (UNCONDITIONAL_JUMP)
    PUSH 0x2f68188                      ; 00531b2a | char[256] g_CurrentMp3Filename
        ;   Label: LAB_00531b2a
    PUSH EBP                            ; 00531b2f
    MOV EDI,0x63afc9                    ; 00531b30 | = "..\\sound\\mp3.cpp" | s_sound_mp3_cpp_0063afc9 = ..\sound\mp3.cpp
    MOV EAX,0xd94                       ; 00531b35
    PUSH 0x63afda                       ; 00531b3a | = "huffman decodertable error at table %..." | s_huffman_decodertable_err_0063afda = huffman decodertable error at table %d.  File: %s
    JMP 0x00531a14                      ; 00531b3f | LAB_00531a14
    ...
    JMP 0x005316f9                      ; 00531b9b | LAB_005316f9
        ;   XREF to: 005316f9 (UNCONDITIONAL_JUMP)
    CMP ESI,dword ptr [ESP + 0x28]      ; 00531ba0
        ;   Label: LAB_00531ba0
    JGE 0x00531bb4                      ; 00531ba4 | LAB_00531bb4
        ;   XREF to: 00531bb4 (CONDITIONAL_JUMP)
    IMUL EAX,dword ptr [EDI + 0x34],0x828 ; 00531ba6
    ADD EAX,0x2f68288                   ; 00531bad | SHuffmanTable[34] g_HuffmanTables
    JMP 0x00531bd2                      ; 00531bb2 | LAB_00531bd2
        ;   XREF to: 00531bd2 (UNCONDITIONAL_JUMP)
    CMP ESI,EBP                         ; 00531bb4
        ;   Label: LAB_00531bb4
    JGE 0x00531bc6                      ; 00531bb6 | LAB_00531bc6
        ;   XREF to: 00531bc6 (CONDITIONAL_JUMP)
    IMUL EAX,dword ptr [EDI + 0x38],0x828 ; 00531bb8
    ADD EAX,0x2f68288                   ; 00531bbf | SHuffmanTable[34] g_HuffmanTables
    JMP 0x00531bd2                      ; 00531bc4 | LAB_00531bd2
        ;   XREF to: 00531bd2 (UNCONDITIONAL_JUMP)
    IMUL EAX,dword ptr [EDI + 0x3c],0x828 ; 00531bc6
        ;   Label: LAB_00531bc6
    ADD EAX,0x2f68288                   ; 00531bcd | SHuffmanTable[34] g_HuffmanTables
    ...
    PUSH ECX                            ; 00531beb
    CALL sound_mp3.cpp_CMP3Decoder_huffmanDecode_FUN_0052f350 ; 00531bec | int sound_mp3.cpp_CMP3Decoder_huffmanDecode_FUN_0052f350(CMP3Decoder * this_ptr, SHuffmanTable * huffman_table, int * x_out, int * y_out, ...)
        ;   XREF to: 0052f350 (UNCONDITIONAL_CALL)
    ...
    JMP 0x0053173b                      ; 00531c47 | LAB_0053173b
    ...
    CALL sound_mp3.cpp_CMP3Decoder_getTotalBitsRead_FUN_0052f160 ; 00531c79 | uint sound_mp3.cpp_CMP3Decoder_getTotalBitsRead_FUN_0052f160(CMP3Decoder * this_ptr)
        ;   XREF to: 0052f160 (UNCONDITIONAL_CALL)
    ...
    CALL sound_mp3.cpp_CMP3Decoder_getTotalBitsRead_FUN_0052f160 ; 00531c8d | uint sound_mp3.cpp_CMP3Decoder_getTotalBitsRead_FUN_0052f160(CMP3Decoder * this_ptr)
        ;   XREF to: 0052f160 (UNCONDITIONAL_CALL)
    ADD EDI,EBP                         ; 00531c92
    ADD ESP,0x4                         ; 00531c94
    CMP EAX,EDI                         ; 00531c97
    JBE 0x00531cc4                      ; 00531c99 | LAB_00531cc4
        ;   XREF to: 00531cc4 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [ESP + 0x4c]      ; 00531c9b
    PUSH EDX                            ; 00531c9f
    CALL sound_mp3.cpp_CMP3Decoder_getTotalBitsRead_FUN_0052f160 ; 00531ca0 | uint sound_mp3.cpp_CMP3Decoder_getTotalBitsRead_FUN_0052f160(CMP3Decoder * this_ptr)
        ;   XREF to: 0052f160 (UNCONDITIONAL_CALL)
    ...
    CALL sound_mp3.cpp_CMP3Decoder_unreadBits_FUN_0052f2c0 ; 00531cbc | void sound_mp3.cpp_CMP3Decoder_unreadBits_FUN_0052f2c0(CMP3Decoder * this_ptr, int num_bits)
    ...
    CALL sound_mp3.cpp_CMP3Decoder_getTotalBitsRead_FUN_0052f160 ; 00531cf6 | uint sound_mp3.cpp_CMP3Decoder_getTotalBitsRead_FUN_0052f160(CMP3Decoder * this_ptr)
        ;   XREF to: 0052f160 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00531cfb
    CMP EAX,EBX                         ; 00531cfe
    JL 0x00531d34                       ; 00531d00 | LAB_00531d34
        ;   XREF to: 00531d34 (CONDITIONAL_JUMP)
    MOV EBX,0x12                        ; 00531d02
        ;   Label: LAB_00531d02
    CMP ESI,0x240                       ; 00531d07
        ;   Label: LAB_00531d07
    JGE 0x00531d46                      ; 00531d0d | LAB_00531d46
    ...
    JMP 0x00531d07                      ; 00531d32 | LAB_00531d07
    ...
    PUSH EBX                            ; 00531d3b
    CALL sound_mp3.cpp_CMP3Decoder_readBits_FUN_0052f170 ; 00531d3c | uint sound_mp3.cpp_CMP3Decoder_readBits_FUN_0052f170(CMP3Decoder * this_ptr, uint num_bits)
        ;   XREF to: 0052f170 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00531d41
    JMP 0x00531d02                      ; 00531d44 | LAB_00531d02
