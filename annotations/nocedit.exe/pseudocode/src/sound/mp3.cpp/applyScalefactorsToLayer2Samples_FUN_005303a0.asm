...
section .text
    ...
    JLE 0x005303e6                      ; 005303b3
        ;   XREF to: 005303e6 (CONDITIONAL_JUMP)  ; LAB_005303e6
    ...
    FLD ST0                             ; 005303c5
    FMUL double ptr [EBX*0x8 + 0x67e3c0] ; 005303c7 | g_MpegScalefactorTable
    ...
    JL 0x005303c1                       ; 005303e4
        ;   XREF to: 005303c1 (CONDITIONAL_JUMP)  ; LAB_005303c1
    ADD EDI,0x4                         ; 005303e6
        ;   Label: LAB_005303e6
    CMP EDI,0x80                        ; 005303e9
    JNZ 0x005303af                      ; 005303ef
        ;   XREF to: 005303af (CONDITIONAL_JUMP)  ; LAB_005303af
