// Name: sound_mp3.cpp_FUN_00534210
// Address: 00534210
// Address Range: [[00534210, 005344ea]]
// Convention: unknown
// Signature: undefined sound_mp3.cpp_FUN_00534210()
// Globals:
//   undefined4 s_test.raw_0063b0e2
...
void sound_mp3_cpp_FUN_00534210
               (undefined4 param_1,undefined4 param_2,int unaff_EBX,undefined4 param_4,
               undefined4 param_5,FILE *param_6,FILE *param_7,FILE *param_8,undefined4 param_9,
               CMP3Decoder *param_10,SIZE_T param_11,int param_12,int param_13)

{
  ...
  crt_io_c_deleteFile_FUN_005ff9d0(">test.raw" + 1);
  ...
  if (pFVar3 == (FILE *)0x0) {
    ...
    core_main_c_displayErrorAndQuit_FUN_00506f10("Hose!",pCVar2);
  }
  pFVar3 = shape_memdbg_cpp_openFile_FUN_0050f7a0
  ...
  do {
    size = sound_mp3_cpp_FUN_00534a60();
    if (param_10 != (CMP3Decoder *)0x0) {
      crt_stdio_c_fwrite_FUN_005fdc00(&DAT_02f48188,size,param_11,param_8);
    }
    iVar4 = iVar4 + param_12 * size;
    if (param_11 != 0) {
      param_13 = iVar4;
      shape_edittool_cpp_CEditorTools_displayCenteredStatusMessage_FUN_0049e790
                (g_CEditorToolsPtr,"%.1fk");
    }
  } while (size == (SIZE_T)(0x20000 / (longlong)(iVar1 * 2)));
  shape_memdbg_cpp_closeFile_FUN_0050f9b0(param_7,"..\\sound\\mp3.cpp",0xde8);
  shape_memdbg_cpp_closeFile_FUN_0050f9b0(param_6,"..\\sound\\mp3.cpp",0xde9);
  g_CurrentDebugFilename = "..\\sound\\mp3.cpp";
  g_CurrentDebugLine = 0xdeb;
  pCVar2 = sound_mp3_cpp_CMP3Decoder_dtor_FUN_00534530(param_10);
  ...
  crt_time_c_time_with_rounding_FUN_006001f0((time_t *)&param_10);
  in_stack_0000003c = param_11 - (int)param_10;
...
// Assembly code:
// 00534210: PUSH EBX
//   Label: sound_mp3.cpp_FUN_00534210
// 00534211: PUSH ESI
// 00534212: PUSH EDI
// 00534213: PUSH EBP
...
// 00534298: CALL sound_mp3.cpp_OpenAndPrepareDecoding_FUN_00534550
//   XREF to: 00534550 (UNCONDITIONAL_CALL)
// 0053429d: ADD ESP,0x8
// 005342a0: PUSH 0x63b124
//   XREF to: 0063b124 (DATA)
// 005342a5: PUSH EBX
// 005342a6: CALL sound_mp3.cpp_OpenAndPrepareDecoding_FUN_00534550
//   XREF to: 00534550 (UNCONDITIONAL_CALL)
...
//   XREF to: Stack[-0x24] (READ)
// 00534359: PUSH ESI
// 0053435a: CALL sound_mp3.cpp_FUN_00534a60
