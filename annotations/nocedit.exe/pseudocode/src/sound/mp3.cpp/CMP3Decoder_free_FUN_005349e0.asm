...
section .text
    ...
    PUSH 0x20b                          ; 00534a17
        ;   Label: LAB_00534a17
    PUSH 0x63ace1                       ; 00534a1c | = "..\\sound\\mp3.cpp" | s_sound_mp3_cpp_0063ace1 = ..\sound\mp3.cpp
    PUSH EDX                            ; 00534a21
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 00534a22 | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
        ;   XREF to: 0050f9b0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00534a27
    MOV dword ptr [EBX],0x0             ; 00534a2a
    MOV EBX,dword ptr [ESI + 0x4]       ; 00534a30
    TEST EBX,EBX                        ; 00534a33
    JNZ 0x00534a3e                      ; 00534a35 | LAB_00534a3e
        ;   XREF to: 00534a3e (CONDITIONAL_JUMP)
    ...
    PUSH 0x210                          ; 00534a3e
        ;   Label: LAB_00534a3e
    PUSH 0x63acf2                       ; 00534a43 | = "..\\sound\\mp3.cpp" | s_sound_mp3_cpp_0063acf2 = ..\sound\mp3.cpp
    PUSH EBX                            ; 00534a48
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 00534a49 | void shape_memdbg.cpp_debugFree_FUN_0050f460(void * ptr, char * filename, int line_number)
