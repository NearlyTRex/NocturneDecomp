// Name: sound_mp3.cpp_FUN_00531480
// Address: 00531480
// Address Range: [[00531480, 0053167a]]
// Convention: unknown
// Signature: undefined sound_mp3.cpp_FUN_00531480()
// Cross-references:
//   sound_mp3.cpp_MpegLoadMaybe_FUN_00534d40 (00534d40) at 00535c00 [UNCONDITIONAL_CALL]
// Function calls:
//   sound_mp3.cpp_FUN_005310f0

#include "nocturne.h"

/* Signature: undefined1 sound_mp3.cpp_FUN_00531480(undefined4 param_1, undefined4 param_2,
   undefined4 param_3, undefined4 param_4, undefined4 param_5, undefined4 param_6) */

void sound_mp3_cpp_FUN_00531480(void)

{
  ...
  iVar10 = in_stack_0000000c + in_stack_00000014 * 0xa0 + 0x18 + in_stack_00000010 * 0x48;
  iVar7 = 0;
  sound_mp3_cpp_FUN_005310f0();
  if ((*(int *)(iVar10 + 0x10) != 0) && (*(int *)(iVar10 + 0x14) == 2)) {
    puVar9 = (undefined4 *)(in_stack_0000000c + in_stack_00000014 * 0xf8);
    if (*(int *)(iVar10 + 0x18) != 0) {
      puVar5 = puVar9;
      iVar10 = in_stack_00000008;
      do {
        puVar2 = puVar5 + 1;
        puVar1 = (undefined4 *)(iVar10 + 0x7358);
        iVar10 = iVar10 + 4;
        iVar7 = iVar7 + 1;
        *puVar5 = *puVar1;
        puVar5 = puVar2;
      ...
      iVar8 = 0xa8;
      iVar10 = in_stack_0000000c + in_stack_00000018 * 0xf8;
      iVar11 = 3;
      do {
        iVar6 = iVar7 * 4 + in_stack_00000008;
        iVar4 = iVar11 * 4 + iVar10;
        do {
          iVar3 = iVar4 + 0x34;
          puVar9 = (undefined4 *)(iVar6 + 0x7358);
          iVar6 = iVar6 + 4;
          iVar7 = iVar7 + 1;
          *(undefined4 *)(iVar4 + 0x5c) = *puVar9;
          iVar4 = iVar3;
      ...
      iVar7 = in_stack_0000000c + 0x30;
      do {
        iVar10 = iVar7 + 0x34;
        *(undefined4 *)(iVar7 + 0x5c) = 0;
        iVar7 = iVar10;
      } while (iVar10 != in_stack_0000000c + 0xcc);
      return;
    }
    iVar10 = 0x9c;
    iVar8 = 0;
    do {
      iVar11 = iVar7 * 4 + in_stack_00000008;
      puVar5 = puVar9 + iVar8;
      do {
        puVar2 = puVar5 + 0xd;
        puVar1 = (undefined4 *)(iVar11 + 0x7358);
        iVar11 = iVar11 + 4;
        iVar7 = iVar7 + 1;
        puVar5[0x17] = *puVar1;
        puVar5 = puVar2;
      } while (puVar2 != (undefined4 *)((int)puVar9 + iVar10));
      iVar8 = iVar8 + 1;
      iVar10 = iVar10 + 4;
    } while (iVar8 < 0xc);
    in_stack_0000000c = in_stack_0000000c + in_stack_00000018 * 0xf8;
  ...
  iVar7 = 0;
  in_stack_0000000c = in_stack_00000018 * 0xf8 + in_stack_0000000c;
  do {
    puVar9 = (undefined4 *)(in_stack_00000008 + 0x7358);
    puVar5 = (undefined4 *)(in_stack_0000000c + iVar7);
    in_stack_00000008 = in_stack_00000008 + 4;
    iVar7 = iVar7 + 4;
    *puVar5 = *puVar9;
  } while (iVar7 != 0x54);
  *(undefined4 *)(in_stack_0000000c + 0x58) = 0;
  return;
}
...
// Assembly code:
// 00531480: PUSH EBX
//   Label: sound_mp3.cpp_FUN_00531480
// 00531481: PUSH ESI
// 00531482: PUSH EDI
// 00531483: PUSH EBP
...
// 005314ce: CALL sound_mp3.cpp_FUN_005310f0
