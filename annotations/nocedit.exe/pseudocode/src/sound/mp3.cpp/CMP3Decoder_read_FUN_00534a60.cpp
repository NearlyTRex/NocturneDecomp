...

{
  ...
  local_14 = 0;
  while( true ) {
    iVar6 = this_ptr->available_samples;
    if (0 < iVar6) {
      if (samples_requested < iVar6) {
        iVar6 = samples_requested;
      }
      uVar5 = this_ptr->num_channels * iVar6 * 2;
      ...
      this_ptr->available_samples = this_ptr->available_samples - iVar6;
      local_14 = local_14 + iVar6;
      samples_requested = samples_requested - iVar6;
      this_ptr->decode_buffer_pos = this_ptr->decode_buffer_pos + this_ptr->num_channels * iVar6;
      output_buffer = output_buffer + this_ptr->num_channels * iVar6;
    }
    for (; 0x47f < samples_requested; samples_requested = samples_requested - iVar6) {
      iVar6 = sound_mp3_cpp_CMP3Decoder_decodeFrame_FUN_00534d40(this_ptr,output_buffer);
      if (iVar6 < 1) {
        return local_14;
      }
      local_14 = local_14 + iVar6;
