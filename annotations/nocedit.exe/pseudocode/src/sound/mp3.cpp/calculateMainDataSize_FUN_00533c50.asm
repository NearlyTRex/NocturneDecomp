...
section .text
    ...
    FDIV double ptr [EDX + EAX*0x8 + 0x67e218] ; 00533c9e | double[2][4] g_MpegSampleRateTable
    MOV EAX,dword ptr [ESP + 0x14]      ; 00533ca5
    CALL crt_math.c_round_FUN_005fe6b0  ; 00533ca9 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [EAX]             ; 00533cae
    FISTP dword ptr [ESP]               ; 00533cb0
    TEST EDX,EDX                        ; 00533cb3
    JZ 0x00533cf2                       ; 00533cb5 | LAB_00533cf2
        ;   XREF to: 00533cf2 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x24],0x1      ; 00533cb7
    JNZ 0x00533cec                      ; 00533cbc | LAB_00533cec
    ...
    JZ 0x00533ccf                       ; 00533cca | LAB_00533ccf
    ...
    JNZ 0x00533d1a                      ; 00533ce1 | LAB_00533d1a
    ...
    SUB dword ptr [ESP],0x20            ; 00533cec
        ;   Label: LAB_00533cec
    JMP 0x00533cc2                      ; 00533cf0 | LAB_00533cc2
