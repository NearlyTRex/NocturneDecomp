// Name: sound_mp3.cpp_FUN_0052ea80
// Address: 0052ea80
// Address Range: [[0052ea80, 0052ec37]]
// Convention: unknown
// Signature: undefined sound_mp3.cpp_FUN_0052ea80()
// Globals:
...
void sound_mp3_cpp_FUN_0052ea80(void)

{
  ...
  in_stack_00000004[4] = (iVar2 != 3) + 1;
  if (*(int *)(iVar1 + 4) == 2) {
    iVar3 = in_stack_00000004[6];
    piVar4 = (int *)*in_stack_00000004;
    iVar5 = *piVar4;
    iVar9 = iVar5 * 0xb4;
    fVar7 = (float10)*(double *)(&DAT_0067e218 + piVar4[4] * 8 + iVar5 * 0x20);
    piVar10 = in_stack_00000004;
    dVar8 = crt_math_c_round_FUN_005fe6b0
                      ((double)CONCAT44(*(int *)(&DAT_0067e258 +
                                                piVar4[3] * 4 + (piVar4[1] + -1) * 0x3c + iVar9) /
                                        in_stack_00000004[4],piVar4[4]));
    ...
    if (iVar5 != *(int *)(iVar3 + 0xc)) {
      ...
      core_main_c_displayErrorAndQuit_FUN_00506f10
                ("MPEG Layer 2 - pick_table - can't load tables!  File: %s",&DAT_02f68188,iVar9,piVar10);
    }
    in_stack_00000004[6] = iVar2;
  }
  else {
    in_stack_00000004[6] = 0x20;
  }
  if (*(int *)(iVar1 + 0x1c) != 1) {
    in_stack_00000004[5] = in_stack_00000004[6];
    return;
  }
  iVar2 = *(int *)(iVar1 + 4);
  iVar1 = *(int *)(iVar1 + 0x20);
  if ((((iVar2 < 1) || (3 < iVar2)) || (iVar1 < 0)) || (3 < iVar1)) {
    g_CurrentFilename = "..\\sound\\mp3.cpp";
    g_CurrentLineNumber = 0x1b2;
    core_main_c_displayErrorAndQuit_FUN_00506f10
              ("js_bound bad layer/modext (%d/%d)  File: %s",iVar2,iVar1,&DAT_02f68188);
  }
  in_stack_00000004[5] = *(int *)("$CMotionController$$" + iVar2 * 0x10 + iVar1 * 4 + 0xf);
  return;
}
...
// Assembly code:
// 0052ea80: PUSH EBX
//   Label: sound_mp3.cpp_FUN_0052ea80
// 0052ea81: PUSH ESI
// 0052ea82: PUSH EDI
// 0052ea83: PUSH EBP
