...
// Cross-references:
//   sound_mp3.cpp_CMP3Decoder_decodeFrame_FUN_00534d40 (00534d40) at 00535882 [UNCONDITIONAL_CALL]
// Globals:
...
//   double[200] g_MpegRequantPowerTable
//   double[200] g_MpegRequantGainTable
// Function calls:
...

{
  ...
  if (g_MpegRequantTablesInitialized == 0) {
    fVar11 = (float10)DOUBLE_0063b04a;
    iVar4 = 0;
    iVar6 = 0;
    do {
    ...
    iVar6 = 0;
    fVar9 = (float10)DOUBLE_0063b052;
    fVar11 = (float10)DOUBLE_0063b042;
    iVar4 = 0;
    do {
      ...
      *(double *)((int)g_MpegRequantGainTable + iVar4) = (double)fVar10;
      iVar4 = iVar4 + 8;
    } while (iVar6 < 200);
...
LAB_00531ee0:
      if (*(int *)((int)quantized_samples->samples[0] + iVar4 + local_68) == 0) {
        *(undefined4 *)((int)output_samples->samples[0] + iVar4 + local_68) = 0;
      }
      else {
        ...
        if ((iVar6 < 1) && (-200 < iVar6)) {
          fVar11 = (float10)g_MpegRequantGainTable[-iVar6];
          pfVar3 = local_3c;
        }
        else {
          fVar11 = crt_math_c_pow_FUN_005ffd76
                             ((float10)DOUBLE_0063b052,(float10)iVar6 * (float10)DOUBLE_0063b042);
          pfVar3 = local_34;
        ...
        *pfVar3 = (float)fVar11;
        ...
        if (iVar6 < 200) {
          *local_18 = *local_18 * (float)g_MpegRequantPowerTable[iVar6];
          ...
          fVar11 = crt_math_c_pow_FUN_005ffd76((float10)iVar6,(float10)DOUBLE_0063b04a);
