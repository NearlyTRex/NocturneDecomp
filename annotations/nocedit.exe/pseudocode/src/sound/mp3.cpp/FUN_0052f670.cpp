// Name: sound_mp3.cpp_FUN_0052f670
// Address: 0052f670
// Address Range: [[0052f670, 0052f79f]]
// Convention: unknown
// Signature: undefined sound_mp3.cpp_FUN_0052f670()
// Cross-references:
//   sound_mp3.cpp_MpegLoadMaybe_FUN_00534d40 (00534d40) at 005353c9 [UNCONDITIONAL_CALL]
// Function calls:
//   sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40

#include "nocturne.h"

/* Signature: undefined1 sound_mp3.cpp_FUN_0052f670(undefined4 param_1, undefined4 param_2,
   undefined4 param_3) */

void sound_mp3_cpp_FUN_0052f670(void)

{
  ...
  iVar7 = *(int *)(in_stack_0000000c + 0x18);
  ...
  if (0 < iVar5) {
    ...
    do {
      iVar6 = 0;
      if (0 < iVar1) {
        puVar3 = (uint *)(local_14 + in_stack_00000008);
        do {
  ...
  if (iVar5 < iVar7) {
    puVar3 = (uint *)(iVar5 * 4 + in_stack_00000008);
    do {
      uVar2 = sound_mp3_cpp_ReadOrWriteBits_FUN_0052ef40();
  ...
  if (iVar7 < 0x20) {
    ...
    do {
      iVar5 = 0;
      if (0 < iVar1) {
        puVar4 = (undefined4 *)(in_stack_00000008 + iVar7);
        do {
          iVar5 = iVar5 + 1;
          *puVar4 = 0;
          puVar4 = puVar4 + 0x20;
...
// Assembly code:
// 0052f670: PUSH EBX
//   Label: sound_mp3.cpp_FUN_0052f670
// 0052f671: PUSH ESI
// 0052f672: PUSH EDI
// 0052f673: PUSH EBP
...
// 0052f6c7: PUSH ECX
// 0052f6c8: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
...
//   XREF to: Stack[0x4] (READ)
// 0052f72f: PUSH EDX
// 0052f730: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
