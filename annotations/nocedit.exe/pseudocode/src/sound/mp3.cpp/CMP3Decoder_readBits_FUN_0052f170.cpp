...

{
  ...
  while (0 < (int)num_bits) {
    if ((this_ptr->memory_bitstream).bits_available == 0) {
      ...
      uVar4 = (this_ptr->memory_bitstream).current_dword_index + 1;
      (this_ptr->memory_bitstream).current_dword_index = uVar4;
      if ((this_ptr->memory_bitstream).buffer_size_limit < uVar4) {
    ...
    uVar4 = (this_ptr->memory_bitstream).bits_available;
    if (num_bits < uVar4) {
      uVar4 = num_bits;
    }
    uVar1 = (this_ptr->memory_bitstream).bits_available;
    num_bits = num_bits - uVar4;
    uVar2 = uVar1 - uVar4;
    local_14 = (byte)uVar2;
