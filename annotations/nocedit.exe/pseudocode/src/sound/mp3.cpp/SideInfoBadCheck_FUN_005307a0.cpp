// Name: sound_mp3.cpp_SideInfoBadCheck_FUN_005307a0
// Address: 005307a0
// Address Range: [[005307a0, 00530d19]]
// Convention: unknown
// Signature: undefined sound_mp3.cpp_SideInfoBadCheck_FUN_005307a0()
// Cross-references:
//   sound_mp3.cpp_MpegLoadMaybe_FUN_00534d40 (00534d40) at 0053560c [UNCONDITIONAL_CALL]
// Globals:
//   undefined4 s_..\sound\mp3.cpp_0063ae92
...
/* Signature: undefined1 sound_mp3.cpp_SideInfoBadCheck(undefined1 param_1, undefined4 param_2,
   undefined4 param_3, undefined4 param_4) */

void sound_mp3_cpp_SideInfoBadCheck_FUN_005307a0
...

{
  ...
  if (*(int *)*param_8 == 0) {
    ...
    *param_8 = uVar2;
    uVar2 = sound_mp3_cpp_ReadOrWriteBits_FUN_0052ef40();
    *(undefined4 *)(param_9 + 4) = uVar2;
    if (0 < local_44) {
      local_30 = param_9;
      do {
        uVar2 = sound_mp3_cpp_ReadOrWriteBits_FUN_0052ef40();
        *(undefined4 *)(local_1c + 0x18) = uVar2;
        uRam0000001c = sound_mp3_cpp_ReadOrWriteBits_FUN_0052ef40();
        uVar2 = sound_mp3_cpp_ReadOrWriteBits_FUN_0052ef40();
        *(undefined4 *)(local_14 + 0x20) = uVar2;
        uVar2 = sound_mp3_cpp_ReadOrWriteBits_FUN_0052ef40();
        *(undefined4 *)(unaff_EBP + 0x24) = uVar2;
        iRam00000028 = sound_mp3_cpp_FUN_0052ee50();
        iVar4 = local_24 * 0xa0 + param_10;
        if (iRam00000028 == 0) {
          iVar3 = 0;
          do {
            uVar2 = sound_mp3_cpp_ReadOrWriteBits_FUN_0052ef40();
            iVar6 = iVar3 + iVar4;
            iVar3 = iVar3 + 4;
            *(undefined4 *)((int)param_8 + iVar6 + 0x34) = uVar2;
          } while (iVar3 != 0xc);
          uVar2 = sound_mp3_cpp_ReadOrWriteBits_FUN_0052ef40();
          *(undefined4 *)((int)param_8 + iVar4 + 0x4c) = uVar2;
          uVar2 = sound_mp3_cpp_ReadOrWriteBits_FUN_0052ef40();
          *(undefined4 *)((int)param_8 + iVar4 + 0x2c) = 0;
          *(undefined4 *)((int)param_8 + iVar4 + 0x50) = uVar2;
        }
        else {
          uVar2 = sound_mp3_cpp_ReadOrWriteBits_FUN_0052ef40();
          ...
          *(undefined4 *)(unaff_EBX + 0x30) = uVar2;
          uVar9 = local_30 + iVar4 + 8;
          uVar8 = local_30 + iVar4;
          do {
            uVar7 = uVar8 + 4;
            uVar2 = sound_mp3_cpp_ReadOrWriteBits_FUN_0052ef40();
            *(undefined4 *)(uVar8 + 0x34) = uVar2;
            uVar8 = uVar7;
          } while (uVar7 != uVar9);
          uVar7 = uVar7 ^ uVar9;
          do {
            uVar2 = sound_mp3_cpp_ReadOrWriteBits_FUN_0052ef40();
            iVar3 = param_6 + unaff_ESI * 0xa0 + in_stack_00000034;
            iVar4 = iVar3 + uVar7;
            uVar7 = uVar7 + 4;
          ...
          if (*(int *)(iVar3 + 0x2c) == 0) {
            ...
            core_main_c_displayErrorAndQuit_FUN_00506f10
                      ("Side info bad: block_type == 0 in split block.  File: %s",&DAT_02f68188);
          }
          else if ((*(int *)(iVar3 + 0x2c) == 2) && (*(int *)(iVar3 + 0x30) == 0)) {
            *(undefined4 *)(iVar3 + 0x4c) = 8;
          }
          else {
            *(undefined4 *)(param_9 + 0x4c) = 7;
          }
        ...
        *(undefined4 *)(unaff_ESI + 0x58) = uVar2;
        uVar2 = sound_mp3_cpp_FUN_0052ee50();
        param_5 = param_5 + 1;
        *(undefined4 *)(unaff_EBX + 0x5c) = uVar2;
    ...
    *(undefined4 *)(param_9 + 4) = uVar2;
    iVar4 = 0;
    if (0 < local_44) {
      local_54 = param_9 + 0x10;
      do {
        iVar3 = param_9 + iVar4 * 0xa0;
        do {
          iVar6 = iVar3 + 4;
          uVar2 = sound_mp3_cpp_FUN_0052ee50();
      ...
      if (0 < local_44) {
        ...
        do {
          ...
          *(undefined4 *)(iVar4 + 0x20) = uVar2;
          uVar2 = sound_mp3_cpp_ReadOrWriteBits_FUN_0052ef40();
          *(undefined4 *)(unaff_EDI + 0x24) = uVar2;
          iVar6 = sound_mp3_cpp_FUN_0052ee50();
          iVar5 = local_28 * 0xa0 + param_10;
          *(int *)(unaff_ESI + 0x28) = iVar6;
          if (iVar6 == 0) {
            iVar6 = 0;
            do {
              uVar2 = sound_mp3_cpp_ReadOrWriteBits_FUN_0052ef40();
              iVar10 = param_6 + iVar5;
              iVar1 = iVar10 + iVar6;
              iVar6 = iVar6 + 4;
            ...
            local_44 = 0x530a93;
            uVar2 = sound_mp3_cpp_ReadOrWriteBits_FUN_0052ef40();
            *(undefined4 *)(iVar10 + 0x4c) = uVar2;
            uVar2 = sound_mp3_cpp_ReadOrWriteBits_FUN_0052ef40();
            *(undefined4 *)(iVar10 + 0x2c) = 0;
            *(undefined4 *)(iVar10 + 0x50) = uVar2;
          }
          else {
            uVar2 = sound_mp3_cpp_ReadOrWriteBits_FUN_0052ef40();
            *(undefined4 *)(unaff_EBX + 0x2c) = uVar2;
            uVar2 = sound_mp3_cpp_FUN_0052ee50();
            uVar8 = local_2c + iVar5;
            *(undefined4 *)(unaff_retaddr + 0x30) = uVar2;
            uVar9 = uVar8 + 8;
            do {
              uVar7 = uVar8 + 4;
              uVar2 = sound_mp3_cpp_ReadOrWriteBits_FUN_0052ef40();
            ...
            uVar7 = uVar7 ^ uVar9;
            iVar6 = unaff_EDI * 0xa0 + in_stack_00000034;
            do {
              local_44 = 0x530941;
              uVar2 = sound_mp3_cpp_ReadOrWriteBits_FUN_0052ef40();
              iVar5 = uVar7 + iVar6;
              uVar7 = uVar7 + 4;
              *(undefined4 *)((int)param_8 + iVar5 + 0x40) = uVar2;
            } while (uVar7 != 0xc);
            iVar5 = *(int *)((int)param_8 + iVar6 + 0x2c);
            if (iVar5 == 0) {
            ...
            else if ((iVar5 == 2) && (*(int *)((int)param_8 + iVar6 + 0x30) == 0)) {
              *(undefined4 *)((int)param_8 + iVar6 + 0x4c) = 8;
            }
            else {
              *(undefined4 *)(iVar3 + 0x4c) = 7;
            }
            *(int *)(iVar4 + 0x50) = 0x14 - *(int *)(iVar4 + 0x4c);
          }
          uVar2 = sound_mp3_cpp_FUN_0052ee50();
          *(undefined4 *)(param_5 + 0x54) = uVar2;
          uVar2 = sound_mp3_cpp_FUN_0052ee50();
          local_2c = param_6;
          *(undefined4 *)(param_6 + 0x58) = uVar2;
          uVar2 = sound_mp3_cpp_FUN_0052ee50();
          param_9 = param_9 + 0xa0;
          iVar6 = param_7 + 0xa0;
          param_5 = param_5 + 1;
          *(undefined4 *)(param_7 + 0x5c) = uVar2;
...
// Assembly code:
// 005307a0: PUSH EBX
//   Label: sound_mp3.cpp_SideInfoBadCheck_FUN_005307a0
// 005307a1: PUSH ESI
// 005307a2: PUSH EDI
// 005307a3: PUSH EBP
...
// 005307c1: PUSH 0x9
// 005307c3: PUSH EBX
// 005307c4: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
...
// 005307e1: PUSH EBX
//   Label: LAB_005307e1
// 005307e2: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
...
// 00530818: CALL sound_mp3.cpp_FUN_0052ee50
...
//   Label: LAB_00530879
// 0053087b: PUSH EBX
// 0053087c: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
...
// 0053089a: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
...
// 005308ac: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
...
// 005308be: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
...
// 005308ce: CALL sound_mp3.cpp_FUN_0052ee50
//   XREF to: 0052ee50 (UNCONDITIONAL_CALL)
...
// 005308e7: PUSH 0x2
// 005308e9: PUSH EBX
// 005308ea: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
...
// 005308fa: CALL sound_mp3.cpp_FUN_0052ee50
//   XREF to: 0052ee50 (UNCONDITIONAL_CALL)
...
// 0053091a: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
...
//   Label: LAB_00530939
// 0053093b: PUSH EBX
// 0053093c: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
...
// 005309a1: PUSH EBX
//   Label: LAB_005309a1
// 005309a2: CALL sound_mp3.cpp_FUN_0052ee50
//   XREF to: 0052ee50 (UNCONDITIONAL_CALL)
...
// 005309b2: CALL sound_mp3.cpp_FUN_0052ee50
//   XREF to: 0052ee50 (UNCONDITIONAL_CALL)
...
// 005309c2: CALL sound_mp3.cpp_FUN_0052ee50
//   XREF to: 0052ee50 (UNCONDITIONAL_CALL)
...
//   Label: LAB_00530a6c
// 00530a6e: PUSH EBX
// 00530a6f: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
...
// 00530a8b: PUSH 0x4
// 00530a8d: PUSH EBX
// 00530a8e: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
// 00530a93: ADD ESP,0x8
// 00530a96: PUSH 0x3
// 00530a98: PUSH EBX
// 00530a99: MOV dword ptr [EDI + 0x4c],EAX
// 00530a9c: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
...
//   Label: LAB_00530ab3
// 00530ab5: PUSH EBX
// 00530ab6: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
...
// 00530ad2: PUSH EBX
//   Label: LAB_00530ad2
// 00530ad3: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
...
//   Label: LAB_00530b14
// 00530b16: PUSH EBX
// 00530b17: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
...
// 00530b35: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
...
// 00530b47: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
...
// 00530b59: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
...
// 00530b69: CALL sound_mp3.cpp_FUN_0052ee50
//   XREF to: 0052ee50 (UNCONDITIONAL_CALL)
...
//   Label: LAB_00530b84
// 00530b86: PUSH EBX
// 00530b87: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
...
// 00530ba3: PUSH 0x4
// 00530ba5: PUSH EBX
// 00530ba6: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
// 00530bab: ADD ESP,0x8
// 00530bae: PUSH 0x3
// 00530bb0: PUSH EBX
// 00530bb1: MOV dword ptr [EDI + 0x4c],EAX
// 00530bb4: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
...
// 00530bc6: PUSH EBX
//   Label: LAB_00530bc6
// 00530bc7: CALL sound_mp3.cpp_FUN_0052ee50
//   XREF to: 0052ee50 (UNCONDITIONAL_CALL)
...
// 00530bd7: CALL sound_mp3.cpp_FUN_0052ee50
//   XREF to: 0052ee50 (UNCONDITIONAL_CALL)
...
//   Label: LAB_00530c3e
// 00530c40: PUSH EBX
// 00530c41: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
...
// 00530c51: CALL sound_mp3.cpp_FUN_0052ee50
//   XREF to: 0052ee50 (UNCONDITIONAL_CALL)
...
// 00530c71: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
...
//   Label: LAB_00530c90
// 00530c92: PUSH EBX
// 00530c93: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
