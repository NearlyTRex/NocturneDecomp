...
section .text
    ...
    JNZ 0x0052f28a                      ; 0052f26a | LAB_0052f28a
    ...
    PUSH ESI                            ; 0052f28a
        ;   Label: LAB_0052f28a
    PUSH 0x2f68188                      ; 0052f28b | char[256] g_CurrentMp3Filename
    MOV ECX,0x63adb8                    ; 0052f290 | = "..\\sound\\mp3.cpp" | s_sound_mp3_cpp_0063adb8 = ..\sound\mp3.cpp
    MOV ESI,0x2d5                       ; 0052f295
    PUSH 0x63adc9                       ; 0052f29a | = "hputbuf - Not Supported yet!!  File: %s" | s_hputbuf_Not_Supported_ye_0063adc9 = hputbuf - Not Supported yet!!  File: %s
    MOV dword ptr [0x02f0ca48],ECX      ; 0052f29f | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 0052f2a5 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0052f2ab | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0052f2b0
    POP ESI                             ; 0052f2b3
    JMP 0x0052f26c                      ; 0052f2b4 | LAB_0052f26c
