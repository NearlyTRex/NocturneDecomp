...
// Cross-references:
//   sound_mp3.cpp_CMP3Decoder_decodeFrame_FUN_00534d40 (00534d40) at 0053542a [UNCONDITIONAL_CALL]
// Function calls:
...

{
  ...
  if (0 < iVar11) {
    ...
    do {
      ...
      while( true ) {
        ...
        if (*local_1c == 0) {
          puVar8 = (undefined4 *)((int)local_18->codes[0] + local_48);
          do {
            *puVar8 = 0;
            puVar8 = puVar8 + 0x20;
          } while (puVar8 != (undefined4 *)((int)local_18[1].codes[0] + local_48));
        }
        else {
        ...
        if ((iVar1 == 2) && (iVar9 <= local_2c)) {
          puVar8 = (undefined4 *)((int)sample_array->codes[0] + local_48);
          do {
            puVar7 = puVar8 + 0x20;
            puVar8[0x60] = *puVar8;
            puVar8 = puVar7;
          } while (puVar7 != (undefined4 *)((int)sample_array[1].codes[0] + local_48));
        }
  ...
  if (iVar11 < 0x20) {
    ...
    do {
      ...
      if (0 < iVar1) {
        do {
          puVar8 = (undefined4 *)((int)sample_array[iVar9].codes[0] + iVar11);
          do {
            puVar7 = puVar8 + 0x20;
            *puVar8 = 0;
            puVar8 = puVar7;
          } while (puVar7 != (undefined4 *)((int)sample_array[iVar9 + 1].codes[0] + iVar11));
          iVar9 = iVar9 + 1;
        } while (iVar9 < iVar1);
      }
      iVar11 = iVar11 + 4;
...
// 0052fe42: CALL sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40
...
// 0052fe5b: PUSH EAX
// 0052fe5c: PUSH EBP
// 0052fe5d: CALL sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
