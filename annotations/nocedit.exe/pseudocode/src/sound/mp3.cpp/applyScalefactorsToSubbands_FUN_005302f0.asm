...
section .text
    ...
    JLE 0x00530397                      ; 00530302 | LAB_00530397
    ...
    JLE 0x0053038c                      ; 00530320 | LAB_0053038c
    ...
    FLD ST0                             ; 00530338
    FMUL double ptr [EBX*0x8 + 0x67e3c0] ; 0053033a | double[64] g_MpegScalefactorTable
    ...
    FLD ST0                             ; 00530351
    FMUL double ptr [EBX*0x8 + 0x67e3c0] ; 00530353 | double[64] g_MpegScalefactorTable
    ...
    FLD ST0                             ; 0053036e
    FMUL double ptr [EBX*0x8 + 0x67e3c0] ; 00530370 | double[64] g_MpegScalefactorTable
