...
;                               FUNCTION
; *****************************************************************************
; __cdecl void sound_mp3.cpp_initializeSynthesisDctTable_FUN_00530400(float * output_dct_table)
;
; Parameters:
...
section .text
    ...
    FMUL double ptr [0x0063ae2a]        ; 00530430 | double DOUBLE_0063ae2a
    FADD double ptr [0x0063ae42]        ; 00530436 | double DOUBLE_0063ae42
    MOV dword ptr [ESP + 0x20],ESI      ; 0053043c
    FILD dword ptr [ESP + 0x20]         ; 00530440
    FMULP                               ; 00530444
    FCOS                                ; 00530446
    FMUL double ptr [0x0063ae32]        ; 00530448 | double DOUBLE_0063ae32
    FLDZ                                ; 0053044e
    FXCH                                ; 00530450
    ...
    FNSTSW AX                           ; 00530456
    SAHF                                ; 00530458
    JBE 0x005304c2                      ; 00530459 | LAB_005304c2
    ...
    PUSH EAX                            ; 00530464
    FADD double ptr [0x0063ae4a]        ; 00530465 | double DOUBLE_0063ae4a
    SUB ESP,0x8                         ; 0053046b
    FSTP double ptr [ESP]               ; 0053046e
    CALL crt_math.c_modf_FUN_00602102   ; 00530471 | double crt_math.c_modf_FUN_00602102(double value, double * integer_part)
    ...
    FLD ST0                             ; 00530480
    FMUL double ptr [0x0063ae3a]        ; 00530482 | double DOUBLE_0063ae3a
    ...
    JNZ 0x00530424                      ; 00530499 | LAB_00530424
    ...
    JL 0x00530419                       ; 005304b5 | LAB_00530419
    ...
    PUSH EAX                            ; 005304ce
    FADD double ptr [0x0063ae52]        ; 005304cf | double DOUBLE_0063ae52
    SUB ESP,0x8                         ; 005304d5
    FSTP double ptr [ESP]               ; 005304d8
    CALL crt_math.c_modf_FUN_00602102   ; 005304db | double crt_math.c_modf_FUN_00602102(double value, double * integer_part)
        ;   XREF to: 00602102 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005304e0
    FLD double ptr [ESP + 0x8]          ; 005304e3
    JMP 0x0053047c                      ; 005304e7 | LAB_0053047c
