...
section .text
    ...
    JZ 0x0052eb11                       ; 0052eaa6 | LAB_0052eb11
    ...
    JNZ 0x0052ec2a                      ; 0052eab5 | LAB_0052ec2a
    ...
    JL 0x0052eace                       ; 0052eac3 | LAB_0052eace
        ;   XREF to: 0052eace (CONDITIONAL_JUMP)
    CMP EDI,0x3                         ; 0052eac5
    JLE 0x0052ec14                      ; 0052eac8 | LAB_0052ec14
        ;   XREF to: 0052ec14 (CONDITIONAL_JUMP)
    PUSH 0x2f68188                      ; 0052eace | char[256] g_CurrentMp3Filename
        ;   Label: LAB_0052eace
    PUSH ESI                            ; 0052ead3
    PUSH EDI                            ; 0052ead4
    MOV EBP,0x63aca4                    ; 0052ead5 | = "..\\sound\\mp3.cpp" | s_sound_mp3_cpp_0063aca4 = ..\sound\mp3.cpp
    MOV EAX,0x1b2                       ; 0052eada
    PUSH 0x63acb5                       ; 0052eadf | = "js_bound bad layer/modext (%d/%d)  Fi..." | s_js_bound_bad_layer_modex_0063acb5 = js_bound bad layer/modext (%d/%d)  File: %s
    MOV dword ptr [0x02f0ca48],EBP      ; 0052eae4 | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 0052eaea | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0052eaef | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    MOV EAX,dword ptr [EAX + 0x67d820]  ; 0052eb00 | void *[4][4] g_MpegLayer2AllocationTables
    ...
    MOV EDX,dword ptr [EAX + EDX*0x4 + 0x67e258] ; 0052eb54 | int[2][3][15] g_MpegBitrateTable
    ...
    FLD double ptr [ECX + EAX*0x8 + 0x67e218] ; 0052eb73 | double[2][4] g_MpegSampleRateTable
    CALL crt_math.c_round_FUN_005fe6b0  ; 0052eb7a | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x10]        ; 0052eb7f
    CMP EDI,0x1                         ; 0052eb83
    JNZ 0x0052ec0d                      ; 0052eb86 | LAB_0052ec0d
        ;   XREF to: 0052ec0d (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x10],0x30     ; 0052eb8c
    JNZ 0x0052ebd6                      ; 0052eb91 | LAB_0052ebd6
        ;   XREF to: 0052ebd6 (CONDITIONAL_JUMP)
    CMP EDX,0x38                        ; 0052eb93
    JL 0x0052ebd6                       ; 0052eb96 | LAB_0052ebd6
        ;   XREF to: 0052ebd6 (CONDITIONAL_JUMP)
    ...
    JZ 0x0052ebca                       ; 0052eba1 | LAB_0052ebca
        ;   XREF to: 0052ebca (CONDITIONAL_JUMP)
    PUSH 0x2f68188                      ; 0052eba3 | char[256] g_CurrentMp3Filename
    MOV EAX,0x63ac5a                    ; 0052eba8 | = "..\\sound\\mp3.cpp" | s_sound_mp3_cpp_0063ac5a = ..\sound\mp3.cpp
    MOV EDX,0x1a2                       ; 0052ebad
    PUSH 0x63ac6b                       ; 0052ebb2 | = "MPEG Layer 2 - pick_table - can't loa..." | s_MPEG_Layer_2_pick_table__0063ac6b = MPEG Layer 2 - pick_table - can't load tables!  File: %s
    MOV [0x02f0ca48],EAX                ; 0052ebb7 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 0052ebbc | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0052ebc2 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0052ebc7
    MOV EAX,dword ptr [ESP + 0xc]       ; 0052ebca
        ;   Label: LAB_0052ebca
    MOV dword ptr [EBX + 0x18],EAX      ; 0052ebce
    JMP 0x0052eaaf                      ; 0052ebd1 | LAB_0052eaaf
        ;   XREF to: 0052eaaf (UNCONDITIONAL_JUMP)
    CMP EDX,0x38                        ; 0052ebd6
        ;   Label: LAB_0052ebd6
    JL 0x0052ebe0                       ; 0052ebd9 | LAB_0052ebe0
        ;   XREF to: 0052ebe0 (CONDITIONAL_JUMP)
    CMP EDX,0x50                        ; 0052ebdb
    JLE 0x0052eb98                      ; 0052ebde | LAB_0052eb98
        ;   XREF to: 0052eb98 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x10],0x30     ; 0052ebe0
        ;   Label: LAB_0052ebe0
    JZ 0x0052ebf3                       ; 0052ebe5 | LAB_0052ebf3
        ;   XREF to: 0052ebf3 (CONDITIONAL_JUMP)
    CMP EDX,0x60                        ; 0052ebe7
    JL 0x0052ebf3                       ; 0052ebea | LAB_0052ebf3
        ;   XREF to: 0052ebf3 (CONDITIONAL_JUMP)
    MOV EAX,0x1                         ; 0052ebec
    JMP 0x0052eb9a                      ; 0052ebf1 | LAB_0052eb9a
        ;   XREF to: 0052eb9a (UNCONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x10],0x20     ; 0052ebf3
        ;   Label: LAB_0052ebf3
    JZ 0x0052ec06                       ; 0052ebf8 | LAB_0052ec06
        ;   XREF to: 0052ec06 (CONDITIONAL_JUMP)
    CMP EDX,0x30                        ; 0052ebfa
    JG 0x0052ec06                       ; 0052ebfd | LAB_0052ec06
        ;   XREF to: 0052ec06 (CONDITIONAL_JUMP)
    MOV EAX,0x2                         ; 0052ebff
    JMP 0x0052eb9a                      ; 0052ec04 | LAB_0052eb9a
        ;   XREF to: 0052eb9a (UNCONDITIONAL_JUMP)
    MOV EAX,0x3                         ; 0052ec06
        ;   Label: LAB_0052ec06
    JMP 0x0052eb9a                      ; 0052ec0b | LAB_0052eb9a
        ;   XREF to: 0052eb9a (UNCONDITIONAL_JUMP)
    MOV EAX,0x4                         ; 0052ec0d
        ;   Label: LAB_0052ec0d
    JMP 0x0052eb9a                      ; 0052ec12 | LAB_0052eb9a
        ;   XREF to: 0052eb9a (UNCONDITIONAL_JUMP)
    TEST ESI,ESI                        ; 0052ec14
        ;   Label: LAB_0052ec14
    JL 0x0052eace                       ; 0052ec16 | LAB_0052eace
        ;   XREF to: 0052eace (CONDITIONAL_JUMP)
    CMP ESI,0x3                         ; 0052ec1c
    JG 0x0052eace                       ; 0052ec1f | LAB_0052eace
        ;   XREF to: 0052eace (CONDITIONAL_JUMP)
    JMP 0x0052eaf7                      ; 0052ec25 | LAB_0052eaf7
