...
section .text
    ...
    JNZ 0x0053286d                      ; 00532605 | LAB_0053286d
        ;   XREF to: 0053286d (CONDITIONAL_JUMP)
    TEST byte ptr [EDX + 0x20],0x2      ; 0053260b
    JZ 0x0053286d                       ; 0053260f | LAB_0053286d
        ;   XREF to: 0053286d (CONDITIONAL_JUMP)
    ...
    JNZ 0x00532874                      ; 00532629 | LAB_00532874
        ;   XREF to: 00532874 (CONDITIONAL_JUMP)
    TEST byte ptr [EDX + 0x20],0x1      ; 0053262f
    JZ 0x00532874                       ; 00532633 | LAB_00532874
        ;   XREF to: 00532874 (CONDITIONAL_JUMP)
    ...
    JNZ 0x0053287b                      ; 00532660 | LAB_0053287b
    ...
    JNZ 0x005326d6                      ; 0053271d | LAB_005326d6
        ;   XREF to: 005326d6 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x1f90],0x2    ; 0053271f
    JNZ 0x00533457                      ; 00532727 | LAB_00533457
    ...
    JL 0x00532790                       ; 00532815 | LAB_00532790
    ...
    JL 0x00532751                       ; 00532860 | LAB_00532751
    ...
    XOR EDX,EDX                         ; 0053286d
        ;   Label: LAB_0053286d
    JMP 0x0053261a                      ; 0053286f | LAB_0053261a
        ;   XREF to: 0053261a (UNCONDITIONAL_JUMP)
    XOR EDX,EDX                         ; 00532874
        ;   Label: LAB_00532874
    JMP 0x0053263b                      ; 00532876 | LAB_0053263b
    ...
    TEST dword ptr [EBX + EDX*0x4 + 0x900],0x7fffffff ; 005328c0
        ;   Label: LAB_005328c0
    JZ 0x0053337b                       ; 005328cb | LAB_0053337b
    ...
    JL 0x00532920                       ; 00532903 | LAB_00532920
        ;   XREF to: 00532920 (CONDITIONAL_JUMP)
    INC ESI                             ; 00532905
        ;   Label: LAB_00532905
    MOV EBX,dword ptr [EAX + 0x67e6cc]  ; 00532906 | DAT_0067e6cc
    ADD EAX,0x4                         ; 0053290c
    CMP EDI,EBX                         ; 0053290f
    JGE 0x00532905                      ; 00532911 | LAB_00532905
    ...
    MOV ESI,dword ptr [EAX + 0x67e6c8]  ; 0053292e | DAT_0067e6cc
    ...
    JGE 0x00532a5b                      ; 00532967 | LAB_00532a5b
    ...
    MOV EBX,dword ptr [EAX + 0x67e6c8]  ; 00532982 | DAT_0067e6cc
    MOV EDI,dword ptr [EDI + 0x67e6cc]  ; 00532988 | DAT_0067e6d0
    SUB EDI,EBX                         ; 0053298e
    TEST EDI,EDI                        ; 00532990
    JLE 0x00532a21                      ; 00532992 | LAB_00532a21
    ...
    CMP AX,0x7                          ; 005329d0
    JZ 0x00532a07                       ; 005329d4 | LAB_00532a07
        ;   XREF to: 00532a07 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x1fa0],0x0    ; 005329d6
    JZ 0x00533393                       ; 005329de | LAB_00533393
    ...
    PUSH EAX                            ; 005329fe
    CALL sound_mp3.cpp_calculateIntensityStereoRatio_FUN_00532540 ; 005329ff | void sound_mp3.cpp_calculateIntensityStereoRatio_FUN_00532540(int intensity_position, double ratio, int unused_param3, int sample_index, ...)
    ...
    JG 0x005329ba                       ; 00532a1f | LAB_005329ba
    ...
    JL 0x00532974                       ; 00532a55 | LAB_00532974
    ...
    JLE 0x005326c0                      ; 00532a7e | LAB_005326c0
        ;   XREF to: 005326c0 (CONDITIONAL_JUMP)
    ...
    JG 0x00532aa2                       ; 00532af5 | LAB_00532aa2
        ;   XREF to: 00532aa2 (CONDITIONAL_JUMP)
    JMP 0x005326c0                      ; 00532af7 | LAB_005326c0
        ;   XREF to: 005326c0 (UNCONDITIONAL_JUMP)
    CMP EAX,dword ptr [ECX + 0x14]      ; 00532afc
        ;   Label: LAB_00532afc
    JNZ 0x005328a9                      ; 00532aff | LAB_005328a9
    ...
    JZ 0x00533059                       ; 00532b22 | LAB_00533059
    ...
    MOV EBX,dword ptr [EAX + 0x67e728]  ; 00532b80 | DAT_0067e758
    MOV EDX,dword ptr [EAX + 0x67e724]  ; 00532b86 | DAT_0067e754
    ...
    JLE 0x00532bf4                      ; 00532ba2 | LAB_00532bf4
    ...
    JZ 0x00532bee                       ; 00532bde | LAB_00532bee
    ...
    JG 0x00532ba4                       ; 00532bf2 | LAB_00532ba4
        ;   XREF to: 00532ba4 (CONDITIONAL_JUMP)
    DEC ESI                             ; 00532bf4
        ;   Label: LAB_00532bf4
    CMP ESI,0x3                         ; 00532bf5
    JGE 0x00532b70                      ; 00532bf8 | LAB_00532b70
    ...
    JG 0x00532f25                       ; 00532c16 | LAB_00532f25
    ...
    JGE 0x00532f55                      ; 00532c4e | LAB_00532f55
    ...
    JLE 0x00532d16                      ; 00532c88 | LAB_00532d16
    ...
    CMP AX,0x7                          ; 00532cc5
    JZ 0x00532cfc                       ; 00532cc9 | LAB_00532cfc
        ;   XREF to: 00532cfc (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x1fa0],0x0    ; 00532ccb
    JZ 0x00532f31                       ; 00532cd3 | LAB_00532f31
    ...
    PUSH EAX                            ; 00532cf3
    CALL sound_mp3.cpp_calculateIntensityStereoRatio_FUN_00532540 ; 00532cf4 | void sound_mp3.cpp_calculateIntensityStereoRatio_FUN_00532540(int intensity_position, double ratio, int unused_param3, int sample_index, ...)
        ;   XREF to: 00532540 (UNCONDITIONAL_CALL)
    ...
    JG 0x00532caf                       ; 00532d14 | LAB_00532caf
    ...
    JMP 0x00532c44                      ; 00532d36 | LAB_00532c44
    ...
    JL 0x00532b50                       ; 00532d5e | LAB_00532b50
        ;   XREF to: 00532b50 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x1fa4],0x3    ; 00532d64
    JG 0x005326c0                       ; 00532d6c | LAB_005326c0
        ;   XREF to: 005326c0 (CONDITIONAL_JUMP)
    ...
    TEST dword ptr [EDI + EDX*0x4 + 0x900],0x7fffffff ; 00532d93
        ;   Label: LAB_00532d93
    JZ 0x0053301d                       ; 00532d9e | LAB_0053301d
    ...
    JG 0x00532e00                       ; 00532de3 | LAB_00532e00
        ;   XREF to: 00532e00 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [ESP + 0x2064]    ; 00532de5
    INC ESI                             ; 00532dec
        ;   Label: LAB_00532dec
    MOV EDX,dword ptr [EAX + 0x67e6cc]  ; 00532ded | DAT_0067e6cc
    ADD EAX,0x4                         ; 00532df3
    CMP EDX,ECX                         ; 00532df6
    JLE 0x00532dec                      ; 00532df8 | LAB_00532dec
    ...
    MOV ESI,dword ptr [EAX + 0x67e6c8]  ; 00532e0e | DAT_0067e6cc
    CMP EBX,0x8                         ; 00532e14
    JGE 0x005326c0                      ; 00532e17 | LAB_005326c0
        ;   XREF to: 005326c0 (CONDITIONAL_JUMP)
    ...
    MOV EDI,dword ptr [EDI + 0x67e6cc]  ; 00532e53 | DAT_0067e6d0
    MOV ECX,dword ptr [EDX + 0x67e6c8]  ; 00532e59 | DAT_0067e6cc
    MOV EAX,dword ptr [ESP + 0x2048]    ; 00532e5f
    SUB EDI,ECX                         ; 00532e66
    SHL EAX,0x2                         ; 00532e68
    TEST EDI,EDI                        ; 00532e6b
    JLE 0x00532ef7                      ; 00532e6d | LAB_00532ef7
    ...
    CMP AX,0x7                          ; 00532ea6
    JZ 0x00532edd                       ; 00532eaa | LAB_00532edd
        ;   XREF to: 00532edd (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x1fa0],0x0    ; 00532eac
    JZ 0x00533035                       ; 00532eb4 | LAB_00533035
    ...
    PUSH EAX                            ; 00532ed4
    CALL sound_mp3.cpp_calculateIntensityStereoRatio_FUN_00532540 ; 00532ed5 | void sound_mp3.cpp_calculateIntensityStereoRatio_FUN_00532540(int intensity_position, double ratio, int unused_param3, int sample_index, ...)
        ;   XREF to: 00532540 (UNCONDITIONAL_CALL)
    ...
    JG 0x00532e90                       ; 00532ef5 | LAB_00532e90
    ...
    JLE 0x00532d3b                      ; 00532fb1 | LAB_00532d3b
    ...
    JLE 0x00532d3b                      ; 00533015 | LAB_00532d3b
        ;   XREF to: 00532d3b (CONDITIONAL_JUMP)
    JMP 0x00532fc9                      ; 0053301b | LAB_00532fc9
        ;   XREF to: 00532fc9 (UNCONDITIONAL_JUMP)
    DEC EDX                             ; 0053301d
        ;   Label: LAB_0053301d
    TEST EDX,EDX                        ; 0053301e
    JGE 0x00533028                      ; 00533020 | LAB_00533028
    ...
    MOV EBX,dword ptr [EAX + 0x67e728]  ; 005330a8 | DAT_0067e758
    MOV EDI,dword ptr [EAX + 0x67e724]  ; 005330ae | DAT_0067e754
    ...
    JLE 0x0053311c                      ; 005330ca | LAB_0053311c
    ...
    JZ 0x00533116                       ; 00533106 | LAB_00533116
    ...
    JG 0x005330cc                       ; 0053311a | LAB_005330cc
        ;   XREF to: 005330cc (CONDITIONAL_JUMP)
    DEC ESI                             ; 0053311c
        ;   Label: LAB_0053311c
    TEST ESI,ESI                        ; 0053311d
    JGE 0x00533098                      ; 0053311f | LAB_00533098
    ...
    JGE 0x0053326b                      ; 00533164 | LAB_0053326b
    ...
    MOV EDI,dword ptr [EAX + 0x67e724]  ; 0053317f | DAT_0067e758
    MOV ESI,dword ptr [ESI + 0x67e728]  ; 00533185 | DAT_0067e75c
    ...
    JLE 0x00533231                      ; 0053319e | LAB_00533231
    ...
    CMP AX,0x7                          ; 005331e0
    JZ 0x00533217                       ; 005331e4 | LAB_00533217
        ;   XREF to: 00533217 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x1fa0],0x0    ; 005331e6
    JZ 0x00533357                       ; 005331ee | LAB_00533357
    ...
    PUSH EAX                            ; 0053320e
    CALL sound_mp3.cpp_calculateIntensityStereoRatio_FUN_00532540 ; 0053320f | void sound_mp3.cpp_calculateIntensityStereoRatio_FUN_00532540(int intensity_position, double ratio, int unused_param3, int sample_index, ...)
        ;   XREF to: 00532540 (UNCONDITIONAL_CALL)
    ...
    JG 0x005331ca                       ; 0053322f | LAB_005331ca
    ...
    JL 0x00533171                       ; 00533265 | LAB_00533171
    ...
    JLE 0x00533329                      ; 005332c7 | LAB_00533329
    ...
    JG 0x005332db                       ; 00533327 | LAB_005332db
    ...
    JZ 0x00533401                       ; 005333e9 | LAB_00533401
    ...
    JMP 0x005327f7                      ; 005333fc | LAB_005327f7
    ...
    JMP 0x005327f7                      ; 00533426 | LAB_005327f7
        ;   XREF to: 005327f7 (UNCONDITIONAL_JUMP)
    PUSH 0x2f68188                      ; 0053342b | char[256] g_CurrentMp3Filename
        ;   Label: LAB_0053342b
    MOV EAX,0x63b05a                    ; 00533430 | = "..\\sound\\mp3.cpp" | s_sound_mp3_cpp_0063b05a = ..\sound\mp3.cpp
    MOV EDX,0x9bd                       ; 00533435
    PUSH 0x63b06b                       ; 0053343a | = "Error in streo processing.  File: %s" | s_Error_in_streo_processin_0063b06b = Error in streo processing.  File: %s
    MOV [0x02f0ca48],EAX                ; 0053343f | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 00533444 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0053344a | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0053344f
    JMP 0x005327fd                      ; 00533452 | LAB_005327fd
        ;   XREF to: 005327fd (UNCONDITIONAL_JUMP)
    ...
    JNZ 0x0053347a                      ; 00533487 | LAB_0053347a
    ...
    JGE 0x00532866                      ; 005334a1 | LAB_00532866
        ;   XREF to: 00532866 (CONDITIONAL_JUMP)
    JMP 0x00533469                      ; 005334a7 | LAB_00533469
