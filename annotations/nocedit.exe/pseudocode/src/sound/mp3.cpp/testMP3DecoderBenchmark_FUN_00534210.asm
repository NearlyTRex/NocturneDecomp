...
;
; Local Variables:
; time_t           Stack[-0x38]:4  local_38
; time_t           Stack[-0x34]:4  local_34
; _FILE *          Stack[-0x30]:4  local_30
; CMP3Decoder *    Stack[-0x2c]:4  local_2c
; _FILE *          Stack[-0x28]:4  local_28
; CMP3Decoder *    Stack[-0x24]:4  local_24
...
section .text
    ...
    PUSH EAX                            ; 00534413
    CALL shape_memdbg.cpp_debugFreeChecked_FUN_0050f210 ; 00534414
    ...
    PUSH EAX                            ; 005344dd
    CALL shape_memdbg.cpp_debugFreeChecked_FUN_0050f210 ; 005344de
        ;   XREF to: 0050f210 (UNCONDITIONAL_CALL)  ; void shape_memdbg.cpp_debugFreeChecked_FUN_0050f210(void * ptr)
