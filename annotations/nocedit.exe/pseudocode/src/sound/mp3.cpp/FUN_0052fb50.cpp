// Name: sound_mp3.cpp_FUN_0052fb50
// Address: 0052fb50
// Address Range: [[0052fb50, 0052fc41]]
// Convention: unknown
// Signature: undefined sound_mp3.cpp_FUN_0052fb50()
// Cross-references:
//   sound_mp3.cpp_MpegLoadMaybe_FUN_00534d40 (00534d40) at 005350cb [UNCONDITIONAL_CALL]
// Function calls:
//   sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40

#include "nocturne.h"

/* Signature: undefined1 sound_mp3.cpp_FUN_0052fb50(undefined4 param_1, undefined4 param_2,
   undefined4 param_3, undefined4 param_4) */

void sound_mp3_cpp_FUN_0052fb50(void)

{
  ...
  iVar6 = *(int *)(in_stack_00000010 + 0x14);
  if (0 < iVar6) {
    local_14 = 0;
    do {
      iVar5 = 0;
      if (0 < iVar1) {
        piVar4 = (int *)(local_14 + in_stack_0000000c);
        piVar2 = (int *)(local_14 + in_stack_00000008);
        do {
          iVar3 = *piVar4;
          if (iVar3 != 0) {
  ...
  if (iVar6 < 0x20) {
    iVar6 = iVar6 * 4;
    local_18 = (int *)(in_stack_0000000c + iVar6);
    do {
      iVar5 = *local_18;
      if (iVar5 != 0) {
        iVar5 = sound_mp3_cpp_ReadOrWriteBits_FUN_0052ef40();
      }
      iVar3 = 0;
      if (0 < iVar1) {
        piVar2 = (int *)(in_stack_00000008 + iVar6);
        do {
          iVar3 = iVar3 + 1;
          *piVar2 = iVar5;
          piVar2 = piVar2 + 0x60;
...
// Assembly code:
// 0052fb50: PUSH EBX
//   Label: sound_mp3.cpp_FUN_0052fb50
// 0052fb51: PUSH ESI
// 0052fb52: PUSH EDI
// 0052fb53: PUSH EBP
...
// 0052fc23: PUSH ECX
// 0052fc24: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
...
//   XREF to: Stack[0x4] (READ)
// 0052fc37: PUSH ESI
// 0052fc38: CALL sound_mp3.cpp_ReadOrWriteBits_FUN_0052ef40
//   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
