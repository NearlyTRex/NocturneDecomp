...
;                               FUNCTION
; *****************************************************************************
; __cdecl int sound_mp3.cpp_validateLayer2AllocationTable_FUN_0052e8d0(SMpegFrame * frame)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [EBP + EAX*0x4 + 0x67e258] ; 0052e913 | int[2][3][15] g_MpegBitrateTable
    ...
    FLD double ptr [ECX + EAX*0x8 + 0x67e218] ; 0052e931 | double[2][4] g_MpegSampleRateTable
    CALL crt_math.c_round_FUN_005fe6b0  ; 0052e938 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x8]         ; 0052e93d
    CMP EBX,0x1                         ; 0052e941
    JNZ 0x0052e9c9                      ; 0052e944 | LAB_0052e9c9
        ;   XREF to: 0052e9c9 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x8],0x30      ; 0052e94a
    JNZ 0x0052e96b                      ; 0052e94f | LAB_0052e96b
        ;   XREF to: 0052e96b (CONDITIONAL_JUMP)
    CMP EDX,0x38                        ; 0052e951
    JL 0x0052e96b                       ; 0052e954 | LAB_0052e96b
        ;   XREF to: 0052e96b (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 0052e956
        ;   Label: LAB_0052e956
    CMP EAX,dword ptr [ESI + 0xc]       ; 0052e958
    JNZ 0x0052e9dd                      ; 0052e95b | LAB_0052e9dd
    ...
    JNZ 0x0052e9dd                      ; 0052e9bd | LAB_0052e9dd
        ;   XREF to: 0052e9dd (CONDITIONAL_JUMP)
    ...
    JNZ 0x0052e9dd                      ; 0052e9d1 | LAB_0052e9dd
        ;   XREF to: 0052e9dd (CONDITIONAL_JUMP)
    ...
    POP EBX                             ; 0052e9db
    RET                                 ; 0052e9dc
    PUSH 0x2f68188                      ; 0052e9dd | char[256] g_CurrentMp3Filename
        ;   Label: LAB_0052e9dd
    MOV EAX,0x63ac5a                    ; 0052e9e2 | = "..\\sound\\mp3.cpp" | s_sound_mp3_cpp_0063ac5a = ..\sound\mp3.cpp
    MOV EDX,0x1a2                       ; 0052e9e7
    PUSH 0x63ac6b                       ; 0052e9ec | = "MPEG Layer 2 - pick_table - can't loa..." | s_MPEG_Layer_2_pick_table__0063ac6b = MPEG Layer 2 - pick_table - can't load tables!  File: %s
    MOV [0x02f0ca48],EAX                ; 0052e9f1 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 0052e9f6 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0052e9fc | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
