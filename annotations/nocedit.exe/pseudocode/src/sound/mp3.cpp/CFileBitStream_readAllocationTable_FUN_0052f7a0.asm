...
section .text
    ...
    JLE 0x0052f806                      ; 0052f7ba | LAB_0052f806
    ...
    JLE 0x0052f7f3                      ; 0052f7d0 | LAB_0052f7f3
    ...
    INC EBX                             ; 0052f7e3
    CALL sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40 ; 0052f7e4 | uint sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40(CFileBitStream * bitstream, int num_bits)
        ;   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0052f7e9
    MOV dword ptr [ESI + -0x80],EAX     ; 0052f7ec
    CMP EBX,EDI                         ; 0052f7ef
    JL 0x0052f7da                       ; 0052f7f1 | LAB_0052f7da
    ...
    JL 0x0052f7cc                       ; 0052f804 | LAB_0052f7cc
        ;   XREF to: 0052f7cc (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [ESP]             ; 0052f806
        ;   Label: LAB_0052f806
    CMP ESI,0x20                        ; 0052f809
    JGE 0x0052f843                      ; 0052f80c | LAB_0052f843
        ;   XREF to: 0052f843 (CONDITIONAL_JUMP)
    SHL ESI,0x2                         ; 0052f80e
    PUSH 0x4                            ; 0052f811
        ;   Label: LAB_0052f811
    PUSH EBP                            ; 0052f813
    CALL sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40 ; 0052f814 | uint sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40(CFileBitStream * bitstream, int num_bits)
        ;   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0052f819
    MOV EBX,EAX                         ; 0052f81c
    XOR EAX,EAX                         ; 0052f81e
    TEST EDI,EDI                        ; 0052f820
    JLE 0x0052f838                      ; 0052f822 | LAB_0052f838
