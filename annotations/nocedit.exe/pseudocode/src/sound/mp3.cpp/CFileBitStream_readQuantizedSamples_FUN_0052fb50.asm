...
;                               FUNCTION
; *****************************************************************************
; __cdecl void sound_mp3.cpp_CFileBitStream_readQuantizedSamples_FUN_0052fb50(CFileBitStream * this_ptr, SMpegSubbandScalefactors * quantized_samples, SMpegSubbandAllocation * allocation, SBitAllocationTable * alloc_table)
;
; Parameters:
...
section .text
    ...
    JLE 0x0052fbbf                      ; 0052fb66 | LAB_0052fbbf
    ...
    JLE 0x0052fbac                      ; 0052fb79 | LAB_0052fbac
    ...
    JNZ 0x0052fc1d                      ; 0052fb93 | LAB_0052fc1d
    ...
    JL 0x0052fb8f                       ; 0052fbaa | LAB_0052fb8f
    ...
    JL 0x0052fbee                       ; 0052fbfd | LAB_0052fbee
    ...
    JL 0x0052fbd8                       ; 0052fc13 | LAB_0052fbd8
    ...
    PUSH ECX                            ; 0052fc23
    CALL sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40 ; 0052fc24 | uint sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40(CFileBitStream * bitstream, int num_bits)
        ;   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0052fc29
    JMP 0x0052fb99                      ; 0052fc2c | LAB_0052fb99
    ...
    PUSH ESI                            ; 0052fc37
    CALL sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40 ; 0052fc38 | uint sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40(CFileBitStream * bitstream, int num_bits)
        ;   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0052fc3d
    JMP 0x0052fbe2                      ; 0052fc40 | LAB_0052fbe2
