...
;                               FUNCTION
; *****************************************************************************
; __cdecl uint sound_mp3.cpp_CFileBitStream_readBit_FUN_0052ee50(CFileBitStream * this_ptr)
;
; Parameters:
...
section .text
    ...
    JNZ 0x0052eefc                      ; 0052ee63 | LAB_0052eefc
    ...
    JGE 0x0052ee92                      ; 0052eeac | LAB_0052ee92
    ...
    PUSH EAX                            ; 0052eede
    DEC ESI                             ; 0052eedf
    CALL crt_stdio.c_fread_FUN_005fd990 ; 0052eee0 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0052eee5
    CMP EAX,0x1                         ; 0052eee8
        ;   Label: LAB_0052eee8
    JNZ 0x0052ef34                      ; 0052eeeb | LAB_0052ef34
        ;   XREF to: 0052ef34 (CONDITIONAL_JUMP)
    DEC dword ptr [EBX + 0x28]          ; 0052eeed
    TEST ESI,ESI                        ; 0052eef0
        ;   Label: LAB_0052eef0
    JGE 0x0052eec1                      ; 0052eef2 | LAB_0052eec1
    ...
    MOV EAX,dword ptr [EDX*0x4 + 0x67e5c0] ; 0052ef0c | DAT_0067e5dc | g_MpegBitMaskTableSingleBit
    MOV CL,DL                           ; 0052ef13
