// Name: sound_mp3.cpp_FUN_0052fee0
// Address: 0052fee0
// Address Range: [[0052fee0, 005301ac]]
// Convention: unknown
// Signature: undefined sound_mp3.cpp_FUN_0052fee0()
// Cross-references:
//   sound_mp3.cpp_MpegLoadMaybe_FUN_00534d40 (00534d40) at 00535452 [UNCONDITIONAL_CALL]
// Globals:
//   undefined4 DAT_0067d860
//   undefined4 DAT_0067d8e8

#include "nocturne.h"

/* Signature: undefined1 sound_mp3.cpp_FUN_0052fee0(undefined4 param_1, undefined4 param_2,
   undefined4 param_3, undefined4 param_4) */

void sound_mp3_cpp_FUN_0052fee0(void)

{
  ...
  local_58 = *(int *)(in_stack_00000010 + 8);
  if (0 < iVar6) {
    local_54 = 0;
    do {
      local_40 = 0;
      do {
        local_1c = 0;
        if (0 < iVar1) {
          local_34 = (undefined4 *)(local_54 + local_40 + in_stack_0000000c);
          local_24 = (undefined4 *)(in_stack_0000000c + local_40 + local_54);
          local_2c = (uint *)(local_40 + local_54 + in_stack_00000004);
          local_30 = (uint *)(local_54 + local_40 + in_stack_00000004);
          local_18 = (float *)(local_54 + local_40 + in_stack_0000000c);
          local_28 = (int *)(local_54 + in_stack_00000008);
          local_20 = (int *)(local_54 + in_stack_00000008);
          do {
            if (*local_28 == 0) {
              *local_34 = 0;
            }
              ...
              for (bVar2 = 0;
                  (uint)(1 << (bVar2 & 0x1f)) <
                  *(uint *)(*(int *)(in_stack_00000008 + local_1c * 0x80 + local_54) * 0x10 +
                           local_58); bVar2 = bVar2 + 1) {
              }
              ...
              *local_18 = *local_18 +
                          (float)*(double *)
                                  (&DAT_0067d8e8 + *(int *)(*local_20 * 0x10 + local_58 + 0xc) * 8);
              *local_18 = *local_18 *
                          (float)*(double *)
                                  (&DAT_0067d860 + *(int *)(*local_20 * 0x10 + local_58 + 0xc) * 8);
            }
  ...
  if (iVar6 < 0x20) {
    ...
    do {
      ...
      do {
        iVar5 = 0;
        if (0 < iVar1) {
          puVar3 = (undefined4 *)(iVar6 + iVar4 + in_stack_0000000c);
          do {
            iVar5 = iVar5 + 1;
            *puVar3 = 0;
            puVar3 = puVar3 + 0x60;
...
// Assembly code:
// 0052fee0: PUSH EBX
//   Label: sound_mp3.cpp_FUN_0052fee0
// 0052fee1: PUSH ESI
// 0052fee2: PUSH EDI
// 0052fee3: PUSH EBP
