...
section .text
    ...
    CALL sound_mp3.cpp_CMP3Decoder_decodeScalefacCompress_FUN_005310f0 ; 005314ce
        ;   XREF to: 005310f0 (UNCONDITIONAL_CALL)  ; void sound_mp3.cpp_CMP3Decoder_decodeScalefacCompress_FUN_005310f0(CMP3Decoder * this_ptr, int * scalefactor_dest, SMpegLayer3SideInfo * side_info, int channel, ...)
