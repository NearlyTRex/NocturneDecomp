...
// Cross-references:
//   sound_mp3.cpp_CMP3Decoder_decodeFrame_FUN_00534d40 (00534d40) at 005358d9 [UNCONDITIONAL_CALL]
// Globals:
...

{
  ...
  do {
    iVar6 = iVar9 + 2;
    *(undefined2 *)((int)&uStack_57a + iVar9 + 2) = 7;
    iVar9 = iVar6;
  } while (iVar6 != 0x480);
      ...
      if (0 < iVar11) {
        ...
        do {
          ...
          *(float *)((int)afStack_e78 + iVar9) = fVar2;
          uVar4 = *(undefined2 *)((int)&uStack_57a + iVar8 + 2);
          *(float *)((int)afStack_1778 + iVar9) = afStack_1778[iVar6];
          local_84 = local_84 + 2;
          *(undefined2 *)((int)&uStack_57a + iVar5 + 2) = uVar4;
          iVar9 = iVar9 + 4;
        } while (0 < iVar11);
      }
    }
        ...
        do {
          ...
          if (0 < iVar6) {
            ...
            do {
              ...
              iVar6 = iVar6 + -1;
              uVar4 = *(undefined2 *)((int)&uStack_57a + iVar9 * 2 + 2);
              *(float *)((int)local_2078 + iVar11) = local_2078[iVar9];
              *(float *)((int)afStack_e78 + iVar11) = fVar2;
              *(undefined2 *)((int)&uStack_57a + iVar8 + 2) = uVar4;
...
// 005329fe: PUSH EAX
// 005329ff: CALL sound_mp3.cpp_calculateIntensityStereoRatio_FUN_00532540
...
// 00532cf3: PUSH EAX
// 00532cf4: CALL sound_mp3.cpp_calculateIntensityStereoRatio_FUN_00532540
//   XREF to: 00532540 (UNCONDITIONAL_CALL)
...
// 00532ed4: PUSH EAX
// 00532ed5: CALL sound_mp3.cpp_calculateIntensityStereoRatio_FUN_00532540
//   XREF to: 00532540 (UNCONDITIONAL_CALL)
...
// 0053320e: PUSH EAX
// 0053320f: CALL sound_mp3.cpp_calculateIntensityStereoRatio_FUN_00532540
//   XREF to: 00532540 (UNCONDITIONAL_CALL)
