...
;                               FUNCTION
; *****************************************************************************
; __cdecl void sound_mp3.cpp_applyPolyphaseWindow_FUN_00533690(float * input_samples, float * output_samples, int mpeg_block_type)
;
; Parameters:
...
section .text
    ...
    CMP dword ptr [0x0067e210],0x1      ; 0053369c | int g_Mp3SynthesisTablesInitialized
    JNZ 0x0053395f                      ; 005336a3 | LAB_0053395f
        ;   XREF to: 0053395f (CONDITIONAL_JUMP)
    XOR EDX,EDX                         ; 005336a9
    XOR ECX,ECX                         ; 005336ab
    FLD double ptr [0x0063b0a2]         ; 005336ad | double DOUBLE_0063b0a2
    FLD double ptr [0x0063b0c2]         ; 005336b3 | double DOUBLE_0063b0c2
    ...
    INC EDX                             ; 005336c8
    FSTP double ptr [ECX + 0x2f46680]   ; 005336c9 | double[4][36] g_Mp3WindowTables
    CMP EDX,0x24                        ; 005336cf
    JL 0x005336b9                       ; 005336d2 | LAB_005336b9
        ;   XREF to: 005336b9 (CONDITIONAL_JUMP)
    FSTP ST0                            ; 005336d4
    FSTP ST0                            ; 005336d6
    XOR EDX,EDX                         ; 005336d8
    XOR ECX,ECX                         ; 005336da
    FLD double ptr [0x0063b0a2]         ; 005336dc | double DOUBLE_0063b0a2
    FLD double ptr [0x0063b0c2]         ; 005336e2 | double DOUBLE_0063b0c2
    ...
    INC EDX                             ; 005336f7
    FSTP double ptr [ECX + 0x2f467a0]   ; 005336f8 | g_Mp3WindowTables[1][0]
    CMP EDX,0x12                        ; 005336fe
    JL 0x005336e8                       ; 00533701 | LAB_005336e8
    ...
    MOV dword ptr [EAX + 0x2f467a4],EBX ; 00533716 | DAT_02f4683c
    MOV dword ptr [EAX + 0x2f467a0],ECX ; 0053371c | DAT_02f46838
    CMP EAX,0xc0                        ; 00533722
    JNZ 0x00533711                      ; 00533727 | LAB_00533711
        ;   XREF to: 00533711 (CONDITIONAL_JUMP)
    MOV EDX,0x18                        ; 00533729
    MOV ECX,EAX                         ; 0053372e
    FLD double ptr [0x0063b0aa]         ; 00533730 | double DOUBLE_0063b0aa
    FLD double ptr [0x0063b0ca]         ; 00533736 | double DOUBLE_0063b0ca
    FLD double ptr [0x0063b0c2]         ; 0053373c | double DOUBLE_0063b0c2
    ...
    INC EDX                             ; 00533753
    FSTP double ptr [ECX + 0x2f467a0]   ; 00533754 | DAT_02f46840
    CMP EDX,0x1e                        ; 0053375a
    JL 0x00533742                       ; 0053375d | LAB_00533742
    ...
    MOV dword ptr [EAX + 0x2f467a0],ESI ; 0053376f | DAT_02f46898
    MOV dword ptr [EAX + 0x2f467a4],ESI ; 00533775 | DAT_02f4689c
    CMP EAX,0x120                       ; 0053377b
    JNZ 0x0053376a                      ; 00533780 | LAB_0053376a
        ;   XREF to: 0053376a (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 00533782
    ADD EAX,0x8                         ; 00533784
        ;   Label: LAB_00533784
    XOR EDX,EDX                         ; 00533787
    MOV dword ptr [EAX + 0x2f469e0],EDX ; 00533789 | g_Mp3WindowTables[3][0]
    MOV dword ptr [EAX + 0x2f469e4],EDX ; 0053378f | DAT_02f469ec
    CMP EAX,0x30                        ; 00533795
    JNZ 0x00533784                      ; 00533798 | LAB_00533784
        ;   XREF to: 00533784 (CONDITIONAL_JUMP)
    MOV EDX,0x6                         ; 0053379a
    MOV ECX,EAX                         ; 0053379f
    FLD double ptr [0x0063b0aa]         ; 005337a1 | double DOUBLE_0063b0aa
    FLD double ptr [0x0063b0d2]         ; 005337a7 | double DOUBLE_0063b0d2
    FLD double ptr [0x0063b0c2]         ; 005337ad | double DOUBLE_0063b0c2
    ...
    INC EDX                             ; 005337c4
    FSTP double ptr [ECX + 0x2f469e0]   ; 005337c5 | DAT_02f469f8
    CMP EDX,0xc                         ; 005337cb
    JL 0x005337b3                       ; 005337ce | LAB_005337b3
    ...
    MOV dword ptr [EAX + 0x2f469e4],ESI ; 005337e5 | DAT_02f46a4c
    MOV dword ptr [EAX + 0x2f469e0],EBX ; 005337eb | DAT_02f46a48
    CMP EAX,0x90                        ; 005337f1
    JNZ 0x005337e0                      ; 005337f6 | LAB_005337e0
        ;   XREF to: 005337e0 (CONDITIONAL_JUMP)
    MOV EDX,0x12                        ; 005337f8
    MOV ECX,EAX                         ; 005337fd
    FLD double ptr [0x0063b0a2]         ; 005337ff | double DOUBLE_0063b0a2
    FLD double ptr [0x0063b0c2]         ; 00533805 | double DOUBLE_0063b0c2
    ...
    INC EDX                             ; 0053381a
    FSTP double ptr [ECX + 0x2f469e0]   ; 0053381b | DAT_02f46a50
    CMP EDX,0x24                        ; 00533821
    JL 0x0053380b                       ; 00533824 | LAB_0053380b
        ;   XREF to: 0053380b (CONDITIONAL_JUMP)
    FSTP ST0                            ; 00533826
    FSTP ST0                            ; 00533828
    XOR EDX,EDX                         ; 0053382a
    XOR ECX,ECX                         ; 0053382c
    FLD double ptr [0x0063b0aa]         ; 0053382e | double DOUBLE_0063b0aa
    FLD double ptr [0x0063b0c2]         ; 00533834 | double DOUBLE_0063b0c2
    ...
    INC EDX                             ; 00533849
    FSTP double ptr [ECX + 0x2f468c0]   ; 0053384a | g_Mp3WindowTables[2][0]
    CMP EDX,0xc                         ; 00533850
    JL 0x0053383a                       ; 00533853 | LAB_0053383a
    ...
    MOV dword ptr [EAX + 0x2f468c0],EDI ; 00533863 | DAT_02f46928
    MOV dword ptr [EAX + 0x2f468c4],EDI ; 00533869 | DAT_02f4692c
    CMP EAX,0x120                       ; 0053386f
    JNZ 0x0053385e                      ; 00533874 | LAB_0053385e
    ...
    JLE 0x005338c4                      ; 00533895 | LAB_005338c4
        ;   XREF to: 005338c4 (CONDITIONAL_JUMP)
    FLD double ptr [0x0063b0b2]         ; 00533897 | double DOUBLE_0063b0b2
    ...
    FSTP double ptr [EBX + 0x2f46b00]   ; 005338b8 | double[12][6] g_Mp3DctMatrix
    CMP ECX,EDX                         ; 005338be
    JL 0x005338a0                       ; 005338c0 | LAB_005338a0
    ...
    JNZ 0x00533886                      ; 005338d3 | LAB_00533886
    ...
    FLD double ptr [0x0063b0ba]         ; 00533904 | double DOUBLE_0063b0ba
    ...
    FSTP double ptr [EBX + 0x2f46d40]   ; 0053392a | double[36][18] g_Mp3PolyCoefficients
    CMP EBX,EDI                         ; 00533930
    JNZ 0x0053390a                      ; 00533932 | LAB_0053390a
    ...
    JL 0x005338ea                       ; 00533955 | LAB_005338ea
        ;   XREF to: 005338ea (CONDITIONAL_JUMP)
    XOR EDX,EDX                         ; 00533957
    MOV dword ptr [0x0067e210],EDX      ; 00533959 | int g_Mp3SynthesisTablesInitialized
    CMP dword ptr [EBP + 0x1c],0x2      ; 0053395f
        ;   Label: LAB_0053395f
    JZ 0x00533a40                       ; 00533963 | LAB_00533a40
    ...
    FABS                                ; 0053397c
    FCOMP double ptr [0x0063b0da]       ; 0053397e | double DOUBLE_0063b0da
    FNSTSW AX                           ; 00533984
    SAHF                                ; 00533986
    JBE 0x00533996                      ; 00533987 | LAB_00533996
    ...
    MOV EDX,0x2f46d48                   ; 005339d1 | double[36][18] g_Mp3PolyCoefficients
    ...
    JL 0x00533a25                       ; 005339fb | LAB_00533a25
    ...
    JGE 0x00533a09                      ; 00533a1b | LAB_00533a09
    ...
    JL 0x005339ba                       ; 00533a37 | LAB_005339ba
    ...
    CALL crt_memory.c_memset_FUN_005fde40 ; 00533a4e | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
    ...
    FLD float ptr [EBX + 0xc]           ; 00533a5c
        ;   Label: LAB_00533a5c
    FMUL double ptr [EAX + 0x2f46b10]   ; 00533a5f | DAT_02f46b10
    FLD float ptr [EBX]                 ; 00533a65
    FMUL double ptr [EAX + 0x2f46b08]   ; 00533a67 | double[12][6] g_Mp3DctMatrix
    FADDP                               ; 00533a6d
    FLD float ptr [EBX + 0x18]          ; 00533a6f
    FMUL double ptr [EAX + 0x2f46b18]   ; 00533a72 | DAT_02f46b18
    FADDP                               ; 00533a78
    FLD float ptr [EBX + 0x24]          ; 00533a7a
    FMUL double ptr [EAX + 0x2f46b20]   ; 00533a7d | DAT_02f46b20
    FADDP                               ; 00533a83
    FLD float ptr [EBX + 0x30]          ; 00533a85
    FMUL double ptr [EAX + 0x2f46b28]   ; 00533a88 | DAT_02f46b28
    FADDP                               ; 00533a8e
    FLD float ptr [EBX + 0x3c]          ; 00533a90
    FMUL double ptr [EAX + 0x2f46b30]   ; 00533a93 | DAT_02f46b30
    FADDP                               ; 00533a99
    ...
    JNZ 0x00533a5c                      ; 00533ab9 | LAB_00533a5c
    ...
    FLD float ptr [EBX + 0x10]          ; 00533ac5
        ;   Label: LAB_00533ac5
    FMUL double ptr [EAX + 0x2f46b10]   ; 00533ac8 | DAT_02f46b10
    FLD float ptr [EBX + 0x4]           ; 00533ace
    FMUL double ptr [EAX + 0x2f46b08]   ; 00533ad1 | double[12][6] g_Mp3DctMatrix
    FADDP                               ; 00533ad7
    FLD float ptr [EBX + 0x1c]          ; 00533ad9
    FMUL double ptr [EAX + 0x2f46b18]   ; 00533adc | DAT_02f46b18
    FADDP                               ; 00533ae2
    FLD float ptr [EBX + 0x28]          ; 00533ae4
    FMUL double ptr [EAX + 0x2f46b20]   ; 00533ae7 | DAT_02f46b20
    FADDP                               ; 00533aed
    FLD float ptr [EBX + 0x34]          ; 00533aef
    FMUL double ptr [EAX + 0x2f46b28]   ; 00533af2 | DAT_02f46b28
    FADDP                               ; 00533af8
    FLD float ptr [EBX + 0x40]          ; 00533afa
    FMUL double ptr [EAX + 0x2f46b30]   ; 00533afd | DAT_02f46b30
    FADDP                               ; 00533b03
    ...
    JNZ 0x00533ac5                      ; 00533b23 | LAB_00533ac5
    ...
    FLD float ptr [EBX + 0x14]          ; 00533b2f
        ;   Label: LAB_00533b2f
    FMUL double ptr [EAX + 0x2f46b10]   ; 00533b32 | DAT_02f46b10
    FLD float ptr [EBX + 0x8]           ; 00533b38
    FMUL double ptr [EAX + 0x2f46b08]   ; 00533b3b | double[12][6] g_Mp3DctMatrix
    FADDP                               ; 00533b41
    FLD float ptr [EBX + 0x20]          ; 00533b43
    FMUL double ptr [EAX + 0x2f46b18]   ; 00533b46 | DAT_02f46b18
    FADDP                               ; 00533b4c
    FLD float ptr [EBX + 0x2c]          ; 00533b4e
    FMUL double ptr [EAX + 0x2f46b20]   ; 00533b51 | DAT_02f46b20
    FADDP                               ; 00533b57
    FLD float ptr [EBX + 0x38]          ; 00533b59
    FMUL double ptr [EAX + 0x2f46b28]   ; 00533b5c | DAT_02f46b28
    FADDP                               ; 00533b62
    FLD float ptr [EBX + 0x44]          ; 00533b64
    FMUL double ptr [EAX + 0x2f46b30]   ; 00533b67 | DAT_02f46b30
    FADDP                               ; 00533b6d
    ...
    JNZ 0x00533b2f                      ; 00533b8d | LAB_00533b2f
