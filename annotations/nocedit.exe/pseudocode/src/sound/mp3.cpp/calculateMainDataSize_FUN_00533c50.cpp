...
// Cross-references:
//   sound_mp3.cpp_CMP3Decoder_decodeFrame_FUN_00534d40 (00534d40) at 00535627 [UNCONDITIONAL_CALL]
// Globals:
...

{
  ...
  dVar2 = crt_math_c_round_FUN_005fe6b0
                    ((double)CONCAT44((frame_info.header)->mpeg_version * 0x20,frame_info.header));
