// Name: sound_mp3.cpp_FUN_00532540
// Address: 00532540
// Address Range: [[00532540, 005325d2]]
// Convention: unknown
// Signature: undefined sound_mp3.cpp_FUN_00532540()
// Cross-references:
//   sound_mp3.cpp_StereoProcessingFile_FUN_005325e0 (005325e0) at 0053320f [UNCONDITIONAL_CALL]
// Function calls:
//   crt_math.c_pow_FUN_005ffd76

#include "nocturne.h"

/* Signature: undefined1 sound_mp3.cpp_FUN_00532540(undefined4 param_1, undefined8 param_2,
   undefined4 param_3, undefined4 param_4) */

void sound_mp3_cpp_FUN_00532540(void)

{
  ...
  pfVar1 = (float *)(in_stack_00000010 * 4 + in_stack_00000014);
  if (in_stack_00000004 == 0) {
    ...
    *pfVar1 = 1.0;
    ...
    if (in_stack_00000004 % 2 != 1) {
      fVar2 = crt_math_c_pow_FUN_005ffd76
                        ((float10)in_stack_00000008,(float10)(in_stack_00000004 / 2));
      *pfVar1 = 1.0;
      pfVar1[0x240] = (float)fVar2;
      return;
    }
    fVar2 = crt_math_c_pow_FUN_005ffd76
                      ((float10)in_stack_00000008,(float10)((in_stack_00000004 + 1) / 2));
    pfVar1[0x240] = 1.0;
    *pfVar1 = (float)fVar2;
  }
  return;
...
// Assembly code:
// 00532540: PUSH EBX
//   Label: sound_mp3.cpp_FUN_00532540
// 00532541: PUSH ESI
