// Name: sound_mp3.cpp_FUN_00530d20
// Address: 00530d20
// Address Range: [[00530d20, 005310ea]]
// Convention: unknown
// Signature: undefined sound_mp3.cpp_FUN_00530d20()
// Cross-references:
//   sound_mp3.cpp_MpegLoadMaybe_FUN_00534d40 (00534d40) at 00535823 [UNCONDITIONAL_CALL]
// Globals:
//   undefined4 DAT_0067e628
//   undefined4 DAT_0067e62c
//   undefined4 DAT_0067e630
//   undefined4 DAT_0067e63c
//   undefined4 DAT_0067e640
//   undefined4 DAT_0067e644
//   undefined4 DAT_0067e648
//   undefined4 DAT_0067e688
// Function calls:
//   sound_mp3.cpp_MemoryCheckOverflow_FUN_0052f170

#include "nocturne.h"

/* Signature: undefined1 sound_mp3.cpp_FUN_00530d20(undefined4 param_1, undefined4 param_2,
   undefined4 param_3, undefined4 param_4, undefined4 param_5) */

void sound_mp3_cpp_FUN_00530d20(void)

{
  ...
  iVar3 = in_stack_0000000c + in_stack_00000014 * 0xa0 + 0x18 + in_stack_00000010 * 0x48;
  if ((*(int *)(iVar3 + 0x10) != 0) && (*(int *)(iVar3 + 0x14) == 2)) {
    puVar7 = (undefined4 *)(in_stack_00000008 + in_stack_00000014 * 0xf8);
    if (*(int *)(iVar3 + 0x18) == 0) {
      local_48 = 0;
      local_34 = 0;
      do {
        iVar3 = *(int *)(&DAT_0067e63c + local_34);
        local_18 = local_48;
        local_20 = iVar3 * 4;
        if (iVar3 < *(int *)(&DAT_0067e640 + local_34)) {
          do {
            puVar6 = (undefined4 *)(local_20 + (int)puVar7);
            do {
              puVar4 = puVar6 + 0xd;
              uVar1 = sound_mp3_cpp_MemoryCheckOverflow_FUN_0052f170();
              puVar6[0x17] = uVar1;
              puVar6 = puVar4;
            } while (puVar4 != puVar7 + iVar3 + 0x27);
            local_20 = local_20 + 4;
            local_18 = local_18 + 1;
          } while (local_18 < (int)puVar7[0x19f990]);
        }
        local_48 = local_48 + 0x40;
        local_34 = local_34 + 4;
      } while (local_48 != 0x80);
      in_stack_00000008 = in_stack_00000008 + in_stack_00000014 * 0xf8;
      iVar3 = in_stack_00000008 + 0x30;
      do {
        iVar2 = iVar3 + 0x34;
        *(undefined4 *)(iVar3 + 0x5c) = 0;
        iVar3 = iVar2;
      } while (iVar2 != in_stack_00000008 + 0xcc);
      return;
    }
    puVar6 = puVar7;
    do {
    ...
    iVar3 = in_stack_0000000c + in_stack_00000018 * 0xf8;
    local_38 = 3;
    do {
      iVar2 = iVar3 + local_3c * 4;
      do {
        iVar5 = iVar2 + 0x34;
        uVar1 = sound_mp3_cpp_MemoryCheckOverflow_FUN_0052f170();
        *(undefined4 *)(iVar2 + 0x5c) = uVar1;
        iVar2 = iVar5;
      } while (iVar5 != local_60 + local_54);
      local_38 = local_38 + 1;
    } while (local_38 < 6);
    local_3c = 6;
    do {
      iVar2 = local_40 * 4 + iVar3;
      do {
        iVar5 = iVar2 + 0x34;
        uVar1 = sound_mp3_cpp_MemoryCheckOverflow_FUN_0052f170();
        *(undefined4 *)(iVar2 + 0x5c) = uVar1;
        iVar2 = iVar5;
      } while (iVar5 != in_stack_0000000c + in_stack_00000018 * 0xf8 + local_4c);
      local_3c = local_3c + 1;
    } while (local_3c < 0xc);
    in_stack_0000000c = in_stack_0000000c + in_stack_00000018 * 0xf8;
    iVar3 = in_stack_0000000c + 0x30;
    do {
      iVar2 = iVar3 + 0x34;
      *(undefined4 *)(iVar3 + 0x5c) = 0;
      iVar3 = iVar2;
    } while (iVar2 != in_stack_0000000c + 0xcc);
    return;
  }
  local_38 = 0;
  local_50 = in_stack_00000014 * 0xa0 + in_stack_0000000c;
  local_44 = 0;
  do {
    if ((*(int *)(local_50 + 8) == 0) || (in_stack_00000010 == 0)) {
      iVar3 = *(int *)(&DAT_0067e628 + local_38);
      puVar7 = (undefined4 *)(iVar3 * 4 + in_stack_00000008 + in_stack_00000014 * 0xf8);
      if (iVar3 < *(int *)(&DAT_0067e62c + local_38)) {
        do {
          uVar1 = sound_mp3_cpp_MemoryCheckOverflow_FUN_0052f170();
          *puVar7 = uVar1;
          iVar3 = iVar3 + 1;
          puVar7 = puVar7 + 1;
        } while (iVar3 < *(int *)(&DAT_0067e62c + local_2c));
      }
    }
    local_38 = local_38 + 4;
    local_44 = local_44 + 1;
  ...
  *(undefined4 *)(in_stack_00000014 * 0xf8 + in_stack_00000008 + 0x58) = 0;
  return;
}
...
// Assembly code:
// 00530d20: PUSH EBX
//   Label: sound_mp3.cpp_FUN_00530d20
// 00530d21: PUSH ESI
// 00530d22: PUSH EDI
// 00530d23: PUSH EBP
...
// 00530dfa: PUSH ECX
// 00530dfb: PUSH EDI
// 00530dfc: CALL sound_mp3.cpp_MemoryCheckOverflow_FUN_0052f170
...
// 00530e95: CALL sound_mp3.cpp_MemoryCheckOverflow_FUN_0052f170
//   XREF to: 0052f170 (UNCONDITIONAL_CALL)
...
// 00530ef8: CALL sound_mp3.cpp_MemoryCheckOverflow_FUN_0052f170
//   XREF to: 0052f170 (UNCONDITIONAL_CALL)
...
// 00530f75: CALL sound_mp3.cpp_MemoryCheckOverflow_FUN_0052f170
//   XREF to: 0052f170 (UNCONDITIONAL_CALL)
...
// 0053104a: CALL sound_mp3.cpp_MemoryCheckOverflow_FUN_0052f170
//   XREF to: 0052f170 (UNCONDITIONAL_CALL)
