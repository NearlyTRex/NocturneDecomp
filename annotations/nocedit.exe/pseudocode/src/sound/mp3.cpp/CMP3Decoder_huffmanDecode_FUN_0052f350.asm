...
section .text
    ...
    JZ 0x0052f429                       ; 0052f413 | LAB_0052f429
        ;   XREF to: 0052f429 (CONDITIONAL_JUMP)
    PUSH EBP                            ; 0052f415
    CALL sound_mp3.cpp_CMP3Decoder_readBit_FUN_0052f250 ; 0052f416 | void sound_mp3.cpp_CMP3Decoder_readBit_FUN_0052f250(CMP3Decoder * this_ptr)
        ;   XREF to: 0052f250 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052f41b
    CMP EAX,0x1                         ; 0052f41e
    JNZ 0x0052f429                      ; 0052f421 | LAB_0052f429
        ;   XREF to: 0052f429 (CONDITIONAL_JUMP)
    ...
    JZ 0x0052f446                       ; 0052f430 | LAB_0052f446
        ;   XREF to: 0052f446 (CONDITIONAL_JUMP)
    PUSH EBP                            ; 0052f432
    CALL sound_mp3.cpp_CMP3Decoder_readBit_FUN_0052f250 ; 0052f433 | void sound_mp3.cpp_CMP3Decoder_readBit_FUN_0052f250(CMP3Decoder * this_ptr)
        ;   XREF to: 0052f250 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052f438
    CMP EAX,0x1                         ; 0052f43b
    JNZ 0x0052f446                      ; 0052f43e | LAB_0052f446
        ;   XREF to: 0052f446 (CONDITIONAL_JUMP)
    ...
    JZ 0x0052f463                       ; 0052f44d | LAB_0052f463
        ;   XREF to: 0052f463 (CONDITIONAL_JUMP)
    PUSH EBP                            ; 0052f44f
    CALL sound_mp3.cpp_CMP3Decoder_readBit_FUN_0052f250 ; 0052f450 | void sound_mp3.cpp_CMP3Decoder_readBit_FUN_0052f250(CMP3Decoder * this_ptr)
        ;   XREF to: 0052f250 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052f455
    CMP EAX,0x1                         ; 0052f458
    JNZ 0x0052f463                      ; 0052f45b | LAB_0052f463
        ;   XREF to: 0052f463 (CONDITIONAL_JUMP)
    ...
    JZ 0x0052f480                       ; 0052f46a | LAB_0052f480
        ;   XREF to: 0052f480 (CONDITIONAL_JUMP)
    PUSH EBP                            ; 0052f46c
    CALL sound_mp3.cpp_CMP3Decoder_readBit_FUN_0052f250 ; 0052f46d | void sound_mp3.cpp_CMP3Decoder_readBit_FUN_0052f250(CMP3Decoder * this_ptr)
        ;   XREF to: 0052f250 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052f472
    CMP EAX,0x1                         ; 0052f475
    JNZ 0x0052f480                      ; 0052f478 | LAB_0052f480
        ;   XREF to: 0052f480 (CONDITIONAL_JUMP)
    ...
    PUSH EBP                            ; 0052f4ae
        ;   Label: LAB_0052f4ae
    CALL sound_mp3.cpp_CMP3Decoder_readBit_FUN_0052f250 ; 0052f4af | void sound_mp3.cpp_CMP3Decoder_readBit_FUN_0052f250(CMP3Decoder * this_ptr)
        ;   XREF to: 0052f250 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052f4b4
    TEST EAX,EAX                        ; 0052f4b7
    JZ 0x0052f51a                       ; 0052f4b9 | LAB_0052f51a
    ...
    JGE 0x0052f4bb                      ; 0052f4cb | LAB_0052f4bb
        ;   XREF to: 0052f4bb (CONDITIONAL_JUMP)
    SHR EDI,0x1                         ; 0052f4cd
        ;   Label: LAB_0052f4cd
    TEST EDI,EDI                        ; 0052f4cf
    JNZ 0x0052f387                      ; 0052f4d1 | LAB_0052f387
        ;   XREF to: 0052f387 (CONDITIONAL_JUMP)
    CMP EBX,dword ptr [0x02f68aac]      ; 0052f4d7 | g_HuffmanTables[0].table_size
    JC 0x0052f387                       ; 0052f4dd | LAB_0052f387
        ;   XREF to: 0052f387 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP],0x0             ; 0052f4e3
    JZ 0x0052f3b9                       ; 0052f4e7 | LAB_0052f3b9
        ;   XREF to: 0052f3b9 (CONDITIONAL_JUMP)
    PUSH 0x2f68188                      ; 0052f4ed | char[256] g_CurrentMp3Filename
    MOV ECX,0x63adf1                    ; 0052f4f2 | = "..\\sound\\mp3.cpp" | s_sound_mp3_cpp_0063adf1 = ..\sound\mp3.cpp
    MOV EBX,0x321                       ; 0052f4f7
    PUSH 0x63ae02                       ; 0052f4fc | = "Illegal Huffman code in data.  File: %s" | s_Illegal_Huffman_code_in__0063ae02 = Illegal Huffman code in data.  File: %s
    MOV dword ptr [0x02f0ca48],ECX      ; 0052f501 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 0052f507 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0052f50d | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0052f512
    JMP 0x0052f3b9                      ; 0052f515 | LAB_0052f3b9
    ...
    JGE 0x0052f51a                      ; 0052f52a | LAB_0052f51a
        ;   XREF to: 0052f51a (CONDITIONAL_JUMP)
    JMP 0x0052f4cd                      ; 0052f52c | LAB_0052f4cd
        ;   XREF to: 0052f4cd (UNCONDITIONAL_JUMP)
    CMP BL,DH                           ; 0052f52e
        ;   Label: LAB_0052f52e
    JZ 0x0052f3d0                       ; 0052f530 | LAB_0052f3d0
        ;   XREF to: 0052f3d0 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [ESI + 0xc]       ; 0052f536
        ;   Label: LAB_0052f536
    TEST EDI,EDI                        ; 0052f539
    JZ 0x0052f559                       ; 0052f53b | LAB_0052f559
    ...
    JNZ 0x0052f559                      ; 0052f547 | LAB_0052f559
        ;   XREF to: 0052f559 (CONDITIONAL_JUMP)
    PUSH EDI                            ; 0052f549
    PUSH EBP                            ; 0052f54a
    CALL sound_mp3.cpp_CMP3Decoder_readBits_FUN_0052f170 ; 0052f54b | uint sound_mp3.cpp_CMP3Decoder_readBits_FUN_0052f170(CMP3Decoder * this_ptr, uint num_bits)
    ...
    JZ 0x0052f576                       ; 0052f560 | LAB_0052f576
        ;   XREF to: 0052f576 (CONDITIONAL_JUMP)
    PUSH EBP                            ; 0052f562
    CALL sound_mp3.cpp_CMP3Decoder_readBit_FUN_0052f250 ; 0052f563 | void sound_mp3.cpp_CMP3Decoder_readBit_FUN_0052f250(CMP3Decoder * this_ptr)
        ;   XREF to: 0052f250 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052f568
    CMP EAX,0x1                         ; 0052f56b
    JNZ 0x0052f576                      ; 0052f56e | LAB_0052f576
        ;   XREF to: 0052f576 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x20]      ; 0052f570
    NEG dword ptr [EAX]                 ; 0052f574
    CMP dword ptr [ESI + 0xc],0x0       ; 0052f576
        ;   Label: LAB_0052f576
    JZ 0x0052f463                       ; 0052f57a | LAB_0052f463
        ;   XREF to: 0052f463 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESI + 0x8]       ; 0052f580
    MOV EBX,dword ptr [ESP + 0x24]      ; 0052f583
    DEC EAX                             ; 0052f587
    CMP EAX,dword ptr [EBX]             ; 0052f588
    JNZ 0x0052f463                      ; 0052f58a | LAB_0052f463
        ;   XREF to: 0052f463 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESI + 0xc]       ; 0052f590
    PUSH EAX                            ; 0052f593
    PUSH EBP                            ; 0052f594
    CALL sound_mp3.cpp_CMP3Decoder_readBits_FUN_0052f170 ; 0052f595 | uint sound_mp3.cpp_CMP3Decoder_readBits_FUN_0052f170(CMP3Decoder * this_ptr, uint num_bits)
        ;   XREF to: 0052f170 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [EBX]             ; 0052f59a
    ADD EDX,EAX                         ; 0052f59c
    ADD ESP,0x8                         ; 0052f59e
    MOV dword ptr [EBX],EDX             ; 0052f5a1
    JMP 0x0052f463                      ; 0052f5a3 | LAB_0052f463
