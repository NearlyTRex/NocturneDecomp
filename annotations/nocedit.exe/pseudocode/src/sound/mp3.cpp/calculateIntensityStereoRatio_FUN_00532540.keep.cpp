...
// Convention: __cdecl
// Signature: void __cdecl sound_mp3_cpp_calculateIntensityStereoRatio_FUN_00532540(int intensity_position,double ratio,int sample_index,float *ratio_buffer)
  ...
  if (intensity_position == 0) {
    ...
    *pfVar1 = 1.0;
    ...
    if (intensity_position % 2 != 1) {
      iVar3 = intensity_position / 2;
      fVar1 = pow((float10)ratio,(float10)iVar3);
      *pfVar1 = 1.0;
      pfVar1[0x240] = (float)fVar1;
      return;
    }
    iVar3 = (intensity_position + 1) / 2;
    fVar2 = pow((float10)ratio,(float10)iVar3);
    pfVar1[0x240] = 1.0;
    *pfVar1 = (float)fVar2;
  }
  return;
