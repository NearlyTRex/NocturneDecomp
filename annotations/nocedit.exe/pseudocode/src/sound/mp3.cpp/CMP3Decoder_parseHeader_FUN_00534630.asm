...
;                               FUNCTION
; *****************************************************************************
; __cdecl int sound_mp3.cpp_CMP3Decoder_parseHeader_FUN_00534630(CMP3Decoder * this_ptr, FILE * file_handle, int file_size)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 0053463b
    CALL sound_mp3.cpp_CMP3Decoder_free_FUN_005349e0 ; 0053463c | void sound_mp3.cpp_CMP3Decoder_free_FUN_005349e0(CMP3Decoder * this_ptr)
    ...
    JNZ 0x0053477e                      ; 00534671 | LAB_0053477e
        ;   XREF to: 0053477e (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [EDI + 0x4]       ; 00534677
        ;   Label: LAB_00534677
    TEST ECX,ECX                        ; 0053467a
    JZ 0x00534698                       ; 0053467c | LAB_00534698
        ;   XREF to: 00534698 (CONDITIONAL_JUMP)
    PUSH 0x210                          ; 0053467e
    PUSH 0x63acf2                       ; 00534683 | = "..\\sound\\mp3.cpp" | s_sound_mp3_cpp_0063acf2 = ..\sound\mp3.cpp
    PUSH ECX                            ; 00534688
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 00534689 | void shape_memdbg.cpp_debugFree_FUN_0050f460(void * ptr, char * filename, int line_number)
    ...
    CALL crt_stdio.c_ftell_FUN_00601560 ; 0053469b | long crt_stdio.c_ftell_FUN_00601560(FILE * file_handle)
    ...
    PUSH 0x63ad03                       ; 005346af | = "..\\sound\\mp3.cpp" | s_sound_mp3_cpp_0063ad03 = ..\sound\mp3.cpp
    MOV dword ptr [EBX + 0x24],EAX      ; 005346b4
    MOV EAX,dword ptr [ESP + 0x64]      ; 005346b7
    PUSH EAX                            ; 005346bb
    MOV dword ptr [EBX + 0x8],EAX       ; 005346bc
    CALL shape_memdbg.cpp_debugMalloc_FUN_0050f250 ; 005346bf | void * shape_memdbg.cpp_debugMalloc_FUN_0050f250(int size, char * filename, int line_number)
        ;   XREF to: 0050f250 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005346c4
    MOV dword ptr [EBX + 0x4],EAX       ; 005346c7
    TEST EAX,EAX                        ; 005346ca
    JNZ 0x005346f5                      ; 005346cc | LAB_005346f5
        ;   XREF to: 005346f5 (CONDITIONAL_JUMP)
    PUSH 0x2f68188                      ; 005346ce | char[256] g_CurrentMp3Filename
    MOV EAX,0x63ad14                    ; 005346d3 | = "..\\sound\\mp3.cpp" | s_sound_mp3_cpp_0063ad14 = ..\sound\mp3.cpp
    MOV EDX,0x200                       ; 005346d8
    PUSH 0x63ad25                       ; 005346dd | = "Out of memory.  File: %s" | s_Out_of_memory_File_s_0063ad25 = Out of memory.  File: %s
    MOV [0x02f0ca48],EAX                ; 005346e2 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 005346e7 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005346ed | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    PUSH ESI                            ; 005346fd
    CALL crt_stdio.c_fseek_FUN_005ffacc ; 005346fe | int crt_stdio.c_fseek_FUN_005ffacc(FILE * file, long offset, int whence)
    ...
    JNZ 0x0053479c                      ; 0053474f | LAB_0053479c
        ;   XREF to: 0053479c (CONDITIONAL_JUMP)
    PUSH EBX                            ; 00534751
        ;   Label: LAB_00534751
    PUSH ESI                            ; 00534752
    CALL sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40 ; 00534753 | uint sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40(CFileBitStream * bitstream, int num_bits)
    ...
    JZ 0x005347af                       ; 00534763 | LAB_005347af
        ;   XREF to: 005347af (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESI + 0x1c]      ; 00534765
    TEST EAX,EAX                        ; 00534768
    JNZ 0x005347af                      ; 0053476a | LAB_005347af
        ;   XREF to: 005347af (CONDITIONAL_JUMP)
    PUSH 0x8                            ; 0053476c
    PUSH ESI                            ; 0053476e
    SHL EBX,0x8                         ; 0053476f
    CALL sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40 ; 00534772 | uint sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40(CFileBitStream * bitstream, int num_bits)
        ;   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00534777
    OR EBX,EAX                          ; 0053477a
    JMP 0x0053475d                      ; 0053477c | LAB_0053475d
        ;   XREF to: 0053475d (UNCONDITIONAL_JUMP)
    PUSH 0x20b                          ; 0053477e
        ;   Label: LAB_0053477e
    PUSH 0x63ace1                       ; 00534783 | = "..\\sound\\mp3.cpp" | s_sound_mp3_cpp_0063ace1 = ..\sound\mp3.cpp
    PUSH EAX                            ; 00534788
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 00534789 | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
        ;   XREF to: 0050f9b0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0053478e
    MOV dword ptr [ESI],0x0             ; 00534791
    JMP 0x00534677                      ; 00534797 | LAB_00534677
    ...
    PUSH ECX                            ; 005347a3
    PUSH EAX                            ; 005347a4
    CALL sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40 ; 005347a5 | uint sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40(CFileBitStream * bitstream, int num_bits)
        ;   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005347aa
    JMP 0x00534751                      ; 005347ad | LAB_00534751
    ...
    PUSH EAX                            ; 005347c6
    CALL sound_mp3.cpp_CFileBitStream_readFrameHeader_FUN_0052f5b0 ; 005347c7 | void sound_mp3.cpp_CFileBitStream_readFrameHeader_FUN_0052f5b0(CFileBitStream * this_ptr, SMpegFrameHeader * header_out)
    ...
    JNZ 0x005349b4                      ; 005347f1 | LAB_005349b4
    ...
    MOV EDX,dword ptr [ECX + EAX*0x4 + 0x67e258] ; 00534838 | int[2][3][15] g_MpegBitrateTable
    ...
    FLD double ptr [EAX + ECX*0x8 + 0x67e218] ; 00534857 | double[2][4] g_MpegSampleRateTable
    CALL crt_math.c_round_FUN_005fe6b0  ; 0053485e | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x64]        ; 00534863
    CMP EBP,0x1                         ; 00534867
    JNZ 0x005349aa                      ; 0053486a | LAB_005349aa
        ;   XREF to: 005349aa (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x64],0x30     ; 00534870
    JNZ 0x00534966                      ; 00534875 | LAB_00534966
        ;   XREF to: 00534966 (CONDITIONAL_JUMP)
    CMP EDX,0x38                        ; 0053487b
    JL 0x00534966                       ; 0053487e | LAB_00534966
        ;   XREF to: 00534966 (CONDITIONAL_JUMP)
    ...
    JZ 0x005348b7                       ; 0053488d | LAB_005348b7
        ;   XREF to: 005348b7 (CONDITIONAL_JUMP)
    PUSH 0x2f68188                      ; 0053488f | char[256] g_CurrentMp3Filename
    MOV ESI,0x63ac5a                    ; 00534894 | = "..\\sound\\mp3.cpp" | s_sound_mp3_cpp_0063ac5a = ..\sound\mp3.cpp
    MOV EBP,0x1a2                       ; 00534899
    PUSH 0x63ac6b                       ; 0053489e | = "MPEG Layer 2 - pick_table - can't loa..." | s_MPEG_Layer_2_pick_table__0063ac6b = MPEG Layer 2 - pick_table - can't load tables!  File: %s
    MOV dword ptr [0x02f0ca48],ESI      ; 005348a3 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBP      ; 005348a9 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005348af | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ...
    JNZ 0x005349d6                      ; 005348c4 | LAB_005349d6
    ...
    JL 0x005348dd                       ; 005348d2 | LAB_005348dd
        ;   XREF to: 005348dd (CONDITIONAL_JUMP)
    CMP EBP,0x3                         ; 005348d4
    JLE 0x005349c0                      ; 005348d7 | LAB_005349c0
        ;   XREF to: 005349c0 (CONDITIONAL_JUMP)
    PUSH 0x2f68188                      ; 005348dd | char[256] g_CurrentMp3Filename
        ;   Label: LAB_005348dd
    PUSH ESI                            ; 005348e2
    PUSH EBP                            ; 005348e3
    MOV EDX,0x63aca4                    ; 005348e4 | = "..\\sound\\mp3.cpp" | s_sound_mp3_cpp_0063aca4 = ..\sound\mp3.cpp
    MOV ECX,0x1b2                       ; 005348e9
    PUSH 0x63acb5                       ; 005348ee | = "js_bound bad layer/modext (%d/%d)  Fi..." | s_js_bound_bad_layer_modex_0063acb5 = js_bound bad layer/modext (%d/%d)  File: %s
    MOV dword ptr [0x02f0ca48],EDX      ; 005348f3 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 005348f9 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005348ff | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ...
    MOV EAX,dword ptr [EAX + 0x67d820]  ; 00534910 | void *[4][4] g_MpegLayer2AllocationTables
    MOV dword ptr [EBX + 0x14],EAX      ; 00534916
        ;   Label: LAB_00534916
    MOV EDX,dword ptr [ESP]             ; 00534919
    MOV EAX,dword ptr [ESP + 0x10]      ; 0053491c
    SHL EDX,0x5                         ; 00534920
    FLD double ptr [EDX + EAX*0x8 + 0x67e218] ; 00534923 | double[2][4] g_MpegSampleRateTable
    FMUL double ptr [0x0063b2aa]        ; 0053492a | double DOUBLE_0063b2aa
    PUSH 0x0                            ; 00534930
    MOV EAX,dword ptr [ESP + 0x80]      ; 00534932
    MOV EDX,dword ptr [ESP + 0x80]      ; 00534939
    CALL crt_math.c_round_FUN_005fe6b0  ; 00534940 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [EAX + 0x100]       ; 00534945
    MOV EAX,dword ptr [ESP + 0x44]      ; 0053494b
    PUSH EDX                            ; 0053494f
    MOV dword ptr [EDX + 0x104],EAX     ; 00534950
    CALL sound_mp3.cpp_CMP3Decoder_seek_FUN_00534ba0 ; 00534956 | int sound_mp3.cpp_CMP3Decoder_seek_FUN_00534ba0(CMP3Decoder * this_ptr, int sample_offset)
