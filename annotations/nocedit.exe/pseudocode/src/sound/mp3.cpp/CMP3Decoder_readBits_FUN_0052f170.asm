...
;                               FUNCTION
; *****************************************************************************
; __cdecl uint sound_mp3.cpp_CMP3Decoder_readBits_FUN_0052f170(CMP3Decoder * this_ptr, uint num_bits)
;
; Parameters:
...
section .text
    ...
    MOV EBP,dword ptr [ECX*0x4 + 0x67e5e0] ; 0052f1c2 | uint[18] g_MpegBitMaskTableMultiBit
    ...
    JG 0x0052f195                       ; 0052f1ef | LAB_0052f195
    ...
    JBE 0x0052f19e                      ; 0052f21a | LAB_0052f19e
        ;   XREF to: 0052f19e (CONDITIONAL_JUMP)
    PUSH 0x2f68188                      ; 0052f21c | char[256] g_CurrentMp3Filename
    MOV EBP,0x63ad8b                    ; 0052f221 | = "..\\sound\\mp3.cpp" | s_sound_mp3_cpp_0063ad8b = ..\sound\mp3.cpp
    MOV EAX,0x2c1                       ; 0052f226
    PUSH 0x63ad9c                       ; 0052f22b | = "Buffer overflow!!  File: %s" | s_Buffer_overflow_File_s_0063ad9c = Buffer overflow!!  File: %s
    MOV dword ptr [0x02f0ca48],EBP      ; 0052f230 | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 0052f236 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0052f23b | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0052f240
    JMP 0x0052f19e                      ; 0052f243 | LAB_0052f19e
        ;   XREF to: 0052f19e (UNCONDITIONAL_JUMP)
    MOV EAX,EDX                         ; 0052f248
        ;   Label: LAB_0052f248
    JMP 0x0052f1ae                      ; 0052f24a | LAB_0052f1ae
