...

{
  ...
  do {
    local_18 = 0;
    if (0 < iVar1) {
      puVar9 = (uint *)&quantized_samples->codes.q[0][local_28];
      pfVar4 = &dequantized_samples->codes.f[0][local_28];
      piVar5 = &allocation->granules[local_28];
      pfVar6 = pfVar4;
      do {
        if (*piVar5 == 0) {
          *pfVar6 = 0.0;
          ...
          bVar3 = (byte)*piVar5;
          if ((quantized_samples[local_18].codes.q[0][local_28] >>
