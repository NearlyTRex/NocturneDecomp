// Name: sound_mp3.cpp_HuffmanDecodeTableThing_FUN_00531680
// Address: 00531680
// Address Range: [[00531680, 00531d4d]]
// Convention: unknown
// Signature: undefined sound_mp3.cpp_HuffmanDecodeTableThing_FUN_00531680()
// Cross-references:
//   sound_mp3.cpp_MpegLoadMaybe_FUN_00534d40 (00534d40) at 00535858 [UNCONDITIONAL_CALL]
// Globals:
...
//   sound_mp3.cpp_FUN_0052f2c0
//   sound_mp3.cpp_HuffmanCodeCheck_FUN_0052f350
//   sound_mp3.cpp_MemoryCheckOverflow_FUN_0052f170

#include "nocturne.h"

/* Signature: undefined1 sound_mp3.cpp_HuffmanDecodeTableThing(undefined4 param_1, undefined4
   param_2, undefined4 param_3, undefined4 param_4, undefined4 param_5, undefined4 param_6,
   undefined4 param_7) */

int sound_mp3_cpp_HuffmanDecodeTableThing_FUN_00531680(void)

{
  ...
  bVar12 = 0;
  local_34 = ((int *)*in_stack_0000001c)[4] + *(int *)*in_stack_0000001c * 3;
  if (DAT_02f45980 == 0) {
    local_18 = DAT_02f45980;
    iVar1 = 0;
    pcVar7 = (char *)0x0;
    local_1c = &DAT_02f68288;
    do {
      pcVar13 = local_1c;
      crt_stdio_c_sprintf_FUN_005fdbd0(local_1c,"%d",pcVar7);
      *(undefined4 *)((int)&DAT_02f68aac + iVar1) = *(undefined4 *)(&DAT_00680170 + local_14);
      *(undefined4 *)((int)&DAT_02f6828c + iVar1) = *(undefined4 *)(&DAT_00680174 + local_14);
      *(undefined4 *)((int)&DAT_02f68290 + iVar1) = *(undefined4 *)(&DAT_00680178 + local_14);
      *(undefined4 *)(&DAT_02f68294 + iVar1) = *(undefined4 *)(&DAT_0068017c + local_14);
      *(int *)((int)&DAT_02f68298 + iVar1) = (1 << ((&DAT_02f68294)[iVar1] & 0x1f)) + -1;
      crt_stdio_c_sscanf_FUN_0060013c(pcVar13,"%u",&local_34);
      if (pcVar7 != local_30) {
        in_stack_ffffffbc = &DAT_02f68188;
        g_CurrentFilename = "..\\sound\\mp3.cpp";
        g_CurrentLineNumber = 0xd72;
        core_main_c_displayErrorAndQuit_FUN_00506f10("wrong table number %u.  File: %s",pcVar7);
      }
      iVar10 = *(int *)(&DAT_00680180 + unaff_EDI);
      if (iVar10 < 0) {
        if (iVar10 != -1) {
          g_CurrentFilename = "..\\sound\\mp3.cpp";
        ...
        *(undefined4 *)((int)&DAT_02f6829c + iVar1) = 0xffffffff;
        if (0x400 < *(uint *)((int)&DAT_02f68aac + iVar1)) {
        ...
        uVar8 = 0;
        puVar4 = *(undefined1 **)(&DAT_00680184 + unaff_EDI);
        iVar10 = iVar1;
        if (*(int *)((int)&DAT_02f68aac + iVar1) != 0) {
          do {
            *(undefined1 *)((int)&DAT_02f682a8 + iVar10) = *puVar4;
            *(undefined1 *)((int)&DAT_02f682a8 + iVar10 + 1) = puVar4[1];
            uVar8 = uVar8 + 1;
            puVar4 = puVar4 + 2;
            iVar10 = iVar10 + 2;
          } while (uVar8 < *(uint *)((int)&DAT_02f68aac + iVar1));
        }
      }
      else {
        *(int *)((int)&DAT_02f6829c + iVar1) = iVar10;
        puVar9 = &DAT_02f682a8 + iVar10 * 0x20a;
        puVar11 = (undefined4 *)((int)&DAT_02f682a8 + iVar1);
        ...
        *(undefined4 *)((int)&DAT_02f68aac + iVar1) = (&DAT_02f68aac)[iVar10 * 0x20a];
        if ((*(int *)((int)&DAT_02f6828c + iVar1) != (&DAT_02f6828c)[iVar10 * 0x20a]) ||
           ((&DAT_02f68290)[iVar10 * 0x20a] != *(int *)((int)&DAT_02f68290 + iVar1))) {
          g_CurrentFilename = "..\\sound\\mp3.cpp";
          g_CurrentLineNumber = 0xd7d;
          pcVar13 = "wrong table %u reference.  File: %s";
LAB_00531a14:
          in_stack_ffffffbc = pcVar7;
  ...
  iVar1 = in_stack_00000014 * 0x48 + in_stack_0000000c + in_stack_00000010 * 0xa0;
  if ((*(int *)(iVar1 + 0x28) == 0) || (*(int *)(iVar1 + 0x2c) != 2)) {
    local_20 = *(undefined **)
                (&DAT_0067e6cc +
                *(int *)(in_stack_0000000c + in_stack_00000010 * 0xa0 + in_stack_00000014 * 0x48 +
                        0x4c) * 4 + local_34 * 0x94);
  }
  else {
    local_20 = (undefined *)0x24;
  }
  sound_mp3_cpp_FUN_0052f160();
  local_2c = in_stack_00000014 * 0x48;
  iVar1 = 1;
  local_20 = (undefined *)(in_stack_0000000c + in_stack_00000010 * 0xa0);
  for (uVar8 = 0; iVar10 = (int)local_20 + local_2c, uVar8 < (uint)(*(int *)(iVar10 + 0x1c) * 2);
      uVar8 = uVar8 + 2) {
    sound_mp3_cpp_HuffmanCodeCheck_FUN_0052f350();
    *(char **)(in_stack_00000010 + ((int)uVar8 / 0x12) * 0x48 + ((int)uVar8 % 0x12) * 4) =
         in_stack_ffffffbc;
    iVar10 = iVar1 / 0x12;
    iVar6 = iVar1 % 0x12;
    iVar1 = iVar1 + 2;
    *(undefined4 *)(in_stack_00000010 + iVar10 * 0x48 + iVar6 * 4) = local_3c;
  }
  sound_mp3_cpp_FUN_0052f160();
  local_20 = &DAT_02f68288 + (*(int *)(iVar10 + 0x5c) + 0x20) * 0x828;
  iVar1 = uVar8 + 3;
  iVar10 = uVar8 + 2;
  local_24 = in_stack_00000014 + in_stack_00000018 * 0xa0 + (int)in_stack_0000001c * 0x48;
  iVar6 = uVar8 + 1;
  for (; (uVar2 = sound_mp3_cpp_FUN_0052f160(), uVar2 < unaff_ESI && ((int)uVar8 < 0x240));
      uVar8 = uVar8 + 4) {
    sound_mp3_cpp_HuffmanCodeCheck_FUN_0052f350();
    *(char **)(in_stack_00000018 + ((int)uVar8 / 0x12) * 0x48 + ((int)uVar8 % 0x12) * 4) = local_30;
    *(int *)(in_stack_00000018 + (iVar6 / 0x12) * 0x48 + (iVar6 % 0x12) * 4) = local_2c;
    *(char ***)(in_stack_00000018 + (iVar10 / 0x12) * 0x48 + (iVar10 % 0x12) * 4) = &local_30;
    iVar3 = iVar1 / 0x12;
    iVar5 = iVar1 % 0x12;
    iVar6 = iVar6 + 4;
    iVar10 = iVar10 + 4;
    iVar1 = iVar1 + 4;
    *(int *)(in_stack_00000018 + iVar3 * 0x48 + iVar5 * 4) = local_34;
  }
  iVar10 = in_stack_00000018 + (int)in_stack_0000001c * 0xa0 + (int)in_stack_00000020 * 0x48;
  sound_mp3_cpp_FUN_0052f160();
  iVar1 = *(int *)(iVar10 + 0x18);
  uVar2 = sound_mp3_cpp_FUN_0052f160();
  if ((uint)(in_stack_00000028 + iVar1) < uVar2) {
    iVar1 = sound_mp3_cpp_FUN_0052f160();
    local_34 = (iVar1 - in_stack_00000030) - *(int *)(iVar10 + 0x18);
    uVar8 = uVar8 - 4;
    sound_mp3_cpp_FUN_0052f2c0();
  }
  ...
  local_34 = 0x531cfb;
  local_2c = sound_mp3_cpp_FUN_0052f160();
  if (local_2c < in_stack_00000034) {
    local_2c = in_stack_00000034 - local_2c;
    local_30 = in_stack_00000024;
    local_34 = 0x531d41;
    local_2c = sound_mp3_cpp_MemoryCheckOverflow_FUN_0052f170();
  }
  for (; (int)uVar8 < 0x240; uVar8 = uVar8 + 1) {
    local_2c = (int)uVar8 / 0x12;
    *(undefined4 *)(in_stack_0000002c + ((int)uVar8 / 0x12) * 0x48 + ((int)uVar8 % 0x12) * 4) = 0;
  }
  return local_2c;
}
...
// Assembly code:
// 00531680: PUSH EBX
//   Label: sound_mp3.cpp_HuffmanDecodeTableThing_FUN_00531680
// 00531681: PUSH ESI
// 00531682: PUSH EDI
// 00531683: PUSH EBP
...
// 00531723: CALL sound_mp3.cpp_FUN_0052f160
...
//   XREF to: Stack[0x4] (READ)
// 00531754: PUSH EDX
// 00531755: CALL sound_mp3.cpp_FUN_0052f160
//   XREF to: 0052f160 (UNCONDITIONAL_CALL)
...
//   XREF to: Stack[0x4] (READ)
// 005317c7: PUSH EAX
// 005317c8: CALL sound_mp3.cpp_FUN_0052f160
//   XREF to: 0052f160 (UNCONDITIONAL_CALL)
...
//   XREF to: Stack[0x4] (READ)
// 00531803: PUSH EDX
// 00531804: CALL sound_mp3.cpp_HuffmanCodeCheck_FUN_0052f350
...
//   XREF to: Stack[0x4] (READ)
// 00531beb: PUSH ECX
// 00531bec: CALL sound_mp3.cpp_HuffmanCodeCheck_FUN_0052f350
//   XREF to: 0052f350 (UNCONDITIONAL_CALL)
...
// 00531c79: CALL sound_mp3.cpp_FUN_0052f160
//   XREF to: 0052f160 (UNCONDITIONAL_CALL)
...
//   XREF to: Stack[0x18] (READ)
// 00531c8d: CALL sound_mp3.cpp_FUN_0052f160
//   XREF to: 0052f160 (UNCONDITIONAL_CALL)
...
//   XREF to: Stack[0x4] (READ)
// 00531c9f: PUSH EDX
// 00531ca0: CALL sound_mp3.cpp_FUN_0052f160
//   XREF to: 0052f160 (UNCONDITIONAL_CALL)
...
// 00531cbc: CALL sound_mp3.cpp_FUN_0052f2c0
...
// 00531cf6: CALL sound_mp3.cpp_FUN_0052f160
//   XREF to: 0052f160 (UNCONDITIONAL_CALL)
...
//   XREF to: Stack[0x4] (READ)
// 00531d3b: PUSH EBX
// 00531d3c: CALL sound_mp3.cpp_MemoryCheckOverflow_FUN_0052f170
