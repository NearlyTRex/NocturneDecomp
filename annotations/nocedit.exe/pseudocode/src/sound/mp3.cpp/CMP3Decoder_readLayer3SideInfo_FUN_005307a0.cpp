...

{
  ...
  if (frame->header->mpeg_version == 0) {
    ...
    side_info_array->field0_0x0 = uVar2;
    if (iVar1 == 1) {
      iVar12 = 1;
    }
    else {
    ...
    side_info_array->field1_0x4 = uVar2;
    local_30 = 0;
    if (0 < iVar1) {
      ...
      do {
        ...
        if (uVar2 == 0) {
          ...
          pSVar10 = pSVar4;
          do {
            piVar5 = &pSVar10->field1_0x4;
            uVar2 = sound_mp3_cpp_CFileBitStream_readBits_FUN_0052ef40(bit_stream,5);
            pSVar10->table_select[0] = uVar2;
            pSVar10 = (SMpegLayer3Granule *)piVar5;
          } while (piVar5 != (int *)pSVar4->field2_0x8);
          uVar2 = (uint)piVar5 ^ (uint)pSVar4->field2_0x8;
          do {
    ...
    iVar12 = 0;
    if (0 < iVar1) {
      local_5c = side_info_array->field2_0x8 + 8;
      do {
        pSVar4 = side_info_array + iVar12;
        do {
          piVar5 = &pSVar4->field1_0x4;
          uVar2 = sound_mp3_cpp_CFileBitStream_readBit_FUN_0052ee50(bit_stream);
          *(uint *)pSVar4->field2_0x8 = uVar2;
    ...
    do {
      local_34 = 0;
      if (0 < iVar1) {
        local_44 = side_info_array->field2_0x8 + local_58 + -8;
        local_40 = local_44;
        local_2c = local_44;
        local_24 = local_44;
        do {
          ...
          *(uint *)(local_24 + 0x28) = uVar2;
          if (uVar2 == 0) {
            ...
            *(uint *)(local_24 + 0x2c) = uVar2;
            uVar2 = sound_mp3_cpp_CFileBitStream_readBit_FUN_0052ee50(bit_stream);
            pcVar11 = side_info_array[local_34].field2_0x8 + local_58 + -8;
