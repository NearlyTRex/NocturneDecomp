// Name: sound_mp3.cpp_FUN_00533690
// Address: 00533690
// Address Range: [[00533690, 00533b95]]
// Convention: unknown
// Signature: undefined sound_mp3.cpp_FUN_00533690()
// Cross-references:
//   sound_mp3.cpp_FUN_00533ba0 (00533ba0) at 00533bdf [UNCONDITIONAL_CALL]
// Globals:
//   undefined4 DAT_0063b0a2
//   undefined4 DAT_0063b0aa
//   undefined4 DAT_0063b0b2
//   undefined4 DAT_0063b0ba
//   undefined4 DAT_0063b0c2
//   undefined4 DAT_0063b0ca
//   undefined4 DAT_0063b0d2
//   undefined4 DAT_0063b0da
//   undefined4 DAT_0067e210
//   undefined8 DAT_02f46688
//   undefined8 DAT_02f46690
//   undefined8 DAT_02f467a8
//   undefined8 DAT_02f467b0
//   undefined4 DAT_02f46838
//   undefined4 DAT_02f4683c
//   undefined4 DAT_02f46840
//   undefined4 DAT_02f46844
//   undefined8 DAT_02f46848
//   undefined8 DAT_02f46850
//   undefined4 DAT_02f46898
//   undefined4 DAT_02f4689c
//   undefined4 DAT_02f468a0
//   undefined4 DAT_02f468a4
//   undefined8 DAT_02f468c8
//   undefined8 DAT_02f468d0
//   undefined4 DAT_02f46928
//   undefined4 DAT_02f4692c
//   undefined4 DAT_02f46930
//   undefined4 DAT_02f46934
//   undefined4 DAT_02f469e8
//   undefined4 DAT_02f469ec
//   undefined4 DAT_02f469f0
//   undefined4 DAT_02f469f4
//   undefined8 DAT_02f469f8
//   undefined8 DAT_02f46a00
//   undefined4 DAT_02f46a48
//   undefined4 DAT_02f46a4c
//   undefined4 DAT_02f46a50
//   undefined4 DAT_02f46a54
//   undefined8 DAT_02f46a58
//   undefined8 DAT_02f46a60
//   undefined8 DAT_02f46b08
//   undefined8 DAT_02f46b10
//   undefined8 DAT_02f46b18
//   undefined8 DAT_02f46b20
//   undefined8 DAT_02f46b28
//   undefined8 DAT_02f46b30
//   undefined8 DAT_02f46b38
//   undefined8 DAT_02f46b40
//   undefined8 DAT_02f46b48
//   undefined8 DAT_02f46b50
//   undefined8 DAT_02f46b58
//   undefined8 DAT_02f46b60
//   undefined4 DAT_02f46d48
...
/* Signature: undefined1 sound_mp3.cpp_FUN_00533690(undefined4 param_1, undefined4 param_2,
   undefined4 param_3) */

void sound_mp3_cpp_FUN_00533690(void)

{
  ...
  if (DAT_0067e210 == 1) {
    iVar11 = 0;
    fVar13 = (float10)_DAT_0063b0a2;
    fVar14 = (float10)_DAT_0063b0c2;
    iVar12 = 0;
    do {
      fVar15 = (float10)fsin(((float10)iVar11 + fVar14) * fVar13);
      iVar11 = iVar11 + 1;
      *(double *)((int)&DAT_02f46688 + iVar12) = (double)fVar15;
      iVar12 = iVar12 + 8;
    } while (iVar11 < 0x24);
    iVar11 = 0;
    fVar13 = (float10)_DAT_0063b0a2;
    ...
    do {
      fVar15 = (float10)fsin(((float10)iVar11 + fVar14) * fVar13);
      iVar11 = iVar11 + 1;
      *(double *)((int)&DAT_02f467a8 + iVar12) = (double)fVar15;
      iVar12 = iVar12 + 8;
    } while (iVar11 < 0x12);
    iVar12 = 0x90;
    do {
      iVar11 = iVar12 + 8;
      *(undefined4 *)((int)&DAT_02f467a8 + iVar12 + 4) = 0x3ff00000;
      *(undefined4 *)((int)&DAT_02f467a8 + iVar12) = 0;
      iVar12 = iVar11;
    } while (iVar11 != 0xc0);
    iVar11 = 0x18;
    fVar13 = (float10)_DAT_0063b0aa;
    fVar14 = (float10)_DAT_0063b0ca;
    fVar15 = (float10)_DAT_0063b0c2;
    iVar12 = 0xc0;
    do {
      fVar16 = (float10)fsin(((float10)iVar11 + fVar15 + fVar14) * fVar13);
      iVar11 = iVar11 + 1;
      *(double *)((int)&DAT_02f467a8 + iVar12) = (double)fVar16;
      iVar12 = iVar12 + 8;
    } while (iVar11 < 0x1e);
    iVar12 = 0xf0;
    do {
      iVar11 = iVar12 + 8;
      *(undefined4 *)((int)&DAT_02f467a8 + iVar12) = 0;
      *(undefined4 *)((int)&DAT_02f467a8 + iVar12 + 4) = 0;
      iVar12 = iVar11;
    } while (iVar11 != 0x120);
    iVar12 = 0;
    do {
      iVar11 = iVar12 + 8;
      *(undefined4 *)((int)&DAT_02f469e8 + iVar12) = 0;
      *(undefined4 *)((int)&DAT_02f469ec + iVar12) = 0;
      iVar12 = iVar11;
    } while (iVar11 != 0x30);
    iVar11 = 6;
    fVar13 = (float10)_DAT_0063b0aa;
    fVar14 = (float10)_DAT_0063b0d2;
    fVar15 = (float10)_DAT_0063b0c2;
    iVar12 = 0x30;
    do {
      fVar16 = (float10)fsin(((float10)iVar11 + fVar15 + fVar14) * fVar13);
      iVar11 = iVar11 + 1;
      *(double *)((int)&DAT_02f469e8 + iVar12) = (double)fVar16;
      iVar12 = iVar12 + 8;
    } while (iVar11 < 0xc);
    iVar12 = 0x60;
    do {
      iVar11 = iVar12 + 8;
      *(undefined4 *)((int)&DAT_02f469ec + iVar12) = 0x3ff00000;
      *(undefined4 *)((int)&DAT_02f469e8 + iVar12) = 0;
      iVar12 = iVar11;
    } while (iVar11 != 0x90);
    iVar11 = 0x12;
    ...
    do {
      fVar15 = (float10)fsin(((float10)iVar11 + fVar14) * fVar13);
      iVar11 = iVar11 + 1;
      *(double *)((int)&DAT_02f469e8 + iVar12) = (double)fVar15;
      iVar12 = iVar12 + 8;
    } while (iVar11 < 0x24);
    iVar11 = 0;
    fVar13 = (float10)_DAT_0063b0aa;
    ...
    do {
      fVar15 = (float10)fsin(((float10)iVar11 + fVar14) * fVar13);
      iVar11 = iVar11 + 1;
      *(double *)((int)&DAT_02f468c8 + iVar12) = (double)fVar15;
      iVar12 = iVar12 + 8;
    } while (iVar11 < 0xc);
    iVar12 = 0x60;
    do {
      iVar11 = iVar12 + 8;
      *(undefined4 *)((int)&DAT_02f468c8 + iVar12) = 0;
      *(undefined4 *)((int)&DAT_02f468c8 + iVar12 + 4) = 0;
      iVar12 = iVar11;
    } while (iVar11 != 0x120);
    local_24 = 0;
    iVar12 = 1;
    ...
    do {
      iVar9 = 1;
      fVar13 = (float10)_DAT_0063b0b2;
      iVar11 = local_24;
      do {
        fVar14 = (float10)fcos((float10)iVar9 * (float10)(iVar12 + 6) * fVar13);
        iVar9 = iVar9 + 2;
        *(double *)((int)&DAT_02f46b08 + iVar11) = (double)fVar14;
        iVar11 = iVar11 + 8;
      } while (iVar9 < 0xd);
      iVar12 = iVar12 + 2;
    ...
    do {
      ...
      do {
        ...
        *(double *)(&DAT_02f46d48 + iVar12) = (double)fVar14;
        iVar12 = iVar9;
  ...
  if (in_stack_0000000c != 2) {
    ...
    do {
      iVar11 = local_44;
      if ((float)_DAT_0063b0da < ABS(in_stack_00000004[iVar12])) {
        local_44 = local_44 + 1;
        aiStack_9c[iVar11] = iVar12;
      }
      iVar12 = iVar12 + 1;
    } while (iVar12 < 0x12);
    local_34 = &DAT_02f46688 + in_stack_0000000c * 0x24;
    local_1c = 0;
    do {
      local_40 = (float *)((int)in_stack_00000008 + local_1c * 4);
      local_3c = &DAT_02f46d48 + local_1c * 0x90;
      local_18 = in_stack_00000004;
      local_38 = (double *)(local_34 + local_1c);
      fVar8 = 0.0;
      iVar12 = local_44;
      if (0 < local_44) {
        do {
          iVar12 = iVar12 + -1;
          fVar8 = in_stack_00000004[aiStack_9c[iVar12]] *
                  (float)*(double *)(&DAT_02f46d48 + local_1c * 0x90 + aiStack_9c[iVar12] * 8) +
                  fVar8;
        } while (0 < iVar12);
        fVar8 = fVar8 * (float)(double)local_34[local_1c];
      }
      *local_40 = fVar8;
      local_1c = local_1c + 1;
    } while (local_1c < 0x24);
  ...
  crt_memory_c_memset_FUN_005fde40(in_stack_00000008,0,0x90);
  iVar11 = 0;
  iVar12 = 0;
  pvVar10 = in_stack_00000008;
  do {
    pdVar1 = (double *)((int)&DAT_02f46b10 + iVar12);
    pdVar2 = (double *)((int)&DAT_02f46b08 + iVar12);
    pdVar3 = (double *)((int)&DAT_02f46b18 + iVar12);
    pdVar4 = (double *)((int)&DAT_02f46b20 + iVar12);
    pdVar5 = (double *)((int)&DAT_02f46b28 + iVar12);
    pdVar6 = (double *)((int)&DAT_02f46b30 + iVar12);
    pdVar7 = (double *)((int)&DAT_02f468c8 + iVar11);
    iVar11 = iVar11 + 8;
    iVar12 = iVar12 + 0x30;
    *(float *)((int)pvVar10 + 0x18) =
         (in_stack_00000004[0xf] * (float)*pdVar6 +
         in_stack_00000004[0xc] * (float)*pdVar5 +
         in_stack_00000004[9] * (float)*pdVar4 +
         in_stack_00000004[6] * (float)*pdVar3 +
         *in_stack_00000004 * (float)*pdVar2 + in_stack_00000004[3] * (float)*pdVar1) *
         (float)*pdVar7 + *(float *)((int)pvVar10 + 0x18);
    pvVar10 = (void *)((int)pvVar10 + 4);
  } while (iVar11 != 0x60);
  iVar12 = 0;
  iVar11 = 0;
  pvVar10 = in_stack_00000008;
  do {
    ...
    iVar11 = iVar11 + 8;
    iVar12 = iVar12 + 0x30;
    *(float *)((int)pvVar10 + 0x30) =
         (in_stack_00000004[0x10] * (float)*pdVar6 +
         in_stack_00000004[0xd] * (float)*pdVar5 +
         in_stack_00000004[10] * (float)*pdVar4 +
         in_stack_00000004[7] * (float)*pdVar3 +
         in_stack_00000004[1] * (float)*pdVar2 + in_stack_00000004[4] * (float)*pdVar1) *
         (float)*pdVar7 + *(float *)((int)pvVar10 + 0x30);
    pvVar10 = (void *)((int)pvVar10 + 4);
  } while (iVar11 != 0x60);
  iVar12 = 0;
  iVar11 = 0;
  do {
    ...
    iVar11 = iVar11 + 8;
    iVar12 = iVar12 + 0x30;
    *(float *)((int)in_stack_00000008 + 0x48) =
         (in_stack_00000004[0x11] * (float)*pdVar6 +
         in_stack_00000004[0xe] * (float)*pdVar5 +
         in_stack_00000004[0xb] * (float)*pdVar4 +
         in_stack_00000004[8] * (float)*pdVar3 +
         in_stack_00000004[2] * (float)*pdVar2 + in_stack_00000004[5] * (float)*pdVar1) *
         (float)*pdVar7 + *(float *)((int)in_stack_00000008 + 0x48);
    in_stack_00000008 = (void *)((int)in_stack_00000008 + 4);
  } while (iVar11 != 0x60);
  return;
}
...
// Assembly code:
// 00533690: PUSH EBX
//   Label: sound_mp3.cpp_FUN_00533690
// 00533691: PUSH ESI
// 00533692: PUSH EDI
// 00533693: PUSH EBP
