...
// Cross-references:
//   sound_mp3.cpp_CMP3Decoder_decodeFrame_FUN_00534d40 (00534d40) at 005350f5 [UNCONDITIONAL_CALL]
...

{
  ...
  iVar1 = header->sampling_rate_index;
  local_28 = 0;
  do {
    local_18 = 0;
    if (0 < iVar1) {
      puVar9 = (uint *)((int)quantized_samples->codes[0] + local_28);
      pfVar4 = (float *)((int)dequantized_samples->codes[0] + local_28);
      ...
      do {
        if (*piVar5 == 0) {
          *pfVar6 = 0.0;
          ...
          bVar3 = (byte)*piVar5;
          if ((*(uint *)((int)quantized_samples[local_18].codes[0] + local_28) >>
