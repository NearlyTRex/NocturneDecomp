...
// Cross-references:
//   sound_mp3.cpp_CMP3Decoder_decodeFrame_FUN_00534d40 (00534d40) at 005351b0 [UNCONDITIONAL_CALL]
// Globals:
...

{
    ...
    do {
      ...
      do {
        fVar10 = (float10)fcos((float10)iVar7 *
                               ((float10)local_1c * (float10)DOUBLE_0063ae5a +
                               (float10)DOUBLE_0063ae72));
        *pfVar8 = (float)(fVar10 * (float10)DOUBLE_0063ae62);
        local_14 = iVar7;
        if (*pfVar8 < 0.0) {
          local_5c[0] = (double)*pfVar8;
          crt_math_c_modf_FUN_00602102((double)(*pfVar8 + (float)DOUBLE_0063ae7a),local_5c);
          dVar1 = local_5c[0];
        }
        else {
          local_64 = (double)*pfVar8;
          crt_math_c_modf_FUN_00602102((double)(*pfVar8 + (float)DOUBLE_0063ae82),&local_64);
          dVar1 = local_64;
        }
        *pfVar8 = (float)dVar1;
        pfVar8 = pfVar8 + 1;
        iVar7 = iVar7 + 2;
        *pfVar9 = *pfVar9 * (float)DOUBLE_0063ae6a;
        pfVar9 = pfVar9 + 1;
      } while (iVar7 != 0x41);
      local_1c = local_1c + 1;
  ...
  local_4c = 0;
  do {
    if ((float)DOUBLE_0063ae8a < ABS(subband_samples[iVar7])) {
