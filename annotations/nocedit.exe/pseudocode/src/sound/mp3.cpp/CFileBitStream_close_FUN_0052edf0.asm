...
section .text
    ...
    PUSH 0x20b                          ; 0052ee06
        ;   Label: LAB_0052ee06
    PUSH 0x63ace1                       ; 0052ee0b | = "..\\sound\\mp3.cpp" | s_sound_mp3_cpp_0063ace1 = ..\sound\mp3.cpp
    PUSH EDX                            ; 0052ee10
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 0052ee11 | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
        ;   XREF to: 0050f9b0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0052ee16
    MOV dword ptr [EBX],0x0             ; 0052ee19
    MOV ESI,dword ptr [EBX + 0x4]       ; 0052ee1f
    TEST ESI,ESI                        ; 0052ee22
    JNZ 0x0052ee29                      ; 0052ee24 | LAB_0052ee29
        ;   XREF to: 0052ee29 (CONDITIONAL_JUMP)
    POP ESI                             ; 0052ee26
    POP EBX                             ; 0052ee27
    RET                                 ; 0052ee28
    PUSH 0x210                          ; 0052ee29
        ;   Label: LAB_0052ee29
    PUSH 0x63acf2                       ; 0052ee2e | = "..\\sound\\mp3.cpp" | s_sound_mp3_cpp_0063acf2 = ..\sound\mp3.cpp
    PUSH ESI                            ; 0052ee33
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 0052ee34 | void shape_memdbg.cpp_debugFree_FUN_0050f460(void * ptr, char * filename, int line_number)
