...
;                               FUNCTION
; *****************************************************************************
; __cdecl uint sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40(CFileBitStream * bitstream, int num_bits)
;
; Parameters:
...
section .text
    ...
    MOV ESI,dword ptr [EDX*0x4 + 0x67e5e0] ; 0052ef88 | uint[18] g_MpegBitMaskTableMultiBit
    ...
    JG 0x0052ef62                       ; 0052efac | LAB_0052ef62
    ...
    POP EBX                             ; 0052efb7
    RET                                 ; 0052efb8
    PUSH 0x2f68188                      ; 0052efb9 | char[256] g_CurrentMp3Filename
        ;   Label: LAB_0052efb9
    PUSH 0x20                           ; 0052efbe
    MOV ECX,0x63ad3e                    ; 0052efc0 | = "..\\sound\\mp3.cpp" | s_sound_mp3_cpp_0063ad3e = ..\sound\mp3.cpp
    MOV ESI,0x267                       ; 0052efc5
    PUSH 0x63ad4f                       ; 0052efca | = "Cannot read or write more than %d bit..." | s_Cannot_read_or_write_mor_0063ad4f = Cannot read or write more than %d bits at a time.  File: %s
    MOV dword ptr [0x02f0ca48],ECX      ; 0052efcf | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 0052efd5 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0052efdb | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0052efe0
    JMP 0x0052ef5b                      ; 0052efe3 | LAB_0052ef5b
    ...
    JGE 0x0052f01e                      ; 0052f038 | LAB_0052f01e
