...
section .text
    ...
    JLE 0x0052f953                      ; 0052f8fa | LAB_0052f953
    ...
    JLE 0x0052f940                      ; 0052f910 | LAB_0052f940
    ...
    JLE 0x0052fa3e                      ; 0052f9a8 | LAB_0052fa3e
    ...
    JZ 0x0052fb2a                       ; 0052f9d7 | LAB_0052fb2a
    ...
    JA 0x0052fa26                       ; 0052f9ee | default
        ;   XREF to: 0052fa26 (CONDITIONAL_JUMP)
    JMP dword ptr [EAX*0x4 + 0x52f8c4]  ; 0052f9f0 | void * switchdataD_0052f8c4
        ;   Label: switchD
    PUSH 0x6                            ; 0052f9f7
        ;   Label: caseD_0
    PUSH ESI                            ; 0052f9f9
    CALL sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40 ; 0052f9fa | uint sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40(CFileBitStream * bitstream, int num_bits)
        ;   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0052f9ff
    PUSH 0x6                            ; 0052fa02
    PUSH ESI                            ; 0052fa04
    MOV dword ptr [EBX],EAX             ; 0052fa05
    CALL sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40 ; 0052fa07 | uint sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40(CFileBitStream * bitstream, int num_bits)
        ;   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0052fa0c
    PUSH 0x6                            ; 0052fa0f
    PUSH ESI                            ; 0052fa11
    MOV dword ptr [EBX + 0x80],EAX      ; 0052fa12
    CALL sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40 ; 0052fa18 | uint sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40(CFileBitStream * bitstream, int num_bits)
        ;   Label: LAB_0052fa18
        ;   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
    ...
    JL 0x0052f9ca                       ; 0052fa3c | LAB_0052f9ca
    ...
    PUSH 0x2                            ; 0052faa4
        ;   Label: LAB_0052faa4
    PUSH ESI                            ; 0052faa6
    CALL sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40 ; 0052faa7 | uint sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40(CFileBitStream * bitstream, int num_bits)
        ;   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
    ...
    JMP 0x0052f935                      ; 0052fac3 | LAB_0052f935
        ;   XREF to: 0052f935 (UNCONDITIONAL_JUMP)
    PUSH 0x6                            ; 0052fac8
        ;   Label: caseD_1
    PUSH ESI                            ; 0052faca
    CALL sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40 ; 0052facb | uint sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40(CFileBitStream * bitstream, int num_bits)
        ;   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
    ...
    JMP 0x0052fa18                      ; 0052fade | LAB_0052fa18
        ;   XREF to: 0052fa18 (UNCONDITIONAL_JUMP)
    PUSH 0x6                            ; 0052fae3
        ;   Label: caseD_3
    PUSH ESI                            ; 0052fae5
    CALL sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40 ; 0052fae6 | uint sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40(CFileBitStream * bitstream, int num_bits)
        ;   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0052faeb
    PUSH 0x6                            ; 0052faee
    PUSH ESI                            ; 0052faf0
    MOV dword ptr [EBX],EAX             ; 0052faf1
    CALL sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40 ; 0052faf3 | uint sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40(CFileBitStream * bitstream, int num_bits)
        ;   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
    MOV dword ptr [EBX + 0x100],EAX     ; 0052faf8
    ADD ESP,0x8                         ; 0052fafe
    MOV dword ptr [EBX + 0x80],EAX      ; 0052fb01
    JMP 0x0052fa26                      ; 0052fb07 | default
        ;   XREF to: 0052fa26 (UNCONDITIONAL_JUMP)
    PUSH 0x6                            ; 0052fb0c
        ;   Label: caseD_2
    PUSH ESI                            ; 0052fb0e
    CALL sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40 ; 0052fb0f | uint sound_mp3.cpp_CFileBitStream_readBits_FUN_0052ef40(CFileBitStream * bitstream, int num_bits)
        ;   XREF to: 0052ef40 (UNCONDITIONAL_CALL)
    ...
    JMP 0x0052fa26                      ; 0052fb25 | default
        ;   XREF to: 0052fa26 (UNCONDITIONAL_JUMP)
    ...
    JMP 0x0052fa26                      ; 0052fb42 | default
        ;   XREF to: 0052fa26 (UNCONDITIONAL_JUMP)
