...
section .text
    ...
    MOV EDX,0x2f68288                   ; 00533d37 | SHuffmanTable[34] g_HuffmanTables
    XOR EBP,EBP                         ; 00533d3c
    XOR EBX,EBX                         ; 00533d3e
    MOV dword ptr [ESP + 0x4],EDX       ; 00533d40 | SHuffmanTable[34] g_HuffmanTables
    MOV dword ptr [ESP + 0x8],EBP       ; 00533d44
    PUSH EBP                            ; 00533d48
        ;   Label: LAB_00533d48
    PUSH 0x63af26                       ; 00533d49 | = "%d" | s_d_0063af26 = %d
    MOV ESI,dword ptr [ESP + 0xc]       ; 00533d4e
    PUSH ESI                            ; 00533d52 | SHuffmanTable[34] g_HuffmanTables
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 00533d53 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00533d58
    MOV EAX,dword ptr [ESP + 0x8]       ; 00533d5b
    MOV EAX,dword ptr [EAX + 0x680170]  ; 00533d5f | SHuffmanTableSource[34] g_HuffmanTableSources
    ...
    PUSH EAX                            ; 00533db1
    PUSH 0x63af29                       ; 00533db2 | = "%u" | s_u_0063af29 = %u
    PUSH ESI                            ; 00533db7 | SHuffmanTable[34] g_HuffmanTables
    CALL crt_stdio.c_sscanf_FUN_0060013c ; 00533db8 | int crt_stdio.c_sscanf_FUN_0060013c(char * str, char * format)
        ;   XREF to: 0060013c (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00533dbd
    CMP EBP,dword ptr [ESP]             ; 00533dc0
    JNZ 0x00533e89                      ; 00533dc3 | LAB_00533e89
    ...
    JL 0x00533ecb                       ; 00533dd5 | LAB_00533ecb
        ;   XREF to: 00533ecb (CONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0x2f6829c],EAX ; 00533ddb | DAT_02f6829c
    IMUL EDX,EAX,0x828                  ; 00533de1
    MOV ESI,0x2f68288                   ; 00533de7 | SHuffmanTable[34] g_HuffmanTables
    MOV EDI,0x2f68288                   ; 00533dec | SHuffmanTable[34] g_HuffmanTables
    ...
    MOVSD.REP ES:EDI,ESI                ; 00533e06 | DAT_02f682ac | DAT_02f682a8
    MOV CL,AL                           ; 00533e08
    AND CL,0x3                          ; 00533e0a
    MOVSB.REP ES:EDI,ESI                ; 00533e0d | DAT_02f682ad | DAT_02f682ac
    POP EDI                             ; 00533e0f
    ...
    JZ 0x00533eb7                       ; 00533e28 | LAB_00533eb7
        ;   XREF to: 00533eb7 (CONDITIONAL_JUMP)
    PUSH 0x2f68188                      ; 00533e2e | char[256] g_CurrentMp3Filename
        ;   Label: LAB_00533e2e
    PUSH EBP                            ; 00533e33
    MOV EDI,0x63af5e                    ; 00533e34 | = "..\\sound\\mp3.cpp" | s_sound_mp3_cpp_0063af5e = ..\sound\mp3.cpp
    MOV EAX,0xd7d                       ; 00533e39
    PUSH 0x63af6f                       ; 00533e3e | = "wrong table %u reference.  File: %s" | s_wrong_table_u_reference__0063af6f = wrong table %u reference.  File: %s
    MOV dword ptr [0x02f0ca48],EDI      ; 00533e43 | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 00533e49 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00533e4e | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   Label: LAB_00533e4e
    ...
    JL 0x00533d48                       ; 00533e79 | LAB_00533d48
    ...
    POP EBX                             ; 00533e87
    RET                                 ; 00533e88
    PUSH 0x2f68188                      ; 00533e89 | char[256] g_CurrentMp3Filename
        ;   Label: LAB_00533e89
    PUSH EBP                            ; 00533e8e
    MOV EDX,0x63af2c                    ; 00533e8f | = "..\\sound\\mp3.cpp" | s_sound_mp3_cpp_0063af2c = ..\sound\mp3.cpp
    MOV ECX,0xd72                       ; 00533e94
    PUSH 0x63af3d                       ; 00533e99 | = "wrong table number %u.  File: %s" | s_wrong_table_number_u_Fil_0063af3d = wrong table number %u.  File: %s
    MOV dword ptr [0x02f0ca48],EDX      ; 00533e9e | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 00533ea4 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00533eaa | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00533eaf
    JMP 0x00533dc9                      ; 00533eb2 | LAB_00533dc9
    ...
    JNZ 0x00533e2e                      ; 00533ec3 | LAB_00533e2e
        ;   XREF to: 00533e2e (CONDITIONAL_JUMP)
    JMP 0x00533e56                      ; 00533ec9 | LAB_00533e56
        ;   XREF to: 00533e56 (UNCONDITIONAL_JUMP)
    CMP EAX,-0x1                        ; 00533ecb
        ;   Label: LAB_00533ecb
    JNZ 0x00533f5a                      ; 00533ece | LAB_00533f5a
    ...
    JNC 0x00533f30                      ; 00533ee6 | LAB_00533f30
    ...
    JBE 0x00533e56                      ; 00533f00 | LAB_00533e56
        ;   XREF to: 00533e56 (CONDITIONAL_JUMP)
    MOV EDX,EAX                         ; 00533f06
        ;   Label: LAB_00533f06
    MOV DL,byte ptr [EDX]               ; 00533f08
    INC EAX                             ; 00533f0a
    MOV byte ptr [ECX + 0x2f682a8],DL   ; 00533f0b | DAT_02f682a8
    MOV EDX,EAX                         ; 00533f11
    ADD ECX,0x2                         ; 00533f13
    MOV DL,byte ptr [EDX]               ; 00533f16
    MOV byte ptr [ECX + 0x2f682a7],DL   ; 00533f18 | DAT_02f682a8+1
    INC ESI                             ; 00533f1e
    MOV EDX,dword ptr [EDI + 0x2f68aac] ; 00533f1f | g_HuffmanTables[0].table_size
    INC EAX                             ; 00533f25
    CMP ESI,EDX                         ; 00533f26
    JNC 0x00533e56                      ; 00533f28 | LAB_00533e56
        ;   XREF to: 00533e56 (CONDITIONAL_JUMP)
    JMP 0x00533f06                      ; 00533f2e | LAB_00533f06
        ;   XREF to: 00533f06 (UNCONDITIONAL_JUMP)
    PUSH 0x2f68188                      ; 00533f30 | char[256] g_CurrentMp3Filename
        ;   Label: LAB_00533f30
    MOV ECX,0x63af93                    ; 00533f35 | = "..\\sound\\mp3.cpp" | s_sound_mp3_cpp_0063af93 = ..\sound\mp3.cpp
    MOV ESI,0xd85                       ; 00533f3a
    PUSH 0x63afa4                       ; 00533f3f | = "MP3 Huffman tree overflow!  File: %s" | s_MP3_Huffman_tree_overflo_0063afa4 = MP3 Huffman tree overflow!  File: %s
    MOV dword ptr [0x02f0ca48],ECX      ; 00533f44 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 00533f4a | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00533f50 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00533f55
    JMP 0x00533ee8                      ; 00533f58 | LAB_00533ee8
        ;   XREF to: 00533ee8 (UNCONDITIONAL_JUMP)
    PUSH 0x2f68188                      ; 00533f5a | char[256] g_CurrentMp3Filename
        ;   Label: LAB_00533f5a
    PUSH EBP                            ; 00533f5f
    MOV ESI,0x63afc9                    ; 00533f60 | = "..\\sound\\mp3.cpp" | s_sound_mp3_cpp_0063afc9 = ..\sound\mp3.cpp
    MOV EDI,0xd94                       ; 00533f65
    PUSH 0x63afda                       ; 00533f6a | = "huffman decodertable error at table %..." | s_huffman_decodertable_err_0063afda = huffman decodertable error at table %d.  File: %s
    MOV dword ptr [0x02f0ca48],ESI      ; 00533f6f | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 00533f75 | int g_CurrentLineNumber
    JMP 0x00533e4e                      ; 00533f7b | LAB_00533e4e
