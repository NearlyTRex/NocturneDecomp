// Name: sound_snddx.cpp_FUN_005ae270
// Address: 005ae270
// Address Range: [[005ae270, 005ae33c]]
// Convention: unknown
// Signature: undefined sound_snddx.cpp_FUN_005ae270()
// Cross-references:
...
/* Signature: undefined1 sound_snddx.cpp_FUN_005ae270(undefined4 param_1) */

bool sound_snddx_cpp_FUN_005ae270(void)

{
  ...
  if (DAT_03f6a9b4 != (int *)0x0) {
    (**(code **)(*DAT_03f6a9b4 + 8))();
    DAT_03f6a9b4 = (int *)0x0;
  }
  if (DAT_03f6a9b0 == (int *)0x0) {
    return iVar1 != 0;
  }
  (**(code **)(*DAT_03f6a9b0 + 8))();
  DAT_03f6a9b0 = (int *)0x0;
  return iVar1 != 0;
}
...
// Assembly code:
// 005ae270: PUSH EBX
//   Label: sound_snddx.cpp_FUN_005ae270
// 005ae271: PUSH ESI
// 005ae272: PUSH EDI
// 005ae273: PUSH EBP
