// Name: sound_snddx.cpp_waveOutWrite_FUN_005b06c0
// Address: 005b06c0
// Address Range: [[005b06c0, 005b0838]]
// Convention: unknown
// Signature: undefined sound_snddx.cpp_waveOutWrite_FUN_005b06c0()
// Cross-references:
//   sound_snddx.cpp_FUN_005b08f0 (005b08f0) at 005b0957 [UNCONDITIONAL_CALL]
//   sound_snddx.cpp_WavOutDevice_poll_FUN_005b0c10 (005b0c10) at 005b0c67 [UNCONDITIONAL_CALL]
// Globals:
//   waveOutPrepareHeader* PTR_waveOutPrepareHeader_0061144c = 00211952
//   waveOutUnprepareHeader* PTR_waveOutUnprepareHeader_00611454 = 0021197a
//   waveOutWrite* PTR_waveOutWrite_00611458 = 00211994
...
/* Signature: undefined1 sound_snddx.cpp_waveOutWrite(undefined4 param_1) */

undefined4 sound_snddx_cpp_waveOutWrite_FUN_005b06c0(void)

{
  ...
  if (((&DAT_03f6ad98)[in_stack_00000004] == 0) ||
     ((LPWAVEHDR)(&DAT_03f6ad58)[in_stack_00000004] == (LPWAVEHDR)0x0)) {
    return 0;
  }
  ...
  iVar4 = (int)((DAT_03f6adb8 + (DAT_03f6adb8 >> 0x1f) * -8) -
               (uint)((DAT_03f6adb8 >> 0x1f) << 2 < 0)) >> 3;
  iVar7 = 0;
  iVar8 = DAT_03f6adbc * 4;
  if (0 < iVar8) {
    iVar2 = (&DAT_03f6ad98)[in_stack_00000004];
    iVar6 = 0;
    do {
      iVar5 = iVar6 + 4;
      iVar1 = iVar2 + iVar7;
  ...
  sound_sndmain_cpp_SfxSlot_kill_2_FUN_005aca90
            (&stack0xffffffdc,iVar7,iVar8,DAT_03f6adb8,&stack0xffffffdc,DAT_03f6adb8,DAT_03f6adbc,
             DAT_03f6adc0,DAT_03f6adc4,iVar4 * DAT_03f6adbc);
  *(int *)(*(int *)((int)&DAT_03f6ad58 + unaff_retaddr) + 4) =
       ((int)((DAT_03f6adb8 + (DAT_03f6adb8 >> 0x1f) * -8) - (uint)((DAT_03f6adb8 >> 0x1f) << 2 < 0)
             ) >> 3) * DAT_03f6adc4 * DAT_03f6adbc;
  MVar3 = (*PTR_waveOutPrepareHeader_0061144c)
...
// Assembly code:
// 005b06c0: PUSH EBX
//   Label: sound_snddx.cpp_waveOutWrite_FUN_005b06c0
// 005b06c1: PUSH ESI
// 005b06c2: PUSH EDI
// 005b06c3: PUSH EBP
...
// 005b0773: PUSH EAX
// 005b0774: CALL sound_sndmain.cpp_SfxSlot_kill_2_FUN_005aca90
