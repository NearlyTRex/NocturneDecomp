// Name: sound_snddx.cpp_DirectSoundDevice_lockSample_FUN_005af220
// Address: 005af220
// Address Range: [[005af220, 005af31b]]
// Convention: unknown
// Signature: undefined sound_snddx.cpp_DirectSoundDevice_lockSample_FUN_005af220()
// Globals:
...
/* Signature: undefined1 sound_snddx.cpp_DirectSoundDevice_lockSample(undefined1 param_1, undefined4
   param_2, undefined4 param_3, undefined4 param_4) */

undefined4 sound_snddx_cpp_DirectSoundDevice_lockSample_FUN_005af220(void)

{
  ...
  iVar3 = in_stack_00000008 * 0x14;
  if (*(int *)(&DAT_03f6ab40 + iVar3) != 0) {
    g_CurrentFilename = "..\\sound\\snddx.cpp";
    g_CurrentLineNumber = 0x2c4;
    puStack_1a4 = (undefined *)0x5af299;
    core_main_c_displayErrorAndQuit_FUN_00506f10("DirectSoundDevice::lockSample - already locked!");
  }
  piStack_1bc = (int *)(&DAT_03f6a9e0)[in_stack_00000008];
  puStack_1a4 = &DAT_03f6ab4c + iVar3;
  puStack_1a8 = &DAT_03f6ab44 + iVar3;
  puStack_1ac = &DAT_03f6ab48 + iVar3;
  puStack_1b0 = &DAT_03f6ab40 + iVar3;
  iStack_1b4 = in_stack_00000010 * *(int *)(&DAT_03f6ab3c + iVar3);
  iStack_1b8 = in_stack_0000000c * *(int *)(&DAT_03f6ab3c + iVar3);
  iVar1 = (**(code **)(*piStack_1bc + 0x2c))();
  if (iVar1 == 0) {
    return *(undefined4 *)(&DAT_03f6ab40 + iVar3);
  }
...
// Assembly code:
// 005af220: PUSH EBX
//   Label: sound_snddx.cpp_DirectSoundDevice_lockSample_FUN_005af220
// 005af221: PUSH ESI
// 005af222: PUSH EBP
...
// 005af307: PUSH EAX
// 005af308: CALL sound_sndmain.cpp_HandleSoundError_FUN_005adba0
