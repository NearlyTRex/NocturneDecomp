// Name: sound_snddx.cpp_DirectSoundDevice_freeSample_FUN_005af190
// Address: 005af190
// Address Range: [[005af190, 005af21c]]
// Convention: unknown
// Signature: undefined sound_snddx.cpp_DirectSoundDevice_freeSample_FUN_005af190()
// Globals:
...
/* Signature: undefined1 sound_snddx.cpp_DirectSoundDevice_freeSample(undefined1 param_1, undefined4
   param_2) */

void sound_snddx_cpp_DirectSoundDevice_freeSample_FUN_005af190(void)

{
  ...
  if ((((in_stack_00000008 < 1) || (0x18 < in_stack_00000008)) ||
    ...
    core_main_c_displayErrorAndQuit_FUN_00506f10
              ("DirectSoundDevice::freeSample - Invalid handle: %d",in_stack_00000008);
  }
  piVar1 = (int *)(&DAT_03f6a9e0)[in_stack_00000008];
  if (piVar1 != (int *)0x0) {
    (**(code **)(*piVar1 + 8))();
    (&DAT_03f6a9e0)[in_stack_00000008] = 0;
  }
  *(undefined4 *)(&DAT_03f6ab3c + in_stack_00000008 * 0x14) = 0;
  return;
}
...
// Assembly code:
// 005af190: PUSH EBX
//   Label: sound_snddx.cpp_DirectSoundDevice_freeSample_FUN_005af190
// 005af191: PUSH ESI
// 005af192: PUSH EBP
