// Name: sound_snddx.cpp_FUN_005aef40
// Address: 005aef40
...
/* Signature: undefined1 sound_snddx.cpp_FUN_005aef40(undefined1 param_1, undefined4 param_2,
   undefined4 param_3, undefined4 param_4, undefined4 param_5) */

int sound_snddx_cpp_FUN_005aef40
  ...
  if (DAT_03f6a9b0 != (int *)0x0) {
    ...
    if (DAT_03f6a9e4 != 0) {
      do {
        iVar5 = iVar5 + 1;
        if (99 < iVar2 + 4) break;
        piVar1 = (int *)((int)&DAT_03f6a9e4 + iVar2);
        iVar2 = iVar2 + 4;
      } while (*piVar1 != 0);
    }
    if (iVar5 < 0x19) {
      piStack_1d8 = (int *)0x5aefa3;
      crt_memory_c_memset_FUN_005fde40(&local_24,0,0x12);
      local_24 = 1;
      local_22 = (short)param_7;
      local_20 = param_8;
      iVar2 = (int)((param_6 + (param_6 >> 0x1f) * -8) - (uint)((param_6 >> 0x1f) << 2 < 0)) >> 3;
      local_18 = (short)iVar2 * local_22;
      local_1c = param_8 * (uint)local_18;
      local_16 = (undefined2)param_6;
      piStack_1d8 = (int *)0x5af02a;
      crt_memory_c_memset_FUN_005fde40(&local_38,0,0x14);
      local_28 = &local_24;
      local_30 = param_7 * param_9 * iVar2;
      local_38 = 0x14;
      local_34 = 0xb0;
      piStack_1d8 = DAT_03f6a9b0;
      iVar3 = (**(code **)(*DAT_03f6a9b0 + 0xc))();
      if (iVar3 == 0) {
        if ((&DAT_03f6a9e0)[iVar5] != 0) {
          *(undefined4 *)(&DAT_03f6ab40 + iVar5 * 0x14) = 0;
          *(int *)(&DAT_03f6ab3c + iVar5 * 0x14) = unaff_EBX * iVar2;
          return iVar5;
        }
      }
      else {
      ...
      sound_sndmain_cpp_HandleSoundError_FUN_005adba0();
      piVar1 = (int *)(&DAT_03f6a9e0)[iVar5];
      if (piVar1 != (int *)0x0) {
        (**(code **)(*piVar1 + 8))();
        (&DAT_03f6a9e0)[iVar5] = 0;
      }
      *(undefined4 *)(&DAT_03f6ab3c + iVar5 * 0x14) = 0;
      return 0;
    }
  }
  return 0;
...
// Assembly code:
// 005aef40: PUSH EBX
//   Label: sound_snddx.cpp_FUN_005aef40
// 005aef41: PUSH ESI
// 005aef42: PUSH EDI
// 005aef43: PUSH EBP
...
//   XREF to: 03f6a9e0 (DATA)
// 005af0b5: CALL sound_sndmain.cpp_HandleSoundError_FUN_005adba0
...
// 005af111: PUSH EAX
// 005af112: CALL sound_sndmain.cpp_HandleSoundError_FUN_005adba0
//   XREF to: 005adba0 (UNCONDITIONAL_CALL)
