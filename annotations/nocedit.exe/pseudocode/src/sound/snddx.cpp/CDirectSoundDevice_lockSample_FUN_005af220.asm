...
section .text
    ...
    CMP dword ptr [EBX + 0x4],0x0       ; 005af274 | g_DirectSoundBufferMetadata[0].pvLockedAudio1
    ...
    MOV EAX,dword ptr [EBX + 0x4]       ; 005af2d7 | g_DirectSoundBufferMetadata[0].pvLockedAudio1
    ...
    PUSH EAX                            ; 005af2fc
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 005af2fd
