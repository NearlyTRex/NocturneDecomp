...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl sound_snddx_cpp_CDirectSoundDevice_allocateSfx_FUN_005af410 (CDirectSoundDevice *this_ptr,int sample_buffer_id)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 005af619
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005af61a
    ...
    PUSH EAX                            ; 005af652
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005af653
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH EAX                            ; 005af688
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005af689
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH EAX                            ; 005af6f4
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005af6f5
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
