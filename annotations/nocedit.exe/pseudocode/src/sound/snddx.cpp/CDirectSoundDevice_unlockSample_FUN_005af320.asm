...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl sound_snddx_cpp_CDirectSoundDevice_unlockSample_FUN_005af320 (CDirectSoundDevice *this_ptr,int buffer_id)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 005af3b2
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005af3b3
