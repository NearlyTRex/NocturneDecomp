// Name: sound_snddx.cpp_WavInDevice_setMode_FUN_005b0f70
// Address: 005b0f70
// Address Range: [[005b0f70, 005b12d0]]
// Convention: unknown
// Signature: undefined sound_snddx.cpp_WavInDevice_setMode_FUN_005b0f70()
// Globals:
...
/* Signature: undefined1 sound_snddx.cpp_WavInDevice_setMode(undefined4 param_1) */

undefined4 sound_snddx_cpp_WavInDevice_setMode_FUN_005b0f70(void)

{
  ...
  tagWAVEINCAPSA tStack_58;
  WAVEFORMATEX WStack_28;
  int iStack_14;
  
  iVar2 = (**(code **)*in_stack_00000004)();
  if (iVar2 == 0) {
    return 0;
  }
  MVar3 = (*waveInGetDevCapsA)(DAT_00681e08,&tStack_58,0x30);
  if (MVar3 != 0) {
    return 0;
  }
  DAT_03f6af30 = in_stack_00000010;
  DAT_03f6af34 = (uint)(in_stack_00000014 != 0);
  WStack_28._16_4_ = tStack_58.dwFormats;
  do {
    uVar8 = 99999;
    iVar2 = 0;
    iVar7 = 0;
    iStack_14 = -1;
    do {
      if ((*(uint *)((int)&DAT_00681e0c + iVar7) & WStack_28._16_4_) != 0) {
        uVar4 = (uint)(in_stack_00000008 < *(int *)((int)&DAT_00681e10 + iVar7));
        if (*(int *)((int)&DAT_00681e10 + iVar7) < in_stack_00000008) {
          uVar4 = uVar4 + 2;
        }
        if ((int)DAT_03f6af30 < *(int *)((int)&DAT_00681e18 + iVar7)) {
          uVar4 = uVar4 + 1;
        }
        if (*(int *)((int)&DAT_00681e18 + iVar7) < (int)DAT_03f6af30) {
          uVar4 = uVar4 + 2;
        }
        if (in_stack_0000000c < *(int *)((int)&DAT_00681e14 + iVar7)) {
          uVar4 = uVar4 + 2;
        }
        if (*(int *)((int)&DAT_00681e14 + iVar7) < in_stack_0000000c) {
          uVar4 = uVar4 + 3;
        }
        if (uVar4 < uVar8) {
          uVar8 = uVar4;
    ...
    DAT_03f6af14 = (&DAT_00681e14)[iStack_14 * 4];
    DAT_03f6af18 = (&DAT_00681e18)[iStack_14 * 4];
    _DAT_03f6af1c = (uint)(DAT_03f6af10 == 8);
    DAT_03f6af20 = DAT_03f6af18 / 0x14;
    DAT_03f6af24 = (DAT_03f6af18 * 2) / DAT_03f6af20;
    if (0x14 < DAT_03f6af24) {
      DAT_03f6af24 = 0x14;
    }
    iVar2 = 0;
    if (0 < DAT_03f6af24) {
      ...
      do {
        ...
        *(LPVOID *)((int)&DAT_03f6aec0 + iVar7) = pvVar6;
        if (pvVar6 == (LPVOID)0x0) break;
        pvVar5 = (*GlobalAlloc)(0x2002,0x20);
        *(HGLOBAL *)((int)&DAT_03f6add0 + iVar7) = pvVar5;
        if (pvVar5 == (HGLOBAL)0x0) break;
        iVar2 = iVar2 + 1;
        pvVar6 = (*GlobalLock)(*(HGLOBAL *)((int)&DAT_03f6add0 + iVar7));
        iVar1 = DAT_03f6af24;
        *(LPVOID *)((int)&DAT_03f6ae20 + iVar7) = pvVar6;
        iVar7 = iVar7 + 4;
      } while (iVar2 < iVar1);
    }
    ...
    WStack_28._16_4_ = WStack_28._16_4_ & ~(&DAT_00681e0c)[iStack_14 * 4];
    in_stack_00000008 = DAT_03f6af28;
    in_stack_0000000c = DAT_03f6af2c;
  } while( true );
}
...
// Assembly code:
// 005b0f70: PUSH EBX
//   Label: sound_snddx.cpp_WavInDevice_setMode_FUN_005b0f70
// 005b0f71: PUSH ESI
// 005b0f72: PUSH EDI
// 005b0f73: PUSH EBP
