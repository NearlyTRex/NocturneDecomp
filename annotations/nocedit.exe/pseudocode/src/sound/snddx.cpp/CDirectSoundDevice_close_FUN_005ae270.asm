...
;                               FUNCTION
; *****************************************************************************
; __cdecl int sound_snddx.cpp_CDirectSoundDevice_close_FUN_005ae270(CDirectSoundDevice * this_ptr)
;
; Parameters:
...
section .text
    ...
    JZ 0x005ae321                       ; 005ae288 | LAB_005ae321
        ;   XREF to: 005ae321 (CONDITIONAL_JUMP)
    MOV EBX,0x3f6a9e0                   ; 005ae28e | IDirectSoundBuffer *[25] g_DirectSoundSampleBuffers
        ;   Label: LAB_005ae28e
    LEA ESI,[EBX + 0x64]                ; 005ae293 | IDirectSoundBuffer *[31] g_DirectSoundHardwareSfxBuffers
    MOV EDX,dword ptr [EBX]             ; 005ae296 | IDirectSoundBuffer *[25] g_DirectSoundSampleBuffers
        ;   Label: LAB_005ae296
    TEST EDX,EDX                        ; 005ae298
    JZ 0x005ae2aa                       ; 005ae29a | LAB_005ae2aa
        ;   XREF to: 005ae2aa (CONDITIONAL_JUMP)
    MOV EAX,EDX                         ; 005ae29c
    PUSH EAX                            ; 005ae29e
    MOV EDX,dword ptr [EDX]             ; 005ae29f
    CALL dword ptr [EDX + 0x8]          ; 005ae2a1
    MOV dword ptr [EBX],0x0             ; 005ae2a4 | IDirectSoundBuffer *[25] g_DirectSoundSampleBuffers
    ADD EBX,0x4                         ; 005ae2aa
        ;   Label: LAB_005ae2aa
    CMP EBX,ESI                         ; 005ae2ad
    JNZ 0x005ae296                      ; 005ae2af | LAB_005ae296
        ;   XREF to: 005ae296 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x03f6a9bc]      ; 005ae2b1 | IDirectSound3DListener * g_DirectSound3DListener
    TEST ECX,ECX                        ; 005ae2b7
    JZ 0x005ae2c9                       ; 005ae2b9 | LAB_005ae2c9
        ;   XREF to: 005ae2c9 (CONDITIONAL_JUMP)
    PUSH ECX                            ; 005ae2bb
    MOV EDX,dword ptr [ECX]             ; 005ae2bc
    XOR EBX,ESI                         ; 005ae2be
    CALL dword ptr [EDX + 0x8]          ; 005ae2c0
    MOV dword ptr [0x03f6a9bc],EBX      ; 005ae2c3 | IDirectSound3DListener * g_DirectSound3DListener
    MOV ESI,dword ptr [0x03f6a9b8]      ; 005ae2c9 | IDirectSoundBuffer * g_DirectSoundSecondaryBuffer
        ;   Label: LAB_005ae2c9
    TEST ESI,ESI                        ; 005ae2cf
    JZ 0x005ae2e1                       ; 005ae2d1 | LAB_005ae2e1
        ;   XREF to: 005ae2e1 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 005ae2d3
    MOV EDX,dword ptr [ESI]             ; 005ae2d4
    XOR EBP,EBP                         ; 005ae2d6
    CALL dword ptr [EDX + 0x8]          ; 005ae2d8
    MOV dword ptr [0x03f6a9b8],EBP      ; 005ae2db | IDirectSoundBuffer * g_DirectSoundSecondaryBuffer
    MOV EAX,[0x03f6a9c0]                ; 005ae2e1 | IKsPropertySet * g_DirectSoundPropertySet
        ;   Label: LAB_005ae2e1
    TEST EAX,EAX                        ; 005ae2e6
    JZ 0x005ae2f8                       ; 005ae2e8 | LAB_005ae2f8
        ;   XREF to: 005ae2f8 (CONDITIONAL_JUMP)
    PUSH EAX                            ; 005ae2ea
    MOV EDX,dword ptr [EAX]             ; 005ae2eb
    CALL dword ptr [EDX + 0x8]          ; 005ae2ed
    XOR EDX,EDX                         ; 005ae2f0
    MOV dword ptr [0x03f6a9c0],EDX      ; 005ae2f2 | IKsPropertySet * g_DirectSoundPropertySet
    MOV ECX,dword ptr [0x03f6a9b4]      ; 005ae2f8 | IDirectSoundBuffer * g_DirectSoundPrimaryBuffer
        ;   Label: LAB_005ae2f8
    TEST ECX,ECX                        ; 005ae2fe
    JZ 0x005ae310                       ; 005ae300 | LAB_005ae310
        ;   XREF to: 005ae310 (CONDITIONAL_JUMP)
    PUSH ECX                            ; 005ae302
    MOV EDX,dword ptr [ECX]             ; 005ae303
    XOR EBX,EBX                         ; 005ae305
    CALL dword ptr [EDX + 0x8]          ; 005ae307
    MOV dword ptr [0x03f6a9b4],EBX      ; 005ae30a | IDirectSoundBuffer * g_DirectSoundPrimaryBuffer
    MOV ESI,dword ptr [0x03f6a9b0]      ; 005ae310 | IDirectSound * g_DirectSound
        ;   Label: LAB_005ae310
    TEST ESI,ESI                        ; 005ae316
    JNZ 0x005ae328                      ; 005ae318 | LAB_005ae328
    ...
    XOR EDI,EDI                         ; 005ae321
        ;   Label: LAB_005ae321
    JMP 0x005ae28e                      ; 005ae323 | LAB_005ae28e
    ...
    MOV dword ptr [0x03f6a9b0],EBP      ; 005ae330 | IDirectSound * g_DirectSound
