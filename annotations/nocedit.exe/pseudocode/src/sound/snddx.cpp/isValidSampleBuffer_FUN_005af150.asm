...
;                               FUNCTION
; *****************************************************************************
; __cdecl int sound_snddx.cpp_isValidSampleBuffer_FUN_005af150(int buffer_id)
;
; Parameters:
...
section .text
    ...
    JLE 0x005af17a                      ; 005af156 | LAB_005af17a
        ;   XREF to: 005af17a (CONDITIONAL_JUMP)
    CMP EDX,0x19                        ; 005af158
    JGE 0x005af17a                      ; 005af15b | LAB_005af17a
        ;   XREF to: 005af17a (CONDITIONAL_JUMP)
    CMP dword ptr [EDX*0x4 + 0x3f6a9e0],0x0 ; 005af15d | IDirectSoundBuffer *[25] g_DirectSoundSampleBuffers
    JZ 0x005af17a                       ; 005af165 | LAB_005af17a
        ;   XREF to: 005af17a (CONDITIONAL_JUMP)
    LEA EAX,[EDX*0x4 + 0x0]             ; 005af167
    ADD EAX,EDX                         ; 005af16e
    CMP dword ptr [EAX*0x4 + 0x3f6ab3c],0x1 ; 005af170 | IDirectSoundBufferMetadata[25] g_DirectSoundBufferMetadata
    JGE 0x005af17d                      ; 005af178 | LAB_005af17d
