...
;                               FUNCTION
; *****************************************************************************
; __cdecl CDirectSoundDevice * __cdecl sound_snddx_cpp_getDirectSoundDevice_FUN_005b0440(UINT device_id)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 005b04d1
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 005b04d2
    ...
    PUSH EAX                            ; 005b05c7
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 005b05c8
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c__sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH EAX                            ; 005b05f4
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 005b05f5
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c__sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH EAX                            ; 005b0656
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 005b0657
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c__sprintf_FUN_005fdbd0(char * buffer, char * format)
