// Name: sound_snddx.cpp_CDirectSoundDevice_FUN_005ae340
// Address: 005ae340
// Address Range: [[005ae340, 005ae4a1]]
// Convention: __cdecl
// Signature: int sound_snddx.cpp_CDirectSoundDevice_FUN_005ae340(CDirectSoundDevice * this_ptr)
// Globals:
...
int __cdecl sound_snddx_cpp_CDirectSoundDevice_FUN_005ae340(CDirectSoundDevice *this_ptr)

{
  ...
  if (iVar3 != 0) {
    ...
    sound_sndmain_cpp_logSoundError_FUN_005adba0(pcVar2);
  }
LAB_005ae43b:
  (*(code *)this_ptr->vtable->func3)();
  return 0;
}
...
// Assembly code:
// 005ae340: PUSH EBX
//   Label: sound_snddx.cpp_CDirectSoundDevice_FUN_005ae340
// 005ae341: PUSH ESI
// 005ae342: PUSH EDI
// 005ae343: PUSH EBP
