// Name: sound_snddx.cpp_DirectSoundDevice_allocateSfx_FUN_005af410
// Address: 005af410
// Address Range: [[005af410, 005af711]]
// Convention: unknown
// Signature: undefined sound_snddx.cpp_DirectSoundDevice_allocateSfx_FUN_005af410()
// Globals:
...
/* Signature: undefined1 sound_snddx.cpp_DirectSoundDevice_allocateSfx(undefined1 param_1,
   undefined4 param_2) */

int sound_snddx_cpp_DirectSoundDevice_allocateSfx_FUN_005af410(void)

{
  ...
  while (iVar3 != 0) {
    ...
    iVar3 = *(int *)((int)&DAT_03f6aa48 + iVar2);
    iVar2 = iVar2 + 4;
  }
  if (0x1e < iVar5) {
  ...
  if (((int *)(&DAT_03f6aa44)[iVar5] == (int *)0x0) ||
    ...
    piVar1 = (int *)(&DAT_03f6aac0)[iVar5];
    if (piVar1 != (int *)0x0) {
      (**(code **)(*piVar1 + 8))();
      (&DAT_03f6aac0)[iVar5] = 0;
    }
      ...
      if (iVar3 == 0) {
        ...
        crt_stdio_c_sprintf_FUN_005fdbd0
                  (acStack_33c,"DirectSux: Unable to %s.  (%s)",
                   "get DirectSound3DBuffer interface from sfx secondary buffer",uVar4);
        sound_sndmain_cpp_HandleSoundError_FUN_005adba0();
      }
    }
  }
...
// Assembly code:
// 005af410: PUSH EBX
//   Label: sound_snddx.cpp_DirectSoundDevice_allocateSfx_FUN_005af410
// 005af411: PUSH ESI
// 005af412: PUSH EDI
// 005af413: PUSH EBP
...
// 005af629: PUSH EAX
// 005af62a: CALL sound_sndmain.cpp_HandleSoundError_FUN_005adba0
...
// 005af662: PUSH EAX
// 005af663: CALL sound_sndmain.cpp_HandleSoundError_FUN_005adba0
//   XREF to: 005adba0 (UNCONDITIONAL_CALL)
...
// 005af693: PUSH EAX
// 005af694: CALL sound_sndmain.cpp_HandleSoundError_FUN_005adba0
//   XREF to: 005adba0 (UNCONDITIONAL_CALL)
...
// 005af704: PUSH EAX
// 005af705: CALL sound_sndmain.cpp_HandleSoundError_FUN_005adba0
//   XREF to: 005adba0 (UNCONDITIONAL_CALL)
