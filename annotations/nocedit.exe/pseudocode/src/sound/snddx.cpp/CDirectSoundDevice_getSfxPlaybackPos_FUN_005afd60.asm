...
section .text
    ...
    JLE 0x005afd82                      ; 005afd77 | LAB_005afd82
        ;   XREF to: 005afd82 (CONDITIONAL_JUMP)
    CMP EBX,0x1f                        ; 005afd79
    JL 0x005afe0a                       ; 005afd7c | LAB_005afe0a
        ;   XREF to: 005afe0a (CONDITIONAL_JUMP)
    MOV ESI,0x6520a3                    ; 005afd82 | = "..\\sound\\snddx.cpp" | s_sound_snddx_cpp_006520a3 = ..\sound\snddx.cpp
        ;   Label: LAB_005afd82
    MOV EDI,0x3d6                       ; 005afd87
    PUSH 0x6520b6                       ; 005afd8c | = "DirectSoundDevice::getSfxPlaybackPos ..." | s_DirectSoundDevice_getSfx_006520b6 = DirectSoundDevice::getSfxPlaybackPos - invalid handle
    MOV dword ptr [0x02f0ca48],ESI      ; 005afd91 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 005afd97 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005afd9d | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    MOV EAX,dword ptr [EBX*0x4 + 0x3f6aa44] ; 005afdb4 | IDirectSoundBuffer *[31] g_DirectSoundHardwareSfxBuffers
    PUSH EDX                            ; 005afdbb
    MOV EBX,dword ptr [EAX]             ; 005afdbc
    PUSH EAX                            ; 005afdbe
    CALL dword ptr [EBX + 0x10]         ; 005afdbf
    TEST EAX,EAX                        ; 005afdc2
    JNZ 0x005afe30                      ; 005afdc4 | LAB_005afe30
        ;   XREF to: 005afe30 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + 0x18]      ; 005afdc6
    MOV ECX,dword ptr [EAX + 0x78]      ; 005afdc9
    PUSH ECX                            ; 005afdcc
    CALL sound_sndmain.cpp_CSfxSample_getBytesPerFrame_FUN_005a8550 ; 005afdcd | int sound_sndmain.cpp_CSfxSample_getBytesPerFrame_FUN_005a8550(CSfxSample * this_ptr)
    ...
    LEA EAX,[EBX*0x4 + 0x0]             ; 005afe0a
        ;   Label: LAB_005afe0a
    CMP dword ptr [EAX + 0x3f6aa44],0x0 ; 005afe11 | IDirectSoundBuffer *[31] g_DirectSoundHardwareSfxBuffers
    JZ 0x005afd82                       ; 005afe18 | LAB_005afd82
        ;   XREF to: 005afd82 (CONDITIONAL_JUMP)
    CMP dword ptr [EAX + 0x3f6aac0],0x0 ; 005afe1e | IDirectSound3DBuffer *[31] g_DirectSound3DBufferInterfaces
    JZ 0x005afd82                       ; 005afe25 | LAB_005afd82
        ;   XREF to: 005afd82 (CONDITIONAL_JUMP)
    JMP 0x005afda5                      ; 005afe2b | LAB_005afda5
        ;   XREF to: 005afda5 (UNCONDITIONAL_JUMP)
    PUSH EAX                            ; 005afe30
        ;   Label: LAB_005afe30
    CALL sound_snddx.cpp_getDirectSoundErrorString_FUN_005ade70 ; 005afe31 | char * sound_snddx.cpp_getDirectSoundErrorString_FUN_005ade70(uint error_code)
        ;   XREF to: 005ade70 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005afe36
    PUSH EAX                            ; 005afe39
    PUSH 0x6520ec                       ; 005afe3a | = "Get playback cursor of hardware sfx s..." | s_Get_playback_cursor_of_h_006520ec = Get playback cursor of hardware sfx secondary buffer
    PUSH 0x651a6c                       ; 005afe3f | = "DirectSux: Unable to %s.  (%s)" | s_DirectSux_Unable_to_s_s_00651a6c = DirectSux: Unable to %s.  (%s)
    LEA EAX,[ESP + 0x14]                ; 005afe44
    PUSH EAX                            ; 005afe48
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005afe49 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 005afe4e
    LEA EAX,[ESP + 0x8]                 ; 005afe51
    PUSH EAX                            ; 005afe55
    CALL sound_sndmain.cpp_logSoundError_FUN_005adba0 ; 005afe56 | void sound_sndmain.cpp_logSoundError_FUN_005adba0(char * format)
