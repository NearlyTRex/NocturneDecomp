...
;                               FUNCTION
; *****************************************************************************
; __cdecl void sound_snddx.cpp_CDirectSoundDevice_initPropertySet_FUN_005ae660(CDirectSoundDevice * this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [0x03f6a9c0]      ; 005ae66a | IKsPropertySet * g_DirectSoundPropertySet
    TEST EDX,EDX                        ; 005ae670
    JZ 0x005ae684                       ; 005ae672 | LAB_005ae684
    ...
    MOV dword ptr [0x03f6a9c0],ECX      ; 005ae67e | IKsPropertySet * g_DirectSoundPropertySet
    PUSH 0x12                           ; 005ae684
        ;   Label: LAB_005ae684
    ...
    CALL crt_memory.c_memset_FUN_005fde40 ; 005ae6ae | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
    ...
    CALL crt_memory.c_memset_FUN_005fde40 ; 005ae6f9 | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
        ;   XREF to: 005fde40 (UNCONDITIONAL_CALL)
    ...
    MOV EAX,[0x03f6a9b0]                ; 005ae73c | IDirectSound * g_DirectSound
    ...
    PUSH EAX                            ; 005ae794
        ;   Label: LAB_005ae794
    CALL sound_snddx.cpp_getDirectSoundErrorString_FUN_005ade70 ; 005ae795 | char * sound_snddx.cpp_getDirectSoundErrorString_FUN_005ade70(uint error_code)
        ;   XREF to: 005ade70 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005ae79a
    PUSH EAX                            ; 005ae79d
    PUSH 0x651b5a                       ; 005ae79e | = "Create temp secondary buffer for prop..." | s_Create_temp_secondary_bu_00651b5a = Create temp secondary buffer for property set creation
    PUSH 0x651a6c                       ; 005ae7a3 | = "DirectSux: Unable to %s.  (%s)" | s_DirectSux_Unable_to_s_s_00651a6c = DirectSux: Unable to %s.  (%s)
    LEA EAX,[ESP + 0xc]                 ; 005ae7a8
    PUSH EAX                            ; 005ae7ac
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005ae7ad | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 005ae7b2
    MOV EAX,ESP                         ; 005ae7b5
    PUSH EAX                            ; 005ae7b7
    CALL sound_sndmain.cpp_logSoundError_FUN_005adba0 ; 005ae7b8 | void sound_sndmain.cpp_logSoundError_FUN_005adba0(char * format)
        ;   XREF to: 005adba0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005ae7bd
    JMP 0x005ae789                      ; 005ae7c0 | LAB_005ae789
    ...
    JMP 0x005ae789                      ; 005ae7d0 | LAB_005ae789
        ;   XREF to: 005ae789 (UNCONDITIONAL_JUMP)
    PUSH 0x3f6a9c0                      ; 005ae7d2 | IKsPropertySet * g_DirectSoundPropertySet
        ;   Label: LAB_005ae7d2
    PUSH 0x681dd0                       ; 005ae7d7 | GUID g_IID_IKsPropertySet
    MOV EAX,dword ptr [ESI]             ; 005ae7dc
    PUSH ESI                            ; 005ae7de
    CALL dword ptr [EAX]                ; 005ae7df
    MOV EBP,dword ptr [ESP + 0x1b8]     ; 005ae7e1
    TEST EBP,EBP                        ; 005ae7e8
    JZ 0x005ae7fc                       ; 005ae7ea | LAB_005ae7fc
    ...
    JZ 0x005ae789                       ; 005ae805 | LAB_005ae789
