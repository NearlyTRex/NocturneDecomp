...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl sound_snddx_cpp_CDirectSoundDevice_initPropertySet_FUN_005ae660(CDirectSoundDevice *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 005ae7ac
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005ae7ad
