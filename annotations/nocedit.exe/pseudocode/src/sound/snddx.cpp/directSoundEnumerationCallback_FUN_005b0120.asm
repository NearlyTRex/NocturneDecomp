...
section .text
    ...
    CMP dword ptr [0x00681e00],0xc      ; 005b0130 | int g_DirectSoundDeviceCount
    JL 0x005b0147                       ; 005b0137 | LAB_005b0147
    ...
    CALL crt_dsound.c_DirectSoundCreate ; 005b015a | HRESULT crt_dsound.c_DirectSoundCreate(LPGUID lpGuid, LPDIRECTSOUND * ppDS, LPUNKNOWN pUnkOuter)
        ;   XREF to: 00610f40 (UNCONDITIONAL_CALL)
    TEST EAX,EAX                        ; 005b015f
    JNZ 0x005b017e                      ; 005b0161 | LAB_005b017e
        ;   XREF to: 005b017e (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x380],0x0     ; 005b0163
    JNZ 0x005b01c3                      ; 005b016b | LAB_005b01c3
    ...
    PUSH EAX                            ; 005b017e
        ;   Label: LAB_005b017e
    CALL sound_snddx.cpp_getDirectSoundErrorString_FUN_005ade70 ; 005b017f | char * sound_snddx.cpp_getDirectSoundErrorString_FUN_005ade70(uint error_code)
        ;   XREF to: 005ade70 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005b0184
    PUSH EAX                            ; 005b0187
    PUSH 0x652271                       ; 005b0188 | = "create DirectSound object" | s_create_DirectSound_objec_00652271 = create DirectSound object
    PUSH 0x651a6c                       ; 005b018d | = "DirectSux: Unable to %s.  (%s)" | s_DirectSux_Unable_to_s_s_00651a6c = DirectSux: Unable to %s.  (%s)
    LEA EAX,[ESP + 0x19c]               ; 005b0192
    PUSH EAX                            ; 005b0199
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005b019a | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 005b019f
    LEA EAX,[ESP + 0x190]               ; 005b01a2
    PUSH EAX                            ; 005b01a9
    CALL sound_sndmain.cpp_logSoundError_FUN_005adba0 ; 005b01aa | void sound_sndmain.cpp_logSoundError_FUN_005adba0(char * format)
    ...
    PUSH EAX                            ; 005b01cd
    CALL crt_memory.c_memset_FUN_005fde40 ; 005b01ce | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
    ...
    JNZ 0x005b02fd                      ; 005b0200 | LAB_005b02fd
    ...
    JZ 0x005b022e                       ; 005b0216 | LAB_005b022e
    ...
    TEST EDI,EDI                        ; 005b022e
        ;   Label: LAB_005b022e
    JZ 0x005b016d                       ; 005b0230 | LAB_005b016d
        ;   XREF to: 005b016d (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x00681e00]      ; 005b0236 | int g_DirectSoundDeviceCount
    ...
    JZ 0x005b0330                       ; 005b024f | LAB_005b0330
    ...
    TEST byte ptr [ESP + 0x324],0x20    ; 005b0269
        ;   Label: LAB_005b0269
    SETNZ AL                            ; 005b0271
    MOV EDX,dword ptr [0x00681e00]      ; 005b0274 | int g_DirectSoundDeviceCount
    ...
    MOV dword ptr [EAX*0x4 + 0x3f69d74],ESI ; 005b0292 | int isRecordingStarted
    ...
    MOV dword ptr [EAX + 0x3f69d78],ESI ; 005b02b7 | int g_RecordingSamplesSigned
    ADD EAX,0x3f69c60                   ; 005b02bd | SDirectSoundDeviceInfo[8] g_DirectSoundDevices
    ...
    MOV AL,byte ptr [ESI]               ; 005b02cd
        ;   Label: LAB_005b02cd
    MOV byte ptr [EDI],AL               ; 005b02cf | DAT_03f69b58
    CMP AL,0x0                          ; 005b02d1
    JZ 0x005b02e5                       ; 005b02d3 | LAB_005b02e5
        ;   XREF to: 005b02e5 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 005b02d5
    ADD ESI,0x2                         ; 005b02d8
    MOV byte ptr [EDI + 0x1],AL         ; 005b02db | DAT_03f69b59
    ADD EDI,0x2                         ; 005b02de
    CMP AL,0x0                          ; 005b02e1
    JNZ 0x005b02cd                      ; 005b02e3 | LAB_005b02cd
        ;   XREF to: 005b02cd (CONDITIONAL_JUMP)
    POP EDI                             ; 005b02e5
        ;   Label: LAB_005b02e5
    MOV EAX,0x1                         ; 005b02e6
    ADD dword ptr [0x00681e00],EAX      ; 005b02eb | int g_DirectSoundDeviceCount
    ...
    PUSH EAX                            ; 005b02fd
        ;   Label: LAB_005b02fd
    CALL sound_snddx.cpp_getDirectSoundErrorString_FUN_005ade70 ; 005b02fe | char * sound_snddx.cpp_getDirectSoundErrorString_FUN_005ade70(uint error_code)
        ;   XREF to: 005ade70 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005b0303
    PUSH EAX                            ; 005b0306
    PUSH 0x65228b                       ; 005b0307 | = "Querry DirectSound capabilities" | s_Querry_DirectSound_capab_0065228b = Querry DirectSound capabilities
    PUSH 0x651a6c                       ; 005b030c | = "DirectSux: Unable to %s.  (%s)" | s_DirectSux_Unable_to_s_s_00651a6c = DirectSux: Unable to %s.  (%s)
    LEA EAX,[ESP + 0xc]                 ; 005b0311
    PUSH EAX                            ; 005b0315
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005b0316 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 005b031b
    MOV EAX,ESP                         ; 005b031e
    PUSH EAX                            ; 005b0320
    CALL sound_sndmain.cpp_logSoundError_FUN_005adba0 ; 005b0321 | void sound_sndmain.cpp_logSoundError_FUN_005adba0(char * format)
        ;   XREF to: 005adba0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005b0326
    XOR EAX,EAX                         ; 005b0329
    JMP 0x005b020b                      ; 005b032b | LAB_005b020b
        ;   XREF to: 005b020b (UNCONDITIONAL_JUMP)
    MOV dword ptr [EAX + 0x3f69c60],0x1 ; 005b0330 | DAT_03f69b44
        ;   Label: LAB_005b0330
    JMP 0x005b0269                      ; 005b033a | LAB_005b0269
