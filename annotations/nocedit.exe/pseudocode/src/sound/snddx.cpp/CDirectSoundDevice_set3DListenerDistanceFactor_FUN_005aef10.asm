...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl sound_snddx_cpp_CDirectSoundDevice_set3DListenerDistanceFactor_FUN_005aef10 (CDirectSoundDevice *this_ptr,double distance_in_feet)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [0x03f6a9bc]      ; 005aef10 | g_DirectSound3DListener
        ;   Label: sound_snddx.cpp_CDirectSoundDevice_set3DListenerDistanceFactor_FUN_005aef10
    TEST EDX,EDX                        ; 005aef16
    JNZ 0x005aef1b                      ; 005aef18
        ;   XREF to: 005aef1b (CONDITIONAL_JUMP)  ; LAB_005aef1b
    RET                                 ; 005aef1a
    FLD double ptr [ESP + 0x8]          ; 005aef1b
        ;   Label: LAB_005aef1b
    FMUL double ptr [0x00651c04]        ; 005aef1f | g_DirectSoundFeetToMeters
    PUSH 0x0                            ; 005aef25
