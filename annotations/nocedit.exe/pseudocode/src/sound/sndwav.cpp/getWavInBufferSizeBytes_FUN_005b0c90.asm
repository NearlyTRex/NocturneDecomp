...
section .text
    ...
    MOV ECX,dword ptr [0x03f6af10]      ; 005b0c90 | int g_WaveInBitsPerSample
    ...
    IMUL EAX,dword ptr [0x03f6af20]     ; 005b0ca5 | int g_WaveInBufferSizeSamples
    IMUL EAX,dword ptr [0x03f6af14]     ; 005b0cac | int g_WaveInChannels
    RET                                 ; 005b0cb3
