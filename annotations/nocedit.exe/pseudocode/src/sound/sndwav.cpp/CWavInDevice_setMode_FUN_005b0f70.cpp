...

{
  ...
  MVar3 = (*g_waveInGetDevCapsAFunc)(g_WaveInDeviceID,(LPWAVEINCAPSA)auStack_54,0x30);
  if (MVar3 != 0) {
    return 0;
  }
  g_WaveInRequestedSampleRate = stereo_flag;
  g_WaveInStereoRequested = (int)(in_stack_00000018 != 0);
  uStack_14 = auStack_54._40_4_;
  do {
    uVar9 = 99999;
    iVar7 = 0;
    iVar8 = 0;
    iVar2 = -1;
    do {
      if ((*(uint *)((int)&g_WaveInFormatTable[0].format_flags + iVar8) & uStack_14) != 0) {
        ...
        if (g_WaveInRequestedSampleRate < *(int *)((int)&g_WaveInFormatTable[0].sample_rate + iVar8)
           ) {
          uVar4 = uVar4 + 1;
        }
        if (*(int *)((int)&g_WaveInFormatTable[0].sample_rate + iVar8) < g_WaveInRequestedSampleRate
           ) {
          uVar4 = uVar4 + 2;
        }
    ...
    g_WaveInRequestedBitsPerSample = channels;
    g_WaveInRequestedChannels = sample_rate;
    if (iVar2 < 0) {
    ...
    if (g_WaveInNumBuffers <= iVar7) {
      WStack_28.nSamplesPerSec._0_2_ = 1;
      WStack_28._18_2_ = (ushort)g_WaveInBitsPerSample;
      WStack_28.nSamplesPerSec._2_2_ = (short)g_WaveInChannels;
      WStack_28.cbSize =
           (short)((int)(g_WaveInBitsPerSample & 0xffffU) >> 3) * (short)g_WaveInChannels;
      WStack_28.nAvgBytesPerSec = g_WaveInSampleRate;
      WStack_28._12_4_ = g_WaveInSampleRate * (uint)WStack_28.cbSize;
      MVar3 = (*g_waveInOpenFunc)(&g_WaveInHandle,g_WaveOutDeviceID,
                                  (LPCWAVEFORMATEX)&WStack_28.nSamplesPerSec,0,0,0);
      if (MVar3 == 0) {
        return 1;
      }
    }
    ...
    channels = g_WaveInRequestedBitsPerSample;
    sample_rate = g_WaveInRequestedChannels;
  } while( true );
}
