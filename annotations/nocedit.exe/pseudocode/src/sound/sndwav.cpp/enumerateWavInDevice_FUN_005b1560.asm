...
;                               FUNCTION
; *****************************************************************************
; __cdecl int sound_sndwav.cpp_enumerateWavInDevice_FUN_005b1560(UINT device_id, SRecordingDeviceInfo * device_info)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 005b1573
    PUSH ESI                            ; 005b1574
    CALL dword ptr CS:[0x611428]        ; 005b1575 | waveInGetDevCapsA * waveInGetDevCapsA
    TEST EAX,EAX                        ; 005b157c
    JZ 0x005b1588                       ; 005b157e | LAB_005b1588
    ...
    PUSH 0x6524e6                       ; 005b158f | = "WavIn: " | s_WavIn_006524e6 = WavIn:
    MOV dword ptr [EBX + 0x104],ESI     ; 005b1594
    CALL support_newmsg.cpp_getLocalizedString_FUN_005441f0 ; 005b159a | char * support_newmsg.cpp_getLocalizedString_FUN_005441f0(char * key)
    ...
    CMP AL,0x0                          ; 005b15ab
    JZ 0x005b15bf                       ; 005b15ad | LAB_005b15bf
    ...
    CMP AL,0x0                          ; 005b15bb
    JNZ 0x005b15a7                      ; 005b15bd | LAB_005b15a7
    ...
    CMP AL,0x0                          ; 005b15d1
    JZ 0x005b15e5                       ; 005b15d3 | LAB_005b15e5
    ...
    CMP AL,0x0                          ; 005b15e1
    JNZ 0x005b15cd                      ; 005b15e3 | LAB_005b15cd
