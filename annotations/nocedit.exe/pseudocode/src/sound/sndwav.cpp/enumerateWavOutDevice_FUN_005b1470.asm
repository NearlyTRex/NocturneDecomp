...
;                               FUNCTION
; *****************************************************************************
; __cdecl int sound_sndwav.cpp_enumerateWavOutDevice_FUN_005b1470(UINT device_id, SSoundDeviceInfo * device_info)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 005b1483
    PUSH ESI                            ; 005b1484
    CALL dword ptr CS:[0x611444]        ; 005b1485 | waveOutGetDevCapsA * waveOutGetDevCapsA
    TEST EAX,EAX                        ; 005b148c
    JZ 0x005b1498                       ; 005b148e | LAB_005b1498
    ...
    PUSH 0x6524d8                       ; 005b14ab | = "WavOutWrite: " | s_WavOutWrite_006524d8 = WavOutWrite:
    MOV dword ptr [EBX + 0x10c],EAX     ; 005b14b0
    CALL support_newmsg.cpp_getLocalizedString_FUN_005441f0 ; 005b14b6 | char * support_newmsg.cpp_getLocalizedString_FUN_005441f0(char * key)
    ...
    CMP AL,0x0                          ; 005b14c7
    JZ 0x005b14db                       ; 005b14c9 | LAB_005b14db
    ...
    CMP AL,0x0                          ; 005b14d7
    JNZ 0x005b14c3                      ; 005b14d9 | LAB_005b14c3
    ...
    CMP AL,0x0                          ; 005b14ed
    JZ 0x005b1501                       ; 005b14ef | LAB_005b1501
    ...
    CMP AL,0x0                          ; 005b14fd
    JNZ 0x005b14e9                      ; 005b14ff | LAB_005b14e9
