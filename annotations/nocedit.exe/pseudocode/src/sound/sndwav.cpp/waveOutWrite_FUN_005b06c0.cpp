// Name: sound_sndwav.cpp_waveOutWrite_FUN_005b06c0
// Address: 005b06c0
// Address Range: [[005b06c0, 005b0838]]
// Convention: unknown
// Signature: undefined sound_sndwav.cpp_waveOutWrite_FUN_005b06c0()
// Cross-references:
//   sound_sndwav.cpp_FUN_005b08f0 (005b08f0) at 005b0957 [UNCONDITIONAL_CALL]
//   sound_sndwav.cpp_WavOutDevice_poll_FUN_005b0c10 (005b0c10) at 005b0c67 [UNCONDITIONAL_CALL]
// Globals:
...
undefined4 sound_sndwav_cpp_waveOutWrite_FUN_005b06c0(void)

{
  ...
  if (0 < DAT_03f6adbc * 4) {
    ...
    do {
      iVar4 = iVar5 + 4;
      iVar1 = iVar2 + iVar6;
      iVar6 = iVar6 + ((int)((DAT_03f6adb8 + (DAT_03f6adb8 >> 0x1f) * -8) -
                            (uint)((DAT_03f6adb8 >> 0x1f) << 2 < 0)) >> 3);
      *(int *)(&stack0xffffffdc + iVar5) = iVar1;
      iVar5 = iVar4;
    } while (iVar4 < DAT_03f6adbc * 4);
  }
...
// Assembly code:
// 005b06c0: PUSH EBX
//   Label: sound_sndwav.cpp_waveOutWrite_FUN_005b06c0
// 005b06c1: PUSH ESI
// 005b06c2: PUSH EDI
// 005b06c3: PUSH EBP
