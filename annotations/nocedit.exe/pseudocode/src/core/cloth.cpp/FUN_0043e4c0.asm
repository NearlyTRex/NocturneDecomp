...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_cloth.cpp_FUN_0043e4c0()
;
; Local Variables:
...
section .text
    ...
    JGE 0x0043e4e1                      ; 0043e4d2 | LAB_0043e4e1
    ...
    PUSH EAX                            ; 0043e4e3
    PUSH ESI                            ; 0043e4e4
    CALL crt_stdio.c_fgetc_outptr_FUN_005ff245 ; 0043e4e5 | int crt_stdio.c_fgetc_outptr_FUN_005ff245(FILE * stream, uchar * output_byte)
    ...
    JNZ 0x0043e4d4                      ; 0043e4f7 | LAB_0043e4d4
