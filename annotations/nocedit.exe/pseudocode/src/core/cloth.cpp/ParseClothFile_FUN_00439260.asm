...
section .text
    ...
    PUSH 0x6182d9                       ; 00439268 | = "wt" | s_wt_006182d9 = wt
    MOV EDX,dword ptr [ESP + 0x1c]      ; 0043926d
    PUSH EDX                            ; 00439271
    PUSH 0x6182dc                       ; 00439272 | = "models" | s_models_006182dc = models
    CALL engine_dosio.c_getFile_FUN_00481a50 ; 00439277 | FILE * engine_dosio.c_getFile_FUN_00481a50(char * directory, char * filename, char * mode)
        ;   XREF to: 00481a50 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0043927c
    MOV EDI,EAX                         ; 0043927f
    TEST EAX,EAX                        ; 00439281
    JZ 0x004394b8                       ; 00439283 | LAB_004394b8
        ;   XREF to: 004394b8 (CONDITIONAL_JUMP)
    PUSH 0x618318                       ; 00439289 | = "version\n" | s_version_00618318 = version

        ;   Label: LAB_00439289
    PUSH EDI                            ; 0043928e
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0043928f | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    PUSH EDI                            ; 0043929e
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0043929f | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004392a4
    PUSH 0x618325                       ; 004392a7 | = "model\n" | s_model_00618325 = model

    PUSH EDI                            ; 004392ac
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 004392ad | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDI                            ; 004392bb
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 004392bc | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004392c1
    PUSH 0x618330                       ; 004392c4 | = "weight,gravity,dampen,spring,bodyFric..." | s_weight_gravity_dampen_sp_00618330 = weight,gravity,dampen,spring,bodyFriction,floorFriction,windArea,momInert

    PUSH EDI                            ; 004392c9
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 004392ca | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH 0x61837b                       ; 00439332 | = "%f,%f,%f,%f,%f,%f,%f,%f\n" | s_f_f_f_f_f_f_f_f_0061837b = %f,%f,%f,%f,%f,%f,%f,%f

    PUSH EDI                            ; 00439337
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00439338 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x48                        ; 0043933d
    PUSH 0x618394                       ; 00439340 | = "transparency\n" | s_transparency_00618394 = transparency

    PUSH EDI                            ; 00439345
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00439346 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDI                            ; 0043935f
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00439360 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00439365
    PUSH 0x6183a6                       ; 00439368 | = "doubleSided\n" | s_doubleSided_006183a6 = doubleSided

    PUSH EDI                            ; 0043936d
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0043936e | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDI                            ; 00439382
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00439383 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00439388
    PUSH 0x6183b7                       ; 0043938b | = "lockedVertexCount\n" | s_lockedVertexCount_006183b7 = lockedVertexCount

    PUSH EDI                            ; 00439390
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00439391 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDI                            ; 004393a5
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 004393a6 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004393ab
    PUSH 0x6183ce                       ; 004393ae | = "lockedVertexList\n" | s_lockedVertexList_006183ce = lockedVertexList

    PUSH EDI                            ; 004393b3
    XOR EBX,EBX                         ; 004393b4
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 004393b6 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [EBP + 0x3f028]   ; 004393bb
    ADD ESP,0x8                         ; 004393c1
    TEST EDX,EDX                        ; 004393c4
    JLE 0x004393f0                      ; 004393c6 | LAB_004393f0
    ...
    INC EBX                             ; 004393da
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 004393db | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EBP + 0x3f028]   ; 004393e0
    ADD ESP,0xc                         ; 004393e6
    CMP EBX,EAX                         ; 004393e9
    JL 0x004393ca                       ; 004393eb | LAB_004393ca
        ;   XREF to: 004393ca (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 004393ed
    PUSH 0x6183e4                       ; 004393f0 | = "collideBoneCount\n" | s_collideBoneCount_006183e4 = collideBoneCount

        ;   Label: LAB_004393f0
    PUSH EDI                            ; 004393f5
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 004393f6 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0043940d | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [EBP + 0x3ce8c]   ; 00439412
    ADD ESP,0xc                         ; 00439418
    TEST ECX,ECX                        ; 0043941b
    JLE 0x004394a0                      ; 0043941d | LAB_004394a0
    ...
    PUSH EBX                            ; 0043947a
    PUSH 0x6183fa                       ; 0043947b | = "\"%s\",%g,%g, %g,%g,%g, %g,%g,%g, %g\n" | s_s_g_g_g_g_g_g_g_g_g_006183fa = "%s",%g,%g, %g,%g,%g, %g,%g,%g, %g

    PUSH EDI                            ; 00439480
    INC ESI                             ; 00439481
    ADD EBX,0xac                        ; 00439482
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00439488 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EBP + 0x3ce8c]   ; 0043948d
    ADD ESP,0x54                        ; 00439493
    CMP ESI,EAX                         ; 00439496
    JL 0x00439429                       ; 00439498 | LAB_00439429
        ;   XREF to: 00439429 (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 0043949a
    PUSH 0x17b                          ; 004394a0
        ;   Label: LAB_004394a0
    PUSH 0x61841e                       ; 004394a5 | = "..\\core\\cloth.cpp" | s_core_cloth_cpp_0061841e = ..\core\cloth.cpp
    PUSH EDI                            ; 004394aa
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 004394ab | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
    ...
    POP EBX                             ; 004394b6
    RET                                 ; 004394b7
    MOV ECX,0x6182e3                    ; 004394b8 | = "..\\core\\cloth.cpp" | s_core_cloth_cpp_006182e3 = ..\core\cloth.cpp
        ;   Label: LAB_004394b8
    MOV EBX,0x12d                       ; 004394bd
    PUSH 0x6182f5                       ; 004394c2 | = "CCloth::save - Unable to open file" | s_CCloth_save_Unable_to_op_006182f5 = CCloth::save - Unable to open file
    MOV dword ptr [0x02f0ca48],ECX      ; 004394c7 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 004394cd | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004394d3 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004394d8
    JMP 0x00439289                      ; 004394db | LAB_00439289
