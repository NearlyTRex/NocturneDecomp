...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_cloth.cpp_FUN_0043e0a0()
;
;
; XREF[1]:
...
section .text
    ...
    PUSH EDX                            ; 0043e0a6
    PUSH 0x618ac9                       ; 0043e0a7 | = "models\\%s\n" | s_models_s_00618ac9 = models\%s

    MOV ECX,dword ptr [ESP + 0x18]      ; 0043e0ac
    PUSH ECX                            ; 0043e0b0
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0043e0b1 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    PUSH ESI                            ; 0043e0c4
    CALL core_dmodel.cpp_CKeyFramedModel_writeDependencies_FUN_0047ed00 ; 0043e0c5 | void core_dmodel.cpp_CKeyFramedModel_writeDependencies_FUN_0047ed00(CKeyFramedModel * this_ptr, FILE * dependency_file, int skip_raw_files)
