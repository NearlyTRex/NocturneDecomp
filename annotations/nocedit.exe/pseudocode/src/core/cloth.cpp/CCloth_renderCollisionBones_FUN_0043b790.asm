...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_cloth_cpp_CCloth_renderCollisionBones_FUN_0043b790(CCloth *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0043b790
        ;   Label: core_cloth.cpp_CCloth_renderCollisionBones_FUN_0043b790
    PUSH ESI                            ; 0043b791
    ...
    PUSH EBX                            ; 0043b7b9
    PUSH ESI                            ; 0043b7ba
    CALL core_cloth.cpp_CCloth_renderBone_FUN_0043b7e0 ; 0043b7bb
