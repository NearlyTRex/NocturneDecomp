...
;                               FUNCTION
; *****************************************************************************
; __cdecl SClothVertex * __cdecl core_cloth_cpp_SClothVertex_dtor_FUN_0043e440(SClothVertex *this_ptr,uint flags)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 0043e44b
    CALL core_cloth.cpp_CVector3f_arrdtor_FUN_0043e460 ; 0043e44c
