...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_cloth.cpp_FUN_0043dcc0()
;
;
; XREF[1]:
...
section .text
    ...
    PUSH EDX                            ; 0043dccb
    PUSH EDI                            ; 0043dccc
    CALL core_dmodel.cpp_CKeyFramedModel_load_FUN_00476db0 ; 0043dccd | void core_dmodel.cpp_CKeyFramedModel_load_FUN_00476db0(CKeyFramedModel * this_ptr, char * filename)
        ;   XREF to: 00476db0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0043dcd2
    PUSH EDI                            ; 0043dcd5
    CALL core_dmodel.cpp_CKeyFramedModel_captureTextures_FUN_00478190 ; 0043dcd6 | void core_dmodel.cpp_CKeyFramedModel_captureTextures_FUN_00478190(CKeyFramedModel * this_ptr)
        ;   XREF to: 00478190 (UNCONDITIONAL_CALL)
    FLD float ptr [0x0065bb54]          ; 0043dcdb | float FLOAT_0065bb54
    FLD float ptr [0x0065bb58]          ; 0043dce1 | float FLOAT_0065bb58
    FLD float ptr [0x0065bb5c]          ; 0043dce7 | float FLOAT_0065bb5c
    FLD float ptr [0x0065bb60]          ; 0043dced | float FLOAT_0065bb60
    MOV dword ptr [EDI + 0x3ce88],0x3f800000 ; 0043dcf3
    FLD float ptr [0x0065bb64]          ; 0043dcfd | float FLOAT_0065bb64
    MOV dword ptr [EDI + 0x3ce84],0x1   ; 0043dd03
    FLD float ptr [0x0065bb68]          ; 0043dd0d | float FLOAT_0065bb68
    MOV dword ptr [EDI + 0x3f028],0x0   ; 0043dd13
    FLD float ptr [0x0065bb6c]          ; 0043dd1d | float FLOAT_0065bb6c
    ...
    CALL core_cloth.cpp_CCloth_allocMemory_FUN_00438c50 ; 0043dd71 | void core_cloth.cpp_CCloth_allocMemory_FUN_00438c50(CCloth * this_ptr)
    ...
    JLE 0x0043ddcf                      ; 0043dd83 | LAB_0043ddcf
    ...
    JL 0x0043dd8e                       ; 0043ddcc | LAB_0043dd8e
