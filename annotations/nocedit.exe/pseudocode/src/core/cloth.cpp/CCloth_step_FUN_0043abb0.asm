...
; int              Stack[-0x1a4]:4  local_1a4
; float            Stack[-0x1a0]:4  local_1a0
; int              Stack[-0x19c]:4  local_19c
...
; CMatrix3x4f *    Stack[-0x38]:4  local_38
; SClothVertex *   Stack[-0x34]:4  local_34
; SClothVertex *   Stack[-0x30]:4  local_30
; int              Stack[-0x2c]:4  local_2c
; CVector3f *      Stack[-0x28]:4  local_28
; SClothBone *     Stack[-0x24]:4  local_24
; SClothVertex *   Stack[-0x20]:4  local_20
