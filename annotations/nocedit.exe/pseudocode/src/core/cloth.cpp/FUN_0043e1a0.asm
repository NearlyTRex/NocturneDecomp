...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_cloth.cpp_FUN_0043e1a0()
;
; Local Variables:
...
;
; XREF[1]:
;   core_cloth.cpp_FUN_0043c3a0 at 0043c3c2
;
; Called Functions:
...
section .text
    ...
    JZ 0x0043e1ee                       ; 0043e1dc | LAB_0043e1ee
    ...
    PUSH EAX                            ; 0043e1f7
    CALL core_dirmat.cpp_CMatrix3x3f_buildRotationMatrix_FUN_00471d30 ; 0043e1f8 | void core_dirmat.cpp_CMatrix3x3f_buildRotationMatrix_FUN_00471d30(CMatrix3x3f * this_ptr, CVector3f * euler_angles)
    ...
    JLE 0x0043e290                      ; 0043e20e | LAB_0043e290
    ...
    PUSH EAX                            ; 0043e22f
    CALL core_dirmat.cpp_CMatrix3x3f_transformVectorTranspose_FUN_00472030 ; 0043e230 | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVectorTranspose_FUN_00472030(CMatrix3x3f * matrix, CVector3f * output, CVector3f * input)
        ;   XREF to: 00472030 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0043e235
    CMP ESI,EAX                         ; 0043e238
    JZ 0x0043e24c                       ; 0043e23a | LAB_0043e24c
    ...
    PUSH EAX                            ; 0043e25e
    CALL core_dirmat.cpp_CMatrix3x3f_transformVectorTranspose_FUN_00472030 ; 0043e25f | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVectorTranspose_FUN_00472030(CMatrix3x3f * matrix, CVector3f * output, CVector3f * input)
        ;   XREF to: 00472030 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0043e264
    CMP EBX,EAX                         ; 0043e267
    JZ 0x0043e27b                       ; 0043e269 | LAB_0043e27b
    ...
    JL 0x0043e21d                       ; 0043e28e | LAB_0043e21d
