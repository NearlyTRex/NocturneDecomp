...

{
  ...
  local_50.slew_rate = (float)this_ptr->vertices;
    ...
    *(float *)((int)local_50.roll + 8) =
    ...
    if (local_50.yaw == 0.0) {
      ...
      if (0 < (this_ptr->model).vertex_count) {
        iVar3 = 0;
        pCVar8 = &this_ptr->vertices[0].offset_pos;
        do {
          piVar6 = (int *)((int)&((this_ptr->model).vertex_list)->x + iVar3);
          iVar1 = iVar1 + 1;
          *piVar6 = (int)ROUND(pCVar8->x * 256.0f);
          piVar6[1] = (int)ROUND(pCVar8->y * 256.0f);
          piVar6[2] = (int)ROUND(pCVar8->z * 256.0f);
          pCVar8 = (CVector3f *)&pCVar8[0x17].z;
          iVar3 = iVar3 + 0xc;
        } while (iVar1 < (this_ptr->model).vertex_count);
      }
      iVar1 = 0;
      if (0 < this_ptr->collide_bone_count) {
        do {
          core_cloth_cpp_CCloth_computeBoneTransform_FUN_0043a2b0
                    (this_ptr,iVar1,&g_CDeformableModelInstanceInstance);
          iVar1 = iVar1 + 1;
    ...
    if ((0 < (int)local_20) && (fVar4 = 0.0, 0 < this_ptr->collide_bone_count)) {
      do {
        ...
        core_cloth_cpp_CCloth_renderBone_FUN_0043b7e0(this_ptr,(int)fVar4,iVar1);
    ...
    iVar1 = (*g_CKeysPtr->vtable->getAndClearKeyState)(g_CKeysPtr,DIK_M);
    if (iVar1 != 0) {
      ...
      if (0 < *(int *)((int)local_20 + 0x964)) {
        ...
        } while ((int)fVar5 < *(int *)((int)local_20 + 0x964));
      }
      iVar1 = shape_edittool_cpp_CPickList_displayChoicesAndWaitForInput_FUN_004a3e20
                        ((CPickList *)&stack0xfffffac0,"Select motion",(int)fStack_1c,0);
      if (-1 < iVar1) {
        core_motion_cpp_CMotionController_jumpToMotion_FUN_0052dde0
                  (&g_CDeformableModelInstanceInstance.motion_controller,iVar1,0.0);
      }
      shape_edittool_cpp_CPickList_dtor_FUN_004a3c80((CPickList *)&stack0xfffffac0,0);
    }
    iVar1 = (*g_CKeysPtr->vtable->getAndClearKeyState)(g_CKeysPtr,DIK_R);
    if (iVar1 != 0) {
      shape_spotview_cpp_CSpotView_reset_FUN_005b9620(g_CSpotViewPtr,0x1f);
    }
    _sprintf
    ...
    iVar1 = (*g_CKeysPtr->vtable->getAndClearKeyState)(g_CKeysPtr,DIK_1);
    if ((iVar1 != 0) && (unaff_ESI = unaff_ESI + 1, 2 < unaff_ESI)) {
      unaff_ESI = 0;
    }
    in_stack_fffffac4 = g_CKeysPtr;
    iVar1 = (*g_CKeysPtr->vtable->getAndClearKeyState)(g_CKeysPtr,DIK_2);
    if (iVar1 != 0) {
    ...
    if (((in_stack_00000028 == 2) && (-1 < in_stack_0000002c)) &&
      ...
      iVar1 = (*g_CKeysPtr->vtable->getAndClearKeyState)(g_CKeysPtr,DIK_D);
      if ((iVar1 != 0) &&
         (iVar1 = shape_edittool_cpp_CEditorTools_showConfirmationDialog_FUN_0049f060
                            (g_CEditorToolsPtr,"Delete this bone?"), iVar1 != 0)) {
        iVar1 = this_ptr->collide_bone_count + -1;
        this_ptr->collide_bone_count = iVar1;
        memmove
                  ((void *)(in_stack_0000003c * 0xac + in_stack_00000020),
                   (void *)((in_stack_0000003c + 1) * 0xac + in_stack_00000020),
                   (iVar1 - in_stack_0000003c) * 0xac);
      }
      iVar1 = (*g_CKeysPtr->vtable->getAndClearKeyState)(g_CKeysPtr,DIK_X);
      if (iVar1 != 0) {
        shape_edittool_cpp_CEditorTools_promptForValidFloat_FUN_004a00f0
                  (g_CEditorToolsPtr,"Enter X radius",(float *)(iVar5 + 0x14),1,0.0,9999.0,
                   1);
      }
      iVar1 = (*g_CKeysPtr->vtable->getAndClearKeyState)(g_CKeysPtr,DIK_Y);
      if (iVar1 != 0) {
        shape_edittool_cpp_CEditorTools_promptForValidFloat_FUN_004a00f0
      ...
      iVar1 = (*g_CKeysPtr->vtable->getAndClearKeyState)(g_CKeysPtr,DIK_TAB);
      if (iVar1 != 0) {
    ...
    iVar1 = (*g_CKeysPtr->vtable->getAndClearKeyState)(g_CKeysPtr,DIK_Z);
    if (iVar1 != 0) {
      core_cloth_cpp_CCloth_setup_FUN_00439710
                (this_ptr,&UNION_UVector3_00838e40.f,&UNION_UVector3_00838e4c.f,
                 &g_CDeformableModelInstanceInstance);
