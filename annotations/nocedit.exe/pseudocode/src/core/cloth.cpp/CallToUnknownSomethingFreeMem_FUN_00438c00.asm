...
section .text
    ...
    PUSH EBX                            ; 00438c05
    CALL core_cloth.cpp_UnknownSomethingAndFreeMem_FUN_00438cb0 ; 00438c06 | undefined core_cloth.cpp_UnknownSomethingAndFreeMem_FUN_00438cb0()
        ;   XREF to: 00438cb0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00438c0b
    PUSH 0x0                            ; 00438c0e
    ADD EBX,0x3ce90                     ; 00438c10
    PUSH EBX                            ; 00438c16
    CALL core_cloth.cpp_freeClothBones_FUN_0043e4a0 ; 00438c17 | void core_cloth.cpp_freeClothBones_FUN_0043e4a0(SClothBone * * array)
        ;   XREF to: 0043e4a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00438c1c
    PUSH 0x0                            ; 00438c1f
    SUB EAX,0x377b8                     ; 00438c21
    PUSH EAX                            ; 00438c26
    CALL core_cloth.cpp_freeClothVertices_FUN_0043e480 ; 00438c27 | int core_cloth.cpp_freeClothVertices_FUN_0043e480(SClothVertex * * array)
        ;   XREF to: 0043e480 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00438c2c
    PUSH 0x1                            ; 00438c2f
    LEA EBX,[EAX + 0xffffa928]          ; 00438c31
    PUSH EBX                            ; 00438c37
    CALL core_dmodel.cpp_CKeyFramedModel_dtor_FUN_00476d90 ; 00438c38 | CKeyFramedModel * core_dmodel.cpp_CKeyFramedModel_dtor_FUN_00476d90(CKeyFramedModel * this_ptr)
