...

{
  ...
  if (0 < pCVar2->bone_count) {
    ...
    do {
      ...
      if (0 < pCVar2->bone_count) {
        do {
          if (iVar6 == pCVar2->bone_list[iVar5].parent_index) {
  ...
  if (-1 < iVar3) {
    ...
    this_ptr->collide_bones[iVar3].euler1.y = 0.0;
    this_ptr->collide_bones[iVar3].euler1.x = 0.0;
    iVar3 = this_ptr->collide_bone_count;
    this_ptr->collide_bones[iVar3].euler2.z = 0.0;
    this_ptr->collide_bones[iVar3].euler2.y = 0.0;
    this_ptr->collide_bones[iVar3].euler2.x = 0.0;
