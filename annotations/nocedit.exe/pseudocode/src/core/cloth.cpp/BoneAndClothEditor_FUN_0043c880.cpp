...

{
  ...
  core_game_cpp_CGame_saveClockTime_FUN_004d7d80(g_CGamePtr,in_stack_fffffbdc);
  ...
  iStack00000100 = in_stack_00000004 + 0x3ce90;
  ...
  do {
    ...
    if (in_stack_000000fc == 0) {
      for (fVar6 = in_stack_000000f0 * motion_name->fps +
    ...
    core_skeleton_cpp_CDeformableModelInstance_computeBoneTransforms_FUN_0059fb40
              (&g_CDeformableModelInstanceInstance);
    *in_stack_00000118 =
         *in_stack_00000118 - g_CDeformableModelInstanceInstance.accumulated_root_motion.x;
    in_stack_00000118[1] =
         in_stack_00000118[1] - g_CDeformableModelInstanceInstance.accumulated_root_motion.y;
    in_stack_00000118[2] =
         in_stack_00000118[2] - g_CDeformableModelInstanceInstance.accumulated_root_motion.z;
    ...
    if (in_stack_00000114 == 0) {
      ...
      if (0 < *(int *)(in_stack_00000004 + 0x104)) {
        iVar8 = 0;
        pfVar5 = (float *)(in_stack_000000f4 + 0xc0);
        do {
    ...
    if (local_40 != 0) {
      ...
      if (0 < *(int *)(in_stack_00000004 + 0x3f028)) {
        do {
          pfVar5 = (float *)(*(int *)(iVar4 + 0x3f02c) * 0x11c + local_38._8_4_);
          aCStack_70[0].x = (int)ROUND(*pfVar5 * _DAT_0065bb3c);
          aCStack_70[0].y = (int)ROUND(pfVar5[1] * _DAT_0065bb3c);
          aCStack_70[0].z = (int)ROUND(pfVar5[2] * _DAT_0065bb3c);
          wincore_windll_cpp_transformAndProjectPoint_FUN_005b575c
                    (&g_CDemonRendererPtr->vertex_buffer_ptr[19999].projected_vertex,aCStack_70);
          core_cloth_cpp_FUN_0043c6e0();
          iStack_14 = iStack_14 + 1;
          iVar4 = iVar4 + 4;
        } while (iStack_14 < *(int *)(in_stack_00000004 + 0x3f028));
      }
    }
    if ((0 < (int)local_24) && (fVar6 = 0.0, 0 < *(int *)(in_stack_00000004 + 0x3ce8c))) {
      do {
        if ((local_24 == 2.8026e-45) && (fVar6 == local_20)) {
      ...
      } while ((int)fVar6 < *(int *)(in_stack_00000004 + 0x3ce8c));
    }
    ...
    if (iVar4 != 0) {
      ...
      iVar4 = -1;
      iVar8 = 0;
      string_data = (char *)local_38._0_4_;
      if (0 < *(int *)((int)unaff_ESI + 0x964)) {
        do {
          shape_edittool_cpp_CStrList_add_FUN_004a2b80((CStrList *)&stack0xfffffad8,string_data);
          if (string_data == in_stack_00000008) {
            iVar4 = iVar8;
          }
          iVar8 = iVar8 + 1;
    ...
    if (((pCVar3 == (CSkeleton *)0xfffff69a) && (-1 < iVar1)) &&
       (iVar1 < *(int *)(in_stack_00000004 + 0x3ce8c))) {
      ...
      iVar8 = iVar1 * 0xac + in_stack_00000014;
      ...
      if (iVar4 == 0) {
        ...
        if (&local_20 != (float *)(iVar8 + 0x28)) {
          local_20 = *(float *)(iVar8 + 0x28);
          fStack_1c = *(float *)(iVar8 + 0x2c);
          local_18 = *(uint *)(iVar8 + 0x30);
        }
        core_slew_cpp_CSlew_processInput_FUN_005a20b0((CSlew *)(local_38 + 0xc));
        fVar6 = 1.0 / in_stack_00000028;
        unaff_ESI = local_24 * fVar6;
        if ((float *)(iVar8 + 0x1c) != (float *)&stack0xfffffff4) {
          *(float *)(iVar8 + 0x1c) = local_28 * fVar6;
          *(float *)(iVar8 + 0x20) = unaff_ESI;
          *(float *)(iVar8 + 0x24) = local_20 * fVar6;
        }
        if ((float *)(iVar8 + 0x28) != &fStack_1c) {
          *(float *)(iVar8 + 0x28) = fStack_1c;
          *(uint *)(iVar8 + 0x2c) = local_18;
          *(int *)(iVar8 + 0x30) = iStack_14;
        }
      }
    ...
    if (iStack00000100 < 0) {
      iStack00000100 = *(int *)(in_stack_00000004 + 0x3ce8c) + -1;
    }
    if (*(int *)(in_stack_00000004 + 0x3ce8c) <= iStack00000100) {
      iStack00000100 = 0;
    }
