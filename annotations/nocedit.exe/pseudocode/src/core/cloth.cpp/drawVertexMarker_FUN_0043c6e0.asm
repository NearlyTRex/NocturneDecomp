...
;
; XREF[3]:
;   core_cloth.cpp_CCloth_boneEditor_FUN_0043c880 at 0043cbdc
;   core_cloth.cpp_CCloth_lockedVertexEditor_FUN_0043d590 at 0043d873
;   core_cloth.cpp_drawVertexMarkerAtWorldPos_FUN_0043c820 at 0043c86b
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0043c6e0
        ;   Label: core_cloth.cpp_drawVertexMarker_FUN_0043c6e0
    PUSH ESI                            ; 0043c6e1
    PUSH EDI                            ; 0043c6e2
    PUSH EBP                            ; 0043c6e3
