...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_cloth_cpp_CCloth_createFromKFM_FUN_0043dcc0(CCloth *this_ptr,char *filename)
;
; Parameters:
...
;
; XREF[1]:
;   core_cloth.cpp_CCloth_showMenu_FUN_0043ddf0 at 0043e08e
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0043dcc0
        ;   Label: core_cloth.cpp_CCloth_createFromKFM_FUN_0043dcc0
    PUSH EDI                            ; 0043dcc1
    PUSH EBP                            ; 0043dcc2
