...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_cloth.cpp_FUN_0043c430()
;
; Local Variables:
...
section .text
    ...
    PUSH 0x838e58                       ; 0043c43c | CDeformableModelInstance g_CDeformableModelInstanceInstance
    MOV dword ptr [ESP + 0x4bc],EDX     ; 0043c441
    CALL core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_005a0820 ; 0043c448 | CSkeleton * core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_005a0820(CDeformableModelInstance * this_ptr)
        ;   XREF to: 005a0820 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0043c44d
    MOV EBP,EAX                         ; 0043c450
    MOV ESI,EAX                         ; 0043c452
    CALL wincore_windll.cpp_clearScreen_FUN_005b3e70 ; 0043c454 | void wincore_windll.cpp_clearScreen_FUN_005b3e70()
        ;   XREF to: 005b3e70 (UNCONDITIONAL_CALL)
    MOV EAX,ESP                         ; 0043c459
    PUSH EAX                            ; 0043c45b
    XOR EDI,EDI                         ; 0043c45c
    CALL shape_edittool.cpp_CPickList_ctor_FUN_004a3b90 ; 0043c45e | CPickList * shape_edittool.cpp_CPickList_ctor_FUN_004a3b90(CPickList * this_ptr)
        ;   XREF to: 004a3b90 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [EBP + 0x28558]   ; 0043c463
    ADD ESP,0x4                         ; 0043c469
    TEST ECX,ECX                        ; 0043c46c
    JLE 0x0043c4ae                      ; 0043c46e | LAB_0043c4ae
    ...
    JLE 0x0043c513                      ; 0043c482 | LAB_0043c513
        ;   XREF to: 0043c513 (CONDITIONAL_JUMP)
    MOV EAX,ESI                         ; 0043c488
    CMP EDI,dword ptr [EAX + 0x2857c]   ; 0043c48a
        ;   Label: LAB_0043c48a
    JNZ 0x0043c501                      ; 0043c490 | LAB_0043c501
        ;   XREF to: 0043c501 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 0043c492
        ;   Label: LAB_0043c492
    LEA EAX,[ESP + 0x4]                 ; 0043c493
    PUSH EAX                            ; 0043c497
    CALL shape_edittool.cpp_CStrList_add_FUN_004a2b80 ; 0043c498 | void shape_edittool.cpp_CStrList_add_FUN_004a2b80(CStrList * this_ptr, char * string_data)
    ...
    JL 0x0043c476                       ; 0043c4ac | LAB_0043c476
        ;   XREF to: 0043c476 (CONDITIONAL_JUMP)
    PUSH 0x0                            ; 0043c4ae
        ;   Label: LAB_0043c4ae
    PUSH -0x1                           ; 0043c4b0
    PUSH 0x618656                       ; 0043c4b2 | = "Select bone to add" | s_Select_bone_to_add_00618656 = Select bone to add
    LEA EAX,[ESP + 0xc]                 ; 0043c4b7
    PUSH EAX                            ; 0043c4bb
    CALL shape_edittool.cpp_CPickList_displayChoicesAndWaitForInput_FUN_004a3e20 ; 0043c4bc | int shape_edittool.cpp_CPickList_displayChoicesAndWaitForInput_FUN_004a3e20(CPickList * this_ptr, char * dialog_title, int config_param1, int config_param2)
        ;   XREF to: 004a3e20 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0043c4c1
    TEST EAX,EAX                        ; 0043c4c4
    JGE 0x0043c51d                      ; 0043c4c6 | LAB_0043c51d
        ;   XREF to: 0043c51d (CONDITIONAL_JUMP)
    PUSH 0x838e58                       ; 0043c4c8 | CDeformableModelInstance g_CDeformableModelInstanceInstance
        ;   Label: LAB_0043c4c8
    PUSH 0x838e4c                       ; 0043c4cd | DAT_00838e4c
    PUSH 0x838e40                       ; 0043c4d2 | DAT_00838e40
    MOV EAX,dword ptr [ESP + 0x4dc]     ; 0043c4d7
    PUSH EAX                            ; 0043c4de
    CALL core_cloth.cpp_FUN_00439710    ; 0043c4df | undefined core_cloth.cpp_FUN_00439710()
        ;   XREF to: 00439710 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0043c4e4
    PUSH 0x0                            ; 0043c4e7
    LEA EAX,[ESP + 0x4]                 ; 0043c4e9
    PUSH EAX                            ; 0043c4ed
    CALL shape_edittool.cpp_CPickList_dtor_FUN_004a3c80 ; 0043c4ee | CPickList * shape_edittool.cpp_CPickList_dtor_FUN_004a3c80(CPickList * this_ptr, uint d1, uint d2, uint d3, ...)
    ...
    JL 0x0043c48a                       ; 0043c50d | LAB_0043c48a
        ;   XREF to: 0043c48a (CONDITIONAL_JUMP)
    TEST ECX,ECX                        ; 0043c513
        ;   Label: LAB_0043c513
    JNZ 0x0043c492                      ; 0043c515 | LAB_0043c492
        ;   XREF to: 0043c492 (CONDITIONAL_JUMP)
    JMP 0x0043c4a0                      ; 0043c51b | LAB_0043c4a0
        ;   XREF to: 0043c4a0 (UNCONDITIONAL_JUMP)
    PUSH EAX                            ; 0043c51d
        ;   Label: LAB_0043c51d
    LEA EAX,[ESP + 0x4]                 ; 0043c51e
    PUSH EAX                            ; 0043c522
    CALL shape_edittool.cpp_CStrList_getStringAt_FUN_004a2f70 ; 0043c523 | char * shape_edittool.cpp_CStrList_getStringAt_FUN_004a2f70(CStrList * this_ptr, int index)
    ...
    CMP AL,0x0                          ; 0043c54b
    JZ 0x0043c55f                       ; 0043c54d | LAB_0043c55f
    ...
    CMP AL,0x0                          ; 0043c55b
    JNZ 0x0043c547                      ; 0043c55d | LAB_0043c547
        ;   XREF to: 0043c547 (CONDITIONAL_JUMP)
    POP EDI                             ; 0043c55f
        ;   Label: LAB_0043c55f
    PUSH 0x618669                       ; 0043c560 | = "Enter in X radius : " | s_Enter_in_X_radius_00618669 = Enter in X radius :
    ...
    PUSH EAX                            ; 0043c578
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 0043c579 | int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
        ;   XREF to: 004032c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0043c57e
    LEA EAX,[ESP + 0x3a8]               ; 0043c581
    PUSH EAX                            ; 0043c588
    CALL crt_string.c_strtod_FUN_005ff0f3 ; 0043c589 | double crt_string.c_strtod_FUN_005ff0f3(char * str)
    ...
    PUSH 0x61867e                       ; 0043c5a6 | = "Enter in Y radius : " | s_Enter_in_Y_radius_0061867e = Enter in Y radius :
    ...
    CALL engine_2d.c_getInputWithPrompt_FUN_004032c0 ; 0043c5c9 | int engine_2d.c_getInputWithPrompt_FUN_004032c0(char * buffer, int max_length, int x, int y, ...)
        ;   XREF to: 004032c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0043c5ce
    LEA EAX,[ESP + 0x3a8]               ; 0043c5d1
    PUSH EAX                            ; 0043c5d8
    CALL crt_string.c_strtod_FUN_005ff0f3 ; 0043c5d9 | double crt_string.c_strtod_FUN_005ff0f3(char * str)
        ;   XREF to: 005ff0f3 (UNCONDITIONAL_CALL)
    ...
    JMP 0x0043c4c8                      ; 0043c69f | LAB_0043c4c8
