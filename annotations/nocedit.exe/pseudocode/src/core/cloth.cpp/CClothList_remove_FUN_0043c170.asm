...
section .text
    ...
    JL 0x0043c184                       ; 0043c17a | LAB_0043c184
        ;   XREF to: 0043c184 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x14]      ; 0043c17c
    CMP EBP,dword ptr [EAX]             ; 0043c180
    JL 0x0043c1a7                       ; 0043c182 | LAB_0043c1a7
        ;   XREF to: 0043c1a7 (CONDITIONAL_JUMP)
    MOV ECX,0x61860f                    ; 0043c184 | = "..\\core\\cloth.cpp" | s_core_cloth_cpp_0061860f = ..\core\cloth.cpp
        ;   Label: LAB_0043c184
    MOV EBX,0x5e4                       ; 0043c189
    PUSH 0x618621                       ; 0043c18e | = "CClothList::remove - invalid index" | s_CClothList_remove_invali_00618621 = CClothList::remove - invalid index
    MOV dword ptr [0x02f0ca48],ECX      ; 0043c193 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 0043c199 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0043c19f | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    MOV ESI,0x618644                    ; 0043c1b9 | = "..\\core\\cloth.cpp" | s_core_cloth_cpp_00618644 = ..\core\cloth.cpp
    MOV dword ptr [0x02f0d944],EDI      ; 0043c1be | int g_CurrentDebugLine
    MOV EAX,dword ptr [EAX + 0x194]     ; 0043c1c4
    MOV dword ptr [0x0067d20c],ESI      ; 0043c1ca | char * g_CurrentDebugFilename
    TEST EAX,EAX                        ; 0043c1d0
    JZ 0x0043c1e8                       ; 0043c1d2 | LAB_0043c1e8
        ;   XREF to: 0043c1e8 (CONDITIONAL_JUMP)
    PUSH 0x0                            ; 0043c1d4
    PUSH EAX                            ; 0043c1d6
    CALL core_cloth.cpp_CallToUnknownSomethingFreeMem_FUN_00438c00 ; 0043c1d7 | undefined core_cloth.cpp_CallToUnknownSomethingFreeMem_FUN_00438c00()
        ;   XREF to: 00438c00 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0043c1dc
    PUSH EAX                            ; 0043c1df
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 0043c1e0 | void shape_memdbg.cpp_debugFree_FUN_0050f210(void * ptr)
    ...
    JGE 0x0043c250                      ; 0043c1ef | LAB_0043c250
    ...
    CMP AL,0x0                          ; 0043c21d
    JZ 0x0043c231                       ; 0043c21f | LAB_0043c231
    ...
    CMP AL,0x0                          ; 0043c22d
    JNZ 0x0043c219                      ; 0043c22f | LAB_0043c219
    ...
    JL 0x0043c211                       ; 0043c24d | LAB_0043c211
