...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_cloth.cpp_CCloth_load_FUN_00438cf0(CCloth * this_ptr, char * filename)
;
; Parameters:
...
;   core_gabriela.cpp_FUN_004d2c40 at 004d2c79
...
section .text
    ...
    PUSH 0x6181bc                       ; 00438d08 | = "rt" | s_rt_006181bc = rt
    PUSH EBX                            ; 00438d0d
    PUSH 0x6181bf                       ; 00438d0e | = "models" | s_models_006181bf = models
    CALL engine_dosio.c_getFile_FUN_00481a50 ; 00438d13 | FILE * engine_dosio.c_getFile_FUN_00481a50(char * directory, char * filename, char * mode)
        ;   XREF to: 00481a50 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00438d18
    MOV dword ptr [ESP + 0x208],EAX     ; 00438d1b
    TEST EAX,EAX                        ; 00438d22
    JZ 0x004391eb                       ; 00438d24 | LAB_004391eb
    ...
    PUSH EAX                            ; 00438d3e
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 00438d3f | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
    ...
    PUSH EDI                            ; 00438d53
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 00438d54 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [ESI + 0x3fe60]   ; 00438d59
    ADD ESP,0xc                         ; 00438d5f
    CMP EAX,0x3                         ; 00438d62
    JLE 0x00438d8e                      ; 00438d65 | LAB_00438d8e
        ;   XREF to: 00438d8e (CONDITIONAL_JUMP)
    PUSH 0x3                            ; 00438d67
    PUSH EAX                            ; 00438d69
    PUSH EBX                            ; 00438d6a
    MOV EDX,0x618202                    ; 00438d6b | = "..\\core\\cloth.cpp" | s_core_cloth_cpp_00618202 = ..\core\cloth.cpp
    MOV ECX,0xa2                        ; 00438d70
    PUSH 0x618214                       ; 00438d75 | = "%s is version %d, this .EXE is old an..." | s_s_is_version_d_this_EXE__00618214 = %s is version %d, this .EXE is old and can only handle up to version %d
    MOV dword ptr [0x02f0ca48],EDX      ; 00438d7a | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 00438d80 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00438d86 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    PUSH EAX                            ; 00438da2
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 00438da3 | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    PUSH EBP                            ; 00438db3
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 00438db4 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00438db9
    MOV EAX,ESP                         ; 00438dbc
    PUSH EAX                            ; 00438dbe
    PUSH ESI                            ; 00438dbf
    CALL core_dmodel.cpp_CKeyFramedModel_load_FUN_00476db0 ; 00438dc0 | void core_dmodel.cpp_CKeyFramedModel_load_FUN_00476db0(CKeyFramedModel * this_ptr, char * filename)
        ;   XREF to: 00476db0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00438dc5
    PUSH ESI                            ; 00438dc8
    CALL core_dmodel.cpp_CKeyFramedModel_captureTextures_FUN_00478190 ; 00438dc9 | void core_dmodel.cpp_CKeyFramedModel_captureTextures_FUN_00478190(CKeyFramedModel * this_ptr)
    ...
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 00438de5 | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    JGE 0x00439214                      ; 00438e19 | LAB_00439214
    ...
    PUSH EAX                            ; 00438e2a
    PUSH EBP                            ; 00438e2b
    PUSH 0x618260                       ; 00438e2c | = "%f,%f,%f,%f,%f,%f\n" | s_f_f_f_f_f_f_00618260 = %f,%f,%f,%f,%f,%f

    MOV EBX,dword ptr [ESP + 0x224]     ; 00438e31
    PUSH EBX                            ; 00438e38
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 00438e39 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    FLD float ptr [0x0065bb54]          ; 00438e3e | float FLOAT_0065bb54
    FLD float ptr [0x0065bb58]          ; 00438e44 | float FLOAT_0065bb58
    FLD float ptr [0x0065bb5c]          ; 00438e4a | float FLOAT_0065bb5c
    FLD float ptr [0x0065bb60]          ; 00438e50 | float FLOAT_0065bb60
    FLD float ptr [0x0065bb64]          ; 00438e56 | float FLOAT_0065bb64
    FLD float ptr [0x0065bb68]          ; 00438e5c | float FLOAT_0065bb68
    FLD float ptr [0x0065bb6c]          ; 00438e62 | float FLOAT_0065bb6c
    ...
    PUSH EAX                            ; 00438ebf
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 00438ec0 | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDI                            ; 00438ed4
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 00438ed5 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [ESI + 0x3fe60]   ; 00438eda
    ADD ESP,0xc                         ; 00438ee0
    CMP EAX,0x2                         ; 00438ee3
    JL 0x00439249                       ; 00438ee6 | LAB_00439249
        ;   XREF to: 00439249 (CONDITIONAL_JUMP)
    PUSH EDI                            ; 00438eec
    PUSH 0xff                           ; 00438eed
    LEA EAX,[ESP + 0x108]               ; 00438ef2
    PUSH EAX                            ; 00438ef9
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 00438efa | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDI                            ; 00438f0e
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 00438f0f | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00438f2b
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 00438f2c | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    PUSH EBX                            ; 00438f40
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 00438f41 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00438f46
    PUSH ESI                            ; 00438f49
    CALL core_cloth.cpp_CCloth_allocMemory_FUN_00438c50 ; 00438f4a | void core_cloth.cpp_CCloth_allocMemory_FUN_00438c50(CCloth * this_ptr)
    ...
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 00438f62 | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [ESI + 0x3f028]   ; 00438f67
    ADD ESP,0xc                         ; 00438f6d
    TEST EAX,EAX                        ; 00438f70
    JLE 0x00438fa0                      ; 00438f72 | LAB_00438fa0
    ...
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 00438f8c | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [ESI + 0x3f028]   ; 00438f91
    ADD ESP,0xc                         ; 00438f97
    CMP EBX,ECX                         ; 00438f9a
    JL 0x00438f7a                       ; 00438f9c | LAB_00438f7a
        ;   XREF to: 00438f7a (CONDITIONAL_JUMP)
    MOV EAX,EAX                         ; 00438f9e
    PUSH ESI                            ; 00438fa0
        ;   Label: LAB_00438fa0
    CALL core_cloth.cpp_ConnectingVerticesCheck_FUN_004394e0 ; 00438fa1 | undefined core_cloth.cpp_ConnectingVerticesCheck_FUN_004394e0()
    ...
    PUSH EAX                            ; 00438fbd
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 00438fbe | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    PUSH EBX                            ; 00438fd2
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 00438fd3 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00438fd8
    MOV EBP,dword ptr [ESI + 0x3ce8c]   ; 00438fdb
    XOR EBX,EBX                         ; 00438fe1
    TEST EBP,EBP                        ; 00438fe3
    JLE 0x00439170                      ; 00438fe5 | LAB_00439170
    ...
    PUSH EBP                            ; 004390a7
    PUSH EAX                            ; 004390a8
    PUSH 0x6182a0                       ; 004390a9 | = "\"%[^\"]\",%f,%f, %f,%f,%f, %f,%f,%f,..." | s_f_f_f_f_f_f_f_f_f_006182a0 = "%[^"]",%f,%f, %f,%f,%f, %f,%f,%f, %f

    MOV EAX,dword ptr [ESP + 0x234]     ; 004390ae
    PUSH EAX                            ; 004390b5
    ADD EDI,0xac                        ; 004390b6
    INC EBX                             ; 004390bc
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004390bd | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ...
    JL 0x0043905f                       ; 0043915d | LAB_0043905f
    ...
    PUSH 0x112                          ; 00439170
        ;   Label: LAB_00439170
    PUSH 0x6182c7                       ; 00439175 | = "..\\core\\cloth.cpp" | s_core_cloth_cpp_006182c7 = ..\core\cloth.cpp
    MOV EBX,dword ptr [ESP + 0x210]     ; 0043917a
    PUSH EBX                            ; 00439181
    XOR EDI,EDI                         ; 00439182
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 00439184 | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
        ;   XREF to: 0050f9b0 (UNCONDITIONAL_CALL)
    MOV EBP,dword ptr [ESI + 0x104]     ; 00439189
    ADD ESP,0xc                         ; 0043918f
    TEST EBP,EBP                        ; 00439192
    JLE 0x004391e0                      ; 00439194 | LAB_004391e0
    ...
    JL 0x0043919e                       ; 004391dc | LAB_0043919e
    ...
    PUSH EBX                            ; 004391eb
        ;   Label: LAB_004391eb
    MOV EDX,0x6181c6                    ; 004391ec | = "..\\core\\cloth.cpp" | s_core_cloth_cpp_006181c6 = ..\core\cloth.cpp
    MOV ECX,0x9b                        ; 004391f1
    PUSH 0x6181d8                       ; 004391f6 | = "CCloth::load - Unable to open file %s" | s_CCloth_load_Unable_to_op_006181d8 = CCloth::load - Unable to open file %s
    MOV dword ptr [0x02f0ca48],EDX      ; 004391fb | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 00439201 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00439207 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0043920c
    JMP 0x00438d2a                      ; 0043920f | LAB_00438d2a
    ...
    PUSH EAX                            ; 0043922d
    PUSH EBP                            ; 0043922e
    PUSH 0x618273                       ; 0043922f | = "%f,%f,%f,%f,%f,%f,%f,%f\n" | s_f_f_f_f_f_f_f_f_00618273 = %f,%f,%f,%f,%f,%f,%f,%f

    MOV EBX,dword ptr [ESP + 0x22c]     ; 00439234
    PUSH EBX                            ; 0043923b
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0043923c | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x28                        ; 00439241
    JMP 0x00438eab                      ; 00439244 | LAB_00438eab
        ;   XREF to: 00438eab (UNCONDITIONAL_JUMP)
    MOV dword ptr [ESI + 0x3ce84],0x0   ; 00439249
        ;   Label: LAB_00439249
    JMP 0x00438f17                      ; 00439253 | LAB_00438f17
