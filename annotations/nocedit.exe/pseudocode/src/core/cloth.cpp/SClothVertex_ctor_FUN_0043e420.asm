...
section .text
    ...
    PUSH 0x6598c0                       ; 0043e424 | WatcomTypeInfo g_CVectorTypeInfo
    PUSH 0x3                            ; 0043e429
    ADD EAX,0xec                        ; 0043e42b
    PUSH EAX                            ; 0043e430
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 0043e431 | void * crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
