...
;
; XREF[2]:
;   core_charactr.cpp_CCharacter_renderCharacter_FUN_00429aa0 at 00429b25
...
section .text
    ...
    PUSH EBX                            ; 0043c320
        ;   Label: core_cloth.cpp_CClothList_render_FUN_0043c320
    PUSH ESI                            ; 0043c321
    PUSH EDI                            ; 0043c322
    PUSH EBP                            ; 0043c323
    ...
    CALL core_cloth.cpp_CCloth_saveJoinedLight_FUN_0043b9f0 ; 0043c346
        ;   XREF to: 0043b9f0 (UNCONDITIONAL_CALL)  ; int core_cloth.cpp_CCloth_saveJoinedLight_FUN_0043b9f0(CCloth * this_ptr, CDeformableModelInstance * model_ptr)
