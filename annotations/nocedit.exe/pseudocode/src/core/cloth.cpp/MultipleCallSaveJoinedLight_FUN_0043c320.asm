...
section .text
    ...
    INC ESI                             ; 0043c345
    CALL core_cloth.cpp_CCloth_saveJoinedLight_FUN_0043b9f0 ; 0043c346 | int core_cloth.cpp_CCloth_saveJoinedLight_FUN_0043b9f0(CCloth * this_ptr)
        ;   XREF to: 0043b9f0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EDI]             ; 0043c34b
    ADD ESP,0x8                         ; 0043c34d
    CMP ESI,EAX                         ; 0043c350
    JL 0x0043c33a                       ; 0043c352 | LAB_0043c33a
    ...
    JLE 0x0043c390                      ; 0043c366 | LAB_0043c390
    ...
    INC ESI                             ; 0043c375
    CALL core_cloth.cpp_FUN_0043bae0    ; 0043c376 | undefined core_cloth.cpp_FUN_0043bae0()
        ;   XREF to: 0043bae0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EDI]             ; 0043c37b
    ADD ESP,0x8                         ; 0043c37d
    CMP ESI,EAX                         ; 0043c380
    JL 0x0043c36a                       ; 0043c382 | LAB_0043c36a
