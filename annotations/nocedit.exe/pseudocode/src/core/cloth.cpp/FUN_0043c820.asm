...
section .text
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 0043c82a | CDemonRenderer * g_CDemonRendererPtr
    ...
    MOV EDX,dword ptr [EDX]             ; 0043c854 | CDemonRenderer g_CDemonRendererInstance
    PUSH EBX                            ; 0043c856
    ADD EDX,0xea5d0                     ; 0043c857
    PUSH EDX                            ; 0043c85d
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 0043c85e | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0043c863
    PUSH 0x4e1f                         ; 0043c866
    CALL core_cloth.cpp_FUN_0043c6e0    ; 0043c86b | undefined core_cloth.cpp_FUN_0043c6e0()
