      ...
      do {
        ...
        if (0 < this_ptr_00->vertex_count[0]) {
          ...
          do {
            local_cc = 0.0;
            local_c8 = 0.0;
            puVar9 = this_ptr_00->vertex_data_ptr[0]->bone_indices + local_4c + -1;
            local_c4 = 0.0;
            pCVar8 = (CVector3f *)(puVar9 + 0x10);
            puVar24 = puVar9;
            puVar21 = puVar9;
            for (iVar14 = 0; puVar21 = puVar21 + 4, iVar14 < (int)(uint)*puVar9; iVar14 = iVar14 + 1
                ) {
              ...
              local_c8 = local_c8 + pCVar10->y * *(float *)puVar21;
              local_c4 = local_c4 + pCVar10->z * *(float *)puVar21;
            }
