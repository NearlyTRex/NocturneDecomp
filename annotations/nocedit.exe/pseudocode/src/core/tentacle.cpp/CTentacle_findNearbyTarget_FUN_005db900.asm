...
section .text
    ...
    PUSH EBX                            ; 005db900
        ;   Label: core_tentacle.cpp_CTentacle_findNearbyTarget_FUN_005db900
    PUSH ESI                            ; 005db901
    PUSH EDI                            ; 005db902
    PUSH EBP                            ; 005db903
    ...
    MOV EBX,dword ptr [EDI + EAX*0x1 + 0x14f09c] ; 005db92f | g_CDemonSetInstance.characters[0] | g_CDemonSetInstance.characters[1]
