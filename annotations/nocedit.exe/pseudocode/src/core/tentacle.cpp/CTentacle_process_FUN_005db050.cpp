...

{
  ...
  if (iVar3 != 0) {
    local_24 = &(this_ptr->base_enemy).base_character.base_actor.orient;
    local_28 = this_ptr->field1_0xbeb4 + 0x48;
    local_20 = &(this_ptr->base_enemy).base_character.base_actor.location.position;
    local_1c = (CVector3f *)&(this_ptr->base_enemy).base_character.model;
    while (0.0 < fStack_254) {
        ...
        if (uVar6 < 0x65) {
          ...
          if ((iVar3 != 0) && (iVar3 = (**(code **)(*(int *)(iVar3 + 0x154) + 0x108))(), iVar3 == 0)
            ...
            if (((ABS(fStack_44) <= (float)6) &&
              ...
              core_xform_cpp_multiplyMatrix3x4_FUN_005f4f10(&CStack_15c,&CStack_18c,pCVar11);
              pfVar8 = afStack_cc;
              pCVar12 = &CStack_12c;
              for (iVar3 = 0xc; iVar3 != 0; iVar3 = iVar3 + -1) {
                pCVar12->m[0].w = *pfVar8;
              ...
              core_xform_cpp_multiplyMatrix3x4_FUN_005f4f10(&CStack_12c,pCVar11,in_stack_fffffda4);
              puVar9 = auStack_fc;
      ...
      *(float *)(this_ptr->field1_0xbeb4 + 0xc) = fVar1;
      if (fVar1 < (float)25) {
        ...
        if (iVar3 != 0) {
          auStack_90._12_4_ =
               *(float *)(iVar3 + 0x20) -
               (float)((CMotionController *)&local_1c->x)->motion_list_ptr;
