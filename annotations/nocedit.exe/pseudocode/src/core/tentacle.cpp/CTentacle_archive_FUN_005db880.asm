...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_tentacle_cpp_CTentacle_archive_FUN_005db880(CTentacle *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005db880
        ;   Label: core_tentacle.cpp_CTentacle_archive_FUN_005db880
    PUSH ESI                            ; 005db881
    MOV EBX,dword ptr [ESP + 0xc]       ; 005db882
    PUSH EBX                            ; 005db886
    CALL core_enemy.cpp_CEnemy_archive_FUN_004a9660 ; 005db887
    ...
    PUSH ESI                            ; 005db89a
    CALL core_actor.cpp_archiveDeformableModelInstance_FUN_0040b970 ; 005db89b
    ...
    PUSH ESI                            ; 005db8b9
    CALL core_actor.cpp_archiveMotionState_FUN_0040b9f0 ; 005db8ba
    ...
    PUSH ESI                            ; 005db8f2
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 005db8f3
