...
section .text
    ...
    PUSH EBX                            ; 005dbcc0
        ;   Label: core_tentacle.cpp_CTentacle_addFilesToExtract_FUN_005dbcc0
    MOV EDX,dword ptr [ESP + 0xc]       ; 005dbcc1
    PUSH EDX                            ; 005dbcc5
    MOV ECX,dword ptr [ESP + 0xc]       ; 005dbcc6
    PUSH ECX                            ; 005dbcca
    CALL core_actor.cpp_CDemonActor_addFilesToExtract_FUN_0040cfd0 ; 005dbccb
    ...
    PUSH EAX                            ; 005dbce1
    CALL core_skeledit.cpp_CDeformableModelInstance_addFilesToExtract_FUN_0058a260 ; 005dbce2
