...
;                               FUNCTION
; *****************************************************************************
; __cdecl CTentacle * __cdecl core_tentacle_cpp_CTentacle_dtor_FUN_005dbcf0 (CTentacle *this_ptr,uint d1,uint d2,uint d3,uint d4,uint d5,uint d6,uint d7,uint d8)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005dbd08
    CALL core_backgnd.cpp_freeFlames_FUN_00412720 ; 005dbd09
    ...
    PUSH EAX                            ; 005dbd18
    CALL core_backgnd.cpp_freeFires_FUN_00412700 ; 005dbd19
    ...
    PUSH EAX                            ; 005dbd28
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 005dbd29
    ...
    PUSH EAX                            ; 005dbd38
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 005dbd39
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; int core_backgnd.cpp_cleanupVector_FUN_004126e0(CVector3f * * objs)
    ADD ESP,0x8                         ; 005dbd3e
    PUSH 0x0                            ; 005dbd41
    SUB EAX,0x1c8                       ; 005dbd43
    PUSH EAX                            ; 005dbd48
    CALL core_cloth.cpp_FUN_0043bf80    ; 005dbd49
    ...
    PUSH 0x6645e0                       ; 005dbd81 | g_CTentacleTypeInfo
        ;   Label: LAB_005dbd81
    PUSH EBX                            ; 005dbd86
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 005dbd87
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 005dbd8c
    PUSH EAX                            ; 005dbd8f
    CALL crt_memory.c_free_FUN_005fe659 ; 005dbd90
    ...
    PUSH EAX                            ; 005dbd9c
        ;   Label: LAB_005dbd9c
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 005dbd9d
