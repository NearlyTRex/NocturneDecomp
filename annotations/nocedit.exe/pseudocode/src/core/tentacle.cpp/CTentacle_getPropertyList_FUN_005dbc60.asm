...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_tentacle_cpp_CTentacle_getPropertyList_FUN_005dbc60 (CTentacle *this_ptr,CActorPropertyList *property_list)
;
; Parameters:
...
section .text
    ...
    PUSH ESI                            ; 005dbc83
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e4a0 ; 005dbc84
    ...
    PUSH ESI                            ; 005dbc92
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e4d0 ; 005dbc93
    ...
    PUSH ESI                            ; 005dbcb0
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e350 ; 005dbcb1
