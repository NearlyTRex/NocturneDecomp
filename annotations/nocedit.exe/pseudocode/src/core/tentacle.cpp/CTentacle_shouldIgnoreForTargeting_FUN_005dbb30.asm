...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_tentacle_cpp_CTentacle_shouldIgnoreForTargeting_FUN_005dbb30(CTentacle *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBP                            ; 005dbb30
        ;   Label: core_tentacle.cpp_CTentacle_shouldIgnoreForTargeting_FUN_005dbb30
