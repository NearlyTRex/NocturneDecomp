...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_tentacle_cpp_CTentacle_FUN_005dbb70(CTentacle *this_ptr)
;
; Parameters:
...
;
; XREF[2]:
;   core_tentacle.cpp_CTentacle_FUN_005db9d0 at 005dba57
...
section .text
    ...
    PUSH EBX                            ; 005dbb70
        ;   Label: core_tentacle.cpp_CTentacle_FUN_005dbb70
    PUSH EDI                            ; 005dbb71
    PUSH EBP                            ; 005dbb72
