...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_tentacle.cpp_CTentacle_FUN_005dbcc0(CTentacle * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH ECX                            ; 005dbcca
    CALL core_actor.cpp_CDemonActor_writeDependencies_FUN_0040cfd0 ; 005dbccb | void core_actor.cpp_CDemonActor_writeDependencies_FUN_0040cfd0(CDemonActor * this_ptr, FILE * file_handle)
    ...
    PUSH EAX                            ; 005dbce1
    CALL core_skeledit.cpp_GetModelPtrOfFile_FUN_0058a260 ; 005dbce2 | undefined core_skeledit.cpp_GetModelPtrOfFile_FUN_0058a260()
