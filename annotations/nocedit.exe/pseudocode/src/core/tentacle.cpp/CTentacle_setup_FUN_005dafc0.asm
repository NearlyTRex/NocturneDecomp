...
section .text
    ...
    PUSH EBX                            ; 005db003
    MOV [0x03f6cd08],EAX                ; 005db004 | INT_03f6cd08
    ...
    PUSH EBX                            ; 005db018
    MOV [0x03f6cd0c],EAX                ; 005db019 | INT_03f6cd0c
