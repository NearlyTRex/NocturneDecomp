...
section .text
    ...
    PUSH EBX                            ; 0048f5b8
    CALL core_backgnd.cpp_freeFlames_FUN_00412720 ; 0048f5b9
    ...
    PUSH EAX                            ; 0048f5c8
    CALL core_backgnd.cpp_freeFires_FUN_00412700 ; 0048f5c9
    ...
    PUSH EAX                            ; 0048f5d8
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 0048f5d9
    ...
    PUSH EAX                            ; 0048f5e8
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 0048f5e9
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; int core_backgnd.cpp_cleanupVector_FUN_004126e0(CVector3f * * objs)
    ADD ESP,0x8                         ; 0048f5ee
    PUSH 0x0                            ; 0048f5f1
    SUB EAX,0x1c8                       ; 0048f5f3
    PUSH EAX                            ; 0048f5f8
    CALL core_cloth.cpp_FUN_0043bf80    ; 0048f5f9
    ...
    PUSH 0x65d230                       ; 0048f631 | g_CDroneTypeInfo
        ;   Label: LAB_0048f631
    PUSH EBX                            ; 0048f636
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 0048f637
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 0048f63c
    PUSH EAX                            ; 0048f63f
    CALL crt_memory.c_free_FUN_005fe659 ; 0048f640
    ...
    PUSH EAX                            ; 0048f64c
        ;   Label: LAB_0048f64c
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 0048f64d
