...
;                               FUNCTION
; *****************************************************************************
; __cdecl CDrone * __cdecl core_drone_cpp_CDrone_dtor_FUN_0048f5a0(CDrone *this_ptr,uint flags)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0048f5b8
    CALL core_armour.cpp_freeFlames_FUN_00412720 ; 0048f5b9
    ...
    PUSH EAX                            ; 0048f5c8
    CALL core_armour.cpp_freeFires_FUN_00412700 ; 0048f5c9
    ...
    PUSH EAX                            ; 0048f5d8
    CALL core_armour.cpp_freeVectors_FUN_004126e0 ; 0048f5d9
    ...
    PUSH EAX                            ; 0048f5e8
    CALL core_armour.cpp_freeVectors_FUN_004126e0 ; 0048f5e9
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; CVector3f * core_armour.cpp_freeVectors_FUN_004126e0(CVector3f * objs)
