...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_drone_cpp_CDrone_randomize_FUN_0048f560(CDrone *this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x4]       ; 0048f560
        ;   Label: core_drone.cpp_CDrone_randomize_FUN_0048f560
    PUSH EDX                            ; 0048f564
    CALL core_enemy.cpp_CEnemy_randomize_FUN_004aa250 ; 0048f565
