...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_drone_cpp_CDrone_archive_FUN_0048f2f0(CDrone *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0048f2f0
        ;   Label: core_drone.cpp_CDrone_archive_FUN_0048f2f0
    MOV EBX,dword ptr [ESP + 0x8]       ; 0048f2f1
    PUSH EBX                            ; 0048f2f5
    CALL core_enemy.cpp_CEnemy_archive_FUN_004a9660 ; 0048f2f6
    ...
    PUSH EAX                            ; 0048f309
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 0048f30a
    ...
    PUSH EAX                            ; 0048f31d
    CALL core_actor.cpp_archiveDeformableModelInstance_FUN_0040b970 ; 0048f31e
    ...
    PUSH EBX                            ; 0048f33c
    CALL core_actor.cpp_archiveMotionState_FUN_0040b9f0 ; 0048f33d
    ...
    PUSH EAX                            ; 0048f352
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 0048f353
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
