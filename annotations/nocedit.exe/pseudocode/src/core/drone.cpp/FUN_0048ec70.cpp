...

{
  ...
  *(float *)((in_stack_00000004->base).unk1 + 0x28) =
       (in_stack_00000004->base).model.accumulated_root_motion.z * fVar4;
  ...
  if (iVar9 == 0) {
    ...
    case 1:
      ...
      if (*(int *)(in_stack_00000004->unk2 + 4) == 0) {
        ...
        if (iVar7 < 0) {
        ...
        else if ((0 < iVar7) && (*(float *)in_stack_00000004->unk2 <= 0.0)) {
          core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                    (&this_ptr->motion_controller,2,1);
          uVar3 = *(uint *)(in_stack_00000004[1].base.base.actor_name + 0x1c);
          ...
          if (iVar7 == 0) {
            uVar12 = (*((in_stack_00000004->base).base.vtable._ub)->playSound)
                               ((CDemonActor *)in_stack_00000004,"drone-attack?.wav");
            *(uint *)(in_stack_00000004[1].base.base.actor_name + 0x1c) = uVar12;
          }
        }
      }
      break;
    ...
    case 8:
      ...
      break;
    case 9:
      if (*(int *)((in_stack_00000004->base).unk1 + 4) != 0) {
        core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
...
switchD_0048f284_caseD_3:
  ...
  if ((local_1c == 1) &&
     (iVar7 = sound_sndmain_cpp_isWithinListenerRadius_FUN_005aa290
                        ((double)(in_stack_00000004->base).base.location.position.x,
                         (double)(in_stack_00000004->base).base.location.position.y,
                         (double)(in_stack_00000004->base).base.location.position.z,50.0),
     iVar7 != 0)) {
    ...
    if (iVar7 == 0) {
      ...
      uVar12 = (*((in_stack_00000004->base).base.vtable._ub)->playAmbientSound)
                         ((CDemonActor *)in_stack_00000004,"slime.wav");
      *(uint *)(in_stack_00000004[1].base.base.actor_name + 0x18) = uVar12;
  ...
  if (iVar7 != 0) {
    ...
    *(float *)((in_stack_00000004->base).unk1 + 0x20) =
    ...
    local_7c = *(float *)((in_stack_00000004->base).unk1 + 0x1c) * in_stack_00000008;
    local_78 = *(float *)((in_stack_00000004->base).unk1 + 0x20) * in_stack_00000008;
    pcVar1 = (in_stack_00000004->base).unk1 + 0x10;
    local_74 = in_stack_00000008 * *(float *)((in_stack_00000004->base).unk1 + 0x24);
    pCVar11 = &(in_stack_00000004->base).model.accumulated_root_motion;
    local_70 = local_7c + *(float *)pcVar1;
    local_6c = local_78 + *(float *)((in_stack_00000004->base).unk1 + 0x14);
    local_68 = local_74 + *(float *)((in_stack_00000004->base).unk1 + 0x18);
    local_40 = local_70 + pCVar11->x;
    local_3c = local_6c + (in_stack_00000004->base).model.accumulated_root_motion.y;
    local_38 = local_68 + (in_stack_00000004->base).model.accumulated_root_motion.z;
    ...
    *(float *)pcVar1 = *(float *)((in_stack_00000004->base).unk1 + 0x14);
    (in_stack_00000004->base).model.accumulated_root_motion.z = 0.0;
    fVar2 = (in_stack_00000004->base).model.accumulated_root_motion.z;
    (in_stack_00000004->base).model.accumulated_root_motion.y = fVar2;
    pCVar11->x = fVar2;
