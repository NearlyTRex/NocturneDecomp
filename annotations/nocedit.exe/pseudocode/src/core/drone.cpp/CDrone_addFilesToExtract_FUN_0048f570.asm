...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_drone_cpp_CDrone_addFilesToExtract_FUN_0048f570(CDrone *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0048f570
        ;   Label: core_drone.cpp_CDrone_addFilesToExtract_FUN_0048f570
    MOV EDX,dword ptr [ESP + 0xc]       ; 0048f571
    PUSH EDX                            ; 0048f575
    MOV ECX,dword ptr [ESP + 0xc]       ; 0048f576
    PUSH ECX                            ; 0048f57a
    CALL core_actor.cpp_CDemonActor_addFilesToExtract_FUN_0040cfd0 ; 0048f57b
    ...
    PUSH EAX                            ; 0048f591
    CALL core_skeledit.cpp_CDeformableModelInstance_addFilesToExtract_FUN_0058a260 ; 0048f592
