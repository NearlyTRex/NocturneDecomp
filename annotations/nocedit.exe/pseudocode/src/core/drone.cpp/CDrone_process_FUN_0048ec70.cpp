...

{
  ...
  (this_ptr->base).base.walk_step_speed =
       (this_ptr->base).base.model.accumulated_root_motion.z * fVar10;
  (this_ptr->base).base.turn_speed = delta_time * fVar3 * fVar2 * fVar11 * fVar10;
...
switchD_0048f284_caseD_3:
  ...
  core_charactr_cpp_CCharacter_applyGestureLookAt_FUN_0042dfc0
            ((CCharacter *)this_ptr,delta_time,in_stack_ffffff24);
  return;
}
