...

{
  ...
  *(float *)((this_ptr->base).base.unk1 + 0x2c) = delta_time * fVar6 * fVar2 * fVar5 * fVar4;
...
switchD_0048f284_caseD_3:
  ...
  {
    iVar8 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660(*(uint *)(this_ptr->unk + 0x18));
    if (iVar8 == 0) {
  ...
  if (iVar8 != 0) {
    ...
    if ((iVar8 != 0) &&
       (pCVar11 = (CDrone *)(**(code **)(*(int *)(iVar8 + 0x154) + 0x108))(), pCVar11 == this_ptr))
    {
    ...
    *(float *)((this_ptr->base).base.unk1 + 0x20) =
    ...
    local_7c = *(float *)((this_ptr->base).base.unk1 + 0x1c) * delta_time;
    local_78 = *(float *)((this_ptr->base).base.unk1 + 0x20) * delta_time;
    pcVar1 = (this_ptr->base).base.unk1 + 0x10;
    local_74 = delta_time * *(float *)((this_ptr->base).base.unk1 + 0x24);
    pCVar12 = &(this_ptr->base).base.model.accumulated_root_motion;
    local_70 = local_7c + *(float *)pcVar1;
    local_6c = local_78 + *(float *)((this_ptr->base).base.unk1 + 0x14);
    local_68 = local_74 + *(float *)((this_ptr->base).base.unk1 + 0x18);
    local_40 = local_70 + pCVar12->x;
