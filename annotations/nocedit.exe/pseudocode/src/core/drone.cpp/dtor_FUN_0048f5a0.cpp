...
// Convention: __cdecl
// Signature: CDrone * __cdecl core_drone_cpp_dtor_FUN_0048f5a0 (CDrone *this_ptr,uint d1,uint d2,uint d3,uint d4,uint d5,uint d6,uint d7,uint d8)
...

{
  ...
  if ((d1 & 4) != 0) {
    ptr_00 = __vec_delete(this_ptr,&g_CDroneTypeInfo);
