...
// Convention: __cdecl
// Signature: CMineCar * __cdecl core_minecar_cpp_factoryFunc_FUN_00520e50(void)
...

{
  ...
  this_ptr = (CPlatform *)shape_memdbg_cpp_debugAllocTracked_FUN_0050f1b0(0x730,"..\\core\\minecar.cpp",0x39)
  ;
