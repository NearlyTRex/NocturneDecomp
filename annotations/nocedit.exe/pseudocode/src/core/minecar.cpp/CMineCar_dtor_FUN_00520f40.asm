...
;                               FUNCTION
; *****************************************************************************
; __cdecl CMineCar * __cdecl core_minecar_cpp_CMineCar_dtor_FUN_00520f40(CMineCar *this_ptr,uint d1,uint d2,uint d3)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00520f40
        ;   Label: core_minecar.cpp_CMineCar_dtor_FUN_00520f40
    ...
    PUSH 0x6616c0                       ; 00520f7d | g_CMineCarTypeInfo
        ;   Label: LAB_00520f7d
    PUSH EBX                            ; 00520f82
    CALL crt_memory.c___vec_delete_FUN_005fe632 ; 00520f83
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c___vec_delete_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 00520f88
    PUSH EAX                            ; 00520f8b
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 00520f8c
