...
// Convention: __cdecl
// Signature: CMineCar * __cdecl core_minecar_cpp_CMineCar_dtor_FUN_00520f40(CMineCar *this_ptr,uint d1,uint d2,uint d3)

#include "nocturne.h"

CMineCar * __cdecl
core_minecar_cpp_CMineCar_dtor_FUN_00520f40(CMineCar *this_ptr,uint d1,uint d2,uint d3)
