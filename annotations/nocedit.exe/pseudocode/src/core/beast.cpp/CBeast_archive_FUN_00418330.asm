...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_beast_cpp_CBeast_archive_FUN_00418330(CBeast *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00418330
        ;   Label: core_beast.cpp_CBeast_archive_FUN_00418330
    PUSH ESI                            ; 00418331
    MOV ESI,dword ptr [ESP + 0xc]       ; 00418332
    PUSH ESI                            ; 00418336
    CALL core_enemy.cpp_CEnemy_archive_FUN_004a9660 ; 00418337
    ...
    PUSH EBX                            ; 0041834a
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 0041834b
    ...
    PUSH EBX                            ; 0041835e
    CALL core_actor.cpp_archiveDeformableModelInstance_FUN_0040b970 ; 0041835f
    ...
    PUSH EBX                            ; 0041836c
    CALL core_actor.cpp_archiveMotionState_FUN_0040b9f0 ; 0041836d
