...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_beast_cpp_CBeast_hasCollision_FUN_00418400(CBeast *this_ptr,SCollisionInfo *collision_info)
;
; Parameters:
...
section .text
    ...
    MOV EAX,dword ptr [ESP + 0x8]       ; 00418400
        ;   Label: core_beast.cpp_CBeast_hasCollision_FUN_00418400
