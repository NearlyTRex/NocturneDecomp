...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_beast_cpp_CBeast_writeDependencies_FUN_00418460(CBeast *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00418460
        ;   Label: core_beast.cpp_CBeast_writeDependencies_FUN_00418460
    ...
    PUSH EAX                            ; 00418481
    CALL core_skeledit.cpp_CDeformableModelInstance_writeDependencies_FUN_0058a260 ; 00418482
