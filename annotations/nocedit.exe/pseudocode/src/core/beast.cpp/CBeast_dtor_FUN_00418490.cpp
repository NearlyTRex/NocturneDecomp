...
{
  CBeast_ptr_13260 pCVar1;
  CBeast_ptr_12060 pSVar1;
  CBeast_ptr_11536 pCVar2;
  CBeast_ptr_11356 pCVar3;
  CBeast_ptr_10900 pCVar4;
  CBeast_ptr_344 pCVar5;
  CDemonActor *ptr;
  void *ptr_00;
