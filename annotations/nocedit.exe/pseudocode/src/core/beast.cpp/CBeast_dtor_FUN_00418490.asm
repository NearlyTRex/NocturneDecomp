...
section .text
    ...
    PUSH EBX                            ; 004184a8
    CALL core_armour.cpp_CFlame_arrdtor_FUN_00412720 ; 004184a9
    ...
    PUSH EAX                            ; 004184b8
    CALL core_armour.cpp_SFire_arrdtor_FUN_00412700 ; 004184b9
    ...
    PUSH EAX                            ; 004184c8
    CALL core_armour.cpp_CVector3f_arrdtor_FUN_004126e0 ; 004184c9
    ...
    PUSH EAX                            ; 004184d8
    CALL core_armour.cpp_CVector3f_arrdtor_FUN_004126e0 ; 004184d9
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; CVector3f * core_armour.cpp_CVector3f_arrdtor_FUN_004126e0(CVector3f * this_ptr, uint flags)
