...
section .text
    ...
    PUSH EBX                            ; 004184a8
    CALL core_armour.cpp_CFlame_arrdtor50_FUN_00412720 ; 004184a9
    ...
    PUSH EAX                            ; 004184b8
    CALL core_armour.cpp_SFire_arrdtor50_FUN_00412700 ; 004184b9
    ...
    PUSH EAX                            ; 004184c8
    CALL core_armour.cpp_CVector3f_arrdtor15_FUN_004126e0 ; 004184c9
    ...
    PUSH EAX                            ; 004184d8
    CALL core_armour.cpp_CVector3f_arrdtor15_FUN_004126e0 ; 004184d9
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; CVector3f * core_armour.cpp_CVector3f_arrdtor15_FUN_004126e0(CVector3f * this_ptr, uint flags)
    ADD ESP,0x8                         ; 004184de
    PUSH 0x0                            ; 004184e1
    SUB EAX,0x1c8                       ; 004184e3
    PUSH EAX                            ; 004184e8
    CALL core_cloth.cpp_CClothList_dtor_FUN_0043bf80 ; 004184e9
    ...
    PUSH EAX                            ; 0041853c
        ;   Label: LAB_0041853c
    CALL shape_memdbg.cpp_debugFreeChecked_FUN_0050f210 ; 0041853d
