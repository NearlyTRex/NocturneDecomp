...
section .text
    ...
    PUSH EBX                            ; 004184a8
    CALL core_backgnd.cpp_freeFlames_FUN_00412720 ; 004184a9
    ...
    PUSH EAX                            ; 004184b8
    CALL core_backgnd.cpp_freeFires_FUN_00412700 ; 004184b9
    ...
    PUSH EAX                            ; 004184c8
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 004184c9
    ...
    PUSH EAX                            ; 004184d8
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 004184d9
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; int core_backgnd.cpp_cleanupVector_FUN_004126e0(CVector3f * * objs)
    ...
    PUSH 0x65abd0                       ; 00418521 | g_CBeastTypeInfo
        ;   Label: LAB_00418521
    PUSH EBX                            ; 00418526
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 00418527
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 0041852c
    PUSH EAX                            ; 0041852f
    CALL crt_memory.c_free_FUN_005fe659 ; 00418530
