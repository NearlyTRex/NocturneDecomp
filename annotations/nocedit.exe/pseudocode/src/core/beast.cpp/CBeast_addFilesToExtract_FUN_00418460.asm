...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_beast_cpp_CBeast_addFilesToExtract_FUN_00418460(CBeast *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00418460
        ;   Label: core_beast.cpp_CBeast_addFilesToExtract_FUN_00418460
    MOV EDX,dword ptr [ESP + 0xc]       ; 00418461
    PUSH EDX                            ; 00418465
    MOV ECX,dword ptr [ESP + 0xc]       ; 00418466
    PUSH ECX                            ; 0041846a
    CALL core_actor.cpp_CDemonActor_addFilesToExtract_FUN_0040cfd0 ; 0041846b
    ...
    PUSH EAX                            ; 00418481
    CALL core_skeledit.cpp_CDeformableModelInstance_addFilesToExtract_FUN_0058a260 ; 00418482
