...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_beast_cpp_FUN_00418420(void)
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH ESI                            ; 0041842a
    PUSH EBX                            ; 0041842b
    CALL core_enemy.cpp_CEnemy_FUN_004aa170 ; 0041842c
    ...
    PUSH ESI                            ; 00418442
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e4a0 ; 00418443
    ...
    PUSH ESI                            ; 00418451
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e4d0 ; 00418452
