      ...
      if (rendering_mode < 5) {
        ...
        case 0xc:
          color = core_ground_cpp_getGroundTypeColor_FUN_004eee20
                            ((uint)((uchar *)this_ptr->ground_type_memory)[local_14]);
...
override_jmp_0045776e_case_0:
        ...
        local_3c = pCVar2[local_14].triangle.normal.x;
        local_38 = pCVar2[local_14].triangle.normal.y;
        local_34 = pCVar2[local_14].triangle.normal.z;
      ...
      core_dcube_cpp_buildAndRenderTrianglePrimitive_FUN_004566e0
                (this_ptr->triangle_buffer[local_14].triangle.vertices,
