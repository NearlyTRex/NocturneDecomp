...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dcube.cpp_CDemonCube_buildVoxelOccupancyGrid_FUN_00457cf0(SVoxelGridParams * params)
;
; Parameters:
...
section .text
    ...
    JZ 0x00457e6b                       ; 00457cfc | LAB_00457e6b
    ...
    JNZ 0x00457e71                      ; 00457d30 | LAB_00457e71
        ;   XREF to: 00457e71 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x2c]          ; 00457d36
        ;   Label: LAB_00457d36
    FDIV float ptr [0x0061a84e]         ; 00457d3a | float g_VoxelSubdivisionCount
    FLD float ptr [0x0061a852]          ; 00457d40 | float g_VoxelSubdivisionReciprocal
    ...
    JNZ 0x00457e8e                      ; 00457d68 | LAB_00457e8e
    ...
    CALL core_dcube.cpp_CDemonCube_testAABBIntersection_FUN_00457ca0 ; 00457df7 | int core_dcube.cpp_CDemonCube_testAABBIntersection_FUN_00457ca0(CDemonCube * this_ptr, CVector3f * aabb_min, CVector3f * aabb_max)
        ;   XREF to: 00457ca0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00457dfc
    TEST EAX,EAX                        ; 00457dff
    JZ 0x00457e0e                       ; 00457e01 | LAB_00457e0e
        ;   XREF to: 00457e0e (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESI]             ; 00457e03
    MOV DL,byte ptr [EBX + 0x66ed90]    ; 00457e05 | uchar[8] g_VoxelGridBitmasks
    OR byte ptr [EDI + EAX*0x1],DL      ; 00457e0b
    INC EBX                             ; 00457e0e
        ;   Label: LAB_00457e0e
    CMP EBX,0x8                         ; 00457e0f
    JL 0x00457dd1                       ; 00457e12 | LAB_00457dd1
    ...
    JL 0x00457da5                       ; 00457e2a | LAB_00457da5
    ...
    JL 0x00457d78                       ; 00457e47 | LAB_00457d78
    ...
    JMP 0x00457d36                      ; 00457e89 | LAB_00457d36
    ...
    JMP 0x00457d6e                      ; 00457ea6 | LAB_00457d6e
