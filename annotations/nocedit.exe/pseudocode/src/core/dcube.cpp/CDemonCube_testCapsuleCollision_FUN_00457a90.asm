...
section .text
    ...
    JLE 0x00457acc                      ; 00457aa4 | LAB_00457acc
    ...
    PUSH EAX                            ; 00457ab2
    CALL core_dcube.cpp_intersectTriangleWithXZCapsule_FUN_00455a30 ; 00457ab3 | uint core_dcube.cpp_intersectTriangleWithXZCapsule_FUN_00455a30(CVector3f * * triangle_vertices, SIntersectXZCylinder * cylinder)
        ;   XREF to: 00455a30 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00457ab8
    TEST EAX,EAX                        ; 00457abb
    JZ 0x00457ac1                       ; 00457abd | LAB_00457ac1
    ...
    JL 0x00457aa8                       ; 00457aca | LAB_00457aa8
        ;   XREF to: 00457aa8 (CONDITIONAL_JUMP)
    TEST EBP,EBP                        ; 00457acc
        ;   Label: LAB_00457acc
    JL 0x00457b20                       ; 00457ace | LAB_00457b20
    ...
    CMP EAX,0x15c4800                   ; 00457adb | CVector3f g_TempNormal0
    JNZ 0x00457b25                      ; 00457ae0 | LAB_00457b25
    ...
    CMP EAX,0x15c480c                   ; 00457aee | CVector3f g_TempNormal1
    JZ 0x00457b0f                       ; 00457af3 | LAB_00457b0f
    ...
    FSTP float ptr [0x015c480c]         ; 00457b09 | CVector3f g_TempNormal1
    SHL EBP,0x5                         ; 00457b0f
        ;   Label: LAB_00457b0f
    MOV EAX,dword ptr [EDI + 0x2c]      ; 00457b12
    MOV EAX,dword ptr [EAX + EBP*0x1 + 0x8] ; 00457b15
    CMP EAX,0x15c4818                   ; 00457b19 | CVector3f g_TempNormal2
    JNZ 0x00457b41                      ; 00457b1e | LAB_00457b41
    ...
    FSTP float ptr [0x015c4800]         ; 00457b39 | CVector3f g_TempNormal0
    JMP 0x00457ae2                      ; 00457b3f | LAB_00457ae2
    ...
    FSTP float ptr [0x015c4818]         ; 00457b55 | CVector3f g_TempNormal2
    POP EBP                             ; 00457b5b
    POP EDI                             ; 00457b5c
    POP ESI                             ; 00457b5d
    POP EBX                             ; 00457b5e
