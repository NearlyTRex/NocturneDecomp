...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dcube.cpp_clipPolygonAgainstMaxZ_FUN_00455070(float max_z_plane)
;
; Parameters:
...
section .text
    ...
    MOV EBX,dword ptr [0x015c473c]      ; 0045507c | uint g_CubeClippedTriangleCount
    MOV EDX,dword ptr [EBP + 0x14]      ; 00455082
    MOV dword ptr [ESP],EDX             ; 00455085
    MOV EDX,dword ptr [0x015c4678]      ; 00455088 | uint g_CubeClipStage5Count
    XOR EDI,EDI                         ; 0045508e
    TEST EDX,EDX                        ; 00455090
    JLE 0x00455117                      ; 00455092 | LAB_00455117
        ;   XREF to: 00455117 (CONDITIONAL_JUMP)
    MOV ESI,0x15c467c                   ; 00455098 | CVector3f[16] g_ClipStageMinZBuffer
    MOV EAX,[0x015c4678]                ; 0045509d | uint g_CubeClipStage5Count
        ;   Label: LAB_0045509d
    LEA ECX,[EDI + 0x1]                 ; 004550a2
    CMP ECX,EAX                         ; 004550a5
    JNZ 0x004550ab                      ; 004550a7 | LAB_004550ab
        ;   XREF to: 004550ab (CONDITIONAL_JUMP)
    XOR ECX,EAX                         ; 004550a9
    IMUL ECX,ECX,0xc                    ; 004550ab
        ;   Label: LAB_004550ab
    MOV EAX,0x15c467c                   ; 004550ae | CVector3f[16] g_ClipStageMinZBuffer
    FLD float ptr [ESI + 0x8]           ; 004550b3 | g_ClipStageMinZBuffer[0].z
    ADD EAX,ECX                         ; 004550b6
    MOV EDX,ESI                         ; 004550b8 | CVector3f[16] g_ClipStageMinZBuffer
    MOV dword ptr [ESP + 0x4],EAX       ; 004550ba | DAT_015c4694
    XOR ECX,ECX                         ; 004550be
    FCOMP float ptr [ESP]               ; 004550c0
    FNSTSW AX                           ; 004550c3
    SAHF                                ; 004550c5
    JBE 0x004550cd                      ; 004550c6 | LAB_004550cd
        ;   XREF to: 004550cd (CONDITIONAL_JUMP)
    MOV ECX,0x1                         ; 004550c8
    MOV EAX,dword ptr [ESP + 0x4]       ; 004550cd
        ;   Label: LAB_004550cd
    FLD float ptr [EAX + 0x8]           ; 004550d1 | g_ClipStageMinZBuffer[0].z
    FCOMP float ptr [ESP]               ; 004550d4
    FNSTSW AX                           ; 004550d7
    SAHF                                ; 004550d9
    JBE 0x004550df                      ; 004550da | LAB_004550df
        ;   XREF to: 004550df (CONDITIONAL_JUMP)
    OR CL,0x2                           ; 004550dc
    CMP ECX,0x3                         ; 004550df
        ;   Label: LAB_004550df
    JA 0x00455109                       ; 004550e2 | caseD_3
        ;   XREF to: 00455109 (CONDITIONAL_JUMP)
    JMP dword ptr [ECX*0x4 + 0x455054]  ; 004550e4 | void * PTR_caseD_3_00455060 | PTR_caseD_1_00455058 = 00455124
        ;   Label: switchD
    IMUL ECX,EBX,0xc                    ; 004550eb
        ;   Label: caseD_0
    ADD ECX,0x15c4740                   ; 004550ee | CVector3f[16] g_CubeClippedTriangleBuffer
    CMP ECX,EDX                         ; 004550f4
    JZ 0x00455108                       ; 004550f6 | LAB_00455108
        ;   XREF to: 00455108 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EDX]             ; 004550f8 | CVector3f[16] g_ClipStageMinZBuffer
    MOV dword ptr [ECX],EAX             ; 004550fa | CVector3f[16] g_CubeClippedTriangleBuffer
    ...
    INC EBX                             ; 00455108
        ;   Label: LAB_00455108
    MOV ECX,dword ptr [0x015c4678]      ; 00455109 | uint g_CubeClipStage5Count
        ;   Label: caseD_3
    INC EDI                             ; 0045510f
    ADD ESI,0xc                         ; 00455110
    CMP EDI,ECX                         ; 00455113
    JL 0x0045509d                       ; 00455115 | LAB_0045509d
        ;   XREF to: 0045509d (CONDITIONAL_JUMP)
    MOV dword ptr [0x015c473c],EBX      ; 00455117 | uint g_CubeClippedTriangleCount
        ;   Label: LAB_00455117
    ...
    PUSH 0x0                            ; 0045513b
    PUSH 0x0                            ; 0045513d
    ADD ECX,0x15c4740                   ; 0045513f | CVector3f[16] g_CubeClippedTriangleBuffer
    PUSH ECX                            ; 00455145
    PUSH EDX                            ; 00455146 | CVector3f[16] g_ClipStageMinZBuffer
    MOV EAX,dword ptr [ESP + 0x2c]      ; 00455147
    PUSH EAX                            ; 0045514b
    MOV dword ptr [0x015c473c],EBX      ; 0045514c | uint g_CubeClippedTriangleCount
    CALL core_dcube.cpp_clipEdgeToPlane_FUN_004547d0 ; 00455152 | void core_dcube.cpp_clipEdgeToPlane_FUN_004547d0(CVector3f * vertex1, CVector3f * vertex2, CVector3f * output_vertex, double plane_nx, ...)
        ;   XREF to: 004547d0 (UNCONDITIONAL_CALL)
    MOV EBX,dword ptr [0x015c473c]      ; 00455157 | uint g_CubeClippedTriangleCount
    ADD ESP,0x2c                        ; 0045515d
    JMP 0x00455108                      ; 00455160 | LAB_00455108
        ;   XREF to: 00455108 (UNCONDITIONAL_JUMP)
    IMUL ECX,EBX,0xc                    ; 00455162
        ;   Label: caseD_2
    ADD ECX,0x15c4740                   ; 00455165 | CVector3f[16] g_CubeClippedTriangleBuffer
    CMP ECX,EDX                         ; 0045516b
    JZ 0x0045517f                       ; 0045516d | LAB_0045517f
        ;   XREF to: 0045517f (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EDX]             ; 0045516f | CVector3f[16] g_ClipStageMinZBuffer
    MOV dword ptr [ECX],EAX             ; 00455171 | CVector3f[16] g_CubeClippedTriangleBuffer
    ...
    PUSH 0x0                            ; 00455197
    PUSH 0x0                            ; 00455199
    ADD ECX,0x15c4740                   ; 0045519b | CVector3f[16] g_CubeClippedTriangleBuffer
    PUSH ECX                            ; 004551a1
    MOV ECX,dword ptr [ESP + 0x28]      ; 004551a2
    PUSH ECX                            ; 004551a6
    PUSH EDX                            ; 004551a7 | CVector3f[16] g_ClipStageMinZBuffer
    MOV dword ptr [0x015c473c],EBX      ; 004551a8 | uint g_CubeClippedTriangleCount
    CALL core_dcube.cpp_clipEdgeToPlane_FUN_004547d0 ; 004551ae | void core_dcube.cpp_clipEdgeToPlane_FUN_004547d0(CVector3f * vertex1, CVector3f * vertex2, CVector3f * output_vertex, double plane_nx, ...)
        ;   XREF to: 004547d0 (UNCONDITIONAL_CALL)
    MOV EBX,dword ptr [0x015c473c]      ; 004551b3 | uint g_CubeClippedTriangleCount
    ADD ESP,0x2c                        ; 004551b9
    JMP 0x00455108                      ; 004551bc | LAB_00455108
        ;   XREF to: 00455108 (UNCONDITIONAL_JUMP)
