...
;                               FUNCTION
; *****************************************************************************
; __cdecl uint core_dcube.cpp_intersectVerticalCylinderSegment_FUN_00455ed0(CVector3f * segment_start, CVector3f * segment_end, float radius, float * out_height)
;
; Parameters:
...
section .text
    ...
    FNSTSW AX                           ; 00455f12
    SAHF                                ; 00455f14
    JNC 0x00456035                      ; 00455f15 | LAB_00456035
    ...
    FMUL double ptr [0x0061a502]        ; 00455f2b | double g_IntersectionConstantFour2
    ...
    FMUL ST0                            ; 00455f44
    FXCH ST3                            ; 00455f46
    FMUL double ptr [0x0061a4fa]        ; 00455f48 | double g_IntersectionConstantTwo2
    FXCH ST3                            ; 00455f4e
    ...
    FNSTSW AX                           ; 00455f6c
    SAHF                                ; 00455f6e
    JA 0x00456035                       ; 00455f6f | LAB_00456035
        ;   XREF to: 00456035 (CONDITIONAL_JUMP)
    ...
    FMUL double ptr [0x0061a4fa]        ; 00455f87 | double g_IntersectionConstantTwo2
    FDIVP                               ; 00455f8d
    FLDZ                                ; 00455f8f
    ...
    FNSTSW AX                           ; 00455f9d
    SAHF                                ; 00455f9f
    JA 0x00455fd6                       ; 00455fa0 | LAB_00455fd6
        ;   XREF to: 00455fd6 (CONDITIONAL_JUMP)
    FLD1                                ; 00455fa2
    FCOMP double ptr [ESP + 0x10]       ; 00455fa4
    FNSTSW AX                           ; 00455fa8
    SAHF                                ; 00455faa
    JC 0x00455fd6                       ; 00455fab | LAB_00455fd6
        ;   XREF to: 00455fd6 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 00455fc6
    SAHF                                ; 00455fc8
    JNC 0x00455fd6                      ; 00455fc9 | LAB_00455fd6
        ;   XREF to: 00455fd6 (CONDITIONAL_JUMP)
    ...
    FMUL double ptr [0x0061a4fa]        ; 00455fe4 | double g_IntersectionConstantTwo2
    FDIVP                               ; 00455fea
    FLDZ                                ; 00455fec
    FXCH                                ; 00455fee
    ...
    FNSTSW AX                           ; 00455ff6
    SAHF                                ; 00455ff8
    JA 0x0045602d                       ; 00455ff9 | LAB_0045602d
        ;   XREF to: 0045602d (CONDITIONAL_JUMP)
    FLD1                                ; 00455ffb
    FCOMP double ptr [ESP]              ; 00455ffd
    FNSTSW AX                           ; 00456000
    SAHF                                ; 00456002
    JC 0x0045602d                       ; 00456003 | LAB_0045602d
        ;   XREF to: 0045602d (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0045601d
    SAHF                                ; 0045601f
    JNC 0x0045602d                      ; 00456020 | LAB_0045602d
        ;   XREF to: 0045602d (CONDITIONAL_JUMP)
