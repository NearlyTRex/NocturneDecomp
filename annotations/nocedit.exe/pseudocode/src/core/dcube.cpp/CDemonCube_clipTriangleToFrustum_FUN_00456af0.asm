...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dcube.cpp_CDemonCube_clipTriangleToFrustum_FUN_00456af0(CDemonCubeFrustum * frustum, CVector3f * vertex1, CVector3f * vertex2, CVector3f * vertex3, uchar texture_id)
;
; Parameters:
...
section .text
    ...
    MOV dword ptr [0x015c42a4],EDX      ; 00456b04 | uint g_CubeInputTriangleCount
    CMP ECX,0x15c42a8                   ; 00456b0a | CVector3f[16] g_CubeInputTriangleBuffer
    JNZ 0x00456ca9                      ; 00456b10 | LAB_00456ca9
    ...
    JZ 0x00456b3e                       ; 00456b20 | LAB_00456b3e
    ...
    JZ 0x00456b66                       ; 00456b48 | LAB_00456b66
    ...
    MOV EBP,0xffffffff                  ; 00456b66
        ;   Label: LAB_00456b66
    MOV EDX,dword ptr [0x015c42a4]      ; 00456b6b | uint g_CubeInputTriangleCount
    XOR EAX,EAX                         ; 00456b71
    XOR EDI,EDI                         ; 00456b73
    MOV dword ptr [ESP],EAX             ; 00456b75
    TEST EDX,EDX                        ; 00456b78
    JLE 0x00456bf4                      ; 00456b7a | LAB_00456bf4
        ;   XREF to: 00456bf4 (CONDITIONAL_JUMP)
    MOV ESI,0x15c42a8                   ; 00456b80 | CVector3f[16] g_CubeInputTriangleBuffer
    FLD float ptr [ESI]                 ; 00456b85 | CVector3f[16] g_CubeInputTriangleBuffer
        ;   Label: LAB_00456b85
    ...
    FNSTSW AX                           ; 00456b8e
    SAHF                                ; 00456b90
    JBE 0x00456b98                      ; 00456b91 | LAB_00456b98
        ;   XREF to: 00456b98 (CONDITIONAL_JUMP)
    MOV EDX,0x1                         ; 00456b93
    FLD float ptr [ECX + 0x4]           ; 00456b98 | g_CubeInputTriangleBuffer[0].y
        ;   Label: LAB_00456b98
    FCOMP float ptr [EBX + 0x18]        ; 00456b9b
    FNSTSW AX                           ; 00456b9e
    SAHF                                ; 00456ba0
    JBE 0x00456ba6                      ; 00456ba1 | LAB_00456ba6
        ;   XREF to: 00456ba6 (CONDITIONAL_JUMP)
    OR DL,0x2                           ; 00456ba3
    FLD float ptr [ECX + 0x8]           ; 00456ba6 | g_CubeInputTriangleBuffer[0].z
        ;   Label: LAB_00456ba6
    FCOMP float ptr [EBX + 0x1c]        ; 00456ba9
    FNSTSW AX                           ; 00456bac
    SAHF                                ; 00456bae
    JBE 0x00456bb4                      ; 00456baf | LAB_00456bb4
        ;   XREF to: 00456bb4 (CONDITIONAL_JUMP)
    OR DL,0x4                           ; 00456bb1
    FLD float ptr [ECX]                 ; 00456bb4 | CVector3f[16] g_CubeInputTriangleBuffer
        ;   Label: LAB_00456bb4
    FCOMP float ptr [EBX + 0x8]         ; 00456bb6
    FNSTSW AX                           ; 00456bb9
    SAHF                                ; 00456bbb
    JNC 0x00456bc1                      ; 00456bbc | LAB_00456bc1
    ...
    FNSTSW AX                           ; 00456bc7
    SAHF                                ; 00456bc9
    JNC 0x00456bcf                      ; 00456bca | LAB_00456bcf
    ...
    FNSTSW AX                           ; 00456bd5
    SAHF                                ; 00456bd7
    JNC 0x00456bdd                      ; 00456bd8 | LAB_00456bdd
        ;   XREF to: 00456bdd (CONDITIONAL_JUMP)
    OR DL,0x20                          ; 00456bda
    MOV ECX,dword ptr [ESP]             ; 00456bdd
        ;   Label: LAB_00456bdd
    MOV EAX,[0x015c42a4]                ; 00456be0 | uint g_CubeInputTriangleCount
    ...
    JL 0x00456b85                       ; 00456bf2 | LAB_00456b85
        ;   XREF to: 00456b85 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP],0x0             ; 00456bf4
        ;   Label: LAB_00456bf4
    JNZ 0x00456cca                      ; 00456bf8 | LAB_00456cca
        ;   XREF to: 00456cca (CONDITIONAL_JUMP)
    MOV ECX,0x3                         ; 00456bfe
    MOV EBX,dword ptr [ESP + 0x1c]      ; 00456c03
    MOV dword ptr [0x015c473c],ECX      ; 00456c07 | uint g_CubeClippedTriangleCount
    CMP EBX,0x15c4740                   ; 00456c0d | CVector3f[16] g_CubeClippedTriangleBuffer
    JZ 0x00456c31                       ; 00456c13 | LAB_00456c31
    ...
    FSTP float ptr [0x015c4740]         ; 00456c2b | CVector3f[16] g_CubeClippedTriangleBuffer
    MOV ESI,dword ptr [ESP + 0x20]      ; 00456c31
        ;   Label: LAB_00456c31
    CMP ESI,0x15c474c                   ; 00456c35 | g_CubeClippedTriangleBuffer[1].x
    JZ 0x00456c59                       ; 00456c3b | LAB_00456c59
    ...
    JZ 0x00456c81                       ; 00456c63 | LAB_00456c81
    ...
    CMP dword ptr [0x015c473c],0x3      ; 00456c81 | uint g_CubeClippedTriangleCount
        ;   Label: LAB_00456c81
    JL 0x00456ca1                       ; 00456c88 | LAB_00456ca1
        ;   XREF to: 00456ca1 (CONDITIONAL_JUMP)
    MOV EBX,0xc                         ; 00456c8a
    XOR ESI,ESI                         ; 00456c8f
    MOV EAX,[0x015c473c]                ; 00456c91 | uint g_CubeClippedTriangleCount
        ;   Label: LAB_00456c91
    SUB EAX,0x2                         ; 00456c96
    CMP ESI,EAX                         ; 00456c99
    JL 0x00456d8a                       ; 00456c9b | LAB_00456d8a
    ...
    FSTP float ptr [0x015c42a8]         ; 00456cbf | CVector3f[16] g_CubeInputTriangleBuffer
    JMP 0x00456b16                      ; 00456cc5 | LAB_00456b16
        ;   XREF to: 00456b16 (UNCONDITIONAL_JUMP)
    TEST EBP,EBP                        ; 00456cca
        ;   Label: LAB_00456cca
    JNZ 0x00456ca1                      ; 00456ccc | LAB_00456ca1
        ;   XREF to: 00456ca1 (CONDITIONAL_JUMP)
    PUSH dword ptr [EBX + 0x18]         ; 00456cce
    MOV dword ptr [0x015c4368],EBP      ; 00456cd1 | uint g_CubeClipStage1Count
    MOV dword ptr [0x015c442c],EBP      ; 00456cd7 | uint g_CubeClipStage2Count
    MOV dword ptr [0x015c44f0],EBP      ; 00456cdd | uint g_CubeClipStage3Count
    MOV dword ptr [0x015c45b4],EBP      ; 00456ce3 | uint g_CubeClipStage4Count
    MOV dword ptr [0x015c4678],EBP      ; 00456ce9 | uint g_CubeClipStage5Count
    MOV dword ptr [0x015c473c],EBP      ; 00456cef | uint g_CubeClippedTriangleCount
    CALL core_dcube.cpp_clipPolygonAgainstMaxY_FUN_00454970 ; 00456cf5 | void core_dcube.cpp_clipPolygonAgainstMaxY_FUN_00454970(float max_y_plane)
        ;   XREF to: 00454970 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [0x015c4368]      ; 00456cfa | uint g_CubeClipStage1Count
    ADD ESP,0x4                         ; 00456d00
    CMP ECX,0x3                         ; 00456d03
    JL 0x00456ca1                       ; 00456d06 | LAB_00456ca1
        ;   XREF to: 00456ca1 (CONDITIONAL_JUMP)
    PUSH dword ptr [EBX + 0xc]          ; 00456d08
    CALL core_dcube.cpp_clipPolygonAgainstMinY_FUN_00454ad0 ; 00456d0b | void core_dcube.cpp_clipPolygonAgainstMinY_FUN_00454ad0(float min_y_plane)
        ;   XREF to: 00454ad0 (UNCONDITIONAL_CALL)
    MOV ESI,dword ptr [0x015c442c]      ; 00456d10 | uint g_CubeClipStage2Count
    ADD ESP,0x4                         ; 00456d16
    CMP ESI,0x3                         ; 00456d19
    JL 0x00456ca1                       ; 00456d1c | LAB_00456ca1
        ;   XREF to: 00456ca1 (CONDITIONAL_JUMP)
    PUSH dword ptr [EBX + 0x14]         ; 00456d1e
    CALL core_dcube.cpp_clipPolygonAgainstMaxX_FUN_00454c40 ; 00456d21 | void core_dcube.cpp_clipPolygonAgainstMaxX_FUN_00454c40(float max_x_plane)
        ;   XREF to: 00454c40 (UNCONDITIONAL_CALL)
    MOV EDI,dword ptr [0x015c44f0]      ; 00456d26 | uint g_CubeClipStage3Count
    ADD ESP,0x4                         ; 00456d2c
    CMP EDI,0x3                         ; 00456d2f
    JL 0x00456ca1                       ; 00456d32 | LAB_00456ca1
        ;   XREF to: 00456ca1 (CONDITIONAL_JUMP)
    PUSH dword ptr [EBX + 0x8]          ; 00456d38
    CALL core_dcube.cpp_clipPolygonAgainstMinX_FUN_00454da0 ; 00456d3b | void core_dcube.cpp_clipPolygonAgainstMinX_FUN_00454da0(float min_x_plane)
        ;   XREF to: 00454da0 (UNCONDITIONAL_CALL)
    MOV EBP,dword ptr [0x015c45b4]      ; 00456d40 | uint g_CubeClipStage4Count
    ADD ESP,0x4                         ; 00456d46
    CMP EBP,0x3                         ; 00456d49
    JL 0x00456ca1                       ; 00456d4c | LAB_00456ca1
        ;   XREF to: 00456ca1 (CONDITIONAL_JUMP)
    PUSH dword ptr [EBX + 0x10]         ; 00456d52
    CALL core_dcube.cpp_clipPolygonAgainstMinZ_FUN_00454f00 ; 00456d55 | void core_dcube.cpp_clipPolygonAgainstMinZ_FUN_00454f00(float min_z_plane)
        ;   XREF to: 00454f00 (UNCONDITIONAL_CALL)
    MOV EAX,[0x015c4678]                ; 00456d5a | uint g_CubeClipStage5Count
    ADD ESP,0x4                         ; 00456d5f
    CMP EAX,0x3                         ; 00456d62
    JL 0x00456ca1                       ; 00456d65 | LAB_00456ca1
        ;   XREF to: 00456ca1 (CONDITIONAL_JUMP)
    PUSH dword ptr [EBX + 0x1c]         ; 00456d6b
    CALL core_dcube.cpp_clipPolygonAgainstMaxZ_FUN_00455070 ; 00456d6e | void core_dcube.cpp_clipPolygonAgainstMaxZ_FUN_00455070(float max_z_plane)
        ;   XREF to: 00455070 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [0x015c473c]      ; 00456d73 | uint g_CubeClippedTriangleCount
    ADD ESP,0x4                         ; 00456d79
    CMP EDX,0x3                         ; 00456d7c
    JL 0x00456ca1                       ; 00456d7f | LAB_00456ca1
        ;   XREF to: 00456ca1 (CONDITIONAL_JUMP)
    JMP 0x00456c81                      ; 00456d85 | LAB_00456c81
        ;   XREF to: 00456c81 (UNCONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x01626408]      ; 00456d8a | int g_VertexCount
        ;   Label: LAB_00456d8a
    IMUL EAX,EDX,0x14                   ; 00456d90
    FLD float ptr [0x015c4740]          ; 00456d93 | CVector3f[16] g_CubeClippedTriangleBuffer
    ...
    FXCH ST2                            ; 00456da5
    FSTP float ptr [EAX + 0x162640c]    ; 00456da7 | SVertexData[20000] g_LoadedVertices
    ...
    FXCH ST2                            ; 00456dd4
    FSTP float ptr [EAX + 0x162640c]    ; 00456dd6 | SVertexData[20000] g_LoadedVertices
    ...
    MOV EBP,dword ptr [0x016e990c]      ; 00456dfd | int g_PolygonCount
    FXCH ST2                            ; 00456e03
    FSTP float ptr [EAX + 0x162640c]    ; 00456e05 | SVertexData[20000] g_LoadedVertices
    ...
    PUSH EDX                            ; 00456e73
    MOV dword ptr [EAX + 0x16e9910],EBP ; 00456e74 | SShapeEditorPolygon[20000] g_ModelPolygonData
    ADD EAX,0x16e9910                   ; 00456e7a | SShapeEditorPolygon[20000] g_ModelPolygonData
    PUSH 0x61a7b7                       ; 00456e7f | = "%d" | s_d_0061a7b7 = %d
    ADD EAX,0x4                         ; 00456e84
    PUSH EAX                            ; 00456e87
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 00456e88 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    MOV EDI,dword ptr [0x016e990c]      ; 00456e8d | int g_PolygonCount
    ...
    MOV EAX,[0x01626408]                ; 00456ea8 | int g_VertexCount
    LEA EDX,[EDI + 0x1]                 ; 00456ead
    ADD EAX,0x3                         ; 00456eb0
    MOV dword ptr [0x016e990c],EDX      ; 00456eb3 | int g_PolygonCount
    MOV [0x01626408],EAX                ; 00456eb9 | int g_VertexCount
    JMP 0x00456c91                      ; 00456ebe | LAB_00456c91
