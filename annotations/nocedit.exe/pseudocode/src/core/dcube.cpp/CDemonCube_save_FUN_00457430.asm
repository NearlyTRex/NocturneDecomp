...
section .text
    ...
    PUSH EAX                            ; 00457444
    CALL crt_stdio.c_fwrite_FUN_005fdc00 ; 00457445 | SIZE_T crt_stdio.c_fwrite_FUN_005fdc00(void * ptr, SIZE_T size, SIZE_T count, FILE * file)
    ...
    PUSH EAX                            ; 00457455
    CALL crt_stdio.c_fwrite_FUN_005fdc00 ; 00457456 | SIZE_T crt_stdio.c_fwrite_FUN_005fdc00(void * ptr, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fdc00 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00457466
    CALL crt_stdio.c_fwrite_FUN_005fdc00 ; 00457467 | SIZE_T crt_stdio.c_fwrite_FUN_005fdc00(void * ptr, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fdc00 (UNCONDITIONAL_CALL)
    ...
    CALL crt_stdio.c_fwrite_FUN_005fdc00 ; 0045747a | SIZE_T crt_stdio.c_fwrite_FUN_005fdc00(void * ptr, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fdc00 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [EBX + 0x20]      ; 0045747f
    ADD ESP,0x10                        ; 00457482
    TEST EDX,EDX                        ; 00457485
    JLE 0x004574b0                      ; 00457487 | LAB_004574b0
    ...
    CALL crt_stdio.c_fwrite_FUN_005fdc00 ; 0045749a | SIZE_T crt_stdio.c_fwrite_FUN_005fdc00(void * ptr, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fdc00 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [EBX + 0x20]      ; 0045749f
    ADD ESP,0x10                        ; 004574a2
    CMP ESI,ECX                         ; 004574a5
    JL 0x0045748b                       ; 004574a7 | LAB_0045748b
    ...
    JLE 0x004574e0                      ; 004574b7 | LAB_004574e0
    ...
    PUSH EAX                            ; 004574c5
    INC ESI                             ; 004574c6
    CALL core_dcube.cpp_CDemonCubeTriangle_writeToFile_FUN_00455250 ; 004574c7 | void core_dcube.cpp_CDemonCubeTriangle_writeToFile_FUN_00455250(CDemonCubeTriangle * this_ptr, FILE * file_handle, CVector3f * vertex_buffer_base)
    ...
    JL 0x004574bb                       ; 004574d7 | LAB_004574bb
    ...
    JNZ 0x004574f2                      ; 004574e5 | LAB_004574f2
        ;   XREF to: 004574f2 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x28],0x0      ; 004574e7
    JNZ 0x0045750d                      ; 004574eb | LAB_0045750d
    ...
    PUSH EDI                            ; 004574f9
    CALL crt_stdio.c_fwrite_FUN_005fdc00 ; 004574fa | SIZE_T crt_stdio.c_fwrite_FUN_005fdc00(void * ptr, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fdc00 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004574ff
    CMP dword ptr [EBX + 0x28],0x0      ; 00457502
    JNZ 0x0045750d                      ; 00457506 | LAB_0045750d
        ;   XREF to: 0045750d (CONDITIONAL_JUMP)
    POP EBP                             ; 00457508
    POP EDI                             ; 00457509
    POP ESI                             ; 0045750a
    ...
    PUSH EDX                            ; 00457514
    CALL crt_stdio.c_fwrite_FUN_005fdc00 ; 00457515 | SIZE_T crt_stdio.c_fwrite_FUN_005fdc00(void * ptr, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fdc00 (UNCONDITIONAL_CALL)
