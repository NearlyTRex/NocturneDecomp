...

{
  ...
  pCVar2 = (CVector3f *)shape_memdbg_cpp_debugAllocTracked2_FUN_0050f1f0
                     ((int)fVar1 * sizeof(CVector3f) + 4,"..\\core\\dcube.cpp",1535);
  pCVar3 = pCVar2;
  ...
  pvVar5 = shape_memdbg_cpp_debugMalloc_FUN_0050f250
                     (this_ptr->triangle_count,"..\\core\\dcube.cpp",1539);
  ...
  pSVar6 = (SVoxelGrid *)shape_memdbg_cpp_debugMalloc_FUN_0050f250(sizeof(SVoxelGrid),"..\\core\\dcube.cpp",1541);
  ...
  pSVar6 = (SVoxelGrid *)shape_memdbg_cpp_debugMalloc_FUN_0050f250(sizeof(SVoxelGrid),"..\\core\\dcube.cpp",1543);
