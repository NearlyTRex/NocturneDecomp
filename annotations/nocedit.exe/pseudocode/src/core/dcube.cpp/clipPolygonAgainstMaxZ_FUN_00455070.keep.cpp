...
// Convention: __cdecl
// Signature: void __cdecl core_dcube_cpp_clipPolygonAgainstMaxZ_FUN_00455070(float max_z_plane)
    ...
    do {
      ...
      case 0:
        if (g_CubeClippedTriangleBuffer + g_CubeClippedTriangleCount != vertex1) {
          g_CubeClippedTriangleBuffer[g_CubeClippedTriangleCount] = *vertex1;
        }
        break;
      case 1:
