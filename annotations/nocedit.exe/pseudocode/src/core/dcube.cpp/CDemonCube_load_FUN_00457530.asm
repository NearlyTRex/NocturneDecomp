...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dcube.cpp_CDemonCube_load_FUN_00457530(CDemonCube * this_ptr, FILE * file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 00457544
    CALL crt_stdio.c_fread_FUN_005fd990 ; 00457545 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
    ...
    PUSH EAX                            ; 00457555
    CALL crt_stdio.c_fread_FUN_005fd990 ; 00457556 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00457566
    CALL crt_stdio.c_fread_FUN_005fd990 ; 00457567 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00457577
    CALL crt_stdio.c_fread_FUN_005fd990 ; 00457578 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [ESI + 0x28]      ; 0045757d
    ADD ESP,0x10                        ; 00457580
    TEST EDX,EDX                        ; 00457583
    JNZ 0x004575f2                      ; 00457585 | LAB_004575f2
    ...
    PUSH EBX                            ; 00457591
    CALL crt_stdio.c_fread_FUN_005fd990 ; 00457592 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00457597
    MOV EDI,dword ptr [ESI + 0x28]      ; 0045759a
    XOR EBX,EBX                         ; 0045759d
    TEST EDI,EDI                        ; 0045759f
    JLE 0x004575d0                      ; 004575a1 | LAB_004575d0
    ...
    PUSH EAX                            ; 004575af
    INC EBX                             ; 004575b0
    CALL core_dcube.cpp_CDemonCubeTriangle_readFromFile_FUN_004551d0 ; 004575b1 | void core_dcube.cpp_CDemonCubeTriangle_readFromFile_FUN_004551d0(CDemonCubeTriangle * this_ptr, FILE * file_handle, CVector3f * vertex_buffer_base)
    ...
    JL 0x004575a5                       ; 004575c1 | LAB_004575a5
    ...
    JZ 0x004575e7                       ; 004575d5 | LAB_004575e7
    ...
    PUSH EDI                            ; 004575de
    CALL crt_stdio.c_fread_FUN_005fd990 ; 004575df | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004575e4
    CMP dword ptr [ESI + 0x28],0x0      ; 004575e7
        ;   Label: LAB_004575e7
    JNZ 0x004575fd                      ; 004575eb | LAB_004575fd
    ...
    PUSH ESI                            ; 004575f2
        ;   Label: LAB_004575f2
    CALL core_dcube.cpp_CDemonCube_allocGeometryMemory_FUN_00456840 ; 004575f3 | void core_dcube.cpp_CDemonCube_allocGeometryMemory_FUN_00456840(CDemonCube * this_ptr)
        ;   XREF to: 00456840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004575f8
    JMP 0x00457587                      ; 004575fb | LAB_00457587
    ...
    PUSH EDX                            ; 00457604
    CALL crt_stdio.c_fread_FUN_005fd990 ; 00457605 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
