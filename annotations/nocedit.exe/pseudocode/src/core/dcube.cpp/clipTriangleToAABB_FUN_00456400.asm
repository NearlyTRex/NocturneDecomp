...
section .text
    ...
    MOV dword ptr [0x015c42a4],0x3      ; 0045640f | g_CubeInputTriangleCount
    MOV EDX,dword ptr [ESP + 0x1c]      ; 00456419
    MOV EDX,dword ptr [EDX]             ; 0045641d
    CMP EDX,0x15c42a8                   ; 0045641f | g_CubeInputTriangleBuffer
    JNZ 0x004565ae                      ; 00456425
        ;   XREF to: 004565ae (CONDITIONAL_JUMP)  ; LAB_004565ae
    ...
    JZ 0x00456453                       ; 00456438
        ;   XREF to: 00456453 (CONDITIONAL_JUMP)  ; LAB_00456453
    ...
    MOV ECX,0xffffffff                  ; 0045647b
        ;   Label: LAB_0045647b
    MOV EAX,[0x015c42a4]                ; 00456480 | g_CubeInputTriangleCount
    ...
    JLE 0x00456513                      ; 00456492
        ;   XREF to: 00456513 (CONDITIONAL_JUMP)  ; LAB_00456513
    MOV EBX,0x15c42a8                   ; 00456498 | g_CubeInputTriangleBuffer
    FLD float ptr [EBX]                 ; 0045649d | g_CubeInputTriangleBuffer | g_CubeInputTriangleBuffer[1].x
        ;   Label: LAB_0045649d
    ...
    FNSTSW AX                           ; 004564a5
    SAHF                                ; 004564a7
    JBE 0x004564af                      ; 004564a8
        ;   XREF to: 004564af (CONDITIONAL_JUMP)  ; LAB_004564af
    MOV EDX,0x1                         ; 004564aa
    FLD float ptr [ECX + 0x4]           ; 004564af | g_CubeInputTriangleBuffer[0].y | g_CubeInputTriangleBuffer[1].y
        ;   Label: LAB_004564af
    FCOMP float ptr [EDI + 0x4]         ; 004564b2
    FNSTSW AX                           ; 004564b5
    SAHF                                ; 004564b7
    JBE 0x004564bd                      ; 004564b8
        ;   XREF to: 004564bd (CONDITIONAL_JUMP)  ; LAB_004564bd
    OR DL,0x2                           ; 004564ba
    FLD float ptr [ECX + 0x8]           ; 004564bd | g_CubeInputTriangleBuffer[0].z | g_CubeInputTriangleBuffer[1].z
        ;   Label: LAB_004564bd
    FCOMP float ptr [EDI + 0x8]         ; 004564c0
    FNSTSW AX                           ; 004564c3
    SAHF                                ; 004564c5
    JBE 0x004564cb                      ; 004564c6
        ;   XREF to: 004564cb (CONDITIONAL_JUMP)  ; LAB_004564cb
    OR DL,0x4                           ; 004564c8
    FLD float ptr [ECX]                 ; 004564cb | g_CubeInputTriangleBuffer | g_CubeInputTriangleBuffer[1].x
        ;   Label: LAB_004564cb
    FCOMP float ptr [ESI]               ; 004564cd
    FNSTSW AX                           ; 004564cf
    SAHF                                ; 004564d1
    JNC 0x004564d7                      ; 004564d2
        ;   XREF to: 004564d7 (CONDITIONAL_JUMP)  ; LAB_004564d7
    OR DL,0x8                           ; 004564d4
    ...
    FNSTSW AX                           ; 004564dd
    SAHF                                ; 004564df
    JNC 0x004564e5                      ; 004564e0
        ;   XREF to: 004564e5 (CONDITIONAL_JUMP)  ; LAB_004564e5
    OR DL,0x10                          ; 004564e2
    ...
    FNSTSW AX                           ; 004564eb
    SAHF                                ; 004564ed
    JNC 0x004564f3                      ; 004564ee
        ;   XREF to: 004564f3 (CONDITIONAL_JUMP)  ; LAB_004564f3
    OR DL,0x20                          ; 004564f0
    ...
    OR EAX,EDX                          ; 00456500
    MOV EDX,dword ptr [0x015c42a4]      ; 00456502 | g_CubeInputTriangleCount
    MOV dword ptr [ESP + 0x4],ECX       ; 00456508
    MOV dword ptr [ESP],EAX             ; 0045650c
    CMP EBP,EDX                         ; 0045650f
    JL 0x0045649d                       ; 00456511
        ;   XREF to: 0045649d (CONDITIONAL_JUMP)  ; LAB_0045649d
    CMP dword ptr [ESP],0x0             ; 00456513
        ;   Label: LAB_00456513
    JNZ 0x004565cc                      ; 00456517
        ;   XREF to: 004565cc (CONDITIONAL_JUMP)  ; LAB_004565cc
    MOV EDX,dword ptr [ESP + 0x1c]      ; 0045651d
    MOV EBP,0x3                         ; 00456521
    MOV EDX,dword ptr [EDX]             ; 00456526
    MOV dword ptr [0x015c473c],EBP      ; 00456528 | g_CubeClippedTriangleCount
    CMP EDX,0x15c4740                   ; 0045652e | g_CubeClippedTriangleBuffer
    JZ 0x0045654f                       ; 00456534
        ;   XREF to: 0045654f (CONDITIONAL_JUMP)  ; LAB_0045654f
    ...
    FSTP float ptr [0x015c4740]         ; 00456549 | g_CubeClippedTriangleBuffer
    ...
    JZ 0x00456577                       ; 0045655c
        ;   XREF to: 00456577 (CONDITIONAL_JUMP)  ; LAB_00456577
    ...
    JZ 0x0045659f                       ; 00456584
        ;   XREF to: 0045659f (CONDITIONAL_JUMP)  ; LAB_0045659f
    ...
    FSTP float ptr [0x015c42a8]         ; 004565c1 | g_CubeInputTriangleBuffer
    JMP 0x0045642b                      ; 004565c7
        ;   XREF to: 0045642b (UNCONDITIONAL_JUMP)  ; LAB_0045642b
    MOV EBX,dword ptr [ESP + 0x4]       ; 004565cc
        ;   Label: LAB_004565cc
    TEST EBX,EBX                        ; 004565d0
    JZ 0x004565e0                       ; 004565d2
        ;   XREF to: 004565e0 (CONDITIONAL_JUMP)  ; LAB_004565e0
    ...
    PUSH dword ptr [EDI + 0x4]          ; 004565e0
        ;   Label: LAB_004565e0
    MOV dword ptr [0x015c4368],EBX      ; 004565e3 | g_CubeClipStage1Count
    MOV dword ptr [0x015c442c],EBX      ; 004565e9 | g_CubeClipStage2Count
    MOV dword ptr [0x015c44f0],EBX      ; 004565ef | g_CubeClipStage3Count
    MOV dword ptr [0x015c45b4],EBX      ; 004565f5 | g_CubeClipStage4Count
    MOV dword ptr [0x015c4678],EBX      ; 004565fb | g_CubeClipStage5Count
    MOV dword ptr [0x015c473c],EBX      ; 00456601 | g_CubeClippedTriangleCount
    CALL core_dcube.cpp_clipPolygonAgainstMaxY_FUN_00454970 ; 00456607
        ;   XREF to: 00454970 (UNCONDITIONAL_CALL)  ; void core_dcube.cpp_clipPolygonAgainstMaxY_FUN_00454970(float max_y_plane)
    MOV EAX,[0x015c4368]                ; 0045660c | g_CubeClipStage1Count
    ADD ESP,0x4                         ; 00456611
    CMP EAX,0x3                         ; 00456614
    JGE 0x00456625                      ; 00456617
        ;   XREF to: 00456625 (CONDITIONAL_JUMP)  ; LAB_00456625
    ...
    PUSH dword ptr [ESI + 0x4]          ; 00456625
        ;   Label: LAB_00456625
    CALL core_dcube.cpp_clipPolygonAgainstMinY_FUN_00454ad0 ; 00456628
        ;   XREF to: 00454ad0 (UNCONDITIONAL_CALL)  ; void core_dcube.cpp_clipPolygonAgainstMinY_FUN_00454ad0(float min_y_plane)
    MOV EDX,dword ptr [0x015c442c]      ; 0045662d | g_CubeClipStage2Count
    ADD ESP,0x4                         ; 00456633
    CMP EDX,0x3                         ; 00456636
    JGE 0x00456647                      ; 00456639
        ;   XREF to: 00456647 (CONDITIONAL_JUMP)  ; LAB_00456647
    ...
    PUSH dword ptr [EDI]                ; 00456647
        ;   Label: LAB_00456647
    CALL core_dcube.cpp_clipPolygonAgainstMaxX_FUN_00454c40 ; 00456649
        ;   XREF to: 00454c40 (UNCONDITIONAL_CALL)  ; void core_dcube.cpp_clipPolygonAgainstMaxX_FUN_00454c40(float max_x_plane)
    MOV ECX,dword ptr [0x015c44f0]      ; 0045664e | g_CubeClipStage3Count
    ADD ESP,0x4                         ; 00456654
    CMP ECX,0x3                         ; 00456657
    JGE 0x00456668                      ; 0045665a
        ;   XREF to: 00456668 (CONDITIONAL_JUMP)  ; LAB_00456668
    ...
    PUSH dword ptr [ESI]                ; 00456668
        ;   Label: LAB_00456668
    CALL core_dcube.cpp_clipPolygonAgainstMinX_FUN_00454da0 ; 0045666a
        ;   XREF to: 00454da0 (UNCONDITIONAL_CALL)  ; void core_dcube.cpp_clipPolygonAgainstMinX_FUN_00454da0(float min_x_plane)
    MOV EBX,dword ptr [0x015c45b4]      ; 0045666f | g_CubeClipStage4Count
    ADD ESP,0x4                         ; 00456675
    CMP EBX,0x3                         ; 00456678
    JGE 0x00456689                      ; 0045667b
        ;   XREF to: 00456689 (CONDITIONAL_JUMP)  ; LAB_00456689
    ...
    PUSH dword ptr [ESI + 0x8]          ; 00456689
        ;   Label: LAB_00456689
    CALL core_dcube.cpp_clipPolygonAgainstMinZ_FUN_00454f00 ; 0045668c
        ;   XREF to: 00454f00 (UNCONDITIONAL_CALL)  ; void core_dcube.cpp_clipPolygonAgainstMinZ_FUN_00454f00(float min_z_plane)
    MOV ESI,dword ptr [0x015c4678]      ; 00456691 | g_CubeClipStage5Count
    ADD ESP,0x4                         ; 00456697
    CMP ESI,0x3                         ; 0045669a
    JGE 0x004566ab                      ; 0045669d
        ;   XREF to: 004566ab (CONDITIONAL_JUMP)  ; LAB_004566ab
    ...
    PUSH dword ptr [EDI + 0x8]          ; 004566ab
        ;   Label: LAB_004566ab
    CALL core_dcube.cpp_clipPolygonAgainstMaxZ_FUN_00455070 ; 004566ae
        ;   XREF to: 00455070 (UNCONDITIONAL_CALL)  ; void core_dcube.cpp_clipPolygonAgainstMaxZ_FUN_00455070(float max_z_plane)
    MOV EDI,dword ptr [0x015c473c]      ; 004566b3 | g_CubeClippedTriangleCount
    ADD ESP,0x4                         ; 004566b9
    CMP EDI,0x3                         ; 004566bc
    JGE 0x0045659f                      ; 004566bf
        ;   XREF to: 0045659f (CONDITIONAL_JUMP)  ; LAB_0045659f
