...
section .text
    ...
    MOV EBX,dword ptr [0x015c4678]      ; 00454f0c | uint g_CubeClipStage5Count
    MOV EDX,dword ptr [EBP + 0x14]      ; 00454f12
    MOV dword ptr [ESP],EDX             ; 00454f15
    MOV EDX,dword ptr [0x015c45b4]      ; 00454f18 | uint g_CubeClipStage4Count
    XOR EDI,EDI                         ; 00454f1e
    TEST EDX,EDX                        ; 00454f20
    JLE 0x00454fa7                      ; 00454f22 | LAB_00454fa7
        ;   XREF to: 00454fa7 (CONDITIONAL_JUMP)
    MOV ESI,0x15c45b8                   ; 00454f28 | CVector3f[16] g_ClipStageMinXBuffer
    MOV EAX,[0x015c45b4]                ; 00454f2d | uint g_CubeClipStage4Count
        ;   Label: LAB_00454f2d
    LEA ECX,[EDI + 0x1]                 ; 00454f32
    CMP ECX,EAX                         ; 00454f35
    JNZ 0x00454f3b                      ; 00454f37 | LAB_00454f3b
        ;   XREF to: 00454f3b (CONDITIONAL_JUMP)
    XOR ECX,EAX                         ; 00454f39
    IMUL ECX,ECX,0xc                    ; 00454f3b
        ;   Label: LAB_00454f3b
    MOV EAX,0x15c45b8                   ; 00454f3e | CVector3f[16] g_ClipStageMinXBuffer
    FLD float ptr [ESI + 0x8]           ; 00454f43 | DAT_015c45c0
    ADD EAX,ECX                         ; 00454f46
    MOV EDX,ESI                         ; 00454f48 | CVector3f[16] g_ClipStageMinXBuffer
    MOV dword ptr [ESP + 0x4],EAX       ; 00454f4a | DAT_015c45d0
    XOR ECX,ECX                         ; 00454f4e
    FCOMP float ptr [ESP]               ; 00454f50
    FNSTSW AX                           ; 00454f53
    SAHF                                ; 00454f55
    JNC 0x00454f5d                      ; 00454f56 | LAB_00454f5d
        ;   XREF to: 00454f5d (CONDITIONAL_JUMP)
    MOV ECX,0x1                         ; 00454f58
    MOV EAX,dword ptr [ESP + 0x4]       ; 00454f5d
        ;   Label: LAB_00454f5d
    FLD float ptr [EAX + 0x8]           ; 00454f61 | DAT_015c45c0
    FCOMP float ptr [ESP]               ; 00454f64
    FNSTSW AX                           ; 00454f67
    SAHF                                ; 00454f69
    JNC 0x00454f6f                      ; 00454f6a | LAB_00454f6f
        ;   XREF to: 00454f6f (CONDITIONAL_JUMP)
    OR CL,0x2                           ; 00454f6c
    CMP ECX,0x3                         ; 00454f6f
        ;   Label: LAB_00454f6f
    JA 0x00454f99                       ; 00454f72 | caseD_3
        ;   XREF to: 00454f99 (CONDITIONAL_JUMP)
    JMP dword ptr [ECX*0x4 + 0x454ef0]  ; 00454f74 | void * PTR_caseD_3_00454efc | PTR_caseD_1_00454ef4 = 00454fb4
        ;   Label: switchD
    IMUL ECX,EBX,0xc                    ; 00454f7b
        ;   Label: caseD_0
    ADD ECX,0x15c467c                   ; 00454f7e | CVector3f[16] g_ClipStageMinZBuffer
    CMP ECX,EDX                         ; 00454f84
    JZ 0x00454f98                       ; 00454f86 | LAB_00454f98
        ;   XREF to: 00454f98 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EDX]             ; 00454f88 | CVector3f[16] g_ClipStageMinXBuffer
    MOV dword ptr [ECX],EAX             ; 00454f8a | CVector3f[16] g_ClipStageMinZBuffer
    ...
    INC EBX                             ; 00454f98
        ;   Label: LAB_00454f98
    MOV ECX,dword ptr [0x015c45b4]      ; 00454f99 | uint g_CubeClipStage4Count
        ;   Label: caseD_3
    INC EDI                             ; 00454f9f
    ADD ESI,0xc                         ; 00454fa0
    CMP EDI,ECX                         ; 00454fa3
    JL 0x00454f2d                       ; 00454fa5 | LAB_00454f2d
        ;   XREF to: 00454f2d (CONDITIONAL_JUMP)
    MOV dword ptr [0x015c4678],EBX      ; 00454fa7 | uint g_CubeClipStage5Count
        ;   Label: LAB_00454fa7
    ...
    PUSH 0x0                            ; 00454fcb
    PUSH 0x0                            ; 00454fcd
    ADD ECX,0x15c467c                   ; 00454fcf | CVector3f[16] g_ClipStageMinZBuffer
    PUSH ECX                            ; 00454fd5
    PUSH EDX                            ; 00454fd6 | CVector3f[16] g_ClipStageMinXBuffer
    MOV EAX,dword ptr [ESP + 0x2c]      ; 00454fd7
    PUSH EAX                            ; 00454fdb
    MOV dword ptr [0x015c4678],EBX      ; 00454fdc | uint g_CubeClipStage5Count
    CALL core_dcube.cpp_clipEdgeToPlane_FUN_004547d0 ; 00454fe2 | void core_dcube.cpp_clipEdgeToPlane_FUN_004547d0(CVector3f * vertex1, CVector3f * vertex2, CVector3f * output_vertex, double plane_nx, ...)
        ;   XREF to: 004547d0 (UNCONDITIONAL_CALL)
    MOV EBX,dword ptr [0x015c4678]      ; 00454fe7 | uint g_CubeClipStage5Count
    ADD ESP,0x2c                        ; 00454fed
    JMP 0x00454f98                      ; 00454ff0 | LAB_00454f98
        ;   XREF to: 00454f98 (UNCONDITIONAL_JUMP)
    IMUL ECX,EBX,0xc                    ; 00454ff2
        ;   Label: caseD_2
    ADD ECX,0x15c467c                   ; 00454ff5 | CVector3f[16] g_ClipStageMinZBuffer
    CMP ECX,EDX                         ; 00454ffb
    JZ 0x0045500f                       ; 00454ffd | LAB_0045500f
        ;   XREF to: 0045500f (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EDX]             ; 00454fff | CVector3f[16] g_ClipStageMinXBuffer
    MOV dword ptr [ECX],EAX             ; 00455001 | CVector3f[16] g_ClipStageMinZBuffer
    ...
    PUSH 0x0                            ; 00455027
    PUSH 0x0                            ; 00455029
    ADD ECX,0x15c467c                   ; 0045502b | CVector3f[16] g_ClipStageMinZBuffer
    PUSH ECX                            ; 00455031
    MOV ECX,dword ptr [ESP + 0x28]      ; 00455032
    PUSH ECX                            ; 00455036
    PUSH EDX                            ; 00455037 | CVector3f[16] g_ClipStageMinXBuffer
    MOV dword ptr [0x015c4678],EBX      ; 00455038 | uint g_CubeClipStage5Count
    CALL core_dcube.cpp_clipEdgeToPlane_FUN_004547d0 ; 0045503e | void core_dcube.cpp_clipEdgeToPlane_FUN_004547d0(CVector3f * vertex1, CVector3f * vertex2, CVector3f * output_vertex, double plane_nx, ...)
        ;   XREF to: 004547d0 (UNCONDITIONAL_CALL)
    MOV EBX,dword ptr [0x015c4678]      ; 00455043 | uint g_CubeClipStage5Count
    ADD ESP,0x2c                        ; 00455049
    JMP 0x00454f98                      ; 0045504c | LAB_00454f98
        ;   XREF to: 00454f98 (UNCONDITIONAL_JUMP)
