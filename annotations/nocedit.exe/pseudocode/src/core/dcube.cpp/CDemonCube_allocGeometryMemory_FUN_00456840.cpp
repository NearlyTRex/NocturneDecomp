...

{
  ...
  pCVar2 = (CVector3f *)shape_memdbg_cpp_debugAllocTracked2_FUN_0050f1f0
                     ((int)fVar1 * 0xc + 4,"..\\core\\dcube.cpp",1535);
  pCVar3 = pCVar2;
  ...
  pSVar6 = (SVoxelGrid *)shape_memdbg_cpp_debugMalloc_FUN_0050f250(0x40,"..\\core\\dcube.cpp",1541);
  ...
  pSVar6 = (SVoxelGrid *)shape_memdbg_cpp_debugMalloc_FUN_0050f250(0x40,"..\\core\\dcube.cpp",1543);
