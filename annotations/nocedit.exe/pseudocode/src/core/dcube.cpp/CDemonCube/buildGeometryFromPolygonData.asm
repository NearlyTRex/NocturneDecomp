...
section .text
    ...
    MOV EAX,[0x016e990c]                ; 00456eda | int g_PolygonCount
    MOV dword ptr [ESI + 0x28],EAX      ; 00456edf
    CALL shape_superopt.cpp_TriListSomething_FUN_005d77a0 ; 00456ee2 | undefined shape_superopt.cpp_TriListSomething_FUN_005d77a0()
        ;   XREF to: 005d77a0 (UNCONDITIONAL_CALL)
    MOV EAX,[0x01626408]                ; 00456ee7 | int g_VertexCount
    MOV dword ptr [ESI + 0x28],0x0      ; 00456eec
    MOV EDX,dword ptr [0x016e990c]      ; 00456ef3 | int g_PolygonCount
    MOV dword ptr [ESI + 0x20],EAX      ; 00456ef9
    XOR EAX,EAX                         ; 00456efc
    TEST EDX,EDX                        ; 00456efe
    JLE 0x00456f30                      ; 00456f00 | LAB_00456f30
        ;   XREF to: 00456f30 (CONDITIONAL_JUMP)
    XOR EDX,EDX                         ; 00456f02
    MOV EBX,dword ptr [EDX + 0x16e99b4] ; 00456f04 | DAT_016e99b4
        ;   Label: LAB_00456f04
    ...
    MOV EBX,dword ptr [0x016e990c]      ; 00456f19 | int g_PolygonCount
    MOV dword ptr [ESI + 0x28],ECX      ; 00456f1f
    CMP EAX,EBX                         ; 00456f22
    JL 0x00456f04                       ; 00456f24 | LAB_00456f04
        ;   XREF to: 00456f04 (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 00456f26
    LEA EDX,[EDX]                       ; 00456f2c
    CMP dword ptr [ESI + 0x28],0x0      ; 00456f30
        ;   Label: LAB_00456f30
    JZ 0x00456f3c                       ; 00456f34 | LAB_00456f3c
        ;   XREF to: 00456f3c (CONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0x20],0x0      ; 00456f36
    JNZ 0x00456f51                      ; 00456f3a | LAB_00456f51
        ;   XREF to: 00456f51 (CONDITIONAL_JUMP)
    ...
    PUSH EDI                            ; 00456f51
        ;   Label: LAB_00456f51
    PUSH ESI                            ; 00456f52
    CALL core_dcube.cpp_CDemonCube_allocGeometryMemory_FUN_00456840 ; 00456f53 | void core_dcube.cpp_CDemonCube_allocGeometryMemory_FUN_00456840(CDemonCube * this_ptr)
    ...
    JLE 0x00456fa0                      ; 00456f62 | LAB_00456fa0
        ;   XREF to: 00456fa0 (CONDITIONAL_JUMP)
    XOR EDI,EDI                         ; 00456f64
    XOR EAX,EAX                         ; 00456f66
    ADD EAX,0xc                         ; 00456f68
        ;   Label: LAB_00456f68
    MOV EBX,dword ptr [ESI + 0x24]      ; 00456f6b
    FLD float ptr [EDI + 0x162640c]     ; 00456f6e | SVertexData[20000] g_LoadedVertices
    INC EDX                             ; 00456f74
    FSTP float ptr [EBX + EAX*0x1 + -0xc] ; 00456f75
    MOV EBX,dword ptr [ESI + 0x24]      ; 00456f79
    MOV ECX,dword ptr [EDI + 0x1626410] ; 00456f7c | DAT_01626410
    MOV dword ptr [EBX + EAX*0x1 + -0x8],ECX ; 00456f82
    MOV EBX,dword ptr [ESI + 0x24]      ; 00456f86
    MOV ECX,dword ptr [EDI + 0x1626414] ; 00456f89 | g_LoadedVertices[0].vertex.z
    MOV dword ptr [EBX + EAX*0x1 + -0x4],ECX ; 00456f8f
    MOV ECX,dword ptr [ESI + 0x20]      ; 00456f93
    ADD EDI,0x14                        ; 00456f96
    CMP EDX,ECX                         ; 00456f99
    JL 0x00456f68                       ; 00456f9b | LAB_00456f68
        ;   XREF to: 00456f68 (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 00456f9d
    XOR EDI,EDI                         ; 00456fa0
        ;   Label: LAB_00456fa0
    MOV EBP,dword ptr [0x016e990c]      ; 00456fa2 | int g_PolygonCount
    MOV dword ptr [ESP + 0x8],EDI       ; 00456fa8
    TEST EBP,EBP                        ; 00456fac
    JLE 0x0045708d                      ; 00456fae | LAB_0045708d
        ;   XREF to: 0045708d (CONDITIONAL_JUMP)
    MOV EAX,0x16e9910                   ; 00456fb4 | SShapeEditorPolygon[20000] g_ModelPolygonData
    ADD EAX,0x4                         ; 00456fb9
    MOV dword ptr [ESP + 0xc],EDI       ; 00456fbc
    MOV dword ptr [ESP + 0x4],EAX       ; 00456fc0 | DAT_016e9914
    MOV EAX,dword ptr [ESP + 0x4]       ; 00456fc4 | DAT_016e9914
        ;   Label: LAB_00456fc4
    PUSH EAX                            ; 00456fc8 | DAT_016e9914
    CALL crt_stdlib.c_atoi_FUN_005ffef0 ; 00456fc9 | int crt_stdlib.c_atoi_FUN_005ffef0(char * string_ptr)
    ...
    JLE 0x0045705b                      ; 00456ffe | LAB_0045705b
        ;   XREF to: 0045705b (CONDITIONAL_JUMP)
    IMUL EDX,dword ptr [EBX + 0x16e99c8],0xc ; 00457000 | DAT_016e99c8 | DAT_016e99d0
        ;   Label: LAB_00457000
    MOV EAX,dword ptr [ESI + 0x24]      ; 00457007
    ADD EDX,EAX                         ; 0045700a
    MOV ECX,dword ptr [EBX + 0x16e99c4] ; 0045700c | DAT_016e99cc
    PUSH EDX                            ; 00457012
    ...
    PUSH EAX                            ; 00457030
    CALL core_dcube.cpp_CDemonCubeTriangle_ctor_FUN_00455430 ; 00457031 | void core_dcube.cpp_CDemonCubeTriangle_ctor_FUN_00455430(CDemonCubeTriangle * this_ptr, CVector3f * vertex0, CVector3f * vertex1, CVector3f * vertex2)
    ...
    JL 0x00457000                       ; 00457059 | LAB_00457000
        ;   XREF to: 00457000 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0xc]       ; 0045705b
        ;   Label: LAB_0045705b
    MOV EDX,dword ptr [ESP + 0x4]       ; 0045705f
    MOV ECX,dword ptr [ESP + 0x8]       ; 00457063
    MOV EBX,dword ptr [0x016e990c]      ; 00457067 | int g_PolygonCount
    ...
    JL 0x00456fc4                       ; 00457087 | LAB_00456fc4
        ;   XREF to: 00456fc4 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 0045708d
        ;   Label: LAB_0045708d
    CALL core_dcube.cpp_CDemonCube_buildVoxelOccupancyGrid_FUN_00457cf0 ; 0045708e | void core_dcube.cpp_CDemonCube_buildVoxelOccupancyGrid_FUN_00457cf0(SVoxelGridParams * params)
        ;   XREF to: 00457cf0 (UNCONDITIONAL_CALL)
