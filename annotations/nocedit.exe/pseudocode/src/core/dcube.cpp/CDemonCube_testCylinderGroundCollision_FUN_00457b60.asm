...
section .text
    ...
    JLE 0x00457ba8                      ; 00457b77
        ;   XREF to: 00457ba8 (CONDITIONAL_JUMP)  ; LAB_00457ba8
    ...
    PUSH EAX                            ; 00457b8e
    CALL core_dcube.cpp_triangleCylinderCollision_FUN_00456040 ; 00457b8f
        ;   XREF to: 00456040 (UNCONDITIONAL_CALL)  ; uint core_dcube.cpp_triangleCylinderCollision_FUN_00456040(CDemonCubeTriangle * triangle, CVector3f * cylinder_center, float cylinder_radius, float * out_height)
    ADD ESP,0x10                        ; 00457b94
    TEST EAX,EAX                        ; 00457b97
    JZ 0x00457b9d                       ; 00457b99
        ;   XREF to: 00457b9d (CONDITIONAL_JUMP)  ; LAB_00457b9d
    ...
    JL 0x00457b7b                       ; 00457ba6
        ;   XREF to: 00457b7b (CONDITIONAL_JUMP)  ; LAB_00457b7b
    TEST EBP,EBP                        ; 00457ba8
        ;   Label: LAB_00457ba8
    JL 0x00457c94                       ; 00457baa
        ;   XREF to: 00457c94 (CONDITIONAL_JUMP)  ; LAB_00457c94
    MOV EBX,EBP                         ; 00457bb0
    MOV EAX,dword ptr [EDI + 0x2c]      ; 00457bb2
    SHL EBX,0x5                         ; 00457bb5
    MOV EAX,dword ptr [EBX + EAX*0x1]   ; 00457bb8
    CMP EAX,0x15c4800                   ; 00457bbb | g_TempNormal0
    JZ 0x00457bdc                       ; 00457bc0
        ;   XREF to: 00457bdc (CONDITIONAL_JUMP)  ; LAB_00457bdc
    ...
    FSTP float ptr [0x015c4800]         ; 00457bd6 | g_TempNormal0
    MOV EAX,EBP                         ; 00457bdc
        ;   Label: LAB_00457bdc
    MOV EBX,dword ptr [EDI + 0x2c]      ; 00457bde
    SHL EAX,0x5                         ; 00457be1
    MOV EAX,dword ptr [EBX + EAX*0x1 + 0x4] ; 00457be4
    CMP EAX,0x15c480c                   ; 00457be8 | g_TempNormal1
    JZ 0x00457c09                       ; 00457bed
        ;   XREF to: 00457c09 (CONDITIONAL_JUMP)  ; LAB_00457c09
    ...
    FSTP float ptr [0x015c4818]         ; 00457c30 | g_TempNormal2
    ...
    JZ 0x00457c87                       ; 00457c72
        ;   XREF to: 00457c87 (CONDITIONAL_JUMP)  ; LAB_00457c87
