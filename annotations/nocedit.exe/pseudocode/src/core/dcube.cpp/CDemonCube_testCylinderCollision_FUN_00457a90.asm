...
;
; XREF[1]:
;   core_dtrace.cpp_CDemonRaytrace_testCylinderCollision_FUN_00496c60 at 00496dda
;
; Referenced Globals:
...
;
; Called Functions:
;   core_dcube.cpp_intersectTriangleWithXZCylinder_FUN_00455a30
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 00457a90
        ;   Label: core_dcube.cpp_CDemonCube_testCylinderCollision_FUN_00457a90
    PUSH ESI                            ; 00457a91
    PUSH EDI                            ; 00457a92
    PUSH EBP                            ; 00457a93
    ...
    PUSH EAX                            ; 00457ab2
    CALL core_dcube.cpp_intersectTriangleWithXZCylinder_FUN_00455a30 ; 00457ab3
        ;   XREF to: 00455a30 (UNCONDITIONAL_CALL)  ; uint core_dcube.cpp_intersectTriangleWithXZCylinder_FUN_00455a30(STriangleRef * triangle, SIntersectXZCylinder * cylinder)
