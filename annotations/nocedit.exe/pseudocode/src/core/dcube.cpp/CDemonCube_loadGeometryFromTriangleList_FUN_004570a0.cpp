  ...
  if (triangle_count != 0) {
    ...
    if (0 < (int)max_bounds) {
      ...
      do {
        ...
        *(undefined4 *)((int)g_ModelPolygonData[0].vertex_indices + iVar8 + 0x40) = 0;
        *(undefined4 *)((int)g_ModelPolygonData[0].uv_coordinates + iVar8) = 0;
        *(undefined4 *)((int)g_ModelPolygonData[0].vertex_indices + iVar8 + 0x44) = 0;
        pCVar4 = (CVector3f *)&pCVar4[4].z;
        *(undefined4 *)((int)g_ModelPolygonData[0].uv_coordinates + iVar8 + 4) = 0;
        iVar9 = iVar9 + 0x3c;
        *(undefined4 *)((int)g_ModelPolygonData[0].vertex_indices + iVar8 + 0x48) = 0;
        iVar6 = iVar6 + 1;
        *(undefined4 *)((int)g_ModelPolygonData[0].uv_coordinates + iVar8 + 8) = 0;
        *(float *)((int)&g_LoadedVertices[1].vertex.z + iVar5) = fVar2;
        *(undefined4 *)((int)g_ModelPolygonData[0].uv_coordinates + iVar8 + 0x40) = 0;
