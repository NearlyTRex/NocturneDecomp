...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_dcube_cpp_CDemonCube_buildGeometryFromPolygonData_FUN_00456ed0(CDemonCube *this_ptr)
;
; Parameters:
...
section .text
    ...
    CALL shape_superopt.cpp_TriListSomething_FUN_005d77a0 ; 00456ee2
        ;   XREF to: 005d77a0 (UNCONDITIONAL_CALL)  ; undefined shape_superopt.cpp_TriListSomething_FUN_005d77a0()
