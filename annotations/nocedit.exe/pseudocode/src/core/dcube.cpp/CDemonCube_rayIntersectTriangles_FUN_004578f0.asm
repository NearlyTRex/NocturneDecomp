...
;                               FUNCTION
; *****************************************************************************
; __cdecl float core_dcube.cpp_CDemonCube_rayIntersectTriangles_FUN_004578f0(CDemonCube * this_ptr, CVector3f * ray_origin, CVector3f * ray_direction, CVector3f * hit_normal, uint * hit_material)
;
; Parameters:
...
section .text
    ...
    JLE 0x0045797b                      ; 00457918 | LAB_0045797b
    ...
    PUSH EAX                            ; 00457929
    CALL core_dcube.cpp_CDemonCubeTriangle_rayTriangleIntersection_FUN_00455460 ; 0045792a | float core_dcube.cpp_CDemonCubeTriangle_rayTriangleIntersection_FUN_00455460(CDemonCubeTriangle * this_ptr, CVector3f * ray_origin, CVector3f * ray_direction)
    ...
    JNZ 0x00457a4e                      ; 004579b6 | LAB_00457a4e
    ...
    CMP EAX,0x15c4800                   ; 004579de | CVector3f g_TempNormal0
    JZ 0x004579ff                       ; 004579e3 | LAB_004579ff
    ...
    FSTP float ptr [0x015c4800]         ; 004579f9 | CVector3f g_TempNormal0
    ...
    CMP EAX,0x15c480c                   ; 00457a0d | CVector3f g_TempNormal1
    JZ 0x00457a2e                       ; 00457a12 | LAB_00457a2e
    ...
    FSTP float ptr [0x015c480c]         ; 00457a28 | CVector3f g_TempNormal1
    ...
    CMP EAX,0x15c4818                   ; 00457a3c | CVector3f g_TempNormal2
    JNZ 0x00457a67                      ; 00457a41 | LAB_00457a67
    ...
    JMP 0x004579bc                      ; 00457a62 | LAB_004579bc
    ...
    FSTP float ptr [0x015c4818]         ; 00457a7b | CVector3f g_TempNormal2
