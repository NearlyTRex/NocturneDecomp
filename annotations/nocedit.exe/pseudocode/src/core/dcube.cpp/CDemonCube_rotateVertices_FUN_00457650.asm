...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dcube.cpp_CDemonCube_rotateVertices_FUN_00457650(CDemonCube * this_ptr, uint rendering_mode)
;
; Parameters:
...
section .text
    ...
    PUSH 0x3f87558                      ; 00457659 | CVector3f g_ZeroVector
    MOV EDX,dword ptr [0x006703ec]      ; 0045765e | CDemonRenderer * g_CDemonRendererPtr
    PUSH EDX                            ; 00457664 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450 ; 00457665 | void engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450(CDemonRenderer * this_ptr, CVector3f * world_position)
        ;   XREF to: 0048c450 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EBP + 0x14]      ; 0045766a
    MOV ECX,dword ptr [EAX + 0x20]      ; 0045766d
    ADD ESP,0x8                         ; 00457670
    CMP ECX,0x4e20                      ; 00457673
    JG 0x0045785e                       ; 00457679 | LAB_0045785e
        ;   XREF to: 0045785e (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 0045767f
        ;   Label: LAB_0045767f
    MOV EAX,[0x006703ec]                ; 00457681 | CDemonRenderer * g_CDemonRendererPtr
    PUSH EAX                            ; 00457686 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_enableFaceCapture_FUN_0048caa0 ; 00457687 | void engine_drender.cpp_CDemonRenderer_enableFaceCapture_FUN_0048caa0(CDemonRenderer * this_ptr, int enabled)
        ;   XREF to: 0048caa0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0045768c
    PUSH 0x1                            ; 0045768f
    MOV EDX,dword ptr [0x006703ec]      ; 00457691 | CDemonRenderer * g_CDemonRendererPtr
    PUSH EDX                            ; 00457697 | CDemonRenderer g_CDemonRendererInstance
    MOV ESI,dword ptr [EBP + 0x14]      ; 00457698
    CALL engine_drender.cpp_CDemonRenderer_setRenderingState_FUN_0048ca00 ; 0045769b | void engine_drender.cpp_CDemonRenderer_setRenderingState_FUN_0048ca00(CDemonRenderer * this_ptr, int state_flag)
        ;   XREF to: 0048ca00 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EBP + 0x14]      ; 004576a0
    MOV EDI,dword ptr [0x006703ec]      ; 004576a3 | CDemonRenderer * g_CDemonRendererPtr
    ...
    MOV EDI,dword ptr [EDI]             ; 004576ba | CDemonRenderer g_CDemonRendererInstance
    TEST EDX,EDX                        ; 004576bc
    JLE 0x00457716                      ; 004576be | LAB_00457716
        ;   XREF to: 00457716 (CONDITIONAL_JUMP)
    LEA EBX,[EBP + -0x38]               ; 004576c0
        ;   Label: LAB_004576c0
    MOV EAX,ESI                         ; 004576c3
    FLD float ptr [EAX]                 ; 004576c5
    FMUL float ptr [0x0065c6b0]         ; 004576c7 | float g_CubeWorldToScreenScale
    FISTP dword ptr [EBX]               ; 004576cd
    FLD float ptr [EAX + 0x4]           ; 004576cf
    FMUL float ptr [0x0065c6b0]         ; 004576d2 | float g_CubeWorldToScreenScale
    FISTP dword ptr [EBX + 0x4]         ; 004576d8
    FLD float ptr [EAX + 0x8]           ; 004576db
    FMUL float ptr [0x0065c6b0]         ; 004576de | float g_CubeWorldToScreenScale
    FISTP dword ptr [EBX + 0x8]         ; 004576e4
    LEA EAX,[EBP + -0x38]               ; 004576e7
    PUSH EAX                            ; 004576ea
    PUSH EDI                            ; 004576eb
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 004576ec | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    MOV DH,byte ptr [EDI + 0x13]        ; 004576f1
    ADD ESP,0x8                         ; 004576f4
    TEST DH,0x80                        ; 004576f7
    JNZ 0x004576ff                      ; 004576fa | LAB_004576ff
    ...
    JL 0x004576c0                       ; 00457714 | LAB_004576c0
    ...
    JNZ 0x00457737                      ; 0045771f | LAB_00457737
        ;   XREF to: 00457737 (CONDITIONAL_JUMP)
    MOV EAX,[0x006703ec]                ; 00457721 | CDemonRenderer * g_CDemonRendererPtr
    MOV EDX,dword ptr [EAX + 0x18]      ; 00457726 | DAT_02c6d590
    TEST EDX,EDX                        ; 00457729
    JNZ 0x00457737                      ; 0045772b | LAB_00457737
        ;   XREF to: 00457737 (CONDITIONAL_JUMP)
    PUSH EDX                            ; 0045772d
    PUSH EAX                            ; 0045772e | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_enableFaceCapture_FUN_0048caa0 ; 0045772f | void engine_drender.cpp_CDemonRenderer_enableFaceCapture_FUN_0048caa0(CDemonRenderer * this_ptr, int enabled)
        ;   XREF to: 0048caa0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00457734
    MOV AH,byte ptr [0x015c42a0]        ; 00457737 | uchar g_ColorConstantsInitialized
        ;   Label: LAB_00457737
    TEST AH,0x1                         ; 0045773d
    JZ 0x0045788c                       ; 00457740 | LAB_0045788c
    ...
    JLE 0x00457836                      ; 00457753 | LAB_00457836
    ...
    CMP dword ptr [EBP + 0x18],0x4      ; 00457765
        ;   Label: LAB_00457765
    JA 0x00457774                       ; 00457769 | LAB_00457774
        ;   XREF to: 00457774 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + -0x14]     ; 0045776b
    JMP dword ptr [EAX + 0x457630]      ; 0045776e | pointer PTR_LAB_00457630
    ...
    JZ 0x0045779a                       ; 00457787 | LAB_0045779a
    ...
    FLD float ptr [0x0061a84a]          ; 0045779a | float g_CubeColorScaleFactor
        ;   Label: LAB_0045779a
    ...
    PUSH EAX                            ; 004577f0
    MOV EDI,dword ptr [0x006703ec]      ; 004577f1 | CDemonRenderer * g_CDemonRendererPtr
    PUSH EDI                            ; 004577f7 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_setRGBAColor_FUN_0048c970 ; 004577f8 | void engine_drender.cpp_CDemonRenderer_setRGBAColor_FUN_0048c970(CDemonRenderer * this_ptr, int red_component, int green_component, int blue_component)
    ...
    INC ESI                             ; 00457819
    CALL core_dcube.cpp_buildAndRenderTrianglePrimitive_FUN_004566e0 ; 0045781a | void core_dcube.cpp_buildAndRenderTrianglePrimitive_FUN_004566e0(CVector3f * * triangle_vertex_pointers, CVector3f * vertex_buffer)
    ...
    JL 0x00457765                       ; 00457830 | LAB_00457765
        ;   XREF to: 00457765 (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 00457836
        ;   Label: LAB_00457836
    MOV EAX,[0x006703ec]                ; 00457838 | CDemonRenderer * g_CDemonRendererPtr
    PUSH EAX                            ; 0045783d | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_enableFaceCapture_FUN_0048caa0 ; 0045783e | void engine_drender.cpp_CDemonRenderer_enableFaceCapture_FUN_0048caa0(CDemonRenderer * this_ptr, int enabled)
        ;   XREF to: 0048caa0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00457843
    PUSH 0x0                            ; 00457846
    MOV EDX,dword ptr [0x006703ec]      ; 00457848 | CDemonRenderer * g_CDemonRendererPtr
    PUSH EDX                            ; 0045784e | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_setRenderingState_FUN_0048ca00 ; 0045784f | void engine_drender.cpp_CDemonRenderer_setRenderingState_FUN_0048ca00(CDemonRenderer * this_ptr, int state_flag)
        ;   XREF to: 0048ca00 (UNCONDITIONAL_CALL)
    ...
    PUSH 0x4e20                         ; 0045785e
        ;   Label: LAB_0045785e
    PUSH ECX                            ; 00457863
    MOV EBX,0x61a7dd                    ; 00457864 | = "..\\core\\dcube.cpp" | s_core_dcube_cpp_0061a7dd = ..\core\dcube.cpp
    MOV ESI,0x7bb                       ; 00457869
    PUSH 0x61a7ef                       ; 0045786e | = "CDemonCube::rotateVerticies - tried t..." | s_CDemonCube_rotateVertici_0061a7ef = CDemonCube::rotateVerticies - tried to rotate %d vertices, but GLOBAL_VERTEX_COUNT = %d
    MOV dword ptr [0x02f0ca48],EBX      ; 00457873 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 00457879 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0045787f | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00457884
    JMP 0x0045767f                      ; 00457887 | LAB_0045767f
    ...
    OR DL,0x1                           ; 00457898
    MOV dword ptr [0x015c4294],EDI      ; 0045789b | CVector3f g_StaticColorVector
    MOV dword ptr [0x015c429c],EDI      ; 004578a1 | g_StaticColorVector.z
    MOV [0x015c4298],EAX                ; 004578a7 | g_StaticColorVector.y
    MOV byte ptr [0x015c42a0],DL        ; 004578ac | uchar g_ColorConstantsInitialized
    JMP 0x00457746                      ; 004578b2 | LAB_00457746
