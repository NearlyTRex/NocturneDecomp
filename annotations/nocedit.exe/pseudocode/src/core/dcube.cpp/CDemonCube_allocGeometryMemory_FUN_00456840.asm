...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_dcube_cpp_CDemonCube_allocGeometryMemory_FUN_00456840(CDemonCube *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 00456863
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1f0 ; 00456864
    ...
    PUSH EAX                            ; 004568ae
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1f0 ; 004568af
        ;   XREF to: 0050f1f0 (UNCONDITIONAL_CALL)  ; void * shape_memdbg.cpp_debugAlloc_FUN_0050f1f0(int size, char * filename, int line_number)
