...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_npc_cpp_CNPC_archive_FUN_00544ba0(CNPC *this_ptr)
;
; Parameters:
; CNPC *           Stack[0x4]:4   this_ptr
;
; XREF[4]:
;   core_hiram.cpp_CHiram_archive_FUN_004f4690 at 004f4695
;   core_hostage.cpp_CHostage_archive_FUN_004f6170 at 004f6177
;   core_hpriest.cpp_CHighPriestOfGardath_archive_FUN_004f7bd0 at 004f7bd5
;   core_passngr.cpp_CPassenger_archive_FUN_00546190 at 00546197
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00544ba0
        ;   Label: core_npc.cpp_CNPC_archive_FUN_00544ba0
    PUSH ESI                            ; 00544ba1
    ...
    PUSH EBX                            ; 00544baf
    CALL core_charactr.cpp_CCharacter_archive_FUN_004283a0 ; 00544bb0
    ...
    PUSH ESI                            ; 00544bce
    CALL core_actor.cpp_archiveDeformableModelInstance_FUN_0040b970 ; 00544bcf
    ...
    PUSH ESI                            ; 00544bdc
    CALL core_actor.cpp_archiveMotionState_FUN_0040b9f0 ; 00544bdd
    ...
    PUSH ESI                            ; 00544bf9
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 00544bfa
    ...
    PUSH EBX                            ; 00544c0e
        ;   Label: LAB_00544c0e
    CALL core_actor.cpp_CDemonActor_archive_FUN_0040c1c0 ; 00544c0f
    ...
    PUSH EBX                            ; 00544c22
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 00544c23
    ...
    PUSH EBX                            ; 00544c39
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 00544c3a
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
