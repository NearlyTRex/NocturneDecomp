...

{
  ...
  pCVar2 = (CNPC_ptr_13260)core_armour_cpp_CFlame_arrdtor50_FUN_00412720(ADJ(pCVar1)->base.flames,0);
  pSVar1 = (CNPC_ptr_12060)core_armour_cpp_SFire_arrdtor50_FUN_00412700(ADJ(pCVar2)->base.fires,0);
  ...
  pCVar4 = (CNPC_ptr_11356)
           core_armour_cpp_CVector3f_arrdtor15_FUN_004126e0
                     (ADJ(pCVar3)->base.collision_test_points,0);
