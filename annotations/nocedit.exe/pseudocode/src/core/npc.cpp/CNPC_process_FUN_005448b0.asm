...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_npc.cpp_CNPC_process_FUN_005448b0(CNPC * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005448c2
    CALL core_charactr.cpp_CCharacter_FUN_00429870 ; 005448c3 | int core_charactr.cpp_CCharacter_FUN_00429870(CCharacter * this_ptr)
        ;   XREF to: 00429870 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005448c8
    TEST EAX,EAX                        ; 005448cb
    JNZ 0x005448d6                      ; 005448cd | LAB_005448d6
    ...
    PUSH dword ptr [EBP + 0x18]         ; 005448d6
        ;   Label: LAB_005448d6
    PUSH EBX                            ; 005448d9
    CALL core_charactr.cpp_CCharacter_FUN_0042ea40 ; 005448da | void core_charactr.cpp_CCharacter_FUN_0042ea40(CCharacter * this_ptr)
    ...
    FNSTSW AX                           ; 0054490d
    SAHF                                ; 0054490f
    JNC 0x0054492a                      ; 00544910 | LAB_0054492a
        ;   XREF to: 0054492a (CONDITIONAL_JUMP)
    MOV EAX,ESP                         ; 00544912
    PUSH EAX                            ; 00544914
    PUSH ESI                            ; 00544915
    CALL core_motion.cpp_CMotionController_advance_FUN_0052d610 ; 00544916 | int core_motion.cpp_CMotionController_advance_FUN_0052d610(CMotionController * this_ptr)
        ;   XREF to: 0052d610 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0054491b
    PUSH EAX                            ; 0054491e
    PUSH EBX                            ; 0054491f
    CALL core_charactr.cpp_CCharacter_FUN_0042ec40 ; 00544920 | void core_charactr.cpp_CCharacter_FUN_0042ec40(CCharacter * this_ptr)
        ;   XREF to: 0042ec40 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00544925
    JMP 0x00544906                      ; 00544928 | LAB_00544906
    ...
    JLE 0x00544995                      ; 0054493d | LAB_00544995
        ;   XREF to: 00544995 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x70],0x1      ; 0054493f
    JNZ 0x00544995                      ; 00544943 | LAB_00544995
        ;   XREF to: 00544995 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [EBX + 0x1f704]   ; 00544945
    TEST ECX,ECX                        ; 0054494b
    JNZ 0x00544995                      ; 0054494d | LAB_00544995
        ;   XREF to: 00544995 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [EBX + 0xdc]      ; 0054494f
    TEST EDI,EDI                        ; 00544955
    JNZ 0x00544995                      ; 00544957 | LAB_00544995
        ;   XREF to: 00544995 (CONDITIONAL_JUMP)
    PUSH ECX                            ; 00544959
    LEA EAX,[ESP + 0x14]                ; 0054495a
    PUSH EAX                            ; 0054495e
    PUSH ESI                            ; 0054495f
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneWorldPosition_FUN_0059fa20 ; 00544960 | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneWorldPosition_FUN_0059fa20(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
    ...
    PUSH EAX                            ; 0054496d
    PUSH EBX                            ; 0054496e
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 0054496f | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
        ;   XREF to: 00408ec0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00544974
    PUSH EDI                            ; 00544977
    LEA EAX,[ESP + 0x2c]                ; 00544978
    PUSH EAX                            ; 0054497c
    MOV EAX,[0x0067b9a0]                ; 0054497d | CGore g_CGoreInstance | CGore * g_CGorePtr
    PUSH EAX                            ; 00544982 | CGore g_CGoreInstance
    CALL core_gore.cpp_FUN_004ede30     ; 00544983 | undefined core_gore.cpp_FUN_004ede30()
    ...
    FLD float ptr [EBP + 0x18]          ; 00544995
        ;   Label: LAB_00544995
    FMUL double ptr [0x0063e364]        ; 00544998 | double DOUBLE_0063e364
    FMUL double ptr [0x0063e36c]        ; 0054499e | double DOUBLE_0063e36c
    ...
    CALL core_charactr.cpp_CCharacter_FUN_0042ca70 ; 005449ba | int core_charactr.cpp_CCharacter_FUN_0042ca70(CCharacter * this_ptr)
        ;   XREF to: 0042ca70 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005449bf
    TEST EAX,EAX                        ; 005449c2
    JZ 0x00544a0c                       ; 005449c4 | LAB_00544a0c
        ;   XREF to: 00544a0c (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0x25b0]    ; 005449c6
    CMP EAX,0x2                         ; 005449cc
    JNC 0x00544b55                      ; 005449cf | LAB_00544b55
        ;   XREF to: 00544b55 (CONDITIONAL_JUMP)
    CMP EAX,0x1                         ; 005449d5
    JNZ 0x00544b62                      ; 005449d8 | LAB_00544b62
        ;   XREF to: 00544b62 (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 005449de
        ;   Label: LAB_005449de
    PUSH 0x63e353                       ; 005449e0 | = "WALK" | s_WALK_0063e353 = WALK
    LEA EAX,[EBX + 0x158]               ; 005449e5
        ;   Label: LAB_005449e5
    PUSH EAX                            ; 005449eb
    CALL core_motion.cpp_CMotionController_setDesiredStateByName_FUN_0052db90 ; 005449ec | void core_motion.cpp_CMotionController_setDesiredStateByName_FUN_0052db90(CMotionController * this_ptr, char * state_name, int force_immediate)
    ...
    FLD float ptr [EBP + 0x18]          ; 00544a0c
        ;   Label: LAB_00544a0c
    FMUL double ptr [0x0063e374]        ; 00544a0f | double DOUBLE_0063e374
    ...
    PUSH EAX                            ; 00544aca
    PUSH EBX                            ; 00544acb
    CALL core_charactr.cpp_CCharacter_FUN_00428f40 ; 00544acc | void core_charactr.cpp_CCharacter_FUN_00428f40(CCharacter * this_ptr)
        ;   XREF to: 00428f40 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00544ad1
    PUSH EBX                            ; 00544ad4
    CALL core_charactr.cpp_CCharacter_FUN_00429820 ; 00544ad5 | void core_charactr.cpp_CCharacter_FUN_00429820(CCharacter * this_ptr)
        ;   XREF to: 00429820 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00544ada
    LEA EAX,[EBX + 0x158]               ; 00544add
    PUSH EAX                            ; 00544ae3
    CALL core_skeleton.cpp_CDeformableModelInstance_updateAnimation_FUN_0059e020 ; 00544ae4 | void core_skeleton.cpp_CDeformableModelInstance_updateAnimation_FUN_0059e020(CDeformableModelInstance * this_ptr)
        ;   XREF to: 0059e020 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00544ae9
    PUSH dword ptr [EBP + 0x18]         ; 00544aec
    PUSH EBX                            ; 00544aef
    CALL core_charactr.cpp_CCharacter_ApplyGestureLookAt_FUN_0042dfc0 ; 00544af0 | void core_charactr.cpp_CCharacter_ApplyGestureLookAt_FUN_0042dfc0(CCharacter * this_ptr)
    ...
    PUSH 0x1                            ; 00544aff
        ;   Label: LAB_00544aff
    PUSH 0x63e31f                       ; 00544b01 | = "STAND" | s_STAND_0063e31f = STAND
    PUSH ESI                            ; 00544b06
    CALL core_motion.cpp_CMotionController_setDesiredStateByName_FUN_0052db90 ; 00544b07 | void core_motion.cpp_CMotionController_setDesiredStateByName_FUN_0052db90(CMotionController * this_ptr, char * state_name, int force_immediate)
        ;   XREF to: 0052db90 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00544b0c
    PUSH EBX                            ; 00544b0f
    PUSH 0x63e325                       ; 00544b10 | = "%s confused while walking to scriptDe..." | s_s_confused_while_walking_0063e325 = %s confused while walking to scriptDest!

    MOV EDX,dword ptr [0x0066e8e0]      ; 00544b15 | CConsole g_ConsolePtr | CConsole * g_CConsolePtr
    PUSH EDX                            ; 00544b1b | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 00544b1c | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
        ;   XREF to: 00441890 (UNCONDITIONAL_CALL)
    JMP 0x005449f1                      ; 00544b21 | LAB_005449f1
        ;   XREF to: 005449f1 (UNCONDITIONAL_JUMP)
    PUSH 0x0                            ; 00544b26
        ;   Label: LAB_00544b26
    PUSH 0x63e34f                       ; 00544b28 | = "RUN" | s_RUN_0063e34f = RUN
    PUSH ESI                            ; 00544b2d
    CALL core_motion.cpp_CMotionController_getMotionList_FUN_0052dce0 ; 00544b2e | CMotionList * core_motion.cpp_CMotionController_getMotionList_FUN_0052dce0(CMotionController * this_ptr)
        ;   XREF to: 0052dce0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00544b33
    PUSH EAX                            ; 00544b36
    CALL core_motion.cpp_CMotionList_findStateIndex_FUN_0052d4f0 ; 00544b37 | int core_motion.cpp_CMotionList_findStateIndex_FUN_0052d4f0(CMotionList * this_ptr)
        ;   XREF to: 0052d4f0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00544b3c
    TEST EAX,EAX                        ; 00544b3f
    JL 0x005449de                       ; 00544b41 | LAB_005449de
        ;   XREF to: 005449de (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 00544b47
    PUSH EAX                            ; 00544b49
    PUSH ESI                            ; 00544b4a
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 00544b4b | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    JMP 0x005449f1                      ; 00544b50 | LAB_005449f1
        ;   XREF to: 005449f1 (UNCONDITIONAL_JUMP)
    LEA ESI,[EBX + 0x158]               ; 00544b55
        ;   Label: LAB_00544b55
    JBE 0x00544b26                      ; 00544b5b | LAB_00544b26
        ;   XREF to: 00544b26 (CONDITIONAL_JUMP)
    CMP EAX,0x3                         ; 00544b5d
    JZ 0x00544aff                       ; 00544b60 | LAB_00544aff
        ;   XREF to: 00544aff (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 00544b62
        ;   Label: LAB_00544b62
    PUSH 0x63e358                       ; 00544b64 | = "STAND" | s_STAND_0063e358 = STAND
    JMP 0x005449e5                      ; 00544b69 | LAB_005449e5
