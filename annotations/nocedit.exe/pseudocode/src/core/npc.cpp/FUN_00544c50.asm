...
section .text
    ...
    CALL core_motion.cpp_CMotionController_getMotionList_FUN_0052dce0 ; 00544c6b | CMotionList * core_motion.cpp_CMotionController_getMotionList_FUN_0052dce0(CMotionController * this_ptr)
    ...
    PUSH EAX                            ; 00544c7a
    PUSH ESI                            ; 00544c7b
    PUSH 0x63e3ac                       ; 00544c7c | = "%s_%d" | s_s_d_0063e3ac = %s_%d
    LEA EAX,[ESP + 0xc]                 ; 00544c81
    PUSH EAX                            ; 00544c85
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 00544c86 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH EAX                            ; 00544c93
    PUSH EBP                            ; 00544c94
    CALL core_motion.cpp_CMotionList_findStateIndex_FUN_0052d4f0 ; 00544c95 | int core_motion.cpp_CMotionList_findStateIndex_FUN_0052d4f0(CMotionList * this_ptr)
        ;   XREF to: 0052d4f0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00544c9a
    TEST EAX,EAX                        ; 00544c9d
    JL 0x00544ca4                       ; 00544c9f | LAB_00544ca4
        ;   XREF to: 00544ca4 (CONDITIONAL_JUMP)
    INC EBX                             ; 00544ca1
    JMP 0x00544c77                      ; 00544ca2 | LAB_00544c77
        ;   XREF to: 00544c77 (UNCONDITIONAL_JUMP)
    TEST EBX,EBX                        ; 00544ca4
        ;   Label: LAB_00544ca4
    JZ 0x00544ce8                       ; 00544ca6 | LAB_00544ce8
        ;   XREF to: 00544ce8 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 00544ca8
    PUSH 0x1                            ; 00544ca9
    CALL core_actor.cpp_getRandomInt_FUN_0040cc70 ; 00544cab | int core_actor.cpp_getRandomInt_FUN_0040cc70(int min_value, int max_value)
        ;   XREF to: 0040cc70 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00544cb0
    PUSH EAX                            ; 00544cb3
    PUSH ESI                            ; 00544cb4
    PUSH 0x63e3b2                       ; 00544cb5 | = "%s_%d" | s_s_d_0063e3b2 = %s_%d
    LEA EAX,[ESP + 0xc]                 ; 00544cba
    PUSH EAX                            ; 00544cbe
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 00544cbf | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00544ccd
    PUSH EBP                            ; 00544cce
    CALL core_motion.cpp_CMotionList_findStateIndex_FUN_0052d4f0 ; 00544ccf | int core_motion.cpp_CMotionList_findStateIndex_FUN_0052d4f0(CMotionList * this_ptr)
        ;   XREF to: 0052d4f0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00544cd4
    TEST EAX,EAX                        ; 00544cd7
    JGE 0x00544d06                      ; 00544cd9 | LAB_00544d06
    ...
    CMP AL,0x0                          ; 00544cef
    JZ 0x00544d03                       ; 00544cf1 | LAB_00544d03
    ...
    CMP AL,0x0                          ; 00544cff
    JNZ 0x00544ceb                      ; 00544d01 | LAB_00544ceb
        ;   XREF to: 00544ceb (CONDITIONAL_JUMP)
    POP EDI                             ; 00544d03
        ;   Label: LAB_00544d03
    JMP 0x00544cc7                      ; 00544d04 | LAB_00544cc7
    ...
    PUSH ECX                            ; 00544d10
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 00544d11 | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
