...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_npc_cpp_CNPC_FUN_00544870(CNPC *this_ptr)
;
; Parameters:
; CNPC *           Stack[0x4]:4   this_ptr
;
; XREF[5]:
;   core_hiram.cpp_FUN_004f4530 at 004f4535
;   core_hostage.cpp_NPCSFromZombieTown_FUN_004f4970 at 004f4b0c
