...
// Convention: __cdecl
// Signature: void __cdecl core_npc_cpp_CNPC_FUN_00544d30(CNPC *this_ptr)
...

{
  ...
  if (pCVar3 == &g_CNPCClassInfo) {
    fVar2 = (this_ptr->base).hit_points - *(float *)(in_stack_00000008 + 4);
    ...
    if (fVar2 <= 0.0) {
      ...
      if (iVar4 == 0) {
        ...
        if (iVar4 == 0) {
          core_npc_cpp_FUN_00544c50();
          core_charactr_cpp_CCharacter_FUN_0042c3c0(&this_ptr->base);
          return;
        }
      }
    }
