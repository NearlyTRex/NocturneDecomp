...

{
  ...
  pCVar2->font_enabled = 1;
  engine_font_cpp_CBitFont_setFontReady_FUN_004d0290(pCVar2,1);
  pCVar1 = shape_memdbg_cpp_debugAlloc_FUN_0050f1b0(0x3198,"..\\core\\dfont.cpp",0x4f);
  pCVar2 = (CBitFont *)0x0;
  if (pCVar1 != (CBitFont *)0x0) {
    pCVar2 = engine_font_cpp_CBitFont_ctor_FUN_004cce90(pCVar1);
  }
  ...
  pCVar2->font_enabled = 1;
  engine_font_cpp_CBitFont_setFontReady_FUN_004d0290(pCVar2,1);
  pCVar1 = shape_memdbg_cpp_debugAlloc_FUN_0050f1b0(0x3198,"..\\core\\dfont.cpp",0x5e);
  pCVar2 = (CBitFont *)0x0;
  if (pCVar1 != (CBitFont *)0x0) {
    pCVar2 = engine_font_cpp_CBitFont_ctor_FUN_004cce90(pCVar1);
  }
  ...
  pCVar2->font_enabled = 1;
  engine_font_cpp_CBitFont_setFontReady_FUN_004d0290(pCVar2,1);
  pCVar1 = shape_memdbg_cpp_debugAlloc_FUN_0050f1b0(0x3198,"..\\core\\dfont.cpp",0x6f);
  pCVar2 = (CBitFont *)0x0;
  if (pCVar1 != (CBitFont *)0x0) {
    pCVar2 = engine_font_cpp_CBitFont_ctor_FUN_004cce90(pCVar1);
  }
  ...
  pCVar1 = shape_memdbg_cpp_debugAlloc_FUN_0050f1b0(0x3198,"..\\core\\dfont.cpp",0x82);
  pCVar2 = (CBitFont *)0x0;
  if (pCVar1 != (CBitFont *)0x0) {
    pCVar2 = engine_font_cpp_CBitFont_ctor_FUN_004cce90(pCVar1);
  }
  ...
  engine_font_cpp_CBitFont_setFontReady_FUN_004d0290(pCVar2,1);
  g_EditorFont = g_SmallEditorFont;
  pCVar1 = shape_memdbg_cpp_debugAlloc_FUN_0050f1b0(0x3198,"..\\core\\dfont.cpp",0x94);
  pCVar2 = (CBitFont *)0x0;
  if (pCVar1 != (CBitFont *)0x0) {
    pCVar2 = engine_font_cpp_CBitFont_ctor_FUN_004cce90(pCVar1);
  }
  ...
  pCVar3 = shape_memdbg_cpp_debugAlloc_FUN_0050f1b0(0x13c,"..\\core\\dfont.cpp",0xa4);
  pCVar4 = (CWinFont *)0x0;
  ...
  pCVar3 = shape_memdbg_cpp_debugAlloc_FUN_0050f1b0(0x13c,"..\\core\\dfont.cpp",0xaa);
  pCVar4 = (CWinFont *)0x0;
  if (pCVar3 != (CWinFont *)0x0) {
  ...
  pCVar2->win_font_helper = pCVar4;
  pCVar3 = shape_memdbg_cpp_debugAlloc_FUN_0050f1b0(0x13c,"..\\core\\dfont.cpp",0xb0);
  pCVar4 = (CWinFont *)0x0;
  if (pCVar3 != (CWinFont *)0x0) {
