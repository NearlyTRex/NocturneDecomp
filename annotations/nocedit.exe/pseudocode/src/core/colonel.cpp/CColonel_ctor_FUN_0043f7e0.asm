...
section .text
    ...
    PUSH EDX                            ; 0043f7e5
    CALL core_hero.cpp_FUN_004f2340     ; 0043f7e6 | undefined core_hero.cpp_FUN_004f2340()
        ;   XREF to: 004f2340 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 0043f7eb
    ADD EAX,0x158                       ; 0043f7ed
    ADD ESP,0x4                         ; 0043f7f2
    MOV dword ptr [EAX + -0x4],0x65bd54 ; 0043f7f5 | CDemonActor_vtable PTR_core_colonel.cpp_FUN_0065bd54
    PUSH 0x618b8e                       ; 0043f7fc | = "colonel.dfm" | s_colonel_dfm_00618b8e = colonel.dfm
    MOV dword ptr [EAX + 0x1fa7c],0x0   ; 0043f801
    PUSH EAX                            ; 0043f80b
    MOV dword ptr [EAX + 0x1fa80],0x0   ; 0043f80c
    CALL core_skeleton.cpp_CDeformableModelInstance_init_FUN_005a0840 ; 0043f816 | void core_skeleton.cpp_CDeformableModelInstance_init_FUN_005a0840(CDeformableModelInstance * this_ptr, char * model_name)
