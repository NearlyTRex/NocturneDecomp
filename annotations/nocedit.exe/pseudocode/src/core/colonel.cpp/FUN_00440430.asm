...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_colonel.cpp_FUN_00440430()
;
;
; XREF[1]:
...
section .text
    ...
    PUSH EAX                            ; 00440444
    PUSH EBX                            ; 00440445
    CALL core_motion.cpp_CMotionController_advance_FUN_0052d610 ; 00440446 | int core_motion.cpp_CMotionController_advance_FUN_0052d610(CMotionController * this_ptr)
        ;   XREF to: 0052d610 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0044044b
    MOV EDX,EAX                         ; 0044044e
    CMP EAX,0x64                        ; 00440450
    JC 0x00440471                       ; 00440453 | LAB_00440471
        ;   XREF to: 00440471 (CONDITIONAL_JUMP)
    JA 0x0044047d                       ; 00440455 | LAB_0044047d
    ...
    FNSTSW AX                           ; 0044045e
    SAHF                                ; 00440460
    JC 0x00440441                       ; 00440461 | LAB_00440441
    ...
    PUSH EDX                            ; 00440471
        ;   Label: LAB_00440471
    PUSH ESI                            ; 00440472
    CALL core_charactr.cpp_CCharacter_FUN_0042ec40 ; 00440473 | void core_charactr.cpp_CCharacter_FUN_0042ec40(CCharacter * this_ptr)
        ;   XREF to: 0042ec40 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00440478
    JMP 0x00440457                      ; 0044047b | LAB_00440457
        ;   XREF to: 00440457 (UNCONDITIONAL_JUMP)
    CMP EAX,0x65                        ; 0044047d
        ;   Label: LAB_0044047d
    JZ 0x00440457                       ; 00440480 | LAB_00440457
        ;   XREF to: 00440457 (CONDITIONAL_JUMP)
    PUSH EDX                            ; 00440482
    PUSH ESI                            ; 00440483
    CALL core_charactr.cpp_CCharacter_FUN_0042ec40 ; 00440484 | void core_charactr.cpp_CCharacter_FUN_0042ec40(CCharacter * this_ptr)
        ;   XREF to: 0042ec40 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00440489
    JMP 0x00440457                      ; 0044048c | LAB_00440457
        ;   XREF to: 00440457 (UNCONDITIONAL_JUMP)
