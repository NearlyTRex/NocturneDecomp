...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_colonel.cpp_FUN_0043ff20()
;
; Local Variables:
...
section .text
    ...
    MOV EDI,dword ptr [0x02db87d0]      ; 0043ff40 | int g_LocalHeroIndex
    PUSH ESI                            ; 0043ff46
    LEA EAX,[EBX + 0xbe2c]              ; 0043ff47
    MOV dword ptr [ESP + 0x94],EDX      ; 0043ff4d
    PUSH EAX                            ; 0043ff54
    MOV dword ptr [ESP + 0x94],ECX      ; 0043ff55
    MOV EDI,dword ptr [EDI*0x4 + 0x2db87c0] ; 0043ff5c | CHero *[4] g_HeroActors
    CALL crt_memory.c_memset_FUN_005fde40 ; 0043ff63 | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
        ;   XREF to: 005fde40 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EBX + 0x1fbd0]   ; 0043ff68
    ADD ESP,0xc                         ; 0043ff6e
    TEST EAX,EAX                        ; 0043ff71
    JZ 0x004402b6                       ; 0043ff73 | LAB_004402b6
        ;   XREF to: 004402b6 (CONDITIONAL_JUMP)
    MOV EAX,[0x02db87d0]                ; 0043ff79 | int g_LocalHeroIndex
    LEA EDX,[EBX + 0x20]                ; 0043ff7e
    MOV EAX,dword ptr [EAX*0x4 + 0x2db87c0] ; 0043ff81 | CHero *[4] g_HeroActors
    ...
    JZ 0x0044004d                       ; 00440033 | LAB_0044004d
    ...
    FCOMP double ptr [0x00618d01]       ; 00440075 | double DOUBLE_00618d01
    FNSTSW AX                           ; 0044007b
    SAHF                                ; 0044007d
    JNC 0x00440319                      ; 0044007e | LAB_00440319
        ;   XREF to: 00440319 (CONDITIONAL_JUMP)
    LEA EAX,[EBX + 0x158]               ; 00440084
    CMP ESI,0x1                         ; 0044008a
    JNZ 0x0044030b                      ; 0044008d | LAB_0044030b
        ;   XREF to: 0044030b (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x1fbd4],0x0   ; 00440093
    JNZ 0x004402e3                      ; 0044009a | LAB_004402e3
        ;   XREF to: 004402e3 (CONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0xbe44],ESI    ; 004400a0
    CMP ESI,0x1                         ; 004400a6
        ;   Label: LAB_004400a6
    JNZ 0x00440174                      ; 004400a9 | LAB_00440174
        ;   XREF to: 00440174 (CONDITIONAL_JUMP)
    LEA EAX,[ESP + 0x54]                ; 004400af
    PUSH EAX                            ; 004400b3
    LEA EAX,[ESP + 0x70]                ; 004400b4
    PUSH EAX                            ; 004400b8
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 004400b9 | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
    ...
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 004400cd | float core_actor.cpp_normalizeAngleToPi_FUN_0040cd70(float angle_radians)
        ;   XREF to: 0040cd70 (UNCONDITIONAL_CALL)
    MOV dword ptr [ESP + 0x98],EAX      ; 004400d2
    FLD float ptr [ESP + 0x98]          ; 004400d9
    FMUL double ptr [0x00618d09]        ; 004400e0 | double DOUBLE_00618d09
    ADD ESP,0x4                         ; 004400e6
    FMUL double ptr [0x00618d11]        ; 004400e9 | double DOUBLE_00618d11
    ...
    FNSTSW AX                           ; 0044010c
    SAHF                                ; 0044010e
    JNC 0x0044011e                      ; 0044010f | LAB_0044011e
    ...
    FNSTSW AX                           ; 0044012b
    SAHF                                ; 0044012d
    JBE 0x0044013d                      ; 0044012e | LAB_0044013d
    ...
    FCOMP double ptr [0x00618d21]       ; 00440147 | double DOUBLE_00618d21
    FNSTSW AX                           ; 0044014d
    SAHF                                ; 0044014f
    JBE 0x00440174                      ; 00440150 | LAB_00440174
        ;   XREF to: 00440174 (CONDITIONAL_JUMP)
    FLD double ptr [ESP + 0x10]         ; 00440152
    FCOMP double ptr [0x00618d29]       ; 00440156 | double DOUBLE_00618d29
    FNSTSW AX                           ; 0044015c
    SAHF                                ; 0044015e
    JNC 0x00440174                      ; 0044015f | LAB_00440174
        ;   XREF to: 00440174 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0xbe38],0x0    ; 00440161
    JZ 0x00440174                       ; 00440168 | LAB_00440174
        ;   XREF to: 00440174 (CONDITIONAL_JUMP)
    ...
    JZ 0x004401b8                       ; 0044019e | LAB_004401b8
    ...
    PUSH EAX                            ; 004401c1
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 004401c2 | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)
    MOV EDX,EAX                         ; 004401c7
    LEA EAX,[ESP + 0x5c]                ; 004401c9
    ADD ESP,0x8                         ; 004401cd
    CMP EAX,EDX                         ; 004401d0
    JZ 0x004401e8                       ; 004401d2 | LAB_004401e8
    ...
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 004401f5 | float core_actor.cpp_normalizeAngleToPi_FUN_0040cd70(float angle_radians)
        ;   XREF to: 0040cd70 (UNCONDITIONAL_CALL)
    ...
    FNSTSW AX                           ; 00440216
    SAHF                                ; 00440218
    JBE 0x00440226                      ; 00440219 | LAB_00440226
    ...
    FNSTSW AX                           ; 00440241
    SAHF                                ; 00440243
    JNC 0x00440251                      ; 00440244 | LAB_00440251
    ...
    FXCH                                ; 00440260
    FMUL double ptr [0x00618d31]        ; 00440262 | double DOUBLE_00618d31
    FXCH                                ; 00440268
    ...
    FNSTSW AX                           ; 00440276
    SAHF                                ; 00440278
    JBE 0x00440282                      ; 00440279 | LAB_00440282
    ...
    FLD float ptr [EBP + 0x18]          ; 00440282
        ;   Label: LAB_00440282
    FMUL double ptr [0x00618d39]        ; 00440285 | double DOUBLE_00618d39
    ...
    FNSTSW AX                           ; 00440299
    SAHF                                ; 0044029b
    JNC 0x004402a6                      ; 0044029c | LAB_004402a6
    ...
    FLD float ptr [ESP + 0x7c]          ; 004402bd
        ;   Label: LAB_004402bd
    FCOMP float ptr [0x00618cf1]        ; 004402c1 | float FLOAT_00618cf1
    FNSTSW AX                           ; 004402c7
    SAHF                                ; 004402c9
    JC 0x0043ffce                       ; 004402ca | LAB_0043ffce
        ;   XREF to: 0043ffce (CONDITIONAL_JUMP)
    JMP 0x00440007                      ; 004402d0 | LAB_00440007
        ;   XREF to: 00440007 (UNCONDITIONAL_JUMP)
    CMP ECX,0x3                         ; 004402d5
        ;   Label: LAB_004402d5
    JZ 0x0043ffdd                       ; 004402d8 | LAB_0043ffdd
        ;   XREF to: 0043ffdd (CONDITIONAL_JUMP)
    JMP 0x00440007                      ; 004402de | LAB_00440007
        ;   XREF to: 00440007 (UNCONDITIONAL_JUMP)
    PUSH EAX                            ; 004402e3
        ;   Label: LAB_004402e3
    CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0 ; 004402e4 | SMotion * core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0(CMotionController * this_ptr)
        ;   XREF to: 0052dab0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EAX + 0x24]      ; 004402e9
    ADD ESP,0x4                         ; 004402ec
    CMP EAX,0x2                         ; 004402ef
    JZ 0x004400a6                       ; 004402f2 | LAB_004400a6
        ;   XREF to: 004400a6 (CONDITIONAL_JUMP)
    CMP EAX,ESI                         ; 004402f8
    JZ 0x004400a6                       ; 004402fa | LAB_004400a6
        ;   XREF to: 004400a6 (CONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0xbe38],ESI    ; 00440300
    JMP 0x004400a6                      ; 00440306 | LAB_004400a6
        ;   XREF to: 004400a6 (UNCONDITIONAL_JUMP)
    PUSH EAX                            ; 0044030b
        ;   Label: LAB_0044030b
    CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0 ; 0044030c | SMotion * core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0(CMotionController * this_ptr)
        ;   XREF to: 0052dab0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00440311
    JMP 0x004400a6                      ; 00440314 | LAB_004400a6
        ;   XREF to: 004400a6 (UNCONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 00440319
        ;   Label: LAB_00440319
    TEST ESI,ESI                        ; 0044031b
    JNZ 0x0044033b                      ; 0044031d | LAB_0044033b
        ;   XREF to: 0044033b (CONDITIONAL_JUMP)
    MOV EAX,[0x02db87d0]                ; 0044031f | int g_LocalHeroIndex
    MOV EAX,dword ptr [EAX*0x4 + 0x2db87c0] ; 00440324 | CHero *[4] g_HeroActors
    PUSH EAX                            ; 0044032b
    ...
    TEST EAX,EAX                        ; 0044033b
        ;   Label: LAB_0044033b
    JNZ 0x0044034b                      ; 0044033d | LAB_0044034b
        ;   XREF to: 0044034b (CONDITIONAL_JUMP)
    LEA EAX,[EDI + 0x20]                ; 0044033f
    PUSH EAX                            ; 00440342
    CALL core_path.cpp_FUN_00548500     ; 00440343 | undefined core_path.cpp_FUN_00548500()
    ...
    PUSH EDX                            ; 00440357
    PUSH EAX                            ; 00440358
    CALL core_path.cpp_CPathMap_findPathWithRetry_FUN_00547d00 ; 00440359 | int core_path.cpp_CPathMap_findPathWithRetry_FUN_00547d00(CPathMap * this_ptr, CVector3f * dest_position, CVector3f * out_euler_angles, int direction_hint)
        ;   XREF to: 00547d00 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0044035e
    TEST EAX,EAX                        ; 00440361
    JZ 0x00440174                       ; 00440363 | LAB_00440174
        ;   XREF to: 00440174 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x28]          ; 00440369
    FSUB float ptr [EBX + 0x34]         ; 0044036d
    SUB ESP,0x4                         ; 00440370
    FSTP float ptr [ESP]                ; 00440373
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 00440376 | float core_actor.cpp_normalizeAngleToPi_FUN_0040cd70(float angle_radians)
        ;   XREF to: 0040cd70 (UNCONDITIONAL_CALL)
    MOV dword ptr [ESP + 0x98],EAX      ; 0044037b
    FLD float ptr [ESP + 0x98]          ; 00440382
    FMUL double ptr [0x00618d09]        ; 00440389 | double DOUBLE_00618d09
    ADD ESP,0x4                         ; 0044038f
    FMUL double ptr [0x00618d11]        ; 00440392 | double DOUBLE_00618d11
    ...
    FNSTSW AX                           ; 004403b5
    SAHF                                ; 004403b7
    JC 0x004403fc                       ; 004403b8 | LAB_004403fc
    ...
    FNSTSW AX                           ; 004403c7
    SAHF                                ; 004403c9
    JBE 0x004403d9                      ; 004403ca | LAB_004403d9
