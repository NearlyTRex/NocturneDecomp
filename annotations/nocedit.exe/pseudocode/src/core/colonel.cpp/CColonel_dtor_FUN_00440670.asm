...
;                               FUNCTION
; *****************************************************************************
; __cdecl CColonel * __cdecl core_colonel_cpp_CColonel_dtor_FUN_00440670(CColonel *this_ptr,uint flags)
;
; Parameters:
...
section .text
    ...
    PUSH 0x65bec0                       ; 00440696 | g_CColonelTypeInfo
        ;   Label: LAB_00440696
    PUSH EBX                            ; 0044069b
    CALL crt_memory.c___vec_delete_FUN_005fe632 ; 0044069c
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c___vec_delete_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 004406a1
    PUSH EAX                            ; 004406a4
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 004406a5
