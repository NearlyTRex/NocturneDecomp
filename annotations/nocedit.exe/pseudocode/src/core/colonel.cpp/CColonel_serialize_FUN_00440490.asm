...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_colonel_cpp_CColonel_serialize_FUN_00440490(CColonel *this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x4]       ; 00440490
        ;   Label: core_colonel.cpp_CColonel_serialize_FUN_00440490
    PUSH EDX                            ; 00440494
    CALL core_hero.cpp_CHero_serialize_FUN_004f2610 ; 00440495
