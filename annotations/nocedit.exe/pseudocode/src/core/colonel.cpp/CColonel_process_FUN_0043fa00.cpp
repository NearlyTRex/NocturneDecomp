...

{
  ...
  fVar1 = (this_ptr->base).invincibility_timer - delta_time;
  (this_ptr->base).invincibility_timer = fVar1;
  if (fVar1 < 0.0) {
  ...
  fVar1 = (float)12.566370614;
  (this_ptr->base).base.walk_step_speed = (this_ptr->base).base.model.accumulated_root_motion.z;
  (this_ptr->base).base.turn_speed = delta_time * fVar1;
    ...
    case 3:
      if ((this_ptr->base).base.is_on_ground != 0) {
        ...
        if ((this_ptr->base).player_control.action_states[6] != 0) {
          ...
          iVar3 = 0;
          this_ptr->guns_drawn = (uint)(iVar6 == 0);
        }
        if ((this_ptr->base).player_control.action_states[3] != 0) {
          ...
          if ((this_ptr->guns_drawn == 0) && ((this_ptr->base).control_type != HERO_CONTROL_AI)) {
            ...
            iVar6 = core_hero_cpp_CHero_tryOpenNearbyDoor_FUN_004f2d70(&this_ptr->base);
            if ((iVar6 != 0) && (iVar6 != 1)) {
              core_hero_cpp_CHero_tryOpenDoor_FUN_004f2ed0(&this_ptr->base);
            }
            if ((iVar6 != 0) ||
               (iVar6 = core_hero_cpp_CHero_tryTalkToNearbyCharacter_FUN_004f2c40(&this_ptr->base),
               iVar6 != 0)) goto LAB_0043fd60;
            iVar6 = core_hero_cpp_CHero_tryPullLever_FUN_004f2f50(&this_ptr->base);
            if (iVar6 != 0) {
...
LAB_0043fd6e:
        ...
        if (iVar3 != pSVar5->state_index) goto LAB_0043fad3;
      }
      break;
    case 6:
...
switchD_0043fe37_caseD_5:
  ...
  if (pCVar3 == (CDemonActor *)0x0) {
    ...
    local_68.x = pCVar4->x + pCVar1->x + (this_ptr->base).base.velocity.x * delta_time;
    ...
    fVar1 = (this_ptr->base).base.position_delta.z;
    (this_ptr->base).base.position_delta.y = fVar1;
    pCVar1->x = fVar1;
    ...
    if ((this_ptr->base).base.grabbed_type == 0) {
      ...
      pCVar4 = core_vecdir_cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(&local_44,pCVar6);
      ...
      fVar1 = delta_time * (float)3.1415926535000001;
      if (local_98 < -fVar1) {
        local_98 = -fVar1;
      }
      if (fVar1 < local_98) {
...
LAB_0043fc14:
  ...
  pCVar7 = &(this_ptr->base).base.model;
  core_skeleton_cpp_CDeformableModelInstance_updateAnimation_FUN_0059e020(pCVar7);
  ...
  if (EVar7 == DEATH_STATE_ALIVE) {
    ...
    *puVar11 = *puVar10;
    ...
    core_skeleton_cpp_CDeformableModelInstance_blendBoneRotations_FUN_0059f750
              (pCVar7,source_quaternions,fVar14,iVar3,
