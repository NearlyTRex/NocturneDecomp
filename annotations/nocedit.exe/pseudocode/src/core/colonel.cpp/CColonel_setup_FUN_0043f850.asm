...
section .text
    ...
    PUSH EBX                            ; 0043f887
    MOV [0x0083b124],EAX                ; 0043f888 | g_ColonelIndices
    ...
    PUSH EBX                            ; 0043f89c
    MOV [0x0083b128],EAX                ; 0043f89d | g_ColonelIndices[1]
    ...
    PUSH EBX                            ; 0043f8b1
    MOV [0x0083b12c],EAX                ; 0043f8b2 | g_ColonelIndices[2]
    ...
    PUSH EBX                            ; 0043f8c6
    MOV [0x0083b130],EAX                ; 0043f8c7 | g_ColonelIndices[3]
    ...
    PUSH EBX                            ; 0043f8db
    MOV [0x0083b134],EAX                ; 0043f8dc | g_ColonelIndices[4]
    ...
    PUSH EBX                            ; 0043f8f0
    MOV [0x0083b138],EAX                ; 0043f8f1 | g_ColonelIndices[5]
    ...
    PUSH EBX                            ; 0043f905
    MOV [0x0083b13c],EAX                ; 0043f906 | g_ColonelIndices[6]
    ...
    PUSH EBX                            ; 0043f91a
    MOV [0x0083b140],EAX                ; 0043f91b | g_ColonelIndices[7]
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 0043f920
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 0043f925
    MOV [0x0083b144],EAX                ; 0043f928 | g_ColonelIndices[8]
    PUSH 0x1                            ; 0043f92d
    ...
    PUSH EBX                            ; 0043f944
    MOV [0x0083b148],EAX                ; 0043f945 | g_ColonelIndices[9]
    ...
    PUSH EBX                            ; 0043f959
    MOV [0x0083b14c],EAX                ; 0043f95a | g_ColonelIndices[10]
    ...
    PUSH EBX                            ; 0043f96e
    MOV [0x0083b150],EAX                ; 0043f96f | g_ColonelIndices[11]
    ...
    PUSH EBX                            ; 0043f983
    MOV [0x0083b154],EAX                ; 0043f984 | g_ColonelIndices[12]
    ...
    PUSH EBX                            ; 0043f998
    MOV [0x0083b158],EAX                ; 0043f999 | g_ColonelIndices[13]
    ...
    PUSH EBX                            ; 0043f9ad
    MOV [0x0083b15c],EAX                ; 0043f9ae | g_ColonelIndices[14]
    ...
    PUSH EBX                            ; 0043f9c2
    MOV [0x0083b160],EAX                ; 0043f9c3 | g_ColonelIndices[15]
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 0043f9c8
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 0043f9cd
    MOV [0x0083b164],EAX                ; 0043f9d0 | g_ColonelIndices[16]
