...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_colonel_cpp_CColonel_processDamage_FUN_004404b0(CColonel *this_ptr,SDamageInfo *damage_info)
;
; Parameters:
...
section .text
    ...
    CALL core_gore.cpp_CGore_FUN_004ee030 ; 00440596
