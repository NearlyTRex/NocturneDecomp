...
;
; Called Functions:
;   core_emitter.cpp_CEmitter_ctor_FUN_004a7ca0
...
section .text
    ...
    PUSH 0x3a                           ; 004a7c60
        ;   Label: core_emitter.cpp_factoryFuncEmitter_FUN_004a7c60
    PUSH 0x624053                       ; 004a7c62 | = "..\\core\\emitter.cpp"
    PUSH 0x494                          ; 004a7c67
    CALL shape_memdbg.cpp_debugAllocTracked1_FUN_0050f1b0 ; 004a7c6c
    ...
    PUSH EAX                            ; 004a7c79
        ;   Label: LAB_004a7c79
    CALL core_emitter.cpp_CEmitter_ctor_FUN_004a7ca0 ; 004a7c7a
        ;   XREF to: 004a7ca0 (UNCONDITIONAL_CALL)  ; CEmitter * core_emitter.cpp_CEmitter_ctor_FUN_004a7ca0(CEmitter * this_ptr)
