...
section .text
    ...
    PUSH 0x65d790                       ; 004a93e6 | g_CEmitterTypeInfo
        ;   Label: LAB_004a93e6
    PUSH EBX                            ; 004a93eb
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 004a93ec
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 004a93f1
    PUSH EAX                            ; 004a93f4
    CALL crt_memory.c_free_FUN_005fe659 ; 004a93f5
    ...
    PUSH EAX                            ; 004a9401
        ;   Label: LAB_004a9401
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 004a9402
