...
section .text
    ...
    CMP dword ptr [0x02cf2b5c],0x0      ; 004a8ff8 | DAT_02cf2b5c
    ...
    PUSH EAX                            ; 004a9010 | g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004a9011 | g_CKeysPtr
    ...
    PUSH EAX                            ; 004a9038 | g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004a9039 | g_CKeysPtr
    ...
    PUSH EAX                            ; 004a905f | g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004a9060 | g_CKeysPtr
    ...
    PUSH EAX                            ; 004a9082 | g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004a9083 | g_CKeysPtr
    ...
    PUSH EAX                            ; 004a90a5 | g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004a90a6 | g_CKeysPtr
    ...
    PUSH EAX                            ; 004a90c8 | g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004a90c9 | g_CKeysPtr
    ...
    PUSH EAX                            ; 004a90eb | g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004a90ec | g_CKeysPtr
    ...
    XOR ESI,ESI                         ; 004a9150
        ;   Label: LAB_004a9150
    MOV dword ptr [0x02cf2b5c],ESI      ; 004a9152 | DAT_02cf2b5c
    ...
    POP EBX                             ; 004a916d
    RET                                 ; 004a916e
    CMP dword ptr [0x02cf2b5c],0x0      ; 004a916f | DAT_02cf2b5c
        ;   Label: LAB_004a916f
    ...
    MOV EAX,[0x02cf2b60]                ; 004a91be | DAT_02cf2b60
    MOV dword ptr [ECX],EAX             ; 004a91c3
    MOV EAX,[0x02cf2b64]                ; 004a91c5 | DAT_02cf2b64
    MOV dword ptr [ECX + 0x4],EAX       ; 004a91ca
    MOV EAX,[0x02cf2b68]                ; 004a91cd | DAT_02cf2b68
    ...
    CMP EAX,0x2cf2b60                   ; 004a9209 | DAT_02cf2b60
    ...
    MOV dword ptr [0x02cf2b64],EDX      ; 004a9218 | DAT_02cf2b64
    FSTP float ptr [0x02cf2b68]         ; 004a921e | DAT_02cf2b68
    FSTP float ptr [0x02cf2b60]         ; 004a9224 | DAT_02cf2b60
    ...
    FLD float ptr [0x02cf2b60]          ; 004a9265 | DAT_02cf2b60
    FLD float ptr [0x02cf2b64]          ; 004a926b | DAT_02cf2b64
    FLD float ptr [0x02cf2b68]          ; 004a9271 | DAT_02cf2b68
    ...
    CMP EAX,0x2cf2b60                   ; 004a92f1 | DAT_02cf2b60
    ...
    MOV dword ptr [0x02cf2b64],EDX      ; 004a9300 | DAT_02cf2b64
    FSTP float ptr [0x02cf2b68]         ; 004a9306 | DAT_02cf2b68
    FSTP float ptr [0x02cf2b60]         ; 004a930c | DAT_02cf2b60
