...
section .text
    ...
    PUSH EBX                            ; 004a8db0
        ;   Label: core_emitter.cpp_CEmitter_getPropertyList_FUN_004a8db0
    PUSH ESI                            ; 004a8db1
    PUSH EDI                            ; 004a8db2
    ...
    PUSH EAX                            ; 004a8dcb
    PUSH 0x6792ec                       ; 004a8dcc | g_EmitterTypePairs
    PUSH 0xb                            ; 004a8dd1
    ...
    JNZ 0x004a8eeb                      ; 004a8ed4
        ;   XREF to: 004a8eeb (CONDITIONAL_JUMP)  ; LAB_004a8eeb
    PUSH 0x0                            ; 004a8ed6
    PUSH 0x2cf2b60                      ; 004a8ed8 | g_EmitterTarget
    ...
    PUSH EBX                            ; 004a8f7c
    PUSH 0x679344                       ; 004a8f7d | g_EmitterSoundTypePairs
    PUSH 0x2                            ; 004a8f82
