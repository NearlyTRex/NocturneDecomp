...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_emitter.cpp_FUN_004a8d20()
;
;
; XREF[1]:
...
section .text
    ...
    CALL core_actor.cpp_getRandomFloat_FUN_0040cc10 ; 004a8d45 | float core_actor.cpp_getRandomFloat_FUN_0040cc10(float min_value, float max_value)
