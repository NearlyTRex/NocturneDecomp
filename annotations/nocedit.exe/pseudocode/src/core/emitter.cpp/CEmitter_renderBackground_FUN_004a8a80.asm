...
section .text
    ...
    PUSH EBX                            ; 004a8a80
        ;   Label: core_emitter.cpp_CEmitter_renderBackground_FUN_004a8a80
    SUB ESP,0x18                        ; 004a8a81
    MOV EBX,dword ptr [ESP + 0x20]      ; 004a8a84
    CMP dword ptr [ESP + 0x24],0x0      ; 004a8a88
    JNZ 0x004a8a94                      ; 004a8a8d
        ;   XREF to: 004a8a94 (CONDITIONAL_JUMP)  ; LAB_004a8a94
    ADD ESP,0x18                        ; 004a8a8f
    POP EBX                             ; 004a8a92
    RET                                 ; 004a8a93
    PUSH EBX                            ; 004a8a94
        ;   Label: LAB_004a8a94
    CALL core_actor.cpp_CDemonActor_setupRenderState_FUN_00408b00 ; 004a8a95
    ...
    PUSH EAX                            ; 004a8aad
    CALL core_box.cpp_CBoundingBox3D_isVisible_FUN_004204f0 ; 004a8aae
        ;   XREF to: 004204f0 (UNCONDITIONAL_CALL)  ; int core_box.cpp_CBoundingBox3D_isVisible_FUN_004204f0(CBoundingBox3D * this_ptr)
    ADD ESP,0x4                         ; 004a8ab3
    PUSH EBX                            ; 004a8ab6
    MOV dword ptr [EBX + 0x48c],EAX     ; 004a8ab7
    CALL core_actor.cpp_CDemonActor_restoreRenderState_FUN_00408b40 ; 004a8abd
