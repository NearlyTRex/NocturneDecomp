...
;                               FUNCTION
; *****************************************************************************
; __cdecl CEmitter * __cdecl core_emitter_cpp_CEmitter_ctor_FUN_004a7ca0(CEmitter *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004a7ca0
        ;   Label: core_emitter.cpp_CEmitter_ctor_FUN_004a7ca0
    PUSH ESI                            ; 004a7ca1
    PUSH EDI                            ; 004a7ca2
    MOV EBX,dword ptr [ESP + 0x10]      ; 004a7ca3
    PUSH EBX                            ; 004a7ca7
    CALL core_actor.cpp_CDemonActor_ctor_FUN_004088b0 ; 004a7ca8
    ...
    PUSH EAX                            ; 004a7cb5
    CALL core_dmodel.cpp_CKeyFramedModelInstance_ctor_FUN_00478ce0 ; 004a7cb6
    ...
    MOV dword ptr [EBX + 0x154],0x65d684 ; 004a7cc1 | g_CEmitterVTable
    MOV dword ptr [EBX + 0x15c],0x3f800000 ; 004a7ccb
    MOV ESI,0x624067                    ; 004a7cd5 | = "none"
    ...
    PUSH EDI                            ; 004a7d01
    MOV AL,byte ptr [ESI]               ; 004a7d02 | = "none" | s_ne_00624069
        ;   Label: LAB_004a7d02
    MOV byte ptr [EDI],AL               ; 004a7d04
    CMP AL,0x0                          ; 004a7d06
    JZ 0x004a7d1a                       ; 004a7d08
        ;   XREF to: 004a7d1a (CONDITIONAL_JUMP)  ; LAB_004a7d1a
    MOV AL,byte ptr [ESI + 0x1]         ; 004a7d0a | s_one_00624068 | s_e_0062406a
    ADD ESI,0x2                         ; 004a7d0d
    MOV byte ptr [EDI + 0x1],AL         ; 004a7d10
    ADD EDI,0x2                         ; 004a7d13
    CMP AL,0x0                          ; 004a7d16
    JNZ 0x004a7d02                      ; 004a7d18
        ;   XREF to: 004a7d02 (CONDITIONAL_JUMP)  ; LAB_004a7d02
    POP EDI                             ; 004a7d1a
        ;   Label: LAB_004a7d1a
    MOV ESI,0x62406c                    ; 004a7d1b | = "none"
    LEA EDI,[EBX + 0x1d0]               ; 004a7d20
    PUSH EDI                            ; 004a7d26
    MOV AL,byte ptr [ESI]               ; 004a7d27 | = "none" | s_ne_0062406e
        ;   Label: LAB_004a7d27
    MOV byte ptr [EDI],AL               ; 004a7d29
    CMP AL,0x0                          ; 004a7d2b
    JZ 0x004a7d3f                       ; 004a7d2d
        ;   XREF to: 004a7d3f (CONDITIONAL_JUMP)  ; LAB_004a7d3f
    MOV AL,byte ptr [ESI + 0x1]         ; 004a7d2f | s_one_0062406d | s_e_0062406f
    ADD ESI,0x2                         ; 004a7d32
    MOV byte ptr [EDI + 0x1],AL         ; 004a7d35
    ADD EDI,0x2                         ; 004a7d38
    CMP AL,0x0                          ; 004a7d3b
    JNZ 0x004a7d27                      ; 004a7d3d
        ;   XREF to: 004a7d27 (CONDITIONAL_JUMP)  ; LAB_004a7d27
    POP EDI                             ; 004a7d3f
        ;   Label: LAB_004a7d3f
    ...
    PUSH 0x624071                       ; 004a7d7c | = "stalrock.kfm"
    ...
    CALL core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0 ; 004a7da6
