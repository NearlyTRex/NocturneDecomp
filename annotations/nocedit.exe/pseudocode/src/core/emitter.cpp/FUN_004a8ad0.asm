...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_emitter.cpp_FUN_004a8ad0()
;
;
; Referenced Globals:
...
section .text
    ...
    FCHS                                ; 004a8ade
    FLD double ptr [0x006240c2]         ; 004a8ae0 | double DOUBLE_006240c2
    FXCH                                ; 004a8ae6
    FMUL ST1                            ; 004a8ae8
    ...
    FADD double ptr [0x006240ca]        ; 004a8b11 | double DOUBLE_006240ca
