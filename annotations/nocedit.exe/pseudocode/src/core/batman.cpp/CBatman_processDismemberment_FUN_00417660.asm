...
section .text
    ...
    PUSH EBX                            ; 00417660
        ;   Label: core_batman.cpp_CBatman_processDismemberment_FUN_00417660
    PUSH ESI                            ; 00417661
    PUSH EDI                            ; 00417662
    PUSH EBP                            ; 00417663
    ...
    MOV EAX,[0x0067b654]                ; 004176e0 | g_CGameInstance | g_CGamePtr
        ;   Label: LAB_004176e0
    CMP dword ptr [EAX + 0x1e0],0x0     ; 004176e5 | g_CGameInstance.gratuitous_dismemberment
    ...
    PUSH EBP                            ; 00417803
    CALL core_bodypart.cpp_CBodyPart_finalizeGeometry_FUN_0041a050 ; 00417804
