...
{
  CBatman_ptr_13260 pCVar1;
  CBatman_ptr_12060 pSVar1;
  CBatman_ptr_11536 pCVar2;
  CBatman_ptr_11356 pCVar3;
  CBatman_ptr_10900 pCVar4;
  CBatman_ptr_344 pCVar5;
  CBatman *ptr;
  void *ptr_00;
  ...
  ptr = (CBatman *)core_actor_cpp_CDemonActor_dtor_FUN_00408a30((CDemonActor *)ADJ(pCVar5),1);
  if ((flags & 2) == 0) {
    return ptr;
  }
