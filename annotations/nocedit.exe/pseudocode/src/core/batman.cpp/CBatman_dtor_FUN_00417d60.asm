...
;                               FUNCTION
; *****************************************************************************
; __cdecl CBatman * __cdecl core_batman_cpp_CBatman_dtor_FUN_00417d60 (CBatman *this_ptr,uint d1,uint d2,uint d3,uint d4,uint d5,uint d6,uint d7,uint d8)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00417d78
    CALL core_backgnd.cpp_freeFlames_FUN_00412720 ; 00417d79
    ...
    PUSH EAX                            ; 00417d88
    CALL core_backgnd.cpp_freeFires_FUN_00412700 ; 00417d89
    ...
    PUSH EAX                            ; 00417d98
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 00417d99
    ...
    PUSH EAX                            ; 00417da8
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 00417da9
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; int core_backgnd.cpp_cleanupVector_FUN_004126e0(CVector3f * * objs)
    ADD ESP,0x8                         ; 00417dae
    PUSH 0x0                            ; 00417db1
    SUB EAX,0x1c8                       ; 00417db3
    PUSH EAX                            ; 00417db8
    CALL core_cloth.cpp_FUN_0043bf80    ; 00417db9
    ...
    PUSH 0x65a8f0                       ; 00417df1 | g_CBatmanTypeInfo
        ;   Label: LAB_00417df1
    PUSH EBX                            ; 00417df6
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 00417df7
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 00417dfc
    PUSH EAX                            ; 00417dff
    CALL crt_memory.c_free_FUN_005fe659 ; 00417e00
    ...
    PUSH EAX                            ; 00417e0c
        ;   Label: LAB_00417e0c
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 00417e0d
