// Name: core_batman.cpp_CBatman_processDismemberment_FUN_00417660
// Address: 00417660
// Address Range: [[00417660, 00417997]]
// Convention: __cdecl
// Signature: void __cdecl core_batman_cpp_CBatman_processDismemberment_FUN_00417660(CBatman *this_ptr,SDamageInfo *damage_info)

#include "nocturne.h"

/* WARNING: Type propagation algorithm not settling */

void __cdecl core_batman_cpp_CBatman_processDismemberment_FUN_00417660(CBatman *this_ptr,SDamageInfo *damage_info)
...
switchD_00417696_default:
  ...
  if (((((iVar1 == this_ptr->part_indices[2]) || (iVar1 == this_ptr->part_indices[3])) ||
       (iVar1 == this_ptr->part_indices[4])) ||
      ((iVar1 == this_ptr->part_indices[5] || (iVar1 == this_ptr->part_indices[1])))) ||
     (iVar1 == this_ptr->part_indices[0])) {
  ...
  iVar1 = damage_info->hit_part_index;
  if (iVar1 == this_ptr->part_indices[0]) {
    fVar1 = damage_info->damage_amount * (float)2.5;
  }
  else {
    if ((iVar1 == this_ptr->part_indices[6]) || (iVar1 == this_ptr->part_indices[1])) {
