...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_batman.cpp_FUN_00417660()
;
; Local Variables:
...
section .text
    ...
    FNSTSW AX                           ; 00417676
    SAHF                                ; 00417678
    JNC 0x004176a5                      ; 00417679 | default
        ;   XREF to: 004176a5 (CONDITIONAL_JUMP)
    CMP dword ptr [ESI],-0x1            ; 0041767b
    JNZ 0x004176a5                      ; 0041767e | default
        ;   XREF to: 004176a5 (CONDITIONAL_JUMP)
    CALL crt_stdlib.c_rand_FUN_005feb5c ; 00417680 | int crt_stdlib.c_rand_FUN_005feb5c()
    ...
    JA 0x004176a5                       ; 00417694 | default
        ;   XREF to: 004176a5 (CONDITIONAL_JUMP)
    JMP dword ptr [EDX*0x4 + 0x41763c]  ; 00417696 | void * switchdataD_0041763c
        ;   Label: switchD
    ...
    JNZ 0x004178a4                      ; 004176af | LAB_004178a4
    ...
    JNZ 0x004176ce                      ; 004176c4 | LAB_004176ce
    ...
    PUSH EAX                            ; 00417731
    CALL core_bodypart.cpp_CreateBodyPart_FUN_00418e10 ; 00417732 | undefined core_bodypart.cpp_CreateBodyPart_FUN_00418e10()
    ...
    PUSH EDI                            ; 00417743
    PUSH EBX                            ; 00417744
    CALL core_charactr.cpp_CCharacter_FUN_0042bd30 ; 00417745 | void core_charactr.cpp_CCharacter_FUN_0042bd30(CCharacter * this_ptr)
    ...
    JNZ 0x0041776c                      ; 00417757 | LAB_0041776c
    ...
    PUSH EDI                            ; 00417762
    PUSH EBX                            ; 00417763
    CALL core_charactr.cpp_CCharacter_FUN_0042bd30 ; 00417764 | void core_charactr.cpp_CCharacter_FUN_0042bd30(CCharacter * this_ptr)
        ;   XREF to: 0042bd30 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00417769
    MOV EDI,dword ptr [EBX + 0xbf30]    ; 0041776c
        ;   Label: LAB_0041776c
    CMP EDI,dword ptr [ESI]             ; 00417772
    JNZ 0x00417789                      ; 00417774 | LAB_00417789
    ...
    PUSH EBP                            ; 0041777f
    PUSH EBX                            ; 00417780
    CALL core_charactr.cpp_CCharacter_FUN_0042bd30 ; 00417781 | void core_charactr.cpp_CCharacter_FUN_0042bd30(CCharacter * this_ptr)
        ;   XREF to: 0042bd30 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00417786
    MOV EDX,dword ptr [EBX + 0xbf24]    ; 00417789
        ;   Label: LAB_00417789
    CMP EDX,dword ptr [ESI]             ; 0041778f
    JNZ 0x004177f5                      ; 00417791 | LAB_004177f5
    ...
    PUSH ECX                            ; 0041779f
    PUSH EBX                            ; 004177a0
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 004177a1 | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
    ...
    PUSH EAX                            ; 004177b2
    PUSH EBX                            ; 004177b3
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 004177b4 | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDX                            ; 004177c5
    PUSH EBX                            ; 004177c6
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 004177c7 | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ...
    PUSH ECX                            ; 004177d8
    PUSH EBX                            ; 004177d9
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 004177da | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDI                            ; 004177eb
    PUSH EBX                            ; 004177ec
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 004177ed | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004177f2
    PUSH 0x615939                       ; 004177f5 | = "limb?.wav" | s_limb_wav_00615939 = limb?.wav
        ;   Label: LAB_004177f5
    PUSH EBX                            ; 004177fa
    CALL core_charactr.cpp_CCharacter_FUN_0042f300 ; 004177fb | void core_charactr.cpp_CCharacter_FUN_0042f300(CCharacter * this_ptr)
        ;   XREF to: 0042f300 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00417800
    PUSH EBP                            ; 00417803
    CALL core_bodypart.cpp_FUN_0041a050 ; 00417804 | undefined core_bodypart.cpp_FUN_0041a050()
    ...
    JZ 0x004178e5                       ; 0041781b | LAB_004178e5
        ;   XREF to: 004178e5 (CONDITIONAL_JUMP)
    FLD float ptr [ESI + 0x8]           ; 00417821
        ;   Label: LAB_00417821
    FLD ST0                             ; 00417824
    FMUL double ptr [0x0061595d]        ; 00417826 | double DOUBLE_0061595d
    FSTP ST1                            ; 0041782c
    ...
    JNZ 0x004178f1                      ; 0041783b | LAB_004178f1
        ;   XREF to: 004178f1 (CONDITIONAL_JUMP)
    FLD float ptr [ESI + 0x4]           ; 00417841
    FLD ST0                             ; 00417844
    FMUL double ptr [0x0061596d]        ; 00417846 | double DOUBLE_0061596d
    FSTP ST1                            ; 0041784c
        ;   Label: LAB_0041784c
    ...
    JNZ 0x00417865                      ; 00417859 | LAB_00417865
        ;   XREF to: 00417865 (CONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0x30],0x68     ; 0041785b
    JZ 0x0041791c                       ; 0041785f | LAB_0041791c
    ...
    MOV EAX,dword ptr [EBX + 0xbf2c]    ; 0041786d
        ;   Label: caseD_1
    JMP 0x004176a3                      ; 00417873 | LAB_004176a3
        ;   XREF to: 004176a3 (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0xbf30]    ; 00417878
        ;   Label: caseD_2
    JMP 0x004176a3                      ; 0041787e | LAB_004176a3
        ;   XREF to: 004176a3 (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0xbf34]    ; 00417883
        ;   Label: caseD_3
    JMP 0x004176a3                      ; 00417889 | LAB_004176a3
        ;   XREF to: 004176a3 (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0xbf20]    ; 0041788e
        ;   Label: caseD_4
    JMP 0x004176a3                      ; 00417894 | LAB_004176a3
        ;   XREF to: 004176a3 (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0xbf24]    ; 00417899
        ;   Label: caseD_5
    JMP 0x004176a3                      ; 0041789f | LAB_004176a3
        ;   XREF to: 004176a3 (UNCONDITIONAL_JUMP)
    CMP EAX,dword ptr [EBX + 0xbf2c]    ; 004178a4
        ;   Label: LAB_004178a4
    JZ 0x004176b5                       ; 004178aa | LAB_004176b5
        ;   XREF to: 004176b5 (CONDITIONAL_JUMP)
    CMP EAX,dword ptr [EBX + 0xbf30]    ; 004178b0
    JZ 0x004176b5                       ; 004178b6 | LAB_004176b5
        ;   XREF to: 004176b5 (CONDITIONAL_JUMP)
    CMP EAX,dword ptr [EBX + 0xbf34]    ; 004178bc
    JZ 0x004176b5                       ; 004178c2 | LAB_004176b5
        ;   XREF to: 004176b5 (CONDITIONAL_JUMP)
    CMP EAX,dword ptr [EBX + 0xbf24]    ; 004178c8
    JZ 0x004176b5                       ; 004178ce | LAB_004176b5
        ;   XREF to: 004176b5 (CONDITIONAL_JUMP)
    CMP EAX,dword ptr [EBX + 0xbf20]    ; 004178d4
    JZ 0x004176b5                       ; 004178da | LAB_004176b5
        ;   XREF to: 004176b5 (CONDITIONAL_JUMP)
    JMP 0x00417831                      ; 004178e0 | LAB_00417831
        ;   XREF to: 00417831 (UNCONDITIONAL_JUMP)
    MOV dword ptr [ESI + 0x4],0x461c3c00 ; 004178e5
        ;   Label: LAB_004178e5
    JMP 0x00417821                      ; 004178ec | LAB_00417821
        ;   XREF to: 00417821 (UNCONDITIONAL_JUMP)
    CMP EAX,dword ptr [EBX + 0xbf38]    ; 004178f1
        ;   Label: LAB_004178f1
    JNZ 0x00417904                      ; 004178f7 | LAB_00417904
        ;   XREF to: 00417904 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESI + 0x4]       ; 004178f9
        ;   Label: LAB_004178f9
    MOV dword ptr [ESI + 0x4],EAX       ; 004178fc
    JMP 0x00417851                      ; 004178ff | LAB_00417851
        ;   XREF to: 00417851 (UNCONDITIONAL_JUMP)
    CMP EAX,dword ptr [EBX + 0xbf24]    ; 00417904
        ;   Label: LAB_00417904
    JZ 0x004178f9                       ; 0041790a | LAB_004178f9
        ;   XREF to: 004178f9 (CONDITIONAL_JUMP)
    FLD float ptr [ESI + 0x4]           ; 0041790c
    FLD ST0                             ; 0041790f
    FMUL double ptr [0x00615965]        ; 00417911 | double DOUBLE_00615965
    JMP 0x0041784c                      ; 00417917 | LAB_0041784c
        ;   XREF to: 0041784c (UNCONDITIONAL_JUMP)
    FLD float ptr [ESI + 0x4]           ; 0041791c
        ;   Label: LAB_0041791c
    PUSH 0x615943                       ; 0041791f | = "Shot thru the heart\n" | s_Shot_thru_the_heart_00615943 = Shot thru the heart

    MOV EDX,dword ptr [0x0066e8e0]      ; 00417924 | CConsole g_ConsolePtr | CConsole * g_CConsolePtr
    FLD ST0                             ; 0041792a
    FMUL double ptr [0x00615975]        ; 0041792c | double DOUBLE_00615975
    PUSH EDX                            ; 00417932 | CConsole g_ConsolePtr
    FSTP ST1                            ; 00417933
    FSTP float ptr [ESI + 0x4]          ; 00417935
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 00417938 | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
        ;   XREF to: 00441890 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0041793d
    PUSH 0x3f000000                     ; 00417940
    CALL core_actor.cpp_randomChance_FUN_0040cd10 ; 00417945 | int core_actor.cpp_randomChance_FUN_0040cd10(float probability_threshold)
        ;   XREF to: 0040cd10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0041794a
    TEST EAX,EAX                        ; 0041794d
    JZ 0x00417865                       ; 0041794f | LAB_00417865
        ;   XREF to: 00417865 (CONDITIONAL_JUMP)
    ...
    CALL core_actor.cpp_CDemonActor_transformVector_FUN_00408e80 ; 00417973 | CVector3f * core_actor.cpp_CDemonActor_transformVector_FUN_00408e80(CDemonActor * this_ptr, CVector3f * output, CVector3f * input)
    ...
    PUSH EAX                            ; 00417986
    PUSH EBX                            ; 00417987
    CALL core_charactr.cpp_CCharacter_FUN_0042b9e0 ; 00417988 | void core_charactr.cpp_CCharacter_FUN_0042b9e0(CCharacter * this_ptr)
