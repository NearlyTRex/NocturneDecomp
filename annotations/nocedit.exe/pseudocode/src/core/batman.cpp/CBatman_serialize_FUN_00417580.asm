...
section .text
    ...
    PUSH EBX                            ; 00417586
    CALL core_enemy.cpp_CEnemy_serialize_FUN_004a9660 ; 00417587
    ...
    PUSH ESI                            ; 0041759a
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 0041759b
    ...
    PUSH ESI                            ; 004175ae
    CALL core_actor.cpp_serializedDeformableModelInstance_FUN_0040b970 ; 004175af
    ...
    PUSH ESI                            ; 004175bc
    CALL core_actor.cpp_serializeMotionState_FUN_0040b9f0 ; 004175bd
    ...
    PUSH ESI                            ; 004175e7
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 004175e8
    ...
    PUSH ESI                            ; 00417607
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 00417608
    ...
    PUSH ESI                            ; 0041761b
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 0041761c
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ADD ESP,0x8                         ; 00417621
    PUSH 0x615932                       ; 00417624 | = "newPos"
    ADD EBX,0xbf60                      ; 00417629
    PUSH EBX                            ; 0041762f
    CALL core_actor.cpp_serializeVector_FUN_0040b340 ; 00417630
