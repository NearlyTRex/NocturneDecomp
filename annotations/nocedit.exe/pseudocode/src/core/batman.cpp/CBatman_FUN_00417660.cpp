...

{
  ...
  if ((0.0 < (float)in_stack_00000008[0xb]) && (*in_stack_00000008 == -1)) {
    ...
    case 1:
      ...
      break;
    case 2:
      iVar2 = *(int *)(this_ptr->unk1 + 0x7c);
      break;
    case 3:
      iVar2 = *(int *)(this_ptr->unk1 + 0x80);
      break;
    case 4:
...
switchD_00417696_default:
  ...
  if (((((iVar2 == *(int *)(this_ptr->unk1 + 0x74)) || (iVar2 == *(int *)(this_ptr->unk1 + 0x78)))
       || (iVar2 == *(int *)(this_ptr->unk1 + 0x7c))) ||
      ((iVar2 == *(int *)(this_ptr->unk1 + 0x80) || (iVar2 == *(int *)(this_ptr->unk1 + 0x70))))) ||
     (iVar2 == *(int *)(this_ptr->unk1 + 0x6c))) {
    local_14 = (float)in_stack_00000008[0xb];
    if (*(int *)(this_ptr->unk1 + 0x6c) == *in_stack_00000008) {
      local_14 = 0.05;
    }
    if (*(int *)(this_ptr->unk1 + 0x70) == *in_stack_00000008) {
      local_14 = 0.02;
    }
    ...
    if (iVar2 != 0) {
      ...
      if (*in_stack_00000008 == *(int *)(this_ptr->unk1 + 0x74)) {
        core_charactr_cpp_CCharacter_FUN_0042bd30((CCharacter *)this_ptr);
      }
      if (*(int *)(this_ptr->unk1 + 0x7c) == *in_stack_00000008) {
        core_charactr_cpp_CCharacter_FUN_0042bd30((CCharacter *)this_ptr);
      }
      if (*(int *)(this_ptr->unk1 + 0x70) == *in_stack_00000008) {
      ...
      if ((this_ptr->base).base.model.part_visibility_flags[*(int *)(this_ptr->unk1 + 0x6c)] == 0) {
  ...
  iVar2 = *in_stack_00000008;
  if (iVar2 == *(int *)(this_ptr->unk1 + 0x6c)) {
    fVar1 = (float)in_stack_00000008[1] * (float)2.5;
  }
  else {
    if ((iVar2 == *(int *)(this_ptr->unk1 + 0x84)) || (iVar2 == *(int *)(this_ptr->unk1 + 0x70))) {
...
LAB_00417851:
  ...
  if ((*(int *)(this_ptr->unk1 + 0x70) == *in_stack_00000008) && (in_stack_00000008[0xc] == 0x68)) {
