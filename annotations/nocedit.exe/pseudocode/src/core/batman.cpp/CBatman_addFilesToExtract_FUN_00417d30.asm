...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_batman_cpp_CBatman_addFilesToExtract_FUN_00417d30(CBatman *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00417d30
        ;   Label: core_batman.cpp_CBatman_addFilesToExtract_FUN_00417d30
    MOV EDX,dword ptr [ESP + 0xc]       ; 00417d31
    PUSH EDX                            ; 00417d35
    MOV ECX,dword ptr [ESP + 0xc]       ; 00417d36
    PUSH ECX                            ; 00417d3a
    CALL core_actor.cpp_CDemonActor_addFilesToExtract_FUN_0040cfd0 ; 00417d3b
    ...
    PUSH EAX                            ; 00417d51
    CALL core_skeledit.cpp_CDeformableModelInstance_addFilesToExtract_FUN_0058a260 ; 00417d52
