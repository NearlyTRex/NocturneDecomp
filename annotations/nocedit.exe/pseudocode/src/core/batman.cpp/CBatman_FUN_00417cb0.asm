...
section .text
    ...
    JZ 0x00417cc0                       ; 00417cbb | LAB_00417cc0
    ...
    PUSH ECX                            ; 00417cc4
    PUSH EAX                            ; 00417cc5
    CALL core_charactr.cpp_CCharacter_FUN_0042bc20 ; 00417cc6 | int core_charactr.cpp_CCharacter_FUN_0042bc20(CCharacter * this_ptr)
