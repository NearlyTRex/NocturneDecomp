// Name: core_batman.cpp_CBatman_archive_FUN_00417580
// Address: 00417580
// Address Range: [[00417580, 0041763a]]
// Convention: __cdecl
// Signature: void __cdecl core_batman_cpp_CBatman_archive_FUN_00417580(CBatman *this_ptr)
...

{
  ...
  if (g_CBatmanClassVersion < 2) {
    ...
    core_actor_cpp_archiveString_FUN_0040b5c0(this_ptr->unk1 + 8,"fallEvent");
    if (g_CBatmanClassVersion < 3) {
      return;
    }
  }
