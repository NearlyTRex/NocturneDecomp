...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_batman_cpp_CBatman_writeDependencies_FUN_00417d30(CBatman *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00417d30
        ;   Label: core_batman.cpp_CBatman_writeDependencies_FUN_00417d30
    ...
    PUSH EAX                            ; 00417d51
    CALL core_skeledit.cpp_CDeformableModelInstance_writeDependencies_FUN_0058a260 ; 00417d52
