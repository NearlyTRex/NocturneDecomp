...
section .text
    ...
    PUSH EBX                            ; 00416510
        ;   Label: core_batman.cpp_CBatman_setup_FUN_00416510
    PUSH ESI                            ; 00416511
    PUSH EDI                            ; 00416512
    MOV ESI,dword ptr [ESP + 0x10]      ; 00416513
    PUSH ESI                            ; 00416517
    CALL core_enemy.cpp_CEnemy_setup_FUN_004a9650 ; 00416518
    ...
    PUSH EBX                            ; 00416551
    MOV [0x008227b8],EAX                ; 00416552 | g_BatmanIndices
    ...
    PUSH EBX                            ; 00416566
    MOV [0x008227c4],EAX                ; 00416567 | g_BatmanIndices[3]
    ...
    PUSH EBX                            ; 0041657b
    MOV [0x008227c8],EAX                ; 0041657c | g_BatmanIndices[4]
    ...
    PUSH EBX                            ; 00416590
    MOV [0x008227cc],EAX                ; 00416591 | g_BatmanIndices[5]
    ...
    PUSH EBX                            ; 004165a5
    MOV [0x008227d0],EAX                ; 004165a6 | g_BatmanIndices[6]
    ...
    PUSH EBX                            ; 004165ba
    MOV [0x008227d4],EAX                ; 004165bb | g_BatmanIndices[7]
    ...
    PUSH EBX                            ; 004165cf
    MOV [0x008227d8],EAX                ; 004165d0 | g_BatmanIndices[8]
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 004165d5
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 004165da
    MOV [0x008227bc],EAX                ; 004165dd | g_BatmanIndices[1]
    PUSH 0x1                            ; 004165e2
    ...
    PUSH EBX                            ; 004165f9
    MOV [0x008227c0],EAX                ; 004165fa | g_BatmanIndices[2]
    ...
    PUSH EBX                            ; 0041660e
    MOV [0x008227dc],EAX                ; 0041660f | g_BatmanIndices[9]
    ...
    PUSH EBX                            ; 00416623
    MOV [0x008227e0],EAX                ; 00416624 | g_BatmanIndices[10]
    ...
    PUSH EBX                            ; 00416638
    MOV [0x008227e4],EAX                ; 00416639 | g_BatmanIndices[11]
    ...
    PUSH EBX                            ; 0041664d
    MOV [0x008227b8],EAX                ; 0041664e | g_BatmanIndices
    ...
    PUSH EBX                            ; 00416662
    MOV [0x008227cc],EAX                ; 00416663 | g_BatmanIndices[5]
    ...
    PUSH EBX                            ; 00416677
    MOV [0x008227d0],EAX                ; 00416678 | g_BatmanIndices[6]
    ...
    PUSH EBX                            ; 0041668c
    MOV [0x008227dc],EAX                ; 0041668d | g_BatmanIndices[9]
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 00416692
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 00416697
    PUSH EDI                            ; 0041669a
    MOV [0x008227e4],EAX                ; 0041669b | g_BatmanIndices[11]
