...

{
  ...
  (this_ptr->base).base.turn_speed = delta_time * fVar13 * fVar4;
  ...
  if (iVar9 == 0) {
      ...
      if ((this_ptr->base).victim == (CCharacter *)0x0) {
        ...
        if ((iVar7 != 0) &&
          ...
          if (iVar7 == g_CDemonSetPtr->enemy_count) {
            ...
            local_28 = 0xd;
            (*pCVar5->playSound)((CDemonActor *)this_ptr,"batman-disappear.wav");
            break;
          }
        }
        pCVar6 = (this_ptr->base).victim;
        local_c8.x = (pCVar6->base).location.position.x -
                     (this_ptr->base).base.base.location.position.x;
        local_c8.y = (pCVar6->base).location.position.y -
                     (this_ptr->base).base.base.location.position.y;
        local_c8.z = (pCVar6->base).location.position.z -
      ...
      if ((this_ptr->base).victim == (CCharacter *)0x0) {
        ...
        iVar7 = core_charactr_cpp_CCharacter_walkToPoint_FUN_004286e0
                          ((CCharacter *)this_ptr,
                           ...
                           fVar13,max_distance);
        if (-1 < iVar7) {
          pCVar12 = &(this_ptr->base).base.base.location;
          pCVar6 = (this_ptr->base).victim;
          local_8c = (pCVar12->position).x - (pCVar6->base).location.position.x;
          ...
          if ((local_38 <= local_2c) && ((this_ptr->base).attack_cooldown <= 0.0)) {
            pCVar6 = (this_ptr->base).victim;
            local_5c.x = (pCVar6->base).location.position.x - (pCVar12->position).x;
            local_5c.y = (pCVar6->base).location.position.y -
                         (this_ptr->base).base.base.location.position.y;
            local_5c.z = (pCVar6->base).location.position.z -
                         (this_ptr->base).base.base.location.position.z;
            ...
            if (ABS(local_14) < (float)0.52359877558333301) {
              ...
              iVar7 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660(uVar11);
              if ((iVar7 == 0) &&
                 (iVar7 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660(this_ptr->sfx_handles[2]),
                 iVar7 == 0)) {
    ...
    case 9:
      ...
      if (((this_ptr->base).victim != (CCharacter *)0x0) ||
         (iVar7 = core_event_cpp_CEventList_evaluateCondition_FUN_004adca0
                            (g_CEventListPtr,this_ptr->fall_event), iVar7 != 0)) {
        core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
    ...
    case 0xd:
      ...
      case 0:
        ...
        break;
      case 1:
        fVar4 = this_ptr->vanish_timer + delta_time;
        this_ptr->vanish_timer = fVar4;
        if (1.0f < fVar4) {
      ...
      case 2:
        local_30 = 1;
        local_1c = 0;
        for (local_18 = 0; fVar4 = 1.0f, local_18 < g_CDemonSetPtr->character_count;
            local_18 = local_18 + 1) {
        ...
        if (local_30 != 0) {
          ...
          pCVar12 = &(this_ptr->base).base.base.location;
          this_ptr->vanish_timer = fVar4;
          (pCVar12->position).x = (this_ptr->new_pos).x;
          ...
          if (pCVar6 != (CCharacter *)0x0) {
            local_a4.x = (pCVar6->base).location.position.x - (pCVar12->position).x;
            local_a4.y = (pCVar6->base).location.position.y -
                         (this_ptr->base).base.base.location.position.y;
            local_a4.z = (pCVar6->base).location.position.z -
                         (this_ptr->base).base.base.location.position.z;
...
switchD_004173a5_caseD_4:
  ...
  if ((iVar7 != 0) && (local_28 != 9)) {
    ...
    (this_ptr->base).base.model.accumulated_root_motion.z = 0.0;
    fVar4 = (this_ptr->base).base.model.accumulated_root_motion.z;
    (this_ptr->base).base.model.accumulated_root_motion.y = fVar4;
    pCVar3->x = fVar4;
