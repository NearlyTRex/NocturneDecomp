  ...
  if (iVar8 == 0) {
    ...
    case 2:
      ...
      if ((this_ptr->base).victim == (CCharacter *)0x0) {
        ...
        if (-1 < iVar6) {
          ...
          pCVar5 = (this_ptr->base).victim;
          local_8c = (pCVar12->position).x - (pCVar5->base).location.position.x;
          ...
          if ((local_38 <= local_2c) && ((this_ptr->base).attack_cooldown <= 0.0)) {
            pCVar5 = (this_ptr->base).victim;
            local_5c.x = (pCVar5->base).location.position.x - (pCVar12->position).x;
            ...
            if (ABS(local_14) < (float)0.52359877558333301) {
              ...
              iVar6 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660(uVar11);
              if ((iVar6 == 0) &&
    ...
    case 3:
      ...
      core_enemy_cpp_CEnemy_testAttackRadius_FUN_004a9880
                (&this_ptr->base,pCVar10,fVar13,damage_info);
      break;
    case 8:
    ...
    case 0xd:
      ...
      case 0:
        ...
        break;
      case 1:
        fVar13 = this_ptr->vanish_timer + delta_time;
        this_ptr->vanish_timer = fVar13;
        if (1.0f < fVar13) {
      ...
      case 2:
        local_30 = 1;
        local_1c = 0;
        for (local_18 = 0; fVar13 = 1.0f, local_18 < g_CDemonSetPtr->character_count;
            local_18 = local_18 + 1) {
        ...
        if (local_30 != 0) {
          ...
          if (pCVar5 != (CCharacter *)0x0) {
            local_a4.x = (pCVar5->base).location.position.x - (pCVar12->position).x;
