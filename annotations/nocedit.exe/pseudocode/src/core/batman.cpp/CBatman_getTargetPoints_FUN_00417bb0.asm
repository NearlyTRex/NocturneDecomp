...
;
; Referenced Globals:
;   int[12] g_BatmanIndices
;   undefined4 g_BatmanIndices[9]
...
section .text
    ...
    PUSH EBX                            ; 00417bb0
        ;   Label: core_batman.cpp_CBatman_getTargetPoints_FUN_00417bb0
    PUSH ESI                            ; 00417bb1
    PUSH EDI                            ; 00417bb2
    PUSH EBP                            ; 00417bb3
    ...
    MOV EDX,dword ptr [0x008227b8]      ; 00417bbf | g_BatmanIndices
    PUSH EDX                            ; 00417bc5
    ...
    JNZ 0x00417c4d                      ; 00417be1
        ;   XREF to: 00417c4d (CONDITIONAL_JUMP)  ; LAB_00417c4d
    ...
    MOV EBP,dword ptr [0x008227dc]      ; 00417bf3 | g_BatmanIndices[9]
    PUSH EBP                            ; 00417bf9
    ...
    JZ 0x00417c32                       ; 00417c20
        ;   XREF to: 00417c32 (CONDITIONAL_JUMP)  ; LAB_00417c32
    ...
    JNZ 0x00417c5f                      ; 00417c41
        ;   XREF to: 00417c5f (CONDITIONAL_JUMP)  ; LAB_00417c5f
    ...
    JMP 0x00417be3                      ; 00417c5d
        ;   XREF to: 00417be3 (UNCONDITIONAL_JUMP)  ; LAB_00417be3
    MOV ECX,dword ptr [0x008227e4]      ; 00417c5f | g_BatmanIndices[11]
        ;   Label: LAB_00417c5f
    PUSH ECX                            ; 00417c65
    ...
    JZ 0x00417c9e                       ; 00417c8c
        ;   XREF to: 00417c9e (CONDITIONAL_JUMP)  ; LAB_00417c9e
