...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_backgnd.cpp_CBackgroundActor_FUN_004129f0(CBackgroundActor * this_ptr)
;
; Parameters:
...
section .text
    ...
    JNZ 0x00412a02                      ; 004129fc | LAB_00412a02
    ...
    LEA EAX,[EBX + 0x158]               ; 00412a02
        ;   Label: LAB_00412a02
    PUSH EAX                            ; 00412a08
    CALL core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80 ; 00412a09 | CKeyFramedModel * core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80(CKeyFramedModelInstance * this_ptr)
        ;   XREF to: 00478d80 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [EAX + 0x5698]    ; 00412a0e
    ADD ESP,0x4                         ; 00412a14
    TEST ECX,ECX                        ; 00412a17
    JZ 0x00412a28                       ; 00412a19 | LAB_00412a28
