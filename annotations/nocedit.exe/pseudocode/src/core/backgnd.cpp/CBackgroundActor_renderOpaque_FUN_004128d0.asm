...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_backgnd_cpp_CBackgroundActor_renderOpaque_FUN_004128d0(CBackgroundActor *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004128d0
        ;   Label: core_backgnd.cpp_CBackgroundActor_renderOpaque_FUN_004128d0
