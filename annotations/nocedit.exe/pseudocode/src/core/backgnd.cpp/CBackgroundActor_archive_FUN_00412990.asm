...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_backgnd_cpp_CBackgroundActor_archive_FUN_00412990(CBackgroundActor *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00412990
        ;   Label: core_backgnd.cpp_CBackgroundActor_archive_FUN_00412990
    MOV EBX,dword ptr [ESP + 0x8]       ; 00412991
    PUSH EBX                            ; 00412995
    CALL core_actor.cpp_CDemonActor_archive_FUN_0040c1c0 ; 00412996
    ...
    PUSH EAX                            ; 004129a9
    CALL core_actor.cpp_archiveKeyframedModelInstance_FUN_0040b8f0 ; 004129aa
    ...
    PUSH EAX                            ; 004129bd
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 004129be
    ...
    PUSH EBX                            ; 004129de
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 004129df
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
