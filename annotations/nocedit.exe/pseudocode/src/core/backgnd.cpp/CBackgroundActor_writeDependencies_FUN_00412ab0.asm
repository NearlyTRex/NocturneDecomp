...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_backgnd_cpp_CBackgroundActor_writeDependencies_FUN_00412ab0 (CBackgroundActor *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x8]       ; 00412ab0
        ;   Label: core_backgnd.cpp_CBackgroundActor_writeDependencies_FUN_00412ab0
