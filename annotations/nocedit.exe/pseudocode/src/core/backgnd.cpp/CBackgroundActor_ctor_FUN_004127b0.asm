...
;                               FUNCTION
; *****************************************************************************
; __cdecl CBackgroundActor * __cdecl core_backgnd_cpp_CBackgroundActor_ctor_FUN_004127b0(CBackgroundActor *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004127b5
    CALL core_actor.cpp_CDemonActor_ctor_FUN_004088b0 ; 004127b6
    ...
    PUSH EAX                            ; 004127c3
    CALL core_dmodel.cpp_CKeyFramedModelInstance_ctor_FUN_00478ce0 ; 004127c4
    ...
    PUSH 0x614e53                       ; 004127d2 | = "candle.kfm"
    LEA EAX,[EBX + 0x158]               ; 004127d7
    PUSH EAX                            ; 004127dd
    MOV dword ptr [EBX + 0x154],0x659f44 ; 004127de | g_CBackgroundActorVTable
    CALL core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0 ; 004127e8
