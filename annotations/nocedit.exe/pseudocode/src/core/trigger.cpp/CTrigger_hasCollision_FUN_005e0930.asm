...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_trigger_cpp_CTrigger_hasCollision_FUN_005e0930(CTrigger *this_ptr,SCollisionInfo *collision_info)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005e0930
        ;   Label: core_trigger.cpp_CTrigger_hasCollision_FUN_005e0930
