      ...
      if (0 < g_HeroCount) {
        do {
          iVar5 = core_trigger_cpp_CTrigger_containsActor_FUN_005e0cd0
                            (this_ptr,(CDemonActor *)g_HeroActors[iVar12]);
          if (iVar5 != 0) {
            pCVar9 = (CDemonActor *)g_HeroActors[iVar12];
            goto LAB_005dfb52;
          }
          iVar12 = iVar12 + 1;
  ...
  case 1:
    ...
    if (this_ptr->cached_actor != (CDemonActor *)0x0) {
      core_actor_cpp_CDemonActor_doCheckForInvalidPointers_FUN_0040ac80
                (this_ptr->cached_actor,"..\\core\\trigger.cpp",238);
...
LAB_005dfb52:
    ...
    if (iVar12 != 0) {
      ...
      local_34 = core_fire_cpp_CFireEffect_getExplosionEffect_FUN_004c8c90
                           (g_CFireEffectPtr,&pCVar2->position,
                            core_chain_cpp_fastSqrt_FUN_00431350
  ...
  case 8:
    ...
    if (iVar12 != 0) {
      for (iVar12 = 0; iVar12 < g_CDemonSetPtr->actor_count; iVar12 = iVar12 + 1) {
        pCVar9 = g_CDemonSetPtr->actors[iVar12];
  ...
  case 9:
    ...
    if (iVar9 != 0) {
      for (iVar12 = 0; iVar12 < g_CDemonSetPtr->actor_count; iVar12 = iVar12 + 1) {
        actor_ptr_00 = (CTrigger *)g_CDemonSetPtr->actors[iVar12];
