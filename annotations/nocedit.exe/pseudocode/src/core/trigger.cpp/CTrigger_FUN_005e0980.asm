...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_trigger.cpp_CTrigger_FUN_005e0980(CTrigger * this_ptr)
;
; Parameters:
...
section .text
    ...
    JZ 0x005e09a4                       ; 005e0990 | LAB_005e09a4
    ...
    PUSH EDX                            ; 005e09ad
    PUSH ESI                            ; 005e09ae
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 005e09af | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
