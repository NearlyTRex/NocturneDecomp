...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_trigger.cpp_CTrigger_FUN_005e1180(CTrigger * this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EAX,[0x0067cf44]                ; 005e11b1 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 005e11b6 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 005e11b7 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 005e11b9
    ADD ESP,0x8                         ; 005e11bb
    TEST EAX,EAX                        ; 005e11be
    JNZ 0x005e1208                      ; 005e11c0 | LAB_005e1208
        ;   XREF to: 005e1208 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 005e11c2
    CALL core_actor.cpp_CDemonActor_processInEditor_FUN_0040d040 ; 005e11c3 | void core_actor.cpp_CDemonActor_processInEditor_FUN_0040d040(CDemonActor * this_ptr)
        ;   XREF to: 0040d040 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005e11c8
    CMP dword ptr [EBX + 0x170],0x1     ; 005e11cb
        ;   Label: LAB_005e11cb
    JNZ 0x005e11fa                      ; 005e11d2 | LAB_005e11fa
        ;   XREF to: 005e11fa (CONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 005e11d4
    FCOMP float ptr [EBX + 0x160]       ; 005e11d7
    FNSTSW AX                           ; 005e11dd
    SAHF                                ; 005e11df
    JZ 0x005e11ee                       ; 005e11e0 | LAB_005e11ee
    ...
    PUSH EBX                            ; 005e11fa
        ;   Label: LAB_005e11fa
    CALL core_trigger.cpp_FUN_005e0ba0  ; 005e11fb | undefined core_trigger.cpp_FUN_005e0ba0()
        ;   XREF to: 005e0ba0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005e1200
    ADD ESP,0x14                        ; 005e1203
    POP EBX                             ; 005e1206
    RET                                 ; 005e1207
    MOV EAX,[0x0067b654]                ; 005e1208 | CGame * g_CGamePtr
        ;   Label: LAB_005e1208
    PUSH 0x4b                           ; 005e120d
    FLD float ptr [EAX + 0x264]         ; 005e120f | g_CGameInstance.delta_time_float
    MOV EAX,[0x0067cf44]                ; 005e1215 | CKeys * g_CKeysPtr
    FMUL double ptr [0x00655a34]        ; 005e121a | double DOUBLE_00655a34
    PUSH EAX                            ; 005e1220 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 005e1221 | void * g_CKeysPtr
    FSTP float ptr [ESP + 0x18]         ; 005e1223
    CALL dword ptr [EDX]                ; 005e1227
    ADD ESP,0x8                         ; 005e1229
    TEST EAX,EAX                        ; 005e122c
    JZ 0x005e1240                       ; 005e122e | LAB_005e1240
    ...
    PUSH 0x4d                           ; 005e1240
        ;   Label: LAB_005e1240
    MOV EAX,[0x0067cf44]                ; 005e1242 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 005e1247 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 005e1248 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 005e124a
    ADD ESP,0x8                         ; 005e124c
    TEST EAX,EAX                        ; 005e124f
    JZ 0x005e1263                       ; 005e1251 | LAB_005e1263
    ...
    PUSH 0x1e                           ; 005e1263
        ;   Label: LAB_005e1263
    MOV EAX,[0x0067cf44]                ; 005e1265 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 005e126a | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 005e126b | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 005e126d
    ADD ESP,0x8                         ; 005e126f
    TEST EAX,EAX                        ; 005e1272
    JZ 0x005e1286                       ; 005e1274 | LAB_005e1286
    ...
    PUSH 0x10                           ; 005e1286
        ;   Label: LAB_005e1286
    MOV EAX,[0x0067cf44]                ; 005e1288 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 005e128d | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 005e128e | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 005e1290
    ADD ESP,0x8                         ; 005e1292
    TEST EAX,EAX                        ; 005e1295
    JZ 0x005e12a9                       ; 005e1297 | LAB_005e12a9
    ...
    PUSH 0x50                           ; 005e12a9
        ;   Label: LAB_005e12a9
    MOV EAX,[0x0067cf44]                ; 005e12ab | CKeys * g_CKeysPtr
    PUSH EAX                            ; 005e12b0 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 005e12b1 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 005e12b3
    ADD ESP,0x8                         ; 005e12b5
    TEST EAX,EAX                        ; 005e12b8
    JZ 0x005e12cc                       ; 005e12ba | LAB_005e12cc
    ...
    PUSH 0x48                           ; 005e12cc
        ;   Label: LAB_005e12cc
    MOV EAX,[0x0067cf44]                ; 005e12ce | CKeys * g_CKeysPtr
    PUSH EAX                            ; 005e12d3 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 005e12d4 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 005e12d6
    ADD ESP,0x8                         ; 005e12d8
    TEST EAX,EAX                        ; 005e12db
    JZ 0x005e12ef                       ; 005e12dd | LAB_005e12ef
    ...
    JGE 0x005e1308                      ; 005e1300 | LAB_005e1308
    ...
    FNSTSW AX                           ; 005e1312
    SAHF                                ; 005e1314
    JNC 0x005e1321                      ; 005e1315 | LAB_005e1321
