...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_trigger.cpp_CTrigger_FUN_005e0a50(CTrigger * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005e0a5a
    PUSH ESI                            ; 005e0a5b
    CALL core_actor.cpp_CDemonActor_getSurfaceProperties_FUN_00409840 ; 005e0a5c | void core_actor.cpp_CDemonActor_getSurfaceProperties_FUN_00409840(CDemonActor * this_ptr, SSurfaceInfo * surface_info)
        ;   XREF to: 00409840 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [ESI + 0x174]     ; 005e0a61
    ADD ESP,0x8                         ; 005e0a67
    CMP EDX,0x5                         ; 005e0a6a
    JNZ 0x005e0a7a                      ; 005e0a6d | LAB_005e0a7a
        ;   XREF to: 005e0a7a (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [ESI + 0x2f4]     ; 005e0a6f
    CMP ECX,dword ptr [EBX + 0x8]       ; 005e0a75
    JZ 0x005e0a91                       ; 005e0a78 | LAB_005e0a91
    ...
    MOV dword ptr [ESI + 0x2f0],0x1     ; 005e0a91
        ;   Label: LAB_005e0a91
    JMP 0x005e0a7a                      ; 005e0a9b | LAB_005e0a7a
