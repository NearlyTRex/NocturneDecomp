...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_trigger.cpp_CTrigger_containsActor_FUN_005e0cd0()
;
; Local Variables:
...
section .text
    ...
    JNZ 0x005e0cf7                      ; 005e0ce9 | LAB_005e0cf7
    ...
    FXCH                                ; 005e0d1a
    FLD float ptr [0x00655848]          ; 005e0d1c | float FLOAT_00655848
    FXCH                                ; 005e0d22
    FMUL ST1                            ; 005e0d24
    FXCH ST2                            ; 005e0d26
    ...
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 005e0d55 | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
        ;   XREF to: 00408ec0 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [EBX + 0x218]     ; 005e0d5a
    ADD ESP,0xc                         ; 005e0d60
    TEST EDX,EDX                        ; 005e0d63
    JNZ 0x005e0e5a                      ; 005e0d65 | LAB_005e0e5a
    ...
    FNSTSW AX                           ; 005e0da0
    SAHF                                ; 005e0da2
    JA 0x005e0ceb                       ; 005e0da3 | LAB_005e0ceb
    ...
    PUSH EAX                            ; 005e0db2
    PUSH EBX                            ; 005e0db3
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 005e0db4 | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
        ;   XREF to: 00408f10 (UNCONDITIONAL_CALL)
    MOV EDX,EAX                         ; 005e0db9
    LEA EAX,[ESP + 0x60]                ; 005e0dbb
    ADD ESP,0xc                         ; 005e0dbf
    CMP EAX,EDX                         ; 005e0dc2
    JZ 0x005e0dda                       ; 005e0dc4 | LAB_005e0dda
    ...
    JBE 0x005e0e87                      ; 005e0de2 | LAB_005e0e87
        ;   XREF to: 005e0e87 (CONDITIONAL_JUMP)
    CMP EAX,0x1                         ; 005e0de8
    JNZ 0x005e0f09                      ; 005e0deb | LAB_005e0f09
    ...
    FNSTSW AX                           ; 005e0e09
    SAHF                                ; 005e0e0b
    JC 0x005e0ceb                       ; 005e0e0c | LAB_005e0ceb
        ;   XREF to: 005e0ceb (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x58]          ; 005e0e12
    FCOMP float ptr [ESP + 0x10]        ; 005e0e16
    FNSTSW AX                           ; 005e0e1a
    SAHF                                ; 005e0e1c
    JA 0x005e0ceb                       ; 005e0e1d | LAB_005e0ceb
        ;   XREF to: 005e0ceb (CONDITIONAL_JUMP)
    ...
    FMUL double ptr [0x0065584c]        ; 005e0e3d | double DOUBLE_0065584c
    FCOMPP                              ; 005e0e43
    FNSTSW AX                           ; 005e0e45
    SAHF                                ; 005e0e47
    JNC 0x005e0efa                      ; 005e0e48 | LAB_005e0efa
    ...
    PUSH ECX                            ; 005e0e60
    PUSH ESI                            ; 005e0e61
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 005e0e62 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005e0e67
    TEST EAX,EAX                        ; 005e0e6a
    JZ 0x005e0e7b                       ; 005e0e6c | LAB_005e0e7b
        ;   XREF to: 005e0e7b (CONDITIONAL_JUMP)
    CMP dword ptr [EAX + 0x2410],0x0    ; 005e0e6e
    JZ 0x005e0ceb                       ; 005e0e75 | LAB_005e0ceb
        ;   XREF to: 005e0ceb (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESI + 0x24]      ; 005e0e7b
        ;   Label: LAB_005e0e7b
    MOV dword ptr [ESP + 0x58],EAX      ; 005e0e7e
    JMP 0x005e0d6b                      ; 005e0e82 | LAB_005e0d6b
    ...
    PUSH EDX                            ; 005e0f10
    MOV EBP,0x6557d8                    ; 005e0f11 | = "..\\core\\trigger.cpp" | s_core_trigger_cpp_006557d8 = ..\core\trigger.cpp
    MOV EAX,0x37d                       ; 005e0f16
    PUSH 0x6557ec                       ; 005e0f1b | = "CTrigger::containsActor - invalid tri..." | s_CTrigger_containsActor_i_006557ec = CTrigger::containsActor - invalid trigger shape %d for %s
    MOV dword ptr [0x02f0ca48],EBP      ; 005e0f20 | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 005e0f26 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005e0f2b | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005e0f30
    MOV EBX,0x383                       ; 005e0f33
    MOV ECX,0x655826                    ; 005e0f38 | = "..\\core\\trigger.cpp" | s_core_trigger_cpp_00655826 = ..\core\trigger.cpp
    PUSH 0x65583a                       ; 005e0f3d | = "Hell froze..." | s_Hell_froze_0065583a = Hell froze...
    MOV dword ptr [0x02f0ca4c],EBX      ; 005e0f42 | int g_CurrentLineNumber
    MOV dword ptr [0x02f0ca48],ECX      ; 005e0f48 | char * g_CurrentFilename
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005e0f4e | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
