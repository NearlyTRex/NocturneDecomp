...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_trigger.cpp_CTrigger_FUN_005e0630(CTrigger * this_ptr)
;
; Parameters:
...
section .text
    ...
    FCHS                                ; 005e063e
    FLD double ptr [0x0065566c]         ; 005e0640 | double DOUBLE_0065566c
    FXCH                                ; 005e0646
    FMUL ST1                            ; 005e0648
    ...
    FADD double ptr [0x00655674]        ; 005e0671 | double DOUBLE_00655674
