...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_trigger_cpp_CTrigger_serialize_FUN_005e0690(CTrigger *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005e0696
    CALL core_actor.cpp_CDemonActor_serialize_FUN_0040c1c0 ; 005e0697
    ...
    PUSH EAX                            ; 005e06aa
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 005e06ab
    ...
    PUSH EAX                            ; 005e06be
    CALL core_actor.cpp_serializeVector_FUN_0040b340 ; 005e06bf
    ...
    PUSH EAX                            ; 005e06d2
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 005e06d3
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ADD ESP,0x8                         ; 005e06d8
    PUSH 0x6556a1                       ; 005e06db | = "onName"
    LEA EAX,[EBX + 0x224]               ; 005e06e0
    PUSH EAX                            ; 005e06e6
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 005e06e7
    ...
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 005e0701
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeString_FUN_0040b5c0(char * * string_buffer, char * property_type)
    ...
    PUSH EAX                            ; 005e073b
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 005e073c
    ...
    PUSH EAX                            ; 005e074f
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 005e0750
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH EAX                            ; 005e0775
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 005e0776
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    PUSH EAX                            ; 005e079b
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 005e079c
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeString_FUN_0040b5c0(char * * string_buffer, char * property_type)
    ...
    PUSH EAX                            ; 005e07b8
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 005e07b9
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH 0x6556b0                       ; 005e07cd | = "whoTriggers"
        ;   Label: LAB_005e07cd
    PUSH EAX                            ; 005e07d2
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 005e07d3
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ADD ESP,0x8                         ; 005e07d8
    PUSH 0x6556bc                       ; 005e07db | = "actorTriggerName"
    PUSH ESI                            ; 005e07e0
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 005e07e1
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeString_FUN_0040b5c0(char * * string_buffer, char * property_type)
    ...
    PUSH EBX                            ; 005e07f9
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 005e07fa
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    PUSH EAX                            ; 005e08af
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 005e08b0
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH EAX                            ; 005e08cc
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 005e08cd
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    PUSH EAX                            ; 005e08e9
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 005e08ea
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    PUSH EBX                            ; 005e090a
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 005e090b
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeString_FUN_0040b5c0(char * * string_buffer, char * property_type)
