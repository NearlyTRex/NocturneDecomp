...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_trigger_cpp_CTrigger_FUN_005e0ba0(CTrigger *this_ptr)
;
; Parameters:
...
;   core_trigger.cpp_CTrigger_processInEditor_FUN_005e1180 at 005e11fb
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 005e0ba0
        ;   Label: core_trigger.cpp_CTrigger_FUN_005e0ba0
