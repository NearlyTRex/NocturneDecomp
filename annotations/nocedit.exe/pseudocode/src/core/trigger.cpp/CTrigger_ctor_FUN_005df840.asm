...
;                               FUNCTION
; *****************************************************************************
; __cdecl CTrigger * core_trigger.cpp_CTrigger_ctor_FUN_005df840(CTrigger * this_ptr)
;
; Parameters:
; CTrigger *       Stack[0x4]:4   this_ptr
;
; XREF[2]:
;   core_trigger.cpp_FUN_005df800 at 005df81a
...
section .text
    ...
    PUSH EDX                            ; 005df846
    CALL core_actor.cpp_CDemonActor_ctor_FUN_004088b0 ; 005df847 | CDemonActor * core_actor.cpp_CDemonActor_ctor_FUN_004088b0(CDemonActor * this_ptr)
        ;   XREF to: 004088b0 (UNCONDITIONAL_CALL)
    MOV dword ptr [EAX + 0x154],0x664a24 ; 005df84c | CDemonActor_vtable g_CTriggerVTable
    ...
    MOV ESI,0x6555f9                    ; 005df888 | = "nobody" | s_nobody_006555f9 = nobody
    ...
    PUSH EDI                            ; 005df8ba
    MOV AL,byte ptr [ESI]               ; 005df8bb | = "nobody" | s_nobody_006555f9 = nobody
        ;   Label: LAB_005df8bb
    MOV byte ptr [EDI],AL               ; 005df8bd
    CMP AL,0x0                          ; 005df8bf
    JZ 0x005df8d3                       ; 005df8c1 | LAB_005df8d3
        ;   XREF to: 005df8d3 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 005df8c3 | s_obody_006555fa
    ADD ESI,0x2                         ; 005df8c6
    MOV byte ptr [EDI + 0x1],AL         ; 005df8c9
    ADD EDI,0x2                         ; 005df8cc
    CMP AL,0x0                          ; 005df8cf
    JNZ 0x005df8bb                      ; 005df8d1 | LAB_005df8bb
        ;   XREF to: 005df8bb (CONDITIONAL_JUMP)
    POP EDI                             ; 005df8d3
        ;   Label: LAB_005df8d3
    MOV ESI,0x655600                    ; 005df8d4 | = "CDemonActor" | s_CDemonActor_00655600 = CDemonActor
    LEA EDI,[EDX + 0x1c8]               ; 005df8d9
    PUSH EDI                            ; 005df8df
    MOV AL,byte ptr [ESI]               ; 005df8e0 | = "CDemonActor" | s_CDemonActor_00655600 = CDemonActor
        ;   Label: LAB_005df8e0
    MOV byte ptr [EDI],AL               ; 005df8e2
    CMP AL,0x0                          ; 005df8e4
    JZ 0x005df8f8                       ; 005df8e6 | LAB_005df8f8
        ;   XREF to: 005df8f8 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 005df8e8 | s_DemonActor_00655601
    ADD ESI,0x2                         ; 005df8eb
    MOV byte ptr [EDI + 0x1],AL         ; 005df8ee
    ADD EDI,0x2                         ; 005df8f1
    CMP AL,0x0                          ; 005df8f4
    JNZ 0x005df8e0                      ; 005df8f6 | LAB_005df8e0
