...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_trigger.cpp_CTrigger_FUN_005e0c30(CTrigger * this_ptr)
;
; Parameters:
...
section .text
    ...
    JZ 0x005e0c4c                       ; 005e0c43 | LAB_005e0c4c
    ...
    FXCH                                ; 005e0c6d
    FLD float ptr [0x006557d4]          ; 005e0c6f | float FLOAT_006557d4
    FXCH                                ; 005e0c75
    FMUL ST1                            ; 005e0c77
    FXCH ST2                            ; 005e0c79
    ...
    JZ 0x005e0cbd                       ; 005e0ca7 | LAB_005e0cbd
