...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_trigger.cpp_CTrigger_process_FUN_005dfac0(CTrigger * this_ptr)
;
; Parameters:
...
section .text
    ...
    JA 0x005dfb58                       ; 005dfaea | default
        ;   XREF to: 005dfb58 (CONDITIONAL_JUMP)
    JMP dword ptr [EAX*0x4 + 0x5dfa84]  ; 005dfaec | void * switchdataD_005dfa84
        ;   Label: switchD
    LEA EAX,[ESI + 0x20]                ; 005dfaf3
        ;   Label: caseD_0
    PUSH dword ptr [ESI + 0x158]        ; 005dfaf6
    PUSH EAX                            ; 005dfafc
    CALL core_hero.cpp_FUN_004f2220     ; 005dfafd | undefined core_hero.cpp_FUN_004f2220()
        ;   XREF to: 004f2220 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005dfb02
    TEST EAX,EAX                        ; 005dfb05
    JZ 0x005dfb58                       ; 005dfb07 | default
        ;   XREF to: 005dfb58 (CONDITIONAL_JUMP)
    ...
    MOV EAX,[0x02db87bc]                ; 005dfb1a | int g_HeroCount
    ADD ESP,0x8                         ; 005dfb1f
    TEST EAX,EAX                        ; 005dfb22
    JLE 0x005dfb58                      ; 005dfb24 | default
        ;   XREF to: 005dfb58 (CONDITIONAL_JUMP)
    XOR EBX,EBX                         ; 005dfb26
    MOV EDX,dword ptr [EBX + 0x2db87c0] ; 005dfb28 | CHero *[4] g_HeroActors
        ;   Label: LAB_005dfb28
    PUSH EDX                            ; 005dfb2e
    PUSH ESI                            ; 005dfb2f
    CALL core_trigger.cpp_CTrigger_containsActor_FUN_005e0cd0 ; 005dfb30 | undefined core_trigger.cpp_CTrigger_containsActor_FUN_005e0cd0()
        ;   XREF to: 005e0cd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005dfb35
    TEST EAX,EAX                        ; 005dfb38
    JZ 0x005dfbbb                       ; 005dfb3a | LAB_005dfbbb
        ;   XREF to: 005dfbbb (CONDITIONAL_JUMP)
    MOV ECX,0x1                         ; 005dfb40
    MOV EAX,dword ptr [EBX + 0x2db87c0] ; 005dfb45 | CHero *[4] g_HeroActors
    ...
    JA 0x005dfb83                       ; 005dfb61 | default
        ;   XREF to: 005dfb83 (CONDITIONAL_JUMP)
    JMP dword ptr [EAX*0x4 + 0x5dfaac]  ; 005dfb63 | void * switchdataD_005dfaac
        ;   Label: switchD
    MOV ECX,dword ptr [ESP + 0x8c]      ; 005dfb6a
        ;   Label: caseD_1
    TEST ECX,ECX                        ; 005dfb71
    JZ 0x005e0024                       ; 005dfb73 | LAB_005e0024
    ...
    JZ 0x005e0082                       ; 005dfb98 | LAB_005e0082
        ;   XREF to: 005e0082 (CONDITIONAL_JUMP)
    ADD ESI,0x224                       ; 005dfb9e
    PUSH ESI                            ; 005dfba4
    MOV EDX,dword ptr [0x006793d0]      ; 005dfba5 | CEventList g_CEventListInstance | CEventList * g_CEventListPtr
    PUSH EDX                            ; 005dfbab | CEventList g_CEventListInstance
    CALL core_event.cpp_CEventList_FUN_004aabe0 ; 005dfbac | void core_event.cpp_CEventList_FUN_004aabe0(CEventList * this_ptr)
    ...
    POP EBX                             ; 005dfbb9
    RET                                 ; 005dfbba
    MOV EAX,[0x02db87bc]                ; 005dfbbb | int g_HeroCount
        ;   Label: LAB_005dfbbb
    INC EDI                             ; 005dfbc0
    ADD EBX,0x4                         ; 005dfbc1
    CMP EDI,EAX                         ; 005dfbc4
    JL 0x005dfb28                       ; 005dfbc6 | LAB_005dfb28
        ;   XREF to: 005dfb28 (CONDITIONAL_JUMP)
    JMP 0x005dfb58                      ; 005dfbcc | default
        ;   XREF to: 005dfb58 (UNCONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0x368],0x0     ; 005dfbce
        ;   Label: caseD_1
    JNZ 0x005dfbf3                      ; 005dfbd5 | LAB_005dfbf3
        ;   XREF to: 005dfbf3 (CONDITIONAL_JUMP)
    LEA EAX,[ESI + 0x178]               ; 005dfbd7
    PUSH EAX                            ; 005dfbdd
    MOV EDI,dword ptr [0x0067d550]      ; 005dfbde | CDemonMission * g_CDemonMissionPtr
    PUSH EDI                            ; 005dfbe4 | CDemonMission g_CDemonMissionInstance
    CALL core_mission.cpp_CDemonMission_FUN_00524030 ; 005dfbe5 | char * core_mission.cpp_CDemonMission_FUN_00524030(CDemonMission * this_ptr)
    ...
    JZ 0x005dfb58                       ; 005dfbfb | default
        ;   XREF to: 005dfb58 (CONDITIONAL_JUMP)
    PUSH 0xee                           ; 005dfc01
    PUSH 0x655616                       ; 005dfc06 | = "..\\core\\trigger.cpp" | s_core_trigger_cpp_00655616 = ..\core\trigger.cpp
    PUSH EAX                            ; 005dfc0b
    CALL core_actor.cpp_CDemonActor_doCheckForInvalidPointers_FUN_0040ac80 ; 005dfc0c | void core_actor.cpp_CDemonActor_doCheckForInvalidPointers_FUN_0040ac80(CDemonActor * this_ptr, char * context_file, int context_line)
        ;   XREF to: 0040ac80 (UNCONDITIONAL_CALL)
    MOV EBX,dword ptr [ESI + 0x368]     ; 005dfc11
    MOV ECX,dword ptr [EBX + 0x70]      ; 005dfc17
    ADD ESP,0xc                         ; 005dfc1a
    CMP ECX,0x1                         ; 005dfc1d
    JNZ 0x005dfb58                      ; 005dfc20 | default
        ;   XREF to: 005dfb58 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 005dfc5a
    SAHF                                ; 005dfc5c
    JA 0x005dfb58                       ; 005dfc5d | default
        ;   XREF to: 005dfb58 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 005dfc63
    PUSH ESI                            ; 005dfc64
    CALL core_trigger.cpp_CTrigger_containsActor_FUN_005e0cd0 ; 005dfc65 | undefined core_trigger.cpp_CTrigger_containsActor_FUN_005e0cd0()
        ;   XREF to: 005e0cd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005dfc6a
    TEST EAX,EAX                        ; 005dfc6d
    JZ 0x005dfb58                       ; 005dfc6f | default
        ;   XREF to: 005dfb58 (CONDITIONAL_JUMP)
    MOV EBX,0x1                         ; 005dfc75
    MOV EAX,dword ptr [ESI + 0x368]     ; 005dfc7a
    MOV dword ptr [ESP + 0x8c],EBX      ; 005dfc80
    JMP 0x005dfb52                      ; 005dfc87 | LAB_005dfb52
        ;   XREF to: 005dfb52 (UNCONDITIONAL_JUMP)
    LEA EAX,[ESI + 0x20]                ; 005dfc8c
        ;   Label: caseD_2
    PUSH dword ptr [ESI + 0x158]        ; 005dfc8f
    PUSH EAX                            ; 005dfc95
    CALL core_hero.cpp_FUN_004f2220     ; 005dfc96 | undefined core_hero.cpp_FUN_004f2220()
        ;   XREF to: 004f2220 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005dfc9b
    TEST EAX,EAX                        ; 005dfc9e
    JZ 0x005dfb58                       ; 005dfca0 | default
        ;   XREF to: 005dfb58 (CONDITIONAL_JUMP)
    ...
    FXCH                                ; 005dfcc9
    FLD float ptr [0x0065562c]          ; 005dfccb | float FLOAT_0065562c
    FXCH                                ; 005dfcd1
    FMUL ST1                            ; 005dfcd3
    FXCH ST2                            ; 005dfcd5
    ...
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 005dfd04 | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
        ;   XREF to: 00408ec0 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 005dfd09
    LEA EAX,[ESP + 0x74]                ; 005dfd0b
    ADD ESP,0xc                         ; 005dfd0f
    CMP EAX,EBX                         ; 005dfd12
    JZ 0x005dfd2a                       ; 005dfd14 | LAB_005dfd2a
    ...
    PUSH EAX                            ; 005dfd5a
    MOV EDX,dword ptr [0x006810c8]      ; 005dfd5b | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
    PUSH EDX                            ; 005dfd61 | CDemonSet g_CDemonSetInstance
    CALL core_set.cpp_CDemonSet_calculateSpatialLighting_FUN_0056db80 ; 005dfd62 | int core_set.cpp_CDemonSet_calculateSpatialLighting_FUN_0056db80(CDemonSet * this_ptr, CVector3i * world_position, CVector3i * surface_normal)
        ;   XREF to: 0056db80 (UNCONDITIONAL_CALL)
    FLD float ptr [ESI + 0x21c]         ; 005dfd67
    ADD ESP,0xc                         ; 005dfd6d
    FMUL double ptr [0x00655634]        ; 005dfd70 | double DOUBLE_00655634
    ...
    FNSTSW AX                           ; 005dfdea
    SAHF                                ; 005dfdec
    JBE 0x005dfdf5                      ; 005dfded | LAB_005dfdf5
    ...
    MOV EDI,dword ptr [0x02d7a7b8]      ; 005dfe69 | undefined4 DAT_02d7a7b8
    SAR EAX,0x1                         ; 005dfe6f
    PUSH 0x0                            ; 005dfe71
    ADD EAX,EDI                         ; 005dfe73
    PUSH EAX                            ; 005dfe75
    PUSH EBX                            ; 005dfe76
    MOV EAX,[0x0067a3d0]                ; 005dfe77 | CFireEffect g_CFireEffectInstance | CFireEffect * g_CFireEffectPtr
    PUSH EAX                            ; 005dfe7c | CFireEffect g_CFireEffectInstance
    CALL core_fire.cpp_CFireEffect_FUN_004c8c90 ; 005dfe7d | int core_fire.cpp_CFireEffect_FUN_004c8c90(CFireEffect * this_ptr)
        ;   XREF to: 004c8c90 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 005dfe82
    MOV dword ptr [ESP + 0x8c],EAX      ; 005dfe85
    JMP 0x005dfb58                      ; 005dfe8c | default
        ;   XREF to: 005dfb58 (UNCONDITIONAL_JUMP)
    LEA EAX,[ESI + 0x20]                ; 005dfe91
        ;   Label: caseD_8
    PUSH dword ptr [ESI + 0x158]        ; 005dfe94
    PUSH EAX                            ; 005dfe9a
    CALL core_hero.cpp_FUN_004f2220     ; 005dfe9b | undefined core_hero.cpp_FUN_004f2220()
        ;   XREF to: 004f2220 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005dfea0
    TEST EAX,EAX                        ; 005dfea3
    JZ 0x005dfb58                       ; 005dfea5 | default
        ;   XREF to: 005dfb58 (CONDITIONAL_JUMP)
    XOR EDI,EDI                         ; 005dfeab
    MOV dword ptr [ESP + 0x98],EDI      ; 005dfead
    MOV EAX,[0x006810c8]                ; 005dfeb4 | CDemonSet * g_CDemonSetPtr
        ;   Label: LAB_005dfeb4
    CMP EDI,dword ptr [EAX + 0x14d154]  ; 005dfeb9 | g_CDemonSetInstance.actor_list_ptr
    JGE 0x005dfb58                      ; 005dfebf | default
        ;   XREF to: 005dfb58 (CONDITIONAL_JUMP)
    ADD EAX,dword ptr [ESP + 0x98]      ; 005dfec5
    MOV EBX,dword ptr [EAX + 0x14d158]  ; 005dfecc | g_CDemonSetInstance.actor_list_data[0]
    PUSH EBX                            ; 005dfed2
    MOV EAX,dword ptr [EBX + 0x154]     ; 005dfed3
    CALL dword ptr [EAX + 0x54]         ; 005dfed9
    ADD ESP,0x4                         ; 005dfedc
    TEST EAX,EAX                        ; 005dfedf
    JNZ 0x005dfef7                      ; 005dfee1 | LAB_005dfef7
    ...
    JMP 0x005dfeb4                      ; 005dfef5 | LAB_005dfeb4
        ;   XREF to: 005dfeb4 (UNCONDITIONAL_JUMP)
    PUSH EBX                            ; 005dfef7
        ;   Label: LAB_005dfef7
    PUSH ESI                            ; 005dfef8
    CALL core_trigger.cpp_CTrigger_containsActor_FUN_005e0cd0 ; 005dfef9 | undefined core_trigger.cpp_CTrigger_containsActor_FUN_005e0cd0()
        ;   XREF to: 005e0cd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005dfefe
    TEST EAX,EAX                        ; 005dff01
    JZ 0x005dfee3                       ; 005dff03 | LAB_005dfee3
    ...
    JMP 0x005dfb58                      ; 005dff17 | default
        ;   XREF to: 005dfb58 (UNCONDITIONAL_JUMP)
    LEA EBX,[ESI + 0x20]                ; 005dff1c
        ;   Label: caseD_9
    PUSH dword ptr [ESI + 0x158]        ; 005dff1f
    PUSH EBX                            ; 005dff25
    CALL core_hero.cpp_FUN_004f2220     ; 005dff26 | undefined core_hero.cpp_FUN_004f2220()
        ;   XREF to: 004f2220 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005dff2b
    TEST EAX,EAX                        ; 005dff2e
    JZ 0x005dfb58                       ; 005dff30 | default
        ;   XREF to: 005dfb58 (CONDITIONAL_JUMP)
    ...
    MOV EAX,[0x006810c8]                ; 005dff60 | CDemonSet * g_CDemonSetPtr
        ;   Label: LAB_005dff60
    CMP EDI,dword ptr [EAX + 0x14d154]  ; 005dff65 | g_CDemonSetInstance.actor_list_ptr
    JGE 0x005dfb58                      ; 005dff6b | default
        ;   XREF to: 005dfb58 (CONDITIONAL_JUMP)
    ADD EAX,dword ptr [ESP + 0x9c]      ; 005dff71
    MOV EBX,dword ptr [EAX + 0x14d158]  ; 005dff78 | g_CDemonSetInstance.actor_list_data[0]
    ...
    FNSTSW AX                           ; 005dffb6
    SAHF                                ; 005dffb8
    JBE 0x005dffcf                      ; 005dffb9 | LAB_005dffcf
    ...
    JMP 0x005dff60                      ; 005dffcd | LAB_005dff60
        ;   XREF to: 005dff60 (UNCONDITIONAL_JUMP)
    CMP EBX,ESI                         ; 005dffcf
        ;   Label: LAB_005dffcf
    JZ 0x005dffbb                       ; 005dffd1 | LAB_005dffbb
        ;   XREF to: 005dffbb (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x94]      ; 005dffd3
    PUSH EAX                            ; 005dffda
    PUSH EBX                            ; 005dffdb
    CALL core_actor.cpp_isOfClass_FUN_0040c6d0 ; 005dffdc | int core_actor.cpp_isOfClass_FUN_0040c6d0(CDemonActor * actor_ptr, char * class_name)
        ;   XREF to: 0040c6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005dffe1
    TEST EAX,EAX                        ; 005dffe4
    JZ 0x005dffbb                       ; 005dffe6 | LAB_005dffbb
        ;   XREF to: 005dffbb (CONDITIONAL_JUMP)
    PUSH 0x0                            ; 005dffe8
    PUSH EBX                            ; 005dffea
    MOV EDX,dword ptr [ESP + 0x98]      ; 005dffeb
    PUSH EDX                            ; 005dfff2
    CALL shape_edittool.cpp_wildcardStringMatch_FUN_004a6e20 ; 005dfff3 | int shape_edittool.cpp_wildcardStringMatch_FUN_004a6e20(char * pattern, char * target_string, int case_sensitive)
        ;   XREF to: 004a6e20 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005dfff8
    TEST EAX,EAX                        ; 005dfffb
    JZ 0x005dffbb                       ; 005dfffd | LAB_005dffbb
        ;   XREF to: 005dffbb (CONDITIONAL_JUMP)
    PUSH EBX                            ; 005dffff
    PUSH ESI                            ; 005e0000
    CALL core_trigger.cpp_CTrigger_containsActor_FUN_005e0cd0 ; 005e0001 | undefined core_trigger.cpp_CTrigger_containsActor_FUN_005e0cd0()
        ;   XREF to: 005e0cd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005e0006
    TEST EAX,EAX                        ; 005e0009
    JZ 0x005dffbb                       ; 005e000b | LAB_005dffbb
        ;   XREF to: 005dffbb (CONDITIONAL_JUMP)
    MOV ECX,0x1                         ; 005e000d
    MOV dword ptr [ESI + 0x2fc],EBX     ; 005e0012
    MOV dword ptr [ESP + 0x8c],ECX      ; 005e0018
    JMP 0x005dfb58                      ; 005e001f | default
        ;   XREF to: 005dfb58 (UNCONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0x15c],0x0     ; 005e0024
        ;   Label: LAB_005e0024
    JNZ 0x005dfb83                      ; 005e002b | default
        ;   XREF to: 005dfb83 (CONDITIONAL_JUMP)
    MOV dword ptr [ESI + 0x16c],ECX     ; 005e0031
    JMP 0x005dfb83                      ; 005e0037 | default
        ;   XREF to: 005dfb83 (UNCONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0x2ec],0x0     ; 005e003c
        ;   Label: caseD_2
    JNZ 0x005e0053                      ; 005e0043 | LAB_005e0053
        ;   XREF to: 005e0053 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x8c],0x0      ; 005e0045
    JNZ 0x005dfb79                      ; 005e004d | LAB_005dfb79
        ;   XREF to: 005dfb79 (CONDITIONAL_JUMP)
    MOV dword ptr [ESI + 0x16c],0x0     ; 005e0053
        ;   Label: LAB_005e0053
    JMP 0x005dfb83                      ; 005e005d | default
        ;   XREF to: 005dfb83 (UNCONDITIONAL_JUMP)
    MOV EBX,dword ptr [ESI + 0x2ec]     ; 005e0062
        ;   Label: caseD_3
    CMP EBX,0x1                         ; 005e0068
    JNZ 0x005e0053                      ; 005e006b | LAB_005e0053
        ;   XREF to: 005e0053 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x8c],0x0      ; 005e006d
    JNZ 0x005e0053                      ; 005e0075 | LAB_005e0053
        ;   XREF to: 005e0053 (CONDITIONAL_JUMP)
    MOV dword ptr [ESI + 0x16c],EBX     ; 005e0077
    JMP 0x005dfb83                      ; 005e007d | default
        ;   XREF to: 005dfb83 (UNCONDITIONAL_JUMP)
    LEA EAX,[ESI + 0x288]               ; 005e0082
        ;   Label: LAB_005e0082
    PUSH EAX                            ; 005e0088
    MOV EAX,[0x006793d0]                ; 005e0089 | CEventList g_CEventListInstance | CEventList * g_CEventListPtr
    PUSH EAX                            ; 005e008e | CEventList g_CEventListInstance
    CALL core_event.cpp_CEventList_FUN_004aabe0 ; 005e008f | void core_event.cpp_CEventList_FUN_004aabe0(CEventList * this_ptr)
        ;   XREF to: 004aabe0 (UNCONDITIONAL_CALL)
