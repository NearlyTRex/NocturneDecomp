...
// Convention: __cdecl
// Signature: float __cdecl core_trigger_cpp_CTrigger_evaluateTriggerCondition_FUN_005e0980(CTrigger *this_ptr,CDemonActor *querying_actor,CVector3f *query_position)
