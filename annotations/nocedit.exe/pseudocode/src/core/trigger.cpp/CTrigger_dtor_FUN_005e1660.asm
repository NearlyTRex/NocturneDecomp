...
;                               FUNCTION
; *****************************************************************************
; __cdecl CTrigger * __cdecl core_trigger_cpp_CTrigger_dtor_FUN_005e1660(CTrigger *this_ptr,uint d1,uint d2)
;
; Parameters:
...
section .text
    ...
    PUSH 0x664b10                       ; 005e1686 | g_CTriggerTypeInfo
        ;   Label: LAB_005e1686
    PUSH EBX                            ; 005e168b
    CALL crt_memory.c___vec_delete_FUN_005fe632 ; 005e168c
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c___vec_delete_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 005e1691
    PUSH EAX                            ; 005e1694
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 005e1695
