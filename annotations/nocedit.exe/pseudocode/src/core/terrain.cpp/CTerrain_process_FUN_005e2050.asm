...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_terrain_cpp_CTerrain_process_FUN_005e2050(CTerrain *this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EAX,[0x02cf6a80]                ; 005e2059 | g_GlobalDeltaTimeInt
    IMUL EDX                            ; 005e205e
    ...
    JG 0x005e2073                       ; 005e2070
        ;   XREF to: 005e2073 (CONDITIONAL_JUMP)  ; LAB_005e2073
    RET                                 ; 005e2072
    PUSH ESI                            ; 005e2073
        ;   Label: LAB_005e2073
