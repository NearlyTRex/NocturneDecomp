...
section .text
    ...
    MOV EDX,dword ptr [0x0067cbc8]      ; 005e1ef1 | CGround g_CGroundInstance | CGround * g_CGroundPtr
    MOV EAX,dword ptr [ESP + 0x8]       ; 005e1ef7
    PUSH EDX                            ; 005e1efb | CGround g_CGroundInstance
    MOV dword ptr [EAX],0x0             ; 005e1efc
    CALL core_ground.cpp_CGround_init_FUN_004eef00 ; 005e1f02 | void core_ground.cpp_CGround_init_FUN_004eef00(CGround * this_ptr)
        ;   XREF to: 004eef00 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005e1f07
    PUSH 0x656590                       ; 005e1f0a | = "junk.jnk" | s_junk_jnk_00656590 = junk.jnk
    MOV ECX,dword ptr [0x0067cbc8]      ; 005e1f0f | CGround g_CGroundInstance | CGround * g_CGroundPtr
    PUSH ECX                            ; 005e1f15 | CGround g_CGroundInstance
    MOV EBX,0x1                         ; 005e1f16
    CALL core_ground.cpp_CGround_load_FUN_004ef030 ; 005e1f1b | int core_ground.cpp_CGround_load_FUN_004ef030(CGround * this_ptr, char * filename)
