...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_terrain_cpp_CTerrain_render_FUN_005e1f50(CTerrain *this_ptr)
;
; Parameters:
...
section .text
    ...
    JNZ 0x005e1f6c                      ; 005e1f63
        ;   XREF to: 005e1f6c (CONDITIONAL_JUMP)  ; LAB_005e1f6c
    ...
    PUSH ESI                            ; 005e1f86
    MOV EDI,dword ptr [0x0067cbc8]      ; 005e1f87 | g_CGroundPtr
    PUSH EDI                            ; 005e1f8d | g_CGroundInstance
    MOV dword ptr [ESP + 0x18],EBX      ; 005e1f8e
    MOV dword ptr [ESP + 0x20],ESI      ; 005e1f92
    CALL core_ground.cpp_CGround_getHeightAtPosition_FUN_004efd30 ; 005e1f96
        ;   XREF to: 004efd30 (UNCONDITIONAL_CALL)  ; int core_ground.cpp_CGround_getHeightAtPosition_FUN_004efd30(CGround * this_ptr, int world_x, int world_z)
    ADD ESP,0xc                         ; 005e1f9b
    FLD double ptr [0x006565a0]         ; 005e1f9e | DOUBLE_006565a0
    ...
    FXCH                                ; 005e1fc3
    CALL crt_math.c_round_FUN_005fe6b0  ; 005e1fc5
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    FXCH                                ; 005e1fca
    CALL crt_math.c_round_FUN_005fe6b0  ; 005e1fcc
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    FXCH                                ; 005e1fd1
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 005e1fe5
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    PUSH EAX                            ; 005e200d
    MOV EDI,dword ptr [0x006703ec]      ; 005e200e | g_CDemonRendererPtr2
    PUSH EDI                            ; 005e2014 | g_CDemonRendererInstance
    MOV dword ptr [ESP + 0x1c],ESI      ; 005e2015
    CALL engine_drender.cpp_CDemonRenderer_setCameraOrigin_FUN_0048c130 ; 005e2019
        ;   XREF to: 0048c130 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_setCameraOrigin_FUN_0048c130(CDemonRenderer * this_ptr, CVector3i * origin)
    ADD ESP,0x8                         ; 005e201e
    MOV EAX,[0x0067cbc8]                ; 005e2021 | g_CGroundInstance | g_CGroundPtr
    PUSH EAX                            ; 005e2026 | g_CGroundInstance
    CALL core_ground.cpp_CGround_render_FUN_004efc90 ; 005e2027
        ;   XREF to: 004efc90 (UNCONDITIONAL_CALL)  ; void core_ground.cpp_CGround_render_FUN_004efc90(CGround * this_ptr)
    ADD ESP,0x4                         ; 005e202c
    MOV EAX,ESP                         ; 005e202f
    PUSH EAX                            ; 005e2031
    MOV EDX,dword ptr [0x006703ec]      ; 005e2032 | g_CDemonRendererInstance | g_CDemonRendererPtr2
    PUSH EDX                            ; 005e2038 | g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_setCameraOriginFromScaledPoint_FUN_0048c150 ; 005e2039
