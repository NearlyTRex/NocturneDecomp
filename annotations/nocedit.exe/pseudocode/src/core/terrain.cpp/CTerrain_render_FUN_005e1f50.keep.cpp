...

{
  ...
  local_24.x = local_24.x + (int)ROUND(ROUND((double)local_30.x * 256));
  local_24.y = (int)ROUND(ROUND((double)local_30.y * 256)) + iVar1;
  local_24.z = (local_24.z + (int)ROUND(ROUND((double)local_30.z * 256))) -
