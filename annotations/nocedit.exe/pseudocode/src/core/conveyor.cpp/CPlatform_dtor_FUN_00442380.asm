...
;                               FUNCTION
; *****************************************************************************
; __cdecl CPlatform * __cdecl core_conveyor_cpp_CPlatform_dtor_FUN_00442380(CPlatform *this_ptr,uint flags)
;
; Parameters:
...
section .text
    ...
    PUSH 0x65c040                       ; 004423bd | g_CPlatformTypeInfo
        ;   Label: LAB_004423bd
    PUSH EBX                            ; 004423c2
    CALL crt_memory.c___vec_delete_FUN_005fe632 ; 004423c3
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c___vec_delete_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 004423c8
    PUSH EAX                            ; 004423cb
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 004423cc
