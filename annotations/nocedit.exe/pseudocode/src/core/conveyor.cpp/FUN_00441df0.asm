...
section .text
    ...
    PUSH EAX                            ; 00441e01
    MOV EDX,dword ptr [0x006793d0]      ; 00441e02 | CEventList g_CEventListInstance | CEventList * g_CEventListPtr
    PUSH EDX                            ; 00441e08 | CEventList g_CEventListInstance
    CALL core_event.cpp_CEventList_evaluateCondition_FUN_004adca0 ; 00441e09 | int core_event.cpp_CEventList_evaluateCondition_FUN_004adca0(CEventList * this_ptr, char * condition_expression)
        ;   XREF to: 004adca0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00441e0e
    TEST EAX,EAX                        ; 00441e11
    JZ 0x00441e1f                       ; 00441e13 | LAB_00441e1f
        ;   XREF to: 00441e1f (CONDITIONAL_JUMP)
    MOV dword ptr [ESI + 0x80c],0x1     ; 00441e15
    LEA EAX,[ESI + 0x7a8]               ; 00441e1f
        ;   Label: LAB_00441e1f
    PUSH EAX                            ; 00441e25
    MOV ECX,dword ptr [0x006793d0]      ; 00441e26 | CEventList g_CEventListInstance | CEventList * g_CEventListPtr
    PUSH ECX                            ; 00441e2c | CEventList g_CEventListInstance
    CALL core_event.cpp_CEventList_evaluateCondition_FUN_004adca0 ; 00441e2d | int core_event.cpp_CEventList_evaluateCondition_FUN_004adca0(CEventList * this_ptr, char * condition_expression)
        ;   XREF to: 004adca0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00441e32
    TEST EAX,EAX                        ; 00441e35
    JNZ 0x00441e7e                      ; 00441e37 | LAB_00441e7e
        ;   XREF to: 00441e7e (CONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0x80c],0x0     ; 00441e39
    JZ 0x00441e88                       ; 00441e40 | LAB_00441e88
    ...
    MOV EAX,[0x006810c8]                ; 00441e5a | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
        ;   Label: LAB_00441e5a
    CMP EDI,dword ptr [EAX + 0x14d154]  ; 00441e5f | g_CDemonSetInstance.actor_list_ptr
    JGE 0x00441e88                      ; 00441e65 | LAB_00441e88
        ;   XREF to: 00441e88 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [EAX + EBP*0x1 + 0x14d158] ; 00441e67 | g_CDemonSetInstance.actor_list_data[0]
    MOV ECX,dword ptr [EBX + 0xdc]      ; 00441e6e
    CMP ESI,ECX                         ; 00441e74
    JZ 0x00441e90                       ; 00441e76 | LAB_00441e90
        ;   XREF to: 00441e90 (CONDITIONAL_JUMP)
    INC EDI                             ; 00441e78
    ADD EBP,0x4                         ; 00441e79
    JMP 0x00441e5a                      ; 00441e7c | LAB_00441e5a
    ...
    CMP byte ptr [ECX + 0x810],0x0      ; 00441e90
        ;   Label: LAB_00441e90
    JNZ 0x00441f1c                      ; 00441e97 | LAB_00441f1c
    ...
    PUSH EAX                            ; 00441ea6
    PUSH ESI                            ; 00441ea7
    CALL core_actor.cpp_CDemonActor_transformVector_FUN_00408e80 ; 00441ea8 | CVector3f * core_actor.cpp_CDemonActor_transformVector_FUN_00408e80(CDemonActor * this_ptr, CVector3f * output, CVector3f * input)
    ...
    JZ 0x00441ef5                       ; 00441edf | LAB_00441ef5
    ...
    JMP 0x00441e5a                      ; 00441f17 | LAB_00441e5a
        ;   XREF to: 00441e5a (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x1c]      ; 00441f1c
        ;   Label: LAB_00441f1c
    PUSH EAX                            ; 00441f20
    PUSH EBX                            ; 00441f21
    CALL core_actor.cpp_isOfClass_FUN_0040c6d0 ; 00441f22 | int core_actor.cpp_isOfClass_FUN_0040c6d0(CDemonActor * actor_ptr, char * class_name)
        ;   XREF to: 0040c6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00441f27
    TEST EAX,EAX                        ; 00441f2a
    JNZ 0x00441e9d                      ; 00441f2c | LAB_00441e9d
        ;   XREF to: 00441e9d (CONDITIONAL_JUMP)
    INC EDI                             ; 00441f32
    ADD EBP,0x4                         ; 00441f33
    JMP 0x00441e5a                      ; 00441f36 | LAB_00441e5a
        ;   XREF to: 00441e5a (UNCONDITIONAL_JUMP)
