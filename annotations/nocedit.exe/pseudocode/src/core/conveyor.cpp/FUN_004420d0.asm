...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_conveyor.cpp_FUN_004420d0()
;
;
; Referenced Globals:
...
section .text
    ...
    FCHS                                ; 004420de
    FLD double ptr [0x00618e7b]         ; 004420e0 | double DOUBLE_00618e7b
    FXCH                                ; 004420e6
    FMUL ST1                            ; 004420e8
    ...
    FADD double ptr [0x00618e83]        ; 00442111 | double DOUBLE_00618e83
