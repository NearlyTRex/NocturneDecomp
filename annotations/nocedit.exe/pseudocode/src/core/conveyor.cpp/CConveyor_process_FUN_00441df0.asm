...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_conveyor_cpp_CConveyor_process_FUN_00441df0(CConveyor *this_ptr,float delta_time)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00441df0
        ;   Label: core_conveyor.cpp_CConveyor_process_FUN_00441df0
    PUSH ESI                            ; 00441df1
    PUSH EDI                            ; 00441df2
    PUSH EBP                            ; 00441df3
