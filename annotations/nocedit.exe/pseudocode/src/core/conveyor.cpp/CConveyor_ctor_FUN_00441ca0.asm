...
;                               FUNCTION
; *****************************************************************************
; __cdecl CConveyor * __cdecl core_conveyor_cpp_CConveyor_ctor_FUN_00441ca0(CConveyor *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH ESI                            ; 00441ca0
        ;   Label: core_conveyor.cpp_CConveyor_ctor_FUN_00441ca0
    PUSH EDI                            ; 00441ca1
    MOV EDX,dword ptr [ESP + 0xc]       ; 00441ca2
    PUSH EDX                            ; 00441ca6
    CALL core_platfrm.cpp_CPlatform_ctor_FUN_0054c850 ; 00441ca7
        ;   XREF to: 0054c850 (UNCONDITIONAL_CALL)  ; CPlatform * core_platfrm.cpp_CPlatform_ctor_FUN_0054c850(CPlatform * this_ptr)
    MOV dword ptr [EAX + 0x154],0x65bf34 ; 00441cac | g_CConveyorVTable
    MOV ESI,0x618e3a                    ; 00441cb6 | = "none"
    ...
    PUSH EDI                            ; 00441cee
    MOV AL,byte ptr [ESI]               ; 00441cef | = "none" | s_ne_00618e3c
        ;   Label: LAB_00441cef
    MOV byte ptr [EDI],AL               ; 00441cf1
    CMP AL,0x0                          ; 00441cf3
    JZ 0x00441d07                       ; 00441cf5
        ;   XREF to: 00441d07 (CONDITIONAL_JUMP)  ; LAB_00441d07
    MOV AL,byte ptr [ESI + 0x1]         ; 00441cf7 | s_one_00618e3b | s_e_00618e3d
    ADD ESI,0x2                         ; 00441cfa
    MOV byte ptr [EDI + 0x1],AL         ; 00441cfd
    ADD EDI,0x2                         ; 00441d00
    CMP AL,0x0                          ; 00441d03
    JNZ 0x00441cef                      ; 00441d05
        ;   XREF to: 00441cef (CONDITIONAL_JUMP)  ; LAB_00441cef
    POP EDI                             ; 00441d07
        ;   Label: LAB_00441d07
    MOV ESI,0x618e3f                    ; 00441d08 | = "none"
    LEA EDI,[EDX + 0x7a8]               ; 00441d0d
    PUSH EDI                            ; 00441d13
    MOV AL,byte ptr [ESI]               ; 00441d14 | = "none" | s_ne_00618e41
        ;   Label: LAB_00441d14
    MOV byte ptr [EDI],AL               ; 00441d16
    CMP AL,0x0                          ; 00441d18
    JZ 0x00441d2c                       ; 00441d1a
        ;   XREF to: 00441d2c (CONDITIONAL_JUMP)  ; LAB_00441d2c
    MOV AL,byte ptr [ESI + 0x1]         ; 00441d1c | s_one_00618e40 | s_e_00618e42
    ADD ESI,0x2                         ; 00441d1f
    MOV byte ptr [EDI + 0x1],AL         ; 00441d22
    ADD EDI,0x2                         ; 00441d25
    CMP AL,0x0                          ; 00441d28
    JNZ 0x00441d14                      ; 00441d2a
        ;   XREF to: 00441d14 (CONDITIONAL_JUMP)  ; LAB_00441d14
    POP EDI                             ; 00441d2c
        ;   Label: LAB_00441d2c
