...
section .text
    ...
    PUSH EAX                            ; 00442039
    CALL core_actor.cpp_serializeVector_FUN_0040b340 ; 0044203a
    ...
    PUSH EAX                            ; 0044204d
    CALL core_actor.cpp_serializeVector_FUN_0040b340 ; 0044204e
        ;   XREF to: 0040b340 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeVector_FUN_0040b340(CVector3f * vector_ptr, char * property_name)
    ADD ESP,0x8                         ; 00442053
    PUSH 0x618e53                       ; 00442056 | = "startEvent"
    LEA EAX,[EBX + 0x744]               ; 0044205b
    PUSH EAX                            ; 00442061
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 00442062
    ...
    PUSH EAX                            ; 00442075
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 00442076
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeString_FUN_0040b5c0(char * * string_buffer, char * property_type)
    ADD ESP,0x8                         ; 0044207b
    PUSH 0x618e68                       ; 0044207e | = "state"
    LEA EAX,[EBX + 0x80c]               ; 00442083
    PUSH EAX                            ; 00442089
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 0044208a
    ...
    PUSH EBX                            ; 004420aa
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 004420ab
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeString_FUN_0040b5c0(char * * string_buffer, char * property_type)
