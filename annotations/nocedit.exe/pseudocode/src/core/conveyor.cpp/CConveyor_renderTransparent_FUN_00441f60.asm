...
section .text
    ...
    PUSH EBX                            ; 00441f60
        ;   Label: core_conveyor.cpp_CConveyor_renderTransparent_FUN_00441f60
    PUSH ESI                            ; 00441f61
    ...
    POP EBX                             ; 00441f7a
    RET                                 ; 00441f7b
    MOV ECX,dword ptr [0x006703ec]      ; 00441f7c | g_CDemonRendererInstance | g_CDemonRendererPtr2
        ;   Label: LAB_00441f7c
    PUSH ECX                            ; 00441f82 | g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_isShadowPass_FUN_0048cae0 ; 00441f83
    ...
    PUSH EAX                            ; 00441ffc
    PUSH EBX                            ; 00441ffd
    CALL core_actor.cpp_CDemonActor_renderBoundingBoxSolid_FUN_0040dec0 ; 00441ffe
