...
section .text
    ...
    PUSH EBX                            ; 00442310
        ;   Label: core_conveyor.cpp_CConveyor_dtor_FUN_00442310
    ...
    PUSH 0x65c020                       ; 0044234d | g_CConveyorTypeInfo
        ;   Label: LAB_0044234d
    PUSH EBX                            ; 00442352
    CALL crt_memory.c___vec_delete_FUN_005fe632 ; 00442353
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c___vec_delete_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 00442358
    PUSH EAX                            ; 0044235b
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 0044235c
    ...
    PUSH EAX                            ; 00442368
        ;   Label: LAB_00442368
    CALL shape_memdbg.cpp_debugFreeChecked_FUN_0050f210 ; 00442369
