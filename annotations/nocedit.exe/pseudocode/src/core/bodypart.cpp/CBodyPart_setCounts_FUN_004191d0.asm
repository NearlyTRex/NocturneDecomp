...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_bodypart.cpp_CBodyPart_setCounts_FUN_004191d0(CBodyPart * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH 0x615bd9                       ; 00419200 | = "..\\core\\bodypart.cpp" | s_core_bodypart_cpp_00615bd9 = ..\core\bodypart.cpp
    SHL EAX,0x2                         ; 00419205
    PUSH EAX                            ; 00419208
    MOV EDX,dword ptr [EBX + 0x178]     ; 00419209
    PUSH EDX                            ; 0041920f
    CALL shape_memdbg.cpp_debugRealloc_FUN_0050f540 ; 00419210 | void * shape_memdbg.cpp_debugRealloc_FUN_0050f540(void * ptr, int new_size, char * filename, int line_number)
    ...
    PUSH 0x615bee                       ; 00419232 | = "..\\core\\bodypart.cpp" | s_core_bodypart_cpp_00615bee = ..\core\bodypart.cpp
    SHL EAX,0x2                         ; 00419237
    PUSH EAX                            ; 0041923a
    MOV ECX,dword ptr [EBX + 0x17c]     ; 0041923b
    PUSH ECX                            ; 00419241
    CALL shape_memdbg.cpp_debugRealloc_FUN_0050f540 ; 00419242 | void * shape_memdbg.cpp_debugRealloc_FUN_0050f540(void * ptr, int new_size, char * filename, int line_number)
        ;   XREF to: 0050f540 (UNCONDITIONAL_CALL)
    ...
    PUSH 0x615c03                       ; 00419263 | = "..\\core\\bodypart.cpp" | s_core_bodypart_cpp_00615c03 = ..\core\bodypart.cpp
    SUB EAX,EDX                         ; 00419268
    PUSH EAX                            ; 0041926a
    MOV ESI,dword ptr [EBX + 0x184]     ; 0041926b
    PUSH ESI                            ; 00419271
    CALL shape_memdbg.cpp_debugRealloc_FUN_0050f540 ; 00419272 | void * shape_memdbg.cpp_debugRealloc_FUN_0050f540(void * ptr, int new_size, char * filename, int line_number)
        ;   XREF to: 0050f540 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00419277
    MOV dword ptr [EBX + 0x184],EAX     ; 0041927a
    PUSH 0xac                           ; 00419280
    MOV EAX,dword ptr [EBX + 0x180]     ; 00419285
    PUSH 0x615c18                       ; 0041928b | = "..\\core\\bodypart.cpp" | s_core_bodypart_cpp_00615c18 = ..\core\bodypart.cpp
    SHL EAX,0x2                         ; 00419290
    PUSH EAX                            ; 00419293
    MOV EDI,dword ptr [EBX + 0x188]     ; 00419294
    PUSH EDI                            ; 0041929a
    CALL shape_memdbg.cpp_debugRealloc_FUN_0050f540 ; 0041929b | void * shape_memdbg.cpp_debugRealloc_FUN_0050f540(void * ptr, int new_size, char * filename, int line_number)
        ;   XREF to: 0050f540 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004192a0
    MOV EBP,dword ptr [EBX + 0x174]     ; 004192a3
    MOV dword ptr [EBX + 0x188],EAX     ; 004192a9
    TEST EBP,EBP                        ; 004192af
    JLE 0x004192ef                      ; 004192b1 | LAB_004192ef
        ;   XREF to: 004192ef (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x178],0x0     ; 004192b3
    JZ 0x004192c5                       ; 004192ba | LAB_004192c5
        ;   XREF to: 004192c5 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x17c],0x0     ; 004192bc
    JNZ 0x004192ef                      ; 004192c3 | LAB_004192ef
        ;   XREF to: 004192ef (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [EBX + 0x174]     ; 004192c5
        ;   Label: LAB_004192c5
    PUSH EDI                            ; 004192cb
    MOV ECX,0x615c2d                    ; 004192cc | = "..\\core\\bodypart.cpp" | s_core_bodypart_cpp_00615c2d = ..\core\bodypart.cpp
    MOV ESI,0xb2                        ; 004192d1
    PUSH 0x615c42                       ; 004192d6 | = "CBodyPart::setCounts - out of memory ..." | s_CBodyPart_setCounts_out__00615c42 = CBodyPart::setCounts - out of memory for vertices - vertexCount = %d
    MOV dword ptr [0x02f0ca48],ECX      ; 004192db | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 004192e1 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004192e7 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004192ec
    CMP dword ptr [EBX + 0x180],0x0     ; 004192ef
        ;   Label: LAB_004192ef
    JLE 0x0041930a                      ; 004192f6 | LAB_0041930a
        ;   XREF to: 0041930a (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x184],0x0     ; 004192f8
    JZ 0x0041930f                       ; 004192ff | LAB_0041930f
        ;   XREF to: 0041930f (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x188],0x0     ; 00419301
    JZ 0x0041930f                       ; 00419308 | LAB_0041930f
        ;   XREF to: 0041930f (CONDITIONAL_JUMP)
    POP EBP                             ; 0041930a
        ;   Label: LAB_0041930a
    POP EDI                             ; 0041930b
    ...
    MOV EDI,dword ptr [EBX + 0x180]     ; 0041930f
        ;   Label: LAB_0041930f
    PUSH EDI                            ; 00419315
    MOV ECX,0x615c87                    ; 00419316 | = "..\\core\\bodypart.cpp" | s_core_bodypart_cpp_00615c87 = ..\core\bodypart.cpp
    MOV ESI,0xb7                        ; 0041931b
    PUSH 0x615c9c                       ; 00419320 | = "CBodyPart::setCounts - out of memory ..." | s_CBodyPart_setCounts_out__00615c9c = CBodyPart::setCounts - out of memory for triangles - triCount = %d
    MOV dword ptr [0x02f0ca48],ECX      ; 00419325 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 0041932b | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00419331 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
