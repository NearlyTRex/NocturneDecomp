...

{
  ...
  core_actor_cpp_archiveInteger_FUN_0040b7f0((int *)(this_ptr->unk + 0x1c),"vertexCount");
  core_actor_cpp_archiveInteger_FUN_0040b7f0((int *)(this_ptr->unk + 0x28),"triCount");
  core_actor_cpp_archiveInteger_FUN_0040b7f0((int *)(this_ptr->unk + 0x34),"textureCount");
  ...
  if (1 < g_CBodyPartClassVersion) {
    core_actor_cpp_archiveSimBox_FUN_0040bd70((CSimBox *)(this_ptr->unk + 0xb74),"simBox");
    core_actor_cpp_archiveActor_FUN_0040b870
              ((CDemonActor *)(this_ptr->unk + 0xdd0),"carriedByActor");
  }
  if (2 < g_CBodyPartClassVersion) {
    core_actor_cpp_archiveInteger_FUN_0040b7f0((int *)(this_ptr->unk + 0xb60),"bloodType");
  ...
  if (3 < g_CBodyPartClassVersion) {
    core_actor_cpp_archiveInteger_FUN_0040b7f0((int *)this_ptr->unk,"renderInBackground");
  }
