...

{
  ...
  do {
    ...
    do {
      ...
      fVar9 = (float10)local_b8.m[0].z * (float10)65536f;
      fVar10 = (float10)local_b8.m[1].x * (float10)65536f;
      fVar11 = (float10)local_b8.m[1].y * (float10)65536f;
      fVar12 = (float10)local_b8.m[1].z * (float10)65536f;
      fVar13 = (float10)local_b8.m[2].x * (float10)65536f;
      ...
      local_28 = (int)ROUND(dVar16);
      fVar9 = (float10)local_b8.m[2].y * (float10)65536f;
      local_5c = 0x7fffffff;
      local_60 = 0x7fffffff;
      ...
      if (0 < extraout_EDX) {
        local_1c = 0;
        do {
          piVar4 = (int *)(*(int *)(in_stack_00000004 + 0x178) + local_1c);
  ...
  *in_stack_00000008 = local_84;
  in_stack_00000008[(uint)bVar8 * -2 + 1] = aiStack_80[(uint)bVar8 * -2];
  (in_stack_00000008 + (uint)bVar8 * -2 + 1)[(uint)bVar8 * -2 + 1] =
       aiStack_80[(uint)bVar8 * -2 + (uint)bVar8 * -2 + 1];
  *in_stack_0000000c = local_6c;
  in_stack_0000000c[(uint)bVar8 * -2 + 1] = aiStack_80[(uint)bVar8 * -2 + 6];
  (in_stack_0000000c + (uint)bVar8 * -2 + 1)[(uint)bVar8 * -2 + 1] =
       aiStack_80[(uint)bVar8 * -2 + (uint)bVar8 * -2 + 7];
