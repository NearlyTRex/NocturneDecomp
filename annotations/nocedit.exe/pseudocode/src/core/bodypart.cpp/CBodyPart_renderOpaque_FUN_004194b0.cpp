    ...
    *(int *)(this_ptr->unk + 0xdd4) = iVar1;
    if (iVar1 != 0) {
      ...
      if (0 < *(int *)(this_ptr->unk + 0x134)) {
        this_ptr_01 = (CKeyFramedModelInstance *)(this_ptr->unk + 0x150);
        position = (CVector3i *)(this_ptr->unk + 0x144);
        do {
          engine_drender_cpp_CDemonRenderer_applyScaledTransform_FUN_0048c4f0
                    (g_CDemonRendererPtr2,position,
                     (CVector3i *)(this_ptr->unk + iVar1 * 0x194 + 0x138));
        ...
        } while (iVar1 < *(int *)(this_ptr->unk + 0x134));
      }
    }
    engine_drender_cpp_CDemonRenderer_matrixPop_FUN_0050d720();
    g_CDemonSetPtr->unk_lighting_param2 = 0;
    return *(int *)(this_ptr->unk + 0xdd4);
  }
  if ((*(int *)(this_ptr->unk + 0xdd4) != 0) && (0 < *(int *)(this_ptr->unk + 0x5f4))) {
    return 1;
  }
  return 0;
}
