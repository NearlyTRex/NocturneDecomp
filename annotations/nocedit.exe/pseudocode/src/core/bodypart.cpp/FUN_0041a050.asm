...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_bodypart_cpp_FUN_0041a050(void)
;
; Local Variables:
...
section .text
    ...
    PUSH EAX                            ; 0041a0dd
    PUSH EDI                            ; 0041a0de
    CALL core_bodypart.cpp_FUN_0041aa40 ; 0041a0df
        ;   XREF to: 0041aa40 (UNCONDITIONAL_CALL)  ; void core_bodypart.cpp_FUN_0041aa40()
