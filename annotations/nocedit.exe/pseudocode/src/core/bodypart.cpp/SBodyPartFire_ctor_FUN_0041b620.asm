...
;                               FUNCTION
; *****************************************************************************
; __cdecl SBodyPartFire * core_bodypart.cpp_SBodyPartFire_ctor_FUN_0041b620(SBodyPartFire * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 0041b627
    CALL core_flame.cpp_CFlame_ctor_FUN_004c9aa0 ; 0041b628 | CFlame * core_flame.cpp_CFlame_ctor_FUN_004c9aa0(CFlame * this_ptr)
