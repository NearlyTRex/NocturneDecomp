...

{
  ...
  if ((2 < this_ptr->vertex_count) && (0 < this_ptr->tri_count)) {
    ...
    if (0 < this_ptr->attached_model_count) {
      ...
      do {
        (pSVar6->position_offset).x = (pSVar6->position_offset).x + local_6c.x;
        (pSVar6->position_offset).y = (pSVar6->position_offset).y + local_6c.y;
        iVar9 = iVar9 + 1;
        (pSVar6->position_offset).z = (pSVar6->position_offset).z + local_6c.z;
        pSVar6 = pSVar6 + 1;
