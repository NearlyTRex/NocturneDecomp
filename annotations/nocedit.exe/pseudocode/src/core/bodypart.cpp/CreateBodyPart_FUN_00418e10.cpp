...

{
  ...
  (this_ptr_00->base_actor).location.position.x = *in_stack_00000004;
  (this_ptr_00->base_actor).location.position.y = in_stack_00000004[1];
  (this_ptr_00->base_actor).location.position.z = in_stack_00000004[2];
  ...
  else if (this_ptr_00->field1_0x158 + 0x128 != (char *)in_stack_0000000c) {
    *(uint *)(this_ptr_00->field1_0x158 + 0x128) = *in_stack_0000000c;
    *(uint *)(this_ptr_00->field1_0x158 + 300) = in_stack_0000000c[1];
    *(uint *)(this_ptr_00->field1_0x158 + 0x130) = in_stack_0000000c[2];
  }
  ...
  *(uint *)(this_ptr_00->field1_0x158 + 0xb58) = in_stack_00000014;
  (this_ptr_00->base_actor).is_transparent = in_stack_00000018;
  *(int *)(this_ptr_00->field1_0x158 + 0xb5c) = in_stack_00000018;
  *(uint *)(this_ptr_00->field1_0x158 + 0xb60) = in_stack_0000001c;
  return this_ptr_00;
}
