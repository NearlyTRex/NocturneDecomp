...

{
  ...
  (ADJ(pCVar2)->initial_velocity).z = 0.0;
  (ADJ(pCVar2)->initial_velocity).y = (ADJ(pCVar2)->initial_velocity).z;
  (ADJ(pCVar2)->initial_velocity).x = (ADJ(pCVar2)->initial_velocity).y;
