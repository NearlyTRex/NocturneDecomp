...
section .text
    ...
    PUSH EBX                            ; 0041ae50
        ;   Label: core_bodypart.cpp_CBodyPart_addFire_FUN_0041ae50
    PUSH EBP                            ; 0041ae51
    ...
    CALL core_actor.cpp_getRandomFloatFromRange_FUN_0040cc10 ; 0041af6a
        ;   XREF to: 0040cc10 (UNCONDITIONAL_CALL)  ; float core_actor.cpp_getRandomFloatFromRange_FUN_0040cc10(float min_value, float max_value)
    MOV dword ptr [ESP + 0x1c],EAX      ; 0041af6f
    MOV EAX,dword ptr [ESP + 0x1c]      ; 0041af73
    MOV dword ptr [EBX + 0xcc8],EAX     ; 0041af77
    ADD ESP,0x8                         ; 0041af7d
    POP ESI                             ; 0041af80
    POP EDI                             ; 0041af81
