...

{
  ...
  if ((*(int *)(this_ptr->field1_0x158 + 0xdd4) != 0) &&
     ((*(int *)this_ptr->field1_0x158 < 2 || (*(int *)(this_ptr->field1_0x158 + 0x5f4) != 0)))) {
    if (*(int *)(this_ptr->field1_0x158 + 0xb5c) != 0) {
      ...
      engine_drender_cpp_CDemonRenderer_setRenderAlpha_FUN_0048ca60
                (g_CDemonRendererPtr2,*(int *)(this_ptr->field1_0x158 + 0xb68));
    ...
    iVar1 = 0;
    if (0 < *(int *)(this_ptr->field1_0x158 + 0x5f4)) {
      do {
        core_flame_cpp_FUN_004ca110();
        iVar1 = iVar1 + 1;
      } while (iVar1 < *(int *)(this_ptr->field1_0x158 + 0x5f4));
    }
    return 1;
  }
  return 0;
