...
section .text
    ...
    PUSH 0x65af00                       ; 004191a4 | g_CBodyPartTypeInfo
        ;   Label: LAB_004191a4
    PUSH EBX                            ; 004191a9
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 004191aa
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 004191af
    PUSH EAX                            ; 004191b2
    CALL crt_memory.c_free_FUN_005fe659 ; 004191b3
    ...
    PUSH EAX                            ; 004191bf
        ;   Label: LAB_004191bf
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 004191c0
