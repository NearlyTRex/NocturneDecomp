...
// Cross-references:
//   core_bodypart.cpp_CBodyPart_onDropped_FUN_00419fd0 (00419fd0) at 00419fe3 [UNCONDITIONAL_CALL]
//   core_bodypart.cpp_CBodyPart_processInEditor_FUN_0041b260 (0041b260) at 0041b272 [UNCONDITIONAL_CALL]
...

{
  ...
  if ((2 < *(int *)(this_ptr->field1_0x158 + 0x1c)) && (0 < *(int *)(this_ptr->field1_0x158 + 0x28))
    ...
    CStack_20.x = fStack_14 * FLOAT_00615e9c;
    CStack_20.y = fStack_10 * FLOAT_00615e9c;
    fStack_c = fStack_30 + fStack_24;
    CStack_20.z = fStack_c * FLOAT_00615e9c;
  ...
  *(undefined4 *)(this_ptr->field1_0x158 + 8) = *(undefined4 *)(this_ptr->field1_0x158 + 0x14);
  *(undefined4 *)(this_ptr->field1_0x158 + 0xc) = *(undefined4 *)(this_ptr->field1_0x158 + 0x18);
  return;
}
