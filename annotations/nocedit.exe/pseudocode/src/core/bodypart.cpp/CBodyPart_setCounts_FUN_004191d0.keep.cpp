...

{
  ...
  pCVar1 = (CVector3i *)shape_memdbg_cpp_debugRealloc_FUN_0050f540
                     (this_ptr->vertices,this_ptr->vertex_count * sizeof(CVector3i),"..\\core\\bodypart.cpp",
                      168);
  this_ptr->vertices = pCVar1;
  pCVar1 = (CVector3i *)shape_memdbg_cpp_debugRealloc_FUN_0050f540
                     (this_ptr->normals,this_ptr->vertex_count * sizeof(CVector3i),"..\\core\\bodypart.cpp",
                      169);
  this_ptr->normals = pCVar1;
  pSVar2 = (SMRGLPrimitiveTriangle *)shape_memdbg_cpp_debugRealloc_FUN_0050f540
                     (this_ptr->faces,this_ptr->tri_count * sizeof(SMRGLPrimitiveTriangle),"..\\core\\bodypart.cpp",171);
