...

{
  ...
  pSVar1 = (CBodyPart_ptr_1872)
           core_bodypart_cpp_SBodyPartFire_arrdtor2_FUN_0041b6b0(ADJ(pCVar1)->fires,0);
  pSVar2 = (CBodyPart_ptr_656)
           core_bodypart_cpp_SBodyPartModel_arrdtor3_FUN_0041b690(ADJ(pSVar1)->attached_models,0);
