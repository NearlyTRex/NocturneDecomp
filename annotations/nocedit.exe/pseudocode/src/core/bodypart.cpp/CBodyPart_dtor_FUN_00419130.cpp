...

{
  ...
  pCVar1 = core_box_cpp_CBox_dtor_FUN_0041dd00(&this_ptr->sim_box,0);
  pSVar2 = core_bodypart_cpp_SBodyPartFire_arrdtor_FUN_0041b6b0
                     ((SBodyPartFire *)&pCVar1[-3].scrape_points[4].local_position.z,0);
  pSVar3 = core_bodypart_cpp_SBodyPartModel_arrdtor_FUN_0041b690
                     ((SBodyPartModel *)(pSVar2[-2].flame.base.create_event + 0x1c),0);
  ptr = (CBodyPart *)
        core_actor_cpp_CDemonActor_dtor_FUN_00408a30
                  ((CDemonActor *)(pSVar3[-2].model.model_name + 8),1);
  if ((flags & 2) == 0) {
    return ptr;
  }
