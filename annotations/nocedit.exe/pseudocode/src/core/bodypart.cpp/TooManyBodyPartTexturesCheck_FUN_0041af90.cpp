// Name: core_bodypart.cpp_TooManyBodyPartTexturesCheck_FUN_0041af90
// Address: 0041af90
// Address Range: [[0041af90, 0041b06d]]
// Convention: unknown
// Signature: undefined core_bodypart.cpp_TooManyBodyPartTexturesCheck_FUN_0041af90()
// Cross-references:
...
/* Signature: undefined1 actors_other_bodypart.cpp_TooManyBodyPartTexturesCheck(undefined4 param_1,
   undefined4 param_2) */

int core_bodypart_cpp_TooManyBodyPartTexturesCheck_FUN_0041af90(void)

{
  ...
  iVar3 = 0;
  if (0 < *(int *)(in_stack_00000004 + 0x18c)) {
    pcVar4 = (char *)(in_stack_00000004 + 0x198);
    do {
      ...
      iVar3 = iVar3 + 1;
      pcVar4 = pcVar4 + 0x18;
    } while (iVar3 < *(int *)(in_stack_00000004 + 0x18c));
  }
  if (9 < *(int *)(in_stack_00000004 + 0x18c)) {
  ...
  crt_memory_c_memset_FUN_005fde40
            ((void *)(*(int *)(in_stack_00000004 + 0x18c) * 0x18 + in_stack_00000004 + 400),0,0x18);
  pcVar4 = (char *)(in_stack_00000004 + 400 + *(int *)(in_stack_00000004 + 0x18c) * 0x18 + 8);
  do {
  ...
  iVar3 = *(int *)(in_stack_00000004 + 0x18c);
  *(int *)(in_stack_00000004 + 0x18c) = iVar3 + 1;
  return iVar3;
}
...
// Assembly code:
// 0041af90: PUSH EBX
//   Label: core_bodypart.cpp_TooManyBodyPartTexturesCheck_FUN_0041af90
// 0041af91: PUSH ESI
// 0041af92: PUSH EDI
// 0041af93: PUSH EBP
