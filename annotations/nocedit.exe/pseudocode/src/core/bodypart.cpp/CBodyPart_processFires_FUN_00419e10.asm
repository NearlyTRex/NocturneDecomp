...
;
; Referenced Globals:
;   double g_BodyPartFlameBaseScale = 1.5
;   double g_BodyPartFlameMaxScale = 3
;   double g_BodyPartFireFadeMultiplier = 0.200000000000000
;   double g_BodyPartFireFadeThreshold = 5
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 00419e10
        ;   Label: core_bodypart.cpp_CBodyPart_processFires_FUN_00419e10
    PUSH ESI                            ; 00419e11
    PUSH EDI                            ; 00419e12
    PUSH EBP                            ; 00419e13
    ...
    FCOMP double ptr [0x00615e2c]       ; 00419eae | g_BodyPartFireFadeThreshold
    FNSTSW AX                           ; 00419eb4
    SAHF                                ; 00419eb6
    JNC 0x00419ec6                      ; 00419eb7
        ;   XREF to: 00419ec6 (CONDITIONAL_JUMP)  ; LAB_00419ec6
    FLD double ptr [ESP]                ; 00419eb9
    FMUL double ptr [0x00615e24]        ; 00419ebc | g_BodyPartFireFadeMultiplier
    FSTP float ptr [ESP + 0x8]          ; 00419ec2
    FLD float ptr [ESP + 0x8]           ; 00419ec6
        ;   Label: LAB_00419ec6
    FLD ST0                             ; 00419eca
    FMUL double ptr [0x00615e14]        ; 00419ecc | g_BodyPartFlameBaseScale
    FXCH                                ; 00419ed2
    FMUL double ptr [0x00615e1c]        ; 00419ed4 | g_BodyPartFlameMaxScale
