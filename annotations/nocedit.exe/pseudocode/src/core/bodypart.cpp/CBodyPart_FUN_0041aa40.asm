...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_bodypart_cpp_CBodyPart_FUN_0041aa40(CBodyPart *this_ptr)
;
; Parameters:
...
;
; XREF[1]:
;   core_bodypart.cpp_CBodyPart_FUN_0041a050 at 0041a0df
;
; Referenced Globals:
...
;
; Called Functions:
;   core_bodypart.cpp_CBodyPart_FUN_0041a630
...
section .text
    ...
    PUSH EBX                            ; 0041aa40
        ;   Label: core_bodypart.cpp_CBodyPart_FUN_0041aa40
    PUSH ESI                            ; 0041aa41
    PUSH EDI                            ; 0041aa42
    PUSH EBP                            ; 0041aa43
    ...
    PUSH ESI                            ; 0041adb3
    CALL core_bodypart.cpp_CBodyPart_FUN_0041a630 ; 0041adb4
        ;   XREF to: 0041a630 (UNCONDITIONAL_CALL)  ; void core_bodypart.cpp_CBodyPart_FUN_0041a630(CBodyPart * this_ptr)
