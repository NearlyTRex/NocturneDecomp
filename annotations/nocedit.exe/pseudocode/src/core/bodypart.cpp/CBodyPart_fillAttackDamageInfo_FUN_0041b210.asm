...
section .text
    ...
    MOV dword ptr [ESP + 0x8],EAX       ; 0041b240
    MOV dword ptr [EBX + 0x2c],0x3ca3d70a ; 0041b244
    MOV EAX,dword ptr [ESP + 0x8]       ; 0041b24b
    MOV dword ptr [EBX + 0x4],EAX       ; 0041b24f
    ADD ESP,0x8                         ; 0041b252
    ADD ESP,0x4                         ; 0041b255
    POP ESI                             ; 0041b258
    POP EBX                             ; 0041b259
    RET                                 ; 0041b25a
