...
section .text
    ...
    PUSH ESI                            ; 0041b228
    CALL core_actor.cpp_CDemonActor_fillAttackDamageInfo_FUN_0040abc0 ; 0041b229 | void core_actor.cpp_CDemonActor_fillAttackDamageInfo_FUN_0040abc0(CDemonActor * this_ptr, int attack_flags, SDamageInfo * out_damage_info, CDemonActor * victim)
        ;   XREF to: 0040abc0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0041b22e
    PUSH 0x41700000                     ; 0041b231
    PUSH 0x40a00000                     ; 0041b236
    CALL core_actor.cpp_getRandomFloat_FUN_0040cc10 ; 0041b23b | float core_actor.cpp_getRandomFloat_FUN_0040cc10(float min_value, float max_value)
