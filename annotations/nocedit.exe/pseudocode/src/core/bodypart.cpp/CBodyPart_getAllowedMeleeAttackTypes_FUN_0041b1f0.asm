...
section .text
    ...
    JZ 0x0041b200                       ; 0041b1fb | LAB_0041b200
        ;   XREF to: 0041b200 (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 0041b1fd
    RET                                 ; 0041b1ff
    PUSH EAX                            ; 0041b200
        ;   Label: LAB_0041b200
    CALL core_actor.cpp_CDemonActor_getAllowedMeleeAttackTypes_FUN_0040a0f0 ; 0041b201 | int core_actor.cpp_CDemonActor_getAllowedMeleeAttackTypes_FUN_0040a0f0(CDemonActor * this_ptr)
