...
section .text
    ...
    JGE 0x0041af82                      ; 0041ae66 | LAB_0041af82
    ...
    JZ 0x0041ae99                       ; 0041ae87 | LAB_0041ae99
    ...
    PUSH EAX                            ; 0041ae9e
    PUSH EBX                            ; 0041ae9f
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 0041aea0 | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
    ...
    CALL core_flame.cpp_FUN_004c9b90    ; 0041aebf | undefined core_flame.cpp_FUN_004c9b90()
    ...
    MOV ESI,0x615e60                    ; 0041aeff | = "CHAR2.RAW" | s_CHAR2_RAW_00615e60 = CHAR2.RAW
    MOV dword ptr [EBX + 0x18c],0x1     ; 0041af04
    PUSH EDI                            ; 0041af0e
    MOV AL,byte ptr [ESI]               ; 0041af0f | = "CHAR2.RAW" | s_CHAR2_RAW_00615e60 = CHAR2.RAW
        ;   Label: LAB_0041af0f
    MOV byte ptr [EDI],AL               ; 0041af11
    CMP AL,0x0                          ; 0041af13
    JZ 0x0041af27                       ; 0041af15 | LAB_0041af27
        ;   XREF to: 0041af27 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0041af17 | s_HAR2.RAW_00615e61
    ADD ESI,0x2                         ; 0041af1a
    MOV byte ptr [EDI + 0x1],AL         ; 0041af1d
    ADD EDI,0x2                         ; 0041af20
    CMP AL,0x0                          ; 0041af23
    JNZ 0x0041af0f                      ; 0041af25 | LAB_0041af0f
    ...
    JLE 0x0041af60                      ; 0041af32 | LAB_0041af60
    ...
    JL 0x0041af36                       ; 0041af4f | LAB_0041af36
    ...
    CALL core_actor.cpp_getRandomFloat_FUN_0040cc10 ; 0041af6a | float core_actor.cpp_getRandomFloat_FUN_0040cc10(float min_value, float max_value)
