...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_crossbow.cpp_CCrossbow_renderTransparent_FUN_00448e80(CCrossbow * this_ptr)
;
; Parameters:
...
section .text
    ...
    JNZ 0x00448e90                      ; 00448e8b | LAB_00448e90
    ...
    ADD EAX,0x57c                       ; 00448e90
        ;   Label: LAB_00448e90
    PUSH EAX                            ; 00448e95
    CALL core_flame.cpp_FUN_004ca110    ; 00448e96 | undefined core_flame.cpp_FUN_004ca110()
