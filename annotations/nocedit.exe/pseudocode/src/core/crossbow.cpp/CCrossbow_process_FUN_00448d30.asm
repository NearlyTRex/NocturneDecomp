...
section .text
    ...
    PUSH EBX                            ; 00448d3c
    CALL core_weapon.cpp_CWeapon_process_FUN_005ee110 ; 00448d3d | void core_weapon.cpp_CWeapon_process_FUN_005ee110(CWeapon * this_ptr)
    ...
    PUSH EAX                            ; 00448d5f
    PUSH EBX                            ; 00448d60
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 00448d61 | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
    ...
    JNZ 0x00448dd9                      ; 00448d88 | LAB_00448dd9
        ;   XREF to: 00448dd9 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x568],0x0     ; 00448d8a
    JLE 0x00448dd9                      ; 00448d91 | LAB_00448dd9
        ;   XREF to: 00448dd9 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x56c],0x5     ; 00448d93
    JNZ 0x00448dd9                      ; 00448d9a | LAB_00448dd9
        ;   XREF to: 00448dd9 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 00448da6
    SAHF                                ; 00448da8
    JC 0x00448dd9                       ; 00448da9 | LAB_00448dd9
        ;   XREF to: 00448dd9 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 00448dbf
    CALL core_flame.cpp_FUN_004c9c00    ; 00448dc0 | undefined core_flame.cpp_FUN_004c9c00()
    ...
    LEA EAX,[EBX + 0x57c]               ; 00448dd9
        ;   Label: LAB_00448dd9
    PUSH EAX                            ; 00448ddf
    CALL core_flame.cpp_FUN_004caa70    ; 00448de0 | undefined core_flame.cpp_FUN_004caa70()
        ;   XREF to: 004caa70 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00448de5
    MOV dword ptr [EBX + 0x578],0x0     ; 00448de8
    JMP 0x00448db5                      ; 00448df2 | LAB_00448db5
