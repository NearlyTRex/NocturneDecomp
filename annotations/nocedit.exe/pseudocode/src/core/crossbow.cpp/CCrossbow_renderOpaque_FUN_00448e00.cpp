...
// Convention: __cdecl
// Signature: int core_crossbow.cpp_CCrossbow_renderOpaque_FUN_00448e00(CCrossbow * this_ptr)
// Function calls:
...

{
  ...
  fStack00000014 = (float)core_crossbow_cpp_FUN_00449540();
  fStack_14 = 6.295898e-39;
  core_dmodel_cpp_CKeyFramedModelInstance_prepareForRendering_FUN_00478d20
            (&(this_ptr->base_weapon).model,fStack00000014,unaff_ESI);
  core_actor_cpp_CDemonActor_restoreRenderState_FUN_00408b40((CDemonActor *)this_ptr);
  return iVar1;
}
