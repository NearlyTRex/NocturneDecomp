// Name: core_crossbow.cpp_FUN_00448f20
// Address: 00448f20
// Address Range: [[00448f20, 0044953a]]
// Convention: unknown
// Signature: undefined core_crossbow.cpp_FUN_00448f20()
// Globals:
//   TerminatedCString s_bow_wav_00619b86
//   undefined4 DAT_00619b92
//   undefined4 DAT_00619b9a
...
//   core_fire.cpp_CFireEffect_FUN_004c7bb0
...
/* Signature: undefined1 actors_weapon_crossbow.cpp_FUN_00448f20(undefined4* param_1) */

undefined4 core_crossbow_cpp_FUN_00448f20(void)

{
  ...
  CStack_6c.x = in_stack_00000004[2].orient.heading;
  core_actor_cpp_CDemonActor_FUN_00408e80(in_stack_00000004);
  CStack_6c.z = fStack_58 + fStack_88;
  fStack_60 = CStack_54.x + fStack_84;
  fStack_5c = CStack_54.y + fStack_80;
  fStack_38 = (float)_DAT_00619b92 / in_stack_00000004[2].orient.heading;
  fStack_40 = fStack_88 * fStack_38;
  fStack_3c = fStack_84 * fStack_38;
  ...
  fStack00000008 = 0.0;
  do {
    fVar2 = core_setcolid_cpp_CDemonSet_raycast_FUN_00572530(g_CDemonSetPtr,&CStack_6c,&CStack_54);
    dVar6 = (double)fVar2;
    if ((dVar6 < 0.0) || (1.0 < dVar6)) break;
    pCVar3 = core_actor_cpp_castToClassHash_FUN_0040c790
                       (g_CDemonSetPtr->collision_actor,g_CCharacterClassInfo.name_hash);
    if ((pCVar3 != (CDemonActor *)0x0) &&
       (iVar1 = (*(pCVar3->metadata).vtable[1].hasCollision)
                          (pCVar3,(SCollisionInfo *)((ulonglong)dVar6 >> 0x20)), 0 < iVar1)) {
    ...
    if (pCVar3 == (CDemonActor *)0x0) {
      if (in_stack_00000034 == 0) {
        if (pCVar4 == (CDemonActor *)0x0) {
          core_fire_cpp_CFireEffect_FUN_004c7bb0(g_CFireEffectPtr);
          break;
        }
        core_trigger_cpp_FUN_005e0aa0();
        iVar1 = core_trigger_cpp_FUN_005e0ac0();
        if (iVar1 != 0) {
          (*(in_stack_00000004->metadata).vtable[1].getBoundingBox)
                    (in_stack_00000004,in_stack_ffffff54);
        ...
        iVar1 = core_glass_cpp_FUN_004eb3a0();
        if (iVar1 == 0) break;
        core_glass_cpp_FUN_004eaef0();
      }
    }
    else {
      iVar1 = (*(pCVar3->metadata).vtable[1].renderOpaque)(pCVar3);
      ...
      volume = (*(in_stack_00000004->metadata).vtable[1].getBoundingBox)(in_stack_00000004,out_box);
      fStack_1c = (g_CDemonSetPtr->collision_result_vec2).x -
                  (g_CDemonSetPtr->collision_result_vec1).x;
      fStack_18 = (g_CDemonSetPtr->collision_result_vec2).y -
                  (g_CDemonSetPtr->collision_result_vec1).y;
      fStack_14 = (g_CDemonSetPtr->collision_result_vec2).z -
                  (g_CDemonSetPtr->collision_result_vec1).z;
      fStack00000008 =
           (float)_DAT_00619b9a /
           SQRT(fStack_14 * fStack_14 + fStack_1c * fStack_1c + fStack_18 * fStack_18);
      fStack_1c = fStack_1c * fStack00000008;
      fStack_18 = fStack_18 * fStack00000008;
      fStack_14 = fStack_14 * fStack00000008;
      pCVar5 = core_actor_cpp_CDemonActor_FUN_00408f10(pCVar3);
      if ((CVector3f *)&stack0xffffff50 != pCVar5) {
        in_stack_ffffff54 = (CBoundingBox3D *)pCVar5->y;
      }
      fStack_a4 = *(float *)(in_stack_00000004[4].actor_name + 0xc);
      (*((in_stack_00000004->metadata).vtable)->getCarrier)(in_stack_00000004);
      (*(pCVar3->metadata).vtable[1].playAmbientSoundWithVolume)
                (pCVar3,&stack0xffffff40,(float)volume);
  ...
  CStack_6c.z = fStack_40 + CStack_54.z * fStack_a4;
  fStack_60 = fStack_3c + fStack_48 * fStack_a4;
  fStack_5c = fStack_38 + fStack_44 * fStack_a4;
  core_sound_cpp_CSound_FUN_005b3a40(g_CSoundPtr,in_stack_00000004->actor_name,"bow-!.wav");
...
// Assembly code:
// 00448f20: PUSH EBX
//   Label: core_crossbow.cpp_FUN_00448f20
// 00448f21: PUSH ESI
// 00448f22: PUSH EDI
// 00448f23: PUSH EBP
...
// 00448f52: PUSH EAX
// 00448f53: PUSH EBX
// 00448f54: CALL core_actor.cpp_CDemonActor_FUN_00408ec0
...
// 00448f98: CALL core_actor.cpp_CDemonActor_FUN_00408e80
...
// 0044942b: PUSH EAX
// 0044942c: PUSH ESI
// 0044942d: CALL core_actor.cpp_CDemonActor_FUN_00408f10
...
// 004494c1: PUSH EAX
//   Label: LAB_004494c1
// 004494c2: CALL core_glass.cpp_FUN_004eb3a0
...
// 004494e4: PUSH EDX
// 004494e5: CALL core_glass.cpp_FUN_004eaef0
...
// 0044952e: CALL core_fire.cpp_CFireEffect_FUN_004c7bb0
