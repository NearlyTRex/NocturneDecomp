...
section .text
    ...
    PUSH 0x820                          ; 00448c37
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1b0 ; 00448c3c
    ...
    PUSH EAX                            ; 00448c49
        ;   Label: LAB_00448c49
    CALL core_crossbow.cpp_FUN_00448c70 ; 00448c4a
        ;   XREF to: 00448c70 (UNCONDITIONAL_CALL)  ; CCrossbow * core_crossbow.cpp_FUN_00448c70(CCrossbow * this_ptr)
