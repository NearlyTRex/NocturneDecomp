// Name: core_crossbow.cpp_FUN_004495a0
// Address: 004495a0
// Address Range: [[004495a0, 00449604]]
// Convention: __cdecl
// Signature: CCrossbow * core_crossbow.cpp_FUN_004495a0(CCrossbow * this_ptr, uint d1, uint d2, uint d3)
// Globals:
...
CCrossbow * __cdecl core_crossbow_cpp_FUN_004495a0(CCrossbow *this_ptr,uint d1,uint d2,uint d3)

{
  ...
  ptr = (CCrossbow *)
        core_weapon_cpp_CWeapon_dtor_FUN_005edf80
                  ((CWeapon *)&pCVar1[-5].metadata.runtime_vector2.z,1,unaff_retaddr,(uint)this_ptr)
  ;
  if ((d3 & 2) == 0) {
    return ptr;
  }
...
// Assembly code:
// 004495a0: PUSH EBX
//   Label: core_crossbow.cpp_FUN_004495a0
