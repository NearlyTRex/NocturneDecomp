...

{
  ...
  (*in_stack_00000004->vtable->getBoundingBox)(in_stack_00000004,(CBoundingBox3D *)local_ec);
  CStack_88.y = 0.1;
  CStack_88.z = 0.1;
  uStack_7c = 0;
  ...
  crt_memory_c_constructObjectArray_DefaultCtor_FUN_005fe667
            ((CVector3f *)((int)register0x00000010 + -0x1c4),8,&g_CVectorTypeInfo);
  do {
  ...
  while( true ) {
    ...
    this_ptr = *(CDemonActor **)(g_CDemonSetPtr->field19_0x14f0a0 + iStack_1c + -4);
    fVar1 = (pCStack_18->position).x - (this_ptr->location).position.x;
    fVar3 = (pCStack_18->position).y - (this_ptr->location).position.y;
    fVar2 = (pCStack_18->position).z - (this_ptr->location).position.z;
    if (fVar2 * fVar2 + fVar3 * fVar3 + fVar1 * fVar1 <= fStack_24) {
      ...
      pCStack_18 = (CLocation *)
                   (*this_ptr->vtable->hasCollision)
                             (this_ptr,(SCollisionInfo *)(auStack_15c + 0x34));
      if (pCStack_18 != (CLocation *)0x0) {
        SStack_120.cylinder_bottom_y = 0.0;
        core_actor_cpp_CDemonActor_worldToLocalPoint_FUN_00408f10
                  (in_stack_00000004,&CStack_58,&(this_ptr->location).position);
        ...
        aCStack_1c4[0].y =
             core_actor_cpp_CDemonActor_rayIntersect_FUN_00409470
                       (this_ptr,(CVector3f *)auStack_70,&CStack_88,&CStack_f8,&SStack_120,
                        (int)pCStack_18,(CBoundingBox3D *)(auStack_cc + 8));
        dStack_1c8 = (double)aCStack_1c4[0].y;
        if ((0.0 <= dStack_1c8) && (dStack_1c8 <= 1.0)) {
          fStack_4c = CStack_88.x * aCStack_1c4[0].y;
          CStack_48.x = CStack_88.y * aCStack_1c4[0].y;
          CStack_48.y = CStack_88.z * aCStack_1c4[0].y;
          ...
          core_actor_cpp_CDemonActor_worldToLocalPoint_FUN_00408f10
                    (this_ptr,(CVector3f *)auStack_94,&CStack_a0);
