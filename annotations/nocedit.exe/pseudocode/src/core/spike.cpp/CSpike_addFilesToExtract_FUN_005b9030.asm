...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_spike_cpp_CSpike_addFilesToExtract_FUN_005b9030(CSpike *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x8]       ; 005b9030
        ;   Label: core_spike.cpp_CSpike_addFilesToExtract_FUN_005b9030
