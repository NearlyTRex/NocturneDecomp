...
;                               FUNCTION
; *****************************************************************************
; __cdecl CBoundingBox3D * __cdecl core_spike_cpp_CSpike_getBoundingBox_FUN_005b87a0(CSpike *this_ptr,CBoundingBox3D *out_box)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005b87a0
        ;   Label: core_spike.cpp_CSpike_getBoundingBox_FUN_005b87a0
    MOV EBX,dword ptr [ESP + 0xc]       ; 005b87a1
    MOV EAX,dword ptr [ESP + 0x8]       ; 005b87a5
    ADD EAX,0x158                       ; 005b87a9
    PUSH EAX                            ; 005b87ae
    CALL core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80 ; 005b87af
