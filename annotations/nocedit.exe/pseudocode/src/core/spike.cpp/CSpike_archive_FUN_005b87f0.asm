...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_spike_cpp_CSpike_archive_FUN_005b87f0(CSpike *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005b87f0
        ;   Label: core_spike.cpp_CSpike_archive_FUN_005b87f0
    MOV EBX,dword ptr [ESP + 0x8]       ; 005b87f1
    PUSH EBX                            ; 005b87f5
    CALL core_actor.cpp_CDemonActor_archive_FUN_0040c1c0 ; 005b87f6
    ...
    PUSH EAX                            ; 005b8809
    CALL core_actor.cpp_archiveKeyframedModelInstance_FUN_0040b8f0 ; 005b880a
    ...
    PUSH EAX                            ; 005b881d
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 005b881e
    ...
    PUSH EAX                            ; 005b8831
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 005b8832
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ADD ESP,0x8                         ; 005b8837
    PUSH 0x652e27                       ; 005b883a | = "areWeActive"
    LEA EAX,[EBX + 0x2dc]               ; 005b883f
    PUSH EAX                            ; 005b8845
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 005b8846
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ADD ESP,0x8                         ; 005b884b
    PUSH 0x652e33                       ; 005b884e | = "extendDistance"
    LEA EAX,[EBX + 0x2ec]               ; 005b8853
    PUSH EAX                            ; 005b8859
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 005b885a
    ...
    PUSH EAX                            ; 005b886d
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 005b886e
