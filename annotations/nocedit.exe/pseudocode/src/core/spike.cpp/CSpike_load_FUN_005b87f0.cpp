...

{
  ...
  core_actor_cpp_archiveString_FUN_0040b5c0
            (in_stack_00000004[2].create_event + 0x2c,"stopEvent");
  core_actor_cpp_archiveString_FUN_0040b5c0
            ((char *)&in_stack_00000004[2].scale,"extendEvent");
  core_actor_cpp_archiveString_FUN_0040b5c0
            (in_stack_00000004[3].actor_name + 0x14,"retractEvent");
  core_actor_cpp_archiveFloat_FUN_0040b770
            ((float *)in_stack_00000004[3].create_event,"extendTime");
  core_actor_cpp_archiveFloat_FUN_0040b770
            ((float *)(in_stack_00000004[3].create_event + 4),"retractTime");
  core_actor_cpp_archiveString_FUN_0040b5c0
            (in_stack_00000004[3].create_event + 0xc,"extendSound");
  core_actor_cpp_archiveString_FUN_0040b5c0
  ...
  core_actor_cpp_archiveFloat_FUN_0040b770((float *)&in_stack_00000004[3].vtable,"param");
  return;
}
