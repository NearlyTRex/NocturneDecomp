...
;                               FUNCTION
; *****************************************************************************
; __cdecl CSpike * __cdecl core_spike_cpp_CSpike_dtor_FUN_005b9050(CSpike *this_ptr,uint flags)
;
; Parameters:
...
section .text
    ...
    PUSH 0x663450                       ; 005b9076 | g_CSpikeTypeInfo
        ;   Label: LAB_005b9076
    PUSH EBX                            ; 005b907b
    CALL crt_memory.c___vec_delete_FUN_005fe632 ; 005b907c
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c___vec_delete_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 005b9081
    PUSH EAX                            ; 005b9084
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 005b9085
