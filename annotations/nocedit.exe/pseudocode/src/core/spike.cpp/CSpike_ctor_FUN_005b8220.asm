...
;                               FUNCTION
; *****************************************************************************
; __cdecl CSpike * core_spike.cpp_CSpike_ctor_FUN_005b8220(CSpike * this_ptr)
;
; Parameters:
; CSpike *         Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_spike.cpp_FUN_005b81e0 at 005b81fa
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 005b8227
    CALL core_actor.cpp_CDemonActor_ctor_FUN_004088b0 ; 005b8228 | CDemonActor * core_actor.cpp_CDemonActor_ctor_FUN_004088b0(CDemonActor * this_ptr)
        ;   XREF to: 004088b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005b822d
    ADD EAX,0x158                       ; 005b8230
    PUSH EAX                            ; 005b8235
    CALL core_dmodel.cpp_CKeyFramedModelInstance_ctor_FUN_00478ce0 ; 005b8236 | CKeyFramedModelInstance * core_dmodel.cpp_CKeyFramedModelInstance_ctor_FUN_00478ce0(CKeyFramedModelInstance * this_ptr)
        ;   XREF to: 00478ce0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005b823b
    LEA EBX,[EAX + 0xfffffea8]          ; 005b823e
    PUSH 0x652de1                       ; 005b8244 | = "bgate.kfm" | s_bgate_kfm_00652de1 = bgate.kfm
    LEA EAX,[EBX + 0x158]               ; 005b8249
    PUSH EAX                            ; 005b824f
    MOV ESI,0x652deb                    ; 005b8250 | = "none" | s_none_00652deb = none
    MOV dword ptr [EBX + 0x154],0x663364 ; 005b8255 | CDemonActor_vtable g_CSpikeVTable
    CALL core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0 ; 005b825f | void core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0(CKeyFramedModelInstance * this_ptr, char * filename)
    ...
    PUSH EDI                            ; 005b828b
    MOV AL,byte ptr [ESI]               ; 005b828c | = "none" | s_none_00652deb = none
        ;   Label: LAB_005b828c
    MOV byte ptr [EDI],AL               ; 005b828e
    CMP AL,0x0                          ; 005b8290
    JZ 0x005b82a4                       ; 005b8292 | LAB_005b82a4
        ;   XREF to: 005b82a4 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 005b8294 | s_one_00652dec
    ADD ESI,0x2                         ; 005b8297
    MOV byte ptr [EDI + 0x1],AL         ; 005b829a
    ADD EDI,0x2                         ; 005b829d
    CMP AL,0x0                          ; 005b82a0
    JNZ 0x005b828c                      ; 005b82a2 | LAB_005b828c
        ;   XREF to: 005b828c (CONDITIONAL_JUMP)
    POP EDI                             ; 005b82a4
        ;   Label: LAB_005b82a4
    MOV ESI,0x652df0                    ; 005b82a5 | = "none" | s_none_00652df0 = none
    LEA EDI,[EBX + 0x354]               ; 005b82aa
    PUSH EDI                            ; 005b82b0
    MOV AL,byte ptr [ESI]               ; 005b82b1 | = "none" | s_none_00652df0 = none
        ;   Label: LAB_005b82b1
    MOV byte ptr [EDI],AL               ; 005b82b3
    CMP AL,0x0                          ; 005b82b5
    JZ 0x005b82c9                       ; 005b82b7 | LAB_005b82c9
        ;   XREF to: 005b82c9 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 005b82b9 | s_one_00652df1
    ADD ESI,0x2                         ; 005b82bc
    MOV byte ptr [EDI + 0x1],AL         ; 005b82bf
    ADD EDI,0x2                         ; 005b82c2
    CMP AL,0x0                          ; 005b82c5
    JNZ 0x005b82b1                      ; 005b82c7 | LAB_005b82b1
        ;   XREF to: 005b82b1 (CONDITIONAL_JUMP)
    POP EDI                             ; 005b82c9
        ;   Label: LAB_005b82c9
    MOV ESI,0x652df5                    ; 005b82ca | = "none" | s_none_00652df5 = none
    LEA EDI,[EBX + 0x3b8]               ; 005b82cf
    PUSH EDI                            ; 005b82d5
    MOV AL,byte ptr [ESI]               ; 005b82d6 | = "none" | s_none_00652df5 = none
        ;   Label: LAB_005b82d6
    MOV byte ptr [EDI],AL               ; 005b82d8
    CMP AL,0x0                          ; 005b82da
    JZ 0x005b82ee                       ; 005b82dc | LAB_005b82ee
        ;   XREF to: 005b82ee (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 005b82de | s_one_00652df6
    ADD ESI,0x2                         ; 005b82e1
    MOV byte ptr [EDI + 0x1],AL         ; 005b82e4
    ADD EDI,0x2                         ; 005b82e7
    CMP AL,0x0                          ; 005b82ea
    JNZ 0x005b82d6                      ; 005b82ec | LAB_005b82d6
        ;   XREF to: 005b82d6 (CONDITIONAL_JUMP)
    POP EDI                             ; 005b82ee
        ;   Label: LAB_005b82ee
    MOV ESI,0x652dfa                    ; 005b82ef | = "none" | s_none_00652dfa = none
    LEA EDI,[EBX + 0x41c]               ; 005b82f4
    PUSH EDI                            ; 005b82fa
    MOV AL,byte ptr [ESI]               ; 005b82fb | = "none" | s_none_00652dfa = none
        ;   Label: LAB_005b82fb
    MOV byte ptr [EDI],AL               ; 005b82fd
    CMP AL,0x0                          ; 005b82ff
    JZ 0x005b8313                       ; 005b8301 | LAB_005b8313
        ;   XREF to: 005b8313 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 005b8303 | s_one_00652dfb
    ADD ESI,0x2                         ; 005b8306
    MOV byte ptr [EDI + 0x1],AL         ; 005b8309
    ADD EDI,0x2                         ; 005b830c
    CMP AL,0x0                          ; 005b830f
    JNZ 0x005b82fb                      ; 005b8311 | LAB_005b82fb
