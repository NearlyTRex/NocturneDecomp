...
;                               FUNCTION
; *****************************************************************************
; __cdecl CFilterFx * core_dfilter.cpp_CFilterFX_dtor_FUN_004706e0(CFilterFx * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004706e5
    CALL core_dfilter.cpp_CFilterFX_free_FUN_00470700 ; 004706e6 | void core_dfilter.cpp_CFilterFX_free_FUN_00470700(CFilterFx * this_ptr)
