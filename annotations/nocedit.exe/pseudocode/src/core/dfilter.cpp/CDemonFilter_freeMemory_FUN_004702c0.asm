...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_dfilter_cpp_CDemonFilter_freeMemory_FUN_004702c0(CDemonFilter *this_ptr)
;
; Parameters:
...
section .text
    ...
    JNZ 0x004702ce                      ; 004702ca
        ;   XREF to: 004702ce (CONDITIONAL_JUMP)  ; LAB_004702ce
    POP EBX                             ; 004702cc
    RET                                 ; 004702cd
    PUSH 0x98                           ; 004702ce
        ;   Label: LAB_004702ce
    PUSH 0x61e59b                       ; 004702d3 | = "..\\core\\dfilter.cpp"
    PUSH EDX                            ; 004702d8
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 004702d9
