...
;                               FUNCTION
; *****************************************************************************
; __cdecl CDemonFilter * core_dfilter.cpp_CFilterCache_getFilter_FUN_00470060(CFilterCache * this_ptr, char * filter_name, char * filter_filename, int enable_init)
;
; Parameters:
...
section .text
    ...
    JLE 0x00470094                      ; 0047006e | LAB_00470094
    ...
    CMP AL,0x0                          ; 004700c0
    JZ 0x004700d4                       ; 004700c2 | LAB_004700d4
    ...
    CMP AL,0x0                          ; 004700d0
    JNZ 0x004700bc                      ; 004700d2 | LAB_004700bc
        ;   XREF to: 004700bc (CONDITIONAL_JUMP)
    POP EDI                             ; 004700d4
        ;   Label: LAB_004700d4
    PUSH 0x58                           ; 004700d5
    PUSH 0x61e4f1                       ; 004700d7 | = "..\\core\\dfilter.cpp" | s_core_dfilter_cpp_0061e4f1 = ..\core\dfilter.cpp
    PUSH 0x4c                           ; 004700dc
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1b0 ; 004700de | void * shape_memdbg.cpp_debugAlloc_FUN_0050f1b0(int size, char * filename, int line_number)
        ;   XREF to: 0050f1b0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004700e3
    TEST EAX,EAX                        ; 004700e6
    JZ 0x004700f3                       ; 004700e8 | LAB_004700f3
        ;   XREF to: 004700f3 (CONDITIONAL_JUMP)
    PUSH EAX                            ; 004700ea
    CALL core_dfilter.cpp_CDemonFilter_ctor_FUN_004701f0 ; 004700eb | CDemonFilter * core_dfilter.cpp_CDemonFilter_ctor_FUN_004701f0(CDemonFilter * this_ptr)
    ...
    JNZ 0x00470123                      ; 004700fe | LAB_00470123
        ;   XREF to: 00470123 (CONDITIONAL_JUMP)
    MOV ESI,0x61e505                    ; 00470100 | = "..\\core\\dfilter.cpp" | s_core_dfilter_cpp_0061e505 = ..\core\dfilter.cpp
    MOV EDI,0x59                        ; 00470105
    PUSH 0x61e519                       ; 0047010a | = "CFilterCache::getFilter - Out of memory" | s_CFilterCache_getFilter_O_0061e519 = CFilterCache::getFilter - Out of memory
    MOV dword ptr [0x02f0ca48],ESI      ; 0047010f | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 00470115 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0047011b | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    PUSH EDX                            ; 00470137
    CALL core_dfilter.cpp_CDemonFilter_load_FUN_004702f0 ; 00470138 | void core_dfilter.cpp_CDemonFilter_load_FUN_004702f0(CDemonFilter * this_ptr, char * filename)
        ;   XREF to: 004702f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0047013d
    CMP dword ptr [ESP + 0x1c],0x0      ; 00470140
    JZ 0x0047015d                       ; 00470145 | LAB_0047015d
        ;   XREF to: 0047015d (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 00470147
    MOV EDI,dword ptr [ESI + 0xa04]     ; 00470149
    PUSH 0x3faa9fbe                     ; 0047014f
    PUSH EDI                            ; 00470154
    CALL core_dfilter.cpp_CDemonFilter_init_FUN_004705a0 ; 00470155 | void core_dfilter.cpp_CDemonFilter_init_FUN_004705a0(CDemonFilter * this_ptr, float init_value, int flags)
    ...
    POP EBX                             ; 00470177
    RET                                 ; 00470178
    MOV EDI,0x61e4b2                    ; 00470179 | = "..\\core\\dfilter.cpp" | s_core_dfilter_cpp_0061e4b2 = ..\core\dfilter.cpp
        ;   Label: LAB_00470179
    MOV EAX,0x55                        ; 0047017e
    PUSH 0x61e4c6                       ; 00470183 | = "CFilterCache::getFilter - Too many fi..." | s_CFilterCache_getFilter_T_0061e4c6 = CFilterCache::getFilter - Too many filters
    MOV dword ptr [0x02f0ca48],EDI      ; 00470188 | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 0047018e | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00470193 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00470198
    JMP 0x0047009f                      ; 0047019b | LAB_0047009f
