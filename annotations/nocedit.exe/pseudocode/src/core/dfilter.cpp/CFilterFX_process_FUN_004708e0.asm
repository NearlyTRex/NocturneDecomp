...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_dfilter_cpp_CFilterFX_process_FUN_004708e0(CFilterFx *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH 0x61e84e                       ; 004708e9 | = "movscrn.raw"
    MOV EDX,dword ptr [0x0066efcc]      ; 004708ee | g_CFilterCacheInstance | g_CFilterCachePtr
    PUSH EDX                            ; 004708f4 | g_CFilterCacheInstance
    CALL core_dfilter.cpp_CFilterCache_findFilter_FUN_004701a0 ; 004708f5
    ...
    JZ 0x0047096b                       ; 00470901
        ;   XREF to: 0047096b (CONDITIONAL_JUMP)  ; LAB_0047096b
    CMP dword ptr [EBX + 0x4],0x0       ; 00470903
    JZ 0x0047096b                       ; 00470907
        ;   XREF to: 0047096b (CONDITIONAL_JUMP)  ; LAB_0047096b
    PUSH ESI                            ; 00470909
    MOV ESI,dword ptr [0x0067b654]      ; 0047090a | g_CGamePtr
    FLD float ptr [ESI + 0x264]         ; 00470910 | g_CGameInstance.delta_time_float
    FMUL double ptr [0x0061e85e]        ; 00470916 | g_MovieFrameRateMultiplier
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 0047093c
