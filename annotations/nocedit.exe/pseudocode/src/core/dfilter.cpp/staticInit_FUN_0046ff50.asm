...
section .text
    ...
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 0046ff5c
        ;   XREF to: 005fe667 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
    ADD ESP,0xc                         ; 0046ff61
    PUSH 0x66ef5c                       ; 0046ff64 | DAT_0066ef5c
    CALL crt_stdlib.c_atexit_FUN_005ff060 ; 0046ff69
    ...
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 0046ff7d
        ;   XREF to: 005fe667 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
    ADD ESP,0xc                         ; 0046ff82
    PUSH 0x66ef6c                       ; 0046ff85 | DAT_0066ef6c
    CALL crt_stdlib.c_atexit_FUN_005ff060 ; 0046ff8a
        ;   XREF to: 005ff060 (UNCONDITIONAL_CALL)  ; void crt_stdlib.c_atexit_FUN_005ff060(WatcomStaticDestructorNode * exit_node)
    ...
    CALL crt_stdlib.c_atexit_FUN_005ff060 ; 0046ffa4
        ;   XREF to: 005ff060 (UNCONDITIONAL_CALL)  ; void crt_stdlib.c_atexit_FUN_005ff060(WatcomStaticDestructorNode * exit_node)
    ...
    CALL crt_stdlib.c_atexit_FUN_005ff060 ; 0046ffbe
        ;   XREF to: 005ff060 (UNCONDITIONAL_CALL)  ; void crt_stdlib.c_atexit_FUN_005ff060(WatcomStaticDestructorNode * exit_node)
