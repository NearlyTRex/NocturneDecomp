...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_boxactor_cpp_CLightActor_propertyDisplayTypeCallback_FUN_00423310(CLightActor *this_ptr,CActorProperty *property,char *output_buffer)
;
; Parameters:
...
section .text
    ...
    PUSH ESI                            ; 00423310
        ;   Label: core_boxactor.cpp_CLightActor_propertyDisplayTypeCallback_FUN_00423310
    PUSH EDI                            ; 00423311
