...
// Convention: __cdecl
// Signature: void core_boxactor.cpp_CLightActor_setup_FUN_00422a20(CLightActor * this_ptr)
...

{
  ...
  core_dlight_cpp_CDemonLight_init_FUN_004727c0((CDemonLight *)(this_ptr->unk + 4));
  return;
}
