...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_boxactor.cpp_CBoxActor_FUN_004224f0(CBoxActor * this_ptr)
;
; Parameters:
