...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_boxactor_cpp_CLightActor_serialize_FUN_00422c80(CLightActor *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00422c80
        ;   Label: core_boxactor.cpp_CLightActor_serialize_FUN_00422c80
    PUSH ESI                            ; 00422c81
    SUB ESP,0x4                         ; 00422c82
    MOV EBX,dword ptr [ESP + 0x10]      ; 00422c85
    PUSH EBX                            ; 00422c89
    CALL core_boxactor.cpp_CBoxActor_serialize_FUN_00422060 ; 00422c8a
    ...
    PUSH EAX                            ; 00422c9d
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 00422c9e
    ...
    PUSH EAX                            ; 00422cbb
    CALL core_actor.cpp_serializeVector_FUN_0040b340 ; 00422cbc
    ...
    CALL core_actor.cpp_serializeOrientation_FUN_0040b3e0 ; 00422cd6
    ...
    PUSH EAX                            ; 00422cf2
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 00422cf3
    ...
    PUSH EAX                            ; 00422d0c
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 00422d0d
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 00422d36
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH EBX                            ; 00422d4b
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 00422d4c
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
