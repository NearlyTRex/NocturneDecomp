...
section .text
    ...
    PUSH EDX                            ; 004228e4
    CALL core_actor.cpp_CDemonActor_processInEditor_FUN_0040d040 ; 004228e5 | void core_actor.cpp_CDemonActor_processInEditor_FUN_0040d040(CDemonActor * this_ptr)
        ;   XREF to: 0040d040 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004228ea
    MOV ECX,dword ptr [ESP + 0x4]       ; 004228ed
    PUSH ECX                            ; 004228f1
    CALL core_boxactor.cpp_FUN_004218d0 ; 004228f2 | undefined core_boxactor.cpp_FUN_004218d0()
