...
// Convention: __cdecl
// Signature: void __cdecl core_boxactor_cpp_CBoxActor_FUN_00422390(CBoxActor *this_ptr,CVector3f *param_2,CVector3f *param_3)
...

{
  ...
  core_actor_cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(&this_ptr->base,&local_48,param_2);
  core_actor_cpp_CDemonActor_inverseTransformVector_FUN_00408ea0(&this_ptr->base,&local_24,param_3);
  if (local_24.z * local_48.z + local_24.x * local_48.x + local_24.y * local_48.y < 0.0) {
    ...
    if ((0.0 <= fStack_14) && (fStack_14 < 1.0)) {
      ...
      fStack_30 = param_3->x * fStack_18;
      fStack_2c = param_3->y * fStack_18;
      fStack_28 = param_3->z * fStack_18;
