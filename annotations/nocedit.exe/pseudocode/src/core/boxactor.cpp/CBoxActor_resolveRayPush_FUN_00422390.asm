...
;   core_boxactor.cpp_CBoxActor_constrainToExtents_FUN_00422590
...
section .text
    ...
    PUSH EBX                            ; 00422390
        ;   Label: core_boxactor.cpp_CBoxActor_resolveRayPush_FUN_00422390
    PUSH ESI                            ; 00422391
    PUSH EBP                            ; 00422392
    ...
    CALL core_boxactor.cpp_CBoxActor_setupPhysicsBox_FUN_004218d0 ; 0042248f
    ...
    PUSH EBX                            ; 00422497
    CALL core_boxactor.cpp_CBoxActor_constrainToExtents_FUN_00422590 ; 00422498
        ;   XREF to: 00422590 (UNCONDITIONAL_CALL)  ; void core_boxactor.cpp_CBoxActor_constrainToExtents_FUN_00422590(CBoxActor * this_ptr)
