...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_boxactor_cpp_CBoxActor_renderTransparent_FUN_00421ef0(CBoxActor *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00421ef0
        ;   Label: core_boxactor.cpp_CBoxActor_renderTransparent_FUN_00421ef0
    PUSH EBP                            ; 00421ef1
    SUB ESP,0x18                        ; 00421ef2
    MOV EBX,dword ptr [ESP + 0x24]      ; 00421ef5
    LEA EAX,[EBX + 0x158]               ; 00421ef9
    PUSH EAX                            ; 00421eff
    CALL core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80 ; 00421f00
        ;   XREF to: 00478d80 (UNCONDITIONAL_CALL)  ; CKeyFramedModel * core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80(CKeyFramedModelInstance * this_ptr)
    MOV EDX,dword ptr [EAX + 0x110]     ; 00421f05
    ADD ESP,0x4                         ; 00421f0b
    CMP EDX,0x1                         ; 00421f0e
    JGE 0x00421f1b                      ; 00421f11
        ;   XREF to: 00421f1b (CONDITIONAL_JUMP)  ; LAB_00421f1b
    ...
    PUSH EAX                            ; 00421f20
    MOV ECX,dword ptr [0x006703e8]      ; 00421f21 | g_CDemonRendererPtr1
    PUSH ECX                            ; 00421f27 | g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450 ; 00421f28
        ;   XREF to: 0048c450 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450(CDemonRenderer * this_ptr, CVector3f * world_position)
    ADD ESP,0x8                         ; 00421f2d
    PUSH 0x0                            ; 00421f30
    LEA EAX,[EBX + 0x30]                ; 00421f32
    PUSH EAX                            ; 00421f35
    MOV ESI,dword ptr [0x006703e8]      ; 00421f36 | g_CDemonRendererPtr1
    PUSH ESI                            ; 00421f3c | g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_applyScaledTransform_FUN_0048c4f0 ; 00421f3d
    ...
    PUSH EAX                            ; 00421f57
    CALL core_box.cpp_CBoundingBox3D_isVisible_FUN_004204f0 ; 00421f58
        ;   XREF to: 004204f0 (UNCONDITIONAL_CALL)  ; int core_box.cpp_CBoundingBox3D_isVisible_FUN_004204f0(CBoundingBox3D * this_ptr)
    ADD ESP,0x4                         ; 00421f5d
    PUSH 0xffff                         ; 00421f60
    MOV EDI,dword ptr [0x006703ec]      ; 00421f65 | g_CDemonRendererPtr2
    ...
    JZ 0x00421faa                       ; 00421f91
        ;   XREF to: 00421faa (CONDITIONAL_JUMP)  ; LAB_00421faa
    PUSH -0x1                           ; 00421f93
    LEA EAX,[EBX + 0x158]               ; 00421f95
    PUSH dword ptr [EBX + 0x310]        ; 00421f9b
    PUSH EAX                            ; 00421fa1
    CALL core_dmodel.cpp_CKeyFramedModelInstance_prepareForRendering_FUN_00478d20 ; 00421fa2
    ...
    CALL engine_drender.cpp_CDemonRenderer_matrixPop_FUN_0050d720 ; 00421fc9
