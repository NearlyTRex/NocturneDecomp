...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_boxactor.cpp_FUN_004224b0()
;
;
; Referenced Globals:
...
section .text
    ...
    JNZ 0x004224c8                      ; 004224bb | LAB_004224c8
        ;   XREF to: 004224c8 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x4]       ; 004224bd
        ;   Label: LAB_004224bd
    MOV EAX,dword ptr [EAX + 0x314]     ; 004224c1
    RET                                 ; 004224c7
    PUSH 0x61679f                       ; 004224c8 | = "CHero" | s_CHero_0061679f = CHero
        ;   Label: LAB_004224c8
    MOV ECX,dword ptr [ESP + 0xc]       ; 004224cd
    PUSH ECX                            ; 004224d1
    CALL core_actor.cpp_isOfClass_FUN_0040c6d0 ; 004224d2 | int core_actor.cpp_isOfClass_FUN_0040c6d0(CDemonActor * actor_ptr, char * class_name)
        ;   XREF to: 0040c6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004224d7
    TEST EAX,EAX                        ; 004224da
    JNZ 0x004224bd                      ; 004224dc | LAB_004224bd
