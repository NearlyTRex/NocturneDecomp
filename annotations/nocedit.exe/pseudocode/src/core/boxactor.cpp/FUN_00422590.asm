...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_boxactor.cpp_FUN_00422590()
;
; Local Variables:
...
;
; XREF[1]:
;   core_boxactor.cpp_FUN_00422390 at 00422498
;
; Called Functions:
...
section .text
    ...
    JNZ 0x004225a7                      ; 004225a0 | LAB_004225a7
    ...
    PUSH EAX                            ; 004225af
    PUSH EDX                            ; 004225b0
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 004225b1 | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
    ...
    PUSH EAX                            ; 004225db
    CALL core_box.cpp_CBoundingBox3D_clampPoint_FUN_00421550 ; 004225dc | CVector3f * core_box.cpp_CBoundingBox3D_clampPoint_FUN_00421550(CBoundingBox3D * this_ptr, CVector3f * out_point, CVector3f * in_point)
        ;   XREF to: 00421550 (UNCONDITIONAL_CALL)
    MOV EDX,EAX                         ; 004225e1
    LEA EAX,[ESP + 0x30]                ; 004225e3
    ADD ESP,0xc                         ; 004225e7
    CMP EAX,EDX                         ; 004225ea
    JZ 0x00422602                       ; 004225ec | LAB_00422602
    ...
    PUSH ESI                            ; 00422613
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 00422614 | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
