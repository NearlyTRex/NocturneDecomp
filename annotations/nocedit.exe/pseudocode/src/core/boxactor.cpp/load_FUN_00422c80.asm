...
section .text
    ...
    PUSH EBX                            ; 00422c89
    CALL core_boxactor.cpp_CBoxActor_load_FUN_00422060 ; 00422c8a
        ;   XREF to: 00422060 (UNCONDITIONAL_CALL)  ; undefined core_boxactor.cpp_CBoxActor_load_FUN_00422060()
