...
section .text
    ...
    PUSH 0x821ff8                       ; 00421650 | g_CDemonActorClassInfo
        ;   Label: core_boxactor.cpp_staticInit_FUN_00421650
    PUSH 0xf                            ; 00421655
    PUSH 0x66e604                       ; 00421657 | g_CBoxActorClassVersion
    PUSH 0x4216c0                       ; 0042165c
    PUSH 0x6165ff                       ; 00421661 | = "CBoxActor"
    PUSH 0x8229b0                       ; 00421666 | g_CBoxActorClassInfo
    CALL core_actor.cpp_registerActorClass_FUN_0040c2e0 ; 0042166b
        ;   XREF to: 0040c2e0 (UNCONDITIONAL_CALL)  ; CDemonActorType * core_actor.cpp_registerActorClass_FUN_0040c2e0(CDemonActorType * this_ptr, char * class_name, CDemonActor_FactoryFunc * factor_func, int * max_version, ...)
    ADD ESP,0x18                        ; 00421670
    PUSH 0x65b390                       ; 00421673 | g_CDemonFilterTypeInfo
    PUSH 0x8                            ; 00421678
    PUSH 0x8229ec                       ; 0042167a | CDemonFilter_ARRAY_008229ec
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 0042167f
        ;   XREF to: 005fe667 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
    ADD ESP,0xc                         ; 00421684
    PUSH 0x66e5cc                       ; 00421687 | DAT_0066e5cc
    CALL crt_stdlib.c_atexit_FUN_005ff060 ; 0042168c
    ...
    PUSH 0x8229b0                       ; 00421694 | g_CBoxActorClassInfo
    PUSH 0x2                            ; 00421699
    PUSH 0x66e608                       ; 0042169b | g_CLightActorClassVersion
    PUSH 0x422950                       ; 004216a0
    PUSH 0x616609                       ; 004216a5 | = "CLightActor"
    PUSH 0x822c4c                       ; 004216aa | g_CLightActorClassInfo
    CALL core_actor.cpp_registerActorClass_FUN_0040c2e0 ; 004216af
        ;   XREF to: 0040c2e0 (UNCONDITIONAL_CALL)  ; CDemonActorType * core_actor.cpp_registerActorClass_FUN_0040c2e0(CDemonActorType * this_ptr, char * class_name, CDemonActor_FactoryFunc * factor_func, int * max_version, ...)
