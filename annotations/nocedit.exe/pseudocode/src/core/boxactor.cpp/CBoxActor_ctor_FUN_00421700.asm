...
;   core_boxactor.cpp_FUN_004216c0 at 004216da
...
section .text
    ...
    PUSH EBX                            ; 00421705
    CALL core_actor.cpp_CDemonActor_ctor_FUN_004088b0 ; 00421706 | CDemonActor * core_actor.cpp_CDemonActor_ctor_FUN_004088b0(CDemonActor * this_ptr)
        ;   XREF to: 004088b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0042170b
    ADD EAX,0x158                       ; 0042170e
    PUSH EAX                            ; 00421713
    CALL core_dmodel.cpp_CKeyFramedModelInstance_ctor_FUN_00478ce0 ; 00421714 | CKeyFramedModelInstance * core_dmodel.cpp_CKeyFramedModelInstance_ctor_FUN_00478ce0(CKeyFramedModelInstance * this_ptr)
        ;   XREF to: 00478ce0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00421719
    ADD EAX,0x23c                       ; 0042171c
    PUSH EAX                            ; 00421721
    CALL core_box.cpp_CBox_ctor_FUN_0041dc50 ; 00421722 | CBox * core_box.cpp_CBox_ctor_FUN_0041dc50(CBox * this_ptr)
        ;   XREF to: 0041dc50 (UNCONDITIONAL_CALL)
    LEA EBX,[EAX + 0xfffffc6c]          ; 00421727
    MOV dword ptr [EBX + 0x154],0x65b1b4 ; 0042172d | CDemonActor_vtable g_CBoxActorVTable
    ...
    PUSH 0x616630                       ; 004217b0 | = "question.kfm" | s_question_kfm_00616630 = question.kfm
    ...
    CALL core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0 ; 004217d7 | void core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0(CKeyFramedModelInstance * this_ptr, char * filename)
