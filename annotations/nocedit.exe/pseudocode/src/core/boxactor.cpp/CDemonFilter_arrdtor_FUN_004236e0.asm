...
;                               FUNCTION
; *****************************************************************************
; __cdecl CDemonFilter * __cdecl core_boxactor_cpp_CDemonFilter_arrdtor_FUN_004236e0(CDemonFilter *objs,uint flags)
;
; Parameters:
...
section .text
    ...
    PUSH 0x65b390                       ; 004236e0 | g_CDemonFilterTypeInfo
        ;   Label: core_boxactor.cpp_CDemonFilter_arrdtor_FUN_004236e0
    PUSH 0x8                            ; 004236e5
