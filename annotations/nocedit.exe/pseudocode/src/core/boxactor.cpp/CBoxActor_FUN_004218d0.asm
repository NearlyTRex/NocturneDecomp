...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_boxactor_cpp_CBoxActor_FUN_004218d0(CBoxActor *this_ptr)
;
; Parameters:
; CBoxActor *      Stack[0x4]:4   this_ptr
;
; XREF[4]:
;   core_boxactor.cpp_CBoxActor_FUN_00422390 at 0042248f
...
section .text
    ...
    PUSH EBX                            ; 004218d0
        ;   Label: core_boxactor.cpp_CBoxActor_FUN_004218d0
