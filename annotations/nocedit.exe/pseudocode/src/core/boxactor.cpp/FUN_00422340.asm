...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_boxactor.cpp_FUN_00422340()
;
;
; Called Functions:
...
section .text
    ...
    JZ 0x00422357                       ; 0042234c | LAB_00422357
        ;   XREF to: 00422357 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x318],0x0     ; 0042234e
    JZ 0x0042235b                       ; 00422355 | LAB_0042235b
    ...
    PUSH EAX                            ; 00422362
    CALL core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80 ; 00422363 | CKeyFramedModel * core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80(CKeyFramedModelInstance * this_ptr)
        ;   XREF to: 00478d80 (UNCONDITIONAL_CALL)
    MOV ESI,dword ptr [EAX + 0x5698]    ; 00422368
    ADD ESP,0x4                         ; 0042236e
    TEST ESI,ESI                        ; 00422371
    JZ 0x00422382                       ; 00422373 | LAB_00422382
