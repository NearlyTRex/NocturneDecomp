...
section .text
    ...
    PUSH 0x0                            ; 00423592
    PUSH 0x616a47                       ; 00423594 | = "Select type of light to fill in initi..." | s_Select_type_of_light_to__00616a47 = Select type of light to fill in initial properties.  (You can manually adjust later).
    CALL core_boxactor.cpp_FUN_00423110 ; 00423599 | undefined core_boxactor.cpp_FUN_00423110()
        ;   XREF to: 00423110 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0042359e
    TEST EAX,EAX                        ; 004235a1
    JL 0x004235b5                       ; 004235a3 | LAB_004235b5
