...
section .text
    ...
    PUSH EAX                            ; 00422994
    CALL core_boxactor.cpp_CBoxActor_ctor_FUN_00421700 ; 00422995 | CBoxActor * core_boxactor.cpp_CBoxActor_ctor_FUN_00421700(CBoxActor * this_ptr)
    ...
    PUSH EAX                            ; 004229ac
    CALL core_dlight.cpp_CDemonLight_ctor_FUN_004726a0 ; 004229ad | CDemonLight * core_dlight.cpp_CDemonLight_ctor_FUN_004726a0(CDemonLight * this_ptr)
        ;   XREF to: 004726a0 (UNCONDITIONAL_CALL)
    SUB EAX,0x670                       ; 004229b2
    MOV dword ptr [EAX + 0x154],0x65b2a4 ; 004229b7 | CDemonActor_vtable PTR_core_box.cpp_FUN_0065b2a4
