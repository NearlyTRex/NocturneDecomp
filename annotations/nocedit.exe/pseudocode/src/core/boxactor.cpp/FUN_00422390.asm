...
section .text
    ...
    PUSH EAX                            ; 004223a9
    PUSH EBX                            ; 004223aa
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 004223ab | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
    ...
    PUSH EAX                            ; 004223b8
    PUSH EBX                            ; 004223b9
    CALL core_actor.cpp_CDemonActor_inverseTransformVector_FUN_00408ea0 ; 004223ba | CVector3f * core_actor.cpp_CDemonActor_inverseTransformVector_FUN_00408ea0(CDemonActor * this_ptr, CVector3f * output_vector, CVector3f * input_vector)
    ...
    FNSTSW AX                           ; 004223e2
    SAHF                                ; 004223e4
    JA 0x004223ed                       ; 004223e5 | LAB_004223ed
    ...
    PUSH EAX                            ; 00422412
    CALL core_box.cpp_CBoundingBox3D_doesRayIntersect_FUN_00420940 ; 00422413 | float core_box.cpp_CBoundingBox3D_doesRayIntersect_FUN_00420940(CBoundingBox3D * this_ptr, CVector3f * ray_origin, CVector3f * ray_direction, CVector3f * out_normal)
    ...
    FNSTSW AX                           ; 0042242d
    SAHF                                ; 0042242f
    JA 0x004223e7                       ; 00422430 | LAB_004223e7
        ;   XREF to: 004223e7 (CONDITIONAL_JUMP)
    FLD1                                ; 00422432
    FCOMP double ptr [ESP]              ; 00422434
    FNSTSW AX                           ; 00422437
    SAHF                                ; 00422439
    JBE 0x004223e7                      ; 0042243a | LAB_004223e7
        ;   XREF to: 004223e7 (CONDITIONAL_JUMP)
    FLD double ptr [0x00616797]         ; 0042243c | double DOUBLE_00616797
    ...
    CALL core_boxactor.cpp_FUN_004218d0 ; 0042248f | undefined core_boxactor.cpp_FUN_004218d0()
        ;   XREF to: 004218d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00422494
    PUSH EBX                            ; 00422497
    CALL core_boxactor.cpp_FUN_00422590 ; 00422498 | undefined core_boxactor.cpp_FUN_00422590()
