...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_boxactor_cpp_CBoxActor_hasCollision_FUN_00422340(CBoxActor *this_ptr,SCollisionInfo *collision_info)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00422340
        ;   Label: core_boxactor.cpp_CBoxActor_hasCollision_FUN_00422340
