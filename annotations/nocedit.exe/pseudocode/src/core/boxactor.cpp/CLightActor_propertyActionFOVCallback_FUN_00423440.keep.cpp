...

{
  ...
  local_10 = (pCVar1->light).base.base.focal_length;
  _sprintf(local_13c,"Enter FOV (mm) for CLightActor %s",this_ptr->base.base.actor_name);
  ...
  (pCVar1->light).base.base.focal_length = local_10;
  return 1;
}
