// Name: core_boxactor.cpp_CBoxActor_serialize_FUN_00422060
// Address: 00422060
...

{
  ...
  ;
  core_actor_cpp_serializeFloat_FUN_0040b770(&this_ptr->weight_in_pounds,"weightInPounds");
  core_actor_cpp_serializeFloat_FUN_0040b770(&this_ptr->fps,"fps");
  core_actor_cpp_serializeVector_FUN_0040b340(&this_ptr->rpm,"rpm");
  core_actor_cpp_serializeString_FUN_0040b5c0
            ((char **)this_ptr->loop_wav_name,"loopWavName");
  core_actor_cpp_serializeString_FUN_0040b5c0
            ((char **)this_ptr->collision_wav_name,"collisionWavName");
  if (g_CBoxActorClassVersion < 7) {
    ...
    core_actor_cpp_serializeInteger_FUN_0040b7f0(&this_ptr->pickup_type,"pickupType");
  }
  core_actor_cpp_serializeActor_FUN_0040b870
            ((CDemonActor *)&this_ptr->carrier_actor,"carriedByActor");
  if (1 < g_CBoxActorClassVersion) {
    core_actor_cpp_serializeInteger_FUN_0040b7f0(&this_ptr->can_be_pushed,"canBePushed");
    core_actor_cpp_serializeActor_FUN_0040b870
  ...
  if (g_CBoxActorClassVersion < 4) {
    ...
    core_actor_cpp_serializeSimBox_FUN_0040bd70((CSimBox *)&this_ptr->sim_box,"simBox");
  }
  ...
  if (g_CBoxActorClassVersion < 6) {
    ...
    core_actor_cpp_serializeInteger_FUN_0040b7f0(&this_ptr->collision_flag,"collisionFlag")
    ;
  }
  ...
  if (0xb < g_CBoxActorClassVersion) {
    core_actor_cpp_serializeString_FUN_0040b5c0((char **)this_ptr->use_event,"useEvent");
  }
  ...
  if (0xd < g_CBoxActorClassVersion) {
    core_actor_cpp_serializeString_FUN_0040b5c0((char **)this_ptr->push_sound,"pushSound");
  }
