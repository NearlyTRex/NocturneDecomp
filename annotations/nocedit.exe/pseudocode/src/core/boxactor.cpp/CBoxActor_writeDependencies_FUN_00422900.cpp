...
// Convention: __cdecl
// Signature: void __cdecl core_boxactor_cpp_CBoxActor_writeDependencies_FUN_00422900(CBoxActor *this_ptr,_FILE *file_handle)

#include "nocturne.h"

void __cdecl
core_boxactor_cpp_CBoxActor_writeDependencies_FUN_00422900(CBoxActor *this_ptr,_FILE *file_handle)
