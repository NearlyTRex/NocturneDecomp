...
section .text
    ...
    PUSH ECX                            ; 0042340c
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 0042340d | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00423412
    SUB ESP,0x8                         ; 00423415
    FLD float ptr [EAX + 0x6a8]         ; 00423418
    FSTP double ptr [ESP]               ; 0042341e
    PUSH 0x6169d8                       ; 00423421 | = "%g mm" | s_g_mm_006169d8 = %g mm
    MOV EBX,dword ptr [ESP + 0x1c]      ; 00423426
    PUSH EBX                            ; 0042342a
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0042342b | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
