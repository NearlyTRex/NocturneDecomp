...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_boxactor_cpp_CLightActor_propertyActionTypeCallback_FUN_00423380(CLightActor *this_ptr,CActorProperty *property)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00423380
        ;   Label: core_boxactor.cpp_CLightActor_propertyActionTypeCallback_FUN_00423380
    PUSH ESI                            ; 00423381
    PUSH EDI                            ; 00423382
