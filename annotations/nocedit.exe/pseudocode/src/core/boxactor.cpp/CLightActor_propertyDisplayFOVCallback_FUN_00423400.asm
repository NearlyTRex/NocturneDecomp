...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_boxactor_cpp_CLightActor_propertyDisplayFOVCallback_FUN_00423400 (CLightActor *this_ptr,CActorProperty *property,char *output_buffer)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00423400
        ;   Label: core_boxactor.cpp_CLightActor_propertyDisplayFOVCallback_FUN_00423400
    ...
    PUSH EBX                            ; 0042342a
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 0042342b
