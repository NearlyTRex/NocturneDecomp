...
section .text
    ...
    PUSH EBX                            ; 00422a25
    CALL core_boxactor.cpp_FUN_00422d60 ; 00422a26 | undefined core_boxactor.cpp_FUN_00422d60()
        ;   XREF to: 00422d60 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00422a2b
    PUSH EBX                            ; 00422a2e
    CALL core_boxactor.cpp_FUN_00421830 ; 00422a2f | undefined core_boxactor.cpp_FUN_00421830()
        ;   XREF to: 00421830 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00422a34
    LEA EAX,[EBX + 0x670]               ; 00422a37
    PUSH EAX                            ; 00422a3d
    CALL core_dlight.cpp_CDemonLight_init_FUN_004727c0 ; 00422a3e | void core_dlight.cpp_CDemonLight_init_FUN_004727c0(CDemonLight * this_ptr)
