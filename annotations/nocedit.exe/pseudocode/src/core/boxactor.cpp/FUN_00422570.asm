...
section .text
    ...
    PUSH ECX                            ; 00422579
    CALL core_actor.cpp_CDemonActor_onPickup_FUN_0040a010 ; 0042257a | void core_actor.cpp_CDemonActor_onPickup_FUN_0040a010(CDemonActor * this_ptr, CDemonActor * owner)
