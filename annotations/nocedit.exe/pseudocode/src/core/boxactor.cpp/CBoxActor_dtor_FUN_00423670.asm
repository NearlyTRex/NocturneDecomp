...
;                               FUNCTION
; *****************************************************************************
; __cdecl CBoxActor * __cdecl core_boxactor_cpp_CBoxActor_dtor_FUN_00423670(CBoxActor *this_ptr,uint flags)
;
; Parameters:
...
section .text
    ...
    PUSH 0x65b3d0                       ; 004236ad | g_CBoxActorTypeInfo
        ;   Label: LAB_004236ad
    PUSH EBX                            ; 004236b2
    CALL crt_memory.c___vec_delete_FUN_005fe632 ; 004236b3
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c___vec_delete_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 004236b8
    PUSH EAX                            ; 004236bb
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 004236bc
