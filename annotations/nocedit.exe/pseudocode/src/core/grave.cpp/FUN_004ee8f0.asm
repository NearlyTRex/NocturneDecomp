...
section .text
    ...
    MOV EDX,dword ptr [0x0067d550]      ; 004ee8fd | CDemonMission g_CDemonMissionInstance | CDemonMission * g_CDemonMissionPtr
    MOV ESI,dword ptr [EDX + 0x4]       ; 004ee903 | DAT_02f33744
    LEA EAX,[ECX + 0x158]               ; 004ee906
    TEST ESI,ESI                        ; 004ee90c
    JZ 0x004ee95a                       ; 004ee90e | LAB_004ee95a
        ;   XREF to: 004ee95a (CONDITIONAL_JUMP)
    PUSH EAX                            ; 004ee910
    CALL core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80 ; 004ee911 | CKeyFramedModel * core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80(CKeyFramedModelInstance * this_ptr)
    ...
    JZ 0x004ee936                       ; 004ee924 | LAB_004ee936
    ...
    JNZ 0x004ee948                      ; 004ee93e | LAB_004ee948
    ...
    JMP 0x004ee940                      ; 004ee958 | LAB_004ee940
        ;   XREF to: 004ee940 (UNCONDITIONAL_JUMP)
    FLD float ptr [ECX + 0x2d4]         ; 004ee95a
        ;   Label: LAB_004ee95a
    CALL crt_math.c_round_FUN_005fe6b0  ; 004ee960 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    PUSH EAX                            ; 004ee965
    FISTP dword ptr [ESP + 0x4]         ; 004ee966
    CALL core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80 ; 004ee96a | CKeyFramedModel * core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80(CKeyFramedModelInstance * this_ptr)
        ;   XREF to: 00478d80 (UNCONDITIONAL_CALL)
    ...
    JZ 0x004ee9a3                       ; 004ee991 | LAB_004ee9a3
    ...
    JZ 0x004ee940                       ; 004ee9ab | LAB_004ee940
