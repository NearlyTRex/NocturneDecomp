...
section .text
    ...
    PUSH EBX                            ; 004ee9e0
        ;   Label: core_grave.cpp_CGrave_getPropertyList_FUN_004ee9e0
    PUSH ESI                            ; 004ee9e1
    ...
    PUSH ESI                            ; 004eea02
    CALL core_actor.cpp_CActorPropertyList_addModelKFM_FUN_0040e3b0 ; 004eea03
    ...
    PUSH ESI                            ; 004eea20
    CALL core_actor.cpp_CActorPropertyList_addFloatRange_FUN_0040e1a0 ; 004eea21
    ...
    PUSH ESI                            ; 004eea35
    CALL core_actor.cpp_CActorPropertyList_addBool_FUN_0040e330 ; 004eea36
    ...
    PUSH ESI                            ; 004eea4a
    CALL core_actor.cpp_CActorPropertyList_addEvent_FUN_0040e460 ; 004eea4b
    ...
    PUSH ESI                            ; 004eea5f
    CALL core_actor.cpp_CActorPropertyList_addSound_FUN_0040e2d0 ; 004eea60
