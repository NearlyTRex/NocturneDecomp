...
;                               FUNCTION
; *****************************************************************************
; __cdecl CGrave * core_grave.cpp_CGrave_dtor_FUN_004eeb40(CGrave * this_ptr, uint d1, uint d2)
;
; Parameters:
...
section .text
    ...
    PUSH 0x65f210                       ; 004eeb66 | g_CGraveTypeInfo
        ;   Label: LAB_004eeb66
    PUSH EBX                            ; 004eeb6b
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 004eeb6c
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 004eeb71
    PUSH EAX                            ; 004eeb74
    CALL crt_memory.c_free_FUN_005fe659 ; 004eeb75
