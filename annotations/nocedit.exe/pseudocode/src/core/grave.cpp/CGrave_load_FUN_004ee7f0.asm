...
section .text
    ...
    PUSH EBX                            ; 004ee7f9
    CALL core_actor.cpp_CDemonActor_serialize_FUN_0040c1c0 ; 004ee7fa
    ...
    PUSH EAX                            ; 004ee80d
    CALL core_actor.cpp_serializeKeyframedModelInstance_FUN_0040b8f0 ; 004ee80e
    ...
    PUSH EAX                            ; 004ee821
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 004ee822
    ...
    PUSH EAX                            ; 004ee840
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 004ee841
    ...
    PUSH EAX                            ; 004ee854
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 004ee855
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH EAX                            ; 004ee873
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 004ee874
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ADD ESP,0x8                         ; 004ee879
    PUSH 0x62e4c7                       ; 004ee87c | = "startCondition"
    LEA EAX,[EBX + 0x2e8]               ; 004ee881
    PUSH EAX                            ; 004ee887
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 004ee888
    ...
    PUSH EAX                            ; 004ee8a8
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 004ee8a9
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    PUSH EBX                            ; 004ee8db
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 004ee8dc
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeString_FUN_0040b5c0(char * * string_buffer, char * property_type)
