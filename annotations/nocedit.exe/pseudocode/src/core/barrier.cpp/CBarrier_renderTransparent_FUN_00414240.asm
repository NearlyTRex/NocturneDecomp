...
section .text
    ...
    CMP dword ptr [EAX + 0x4],0x0       ; 0041424e | g_CDemonMissionInstance.is_in_editor
    ...
    CALL engine_drender.cpp_CDemonRenderer_isShadowPass_FUN_0048cae0 ; 00414263
    ...
    MOV EBP,dword ptr [ESI + 0x28]      ; 004142ac | g_CDemonMissionInstance.selected_actor
    ...
    PUSH 0x40                           ; 004142c2
    PUSH EBX                            ; 004142c4
    CALL core_actor.cpp_CDemonActor_renderBoundingBoxSolid_FUN_0040dec0 ; 004142c5
