...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_barrier_cpp_CBarrier_processInEditor_FUN_00414460(CBarrier *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00414460
        ;   Label: core_barrier.cpp_CBarrier_processInEditor_FUN_00414460
    PUSH EBP                            ; 00414461
