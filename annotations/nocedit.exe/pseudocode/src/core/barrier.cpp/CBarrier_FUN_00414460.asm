...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_barrier.cpp_CBarrier_FUN_00414460(CBarrier * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH 0x1d                           ; 0041446d
    MOV EAX,[0x0067cf44]                ; 0041446f | CKeys * g_CKeysPtr
    PUSH EAX                            ; 00414474 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 00414475 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 00414477
    ADD ESP,0x8                         ; 00414479
    TEST EAX,EAX                        ; 0041447c
    JZ 0x004145fc                       ; 0041447e | LAB_004145fc
        ;   XREF to: 004145fc (CONDITIONAL_JUMP)
    MOV EAX,[0x0067b654]                ; 00414484 | CGame * g_CGamePtr
    PUSH 0x2a                           ; 00414489
    FLD float ptr [EAX + 0x264]         ; 0041448b | g_CGameInstance.delta_time_float
    MOV EAX,[0x0067cf44]                ; 00414491 | CKeys * g_CKeysPtr
    FMUL double ptr [0x006151bf]        ; 00414496 | double DOUBLE_006151bf
    PUSH EAX                            ; 0041449c | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 0041449d | void * g_CKeysPtr
    FSTP float ptr [ESP + 0x8]          ; 0041449f
    CALL dword ptr [EDX]                ; 004144a3
    ADD ESP,0x8                         ; 004144a5
    TEST EAX,EAX                        ; 004144a8
    JZ 0x004144bc                       ; 004144aa | LAB_004144bc
        ;   XREF to: 004144bc (CONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 004144ac
    FLD ST0                             ; 004144af
    FMUL double ptr [0x006151bf]        ; 004144b1 | double DOUBLE_006151bf
    FSTP ST1                            ; 004144b7
    FSTP float ptr [ESP]                ; 004144b9
    PUSH 0x38                           ; 004144bc
        ;   Label: LAB_004144bc
    MOV EAX,[0x0067cf44]                ; 004144be | CKeys * g_CKeysPtr
    PUSH EAX                            ; 004144c3 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004144c4 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 004144c6
    ADD ESP,0x8                         ; 004144c8
    TEST EAX,EAX                        ; 004144cb
    JZ 0x004144db                       ; 004144cd | LAB_004144db
        ;   XREF to: 004144db (CONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 004144cf
    FMUL double ptr [0x006151c7]        ; 004144d2 | double DOUBLE_006151c7
    FSTP float ptr [ESP]                ; 004144d8
    PUSH 0x4b                           ; 004144db
        ;   Label: LAB_004144db
    MOV EAX,[0x0067cf44]                ; 004144dd | CKeys * g_CKeysPtr
    PUSH EAX                            ; 004144e2 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004144e3 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 004144e5
    ADD ESP,0x8                         ; 004144e7
    TEST EAX,EAX                        ; 004144ea
    JZ 0x004144fd                       ; 004144ec | LAB_004144fd
    ...
    PUSH 0x4d                           ; 004144fd
        ;   Label: LAB_004144fd
    MOV EAX,[0x0067cf44]                ; 004144ff | CKeys * g_CKeysPtr
    PUSH EAX                            ; 00414504 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 00414505 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 00414507
    ADD ESP,0x8                         ; 00414509
    TEST EAX,EAX                        ; 0041450c
    JZ 0x0041451f                       ; 0041450e | LAB_0041451f
    ...
    PUSH 0x1e                           ; 0041451f
        ;   Label: LAB_0041451f
    MOV EAX,[0x0067cf44]                ; 00414521 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 00414526 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 00414527 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 00414529
    ADD ESP,0x8                         ; 0041452b
    TEST EAX,EAX                        ; 0041452e
    JZ 0x00414541                       ; 00414530 | LAB_00414541
    ...
    PUSH 0x10                           ; 00414541
        ;   Label: LAB_00414541
    MOV EAX,[0x0067cf44]                ; 00414543 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 00414548 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 00414549 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 0041454b
    ADD ESP,0x8                         ; 0041454d
    TEST EAX,EAX                        ; 00414550
    JZ 0x00414563                       ; 00414552 | LAB_00414563
    ...
    PUSH 0x50                           ; 00414563
        ;   Label: LAB_00414563
    MOV EAX,[0x0067cf44]                ; 00414565 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 0041456a | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 0041456b | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 0041456d
    ADD ESP,0x8                         ; 0041456f
    TEST EAX,EAX                        ; 00414572
    JZ 0x00414585                       ; 00414574 | LAB_00414585
    ...
    PUSH 0x48                           ; 00414585
        ;   Label: LAB_00414585
    MOV EAX,[0x0067cf44]                ; 00414587 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 0041458c | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 0041458d | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 0041458f
    ADD ESP,0x8                         ; 00414591
    TEST EAX,EAX                        ; 00414594
    JZ 0x004145a7                       ; 00414596 | LAB_004145a7
    ...
    JGE 0x004145c0                      ; 004145b8 | LAB_004145c0
    ...
    FNSTSW AX                           ; 004145ca
    SAHF                                ; 004145cc
    JNC 0x004145d9                      ; 004145cd | LAB_004145d9
    ...
    FNSTSW AX                           ; 004145e3
    SAHF                                ; 004145e5
    JC 0x004145ed                       ; 004145e6 | LAB_004145ed
    ...
    PUSH EBX                            ; 004145fc
        ;   Label: LAB_004145fc
    CALL core_actor.cpp_CDemonActor_processInEditor_FUN_0040d040 ; 004145fd | void core_actor.cpp_CDemonActor_processInEditor_FUN_0040d040(CDemonActor * this_ptr)
