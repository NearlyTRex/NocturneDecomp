...
;                               FUNCTION
; *****************************************************************************
; __cdecl CBarrier * __cdecl core_barrier_cpp_CBarrier_dtor_FUN_00414670(CBarrier *this_ptr,uint d1,uint d2)
;
; Parameters:
...
section .text
    ...
    PUSH 0x65a440                       ; 00414696 | g_CBarrierTypeInfo
        ;   Label: LAB_00414696
    PUSH EBX                            ; 0041469b
    CALL crt_memory.c___vec_delete_FUN_005fe632 ; 0041469c
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c___vec_delete_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 004146a1
    PUSH EAX                            ; 004146a4
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 004146a5
