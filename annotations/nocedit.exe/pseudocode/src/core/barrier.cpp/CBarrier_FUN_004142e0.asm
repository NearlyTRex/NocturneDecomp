...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_barrier.cpp_CBarrier_FUN_004142e0(CBarrier * this_ptr)
;
; Parameters:
...
section .text
    ...
    FCHS                                ; 004142ee
    FLD double ptr [0x0061515f]         ; 004142f0 | double DOUBLE_0061515f
    FXCH                                ; 004142f6
    FMUL ST1                            ; 004142f8
    ...
    FADD double ptr [0x00615167]        ; 00414321 | double DOUBLE_00615167
