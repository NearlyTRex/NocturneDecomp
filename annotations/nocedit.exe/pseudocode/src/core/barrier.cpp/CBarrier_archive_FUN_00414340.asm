...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_barrier_cpp_CBarrier_archive_FUN_00414340(CBarrier *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00414340
        ;   Label: core_barrier.cpp_CBarrier_archive_FUN_00414340
    MOV EBX,dword ptr [ESP + 0x8]       ; 00414341
    PUSH EBX                            ; 00414345
    CALL core_actor.cpp_CDemonActor_archive_FUN_0040c1c0 ; 00414346
    ...
    PUSH EAX                            ; 00414359
    CALL core_actor.cpp_archiveVector_FUN_0040b340 ; 0041435a
    ...
    PUSH EAX                            ; 0041437a
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 0041437b
    ...
    PUSH EBX                            ; 0041438e
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 0041438f
