...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_haystack.cpp_FUN_004f1970()
;
; Local Variables:
...
;
; XREF[1]:
;   core_haystack.cpp_FUN_004f0e40 at 004f0edd
;
; Referenced Globals:
...
section .text
    ...
    PUSH EAX                            ; 004f1985
    PUSH ESI                            ; 004f1986
    CALL core_motion.cpp_CMotionController_advance_FUN_0052d610 ; 004f1987 | int core_motion.cpp_CMotionController_advance_FUN_0052d610(CMotionController * this_ptr)
        ;   XREF to: 0052d610 (UNCONDITIONAL_CALL)
    MOV EDX,EAX                         ; 004f198c
    SUB EAX,0x65                        ; 004f198e
    ADD ESP,0x8                         ; 004f1991
    CMP EAX,0x7                         ; 004f1994
    JA 0x004f1a97                       ; 004f1997 | default
        ;   XREF to: 004f1a97 (CONDITIONAL_JUMP)
    JMP dword ptr [EAX*0x4 + 0x4f1944]  ; 004f199d | void * switchdataD_004f1944
        ;   Label: switchD
    MOV EDI,dword ptr [0x02db8734]      ; 004f19a4 | undefined4 DAT_02db8734
        ;   Label: caseD_65
    PUSH EDI                            ; 004f19aa
    PUSH EBX                            ; 004f19ab
    CALL core_haystack.cpp_FUN_004f1ab0 ; 004f19ac | undefined core_haystack.cpp_FUN_004f1ab0()
    ...
    FNSTSW AX                           ; 004f19d1
    SAHF                                ; 004f19d3
    JC 0x004f1982                       ; 004f19d4 | LAB_004f1982
    ...
    POP EBX                             ; 004f19db
    RET                                 ; 004f19dc
    MOV EDX,dword ptr [0x02db8738]      ; 004f19dd | undefined4 DAT_02db8738
        ;   Label: caseD_66
    PUSH EDX                            ; 004f19e3
    PUSH EBX                            ; 004f19e4
    CALL core_haystack.cpp_FUN_004f1ab0 ; 004f19e5 | undefined core_haystack.cpp_FUN_004f1ab0()
        ;   XREF to: 004f1ab0 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [EBX + 0x1fbd8]   ; 004f19ea
    ADD ESP,0x8                         ; 004f19f0
    TEST ECX,ECX                        ; 004f19f3
    JMP 0x004f19bc                      ; 004f19f5 | LAB_004f19bc
    ...
    CALL sound_sndmain.cpp_isWithinListenerRadius_FUN_005aa290 ; 004f1a19 | int sound_sndmain.cpp_isWithinListenerRadius_FUN_005aa290(double pos_x, double pos_y, double pos_z, double radius)
        ;   XREF to: 005aa290 (UNCONDITIONAL_CALL)
    ADD ESP,0x20                        ; 004f1a1e
    TEST EAX,EAX                        ; 004f1a21
    JZ 0x004f19ca                       ; 004f1a23 | LAB_004f19ca
        ;   XREF to: 004f19ca (CONDITIONAL_JUMP)
    PUSH 0x62e9b3                       ; 004f1a25 | = "box-swing?.wav" | s_box_swing_wav_0062e9b3 = box-swing?.wav
    MOV EAX,dword ptr [EBX + 0x154]     ; 004f1a2a
    PUSH EBX                            ; 004f1a30
    CALL dword ptr [EAX + 0x24]         ; 004f1a31
    ADD ESP,0x8                         ; 004f1a34
    JMP 0x004f19ca                      ; 004f1a37 | LAB_004f19ca
    ...
    CALL sound_sndmain.cpp_isWithinListenerRadius_FUN_005aa290 ; 004f1a5b | int sound_sndmain.cpp_isWithinListenerRadius_FUN_005aa290(double pos_x, double pos_y, double pos_z, double radius)
        ;   XREF to: 005aa290 (UNCONDITIONAL_CALL)
    ADD ESP,0x20                        ; 004f1a60
    TEST EAX,EAX                        ; 004f1a63
    JZ 0x004f19ca                       ; 004f1a65 | LAB_004f19ca
        ;   XREF to: 004f19ca (CONDITIONAL_JUMP)
    PUSH 0x3ecccccd                     ; 004f1a6b
    CALL core_actor.cpp_randomChance_FUN_0040cd10 ; 004f1a70 | int core_actor.cpp_randomChance_FUN_0040cd10(float probability_threshold)
        ;   XREF to: 0040cd10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004f1a75
    TEST EAX,EAX                        ; 004f1a78
    JZ 0x004f19ca                       ; 004f1a7a | LAB_004f19ca
        ;   XREF to: 004f19ca (CONDITIONAL_JUMP)
    PUSH 0x62e9c2                       ; 004f1a80 | = "box-punch?.wav" | s_box_punch_wav_0062e9c2 = box-punch?.wav
    MOV EAX,dword ptr [EBX + 0x154]     ; 004f1a85
    PUSH EBX                            ; 004f1a8b
    CALL dword ptr [EAX + 0x24]         ; 004f1a8c
    ADD ESP,0x8                         ; 004f1a8f
    JMP 0x004f19ca                      ; 004f1a92 | LAB_004f19ca
        ;   XREF to: 004f19ca (UNCONDITIONAL_JUMP)
    PUSH EDX                            ; 004f1a97
        ;   Label: default
    PUSH EBX                            ; 004f1a98
    CALL core_charactr.cpp_CCharacter_FUN_0042ec40 ; 004f1a99 | void core_charactr.cpp_CCharacter_FUN_0042ec40(CCharacter * this_ptr)
        ;   XREF to: 0042ec40 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004f1a9e
    JMP 0x004f19ca                      ; 004f1aa1 | LAB_004f19ca
        ;   XREF to: 004f19ca (UNCONDITIONAL_JUMP)
