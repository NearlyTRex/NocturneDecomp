...
;                               FUNCTION
; *****************************************************************************
; __cdecl CHaystack * __cdecl core_haystack_cpp_FUN_004f1d10(CHaystack *this_ptr,uint d1,uint d2)
;
; Parameters:
...
section .text
    ...
    PUSH 0x65f560                       ; 004f1d36 | g_CHaystackTypeInfo
        ;   Label: LAB_004f1d36
    PUSH EBX                            ; 004f1d3b
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 004f1d3c
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 004f1d41
    PUSH EAX                            ; 004f1d44
    CALL crt_memory.c_free_FUN_005fe659 ; 004f1d45
    ...
    PUSH EAX                            ; 004f1d51
        ;   Label: LAB_004f1d51
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 004f1d52
