...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_haystack_cpp_CHaystack_archive_FUN_004f1b50(CHaystack *this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x4]       ; 004f1b50
        ;   Label: core_haystack.cpp_CHaystack_archive_FUN_004f1b50
    PUSH EDX                            ; 004f1b54
    CALL core_hero.cpp_CHero_archive_FUN_004f2610 ; 004f1b55
