...
section .text
    ...
    PUSH EBX                            ; 004f1ab0
        ;   Label: core_haystack.cpp_CHaystack_checkMeleeHit_FUN_004f1ab0
    PUSH ESI                            ; 004f1ab1
    PUSH EDI                            ; 004f1ab2
    PUSH EBP                            ; 004f1ab3
    ...
    MOV EBX,dword ptr [ESI + EBX*0x1 + 0x14f09c] ; 004f1af5 | g_CDemonSetInstance.characters[0] | g_CDemonSetInstance.characters[1]
