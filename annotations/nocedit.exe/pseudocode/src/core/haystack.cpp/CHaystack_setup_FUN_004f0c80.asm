...
section .text
    ...
    PUSH EBX                            ; 004f0c80
        ;   Label: core_haystack.cpp_CHaystack_setup_FUN_004f0c80
    PUSH ESI                            ; 004f0c81
    MOV ESI,dword ptr [ESP + 0xc]       ; 004f0c82
    PUSH ESI                            ; 004f0c86
    CALL core_hero.cpp_CHero_setup_FUN_004f2540 ; 004f0c87
    ...
    PUSH EBX                            ; 004f0cb7
    MOV [0x02db8700],EAX                ; 004f0cb8 | g_HaystackIndices
    ...
    PUSH EBX                            ; 004f0ccc
    MOV [0x02db8704],EAX                ; 004f0ccd | g_HaystackIndices[1]
    ...
    PUSH EBX                            ; 004f0ce1
    MOV [0x02db8708],EAX                ; 004f0ce2 | g_HaystackIndices[2]
    ...
    PUSH EBX                            ; 004f0cf6
    MOV [0x02db870c],EAX                ; 004f0cf7 | g_HaystackIndices[3]
    ...
    PUSH EBX                            ; 004f0d0b
    MOV [0x02db8710],EAX                ; 004f0d0c | g_HaystackIndices[4]
    ...
    PUSH EBX                            ; 004f0d20
    MOV [0x02db8714],EAX                ; 004f0d21 | g_HaystackIndices[5]
    ...
    PUSH EBX                            ; 004f0d35
    MOV [0x02db8718],EAX                ; 004f0d36 | g_HaystackIndices[6]
    ...
    PUSH EBX                            ; 004f0d4a
    MOV [0x02db871c],EAX                ; 004f0d4b | g_HaystackIndices[7]
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 004f0d50
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 004f0d55
    MOV [0x02db8720],EAX                ; 004f0d58 | g_HaystackIndices[8]
    PUSH 0x1                            ; 004f0d5d
    ...
    PUSH EBX                            ; 004f0d74
    MOV [0x02db8724],EAX                ; 004f0d75 | g_HaystackIndices[9]
    ...
    PUSH EBX                            ; 004f0d89
    MOV [0x02db8728],EAX                ; 004f0d8a | g_HaystackIndices[10]
    ...
    PUSH EBX                            ; 004f0d9e
    MOV [0x02db872c],EAX                ; 004f0d9f | g_HaystackIndices[11]
    ...
    PUSH EBX                            ; 004f0db3
    MOV [0x02db8730],EAX                ; 004f0db4 | g_HaystackIndices[12]
    ...
    PUSH EBX                            ; 004f0dc8
    MOV [0x02db8734],EAX                ; 004f0dc9 | g_HaystackIndices[13]
    ...
    PUSH EBX                            ; 004f0ddd
    MOV [0x02db8738],EAX                ; 004f0dde | g_HaystackIndices[14]
    ...
    PUSH EBX                            ; 004f0df2
    MOV [0x02db873c],EAX                ; 004f0df3 | g_HaystackIndices[15]
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 004f0df8
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 004f0dfd
    MOV [0x02db8740],EAX                ; 004f0e00 | g_HaystackIndices[16]
