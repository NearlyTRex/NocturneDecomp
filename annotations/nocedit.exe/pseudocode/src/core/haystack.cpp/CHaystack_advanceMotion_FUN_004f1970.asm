...
;   undefined4 g_HaystackIndices[13]
;   undefined4 g_HaystackIndices[14]
;
; Called Functions:
;   core_actor.cpp_randomChance_FUN_0040cd10
;   core_charactr.cpp_CCharacter_processMotion_FUN_0042ec40
;   core_haystack.cpp_CHaystack_checkMeleeHit_FUN_004f1ab0
...
section .text
    ...
    PUSH EBX                            ; 004f1970
        ;   Label: core_haystack.cpp_CHaystack_advanceMotion_FUN_004f1970
    PUSH ESI                            ; 004f1971
    PUSH EDI                            ; 004f1972
    PUSH EBP                            ; 004f1973
    ...
    JMP dword ptr [EAX*0x4 + 0x4f1944]  ; 004f199d | caseD_65 | caseD_66 | caseD_69
        ;   Label: switchD
    MOV EDI,dword ptr [0x02db8734]      ; 004f19a4 | g_HaystackIndices[13]
        ;   Label: caseD_65
    PUSH EDI                            ; 004f19aa
    PUSH EBX                            ; 004f19ab
    CALL core_haystack.cpp_CHaystack_checkMeleeHit_FUN_004f1ab0 ; 004f19ac
        ;   XREF to: 004f1ab0 (UNCONDITIONAL_CALL)  ; void core_haystack.cpp_CHaystack_checkMeleeHit_FUN_004f1ab0(CHaystack * this_ptr, int bone_index)
    ...
    POP EBX                             ; 004f19db
    RET                                 ; 004f19dc
    MOV EDX,dword ptr [0x02db8738]      ; 004f19dd | g_HaystackIndices[14]
        ;   Label: caseD_66
    PUSH EDX                            ; 004f19e3
    PUSH EBX                            ; 004f19e4
    CALL core_haystack.cpp_CHaystack_checkMeleeHit_FUN_004f1ab0 ; 004f19e5
        ;   XREF to: 004f1ab0 (UNCONDITIONAL_CALL)  ; void core_haystack.cpp_CHaystack_checkMeleeHit_FUN_004f1ab0(CHaystack * this_ptr, int bone_index)
