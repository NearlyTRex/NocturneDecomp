...

{
  ...
  *(float *)(in_stack_00000004->unk1 + 0x2c) = in_stack_00000008 * (float)12.566370614;
  ...
  fVar13 = *(float *)in_stack_00000004[1].base.actor_name - in_stack_00000008;
  *(float *)in_stack_00000004[1].base.actor_name = fVar13;
  if (fVar13 < 0.0) {
...
switchD_004f12ce_caseD_8:
  if (in_stack_00000004->grabbed_by == (CDemonActor *)0x0) {
    ...
    *(float *)(in_stack_00000004->unk1 + 0x20) =
    ...
    local_3c = pCVar5->x + *(float *)(in_stack_00000004->unk1 + 0x10);
    ...
    *(float *)(in_stack_00000004->unk1 + 0x10) = *(float *)(in_stack_00000004->unk1 + 0x14);
    ...
    CStack_78.z = *(float *)(in_stack_00000004->unk1 + 0x1c) * in_stack_00000008;
    local_68 = *(float *)(in_stack_00000004->unk1 + 0x20) * in_stack_00000008;
    local_64 = in_stack_00000008 * *(float *)(in_stack_00000004->unk1 + 0x24);
    ...
    if (in_stack_00000004->grabbed_type == 0) {
      pCVar5 = core_actor_cpp_CDemonActor_worldToLocalPoint_FUN_00408f10
                         (&in_stack_00000004->base,&local_60,
      ...
      (in_stack_00000004->base).orient.bank = (in_stack_00000004->base).orient.bank + (float)pCVar12
      ;
...
LAB_004f1041:
      ...
      if (*(int *)(in_stack_00000004[1].base.actor_name + 0x14) == 0) goto LAB_004f1054;
      iVar4 = 0x11;
    }
    core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
              (&(in_stack_00000004->model).motion_controller,iVar4,1);
