...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_haystack_cpp_CHaystack_FUN_004f1b70(CHaystack *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EDI                            ; 004f1bfe
        ;   Label: LAB_004f1bfe
    PUSH EBX                            ; 004f1bff
    CALL core_charactr.cpp_CCharacter_FUN_0042c3c0 ; 004f1c00
    ...
    PUSH EDI                            ; 004f1c78
    PUSH EBX                            ; 004f1c79
    CALL core_charactr.cpp_CCharacter_FUN_0042c3c0 ; 004f1c7a
        ;   XREF to: 0042c3c0 (UNCONDITIONAL_CALL)  ; void core_charactr.cpp_CCharacter_FUN_0042c3c0(CCharacter * this_ptr)
