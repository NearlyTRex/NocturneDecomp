...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_haystack_cpp_FUN_004f13f0(void)
;
; Local Variables:
...
section .text
    ...
    CALL core_hero.cpp_FUN_004f3960     ; 004f14bc
    ...
    PUSH EAX                            ; 004f15a2
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 004f15a3
    ...
    PUSH EAX                            ; 004f16ab
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 004f16ac
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)  ; CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
