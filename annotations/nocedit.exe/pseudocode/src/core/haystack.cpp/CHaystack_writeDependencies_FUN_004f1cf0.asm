...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_haystack_cpp_CHaystack_writeDependencies_FUN_004f1cf0(CHaystack *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x8]       ; 004f1cf0
        ;   Label: core_haystack.cpp_CHaystack_writeDependencies_FUN_004f1cf0
    PUSH EDX                            ; 004f1cf4
    MOV ECX,dword ptr [ESP + 0x8]       ; 004f1cf5
    PUSH ECX                            ; 004f1cf9
    CALL core_hero.cpp_CHero_writeDependencies_FUN_004f3fa0 ; 004f1cfa
