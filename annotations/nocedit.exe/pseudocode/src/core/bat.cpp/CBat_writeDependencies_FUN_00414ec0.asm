...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_bat_cpp_CBat_writeDependencies_FUN_00414ec0(CBat *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00414ec0
        ;   Label: core_bat.cpp_CBat_writeDependencies_FUN_00414ec0
    PUSH ESI                            ; 00414ec1
