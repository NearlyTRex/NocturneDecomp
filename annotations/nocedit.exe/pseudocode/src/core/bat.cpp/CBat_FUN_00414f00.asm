...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_bat.cpp_CBat_FUN_00414f00(CBat * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH 0x2a                           ; 00414f0d
    MOV EAX,[0x0067cf44]                ; 00414f0f | CKeys * g_CKeysPtr
    MOV EDX,0x3f800000                  ; 00414f14
    PUSH EAX                            ; 00414f19 | void * g_CKeysPtr
    MOV dword ptr [ESP + 0x8],EDX       ; 00414f1a
    MOV EDX,dword ptr [EAX]             ; 00414f1e | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 00414f20
    ADD ESP,0x8                         ; 00414f22
    TEST EAX,EAX                        ; 00414f25
    JZ 0x00414f30                       ; 00414f27 | LAB_00414f30
        ;   XREF to: 00414f30 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP],0x40800000      ; 00414f29
    PUSH 0x38                           ; 00414f30
        ;   Label: LAB_00414f30
    MOV EAX,[0x0067cf44]                ; 00414f32 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 00414f37 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 00414f38 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 00414f3a
    ADD ESP,0x8                         ; 00414f3c
    TEST EAX,EAX                        ; 00414f3f
    JZ 0x00414f4f                       ; 00414f41 | LAB_00414f4f
        ;   XREF to: 00414f4f (CONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 00414f43
    FMUL double ptr [0x00615426]        ; 00414f46 | double DOUBLE_00615426
    FSTP float ptr [ESP]                ; 00414f4c
    PUSH 0x34                           ; 00414f4f
        ;   Label: LAB_00414f4f
    MOV EAX,[0x0067cf44]                ; 00414f51 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 00414f56 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 00414f57 | void * g_CKeysPtr
    CALL dword ptr [EDX + 0x4]          ; 00414f59
    ADD ESP,0x8                         ; 00414f5c
    TEST EAX,EAX                        ; 00414f5f
    JZ 0x00414f72                       ; 00414f61 | LAB_00414f72
    ...
    PUSH 0x33                           ; 00414f72
        ;   Label: LAB_00414f72
    MOV EAX,[0x0067cf44]                ; 00414f74 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 00414f79 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 00414f7a | void * g_CKeysPtr
    CALL dword ptr [EDX + 0x4]          ; 00414f7c
    ADD ESP,0x8                         ; 00414f7f
    TEST EAX,EAX                        ; 00414f82
    JZ 0x00414f95                       ; 00414f84 | LAB_00414f95
    ...
    PUSH EBX                            ; 00414f95
        ;   Label: LAB_00414f95
    CALL core_bat.cpp_FUN_00414ce0      ; 00414f96 | undefined core_bat.cpp_FUN_00414ce0()
