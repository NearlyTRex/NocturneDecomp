...
section .text
    ...
    PUSH EDX                            ; 00414fba
    CALL core_actor.cpp_CDemonActor_showEditorHelp_FUN_0040d150 ; 00414fbb | void core_actor.cpp_CDemonActor_showEditorHelp_FUN_0040d150(CDemonActor * this_ptr, int * y_pos)
        ;   XREF to: 0040d150 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00414fc0
    PUSH 0x61542e                       ; 00414fc3 | = "Move bat along course." | s_Move_bat_along_course_0061542e = Move bat along course.
    MOV ECX,dword ptr [EBX]             ; 00414fc8
    PUSH 0x615445                       ; 00414fca | = "</>" | s_anon_00615445 = </>
    ADD ECX,0xb                         ; 00414fcf
    PUSH EBX                            ; 00414fd2
    MOV dword ptr [EBX],ECX             ; 00414fd3
    CALL core_actor.cpp_drawTwoColumnPropertyLine_FUN_0040d1e0 ; 00414fd5 | void core_actor.cpp_drawTwoColumnPropertyLine_FUN_0040d1e0(int * y_position, char * left_text, char * right_text)
