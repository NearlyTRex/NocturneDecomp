...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_bat.cpp_FUN_004146f0()
;
; Local Variables:
...
section .text
    ...
    FNSTSW AX                           ; 00414706
    SAHF                                ; 00414708
    JBE 0x00414751                      ; 00414709 | LAB_00414751
    ...
    CALL crt_math.c_floor_FUN_005feb90  ; 00414719 | double crt_math.c_floor_FUN_005feb90(double input_value)
    ...
    FNSTSW AX                           ; 0041473a
    SAHF                                ; 0041473c
    JA 0x00414746                       ; 0041473d | LAB_00414746
    ...
    JMP 0x0041473f                      ; 0041474f | LAB_0041473f
    ...
    CALL crt_math.c_floor_FUN_005feb90  ; 0041475d | double crt_math.c_floor_FUN_005feb90(double input_value)
        ;   XREF to: 005feb90 (UNCONDITIONAL_CALL)
