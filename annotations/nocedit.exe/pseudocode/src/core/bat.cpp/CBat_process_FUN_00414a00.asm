...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_bat.cpp_CBat_process_FUN_00414a00(CBat * this_ptr)
;
; Parameters:
...
section .text
    ...
    CALL core_bat.cpp_FUN_00414ce0      ; 00414a3f | undefined core_bat.cpp_FUN_00414ce0()
    ...
    FMUL double ptr [0x00615366]        ; 00414a5c | double DOUBLE_00615366
    FDIV float ptr [EBP + 0x14]         ; 00414a62
    FLD float ptr [ESI + 0x8]           ; 00414a65
    FSUB float ptr [ESP + 0x18]         ; 00414a68
    FXCH                                ; 00414a6c
    FADD double ptr [0x0061536e]        ; 00414a6e | double DOUBLE_0061536e
    FXCH                                ; 00414a74
    FSTP float ptr [ESP + 0xc]          ; 00414a76
    FST float ptr [ESP]                 ; 00414a7a
    FCOMP double ptr [0x00615376]       ; 00414a7d | double DOUBLE_00615376
    FNSTSW AX                           ; 00414a83
    SAHF                                ; 00414a85
    JC 0x00414b3a                       ; 00414a86 | LAB_00414b3a
        ;   XREF to: 00414b3a (CONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 00414a8c
        ;   Label: LAB_00414a8c
    FCOMP double ptr [0x0061537e]       ; 00414a8f | double DOUBLE_0061537e
    FNSTSW AX                           ; 00414a95
    SAHF                                ; 00414a97
    JBE 0x00414aa1                      ; 00414a98 | LAB_00414aa1
    ...
    FMUL double ptr [0x00615386]        ; 00414aaa | double DOUBLE_00615386
    ...
    CALL core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80 ; 00414ae8 | CKeyFramedModel * core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80(CKeyFramedModelInstance * this_ptr)
    ...
    FNSTSW AX                           ; 00414b2f
    SAHF                                ; 00414b31
    JNC 0x00414b64                      ; 00414b32 | LAB_00414b64
    ...
    MOV dword ptr [ESP],0x41200000      ; 00414b3a
        ;   Label: LAB_00414b3a
    JMP 0x00414a8c                      ; 00414b41 | LAB_00414a8c
    ...
    FNSTSW AX                           ; 00414b4e
    SAHF                                ; 00414b50
    JBE 0x00414b13                      ; 00414b51 | LAB_00414b13
    ...
    JMP 0x00414b13                      ; 00414b62 | LAB_00414b13
        ;   XREF to: 00414b13 (UNCONDITIONAL_JUMP)
    MOV ESI,dword ptr [EBX + 0x380]     ; 00414b64
        ;   Label: LAB_00414b64
    PUSH ESI                            ; 00414b6a
    CALL sound_sndmain.cpp_isSfxPlaying_FUN_005a9660 ; 00414b6b | int sound_sndmain.cpp_isSfxPlaying_FUN_005a9660(uint sfx_handle)
        ;   XREF to: 005a9660 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00414b70
    TEST EAX,EAX                        ; 00414b73
    JNZ 0x00414bbe                      ; 00414b75 | LAB_00414bbe
    ...
    CALL sound_sndmain.cpp_isWithinListenerRadius_FUN_005aa290 ; 00414b98 | int sound_sndmain.cpp_isWithinListenerRadius_FUN_005aa290(double pos_x, double pos_y, double pos_z, double radius)
        ;   XREF to: 005aa290 (UNCONDITIONAL_CALL)
    ADD ESP,0x20                        ; 00414b9d
    TEST EAX,EAX                        ; 00414ba0
    JZ 0x00414bbe                       ; 00414ba2 | LAB_00414bbe
        ;   XREF to: 00414bbe (CONDITIONAL_JUMP)
    ...
    CALL core_actor.cpp_getRandomFloat_FUN_0040cc10 ; 00414bca | float core_actor.cpp_getRandomFloat_FUN_0040cc10(float min_value, float max_value)
