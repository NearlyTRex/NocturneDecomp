...
section .text
    ...
    PUSH EBX                            ; 00414ec0
        ;   Label: core_bat.cpp_CBat_addFilesToExtract_FUN_00414ec0
    PUSH ESI                            ; 00414ec1
    MOV EBX,dword ptr [ESP + 0xc]       ; 00414ec2
    MOV ESI,dword ptr [ESP + 0x10]      ; 00414ec6
    PUSH ESI                            ; 00414eca
    PUSH EBX                            ; 00414ecb
    CALL core_actor.cpp_CDemonActor_addFilesToExtract_FUN_0040cfd0 ; 00414ecc
    ...
    PUSH EAX                            ; 00414edb
    CALL core_dmodel.cpp_CKeyFramedModelInstance_addFilesToExtract_FUN_0047edd0 ; 00414edc
