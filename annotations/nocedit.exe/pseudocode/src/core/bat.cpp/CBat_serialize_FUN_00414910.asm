...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_bat_cpp_CBat_serialize_FUN_00414910(CBat *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00414915
    CALL core_actor.cpp_CDemonActor_serialize_FUN_0040c1c0 ; 00414916
    ...
    PUSH EAX                            ; 00414929
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 0041492a
    ...
    PUSH EAX                            ; 0041493d
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 0041493e
    ...
    PUSH EAX                            ; 0041495c
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 0041495d
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ADD ESP,0x8                         ; 00414962
    PUSH 0x615318                       ; 00414965 | = "courseSpeed"
    LEA EAX,[EBX + 0x308]               ; 0041496a
    PUSH EAX                            ; 00414970
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 00414971
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH EAX                            ; 0041498d
    CALL core_actor.cpp_serializeKeyframedModelInstance_FUN_0040b8f0 ; 0041498e
    ...
    PUSH 0x615304                       ; 004149a1 | = "speed"
        ;   Label: LAB_004149a1
    PUSH EAX                            ; 004149a6
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 004149a7
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
