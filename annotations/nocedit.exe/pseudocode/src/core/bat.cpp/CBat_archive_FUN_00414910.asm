...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_bat_cpp_CBat_archive_FUN_00414910(CBat *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00414910
        ;   Label: core_bat.cpp_CBat_archive_FUN_00414910
    MOV EBX,dword ptr [ESP + 0x8]       ; 00414911
    PUSH EBX                            ; 00414915
    CALL core_actor.cpp_CDemonActor_archive_FUN_0040c1c0 ; 00414916
    ...
    PUSH 0x6152ef                       ; 0041491e | = "courseFilename"
    LEA EAX,[EBX + 0x158]               ; 00414923
    PUSH EAX                            ; 00414929
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 0041492a
    ...
    PUSH 0x6152fe                       ; 00414932 | = "param"
    LEA EAX,[EBX + 0x304]               ; 00414937
    PUSH EAX                            ; 0041493d
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 0041493e
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
    MOV EDX,dword ptr [0x0066e4b4]      ; 00414943 | g_CBatClassVersion
    ADD ESP,0x8                         ; 00414949
    LEA EAX,[EBX + 0x30c]               ; 0041494c
    CMP EDX,0x3                         ; 00414952
    JL 0x004149a1                       ; 00414955
        ;   XREF to: 004149a1 (CONDITIONAL_JUMP)  ; LAB_004149a1
    PUSH 0x61530a                       ; 00414957 | = "flapSpeedMult"
    PUSH EAX                            ; 0041495c
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 0041495d
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ADD ESP,0x8                         ; 00414962
    PUSH 0x615318                       ; 00414965 | = "courseSpeed"
    LEA EAX,[EBX + 0x308]               ; 0041496a
    PUSH EAX                            ; 00414970
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 00414971
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ADD ESP,0x8                         ; 00414976
    CMP dword ptr [0x0066e4b4],0x2      ; 00414979 | g_CBatClassVersion
        ;   Label: LAB_00414979
    JL 0x00414996                       ; 00414980
        ;   XREF to: 00414996 (CONDITIONAL_JUMP)  ; LAB_00414996
    PUSH 0x615324                       ; 00414982 | = "modelName"
    LEA EAX,[EBX + 0x188]               ; 00414987
    PUSH EAX                            ; 0041498d
    CALL core_actor.cpp_archiveKeyframedModelInstance_FUN_0040b8f0 ; 0041498e
    ...
    CMP dword ptr [0x0066e4b4],0x4      ; 00414996 | g_CBatClassVersion
        ;   Label: LAB_00414996
    JGE 0x004149c3                      ; 0041499d
        ;   XREF to: 004149c3 (CONDITIONAL_JUMP)  ; LAB_004149c3
    POP EBX                             ; 0041499f
    RET                                 ; 004149a0
    PUSH 0x615304                       ; 004149a1 | = "speed"
        ;   Label: LAB_004149a1
    PUSH EAX                            ; 004149a6
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 004149a7
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
    FLD float ptr [EBX + 0x30c]         ; 004149ac
    FMUL double ptr [0x0061535e]        ; 004149b2 | DOUBLE_0061535e
    ADD ESP,0x8                         ; 004149b8
    FSTP float ptr [EBX + 0x308]        ; 004149bb
    JMP 0x00414979                      ; 004149c1
        ;   XREF to: 00414979 (UNCONDITIONAL_JUMP)  ; LAB_00414979
    PUSH 0x0                            ; 004149c3
        ;   Label: LAB_004149c3
    LEA EAX,[EBX + 0x314]               ; 004149c5
    PUSH EAX                            ; 004149cb
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 004149cc
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveString_FUN_0040b5c0(char * string_buffer, char * property_type)
    ADD ESP,0x8                         ; 004149d1
    PUSH 0x61532e                       ; 004149d4 | = "periodicSoundTimerMin"
    LEA EAX,[EBX + 0x378]               ; 004149d9
    PUSH EAX                            ; 004149df
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 004149e0
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ADD ESP,0x8                         ; 004149e5
    PUSH 0x615344                       ; 004149e8 | = "periodicSoundTimerMax"
    ADD EBX,0x37c                       ; 004149ed
    PUSH EBX                            ; 004149f3
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 004149f4
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
