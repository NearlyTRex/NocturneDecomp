...
// Signature: void __edi_esi_ebx core_dstrender_cpp_renderDepthOnlyStandard_FUN_0049072f(SSoftwareEdge *left_edge,SSoftwareEdge *right_edge,int scanline_y)
...

{
  ...
  if (iVar7 != 0 && uVar5 <= uVar6 >> 0x10) {
    puVar9 = (ushort *)g_ScreenBufferArray[scanline_y] + uVar5;
