...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dstrender.cpp_renderDepthOnlyReversed_FUN_004906e9(SEdgeData * left_edge, SEdgeData * right_edge, int scanline_y)
;
;
; XREF[1]:
...
section .text
    ...
    JBE 0x004906f8                      ; 004906f3 | LAB_004906f8
    ...
    MOV EBX,dword ptr [EBX*0x4 + 0x2cf7d5c] ; 004906fe | uint *[1024] g_ZBufferScanlineArray
    SUB ECX,EAX                         ; 00490705
    JLE 0x0049072c                      ; 00490707 | LAB_0049072c
    ...
    CMP ESI,dword ptr [EBX]             ; 0049071e
        ;   Label: LAB_0049071e
    JL 0x00490724                       ; 00490720 | LAB_00490724
    ...
    DEC ECX                             ; 00490729
    JG 0x0049071e                       ; 0049072a | LAB_0049071e
