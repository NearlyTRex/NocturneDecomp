...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dstrender.cpp_renderDepthInterlacedProfiled_FUN_00490c37(SEdgeData * left_edge, SEdgeData * right_edge, int scanline_y)
;
;
; XREF[1]:
...
section .text
    ...
    JZ 0x00490c44                       ; 00490c3f | LAB_00490c44
    ...
    JBE 0x00490c52                      ; 00490c4d | LAB_00490c52
    ...
    MOV EBP,dword ptr [EBX*0x4 + 0x2cf7d5c] ; 00490c58 | uint *[1024] g_ZBufferScanlineArray
    SUB ECX,EAX                         ; 00490c5f
    JLE 0x00490c90                      ; 00490c61 | LAB_00490c90
    ...
    IMUL dword ptr [ECX*0x4 + 0x2d02580] ; 00490c6f | uint[1600] g_ReciprocalLookupTable
    ...
    POP ESI                             ; 00490c92
    RET                                 ; 00490c93
    MOV EAX,[0x02c6d5a4]                ; 00490c94 | int g_RenderPixelCounter
        ;   Label: LAB_00490c94
    INC EAX                             ; 00490c99
    MOV [0x02c6d5a4],EAX                ; 00490c9a | int g_RenderPixelCounter
    CMP EAX,dword ptr [0x006703f0]      ; 00490c9f | int g_RenderPixelBudget
    JC 0x00490c85                       ; 00490ca5 | LAB_00490c85
        ;   XREF to: 00490c85 (CONDITIONAL_JUMP)
    MOV dword ptr [0x02c6d5a8],0x1      ; 00490ca7 | int g_RenderAbortFlag
    POP EBP                             ; 00490cb1
    POP EDI                             ; 00490cb2
    POP ESI                             ; 00490cb3
    RET                                 ; 00490cb4
