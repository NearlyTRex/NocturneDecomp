...

{
  ...
  do {
    ...
    uVar8 = pmulhw(CONCAT26 /* combine 2-byte values */((short)(uVar10 >> 0x18) * (short)(uVar13 >> 0x18),
                            CONCAT24 /* combine 2-byte values */((short)(uVar10 >> 8) * (short)(uVar13 >> 8),
    ...
    *output_buffer =
         CONCAT13 /* combine 2-byte values */((uVar12 != 0) * (uVar12 < 0x100) * (char)uVar12 - (0xff < uVar12),
                  CONCAT12 /* combine 2-byte values */((uVar11 != 0) * (uVar11 < 0x100) * (char)uVar11 - (0xff < uVar11),
                           CONCAT11 /* combine 2-byte values */((uVar9 != 0) * (uVar9 < 0x100) * (char)uVar9 - (0xff < uVar9),
    ...
    uVar8 = pmulhw(CONCAT26 /* combine 2-byte values */((short)(uVar10 >> 0x18) * (uVar7 >> 8),
                            CONCAT24 /* combine 2-byte values */((short)(uVar10 >> 8) *
