...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dstrender.cpp_blendLightmapToTexture64BitOutput_FUN_004924a9(ulonglong * output_buffer, ulonglong * texture_buffer, byte * texture_indices, byte * lightmap_indices, int pixel_count)
;
; Parameters:
...
section .text
    ...
    MOVD MM5,dword ptr [0x02d052a8]     ; 004924c1 | int g_SolidColorMode
    PUNPCKLBW MM5,MM7                   ; 004924c8
    PSLLW MM5,0x6                       ; 004924cb
    MOVZX EDX,byte ptr [EBX]            ; 004924cf
        ;   Label: LAB_004924cf
    MOVQ MM0,qword ptr [ESI]            ; 004924d2
    MOVD MM2,dword ptr [EDX*0x4 + 0xc19dfc] ; 004924d5 | uint[256] g_LightmapTexturePalette
    ...
    MOVQ MM3,qword ptr [EAX*0x8 + 0x6779f0] ; 004924f8 | ushort[384] g_LightmapData
    PMULLW MM1,MM2                      ; 00492500
    MOVQ MM2,MM3                        ; 00492503
    MOVQ MM4,MM5                        ; 00492506
    PXOR MM2,qword ptr [0x006781e8]     ; 00492509 | double g_LightmapXorMask
    PMULHW MM0,MM2                      ; 00492510
    PMULHW MM1,MM2                      ; 00492513
    PMULHW MM4,MM3                      ; 00492516
    PADDW MM0,MM4                       ; 00492519
    PADDW MM1,MM4                       ; 0049251c
    PADDW MM0,qword ptr [0x00676478]    ; 0049251f | ulonglong g_LightmapBlendBias1
    PADDW MM1,qword ptr [0x00676480]    ; 00492526 | ulonglong g_LightmapBlendBias2
    ...
    MOVD MM2,dword ptr [EDX*0x4 + 0xc19dfc] ; 00492547 | uint[256] g_LightmapTexturePalette
    ...
    MOVQ MM3,qword ptr [EAX*0x8 + 0x6779f0] ; 0049256a | ushort[384] g_LightmapData
    PMULLW MM1,MM2                      ; 00492572
    MOVQ MM2,MM3                        ; 00492575
    MOVQ MM4,MM5                        ; 00492578
    PXOR MM2,qword ptr [0x006781e8]     ; 0049257b | double g_LightmapXorMask
    PMULHW MM0,MM2                      ; 00492582
    PMULHW MM1,MM2                      ; 00492585
    PMULHW MM4,MM3                      ; 00492588
    PADDW MM0,MM4                       ; 0049258b
    PADDW MM1,MM4                       ; 0049258e
    PADDW MM0,qword ptr [0x00676478]    ; 00492591 | ulonglong g_LightmapBlendBias1
    PADDW MM1,qword ptr [0x00676480]    ; 00492598 | ulonglong g_LightmapBlendBias2
    ...
    JG 0x004924cf                       ; 004925b8 | LAB_004924cf
