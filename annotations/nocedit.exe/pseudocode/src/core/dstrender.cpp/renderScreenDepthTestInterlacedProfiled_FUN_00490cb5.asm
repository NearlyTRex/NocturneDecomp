...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dstrender.cpp_renderScreenDepthTestInterlacedProfiled_FUN_00490cb5(SEdgeData * left_edge, SEdgeData * right_edge, int scanline_y)
;
;
; XREF[1]:
...
section .text
    ...
    JZ 0x00490cc2                       ; 00490cbd | LAB_00490cc2
    ...
    JBE 0x00490cd0                      ; 00490ccb | LAB_00490cd0
    ...
    MOV EBP,dword ptr [EBX*0x4 + 0x2cf6a9c] ; 00490cd6 | void *[1024] g_ScreenBufferArray
    SUB ECX,EAX                         ; 00490cdd
    JLE 0x00490d10                      ; 00490cdf | LAB_00490d10
    ...
    IMUL dword ptr [ECX*0x4 + 0x2d02580] ; 00490cec | uint[1600] g_ReciprocalLookupTable
    ...
    POP ESI                             ; 00490d12
    RET                                 ; 00490d13
    MOV EAX,[0x02c6d5a4]                ; 00490d14 | int g_RenderPixelCounter
        ;   Label: LAB_00490d14
    INC EAX                             ; 00490d19
    MOV [0x02c6d5a4],EAX                ; 00490d1a | int g_RenderPixelCounter
    CMP EAX,dword ptr [0x006703f0]      ; 00490d1f | int g_RenderPixelBudget
    JC 0x00490d05                       ; 00490d25 | LAB_00490d05
        ;   XREF to: 00490d05 (CONDITIONAL_JUMP)
    MOV dword ptr [0x02c6d5a8],0x1      ; 00490d27 | int g_RenderAbortFlag
    POP EBP                             ; 00490d31
    POP EDI                             ; 00490d32
    POP ESI                             ; 00490d33
    RET                                 ; 00490d34
