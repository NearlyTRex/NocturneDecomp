...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dstrender.cpp_renderDepthOnlyStandard_FUN_0049072f(SEdgeData * left_edge, SEdgeData * right_edge, int scanline_y)
;
;
; XREF[20]:
...
section .text
    ...
    JBE 0x0049073e                      ; 00490739 | LAB_0049073e
    ...
    MOV EBX,dword ptr [EBX*0x4 + 0x2cf6a9c] ; 00490744 | void *[1024] g_ScreenBufferArray
    SUB ECX,EAX                         ; 0049074b
    JLE 0x0049077a                      ; 0049074d | LAB_0049077a
    ...
    JNC 0x00490772                      ; 0049076d | LAB_00490772
    ...
    DEC ECX                             ; 00490777
    JG 0x00490763                       ; 00490778 | LAB_00490763
