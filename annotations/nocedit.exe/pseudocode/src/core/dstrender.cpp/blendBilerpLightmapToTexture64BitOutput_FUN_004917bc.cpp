...

{
  ...
  do {
    ...
    uVar5 = (uint)(CONCAT34 /* combine 2-byte values */((int3)(CONCAT25 /* combine 2-byte values */((short)(((uint7)(byte)(uVar3 >> 0x18) << 0x30) >> 0x28),
    ...
    uVar12 = (ushort)(CONCAT43 /* combine 2-byte values */(uVar6,CONCAT12 /* combine 2-byte values */((char)(uVar2 >> 8),(ushort)uVar2)) >> 0x10) & 0xff;
    ...
    uVar9 = pmulhw(CONCAT26 /* combine 2-byte values */((uVar8 >> 8) * sVar21,
                            CONCAT24 /* combine 2-byte values */((short)CONCAT21 /* combine 2-byte values */(uVar8,(char)(uVar1 >> 0x10)) * sVar20,
                                     CONCAT22 /* combine 2-byte values */((byte)(uVar1 >> 8) * uVar12,(byte)uVar1 * uVar11))),
                   uVar18);
    uVar14 = pmulhw(CONCAT26 /* combine 2-byte values */((uVar10 >> 8) * ((ushort)((short)(uVar25 >> 0x18) + sVar21) >> 1),
                             CONCAT24 /* combine 2-byte values */((short)CONCAT21 /* combine 2-byte values */(uVar10,(char)(uVar1 >> 0x30)) *
                                      ((ushort)((short)(uVar25 >> 8) + sVar20) >> 1),
                                      CONCAT22 /* combine 2-byte values */((ushort)(byte)(uVar1 >> 0x28) *
                                               ((ushort)(((ushort)(CONCAT43 /* combine 2-byte values */(uVar5,CONCAT12 /* combine 2-byte values */((char)(
    ...
    *output_buffer =
         CONCAT17 /* combine 2-byte values */((uVar17 != 0) * (uVar17 < 0x100) * (char)uVar17 - (0xff < uVar17),
                  CONCAT16 /* combine 2-byte values */((uVar16 != 0) * (uVar16 < 0x100) * (char)uVar16 - (0xff < uVar16),
                           CONCAT15 /* combine 2-byte values */((uVar15 != 0) * (uVar15 < 0x100) * (char)uVar15 -
                                    (0xff < uVar15),
                                    CONCAT14 /* combine 2-byte values */((uVar13 != 0) * (uVar13 < 0x100) * (char)uVar13 -
                                             (0xff < uVar13),
                                             CONCAT13 /* combine 2-byte values */((uVar12 != 0) * (uVar12 < 0x100) *
                                                      (char)uVar12 - (0xff < uVar12),
                                                      CONCAT12 /* combine 2-byte values */((uVar11 != 0) * (uVar11 < 0x100) *
                                                               (char)uVar11 - (0xff < uVar11),
                                                               CONCAT11 /* combine 2-byte values */((uVar10 != 0) *
                                                                        (uVar10 < 0x100) *
                                                                        (char)uVar10 -
                                                                        (0xff < uVar10),
                                                                        (uVar8 != 0) *
