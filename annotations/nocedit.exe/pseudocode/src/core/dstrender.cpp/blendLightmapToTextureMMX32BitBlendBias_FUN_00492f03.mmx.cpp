// Name: core_dstrender.cpp_blendLightmapToTextureMMX32BitBlendBias_FUN_00492f03
// Address: 00492f03
// Address Range: [[00492f03, 0049333c] [00493340, 0049344f]]
// Convention: __cdecl
// Signature: void __cdecl core_dstrender_cpp_blendLightmapToTextureMMX32BitBlendBias_FUN_00492f03(uint *output_buffer,ulonglong *texture_buffer,byte *texture_indices,byte *lightmap_indices,int pixel_count)
...
__asm {
        ...
        mov EAX,[0x00677cb0]
        mov EAX,[0x00677cd0]
        mov EAX,[g_LightmapBlendConstants]
        mov EAX,[g_LightmapBlendConstants+0x20]
        mov EAX,[g_LightmapBlendConstants+0x40]
        mov EAX,[g_LightmapBlendConstants+0x60]
        mov EAX,[g_LightmapBlendConstants+0x80]
        mov EAX,[g_LightmapBlendConstants+0xa0]
        mov EAX,[g_LightmapBlendConstants+0xc0]
        mov EAX,[g_LightmapBlendConstants+0xe0]
        mov EAX,[g_LightmapBlendConstants+0x100]
        mov EAX,[g_LightmapBlendConstants+0x120]
        mov EAX,[g_LightmapBlendConstants+0x140]
        mov EAX,[g_LightmapBlendConstants+0x160]
        mov EAX,[g_LightmapBlendConstants+0x180]
        mov EAX,[g_LightmapBlendConstants+0x1a0]
        mov EAX,[g_LightmapBlendConstants+0x1c0]
        mov EAX,[g_LightmapBlendConstants+0x1e0]
        mov EAX,[g_LightmapBlendConstants+0x200]
        mov EAX,[g_LightmapBlendConstants+0x220]
        mov EAX,[g_LightmapBlendConstants+0x240]
        mov EAX,[g_LightmapBlendConstants+0x260]
        mov EAX,[g_LightmapBlendConstants+0x280]
        mov EAX,[g_LightmapBlendConstants+0x2a0]
        mov EAX,[g_LightmapBlendConstants+0x2c0]
        mov EAX,[g_LightmapBlendConstants+0x2e0]
        mov EAX,[g_LightmapBlendConstants+0x300]
        mov EAX,[g_LightmapBlendConstants+0x320]
        mov EAX,[g_LightmapBlendConstants+0x340]
        mov EAX,[g_LightmapBlendConstants+0x360]
        mov EAX,[g_LightmapBlendConstants+0x380]
        mov EAX,[g_LightmapBlendConstants+0x3a0]
        mov EAX,[g_LightmapBlendConstants+0x3c0]
        mov EAX,[g_LightmapBlendConstants+0x3e0]
        mov EAX,[g_LightmapBlendConstants+0x400]
        mov EAX,[g_LightmapBlendConstants+0x420]
        mov EAX,[g_LightmapBlendConstants+0x440]
        mov EAX,[g_LightmapBlendConstants+0x460]
        mov EAX,[g_LightmapBlendConstants+0x480]
        mov EAX,[g_LightmapBlendConstants+0x4a0]
        mov EAX,[g_LightmapBlendConstants+0x4c0]
        mov EAX,[g_LightmapBlendConstants+0x4e0]
        jmp LAB_00493340
    LAB_00493340:
