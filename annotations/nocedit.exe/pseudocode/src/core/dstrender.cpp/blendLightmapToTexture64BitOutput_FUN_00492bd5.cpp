...

{
  ...
  do {
    ...
    uVar7 = pmulhw(CONCAT26 /* combine 2-byte values */((uVar6 >> 8) * (short)(uVar11 >> 0x18),
                            CONCAT24 /* combine 2-byte values */((short)CONCAT21 /* combine 2-byte values */(uVar6,(char)(uVar1 >> 0x10)) *
                                     (short)(uVar11 >> 8),
                                     CONCAT22 /* combine 2-byte values */((ushort)(byte)(uVar1 >> 8) *
    ...
    *output_buffer =
         CONCAT13 /* combine 2-byte values */((uVar10 != 0) * (uVar10 < 0x100) * (char)uVar10 - (0xff < uVar10),
                  CONCAT12 /* combine 2-byte values */((uVar9 != 0) * (uVar9 < 0x100) * (char)uVar9 - (0xff < uVar9),
                           CONCAT11 /* combine 2-byte values */((uVar8 != 0) * (uVar8 < 0x100) * (char)uVar8 - (0xff < uVar8),
    ...
    uVar7 = pmulhw(CONCAT26 /* combine 2-byte values */((uVar6 >> 8) * (uVar8 >> 8),
                            CONCAT24 /* combine 2-byte values */((short)CONCAT21 /* combine 2-byte values */(uVar6,(char)((ulonglong)uVar7 >> 0x10)) *
                                     (short)(CONCAT25 /* combine 2-byte values */(uVar8,CONCAT14 /* combine 2-byte values */((char)(uVar2 >> 0x10),uVar2))
                                            >> 0x20),
                                     CONCAT22 /* combine 2-byte values */((ushort)(byte)((ulonglong)uVar7 >> 8) *
                                              (ushort)(byte)(uVar2 >> 8),
