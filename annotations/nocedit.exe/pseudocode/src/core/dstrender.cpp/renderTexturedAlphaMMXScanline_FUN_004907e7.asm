...
;
; XREF[5]:
;   engine_drender.cpp_CDemonRenderer_renderDestReadBlendDirect_FUN_0048b890 at 0048b8e8
;   engine_drender.cpp_CDemonRenderer_renderDestReadBlendPoly_FUN_0048b970 at 0048b9e8
;   engine_drender.cpp_CDemonRenderer_renderFullEffectsDirect_FUN_0048b650 at 0048b6a8
...
section .text
    ...
    JBE 0x004907f7                      ; 004907f2
        ;   XREF to: 004907f7 (CONDITIONAL_JUMP)  ; LAB_004907f7
    XCHG EAX,ECX                        ; 004907f4
    XCHG EDI,ESI                        ; 004907f5
    SHR ECX,0x10                        ; 004907f7
        ;   Label: LAB_004907f7
    SHR EAX,0x10                        ; 004907fa
    MOV EBP,dword ptr [EBX*0x4 + 0x2cf6a9c] ; 004907fd | g_ScreenBufferArray
    SUB ECX,EAX                         ; 00490804
    JLE 0x004908fc                      ; 00490806
        ;   XREF to: 004908fc (CONDITIONAL_JUMP)  ; LAB_004908fc
    SHL ECX,0x1                         ; 0049080c
    LEA EBP,[EBP + EAX*0x2]             ; 0049080e
    MOV dword ptr [0x006723d4],ECX      ; 00490812 | g_PerspectiveScanlinePixelCount
    MOV dword ptr [0x006723d8],EBP      ; 00490818 | g_PerspectiveScanlineZPtr
    ...
    MOV ESI,dword ptr [0x006723b4]      ; 00490880 | g_StartDepthZ
    MOV EBP,dword ptr [0x006723d8]      ; 00490886 | g_PerspectiveScanlineZPtr
        ;   Label: LAB_00490886
    ADD EBP,EDI                         ; 0049088c
    MOVZX EAX,word ptr [EBP]            ; 0049088e
    CMP ESI,EAX                         ; 00490892
    JNC 0x004908dd                      ; 00490894
        ;   XREF to: 004908dd (CONDITIONAL_JUMP)  ; LAB_004908dd
    MOVD MM0,ECX                        ; 00490896
    MOVD MM2,EDX                        ; 00490899
    PSRLQ MM0,qword ptr [0x006826e0]    ; 0049089c | g_TextureShift1
    PSRLQ MM2,qword ptr [0x00682700]    ; 004908a3 | g_TextureShift2
    PAND MM0,qword ptr [0x00682720]     ; 004908aa | g_TextureMask1
    PAND MM2,qword ptr [0x00682740]     ; 004908b1 | g_TextureMask2
    PADDD MM0,MM2                       ; 004908b8
    MOVD EBX,MM0                        ; 004908bb
    MOV EAX,[0x02d03e84]                ; 004908be | g_CurrentTextureOpacityData
    TEST EAX,0xffffffff                 ; 004908c3
    JNZ 0x004908cf                      ; 004908c8
        ;   XREF to: 004908cf (CONDITIONAL_JUMP)  ; LAB_004908cf
    MOV EAX,[0x02d03e80]                ; 004908ca | g_CurrentTextureData
    ADD EBX,EAX                         ; 004908cf
        ;   Label: LAB_004908cf
    MOVZX EAX,byte ptr [EBX]            ; 004908d1
    CMP EAX,0x0                         ; 004908d4
    JZ 0x004908dd                       ; 004908d7
        ;   XREF to: 004908dd (CONDITIONAL_JUMP)  ; LAB_004908dd
