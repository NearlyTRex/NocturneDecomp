...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dstrender.cpp_renderDepth16BitConditional_FUN_0049077d(SEdgeData * left_edge, SEdgeData * right_edge, int scanline_y)
;
;
; XREF[1]:
...
section .text
    ...
    JBE 0x0049078c                      ; 00490787 | LAB_0049078c
    ...
    MOV EBX,dword ptr [EBX*0x4 + 0x2cf6a9c] ; 00490792 | void *[1024] g_ScreenBufferArray
    SUB ECX,EAX                         ; 00490799
    JLE 0x004907ce                      ; 0049079b | LAB_004907ce
    ...
    JZ 0x004907c6                       ; 004907ba | LAB_004907c6
        ;   XREF to: 004907c6 (CONDITIONAL_JUMP)
    CMP EAX,0xffff                      ; 004907bc
    JA 0x004907e0                       ; 004907c1 | LAB_004907e0
    ...
    DEC ECX                             ; 004907cb
    JG 0x004907b1                       ; 004907cc | LAB_004907b1
    ...
    MOV word ptr [EBX],0xffff           ; 004907e0
        ;   Label: LAB_004907e0
    JMP 0x004907c6                      ; 004907e5 | LAB_004907c6
