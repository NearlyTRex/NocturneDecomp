...
section .text
    ...
    PUSH EBP                            ; 00493dc4
        ;   Label: core_dstrender.cpp_blendLightmapPerPxU64toU16pAmbientPx2MMX_FUN_00493dc4
    ...
    PXOR MM2,qword ptr [0x006781e8]     ; 00493fea | g_LightmapData[1020]
    ...
    PXOR MM2,qword ptr [0x006781e8]     ; 00494073 | g_LightmapData[1020]
