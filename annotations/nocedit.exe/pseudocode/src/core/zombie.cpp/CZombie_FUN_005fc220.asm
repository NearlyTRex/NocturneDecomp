...
section .text
    ...
    FNSTSW AX                           ; 005fc236
    SAHF                                ; 005fc238
    JNC 0x005fc265                      ; 005fc239 | default
        ;   XREF to: 005fc265 (CONDITIONAL_JUMP)
    CMP dword ptr [ESI],-0x1            ; 005fc23b
    JNZ 0x005fc265                      ; 005fc23e | default
        ;   XREF to: 005fc265 (CONDITIONAL_JUMP)
    CALL crt_stdlib.c_rand_FUN_005feb5c ; 005fc240 | int crt_stdlib.c_rand_FUN_005feb5c()
    ...
    JA 0x005fc265                       ; 005fc254 | default
        ;   XREF to: 005fc265 (CONDITIONAL_JUMP)
    JMP dword ptr [EDX*0x4 + 0x5fc200]  ; 005fc256 | void * switchdataD_005fc200
        ;   Label: switchD
    ...
    JNZ 0x005fc462                      ; 005fc26f | LAB_005fc462
    ...
    JNZ 0x005fc28e                      ; 005fc284 | LAB_005fc28e
    ...
    JNZ 0x005fc2a0                      ; 005fc296 | LAB_005fc2a0
        ;   XREF to: 005fc2a0 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x8],0x3ca3d70a ; 005fc298
    MOV EAX,[0x0067b654]                ; 005fc2a0 | CGame g_CGameInstance | CGame * g_CGamePtr
        ;   Label: LAB_005fc2a0
    CMP dword ptr [EAX + 0x1e0],0x0     ; 005fc2a5 | g_CGameInstance.field57_0x1e0
    JZ 0x005fc2b6                       ; 005fc2ac | LAB_005fc2b6
        ;   XREF to: 005fc2b6 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x8],0x3f800000 ; 005fc2ae
    MOV EAX,[0x0067b654]                ; 005fc2b6 | CGame g_CGameInstance | CGame * g_CGamePtr
        ;   Label: LAB_005fc2b6
    MOV EDX,dword ptr [EAX + 0x14]      ; 005fc2bb | g_CGameInstance.blood_flag
    TEST EDX,EDX                        ; 005fc2be
    JNZ 0x005fc2c6                      ; 005fc2c0 | LAB_005fc2c6
        ;   XREF to: 005fc2c6 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x8],EDX       ; 005fc2c2
    PUSH dword ptr [ESP + 0x8]          ; 005fc2c6
        ;   Label: LAB_005fc2c6
    CALL core_actor.cpp_randomChance_FUN_0040cd10 ; 005fc2ca | int core_actor.cpp_randomChance_FUN_0040cd10(float probability_threshold)
        ;   XREF to: 0040cd10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005fc2cf
    TEST EAX,EAX                        ; 005fc2d2
    JZ 0x005fc3f9                       ; 005fc2d4 | LAB_005fc3f9
    ...
    PUSH EAX                            ; 005fc2ec
    CALL core_bodypart.cpp_CreateBodyPart_FUN_00418e10 ; 005fc2ed | undefined core_bodypart.cpp_CreateBodyPart_FUN_00418e10()
    ...
    PUSH EDI                            ; 005fc2fe
    PUSH EBX                            ; 005fc2ff
    CALL core_charactr.cpp_CCharacter_FUN_0042bd30 ; 005fc300 | void core_charactr.cpp_CCharacter_FUN_0042bd30(CCharacter * this_ptr)
    ...
    JNZ 0x005fc327                      ; 005fc312 | LAB_005fc327
    ...
    PUSH EDI                            ; 005fc31d
    PUSH EBX                            ; 005fc31e
    CALL core_charactr.cpp_CCharacter_FUN_0042bd30 ; 005fc31f | void core_charactr.cpp_CCharacter_FUN_0042bd30(CCharacter * this_ptr)
        ;   XREF to: 0042bd30 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 005fc324
    MOV EDI,dword ptr [EBX + 0xbf80]    ; 005fc327
        ;   Label: LAB_005fc327
    CMP EDI,dword ptr [ESI]             ; 005fc32d
    JNZ 0x005fc344                      ; 005fc32f | LAB_005fc344
    ...
    PUSH EBP                            ; 005fc33a
    PUSH EBX                            ; 005fc33b
    CALL core_charactr.cpp_CCharacter_FUN_0042bd30 ; 005fc33c | void core_charactr.cpp_CCharacter_FUN_0042bd30(CCharacter * this_ptr)
        ;   XREF to: 0042bd30 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 005fc341
    MOV EDX,dword ptr [EBX + 0xbf8c]    ; 005fc344
        ;   Label: LAB_005fc344
    CMP EDX,dword ptr [ESI]             ; 005fc34a
    JNZ 0x005fc3b0                      ; 005fc34c | LAB_005fc3b0
    ...
    PUSH ECX                            ; 005fc35a
    PUSH EBX                            ; 005fc35b
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 005fc35c | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
    ...
    PUSH EAX                            ; 005fc36d
    PUSH EBX                            ; 005fc36e
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 005fc36f | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDX                            ; 005fc380
    PUSH EBX                            ; 005fc381
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 005fc382 | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ...
    PUSH ECX                            ; 005fc393
    PUSH EBX                            ; 005fc394
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 005fc395 | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDI                            ; 005fc3a6
    PUSH EBX                            ; 005fc3a7
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 005fc3a8 | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 005fc3ad
    PUSH 0x6589b9                       ; 005fc3b0 | = "limb?.wav" | s_limb_wav_006589b9 = limb?.wav
        ;   Label: LAB_005fc3b0
    PUSH EBX                            ; 005fc3b5
    CALL core_charactr.cpp_CCharacter_FUN_0042f300 ; 005fc3b6 | void core_charactr.cpp_CCharacter_FUN_0042f300(CCharacter * this_ptr)
        ;   XREF to: 0042f300 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005fc3bb
    PUSH EBP                            ; 005fc3be
    CALL core_bodypart.cpp_FUN_0041a050 ; 005fc3bf | undefined core_bodypart.cpp_FUN_0041a050()
    ...
    JZ 0x005fc4a3                       ; 005fc3d6 | LAB_005fc4a3
