...

{
  ...
  pcVar7 = "true";
  (pCVar4->base_enemy).base_character.base_actor.vtable._ub = &g_CZombieVTable;
  core_skeleton_cpp_CDeformableModelInstance_init_FUN_005a0840
            (&(pCVar4->base_enemy).base_character.model,"zombie1.dfm");
  ...
  pcVar8 = pCVar4->field1_0xbeb4 + 0x28;
  pCVar2 = &pCVar4->base_enemy;
  ...
  *(float *)((pCVar4->base_enemy).base_character.cloth_data + 0x34c) = fVar5;
  ...
  *(int *)(pCVar4->field1_0xbeb4 + 0xc) = iVar6;
