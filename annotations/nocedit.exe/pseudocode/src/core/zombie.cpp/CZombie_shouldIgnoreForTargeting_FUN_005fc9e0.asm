...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_zombie_cpp_CZombie_shouldIgnoreForTargeting_FUN_005fc9e0(CZombie *this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EAX,dword ptr [ESP + 0x4]       ; 005fc9e0
        ;   Label: core_zombie.cpp_CZombie_shouldIgnoreForTargeting_FUN_005fc9e0
