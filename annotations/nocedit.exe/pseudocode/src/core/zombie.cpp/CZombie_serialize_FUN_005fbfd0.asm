...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_zombie_cpp_CZombie_serialize_FUN_005fbfd0(CZombie *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005fbfd6
    CALL core_enemy.cpp_CEnemy_serialize_FUN_004a9660 ; 005fbfd7
    ...
    PUSH EAX                            ; 005fbfea
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 005fbfeb
    ...
    PUSH EAX                            ; 005fbffe
    CALL core_actor.cpp_serializedDeformableModelInstance_FUN_0040b970 ; 005fbfff
    ...
    PUSH EAX                            ; 005fc022
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 005fc023
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH EAX                            ; 005fc036
    CALL core_actor.cpp_serializeMotionState_FUN_0040b9f0 ; 005fc037
    ...
    PUSH EAX                            ; 005fc053
    CALL core_actor.cpp_serializePartStatus_FUN_0040bae0 ; 005fc054
    ...
    PUSH EAX                            ; 005fc072
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 005fc073
    ...
    PUSH EAX                            ; 005fc08f
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 005fc090
    ...
    PUSH EAX                            ; 005fc0ac
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 005fc0ad
        ;   XREF to: 0040b870 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeActor_FUN_0040b870(CDemonActor * actor_ptr, char * property_name)
    ...
    PUSH EAX                            ; 005fc0d0
    CALL core_actor.cpp_serializeClothList_FUN_0040be60 ; 005fc0d1
    ...
    PUSH EAX                            ; 005fc0ed
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 005fc0ee
    ...
    PUSH EBX                            ; 005fc10d
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 005fc10e
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
