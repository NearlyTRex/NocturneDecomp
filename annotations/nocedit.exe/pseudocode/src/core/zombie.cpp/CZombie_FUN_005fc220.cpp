...
switchD_005fc256_default:
  ...
  if (((((iVar1 == this_ptr->part_indices[0]) || (iVar1 == this_ptr->part_indices[1])) ||
    ...
    if (this_ptr->part_indices[6] == *in_stack_00000008) {
      local_14 = 0.05;
    }
    if (this_ptr->part_indices[5] == *in_stack_00000008) {
      local_14 = 0.02;
    }
    ...
    if (iVar1 != 0) {
      body_part = core_bodypart_cpp_createBodyPart_FUN_00418e10
                            (&(this_ptr->base).base.base.location.position,
                             &(this_ptr->base).base.base.orient,(CVector3f *)(in_stack_00000008 + 3)
      ...
      if (this_ptr->part_indices[5] == *in_stack_00000008) {
        ...
        core_charactr_cpp_CCharacter_detachBodyPart_FUN_0042bcc0
                  ((CCharacter *)this_ptr,this_ptr->part_indices[6]);
      }
