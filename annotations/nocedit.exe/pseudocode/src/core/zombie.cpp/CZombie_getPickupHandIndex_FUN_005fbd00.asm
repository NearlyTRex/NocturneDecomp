...
;
; XREF[3]:
;   core_zombie.cpp_CZombie_canPickupWithHand_FUN_005fbda0 at 005fbdab
;   core_zombie.cpp_CZombie_processPickup_FUN_005fb530 at 005fb6de
...
section .text
    ...
    PUSH EBX                            ; 005fbd00
        ;   Label: core_zombie.cpp_CZombie_getPickupHandIndex_FUN_005fbd00
    PUSH EBP                            ; 005fbd01
    ...
    PUSH EAX                            ; 005fbd19
    CALL crt_string.c__stricmp_FUN_005fe7f0 ; 005fbd1a
    ...
    PUSH EAX                            ; 005fbd35
    CALL crt_string.c__strnicmp_FUN_005ff070 ; 005fbd36
