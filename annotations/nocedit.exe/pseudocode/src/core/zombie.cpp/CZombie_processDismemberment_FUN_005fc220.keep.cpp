// Name: core_zombie.cpp_CZombie_processDismemberment_FUN_005fc220
// Address: 005fc220
// MANUAL RECONSTRUCTION
// Address Range: [[005fc220, 005fc4ea]]
// Convention: __cdecl
// Signature: void __cdecl core_zombie_cpp_CZombie_processDismemberment_FUN_005fc220(CZombie *this_ptr,SDamageInfo *damage_info)
...
switchD_005fc256_default:
  ...
  if (((((iVar2 == this_ptr->part_indices[0]) || (iVar2 == this_ptr->part_indices[1])) ||
       (iVar2 == this_ptr->part_indices[2])) ||
      ((iVar2 == this_ptr->part_indices[3] || (iVar2 == this_ptr->part_indices[5])))) ||
     (iVar2 == this_ptr->part_indices[6])) {
  ...
  iVar2 = damage_info->hit_part_index;
  if (iVar2 == this_ptr->part_indices[6]) {
    damage_info->damage_amount = damage_info->damage_amount * (float)2.5;
    return;
  }
  if ((iVar2 != this_ptr->part_indices[4]) && (iVar2 != this_ptr->part_indices[5])) {
