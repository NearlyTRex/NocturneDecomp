...
// Convention: __cdecl
// Signature: int __cdecl core_zombie_cpp_CZombie_PickupSomethingPossibly_FUN_005fb530(void)
...

{
  ...
  fVar11 = *(float *)(in_stack_00000004[1].base.create_event + 0x28) - in_stack_00000008;
  *(float *)(in_stack_00000004[1].base.create_event + 0x28) = fVar11;
  if (0.0 < fVar11) {
  ...
  if (0.0 < *(float *)(in_stack_00000004[1].base.create_event + 0x2c)) {
    fVar11 = *(float *)(in_stack_00000004[1].base.create_event + 0x2c) - in_stack_00000008;
    *(float *)(in_stack_00000004[1].base.create_event + 0x2c) = fVar11;
    if (0.0 <= fVar11) {
      return 0;
    }
    pCVar5 = in_stack_00000004 + 1;
    (pCVar5->base).create_event[0x2c] = '\0';
    (pCVar5->base).create_event[0x2d] = '\0';
    (pCVar5->base).create_event[0x2e] = '\0';
    (pCVar5->base).create_event[0x2f] = '\0';
    return 0;
  }
  iVar7 = *(int *)(in_stack_00000004[1].base.create_event + 0x30);
  ...
  if (iVar7 == 0) {
    ...
    for (local_18 = 0; local_18 < (int)g_CDemonSetPtr->actor_list_ptr; local_18 = local_18 + 1) {
      ...
      if ((pCVar6 == (CDemonActor *)0x0) &&
         (iVar8 = (*((pCVar2->vtable)._ub)->canPickup)(pCVar2,&in_stack_00000004->base), iVar8 == 3)
         ) {
        ...
        if (((local_14 != 0.0) && (iVar8 = core_zombie_cpp_CZombie_FUN_005fbda0(), iVar8 != 0)) &&
          ...
          if (((float)5 <= fVar11) &&
             (fVar11 <= *(float *)(in_stack_00000004[1].base.create_event + 0x20) * 15.0f))
          {
    ...
    *(uint *)(in_stack_00000004[1].base.create_event + 0x30) = auStack_14c[iVar10 + -5];
    iVar7 = *(int *)(in_stack_00000004[1].base.create_event + 0x24);
    fVar11 = afStack_124[iVar10 + -5];
    pCVar5 = in_stack_00000004 + 1;
    (pCVar5->base).create_event[0x2c] = '\0';
    (pCVar5->base).create_event[0x2d] = '\0';
    (pCVar5->base).create_event[0x2e] = ' ';
    (pCVar5->base).create_event[0x2f] = -0x3e;
    *(float *)(in_stack_00000004[1].base.create_event + 0x34) = fVar11;
    *(int *)(in_stack_00000004[1].base.create_event + 0x24) = iVar7 + 1;
    engine_console_cpp_CConsole_printf_FUN_00441890
              (g_CConsolePtr,"%s is going to try to pick up %s\n");
    return 1;
  }
  iVar7 = (**(code **)(*(int *)(iVar7 + 0x154) + 0x8c))();
  if (iVar7 != 0) {
    engine_console_cpp_CConsole_printf_FUN_00441890
              (g_CConsolePtr,"%s can't pick up %s, sombody else beat me to it!\n");
    pCVar5 = in_stack_00000004 + 1;
    (pCVar5->base).create_event[0x30] = '\0';
    (pCVar5->base).create_event[0x31] = '\0';
    (pCVar5->base).create_event[0x32] = '\0';
    (pCVar5->base).create_event[0x33] = '\0';
    pCVar5 = in_stack_00000004 + 1;
    (pCVar5->base).create_event[0x2c] = '\0';
    (pCVar5->base).create_event[0x2d] = '\0';
    (pCVar5->base).create_event[0x2e] = '\0';
  ...
  iVar7 = *(int *)(in_stack_00000004[1].base.create_event + 0x30);
  fVar11 = (pCVar1->position).x - *(float *)(iVar7 + 0x20);
  fVar4 = (in_stack_00000004->base).location.position.z - *(float *)(iVar7 + 0x28);
  fVar11 = (float)5 - SQRT(fVar4 * fVar4 + fVar11 * fVar11) * (float)0.33333333333333298;
  if (fVar11 < 1.0) {
    fVar11 = 1.0;
  }
  iVar10 = -1;
  *(float *)(in_stack_00000004[1].base.create_event + 0x2c) =
       in_stack_00000008 * fVar11 + *(float *)(in_stack_00000004[1].base.create_event + 0x2c);
  iVar7 = core_zombie_cpp_CZombie_FUN_005fbd00();
  if ((((-1 < iVar7) && (*(float *)(in_stack_00000004[1].base.create_event + 0x2c) < 0.0)) &&
      (iVar8 = (**(code **)(*(int *)(*(int *)(in_stack_00000004[1].base.create_event + 0x30) + 0x154
                                    ) + 0x7c))(), iVar8 == 3)) &&
     (iVar8 = core_zombie_cpp_CZombie_FUN_005fbda0(), iVar8 != 0)) {
...
LAB_005fba18:
        iVar10 = *(int *)(in_stack_00000004[1].base.create_event + 0x30);
  ...
  if (iVar10 < 0) {
    ...
    (pCVar5->base).create_event[0x2c] = '\0';
    (pCVar5->base).create_event[0x2d] = '\0';
    (pCVar5->base).create_event[0x2e] = -0x60;
    (pCVar5->base).create_event[0x2f] = 'A';
    core_zombie_cpp_CZombie_FUN_005fca10();
    return 0;
  }
  if (iVar10 < 1) {
  ...
  engine_console_cpp_CConsole_printf_FUN_00441890(g_CConsolePtr,"%s beginning to pickup %s\n");
  uVar3 = *(uint *)(in_stack_00000004[1].base.create_event + 0x34);
  if (uVar3 < 2) {
    if (uVar3 != 1) {
LAB_005fbae6:
...
LAB_005fba91:
  core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
            (&(in_stack_00000004->model).motion_controller,iVar7,1);
  return 1;
}
