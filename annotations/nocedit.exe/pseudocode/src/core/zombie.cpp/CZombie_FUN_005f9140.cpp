...

{
  ...
  *(int *)(this_ptr->field4_0xbf48 + 0x48) = iVar2;
  ...
  ;
  if (iVar2 == 0) {
    uVar1 = *(uint *)(this_ptr->field4_0xbf48 + 0x30);
    *(uint *)(this_ptr->field4_0xbf48 + 0x30) =
         *(uint *)(this_ptr->field4_0xbf48 + 0x38);
    *(uint *)(this_ptr->field4_0xbf48 + 0x38) = uVar1;
    uVar1 = *(uint *)(this_ptr->field4_0xbf48 + 0x34);
    *(uint *)(this_ptr->field4_0xbf48 + 0x34) =
         *(uint *)(this_ptr->field4_0xbf48 + 0x3c);
    *(uint *)(this_ptr->field4_0xbf48 + 0x3c) = uVar1;
  }
  *(uint *)(this_ptr->base_enemy).base_character.carry_hands[0].field0_0x0 =
       *(uint *)(this_ptr->field4_0xbf48 + 8);
  *(uint *)((this_ptr->base_enemy).base_character.carry_hands[0].field0_0x0 + 4) =
       *(uint *)(this_ptr->field4_0xbf48 + 0x34);
  *(uint *)(this_ptr->base_enemy).base_character.carry_hands[1].field0_0x0 =
       *(uint *)(this_ptr->field4_0xbf48 + 0xc);
  *(uint *)((this_ptr->base_enemy).base_character.carry_hands[1].field0_0x0 + 4) =
       *(uint *)(this_ptr->field4_0xbf48 + 0x3c);
