...
// Convention: unknown
// Signature: undefined4 core_zombie_cpp_CZombie_FUN_005fbda0(void)
...
uint core_zombie_cpp_CZombie_FUN_005fbda0(void)

{
  ...
  if ((-1 < iVar1) && (iVar1 = *(int *)(in_stack_00000004 + 0x24b0 + iVar1 * 0x44), -1 < iVar1)) {
    return *(uint *)(in_stack_00000004 + 0x2298 + iVar1 * 4);
  }
  return 0;
}
