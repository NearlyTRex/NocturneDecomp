...

{
  ...
  this_ptr->bone_indices[5] = iVar2;
  iVar2 = core_skeleton_cpp_CSkeleton_findBone_FUN_00599fc0
                    (this_ptr_01,"Bip01 R UpperArm",1);
  this_ptr->bone_indices[6] = iVar2;
  iVar2 = core_skeleton_cpp_CSkeleton_findBone_FUN_00599fc0(this_ptr_01,"Bip01 L Foot",1);
  this_ptr->bone_indices[7] = iVar2;
  iVar2 = core_skeleton_cpp_CSkeleton_findBone_FUN_00599fc0(this_ptr_01,"Bip01 R Foot",1);
  this_ptr->bone_indices[8] = iVar2;
  iVar2 = core_skeleton_cpp_CSkeleton_findBone_FUN_00599fc0(this_ptr_01,"Bip01 L Hand",1);
  ...
  iVar2 = core_skeleton_cpp_CSkeleton_findBone_FUN_00599fc0(this_ptr_01,"Bip01 Spine",1);
  this_ptr->bone_indices[9] = iVar2;
  iVar2 = core_skeleton_cpp_CSkeleton_findBone_FUN_00599fc0(this_ptr_01,"Bip01 Spine2",1);
  this_ptr->bone_indices[10] = iVar2;
  ...
  iVar2 = _stricmp(str1,"newzchik.dfm");
  if (((iVar2 == 0) ||
      (iVar2 = _stricmp(str1,"zombho1.dfm"), iVar2 == 0)) ||
     (iVar2 = _stricmp(str1,"zombho2.dfm"), iVar2 == 0)) {
