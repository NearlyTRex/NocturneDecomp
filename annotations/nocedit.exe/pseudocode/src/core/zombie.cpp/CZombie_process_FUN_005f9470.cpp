...

{
  ...
  pCVar20 = (this_ptr->base).base.grabbed_by;
  ...
  if (0.0 < *(float *)(this_ptr->unk2 + 0x4c)) {
    *(float *)(this_ptr->unk2 + 0x4c) = *(float *)(this_ptr->unk2 + 0x4c) - delta_time;
  }
...
LAB_005f9541:
      ...
      if (uVar11 < 6) {
        if (*(int *)((this_ptr->base).unk2 + 4) != 0) {
          ...
          if (SQRT(local_198 * local_198 + local_1a0 * local_1a0) <= 1.0) {
            ...
            core_setcolid_cpp_CDemonSet_initMaybe_FUN_00574180(g_CDemonSetPtr);
            if ((iVar9 != 0) ||
               (iVar14 = (**(code **)(*(int *)(*(int *)((this_ptr->base).unk2 + 4) + 0x154) + 0x100)
                         )(), iVar14 != 0)) {
              if (iVar9 != 0) {
      ...
      if (*(int *)((this_ptr->base).unk2 + 4) != 0) {
        pCVar12 = core_skeleton_cpp_CDeformableModelInstance_getBoneWorldPosition_FUN_0059fa20
                            (local_20,&local_29c,*(int *)(this_ptr->unk2 + 4));
        core_actor_cpp_CDemonActor_localToWorldPoint_FUN_00408ec0
                  ((CDemonActor *)this_ptr,&local_248,pCVar12);
        if (*(int *)(this_ptr->unk2 + 0x40) < 0) {
          iVar9 = *(int *)((this_ptr->base).unk2 + 4);
        ...
        iVar9 = (**(code **)(*(int *)(*(int *)((this_ptr->base).unk2 + 4) + 0x154) + 0x120))();
        if (0 < iVar9) {
      ...
      pCVar20 = (this_ptr->base).base.carry_hands[iVar9].carry_actor;
      if (pCVar20 != (CDemonActor *)0x0) {
        engine_console_cpp_CConsole_printf_FUN_00441890
        ...
        if (*(int *)((this_ptr->base).unk2 + 4) != 0) {
          ...
          pCVar12 = core_actor_cpp_CDemonActor_localToWorldPoint_FUN_00408ec0
                              ((this_ptr->base).base.carry_hands[iVar9].carry_actor,&local_c8,
                               &local_ec);
          pfVar16 = (float *)(**(code **)(*(int *)(*(int *)((this_ptr->base).unk2 + 4) + 0x154) +
                                         0x14))();
      ...
      if (*(CDoor **)(this_ptr->unk1 + 0x24) != (CDoor *)0x0) {
        core_door_cpp_CDoor_FUN_00480de0(*(CDoor **)(this_ptr->unk1 + 0x24));
        (**(code **)(*(int *)(*(int *)(this_ptr->unk1 + 0x24) + 0x154) + 0x24))();
      ...
      if (uVar11 < 0x66) {
        ...
        pCVar12 = core_skeleton_cpp_CDeformableModelInstance_getBoneWorldPosition_FUN_0059fa20
                            (pCVar2,&local_11c,*(int *)(this_ptr->unk2 + 4));
        core_actor_cpp_CDemonActor_localToWorldPoint_FUN_00408ec0
  ...
  fVar6 = (float)0.5;
  iVar9 = *(int *)(this_ptr->unk2 + 0x3c);
  *(float *)((this_ptr->base).base.unk1 + 0x28) =
       (this_ptr->base).base.model.accumulated_root_motion.z;
  *(float *)((this_ptr->base).base.unk1 + 0x2c) = delta_time * fVar7 * fVar3 * fVar6;
  if (((((this_ptr->base).base.model.part_visibility_flags[iVar9] == 0) &&
       ((this_ptr->base).base.model.part_visibility_flags[*(int *)(this_ptr->unk2 + 0x34)] == 0)) ||
      ((this_ptr->base).base.model.part_visibility_flags[*(int *)(this_ptr->unk2 + 0x48)] == 0)) &&
     ((0.0 <= *(float *)(this_ptr->unk2 + 0x50) &&
      (fVar3 = *(float *)(this_ptr->unk2 + 0x50) + delta_time,
      *(float *)(this_ptr->unk2 + 0x50) = fVar3, (float)6 <= fVar3)))) {
    ...
    this_ptr->unk2[0x52] = -0x80;
    this_ptr->unk2[0x53] = -0x41;
  }
...
LAB_005fa85e:
          ...
          cVar24 = (this_ptr->base).base.model.part_visibility_flags
                   [*(int *)(this_ptr->unk2 + 0x34)] != 0;
          if ((this_ptr->base).base.model.part_visibility_flags[*(int *)(this_ptr->unk2 + 0x3c)] !=
              0) {
            cVar24 = cVar24 + '\x01';
          }
          ...
          if (iVar9 == 0) {
            ...
            if (((-1 < local_40) &&
                (pCVar20 = (this_ptr->base).base.carry_hands[local_40].carry_actor,
                pCVar20 != (CDemonActor *)0x0)) && (*(int *)(this_ptr->unk1 + 0x1c) == 1)) {
              local_44 = 1.0;
              if (pCVar20 != (CDemonActor *)0x0) {
            ...
            if (iVar9 < 0) {
              ...
              iVar14 = core_zombie_cpp_CZombie_FUN_005fbd00();
              iVar9 = *(int *)((this_ptr->base).unk2 + 4);
              local_1ac = (this_ptr->base).base.base.location.position.x - *(float *)(iVar9 + 0x20);
              local_1a8 = (this_ptr->base).base.base.location.position.y - *(float *)(iVar9 + 0x24);
              local_1a4 = (this_ptr->base).base.base.location.position.z - *(float *)(iVar9 + 0x28);
              if (SQRT(local_1a4 * local_1a4 + local_1ac * local_1ac + local_1a8 * local_1a8) <
                ...
                if (((ABS(pCVar12->y) < (float)0.261799387791667) && (-1 < iVar14)) &&
                   (uVar11 = *(uint *)(this_ptr->unk1 + 0x1c), 1 < uVar11)) {
                  if (uVar11 < 3) {
                    if ((this_ptr->base).base.carry_hands[iVar14].carry_actor != (CDemonActor *)0x0)
                    {
                      engine_console_cpp_CConsole_printf_FUN_00441890
                      ...
                      core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                          ...
                          ((this_ptr->base).base.carry_hands[iVar14].carry_actor !=
                           (CDemonActor *)0x0)) {
                    engine_console_cpp_CConsole_printf_FUN_00441890
            ...
            else if (((cVar24 != '\0') && (*(float *)(this_ptr->base).unk2 <= 0.0)) &&
                    (iVar9 = (**(code **)(*(int *)(*(int *)((this_ptr->base).unk2 + 4) + 0x154) +
                                         0x108))(), iVar9 == 0)) {
              if ((local_40 < 0) ||
...
LAB_005fac96:
          ...
          iVar9 = core_zombie_cpp_CZombie_FUN_005fbd00();
          if ((((iVar9 < 0) ||
               (iVar14 = (**(code **)(*(int *)(*(int *)((this_ptr->base).unk2 + 4) + 0x154) + 0x120)
                         )(), 0 < iVar14)) ||
              ((this_ptr->base).base.carry_hands[iVar9].carry_actor == (CDemonActor *)0x0)) ||
             (iVar14 = (**(code **)(*(int *)(*(int *)((this_ptr->base).unk2 + 4) + 0x154) + 0x108))
                                 (), iVar14 != 0)) {
            engine_console_cpp_CConsole_printf_FUN_00441890
        ...
        if (0xd < uVar11) {
          if (uVar11 < 0xf) {
            iVar9 = core_event_cpp_CEventList_evaluateCondition_FUN_004adca0
                              (g_CEventListPtr,this_ptr->unk1 + 0x28);
            if ((iVar9 != 0) &&
               (fVar3 = *(float *)(this_ptr->unk2 + 0x5c) - delta_time,
               *(float *)(this_ptr->unk2 + 0x5c) = fVar3, fVar3 < 0.0)) {
              iVar9 = 0;
              local_28 = 0;
              *(float *)(this_ptr->unk2 + 0x5c) = *(float *)(this_ptr->unk2 + 0x5c) + 1.0;
              local_24 = pCVar1;
            ...
            if (((iVar9 != 0) &&
               ...
               (ABS((this_ptr->base).base.base.location.position.y - *(float *)(iVar9 + 0x24)) <=
                (float)2)) {
              core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                        (&pCVar2->motion_controller,0,1);
            }
...
LAB_005fa279:
          core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
              ...
              (fVar3 = *(float *)(this_ptr->unk2 + 0x60) - delta_time,
              *(float *)(this_ptr->unk2 + 0x60) = fVar3, fVar3 <= 0.0)) {
        pCVar5 = (this_ptr->base).base.base.vtable._ue;
        this_ptr->unk2[0x60] = '\0';
        ...
        if (iVar9 != 0) {
          ...
          local_250 = (this_ptr->base).base.base.location.position.y - *(float *)(iVar9 + 0x24);
          local_24c = (this_ptr->base).base.base.location.position.z - *(float *)(iVar9 + 0x28);
          ...
          if (local_5c <= (float)8) {
            local_30 = *(float *)((this_ptr->base).base.cloth_data + 0x358);
            if (local_30 < *(float *)((this_ptr->base).base.cloth_data + 0x354)) {
              local_30 = (this_ptr->base).base.model.bounding_box.max.y;
            }
            if (local_30 < *(float *)((this_ptr->base).base.cloth_data + 0x354)) {
              local_30 = *(float *)((this_ptr->base).base.cloth_data + 0x354) +
                         (float)0.5;
            }
            iVar9 = 0;
            do {
              ...
              local_18 = (CVector3f *)
                         core_setcolid_cpp_CDemonSet_testCapsuleCollision_FUN_00573470
                                   (g_CDemonSetPtr,(this_ptr->base).base.base.location.position.x,
                                    ...
                                    (float)(fVar26 * (float10)0.050000000000000003),
                                    (float)(fVar25 * (float10)0.050000000000000003),
                                    *(float *)((this_ptr->base).base.cloth_data + 0x348),
                                    (void *)((this_ptr->base).base.base.location.position.y +
                                            *(float *)((this_ptr->base).base.cloth_data + 0x354)),
                                    (void *)((this_ptr->base).base.base.location.position.y +
                                            local_30));
              local_14 = local_18;
              core_setcolid_cpp_CDemonSet_initMaybe_FUN_00574180(g_CDemonSetPtr);
...
LAB_005fa18b:
    if ((0.0 <= local_34) && (*(int *)((this_ptr->base).unk2 + 4) != 0)) {
      ...
      *(float *)((this_ptr->base).base.unk1 + 0x28) = local_4c * (this_ptr->base).speed * delta_time
      ;
      *(float *)((this_ptr->base).base.unk1 + 0x2c) = delta_time * fVar3 * fVar6;
      local_e0 = 0;
      local_d8 = local_34;
      local_dc = 0;
      (**(code **)(*(int *)(*(int *)((this_ptr->base).unk2 + 4) + 0x154) + 0xbc))();
      ...
      if (iVar9 != 1) {
        ...
        core_zombie_cpp_CZombie_FUN_005fca10();
        pCVar8 = &this_ptr->base;
        (pCVar8->base).unk1[0xc] = '\0';
        (pCVar8->base).unk1[0xd] = '\0';
        (pCVar8->base).unk1[0xe] = '\0';
        (pCVar8->base).unk1[0xf] = '\0';
      }
    }
  }
  else {
    uVar11 = *(uint *)((this_ptr->base).base.unk2 + 0x10);
    if (uVar11 < 2) {
      if (uVar11 == 1) {
LAB_005f9ea6:
        if (iVar9 != 1) {
    ...
    if (iVar9 != 0xf) {
      ...
      if (iVar14 != 0) {
        ...
        *(float *)((this_ptr->base).base.unk1 + 0x20) =
        ...
        local_260 = *(float *)((this_ptr->base).base.unk1 + 0x1c) * delta_time;
        local_25c = *(float *)((this_ptr->base).base.unk1 + 0x20) * delta_time;
        pcVar21 = (this_ptr->base).base.unk1 + 0x10;
        local_258 = delta_time * *(float *)((this_ptr->base).base.unk1 + 0x24);
        pCVar12 = &(this_ptr->base).base.model.accumulated_root_motion;
        local_110 = local_260 + *(float *)pcVar21;
        local_10c = local_25c + *(float *)((this_ptr->base).base.unk1 + 0x14);
        local_108 = local_258 + *(float *)((this_ptr->base).base.unk1 + 0x18);
        ...
        pCVar8 = &this_ptr->base;
        (pCVar8->base).unk1[0x18] = '\0';
        (pCVar8->base).unk1[0x19] = '\0';
        (pCVar8->base).unk1[0x1a] = '\0';
        (pCVar8->base).unk1[0x1b] = '\0';
        *(uint *)((this_ptr->base).base.unk1 + 0x14) =
             *(uint *)((this_ptr->base).base.unk1 + 0x18);
        *(float *)pcVar21 = *(float *)((this_ptr->base).base.unk1 + 0x14);
        (this_ptr->base).base.model.accumulated_root_motion.z = 0.0;
        ...
        if ((iVar9 == 1) &&
          ...
          if (ABS(pCVar12->y) < (float)0.34906585038888899) {
            ...
            *(CDemonActor **)(this_ptr->unk1 + 0x24) = local_58;
          }
        }
      }
      goto LAB_005f9f22;
...
LAB_005f9f22:
  ...
  if ((this_ptr->base).pool_me == 0) {
    ...
    if ((*(int *)(this_ptr->unk2 + 0x40) < 0) &&
       ((this_ptr->base).base.model.part_visibility_flags[*(int *)(this_ptr->unk2 + 0x44)] != 0)) {
      (this_ptr->base).base.model.part_visibility_flags[*(int *)(this_ptr->unk2 + 0x44)] = 0;
      core_charactr_cpp_CCharacter_FUN_0042b760((CCharacter *)this_ptr);
      (this_ptr->base).base.model.part_visibility_flags[*(int *)(this_ptr->unk2 + 0x44)] = 1;
    }
    core_charactr_cpp_CCharacter_FUN_0042b670((CCharacter *)this_ptr);
  }
  iVar9 = core_zombie_cpp_CZombie_FUN_005fbd00();
  if (((local_48 != 0) && (-1 < iVar9)) &&
     (pCVar20 = (this_ptr->base).base.carry_hands[iVar9].carry_actor, pCVar20 != (CDemonActor *)0x0)
     ) {
