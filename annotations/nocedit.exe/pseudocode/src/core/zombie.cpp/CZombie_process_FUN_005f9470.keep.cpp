          ...
          if (pCVar18 != (CDemonActor *)0x0) {
            ...
            if (-1 < iVar6) {
              ...
              engine_console_cpp_CConsole_printf_FUN_00441890
                        (g_CConsolePtr,"%s picked up %s using hand %d\n",(this_ptr->base).base.base.actor_name,pCVar18->actor_name,iVar6);
            }
          }
        }
        else {
LAB_005f9541:
      ...
      if (pCVar18 != (CDemonActor *)0x0) {
        engine_console_cpp_CConsole_printf_FUN_00441890
                  (g_CConsolePtr,"%s lugging %s\n",(this_ptr->base).base.base.actor_name,pCVar18->actor_name);
        local_14c.x = 0.0;
        local_14c.y = 6.0;
        local_14c.z = 17.0;
          ...
          if (iVar6 == 0) {
            ...
            if (((-1 < local_40) &&
              ...
              if (pCVar18 != (CDemonActor *)0x0) {
                ...
                core_actor_cpp_CVector3f_ctor_FUN_00410340(&local_194);
...
LAB_005fac96:
          ...
          if ((((iVar6 < 0) ||
            ...
            if (pCVar18 != (CDemonActor *)0x0) {
              ...
              local_68 = &local_1f4;
              core_actor_cpp_CVector3f_ctor_FUN_00410340(local_68);
            ...
            local_34 = local_3c;
            local_54 = core_motion_cpp_CMotionController_frameToMarkerPosition_FUN_0052e2b0
                                 (&(this_ptr->base).base.model.motion_controller);
            local_88 = (double)local_54;
        ...
        if (pCVar3 != (CCharacter *)0x0) {
          ...
          if (local_5c <= (float)8) {
            ...
            do {
              ...
              local_18 = core_setcolid_cpp_CDemonSet_testCylinderCollision_FUN_00573470
