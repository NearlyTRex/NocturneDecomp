...
section .text
    ...
    PUSH EDI                            ; 005fc4fb
    PUSH EBX                            ; 005fc4fc
    CALL core_zombie.cpp_CZombie_FUN_005fc220 ; 005fc4fd | undefined core_zombie.cpp_CZombie_FUN_005fc220()
    ...
    JZ 0x005fc607                       ; 005fc533 | LAB_005fc607
    ...
    FNSTSW AX                           ; 005fc553
    SAHF                                ; 005fc555
    JC 0x005fc671                       ; 005fc556 | LAB_005fc671
        ;   XREF to: 005fc671 (CONDITIONAL_JUMP)
    PUSH EDX                            ; 005fc55c
    MOV dword ptr [EBX + 0x243c],0x0    ; 005fc55d
    CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0 ; 005fc567 | SMotion * core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0(CMotionController * this_ptr)
        ;   XREF to: 0052dab0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EAX + 0x24]      ; 005fc56c
    ADD ESP,0x4                         ; 005fc56f
    CMP EAX,0x8                         ; 005fc572
    JZ 0x005fc5f9                       ; 005fc575 | LAB_005fc5f9
        ;   XREF to: 005fc5f9 (CONDITIONAL_JUMP)
    CMP EAX,0x7                         ; 005fc57b
    JZ 0x005fc5f9                       ; 005fc57e | LAB_005fc5f9
        ;   XREF to: 005fc5f9 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 005fc580
    PUSH EBX                            ; 005fc581
    CALL core_zombie.cpp_CZombie_FUN_005fbde0 ; 005fc582 | undefined core_zombie.cpp_CZombie_FUN_005fbde0()
    ...
    JZ 0x005fc612                       ; 005fc59e | LAB_005fc612
    ...
    PUSH EAX                            ; 005fc5a9
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 005fc5aa | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005fc5af
    MOV ESI,dword ptr [EBX + 0xbf9c]    ; 005fc5b2
    PUSH ESI                            ; 005fc5b8
    CALL sound_sndmain.cpp_killSfx_FUN_005a9c40 ; 005fc5b9 | int sound_sndmain.cpp_killSfx_FUN_005a9c40(uint sfx_handle)
        ;   XREF to: 005a9c40 (UNCONDITIONAL_CALL)
    MOV EBP,dword ptr [EBX + 0xbf48]    ; 005fc5be
    ADD ESP,0x4                         ; 005fc5c4
    TEST EBP,EBP                        ; 005fc5c7
    JZ 0x005fc667                       ; 005fc5c9 | LAB_005fc667
        ;   XREF to: 005fc667 (CONDITIONAL_JUMP)
    PUSH 0x6589e9                       ; 005fc5cf | = "f-zombie-die?.wav" | s_f_zombie_die_wav_006589e9 = f-zombie-die?.wav
    ...
    PUSH EDI                            ; 005fc5f9
        ;   Label: LAB_005fc5f9
    PUSH EBX                            ; 005fc5fa
    CALL core_enemy.cpp_FUN_004a9f10    ; 005fc5fb | undefined core_enemy.cpp_FUN_004a9f10()
    ...
    PUSH EAX                            ; 005fc643
    CALL core_motion.cpp_CMotionController_getMotionList_FUN_0052dce0 ; 005fc644 | CMotionList * core_motion.cpp_CMotionController_getMotionList_FUN_0052dce0(CMotionController * this_ptr)
        ;   XREF to: 0052dce0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005fc649
    PUSH EAX                            ; 005fc64c
    CALL core_motion.cpp_CMotionList_findMotionIndex_FUN_0052d460 ; 005fc64d | int core_motion.cpp_CMotionList_findMotionIndex_FUN_0052d460(CMotionList * this_ptr)
        ;   XREF to: 0052d460 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005fc652
    TEST EAX,EAX                        ; 005fc655
    JL 0x005fc5a0                       ; 005fc657 | LAB_005fc5a0
        ;   XREF to: 005fc5a0 (CONDITIONAL_JUMP)
    MOV ESI,0x9                         ; 005fc65d
    JMP 0x005fc5a0                      ; 005fc662 | LAB_005fc5a0
        ;   XREF to: 005fc5a0 (UNCONDITIONAL_JUMP)
    PUSH 0x6589fb                       ; 005fc667 | = "zom-d0?.wav" | s_zom_d0_wav_006589fb = zom-d0?.wav
        ;   Label: LAB_005fc667
    JMP 0x005fc5d4                      ; 005fc66c | LAB_005fc5d4
        ;   XREF to: 005fc5d4 (UNCONDITIONAL_JUMP)
    PUSH 0x1                            ; 005fc671
        ;   Label: LAB_005fc671
    PUSH 0x4                            ; 005fc673
    PUSH EDX                            ; 005fc675
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 005fc676 | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ...
    FNSTSW AX                           ; 005fc688
    SAHF                                ; 005fc68a
    JC 0x005fc5f9                       ; 005fc68b | LAB_005fc5f9
        ;   XREF to: 005fc5f9 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [EBX + 0xbf9c]    ; 005fc691
    PUSH ECX                            ; 005fc697
    MOV dword ptr [EBX + 0xbf94],0x40000000 ; 005fc698
    CALL sound_sndmain.cpp_isSfxPlaying_FUN_005a9660 ; 005fc6a2 | int sound_sndmain.cpp_isSfxPlaying_FUN_005a9660(uint sfx_handle)
        ;   XREF to: 005a9660 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005fc6a7
    TEST EAX,EAX                        ; 005fc6aa
    JNZ 0x005fc5f9                      ; 005fc6ac | LAB_005fc5f9
        ;   XREF to: 005fc5f9 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0xbf48],0x0    ; 005fc6b2
    JZ 0x005fc6e1                       ; 005fc6b9 | LAB_005fc6e1
        ;   XREF to: 005fc6e1 (CONDITIONAL_JUMP)
    PUSH 0x658a07                       ; 005fc6bb | = "f-zombie-hit?.wav" | s_f_zombie_hit_wav_00658a07 = f-zombie-hit?.wav
    ...
    PUSH EDI                            ; 005fc6d3
    PUSH EBX                            ; 005fc6d4
    CALL core_enemy.cpp_FUN_004a9f10    ; 005fc6d5 | undefined core_enemy.cpp_FUN_004a9f10()
        ;   XREF to: 004a9f10 (UNCONDITIONAL_CALL)
    ...
    POP EBX                             ; 005fc6df
    RET                                 ; 005fc6e0
    PUSH 0x658a19                       ; 005fc6e1 | = "zom-s0?.wav" | s_zom_s0_wav_00658a19 = zom-s0?.wav
        ;   Label: LAB_005fc6e1
    ...
    PUSH EDI                            ; 005fc6f9
    PUSH EBX                            ; 005fc6fa
    CALL core_enemy.cpp_FUN_004a9f10    ; 005fc6fb | undefined core_enemy.cpp_FUN_004a9f10()
        ;   XREF to: 004a9f10 (UNCONDITIONAL_CALL)
