...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_zombie.cpp_CZombie_FUN_005fbd00()
;
;
; XREF[3]:
...
section .text
    ...
    JZ 0x005fbd26                       ; 005fbd0a | LAB_005fbd26
        ;   XREF to: 005fbd26 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + 0xc]       ; 005fbd0c
    PUSH 0x658919                       ; 005fbd0f | = "jeff.dfm" | s_jeff_dfm_00658919 = jeff.dfm
    ADD EAX,0x23b8                      ; 005fbd14
    PUSH EAX                            ; 005fbd19
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 005fbd1a | int crt_string.c_stricmp_FUN_005fe7f0(char * str1, char * str2)
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005fbd1f
    TEST EAX,EAX                        ; 005fbd22
    JZ 0x005fbd56                       ; 005fbd24 | LAB_005fbd56
        ;   XREF to: 005fbd56 (CONDITIONAL_JUMP)
    PUSH 0x3                            ; 005fbd26
        ;   Label: LAB_005fbd26
    MOV EAX,dword ptr [EBP + 0xc]       ; 005fbd28
    PUSH 0x658922                       ; 005fbd2b | = "new" | s_new_00658922 = new
    ADD EAX,0x23b8                      ; 005fbd30
    PUSH EAX                            ; 005fbd35
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 005fbd36 | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005fbd3b
    TEST EAX,EAX                        ; 005fbd3e
    JNZ 0x005fbd78                      ; 005fbd40 | LAB_005fbd78
        ;   XREF to: 005fbd78 (CONDITIONAL_JUMP)
    CMP EBX,0x2                         ; 005fbd42
    JNC 0x005fbd60                      ; 005fbd45 | LAB_005fbd60
        ;   XREF to: 005fbd60 (CONDITIONAL_JUMP)
    CMP EBX,0x1                         ; 005fbd47
    JNZ 0x005fbd67                      ; 005fbd4a | LAB_005fbd67
    ...
    POP EBX                             ; 005fbd5e
    RET                                 ; 005fbd5f
    JBE 0x005fbd4c                      ; 005fbd60 | LAB_005fbd4c
        ;   Label: LAB_005fbd60
        ;   XREF to: 005fbd4c (CONDITIONAL_JUMP)
    CMP EBX,0x3                         ; 005fbd62
    JZ 0x005fbd4c                       ; 005fbd65 | LAB_005fbd4c
        ;   XREF to: 005fbd4c (CONDITIONAL_JUMP)
    ...
    CMP EBX,0x2                         ; 005fbd78
        ;   Label: LAB_005fbd78
    JNC 0x005fbd8c                      ; 005fbd7b | LAB_005fbd8c
        ;   XREF to: 005fbd8c (CONDITIONAL_JUMP)
    CMP EBX,0x1                         ; 005fbd7d
    JZ 0x005fbd4c                       ; 005fbd80 | LAB_005fbd4c
        ;   XREF to: 005fbd4c (CONDITIONAL_JUMP)
    ...
    POP EBX                             ; 005fbd8a
    RET                                 ; 005fbd8b
    JBE 0x005fbd71                      ; 005fbd8c | LAB_005fbd71
        ;   Label: LAB_005fbd8c
        ;   XREF to: 005fbd71 (CONDITIONAL_JUMP)
    CMP EBX,0x3                         ; 005fbd8e
    JZ 0x005fbd4c                       ; 005fbd91 | LAB_005fbd4c
        ;   XREF to: 005fbd4c (CONDITIONAL_JUMP)
