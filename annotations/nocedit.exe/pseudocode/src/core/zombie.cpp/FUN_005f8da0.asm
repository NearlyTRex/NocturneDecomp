...
section .text
    ...
    PUSH EAX                            ; 005f8dc5
    CALL core_actor.cpp_CVector_ctor_FUN_00410340 ; 005f8dc6 | CVector3f * core_actor.cpp_CVector_ctor_FUN_00410340(CVector3f * this_ptr)
    ...
    CALL core_actor.cpp_CVector_ctor_FUN_00410340 ; 005f8e00 | CVector3f * core_actor.cpp_CVector_ctor_FUN_00410340(CVector3f * this_ptr)
        ;   XREF to: 00410340 (UNCONDITIONAL_CALL)
    ...
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 005f8e3b | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
