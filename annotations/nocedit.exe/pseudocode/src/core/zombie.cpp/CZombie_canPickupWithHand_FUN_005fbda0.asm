...
;
; XREF[1]:
;   core_zombie.cpp_CZombie_processPickup_FUN_005fb530 at 005fb728
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 005fbda0
        ;   Label: core_zombie.cpp_CZombie_canPickupWithHand_FUN_005fbda0
    MOV EBX,dword ptr [ESP + 0x8]       ; 005fbda1
    MOV EDX,dword ptr [ESP + 0xc]       ; 005fbda5
    PUSH EDX                            ; 005fbda9
    PUSH EBX                            ; 005fbdaa
    CALL core_zombie.cpp_CZombie_getPickupHandIndex_FUN_005fbd00 ; 005fbdab
