...
section .text
    ...
    PUSH ESI                            ; 005a2513
    MOV [0x03f48fa0],EAX                ; 005a2514 | g_SmileyIndices
    ...
    PUSH ESI                            ; 005a2528
    MOV [0x03f48fac],EAX                ; 005a2529 | g_SmileyIndices[3]
    ...
    PUSH ESI                            ; 005a253d
    MOV [0x03f48fb0],EAX                ; 005a253e | g_SmileyIndices[4]
    ...
    PUSH ESI                            ; 005a2552
    MOV [0x03f48fb4],EAX                ; 005a2553 | g_SmileyIndices[5]
    ...
    PUSH ESI                            ; 005a2567
    MOV [0x03f48fb8],EAX                ; 005a2568 | g_SmileyIndices[6]
    ...
    PUSH ESI                            ; 005a257c
    MOV [0x03f48fbc],EAX                ; 005a257d | g_SmileyIndices[7]
    ...
    PUSH ESI                            ; 005a2591
    MOV [0x03f48fc0],EAX                ; 005a2592 | g_SmileyIndices[8]
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 005a2597
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 005a259c
    MOV [0x03f48fa4],EAX                ; 005a259f | g_SmileyIndices[1]
    PUSH 0x1                            ; 005a25a4
    ...
    PUSH ESI                            ; 005a25bb
    MOV [0x03f48fa8],EAX                ; 005a25bc | g_SmileyIndices[2]
    ...
    PUSH ESI                            ; 005a25d0
    MOV [0x03f48fc4],EAX                ; 005a25d1 | g_SmileyIndices[9]
    ...
    PUSH ESI                            ; 005a25e5
    MOV [0x03f48fc8],EAX                ; 005a25e6 | g_SmileyIndices[10]
    ...
    PUSH ESI                            ; 005a25fa
    MOV [0x03f48fcc],EAX                ; 005a25fb | g_SmileyIndices[11]
    ...
    PUSH ESI                            ; 005a260f
    MOV [0x03f48fa0],EAX                ; 005a2610 | g_SmileyIndices
    ...
    PUSH ESI                            ; 005a2624
    MOV [0x03f48fb4],EAX                ; 005a2625 | g_SmileyIndices[5]
    ...
    PUSH ESI                            ; 005a2639
    MOV [0x03f48fb8],EAX                ; 005a263a | g_SmileyIndices[6]
    ...
    PUSH ESI                            ; 005a264e
    MOV [0x03f48fc4],EAX                ; 005a264f | g_SmileyIndices[9]
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 005a2654
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 005a2659
    PUSH EDI                            ; 005a265c
    MOV [0x03f48fcc],EAX                ; 005a265d | g_SmileyIndices[11]
    ...
    CALL crt_string.c__stricmp_FUN_005fe7f0 ; 005a2788
    ...
    PUSH EAX                            ; 005a27a9
    CALL crt_string.c__stricmp_FUN_005fe7f0 ; 005a27aa
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)  ; int crt_string.c__stricmp_FUN_005fe7f0(char * str1, char * str2)
