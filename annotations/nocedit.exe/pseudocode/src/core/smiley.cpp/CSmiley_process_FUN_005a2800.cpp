...

{
  ...
  fVar13 = *(float *)(this_ptr->unk2 + 0x34) - delta_time;
  *(float *)(this_ptr->unk2 + 0x34) = fVar13;
  if (fVar13 < 0.0) {
    ...
    if (uVar7 < 0x66) {
      if (uVar7 == 0x65) {
        ...
        if (pCVar3 == (CDemonActor *)0x0) {
          ...
          iVar6 = (*(((pCVar3->vtable)._uc)->_uc).cfunc6)();
          if (iVar6 == 0) {
            core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                      (&pCVar2->motion_controller,1,1);
          }
      ...
      *(int *)(this_ptr->unk2 + 0x2c) = iVar6;
      if (2 < iVar6) {
        if ((this_ptr->base).victim == (CDemonActor *)0x0) {
          ...
          (*(((pCVar4->base).vtable._uc)->_uc).processDamage)(pCVar4,&local_118);
        }
      }
    }
    else {
  ...
  if (iVar9 == 0) {
    ...
    case 1:
      ...
      if (iVar6 == 0) {
        ...
        pCVar3 = (this_ptr->base).victim;
        if (pCVar3 != (CDemonActor *)0x0) {
          local_58.x = (pCVar3->location).position.x -
                       (this_ptr->base).base.base.location.position.x;
          local_58.y = (pCVar3->location).position.y -
                       (this_ptr->base).base.base.location.position.y;
          local_58.z = (pCVar3->location).position.z -
    ...
    case 2:
      ...
      if (iVar6 == 0) {
        ...
        pCVar3 = (this_ptr->base).victim;
        if (pCVar3 != (CDemonActor *)0x0) {
          if (this_ptr == (CSmiley *)pCVar3[0x1b].prev_actor) {
            (*(((pCVar3->vtable)._uc)->_uc).cfunc7)(pCVar3);
          }
          local_8c = 2.5f;
          local_1c = 2.5f;
          (this_ptr->base).base.model.accumulated_root_motion.z = 0.0;
          ...
          local_90 = 0;
          pCVar3 = (this_ptr->base).victim;
          (*((pCVar3->vtable)._ub)->getPathMap)(pCVar3);
          iVar6 = core_charactr_cpp_CCharacter_walkToPoint_FUN_004286e0((CCharacter *)this_ptr);
          if ((-1 < iVar6) && (0 < iVar6)) {
            pCVar3 = (this_ptr->base).victim;
            local_a0 = (pCVar3->location).position.x -
                       (this_ptr->base).base.base.location.position.x;
            local_9c = (pCVar3->location).position.y -
                       (this_ptr->base).base.base.location.position.y;
            local_98 = (pCVar3->location).position.z -
                       (this_ptr->base).base.base.location.position.z;
    ...
    case 8:
      if (((this_ptr->base).pool_me == 0) &&
        ...
        pCVar11 = core_skeleton_cpp_CDeformableModelInstance_getBoneWorldPosition_FUN_0059fa20
                            (pCVar2,local_40,0);
        core_actor_cpp_CDemonActor_localToWorldPoint_FUN_00408ec0
                  ((CDemonActor *)this_ptr,&local_4c,pCVar11);
    ...
    case 9:
      pCVar4 = (CCharacter *)(this_ptr->base).victim;
      if ((pCVar4 == (CCharacter *)0x0) || (pCVar4->grabbed_by == (CDemonActor *)0x0)) {
        core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                  (&pCVar2->motion_controller,1,1);
      }
      else {
        iVar6 = (*(((pCVar4->base).vtable._uc)->_uc).isDamageable)(pCVar4);
        if (iVar6 == 0) {
          ...
          pCVar11 = core_xform_cpp_transformVector3x4_FUN_005f4dc0
                              (&local_88,&g_ZeroVector,
                               ...
                               [INT_03f48fa8].m);
          core_actor_cpp_CDemonActor_localToWorldPoint_FUN_00408ec0
                    ((CDemonActor *)this_ptr,&local_d0,pCVar11);
          core_enemy_cpp_CEnemy_FUN_004a9880(&this_ptr->base);
        }
        else {
...
LAB_005a2b8e:
    ...
    core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
              (&(this_ptr->base).base.model.motion_controller,(int)fVar13,1);
  }
  else {
...
switchD_005a3055_caseD_7:
  ...
  if (local_24 == 0xb) {
    ...
    if (iVar6 != 0) {
      pCVar3 = (this_ptr->base).victim;
      if ((pCVar3 != (CDemonActor *)0x0) &&
         (pCVar12 = (CSmiley *)(*(((pCVar3->vtable)._uc)->_uc).cfunc8)(), pCVar12 == this_ptr)) {
