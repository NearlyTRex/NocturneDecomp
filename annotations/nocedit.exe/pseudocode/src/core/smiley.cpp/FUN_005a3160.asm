...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_smiley.cpp_FUN_005a3160()
;
;
; Referenced Globals:
...
section .text
    ...
    JNZ 0x005a3179                      ; 005a316f | LAB_005a3179
    ...
    JZ 0x005a31a8                       ; 005a318b | LAB_005a31a8
    ...
    POP EBX                             ; 005a31a6
    RET                                 ; 005a31a7
    MOV EDX,dword ptr [0x03f48fa8]      ; 005a31a8 | undefined4 DAT_03f48fa8
        ;   Label: LAB_005a31a8
    ...
    PUSH EAX                            ; 005a31c2
    PUSH 0x3f87558                      ; 005a31c3 | CVector3f g_ZeroVector
    LEA EAX,[ESP + 0x14]                ; 005a31c8
    PUSH EAX                            ; 005a31cc
    CALL core_xform.cpp_transformVector3x4_FUN_005f4dc0 ; 005a31cd | CVector3f * core_xform.cpp_transformVector3x4_FUN_005f4dc0(CVector3f * output_vector, CVector3f * input_vector, CMatrix3x4f * matrix)
    ...
    PUSH EAX                            ; 005a31da
    PUSH ESI                            ; 005a31db
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 005a31dc | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
    ...
    FADD float ptr [0x0064f322]         ; 005a31f0 | float FLOAT_0064f322
    PUSH EAX                            ; 005a31f6
