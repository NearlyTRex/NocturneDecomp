...
section .text
    ...
    PUSH EDX                            ; 005a2435
    CALL core_enemy.cpp_CEnemy_ctor_FUN_004a9500 ; 005a2436 | CEnemy * core_enemy.cpp_CEnemy_ctor_FUN_004a9500(CEnemy * this_ptr)
        ;   XREF to: 004a9500 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005a243b
    PUSH 0x64f165                       ; 005a243e | = "smiley.dfm" | s_smiley_dfm_0064f165 = smiley.dfm
    MOV EBX,EAX                         ; 005a2443
    ADD EAX,0x158                       ; 005a2445
    PUSH EAX                            ; 005a244a
    MOV dword ptr [EAX + -0x4],0x662f84 ; 005a244b | CDemonActor_vtable g_CSmileyVTable
    CALL core_skeleton.cpp_CDeformableModelInstance_init_FUN_005a0840 ; 005a2452 | void core_skeleton.cpp_CDeformableModelInstance_init_FUN_005a0840(CDeformableModelInstance * this_ptr, char * model_name)
