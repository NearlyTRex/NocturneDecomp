...
;                               FUNCTION
; *****************************************************************************
; __cdecl CSmiley * __cdecl core_smiley_cpp_CSmiley_dtor_FUN_005a3880(CSmiley *this_ptr,uint flags)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005a3898
    CALL core_armour.cpp_freeFlames_FUN_00412720 ; 005a3899
    ...
    PUSH EAX                            ; 005a38a8
    CALL core_armour.cpp_freeFires_FUN_00412700 ; 005a38a9
    ...
    PUSH EAX                            ; 005a38b8
    CALL core_armour.cpp_freeVectors_FUN_004126e0 ; 005a38b9
    ...
    PUSH EAX                            ; 005a38c8
    CALL core_armour.cpp_freeVectors_FUN_004126e0 ; 005a38c9
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; CVector3f * core_armour.cpp_freeVectors_FUN_004126e0(CVector3f * objs)
