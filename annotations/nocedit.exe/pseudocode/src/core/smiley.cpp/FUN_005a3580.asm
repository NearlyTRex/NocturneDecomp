...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_smiley_cpp_FUN_005a3580(void)
;
;
; Referenced Globals:
...
section .text
    ...
    JNZ 0x005a364e                      ; 005a3591
        ;   XREF to: 005a364e (CONDITIONAL_JUMP)  ; LAB_005a364e
    MOV ECX,dword ptr [ESI + 0x30]      ; 005a3597
    CMP ECX,0x4                         ; 005a359a
    JZ 0x005a365f                       ; 005a359d
        ;   XREF to: 005a365f (CONDITIONAL_JUMP)  ; LAB_005a365f
    CMP ECX,0xb                         ; 005a35a3
    JLE 0x005a35b4                      ; 005a35a6
        ;   XREF to: 005a35b4 (CONDITIONAL_JUMP)  ; LAB_005a35b4
    CMP ECX,0x6b                        ; 005a35a8
    JZ 0x005a35b4                       ; 005a35ab
        ;   XREF to: 005a35b4 (CONDITIONAL_JUMP)  ; LAB_005a35b4
    ...
    FNSTSW AX                           ; 005a35bb
    SAHF                                ; 005a35bd
    JNC 0x005a35ca                      ; 005a35be
        ;   XREF to: 005a35ca (CONDITIONAL_JUMP)  ; LAB_005a35ca
    PUSH ESI                            ; 005a35c0
    PUSH EBX                            ; 005a35c1
    CALL core_smiley.cpp_FUN_005a32a0   ; 005a35c2
        ;   XREF to: 005a32a0 (UNCONDITIONAL_CALL)  ; void core_smiley.cpp_FUN_005a32a0()
    ...
    FNSTSW AX                           ; 005a35e4
    SAHF                                ; 005a35e6
    JC 0x005a366b                       ; 005a35e7
        ;   XREF to: 005a366b (CONDITIONAL_JUMP)  ; LAB_005a366b
    PUSH EDI                            ; 005a35ed
    MOV dword ptr [EBX + 0x243c],0x0    ; 005a35ee
    CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0 ; 005a35f8
        ;   XREF to: 0052dab0 (UNCONDITIONAL_CALL)  ; SMotion * core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0(CMotionController * this_ptr)
    MOV EAX,dword ptr [EAX + 0x24]      ; 005a35fd
    ADD ESP,0x4                         ; 005a3600
    CMP EAX,0x8                         ; 005a3603
    JZ 0x005a3640                       ; 005a3606
        ;   XREF to: 005a3640 (CONDITIONAL_JUMP)  ; LAB_005a3640
    CMP EAX,0x7                         ; 005a3608
    JZ 0x005a3640                       ; 005a360b
        ;   XREF to: 005a3640 (CONDITIONAL_JUMP)  ; LAB_005a3640
    PUSH 0x1                            ; 005a360d
    PUSH 0x7                            ; 005a360f
    PUSH EDI                            ; 005a3611
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 005a3612
    ...
    PUSH 0x64f37a                       ; 005a362e | = "smiley_die??.wav"
    ...
    MOV dword ptr [ESI + 0x30],0x64     ; 005a365f
        ;   Label: LAB_005a365f
    JMP 0x005a35ad                      ; 005a3666
        ;   XREF to: 005a35ad (UNCONDITIONAL_JUMP)  ; LAB_005a35ad
    PUSH 0x1                            ; 005a366b
        ;   Label: LAB_005a366b
    PUSH 0x3                            ; 005a366d
    PUSH EDI                            ; 005a366f
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 005a3670
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)  ; void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
