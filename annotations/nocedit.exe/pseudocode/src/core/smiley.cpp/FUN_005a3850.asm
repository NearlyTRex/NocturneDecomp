...
section .text
    ...
    PUSH ECX                            ; 005a385a
    CALL core_actor.cpp_CDemonActor_writeDependencies_FUN_0040cfd0 ; 005a385b
    ...
    PUSH EAX                            ; 005a3871
    CALL core_skeledit.cpp_CDeformableModelInstance_writeDependencies_FUN_0058a260 ; 005a3872
