...
section .text
    ...
    PUSH EBX                            ; 005a24d9
    CALL core_enemy.cpp_CEnemy_FUN_004a9650 ; 005a24da
    ...
    PUSH ESI                            ; 005a2513
    MOV [0x03f48fa0],EAX                ; 005a2514 | DAT_03f48fa0
    ...
    PUSH ESI                            ; 005a2552
    MOV [0x03f48fb4],EAX                ; 005a2553 | DAT_03f48fb4
    ...
    PUSH ESI                            ; 005a2567
    MOV [0x03f48fb8],EAX                ; 005a2568 | DAT_03f48fb8
    ...
    PUSH ESI                            ; 005a25bb
    MOV [0x03f48fa8],EAX                ; 005a25bc | DAT_03f48fa8
    ...
    PUSH ESI                            ; 005a25d0
    MOV [0x03f48fc4],EAX                ; 005a25d1 | DAT_03f48fc4
    ...
    PUSH ESI                            ; 005a25fa
    MOV [0x03f48fcc],EAX                ; 005a25fb | DAT_03f48fcc
    ...
    PUSH ESI                            ; 005a260f
    MOV [0x03f48fa0],EAX                ; 005a2610 | DAT_03f48fa0
    ...
    PUSH ESI                            ; 005a2624
    MOV [0x03f48fb4],EAX                ; 005a2625 | DAT_03f48fb4
    ...
    PUSH ESI                            ; 005a2639
    MOV [0x03f48fb8],EAX                ; 005a263a | DAT_03f48fb8
