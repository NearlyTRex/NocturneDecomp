...
;
; Referenced Globals:
;   int[12] g_SmileyIndices
;   undefined4 g_SmileyIndices[5]
;   undefined4 g_SmileyIndices[6]
;   undefined4 g_SmileyIndices[9]
...
section .text
    ...
    PUSH ESI                            ; 005a3690
        ;   Label: core_smiley.cpp_CSmiley_getTargetPoints_FUN_005a3690
    PUSH EDI                            ; 005a3691
    PUSH EBP                            ; 005a3692
    ...
    JNZ 0x005a36b0                      ; 005a36a5
        ;   XREF to: 005a36b0 (CONDITIONAL_JUMP)  ; LAB_005a36b0
    ...
    PUSH EBX                            ; 005a36b0
        ;   Label: LAB_005a36b0
    MOV ECX,dword ptr [0x03f48fa0]      ; 005a36b1 | g_SmileyIndices
    PUSH ECX                            ; 005a36b7
    ...
    JZ 0x005a36e5                       ; 005a36d3
        ;   XREF to: 005a36e5 (CONDITIONAL_JUMP)  ; LAB_005a36e5
    ...
    MOV EBP,dword ptr [0x03f48fb4]      ; 005a36e5 | g_SmileyIndices[5]
        ;   Label: LAB_005a36e5
    PUSH EBP                            ; 005a36eb
    ...
    JZ 0x005a3724                       ; 005a3712
        ;   XREF to: 005a3724 (CONDITIONAL_JUMP)  ; LAB_005a3724
    ...
    MOV EAX,[0x03f48fb8]                ; 005a3724 | g_SmileyIndices[6]
        ;   Label: LAB_005a3724
    PUSH EAX                            ; 005a3729
    ...
    JZ 0x005a3763                       ; 005a3751
        ;   XREF to: 005a3763 (CONDITIONAL_JUMP)  ; LAB_005a3763
    ...
    MOV EDX,dword ptr [0x03f48fc4]      ; 005a3763 | g_SmileyIndices[9]
        ;   Label: LAB_005a3763
    PUSH EDX                            ; 005a3769
    ...
    JZ 0x005a37a3                       ; 005a3791
        ;   XREF to: 005a37a3 (CONDITIONAL_JUMP)  ; LAB_005a37a3
    ...
    MOV ECX,dword ptr [0x03f48fcc]      ; 005a37a3 | g_SmileyIndices[11]
        ;   Label: LAB_005a37a3
    PUSH ECX                            ; 005a37a9
    ...
    JZ 0x005a37e3                       ; 005a37d1
        ;   XREF to: 005a37e3 (CONDITIONAL_JUMP)  ; LAB_005a37e3
