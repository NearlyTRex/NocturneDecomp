...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_smiley_cpp_CSmiley_load_FUN_005a3220(void)
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH ESI                            ; 005a3226
    CALL core_enemy.cpp_CEnemy_serialize_FUN_004a9660 ; 005a3227
    ...
    PUSH EBX                            ; 005a323a
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 005a323b
    ...
    PUSH EBX                            ; 005a324e
    CALL core_actor.cpp_serializedDeformableModelInstance_FUN_0040b970 ; 005a324f
    ...
    PUSH ESI                            ; 005a3262
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 005a3263
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ADD ESP,0x8                         ; 005a3268
    PUSH 0x64f344                       ; 005a326b | = "motion state"
    PUSH EBX                            ; 005a3270
    CALL core_actor.cpp_serializeMotionState_FUN_0040b9f0 ; 005a3271
