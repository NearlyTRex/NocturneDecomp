...
section .text
    ...
    PUSH EBX                            ; 005ec4f0
        ;   Label: core_waypoint.cpp_CWayPoint_rebuildConnectivity_FUN_005ec4f0
    PUSH ESI                            ; 005ec4f1
    PUSH EDI                            ; 005ec4f2
    PUSH EBP                            ; 005ec4f3
    ...
    PUSH EBX                            ; 005ec4fb
    CALL core_waypoint.cpp_CWayPoint_cleanupAdjacency_FUN_005ec830 ; 005ec4fc
    ...
    INC ESI                             ; 005ec51d
    CALL core_waypoint.cpp_CWayPoint_removeAllAdjTo_FUN_005ec640 ; 005ec51e
    ...
    CALL core_waypoint.cpp_CWayPoint_isReachable_FUN_005ebd40 ; 005ec58c
        ;   XREF to: 005ebd40 (UNCONDITIONAL_CALL)  ; int core_waypoint.cpp_CWayPoint_isReachable_FUN_005ebd40(CWayPoint * this_ptr, CLocation * from_location, int use_tight_bounds)
    ...
    PUSH EAX                            ; 005ec5a3
    CALL core_waypoint.cpp_CWayPoint_isReachable_FUN_005ebd40 ; 005ec5a4
        ;   XREF to: 005ebd40 (UNCONDITIONAL_CALL)  ; int core_waypoint.cpp_CWayPoint_isReachable_FUN_005ebd40(CWayPoint * this_ptr, CLocation * from_location, int use_tight_bounds)
