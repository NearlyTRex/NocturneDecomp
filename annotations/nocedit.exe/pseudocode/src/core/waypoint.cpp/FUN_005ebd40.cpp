...

{
  ...
  local_1c = in_stack_00000004[1] - in_stack_00000008[1];
  local_18 = in_stack_00000004[2] - in_stack_00000008[2];
  if (in_stack_0000000c == 0) {
    if ((ABS(local_1c) <= (float)10) && (ABS(local_20) <= (float)30)) {
      if ((float)30 < ABS(local_18)) {
        return false;
      }
      goto LAB_005ebde7;
    }
  }
  else if (((ABS(local_1c) <= (float)8) && (ABS(local_20) <= (float)25))
          && (ABS(local_18) <= (float)25)) {
LAB_005ebde7:
    local_14.x = *in_stack_00000004;
    local_14.y = in_stack_00000004[1];
    local_14.z = in_stack_00000004[2];
