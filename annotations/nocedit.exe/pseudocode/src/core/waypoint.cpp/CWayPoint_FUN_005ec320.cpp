...

{
  ...
  if (in_stack_00000008 != 0) {
    iVar3 = core_waypoint_cpp_CWayPoint_FUN_005ebd40(this_ptr);
    if (iVar3 != 0) {
      ...
      *(uint *)(in_stack_00000008 + 0x554) = 0;
      do {
        ...
        if (0 < *(int *)(iVar7 + 0x370)) {
          do {
            fVar2 = *(float *)(iVar7 + 0x554) + *(float *)(iVar8 + 0x378);
            iVar1 = *(int *)(iVar8 + 0x374);
            SVar6 = n;
        ...
        if (iVar3 < 1) {
          ...
          for (iVar8 = 0; iVar8 < *(int *)(g_CDemonSetPtr->unk4 + 0x5dc4); iVar8 = iVar8 + 1) {
            ...
            if ((*(float *)(iVar1 + 0x554) < local_18) &&
               (iVar5 = core_waypoint_cpp_CWayPoint_FUN_005ebd40(this_ptr), iVar5 != 0)) {
