...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_waypoint.cpp_CWayPoint_FUN_005ec5e0(CWayPoint * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005ec5e5
    CALL core_waypoint.cpp_FUN_005ec4f0 ; 005ec5e6 | undefined core_waypoint.cpp_FUN_005ec4f0()
        ;   XREF to: 005ec4f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005ec5eb
    PUSH EBX                            ; 005ec5ee
    CALL core_trigger.cpp_CTrigger_FUN_005e1180 ; 005ec5ef | void core_trigger.cpp_CTrigger_FUN_005e1180(CTrigger * this_ptr)
