...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_waypoint.cpp_CWaypoint_FUN_005ebeb0(CWayPoint * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH ESI                            ; 005ebeba
    CALL core_trigger.cpp_CTrigger_FUN_005df990 ; 005ebebb | void core_trigger.cpp_CTrigger_FUN_005df990(CTrigger * this_ptr)
    ...
    JLE 0x005ebf0f                      ; 005ebecd | LAB_005ebf0f
    ...
    JL 0x005ebed5                       ; 005ebf0c | LAB_005ebed5
        ;   XREF to: 005ebed5 (CONDITIONAL_JUMP)
    POP EDI                             ; 005ebf0e
    CMP byte ptr [ESI + 0x78],0x0       ; 005ebf0f
        ;   Label: LAB_005ebf0f
    JNZ 0x005ebf1c                      ; 005ebf13 | LAB_005ebf1c
    ...
    POP EBX                             ; 005ebf1a
    RET                                 ; 005ebf1b
    PUSH 0x65753c                       ; 005ebf1c | = "none" | s_none_0065753c = none
        ;   Label: LAB_005ebf1c
    ADD ESI,0x78                        ; 005ebf21
    PUSH ESI                            ; 005ebf24
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 005ebf25 | int crt_string.c_stricmp_FUN_005fe7f0(char * str1, char * str2)
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005ebf2a
    TEST EAX,EAX                        ; 005ebf2d
    JZ 0x005ebf15                       ; 005ebf2f | LAB_005ebf15
        ;   XREF to: 005ebf15 (CONDITIONAL_JUMP)
    PUSH 0x657541                       ; 005ebf31 | = "true" | s_true_00657541 = true
    PUSH ESI                            ; 005ebf36
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 005ebf37 | int crt_string.c_stricmp_FUN_005fe7f0(char * str1, char * str2)
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005ebf3c
    TEST EAX,EAX                        ; 005ebf3f
    JZ 0x005ebf15                       ; 005ebf41 | LAB_005ebf15
        ;   XREF to: 005ebf15 (CONDITIONAL_JUMP)
    MOV EBP,0x657546                    ; 005ebf43 | = "..\\core\\waypoint.cpp" | s_core_waypoint_cpp_00657546 = ..\core\waypoint.cpp
    MOV EAX,0x79                        ; 005ebf48
    PUSH 0x65755b                       ; 005ebf4d | = "Can't have creation event for waypoint." | s_Can_t_have_creation_even_0065755b = Can't have creation event for waypoint.
    MOV dword ptr [0x02f0ca48],EBP      ; 005ebf52 | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 005ebf58 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005ebf5d | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
