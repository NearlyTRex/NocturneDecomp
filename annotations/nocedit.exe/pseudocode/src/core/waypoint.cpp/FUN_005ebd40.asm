...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_waypoint.cpp_FUN_005ebd40()
;
; Local Variables:
...
;
; XREF[2]:
;   core_waypoint.cpp_FUN_005ec320 at 005ec340
;   core_waypoint.cpp_FUN_005ec4f0 at 005ec5a4
;
; Referenced Globals:
...
section .text
    ...
    JZ 0x005ebdad                       ; 005ebd71 | LAB_005ebdad
        ;   XREF to: 005ebdad (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x10]          ; 005ebd73
    FABS                                ; 005ebd77
    FCOMP double ptr [0x00657517]       ; 005ebd79 | double DOUBLE_00657517
    FNSTSW AX                           ; 005ebd7f
    SAHF                                ; 005ebd81
    JA 0x005ebda6                       ; 005ebd82 | LAB_005ebda6
        ;   XREF to: 005ebda6 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0xc]           ; 005ebd84
    FABS                                ; 005ebd88
    FCOMP double ptr [0x0065751f]       ; 005ebd8a | double DOUBLE_0065751f
    FNSTSW AX                           ; 005ebd90
    SAHF                                ; 005ebd92
    JA 0x005ebda6                       ; 005ebd93 | LAB_005ebda6
        ;   XREF to: 005ebda6 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x14]          ; 005ebd95
    FABS                                ; 005ebd99
    FCOMP double ptr [0x0065751f]       ; 005ebd9b | double DOUBLE_0065751f
    FNSTSW AX                           ; 005ebda1
    SAHF                                ; 005ebda3
    JBE 0x005ebde7                      ; 005ebda4 | LAB_005ebde7
    ...
    FLD float ptr [ESP + 0x10]          ; 005ebdad
        ;   Label: LAB_005ebdad
    FABS                                ; 005ebdb1
    FCOMP double ptr [0x00657507]       ; 005ebdb3 | double DOUBLE_00657507
    FNSTSW AX                           ; 005ebdb9
    SAHF                                ; 005ebdbb
    JA 0x005ebda6                       ; 005ebdbc | LAB_005ebda6
        ;   XREF to: 005ebda6 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0xc]           ; 005ebdbe
    FABS                                ; 005ebdc2
    FCOMP double ptr [0x0065750f]       ; 005ebdc4 | double DOUBLE_0065750f
    FNSTSW AX                           ; 005ebdca
    SAHF                                ; 005ebdcc
    JA 0x005ebda6                       ; 005ebdcd | LAB_005ebda6
        ;   XREF to: 005ebda6 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x14]          ; 005ebdcf
    FABS                                ; 005ebdd3
    FCOMP double ptr [0x0065750f]       ; 005ebdd5 | double DOUBLE_0065750f
    FNSTSW AX                           ; 005ebddb
    SAHF                                ; 005ebddd
    JBE 0x005ebde7                      ; 005ebdde | LAB_005ebde7
        ;   XREF to: 005ebde7 (CONDITIONAL_JUMP)
    ...
    CALL core_path.cpp_FUN_00548500     ; 005ebe00 | undefined core_path.cpp_FUN_00548500()
    ...
    PUSH EDX                            ; 005ebe13
    PUSH EAX                            ; 005ebe14
    CALL core_path.cpp_CPathMap_findPathWithRetry_FUN_00547d00 ; 005ebe15 | int core_path.cpp_CPathMap_findPathWithRetry_FUN_00547d00(CPathMap * this_ptr, CVector3f * dest_position, CVector3f * out_euler_angles, int direction_hint)
