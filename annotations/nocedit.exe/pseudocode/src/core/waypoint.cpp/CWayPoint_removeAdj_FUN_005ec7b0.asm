...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_waypoint.cpp_CWayPoint_removeAdj_FUN_005ec7b0()
;
;
; XREF[2]:
...
section .text
    ...
    JL 0x005ec7fb                       ; 005ec7bd | LAB_005ec7fb
        ;   XREF to: 005ec7fb (CONDITIONAL_JUMP)
    CMP ESI,dword ptr [EBX + 0x370]     ; 005ec7bf
    JGE 0x005ec7fb                      ; 005ec7c5 | LAB_005ec7fb
        ;   XREF to: 005ec7fb (CONDITIONAL_JUMP)
    ...
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 005ec7ef | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
    ...
    PUSH EDI                            ; 005ec7fb
        ;   Label: LAB_005ec7fb
    MOV ECX,0x65767a                    ; 005ec7fc | = "..\\core\\waypoint.cpp" | s_core_waypoint_cpp_0065767a = ..\core\waypoint.cpp
    MOV EDI,0x18f                       ; 005ec801
    PUSH 0x65768f                       ; 005ec806 | = "CWayPoint::removeAdj - invalid index" | s_CWayPoint_removeAdj_inva_0065768f = CWayPoint::removeAdj - invalid index
    MOV dword ptr [0x02f0ca48],ECX      ; 005ec80b | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 005ec811 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005ec817 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005ec81c
    POP EDI                             ; 005ec81f
    JMP 0x005ec7c7                      ; 005ec820 | LAB_005ec7c7
