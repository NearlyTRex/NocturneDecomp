...
;
; XREF[3]:
;   core_waypoint.cpp_CWayPoint_FUN_005ec610 at 005ec630
;   core_waypoint.cpp_CWayPoint_addAdj_FUN_005ec700 at 005ec718
;   core_waypoint.cpp_FUN_005ec4f0 at 005ec51e
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 005ec673
        ;   Label: LAB_005ec673
    PUSH EDI                            ; 005ec674
    CALL core_waypoint.cpp_CWayPoint_removeAdj_FUN_005ec7b0 ; 005ec675 | undefined core_waypoint.cpp_CWayPoint_removeAdj_FUN_005ec7b0()
        ;   XREF to: 005ec7b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005ec67a
    CMP EBX,dword ptr [EDI + 0x370]     ; 005ec67d
    JL 0x005ec65a                       ; 005ec683 | LAB_005ec65a
        ;   XREF to: 005ec65a (CONDITIONAL_JUMP)
    POP EBP                             ; 005ec685
    POP EDI                             ; 005ec686
    POP ESI                             ; 005ec687
