...
;                               FUNCTION
; *****************************************************************************
; __cdecl CWayPoint * __cdecl core_waypoint_cpp_CWayPoint_dtor_FUN_005ec8d0(CWayPoint *this_ptr,uint d1,uint d2)
;
; Parameters:
...
section .text
    ...
    PUSH 0x665570                       ; 005ec8f6 | g_CWayPointTypeInfo
        ;   Label: LAB_005ec8f6
    PUSH EBX                            ; 005ec8fb
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 005ec8fc
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 005ec901
    PUSH EAX                            ; 005ec904
    CALL crt_memory.c_free_FUN_005fe659 ; 005ec905
    ...
    PUSH EAX                            ; 005ec911
        ;   Label: LAB_005ec911
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 005ec912
