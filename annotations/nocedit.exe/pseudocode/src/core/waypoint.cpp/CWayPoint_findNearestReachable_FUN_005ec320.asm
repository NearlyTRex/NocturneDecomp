...
section .text
    ...
    PUSH EBX                            ; 005ec320
        ;   Label: core_waypoint.cpp_CWayPoint_findNearestReachable_FUN_005ec320
    PUSH EBP                            ; 005ec321
    ...
    PUSH EDX                            ; 005ec33f
    CALL core_waypoint.cpp_CWayPoint_isReachable_FUN_005ebd40 ; 005ec340
    ...
    MOV ESI,0x1                         ; 005ec386
        ;   Label: LAB_005ec386
    MOV dword ptr [0x03f939a4],EBX      ; 005ec38b | g_WaypointSearchQueue
    ...
    PUSH ECX                            ; 005ec49d
    CALL core_waypoint.cpp_CWayPoint_isReachable_FUN_005ebd40 ; 005ec49e
        ;   XREF to: 005ebd40 (UNCONDITIONAL_CALL)  ; int core_waypoint.cpp_CWayPoint_isReachable_FUN_005ebd40(CWayPoint * this_ptr, CLocation * from_location, int use_tight_bounds)
