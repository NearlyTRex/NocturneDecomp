...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_waypoint.cpp_FUN_005ec4f0()
;
; Local Variables:
...
section .text
    ...
    PUSH EBX                            ; 005ec4fb
    CALL core_waypoint.cpp_FUN_005ec830 ; 005ec4fc | undefined core_waypoint.cpp_FUN_005ec830()
    ...
    JLE 0x005ec530                      ; 005ec50e | LAB_005ec530
    ...
    INC ESI                             ; 005ec51d
    CALL core_waypoint.cpp_CallWayPoint_removeAdj_FUN_005ec640 ; 005ec51e | undefined core_waypoint.cpp_CallWayPoint_removeAdj_FUN_005ec640()
        ;   XREF to: 005ec640 (UNCONDITIONAL_CALL)
    MOV EBP,dword ptr [EBX + 0x370]     ; 005ec523
    ADD ESP,0x8                         ; 005ec529
    CMP ESI,EBP                         ; 005ec52c
    JL 0x005ec512                       ; 005ec52e | LAB_005ec512
        ;   XREF to: 005ec512 (CONDITIONAL_JUMP)
    MOV EAX,[0x0067d550]                ; 005ec530 | CDemonMission g_CDemonMissionInstance | CDemonMission * g_CDemonMissionPtr
        ;   Label: LAB_005ec530
    PUSH EAX                            ; 005ec535 | CDemonMission g_CDemonMissionInstance
    XOR EDI,EDI                         ; 005ec536
    XOR EBP,EBP                         ; 005ec538
    CALL core_mission.cpp_CDemonMission_buildSetActorList_FUN_00523e60 ; 005ec53a | void core_mission.cpp_CDemonMission_buildSetActorList_FUN_00523e60(CDemonMission * this_ptr)
    ...
    MOV EAX,[0x006810c8]                ; 005ec552 | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
        ;   Label: LAB_005ec552
    CMP EDI,dword ptr [EAX + 0x154e64]  ; 005ec557 | DAT_032690dc
    JGE 0x005ec5cf                      ; 005ec55d | LAB_005ec5cf
        ;   XREF to: 005ec5cf (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [EAX + EBP*0x1 + 0x154e68] ; 005ec563 | DAT_032690e0
    CMP ESI,EBX                         ; 005ec56a
    JNZ 0x005ec574                      ; 005ec56c | LAB_005ec574
        ;   XREF to: 005ec574 (CONDITIONAL_JUMP)
    INC EDI                             ; 005ec56e
        ;   Label: LAB_005ec56e
    ADD EBP,0x4                         ; 005ec56f
    JMP 0x005ec552                      ; 005ec572 | LAB_005ec552
        ;   XREF to: 005ec552 (UNCONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0x370],0x3c    ; 005ec574
        ;   Label: LAB_005ec574
    JGE 0x005ec56e                      ; 005ec57b | LAB_005ec56e
    ...
    CALL core_waypoint.cpp_FUN_005ebd40 ; 005ec58c | undefined core_waypoint.cpp_FUN_005ebd40()
        ;   XREF to: 005ebd40 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005ec591
    TEST EAX,EAX                        ; 005ec594
    JZ 0x005ec56e                       ; 005ec596 | LAB_005ec56e
        ;   XREF to: 005ec56e (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 005ec598
    ...
    PUSH EAX                            ; 005ec5a3
    CALL core_waypoint.cpp_FUN_005ebd40 ; 005ec5a4 | undefined core_waypoint.cpp_FUN_005ebd40()
        ;   XREF to: 005ebd40 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005ec5a9
    TEST EAX,EAX                        ; 005ec5ac
    JZ 0x005ec56e                       ; 005ec5ae | LAB_005ec56e
        ;   XREF to: 005ec56e (CONDITIONAL_JUMP)
    PUSH ESI                            ; 005ec5b0
    PUSH EBX                            ; 005ec5b1
    CALL core_waypoint.cpp_CWayPoint_addAdj_FUN_005ec700 ; 005ec5b2 | undefined core_waypoint.cpp_CWayPoint_addAdj_FUN_005ec700()
        ;   XREF to: 005ec700 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005ec5b7
    PUSH EBX                            ; 005ec5ba
    PUSH ESI                            ; 005ec5bb
    CALL core_waypoint.cpp_CWayPoint_addAdj_FUN_005ec700 ; 005ec5bc | undefined core_waypoint.cpp_CWayPoint_addAdj_FUN_005ec700()
        ;   XREF to: 005ec700 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [EBX + 0x370]     ; 005ec5c1
    ADD ESP,0x8                         ; 005ec5c7
    CMP EDX,0x3c                        ; 005ec5ca
    JL 0x005ec56e                       ; 005ec5cd | LAB_005ec56e
        ;   XREF to: 005ec56e (CONDITIONAL_JUMP)
