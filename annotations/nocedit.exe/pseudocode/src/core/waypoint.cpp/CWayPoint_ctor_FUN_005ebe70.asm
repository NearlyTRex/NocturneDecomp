...
;
; XREF[1]:
;   core_waypoint.cpp_FUN_005ebe30 at 005ebe4a
;
; Referenced Globals:
...
section .text
    ...
    PUSH EDX                            ; 005ebe74
    CALL core_trigger.cpp_CTrigger_ctor_FUN_005df840 ; 005ebe75 | CTrigger * core_trigger.cpp_CTrigger_ctor_FUN_005df840(CTrigger * this_ptr)
        ;   XREF to: 005df840 (UNCONDITIONAL_CALL)
    MOV dword ptr [EAX + 0x154],0x665484 ; 005ebe7a | CDemonActor_vtable g_CWayPointVTable
