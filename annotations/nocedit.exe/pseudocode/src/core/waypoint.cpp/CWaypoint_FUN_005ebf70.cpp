...

{
  ...
  if (((*(int *)(g_CDemonMissionPtr->field0_0x0 + 4) != 0) &&
    ...
    if (0 < this_ptr->num_adjacent_waypoints) {
      do {
        this_ptr_00 = *(CWayPoint **)pCVar4->field2_0x374;
        ...
        iVar1 = iVar1 + 1;
        pCVar4 = (CWayPoint *)((pCVar4->base_trigger).base_actor.actor_name + 8);
      } while (iVar1 < this_ptr->num_adjacent_waypoints);
    }
    core_actor_cpp_CDemonActor_restoreRenderState_FUN_00408b40((CDemonActor *)this_ptr);
    if ((unaff_EDI != (CWayPoint *)0x0) && (*(int *)(g_CDemonMissionPtr->field2_0xc + 0x34) != 0)) {
      if ((this_ptr != unaff_EDI) && (*(int *)(g_CDemonMissionPtr->field2_0xc + 0x34) != 2)) {
        return 0;
      }
