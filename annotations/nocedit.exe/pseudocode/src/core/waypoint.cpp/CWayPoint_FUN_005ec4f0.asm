...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_waypoint_cpp_CWayPoint_FUN_005ec4f0(CWayPoint *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005ec4f0
        ;   Label: core_waypoint.cpp_CWayPoint_FUN_005ec4f0
    PUSH ESI                            ; 005ec4f1
    PUSH EDI                            ; 005ec4f2
    PUSH EBP                            ; 005ec4f3
    ...
    PUSH EBX                            ; 005ec4fb
    CALL core_waypoint.cpp_CWayPoint_FUN_005ec830 ; 005ec4fc
    ...
    INC ESI                             ; 005ec51d
    CALL core_waypoint.cpp_CWayPoint_FUN_005ec640 ; 005ec51e
    ...
    CALL core_waypoint.cpp_CWayPoint_FUN_005ebd40 ; 005ec58c
    ...
    PUSH EAX                            ; 005ec5a3
    CALL core_waypoint.cpp_CWayPoint_FUN_005ebd40 ; 005ec5a4
        ;   XREF to: 005ebd40 (UNCONDITIONAL_CALL)  ; int core_waypoint.cpp_CWayPoint_FUN_005ebd40(CWayPoint * this_ptr)
