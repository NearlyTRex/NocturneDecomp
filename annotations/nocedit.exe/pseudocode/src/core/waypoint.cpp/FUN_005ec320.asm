...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_waypoint.cpp_FUN_005ec320()
;
; Local Variables:
...
section .text
    ...
    JNZ 0x005ec335                      ; 005ec32b | LAB_005ec335
    ...
    PUSH EDX                            ; 005ec33f
    CALL core_waypoint.cpp_FUN_005ebd40 ; 005ec340 | undefined core_waypoint.cpp_FUN_005ebd40()
        ;   XREF to: 005ebd40 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005ec345
    TEST EAX,EAX                        ; 005ec348
    JNZ 0x005ec37e                      ; 005ec34a | LAB_005ec37e
        ;   XREF to: 005ec37e (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x370],0x1     ; 005ec34c
    JL 0x005ec32f                       ; 005ec353 | LAB_005ec32f
        ;   XREF to: 005ec32f (CONDITIONAL_JUMP)
    PUSH EDI                            ; 005ec355
    PUSH ESI                            ; 005ec356
    XOR ESI,ESI                         ; 005ec357
    MOV EDX,dword ptr [0x006810c8]      ; 005ec359 | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
        ;   Label: LAB_005ec359
    CMP ESI,dword ptr [EDX + 0x154e64]  ; 005ec35f | DAT_032690dc
    JGE 0x005ec386                      ; 005ec365 | LAB_005ec386
    ...
    JMP 0x005ec359                      ; 005ec37c | LAB_005ec359
    ...
    MOV ESI,0x1                         ; 005ec386
        ;   Label: LAB_005ec386
    MOV dword ptr [0x03f939a4],EBX      ; 005ec38b | undefined4 DAT_03f939a4
    MOV dword ptr [EBX + 0x554],0x0     ; 005ec391
    DEC ESI                             ; 005ec39b
        ;   Label: LAB_005ec39b
    LEA EBX,[ESI*0x4 + 0x0]             ; 005ec39c
    PUSH EBX                            ; 005ec3a3
    PUSH 0x3f939a8                      ; 005ec3a4 | undefined4 DAT_03f939a8
    MOV EAX,[0x03f939a4]                ; 005ec3a9 | undefined4 DAT_03f939a4
    PUSH 0x3f939a4                      ; 005ec3ae | undefined4 DAT_03f939a4
    MOV dword ptr [ESP + 0x18],EAX      ; 005ec3b3
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 005ec3b7 | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
    ...
    JLE 0x005ec449                      ; 005ec3d1 | LAB_005ec449
    ...
    FNSTSW AX                           ; 005ec3fb
    SAHF                                ; 005ec3fd
    JNC 0x005ec42f                      ; 005ec3fe | LAB_005ec42f
    ...
    JLE 0x005ec421                      ; 005ec40e | LAB_005ec421
        ;   XREF to: 005ec421 (CONDITIONAL_JUMP)
    LEA EBX,[ESI*0x4 + 0x0]             ; 005ec410
    XOR EAX,EAX                         ; 005ec417
    CMP ECX,dword ptr [EAX + 0x3f939a4] ; 005ec419 | undefined4 DAT_03f939a4 | DAT_03f939a8
        ;   Label: LAB_005ec419
    JNZ 0x005ec489                      ; 005ec41f | LAB_005ec489
        ;   XREF to: 005ec489 (CONDITIONAL_JUMP)
    CMP EDX,ESI                         ; 005ec421
        ;   Label: LAB_005ec421
    JNZ 0x005ec42f                      ; 005ec423 | LAB_005ec42f
        ;   XREF to: 005ec42f (CONDITIONAL_JUMP)
    ADD EBP,0x4                         ; 005ec425
    INC ESI                             ; 005ec428
    MOV dword ptr [EBP + 0x3f939a0],ECX ; 005ec429 | undefined4 DAT_03f939a4 | DAT_03f939a8
    ...
    JL 0x005ec3db                       ; 005ec447 | LAB_005ec3db
        ;   XREF to: 005ec3db (CONDITIONAL_JUMP)
    TEST ESI,ESI                        ; 005ec449
        ;   Label: LAB_005ec449
    JG 0x005ec39b                       ; 005ec44b | LAB_005ec39b
    ...
    PUSH ECX                            ; 005ec49d
    CALL core_waypoint.cpp_FUN_005ebd40 ; 005ec49e | undefined core_waypoint.cpp_FUN_005ebd40()
        ;   XREF to: 005ebd40 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005ec4a3
    TEST EAX,EAX                        ; 005ec4a6
    JZ 0x005ec483                       ; 005ec4a8 | LAB_005ec483
    ...
    JMP 0x005ec483                      ; 005ec4b6 | LAB_005ec483
