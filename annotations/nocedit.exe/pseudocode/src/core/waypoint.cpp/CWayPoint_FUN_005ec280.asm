...
section .text
    ...
    PUSH EDI                            ; 005ec28b
    CALL core_trigger.cpp_CTrigger_serialize_FUN_005e0690 ; 005ec28c | void core_trigger.cpp_CTrigger_serialize_FUN_005e0690(CTrigger * this_ptr)
        ;   XREF to: 005e0690 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [0x0068489c]      ; 005ec291 | int g_CWayPointClassVersion
    ADD ESP,0x4                         ; 005ec297
    CMP EDX,0x2                         ; 005ec29a
    JL 0x005ec2b8                       ; 005ec29d | LAB_005ec2b8
        ;   XREF to: 005ec2b8 (CONDITIONAL_JUMP)
    CMP dword ptr [0x0068489c],0x2      ; 005ec29f | int g_CWayPointClassVersion
        ;   Label: LAB_005ec29f
    JGE 0x005ec2cc                      ; 005ec2a6 | LAB_005ec2cc
    ...
    POP EBX                             ; 005ec2b6
    RET                                 ; 005ec2b7
    PUSH 0x657587                       ; 005ec2b8 | = "nextWayPoint" | s_nextWayPoint_00657587 = nextWayPoint
        ;   Label: LAB_005ec2b8
    LEA EBX,[ESP + 0x4]                 ; 005ec2bd
    PUSH EBX                            ; 005ec2c1
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 005ec2c2 | void core_actor.cpp_serializeActor_FUN_0040b870(CDemonActor * actor_ptr, char * property_name)
        ;   XREF to: 0040b870 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005ec2c7
    JMP 0x005ec29f                      ; 005ec2ca | LAB_005ec29f
        ;   XREF to: 005ec29f (UNCONDITIONAL_JUMP)
    PUSH 0x657594                       ; 005ec2cc | = "adjCount" | s_adjCount_00657594 = adjCount
        ;   Label: LAB_005ec2cc
    LEA EBX,[EDI + 0x370]               ; 005ec2d1
    PUSH EBX                            ; 005ec2d7
    XOR ESI,ESI                         ; 005ec2d8
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 005ec2da | void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)
    MOV EBX,dword ptr [EDI + 0x370]     ; 005ec2df
    ADD ESP,0x8                         ; 005ec2e5
    TEST EBX,EBX                        ; 005ec2e8
    JLE 0x005ec2b0                      ; 005ec2ea | LAB_005ec2b0
    ...
    PUSH EBX                            ; 005ec2f4
    INC ESI                             ; 005ec2f5
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 005ec2f6 | void core_actor.cpp_serializeActor_FUN_0040b870(CDemonActor * actor_ptr, char * property_name)
        ;   XREF to: 0040b870 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005ec2fb
    MOV EBP,dword ptr [EDI + 0x370]     ; 005ec2fe
    ADD EBX,0x8                         ; 005ec304
    CMP ESI,EBP                         ; 005ec307
    JL 0x005ec2f2                       ; 005ec309 | LAB_005ec2f2
