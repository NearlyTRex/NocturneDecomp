// Name: core_waypoint.cpp_CWayPoint_archive_FUN_005ec280
// Address: 005ec280
// Address Range: [[005ec280, 005ec312]]
// Convention: __cdecl
// Signature: void __cdecl core_waypoint_cpp_CWayPoint_archive_FUN_005ec280(CWayPoint *this_ptr)
...

{
  ...
  if (g_CWayPointClassVersion < 2) {
    core_actor_cpp_archiveActor_FUN_0040b870(&local_14,"nextWayPoint");
  }
  if (1 < g_CWayPointClassVersion) {
    ...
    if (0 < this_ptr->num_adjacent_waypoints) {
      ...
      do {
        iVar1 = iVar1 + 1;
        core_actor_cpp_archiveActor_FUN_0040b870((CDemonActor **)actor_ptr,(char *)0x0);
