...

{
  ...
  fVar2 = core_actor_cpp_normalizeAngleToPi_FUN_0040cd70((this_ptr->orient).vec.z);
  (this_ptr->orient).vec.z = fVar2;
  fVar2 = core_actor_cpp_normalizeAngleToPi_FUN_0040cd70((this_ptr->orient).vec.y);
  (this_ptr->orient).vec.y = fVar2;
