...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_actor.cpp_trimActorName_FUN_004087b0(CDemonActor * actor_ptr)
;
; Parameters:
...
section .text
    ...
    JLE 0x004087e0                      ; 004087c7 | LAB_004087e0
    ...
    TEST byte ptr [EDX + 0x6849c4],0x2  ; 004087d7 | char[256] g_CharacterClassificationTable
    JNZ 0x004087ff                      ; 004087de | LAB_004087ff
    ...
    TEST byte ptr [EAX + 0x6849c4],0x2  ; 004087f2 | char[256] g_CharacterClassificationTable
    JNZ 0x00408807                      ; 004087f9 | LAB_00408807
    ...
    JG 0x004087cc                       ; 00408803 | LAB_004087cc
        ;   XREF to: 004087cc (CONDITIONAL_JUMP)
    JMP 0x004087e0                      ; 00408805 | LAB_004087e0
    ...
    PUSH ESI                            ; 00408809
    DEC EBX                             ; 0040880a
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 0040880b | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
        ;   XREF to: 005fe5e0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00408810
    JMP 0x004087e9                      ; 00408813 | LAB_004087e9
