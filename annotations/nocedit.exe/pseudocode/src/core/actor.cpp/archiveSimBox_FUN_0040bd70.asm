...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_actor_cpp_archiveSimBox_FUN_0040bd70(CSimBox *simbox_ptr,char *property_name)
;
; Parameters:
...
;
; XREF[2]:
;   core_bodypart.cpp_CBodyPart_archive_FUN_00419880 at 00419a05
;   core_boxactor.cpp_CBoxActor_archive_FUN_00422060 at 00422190
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0040bd70
        ;   Label: core_actor.cpp_archiveSimBox_FUN_0040bd70
    PUSH ESI                            ; 0040bd71
    PUSH EBP                            ; 0040bd72
    ...
    CALL core_box.cpp_CBox_loadFromFile_FUN_0041fe90 ; 0040bda9
        ;   XREF to: 0041fe90 (UNCONDITIONAL_CALL)  ; void core_box.cpp_CBox_loadFromFile_FUN_0041fe90(CBox * this_ptr, _FILE * file_handle)
    ...
    CALL core_box.cpp_CBox_saveToFile_FUN_00420020 ; 0040be2c
        ;   XREF to: 00420020 (UNCONDITIONAL_CALL)  ; void core_box.cpp_CBox_saveToFile_FUN_00420020(CBox * this_ptr, _FILE * file_handle)
