...

{
  ...
  local_18 = direction_offset->x * FLOAT_0061444c;
  local_14 = direction_offset->y * FLOAT_0061444c;
  local_10 = FLOAT_0061444c * direction_offset->z;
  fVar1 = (float)start_point->y * FLOAT_00614450 + local_14;
  fVar2 = FLOAT_00614450 * (float)start_point->z + local_10;
  uStack_60 = 0x40d3f1;
