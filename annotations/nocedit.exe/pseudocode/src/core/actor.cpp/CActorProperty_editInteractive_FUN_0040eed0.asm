...
; char[300]        Stack[-0xaac]:300  local_aac
; char[300]        Stack[-0x980]:300  local_980
; char[236]        Stack[-0x854]:236  local_854
; char[260]        Stack[-0x750]:260  local_750
; char[260]        Stack[-0x64c]:260  local_64c
; char[236]        Stack[-0x548]:236  local_548
...
section .text
    ...
    PUSH ESI                            ; 0040f92d | g_CEditorToolsInstance
    ...
    PUSH EDI                            ; 0040f9f1 | g_CEditorToolsInstance
    ...
    PUSH EBP                            ; 0040fdf0 | g_CEditorToolsInstance
    ...
    PUSH EAX                            ; 0040ff24 | g_CEditorToolsInstance
