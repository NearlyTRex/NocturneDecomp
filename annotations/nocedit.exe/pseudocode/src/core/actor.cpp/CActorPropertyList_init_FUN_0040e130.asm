...
;
; XREF[8]:
;   core_msnedit.cpp_CDemonMission_buildScriptCrossReferences_FUN_0053ea30 at 0053ea59
;   core_msnedit.cpp_CDemonMission_changeActorType_FUN_0053d8b0 at 0053da21
...
;   core_msnedit.cpp_CDemonMission_showSoundFilesInMission_FUN_0053ec80 at 0053eced
...
section .text
    ...
    PUSH EBX                            ; 0040e130
        ;   Label: core_actor.cpp_CActorPropertyList_init_FUN_0040e130
    MOV EBX,dword ptr [ESP + 0x8]       ; 0040e131
    PUSH EBX                            ; 0040e135
    MOV dword ptr [EBX],0x0             ; 0040e136
    CALL core_actor.cpp_CActorPropertyList_resetSelection_FUN_0040e150 ; 0040e13c
