...
section .text
    ...
    PUSH 0x613898                       ; 00409885 | = "..\\core\\actor.cpp" | s_core_actor_cpp_00613898 = ..\core\actor.cpp
    MOV EDX,dword ptr [ESP + 0xc]       ; 0040988a
    PUSH EDX                            ; 0040988e
    CALL core_actor.cpp_CDemonActor_doCheckForInvalidPointers_FUN_0040ac80 ; 0040988f | void core_actor.cpp_CDemonActor_doCheckForInvalidPointers_FUN_0040ac80(CDemonActor * this_ptr, char * context_file, int context_line)
