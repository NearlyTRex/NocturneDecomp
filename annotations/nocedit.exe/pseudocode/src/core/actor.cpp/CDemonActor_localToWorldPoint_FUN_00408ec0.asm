...
;                               FUNCTION
; *****************************************************************************
; __cdecl CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
;
; Parameters:
...
;
; XREF[146]:
;   core_actor.cpp_CDemonActor_processFootstepAtOffset_FUN_0040c8f0 at 0040c903
...
;   core_baron.cpp_FUN_004136b0 at 00413984
...
section .text
    ...
    PUSH EAX                            ; 00408ed9
    CALL core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0 ; 00408eda | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0(CMatrix3x3f * this_ptr, CVector3f * output, CVector3f * input)
