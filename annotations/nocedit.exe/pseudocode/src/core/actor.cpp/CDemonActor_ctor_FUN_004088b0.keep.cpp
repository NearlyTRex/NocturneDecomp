...

{
  ...
  (ADJ(pCVar2)->location).position.x = 0.0;
  (ADJ(pCVar2)->location).position.y = 0.0;
  (ADJ(pCVar2)->location).position.z = 0.0;
  (ADJ(pCVar2)->location).area_id = 0;
  (ADJ(pCVar2)->orient).vec.x = 0.0;
  (ADJ(pCVar2)->orient).vec.y = 0.0;
  ...
  (ADJ(pCVar2)->platform_position_delta).x = 0.0;
  (ADJ(pCVar2)->platform_position_delta).y = 0.0;
  (ADJ(pCVar2)->platform_position_delta).z = 0.0;
  (ADJ(pCVar2)->platform_orientation_delta).x = 0.0;
  (ADJ(pCVar2)->platform_orientation_delta).y = 0.0;
