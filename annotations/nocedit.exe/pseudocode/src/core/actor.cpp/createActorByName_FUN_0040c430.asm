...
;
; XREF[15]:
;   core_baron.cpp_CBaronWeapon_findOrCreateBaron_FUN_00413f20 at 00413f7c
...
;   core_hero.cpp_CHero_createDefaultWeapon_FUN_004f2a30 at 004f2a51
...
section .text
    ...
    PUSH ESI                            ; 0040c437
    CALL core_actor.cpp_getActorClassByName_FUN_0040c3c0 ; 0040c438
    ...
    JZ 0x0040c47e                       ; 0040c444
        ;   XREF to: 0040c47e (CONDITIONAL_JUMP)  ; LAB_0040c47e
    CMP dword ptr [EBX + 0x2c],0x0      ; 0040c446
        ;   Label: LAB_0040c446
    JNZ 0x0040c46f                      ; 0040c44a
        ;   XREF to: 0040c46f (CONDITIONAL_JUMP)  ; LAB_0040c46f
    PUSH ESI                            ; 0040c44c
    MOV EBP,0x614249                    ; 0040c44d | = "..\\core\\actor.cpp"
    MOV EAX,0xa41                       ; 0040c452
    PUSH 0x61425b                       ; 0040c457 | = "Can't create instance of abstract typ..."
    MOV dword ptr [0x02f0ca48],EBP      ; 0040c45c | g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 0040c462 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0040c467
    ...
    JZ 0x0040c4a4                       ; 0040c476
        ;   XREF to: 0040c4a4 (CONDITIONAL_JUMP)  ; LAB_0040c4a4
    ...
    PUSH ESI                            ; 0040c47e
        ;   Label: LAB_0040c47e
    MOV EDX,0x61420a                    ; 0040c47f | = "..\\core\\actor.cpp"
    MOV ECX,0xa3b                       ; 0040c484
    PUSH 0x61421c                       ; 0040c489 | = "Can't create actor of unknown class t..."
    MOV dword ptr [0x02f0ca48],EDX      ; 0040c48e | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 0040c494 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0040c49a
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ADD ESP,0x8                         ; 0040c49f
    JMP 0x0040c446                      ; 0040c4a2
        ;   XREF to: 0040c446 (UNCONDITIONAL_JUMP)  ; LAB_0040c446
    PUSH ESI                            ; 0040c4a4
        ;   Label: LAB_0040c4a4
    MOV EDX,0x614285                    ; 0040c4a5 | = "..\\core\\actor.cpp"
    MOV ECX,0xa4a                       ; 0040c4aa
    PUSH 0x614297                       ; 0040c4af | = "Not enough memory to create %s"
    MOV dword ptr [0x02f0ca48],EDX      ; 0040c4b4 | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 0040c4ba | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0040c4c0
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
