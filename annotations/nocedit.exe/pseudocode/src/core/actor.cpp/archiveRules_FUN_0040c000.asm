...
;
; XREF[2]:
;   core_door.cpp_CDoor_archive_FUN_00480aa0 at 00480c67
;   core_lever.cpp_CLever_archive_FUN_00504e80 at 00504fe5
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0040c000
        ;   Label: core_actor.cpp_archiveRules_FUN_0040c000
    PUSH ESI                            ; 0040c001
    PUSH EDI                            ; 0040c002
    PUSH EBP                            ; 0040c003
    ...
    CALL core_actor.cpp_archiveDescription_FUN_0040b290 ; 0040c065
