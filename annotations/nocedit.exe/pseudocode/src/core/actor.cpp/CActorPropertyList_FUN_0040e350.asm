...
;   core_ladder.cpp_FUN_00502ca0 at 00502cde
...
section .text
    ...
    PUSH EDI                            ; 0040e36c
    CALL core_actor.cpp_CActorPropertyList_snag_FUN_0040e6c0 ; 0040e36d | int core_actor.cpp_CActorPropertyList_snag_FUN_0040e6c0(CActorPropertyList * this_ptr, int property_type, char * property_name, void * data_ptr, ...)
        ;   XREF to: 0040e6c0 (UNCONDITIONAL_CALL)
    MOV EDX,EAX                         ; 0040e372
    ADD ESP,0x14                        ; 0040e374
    TEST ESI,ESI                        ; 0040e377
    JNZ 0x0040e380                      ; 0040e379 | LAB_0040e380
        ;   XREF to: 0040e380 (CONDITIONAL_JUMP)
    MOV ESI,0x614464                    ; 0040e37b | undefined1 DAT_00614464
    LEA EDI,[EDX + 0x84]                ; 0040e380
        ;   Label: LAB_0040e380
    PUSH EDI                            ; 0040e386
    MOV AL,byte ptr [ESI]               ; 0040e387 | undefined1 DAT_00614464
        ;   Label: LAB_0040e387
    MOV byte ptr [EDI],AL               ; 0040e389
    CMP AL,0x0                          ; 0040e38b
    JZ 0x0040e39f                       ; 0040e38d | LAB_0040e39f
        ;   XREF to: 0040e39f (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0040e38f | = "%s %d" | s_s_d_00614465 = %s %d
    ADD ESI,0x2                         ; 0040e392
    MOV byte ptr [EDI + 0x1],AL         ; 0040e395
    ADD EDI,0x2                         ; 0040e398
    CMP AL,0x0                          ; 0040e39b
    JNZ 0x0040e387                      ; 0040e39d | LAB_0040e387
