...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_actor_cpp_archiveQuaternion_FUN_0040b520(CQuaternion4f *quat_ptr,char *property_type)
;
; Parameters:
...
;   core_platfrm.cpp_CPlatform_archive_FUN_0054dbc0 at 0054dec7
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0040b520
        ;   Label: core_actor.cpp_archiveQuaternion_FUN_0040b520
    PUSH EDI                            ; 0040b521
    ...
    CALL core_actor.cpp_archiveDescription_FUN_0040b290 ; 0040b55f
