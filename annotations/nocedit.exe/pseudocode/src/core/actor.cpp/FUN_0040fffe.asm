...
section .text
    ...
    PUSH EAX                            ; 00410005
    MOV ECX,dword ptr [0x006793d0]      ; 00410006 | CEventList g_CEventListInstance | CEventList * g_CEventListPtr
    PUSH ECX                            ; 0041000c | CEventList g_CEventListInstance
    CALL core_event.cpp_CEventList_FUN_004add40 ; 0041000d | int core_event.cpp_CEventList_FUN_004add40(CEventList * this_ptr)
        ;   XREF to: 004add40 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00410012
    TEST EAX,EAX                        ; 00410015
    JNZ 0x00410052                      ; 00410017 | LAB_00410052
    ...
    JL 0x00410066                       ; 00410021 | LAB_00410066
    ...
    PUSH EBP                            ; 00410036
    PUSH ESI                            ; 00410037
    CALL core_event.cpp_CRuleList_insert_FUN_004b1680 ; 00410038 | void core_event.cpp_CRuleList_insert_FUN_004b1680(CRuleList * this_ptr)
    ...
    PUSH EAX                            ; 00410052
        ;   Label: LAB_00410052
    MOV EAX,[0x00678a60]                ; 00410053 | CEditorTools * g_CEditorToolsPtr
    PUSH EAX                            ; 00410058 | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_showError_FUN_0049e740 ; 00410059 | void shape_edittool.cpp_CEditorTools_showError_FUN_0049e740(CEditorTools * this_ptr, char * format)
        ;   XREF to: 0049e740 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0041005e
    JMP 0x0040fdd3                      ; 00410061 | LAB_0040fdd3
    ...
    CMP AL,0x0                          ; 00410087
    JZ 0x0041009b                       ; 00410089 | LAB_0041009b
    ...
    CMP AL,0x0                          ; 00410097
    JNZ 0x00410083                      ; 00410099 | LAB_00410083
    ...
    CMP AL,0x0                          ; 004100c7
    JZ 0x004100db                       ; 004100c9 | LAB_004100db
    ...
    CMP AL,0x0                          ; 004100d7
    JNZ 0x004100c3                      ; 004100d9 | LAB_004100c3
