// Name: core_actor.cpp_archiveOrientation_FUN_0040b3e0
// Address: 0040b3e0
// MANUAL RECONSTRUCTION
// Address Range: [[0040b3e0, 0040b470]]
// Convention: __cdecl
// Signature: void __cdecl core_actor_cpp_archiveOrientation_FUN_0040b3e0(COrientation *orient_ptr,char *property_name)
...

{
  ...
  if (g_ActorReadingMode == 1) {
    iVar1 = _fscanf(g_ActorDataFile,"%f,%f,%f",&orient_ptr->pitch,&orient_ptr->heading,&orient_ptr->bank);
    if (iVar1 != 3) {
  ...
  core_actor_cpp_archiveDescription_FUN_0040b290("Euler PBH orientation",property_name);
  return;
}
