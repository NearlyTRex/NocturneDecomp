...
section .text
    ...
    JL 0x00409920                       ; 0040990a | LAB_00409920
        ;   XREF to: 00409920 (CONDITIONAL_JUMP)
    TEST EDX,EDX                        ; 0040990c
    JL 0x00409920                       ; 0040990e | LAB_00409920
        ;   XREF to: 00409920 (CONDITIONAL_JUMP)
    CMP EAX,dword ptr [0x00679394]      ; 00409910 | int g_WindowWidth
    JGE 0x00409920                      ; 00409916 | LAB_00409920
        ;   XREF to: 00409920 (CONDITIONAL_JUMP)
    CMP EDX,dword ptr [0x00679398]      ; 00409918 | int g_WindowHeight
    JL 0x00409921                       ; 0040991e | LAB_00409921
    ...
    PUSH EDX                            ; 00409921
        ;   Label: LAB_00409921
    PUSH EAX                            ; 00409922
    CALL engine_2d.c_plotPixel_FUN_00401140 ; 00409923 | void engine_2d.c_plotPixel_FUN_00401140(int x, int y)
