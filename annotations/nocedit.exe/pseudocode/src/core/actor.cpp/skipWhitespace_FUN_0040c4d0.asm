...
section .text
    ...
    TEST byte ptr [EDX + 0x6849c4],0x2  ; 0040c4e0 | char[256] g_CharacterClassificationTable
    JZ 0x0040c47d                       ; 0040c4e7 | LAB_0040c47d
        ;   XREF to: 0040c47d (CONDITIONAL_JUMP)
    INC EAX                             ; 0040c4e9
    MOV dword ptr [ECX],EAX             ; 0040c4ea
    JMP 0x0040c4d4                      ; 0040c4ec | LAB_0040c4d4
