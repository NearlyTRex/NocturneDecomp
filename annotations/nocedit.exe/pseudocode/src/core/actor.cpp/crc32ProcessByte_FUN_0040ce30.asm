...
;   core_script.cpp_CScript_computeChecksum_FUN_00560d80 at 00560db2
;
; *****************************************************************************
...
section .text
    ...
    JZ 0x0040cefb                       ; 0040cec8
        ;   XREF to: 0040cefb (CONDITIONAL_JUMP)  ; LAB_0040cefb
    ...
    LEA EDX,[ECX + ECX*0x1]             ; 0040ced7
        ;   Label: LAB_0040ced7
    JMP 0x0040ce56                      ; 0040ceda
        ;   XREF to: 0040ce56 (UNCONDITIONAL_JUMP)  ; LAB_0040ce56
    MOV EDX,dword ptr [EAX]             ; 0040cedf
        ;   Label: LAB_0040cedf
    ADD EDX,EDX                         ; 0040cee1
    JMP 0x0040ce6c                      ; 0040cee3
        ;   XREF to: 0040ce6c (UNCONDITIONAL_JUMP)  ; LAB_0040ce6c
    ADD EDX,EDX                         ; 0040cee5
        ;   Label: LAB_0040cee5
    JMP 0x0040ce80                      ; 0040cee7
        ;   XREF to: 0040ce80 (UNCONDITIONAL_JUMP)  ; LAB_0040ce80
    ADD EDX,EDX                         ; 0040cee9
        ;   Label: LAB_0040cee9
    JMP 0x0040ce90                      ; 0040ceeb
        ;   XREF to: 0040ce90 (UNCONDITIONAL_JUMP)  ; LAB_0040ce90
    ADD EDX,EDX                         ; 0040ceed
        ;   Label: LAB_0040ceed
    JMP 0x0040cea0                      ; 0040ceef
        ;   XREF to: 0040cea0 (UNCONDITIONAL_JUMP)  ; LAB_0040cea0
    ADD EDX,EDX                         ; 0040cef1
        ;   Label: LAB_0040cef1
    JMP 0x0040ceb0                      ; 0040cef3
        ;   XREF to: 0040ceb0 (UNCONDITIONAL_JUMP)  ; LAB_0040ceb0
    MOV EDX,dword ptr [EAX]             ; 0040cef5
        ;   Label: LAB_0040cef5
    ADD EDX,EDX                         ; 0040cef7
    JMP 0x0040cec2                      ; 0040cef9
        ;   XREF to: 0040cec2 (UNCONDITIONAL_JUMP)  ; LAB_0040cec2
