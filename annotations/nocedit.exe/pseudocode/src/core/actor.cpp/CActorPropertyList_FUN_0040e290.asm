...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_actor.cpp_CActorPropertyList_FUN_0040e290(CActorPropertyList * this_ptr)
;
; Parameters:
...
;   core_chain.cpp_FUN_00431120 at 00431204
;   core_charactr.cpp_CCharacter_FUN_0042f730 at 0042f7ce
...
;   core_enemy.cpp_CEnemy_FUN_004aa170 at 004aa200
;   ... and 10 more
;
; Called Functions:
...
section .text
    ...
    PUSH ESI                            ; 0040e2a7
    CALL core_actor.cpp_CActorPropertyList_snag_FUN_0040e6c0 ; 0040e2a8 | int core_actor.cpp_CActorPropertyList_snag_FUN_0040e6c0(CActorPropertyList * this_ptr, int property_type, char * property_name, void * data_ptr, ...)
