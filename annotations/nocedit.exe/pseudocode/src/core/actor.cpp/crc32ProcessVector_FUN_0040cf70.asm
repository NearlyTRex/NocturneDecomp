...
section .text
    ...
    PUSH ECX                            ; 0040cf7b
    CALL core_actor.cpp_crc32ProcessBuffer_FUN_0040cf10 ; 0040cf7c | void core_actor.cpp_crc32ProcessBuffer_FUN_0040cf10(uint * crc_state, byte * buffer, int buffer_length)
