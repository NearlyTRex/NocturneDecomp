...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_actor.cpp_CActorPropertyList_FUN_0040e330(CActorPropertyList * this_ptr)
;
; Parameters:
...
;   core_boxactor.cpp_FUN_004226e0 at 004228a0
;   core_chain.cpp_FUN_00431120 at 00431243
...
section .text
    ...
    PUSH EBX                            ; 0040e343
    CALL core_actor.cpp_CActorPropertyList_snag_FUN_0040e6c0 ; 0040e344 | int core_actor.cpp_CActorPropertyList_snag_FUN_0040e6c0(CActorPropertyList * this_ptr, int property_type, char * property_name, void * data_ptr, ...)
