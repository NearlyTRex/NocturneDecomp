...
; CKeyFramedModelInstance * Stack[0xc]:4   data_ptr
; int              Stack[0x10]:4   allow_none
;
; XREF[31]:
...
;   core_anvil.cpp_CAnvil_getPropertyList_FUN_00412030 at 00412053
;   core_backgnd.cpp_CBackgroundActor_getPropertyList_FUN_00412a40 at 00412a63
;   core_bat.cpp_CBat_getPropertyList_FUN_00414dc0 at 00414e40
...
section .text
    ...
    PUSH EBX                            ; 0040e3b0
        ;   Label: core_actor.cpp_CActorPropertyList_addModelKFM_FUN_0040e3b0
    PUSH 0x0                            ; 0040e3b1
    ...
    PUSH EBX                            ; 0040e3c3
    CALL core_actor.cpp_CActorPropertyList_snag_FUN_0040e6c0 ; 0040e3c4
