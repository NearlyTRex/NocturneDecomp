// Name: core_actor.cpp_CDemonActor_FUN_004093f0
// Address: 004093f0
// Address Range: [[004093f0, 0040946a]]
// Convention: __cdecl
// Signature: int core_actor.cpp_CDemonActor_FUN_004093f0(CDemonActor * this_ptr)
// Function calls:
...
int __cdecl core_actor_cpp_CDemonActor_FUN_004093f0(CDemonActor *this_ptr)

{
  ...
  fStack_2c = (float)(*((this_ptr->metadata).vtable)->hasCollision)
                               (this_ptr,(SCollisionInfo *)&puStack_30);
  if (fStack_2c == 0.0) {
    return 0x40000000;
  }
  puStack_30 = auStack_1c;
  fVar1 = core_actor_cpp_CDemonActor_rayIntersect_FUN_00409470(this_ptr);
  return (int)fVar1;
}
...
// Assembly code:
// 004093f0: PUSH EBX
//   Label: core_actor.cpp_CDemonActor_FUN_004093f0
