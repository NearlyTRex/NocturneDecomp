...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_actor.cpp_matchClassTerm_FUN_0040c4f0(CDemonActorType * type_ptr, char * * parse_pos)
;
; Parameters:
...
section .text
    ...
    TEST byte ptr [EDX + 0x6849c4],0x2  ; 0040c50a | char[256] g_CharacterClassificationTable
    JNZ 0x0040c545                      ; 0040c511 | LAB_0040c545
        ;   XREF to: 0040c545 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [EBX]             ; 0040c513
    MOV CH,byte ptr [EDI]               ; 0040c515
    CMP CH,0x28                         ; 0040c517
    JZ 0x0040c54a                       ; 0040c51a | LAB_0040c54a
        ;   XREF to: 0040c54a (CONDITIONAL_JUMP)
    CMP CH,0x21                         ; 0040c51c
    JNZ 0x0040c594                      ; 0040c51f | LAB_0040c594
        ;   XREF to: 0040c594 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 0040c525
    INC EDI                             ; 0040c526
    PUSH EBP                            ; 0040c527
    MOV dword ptr [EBX],EDI             ; 0040c528
    CALL core_actor.cpp_matchClassTerm_FUN_0040c4f0 ; 0040c52a | int core_actor.cpp_matchClassTerm_FUN_0040c4f0(CDemonActorType * type_ptr, char * * parse_pos)
        ;   XREF to: 0040c4f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0040c52f
    MOV EDI,EAX                         ; 0040c532
    TEST EAX,EAX                        ; 0040c534
    JL 0x0040c53e                       ; 0040c536 | LAB_0040c53e
    ...
    JMP 0x0040c4fe                      ; 0040c548 | LAB_0040c4fe
    ...
    CALL core_actor.cpp_matchClassExpression_FUN_0040c610 ; 0040c54f | int core_actor.cpp_matchClassExpression_FUN_0040c610(CDemonActorType * type_ptr, char * * parse_pos)
        ;   XREF to: 0040c610 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0040c554
    MOV EDI,EAX                         ; 0040c557
    TEST EAX,EAX                        ; 0040c559
    JL 0x0040c579                       ; 0040c55b | LAB_0040c579
    ...
    TEST byte ptr [EDX + 0x6849c4],0x2  ; 0040c56b | char[256] g_CharacterClassificationTable
    JZ 0x0040c583                       ; 0040c572 | LAB_0040c583
        ;   XREF to: 0040c583 (CONDITIONAL_JUMP)
    INC EAX                             ; 0040c574
    MOV dword ptr [ESI],EAX             ; 0040c575
    JMP 0x0040c55f                      ; 0040c577 | LAB_0040c55f
    ...
    JNZ 0x0040c579                      ; 0040c588 | LAB_0040c579
        ;   XREF to: 0040c579 (CONDITIONAL_JUMP)
    INC EAX                             ; 0040c58a
    ...
    TEST byte ptr [EAX + 0x6849c4],0xe0 ; 0040c59d | char[256] g_CharacterClassificationTable
    JZ 0x0040c5fa                       ; 0040c5a4 | LAB_0040c5fa
    ...
    PUSH EAX                            ; 0040c5b1
    CALL crt_ctype.c_tolower_FUN_005feb30 ; 0040c5b2 | int crt_ctype.c_tolower_FUN_005feb30(int character)
    ...
    TEST byte ptr [EDX + 0x6849c4],0xe0 ; 0040c5de | char[256] g_CharacterClassificationTable
    JNZ 0x0040c5a8                      ; 0040c5e5 | LAB_0040c5a8
        ;   XREF to: 0040c5a8 (CONDITIONAL_JUMP)
    PUSH EAX                            ; 0040c5e7
    PUSH EBP                            ; 0040c5e8
    CALL core_actor.cpp_checkNameHash_FUN_0040c700 ; 0040c5e9 | int core_actor.cpp_checkNameHash_FUN_0040c700(CDemonActorType * type_ptr, uint name_hash)
