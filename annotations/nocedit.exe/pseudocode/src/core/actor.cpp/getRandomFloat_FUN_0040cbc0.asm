...
section .text
    ...
    MOV EAX,[0x0067b654]                ; 0040cbc3 | CGame g_CGameInstance | CGame * g_CGamePtr
    CMP dword ptr [EAX + 0x23c],0x0     ; 0040cbc8 | DAT_02d81cd8
    JZ 0x0040cbee                       ; 0040cbcf | LAB_0040cbee
        ;   XREF to: 0040cbee (CONDITIONAL_JUMP)
    CALL core_actor.cpp_generateRandomValue_FUN_0040cba0 ; 0040cbd1 | uint core_actor.cpp_generateRandomValue_FUN_0040cba0()
        ;   XREF to: 0040cba0 (UNCONDITIONAL_CALL)
    MOV dword ptr [ESP + 0x4],EAX       ; 0040cbd6
    FILD dword ptr [ESP + 0x4]          ; 0040cbda
    FMUL float ptr [0x006142ec]         ; 0040cbde | int INT_006142ec
    FSTP float ptr [ESP]                ; 0040cbe4
    MOV EAX,dword ptr [ESP]             ; 0040cbe7
    ADD ESP,0x8                         ; 0040cbea
    RET                                 ; 0040cbed
    CALL crt_stdlib.c_rand_FUN_005feb5c ; 0040cbee | int crt_stdlib.c_rand_FUN_005feb5c()
        ;   Label: LAB_0040cbee
        ;   XREF to: 005feb5c (UNCONDITIONAL_CALL)
    MOV dword ptr [ESP + 0x4],EAX       ; 0040cbf3
    FILD dword ptr [ESP + 0x4]          ; 0040cbf7
    FMUL float ptr [0x006142e8]         ; 0040cbfb | float FLOAT_006142e8
