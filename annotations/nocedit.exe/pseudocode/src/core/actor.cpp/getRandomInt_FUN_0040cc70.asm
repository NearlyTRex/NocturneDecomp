...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_actor.cpp_getRandomInt_FUN_0040cc70(int min_value, int max_value)
;
; Parameters:
...
;   core_boxactor.cpp_FUN_00422a50 at 00422ac3
...
section .text
    ...
    MOV EAX,[0x0067b654]                ; 0040cc8d | CGame g_CGameInstance | CGame * g_CGamePtr
    FADD double ptr [0x006142f8]        ; 0040cc92 | double DOUBLE_006142f8
    MOV EDX,dword ptr [EAX + 0x23c]     ; 0040cc98 | DAT_02d81cd8
    FSTP double ptr [ESP]               ; 0040cc9e
    TEST EDX,EDX                        ; 0040cca1
    JNZ 0x0040ccea                      ; 0040cca3 | LAB_0040ccea
        ;   XREF to: 0040ccea (CONDITIONAL_JUMP)
    CALL crt_stdlib.c_rand_FUN_005feb5c ; 0040cca5 | int crt_stdlib.c_rand_FUN_005feb5c()
        ;   XREF to: 005feb5c (UNCONDITIONAL_CALL)
    MOV dword ptr [ESP + 0x10],EAX      ; 0040ccaa
    FILD dword ptr [ESP + 0x10]         ; 0040ccae
    FMUL float ptr [0x00614300]         ; 0040ccb2 | float FLOAT_00614300
    ...
    FADDP                               ; 0040cccb
    CALL crt_math.c_round_FUN_005fe6b0  ; 0040cccd | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0xc]         ; 0040ccd2
    MOV ECX,dword ptr [ESP + 0xc]       ; 0040ccd6
    CMP EBX,ECX                         ; 0040ccda
    JG 0x0040ccff                       ; 0040ccdc | LAB_0040ccff
        ;   XREF to: 0040ccff (CONDITIONAL_JUMP)
    CMP ESI,ECX                         ; 0040ccde
    JGE 0x0040cd03                      ; 0040cce0 | LAB_0040cd03
    ...
    POP EBX                             ; 0040cce8
    RET                                 ; 0040cce9
    CALL core_actor.cpp_generateRandomValue_FUN_0040cba0 ; 0040ccea | uint core_actor.cpp_generateRandomValue_FUN_0040cba0()
        ;   Label: LAB_0040ccea
        ;   XREF to: 0040cba0 (UNCONDITIONAL_CALL)
    MOV dword ptr [ESP + 0x10],EAX      ; 0040ccef
    FILD dword ptr [ESP + 0x10]         ; 0040ccf3
    FMUL float ptr [0x00614304]         ; 0040ccf7 | int INT_00614304
    JMP 0x0040ccb8                      ; 0040ccfd | LAB_0040ccb8
        ;   XREF to: 0040ccb8 (UNCONDITIONAL_JUMP)
    MOV EAX,EBX                         ; 0040ccff
        ;   Label: LAB_0040ccff
    JMP 0x0040cce4                      ; 0040cd01 | LAB_0040cce4
