...
;   core_chain.cpp_CChain_FUN_00431120 at 00431178
...
section .text
    ...
    PUSH EBX                            ; 0040e350
        ;   Label: core_actor.cpp_CActorPropertyList_addChoice_FUN_0040e350
    PUSH ESI                            ; 0040e351
    PUSH EDI                            ; 0040e352
    ...
    MOV ESI,0x614464                    ; 0040e37b | s_EmptyChar_00614464
    LEA EDI,[EDX + 0x84]                ; 0040e380
        ;   Label: LAB_0040e380
    PUSH EDI                            ; 0040e386
    MOV AL,byte ptr [ESI]               ; 0040e387 | s_EmptyChar_00614464 | s_s_%d_00614466
        ;   Label: LAB_0040e387
