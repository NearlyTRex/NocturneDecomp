...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_actor.cpp_CActorPropertyList_FUN_0040e5a0(CActorPropertyList * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH ECX                            ; 0040e604
    CALL core_actor.cpp_CActorPropertyList_snag_FUN_0040e6c0 ; 0040e605 | int core_actor.cpp_CActorPropertyList_snag_FUN_0040e6c0(CActorPropertyList * this_ptr, int property_type, char * property_name, void * data_ptr, ...)
        ;   XREF to: 0040e6c0 (UNCONDITIONAL_CALL)
    MOV dword ptr [EAX + 0x5c],EBX      ; 0040e60a
    INC EBX                             ; 0040e60d
    ADD ESP,0x14                        ; 0040e60e
    CMP EBX,ESI                         ; 0040e611
    JL 0x0040e5dc                       ; 0040e613 | LAB_0040e5dc
    ...
    MOV ESI,0x5                         ; 0040e62b
        ;   Label: LAB_0040e62b
    JMP 0x0040e5c3                      ; 0040e630 | LAB_0040e5c3
