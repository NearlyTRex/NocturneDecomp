...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_actor_cpp_CDemonActor_canLookAt_FUN_00409f20(CDemonActor *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH 0x530                          ; 00409f20
        ;   Label: core_actor.cpp_CDemonActor_canLookAt_FUN_00409f20
    PUSH 0x613916                       ; 00409f25 | = "..\\core\\actor.cpp"
    MOV EDX,dword ptr [ESP + 0xc]       ; 00409f2a
    PUSH EDX                            ; 00409f2e
    CALL core_actor.cpp_CDemonActor_doCheckForInvalidPointers_FUN_0040ac80 ; 00409f2f
