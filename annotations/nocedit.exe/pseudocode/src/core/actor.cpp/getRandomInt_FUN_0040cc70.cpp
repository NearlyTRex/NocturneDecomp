...
//   core_fire.cpp_CBulletHole_ctor_FUN_004bf7f0 (004bf7f0) at 004bf8cd [UNCONDITIONAL_CALL]
...

{
  ...
  uStack_1c = (undefined4)((ulonglong)((double)(max_value - min_value) + DOUBLE_006142f8) >> 0x20);
  if (iVar3 == 0) {
  ...
  fVar4 = (float10)min_value + (float10)fVar1 * (float10)(double)CONCAT44(local_18,uStack_1c);
