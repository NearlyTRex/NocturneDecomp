...
section .text
    ...
    MOV EBX,dword ptr [0x00822044]      ; 0040c7f1 | int g_NumActorClassTypes
    XOR EDX,EDX                         ; 0040c7f7
    TEST EBX,EBX                        ; 0040c7f9
    JLE 0x0040c820                      ; 0040c7fb | LAB_0040c820
        ;   XREF to: 0040c820 (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 0040c7fd
    MOV ECX,dword ptr [EAX + 0x822048]  ; 0040c7ff | CDemonActorType *[200] g_ActorClassRegistrations
        ;   Label: LAB_0040c7ff
    ...
    JL 0x0040c7ff                       ; 0040c814 | LAB_0040c7ff
        ;   XREF to: 0040c7ff (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 0040c816
    LEA EDX,[EDX]                       ; 0040c81c
    MOV dword ptr [0x00822044],EBX      ; 0040c820 | int g_NumActorClassTypes
        ;   Label: LAB_0040c820
    POP EBX                             ; 0040c826
    RET                                 ; 0040c827
