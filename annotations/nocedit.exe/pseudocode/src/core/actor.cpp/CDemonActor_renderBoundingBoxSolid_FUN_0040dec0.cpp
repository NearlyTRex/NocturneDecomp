...

{
  ...
  do {
    ...
    *(int *)((int)&g_CDemonRendererPtr2->vertex_buffer_ptr->r + iVar1) = iStack_18;
    *(int *)((int)&this_ptr_00->vertex_buffer_ptr->g + iVar1) = iStack_14;
    *(int *)((int)&this_ptr_00->vertex_buffer_ptr->b + iVar1) = blue << 8;
    *(int *)((int)&this_ptr_00->vertex_buffer_ptr->a + iVar1) = iStack_1c;
