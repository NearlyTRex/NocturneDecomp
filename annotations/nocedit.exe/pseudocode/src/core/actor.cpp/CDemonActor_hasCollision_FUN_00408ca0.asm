...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_actor_cpp_CDemonActor_hasCollision_FUN_00408ca0(CDemonActor *this_ptr,SCollisionInfo *collision_info)
;
; Parameters:
...
section .text
    ...
    PUSH 0x61364e                       ; 00408ca5 | = "..\\core\\actor.cpp"
    MOV EDX,dword ptr [ESP + 0xc]       ; 00408caa
    PUSH EDX                            ; 00408cae
    CALL core_actor.cpp_CDemonActor_doCheckForInvalidPointers_FUN_0040ac80 ; 00408caf
