// Name: core_actor.cpp_CDemonActor_FUN_0040aee0
// Address: 0040aee0
// Address Range: [[0040aee0, 0040af25]]
// Convention: __watcallRegister
// Signature: int core_actor.cpp_CDemonActor_FUN_0040aee0(int unk)
// Cross-references:
...
//   undefined1 DAT_0066e177
//   char* g_PropertyNamePrefix = 00000000
//   undefined4 g_PropertyNamePrefix+1

#include "nocturne.h"

int core_actor_cpp_CDemonActor_FUN_0040aee0(int unk)

{
  ...
  iVar2 = in_stack_00000004 + (~uVar3 - 1);
  if (iVar2 < 0) {
    iVar2 = 0;
  }
  *(undefined1 *)((int)&g_PropertyNamePrefix + iVar2) = 0;
...
// Assembly code:
// 0040aee0: PUSH EDI
//   Label: core_actor.cpp_CDemonActor_FUN_0040aee0
