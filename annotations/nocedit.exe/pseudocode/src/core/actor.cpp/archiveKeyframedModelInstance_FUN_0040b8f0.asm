...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_actor_cpp_archiveKeyframedModelInstance_FUN_0040b8f0 (CKeyFramedModelInstance *model_ptr,char *property_name)
;
; Parameters:
...
;   core_ammobox.cpp_CAmmoBox_archive_FUN_00411900 at 0041191a
;   core_anvil.cpp_CAnvil_archive_FUN_00411f50 at 00411f6a
;   core_backgnd.cpp_CBackgroundActor_archive_FUN_00412990 at 004129aa
...
section .text
    ...
    PUSH ESI                            ; 0040b8f0
        ;   Label: core_actor.cpp_archiveKeyframedModelInstance_FUN_0040b8f0
    PUSH EDI                            ; 0040b8f1
    ...
    PUSH ESI                            ; 0040b914
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 0040b915
    ...
    PUSH ESI                            ; 0040b956
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 0040b957
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveString_FUN_0040b5c0(char * string_buffer, char * property_type)
