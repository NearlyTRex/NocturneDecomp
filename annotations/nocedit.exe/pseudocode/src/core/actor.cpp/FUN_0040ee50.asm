...
section .text
    ...
    PUSH ECX                            ; 0040ee68
    CALL core_actor.cpp_CActorProperty_FUN_0040ea50 ; 0040ee69 | undefined core_actor.cpp_CActorProperty_FUN_0040ea50()
        ;   XREF to: 0040ea50 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0040ee6e
    MOV EAX,ESP                         ; 0040ee71
    PUSH EAX                            ; 0040ee73
    CALL engine_2d.c_getStringWidth_FUN_004018a0 ; 0040ee74 | int engine_2d.c_getStringWidth_FUN_004018a0(char * text)
