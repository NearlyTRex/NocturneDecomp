...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_actor_cpp_CActorProperty_getValueWidth_FUN_0040ee50(CActorProperty *this_ptr,int index)
;
; Parameters:
...
section .text
    ...
    SUB ESP,0x12c                       ; 0040ee50
        ;   Label: core_actor.cpp_CActorProperty_getValueWidth_FUN_0040ee50
    ...
    PUSH ECX                            ; 0040ee68
    CALL core_actor.cpp_CActorProperty_renderValue_FUN_0040ea50 ; 0040ee69
