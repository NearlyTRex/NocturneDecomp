...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_actor.cpp_drawBoundingBox_FUN_0040d470(CBoundingBox3D * bbox, int line_color)
;
; Parameters:
...
section .text
    ...
    MOV [0x02d02570],EAX                ; 0040d483 | int g_ActiveRenderColor
    ...
    PUSH EDX                            ; 0040d499
    CALL core_box.cpp_CBoundingBox3D_getCorner_FUN_004202b0 ; 0040d49a | CVector3f * core_box.cpp_CBoundingBox3D_getCorner_FUN_004202b0(CBoundingBox3D * this_ptr, CVector3f * out_point, uint corner_index)
    ...
    PUSH ECX                            ; 0040d4b1
    CALL core_box.cpp_CBoundingBox3D_getCorner_FUN_004202b0 ; 0040d4b2 | CVector3f * core_box.cpp_CBoundingBox3D_getCorner_FUN_004202b0(CBoundingBox3D * this_ptr, CVector3f * out_point, uint corner_index)
        ;   XREF to: 004202b0 (UNCONDITIONAL_CALL)
    ...
    FLD float ptr [0x00614454]          ; 0040d4dd | float FLOAT_00614454
    ...
    FLD float ptr [0x00614458]          ; 0040d4fb | float FLOAT_00614458
    ...
    MOV EDX,dword ptr [0x006703e8]      ; 0040d541 | CDemonRenderer * g_CDemonRendererPtr
    ...
    FMUL float ptr [0x006597b0]         ; 0040d564 | float FLOAT_006597b0
    FISTP dword ptr [EBX]               ; 0040d56a
    FLD float ptr [EAX + 0x4]           ; 0040d56c
    FMUL float ptr [0x006597b0]         ; 0040d56f | float FLOAT_006597b0
    FISTP dword ptr [EBX + 0x4]         ; 0040d575
    FLD float ptr [EAX + 0x8]           ; 0040d578
    FMUL float ptr [0x006597b0]         ; 0040d57b | float FLOAT_006597b0
    FISTP dword ptr [EBX + 0x8]         ; 0040d581
    LEA EAX,[ESP + 0x114]               ; 0040d584
    PUSH EAX                            ; 0040d58b
    MOV EAX,dword ptr [EDX]             ; 0040d58c | CDemonRenderer g_CDemonRendererInstance
    PUSH EAX                            ; 0040d58e
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 0040d58f | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    LEA EBX,[ESP + 0x14]                ; 0040d594
    ADD ESP,0x8                         ; 0040d598
    LEA EAX,[ESP + 0x48]                ; 0040d59b
    MOV EDX,dword ptr [0x006703e8]      ; 0040d59f | CDemonRenderer * g_CDemonRendererPtr
    FLD float ptr [EAX]                 ; 0040d5a5
    FMUL float ptr [0x006597b0]         ; 0040d5a7 | float FLOAT_006597b0
    FISTP dword ptr [EBX]               ; 0040d5ad
    FLD float ptr [EAX + 0x4]           ; 0040d5af
    FMUL float ptr [0x006597b0]         ; 0040d5b2 | float FLOAT_006597b0
    FISTP dword ptr [EBX + 0x4]         ; 0040d5b8
    FLD float ptr [EAX + 0x8]           ; 0040d5bb
    FMUL float ptr [0x006597b0]         ; 0040d5be | float FLOAT_006597b0
    FISTP dword ptr [EBX + 0x8]         ; 0040d5c4
    LEA EAX,[ESP + 0xc]                 ; 0040d5c7
    PUSH EAX                            ; 0040d5cb
    MOV EAX,dword ptr [EDX]             ; 0040d5cc | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0x30                        ; 0040d5ce
    PUSH EAX                            ; 0040d5d1
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 0040d5d2 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0040d5d7
    MOV EAX,[0x006703e8]                ; 0040d5da | CDemonRenderer * g_CDemonRendererPtr
    SUB ESP,0x30                        ; 0040d5df
    MOV EAX,dword ptr [EAX]             ; 0040d5e2 | CDemonRenderer g_CDemonRendererInstance
    ...
    CALL engine_3d.c_clipAndDrawLine2D_FUN_00407d70 ; 0040d5fe | void engine_3d.c_clipAndDrawLine2D_FUN_00407d70(SRenderVertex * vertex1, SRenderVertex * vertex2)
    ...
    PUSH EBX                            ; 0040d617
    CALL core_box.cpp_CBoundingBox3D_getCorner_FUN_004202b0 ; 0040d618 | CVector3f * core_box.cpp_CBoundingBox3D_getCorner_FUN_004202b0(CBoundingBox3D * this_ptr, CVector3f * out_point, uint corner_index)
        ;   XREF to: 004202b0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 0040d62f
    CALL core_box.cpp_CBoundingBox3D_getCorner_FUN_004202b0 ; 0040d630 | CVector3f * core_box.cpp_CBoundingBox3D_getCorner_FUN_004202b0(CBoundingBox3D * this_ptr, CVector3f * out_point, uint corner_index)
        ;   XREF to: 004202b0 (UNCONDITIONAL_CALL)
    ...
    FLD float ptr [0x00614454]          ; 0040d65b | float FLOAT_00614454
    ...
    FLD float ptr [0x00614458]          ; 0040d679 | float FLOAT_00614458
    ...
    MOV EDX,dword ptr [0x006703e8]      ; 0040d6c2 | CDemonRenderer * g_CDemonRendererPtr
    ...
    FMUL float ptr [0x006597b0]         ; 0040d6eb | float FLOAT_006597b0
    FISTP dword ptr [EBX]               ; 0040d6f1
    FLD float ptr [EAX + 0x4]           ; 0040d6f3
    FMUL float ptr [0x006597b0]         ; 0040d6f6 | float FLOAT_006597b0
    FISTP dword ptr [EBX + 0x4]         ; 0040d6fc
    FLD float ptr [EAX + 0x8]           ; 0040d6ff
    FMUL float ptr [0x006597b0]         ; 0040d702 | float FLOAT_006597b0
    FISTP dword ptr [EBX + 0x8]         ; 0040d708
    LEA EAX,[ESP + 0x108]               ; 0040d70b
    PUSH EAX                            ; 0040d712
    MOV EAX,dword ptr [EDX]             ; 0040d713 | CDemonRenderer g_CDemonRendererInstance
    PUSH EAX                            ; 0040d715
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 0040d716 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    LEA EBX,[ESP + 0x80]                ; 0040d71b
    ADD ESP,0x8                         ; 0040d722
    LEA EAX,[ESP + 0xc0]                ; 0040d725
    MOV EDX,dword ptr [0x006703e8]      ; 0040d72c | CDemonRenderer * g_CDemonRendererPtr
    FLD float ptr [EAX]                 ; 0040d732
    FMUL float ptr [0x006597b0]         ; 0040d734 | float FLOAT_006597b0
    FISTP dword ptr [EBX]               ; 0040d73a
    FLD float ptr [EAX + 0x4]           ; 0040d73c
    FMUL float ptr [0x006597b0]         ; 0040d73f | float FLOAT_006597b0
    FISTP dword ptr [EBX + 0x4]         ; 0040d745
    FLD float ptr [EAX + 0x8]           ; 0040d748
    FMUL float ptr [0x006597b0]         ; 0040d74b | float FLOAT_006597b0
    FISTP dword ptr [EBX + 0x8]         ; 0040d751
    LEA EAX,[ESP + 0x78]                ; 0040d754
    PUSH EAX                            ; 0040d758
    MOV EAX,dword ptr [EDX]             ; 0040d759 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0x30                        ; 0040d75b
    PUSH EAX                            ; 0040d75e
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 0040d75f | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0040d764
    MOV EAX,[0x006703e8]                ; 0040d767 | CDemonRenderer * g_CDemonRendererPtr
    SUB ESP,0x30                        ; 0040d76c
    MOV EAX,dword ptr [EAX]             ; 0040d76f | CDemonRenderer g_CDemonRendererInstance
    ...
    CALL engine_3d.c_clipAndDrawLine2D_FUN_00407d70 ; 0040d78b | void engine_3d.c_clipAndDrawLine2D_FUN_00407d70(SRenderVertex * vertex1, SRenderVertex * vertex2)
        ;   XREF to: 00407d70 (UNCONDITIONAL_CALL)
    ...
    PUSH EDI                            ; 0040d7a7
    CALL core_box.cpp_CBoundingBox3D_getCorner_FUN_004202b0 ; 0040d7a8 | CVector3f * core_box.cpp_CBoundingBox3D_getCorner_FUN_004202b0(CBoundingBox3D * this_ptr, CVector3f * out_point, uint corner_index)
        ;   XREF to: 004202b0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0040d7ba
    PUSH EDI                            ; 0040d7bb
    CALL core_box.cpp_CBoundingBox3D_getCorner_FUN_004202b0 ; 0040d7bc | CVector3f * core_box.cpp_CBoundingBox3D_getCorner_FUN_004202b0(CBoundingBox3D * this_ptr, CVector3f * out_point, uint corner_index)
        ;   XREF to: 004202b0 (UNCONDITIONAL_CALL)
    ...
    FLD float ptr [0x00614454]          ; 0040d7e7 | float FLOAT_00614454
    ...
    FLD float ptr [0x00614458]          ; 0040d80e | float FLOAT_00614458
    ...
    MOV EDX,dword ptr [0x006703e8]      ; 0040d857 | CDemonRenderer * g_CDemonRendererPtr
    ...
    FMUL float ptr [0x006597b0]         ; 0040d880 | float FLOAT_006597b0
    FISTP dword ptr [EBX]               ; 0040d886
    FLD float ptr [EAX + 0x4]           ; 0040d888
    FMUL float ptr [0x006597b0]         ; 0040d88b | float FLOAT_006597b0
    FISTP dword ptr [EBX + 0x4]         ; 0040d891
    FLD float ptr [EAX + 0x8]           ; 0040d894
    FMUL float ptr [0x006597b0]         ; 0040d897 | float FLOAT_006597b0
    FISTP dword ptr [EBX + 0x8]         ; 0040d89d
    LEA EAX,[ESP + 0x9c]                ; 0040d8a0
    PUSH EAX                            ; 0040d8a7
    MOV EAX,dword ptr [EDX]             ; 0040d8a8 | CDemonRenderer g_CDemonRendererInstance
    PUSH EAX                            ; 0040d8aa
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 0040d8ab | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    LEA EBX,[ESP + 0x20]                ; 0040d8b0
    ADD ESP,0x8                         ; 0040d8b4
    LEA EAX,[ESP + 0x3c]                ; 0040d8b7
    MOV EDX,dword ptr [0x006703e8]      ; 0040d8bb | CDemonRenderer * g_CDemonRendererPtr
    FLD float ptr [EAX]                 ; 0040d8c1
    FMUL float ptr [0x006597b0]         ; 0040d8c3 | float FLOAT_006597b0
    FISTP dword ptr [EBX]               ; 0040d8c9
    FLD float ptr [EAX + 0x4]           ; 0040d8cb
    FMUL float ptr [0x006597b0]         ; 0040d8ce | float FLOAT_006597b0
    FISTP dword ptr [EBX + 0x4]         ; 0040d8d4
    FLD float ptr [EAX + 0x8]           ; 0040d8d7
    FMUL float ptr [0x006597b0]         ; 0040d8da | float FLOAT_006597b0
    FISTP dword ptr [EBX + 0x8]         ; 0040d8e0
    LEA EAX,[ESP + 0x18]                ; 0040d8e3
    PUSH EAX                            ; 0040d8e7
    MOV EAX,dword ptr [EDX]             ; 0040d8e8 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0x30                        ; 0040d8ea
    PUSH EAX                            ; 0040d8ed
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 0040d8ee | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0040d8f3
    MOV EAX,[0x006703e8]                ; 0040d8f6 | CDemonRenderer * g_CDemonRendererPtr
    SUB ESP,0x30                        ; 0040d8fb
    MOV EAX,dword ptr [EAX]             ; 0040d8fe | CDemonRenderer g_CDemonRendererInstance
    ...
    CALL engine_3d.c_clipAndDrawLine2D_FUN_00407d70 ; 0040d91b | void engine_3d.c_clipAndDrawLine2D_FUN_00407d70(SRenderVertex * vertex1, SRenderVertex * vertex2)
        ;   XREF to: 00407d70 (UNCONDITIONAL_CALL)
    ADD ESP,0x60                        ; 0040d920
    CMP EBP,0x8                         ; 0040d923
    JL 0x0040d488                       ; 0040d926 | LAB_0040d488
