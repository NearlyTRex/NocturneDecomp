...
// Convention: __cdecl
// Signature: void __cdecl core_actor_cpp_CDemonActor_save_FUN_0040af30(CDemonActor *this_ptr,FILE *file_handle)
...

{
  ...
  pcVar3 = core_actor_cpp_CDemonActor_getActorClassName_FUN_00408b90(this_ptr);
  if (this_ptr->actor_name[0] == '\0') {
    g_CurrentFilename = "..\\core\\actor.cpp";
    g_CurrentLineNumber = 0x778;
    core_main_c_displayErrorAndQuit_FUN_00506f10("CDemonActor::save - tried to save actor of class %s with no name",pcVar3);
  }
  crt_stdio_c_fprintf_FUN_005fe6d0
            (file_handle,"%s{ %s \"%s\"\n",g_PropertyNamePrefix,pcVar3,this_ptr);
  pCVar2 = g_CurrentActorBeingProcessed;
  pFVar1 = g_ActorDataFile;
  ...
  if ((file_handle->_flag & 0x20) != 0) {
    ...
    core_main_c_displayErrorAndQuit_FUN_00506f10("IO Error after writing actor of type %s",pcVar3);
  }
  g_ActorDataFile = unaff_EBP;
  g_CurrentActorBeingProcessed = pCVar2;
  g_ActorReadingMode = (int)pFVar1;
  return;
}
