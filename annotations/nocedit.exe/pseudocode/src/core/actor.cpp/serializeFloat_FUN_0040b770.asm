...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_actor_cpp_serializeFloat_FUN_0040b770(float *float_ptr,char *property_name)
;
; Parameters:
...
section .text
    ...
    CALL core_actor.cpp_serializeDescription_FUN_0040b290 ; 0040b7a3
