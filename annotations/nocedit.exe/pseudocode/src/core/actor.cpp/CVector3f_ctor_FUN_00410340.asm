...
;   core_mobster.cpp_getObjectGrabPointWorld_FUN_00525110 at 00525136
...
;   core_zombie.cpp_getObjectGrabPointWorld_FUN_005f8da0 at 005f8dc6
;
; *****************************************************************************
...
section .text
    ...
    MOV EAX,dword ptr [ESP + 0x4]       ; 00410340
        ;   Label: core_actor.cpp_CVector3f_ctor_FUN_00410340
    RET                                 ; 00410344
