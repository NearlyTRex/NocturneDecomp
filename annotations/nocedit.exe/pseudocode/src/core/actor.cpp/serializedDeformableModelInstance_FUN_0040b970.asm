...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_actor_cpp_serializedDeformableModelInstance_FUN_0040b970 (CDeformableModelInstance *model_ptr,char *property_name)
;
; Parameters:
...
;   core_beast.cpp_CBeast_serialize_FUN_00418330 at 0041835f
;   core_biggs.cpp_CBiggs_serialize_FUN_00418ac0 at 00418aef
;   core_boneguy.cpp_CBoneGuy_serialize_FUN_0041d270 at 0041d2aa
;   core_bride.cpp_CBride_serialize_FUN_00424560 at 00424585
...
section .text
    ...
    PUSH ESI                            ; 0040b994
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 0040b995
    ...
    PUSH ESI                            ; 0040b9d9
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 0040b9da
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeString_FUN_0040b5c0(char * * string_buffer, char * property_type)
