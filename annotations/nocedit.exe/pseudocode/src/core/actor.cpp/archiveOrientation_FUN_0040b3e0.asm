...
;   core_boxactor.cpp_CLightActor_archive_FUN_00422c80 at 00422cd6
;   core_manpuz.cpp_CMansionPuzzleCircle_archive_FUN_0050adf0 at 0050aeb2
;   core_turret.cpp_CTurret_archive_FUN_005e2c40 at 005e2c5a
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0040b3e0
        ;   Label: core_actor.cpp_archiveOrientation_FUN_0040b3e0
    PUSH EDI                            ; 0040b3e1
    ...
    CALL core_actor.cpp_archiveDescription_FUN_0040b290 ; 0040b41b
