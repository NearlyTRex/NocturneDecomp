...
section .text
    ...
    PUSH EBX                            ; 0040bd70
        ;   Label: core_actor.cpp_archiveBox_FUN_0040bd70
    PUSH ESI                            ; 0040bd71
    PUSH EBP                            ; 0040bd72
    ...
    CALL core_box.cpp_CBox_saveToFile_FUN_00420020 ; 0040be2c
        ;   XREF to: 00420020 (UNCONDITIONAL_CALL)  ; void core_box.cpp_CBox_saveToFile_FUN_00420020(CBox * this_ptr, _FILE * file_handle, char * indent_prefix)
