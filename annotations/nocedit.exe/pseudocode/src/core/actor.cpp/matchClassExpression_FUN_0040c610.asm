...
section .text
    ...
    PUSH ESI                            ; 0040c651
        ;   Label: LAB_0040c651
    PUSH EBP                            ; 0040c652
    CALL core_actor.cpp_matchClassTerm_FUN_0040c4f0 ; 0040c653 | int core_actor.cpp_matchClassTerm_FUN_0040c4f0(CDemonActorType * type_ptr, char * * parse_pos)
        ;   XREF to: 0040c4f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0040c658
    TEST EAX,EAX                        ; 0040c65b
    JL 0x0040c674                       ; 0040c65d | LAB_0040c674
        ;   XREF to: 0040c674 (CONDITIONAL_JUMP)
    JLE 0x0040c620                      ; 0040c65f | LAB_0040c620
        ;   XREF to: 0040c620 (CONDITIONAL_JUMP)
    MOV EDI,0x1                         ; 0040c661
    JMP 0x0040c620                      ; 0040c666 | LAB_0040c620
        ;   XREF to: 0040c620 (UNCONDITIONAL_JUMP)
    INC EAX                             ; 0040c668
        ;   Label: LAB_0040c668
    MOV dword ptr [EDX],EAX             ; 0040c669
    JMP 0x0040c622                      ; 0040c66b | LAB_0040c622
    ...
    PUSH ESI                            ; 0040c68d
        ;   Label: LAB_0040c68d
    PUSH EBP                            ; 0040c68e
    CALL core_actor.cpp_matchClassTerm_FUN_0040c4f0 ; 0040c68f | int core_actor.cpp_matchClassTerm_FUN_0040c4f0(CDemonActorType * type_ptr, char * * parse_pos)
        ;   XREF to: 0040c4f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0040c694
    TEST EAX,EAX                        ; 0040c697
    JL 0x0040c674                       ; 0040c699 | LAB_0040c674
        ;   XREF to: 0040c674 (CONDITIONAL_JUMP)
    JNZ 0x0040c620                      ; 0040c69b | LAB_0040c620
        ;   XREF to: 0040c620 (CONDITIONAL_JUMP)
    XOR EDI,EDI                         ; 0040c69d
    JMP 0x0040c620                      ; 0040c69f | LAB_0040c620
        ;   XREF to: 0040c620 (UNCONDITIONAL_JUMP)
    PUSH ESI                            ; 0040c6a4
        ;   Label: LAB_0040c6a4
    PUSH EBP                            ; 0040c6a5
    CALL core_actor.cpp_matchClassTerm_FUN_0040c4f0 ; 0040c6a6 | int core_actor.cpp_matchClassTerm_FUN_0040c4f0(CDemonActorType * type_ptr, char * * parse_pos)
        ;   XREF to: 0040c4f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0040c6ab
    TEST EAX,EAX                        ; 0040c6ae
    JL 0x0040c674                       ; 0040c6b0 | LAB_0040c674
        ;   XREF to: 0040c674 (CONDITIONAL_JUMP)
    JLE 0x0040c620                      ; 0040c6b2 | LAB_0040c620
        ;   XREF to: 0040c620 (CONDITIONAL_JUMP)
    MOV EDI,0x1                         ; 0040c6b8
    JMP 0x0040c620                      ; 0040c6bd | LAB_0040c620
        ;   XREF to: 0040c620 (UNCONDITIONAL_JUMP)
