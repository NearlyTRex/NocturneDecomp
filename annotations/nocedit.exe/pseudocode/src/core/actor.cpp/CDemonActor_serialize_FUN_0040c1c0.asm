...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_actor_cpp_CDemonActor_serialize_FUN_0040c1c0(CDemonActor *this_ptr)
;
; Parameters:
...
;   core_battery.cpp_CBattery_serialize_FUN_00418000 at 00418006
...
;   core_chain.cpp_CChain_serialize_FUN_00430fe0 at 00430fe6
;   ... and 40 more
;
; Referenced Globals:
...
section .text
    ...
    PUSH EAX                            ; 0040c1d0
    CALL core_actor.cpp_serializeLocation_FUN_0040b480 ; 0040c1d1
        ;   XREF to: 0040b480 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeLocation_FUN_0040b480(CLocation * location_ptr, char * property_name)
    ADD ESP,0x8                         ; 0040c1d6
    PUSH 0x6141b5                       ; 0040c1d9 | = "orient"
    LEA EAX,[EBX + 0x30]                ; 0040c1de
    PUSH EAX                            ; 0040c1e1
    CALL core_actor.cpp_serializeOrientation_FUN_0040b3e0 ; 0040c1e2
    ...
    PUSH EAX                            ; 0040c20c
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 0040c20d
    ...
    PUSH EAX                            ; 0040c22b
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 0040c22c
    ...
    PUSH EAX                            ; 0040c23c
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 0040c23d
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ADD ESP,0x8                         ; 0040c242
    PUSH 0x6141d6                       ; 0040c245 | = "createEvent"
    ADD EBX,0x78                        ; 0040c24a
    PUSH EBX                            ; 0040c24d
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 0040c24e
