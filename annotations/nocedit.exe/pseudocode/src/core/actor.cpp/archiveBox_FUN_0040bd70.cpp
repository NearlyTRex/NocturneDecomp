// Name: core_actor.cpp_archiveBox_FUN_0040bd70
// Address: 0040bd70
// Address Range: [[0040bd70, 0040be5b]]
// Convention: __cdecl
// Signature: void __cdecl core_actor_cpp_archiveBox_FUN_0040bd70(CBox *box_ptr,char *property_name)
...

{
  ...
  if (g_ActorReadingMode != 1) {
    ...
    core_box_cpp_CBox_saveToFile_FUN_00420020(box_ptr,g_ActorDataFile,g_PropertyNamePrefix);
    core_actor_cpp_adjustIndentationLevel_FUN_0040aee0(-1);
  ...
  core_box_cpp_CBox_loadFromFile_FUN_0041fe90(box_ptr,g_ActorDataFile);
  do {
    while( true ) {
      iVar1 = _fgetc(g_ActorDataFile);
      if (-1 < iVar1) break;
