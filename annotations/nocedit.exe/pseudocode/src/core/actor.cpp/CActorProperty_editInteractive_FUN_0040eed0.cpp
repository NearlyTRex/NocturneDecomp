...

{
  ...
  undefined1 local_3444 [936];
  CPickList local_309c;
  CPickList local_2cf4;
  undefined1 local_294c [936];
  CPickList local_25a4;
  undefined1 local_21fc [936];
  ...
  case 0:
    ...
    while (bVar6 = shape_edittool_cpp_CEditorTools_promptForValidInteger_FUN_004a0020
                             (g_CEditorToolsPtr,local_2a0,&local_2c,SUB41(this_ptr->min_or_index,0),
  ...
  case 1:
    ...
    while (iVar15 = shape_edittool_cpp_CEditorTools_promptForValidFloat_FUN_004a00f0
                              (g_CEditorToolsPtr,local_2a0,&local_30,SUB41(this_ptr->min_or_index,0)
  ...
  case 5:
    ...
    if (iVar15 != 0) {
      *(undefined4 *)this_ptr->data_ptr = local_28;
      if (this_ptr->auto_update_flag == 0) {
        return 1;
      }
      (*actor->vtable->setup)(actor);
  ...
  case 0xf:
    ...
    *(undefined4 *)this_ptr->data_ptr = *(undefined4 *)((int)pvVar11 + iVar15 + 4);
LAB_00410163:
    shape_edittool_cpp_CPickList_dtor_FUN_004a3c80
  ...
  case 0x12:
    ...
    while( true ) {
      ...
      do {
        ...
        crt_stdio_c_sprintf_FUN_005fdbd0
                  (local_368,"%s\t%s",*(undefined4 *)((int)&PTR_s_thrust_0066e310 + iVar22),
                   pcVar8);
        iVar22 = iVar22 + 8;
...
// 0040f91a: CALL core_event.cpp_CEventList_FUN_004add00
...
// 0040f9dd: PUSH ECX
//   XREF to: 02d05310 (DATA)
// 0040f9de: CALL core_event.cpp_CEventList_FUN_004add40
...
// 0040ffdc: PUSH EDX
//   XREF to: 02d05310 (DATA)
// 0040ffdd: CALL core_event.cpp_CEventList_FUN_004add00
//   XREF to: 004add00 (UNCONDITIONAL_CALL)
