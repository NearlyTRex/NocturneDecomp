...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_actor_cpp_archiveLocation_FUN_0040b480(CLocation *location_ptr,char *property_name)
;
; Parameters:
...
;
; XREF[1]:
;   core_actor.cpp_CDemonActor_archive_FUN_0040c1c0 at 0040c1d1
;
; Referenced Globals:
...
section .text
    ...
    PUSH ESI                            ; 0040b480
        ;   Label: core_actor.cpp_archiveLocation_FUN_0040b480
    PUSH EDI                            ; 0040b481
    PUSH EBP                            ; 0040b482
    ...
    CALL core_actor.cpp_archiveDescription_FUN_0040b290 ; 0040b4c0
