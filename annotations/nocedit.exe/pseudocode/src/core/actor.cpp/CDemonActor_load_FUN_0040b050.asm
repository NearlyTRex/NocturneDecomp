...
;   core_msnedit.cpp_CDemonMission_replicateActor_FUN_0053bd80 at 0053be7b
;   core_msnedit.cpp_CDemonMission_undoActorChanges_FUN_0053c0b0 at 0053c109
;
; Referenced Globals:
...
section .text
    ...
    PUSH EAX                            ; 0040b098
    PUSH ESI                            ; 0040b099
    CALL crt_string.c__stricmp_FUN_005fe7f0 ; 0040b09a
    ...
    PUSH EAX                            ; 0040b139
    PUSH EBP                            ; 0040b13a
    CALL crt_string.c__stricmp_FUN_005fe7f0 ; 0040b13b
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)  ; int crt_string.c__stricmp_FUN_005fe7f0(char * str1, char * str2)
    ...
    PUSH EAX                            ; 0040b1cc
    PUSH EBX                            ; 0040b1cd
    CALL crt_string.c__stricmp_FUN_005fe7f0 ; 0040b1ce
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)  ; int crt_string.c__stricmp_FUN_005fe7f0(char * str1, char * str2)
