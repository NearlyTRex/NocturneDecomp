...
section .text
    ...
    CMP dword ptr [0x00822038],0x1      ; 0040b526 | int g_ActorReadingMode
    JNZ 0x0040b580                      ; 0040b52d | LAB_0040b580
    ...
    PUSH EDX                            ; 0040b53a
    PUSH EAX                            ; 0040b53b
    PUSH 0x613eed                       ; 0040b53c | = "%f,%f,%f,%f" | s_f_f_f_f_00613eed = %f,%f,%f,%f
    MOV EBX,dword ptr [0x00822034]      ; 0040b541 | FILE * g_ActorDataFile
    PUSH EBX                            ; 0040b547
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0040b548 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x18                        ; 0040b54d
    CMP EAX,0x4                         ; 0040b550
    JNZ 0x0040b56a                      ; 0040b553 | LAB_0040b56a
        ;   XREF to: 0040b56a (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [ESP + 0x10]      ; 0040b555
        ;   Label: LAB_0040b555
    PUSH EDI                            ; 0040b559
    PUSH 0x66e118                       ; 0040b55a | = "Quaternion" | s_Quaternion_0066e118 = Quaternion
    CALL core_actor.cpp_serializeDescription_FUN_0040b290 ; 0040b55f | void core_actor.cpp_serializeDescription_FUN_0040b290(char * property_description, char * property_name)
    ...
    PUSH ESI                            ; 0040b56f
    PUSH 0x66e118                       ; 0040b570 | = "Quaternion" | s_Quaternion_0066e118 = Quaternion
    CALL core_actor.cpp_handleActorPropertyParseError_FUN_0040b210 ; 0040b575 | void core_actor.cpp_handleActorPropertyParseError_FUN_0040b210(char * property_description, char * property_type)
        ;   XREF to: 0040b210 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0040b57a
    POP ESI                             ; 0040b57d
    JMP 0x0040b555                      ; 0040b57e | LAB_0040b555
    ...
    PUSH 0x66e178                       ; 0040b5a3 | char[104] g_PropertyNamePrefix
    PUSH 0x613ef9                       ; 0040b5a8 | = "%s%g,%g,%g,%g" | s_s_g_g_g_g_00613ef9 = %s%g,%g,%g,%g
    MOV ECX,dword ptr [0x00822034]      ; 0040b5ad | FILE * g_ActorDataFile
    PUSH ECX                            ; 0040b5b3
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0040b5b4 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x2c                        ; 0040b5b9
    JMP 0x0040b555                      ; 0040b5bc | LAB_0040b555
        ;   XREF to: 0040b555 (UNCONDITIONAL_JUMP)
