...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_actor.cpp_CActorProperty_FUN_0040ea50()
;
; Local Variables:
...
section .text
    ...
    JA 0x0040ee01                       ; 0040ea61 | default
        ;   XREF to: 0040ee01 (CONDITIONAL_JUMP)
    JMP dword ptr [EAX*0x4 + 0x40ea00]  ; 0040ea67 | void * switchdataD_0040ea00
        ;   Label: switchD
    MOV EAX,dword ptr [EBX + 0x68]      ; 0040ea6e
        ;   Label: caseD_0
    MOV EDI,dword ptr [EAX]             ; 0040ea71
    PUSH EDI                            ; 0040ea73
    MOV EAX,0x6144c2                    ; 0040ea74 | = "%d" | s_d_006144c2 = %d
    PUSH EAX                            ; 0040ea79 | = "%d" | s_d_006144c2 = %d
    PUSH EBP                            ; 0040ea7a
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0040ea7b | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH 0x6144c5                       ; 0040ea93 | = "%g" | s_g_006144c5 = %g
    PUSH EBP                            ; 0040ea98
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0040ea99 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ...
    PUSH 0x6144c8                       ; 0040eac3 | = "%g,%g,%g" | s_g_g_g_006144c8 = %g,%g,%g
    PUSH EBP                            ; 0040eac8
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0040eac9 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ...
    JZ 0x0040eb04                       ; 0040eadc | LAB_0040eb04
        ;   XREF to: 0040eb04 (CONDITIONAL_JUMP)
    MOV ESI,0x6144d1                    ; 0040eade | = "TRUE" | s_TRUE_006144d1 = TRUE
    MOV EDI,EBP                         ; 0040eae3
        ;   Label: LAB_0040eae3
    PUSH EDI                            ; 0040eae5
    MOV AL,byte ptr [ESI]               ; 0040eae6 | = "TRUE" | s_TRUE_006144d1 = TRUE | s_FALSE_006144d6 = FALSE
        ;   Label: LAB_0040eae6
    MOV byte ptr [EDI],AL               ; 0040eae8
    CMP AL,0x0                          ; 0040eaea
    JZ 0x0040eafe                       ; 0040eaec | LAB_0040eafe
        ;   XREF to: 0040eafe (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0040eaee | DAT_006144d2
    ADD ESI,0x2                         ; 0040eaf1
    MOV byte ptr [EDI + 0x1],AL         ; 0040eaf4
    ADD EDI,0x2                         ; 0040eaf7
    CMP AL,0x0                          ; 0040eafa
    JNZ 0x0040eae6                      ; 0040eafc | LAB_0040eae6
    ...
    POP EBX                             ; 0040eb02
    RET                                 ; 0040eb03
    MOV ESI,0x6144d6                    ; 0040eb04 | = "FALSE" | s_FALSE_006144d6 = FALSE
        ;   Label: LAB_0040eb04
    JMP 0x0040eae3                      ; 0040eb09 | LAB_0040eae3
    ...
    CMP AL,0x0                          ; 0040eb15
    JZ 0x0040eb29                       ; 0040eb17 | LAB_0040eb29
    ...
    CMP AL,0x0                          ; 0040eb25
    JNZ 0x0040eb11                      ; 0040eb27 | LAB_0040eb11
    ...
    JNZ 0x0040eb3c                      ; 0040eb35 | LAB_0040eb3c
        ;   XREF to: 0040eb3c (CONDITIONAL_JUMP)
    MOV ESI,0x6144dc                    ; 0040eb37 | = "(none)" | s_(none)_006144dc = (none)
    MOV EDI,EBP                         ; 0040eb3c
        ;   Label: LAB_0040eb3c
    PUSH EDI                            ; 0040eb3e
    MOV AL,byte ptr [ESI]               ; 0040eb3f | = "(none)" | s_(none)_006144dc = (none)
        ;   Label: LAB_0040eb3f
    MOV byte ptr [EDI],AL               ; 0040eb41
    CMP AL,0x0                          ; 0040eb43
    JZ 0x0040eb57                       ; 0040eb45 | LAB_0040eb57
        ;   XREF to: 0040eb57 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0040eb47 | DAT_006144dd
    ADD ESI,0x2                         ; 0040eb4a
    MOV byte ptr [EDI + 0x1],AL         ; 0040eb4d
    ADD EDI,0x2                         ; 0040eb50
    CMP AL,0x0                          ; 0040eb53
    JNZ 0x0040eb3f                      ; 0040eb55 | LAB_0040eb3f
    ...
    JNZ 0x0040eb8c                      ; 0040eb64 | LAB_0040eb8c
        ;   XREF to: 0040eb8c (CONDITIONAL_JUMP)
    MOV ESI,0x6144e3                    ; 0040eb66 | = "(none)" | s_(none)_006144e3 = (none)
    MOV EDI,EBP                         ; 0040eb6b
    PUSH EDI                            ; 0040eb6d
    MOV AL,byte ptr [ESI]               ; 0040eb6e | = "(none)" | s_(none)_006144e3 = (none)
        ;   Label: LAB_0040eb6e
    MOV byte ptr [EDI],AL               ; 0040eb70
    CMP AL,0x0                          ; 0040eb72
    JZ 0x0040eb86                       ; 0040eb74 | LAB_0040eb86
        ;   XREF to: 0040eb86 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0040eb76 | DAT_006144e4
    ADD ESI,0x2                         ; 0040eb79
    MOV byte ptr [EDI + 0x1],AL         ; 0040eb7c
    ADD EDI,0x2                         ; 0040eb7f
    CMP AL,0x0                          ; 0040eb82
    JNZ 0x0040eb6e                      ; 0040eb84 | LAB_0040eb6e
    ...
    CMP AL,0x0                          ; 0040eb95
    JZ 0x0040eba9                       ; 0040eb97 | LAB_0040eba9
    ...
    CMP AL,0x0                          ; 0040eba5
    JNZ 0x0040eb91                      ; 0040eba7 | LAB_0040eb91
    ...
    CMP AL,0x0                          ; 0040ebbc
    JZ 0x0040ebd0                       ; 0040ebbe | LAB_0040ebd0
    ...
    CMP AL,0x0                          ; 0040ebcc
    JNZ 0x0040ebb8                      ; 0040ebce | LAB_0040ebb8
    ...
    CMP AL,0x0                          ; 0040ebe6
    JZ 0x0040ebfa                       ; 0040ebe8 | LAB_0040ebfa
    ...
    CMP AL,0x0                          ; 0040ebf6
    JNZ 0x0040ebe2                      ; 0040ebf8 | LAB_0040ebe2
    ...
    PUSH ECX                            ; 0040ec05
    CALL core_ground.cpp_getGroundTypeName_FUN_004eed80 ; 0040ec06 | char * core_ground.cpp_getGroundTypeName_FUN_004eed80(int type)
    ...
    CMP AL,0x0                          ; 0040ec17
    JZ 0x0040ec2b                       ; 0040ec19 | LAB_0040ec2b
    ...
    CMP AL,0x0                          ; 0040ec27
    JNZ 0x0040ec13                      ; 0040ec29 | LAB_0040ec13
    ...
    MOV EAX,dword ptr [EBX + 0x68]      ; 0040ec31
        ;   Label: caseD_d
    PUSH EAX                            ; 0040ec34
    CALL core_motion.cpp_CMotionController_getMotionList_FUN_0052dce0 ; 0040ec35 | CMotionList * core_motion.cpp_CMotionController_getMotionList_FUN_0052dce0(CMotionController * this_ptr)
        ;   XREF to: 0052dce0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0040ec3a
    MOV EDX,dword ptr [EBX + 0x68]      ; 0040ec3d
    PUSH EDX                            ; 0040ec40
    MOV ESI,EAX                         ; 0040ec41
    CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0 ; 0040ec43 | SMotion * core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0(CMotionController * this_ptr)
    ...
    PUSH EAX                            ; 0040ec60
    PUSH EBX                            ; 0040ec61
    PUSH 0x6144ea                       ; 0040ec62 | = "%s (%s)" | s_s_s_006144ea = %s (%s)
    PUSH EBP                            ; 0040ec67
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0040ec68 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ...
    JL 0x0040eca5                       ; 0040ec7d | LAB_0040eca5
        ;   XREF to: 0040eca5 (CONDITIONAL_JUMP)
    MOV ESI,0x6144f2                    ; 0040ec7f | = "(add a new cloth)" | s_add_a_new_cloth_006144f2 = (add a new cloth)
    MOV EDI,EBP                         ; 0040ec84
    PUSH EDI                            ; 0040ec86
    MOV AL,byte ptr [ESI]               ; 0040ec87 | = "(add a new cloth)" | s_add_a_new_cloth_006144f2 = (add a new cloth)
        ;   Label: LAB_0040ec87
    MOV byte ptr [EDI],AL               ; 0040ec89
    CMP AL,0x0                          ; 0040ec8b
    JZ 0x0040ec9f                       ; 0040ec8d | LAB_0040ec9f
        ;   XREF to: 0040ec9f (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0040ec8f | s_add_a_new_cloth)_006144f3
    ADD ESI,0x2                         ; 0040ec92
    MOV byte ptr [EDI + 0x1],AL         ; 0040ec95
    ADD EDI,0x2                         ; 0040ec98
    CMP AL,0x0                          ; 0040ec9b
    JNZ 0x0040ec87                      ; 0040ec9d | LAB_0040ec87
    ...
    CMP AL,0x0                          ; 0040ecbc
    JZ 0x0040ecd0                       ; 0040ecbe | LAB_0040ecd0
    ...
    CMP AL,0x0                          ; 0040eccc
    JNZ 0x0040ecb8                      ; 0040ecce | LAB_0040ecb8
    ...
    JL 0x0040ed06                       ; 0040ecde | LAB_0040ed06
        ;   XREF to: 0040ed06 (CONDITIONAL_JUMP)
    MOV ESI,0x614504                    ; 0040ece0 | = "(add a rule)" | s_add_a_rule_00614504 = (add a rule)
    MOV EDI,EBP                         ; 0040ece5
    PUSH EDI                            ; 0040ece7
    MOV AL,byte ptr [ESI]               ; 0040ece8 | = "(add a rule)" | s_add_a_rule_00614504 = (add a rule)
        ;   Label: LAB_0040ece8
    MOV byte ptr [EDI],AL               ; 0040ecea
    CMP AL,0x0                          ; 0040ecec
    JZ 0x0040ed00                       ; 0040ecee | LAB_0040ed00
        ;   XREF to: 0040ed00 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0040ecf0 | s_add_a_rule)_00614505
    ADD ESI,0x2                         ; 0040ecf3
    MOV byte ptr [EDI + 0x1],AL         ; 0040ecf6
    ADD EDI,0x2                         ; 0040ecf9
    CMP AL,0x0                          ; 0040ecfc
    JNZ 0x0040ece8                      ; 0040ecfe | LAB_0040ece8
    ...
    PUSH EAX                            ; 0040ed23
    PUSH 0x614511                       ; 0040ed24 | = "%s => %s" | s_s_s_00614511 = %s => %s
    PUSH EBP                            ; 0040ed29
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0040ed2a | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ...
    JNZ 0x0040ed77                      ; 0040ed50 | LAB_0040ed77
    ...
    PUSH EDI                            ; 0040ed58
    MOV AL,byte ptr [ESI]               ; 0040ed59 | = "??????" | s_??????_0061451a = ??????
        ;   Label: LAB_0040ed59
    MOV byte ptr [EDI],AL               ; 0040ed5b
    CMP AL,0x0                          ; 0040ed5d
    JZ 0x0040ed71                       ; 0040ed5f | LAB_0040ed71
    ...
    CMP AL,0x0                          ; 0040ed6d
    JNZ 0x0040ed59                      ; 0040ed6f | LAB_0040ed59
    ...
    JL 0x0040ed4b                       ; 0040ed80 | LAB_0040ed4b
        ;   XREF to: 0040ed4b (CONDITIONAL_JUMP)
    JMP 0x0040ed54                      ; 0040ed82 | LAB_0040ed54
        ;   XREF to: 0040ed54 (UNCONDITIONAL_JUMP)
    MOV ESI,0x614521                    ; 0040ed84 | = "(none)" | s_(none)_00614521 = (none)
        ;   Label: caseD_12
    MOV EDI,EBP                         ; 0040ed89
    PUSH EDI                            ; 0040ed8b
    MOV AL,byte ptr [ESI]               ; 0040ed8c | = "(none)" | s_(none)_00614521 = (none)
        ;   Label: LAB_0040ed8c
    MOV byte ptr [EDI],AL               ; 0040ed8e
    CMP AL,0x0                          ; 0040ed90
    JZ 0x0040eda4                       ; 0040ed92 | LAB_0040eda4
        ;   XREF to: 0040eda4 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0040ed94 | DAT_00614522
    ADD ESI,0x2                         ; 0040ed97
    MOV byte ptr [EDI + 0x1],AL         ; 0040ed9a
    ADD EDI,0x2                         ; 0040ed9d
    CMP AL,0x0                          ; 0040eda0
    JNZ 0x0040ed8c                      ; 0040eda2 | LAB_0040ed8c
    ...
    MOV EAX,dword ptr [EBX + 0x68]      ; 0040eda9
        ;   Label: LAB_0040eda9
    MOV EDX,dword ptr [EDI + 0x66e30c]  ; 0040edac | undefined4 DAT_0066e30c | DAT_0066e314 = 0x2
    TEST dword ptr [EAX],EDX            ; 0040edb2
    JZ 0x0040ede1                       ; 0040edb4 | LAB_0040ede1
        ;   XREF to: 0040ede1 (CONDITIONAL_JUMP)
    CMP ESI,EBP                         ; 0040edb6
    JBE 0x0040edca                      ; 0040edb8 | LAB_0040edca
        ;   XREF to: 0040edca (CONDITIONAL_JUMP)
    PUSH 0x614528                       ; 0040edba | = ", " | s_anon_00614528 = ,
    PUSH ESI                            ; 0040edbf
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0040edc0 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0040edc5
    ADD ESI,EAX                         ; 0040edc8
    MOV ECX,dword ptr [EDI + 0x66e310]  ; 0040edca | void * PTR_s_thrust_0066e310 | PTR_s_swing_0066e318 = 006146fc
        ;   Label: LAB_0040edca
    PUSH ECX                            ; 0040edd0
    PUSH 0x61452b                       ; 0040edd1 | = "%s" | s_s_0061452b = %s
    PUSH ESI                            ; 0040edd6
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0040edd7 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ...
    JZ 0x0040ea83                       ; 0040ede7 | LAB_0040ea83
        ;   XREF to: 0040ea83 (CONDITIONAL_JUMP)
    JMP 0x0040eda9                      ; 0040eded | LAB_0040eda9
    ...
    MOV ESI,dword ptr [EBX]             ; 0040ee01
        ;   Label: default
    PUSH ESI                            ; 0040ee03
    MOV EDX,0x61452e                    ; 0040ee04 | = "..\\core\\actor.cpp" | s_core_actor_cpp_0061452e = ..\core\actor.cpp
    MOV ECX,0xfc9                       ; 0040ee09
    PUSH 0x614540                       ; 0040ee0e | = "Unknown CActorProperty type: %d" | s_Unknown_CActorProperty_t_00614540 = Unknown CActorProperty type: %d
    MOV dword ptr [0x02f0ca48],EDX      ; 0040ee13 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 0040ee19 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0040ee1f | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
