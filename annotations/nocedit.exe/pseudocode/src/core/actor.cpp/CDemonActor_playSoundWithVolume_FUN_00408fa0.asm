...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_actor_cpp_CDemonActor_playSoundWithVolume_FUN_00408fa0(CDemonActor *this_ptr,char *sound_name,float volume)
;
; Parameters:
...
section .text
    ...
    PUSH ECX                            ; 00408fb1
    PUSH EDX                            ; 00408fb2
    MOV EBX,dword ptr [0x00681ef8]      ; 00408fb3 | g_CSoundInstance | g_CSoundPtr
    PUSH EBX                            ; 00408fb9 | g_CSoundInstance
    CALL core_sound.cpp_CSound_playActorPositionalSoundWithDelay_FUN_005b3ae0 ; 00408fba
