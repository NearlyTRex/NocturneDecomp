...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_actor.cpp_CActorPropertyList_FUN_0040e770()
;
; Local Variables:
...
section .text
    ...
    JLE 0x0040e7bd                      ; 0040e787 | LAB_0040e7bd
        ;   XREF to: 0040e7bd (CONDITIONAL_JUMP)
    LEA EBX,[EDI + 0x8]                 ; 0040e789
    PUSH EBX                            ; 0040e78c
        ;   Label: LAB_0040e78c
    CALL core_actor.cpp_FUN_0040ee30    ; 0040e78d | undefined core_actor.cpp_FUN_0040ee30()
        ;   XREF to: 0040ee30 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0040e792
    CMP EAX,EBP                         ; 0040e795
    JLE 0x0040e79b                      ; 0040e797 | LAB_0040e79b
    ...
    PUSH EDX                            ; 0040e79d
    PUSH EBX                            ; 0040e79e
    CALL core_actor.cpp_FUN_0040ee50    ; 0040e79f | undefined core_actor.cpp_FUN_0040ee50()
        ;   XREF to: 0040ee50 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0040e7a4
    CMP EAX,dword ptr [ESP]             ; 0040e7a7
    JLE 0x0040e7af                      ; 0040e7aa | LAB_0040e7af
    ...
    JL 0x0040e78c                       ; 0040e7bb | LAB_0040e78c
        ;   XREF to: 0040e78c (CONDITIONAL_JUMP)
    PUSH 0x6144b9                       ; 0040e7bd | = ": " | s_anon_006144b9 = :
        ;   Label: LAB_0040e7bd
    CALL engine_2d.c_getStringWidth_FUN_004018a0 ; 0040e7c2 | int engine_2d.c_getStringWidth_FUN_004018a0(char * text)
    ...
    PUSH 0x6144bc                       ; 0040e7d5 | = ": " | s_anon_006144bc = :
    MOV dword ptr [EDI + 0x24f0],EAX    ; 0040e7da
    CALL engine_2d.c_getStringWidth_FUN_004018a0 ; 0040e7e0 | int engine_2d.c_getStringWidth_FUN_004018a0(char * text)
        ;   XREF to: 004018a0 (UNCONDITIONAL_CALL)
