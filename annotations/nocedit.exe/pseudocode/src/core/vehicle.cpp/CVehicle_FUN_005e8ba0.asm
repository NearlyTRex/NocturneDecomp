...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_vehicle.cpp_CVehicle_FUN_005e8ba0(CVehicle * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 005e8bb7
    CALL core_actor.cpp_CDemonActor_getPropertyList_FUN_0040d290 ; 005e8bb8 | void core_actor.cpp_CDemonActor_getPropertyList_FUN_0040d290(CDemonActor * this_ptr, CActorPropertyList * property_list)
    ...
    PUSH EAX                            ; 005e8bce
    PUSH 0x656f69                       ; 005e8bcf | = "Model file (.kfm)" | s_Model_file_kfm_00656f69 = Model file (.kfm)
    PUSH EBP                            ; 005e8bd4
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e3b0 ; 005e8bd5 | void core_actor.cpp_CActorPropertyList_FUN_0040e3b0(CActorPropertyList * this_ptr)
    ...
    JLE 0x005e8c86                      ; 005e8bee | LAB_005e8c86
    ...
    MOV EAX,dword ptr [EDI + 0x684480]  ; 005e8c11 | void * PTR_s_Left_front_00684480 | PTR_s_Right_front_00684484 = 00656fc0
        ;   Label: LAB_005e8c11
    PUSH EAX                            ; 005e8c17 | = "Left front" | s_Left_front_00656fb5 = Left front | s_Right_front_00656fc0 = Right front
    PUSH 0x656f7b                       ; 005e8c18 | = "%s tire" | s_s_tire_00656f7b = %s tire
    LEA EAX,[ESP + 0x10]                ; 005e8c1d
    PUSH EAX                            ; 005e8c21
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005e8c22 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e3b0 ; 005e8c49 | void core_actor.cpp_CActorPropertyList_FUN_0040e3b0(CActorPropertyList * this_ptr)
        ;   XREF to: 0040e3b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 005e8c4e
    PUSH 0x0                            ; 005e8c51
    MOV EDX,dword ptr [ESP + 0x10c]     ; 005e8c53
    PUSH EDX                            ; 005e8c5a
    PUSH 0x656f83                       ; 005e8c5b | = "bpos" | s_bpos_00656f83 = bpos
    PUSH EBP                            ; 005e8c60
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e260 ; 005e8c61 | void core_actor.cpp_CActorPropertyList_FUN_0040e260(CActorPropertyList * this_ptr)
    ...
    JL 0x005e8c11                       ; 005e8c82 | LAB_005e8c11
    ...
    PUSH EAX                            ; 005e8c94
    PUSH 0x656f88                       ; 005e8c95 | = "Current time" | s_Current_time_00656f88 = Current time
    PUSH EBP                            ; 005e8c9a
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e160 ; 005e8c9b | void core_actor.cpp_CActorPropertyList_FUN_0040e160(CActorPropertyList * this_ptr)
    ...
    PUSH EAX                            ; 005e8cb1
    PUSH 0x656f95                       ; 005e8cb2 | = "Total time" | s_Total_time_00656f95 = Total time
    PUSH EBP                            ; 005e8cb7
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e160 ; 005e8cb8 | void core_actor.cpp_CActorPropertyList_FUN_0040e160(CActorPropertyList * this_ptr)
        ;   XREF to: 0040e160 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 005e8cd0
    PUSH 0x656fa0                       ; 005e8cd1 | = "Course name" | s_Course_name_00656fa0 = Course name
    PUSH EBP                            ; 005e8cd6
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e290 ; 005e8cd7 | void core_actor.cpp_CActorPropertyList_FUN_0040e290(CActorPropertyList * this_ptr)
