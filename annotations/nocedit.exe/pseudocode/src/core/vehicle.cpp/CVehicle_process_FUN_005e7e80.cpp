...

{
  ...
  pCVar7 = (CVector3f *)(this_ptr->field1_0x158 + 0x76c);
  if (delta_time <= 0.0) {
  ...
  local_34 = *(float *)(this_ptr->field1_0x158 + 0x76c) * 2.0f;
  local_30 = *(float *)(this_ptr->field1_0x158 + 0x770) * 2.0f;
  local_2c = 2.0f * *(float *)(this_ptr->field1_0x158 + 0x774);
  ...
  ;
  if ((CVector3f *)(this_ptr->field1_0x158 + 0x778) != pCVar7) {
    ((CVector3f *)(this_ptr->field1_0x158 + 0x778))->x = pCVar7->x;
    *(float *)(this_ptr->field1_0x158 + 0x77c) = pCVar7->y;
    *(float *)(this_ptr->field1_0x158 + 0x780) = pCVar7->z;
  }
  iVar12 = 0;
  pCVar8 = this_ptr;
  if (0 < this_ptr->tire_count) {
    do {
      iVar12 = iVar12 + 1;
      *(float *)(pCVar8->field3_0x93c + 400) =
           *(float *)(pCVar8->field3_0x93c + 0xc) * local_24 +
           *(float *)(pCVar8->field3_0x93c + 400);
      pCVar8 = (CVehicle *)(pCVar8->field1_0x158 + 0x5c);
    } while (iVar12 < this_ptr->tire_count);
  }
  fVar3 = (this_ptr->base_actor).location.position.y;
  fVar4 = (this_ptr->base_actor).orient.bank;
  (this_ptr->base_actor).orient.pitch = 0.0;
  pCVar5 = (this_ptr->base_actor).vtable._ub;
  fVar4 = fVar4 + 1.570796f;
  (this_ptr->base_actor).location.position.y = fVar3 + 3.7f;
  (this_ptr->base_actor).orient.bank = fVar4;
  (*pCVar5->getBoundingBox)(&this_ptr->base_actor,&local_a0);
  iVar12 = 0;
  for (iVar13 = 0; iVar13 < g_CDemonSetPtr->damage_listener_count; iVar13 = iVar13 + 1) {
    this_ptr_00 = *(CCharacter **)(g_CDemonSetPtr->field19_0x14f0a0 + iVar12 + -4);
    pCVar9 = core_actor_cpp_castToClassHash_FUN_0040c790
                       (&this_ptr_00->base_actor,g_CMobsterClassInfo.name_hash);
    if ((pCVar9 == (CDemonActor *)0x0) ||
      ...
      iVar10 = (*((this_ptr_00->base_actor).vtable._ub)->hasCollision)
                         (&this_ptr_00->base_actor,(SCollisionInfo *)(auStack_f4 + 0x34));
      if ((iVar10 == 2) &&
         (((((this_ptr_00->base_actor).location.position.y <=
             (this_ptr->base_actor).location.position.y + local_80 &&
            ((this_ptr->base_actor).location.position.y + local_a0.max.z <=
             (this_ptr_00->base_actor).location.position.y + local_a0.min.x)) &&
           (core_actor_cpp_CDemonActor_worldToLocalPoint_FUN_00408f10
                      (&this_ptr->base_actor,(CVector3f *)(local_58 + 4),
                       &(this_ptr_00->base_actor).location.position),
        ...
        if (local_4c.x - local_a0.min.y <= local_7c) {
          ...
          (*(((this_ptr_00->base_actor).vtable._uc)->_uc).processDamage)
                ...
                (iVar10 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660
                                    (*(uint *)(this_ptr->field6_0x1034 + 0x20)), iVar10 == 0)) {
          uVar11 = core_vehicle_cpp_FUN_005e8b50();
          *(uint *)(this_ptr->field6_0x1034 + 0x20) = uVar11;
        }
      }
    }
    iVar12 = iVar12 + 4;
  ...
  fStack_38 = (this_ptr->base_actor).location.position.x -
              (pCVar6->base_character).base_actor.location.position.x;
  local_34 = (this_ptr->base_actor).location.position.y -
             (pCVar6->base_character).base_actor.location.position.y;
  local_30 = (this_ptr->base_actor).location.position.z -
             (pCVar6->base_character).base_actor.location.position.z;
  ...
  for (iVar13 = 0; iVar13 < *(int *)(g_CDemonSetPtr->field19_0x14f0a0 + 0x1f3c); iVar13 = iVar13 + 1
    ...
    if ((pCVar9 != (CDemonActor *)0x0) &&
      ...
      if (*(int *)(pCVar9[0x8e].actor_name + 0x14) == 0) {
        *(CDemonActor **)(pCVar8->field6_0x1034 + 0x3c) = pCVar9;
        local_14 = 1;
      }
      else {
        *(CDemonActor **)(pCVar8->field6_0x1034 + 0x40) = pCVar9;
        iStack_18 = 1;
      }
    }
    iVar12 = iVar12 + 4;
...
joined_r0x005e8664:
  ...
  core_skeleton_cpp_CDeformableModelInstance_init_FUN_005a0840
            (&(this_ptr_02->base_enemy).base_character.model,model_name);
  *(CVehicle **)(this_ptr_02->field3_0xbedc + 4) = this_ptr;
  if (local_14 == 0) {
    this_ptr_02->side_of_car = 0;
    *(CMobster **)(this_ptr->field6_0x1034 + 0x3c) = this_ptr_02;
  }
  else {
    this_ptr_02->side_of_car = 1;
    *(CMobster **)(this_ptr->field6_0x1034 + 0x40) = this_ptr_02;
  }
  core_mission_cpp_CDemonMission_initNewActorMaybe_FUN_00524700(g_CDemonMissionPtr);
  core_mission_cpp_CDemonMission_initNewActorMaybe_FUN_00524700(g_CDemonMissionPtr);
  (this_ptr_02->base_enemy).base_character.base_actor.location.position.x =
       (this_ptr->base_actor).location.position.x;
  (this_ptr_02->base_enemy).base_character.base_actor.location.position.y =
       (this_ptr->base_actor).location.position.y;
  (this_ptr_02->base_enemy).base_character.base_actor.location.position.z =
       (this_ptr->base_actor).location.position.z;
  (this_ptr_02->base_enemy).base_character.base_actor.location.area_id =
       (this_ptr->base_actor).location.area_id;
  pCVar1 = &(this_ptr_02->base_enemy).base_character.base_actor.orient;
  pCVar2 = &(this_ptr->base_actor).orient;
  if (pCVar1 != pCVar2) {
    pCVar1->pitch = pCVar2->pitch;
    (this_ptr_02->base_enemy).base_character.base_actor.orient.bank =
         (this_ptr->base_actor).orient.bank;
    (this_ptr_02->base_enemy).base_character.base_actor.orient.heading =
  ...
  *(int *)(iVar12 + 0x2c) = (this_ptr->base_actor).location.area_id;
  ...
  (*((this_ptr_02->base_enemy).base_character.base_actor.vtable._ub)->setup)
...
LAB_005e82f4:
  ...
  if (iVar12 == 0) {
    uVar11 = core_vehicle_cpp_FUN_005e8b50();
    *(uint *)(this_ptr->field6_0x1034 + 0x24) = uVar11;
  }
  ...
  if (((float)0.20000000000000001 < ABS(*(float *)(this_ptr->field1_0x158 + 0x778))) &&
    ...
    uVar11 = core_vehicle_cpp_FUN_005e8b50();
    *(uint *)(this_ptr->field6_0x1034 + 0x28) = uVar11;
    return;
  }
  return;
}
