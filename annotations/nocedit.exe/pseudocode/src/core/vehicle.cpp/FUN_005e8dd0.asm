...
section .text
    ...
    PUSH 0x665150                       ; 005e8dd0 | WatcomTypeInfo g_CTireTypeInfo
        ;   Label: core_vehicle.cpp_FUN_005e8dd0
    PUSH 0x4                            ; 005e8dd5
    MOV EDX,dword ptr [ESP + 0xc]       ; 005e8dd7
    PUSH EDX                            ; 005e8ddb
    CALL crt_memory.c_freeTypeArray_FUN_005feee9 ; 005e8ddc | int crt_memory.c_freeTypeArray_FUN_005feee9(void * * obj_array, int obj_count, WatcomTypeInfo * type_info)
