...

{
  ...
  (ADJ(pCVar4)->local_velocity).y = 0.0;
  (ADJ(pCVar4)->local_velocity).x = 0.0;
  (ADJ(pCVar4)->world_velocity).z = 0.0;
  (ADJ(pCVar4)->world_velocity).y = 0.0;
  (ADJ(pCVar4)->world_velocity).x = 0.0;
  ADJ(pCVar4)->unused_physics_vectors[2].z = 0.0;
  ADJ(pCVar4)->unused_physics_vectors[2].y = 0.0;
  ADJ(pCVar4)->unused_physics_vectors[2].x = 0.0;
