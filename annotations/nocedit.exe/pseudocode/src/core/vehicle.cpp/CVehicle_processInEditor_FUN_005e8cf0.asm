...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_vehicle_cpp_CVehicle_processInEditor_FUN_005e8cf0(CVehicle *this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x4]       ; 005e8cf0
        ;   Label: core_vehicle.cpp_CVehicle_processInEditor_FUN_005e8cf0
    PUSH EDX                            ; 005e8cf4
