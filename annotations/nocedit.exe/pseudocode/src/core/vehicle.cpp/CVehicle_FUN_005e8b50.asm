...
;                               FUNCTION
; *****************************************************************************
; __cdecl uint __cdecl core_vehicle_cpp_CVehicle_FUN_005e8b50(CVehicle *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005e8b50
        ;   Label: core_vehicle.cpp_CVehicle_FUN_005e8b50
    PUSH ESI                            ; 005e8b51
    MOV ESI,dword ptr [ESP + 0xc]       ; 005e8b52
    LEA EBX,[ESI + 0x20]                ; 005e8b56
    CALL sound_sndmain.cpp_pushSfxOptions_FUN_005a8c30 ; 005e8b59
        ;   XREF to: 005a8c30 (UNCONDITIONAL_CALL)  ; void sound_sndmain.cpp_pushSfxOptions_FUN_005a8c30()
    PUSH EBX                            ; 005e8b5e
    CALL sound_sndmain.cpp_setNextSfxTrackedFloatPosition_FUN_005a8940 ; 005e8b5f
    ...
    PUSH EDX                            ; 005e8b7b
    PUSH ESI                            ; 005e8b7c
    MOV ECX,dword ptr [0x00681ef8]      ; 005e8b7d | g_CSoundInstance | g_CSoundPtr
    PUSH ECX                            ; 005e8b83 | g_CSoundInstance
    CALL core_sound.cpp_CSound_playTrackedActorSound_FUN_005b3a70 ; 005e8b84
    ...
    CALL sound_sndmain.cpp_popSfxOptions_FUN_005a8cb0 ; 005e8b8e
