...
;                               FUNCTION
; *****************************************************************************
; __cdecl CVehicle * __cdecl core_vehicle_cpp_CVehicle_ctor_FUN_005e7940(CVehicle *this_ptr)
;
; Parameters:
; CVehicle *       Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_vehicle.cpp_factoryFunc_FUN_005e7900 at 005e791a
;
; Referenced Globals:
...
section .text
    ...
    PUSH EAX                            ; 005e79a7
    MOV dword ptr [EBX + 0x154],0x665064 ; 005e79a8 | PTR_core_vehicle.cpp_FUN_00665064
