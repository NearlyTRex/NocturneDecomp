...
section .text
    ...
    FNSTSW AX                           ; 005e7865
    SAHF                                ; 005e7867
    JC 0x005e7888                       ; 005e7868 | LAB_005e7888
    ...
    JMP 0x005e787b                      ; 005e7899 | LAB_005e787b
        ;   XREF to: 005e787b (UNCONDITIONAL_JUMP)
    FLD float ptr [EDX + 0x8]           ; 005e789b
        ;   Label: LAB_005e789b
    FLD float ptr [EDX]                 ; 005e789e
    CALL crt_math.c_atan2_FUN_006013b1  ; 005e78a0 | float10 crt_math.c_atan2_FUN_006013b1(float10 y, float10 x)
    ...
    CALL crt_math.c_atan2_FUN_006013b1  ; 005e78b8 | float10 crt_math.c_atan2_FUN_006013b1(float10 y, float10 x)
        ;   XREF to: 006013b1 (UNCONDITIONAL_CALL)
    FCHS                                ; 005e78bd
