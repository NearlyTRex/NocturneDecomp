...

{
  ...
  if (0 < this_ptr->tire_count) {
    float_ptr_00 = this_ptr->field3_0x93c + 0x10;
    float_ptr = this_ptr->field3_0x93c + 0xc;
    model_ptr = (CKeyFramedModelInstance *)(this_ptr->field3_0x93c + 0x14);
    do {
      ...
      core_actor_cpp_serializeVector_FUN_0040b340
                ((CVector3f *)(this_ptr->field3_0x93c + iVar1 * 0x1b4),"static_bpos");
  ...
  if (g_CVehicleClassVersion < 2) {
    ...
    core_actor_cpp_serializeString_FUN_0040b5c0
              ((char **)this_ptr->field6_0x1034,"courseName");
    if (g_CVehicleClassVersion < 3) {
      return;
    }
  }
  core_actor_cpp_serializeActor_FUN_0040b870
            ((CDemonActor *)(this_ptr->field6_0x1034 + 0x3c),"lastMobsterLeft");
  core_actor_cpp_serializeActor_FUN_0040b870
            ((CDemonActor *)(this_ptr->field6_0x1034 + 0x3c),"lastMobsterRight");
  return;
}
