...
section .text
    ...
    PUSH 0x665170                       ; 005e8d6d | g_CVehicleTypeInfo
        ;   Label: LAB_005e8d6d
    PUSH EBX                            ; 005e8d72
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 005e8d73
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 005e8d78
    PUSH EAX                            ; 005e8d7b
    CALL crt_memory.c_free_FUN_005fe659 ; 005e8d7c
    ...
    PUSH EAX                            ; 005e8d88
        ;   Label: LAB_005e8d88
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 005e8d89
