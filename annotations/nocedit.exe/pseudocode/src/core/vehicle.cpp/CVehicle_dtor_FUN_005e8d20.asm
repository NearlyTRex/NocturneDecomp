...
;   core_vehicle.cpp_freeTires_FUN_005e8dd0
...
section .text
    ...
    PUSH EAX                            ; 005e8d44
    CALL core_vehicle.cpp_freeTires_FUN_005e8dd0 ; 005e8d45
        ;   XREF to: 005e8dd0 (UNCONDITIONAL_CALL)  ; CTire * core_vehicle.cpp_freeTires_FUN_005e8dd0(CTire * objs)
