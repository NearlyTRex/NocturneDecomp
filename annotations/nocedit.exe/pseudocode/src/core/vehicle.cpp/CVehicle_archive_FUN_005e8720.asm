...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_vehicle_cpp_CVehicle_archive_FUN_005e8720(CVehicle *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005e8720
        ;   Label: core_vehicle.cpp_CVehicle_archive_FUN_005e8720
    PUSH EBP                            ; 005e8721
    SUB ESP,0x8                         ; 005e8722
    MOV EDX,dword ptr [ESP + 0x14]      ; 005e8725
    PUSH EDX                            ; 005e8729
    CALL core_actor.cpp_CDemonActor_archive_FUN_0040c1c0 ; 005e872a
    ...
    PUSH EAX                            ; 005e8740
    CALL core_actor.cpp_archiveKeyframedModelInstance_FUN_0040b8f0 ; 005e8741
    ...
    PUSH EAX                            ; 005e8757
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 005e8758
    ...
    CALL core_actor.cpp_archiveKeyframedModelInstance_FUN_0040b8f0 ; 005e87b0
        ;   XREF to: 0040b8f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveKeyframedModelInstance_FUN_0040b8f0(CKeyFramedModelInstance * model_ptr, char * property_name)
    ADD ESP,0x8                         ; 005e87b5
    PUSH 0x656f12                       ; 005e87b8 | = "static_bpos"
    MOV EAX,dword ptr [ESP + 0xc]       ; 005e87bd
    PUSH EAX                            ; 005e87c1
    CALL core_actor.cpp_archiveVector_FUN_0040b340 ; 005e87c2
    ...
    PUSH EBP                            ; 005e87cf
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 005e87d0
    ...
    PUSH ESI                            ; 005e87dd
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 005e87de
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH EAX                            ; 005e882f
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 005e8830
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH EAX                            ; 005e8846
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 005e8847
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH EAX                            ; 005e885d
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 005e885e
