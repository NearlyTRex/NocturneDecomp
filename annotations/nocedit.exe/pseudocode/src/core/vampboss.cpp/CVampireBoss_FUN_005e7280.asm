...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_vampboss.cpp_CVampireBoss_FUN_005e7280(CVampireBoss * this_ptr)
;
; Parameters:
...
section .text
    ...
    FXCH                                ; 005e72ad
    FLD float ptr [0x00656cab]          ; 005e72af | float FLOAT_00656cab
    FXCH                                ; 005e72b5
    FMUL ST1                            ; 005e72b7
    FXCH ST2                            ; 005e72b9
    ...
    JNZ 0x005e72f3                      ; 005e72e7 | LAB_005e72f3
