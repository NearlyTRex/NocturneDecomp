...

{
  ...
  if (iVar18 == 2) {
    ...
    if ((this_ptr->bat_ai_state != 2) && (this_ptr->bat_ai_state != 3)) {
      ...
      if (fVar13 < (float)5) {
        ...
        local_18 = (float)(uint)(fVar10 - fVar11 < (float)10);
    ...
    fVar10 = local_18 * delta_time * 1.2;
    if (ABS(fVar10) <= ABS(local_18)) {
    ...
    local_18 = core_actor_cpp_normalizeAngleToPi_FUN_0040cd70
                         (local_38 - (this_ptr->base).base.base.orient.vec.x);
    fVar3 = (this_ptr->base).base.hit_points;
    local_58 = -0.3926991;
    local_24 = 0.3926991;
    (this_ptr->base).base.base.orient.vec.x =
         local_18 * delta_time * 1.2 + (this_ptr->base).base.base.orient.vec.x;
  ...
  if (iVar18 == 3) {
    ...
    core_cloth_cpp_CCloth_process_FUN_0043ab80
              (&this_ptr->cape_cloth,&(this_ptr->base).base.base.location.position,
               &euler_00->vec,delta_time,
               (this_ptr->base).base.closest_distance_threshold,pCVar6);
    core_cloth_cpp_CCloth_process_FUN_0043ab80
              (&this_ptr->skirt_cloth,&(this_ptr->base).base.base.location.position,
               &euler_00->vec,delta_time,
               (this_ptr->base).base.closest_distance_threshold,pCVar6);
    pCVar20 = core_skeleton_cpp_CDeformableModelInstance_computeBoundingBoxFromBones_FUN_005a16c0
                        (pCVar6,&local_1b4);
    ...
    if (pCVar8->letterbox_mode == 0) {
      ...
      default:
        ...
        if (iVar21 == 0) {
          ...
          turn_speed = (this_ptr->base).base.turn_speed;
          local_18 = core_actor_cpp_normalizeAngleToPi_FUN_0040cd70
                               ((this_ptr->base).base.turn_angle_accumulator);
          clamped_angle = -turn_speed;
          if ((clamped_angle <= local_18) &&
             (clamped_angle = local_18, turn_speed < local_18)) {
            clamped_angle = turn_speed;
          }
          fVar10 = this_ptr->action_timer - delta_time;
          (this_ptr->base).base.turn_angle_accumulator = clamped_angle;
