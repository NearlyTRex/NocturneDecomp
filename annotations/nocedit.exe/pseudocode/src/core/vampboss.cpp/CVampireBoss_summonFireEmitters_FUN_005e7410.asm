...
;   core_emitter.cpp_CEmitter_launchFireballAtHero_FUN_004a7e80
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 005e7410
        ;   Label: core_vampboss.cpp_CVampireBoss_summonFireEmitters_FUN_005e7410
    PUSH ESI                            ; 005e7411
    PUSH EDI                            ; 005e7412
    ...
    JNZ 0x005e746b                      ; 005e7460
        ;   XREF to: 005e746b (CONDITIONAL_JUMP)  ; LAB_005e746b
    PUSH EAX                            ; 005e7462
    CALL core_emitter.cpp_CEmitter_launchFireballAtHero_FUN_004a7e80 ; 005e7463
        ;   XREF to: 004a7e80 (UNCONDITIONAL_CALL)  ; void core_emitter.cpp_CEmitter_launchFireballAtHero_FUN_004a7e80(CEmitter * this_ptr)
