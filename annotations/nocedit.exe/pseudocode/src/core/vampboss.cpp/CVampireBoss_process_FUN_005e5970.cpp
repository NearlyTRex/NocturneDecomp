...

{
  ...
  if (iVar10 == 2) {
    ...
    if ((this_ptr->base_enemy).base_character.hit_points < (float)25) {
      iVar10 = *(int *)(this_ptr->field5_0xce8f4 + 0x10);
    ...
    if ((*(int *)(this_ptr->field5_0xce8f4 + 0x10) != 2) &&
      ...
      if (SQRT(local_f4 * local_f4 + local_ec * local_ec) < (float)5) {
        ...
        if ((float10)0 != ABS((float10)(int)local_18)) {
          ...
          (*(((g_HeroActors[g_LocalHeroIndex]->base_character).base_actor.vtable._uc)->_uc).
            processDamage)(&g_HeroActors[g_LocalHeroIndex]->base_character,&local_244);
        }
      }
      ...
      if ((*(int *)(this_ptr->field5_0xce8f4 + 0x10) == 0) &&
         (fVar4 = *(float *)this_ptr->field5_0xce8f4 - delta_time,
         *(float *)this_ptr->field5_0xce8f4 = fVar4, fVar4 < 0.0)) {
        this_ptr->field5_0xce8f4[0x10] = '\x01';
        this_ptr->field5_0xce8f4[0x11] = '\0';
        this_ptr->field5_0xce8f4[0x12] = '\0';
        this_ptr->field5_0xce8f4[0x13] = '\0';
      ...
      if ((((pSVar11->state_index == 0) && (*(int *)(this_ptr->field5_0xce8f4 + 0x10) == 0)) &&
          (local_248 < (float)24)) && (*(int *)(this_ptr->field5_0xce8f4 + 8) == 0)) {
        ...
        core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                  ((CMotionController *)(this_ptr->field1_0xbeb4 + 8),iVar10,1);
      }
    }
    pCVar5 = g_HeroActors[g_LocalHeroIndex];
    pCVar16 = &(pCVar5->base_character).base_actor.location;
    if ((CLocation *)&local_b0 != pCVar16) {
      local_b0 = (pCVar16->position).x;
      fStack_ac = (pCVar5->base_character).base_actor.location.position.y;
      fStack_a8 = (pCVar5->base_character).base_actor.location.position.z;
    }
    if (*(int *)(this_ptr->field5_0xce8f4 + 0x10) == 2) {
      *(float *)(this_ptr->field5_0xce8f4 + 4) =
           *(float *)(this_ptr->field5_0xce8f4 + 4) - delta_time;
      iVar10 = *(int *)((int)this_ptr +
                       (4 - *(int *)(this_ptr->field5_0xce8f4 + 0x14)) * 4 + 0xce908);
      ...
      if ((*(float *)(this_ptr->field5_0xce8f4 + 4) <= 0.0) ||
         (fVar4 = local_b0 - (this_ptr->base_enemy).base_character.base_actor.location.position.x,
         fVar6 = fStack_a8 - (this_ptr->base_enemy).base_character.base_actor.location.position.z,
      ...
      iVar10 = *(int *)(this_ptr->field5_0xce8f4 +
      ...
      fVar4 = *(float *)(this_ptr->field5_0xce8f4 + 4) - delta_time;
      *(float *)(this_ptr->field5_0xce8f4 + 4) = fVar4;
      if ((fVar4 <= 0.0) ||
         (fVar4 = local_b0 - (this_ptr->base_enemy).base_character.base_actor.location.position.x,
         fVar6 = fStack_a8 - (this_ptr->base_enemy).base_character.base_actor.location.position.z,
    ...
    local_e0 = local_b0 - (this_ptr->base_enemy).base_character.base_actor.location.position.x;
    local_dc.x = fStack_ac - (this_ptr->base_enemy).base_character.base_actor.location.position.y;
    fVar18 = (float10)fStack_a8 -
    ...
    local_18 = (CLocation *)
               core_actor_cpp_normalizeAngleToPi_FUN_0040cd70
                         (local_40 - (this_ptr->base_enemy).base_character.base_actor.orient.bank);
    ...
    if (ABS(fVar4) <= ABS((float)local_18)) {
      (this_ptr->base_enemy).base_character.base_actor.orient.bank =
           (this_ptr->base_enemy).base_character.base_actor.orient.bank + fVar4;
    }
    else {
      (this_ptr->base_enemy).base_character.base_actor.orient.bank = local_40;
    }
    local_38 = (CLocation *)
               core_actor_cpp_normalizeAngleToPi_FUN_0040cd70
                         ((float)local_38 -
                          (this_ptr->base_enemy).base_character.base_actor.orient.pitch);
    fVar4 = (this_ptr->base_enemy).base_character.hit_points;
    local_58 = -0.3926991;
    local_24 = 0.3926991;
    (this_ptr->base_enemy).base_character.base_actor.orient.pitch =
         (float)local_38 * delta_time * local_68 +
         (this_ptr->base_enemy).base_character.base_actor.orient.pitch;
    if ((fVar4 < (float)25) && (*(int *)(this_ptr->field5_0xce8f4 + 0x10) == 0)) {
      local_24 = 1.5707964;
      local_58 = -1.5707964;
    }
    if ((this_ptr->base_enemy).base_character.base_actor.orient.pitch < local_58) {
      (this_ptr->base_enemy).base_character.base_actor.orient.pitch = local_58;
    }
    if (local_24 < (this_ptr->base_enemy).base_character.base_actor.orient.pitch) {
      (this_ptr->base_enemy).base_character.base_actor.orient.pitch = local_24;
    }
    ...
    if (fVar19 < (float10)local_b4) {
      (this_ptr->base_enemy).base_character.base_actor.location.position.y = local_b4;
    }
    local_18 = local_38;
    core_actor_cpp_CDemonActor_updateOrientationMatrix_FUN_00408c10((CDemonActor *)this_ptr);
    pCVar12 = core_skeleton_cpp_CDeformableModelInstance_computeBoundingBox_FUN_005a16c0
                        ((CDeformableModelInstance *)(this_ptr->field1_0xbeb4 + 8),&local_19c);
    pCVar2 = (CBoundingBox3D *)((this_ptr->base_enemy).base_character.field11_0x25a0 + 0x58);
    if (pCVar2 != pCVar12) {
      (pCVar2->min).x = (pCVar12->min).x;
      *(float *)((this_ptr->base_enemy).base_character.field11_0x25a0 + 0x5c) = (pCVar12->min).y;
      *(float *)((this_ptr->base_enemy).base_character.field11_0x25a0 + 0x60) = (pCVar12->min).z;
    }
    pcVar1 = (this_ptr->base_enemy).base_character.field11_0x25a0 + 100;
    if ((CVector3f *)pcVar1 != &pCVar12->max) {
      *(float *)pcVar1 = (pCVar12->max).x;
      *(float *)((this_ptr->base_enemy).base_character.field11_0x25a0 + 0x68) = (pCVar12->max).y;
      *(float *)((this_ptr->base_enemy).base_character.field11_0x25a0 + 0x6c) = (pCVar12->max).z;
    }
    goto LAB_005e5f5f;
  }
  if (iVar10 == 1) {
    ...
    core_skeleton_cpp_CDeformableModelInstance_computeBoundingBox_FUN_005a16c0
              ((CDeformableModelInstance *)(this_ptr->field1_0xbeb4 + 8),&local_184);
    pCVar2 = (CBoundingBox3D *)((this_ptr->base_enemy).base_character.field11_0x25a0 + 0x58);
    ...
    (this_ptr->base_enemy).base_character.base_actor.location.position.y =
         (this_ptr->base_enemy).base_character.base_actor.location.position.y + delta_time;
    goto LAB_005e5f5f;
  }
  if (iVar10 == 3) {
    ...
    if (0.0 < local_60 - local_64) {
      ...
      this_ptr->form = 0;
      core_event_cpp_CEventList_FUN_004aabe0(pCVar8);
      fVar4 = *(float *)((this_ptr->base_enemy).base_character.field2_0x240c + 8);
      this_ptr->morph_t = 0.0;
    }
    (this_ptr->base_enemy).base_character.base_actor.location.position.y = fVar4;
    core_vampboss_cpp_FUN_005e6ca0();
    core_skeleton_cpp_CDeformableModelInstance_updateAnimationAndTransforms_FUN_0059e000
              ((CDeformableModelInstance *)(this_ptr->field1_0xbeb4 + 8));
    core_cloth_cpp_FUN_0043ab80();
    ...
    core_skeleton_cpp_CDeformableModelInstance_computeBoundingBox_FUN_005a16c0
              ((CDeformableModelInstance *)(this_ptr->field1_0xbeb4 + 8),&local_1cc);
    pCVar2 = (CBoundingBox3D *)((this_ptr->base_enemy).base_character.field11_0x25a0 + 0x58);
...
LAB_005e648e:
      ...
      if (uVar13 == 0x29a) {
        ...
        iVar10 = 0;
        for (local_2c = 0; local_2c < *(int *)(g_CDemonSetPtr->field19_0x14f0a0 + 0x1f3c);
            local_2c = local_2c + 1) {
          this_ptr_00 = (CCharacter *)
                        core_actor_cpp_castToClassHash_FUN_0040c790
                                  (*(CDemonActor **)
                                    (g_CDemonSetPtr->field19_0x14f0a0 + iVar10 + 8000),
          ...
          if ((this_ptr_00 != (CCharacter *)0x0) &&
            ...
            (*(((this_ptr_00->base_actor).vtable._uc)->_uc).processDamage)(this_ptr_00,&SStack_208);
          }
          iVar10 = iVar10 + 4;
        }
      }
    ...
    *(float *)((this_ptr->base_enemy).base_character.field2_0x240c + 0x2c) =
    ...
    if (pCVar9->letterbox_mode == 0) {
      *(float *)((this_ptr->base_enemy).base_character.field2_0x240c + 0x28) =
      ...
      default:
        fVar4 = ((this_ptr->base_enemy).base_character.max_hit_points * delta_time) / 120.0f
                + (this_ptr->base_enemy).base_character.hit_points;
        (this_ptr->base_enemy).base_character.hit_points = fVar4;
        if ((float)50 < fVar4) goto LAB_005e6560;
        iVar15 = core_hero_cpp_FUN_004f2220();
        if (iVar15 == 0) {
          pCVar5 = g_HeroActors[g_LocalHeroIndex];
          local_d0.x = (pCVar5->base_character).base_actor.location.position.x -
                       (this_ptr->base_enemy).base_character.base_actor.location.position.x;
          local_d0.y = (pCVar5->base_character).base_actor.location.position.y -
                       (this_ptr->base_enemy).base_character.base_actor.location.position.y;
          local_d0.z = (pCVar5->base_character).base_actor.location.position.z -
                       (this_ptr->base_enemy).base_character.base_actor.location.position.z;
          ...
          local_18 = (CLocation *)
                     core_actor_cpp_normalizeAngleToPi_FUN_0040cd70
                               (local_114 -
                                (this_ptr->base_enemy).base_character.base_actor.orient.bank);
          *(CLocation **)((this_ptr->base_enemy).base_character.field2_0x240c + 0xc) = local_18;
          local_3c = *(float *)((this_ptr->base_enemy).base_character.field2_0x240c + 0xc);
          local_48 = *(float *)((this_ptr->base_enemy).base_character.field2_0x240c + 0x2c);
          ...
          fVar4 = *(float *)this_ptr->field5_0xce8f4 - delta_time;
          *(float *)((this_ptr->base_enemy).base_character.field2_0x240c + 0xc) = local_4c;
          *(float *)this_ptr->field5_0xce8f4 = fVar4;
      ...
      if (iVar15 == 0) {
        pCVar5 = g_HeroActors[g_LocalHeroIndex];
        local_13c.x = (pCVar5->base_character).base_actor.location.position.x -
                      (this_ptr->base_enemy).base_character.base_actor.location.position.x;
        local_13c.y = (pCVar5->base_character).base_actor.location.position.y -
                      (this_ptr->base_enemy).base_character.base_actor.location.position.y;
        local_13c.z = (pCVar5->base_character).base_actor.location.position.z -
                      (this_ptr->base_enemy).base_character.base_actor.location.position.z;
        pCVar14 = core_vehicle_cpp_convertDirectionVectorToEulerAngles_FUN_005e7830
                            (&local_130,&local_13c);
        local_120 = pCVar14->y;
        local_18 = (CLocation *)
                   core_actor_cpp_normalizeAngleToPi_FUN_0040cd70
                             (local_120 -
                              (this_ptr->base_enemy).base_character.base_actor.orient.bank);
        *(CLocation **)((this_ptr->base_enemy).base_character.field2_0x240c + 0xc) = local_18;
        local_34 = *(float *)((this_ptr->base_enemy).base_character.field2_0x240c + 0xc);
        local_50 = *(float *)((this_ptr->base_enemy).base_character.field2_0x240c + 0x2c);
        ...
        *(float *)((this_ptr->base_enemy).base_character.field2_0x240c + 0xc) = local_54;
...
LAB_005e6560:
  ...
  if ((g_CGamePtr->letterbox_mode == 0) && (iVar10 != 2)) {
    local_100 = *(float *)((this_ptr->base_enemy).base_character.field2_0x240c + 0x10) +
                (this_ptr->base_enemy).base_character.model.accumulated_root_motion.x;
    local_f8 = *(float *)((this_ptr->base_enemy).base_character.field2_0x240c + 0x18) +
               (this_ptr->base_enemy).base_character.model.accumulated_root_motion.z;
    local_fc = (*(float *)((this_ptr->base_enemy).base_character.field2_0x240c + 0x14) +
