...

{
  ...
  float *volume;
  CDeformableModelInstance *pCVar22;
  ...
  if (iVar7 == 2) {
    ...
    pCVar22 = (CDeformableModelInstance *)(this_ptr->field1_0xbeb4 + 8);
    core_skeleton_cpp_CDeformableModelInstance_updateAnimationAndTransforms_FUN_0059e000(pCVar22);
    ...
    if ((this_ptr->base_enemy).base_character.hit_points < (float)DOUBLE_00656b7b) {
      ...
      if ((iVar7 != 2) && (iVar7 != 3)) {
        pCVar22 = (CDeformableModelInstance *)0x5e5a2b;
    ...
    if ((*(int *)(this_ptr->field5_0xce8f4 + 0x10) != 2) &&
      ...
      if ((float)DOUBLE_00656b93 < (float)pCVar22) {
    ...
    pCVar3 = g_HeroActors[g_LocalHeroIndex];
    pCVar14 = &(pCVar3->base_character).base_actor.location;
    if ((CLocation *)&fStack_90 != pCVar14) {
      fStack_90 = (pCVar14->position).x;
    ...
    fVar16 = (float10)fStack_88 -
             (float10)(this_ptr->base_enemy).base_character.base_actor.location.position.z;
    CStack_c0.z = (float)fVar16;
    crt_math_c_atan2_FUN_006013b1((float10)CStack_c0.x,fVar16);
    ...
    (this_ptr_00->base_enemy).base_character.base_actor.orient.pitch =
         fVar9 * in_stack_00000008 * local_40 + (pCVar4->base_character).base_actor.orient.pitch;
    ...
    fVar16 = (float10)(this_ptr_00->base_enemy).base_character.base_actor.orient.pitch;
    fVar17 = (float10)fsin(fVar16);
    fVar18 = (float10)(this_ptr_00->base_enemy).base_character.base_actor.orient.bank;
    fVar19 = (float10)fsin(fVar18);
    fVar16 = (float10)fcos(fVar16);
    fVar18 = (float10)fcos(fVar18);
    fVar20 = (float10)local_1c;
    ...
    (this_ptr_00->base_enemy).base_character.base_actor.location.position.y = (float)fVar17;
    ...
    (this_ptr_00->base_enemy).base_character.base_actor.location.position.z =
         (float)(fVar18 * fVar16 * fVar20 * fVar21 + (float10)fVar8);
    if (fVar17 < (float10)fStack_8c) {
  ...
  if (iVar7 == 1) {
    ...
    core_cloth_cpp_FUN_0043ab80();
    pCVar22 = &(this_ptr->base_enemy).base_character.model;
    while (0.0 < in_stack_00000008) {
      core_motion_cpp_CMotionController_advance_FUN_0052d610(&pCVar22->motion_controller);
    }
    core_skeleton_cpp_CDeformableModelInstance_updateAnimationAndTransforms_FUN_0059e000(pCVar22);
    core_cloth_cpp_FUN_0043ab80();
    core_cloth_cpp_FUN_0043ab80();
    pCVar10 = core_skeleton_cpp_CDeformableModelInstance_FUN_005a16c0(pCVar22);
...
LAB_005e649b:
  ...
  pCVar22 = &(this_ptr->base_enemy).base_character.model;
  iVar7 = core_motion_cpp_CMotionController_FUN_0052dab0(&pCVar22->motion_controller);
  pCVar6 = g_CGamePtr;
        ...
        if (iVar13 == 0) {
          ...
          *(float *)this_ptr->field5_0xce8f4 = fVar8;
          if (fVar8 <= 0.0) {
            ...
            if (iVar13 == 0) {
              core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                        (&pCVar22->motion_controller,4,1);
            }
            else if (iVar13 == 1) {
              core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                        (&pCVar22->motion_controller,5,1);
            }
            else if (iVar13 == 2) {
              core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                        (&pCVar22->motion_controller,6,1);
            }
          }
        }
        else {
      ...
      if (iVar13 == 0) {
        ...
        *(float *)((this_ptr->base_enemy).base_character.field2_0x240c + 0xc) = fVar8;
        local_2c = *(CDeformableModelInstance **)
                    ((this_ptr->base_enemy).base_character.field2_0x240c + 0x2c);
        pCVar22 = (CDeformableModelInstance *)
        ...
        local_2c = local_34;
        if (((float)local_34 <= (float)pCVar22) &&
           (local_2c = pCVar22, (float)local_28 < (float)pCVar22)) {
          local_2c = local_28;
        }
        *(CDeformableModelInstance **)((this_ptr->base_enemy).base_character.field2_0x240c + 0xc) =
             local_2c;
