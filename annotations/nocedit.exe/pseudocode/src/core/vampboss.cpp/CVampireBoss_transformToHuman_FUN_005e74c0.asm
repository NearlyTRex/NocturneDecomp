...
section .text
    ...
    PUSH EBX                            ; 005e74c0
        ;   Label: core_vampboss.cpp_CVampireBoss_transformToHuman_FUN_005e74c0
    MOV EBX,dword ptr [ESP + 0x8]       ; 005e74c1
    PUSH 0x0                            ; 005e74c5
    PUSH 0x656cec                       ; 005e74c7 | = "float"
    LEA EAX,[EBX + 0x158]               ; 005e74cc
    PUSH EAX                            ; 005e74d2
    MOV dword ptr [EBX + 0xcdcc0],0x3   ; 005e74d3
    CALL core_motion.cpp_CMotionController_jumpToMotionByName_FUN_0052ddb0 ; 005e74dd
    ...
    PUSH 0x656cf2                       ; 005e74e5 | = "voicuhuman.wav"
