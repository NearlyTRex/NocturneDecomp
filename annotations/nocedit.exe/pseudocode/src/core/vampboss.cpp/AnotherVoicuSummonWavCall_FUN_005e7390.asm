...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_vampboss.cpp_AnotherVoicuSummonWavCall_FUN_005e7390()
;
;
; XREF[1]:
...
section .text
    ...
    PUSH 0x656cbf                       ; 005e7398 | = "voicusummon.wav" | s_voicusummon_wav_00656cbf = voicusummon.wav
    ...
    MOV EBX,dword ptr [0x006810c8]      ; 005e73ae | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
        ;   Label: LAB_005e73ae
    CMP ESI,dword ptr [EBX + 0x14d154]  ; 005e73b4 | g_CDemonSetInstance.actor_list_ptr
    JL 0x005e73c1                       ; 005e73ba | LAB_005e73c1
    ...
    PUSH EBP                            ; 005e73cf
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 005e73d0 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 005e73d5
    ADD ESP,0x8                         ; 005e73d7
    TEST EAX,EAX                        ; 005e73da
    JZ 0x005e7401                       ; 005e73dc | LAB_005e7401
        ;   XREF to: 005e7401 (CONDITIONAL_JUMP)
    CMP dword ptr [EAX + 0x2d4],0x2     ; 005e73de
    JNZ 0x005e7401                      ; 005e73e5 | LAB_005e7401
        ;   XREF to: 005e7401 (CONDITIONAL_JUMP)
    PUSH 0x3f000000                     ; 005e73e7
    CALL core_actor.cpp_randomChance_FUN_0040cd10 ; 005e73ec | int core_actor.cpp_randomChance_FUN_0040cd10(float probability_threshold)
        ;   XREF to: 0040cd10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005e73f1
    TEST EAX,EAX                        ; 005e73f4
    JNZ 0x005e7401                      ; 005e73f6 | LAB_005e7401
        ;   XREF to: 005e7401 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 005e73f8
    CALL core_drip.cpp_FUN_0048e6b0     ; 005e73f9 | undefined core_drip.cpp_FUN_0048e6b0()
        ;   XREF to: 0048e6b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005e73fe
    INC ESI                             ; 005e7401
        ;   Label: LAB_005e7401
    ADD EDI,0x4                         ; 005e7402
    JMP 0x005e73ae                      ; 005e7405 | LAB_005e73ae
