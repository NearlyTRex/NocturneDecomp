...

{
  ...
  if (*(int *)(in_stack_00000004[0x11].cloth_data + 0x11c4) == 0) {
    ...
    if (fVar5 < (float)DOUBLE_00656ca3) {
    ...
    if (iVar1 == 0) {
      ...
      *(undefined4 *)(in_stack_00000004[0x11].cloth_data + 0x1e04) = uVar2;
      return;
    }
  }
  return;
...
// 005e70c0: PUSH EBX
// 005e70c1: CALL sound_sndmain.cpp_isSfxPlaying_FUN_005a9660
...
// 005e7231: PUSH EBP
// 005e7232: CALL sound_sndmain.cpp_killSfx_FUN_005a9c40
