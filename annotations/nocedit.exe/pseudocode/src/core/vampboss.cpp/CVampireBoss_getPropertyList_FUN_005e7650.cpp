...

{
  ...
  core_actor_cpp_CActorPropertyList_addChoice_FUN_0040e350
            (property_list,"Waypoint 0",this_ptr->unk3 + 0x18,1,"CWayPoint",
             (CDemonActor_CActorPropertyValidatorFunc *)0x0);
  core_actor_cpp_CActorPropertyList_addChoice_FUN_0040e350
            (property_list,"Waypoint 1",this_ptr->unk3 + 0x1c,1,"CWayPoint",
             (CDemonActor_CActorPropertyValidatorFunc *)0x0);
  core_actor_cpp_CActorPropertyList_addChoice_FUN_0040e350
            (property_list,"Waypoint 2",this_ptr->unk3 + 0x20,1,"CWayPoint",
             (CDemonActor_CActorPropertyValidatorFunc *)0x0);
  core_actor_cpp_CActorPropertyList_addChoice_FUN_0040e350
            (property_list,"Waypoint 3",this_ptr->unk3 + 0x24,1,"CWayPoint",
             (CDemonActor_CActorPropertyValidatorFunc *)0x0);
  return;
}
