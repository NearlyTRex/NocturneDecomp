...
section .text
    ...
    PUSH EBX                            ; 005e6f55
    CALL core_enemy.cpp_CEnemy_serialize_FUN_004a9660 ; 005e6f56
    ...
    PUSH EAX                            ; 005e6f7d
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 005e6f7e
    ...
    PUSH EAX                            ; 005e6f91
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 005e6f92
        ;   XREF to: 0040b870 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeActor_FUN_0040b870(CDemonActor * actor_ptr, char * property_name)
    ADD ESP,0x8                         ; 005e6f97
    PUSH 0x656c3f                       ; 005e6f9a | = "wayPoint2"
    LEA EAX,[EBX + 0xce914]             ; 005e6f9f
    PUSH EAX                            ; 005e6fa5
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 005e6fa6
        ;   XREF to: 0040b870 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeActor_FUN_0040b870(CDemonActor * actor_ptr, char * property_name)
    ADD ESP,0x8                         ; 005e6fab
    PUSH 0x656c49                       ; 005e6fae | = "wayPoint3"
    LEA EAX,[EBX + 0xce918]             ; 005e6fb3
    PUSH EAX                            ; 005e6fb9
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 005e6fba
        ;   XREF to: 0040b870 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeActor_FUN_0040b870(CDemonActor * actor_ptr, char * property_name)
    ...
    PUSH EAX                            ; 005e6fd8
    CALL core_actor.cpp_serializeMotionState_FUN_0040b9f0 ; 005e6fd9
    ...
    PUSH EAX                            ; 005e6fec
    CALL core_actor.cpp_serializeMotionState_FUN_0040b9f0 ; 005e6fed
        ;   XREF to: 0040b9f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeMotionState_FUN_0040b9f0(CMotionController * motion_controller, char * property_name)
    ...
    PUSH EAX                            ; 005e7005
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 005e7006
    ...
    PUSH EBX                            ; 005e7019
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 005e701a
