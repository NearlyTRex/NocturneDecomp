...
// Convention: __cdecl
// Signature: CVampireBoss * __cdecl core_vampboss_cpp_factoryFunc_FUN_005e5550(void)
...

{
  ...
  pCVar1 = (CVampireBoss *)shape_memdbg_cpp_debugAlloc_FUN_0050f1b0(0xce920,"..\\core\\vampboss.cpp",0x60);
