...
section .text
    ...
    CALL engine_drender.cpp_CDemonRenderer_isShadowPass_FUN_0048cae0 ; 005e6e50
    ...
    PUSH ESI                            ; 005e6eb7
    CALL core_morph.cpp_CMorph_updateModelFromDeformable_FUN_0052b600 ; 005e6eb8
    ...
    PUSH 0x0                            ; 005e6ec5
    PUSH ESI                            ; 005e6ec7
    CALL core_morph.cpp_CMorph_updateModelFromKeyframed_FUN_0052b640 ; 005e6ec8
    ...
    PUSH 0x0                            ; 005e6ed5
    PUSH ESI                            ; 005e6ed7
    CALL core_morph.cpp_CMorph_updateModelFromKeyframed_FUN_0052b640 ; 005e6ed8
        ;   XREF to: 0052b640 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_CMorph_updateModelFromKeyframed_FUN_0052b640(CMorph * this_ptr, int model_index, CKeyFramedModel * model_ptr, int frame_index, ...)
    ...
    PUSH 0x0                            ; 005e6ee9
    PUSH ESI                            ; 005e6eeb
    CALL core_morph.cpp_CMorph_updateModelFromKeyframed_FUN_0052b640 ; 005e6eec
        ;   XREF to: 0052b640 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_CMorph_updateModelFromKeyframed_FUN_0052b640(CMorph * this_ptr, int model_index, CKeyFramedModel * model_ptr, int frame_index, ...)
    ...
    PUSH 0x0                            ; 005e6ef9
    PUSH ESI                            ; 005e6efb
    CALL core_morph.cpp_CMorph_updateModelFromKeyframed_FUN_0052b640 ; 005e6efc
        ;   XREF to: 0052b640 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_CMorph_updateModelFromKeyframed_FUN_0052b640(CMorph * this_ptr, int model_index, CKeyFramedModel * model_ptr, int frame_index, ...)
    ...
    PUSH 0x1                            ; 005e6f0b
    PUSH ESI                            ; 005e6f0d
    CALL core_morph.cpp_CMorph_updateModelFromDeformable_FUN_0052b600 ; 005e6f0e
        ;   XREF to: 0052b600 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_CMorph_updateModelFromDeformable_FUN_0052b600(CMorph * this_ptr, int model_index, CDeformableModelInstance * model_ptr, int part_index)
    ...
    PUSH 0x1                            ; 005e6f1b
    PUSH ESI                            ; 005e6f1d
    CALL core_morph.cpp_CMorph_updateModelFromKeyframed_FUN_0052b640 ; 005e6f1e
        ;   XREF to: 0052b640 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_CMorph_updateModelFromKeyframed_FUN_0052b640(CMorph * this_ptr, int model_index, CKeyFramedModel * model_ptr, int frame_index, ...)
    ...
    PUSH 0x1                            ; 005e6f2b
    PUSH ESI                            ; 005e6f2d
    CALL core_morph.cpp_CMorph_updateModelFromKeyframed_FUN_0052b640 ; 005e6f2e
        ;   XREF to: 0052b640 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_CMorph_updateModelFromKeyframed_FUN_0052b640(CMorph * this_ptr, int model_index, CKeyFramedModel * model_ptr, int frame_index, ...)
    ADD ESP,0x14                        ; 005e6f33
    PUSH dword ptr [EBX + 0xce8f0]      ; 005e6f36
    PUSH ESI                            ; 005e6f3c
    CALL core_morph.cpp_CMorph_render_FUN_0052bae0 ; 005e6f3d
