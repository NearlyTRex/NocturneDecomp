...
section .text
    ...
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 005e58d7 | float core_actor.cpp_normalizeAngleToPi_FUN_0040cd70(float angle_radians)
    ...
    MOV EAX,dword ptr [ESP]             ; 005e591d
        ;   Label: LAB_005e591d
    JMP 0x005e5911                      ; 005e5920 | LAB_005e5911
