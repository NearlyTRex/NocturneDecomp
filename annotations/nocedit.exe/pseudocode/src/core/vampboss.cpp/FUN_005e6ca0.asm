...
section .text
    ...
    FNSTSW AX                           ; 005e6cb3
    SAHF                                ; 005e6cb5
    JNC 0x005e6d74                      ; 005e6cb6 | LAB_005e6d74
    ...
    PUSH EAX                            ; 005e6cc5
    PUSH ESI                            ; 005e6cc6
    CALL core_motion.cpp_CMotionController_advance_FUN_0052d610 ; 005e6cc7 | int core_motion.cpp_CMotionController_advance_FUN_0052d610(CMotionController * this_ptr)
        ;   XREF to: 0052d610 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005e6ccc
    CMP EAX,0x66                        ; 005e6ccf
    JNC 0x005e6d81                      ; 005e6cd2 | LAB_005e6d81
        ;   XREF to: 005e6d81 (CONDITIONAL_JUMP)
    CMP EAX,0x65                        ; 005e6cd8
    JNZ 0x005e6d66                      ; 005e6cdb | LAB_005e6d66
    ...
    JNZ 0x005e6cfc                      ; 005e6cf0 | LAB_005e6cfc
    ...
    FNSTSW AX                           ; 005e6d2e
    SAHF                                ; 005e6d30
    JNC 0x005e6d66                      ; 005e6d31 | LAB_005e6d66
        ;   XREF to: 005e6d66 (CONDITIONAL_JUMP)
    FLD double ptr [ESP]                ; 005e6d33
    FMUL double ptr [0x00656bf3]        ; 005e6d36 | double DOUBLE_00656bf3
    SUB ESP,0x8                         ; 005e6d3c
    FSTP double ptr [ESP]               ; 005e6d3f
    PUSH 0x656bcb                       ; 005e6d42 | = "wing?.wav @%f" | s_wing_wav_f_00656bcb = wing?.wav @%f
    LEA EAX,[ESP + 0x18]                ; 005e6d47
    PUSH EAX                            ; 005e6d4b
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005e6d4c | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    FNSTSW AX                           ; 005e6d6b
    SAHF                                ; 005e6d6d
    JC 0x005e6cc2                       ; 005e6d6e | LAB_005e6cc2
    ...
    POP EBX                             ; 005e6d78
    RET                                 ; 005e6d79
    PUSH 0x656bd9                       ; 005e6d7a | = "wing?.wav @1.5 *1.2" | s_wing_wav_1_5_1_2_00656bd9 = wing?.wav @1.5 *1.2
        ;   Label: LAB_005e6d7a
    JMP 0x005e6d59                      ; 005e6d7f | LAB_005e6d59
        ;   XREF to: 005e6d59 (UNCONDITIONAL_JUMP)
    JBE 0x005e6d7a                      ; 005e6d81 | LAB_005e6d7a
        ;   Label: LAB_005e6d81
        ;   XREF to: 005e6d7a (CONDITIONAL_JUMP)
    CMP EAX,0x67                        ; 005e6d83
    JZ 0x005e6d7a                       ; 005e6d86 | LAB_005e6d7a
        ;   XREF to: 005e6d7a (CONDITIONAL_JUMP)
    FLDZ                                ; 005e6d88
    FCOMP float ptr [EBP + 0x14]        ; 005e6d8a
    FNSTSW AX                           ; 005e6d8d
    SAHF                                ; 005e6d8f
    JC 0x005e6cc2                       ; 005e6d90 | LAB_005e6cc2
        ;   XREF to: 005e6cc2 (CONDITIONAL_JUMP)
