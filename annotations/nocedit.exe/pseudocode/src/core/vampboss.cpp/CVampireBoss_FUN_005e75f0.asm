...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_vampboss_cpp_CVampireBoss_FUN_005e75f0(CVampireBoss *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005e763f
        ;   Label: LAB_005e763f
    PUSH ESI                            ; 005e7640
    CALL core_charactr.cpp_CCharacter_hasCollision_FUN_0042bc20 ; 005e7641
