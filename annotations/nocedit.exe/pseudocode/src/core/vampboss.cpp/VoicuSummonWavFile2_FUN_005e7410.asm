...
section .text
    ...
    PUSH 0x656ccf                       ; 005e7417 | = "voicusummon.wav" | s_voicusummon_wav_00656ccf = voicusummon.wav
    ...
    MOV EAX,[0x006810c8]                ; 005e742d | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
        ;   Label: LAB_005e742d
    CMP ESI,dword ptr [EAX + 0x14d154]  ; 005e7432 | g_CDemonSetInstance.actor_list_ptr
    JL 0x005e743e                       ; 005e7438 | LAB_005e743e
    ...
    PUSH EDI                            ; 005e744c
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 005e744d | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005e7452
    TEST EAX,EAX                        ; 005e7455
    JZ 0x005e746b                       ; 005e7457 | LAB_005e746b
        ;   XREF to: 005e746b (CONDITIONAL_JUMP)
    CMP dword ptr [EAX + 0x158],0x2     ; 005e7459
    JNZ 0x005e746b                      ; 005e7460 | LAB_005e746b
        ;   XREF to: 005e746b (CONDITIONAL_JUMP)
    PUSH EAX                            ; 005e7462
    CALL core_emitter.cpp_FUN_004a7e80  ; 005e7463 | undefined core_emitter.cpp_FUN_004a7e80()
        ;   XREF to: 004a7e80 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005e7468
    INC ESI                             ; 005e746b
        ;   Label: LAB_005e746b
    ADD EBX,0x4                         ; 005e746c
    JMP 0x005e742d                      ; 005e746f | LAB_005e742d
