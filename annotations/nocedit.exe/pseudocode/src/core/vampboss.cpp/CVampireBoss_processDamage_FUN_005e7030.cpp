...

{
  ...
  if (this_ptr->form == 0) {
    if ((damage_info->ammo_type == AMMO_TYPE_HOLY) &&
       ...
       this_ptr_00 != (CMelee *)0x0)) {
      core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                (&(this_ptr->base).base.model.motion_controller,10,1);
      pCVar4 = (*((this_ptr_00->base).base.vtable._ub)->getCarrier)((CDemonActor *)this_ptr_00);
      if (pCVar4 != (CDemonActor *)0x0) {
        (*((pCVar4->vtable)._ub)->drop)(pCVar4,(CDemonActor *)this_ptr_00,(CVector3f *)0x0);
        pCVar1 = (CHero *)core_actor_cpp_castToClassHash_FUN_0040c790
                                    (pCVar4,g_CHeroClassInfo.name_hash);
        if (pCVar1 != (CHero *)0x0) {
          pCVar5 = core_inv_cpp_CInventory_findItemByName_FUN_004fe9d0
                             (&pCVar1->inventory,(char *)this_ptr_00);
          if ((CMelee *)pCVar5 == this_ptr_00) {
            core_inv_cpp_CInventory_removeItem_FUN_004fea70
                      (&pCVar1->inventory,(CDemonActor *)this_ptr_00,0);
            core_mission_cpp_CDemonMission_addActorToList_FUN_00523b70
                      (g_CDemonMissionPtr,(CDemonActor *)this_ptr_00);
          }
        }
      }
      core_charactr_cpp_CCharacter_pickupObjectNow_FUN_0042cdb0
                ((CCharacter *)this_ptr,0,(CDemonActor *)this_ptr_00,0.2);
    ...
    core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
              (&(this_ptr->model).motion_controller,iVar1,1);
