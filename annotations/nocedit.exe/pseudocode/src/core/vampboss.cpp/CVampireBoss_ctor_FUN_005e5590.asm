...
;                               FUNCTION
; *****************************************************************************
; __cdecl CVampireBoss * core_vampboss.cpp_CVampireBoss_ctor_FUN_005e5590(CVampireBoss * this_ptr)
;
; Parameters:
; CVampireBoss *   Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_vampboss.cpp_FUN_005e5550 at 005e556a
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 005e5595
    CALL core_enemy.cpp_CEnemy_ctor_FUN_004a9500 ; 005e5596 | CEnemy * core_enemy.cpp_CEnemy_ctor_FUN_004a9500(CEnemy * this_ptr)
        ;   XREF to: 004a9500 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005e559b
    ADD EAX,0xbebc                      ; 005e559e
    PUSH EAX                            ; 005e55a3
    CALL core_skeleton.cpp_CDeformableModelInstance_ctor_FUN_0059ddc0 ; 005e55a4 | CDeformableModelInstance * core_skeleton.cpp_CDeformableModelInstance_ctor_FUN_0059ddc0(CDeformableModelInstance * this_ptr)
        ;   XREF to: 0059ddc0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005e55a9
    ADD EAX,0x22b4                      ; 005e55ac
    PUSH EAX                            ; 005e55b1
    CALL core_cloth.cpp_FUN_00438ba0    ; 005e55b2 | undefined core_cloth.cpp_FUN_00438ba0()
        ;   XREF to: 00438ba0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005e55b7
    ADD EAX,0x3fe70                     ; 005e55ba
    PUSH EAX                            ; 005e55bf
    CALL core_cloth.cpp_FUN_00438ba0    ; 005e55c0 | undefined core_cloth.cpp_FUN_00438ba0()
        ;   XREF to: 00438ba0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005e55c5
    ADD EAX,0x3fe70                     ; 005e55c8
    PUSH EAX                            ; 005e55cd
    CALL core_cloth.cpp_FUN_00438ba0    ; 005e55ce | undefined core_cloth.cpp_FUN_00438ba0()
        ;   XREF to: 00438ba0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005e55d3
    ADD EAX,0x3fe74                     ; 005e55d6
    PUSH EAX                            ; 005e55db
    CALL core_morph.cpp_FUN_0052b310    ; 005e55dc | undefined core_morph.cpp_FUN_0052b310()
        ;   XREF to: 0052b310 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005e55e1
    LEA EBX,[EAX + 0xfff3233c]          ; 005e55e4
    PUSH 0x656ac5                       ; 005e55ea | = "nosfer.dfm" | s_nosfer_dfm_00656ac5 = nosfer.dfm
    LEA EAX,[EBX + 0x158]               ; 005e55ef
    PUSH EAX                            ; 005e55f5
    MOV dword ptr [EBX + 0x154],0x664e94 ; 005e55f6 | CDemonActor_vtable g_CVampireBossVTable
    CALL core_skeleton.cpp_CDeformableModelInstance_init_FUN_005a0840 ; 005e5600 | void core_skeleton.cpp_CDeformableModelInstance_init_FUN_005a0840(CDeformableModelInstance * this_ptr, char * model_name)
        ;   XREF to: 005a0840 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005e5605
    PUSH 0x656ad0                       ; 005e5608 | = "batboss.dfm" | s_batboss_dfm_00656ad0 = batboss.dfm
    LEA EAX,[EBX + 0xbebc]              ; 005e560d
    PUSH EAX                            ; 005e5613
    CALL core_skeleton.cpp_CDeformableModelInstance_init_FUN_005a0840 ; 005e5614 | void core_skeleton.cpp_CDeformableModelInstance_init_FUN_005a0840(CDeformableModelInstance * this_ptr, char * model_name)
        ;   XREF to: 005a0840 (UNCONDITIONAL_CALL)
