...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_armour_cpp_CArmour_setup_FUN_00412240(CArmour *this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x4]       ; 00412240
        ;   Label: core_armour.cpp_CArmour_setup_FUN_00412240
    PUSH EDX                            ; 00412244
    CALL core_enemy.cpp_CEnemy_setup_FUN_004a9650 ; 00412245
