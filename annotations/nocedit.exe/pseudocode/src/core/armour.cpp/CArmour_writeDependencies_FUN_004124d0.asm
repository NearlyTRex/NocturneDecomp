...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_armour_cpp_CArmour_writeDependencies_FUN_004124d0(CArmour *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004124d0
        ;   Label: core_armour.cpp_CArmour_writeDependencies_FUN_004124d0
    MOV EDX,dword ptr [ESP + 0xc]       ; 004124d1
    PUSH EDX                            ; 004124d5
    MOV ECX,dword ptr [ESP + 0xc]       ; 004124d6
    PUSH ECX                            ; 004124da
    CALL core_actor.cpp_CDemonActor_writeDependencies_FUN_0040cfd0 ; 004124db
    ...
    PUSH EAX                            ; 004124f1
    CALL core_skeledit.cpp_CDeformableModelInstance_writeDependencies_FUN_0058a260 ; 004124f2
