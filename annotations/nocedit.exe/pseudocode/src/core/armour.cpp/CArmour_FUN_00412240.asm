...
section .text
    ...
    PUSH EDX                            ; 00412244
    CALL core_enemy.cpp_CEnemy_FUN_004a9650 ; 00412245 | void core_enemy.cpp_CEnemy_FUN_004a9650(CEnemy * this_ptr)
        ;   XREF to: 004a9650 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0041224a
    MOV EAX,dword ptr [ESP + 0x4]       ; 0041224d
    ADD EAX,0x158                       ; 00412251
    PUSH EAX                            ; 00412256
    CALL core_skeleton.cpp_CDeformableModelInstance_preCache_FUN_005a0450 ; 00412257 | void core_skeleton.cpp_CDeformableModelInstance_preCache_FUN_005a0450(CDeformableModelInstance * this_ptr)
