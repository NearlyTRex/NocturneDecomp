...
section .text
    ...
    PUSH EBX                            ; 004125d8
    CALL core_armour.cpp_CFlame_arrdtor50_FUN_00412720 ; 004125d9
    ...
    PUSH EAX                            ; 004125e8
    CALL core_armour.cpp_SFire_arrdtor50_FUN_00412700 ; 004125e9
    ...
    PUSH EAX                            ; 004125f8
    CALL core_armour.cpp_CVector3f_arrdtor15_FUN_004126e0 ; 004125f9
    ...
    PUSH EAX                            ; 00412608
    CALL core_armour.cpp_CVector3f_arrdtor15_FUN_004126e0 ; 00412609
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; CVector3f * core_armour.cpp_CVector3f_arrdtor15_FUN_004126e0(CVector3f * this_ptr, uint flags)
