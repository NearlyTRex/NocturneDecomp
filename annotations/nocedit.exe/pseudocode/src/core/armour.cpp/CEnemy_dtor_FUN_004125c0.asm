...
;                               FUNCTION
; *****************************************************************************
; __cdecl CEnemy * __cdecl core_armour_cpp_CEnemy_dtor_FUN_004125c0 (CEnemy *this_ptr,uint d1,uint d2,uint d3,uint d4,uint d5,uint d6,uint d7,uint d8)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004125d8
    CALL core_armour.cpp_freeFlames_FUN_00412720 ; 004125d9
    ...
    PUSH EAX                            ; 004125e8
    CALL core_armour.cpp_freeFires_FUN_00412700 ; 004125e9
    ...
    PUSH EAX                            ; 004125f8
    CALL core_armour.cpp_freeVectors_FUN_004126e0 ; 004125f9
    ...
    PUSH EAX                            ; 00412608
    CALL core_armour.cpp_freeVectors_FUN_004126e0 ; 00412609
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; int core_armour.cpp_freeVectors_FUN_004126e0(CVector3f * * objs)
