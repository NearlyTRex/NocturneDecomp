...
;                               FUNCTION
; *****************************************************************************
; __cdecl CArmour * __cdecl core_armour_cpp_CArmour_dtor_FUN_00412500 (CArmour *this_ptr,uint d1,uint d2,uint d3,uint d4,uint d5,uint d6,uint d7,uint d8)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00412518
    CALL core_backgnd.cpp_freeFlames_FUN_00412720 ; 00412519
    ...
    PUSH EAX                            ; 00412528
    CALL core_backgnd.cpp_freeFires_FUN_00412700 ; 00412529
    ...
    PUSH EAX                            ; 00412538
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 00412539
    ...
    PUSH EAX                            ; 00412548
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 00412549
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; int core_backgnd.cpp_cleanupVector_FUN_004126e0(CVector3f * * objs)
    ADD ESP,0x8                         ; 0041254e
    PUSH 0x0                            ; 00412551
    SUB EAX,0x1c8                       ; 00412553
    PUSH EAX                            ; 00412558
    CALL core_cloth.cpp_FUN_0043bf80    ; 00412559
    ...
    PUSH 0x659ea0                       ; 00412591 | g_CArmourTypeInfo
        ;   Label: LAB_00412591
    PUSH EBX                            ; 00412596
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 00412597
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 0041259c
    PUSH EAX                            ; 0041259f
    CALL crt_memory.c_free_FUN_005fe659 ; 004125a0
    ...
    PUSH EAX                            ; 004125ac
        ;   Label: LAB_004125ac
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 004125ad
