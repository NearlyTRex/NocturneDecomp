...
section .text
    ...
    PUSH EBX                            ; 00412518
    CALL core_armour.cpp_CFlame_arrdtor50_FUN_00412720 ; 00412519
    ...
    PUSH EAX                            ; 00412528
    CALL core_armour.cpp_SFire_arrdtor50_FUN_00412700 ; 00412529
    ...
    PUSH EAX                            ; 00412538
    CALL core_armour.cpp_CVector3f_arrdtor15_FUN_004126e0 ; 00412539
    ...
    PUSH EAX                            ; 00412548
    CALL core_armour.cpp_CVector3f_arrdtor15_FUN_004126e0 ; 00412549
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; CVector3f * core_armour.cpp_CVector3f_arrdtor15_FUN_004126e0(CVector3f * this_ptr, uint flags)
