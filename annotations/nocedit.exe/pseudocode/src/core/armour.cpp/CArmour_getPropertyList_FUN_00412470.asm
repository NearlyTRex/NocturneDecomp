...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_armour_cpp_CArmour_getPropertyList_FUN_00412470 (CArmour *this_ptr,CActorPropertyList *property_list)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00412470
        ;   Label: core_armour.cpp_CArmour_getPropertyList_FUN_00412470
    PUSH ESI                            ; 00412471
    PUSH EDI                            ; 00412472
    ...
    PUSH ESI                            ; 0041247b
    PUSH EDI                            ; 0041247c
    CALL core_enemy.cpp_CEnemy_getPropertyList_FUN_004aa170 ; 0041247d
    ...
    PUSH ESI                            ; 00412493
    CALL core_actor.cpp_CActorPropertyList_addModelDFM_FUN_0040e4a0 ; 00412494
    ...
    PUSH ESI                            ; 004124a2
    CALL core_actor.cpp_CActorPropertyList_addMotion_FUN_0040e4d0 ; 004124a3
    ...
    PUSH ESI                            ; 004124b7
    CALL core_actor.cpp_CActorPropertyList_addEvent_FUN_0040e460 ; 004124b8
