...
// Convention: __cdecl
// Signature: CArmour * __cdecl core_armour_cpp_CArmour_dtor_FUN_00412500(CArmour *this_ptr,uint flags)
...
{
  CArmour_ptr_13260 pCVar1;
  CArmour_ptr_12060 pSVar1;
  CArmour_ptr_11536 pCVar2;
  CArmour_ptr_11356 pCVar3;
  CArmour_ptr_10900 pCVar4;
  CArmour_ptr_344 pCVar5;
  CArmour *ptr;
  void *ptr_00;
  
  if ((flags & 4) != 0) {
    ptr_00 = __vec_delete(this_ptr,&g_CArmourTypeInfo);
    shape_memdbg_cpp_free_FUN_005fe659(ptr_00);
    return this_ptr;
  }
  pCVar1 = (CArmour_ptr_13260)
           core_armour_cpp_CFlame_arrdtor50_FUN_00412720((this_ptr->base).base.flames,0);
  pSVar1 = (CArmour_ptr_12060)
           core_armour_cpp_SFire_arrdtor50_FUN_00412700(ADJ(pCVar1)->base.base.fires,0);
  pCVar2 = (CArmour_ptr_11536)
           core_armour_cpp_CVector3f_arrdtor15_FUN_004126e0
                     (ADJ(pSVar1)->base.base.collision_test_normals,0);
  pCVar3 = (CArmour_ptr_11356)
           core_armour_cpp_CVector3f_arrdtor15_FUN_004126e0
  ...
  ptr = (CArmour *)core_actor_cpp_CDemonActor_dtor_FUN_00408a30((CDemonActor *)ADJ(pCVar5),1);
  if ((flags & 2) == 0) {
    return ptr;
  }
