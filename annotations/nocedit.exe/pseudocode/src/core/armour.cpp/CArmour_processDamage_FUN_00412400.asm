...
section .text
    ...
    PUSH EBX                            ; 00412400
        ;   Label: core_armour.cpp_CArmour_processDamage_FUN_00412400
    MOV EBX,dword ptr [ESP + 0x8]       ; 00412401
    PUSH 0x1                            ; 00412405
    PUSH 0xbf800000                     ; 00412407
    PUSH 0x0                            ; 0041240c
    PUSH EBX                            ; 0041240e
    CALL core_charactr.cpp_CCharacter_dismember_FUN_0042b9e0 ; 0041240f
    ...
    PUSH EDX                            ; 0041242d
    PUSH EBX                            ; 0041242e
    CALL core_enemy.cpp_CEnemy_processDamage_FUN_004a9f10 ; 0041242f
