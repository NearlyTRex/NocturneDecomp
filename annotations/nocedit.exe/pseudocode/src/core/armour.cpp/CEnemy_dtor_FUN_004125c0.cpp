...

{
  ...
  pCVar1 = (CEnemy_ptr_13260)
           core_armour_cpp_CFlame_arrdtor50_FUN_00412720((this_ptr->base).flames,0);
  pSVar1 = (CEnemy_ptr_12060)core_armour_cpp_SFire_arrdtor50_FUN_00412700(ADJ(pCVar1)->base.fires,0);
  pCVar2 = (CEnemy_ptr_11536)
           core_armour_cpp_CVector3f_arrdtor15_FUN_004126e0
                     (ADJ(pSVar1)->base.collision_test_normals,0);
  pCVar3 = (CEnemy_ptr_11356)
           core_armour_cpp_CVector3f_arrdtor15_FUN_004126e0
                     (ADJ(pCVar2)->base.collision_test_points,0);
