...
// Convention: __cdecl
// Signature: CEnemy * __cdecl core_armour_cpp_CEnemy_dtor_FUN_004125c0 (CEnemy *this_ptr,uint d1,uint d2,uint d3,uint d4,uint d5,uint d6,uint d7,uint d8)

#include "nocturne.h"

CEnemy * __cdecl
core_armour_cpp_CEnemy_dtor_FUN_004125c0
...

{
  ...
  iVar1 = core_armour_cpp_freeFlames_FUN_00412720((CFlame **)((this_ptr->base).cloth_data + 0x934));
