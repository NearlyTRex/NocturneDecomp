...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_armour.cpp_CArmour_FUN_00412450(CArmour * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH ECX                            ; 00412459
    CALL core_charactr.cpp_CCharacter_FUN_0042bc20 ; 0041245a | int core_charactr.cpp_CCharacter_FUN_0042bc20(CCharacter * this_ptr)
