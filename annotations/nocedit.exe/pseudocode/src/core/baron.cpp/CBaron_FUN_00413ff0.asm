...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_baron.cpp_CBaron_FUN_00413ff0(CBaron * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH ECX                            ; 00413ff9
    CALL core_charactr.cpp_CCharacter_FUN_0042f8a0 ; 00413ffa | void core_charactr.cpp_CCharacter_FUN_0042f8a0(CCharacter * this_ptr)
