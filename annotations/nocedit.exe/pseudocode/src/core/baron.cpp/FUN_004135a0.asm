...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_baron.cpp_FUN_004135a0()
;
;
; XREF[2]:
;   core_baron.cpp_CBaronWeapon_setWeaponState_FUN_00413e90 at 00413f11
;   core_baron.cpp_FUN_004135e0 at 00413694
;
; Called Functions:
...
section .text
    ...
    JNZ 0x004135b7                      ; 004135b1 | LAB_004135b7
        ;   XREF to: 004135b7 (CONDITIONAL_JUMP)
    TEST EDX,EDX                        ; 004135b3
    JNZ 0x004135b9                      ; 004135b5 | LAB_004135b9
    ...
    PUSH EAX                            ; 004135c3
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 004135c4 | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
