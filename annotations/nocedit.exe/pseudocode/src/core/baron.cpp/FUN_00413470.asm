...
section .text
    ...
    PUSH EDI                            ; 0041349f
    PUSH ESI                            ; 004134a0
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 004134a1 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004134a6
    TEST EAX,EAX                        ; 004134a9
    JNZ 0x0041357f                      ; 004134ab | LAB_0041357f
    ...
    PUSH ECX                            ; 004134da
    CALL core_actor.cpp_CDemonActor_transformVector_FUN_00408e80 ; 004134db | CVector3f * core_actor.cpp_CDemonActor_transformVector_FUN_00408e80(CDemonActor * this_ptr, CVector3f * output, CVector3f * input)
    ...
    JZ 0x0041353d                       ; 0041352b | LAB_0041353d
    ...
    PUSH EAX                            ; 00413547
    CALL crt_memory.c_memset_FUN_005fde40 ; 00413548 | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
    ...
    PUSH EAX                            ; 0041355a
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 0041355b | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
    ...
    JG 0x00413491                       ; 00413591 | LAB_00413491
        ;   XREF to: 00413491 (CONDITIONAL_JUMP)
    JMP 0x004134b1                      ; 00413597 | LAB_004134b1
