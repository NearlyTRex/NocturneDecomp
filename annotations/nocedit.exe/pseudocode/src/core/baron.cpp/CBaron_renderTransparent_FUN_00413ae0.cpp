...
LAB_00413b43:
    in_stack_ffffffc4 = in_stack_ffffffc4 * (float)65000;
  }
  else {
    if (uVar2 < 7) goto LAB_00413b43;
    if (uVar2 != 7) goto LAB_00413b59;
    in_stack_ffffffc4 = ((float)pSVar3->frame_count - fStack_14) * (float)65000;
  }
  dVar5 = crt_math_c_round_FUN_005fe6b0((double)(in_stack_ffffffc4 / (float)pSVar3->frame_count));
  fStack_14 = (float)(int)ROUND(dVar5);
LAB_00413b59:
  if (*(int *)(this_ptr->field1_0x1fbd4 + 0xfc) != 0) {
    engine_3d_c_setRenderAlpha_FUN_00406d80(((int)fStack_14 * 2) / 3);
