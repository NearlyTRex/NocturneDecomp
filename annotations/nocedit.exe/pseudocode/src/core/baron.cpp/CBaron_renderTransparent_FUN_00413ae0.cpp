...
LAB_00413b43:
    fVar5 = ((float10)in_stack_ffffffc4 * (float10)DOUBLE_00615091) / (float10)pSVar3->frame_count;
  }
  else {
    if (uVar2 < 7) goto LAB_00413b43;
    if (uVar2 != 7) goto LAB_00413b59;
    fVar5 = (float10)pSVar3->frame_count;
    fVar5 = ((fVar5 - (float10)in_stack_ffffffec) * (float10)DOUBLE_00615091) / fVar5;
  }
  crt_math_c_round_FUN_005fe6b0((double)CONCAT44(extraout_EDX,pSVar3));
...
//   Label: LAB_00413b05
// 00413b0b: PUSH EDI
// 00413b0c: CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0
...
// 00413b23: CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0
//   XREF to: 0052dab0 (UNCONDITIONAL_CALL)
...
// 00413c6c: PUSH EBX
// 00413c6d: PUSH ESI
// 00413c6e: CALL core_motion.cpp_CMotionController_render_FUN_0052e700
