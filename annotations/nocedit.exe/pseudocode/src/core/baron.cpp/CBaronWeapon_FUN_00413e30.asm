...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_baron.cpp_CBaronWeapon_FUN_00413e30(CBaronWeapon * this_ptr)
;
; Parameters:
...
section .text
    ...
    LEA EAX,[EDX + 0x158]               ; 00413e6c
        ;   Label: LAB_00413e6c
    PUSH EAX                            ; 00413e72
    CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0 ; 00413e73 | SMotion * core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0(CMotionController * this_ptr)
        ;   XREF to: 0052dab0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EAX + 0x24]      ; 00413e78
    ADD ESP,0x4                         ; 00413e7b
    CMP EAX,0x3                         ; 00413e7e
    JA 0x00413e61                       ; 00413e81 | default
        ;   XREF to: 00413e61 (CONDITIONAL_JUMP)
    JMP dword ptr [EAX*0x4 + 0x413e20]  ; 00413e83 | void * switchdataD_00413e20
        ;   Label: switchD
