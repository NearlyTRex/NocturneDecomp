...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_baron.cpp_CBaronWeapon_setWeaponState_FUN_00413e90(CBaronWeapon * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 00413e9b
    PUSH EBX                            ; 00413e9c
    CALL core_weapon.cpp_CWeapon_FUN_005ee640 ; 00413e9d | void core_weapon.cpp_CWeapon_FUN_005ee640(CWeapon * this_ptr)
    ...
    JNZ 0x00413f05                      ; 00413ec0 | LAB_00413f05
        ;   XREF to: 00413f05 (CONDITIONAL_JUMP)
    TEST EAX,EAX                        ; 00413ec2
    JNZ 0x00413ee8                      ; 00413ec4 | LAB_00413ee8
        ;   XREF to: 00413ee8 (CONDITIONAL_JUMP)
    MOV EBP,0x6150b5                    ; 00413ec6 | = "..\\core\\baron.cpp" | s_core_baron_cpp_006150b5 = ..\core\baron.cpp
    MOV EAX,0x31c                       ; 00413ecb
    PUSH 0x6150c7                       ; 00413ed0 | = "CBaronWeapon::setWeaponState - I'm dr..." | s_CBaronWeapon_setWeaponSt_006150c7 = CBaronWeapon::setWeaponState - I'm drawn, but nobody's carrying me??
    MOV dword ptr [0x02f0ca48],EBP      ; 00413ed5 | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 00413edb | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00413ee0 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00413ee5
    PUSH EBX                            ; 00413ee8
        ;   Label: LAB_00413ee8
    CALL core_baron.cpp_FUN_00413f20    ; 00413ee9 | undefined core_baron.cpp_FUN_00413f20()
        ;   XREF to: 00413f20 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00413eee
    PUSH ESI                            ; 00413ef1
    MOV EDX,dword ptr [EBX + 0x578]     ; 00413ef2
    PUSH EDX                            ; 00413ef8
    CALL core_baron.cpp_FUN_00413470    ; 00413ef9 | undefined core_baron.cpp_FUN_00413470()
    ...
    JZ 0x00413f01                       ; 00413f0d | LAB_00413f01
        ;   XREF to: 00413f01 (CONDITIONAL_JUMP)
    PUSH EAX                            ; 00413f0f
    PUSH ESI                            ; 00413f10
    CALL core_baron.cpp_FUN_004135a0    ; 00413f11 | undefined core_baron.cpp_FUN_004135a0()
