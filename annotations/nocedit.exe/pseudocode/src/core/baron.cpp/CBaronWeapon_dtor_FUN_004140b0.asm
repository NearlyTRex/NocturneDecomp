...
;                               FUNCTION
; *****************************************************************************
; __cdecl CBaronWeapon * __cdecl core_baron_cpp_CBaronWeapon_dtor_FUN_004140b0(CBaronWeapon *this_ptr,uint d1,uint d2)
;
; Parameters:
...
section .text
    ...
    JNZ 0x004140d6                      ; 004140ba
        ;   XREF to: 004140d6 (CONDITIONAL_JUMP)  ; LAB_004140d6
    PUSH 0x1                            ; 004140bc
    PUSH EBX                            ; 004140be
    CALL core_weapon.cpp_CWeapon_dtor_FUN_005edf80 ; 004140bf
    ...
    JNZ 0x004140f1                      ; 004140d0
        ;   XREF to: 004140f1 (CONDITIONAL_JUMP)  ; LAB_004140f1
    MOV EAX,EBX                         ; 004140d2
    POP EBX                             ; 004140d4
    RET                                 ; 004140d5
    PUSH 0x65a2f0                       ; 004140d6 | g_CBaronWeaponTypeInfo
        ;   Label: LAB_004140d6
    PUSH EBX                            ; 004140db
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 004140dc
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 004140e1
    PUSH EAX                            ; 004140e4
    CALL crt_memory.c_free_FUN_005fe659 ; 004140e5
    ...
    PUSH EAX                            ; 004140f1
        ;   Label: LAB_004140f1
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 004140f2
