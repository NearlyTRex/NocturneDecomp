...
;                               FUNCTION
; *****************************************************************************
; __cdecl CBaron * core_baron.cpp_CBaron_ctor_FUN_00412bc0(CBaron * this_ptr)
;
; Parameters:
; CBaron *         Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_baron.cpp_FUN_00412b80 at 00412b9a
;
; Referenced Globals:
...
section .text
    ...
    PUSH EDX                            ; 00412bc7
    CALL core_hero.cpp_FUN_004f2340     ; 00412bc8 | undefined core_hero.cpp_FUN_004f2340()
        ;   XREF to: 004f2340 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00412bcd
    PUSH 0x614ed7                       ; 00412bd0 | = "baron.dfm" | s_baron_dfm_00614ed7 = baron.dfm
    MOV EBX,EAX                         ; 00412bd5
    ADD EAX,0x158                       ; 00412bd7
    PUSH EAX                            ; 00412bdc
    MOV dword ptr [EAX + -0x4],0x65a074 ; 00412bdd | CDemonActor_vtable g_CBaronVTable
    CALL core_skeleton.cpp_CDeformableModelInstance_init_FUN_005a0840 ; 00412be4 | void core_skeleton.cpp_CDeformableModelInstance_init_FUN_005a0840(CDeformableModelInstance * this_ptr, char * model_name)
    ...
    MOV ESI,0x614ee1                    ; 00412c15 | = "none" | s_none_00614ee1 = none
    ...
    PUSH EDI                            ; 00412c41
    MOV AL,byte ptr [ESI]               ; 00412c42 | = "none" | s_none_00614ee1 = none
        ;   Label: LAB_00412c42
    MOV byte ptr [EDI],AL               ; 00412c44
    CMP AL,0x0                          ; 00412c46
    JZ 0x00412c5a                       ; 00412c48 | LAB_00412c5a
        ;   XREF to: 00412c5a (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 00412c4a | s_one_00614ee2
    ADD ESI,0x2                         ; 00412c4d
    MOV byte ptr [EDI + 0x1],AL         ; 00412c50
    ADD EDI,0x2                         ; 00412c53
    CMP AL,0x0                          ; 00412c56
    JNZ 0x00412c42                      ; 00412c58 | LAB_00412c42
        ;   XREF to: 00412c42 (CONDITIONAL_JUMP)
    POP EDI                             ; 00412c5a
        ;   Label: LAB_00412c5a
    MOV ESI,0x614ee6                    ; 00412c5b | = "none" | s_none_00614ee6 = none
    LEA EDI,[EBX + 0x1fc38]             ; 00412c60
    PUSH EDI                            ; 00412c66
    MOV AL,byte ptr [ESI]               ; 00412c67 | = "none" | s_none_00614ee6 = none
        ;   Label: LAB_00412c67
    MOV byte ptr [EDI],AL               ; 00412c69
    CMP AL,0x0                          ; 00412c6b
    JZ 0x00412c7f                       ; 00412c6d | LAB_00412c7f
        ;   XREF to: 00412c7f (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 00412c6f | s_one_00614ee7
    ADD ESI,0x2                         ; 00412c72
    MOV byte ptr [EDI + 0x1],AL         ; 00412c75
    ADD EDI,0x2                         ; 00412c78
    CMP AL,0x0                          ; 00412c7b
    JNZ 0x00412c67                      ; 00412c7d | LAB_00412c67
        ;   XREF to: 00412c67 (CONDITIONAL_JUMP)
    POP EDI                             ; 00412c7f
        ;   Label: LAB_00412c7f
    PUSH 0x614eeb                       ; 00412c80 | = "baronshell.kfm" | s_baronshell_kfm_00614eeb = baronshell.kfm
    PUSH 0x82251c                       ; 00412c85 | CKeyFramedModelInstance g_CKeyFramedModelInstanceInstance
    CALL core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0 ; 00412c8a | void core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0(CKeyFramedModelInstance * this_ptr, char * filename)
