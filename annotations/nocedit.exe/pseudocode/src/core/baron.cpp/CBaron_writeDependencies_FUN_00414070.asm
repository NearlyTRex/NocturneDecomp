...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_baron_cpp_CBaron_writeDependencies_FUN_00414070(CBaron *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x8]       ; 00414070
        ;   Label: core_baron.cpp_CBaron_writeDependencies_FUN_00414070
    PUSH EDX                            ; 00414074
    MOV ECX,dword ptr [ESP + 0x8]       ; 00414075
    PUSH ECX                            ; 00414079
    CALL core_hero.cpp_CHero_writeDependencies_FUN_004f3fa0 ; 0041407a
