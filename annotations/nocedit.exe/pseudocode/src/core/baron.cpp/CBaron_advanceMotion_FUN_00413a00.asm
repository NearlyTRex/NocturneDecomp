...
;
; Called Functions:
;   core_baron.cpp_CBaron_performLightningAttack_FUN_004136b0
...
section .text
    ...
    PUSH EBX                            ; 00413a00
        ;   Label: core_baron.cpp_CBaron_advanceMotion_FUN_00413a00
    PUSH ESI                            ; 00413a01
    PUSH EBP                            ; 00413a02
    ...
    PUSH EBX                            ; 00413a35
        ;   Label: LAB_00413a35
    CALL core_baron.cpp_CBaron_performLightningAttack_FUN_004136b0 ; 00413a36
        ;   XREF to: 004136b0 (UNCONDITIONAL_CALL)  ; void core_baron.cpp_CBaron_performLightningAttack_FUN_004136b0(CBaron * this_ptr)
