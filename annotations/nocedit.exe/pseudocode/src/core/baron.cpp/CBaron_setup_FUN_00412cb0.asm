...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_baron_cpp_CBaron_setup_FUN_00412cb0(CBaron *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00412cb0
        ;   Label: core_baron.cpp_CBaron_setup_FUN_00412cb0
    PUSH ESI                            ; 00412cb1
    MOV ESI,dword ptr [ESP + 0xc]       ; 00412cb2
    PUSH ESI                            ; 00412cb6
    CALL core_hero.cpp_CHero_setup_FUN_004f2540 ; 00412cb7
    ...
    PUSH EBX                            ; 00412ce7
    MOV [0x00822498],EAX                ; 00412ce8 | INT_00822498
    ...
    PUSH EBX                            ; 00412cfc
    MOV [0x0082249c],EAX                ; 00412cfd | INT_0082249c
    ...
    PUSH EBX                            ; 00412d11
    MOV [0x008224a0],EAX                ; 00412d12 | INT_008224a0
    ...
    PUSH EBX                            ; 00412d26
    MOV [0x008224a4],EAX                ; 00412d27 | INT_008224a4
    ...
    PUSH EBX                            ; 00412d3b
    MOV [0x008224a8],EAX                ; 00412d3c | INT_008224a8
    ...
    PUSH EBX                            ; 00412d50
    MOV [0x008224ac],EAX                ; 00412d51 | INT_008224ac
    ...
    PUSH EBX                            ; 00412d65
    MOV [0x008224b0],EAX                ; 00412d66 | INT_008224b0
    ...
    PUSH EBX                            ; 00412da4
    MOV [0x008224bc],EAX                ; 00412da5 | INT_008224bc
    ...
    PUSH EBX                            ; 00412db9
    MOV [0x008224c0],EAX                ; 00412dba | INT_008224c0
    ...
    PUSH EBX                            ; 00412dce
    MOV [0x008224c4],EAX                ; 00412dcf | INT_008224c4
    ...
    PUSH EBX                            ; 00412de3
    MOV [0x008224c8],EAX                ; 00412de4 | INT_008224c8
    ...
    PUSH EBX                            ; 00412df8
    MOV [0x008224cc],EAX                ; 00412df9 | INT_008224cc
    ...
    PUSH EBX                            ; 00412e0d
    MOV [0x008224d0],EAX                ; 00412e0e | INT_008224d0
    ...
    PUSH EBX                            ; 00412e22
    MOV [0x008224d4],EAX                ; 00412e23 | INT_008224d4
    ...
    PUSH EBX                            ; 00412e37
    MOV [0x008224d8],EAX                ; 00412e38 | INT_008224d8
