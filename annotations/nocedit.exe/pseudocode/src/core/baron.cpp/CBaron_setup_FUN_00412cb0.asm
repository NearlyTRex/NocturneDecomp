...
section .text
    ...
    PUSH EBX                            ; 00412ce7
    MOV [0x00822498],EAX                ; 00412ce8 | g_BaronIndices
    ...
    PUSH EBX                            ; 00412cfc
    MOV [0x0082249c],EAX                ; 00412cfd | g_BaronIndices[1]
    ...
    PUSH EBX                            ; 00412d11
    MOV [0x008224a0],EAX                ; 00412d12 | g_BaronIndices[2]
    ...
    PUSH EBX                            ; 00412d26
    MOV [0x008224a4],EAX                ; 00412d27 | g_BaronIndices[3]
    ...
    PUSH EBX                            ; 00412d3b
    MOV [0x008224a8],EAX                ; 00412d3c | g_BaronIndices[4]
    ...
    PUSH EBX                            ; 00412d50
    MOV [0x008224ac],EAX                ; 00412d51 | g_BaronIndices[5]
    ...
    PUSH EBX                            ; 00412d65
    MOV [0x008224b0],EAX                ; 00412d66 | g_BaronIndices[6]
    ...
    PUSH EBX                            ; 00412d7a
    MOV [0x008224b4],EAX                ; 00412d7b | g_BaronIndices[7]
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 00412d80
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 00412d85
    MOV [0x008224b8],EAX                ; 00412d88 | g_BaronIndices[8]
    PUSH 0x1                            ; 00412d8d
    ...
    PUSH EBX                            ; 00412da4
    MOV [0x008224bc],EAX                ; 00412da5 | g_BaronIndices[9]
    ...
    PUSH EBX                            ; 00412db9
    MOV [0x008224c0],EAX                ; 00412dba | g_BaronIndices[10]
    ...
    PUSH EBX                            ; 00412dce
    MOV [0x008224c4],EAX                ; 00412dcf | g_BaronIndices[11]
    ...
    PUSH EBX                            ; 00412de3
    MOV [0x008224c8],EAX                ; 00412de4 | g_BaronIndices[12]
    ...
    PUSH EBX                            ; 00412df8
    MOV [0x008224cc],EAX                ; 00412df9 | g_BaronIndices[13]
    ...
    PUSH EBX                            ; 00412e0d
    MOV [0x008224d0],EAX                ; 00412e0e | g_BaronIndices[14]
    ...
    PUSH EBX                            ; 00412e22
    MOV [0x008224d4],EAX                ; 00412e23 | g_BaronIndices[15]
    ...
    PUSH EBX                            ; 00412e37
    MOV [0x008224d8],EAX                ; 00412e38 | g_BaronIndices[16]
