...
section .text
    ...
    JZ 0x00412ee3                       ; 00412e9e | LAB_00412ee3
        ;   XREF to: 00412ee3 (CONDITIONAL_JUMP)
    LEA EAX,[EBP + 0x1fc38]             ; 00412ea0
    PUSH EAX                            ; 00412ea6
    MOV ECX,dword ptr [0x006793d0]      ; 00412ea7 | CEventList * g_CEventListPtr
    PUSH ECX                            ; 00412ead | CEventList g_CEventListInstance
    CALL core_event.cpp_CEventList_evaluateCondition_FUN_004adca0 ; 00412eae | int core_event.cpp_CEventList_evaluateCondition_FUN_004adca0(CEventList * this_ptr, char * condition_expression)
        ;   XREF to: 004adca0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00412eb3
    TEST EAX,EAX                        ; 00412eb6
    JZ 0x00412ec7                       ; 00412eb8 | LAB_00412ec7
        ;   XREF to: 00412ec7 (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 00412eba
    PUSH 0x7                            ; 00412ebc
    PUSH EBX                            ; 00412ebe
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 00412ebf | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00412ec4
    CMP dword ptr [EBP + 0x1fccc],0x0   ; 00412ec7
        ;   Label: LAB_00412ec7
    JNZ 0x00412f20                      ; 00412ece | LAB_00412f20
        ;   XREF to: 00412f20 (CONDITIONAL_JUMP)
    CMP dword ptr [EBP + 0xbe28],0x2    ; 00412ed0
    JNZ 0x00412f20                      ; 00412ed7 | LAB_00412f20
        ;   XREF to: 00412f20 (CONDITIONAL_JUMP)
    ...
    LEA EAX,[EBP + 0x1fbd4]             ; 00412ee3
        ;   Label: LAB_00412ee3
    PUSH EAX                            ; 00412ee9
    MOV ESI,dword ptr [0x006793d0]      ; 00412eea | CEventList * g_CEventListPtr
    PUSH ESI                            ; 00412ef0 | CEventList g_CEventListInstance
    CALL core_event.cpp_CEventList_evaluateCondition_FUN_004adca0 ; 00412ef1 | int core_event.cpp_CEventList_evaluateCondition_FUN_004adca0(CEventList * this_ptr, char * condition_expression)
        ;   XREF to: 004adca0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00412ef6
    TEST EAX,EAX                        ; 00412ef9
    JZ 0x00412ec7                       ; 00412efb | LAB_00412ec7
        ;   XREF to: 00412ec7 (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 00412efd
    PUSH 0x6                            ; 00412eff
    PUSH EBX                            ; 00412f01
    MOV dword ptr [EBP + 0x1fccc],0x1   ; 00412f02
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 00412f0c | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00412f11
    MOV dword ptr [EBP + 0x1fcd0],0x1   ; 00412f14
    JMP 0x00412ec7                      ; 00412f1e | LAB_00412ec7
        ;   XREF to: 00412ec7 (UNCONDITIONAL_JUMP)
    PUSH dword ptr [ESP + 0xac]         ; 00412f20
        ;   Label: LAB_00412f20
    PUSH EBP                            ; 00412f27
    CALL core_charactr.cpp_CCharacter_FUN_00429870 ; 00412f28 | int core_charactr.cpp_CCharacter_FUN_00429870(CCharacter * this_ptr)
        ;   XREF to: 00429870 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00412f2d
    TEST EAX,EAX                        ; 00412f30
    JZ 0x00412ed9                       ; 00412f32 | LAB_00412ed9
        ;   XREF to: 00412ed9 (CONDITIONAL_JUMP)
    CMP dword ptr [EBP + 0xbe28],0x2    ; 00412f34
    JZ 0x004131ef                       ; 00412f3b | LAB_004131ef
        ;   XREF to: 004131ef (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0xac]          ; 00412f41
        ;   Label: LAB_00412f41
    FMUL double ptr [0x00615029]        ; 00412f48 | double DOUBLE_00615029
    MOV EAX,[0x0067b654]                ; 00412f4e | CGame * g_CGamePtr
    FSTP float ptr [EBP + 0x2438]       ; 00412f53
    CMP dword ptr [EAX + 0x228],0x0     ; 00412f59 | DAT_02d81cc4
    JZ 0x00412f74                       ; 00412f60 | LAB_00412f74
        ;   XREF to: 00412f74 (CONDITIONAL_JUMP)
    FLD float ptr [EBP + 0x2438]        ; 00412f62
    FMUL double ptr [0x00615031]        ; 00412f68 | double DOUBLE_00615031
    ...
    FNSTSW AX                           ; 00412f8b
    SAHF                                ; 00412f8d
    JBE 0x00412f9a                      ; 00412f8e | LAB_00412f9a
    ...
    CALL core_baron.cpp_FUN_00413a00    ; 00412fba | undefined core_baron.cpp_FUN_00413a00()
        ;   XREF to: 00413a00 (UNCONDITIONAL_CALL)
    MOV EBX,dword ptr [EBP + 0x1fccc]   ; 00412fbf
    ADD ESP,0x8                         ; 00412fc5
    TEST EBX,EBX                        ; 00412fc8
    JZ 0x00412ed9                       ; 00412fca | LAB_00412ed9
        ;   XREF to: 00412ed9 (CONDITIONAL_JUMP)
    PUSH EDI                            ; 00412fd0
    PUSH dword ptr [ESP + 0xb0]         ; 00412fd1
    PUSH EBP                            ; 00412fd8
    CALL core_charactr.cpp_CCharacter_FUN_0042ca70 ; 00412fd9 | int core_charactr.cpp_CCharacter_FUN_0042ca70(CCharacter * this_ptr)
    ...
    JZ 0x00413448                       ; 00412feb | LAB_00413448
        ;   XREF to: 00413448 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [EBP + 0x25b0]    ; 00412ff1
    CMP EBX,0x2                         ; 00412ff7
    JNC 0x00413230                      ; 00412ffa | LAB_00413230
        ;   XREF to: 00413230 (CONDITIONAL_JUMP)
    CMP EBX,0x1                         ; 00413000
    JNZ 0x00413237                      ; 00413003 | LAB_00413237
        ;   XREF to: 00413237 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 00413009
    PUSH EBX                            ; 0041300a
    PUSH EAX                            ; 0041300b
        ;   Label: LAB_0041300b
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 0041300c | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   Label: LAB_0041300c
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ...
    FMUL double ptr [0x00615039]        ; 0041302f | double DOUBLE_00615039
    ...
    CALL core_charactr.cpp_CCharacter_FUN_00429820 ; 004130c5 | void core_charactr.cpp_CCharacter_FUN_00429820(CCharacter * this_ptr)
        ;   XREF to: 00429820 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004130ca
    LEA EBX,[EBP + 0x158]               ; 004130cd
    PUSH EBX                            ; 004130d3
    CALL core_skeleton.cpp_CDeformableModelInstance_updateAnimation_FUN_0059e020 ; 004130d4 | void core_skeleton.cpp_CDeformableModelInstance_updateAnimation_FUN_0059e020(CDeformableModelInstance * this_ptr)
        ;   XREF to: 0059e020 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004130d9
    PUSH 0x59ddb0                       ; 004130dc
    MOV ESI,dword ptr [0x00822498]      ; 004130e1 | undefined4 DAT_00822498
    PUSH ESI                            ; 004130e7
    LEA EAX,[EBP + 0x1fc9c]             ; 004130e8
    PUSH dword ptr [EBP + 0x1fca8]      ; 004130ee
    PUSH EAX                            ; 004130f4
    LEA ESI,[ESP + 0x14]                ; 004130f5
    CALL core_xform.cpp_eulerToQuaternion_FUN_005f7b20 ; 004130f9 | CQuaternion4f * core_xform.cpp_eulerToQuaternion_FUN_005f7b20(CQuaternion4f * quat_out, CVector3f * euler_angles)
    ...
    CALL core_skeleton.cpp_CDeformableModelInstance_blendBoneRotations_FUN_0059f750 ; 00413113 | void core_skeleton.cpp_CDeformableModelInstance_blendBoneRotations_FUN_0059f750(CDeformableModelInstance * this_ptr, CQuaternion4f * source_quaternions, float blend_weight, int bone_index, ...)
    ...
    CALL core_charactr.cpp_CCharacter_ApplyGestureLookAt_FUN_0042dfc0 ; 0041312a | void core_charactr.cpp_CCharacter_ApplyGestureLookAt_FUN_0042dfc0(CCharacter * this_ptr)
    ...
    CALL core_actor.cpp_getRandomFloat_FUN_0040cc10 ; 0041313f | float core_actor.cpp_getRandomFloat_FUN_0040cc10(float min_value, float max_value)
    ...
    CALL core_actor.cpp_getRandomFloat_FUN_0040cc10 ; 00413168 | float core_actor.cpp_getRandomFloat_FUN_0040cc10(float min_value, float max_value)
        ;   XREF to: 0040cc10 (UNCONDITIONAL_CALL)
    MOV dword ptr [ESP + 0xa0],EAX      ; 0041316d
    MOV EBP,dword ptr [0x0067a3d0]      ; 00413174 | CFireEffect * g_CFireEffectPtr
    ...
    PUSH EBP                            ; 004131bb | CFireEffect g_CFireEffectInstance
    FSTP float ptr [ESP + 0x64]         ; 004131bc
    CALL core_fire.cpp_CFireEffect_createSmokeParticle_FUN_004c7b20 ; 004131c0 | void core_fire.cpp_CFireEffect_createSmokeParticle_FUN_004c7b20(CFireEffect * this_ptr, CVector3f * position, float drag_factor, CVector3f * wind_influence, ...)
        ;   XREF to: 004c7b20 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 004131c5
    CMP EBX,0x2                         ; 004131c8
    JL 0x00413135                       ; 004131cb | LAB_00413135
        ;   XREF to: 00413135 (CONDITIONAL_JUMP)
    FLD float ptr [0x008224dc]          ; 004131d1 | undefined4 DAT_008224dc
    FADD float ptr [ESP + 0xb0]         ; 004131d7
    FSTP float ptr [0x008224dc]         ; 004131de | undefined4 DAT_008224dc
    POP EDI                             ; 004131e4
    ...
    PUSH dword ptr [ESP + 0xac]         ; 004131ef
        ;   Label: LAB_004131ef
    PUSH EBP                            ; 004131f6
    CALL core_baron.cpp_FUN_004135e0    ; 004131f7 | undefined core_baron.cpp_FUN_004135e0()
        ;   XREF to: 004135e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004131fc
    JMP 0x00412f41                      ; 004131ff | LAB_00412f41
        ;   XREF to: 00412f41 (UNCONDITIONAL_JUMP)
    PUSH 0x1                            ; 00413204
        ;   Label: LAB_00413204
    PUSH 0x0                            ; 00413206
    PUSH EAX                            ; 00413208
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 00413209 | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0041320e
    PUSH EBP                            ; 00413211
    PUSH 0x614ff9                       ; 00413212 | = "%s confused while walking to scriptDe..." | s_s_confused_while_walking_00614ff9 = %s confused while walking to scriptDest!

    MOV EAX,[0x0066e8e0]                ; 00413217 | CConsole * g_CConsolePtr
    PUSH EAX                            ; 0041321c | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 0041321d | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
        ;   XREF to: 00441890 (UNCONDITIONAL_CALL)
    JMP 0x00413011                      ; 00413222 | LAB_00413011
        ;   XREF to: 00413011 (UNCONDITIONAL_JUMP)
    PUSH 0x1                            ; 00413227
        ;   Label: LAB_00413227
    PUSH 0x3                            ; 00413229
    JMP 0x0041300b                      ; 0041322b | LAB_0041300b
        ;   XREF to: 0041300b (UNCONDITIONAL_JUMP)
    JBE 0x00413227                      ; 00413230 | LAB_00413227
        ;   Label: LAB_00413230
        ;   XREF to: 00413227 (CONDITIONAL_JUMP)
    CMP EBX,0x3                         ; 00413232
    JZ 0x00413204                       ; 00413235 | LAB_00413204
        ;   XREF to: 00413204 (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 00413237
        ;   Label: LAB_00413237
    PUSH 0x0                            ; 00413239
    LEA EAX,[EBP + 0x158]               ; 0041323b
    JMP 0x0041300b                      ; 00413241 | LAB_0041300b
        ;   XREF to: 0041300b (UNCONDITIONAL_JUMP)
    MOV EBX,dword ptr [0x008224cc]      ; 00413246 | undefined4 DAT_008224cc
        ;   Label: caseD_4
    ...
    PUSH EAX                            ; 00413260
    PUSH 0x3f87558                      ; 00413261 | CVector3f g_ZeroVector
    LEA EAX,[ESP + 0x2c]                ; 00413266
    PUSH EAX                            ; 0041326a
    CALL core_xform.cpp_transformVector3x4_FUN_005f4dc0 ; 0041326b | CVector3f * core_xform.cpp_transformVector3x4_FUN_005f4dc0(CVector3f * output_vector, CVector3f * input_vector, CMatrix3x4f * matrix)
    ...
    PUSH EAX                            ; 00413278
    PUSH EBP                            ; 00413279
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 0041327a | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
        ;   XREF to: 00408ec0 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 0041327f
    LEA EAX,[ESP + 0x84]                ; 00413281
    ADD ESP,0xc                         ; 00413288
    CMP EAX,EBX                         ; 0041328b
    JZ 0x004132a6                       ; 0041328d | LAB_004132a6
    ...
    MOV EBX,dword ptr [0x008224d0]      ; 004132a6 | undefined4 DAT_008224d0
        ;   Label: LAB_004132a6
    ...
    PUSH EAX                            ; 004132c0
    PUSH 0x3f87558                      ; 004132c1 | CVector3f g_ZeroVector
    LEA EAX,[ESP + 0x8c]                ; 004132c6
    PUSH EAX                            ; 004132cd
    CALL core_xform.cpp_transformVector3x4_FUN_005f4dc0 ; 004132ce | CVector3f * core_xform.cpp_transformVector3x4_FUN_005f4dc0(CVector3f * output_vector, CVector3f * input_vector, CMatrix3x4f * matrix)
        ;   XREF to: 005f4dc0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 004132db
    PUSH EBP                            ; 004132dc
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 004132dd | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
        ;   XREF to: 00408ec0 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 004132e2
    LEA EAX,[ESP + 0x60]                ; 004132e4
    ADD ESP,0xc                         ; 004132e8
    CMP EAX,EBX                         ; 004132eb
    JZ 0x00413303                       ; 004132ed | LAB_00413303
    ...
    CMP dword ptr [EBP + 0x1fcb0],0x0   ; 00413303
        ;   Label: LAB_00413303
    JNZ 0x0041336c                      ; 0041330a | LAB_0041336c
        ;   XREF to: 0041336c (CONDITIONAL_JUMP)
    PUSH 0x66e460                       ; 0041330c | SMRGLTextureBasic DAT_0066e460
    ...
    PUSH EAX                            ; 0041332e
    MOV EDI,dword ptr [0x0067a3d0]      ; 0041332f | CFireEffect * g_CFireEffectPtr
    PUSH EDI                            ; 00413335 | CFireEffect g_CFireEffectInstance
    CALL core_fire.cpp_CFireEffect_FUN_004c90c0 ; 00413336 | int core_fire.cpp_CFireEffect_FUN_004c90c0(CFireEffect * this_ptr)
        ;   XREF to: 004c90c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x1c                        ; 0041333b
    PUSH 0x66e460                       ; 0041333e | SMRGLTextureBasic DAT_0066e460
    ...
    PUSH EAX                            ; 0041335d
    MOV EAX,[0x0067a3d0]                ; 0041335e | CFireEffect g_CFireEffectInstance | CFireEffect * g_CFireEffectPtr
    PUSH EAX                            ; 00413363 | CFireEffect g_CFireEffectInstance
    CALL core_fire.cpp_CFireEffect_FUN_004c90c0 ; 00413364 | int core_fire.cpp_CFireEffect_FUN_004c90c0(CFireEffect * this_ptr)
        ;   XREF to: 004c90c0 (UNCONDITIONAL_CALL)
    ...
    JZ 0x00413391                       ; 00413378 | LAB_00413391
    ...
    JZ 0x004133b3                       ; 0041339d | LAB_004133b3
    ...
    CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0 ; 00413425 | SMotion * core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0(CMotionController * this_ptr)
        ;   XREF to: 0052dab0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EAX + 0x24]      ; 0041342a
    ADD ESP,0x4                         ; 0041342d
    CMP EBX,EAX                         ; 00413430
    JZ 0x00413014                       ; 00413432 | default
        ;   XREF to: 00413014 (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 00413438
    PUSH EBX                            ; 0041343a
    PUSH ESI                            ; 0041343b
    JMP 0x0041300c                      ; 0041343c | LAB_0041300c
        ;   XREF to: 0041300c (UNCONDITIONAL_JUMP)
    MOV EBX,0x1                         ; 00413441
        ;   Label: LAB_00413441
    JMP 0x004133dc                      ; 00413446 | LAB_004133dc
        ;   XREF to: 004133dc (UNCONDITIONAL_JUMP)
    PUSH EAX                            ; 00413448
        ;   Label: LAB_00413448
    CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0 ; 00413449 | SMotion * core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0(CMotionController * this_ptr)
        ;   XREF to: 0052dab0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EAX + 0x24]      ; 0041344e
    ADD ESP,0x4                         ; 00413451
    CMP EAX,0x4                         ; 00413454
    JA 0x00413014                       ; 00413457 | default
        ;   XREF to: 00413014 (CONDITIONAL_JUMP)
    JMP dword ptr [EAX*0x4 + 0x412e68]  ; 0041345d | pointer switchdataD_00412e68
        ;   Label: switchD
