...
section .text
    ...
    PUSH EBX                            ; 005e3dd5
    CALL core_actor.cpp_CDemonActor_processInEditor_FUN_0040d040 ; 005e3dd6 | void core_actor.cpp_CDemonActor_processInEditor_FUN_0040d040(CDemonActor * this_ptr)
    ...
    JNZ 0x005e3ded                      ; 005e3de9 | LAB_005e3ded
