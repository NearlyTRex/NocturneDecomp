...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_turret_cpp_CTurret_FUN_005e3ca0(CTurret *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH ESI                            ; 005e3cdc
    CALL core_actor.cpp_CActorPropertyList_addEvent_FUN_0040e460 ; 005e3cdd
    ...
    PUSH ESI                            ; 005e3cfa
    CALL core_actor.cpp_CActorPropertyList_addFloatRange_FUN_0040e1a0 ; 005e3cfb
    ...
    PUSH ESI                            ; 005e3d18
    CALL core_actor.cpp_CActorPropertyList_addFloatRange_FUN_0040e1a0 ; 005e3d19
        ;   XREF to: 0040e1a0 (UNCONDITIONAL_CALL)  ; CActorProperty * core_actor.cpp_CActorPropertyList_addFloatRange_FUN_0040e1a0(CActorPropertyList * this_ptr, char * property_name, float * data_ptr, float min_value, ...)
    ...
    PUSH ESI                            ; 005e3d36
    CALL core_actor.cpp_CActorPropertyList_addFloatRange_FUN_0040e1a0 ; 005e3d37
        ;   XREF to: 0040e1a0 (UNCONDITIONAL_CALL)  ; CActorProperty * core_actor.cpp_CActorPropertyList_addFloatRange_FUN_0040e1a0(CActorPropertyList * this_ptr, char * property_name, float * data_ptr, float min_value, ...)
    ...
    PUSH ESI                            ; 005e3d54
    CALL core_actor.cpp_CActorPropertyList_addFloatRange_FUN_0040e1a0 ; 005e3d55
        ;   XREF to: 0040e1a0 (UNCONDITIONAL_CALL)  ; CActorProperty * core_actor.cpp_CActorPropertyList_addFloatRange_FUN_0040e1a0(CActorPropertyList * this_ptr, char * property_name, float * data_ptr, float min_value, ...)
    ...
    PUSH ESI                            ; 005e3d72
    CALL core_actor.cpp_CActorPropertyList_addFloatRange_FUN_0040e1a0 ; 005e3d73
        ;   XREF to: 0040e1a0 (UNCONDITIONAL_CALL)  ; CActorProperty * core_actor.cpp_CActorPropertyList_addFloatRange_FUN_0040e1a0(CActorPropertyList * this_ptr, char * property_name, float * data_ptr, float min_value, ...)
    ...
    PUSH ESI                            ; 005e3dac
    CALL core_actor.cpp_CActorPropertyList_addString_FUN_0040e290 ; 005e3dad
    ...
    PUSH ESI                            ; 005e3dc1
    CALL core_actor.cpp_CActorPropertyList_addBool_FUN_0040e330 ; 005e3dc2
