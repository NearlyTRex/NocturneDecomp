...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_turret_cpp_CTurret_FUN_005e3280(CTurret *this_ptr)
;
; Parameters:
...
;
; XREF[2]:
;   core_turret.cpp_CTurret_FUN_005e2d50 at 005e321d
;   core_turret.cpp_CTurret_FUN_005e3560 at 005e35c4
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 005e3280
        ;   Label: core_turret.cpp_CTurret_FUN_005e3280
    PUSH EBP                            ; 005e3281
