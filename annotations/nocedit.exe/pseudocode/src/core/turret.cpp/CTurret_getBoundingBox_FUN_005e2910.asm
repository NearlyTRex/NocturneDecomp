...
; CKeyFramedModelInstance * Stack[-0x10]:4  local_10
...
section .text
    ...
    PUSH EBX                            ; 005e2910
        ;   Label: core_turret.cpp_CTurret_getBoundingBox_FUN_005e2910
    PUSH EBP                            ; 005e2911
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 005e2945
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    PUSH EAX                            ; 005e294a
    FISTP dword ptr [ESP + 0xf8]        ; 005e294b
    CALL core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80 ; 005e2952
    ...
    CALL core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80 ; 005e29b3
        ;   XREF to: 00478d80 (UNCONDITIONAL_CALL)  ; CKeyFramedModel * core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80(CKeyFramedModelInstance * this_ptr)
    MOV ECX,dword ptr [EAX + 0x110]     ; 005e29b8
    ADD ESP,0x4                         ; 005e29be
    CMP ECX,0x1                         ; 005e29c1
    JGE 0x005e29d1                      ; 005e29c4
        ;   XREF to: 005e29d1 (CONDITIONAL_JUMP)  ; LAB_005e29d1
    ...
    PUSH EAX                            ; 005e29d9
    PUSH 0x3f87558                      ; 005e29da | g_ZeroVector
    LEA EAX,[ESP + 0xa0]                ; 005e29df
    PUSH EAX                            ; 005e29e6
    CALL core_xform.cpp_buildMatrixFromEulerAndPositionDirect_FUN_005f54c0 ; 005e29e7
    ...
    PUSH EAX                            ; 005e29f2
    PUSH 0x3f87558                      ; 005e29f3 | g_ZeroVector
    LEA EAX,[ESP + 0x10]                ; 005e29f8
    PUSH EAX                            ; 005e29fc
    CALL core_xform.cpp_buildMatrixFromEulerAndPosition_FUN_005f5390 ; 005e29fd
    ...
    CALL core_xform.cpp_multiplyMatrix3x4_FUN_005f4f10 ; 005e2a16
    ...
    PUSH 0x1                            ; 005e2a22
    JMP 0x03fc3be0                      ; 005e2a24
        ;   XREF to: 03fc3be0 (UNCONDITIONAL_JUMP)  ; LAB_03fc3be0
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 005e2a4d
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    PUSH EBX                            ; 005e2a52
    FISTP dword ptr [ESP + 0x100]       ; 005e2a53
    CALL core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80 ; 005e2a5a
        ;   XREF to: 00478d80 (UNCONDITIONAL_CALL)  ; CKeyFramedModel * core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80(CKeyFramedModelInstance * this_ptr)
    ...
    PUSH EAX                            ; 005e2ade
    CALL core_box.cpp_CBoundingBox3D_getCorner_FUN_004202b0 ; 005e2adf
    ...
    PUSH EAX                            ; 005e2aef
    CALL core_xform.cpp_transformVector3x4_FUN_005f4dc0 ; 005e2af0
        ;   XREF to: 005f4dc0 (UNCONDITIONAL_CALL)  ; CVector3f * core_xform.cpp_transformVector3x4_FUN_005f4dc0(CVector3f * output_vector, CVector3f * input_vector, CMatrix3x4f * matrix)
    ADD ESP,0xc                         ; 005e2af5
    PUSH EAX                            ; 005e2af8
    PUSH EBP                            ; 005e2af9
    INC EBX                             ; 005e2afa
    CALL core_box.cpp_CBoundingBox3D_expand_FUN_00420240 ; 005e2afb
    ...
    JL 0x005e2ac9                       ; 005e2b06
        ;   XREF to: 005e2ac9 (CONDITIONAL_JUMP)  ; LAB_005e2ac9
    MOV EAX,EBP                         ; 005e2b08
    ADD ESP,0xf8                        ; 005e2b0a
    POP EBP                             ; 005e2b10
    POP EBX                             ; 005e2b11
    RET                                 ; 005e2b12
    MOV ECX,0xc                         ; 03fc3be0
        ;   Label: LAB_03fc3be0
    LEA ESI,[ESP + 0x6c]                ; 03fc3be5
    PUSH EBX                            ; 03fc3be9
    MOV ECX,dword ptr [ESI]             ; 03fc3bea
    MOV dword ptr [EDI],ECX             ; 03fc3bec
    MOV ECX,dword ptr [ESI + 0x4]       ; 03fc3bee
    MOV dword ptr [EDI + 0x4],ECX       ; 03fc3bf1
    MOV ECX,dword ptr [ESI + 0x8]       ; 03fc3bf4
    MOV dword ptr [EDI + 0x8],ECX       ; 03fc3bf7
    MOV ECX,dword ptr [ESI + 0xc]       ; 03fc3bfa
    MOV dword ptr [EDI + 0xc],ECX       ; 03fc3bfd
    MOV ECX,dword ptr [ESI + 0x10]      ; 03fc3c00
    MOV dword ptr [EDI + 0x10],ECX      ; 03fc3c03
    MOV ECX,dword ptr [ESI + 0x14]      ; 03fc3c06
    MOV dword ptr [EDI + 0x14],ECX      ; 03fc3c09
    MOV ECX,dword ptr [ESI + 0x18]      ; 03fc3c0c
    MOV dword ptr [EDI + 0x18],ECX      ; 03fc3c0f
    MOV ECX,dword ptr [ESI + 0x1c]      ; 03fc3c12
    MOV dword ptr [EDI + 0x1c],ECX      ; 03fc3c15
    MOV ECX,dword ptr [ESI + 0x20]      ; 03fc3c18
    MOV dword ptr [EDI + 0x20],ECX      ; 03fc3c1b
    MOV ECX,dword ptr [ESI + 0x24]      ; 03fc3c1e
    MOV dword ptr [EDI + 0x24],ECX      ; 03fc3c21
    MOV ECX,dword ptr [ESI + 0x28]      ; 03fc3c24
    MOV dword ptr [EDI + 0x28],ECX      ; 03fc3c27
    MOV ECX,dword ptr [ESI + 0x2c]      ; 03fc3c2a
    MOV dword ptr [EDI + 0x2c],ECX      ; 03fc3c2d
    ADD ESI,0x30                        ; 03fc3c30
    ADD EDI,0x30                        ; 03fc3c33
    XOR ECX,ECX                         ; 03fc3c36
    JMP 0x005e2a30                      ; 03fc3c38
        ;   XREF to: 005e2a30 (UNCONDITIONAL_JUMP)  ; LAB_005e2a30
