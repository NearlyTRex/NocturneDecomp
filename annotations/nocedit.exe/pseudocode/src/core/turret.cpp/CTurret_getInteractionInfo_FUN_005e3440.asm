...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_turret_cpp_CTurret_getInteractionInfo_FUN_005e3440 (CTurret *this_ptr,SInteractionInfo *interaction_info)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005e3440
        ;   Label: core_turret.cpp_CTurret_getInteractionInfo_FUN_005e3440
    PUSH ESI                            ; 005e3441
