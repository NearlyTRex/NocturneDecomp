...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_turret_cpp_CTurret_archive_FUN_005e2c40(CTurret *this_ptr)
;
; Parameters:
...
;   core_weapon.cpp_CWeapon_archive_FUN_005ee250
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 005e2c40
        ;   Label: core_turret.cpp_CTurret_archive_FUN_005e2c40
    MOV EBX,dword ptr [ESP + 0x8]       ; 005e2c41
    PUSH EBX                            ; 005e2c45
    CALL core_weapon.cpp_CWeapon_archive_FUN_005ee250 ; 005e2c46
        ;   XREF to: 005ee250 (UNCONDITIONAL_CALL)  ; void core_weapon.cpp_CWeapon_archive_FUN_005ee250(CWeapon * this_ptr)
    ADD ESP,0x4                         ; 005e2c4b
    PUSH 0x6566c0                       ; 005e2c4e | = "homeOrient"
    LEA EAX,[EBX + 0x578]               ; 005e2c53
    PUSH EAX                            ; 005e2c59
    CALL core_actor.cpp_archiveOrientation_FUN_0040b3e0 ; 005e2c5a
    ...
    PUSH EAX                            ; 005e2c6d
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 005e2c6e
    ...
    PUSH EAX                            ; 005e2c81
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 005e2c82
    ...
    PUSH EAX                            ; 005e2c95
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 005e2c96
    ...
    PUSH EAX                            ; 005e2d0d
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 005e2d0e
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveString_FUN_0040b5c0(char * string_buffer, char * property_type)
    ADD ESP,0x8                         ; 005e2d13
    PUSH 0x65673e                       ; 005e2d16 | = "rotateDegPerSec"
    LEA EAX,[EBX + 0x778]               ; 005e2d1b
    PUSH EAX                            ; 005e2d21
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 005e2d22
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH EBX                            ; 005e2d42
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 005e2d43
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
