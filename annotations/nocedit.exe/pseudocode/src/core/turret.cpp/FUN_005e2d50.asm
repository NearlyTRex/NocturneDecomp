...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_turret.cpp_FUN_005e2d50()
;
; Local Variables:
...
section .text
    ...
    JZ 0x005e2edc                       ; 005e2d69 | LAB_005e2edc
    ...
    CALL core_box.cpp_CBoundingBox3D_reset_FUN_00420fb0 ; 005e2d90 | void core_box.cpp_CBoundingBox3D_reset_FUN_00420fb0(CBoundingBox3D * this_ptr)
    ...
    PUSH EAX                            ; 005e2da8
    CALL core_box.cpp_CBoundingBox3D_getCorner_FUN_004202b0 ; 005e2da9 | CVector3f * core_box.cpp_CBoundingBox3D_getCorner_FUN_004202b0(CBoundingBox3D * this_ptr, CVector3f * out_point, uint corner_index)
    ...
    PUSH EDI                            ; 005e2dc0
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 005e2dc1 | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
    ...
    PUSH EAX                            ; 005e2dd1
    INC EBX                             ; 005e2dd2
    CALL core_box.cpp_CBoundingBox3D_expand_FUN_00420240 ; 005e2dd3 | void core_box.cpp_CBoundingBox3D_expand_FUN_00420240(CBoundingBox3D * this_ptr, CVector3f * point)
        ;   XREF to: 00420240 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005e2dd8
    CMP EBX,0x8                         ; 005e2ddb
    JL 0x005e2d98                       ; 005e2dde | LAB_005e2d98
    ...
    FXCH ST5                            ; 005e2e4d
    FLD float ptr [0x00656778]          ; 005e2e4f | float FLOAT_00656778
    FXCH                                ; 005e2e55
    ...
    FADDP                               ; 005e2e5f
    FXCH ST2                            ; 005e2e61
    FLD float ptr [0x0065677c]          ; 005e2e63 | float FLOAT_0065677c
    FXCH                                ; 005e2e69
    ...
    MOV EAX,[0x006810c8]                ; 005e2ea9 | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
        ;   Label: LAB_005e2ea9
    CMP EDI,dword ptr [EAX + 0x14d154]  ; 005e2eae | g_CDemonSetInstance.actor_list_ptr
    JGE 0x005e3200                      ; 005e2eb4 | LAB_005e3200
        ;   XREF to: 005e3200 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [EAX + EBP*0x1 + 0x14d158] ; 005e2eba | g_CDemonSetInstance.actor_list_data[0]
    MOV EAX,dword ptr [ESP + 0x148]     ; 005e2ec1
    PUSH EAX                            ; 005e2ec8
    PUSH EBX                            ; 005e2ec9
    CALL core_actor.cpp_isOfClass_FUN_0040c6d0 ; 005e2eca | int core_actor.cpp_isOfClass_FUN_0040c6d0(CDemonActor * actor_ptr, char * class_name)
        ;   XREF to: 0040c6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005e2ecf
    TEST EAX,EAX                        ; 005e2ed2
    JNZ 0x005e2efc                      ; 005e2ed4 | LAB_005e2efc
        ;   XREF to: 005e2efc (CONDITIONAL_JUMP)
    INC EDI                             ; 005e2ed6
        ;   Label: LAB_005e2ed6
    ADD EBP,0x4                         ; 005e2ed7
    JMP 0x005e2ea9                      ; 005e2eda | LAB_005e2ea9
        ;   XREF to: 005e2ea9 (UNCONDITIONAL_JUMP)
    PUSH ESI                            ; 005e2edc
        ;   Label: LAB_005e2edc
    PUSH 0x65675b                       ; 005e2edd | = "%s has no guard trigger!\n" | s_s_has_no_guard_trigger_0065675b = %s has no guard trigger!

    MOV ECX,dword ptr [0x0066e8e0]      ; 005e2ee2 | CConsole g_ConsolePtr | CConsole * g_CConsolePtr
    PUSH ECX                            ; 005e2ee8 | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 005e2ee9 | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
    ...
    JZ 0x005e2ed6                       ; 005e2f6a | LAB_005e2ed6
        ;   XREF to: 005e2ed6 (CONDITIONAL_JUMP)
    PUSH 0x6598c0                       ; 005e2f70 | WatcomTypeInfo g_CVectorTypeInfo
    PUSH 0xa                            ; 005e2f75
    LEA EAX,[ESP + 0x8]                 ; 005e2f77
    PUSH EAX                            ; 005e2f7b
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 005e2f7c | void * crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
    ...
    JGE 0x005e3033                      ; 005e2f97 | LAB_005e3033
    ...
    FXCH                                ; 005e2fc3
    FLD float ptr [0x00656780]          ; 005e2fc5 | float FLOAT_00656780
    FXCH                                ; 005e2fcb
    FMUL ST1                            ; 005e2fcd
    FXCH ST2                            ; 005e2fcf
    ...
    JZ 0x005e3033                       ; 005e3011 | LAB_005e3033
        ;   XREF to: 005e3033 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 005e303d
    PUSH EBX                            ; 005e303e
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 005e303f | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
        ;   XREF to: 00408ec0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDX                            ; 005e305d
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 005e305e | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
    ...
    PUSH EAX                            ; 005e30e7
    PUSH ESI                            ; 005e30e8
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 005e30e9 | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
        ;   XREF to: 00408f10 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005e30ee
    PUSH EAX                            ; 005e30f1
    LEA EAX,[ESP + 0x118]               ; 005e30f2
    PUSH EAX                            ; 005e30f9
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 005e30fa | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005e30ff
    FLD float ptr [ESP + 0x114]         ; 005e3102
    FCOMP float ptr [0x00664b6c]        ; 005e3109 | undefined4 DAT_00664b6c
    FNSTSW AX                           ; 005e310f
    SAHF                                ; 005e3111
    JC 0x005e2ed6                       ; 005e3112 | LAB_005e2ed6
        ;   XREF to: 005e2ed6 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x114]         ; 005e3118
    FCOMP float ptr [0x00664b70]        ; 005e311f | undefined4 DAT_00664b70
    FNSTSW AX                           ; 005e3125
    SAHF                                ; 005e3127
    JA 0x005e2ed6                       ; 005e3128 | LAB_005e2ed6
        ;   XREF to: 005e2ed6 (CONDITIONAL_JUMP)
    ...
    JZ 0x005e2ed6                       ; 005e31c7 | LAB_005e2ed6
        ;   XREF to: 005e2ed6 (CONDITIONAL_JUMP)
    ...
    JMP 0x005e2ea9                      ; 005e31fb | LAB_005e2ea9
        ;   XREF to: 005e2ea9 (UNCONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0xd0],0x42c60000 ; 005e3200
        ;   Label: LAB_005e3200
    JG 0x005e3259                       ; 005e320b | LAB_005e3259
        ;   XREF to: 005e3259 (CONDITIONAL_JUMP)
    LEA EAX,[ESP + 0x120]               ; 005e320d
    PUSH dword ptr [ESP + 0x164]        ; 005e3214
    PUSH EAX                            ; 005e321b
    PUSH ESI                            ; 005e321c
    CALL core_turret.cpp_FUN_005e3280   ; 005e321d | undefined core_turret.cpp_FUN_005e3280()
    ...
    FNSTSW AX                           ; 005e322f
    SAHF                                ; 005e3231
    JC 0x005e3244                       ; 005e3232 | LAB_005e3244
    ...
    PUSH dword ptr [ESP + 0x164]        ; 005e3259
        ;   Label: LAB_005e3259
    PUSH ESI                            ; 005e3260
    CALL core_turret.cpp_FUN_005e3560   ; 005e3261 | undefined core_turret.cpp_FUN_005e3560()
