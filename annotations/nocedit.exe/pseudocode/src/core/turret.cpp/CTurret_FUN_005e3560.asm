...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_turret_cpp_CTurret_FUN_005e3560(CTurret *this_ptr)
;
; Parameters:
...
;
; XREF[2]:
;   core_turret.cpp_CTurret_FUN_005e2d50 at 005e3261
...
section .text
    ...
    PUSH EBX                            ; 005e3560
        ;   Label: core_turret.cpp_CTurret_FUN_005e3560
    PUSH ESI                            ; 005e3561
    PUSH EDI                            ; 005e3562
    PUSH EBP                            ; 005e3563
    ...
    PUSH EBX                            ; 005e35c2
    PUSH ESI                            ; 005e35c3
    CALL core_turret.cpp_CTurret_FUN_005e3280 ; 005e35c4
        ;   XREF to: 005e3280 (UNCONDITIONAL_CALL)  ; int core_turret.cpp_CTurret_FUN_005e3280(CTurret * this_ptr)
