...
;
; XREF[2]:
;   core_turret.cpp_CTurret_updatePatrol_FUN_005e3560 at 005e35c4
;   core_turret.cpp_CTurret_updateTargeting_FUN_005e2d50 at 005e321d
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 005e3280
        ;   Label: core_turret.cpp_CTurret_aimAtTarget_FUN_005e3280
    PUSH EBP                            ; 005e3281
