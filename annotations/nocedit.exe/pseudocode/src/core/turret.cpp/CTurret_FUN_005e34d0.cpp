...
// Convention: __cdecl
// Signature: int __cdecl core_turret_cpp_CTurret_FUN_005e34d0(CTurret *this_ptr)
...

{
  ...
  if (*(int *)(in_stack_0000000c + 0x10) == 0) {
    ...
    if (pCVar1 != (COrientation *)in_stack_00000008) {
      ...
      (this_ptr->base).base.orient.bank = in_stack_00000008[1];
      (this_ptr->base).base.orient.heading = in_stack_00000008[2];
    }
