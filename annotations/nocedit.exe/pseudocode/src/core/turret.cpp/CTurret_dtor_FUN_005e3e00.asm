...
;                               FUNCTION
; *****************************************************************************
; __cdecl CTurret * __cdecl core_turret_cpp_CTurret_dtor_FUN_005e3e00(CTurret *this_ptr,uint d1,uint d2)
;
; Parameters:
...
section .text
    ...
    PUSH 0x664c90                       ; 005e3e26 | g_CTurretTypeInfo
        ;   Label: LAB_005e3e26
    PUSH EBX                            ; 005e3e2b
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 005e3e2c
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 005e3e31
    PUSH EAX                            ; 005e3e34
    CALL crt_memory.c_free_FUN_005fe659 ; 005e3e35
