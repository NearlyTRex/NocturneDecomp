...

{
  ...
  if (local_30.x < DAT_00664b6c) {
    local_30.x = DAT_00664b6c;
  }
  if (DAT_00664b70 < local_30.x) {
    local_30.x = DAT_00664b70;
  }
  core_actor_cpp_normalizeAngleToPi_FUN_0040cd70(local_30.y - (in_stack_00000004->orient).bank);
  ...
  local_14 = -local_c;
  if (local_30.x < local_14) {
    local_30.x = local_14;
  }
  if (local_c < local_30.x) {
    local_30.x = local_c;
  }
  local_10 = -local_c;
  ...
  (in_stack_00000004->orient).bank = (in_stack_00000004->orient).bank + local_30.x;
  (in_stack_00000004->orient).pitch = (in_stack_00000004->orient).pitch + local_34;
  ...
  if (((float10)0 != ABS((float10)(local_34 < (float)0.001))) &&
     ((float10)0 != ABS((float10)((float)in_stack_00000004 < (float)0.001)))) {
    return 1;
  }
  return 0;
}
