...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_turret_cpp_CTurret_stopInteraction_FUN_005e3540(CTurret *this_ptr,CDemonActor *user)
;
; Parameters:
...
section .text
    ...
    MOV EAX,dword ptr [ESP + 0x4]       ; 005e3540
        ;   Label: core_turret.cpp_CTurret_stopInteraction_FUN_005e3540
