...
section .text
    ...
    PUSH EBX                            ; 005e2d50
        ;   Label: core_turret.cpp_CTurret_updateTargeting_FUN_005e2d50
    PUSH ESI                            ; 005e2d51
    PUSH EDI                            ; 005e2d52
    PUSH EBP                            ; 005e2d53
    ...
    MOV EBX,dword ptr [EAX + EBP*0x1 + 0x14d158] ; 005e2eba | g_CDemonSetInstance.actors[0] | g_CDemonSetInstance.actors[1]
    ...
    PUSH EAX                            ; 005e321b
    PUSH ESI                            ; 005e321c
    CALL core_turret.cpp_CTurret_aimAtTarget_FUN_005e3280 ; 005e321d
    ...
    PUSH dword ptr [ESP + 0x164]        ; 005e3259
        ;   Label: LAB_005e3259
    PUSH ESI                            ; 005e3260
    CALL core_turret.cpp_CTurret_updatePatrol_FUN_005e3560 ; 005e3261
