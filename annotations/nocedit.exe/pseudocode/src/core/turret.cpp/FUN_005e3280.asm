...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_turret.cpp_FUN_005e3280()
;
; Local Variables:
...
section .text
    ...
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 005e32b9 | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005e32be
    FLD float ptr [ESP + 0x8]           ; 005e32c1
    FCOMP float ptr [0x00664b6c]        ; 005e32c5 | undefined4 DAT_00664b6c
    FNSTSW AX                           ; 005e32cb
    SAHF                                ; 005e32cd
    JC 0x005e3422                       ; 005e32ce | LAB_005e3422
        ;   XREF to: 005e3422 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x8]           ; 005e32d4
        ;   Label: LAB_005e32d4
    FCOMP float ptr [0x00664b70]        ; 005e32d8 | undefined4 DAT_00664b70
    FNSTSW AX                           ; 005e32de
    SAHF                                ; 005e32e0
    JBE 0x005e32ec                      ; 005e32e1 | LAB_005e32ec
        ;   XREF to: 005e32ec (CONDITIONAL_JUMP)
    MOV EAX,[0x00664b70]                ; 005e32e3 | undefined4 DAT_00664b70
    ...
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 005e32f9 | float core_actor.cpp_normalizeAngleToPi_FUN_0040cd70(float angle_radians)
    ...
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 005e331c | float core_actor.cpp_normalizeAngleToPi_FUN_0040cd70(float angle_radians)
        ;   XREF to: 0040cd70 (UNCONDITIONAL_CALL)
    FLD float ptr [EBX + 0x778]         ; 005e3321
    MOV dword ptr [ESP + 0x30],EAX      ; 005e3327
    FMUL double ptr [0x00656788]        ; 005e332b | double DOUBLE_00656788
    ...
    FNSTSW AX                           ; 005e3356
    SAHF                                ; 005e3358
    JNC 0x005e3363                      ; 005e3359 | LAB_005e3363
    ...
    FNSTSW AX                           ; 005e336b
    SAHF                                ; 005e336d
    JBE 0x005e3378                      ; 005e336e | LAB_005e3378
    ...
    FNSTSW AX                           ; 005e3389
    SAHF                                ; 005e338b
    JNC 0x005e3395                      ; 005e338c | LAB_005e3395
    ...
    FNSTSW AX                           ; 005e339c
    SAHF                                ; 005e339e
    JBE 0x005e33a8                      ; 005e339f | LAB_005e33a8
    ...
    CALL core_actor.cpp_CDemonActor_updateOrientationMatrix_FUN_00408c10 ; 005e33c3 | void core_actor.cpp_CDemonActor_updateOrientationMatrix_FUN_00408c10(CDemonActor * this_ptr)
        ;   XREF to: 00408c10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005e33c8
    FLD float ptr [ESP + 0x4]           ; 005e33cb
    FCOMP double ptr [0x00656790]       ; 005e33cf | double DOUBLE_00656790
    FNSTSW AX                           ; 005e33d5
    SAHF                                ; 005e33d7
    JNC 0x005e3430                      ; 005e33d8 | LAB_005e3430
    ...
    FNSTSW AX                           ; 005e33ed
    SAHF                                ; 005e33ef
    JZ 0x005e3438                       ; 005e33f0 | LAB_005e3438
        ;   XREF to: 005e3438 (CONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 005e33f2
    FCOMP double ptr [0x00656790]       ; 005e33f5 | double DOUBLE_00656790
    FNSTSW AX                           ; 005e33fb
    SAHF                                ; 005e33fd
    JNC 0x005e3434                      ; 005e33fe | LAB_005e3434
    ...
    FNSTSW AX                           ; 005e3413
    SAHF                                ; 005e3415
    JZ 0x005e3438                       ; 005e3416 | LAB_005e3438
        ;   XREF to: 005e3438 (CONDITIONAL_JUMP)
    ...
    POP EBX                             ; 005e3420
    RET                                 ; 005e3421
    MOV EAX,[0x00664b6c]                ; 005e3422 | undefined4 DAT_00664b6c
        ;   Label: LAB_005e3422
    MOV dword ptr [ESP + 0x8],EAX       ; 005e3427
    JMP 0x005e32d4                      ; 005e342b | LAB_005e32d4
        ;   XREF to: 005e32d4 (UNCONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 005e3430
        ;   Label: LAB_005e3430
    JMP 0x005e33df                      ; 005e3432 | LAB_005e33df
        ;   XREF to: 005e33df (UNCONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 005e3434
        ;   Label: LAB_005e3434
    JMP 0x005e3405                      ; 005e3436 | LAB_005e3405
