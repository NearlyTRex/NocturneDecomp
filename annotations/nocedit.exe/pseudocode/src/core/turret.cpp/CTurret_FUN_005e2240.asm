...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_turret.cpp_CTurret_FUN_005e2240(CTurret * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 005e2251
    CALL core_dmodel.cpp_CKeyFramedModelInstance_preCache_FUN_00478d60 ; 005e2252 | CKeyFramedModel * core_dmodel.cpp_CKeyFramedModelInstance_preCache_FUN_00478d60(CKeyFramedModelInstance * this_ptr)
        ;   XREF to: 00478d60 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005e2257
    PUSH EBP                            ; 005e225a
    CALL core_weapon.cpp_CWeapon_FUN_005edff0 ; 005e225b | void core_weapon.cpp_CWeapon_FUN_005edff0(CWeapon * this_ptr)
        ;   XREF to: 005edff0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005e2260
    LEA EAX,[EBP + 0x158]               ; 005e2263
    PUSH EAX                            ; 005e2269
    CALL core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80 ; 005e226a | CKeyFramedModel * core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80(CKeyFramedModelInstance * this_ptr)
    ...
    CALL core_dmodel.cpp_CKeyFramedModel_getFrameVertices_FUN_00477890 ; 005e2285 | CVector3i * core_dmodel.cpp_CKeyFramedModel_getFrameVertices_FUN_00477890(CKeyFramedModel * this_ptr, int frame_index)
    ...
    JGE 0x005e22f0                      ; 005e22a1 | LAB_005e22f0
        ;   XREF to: 005e22f0 (CONDITIONAL_JUMP)
    FILD dword ptr [EDX + 0x4]          ; 005e22a3
    FMUL double ptr [0x006565f8]        ; 005e22a6 | double DOUBLE_006565f8
    ...
    FNSTSW AX                           ; 005e22b8
    SAHF                                ; 005e22ba
    JA 0x005e22c3                       ; 005e22bb | LAB_005e22c3
        ;   XREF to: 005e22c3 (CONDITIONAL_JUMP)
    INC ECX                             ; 005e22bd
        ;   Label: LAB_005e22bd
    ADD EDX,0xc                         ; 005e22be
    JMP 0x005e2299                      ; 005e22c1 | LAB_005e2299
    ...
    JMP 0x005e22bd                      ; 005e22ee | LAB_005e22bd
