...
;                               FUNCTION
; *****************************************************************************
; __cdecl int * __cdecl core_turret_cpp_CTurret_FUN_005e2910(CTurret *this_ptr)
;
; Parameters:
...
section .text
    ...
    CALL core_turret.cpp_CTurret_getCurFrame_FUN_005e2b30 ; 005e2929
        ;   XREF to: 005e2b30 (UNCONDITIONAL_CALL)  ; float core_turret.cpp_CTurret_getCurFrame_FUN_005e2b30()
