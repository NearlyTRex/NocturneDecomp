...

{
  ...
  (this_ptr->home_orient).vec.x = (pUVar1->vec).x;
  (this_ptr->home_orient).vec.y = (this_ptr->base).base.orient.vec.y;
  (this_ptr->home_orient).vec.z = (this_ptr->base).base.orient.vec.z;
  return;
}
