...
section .text
    ...
    PUSH EDX                            ; 0049cdc5
    CALL core_weapon.cpp_CWeapon_ctor_FUN_005ede70 ; 0049cdc6 | CWeapon * core_weapon.cpp_CWeapon_ctor_FUN_005ede70(CWeapon * this_ptr)
        ;   XREF to: 005ede70 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0049cdcb
    PUSH 0x622e81                       ; 0049cdce | = "dynamitestick.kfm" | s_dynamitestick_kfm_00622e81 = dynamitestick.kfm
    MOV EBX,EAX                         ; 0049cdd3
    ADD EAX,0x158                       ; 0049cdd5
    PUSH EAX                            ; 0049cdda
    MOV dword ptr [EAX + -0x4],0x65d314 ; 0049cddb | CDemonActor_vtable PTR_core_weapon.cpp_ActorModelSomething_FUN_0065d314
    CALL core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0 ; 0049cde2 | void core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0(CKeyFramedModelInstance * this_ptr, char * filename)
