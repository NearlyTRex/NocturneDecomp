...
section .text
    ...
    PUSH EBX                            ; 0049ce75
    CALL core_weapon.cpp_FUN_005ee6e0   ; 0049ce76 | undefined core_weapon.cpp_FUN_005ee6e0()
        ;   XREF to: 005ee6e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0049ce7b
    TEST EAX,EAX                        ; 0049ce7e
    JNZ 0x0049ce84                      ; 0049ce80 | LAB_0049ce84
    ...
    PUSH EAX                            ; 0049cea0
    MOV ECX,dword ptr [0x0067a3d0]      ; 0049cea1 | CFireEffect g_CFireEffectInstance | CFireEffect * g_CFireEffectPtr
    PUSH ECX                            ; 0049cea7 | CFireEffect g_CFireEffectInstance
    CALL core_fire.cpp_CFireEffect_FUN_004c8dd0 ; 0049cea8 | void core_fire.cpp_CFireEffect_FUN_004c8dd0(CFireEffect * this_ptr)
