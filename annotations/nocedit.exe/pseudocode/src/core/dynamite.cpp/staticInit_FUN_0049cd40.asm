...
section .text
    ...
    PUSH 0x3f95d40                      ; 0049cd40 | CDemonActorType g_CWeaponClassInfo
        ;   Label: core_dynamite.cpp_staticInit_FUN_0049cd40
    PUSH 0x1                            ; 0049cd45
    PUSH 0x678a34                       ; 0049cd47 | int g_CDynamiteClassVersion
    PUSH 0x49cd80                       ; 0049cd4c
    PUSH 0x622e62                       ; 0049cd51 | = "CDynamite" | s_CDynamite_00622e62 = CDynamite
    PUSH 0x2ceece8                      ; 0049cd56 | CDemonActorType g_CDynamiteClassInfo
    CALL core_actor.cpp_registerActorClass_FUN_0040c2e0 ; 0049cd5b | CDemonActorType * core_actor.cpp_registerActorClass_FUN_0040c2e0(CDemonActorType * this_ptr, char * class_name, CDemonActor_FactoryFunc * factor_func, int * max_version, ...)
