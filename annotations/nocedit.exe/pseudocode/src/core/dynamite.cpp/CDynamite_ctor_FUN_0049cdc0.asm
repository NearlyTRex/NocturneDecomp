...
;                               FUNCTION
; *****************************************************************************
; __cdecl CDynamite * __cdecl core_dynamite_cpp_CDynamite_ctor_FUN_0049cdc0(CDynamite *this_ptr)
;
; Parameters:
; CDynamite *      Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_dynamite.cpp_factoryFunc_FUN_0049cd80 at 0049cd9a
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0049cdc0
        ;   Label: core_dynamite.cpp_CDynamite_ctor_FUN_0049cdc0
    ...
    PUSH EAX                            ; 0049cdda
    MOV dword ptr [EAX + -0x4],0x65d314 ; 0049cddb | g_CDynamiteVTable
