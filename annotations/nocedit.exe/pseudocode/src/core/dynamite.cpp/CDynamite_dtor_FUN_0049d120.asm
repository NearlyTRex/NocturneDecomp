...
;                               FUNCTION
; *****************************************************************************
; __cdecl CDynamite * __cdecl core_dynamite_cpp_CDynamite_dtor_FUN_0049d120(CDynamite *this_ptr,uint d1,uint d2)
;
; Parameters:
...
section .text
    ...
    PUSH 0x65d420                       ; 0049d146 | g_CDynamiteTypeInfo
        ;   Label: LAB_0049d146
    PUSH EBX                            ; 0049d14b
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 0049d14c
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 0049d151
    PUSH EAX                            ; 0049d154
    CALL crt_memory.c_free_FUN_005fe659 ; 0049d155
    ...
    PUSH EAX                            ; 0049d161
        ;   Label: LAB_0049d161
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 0049d162
