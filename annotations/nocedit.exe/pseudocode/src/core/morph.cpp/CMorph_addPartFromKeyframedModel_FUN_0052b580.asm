...
;
; Called Functions:
;   core_morph.cpp_CMorphModel_addPartFromKeyFramedModel_FUN_0052a8d0
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 0052b580
        ;   Label: core_morph.cpp_CMorph_addPartFromKeyframedModel_FUN_0052b580
    ...
    PUSH EAX                            ; 0052b5a6
    CALL core_morph.cpp_CMorphModel_addPartFromKeyFramedModel_FUN_0052a8d0 ; 0052b5a7
        ;   XREF to: 0052a8d0 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_CMorphModel_addPartFromKeyFramedModel_FUN_0052a8d0(CMorphModel * this_ptr, CKeyFramedModel * model_ptr, int frame_index)
