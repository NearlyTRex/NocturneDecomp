...
// Convention: __cdecl
// Signature: void __cdecl core_morph_cpp_CMorphModel_animate_FUN_0052a920(CMorphModel *this_ptr)
...

{
  ...
  iVar3 = in_stack_00000010 + *(int *)(this_ptr->unk1 + in_stack_00000008 * 0x10 + 0xc);
  if (*(int *)(this_ptr->unk1 + in_stack_00000008 * 0x10 + 0xc) +
      *(int *)(this_ptr->unk1 + in_stack_00000008 * 0x10 + 4) < iVar3 + in_stack_00000014) {
    g_CurrentFilename = "..\\core\\morph.cpp";
