...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_morph_cpp_CMorph_FUN_0052ca90(CMorph *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0052ca90
        ;   Label: core_morph.cpp_CMorph_FUN_0052ca90
    PUSH ESI                            ; 0052ca91
    PUSH EDI                            ; 0052ca92
    PUSH EBP                            ; 0052ca93
    ...
    PUSH ESI                            ; 0052cb33
    CALL core_morph.cpp_CMorph_FUN_0052bae0 ; 0052cb34
