...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_morph.cpp_CMorphModel_FUN_0052a710(CMorphModel * this_ptr)
;
; Parameters:
...
section .text
    ...
    JGE 0x0052a816                      ; 0052a71b | LAB_0052a816
    ...
    PUSH 0x63a1cf                       ; 0052a77c | = "..\\core\\morph.cpp" | s_core_morph_cpp_0063a1cf = ..\core\morph.cpp
    SHL EAX,0x4                         ; 0052a781
    PUSH EAX                            ; 0052a784
    MOV EAX,dword ptr [EBX + 0x58]      ; 0052a785
    PUSH EAX                            ; 0052a788
    MOV dword ptr [EBX + 0x5c],EBP      ; 0052a789
    CALL shape_memdbg.cpp_debugRealloc_FUN_0050f540 ; 0052a78c | void * shape_memdbg.cpp_debugRealloc_FUN_0050f540(void * ptr, int new_size, char * filename, int line_number)
    ...
    PUSH 0x63a1e1                       ; 0052a7a7 | = "..\\core\\morph.cpp" | s_core_morph_cpp_0063a1e1 = ..\core\morph.cpp
    SUB EAX,EDX                         ; 0052a7ac
    PUSH EAX                            ; 0052a7ae
    MOV EDX,dword ptr [EBX + 0x60]      ; 0052a7af
    PUSH EDX                            ; 0052a7b2
    CALL shape_memdbg.cpp_debugRealloc_FUN_0050f540 ; 0052a7b3 | void * shape_memdbg.cpp_debugRealloc_FUN_0050f540(void * ptr, int new_size, char * filename, int line_number)
        ;   XREF to: 0050f540 (UNCONDITIONAL_CALL)
    ...
    JNZ 0x0052a83e                      ; 0052a7c8 | LAB_0052a83e
        ;   XREF to: 0052a83e (CONDITIONAL_JUMP)
    MOV EBP,0x63a1f3                    ; 0052a7ca | = "..\\core\\morph.cpp" | s_core_morph_cpp_0063a1f3 = ..\core\morph.cpp
        ;   Label: LAB_0052a7ca
    MOV EAX,0xc5                        ; 0052a7cf
    PUSH 0x63a205                       ; 0052a7d4 | = "CMorphModel::setup - out of memory!" | s_CMorphModel_setup_out_of_0063a205 = CMorphModel::setup - out of memory!
    MOV dword ptr [0x02f0ca48],EBP      ; 0052a7d9 | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 0052a7df | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0052a7e4 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052a7e9
    MOV EDX,dword ptr [ESP + 0x1c]      ; 0052a7ec
        ;   Label: LAB_0052a7ec
    TEST EDX,EDX                        ; 0052a7f0
    JZ 0x0052a809                       ; 0052a7f2 | LAB_0052a809
    ...
    PUSH EAX                            ; 0052a7ff
    PUSH EBX                            ; 0052a800
    CALL core_morph.cpp_CMorphModel_animate_FUN_0052a920 ; 0052a801 | void core_morph.cpp_CMorphModel_animate_FUN_0052a920(CMorphModel * this_ptr)
        ;   XREF to: 0052a920 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0052a806
    MOV EDI,dword ptr [ESP + 0x24]      ; 0052a809
        ;   Label: LAB_0052a809
    TEST EDI,EDI                        ; 0052a80d
    JNZ 0x0052a846                      ; 0052a80f | LAB_0052a846
    ...
    POP EBX                             ; 0052a814
    RET                                 ; 0052a815
    MOV ECX,0x63a196                    ; 0052a816 | = "..\\core\\morph.cpp" | s_core_morph_cpp_0063a196 = ..\core\morph.cpp
        ;   Label: LAB_0052a816
    MOV ESI,0xac                        ; 0052a81b
    PUSH 0x63a1a8                       ; 0052a820 | = "CMorphModel::addPart - too many parts!" | s_CMorphModel_addPart_too__0063a1a8 = CMorphModel::addPart - too many parts!
    MOV dword ptr [0x02f0ca48],ECX      ; 0052a825 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 0052a82b | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0052a831 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052a836
    JMP 0x0052a721                      ; 0052a839 | LAB_0052a721
        ;   XREF to: 0052a721 (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x60],0x0      ; 0052a83e
        ;   Label: LAB_0052a83e
    JZ 0x0052a7ca                       ; 0052a842 | LAB_0052a7ca
        ;   XREF to: 0052a7ca (CONDITIONAL_JUMP)
    JMP 0x0052a7ec                      ; 0052a844 | LAB_0052a7ec
    ...
    PUSH EAX                            ; 0052a85b
    PUSH EBX                            ; 0052a85c
    CALL core_morph.cpp_CMorphModel_FUN_0052aca0 ; 0052a85d | void core_morph.cpp_CMorphModel_FUN_0052aca0(CMorphModel * this_ptr)
