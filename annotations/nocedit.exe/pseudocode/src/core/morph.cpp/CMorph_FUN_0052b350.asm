...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_morph_cpp_CMorph_FUN_0052b350(CMorph *this_ptr)
;
; Parameters:
; CMorph *         Stack[0x4]:4   this_ptr
;
; XREF[2]:
;   core_morph.cpp_CMorph_dtor_FUN_0052b330 at 0052b335
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x4]       ; 0052b350
        ;   Label: core_morph.cpp_CMorph_FUN_0052b350
    PUSH EDX                            ; 0052b354
