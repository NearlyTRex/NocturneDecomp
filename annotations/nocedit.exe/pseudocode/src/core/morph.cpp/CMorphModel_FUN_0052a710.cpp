...
// Convention: __cdecl
// Signature: void core_morph.cpp_CMorphModel_FUN_0052a710(CMorphModel * this_ptr)
// Cross-references:
//   core_morph.cpp_CMorphModel_FUN_0052a870 (0052a870) at 0052a8bf [UNCONDITIONAL_CALL]
// Globals:
...

{
  ...
  *(undefined4 *)(this_ptr->field0_0x0 + *(int *)this_ptr->field0_0x0 * 0x10 + 8) =
       in_stack_00000014;
  this_ptr->num_points =
       this_ptr->num_points +
  ...
  *(void **)this_ptr->field2_0x58 = pvVar2;
  pvVar2 = shape_memdbg_cpp_debugRealloc_FUN_0050f540
                      ...
                      *(int *)(this_ptr->field2_0x58 + 4) * 0x3c,"..\\core\\morph.cpp",0xbf);
  iVar1 = *(int *)this_ptr->field0_0x0;
  *(void **)(this_ptr->field2_0x58 + 8) = pvVar2;
  *(int *)this_ptr->field0_0x0 = iVar1 + 1;
...
// 0052a85b: PUSH EAX
// 0052a85c: PUSH EBX
// 0052a85d: CALL core_morph.cpp_CMorphModel_FUN_0052aca0
