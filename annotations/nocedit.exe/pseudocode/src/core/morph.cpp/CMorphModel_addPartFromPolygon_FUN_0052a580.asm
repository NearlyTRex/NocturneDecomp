...
;   core_morph.cpp_CMorphModel_setFaceListFromPolygon_FUN_0052aac0
...
section .text
    ...
    PUSH EBX                            ; 0052a580
        ;   Label: core_morph.cpp_CMorphModel_addPartFromPolygon_FUN_0052a580
    PUSH ESI                            ; 0052a581
    PUSH EDI                            ; 0052a582
    PUSH EBP                            ; 0052a583
    ...
    PUSH EAX                            ; 0052a699
    PUSH ESI                            ; 0052a69a
    CALL core_morph.cpp_CMorphModel_animateFromVertexBuffer_FUN_0052a920 ; 0052a69b
