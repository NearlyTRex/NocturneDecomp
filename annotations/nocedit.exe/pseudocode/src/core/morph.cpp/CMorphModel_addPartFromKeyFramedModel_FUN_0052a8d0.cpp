...

{
  ...
  core_morph_cpp_CMorphModel_addPartFromPolygon_FUN_0052a580
            (this_ptr,model_ptr->vertex_count,vertex_data,poly_count,poly_data,poly_stride,
