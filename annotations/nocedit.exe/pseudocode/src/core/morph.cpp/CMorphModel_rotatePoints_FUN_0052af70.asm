...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_morph.cpp_CMorphModel_rotatePoints_FUN_0052af70(CMorphModel * this_ptr)
;
; Parameters:
...
section .text
    ...
    JG 0x0052b0ca                       ; 0052af82 | LAB_0052b0ca
    ...
    JLE 0x0052b0ba                      ; 0052afb0 | LAB_0052b0ba
        ;   XREF to: 0052b0ba (CONDITIONAL_JUMP)
    MOV ESI,0x2f3dbb4                   ; 0052afb6 | undefined4 DAT_02f3dbb4
    ...
    MOV EBX,ESI                         ; 0052b012 | undefined4 DAT_02f3dbb4
    ...
    FMUL float ptr [0x00661b40]         ; 0052b041 | float FLOAT_00661b40
    FISTP dword ptr [EBX]               ; 0052b047 | undefined4 DAT_02f3dbb4
    FLD float ptr [EAX + 0x4]           ; 0052b049
    FMUL float ptr [0x00661b40]         ; 0052b04c | float FLOAT_00661b40
    FISTP dword ptr [EBX + 0x4]         ; 0052b052 | undefined4 DAT_02f3dbb8
    FLD float ptr [EAX + 0x8]           ; 0052b055
    FMUL float ptr [0x00661b40]         ; 0052b058 | float FLOAT_00661b40
    FISTP dword ptr [EBX + 0x8]         ; 0052b05e | undefined4 DAT_02f3dbbc
    MOV EAX,[0x006703ec]                ; 0052b061 | CDemonRenderer * g_CDemonRendererPtr
    MOV EAX,dword ptr [EAX]             ; 0052b066 | CDemonRenderer g_CDemonRendererInstance
    PUSH ESI                            ; 0052b068 | undefined4 DAT_02f3dbb4
    ADD EAX,EDI                         ; 0052b069
    PUSH EAX                            ; 0052b06b
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 0052b06c | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    MOV EAX,[0x006703ec]                ; 0052b071 | CDemonRenderer * g_CDemonRendererPtr
    MOV EAX,dword ptr [EAX]             ; 0052b076 | CDemonRenderer g_CDemonRendererInstance
    MOV EAX,dword ptr [EDI + EAX*0x1 + 0x10] ; 0052b078
    ADD ESP,0x8                         ; 0052b07c
    TEST EAX,0x80000000                 ; 0052b07f
    JZ 0x0052b0f2                       ; 0052b084 | LAB_0052b0f2
    ...
    POP EBX                             ; 0052b0c8
    RET                                 ; 0052b0c9
    MOV ECX,0x63a3f7                    ; 0052b0ca | = "..\\core\\morph.cpp" | s_core_morph_cpp_0063a3f7 = ..\core\morph.cpp
        ;   Label: LAB_0052b0ca
    MOV EBX,0x1f8                       ; 0052b0cf
    PUSH 0x63a409                       ; 0052b0d4 | = "CMorphModel::rotatePoints - too many ..." | s_CMorphModel_rotatePoints_0063a409 = CMorphModel::rotatePoints - too many points!
    MOV dword ptr [0x02f0ca48],ECX      ; 0052b0d9 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 0052b0df | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0052b0e5 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052b0ea
    JMP 0x0052af88                      ; 0052b0ed | LAB_0052af88
        ;   XREF to: 0052af88 (UNCONDITIONAL_JUMP)
    XOR ECX,ECX                         ; 0052b0f2
        ;   Label: LAB_0052b0f2
    MOV dword ptr [ESP + 0x30],ECX      ; 0052b0f4
    JMP 0x0052b099                      ; 0052b0f8 | LAB_0052b099
        ;   XREF to: 0052b099 (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x48]      ; 0052b0fa
        ;   Label: LAB_0052b0fa
    MOV EDI,dword ptr [EAX + 0x54]      ; 0052b0fe
    PUSH EDI                            ; 0052b101
    MOV EBP,dword ptr [0x006810c8]      ; 0052b102 | CDemonSet * g_CDemonSetPtr
    PUSH EBP                            ; 0052b108 | CDemonSet g_CDemonSetInstance
    CALL core_set.cpp_CDemonSet_FUN_0056e5d0 ; 0052b109 | void core_set.cpp_CDemonSet_FUN_0056e5d0(CDemonSet * this_ptr)
        ;   XREF to: 0056e5d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0052b10e
    PUSH ESI                            ; 0052b111
    PUSH 0x3                            ; 0052b112
    MOV EAX,dword ptr [ESP + 0x50]      ; 0052b114
    PUSH 0x2f3dbb4                      ; 0052b118 | undefined4 DAT_02f3dbb4
    ...
    PUSH EBX                            ; 0052b128
    MOV ESI,dword ptr [0x006810c8]      ; 0052b129 | CDemonSet * g_CDemonSetPtr
    PUSH ESI                            ; 0052b12f | CDemonSet g_CDemonSetInstance
    CALL core_set.cpp_CDemonSet_lightVerticies_FUN_0056eac0 ; 0052b130 | float core_set.cpp_CDemonSet_lightVerticies_FUN_0056eac0(CDemonSet * this_ptr, int vertex_count, int tri_count, SInputFace * tri_data_ptr, ...)
        ;   XREF to: 0056eac0 (UNCONDITIONAL_CALL)
    ADD ESP,0x1c                        ; 0052b135
    MOV EDI,dword ptr [ESP + 0x24]      ; 0052b138
    PUSH EDI                            ; 0052b13c
    MOV EBP,dword ptr [0x006703ec]      ; 0052b13d | CDemonRenderer * g_CDemonRendererPtr
    PUSH EBP                            ; 0052b143 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_enableFaceCapture_FUN_0048caa0 ; 0052b144 | void engine_drender.cpp_CDemonRenderer_enableFaceCapture_FUN_0048caa0(CDemonRenderer * this_ptr, int enabled)
