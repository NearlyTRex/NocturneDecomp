...
;                               FUNCTION
; *****************************************************************************
; __cdecl CBoundingBox3D * __cdecl core_morph_cpp_CBoundingBox3D_arrdtor_FUN_0052ccf0(CBoundingBox3D *objs,uint flags)
;
; Parameters:
...
section .text
    ...
    PUSH 0x659900                       ; 0052ccf0 | g_CBoundingBox3DTypeInfo
        ;   Label: core_morph.cpp_CBoundingBox3D_arrdtor_FUN_0052ccf0
    PUSH 0x2                            ; 0052ccf5
