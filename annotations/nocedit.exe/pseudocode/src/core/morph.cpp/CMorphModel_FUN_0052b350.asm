...
section .text
    ...
    PUSH EDX                            ; 0052b354
    CALL core_morph.cpp_CMorphModel_free_FUN_0052a510 ; 0052b355 | void core_morph.cpp_CMorphModel_free_FUN_0052a510(CMorphModel * this_ptr)
        ;   XREF to: 0052a510 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052b35a
    MOV EAX,dword ptr [ESP + 0x4]       ; 0052b35d
    ADD EAX,0x608                       ; 0052b361
    PUSH EAX                            ; 0052b366
    CALL core_morph.cpp_CMorphModel_free_FUN_0052a510 ; 0052b367 | void core_morph.cpp_CMorphModel_free_FUN_0052a510(CMorphModel * this_ptr)
        ;   XREF to: 0052a510 (UNCONDITIONAL_CALL)
