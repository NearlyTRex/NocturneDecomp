...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_morph.cpp_FUN_0052aa80(void)
;
;
; XREF[1]:
...
section .text
    ...
    PUSH EBX                            ; 0052aa80
        ;   Label: core_morph.cpp_FUN_0052aa80
    PUSH ESI                            ; 0052aa81
    ...
    PUSH ECX                            ; 0052aa93
    PUSH EDX                            ; 0052aa94
    CALL core_dmodel.cpp_CKeyFramedModel_getFrameVertices_FUN_00477890 ; 0052aa95 | CVector3i * core_dmodel.cpp_CKeyFramedModel_getFrameVertices_FUN_00477890(CKeyFramedModel * this_ptr, int frame_index)
    ...
    PUSH ESI                            ; 0052aaa7
    CALL core_morph.cpp_CMorphModel_animate_FUN_0052a920 ; 0052aaa8 | void core_morph.cpp_CMorphModel_animate_FUN_0052a920(CMorphModel * this_ptr)
