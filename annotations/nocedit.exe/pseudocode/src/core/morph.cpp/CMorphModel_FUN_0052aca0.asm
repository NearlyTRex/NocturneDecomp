...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_morph_cpp_CMorphModel_FUN_0052aca0(CMorphModel *this_ptr)
;
; Parameters:
...
;
; XREF[1]:
;   core_morph.cpp_CMorphModel_FUN_0052a710 at 0052a85d
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0052aca0
        ;   Label: core_morph.cpp_CMorphModel_FUN_0052aca0
    PUSH ESI                            ; 0052aca1
    PUSH EDI                            ; 0052aca2
    PUSH EBP                            ; 0052aca3
