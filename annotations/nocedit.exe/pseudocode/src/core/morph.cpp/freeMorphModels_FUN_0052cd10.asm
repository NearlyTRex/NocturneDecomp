...
section .text
    ...
    PUSH 0x661b60                       ; 0052cd10 | WatcomTypeInfo g_CMorphModelTypeInfo
        ;   Label: core_morph.cpp_freeMorphModels_FUN_0052cd10
    PUSH 0x2                            ; 0052cd15
    MOV EDX,dword ptr [ESP + 0xc]       ; 0052cd17
    PUSH EDX                            ; 0052cd1b
    CALL crt_memory.c_freeTypeArray_FUN_005feee9 ; 0052cd1c | int crt_memory.c_freeTypeArray_FUN_005feee9(void * * obj_array, int obj_count, WatcomTypeInfo * type_info)
