...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_morph.cpp_CMorphModel_findOrAddTexture_FUN_0052ae60(CMorphModel * this_ptr, char * filename)
;
; Parameters:
...
section .text
    ...
    JLE 0x0052ae95                      ; 0052ae73 | LAB_0052ae95
        ;   XREF to: 0052ae95 (CONDITIONAL_JUMP)
    LEA EDI,[EBX + 0x70]                ; 0052ae75
    PUSH EBP                            ; 0052ae78
        ;   Label: LAB_0052ae78
    PUSH EDI                            ; 0052ae79
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 0052ae7a | int crt_string.c_stricmp_FUN_005fe7f0(char * str1, char * str2)
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0052ae7f
    TEST EAX,EAX                        ; 0052ae82
    JZ 0x0052af1c                       ; 0052ae84 | LAB_0052af1c
        ;   XREF to: 0052af1c (CONDITIONAL_JUMP)
    INC ESI                             ; 0052ae8a
    MOV ECX,dword ptr [EBX + 0x64]      ; 0052ae8b
    ADD EDI,0x48                        ; 0052ae8e
    CMP ESI,ECX                         ; 0052ae91
    JL 0x0052ae78                       ; 0052ae93 | LAB_0052ae78
        ;   XREF to: 0052ae78 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x64],0x14     ; 0052ae95
        ;   Label: LAB_0052ae95
    JL 0x0052aebd                       ; 0052ae99 | LAB_0052aebd
        ;   XREF to: 0052aebd (CONDITIONAL_JUMP)
    MOV EDI,0x63a3a7                    ; 0052ae9b | = "..\\core\\morph.cpp" | s_core_morph_cpp_0063a3a7 = ..\core\morph.cpp
    MOV EAX,0x1d0                       ; 0052aea0
    PUSH 0x63a3b9                       ; 0052aea5 | = "CMorphModel::findOrAddTexture - too m..." | s_CMorphModel_findOrAddTex_0063a3b9 = CMorphModel::findOrAddTexture - too many textures!
    MOV dword ptr [0x02f0ca48],EDI      ; 0052aeaa | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 0052aeb0 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0052aeb5 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    PUSH EAX                            ; 0052aed5
    CALL crt_memory.c_memset_FUN_005fde40 ; 0052aed6 | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
    ...
    CMP AL,0x0                          ; 0052aef9
    JZ 0x0052af0d                       ; 0052aefb | LAB_0052af0d
    ...
    CMP AL,0x0                          ; 0052af09
    JNZ 0x0052aef5                      ; 0052af0b | LAB_0052aef5
