...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_morph_cpp_CMorphModel_findOrAddTexture_FUN_0052ae60(CMorphModel *this_ptr,char *filename)
;
; Parameters:
...
section .text
    ...
    PUSH EBP                            ; 0052ae78
        ;   Label: LAB_0052ae78
    PUSH EDI                            ; 0052ae79
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 0052ae7a
