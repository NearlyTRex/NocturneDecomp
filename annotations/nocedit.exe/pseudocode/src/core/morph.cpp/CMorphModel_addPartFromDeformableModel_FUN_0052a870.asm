...
;
; XREF[2]:
;   core_morph.cpp_CMorph_addPartFromDeformableModel_FUN_0052b550 at 0052b571
;   core_morph.cpp_CMorph_setupModelFromDeformable_FUN_0052b430 at 0052b45b
;
; Called Functions:
;   core_morph.cpp_CMorphModel_addPartFromVertexBuffer_FUN_0052a710
...
section .text
    ...
    PUSH EBX                            ; 0052a870
        ;   Label: core_morph.cpp_CMorphModel_addPartFromDeformableModel_FUN_0052a870
    PUSH ESI                            ; 0052a871
    PUSH EDI                            ; 0052a872
    PUSH EBP                            ; 0052a873
    ...
    PUSH ECX                            ; 0052a8be
    CALL core_morph.cpp_CMorphModel_addPartFromVertexBuffer_FUN_0052a710 ; 0052a8bf
        ;   XREF to: 0052a710 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_CMorphModel_addPartFromVertexBuffer_FUN_0052a710(CMorphModel * this_ptr, int vertex_count, CVector3i * skinned_vertices, int tri_count, ...)
