...
; float[3]         Stack[-0xa4]:12  local_a4
...
; CMorph *         Stack[-0x38]:4  local_38
; CMorph *         Stack[-0x34]:4  local_34
; CMorph *         Stack[-0x30]:4  local_30
; int              Stack[-0x2c]:4  local_2c
; int              Stack[-0x28]:4  local_28
; CBoundingBox3D * Stack[-0x24]:4  local_24
; CVector3f *      Stack[-0x20]:4  local_20
; float *          Stack[-0x1c]:4  local_1c
; CMorph *         Stack[-0x18]:4  local_18
; CMorph *         Stack[-0x14]:4  local_14
;
; XREF[8]:
