...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_morph_cpp_CMorphModel_FUN_0052b330(CMorphModel *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 0052b334
    CALL core_morph.cpp_CMorphModel_FUN_0052b350 ; 0052b335
    ...
    PUSH ECX                            ; 0052b343
    CALL core_morph.cpp_freeMorphModels_FUN_0052cd10 ; 0052b344
        ;   XREF to: 0052cd10 (UNCONDITIONAL_CALL)  ; CMorphModel * core_morph.cpp_freeMorphModels_FUN_0052cd10(CMorphModel * objs)
