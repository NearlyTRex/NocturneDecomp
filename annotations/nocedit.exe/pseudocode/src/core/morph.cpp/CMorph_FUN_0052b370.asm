...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_morph_cpp_CMorph_FUN_0052b370(CMorph *this_ptr,int model_index)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0052b370
        ;   Label: core_morph.cpp_CMorph_FUN_0052b370
    PUSH ESI                            ; 0052b371
    PUSH EDI                            ; 0052b372
    PUSH EBP                            ; 0052b373
    ...
    PUSH EAX                            ; 0052b3b7
    PUSH EBX                            ; 0052b3b8
    CALL core_morph.cpp_CMorphModel_addPart_FUN_0052a580 ; 0052b3b9
