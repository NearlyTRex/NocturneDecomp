...
;
; XREF[1]:
;   core_morph.cpp_CMorphModel_addPartFromDeformableModel_FUN_0052a870 at 0052a8bf
;
; Referenced Globals:
...
;   core_morph.cpp_CMorphModel_setFaceListFromTriangles_FUN_0052aca0
...
section .text
    ...
    PUSH EBX                            ; 0052a710
        ;   Label: core_morph.cpp_CMorphModel_addPartFromVertexBuffer_FUN_0052a710
    PUSH ESI                            ; 0052a711
    PUSH EDI                            ; 0052a712
    PUSH EBP                            ; 0052a713
    ...
    PUSH EAX                            ; 0052a7ff
    PUSH EBX                            ; 0052a800
    CALL core_morph.cpp_CMorphModel_animateFromVertexBuffer_FUN_0052a920 ; 0052a801
    ...
    PUSH EAX                            ; 0052a85b
    PUSH EBX                            ; 0052a85c
    CALL core_morph.cpp_CMorphModel_setFaceListFromTriangles_FUN_0052aca0 ; 0052a85d
        ;   XREF to: 0052aca0 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_CMorphModel_setFaceListFromTriangles_FUN_0052aca0(CMorphModel * this_ptr, int part_index, SInputFace * face_data, STextureSet * texture_sets, ...)
