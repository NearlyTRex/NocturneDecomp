...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_morph.cpp_FUN_0052b4b0()
;
;
; Called Functions:
...
section .text
    ...
    PUSH EAX                            ; 0052b4ef
    CALL core_morph.cpp_CMorphModel_addPart_FUN_0052a580 ; 0052b4f0 | void core_morph.cpp_CMorphModel_addPart_FUN_0052a580(CMorphModel * this_ptr)
