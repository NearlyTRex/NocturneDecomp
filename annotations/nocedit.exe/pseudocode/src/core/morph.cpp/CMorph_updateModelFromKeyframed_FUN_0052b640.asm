...
;
; Called Functions:
;   core_morph.cpp_CMorphModel_animateFromKeyframedModel_FUN_0052aa80
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 0052b640
        ;   Label: core_morph.cpp_CMorph_updateModelFromKeyframed_FUN_0052b640
    PUSH ESI                            ; 0052b641
    ...
    PUSH EAX                            ; 0052b66c
    CALL core_morph.cpp_CMorphModel_animateFromKeyframedModel_FUN_0052aa80 ; 0052b66d
        ;   XREF to: 0052aa80 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_CMorphModel_animateFromKeyframedModel_FUN_0052aa80(CMorphModel * this_ptr, int part_index, CKeyFramedModel * model_ptr, int frame_index)
