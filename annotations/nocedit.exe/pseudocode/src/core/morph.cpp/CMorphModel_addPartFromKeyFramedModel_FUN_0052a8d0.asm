...
;
; XREF[2]:
;   core_morph.cpp_CMorph_addPartFromKeyframedModel_FUN_0052b580 at 0052b5a7
;   core_morph.cpp_CMorph_setupModelFromKeyframed_FUN_0052b470 at 0052b4a0
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 0052a8d0
        ;   Label: core_morph.cpp_CMorphModel_addPartFromKeyFramedModel_FUN_0052a8d0
    PUSH EBP                            ; 0052a8d1
    ...
    PUSH ECX                            ; 0052a90d
    CALL core_morph.cpp_CMorphModel_addPartFromPolygon_FUN_0052a580 ; 0052a90e
