...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_morph.cpp_FUN_0052b550()
;
;
; Called Functions:
...
section .text
    ...
    PUSH EAX                            ; 0052b570
    CALL core_morph.cpp_CMorphModel_FUN_0052a870 ; 0052b571 | void core_morph.cpp_CMorphModel_FUN_0052a870(CMorphModel * this_ptr)
