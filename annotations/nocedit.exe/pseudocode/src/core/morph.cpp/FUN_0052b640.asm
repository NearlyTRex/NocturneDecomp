...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_morph.cpp_FUN_0052b640(void)
;
;
; XREF[3]:
...
section .text
    ...
    PUSH EAX                            ; 0052b66c
    CALL core_morph.cpp_FUN_0052aa80    ; 0052b66d
        ;   XREF to: 0052aa80 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_FUN_0052aa80()
