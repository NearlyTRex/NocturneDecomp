...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_morph_cpp_CMorph_FUN_0052b470 (CMorph *this_ptr,int model_index,CKeyFramedModel *model_ptr,int frame_index)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0052b470
        ;   Label: core_morph.cpp_CMorph_FUN_0052b470
