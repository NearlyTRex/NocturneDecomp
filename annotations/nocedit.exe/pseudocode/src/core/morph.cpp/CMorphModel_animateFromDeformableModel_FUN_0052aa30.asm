...
;
; XREF[1]:
;   core_morph.cpp_CMorph_updateModelFromDeformable_FUN_0052b600 at 0052b627
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 0052aa30
        ;   Label: core_morph.cpp_CMorphModel_animateFromDeformableModel_FUN_0052aa30
    PUSH ESI                            ; 0052aa31
    ...
    PUSH ESI                            ; 0052aa70
    CALL core_morph.cpp_CMorphModel_animateFromVertexBuffer_FUN_0052a920 ; 0052aa71
