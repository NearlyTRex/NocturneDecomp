...
section .text
    ...
    PUSH EBX                            ; 0052aa00
        ;   Label: core_morph.cpp_CMorphModel_animateFromPartVertexBuffer_FUN_0052aa00
    PUSH ESI                            ; 0052aa01
    ...
    PUSH ECX                            ; 0052aa1b
    PUSH EDX                            ; 0052aa1c
    CALL core_morph.cpp_CMorphModel_animateFromVertexBuffer_FUN_0052a920 ; 0052aa1d
