...
;                               FUNCTION
; *****************************************************************************
; __cdecl SMorphControlPoint * __cdecl core_morph_cpp_SMorphControlPoint_dtor_FUN_0052cc70(SMorphControlPoint *this_ptr)
;
; Parameters:
...
section .text
    ...
    CALL core_morph.cpp_freeVectors_FUN_0052cc90 ; 0052cc7a
        ;   XREF to: 0052cc90 (UNCONDITIONAL_CALL)  ; CVector3f * core_morph.cpp_freeVectors_FUN_0052cc90(CVector3f * objs)
