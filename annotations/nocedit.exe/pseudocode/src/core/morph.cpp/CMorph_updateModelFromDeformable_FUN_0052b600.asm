...
;
; Called Functions:
;   core_morph.cpp_CMorphModel_animateFromDeformableModel_FUN_0052aa30
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 0052b600
        ;   Label: core_morph.cpp_CMorph_updateModelFromDeformable_FUN_0052b600
    ...
    PUSH EAX                            ; 0052b626
    CALL core_morph.cpp_CMorphModel_animateFromDeformableModel_FUN_0052aa30 ; 0052b627
        ;   XREF to: 0052aa30 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_CMorphModel_animateFromDeformableModel_FUN_0052aa30(CMorphModel * this_ptr, int part_index, CDeformableModelInstance * model_ptr)
