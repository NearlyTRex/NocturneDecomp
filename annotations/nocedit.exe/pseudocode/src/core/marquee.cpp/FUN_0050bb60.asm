...
section .text
    ...
    PUSH EDX                            ; 0050bb66
    CALL core_actor.cpp_CDemonActor_ctor_FUN_004088b0 ; 0050bb67 | CDemonActor * core_actor.cpp_CDemonActor_ctor_FUN_004088b0(CDemonActor * this_ptr)
        ;   XREF to: 004088b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0050bb6c
    ADD EAX,0x1a4                       ; 0050bb6f
    PUSH EAX                            ; 0050bb74
    CALL core_course.cpp_CCourse_ctor_FUN_004424c0 ; 0050bb75 | CCourse * core_course.cpp_CCourse_ctor_FUN_004424c0(CCourse * this_ptr)
        ;   XREF to: 004424c0 (UNCONDITIONAL_CALL)
    LEA EDX,[EAX + 0xfffffe5c]          ; 0050bb7a
    MOV ESI,0x6359b7                    ; 0050bb80 | = "menu1.pth" | s_menu1_pth_006359b7 = menu1.pth
    ADD ESP,0x4                         ; 0050bb85
    MOV dword ptr [EDX + 0x154],0x661044 ; 0050bb88 | CDemonActor_vtable PTR_core_marquee.cpp_FUN_00661044
    LEA EDI,[EDX + 0x158]               ; 0050bb92
    MOV dword ptr [EDX + 0x178],0x41200000 ; 0050bb98
    PUSH EDI                            ; 0050bba2
    MOV AL,byte ptr [ESI]               ; 0050bba3 | = "menu1.pth" | s_menu1_pth_006359b7 = menu1.pth
        ;   Label: LAB_0050bba3
    MOV byte ptr [EDI],AL               ; 0050bba5
    CMP AL,0x0                          ; 0050bba7
    JZ 0x0050bbbb                       ; 0050bba9 | LAB_0050bbbb
        ;   XREF to: 0050bbbb (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0050bbab | s_enu1.pth_006359b8
    ADD ESI,0x2                         ; 0050bbae
    MOV byte ptr [EDI + 0x1],AL         ; 0050bbb1
    ADD EDI,0x2                         ; 0050bbb4
    CMP AL,0x0                          ; 0050bbb7
    JNZ 0x0050bba3                      ; 0050bbb9 | LAB_0050bba3
