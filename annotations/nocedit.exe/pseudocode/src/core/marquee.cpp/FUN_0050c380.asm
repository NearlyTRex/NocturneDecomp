...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_marquee.cpp_FUN_0050c380()
;
;
; *****************************************************************************
...
section .text
    ...
    JNZ 0x0050c3c1                      ; 0050c3bd | LAB_0050c3c1
        ;   XREF to: 0050c3c1 (CONDITIONAL_JUMP)
    POP EBX                             ; 0050c3bf
    RET                                 ; 0050c3c0
