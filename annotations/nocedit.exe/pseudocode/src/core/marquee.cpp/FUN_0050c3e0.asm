...
section .text
    ...
    PUSH ESI                            ; 0050c3ea
    PUSH EBX                            ; 0050c3eb
    CALL core_actor.cpp_CDemonActor_getPropertyList_FUN_0040d290 ; 0050c3ec | void core_actor.cpp_CDemonActor_getPropertyList_FUN_0040d290(CDemonActor * this_ptr, CActorPropertyList * property_list)
    ...
    PUSH EAX                            ; 0050c3fe
    PUSH 0x6359e7                       ; 0050c3ff | = "courseName" | s_courseName_006359e7 = courseName
    PUSH ESI                            ; 0050c404
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e290 ; 0050c405 | void core_actor.cpp_CActorPropertyList_FUN_0040e290(CActorPropertyList * this_ptr)
        ;   XREF to: 0040e290 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0050c40a
    PUSH 0x0                            ; 0050c40d
    LEA EAX,[EBX + 0x178]               ; 0050c40f
    PUSH EAX                            ; 0050c415
    PUSH 0x6359f2                       ; 0050c416 | = "totalTime" | s_totalTime_006359f2 = totalTime
    PUSH ESI                            ; 0050c41b
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e160 ; 0050c41c | void core_actor.cpp_CActorPropertyList_FUN_0040e160(CActorPropertyList * this_ptr)
        ;   XREF to: 0040e160 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0050c421
    LEA EAX,[EBX + 0x1a0]               ; 0050c424
    PUSH EAX                            ; 0050c42a
    PUSH 0x67d13c                       ; 0050c42b | void * PTR_s_Ring_0067d13c
    PUSH 0x2                            ; 0050c430
    PUSH 0x635a09                       ; 0050c432 | = "Display type" | s_Display_type_00635a09 = Display type
    PUSH ESI                            ; 0050c437
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e640 ; 0050c438 | void core_actor.cpp_CActorPropertyList_FUN_0040e640(CActorPropertyList * this_ptr)
        ;   XREF to: 0040e640 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [EBX + 0x1a0]     ; 0050c43d
    ADD ESP,0x14                        ; 0050c443
    TEST EDX,EDX                        ; 0050c446
    JZ 0x0050c459                       ; 0050c448 | LAB_0050c459
    ...
    PUSH EAX                            ; 0050c460
    PUSH 0x635a16                       ; 0050c461 | = "phase" | s_phase_00635a16 = phase
    PUSH ESI                            ; 0050c466
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e1e0 ; 0050c467 | void core_actor.cpp_CActorPropertyList_FUN_0040e1e0(CActorPropertyList * this_ptr)
