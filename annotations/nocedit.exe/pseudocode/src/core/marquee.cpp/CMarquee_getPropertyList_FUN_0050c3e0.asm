...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_marquee_cpp_CMarquee_getPropertyList_FUN_0050c3e0(CMarquee *this_ptr,CActorPropertyList *property_list)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0050c3e0
        ;   Label: core_marquee.cpp_CMarquee_getPropertyList_FUN_0050c3e0
    PUSH ESI                            ; 0050c3e1
