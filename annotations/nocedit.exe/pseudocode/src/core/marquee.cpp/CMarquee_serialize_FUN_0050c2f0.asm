...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_marquee_cpp_CMarquee_serialize_FUN_0050c2f0(CMarquee *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0050c2f0
        ;   Label: core_marquee.cpp_CMarquee_serialize_FUN_0050c2f0
    MOV EBX,dword ptr [ESP + 0x8]       ; 0050c2f1
    PUSH EBX                            ; 0050c2f5
    CALL core_actor.cpp_CDemonActor_serialize_FUN_0040c1c0 ; 0050c2f6
    ...
    PUSH EAX                            ; 0050c309
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 0050c30a
    ...
    PUSH EAX                            ; 0050c31d
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 0050c31e
    ...
    PUSH EAX                            ; 0050c331
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 0050c332
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ADD ESP,0x8                         ; 0050c337
    PUSH 0x6359dc                       ; 0050c33a | = "phase"
    LEA EAX,[EBX + 0x180]               ; 0050c33f
    PUSH EAX                            ; 0050c345
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 0050c346
    ...
    PUSH EBX                            ; 0050c359
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 0050c35a
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
