...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_marquee_cpp_CMarquee_addFilesToExtract_FUN_0050c480(CMarquee *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0050c480
        ;   Label: core_marquee.cpp_CMarquee_addFilesToExtract_FUN_0050c480
    MOV EDX,dword ptr [ESP + 0xc]       ; 0050c481
    PUSH EDX                            ; 0050c485
    MOV ECX,dword ptr [ESP + 0xc]       ; 0050c486
    PUSH ECX                            ; 0050c48a
    CALL core_actor.cpp_CDemonActor_addFilesToExtract_FUN_0040cfd0 ; 0050c48b
