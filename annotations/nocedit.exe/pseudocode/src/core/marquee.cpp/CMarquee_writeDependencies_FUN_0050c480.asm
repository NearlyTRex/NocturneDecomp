...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_marquee_cpp_CMarquee_writeDependencies_FUN_0050c480(CMarquee *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0050c480
        ;   Label: core_marquee.cpp_CMarquee_writeDependencies_FUN_0050c480
