...
;                               FUNCTION
; *****************************************************************************
; __cdecl CMarquee * __cdecl core_marquee_cpp_CMarquee_ctor_FUN_0050bb60(CMarquee *this_ptr)
;
; Parameters:
; CMarquee *       Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_marquee.cpp_factoryFunc_FUN_0050bb20 at 0050bb3a
;
; Referenced Globals:
...
section .text
    ...
    PUSH ESI                            ; 0050bb60
        ;   Label: core_marquee.cpp_CMarquee_ctor_FUN_0050bb60
    PUSH EDI                            ; 0050bb61
    ...
    MOV dword ptr [EDX + 0x154],0x661044 ; 0050bb88 | g_CMarqueeVTable
