...
;
; XREF[1]:
;   core_setcolid.cpp_CDemonSet_transferVoxelShadow_FUN_005744d0 at 0057452a
;
; Referenced Globals:
...
;   core_dtrace.cpp_CDemonRaytrace_restoreShadowBitFromBuffer_FUN_0049a280
...
section .text
    ...
    PUSH EBX                            ; 00499f10
        ;   Label: core_dtrace.cpp_CDemonRaytrace_transferShadowVoxels_FUN_00499f10
    PUSH ESI                            ; 00499f11
    PUSH EDI                            ; 00499f12
    PUSH EBP                            ; 00499f13
    ...
    PUSH EAX                            ; 0049a115
    CALL core_dtrace.cpp_CDemonRaytrace_restoreShadowBitFromBuffer_FUN_0049a280 ; 0049a116
        ;   XREF to: 0049a280 (UNCONDITIONAL_CALL)  ; void core_dtrace.cpp_CDemonRaytrace_restoreShadowBitFromBuffer_FUN_0049a280(CDemonRaytrace * this_ptr, CVector3f * world_position)
