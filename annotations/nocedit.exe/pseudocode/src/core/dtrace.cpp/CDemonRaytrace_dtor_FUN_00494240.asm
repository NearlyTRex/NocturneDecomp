...
section .text
    ...
    PUSH EBX                            ; 00494245
    CALL core_dtrace.cpp_CDemonRaytrace_freeCubeList_FUN_004942d0 ; 00494246 | void core_dtrace.cpp_CDemonRaytrace_freeCubeList_FUN_004942d0(CDemonRaytrace * this_ptr)
        ;   XREF to: 004942d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0049424b
    PUSH EBX                            ; 0049424e
    CALL core_dtrace.cpp_CDemonRaytrace_freeTriList_FUN_00494690 ; 0049424f | void core_dtrace.cpp_CDemonRaytrace_freeTriList_FUN_00494690(CDemonRaytrace * this_ptr)
        ;   XREF to: 00494690 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00494254
    PUSH EBX                            ; 00494257
    CALL core_dtrace.cpp_CDemonRaytrace_freeNewCubeList_FUN_00494400 ; 00494258 | void core_dtrace.cpp_CDemonRaytrace_freeNewCubeList_FUN_00494400(CDemonRaytrace * this_ptr)
