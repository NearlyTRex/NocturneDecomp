...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dtrace.cpp_CDemonRaytrace_setVoxelShadowBit_FUN_0049a160(CDemonRaytrace * this_ptr, CVector3f * world_position)
;
; Parameters:
...
section .text
    ...
    CALL core_dtrace.cpp_CDemonRaytrace_worldPositionToGridCoords_FUN_004997d0 ; 0049a179 | void core_dtrace.cpp_CDemonRaytrace_worldPositionToGridCoords_FUN_004997d0(CDemonRaytrace * this_ptr, CVector3f * world_position, CVector3i * output_grid_coords)
    ...
    CALL core_dtrace.cpp_CDemonRaytrace_worldPositionToVoxelCoords_FUN_00499880 ; 0049a1c4 | void core_dtrace.cpp_CDemonRaytrace_worldPositionToVoxelCoords_FUN_00499880(CDemonRaytrace * this_ptr, CVector3f * world_position, CVector3i * output_voxel_coords)
    ...
    CALL core_dtrace.cpp_CDemonRaytrace_getCubeAt_FUN_004952b0 ; 0049a215 | CDemonCube * core_dtrace.cpp_CDemonRaytrace_getCubeAt_FUN_004952b0(CDemonRaytrace * this_ptr, int grid_x, int grid_y, int grid_z)
        ;   XREF to: 004952b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0049a21a
    MOV EBX,EAX                         ; 0049a21d
    TEST EAX,EAX                        ; 0049a21f
    JNZ 0x0049a246                      ; 0049a221 | LAB_0049a246
        ;   XREF to: 0049a246 (CONDITIONAL_JUMP)
    MOV EDX,0x622d7a                    ; 0049a223 | = "..\\core\\dtrace.cpp" | s_core_dtrace_cpp_00622d7a = ..\core\dtrace.cpp
    MOV ECX,0xb19                       ; 0049a228
    PUSH 0x622d8d                       ; 0049a22d | = "Parity Check 999" | s_Parity_Check_999_00622d8d = Parity Check 999
    MOV dword ptr [0x02f0ca48],EDX      ; 0049a232 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 0049a238 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0049a23e | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0049a243
    CMP dword ptr [EBX],0x0             ; 0049a246
        ;   Label: LAB_0049a246
    JNZ 0x0049a254                      ; 0049a249 | LAB_0049a254
        ;   XREF to: 0049a254 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 0049a24b
    CALL core_dcube.cpp_CDemonCube_allocVoxelMemory_FUN_004567b0 ; 0049a24c | void core_dcube.cpp_CDemonCube_allocVoxelMemory_FUN_004567b0(CDemonCube * this_ptr)
    ...
    MOV BL,byte ptr [EBX + 0x6789f8]    ; 0049a26b | uchar[8] g_VoxelYBitMasks
    OR DL,BL                            ; 0049a271
