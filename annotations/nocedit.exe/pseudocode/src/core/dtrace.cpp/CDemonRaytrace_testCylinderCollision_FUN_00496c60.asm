...
section .text
    ...
    PUSH EBX                            ; 00496c60
        ;   Label: core_dtrace.cpp_CDemonRaytrace_testCylinderCollision_FUN_00496c60
    PUSH ESI                            ; 00496c61
    PUSH EDI                            ; 00496c62
    PUSH EBP                            ; 00496c63
    ...
    PUSH EBP                            ; 00496dd8
    PUSH EAX                            ; 00496dd9
    CALL core_dcube.cpp_CDemonCube_testCylinderCollision_FUN_00457a90 ; 00496dda
        ;   XREF to: 00457a90 (UNCONDITIONAL_CALL)  ; void core_dcube.cpp_CDemonCube_testCylinderCollision_FUN_00457a90(CDemonCube * this_ptr, SIntersectXZCylinder * cylinder)
