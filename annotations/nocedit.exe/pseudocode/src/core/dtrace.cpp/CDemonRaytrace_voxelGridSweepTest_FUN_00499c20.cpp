        ...
        do {
          ...
          if (0 < local_24) {
            do {
              fVar2 = (float)0.5;
              local_50._8_4_ =
                   (float)pCVar3 * fVar2 + (float)local_28 * (float)pCVar3 + end_position->x;
              local_44 = fVar10 * fVar2 + (float)local_20 * fVar10 + end_position->y;
              local_40 = (float)iVar4 * (local_58 / fVar1) + end_position->z +
              ...
              core_dtrace_cpp_CDemonRaytrace_setVoxelShadowBit_FUN_0049a160(this_ptr,pCVar3);
              iVar4 = iVar4 + 1;
