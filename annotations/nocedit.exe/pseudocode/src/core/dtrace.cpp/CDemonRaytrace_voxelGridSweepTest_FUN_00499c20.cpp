      ...
      if (0 < local_24) {
        do {
          ...
          if (0 < local_1c) {
            do {
              fVar2 = (float)0.5;
              local_40.x = (float)fVar8 * fVar2 + (float)local_20 * (float)fVar8 + end_position->x;
              local_40.y = (float)fVar5 * fVar2 + (float)local_18 * (float)fVar5 + end_position->y;
              local_40.z = (float)iVar4 * fVar1 + end_position->z + fVar1 * fVar2;
              local_14 = iVar4;
