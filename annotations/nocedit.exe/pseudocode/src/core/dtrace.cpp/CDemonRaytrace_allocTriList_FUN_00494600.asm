...
section .text
    ...
    PUSH 0x6226c0                       ; 0049461d | = "..\\core\\dtrace.cpp" | s_core_dtrace_cpp_006226c0 = ..\core\dtrace.cpp
    ADD EAX,0x4                         ; 00494622
    PUSH EAX                            ; 00494625
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1f0 ; 00494626 | void * shape_memdbg.cpp_debugAlloc_FUN_0050f1f0(int size, char * filename, int line_number)
        ;   XREF to: 0050f1f0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0049462b
    TEST EAX,EAX                        ; 0049462e
    JNZ 0x0049465d                      ; 00494630 | LAB_0049465d
        ;   XREF to: 0049465d (CONDITIONAL_JUMP)
    PUSH 0xf8                           ; 00494632
        ;   Label: LAB_00494632
    PUSH 0x6226d3                       ; 00494637 | = "..\\core\\dtrace.cpp" | s_core_dtrace_cpp_006226d3 = ..\core\dtrace.cpp
    MOV EDX,dword ptr [EBX + 0x4]       ; 0049463c
    PUSH EDX                            ; 0049463f
    MOV dword ptr [EBX + 0x8],EAX       ; 00494640
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1f0 ; 00494643 | void * shape_memdbg.cpp_debugAlloc_FUN_0050f1f0(int size, char * filename, int line_number)
        ;   XREF to: 0050f1f0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00494648
    MOV ECX,dword ptr [EBX + 0x8]       ; 0049464b
    MOV dword ptr [EBX + 0xc],EAX       ; 0049464e
    TEST ECX,ECX                        ; 00494651
    JZ 0x00494665                       ; 00494653 | LAB_00494665
        ;   XREF to: 00494665 (CONDITIONAL_JUMP)
    TEST EAX,EAX                        ; 00494655
    JZ 0x00494665                       ; 00494657 | LAB_00494665
        ;   XREF to: 00494665 (CONDITIONAL_JUMP)
    POP EBP                             ; 00494659
    POP ESI                             ; 0049465a
    POP EBX                             ; 0049465b
    ...
    JMP 0x00494632                      ; 00494663 | LAB_00494632
        ;   XREF to: 00494632 (UNCONDITIONAL_JUMP)
    PUSH EDI                            ; 00494665
        ;   Label: LAB_00494665
    MOV EDI,0x6226e6                    ; 00494666 | = "..\\core\\dtrace.cpp" | s_core_dtrace_cpp_006226e6 = ..\core\dtrace.cpp
    MOV EBP,0xf9                        ; 0049466b
    PUSH 0x6226f9                       ; 00494670 | = "CDemonRaytrace::allocTriList - Out of..." | s_CDemonRaytrace_allocTriL_006226f9 = CDemonRaytrace::allocTriList - Out of memory!
    MOV dword ptr [0x02f0ca48],EDI      ; 00494675 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBP      ; 0049467b | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00494681 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
