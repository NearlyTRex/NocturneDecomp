...
;                               FUNCTION
; *****************************************************************************
; __cdecl float core_dtrace.cpp_CDemonRaytrace_cylinderGroundCheck_FUN_00496950(CDemonRaytrace * this_ptr, CVector3f * pos, float radius, int * hit_flag, CVector3f * normal_out)
;
; Parameters:
...
section .text
    ...
    FADD float ptr [0x00622b72]         ; 00496986 | float FLOAT_00622b72
    FLD float ptr [ESP + 0x4]           ; 0049698c
    MOV EAX,dword ptr [EDX]             ; 00496990
    FXCH                                ; 00496992
    FST float ptr [ESP + 0x1c]          ; 00496994
    FXCH                                ; 00496998
    FADD float ptr [0x00622b76]         ; 0049699a | float FLOAT_00622b76
    ...
    FXCH ST4                            ; 00496a1e
    CALL crt_math.c_round_FUN_005fe6b0  ; 00496a20 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH ST3                            ; 00496a25
    CALL crt_math.c_round_FUN_005fe6b0  ; 00496a27 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH ST3                            ; 00496a2c
    ...
    FXCH ST3                            ; 00496a44
    CALL crt_math.c_round_FUN_005fe6b0  ; 00496a46 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH                                ; 00496a4b
    CALL crt_math.c_round_FUN_005fe6b0  ; 00496a4d | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH ST3                            ; 00496a52
    CALL crt_math.c_round_FUN_005fe6b0  ; 00496a54 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH ST2                            ; 00496a59
    CALL crt_math.c_round_FUN_005fe6b0  ; 00496a5b | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH                                ; 00496a60
    ...
    JL 0x00496b43                       ; 00496a76 | LAB_00496b43
    ...
    JG 0x00496ae4                       ; 00496a86 | LAB_00496ae4
    ...
    JG 0x00496adb                       ; 00496a92 | LAB_00496adb
    ...
    PUSH ESI                            ; 00496a9a
    PUSH EBP                            ; 00496a9b
    CALL core_dtrace.cpp_CDemonRaytrace_getCubeAt_FUN_004952b0 ; 00496a9c | CDemonCube * core_dtrace.cpp_CDemonRaytrace_getCubeAt_FUN_004952b0(CDemonRaytrace * this_ptr, int grid_x, int grid_y, int grid_z)
        ;   XREF to: 004952b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00496aa1
    TEST EAX,EAX                        ; 00496aa4
    JZ 0x00496ad2                       ; 00496aa6 | LAB_00496ad2
    ...
    PUSH EDX                            ; 00496abf
    PUSH EAX                            ; 00496ac0
    CALL core_dcube.cpp_CDemonCube_testCylinderGroundCollision_FUN_00457b60 ; 00496ac1 | int core_dcube.cpp_CDemonCube_testCylinderGroundCollision_FUN_00457b60(CDemonCube * this_ptr, CVector3f * cylinder_position, float cylinder_radius, CVector3f * output_height, ...)
        ;   XREF to: 00457b60 (UNCONDITIONAL_CALL)
    ADD ESP,0x18                        ; 00496ac6
    TEST EAX,EAX                        ; 00496ac9
    JZ 0x00496ad2                       ; 00496acb | LAB_00496ad2
        ;   XREF to: 00496ad2 (CONDITIONAL_JUMP)
    ...
    JZ 0x00496b1a                       ; 00496b12 | LAB_00496b1a
