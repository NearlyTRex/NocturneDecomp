...
section .text
    ...
    PUSH EDI                            ; 00497567
    PUSH ESI                            ; 00497568
    CALL core_dtrace.cpp_CDemonRaytrace_getCubeAt_FUN_004952b0 ; 00497569 | CDemonCube * core_dtrace.cpp_CDemonRaytrace_getCubeAt_FUN_004952b0(CDemonRaytrace * this_ptr, int grid_x, int grid_y, int grid_z)
        ;   XREF to: 004952b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0049756e
    MOV dword ptr [ESP + 0xa0],EAX      ; 00497571
    TEST EAX,EAX                        ; 00497578
    JZ 0x0049755a                       ; 0049757a | LAB_0049755a
        ;   XREF to: 0049755a (CONDITIONAL_JUMP)
    CMP dword ptr [EAX],0x0             ; 0049757c
    JZ 0x0049755a                       ; 0049757f | LAB_0049755a
        ;   XREF to: 0049755a (CONDITIONAL_JUMP)
    ...
    MOV ECX,dword ptr [0x02ca0398]      ; 004975f4 | int g_CubesWithVoxelsCount
    MOV EDX,dword ptr [0x006703e8]      ; 004975fa | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    INC ECX                             ; 00497600
    LEA EAX,[ESP + 0x28]                ; 00497601
    FADD float ptr [ESI + 0x18]         ; 00497605
    MOV dword ptr [0x02ca0398],ECX      ; 00497608 | int g_CubesWithVoxelsCount
    FSTP float ptr [ESP + 0x30]         ; 0049760e
    FLD float ptr [EAX]                 ; 00497612
    FMUL float ptr [0x0065d270]         ; 00497614 | float g_RaytraceWorldToScreenScale
    FISTP dword ptr [EBX]               ; 0049761a
    FLD float ptr [EAX + 0x4]           ; 0049761c
    FMUL float ptr [0x0065d270]         ; 0049761f | float g_RaytraceWorldToScreenScale
    FISTP dword ptr [EBX + 0x4]         ; 00497625
    FLD float ptr [EAX + 0x8]           ; 00497628
    FMUL float ptr [0x0065d270]         ; 0049762b | float g_RaytraceWorldToScreenScale
    FISTP dword ptr [EBX + 0x8]         ; 00497631
    LEA EAX,[ESP + 0x70]                ; 00497634
    PUSH EAX                            ; 00497638
    MOV EAX,dword ptr [EDX]             ; 00497639 | CDemonRenderer g_CDemonRendererInstance
    PUSH EAX                            ; 0049763b
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 0049763c | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    MOV EDX,dword ptr [0x006703e8]      ; 00497689 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    FADD float ptr [ESI + 0x18]         ; 0049768f
    LEA EAX,[ESP + 0x28]                ; 00497692
    FSTP float ptr [ESP + 0x30]         ; 00497696
    FLD float ptr [EAX]                 ; 0049769a
    FMUL float ptr [0x0065d270]         ; 0049769c | float g_RaytraceWorldToScreenScale
    FISTP dword ptr [EBX]               ; 004976a2
    FLD float ptr [EAX + 0x4]           ; 004976a4
    FMUL float ptr [0x0065d270]         ; 004976a7 | float g_RaytraceWorldToScreenScale
    FISTP dword ptr [EBX + 0x4]         ; 004976ad
    FLD float ptr [EAX + 0x8]           ; 004976b0
    FMUL float ptr [0x0065d270]         ; 004976b3 | float g_RaytraceWorldToScreenScale
    FISTP dword ptr [EBX + 0x8]         ; 004976b9
    LEA EAX,[ESP + 0x58]                ; 004976bc
    PUSH EAX                            ; 004976c0
    MOV EAX,dword ptr [EDX]             ; 004976c1 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0x30                        ; 004976c3
    PUSH EAX                            ; 004976c6
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 004976c7 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ...
    MOV EDX,dword ptr [0x006703e8]      ; 00497729 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    FLD float ptr [EAX]                 ; 0049772f
    FMUL float ptr [0x0065d270]         ; 00497731 | float g_RaytraceWorldToScreenScale
    FISTP dword ptr [EBX]               ; 00497737
    FLD float ptr [EAX + 0x4]           ; 00497739
    FMUL float ptr [0x0065d270]         ; 0049773c | float g_RaytraceWorldToScreenScale
    FISTP dword ptr [EBX + 0x4]         ; 00497742
    FLD float ptr [EAX + 0x8]           ; 00497745
    FMUL float ptr [0x0065d270]         ; 00497748 | float g_RaytraceWorldToScreenScale
    FISTP dword ptr [EBX + 0x8]         ; 0049774e
    LEA EAX,[ESP + 0x94]                ; 00497751
    PUSH EAX                            ; 00497758
    MOV EAX,dword ptr [EDX]             ; 00497759 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0x60                        ; 0049775b
    PUSH EAX                            ; 0049775e
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 0049775f | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ...
    MOV EDX,dword ptr [0x006703e8]      ; 004977a2 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    FSTP float ptr [ESP + 0x30]         ; 004977a8
    FLD float ptr [EAX]                 ; 004977ac
    FMUL float ptr [0x0065d270]         ; 004977ae | float g_RaytraceWorldToScreenScale
    FISTP dword ptr [EBX]               ; 004977b4
    FLD float ptr [EAX + 0x4]           ; 004977b6
    FMUL float ptr [0x0065d270]         ; 004977b9 | float g_RaytraceWorldToScreenScale
    FISTP dword ptr [EBX + 0x4]         ; 004977bf
    FLD float ptr [EAX + 0x8]           ; 004977c2
    FMUL float ptr [0x0065d270]         ; 004977c5 | float g_RaytraceWorldToScreenScale
    FISTP dword ptr [EBX + 0x8]         ; 004977cb
    LEA EAX,[ESP + 0x7c]                ; 004977ce
    PUSH EAX                            ; 004977d2
    MOV EAX,dword ptr [EDX]             ; 004977d3 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0x90                        ; 004977d5
    PUSH EAX                            ; 004977da
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 004977db | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ...
    MOV EDX,dword ptr [0x006703e8]      ; 0049782d | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    FADD float ptr [ESI + 0x18]         ; 00497833
    LEA EAX,[ESP + 0x28]                ; 00497836
    FSTP float ptr [ESP + 0x30]         ; 0049783a
    FLD float ptr [EAX]                 ; 0049783e
    FMUL float ptr [0x0065d270]         ; 00497840 | float g_RaytraceWorldToScreenScale
    FISTP dword ptr [EBX]               ; 00497846
    FLD float ptr [EAX + 0x4]           ; 00497848
    FMUL float ptr [0x0065d270]         ; 0049784b | float g_RaytraceWorldToScreenScale
    FISTP dword ptr [EBX + 0x4]         ; 00497851
    FLD float ptr [EAX + 0x8]           ; 00497854
    FMUL float ptr [0x0065d270]         ; 00497857 | float g_RaytraceWorldToScreenScale
    FISTP dword ptr [EBX + 0x8]         ; 0049785d
    LEA EAX,[ESP + 0x34]                ; 00497860
    PUSH EAX                            ; 00497864
    MOV EAX,dword ptr [EDX]             ; 00497865 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0xc0                        ; 00497867
    PUSH EAX                            ; 0049786c
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 0049786d | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ...
    MOV EDX,dword ptr [0x006703e8]      ; 004978b0 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    FSTP float ptr [ESP + 0x30]         ; 004978b6
    FLD float ptr [EAX]                 ; 004978ba
    FMUL float ptr [0x0065d270]         ; 004978bc | float g_RaytraceWorldToScreenScale
    FISTP dword ptr [EBX]               ; 004978c2
    FLD float ptr [EAX + 0x4]           ; 004978c4
    FMUL float ptr [0x0065d270]         ; 004978c7 | float g_RaytraceWorldToScreenScale
    FISTP dword ptr [EBX + 0x4]         ; 004978cd
    FLD float ptr [EAX + 0x8]           ; 004978d0
    FMUL float ptr [0x0065d270]         ; 004978d3 | float g_RaytraceWorldToScreenScale
    FISTP dword ptr [EBX + 0x8]         ; 004978d9
    LEA EAX,[ESP + 0x40]                ; 004978dc
    PUSH EAX                            ; 004978e0
    MOV EAX,dword ptr [EDX]             ; 004978e1 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0xf0                        ; 004978e3
    PUSH EAX                            ; 004978e8
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 004978e9 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ...
    MOV EDX,dword ptr [0x006703e8]      ; 0049792c | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    FSTP float ptr [ESP + 0x30]         ; 00497932
    FLD float ptr [EAX]                 ; 00497936
    FMUL float ptr [0x0065d270]         ; 00497938 | float g_RaytraceWorldToScreenScale
    FISTP dword ptr [EBX]               ; 0049793e
    FLD float ptr [EAX + 0x4]           ; 00497940
    FMUL float ptr [0x0065d270]         ; 00497943 | float g_RaytraceWorldToScreenScale
    FISTP dword ptr [EBX + 0x4]         ; 00497949
    FLD float ptr [EAX + 0x8]           ; 0049794c
    FMUL float ptr [0x0065d270]         ; 0049794f | float g_RaytraceWorldToScreenScale
    FISTP dword ptr [EBX + 0x8]         ; 00497955
    LEA EAX,[ESP + 0x64]                ; 00497958
    PUSH EAX                            ; 0049795c
    MOV EAX,dword ptr [EDX]             ; 0049795d | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0x120                       ; 0049795f
    PUSH EAX                            ; 00497964
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 00497965 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ...
    MOV EDX,dword ptr [0x006703e8]      ; 004979a8 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    FSTP float ptr [ESP + 0x30]         ; 004979ae
    FLD float ptr [EAX]                 ; 004979b2
    FMUL float ptr [0x0065d270]         ; 004979b4 | float g_RaytraceWorldToScreenScale
    FISTP dword ptr [EBX]               ; 004979ba
    FLD float ptr [EAX + 0x4]           ; 004979bc
    FMUL float ptr [0x0065d270]         ; 004979bf | float g_RaytraceWorldToScreenScale
    FISTP dword ptr [EBX + 0x4]         ; 004979c5
    FLD float ptr [EAX + 0x8]           ; 004979c8
    FMUL float ptr [0x0065d270]         ; 004979cb | float g_RaytraceWorldToScreenScale
    FISTP dword ptr [EBX + 0x8]         ; 004979d1
    LEA EAX,[ESP + 0x4c]                ; 004979d4
    PUSH EAX                            ; 004979d8
    MOV EAX,dword ptr [EDX]             ; 004979d9 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0x150                       ; 004979db
    PUSH EAX                            ; 004979e0
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 004979e1 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ...
    JZ 0x00497a35                       ; 00497a2b | LAB_00497a35
        ;   XREF to: 00497a35 (CONDITIONAL_JUMP)
    TEST AL,0xff                        ; 00497a2d
    JNZ 0x0049755a                      ; 00497a2f | LAB_0049755a
        ;   XREF to: 0049755a (CONDITIONAL_JUMP)
    MOV EAX,[0x02ca039c]                ; 00497a35 | int g_CubesVisibleCount
        ;   Label: LAB_00497a35
    INC EAX                             ; 00497a3a
    MOV EDX,dword ptr [ESP + 0xe8]      ; 00497a3b
    MOV [0x02ca039c],EAX                ; 00497a42 | int g_CubesVisibleCount
    CMP EDX,0x1                         ; 00497a47
    JG 0x00497b8a                       ; 00497a4a | LAB_00497b8a
    ...
    MOV EBX,dword ptr [0x02ca03a0]      ; 00497aa2 | int g_CubesRenderedCount
    MOV EDI,dword ptr [0x006703ec]      ; 00497aa8 | CDemonRenderer * g_CDemonRendererPtr
    INC EBX                             ; 00497aae
    LEA EAX,[ESP + 0x88]                ; 00497aaf
    MOV dword ptr [0x02ca03a0],EBX      ; 00497ab6 | int g_CubesRenderedCount
    PUSH EAX                            ; 00497abc
    FADD float ptr [ESI + 0x18]         ; 00497abd
    PUSH EDI                            ; 00497ac0 | CDemonRenderer g_CDemonRendererInstance
    FSTP float ptr [ESP + 0x98]         ; 00497ac1
    CALL engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450 ; 00497ac8 | void engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450(CDemonRenderer * this_ptr, CVector3f * world_position)
    ...
    PUSH EAX                            ; 00497ada
    CALL core_dcube.cpp_CDemonCube_rotateVertices_FUN_00457650 ; 00497adb | void core_dcube.cpp_CDemonCube_rotateVertices_FUN_00457650(CDemonCube * this_ptr, uint rendering_mode)
        ;   XREF to: 00457650 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00497ae0
    PUSH 0x3f87558                      ; 00497ae3 | CVector3f g_ZeroVector
    MOV EDX,dword ptr [0x006703ec]      ; 00497ae8 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH EDX                            ; 00497aee | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450 ; 00497aef | void engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450(CDemonRenderer * this_ptr, CVector3f * world_position)
        ;   XREF to: 0048c450 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00497af4
    MOV EAX,[0x02ca03a4]                ; 00497af7 | int g_PVSDrawnCubeCount
    MOV EDX,dword ptr [ESP + 0xa0]      ; 00497afc
    MOV EBX,EAX                         ; 00497b03
    MOV dword ptr [EAX*0x4 + 0x2ca03ac],EDX ; 00497b05 | CDemonCube *[20000] g_PVSCubePointers
    SHL EAX,0x2                         ; 00497b0c
    SUB EAX,EBX                         ; 00497b0f
    MOV ESI,0x2cb3c2c                   ; 00497b11 | CVector3f[20000] g_PVSCubePositions
    SHL EAX,0x2                         ; 00497b16
    ADD ESI,EAX                         ; 00497b19
    LEA EAX,[ESP + 0x88]                ; 00497b1b
    CMP ESI,EAX                         ; 00497b22
    JZ 0x00497b43                       ; 00497b24 | LAB_00497b43
        ;   XREF to: 00497b43 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x88]      ; 00497b26
    MOV dword ptr [ESI],EAX             ; 00497b2d | CVector3f[20000] g_PVSCubePositions
    ...
    MOV ECX,dword ptr [0x02ca03a4]      ; 00497b43 | int g_PVSDrawnCubeCount
        ;   Label: LAB_00497b43
    INC ECX                             ; 00497b49
    MOV dword ptr [0x02ca03a4],ECX      ; 00497b4a | int g_PVSDrawnCubeCount
    CMP ECX,0x4e20                      ; 00497b50
    JL 0x0049755a                       ; 00497b56 | LAB_0049755a
        ;   XREF to: 0049755a (CONDITIONAL_JUMP)
    MOV ESI,0x622b86                    ; 00497b5c | = "..\\core\\dtrace.cpp" | s_core_dtrace_cpp_00622b86 = ..\core\dtrace.cpp
    MOV EDI,0x792                       ; 00497b61
    PUSH 0x622b99                       ; 00497b66 | = "Too many drawn cubes.  Need to recomp..." | s_Too_many_drawn_cubes_Nee_00622b99 = Too many drawn cubes.  Need to recompile.
    MOV dword ptr [0x02f0ca48],ESI      ; 00497b6b | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 00497b71 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00497b77 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    FMUL double ptr [0x00622bca]        ; 00497bba | double DOUBLE_00622bca
    ...
    MOV ECX,dword ptr [0x006703e8]      ; 00497bd8 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH EAX                            ; 00497bde
    CALL crt_math.c_round_FUN_005fe6b0  ; 00497bdf | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    PUSH ECX                            ; 00497be4 | CDemonRenderer g_CDemonRendererInstance
    FISTP dword ptr [ESP + 0x1c]        ; 00497be5
    MOV dword ptr [ESP + 0x24],EBX      ; 00497be9
    CALL engine_drender.cpp_CDemonRenderer_renderTexturedBasic_FUN_0048ab50 ; 00497bed | int engine_drender.cpp_CDemonRenderer_renderTexturedBasic_FUN_0048ab50(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * prim)
        ;   XREF to: 0048ab50 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00497bf2
    TEST EAX,EAX                        ; 00497bf5
    JNZ 0x00497a50                      ; 00497bf7 | LAB_00497a50
    ...
    FMUL double ptr [0x00622bd2]        ; 00497c20 | double DOUBLE_00622bd2
    ...
    MOV ECX,dword ptr [0x006703e8]      ; 00497c4c | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH EAX                            ; 00497c52
    CALL crt_math.c_round_FUN_005fe6b0  ; 00497c53 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    PUSH ECX                            ; 00497c58 | CDemonRenderer g_CDemonRendererInstance
    FISTP dword ptr [ESP + 0x1c]        ; 00497c59
    CALL engine_drender.cpp_CDemonRenderer_renderTexturedBasic_FUN_0048ab50 ; 00497c5d | int engine_drender.cpp_CDemonRenderer_renderTexturedBasic_FUN_0048ab50(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * prim)
        ;   XREF to: 0048ab50 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00497c62
    TEST EAX,EAX                        ; 00497c65
    JNZ 0x00497a50                      ; 00497c67 | LAB_00497a50
        ;   XREF to: 00497a50 (CONDITIONAL_JUMP)
    ...
    FMUL double ptr [0x00622bca]        ; 00497c92 | double DOUBLE_00622bca
    MOV EDX,0x3                         ; 00497c98
    MOV ECX,dword ptr [0x006703e8]      ; 00497c9d | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    ...
    PUSH EAX                            ; 00497cbf
    CALL crt_math.c_round_FUN_005fe6b0  ; 00497cc0 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    PUSH ECX                            ; 00497cc5 | CDemonRenderer g_CDemonRendererInstance
    FISTP dword ptr [ESP + 0x1c]        ; 00497cc6
    CALL engine_drender.cpp_CDemonRenderer_renderTexturedBasic_FUN_0048ab50 ; 00497cca | int engine_drender.cpp_CDemonRenderer_renderTexturedBasic_FUN_0048ab50(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * prim)
        ;   XREF to: 0048ab50 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00497ccf
    TEST EAX,EAX                        ; 00497cd2
    JNZ 0x00497a50                      ; 00497cd4 | LAB_00497a50
        ;   XREF to: 00497a50 (CONDITIONAL_JUMP)
    ...
    FMUL double ptr [0x00622bd2]        ; 00497d02 | double DOUBLE_00622bd2
    MOV EDX,0x5                         ; 00497d08
    MOV ECX,dword ptr [0x006703e8]      ; 00497d0d | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    ...
    PUSH EAX                            ; 00497d2b
    CALL crt_math.c_round_FUN_005fe6b0  ; 00497d2c | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    PUSH ECX                            ; 00497d31 | CDemonRenderer g_CDemonRendererInstance
    FISTP dword ptr [ESP + 0x1c]        ; 00497d32
    MOV dword ptr [ESP + 0x24],EBX      ; 00497d36
    CALL engine_drender.cpp_CDemonRenderer_renderTexturedBasic_FUN_0048ab50 ; 00497d3a | int engine_drender.cpp_CDemonRenderer_renderTexturedBasic_FUN_0048ab50(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * prim)
        ;   XREF to: 0048ab50 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00497d3f
    TEST EAX,EAX                        ; 00497d42
    JNZ 0x00497a50                      ; 00497d44 | LAB_00497a50
        ;   XREF to: 00497a50 (CONDITIONAL_JUMP)
    ...
    FMUL double ptr [0x00622bd2]        ; 00497d78 | double DOUBLE_00622bd2
    ...
    MOV ECX,dword ptr [0x006703e8]      ; 00497da4 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH EAX                            ; 00497daa
    CALL crt_math.c_round_FUN_005fe6b0  ; 00497dab | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    PUSH ECX                            ; 00497db0 | CDemonRenderer g_CDemonRendererInstance
    FISTP dword ptr [ESP + 0x1c]        ; 00497db1
    CALL engine_drender.cpp_CDemonRenderer_renderTexturedBasic_FUN_0048ab50 ; 00497db5 | int engine_drender.cpp_CDemonRenderer_renderTexturedBasic_FUN_0048ab50(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * prim)
        ;   XREF to: 0048ab50 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00497dba
    TEST EAX,EAX                        ; 00497dbd
    JNZ 0x00497a50                      ; 00497dbf | LAB_00497a50
        ;   XREF to: 00497a50 (CONDITIONAL_JUMP)
    ...
    FMUL double ptr [0x00622bca]        ; 00497df2 | double DOUBLE_00622bca
    MOV ECX,dword ptr [0x006703e8]      ; 00497df8 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    ...
    PUSH EAX                            ; 00497e1d
    CALL crt_math.c_round_FUN_005fe6b0  ; 00497e1e | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    PUSH ECX                            ; 00497e23 | CDemonRenderer g_CDemonRendererInstance
    FISTP dword ptr [ESP + 0x1c]        ; 00497e24
    MOV dword ptr [ESP + 0x24],EBX      ; 00497e28
    CALL engine_drender.cpp_CDemonRenderer_renderTexturedBasic_FUN_0048ab50 ; 00497e2c | int engine_drender.cpp_CDemonRenderer_renderTexturedBasic_FUN_0048ab50(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * prim)
        ;   XREF to: 0048ab50 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00497e31
    TEST EAX,EAX                        ; 00497e34
    JNZ 0x00497a50                      ; 00497e36 | LAB_00497a50
        ;   XREF to: 00497a50 (CONDITIONAL_JUMP)
