...
;                               FUNCTION
; *****************************************************************************
; __cdecl float core_dtrace.cpp_CDemonRaytrace_rayVoxelIntersection_FUN_00495b70(CDemonRaytrace * this_ptr, CVector3f * ray_start, CVector3f * ray_end, CVector3f * out_intersection_point, int * out_intersection_type)
;
; Parameters:
...
section .text
    ...
    CALL crt_math.c_floor_FUN_005feb90  ; 00495bc9 | double crt_math.c_floor_FUN_005feb90(double input_value)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 00495bdd | double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    CALL crt_math.c_floor_FUN_005feb90  ; 00495bf2 | double crt_math.c_floor_FUN_005feb90(double input_value)
        ;   XREF to: 005feb90 (UNCONDITIONAL_CALL)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 00495c06 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    CALL crt_math.c_floor_FUN_005feb90  ; 00495c1b | double crt_math.c_floor_FUN_005feb90(double input_value)
        ;   XREF to: 005feb90 (UNCONDITIONAL_CALL)
    ...
    FXCH ST3                            ; 00495c4c
    CALL crt_math.c_round_FUN_005fe6b0  ; 00495c4e | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    CALL crt_math.c_floor_FUN_005feb90  ; 00495c6e | double crt_math.c_floor_FUN_005feb90(double input_value)
        ;   XREF to: 005feb90 (UNCONDITIONAL_CALL)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 00495c82 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    CALL crt_math.c_floor_FUN_005feb90  ; 00495c96 | double crt_math.c_floor_FUN_005feb90(double input_value)
        ;   XREF to: 005feb90 (UNCONDITIONAL_CALL)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 00495caa | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    CALL crt_math.c_floor_FUN_005feb90  ; 00495cbf | double crt_math.c_floor_FUN_005feb90(double input_value)
        ;   XREF to: 005feb90 (UNCONDITIONAL_CALL)
    ...
    JL 0x00495d16                       ; 00495d0a | LAB_00495d16
        ;   XREF to: 00495d16 (CONDITIONAL_JUMP)
    CMP EDI,dword ptr [ESP + 0x58]      ; 00495d0c
    JLE 0x00496005                      ; 00495d10 | LAB_00496005
    ...
    JL 0x00495d2e                       ; 00495d22 | LAB_00495d2e
        ;   XREF to: 00495d2e (CONDITIONAL_JUMP)
    CMP EDI,dword ptr [ESP + 0x50]      ; 00495d24
    JLE 0x00496005                      ; 00495d28 | LAB_00496005
        ;   XREF to: 00496005 (CONDITIONAL_JUMP)
    ...
    JL 0x00495d46                       ; 00495d3a | LAB_00495d46
        ;   XREF to: 00495d46 (CONDITIONAL_JUMP)
    CMP EDI,dword ptr [ESP + 0x54]      ; 00495d3c
    JLE 0x00496005                      ; 00495d40 | LAB_00496005
        ;   XREF to: 00496005 (CONDITIONAL_JUMP)
    ...
    JZ 0x00496054                       ; 00495d74 | LAB_00496054
    ...
    FNSTSW AX                           ; 00495d9a
    SAHF                                ; 00495d9c
    JNC 0x00496005                      ; 00495d9d | LAB_00496005
        ;   XREF to: 00496005 (CONDITIONAL_JUMP)
    ...
    FABS                                ; 00495dbe
    FLD float ptr [0x00622b62]          ; 00495dc0 | float g_VoxelGridSize
    ...
    FMULP ST3                           ; 00495dd4
    FXCH                                ; 00495dd6
    CALL crt_math.c_round_FUN_005fe6b0  ; 00495dd8 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x68]        ; 00495ddd
    FLD float ptr [ESP + 0x20]          ; 00495de1
    FXCH                                ; 00495de5
    CALL crt_math.c_round_FUN_005fe6b0  ; 00495de7 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x94]        ; 00495dec
    FLDZ                                ; 00495df3
    FXCH ST2                            ; 00495df5
    CALL crt_math.c_round_FUN_005fe6b0  ; 00495df7 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    FNSTSW AX                           ; 00495e04
    SAHF                                ; 00495e06
    JA 0x00496075                       ; 00495e07 | LAB_00496075
    ...
    FNSTSW AX                           ; 00495e46
    SAHF                                ; 00495e48
    JA 0x004960a6                       ; 00495e49 | LAB_004960a6
    ...
    FNSTSW AX                           ; 00495e85
    SAHF                                ; 00495e87
    JA 0x004960d6                       ; 00495e88 | LAB_004960d6
    ...
    FMULP ST4                           ; 00495f1d
    FXCH ST4                            ; 00495f1f
    CALL crt_math.c_round_FUN_005fe6b0  ; 00495f21 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH ST4                            ; 00495f26
    FSUBP ST2,ST0                       ; 00495f28
    FXCH ST3                            ; 00495f2a
    FISTP dword ptr [ESP + 0x80]        ; 00495f2c
    CALL crt_math.c_round_FUN_005fe6b0  ; 00495f33 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH                                ; 00495f38
    FSUBP ST2,ST0                       ; 00495f3a
    FISTP dword ptr [ESP + 0x84]        ; 00495f3c
    CALL crt_math.c_round_FUN_005fe6b0  ; 00495f43 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDX                            ; 00495f6c
    CALL core_dtrace.cpp_CDemonRaytrace_getCubeAt_FUN_004952b0 ; 00495f6d | CDemonCube * core_dtrace.cpp_CDemonRaytrace_getCubeAt_FUN_004952b0(CDemonRaytrace * this_ptr, int grid_x, int grid_y, int grid_z)
        ;   XREF to: 004952b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00495f72
    TEST EAX,EAX                        ; 00495f75
    JNZ 0x00496106                      ; 00495f77 | LAB_00496106
        ;   XREF to: 00496106 (CONDITIONAL_JUMP)
    DEC ESI                             ; 00495f7d
        ;   Label: LAB_00495f7d
    TEST ESI,ESI                        ; 00495f7e
    JLE 0x004961f6                      ; 00495f80 | LAB_004961f6
    ...
    JMP 0x00495f57                      ; 00495ff5 | LAB_00495f57
        ;   XREF to: 00495f57 (UNCONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x58],0x0      ; 00495ffa
        ;   Label: LAB_00495ffa
    JGE 0x00495ce8                      ; 00495fff | LAB_00495ce8
    ...
    CMP dword ptr [ESP + 0x50],0x0      ; 00496018
        ;   Label: LAB_00496018
    JGE 0x00495cf3                      ; 0049601d | LAB_00495cf3
    ...
    CMP dword ptr [ESP + 0x54],0x0      ; 00496036
        ;   Label: LAB_00496036
    JGE 0x00495cfe                      ; 0049603b | LAB_00495cfe
    ...
    JNZ 0x00495d7a                      ; 0049605c | LAB_00495d7a
        ;   XREF to: 00495d7a (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x7c]      ; 00496062
    CMP EAX,dword ptr [ESP + 0x54]      ; 00496066
    JNZ 0x00495d7a                      ; 0049606a | LAB_00495d7a
        ;   XREF to: 00495d7a (CONDITIONAL_JUMP)
    JMP 0x00495f4f                      ; 00496070 | LAB_00495f4f
    ...
    JMP 0x00495e3a                      ; 004960a1 | LAB_00495e3a
    ...
    JMP 0x00495e79                      ; 004960d1 | LAB_00495e79
    ...
    JMP 0x00495eb8                      ; 00496101 | LAB_00495eb8
    ...
    PUSH ECX                            ; 00496118
    PUSH EAX                            ; 00496119
    CALL core_dcube.cpp_CDemonCube_rayIntersectTriangles_FUN_004578f0 ; 0049611a | float core_dcube.cpp_CDemonCube_rayIntersectTriangles_FUN_004578f0(CDemonCube * this_ptr, CVector3f * ray_origin, CVector3f * ray_direction, CVector3f * hit_normal, ...)
    ...
    JZ 0x0049616d                       ; 00496165 | LAB_0049616d
    ...
    FNSTSW AX                           ; 00496180
    SAHF                                ; 00496182
    JC 0x00495f7d                       ; 00496183 | LAB_00495f7d
    ...
    JL 0x004961be                       ; 004961a5 | LAB_004961be
    ...
    JMP 0x00495f57                      ; 004961b9 | LAB_00495f57
        ;   XREF to: 00495f57 (UNCONDITIONAL_JUMP)
    ...
    JMP 0x00495f57                      ; 004961f1 | LAB_00495f57
        ;   XREF to: 00495f57 (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + 0x24]      ; 004961f6
        ;   Label: LAB_004961f6
    TEST EAX,EAX                        ; 004961f9
    JZ 0x00496005                       ; 004961fb | LAB_00496005
        ;   XREF to: 00496005 (CONDITIONAL_JUMP)
