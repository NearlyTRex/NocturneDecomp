...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_dtrace.cpp_CDemonRaytrace_rayVoxelGridTest_FUN_00496220(CDemonRaytrace * this_ptr, CVector3f * start_pos, CVector3f * end_pos)
;
; Parameters:
...
section .text
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 00496271 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH                                ; 00496276
    CALL crt_math.c_round_FUN_005fe6b0  ; 00496278 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH                                ; 0049627d
    FISTP dword ptr [ESP + 0x70]        ; 0049627f
    FISTP dword ptr [ESP + 0x78]        ; 00496283
    FST float ptr [ESP + 0x54]          ; 00496287
    CALL crt_math.c_round_FUN_005fe6b0  ; 0049628b | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x74]        ; 00496290
    SUB ESP,0x8                         ; 00496294
    FSTP double ptr [ESP]               ; 00496297
    CALL crt_math.c_floor_FUN_005feb90  ; 0049629a | double crt_math.c_floor_FUN_005feb90(double input_value)
    ...
    FXCH                                ; 004962ba
    CALL crt_math.c_round_FUN_005fe6b0  ; 004962bc | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x44]        ; 004962c1
    SUB ESP,0x8                         ; 004962c5
    FSTP double ptr [ESP]               ; 004962c8
    CALL crt_math.c_floor_FUN_005feb90  ; 004962cb | double crt_math.c_floor_FUN_005feb90(double input_value)
        ;   XREF to: 005feb90 (UNCONDITIONAL_CALL)
    ...
    FXCH                                ; 004962eb
    CALL crt_math.c_round_FUN_005fe6b0  ; 004962ed | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x38]        ; 004962f2
    SUB ESP,0x8                         ; 004962f6
    FSTP double ptr [ESP]               ; 004962f9
    CALL crt_math.c_floor_FUN_005feb90  ; 004962fc | double crt_math.c_floor_FUN_005feb90(double input_value)
        ;   XREF to: 005feb90 (UNCONDITIONAL_CALL)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 00496318 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    FNSTSW AX                           ; 00496379
    SAHF                                ; 0049637b
    JNC 0x004965bf                      ; 0049637c | LAB_004965bf
    ...
    FLD ST0                             ; 00496392
    FABS                                ; 00496394
    FLD float ptr [0x00622b66]          ; 00496396 | float g_VoxelGridSize2
    ...
    FMULP                               ; 004963aa
    FXCH ST3                            ; 004963ac
    CALL crt_math.c_round_FUN_005fe6b0  ; 004963ae | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x68]        ; 004963b3
    FLDZ                                ; 004963b7
    FXCH ST2                            ; 004963b9
    CALL crt_math.c_round_FUN_005fe6b0  ; 004963bb | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH ST3                            ; 004963c0
    CALL crt_math.c_round_FUN_005fe6b0  ; 004963c2 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH ST3                            ; 004963c7
    ...
    FNSTSW AX                           ; 004963d5
    SAHF                                ; 004963d7
    JA 0x004965c8                       ; 004963d8 | LAB_004965c8
    ...
    FNSTSW AX                           ; 00496414
    SAHF                                ; 00496416
    JA 0x004965f2                       ; 00496417 | LAB_004965f2
    ...
    FNSTSW AX                           ; 00496453
    SAHF                                ; 00496455
    JA 0x0049661c                       ; 00496456 | LAB_0049661c
    ...
    FMULP ST4                           ; 004964e8
    FXCH ST4                            ; 004964ea
    CALL crt_math.c_round_FUN_005fe6b0  ; 004964ec | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH ST4                            ; 004964f1
    FSUBP ST2,ST0                       ; 004964f3
    FXCH ST3                            ; 004964f5
    FISTP dword ptr [ESP + 0x7c]        ; 004964f7
    CALL crt_math.c_round_FUN_005fe6b0  ; 004964fb | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH                                ; 00496500
    FSUBP ST2,ST0                       ; 00496502
    FISTP dword ptr [ESP + 0x80]        ; 00496504
    CALL crt_math.c_round_FUN_005fe6b0  ; 0049650b | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDX                            ; 00496525
    PUSH ESI                            ; 00496526
    CALL core_dtrace.cpp_CDemonRaytrace_getCubeAt_FUN_004952b0 ; 00496527 | CDemonCube * core_dtrace.cpp_CDemonRaytrace_getCubeAt_FUN_004952b0(CDemonRaytrace * this_ptr, int grid_x, int grid_y, int grid_z)
        ;   XREF to: 004952b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0049652c
    TEST EAX,EAX                        ; 0049652f
    JNZ 0x00496646                      ; 00496531 | LAB_00496646
        ;   XREF to: 00496646 (CONDITIONAL_JUMP)
    DEC EBX                             ; 00496537
        ;   Label: LAB_00496537
    TEST EBX,EBX                        ; 00496538
    JLE 0x004965bf                      ; 0049653a | LAB_004965bf
        ;   XREF to: 004965bf (CONDITIONAL_JUMP)
    ...
    JL 0x0049669a                       ; 00496565 | LAB_0049669a
        ;   XREF to: 0049669a (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x80],0x0      ; 0049656b
    JL 0x004966a4                       ; 00496573 | LAB_004966a4
    ...
    JMP 0x00496517                      ; 004965a7 | LAB_00496517
        ;   XREF to: 00496517 (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x78]      ; 004965ac
        ;   Label: LAB_004965ac
    CMP EAX,dword ptr [ESP + 0x40]      ; 004965b0
    JNZ 0x00496359                      ; 004965b4 | LAB_00496359
        ;   XREF to: 00496359 (CONDITIONAL_JUMP)
    JMP 0x00496517                      ; 004965ba | LAB_00496517
        ;   XREF to: 00496517 (UNCONDITIONAL_JUMP)
    ...
    JMP 0x00496404                      ; 004965ed | LAB_00496404
    ...
    JMP 0x00496443                      ; 00496617 | LAB_00496443
    ...
    JMP 0x00496482                      ; 00496641 | LAB_00496482
    ...
    PUSH EDI                            ; 00496655
    PUSH EAX                            ; 00496656
    CALL core_dcube.cpp_CDemonCube_rayIntersectTriangles_FUN_004578f0 ; 00496657 | float core_dcube.cpp_CDemonCube_rayIntersectTriangles_FUN_004578f0(CDemonCube * this_ptr, CVector3f * ray_origin, CVector3f * ray_direction, CVector3f * hit_normal, ...)
    ...
    FNSTSW AX                           ; 00496677
    SAHF                                ; 00496679
    JA 0x00496537                       ; 0049667a | LAB_00496537
        ;   XREF to: 00496537 (CONDITIONAL_JUMP)
    FLD1                                ; 00496680
    FCOMP double ptr [ESP]              ; 00496682
    FNSTSW AX                           ; 00496685
    SAHF                                ; 00496687
    JC 0x00496537                       ; 00496688 | LAB_00496537
        ;   XREF to: 00496537 (CONDITIONAL_JUMP)
    ...
    CMP dword ptr [ESP + 0x84],0x0      ; 0049669a
        ;   Label: LAB_0049669a
    JL 0x004966bb                       ; 004966a2 | LAB_004966bb
    ...
    JMP 0x00496517                      ; 004966b6 | LAB_00496517
        ;   XREF to: 00496517 (UNCONDITIONAL_JUMP)
    ...
    JMP 0x00496517                      ; 004966e9 | LAB_00496517
        ;   XREF to: 00496517 (UNCONDITIONAL_JUMP)
