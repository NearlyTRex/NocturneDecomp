...
section .text
    ...
    JL 0x00494ff4                       ; 00494fe7
        ;   XREF to: 00494ff4 (CONDITIONAL_JUMP)  ; LAB_00494ff4
    TEST byte ptr [EBP + 0xc],0x20      ; 00494fe9
    JNZ 0x00495009                      ; 00494fed
        ;   XREF to: 00495009 (CONDITIONAL_JUMP)  ; LAB_00495009
    POP EBP                             ; 00494fef
    POP EDI                             ; 00494ff0
    POP ESI                             ; 00494ff1
    POP EBX                             ; 00494ff2
    ...
    JMP 0x00494fd8                      ; 00495007
        ;   XREF to: 00494fd8 (UNCONDITIONAL_JUMP)  ; LAB_00494fd8
    MOV EBX,0x622a03                    ; 00495009 | = "..\\core\\dtrace.cpp"
        ;   Label: LAB_00495009
    MOV ESI,0x251                       ; 0049500e
    PUSH 0x622a16                       ; 00495013 | = "CDemonRaytrace::saveBinary - error wr..."
    MOV dword ptr [0x02f0ca48],EBX      ; 00495018 | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 0049501e | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00495024
