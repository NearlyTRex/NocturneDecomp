// Name: core_dtrace.cpp_CDemonRaytrace_markShadowVoxels_FUN_00499c20
// Address: 00499c20
// Address Range: [[00499c20, 00499e6f]]
// Convention: __cdecl
// Signature: void __cdecl core_dtrace_cpp_CDemonRaytrace_markShadowVoxels_FUN_00499c20(CDemonRaytrace *this_ptr,CVector3f *offset,CVector3f *rotation,CVector3f *extent,CVector3f *light_position)
...

{
  ...
  local_58 = light_position->x - extent->x;
  local_54 = light_position->y - extent->y;
  local_50 = light_position->z - extent->z;
  fVar3 = (float)2;
      ...
      if (0 < local_24) {
        do {
          ...
          if (0 < local_1c) {
            do {
              fVar4 = (float)0.5;
              local_40.x = fVar1 * fVar4 + (float)local_20 * fVar1 + extent->x;
              local_40.y = fVar2 * fVar4 + (float)local_18 * fVar2 + extent->y;
              local_40.z = (float)iVar6 * fVar3 + extent->z + fVar3 * fVar4;
              local_14 = iVar6;
