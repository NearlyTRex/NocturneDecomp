      ...
      if (0 < local_24) {
        do {
          ...
          if (0 < local_1c) {
            do {
              fVar4 = (float)0.5;
              local_40.x = fVar1 * fVar4 + (float)local_20 * fVar1 + start_position->x;
              local_40.y = fVar2 * fVar4 + (float)local_18 * fVar2 + start_position->y;
              local_40.z = (float)iVar6 * fVar3 + start_position->z + fVar3 * fVar4;
              local_14 = iVar6;
