...

{
  ...
  if (DAT_02cee5ac == 1) {
    sprintf(local_224.found_path,"data\\%s",filename);
    ...
    if (iVar2 != 0) {
      ...
      _fseek(p_Var1,local_224.file_offset,0);
      core_dtrace_cpp_CDemonRaytrace_saveBinary_FUN_00494f50(this_ptr,p_Var1);
      shape_memdbg_cpp_closeFile_FUN_0050f9b0(p_Var1,"..\\core\\dtrace.cpp",0x221);
    }
  }
  return 1;
}
