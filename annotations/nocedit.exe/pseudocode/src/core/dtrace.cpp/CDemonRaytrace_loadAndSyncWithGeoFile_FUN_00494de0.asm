...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_dtrace_cpp_CDemonRaytrace_loadAndSyncWithGeoFile_FUN_00494de0 (CDemonRaytrace *this_ptr,char *filename)
;
; Parameters:
...
section .text
    ...
    PUSH 0x622916                       ; 00494df8 | = "rb"
    PUSH ESI                            ; 00494dfd
    PUSH 0x622919                       ; 00494dfe | = "data"
    CALL engine_dosio.c_getFile_FUN_00481a50 ; 00494e03
        ;   XREF to: 00481a50 (UNCONDITIONAL_CALL)  ; _FILE * engine_dosio.c_getFile_FUN_00481a50(char * directory, char * filename, char * mode)
    MOV EBX,EAX                         ; 00494e08
    ADD ESP,0xc                         ; 00494e0a
    TEST EAX,EAX                        ; 00494e0d
    JNZ 0x00494e1c                      ; 00494e0f
        ;   XREF to: 00494e1c (CONDITIONAL_JUMP)  ; LAB_00494e1c
    ...
    PUSH EAX                            ; 00494e1c
        ;   Label: LAB_00494e1c
    PUSH EDI                            ; 00494e1d
    CALL core_dtrace.cpp_CDemonRaytrace_loadBinary_FUN_004947a0 ; 00494e1e
        ;   XREF to: 004947a0 (UNCONDITIONAL_CALL)  ; void core_dtrace.cpp_CDemonRaytrace_loadBinary_FUN_004947a0(CDemonRaytrace * this_ptr, _FILE * file_handle)
    ADD ESP,0x8                         ; 00494e23
    PUSH 0x212                          ; 00494e26
    PUSH 0x62291e                       ; 00494e2b | = "..\\core\\dtrace.cpp"
    PUSH EBX                            ; 00494e30
    ...
    JNZ 0x00494f1b                      ; 00494e42
        ;   XREF to: 00494f1b (CONDITIONAL_JUMP)  ; LAB_00494f1b
    PUSH ESI                            ; 00494e48
    ...
    PUSH EAX                            ; 00494e5d
    CALL engine_dosio.c_findFile_FUN_00481760 ; 00494e5e
    ...
    JZ 0x00494f2b                       ; 00494e68
        ;   XREF to: 00494f2b (CONDITIONAL_JUMP)  ; LAB_00494f2b
    CMP dword ptr [ESP + 0x208],0x0     ; 00494e6e
    JZ 0x00494f2b                       ; 00494e76
        ;   XREF to: 00494f2b (CONDITIONAL_JUMP)  ; LAB_00494f2b
    ...
    JZ 0x00494f1b                       ; 00494e9b
        ;   XREF to: 00494f1b (CONDITIONAL_JUMP)  ; LAB_00494f1b
    PUSH 0x21d                          ; 00494ea1
    PUSH 0x62299b                       ; 00494ea6 | = "..\\core\\dtrace.cpp"
    PUSH 0x6229ae                       ; 00494eab | = "rb+"
    PUSH 0x0                            ; 00494eb0
    LEA EAX,[ESP + 0x110]               ; 00494eb2
    PUSH EAX                            ; 00494eb9
    CALL shape_memdbg.cpp_openFile_FUN_0050f7a0 ; 00494eba
        ;   XREF to: 0050f7a0 (UNCONDITIONAL_CALL)  ; _FILE * shape_memdbg.cpp_openFile_FUN_0050f7a0(char * filename, char * directory, char * mode, char * source_file, ...)
    ADD ESP,0x14                        ; 00494ebf
    MOV EBX,EAX                         ; 00494ec2
    TEST EAX,EAX                        ; 00494ec4
    JNZ 0x00494eeb                      ; 00494ec6
        ;   XREF to: 00494eeb (CONDITIONAL_JUMP)  ; LAB_00494eeb
    MOV ESI,0x6229b2                    ; 00494ec8 | = "..\\core\\dtrace.cpp"
    MOV EBP,0x21e                       ; 00494ecd
    PUSH 0x6229c5                       ; 00494ed2 | = "Can't rewrite .POD file for unknown r..."
    MOV dword ptr [0x02f0ca48],ESI      ; 00494ed7 | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBP      ; 00494edd | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00494ee3
    ...
    PUSH EAX                            ; 00494ef4
    PUSH EBX                            ; 00494ef5
    CALL crt_stdio.c_fseek_FUN_005ffacc ; 00494ef6
    ...
    PUSH EBX                            ; 00494efe
    PUSH EDI                            ; 00494eff
    CALL core_dtrace.cpp_CDemonRaytrace_saveBinary_FUN_00494f50 ; 00494f00
    ...
    PUSH 0x221                          ; 00494f08
    PUSH 0x6229f0                       ; 00494f0d | = "..\\core\\dtrace.cpp"
    PUSH EBX                            ; 00494f12
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 00494f13
        ;   XREF to: 0050f9b0 (UNCONDITIONAL_CALL)  ; int shape_memdbg.cpp_closeFile_FUN_0050f9b0(_FILE * file_ptr, char * source_file, int line_number)
    ...
    PUSH ESI                            ; 00494f2b
        ;   Label: LAB_00494f2b
    PUSH EDI                            ; 00494f2c
    CALL core_dtrace.cpp_CDemonRaytrace_save_FUN_00495040 ; 00494f2d
