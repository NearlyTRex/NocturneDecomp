...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dtrace.cpp_CDemonRaytrace_crunch_FUN_00495310(CDemonRaytrace * this_ptr, float cube_size)
;
; Parameters:
...
section .text
    ...
    FXCH                                ; 00495333
    FMUL ST1                            ; 00495335
    CALL crt_math.c_round_FUN_005fe6b0  ; 00495337 | double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    FMUL ST2                            ; 00495357
    CALL crt_math.c_round_FUN_005fe6b0  ; 00495359 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    FMULP ST3                           ; 00495379
    FXCH ST2                            ; 0049537b
    CALL crt_math.c_round_FUN_005fe6b0  ; 0049537d | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    FDIV float ptr [0x00622b5a]         ; 004953a9 | float g_CubeGridScaleFactor
    FSTP float ptr [EBP + -0x6]         ; 004953af
    FLD float ptr [0x00622b5e]          ; 004953b2 | float g_CubeGridMultiplier
    ...
    JZ 0x004953e1                       ; 004953ce | LAB_004953e1
    ...
    PUSH EDI                            ; 004953e1
        ;   Label: LAB_004953e1
    CALL core_dtrace.cpp_CDemonRaytrace_allocNewCubeList_FUN_00494380 ; 004953e2 | void core_dtrace.cpp_CDemonRaytrace_allocNewCubeList_FUN_00494380(CDemonRaytrace * this_ptr)
    ...
    PUSH 0x622ae4                       ; 00495400 | = "..\\core\\dtrace.cpp" | s_core_dtrace_cpp_00622ae4 = ..\core\dtrace.cpp
    ADD EAX,0x4                         ; 00495405
    PUSH EAX                            ; 00495408
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1f0 ; 00495409 | void * shape_memdbg.cpp_debugAlloc_FUN_0050f1f0(int size, char * filename, int line_number)
        ;   XREF to: 0050f1f0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0049540e
    TEST EAX,EAX                        ; 00495411
    JZ 0x0049541b                       ; 00495413 | LAB_0049541b
    ...
    JNZ 0x00495445                      ; 00495420 | LAB_00495445
        ;   XREF to: 00495445 (CONDITIONAL_JUMP)
    MOV EDX,0x622af7                    ; 00495422 | = "..\\core\\dtrace.cpp" | s_core_dtrace_cpp_00622af7 = ..\core\dtrace.cpp
    MOV ECX,0x2ee                       ; 00495427
    PUSH 0x622b0a                       ; 0049542c | = "CDemonRaytrace::crunch - out of refLi..." | s_CDemonRaytrace_crunch_ou_00622b0a = CDemonRaytrace::crunch - out of refList memory
    MOV dword ptr [0x02f0ca48],EDX      ; 00495431 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 00495437 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0049543d | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    JLE 0x004955b9                      ; 0049544c | LAB_004955b9
    ...
    FNSTSW AX                           ; 004954db
    SAHF                                ; 004954dd
    JNC 0x004954e6                      ; 004954de | LAB_004954e6
    ...
    FNSTSW AX                           ; 004954ec
    SAHF                                ; 004954ee
    JBE 0x004954f7                      ; 004954ef | LAB_004954f7
    ...
    FNSTSW AX                           ; 004954fd
    SAHF                                ; 004954ff
    JNC 0x00495508                      ; 00495500 | LAB_00495508
    ...
    FNSTSW AX                           ; 0049550e
    SAHF                                ; 00495510
    JBE 0x00495519                      ; 00495511 | LAB_00495519
    ...
    FNSTSW AX                           ; 0049551f
    SAHF                                ; 00495521
    JNC 0x0049552a                      ; 00495522 | LAB_0049552a
    ...
    FNSTSW AX                           ; 00495530
    SAHF                                ; 00495532
    JBE 0x0049553b                      ; 00495533 | LAB_0049553b
    ...
    FNSTSW AX                           ; 00495541
    SAHF                                ; 00495543
    JNC 0x0049554c                      ; 00495544 | LAB_0049554c
    ...
    FNSTSW AX                           ; 00495552
    SAHF                                ; 00495554
    JBE 0x0049555d                      ; 00495555 | LAB_0049555d
    ...
    FNSTSW AX                           ; 00495563
    SAHF                                ; 00495565
    JNC 0x0049556e                      ; 00495566 | LAB_0049556e
    ...
    FNSTSW AX                           ; 00495574
    SAHF                                ; 00495576
    JBE 0x0049557f                      ; 00495577 | LAB_0049557f
    ...
    FNSTSW AX                           ; 00495585
    SAHF                                ; 00495587
    JNC 0x00495590                      ; 00495588 | LAB_00495590
    ...
    FNSTSW AX                           ; 00495596
    SAHF                                ; 00495598
    JBE 0x004955a1                      ; 00495599 | LAB_004955a1
    ...
    JL 0x00495458                       ; 004955b3 | LAB_00495458
        ;   XREF to: 00495458 (CONDITIONAL_JUMP)
    PUSH 0x622b39                       ; 004955b9 | = "Cube crunch" | s_Cube_crunch_00622b39 = Cube crunch
        ;   Label: LAB_004955b9
    MOV EDX,dword ptr [0x00678a60]      ; 004955be | CEditorTools g_CEditorToolsPtr | CEditorTools * g_CEditorToolsPtr
    PUSH EDX                            ; 004955c4 | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_showCenteredProgressDialog_FUN_004a0430 ; 004955c5 | void shape_edittool.cpp_CEditorTools_showCenteredProgressDialog_FUN_004a0430(CEditorTools * this_ptr, char * message_text)
    ...
    JLE 0x00495822                      ; 004955d7 | LAB_00495822
    ...
    JL 0x0049565d                       ; 00495603 | LAB_0049565d
    ...
    FNSTSW AX                           ; 0049562a
    SAHF                                ; 0049562c
    JA 0x00495863                       ; 0049562d | LAB_00495863
    ...
    FNSTSW AX                           ; 0049563c
    SAHF                                ; 0049563e
    JC 0x00495863                       ; 0049563f | LAB_00495863
        ;   XREF to: 00495863 (CONDITIONAL_JUMP)
    ...
    JLE 0x0049561e                      ; 0049565b | LAB_0049561e
    ...
    JLE 0x00495810                      ; 00495667 | LAB_00495810
    ...
    JL 0x004956f3                       ; 00495699 | LAB_004956f3
    ...
    FNSTSW AX                           ; 004956c0
    SAHF                                ; 004956c2
    JA 0x00495974                       ; 004956c3 | LAB_00495974
    ...
    FNSTSW AX                           ; 004956d2
    SAHF                                ; 004956d4
    JC 0x00495974                       ; 004956d5 | LAB_00495974
        ;   XREF to: 00495974 (CONDITIONAL_JUMP)
    ...
    JLE 0x004956b4                      ; 004956f1 | LAB_004956b4
    ...
    JLE 0x004957fe                      ; 004956fd | LAB_004957fe
    ...
    MOV ECX,dword ptr [0x00678a60]      ; 0049573c | CEditorTools g_CEditorToolsPtr | CEditorTools * g_CEditorToolsPtr
    ...
    PUSH ECX                            ; 00495759 | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_updatePercentage_FUN_004a0530 ; 0049575a | void shape_edittool.cpp_CEditorTools_updatePercentage_FUN_004a0530(CEditorTools * this_ptr, float progress_min, float progress_max)
    ...
    CALL core_dcube.cpp_CDemonCube_setBounds_FUN_00456a90 ; 00495796 | void core_dcube.cpp_CDemonCube_setBounds_FUN_00456a90(CDemonCube * this_ptr, CVector3f * min_bounds, CVector3f * max_bounds)
        ;   XREF to: 00456a90 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EBP + 0x72]      ; 0049579b
    ADD ESP,0xc                         ; 0049579e
    TEST EAX,EAX                        ; 004957a1
    JLE 0x004957e0                      ; 004957a3 | LAB_004957e0
    ...
    INC ESI                             ; 004957d0
    CALL core_dcube.cpp_CDemonCube_clipTriangleToFrustum_FUN_00456af0 ; 004957d1 | void core_dcube.cpp_CDemonCube_clipTriangleToFrustum_FUN_00456af0(CDemonCubeFrustum * frustum, CVector3f * vertex1, CVector3f * vertex2, CVector3f * vertex3, ...)
        ;   XREF to: 00456af0 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [EBP + 0x72]      ; 004957d6
    ADD ESP,0x14                        ; 004957d9
    CMP ESI,EDX                         ; 004957dc
    JL 0x004957a8                       ; 004957de | LAB_004957a8
        ;   XREF to: 004957a8 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [EBP + 0x6e]      ; 004957e0
        ;   Label: LAB_004957e0
    PUSH EDX                            ; 004957e3
    CALL core_dcube.cpp_CDemonCube_buildGeometryFromPolygonData ; 004957e4 | void core_dcube.cpp_CDemonCube_buildGeometryFromPolygonData(CDemonCube * this_ptr)
    ...
    JL 0x00495703                       ; 004957f8 | LAB_00495703
    ...
    JL 0x00495674                       ; 0049580a | LAB_00495674
    ...
    JL 0x004955dd                       ; 0049581c | LAB_004955dd
        ;   XREF to: 004955dd (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [0x00678a60]      ; 00495822 | CEditorTools g_CEditorToolsPtr | CEditorTools * g_CEditorToolsPtr
        ;   Label: LAB_00495822
    PUSH EBX                            ; 00495828 | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_restoreWindowAndCleanup_FUN_004a0dd0 ; 00495829 | void shape_edittool.cpp_CEditorTools_restoreWindowAndCleanup_FUN_004a0dd0(CEditorTools * this_ptr)
        ;   XREF to: 004a0dd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0049582e
    PUSH EDI                            ; 00495831
    MOV ESI,0x622b45                    ; 00495832 | = "..\\core\\dtrace.cpp" | s_core_dtrace_cpp_00622b45 = ..\core\dtrace.cpp
    CALL core_dtrace.cpp_CDemonRaytrace_freeTriList_FUN_00494690 ; 00495837 | void core_dtrace.cpp_CDemonRaytrace_freeTriList_FUN_00494690(CDemonRaytrace * this_ptr)
        ;   XREF to: 00494690 (UNCONDITIONAL_CALL)
    MOV EDI,0x38c                       ; 0049583c
    MOV EAX,dword ptr [EBP + 0x46]      ; 00495841
    ADD ESP,0x4                         ; 00495844
    MOV dword ptr [0x0067d20c],ESI      ; 00495847 | char * g_CurrentDebugFilename
    MOV dword ptr [0x02f0d944],EDI      ; 0049584d | int g_CurrentDebugLine
    TEST EAX,EAX                        ; 00495853
    JNZ 0x00495a85                      ; 00495855 | LAB_00495a85
    ...
    PUSH EAX                            ; 0049587b
    CALL core_charactr.cpp_CCharacter_setActorNameMaybe_FUN_0042fb00 ; 0049587c | CCharacter * core_charactr.cpp_CCharacter_setActorNameMaybe_FUN_0042fb00(CCharacter * this_ptr, char * * actor_name)
    ...
    PUSH EAX                            ; 0049588b
    CALL core_charactr.cpp_CCharacter_setActorNameMaybe_FUN_0042faf0 ; 0049588c | CCharacter * core_charactr.cpp_CCharacter_setActorNameMaybe_FUN_0042faf0(CCharacter * this_ptr, char * * actor_name)
    ...
    PUSH EAX                            ; 0049589b
    CALL core_charactr.cpp_CCharacter_setActorNameMaybe_FUN_0042fae0 ; 0049589c | CCharacter * core_charactr.cpp_CCharacter_setActorNameMaybe_FUN_0042fae0(CCharacter * this_ptr, char * * actor_name)
    ...
    PUSH EAX                            ; 004958b1
    CALL core_charactr.cpp_CCharacter_setActorNameMaybe_FUN_0042fb00 ; 004958b2 | CCharacter * core_charactr.cpp_CCharacter_setActorNameMaybe_FUN_0042fb00(CCharacter * this_ptr, char * * actor_name)
        ;   XREF to: 0042fb00 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 004958c4
    CALL core_charactr.cpp_CCharacter_setActorNameMaybe_FUN_0042faf0 ; 004958c5 | CCharacter * core_charactr.cpp_CCharacter_setActorNameMaybe_FUN_0042faf0(CCharacter * this_ptr, char * * actor_name)
        ;   XREF to: 0042faf0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 004958d7
    CALL core_charactr.cpp_CCharacter_setActorNameMaybe_FUN_0042fae0 ; 004958d8 | CCharacter * core_charactr.cpp_CCharacter_setActorNameMaybe_FUN_0042fae0(CCharacter * this_ptr, char * * actor_name)
        ;   XREF to: 0042fae0 (UNCONDITIONAL_CALL)
    ...
    JZ 0x00495901                       ; 004958ef | LAB_00495901
    ...
    JZ 0x0049591e                       ; 0049590c | LAB_0049591e
    ...
    JZ 0x00495941                       ; 0049592e | LAB_00495941
    ...
    JZ 0x0049595c                       ; 00495949 | LAB_0049595c
    ...
    JMP 0x00495655                      ; 0049596f | LAB_00495655
    ...
    PUSH EAX                            ; 0049598c
    CALL core_charactr.cpp_CCharacter_setActorNameMaybe_FUN_0042fb00 ; 0049598d | CCharacter * core_charactr.cpp_CCharacter_setActorNameMaybe_FUN_0042fb00(CCharacter * this_ptr, char * * actor_name)
        ;   XREF to: 0042fb00 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0049599c
    CALL core_charactr.cpp_CCharacter_setActorNameMaybe_FUN_0042faf0 ; 0049599d | CCharacter * core_charactr.cpp_CCharacter_setActorNameMaybe_FUN_0042faf0(CCharacter * this_ptr, char * * actor_name)
        ;   XREF to: 0042faf0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 004959ac
    CALL core_charactr.cpp_CCharacter_setActorNameMaybe_FUN_0042fae0 ; 004959ad | CCharacter * core_charactr.cpp_CCharacter_setActorNameMaybe_FUN_0042fae0(CCharacter * this_ptr, char * * actor_name)
        ;   XREF to: 0042fae0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 004959c2
    CALL core_charactr.cpp_CCharacter_setActorNameMaybe_FUN_0042fb00 ; 004959c3 | CCharacter * core_charactr.cpp_CCharacter_setActorNameMaybe_FUN_0042fb00(CCharacter * this_ptr, char * * actor_name)
        ;   XREF to: 0042fb00 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 004959d5
    CALL core_charactr.cpp_CCharacter_setActorNameMaybe_FUN_0042faf0 ; 004959d6 | CCharacter * core_charactr.cpp_CCharacter_setActorNameMaybe_FUN_0042faf0(CCharacter * this_ptr, char * * actor_name)
        ;   XREF to: 0042faf0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 004959e8
    CALL core_charactr.cpp_CCharacter_setActorNameMaybe_FUN_0042fae0 ; 004959e9 | CCharacter * core_charactr.cpp_CCharacter_setActorNameMaybe_FUN_0042fae0(CCharacter * this_ptr, char * * actor_name)
        ;   XREF to: 0042fae0 (UNCONDITIONAL_CALL)
    ...
    JZ 0x00495a12                       ; 00495a00 | LAB_00495a12
    ...
    JZ 0x00495a2f                       ; 00495a1d | LAB_00495a2f
    ...
    JZ 0x00495a52                       ; 00495a3f | LAB_00495a52
    ...
    JZ 0x00495a6d                       ; 00495a5a | LAB_00495a6d
    ...
    JMP 0x004956eb                      ; 00495a80 | LAB_004956eb
        ;   XREF to: 004956eb (UNCONDITIONAL_JUMP)
    SUB EAX,0x4                         ; 00495a85
        ;   Label: LAB_00495a85
    PUSH EAX                            ; 00495a88
    CALL crt_memory.c_free_FUN_005fe659 ; 00495a89 | void crt_memory.c_free_FUN_005fe659(void * ptr)
