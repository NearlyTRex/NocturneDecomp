...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dtrace.cpp_CDemonRaytrace_testCapsuleCollision_FUN_00496c60(CDemonRaytrace * this_ptr, SCapsuleCollision * capsule_data)
;
; Parameters:
...
section .text
    ...
    MOV EAX,0x15c4818                   ; 00496c6b | CVector3f g_TempNormal2
    CMP EAX,0x3f87558                   ; 00496c70 | CVector3f g_ZeroVector
    JNZ 0x00496e05                      ; 00496c75 | LAB_00496e05
        ;   XREF to: 00496e05 (CONDITIONAL_JUMP)
    MOV EAX,0x15c480c                   ; 00496c7b | CVector3f g_TempNormal1
        ;   Label: LAB_00496c7b
    CMP EAX,0x15c4818                   ; 00496c80 | CVector3f g_TempNormal2
    JZ 0x00496ca9                       ; 00496c85 | LAB_00496ca9
        ;   XREF to: 00496ca9 (CONDITIONAL_JUMP)
    FLD float ptr [0x015c4818]          ; 00496c87 | CVector3f g_TempNormal2
    ...
    FSTP float ptr [0x015c480c]         ; 00496ca3 | CVector3f g_TempNormal1
    MOV EAX,0x15c4800                   ; 00496ca9 | CVector3f g_TempNormal0
        ;   Label: LAB_00496ca9
    CMP EAX,0x15c480c                   ; 00496cae | CVector3f g_TempNormal1
    JZ 0x00496cd7                       ; 00496cb3 | LAB_00496cd7
        ;   XREF to: 00496cd7 (CONDITIONAL_JUMP)
    FLD float ptr [0x015c480c]          ; 00496cb5 | CVector3f g_TempNormal1
    ...
    FSTP float ptr [0x015c4800]         ; 00496cd1 | CVector3f g_TempNormal0
    FLDZ                                ; 00496cd7
        ;   Label: LAB_00496cd7
    FCOMP float ptr [EBP + 0x18]        ; 00496cd9
    FNSTSW AX                           ; 00496cdc
    SAHF                                ; 00496cde
    JNC 0x00496e2c                      ; 00496cdf | LAB_00496e2c
    ...
    FMULP                               ; 00496d09
    FXCH                                ; 00496d0b
    CALL crt_math.c_round_FUN_005fe6b0  ; 00496d0d | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH                                ; 00496d12
    CALL crt_math.c_round_FUN_005fe6b0  ; 00496d14 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    FLDZ                                ; 00496d3e
    FXCH ST2                            ; 00496d40
    CALL crt_math.c_round_FUN_005fe6b0  ; 00496d42 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH                                ; 00496d47
    CALL crt_math.c_round_FUN_005fe6b0  ; 00496d49 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH                                ; 00496d4e
    ...
    FNSTSW AX                           ; 00496d5b
    SAHF                                ; 00496d5d
    JNC 0x00496e49                      ; 00496d5e | LAB_00496e49
    ...
    FMULP                               ; 00496d88
    FXCH                                ; 00496d8a
    CALL crt_math.c_round_FUN_005fe6b0  ; 00496d8c | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH                                ; 00496d91
    CALL crt_math.c_round_FUN_005fe6b0  ; 00496d93 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    JG 0x00496dfd                       ; 00496daa | LAB_00496dfd
    ...
    JG 0x00496df4                       ; 00496db6 | LAB_00496df4
    ...
    JG 0x00496deb                       ; 00496dc2 | LAB_00496deb
    ...
    PUSH EAX                            ; 00496dcb
    CALL core_dtrace.cpp_CDemonRaytrace_getCubeAt_FUN_004952b0 ; 00496dcc | CDemonCube * core_dtrace.cpp_CDemonRaytrace_getCubeAt_FUN_004952b0(CDemonRaytrace * this_ptr, int grid_x, int grid_y, int grid_z)
        ;   XREF to: 004952b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00496dd1
    TEST EAX,EAX                        ; 00496dd4
    JZ 0x00496de2                       ; 00496dd6 | LAB_00496de2
        ;   XREF to: 00496de2 (CONDITIONAL_JUMP)
    PUSH EBP                            ; 00496dd8
    PUSH EAX                            ; 00496dd9
    CALL core_dcube.cpp_CDemonCube_testCapsuleCollision_FUN_00457a90 ; 00496dda | void core_dcube.cpp_CDemonCube_testCapsuleCollision_FUN_00457a90(CDemonCube * this_ptr, SIntersectXZCylinder * capsule_data)
    ...
    POP EBX                             ; 00496e03
    RET                                 ; 00496e04
    FLD float ptr [0x03f87558]          ; 00496e05 | CVector3f g_ZeroVector
        ;   Label: LAB_00496e05
    ...
    FSTP float ptr [0x015c4818]         ; 00496e21 | CVector3f g_TempNormal2
    JMP 0x00496c7b                      ; 00496e27 | LAB_00496c7b
    ...
    JMP 0x00496cfd                      ; 00496e44 | LAB_00496cfd
    ...
    JMP 0x00496d7c                      ; 00496e61 | LAB_00496d7c
