...
section .text
    ...
    CALL core_dtrace.cpp_CDemonRaytrace_freeNewCubeList_FUN_00494400 ; 004947b2 | void core_dtrace.cpp_CDemonRaytrace_freeNewCubeList_FUN_00494400(CDemonRaytrace * this_ptr)
    ...
    PUSH EAX                            ; 004947c9
    MOV dword ptr [0x02cee5ac],ECX      ; 004947ca | undefined4 DAT_02cee5ac
    CALL crt_stdio.c_fread_FUN_005fd990 ; 004947d0 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004947d5
    CMP dword ptr [ESP + 0x24],0x1      ; 004947d8
    JL 0x004948ff                       ; 004947dd | LAB_004948ff
        ;   XREF to: 004948ff (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x24]      ; 004947e3
        ;   Label: LAB_004947e3
    CMP EAX,dword ptr [0x006789f0]      ; 004947e7 | int g_GeoFileFormatVersion
    JLE 0x00494812                      ; 004947ed | LAB_00494812
        ;   XREF to: 00494812 (CONDITIONAL_JUMP)
    MOV ECX,0x62278d                    ; 004947ef | = "..\\core\\dtrace.cpp" | s_core_dtrace_cpp_0062278d = ..\core\dtrace.cpp
    MOV EBX,0x14b                       ; 004947f4
    PUSH 0x6227a0                       ; 004947f9 | = "CDemonRaytrace::loadBinary - file is ..." | s_CDemonRaytrace_loadBinar_006227a0 = CDemonRaytrace::loadBinary - file is newer than .exe!
    MOV dword ptr [0x02f0ca48],ECX      ; 004947fe | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 00494804 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0049480a | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    PUSH EAX                            ; 0049481e
    CALL crt_stdio.c_fread_FUN_005fd990 ; 0049481f | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0049482f
    CALL crt_stdio.c_fread_FUN_005fd990 ; 00494830 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00494840
    CALL crt_stdio.c_fread_FUN_005fd990 ; 00494841 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00494851
    CALL crt_stdio.c_fread_FUN_005fd990 ; 00494852 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00494862
    CALL crt_stdio.c_fread_FUN_005fd990 ; 00494863 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ...
    PUSH EBX                            ; 00494873
    CALL crt_stdio.c_fread_FUN_005fd990 ; 00494874 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    FLD float ptr [EBX]                 ; 00494879
    FDIV float ptr [0x0062290e]         ; 0049487b | float FLOAT_0062290e
    ADD ESP,0x10                        ; 00494881
    FSTP float ptr [ESP + 0x18]         ; 00494884
    FLD float ptr [0x00622912]          ; 00494888 | float FLOAT_00622912
    ...
    JZ 0x004948bd                       ; 004948a7 | LAB_004948bd
    ...
    CMP dword ptr [ESP + 0x24],0x4      ; 004948bd
        ;   Label: LAB_004948bd
    JL 0x00494926                       ; 004948c2 | LAB_00494926
        ;   XREF to: 00494926 (CONDITIONAL_JUMP)
    PUSH EBP                            ; 004948c4
    CALL core_dtrace.cpp_CDemonRaytrace_allocNewCubeList_FUN_00494380 ; 004948c5 | void core_dtrace.cpp_CDemonRaytrace_allocNewCubeList_FUN_00494380(CDemonRaytrace * this_ptr)
    ...
    JGE 0x00494d98                      ; 004948e0 | LAB_00494d98
    ...
    PUSH EAX                            ; 004948f0
    INC EDI                             ; 004948f1
    CALL core_dcube.cpp_CDemonCube_load_FUN_00457530 ; 004948f2 | void core_dcube.cpp_CDemonCube_load_FUN_00457530(CDemonCube * this_ptr, FILE * file_handle)
        ;   XREF to: 00457530 (UNCONDITIONAL_CALL)
    ADD ESI,0x34                        ; 004948f7
    ADD ESP,0x8                         ; 004948fa
    JMP 0x004948d1                      ; 004948fd | LAB_004948d1
        ;   XREF to: 004948d1 (UNCONDITIONAL_JUMP)
    MOV EDI,0x62274d                    ; 004948ff | = "..\\core\\dtrace.cpp" | s_core_dtrace_cpp_0062274d = ..\core\dtrace.cpp
        ;   Label: LAB_004948ff
    MOV EAX,0x148                       ; 00494904
    PUSH 0x622760                       ; 00494909 | = "CDemonRaytrace::loadBinary - invalid ..." | s_CDemonRaytrace_loadBinar_00622760 = CDemonRaytrace::loadBinary - invalid version
    MOV dword ptr [0x02f0ca48],EDI      ; 0049490e | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 00494914 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00494919 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0049491e
    JMP 0x004947e3                      ; 00494921 | LAB_004947e3
        ;   XREF to: 004947e3 (UNCONDITIONAL_JUMP)
    PUSH EBP                            ; 00494926
        ;   Label: LAB_00494926
    CALL core_dtrace.cpp_CDemonRaytrace_allocCubeList_FUN_00494270 ; 00494927 | void core_dtrace.cpp_CDemonRaytrace_allocCubeList_FUN_00494270(CDemonRaytrace * this_ptr)
        ;   XREF to: 00494270 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0049492c
    CMP dword ptr [ESP + 0x24],0x3      ; 0049492f
    JGE 0x00494b94                      ; 00494934 | LAB_00494b94
    ...
    JLE 0x00494ac7                      ; 00494955 | LAB_00494ac7
    ...
    PUSH EDI                            ; 0049496d
    CALL crt_stdio.c_fread_FUN_005fd990 ; 0049496e | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [EDI]             ; 00494973
    ADD ESP,0x10                        ; 00494975
    TEST ECX,ECX                        ; 00494978
    JZ 0x00494a50                       ; 0049497a | LAB_00494a50
        ;   XREF to: 00494a50 (CONDITIONAL_JUMP)
    MOV EBX,ECX                         ; 00494980
    IMUL EAX,ECX,0x38                   ; 00494982
    PUSH 0x172                          ; 00494985
    PUSH 0x6227d6                       ; 0049498a | = "..\\core\\dtrace.cpp" | s_core_dtrace_cpp_006227d6 = ..\core\dtrace.cpp
    ADD EAX,0x4                         ; 0049498f
    PUSH EAX                            ; 00494992
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1f0 ; 00494993 | void * shape_memdbg.cpp_debugAlloc_FUN_0050f1f0(int size, char * filename, int line_number)
        ;   XREF to: 0050f1f0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00494998
    TEST EAX,EAX                        ; 0049499b
    JZ 0x004949a5                       ; 0049499d | LAB_004949a5
        ;   XREF to: 004949a5 (CONDITIONAL_JUMP)
    ADD EAX,0x4                         ; 0049499f
    MOV dword ptr [EAX + -0x4],EBX      ; 004949a2
    PUSH 0x173                          ; 004949a5
        ;   Label: LAB_004949a5
    PUSH 0x6227e9                       ; 004949aa | = "..\\core\\dtrace.cpp" | s_core_dtrace_cpp_006227e9 = ..\core\dtrace.cpp
    MOV EBX,dword ptr [EDI]             ; 004949af
    PUSH EBX                            ; 004949b1
    MOV dword ptr [EDI + 0x4],EAX       ; 004949b2
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1f0 ; 004949b5 | void * shape_memdbg.cpp_debugAlloc_FUN_0050f1f0(int size, char * filename, int line_number)
        ;   XREF to: 0050f1f0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004949ba
    MOV ESI,dword ptr [EDI + 0x4]       ; 004949bd
    MOV dword ptr [EDI + 0x54],EAX      ; 004949c0
    TEST ESI,ESI                        ; 004949c3
    JNZ 0x00494aa7                      ; 004949c5 | LAB_00494aa7
        ;   XREF to: 00494aa7 (CONDITIONAL_JUMP)
    MOV EDX,0x6227fc                    ; 004949cb | = "..\\core\\dtrace.cpp" | s_core_dtrace_cpp_006227fc = ..\core\dtrace.cpp
        ;   Label: LAB_004949cb
    MOV ECX,0x175                       ; 004949d0
    PUSH 0x62280f                       ; 004949d5 | = "CDemonRaytrace::loadBinary - out of m..." | s_CDemonRaytrace_loadBinar_0062280f = CDemonRaytrace::loadBinary - out of memory!
    MOV dword ptr [0x02f0ca48],EDX      ; 004949da | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 004949e0 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004949e6 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ...
    JLE 0x00494a15                      ; 004949f4 | LAB_00494a15
    ...
    PUSH EAX                            ; 00494a02
    INC ESI                             ; 00494a03
    CALL core_dtri.cpp_CDemonTriangle_readDataBinary_FUN_0049a5a0 ; 00494a04 | void core_dtri.cpp_CDemonTriangle_readDataBinary_FUN_0049a5a0(CDemonTriangle * this_ptr, FILE * file_handle)
    ...
    JL 0x004949f8                       ; 00494a13 | LAB_004949f8
        ;   XREF to: 004949f8 (CONDITIONAL_JUMP)
    PUSH 0x17a                          ; 00494a15
        ;   Label: LAB_00494a15
    PUSH 0x62283b                       ; 00494a1a | = "..\\core\\dtrace.cpp" | s_core_dtrace_cpp_0062283b = ..\core\dtrace.cpp
    PUSH 0x388                          ; 00494a1f
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1b0 ; 00494a24 | void * shape_memdbg.cpp_debugAlloc_FUN_0050f1b0(int size, char * filename, int line_number)
        ;   XREF to: 0050f1b0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00494a29
    TEST EAX,EAX                        ; 00494a2c
    JZ 0x00494a39                       ; 00494a2e | LAB_00494a39
        ;   XREF to: 00494a39 (CONDITIONAL_JUMP)
    PUSH EAX                            ; 00494a30
    CALL core_dpart.cpp_CDemonPart_ctor_FUN_00482110 ; 00494a31 | CDemonPart * core_dpart.cpp_CDemonPart_ctor_FUN_00482110(CDemonPart * this_ptr)
    ...
    CALL core_dtrace.cpp_CDemonRaytrace_convertLinearIndexToWorldPosAndCallback_FUN_00494710 ; 00494a48 | void core_dtrace.cpp_CDemonRaytrace_convertLinearIndexToWorldPosAndCallback_FUN_00494710(CDemonRaytrace * this_ptr, void * callback_data, int linear_index, void * user_data)
    ...
    PUSH EAX                            ; 00494a5c
    CALL crt_stdio.c_fread_FUN_005fd990 ; 00494a5d | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00494a62
    CMP dword ptr [ESP + 0x24],0x2      ; 00494a65
    JL 0x00494ab4                       ; 00494a6a | LAB_00494ab4
    ...
    PUSH EDX                            ; 00494a79
    CALL crt_stdio.c_fread_FUN_005fd990 ; 00494a7a | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ...
    JMP 0x00494944                      ; 00494aa2 | LAB_00494944
        ;   XREF to: 00494944 (UNCONDITIONAL_JUMP)
    TEST EAX,EAX                        ; 00494aa7
        ;   Label: LAB_00494aa7
    JZ 0x004949cb                       ; 00494aa9 | LAB_004949cb
        ;   XREF to: 004949cb (CONDITIONAL_JUMP)
    JMP 0x004949ee                      ; 00494aaf | LAB_004949ee
    ...
    PUSH EBX                            ; 00494abc
    CALL crt_memory.c_memset_FUN_005fde40 ; 00494abd | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
        ;   XREF to: 005fde40 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00494ac2
    JMP 0x00494a82                      ; 00494ac5 | LAB_00494a82
        ;   XREF to: 00494a82 (UNCONDITIONAL_JUMP)
    PUSH EBP                            ; 00494ac7
        ;   Label: LAB_00494ac7
    CALL core_dtrace.cpp_CDemonRaytrace_consolidateTriList_FUN_00494450 ; 00494ac8 | void core_dtrace.cpp_CDemonRaytrace_consolidateTriList_FUN_00494450(CDemonRaytrace * this_ptr)
        ;   XREF to: 00494450 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00494acd
    PUSH EBP                            ; 00494ad0
        ;   Label: LAB_00494ad0
    CALL core_dtrace.cpp_CDemonRaytrace_allocNewCubeList_FUN_00494380 ; 00494ad1 | void core_dtrace.cpp_CDemonRaytrace_allocNewCubeList_FUN_00494380(CDemonRaytrace * this_ptr)
        ;   XREF to: 00494380 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00494ad6
    PUSH 0x6228a9                       ; 00494ad9 | = "Converting .GEO file to version 4" | s_Converting_GEO_file_to_v_006228a9 = Converting .GEO file to version 4
    MOV EDI,dword ptr [0x00678a60]      ; 00494ade | CEditorTools * g_CEditorToolsPtr
    PUSH EDI                            ; 00494ae4 | CEditorTools g_CEditorToolsPtr
    XOR EBX,EBX                         ; 00494ae5
    CALL shape_edittool.cpp_CEditorTools_showCenteredProgressDialog_FUN_004a0430 ; 00494ae7 | void shape_edittool.cpp_CEditorTools_showCenteredProgressDialog_FUN_004a0430(CEditorTools * this_ptr, char * message_text)
    ...
    JGE 0x00494d6c                      ; 00494b0b | LAB_00494d6c
    ...
    CALL core_dtrace.cpp_CDemonRaytrace_convertCubeIndexToPosition_FUN_00499ba0 ; 00494b1b | CVector3f * core_dtrace.cpp_CDemonRaytrace_convertCubeIndexToPosition_FUN_00499ba0(CDemonRaytrace * this_ptr, CVector3f * output_position, int cube_index)
    ...
    PUSH EAX                            ; 00494b6e
    CALL core_dcube.cpp_CDemonCube_loadGeometryFromTriangleList_FUN_004570a0 ; 00494b6f | void core_dcube.cpp_CDemonCube_loadGeometryFromTriangleList_FUN_004570a0(CDemonCube * this_ptr, void * triangle_data, int triangle_count, CVector3f * min_bounds, ...)
        ;   XREF to: 004570a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x1c                        ; 00494b74
    TEST BL,0xf                         ; 00494b77
    JZ 0x00494d1d                       ; 00494b7a | LAB_00494d1d
    ...
    JMP 0x00494afc                      ; 00494b8f | LAB_00494afc
    ...
    JGE 0x00494c6b                      ; 00494ba7 | LAB_00494c6b
    ...
    PUSH EBX                            ; 00494bbb
    CALL crt_stdio.c_fread_FUN_005fd990 ; 00494bbc | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [EBX]             ; 00494bc1
    ADD ESP,0x10                        ; 00494bc3
    TEST EDX,EDX                        ; 00494bc6
    JLE 0x00494c52                      ; 00494bc8 | LAB_00494c52
        ;   XREF to: 00494c52 (CONDITIONAL_JUMP)
    PUSH 0x19a                          ; 00494bce
    PUSH 0x62284e                       ; 00494bd3 | = "..\\core\\dtrace.cpp" | s_core_dtrace_cpp_0062284e = ..\core\dtrace.cpp
    PUSH 0x388                          ; 00494bd8
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1b0 ; 00494bdd | void * shape_memdbg.cpp_debugAlloc_FUN_0050f1b0(int size, char * filename, int line_number)
        ;   XREF to: 0050f1b0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00494be2
    TEST EAX,EAX                        ; 00494be5
    JZ 0x00494bf2                       ; 00494be7 | LAB_00494bf2
        ;   XREF to: 00494bf2 (CONDITIONAL_JUMP)
    PUSH EAX                            ; 00494be9
    CALL core_dpart.cpp_CDemonPart_ctor_FUN_00482110 ; 00494bea | CDemonPart * core_dpart.cpp_CDemonPart_ctor_FUN_00482110(CDemonPart * this_ptr)
        ;   XREF to: 00482110 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00494bef
    MOV dword ptr [EBX + 0xc],EAX       ; 00494bf2
        ;   Label: LAB_00494bf2
    TEST EAX,EAX                        ; 00494bf5
    JNZ 0x00494c1b                      ; 00494bf7 | LAB_00494c1b
        ;   XREF to: 00494c1b (CONDITIONAL_JUMP)
    MOV EAX,0x622861                    ; 00494bf9 | = "..\\core\\dtrace.cpp" | s_core_dtrace_cpp_00622861 = ..\core\dtrace.cpp
    MOV EDX,0x19b                       ; 00494bfe
    PUSH 0x622874                       ; 00494c03 | = "Out of memory for cube model loading ..." | s_Out_of_memory_for_cube_m_00622874 = Out of memory for cube model loading dtrace database
    MOV [0x02f0ca48],EAX                ; 00494c08 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 00494c0d | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00494c13 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00494c24
    PUSH EBP                            ; 00494c25
    CALL core_dtrace.cpp_CDemonRaytrace_convertLinearIndexToWorldPosAndCallback_FUN_00494710 ; 00494c26 | void core_dtrace.cpp_CDemonRaytrace_convertLinearIndexToWorldPosAndCallback_FUN_00494710(CDemonRaytrace * this_ptr, void * callback_data, int linear_index, void * user_data)
        ;   XREF to: 00494710 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00494c3a
    CALL crt_stdio.c_fread_FUN_005fd990 ; 00494c3b | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ...
    JMP 0x00494b98                      ; 00494c4d | LAB_00494b98
    ...
    PUSH EBX                            ; 00494c59
    CALL crt_memory.c_memset_FUN_005fde40 ; 00494c5a | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
        ;   XREF to: 005fde40 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00494c5f
    INC ESI                             ; 00494c62
    ADD EDI,0x58                        ; 00494c63
    JMP 0x00494b98                      ; 00494c66 | LAB_00494b98
        ;   XREF to: 00494b98 (UNCONDITIONAL_JUMP)
    ...
    CALL core_dtrace.cpp_CDemonRaytrace_allocTriList_FUN_00494600 ; 00494c75 | void core_dtrace.cpp_CDemonRaytrace_allocTriList_FUN_00494600(CDemonRaytrace * this_ptr)
        ;   XREF to: 00494600 (UNCONDITIONAL_CALL)
    MOV EBX,dword ptr [EBP + 0x4]       ; 00494c7a
    ADD ESP,0x4                         ; 00494c7d
    TEST EBX,EBX                        ; 00494c80
    JLE 0x00494cb0                      ; 00494c82 | LAB_00494cb0
    ...
    PUSH EAX                            ; 00494c90
    INC ESI                             ; 00494c91
    CALL core_dtri.cpp_CDemonTriangle_readDataBinary_FUN_0049a5a0 ; 00494c92 | void core_dtri.cpp_CDemonTriangle_readDataBinary_FUN_0049a5a0(CDemonTriangle * this_ptr, FILE * file_handle)
        ;   XREF to: 0049a5a0 (UNCONDITIONAL_CALL)
    ADD EBX,0x38                        ; 00494c97
    MOV EAX,dword ptr [EBP + 0x4]       ; 00494c9a
    ADD ESP,0x8                         ; 00494c9d
    CMP ESI,EAX                         ; 00494ca0
    JL 0x00494c8a                       ; 00494ca2 | LAB_00494c8a
    ...
    CALL crt_stdio.c_fread_FUN_005fd990 ; 00494cc3 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ...
    JMP 0x00494ccd                      ; 00494d07 | LAB_00494ccd
    ...
    JMP 0x00494ccd                      ; 00494d1b | LAB_00494ccd
        ;   XREF to: 00494ccd (UNCONDITIONAL_JUMP)
    ...
    MOV ESI,dword ptr [0x00678a60]      ; 00494d46 | CEditorTools * g_CEditorToolsPtr
    FSTP float ptr [ESP]                ; 00494d4c
    PUSH ESI                            ; 00494d4f | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_updatePercentage_FUN_004a0530 ; 00494d50 | void shape_edittool.cpp_CEditorTools_updatePercentage_FUN_004a0530(CEditorTools * this_ptr, float progress_min, float progress_max)
    ...
    JMP 0x00494afc                      ; 00494d67 | LAB_00494afc
        ;   XREF to: 00494afc (UNCONDITIONAL_JUMP)
    MOV EBX,dword ptr [0x00678a60]      ; 00494d6c | CEditorTools g_CEditorToolsPtr | CEditorTools * g_CEditorToolsPtr
        ;   Label: LAB_00494d6c
    PUSH EBX                            ; 00494d72 | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_restoreWindowAndCleanup_FUN_004a0dd0 ; 00494d73 | void shape_edittool.cpp_CEditorTools_restoreWindowAndCleanup_FUN_004a0dd0(CEditorTools * this_ptr)
        ;   XREF to: 004a0dd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00494d78
    PUSH EBP                            ; 00494d7b
    CALL core_dtrace.cpp_CDemonRaytrace_freeCubeList_FUN_004942d0 ; 00494d7c | void core_dtrace.cpp_CDemonRaytrace_freeCubeList_FUN_004942d0(CDemonRaytrace * this_ptr)
        ;   XREF to: 004942d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00494d81
    PUSH EBP                            ; 00494d84
    MOV ESI,0x1                         ; 00494d85
    CALL core_dtrace.cpp_CDemonRaytrace_freeTriList_FUN_00494690 ; 00494d8a | void core_dtrace.cpp_CDemonRaytrace_freeTriList_FUN_00494690(CDemonRaytrace * this_ptr)
        ;   XREF to: 00494690 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00494d8f
    MOV dword ptr [0x02cee5ac],ESI      ; 00494d92 | undefined4 DAT_02cee5ac
    MOV EAX,dword ptr [ESP + 0x58]      ; 00494d98
        ;   Label: LAB_00494d98
    TEST byte ptr [EAX + 0xc],0x20      ; 00494d9c
    JNZ 0x00494daa                      ; 00494da0 | LAB_00494daa
    ...
    POP EBX                             ; 00494da8
    RET                                 ; 00494da9
    MOV EDX,0x6228cb                    ; 00494daa | = "..\\core\\dtrace.cpp" | s_core_dtrace_cpp_006228cb = ..\core\dtrace.cpp
        ;   Label: LAB_00494daa
    MOV ECX,0x1ff                       ; 00494daf
    PUSH 0x6228de                       ; 00494db4 | = "CDemonRaytrace::loadBinary - error re..." | s_CDemonRaytrace_loadBinar_006228de = CDemonRaytrace::loadBinary - error reading file
    MOV dword ptr [0x02f0ca48],EDX      ; 00494db9 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 00494dbf | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00494dc5 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
