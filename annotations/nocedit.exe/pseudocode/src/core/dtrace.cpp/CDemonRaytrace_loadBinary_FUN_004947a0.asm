...
section .text
    ...
    CALL core_dcube.cpp_CDemonCube_load_FUN_00457530 ; 004948f2
        ;   XREF to: 00457530 (UNCONDITIONAL_CALL)  ; void core_dcube.cpp_CDemonCube_load_FUN_00457530(CDemonCube * this_ptr, _FILE * file_handle)
    ...
    PUSH EAX                            ; 00494992
    CALL shape_memdbg.cpp_debugAllocTracked2_FUN_0050f1f0 ; 00494993
    ...
    CALL shape_memdbg.cpp_debugAllocTracked2_FUN_0050f1f0 ; 004949b5
        ;   XREF to: 0050f1f0 (UNCONDITIONAL_CALL)  ; void * shape_memdbg.cpp_debugAllocTracked2_FUN_0050f1f0(int size, char * filename, int line_number)
    ...
    CALL core_dtri.cpp_CDemonTriangle_readDataBinary_FUN_0049a5a0 ; 00494a04
        ;   XREF to: 0049a5a0 (UNCONDITIONAL_CALL)  ; void core_dtri.cpp_CDemonTriangle_readDataBinary_FUN_0049a5a0(CDemonTriangle * this_ptr, _FILE * file_handle)
    ...
    PUSH 0x388                          ; 00494a1f
    CALL shape_memdbg.cpp_debugAllocTracked1_FUN_0050f1b0 ; 00494a24
    ...
    PUSH 0x388                          ; 00494bd8
    CALL shape_memdbg.cpp_debugAllocTracked1_FUN_0050f1b0 ; 00494bdd
        ;   XREF to: 0050f1b0 (UNCONDITIONAL_CALL)  ; void * shape_memdbg.cpp_debugAllocTracked1_FUN_0050f1b0(int size, char * filename, int line_number)
