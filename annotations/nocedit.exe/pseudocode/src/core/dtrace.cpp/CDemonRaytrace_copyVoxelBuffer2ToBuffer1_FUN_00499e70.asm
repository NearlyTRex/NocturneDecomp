...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_dtrace_cpp_CDemonRaytrace_copyVoxelBuffer2ToBuffer1_FUN_00499e70(CDemonRaytrace *this_ptr)
;
; Parameters:
...
section .text
    ...
    JLE 0x00499ed9                      ; 00499e85
        ;   XREF to: 00499ed9 (CONDITIONAL_JUMP)  ; LAB_00499ed9
    XOR EDI,EDI                         ; 00499e87
        ;   Label: LAB_00499e87
    MOV EAX,dword ptr [EBP + 0x44]      ; 00499e89
    MOV dword ptr [ESP + 0x4],EDI       ; 00499e8c
    TEST EAX,EAX                        ; 00499e90
    JLE 0x00499ecb                      ; 00499e92
        ;   XREF to: 00499ecb (CONDITIONAL_JUMP)  ; LAB_00499ecb
    MOV ESI,dword ptr [EBP + 0x48]      ; 00499e94
        ;   Label: LAB_00499e94
    XOR EBX,EBX                         ; 00499e97
    TEST ESI,ESI                        ; 00499e99
    JLE 0x00499ebb                      ; 00499e9b
        ;   XREF to: 00499ebb (CONDITIONAL_JUMP)  ; LAB_00499ebb
    PUSH EBX                            ; 00499e9d
        ;   Label: LAB_00499e9d
    ...
    PUSH EDX                            ; 00499ea7
    PUSH EBP                            ; 00499ea8
    CALL core_dtrace.cpp_CDemonRaytrace_getCubeAt_FUN_004952b0 ; 00499ea9
    ...
    JNZ 0x00499ee1                      ; 00499eb3
        ;   XREF to: 00499ee1 (CONDITIONAL_JUMP)  ; LAB_00499ee1
    INC EBX                             ; 00499eb5
        ;   Label: LAB_00499eb5
    CMP EBX,dword ptr [EBP + 0x48]      ; 00499eb6
    JL 0x00499e9d                       ; 00499eb9
        ;   XREF to: 00499e9d (CONDITIONAL_JUMP)  ; LAB_00499e9d
    ...
    JL 0x00499e94                       ; 00499ec9
        ;   XREF to: 00499e94 (CONDITIONAL_JUMP)  ; LAB_00499e94
    ...
    JL 0x00499e87                       ; 00499ed7
        ;   XREF to: 00499e87 (CONDITIONAL_JUMP)  ; LAB_00499e87
    ...
    JZ 0x00499eb5                       ; 00499ee5
        ;   XREF to: 00499eb5 (CONDITIONAL_JUMP)  ; LAB_00499eb5
    MOV ESI,dword ptr [EAX + 0x4]       ; 00499ee7
    TEST ESI,ESI                        ; 00499eea
    JZ 0x00499eb5                       ; 00499eec
        ;   XREF to: 00499eb5 (CONDITIONAL_JUMP)  ; LAB_00499eb5
    ...
    POP EDI                             ; 00499f04
    JMP 0x00499eb5                      ; 00499f05
        ;   XREF to: 00499eb5 (UNCONDITIONAL_JUMP)  ; LAB_00499eb5
