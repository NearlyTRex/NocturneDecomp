...
;                               FUNCTION
; *****************************************************************************
; __cdecl float core_dtrace.cpp_CDemonRaytrace_getVoxelHeightAtPosition_FUN_00499170(CDemonRaytrace * this_ptr, CVector3f * world_position)
;
; Parameters:
...
section .text
    ...
    FXCH ST2                            ; 00499199
    CALL crt_math.c_round_FUN_005fe6b0  ; 0049919b | double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    FLD float ptr [0x00622d4e]          ; 004991b8 | float g_VoxelSizeReciprocal
    FLD float ptr [EBX + 0x28]          ; 004991be
    FMUL ST1                            ; 004991c1
    FDIVP ST2,ST0                       ; 004991c3
    FXCH ST2                            ; 004991c5
    CALL crt_math.c_round_FUN_005fe6b0  ; 004991c7 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    FDIVP                               ; 004991ea
    FXCH ST3                            ; 004991ec
    CALL crt_math.c_round_FUN_005fe6b0  ; 004991ee | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 00499213 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x10]        ; 00499218
    MOV EDX,dword ptr [ESP + 0x10]      ; 0049921c
    FXCH                                ; 00499220
    CALL crt_math.c_round_FUN_005fe6b0  ; 00499222 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x18]        ; 00499227
    CALL crt_math.c_round_FUN_005fe6b0  ; 0049922b | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP]               ; 00499230
    TEST EDX,EDX                        ; 00499233
    JL 0x004992d3                       ; 00499235 | LAB_004992d3
        ;   XREF to: 004992d3 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [ESP + 0x18]      ; 0049923b
    TEST ECX,ECX                        ; 0049923f
    JL 0x004992d3                       ; 00499241 | LAB_004992d3
        ;   XREF to: 004992d3 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [ESP]             ; 00499247
    TEST ESI,ESI                        ; 0049924a
    JL 0x004992d3                       ; 0049924c | LAB_004992d3
        ;   XREF to: 004992d3 (CONDITIONAL_JUMP)
    CMP EDX,0x8                         ; 00499252
    JGE 0x004992d3                      ; 00499255 | LAB_004992d3
        ;   XREF to: 004992d3 (CONDITIONAL_JUMP)
    CMP ECX,0x8                         ; 0049925b
    JGE 0x004992d3                      ; 0049925e | LAB_004992d3
        ;   XREF to: 004992d3 (CONDITIONAL_JUMP)
    CMP ESI,0x8                         ; 00499264
    JGE 0x004992d3                      ; 00499267 | LAB_004992d3
        ;   XREF to: 004992d3 (CONDITIONAL_JUMP)
    ...
    PUSH ECX                            ; 0049927a
    PUSH EBX                            ; 0049927b
    CALL core_dtrace.cpp_CDemonRaytrace_getCubeAt_FUN_004952b0 ; 0049927c | CDemonCube * core_dtrace.cpp_CDemonRaytrace_getCubeAt_FUN_004952b0(CDemonRaytrace * this_ptr, int grid_x, int grid_y, int grid_z)
        ;   XREF to: 004952b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00499281
    TEST EAX,EAX                        ; 00499284
    JZ 0x004992e7                       ; 00499286 | LAB_004992e7
        ;   XREF to: 004992e7 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [EAX]             ; 00499288
    TEST EDI,EDI                        ; 0049928a
    JZ 0x004992b2                       ; 0049928c | LAB_004992b2
    ...
    MOV AL,byte ptr [EAX + 0x6789f8]    ; 004992a3 | uchar[8] g_VoxelYBitMasks
    AND EAX,0xff                        ; 004992a9
    TEST EDX,EAX                        ; 004992ae
    JNZ 0x004992f1                      ; 004992b0 | LAB_004992f1
    ...
    JGE 0x0049926c                      ; 004992bd | LAB_0049926c
    ...
    JMP 0x0049926c                      ; 004992d1 | LAB_0049926c
    ...
    MOV dword ptr [ESP + 0x4],0xc479f99a ; 004992e7
        ;   Label: LAB_004992e7
    JMP 0x004992db                      ; 004992ef | LAB_004992db
    ...
    FMUL float ptr [0x00622d4e]         ; 00499312 | float g_VoxelSizeReciprocal
    FADDP                               ; 00499318
