...

{
  ...
  bVar4 = 0;
  local_24 = (double)((world_position->x - (this_ptr->bbox_min).x) / (this_ptr->adjusted_size).x);
  uStack_2c = (double)CONCAT44 /* combine 2-byte values */(0x4998a2,(uint)uStack_2c);
  ...
  uStack_2c = (double)CONCAT44 /* combine 2-byte values */(uStack_2c._4_4_,0x4998ea);
  dVar6 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44 /* combine 2-byte values */(in_EDX,in_EAX));
