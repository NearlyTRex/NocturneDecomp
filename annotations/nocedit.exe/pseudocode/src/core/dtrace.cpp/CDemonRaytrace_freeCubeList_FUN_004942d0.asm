...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_dtrace_cpp_CDemonRaytrace_freeCubeList_FUN_004942d0(CDemonRaytrace *this_ptr)
;
; Parameters:
...
section .text
    ...
    JZ 0x0049436c                       ; 004942da
        ;   XREF to: 0049436c (CONDITIONAL_JUMP)  ; LAB_0049436c
    PUSH EDI                            ; 004942e0
    PUSH EBX                            ; 004942e1
    ...
    JGE 0x00494354                      ; 004942f7
        ;   XREF to: 00494354 (CONDITIONAL_JUMP)  ; LAB_00494354
    ...
    JNZ 0x00494326                      ; 00494317
        ;   XREF to: 00494326 (CONDITIONAL_JUMP)  ; LAB_00494326
    ADD EDI,0x58                        ; 00494319
        ;   Label: LAB_00494319
    INC EBP                             ; 0049431c
    MOV dword ptr [EBX + 0xc],0x0       ; 0049431d
    JMP 0x004942e6                      ; 00494324
        ;   XREF to: 004942e6 (UNCONDITIONAL_JUMP)  ; LAB_004942e6
    MOV ECX,0x9c                        ; 00494326
        ;   Label: LAB_00494326
    MOV EDX,0x6225df                    ; 0049432b | = "..\\core\\dtrace.cpp"
    MOV dword ptr [0x02f0d944],ECX      ; 00494330 | g_CurrentDebugLine
    MOV dword ptr [0x0067d20c],EDX      ; 00494336 | g_CurrentDebugFilename
    JZ 0x00494319                       ; 0049433c
        ;   XREF to: 00494319 (CONDITIONAL_JUMP)  ; LAB_00494319
    PUSH 0x0                            ; 0049433e
    PUSH EAX                            ; 00494340
    ...
    JMP 0x00494319                      ; 00494352
        ;   XREF to: 00494319 (UNCONDITIONAL_JUMP)  ; LAB_00494319
    PUSH 0xa0                           ; 00494354
        ;   Label: LAB_00494354
    PUSH 0x6225f2                       ; 00494359 | = "..\\core\\dtrace.cpp"
    MOV EBX,dword ptr [ESI + 0x4c]      ; 0049435e
    PUSH EBX                            ; 00494361
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 00494362
