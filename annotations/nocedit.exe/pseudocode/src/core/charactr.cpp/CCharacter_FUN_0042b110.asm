...
section .text
    ...
    CALL core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_005a0820 ; 0042b124 | CSkeleton * core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_005a0820(CDeformableModelInstance * this_ptr)
        ;   XREF to: 005a0820 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0042b129
    MOV EDX,dword ptr [EBP + 0x2f10]    ; 0042b12c
    MOV dword ptr [ESP],EAX             ; 0042b132
    TEST EDX,EDX                        ; 0042b135
    JLE 0x0042b178                      ; 0042b137 | LAB_0042b178
    ...
    JZ 0x0042b164                       ; 0042b14f | LAB_0042b164
    ...
    JNZ 0x0042b180                      ; 0042b162 | LAB_0042b180
    ...
    JL 0x0042b141                       ; 0042b176 | LAB_0042b141
    ...
    JMP 0x0042b164                      ; 0042b18d | LAB_0042b164
