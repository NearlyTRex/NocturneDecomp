...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_charactr_cpp_CCharacter_spawnGoreAtBone_FUN_0042b760 (CCharacter *this_ptr,int part_index,int bone_index,float chance)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0042b760
        ;   Label: core_charactr.cpp_CCharacter_spawnGoreAtBone_FUN_0042b760
    ...
    CALL core_gore.cpp_CGore_FUN_004edaa0 ; 0042b7f3
