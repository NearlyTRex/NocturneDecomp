...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_charactr_cpp_CCharacter_preProcess_FUN_00429820(CCharacter *this_ptr)
;
; Parameters:
...
;   core_beast.cpp_CBeast_process_FUN_004182a0 at 00418303
;   core_biggs.cpp_CBiggs_process_FUN_00418700 at 004188d0
;   core_boneguy.cpp_CBoneGuy_process_FUN_0041bf90 at 0041c513
...
section .text
    ...
    SUB ESP,0xc                         ; 00429820
        ;   Label: core_charactr.cpp_CCharacter_preProcess_FUN_00429820
    ...
    CALL core_charactr.cpp_CCharacter_setOrientation_FUN_0042ded0 ; 0042985d
