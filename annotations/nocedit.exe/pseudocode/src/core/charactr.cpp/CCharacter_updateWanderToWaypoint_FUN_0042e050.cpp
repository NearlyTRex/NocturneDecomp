...

{
  ...
  fVar5 = (float)this_ptr->field37_0x25f4 - delta_time;
...
LAB_0042e20c:
  ...
  path_map = (CPathMap *)(**(code **)(*(int *)(this_ptr->field36_0x25f0 + 0x154) + 0xbc))();
  iVar4 = core_charactr_cpp_CCharacter_walkToPoint_FUN_004286e0
                    (this_ptr,(CVector3f *)(this_ptr->field36_0x25f0 + 0x20),path_map,direction,
                     fVar5,fVar6);
  if (iVar4 == 0) {
    return 1;
  }
