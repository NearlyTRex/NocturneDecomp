...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_charactr.cpp_CCharacter_FUN_0042e050(CCharacter * this_ptr)
;
; Parameters:
...
section .text
    ...
    JZ 0x0042e180                       ; 0042e06a | LAB_0042e180
        ;   XREF to: 0042e180 (CONDITIONAL_JUMP)
    CMP byte ptr [EDX],0x0              ; 0042e070
    JZ 0x0042e180                       ; 0042e073 | LAB_0042e180
        ;   XREF to: 0042e180 (CONDITIONAL_JUMP)
    ...
    FADDP                               ; 0042e0c7
    FSQRT                               ; 0042e0c9
    FCOMP double ptr [0x006174d2]       ; 0042e0cb | double DOUBLE_006174d2
    FNSTSW AX                           ; 0042e0d1
    SAHF                                ; 0042e0d3
    JNC 0x0042e1ab                      ; 0042e0d4 | LAB_0042e1ab
        ;   XREF to: 0042e1ab (CONDITIONAL_JUMP)
    ...
    MOV ESI,dword ptr [0x006810c8]      ; 0042e11d | CDemonSet * g_CDemonSetPtr
        ;   Label: LAB_0042e11d
    MOV EAX,dword ptr [ESP + 0x1f60]    ; 0042e123
    CMP EAX,dword ptr [ESI + 0x154e64]  ; 0042e12a | DAT_032690dc
    JGE 0x0042e279                      ; 0042e130 | LAB_0042e279
        ;   XREF to: 0042e279 (CONDITIONAL_JUMP)
    ADD ESI,dword ptr [ESP + 0x1f5c]    ; 0042e136
    PUSH 0x0                            ; 0042e13d
    MOV ESI,dword ptr [ESI + 0x154e68]  ; 0042e13f | DAT_032690e0
    PUSH ESI                            ; 0042e145
    MOV EDX,dword ptr [ESP + 0x1f94]    ; 0042e146
    PUSH EDX                            ; 0042e14d
    CALL shape_edittool.cpp_wildcardStringMatch_FUN_004a6e20 ; 0042e14e | int shape_edittool.cpp_wildcardStringMatch_FUN_004a6e20(char * pattern, char * target_string, int case_sensitive)
        ;   XREF to: 004a6e20 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0042e153
    TEST EAX,EAX                        ; 0042e156
    JNZ 0x0042e227                      ; 0042e158 | LAB_0042e227
    ...
    JMP 0x0042e11d                      ; 0042e17e | LAB_0042e11d
    ...
    CMP dword ptr [EDI + 0x25f0],0x0    ; 0042e1ab
        ;   Label: LAB_0042e1ab
    JZ 0x0042e0e4                       ; 0042e1b2 | LAB_0042e0e4
        ;   XREF to: 0042e0e4 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [EDI + 0x25ec]    ; 0042e1b8
    TEST ESI,ESI                        ; 0042e1be
    JZ 0x0042e0ee                       ; 0042e1c0 | LAB_0042e0ee
        ;   XREF to: 0042e0ee (CONDITIONAL_JUMP)
    PUSH ESI                            ; 0042e1c6
    LEA EAX,[EDI + 0x20]                ; 0042e1c7
    PUSH EAX                            ; 0042e1ca
    CALL core_waypoint.cpp_FUN_005ec320 ; 0042e1cb | undefined core_waypoint.cpp_FUN_005ec320()
    ...
    CMP dword ptr [EDI + 0x25f0],0x0    ; 0042e1d9
        ;   Label: LAB_0042e1d9
    JZ 0x0042e2f6                       ; 0042e1e0 | LAB_0042e2f6
        ;   XREF to: 0042e2f6 (CONDITIONAL_JUMP)
    PUSH 0x40000000                     ; 0042e1e6
    PUSH 0x3f800000                     ; 0042e1eb
    CALL core_actor.cpp_getRandomFloat_FUN_0040cc10 ; 0042e1f0 | float core_actor.cpp_getRandomFloat_FUN_0040cc10(float min_value, float max_value)
        ;   Label: LAB_0042e1f0
        ;   XREF to: 0040cc10 (UNCONDITIONAL_CALL)
    MOV EBX,dword ptr [EDI + 0x25f0]    ; 0042e20c
        ;   Label: LAB_0042e20c
    TEST EBX,EBX                        ; 0042e212
    JNZ 0x0042e305                      ; 0042e214 | LAB_0042e305
    ...
    FADDP                               ; 0042e24b
    FSQRT                               ; 0042e24d
    FCOMP float ptr [0x006174da]        ; 0042e24f | float FLOAT_006174da
    FNSTSW AX                           ; 0042e255
    SAHF                                ; 0042e257
    JC 0x0042e15e                       ; 0042e258 | LAB_0042e15e
    ...
    JMP 0x0042e15e                      ; 0042e274 | LAB_0042e15e
        ;   XREF to: 0042e15e (UNCONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x1f58],0x0    ; 0042e279
        ;   Label: LAB_0042e279
    JLE 0x0042e1d9                      ; 0042e281 | LAB_0042e1d9
    ...
    PUSH EAX                            ; 0042e2a2
    PUSH 0x0                            ; 0042e2a3
    CALL core_actor.cpp_getRandomInt_FUN_0040cc70 ; 0042e2a5 | int core_actor.cpp_getRandomInt_FUN_0040cc70(int min_value, int max_value)
    ...
    PUSH EAX                            ; 0042e32a
    PUSH EDI                            ; 0042e32b
    CALL core_charactr.cpp_CCharacter_walkToPoint_FUN_004286e0 ; 0042e32c | int core_charactr.cpp_CCharacter_walkToPoint_FUN_004286e0(CCharacter * this_ptr)
        ;   XREF to: 004286e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x18                        ; 0042e331
    TEST EAX,EAX                        ; 0042e334
    JZ 0x0042e347                       ; 0042e336 | LAB_0042e347
        ;   XREF to: 0042e347 (CONDITIONAL_JUMP)
    JL 0x0042e357                       ; 0042e338 | LAB_0042e357
