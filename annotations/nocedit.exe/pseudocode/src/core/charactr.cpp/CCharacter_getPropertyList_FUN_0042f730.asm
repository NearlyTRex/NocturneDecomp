...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_charactr_cpp_CCharacter_getPropertyList_FUN_0042f730 (CCharacter *this_ptr,CActorPropertyList *property_list)
;
; Parameters:
...
section .text
    ...
    PUSH ESI                            ; 0042f752
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e500 ; 0042f753
        ;   XREF to: 0040e500 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_CActorPropertyList_FUN_0040e500(CActorPropertyList * this_ptr)
    ...
    PUSH ESI                            ; 0042f78a
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e670 ; 0042f78b
    ...
    PUSH ESI                            ; 0042f79f
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e480 ; 0042f7a0
    ...
    PUSH ESI                            ; 0042f7b4
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e330 ; 0042f7b5
    ...
    PUSH ESI                            ; 0042f7cd
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e290 ; 0042f7ce
    ...
    PUSH ESI                            ; 0042f7e9
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e640 ; 0042f7ea
