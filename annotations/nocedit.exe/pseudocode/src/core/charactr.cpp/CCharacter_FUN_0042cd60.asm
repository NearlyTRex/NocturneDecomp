...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_charactr.cpp_CCharacter_FUN_0042cd60(CCharacter * this_ptr)
;
; Parameters:
...
section .text
    ...
    JNZ 0x0042cd71                      ; 0042cd6d | LAB_0042cd71
        ;   XREF to: 0042cd71 (CONDITIONAL_JUMP)
    POP EBX                             ; 0042cd6f
    RET                                 ; 0042cd70
    PUSH EDX                            ; 0042cd71
        ;   Label: LAB_0042cd71
    CALL core_door.cpp_FUN_0047fcf0     ; 0042cd72 | undefined core_door.cpp_FUN_0047fcf0()
