...

{
  ...
  core_actor_cpp_CDemonActor_worldToLocalPoint_FUN_00408f10
            (&this_ptr->base_actor,(CVector3f *)&local_10,world_point);
  iVar1 = (*((this_ptr->base_actor).vtable._ub)->testCylinderCollision)
                    (&this_ptr->base_actor,(SCollisionReturnInfo *)&local_10,tolerance);
  if (iVar1 == 0) {
    in_stack_0000001c->damage_amount = 0.0;
    return 0;
  }
  local_10 = 6.130527e-39;
  (*(((this_ptr->base_actor).vtable._uc)->_uc).processDamage)(this_ptr,in_stack_0000001c);
  return 1;
}
