...
// Convention: __cdecl
// Signature: void __cdecl core_charactr_cpp_CCharacter_FUN_0042b8e0(CCharacter *this_ptr)
...

{
  ...
  core_skeleton_cpp_CDeformableModelInstance_shatter_FUN_005a14b0
            (&this_ptr->model,&(this_ptr->base).location.position,
             (CVector3f *)&(this_ptr->base).orient,0);
  (this_ptr->base).was_created = 2;
  return;
}
