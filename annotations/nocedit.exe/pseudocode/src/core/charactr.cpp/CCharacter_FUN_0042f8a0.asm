...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_charactr.cpp_CCharacter_FUN_0042f8a0(CCharacter * this_ptr)
;
; Parameters:
; CCharacter *     Stack[0x4]:4   this_ptr
;
; XREF[9]:
;   core_baron.cpp_CBaron_FUN_00413ff0 at 00413ffa
;   core_colonel.cpp_FUN_004405f0 at 004405fa
;   core_gabriela.cpp_FUN_004d75e0 at 004d75eb
;   core_haystack.cpp_FUN_004f1cb0 at 004f1cba
;   core_icepick.cpp_FUN_004f9780 at 004f978a
;   core_mimic.cpp_FUN_00520da0 at 00520dbc
...
section .text
    ...
    PUSH EBX                            ; 0042f8aa
    PUSH ESI                            ; 0042f8ab
    CALL core_actor.cpp_CDemonActor_onActorDeleted_FUN_0040d000 ; 0042f8ac | void core_actor.cpp_CDemonActor_onActorDeleted_FUN_0040d000(CDemonActor * this_ptr, CDemonActor * deleted_actor)
    ...
    JNZ 0x0042f8bc                      ; 0042f8dd | LAB_0042f8bc
        ;   XREF to: 0042f8bc (CONDITIONAL_JUMP)
    POP ESI                             ; 0042f8df
    POP EBX                             ; 0042f8e0
    RET                                 ; 0042f8e1
