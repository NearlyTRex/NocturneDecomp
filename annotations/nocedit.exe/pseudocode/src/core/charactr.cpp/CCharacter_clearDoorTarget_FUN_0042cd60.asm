...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_charactr_cpp_CCharacter_clearDoorTarget_FUN_0042cd60(CCharacter *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0042cd60
        ;   Label: core_charactr.cpp_CCharacter_clearDoorTarget_FUN_0042cd60
