...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_charactr_cpp_CCharacter_setOrientation_FUN_0042ded0 (CCharacter *this_ptr,UOrientationVector *orientation)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0042ded0
        ;   Label: core_charactr.cpp_CCharacter_setOrientation_FUN_0042ded0
    PUSH ESI                            ; 0042ded1
