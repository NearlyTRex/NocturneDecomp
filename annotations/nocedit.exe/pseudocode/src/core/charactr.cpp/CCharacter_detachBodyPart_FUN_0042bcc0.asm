...
;   core_batman.cpp_CBatman_processDismemberment_FUN_00417660 at 004177a1
;   core_charactr.cpp_CCharacter_dismember_FUN_0042b9e0 at 0042ba66
;   core_cow.cpp_CZombieCow_processDismemberment_FUN_004448c0 at 00444a22
...
section .text
    ...
    PUSH EBX                            ; 0042bcc0
        ;   Label: core_charactr.cpp_CCharacter_detachBodyPart_FUN_0042bcc0
    PUSH ESI                            ; 0042bcc1
    PUSH EBP                            ; 0042bcc2
    ...
    CALL core_charactr.cpp_CCharacter_dismemberPartInternal_FUN_0042bd30 ; 0042bd14
