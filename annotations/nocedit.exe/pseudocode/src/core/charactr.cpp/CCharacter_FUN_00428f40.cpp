...

{
  ...
  do {
    ...
    do {
      ...
      *(undefined4 *)pcVar7 = *(undefined4 *)(pcVar7 + 8);
      pcVar13[8] = '\0';
      pcVar13[9] = '\0';
      pcVar13[10] = '\0';
      pcVar13[0xb] = '\0';
      pcVar7 = pcVar7 + 0xc;
      *(undefined4 *)(pcVar13 + 4) = *(undefined4 *)(pcVar13 + 8);
      *(undefined4 *)pcVar13 = *(undefined4 *)(pcVar13 + 8);
      pcVar13 = pcVar13 + 0xc;
  ...
  do {
    ...
    if (local_28 < fVar8) {
      local_28 = this_ptr->size_scale * (float)DOUBLE_00617072 + fVar8;
    }
    local_9c._0_4_ = SUB84(dVar5,0);
    ...
    if (0.0 <= fVar8) {
      ...
      *(float *)(this_ptr->field2_0x240c + 8) = fVar8;
      ...
      fVar8 = (float)DOUBLE_00617082 - fStack_94;
      ...
      fVar8 = fVar8 * (float)DOUBLE_0061707a;
      ...
      local_30 = fVar8 + (float)DOUBLE_0061708a;
...
// 00429488: CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0
