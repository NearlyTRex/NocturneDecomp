...
int __cdecl
core_charactr_cpp_CCharacter_attractActorToward_FUN_0042c010
          (CCharacter *this_ptr,CDemonActor *actor,CVector3f *target_local_point)

{
  ...
  if ((actor != (CDemonActor *)0x0) &&
    ...
    pCVar2 = core_actor_cpp_CDemonActor_localToWorldPoint_FUN_00408ec0
                       (actor,(CVector3f *)&stack0xffffffbc,target_local_point);
    ...
    (*((actor->vtable)._ub)->setPositionAndOrientation)(actor,&local_38,&(actor->orient).vec);
    return 1;
  }
  return 0;
}
