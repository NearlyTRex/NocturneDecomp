...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_charactr_cpp_CCharacter_renderFlames_FUN_0042b110(CCharacter *this_ptr)
;
; Parameters:
...
;
; XREF[1]:
;   core_charactr.cpp_CCharacter_renderTransparent_FUN_0042b0e0 at 0042b100
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 0042b110
        ;   Label: core_charactr.cpp_CCharacter_renderFlames_FUN_0042b110
    PUSH ESI                            ; 0042b111
    PUSH EDI                            ; 0042b112
    PUSH EBP                            ; 0042b113
