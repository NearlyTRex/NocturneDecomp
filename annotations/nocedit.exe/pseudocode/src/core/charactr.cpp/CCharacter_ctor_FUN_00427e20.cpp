...

{
  ...
  pCVar3 = core_cloth_cpp_CClothList_ctor_FUN_0043bf40
                     ((CClothList *)(pCVar2[1].rest_pose_data + 0x5d));
  pvVar4 = __arrinit(pCVar3[1].filenames[0] + 8,0xf,&g_CVectorTypeInfo);
  pvVar4 = __arrinit((void *)((int)pvVar4 + 0xb4),0xf,&g_CVectorTypeInfo);
  pvVar4 = __arrinit((void *)((int)pvVar4 + 0x20c),0x32,&g_SFireTypeInfo);
  pvVar4 = __arrinit((void *)((int)pvVar4 + 0x4b0),0x32,&g_CFlameTypeInfo)
  ;
  *(CDemonActor_vtable **)((int)pvVar4 + -0x3278) = &g_CCharacterVTable;
  ...
  *(uint *)((int)pvVar4 + -0xde8) = 0xffffffff;
  pCVar5 = (CCharacter *)((int)pvVar4 + -0x33cc);
  do {
  ...
  } while (pfVar6 != (float *)((int)pvVar4 + -0x3344));
  ...
  *(byte *)((int)pvVar4 + -0xe98) = 0;
  return (CCharacter *)((int)pvVar4 + -0x33cc);
}
