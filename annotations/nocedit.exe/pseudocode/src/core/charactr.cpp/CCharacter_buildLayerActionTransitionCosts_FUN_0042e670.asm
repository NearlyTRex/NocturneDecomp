...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_charactr_cpp_CCharacter_buildLayerActionTransitionCosts_FUN_0042e670(CCharacter *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0042e670
        ;   Label: core_charactr.cpp_CCharacter_buildLayerActionTransitionCosts_FUN_0042e670
    PUSH ESI                            ; 0042e671
    PUSH EDI                            ; 0042e672
    PUSH EBP                            ; 0042e673
    ...
    JZ 0x0042e803                       ; 0042e682
        ;   XREF to: 0042e803 (CONDITIONAL_JUMP)  ; LAB_0042e803
    ...
    JNZ 0x0042e696                      ; 0042e6a5
        ;   XREF to: 0042e696 (CONDITIONAL_JUMP)  ; LAB_0042e696
    INC EBX                             ; 0042e6a7
    ADD EAX,0x50                        ; 0042e6a8
    CMP EBX,0x14                        ; 0042e6ab
    JL 0x0042e68d                       ; 0042e6ae
        ;   XREF to: 0042e68d (CONDITIONAL_JUMP)  ; LAB_0042e68d
    MOV EAX,dword ptr [ESP + 0x2c]      ; 0042e6b0
    ADD EAX,0x158                       ; 0042e6b4
    PUSH EAX                            ; 0042e6b9
    CALL core_motion.cpp_CMotionController_getMotionList_FUN_0052dce0 ; 0042e6ba
    ...
    JLE 0x0042e762                      ; 0042e6d2
        ;   XREF to: 0042e762 (CONDITIONAL_JUMP)  ; LAB_0042e762
    ...
    JL 0x0042e746                       ; 0042e72e
        ;   XREF to: 0042e746 (CONDITIONAL_JUMP)  ; LAB_0042e746
    ...
    CMP dword ptr [EBX + 0x28],0x0      ; 0042e746
        ;   Label: LAB_0042e746
    JLE 0x0042e80b                      ; 0042e74a
        ;   XREF to: 0042e80b (CONDITIONAL_JUMP)  ; LAB_0042e80b
    ...
    JL 0x0042e6eb                       ; 0042e760
        ;   XREF to: 0042e6eb (CONDITIONAL_JUMP)  ; LAB_0042e6eb
    ...
    JNZ 0x0042e768                      ; 0042e77e
        ;   XREF to: 0042e768 (CONDITIONAL_JUMP)  ; LAB_0042e768
    ...
    FNSTSW AX                           ; 0042e7ce
    SAHF                                ; 0042e7d0
    JC 0x0042e826                       ; 0042e7d1
        ;   XREF to: 0042e826 (CONDITIONAL_JUMP)  ; LAB_0042e826
    ADD ECX,0x4                         ; 0042e7d3
        ;   Label: LAB_0042e7d3
    ADD EDX,0x4                         ; 0042e7d6
    CMP ECX,EBX                         ; 0042e7d9
    JNZ 0x0042e7b8                      ; 0042e7db
        ;   XREF to: 0042e7b8 (CONDITIONAL_JUMP)  ; LAB_0042e7b8
    ...
    JL 0x0042e7a5                       ; 0042e7ef
        ;   XREF to: 0042e7a5 (CONDITIONAL_JUMP)  ; LAB_0042e7a5
    ...
    JNZ 0x0042e790                      ; 0042e801
        ;   XREF to: 0042e790 (CONDITIONAL_JUMP)  ; LAB_0042e790
    ...
    JMP 0x0042e750                      ; 0042e821
        ;   XREF to: 0042e750 (UNCONDITIONAL_JUMP)  ; LAB_0042e750
    MOV EAX,dword ptr [ESP + 0x14]      ; 0042e826
        ;   Label: LAB_0042e826
    MOV dword ptr [EDX + 0xb7e4],EAX    ; 0042e82a
    JMP 0x0042e7d3                      ; 0042e830
        ;   XREF to: 0042e7d3 (UNCONDITIONAL_JUMP)  ; LAB_0042e7d3
