...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_charactr_cpp_CCharacter_serialize_FUN_004283a0(CCharacter *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004283ab
    CALL core_actor.cpp_CDemonActor_serialize_FUN_0040c1c0 ; 004283ac
    ...
    PUSH EAX                            ; 004283bf
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 004283c0
    ...
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 0042841e
    ...
    PUSH EAX                            ; 00428464
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 00428465
    ...
    PUSH EAX                            ; 00428481
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 00428482
    ...
    PUSH EAX                            ; 00428495
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 00428496
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ADD ESP,0x8                         ; 0042849b
    PUSH 0x616fc6                       ; 0042849e | = "clothList"
    LEA EAX,[EBX + 0x2a94]              ; 004284a3
    PUSH EAX                            ; 004284a9
    CALL core_actor.cpp_serializeClothList_FUN_0040be60 ; 004284aa
    ...
    PUSH EAX                            ; 004284c6
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 004284c7
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH EAX                            ; 004284f9
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 004284fa
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    PUSH EAX                            ; 00428522
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 00428523
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    PUSH EAX                            ; 0042853a
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 0042853b
        ;   XREF to: 0040b870 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeActor_FUN_0040b870(CDemonActor * actor_ptr, char * property_name)
    ...
    PUSH EAX                            ; 00428560
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 00428561
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    PUSH EAX                            ; 00428577
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 00428578
        ;   XREF to: 0040b870 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeActor_FUN_0040b870(CDemonActor * actor_ptr, char * property_name)
    ...
    PUSH EAX                            ; 00428590
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 00428591
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ADD ESP,0x8                         ; 00428596
    PUSH 0x616fe8                       ; 00428599 | = "descriptiveName"
    LEA EAX,[EBX + 0x2448]              ; 0042859e
    PUSH EAX                            ; 004285a4
    CALL core_actor.cpp_serializeLocalizedString_FUN_0040b6e0 ; 004285a5
    ...
    PUSH EBX                            ; 004285b8
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 004285b9
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
