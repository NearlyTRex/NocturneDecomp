...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_charactr_cpp_CCharacter_releaseFromGrab_FUN_0042bf40(CCharacter *this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x4]       ; 0042bf40
        ;   Label: core_charactr.cpp_CCharacter_releaseFromGrab_FUN_0042bf40
