...

{
  ...
  if ((this_ptr->model).padding_0x0[0x2260] != '\0') {
    if (*(int *)((this_ptr->model).padding_0x0 + in_stack_0000000c * 4 + 0x2140) != 0) {
      core_skeleton_cpp_CDeformableModelInstance_FUN_005a1040();
      local_14 = 0;
      if (0 < *(int *)(this_ptr->cloth_data + 0x35c)) {
        local_18 = (this_ptr->model).padding_0x0 + 0xe80;
          ...
          if ((in_stack_0000000c == *(int *)pcVar1) && (-1 < *(int *)(pcVar1 + 4))) {
            core_xform_cpp_transformVector3x4_FUN_005f4dc0
                      (&local_30,(CVector3f *)(pcVar1 + 8),
                       (CMatrix3x4f *)
                       ((this_ptr->model).padding_0x0 + *(int *)(pcVar1 + 4) * 0x30 + 0xe80));
