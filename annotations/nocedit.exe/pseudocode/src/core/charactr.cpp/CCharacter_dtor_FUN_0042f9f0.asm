...
;                               FUNCTION
; *****************************************************************************
; __cdecl CDemonActor * __cdecl core_charactr_cpp_CCharacter_dtor_FUN_0042f9f0 (CCharacter *this_ptr,uint d1,uint d2,uint d3,uint d4,uint d5,uint d6,uint d7,uint d8)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0042fa08
    CALL core_backgnd.cpp_freeFlames_FUN_00412720 ; 0042fa09
    ...
    PUSH EAX                            ; 0042fa18
    CALL core_backgnd.cpp_freeFires_FUN_00412700 ; 0042fa19
    ...
    PUSH EAX                            ; 0042fa28
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 0042fa29
    ...
    PUSH EAX                            ; 0042fa38
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 0042fa39
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; int core_backgnd.cpp_cleanupVector_FUN_004126e0(CVector3f * * objs)
    ...
    PUSH 0x65b9c0                       ; 0042fa81 | g_CCharacterTypeInfo
        ;   Label: LAB_0042fa81
    PUSH EBX                            ; 0042fa86
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 0042fa87
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 0042fa8c
    PUSH EAX                            ; 0042fa8f
    CALL crt_memory.c_free_FUN_005fe659 ; 0042fa90
