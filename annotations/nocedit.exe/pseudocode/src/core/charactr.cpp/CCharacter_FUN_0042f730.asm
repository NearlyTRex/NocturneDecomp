...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_charactr_cpp_CCharacter_FUN_0042f730(CCharacter *this_ptr)
;
; Parameters:
...
section .text
    ...
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e500 ; 0042f753
        ;   XREF to: 0040e500 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_CActorPropertyList_FUN_0040e500()
