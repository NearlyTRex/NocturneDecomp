...

{
  ...
  if (0.0 <= *(float *)(this_ptr->cloth_data + 0x32c)) {
    pCVar5 = &(this_ptr->base_actor).location;
    pCVar2 = (CDemonActor *)core_hero_cpp_closestHeroToPoint_FUN_004f2170();
    local_2c = pCVar2;
    core_actor_cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(pCVar2,&local_a4,&pCVar5->position);
    pCVar3 = core_vehicle_cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(&local_bc,&local_a4);
    fVar6 = pCVar3->y;
    local_44.x = (pCVar5->position).x - (pCVar2->location).position.x;
    local_44.y = (this_ptr->base_actor).location.position.y - (pCVar2->location).position.y;
    local_44.z = (this_ptr->base_actor).location.position.z - (pCVar2->location).position.z;
    pCVar3 = core_vehicle_cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(&local_8c,&local_44);
    local_24 = pCVar3->y;
    iVar1 = (*pCVar2->vtable[1].processMeleeHit)(pCVar2,in_stack_fffffee8);
    pCVar2 = local_2c;
    if ((iVar1 != 0) && (ABS(fVar6) < (float)0.78539816337500001)) {
      uStack_28 = (uint)(local_a4.x < 0.0);
      uStack_1c = 0;
      pCVar5 = &local_2c->location;
      do {
        uVar4 = uStack_1c;
        if (uStack_28 != 0) {
          uVar4 = uStack_1c ^ 1;
        }
        CStack_80.y = local_24 + *(float *)(&DAT_0066e740 + uVar4 * 4);
        CStack_80.x = 0.0;
        CStack_80.z = 0.0;
        ...
        for (fStack_110 = 6.5; (float)2.3999999999999999 < fStack_110;
          ...
          fStack_68 = (pCVar5->position).x + pCVar3->x;
          fStack_64 = (pCVar2->location).position.y + pCVar3->y;
          fStack_60 = (pCVar2->location).position.z + pCVar3->z;
    ...
    pCVar2 = local_2c;
    if (((ABS(local_a4.y) <= (float)4) && (ABS(fVar6) <= (float)0.52359877558333301)) &&
      ...
      *(float *)(this_ptr->cloth_data + 0x32c) = fVar6;
      ...
      do {
        ...
        for (fVar6 = 4.5; (float)2.3999999999999999 < fVar6; fVar6 = fVar6 + -1f) {
          CStack_38.x = 0.0;
          CStack_38.y = 0.0;
          CStack_38.z = fVar6;
          pCVar3 = core_dirmat_cpp_CMatrix3x3f_transformVector_FUN_00471fd0
                             (&CStack_e4,&CStack_50,&CStack_38);
          fStack_98 = (pCVar5->position).x + pCVar3->x;
          fStack_94 = (pCVar2->location).position.y + pCVar3->y;
          fStack_90 = (pCVar2->location).position.z + pCVar3->z;
