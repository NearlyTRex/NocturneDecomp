...
section .text
    ...
    PUSH EBX                            ; 0042f3e0
        ;   Label: core_charactr.cpp_CCharacter_propertyActionCallback_FUN_0042f3e0
    PUSH ESI                            ; 0042f3e1
    PUSH EDI                            ; 0042f3e2
    PUSH EBP                            ; 0042f3e3
    ...
    MOV EBX,dword ptr [EDI + EAX*0x1 + 0x14d158] ; 0042f566 | g_CDemonSetInstance.actors[0] | g_CDemonSetInstance.actors[1] | g_CDemonSetInstance.actors[2]
