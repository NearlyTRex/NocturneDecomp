// Name: core_charactr.cpp_CCharacter_spawnGoreAtBone_FUN_0042b760
// Address: 0042b760
// Address Range: [[0042b760, 0042b801]]
// Convention: __cdecl
// Signature: void __cdecl core_charactr_cpp_CCharacter_spawnGoreAtBone_FUN_0042b760(CCharacter *this_ptr,int part_index,int bone_index,float chance)
  ...
  if ((this_ptr->model).part_data.visibility_flags[part_index] == 0) {
    ...
    if (iVar1 != 0) {
      ...
      core_gore_cpp_CGore_spawnBloodParticles_FUN_004edaa0
                (g_CGorePtr,&local_10,&local_1c,this_ptr->blood_type);
      return;
    }
  }
  return;
