...

{
  ...
  do {
    ...
    *(uint *)((int)&g_CDemonRendererPtr2->vertex_buffer_ptr->u + iVar7) = 0x800000;
    iVar6 = iVar7 + 0x30;
    *(uint *)((int)&pCVar5->vertex_buffer_ptr->v + iVar7) = 0x800000;
    iVar7 = iVar6;
  } while (iVar6 != 0x12c0);
  ...
  do {
    ...
    do {
      ...
      *(uint *)((int)&pCVar4->vertex_buffer_ptr->g + iVar9) = 0xffff;
      *(uint *)((int)&pCVar4->vertex_buffer_ptr->b + iVar9) = 0;
      pCVar7 = core_actor_cpp_CDemonActor_worldToLocalPoint_FUN_00408f10
                         (&this_ptr->base,&local_90,pCVar6);
      if (&local_84 != pCVar7) {
        local_84.x = pCVar7->x;
        local_84.y = pCVar7->y;
        local_84.z = pCVar7->z;
  ...
  do {
    ...
    do {
      pCVar4 = g_CDemonRendererPtr2;
      *(uint *)((int)&g_CDemonRendererPtr2->vertex_buffer_ptr->r + iVar7) = 0;
      *(uint *)((int)&pCVar4->vertex_buffer_ptr->g + iVar7) = 0;
      *(uint *)((int)&pCVar4->vertex_buffer_ptr->b + iVar7) = 0xffff;
  ...
  local_1c = 0;
  do {
    fVar12 = (float10)(local_1c * 2) * (float10)3.1415926535000001 * (float10)0.041666666666666699;
    fVar13 = (float10)fsin(fVar12);
    fVar9 = (float10)fcos(fVar12);
    fVar14 = (float10)(fVar1 * fVar2);
    local_84.x = (float)(fVar13 * fVar14);
    local_84.z = (float)(fVar9 * fVar14);
    ...
    wincore_windll_cpp_transformAndProjectPoint_FUN_005b575c
              ((SProjectedVertex *)
               ...
               iVar8),local_60);
    pCVar4 = g_CDemonRendererPtr2;
    *(uint *)((int)&g_CDemonRendererPtr2->vertex_buffer_ptr->r + iVar8) = 0xffff;
    *(uint *)((int)&pCVar4->vertex_buffer_ptr->g + iVar8) = 0;
    *(uint *)((int)&pCVar4->vertex_buffer_ptr->b + iVar8) = 0;
    local_84.y = local_38;
    ...
    wincore_windll_cpp_transformAndProjectPoint_FUN_005b575c
              ((SProjectedVertex *)
               ((int)&(pCVar4->vertex_buffer_ptr->projected_vertex).transformed_x + iVar7),&local_b4
              );
    pCVar4 = g_CDemonRendererPtr2;
    *(uint *)((int)&g_CDemonRendererPtr2->vertex_buffer_ptr->r + iVar7) = 0xffff;
    *(uint *)((int)&pCVar4->vertex_buffer_ptr->g + iVar7) = 0;
    *(uint *)((int)&pCVar4->vertex_buffer_ptr->b + iVar7) = 0;
    if (0 < local_1c) {
      local_e8.base.count = 4;
      engine_drender_cpp_CDemonRenderer_setRenderAlpha_FUN_0048ca60(pCVar4,0x4000);
      engine_drender_cpp_CDemonRenderer_renderPerspective_FUN_0048ae10
                (g_CDemonRendererPtr2,&local_e8,0x267);
    }
    iVar8 = iVar8 + 0x60;
  ...
  iVar8 = 0;
  pCVar4->vertex_buffer_ptr->g = 0;
  iVar7 = 0x30;
  local_f0 = 0;
  pCVar4->vertex_buffer_ptr->b = 0;
  do {
    fVar9 = (float10)local_f0 * (float10)3.1415926535000001 * (float10)0.041666666666666699;
    fVar10 = (float10)fsin(fVar9);
    fVar9 = (float10)fcos(fVar9);
    local_84.x = (float)((float10)this_ptr->size_scale *
                        (float10)this_ptr->collision_cylinder_height * fVar10);
    local_84.y = 0.0;
    local_84.z = (float)(fVar9 * (float10)this_ptr->collision_cylinder_height *
