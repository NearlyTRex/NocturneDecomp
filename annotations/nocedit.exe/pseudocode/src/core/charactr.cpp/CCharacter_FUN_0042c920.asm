...
section .text
    ...
    PUSH 0x0                            ; 0042c994
        ;   Label: LAB_0042c994
    PUSH 0x617252                       ; 0042c996 | = "STAND" | s_STAND_00617252 = STAND
    PUSH ESI                            ; 0042c99b
    CALL core_motion.cpp_CMotionController_getMotionList_FUN_0052dce0 ; 0042c99c | CMotionList * core_motion.cpp_CMotionController_getMotionList_FUN_0052dce0(CMotionController * this_ptr)
        ;   XREF to: 0052dce0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0042c9a1
    PUSH EAX                            ; 0042c9a4
    CALL core_motion.cpp_CMotionList_findStateIndex_FUN_0052d4f0 ; 0042c9a5 | int core_motion.cpp_CMotionList_findStateIndex_FUN_0052d4f0(CMotionList * this_ptr)
        ;   XREF to: 0052d4f0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0042c9aa
    TEST EAX,EAX                        ; 0042c9ad
    JL 0x0042c954                       ; 0042c9af | LAB_0042c954
        ;   XREF to: 0042c954 (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 0042c9b1
    PUSH 0x617258                       ; 0042c9b3 | = "STAND" | s_STAND_00617258 = STAND
    PUSH ESI                            ; 0042c9b8
    CALL core_motion.cpp_CMotionController_setDesiredStateByName_FUN_0052db90 ; 0042c9b9 | void core_motion.cpp_CMotionController_setDesiredStateByName_FUN_0052db90(CMotionController * this_ptr, char * state_name, int force_immediate)
        ;   XREF to: 0052db90 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0042c9be
    JMP 0x0042c954                      ; 0042c9c1 | LAB_0042c954
        ;   XREF to: 0042c954 (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0x25b0],0x1    ; 0042c9c3
        ;   Label: LAB_0042c9c3
    JMP 0x0042c95f                      ; 0042c9cd | LAB_0042c95f
