...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_charactr.cpp_CCharacter_pickupObjectNow_FUN_0042cdb0(CCharacter * this_ptr)
;
; Parameters:
...
section .text
    ...
    JL 0x0042cdc9                       ; 0042cdc2 | LAB_0042cdc9
        ;   XREF to: 0042cdc9 (CONDITIONAL_JUMP)
    CMP EDI,0x2                         ; 0042cdc4
    JL 0x0042cdec                       ; 0042cdc7 | LAB_0042cdec
        ;   XREF to: 0042cdec (CONDITIONAL_JUMP)
    MOV EDX,0x6172a2                    ; 0042cdc9 | = "..\\core\\charactr.cpp" | s_core_charactr_cpp_006172a2 = ..\core\charactr.cpp
        ;   Label: LAB_0042cdc9
    MOV ECX,0xbd3                       ; 0042cdce
    PUSH 0x6172b7                       ; 0042cdd3 | = "CCharacter::pickupObjectNow - invalid..." | s_CCharacter_pickupObjectN_006172b7 = CCharacter::pickupObjectNow - invalid hand index
    MOV dword ptr [0x02f0ca48],EDX      ; 0042cdd8 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 0042cdde | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0042cde4 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0042cde9
    TEST EBP,EBP                        ; 0042cdec
        ;   Label: LAB_0042cdec
    JNZ 0x0042cdf5                      ; 0042cdee | LAB_0042cdf5
    ...
    JL 0x0042ce2b                       ; 0042ce1f | LAB_0042ce2b
        ;   XREF to: 0042ce2b (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + EAX*0x4 + 0x2298],0x0 ; 0042ce21
    JZ 0x0042cdf0                       ; 0042ce29 | LAB_0042cdf0
        ;   XREF to: 0042cdf0 (CONDITIONAL_JUMP)
    CMP dword ptr [ESI],0x0             ; 0042ce2b
        ;   Label: LAB_0042ce2b
    JGE 0x0042ce52                      ; 0042ce2e | LAB_0042ce52
        ;   XREF to: 0042ce52 (CONDITIONAL_JUMP)
    MOV EAX,0x6172e8                    ; 0042ce30 | = "..\\core\\charactr.cpp" | s_core_charactr_cpp_006172e8 = ..\core\charactr.cpp
    MOV EDX,0xbeb                       ; 0042ce35
    PUSH 0x6172fd                       ; 0042ce3a | = "CCharacter::pickupObjectNow - invalid..." | s_CCharacter_pickupObjectN_006172fd = CCharacter::pickupObjectNow - invalid bone!
    MOV [0x02f0ca48],EAX                ; 0042ce3f | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 0042ce44 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0042ce4a | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ...
    CALL core_charactr.cpp_CCharacter_computePickup_FUN_0042ce80 ; 0042ce6c | void core_charactr.cpp_CCharacter_computePickup_FUN_0042ce80(CCharacter * this_ptr)
