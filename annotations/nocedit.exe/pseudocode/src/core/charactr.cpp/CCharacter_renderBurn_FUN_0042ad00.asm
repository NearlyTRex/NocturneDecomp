...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_charactr_cpp_CCharacter_renderBurn_FUN_0042ad00(CCharacter *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0042ad00
        ;   Label: core_charactr.cpp_CCharacter_renderBurn_FUN_0042ad00
    PUSH ESI                            ; 0042ad01
    PUSH EDI                            ; 0042ad02
    PUSH EBP                            ; 0042ad03
