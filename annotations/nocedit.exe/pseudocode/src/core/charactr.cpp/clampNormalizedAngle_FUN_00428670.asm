...
;                               FUNCTION
; *****************************************************************************
; __cdecl float __cdecl core_charactr_cpp_clampNormalizedAngle_FUN_00428670(float angle,float limit)
;
; Parameters:
...
section .text
    ...
    SUB ESP,0xc                         ; 00428670
        ;   Label: core_charactr.cpp_clampNormalizedAngle_FUN_00428670
