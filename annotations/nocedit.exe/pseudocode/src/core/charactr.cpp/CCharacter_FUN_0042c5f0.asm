...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_charactr.cpp_CCharacter_FUN_0042c5f0(CCharacter * this_ptr)
;
; Parameters:
...
section .text
    ...
    JZ 0x0042c700                       ; 0042c607 | LAB_0042c700
    ...
    FNSTSW AX                           ; 0042c639
    SAHF                                ; 0042c63b
    JA 0x0042c722                       ; 0042c63c | LAB_0042c722
        ;   XREF to: 0042c722 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x4]           ; 0042c642
    FABS                                ; 0042c646
    FCOMP double ptr [0x00617222]       ; 0042c648 | double DOUBLE_00617222
    FNSTSW AX                           ; 0042c64e
    SAHF                                ; 0042c650
    JA 0x0042c83e                       ; 0042c651 | LAB_0042c83e
        ;   XREF to: 0042c83e (CONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 0042c657
    FABS                                ; 0042c65a
    FCOMP double ptr [0x0061722a]       ; 0042c65c | double DOUBLE_0061722a
    FNSTSW AX                           ; 0042c662
    SAHF                                ; 0042c664
    JA 0x0042c83e                       ; 0042c665 | LAB_0042c83e
        ;   XREF to: 0042c83e (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x8]           ; 0042c66b
    FABS                                ; 0042c66f
    FCOMP double ptr [0x0061722a]       ; 0042c671 | double DOUBLE_0061722a
    FNSTSW AX                           ; 0042c677
    SAHF                                ; 0042c679
    JA 0x0042c83e                       ; 0042c67a | LAB_0042c83e
        ;   XREF to: 0042c83e (CONDITIONAL_JUMP)
    ...
    FLD float ptr [EBP + 0x1c]          ; 0042c6ce
        ;   Label: LAB_0042c6ce
    FCOMP double ptr [0x0061723a]       ; 0042c6d1 | double DOUBLE_0061723a
    FNSTSW AX                           ; 0042c6d7
    SAHF                                ; 0042c6d9
    JNC 0x0042c6e3                      ; 0042c6da | LAB_0042c6e3
    ...
    FNSTSW AX                           ; 0042c6ea
    SAHF                                ; 0042c6ec
    JNC 0x0042c8a4                      ; 0042c6ed | LAB_0042c8a4
    ...
    PUSH ESI                            ; 0042c700
        ;   Label: LAB_0042c700
    PUSH 0x6171ab                       ; 0042c701 | = "%s tried to follow NULL actor!\n" | s_s_tried_to_follow_NULL_a_006171ab = %s tried to follow NULL actor!

    MOV ECX,dword ptr [0x0066e8e0]      ; 0042c706 | CConsole g_ConsolePtr | CConsole * g_CConsolePtr
    PUSH ECX                            ; 0042c70c | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 0042c70d | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
    ...
    CALL core_actor.cpp_CDemonActor_inverseTransformVector_FUN_00408ea0 ; 0042c731 | CVector3f * core_actor.cpp_CDemonActor_inverseTransformVector_FUN_00408ea0(CDemonActor * this_ptr, CVector3f * output_vector, CVector3f * input_vector)
        ;   XREF to: 00408ea0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0042c736
    PUSH EAX                            ; 0042c739
    LEA EAX,[ESP + 0x1c]                ; 0042c73a
    PUSH EAX                            ; 0042c73e
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 0042c73f | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
    ...
    JNZ 0x0042c7f5                      ; 0042c754 | LAB_0042c7f5
        ;   XREF to: 0042c7f5 (CONDITIONAL_JUMP)
    FLD float ptr [ESI + 0x2418]        ; 0042c75a
    FABS                                ; 0042c760
    FCOMP double ptr [0x0061724a]       ; 0042c762 | double DOUBLE_0061724a
    FNSTSW AX                           ; 0042c768
    SAHF                                ; 0042c76a
    JBE 0x0042c81a                      ; 0042c76b | LAB_0042c81a
    ...
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 0042c78f | float core_actor.cpp_normalizeAngleToPi_FUN_0040cd70(float angle_radians)
    ...
    FNSTSW AX                           ; 0042c7b5
    SAHF                                ; 0042c7b7
    JNC 0x0042c825                      ; 0042c7b8 | LAB_0042c825
    ...
    PUSH EDI                            ; 0042c83e
        ;   Label: LAB_0042c83e
    PUSH ESI                            ; 0042c83f
    PUSH 0x6171cb                       ; 0042c840 | = "%s confused while following %s\n" | s_s_confused_while_followi_006171cb = %s confused while following %s

    MOV ECX,dword ptr [0x0066e8e0]      ; 0042c845 | CConsole g_ConsolePtr | CConsole * g_CConsolePtr
    PUSH ECX                            ; 0042c84b | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 0042c84c | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
        ;   XREF to: 00441890 (UNCONDITIONAL_CALL)
    ...
    MOV dword ptr [EBP + 0x20],0x7149f2ca ; 0042c861
        ;   Label: LAB_0042c861
    JMP 0x0042c6ad                      ; 0042c868 | LAB_0042c6ad
        ;   XREF to: 0042c6ad (UNCONDITIONAL_JUMP)
    CMP EAX,0x1                         ; 0042c86d
        ;   Label: LAB_0042c86d
    JNZ 0x0042c88c                      ; 0042c870 | LAB_0042c88c
    ...
    JMP 0x0042c6cb                      ; 0042c887 | LAB_0042c6cb
        ;   XREF to: 0042c6cb (UNCONDITIONAL_JUMP)
    CMP EAX,0x2                         ; 0042c88c
        ;   Label: LAB_0042c88c
    JNZ 0x0042c6ce                      ; 0042c88f | LAB_0042c6ce
    ...
    JMP 0x0042c6ce                      ; 0042c89f | LAB_0042c6ce
        ;   XREF to: 0042c6ce (UNCONDITIONAL_JUMP)
    PUSH 0x0                            ; 0042c8a4
        ;   Label: LAB_0042c8a4
    PUSH 0x0                            ; 0042c8a6
    PUSH 0x3f87558                      ; 0042c8a8 | CVector3f g_ZeroVector
    ...
    PUSH EAX                            ; 0042c8c1
    PUSH ESI                            ; 0042c8c2
    CALL core_charactr.cpp_CCharacter_walkToPoint_FUN_004286e0 ; 0042c8c3 | int core_charactr.cpp_CCharacter_walkToPoint_FUN_004286e0(CCharacter * this_ptr)
        ;   XREF to: 004286e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x18                        ; 0042c8c8
    TEST EAX,EAX                        ; 0042c8cb
    JL 0x0042c8e8                       ; 0042c8cd | LAB_0042c8e8
        ;   XREF to: 0042c8e8 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x24]          ; 0042c8cf
    FCOMP float ptr [EBP + 0x20]        ; 0042c8d3
    FNSTSW AX                           ; 0042c8d6
    SAHF                                ; 0042c8d8
    JBE 0x0042c90b                      ; 0042c8d9 | LAB_0042c90b
    ...
    PUSH EDI                            ; 0042c8e8
        ;   Label: LAB_0042c8e8
    PUSH ESI                            ; 0042c8e9
    PUSH 0x6171eb                       ; 0042c8ea | = "%s confused after pathmap call while ..." | s_s_confused_after_pathmap_006171eb = %s confused after pathmap call while following %s

    MOV EDX,dword ptr [0x0066e8e0]      ; 0042c8ef | CConsole g_ConsolePtr | CConsole * g_CConsolePtr
    PUSH EDX                            ; 0042c8f5 | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 0042c8f6 | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
        ;   XREF to: 00441890 (UNCONDITIONAL_CALL)
