...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_charactr_cpp_CCharacter_shatter_FUN_0042b8e0(CCharacter *this_ptr)
;
; Parameters:
...
;   core_ghoul.cpp_CGhoul_processDamage_FUN_004e87e0 at 004e8a3a
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0042b8e0
        ;   Label: core_charactr.cpp_CCharacter_shatter_FUN_0042b8e0
