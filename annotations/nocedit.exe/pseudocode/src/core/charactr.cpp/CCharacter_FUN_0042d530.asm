...
section .text
    ...
    JNZ 0x0042d54e                      ; 0042d547 | LAB_0042d54e
    ...
    PUSH EAX                            ; 0042d550
    PUSH EDX                            ; 0042d551
    CALL core_skeleton.cpp_CDeformableModelInstance_computeBoundingBox_FUN_005a16c0 ; 0042d552 | CBoundingBox3D * core_skeleton.cpp_CDeformableModelInstance_computeBoundingBox_FUN_005a16c0(CDeformableModelInstance * this_ptr, CBoundingBox3D * output_bbox)
    ...
    JZ 0x0042d57a                       ; 0042d566 | LAB_0042d57a
    ...
    JZ 0x0042d549                       ; 0042d582 | LAB_0042d549
