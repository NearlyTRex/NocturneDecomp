...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_charactr_cpp_CCharacter_moveOutOfHeroWay_FUN_0042ede0(CCharacter *this_ptr,float delta_time)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0042ede0
        ;   Label: core_charactr.cpp_CCharacter_moveOutOfHeroWay_FUN_0042ede0
    PUSH ESI                            ; 0042ede1
    PUSH EDI                            ; 0042ede2
    PUSH EBP                            ; 0042ede3
