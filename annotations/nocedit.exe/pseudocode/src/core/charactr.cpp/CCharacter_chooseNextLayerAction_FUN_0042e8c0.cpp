...

{
  ...
  if ((*(int *)(this_ptr->unk3 + 0x46c) < 0) ||
     (*(int *)(this_ptr->unk3 + 8) <= *(int *)(this_ptr->unk3 + 0x46c))) {
  ...
  if ((float)1.0000000000000001e-05 <= *(float *)(this_ptr->unk3 + 0x470)) {
    if (*(float *)(this_ptr->unk3 + 0x470) <= (float)0.99999000000000005) {
      return;
    }
    iVar2 = *(int *)(this_ptr->unk3 + *(int *)(this_ptr->unk3 + 0x46c) * 0x38 + 0x10);
  }
  else {
    iVar2 = *(int *)(this_ptr->unk3 + *(int *)(this_ptr->unk3 + 0x46c) * 0x38 + 0xc);
  }
  if (in_stack_00000008 != iVar2) {
    local_14 = 999.0;
    iVar3 = 0;
    if (0 < *(int *)(this_ptr->unk3 + 8)) {
      pcVar4 = this_ptr->unk3 + 0xc;
      do {
        if ((*(int *)(pcVar4 + 0x28) < 0) || (*(int *)pcVar4 != iVar2)) {
          if ((*(int *)(pcVar4 + 0x28) < 1) &&
             ((*(int *)(pcVar4 + 4) == iVar2 &&
              ...
              fVar1 < local_14)))) {
            this_ptr->unk3[0x470] = '\0';
            this_ptr->unk3[0x471] = '\0';
            this_ptr->unk3[0x472] = -0x80;
            this_ptr->unk3[0x473] = '?';
            *(int *)(this_ptr->unk3 + 0x46c) = iVar3;
            local_14 = fVar1;
          }
        }
        else {
          ...
          if (fVar1 < local_14) {
            this_ptr->unk3[0x470] = '\0';
            this_ptr->unk3[0x471] = '\0';
            this_ptr->unk3[0x472] = '\0';
            this_ptr->unk3[0x473] = '\0';
            *(int *)(this_ptr->unk3 + 0x46c) = iVar3;
            local_14 = fVar1;
          }
        }
        iVar3 = iVar3 + 1;
        pcVar4 = pcVar4 + 0x38;
      } while (iVar3 < *(int *)(this_ptr->unk3 + 8));
    }
  }
  return;
}
