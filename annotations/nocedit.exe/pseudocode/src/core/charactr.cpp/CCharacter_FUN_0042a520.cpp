  ...
  if (-1 < in_stack_0000000c) {
    ...
    if (iVar5 != -1) {
      ...
      fVar10 = SQRT(fVar12 * (float10)(float)fVar12 +
                    fVar11 * fVar11 + fVar10 * (float10)(float)fVar10) * (float10)DOUBLE_006170c2;
      crt_math_c_round_FUN_005fe6b0((double)CONCAT44(pCVar7,pCVar4));
...
// 0042a6ae: PUSH EBP
// 0042a6af: PUSH EAX
// 0042a6b0: CALL core_skeleton.cpp_CDeformableModel_getBonePart_FUN_0059c2d0
...
// 0042a761: PUSH EAX
// 0042a762: PUSH EBX
// 0042a763: CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0
