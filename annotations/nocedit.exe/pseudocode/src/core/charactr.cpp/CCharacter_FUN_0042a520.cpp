...
// Convention: __cdecl
// Signature: void __cdecl core_charactr_cpp_CCharacter_FUN_0042a520(CCharacter *this_ptr)
...

{
  ...
  if (-1 < in_stack_0000000c) {
    ...
    if (iVar5 != -1) {
      pCVar7 = (CVector3f *)((int)local_44 + in_stack_0000000c * 0xc);
      ...
      if (0 < local_30) {
        ...
        while (this_ptr->fire_count < 0x32) {
          ...
          *(int *)pSVar8->unk = iVar6;
          local_1c = local_38;
          local_18 = iVar5 + 1;
          *(int *)(pSVar8->unk + 4) = in_stack_0000000c;
          ...
          *(float *)((int)this_ptr->field65_0x2f1c + this_ptr->fire_count * 0x2a4 + 0x36c) =
          ...
          iVar5 = iVar5 + 1;
          *(int *)((int)this_ptr->field65_0x2f1c + this_ptr->fire_count * 0x2a4 + 0x3b4) =
               this_ptr->field63_0x2f14;
          if (local_30 <= iVar5) {
            return;
          }
        }
