...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_charactr.cpp_CCharacter_FUN_0042ede0(CCharacter * this_ptr)
;
; Parameters:
...
section .text
    ...
    FNSTSW AX                           ; 0042edfc
    SAHF                                ; 0042edfe
    JBE 0x0042ee63                      ; 0042edff | LAB_0042ee63
    ...
    FNSTSW AX                           ; 0042ee14
    SAHF                                ; 0042ee16
    JBE 0x0042ee2a                      ; 0042ee17 | LAB_0042ee2a
        ;   XREF to: 0042ee2a (CONDITIONAL_JUMP)
    FLD float ptr [EDI + 0x2dd4]        ; 0042ee19
    FCOMP double ptr [0x0061766a]       ; 0042ee1f | double DOUBLE_0061766a
    FNSTSW AX                           ; 0042ee25
    SAHF                                ; 0042ee27
    JBE 0x0042ee3d                      ; 0042ee28 | LAB_0042ee3d
    ...
    PUSH 0x0                            ; 0042ee3d
        ;   Label: LAB_0042ee3d
    PUSH 0x0                            ; 0042ee3f
    PUSH 0x3f87558                      ; 0042ee41 | CVector3f g_ZeroVector
    PUSH 0x0                            ; 0042ee46
    LEA EAX,[EDI + 0x2dc8]              ; 0042ee48
    PUSH EAX                            ; 0042ee4e
    PUSH EDI                            ; 0042ee4f
    CALL core_charactr.cpp_CCharacter_walkToPoint_FUN_004286e0 ; 0042ee50 | int core_charactr.cpp_CCharacter_walkToPoint_FUN_004286e0(CCharacter * this_ptr)
        ;   XREF to: 004286e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x18                        ; 0042ee55
    TEST EAX,EAX                        ; 0042ee58
    JNZ 0x0042ee2a                      ; 0042ee5a | LAB_0042ee2a
        ;   XREF to: 0042ee2a (CONDITIONAL_JUMP)
    MOV EAX,0x1                         ; 0042ee5c
    JMP 0x0042ee36                      ; 0042ee61 | LAB_0042ee36
        ;   XREF to: 0042ee36 (UNCONDITIONAL_JUMP)
    LEA ESI,[EDI + 0x20]                ; 0042ee63
        ;   Label: LAB_0042ee63
    PUSH ESI                            ; 0042ee66
    CALL core_hero.cpp_closestHeroToPoint_FUN_004f2170 ; 0042ee67 | undefined core_hero.cpp_closestHeroToPoint_FUN_004f2170()
    ...
    PUSH EAX                            ; 0042ee7d
    PUSH EBX                            ; 0042ee7e
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 0042ee7f | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
    ...
    PUSH EAX                            ; 0042ee90
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 0042ee91 | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
    ...
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 0042eedc | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)
    ...
    JZ 0x0042f09e                       ; 0042ef00 | LAB_0042f09e
        ;   XREF to: 0042f09e (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x4]           ; 0042ef06
    FCOMP double ptr [0x00617662]       ; 0042ef0a | double DOUBLE_00617662
    FNSTSW AX                           ; 0042ef10
    SAHF                                ; 0042ef12
    JNC 0x0042f09e                      ; 0042ef13 | LAB_0042f09e
        ;   XREF to: 0042f09e (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0042ef21
    SAHF                                ; 0042ef23
    JBE 0x0042f07f                      ; 0042ef24 | LAB_0042f07f
    ...
    JNZ 0x0042f203                      ; 0042ef5f | LAB_0042f203
    ...
    PUSH EAX                            ; 0042efa4
    CALL core_dirmat.cpp_CMatrix3x3f_buildRotationMatrix_FUN_00471d30 ; 0042efa5 | void core_dirmat.cpp_CMatrix3x3f_buildRotationMatrix_FUN_00471d30(CMatrix3x3f * this_ptr, CVector3f * euler_angles)
    ...
    FLD float ptr [ESP + 0x8]           ; 0042efb6
        ;   Label: LAB_0042efb6
    FCOMP double ptr [0x006176a2]       ; 0042efba | double DOUBLE_006176a2
    FNSTSW AX                           ; 0042efc0
    SAHF                                ; 0042efc2
    JBE 0x0042f086                      ; 0042efc3 | LAB_0042f086
    ...
    CALL core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0 ; 0042efed | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0(CMatrix3x3f * this_ptr, CVector3f * output, CVector3f * input)
    ...
    JZ 0x0042f042                       ; 0042f023 | LAB_0042f042
    ...
    PUSH 0x0                            ; 0042f042
        ;   Label: LAB_0042f042
    PUSH 0x0                            ; 0042f044
    PUSH 0x3f87558                      ; 0042f046 | CVector3f g_ZeroVector
    PUSH 0x0                            ; 0042f04b
    PUSH EBX                            ; 0042f04d
    PUSH EDI                            ; 0042f04e
    CALL core_charactr.cpp_CCharacter_walkToPoint_FUN_004286e0 ; 0042f04f | int core_charactr.cpp_CCharacter_walkToPoint_FUN_004286e0(CCharacter * this_ptr)
        ;   XREF to: 004286e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x18                        ; 0042f054
    TEST EAX,EAX                        ; 0042f057
    JL 0x0042f20a                       ; 0042f059 | LAB_0042f20a
    ...
    XOR EAX,EAX                         ; 0042f07f
        ;   Label: LAB_0042f07f
    JMP 0x0042ef2f                      ; 0042f081 | LAB_0042ef2f
    ...
    JL 0x0042ef4f                       ; 0042f098 | LAB_0042ef4f
        ;   XREF to: 0042ef4f (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x78]          ; 0042f09e
        ;   Label: LAB_0042f09e
    FABS                                ; 0042f0a2
    FCOMP double ptr [0x00617672]       ; 0042f0a4 | double DOUBLE_00617672
    FNSTSW AX                           ; 0042f0aa
    SAHF                                ; 0042f0ac
    JA 0x0042ee2a                       ; 0042f0ad | LAB_0042ee2a
        ;   XREF to: 0042ee2a (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x4]           ; 0042f0b3
    FCOMP double ptr [0x0061767a]       ; 0042f0b7 | double DOUBLE_0061767a
    FNSTSW AX                           ; 0042f0bd
    SAHF                                ; 0042f0bf
    JA 0x0042ee2a                       ; 0042f0c0 | LAB_0042ee2a
        ;   XREF to: 0042ee2a (CONDITIONAL_JUMP)
    ...
    FADDP                               ; 0042f0da
    FSQRT                               ; 0042f0dc
    FCOMP double ptr [0x00617682]       ; 0042f0de | double DOUBLE_00617682
    FNSTSW AX                           ; 0042f0e4
    SAHF                                ; 0042f0e6
    JA 0x0042ee2a                       ; 0042f0e7 | LAB_0042ee2a
        ;   XREF to: 0042ee2a (CONDITIONAL_JUMP)
    FLD float ptr [EDI + 0x2dc4]        ; 0042f0ed
    FADD float ptr [EBP + 0x18]         ; 0042f0f3
    FST float ptr [EDI + 0x2dc4]        ; 0042f0f6
    FCOMP double ptr [0x0061768a]       ; 0042f0fc | double DOUBLE_0061768a
    FNSTSW AX                           ; 0042f102
    SAHF                                ; 0042f104
    JC 0x0042ee34                       ; 0042f105 | LAB_0042ee34
    ...
    FMUL double ptr [0x00617692]        ; 0042f142 | double DOUBLE_00617692
    FMUL double ptr [0x0061769a]        ; 0042f148 | double DOUBLE_0061769a
    MOV AH,byte ptr [ESP + 0x100]       ; 0042f14e
    FSTP float ptr [ESP + 0xf8]         ; 0042f155
    TEST AH,0x1                         ; 0042f15c
    JNZ 0x0042f21d                      ; 0042f15f | LAB_0042f21d
    ...
    CALL core_dirmat.cpp_CMatrix3x3f_buildRotationMatrix_FUN_00471d30 ; 0042f1a5 | void core_dirmat.cpp_CMatrix3x3f_buildRotationMatrix_FUN_00471d30(CMatrix3x3f * this_ptr, CVector3f * euler_angles)
        ;   XREF to: 00471d30 (UNCONDITIONAL_CALL)
    ...
    FLD float ptr [ESP]                 ; 0042f1b5
        ;   Label: LAB_0042f1b5
    FCOMP double ptr [0x006176a2]       ; 0042f1b8 | double DOUBLE_006176a2
    FNSTSW AX                           ; 0042f1be
    SAHF                                ; 0042f1c0
    JA 0x0042f23b                       ; 0042f1c1 | LAB_0042f23b
    ...
    JLE 0x0042f124                      ; 0042f1d5 | LAB_0042f124
        ;   XREF to: 0042f124 (CONDITIONAL_JUMP)
    PUSH EDI                            ; 0042f1db
    PUSH 0x617626                       ; 0042f1dc | = "%s was in the way, but couldn't figur..." | s_s_was_in_the_way_but_cou_00617626 = %s was in the way, but couldn't figure out where to move!

    MOV EDX,dword ptr [0x0066e8e0]      ; 0042f1e1 | CConsole g_ConsolePtr | CConsole * g_CConsolePtr
    PUSH EDX                            ; 0042f1e7 | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 0042f1e8 | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
    ...
    XOR AL,0x1                          ; 0042f203
        ;   Label: LAB_0042f203
    JMP 0x0042ef65                      ; 0042f205 | LAB_0042ef65
        ;   XREF to: 0042ef65 (UNCONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x8]           ; 0042f20a
        ;   Label: LAB_0042f20a
    FADD float ptr [0x006176aa]         ; 0042f20e | float FLOAT_006176aa
    FSTP float ptr [ESP + 0x8]          ; 0042f214
    JMP 0x0042efb6                      ; 0042f218 | LAB_0042efb6
        ;   XREF to: 0042efb6 (UNCONDITIONAL_JUMP)
    XOR byte ptr [ESP + 0xfb],0x80      ; 0042f21d
        ;   Label: LAB_0042f21d
    JMP 0x0042f165                      ; 0042f225 | LAB_0042f165
        ;   XREF to: 0042f165 (UNCONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 0042f22a
        ;   Label: LAB_0042f22a
    FADD float ptr [0x006176aa]         ; 0042f22d | float FLOAT_006176aa
    FSTP float ptr [ESP]                ; 0042f233
    JMP 0x0042f1b5                      ; 0042f236 | LAB_0042f1b5
    ...
    CALL core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0 ; 0042f26a | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0(CMatrix3x3f * this_ptr, CVector3f * output, CVector3f * input)
        ;   XREF to: 00471fd0 (UNCONDITIONAL_CALL)
    ...
    JZ 0x0042f2bf                       ; 0042f2a0 | LAB_0042f2bf
    ...
    PUSH 0x0                            ; 0042f2bf
        ;   Label: LAB_0042f2bf
    PUSH 0x0                            ; 0042f2c1
    PUSH 0x3f87558                      ; 0042f2c3 | CVector3f g_ZeroVector
    PUSH 0x0                            ; 0042f2c8
    PUSH EBX                            ; 0042f2ca
    PUSH EDI                            ; 0042f2cb
    CALL core_charactr.cpp_CCharacter_walkToPoint_FUN_004286e0 ; 0042f2cc | int core_charactr.cpp_CCharacter_walkToPoint_FUN_004286e0(CCharacter * this_ptr)
        ;   XREF to: 004286e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x18                        ; 0042f2d1
    TEST EAX,EAX                        ; 0042f2d4
    JL 0x0042f22a                       ; 0042f2d6 | LAB_0042f22a
