...

{
  ...
  char *local_1c;
  char *local_18;
  CSkeleton *pCStack_14;
  
  this_ptr_00 = &this_ptr->model;
  pCStack_14 = core_skeleton_cpp_CDeformableModelInstance_getSkeletonPtr_FUN_005a0820(this_ptr_00);
  if (*(int *)(this_ptr->cloth_data + 0x8d40) == 0) {
    if (0 < *(int *)(this_ptr->cloth_data + 0x478)) {
      ...
      if (0 < pCVar3->bone_count) {
        ...
        do {
          *(uint *)((int)&DAT_00823c54 + iVar5) = 0;
          iVar9 = iVar9 + 1;
          iVar5 = iVar5 + 4;
        } while (iVar9 < local_34->bone_count);
      }
      fVar1 = DAT_0065b830;
      iVar9 = 0;
      if (0 < *(int *)(this_ptr->cloth_data + 0x478)) {
      ...
      iVar9 = 0;
      local_28 = 0;
      if (0 < local_34->bone_count) {
        local_40 = &this_ptr->model;
        iVar5 = 0;
        local_30 = pCVar4;
        do {
          ...
          if (local_30->farthest_child_bone[0] == -1) {
            iVar9 = iVar9 + 1;
          }
          pCVar4 = core_skeleton_cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0(local_40);
          ...
          local_28 = local_28 + 1;
        } while (local_28 < local_34->bone_count);
      }
      if (iVar9 == local_34->bone_count) {
      ...
      local_48 = (float)*(int *)(this_ptr->cloth_data + 0x478) * (float)0.59999999999999998 *
                 (float)0.02 + (float)0.40000000000000002;
      iVar9 = sound_sndmain_cpp_setSfxVolume_FUN_005a9ae0
                        (*(uint *)(this_ptr->cloth_data + 0x8d3c),local_48);
      if (iVar9 == 0) {
        sound_sndmain_cpp_pushSfxOptions_FUN_005a8c30();
        sound_sndmain_cpp_setNextSfxVolume_FUN_005a8a60(local_48);
  ...
  if (0 < *(int *)(this_ptr->cloth_data + 0x478)) {
    ...
    local_44 = this_ptr->cloth_data + 0x934;
    ...
    do {
      if ((this_ptr->model).part_visibility_flags[*(int *)pcVar11] != 0) {
        ...
        *(float *)(local_20->cloth_data + 0xa94) = *(float *)(pcVar11 + 0x14) * fVar1;
        (**(code **)(*(int *)(local_44 + local_24 * 0x2a4 + 0x154) + 4))();
      }
  ...
  if ((*(int *)(this_ptr->field11_0x25a0 + 0x74) == 0) &&
    ...
    local_38 = in_stack_00000008 * _DAT_0065b82c;
    local_2c = 0;
    do {
      local_18 = local_1c;
      if (((this_ptr->model).part_visibility_flags[*(int *)local_1c] != 0) &&
         (fVar1 = local_38 * *(float *)(this_ptr->cloth_data + 0x480) + *(float *)(local_1c + 0x14),
         *(float *)(local_1c + 0x14) = fVar1, DAT_0065b830 < fVar1)) {
        *(float *)(local_1c + 0x14) = DAT_0065b830;
        iVar9 = 0;
        pCVar3 = pCStack_14;
        if (0 < pCStack_14->bone_count) {
          do {
            uVar8 = pCVar3->bone_list[0].parent_index;
            if (uVar8 == *(uint *)(local_18 + 4)) {
              uVar8 = uVar8 ^ *(uint *)(local_18 + 4);
              pCVar10 = this_ptr;
              if (0 < *(int *)(this_ptr->cloth_data + 0x478)) {
                do {
          ...
          } while (iVar9 < pCStack_14->bone_count);
        }
        iVar9 = 0;
        if (0 < *(int *)(this_ptr->cloth_data + 0x478)) {
          pCVar10 = this_ptr;
          do {
            if (pCStack_14->bone_list[*(int *)(local_18 + 4)].parent_index ==
