...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_charactr_cpp_CCharacter_FUN_0042b5b0(CCharacter *this_ptr)
;
; Parameters:
...
;   core_flame.cpp_CFlame_FUN_004c9c00 at 004c9ebd
;
; Referenced Globals:
...
section .text
    ...
    PUSH EAX                            ; 0042b64a
    PUSH EBX                            ; 0042b64b
    CALL core_charactr.cpp_CCharacter_FUN_0042a520 ; 0042b64c
