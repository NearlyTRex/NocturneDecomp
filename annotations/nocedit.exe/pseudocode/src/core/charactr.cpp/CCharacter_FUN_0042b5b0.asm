...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_charactr.cpp_CCharacter_FUN_0042b5b0(CCharacter * this_ptr)
;
; Parameters:
...
section .text
    ...
    POP EBX                             ; 0042b5dc
    RET                                 ; 0042b5dd
    PUSH 0x61713e                       ; 0042b5de | = "CHero" | s_CHero_0061713e = CHero
        ;   Label: LAB_0042b5de
    PUSH EBX                            ; 0042b5e3
    CALL core_actor.cpp_isOfClass_FUN_0040c6d0 ; 0042b5e4 | int core_actor.cpp_isOfClass_FUN_0040c6d0(CDemonActor * actor_ptr, char * class_name)
        ;   XREF to: 0040c6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0042b5e9
    TEST EAX,EAX                        ; 0042b5ec
    JNZ 0x0042b5d9                      ; 0042b5ee | LAB_0042b5d9
        ;   XREF to: 0042b5d9 (CONDITIONAL_JUMP)
    JMP 0x0042b5c8                      ; 0042b5f0 | LAB_0042b5c8
        ;   XREF to: 0042b5c8 (UNCONDITIONAL_JUMP)
    MOV ESI,dword ptr [ESP + 0x18]      ; 0042b5f2
        ;   Label: LAB_0042b5f2
    PUSH ESI                            ; 0042b5f6
    PUSH EDX                            ; 0042b5f7
    CALL core_skeleton.cpp_CDeformableModelInstance_findClosestBone_FUN_005a1160 ; 0042b5f8 | int core_skeleton.cpp_CDeformableModelInstance_findClosestBone_FUN_005a1160(CDeformableModelInstance * this_ptr, CVector3f * point)
    ...
    PUSH EAX                            ; 0042b641
    CALL core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_005a0820 ; 0042b642 | CSkeleton * core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_005a0820(CDeformableModelInstance * this_ptr)
        ;   XREF to: 005a0820 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0042b647
    PUSH EAX                            ; 0042b64a
    PUSH EBX                            ; 0042b64b
    CALL core_charactr.cpp_CCharacter_FUN_0042a520 ; 0042b64c | void core_charactr.cpp_CCharacter_FUN_0042a520(CCharacter * this_ptr)
