...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_charactr_cpp_CCharacter_getDeathState_FUN_0042c580(CCharacter *this_ptr)
;
; Parameters:
; CCharacter *     Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_stranger.cpp_CStranger_getDeathState_FUN_005c67c0 at 005c67e0
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0042c580
        ;   Label: core_charactr.cpp_CCharacter_getDeathState_FUN_0042c580
