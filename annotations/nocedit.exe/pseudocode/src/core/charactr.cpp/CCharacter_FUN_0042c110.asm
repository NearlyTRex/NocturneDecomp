...
section .text
    ...
    PUSH EAX                            ; 0042c121
    PUSH EBX                            ; 0042c122
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 0042c123 | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
    ...
    JNZ 0x0042c158                      ; 0042c144 | LAB_0042c158
