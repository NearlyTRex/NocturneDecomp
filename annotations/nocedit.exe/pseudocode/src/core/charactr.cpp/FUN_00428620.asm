...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_charactr.cpp_FUN_00428620()
;
; Local Variables:
...
section .text
    ...
    MOV EAX,dword ptr [ESP]             ; 00428655
        ;   Label: LAB_00428655
    JMP 0x00428649                      ; 00428658 | LAB_00428649
