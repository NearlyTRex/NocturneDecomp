...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_charactr.cpp_CCharacter_FUN_0042ad00(CCharacter * this_ptr)
;
; Parameters:
...
section .text
    ...
    JNZ 0x0042ad1f                      ; 0042ad16 | LAB_0042ad1f
    ...
    POP EBX                             ; 0042ad1d
    RET                                 ; 0042ad1e
    PUSH 0x66e784                       ; 0042ad1f | SMRGLTextureBasic DAT_0066e784
        ;   Label: LAB_0042ad1f
    MOV ECX,dword ptr [0x006703ec]      ; 0042ad24 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH ECX                            ; 0042ad2a | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80 ; 0042ad2b | void engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80(CDemonRenderer * this_ptr, SMRGLTextureBasic * texture)
    ...
    JNZ 0x0042aeb4                      ; 0042ad47 | LAB_0042aeb4
        ;   XREF to: 0042aeb4 (CONDITIONAL_JUMP)
    PUSH EDI                            ; 0042ad4d
    CALL core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_005a0820 ; 0042ad4e | CSkeleton * core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_005a0820(CDeformableModelInstance * this_ptr)
        ;   XREF to: 005a0820 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0042ad53
    PUSH EDI                            ; 0042ad56
    MOV ESI,EAX                         ; 0042ad57
    MOV EBX,EAX                         ; 0042ad59
    CALL core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0 ; 0042ad5b | CDeformableModel * core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0(CDeformableModelInstance * this_ptr)
    ...
    JLE 0x0042adf4                      ; 0042adad | LAB_0042adf4
        ;   XREF to: 0042adf4 (CONDITIONAL_JUMP)
    FLD float ptr [0x0065b830]          ; 0042adaf | undefined4 DAT_0065b830
    FLD double ptr [0x00617132]         ; 0042adb5 | double DOUBLE_00617132
    MOV EDX,EAX                         ; 0042adbb
    FLD float ptr [EDX + 0x2f30]        ; 0042adbd
        ;   Label: LAB_0042adbd
    MOV EAX,dword ptr [EDX + 0x2f20]    ; 0042adc3
    FMUL ST1                            ; 0042adc9
    FLD float ptr [EAX*0x4 + 0x823c54]  ; 0042adcb | undefined4 DAT_00823c54
    FLD ST3                             ; 0042add2
    FDIVP ST2,ST0                       ; 0042add4
    FADDP                               ; 0042add6
    FSTP float ptr [EAX*0x4 + 0x823c54] ; 0042add8 | undefined4 DAT_00823c54
    MOV EAX,dword ptr [EBP + 0x14]      ; 0042addf
    INC ECX                             ; 0042ade2
    MOV ESI,dword ptr [EAX + 0x2f10]    ; 0042ade3
    ADD EDX,0x18                        ; 0042ade9
    CMP ECX,ESI                         ; 0042adec
    JL 0x0042adbd                       ; 0042adee | LAB_0042adbd
    ...
    JLE 0x0042ae31                      ; 0042ae00 | LAB_0042ae31
        ;   XREF to: 0042ae31 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [ESP + 0x10]      ; 0042ae02
    FLD float ptr [ECX*0x4 + 0x823c54]  ; 0042ae06 | undefined4 DAT_00823c54 | DAT_00823c58
        ;   Label: LAB_0042ae06
    FCOMP double ptr [0x00617132]       ; 0042ae0d | double DOUBLE_00617132
    FNSTSW AX                           ; 0042ae13
    SAHF                                ; 0042ae15
    JC 0x0042ae19                       ; 0042ae16 | LAB_0042ae19
        ;   XREF to: 0042ae19 (CONDITIONAL_JUMP)
    INC EDX                             ; 0042ae18
    CMP dword ptr [EDI + 0x8dcc],-0x1   ; 0042ae19
        ;   Label: LAB_0042ae19
    JNZ 0x0042ae23                      ; 0042ae20 | LAB_0042ae23
    ...
    JGE 0x0042af38                      ; 0042ae5d | LAB_0042af38
    ...
    JGE 0x0042aeeb                      ; 0042ae7d | LAB_0042aeeb
        ;   XREF to: 0042aeeb (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 0042ae83
    MOV AL,byte ptr [EBX + 0x1]         ; 0042ae85
    FLD float ptr [ECX + 0x4]           ; 0042ae88
    FMUL float ptr [EAX*0x4 + 0x823c54] ; 0042ae8b | undefined4 DAT_00823c54
    CALL crt_math.c_round_FUN_005fe6b0  ; 0042ae92 | double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    JMP 0x0042ae77                      ; 0042aeb2 | LAB_0042ae77
    ...
    PUSH -0x1                           ; 0042aebd
    PUSH EDI                            ; 0042aebf
    CALL core_skeleton.cpp_CDeformableModelInstance_renderWithOptions_FUN_005a0150 ; 0042aec0 | void core_skeleton.cpp_CDeformableModelInstance_renderWithOptions_FUN_005a0150(CDeformableModelInstance * this_ptr, int lod_index, uint render_flags, int lighting_mode, ...)
    ...
    JMP 0x0042ae3d                      ; 0042aee6 | LAB_0042ae3d
        ;   XREF to: 0042ae3d (UNCONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 0042aeeb
        ;   Label: LAB_0042aeeb
    FCOMP double ptr [0x00617132]       ; 0042aeee | double DOUBLE_00617132
    FNSTSW AX                           ; 0042aef4
    SAHF                                ; 0042aef6
    JBE 0x0042af00                      ; 0042aef7 | LAB_0042af00
    ...
    MOV EAX,[0x006703ec]                ; 0042af0b | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    CALL crt_math.c_round_FUN_005fe6b0  ; 0042af10 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    INC EDI                             ; 0042af15
    FISTP dword ptr [ESP + 0x1c]        ; 0042af16
    ADD EBX,0x34                        ; 0042af1a
    MOV EDX,dword ptr [EAX]             ; 0042af1d | CDemonRenderer g_CDemonRendererInstance
    ...
    JMP 0x0042ae52                      ; 0042af33 | LAB_0042ae52
    ...
    PUSH EAX                            ; 0042af4b
    CALL core_skeleton.cpp_CDeformableModelInstance_renderWithOptions_FUN_005a0150 ; 0042af4c | void core_skeleton.cpp_CDeformableModelInstance_renderWithOptions_FUN_005a0150(CDeformableModelInstance * this_ptr, int lod_index, uint render_flags, int lighting_mode, ...)
        ;   XREF to: 005a0150 (UNCONDITIONAL_CALL)
