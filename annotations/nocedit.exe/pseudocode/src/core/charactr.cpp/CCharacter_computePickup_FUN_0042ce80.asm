...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_charactr.cpp_CCharacter_computePickup_FUN_0042ce80(CCharacter * this_ptr)
;
; Parameters:
...
section .text
    ...
    JL 0x0042cf9f                       ; 0042ceaa | LAB_0042cf9f
    ...
    PUSH EAX                            ; 0042cebf
    CALL core_xform.cpp_buildMatrixFromEulerAndPosition_FUN_005f5390 ; 0042cec0 | void core_xform.cpp_buildMatrixFromEulerAndPosition_FUN_005f5390(CMatrix3x4f * output_matrix, CVector3f * position, CVector3f * euler_angles)
    ...
    PUSH EAX                            ; 0042cedd
    CALL core_xform.cpp_buildMatrixFromEulerAndPositionDirect_FUN_005f54c0 ; 0042cede | void core_xform.cpp_buildMatrixFromEulerAndPositionDirect_FUN_005f54c0(CMatrix3x4f * output_matrix, CVector3f * position, CVector3f * euler_angles)
    ...
    CALL core_xform.cpp_multiplyMatrix3x4_FUN_005f4f10 ; 0042cefe | CMatrix3x4f * core_xform.cpp_multiplyMatrix3x4_FUN_005f4f10(CMatrix3x4f * output_matrix, CMatrix3x4f * matrix_a, CMatrix3x4f * matrix_b)
    ...
    CALL core_xform.cpp_multiplyMatrix3x4_FUN_005f4f10 ; 0042cf41 | CMatrix3x4f * core_xform.cpp_multiplyMatrix3x4_FUN_005f4f10(CMatrix3x4f * output_matrix, CMatrix3x4f * matrix_a, CMatrix3x4f * matrix_b)
        ;   XREF to: 005f4f10 (UNCONDITIONAL_CALL)
    ...
    CALL core_xform.cpp_inverse_FUN_005f6210 ; 0042cf63 | CMatrix3x4f * core_xform.cpp_inverse_FUN_005f6210(CMatrix3x4f * output_matrix, CMatrix3x4f * input_matrix)
    ...
    FNSTSW AX                           ; 0042cf84
    SAHF                                ; 0042cf86
    JNC 0x0042cfc7                      ; 0042cf87 | LAB_0042cfc7
    ...
    POP EBX                             ; 0042cf9d
    RET                                 ; 0042cf9e
    MOV ECX,0x617329                    ; 0042cf9f | = "..\\core\\charactr.cpp" | s_core_charactr_cpp_00617329 = ..\core\charactr.cpp
        ;   Label: LAB_0042cf9f
    MOV ESI,0xc00                       ; 0042cfa4
    PUSH 0x61733e                       ; 0042cfa9 | = "CCharacter::computePickup - invalid b..." | s_CCharacter_computePickup_0061733e = CCharacter::computePickup - invalid bone!
    MOV dword ptr [0x02f0ca48],ECX      ; 0042cfae | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 0042cfb4 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0042cfba | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0042cfbf
    JMP 0x0042ceb0                      ; 0042cfc2 | LAB_0042ceb0
