...
section .text
    ...
    PUSH EAX                            ; 0042a3fe
    CALL core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0 ; 0042a3ff | CDeformableModel * core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0(CDeformableModelInstance * this_ptr)
        ;   XREF to: 005a07a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0042a404
    PUSH EAX                            ; 0042a407
    CALL core_skeleton.cpp_CDeformableModel_getPartPtr_FUN_0059c220 ; 0042a408 | SPart * core_skeleton.cpp_CDeformableModel_getPartPtr_FUN_0059c220(CDeformableModel * this_ptr, int part_index)
