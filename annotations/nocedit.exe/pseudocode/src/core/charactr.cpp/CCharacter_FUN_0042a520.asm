...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_charactr.cpp_CCharacter_FUN_0042a520(CCharacter * this_ptr)
;
; Parameters:
...
;
; XREF[2]:
;   core_charactr.cpp_CCharacter_FUN_0042a830 at 0042acb3
;   core_charactr.cpp_CCharacter_FUN_0042b5b0 at 0042b64c
;
; Referenced Globals:
...
section .text
    ...
    JL 0x0042a643                       ; 0042a537 | LAB_0042a643
    ...
    JLE 0x0042a588                      ; 0042a564 | LAB_0042a588
        ;   XREF to: 0042a588 (CONDITIONAL_JUMP)
    CMP EBP,dword ptr [EDX + 0x2857c]   ; 0042a566
        ;   Label: LAB_0042a566
    JZ 0x0042a64b                       ; 0042a56c | LAB_0042a64b
    ...
    JL 0x0042a566                       ; 0042a586 | LAB_0042a566
        ;   XREF to: 0042a566 (CONDITIONAL_JUMP)
    CMP ECX,-0x1                        ; 0042a588
        ;   Label: LAB_0042a588
    JZ 0x0042a643                       ; 0042a58b | LAB_0042a643
        ;   XREF to: 0042a643 (CONDITIONAL_JUMP)
    ...
    FADDP                               ; 0042a5e3
    FSQRT                               ; 0042a5e5
    FMUL double ptr [0x006170c2]        ; 0042a5e7 | double DOUBLE_006170c2
    CALL crt_math.c_round_FUN_005fe6b0  ; 0042a5ed | double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    JLE 0x0042a643                      ; 0042a603 | LAB_0042a643
        ;   XREF to: 0042a643 (CONDITIONAL_JUMP)
    ...
    CMP dword ptr [EBX + 0x2f10],0x32   ; 0042a636
        ;   Label: LAB_0042a636
    JL 0x0042a67f                       ; 0042a63d | LAB_0042a67f
    ...
    FNSTSW AX                           ; 0042a667
    SAHF                                ; 0042a669
    JBE 0x0042a572                      ; 0042a66a | LAB_0042a572
    ...
    JMP 0x0042a572                      ; 0042a67a | LAB_0042a572
    ...
    CALL core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0 ; 0042a6a6 | CDeformableModel * core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0(CDeformableModelInstance * this_ptr)
        ;   XREF to: 005a07a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0042a6ab
    PUSH EBP                            ; 0042a6ae
    PUSH EAX                            ; 0042a6af
    CALL core_skeleton.cpp_CDeformableModel_getBonePart_FUN_0059c2d0 ; 0042a6b0 | int core_skeleton.cpp_CDeformableModel_getBonePart_FUN_0059c2d0(CDeformableModel * this_ptr, int bone_index)
    ...
    JZ 0x0042a742                       ; 0042a72c | LAB_0042a742
    ...
    PUSH EAX                            ; 0042a753
    CALL core_xform.cpp_transformVector3x4_FUN_005f4dc0 ; 0042a754 | CVector3f * core_xform.cpp_transformVector3x4_FUN_005f4dc0(CVector3f * output_vector, CVector3f * input_vector, CMatrix3x4f * matrix)
    ...
    PUSH EAX                            ; 0042a761
    PUSH EBX                            ; 0042a762
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 0042a763 | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
    ...
    FLD double ptr [0x006170c2]         ; 0042a7b9 | double DOUBLE_006170c2
    ...
    JL 0x0042a636                       ; 0042a81a | LAB_0042a636
