...
;                               FUNCTION
; *****************************************************************************
; __cdecl CCharacter * __cdecl core_charactr_cpp_CCharacter_ctor_FUN_00427e20(CCharacter *this_ptr)
;
; Parameters:
...
;   core_hero.cpp_CHero_ctor_FUN_004f2340 at 004f2346
;   core_npc.cpp_CNPC_ctor_FUN_005447e0 at 005447e6
;
; Referenced Globals:
...
section .text
    ...
    PUSH EAX                            ; 00427e58
    CALL crt_memory.c___arrinit_FUN_005fe667 ; 00427e59
    ...
    PUSH EAX                            ; 00427e6d
    CALL crt_memory.c___arrinit_FUN_005fe667 ; 00427e6e
        ;   XREF to: 005fe667 (UNCONDITIONAL_CALL)  ; void * crt_memory.c___arrinit_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
    ...
    PUSH EAX                            ; 00427e82
    CALL crt_memory.c___arrinit_FUN_005fe667 ; 00427e83
        ;   XREF to: 005fe667 (UNCONDITIONAL_CALL)  ; void * crt_memory.c___arrinit_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
    ...
    PUSH EAX                            ; 00427e97
    CALL crt_memory.c___arrinit_FUN_005fe667 ; 00427e98
        ;   XREF to: 005fe667 (UNCONDITIONAL_CALL)  ; void * crt_memory.c___arrinit_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
