...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_charactr.cpp_CCharacter_FUN_0042bd30(CCharacter * this_ptr)
;
; Parameters:
...
section .text
    ...
    TEST DL,DL                          ; 0042bd57
    JZ 0x0042bd75                       ; 0042bd59 | LAB_0042bd75
    ...
    JNZ 0x0042bd7d                      ; 0042bd73 | LAB_0042bd7d
    ...
    PUSH EDI                            ; 0042bd8a
    PUSH EBX                            ; 0042bd8b
    CALL core_skeleton.cpp_CDeformableModelInstance_dismemberPart_FUN_005a1040 ; 0042bd8c | void core_skeleton.cpp_CDeformableModelInstance_dismemberPart_FUN_005a1040(CDeformableModelInstance * this_ptr, CBodyPart * body_part, int part_index)
    ...
    JLE 0x0042bde5                      ; 0042bda7 | LAB_0042bde5
    ...
    JZ 0x0042be7d                       ; 0042bdc5 | LAB_0042be7d
    ...
    JL 0x0042bdbd                       ; 0042bde3 | LAB_0042bdbd
    ...
    JLE 0x0042be25                      ; 0042bdf5 | LAB_0042be25
    ...
    JZ 0x0042beee                       ; 0042be0b | LAB_0042beee
    ...
    JL 0x0042be03                       ; 0042be23 | LAB_0042be03
    ...
    CMP EDI,dword ptr [ESI + 0x24b0]    ; 0042be33
        ;   Label: LAB_0042be33
    JNZ 0x0042be5a                      ; 0042be39 | LAB_0042be5a
    ...
    JL 0x0042be33                       ; 0042be61 | LAB_0042be33
    ...
    CALL core_xform.cpp_multiplyMatrix3x4_FUN_005f4f10 ; 0042be9c | CMatrix3x4f * core_xform.cpp_multiplyMatrix3x4_FUN_005f4f10(CMatrix3x4f * output_matrix, CMatrix3x4f * matrix_a, CMatrix3x4f * matrix_b)
    ...
    CALL core_xform.cpp_matrixToEulerAngles_FUN_005f5690 ; 0042beb6 | CVector3f * core_xform.cpp_matrixToEulerAngles_FUN_005f5690(CVector3f * euler_out, CMatrix3x3f * matrix_ptr)
    ...
    PUSH EDI                            ; 0042bee0
    CALL core_bodypart.cpp_FUN_0041add0 ; 0042bee1 | undefined core_bodypart.cpp_FUN_0041add0()
        ;   XREF to: 0041add0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0042bee6
    JMP 0x0042bdcb                      ; 0042bee9 | LAB_0042bdcb
        ;   XREF to: 0042bdcb (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0x4]       ; 0042beee
        ;   Label: LAB_0042beee
    TEST EAX,EAX                        ; 0042bef1
    JL 0x0042be11                       ; 0042bef3 | LAB_0042be11
    ...
    PUSH EAX                            ; 0042bf06
    CALL core_xform.cpp_transformVector3x4_FUN_005f4dc0 ; 0042bf07 | CVector3f * core_xform.cpp_transformVector3x4_FUN_005f4dc0(CVector3f * output_vector, CVector3f * input_vector, CMatrix3x4f * matrix)
    ...
    PUSH ECX                            ; 0042bf19
    CALL core_bodypart.cpp_FUN_0041ae50 ; 0042bf1a | undefined core_bodypart.cpp_FUN_0041ae50()
        ;   XREF to: 0041ae50 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0042bf1f
    JMP 0x0042be11                      ; 0042bf22 | LAB_0042be11
