...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_charactr_cpp_CCharacter_applyDamage_FUN_00428ee0(CCharacter *this_ptr,int damage_type,float damage_amount)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00428ee0
        ;   Label: core_charactr.cpp_CCharacter_applyDamage_FUN_00428ee0
