...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_charactr.cpp_CCharacter_FUN_00429aa0(CCharacter * this_ptr)
;
; Parameters:
...
;   core_charactr.cpp_CCharacter_FUN_0042a390 at 0042a3cd
...
section .text
    ...
    JZ 0x00429b06                       ; 00429aae | LAB_00429b06
        ;   XREF to: 00429b06 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x006703ec]      ; 00429ab0 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
        ;   Label: LAB_00429ab0
    PUSH ECX                            ; 00429ab6 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_getFaceCount_FUN_0048cae0 ; 00429ab7 | int engine_drender.cpp_CDemonRenderer_getFaceCount_FUN_0048cae0(CDemonRenderer * this_ptr)
        ;   XREF to: 0048cae0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00429abc
    TEST EAX,EAX                        ; 00429abf
    JNZ 0x00429aeb                      ; 00429ac1 | LAB_00429aeb
        ;   XREF to: 00429aeb (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x2614],0x0    ; 00429ac3
    JNZ 0x00429ad5                      ; 00429aca | LAB_00429ad5
        ;   XREF to: 00429ad5 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 00429acc
    CALL core_charactr.cpp_CCharacter_FUN_0042ad00 ; 00429acd | void core_charactr.cpp_CCharacter_FUN_0042ad00(CCharacter * this_ptr)
    ...
    FNSTSW AX                           ; 00429add
    SAHF                                ; 00429adf
    JNC 0x00429aeb                      ; 00429ae0 | LAB_00429aeb
        ;   XREF to: 00429aeb (CONDITIONAL_JUMP)
    PUSH EBX                            ; 00429ae2
    CALL core_charactr.cpp_CCharacter_FUN_0042af60 ; 00429ae3 | void core_charactr.cpp_CCharacter_FUN_0042af60(CCharacter * this_ptr)
        ;   XREF to: 0042af60 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00429ae8
    PUSH EBX                            ; 00429aeb
        ;   Label: LAB_00429aeb
    CALL core_charactr.cpp_CCharacter_FUN_0042a420 ; 00429aec | void core_charactr.cpp_CCharacter_FUN_0042a420(CCharacter * this_ptr)
        ;   XREF to: 0042a420 (UNCONDITIONAL_CALL)
    MOV EAX,[0x0067b654]                ; 00429af1 | CGame g_CGameInstance | CGame * g_CGamePtr
    MOV EDI,dword ptr [EAX + 0x21c]     ; 00429af6 | DAT_02d81cb8
    ADD ESP,0x4                         ; 00429afc
    TEST EDI,EDI                        ; 00429aff
    JNZ 0x00429b30                      ; 00429b01 | LAB_00429b30
    ...
    PUSH ESI                            ; 00429b14
    CALL core_skeleton.cpp_CDeformableModelInstance_renderWithOptions_FUN_005a0150 ; 00429b15 | void core_skeleton.cpp_CDeformableModelInstance_renderWithOptions_FUN_005a0150(CDeformableModelInstance * this_ptr, int lod_index, uint render_flags, int lighting_mode, ...)
        ;   XREF to: 005a0150 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 00429b1a
    PUSH ESI                            ; 00429b1d
    LEA EAX,[EBX + 0x2a94]              ; 00429b1e
    PUSH EAX                            ; 00429b24
    CALL core_cloth.cpp_MultipleCallSaveJoinedLight_FUN_0043c320 ; 00429b25 | undefined core_cloth.cpp_MultipleCallSaveJoinedLight_FUN_0043c320()
        ;   XREF to: 0043c320 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00429b2a
    POP ESI                             ; 00429b2d
    JMP 0x00429ab0                      ; 00429b2e | LAB_00429ab0
        ;   XREF to: 00429ab0 (UNCONDITIONAL_JUMP)
    PUSH EBX                            ; 00429b30
        ;   Label: LAB_00429b30
    CALL core_charactr.cpp_CCharacter_FUN_00429b40 ; 00429b31 | void core_charactr.cpp_CCharacter_FUN_00429b40(CCharacter * this_ptr)
