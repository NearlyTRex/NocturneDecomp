...
;   core_biggs.cpp_CBiggs_process_FUN_00418700 at 00418958
;   core_boneguy.cpp_CBoneGuy_process_FUN_0041bf90 at 0041c322
;   core_bride.cpp_CBride_process_FUN_00423a30 at 00423bd3
;   core_colonel.cpp_CColonel_processMotionEvents_FUN_00440430 at 00440484
;   core_cow.cpp_CZombieCow_process_FUN_00444310 at 00444564
;   core_dog.cpp_CZombieDog_process_FUN_0047f140 at 0047f3ab
;   core_dracbrid.cpp_CDraculaBride_process_FUN_00484410 at 00484623
...
section .text
    ...
    PUSH EBX                            ; 0042ec40
        ;   Label: core_charactr.cpp_CCharacter_processMotion_FUN_0042ec40
    PUSH ESI                            ; 0042ec41
    PUSH EDI                            ; 0042ec42
    ...
    JNC 0x0042edb5                      ; 0042ec57
        ;   XREF to: 0042edb5 (CONDITIONAL_JUMP)  ; LAB_0042edb5
    CMP EAX,0x1                         ; 0042ec5d
    JNZ 0x0042ec6b                      ; 0042ec60
        ;   XREF to: 0042ec6b (CONDITIONAL_JUMP)  ; LAB_0042ec6b
    CMP dword ptr [EBX + 0x2410],0x0    ; 0042ec62
    JNZ 0x0042ec72                      ; 0042ec69
        ;   XREF to: 0042ec72 (CONDITIONAL_JUMP)  ; LAB_0042ec72
    ...
    PUSH 0x0                            ; 0042ec72
        ;   Label: LAB_0042ec72
    PUSH 0x6175f2                       ; 0042ec74 | = "Bip01 L Foot"
    PUSH ESI                            ; 0042ec79
    CALL core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_005a0820 ; 0042ec7a
        ;   XREF to: 005a0820 (UNCONDITIONAL_CALL)  ; CSkeleton * core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_005a0820(CDeformableModelInstance * this_ptr)
    ADD ESP,0x4                         ; 0042ec7f
    PUSH EAX                            ; 0042ec82
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 0042ec83
    ...
    CMP dword ptr [EBX + 0x2410],0x0    ; 0042ecb8
        ;   Label: LAB_0042ecb8
    JZ 0x0042ec6b                       ; 0042ecbf
        ;   XREF to: 0042ec6b (CONDITIONAL_JUMP)  ; LAB_0042ec6b
    PUSH 0x0                            ; 0042ecc1
    PUSH 0x6175ff                       ; 0042ecc3 | = "Bip01 R Foot"
    PUSH ESI                            ; 0042ecc8
    CALL core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_005a0820 ; 0042ecc9
        ;   XREF to: 005a0820 (UNCONDITIONAL_CALL)  ; CSkeleton * core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_005a0820(CDeformableModelInstance * this_ptr)
    ADD ESP,0x4                         ; 0042ecce
    PUSH EAX                            ; 0042ecd1
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 0042ecd2
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 0042ecd7
    TEST EAX,EAX                        ; 0042ecda
    JL 0x0042ec6b                       ; 0042ecdc
        ;   XREF to: 0042ec6b (CONDITIONAL_JUMP)  ; LAB_0042ec6b
    ...
    CMP dword ptr [EBX + 0x2410],0x0    ; 0042ed07
        ;   Label: LAB_0042ed07
    JZ 0x0042ec6b                       ; 0042ed0e
        ;   XREF to: 0042ec6b (CONDITIONAL_JUMP)  ; LAB_0042ec6b
    PUSH 0x0                            ; 0042ed14
    PUSH 0x61760c                       ; 0042ed16 | = "Bip01 L Foot"
    PUSH ESI                            ; 0042ed1b
    CALL core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_005a0820 ; 0042ed1c
        ;   XREF to: 005a0820 (UNCONDITIONAL_CALL)  ; CSkeleton * core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_005a0820(CDeformableModelInstance * this_ptr)
    ADD ESP,0x4                         ; 0042ed21
    PUSH EAX                            ; 0042ed24
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 0042ed25
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 0042ed2a
    TEST EAX,EAX                        ; 0042ed2d
    JL 0x0042ec6b                       ; 0042ed2f
        ;   XREF to: 0042ec6b (CONDITIONAL_JUMP)  ; LAB_0042ec6b
    ...
    CMP dword ptr [EBX + 0x2410],0x0    ; 0042ed5e
        ;   Label: LAB_0042ed5e
    JZ 0x0042ec6b                       ; 0042ed65
        ;   XREF to: 0042ec6b (CONDITIONAL_JUMP)  ; LAB_0042ec6b
    PUSH 0x0                            ; 0042ed6b
    PUSH 0x617619                       ; 0042ed6d | = "Bip01 R Foot"
    PUSH ESI                            ; 0042ed72
    CALL core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_005a0820 ; 0042ed73
        ;   XREF to: 005a0820 (UNCONDITIONAL_CALL)  ; CSkeleton * core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_005a0820(CDeformableModelInstance * this_ptr)
    ADD ESP,0x4                         ; 0042ed78
    PUSH EAX                            ; 0042ed7b
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 0042ed7c
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 0042ed81
    TEST EAX,EAX                        ; 0042ed84
    JL 0x0042ec6b                       ; 0042ed86
        ;   XREF to: 0042ec6b (CONDITIONAL_JUMP)  ; LAB_0042ec6b
    ...
    POP EBX                             ; 0042edb3
    RET                                 ; 0042edb4
    JBE 0x0042ecb8                      ; 0042edb5
        ;   XREF to: 0042ecb8 (CONDITIONAL_JUMP)  ; LAB_0042ecb8
        ;   Label: LAB_0042edb5
    CMP EAX,0x1f                        ; 0042edbb
    JC 0x0042ec6b                       ; 0042edbe
        ;   XREF to: 0042ec6b (CONDITIONAL_JUMP)  ; LAB_0042ec6b
    JBE 0x0042ed07                      ; 0042edc4
        ;   XREF to: 0042ed07 (CONDITIONAL_JUMP)  ; LAB_0042ed07
    CMP EAX,0x25                        ; 0042edca
    JZ 0x0042ed5e                       ; 0042edcd
        ;   XREF to: 0042ed5e (CONDITIONAL_JUMP)  ; LAB_0042ed5e
