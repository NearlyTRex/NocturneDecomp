...
{
  (out_box->min).x = *(float *)(this_ptr->field11_0x25a0 + 0x58);
  (out_box->min).y = *(float *)(this_ptr->field11_0x25a0 + 0x5c);
  (out_box->min).z = *(float *)(this_ptr->field11_0x25a0 + 0x60);
  (out_box->max).x = *(float *)(this_ptr->field11_0x25a0 + 100);
  (out_box->max).y = *(float *)(this_ptr->field11_0x25a0 + 0x68);
  (out_box->max).z = *(float *)(this_ptr->field11_0x25a0 + 0x6c);
  return out_box;
}
