...
core_charactr_cpp_CCharacter_dismember_FUN_0042b9e0
          (CCharacter *this_ptr,CVector3f *impact_point,float impact_force)

{
  ...
  if ((this_ptr->model).model_name[0] != '\0') {
    ...
    if (1 < (int)local_24) {
      ...
      if (0 < (int)local_24) {
        do {
          if ((impact_point != (CVector3f *)0x0) && (0.0 < impact_force)) {
            core_vehicle_cpp_convertDirectionVectorToEulerAngles_FUN_005e7830
                      (&local_3c,impact_point);
            local_20 = -impact_force;
            local_18 = core_actor_cpp_getRandomFloat_FUN_0040cc10(local_20,impact_force);
