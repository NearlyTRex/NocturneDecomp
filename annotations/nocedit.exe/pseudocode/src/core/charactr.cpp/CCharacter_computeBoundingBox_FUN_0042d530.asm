...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_charactr_cpp_CCharacter_computeBoundingBox_FUN_0042d530(CCharacter *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0042d530
        ;   Label: core_charactr.cpp_CCharacter_computeBoundingBox_FUN_0042d530
