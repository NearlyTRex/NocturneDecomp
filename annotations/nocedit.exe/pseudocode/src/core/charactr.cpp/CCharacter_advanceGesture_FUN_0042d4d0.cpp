// Name: core_charactr.cpp_CCharacter_advanceGesture_FUN_0042d4d0
// Address: 0042d4d0
// Address Range: [[0042d4d0, 0042d52d]]
// Convention: __cdecl
// Signature: void __cdecl core_charactr_cpp_CCharacter_advanceGesture_FUN_0042d4d0(CCharacter *this_ptr,float delta_time)
...

{
  ...
  if (-1 < iVar1) {
    ...
    this_ptr->gesture_frame = delta_time * pCVar2->motions[iVar1].fps + this_ptr->gesture_frame;
