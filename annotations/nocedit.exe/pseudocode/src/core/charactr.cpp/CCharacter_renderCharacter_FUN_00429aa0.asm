...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_charactr_cpp_CCharacter_renderCharacter_FUN_00429aa0(CCharacter *this_ptr)
;
; Parameters:
...
;   core_charactr.cpp_CCharacter_renderBurn_FUN_0042ad00
;   core_charactr.cpp_CCharacter_renderCollision_FUN_00429b40
;   core_charactr.cpp_CCharacter_renderEthereal_FUN_0042af60
...
section .text
    ...
    PUSH EBX                            ; 00429aa0
        ;   Label: core_charactr.cpp_CCharacter_renderCharacter_FUN_00429aa0
    PUSH EDI                            ; 00429aa1
    ...
    PUSH EBX                            ; 00429acc
    CALL core_charactr.cpp_CCharacter_renderBurn_FUN_0042ad00 ; 00429acd
        ;   XREF to: 0042ad00 (UNCONDITIONAL_CALL)  ; void core_charactr.cpp_CCharacter_renderBurn_FUN_0042ad00(CCharacter * this_ptr)
    ...
    JNC 0x00429aeb                      ; 00429ae0
        ;   XREF to: 00429aeb (CONDITIONAL_JUMP)  ; LAB_00429aeb
    PUSH EBX                            ; 00429ae2
    CALL core_charactr.cpp_CCharacter_renderEthereal_FUN_0042af60 ; 00429ae3
        ;   XREF to: 0042af60 (UNCONDITIONAL_CALL)  ; void core_charactr.cpp_CCharacter_renderEthereal_FUN_0042af60(CCharacter * this_ptr)
    ...
    PUSH EBX                            ; 00429b30
        ;   Label: LAB_00429b30
    CALL core_charactr.cpp_CCharacter_renderCollision_FUN_00429b40 ; 00429b31
        ;   XREF to: 00429b40 (UNCONDITIONAL_CALL)  ; void core_charactr.cpp_CCharacter_renderCollision_FUN_00429b40(CCharacter * this_ptr)
