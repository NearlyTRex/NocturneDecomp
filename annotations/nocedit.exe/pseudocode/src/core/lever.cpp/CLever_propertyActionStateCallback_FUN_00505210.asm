...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_lever_cpp_CLever_propertyActionStateCallback_FUN_00505210(CLever *this_ptr,CActorProperty *property)
;
; Parameters:
...
;
; XREF[1]:
;   core_lever.cpp_CLever_getPropertyList_FUN_00505240 at 00505283
;
; Referenced Globals:
...
section .text
    ...
    MOV EDX,dword ptr [0x02dd3090]      ; 00505210 | g_CLeverClassInfo.name_hash
        ;   Label: core_lever.cpp_CLever_propertyActionStateCallback_FUN_00505210
    PUSH EDX                            ; 00505216
