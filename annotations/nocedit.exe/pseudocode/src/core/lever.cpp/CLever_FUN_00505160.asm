...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_lever_cpp_CLever_FUN_00505160(CLever *this_ptr)
;
; Parameters:
; CLever *         Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_lever.cpp_CLever_getPropertyList_FUN_00505240 at 0050526b
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00505160
        ;   Label: core_lever.cpp_CLever_FUN_00505160
