...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_lever_cpp_CLever_showEditorHelp_FUN_00505390(CLever *this_ptr,int *y_pos)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00505390
        ;   Label: core_lever.cpp_CLever_showEditorHelp_FUN_00505390
    PUSH ESI                            ; 00505391
    PUSH EDI                            ; 00505392
