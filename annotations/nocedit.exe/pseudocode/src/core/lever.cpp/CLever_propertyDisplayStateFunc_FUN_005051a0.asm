...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_lever_cpp_CLever_propertyDisplayStateFunc_FUN_005051a0 (CLever *this_ptr,CActorProperty *property,char *output_buffer)
;
; Parameters:
...
;
; XREF[1]:
;   core_lever.cpp_CLever_getPropertyList_FUN_00505240 at 00505288
;
; Referenced Globals:
...
section .text
    ...
    PUSH ESI                            ; 005051a0
        ;   Label: core_lever.cpp_CLever_propertyDisplayStateFunc_FUN_005051a0
    PUSH EDI                            ; 005051a1
