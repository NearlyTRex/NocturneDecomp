...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_lever.cpp_FUN_00505100()
;
;
; XREF[1]:
;   core_lever.cpp_FUN_00505240 at 00505270
;
; Referenced Globals:
...
section .text
    ...
    PUSH ECX                            ; 00505111
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 00505112 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EAX + 0x2d8]     ; 00505117
    ADD ESP,0x8                         ; 0050511d
    TEST EAX,EAX                        ; 00505120
    JBE 0x0050514b                      ; 00505122 | LAB_0050514b
        ;   XREF to: 0050514b (CONDITIONAL_JUMP)
    CMP EAX,0x1                         ; 00505124
    JNZ 0x00505152                      ; 00505127 | LAB_00505152
        ;   XREF to: 00505152 (CONDITIONAL_JUMP)
    MOV ESI,0x631165                    ; 00505129 | = "Wall lever" | s_Wall_lever_00631165 = Wall lever
    PUSH EDI                            ; 0050512e
        ;   Label: LAB_0050512e
    MOV AL,byte ptr [ESI]               ; 0050512f | = "Wall lever" | s_Ground_lever_00631158 = Ground lever | s_Wall_lever_00631165 = Wall lever
        ;   Label: LAB_0050512f
    MOV byte ptr [EDI],AL               ; 00505131
    CMP AL,0x0                          ; 00505133
    JZ 0x00505147                       ; 00505135 | LAB_00505147
        ;   XREF to: 00505147 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 00505137 | s_all_lever_00631166
    ADD ESI,0x2                         ; 0050513a
    MOV byte ptr [EDI + 0x1],AL         ; 0050513d
    ADD EDI,0x2                         ; 00505140
    CMP AL,0x0                          ; 00505143
    JNZ 0x0050512f                      ; 00505145 | LAB_0050512f
    ...
    POP ESI                             ; 00505149
    RET                                 ; 0050514a
    MOV ESI,0x631158                    ; 0050514b | = "Ground lever" | s_Ground_lever_00631158 = Ground lever
        ;   Label: LAB_0050514b
    JMP 0x0050512e                      ; 00505150 | LAB_0050512e
        ;   XREF to: 0050512e (UNCONDITIONAL_JUMP)
    MOV ESI,0x631170                    ; 00505152 | = "Unknown" | s_Unknown_00631170 = Unknown
        ;   Label: LAB_00505152
    JMP 0x0050512e                      ; 00505157 | LAB_0050512e
        ;   XREF to: 0050512e (UNCONDITIONAL_JUMP)
