...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_lever.cpp_FUN_00504d80()
;
;
; Called Functions:
...
section .text
    ...
    PUSH EAX                            ; 00504d8e
    CALL core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80 ; 00504d8f | CKeyFramedModel * core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80(CKeyFramedModelInstance * this_ptr)
