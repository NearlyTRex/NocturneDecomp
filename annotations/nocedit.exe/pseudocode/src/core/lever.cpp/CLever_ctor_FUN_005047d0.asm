...
;                               FUNCTION
; *****************************************************************************
; __cdecl CLever * __cdecl core_lever_cpp_CLever_ctor_FUN_005047d0(CLever *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005047d0
        ;   Label: core_lever.cpp_CLever_ctor_FUN_005047d0
    MOV EBX,dword ptr [ESP + 0x8]       ; 005047d1
    PUSH EBX                            ; 005047d5
    CALL core_actor.cpp_CDemonActor_ctor_FUN_004088b0 ; 005047d6
    ...
    PUSH EAX                            ; 005047e3
    CALL core_dmodel.cpp_CKeyFramedModelInstance_ctor_FUN_00478ce0 ; 005047e4
    ...
    PUSH EAX                            ; 0050480c
    MOV dword ptr [EBX + 0x154],0x660914 ; 0050480d | g_CLeverVTable
    CALL core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0 ; 00504817
