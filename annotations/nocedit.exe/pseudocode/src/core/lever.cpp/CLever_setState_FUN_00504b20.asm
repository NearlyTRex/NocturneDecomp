...
section .text
    ...
    PUSH EBX                            ; 00504b20
        ;   Label: core_lever.cpp_CLever_setState_FUN_00504b20
    PUSH ESI                            ; 00504b21
    PUSH EDI                            ; 00504b22
    PUSH EBP                            ; 00504b23
    ...
    MOV EAX,[0x006810c8]                ; 00504b94 | g_CDemonSetInstance | g_CDemonSetPtr
        ;   Label: LAB_00504b94
    CMP ESI,dword ptr [EAX + 0x14d154]  ; 00504b99 | g_CDemonSetInstance.actor_count
    ...
    CALL core_event.cpp_CEventList_executeCommands_FUN_004aabe0 ; 00504bd4
    ...
    CALL core_event.cpp_CEventList_executeCommands_FUN_004aabe0 ; 00504c0e
        ;   XREF to: 004aabe0 (UNCONDITIONAL_CALL)  ; int core_event.cpp_CEventList_executeCommands_FUN_004aabe0(CEventList * this_ptr, char * commands)
    ...
    MOV ECX,dword ptr [0x02dd3090]      ; 00504c50 | g_CLeverClassInfo.name_hash
        ;   Label: LAB_00504c50
    PUSH ECX                            ; 00504c56
    MOV EBP,dword ptr [EBX + EAX*0x1 + 0x14d158] ; 00504c57 | g_CDemonSetInstance.actors[0]
    PUSH EBP                            ; 00504c5e
