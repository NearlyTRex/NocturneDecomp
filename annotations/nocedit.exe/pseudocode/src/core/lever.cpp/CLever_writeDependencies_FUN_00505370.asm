...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_lever_cpp_CLever_writeDependencies_FUN_00505370(CLever *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x8]       ; 00505370
        ;   Label: core_lever.cpp_CLever_writeDependencies_FUN_00505370
