...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_lever.cpp_FUN_00505080()
;
; Local Variables:
...
;
; XREF[1]:
;   core_hero.cpp_FUN_004f2f50 at 004f3055
;
; Called Functions:
...
section .text
    ...
    JNZ 0x005050a4                      ; 00505096 | LAB_005050a4
    ...
    PUSH EAX                            ; 005050ac
    PUSH EBX                            ; 005050ad
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 005050ae | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
        ;   XREF to: 00408f10 (UNCONDITIONAL_CALL)
    MOV ESI,dword ptr [EBX + 0x80c]     ; 005050b3
    ADD ESP,0xc                         ; 005050b9
    TEST ESI,ESI                        ; 005050bc
    JNZ 0x005050cd                      ; 005050be | LAB_005050cd
    ...
    FNSTSW AX                           ; 005050e0
    SAHF                                ; 005050e2
    JBE 0x005050ee                      ; 005050e3 | LAB_005050ee
        ;   XREF to: 005050ee (CONDITIONAL_JUMP)
