// Name: core_ammo.cpp_CAmmo_setWeaponClass_FUN_00410fd0
// Address: 00410fd0
// MANUAL RECONSTRUCTION
// Address Range: [[00410fd0, 004111a7]]
// Convention: __cdecl
// Signature: void __cdecl core_ammo_cpp_CAmmo_setWeaponClass_FUN_00410fd0(CAmmo *this_ptr,char *weapon_class_name)
...

{
  ...
  if (this_ptr->weapon_class_name != weapon_class_name) {
    strcpy(this_ptr->weapon_class_name,weapon_class_name);
  }
