...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_ghoul_cpp_CGhoul_FUN_004e8e40(CGhoul *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004e8e40
        ;   Label: core_ghoul.cpp_CGhoul_FUN_004e8e40
    MOV EBX,dword ptr [ESP + 0x8]       ; 004e8e41
    PUSH EBX                            ; 004e8e45
    CALL core_enemy.cpp_CEnemy_FUN_004aa250 ; 004e8e46
