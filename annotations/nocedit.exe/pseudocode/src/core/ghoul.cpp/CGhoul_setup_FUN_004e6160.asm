...
section .text
    ...
    PUSH EBX                            ; 004e6160
        ;   Label: core_ghoul.cpp_CGhoul_setup_FUN_004e6160
    PUSH ESI                            ; 004e6161
    ...
    PUSH ESI                            ; 004e6198
    MOV [0x02d832fc],EAX                ; 004e6199 | g_GhoulIndices
    ...
    PUSH ESI                            ; 004e61ad
    MOV [0x02d83308],EAX                ; 004e61ae | g_GhoulIndices[3]
    ...
    PUSH ESI                            ; 004e61c2
    MOV [0x02d8330c],EAX                ; 004e61c3 | g_GhoulIndices[4]
    ...
    PUSH ESI                            ; 004e61d7
    MOV [0x02d83310],EAX                ; 004e61d8 | g_GhoulIndices[5]
    ...
    PUSH ESI                            ; 004e61ec
    MOV [0x02d83314],EAX                ; 004e61ed | g_GhoulIndices[6]
    ...
    PUSH ESI                            ; 004e6201
    MOV [0x02d83318],EAX                ; 004e6202 | g_GhoulIndices[7]
    ...
    PUSH ESI                            ; 004e6216
    MOV [0x02d8331c],EAX                ; 004e6217 | g_GhoulIndices[8]
    ...
    PUSH ESI                            ; 004e622b
    MOV [0x02d83300],EAX                ; 004e622c | g_GhoulIndices[1]
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 004e6231
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 004e6236
    MOV [0x02d83304],EAX                ; 004e6239 | g_GhoulIndices[2]
    PUSH 0x1                            ; 004e623e
    ...
    PUSH ESI                            ; 004e6255
    MOV [0x02d83320],EAX                ; 004e6256 | g_GhoulIndices[9]
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 004e625b
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 004e6260
    PUSH EDI                            ; 004e6263
    MOV [0x02d83324],EAX                ; 004e6264 | g_GhoulIndices[10]
    ...
    CALL core_enemy.cpp_CEnemy_setup_FUN_004a9650 ; 004e6367
