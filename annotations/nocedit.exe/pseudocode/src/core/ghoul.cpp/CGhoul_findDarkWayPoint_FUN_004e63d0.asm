...
section .text
    ...
    JNZ 0x004e63fd                      ; 004e63e2 | LAB_004e63fd
    ...
    FNSTSW AX                           ; 004e63f8
    SAHF                                ; 004e63fa
    JNC 0x004e6405                      ; 004e63fb | LAB_004e6405
    ...
    CALL core_actor.cpp_getRandomFloat_FUN_0040cc10 ; 004e640f | float core_actor.cpp_getRandomFloat_FUN_0040cc10(float min_value, float max_value)
