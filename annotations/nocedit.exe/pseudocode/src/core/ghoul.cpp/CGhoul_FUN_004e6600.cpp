...
switchD_004e6f9a_caseD_e:
  ...
  if (0.0 < local_64) {
      ...
      if (*(int *)(in_stack_00000004->field6_0xbe38 + 4) == 0) {
        ...
        if (pCVar13 == in_stack_00000004) {
          ...
          if (iVar10 == 0) {
            ...
            if (0.0 < local_ac) {
              fVar21 = (float10)local_29c.damage_amount * (float10)DOUBLE_0062ddca *
    ...
    case 0xc:
      ...
      fVar21 = (float10)local_14 * (float10)DOUBLE_0062ddba;
      dVar23 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44(extraout_EDX_00,local_14));
    ...
    case 0xd:
      ...
      local_14 = core_actor_cpp_getRandomFloat_FUN_0040cc10(8.0,12.0);
      fVar21 = (float10)local_14 * (float10)DOUBLE_0062ddba;
      dVar23 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44(extraout_EDX_01,local_14));
    ...
    case 0x10:
      ...
      local_14 = core_actor_cpp_getRandomFloat_FUN_0040cc10(8.0,12.0);
      fVar21 = (float10)local_14 * (float10)DOUBLE_0062ddba;
      dVar23 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44(extraout_EDX_02,local_14));
  ...
  *(float *)((in_stack_00000004->base_character).field2_0x240c + 0x2c) =
  ...
  if (iVar10 == 0x11) {
    fVar15 = in_stack_00000004->speed;
    fVar21 = (float10)DOUBLE_0062dd6a;
    *(float *)((in_stack_00000004->base_character).field2_0x240c + 0x2c) =
      ...
      if ((float)in_stack_00000004[1].base_character.base_actor.health <= 0.0) {
        ...
        if (iVar12 == 0) {
          ...
          if (SQRT(local_178 * local_178 + local_180 * local_180 + local_17c * local_17c) <
            ...
            if ((float)DOUBLE_0062ddb2 < fVar15) {
    ...
    case 10:
      ...
      if (((0 < (int)fVar15) ||
        ...
        if ((0 < (int)in_stack_00000004[1].base_character.base_actor.location.position.z) ||
          ...
          fVar21 = (float10)local_14 * (float10)DOUBLE_0062dd72;
          force_immediate = 1;
          iVar12 = 0xf;
          ...
          *(int *)(in_stack_00000004[1].base_character.base_actor.actor_name + 0x10) =
               (int)ROUND(fVar21);
          core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                    (SUB84(dVar23,0),iVar12,force_immediate);
        }
      }
...
LAB_004e7243:
            ...
            iVar12 = 0;
            do {
              local_68 = (float)iVar12 * (float)DOUBLE_0062ddd2 * (float)DOUBLE_0062ddba;
              ...
              local_6c = core_setcolid_cpp_CDemonSet_testCapsuleCollision_FUN_00573470
                                   (g_CDemonSetPtr,
                                    ...
                                    .x,(in_stack_00000004->base_character).base_actor.location.
                                       position.z,(float)(fVar22 * (float10)DOUBLE_0062ddda),
                                    (float)(fVar21 * (float10)DOUBLE_0062ddda),
          ...
          *(int *)(in_stack_00000004[1].base_character.base_actor.actor_name + 0x14) = iVar12;
          if (iVar12 < 1) {
            ...
            fVar21 = -(float10)local_14 * (float10)FLOAT_0062dd8a;
...
LAB_004e6754:
  ...
  if (((float)DOUBLE_0062ddf2 <
    ...
    if (extraout_EAX == 0) {
      ...
      *(undefined4 *)(in_stack_00000004[1].base_character.base_actor.actor_name + 8) = uVar16;
    }
  }
  else {
  ...
  if ((in_stack_00000004[1].base_character.base_actor.field6_0x68 != 0) && (iVar10 == 0x11)) {
    ...
    if (in_stack_00000008 * (float)DOUBLE_0062dd82 <= SQRT(fVar3 * fVar3 + fVar15 * fVar15)) {
...
// 004e6671: PUSH EDX
// 004e6672: CALL core_motion.cpp_CMotionController_getStateBlendWeight_FUN_0052dd20
...
// 004e66bd: CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0
...
// 004e68be: PUSH ECX
// 004e68bf: PUSH ESI
// 004e68c0: CALL core_motion.cpp_CMotionController_markerPositionToFrame_FUN_0052e3a0
...
//   XREF to: 004e70a3 (CONDITIONAL_JUMP)
// 004e7c71: PUSH ESI
// 004e7c72: CALL core_motion.cpp_CMotionController_frameToMarkerPosition_FUN_0052e2b0
...
//   XREF to: 004e70a3 (CONDITIONAL_JUMP)
// 004e7ddf: PUSH ESI
// 004e7de0: CALL core_motion.cpp_CMotionController_frameToMarkerPosition_FUN_0052e2b0
//   XREF to: 0052e2b0 (UNCONDITIONAL_CALL)
...
// 004e7fe4: PUSH ESI
// 004e7fe5: CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0
//   XREF to: 0052dab0 (UNCONDITIONAL_CALL)
