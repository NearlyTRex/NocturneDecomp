...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_ghoul.cpp_FUN_004e8520()
;
; Local Variables:
...
section .text
    ...
    FNSTSW AX                           ; 004e8536
    SAHF                                ; 004e8538
    JNC 0x004e8565                      ; 004e8539 | default
        ;   XREF to: 004e8565 (CONDITIONAL_JUMP)
    CMP dword ptr [ESI],-0x1            ; 004e853b
    JNZ 0x004e8565                      ; 004e853e | default
        ;   XREF to: 004e8565 (CONDITIONAL_JUMP)
    CALL crt_stdlib.c_rand_FUN_005feb5c ; 004e8540 | int crt_stdlib.c_rand_FUN_005feb5c()
    ...
    JA 0x004e8565                       ; 004e8554 | default
        ;   XREF to: 004e8565 (CONDITIONAL_JUMP)
    JMP dword ptr [EDX*0x4 + 0x4e8504]  ; 004e8556 | void * switchdataD_004e8504
        ;   Label: switchD
    ...
    JNZ 0x004e8755                      ; 004e856f | LAB_004e8755
    ...
    JNZ 0x004e858e                      ; 004e8584 | LAB_004e858e
    ...
    JNZ 0x004e85a0                      ; 004e8596 | LAB_004e85a0
        ;   XREF to: 004e85a0 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x8],0x3ca3d70a ; 004e8598
    MOV EAX,[0x0067b654]                ; 004e85a0 | CGame g_CGameInstance | CGame * g_CGamePtr
        ;   Label: LAB_004e85a0
    CMP dword ptr [EAX + 0x1e0],0x0     ; 004e85a5 | g_CGameInstance.field57_0x1e0
    JZ 0x004e85b6                       ; 004e85ac | LAB_004e85b6
        ;   XREF to: 004e85b6 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x8],0x3f800000 ; 004e85ae
    MOV EAX,[0x0067b654]                ; 004e85b6 | CGame g_CGameInstance | CGame * g_CGamePtr
        ;   Label: LAB_004e85b6
    MOV EDX,dword ptr [EAX + 0x14]      ; 004e85bb | g_CGameInstance.blood_flag
    TEST EDX,EDX                        ; 004e85be
    JNZ 0x004e85c6                      ; 004e85c0 | LAB_004e85c6
        ;   XREF to: 004e85c6 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x8],EDX       ; 004e85c2
    PUSH dword ptr [ESP + 0x8]          ; 004e85c6
        ;   Label: LAB_004e85c6
    CALL core_actor.cpp_randomChance_FUN_0040cd10 ; 004e85ca | int core_actor.cpp_randomChance_FUN_0040cd10(float probability_threshold)
        ;   XREF to: 0040cd10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004e85cf
    TEST EAX,EAX                        ; 004e85d2
    JZ 0x004e86ec                       ; 004e85d4 | LAB_004e86ec
    ...
    PUSH EAX                            ; 004e85ec
    CALL core_bodypart.cpp_CreateBodyPart_FUN_00418e10 ; 004e85ed | undefined core_bodypart.cpp_CreateBodyPart_FUN_00418e10()
    ...
    PUSH EDI                            ; 004e85fe
    PUSH EBX                            ; 004e85ff
    CALL core_charactr.cpp_CCharacter_FUN_0042bd30 ; 004e8600 | void core_charactr.cpp_CCharacter_FUN_0042bd30(CCharacter * this_ptr)
    ...
    JNZ 0x004e8627                      ; 004e8612 | LAB_004e8627
    ...
    PUSH EDI                            ; 004e861d
    PUSH EBX                            ; 004e861e
    CALL core_charactr.cpp_CCharacter_FUN_0042bd30 ; 004e861f | void core_charactr.cpp_CCharacter_FUN_0042bd30(CCharacter * this_ptr)
        ;   XREF to: 0042bd30 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004e8624
    MOV EDI,dword ptr [EBX + 0xbee8]    ; 004e8627
        ;   Label: LAB_004e8627
    CMP EDI,dword ptr [ESI]             ; 004e862d
    JNZ 0x004e8644                      ; 004e862f | LAB_004e8644
    ...
    PUSH EBP                            ; 004e863a
    PUSH EBX                            ; 004e863b
    CALL core_charactr.cpp_CCharacter_FUN_0042bd30 ; 004e863c | void core_charactr.cpp_CCharacter_FUN_0042bd30(CCharacter * this_ptr)
        ;   XREF to: 0042bd30 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004e8641
    MOV EDX,dword ptr [EBX + 0xbf04]    ; 004e8644
        ;   Label: LAB_004e8644
    CMP EDX,dword ptr [ESI]             ; 004e864a
    JNZ 0x004e86b0                      ; 004e864c | LAB_004e86b0
    ...
    PUSH ECX                            ; 004e865a
    PUSH EBX                            ; 004e865b
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 004e865c | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
    ...
    PUSH EAX                            ; 004e866d
    PUSH EBX                            ; 004e866e
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 004e866f | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDX                            ; 004e8680
    PUSH EBX                            ; 004e8681
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 004e8682 | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ...
    PUSH ECX                            ; 004e8693
    PUSH EBX                            ; 004e8694
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 004e8695 | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDI                            ; 004e86a6
    PUSH EBX                            ; 004e86a7
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 004e86a8 | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004e86ad
    PUSH 0x62de5e                       ; 004e86b0 | = "limb?.wav" | s_limb_wav_0062de5e = limb?.wav
        ;   Label: LAB_004e86b0
    PUSH EBX                            ; 004e86b5
    CALL core_charactr.cpp_CCharacter_FUN_0042f300 ; 004e86b6 | void core_charactr.cpp_CCharacter_FUN_0042f300(CCharacter * this_ptr)
        ;   XREF to: 0042f300 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004e86bb
    PUSH EBP                            ; 004e86be
    CALL core_bodypart.cpp_FUN_0041a050 ; 004e86bf | undefined core_bodypart.cpp_FUN_0041a050()
    ...
    JZ 0x004e8796                       ; 004e86d6 | LAB_004e8796
        ;   XREF to: 004e8796 (CONDITIONAL_JUMP)
    FLD float ptr [ESI + 0x8]           ; 004e86dc
        ;   Label: LAB_004e86dc
    FLD ST0                             ; 004e86df
    FMUL double ptr [0x0062de6a]        ; 004e86e1 | double DOUBLE_0062de6a
    FSTP ST1                            ; 004e86e7
    ...
    FLD float ptr [ESI + 0x4]           ; 004e87ba
        ;   Label: LAB_004e87ba
    FLD ST0                             ; 004e87bd
    FMUL double ptr [0x0062de72]        ; 004e87bf | double DOUBLE_0062de72
    FSTP ST1                            ; 004e87c5
