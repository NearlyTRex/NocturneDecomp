...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_ghoul.cpp_FUN_004e87e0()
;
; Local Variables:
...
section .text
    ...
    JNZ 0x004e885c                      ; 004e8844 | LAB_004e885c
        ;   XREF to: 004e885c (CONDITIONAL_JUMP)
    ...
    JZ 0x004e8a2e                       ; 004e887a | LAB_004e8a2e
    ...
    FNSTSW AX                           ; 004e8890
    SAHF                                ; 004e8892
    JC 0x004e8a9a                       ; 004e8893 | LAB_004e8a9a
    ...
    JNZ 0x004e8a39                      ; 004e88ab | LAB_004e8a39
        ;   XREF to: 004e8a39 (CONDITIONAL_JUMP)
    PUSH EDX                            ; 004e88b1
    CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0 ; 004e88b2 | SMotion * core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0(CMotionController * this_ptr)
        ;   XREF to: 0052dab0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EAX + 0x24]      ; 004e88b7
    ADD ESP,0x4                         ; 004e88ba
    CMP EAX,0xa                         ; 004e88bd
    JZ 0x004e89a9                       ; 004e88c0 | LAB_004e89a9
        ;   XREF to: 004e89a9 (CONDITIONAL_JUMP)
    CMP EAX,0x9                         ; 004e88c6
    JZ 0x004e89a9                       ; 004e88c9 | LAB_004e89a9
        ;   XREF to: 004e89a9 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0xbf08]    ; 004e88cf
    MOV EDX,dword ptr [EBX + EAX*0x4 + 0x2298] ; 004e88d5
    TEST EDX,EDX                        ; 004e88dc
    JZ 0x004e8a53                       ; 004e88de | LAB_004e8a53
    ...
    JNZ 0x004e8a5e                      ; 004e8917 | LAB_004e8a5e
    ...
    PUSH EAX                            ; 004e892b
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 004e892c | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004e8931
    MOV ESI,dword ptr [EBX + 0xbf14]    ; 004e8934
    PUSH ESI                            ; 004e893a
    CALL sound_sndmain.cpp_isSfxPlaying_FUN_005a9660 ; 004e893b | int sound_sndmain.cpp_isSfxPlaying_FUN_005a9660(uint sfx_handle)
        ;   XREF to: 005a9660 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004e8940
    TEST EAX,EAX                        ; 004e8943
    JNZ 0x004e895f                      ; 004e8945 | LAB_004e895f
        ;   XREF to: 004e895f (CONDITIONAL_JUMP)
    PUSH 0x62de8e                       ; 004e8947 | = "ghoul-die-!-?.wav @1.6" | s_ghoul_die_wav_1_6_0062de8e = ghoul-die-!-?.wav @1.6
    ...
    CALL core_actor.cpp_getRandomFloat_FUN_0040cc10 ; 004e8969 | float core_actor.cpp_getRandomFloat_FUN_0040cc10(float min_value, float max_value)
        ;   XREF to: 0040cc10 (UNCONDITIONAL_CALL)
    PUSH EDI                            ; 004e89a9
        ;   Label: LAB_004e89a9
    PUSH EBX                            ; 004e89aa
    CALL core_enemy.cpp_FUN_004a9f10    ; 004e89ab | undefined core_enemy.cpp_FUN_004a9f10()
    ...
    LEA EAX,[EBX + 0x158]               ; 004e89ba
        ;   Label: LAB_004e89ba
    PUSH EAX                            ; 004e89c0
    CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0 ; 004e89c1 | SMotion * core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0(CMotionController * this_ptr)
        ;   XREF to: 0052dab0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EAX + 0x24]      ; 004e89c6
    ADD ESP,0x4                         ; 004e89c9
    TEST EAX,EAX                        ; 004e89cc
    JNZ 0x004e880c                      ; 004e89ce | LAB_004e880c
    ...
    JZ 0x004e8a15                       ; 004e8a03 | LAB_004e8a15
    ...
    PUSH 0x62de82                       ; 004e8a15 | = "go berzerk\n" | s_go_berzerk_0062de82 = go berzerk

        ;   Label: LAB_004e8a15
    MOV ESI,dword ptr [0x0066e8e0]      ; 004e8a1a | CConsole * g_CConsolePtr
    PUSH ESI                            ; 004e8a20 | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 004e8a21 | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
        ;   XREF to: 00441890 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004e8a26
    JMP 0x004e880c                      ; 004e8a29 | LAB_004e880c
        ;   XREF to: 004e880c (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0x243c],ECX    ; 004e8a2e
        ;   Label: LAB_004e8a2e
    JMP 0x004e8880                      ; 004e8a34 | LAB_004e8880
        ;   XREF to: 004e8880 (UNCONDITIONAL_JUMP)
    PUSH EBX                            ; 004e8a39
        ;   Label: LAB_004e8a39
    CALL core_charactr.cpp_CCharacter_FUN_0042b8e0 ; 004e8a3a | void core_charactr.cpp_CCharacter_FUN_0042b8e0(CCharacter * this_ptr)
        ;   XREF to: 0042b8e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004e8a3f
    PUSH EDI                            ; 004e8a42
    PUSH EBX                            ; 004e8a43
    CALL core_enemy.cpp_FUN_004a9f10    ; 004e8a44 | undefined core_enemy.cpp_FUN_004a9f10()
        ;   XREF to: 004a9f10 (UNCONDITIONAL_CALL)
    ...
    MOV dword ptr [EBX + 0xbed8],EDX    ; 004e8a53
        ;   Label: LAB_004e8a53
    JMP 0x004e88ea                      ; 004e8a59 | LAB_004e88ea
        ;   XREF to: 004e88ea (UNCONDITIONAL_JUMP)
    JZ 0x004e891d                       ; 004e8a5e | LAB_004e891d
        ;   Label: LAB_004e8a5e
    ...
    JL 0x004e890b                       ; 004e8a70 | LAB_004e890b
        ;   XREF to: 004e890b (CONDITIONAL_JUMP)
    JMP 0x004e8922                      ; 004e8a76 | LAB_004e8922
        ;   XREF to: 004e8922 (UNCONDITIONAL_JUMP)
    PUSH 0x3f000000                     ; 004e8a7b
        ;   Label: LAB_004e8a7b
    CALL core_actor.cpp_randomChance_FUN_0040cd10 ; 004e8a80 | int core_actor.cpp_randomChance_FUN_0040cd10(float probability_threshold)
        ;   XREF to: 0040cd10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004e8a85
    TEST EAX,EAX                        ; 004e8a88
    JZ 0x004e8922                       ; 004e8a8a | LAB_004e8922
        ;   XREF to: 004e8922 (CONDITIONAL_JUMP)
    MOV ESI,0x7                         ; 004e8a90
    JMP 0x004e8922                      ; 004e8a95 | LAB_004e8922
        ;   XREF to: 004e8922 (UNCONDITIONAL_JUMP)
    PUSH EDX                            ; 004e8a9a
        ;   Label: LAB_004e8a9a
    CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0 ; 004e8a9b | SMotion * core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0(CMotionController * this_ptr)
        ;   XREF to: 0052dab0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 004e8aef
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 004e8af0 | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004e8af5
    MOV ESI,dword ptr [EBX + 0xbf10]    ; 004e8af8
        ;   Label: LAB_004e8af8
    PUSH ESI                            ; 004e8afe
    CALL sound_sndmain.cpp_isSfxPlaying_FUN_005a9660 ; 004e8aff | int sound_sndmain.cpp_isSfxPlaying_FUN_005a9660(uint sfx_handle)
        ;   XREF to: 005a9660 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004e8b04
    TEST EAX,EAX                        ; 004e8b07
    JNZ 0x004e89a9                      ; 004e8b09 | LAB_004e89a9
        ;   XREF to: 004e89a9 (CONDITIONAL_JUMP)
    PUSH 0x62deb3                       ; 004e8b0f | = "ghoul-mad-!-?.wav" | s_ghoul_mad_wav_0062deb3 = ghoul-mad-!-?.wav
    ...
    PUSH EDI                            ; 004e8b27
    PUSH EBX                            ; 004e8b28
    CALL core_enemy.cpp_FUN_004a9f10    ; 004e8b29 | undefined core_enemy.cpp_FUN_004a9f10()
        ;   XREF to: 004a9f10 (UNCONDITIONAL_CALL)
    ...
    TEST EAX,EAX                        ; 004e8b38
        ;   Label: LAB_004e8b38
    JNZ 0x004e8acc                      ; 004e8b3a | LAB_004e8acc
        ;   XREF to: 004e8acc (CONDITIONAL_JUMP)
    PUSH 0x3e800000                     ; 004e8b3c
    CALL core_actor.cpp_randomChance_FUN_0040cd10 ; 004e8b41 | int core_actor.cpp_randomChance_FUN_0040cd10(float probability_threshold)
        ;   XREF to: 0040cd10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004e8b46
    TEST EAX,EAX                        ; 004e8b49
    JNZ 0x004e8acc                      ; 004e8b4b | LAB_004e8acc
        ;   XREF to: 004e8acc (CONDITIONAL_JUMP)
    PUSH 0x2                            ; 004e8b51
    PUSH 0x1                            ; 004e8b53
    CALL core_actor.cpp_getRandomInt_FUN_0040cc70 ; 004e8b55 | int core_actor.cpp_getRandomInt_FUN_0040cc70(int min_value, int max_value)
        ;   XREF to: 0040cc70 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004e8b5a
    PUSH EAX                            ; 004e8b5d
    PUSH 0x62dea5                       ; 004e8b5e | = "guul flinch%d" | s_guul_flinch_d_0062dea5 = guul flinch%d
    LEA EAX,[EBP + -0x68]               ; 004e8b63
    PUSH EAX                            ; 004e8b66
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 004e8b67 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH EAX                            ; 004e8b7b
    CALL core_motion.cpp_CMotionController_getMotionList_FUN_0052dce0 ; 004e8b7c | CMotionList * core_motion.cpp_CMotionController_getMotionList_FUN_0052dce0(CMotionController * this_ptr)
        ;   XREF to: 0052dce0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004e8b81
    PUSH EAX                            ; 004e8b84
    CALL core_motion.cpp_CMotionList_findMotionIndex_FUN_0052d460 ; 004e8b85 | int core_motion.cpp_CMotionList_findMotionIndex_FUN_0052d460(CMotionList * this_ptr)
    ...
    JMP 0x004e8af8                      ; 004e8b9d | LAB_004e8af8
