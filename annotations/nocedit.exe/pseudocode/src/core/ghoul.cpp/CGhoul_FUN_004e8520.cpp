...

{
  ...
  if ((0.0 < (float)in_stack_00000008[0xb]) && (*in_stack_00000008 == -1)) {
    ...
    switch(iVar1 % 6) {
    case 0:
      iVar1 = *(int *)this_ptr->unk3;
      break;
    case 1:
      iVar1 = *(int *)(this_ptr->unk3 + 4);
      break;
    case 2:
      iVar1 = *(int *)(this_ptr->unk3 + 8);
      break;
    case 3:
      iVar1 = *(int *)(this_ptr->unk3 + 0xc);
      break;
    case 4:
      iVar1 = *(int *)(this_ptr->unk3 + 0x28);
      break;
    case 5:
      iVar1 = *(int *)(this_ptr->unk3 + 0x24);
      break;
    default:
...
switchD_004e8556_default:
  ...
  if (((((iVar1 == *(int *)this_ptr->unk3) || (iVar1 == *(int *)(this_ptr->unk3 + 4))) ||
       (iVar1 == *(int *)(this_ptr->unk3 + 8))) ||
      ((iVar1 == *(int *)(this_ptr->unk3 + 0xc) || (iVar1 == *(int *)(this_ptr->unk3 + 0x24))))) ||
     (iVar1 == *(int *)(this_ptr->unk3 + 0x28))) {
    local_14 = (float)in_stack_00000008[0xb];
    if (*(int *)(this_ptr->unk3 + 0x28) == *in_stack_00000008) {
      local_14 = 0.05;
    }
    ...
    if (iVar1 != 0) {
      ...
      if (*in_stack_00000008 == *(int *)this_ptr->unk3) {
        core_charactr_cpp_CCharacter_dismemberPartInternal_FUN_0042bd30
                  ((CCharacter *)this_ptr,body_part,*(int *)(this_ptr->unk3 + 4),0);
      }
      if (*(int *)(this_ptr->unk3 + 8) == *in_stack_00000008) {
        core_charactr_cpp_CCharacter_dismemberPartInternal_FUN_0042bd30
                  ((CCharacter *)this_ptr,body_part,*(int *)(this_ptr->unk3 + 0xc),0);
      }
      if (*(int *)(this_ptr->unk3 + 0x24) == *in_stack_00000008) {
        core_charactr_cpp_CCharacter_detachBodyPart_FUN_0042bcc0
                  ((CCharacter *)this_ptr,*(int *)(this_ptr->unk3 + 8));
        core_charactr_cpp_CCharacter_detachBodyPart_FUN_0042bcc0
                  ((CCharacter *)this_ptr,*(int *)(this_ptr->unk3 + 0xc));
        core_charactr_cpp_CCharacter_detachBodyPart_FUN_0042bcc0
                  ((CCharacter *)this_ptr,*(int *)this_ptr->unk3);
        core_charactr_cpp_CCharacter_detachBodyPart_FUN_0042bcc0
                  ((CCharacter *)this_ptr,*(int *)(this_ptr->unk3 + 4));
        core_charactr_cpp_CCharacter_detachBodyPart_FUN_0042bcc0
                  ((CCharacter *)this_ptr,*(int *)(this_ptr->unk3 + 0x28));
      }
  ...
  iVar1 = *in_stack_00000008;
  if (iVar1 == *(int *)(this_ptr->unk3 + 0x28)) {
    in_stack_00000008[1] = (int)((float)in_stack_00000008[1] * (float)2.5);
    return;
  }
  if ((iVar1 != *(int *)(this_ptr->unk3 + 0x20)) && (iVar1 != *(int *)(this_ptr->unk3 + 0x24))) {
