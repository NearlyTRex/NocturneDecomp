      ...
      if ((pCVar2 != (CCharacter *)0x0) &&
        ...
        if (pCVar13 == (CDemonActor *)0x0) {
          ...
          if (iVar6 != 0) {
            ...
            fVar18 = local_1c8.x - (pCVar13->location).position.x;
            fVar25 = local_1c8.z - (pCVar13->location).position.z;
            bVar4 = SQRT(fVar25 * fVar25 + fVar18 * fVar18) <= 1.0;
            pCVar2 = (CCharacter *)(this_ptr->base).victim;
            if (ABS(local_1c8.y - (pCVar2->base).location.position.y) <= (float)4) {
              if (bVar4) {
...
LAB_004e6a5f:
    ...
    case 10:
      ...
      if (pCVar2 == (CCharacter *)0x0) {
        ...
        pCVar14 = (CGhoul *)(*(((pCVar2->base).vtable._uc)->_uc).getGrabber)(pCVar2);
        if (pCVar14 == this_ptr) {
          pCVar2 = (CCharacter *)(this_ptr->base).victim;
    ...
    case 0xd:
      ...
      pCVar12 = core_skeleton_cpp_CDeformableModelInstance_getBoneWorldPosition_FUN_0059fa20
                          ((CDeformableModelInstance *)pCVar9,&local_1b0,INT_02d832fc);
      core_actor_cpp_CDemonActor_localToWorldPoint_FUN_00408ec0
    ...
    case 0x10:
      core_skeleton_cpp_CDeformableModelInstance_updateAnimation_FUN_0059e020
                ((CDeformableModelInstance *)pCVar9);
      pCVar12 = core_skeleton_cpp_CDeformableModelInstance_getBoneWorldPosition_FUN_0059fa20
                          ((CDeformableModelInstance *)pCVar9,&local_1ec,INT_02d832fc);
      core_actor_cpp_CDemonActor_localToWorldPoint_FUN_00408ec0
  ...
  (this_ptr->base).base.turn_speed = delta_time * fVar25 * fVar18;
  ...
  if (iVar6 == 0x11) {
    ...
    (this_ptr->base).base.walk_step_speed = (float)((float10)local_8c * fVar21 * (float10)fVar18);
  }
      ...
      if (*(float *)(this_ptr->unk3 + 0x38) <= 0.0) {
        ...
        if (iVar8 == 0) {
          ...
          if ((this_ptr->base).victim != (CDemonActor *)0x0) {
            ...
            if ((iVar8 == 0) ||
               (iVar8 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660
                                  (*(uint *)(this_ptr->unk3 + 0x30)), iVar8 == 0)) {
          ...
          if (SQRT(local_178 * local_178 +
              ...
              (float)4) {
            fVar18 = (this_ptr->base).base.hit_points + delta_time;
            *(float *)(this_ptr->unk3 + 0x40) = *(float *)(this_ptr->unk3 + 0x40) - delta_time;
            (this_ptr->base).base.hit_points = fVar18;
            if ((float)100 < fVar18) {
    ...
    case 0x11:
      ...
      if (0.0 < *(float *)(this_ptr->unk3 + 0x38)) {
        *(float *)(this_ptr->unk3 + 0x38) = *(float *)(this_ptr->unk3 + 0x38) - delta_time;
        ...
        (this_ptr->base).base.model.accumulated_root_motion.x =
             (this_ptr->base).base.model.accumulated_root_motion.y;
        cVar20 = (this_ptr->base).base.model.part_visibility_flags[*(int *)(this_ptr->unk3 + 4)] !=
                 0;
        ...
        pCVar5 = g_CGamePtr;
        if (iVar8 == 0) {
          in_stack_fffffc88 = (char *)delta_time;
          (*(((this_ptr->base).base.base.vtable._ue)->_ue).enemyfunc2)();
          pCVar13 = (this_ptr->base).victim;
          if (pCVar13 == (CDemonActor *)0x0) {
            core_enemy_cpp_CEnemy_FUN_004a9fd0(&this_ptr->base);
            ...
            if (*(int *)(this_ptr->unk3 + 0x3c) == 0) {
              ...
              iVar8 = core_charactr_cpp_CCharacter_walkToPoint_FUN_004286e0
                                ((CCharacter *)this_ptr,
                                 &(((this_ptr->base).victim)->location).position,pCVar11,pCVar12,
                                 fVar18,(float)in_stack_fffffc88);
              if (iVar8 < 0) {
                in_stack_fffffc88 = (char *)0x1;
                core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00(local_30,0,1);
              }
              else if (((0 < iVar8) && (cVar20 != '\0')) && (*(float *)(this_ptr->base).unk2 <= 0.0)
                      ) {
                in_stack_fffffc88 = ((this_ptr->base).victim)->actor_name;
                pCVar13 = (*(((((CGhoul *)in_stack_fffffc88)->base).base.base.vtable._uc)->_uc).
                            getGrabber)((CCharacter *)in_stack_fffffc88);
                if ((pCVar13 == (CDemonActor *)0x0) && (*(float *)(this_ptr->unk2 + 4) <= 0.0)) {
...
LAB_004e7a33:
            if (*(int *)this_ptr->unk2 != 0) {
              ...
              ;
              iVar8 = core_charactr_cpp_CCharacter_walkToPoint_FUN_004286e0
                                ((CCharacter *)this_ptr,pCVar12,pCVar11,pCVar26,
    ...
    case 10:
      ...
      if (((0 < iVar8) || (0 < this_ptr->lives_left)) &&
        ...
        if ((0 < this_ptr->spasm_count) || (0 < this_ptr->lives_left)) {
          ...
          *(int *)(this_ptr->unk1 + 8) = (int)ROUND(dVar23);
          core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
...
LAB_004e7243:
            ...
            fVar18 = 0.0;
            do {
              local_68 = (float)(int)fVar18 * (float)6.2831853070000001 * (float)0.25;
              local_14 = fVar18;
...
LAB_004e7d9a:
    ...
    case 0xe:
      ...
      *(int *)(this_ptr->unk1 + 4) = iVar8;
      if (iVar8 < 1) {
        ...
        dVar23 = round((double)(local_14 * (float)65536));
        *(int *)(this_ptr->unk1 + 4) = (int)ROUND(dVar23);
      }
      (*(((this_ptr->base).base.base.vtable._ue)->_ue).enemyfunc2)();
      if ((this_ptr->base).victim != (CDemonActor *)0x0) {
        core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
    ...
    if (((0.0 <= (float)local_20) && (*(float *)(this_ptr->unk2 + 4) <= 0.0)) &&
      ...
      iVar8 = core_charactr_cpp_CCharacter_walkToPoint_FUN_004286e0
                        ((CCharacter *)this_ptr,pCVar12,pCVar11,pCVar26,fVar18,
...
LAB_004e6754:
  ...
  if (iVar8 != 0) {
    ...
    pCVar26 = &(this_ptr->base).base.model.accumulated_root_motion;
    ...
    local_18c.x = local_d8 + pCVar26->x;
    ...
    (this_ptr->base).base.model.accumulated_root_motion.y =
         (this_ptr->base).base.model.accumulated_root_motion.z;
    pCVar26->x = (this_ptr->base).base.model.accumulated_root_motion.y;
  ...
  if (0.0 < local_b4) {
    ...
    fVar18 = 1.0 - *(float *)(this_ptr->unk2 + 4);
    local_5c = 1.0 - fVar18 * fVar18 * fVar18;
    local_14 = local_60;
    core_skeleton_cpp_CDeformableModelInstance_blendMotion_FUN_0059eb50
              (this_ptr_00,*(int *)(this_ptr->unk2 + 8),local_60,local_5c,INT_02d83320,
               core_skeleton_cpp_defaultBlendWeight_FUN_0059ddb0);
    fVar18 = *(float *)(this_ptr->unk2 + 4) - delta_time / 0.7f;
  ...
  if (((float)0.01 < ABS((this_ptr->base).base.turn_angle_accumulator)) ||
     (fVar18 = (this_ptr->base).base.field6_0x241c.y, fVar25 = (this_ptr->base).base.field6_0x241c.x
     , fVar1 = (this_ptr->base).base.field6_0x241c.z,
     (float)0.01 < SQRT(fVar1 * fVar1 + fVar25 * fVar25 + fVar18 * fVar18))) {
  ...
  if ((this_ptr->base).pool_me == 0) {
    ...
    core_charactr_cpp_CCharacter_spawnBloodAtBone_FUN_0042b810
              ((CCharacter *)this_ptr,iVar8,iVar24,fVar18);
    core_charactr_cpp_CCharacter_processDamageDecals_FUN_0042b670((CCharacter *)this_ptr);
  }
  if ((*(int *)(this_ptr->unk3 + 0x3c) != 0) && (iVar6 == 0x11)) {
    fVar18 = (this_ptr->base).base.base.location.position.x - *(float *)(this_ptr->unk3 + 0x4c);
    fVar25 = (this_ptr->base).base.base.location.position.z - *(float *)(this_ptr->unk3 + 0x54);
    if (delta_time * (float)0.5 <= SQRT(fVar25 * fVar25 + fVar18 * fVar18)) {
      ...
      fVar18 = *(float *)(this_ptr->unk3 + 0x48) - delta_time;
      *(float *)(this_ptr->unk3 + 0x48) = fVar18;
      if (fVar18 < 0.0) {
        this_ptr->unk3[0x40] = '\0';
        this_ptr->unk3[0x41] = '\0';
        this_ptr->unk3[0x42] = -0x10;
