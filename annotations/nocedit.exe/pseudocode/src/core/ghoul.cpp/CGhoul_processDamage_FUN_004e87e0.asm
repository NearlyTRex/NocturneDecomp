...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_ghoul_cpp_CGhoul_processDamage_FUN_004e87e0(CGhoul *this_ptr,SDamageInfo *damage_info)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004e87e0
        ;   Label: core_ghoul.cpp_CGhoul_processDamage_FUN_004e87e0
    PUSH ESI                            ; 004e87e1
    PUSH EDI                            ; 004e87e2
    PUSH EBP                            ; 004e87e3
