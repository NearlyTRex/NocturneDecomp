      ...
      if (this_ptr->stun_timer <= 0.0) {
        ...
        if (pCVar14 == (CDemonActor *)0x0) {
          ...
          if (SQRT(local_178 * local_178 +
                   local_180 * local_180 + local_17c * local_17c) <
              (float)4) {
        ...
        if (EVar13 == DEATH_STATE_ALIVE) {
          ...
          if (pCVar3 == (CCharacter *)0x0) {
            ...
            if (pCVar14 == (CDemonActor *)0x0) {
              ...
              fVar23 = 0.0;
              pCVar11 = (*((pCVar14->vtable)._ub)->getPathMap)(pCVar14);
              iVar9 = core_charactr_cpp_CCharacter_walkToPoint_FUN_004286e0
                                ((CCharacter *)this_ptr,
                                 &(this_ptr->dark_waypoint->location).position,
                                 pCVar11,(CVector3f *)&g_ZeroVector,3.0f,fVar23);
              if (0 < iVar9) {
                core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00(local_30,0,1);
          ...
          if ((this_ptr->base).base.model.part_data.visibility_flags[iVar9] != 0) {
            ...
            if ((local_50 <= (float)2) &&
              ...
              iVar9 = core_enemy_cpp_CEnemy_testAttackRadius_FUN_004a9880
                                (&this_ptr->base,pCVar12,fVar23,&local_2d8);
              if (iVar9 != 0) {
                (*((this_ptr->base).base.base.vtable._ub)->playSound)
...
LAB_004e7d9a:
        ...
        if (pCVar14 == (CDemonActor *)0x0) {
          ...
          pCVar3 = (this_ptr->base).victim;
          pCVar10 = (CGhoul *)
                    (*(((pCVar3->base).vtable._uc)->_uc).getGrabber)(pCVar3);
          if (pCVar10 != this_ptr) {
            core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                      ((CMotionController *)pCVar11,1,1);
          }
      ...
      if ((this_ptr->base).base.model.part_data.visibility_flags[iVar9] != 0) {
        ...
        if (local_4c <= (float)2) {
          ...
          if (1.0 <= local_a4) {
            ...
            iVar9 = core_enemy_cpp_CEnemy_testAttackRadius_FUN_004a9880
                              (&this_ptr->base,pCVar12,fVar23,&local_314);
            if (iVar9 != 0) {
              (*((this_ptr->base).base.base.vtable._ub)->playSound)
                        ((CDemonActor *)this_ptr,"gh-hits?.wav");
            }
    ...
    if (((0.0 <= local_20) && (this_ptr->flinch_blend_weight <= 0.0)) &&
      ...
      iVar9 = core_charactr_cpp_CCharacter_walkToPoint_FUN_004286e0
                        ((CCharacter *)this_ptr,pCVar12,pCVar11,&local_174,3.0f,
                         fVar23);
      if (iVar9 != 1) {
        core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                  (&(this_ptr->base).base.model.motion_controller,1,1);
...
LAB_004e6754:
  ...
  if (((float)0.01 < ABS((this_ptr->base).base.turn_angle_accumulator)) ||
    ...
    if (iVar9 == 0) {
      _sprintf
                (local_260,"ghoul-walk-?.wav *%f",(double)(this_ptr->base).speed);
      uVar15 = (*((this_ptr->base).base.base.vtable._ub)->playAmbientSound)
                         ((CDemonActor *)this_ptr,local_260);
