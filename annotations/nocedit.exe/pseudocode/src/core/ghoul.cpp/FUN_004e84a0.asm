...
section .text
    ...
    MOV EDX,dword ptr [0x02d832fc]      ; 004e84ac | undefined4 DAT_02d832fc
    ...
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneWorldMatrix_FUN_0059f820 ; 004e84c3 | void core_skeleton.cpp_CDeformableModelInstance_getBoneWorldMatrix_FUN_0059f820(CDeformableModelInstance * this_ptr, int bone_index, CMatrix3x4f * out_matrix)
    ...
    CALL core_xform.cpp_transformVector3x4_FUN_005f4dc0 ; 004e84f2 | CVector3f * core_xform.cpp_transformVector3x4_FUN_005f4dc0(CVector3f * output_vector, CVector3f * input_vector, CMatrix3x4f * matrix)
