...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_ghoul_cpp_CGhoul_FUN_004e8520(CGhoul *this_ptr)
;
; Parameters:
...
;
; XREF[1]:
;   core_ghoul.cpp_CGhoul_processDamage_FUN_004e87e0 at 004e881e
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004e8520
        ;   Label: core_ghoul.cpp_CGhoul_FUN_004e8520
    PUSH ESI                            ; 004e8521
    PUSH EDI                            ; 004e8522
    PUSH EBP                            ; 004e8523
    ...
    MOV EAX,[0x0067b654]                ; 004e85a0 | g_CGameInstance | g_CGamePtr
        ;   Label: LAB_004e85a0
    CMP dword ptr [EAX + 0x1e0],0x0     ; 004e85a5 | g_CGameInstance.gratuitous_dismemberment
    ...
    PUSH EDI                            ; 004e85fe
    PUSH EBX                            ; 004e85ff
    CALL core_charactr.cpp_CCharacter_dismemberPartInternal_FUN_0042bd30 ; 004e8600
    ...
    PUSH EDI                            ; 004e861d
    PUSH EBX                            ; 004e861e
    CALL core_charactr.cpp_CCharacter_dismemberPartInternal_FUN_0042bd30 ; 004e861f
        ;   XREF to: 0042bd30 (UNCONDITIONAL_CALL)  ; void core_charactr.cpp_CCharacter_dismemberPartInternal_FUN_0042bd30(CCharacter * this_ptr, CBodyPart * body_part, int part_index, int render_in_background)
    ...
    PUSH EBP                            ; 004e863a
    PUSH EBX                            ; 004e863b
    CALL core_charactr.cpp_CCharacter_dismemberPartInternal_FUN_0042bd30 ; 004e863c
        ;   XREF to: 0042bd30 (UNCONDITIONAL_CALL)  ; void core_charactr.cpp_CCharacter_dismemberPartInternal_FUN_0042bd30(CCharacter * this_ptr, CBodyPart * body_part, int part_index, int render_in_background)
    ...
    PUSH 0x62de5e                       ; 004e86b0 | = "limb?.wav"
        ;   Label: LAB_004e86b0
    PUSH EBX                            ; 004e86b5
    CALL core_charactr.cpp_CCharacter_playSoundWithCooldown_FUN_0042f300 ; 004e86b6
    ...
    PUSH EBP                            ; 004e86be
    CALL core_bodypart.cpp_CBodyPart_FUN_0041a050 ; 004e86bf
