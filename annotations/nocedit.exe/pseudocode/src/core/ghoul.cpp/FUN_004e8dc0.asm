...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_ghoul_cpp_FUN_004e8dc0(void)
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH ESI                            ; 004e8dcb
    PUSH EDI                            ; 004e8dcc
    CALL core_enemy.cpp_CEnemy_FUN_004aa170 ; 004e8dcd
    ...
    PUSH ESI                            ; 004e8de3
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e4a0 ; 004e8de4
    ...
    PUSH ESI                            ; 004e8df2
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e4d0 ; 004e8df3
    ...
    PUSH ESI                            ; 004e8e10
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e220 ; 004e8e11
