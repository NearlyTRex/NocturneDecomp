...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_ghoul.cpp_FUN_004e8bc0()
;
; Local Variables:
...
section .text
    ...
    MOV EDX,dword ptr [0x02d83320]      ; 004e8bcf | undefined4 DAT_02d83320
    PUSH EDX                            ; 004e8bd5
    LEA EAX,[ESP + 0x34]                ; 004e8bd6
    PUSH EAX                            ; 004e8bda
    LEA EAX,[ESI + 0x158]               ; 004e8bdb
    PUSH EAX                            ; 004e8be1
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00 ; 004e8be2 | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
        ;   XREF to: 0059fb00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004e8be7
    LEA EAX,[ESP + 0x30]                ; 004e8bea
    MOV ECX,dword ptr [EBP + 0x18]      ; 004e8bee
    CMP EAX,ECX                         ; 004e8bf1
    JNZ 0x004e8cea                      ; 004e8bf3 | LAB_004e8cea
    ...
    JA 0x004e8ccf                       ; 004e8c20 | default
        ;   XREF to: 004e8ccf (CONDITIONAL_JUMP)
    JMP dword ptr [EDX*0x4 + 0x4e8ba4]  ; 004e8c26 | void * switchdataD_004e8ba4
        ;   Label: switchD
    MOV EAX,dword ptr [ESI + 0xbee0]    ; 004e8c2d
        ;   Label: caseD_0
    CMP dword ptr [ESI + EAX*0x4 + 0x2298],0x0 ; 004e8c33
    JZ 0x004e8ccf                       ; 004e8c3b | default
        ;   XREF to: 004e8ccf (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x02d83310]      ; 004e8c41 | undefined4 DAT_02d83310
    PUSH ECX                            ; 004e8c47
    LEA EAX,[ESP + 0x40]                ; 004e8c48
    PUSH EAX                            ; 004e8c4c
        ;   Label: LAB_004e8c4c
    PUSH EDI                            ; 004e8c4d
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00 ; 004e8c4e | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
        ;   XREF to: 0059fb00 (UNCONDITIONAL_CALL)
    MOV EDX,EAX                         ; 004e8c53
    LEA EAX,[ESP + 0x24]                ; 004e8c55
    ADD ESP,0xc                         ; 004e8c59
    CMP EAX,EDX                         ; 004e8c5c
    JZ 0x004e8c74                       ; 004e8c5e | LAB_004e8c74
    ...
    IMUL EDX,EBX,0xc                    ; 004e8c74
        ;   Label: LAB_004e8c74
    FLD double ptr [0x0062ded2]         ; 004e8c77 | double DOUBLE_0062ded2
    FLD float ptr [ESP + 0x18]          ; 004e8c7d
    FMUL ST1                            ; 004e8c81
    FLD float ptr [ESP + 0x1c]          ; 004e8c83
    FMUL double ptr [0x0062deda]        ; 004e8c87 | double DOUBLE_0062deda
    FLD float ptr [ESP + 0x30]          ; 004e8c8d
    FMULP ST3                           ; 004e8c91
    FLD float ptr [ESP + 0x34]          ; 004e8c93
    FMUL double ptr [0x0062dee2]        ; 004e8c97 | double DOUBLE_0062dee2
    ...
    JZ 0x004e8cce                       ; 004e8cb8 | LAB_004e8cce
    ...
    JL 0x004e8c0a                       ; 004e8cdb | LAB_004e8c0a
    ...
    JMP 0x004e8bf9                      ; 004e8cfe | LAB_004e8bf9
        ;   XREF to: 004e8bf9 (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESI + 0xbee8]    ; 004e8d03
        ;   Label: caseD_1
    CMP dword ptr [ESI + EAX*0x4 + 0x2298],0x0 ; 004e8d09
    JZ 0x004e8ccf                       ; 004e8d11 | default
        ;   XREF to: 004e8ccf (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x02d83314]      ; 004e8d13 | undefined4 DAT_02d83314
    PUSH ECX                            ; 004e8d19
    LEA EAX,[ESP + 0x10]                ; 004e8d1a
    JMP 0x004e8c4c                      ; 004e8d1e | LAB_004e8c4c
        ;   XREF to: 004e8c4c (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESI + 0xbf08]    ; 004e8d23
        ;   Label: caseD_2
    CMP dword ptr [ESI + EAX*0x4 + 0x2298],0x0 ; 004e8d29
    JZ 0x004e8ccf                       ; 004e8d31 | default
        ;   XREF to: 004e8ccf (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x02d832fc]      ; 004e8d33 | undefined4 DAT_02d832fc
    PUSH ECX                            ; 004e8d39
    LEA EAX,[ESP + 0x28]                ; 004e8d3a
    PUSH EAX                            ; 004e8d3e
    PUSH EDI                            ; 004e8d3f
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00 ; 004e8d40 | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
        ;   XREF to: 0059fb00 (UNCONDITIONAL_CALL)
    IMUL EDX,EBX,0xc                    ; 004e8d45
    ADD ESP,0xc                         ; 004e8d48
    ADD EDX,dword ptr [EBP + 0x18]      ; 004e8d4b
    CMP EDX,EAX                         ; 004e8d4e
    JZ 0x004e8cce                       ; 004e8d50 | LAB_004e8cce
        ;   XREF to: 004e8cce (CONDITIONAL_JUMP)
    ...
    JMP 0x004e8cce                      ; 004e8d66 | LAB_004e8cce
        ;   XREF to: 004e8cce (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESI + 0xbf04]    ; 004e8d6b
        ;   Label: caseD_3
    CMP dword ptr [ESI + EAX*0x4 + 0x2298],0x0 ; 004e8d71
    JZ 0x004e8ccf                       ; 004e8d79 | default
        ;   XREF to: 004e8ccf (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x02d83324]      ; 004e8d7f | undefined4 DAT_02d83324
    PUSH ECX                            ; 004e8d85
    LEA EAX,[ESP + 0x4]                 ; 004e8d86
    PUSH EAX                            ; 004e8d8a
    PUSH EDI                            ; 004e8d8b
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00 ; 004e8d8c | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
        ;   XREF to: 0059fb00 (UNCONDITIONAL_CALL)
    IMUL EDX,EBX,0xc                    ; 004e8d91
    ADD ESP,0xc                         ; 004e8d94
    ADD EDX,dword ptr [EBP + 0x18]      ; 004e8d97
    CMP EDX,EAX                         ; 004e8d9a
    JZ 0x004e8cce                       ; 004e8d9c | LAB_004e8cce
        ;   XREF to: 004e8cce (CONDITIONAL_JUMP)
    ...
    JMP 0x004e8cce                      ; 004e8db2 | LAB_004e8cce
        ;   XREF to: 004e8cce (UNCONDITIONAL_JUMP)
