...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_keyactor_cpp_CKeyActor_writeDependencies_FUN_00501990(CKeyActor *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x8]       ; 00501990
        ;   Label: core_keyactor.cpp_CKeyActor_writeDependencies_FUN_00501990
