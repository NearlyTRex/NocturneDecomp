...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_keyactor_cpp_CKeyActor_process_FUN_00501710(CKeyActor *this_ptr,float delta_time)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00501710
        ;   Label: core_keyactor.cpp_CKeyActor_process_FUN_00501710
    PUSH ESI                            ; 00501711
