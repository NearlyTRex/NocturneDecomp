...
;                               FUNCTION
; *****************************************************************************
; __cdecl CKeyActor * core_keyactor.cpp_CKeyActor_dtor_FUN_005019b0(CKeyActor * this_ptr, uint d1)
;
; Parameters:
...
section .text
    ...
    PUSH 0x6605a0                       ; 005019d6 | g_CKeyActorTypeInfo
        ;   Label: LAB_005019d6
    PUSH EBX                            ; 005019db
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 005019dc
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 005019e1
    PUSH EAX                            ; 005019e4
    CALL crt_memory.c_free_FUN_005fe659 ; 005019e5
