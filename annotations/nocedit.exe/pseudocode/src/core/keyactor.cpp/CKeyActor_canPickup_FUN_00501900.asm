...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_keyactor_cpp_CKeyActor_canPickup_FUN_00501900(CKeyActor *this_ptr,CDemonActor *picker)
;
; Parameters:
...
section .text
    ...
    PUSH 0x630c77                       ; 00501900 | = "CHero"
        ;   Label: core_keyactor.cpp_CKeyActor_canPickup_FUN_00501900
