...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_keyactor.cpp_FUN_00501710()
;
; Local Variables:
...
section .text
    ...
    FMUL double ptr [0x00630c3d]        ; 00501720 | double DOUBLE_00630c3d
    PUSH EAX                            ; 00501726
    ...
    CALL core_dglobe.cpp_CDemonGlobe_setColor_FUN_00471310 ; 00501740 | void core_dglobe.cpp_CDemonGlobe_setColor_FUN_00471310(CDemonGlobe * this_ptr, CColor3f * color)
        ;   XREF to: 00471310 (UNCONDITIONAL_CALL)
    FLD float ptr [ESI + 0x2d8]         ; 00501745
    FSIN                                ; 0050174b
    FMUL double ptr [0x00630c45]        ; 0050174d | double DOUBLE_00630c45
    FADD double ptr [0x00630c4d]        ; 00501753 | double DOUBLE_00630c4d
    ADD ESP,0x8                         ; 00501759
    CALL crt_math.c_round_FUN_005fe6b0  ; 0050175c | double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    CALL core_dglobe.cpp_CDemonGlobe_precomputeAttenuation_FUN_00471360 ; 0050178f | void core_dglobe.cpp_CDemonGlobe_precomputeAttenuation_FUN_00471360(CDemonGlobe * this_ptr, float radius)
        ;   XREF to: 00471360 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00501794
    PUSH EBX                            ; 00501797
    MOV EDX,dword ptr [0x006810c8]      ; 00501798 | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
    PUSH EDX                            ; 0050179e | CDemonSet g_CDemonSetInstance
    MOV dword ptr [EBX + 0x20],0x0      ; 0050179f
    CALL core_set.cpp_CDemonSet_FUN_0056d110 ; 005017a6 | void core_set.cpp_CDemonSet_FUN_0056d110(CDemonSet * this_ptr)
