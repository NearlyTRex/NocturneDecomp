...
section .text
    ...
    JZ 0x0050407f                       ; 00503df4 | LAB_0050407f
    ...
    MOV dword ptr [ESI + 0x124],0xff    ; 00503e22
        ;   Label: LAB_00503e22
    PUSH 0x631017                       ; 00503e2c | = "moon.kfm" | s_moon_kfm_00631017 = moon.kfm
    MOV dword ptr [ESI + 0x128],0xff    ; 00503e31
    PUSH 0x2dcd980                      ; 00503e3b | CKeyFramedModel g_LoadingMoonModel
    MOV dword ptr [ESI + 0x12c],0xff    ; 00503e40
    CALL core_dmodel.cpp_CKeyFramedModel_load_FUN_00476db0 ; 00503e4a | void core_dmodel.cpp_CKeyFramedModel_load_FUN_00476db0(CKeyFramedModel * this_ptr, char * filename)
        ;   XREF to: 00476db0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00503e4f
    PUSH 0x67cf84                       ; 00503e52 | SMRGLTextureBasic g_LoadingMoonGlowTexture
    MOV EDX,dword ptr [0x006703ec]      ; 00503e57 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH EDX                            ; 00503e5d | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80 ; 00503e5e | void engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80(CDemonRenderer * this_ptr, SMRGLTextureBasic * texture)
        ;   XREF to: 0048db80 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00503e63
    CMP EDI,-0x1                        ; 00503e66
    JNZ 0x00503e87                      ; 00503e69 | LAB_00503e87
        ;   XREF to: 00503e87 (CONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0x110],0x0     ; 00503e6b
    JNZ 0x00503e87                      ; 00503e72 | LAB_00503e87
        ;   XREF to: 00503e87 (CONDITIONAL_JUMP)
    CALL crt_stdlib.c_rand_FUN_005feb5c ; 00503e74 | int crt_stdlib.c_rand_FUN_005feb5c()
    ...
    TEST EDI,EDI                        ; 00503e87
        ;   Label: LAB_00503e87
    JNZ 0x00503f2a                      ; 00503e89 | LAB_00503f2a
        ;   XREF to: 00503f2a (CONDITIONAL_JUMP)
    LEA EDX,[ESP + 0x14]                ; 00503e8f
    PUSH EDX                            ; 00503e93
    CALL engine_alphabit.cpp_CAlphaBitmap_ctor_FUN_00410520 ; 00503e94 | void engine_alphabit.cpp_CAlphaBitmap_ctor_FUN_00410520(CAlphaBitmap * this_ptr)
        ;   XREF to: 00410520 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00503e99
    PUSH 0x1e0                          ; 00503e9c
    PUSH 0x280                          ; 00503ea1
    PUSH 0x631020                       ; 00503ea6 | = "load1" | s_load1_00631020 = load1
    LEA EDX,[ESP + 0x20]                ; 00503eab
    PUSH EDX                            ; 00503eaf
    CALL engine_alphabit.cpp_CAlphaBitmap_load_FUN_004105d0 ; 00503eb0 | void engine_alphabit.cpp_CAlphaBitmap_load_FUN_004105d0(CAlphaBitmap * this_ptr, char * filename, int width, int height)
    ...
    PUSH EDX                            ; 00503ec3
    CALL engine_alphabit.cpp_CAlphaBitmap_display_FUN_00410950 ; 00503ec4 | void engine_alphabit.cpp_CAlphaBitmap_display_FUN_00410950(CAlphaBitmap * this_ptr, int x, int y, int alpha)
    ...
    CALL engine_alphabit.cpp_CAlphaBitmap_dtor_FUN_00410540 ; 00503f22 | CAlphaBitmap * engine_alphabit.cpp_CAlphaBitmap_dtor_FUN_00410540(CAlphaBitmap * this_ptr)
        ;   XREF to: 00410540 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00503f27
    CMP EDI,0x1                         ; 00503f2a
        ;   Label: LAB_00503f2a
    JNZ 0x00503fcd                      ; 00503f2d | LAB_00503fcd
        ;   XREF to: 00503fcd (CONDITIONAL_JUMP)
    LEA EDX,[ESP + 0x28]                ; 00503f33
    PUSH EDX                            ; 00503f37
    CALL engine_alphabit.cpp_CAlphaBitmap_ctor_FUN_00410520 ; 00503f38 | void engine_alphabit.cpp_CAlphaBitmap_ctor_FUN_00410520(CAlphaBitmap * this_ptr)
        ;   XREF to: 00410520 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00503f3d
    PUSH 0x1e0                          ; 00503f40
    PUSH 0x280                          ; 00503f45
    PUSH 0x631026                       ; 00503f4a | = "load2" | s_load2_00631026 = load2
    LEA EDX,[ESP + 0x34]                ; 00503f4f
    PUSH EDX                            ; 00503f53
    CALL engine_alphabit.cpp_CAlphaBitmap_load_FUN_004105d0 ; 00503f54 | void engine_alphabit.cpp_CAlphaBitmap_load_FUN_004105d0(CAlphaBitmap * this_ptr, char * filename, int width, int height)
        ;   XREF to: 004105d0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDX                            ; 00503f69
    CALL engine_alphabit.cpp_CAlphaBitmap_display_FUN_00410950 ; 00503f6a | void engine_alphabit.cpp_CAlphaBitmap_display_FUN_00410950(CAlphaBitmap * this_ptr, int x, int y, int alpha)
        ;   XREF to: 00410950 (UNCONDITIONAL_CALL)
    ...
    CALL engine_alphabit.cpp_CAlphaBitmap_dtor_FUN_00410540 ; 00503fc5 | CAlphaBitmap * engine_alphabit.cpp_CAlphaBitmap_dtor_FUN_00410540(CAlphaBitmap * this_ptr)
        ;   XREF to: 00410540 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00503fca
    CMP EDI,0x2                         ; 00503fcd
        ;   Label: LAB_00503fcd
    JNZ 0x00504074                      ; 00503fd0 | LAB_00504074
        ;   XREF to: 00504074 (CONDITIONAL_JUMP)
    LEA EDX,[ESP + 0x3c]                ; 00503fd6
    PUSH EDX                            ; 00503fda
    CALL engine_alphabit.cpp_CAlphaBitmap_ctor_FUN_00410520 ; 00503fdb | void engine_alphabit.cpp_CAlphaBitmap_ctor_FUN_00410520(CAlphaBitmap * this_ptr)
        ;   XREF to: 00410520 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00503fe0
    PUSH 0x1e0                          ; 00503fe3
    PUSH 0x280                          ; 00503fe8
    PUSH 0x63102c                       ; 00503fed | = "load3" | s_load3_0063102c = load3
    LEA EDX,[ESP + 0x48]                ; 00503ff2
    PUSH EDX                            ; 00503ff6
    CALL engine_alphabit.cpp_CAlphaBitmap_load_FUN_004105d0 ; 00503ff7 | void engine_alphabit.cpp_CAlphaBitmap_load_FUN_004105d0(CAlphaBitmap * this_ptr, char * filename, int width, int height)
        ;   XREF to: 004105d0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDX                            ; 0050400c
    CALL engine_alphabit.cpp_CAlphaBitmap_display_FUN_00410950 ; 0050400d | void engine_alphabit.cpp_CAlphaBitmap_display_FUN_00410950(CAlphaBitmap * this_ptr, int x, int y, int alpha)
        ;   XREF to: 00410950 (UNCONDITIONAL_CALL)
    ...
    CALL engine_alphabit.cpp_CAlphaBitmap_dtor_FUN_00410540 ; 0050406c | CAlphaBitmap * engine_alphabit.cpp_CAlphaBitmap_dtor_FUN_00410540(CAlphaBitmap * this_ptr)
        ;   XREF to: 00410540 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00504071
    CMP EDI,0x3                         ; 00504074
        ;   Label: LAB_00504074
    JZ 0x005040b3                       ; 00504077 | LAB_005040b3
    ...
    PUSH EBX                            ; 0050407f
        ;   Label: LAB_0050407f
    CALL wincore_windll.cpp_clearScreen_FUN_005b3e70 ; 00504080 | void wincore_windll.cpp_clearScreen_FUN_005b3e70()
    ...
    POP EBX                             ; 005040ad
    JMP 0x00503e22                      ; 005040ae | LAB_00503e22
        ;   XREF to: 00503e22 (UNCONDITIONAL_JUMP)
    MOV EDX,ESP                         ; 005040b3
        ;   Label: LAB_005040b3
    PUSH EDX                            ; 005040b5
    CALL engine_alphabit.cpp_CAlphaBitmap_ctor_FUN_00410520 ; 005040b6 | void engine_alphabit.cpp_CAlphaBitmap_ctor_FUN_00410520(CAlphaBitmap * this_ptr)
        ;   XREF to: 00410520 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005040bb
    PUSH 0x1e0                          ; 005040be
    PUSH 0x280                          ; 005040c3
    PUSH 0x631032                       ; 005040c8 | = "load4" | s_load4_00631032 = load4
    LEA EDX,[ESP + 0xc]                 ; 005040cd
    PUSH EDX                            ; 005040d1
    CALL engine_alphabit.cpp_CAlphaBitmap_load_FUN_004105d0 ; 005040d2 | void engine_alphabit.cpp_CAlphaBitmap_load_FUN_004105d0(CAlphaBitmap * this_ptr, char * filename, int width, int height)
        ;   XREF to: 004105d0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDX                            ; 005040e7
    CALL engine_alphabit.cpp_CAlphaBitmap_display_FUN_00410950 ; 005040e8 | void engine_alphabit.cpp_CAlphaBitmap_display_FUN_00410950(CAlphaBitmap * this_ptr, int x, int y, int alpha)
        ;   XREF to: 00410950 (UNCONDITIONAL_CALL)
    ...
    CALL engine_alphabit.cpp_CAlphaBitmap_dtor_FUN_00410540 ; 00504147 | CAlphaBitmap * engine_alphabit.cpp_CAlphaBitmap_dtor_FUN_00410540(CAlphaBitmap * this_ptr)
        ;   XREF to: 00410540 (UNCONDITIONAL_CALL)
