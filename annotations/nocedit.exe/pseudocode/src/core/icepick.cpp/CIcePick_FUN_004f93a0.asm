...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_icepick_cpp_CIcePick_FUN_004f93a0(CIcePick *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004f93a0
        ;   Label: core_icepick.cpp_CIcePick_FUN_004f93a0
    PUSH ESI                            ; 004f93a1
    PUSH EDI                            ; 004f93a2
    PUSH EBP                            ; 004f93a3
    ...
    PUSH EDI                            ; 004f9409
    PUSH EBX                            ; 004f940a
    CALL core_icepick.cpp_CIcePick_FUN_004f9490 ; 004f940b
        ;   XREF to: 004f9490 (UNCONDITIONAL_CALL)  ; void core_icepick.cpp_CIcePick_FUN_004f9490(CIcePick * this_ptr)
    ...
    PUSH ECX                            ; 004f941b
    PUSH EBX                            ; 004f941c
    CALL core_icepick.cpp_CIcePick_FUN_004f9490 ; 004f941d
        ;   XREF to: 004f9490 (UNCONDITIONAL_CALL)  ; void core_icepick.cpp_CIcePick_FUN_004f9490(CIcePick * this_ptr)
