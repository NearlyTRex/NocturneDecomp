...
;                               FUNCTION
; *****************************************************************************
; __cdecl CIcePick * core_icepick.cpp_FUN_004f7df0(CIcePick * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 004f7df5
    CALL core_hero.cpp_FUN_004f2340     ; 004f7df6 | undefined core_hero.cpp_FUN_004f2340()
        ;   XREF to: 004f2340 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 004f7dfb
    ADD EAX,0x158                       ; 004f7dfd
    ADD ESP,0x4                         ; 004f7e02
    MOV dword ptr [EAX + -0x4],0x660034 ; 004f7e05 | CDemonActor_vtable PTR_core_icepick.cpp_FUN_00660034
    PUSH 0x62f5a8                       ; 004f7e0c | = "icepick.dfm" | s_icepick_dfm_0062f5a8 = icepick.dfm
    MOV dword ptr [EAX + 0x1fa7c],0x0   ; 004f7e11
    PUSH EAX                            ; 004f7e1b
    MOV dword ptr [EAX + 0x1fa80],0x0   ; 004f7e1c
    CALL core_skeleton.cpp_CDeformableModelInstance_init_FUN_005a0840 ; 004f7e26 | void core_skeleton.cpp_CDeformableModelInstance_init_FUN_005a0840(CDeformableModelInstance * this_ptr, char * model_name)
