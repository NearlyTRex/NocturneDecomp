...

{
  ...
  if (*(int *)(this_ptr->unk + 0x1c) != 0) {
    if (this_ptr->guns_drawn == 0) {
      fVar1 = *(float *)(this_ptr->unk + 0x24) - in_stack_00000008 * (float)2;
      *(float *)(this_ptr->unk + 0x24) = fVar1;
      if (fVar1 < 0.0) {
        this_ptr->unk[0x24] = '\0';
        this_ptr->unk[0x25] = '\0';
        this_ptr->unk[0x26] = '\0';
      ...
      fVar1 = in_stack_00000008 * (float)2 + *(float *)(this_ptr->unk + 0x24);
      *(float *)(this_ptr->unk + 0x24) = fVar1;
      if (1.0 < fVar1) {
        this_ptr->unk[0x24] = '\0';
        this_ptr->unk[0x25] = '\0';
        this_ptr->unk[0x26] = -0x80;
        this_ptr->unk[0x27] = '?';
      }
    }
    ...
    *(float *)(this_ptr->unk + 0x28) = fVar1;
    if ((float)0.78539816337500001 < fVar1) {
      ...
      this_ptr->unk[0x29] = '\x0f';
      this_ptr->unk[0x2a] = 'I';
      this_ptr->unk[0x2b] = '?';
    }
    if (*(float *)(this_ptr->unk + 0x28) < (float)-0.78539816337500001) {
      this_ptr->unk[0x28] = -0x25;
      this_ptr->unk[0x29] = '\x0f';
      this_ptr->unk[0x2a] = 'I';
      this_ptr->unk[0x2b] = -0x41;
    }
    core_xform_cpp_quaternionFromAngleX_FUN_005f79b0(*(float *)(this_ptr->unk + 0x28),&local_30);
    ...
    *puVar4 = *puVar3;
    ...
    core_skeleton_cpp_CDeformableModelInstance_applyRotationToHierarchy_FUN_0059ff20
              (&(this_ptr->base).base.model,&local_20,*(float *)(this_ptr->unk + 0x24),iVar2,
               blend_callback);
  }
  return;
}
