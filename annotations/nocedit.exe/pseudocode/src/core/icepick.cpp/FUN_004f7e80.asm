...
section .text
    ...
    PUSH ESI                            ; 004f7e86
    CALL core_hero.cpp_CHero_FUN_004f2540 ; 004f7e87
    ...
    PUSH EBX                            ; 004f7eb7
    MOV [0x02db8970],EAX                ; 004f7eb8 | DAT_02db8970
    ...
    PUSH EBX                            ; 004f7fc8
    MOV [0x02db89a4],EAX                ; 004f7fc9 | DAT_02db89a4
    ...
    PUSH EBX                            ; 004f7fdd
    MOV [0x02db89a8],EAX                ; 004f7fde | DAT_02db89a8
    ...
    PUSH EBX                            ; 004f8007
    MOV [0x02db89b0],EAX                ; 004f8008 | DAT_02db89b0
    ...
    MOV EAX,[0x02db89a4]                ; 004f8035 | DAT_02db89a4
    MOV dword ptr [ESI + 0x24ac],EAX    ; 004f803a
    MOV EAX,[0x02db89a8]                ; 004f8040 | DAT_02db89a8
