...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_icepick_cpp_CIcePick_writeDependencies_FUN_004f97c0(CIcePick *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x8]       ; 004f97c0
        ;   Label: core_icepick.cpp_CIcePick_writeDependencies_FUN_004f97c0
    PUSH EDX                            ; 004f97c4
    MOV ECX,dword ptr [ESP + 0x8]       ; 004f97c5
    PUSH ECX                            ; 004f97c9
    CALL core_hero.cpp_CHero_writeDependencies_FUN_004f3fa0 ; 004f97ca
