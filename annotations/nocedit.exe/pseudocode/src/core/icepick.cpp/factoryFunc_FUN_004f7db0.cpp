...
// Convention: __cdecl
// Signature: CIcePick * __cdecl core_icepick_cpp_factoryFunc_FUN_004f7db0(void)
...

{
  ...
  pCVar1 = (CIcePick *)shape_memdbg_cpp_debugAllocTracked_FUN_0050f1b0(0x1fc04,"..\\core\\icepick.cpp",0x66)
  ;
