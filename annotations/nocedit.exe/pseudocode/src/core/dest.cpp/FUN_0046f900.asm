...
section .text
    ...
    PUSH EDX                            ; 0046f906
    MOV ESI,0x61e39d                    ; 0046f907 | = "none" | s_none_0061e39d = none
    CALL core_actor.cpp_CDemonActor_ctor_FUN_004088b0 ; 0046f90c | CDemonActor * core_actor.cpp_CDemonActor_ctor_FUN_004088b0(CDemonActor * this_ptr)
        ;   XREF to: 004088b0 (UNCONDITIONAL_CALL)
    MOV EDX,EAX                         ; 0046f911
    ADD ESP,0x4                         ; 0046f913
    LEA EDI,[EAX + 0x188]               ; 0046f916
    MOV dword ptr [EAX + 0x154],0x65c724 ; 0046f91c | CDemonActor_vtable PTR_core_dest.cpp_FUN_0065c724
    PUSH EDI                            ; 0046f926
    MOV AL,byte ptr [ESI]               ; 0046f927 | = "none" | s_none_0061e39d = none
        ;   Label: LAB_0046f927
    MOV byte ptr [EDI],AL               ; 0046f929
    CMP AL,0x0                          ; 0046f92b
    JZ 0x0046f93f                       ; 0046f92d | LAB_0046f93f
        ;   XREF to: 0046f93f (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0046f92f | s_one_0061e39e
    ADD ESI,0x2                         ; 0046f932
    MOV byte ptr [EDI + 0x1],AL         ; 0046f935
    ADD EDI,0x2                         ; 0046f938
    CMP AL,0x0                          ; 0046f93b
    JNZ 0x0046f927                      ; 0046f93d | LAB_0046f927
