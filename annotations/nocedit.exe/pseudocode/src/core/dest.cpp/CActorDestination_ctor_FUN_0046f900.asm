...
;                               FUNCTION
; *****************************************************************************
; __cdecl CActorDestination * __cdecl core_dest_cpp_CActorDestination_ctor_FUN_0046f900(CActorDestination *this_ptr)
;
; Parameters:
; CActorDestination * Stack[0x4]:4   this_ptr
;
; XREF[2]:
;   core_dest.cpp_factoryFunc_FUN_0046f8c0 at 0046f8da
;   core_filmreel.cpp_CFilmProjector_ctor_FUN_004bea40 at 004bea48
;
; Referenced Globals:
...
section .text
    ...
    PUSH ESI                            ; 0046f900
        ;   Label: core_dest.cpp_CActorDestination_ctor_FUN_0046f900
    PUSH EDI                            ; 0046f901
    ...
    MOV dword ptr [EAX + 0x154],0x65c724 ; 0046f91c | g_CActorDestinationVTable
    PUSH EDI                            ; 0046f926
