...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_dest_cpp_CActorDestination_load_FUN_0046fdb0(void)
;
; Local Variables:
...
section .text
    ...
    PUSH EBX                            ; 0046fdbe
    CALL core_actor.cpp_CDemonActor_serialize_FUN_0040c1c0 ; 0046fdbf
    ...
    PUSH EAX                            ; 0046fddd
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 0046fdde
    ...
    PUSH EAX                            ; 0046fdfc
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 0046fdfd
    ...
    PUSH EAX                            ; 0046fe19
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 0046fe1a
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeString_FUN_0040b5c0(char * * string_buffer, char * property_type)
    ...
    PUSH EAX                            ; 0046fe3c
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 0046fe3d
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeString_FUN_0040b5c0(char * * string_buffer, char * property_type)
    ...
    PUSH EBX                            ; 0046fe5c
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 0046fe5d
