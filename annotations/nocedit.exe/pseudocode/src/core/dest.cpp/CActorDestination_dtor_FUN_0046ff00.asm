...
;                               FUNCTION
; *****************************************************************************
; __cdecl CActorDestination * __cdecl core_dest_cpp_CActorDestination_dtor_FUN_0046ff00(CActorDestination *this_ptr,uint flags)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 0046ff41
        ;   Label: LAB_0046ff41
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 0046ff42
