...
;
; XREF[1]:
;   core_filmreel.cpp_CFilmProjector_process_FUN_004beb40 at 004beb73
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0046f9b0
        ;   Label: core_dest.cpp_CActorDestination_process_FUN_0046f9b0
    PUSH ESI                            ; 0046f9b1
    PUSH EDI                            ; 0046f9b2
    PUSH EBP                            ; 0046f9b3
    ...
    MOV EAX,dword ptr [EDX + 0x14d158]  ; 0046f9f0 | g_CDemonSetInstance.actors[0] | g_CDemonSetInstance.actors[1]
    ...
    PUSH EAX                            ; 0046fa44
    CALL core_dest.cpp_CActorDestination_acceptsActor_FUN_0046fd50 ; 0046fa45
