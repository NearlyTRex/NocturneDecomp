...

{
  ...
  if ((this_ptr->needs_actor_search != 0) && (this_ptr->dest_actor == (CDemonActor *)0x0)) {
    ...
    for (iVar4 = 0; iVar4 < g_CDemonSetPtr->actor_count; iVar4 = iVar4 + 1) {
      ...
      local_2c = (this_ptr->base).location.position.x - *(float *)(iVar1 + 0x20);
      local_28 = (this_ptr->base).location.position.y - *(float *)(iVar1 + 0x24);
      local_24 = (this_ptr->base).location.position.z - *(float *)(iVar1 + 0x28);
