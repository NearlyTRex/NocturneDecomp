...
;   core_hero.cpp_CHero_findItemUseTarget_FUN_004f35b0 at 004f3650
;   core_stranger.cpp_CStranger_tryPlaceObject_FUN_005c2850 at 005c29f7
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 0046fd50
        ;   Label: core_dest.cpp_CActorDestination_acceptsActor_FUN_0046fd50
    PUSH ESI                            ; 0046fd51
