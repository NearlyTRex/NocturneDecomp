...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_flamecan.cpp_FUN_004cb390()
;
; Local Variables:
...
section .text
    ...
    PUSH EAX                            ; 004cb39e
    MOV EDX,dword ptr [0x006793d0]      ; 004cb39f | CEventList g_CEventListInstance | CEventList * g_CEventListPtr
    PUSH EDX                            ; 004cb3a5 | CEventList g_CEventListInstance
    CALL core_event.cpp_CEventList_evaluateCondition_FUN_004adca0 ; 004cb3a6 | int core_event.cpp_CEventList_evaluateCondition_FUN_004adca0(CEventList * this_ptr, char * condition_expression)
        ;   XREF to: 004adca0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004cb3ab
    TEST EAX,EAX                        ; 004cb3ae
    JNZ 0x004cb3c0                      ; 004cb3b0 | LAB_004cb3c0
        ;   XREF to: 004cb3c0 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x2d4],0x0     ; 004cb3b2
    JNZ 0x004cb3d7                      ; 004cb3b9 | LAB_004cb3d7
    ...
    PUSH EBX                            ; 004cb3c0
        ;   Label: LAB_004cb3c0
    CALL core_flamecan.cpp_FUN_004cb340 ; 004cb3c1 | undefined core_flamecan.cpp_FUN_004cb340()
        ;   XREF to: 004cb340 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004cb3c6
    CMP dword ptr [EBX + 0x2d4],0x0     ; 004cb3c9
    JNZ 0x004cb3d7                      ; 004cb3d0 | LAB_004cb3d7
        ;   XREF to: 004cb3d7 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 004cb3e1
    CALL core_flame.cpp_FUN_004c9c00    ; 004cb3e2 | undefined core_flame.cpp_FUN_004c9c00()
    ...
    FNSTSW AX                           ; 004cb3fe
    SAHF                                ; 004cb400
    JC 0x004cb3bb                       ; 004cb401 | LAB_004cb3bb
        ;   XREF to: 004cb3bb (CONDITIONAL_JUMP)
    PUSH EDI                            ; 004cb403
    PUSH ESI                            ; 004cb404
    PUSH 0x1                            ; 004cb405
    PUSH EBX                            ; 004cb407
    MOV ESI,dword ptr [0x0067d550]      ; 004cb408 | CDemonMission * g_CDemonMissionPtr
    PUSH ESI                            ; 004cb40e | CDemonMission g_CDemonMissionInstance
    CALL core_mission.cpp_CDemonMission_markActorToDelete_FUN_005240a0 ; 004cb40f | void core_mission.cpp_CDemonMission_markActorToDelete_FUN_005240a0(CDemonMission * this_ptr)
    ...
    FLD float ptr [0x0062a2e8]          ; 004cb435 | float FLOAT_0062a2e8
    FXCH                                ; 004cb43b
    FMUL ST1                            ; 004cb43d
    ...
    FMULP ST3                           ; 004cb45f
    MOV EDI,dword ptr [0x0067a3d0]      ; 004cb461 | CFireEffect * g_CFireEffectPtr
    ...
    PUSH EDI                            ; 004cb4aa | CFireEffect g_CFireEffectInstance
    FSTP float ptr [ESP + 0x3c]         ; 004cb4ab
    CALL core_fire.cpp_CFireEffect_FUN_004c8c10 ; 004cb4af | void core_fire.cpp_CFireEffect_FUN_004c8c10(CFireEffect * this_ptr)
