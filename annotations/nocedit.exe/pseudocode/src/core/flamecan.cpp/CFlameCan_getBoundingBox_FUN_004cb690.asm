...
;                               FUNCTION
; *****************************************************************************
; __cdecl CBoundingBox3D * __cdecl core_flamecan_cpp_CFlameCan_getBoundingBox_FUN_004cb690(CFlameCan *this_ptr,CBoundingBox3D *out_box)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004cb690
        ;   Label: core_flamecan.cpp_CFlameCan_getBoundingBox_FUN_004cb690
    MOV EBX,dword ptr [ESP + 0xc]       ; 004cb691
    MOV EAX,dword ptr [ESP + 0x8]       ; 004cb695
    ADD EAX,0x158                       ; 004cb699
    PUSH EAX                            ; 004cb69e
    CALL core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80 ; 004cb69f
