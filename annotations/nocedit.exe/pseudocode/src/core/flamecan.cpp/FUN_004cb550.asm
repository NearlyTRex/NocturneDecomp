...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_flamecan.cpp_FUN_004cb550()
;
;
; Called Functions:
...
section .text
    ...
    JNZ 0x004cb566                      ; 004cb55c | LAB_004cb566
    ...
    LEA EAX,[EBX + 0x340]               ; 004cb566
        ;   Label: LAB_004cb566
    PUSH EAX                            ; 004cb56c
    CALL core_flame.cpp_FUN_004ca110    ; 004cb56d | undefined core_flame.cpp_FUN_004ca110()
