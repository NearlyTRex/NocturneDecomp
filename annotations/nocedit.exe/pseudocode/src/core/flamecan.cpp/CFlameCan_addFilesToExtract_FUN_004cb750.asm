...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_flamecan_cpp_CFlameCan_addFilesToExtract_FUN_004cb750(CFlameCan *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004cb750
        ;   Label: core_flamecan.cpp_CFlameCan_addFilesToExtract_FUN_004cb750
    PUSH ESI                            ; 004cb751
    MOV EBX,dword ptr [ESP + 0xc]       ; 004cb752
    MOV ESI,dword ptr [ESP + 0x10]      ; 004cb756
    PUSH ESI                            ; 004cb75a
    PUSH EBX                            ; 004cb75b
    CALL core_actor.cpp_CDemonActor_addFilesToExtract_FUN_0040cfd0 ; 004cb75c
    ...
    PUSH EAX                            ; 004cb78e
    CALL core_dmodel.cpp_CKeyFramedModel_addFilesToExtract_FUN_0047ed00 ; 004cb78f
