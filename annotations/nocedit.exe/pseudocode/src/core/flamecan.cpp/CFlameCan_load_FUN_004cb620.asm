...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_flamecan_cpp_CFlameCan_load_FUN_004cb620(void)
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004cb625
    CALL core_actor.cpp_CDemonActor_serialize_FUN_0040c1c0 ; 004cb626
    ...
    PUSH EAX                            ; 004cb639
    CALL core_actor.cpp_serializeKeyframedModelInstance_FUN_0040b8f0 ; 004cb63a
    ...
    PUSH EAX                            ; 004cb64d
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 004cb64e
    ...
    PUSH EAX                            ; 004cb661
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 004cb662
    ...
    PUSH EBX                            ; 004cb675
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 004cb676
