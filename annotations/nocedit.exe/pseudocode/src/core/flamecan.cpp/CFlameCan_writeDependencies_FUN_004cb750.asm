...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_flamecan_cpp_CFlameCan_writeDependencies_FUN_004cb750(CFlameCan *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004cb750
        ;   Label: core_flamecan.cpp_CFlameCan_writeDependencies_FUN_004cb750
    PUSH ESI                            ; 004cb751
