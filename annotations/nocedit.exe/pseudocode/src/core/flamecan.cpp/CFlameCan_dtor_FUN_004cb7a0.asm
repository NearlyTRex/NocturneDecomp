...
section .text
    ...
    PUSH 0x65e230                       ; 004cb7dd | g_CFlameCanTypeInfo
        ;   Label: LAB_004cb7dd
    PUSH EBX                            ; 004cb7e2
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 004cb7e3
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 004cb7e8
    PUSH EAX                            ; 004cb7eb
    CALL crt_memory.c_free_FUN_005fe659 ; 004cb7ec
    ...
    PUSH EAX                            ; 004cb7f8
        ;   Label: LAB_004cb7f8
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 004cb7f9
