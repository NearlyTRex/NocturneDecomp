...
section .text
    ...
    PUSH ECX                            ; 00568f5a
    CALL core_actor.cpp_CDemonActor_writeDependencies_FUN_0040cfd0 ; 00568f5b | void core_actor.cpp_CDemonActor_writeDependencies_FUN_0040cfd0(CDemonActor * this_ptr, FILE * file_handle)
    ...
    PUSH EAX                            ; 00568f71
    CALL core_skeledit.cpp_GetModelPtrOfFile_FUN_0058a260 ; 00568f72 | undefined core_skeledit.cpp_GetModelPtrOfFile_FUN_0058a260()
