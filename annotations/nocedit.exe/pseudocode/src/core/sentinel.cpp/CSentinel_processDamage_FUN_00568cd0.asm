...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_sentinel_cpp_CSentinel_processDamage_FUN_00568cd0(CSentinel *this_ptr,SDamageInfo *damage_info)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00568cd0
        ;   Label: core_sentinel.cpp_CSentinel_processDamage_FUN_00568cd0
    PUSH ESI                            ; 00568cd1
    PUSH EDI                            ; 00568cd2
