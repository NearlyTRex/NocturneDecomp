...
section .text
    ...
    PUSH ESI                            ; 00568f1a
    PUSH EBX                            ; 00568f1b
    CALL core_enemy.cpp_CEnemy_FUN_004aa170 ; 00568f1c | int core_enemy.cpp_CEnemy_FUN_004aa170(CEnemy * this_ptr)
        ;   XREF to: 004aa170 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00568f21
    PUSH 0x0                            ; 00568f24
    ADD EBX,0x158                       ; 00568f26
    PUSH EBX                            ; 00568f2c
    PUSH 0x6458d7                       ; 00568f2d | = "Model" | s_Model_006458d7 = Model
    PUSH ESI                            ; 00568f32
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e4a0 ; 00568f33 | void core_actor.cpp_CActorPropertyList_FUN_0040e4a0(CActorPropertyList * this_ptr)
        ;   XREF to: 0040e4a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00568f38
    PUSH EBX                            ; 00568f3b
    PUSH 0x6458dd                       ; 00568f3c | = "State" | s_State_006458dd = State
    PUSH ESI                            ; 00568f41
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e4d0 ; 00568f42 | void core_actor.cpp_CActorPropertyList_FUN_0040e4d0(CActorPropertyList * this_ptr)
