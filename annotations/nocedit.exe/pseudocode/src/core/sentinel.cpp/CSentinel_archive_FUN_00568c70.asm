...
section .text
    ...
    PUSH EBX                            ; 00568c70
        ;   Label: core_sentinel.cpp_CSentinel_archive_FUN_00568c70
    MOV EBX,dword ptr [ESP + 0x8]       ; 00568c71
    PUSH EBX                            ; 00568c75
    CALL core_enemy.cpp_CEnemy_archive_FUN_004a9660 ; 00568c76
    ...
    PUSH EAX                            ; 00568c89
    CALL core_actor.cpp_archiveDeformableModelInstance_FUN_0040b970 ; 00568c8a
    ...
    PUSH EBX                            ; 00568ca8
    CALL core_actor.cpp_archiveMotionState_FUN_0040b9f0 ; 00568ca9
    ...
    PUSH EAX                            ; 00568cbe
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 00568cbf
