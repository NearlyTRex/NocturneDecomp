...
;                               FUNCTION
; *****************************************************************************
; __cdecl CSentinel * __cdecl core_sentinel_cpp_CSentinel_dtor_FUN_00568f80 (CSentinel *this_ptr,uint d1,uint d2,uint d3,uint d4,uint d5,uint d6,uint d7,uint d8)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00568f98
    CALL core_backgnd.cpp_freeFlames_FUN_00412720 ; 00568f99
    ...
    PUSH EAX                            ; 00568fa8
    CALL core_backgnd.cpp_freeFires_FUN_00412700 ; 00568fa9
    ...
    PUSH EAX                            ; 00568fb8
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 00568fb9
    ...
    PUSH EAX                            ; 00568fc8
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 00568fc9
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; int core_backgnd.cpp_cleanupVector_FUN_004126e0(CVector3f * * objs)
    ADD ESP,0x8                         ; 00568fce
    PUSH 0x0                            ; 00568fd1
    SUB EAX,0x1c8                       ; 00568fd3
    PUSH EAX                            ; 00568fd8
    CALL core_cloth.cpp_FUN_0043bf80    ; 00568fd9
    ...
    PUSH 0x662800                       ; 00569011 | g_CSentinelTypeInfo
        ;   Label: LAB_00569011
    PUSH EBX                            ; 00569016
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 00569017
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 0056901c
    PUSH EAX                            ; 0056901f
    CALL crt_memory.c_free_FUN_005fe659 ; 00569020
    ...
    PUSH EAX                            ; 0056902c
        ;   Label: LAB_0056902c
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 0056902d
