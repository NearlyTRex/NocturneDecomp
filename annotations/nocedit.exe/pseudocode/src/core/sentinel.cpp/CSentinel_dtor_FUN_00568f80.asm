...
section .text
    ...
    PUSH EBX                            ; 00568f98
    CALL core_armour.cpp_CFlame_arrdtor50_FUN_00412720 ; 00568f99
    ...
    PUSH EAX                            ; 00568fa8
    CALL core_armour.cpp_SFire_arrdtor50_FUN_00412700 ; 00568fa9
    ...
    PUSH EAX                            ; 00568fb8
    CALL core_armour.cpp_CVector3f_arrdtor15_FUN_004126e0 ; 00568fb9
    ...
    PUSH EAX                            ; 00568fc8
    CALL core_armour.cpp_CVector3f_arrdtor15_FUN_004126e0 ; 00568fc9
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; CVector3f * core_armour.cpp_CVector3f_arrdtor15_FUN_004126e0(CVector3f * this_ptr, uint flags)
