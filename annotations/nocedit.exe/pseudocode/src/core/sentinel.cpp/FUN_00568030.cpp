...
// Convention: __cdecl
// Signature: void __cdecl core_sentinel_cpp_FUN_00568030(void)
...
LAB_00568089:
  if (0.0 < local_2c) {
    ...
    case 100:
      if ((((*(int *)(in_stack_00000004->unk2 + 4) != 0) &&
        ...
        fVar3 = local_c8.x - *(float *)(*(int *)(in_stack_00000004->unk2 + 4) + 0x20);
        fVar5 = local_c8.z - *(float *)(*(int *)(in_stack_00000004->unk2 + 4) + 0x28);
        fVar3 = SQRT(fVar5 * fVar5 + fVar3 * fVar3);
        fVar5 = (float)0.80000000000000004;
        if (ABS(local_c8.y - *(float *)(*(int *)(in_stack_00000004->unk2 + 4) + 0x24)) <=
            (float)4) {
          if ((fVar5 < fVar3) ||
             (iVar7 = (**(code **)(*(int *)(*(int *)(in_stack_00000004->unk2 + 4) + 0x154) + 0x100))
                                (), iVar7 != 0)) {
            if (fVar5 < fVar3) {
  ...
  (in_stack_00000004->base).walk_step_speed =
       (in_stack_00000004->base).model.accumulated_root_motion.z;
  (in_stack_00000004->base).turn_speed = in_stack_00000008 * fVar5 * fVar3;
  ...
  if (iVar9 == 0) {
    if ((iVar7 == 10) || (iVar7 == 0xb)) {
      (in_stack_00000004->base).collision_cylinder_radius = 0.5;
    }
    else {
      (in_stack_00000004->base).collision_cylinder_radius = 2.0;
    }
    switch(local_1c) {
    case 0:
      ...
      if (iVar7 == 0) {
        ...
        local_5c = *(float *)(iVar7 + 0x20) - (in_stack_00000004->base).base.location.position.x;
        local_58 = *(float *)(iVar7 + 0x24) - (in_stack_00000004->base).base.location.position.y;
        local_54 = *(float *)(iVar7 + 0x28) - (in_stack_00000004->base).base.location.position.z;
    ...
    case 2:
      ...
      if (*(int *)(in_stack_00000004->unk2 + 4) != 0) {
        ...
        if (-1 < iVar7) {
          local_e0 = (in_stack_00000004->base).base.location.position.x -
                     *(float *)(*(int *)(in_stack_00000004->unk2 + 4) + 0x20);
          local_d8 = (in_stack_00000004->base).base.location.position.z -
          ...
          if ((local_24 <= local_20) && (*(float *)in_stack_00000004->unk2 <= 0.0)) {
            ...
            local_14 = core_actor_cpp_normalizeAngleToPi_FUN_0040cd70
                                 (local_74.y - (in_stack_00000004->base).base.orient.bank);
            if (ABS(local_14) < (float)0.52359877558333301) {
              ...
              if (iVar7 == 0) {
                ...
                (pCVar6->base).actor_name[0xc] = '\0';
                (pCVar6->base).actor_name[0xd] = '\0';
                (pCVar6->base).actor_name[0xe] = -0x60;
                (pCVar6->base).actor_name[0xf] = '@';
              }
              else {
                core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
...
LAB_0056878f:
    ...
    case 3:
      ...
      iVar7 = *(int *)(in_stack_00000004->unk2 + 4);
      local_11c = (in_stack_00000004->base).base.location.position.x - *(float *)(iVar7 + 0x20);
      local_118 = (in_stack_00000004->base).base.location.position.y - *(float *)(iVar7 + 0x24);
      local_114 = (in_stack_00000004->base).base.location.position.z - *(float *)(iVar7 + 0x28);
      if (12.0f <=
    ...
    case 9:
      ...
      break;
    case 10:
      fVar3 = *(float *)(in_stack_00000004[1].base.base.actor_name + 0xc) - in_stack_00000008;
      *(float *)(in_stack_00000004[1].base.base.actor_name + 0xc) = fVar3;
      if (fVar3 < 0.0) {
        core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
    ...
    case 0xf:
      ...
      if (iVar7 == 0) {
        ...
        (in_stack_00000004->base).base.orient.bank = local_d4.y;
      }
    }
    goto switchD_00568487_caseD_d;
  }
  uVar4 = (in_stack_00000004->base).field22_0x25b0;
  if (uVar4 < 2) {
    if (uVar4 == 1) {
LAB_005680fd:
      iVar7 = 2;
...
switchD_00568487_caseD_d:
  ...
  if (iVar7 != 0) {
    ...
    local_104 = (in_stack_00000004->base).field7_0x2428.x * in_stack_00000008;
    local_100 = (in_stack_00000004->base).field7_0x2428.y * in_stack_00000008;
    pCVar10 = &(in_stack_00000004->base).field6_0x241c;
    local_fc = in_stack_00000008 * (in_stack_00000004->base).field7_0x2428.z;
    pCVar2 = &(in_stack_00000004->base).model.accumulated_root_motion;
    local_ec = local_104 + pCVar10->x;
    local_e8 = local_100 + (in_stack_00000004->base).field6_0x241c.y;
    local_e4 = local_fc + (in_stack_00000004->base).field6_0x241c.z;
    local_68 = local_ec + pCVar2->x;
    local_64 = local_e8 + (in_stack_00000004->base).model.accumulated_root_motion.y;
    local_60 = local_e4 + (in_stack_00000004->base).model.accumulated_root_motion.z;
