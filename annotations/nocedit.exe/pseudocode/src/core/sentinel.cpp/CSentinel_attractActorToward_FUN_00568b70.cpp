...
int __cdecl
core_sentinel_cpp_CSentinel_attractActorToward_FUN_00568b70
          (CSentinel *this_ptr,CDemonActor *actor,CVector3f *target_local_point)

{
  ...
  pCVar1 = core_xform_cpp_transformVector3x4_FUN_005f4dc0
                     (&local_10,&g_ZeroVector,
                      (CMatrix3x4f *)
                      (this_ptr->base).base.model.bone_transform.bone_world_matrices[INT_03114210].m
                     );
  pCVar2 = core_xform_cpp_transformVector3x4_FUN_005f4dc0
                     (&local_34,&g_ZeroVector,
                      (CMatrix3x4f *)
                      (this_ptr->base).base.model.bone_transform.bone_world_matrices[INT_03114214].m
                     );
  ...
  (*((actor->vtable)._ub)->setPositionAndOrientation)(actor,&local_28,&(actor->orient).vec);
  return 1;
}
