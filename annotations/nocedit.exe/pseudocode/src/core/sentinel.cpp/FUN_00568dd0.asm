...
section .text
    ...
    MOV EDX,dword ptr [0x0311420c]      ; 00568ddf | undefined4 DAT_0311420c
    PUSH EDX                            ; 00568de5
    ...
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00 ; 00568df7 | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
        ;   XREF to: 0059fb00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00568dfc
    CMP EBX,EAX                         ; 00568dff
    JZ 0x00568e13                       ; 00568e01 | LAB_00568e13
    ...
    MOV ECX,dword ptr [0x03114220]      ; 00568e13 | undefined4 DAT_03114220
        ;   Label: LAB_00568e13
    PUSH ECX                            ; 00568e19
    ...
    PUSH EAX                            ; 00568e25
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00 ; 00568e26 | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
        ;   XREF to: 0059fb00 (UNCONDITIONAL_CALL)
    LEA EDX,[EBX + 0xc]                 ; 00568e2b
    ADD ESP,0xc                         ; 00568e2e
    CMP EDX,EAX                         ; 00568e31
    JZ 0x00568e45                       ; 00568e33 | LAB_00568e45
    ...
    MOV EBP,dword ptr [0x03114224]      ; 00568e45 | undefined4 DAT_03114224
        ;   Label: LAB_00568e45
    PUSH EBP                            ; 00568e4b
    ...
    PUSH EAX                            ; 00568e57
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00 ; 00568e58 | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
        ;   XREF to: 0059fb00 (UNCONDITIONAL_CALL)
    LEA EDX,[EBX + 0x18]                ; 00568e5d
    ADD ESP,0xc                         ; 00568e60
    CMP EDX,EAX                         ; 00568e63
    JZ 0x00568e77                       ; 00568e65 | LAB_00568e77
    ...
    MOV EAX,[0x03114230]                ; 00568e77 | undefined4 DAT_03114230
        ;   Label: LAB_00568e77
    PUSH EAX                            ; 00568e7c
    ...
    PUSH EAX                            ; 00568e88
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00 ; 00568e89 | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
        ;   XREF to: 0059fb00 (UNCONDITIONAL_CALL)
    LEA EDX,[EBX + 0x24]                ; 00568e8e
    ADD ESP,0xc                         ; 00568e91
    CMP EDX,EAX                         ; 00568e94
    JZ 0x00568ea8                       ; 00568e96 | LAB_00568ea8
    ...
    MOV EDX,dword ptr [0x03114238]      ; 00568ea8 | undefined4 DAT_03114238
        ;   Label: LAB_00568ea8
    PUSH EDX                            ; 00568eae
    ...
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00 ; 00568ebe | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
        ;   XREF to: 0059fb00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00568ec3
    CMP EBX,EAX                         ; 00568ec6
    JNZ 0x00568ed4                      ; 00568ec8 | LAB_00568ed4
