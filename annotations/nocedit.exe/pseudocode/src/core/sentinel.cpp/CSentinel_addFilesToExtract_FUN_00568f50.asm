...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_sentinel_cpp_CSentinel_addFilesToExtract_FUN_00568f50(CSentinel *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00568f50
        ;   Label: core_sentinel.cpp_CSentinel_addFilesToExtract_FUN_00568f50
    MOV EDX,dword ptr [ESP + 0xc]       ; 00568f51
    PUSH EDX                            ; 00568f55
    MOV ECX,dword ptr [ESP + 0xc]       ; 00568f56
    PUSH ECX                            ; 00568f5a
    CALL core_actor.cpp_CDemonActor_addFilesToExtract_FUN_0040cfd0 ; 00568f5b
    ...
    PUSH EAX                            ; 00568f71
    CALL core_skeledit.cpp_CDeformableModelInstance_addFilesToExtract_FUN_0058a260 ; 00568f72
