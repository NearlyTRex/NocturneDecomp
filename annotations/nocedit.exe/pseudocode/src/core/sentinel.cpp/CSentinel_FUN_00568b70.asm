...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_sentinel_cpp_CSentinel_FUN_00568b70(CSentinel *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EDI                            ; 00568b70
        ;   Label: core_sentinel.cpp_CSentinel_FUN_00568b70
    SUB ESP,0x3c                        ; 00568b71
    MOV EDI,dword ptr [ESP + 0x48]      ; 00568b74
    TEST EDI,EDI                        ; 00568b78
    JNZ 0x00568b83                      ; 00568b7a
        ;   XREF to: 00568b83 (CONDITIONAL_JUMP)  ; LAB_00568b83
    ...
    PUSH EAX                            ; 00568ba3
    PUSH 0x3f87558                      ; 00568ba4 | g_ZeroVector
    ...
    PUSH EAX                            ; 00568bcc
    PUSH 0x3f87558                      ; 00568bcd | g_ZeroVector
    LEA EAX,[ESP + 0x1c]                ; 00568bd2
    PUSH EAX                            ; 00568bd6
    CALL core_xform.cpp_transformVector3x4_FUN_005f4dc0 ; 00568bd7
        ;   XREF to: 005f4dc0 (UNCONDITIONAL_CALL)  ; CVector3f * core_xform.cpp_transformVector3x4_FUN_005f4dc0(CVector3f * output_vector, CVector3f * input_vector, CMatrix3x4f * matrix)
    ...
    FXCH                                ; 00568bed
    FLD float ptr [0x00645882]          ; 00568bef | FLOAT_00645882
    FXCH                                ; 00568bf5
    FMUL ST1                            ; 00568bf7
    FXCH ST2                            ; 00568bf9
    ...
    PUSH EAX                            ; 00568c2a
    FADD float ptr [0x00645886]         ; 00568c2b | FLOAT_00645886
    PUSH EDX                            ; 00568c31
    FSTP float ptr [ESP + 0x40]         ; 00568c32
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 00568c36
    ...
    FADD float ptr [0x0064588a]         ; 00568c4a | FLOAT_0064588a
    PUSH EAX                            ; 00568c50
