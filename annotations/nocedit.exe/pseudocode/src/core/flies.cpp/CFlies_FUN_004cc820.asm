...
;                               FUNCTION
; *****************************************************************************
; __cdecl float * __cdecl core_flies_cpp_CFlies_FUN_004cc820(CFlies *this_ptr)
;
; Parameters:
...
;
; XREF[2]:
;   core_flies.cpp_CFlies_FUN_004cc760 at 004cc797
...
section .text
    ...
    PUSH EBX                            ; 004cc820
        ;   Label: core_flies.cpp_CFlies_FUN_004cc820
    PUSH ESI                            ; 004cc821
    PUSH EDI                            ; 004cc822
    PUSH EBP                            ; 004cc823
