...

{
  ...
  if ((g_ZBufferScanlineArray[in_stack_00000008][in_stack_00000004] < in_stack_0000000c) &&
    ...
    uVar2 = (uint)(CONCAT34 /* combine 2-byte values */((int3)(CONCAT25 /* combine 2-byte values */((short)(((uint7)(byte)((uint)uVar1 >> 0x18) << 0x30) >>
    ...
    uVar6 = (ushort)(byte)((uint)g_ActiveRenderColor >> 8) * (ushort)(byte)((uint)DAT_02d7a804 >> 8)
            + ((ushort)(CONCAT43 /* combine 2-byte values */(uVar2,CONCAT12 /* combine 2-byte values */((char)((uint)uVar1 >> 8),(ushort)uVar1)) >> 0x10) &
              0xff) * (ushort)(byte)((uint)DAT_02d7a800 >> 8);
    uVar8 = (short)CONCAT21 /* combine 2-byte values */(uVar9,(char)((uint)g_ActiveRenderColor >> 0x10)) *
            (short)CONCAT21 /* combine 2-byte values */(uVar7,(char)((uint)DAT_02d7a804 >> 0x10)) +
            (short)(uVar12 >> 8) * (short)CONCAT21 /* combine 2-byte values */(uVar5,(char)((uint)DAT_02d7a800 >> 0x10));
    uVar10 = (uVar9 >> 8) * (uVar7 >> 8) + (short)(uVar12 >> 0x18) * (uVar5 >> 8);
    uVar5 = uVar4 >> 8;
    uVar7 = uVar6 >> 8;
    uVar9 = uVar8 >> 8;
    uVar11 = uVar10 >> 8;
    *puVar3 = CONCAT13 /* combine 2-byte values */((uVar11 != 0) * (uVar11 < 0x100) * (char)(uVar10 >> 8) - (0xff < uVar11),
                       CONCAT12 /* combine 2-byte values */((uVar9 != 0) * (uVar9 < 0x100) * (char)(uVar8 >> 8) - (0xff < uVar9)
                                ,CONCAT11 /* combine 2-byte values */((uVar7 != 0) * (uVar7 < 0x100) * (char)(uVar6 >> 8) -
                                          (0xff < uVar7),
