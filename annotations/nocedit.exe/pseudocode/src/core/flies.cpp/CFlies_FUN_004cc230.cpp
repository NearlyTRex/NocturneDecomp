// Name: core_flies.cpp_CFlies_FUN_004cc230
// Address: 004cc230
// Address Range: [[004cc230, 004cc2b6]]
// Convention: __cdecl
// Signature: void __cdecl core_flies_cpp_CFlies_FUN_004cc230(CFlies *this_ptr)
...

{
  ...
  if ((g_ZBufferScanlineArray[in_stack_00000008][(int)this_ptr] < in_stack_0000000c) &&
     (g_BitsPerPixel == 0x20)) {
    puVar3 = (uint *)((int)g_ScreenBufferArray[in_stack_00000008] + (int)this_ptr * 4);
    uVar1 = *puVar3;
