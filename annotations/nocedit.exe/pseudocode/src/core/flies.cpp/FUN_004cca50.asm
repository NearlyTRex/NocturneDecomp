...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_flies.cpp_FUN_004cca50()
;
;
; XREF[1]:
...
section .text
    ...
    MOV EAX,[0x006810c8]                ; 004cca5c | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
        ;   Label: LAB_004cca5c
    CMP EBX,dword ptr [EAX + 0x14d154]  ; 004cca61 | g_CDemonSetInstance.actor_list_ptr
    JL 0x004cca76                       ; 004cca67 | LAB_004cca76
    ...
    JMP 0x004cca5c                      ; 004cca74 | LAB_004cca5c
    ...
    PUSH EBP                            ; 004cca84
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 004cca85 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004cca8a
    TEST EAX,EAX                        ; 004cca8d
    JZ 0x004cca70                       ; 004cca8f | LAB_004cca70
        ;   XREF to: 004cca70 (CONDITIONAL_JUMP)
    CMP EDI,dword ptr [EAX + 0x2a08]    ; 004cca91
    JNZ 0x004cca70                      ; 004cca97 | LAB_004cca70
        ;   XREF to: 004cca70 (CONDITIONAL_JUMP)
    POP EBP                             ; 004cca99
    POP EDI                             ; 004cca9a
    POP ESI                             ; 004cca9b
