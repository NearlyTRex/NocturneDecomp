...

{
  ...
  this_ptr = (*in_stack_00000004->vtable->getBoundingBox)(in_stack_00000004,&CStack_50);
  ...
  if (iStack_20 != 0) {
    ...
    if (0 < *(int *)(in_stack_00000004[1].actor_name + 0xc)) {
      ...
      do {
        ...
        fStack_30 = (float)(int)ROUND(fStack_38 * _DAT_0065e500);
        CStack_2c.x = (int)ROUND(fStack_34 * _DAT_0065e500);
        CStack_2c.y = (int)ROUND(fStack_30 * _DAT_0065e500);
        wincore_windll_cpp_transformAndProjectPoint_FUN_005b575c
                  (&g_CDemonRendererPtr->vertex_buffer_ptr->projected_vertex,&CStack_2c);
        pCVar2 = g_CDemonRendererPtr;
          ...
          if (g_UseExternalRenderer == 0) {
            ...
            *(short *)((int)&pCVar2->vertex_buffer_ptr[2].projected_vertex.screen_y + 2) =
            ...
            engine_drender_cpp_CDemonRenderer_renderWireframeVariant_FUN_0048aeb0
                      (pCVar2,(SMRGLHeaderPrimitive *)&stack0xffffff68,999);
          }
        }
        pcStack_18 = (char *)((int)pcStack_18 + 0x34);
        iStack_1c = iStack_1c + 1;
      } while (iStack_1c < *(int *)(in_stack_00000004[1].actor_name + 0xc));
    }
  }
