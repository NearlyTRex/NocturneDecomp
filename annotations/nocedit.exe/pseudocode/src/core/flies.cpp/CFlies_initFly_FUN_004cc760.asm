...
;   core_flies.cpp_CFlies_setup_FUN_004cbe20 at 004cbe3d
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 004cc760
        ;   Label: core_flies.cpp_CFlies_initFly_FUN_004cc760
    PUSH ESI                            ; 004cc761
    PUSH EDI                            ; 004cc762
    PUSH EBP                            ; 004cc763
    ...
    CALL core_flies.cpp_CFlies_generateRandomPoint_FUN_004cc820 ; 004cc797
    ...
    PUSH EAX                            ; 004cc7bb
    PUSH EBP                            ; 004cc7bc
    CALL core_flies.cpp_CFlies_generateRandomPoint_FUN_004cc820 ; 004cc7bd
        ;   XREF to: 004cc820 (UNCONDITIONAL_CALL)  ; CVector3f * core_flies.cpp_CFlies_generateRandomPoint_FUN_004cc820(CFlies * this_ptr, CVector3f * out_point, CVector3f * reference_point)
    ...
    PUSH 0x0                            ; 004cc7e8
    CALL core_actor.cpp_getRandomFloatFromRange_FUN_0040cc10 ; 004cc7ea
        ;   XREF to: 0040cc10 (UNCONDITIONAL_CALL)  ; float core_actor.cpp_getRandomFloatFromRange_FUN_0040cc10(float min_value, float max_value)
    MOV dword ptr [ESP + 0x24],EAX      ; 004cc7ef
    FLD float ptr [ESP + 0x24]          ; 004cc7f3
    ADD ESP,0x8                         ; 004cc7f7
    MOV EAX,dword ptr [ESP + 0x18]      ; 004cc7fa
    FSTP float ptr [EAX]                ; 004cc7fe
    ADD ESP,0x20                        ; 004cc800
    POP EBP                             ; 004cc803
    POP EDI                             ; 004cc804
    POP ESI                             ; 004cc805
    POP EBX                             ; 004cc806
