...
;                               FUNCTION
; *****************************************************************************
; __cdecl CFlies * __cdecl core_flies_cpp_FUN_004cccb0(CFlies *this_ptr,uint d1,uint d2,uint d3)
;
; Parameters:
...
section .text
    ...
    PUSH 0x65e630                       ; 004ccced | g_CFliesTypeInfo
        ;   Label: LAB_004ccced
    PUSH EBX                            ; 004cccf2
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 004cccf3
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 004cccf8
    PUSH EAX                            ; 004cccfb
    CALL crt_memory.c_free_FUN_005fe659 ; 004cccfc
    ...
    PUSH EAX                            ; 004ccd08
        ;   Label: LAB_004ccd08
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 004ccd09
