...
;   core_flies.cpp_freeFlies_FUN_004ccd60
...
section .text
    ...
    PUSH EBX                            ; 004cccc4
    CALL core_flies.cpp_freeFlies_FUN_004ccd60 ; 004cccc5
        ;   XREF to: 004ccd60 (UNCONDITIONAL_CALL)  ; SFly * core_flies.cpp_freeFlies_FUN_004ccd60(SFly * objs)
