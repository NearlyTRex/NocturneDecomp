...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_flies.cpp_FUN_004ccaf0()
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH 0x1d                           ; 004ccaf8
    MOV EAX,[0x0067cf44]                ; 004ccafa | CKeys * g_CKeysPtr
    PUSH EAX                            ; 004ccaff | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004ccb00 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 004ccb02
    ADD ESP,0x8                         ; 004ccb04
    TEST EAX,EAX                        ; 004ccb07
    JZ 0x004ccc60                       ; 004ccb09 | LAB_004ccc60
        ;   XREF to: 004ccc60 (CONDITIONAL_JUMP)
    MOV EAX,[0x0067b654]                ; 004ccb0f | CGame * g_CGamePtr
    PUSH 0x4b                           ; 004ccb14
    FLD float ptr [EAX + 0x264]         ; 004ccb16 | g_CGameInstance.delta_time_float
    MOV EAX,[0x0067cf44]                ; 004ccb1c | CKeys * g_CKeysPtr
    FMUL double ptr [0x0062a47e]        ; 004ccb21 | double DOUBLE_0062a47e
    PUSH EAX                            ; 004ccb27 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004ccb28 | void * g_CKeysPtr
    FSTP float ptr [ESP + 0xc]          ; 004ccb2a
    CALL dword ptr [EDX]                ; 004ccb2e
    ADD ESP,0x8                         ; 004ccb30
    TEST EAX,EAX                        ; 004ccb33
    JZ 0x004ccb47                       ; 004ccb35 | LAB_004ccb47
    ...
    PUSH 0x4d                           ; 004ccb47
        ;   Label: LAB_004ccb47
    MOV EAX,[0x0067cf44]                ; 004ccb49 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 004ccb4e | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004ccb4f | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 004ccb51
    ADD ESP,0x8                         ; 004ccb53
    TEST EAX,EAX                        ; 004ccb56
    JZ 0x004ccb6a                       ; 004ccb58 | LAB_004ccb6a
    ...
    PUSH 0x1e                           ; 004ccb6a
        ;   Label: LAB_004ccb6a
    MOV EAX,[0x0067cf44]                ; 004ccb6c | CKeys * g_CKeysPtr
    PUSH EAX                            ; 004ccb71 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004ccb72 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 004ccb74
    ADD ESP,0x8                         ; 004ccb76
    TEST EAX,EAX                        ; 004ccb79
    JZ 0x004ccb8d                       ; 004ccb7b | LAB_004ccb8d
    ...
    PUSH 0x10                           ; 004ccb8d
        ;   Label: LAB_004ccb8d
    MOV EAX,[0x0067cf44]                ; 004ccb8f | CKeys * g_CKeysPtr
    PUSH EAX                            ; 004ccb94 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004ccb95 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 004ccb97
    ADD ESP,0x8                         ; 004ccb99
    TEST EAX,EAX                        ; 004ccb9c
    JZ 0x004ccbb0                       ; 004ccb9e | LAB_004ccbb0
    ...
    PUSH 0x50                           ; 004ccbb0
        ;   Label: LAB_004ccbb0
    MOV EAX,[0x0067cf44]                ; 004ccbb2 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 004ccbb7 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004ccbb8 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 004ccbba
    ADD ESP,0x8                         ; 004ccbbc
    TEST EAX,EAX                        ; 004ccbbf
    JZ 0x004ccbd3                       ; 004ccbc1 | LAB_004ccbd3
    ...
    PUSH 0x48                           ; 004ccbd3
        ;   Label: LAB_004ccbd3
    MOV EAX,[0x0067cf44]                ; 004ccbd5 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 004ccbda | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004ccbdb | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 004ccbdd
    ADD ESP,0x8                         ; 004ccbdf
    TEST EAX,EAX                        ; 004ccbe2
    JZ 0x004ccbf6                       ; 004ccbe4 | LAB_004ccbf6
    ...
    JGE 0x004ccc0e                      ; 004ccc06 | LAB_004ccc0e
    ...
    FNSTSW AX                           ; 004ccc17
    SAHF                                ; 004ccc19
    JNC 0x004ccc25                      ; 004ccc1a | LAB_004ccc25
    ...
    PUSH EBX                            ; 004ccc60
        ;   Label: LAB_004ccc60
    CALL core_actor.cpp_CDemonActor_processInEditor_FUN_0040d040 ; 004ccc61 | void core_actor.cpp_CDemonActor_processInEditor_FUN_0040d040(CDemonActor * this_ptr)
        ;   XREF to: 0040d040 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004ccc66
    JMP 0x004ccc3c                      ; 004ccc69 | LAB_004ccc3c
