...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_flies.cpp_FUN_004cc820()
;
; Local Variables:
...
;
; XREF[2]:
;   core_flies.cpp_FUN_004cbf00 at 004cc1fd
;   core_flies.cpp_FUN_004cc760 at 004cc797
;
; Called Functions:
...
section .text
    ...
    PUSH 0x0                            ; 004cc83a
    CALL core_actor.cpp_getRandomFloat_FUN_0040cc10 ; 004cc83c | float core_actor.cpp_getRandomFloat_FUN_0040cc10(float min_value, float max_value)
