...
// Address Range: [[004cc820, 004cca4e]]
// Convention: __cdecl
...

{
  ...
  out_point->z = fVar6;
#else
  fVar12 = nocturne_rng_fx_range(0.0,1.0);
  out_point->y = fVar12;
  out_point->y = out_point->y * out_point->y * (this_ptr->box_size).y;
  fVar12 = (this_ptr->box_size).x;
  fVar12 = nocturne_rng_fx_range(fVar12 * (float)-0.5,fVar12 * (float)0.5);
  out_point->x = fVar12;
  fVar12 = (this_ptr->box_size).z;
  fVar6 = nocturne_rng_fx_range(fVar12 * (float)-0.5,fVar12 * (float)0.5);
  out_point->z = fVar6;
#endif
