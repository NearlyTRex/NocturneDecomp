...

{
  ...
  if (iVar3 != 0) {
    ...
    if (g_UseExternalRenderer == 0) {
      ...
      SStack_a0.vertices[0].texture_u = 0x80 << 16;
      SStack_a0.vertices[0].texture_v = 0x80 << 16;
      SStack_a0.vertices[1].texture_u = 0x80 << 16;
      SStack_a0.vertices[1].texture_v = 0x80 << 16;
      SStack_a0.vertices[2].texture_u = 0x80 << 16;
      SStack_a0.vertices[2].texture_v = 0x80 << 16;
