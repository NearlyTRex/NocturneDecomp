...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_flies.cpp_FUN_004cc230()
;
; Local Variables:
; undefined4       Stack[-0x14]:4  local_14
;
; XREF[2]:
;   core_flies.cpp_FUN_004cc2c0 at 004cc2e9
;   core_flies.cpp_FUN_004cc300 at 004cc6e6
;
; Referenced Globals:
...
section .text
    ...
    MOV ECX,dword ptr [EAX + 0x2cf7d5c] ; 004cc242 | uint *[1024] g_ZBufferScanlineArray
    SHL EDX,0x2                         ; 004cc248
    MOV EBX,dword ptr [EBP + 0x1c]      ; 004cc24b
    CMP EBX,dword ptr [ECX + EDX*0x1]   ; 004cc24e
    JBE 0x004cc25c                      ; 004cc251 | LAB_004cc25c
        ;   XREF to: 004cc25c (CONDITIONAL_JUMP)
    CMP dword ptr [0x0067939c],0x20     ; 004cc253 | int g_BitsPerPixel
    JZ 0x004cc263                       ; 004cc25a | LAB_004cc263
    ...
    POP EBX                             ; 004cc261
    RET                                 ; 004cc262
    MOV EAX,dword ptr [EAX + 0x2cf6a9c] ; 004cc263 | void *[1024] g_ScreenBufferArray
        ;   Label: LAB_004cc263
    ADD EAX,EDX                         ; 004cc269
    MOV dword ptr [EBP + -0x4],EAX      ; 004cc26b
    MOV EDI,dword ptr [EBP + 0xfffffffc] ; 004cc26e
    MOVD MM0,dword ptr [0x02d02570]     ; 004cc274 | int g_ActiveRenderColor
    PXOR MM7,MM7                        ; 004cc27b
    MOVD MM1,dword ptr [EDI]            ; 004cc27e
    MOVD MM2,dword ptr [0x02d7a800]     ; 004cc281 | undefined4 DAT_02d7a800
    MOVD MM3,dword ptr [0x02d7a804]     ; 004cc288 | undefined4 DAT_02d7a804
