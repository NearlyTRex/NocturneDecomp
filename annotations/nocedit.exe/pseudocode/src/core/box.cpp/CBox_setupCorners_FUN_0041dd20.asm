...
section .text
    ...
    JZ 0x0041dd44                       ; 0041dd30
        ;   XREF to: 0041dd44 (CONDITIONAL_JUMP)  ; LAB_0041dd44
    PUSH EBX                            ; 0041dd32
    ...
    FLD float ptr [EAX + 0xa4]          ; 0041dd44
        ;   Label: LAB_0041dd44
    FMUL double ptr [0x0061646f]        ; 0041dd4a | g_BoxHalfExtentMultiplier
    FLD float ptr [EAX + 0xac]          ; 0041dd50
    FMUL double ptr [0x0061646f]        ; 0041dd56 | g_BoxHalfExtentMultiplier
    FLD float ptr [EAX + 0xac]          ; 0041dd5c
    FMUL double ptr [0x0061646f]        ; 0041dd62 | g_BoxHalfExtentMultiplier
    FLD float ptr [EAX + 0xa4]          ; 0041dd68
    FMUL double ptr [0x0061646f]        ; 0041dd6e | g_BoxHalfExtentMultiplier
    FLD float ptr [EAX + 0xa4]          ; 0041dd74
    FMUL double ptr [0x0061646f]        ; 0041dd7a | g_BoxHalfExtentMultiplier
    FLD float ptr [EAX + 0xa8]          ; 0041dd80
    FMUL double ptr [0x0061646f]        ; 0041dd86 | g_BoxHalfExtentMultiplier
    FLD float ptr [EAX + 0xa8]          ; 0041dd8c
    FCHS                                ; 0041dd92
    MOV dword ptr [EAX + 0xb0],0x8      ; 0041dd94
    FMUL double ptr [0x0061646f]        ; 0041dd9e | g_BoxHalfExtentMultiplier
    FXCH ST6                            ; 0041dda4
    FSTP float ptr [EAX + 0xb4]         ; 0041dda6
    FLD float ptr [EAX + 0xac]          ; 0041ddac
    FMUL double ptr [0x0061646f]        ; 0041ddb2 | g_BoxHalfExtentMultiplier
    FXCH ST6                            ; 0041ddb8
    FSTP float ptr [EAX + 0xb8]         ; 0041ddba
    FLD float ptr [EAX + 0xa4]          ; 0041ddc0
    FCHS                                ; 0041ddc6
    FMUL double ptr [0x0061646f]        ; 0041ddc8 | g_BoxHalfExtentMultiplier
    FXCH ST5                            ; 0041ddce
    FSTP float ptr [EAX + 0xbc]         ; 0041ddd0
    FLD float ptr [EAX + 0xa8]          ; 0041ddd6
    FCHS                                ; 0041dddc
    FMUL double ptr [0x0061646f]        ; 0041ddde | g_BoxHalfExtentMultiplier
    FXCH ST5                            ; 0041dde4
    FSTP float ptr [EAX + 0xe8]         ; 0041dde6
    FLD float ptr [EAX + 0xa8]          ; 0041ddec
    FMUL double ptr [0x0061646f]        ; 0041ddf2 | g_BoxHalfExtentMultiplier
    FXCH ST5                            ; 0041ddf8
    FSTP float ptr [EAX + 0xec]         ; 0041ddfa
    FLD float ptr [EAX + 0xa4]          ; 0041de00
    FCHS                                ; 0041de06
    FMUL double ptr [0x0061646f]        ; 0041de08 | g_BoxHalfExtentMultiplier
    FXCH ST4                            ; 0041de0e
    FSTP float ptr [EAX + 0xf0]         ; 0041de10
    FLD float ptr [EAX + 0xa8]          ; 0041de16
    FCHS                                ; 0041de1c
    FMUL double ptr [0x0061646f]        ; 0041de1e | g_BoxHalfExtentMultiplier
    FXCH ST4                            ; 0041de24
    FSTP float ptr [EAX + 0x11c]        ; 0041de26
    FLD float ptr [EAX + 0xac]          ; 0041de2c
    FCHS                                ; 0041de32
    FMUL double ptr [0x0061646f]        ; 0041de34 | g_BoxHalfExtentMultiplier
    FXCH ST4                            ; 0041de3a
    FSTP float ptr [EAX + 0x120]        ; 0041de3c
    FLD float ptr [EAX + 0xa8]          ; 0041de42
    FCHS                                ; 0041de48
    FMUL double ptr [0x0061646f]        ; 0041de4a | g_BoxHalfExtentMultiplier
    FXCH ST3                            ; 0041de50
    FSTP float ptr [EAX + 0x150]        ; 0041de52
    FLD float ptr [EAX + 0xac]          ; 0041de58
    FCHS                                ; 0041de5e
    FMUL double ptr [0x0061646f]        ; 0041de60 | g_BoxHalfExtentMultiplier
    FXCH ST2                            ; 0041de66
    FSTP float ptr [EAX + 0x184]        ; 0041de68
    FLD float ptr [EAX + 0xac]          ; 0041de6e
    FMUL double ptr [0x0061646f]        ; 0041de74 | g_BoxHalfExtentMultiplier
    FXCH                                ; 0041de7a
    FSTP float ptr [EAX + 0x188]        ; 0041de7c
    FLD float ptr [EAX + 0xa8]          ; 0041de82
    FMUL double ptr [0x0061646f]        ; 0041de88 | g_BoxHalfExtentMultiplier
    FXCH ST6                            ; 0041de8e
    FSTP float ptr [EAX + 0x18c]        ; 0041de90
    FLD float ptr [EAX + 0xa4]          ; 0041de96
    FCHS                                ; 0041de9c
    FMUL double ptr [0x0061646f]        ; 0041de9e | g_BoxHalfExtentMultiplier
    FXCH ST5                            ; 0041dea4
    FSTP float ptr [EAX + 0x1bc]        ; 0041dea6
    FLD float ptr [EAX + 0xa4]          ; 0041deac
    FCHS                                ; 0041deb2
    FMUL double ptr [0x0061646f]        ; 0041deb4 | g_BoxHalfExtentMultiplier
    FXCH                                ; 0041deba
    FSTP float ptr [EAX + 0x1c0]        ; 0041debc
    FLD float ptr [EAX + 0xac]          ; 0041dec2
    FCHS                                ; 0041dec8
    FMUL double ptr [0x0061646f]        ; 0041deca | g_BoxHalfExtentMultiplier
    FXCH ST6                            ; 0041ded0
    ...
    FLD double ptr [0x0061646f]         ; 0041df02 | g_BoxHalfExtentMultiplier
    ...
    CALL core_box.cpp_CBox_updateTransform_FUN_0041e0e0 ; 0041df45
