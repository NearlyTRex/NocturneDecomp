...
;                               FUNCTION
; *****************************************************************************
; __cdecl CVector3f * core_box.cpp_CBoundingBox3D_clampPoint_FUN_00421550(CBoundingBox3D * this_ptr, CVector3f * out_point, CVector3f * in_point)
;
; Parameters:
...
;   core_boxactor.cpp_FUN_00422590 at 004225dc
;   core_enemy.cpp_FUN_004a9a50 at 004a9abb
;   core_platfrm.cpp_FUN_0054cc30 at 0054d289
;
; *****************************************************************************
...
section .text
    ...
    FNSTSW AX                           ; 0042157a
    SAHF                                ; 0042157c
    JC 0x004215d1                       ; 0042157d | LAB_004215d1
    ...
    FNSTSW AX                           ; 00421584
    SAHF                                ; 00421586
    JBE 0x0042158e                      ; 00421587 | LAB_0042158e
    ...
    FNSTSW AX                           ; 00421594
    SAHF                                ; 00421596
    JNC 0x0042159f                      ; 00421597 | LAB_0042159f
    ...
    FNSTSW AX                           ; 004215a5
    SAHF                                ; 004215a7
    JBE 0x004215b0                      ; 004215a8 | LAB_004215b0
    ...
    FNSTSW AX                           ; 004215b6
    SAHF                                ; 004215b8
    JNC 0x004215c1                      ; 004215b9 | LAB_004215c1
    ...
    FNSTSW AX                           ; 004215c7
    SAHF                                ; 004215c9
    JA 0x004215d7                       ; 004215ca | LAB_004215d7
    ...
    JMP 0x0042157f                      ; 004215d5 | LAB_0042157f
