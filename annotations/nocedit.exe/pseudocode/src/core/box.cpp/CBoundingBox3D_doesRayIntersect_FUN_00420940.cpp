...

{
  ...
  if (ray_origin->x < (this_ptr->min).x) {
    local_30 = (this_ptr->min).x - ray_origin->x;
    if (ray_direction->x < local_30) {
      return -1.0;
    }
    local_30 = local_30 / ray_direction->x;
    local_3c = -1.0;
LAB_00420997:
    bVar3 = false;
  }
    ...
    if ((this_ptr->max).x < ray_origin->x) {
      local_30 = (this_ptr->max).x - ray_origin->x;
      if (local_30 < ray_direction->x) {
        return -1.0;
      }
      local_30 = local_30 / ray_direction->x;
      local_3c = 1.0;
  ...
  if ((this_ptr->min).y <= ray_origin->y) {
    ...
    local_2c = (this_ptr->max).y - ray_origin->y;
    if (local_2c < ray_direction->y) {
      return -1.0;
    }
    local_2c = local_2c / ray_direction->y;
    local_40 = 1.0;
  }
  else {
    local_2c = (this_ptr->min).y - ray_origin->y;
    if (ray_direction->y < local_2c) {
      return -1.0;
    }
    local_2c = local_2c / ray_direction->y;
    local_40 = -1.0;
...
LAB_004209dc:
  if ((this_ptr->min).z <= ray_origin->z) {
    if ((this_ptr->max).z < ray_origin->z) {
      local_34 = (this_ptr->max).z - ray_origin->z;
      if (local_34 < ray_direction->z) {
        return -1.0;
      }
      local_34 = local_34 / ray_direction->z;
      local_1c = 1.0;
    }
    else {
      local_34 = -1.0;
    ...
    local_34 = (this_ptr->min).z - ray_origin->z;
    if (ray_direction->z < local_34) {
      return -1.0;
    }
    local_34 = local_34 / ray_direction->z;
    local_1c = -1.0;
  ...
  bVar3 = local_30 < local_2c;
  if (local_34 <= local_28) {
    if (!bVar3) {
      fVar1 = ray_direction->y * local_28 + ray_origin->y;
      ...
      fVar1 = ray_direction->z * local_28 + ray_origin->z;
      ...
      if (fVar1 <= (this_ptr->max).z) {
        ...
        out_normal->y = 0.0;
        out_normal->z = 0.0;
        out_normal->x = local_3c;
        return local_28;
      }
      return -1.0;
    }
    if (bVar3 < 2) {
      fVar1 = ray_direction->x * local_28 + ray_origin->x;
  ...
  if (((((this_ptr->min).x <= fVar1) && (fVar1 <= (this_ptr->max).x)) &&
      (fVar1 = ray_direction->y * local_28 + ray_origin->y, (this_ptr->min).y <= fVar1)) &&
     (fVar1 <= (this_ptr->max).y)) {
    if (out_normal != (CVector3f *)0x0) {
      out_normal->y = 0.0;
      out_normal->x = 0.0;
      out_normal->z = local_1c;
    }
    return local_28;
  }
  return -1.0;
