...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_box_cpp_CBoundingBox3D_isInverted_FUN_00420fe0(CBoundingBox3D *this_ptr)
;
; Parameters:
