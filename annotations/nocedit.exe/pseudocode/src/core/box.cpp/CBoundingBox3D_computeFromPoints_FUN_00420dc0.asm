...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_box.cpp_CBoundingBox3D_computeFromPoints_FUN_00420dc0(CBoundingBox3D * this_ptr, int point_count, CVector3f * points)
;
; Parameters:
...
section .text
    ...
    JNZ 0x00420e44                      ; 00420dd6 | LAB_00420e44
        ;   XREF to: 00420e44 (CONDITIONAL_JUMP)
    CMP EDX,EBX                         ; 00420ddc
        ;   Label: LAB_00420ddc
    JZ 0x00420df0                       ; 00420dde | LAB_00420df0
    ...
    JLE 0x00420e40                      ; 00420df7 | LAB_00420e40
    ...
    FNSTSW AX                           ; 00420e1c
    SAHF                                ; 00420e1e
    JNC 0x00420e5c                      ; 00420e1f | LAB_00420e5c
    ...
    FNSTSW AX                           ; 00420e2d
    SAHF                                ; 00420e2f
    JNC 0x00420e6f                      ; 00420e30 | LAB_00420e6f
    ...
    JL 0x00420dfc                       ; 00420e3e | LAB_00420dfc
    ...
    FNSTSW AX                           ; 00420e75
    SAHF                                ; 00420e77
    JBE 0x00420e38                      ; 00420e78 | LAB_00420e38
    ...
    JL 0x00420dfc                       ; 00420e86 | LAB_00420dfc
        ;   XREF to: 00420dfc (CONDITIONAL_JUMP)
    POP EDI                             ; 00420e8c
    POP ESI                             ; 00420e8d
    POP EBX                             ; 00420e8e
