...
section .text
    ...
    PUSH EDI                            ; 0042002f
    PUSH 0x61656d                       ; 00420030 | = "%sboxVersion\n" | s_sboxVersion_0061656d = %sboxVersion

    PUSH ESI                            ; 00420035
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00420036 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    PUSH ESI                            ; 00420046
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00420047 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0042004c
    PUSH EDI                            ; 0042004f
    PUSH 0x616581                       ; 00420050 | = "%sboxStateInfo\n" | s_sboxStateInfo_00616581 = %sboxStateInfo

    PUSH ESI                            ; 00420055
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00420056 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDI                            ; 00420078
    PUSH 0x616591                       ; 00420079 | = "%s%f,%f,%f\n" | s_s_f_f_f_00616591 = %s%f,%f,%f

    PUSH ESI                            ; 0042007e
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0042007f | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDI                            ; 004200a2
    PUSH 0x61659d                       ; 004200a3 | = "%s%f,%f,%f\n" | s_s_f_f_f_0061659d = %s%f,%f,%f

    PUSH ESI                            ; 004200a8
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 004200a9 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDI                            ; 004200d5
    PUSH 0x6165a9                       ; 004200d6 | = "%s%f,%f,%f\n" | s_s_f_f_f_006165a9 = %s%f,%f,%f

    PUSH ESI                            ; 004200db
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 004200dc | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    FLD float ptr [EBX + 0x94]          ; 004200e1
    ADD ESP,0x24                        ; 004200e7
    FMUL double ptr [0x006165df]        ; 004200ea | double DOUBLE_006165df
    ...
    PUSH ESI                            ; 004200fc
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 004200fd | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDI                            ; 00420120
    PUSH 0x6165bb                       ; 00420121 | = "%s%f,%f,%f\n" | s_s_f_f_f_006165bb = %s%f,%f,%f

    PUSH ESI                            ; 00420126
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00420127 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDI                            ; 0042014a
    PUSH 0x6165c7                       ; 0042014b | = "%s%f,%f,%f\n" | s_s_f_f_f_006165c7 = %s%f,%f,%f

    PUSH ESI                            ; 00420150
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00420151 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 00420166
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00420167 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
