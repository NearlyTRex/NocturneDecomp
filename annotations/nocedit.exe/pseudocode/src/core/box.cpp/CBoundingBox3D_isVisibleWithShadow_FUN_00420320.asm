...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_box.cpp_CBoundingBox3D_isVisibleWithShadow_FUN_00420320(CBoundingBox3D * this_ptr)
;
; Parameters:
...
section .text
    ...
    CMP dword ptr [0x020a5740],0x0      ; 00420324 | CDemonLight * g_CurrentShadowLight
    JZ 0x004204ad                       ; 0042032b | LAB_004204ad
        ;   XREF to: 004204ad (CONDITIONAL_JUMP)
    PUSH EDI                            ; 00420331
    PUSH ESI                            ; 00420332
    PUSH EBX                            ; 00420333
    MOV EDX,dword ptr [0x006703ec]      ; 00420334 | CDemonRenderer * g_CDemonRendererPtr
    MOV EAX,[0x02d02550]                ; 0042033a | int g_ViewportRightFixed
    MOV ECX,dword ptr [0x02d02548]      ; 0042033f | int g_ViewportCenterXFixed
    MOV EDI,dword ptr [0x02d02550]      ; 00420345 | int g_ViewportRightFixed
    MOV ESI,dword ptr [0x02d0254c]      ; 0042034b | int g_ViewportCenterYFixed
    MOV EBP,dword ptr [0x02d02554]      ; 00420351 | int g_ViewportBottomFixed
    MOV EDX,dword ptr [EDX]             ; 00420357 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,ECX                         ; 00420359
    SUB EDI,ECX                         ; 0042035b
    MOV dword ptr [ESP + 0x20],EAX      ; 0042035d
    MOV EAX,[0x02d02554]                ; 00420361 | int g_ViewportBottomFixed
    ...
    JGE 0x004203f2                      ; 004203c6 | LAB_004203f2
        ;   XREF to: 004203f2 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [ECX + 0x8]       ; 004203c8
    CMP EDX,EBX                         ; 004203cb
    JGE 0x004203f2                      ; 004203cd | LAB_004203f2
        ;   XREF to: 004203f2 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x02d0254c]      ; 004203cf | int g_ViewportCenterYFixed
    MOV EAX,dword ptr [ECX + 0x4]       ; 004203d5
    IMUL EDX                            ; 004203d8
    IDIV EBX                            ; 004203da
    ADD EAX,dword ptr [0x02d02554]      ; 004203dc | int g_ViewportBottomFixed
    CMP EAX,EBP                         ; 004203e2
    JLE 0x004203e8                      ; 004203e4 | LAB_004203e8
        ;   XREF to: 004203e8 (CONDITIONAL_JUMP)
    MOV EBP,EAX                         ; 004203e6
    CMP EAX,dword ptr [ESP + 0x24]      ; 004203e8
        ;   Label: LAB_004203e8
    JGE 0x004203f2                      ; 004203ec | LAB_004203f2
        ;   XREF to: 004203f2 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x24],EAX      ; 004203ee
    MOV EDX,dword ptr [ECX + 0x8]       ; 004203f2
        ;   Label: LAB_004203f2
    CMP EDX,dword ptr [ECX]             ; 004203f5
    JG 0x00420407                       ; 004203f7 | LAB_00420407
        ;   XREF to: 00420407 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [0x02d02550]      ; 004203f9 | int g_ViewportRightFixed
    MOV EDI,dword ptr [0x02d02548]      ; 004203ff | int g_ViewportCenterXFixed
    ...
    JL 0x00420423                       ; 00420410 | LAB_00420423
        ;   XREF to: 00420423 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [0x02d02548]      ; 00420412 | int g_ViewportCenterXFixed
    MOV EAX,[0x02d02550]                ; 00420418 | int g_ViewportRightFixed
    ...
    JG 0x0042043c                       ; 00420429 | LAB_0042043c
        ;   XREF to: 0042043c (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [0x02d02554]      ; 0042042b | int g_ViewportBottomFixed
    MOV EAX,[0x02d0254c]                ; 00420431 | int g_ViewportCenterYFixed
    ...
    JL 0x00420456                       ; 00420446 | LAB_00420456
        ;   XREF to: 00420456 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x02d0254c]      ; 00420448 | int g_ViewportCenterYFixed
    MOV EBP,dword ptr [0x02d02554]      ; 0042044e | int g_ViewportBottomFixed
    SUB EBP,ECX                         ; 00420454
    MOV EBX,dword ptr [ESP + 0x1c]      ; 00420456
        ;   Label: LAB_00420456
    ADD ESI,0x30                        ; 0042045a
    CMP ESI,EBX                         ; 0042045d
    JNZ 0x0042037a                      ; 0042045f | LAB_0042037a
        ;   XREF to: 0042037a (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [ESP + 0x20]      ; 00420465
    MOV EAX,dword ptr [ESP + 0x24]      ; 00420469
    MOV EDX,dword ptr [0x020a5740]      ; 0042046d | CDemonLight * g_CurrentShadowLight
    ...
    CALL core_dlight.cpp_CDemonLight_testShadowMapRegion_FUN_00476000 ; 0042049d | int core_dlight.cpp_CDemonLight_testShadowMapRegion_FUN_00476000(CDemonLight * this_ptr, CRect * rect)
    ...
    JLE 0x004204c6                      ; 004204c0 | LAB_004204c6
    ...
    JGE 0x004204cf                      ; 004204cb | LAB_004204cf
    ...
    JLE 0x004204de                      ; 004204d8 | LAB_004204de
    ...
    JGE 0x00420456                      ; 004204e3 | LAB_00420456
        ;   XREF to: 00420456 (CONDITIONAL_JUMP)
    MOV EBP,EBX                         ; 004204e9
    JMP 0x00420456                      ; 004204eb | LAB_00420456
