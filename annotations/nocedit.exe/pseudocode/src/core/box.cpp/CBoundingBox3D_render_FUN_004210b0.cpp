...

{
  ...
  if (pvVar2 == (void *)0x0) {
    ...
    g_CDemonRendererPtr2->vertex_buffer_ptr->z = 0x7fff;
    pCVar1->vertex_buffer_ptr->r = 0;
    pCVar1->vertex_buffer_ptr->g = 0;
    pCVar1->vertex_buffer_ptr[1].z = 0;
    pCVar1->vertex_buffer_ptr[1].r = 0x7fff;
    pCVar1->vertex_buffer_ptr[1].g = 0;
    pCVar1->vertex_buffer_ptr[2].z = 0;
    pCVar1->vertex_buffer_ptr[2].r = 0;
    pCVar1->vertex_buffer_ptr[2].g = 0x7fff;
    pCVar1->vertex_buffer_ptr[3].z = 0x7fff;
    pCVar1->vertex_buffer_ptr[3].r = 0x7fff;
    pCVar1->vertex_buffer_ptr[3].g = 0;
    pCVar1->vertex_buffer_ptr[4].z = 0;
    pCVar1->vertex_buffer_ptr[4].r = 0x7fff;
    pCVar1->vertex_buffer_ptr[4].g = 0x7fff;
    pCVar1->vertex_buffer_ptr[5].z = 0x7fff;
    pCVar1->vertex_buffer_ptr[5].r = 0;
    pCVar1->vertex_buffer_ptr[5].g = 0x7fff;
    pCVar1->vertex_buffer_ptr[6].z = 0x7fff;
    pCVar1->vertex_buffer_ptr[6].r = 0x7fff;
    pCVar1->vertex_buffer_ptr[6].g = 0x7fff;
    pCVar1->vertex_buffer_ptr[7].z = 0;
