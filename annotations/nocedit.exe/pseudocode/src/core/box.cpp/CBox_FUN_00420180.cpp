// Name: core_box.cpp_CBox_FUN_00420180
// Address: 00420180
// Address Range: [[00420180, 004201fe]]
// Convention: __cdecl
// Signature: void core_box.cpp_CBox_FUN_00420180(CBox * this_ptr)
// Cross-references:
...
void __cdecl core_box_cpp_CBox_FUN_00420180(CBox *this_ptr)

{
  ...
  if (in_stack_00000008 != (float *)0x0) {
    if (&this_ptr->linear_velocity != (CVector3f *)in_stack_00000008) {
      (this_ptr->linear_velocity).x = *in_stack_00000008;
      (this_ptr->linear_velocity).y = in_stack_00000008[1];
      (this_ptr->linear_velocity).z = in_stack_00000008[2];
    }
    ...
    if (&this_ptr->external_force != pCVar1) {
      (this_ptr->external_force).x = pCVar1->x;
      (this_ptr->external_force).y = pCVar1->y;
      (this_ptr->external_force).z = pCVar1->z;
    }
  }
  if ((in_stack_0000000c != (float *)0x0) &&
     (&this_ptr->angular_velocity != (CVector3f *)in_stack_0000000c)) {
    (this_ptr->angular_velocity).x = *in_stack_0000000c;
    (this_ptr->angular_velocity).y = in_stack_0000000c[1];
    (this_ptr->angular_velocity).z = in_stack_0000000c[2];
    return;
  }
  return;
}
...
// Assembly code:
// 00420180: PUSH EBX
//   Label: core_box.cpp_CBox_FUN_00420180
// 00420181: PUSH ESI
