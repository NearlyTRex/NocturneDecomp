...
section .text
    ...
    PUSH 0x65b140                       ; 00420220 | WatcomTypeInfo g_SScrapeTypeInfo
        ;   Label: core_box.cpp_freeScrapes_FUN_00420220
    PUSH 0x8                            ; 00420225
    MOV EDX,dword ptr [ESP + 0xc]       ; 00420227
    PUSH EDX                            ; 0042022b
    CALL crt_memory.c_freeTypeArray_FUN_005feee9 ; 0042022c | int crt_memory.c_freeTypeArray_FUN_005feee9(void * * obj_array, int obj_count, WatcomTypeInfo * type_info)
