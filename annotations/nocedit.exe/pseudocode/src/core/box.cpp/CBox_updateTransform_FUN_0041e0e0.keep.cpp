...

{
  ...
  if (this_ptr != (CBox *)new_position) {
    this_ptr->position = *new_position;
  }
  if (&this_ptr->orientation != new_orientation) {
    this_ptr->orientation = *new_orientation;
  }
  ...
  (this_ptr->linear_velocity_local).x = 0.0;
  (this_ptr->linear_velocity_local).y = 0.0;
  ...
  (this_ptr->linear_velocity_temp).x = 0.0;
  (this_ptr->linear_velocity_temp).y = 0.0;
  (this_ptr->linear_velocity_temp).z = 0.0;
  (this_ptr->angular_velocity_temp).x = 0.0;
  (this_ptr->angular_velocity_temp).y = 0.0;
  (this_ptr->angular_velocity_temp).z = 0.0;
  (this_ptr->linear_velocity).x = 0.0;
  (this_ptr->linear_velocity).y = 0.0;
