...
section .text
    ...
    FNSTSW AX                           ; 00420983
    SAHF                                ; 00420985
    JC 0x00420ae0                       ; 00420986 | LAB_00420ae0
    ...
    FNSTSW AX                           ; 004209a7
    SAHF                                ; 004209a9
    JNC 0x00420b00                      ; 004209aa | LAB_00420b00
    ...
    FNSTSW AX                           ; 004209bd
    SAHF                                ; 004209bf
    JA 0x00420ae0                       ; 004209c0 | LAB_00420ae0
        ;   XREF to: 00420ae0 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 004209e2
    SAHF                                ; 004209e4
    JNC 0x00420b3b                      ; 004209e5 | LAB_00420b3b
    ...
    FNSTSW AX                           ; 004209f8
    SAHF                                ; 004209fa
    JA 0x00420ae0                       ; 004209fb | LAB_00420ae0
        ;   XREF to: 00420ae0 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 00420a26
    SAHF                                ; 00420a28
    JBE 0x00420a38                      ; 00420a29 | LAB_00420a38
    ...
    FNSTSW AX                           ; 00420a40
    SAHF                                ; 00420a42
    JBE 0x00420d28                      ; 00420a43 | LAB_00420d28
    ...
    FNSTSW AX                           ; 00420a5f
    SAHF                                ; 00420a61
    JC 0x00420ae0                       ; 00420a62 | LAB_00420ae0
        ;   XREF to: 00420ae0 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x44]          ; 00420a68
    FCOMP float ptr [ECX + 0xc]         ; 00420a6c
    FNSTSW AX                           ; 00420a6f
    SAHF                                ; 00420a71
    JA 0x00420ae0                       ; 00420a72 | LAB_00420ae0
        ;   XREF to: 00420ae0 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 00420a85
    SAHF                                ; 00420a87
    JC 0x00420ae0                       ; 00420a88 | LAB_00420ae0
        ;   XREF to: 00420ae0 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x24]          ; 00420a8a
    FCOMP float ptr [ECX + 0x10]        ; 00420a8e
    FNSTSW AX                           ; 00420a91
    SAHF                                ; 00420a93
    JA 0x00420ae0                       ; 00420a94 | LAB_00420ae0
        ;   XREF to: 00420ae0 (CONDITIONAL_JUMP)
    TEST EDX,EDX                        ; 00420a96
    JZ 0x00420aae                       ; 00420a98 | LAB_00420aae
    ...
    MOV dword ptr [ESP + 0x2c],0xbf800000 ; 00420af3
        ;   Label: LAB_00420af3
    JMP 0x004209a1                      ; 00420afb | LAB_004209a1
    ...
    FNSTSW AX                           ; 00420b06
    SAHF                                ; 00420b08
    JBE 0x00420b2e                      ; 00420b09 | LAB_00420b2e
    ...
    FNSTSW AX                           ; 00420b41
    SAHF                                ; 00420b43
    JBE 0x00420b6c                      ; 00420b44 | LAB_00420b6c
    ...
    JNZ 0x00420bf4                      ; 00420ba0 | LAB_00420bf4
    ...
    FNSTSW AX                           ; 00420bbd
    SAHF                                ; 00420bbf
    JNC 0x00420c0a                      ; 00420bc0 | LAB_00420c0a
    ...
    JMP 0x00420ba2                      ; 00420c08 | LAB_00420ba2
    ...
    FNSTSW AX                           ; 00420c3e
    SAHF                                ; 00420c40
    JC 0x00420ae0                       ; 00420c41 | LAB_00420ae0
        ;   XREF to: 00420ae0 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x18]          ; 00420c47
    FCOMP float ptr [ECX + 0x10]        ; 00420c4b
    FNSTSW AX                           ; 00420c4e
    SAHF                                ; 00420c50
    JA 0x00420ae0                       ; 00420c51 | LAB_00420ae0
        ;   XREF to: 00420ae0 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 00420c68
    SAHF                                ; 00420c6a
    JC 0x00420ae0                       ; 00420c6b | LAB_00420ae0
        ;   XREF to: 00420ae0 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x14]          ; 00420c71
    FCOMP float ptr [ECX + 0x14]        ; 00420c75
    FNSTSW AX                           ; 00420c78
    SAHF                                ; 00420c7a
    JA 0x00420ae0                       ; 00420c7b | LAB_00420ae0
        ;   XREF to: 00420ae0 (CONDITIONAL_JUMP)
    TEST EDX,EDX                        ; 00420c81
    JZ 0x00420aae                       ; 00420c83 | LAB_00420aae
        ;   XREF to: 00420aae (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 00420cb6
    SAHF                                ; 00420cb8
    JC 0x00420ae0                       ; 00420cb9 | LAB_00420ae0
        ;   XREF to: 00420ae0 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x3c]          ; 00420cbf
    FCOMP float ptr [ECX + 0xc]         ; 00420cc3
    FNSTSW AX                           ; 00420cc6
    SAHF                                ; 00420cc8
    JA 0x00420ae0                       ; 00420cc9 | LAB_00420ae0
        ;   XREF to: 00420ae0 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 00420ce0
    SAHF                                ; 00420ce2
    JC 0x00420ae0                       ; 00420ce3 | LAB_00420ae0
        ;   XREF to: 00420ae0 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x10]          ; 00420ce9
    FCOMP float ptr [ECX + 0x14]        ; 00420ced
    FNSTSW AX                           ; 00420cf0
    SAHF                                ; 00420cf2
    JA 0x00420ae0                       ; 00420cf3 | LAB_00420ae0
        ;   XREF to: 00420ae0 (CONDITIONAL_JUMP)
    TEST EDX,EDX                        ; 00420cf9
    JZ 0x00420aae                       ; 00420cfb | LAB_00420aae
        ;   XREF to: 00420aae (CONDITIONAL_JUMP)
    ...
    CMP EDI,0x1                         ; 00420d28
        ;   Label: LAB_00420d28
    JNC 0x00420d48                      ; 00420d2b | LAB_00420d48
        ;   XREF to: 00420d48 (CONDITIONAL_JUMP)
    TEST EDI,EDI                        ; 00420d2d
    JZ 0x00420c2d                       ; 00420d2f | LAB_00420c2d
    ...
    POP EBX                             ; 00420d46
    RET                                 ; 00420d47
    JBE 0x00420ca8                      ; 00420d48 | LAB_00420ca8
        ;   Label: LAB_00420d48
        ;   XREF to: 00420ca8 (CONDITIONAL_JUMP)
    CMP EDI,0x2                         ; 00420d4e
    JZ 0x00420a51                       ; 00420d51 | LAB_00420a51
