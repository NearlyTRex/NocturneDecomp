...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_box.cpp_CBoundingBox3D_isVisible_FUN_004204f0(CBoundingBox3D * this_ptr)
;
; Parameters:
...
;   core_ammobox.cpp_CAmmoBox_FUN_00411820 at 00411847
;   core_anvil.cpp_CAnvil_FUN_00411ec0 at 00411f15
;   core_backgnd.cpp_CBackgroundActor_FUN_00412860 at 00412899
;   core_backgnd.cpp_CBackgroundActor_FUN_004128d0 at 00412907
;   core_baron.cpp_CBaron_renderTransparent_FUN_00413ae0 at 00413bf3
;   core_barrier.cpp_CBarrier_FUN_00414240 at 0041428d
;   core_bat.cpp_CBat_FUN_00414bf0 at 00414c13
;   core_batman.cpp_CBatman_renderOpaque_FUN_004173b0 at 00417433
;   core_battery.cpp_FUN_00417f80 at 00417fc2
;   ... and 69 more
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004204f9
    CALL core_box.cpp_CBoundingBox3D_isVisibleWithCamera_FUN_00420680 ; 004204fa | int core_box.cpp_CBoundingBox3D_isVisibleWithCamera_FUN_00420680(CBoundingBox3D * this_ptr)
        ;   XREF to: 00420680 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004204ff
    TEST EAX,EAX                        ; 00420502
    JNZ 0x0042050c                      ; 00420504 | LAB_0042050c
        ;   XREF to: 0042050c (CONDITIONAL_JUMP)
    ADD ESP,0x6c                        ; 00420506
    POP ESI                             ; 00420509
    POP EBX                             ; 0042050a
    RET                                 ; 0042050b
    MOV EDX,dword ptr [0x006703ec]      ; 0042050c | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
        ;   Label: LAB_0042050c
    PUSH EDX                            ; 00420512 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_getFaceCount_FUN_0048cae0 ; 00420513 | int engine_drender.cpp_CDemonRenderer_getFaceCount_FUN_0048cae0(CDemonRenderer * this_ptr)
        ;   XREF to: 0048cae0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00420518
    TEST EAX,EAX                        ; 0042051b
    JNZ 0x00420667                      ; 0042051d | LAB_00420667
    ...
    FXCH                                ; 00420534
    FLD float ptr [0x006165e7]          ; 00420536 | float FLOAT_006165e7
    FXCH                                ; 0042053c
    FMUL ST1                            ; 0042053e
    FXCH ST2                            ; 00420540
    ...
    JZ 0x0042058c                       ; 00420572 | LAB_0042058c
    ...
    MOV EAX,0x772a88                    ; 0042058c | int g_StoredX
        ;   Label: LAB_0042058c
    LEA EBX,[ESP + 0x54]                ; 00420591
    FILD dword ptr [EAX]                ; 00420595 | int g_StoredX
    FMUL float ptr [0x0065b168]         ; 00420597 | float FLOAT_0065b168
    FSTP float ptr [EBX]                ; 0042059d
    FILD dword ptr [EAX + 0x4]          ; 0042059f | int g_StoredY
    FMUL float ptr [0x0065b168]         ; 004205a2 | float FLOAT_0065b168
    FSTP float ptr [EBX + 0x4]          ; 004205a8
    FILD dword ptr [EAX + 0x8]          ; 004205ab | int g_StoredZ
    FMUL float ptr [0x0065b168]         ; 004205ae | float FLOAT_0065b168
    FSTP float ptr [EBX + 0x8]          ; 004205b4
    LEA EBX,[ESP + 0x30]                ; 004205b7
    LEA EAX,[ESP + 0x60]                ; 004205bb
    FLD float ptr [EAX]                 ; 004205bf
    FMUL float ptr [0x0065b160]         ; 004205c1 | float g_BoundingBoxWorldToIntegerScale
    FISTP dword ptr [EBX]               ; 004205c7
    FLD float ptr [EAX + 0x4]           ; 004205c9
    FMUL float ptr [0x0065b160]         ; 004205cc | float g_BoundingBoxWorldToIntegerScale
    FISTP dword ptr [EBX + 0x4]         ; 004205d2
    FLD float ptr [EAX + 0x8]           ; 004205d5
    FMUL float ptr [0x0065b160]         ; 004205d8 | float g_BoundingBoxWorldToIntegerScale
    FISTP dword ptr [EBX + 0x8]         ; 004205de
    LEA EAX,[ESP + 0x30]                ; 004205e1
    PUSH EAX                            ; 004205e5
    LEA EAX,[ESP + 0x4]                 ; 004205e6
    PUSH EAX                            ; 004205ea
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 004205eb | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004205f0
    MOV ECX,dword ptr [0x00823a74]      ; 004205f3 | CDemonCamera * g_CurrentSceneCamera
    ...
    JZ 0x00420656                       ; 00420629 | LAB_00420656
        ;   XREF to: 00420656 (CONDITIONAL_JUMP)
    MOV EAX,ESP                         ; 0042062b
    PUSH EAX                            ; 0042062d
    LEA EAX,[ESP + 0x58]                ; 0042062e
    PUSH EAX                            ; 00420632
    PUSH 0x32758e4                      ; 00420633 | CDemonCamera g_CDemonCameraInstance
    CALL core_dcamera.cpp_CDemonCamera_setupPerspectiveAndFog_FUN_004537d0 ; 00420638 | void core_dcamera.cpp_CDemonCamera_setupPerspectiveAndFog_FUN_004537d0(CDemonCamera * this_ptr, CVector3f * position, float max_distance)
        ;   XREF to: 004537d0 (UNCONDITIONAL_CALL)
    MOV ESI,dword ptr [0x02d051f4]      ; 0042063d | float g_PerspectiveReciprocal
    ADD ESP,0xc                         ; 00420643
    CMP ESI,0xfde8                      ; 00420646
    JLE 0x0042065c                      ; 0042064c | LAB_0042065c
    ...
    POP EBX                             ; 00420654
    RET                                 ; 00420655
    MOV dword ptr [0x02d051f4],ECX      ; 00420656 | float g_PerspectiveReciprocal
        ;   Label: LAB_00420656
    ...
    PUSH EBX                            ; 00420667
        ;   Label: LAB_00420667
    CALL core_box.cpp_CBoundingBox3D_isVisibleWithShadow_FUN_00420320 ; 00420668 | int core_box.cpp_CBoundingBox3D_isVisibleWithShadow_FUN_00420320(CBoundingBox3D * this_ptr)
        ;   XREF to: 00420320 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0042066d
    TEST EAX,EAX                        ; 00420670
    JNZ 0x0042065c                      ; 00420672 | LAB_0042065c
        ;   XREF to: 0042065c (CONDITIONAL_JUMP)
