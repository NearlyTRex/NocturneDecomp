...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_box.cpp_CBox_process_FUN_0041e2f0(CBox * this_ptr, float delta_time)
;
; Parameters:
...
section .text
    ...
    FCOMP double ptr [0x006164bf]       ; 0041e303 | double g_BoxMaxTimestep
    FNSTSW AX                           ; 0041e309
    SAHF                                ; 0041e30b
    JBE 0x0041e33a                      ; 0041e30c | LAB_0041e33a
        ;   XREF to: 0041e33a (CONDITIONAL_JUMP)
    FLD double ptr [ESP]                ; 0041e30e
    FMUL double ptr [0x006164c7]        ; 0041e311 | double g_BoxTimestepHalf
    FSTP float ptr [ESP + 0x8]          ; 0041e317
    PUSH dword ptr [ESP + 0x8]          ; 0041e31b
    PUSH EBX                            ; 0041e31f
    CALL core_box.cpp_CBox_process_FUN_0041e2f0 ; 0041e320 | void core_box.cpp_CBox_process_FUN_0041e2f0(CBox * this_ptr, float delta_time)
        ;   XREF to: 0041e2f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0041e325
    PUSH dword ptr [ESP + 0x8]          ; 0041e328
    PUSH EBX                            ; 0041e32c
    CALL core_box.cpp_CBox_process_FUN_0041e2f0 ; 0041e32d | void core_box.cpp_CBox_process_FUN_0041e2f0(CBox * this_ptr, float delta_time)
        ;   XREF to: 0041e2f0 (UNCONDITIONAL_CALL)
    ...
    PUSH dword ptr [EBP + 0x10]         ; 0041e33a
        ;   Label: LAB_0041e33a
    PUSH EBX                            ; 0041e33d
    CALL core_box.cpp_CBox_processPhysics_FUN_0041e350 ; 0041e33e | void core_box.cpp_CBox_processPhysics_FUN_0041e350(CBox * this_ptr, float delta_time)
