...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_box.cpp_CBoundingBox3D_isVisibleWithCamera_FUN_00420680(CBoundingBox3D * this_ptr)
;
; Parameters:
...
section .text
    ...
    CALL core_box.cpp_CBoundingBox3D_getCorner_FUN_004202b0 ; 004206a5 | CVector3f * core_box.cpp_CBoundingBox3D_getCorner_FUN_004202b0(CBoundingBox3D * this_ptr, CVector3f * out_point, uint corner_index)
        ;   XREF to: 004202b0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004206aa
    LEA EAX,[ESP + 0x60]                ; 004206ad
    MOV ECX,dword ptr [0x006703ec]      ; 004206b1 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    FLD float ptr [EAX]                 ; 004206b7
    FMUL float ptr [0x0065b160]         ; 004206b9 | float g_BoundingBoxWorldToIntegerScale
    FISTP dword ptr [EBX]               ; 004206bf
    FLD float ptr [EAX + 0x4]           ; 004206c1
    FMUL float ptr [0x0065b160]         ; 004206c4 | float g_BoundingBoxWorldToIntegerScale
    FISTP dword ptr [EBX + 0x4]         ; 004206ca
    FLD float ptr [EAX + 0x8]           ; 004206cd
    FMUL float ptr [0x0065b160]         ; 004206d0 | float g_BoundingBoxWorldToIntegerScale
    FISTP dword ptr [EBX + 0x8]         ; 004206d6
    LEA EAX,[ESP + 0x6c]                ; 004206d9
    PUSH EAX                            ; 004206dd
    MOV EAX,dword ptr [ECX]             ; 004206de | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,EDI                         ; 004206e0
    PUSH EAX                            ; 004206e2
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 004206e3 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    MOV EAX,[0x006703ec]                ; 004206e8 | CDemonRenderer * g_CDemonRendererPtr
    MOV EAX,dword ptr [EAX]             ; 004206ed | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,EDI                         ; 004206ef
    MOV DL,byte ptr [EAX + 0x13]        ; 004206f1
    ADD ESP,0x8                         ; 004206f4
    TEST DL,0x80                        ; 004206f7
    JZ 0x0042082b                       ; 004206fa | LAB_0042082b
    ...
    JL 0x00420693                       ; 0042070a | LAB_00420693
        ;   XREF to: 00420693 (CONDITIONAL_JUMP)
    TEST EBP,EBP                        ; 0042070c
    JNZ 0x00420832                      ; 0042070e | LAB_00420832
        ;   XREF to: 00420832 (CONDITIONAL_JUMP)
    XOR ESI,ESI                         ; 00420714
    XOR ECX,ECX                         ; 00420716
    MOV EAX,[0x006703ec]                ; 00420718 | CDemonRenderer * g_CDemonRendererPtr
        ;   Label: LAB_00420718
    MOV EDI,dword ptr [EAX]             ; 0042071d | CDemonRenderer g_CDemonRendererInstance
    ...
    MOV EAX,[0x02f0d364]                ; 0042073d | CMatrix3x3i g_InverseMatrix
    IMUL EDX                            ; 00420742
    ...
    MOV EBX,dword ptr [0x02d052c4]      ; 0042076d | int g_CameraOriginX
    ...
    ADD EAX,dword ptr [0x02d052c8]      ; 004207b0 | int g_CameraOriginY
    ...
    MOV EBP,dword ptr [0x02d052cc]      ; 004207ee | int g_CameraOriginZ
    ...
    JNZ 0x00420718                      ; 00420808 | LAB_00420718
        ;   XREF to: 00420718 (CONDITIONAL_JUMP)
    MOV EBX,ESP                         ; 0042080e
    MOV EAX,[0x00823a74]                ; 00420810 | CDemonCamera * g_CurrentSceneCamera
    PUSH EBX                            ; 00420815
    ...
    XOR EBP,EBP                         ; 0042082b
        ;   Label: LAB_0042082b
    JMP 0x00420703                      ; 0042082d | LAB_00420703
