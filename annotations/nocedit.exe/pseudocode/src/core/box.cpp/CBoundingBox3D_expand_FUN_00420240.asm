...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_box.cpp_CBoundingBox3D_expand_FUN_00420240(CBoundingBox3D * this_ptr, CVector3f * point)
;
; Parameters:
...
;   core_bugs.cpp_FUN_004272f0 at 00427344
;   core_cloth.cpp_LockVerticesMaybe_FUN_0043d590 at 0043d63c
...
section .text
    ...
    FNSTSW AX                           ; 0042024c
    SAHF                                ; 0042024e
    JC 0x0042029f                       ; 0042024f | LAB_0042029f
    ...
    FNSTSW AX                           ; 00420256
    SAHF                                ; 00420258
    JBE 0x00420260                      ; 00420259 | LAB_00420260
    ...
    FNSTSW AX                           ; 00420266
    SAHF                                ; 00420268
    JNC 0x00420271                      ; 00420269 | LAB_00420271
    ...
    FNSTSW AX                           ; 00420277
    SAHF                                ; 00420279
    JBE 0x00420282                      ; 0042027a | LAB_00420282
    ...
    FNSTSW AX                           ; 00420288
    SAHF                                ; 0042028a
    JNC 0x00420293                      ; 0042028b | LAB_00420293
