...

{
  ...
  if (((this_ptr->flame_state != 0) || (g_CDemonMissionPtr->is_in_editor != 0)) &&
    ...
    if ((this_ptr->is_visible != 0) && (this_ptr->which_flame != 3)) {
      ...
      if (iStack_18 != 0) {
        do {
          ...
          local_11c.base.base.count = 4;
          local_11c.base.surface_normal.A = 0;
          local_11c.base.surface_normal.B = 0;
          local_11c.base.surface_normal.C = 0;
          local_11c.base.surface_normal.D = 0;
          local_11c.vertices[0] = 0;
          local_11c.vertices[1] = 1;
          local_11c.vertices[2] = 2;
          local_11c.vertices[3] = 3;
          engine_drender_cpp_CDemonRenderer_renderMaximumQuality_FUN_0048bad0
                    (g_CDemonRendererPtr2,&local_11c.base);
    ...
    if ((this_ptr->which_flame == 1) &&
      ...
      CStack_c4.x = (int)ROUND(fVar7 * 256.0f);
      CStack_c4.y = (int)ROUND(fVar7 * 256.0f);
      CStack_c4.z = 0;
      wincore_windll_cpp_transformAndProjectPoint_FUN_005b575c
                (&g_CDemonRendererPtr2->vertex_buffer_ptr->projected_vertex,&CStack_c4);
      fStack_48 = -fVar7;
      CStack_70.x = (int)ROUND(fStack_48 * 256.0f);
      CStack_70.y = (int)ROUND(fVar7 * 256.0f);
      CStack_70.z = 0;
      wincore_windll_cpp_transformAndProjectPoint_FUN_005b575c
                (&g_CDemonRendererPtr2->vertex_buffer_ptr[1].projected_vertex,&CStack_70);
      fStack_44 = -fVar7;
      CStack_94.x = (int)ROUND(fStack_48 * 256.0f);
      CStack_94.y = (int)ROUND(fStack_44 * 256.0f);
      CStack_94.z = 0;
      wincore_windll_cpp_transformAndProjectPoint_FUN_005b575c
                (&g_CDemonRendererPtr2->vertex_buffer_ptr[2].projected_vertex,&CStack_94);
      fStack_48 = -fStack_48;
      CStack_40.x = (int)ROUND(fStack_48 * 256.0f);
      CStack_40.y = (int)ROUND(fStack_44 * 256.0f);
      CStack_40.z = 0;
      wincore_windll_cpp_transformAndProjectPoint_FUN_005b575c
      ...
      local_144.base.surface_normal.A = 0;
      ...
      local_144.vertices[1] = 1;
      local_144.vertices[2] = 2;
      local_144.vertices[3] = 3;
      engine_drender_cpp_CDemonRenderer_captureTexture_FUN_0048db80
                (this_ptr_00,&SMRGLTextureBasic_0067b0c8);
      engine_drender_cpp_CDemonRenderer_setBlendMode_FUN_0048ca50(g_CDemonRendererPtr2,1);
      engine_drender_cpp_CDemonRenderer_renderPerspective_FUN_0048ae10
                (g_CDemonRendererPtr2,&local_144.base,0x163);
      engine_drender_cpp_CDemonRenderer_setBlendMode_FUN_0048ca50(g_CDemonRendererPtr2,0);
      engine_drender_cpp_CDemonRenderer_matrixPop_FUN_0048c640(g_CDemonRendererPtr2);
    }
