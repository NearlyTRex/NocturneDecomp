...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_flame_cpp_CFlame_getPropertyList_FUN_004cae70 (CFlame *this_ptr,CActorPropertyList *property_list)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004cae70
        ;   Label: core_flame.cpp_CFlame_getPropertyList_FUN_004cae70
    PUSH ESI                            ; 004cae71
    ...
    PUSH ESI                            ; 004caec3
    CALL core_actor.cpp_CActorPropertyList_addEvent_FUN_0040e460 ; 004caec4
    ...
    PUSH ESI                            ; 004caed8
    CALL core_actor.cpp_CActorPropertyList_addEvent_FUN_0040e460 ; 004caed9
        ;   XREF to: 0040e460 (UNCONDITIONAL_CALL)  ; CActorProperty * core_actor.cpp_CActorPropertyList_addEvent_FUN_0040e460(CActorPropertyList * this_ptr, char * property_name, char * data_ptr)
    ...
    PUSH ESI                            ; 004caeed
    CALL core_actor.cpp_CActorPropertyList_addBool_FUN_0040e330 ; 004caeee
    ...
    PUSH ESI                            ; 004caf30
    CALL core_actor.cpp_CActorPropertyList_addBool_FUN_0040e330 ; 004caf31
        ;   XREF to: 0040e330 (UNCONDITIONAL_CALL)  ; CActorProperty * core_actor.cpp_CActorPropertyList_addBool_FUN_0040e330(CActorPropertyList * this_ptr, char * property_name, int * data_ptr)
    ...
    PUSH ESI                            ; 004caf45
    CALL core_actor.cpp_CActorPropertyList_addBool_FUN_0040e330 ; 004caf46
        ;   XREF to: 0040e330 (UNCONDITIONAL_CALL)  ; CActorProperty * core_actor.cpp_CActorPropertyList_addBool_FUN_0040e330(CActorPropertyList * this_ptr, char * property_name, int * data_ptr)
