...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_flame_cpp_FUN_004cae70(void)
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH ESI                            ; 004cae7a
    PUSH EBX                            ; 004cae7b
    CALL core_actor.cpp_CDemonActor_getPropertyList_FUN_0040d290 ; 004cae7c
    ...
    PUSH ESI                            ; 004cae97
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e640 ; 004cae98
    ...
    PUSH ESI                            ; 004caeae
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e160 ; 004caeaf
    ...
    PUSH EAX                            ; 004caebd
    PUSH 0x62a20f                       ; 004caebe | = "On event"
    PUSH ESI                            ; 004caec3
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e460 ; 004caec4
    ...
    PUSH EAX                            ; 004caed2
    PUSH 0x62a218                       ; 004caed3 | = "Off event"
    PUSH ESI                            ; 004caed8
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e460 ; 004caed9
        ;   XREF to: 0040e460 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_CActorPropertyList_FUN_0040e460(CActorPropertyList * this_ptr)
    ADD ESP,0xc                         ; 004caede
    LEA EAX,[EBX + 0x1b4]               ; 004caee1
    PUSH EAX                            ; 004caee7
    PUSH 0x62a222                       ; 004caee8 | = "Flame state"
    PUSH ESI                            ; 004caeed
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e330 ; 004caeee
    ...
    PUSH ESI                            ; 004caf04
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e160 ; 004caf05
        ;   XREF to: 0040e160 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_CActorPropertyList_FUN_0040e160(CActorPropertyList * this_ptr)
    ...
    PUSH ESI                            ; 004caf1b
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e160 ; 004caf1c
        ;   XREF to: 0040e160 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_CActorPropertyList_FUN_0040e160(CActorPropertyList * this_ptr)
    ADD ESP,0x10                        ; 004caf21
    LEA EAX,[EBX + 0x288]               ; 004caf24
    PUSH EAX                            ; 004caf2a
    PUSH 0x62a243                       ; 004caf2b | = "Catch hero on fire"
    PUSH ESI                            ; 004caf30
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e330 ; 004caf31
        ;   XREF to: 0040e330 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_CActorPropertyList_FUN_0040e330(CActorPropertyList * this_ptr)
    ADD ESP,0xc                         ; 004caf36
    ADD EBX,0x28c                       ; 004caf39
    PUSH EBX                            ; 004caf3f
    PUSH 0x62a256                       ; 004caf40 | = "Catch enemies on fire"
    PUSH ESI                            ; 004caf45
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e330 ; 004caf46
        ;   XREF to: 0040e330 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_CActorPropertyList_FUN_0040e330(CActorPropertyList * this_ptr)
