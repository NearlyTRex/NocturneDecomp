...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_flame_cpp_CFlame_load_FUN_004cac60(void)
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004cac65
    CALL core_actor.cpp_CDemonActor_archive_FUN_0040c1c0 ; 004cac66
    ...
    PUSH EAX                            ; 004cac79
    CALL core_actor.cpp_archiveVector_FUN_0040b340 ; 004cac7a
    ...
    PUSH EAX                            ; 004caca5
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 004caca6
    ...
    PUSH EAX                            ; 004cacc2
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 004cacc3
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveString_FUN_0040b5c0(char * string_buffer, char * property_type)
    ...
    PUSH EAX                            ; 004cacdf
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 004cace0
    ...
    PUSH EAX                            ; 004cacfc
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 004cacfd
    ...
    PUSH EAX                            ; 004cad10
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 004cad11
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH EAX                            ; 004cad2f
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 004cad30
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ADD ESP,0x8                         ; 004cad35
    PUSH 0x62a16b                       ; 004cad38 | = "globeScalar"
    LEA EAX,[EBX + 0x1ac]               ; 004cad3d
    PUSH EAX                            ; 004cad43
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 004cad44
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH EAX                            ; 004cad5c
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 004cad5d
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ADD ESP,0x8                         ; 004cad62
    PUSH 0x62a1b0                       ; 004cad65 | = "burnEnemy"
    ADD EBX,0x28c                       ; 004cad6a
    PUSH EBX                            ; 004cad70
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 004cad71
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
