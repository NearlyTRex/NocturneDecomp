...
;                               FUNCTION
; *****************************************************************************
; __cdecl CBoundingBox3D * __cdecl core_flame_cpp_CFlame_getBoundingBox_FUN_004cac00(CFlame *this_ptr,CBoundingBox3D *out_box)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x4]       ; 004cac00
        ;   Label: core_flame.cpp_CFlame_getBoundingBox_FUN_004cac00
