...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_flame_cpp_CFlame_FUN_004cad90(CFlame *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004cad90
        ;   Label: core_flame.cpp_CFlame_FUN_004cad90
    PUSH ESI                            ; 004cad91
    PUSH EBP                            ; 004cad92
    ...
    CALL core_dglobe.cpp_CDemonGlobe_setColor_FUN_00471310 ; 004caddc
