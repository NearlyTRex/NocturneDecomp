...

{
  ...
  char local_f8 [96];
  SCollisionInfo SStack_98;
  SCollisionInfo SStack_70;
  float fStack_48;
  float fStack_44;
  float fStack_40;
  float fStack_3c;
  ...
  if (*(int *)(in_stack_00000004 + 0x1b4) != 0) {
    ...
    *(uint *)(in_stack_00000004 + 0x34) = 0;
    ...
    if (*(int *)(in_stack_00000004 + 0x288) != 0) {
      core_setcolid_cpp_SCollisionInfo_ctor_FUN_005743c0(&SStack_98);
      iVar1 = (*((g_HeroActors[g_LocalHeroIndex]->base_character).base_actor.vtable)->hasCollision)
                        ((CDemonActor *)g_HeroActors[g_LocalHeroIndex],&SStack_98);
      if (iVar1 == 2) {
        ...
        if (((float)-0.5 < fStack_40) && (fStack_40 < SStack_98.cylinder_radius)) {
          ...
          iStack_18 = iStack_1c;
          if ((ABS(fStack_48) < SStack_98.cylinder_radius + fStack_20) &&
             (ABS(fStack_40) < SStack_98.cylinder_radius + fStack_20)) {
    ...
    if (*(int *)(in_stack_00000004 + 0x28c) != 0) {
      ...
      if (0 < *(int *)(g_CDemonSetPtr->field19_0x14f0a0 + 0x1f3c)) {
        ...
        core_setcolid_cpp_SCollisionInfo_ctor_FUN_005743c0(&SStack_70);
        iVar1 = (*((this_ptr_00->base_actor).vtable)->hasCollision)
                          (&this_ptr_00->base_actor,&SStack_70);
        if (iVar1 == 2) {
          ...
          if (((float10)-0.5 < fVar3) && (fStack_38 < SStack_70.cylinder_top_y)) {
            fStack_28 = (float)iStack_24;
            if ((ABS(fStack_3c) < SStack_70.cylinder_radius + fStack_28) &&
               (ABS(fStack_34) < SStack_70.cylinder_radius + fStack_28)) {
              iStack_18 = iStack_24;
