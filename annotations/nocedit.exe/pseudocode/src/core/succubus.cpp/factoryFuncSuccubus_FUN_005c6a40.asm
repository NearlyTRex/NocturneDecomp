...
section .text
    ...
    PUSH 0x4b                           ; 005c6a40
        ;   Label: core_succubus.cpp_factoryFuncSuccubus_FUN_005c6a40
    PUSH 0x653fc3                       ; 005c6a42 | = "..\\core\\succubus.cpp"
    PUSH 0xef68                         ; 005c6a47
    CALL shape_memdbg.cpp_debugAllocTracked1_FUN_0050f1b0 ; 005c6a4c
        ;   XREF to: 0050f1b0 (UNCONDITIONAL_CALL)  ; void * shape_memdbg.cpp_debugAllocTracked1_FUN_0050f1b0(int size, char * filename, int line_number)
    ADD ESP,0xc                         ; 005c6a51
    TEST EAX,EAX                        ; 005c6a54
    JNZ 0x005c6a59                      ; 005c6a56
        ;   XREF to: 005c6a59 (CONDITIONAL_JUMP)  ; LAB_005c6a59
    RET                                 ; 005c6a58
    PUSH EAX                            ; 005c6a59
        ;   Label: LAB_005c6a59
    CALL core_succubus.cpp_CSuccubus_ctor_FUN_005c6a80 ; 005c6a5a
        ;   XREF to: 005c6a80 (UNCONDITIONAL_CALL)  ; CSuccubus * core_succubus.cpp_CSuccubus_ctor_FUN_005c6a80(CSuccubus * this_ptr)
