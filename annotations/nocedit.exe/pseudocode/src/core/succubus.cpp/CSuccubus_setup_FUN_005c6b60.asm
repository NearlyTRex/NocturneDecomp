...
;   core_morph.cpp_CMorph_addPartFromKeyframedModel_FUN_0052b580
...
section .text
    ...
    PUSH EBX                            ; 005c6b60
        ;   Label: core_succubus.cpp_CSuccubus_setup_FUN_005c6b60
    PUSH ESI                            ; 005c6b61
    PUSH EDI                            ; 005c6b62
    PUSH EBP                            ; 005c6b63
    ...
    PUSH ESI                            ; 005c6c3b
    MOV [0x03f6bb68],EAX                ; 005c6c3c | g_SuccubusIndices[1]
    ...
    PUSH ESI                            ; 005c6c50
    MOV [0x03f6bb74],EAX                ; 005c6c51 | g_SuccubusIndices[4]
    ...
    PUSH ESI                            ; 005c6c65
    MOV [0x03f6bb78],EAX                ; 005c6c66 | g_SuccubusIndices[5]
    ...
    PUSH ESI                            ; 005c6c7a
    MOV [0x03f6bb7c],EAX                ; 005c6c7b | g_SuccubusIndices[6]
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 005c6c80
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 005c6c85
    MOV [0x03f6bb80],EAX                ; 005c6c88 | g_SuccubusIndices[7]
    PUSH 0x1                            ; 005c6c8d
    ...
    PUSH ESI                            ; 005c6ca4
    MOV [0x03f6bb84],EAX                ; 005c6ca5 | g_SuccubusIndices[8]
    ...
    PUSH ESI                            ; 005c6cb9
    MOV [0x03f6bb88],EAX                ; 005c6cba | g_SuccubusIndices[9]
    ...
    PUSH ESI                            ; 005c6cce
    MOV [0x03f6bb6c],EAX                ; 005c6ccf | g_SuccubusIndices[2]
    ...
    PUSH ESI                            ; 005c6ce3
    MOV [0x03f6bb70],EAX                ; 005c6ce4 | g_SuccubusIndices[3]
    ...
    PUSH ESI                            ; 005c6cf8
    MOV [0x03f6bb8c],EAX                ; 005c6cf9 | g_SuccubusIndices[10]
    ...
    PUSH ESI                            ; 005c6d0d
    MOV [0x03f6bb90],EAX                ; 005c6d0e | g_SuccubusIndices[11]
    ...
    PUSH ESI                            ; 005c6d22
    MOV [0x03f6bb94],EAX                ; 005c6d23 | g_SuccubusIndices[12]
    ...
    PUSH ESI                            ; 005c6d37
    MOV [0x03f6bb68],EAX                ; 005c6d38 | g_SuccubusIndices[1]
    ...
    PUSH ESI                            ; 005c6d4c
    MOV [0x03f6bb7c],EAX                ; 005c6d4d | g_SuccubusIndices[6]
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 005c6d52
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 005c6d57
    MOV [0x03f6bb80],EAX                ; 005c6d5a | g_SuccubusIndices[7]
    PUSH 0x1                            ; 005c6d5f
    ...
    PUSH ESI                            ; 005c6d76
    MOV [0x03f6bb8c],EAX                ; 005c6d77 | g_SuccubusIndices[10]
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 005c6d7c
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 005c6d81
    PUSH EDI                            ; 005c6d84
    MOV [0x03f6bb94],EAX                ; 005c6d85 | g_SuccubusIndices[12]
    ...
    PUSH ESI                            ; 005c6dc8
    CALL core_morph.cpp_CMorph_setupModelFromDeformable_FUN_0052b430 ; 005c6dc9
    ...
    PUSH 0x1                            ; 005c6dd2
    PUSH ESI                            ; 005c6dd4
    CALL core_morph.cpp_CMorph_setupModelFromDeformable_FUN_0052b430 ; 005c6dd5
        ;   XREF to: 0052b430 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_CMorph_setupModelFromDeformable_FUN_0052b430(CMorph * this_ptr, int model_index, CDeformableModelInstance * model_ptr)
    ...
    PUSH 0x1                            ; 005c6de7
    PUSH ESI                            ; 005c6de9
    MOV [0x02f43974],EAX                ; 005c6dea | INT_02f43974
    CALL core_morph.cpp_CMorph_addPartFromKeyframedModel_FUN_0052b580 ; 005c6def
        ;   XREF to: 0052b580 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_CMorph_addPartFromKeyframedModel_FUN_0052b580(CMorph * this_ptr, int model_index, CKeyFramedModel * model_ptr, int frame_index)
    ...
    PUSH ECX                            ; 005c6e05
    PUSH ESI                            ; 005c6e06
    MOV dword ptr [0x02f43974],ECX      ; 005c6e07 | INT_02f43974
    CALL core_morph.cpp_CMorph_addPartFromKeyframedModel_FUN_0052b580 ; 005c6e0d
        ;   XREF to: 0052b580 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_CMorph_addPartFromKeyframedModel_FUN_0052b580(CMorph * this_ptr, int model_index, CKeyFramedModel * model_ptr, int frame_index)
    ADD ESP,0x10                        ; 005c6e12
    XOR EDX,EDX                         ; 005c6e15
    PUSH ESI                            ; 005c6e17
    MOV dword ptr [0x02f43974],EDX      ; 005c6e18 | INT_02f43974
