...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_succubus_cpp_CSuccubus_archive_FUN_005c7710(CSuccubus *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005c7710
        ;   Label: core_succubus.cpp_CSuccubus_archive_FUN_005c7710
    PUSH ESI                            ; 005c7711
    MOV ESI,dword ptr [ESP + 0xc]       ; 005c7712
    PUSH ESI                            ; 005c7716
    CALL core_enemy.cpp_CEnemy_archive_FUN_004a9660 ; 005c7717
    ...
    PUSH EBX                            ; 005c772a
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 005c772b
    ...
    PUSH EBX                            ; 005c773e
    CALL core_actor.cpp_archiveDeformableModelInstance_FUN_0040b970 ; 005c773f
    ...
    PUSH EBX                            ; 005c774c
    CALL core_actor.cpp_archiveMotionState_FUN_0040b9f0 ; 005c774d
