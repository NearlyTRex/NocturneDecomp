...
// Convention: __cdecl
// Signature: void __cdecl core_succubus_cpp_CSuccubus_FUN_005c7790(CSuccubus *this_ptr)
...

{
  ...
  core_charactr_cpp_CCharacter_hasCollision_FUN_0042bc20((CCharacter *)this_ptr,in_stack_00000008);
  return;
}
