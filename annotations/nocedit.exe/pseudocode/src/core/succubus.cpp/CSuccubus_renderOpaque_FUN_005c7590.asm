...
section .text
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 005c7599 | g_CDemonRendererInstance | g_CDemonRendererPtr2
    PUSH EDX                            ; 005c759f | g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_getAlphaMask_FUN_0048ce00 ; 005c75a0
    ...
    JZ 0x005c7674                       ; 005c75ac
        ;   XREF to: 005c7674 (CONDITIONAL_JUMP)  ; LAB_005c7674
    CMP dword ptr [EBX + 0x240c],0x0    ; 005c75b2
        ;   Label: LAB_005c75b2
    JNZ 0x005c767f                      ; 005c75b9
        ;   XREF to: 005c767f (CONDITIONAL_JUMP)  ; LAB_005c767f
    PUSH EDI                            ; 005c75bf
    PUSH ESI                            ; 005c75c0
    PUSH EBX                            ; 005c75c1
    CALL core_actor.cpp_CDemonActor_setupRenderState_FUN_00408b00 ; 005c75c2
    ...
    JZ 0x005c7687                       ; 005c75ff
        ;   XREF to: 005c7687 (CONDITIONAL_JUMP)  ; LAB_005c7687
    PUSH 0x0                            ; 005c7605
    PUSH 0x1                            ; 005c7607
    PUSH -0x1                           ; 005c7609
    PUSH -0x1                           ; 005c760b
    PUSH EDI                            ; 005c760d
    CALL core_skeleton.cpp_CDeformableModelInstance_renderWithOptions_FUN_005a0150 ; 005c760e
    ...
    JZ 0x005c765f                       ; 005c762d
        ;   XREF to: 005c765f (CONDITIONAL_JUMP)  ; LAB_005c765f
    MOV EDX,dword ptr [0x006703ec]      ; 005c762f | g_CDemonRendererInstance | g_CDemonRendererPtr2
    PUSH EDX                            ; 005c7635 | g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_getFaceCount_FUN_0048cae0 ; 005c7636
        ;   XREF to: 0048cae0 (UNCONDITIONAL_CALL)  ; int engine_drender.cpp_CDemonRenderer_getFaceCount_FUN_0048cae0(CDemonRenderer * this_ptr)
    ADD ESP,0x4                         ; 005c763b
    TEST EAX,EAX                        ; 005c763e
    JNZ 0x005c765f                      ; 005c7640
        ;   XREF to: 005c765f (CONDITIONAL_JUMP)  ; LAB_005c765f
    PUSH EBX                            ; 005c7642
    LEA EAX,[EBX + 0x158]               ; 005c7643
    PUSH EAX                            ; 005c7649
    CALL core_motion.cpp_CMotionController_render_FUN_0052e700 ; 005c764a
    ...
    PUSH EBX                            ; 005c765f
        ;   Label: LAB_005c765f
    CALL core_actor.cpp_CDemonActor_restoreRenderState_FUN_00408b40 ; 005c7660
    ...
    MOV dword ptr [EBX + 0x2620],EAX    ; 005c7674
        ;   Label: LAB_005c7674
    JMP 0x005c75b2                      ; 005c767a
        ;   XREF to: 005c75b2 (UNCONDITIONAL_JUMP)  ; LAB_005c75b2
    ...
    CMP dword ptr [EBX + 0xe334],0x0    ; 005c7687
        ;   Label: LAB_005c7687
    JZ 0x005c76fc                       ; 005c768e
        ;   XREF to: 005c76fc (CONDITIONAL_JUMP)  ; LAB_005c76fc
    PUSH EBP                            ; 005c7690
    ...
    PUSH ESI                            ; 005c769f
    CALL core_morph.cpp_CMorph_updateModelFromDeformable_FUN_0052b600 ; 005c76a0
    ...
    PUSH 0x1                            ; 005c76aa
    PUSH ESI                            ; 005c76ac
    CALL core_morph.cpp_CMorph_updateModelFromDeformable_FUN_0052b600 ; 005c76ad
        ;   XREF to: 0052b600 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_CMorph_updateModelFromDeformable_FUN_0052b600(CMorph * this_ptr, int model_index, CDeformableModelInstance * model_ptr, int part_index)
    ...
    PUSH 0x1                            ; 005c76bf
    PUSH ESI                            ; 005c76c1
    CALL core_morph.cpp_CMorph_updateModelFromKeyframed_FUN_0052b640 ; 005c76c2
        ;   XREF to: 0052b640 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_CMorph_updateModelFromKeyframed_FUN_0052b640(CMorph * this_ptr, int model_index, CKeyFramedModel * model_ptr, int frame_index, ...)
