...
section .text
    ...
    PUSH ECX                            ; 005c77fa
    CALL core_actor.cpp_CDemonActor_addFilesToExtract_FUN_0040cfd0 ; 005c77fb
    ...
    PUSH EAX                            ; 005c7811
    CALL core_skeledit.cpp_CDeformableModelInstance_addFilesToExtract_FUN_0058a260 ; 005c7812
