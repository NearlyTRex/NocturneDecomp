...

{
  ...
  *(uint *)(this_ptr->unk + 0x2254) = *(uint *)(this_ptr->unk + 0x2258);
  ...
  (this_ptr->base).base.turn_speed = delta_time * fVar18 * fVar19;
    ...
    if (uVar9 == 0) {
      ...
      if ((this_ptr->base).victim == (CDemonActor *)0x0) {
        ...
        if (-1 < iVar8) {
          ...
          if ((SQRT(fVar18 * fVar18 + in_stack_ffffff8c * in_stack_ffffff8c + fVar19 * fVar19) <
...
LAB_005c6fd0:
  ...
  if (iVar8 != 0) {
    ...
    local_44.x = (this_ptr->base).base.field7_0x2428.x * delta_time + pCVar17->x + pCVar2->x;
  ...
  if ((*(int *)(this_ptr->unk + 0x2478) != 0) &&
     (fVar19 = *(float *)(this_ptr->unk + 0x247c) + delta_time,
     *(float *)(this_ptr->unk + 0x247c) = fVar19, 4.0f < fVar19)) {
  ...
  if (iVar8 == 0) {
    ...
    if ((iVar8 == 0) &&
       (fVar19 = *(float *)(this_ptr->unk + 0x2474) - delta_time,
       *(float *)(this_ptr->unk + 0x2474) = fVar19, fVar19 < 0.0)) {
