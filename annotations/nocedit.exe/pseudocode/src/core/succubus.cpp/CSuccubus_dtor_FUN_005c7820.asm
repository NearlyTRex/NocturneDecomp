...
;                               FUNCTION
; *****************************************************************************
; __cdecl CSuccubus * __cdecl core_succubus_cpp_CSuccubus_dtor_FUN_005c7820 (CSuccubus *this_ptr,uint d1,uint d2,uint d3,uint d4,uint d5,uint d6,uint d7,uint d8, uint d9,uint d10,uint d11)
;
; Parameters:
...
section .text
    ...
    JNZ 0x005c78e1                      ; 005c782a
        ;   XREF to: 005c78e1 (CONDITIONAL_JUMP)  ; LAB_005c78e1
    PUSH 0x0                            ; 005c7830
    ADD EBX,0xe33c                      ; 005c7832
    PUSH EBX                            ; 005c7838
    CALL core_morph.cpp_CMorphModel_FUN_0052b330 ; 005c7839
    ...
    PUSH EAX                            ; 005c7858
    CALL core_skeleton.cpp_CDeformableModelInstance_dtor_FUN_0059de40 ; 005c7859
    ...
    PUSH EAX                            ; 005c7868
    CALL core_backgnd.cpp_freeFlames_FUN_00412720 ; 005c7869
    ...
    PUSH EAX                            ; 005c7878
    CALL core_backgnd.cpp_freeFires_FUN_00412700 ; 005c7879
    ...
    PUSH EAX                            ; 005c7888
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 005c7889
    ...
    PUSH EAX                            ; 005c7898
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 005c7899
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; int core_backgnd.cpp_cleanupVector_FUN_004126e0(CVector3f * * objs)
    ...
    PUSH EAX                            ; 005c78b8
    CALL core_skeleton.cpp_CDeformableModelInstance_dtor_FUN_0059de40 ; 005c78b9
        ;   XREF to: 0059de40 (UNCONDITIONAL_CALL)  ; CDeformableModelInstance * core_skeleton.cpp_CDeformableModelInstance_dtor_FUN_0059de40(CDeformableModelInstance * this_ptr, uint d1, uint d2, uint d3, ...)
    ADD ESP,0x8                         ; 005c78be
    PUSH 0x1                            ; 005c78c1
    LEA EBX,[EAX + 0xfffffea8]          ; 005c78c3
    PUSH EBX                            ; 005c78c9
    CALL core_actor.cpp_CDemonActor_dtor_FUN_00408a30 ; 005c78ca
    ...
    JNZ 0x005c78fc                      ; 005c78db
        ;   XREF to: 005c78fc (CONDITIONAL_JUMP)  ; LAB_005c78fc
    MOV EAX,EBX                         ; 005c78dd
    POP EBX                             ; 005c78df
    RET                                 ; 005c78e0
    PUSH 0x663ab0                       ; 005c78e1 | g_CSuccubusTypeInfo
        ;   Label: LAB_005c78e1
    PUSH EBX                            ; 005c78e6
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 005c78e7
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 005c78ec
    PUSH EAX                            ; 005c78ef
    CALL crt_memory.c_free_FUN_005fe659 ; 005c78f0
    ...
    PUSH EAX                            ; 005c78fc
        ;   Label: LAB_005c78fc
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 005c78fd
