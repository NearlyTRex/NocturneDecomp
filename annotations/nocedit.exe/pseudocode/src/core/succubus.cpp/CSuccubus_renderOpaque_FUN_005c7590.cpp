    ...
    if (iStack_c != 0) {
      ...
      if (iVar1 == 0) {
        if (*(int *)(this_ptr->unk + 0x2478) == 0) {
          ...
          core_morph_cpp_CMorph_updateModelFromDeformable_FUN_0052b600
                    (this_ptr_00,1,(CDeformableModelInstance *)model_ptr,0);
          core_morph_cpp_CMorph_updateModelFromKeyframed_FUN_0052b640
                    (this_ptr_00,1,*(CKeyFramedModel **)(this_ptr->unk + 0x2448),0,1);
          core_morph_cpp_CMorph_updateModelFromKeyframed_FUN_0052b640
                    (this_ptr_00,1,*(CKeyFramedModel **)(this_ptr->unk + 0x2448),0,2);
          core_morph_cpp_CMorph_render_FUN_0052bae0
                    (this_ptr_00,*(float *)(this_ptr->unk + 0x247c) / 4.0f);
        }
      }
      else {
        core_skeleton_cpp_CDeformableModelInstance_renderWithOptions_FUN_005a0150
                  ((CDeformableModelInstance *)model_ptr,-1,0xffffffff,1,0);
        core_cloth_cpp_CClothList_render_FUN_0043c320
                  ((CClothList *)(this_ptr->unk + 0x22b4),(CDeformableModelInstance *)model_ptr);
      }
      if ((DAT_02f43978 != 0) &&
