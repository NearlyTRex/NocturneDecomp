...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_trap_cpp_CTrap_addFilesToExtract_FUN_005dea90(CTrap *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x8]       ; 005dea90
        ;   Label: core_trap.cpp_CTrap_addFilesToExtract_FUN_005dea90
    PUSH EDX                            ; 005dea94
