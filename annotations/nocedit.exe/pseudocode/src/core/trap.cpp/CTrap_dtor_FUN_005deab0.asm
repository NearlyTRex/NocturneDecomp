...
;                               FUNCTION
; *****************************************************************************
; __cdecl CTrap * __cdecl core_trap_cpp_CTrap_dtor_FUN_005deab0(CTrap *this_ptr,uint d1,uint d2)
;
; Parameters:
...
section .text
    ...
    PUSH 0x6648b0                       ; 005dead6 | g_CTrapTypeInfo
        ;   Label: LAB_005dead6
    PUSH EBX                            ; 005deadb
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 005deadc
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 005deae1
    PUSH EAX                            ; 005deae4
    CALL crt_memory.c_free_FUN_005fe659 ; 005deae5
