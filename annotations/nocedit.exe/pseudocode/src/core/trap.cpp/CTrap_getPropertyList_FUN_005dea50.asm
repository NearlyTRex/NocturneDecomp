...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_trap_cpp_CTrap_getPropertyList_FUN_005dea50(CTrap *this_ptr,CActorPropertyList *property_list)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005dea50
        ;   Label: core_trap.cpp_CTrap_getPropertyList_FUN_005dea50
    MOV EDX,dword ptr [ESP + 0xc]       ; 005dea51
    PUSH EDX                            ; 005dea55
    MOV ECX,dword ptr [ESP + 0xc]       ; 005dea56
    PUSH ECX                            ; 005dea5a
    CALL core_actor.cpp_CDemonActor_getPropertyList_FUN_0040d290 ; 005dea5b
