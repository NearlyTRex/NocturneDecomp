...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_trap_cpp_CTrap_archive_FUN_005de9c0(CTrap *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005de9c0
        ;   Label: core_trap.cpp_CTrap_archive_FUN_005de9c0
    MOV EBX,dword ptr [ESP + 0x8]       ; 005de9c1
    PUSH EBX                            ; 005de9c5
    CALL core_actor.cpp_CDemonActor_archive_FUN_0040c1c0 ; 005de9c6
    ...
    PUSH EAX                            ; 005de9d9
    CALL core_actor.cpp_archiveKeyframedModelInstance_FUN_0040b8f0 ; 005de9da
    ...
    PUSH EAX                            ; 005de9ed
    CALL core_actor.cpp_archiveActor_FUN_0040b870 ; 005de9ee
