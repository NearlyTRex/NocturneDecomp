...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_trap.cpp_CTrap_process_FUN_005de770(CTrap * this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EBX,dword ptr [0x006810c8]      ; 005de7aa | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
        ;   Label: LAB_005de7aa
    CMP EBP,dword ptr [EBX + 0x150fdc]  ; 005de7b0 | g_CDemonSetInstance.field19_0x14f0a0[7996]
    JL 0x005de7f9                       ; 005de7b6 | LAB_005de7f9
    ...
    PUSH ECX                            ; 005de807
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 005de808 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 005de80d
    ADD ESP,0x8                         ; 005de80f
    TEST EAX,EAX                        ; 005de812
    JZ 0x005de7f3                       ; 005de814 | LAB_005de7f3
        ;   XREF to: 005de7f3 (CONDITIONAL_JUMP)
    CMP dword ptr [EAX + 0xbee8],0x0    ; 005de816
    JNZ 0x005de7f3                      ; 005de81d | LAB_005de7f3
        ;   XREF to: 005de7f3 (CONDITIONAL_JUMP)
    LEA EAX,[ESP + 0x3c]                ; 005de81f
    PUSH EAX                            ; 005de823
    CALL core_setcolid.cpp_SCollisionInfo_ctor_FUN_005743c0 ; 005de824 | SCollisionInfo * core_setcolid.cpp_SCollisionInfo_ctor_FUN_005743c0(SCollisionInfo * this_ptr)
    ...
    FNSTSW AX                           ; 005de848
    SAHF                                ; 005de84a
    JC 0x005de7f3                       ; 005de84b | LAB_005de7f3
        ;   XREF to: 005de7f3 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 005de85d
    SAHF                                ; 005de85f
    JA 0x005de7f3                       ; 005de860 | LAB_005de7f3
        ;   XREF to: 005de7f3 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 005de86d
    PUSH ESI                            ; 005de86e
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 005de86f | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
    ...
    FNSTSW AX                           ; 005de883
    SAHF                                ; 005de885
    JC 0x005de7f3                       ; 005de886 | LAB_005de7f3
        ;   XREF to: 005de7f3 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 005de898
    SAHF                                ; 005de89a
    JA 0x005de7f3                       ; 005de89b | LAB_005de7f3
        ;   XREF to: 005de7f3 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 005de8b0
    SAHF                                ; 005de8b2
    JC 0x005de7f3                       ; 005de8b3 | LAB_005de7f3
        ;   XREF to: 005de7f3 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 005de8c8
    SAHF                                ; 005de8ca
    JA 0x005de7f3                       ; 005de8cb | LAB_005de7f3
        ;   XREF to: 005de7f3 (CONDITIONAL_JUMP)
    ...
    CALL core_charactr.cpp_SDamageInfo_ctor_FUN_00427db0 ; 005de8ea | SDamageInfo * core_charactr.cpp_SDamageInfo_ctor_FUN_00427db0(SDamageInfo * this_ptr)
