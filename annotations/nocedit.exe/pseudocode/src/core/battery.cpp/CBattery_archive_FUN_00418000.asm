...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_battery_cpp_CBattery_archive_FUN_00418000(CBattery *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00418000
        ;   Label: core_battery.cpp_CBattery_archive_FUN_00418000
    MOV EBX,dword ptr [ESP + 0x8]       ; 00418001
    PUSH EBX                            ; 00418005
    CALL core_actor.cpp_CDemonActor_archive_FUN_0040c1c0 ; 00418006
    ...
    PUSH EAX                            ; 00418019
    CALL core_actor.cpp_archiveKeyframedModelInstance_FUN_0040b8f0 ; 0041801a
    ...
    PUSH EAX                            ; 0041802d
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 0041802e
    ...
    PUSH EBX                            ; 00418041
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 00418042
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
