...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_battery_cpp_CBattery_writeDependencies_FUN_00418110(CBattery *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00418110
        ;   Label: core_battery.cpp_CBattery_writeDependencies_FUN_00418110
    PUSH ESI                            ; 00418111
