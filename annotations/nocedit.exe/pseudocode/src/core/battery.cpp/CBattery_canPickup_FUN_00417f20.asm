...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_battery_cpp_CBattery_canPickup_FUN_00417f20(CBattery *this_ptr,CDemonActor *picker)
;
; Parameters:
...
section .text
    ...
    PUSH 0x6159e6                       ; 00417f20 | = "CHero"
        ;   Label: core_battery.cpp_CBattery_canPickup_FUN_00417f20
