...
section .text
    ...
    PUSH EBX                            ; 00418110
        ;   Label: core_battery.cpp_CBattery_addFilesToExtract_FUN_00418110
    PUSH ESI                            ; 00418111
    MOV EBX,dword ptr [ESP + 0xc]       ; 00418112
    MOV ESI,dword ptr [ESP + 0x10]      ; 00418116
    PUSH ESI                            ; 0041811a
    PUSH EBX                            ; 0041811b
    CALL core_actor.cpp_CDemonActor_addFilesToExtract_FUN_0040cfd0 ; 0041811c
    ...
    PUSH EAX                            ; 0041814e
    CALL core_dmodel.cpp_CKeyFramedModel_addFilesToExtract_FUN_0047ed00 ; 0041814f
