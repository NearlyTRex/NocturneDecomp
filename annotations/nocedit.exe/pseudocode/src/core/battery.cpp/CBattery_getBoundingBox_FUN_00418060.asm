...
;                               FUNCTION
; *****************************************************************************
; __cdecl CBoundingBox3D * __cdecl core_battery_cpp_CBattery_getBoundingBox_FUN_00418060(CBattery *this_ptr,CBoundingBox3D *out_box)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00418060
        ;   Label: core_battery.cpp_CBattery_getBoundingBox_FUN_00418060
