...
section .text
    ...
    PUSH EBX                            ; 00558720
        ;   Label: core_scat.cpp_CScat_updateAiming_FUN_00558720
    PUSH ESI                            ; 00558721
    PUSH EDI                            ; 00558722
    PUSH EBP                            ; 00558723
    ...
    MOV EBX,dword ptr [EDI + EAX*0x1 + 0x14d158] ; 005589ff | g_CDemonSetInstance.actors[0] | g_CDemonSetInstance.actors[1]
