...
;
; XREF[1]:
;   core_scat.cpp_CScat_FUN_00558720 at 00558a17
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00558cf0
        ;   Label: core_scat.cpp_CScat_FUN_00558cf0
    PUSH ESI                            ; 00558cf1
    PUSH EDI                            ; 00558cf2
    PUSH EBP                            ; 00558cf3
    ...
    PUSH EAX                            ; 00558dd6
    CALL core_vecdir.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 00558dd7
    ...
    CALL core_setcolid.cpp_CDemonSet_init_FUN_00574180 ; 00558f78
