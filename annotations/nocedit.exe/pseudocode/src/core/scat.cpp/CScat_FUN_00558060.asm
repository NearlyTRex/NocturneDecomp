...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_scat_cpp_CScat_FUN_00558060(CScat *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00558060
        ;   Label: core_scat.cpp_CScat_FUN_00558060
    PUSH ESI                            ; 00558061
    PUSH EDI                            ; 00558062
    PUSH EBP                            ; 00558063
    ...
    JA 0x00558106                       ; 005580fd
        ;   XREF to: 00558106 (CONDITIONAL_JUMP)  ; caseD_6
    JMP dword ptr [EAX*0x4 + 0x558038]  ; 005580ff | caseD_6 | caseD_8 | switchdataD_00558038
        ;   Label: switchD
