...
section .text
    ...
    MOV ESI,dword ptr [0x0310616c]      ; 005584bc | DAT_0310616c
    MOV dword ptr [ESP + 0x144],ESI     ; 005584c2
    MOV ESI,dword ptr [0x03106174]      ; 005584c9 | DAT_03106174
    ...
    POP EBX                             ; 00558536
    RET                                 ; 00558537
    MOV ESI,dword ptr [0x03106168]      ; 00558538 | DAT_03106168
        ;   Label: LAB_00558538
    MOV dword ptr [ESP + 0x144],ESI     ; 0055853e
    MOV ESI,dword ptr [0x03106170]      ; 00558545 | DAT_03106170
