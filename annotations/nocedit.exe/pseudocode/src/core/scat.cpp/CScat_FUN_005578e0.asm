...
;
; XREF[1]:
;   core_scat.cpp_CScat_process_FUN_005571f0 at 00557663
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 005578e0
        ;   Label: core_scat.cpp_CScat_FUN_005578e0
    PUSH ESI                            ; 005578e1
    PUSH EDI                            ; 005578e2
    PUSH EBP                            ; 005578e3
    ...
    MOV ESI,dword ptr [0x02db87d0]      ; 005578f9 | g_LocalHeroIndex
    MOV EDI,dword ptr [EBX + 0x1fbd0]   ; 005578ff
    MOV dword ptr [ESP + 0x70],EDX      ; 00557905
    MOV dword ptr [ESP + 0x74],ECX      ; 00557909
    MOV ESI,dword ptr [ESI*0x4 + 0x2db87c0] ; 0055790d | g_HeroActors
    TEST EDI,EDI                        ; 00557914
    JNZ 0x0055791f                      ; 00557916
        ;   XREF to: 0055791f (CONDITIONAL_JUMP)  ; LAB_0055791f
    ...
    PUSH EAX                            ; 00557929
    CALL crt_memory.c_memset_FUN_005fde40 ; 0055792a
        ;   XREF to: 005fde40 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
    MOV EAX,[0x02db87d0]                ; 0055792f | g_LocalHeroIndex
    LEA EDX,[EBX + 0x20]                ; 00557934
    MOV EAX,dword ptr [EAX*0x4 + 0x2db87c0] ; 00557937 | g_HeroActors
    ...
    JNZ 0x00557c94                      ; 00557969
        ;   XREF to: 00557c94 (CONDITIONAL_JUMP)  ; LAB_00557c94
    LEA EAX,[EBX + 0x1f738]             ; 0055796f
        ;   Label: LAB_0055796f
    MOV EAX,dword ptr [EAX + 0x330]     ; 00557975
    TEST EAX,EAX                        ; 0055797b
    JZ 0x005579b3                       ; 0055797d
        ;   XREF to: 005579b3 (CONDITIONAL_JUMP)  ; LAB_005579b3
    CMP dword ptr [EAX + 0x568],0x0     ; 0055797f
    JLE 0x005579b3                      ; 00557986
        ;   XREF to: 005579b3 (CONDITIONAL_JUMP)  ; LAB_005579b3
    MOV dword ptr [ESP + 0x60],0x461c3f9a ; 00557988
    LEA EAX,[ESP + 0x60]                ; 00557990
    PUSH EAX                            ; 00557994
    PUSH EBX                            ; 00557995
    CALL core_hero.cpp_CHero_FUN_004f3960 ; 00557996
    ...
    JGE 0x005579b3                      ; 005579aa
        ;   XREF to: 005579b3 (CONDITIONAL_JUMP)  ; LAB_005579b3
    MOV EDI,0x1                         ; 005579ac
    MOV ESI,EAX                         ; 005579b1
    CMP EDI,dword ptr [EBX + 0x1fbd4]   ; 005579b3
        ;   Label: LAB_005579b3
    JZ 0x005579c5                       ; 005579b9
        ;   XREF to: 005579c5 (CONDITIONAL_JUMP)  ; LAB_005579c5
    ...
    JNZ 0x00557a38                      ; 00557a30
        ;   XREF to: 00557a38 (CONDITIONAL_JUMP)  ; LAB_00557a38
    XOR EDX,EDX                         ; 00557a32
    MOV dword ptr [ESP + 0x14],EDX      ; 00557a34
    MOV ECX,dword ptr [EBX + 0x1fbe8]   ; 00557a38
        ;   Label: LAB_00557a38
    TEST ECX,ECX                        ; 00557a3e
    JZ 0x00557b63                       ; 00557a40
        ;   XREF to: 00557b63 (CONDITIONAL_JUMP)  ; LAB_00557b63
    XOR EAX,EAX                         ; 00557a46
    MOV EDX,dword ptr [ECX + 0x2e0]     ; 00557a48
    MOV dword ptr [ESP + 0x64],EAX      ; 00557a4e
    CMP EDX,0x8                         ; 00557a52
    JNZ 0x00557ca2                      ; 00557a55
        ;   XREF to: 00557ca2 (CONDITIONAL_JUMP)  ; LAB_00557ca2
    FLD float ptr [ESP + 0x14]          ; 00557a5b
    FCOMP double ptr [0x006413ec]       ; 00557a5f | DOUBLE_006413ec
    FNSTSW AX                           ; 00557a65
    SAHF                                ; 00557a67
    JNC 0x00557a9f                      ; 00557a68
        ;   XREF to: 00557a9f (CONDITIONAL_JUMP)  ; LAB_00557a9f
    LEA EAX,[EBX + 0x158]               ; 00557a6a
    PUSH EAX                            ; 00557a70
    CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0 ; 00557a71
        ;   XREF to: 0052dab0 (UNCONDITIONAL_CALL)  ; SMotion * core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0(CMotionController * this_ptr)
    MOV EAX,dword ptr [EAX + 0x24]      ; 00557a76
    ADD ESP,0x4                         ; 00557a79
    CMP EAX,0x7                         ; 00557a7c
    JNZ 0x00557a94                      ; 00557a7f
        ;   XREF to: 00557a94 (CONDITIONAL_JUMP)  ; LAB_00557a94
    CMP dword ptr [EBX + 0x1fbd4],0x0   ; 00557a81
    JZ 0x00557a94                       ; 00557a88
        ;   XREF to: 00557a94 (CONDITIONAL_JUMP)  ; LAB_00557a94
    MOV dword ptr [EBX + 0xbe38],0x1    ; 00557a8a
    CMP dword ptr [ESP + 0x64],0x0      ; 00557a94
        ;   Label: LAB_00557a94
    JZ 0x00557b63                       ; 00557a99
        ;   XREF to: 00557b63 (CONDITIONAL_JUMP)  ; LAB_00557b63
    PUSH ESI                            ; 00557a9f
        ;   Label: LAB_00557a9f
    ...
    JNZ 0x00557ac3                      ; 00557ab3
        ;   XREF to: 00557ac3 (CONDITIONAL_JUMP)  ; LAB_00557ac3
    LEA EAX,[ESI + 0x20]                ; 00557ab5
    PUSH EAX                            ; 00557ab8
    CALL core_path.cpp_getPathMap_FUN_00548500 ; 00557ab9
    ...
    PUSH EAX                            ; 00557acf
    PUSH EDX                            ; 00557ad0
    CALL core_path.cpp_CPathMap_findPathWithRetry_FUN_00547d00 ; 00557ad1
    ...
    FMUL double ptr [0x006413f4]        ; 00557afb | DOUBLE_006413f4
    ADD ESP,0x4                         ; 00557b01
    FMUL double ptr [0x006413fc]        ; 00557b04 | DOUBLE_006413fc
    ...
    FNSTSW AX                           ; 00557b1e
    SAHF                                ; 00557b20
    JNC 0x00557b2d                      ; 00557b21
        ;   XREF to: 00557b2d (CONDITIONAL_JUMP)  ; LAB_00557b2d
    ...
    FNSTSW AX                           ; 00557b37
    SAHF                                ; 00557b39
    JBE 0x00557b46                      ; 00557b3a
        ;   XREF to: 00557b46 (CONDITIONAL_JUMP)  ; LAB_00557b46
    MOV EAX,dword ptr [ESP + 0x70]      ; 00557b3c
    MOV dword ptr [EBX + 0xbe50],EAX    ; 00557b40
    FLD float ptr [ESP + 0x14]          ; 00557b46
        ;   Label: LAB_00557b46
    FCOMP double ptr [0x00641404]       ; 00557b4a | DOUBLE_00641404
    FNSTSW AX                           ; 00557b50
    SAHF                                ; 00557b52
    JNC 0x00557d0c                      ; 00557b53
        ;   XREF to: 00557d0c (CONDITIONAL_JUMP)  ; LAB_00557d0c
    ...
    JZ 0x00557ba7                       ; 00557b8d
        ;   XREF to: 00557ba7 (CONDITIONAL_JUMP)  ; LAB_00557ba7
    ...
    PUSH EAX                            ; 00557bb0
    CALL core_vecdir.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 00557bb1
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)  ; CVector3f * core_vecdir.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
    MOV ESI,EAX                         ; 00557bb6
    LEA EAX,[ESP + 0x5c]                ; 00557bb8
    ADD ESP,0x8                         ; 00557bbc
    CMP EAX,ESI                         ; 00557bbf
    JZ 0x00557bd7                       ; 00557bc1
        ;   XREF to: 00557bd7 (CONDITIONAL_JUMP)  ; LAB_00557bd7
    ...
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 00557be4
        ;   XREF to: 0040cd70 (UNCONDITIONAL_CALL)  ; float core_actor.cpp_normalizeAngleToPi_FUN_0040cd70(float angle_radians)
    ...
    FNSTSW AX                           ; 00557bfc
    SAHF                                ; 00557bfe
    JBE 0x00557c09                      ; 00557bff
        ;   XREF to: 00557c09 (CONDITIONAL_JUMP)  ; LAB_00557c09
    ...
    FNSTSW AX                           ; 00557c1b
    SAHF                                ; 00557c1d
    JNC 0x00557c28                      ; 00557c1e
        ;   XREF to: 00557c28 (CONDITIONAL_JUMP)  ; LAB_00557c28
    ...
    FXCH                                ; 00557c37
    FMUL double ptr [0x0064140c]        ; 00557c39 | DOUBLE_0064140c
    FXCH                                ; 00557c3f
    ...
    FNSTSW AX                           ; 00557c4d
    SAHF                                ; 00557c4f
    JBE 0x00557c59                      ; 00557c50
        ;   XREF to: 00557c59 (CONDITIONAL_JUMP)  ; LAB_00557c59
    FLD double ptr [ESP]                ; 00557c52
    FSTP float ptr [ESP + 0x10]         ; 00557c55
    FLD float ptr [EBP + 0x18]          ; 00557c59
        ;   Label: LAB_00557c59
    FMUL double ptr [0x00641414]        ; 00557c5c | DOUBLE_00641414
    ...
    FNSTSW AX                           ; 00557c70
    SAHF                                ; 00557c72
    JNC 0x00557c7d                      ; 00557c73
        ;   XREF to: 00557c7d (CONDITIONAL_JUMP)  ; LAB_00557c7d
    ...
    CMP EAX,0x3                         ; 00557c94
        ;   Label: LAB_00557c94
    JZ 0x0055796f                       ; 00557c97
        ;   XREF to: 0055796f (CONDITIONAL_JUMP)  ; LAB_0055796f
    JMP 0x005579b3                      ; 00557c9d
        ;   XREF to: 005579b3 (UNCONDITIONAL_JUMP)  ; LAB_005579b3
    FLD float ptr [ESP + 0x14]          ; 00557ca2
        ;   Label: LAB_00557ca2
    FCOMP double ptr [0x006413dc]       ; 00557ca6 | DOUBLE_006413dc
    FNSTSW AX                           ; 00557cac
    SAHF                                ; 00557cae
    JNC 0x00557a9f                      ; 00557caf
        ;   XREF to: 00557a9f (CONDITIONAL_JUMP)  ; LAB_00557a9f
    CMP dword ptr [EBX + 0x1fbd4],0x0   ; 00557cb5
    JZ 0x00557cf3                       ; 00557cbc
        ;   XREF to: 00557cf3 (CONDITIONAL_JUMP)  ; LAB_00557cf3
    TEST EDI,EDI                        ; 00557cbe
    JZ 0x00557cf3                       ; 00557cc0
        ;   XREF to: 00557cf3 (CONDITIONAL_JUMP)  ; LAB_00557cf3
    FLD float ptr [EBX + 0x2a90]        ; 00557cc2
    FCOMP double ptr [0x006413e4]       ; 00557cc8 | DOUBLE_006413e4
    FNSTSW AX                           ; 00557cce
    SAHF                                ; 00557cd0
    JBE 0x00557ce6                      ; 00557cd1
        ;   XREF to: 00557ce6 (CONDITIONAL_JUMP)  ; LAB_00557ce6
    CMP dword ptr [EBX + 0x1fbfc],0x0   ; 00557cd3
    JZ 0x00557ce6                       ; 00557cda
        ;   XREF to: 00557ce6 (CONDITIONAL_JUMP)  ; LAB_00557ce6
    ...
    PUSH EAX                            ; 00557ce9
    PUSH EBX                            ; 00557cea
    CALL core_charactr.cpp_CCharacter_turnTowardPoint_FUN_00428d80 ; 00557ceb
        ;   XREF to: 00428d80 (UNCONDITIONAL_CALL)  ; void core_charactr.cpp_CCharacter_turnTowardPoint_FUN_00428d80(CCharacter * this_ptr, CVector3f * target)
    ADD ESP,0x8                         ; 00557cf0
    MOV dword ptr [EBX + 0xbe34],0x0    ; 00557cf3
        ;   Label: LAB_00557cf3
    MOV dword ptr [EBX + 0xbe2c],0x0    ; 00557cfd
    JMP 0x00557a94                      ; 00557d07
        ;   XREF to: 00557a94 (UNCONDITIONAL_JUMP)  ; LAB_00557a94
    MOV dword ptr [EBX + 0xbe34],0x1    ; 00557d0c
        ;   Label: LAB_00557d0c
    JMP 0x00557b59                      ; 00557d16
        ;   XREF to: 00557b59 (UNCONDITIONAL_JUMP)  ; LAB_00557b59
