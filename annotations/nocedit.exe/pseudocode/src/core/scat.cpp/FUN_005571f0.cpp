...
LAB_00557637:
  ...
  if (in_stack_00000004->grabbed_by == (CDemonActor *)0x0) {
    ...
    *(float *)(in_stack_00000004->field2_0x240c + 0x20) =
    ...
    local_4c = fVar12 + fVar1 + local_64;
...
LAB_00557408:
  ...
  if ((iVar10 == 0) &&
    ...
    this_ptr_00 = pCStack_20;
    source_quaternions = (CQuaternion4f *)&stack0xffffff7c;
    *(uint *)(&stack0xffffff80 + (uint)bVar14 * -8) =
         *(uint *)(&stack0xffffff90 + (uint)bVar14 * -8);
    ...
    *(uint *)
    ...
    core_skeleton_cpp_CDeformableModelInstance_blendBoneRotations_FUN_0059f750
              (this_ptr_00,source_quaternions,(float)pCVar11,iVar10,blend_callback);
  }
