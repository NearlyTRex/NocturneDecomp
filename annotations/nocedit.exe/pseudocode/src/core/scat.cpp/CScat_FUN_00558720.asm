...
section .text
    ...
    PUSH EBX                            ; 00558720
        ;   Label: core_scat.cpp_CScat_FUN_00558720
    PUSH ESI                            ; 00558721
    PUSH EDI                            ; 00558722
    PUSH EBP                            ; 00558723
    ...
    JZ 0x00558916                       ; 00558741
        ;   XREF to: 00558916 (CONDITIONAL_JUMP)  ; LAB_00558916
    ...
    JNZ 0x0055893d                      ; 00558766
        ;   XREF to: 0055893d (CONDITIONAL_JUMP)  ; LAB_0055893d
    CMP dword ptr [ESI + 0x1fbd4],0x0   ; 0055876c
        ;   Label: LAB_0055876c
    JNZ 0x005589b5                      ; 00558773
        ;   XREF to: 005589b5 (CONDITIONAL_JUMP)  ; LAB_005589b5
    MOV dword ptr [ESI + 0x1fbf8],0x0   ; 00558779
        ;   Label: LAB_00558779
    CMP dword ptr [ESI + 0xbe38],0x0    ; 00558783
        ;   Label: LAB_00558783
    JZ 0x00558a81                       ; 0055878a
        ;   XREF to: 00558a81 (CONDITIONAL_JUMP)  ; LAB_00558a81
    MOV EBX,dword ptr [ESI + 0x1fbf8]   ; 00558790
    TEST EBX,EBX                        ; 00558796
    JNZ 0x005587bd                      ; 00558798
        ;   XREF to: 005587bd (CONDITIONAL_JUMP)  ; LAB_005587bd
    ...
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 005587d0
    ...
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 005587ff
        ;   XREF to: 0040cd70 (UNCONDITIONAL_CALL)  ; float core_actor.cpp_normalizeAngleToPi_FUN_0040cd70(float angle_radians)
    MOV dword ptr [ESP + 0x12c],EAX     ; 00558804
    FLD float ptr [ESP + 0x12c]         ; 0055880b
    ADD ESP,0x4                         ; 00558812
    FLD float ptr [EBP + 0x18]          ; 00558815
    FMUL double ptr [0x0064144c]        ; 00558818 | DOUBLE_0064144c
    FMUL double ptr [0x00641464]        ; 0055881e | DOUBLE_00641464
    ...
    FNSTSW AX                           ; 0055884b
    SAHF                                ; 0055884d
    JNC 0x0055885e                      ; 0055884e
        ;   XREF to: 0055885e (CONDITIONAL_JUMP)  ; LAB_0055885e
    ...
    FNSTSW AX                           ; 0055886c
    SAHF                                ; 0055886e
    JBE 0x0055887f                      ; 0055886f
        ;   XREF to: 0055887f (CONDITIONAL_JUMP)  ; LAB_0055887f
    ...
    FNSTSW AX                           ; 0055889d
    SAHF                                ; 0055889f
    JNC 0x005588b0                      ; 005588a0
        ;   XREF to: 005588b0 (CONDITIONAL_JUMP)  ; LAB_005588b0
    ...
    FNSTSW AX                           ; 005588be
    SAHF                                ; 005588c0
    JBE 0x005588d1                      ; 005588c1
        ;   XREF to: 005588d1 (CONDITIONAL_JUMP)  ; LAB_005588d1
    ...
    JZ 0x0055890f                       ; 00558903
        ;   XREF to: 0055890f (CONDITIONAL_JUMP)  ; LAB_0055890f
    CMP dword ptr [EBP + 0x1c],0x0      ; 00558905
    JZ 0x00558c5d                       ; 00558909
        ;   XREF to: 00558c5d (CONDITIONAL_JUMP)  ; LAB_00558c5d
    ...
    LEA EAX,[ESI + 0x158]               ; 00558916
        ;   Label: LAB_00558916
    PUSH EAX                            ; 0055891c
    CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0 ; 0055891d
        ;   XREF to: 0052dab0 (UNCONDITIONAL_CALL)  ; SMotion * core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0(CMotionController * this_ptr)
    MOV EAX,dword ptr [EAX + 0x24]      ; 00558922
    ADD ESP,0x4                         ; 00558925
    CMP EAX,0x2                         ; 00558928
    JNZ 0x00558747                      ; 0055892b
        ;   XREF to: 00558747 (CONDITIONAL_JUMP)  ; LAB_00558747
    MOV dword ptr [EBP + 0x1c],0x1      ; 00558931
    JMP 0x00558747                      ; 00558938
        ;   XREF to: 00558747 (UNCONDITIONAL_JUMP)  ; LAB_00558747
    CMP dword ptr [ESI + 0xbe28],0x2    ; 0055893d
        ;   Label: LAB_0055893d
    JZ 0x0055876c                       ; 00558944
        ;   XREF to: 0055876c (CONDITIONAL_JUMP)  ; LAB_0055876c
    FLD float ptr [ESI + 0xbe54]        ; 0055894a
    FMUL double ptr [0x0064144c]        ; 00558950 | DOUBLE_0064144c
    FMUL double ptr [0x00641454]        ; 00558956 | DOUBLE_00641454
    ...
    FCOMP float ptr [0x0064145c]        ; 00558979 | FLOAT_0064145c
    FNSTSW AX                           ; 0055897f
    SAHF                                ; 00558981
    JNC 0x0055898c                      ; 00558982
        ;   XREF to: 0055898c (CONDITIONAL_JUMP)  ; LAB_0055898c
    ...
    FNSTSW AX                           ; 00558997
    SAHF                                ; 00558999
    JBE 0x005589a7                      ; 0055899a
        ;   XREF to: 005589a7 (CONDITIONAL_JUMP)  ; LAB_005589a7
    ...
    JMP 0x005587bd                      ; 005589b0
        ;   XREF to: 005587bd (UNCONDITIONAL_JUMP)  ; LAB_005587bd
    MOV EDI,dword ptr [EBP + 0x1c]      ; 005589b5
        ;   Label: LAB_005589b5
    TEST EDI,EDI                        ; 005589b8
    JNZ 0x00558779                      ; 005589ba
        ;   XREF to: 00558779 (CONDITIONAL_JUMP)  ; LAB_00558779
    CMP dword ptr [ESI + 0xbe38],0x0    ; 005589c0
    JNZ 0x00558783                      ; 005589c7
        ;   XREF to: 00558783 (CONDITIONAL_JUMP)  ; LAB_00558783
    ...
    PUSH EBX                            ; 00558a15
    PUSH ESI                            ; 00558a16
    CALL core_scat.cpp_CScat_FUN_00558cf0 ; 00558a17
        ;   XREF to: 00558cf0 (UNCONDITIONAL_CALL)  ; int core_scat.cpp_CScat_FUN_00558cf0(CScat * this_ptr)
    ...
    JMP 0x005589e7                      ; 00558a4b
        ;   XREF to: 005589e7 (UNCONDITIONAL_JUMP)  ; LAB_005589e7
    FLD float ptr [ESP]                 ; 00558a4d
        ;   Label: LAB_00558a4d
    FCOMP float ptr [ESP + 0x11c]       ; 00558a50
    FNSTSW AX                           ; 00558a57
    SAHF                                ; 00558a59
    JNC 0x00558a39                      ; 00558a5a
        ;   XREF to: 00558a39 (CONDITIONAL_JUMP)  ; LAB_00558a39
    MOV EAX,dword ptr [ESP]             ; 00558a5c
    MOV dword ptr [ESP + 0x118],EBX     ; 00558a5f
    MOV dword ptr [ESP + 0x11c],EAX     ; 00558a66
    JMP 0x00558a39                      ; 00558a6d
        ;   XREF to: 00558a39 (UNCONDITIONAL_JUMP)  ; LAB_00558a39
    MOV EAX,dword ptr [ESP + 0x118]     ; 00558a6f
        ;   Label: LAB_00558a6f
    MOV dword ptr [ESI + 0x1fbf8],EAX   ; 00558a76
    JMP 0x00558783                      ; 00558a7c
        ;   XREF to: 00558783 (UNCONDITIONAL_JUMP)  ; LAB_00558783
    CMP dword ptr [ESI + 0x1fbf8],0x0   ; 00558a81
        ;   Label: LAB_00558a81
    JZ 0x005587bd                       ; 00558a88
        ;   XREF to: 005587bd (CONDITIONAL_JUMP)  ; LAB_005587bd
    PUSH 0x6598c0                       ; 00558a8e | g_CVectorTypeInfo
    PUSH 0xa                            ; 00558a93
    LEA EAX,[ESP + 0x10]                ; 00558a95
    PUSH EAX                            ; 00558a99
    CALL crt_memory.c___arrinit_FUN_005fe667 ; 00558a9a
    ...
    JLE 0x00558bad                      ; 00558abc
        ;   XREF to: 00558bad (CONDITIONAL_JUMP)  ; LAB_00558bad
    LEA EBX,[ESP + 0xe0]                ; 00558ac2
    LEA EAX,[ESP + 0x8]                 ; 00558ac9
    CMP EBX,EAX                         ; 00558acd
    JZ 0x00558af2                       ; 00558acf
        ;   XREF to: 00558af2 (CONDITIONAL_JUMP)  ; LAB_00558af2
    ...
    PUSH EDX                            ; 00558b08
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 00558b09
    ...
    FXCH                                ; 00558bdc
    FLD float ptr [0x00641460]          ; 00558bde | FLOAT_00641460
    FXCH                                ; 00558be4
    FMUL ST1                            ; 00558be6
    FXCH ST2                            ; 00558be8
    ...
    JMP 0x00558aeb                      ; 00558c58
        ;   XREF to: 00558aeb (UNCONDITIONAL_JUMP)  ; LAB_00558aeb
    FLD float ptr [ESI + 0x1fbf0]       ; 00558c5d
        ;   Label: LAB_00558c5d
    FSUB float ptr [ESP + 0x114]        ; 00558c63
    SUB ESP,0x4                         ; 00558c6a
    FSTP float ptr [ESP]                ; 00558c6d
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 00558c70
        ;   XREF to: 0040cd70 (UNCONDITIONAL_CALL)  ; float core_actor.cpp_normalizeAngleToPi_FUN_0040cd70(float angle_radians)
    MOV dword ptr [ESP + 0x12c],EAX     ; 00558c75
    FLD float ptr [ESP + 0x12c]         ; 00558c7c
    FABS                                ; 00558c83
    ADD ESP,0x4                         ; 00558c85
    FCOMP double ptr [0x0064146c]       ; 00558c88 | DOUBLE_0064146c
    FNSTSW AX                           ; 00558c8e
    SAHF                                ; 00558c90
    JNC 0x00558ca4                      ; 00558c91
        ;   XREF to: 00558ca4 (CONDITIONAL_JUMP)  ; LAB_00558ca4
    ...
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 00558cb7
        ;   XREF to: 0040cd70 (UNCONDITIONAL_CALL)  ; float core_actor.cpp_normalizeAngleToPi_FUN_0040cd70(float angle_radians)
    MOV dword ptr [ESP + 0x12c],EAX     ; 00558cbc
    FLD float ptr [ESP + 0x12c]         ; 00558cc3
    FABS                                ; 00558cca
    ADD ESP,0x4                         ; 00558ccc
    FCOMP double ptr [0x0064146c]       ; 00558ccf | DOUBLE_0064146c
    FNSTSW AX                           ; 00558cd5
    SAHF                                ; 00558cd7
    JC 0x00558c93                       ; 00558cd8
        ;   XREF to: 00558c93 (CONDITIONAL_JUMP)  ; LAB_00558c93
