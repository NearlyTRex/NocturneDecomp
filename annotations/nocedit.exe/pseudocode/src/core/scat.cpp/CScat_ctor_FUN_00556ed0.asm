...
;                               FUNCTION
; *****************************************************************************
; __cdecl CScat * core_scat.cpp_CScat_ctor_FUN_00556ed0(CScat * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 00556ed5
    CALL core_hero.cpp_FUN_004f2340     ; 00556ed6 | undefined core_hero.cpp_FUN_004f2340()
        ;   XREF to: 004f2340 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00556edb
    MOV EBX,EAX                         ; 00556ede
    ADD EAX,0x158                       ; 00556ee0
    PUSH 0x641211                       ; 00556ee5 | = "scat.dfm" | s_scat_dfm_00641211 = scat.dfm
    MOV dword ptr [EAX + -0x4],0x662464 ; 00556eea | CDemonActor_vtable PTR_core_scat.cpp_FUN_00662464
    PUSH EAX                            ; 00556ef1
    MOV dword ptr [EAX + 0x1fa7c],0x0   ; 00556ef2
    CALL core_skeleton.cpp_CDeformableModelInstance_init_FUN_005a0840 ; 00556efc | void core_skeleton.cpp_CDeformableModelInstance_init_FUN_005a0840(CDeformableModelInstance * this_ptr, char * model_name)
    ...
    CALL core_scat.cpp_FUN_00557150     ; 00556f27 | undefined core_scat.cpp_FUN_00557150()
    ...
    PUSH 0x64121a                       ; 00556f45 | = "draw_stand2coatPocket" | s_draw_stand2coatPocket_0064121a = draw_stand2coatPocket
    ...
    CALL core_charactr.cpp_CCharacter_addLayerAction_FUN_0042e5d0 ; 00556f6f | void core_charactr.cpp_CCharacter_addLayerAction_FUN_0042e5d0(CCharacter * this_ptr)
        ;   XREF to: 0042e5d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 00556f74
    PUSH 0x0                            ; 00556f77
    PUSH 0x641230                       ; 00556f79 | = "draw_coatPocket2aimPistols" | s_draw_coatPocket2aimPisto_00641230 = draw_coatPocket2aimPistols
    PUSH 0x2                            ; 00556f7e
    PUSH 0x1                            ; 00556f80
    PUSH EBX                            ; 00556f82
    CALL core_charactr.cpp_CCharacter_addLayerAction_FUN_0042e5d0 ; 00556f83 | void core_charactr.cpp_CCharacter_addLayerAction_FUN_0042e5d0(CCharacter * this_ptr)
        ;   XREF to: 0042e5d0 (UNCONDITIONAL_CALL)
