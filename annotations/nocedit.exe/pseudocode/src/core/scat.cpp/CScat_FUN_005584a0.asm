...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_scat_cpp_CScat_FUN_005584a0(CScat *this_ptr)
;
; Parameters:
...
;
; XREF[1]:
;   core_scat.cpp_CScat_FUN_005582c0 at 00558486
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 005584a0
        ;   Label: core_scat.cpp_CScat_FUN_005584a0
    PUSH ESI                            ; 005584a1
    PUSH EDI                            ; 005584a2
    PUSH EBP                            ; 005584a3
