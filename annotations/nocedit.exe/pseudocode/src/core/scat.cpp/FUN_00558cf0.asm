...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_scat.cpp_FUN_00558cf0()
;
; Local Variables:
...
section .text
    ...
    PUSH EDX                            ; 00558d0b
    PUSH ESI                            ; 00558d0c
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 00558d0d | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00558d12
    PUSH 0x6598c0                       ; 00558d15 | WatcomTypeInfo g_CVectorTypeInfo
    PUSH 0xa                            ; 00558d1a
    MOV EBX,EAX                         ; 00558d1c
    LEA EAX,[ESP + 0x20]                ; 00558d1e
    PUSH EAX                            ; 00558d22
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 00558d23 | void * crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
    ...
    JZ 0x00558d59                       ; 00558d3f | LAB_00558d59
        ;   XREF to: 00558d59 (CONDITIONAL_JUMP)
    TEST EBX,EBX                        ; 00558d41
    JZ 0x00558d72                       ; 00558d43 | LAB_00558d72
    ...
    JLE 0x00558d72                      ; 00558d57 | LAB_00558d72
        ;   XREF to: 00558d72 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 00558d7d
    PUSH EDI                            ; 00558d7e
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 00558d7f | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
    ...
    FNSTSW AX                           ; 00558d92
    SAHF                                ; 00558d94
    JNC 0x00558d59                      ; 00558d95 | LAB_00558d59
        ;   XREF to: 00558d59 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 00558dd6
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 00558dd7 | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
    ...
    JZ 0x00558e2b                       ; 00558deb | LAB_00558e2b
        ;   XREF to: 00558e2b (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x14]          ; 00558ded
    FCOMP double ptr [0x0064148c]       ; 00558df1 | double DOUBLE_0064148c
    FNSTSW AX                           ; 00558df7
    SAHF                                ; 00558df9
    JA 0x00558d59                       ; 00558dfa | LAB_00558d59
        ;   XREF to: 00558d59 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x10]          ; 00558e00
    FST double ptr [ESP + 0x8]          ; 00558e04
    FCOMP double ptr [0x00641494]       ; 00558e08 | double DOUBLE_00641494
    FNSTSW AX                           ; 00558e0e
    SAHF                                ; 00558e10
    JC 0x00558d59                       ; 00558e11 | LAB_00558d59
        ;   XREF to: 00558d59 (CONDITIONAL_JUMP)
    FLD double ptr [ESP + 0x8]          ; 00558e17
    FCOMP double ptr [0x0064149c]       ; 00558e1b | double DOUBLE_0064149c
    FNSTSW AX                           ; 00558e21
    SAHF                                ; 00558e23
    JBE 0x00558e66                      ; 00558e24 | LAB_00558e66
        ;   XREF to: 00558e66 (CONDITIONAL_JUMP)
    JMP 0x00558d59                      ; 00558e26 | LAB_00558d59
        ;   XREF to: 00558d59 (UNCONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x14]          ; 00558e2b
        ;   Label: LAB_00558e2b
    FCOMP double ptr [0x00641474]       ; 00558e2f | double DOUBLE_00641474
    FNSTSW AX                           ; 00558e35
    SAHF                                ; 00558e37
    JA 0x00558d59                       ; 00558e38 | LAB_00558d59
        ;   XREF to: 00558d59 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x10]          ; 00558e3e
    FST double ptr [ESP]                ; 00558e42
    FCOMP double ptr [0x0064147c]       ; 00558e45 | double DOUBLE_0064147c
    FNSTSW AX                           ; 00558e4b
    SAHF                                ; 00558e4d
    JC 0x00558d59                       ; 00558e4e | LAB_00558d59
        ;   XREF to: 00558d59 (CONDITIONAL_JUMP)
    FLD double ptr [ESP]                ; 00558e54
    FCOMP double ptr [0x00641484]       ; 00558e57 | double DOUBLE_00641484
    FNSTSW AX                           ; 00558e5d
    SAHF                                ; 00558e5f
    JA 0x00558d59                       ; 00558e60 | LAB_00558d59
        ;   XREF to: 00558d59 (CONDITIONAL_JUMP)
    ...
    FXCH                                ; 00558e8f
    FLD float ptr [0x006414a4]          ; 00558e91 | float FLOAT_006414a4
    FXCH                                ; 00558e97
    FMUL ST1                            ; 00558e99
    FXCH ST2                            ; 00558e9b
    ...
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 00558f15 | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
        ;   XREF to: 00408ec0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00558f1a
    PUSH 0x1                            ; 00558f1d
    MOV EAX,[0x006810c8]                ; 00558f1f | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
    PUSH EAX                            ; 00558f24 | CDemonSet g_CDemonSetInstance
    CALL core_setcolid.cpp_CDemonSet_setRayType_FUN_00574230 ; 00558f25 | void core_setcolid.cpp_CDemonSet_setRayType_FUN_00574230(CDemonSet * this_ptr, int ray_type)
        ;   XREF to: 00574230 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00558f2a
    PUSH EDI                            ; 00558f2d
    MOV EDX,dword ptr [0x006810c8]      ; 00558f2e | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
    PUSH EDX                            ; 00558f34 | CDemonSet g_CDemonSetInstance
    CALL core_setcolid.cpp_CDemonSet_ignore_FUN_005741b0 ; 00558f35 | void core_setcolid.cpp_CDemonSet_ignore_FUN_005741b0(CDemonSet * this_ptr, CDemonActor * actor)
    ...
    PUSH EAX                            ; 00558f4c
    MOV ECX,dword ptr [0x006810c8]      ; 00558f4d | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
    PUSH ECX                            ; 00558f53 | CDemonSet g_CDemonSetInstance
    CALL core_setcolid.cpp_CDemonSet_raycast_FUN_00572530 ; 00558f54 | float core_setcolid.cpp_CDemonSet_raycast_FUN_00572530(CDemonSet * this_ptr, CVector3f * ray_origin, CVector3f * ray_target)
    ...
    MOV EBX,dword ptr [0x006810c8]      ; 00558f6a | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
    PUSH EBX                            ; 00558f70 | CDemonSet g_CDemonSetInstance
    FSTP float ptr [ESP + 0xf8]         ; 00558f71
    CALL core_setcolid.cpp_CDemonSet_initMaybe_FUN_00574180 ; 00558f78 | void core_setcolid.cpp_CDemonSet_initMaybe_FUN_00574180(CDemonSet * this_ptr)
    ...
    FNSTSW AX                           ; 00558f8b
    SAHF                                ; 00558f8d
    JC 0x00558d59                       ; 00558f8e | LAB_00558d59
        ;   XREF to: 00558d59 (CONDITIONAL_JUMP)
    MOV EAX,[0x006810c8]                ; 00558f94 | CDemonSet * g_CDemonSetPtr
    CMP ESI,dword ptr [EAX + 0x14d144]  ; 00558f99 | DAT_032613bc
    JNZ 0x00558d59                      ; 00558f9f | LAB_00558d59
        ;   XREF to: 00558d59 (CONDITIONAL_JUMP)
