...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_scat_cpp_CScat_writeDependencies_FUN_00559140(CScat *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x8]       ; 00559140
        ;   Label: core_scat.cpp_CScat_writeDependencies_FUN_00559140
    PUSH EDX                            ; 00559144
