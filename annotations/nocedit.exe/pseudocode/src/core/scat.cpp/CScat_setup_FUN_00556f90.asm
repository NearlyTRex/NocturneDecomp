...
section .text
    ...
    PUSH EBX                            ; 00556f90
        ;   Label: core_scat.cpp_CScat_setup_FUN_00556f90
    PUSH ESI                            ; 00556f91
    ...
    PUSH EBX                            ; 00556fc7
    MOV [0x0310615c],EAX                ; 00556fc8 | g_ScatIndices
    ...
    PUSH EBX                            ; 00556fdc
    MOV [0x03106160],EAX                ; 00556fdd | g_ScatIndices[1]
    ...
    PUSH EBX                            ; 00556ff1
    MOV [0x03106164],EAX                ; 00556ff2 | g_ScatIndices[2]
    ...
    PUSH EBX                            ; 00557006
    MOV [0x03106168],EAX                ; 00557007 | g_ScatIndices[3]
    ...
    PUSH EBX                            ; 0055701b
    MOV [0x0310616c],EAX                ; 0055701c | g_ScatIndices[4]
    ...
    PUSH EBX                            ; 00557030
    MOV [0x03106170],EAX                ; 00557031 | g_ScatIndices[5]
    ...
    PUSH EBX                            ; 00557045
    MOV [0x03106174],EAX                ; 00557046 | g_ScatIndices[6]
    ...
    PUSH EBX                            ; 0055705a
    MOV [0x03106178],EAX                ; 0055705b | g_ScatIndices[7]
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 00557060
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 00557065
    MOV [0x0310617c],EAX                ; 00557068 | g_ScatIndices[8]
    PUSH 0x1                            ; 0055706d
    ...
    PUSH EBX                            ; 00557084
    MOV [0x03106180],EAX                ; 00557085 | g_ScatIndices[9]
    ...
    PUSH EBX                            ; 00557099
    MOV [0x03106184],EAX                ; 0055709a | g_ScatIndices[10]
    ...
    PUSH EBX                            ; 005570ae
    MOV [0x03106188],EAX                ; 005570af | g_ScatIndices[11]
    ...
    PUSH EBX                            ; 005570c3
    MOV [0x0310618c],EAX                ; 005570c4 | g_ScatIndices[12]
    ...
    PUSH EBX                            ; 005570d8
    MOV [0x03106190],EAX                ; 005570d9 | g_ScatIndices[13]
    ...
    PUSH EBX                            ; 005570ed
    MOV [0x03106194],EAX                ; 005570ee | g_ScatIndices[14]
    ...
    PUSH EBX                            ; 00557102
    MOV [0x03106198],EAX                ; 00557103 | g_ScatIndices[15]
    ...
    PUSH EBX                            ; 00557117
    MOV [0x031061a0],EAX                ; 00557118 | g_ScatIndices[17]
    ...
    PUSH EBX                            ; 0055712c
    MOV [0x0310619c],EAX                ; 0055712d | g_ScatIndices[16]
