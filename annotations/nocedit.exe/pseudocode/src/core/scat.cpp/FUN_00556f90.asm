...
section .text
    ...
    PUSH ESI                            ; 00556f96
    CALL core_hero.cpp_CHero_FUN_004f2540 ; 00556f97
    ...
    PUSH EBX                            ; 00556fc7
    MOV [0x0310615c],EAX                ; 00556fc8 | DAT_0310615c
    ...
    PUSH EBX                            ; 00557006
    MOV [0x03106168],EAX                ; 00557007 | DAT_03106168
    ...
    PUSH EBX                            ; 0055701b
    MOV [0x0310616c],EAX                ; 0055701c | DAT_0310616c
    ...
    PUSH EBX                            ; 00557030
    MOV [0x03106170],EAX                ; 00557031 | DAT_03106170
    ...
    PUSH EBX                            ; 00557045
    MOV [0x03106174],EAX                ; 00557046 | DAT_03106174
    ...
    PUSH EBX                            ; 005570ed
    MOV [0x03106194],EAX                ; 005570ee | DAT_03106194
    ...
    PUSH EBX                            ; 0055712c
    MOV [0x0310619c],EAX                ; 0055712d | DAT_0310619c
