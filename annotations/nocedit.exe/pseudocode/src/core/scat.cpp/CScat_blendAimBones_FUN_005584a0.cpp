...

{
  ...
  if (hand_index == 0) {
    ...
    puVar2 = (uint *)((int)&local_fc + (uint)bVar6 * -8 + (uint)bVar6 * -8 + 8);
    puVar1 = (uint *)((int)&local_cc + (uint)bVar6 * -8 + (uint)bVar6 * -8 + 8);
    *(uint *)((int)&local_fc + (uint)bVar6 * -8 + 4) =
         *(uint *)((int)&local_cc + (uint)bVar6 * -8 + 4);
    *puVar2 = *puVar1;
    puVar2[(uint)bVar6 * -2 + 1] = puVar1[(uint)bVar6 * -2 + 1];
    ...
    puVar2 = (uint *)((int)&local_fc + (uint)bVar6 * -8 + (uint)bVar6 * -8 + 8);
    puVar1 = (uint *)((int)&local_ac + (uint)bVar6 * -8 + (uint)bVar6 * -8 + 8);
    *(uint *)((int)&local_fc + (uint)bVar6 * -8 + 4) =
  ...
  puVar1 = (uint *)((int)&local_13c + (uint)bVar6 * -8 + (uint)bVar6 * -8 + 8);
  puVar4 = puVar3 + (uint)bVar6 * -2 + 1;
  *(uint *)((int)&local_13c + (uint)bVar6 * -8 + 4) = *puVar3;
  *puVar1 = *puVar4;
  puVar1[(uint)bVar6 * -2 + 1] = puVar4[(uint)bVar6 * -2 + 1];
  ...
  puVar2 = (uint *)((int)&local_10c + (uint)bVar6 * -8 + (uint)bVar6 * -8 + 8);
  puVar1 = (uint *)((int)&local_7c + (uint)bVar6 * -8 + (uint)bVar6 * -8 + 8);
  ...
  *puVar2 = *puVar1;
  ...
  puVar1 = (uint *)((int)&local_14c + (uint)bVar6 * -8 + (uint)bVar6 * -8 + 8);
  ...
  *puVar2 = *puVar1;
  ...
  puVar2 = (uint *)((int)&local_12c + (uint)bVar6 * -8 + (uint)bVar6 * -8 + 8);
  puVar1 = (uint *)((int)&local_15c + (uint)bVar6 * -8 + (uint)bVar6 * -8 + 8);
  ...
  *puVar2 = *puVar1;
  ...
  puVar2 = (uint *)((int)&local_ec + (uint)bVar6 * -8 + (uint)bVar6 * -8 + 8);
  puVar1 = (uint *)((int)&local_4c + (uint)bVar6 * -8 + (uint)bVar6 * -8 + 8);
  ...
  *puVar2 = *puVar1;
  ...
  puVar2 = (uint *)((int)&local_2c + (uint)bVar6 * -8 + (uint)bVar6 * -8 + 8);
  puVar1 = (uint *)((int)&local_3c + (uint)bVar6 * -8 + (uint)bVar6 * -8 + 8);
  *(uint *)((int)&local_2c + (uint)bVar6 * -8 + 4) =
       *(uint *)((int)&local_3c + (uint)bVar6 * -8 + 4);
  *puVar2 = *puVar1;
  puVar2[(uint)bVar6 * -2 + 1] = puVar1[(uint)bVar6 * -2 + 1];
  core_xform_cpp_slerpQuaternion_FUN_005f77e0
            ((this_ptr->base).base.model.bone_transform.bone_rotations + local_1c,&local_2c,t,
             &local_8c);
  pCVar3 = (this_ptr->base).base.model.bone_transform.bone_rotations + local_1c;
  puVar2 = (uint *)((int)pCVar3 + ((uint)bVar6 * -2 + 1) * 4);
  pCVar3->w = local_8c.w;
  puVar5 = puVar2 + (uint)bVar6 * -2 + 1;
  puVar1 = (uint *)((int)&local_8c + (uint)bVar6 * -8 + (uint)bVar6 * -8 + 8);
  *puVar2 = *(uint *)((int)&local_8c + (uint)bVar6 * -8 + 4);
  *puVar5 = *puVar1;
  puVar5[(uint)bVar6 * -2 + 1] = puVar1[(uint)bVar6 * -2 + 1];
  pCVar3 = &local_12c;
  ...
  puVar1 = (uint *)((int)&local_5c + (uint)bVar6 * -8 + (uint)bVar6 * -8 + 8);
  ...
  *puVar2 = *puVar1;
  ...
  puVar2 = (uint *)((int)&local_2c + (uint)bVar6 * -8 + (uint)bVar6 * -8 + 8);
  puVar1 = (uint *)((int)&local_6c + (uint)bVar6 * -8 + (uint)bVar6 * -8 + 8);
  *(uint *)((int)&local_2c + (uint)bVar6 * -8 + 4) =
