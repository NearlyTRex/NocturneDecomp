...

{
  ...
  core_skeleton_cpp_CDeformableModelInstance_init_FUN_005a0840
            (&(this_ptr_00->base_hero).base_character.model,"scat.dfm");
  ...
  *(uint *)(this_ptr_00->field1_0x1fbd4 + 8) =
       *(uint *)(this_ptr_00->field1_0x1fbd4 + 0xc);
  *(uint *)(this_ptr_00->field1_0x1fbd4 + 4) =
       *(uint *)(this_ptr_00->field1_0x1fbd4 + 8);
