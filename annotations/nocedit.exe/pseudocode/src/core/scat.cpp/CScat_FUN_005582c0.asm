...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_scat_cpp_CScat_FUN_005582c0(CScat *this_ptr)
;
; Parameters:
...
;   core_scat.cpp_CScat_FUN_005584a0
...
section .text
    ...
    PUSH EBX                            ; 005582c0
        ;   Label: core_scat.cpp_CScat_FUN_005582c0
    PUSH ESI                            ; 005582c1
    PUSH EDI                            ; 005582c2
    PUSH EBP                            ; 005582c3
    ...
    PUSH ECX                            ; 00558484
        ;   Label: LAB_00558484
    PUSH EBX                            ; 00558485
    CALL core_scat.cpp_CScat_FUN_005584a0 ; 00558486
        ;   XREF to: 005584a0 (UNCONDITIONAL_CALL)  ; void core_scat.cpp_CScat_FUN_005584a0(CScat * this_ptr)
