...

{
  ...
  *puVar5 = *puVar4;
  ...
  core_xform_cpp_quaternionFromAngleY_FUN_005f79f0(*(float *)(this_ptr->unk + 0x1c),&local_7c);
  ...
  *puVar4 = *puVar3;
  puVar4[(uint)bVar6 * -2 + 1] = puVar3[(uint)bVar6 * -2 + 1];
  pCVar2 = &local_10c;
  core_xform_cpp_quaternionFromAngleX_FUN_005f79b0(*(float *)(this_ptr->unk + 0x18),&local_14c);
