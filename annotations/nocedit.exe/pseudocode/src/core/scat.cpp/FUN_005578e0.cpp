...

{
  ...
  local_30 = (in_stack_00000004->base_actor).location.position.z -
  ...
  if ((((*(int *)(in_stack_00000004[2].cloth_data + 0x54f0) == 2) ||
    ...
    if ((pCVar2 != (CHero *)0x0) && (local_2c < 0x41f00000)) {
      iVar6 = 1;
      this_ptr_00 = pCVar2;
    }
  }
  ...
  local_5c = (this_ptr_00->base_character).base_actor.location.position.x -
             (in_stack_00000004->base_actor).location.position.x;
  local_58 = (this_ptr_00->base_character).base_actor.location.position.y -
             (in_stack_00000004->base_actor).location.position.y;
  fStack_54 = (this_ptr_00->base_character).base_actor.location.position.z -
              (in_stack_00000004->base_actor).location.position.z;
  if ((float *)local_38 != &local_5c) {
    local_38._0_4_ = local_5c;
    local_38._4_4_ = local_58;
    local_30 = fStack_54;
  }
  local_78 = SQRT(local_30 * local_30 +
...
LAB_00557b63:
  local_74 = (this_ptr_00->base_character).base_actor.location.position.x -
             (in_stack_00000004->base_actor).location.position.x;
  local_70 = (this_ptr_00->base_character).base_actor.location.position.y -
             (in_stack_00000004->base_actor).location.position.y;
  fStack_6c = (this_ptr_00->base_character).base_actor.location.position.z -
              (in_stack_00000004->base_actor).location.position.z;
  if ((float *)local_38 != &local_74) {
    local_38._0_4_ = local_74;
    local_38._4_4_ = local_70;
    local_30 = fStack_6c;
  }
  pCVar5 = core_vehicle_cpp_convertDirectionVectorToEulerAngles_FUN_005e7830
                     (&CStack_68,(CVector3f *)local_38);
  if ((CVector3f *)(local_38 + 4) != pCVar5) {
    local_38._0_4_ = pCVar5->x;
    local_38._4_4_ = pCVar5->y;
    local_30 = pCVar5->z;
  }
  fStack_40 = core_actor_cpp_normalizeAngleToPi_FUN_0040cd70
                        ((float)local_38._4_4_ - (in_stack_00000004->base_actor).orient.bank);
