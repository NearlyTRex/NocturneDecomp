...
section .text
    ...
    PUSH EBX                            ; 00557ea0
        ;   Label: core_scat.cpp_CScat_processDamage_FUN_00557ea0
    PUSH ESI                            ; 00557ea1
    PUSH EDI                            ; 00557ea2
    PUSH EBP                            ; 00557ea3
    ...
    MOV EAX,[0x0067b654]                ; 00557eb8 | g_CGamePtr
        ;   Label: LAB_00557eb8
    CMP dword ptr [EAX + 0x1d0],0x0     ; 00557ebd | g_CGameInstance.god_mode_enabled
    ...
    MOV EAX,[0x0067b654]                ; 00557ecd | g_CGamePtr
        ;   Label: LAB_00557ecd
    MOV ESI,dword ptr [EAX + 0x22c]     ; 00557ed2 | g_CGameInstance.allow_damage_flag
    ...
    PUSH EDI                            ; 00557f15
    PUSH EBX                            ; 00557f16
    CALL core_charactr.cpp_CCharacter_processDamage_FUN_0042c3c0 ; 00557f17
    ...
    CALL core_gore.cpp_CGore_spawnFliesOnActor_FUN_004ee030 ; 00557f86
    ...
    PUSH EDI                            ; 00557fa0
    PUSH EBX                            ; 00557fa1
    CALL core_charactr.cpp_CCharacter_processDamage_FUN_0042c3c0 ; 00557fa2
        ;   XREF to: 0042c3c0 (UNCONDITIONAL_CALL)  ; void core_charactr.cpp_CCharacter_processDamage_FUN_0042c3c0(CCharacter * this_ptr, SDamageInfo * damage_info)
    ...
    PUSH EDI                            ; 00557fdb
    PUSH EBX                            ; 00557fdc
    CALL core_charactr.cpp_CCharacter_processDamage_FUN_0042c3c0 ; 00557fdd
        ;   XREF to: 0042c3c0 (UNCONDITIONAL_CALL)  ; void core_charactr.cpp_CCharacter_processDamage_FUN_0042c3c0(CCharacter * this_ptr, SDamageInfo * damage_info)
