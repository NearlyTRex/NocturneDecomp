...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_scat.cpp_FUN_00558060()
;
; Local Variables:
...
;
; XREF[1]:
;   core_scat.cpp_FUN_005571f0 at 00557435
;
; Referenced Globals:
...
section .text
    ...
    PUSH ESI                            ; 00558075
    CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0 ; 00558076 | SMotion * core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0(CMotionController * this_ptr)
        ;   XREF to: 0052dab0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EAX + 0x24]      ; 0055807b
    ADD ESP,0x4                         ; 0055807e
    CMP EAX,0xc                         ; 00558081
    JNZ 0x0055808d                      ; 00558084 | LAB_0055808d
    ...
    PUSH ESI                            ; 0055808d
        ;   Label: LAB_0055808d
    CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0 ; 0055808e | SMotion * core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0(CMotionController * this_ptr)
        ;   XREF to: 0052dab0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EAX + 0x24]      ; 00558093
    ADD ESP,0x4                         ; 00558096
    CMP EAX,0xd                         ; 00558099
    JZ 0x00558086                       ; 0055809c | LAB_00558086
    ...
    PUSH EAX                            ; 0055810f
    PUSH EBX                            ; 00558110
    CALL core_charactr.cpp_CCharacter_advanceLayerAction_FUN_0042e370 ; 00558111 | int core_charactr.cpp_CCharacter_advanceLayerAction_FUN_0042e370(CCharacter * this_ptr)
    ...
    PUSH EAX                            ; 00558125
    CALL core_motion.cpp_CMotionController_getMotionList_FUN_0052dce0 ; 00558126 | CMotionList * core_motion.cpp_CMotionController_getMotionList_FUN_0052dce0(CMotionController * this_ptr)
        ;   XREF to: 0052dce0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0055812b
    CMP dword ptr [ESP],0x0             ; 0055812e
    JL 0x005581db                       ; 00558132 | LAB_005581db
        ;   XREF to: 005581db (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [EBX + 0x1fbe8]   ; 00558138
    CMP ESI,ECX                         ; 0055813e
    JZ 0x005581d1                       ; 00558140 | LAB_005581d1
        ;   XREF to: 005581d1 (CONDITIONAL_JUMP)
    TEST ECX,ECX                        ; 00558146
    JZ 0x0055817a                       ; 00558148 | LAB_0055817a
        ;   XREF to: 0055817a (CONDITIONAL_JUMP)
    MOV EAX,ECX                         ; 0055814a
    JNZ 0x00558285                      ; 0055814c | LAB_00558285
        ;   XREF to: 00558285 (CONDITIONAL_JUMP)
    CMP EAX,dword ptr [ESP + 0x8]       ; 00558152
        ;   Label: LAB_00558152
    JNZ 0x0055817a                      ; 00558156 | LAB_0055817a
        ;   XREF to: 0055817a (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 00558158
    ...
    JNZ 0x005581d1                      ; 005581be | LAB_005581d1
        ;   XREF to: 005581d1 (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 005581c0
    PUSH 0x6                            ; 005581c2
    MOV ECX,dword ptr [ESP + 0xc]       ; 005581c4
    PUSH ECX                            ; 005581c8
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 005581c9 | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005581ce
    PUSH EDI                            ; 005581d1
        ;   Label: LAB_005581d1
    PUSH EBX                            ; 005581d2
    CALL core_charactr.cpp_CCharacter_chooseNextLayerAction_FUN_0042e8c0 ; 005581d3 | void core_charactr.cpp_CCharacter_chooseNextLayerAction_FUN_0042e8c0(CCharacter * this_ptr)
    ...
    JL 0x005580d6                       ; 005581e7 | LAB_005580d6
    ...
    XOR ESI,ESI                         ; 005581f4
        ;   Label: LAB_005581f4
    JMP 0x005580b8                      ; 005581f6 | LAB_005580b8
        ;   XREF to: 005580b8 (UNCONDITIONAL_JUMP)
    CMP ESI,ECX                         ; 005581fb
        ;   Label: LAB_005581fb
    JZ 0x005580c6                       ; 005581fd | LAB_005580c6
        ;   XREF to: 005580c6 (CONDITIONAL_JUMP)
    CMP dword ptr [ECX + 0x2e0],0x8     ; 00558203
    JNZ 0x005580c6                      ; 0055820a | LAB_005580c6
        ;   XREF to: 005580c6 (CONDITIONAL_JUMP)
    LEA EDI,[EBX + 0x158]               ; 00558210
    PUSH EDI                            ; 00558216
    CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0 ; 00558217 | SMotion * core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0(CMotionController * this_ptr)
        ;   XREF to: 0052dab0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EAX + 0x24]      ; 0055821c
    ADD ESP,0x4                         ; 0055821f
    TEST EAX,EAX                        ; 00558222
    JNZ 0x00558231                      ; 00558224 | LAB_00558231
        ;   XREF to: 00558231 (CONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0x1fbe8],EAX   ; 00558226
    JMP 0x005580c6                      ; 0055822c | LAB_005580c6
        ;   XREF to: 005580c6 (UNCONDITIONAL_JUMP)
    PUSH 0x1                            ; 00558231
        ;   Label: LAB_00558231
    PUSH 0x0                            ; 00558233
    PUSH EDI                            ; 00558235
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 00558236 | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0055823b
    JMP 0x005580c6                      ; 0055823e | LAB_005580c6
        ;   XREF to: 005580c6 (UNCONDITIONAL_JUMP)
    XOR EDI,EDI                         ; 00558243
        ;   Label: caseD_8
    JMP 0x0055810b                      ; 00558245 | LAB_0055810b
        ;   XREF to: 0055810b (UNCONDITIONAL_JUMP)
    TEST EDI,EDI                        ; 0055824a
        ;   Label: LAB_0055824a
    JNZ 0x0055826d                      ; 0055824c | LAB_0055826d
        ;   XREF to: 0055826d (CONDITIONAL_JUMP)
    TEST ESI,ESI                        ; 0055824e
    JZ 0x0055810b                       ; 00558250 | LAB_0055810b
        ;   XREF to: 0055810b (CONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0x2e0],0x8     ; 00558256
    JZ 0x0055810b                       ; 0055825d | LAB_0055810b
        ;   XREF to: 0055810b (CONDITIONAL_JUMP)
    MOV EDI,0x1                         ; 00558263
        ;   Label: LAB_00558263
    JMP 0x0055810b                      ; 00558268 | LAB_0055810b
        ;   XREF to: 0055810b (UNCONDITIONAL_JUMP)
    MOV EAX,EDI                         ; 0055826d
        ;   Label: LAB_0055826d
    JZ 0x0055810b                       ; 0055826f | LAB_0055810b
        ;   XREF to: 0055810b (CONDITIONAL_JUMP)
    CMP dword ptr [EDI + 0x2e0],0x8     ; 00558275
    JNZ 0x00558263                      ; 0055827c | LAB_00558263
        ;   XREF to: 00558263 (CONDITIONAL_JUMP)
    XOR EDI,EDI                         ; 0055827e
    JMP 0x0055810b                      ; 00558280 | LAB_0055810b
        ;   XREF to: 0055810b (UNCONDITIONAL_JUMP)
    CMP dword ptr [ECX + 0x2e0],0x8     ; 00558285
        ;   Label: LAB_00558285
    JNZ 0x00558295                      ; 0055828c | LAB_00558295
        ;   XREF to: 00558295 (CONDITIONAL_JUMP)
    XOR EAX,ECX                         ; 0055828e
    JMP 0x00558152                      ; 00558290 | LAB_00558152
        ;   XREF to: 00558152 (UNCONDITIONAL_JUMP)
    MOV EAX,0x1                         ; 00558295
        ;   Label: LAB_00558295
    JMP 0x00558152                      ; 0055829a | LAB_00558152
        ;   XREF to: 00558152 (UNCONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0x2e0],0x8     ; 0055829f
        ;   Label: LAB_0055829f
    JZ 0x0055818b                       ; 005582a6 | LAB_0055818b
        ;   XREF to: 0055818b (CONDITIONAL_JUMP)
    MOV EAX,0x1                         ; 005582ac
    JMP 0x0055818d                      ; 005582b1 | LAB_0055818d
