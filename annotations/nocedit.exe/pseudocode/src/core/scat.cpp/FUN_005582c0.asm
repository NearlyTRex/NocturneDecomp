...
;
; XREF[1]:
;   core_scat.cpp_FUN_005571f0 at 00557532
;
; Referenced Globals:
...
section .text
    ...
    JZ 0x00558475                       ; 005582f1 | LAB_00558475
    ...
    JNZ 0x00558323                      ; 0055830f | LAB_00558323
    ...
    PUSH ESI                            ; 0055832b
    CALL core_motion.cpp_CMotionController_getStateBlendWeight_FUN_0052dd20 ; 0055832c | float core_motion.cpp_CMotionController_getStateBlendWeight_FUN_0052dd20(CMotionController * this_ptr, int desired_state_index)
        ;   XREF to: 0052dd20 (UNCONDITIONAL_CALL)
    MOV dword ptr [ESP + 0x20],EAX      ; 00558331
    ADD ESP,0x8                         ; 00558335
    PUSH 0x5                            ; 00558338
    PUSH ESI                            ; 0055833a
    CALL core_motion.cpp_CMotionController_getStateBlendWeight_FUN_0052dd20 ; 0055833b | float core_motion.cpp_CMotionController_getStateBlendWeight_FUN_0052dd20(CMotionController * this_ptr, int desired_state_index)
        ;   XREF to: 0052dd20 (UNCONDITIONAL_CALL)
    ...
    CALL core_motion.cpp_CMotionController_getStateBlendWeight_FUN_0052dd20 ; 00558356 | float core_motion.cpp_CMotionController_getStateBlendWeight_FUN_0052dd20(CMotionController * this_ptr, int desired_state_index)
        ;   XREF to: 0052dd20 (UNCONDITIONAL_CALL)
    ...
    CALL core_motion.cpp_CMotionController_getStateBlendWeight_FUN_0052dd20 ; 00558371 | float core_motion.cpp_CMotionController_getStateBlendWeight_FUN_0052dd20(CMotionController * this_ptr, int desired_state_index)
        ;   XREF to: 0052dd20 (UNCONDITIONAL_CALL)
    ...
    CALL core_motion.cpp_CMotionController_getStateBlendWeight_FUN_0052dd20 ; 0055838c | float core_motion.cpp_CMotionController_getStateBlendWeight_FUN_0052dd20(CMotionController * this_ptr, int desired_state_index)
        ;   XREF to: 0052dd20 (UNCONDITIONAL_CALL)
    ...
    FNSTSW AX                           ; 005583bc
    SAHF                                ; 005583be
    JBE 0x005583c7                      ; 005583bf | LAB_005583c7
    ...
    FCOMP double ptr [0x00641444]       ; 005583ce | double DOUBLE_00641444
    FNSTSW AX                           ; 005583d4
    SAHF                                ; 005583d6
    JBE 0x0055846e                      ; 005583d7 | LAB_0055846e
        ;   XREF to: 0055846e (CONDITIONAL_JUMP)
    FLD1                                ; 005583dd
    FCOMP double ptr [ESP]              ; 005583df
    FNSTSW AX                           ; 005583e2
    SAHF                                ; 005583e4
    JNC 0x005583ef                      ; 005583e5 | LAB_005583ef
    ...
    PUSH ESI                            ; 00558415
    CALL core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_005a0820 ; 00558416 | CSkeleton * core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_005a0820(CDeformableModelInstance * this_ptr)
        ;   XREF to: 005a0820 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0055841b
    PUSH EAX                            ; 0055841e
    CALL core_motion.cpp_CMotionList_findMotionIndex_FUN_0052d460 ; 0055841f | int core_motion.cpp_CMotionList_findMotionIndex_FUN_0052d460(CMotionList * this_ptr)
    ...
    CALL core_motion.cpp_CMotionController_markerPositionToFrame_FUN_0052e3a0 ; 00558431 | float core_motion.cpp_CMotionController_markerPositionToFrame_FUN_0052e3a0(CMotionController * this_ptr, int motion_index, float marker_position)
    ...
    MOV EDX,dword ptr [0x0310619c]      ; 00558446 | undefined4 DAT_0310619c
    PUSH EDX                            ; 0055844c
    ...
    PUSH EDI                            ; 00558459
    PUSH ESI                            ; 0055845a
    CALL core_skeleton.cpp_CDeformableModelInstance_blendMotion_FUN_0059eb50 ; 0055845b | void core_skeleton.cpp_CDeformableModelInstance_blendMotion_FUN_0059eb50(CDeformableModelInstance * this_ptr, int target_motion_index, float target_frame_number, float blend_weight, ...)
        ;   XREF to: 0059eb50 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [EBX + 0x2a8c]    ; 00558460
    ADD ESP,0x18                        ; 00558466
    CMP ECX,0x1                         ; 00558469
    JZ 0x00558484                       ; 0055846c | LAB_00558484
    ...
    JMP 0x005582f7                      ; 0055847f | LAB_005582f7
        ;   XREF to: 005582f7 (UNCONDITIONAL_JUMP)
    PUSH ECX                            ; 00558484
        ;   Label: LAB_00558484
    PUSH EBX                            ; 00558485
    CALL core_scat.cpp_FUN_005584a0     ; 00558486 | undefined core_scat.cpp_FUN_005584a0()
