...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_werewolf_cpp_CWerewolf_archive_FUN_005f1980(CWerewolf *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005f1980
        ;   Label: core_werewolf.cpp_CWerewolf_archive_FUN_005f1980
    MOV EBX,dword ptr [ESP + 0x8]       ; 005f1981
    PUSH EBX                            ; 005f1985
    CALL core_enemy.cpp_CEnemy_archive_FUN_004a9660 ; 005f1986
    ...
    PUSH EAX                            ; 005f1999
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 005f199a
    ...
    PUSH EAX                            ; 005f19ad
    CALL core_actor.cpp_archiveDeformableModelInstance_FUN_0040b970 ; 005f19ae
    ...
    PUSH EAX                            ; 005f19d0
    CALL core_actor.cpp_archiveMotionState_FUN_0040b9f0 ; 005f19d1
    ...
    PUSH EAX                            ; 005f19ef
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 005f19f0
    ...
    PUSH EAX                            ; 005f1a20
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 005f1a21
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH EAX                            ; 005f1a3d
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 005f1a3e
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    PUSH EAX                            ; 005f1a5c
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 005f1a5d
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH EAX                            ; 005f1a75
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 005f1a76
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ADD ESP,0x8                         ; 005f1a7b
    PUSH 0x657e16                       ; 005f1a7e | = "phaseTimer"
    LEA EAX,[EBX + 0xbefc]              ; 005f1a83
    PUSH EAX                            ; 005f1a89
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 005f1a8a
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
