...
section .text
    ...
    PUSH ESI                            ; 005efb71
    PUSH 0x2cf2bb8                      ; 005efb72 | CDemonActorType g_CEnemyClassInfo
    PUSH 0x6                            ; 005efb77
    MOV EDX,0xbe8f5c29                  ; 005efb79
    MOV ECX,0x3ed70a3d                  ; 005efb7e
    PUSH 0x684958                       ; 005efb83 | int g_CWerewolfClassVersion
    ...
    PUSH 0x657c34                       ; 005efba3 | = "CWerewolf" | s_CWerewolf_00657c34 = CWerewolf
    MOV dword ptr [0x03f96b4c],EBX      ; 005efba8 | DAT_03f96b4c
    MOV dword ptr [0x03f96b50],ESI      ; 005efbae | DAT_03f96b50
    PUSH 0x3f96b5c                      ; 005efbb4 | CDemonActorType g_CWerewolfClassInfo
    MOV dword ptr [0x03f96b54],ECX      ; 005efbb9 | DAT_03f96b54
    MOV dword ptr [0x03f96b58],EBX      ; 005efbbf | DAT_03f96b58
    CALL core_actor.cpp_registerActorClass_FUN_0040c2e0 ; 005efbc5 | CDemonActorType * core_actor.cpp_registerActorClass_FUN_0040c2e0(CDemonActorType * this_ptr, char * class_name, CDemonActor_FactoryFunc * factor_func, int * max_version, ...)
