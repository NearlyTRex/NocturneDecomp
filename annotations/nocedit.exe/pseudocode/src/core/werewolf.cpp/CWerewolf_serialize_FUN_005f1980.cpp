...
// Convention: __cdecl
// Signature: void __cdecl core_werewolf_cpp_CWerewolf_serialize_FUN_005f1980(CWerewolf *this_ptr)
...

{
  ...
  core_actor_cpp_serializeActor_FUN_0040b870((CDemonActor *)this_ptr->unk5,"alpha1");
  core_actor_cpp_serializeActor_FUN_0040b870((CDemonActor *)(this_ptr->unk5 + 4),"alpha2");
  return;
}
