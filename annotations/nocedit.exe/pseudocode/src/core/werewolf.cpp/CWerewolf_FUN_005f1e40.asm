...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_werewolf_cpp_CWerewolf_FUN_005f1e40(CWerewolf *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005f1e40
        ;   Label: core_werewolf.cpp_CWerewolf_FUN_005f1e40
    PUSH ESI                            ; 005f1e41
    PUSH EDI                            ; 005f1e42
    PUSH EBP                            ; 005f1e43
    ...
    MOV EDX,dword ptr [0x0066e8e0]      ; 005f1f09 | g_CConsoleInstance | g_CConsolePtr
    PUSH EDX                            ; 005f1f0f | g_CConsoleInstance
