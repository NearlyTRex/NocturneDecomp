...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_werewolf.cpp_FUN_005f1e40()
;
; Local Variables:
...
section .text
    ...
    JZ 0x005f1e5e                       ; 005f1e53 | LAB_005f1e5e
        ;   XREF to: 005f1e5e (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0xbe3c],0x0    ; 005f1e55
    JNZ 0x005f1e65                      ; 005f1e5c | LAB_005f1e65
    ...
    CALL core_xform.cpp_transformVector3x4_FUN_005f4dc0 ; 005f1e98 | CVector3f * core_xform.cpp_transformVector3x4_FUN_005f4dc0(CVector3f * output_vector, CVector3f * input_vector, CMatrix3x4f * matrix)
    ...
    PUSH EAX                            ; 005f1ead
    PUSH EBX                            ; 005f1eae
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 005f1eaf | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
    ...
    FNSTSW AX                           ; 005f1ec0
    SAHF                                ; 005f1ec2
    JC 0x005f1fdb                       ; 005f1ec3 | LAB_005f1fdb
    ...
    PUSH 0x657e6c                       ; 005f1f04 | = "Chain stretched to %f\n" | s_Chain_stretched_to_f_00657e6c = Chain stretched to %f

    MOV EDX,dword ptr [0x0066e8e0]      ; 005f1f09 | CConsole g_ConsolePtr | CConsole * g_CConsolePtr
    PUSH EDX                            ; 005f1f0f | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 005f1f10 | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
    ...
    FNSTSW AX                           ; 005f1f21
    SAHF                                ; 005f1f23
    JBE 0x005f1e5e                      ; 005f1f24 | LAB_005f1e5e
        ;   XREF to: 005f1e5e (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 005f1f43
    SAHF                                ; 005f1f45
    JA 0x005f1e5e                       ; 005f1f46 | LAB_005f1e5e
        ;   XREF to: 005f1e5e (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 005f1f81
    SAHF                                ; 005f1f83
    JNC 0x005f1e5e                      ; 005f1f84 | LAB_005f1e5e
        ;   XREF to: 005f1e5e (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 005f1f97
    SAHF                                ; 005f1f99
    JNC 0x005f1e5e                      ; 005f1f9a | LAB_005f1e5e
        ;   XREF to: 005f1e5e (CONDITIONAL_JUMP)
    ...
    CALL core_charactr.cpp_CCharacter_FUN_00428f40 ; 005f1fcc | void core_charactr.cpp_CCharacter_FUN_00428f40(CCharacter * this_ptr)
    ...
    CALL core_charactr.cpp_CCharacter_FUN_00428f40 ; 005f1ff5 | void core_charactr.cpp_CCharacter_FUN_00428f40(CCharacter * this_ptr)
        ;   XREF to: 00428f40 (UNCONDITIONAL_CALL)
