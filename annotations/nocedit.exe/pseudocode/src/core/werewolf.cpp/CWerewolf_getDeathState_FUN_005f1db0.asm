...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_werewolf_cpp_CWerewolf_getDeathState_FUN_005f1db0(CWerewolf *this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EAX,dword ptr [ESP + 0x4]       ; 005f1db0
        ;   Label: core_werewolf.cpp_CWerewolf_getDeathState_FUN_005f1db0
