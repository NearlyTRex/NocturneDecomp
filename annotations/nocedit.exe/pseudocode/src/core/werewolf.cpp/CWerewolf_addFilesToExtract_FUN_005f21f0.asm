...
section .text
    ...
    PUSH EBX                            ; 005f21f0
        ;   Label: core_werewolf.cpp_CWerewolf_addFilesToExtract_FUN_005f21f0
    MOV EDX,dword ptr [ESP + 0xc]       ; 005f21f1
    PUSH EDX                            ; 005f21f5
    MOV ECX,dword ptr [ESP + 0xc]       ; 005f21f6
    PUSH ECX                            ; 005f21fa
    CALL core_actor.cpp_CDemonActor_addFilesToExtract_FUN_0040cfd0 ; 005f21fb
    ...
    PUSH EAX                            ; 005f2211
    CALL core_skeledit.cpp_CDeformableModelInstance_addFilesToExtract_FUN_0058a260 ; 005f2212
