...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_werewolf_cpp_CWerewolf_getPropertyList_FUN_005f20d0(CWerewolf *this_ptr,CActorPropertyList *property_list)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005f20d0
        ;   Label: core_werewolf.cpp_CWerewolf_getPropertyList_FUN_005f20d0
    PUSH ESI                            ; 005f20d1
    PUSH EDI                            ; 005f20d2
