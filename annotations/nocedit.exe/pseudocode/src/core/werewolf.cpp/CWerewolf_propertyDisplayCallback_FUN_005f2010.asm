...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_werewolf_cpp_CWerewolf_propertyDisplayCallback_FUN_005f2010 (CWerewolf *this_ptr,CActorProperty *property,char *output_buffer)
;
; Parameters:
...
;
; XREF[1]:
;   core_werewolf.cpp_CWerewolf_getPropertyList_FUN_005f20d0 at 005f2110
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 005f2010
        ;   Label: core_werewolf.cpp_CWerewolf_propertyDisplayCallback_FUN_005f2010
    PUSH ESI                            ; 005f2011
    ...
    PUSH ECX                            ; 005f2021
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 005f2022
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)  ; CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
    MOV ESI,dword ptr [EAX + 0xbebc]    ; 005f2027
    ADD ESP,0x8                         ; 005f202d
    TEST ESI,ESI                        ; 005f2030
    JZ 0x005f204a                       ; 005f2032
        ;   XREF to: 005f204a (CONDITIONAL_JUMP)  ; LAB_005f204a
    CMP ESI,0x1                         ; 005f2034
    JNZ 0x005f2051                      ; 005f2037
        ;   XREF to: 005f2051 (CONDITIONAL_JUMP)  ; LAB_005f2051
