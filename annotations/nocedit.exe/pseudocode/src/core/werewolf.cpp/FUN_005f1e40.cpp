...
// Convention: __cdecl
// Signature: void __cdecl core_werewolf_cpp_FUN_005f1e40(void)
...

{
  ...
  if ((*(int *)(in_stack_00000004[1].base.create_event + 0x4c) != 0) &&
     (*(int *)(in_stack_00000004[1].base.actor_name + 0x18) != 0)) {
    local_50.x = 0.0;
    local_50.y = -0.3;
    local_50.z = 0.0;
    core_xform_cpp_transformVector3x4_FUN_005f4dc0
               ...
               *(int *)(in_stack_00000004[1].base.create_event + 0x34));
    core_actor_cpp_CDemonActor_worldToLocalPoint_FUN_00408f10
              (&in_stack_00000004->base,&local_68,
               (CVector3f *)(*(int *)(in_stack_00000004[1].base.create_event + 0x4c) + 0x20));
    ...
    if ((*(float *)(in_stack_00000004[1].base.create_event + 0x50) < local_1c) &&
       (fVar1 = *(float *)(in_stack_00000004[1].base.create_event + 0x50),
