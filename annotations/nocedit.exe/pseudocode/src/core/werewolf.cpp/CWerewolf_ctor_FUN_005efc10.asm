...
;                               FUNCTION
; *****************************************************************************
; __cdecl CWerewolf * __cdecl core_werewolf_cpp_CWerewolf_ctor_FUN_005efc10(CWerewolf *this_ptr)
;
; Parameters:
