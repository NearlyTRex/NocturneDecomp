...

{
  ...
  if (g_TotalPhysicalMemory < 0x3c00000) {
    ...
    ;
    iVar7 = -1;
    pcVar5 = low_memory_message + 0x10;
    do {
      pcVar11 = pcVar5;
      if (iVar7 == 0) break;
      iVar7 = iVar7 + -1;
    ...
    ;
    iVar7 = -1;
    pcVar5 = low_memory_message + 0x14;
    do {
      pcVar11 = pcVar5;
      if (iVar7 == 0) break;
      iVar7 = iVar7 + -1;
  ...
  if (g_MessageFlags[0] < 0xc800000) {
    ...
    shape_edittool_cpp_CEditorTools_showWarning_FUN_0049e6f0(g_CEditorToolsPtr,&stack0xfffff8e4);
  }
  pCVar4 = g_CGamePtr;
  ...
  engine_font_cpp_CBitFont_getTextWidth_FUN_004cfe80(g_ThemeFont,loading_text + 0xc);
  engine_font_cpp_CBitFont_getCharWidth_FUN_004d01d0(g_ThemeFont,0x58);
  engine_alphabit_cpp_CAlphaBitmap_ctor_FUN_00410520((CAlphaBitmap *)&stack0xffffffec);
  engine_alphabit_cpp_CAlphaBitmap_load_FUN_004105d0
            ((CAlphaBitmap *)&stack0xfffffff0,"fangs",0x280,0x1e0);
  engine_alphabit_cpp_CAlphaBitmap_display_FUN_00410950((CAlphaBitmap *)&stack0xfffffff4,0,0,0x8000)
  ;
  wincore_wddvmem_cpp_swapBuffers_FUN_005eda20();
  engine_alphabit_cpp_CAlphaBitmap_dtor_FUN_00410540((CAlphaBitmap *)&stack0xfffffffc);
  ...
  do {
    ...
    iVar7 = iVar7 + 4;
    iVar9 = iStack0000001c + 1;
    core_dfilter_cpp_CDemonFilter_init_FUN_004705a0
              ((CDemonFilter *)*puVar1,
               (float)iStack0000001c * (float)0.125 + (float)0.125,0);
    iStack0000001c = iVar9;
  } while (iVar9 < 8);
  iVar9 = 0;
  iVar7 = 0;
  do {
