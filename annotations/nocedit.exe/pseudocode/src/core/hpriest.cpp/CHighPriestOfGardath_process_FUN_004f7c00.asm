...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_hpriest_cpp_CHighPriestOfGardath_process_FUN_004f7c00 (CHighPriestOfGardath *this_ptr,float delta_time)
;
; Parameters:
...
section .text
    ...
    PUSH 0x0                            ; 004f7c35
    PUSH EBX                            ; 004f7c37
    CALL core_charactr.cpp_CCharacter_FUN_0042b9e0 ; 004f7c38
