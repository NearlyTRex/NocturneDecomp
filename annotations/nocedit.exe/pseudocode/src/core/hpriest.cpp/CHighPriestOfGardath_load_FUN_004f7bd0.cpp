...
// Convention: __cdecl
// Signature: void __cdecl core_hpriest_cpp_CHighPriestOfGardath_load_FUN_004f7bd0(void)
...

{
  ...
  core_actor_cpp_serializeString_FUN_0040b5c0((char **)(in_stack_00000004 + 1),"killEvent")
  ;
  return;
}
