...
section .text
    ...
    PUSH ECX                            ; 004f7c7a
    CALL core_npc.cpp_CNPC_FUN_00544e40 ; 004f7c7b | void core_npc.cpp_CNPC_FUN_00544e40(CNPC * this_ptr)
        ;   XREF to: 00544e40 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004f7c80
    MOV EAX,dword ptr [ESP + 0x8]       ; 004f7c83
    ADD EAX,0x1f708                     ; 004f7c87
    PUSH EAX                            ; 004f7c8c
    PUSH 0x62f57d                       ; 004f7c8d | = "Kill me event" | s_Kill_me_event_0062f57d = Kill me event
    MOV EBX,dword ptr [ESP + 0x14]      ; 004f7c92
    PUSH EBX                            ; 004f7c96
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e460 ; 004f7c97 | void core_actor.cpp_CActorPropertyList_FUN_0040e460(CActorPropertyList * this_ptr)
