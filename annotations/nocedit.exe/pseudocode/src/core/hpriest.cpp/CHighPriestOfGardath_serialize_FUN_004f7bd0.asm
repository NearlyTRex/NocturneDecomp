...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_hpriest_cpp_CHighPriestOfGardath_serialize_FUN_004f7bd0(CHighPriestOfGardath *this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x4]       ; 004f7bd0
        ;   Label: core_hpriest.cpp_CHighPriestOfGardath_serialize_FUN_004f7bd0
    PUSH EDX                            ; 004f7bd4
