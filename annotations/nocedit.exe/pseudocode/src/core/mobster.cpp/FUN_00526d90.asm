...
section .text
    ...
    JNZ 0x00527091                      ; 00526da9 | LAB_00527091
    ...
    FNSTSW AX                           ; 00526dc2
    SAHF                                ; 00526dc4
    JC 0x00526e7d                       ; 00526dc5 | LAB_00526e7d
    ...
    JZ 0x00527091                       ; 00526de3 | LAB_00527091
        ;   XREF to: 00527091 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [EBX + 0x24f8]    ; 00526de9
    TEST EDI,EDI                        ; 00526def
    JNZ 0x00527091                      ; 00526df1 | LAB_00527091
        ;   XREF to: 00527091 (CONDITIONAL_JUMP)
    ...
    JMP 0x00526e32                      ; 00526e7b | LAB_00526e32
    ...
    CALL core_actor.cpp_getRandomFloat_FUN_0040cc10 ; 00526e97 | float core_actor.cpp_getRandomFloat_FUN_0040cc10(float min_value, float max_value)
    ...
    FNSTSW AX                           ; 00526ece
    SAHF                                ; 00526ed0
    JBE 0x00527091                      ; 00526ed1 | LAB_00527091
        ;   XREF to: 00527091 (CONDITIONAL_JUMP)
    ...
    JNZ 0x00527043                      ; 00526ef8 | LAB_00527043
    ...
    FADDP                               ; 00526f16
    FSQRT                               ; 00526f18
    FMUL double ptr [0x00639916]        ; 00526f1a | double DOUBLE_00639916
    FSUBR double ptr [0x0063991e]       ; 00526f20 | double DOUBLE_0063991e
    FST float ptr [ESP]                 ; 00526f26
    FLD1                                ; 00526f29
    FCOMPP                              ; 00526f2b
    FNSTSW AX                           ; 00526f2d
    SAHF                                ; 00526f2f
    JBE 0x00526f39                      ; 00526f30 | LAB_00526f39
    ...
    FNSTSW AX                           ; 00526f57
    SAHF                                ; 00526f59
    JBE 0x0052702e                      ; 00526f5a | LAB_0052702e
    ...
    JNZ 0x0052702e                      ; 00526f7d | LAB_0052702e
        ;   XREF to: 0052702e (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 00526fc5
    CALL core_bodypart.cpp_FUN_0041b540 ; 00526fc6 | undefined core_bodypart.cpp_FUN_0041b540()
        ;   XREF to: 0041b540 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00526fcb
    PUSH EAX                            ; 00526fce
    CALL core_bodypart.cpp_FUN_0041b4e0 ; 00526fcf | undefined core_bodypart.cpp_FUN_0041b4e0()
    ...
    PUSH EAX                            ; 00526fe4
    FADD double ptr [0x00639926]        ; 00526fe5 | double DOUBLE_00639926
    PUSH EBX                            ; 00526feb
    FSTP float ptr [ESP + 0x80]         ; 00526fec
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 00526ff3 | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
    ...
    CALL core_charactr.cpp_CCharacter_walkToPoint_FUN_004286e0 ; 00527024 | int core_charactr.cpp_CCharacter_walkToPoint_FUN_004286e0(CCharacter * this_ptr)
    ...
    JL 0x0052706d                       ; 00527038 | LAB_0052706d
        ;   XREF to: 0052706d (CONDITIONAL_JUMP)
    JG 0x0052709a                       ; 0052703a | LAB_0052709a
        ;   XREF to: 0052709a (CONDITIONAL_JUMP)
    MOV EAX,0x1                         ; 0052703c
    JMP 0x00527093                      ; 00527041 | LAB_00527093
    ...
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 0052705c | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
    ...
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 00527089 | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ...
    PUSH 0x7                            ; 0052709c
    PUSH EAX                            ; 0052709e
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 0052709f | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ...
    POP EBX                             ; 005270b1
    RET                                 ; 005270b2
    PUSH 0x639906                       ; 005270b3 | = "CTommyGun" | s_CTommyGun_00639906 = CTommyGun
        ;   Label: LAB_005270b3
    PUSH EBX                            ; 005270b8
    CALL core_actor.cpp_isOfClass_FUN_0040c6d0 ; 005270b9 | int core_actor.cpp_isOfClass_FUN_0040c6d0(CDemonActor * actor_ptr, char * class_name)
        ;   XREF to: 0040c6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005270be
    TEST EAX,EAX                        ; 005270c1
    JZ 0x00526e69                       ; 005270c3 | LAB_00526e69
    ...
    FCOMP double ptr [0x0063991e]       ; 0052711b | double DOUBLE_0063991e
    FNSTSW AX                           ; 00527121
    SAHF                                ; 00527123
    JC 0x00526e69                       ; 00527124 | LAB_00526e69
        ;   XREF to: 00526e69 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x4],0x41700000 ; 0052712a
    JG 0x00526e69                       ; 00527132 | LAB_00526e69
        ;   XREF to: 00526e69 (CONDITIONAL_JUMP)
    ...
    JL 0x00526e69                       ; 00527151 | LAB_00526e69
        ;   XREF to: 00526e69 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [ESP + 0x8c]      ; 00527157
        ;   Label: LAB_00527157
    CMP ESI,0x1                         ; 0052715e
    JL 0x00527091                       ; 00527161 | LAB_00527091
        ;   XREF to: 00527091 (CONDITIONAL_JUMP)
    LEA EAX,[ESI + -0x1]                ; 00527167
    PUSH EAX                            ; 0052716a
    PUSH 0x0                            ; 0052716b
    CALL core_actor.cpp_getRandomInt_FUN_0040cc70 ; 0052716d | int core_actor.cpp_getRandomInt_FUN_0040cc70(int min_value, int max_value)
    ...
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 005271a4 | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
