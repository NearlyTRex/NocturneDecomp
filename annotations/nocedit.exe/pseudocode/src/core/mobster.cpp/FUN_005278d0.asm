...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_mobster.cpp_FUN_005278d0()
;
; Local Variables:
...
section .text
    ...
    MOV EDX,dword ptr [0x02f37ec8]      ; 005278df | undefined4 DAT_02f37ec8
    PUSH EDX                            ; 005278e5
    ...
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00 ; 005278f7 | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
        ;   XREF to: 0059fb00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005278fc
    CMP EDI,EAX                         ; 005278ff
    JNZ 0x0052796d                      ; 00527901 | LAB_0052796d
        ;   XREF to: 0052796d (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESI + 0xbf80]    ; 00527903
        ;   Label: LAB_00527903
    CMP dword ptr [ESI + EAX*0x4 + 0x2298],0x0 ; 00527909
    JZ 0x00527953                       ; 00527911 | LAB_00527953
        ;   XREF to: 00527953 (CONDITIONAL_JUMP)
    MOV EBP,dword ptr [0x02f37eec]      ; 00527913 | undefined4 DAT_02f37eec
    PUSH EBP                            ; 00527919
    LEA EAX,[ESP + 0x10]                ; 0052791a
    PUSH EAX                            ; 0052791e
    LEA EAX,[ESI + 0x158]               ; 0052791f
    PUSH EAX                            ; 00527925
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00 ; 00527926 | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
        ;   XREF to: 0059fb00 (UNCONDITIONAL_CALL)
    ...
    JZ 0x00527952                       ; 00527940 | LAB_00527952
    ...
    JNZ 0x0052797f                      ; 00527961 | LAB_0052797f
    ...
    JMP 0x00527903                      ; 0052797d | LAB_00527903
        ;   XREF to: 00527903 (UNCONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x02f37ef4]      ; 0052797f | undefined4 DAT_02f37ef4
        ;   Label: LAB_0052797f
    PUSH ECX                            ; 00527985
    ...
    PUSH ESI                            ; 00527991
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00 ; 00527992 | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
        ;   XREF to: 0059fb00 (UNCONDITIONAL_CALL)
    ...
    JZ 0x005279be                       ; 005279ac | LAB_005279be
