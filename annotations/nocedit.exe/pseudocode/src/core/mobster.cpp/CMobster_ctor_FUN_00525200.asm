...
section .text
    ...
    PUSH EDX                            ; 00525207
    CALL core_enemy.cpp_CEnemy_ctor_FUN_004a9500 ; 00525208 | CEnemy * core_enemy.cpp_CEnemy_ctor_FUN_004a9500(CEnemy * this_ptr)
        ;   XREF to: 004a9500 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052520d
    PUSH 0x6396ca                       ; 00525210 | = "mobster1.dfm" | s_mobster1_dfm_006396ca = mobster1.dfm
    MOV EBX,EAX                         ; 00525215
    ADD EAX,0x158                       ; 00525217
    PUSH EAX                            ; 0052521c
    MOV dword ptr [EAX + -0x4],0x661794 ; 0052521d | CDemonActor_vtable PTR_core_mobster.cpp_FUN_00525340_00661794
    CALL core_skeleton.cpp_CDeformableModelInstance_init_FUN_005a0840 ; 00525224 | void core_skeleton.cpp_CDeformableModelInstance_init_FUN_005a0840(CDeformableModelInstance * this_ptr, char * model_name)
    ...
    CALL core_actor.cpp_getRandomInt_FUN_0040cc70 ; 00525261 | int core_actor.cpp_getRandomInt_FUN_0040cc70(int min_value, int max_value)
    ...
    CALL core_actor.cpp_getRandomInt_FUN_0040cc70 ; 005252af | int core_actor.cpp_getRandomInt_FUN_0040cc70(int min_value, int max_value)
        ;   XREF to: 0040cc70 (UNCONDITIONAL_CALL)
    ...
    MOV ESI,0x6396d7                    ; 005252e6 | = "none" | s_none_006396d7 = none
    ...
    PUSH EDI                            ; 0052530e
    MOV AL,byte ptr [ESI]               ; 0052530f | = "none" | s_none_006396d7 = none
        ;   Label: LAB_0052530f
    MOV byte ptr [EDI],AL               ; 00525311
    CMP AL,0x0                          ; 00525313
    JZ 0x00525327                       ; 00525315 | LAB_00525327
        ;   XREF to: 00525327 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 00525317 | DAT_006396d8
    ADD ESI,0x2                         ; 0052531a
    MOV byte ptr [EDI + 0x1],AL         ; 0052531d
    ADD EDI,0x2                         ; 00525320
    CMP AL,0x0                          ; 00525323
    JNZ 0x0052530f                      ; 00525325 | LAB_0052530f
