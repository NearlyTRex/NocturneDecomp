...
// Convention: __cdecl
// Signature: CMobster * __cdecl core_mobster_cpp_CMobster_dtor_FUN_00527c70(CMobster *this_ptr,uint flags)
...
{
  CMobster_ptr_13260 pCVar1;
  CMobster_ptr_12060 pSVar1;
  CMobster_ptr_11536 pCVar2;
  CMobster_ptr_11356 pCVar3;
  CMobster_ptr_10900 pCVar4;
  CMobster_ptr_344 pCVar5;
  CMobster *ptr;
  void *ptr_00;
  ...
  ptr = (CMobster *)core_actor_cpp_CDemonActor_dtor_FUN_00408a30((CDemonActor *)ADJ(pCVar5),1);
  if ((flags & 2) == 0) {
    return ptr;
  }
