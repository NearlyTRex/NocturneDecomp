...
section .text
    ...
    PUSH EBX                            ; 00527c40
        ;   Label: core_mobster.cpp_CMobster_addFilesToExtract_FUN_00527c40
    MOV EDX,dword ptr [ESP + 0xc]       ; 00527c41
    PUSH EDX                            ; 00527c45
    MOV ECX,dword ptr [ESP + 0xc]       ; 00527c46
    PUSH ECX                            ; 00527c4a
    CALL core_actor.cpp_CDemonActor_addFilesToExtract_FUN_0040cfd0 ; 00527c4b
    ...
    PUSH EAX                            ; 00527c61
    CALL core_skeledit.cpp_CDeformableModelInstance_addFilesToExtract_FUN_0058a260 ; 00527c62
