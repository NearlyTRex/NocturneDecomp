...
;   undefined4 g_MobsterIndices[2]
;   undefined4 g_MobsterIndices[10]
...
section .text
    ...
    JZ 0x005267d0                       ; 005267b7
        ;   XREF to: 005267d0 (CONDITIONAL_JUMP)  ; LAB_005267d0
    MOV ECX,dword ptr [EBX + 0xbe3c]    ; 005267b9
    TEST ECX,ECX                        ; 005267bf
    JNZ 0x005267d8                      ; 005267c1
        ;   XREF to: 005267d8 (CONDITIONAL_JUMP)  ; LAB_005267d8
    ...
    MOV dword ptr [EBX + 0xbf8c],EDX    ; 005267d0
        ;   Label: LAB_005267d0
    JMP 0x005267c9                      ; 005267d6
        ;   XREF to: 005267c9 (UNCONDITIONAL_JUMP)  ; LAB_005267c9
    PUSH ECX                            ; 005267d8
        ;   Label: LAB_005267d8
    PUSH EBX                            ; 005267d9
    ...
    JZ 0x00526a8c                       ; 005267e4
        ;   XREF to: 00526a8c (CONDITIONAL_JUMP)  ; LAB_00526a8c
    MOV EAX,[0x03f95d78]                ; 005267ea | g_CWeaponClassInfo.name_hash
        ;   Label: LAB_005267ea
    PUSH EAX                            ; 005267ef
    MOV EDX,dword ptr [EBX + 0x24f8]    ; 005267f0
    PUSH EDX                            ; 005267f6
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 005267f7
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)  ; CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
    ADD ESP,0x8                         ; 005267fc
    TEST EAX,EAX                        ; 005267ff
    JNZ 0x00526826                      ; 00526801
        ;   XREF to: 00526826 (CONDITIONAL_JUMP)  ; LAB_00526826
    MOV ECX,0x6398ae                    ; 00526803 | = "..\\core\\mobster.cpp"
    MOV ESI,0x323                       ; 00526808
    PUSH 0x6398c2                       ; 0052680d | = "CMobster::aimTommyGun - I'm not carry..."
    MOV dword ptr [0x02f0ca48],ECX      ; 00526812 | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 00526818 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0052681e
    ...
    MOV EDX,dword ptr [0x02f37ed0]      ; 0052683f | g_MobsterIndices[2]
        ;   Label: LAB_0052683f
    ...
    PUSH EAX                            ; 0052685b
    PUSH 0x3f87558                      ; 0052685c | g_ZeroVector
    LEA EAX,[ESP + 0x40]                ; 00526861
    PUSH EAX                            ; 00526865
    CALL core_xform.cpp_transformVector3x4_FUN_005f4dc0 ; 00526866
    ...
    PUSH EAX                            ; 00526873
    PUSH EBX                            ; 00526874
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 00526875
    ...
    PUSH ESI                            ; 005268ad
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 005268ae
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)  ; CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
    ADD ESP,0x8                         ; 005268b3
    TEST EAX,EAX                        ; 005268b6
    JZ 0x00526aa6                       ; 005268b8
        ;   XREF to: 00526aa6 (CONDITIONAL_JUMP)  ; LAB_00526aa6
    FLD float ptr [ESP + 0x54]          ; 005268be
    FADD float ptr [0x006398f6]         ; 005268c2 | FLOAT_006398f6
    ...
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 005268eb
    ...
    FNSTSW AX                           ; 00526924
    SAHF                                ; 00526926
    JBE 0x00526ab5                      ; 00526927
        ;   XREF to: 00526ab5 (CONDITIONAL_JUMP)  ; LAB_00526ab5
    FLD float ptr [ESP + 0x4]           ; 0052692d
    FCOMP double ptr [0x006398fe]       ; 00526931 | DOUBLE_006398fe
    FNSTSW AX                           ; 00526937
    SAHF                                ; 00526939
    JBE 0x00526ab5                      ; 0052693a
        ;   XREF to: 00526ab5 (CONDITIONAL_JUMP)  ; LAB_00526ab5
    ...
    FNSTSW AX                           ; 00526953
    SAHF                                ; 00526955
    JNC 0x00526962                      ; 00526956
        ;   XREF to: 00526962 (CONDITIONAL_JUMP)  ; LAB_00526962
    ...
    FNSTSW AX                           ; 00526973
    SAHF                                ; 00526975
    JNC 0x00526980                      ; 00526976
        ;   XREF to: 00526980 (CONDITIONAL_JUMP)  ; LAB_00526980
    ...
    FNSTSW AX                           ; 00526987
    SAHF                                ; 00526989
    JBE 0x00526993                      ; 0052698a
        ;   XREF to: 00526993 (CONDITIONAL_JUMP)  ; LAB_00526993
    ...
    FNSTSW AX                           ; 005269a4
    SAHF                                ; 005269a6
    JNC 0x005269b1                      ; 005269a7
        ;   XREF to: 005269b1 (CONDITIONAL_JUMP)  ; LAB_005269b1
    ...
    FNSTSW AX                           ; 005269b8
    SAHF                                ; 005269ba
    JBE 0x005269c4                      ; 005269bb
        ;   XREF to: 005269c4 (CONDITIONAL_JUMP)  ; LAB_005269c4
    ...
    MOV ECX,dword ptr [0x02f37ef0]      ; 005269dd | g_MobsterIndices[10]
    PUSH ECX                            ; 005269e3
    ...
    PUSH EAX                            ; 005269f1
        ;   Label: LAB_005269f1
    CALL core_skeleton.cpp_CDeformableModelInstance_blendMotion_FUN_0059eb50 ; 005269f2
    ...
    CALL core_xform.cpp_quaternionFromAngleX_FUN_005f79b0 ; 00526a06
    ...
    JMP 0x0060e4c0                      ; 00526a12
        ;   XREF to: 0060e4c0 (UNCONDITIONAL_JUMP)  ; LAB_0060e4c0
    MOV ESI,dword ptr [0x02f37ef0]      ; 00526a1b | g_MobsterIndices[10]
        ;   Label: LAB_00526a1b
    PUSH ESI                            ; 00526a21
    ...
    CALL core_skeleton.cpp_CDeformableModelInstance_applyRotationToHierarchy_FUN_0059ff20 ; 00526a3b
    ...
    CALL core_xform.cpp_quaternionFromAngleY_FUN_005f79f0 ; 00526a4b
    ...
    MOV EAX,[0x02f37ef0]                ; 00526a5c | g_MobsterIndices[10]
    LEA ESI,[ESP + 0x1c]                ; 00526a61
    PUSH EAX                            ; 00526a65
    JMP 0x0060497f                      ; 00526a66
        ;   XREF to: 0060497f (UNCONDITIONAL_JUMP)  ; LAB_0060497f
    PUSH dword ptr [EBX + 0xbf8c]       ; 00526a6e
        ;   Label: LAB_00526a6e
    PUSH EAX                            ; 00526a74
    MOV EDX,dword ptr [ESP + 0x80]      ; 00526a75
    PUSH EDX                            ; 00526a7c
    CALL core_skeleton.cpp_CDeformableModelInstance_applyRotationToHierarchy_FUN_0059ff20 ; 00526a7d
        ;   XREF to: 0059ff20 (UNCONDITIONAL_CALL)  ; void core_skeleton.cpp_CDeformableModelInstance_applyRotationToHierarchy_FUN_0059ff20(CDeformableModelInstance * this_ptr, CQuaternion4f * rotation_quat, float blend_weight, int bone_index, ...)
    ...
    CMP dword ptr [EBX + 0xbee8],0x0    ; 00526a8c
        ;   Label: LAB_00526a8c
    JNZ 0x005267ea                      ; 00526a93
        ;   XREF to: 005267ea (CONDITIONAL_JUMP)  ; LAB_005267ea
    ...
    FLD float ptr [ESP + 0x54]          ; 00526aa6
        ;   Label: LAB_00526aa6
    FADD float ptr [0x006398f2]         ; 00526aaa | FLOAT_006398f2
    JMP 0x005268c8                      ; 00526ab0
        ;   XREF to: 005268c8 (UNCONDITIONAL_JUMP)  ; LAB_005268c8
    ...
    FNSTSW AX                           ; 00526ac8
    SAHF                                ; 00526aca
    JBE 0x00526962                      ; 00526acb
        ;   XREF to: 00526962 (CONDITIONAL_JUMP)  ; LAB_00526962
    MOV dword ptr [EBX + 0xbf8c],0x0    ; 00526ad1
    JMP 0x00526962                      ; 00526adb
        ;   XREF to: 00526962 (UNCONDITIONAL_JUMP)  ; LAB_00526962
    PUSH 0x59ddb0                       ; 00526ae0
        ;   Label: LAB_00526ae0
    MOV EDX,dword ptr [0x02f37ef0]      ; 00526ae5 | g_MobsterIndices[10]
    PUSH EDX                            ; 00526aeb
    PUSH dword ptr [EBX + 0xbf8c]       ; 00526aec
    PUSH 0x40c00000                     ; 00526af2
    PUSH 0x2                            ; 00526af7
    JMP 0x005269f1                      ; 00526af9
        ;   XREF to: 005269f1 (UNCONDITIONAL_JUMP)  ; LAB_005269f1
    MOV ECX,dword ptr [ESI]             ; 0060497f
        ;   Label: LAB_0060497f
    MOV dword ptr [EDI],ECX             ; 00604981
    MOV ECX,dword ptr [ESI + 0x4]       ; 00604983
    MOV dword ptr [EDI + 0x4],ECX       ; 00604986
    MOV ECX,dword ptr [ESI + 0x8]       ; 00604989
    MOV dword ptr [EDI + 0x8],ECX       ; 0060498c
    MOV ECX,dword ptr [ESI + 0xc]       ; 0060498f
    MOV dword ptr [EDI + 0xc],ECX       ; 00604992
    ADD ESI,0x10                        ; 00604995
    ADD EDI,0x10                        ; 00604998
    LEA EAX,[ESP + 0x10]                ; 0060499b
    JMP 0x00526a6e                      ; 0060499f
        ;   XREF to: 00526a6e (UNCONDITIONAL_JUMP)  ; LAB_00526a6e
    MOV ECX,dword ptr [ESI]             ; 0060e4c0
        ;   Label: LAB_0060e4c0
    MOV dword ptr [EDI],ECX             ; 0060e4c2
    MOV ECX,dword ptr [ESI + 0x4]       ; 0060e4c4
    MOV dword ptr [EDI + 0x4],ECX       ; 0060e4c7
    MOV ECX,dword ptr [ESI + 0x8]       ; 0060e4ca
    MOV dword ptr [EDI + 0x8],ECX       ; 0060e4cd
    MOV ECX,dword ptr [ESI + 0xc]       ; 0060e4d0
    MOV dword ptr [EDI + 0xc],ECX       ; 0060e4d3
    ADD ESI,0x10                        ; 0060e4d6
    ADD EDI,0x10                        ; 0060e4d9
    PUSH 0x59ddb0                       ; 0060e4dc
    JMP 0x00526a1b                      ; 0060e4e1
        ;   XREF to: 00526a1b (UNCONDITIONAL_JUMP)  ; LAB_00526a1b
