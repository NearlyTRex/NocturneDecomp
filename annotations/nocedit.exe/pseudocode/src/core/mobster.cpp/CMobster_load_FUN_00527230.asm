...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_mobster_cpp_CMobster_load_FUN_00527230(void)
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00527235
    CALL core_enemy.cpp_CEnemy_serialize_FUN_004a9660 ; 00527236
    ...
    PUSH EAX                            ; 00527249
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 0052724a
    ...
    PUSH EAX                            ; 0052725d
    CALL core_actor.cpp_serializedDeformableModelInstance_FUN_0040b970 ; 0052725e
    ...
    PUSH EAX                            ; 00527280
    CALL core_actor.cpp_serializeMotionState_FUN_0040b9f0 ; 00527281
    ...
    PUSH EAX                            ; 0052729f
    CALL core_actor.cpp_serializeClothList_FUN_0040be60 ; 005272a0
    ...
    PUSH EAX                            ; 005272bc
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 005272bd
    ...
    PUSH EAX                            ; 005272d0
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 005272d1
    ...
    PUSH EAX                            ; 005272ed
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 005272ee
        ;   XREF to: 0040b870 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeActor_FUN_0040b870(CDemonActor * actor_ptr, char * property_name)
    ADD ESP,0x8                         ; 005272f3
    PUSH 0x63997c                       ; 005272f6 | = "sideOfCar"
    LEA EAX,[EBX + 0xbee4]              ; 005272fb
    PUSH EAX                            ; 00527301
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 00527302
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    PUSH EAX                            ; 00527320
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 00527321
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH EAX                            ; 00527339
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 0052733a
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ADD ESP,0x8                         ; 0052733f
    PUSH 0x639992                       ; 00527342 | = "holdPosCond"
    ADD EBX,0xbeec                      ; 00527347
    PUSH EBX                            ; 0052734d
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 0052734e
