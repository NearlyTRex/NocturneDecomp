...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_mobster_cpp_FUN_00527b70(void)
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00527b7b
    PUSH ESI                            ; 00527b7c
    CALL core_enemy.cpp_CEnemy_FUN_004aa170 ; 00527b7d
    ...
    PUSH EBX                            ; 00527b93
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e4a0 ; 00527b94
    ...
    PUSH EBX                            ; 00527ba2
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e4d0 ; 00527ba3
    ...
    PUSH EBX                            ; 00527bc0
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e350 ; 00527bc1
    ...
    PUSH EBX                            ; 00527bde
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e350 ; 00527bdf
        ;   XREF to: 0040e350 (UNCONDITIONAL_CALL)  ; int core_actor.cpp_CActorPropertyList_FUN_0040e350(CActorPropertyList * this_ptr)
    ...
    PUSH EBX                            ; 00527bf3
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e330 ; 00527bf4
    ...
    PUSH EBX                            ; 00527c08
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e330 ; 00527c09
        ;   XREF to: 0040e330 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_CActorPropertyList_FUN_0040e330(CActorPropertyList * this_ptr)
    ...
    PUSH EBX                            ; 00527c1d
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e460 ; 00527c1e
