...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_mobster.cpp_FUN_00525840()
;
; Local Variables:
...
section .text
    ...
    PUSH EBX                            ; 0052585b
    CALL core_charactr.cpp_CCharacter_FUN_00429870 ; 0052585c | int core_charactr.cpp_CCharacter_FUN_00429870(CCharacter * this_ptr)
        ;   XREF to: 00429870 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00525861
    TEST EAX,EAX                        ; 00525864
    JNZ 0x00525893                      ; 00525866 | LAB_00525893
        ;   XREF to: 00525893 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0xbee0],0x0    ; 00525868
    JNZ 0x00525879                      ; 0052586f | LAB_00525879
    ...
    PUSH EAX                            ; 005258f1
    CALL sound_sndmain.cpp_killSfx_FUN_005a9c40 ; 005258f2 | int sound_sndmain.cpp_killSfx_FUN_005a9c40(uint sfx_handle)
    ...
    JNZ 0x00525925                      ; 0052590c | LAB_00525925
        ;   XREF to: 00525925 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [EBX + 0xbf5c]    ; 0052590e
    PUSH EDX                            ; 00525914
    CALL sound_sndmain.cpp_isSfxPlaying_FUN_005a9660 ; 00525915 | int sound_sndmain.cpp_isSfxPlaying_FUN_005a9660(uint sfx_handle)
        ;   XREF to: 005a9660 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052591a
    TEST EAX,EAX                        ; 0052591d
    JZ 0x00525a47                       ; 0052591f | LAB_00525a47
    ...
    FNSTSW AX                           ; 0052593b
    SAHF                                ; 0052593d
    JBE 0x0052594a                      ; 0052593e | LAB_0052594a
    ...
    FNSTSW AX                           ; 00525960
    SAHF                                ; 00525962
    JBE 0x0052596f                      ; 00525963 | LAB_0052596f
    ...
    JZ 0x00525a7b                       ; 0052597e | LAB_00525a7b
    ...
    JZ 0x00525a93                       ; 00525993 | LAB_00525a93
        ;   XREF to: 00525a93 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0xbee8],0x0    ; 00525999
        ;   Label: LAB_00525999
    JZ 0x00525aaa                       ; 005259a0 | LAB_00525aaa
    ...
    FNSTSW AX                           ; 005259da
    SAHF                                ; 005259dc
    JNC 0x00525b0b                      ; 005259dd | LAB_00525b0b
        ;   XREF to: 00525b0b (CONDITIONAL_JUMP)
    LEA EAX,[EBP + 0x52]                ; 005259e3
    PUSH EAX                            ; 005259e6
    PUSH ESI                            ; 005259e7
    CALL core_motion.cpp_CMotionController_advance_FUN_0052d610 ; 005259e8 | int core_motion.cpp_CMotionController_advance_FUN_0052d610(CMotionController * this_ptr)
        ;   XREF to: 0052d610 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005259ed
    CMP EAX,0x64                        ; 005259f0
    JZ 0x00525ad7                       ; 005259f3 | LAB_00525ad7
        ;   XREF to: 00525ad7 (CONDITIONAL_JUMP)
    PUSH EAX                            ; 005259f9
    PUSH EBX                            ; 005259fa
    CALL core_charactr.cpp_CCharacter_FUN_0042ec40 ; 005259fb | void core_charactr.cpp_CCharacter_FUN_0042ec40(CCharacter * this_ptr)
        ;   XREF to: 0042ec40 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00525a00
    JMP 0x005259d3                      ; 00525a03 | LAB_005259d3
        ;   XREF to: 005259d3 (UNCONDITIONAL_JUMP)
    LEA EAX,[EBP + 0xfffffeee]          ; 00525a05
        ;   Label: LAB_00525a05
    PUSH EAX                            ; 00525a0b
    CALL core_charactr.cpp_SDamageInfo_ctor_FUN_00427db0 ; 00525a0c | SDamageInfo * core_charactr.cpp_SDamageInfo_ctor_FUN_00427db0(SDamageInfo * this_ptr)
    ...
    JMP 0x005258a7                      ; 00525a42 | LAB_005258a7
        ;   XREF to: 005258a7 (UNCONDITIONAL_JUMP)
    MOV ECX,dword ptr [EBX + 0xbf50]    ; 00525a47
        ;   Label: LAB_00525a47
    PUSH ECX                            ; 00525a4d
    CALL sound_sndmain.cpp_isSfxPlaying_FUN_005a9660 ; 00525a4e | int sound_sndmain.cpp_isSfxPlaying_FUN_005a9660(uint sfx_handle)
        ;   XREF to: 005a9660 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00525a53
    TEST EAX,EAX                        ; 00525a56
    JNZ 0x00525925                      ; 00525a58 | LAB_00525925
        ;   XREF to: 00525925 (CONDITIONAL_JUMP)
    PUSH 0x639846                       ; 00525a5e | = "mob-scream?.wav" | s_mob_scream_wav_00639846 = mob-scream?.wav
    ...
    JMP 0x00525925                      ; 00525a76 | LAB_00525925
    ...
    JMP 0x00525984                      ; 00525a8e | LAB_00525984
    ...
    JMP 0x00525999                      ; 00525aa5 | LAB_00525999
        ;   XREF to: 00525999 (UNCONDITIONAL_JUMP)
    LEA EAX,[EBX + 0xbeec]              ; 00525aaa
        ;   Label: LAB_00525aaa
    PUSH EAX                            ; 00525ab0
    MOV EDX,dword ptr [0x006793d0]      ; 00525ab1 | CEventList * g_CEventListPtr
    PUSH EDX                            ; 00525ab7 | CEventList g_CEventListInstance
    CALL core_event.cpp_CEventList_evaluateCondition_FUN_004adca0 ; 00525ab8 | int core_event.cpp_CEventList_evaluateCondition_FUN_004adca0(CEventList * this_ptr, char * condition_expression)
        ;   XREF to: 004adca0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00525abd
    TEST EAX,EAX                        ; 00525ac0
    JZ 0x005259a6                       ; 00525ac2 | LAB_005259a6
        ;   XREF to: 005259a6 (CONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0xbee8],0x1    ; 00525ac8
    JMP 0x005259a6                      ; 00525ad2 | LAB_005259a6
        ;   XREF to: 005259a6 (UNCONDITIONAL_JUMP)
    MOV EDX,dword ptr [EBX + 0xbec8]    ; 00525ad7
        ;   Label: LAB_00525ad7
    TEST EDX,EDX                        ; 00525add
    JZ 0x005259d3                       ; 00525adf | LAB_005259d3
    ...
    CALL core_charactr.cpp_CCharacter_pickupObjectNow_FUN_0042cdb0 ; 00525afe | void core_charactr.cpp_CCharacter_pickupObjectNow_FUN_0042cdb0(CCharacter * this_ptr)
        ;   XREF to: 0042cdb0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00525b03
    JMP 0x005259d3                      ; 00525b06 | LAB_005259d3
        ;   XREF to: 005259d3 (UNCONDITIONAL_JUMP)
    FLD float ptr [EBX + 0xbe24]        ; 00525b0b
        ;   Label: LAB_00525b0b
    FLD float ptr [EBP + 0x92]          ; 00525b11
    FMUL double ptr [0x00639886]        ; 00525b17 | double DOUBLE_00639886
    FMULP                               ; 00525b1d
    FLD float ptr [EBX + 0x23b4]        ; 00525b1f
    PUSH ESI                            ; 00525b25
    FSTP float ptr [EBX + 0x2434]       ; 00525b26
    FSTP float ptr [EBX + 0x2438]       ; 00525b2c
    CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0 ; 00525b32 | SMotion * core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0(CMotionController * this_ptr)
        ;   XREF to: 0052dab0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00525b37
    PUSH dword ptr [EBP + 0x92]         ; 00525b3a
    PUSH EBX                            ; 00525b40
    MOV EDI,dword ptr [EAX + 0x24]      ; 00525b41
    CALL core_charactr.cpp_CCharacter_FUN_0042ca70 ; 00525b44 | int core_charactr.cpp_CCharacter_FUN_0042ca70(CCharacter * this_ptr)
        ;   XREF to: 0042ca70 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00525b49
    TEST EAX,EAX                        ; 00525b4c
    JZ 0x00526776                       ; 00525b4e | LAB_00526776
        ;   XREF to: 00526776 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0x25b0]    ; 00525b54
    CMP EAX,0x2                         ; 00525b5a
    JNC 0x00525da1                      ; 00525b5d | LAB_00525da1
        ;   XREF to: 00525da1 (CONDITIONAL_JUMP)
    CMP EAX,0x1                         ; 00525b63
    JNZ 0x00525dac                      ; 00525b66 | LAB_00525dac
    ...
    LEA EAX,[EBX + 0x158]               ; 00525b70
        ;   Label: LAB_00525b70
    PUSH EAX                            ; 00525b76
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 00525b77 | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
    ...
    FNSTSW AX                           ; 00525ba1
    SAHF                                ; 00525ba3
    JNC 0x00525bb8                      ; 00525ba4 | LAB_00525bb8
    ...
    CMP dword ptr [EBX + 0xbee0],0x0    ; 00525bb8
        ;   Label: LAB_00525bb8
    JNZ 0x00526786                      ; 00525bbf | LAB_00526786
        ;   XREF to: 00526786 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 00525bc5
    CALL core_charactr.cpp_CCharacter_FUN_004297e0 ; 00525bc6 | int core_charactr.cpp_CCharacter_FUN_004297e0(CCharacter * this_ptr)
        ;   XREF to: 004297e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00525bcb
    TEST EAX,EAX                        ; 00525bce
    JZ 0x00525cd1                       ; 00525bd0 | LAB_00525cd1
        ;   XREF to: 00525cd1 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [EBX + 0xbe3c]    ; 00525bd6
    TEST EDI,EDI                        ; 00525bdc
    JZ 0x00525c0a                       ; 00525bde | LAB_00525c0a
    ...
    JNZ 0x00525c0a                      ; 00525bf2 | LAB_00525c0a
        ;   XREF to: 00525c0a (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0xbe3c]    ; 00525bf4
    PUSH EAX                            ; 00525bfa
    MOV EDX,dword ptr [0x006810c8]      ; 00525bfb | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
    PUSH EDX                            ; 00525c01 | CDemonSet g_CDemonSetInstance
    CALL core_setcolid.cpp_CDemonSet_ignore_FUN_005741b0 ; 00525c02 | void core_setcolid.cpp_CDemonSet_ignore_FUN_005741b0(CDemonSet * this_ptr, CDemonActor * actor)
        ;   XREF to: 005741b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00525c07
    FLD float ptr [EBP + 0x92]          ; 00525c0a
        ;   Label: LAB_00525c0a
    FLD ST0                             ; 00525c10
    FMUL double ptr [0x006398a6]        ; 00525c12 | double DOUBLE_006398a6
    ...
    CALL core_charactr.cpp_CCharacter_FUN_00428f40 ; 00525cc9 | void core_charactr.cpp_CCharacter_FUN_00428f40(CCharacter * this_ptr)
    ...
    PUSH ESI                            ; 00525cde
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 00525cdf | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00525ce4
    TEST EAX,EAX                        ; 00525ce7
    JZ 0x00525cfe                       ; 00525ce9 | LAB_00525cfe
    ...
    PUSH EAX                            ; 00525d0b
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 00525d0c | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00525d11
    TEST EAX,EAX                        ; 00525d14
    JZ 0x00525d2b                       ; 00525d16 | LAB_00525d2b
    ...
    PUSH EBX                            ; 00525d2b
        ;   Label: LAB_00525d2b
    CALL core_charactr.cpp_CCharacter_FUN_00429820 ; 00525d2c | void core_charactr.cpp_CCharacter_FUN_00429820(CCharacter * this_ptr)
        ;   XREF to: 00429820 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00525d31
    LEA EAX,[EBX + 0x158]               ; 00525d34
    PUSH EAX                            ; 00525d3a
    CALL core_skeleton.cpp_CDeformableModelInstance_updateAnimation_FUN_0059e020 ; 00525d3b | void core_skeleton.cpp_CDeformableModelInstance_updateAnimation_FUN_0059e020(CDeformableModelInstance * this_ptr)
    ...
    JNZ 0x00525d66                      ; 00525d55 | LAB_00525d66
        ;   XREF to: 00525d66 (CONDITIONAL_JUMP)
    PUSH dword ptr [EBP + 0x92]         ; 00525d57
    PUSH EBX                            ; 00525d5d
    CALL core_mobster.cpp_CMobster_aimTommyGun_FUN_005267a0 ; 00525d5e | undefined core_mobster.cpp_CMobster_aimTommyGun_FUN_005267a0()
        ;   XREF to: 005267a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00525d63
    PUSH dword ptr [EBP + 0x92]         ; 00525d66
        ;   Label: LAB_00525d66
    PUSH EBX                            ; 00525d6c
    CALL core_charactr.cpp_CCharacter_ApplyGestureLookAt_FUN_0042dfc0 ; 00525d6d | void core_charactr.cpp_CCharacter_ApplyGestureLookAt_FUN_0042dfc0(CCharacter * this_ptr)
    ...
    PUSH 0x0                            ; 00525d7f
    PUSH ESI                            ; 00525d81
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 00525d82 | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00525d87
    PUSH EBX                            ; 00525d8a
    PUSH 0x639856                       ; 00525d8b | = "%s confused while walking to scriptDe..." | s_s_confused_while_walking_00639856 = %s confused while walking to scriptDest!

    MOV ECX,dword ptr [0x0066e8e0]      ; 00525d90 | CConsole * g_CConsolePtr
    PUSH ECX                            ; 00525d96 | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 00525d97 | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
        ;   XREF to: 00441890 (UNCONDITIONAL_CALL)
    JMP 0x00525b7c                      ; 00525d9c | LAB_00525b7c
        ;   XREF to: 00525b7c (UNCONDITIONAL_JUMP)
    JBE 0x00525b6c                      ; 00525da1 | LAB_00525b6c
        ;   Label: LAB_00525da1
        ;   XREF to: 00525b6c (CONDITIONAL_JUMP)
    CMP EAX,0x3                         ; 00525da7
    JZ 0x00525d7d                       ; 00525daa | LAB_00525d7d
        ;   XREF to: 00525d7d (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 00525dac
        ;   Label: LAB_00525dac
    PUSH 0x0                            ; 00525dae
    JMP 0x00525b70                      ; 00525db0 | LAB_00525b70
        ;   XREF to: 00525b70 (UNCONDITIONAL_JUMP)
    LEA EAX,[EBP + 0xffffff2a]          ; 00525db5
        ;   Label: caseD_9
    PUSH EAX                            ; 00525dbb
    CALL core_charactr.cpp_SDamageInfo_ctor_FUN_00427db0 ; 00525dbc | SDamageInfo * core_charactr.cpp_SDamageInfo_ctor_FUN_00427db0(SDamageInfo * this_ptr)
        ;   XREF to: 00427db0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00525dc1
    PUSH 0x41700000                     ; 00525dc4
    PUSH 0x40e00000                     ; 00525dc9
    CALL core_actor.cpp_getRandomFloat_FUN_0040cc10 ; 00525dce | float core_actor.cpp_getRandomFloat_FUN_0040cc10(float min_value, float max_value)
    ...
    JZ 0x00525e54                       ; 00525dfd | LAB_00525e54
        ;   XREF to: 00525e54 (CONDITIONAL_JUMP)
    LEA EAX,[EBP + 0xffffff2a]          ; 00525dff
    MOV EDX,dword ptr [0x02f37ecc]      ; 00525e05 | undefined4 DAT_02f37ecc
    PUSH EAX                            ; 00525e0b
    ...
    PUSH EAX                            ; 00525e27
    PUSH 0x3f87558                      ; 00525e28 | CVector3f g_ZeroVector
    LEA EAX,[EBP + 0xffffff72]          ; 00525e2d
    PUSH EAX                            ; 00525e33
    CALL core_xform.cpp_transformVector3x4_FUN_005f4dc0 ; 00525e34 | CVector3f * core_xform.cpp_transformVector3x4_FUN_005f4dc0(CVector3f * output_vector, CVector3f * input_vector, CMatrix3x4f * matrix)
    ...
    PUSH EAX                            ; 00525e40
    PUSH EBX                            ; 00525e41
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 00525e42 | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
        ;   XREF to: 00408ec0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00525e47
    PUSH EAX                            ; 00525e4a
    PUSH EBX                            ; 00525e4b
    CALL core_enemy.cpp_FUN_004a9880    ; 00525e4c | undefined core_enemy.cpp_FUN_004a9880()
        ;   XREF to: 004a9880 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00525e51
    PUSH 0x41700000                     ; 00525e54
        ;   Label: LAB_00525e54
    PUSH 0x40e00000                     ; 00525e59
    CALL core_actor.cpp_getRandomFloat_FUN_0040cc10 ; 00525e5e | float core_actor.cpp_getRandomFloat_FUN_0040cc10(float min_value, float max_value)
        ;   XREF to: 0040cc10 (UNCONDITIONAL_CALL)
    ...
    JZ 0x00525b97                       ; 00525e81 | caseD_4
        ;   XREF to: 00525b97 (CONDITIONAL_JUMP)
    LEA EAX,[EBP + 0xffffff2a]          ; 00525e87
    MOV EDX,dword ptr [0x02f37ed0]      ; 00525e8d | undefined4 DAT_02f37ed0
    PUSH EAX                            ; 00525e93
    ...
    PUSH EAX                            ; 00525eaf
    PUSH 0x3f87558                      ; 00525eb0 | CVector3f g_ZeroVector
    LEA EAX,[EBP + -0xa]                ; 00525eb5
    PUSH EAX                            ; 00525eb8
    CALL core_xform.cpp_transformVector3x4_FUN_005f4dc0 ; 00525eb9 | CVector3f * core_xform.cpp_transformVector3x4_FUN_005f4dc0(CVector3f * output_vector, CVector3f * input_vector, CMatrix3x4f * matrix)
        ;   XREF to: 005f4dc0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00525ec5
    PUSH EBX                            ; 00525ec6
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 00525ec7 | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
        ;   XREF to: 00408ec0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00525ecc
    PUSH EAX                            ; 00525ecf
    PUSH EBX                            ; 00525ed0
    CALL core_enemy.cpp_FUN_004a9880    ; 00525ed1 | undefined core_enemy.cpp_FUN_004a9880()
        ;   XREF to: 004a9880 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00525ed6
    JMP 0x00525b97                      ; 00525ed9 | caseD_4
    ...
    FNSTSW AX                           ; 00525ee8
    SAHF                                ; 00525eea
    JC 0x00525b97                       ; 00525eeb | caseD_4
        ;   XREF to: 00525b97 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 00525ef1
    CALL core_mobster.cpp_FUN_005271c0  ; 00525ef2 | undefined core_mobster.cpp_FUN_005271c0()
        ;   XREF to: 005271c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00525ef7
    JMP 0x00525b97                      ; 00525efa | caseD_4
        ;   XREF to: 00525b97 (UNCONDITIONAL_JUMP)
    ...
    JNZ 0x00525f97                      ; 00525f1d | LAB_00525f97
        ;   XREF to: 00525f97 (CONDITIONAL_JUMP)
    FLD float ptr [EBX + 0xbf8c]        ; 00525f1f
        ;   Label: LAB_00525f1f
    FCOMP double ptr [0x0063988e]       ; 00525f25 | double DOUBLE_0063988e
    FNSTSW AX                           ; 00525f2b
    SAHF                                ; 00525f2d
    JNC 0x00526086                      ; 00525f2e | LAB_00526086
        ;   XREF to: 00526086 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0xbee8],0x0    ; 00525f34
        ;   Label: LAB_00525f34
    JZ 0x0052609e                       ; 00525f3b | LAB_0052609e
        ;   XREF to: 0052609e (CONDITIONAL_JUMP)
    PUSH 0x40a00000                     ; 00525f41
    PUSH 0x40800000                     ; 00525f46
    CALL core_actor.cpp_getRandomFloat_FUN_0040cc10 ; 00525f4b | float core_actor.cpp_getRandomFloat_FUN_0040cc10(float min_value, float max_value)
        ;   Label: LAB_00525f4b
        ;   XREF to: 0040cc10 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00525f69
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 00525f6a | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00525f6f
    PUSH 0x3e99999a                     ; 00525f72
    CALL core_actor.cpp_randomChance_FUN_0040cd10 ; 00525f77 | int core_actor.cpp_randomChance_FUN_0040cd10(float probability_threshold)
        ;   XREF to: 0040cd10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00525f7c
    TEST EAX,EAX                        ; 00525f7f
    JZ 0x00525b97                       ; 00525f81 | caseD_4
        ;   XREF to: 00525b97 (CONDITIONAL_JUMP)
    PUSH 0x3                            ; 00525f87
    PUSH EBX                            ; 00525f89
    CALL core_mobster.cpp_FUN_005279f0  ; 00525f8a | undefined core_mobster.cpp_FUN_005279f0()
        ;   XREF to: 005279f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00525f8f
    JMP 0x00525b97                      ; 00525f92 | caseD_4
        ;   XREF to: 00525b97 (UNCONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 00525fa4
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 00525fa5 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    MOV ESI,EAX                         ; 00525faa
    ADD ESP,0x8                         ; 00525fac
    MOV EDI,EAX                         ; 00525faf
    TEST EAX,EAX                        ; 00525fb1
    JZ 0x00526004                       ; 00525fb3 | LAB_00526004
        ;   XREF to: 00526004 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x006810c8]      ; 00525fb5 | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
    PUSH EDX                            ; 00525fbb | CDemonSet g_CDemonSetInstance
    CALL core_setcolid.cpp_CDemonSet_initMaybe_FUN_00574180 ; 00525fbc | void core_setcolid.cpp_CDemonSet_initMaybe_FUN_00574180(CDemonSet * this_ptr)
    ...
    JZ 0x00525ffb                       ; 00525fe9 | LAB_00525ffb
    ...
    PUSH ESI                            ; 00526011
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 00526012 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    MOV ESI,EAX                         ; 00526017
    ADD ESP,0x8                         ; 00526019
    MOV dword ptr [EBP + 0x5e],EAX      ; 0052601c
    TEST EAX,EAX                        ; 0052601f
    JZ 0x00525f1f                       ; 00526021 | LAB_00525f1f
        ;   XREF to: 00525f1f (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [0x006810c8]      ; 00526027 | CDemonSet * g_CDemonSetPtr
    PUSH EDI                            ; 0052602d | CDemonSet g_CDemonSetInstance
    CALL core_setcolid.cpp_CDemonSet_initMaybe_FUN_00574180 ; 0052602e | void core_setcolid.cpp_CDemonSet_initMaybe_FUN_00574180(CDemonSet * this_ptr)
        ;   XREF to: 00574180 (UNCONDITIONAL_CALL)
    ...
    JMP 0x00525f1f                      ; 00526081 | LAB_00525f1f
        ;   XREF to: 00525f1f (UNCONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 00526090
    SAHF                                ; 00526092
    JNC 0x00525f34                      ; 00526093 | LAB_00525f34
        ;   XREF to: 00525f34 (CONDITIONAL_JUMP)
    JMP 0x00525b97                      ; 00526099 | caseD_4
        ;   XREF to: 00525b97 (UNCONDITIONAL_JUMP)
    PUSH 0x40800000                     ; 0052609e
        ;   Label: LAB_0052609e
    PUSH 0x40000000                     ; 005260a3
    JMP 0x00525f4b                      ; 005260a8 | LAB_00525f4b
        ;   XREF to: 00525f4b (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0xbe28]    ; 005260ad
        ;   Label: caseD_5
    TEST EAX,EAX                        ; 005260b3
    JNZ 0x00525b97                      ; 005260b5 | caseD_4
        ;   XREF to: 00525b97 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0xdc],0x0      ; 005260bb
    JNZ 0x00525b97                      ; 005260c2 | caseD_4
        ;   XREF to: 00525b97 (CONDITIONAL_JUMP)
    PUSH EAX                            ; 005260c8
    LEA EAX,[EBP + 0x3e]                ; 005260c9
    PUSH EAX                            ; 005260cc
    PUSH ESI                            ; 005260cd
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneWorldPosition_FUN_0059fa20 ; 005260ce | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneWorldPosition_FUN_0059fa20(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
    ...
    PUSH EAX                            ; 005260da
    PUSH EBX                            ; 005260db
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 005260dc | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
        ;   XREF to: 00408ec0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005260e1
    PUSH 0x0                            ; 005260e4
    LEA EAX,[EBP + -0x3a]               ; 005260e6
    PUSH EAX                            ; 005260e9
    MOV ECX,dword ptr [0x0067b9a0]      ; 005260ea | CGore g_CGoreInstance | CGore * g_CGorePtr
    PUSH ECX                            ; 005260f0 | CGore g_CGoreInstance
    CALL core_gore.cpp_FUN_004ede30     ; 005260f1 | undefined core_gore.cpp_FUN_004ede30()
        ;   XREF to: 004ede30 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005260f6
    MOV dword ptr [EBX + 0xbe28],0x1    ; 005260f9
    JMP 0x00525b97                      ; 00526103 | caseD_4
        ;   XREF to: 00525b97 (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0xbee8],0x0    ; 00526108
        ;   Label: caseD_0
    JZ 0x00526146                       ; 0052610f | LAB_00526146
        ;   XREF to: 00526146 (CONDITIONAL_JUMP)
    MOV EAX,[0x02db87d0]                ; 00526111 | int g_LocalHeroIndex
    MOV EAX,dword ptr [EAX*0x4 + 0x2db87c0] ; 00526116 | CHero *[4] g_HeroActors
    FLD float ptr [EBX + 0xbf8c]        ; 0052611d
    MOV dword ptr [EBX + 0xbe3c],EAX    ; 00526123
    FCOMP double ptr [0x0063988e]       ; 00526129 | double DOUBLE_0063988e
    FNSTSW AX                           ; 0052612f
    SAHF                                ; 00526131
    JBE 0x00525b97                      ; 00526132 | caseD_4
        ;   XREF to: 00525b97 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 00526138
        ;   Label: LAB_00526138
    CALL core_mobster.cpp_FUN_005271c0  ; 00526139 | undefined core_mobster.cpp_FUN_005271c0()
        ;   XREF to: 005271c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052613e
    JMP 0x00525b97                      ; 00526141 | caseD_4
        ;   XREF to: 00525b97 (UNCONDITIONAL_JUMP)
    ...
    FADDP                               ; 005261ad
    FSQRT                               ; 005261af
    FCOMP double ptr [0x0063989e]       ; 005261b1 | double DOUBLE_0063989e
    FNSTSW AX                           ; 005261b7
    SAHF                                ; 005261b9
    JA 0x0052622a                       ; 005261ba | LAB_0052622a
        ;   XREF to: 0052622a (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0xbee0],0x0    ; 005261bc
        ;   Label: LAB_005261bc
    JZ 0x00526255                       ; 005261c3 | LAB_00526255
        ;   XREF to: 00526255 (CONDITIONAL_JUMP)
    FLD float ptr [EBX + 0xbf8c]        ; 005261c9
    FCOMP double ptr [0x0063988e]       ; 005261cf | double DOUBLE_0063988e
    FNSTSW AX                           ; 005261d5
    SAHF                                ; 005261d7
    JBE 0x00525b97                      ; 005261d8 | caseD_4
        ;   XREF to: 00525b97 (CONDITIONAL_JUMP)
    PUSH 0x3e800000                     ; 005261de
    CALL core_actor.cpp_randomChance_FUN_0040cd10 ; 005261e3 | int core_actor.cpp_randomChance_FUN_0040cd10(float probability_threshold)
        ;   XREF to: 0040cd10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005261e8
    TEST EAX,EAX                        ; 005261eb
    JZ 0x00526138                       ; 005261ed | LAB_00526138
        ;   XREF to: 00526138 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 005261f3
    CALL core_mobster.cpp_FUN_00525720  ; 005261f4 | undefined core_mobster.cpp_FUN_00525720()
        ;   XREF to: 00525720 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005261f9
    JMP 0x00525b97                      ; 005261fc | caseD_4
        ;   XREF to: 00525b97 (UNCONDITIONAL_JUMP)
    PUSH dword ptr [EBP + 0x92]         ; 00526201
        ;   Label: LAB_00526201
    PUSH EBX                            ; 00526207
    CALL core_enemy.cpp_CEnemy_FUN_004a9fd0 ; 00526208 | void core_enemy.cpp_CEnemy_FUN_004a9fd0(CEnemy * this_ptr)
        ;   XREF to: 004a9fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0052620d
    TEST EAX,EAX                        ; 00526210
    JZ 0x00525b97                       ; 00526212 | caseD_4
        ;   XREF to: 00525b97 (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 00526218
    PUSH 0x1                            ; 0052621a
    PUSH ESI                            ; 0052621c
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 0052621d | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00526222
    JMP 0x00525b97                      ; 00526225 | caseD_4
        ;   XREF to: 00525b97 (UNCONDITIONAL_JUMP)
    PUSH 0x1                            ; 0052622a
        ;   Label: LAB_0052622a
    PUSH 0x8                            ; 0052622c
    ...
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 00526239 | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0052623e
    JMP 0x00525b97                      ; 00526241 | caseD_4
        ;   XREF to: 00525b97 (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0xbed8],0x0    ; 00526246
        ;   Label: LAB_00526246
    JMP 0x005261bc                      ; 00526250 | LAB_005261bc
    ...
    FADDP                               ; 0052628d
    FSQRT                               ; 0052628f
    FLD float ptr [0x00661778]          ; 00526291 | undefined4 DAT_00661778
    FLD1                                ; 00526297
    FADDP                               ; 00526299
    FXCH                                ; 0052629b
    ...
    FNSTSW AX                           ; 005262ab
    SAHF                                ; 005262ad
    JNC 0x00526316                      ; 005262ae | LAB_00526316
        ;   XREF to: 00526316 (CONDITIONAL_JUMP)
    LEA EAX,[EBP + 0xffffff7e]          ; 005262b0
    PUSH EAX                            ; 005262b6
    LEA EAX,[EBP + 0x1a]                ; 005262b7
    PUSH EAX                            ; 005262ba
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 005262bb | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
    ...
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 005262cf | float core_actor.cpp_normalizeAngleToPi_FUN_0040cd70(float angle_radians)
        ;   XREF to: 0040cd70 (UNCONDITIONAL_CALL)
    MOV dword ptr [EBP + 0x76],EAX      ; 005262d4
    FLD float ptr [EBP + 0x76]          ; 005262d7
    FABS                                ; 005262da
    ADD ESP,0x4                         ; 005262dc
    FCOMP double ptr [0x00639896]       ; 005262df | double DOUBLE_00639896
    FNSTSW AX                           ; 005262e5
    SAHF                                ; 005262e7
    JNC 0x00526316                      ; 005262e8 | LAB_00526316
        ;   XREF to: 00526316 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 005262f4
    SAHF                                ; 005262f6
    JC 0x00526316                       ; 005262f7 | LAB_00526316
        ;   XREF to: 00526316 (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 005262f9
    PUSH 0x9                            ; 005262fb
    LEA EAX,[EBX + 0x158]               ; 005262fd
    PUSH EAX                            ; 00526303
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 00526304 | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ...
    FNSTSW AX                           ; 0052631f
    SAHF                                ; 00526321
    JNC 0x00526345                      ; 00526322 | LAB_00526345
    ...
    FNSTSW AX                           ; 00526333
    SAHF                                ; 00526335
    JNC 0x0052635d                      ; 00526336 | LAB_0052635d
        ;   XREF to: 0052635d (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 00526338
    PUSH 0x1                            ; 0052633a
    PUSH EDX                            ; 0052633c
        ;   Label: LAB_0052633c
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 0052633d | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00526342
    CMP dword ptr [EBX + 0xbecc],0x0    ; 00526345
        ;   Label: LAB_00526345
    JZ 0x00526363                       ; 0052634c | LAB_00526363
        ;   XREF to: 00526363 (CONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0xbecc],0x1    ; 0052634e
        ;   Label: LAB_0052634e
    JMP 0x00525b97                      ; 00526358 | caseD_4
        ;   XREF to: 00525b97 (UNCONDITIONAL_JUMP)
    PUSH 0x1                            ; 0052635d
        ;   Label: LAB_0052635d
    PUSH 0x8                            ; 0052635f
    JMP 0x0052633c                      ; 00526361 | LAB_0052633c
        ;   XREF to: 0052633c (UNCONDITIONAL_JUMP)
    PUSH 0x3f333333                     ; 00526363
        ;   Label: LAB_00526363
    CALL core_actor.cpp_randomChance_FUN_0040cd10 ; 00526368 | int core_actor.cpp_randomChance_FUN_0040cd10(float probability_threshold)
        ;   XREF to: 0040cd10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052636d
    TEST EAX,EAX                        ; 00526370
    JZ 0x0052634e                       ; 00526372 | LAB_0052634e
        ;   XREF to: 0052634e (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 00526374
    PUSH EBX                            ; 00526376
    CALL core_mobster.cpp_FUN_005279f0  ; 00526377 | undefined core_mobster.cpp_FUN_005279f0()
        ;   XREF to: 005279f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0052637c
    MOV dword ptr [EBX + 0xbecc],0x1    ; 0052637f
    JMP 0x00525b97                      ; 00526389 | caseD_4
        ;   XREF to: 00525b97 (UNCONDITIONAL_JUMP)
    ...
    JZ 0x0052644b                       ; 005263b2 | LAB_0052644b
        ;   XREF to: 0052644b (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0xbed8],0x0    ; 005263b8
    JZ 0x00526493                       ; 005263bf | LAB_00526493
    ...
    MOV EAX,[0x00661778]                ; 005263e9 | undefined4 DAT_00661778
    ...
    PUSH EAX                            ; 0052641b
    PUSH EBX                            ; 0052641c
    CALL core_charactr.cpp_CCharacter_walkToPoint_FUN_004286e0 ; 0052641d | int core_charactr.cpp_CCharacter_walkToPoint_FUN_004286e0(CCharacter * this_ptr)
        ;   XREF to: 004286e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x18                        ; 00526422
    TEST EAX,EAX                        ; 00526425
    JG 0x00526481                       ; 00526427 | LAB_00526481
        ;   XREF to: 00526481 (CONDITIONAL_JUMP)
    JGE 0x00525b97                      ; 00526429 | caseD_4
        ;   XREF to: 00525b97 (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 0052642f
    PUSH 0x0                            ; 00526431
    PUSH ESI                            ; 00526433
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 00526434 | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00526439
    MOV dword ptr [EBX + 0xbedc],0x0    ; 0052643c
    JMP 0x00525b97                      ; 00526446 | caseD_4
        ;   XREF to: 00525b97 (UNCONDITIONAL_JUMP)
    PUSH dword ptr [EBP + 0x92]         ; 0052644b
        ;   Label: LAB_0052644b
    PUSH EBX                            ; 00526451
    CALL core_enemy.cpp_CEnemy_FUN_004a9fd0 ; 00526452 | void core_enemy.cpp_CEnemy_FUN_004a9fd0(CEnemy * this_ptr)
        ;   XREF to: 004a9fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00526457
    TEST EAX,EAX                        ; 0052645a
    JZ 0x00526470                       ; 0052645c | LAB_00526470
        ;   XREF to: 00526470 (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 0052645e
    PUSH 0x1                            ; 00526460
    PUSH ESI                            ; 00526462
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 00526463 | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00526468
    JMP 0x00525b97                      ; 0052646b | caseD_4
        ;   XREF to: 00525b97 (UNCONDITIONAL_JUMP)
    PUSH 0x1                            ; 00526470
        ;   Label: LAB_00526470
    PUSH EAX                            ; 00526472
    PUSH ESI                            ; 00526473
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 00526474 | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00526479
    JMP 0x00525b97                      ; 0052647c | caseD_4
        ;   XREF to: 00525b97 (UNCONDITIONAL_JUMP)
    PUSH 0x1                            ; 00526481
        ;   Label: LAB_00526481
    PUSH 0x0                            ; 00526483
    PUSH ESI                            ; 00526485
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 00526486 | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0052648b
    JMP 0x00525b97                      ; 0052648e | caseD_4
        ;   XREF to: 00525b97 (UNCONDITIONAL_JUMP)
    PUSH dword ptr [EBP + 0x92]         ; 00526493
        ;   Label: LAB_00526493
    PUSH EBX                            ; 00526499
    CALL core_mobster.cpp_FUN_00526d90  ; 0052649a | undefined core_mobster.cpp_FUN_00526d90()
        ;   XREF to: 00526d90 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0052649f
    TEST EAX,EAX                        ; 005264a2
    JNZ 0x00525b97                      ; 005264a4 | caseD_4
        ;   XREF to: 00525b97 (CONDITIONAL_JUMP)
    FLD float ptr [0x00661778]          ; 005264aa | undefined4 DAT_00661778
    FLD1                                ; 005264b0
    FADDP                               ; 005264b2
    MOV ESI,dword ptr [EBX + 0x24f8]    ; 005264b4
    FSTP float ptr [EBP + 0x66]         ; 005264ba
    TEST ESI,ESI                        ; 005264bd
    JZ 0x005264c9                       ; 005264bf | LAB_005264c9
        ;   XREF to: 005264c9 (CONDITIONAL_JUMP)
    MOV EAX,[0x0066177c]                ; 005264c1 | undefined4 DAT_0066177c
    ...
    MOV EAX,[0x00661778]                ; 005264ed | undefined4 DAT_00661778
    ...
    PUSH EAX                            ; 00526522
    PUSH EBX                            ; 00526523
    CALL core_charactr.cpp_CCharacter_walkToPoint_FUN_004286e0 ; 00526524 | int core_charactr.cpp_CCharacter_walkToPoint_FUN_004286e0(CCharacter * this_ptr)
        ;   XREF to: 004286e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x18                        ; 00526529
    TEST EAX,EAX                        ; 0052652c
    JL 0x00525b97                       ; 0052652e | caseD_4
        ;   XREF to: 00525b97 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0052657c
    SAHF                                ; 0052657e
    JA 0x00526648                       ; 0052657f | LAB_00526648
    ...
    FNSTSW AX                           ; 005265b8
    SAHF                                ; 005265ba
    JNC 0x00526672                      ; 005265bb | LAB_00526672
    ...
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 005265e9 | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)
    ...
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 005265fd | float core_actor.cpp_normalizeAngleToPi_FUN_0040cd70(float angle_radians)
        ;   XREF to: 0040cd70 (UNCONDITIONAL_CALL)
    MOV dword ptr [EBP + 0x76],EAX      ; 00526602
    FLD float ptr [EBP + 0x76]          ; 00526605
    FABS                                ; 00526608
    ADD ESP,0x4                         ; 0052660a
    FCOMP double ptr [0x00639896]       ; 0052660d | double DOUBLE_00639896
    FNSTSW AX                           ; 00526613
    SAHF                                ; 00526615
    JNC 0x0052663e                      ; 00526616 | LAB_0052663e
    ...
    FNSTSW AX                           ; 00526622
    SAHF                                ; 00526624
    JC 0x0052663e                       ; 00526625 | LAB_0052663e
        ;   XREF to: 0052663e (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 00526627
    PUSH 0x9                            ; 00526629
    PUSH ESI                            ; 0052662b
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 0052662c | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ...
    FNSTSW AX                           ; 00526651
    SAHF                                ; 00526653
    JBE 0x00525b97                      ; 00526654 | caseD_4
        ;   XREF to: 00525b97 (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 0052665a
    PUSH 0x0                            ; 0052665c
    LEA EAX,[EBX + 0x158]               ; 0052665e
    PUSH EAX                            ; 00526664
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 00526665 | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0052666a
    JMP 0x00525b97                      ; 0052666d | caseD_4
        ;   XREF to: 00525b97 (UNCONDITIONAL_JUMP)
    FLD float ptr [EBX + 0xbf8c]        ; 00526672
        ;   Label: LAB_00526672
    FCOMP double ptr [0x0063988e]       ; 00526678 | double DOUBLE_0063988e
    FNSTSW AX                           ; 0052667e
    SAHF                                ; 00526680
    JBE 0x0052663e                      ; 00526681 | LAB_0052663e
        ;   XREF to: 0052663e (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0052668d
    SAHF                                ; 0052668f
    JC 0x0052663e                       ; 00526690 | LAB_0052663e
        ;   XREF to: 0052663e (CONDITIONAL_JUMP)
    PUSH 0x3e99999a                     ; 00526692
    MOV dword ptr [EBX + 0xbed4],0x0    ; 00526697
    CALL core_actor.cpp_randomChance_FUN_0040cd10 ; 005266a1 | int core_actor.cpp_randomChance_FUN_0040cd10(float probability_threshold)
        ;   XREF to: 0040cd10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005266a6
    TEST EAX,EAX                        ; 005266a9
    JZ 0x005266b8                       ; 005266ab | LAB_005266b8
        ;   XREF to: 005266b8 (CONDITIONAL_JUMP)
    PUSH 0x2                            ; 005266ad
    PUSH EBX                            ; 005266af
    CALL core_mobster.cpp_FUN_005279f0  ; 005266b0 | undefined core_mobster.cpp_FUN_005279f0()
        ;   XREF to: 005279f0 (UNCONDITIONAL_CALL)
    ...
    FNSTSW AX                           ; 005266c2
    SAHF                                ; 005266c4
    JNC 0x005266fb                      ; 005266c5 | LAB_005266fb
        ;   XREF to: 005266fb (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [EBX + 0x24b4]    ; 005266c7
    LEA EAX,[EBX + 0x158]               ; 005266cd
    TEST EDX,EDX                        ; 005266d3
    JZ 0x005266e9                       ; 005266d5 | LAB_005266e9
        ;   XREF to: 005266e9 (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 005266d7
    PUSH 0xb                            ; 005266d9
    PUSH EAX                            ; 005266db
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 005266dc | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005266e1
    JMP 0x0052663e                      ; 005266e4 | LAB_0052663e
        ;   XREF to: 0052663e (UNCONDITIONAL_JUMP)
    PUSH 0x1                            ; 005266e9
        ;   Label: LAB_005266e9
    PUSH 0xa                            ; 005266eb
    PUSH EAX                            ; 005266ed
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 005266ee | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005266f3
    JMP 0x0052663e                      ; 005266f6 | LAB_0052663e
        ;   XREF to: 0052663e (UNCONDITIONAL_JUMP)
    PUSH EBX                            ; 005266fb
        ;   Label: LAB_005266fb
    CALL core_mobster.cpp_FUN_005271c0  ; 005266fc | undefined core_mobster.cpp_FUN_005271c0()
        ;   XREF to: 005271c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00526701
    JMP 0x0052663e                      ; 00526704 | LAB_0052663e
        ;   XREF to: 0052663e (UNCONDITIONAL_JUMP)
    ...
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 00526731 | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)
    ...
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 00526745 | float core_actor.cpp_normalizeAngleToPi_FUN_0040cd70(float angle_radians)
        ;   XREF to: 0040cd70 (UNCONDITIONAL_CALL)
    MOV dword ptr [EBP + 0x76],EAX      ; 0052674a
    FLD float ptr [EBP + 0x76]          ; 0052674d
    FABS                                ; 00526750
    ADD ESP,0x4                         ; 00526752
    FCOMP double ptr [0x00639896]       ; 00526755 | double DOUBLE_00639896
    FNSTSW AX                           ; 0052675b
    SAHF                                ; 0052675d
    JNC 0x0052663e                      ; 0052675e | LAB_0052663e
        ;   XREF to: 0052663e (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 00526764
    PUSH 0x9                            ; 00526766
    PUSH ESI                            ; 00526768
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 00526769 | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0052676e
    JMP 0x0052663e                      ; 00526771 | LAB_0052663e
        ;   XREF to: 0052663e (UNCONDITIONAL_JUMP)
    CMP EDI,0xb                         ; 00526776
        ;   Label: LAB_00526776
    JA 0x00525b97                       ; 00526779 | caseD_4
        ;   XREF to: 00525b97 (CONDITIONAL_JUMP)
    JMP dword ptr [EDI*0x4 + 0x525810]  ; 0052677f | void * switchdataD_00525810
        ;   Label: switchD
    PUSH EBX                            ; 00526786
        ;   Label: LAB_00526786
    CALL core_mobster.cpp_FUN_00525650  ; 00526787 | undefined core_mobster.cpp_FUN_00525650()
        ;   XREF to: 00525650 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052678c
    JMP 0x00525cd1                      ; 0052678f | LAB_00525cd1
