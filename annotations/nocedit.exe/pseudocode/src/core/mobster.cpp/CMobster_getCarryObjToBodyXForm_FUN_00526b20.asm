...
section .text
    ...
    PUSH EBX                            ; 00526b20
        ;   Label: core_mobster.cpp_CMobster_getCarryObjToBodyXForm_FUN_00526b20
    PUSH EDI                            ; 00526b21
    PUSH EBP                            ; 00526b22
    ...
    JMP 0x03fc4239                      ; 00526c27
        ;   XREF to: 03fc4239 (UNCONDITIONAL_JUMP)  ; LAB_03fc4239
    ...
    MOV ECX,0xc                         ; 03fc4239
        ;   Label: LAB_03fc4239
    LEA ESI,[ESP + 0x38]                ; 03fc423e
    ADD ESP,0x8                         ; 03fc4242
    MOV ECX,dword ptr [ESI]             ; 03fc4245
    MOV dword ptr [EDI],ECX             ; 03fc4247
    MOV ECX,dword ptr [ESI + 0x4]       ; 03fc4249
    MOV dword ptr [EDI + 0x4],ECX       ; 03fc424c
    MOV ECX,dword ptr [ESI + 0x8]       ; 03fc424f
    MOV dword ptr [EDI + 0x8],ECX       ; 03fc4252
    MOV ECX,dword ptr [ESI + 0xc]       ; 03fc4255
    MOV dword ptr [EDI + 0xc],ECX       ; 03fc4258
    MOV ECX,dword ptr [ESI + 0x10]      ; 03fc425b
    MOV dword ptr [EDI + 0x10],ECX      ; 03fc425e
    MOV ECX,dword ptr [ESI + 0x14]      ; 03fc4261
    MOV dword ptr [EDI + 0x14],ECX      ; 03fc4264
    MOV ECX,dword ptr [ESI + 0x18]      ; 03fc4267
    MOV dword ptr [EDI + 0x18],ECX      ; 03fc426a
    MOV ECX,dword ptr [ESI + 0x1c]      ; 03fc426d
    MOV dword ptr [EDI + 0x1c],ECX      ; 03fc4270
    MOV ECX,dword ptr [ESI + 0x20]      ; 03fc4273
    MOV dword ptr [EDI + 0x20],ECX      ; 03fc4276
    MOV ECX,dword ptr [ESI + 0x24]      ; 03fc4279
    MOV dword ptr [EDI + 0x24],ECX      ; 03fc427c
    MOV ECX,dword ptr [ESI + 0x28]      ; 03fc427f
    MOV dword ptr [EDI + 0x28],ECX      ; 03fc4282
    MOV ECX,dword ptr [ESI + 0x2c]      ; 03fc4285
    MOV dword ptr [EDI + 0x2c],ECX      ; 03fc4288
    ADD ESI,0x30                        ; 03fc428b
    ADD EDI,0x30                        ; 03fc428e
    XOR ECX,ECX                         ; 03fc4291
    JMP 0x00526c35                      ; 03fc4293
        ;   XREF to: 00526c35 (UNCONDITIONAL_JUMP)  ; LAB_00526c35
