...
;
; XREF[1]:
;   core_mobster.cpp_CMobster_process_FUN_00525840 at 0052649a
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00526d90
        ;   Label: core_mobster.cpp_CMobster_processWeaponPickup_FUN_00526d90
    PUSH ESI                            ; 00526d91
    PUSH EDI                            ; 00526d92
    PUSH EBP                            ; 00526d93
    ...
    MOV EBX,dword ptr [EDI + EAX*0x1 + 0x14d158] ; 00526e4a | g_CDemonSetInstance.actors[0] | g_CDemonSetInstance.actors[1]
    PUSH EBX                            ; 00526e51
    ...
    CALL core_actor.cpp_getRandomFloatFromRange_FUN_0040cc10 ; 00526e97
        ;   XREF to: 0040cc10 (UNCONDITIONAL_CALL)  ; float core_actor.cpp_getRandomFloatFromRange_FUN_0040cc10(float min_value, float max_value)
    MOV dword ptr [ESP + 0xa4],EAX      ; 00526e9c
    FLD float ptr [ESP + 0xa4]          ; 00526ea3
    ADD ESP,0x8                         ; 00526eaa
    MOV EAX,dword ptr [EBP + 0x14]      ; 00526ead
    FSTP float ptr [EAX + 0xbec0]       ; 00526eb0
    JMP 0x00526dcb                      ; 00526eb6
        ;   XREF to: 00526dcb (UNCONDITIONAL_JUMP)  ; LAB_00526dcb
