...
/* Signature: byte actors_enemy_mobster.cpp_FUN_00525340(uint param_1) */
...

{
  ...
  *(uint *)((in_stack_00000004->base_character).carry_hands[0].field0_0x0 + 4) =
       *(uint *)(in_stack_00000004[1].base_character.base_actor.create_event + 0x38);
  *(int *)(in_stack_00000004->base_character).carry_hands[1].field0_0x0 = DAT_02f37ed0;
  *(uint *)((in_stack_00000004->base_character).carry_hands[1].field0_0x0 + 4) =
       *(uint *)(in_stack_00000004[1].base_character.base_actor.create_event + 0x40);
