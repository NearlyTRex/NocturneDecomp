...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_mobster_cpp_CMobster_writeDependencies_FUN_00527c40(CMobster *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00527c40
        ;   Label: core_mobster.cpp_CMobster_writeDependencies_FUN_00527c40
    ...
    PUSH EAX                            ; 00527c61
    CALL core_skeledit.cpp_CDeformableModelInstance_writeDependencies_FUN_0058a260 ; 00527c62
