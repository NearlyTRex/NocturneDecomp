  ...
  if ((in_stack_00000004->base).carry_hands[1].carry_actor == (CDemonActor *)0x0) {
    ...
    if (*(int *)(in_stack_00000004->unk2 + 4) != 0) {
      ...
      if ((local_88 <= ABS((float)local_18)) || (local_84 <= (float)2)) {
        ...
        *(float *)(in_stack_00000004[1].base.base.create_event + 0x60) = fVar8;
        if (1.0 < fVar8) {
          ...
          (pCVar1->base).create_event[0x60] = '\0';
          (pCVar1->base).create_event[0x61] = '\0';
          (pCVar1->base).create_event[0x62] = -0x80;
          (pCVar1->base).create_event[99] = '?';
        }
      }
      local_1c = -local_88;
      ...
      if ((in_stack_00000004->base).carry_hands[0].carry_actor == (CDemonActor *)0x0) {
        fVar8 = *(float *)(in_stack_00000004[1].base.base.create_event + 0x60);
        iVar2 = 2;
      }
      else {
        fVar8 = *(float *)(in_stack_00000004[1].base.base.create_event + 0x60);
      ...
      core_skeleton_cpp_CDeformableModelInstance_blendMotion_FUN_0059eb50
                (&(in_stack_00000004->base).model,iVar2,6.0,fVar8,INT_02f37ef0,
      ...
      *puVar6 = *puVar5;
      ...
      core_skeleton_cpp_CDeformableModelInstance_applyRotationToHierarchy_FUN_0059ff20
                (local_18,&local_80,*(float *)(in_stack_00000004[1].base.base.create_event + 0x60),
                 INT_02f37ef0,core_skeleton_cpp_defaultBlendWeight_FUN_0059ddb0);
