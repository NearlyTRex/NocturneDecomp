...
section .text
    ...
    FNSTSW AX                           ; 00527399
    SAHF                                ; 0052739b
    JNC 0x005273c8                      ; 0052739c | default
        ;   XREF to: 005273c8 (CONDITIONAL_JUMP)
    CMP dword ptr [ESI],-0x1            ; 0052739e
    JNZ 0x005273c8                      ; 005273a1 | default
        ;   XREF to: 005273c8 (CONDITIONAL_JUMP)
    CALL crt_stdlib.c_rand_FUN_005feb5c ; 005273a3 | int crt_stdlib.c_rand_FUN_005feb5c()
    ...
    JA 0x005273c8                       ; 005273b7 | default
        ;   XREF to: 005273c8 (CONDITIONAL_JUMP)
    JMP dword ptr [EDX*0x4 + 0x527364]  ; 005273b9 | void * switchdataD_00527364
        ;   Label: switchD
    ...
    JNZ 0x00527682                      ; 005273d2 | LAB_00527682
        ;   XREF to: 00527682 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [EBX + 0xbf84]    ; 005273d8
        ;   Label: LAB_005273d8
    CMP ECX,dword ptr [ESI]             ; 005273de
    JNZ 0x00527413                      ; 005273e0 | LAB_00527413
        ;   XREF to: 00527413 (CONDITIONAL_JUMP)
    PUSH 0x3f800000                     ; 005273e2
    PUSH 0x0                            ; 005273e7
    CALL core_actor.cpp_getRandomFloat_FUN_0040cc10 ; 005273e9 | float core_actor.cpp_getRandomFloat_FUN_0040cc10(float min_value, float max_value)
        ;   XREF to: 0040cc10 (UNCONDITIONAL_CALL)
    MOV dword ptr [ESP + 0x20],EAX      ; 005273ee
    FLD float ptr [ESP + 0x20]          ; 005273f2
    ADD ESP,0x8                         ; 005273f6
    FST double ptr [ESP]                ; 005273f9
    FCOMP double ptr [0x006399ae]       ; 005273fc | double DOUBLE_006399ae
    FNSTSW AX                           ; 00527402
    SAHF                                ; 00527404
    JNC 0x005276c3                      ; 00527405 | LAB_005276c3
    ...
    JNZ 0x0052742c                      ; 00527422 | LAB_0052742c
    ...
    JNZ 0x0052743e                      ; 00527434 | LAB_0052743e
        ;   XREF to: 0052743e (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x14],0x3d75c28f ; 00527436
    MOV EAX,[0x0067b654]                ; 0052743e | CGame * g_CGamePtr
        ;   Label: LAB_0052743e
    CMP dword ptr [EAX + 0x1e0],0x0     ; 00527443 | g_CGameInstance.field57_0x1e0
    JZ 0x00527454                       ; 0052744a | LAB_00527454
        ;   XREF to: 00527454 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x14],0x3f800000 ; 0052744c
    MOV EAX,[0x0067b654]                ; 00527454 | CGame g_CGameInstance | CGame * g_CGamePtr
        ;   Label: LAB_00527454
    MOV EDX,dword ptr [EAX + 0x14]      ; 00527459 | g_CGameInstance.blood_flag
    TEST EDX,EDX                        ; 0052745c
    JNZ 0x00527464                      ; 0052745e | LAB_00527464
        ;   XREF to: 00527464 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x14],EDX      ; 00527460
    PUSH dword ptr [ESP + 0x14]         ; 00527464
        ;   Label: LAB_00527464
    CALL core_actor.cpp_randomChance_FUN_0040cd10 ; 00527468 | int core_actor.cpp_randomChance_FUN_0040cd10(float probability_threshold)
        ;   XREF to: 0040cd10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052746d
    TEST EAX,EAX                        ; 00527470
    JZ 0x0052761a                       ; 00527472 | LAB_0052761a
    ...
    PUSH EAX                            ; 0052748a
    CALL core_bodypart.cpp_CreateBodyPart_FUN_00418e10 ; 0052748b | undefined core_bodypart.cpp_CreateBodyPart_FUN_00418e10()
    ...
    PUSH EDI                            ; 0052749e
    PUSH EBX                            ; 0052749f
    CALL core_charactr.cpp_CCharacter_FUN_0042bd30 ; 005274a0 | void core_charactr.cpp_CCharacter_FUN_0042bd30(CCharacter * this_ptr)
    ...
    JNZ 0x005274c7                      ; 005274b2 | LAB_005274c7
    ...
    PUSH EDI                            ; 005274bd
    PUSH EBX                            ; 005274be
    CALL core_charactr.cpp_CCharacter_FUN_0042bd30 ; 005274bf | void core_charactr.cpp_CCharacter_FUN_0042bd30(CCharacter * this_ptr)
        ;   XREF to: 0042bd30 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 005274c4
    MOV EDI,dword ptr [EBX + 0xbf68]    ; 005274c7
        ;   Label: LAB_005274c7
    CMP EDI,dword ptr [ESI]             ; 005274cd
    JNZ 0x005274e8                      ; 005274cf | LAB_005274e8
    ...
    PUSH EDX                            ; 005274de
    PUSH EBX                            ; 005274df
    CALL core_charactr.cpp_CCharacter_FUN_0042bd30 ; 005274e0 | void core_charactr.cpp_CCharacter_FUN_0042bd30(CCharacter * this_ptr)
        ;   XREF to: 0042bd30 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 005274e5
    MOV ECX,dword ptr [EBX + 0xbf84]    ; 005274e8
        ;   Label: LAB_005274e8
    CMP ECX,dword ptr [ESI]             ; 005274ee
    JNZ 0x00527580                      ; 005274f0 | LAB_00527580
    ...
    PUSH EAX                            ; 00527502
    PUSH EBX                            ; 00527503
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 00527504 | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
    ...
    PUSH EDX                            ; 00527515
    PUSH EBX                            ; 00527516
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 00527517 | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ...
    PUSH ECX                            ; 00527528
    PUSH EBX                            ; 00527529
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 0052752a | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0052753b
    PUSH EBX                            ; 0052753c
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 0052753d | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDX                            ; 0052754e
    PUSH EBX                            ; 0052754f
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 00527550 | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ...
    PUSH 0x63999e                       ; 00527580 | = "limb?.wav" | s_limb_wav_0063999e = limb?.wav
        ;   Label: LAB_00527580
    PUSH EBX                            ; 00527585
    CALL core_charactr.cpp_CCharacter_FUN_0042f300 ; 00527586 | void core_charactr.cpp_CCharacter_FUN_0042f300(CCharacter * this_ptr)
        ;   XREF to: 0042f300 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0052758b
    MOV ECX,dword ptr [ESP + 0x10]      ; 0052758e
    PUSH ECX                            ; 00527592
    CALL core_bodypart.cpp_FUN_0041a050 ; 00527593 | undefined core_bodypart.cpp_FUN_0041a050()
    ...
    JNZ 0x005276fd                      ; 00527600 | LAB_005276fd
    ...
    FLD float ptr [ESI + 0x4]           ; 00527725
        ;   Label: LAB_00527725
    FLD ST0                             ; 00527728
    FMUL double ptr [0x006399c6]        ; 0052772a | double DOUBLE_006399c6
    FSTP ST1                            ; 00527730
