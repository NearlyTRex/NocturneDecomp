...

{
  ...
  if (0 < (this_ptr->base).base.fire_count) {
    ...
    if (((EVar7 == DEATH_STATE_ALIVE) &&
        (iVar11 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660(this_ptr->sfx_handle), iVar11 == 0))
  ...
  fVar20 = this_ptr->firing_cooldown - delta_time;
  this_ptr->firing_cooldown = fVar20;
  if (fVar20 < 0.0) {
    this_ptr->firing_cooldown = 0.0;
  }
  fVar20 = this_ptr->taunt_timer - delta_time;
  this_ptr->taunt_timer = fVar20;
  if (fVar20 < 0.0) {
  ...
  if ((this_ptr->hold_pos_flag == 0) &&
     (iVar11 = core_event_cpp_CEventList_evaluateCondition_FUN_004adca0
                         (g_CEventListPtr,this_ptr->hold_pos_condition), iVar11 != 0)) {
  ...
  while (0.0 < local_38) {
    ...
    if (iVar11 == 100) {
      pCVar16 = this_ptr->target_weapon;
      if (pCVar16 != (CDemonActor *)0x0) {
        ...
        core_charactr_cpp_CCharacter_pickupObjectNow_FUN_0042cdb0
                  ((CCharacter *)this_ptr,1,pCVar16,0.2);
      }
    }
    else {
  ...
  fVar21 = (float)3.1415926535000001;
  (this_ptr->base).base.walk_step_speed = (this_ptr->base).base.model.accumulated_root_motion.z;
  (this_ptr->base).base.turn_speed = delta_time * fVar21 * fVar20;
  ...
  if (iVar10 == 0) {
    ...
    case 0:
      if (this_ptr->hold_pos_flag == 0) {
        ...
        pCVar16 = this_ptr->our_post;
        if (pCVar16 != (CDemonActor *)0x0) {
          if (this_ptr->post_mode == 0) {
            fVar20 = (this_ptr->base).base.base.location.position.x - (pCVar16->location).position.x
            ;
            fVar21 = (this_ptr->base).base.base.location.position.y - (pCVar16->location).position.y
            ;
            fVar10 = (this_ptr->base).base.base.location.position.z - (pCVar16->location).position.z
            ;
            if ((float)2 < SQRT(fVar10 * fVar10 + fVar20 * fVar20 + fVar21 * fVar21))
            {
        ...
        if (this_ptr->vehicle == (CDemonActor *)0x0) {
          ...
          local_10c.x = (pCVar9->base).location.position.x -
                        (this_ptr->base).base.base.location.position.x;
          local_10c.y = (pCVar9->base).location.position.y -
                        (this_ptr->base).base.base.location.position.y;
          local_10c.z = (pCVar9->base).location.position.z -
          ...
          if ((this_ptr->weapon_search_count == 0) &&
             (iVar11 = core_actor_cpp_randomChance_FUN_0040cd10(0.7), iVar11 != 0)) {
    ...
    case 8:
      ...
      if ((this_ptr->base).victim == (CCharacter *)0x0) {
        ...
        iVar11 = core_mobster_cpp_CMobster_processWeaponPickup_FUN_00526d90(this_ptr,delta_time);
        if (iVar11 == 0) {
          local_24 = 3.0f + 1.0;
          ...
          local_a0.y = 0.0;
          pCVar9 = (this_ptr->base).victim;
          path_map = (*((pCVar9->base).vtable._ub)->getPathMap)(&pCVar9->base);
          iVar11 = core_charactr_cpp_CCharacter_walkToPoint_FUN_004286e0
                             ((CCharacter *)this_ptr,
                              &(((this_ptr->base).victim)->base).location.position,path_map,pCVar18,
                              fVar20,fVar21);
          if (-1 < iVar11) {
            pCVar1 = &(this_ptr->base).base.base.location;
            pCVar9 = (this_ptr->base).victim;
            fVar20 = (pCVar1->position).x - (pCVar9->base).location.position.x;
            fVar21 = (this_ptr->base).base.base.location.position.z -
                     (pCVar9->base).location.position.z;
            local_30 = SQRT(fVar21 * fVar21 + fVar20 * fVar20);
            local_1c = local_30;
            if ((local_30 <= local_24) && ((this_ptr->base).attack_cooldown <= 0.0)) {
              pCVar6 = &(this_ptr->base).base.model;
              if ((this_ptr->base).base.carry_hands[1].carry_actor == (CDemonActor *)0x0) {
                pCVar9 = (this_ptr->base).victim;
                local_b8.x = (pCVar9->base).location.position.x - (pCVar1->position).x;
                local_b8.y = (pCVar9->base).location.position.y -
                             (this_ptr->base).base.base.location.position.y;
                local_b8.z = (pCVar9->base).location.position.z -
                             (this_ptr->base).base.base.location.position.z;
                ...
                if (((float)0.5 < this_ptr->firing_blend) &&
                   (this_ptr->firing_cooldown <= 0.0)) {
                  this_ptr->taunt_timer = 0.0;
                  iVar11 = core_actor_cpp_randomChance_FUN_0040cd10(0.3);
                  if (iVar11 != 0) {
                ...
                pCVar9 = (this_ptr->base).victim;
                local_e8.x = (pCVar9->base).location.position.x - (pCVar1->position).x;
                local_e8.y = (pCVar9->base).location.position.y -
                             (this_ptr->base).base.base.location.position.y;
                local_e8.z = (pCVar9->base).location.position.z -
                             (this_ptr->base).base.base.location.position.z;
                core_vecdir_cpp_convertDirectionVectorToEulerAngles_FUN_005e7830
                          (&local_58,&local_e8);
                local_14 = core_actor_cpp_normalizeAngleToPi_FUN_0040cd70
    ...
    case 6:
      ...
      if ((this_ptr->base).victim != (CCharacter *)0x0) {
        ...
        if (pCVar14 != (CWeapon *)0x0) {
          ...
          iVar11 = (*(pCVar5->_uw).isReadyToFire)(pCVar14);
          if (iVar11 != 0) {
        ...
        if (this_ptr_00 != (CWeapon *)0x0) {
          core_setcolid_cpp_CDemonSet_init_FUN_00574180(g_CDemonSetPtr);
          pCVar8 = (this_ptr_00->base).vtable._uw;
          iVar11 = this_ptr_00->ammo_count;
          this_ptr_00->ammo_count = 100;
          iVar19 = (*(pCVar8->_uw).isReadyToFire)(this_ptr_00);
          if (iVar19 == 0) {
            local_2c->ammo_count = iVar11;
          }
          else {
      ...
      if ((this_ptr->firing_blend < (float)0.5) || (this_ptr->firing_cooldown <= 0.0)) {
        ...
        local_14 = core_actor_cpp_getRandomFloat_FUN_0040cc10(fVar20,fVar21);
    ...
    case 5:
      if (((this_ptr->base).pool_me == 0) &&
        ...
        core_actor_cpp_CDemonActor_localToWorldPoint_FUN_00408ec0
                  ((CDemonActor *)this_ptr,&local_c4,pCVar18);
    ...
    case 9:
      ...
      if ((this_ptr->base).base.model.part_data.visibility_flags[this_ptr->part_indices[3]] != 0) {
        ...
        core_enemy_cpp_CEnemy_testAttackRadius_FUN_004a9880
                  (&this_ptr->base,pCVar18,fVar20,damage_info);
      }
      break;
    case 10:
    case 0xb:
...
LAB_00525dac:
    ...
    if (uVar7 < 3) goto LAB_00525b6c;
    if (uVar7 != 3) goto LAB_00525dac;
...
switchD_0052677f_caseD_7:
  ...
  if (this_ptr->vehicle == (CDemonActor *)0x0) {
    ...
    if (iVar11 != 0) {
      ...
      pCVar18 = &(this_ptr->base).base.position_delta;
      pCVar3 = &(this_ptr->base).base.model.accumulated_root_motion;
      local_7c.x = (this_ptr->base).base.velocity.x * delta_time + pCVar18->x + pCVar3->x;
      ...
      pCVar18->x = (this_ptr->base).base.position_delta.y;
      (this_ptr->base).base.model.accumulated_root_motion.z = 0.0;
  ...
  if (pCVar16 != (CDemonActor *)0x0) {
    (*((pCVar16->vtable)._ub)->process)(pCVar16,delta_time);
  }
  core_charactr_cpp_CCharacter_preProcess_FUN_00429820((CCharacter *)this_ptr);
  core_skeleton_cpp_CDeformableModelInstance_updateAnimation_FUN_0059e020
            (&(this_ptr->base).base.model);
  EVar17 = (*(((this_ptr->base).base.base.vtable._uc)->_uc).getDeathState)((CCharacter *)this_ptr);
  if (EVar17 == DEATH_STATE_ALIVE) {
