...

{
  ...
  if (this_ptr->blown_up == 2) {
    ...
    if (0 < this_ptr->box_count) {
      do {
        ...
        pCVar9->unk2[3] = '\0';
        iVar6 = iVar6 + 1;
        pCVar9 = (CBoneGuy *)((pCVar9->base).base.base.orient_matrix.m + 1);
  ...
  *(float *)((this_ptr->base).base.unk1 + 0x28) =
       (this_ptr->base).base.model.accumulated_root_motion.z;
  *(float *)((this_ptr->base).base.unk1 + 0x2c) = delta_time * fVar4 * fVar15 * fVar3;
  ...
  if (iVar8 == 0) {
      ...
      if (*(int *)((this_ptr->base).unk2 + 4) == 0) {
        ...
        if (iVar6 == 0) {
          ...
          if (iVar6 < 0) {
            ...
            fVar15 = (this_ptr->base).base.base.location.position.x - *(float *)(iVar6 + 0x20);
            fVar3 = (this_ptr->base).base.base.location.position.z - *(float *)(iVar6 + 0x28);
            if ((SQRT(fVar3 * fVar3 + fVar15 * fVar15) <= local_30 + (float)0.5) &&
    ...
    uVar10 = *(uint *)((this_ptr->base).base.unk2 + 0x10);
    if (uVar10 < 2) {
      if (uVar10 == 1) {
LAB_0041c3c9:
        iVar6 = 1;
...
LAB_0041c60c:
      ...
      if (uVar10 < 3) goto LAB_0041c3c9;
      if (uVar10 != 3) goto LAB_0041c60c;
  ...
  if (iVar6 != 0) {
    iVar6 = *(int *)((this_ptr->base).unk2 + 4);
    if ((iVar6 != 0) &&
       (pCVar9 = (CBoneGuy *)(**(code **)(*(int *)(iVar6 + 0x154) + 0x108))(), pCVar9 == this_ptr))
    {
    ...
    *(float *)((this_ptr->base).base.unk1 + 0x20) =
    ...
    local_64 = *(float *)((this_ptr->base).base.unk1 + 0x1c) * delta_time;
    ...
    local_78 = local_60 + *(float *)((this_ptr->base).base.unk1 + 0x14);
    local_74 = local_5c + *(float *)((this_ptr->base).base.unk1 + 0x18);
    local_dc = local_88.z + pCVar11->x;
                         ...
                         (double)(this_ptr->base).base.base.location.position.z,100.0), iVar6 != 0))
  {
    ...
    sound_sndmain_cpp_setNextSfxTriggerTime_FUN_005a8be0((double)local_14,(int)fVar15);
    uVar10 = (*((this_ptr->base).base.base.vtable._ub)->playAmbientSound)
                       ((CDemonActor *)this_ptr,"boneGuy-walkloop.wav");
    this_ptr->sfx_handle = uVar10;
