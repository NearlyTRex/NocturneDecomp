// Name: core_boneguy.cpp_CBoneGuy_serialize_FUN_0041d270
// Address: 0041d270
// Address Range: [[0041d270, 0041d4b2]]
// Convention: __cdecl
// Signature: void __cdecl core_boneguy_cpp_CBoneGuy_serialize_FUN_0041d270(CBoneGuy *this_ptr)
...

{
  ...
  if (1 < g_CBoneGuyClassVersion) {
    core_actor_cpp_serializeString_FUN_0040b5c0
              ((char **)(this_ptr->unk1 + 0x1c),"deathEvent");
    core_actor_cpp_serializeFloat_FUN_0040b770(&this_ptr->recombine_time,"recombineTime");
    core_actor_cpp_serializeInteger_FUN_0040b7f0(&this_ptr->blown_up,"blownUp");
    core_actor_cpp_serializeFloat_FUN_0040b770(&this_ptr->param,"param");
    core_actor_cpp_serializeInteger_FUN_0040b7f0(&this_ptr->box_count,"boxCount");
