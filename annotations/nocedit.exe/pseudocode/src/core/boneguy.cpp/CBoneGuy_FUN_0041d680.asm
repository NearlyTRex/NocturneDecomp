...
section .text
    ...
    PUSH EDX                            ; 0041d68b
    CALL core_charactr.cpp_CCharacter_FUN_0042d060 ; 0041d68c | void core_charactr.cpp_CCharacter_FUN_0042d060(CCharacter * this_ptr)
    ...
    CALL core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0 ; 0041d6b2 | CDeformableModel * core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0(CDeformableModelInstance * this_ptr)
    ...
    JG 0x0041d875                       ; 0041d6d1 | LAB_0041d875
    ...
    JLE 0x0041d853                      ; 0041d6e9 | LAB_0041d853
    ...
    CALL core_actor.cpp_getRandomFloat_FUN_0040cc10 ; 0041d72b | float core_actor.cpp_getRandomFloat_FUN_0040cc10(float min_value, float max_value)
        ;   XREF to: 0040cc10 (UNCONDITIONAL_CALL)
    PUSH 0x616342                       ; 0041d853 | = "boneguy-fallapart.wav" | s_boneguy_fallapart_wav_00616342 = boneguy-fallapart.wav
        ;   Label: LAB_0041d853
    ...
    POP EBX                             ; 0041d873
    RET                                 ; 0041d874
    MOV EBX,0x616304                    ; 0041d875 | = "..\\core\\boneguy.cpp" | s_core_boneguy_cpp_00616304 = ..\core\boneguy.cpp
        ;   Label: LAB_0041d875
    MOV ESI,0x443                       ; 0041d87a
    PUSH 0x616318                       ; 0041d87f | = "CBoneGuy::explode - Not enough contai..." | s_CBoneGuy_explode_Not_eno_00616318 = CBoneGuy::explode - Not enough containers
    MOV dword ptr [0x02f0ca48],EBX      ; 0041d884 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 0041d88a | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0041d890 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0041d895
    JMP 0x0041d6d7                      ; 0041d898 | LAB_0041d6d7
