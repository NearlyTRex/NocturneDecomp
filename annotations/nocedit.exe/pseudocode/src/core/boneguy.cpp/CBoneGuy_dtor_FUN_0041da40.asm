...
section .text
    ...
    PUSH EBX                            ; 0041da58
    CALL core_boneguy.cpp_FUN_0041db30  ; 0041da59
        ;   XREF to: 0041db30 (UNCONDITIONAL_CALL)  ; int core_boneguy.cpp_FUN_0041db30(SBoneGuyBox * * objs)
    ADD ESP,0x8                         ; 0041da5e
    PUSH 0x0                            ; 0041da61
    SUB EAX,0x8b70                      ; 0041da63
    PUSH EAX                            ; 0041da68
    CALL core_backgnd.cpp_freeFlames_FUN_00412720 ; 0041da69
    ...
    PUSH EAX                            ; 0041da78
    CALL core_backgnd.cpp_freeFires_FUN_00412700 ; 0041da79
    ...
    PUSH EAX                            ; 0041da88
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 0041da89
    ...
    PUSH EAX                            ; 0041da98
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 0041da99
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; int core_backgnd.cpp_cleanupVector_FUN_004126e0(CVector3f * * objs)
    ADD ESP,0x8                         ; 0041da9e
    PUSH 0x0                            ; 0041daa1
    SUB EAX,0x1c8                       ; 0041daa3
    PUSH EAX                            ; 0041daa8
    CALL core_cloth.cpp_FUN_0043bf80    ; 0041daa9
    ...
    PUSH 0x65b100                       ; 0041dae1 | g_CBoneGuyTypeInfo
        ;   Label: LAB_0041dae1
    PUSH EBX                            ; 0041dae6
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 0041dae7
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 0041daec
    PUSH EAX                            ; 0041daef
    CALL crt_memory.c_free_FUN_005fe659 ; 0041daf0
