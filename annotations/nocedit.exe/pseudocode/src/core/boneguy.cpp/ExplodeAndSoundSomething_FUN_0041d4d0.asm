...
section .text
    ...
    PUSH EDX                            ; 0041d4db
    CALL sound_sndmain.cpp_killSfx_FUN_005a9c40 ; 0041d4dc | int sound_sndmain.cpp_killSfx_FUN_005a9c40(uint sfx_handle)
    ...
    FNSTSW AX                           ; 0041d4fb
    SAHF                                ; 0041d4fd
    JC 0x0041d523                       ; 0041d4fe | LAB_0041d523
        ;   XREF to: 0041d523 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 0041d500
    MOV dword ptr [EBX + 0x243c],0x3f800000 ; 0041d501
    CALL core_boneguy.cpp_CBoneGuy_FUN_0041d680 ; 0041d50b | void core_boneguy.cpp_CBoneGuy_FUN_0041d680(CBoneGuy * this_ptr)
        ;   XREF to: 0041d680 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0041d510
    MOV ECX,dword ptr [ESP + 0xc]       ; 0041d513
    PUSH ECX                            ; 0041d517
    PUSH EBX                            ; 0041d518
    CALL core_enemy.cpp_FUN_004a9f10    ; 0041d519 | undefined core_enemy.cpp_FUN_004a9f10()
    ...
    PUSH EAX                            ; 0041d52d
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 0041d52e | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0041d533
    MOV ECX,dword ptr [ESP + 0xc]       ; 0041d536
    PUSH ECX                            ; 0041d53a
    PUSH EBX                            ; 0041d53b
    CALL core_enemy.cpp_FUN_004a9f10    ; 0041d53c | undefined core_enemy.cpp_FUN_004a9f10()
        ;   XREF to: 004a9f10 (UNCONDITIONAL_CALL)
