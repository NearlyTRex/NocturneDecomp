...
section .text
    ...
    PUSH EBX                            ; 0041ca40
        ;   Label: core_boneguy.cpp_CBoneGuy_getCarryObjToBodyXForm_FUN_0041ca40
    PUSH EDI                            ; 0041ca41
    PUSH EBP                            ; 0041ca42
    ...
    PUSH EAX                            ; 0041cab7
    CALL core_actor.cpp_CVector3f_ctor_FUN_00410340 ; 0041cab8
    ...
    CALL core_actor.cpp_CVector3f_ctor_FUN_00410340 ; 0041cae9
        ;   XREF to: 00410340 (UNCONDITIONAL_CALL)  ; CVector3f * core_actor.cpp_CVector3f_ctor_FUN_00410340(CVector3f * this_ptr)
    ...
    JMP 0x03fc48ab                      ; 0041cbc0
        ;   XREF to: 03fc48ab (UNCONDITIONAL_JUMP)  ; LAB_03fc48ab
    PUSH EAX                            ; 0041cbd2
        ;   Label: LAB_0041cbd2
    ...
    POP EBX                             ; 0041cc35
    RET                                 ; 0041cc36
    MOV ECX,0xc                         ; 03fc48ab
        ;   Label: LAB_03fc48ab
    PUSH EAX                            ; 03fc48b0
    LEA EAX,[EBP + 0x3e]                ; 03fc48b1
    LEA ESI,[EBP + -0x3a]               ; 03fc48b4
    PUSH EAX                            ; 03fc48b7
    LEA EAX,[EBP + 0x62]                ; 03fc48b8
    MOV ECX,dword ptr [ESI]             ; 03fc48bb
    MOV dword ptr [EDI],ECX             ; 03fc48bd
    MOV ECX,dword ptr [ESI + 0x4]       ; 03fc48bf
    MOV dword ptr [EDI + 0x4],ECX       ; 03fc48c2
    MOV ECX,dword ptr [ESI + 0x8]       ; 03fc48c5
    MOV dword ptr [EDI + 0x8],ECX       ; 03fc48c8
    MOV ECX,dword ptr [ESI + 0xc]       ; 03fc48cb
    MOV dword ptr [EDI + 0xc],ECX       ; 03fc48ce
    MOV ECX,dword ptr [ESI + 0x10]      ; 03fc48d1
    MOV dword ptr [EDI + 0x10],ECX      ; 03fc48d4
    MOV ECX,dword ptr [ESI + 0x14]      ; 03fc48d7
    MOV dword ptr [EDI + 0x14],ECX      ; 03fc48da
    MOV ECX,dword ptr [ESI + 0x18]      ; 03fc48dd
    MOV dword ptr [EDI + 0x18],ECX      ; 03fc48e0
    MOV ECX,dword ptr [ESI + 0x1c]      ; 03fc48e3
    MOV dword ptr [EDI + 0x1c],ECX      ; 03fc48e6
    MOV ECX,dword ptr [ESI + 0x20]      ; 03fc48e9
    MOV dword ptr [EDI + 0x20],ECX      ; 03fc48ec
    MOV ECX,dword ptr [ESI + 0x24]      ; 03fc48ef
    MOV dword ptr [EDI + 0x24],ECX      ; 03fc48f2
    MOV ECX,dword ptr [ESI + 0x28]      ; 03fc48f5
    MOV dword ptr [EDI + 0x28],ECX      ; 03fc48f8
    MOV ECX,dword ptr [ESI + 0x2c]      ; 03fc48fb
    MOV dword ptr [EDI + 0x2c],ECX      ; 03fc48fe
    ADD ESI,0x30                        ; 03fc4901
    ADD EDI,0x30                        ; 03fc4904
    XOR ECX,ECX                         ; 03fc4907
    JMP 0x0041cbd2                      ; 03fc4909
        ;   XREF to: 0041cbd2 (UNCONDITIONAL_JUMP)  ; LAB_0041cbd2
