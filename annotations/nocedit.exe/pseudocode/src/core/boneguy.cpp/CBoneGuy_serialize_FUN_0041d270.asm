...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_boneguy_cpp_CBoneGuy_serialize_FUN_0041d270(CBoneGuy *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0041d270
        ;   Label: core_boneguy.cpp_CBoneGuy_serialize_FUN_0041d270
    PUSH ESI                            ; 0041d271
    PUSH EDI                            ; 0041d272
    PUSH EBP                            ; 0041d273
    ...
    PUSH EDX                            ; 0041d27b
    CALL core_enemy.cpp_CEnemy_serialize_FUN_004a9660 ; 0041d27c
    ...
    PUSH EAX                            ; 0041d292
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 0041d293
    ...
    PUSH EAX                            ; 0041d2a9
    CALL core_actor.cpp_serializedDeformableModelInstance_FUN_0040b970 ; 0041d2aa
    ...
    PUSH EBX                            ; 0041d2d0
    CALL core_actor.cpp_serializeMotionState_FUN_0040b9f0 ; 0041d2d1
    ...
    PUSH EAX                            ; 0041d2f6
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 0041d2f7
    ...
    PUSH EAX                            ; 0041d30d
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 0041d30e
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH EAX                            ; 0041d324
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 0041d325
    ...
    PUSH EAX                            ; 0041d33b
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 0041d33c
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH EAX                            ; 0041d352
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 0041d353
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ADD ESP,0x8                         ; 0041d358
    PUSH 0x616298                       ; 0041d35b | = "partStatus"
    PUSH EBX                            ; 0041d360
    CALL core_actor.cpp_serializePartStatus_FUN_0040bae0 ; 0041d361
    ...
    PUSH EAX                            ; 0041d3ca
    CALL core_actor.cpp_serializeVector_FUN_0040b340 ; 0041d3cb
    ...
    PUSH EBP                            ; 0041d3d8
    CALL core_actor.cpp_serializeVector_FUN_0040b340 ; 0041d3d9
        ;   XREF to: 0040b340 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeVector_FUN_0040b340(CVector3f * vector_ptr, char * property_name)
    ADD ESP,0x8                         ; 0041d3de
    PUSH 0x6162bc                       ; 0041d3e1 | = "boxListDestOrient"
    PUSH EDI                            ; 0041d3e6
    CALL core_actor.cpp_serializeQuaternion_FUN_0040b520 ; 0041d3e7
    ...
    PUSH ECX                            ; 0041d3f8
    CALL core_actor.cpp_serializeQuaternion_FUN_0040b520 ; 0041d3f9
        ;   XREF to: 0040b520 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeQuaternion_FUN_0040b520(CQuaternion4f * quat_ptr, char * property_type)
    ADD ESP,0x8                         ; 0041d3fe
    PUSH 0x6162e1                       ; 0041d401 | = "sourcePos"
    PUSH ESI                            ; 0041d406
    CALL core_actor.cpp_serializeVector_FUN_0040b340 ; 0041d407
        ;   XREF to: 0040b340 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeVector_FUN_0040b340(CVector3f * vector_ptr, char * property_name)
    ...
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 0041d420
    ...
    PUSH EAX                            ; 0041d486
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 0041d487
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH EAX                            ; 0041d4a2
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 0041d4a3
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
