...

{
  ...
  pSVar1 = core_boneguy_cpp_freeBoneGuyBoxes_FUN_0041db30((SBoneGuyBox *)&this_ptr->box_list_pos);
  pCVar2 = core_armour_cpp_freeFlames_FUN_00412720((CFlame *)(pSVar1[-0x1f0].unk + 0x10));
