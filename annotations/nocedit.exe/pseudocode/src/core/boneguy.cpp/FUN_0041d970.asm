...
section .text
    ...
    JZ 0x0041d980                       ; 0041d97b | LAB_0041d980
    ...
    PUSH ECX                            ; 0041d984
    PUSH EAX                            ; 0041d985
    CALL core_charactr.cpp_CCharacter_FUN_0042bc20 ; 0041d986 | int core_charactr.cpp_CCharacter_FUN_0042bc20(CCharacter * this_ptr)
