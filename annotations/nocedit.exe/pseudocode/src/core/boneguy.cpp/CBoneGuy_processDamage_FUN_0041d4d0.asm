...
section .text
    ...
    PUSH EBX                            ; 0041d4d0
        ;   Label: core_boneguy.cpp_CBoneGuy_processDamage_FUN_0041d4d0
    ...
    PUSH ECX                            ; 0041d517
    PUSH EBX                            ; 0041d518
    CALL core_enemy.cpp_CEnemy_processDamage_FUN_004a9f10 ; 0041d519
    ...
    PUSH ECX                            ; 0041d53a
    PUSH EBX                            ; 0041d53b
    CALL core_enemy.cpp_CEnemy_processDamage_FUN_004a9f10 ; 0041d53c
        ;   XREF to: 004a9f10 (UNCONDITIONAL_CALL)  ; void core_enemy.cpp_CEnemy_processDamage_FUN_004a9f10(CEnemy * this_ptr, SDamageInfo * damage_info)
