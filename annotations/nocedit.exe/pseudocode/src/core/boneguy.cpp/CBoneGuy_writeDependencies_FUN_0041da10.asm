...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_boneguy_cpp_CBoneGuy_writeDependencies_FUN_0041da10(CBoneGuy *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0041da10
        ;   Label: core_boneguy.cpp_CBoneGuy_writeDependencies_FUN_0041da10
    MOV EDX,dword ptr [ESP + 0xc]       ; 0041da11
    PUSH EDX                            ; 0041da15
    MOV ECX,dword ptr [ESP + 0xc]       ; 0041da16
    PUSH ECX                            ; 0041da1a
    CALL core_actor.cpp_CDemonActor_writeDependencies_FUN_0040cfd0 ; 0041da1b
    ...
    PUSH EAX                            ; 0041da31
    CALL core_skeledit.cpp_CDeformableModelInstance_writeDependencies_FUN_0058a260 ; 0041da32
