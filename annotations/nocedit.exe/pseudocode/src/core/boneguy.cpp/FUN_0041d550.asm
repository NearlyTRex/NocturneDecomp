...
section .text
    ...
    JZ 0x0041d570                       ; 0041d565 | LAB_0041d570
    ...
    POP EBX                             ; 0041d56e
    RET                                 ; 0041d56f
    MOV ECX,dword ptr [0x00822944]      ; 0041d570 | undefined4 DAT_00822944
        ;   Label: LAB_0041d570
    PUSH ECX                            ; 0041d576
    ...
    PUSH EAX                            ; 0041d582
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00 ; 0041d583 | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
        ;   XREF to: 0059fb00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0041d588
    CMP EBX,EAX                         ; 0041d58b
    JZ 0x0041d59f                       ; 0041d58d | LAB_0041d59f
    ...
    PUSH EDI                            ; 0041d59f
        ;   Label: LAB_0041d59f
    MOV EDI,dword ptr [0x00822958]      ; 0041d5a0 | undefined4 DAT_00822958
    PUSH EDI                            ; 0041d5a6
    LEA EAX,[ESP + 0x2c]                ; 0041d5a7
    PUSH EAX                            ; 0041d5ab
    LEA EAX,[ESI + 0x158]               ; 0041d5ac
    PUSH EAX                            ; 0041d5b2
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00 ; 0041d5b3 | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
        ;   XREF to: 0059fb00 (UNCONDITIONAL_CALL)
    LEA EDX,[EBX + 0xc]                 ; 0041d5b8
    ADD ESP,0xc                         ; 0041d5bb
    CMP EDX,EAX                         ; 0041d5be
    JZ 0x0041d5d2                       ; 0041d5c0 | LAB_0041d5d2
    ...
    MOV EBP,dword ptr [0x0082295c]      ; 0041d5d2 | undefined4 DAT_0082295c
        ;   Label: LAB_0041d5d2
    PUSH EBP                            ; 0041d5d8
    ...
    PUSH EAX                            ; 0041d5e4
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00 ; 0041d5e5 | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
        ;   XREF to: 0059fb00 (UNCONDITIONAL_CALL)
    LEA EDX,[EBX + 0x18]                ; 0041d5ea
    ADD ESP,0xc                         ; 0041d5ed
    CMP EDX,EAX                         ; 0041d5f0
    JZ 0x0041d604                       ; 0041d5f2 | LAB_0041d604
    ...
    MOV EAX,[0x00822968]                ; 0041d604 | undefined4 DAT_00822968
        ;   Label: LAB_0041d604
    PUSH EAX                            ; 0041d609
    ...
    PUSH EAX                            ; 0041d615
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00 ; 0041d616 | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
        ;   XREF to: 0059fb00 (UNCONDITIONAL_CALL)
    LEA EDX,[EBX + 0x24]                ; 0041d61b
    ADD ESP,0xc                         ; 0041d61e
    CMP EDX,EAX                         ; 0041d621
    JZ 0x0041d635                       ; 0041d623 | LAB_0041d635
    ...
    MOV EDX,dword ptr [0x0082296c]      ; 0041d635 | undefined4 DAT_0082296c
        ;   Label: LAB_0041d635
    PUSH EDX                            ; 0041d63b
    ...
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00 ; 0041d64b | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
        ;   XREF to: 0059fb00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0041d650
    CMP EBX,EAX                         ; 0041d653
    JZ 0x0041d667                       ; 0041d655 | LAB_0041d667
