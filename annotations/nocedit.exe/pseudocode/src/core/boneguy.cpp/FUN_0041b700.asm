...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_boneguy.cpp_FUN_0041b700()
;
;
; Referenced Globals:
...
section .text
    ...
    FLD float ptr [0x00615f0d]          ; 0041b72b | float FLOAT_00615f0d
    FXCH                                ; 0041b731
    FMUL ST1                            ; 0041b733
    ...
    FADD double ptr [0x00615f15]        ; 0041b75e | double DOUBLE_00615f15
