...
int __cdecl
core_boneguy_cpp_CBoneGuy_getTargetPoints_FUN_0041d550
          (CBoneGuy *this_ptr,CVector3f *out_points_array)

{
  ...
  pCVar1 = core_skeleton_cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00
                     (&(this_ptr->base).base.model,&local_30,DAT_00822944);
  ...
  pCVar1 = core_skeleton_cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00
                     (&(this_ptr->base).base.model,&local_3c,DAT_00822968);
  ...
  pCVar1 = core_skeleton_cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00
                     (&(this_ptr->base).base.model,&local_48,DAT_0082296c);
