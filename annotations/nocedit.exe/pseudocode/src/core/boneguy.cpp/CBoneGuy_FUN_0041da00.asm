...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_boneguy_cpp_CBoneGuy_FUN_0041da00(CBoneGuy *this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x4]       ; 0041da00
        ;   Label: core_boneguy.cpp_CBoneGuy_FUN_0041da00
    PUSH EDX                            ; 0041da04
    CALL core_enemy.cpp_CEnemy_FUN_004aa250 ; 0041da05
