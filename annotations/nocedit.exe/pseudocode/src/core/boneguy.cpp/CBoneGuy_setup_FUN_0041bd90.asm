...
section .text
    ...
    PUSH EBX                            ; 0041bd90
        ;   Label: core_boneguy.cpp_CBoneGuy_setup_FUN_0041bd90
    PUSH ESI                            ; 0041bd91
    PUSH EDI                            ; 0041bd92
    ...
    PUSH EBX                            ; 0041bdc8
    MOV [0x00822944],EAX                ; 0041bdc9 | g_BoneGuyIndices
    ...
    PUSH EBX                            ; 0041bddd
    MOV [0x00822950],EAX                ; 0041bdde | g_BoneGuyIndices[3]
    ...
    PUSH EBX                            ; 0041bdf2
    MOV [0x00822954],EAX                ; 0041bdf3 | g_BoneGuyIndices[4]
    ...
    PUSH EBX                            ; 0041be07
    MOV [0x00822958],EAX                ; 0041be08 | g_BoneGuyIndices[5]
    ...
    PUSH EBX                            ; 0041be1c
    MOV [0x0082295c],EAX                ; 0041be1d | g_BoneGuyIndices[6]
    ...
    PUSH EBX                            ; 0041be31
    MOV [0x00822960],EAX                ; 0041be32 | g_BoneGuyIndices[7]
    ...
    PUSH EBX                            ; 0041be46
    MOV [0x00822964],EAX                ; 0041be47 | g_BoneGuyIndices[8]
    ...
    PUSH EBX                            ; 0041be5b
    MOV [0x00822948],EAX                ; 0041be5c | g_BoneGuyIndices[1]
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 0041be61
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 0041be66
    MOV [0x0082294c],EAX                ; 0041be69 | g_BoneGuyIndices[2]
    PUSH 0x1                            ; 0041be6e
    ...
    PUSH EBX                            ; 0041be85
    MOV [0x00822968],EAX                ; 0041be86 | g_BoneGuyIndices[9]
    ...
    PUSH EBX                            ; 0041be9a
    MOV [0x0082296c],EAX                ; 0041be9b | g_BoneGuyIndices[10]
    ...
    PUSH EBX                            ; 0041beaf
    MOV [0x00822944],EAX                ; 0041beb0 | g_BoneGuyIndices
    ...
    PUSH EBX                            ; 0041bec4
    MOV [0x00822958],EAX                ; 0041bec5 | g_BoneGuyIndices[5]
    ...
    PUSH EBX                            ; 0041bed9
    MOV [0x0082295c],EAX                ; 0041beda | g_BoneGuyIndices[6]
    ...
    PUSH EBX                            ; 0041beee
    MOV [0x00822968],EAX                ; 0041beef | g_BoneGuyIndices[9]
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 0041bef4
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 0041bef9
    PUSH EDI                            ; 0041befc
    MOV [0x0082296c],EAX                ; 0041befd | g_BoneGuyIndices[10]
    ...
    MOV EAX,[0x00822948]                ; 0041bf1b | g_BoneGuyIndices[1]
        ;   Label: LAB_0041bf1b
    MOV dword ptr [ESI + 0x24ac],EAX    ; 0041bf20
    MOV EAX,[0x0082294c]                ; 0041bf26 | g_BoneGuyIndices[2]
    PUSH ESI                            ; 0041bf2b
