...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_dmodel_cpp_CKeyFramedModel_export_FUN_00478e10(CKeyFramedModel *this_ptr,char *output_filename)
;
; Parameters:
...
section .text
    ...
    MOV AL,byte ptr [ESI]               ; 00478e1d
        ;   Label: LAB_00478e1d
    CMP AL,DL                           ; 00478e1f
    JZ 0x00478e35                       ; 00478e21
        ;   XREF to: 00478e35 (CONDITIONAL_JUMP)  ; LAB_00478e35
    CMP AL,0x0                          ; 00478e23
    JZ 0x00478e33                       ; 00478e25
        ;   XREF to: 00478e33 (CONDITIONAL_JUMP)  ; LAB_00478e33
    INC ESI                             ; 00478e27
    MOV AL,byte ptr [ESI]               ; 00478e28
    CMP AL,DL                           ; 00478e2a
    JZ 0x00478e35                       ; 00478e2c
        ;   XREF to: 00478e35 (CONDITIONAL_JUMP)  ; LAB_00478e35
    INC ESI                             ; 00478e2e
    CMP AL,0x0                          ; 00478e2f
    JNZ 0x00478e1d                      ; 00478e31
        ;   XREF to: 00478e1d (CONDITIONAL_JUMP)  ; LAB_00478e1d
    SUB ESI,ESI                         ; 00478e33
        ;   Label: LAB_00478e33
    TEST ESI,ESI                        ; 00478e35
        ;   Label: LAB_00478e35
    JNZ 0x00478e5f                      ; 00478e37
        ;   XREF to: 00478e5f (CONDITIONAL_JUMP)  ; LAB_00478e5f
    MOV DL,0x5c                         ; 00478e39
    MOV ESI,dword ptr [ESP + 0x28]      ; 00478e3b
    MOV AL,byte ptr [ESI]               ; 00478e3f
        ;   Label: LAB_00478e3f
    CMP AL,DL                           ; 00478e41
    JZ 0x00478e57                       ; 00478e43
        ;   XREF to: 00478e57 (CONDITIONAL_JUMP)  ; LAB_00478e57
    CMP AL,0x0                          ; 00478e45
    JZ 0x00478e55                       ; 00478e47
        ;   XREF to: 00478e55 (CONDITIONAL_JUMP)  ; LAB_00478e55
    INC ESI                             ; 00478e49
    MOV AL,byte ptr [ESI]               ; 00478e4a
    CMP AL,DL                           ; 00478e4c
    JZ 0x00478e57                       ; 00478e4e
        ;   XREF to: 00478e57 (CONDITIONAL_JUMP)  ; LAB_00478e57
    INC ESI                             ; 00478e50
    CMP AL,0x0                          ; 00478e51
    JNZ 0x00478e3f                      ; 00478e53
        ;   XREF to: 00478e3f (CONDITIONAL_JUMP)  ; LAB_00478e3f
    SUB ESI,ESI                         ; 00478e55
        ;   Label: LAB_00478e55
    TEST ESI,ESI                        ; 00478e57
        ;   Label: LAB_00478e57
    JZ 0x00479015                       ; 00478e59
        ;   XREF to: 00479015 (CONDITIONAL_JUMP)  ; LAB_00479015
    PUSH 0x569                          ; 00478e5f
        ;   Label: LAB_00478e5f
    PUSH 0x61f9f9                       ; 00478e64 | = "..\\core\\dmodel.cpp"
    PUSH 0x61fa0c                       ; 00478e69 | = "wt"
    PUSH 0x0                            ; 00478e6e
    MOV ECX,dword ptr [ESP + 0x38]      ; 00478e70
    PUSH ECX                            ; 00478e74
    CALL shape_memdbg.cpp_openFile_FUN_0050f7a0 ; 00478e75
    ...
    TEST EDI,EDI                        ; 00478e7f
        ;   Label: LAB_00478e7f
    JNZ 0x00478eab                      ; 00478e81
        ;   XREF to: 00478eab (CONDITIONAL_JUMP)  ; LAB_00478eab
    MOV EBP,dword ptr [ESP + 0x28]      ; 00478e83
    PUSH EBP                            ; 00478e87
    MOV EBX,0x61fa19                    ; 00478e88 | = "..\\core\\dmodel.cpp"
    MOV ESI,0x56d                       ; 00478e8d
    PUSH 0x61fa2c                       ; 00478e92 | = "Can't create demon model %s"
    MOV dword ptr [0x02f0ca48],EBX      ; 00478e97 | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 00478e9d | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00478ea3
    ...
    JNZ 0x00479033                      ; 00478eb9
        ;   XREF to: 00479033 (CONDITIONAL_JUMP)  ; LAB_00479033
    PUSH 0x61fa48                       ; 00478ebf | = "// .KFM version\n"
        ;   Label: LAB_00478ebf
    PUSH EDI                            ; 00478ec4
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00478ec5
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ADD ESP,0x8                         ; 00478eca
    PUSH 0x8                            ; 00478ecd
    PUSH 0x61fa59                       ; 00478ecf | = "%d\n"
    PUSH EDI                            ; 00478ed4
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00478ed5
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ADD ESP,0xc                         ; 00478eda
    PUSH 0x61fa5d                       ; 00478edd | = "// vertexCount,polyCount,textureCount..."
    PUSH EDI                            ; 00478ee2
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00478ee3
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    PUSH EDI                            ; 00478f17
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00478f18
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ADD ESP,0x1c                        ; 00478f1d
    PUSH 0x61faa9                       ; 00478f20 | = "// useCollisionListFlag\n"
    PUSH EDI                            ; 00478f25
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00478f26
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ADD ESP,0x8                         ; 00478f2b
    PUSH EBX                            ; 00478f2e
    PUSH 0x61fac2                       ; 00478f2f | = "%d\n"
    PUSH EDI                            ; 00478f34
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00478f35
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ADD ESP,0xc                         ; 00478f3a
    PUSH 0x61fac6                       ; 00478f3d | = "// transparentPixelFlag\n"
    PUSH EDI                            ; 00478f42
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00478f43
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    PUSH EDI                            ; 00478f5b
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00478f5c
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ADD ESP,0xc                         ; 00478f61
    PUSH 0x61fae3                       ; 00478f64 | = "// disableBackfaceCulling\n"
    PUSH EDI                            ; 00478f69
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00478f6a
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    PUSH EDI                            ; 00478f82
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00478f83
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00478fa9
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ADD ESP,0x8                         ; 00478fae
    PUSH EBX                            ; 00478fb1
    PUSH 0x61fb15                       ; 00478fb2 | = "%d\n"
    PUSH EDI                            ; 00478fb7
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00478fb8
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00478fca
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    JGE 0x0047903d                      ; 00478feb
        ;   XREF to: 0047903d (CONDITIONAL_JUMP)  ; LAB_0047903d
    ...
    INC ESI                             ; 0047900a
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0047900b
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ADD ESP,0x14                        ; 00479010
    JMP 0x00478fd2                      ; 00479013
        ;   XREF to: 00478fd2 (UNCONDITIONAL_JUMP)  ; LAB_00478fd2
    PUSH 0x61fa0f                       ; 00479015 | = "wt"
        ;   Label: LAB_00479015
    MOV EDX,dword ptr [ESP + 0x2c]      ; 0047901a
    PUSH EDX                            ; 0047901e
    PUSH 0x61fa12                       ; 0047901f | = "models"
    CALL engine_dosio.c_getFile_FUN_00481a50 ; 00479024
        ;   XREF to: 00481a50 (UNCONDITIONAL_CALL)  ; FILE * engine_dosio.c_getFile_FUN_00481a50(char * directory, char * filename, char * mode)
    MOV EDI,EAX                         ; 00479029
    ADD ESP,0xc                         ; 0047902b
    JMP 0x00478e7f                      ; 0047902e
        ;   XREF to: 00478e7f (UNCONDITIONAL_JUMP)  ; LAB_00478e7f
    MOV EBX,0x1                         ; 00479033
        ;   Label: LAB_00479033
    JMP 0x00478ebf                      ; 00479038
        ;   XREF to: 00478ebf (UNCONDITIONAL_JUMP)  ; LAB_00478ebf
    PUSH 0x61fb3a                       ; 0047903d | = "// poly list: textureIndex, n, verts(..."
        ;   Label: LAB_0047903d
    PUSH EDI                            ; 00479042
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00479043
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    JLE 0x0047910f                      ; 0047905d
        ;   XREF to: 0047910f (CONDITIONAL_JUMP)  ; LAB_0047910f
    ...
    PUSH ESI                            ; 00479091
    PUSH 0x61fb6f                       ; 00479092 | = "%d,%d"
    PUSH EDI                            ; 00479097
    XOR ESI,ESI                         ; 00479098
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0047909a
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    MOV EAX,dword ptr [EBP + 0x4]       ; 0047909f
    ADD ESP,0x10                        ; 004790a2
    TEST EAX,EAX                        ; 004790a5
    JLE 0x004790d0                      ; 004790a7
        ;   XREF to: 004790d0 (CONDITIONAL_JUMP)  ; LAB_004790d0
    ...
    PUSH ECX                            ; 004790b6
    PUSH 0x61fb75                       ; 004790b7 | = ", %d,%d,%d"
    PUSH EDI                            ; 004790bc
    ADD EBX,0xc                         ; 004790bd
    INC ESI                             ; 004790c0
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 004790c1
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    MOV EAX,dword ptr [EBP + 0x4]       ; 004790c6
    ADD ESP,0x14                        ; 004790c9
    CMP ESI,EAX                         ; 004790cc
    JL 0x004790ab                       ; 004790ce
        ;   XREF to: 004790ab (CONDITIONAL_JUMP)  ; LAB_004790ab
    PUSH 0x61fb80                       ; 004790d0 | = "\n"
        ;   Label: LAB_004790d0
    PUSH EDI                            ; 004790d5
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 004790d6
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    JL 0x0047906b                       ; 00479109
        ;   XREF to: 0047906b (CONDITIONAL_JUMP)  ; LAB_0047906b
    CMP dword ptr [ESP],0x0             ; 0047910f
        ;   Label: LAB_0047910f
    JZ 0x00479170                       ; 00479113
        ;   XREF to: 00479170 (CONDITIONAL_JUMP)  ; LAB_00479170
    PUSH 0x61fb82                       ; 00479115 | = "// envMapOpacity list\n"
    PUSH EDI                            ; 0047911a
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0047911b
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    PUSH EDI                            ; 0047914c
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0047914d
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ADD ESP,0xc                         ; 00479152
    MOV EAX,dword ptr [ESP + 0x24]      ; 00479155
    INC ESI                             ; 00479159
    CMP ESI,dword ptr [EAX + 0x110]     ; 0047915a
    JL 0x00479133                       ; 00479160
        ;   XREF to: 00479133 (CONDITIONAL_JUMP)  ; LAB_00479133
    ...
    PUSH 0x61fb9d                       ; 00479170 | = "// texture list\n"
        ;   Label: LAB_00479170
    PUSH EDI                            ; 00479175
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00479176
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    JLE 0x004791c0                      ; 0047918c
        ;   XREF to: 004791c0 (CONDITIONAL_JUMP)  ; LAB_004791c0
    LEA ESI,[EAX + 0x12c]               ; 0047918e
    PUSH ESI                            ; 00479194
        ;   Label: LAB_00479194
    PUSH 0x61fbae                       ; 00479195 | = "%s\n"
    PUSH EDI                            ; 0047919a
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0047919b
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    JL 0x00479194                       ; 004791b3
        ;   XREF to: 00479194 (CONDITIONAL_JUMP)  ; LAB_00479194
    ...
    PUSH 0x61fbb2                       ; 004791c0 | = "// part list (vertexCount, polyCount)\n"
        ;   Label: LAB_004791c0
    PUSH EDI                            ; 004791c5
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 004791c6
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    JLE 0x00479210                      ; 004791dc
        ;   XREF to: 00479210 (CONDITIONAL_JUMP)  ; LAB_00479210
    ...
    PUSH EDI                            ; 004791f3
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 004791f4
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    JL 0x004791e0                       ; 0047920c
        ;   XREF to: 004791e0 (CONDITIONAL_JUMP)  ; LAB_004791e0
    MOV EAX,EAX                         ; 0047920e
    TEST byte ptr [EDI + 0xc],0x20      ; 00479210
        ;   Label: LAB_00479210
    JNZ 0x00479231                      ; 00479214
        ;   XREF to: 00479231 (CONDITIONAL_JUMP)  ; LAB_00479231
    PUSH 0x5e5                          ; 00479216
        ;   Label: LAB_00479216
    PUSH 0x61fc0d                       ; 0047921b | = "..\\core\\dmodel.cpp"
    PUSH EDI                            ; 00479220
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 00479221
    ...
    MOV EBX,dword ptr [ESP + 0x28]      ; 00479231
        ;   Label: LAB_00479231
    PUSH EBX                            ; 00479235
    MOV EDX,0x61fbe0                    ; 00479236 | = "..\\core\\dmodel.cpp"
    MOV ECX,0x5e1                       ; 0047923b
    PUSH 0x61fbf3                       ; 00479240 | = "Error writing model to %s"
    MOV dword ptr [0x02f0ca48],EDX      ; 00479245 | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 0047924b | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00479251
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ADD ESP,0x8                         ; 00479256
    JMP 0x00479216                      ; 00479259
        ;   XREF to: 00479216 (UNCONDITIONAL_JUMP)  ; LAB_00479216
