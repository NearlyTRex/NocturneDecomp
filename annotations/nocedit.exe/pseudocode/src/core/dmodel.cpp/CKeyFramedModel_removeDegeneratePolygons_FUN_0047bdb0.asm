...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dmodel.cpp_CKeyFramedModel_removeDegeneratePolygons_FUN_0047bdb0(CKeyFramedModel * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 0047bdbb
    CALL core_dmodel.cpp_CKeyFramedModel_validatePartList_FUN_0047bf40 ; 0047bdbc | void core_dmodel.cpp_CKeyFramedModel_validatePartList_FUN_0047bf40(CKeyFramedModel * this_ptr)
    ...
    JLE 0x0047bef8                      ; 0047bdd9 | LAB_0047bef8
    ...
    JLE 0x0047bed4                      ; 0047be1f | LAB_0047bed4
    ...
    JLE 0x0047be80                      ; 0047be3e | LAB_0047be80
    ...
    JGE 0x0047be6d                      ; 0047be4a | LAB_0047be6d
    ...
    JNZ 0x0047be62                      ; 0047be5b | LAB_0047be62
    ...
    JL 0x0047be55                       ; 0047be6b | LAB_0047be55
    ...
    JL 0x0047be44                       ; 0047be7e | LAB_0047be44
        ;   XREF to: 0047be44 (CONDITIONAL_JUMP)
    TEST EDI,EDI                        ; 0047be80
        ;   Label: LAB_0047be80
    JZ 0x0047bf0d                       ; 0047be82 | LAB_0047bf0d
    ...
    PUSH EAX                            ; 0047bebc
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 0047bebd | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
        ;   XREF to: 005fe5e0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0047bec2
    MOV EAX,dword ptr [ESP + 0x10]      ; 0047bec5
    DEC dword ptr [EAX + 0x558c]        ; 0047bec9
    JMP 0x0047be09                      ; 0047becf | LAB_0047be09
    ...
    JL 0x0047bde3                       ; 0047bef2 | LAB_0047bde3
        ;   XREF to: 0047bde3 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [ESP + 0x38]      ; 0047bef8
        ;   Label: LAB_0047bef8
    PUSH EBX                            ; 0047befc
    CALL core_dmodel.cpp_CKeyFramedModel_validatePartList_FUN_0047bf40 ; 0047befd | void core_dmodel.cpp_CKeyFramedModel_validatePartList_FUN_0047bf40(CKeyFramedModel * this_ptr)
        ;   XREF to: 0047bf40 (UNCONDITIONAL_CALL)
    ...
    JMP 0x0047be09                      ; 0047bf2c | LAB_0047be09
        ;   XREF to: 0047be09 (UNCONDITIONAL_JUMP)
