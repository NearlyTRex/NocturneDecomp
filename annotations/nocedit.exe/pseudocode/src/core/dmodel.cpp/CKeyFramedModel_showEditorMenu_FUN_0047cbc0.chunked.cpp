...
typedef struct CKeyFramedModel_showEditorMenu_Ctx {
    ...
    char cVar2;
    int *piVar1;
} CKeyFramedModel_showEditorMenu_Ctx;
...
static int CKeyFramedModel_showEditorMenu_check_bVar2_0(CKeyFramedModel_showEditorMenu_Ctx *ctx) {
    ...
    bool &bVar9 = ctx->bVar9;
    CVector3f *&pCVar8 = ctx->pCVar8;
    int &iVar12 = ctx->iVar12;
    int &iVar18 = ctx->iVar18;
    int &iVar11 = ctx->iVar11;
    int &x = ctx->x;
    auto &local_408 = ctx->local_408;
    auto &local_2dc = ctx->local_2dc;
    CMatrix3x3f &local_1e4 = ctx->local_1e4;
    CVector3f &local_114 = ctx->local_114;
    CVector3f &local_d8 = ctx->local_d8;
    CVector3f &local_b4 = ctx->local_b4;
    CVector3f &local_90 = ctx->local_90;
...
static int CKeyFramedModel_showEditorMenu_check_bVar8_2(CKeyFramedModel_showEditorMenu_Ctx *ctx) {
    ...
    int &iVar12 = ctx->iVar12;
    int &iVar13 = ctx->iVar13;
    int &iVar14 = ctx->iVar14;
    int &iVar15 = ctx->iVar15;
    int &iVar16 = ctx->iVar16;
    int &iVar18 = ctx->iVar18;
    int &x = ctx->x;
    float &local_18c = ctx->local_18c;
    float &local_188 = ctx->local_188;
    float &local_184 = ctx->local_184;
    CVector3i *&pCVar4 = ctx->pCVar4;
...
static int CKeyFramedModel_showEditorMenu_check_bVar10_4_check_local_84_0_check_local_84_0(CKeyFramedModel_showEditorMenu_Ctx *ctx) {
    ...
    bool &bVar2 = ctx->bVar2;
    int &iVar12 = ctx->iVar12;
    int &iVar18 = ctx->iVar18;
    char *&pcVar10 = ctx->pcVar10;
    char *&pcVar12 = ctx->pcVar12;
    char *&pcVar19 = ctx->pcVar19;
    CKeyFramedModel *&pCVar13 = ctx->pCVar13;
    char *&pcVar20 = ctx->pcVar20;
    byte &bVar15 = ctx->bVar15;
    int &local_ca8 = ctx->local_ca8;
    auto &local_b98 = ctx->local_b98;
    auto &local_998 = ctx->local_998;
    auto &local_698 = ctx->local_698;
    auto &local_408 = ctx->local_408;
    uint &local_84 = ctx->local_84;
    auto &local_18 = ctx->local_18;
...
static int CKeyFramedModel_showEditorMenu_check_bVar10_4_check_local_84_0_check_local_84_1(CKeyFramedModel_showEditorMenu_Ctx *ctx) {
    ...
    int &iVar18 = ctx->iVar18;
    char *&pcVar19 = ctx->pcVar19;
    auto &local_a98 = ctx->local_a98;
    auto &local_898 = ctx->local_898;
    auto &local_798 = ctx->local_798;
...
static int CKeyFramedModel_showEditorMenu_check_bVar10_4_check_local_84_1(CKeyFramedModel_showEditorMenu_Ctx *ctx) {
    ...
    float &fVar3 = ctx->fVar3;
    int &iVar12 = ctx->iVar12;
    CVector3f *&pCVar17 = ctx->pCVar17;
    int &iVar18 = ctx->iVar18;
    int &x = ctx->x;
    auto &local_340 = ctx->local_340;
    CMatrix3x4f &local_214 = ctx->local_214;
    CVector3f &local_15c = ctx->local_15c;
    CVector3f &local_108 = ctx->local_108;
    CVector3f &local_fc = ctx->local_fc;
    CCourse &local_f0 = ctx->local_f0;
    CVector3f &local_9c = ctx->local_9c;
    uint &local_84 = ctx->local_84;
    float &local_70 = ctx->local_70;
...
{
  CKeyFramedModel_showEditorMenu_Ctx _ctx_storage = {};
  CKeyFramedModel_showEditorMenu_Ctx *ctx = &_ctx_storage;
  ctx->this_ptr = this_ptr;
    ...
    float &local_190 = ctx->local_190;
    float &local_18c = ctx->local_18c;
    float &local_188 = ctx->local_188;
    float &local_184 = ctx->local_184;
    float &local_180 = ctx->local_180;
    ...
    float &local_164 = ctx->local_164;
    float &local_160 = ctx->local_160;
    CVector3f &local_15c = ctx->local_15c;
    float &local_150 = ctx->local_150;
    float &local_14c = ctx->local_14c;
    float &local_148 = ctx->local_148;
    float &local_144 = ctx->local_144;
    float &local_140 = ctx->local_140;
    float &local_13c = ctx->local_13c;
    CVector3f &local_138 = ctx->local_138;
    CVector3f &local_12c = ctx->local_12c;
    float &local_120 = ctx->local_120;
    float &local_11c = ctx->local_11c;
    float &local_118 = ctx->local_118;
    CVector3f &local_114 = ctx->local_114;
    CVector3f &local_108 = ctx->local_108;
    CVector3f &local_fc = ctx->local_fc;
    CCourse &local_f0 = ctx->local_f0;
    ...
    float &local_74 = ctx->local_74;
    float &local_70 = ctx->local_70;
    uint &local_6c = ctx->local_6c;
    uint &local_68 = ctx->local_68;
    uint &local_64 = ctx->local_64;
    uint &local_60 = ctx->local_60;
    ...
    auto &local_18 = ctx->local_18;
    auto &local_14 = ctx->local_14;
    uint &uVar7 = ctx->uVar7;
    CDemonSet *&pCVar6 = ctx->pCVar6;
    float &fVar5 = ctx->fVar5;
    CVector3i *&pCVar4 = ctx->pCVar4;
    CKeyFramedModel *&pCVar14 = ctx->pCVar14;
    SRenderVertex *&pSVar3 = ctx->pSVar3;
    char &cVar2 = ctx->cVar2;
    int *&piVar1 = ctx->piVar1;
  ...
  do {
    ...
    if (this_ptr->frame_count < 1) {
      ...
      CKeyFramedModel_showEditorMenu_check_bVar2_0(ctx);
    }
    else {
      engine_2d_c_drawText_FUN_00401fd0("(Model not crammed)",iVar9,g_WindowHeight / 2);
    }
    if (!bVar9) {
      CKeyFramedModel_showEditorMenu_chunk_1(ctx);
    }
    ...
    if (bVar8) {
      CKeyFramedModel_showEditorMenu_check_bVar8_2(ctx);
    }
    else {
      CKeyFramedModel_showEditorMenu_else_3(ctx);
    }
    ...
    if (bVar10) {
      ...
      if (iVar18 != 0) {
        ...
        if (local_84 < 0x42) {
        if (local_84 < 0x35) {
          CKeyFramedModel_showEditorMenu_check_bVar10_4_check_local_84_0_check_local_84_0(ctx);
        }
        else if (local_84 < 0x36) {
          int _rc = CKeyFramedModel_showEditorMenu_check_bVar10_4_check_local_84_0_check_local_84_1(ctx);
          if (_rc == GOTO_LAB_0047d6c7) goto LAB_0047d6c7;
        }
        else if (local_84 < 0x37) {
          int _rc = CKeyFramedModel_showEditorMenu_check_bVar10_4_check_local_84_0_check_local_84_2(ctx);
          if (_rc == GOTO_LAB_0047dc33) goto LAB_0047dc33;
        }
        else if (local_84 < 0x38) {
          CKeyFramedModel_showEditorMenu_check_bVar10_4_check_local_84_0_check_local_84_3(ctx);
        }
          ...
          CKeyFramedModel_showEditorMenu_check_bVar10_4_check_local_84_1(ctx);
        }
          ...
          CKeyFramedModel_showEditorMenu_check_bVar10_4_check_local_84_2(ctx);
        }
