...
;                               FUNCTION
; *****************************************************************************
; __cdecl CVector3i * __cdecl core_dmodel_cpp_CKeyFramedModel_getFrameVertices_FUN_00477890(CKeyFramedModel *this_ptr,int frame_index)
;
; Parameters:
...
;   core_morph.cpp_CMorphModel_FUN_0052aa80 at 0052aa95
