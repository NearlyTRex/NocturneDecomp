...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_dmodel_cpp_CKeyFramedModel_recenter_FUN_0047c220(CKeyFramedModel *this_ptr,int frame_index)
;
; Parameters:
...
section .text
    ...
    FXCH                                ; 0047c25e
    FLD float ptr [0x00620557]          ; 0047c260 | FLOAT_00620557
    FXCH                                ; 0047c266
    FMUL ST1                            ; 0047c268
    FXCH ST2                            ; 0047c26a
    ...
    CALL core_dmodel.cpp_CKeyFramedModel_applyBias_FUN_0047c370 ; 0047c2b5
