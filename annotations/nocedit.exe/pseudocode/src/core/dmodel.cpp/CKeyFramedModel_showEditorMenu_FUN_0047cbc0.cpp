...

{
  ...
  do {
    ...
    (pCVar4->light_direction).x = -0x4844;
    (pCVar4->light_direction).y = -0x4844;
    (pCVar4->light_direction).z = 0x4844;
    pCVar4->ambient_base_quick = 32000;
    wincore_windll_cpp_clearZBuffer_FUN_005b3ed4();
    iVar7 = g_WindowWidth / 2 + -0x28;
    if (this_ptr->frame_count < 1) {
      engine_2d_c_drawText_FUN_00401fd0("(No model)",iVar7,g_WindowHeight / 2);
    }
    else if (local_64 == 0) {
      engine_2d_c_drawText_FUN_00401fd0("(Model not crammed)",iVar7,g_WindowHeight / 2);
    }
    else {
      ...
      core_dmodel_cpp_CKeyFramedModel_prepareForRender_FUN_00477850(this_ptr,local_1c,0,iVar7);
      uVar5 = local_68;
      engine_drender_cpp_CDemonRenderer_matrixPop_FUN_0050d720();
      if ((uVar5 != 0) && (iVar7 = 0, 0 < this_ptr->vertex_count)) {
        iVar9 = 0;
        do {
          pSVar2 = g_CDemonRendererPtr2->vertex_buffer_ptr;
          if ((*(byte *)((int)&(pSVar2->projected_vertex).screen_x + iVar9 + 3) & 0x80) == 0) {
            local_4c = *(int *)((int)&(pSVar2->projected_vertex).screen_y + iVar9) >> 0x10;
            x_pos = *(int *)((int)&(pSVar2->projected_vertex).screen_x + iVar9) >> 0x10;
            if (-1 < x_pos) {
              crt_stdio_c_sprintf_FUN_005fdbd0(local_2dc,"%d",iVar7,uVar17);
      ...
      if (local_60 == 0) {
        ...
        crt_stdio_c_sprintf_FUN_005fdbd0
                  (local_408,"Frame: %d of %d",local_1c,extraout_EAX,uVar17);
    ...
    if (local_60 == 0) {
      ...
      crt_stdio_c_sprintf_FUN_005fdbd0(local_408,"I.  Interactive bias is now %s",pcVar12);
      ...
      crt_stdio_c_sprintf_FUN_005fdbd0(local_408,"E.  Exact collision (currently %s)",pcVar12);
      ...
      crt_stdio_c_sprintf_FUN_005fdbd0(local_408,"T.  Transparent pixel (currently %s)",pcVar12);
    ...
    if (local_6c == 0) {
      ...
      iVar7 = (*g_CKeysPtr->vtable->getKeyState)(g_CKeysPtr,0x4c);
      if (iVar7 != 0) {
        local_78 = 0.0;
        local_50 = 0;
        local_74 = 0.0;
      ...
      if ((local_cc != 0 || local_c8 != 0) || local_c4 != 0) {
        iVar7 = 0;
        for (iVar9 = 0; iVar9 < this_ptr->vertex_count * this_ptr->frame_count; iVar9 = iVar9 + 1) {
          ppCVar3 = this_ptr->vertex_list;
          *(int *)(iVar7 + (int)ppCVar3) = *(int *)(iVar7 + (int)ppCVar3) + local_cc;
          *(int *)(iVar7 + 4 + (int)ppCVar3) = *(int *)(iVar7 + 4 + (int)ppCVar3) + local_c8;
          *(int *)(iVar7 + 8 + (int)ppCVar3) = *(int *)(iVar7 + 8 + (int)ppCVar3) + local_c4;
          iVar7 = iVar7 + 0xc;
        }
    ...
    iVar7 = (*g_CKeysPtr->vtable->getAndClearKeyState)(g_CKeysPtr,0x4c);
    if (iVar7 != 0) {
      local_d8.y = 0.0;
      local_d8.x = 0.0;
      local_7c = 15.0;
        ...
        if (local_84 < 0x42) {
          if (local_84 < 0x35) {
            if (local_84 < 0x32) {
              if ((local_84 == 0x31) &&
                 (iVar7 = shape_edittool_cpp_CEditorTools_showFileSelectionDialog_FUN_0049f270
                                    (g_CEditorToolsPtr,"Load Keyframed model",
                                     "models","*.kfm",(int)local_408), iVar7 != 0))
              {
                ...
                shape_edittool_cpp_CEditorTools_showError_FUN_0049e740
                      ...
                      (iVar7 = shape_edittool_cpp_CEditorTools_showFilenameInputDialog_FUN_0049fb70
                                         (g_CEditorToolsPtr,"Save Keyframed model",
                                          "models",0x620967,(int)this_ptr), iVar7 != 0)) {
              ...
              iVar7 = shape_edittool_cpp_CEditorTools_showDirectoryBrowser_FUN_0049f420
              ...
              if (iVar7 != 0) {
                ...
                do {
                  ...
                  if (iVar7 == 0) break;
                  iVar7 = iVar7 + -1;
                  pCVar13 = (CKeyFramedModel *)((int)pCVar8 + (uint)bVar14 * -2 + 1);
                  pcVar10 = pCVar8->model_filename;
                  pCVar8 = pCVar13;
                } while (*pcVar10 != '\0');
                pcVar10 = (char *)((int)&pCVar13[-1].padding + 3);
                do {
                  cVar1 = *pcVar12;
                  *pcVar10 = cVar1;
                  if (cVar1 == '\0') break;
              ...
              if (iVar7 != 0) {
                ...
                iVar7 = engine_dosio_c_findFile_FUN_00481760((SFoundFileInfo *)&stack0xfffff150);
                if ((iVar7 == 0) || (local_ca8 == 0)) {
                  iVar7 = core_dmodel_cpp_copyFile_FUN_0047c930("t:\\",&stack0xfffff150,1);
                  if (iVar7 != 0) {
                    crt_file_c_makepath_FUN_005febfc
                    ...
                    if (0 < this_ptr->texture_count) {
                      pCVar8 = (CKeyFramedModel *)(local_44->base).texture_name;
                      do {
                        iVar9 = core_dmodel_cpp_CKeyFramedModel_copyTextureFiles_FUN_0047ca50
                                          (pCVar8,local_18,local_998,(char *)0x0,"art");
                        if (iVar9 == 0) {
                          core_dmodel_cpp_CKeyFramedModel_free_FUN_00477690(this_ptr);
                          break;
                        }
                        iVar7 = iVar7 + 1;
                        pCVar8 = (CKeyFramedModel *)(pCVar8->model_filename + 0x48);
            ...
            if (this_ptr->frame_count < 1) {
              ...
              do {
                ...
                iVar7 = 0;
                if (0 < this_ptr->texture_count) {
                  pCVar8 = (CKeyFramedModel *)(local_40->base).texture_name;
                  do {
                    iVar9 = core_dmodel_cpp_CKeyFramedModel_copyTextureFiles_FUN_0047ca50
                                      (pCVar8,(char *)0x0,"art",local_14,local_a98);
                    if (iVar9 == 0) break;
                    iVar7 = iVar7 + 1;
                    pCVar8 = (CKeyFramedModel *)(pCVar8->model_filename + 0x48);
                  } while (iVar7 < this_ptr->texture_count);
          ...
          if (this_ptr->frame_count < 1) {
            ...
            dVar16 = crt_math_c_round_FUN_005fe6b0((double)local_70);
            local_1c = (CKeyFramedModelInstance *)(int)ROUND(dVar16);
            pCVar6 = this_ptr->frame_bounds + (int)local_1c * 2;
            local_1a4 = pCVar6->x;
            local_1a0 = pCVar6->y;
            local_19c = pCVar6->z;
            local_198 = pCVar6[1].x;
            local_194 = pCVar6[1].y;
            local_190 = pCVar6[1].z;
            local_30[1] = 0.5;
            ...
            fVar15 = (float10)local_a0 * (float10)0.5;
            dVar16 = crt_math_c_round_FUN_005fe6b0((double)local_70);
            local_13c = (float)fVar15;
            local_1c = (CKeyFramedModelInstance *)(int)ROUND(dVar16);
          ...
          if (local_84 < 0x44) {
            ...
            if (iVar7 != 0) {
              ...
              iVar7 = 0;
              for (iVar9 = 0; iVar9 < this_ptr->vertex_count; iVar9 = iVar9 + 1) {
                local_108.z = (float)0.00390625;
                local_108.x = (float)*(int *)(iVar7 + (int)this_ptr->vertex_list) * local_108.z;
                local_108.y = (float)*(int *)(iVar7 + 4 + (int)this_ptr->vertex_list) * local_108.z;
                local_108.z = (float)*(int *)(iVar7 + 8 + (int)this_ptr->vertex_list) * local_108.z;
                pCVar6 = core_xform_cpp_transformVector3x4_FUN_005f4dc0
                                   (&local_15c,&local_108,&local_214);
                if (&local_108 != pCVar6) {
                  local_108.x = pCVar6->x;
                  local_108.y = pCVar6->y;
                  local_108.z = pCVar6->z;
                }
                fVar15 = (float10)256;
                ppCVar3 = this_ptr->vertex_list;
                dVar16 = crt_math_c_round_FUN_005fe6b0((double)((float10)local_108.x * fVar15));
                local_1c = (CKeyFramedModelInstance *)(int)ROUND(dVar16);
                *(CKeyFramedModelInstance **)(iVar7 + (int)ppCVar3) = local_1c;
                dVar16 = crt_math_c_round_FUN_005fe6b0((double)((float10)local_108.y * fVar15));
                local_1c = (CKeyFramedModelInstance *)(int)ROUND(dVar16);
                *(CKeyFramedModelInstance **)(extraout_EAX_00 + iVar7 + 4) = local_1c;
                ppCVar3 = this_ptr->vertex_list;
                dVar16 = crt_math_c_round_FUN_005fe6b0((double)(fVar15 * (float10)local_108.z));
                local_1c = (CKeyFramedModelInstance *)(int)ROUND(dVar16);
                *(CKeyFramedModelInstance **)(iVar7 + 8 + (int)ppCVar3) = local_1c;
                iVar7 = iVar7 + 0xc;
              }
          ...
          if (0x51 < local_84) {
            if (local_84 < 0x53) {
              ...
              pCVar6 = this_ptr->frame_bounds + local_20 * 2;
              local_1bc = pCVar6->x;
              local_1b8 = pCVar6->y;
              local_1b4 = pCVar6->z;
              local_1b0 = pCVar6[1].x;
              local_1ac = pCVar6[1].y;
              local_174 = local_1b0 - local_1bc;
              local_1a8 = pCVar6[1].z;
              ...
              puVar11 = &DAT_00670210;
              pcVar12 = local_278;
              for (iVar7 = 0x19; iVar7 != 0; iVar7 = iVar7 + -1) {
                *(uint *)pcVar12 = *puVar11;
                puVar11 = puVar11 + (uint)bVar14 * -2 + 1;
                pcVar12 = pcVar12 + ((uint)bVar14 * -2 + 1) * 4;
              }
              while (iVar7 = shape_edittool_cpp_CEditorTools_showTextInputDialog_FUN_004a03d0
                                       (g_CEditorToolsPtr,local_4d0,local_278,100,1), iVar7 != 0) {
                iVar7 = crt_stdio_c_sscanf_FUN_0060013c(local_278,"%f,%f,%f");
                if (iVar7 == 3) {
