...

{
  ...
  if (file_ptr != (_FILE *)0x0) {
    ...
    if (file_ptr_00 != (_FILE *)0x0) {
      ...
      shape_memdbg_cpp_closeFile_FUN_0050f9b0(file_ptr,"..\\core\\dmodel.cpp",2962);
      shape_memdbg_cpp_closeFile_FUN_0050f9b0(file_ptr_00,"..\\core\\dmodel.cpp",2963);
      return 1;
    }
    shape_memdbg_cpp_closeFile_FUN_0050f9b0(file_ptr,"..\\core\\dmodel.cpp",2949);
