...
section .text
    ...
    JLE 0x00476ca5                      ; 00476c8c | LAB_00476ca5
        ;   XREF to: 00476ca5 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 00476c8e
        ;   Label: LAB_00476c8e
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 00476c8f | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00476c94
    TEST EAX,EAX                        ; 00476c97
    JL 0x00476ca5                       ; 00476c99 | LAB_00476ca5
        ;   XREF to: 00476ca5 (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 00476c9b
    JNZ 0x00476c8e                      ; 00476c9e | LAB_00476c8e
        ;   XREF to: 00476c8e (CONDITIONAL_JUMP)
    DEC ESI                             ; 00476ca0
    TEST ESI,ESI                        ; 00476ca1
    JG 0x00476c8e                       ; 00476ca3 | LAB_00476c8e
        ;   XREF to: 00476c8e (CONDITIONAL_JUMP)
    POP ESI                             ; 00476ca5
        ;   Label: LAB_00476ca5
    POP EBX                             ; 00476ca6
