...
;                               FUNCTION
; *****************************************************************************
; __cdecl float core_dmodel.cpp_CKeyFramedModel_intersectRay_FUN_004781d0(CKeyFramedModel * this_ptr, int frame_index, CVector3f * ray_origin, CVector3f * ray_direction, CVector3f * output_normal)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 0047821c
    CALL core_box.cpp_CBoundingBox3D_doesRayIntersect_FUN_00420940 ; 0047821d | float core_box.cpp_CBoundingBox3D_doesRayIntersect_FUN_00420940(CBoundingBox3D * this_ptr, CVector3f * ray_origin, CVector3f * ray_direction, CVector3f * out_normal)
    ...
    FNSTSW AX                           ; 0047823f
    SAHF                                ; 00478241
    JA 0x00478477                       ; 00478242 | LAB_00478477
        ;   XREF to: 00478477 (CONDITIONAL_JUMP)
    FLD1                                ; 00478248
    FCOMP double ptr [ESP + 0x10]       ; 0047824a
    FNSTSW AX                           ; 0047824e
    SAHF                                ; 00478250
    JC 0x00478477                       ; 00478251 | LAB_00478477
        ;   XREF to: 00478477 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0xd0],0x40000000 ; 00478257
    MOV EAX,dword ptr [EBP + 0x14]      ; 00478262
    CMP dword ptr [EAX + 0x5698],0x0    ; 00478265
    JNZ 0x0047850c                      ; 0047826c | LAB_0047850c
        ;   XREF to: 0047850c (CONDITIONAL_JUMP)
    PUSH EDI                            ; 00478272
    PUSH EAX                            ; 00478273
    MOV EBX,EAX                         ; 00478274
    CALL core_dmodel.cpp_CKeyFramedModel_getFrameVertices_FUN_00477890 ; 00478276 | CVector3i * core_dmodel.cpp_CKeyFramedModel_getFrameVertices_FUN_00477890(CKeyFramedModel * this_ptr, int frame_index)
    ...
    JLE 0x0047845b                      ; 00478298 | LAB_0047845b
    ...
    FMUL float ptr [0x0065c974]         ; 004782d4 | float g_Fixed16ToFloat
    FSTP float ptr [EBX]                ; 004782da
    FILD dword ptr [EAX + 0x4]          ; 004782dc
    FMUL float ptr [0x0065c974]         ; 004782df | float g_Fixed16ToFloat
    FSTP float ptr [EBX + 0x4]          ; 004782e5
    FILD dword ptr [EAX + 0x8]          ; 004782e8
    FMUL float ptr [0x0065c974]         ; 004782eb | float g_Fixed16ToFloat
    ...
    FMUL float ptr [0x0065c974]         ; 0047835d | float g_Fixed16ToFloat
    FSTP float ptr [EBX]                ; 00478363
    FILD dword ptr [EAX + 0x4]          ; 00478365
    FMUL float ptr [0x0065c974]         ; 00478368 | float g_Fixed16ToFloat
    FSTP float ptr [EBX + 0x4]          ; 0047836e
    FILD dword ptr [EAX + 0x8]          ; 00478371
    FMUL float ptr [0x0065c974]         ; 00478374 | float g_Fixed16ToFloat
    ...
    CALL core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790 ; 004783a1 | void core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790(CDemonTriangle * this_ptr, CVector3f * vertex1, CVector3f * vertex2, CVector3f * vertex3)
        ;   XREF to: 0049a790 (UNCONDITIONAL_CALL)
    LEA EAX,[ESP + 0xa4]                ; 004783a6
    ADD ESP,0x10                        ; 004783ad
    CMP EAX,EBX                         ; 004783b0
    JZ 0x004783de                       ; 004783b2 | LAB_004783de
    ...
    PUSH EAX                            ; 004783ea
    CALL core_dtri.cpp_rayTriangleIntersection_FUN_0049a800 ; 004783eb | float core_dtri.cpp_rayTriangleIntersection_FUN_0049a800(CDemonTriangle * triangle, CVector3f * rayOrigin, CVector3f * rayDirection)
    ...
    FNSTSW AX                           ; 0047840c
    SAHF                                ; 0047840e
    JBE 0x00478484                      ; 0047840f | LAB_00478484
    ...
    JL 0x00478342                       ; 00478424 | LAB_00478342
    ...
    JL 0x004782a5                       ; 00478455 | LAB_004782a5
    ...
    MOV dword ptr [ESP + 0xbc],0x40000000 ; 00478477
        ;   Label: LAB_00478477
    JMP 0x00478469                      ; 00478482 | LAB_00478469
    ...
    JZ 0x00478411                       ; 004784ed | LAB_00478411
        ;   XREF to: 00478411 (CONDITIONAL_JUMP)
    ...
    JMP 0x00478411                      ; 00478507 | LAB_00478411
    ...
    PUSH EBX                            ; 0047851e
    CALL core_dirmat.cpp_CMatrix3x3f_transformVectorTranspose_FUN_00472030 ; 0047851f | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVectorTranspose_FUN_00472030(CMatrix3x3f * matrix, CVector3f * output, CVector3f * input)
    ...
    PUSH EAX                            ; 00478532
    PUSH EBX                            ; 00478533
    CALL core_dirmat.cpp_CMatrix3x3f_transformVectorTranspose_FUN_00472030 ; 00478534 | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVectorTranspose_FUN_00472030(CMatrix3x3f * matrix, CVector3f * output, CVector3f * input)
        ;   XREF to: 00472030 (UNCONDITIONAL_CALL)
    ...
    JLE 0x0047845b                      ; 0047856e | LAB_0047845b
        ;   XREF to: 0047845b (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 00478589
    PUSH EBX                            ; 0047858a
    CALL core_dtri.cpp_rayTriangleIntersection_FUN_0049a800 ; 0047858b | float core_dtri.cpp_rayTriangleIntersection_FUN_0049a800(CDemonTriangle * triangle, CVector3f * rayOrigin, CVector3f * rayDirection)
        ;   XREF to: 0049a800 (UNCONDITIONAL_CALL)
    ...
    FNSTSW AX                           ; 004785ac
    SAHF                                ; 004785ae
    JBE 0x004785c8                      ; 004785af | LAB_004785c8
    ...
    JGE 0x0047845b                      ; 004785c0 | LAB_0047845b
        ;   XREF to: 0047845b (CONDITIONAL_JUMP)
    JMP 0x0047857d                      ; 004785c6 | LAB_0047857d
    ...
    CALL core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0 ; 00478626 | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0(CMatrix3x3f * this_ptr, CVector3f * output, CVector3f * input)
        ;   XREF to: 00471fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0047862b
    CMP ESI,EAX                         ; 0047862e
    JZ 0x004785b1                       ; 00478630 | LAB_004785b1
        ;   XREF to: 004785b1 (CONDITIONAL_JUMP)
    ...
    JMP 0x004785b1                      ; 00478646 | LAB_004785b1
