...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_dmodel_cpp_staticInit_FUN_00476c50(void)
;
;
; Referenced Globals:
