...
;                               FUNCTION
; *****************************************************************************
; __cdecl CKeyFramedModel * __cdecl core_dmodel_cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80(CKeyFramedModelInstance *this_ptr)
;
; Parameters:
...
;   core_anvil.cpp_CAnvil_writeDependencies_FUN_00412090 at 004120c6
