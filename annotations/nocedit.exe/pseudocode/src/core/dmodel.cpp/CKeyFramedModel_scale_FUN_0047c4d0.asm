...
section .text
    ...
    JL 0x0047c506                       ; 0047c4f4 | LAB_0047c506
        ;   XREF to: 0047c506 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 0047c4f6
    CALL core_dmodel.cpp_CKeyFramedModel_calculateFrameBounds_FUN_00478010 ; 0047c4f7 | void core_dmodel.cpp_CKeyFramedModel_calculateFrameBounds_FUN_00478010(CKeyFramedModel * model_ptr)
    ...
    FADD double ptr [0x0062057b]        ; 0047c514 | double DOUBLE_0062057b
    SUB ESP,0x8                         ; 0047c51a
    FSTP double ptr [ESP]               ; 0047c51d
    CALL crt_math.c_floor_FUN_005feb90  ; 0047c520 | double crt_math.c_floor_FUN_005feb90(double input_value)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 0047c531 | double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    FADD double ptr [0x0062057b]        ; 0047c55a | double DOUBLE_0062057b
    SUB ESP,0x8                         ; 0047c560
    FSTP double ptr [ESP]               ; 0047c563
    CALL crt_math.c_floor_FUN_005feb90  ; 0047c566 | double crt_math.c_floor_FUN_005feb90(double input_value)
        ;   XREF to: 005feb90 (UNCONDITIONAL_CALL)
    MOV dword ptr [ESP + 0x8],EAX       ; 0047c56b
    MOV dword ptr [ESP + 0xc],EDX       ; 0047c56f
    FLD double ptr [ESP + 0x8]          ; 0047c573
    CALL crt_math.c_round_FUN_005fe6b0  ; 0047c577 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    FADD double ptr [0x0062057b]        ; 0047c5a3 | double DOUBLE_0062057b
    SUB ESP,0x8                         ; 0047c5a9
    FSTP double ptr [ESP]               ; 0047c5ac
    CALL crt_math.c_floor_FUN_005feb90  ; 0047c5af | double crt_math.c_floor_FUN_005feb90(double input_value)
        ;   XREF to: 005feb90 (UNCONDITIONAL_CALL)
    MOV dword ptr [ESP + 0x8],EAX       ; 0047c5b4
    MOV dword ptr [ESP + 0xc],EDX       ; 0047c5b8
    INC EDI                             ; 0047c5bc
    FLD double ptr [ESP + 0x8]          ; 0047c5bd
    CALL crt_math.c_round_FUN_005fe6b0  ; 0047c5c1 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    JMP 0x0047c4e3                      ; 0047c5e0 | LAB_0047c4e3
