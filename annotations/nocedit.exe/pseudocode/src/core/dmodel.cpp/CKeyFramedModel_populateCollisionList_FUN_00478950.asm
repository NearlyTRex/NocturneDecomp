...
section .text
    ...
    JZ 0x0047897b                       ; 00478969 | LAB_0047897b
    ...
    PUSH EBX                            ; 0047898f
    CALL core_dirmat.cpp_CMatrix3x3f_buildRotationMatrix_FUN_00471d30 ; 00478990 | void core_dirmat.cpp_CMatrix3x3f_buildRotationMatrix_FUN_00471d30(CMatrix3x3f * this_ptr, CVector3f * euler_angles)
    ...
    JLE 0x00478bf2                      ; 004789b4 | LAB_00478bf2
    ...
    JLE 0x00478bd7                      ; 004789fb | LAB_00478bd7
    ...
    FMUL float ptr [0x0065c974]         ; 00478a2b | float g_Fixed16ToFloat
    FSTP float ptr [EBX]                ; 00478a31
    FILD dword ptr [EAX + 0x4]          ; 00478a33
    FMUL float ptr [0x0065c974]         ; 00478a36 | float g_Fixed16ToFloat
    FSTP float ptr [EBX + 0x4]          ; 00478a3c
    FILD dword ptr [EAX + 0x8]          ; 00478a3f
    FMUL float ptr [0x0065c974]         ; 00478a42 | float g_Fixed16ToFloat
    ...
    FMUL float ptr [0x0065c974]         ; 00478a5b | float g_Fixed16ToFloat
    FSTP float ptr [EBX]                ; 00478a61
    FILD dword ptr [EAX + 0x4]          ; 00478a63
    FMUL float ptr [0x0065c974]         ; 00478a66 | float g_Fixed16ToFloat
    FSTP float ptr [EBX + 0x4]          ; 00478a6c
    FILD dword ptr [EAX + 0x8]          ; 00478a6f
    FMUL float ptr [0x0065c974]         ; 00478a72 | float g_Fixed16ToFloat
    ...
    PUSH EDI                            ; 00478a89
    CALL core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0 ; 00478a8a | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0(CMatrix3x3f * this_ptr, CVector3f * output, CVector3f * input)
        ;   XREF to: 00471fd0 (UNCONDITIONAL_CALL)
    MOV EDX,EAX                         ; 00478a8f
    LEA EAX,[ESP + 0x3c]                ; 00478a91
    ADD ESP,0xc                         ; 00478a95
    CMP EAX,EDX                         ; 00478a98
    JZ 0x00478ab0                       ; 00478a9a | LAB_00478ab0
    ...
    PUSH EAX                            ; 00478abe
    CALL core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0 ; 00478abf | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0(CMatrix3x3f * this_ptr, CVector3f * output, CVector3f * input)
        ;   XREF to: 00471fd0 (UNCONDITIONAL_CALL)
    MOV EDX,EAX                         ; 00478ac4
    LEA EAX,[ESP + 0x30]                ; 00478ac6
    ADD ESP,0xc                         ; 00478aca
    CMP EAX,EDX                         ; 00478acd
    JZ 0x00478ae5                       ; 00478acf | LAB_00478ae5
    ...
    JGE 0x00478bb1                      ; 00478af1 | LAB_00478bb1
    ...
    FMUL float ptr [0x0065c974]         ; 00478b0a | float g_Fixed16ToFloat
    FSTP float ptr [EBX]                ; 00478b10
    FILD dword ptr [EAX + 0x4]          ; 00478b12
    FMUL float ptr [0x0065c974]         ; 00478b15 | float g_Fixed16ToFloat
    FSTP float ptr [EBX + 0x4]          ; 00478b1b
    FILD dword ptr [EAX + 0x8]          ; 00478b1e
    FMUL float ptr [0x0065c974]         ; 00478b21 | float g_Fixed16ToFloat
    ...
    PUSH ECX                            ; 00478b38
    CALL core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0 ; 00478b39 | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0(CMatrix3x3f * this_ptr, CVector3f * output, CVector3f * input)
        ;   XREF to: 00471fd0 (UNCONDITIONAL_CALL)
    MOV EDX,EAX                         ; 00478b3e
    LEA EAX,[ESP + 0x24]                ; 00478b40
    ADD ESP,0xc                         ; 00478b44
    CMP EAX,EDX                         ; 00478b47
    JZ 0x00478b5f                       ; 00478b49 | LAB_00478b5f
    ...
    PUSH EAX                            ; 00478b6d
    PUSH EBP                            ; 00478b6e
    CALL core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790 ; 00478b6f | void core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790(CDemonTriangle * this_ptr, CVector3f * vertex1, CVector3f * vertex2, CVector3f * vertex3)
    ...
    JZ 0x00478b9e                       ; 00478b84 | LAB_00478b9e
    ...
    JL 0x00478afa                       ; 00478bab | LAB_00478afa
    ...
    JL 0x00478a07                       ; 00478bd1 | LAB_00478a07
    ...
    JL 0x004789c6                       ; 00478bec | LAB_004789c6
