...

{
  ...
  local_28 = (float)((float10)local_50 * (float10)local_48 +
                    fVar12 * (float10)local_5c * (float10)local_4c);
  local_2c = -local_5c;
  local_60 = (float)(fVar13 * (float10)local_5c);
  local_40 = (float)(fVar11 * (float10)local_54);
  local_18 = (float)(fVar5 * (float10)local_54);
  local_24 = 0;
  local_30 = -local_50 * local_4c + (float)(fVar12 * (float10)local_5c) * local_48;
  local_44 = local_4c * local_58 + local_60 * local_48;
  local_3c = (float)(fVar13 * (float10)local_5c * (float10)local_4c +
  ...
  while (iVar1 = this_ptr->vertex_count * this_ptr->frame_count,
    ...
    iVar3 = *piVar3;
    (&local_84)[(uint)bVar5 * -2] = *piVar4;
    (&local_80)[(uint)bVar5 * -2 + (uint)bVar5 * -2] = piVar4[(uint)bVar5 * -2 + 1];
    ...
    local_7c = floor
                         ((double)((float)local_80 * local_3c +
                                   (float)iVar3 * local_28 + (float)local_84 * local_40 +
                                  (float)0.5));
