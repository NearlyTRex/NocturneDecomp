...
// Convention: __cdecl
// Signature: void __cdecl core_dmodel_cpp_CKeyFramedModel_recenter_FUN_0047c220(CKeyFramedModel *this_ptr,int frame_index)
...

{
  ...
  pCVar1 = &this_ptr->frame_bounds[frame_index].min;
