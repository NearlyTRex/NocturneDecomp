...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dmodel.cpp_CKeyFramedModel_removeUnusedVertices_FUN_0047aa30(CKeyFramedModel * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH 0x62023b                       ; 0047aa36 | = "Removing unused vertices..." | s_Removing_unused_vertices_0062023b = Removing unused vertices...
    MOV EDX,dword ptr [0x00678a60]      ; 0047aa3b | CEditorTools g_CEditorToolsPtr | CEditorTools * g_CEditorToolsPtr
    PUSH EDX                            ; 0047aa41 | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_displayCenteredStatusMessage_FUN_0049e790 ; 0047aa42 | void shape_edittool.cpp_CEditorTools_displayCenteredStatusMessage_FUN_0049e790(CEditorTools * this_ptr, char * message)
        ;   XREF to: 0049e790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0047aa47
    MOV ECX,dword ptr [ESP + 0x2c]      ; 0047aa4a
    PUSH ECX                            ; 0047aa4e
    CALL core_dmodel.cpp_CKeyFramedModel_validatePartList_FUN_0047bf40 ; 0047aa4f | void core_dmodel.cpp_CKeyFramedModel_validatePartList_FUN_0047bf40(CKeyFramedModel * this_ptr)
    ...
    JL 0x0047aa6f                       ; 0047aa64 | LAB_0047aa6f
        ;   XREF to: 0047aa6f (CONDITIONAL_JUMP)
    CMP dword ptr [EAX + 0x100],0x1     ; 0047aa66
    JGE 0x0047aa76                      ; 0047aa6d | LAB_0047aa76
    ...
    PUSH 0x868                          ; 0047aa76
        ;   Label: LAB_0047aa76
    PUSH 0x620257                       ; 0047aa7b | = "..\\core\\dmodel.cpp" | s_core_dmodel_cpp_00620257 = ..\core\dmodel.cpp
    LEA EAX,[EBX*0x4 + 0x0]             ; 0047aa80
    PUSH EAX                            ; 0047aa87
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1f0 ; 0047aa88 | void * shape_memdbg.cpp_debugAlloc_FUN_0050f1f0(int size, char * filename, int line_number)
        ;   XREF to: 0050f1f0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0047aa8d
    MOV dword ptr [ESP + 0xc],EAX       ; 0047aa90
    TEST EAX,EAX                        ; 0047aa94
    JNZ 0x0047aac6                      ; 0047aa96 | LAB_0047aac6
        ;   XREF to: 0047aac6 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x2c]      ; 0047aa98
    MOV EDX,dword ptr [EAX + 0x104]     ; 0047aa9c
    PUSH EDX                            ; 0047aaa2
    MOV EDI,0x62026a                    ; 0047aaa3 | = "..\\core\\dmodel.cpp" | s_core_dmodel_cpp_0062026a = ..\core\dmodel.cpp
    MOV EBP,0x869                       ; 0047aaa8
    PUSH 0x62027d                       ; 0047aaad | = "CKeyFramedModel::removeUnusedVertices..." | s_CKeyFramedModel_removeUn_0062027d = CKeyFramedModel::removeUnusedVertices out of memory for auxArray, vertexCount = %d
    MOV dword ptr [0x02f0ca48],EDI      ; 0047aab2 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBP      ; 0047aab8 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0047aabe | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    PUSH ECX                            ; 0047aadb
    CALL crt_memory.c_memset_FUN_005fde40 ; 0047aadc | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
    ...
    JLE 0x0047ab3c                      ; 0047aaf2 | LAB_0047ab3c
    ...
    JLE 0x0047ab2a                      ; 0047ab0d | LAB_0047ab2a
    ...
    JL 0x0047ab11                       ; 0047ab28 | LAB_0047ab11
    ...
    JL 0x0047aafa                       ; 0047ab3a | LAB_0047aafa
    ...
    JL 0x0047ab54                       ; 0047ab78 | LAB_0047ab54
    ...
    JLE 0x0047abcf                      ; 0047abaf | LAB_0047abcf
    ...
    JL 0x0047abb7                       ; 0047abcd | LAB_0047abb7
    ...
    JL 0x0047ab9c                       ; 0047abdf | LAB_0047ab9c
    ...
    JLE 0x0047ac46                      ; 0047abfb | LAB_0047ac46
    ...
    JLE 0x0047ad4a                      ; 0047ac70 | LAB_0047ad4a
        ;   XREF to: 0047ad4a (CONDITIONAL_JUMP)
    ...
    JLE 0x0047ad12                      ; 0047ac9b | LAB_0047ad12
    ...
    JLE 0x0047acf3                      ; 0047acac | LAB_0047acf3
    ...
    JGE 0x0047acdd                      ; 0047acb9 | LAB_0047acdd
        ;   XREF to: 0047acdd (CONDITIONAL_JUMP)
    MOV EAX,0x6202d0                    ; 0047acbb | = "..\\core\\dmodel.cpp" | s_core_dmodel_cpp_006202d0 = ..\core\dmodel.cpp
    MOV EDX,0x8ae                       ; 0047acc0
    PUSH 0x6202e3                       ; 0047acc5 | = "Part vertex overlap detected!" | s_Part_vertex_overlap_dete_006202e3 = Part vertex overlap detected!
    MOV [0x02f0ca48],EAX                ; 0047acca | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 0047accf | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0047acd5 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0047acda
    CMP EBX,EBP                         ; 0047acdd
        ;   Label: LAB_0047acdd
    JL 0x0047ace4                       ; 0047acdf | LAB_0047ace4
    ...
    JL 0x0047acb0                       ; 0047acf1 | LAB_0047acb0
    ...
    JL 0x0047aca1                       ; 0047ad10 | LAB_0047aca1
    ...
    JL 0x0047ac83                       ; 0047ad44 | LAB_0047ac83
        ;   XREF to: 0047ac83 (CONDITIONAL_JUMP)
    MOV ECX,0x620301                    ; 0047ad4a | = "..\\core\\dmodel.cpp" | s_core_dmodel_cpp_00620301 = ..\core\dmodel.cpp
        ;   Label: LAB_0047ad4a
    MOV ESI,dword ptr [ESP + 0x10]      ; 0047ad4f
    MOV EBX,0x8bc                       ; 0047ad53
    PUSH ESI                            ; 0047ad58
    MOV dword ptr [0x0067d20c],ECX      ; 0047ad59 | char * g_CurrentDebugFilename
    MOV dword ptr [0x02f0d944],EBX      ; 0047ad5f | int g_CurrentDebugLine
    CALL crt_memory.c_free_FUN_005fe659 ; 0047ad65 | void crt_memory.c_free_FUN_005fe659(void * ptr)
        ;   XREF to: 005fe659 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0047ad6a
    MOV EDI,dword ptr [ESP + 0x30]      ; 0047ad6d
    PUSH EDI                            ; 0047ad71
    CALL core_dmodel.cpp_CKeyFramedModel_validatePartList_FUN_0047bf40 ; 0047ad72 | void core_dmodel.cpp_CKeyFramedModel_validatePartList_FUN_0047bf40(CKeyFramedModel * this_ptr)
        ;   XREF to: 0047bf40 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0047ad77
    PUSH EDI                            ; 0047ad7a
    CALL core_dmodel.cpp_CKeyFramedModel_calcNormals_FUN_00477e60 ; 0047ad7b | void core_dmodel.cpp_CKeyFramedModel_calcNormals_FUN_00477e60(CKeyFramedModel * this_ptr)
    ...
    MOV dword ptr [EAX],0xffffffff      ; 0047ad8b
        ;   Label: LAB_0047ad8b
    JMP 0x0047ab68                      ; 0047ad91 | LAB_0047ab68
