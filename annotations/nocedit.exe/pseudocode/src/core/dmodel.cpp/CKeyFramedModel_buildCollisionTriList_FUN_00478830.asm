...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dmodel.cpp_CKeyFramedModel_buildCollisionTriList_FUN_00478830(CKeyFramedModel * this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EDX,0x61f8b4                    ; 0047883b | = "..\\core\\dmodel.cpp" | s_core_dmodel_cpp_0061f8b4 = ..\core\dmodel.cpp
    MOV EAX,dword ptr [EBX + 0x5698]    ; 00478840
    MOV dword ptr [0x02f0d944],ECX      ; 00478846 | int g_CurrentDebugLine
    MOV dword ptr [0x0067d20c],EDX      ; 0047884c | char * g_CurrentDebugFilename
    TEST EAX,EAX                        ; 00478852
    JNZ 0x00478936                      ; 00478854 | LAB_00478936
    ...
    JL 0x00478893                       ; 004788ba | LAB_00478893
    ...
    PUSH 0x61f8c7                       ; 004788dd | = "..\\core\\dmodel.cpp" | s_core_dmodel_cpp_0061f8c7 = ..\core\dmodel.cpp
    ADD EAX,0x4                         ; 004788e2
    PUSH EAX                            ; 004788e5
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1f0 ; 004788e6 | void * shape_memdbg.cpp_debugAlloc_FUN_0050f1f0(int size, char * filename, int line_number)
        ;   XREF to: 0050f1f0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004788eb
    TEST EAX,EAX                        ; 004788ee
    JZ 0x004788f8                       ; 004788f0 | LAB_004788f8
    ...
    JNZ 0x00478925                      ; 00478900 | LAB_00478925
        ;   XREF to: 00478925 (CONDITIONAL_JUMP)
    MOV EDX,0x61f8da                    ; 00478902 | = "..\\core\\dmodel.cpp" | s_core_dmodel_cpp_0061f8da = ..\core\dmodel.cpp
    MOV ECX,0x470                       ; 00478907
    PUSH 0x61f8ed                       ; 0047890c | = "CKeyFramedModel::buildCollisionTriLis..." | s_CKeyFramedModel_buildCol_0061f8ed = CKeyFramedModel::buildCollisionTriList - out of memory
    MOV dword ptr [0x02f0ca48],EDX      ; 00478911 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 00478917 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0047891d | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00478922
    PUSH 0x3f87558                      ; 00478925 | CVector3f g_ZeroVector
        ;   Label: LAB_00478925
    PUSH EBX                            ; 0047892a
    CALL core_dmodel.cpp_CKeyFramedModel_populateCollisionList_FUN_00478950 ; 0047892b | void core_dmodel.cpp_CKeyFramedModel_populateCollisionList_FUN_00478950(CKeyFramedModel * this_ptr, CVector3f * transform_vector)
    ...
    SUB EAX,0x4                         ; 00478936
        ;   Label: LAB_00478936
    PUSH EAX                            ; 00478939
    CALL crt_memory.c_free_FUN_005fe659 ; 0047893a | void crt_memory.c_free_FUN_005fe659(void * ptr)
        ;   XREF to: 005fe659 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0047893f
    JMP 0x0047885a                      ; 00478942 | LAB_0047885a
