...
section .text
    ...
    PUSH EBX                            ; 0047ea19
    CALL core_dmodel.cpp_CKeyFramedModel_free_FUN_00477690 ; 0047ea1a | void core_dmodel.cpp_CKeyFramedModel_free_FUN_00477690(CKeyFramedModel * this_ptr)
        ;   XREF to: 00477690 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [0x01626408]      ; 0047ea1f | int g_VertexCount
    ADD ESP,0x4                         ; 0047ea25
    CMP EDX,0x1                         ; 0047ea28
    JL 0x0047ea38                       ; 0047ea2b | LAB_0047ea38
        ;   XREF to: 0047ea38 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x016e990c]      ; 0047ea2d | int g_PolygonCount
    CMP ECX,0x1                         ; 0047ea33
    JGE 0x0047ea3e                      ; 0047ea36 | LAB_0047ea3e
    ...
    CALL core_dmodel.cpp_CKeyFramedModel_allocate_FUN_00477bf0 ; 0047ea4e | void core_dmodel.cpp_CKeyFramedModel_allocate_FUN_00477bf0(CKeyFramedModel * this_ptr, int vertex_count, int poly_count, int texture_count, ...)
        ;   XREF to: 00477bf0 (UNCONDITIONAL_CALL)
    MOV EBP,dword ptr [EBX + 0x104]     ; 0047ea53
    ADD ESP,0x18                        ; 0047ea59
    TEST EBP,EBP                        ; 0047ea5c
    JLE 0x0047eae3                      ; 0047ea5e | LAB_0047eae3
        ;   XREF to: 0047eae3 (CONDITIONAL_JUMP)
    FLD double ptr [0x00620efb]         ; 0047ea64 | double DOUBLE_00620efb
    XOR ECX,ECX                         ; 0047ea6a
    XOR EDX,EDX                         ; 0047ea6c
    FLD float ptr [ECX + 0x162640c]     ; 0047ea6e | SVertexData[20000] g_LoadedVertices
        ;   Label: LAB_0047ea6e
    MOV EAX,dword ptr [EBX + 0x10c]     ; 0047ea74
    FMUL ST1                            ; 0047ea7a
    LEA EDI,[EAX + EDX*0x1]             ; 0047ea7c
    CALL crt_math.c_round_FUN_005fe6b0  ; 0047ea7f | double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 0047ea9f | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 0047eac0 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    JL 0x0047ea6e                       ; 0047eadf | LAB_0047ea6e
    ...
    JLE 0x0047ecb0                      ; 0047eafb | LAB_0047ecb0
    ...
    MOV EAX,0x16e9910                   ; 0047eb0f | SShapeEditorPolygon[20000] g_ModelPolygonData
    ...
    JLE 0x0047ebe1                      ; 0047eb56 | LAB_0047ebe1
        ;   XREF to: 0047ebe1 (CONDITIONAL_JUMP)
    FLD double ptr [0x00620f03]         ; 0047eb5c | double DOUBLE_00620f03
    ...
    MOV EAX,dword ptr [EDX + 0x16e99c8] ; 0047eb74 | DAT_016e99c8
    MOV dword ptr [EDI + 0x18],EAX      ; 0047eb7a
    FLD float ptr [EDX + 0x16e9a08]     ; 0047eb7d | DAT_016e9a08
    MOV EAX,dword ptr [EBX + 0x114]     ; 0047eb83
    FMUL ST1                            ; 0047eb89
    ADD EAX,EBP                         ; 0047eb8b
    ADD EAX,ECX                         ; 0047eb8d
    MOV dword ptr [ESP + 0x8],EAX       ; 0047eb8f
    CALL crt_math.c_round_FUN_005fe6b0  ; 0047eb93 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 0047ebb7 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    JL 0x0047eb62                       ; 0047ebdd | LAB_0047eb62
    ...
    JLE 0x0047ec0a                      ; 0047ebeb | LAB_0047ec0a
    ...
    PUSH EDI                            ; 0047ebf8 | DAT_016e9914
        ;   Label: LAB_0047ebf8
    PUSH ESI                            ; 0047ebf9
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 0047ebfa | int crt_string.c_stricmp_FUN_005fe7f0(char * str1, char * str2)
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0047ebff
    TEST EAX,EAX                        ; 0047ec02
    JNZ 0x0047ecda                      ; 0047ec04 | LAB_0047ecda
        ;   XREF to: 0047ecda (CONDITIONAL_JUMP)
    CMP EBP,dword ptr [EBX + 0x120]     ; 0047ec0a
        ;   Label: LAB_0047ec0a
    JL 0x0047ec6b                       ; 0047ec10 | LAB_0047ec6b
        ;   XREF to: 0047ec6b (CONDITIONAL_JUMP)
    CMP EBP,0x12c                       ; 0047ec12
    JL 0x0047ec3d                       ; 0047ec18 | LAB_0047ec3d
        ;   XREF to: 0047ec3d (CONDITIONAL_JUMP)
    MOV ESI,0x620eb3                    ; 0047ec1a | = "..\\core\\dmodel.cpp" | s_core_dmodel_cpp_00620eb3 = ..\core\dmodel.cpp
    MOV EDI,0xe45                       ; 0047ec1f
    PUSH 0x620ec6                       ; 0047ec24 | = "CKeyFramedModel::exportToDSE() - Too ..." | s_CKeyFramedModel_exportTo_00620ec6 = CKeyFramedModel::exportToDSE() - Too many textures!
    MOV dword ptr [0x02f0ca48],ESI      ; 0047ec29 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 0047ec2f | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0047ec35 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    PUSH EDI                            ; 0047ec4b
    MOV AL,byte ptr [ESI]               ; 0047ec4c | DAT_016e9914
        ;   Label: LAB_0047ec4c
    MOV byte ptr [EDI],AL               ; 0047ec4e
    CMP AL,0x0                          ; 0047ec50
    JZ 0x0047ec64                       ; 0047ec52 | LAB_0047ec64
        ;   XREF to: 0047ec64 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0047ec54 | DAT_016e9915
    ADD ESI,0x2                         ; 0047ec57
    MOV byte ptr [EDI + 0x1],AL         ; 0047ec5a
    ADD EDI,0x2                         ; 0047ec5d
    CMP AL,0x0                          ; 0047ec60
    JNZ 0x0047ec4c                      ; 0047ec62 | LAB_0047ec4c
    ...
    JL 0x0047eb23                       ; 0047ecaa | LAB_0047eb23
    ...
    JL 0x0047ebf8                       ; 0047ece6 | LAB_0047ebf8
        ;   XREF to: 0047ebf8 (CONDITIONAL_JUMP)
    JMP 0x0047ec0a                      ; 0047ecec | LAB_0047ec0a
