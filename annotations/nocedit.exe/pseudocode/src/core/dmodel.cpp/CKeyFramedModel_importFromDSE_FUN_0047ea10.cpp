...

{
  ...
  if (0 < this_ptr->vertex_count) {
    ...
    do {
      ...
      dVar12 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44 /* combine 2-byte values */(iVar5,ppCVar3));
      ...
      *(int *)((int)ppCVar3 + iVar5) = (int)ROUND(fVar11);
      ...
      dVar12 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44 /* combine 2-byte values */(iVar4,ppCVar3));
        ...
        do {
          *(uint *)((int)this_ptr->poly_vert_list + iVar5 + local_c + 0x18) =
          ...
          dVar12 = crt_math_c_round_FUN_005fe6b0
                             ((double)CONCAT44 /* combine 2-byte values */(iVar4,(int)this_ptr->poly_vert_list + iVar5 + local_c
                                              ));
          iVar4 = (int)((ulonglong)dVar12 >> 0x20);
          ...
          *(int *)(local_24 + 0x1c) = iVar1;
          ...
          dVar12 = crt_math_c_round_FUN_005fe6b0
                             ((double)CONCAT44 /* combine 2-byte values */(iVar4,(int)this_ptr->poly_vert_list + local_c));
          *(int *)(SUB84 /* extract 2-byte value */(dVar12,0) + extraout_ECX_02 + 0x20) = (int)ROUND(fVar11);
