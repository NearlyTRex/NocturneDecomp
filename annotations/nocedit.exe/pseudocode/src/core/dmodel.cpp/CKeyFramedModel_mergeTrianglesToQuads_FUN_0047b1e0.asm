...
section .text
    ...
    MOV ECX,dword ptr [0x00678a60]      ; 0047b255 | g_CEditorToolsInstance | g_CEditorToolsPtr
    PUSH ECX                            ; 0047b25b | g_CEditorToolsInstance
    ...
    JZ 0x0047b210                       ; 0047b4b6
        ;   XREF to: 0047b210 (CONDITIONAL_JUMP)  ; LAB_0047b210
    MOV EBX,dword ptr [0x00678a60]      ; 0047b4bc | g_CEditorToolsInstance | g_CEditorToolsPtr
    PUSH EBX                            ; 0047b4c2 | g_CEditorToolsInstance
    ...
    MOV EAX,[0x00678a60]                ; 0047b5c2 | g_CEditorToolsInstance | g_CEditorToolsPtr
    FSTP float ptr [ESP]                ; 0047b5c7
    PUSH EAX                            ; 0047b5ca | g_CEditorToolsInstance
    ...
    JMP 0x00609dd1                      ; 0047b720
        ;   XREF to: 00609dd1 (UNCONDITIONAL_JUMP)  ; LAB_00609dd1
    ...
    JMP 0x00609df4                      ; 0047b74a
        ;   XREF to: 00609df4 (UNCONDITIONAL_JUMP)  ; LAB_00609df4
    LEA EDI,[ESP + 0x38]                ; 0047b74f
        ;   Label: LAB_0047b74f
    LEA ESI,[EDX + 0x18]                ; 0047b753
    JMP 0x00609e11                      ; 0047b756
        ;   XREF to: 00609e11 (UNCONDITIONAL_JUMP)  ; LAB_00609e11
    ...
    JMP 0x00609e34                      ; 0047b779
        ;   XREF to: 00609e34 (UNCONDITIONAL_JUMP)  ; LAB_00609e34
    ...
    JMP 0x0060c2e0                      ; 0047bb37
        ;   XREF to: 0060c2e0 (UNCONDITIONAL_JUMP)  ; CAVE_cave_0060c2e0
    LEA ESI,[ESP + 0x2c]                ; 0047bb41
        ;   Label: LAB_0047bb41
    LEA EDI,[EDI + 0x24]                ; 0047bb45
    JMP 0x0060c302                      ; 0047bb48
        ;   XREF to: 0060c302 (UNCONDITIONAL_JUMP)  ; LAB_0060c302
    LEA ESI,[ESP + 0x38]                ; 0047bb52
        ;   Label: LAB_0047bb52
    LEA EDI,[EDI + 0x30]                ; 0047bb56
    JMP 0x0060c324                      ; 0047bb59
        ;   XREF to: 0060c324 (UNCONDITIONAL_JUMP)  ; LAB_0060c324
    LEA ESI,[ESP + 0x44]                ; 0047bb63
        ;   Label: LAB_0047bb63
    LEA EDI,[EDI + 0x3c]                ; 0047bb67
    MOV EAX,dword ptr [ESP + 0xdc]      ; 0047bb6a
    JMP 0x0060c346                      ; 0047bb71
        ;   XREF to: 0060c346 (UNCONDITIONAL_JUMP)  ; LAB_0060c346
    ...
    JMP 0x0047b333                      ; 0047bbb0
        ;   XREF to: 0047b333 (UNCONDITIONAL_JUMP)  ; LAB_0047b333
    MOV ECX,dword ptr [ESI]             ; 00609dd1
        ;   Label: LAB_00609dd1
    MOV dword ptr [EDI],ECX             ; 00609dd3
    MOV ECX,dword ptr [ESI + 0x4]       ; 00609dd5
    MOV dword ptr [EDI + 0x4],ECX       ; 00609dd8
    MOV ECX,dword ptr [ESI + 0x8]       ; 00609ddb
    MOV dword ptr [EDI + 0x8],ECX       ; 00609dde
    ADD ESI,0xc                         ; 00609de1
    ADD EDI,0xc                         ; 00609de4
    IMUL ESI,dword ptr [EAX*0x4 + 0x6700f0],0xc ; 00609de7
    JMP 0x0047b72b                      ; 00609def
        ;   XREF to: 0047b72b (UNCONDITIONAL_JUMP)  ; LAB_0047b72b
    MOV ECX,dword ptr [ESI]             ; 00609df4
        ;   Label: LAB_00609df4
    MOV dword ptr [EDI],ECX             ; 00609df6
    MOV ECX,dword ptr [ESI + 0x4]       ; 00609df8
    MOV dword ptr [EDI + 0x4],ECX       ; 00609dfb
    MOV ECX,dword ptr [ESI + 0x8]       ; 00609dfe
    MOV dword ptr [EDI + 0x8],ECX       ; 00609e01
    ADD ESI,0xc                         ; 00609e04
    ADD EDI,0xc                         ; 00609e07
    ADD EDX,EBX                         ; 00609e0a
    JMP 0x0047b74f                      ; 00609e0c
        ;   XREF to: 0047b74f (UNCONDITIONAL_JUMP)  ; LAB_0047b74f
    MOV ECX,dword ptr [ESI]             ; 00609e11
        ;   Label: LAB_00609e11
    MOV dword ptr [EDI],ECX             ; 00609e13
    MOV ECX,dword ptr [ESI + 0x4]       ; 00609e15
    MOV dword ptr [EDI + 0x4],ECX       ; 00609e18
    MOV ECX,dword ptr [ESI + 0x8]       ; 00609e1b
    MOV dword ptr [EDI + 0x8],ECX       ; 00609e1e
    ADD ESI,0xc                         ; 00609e21
    ADD EDI,0xc                         ; 00609e24
    IMUL EAX,dword ptr [EAX*0x4 + 0x6700fc],0xc ; 00609e27
    JMP 0x0047b761                      ; 00609e2f
        ;   XREF to: 0047b761 (UNCONDITIONAL_JUMP)  ; LAB_0047b761
    MOV ECX,dword ptr [ESI]             ; 00609e34
        ;   Label: LAB_00609e34
    MOV dword ptr [EDI],ECX             ; 00609e36
    MOV ECX,dword ptr [ESI + 0x4]       ; 00609e38
    MOV dword ptr [EDI + 0x4],ECX       ; 00609e3b
    MOV ECX,dword ptr [ESI + 0x8]       ; 00609e3e
    MOV dword ptr [EDI + 0x8],ECX       ; 00609e41
    ADD ESI,0xc                         ; 00609e44
    ADD EDI,0xc                         ; 00609e47
    XOR EDX,EDX                         ; 00609e4a
    JMP 0x0047b77e                      ; 00609e4c
        ;   XREF to: 0047b77e (UNCONDITIONAL_JUMP)  ; LAB_0047b77e
    MOV ECX,dword ptr [ESI]             ; 0060c2e0
        ;   Label: CAVE_cave_0060c2e0
    MOV dword ptr [EDI],ECX             ; 0060c2e2
    MOV ECX,dword ptr [ESI + 0x4]       ; 0060c2e4
    MOV dword ptr [EDI + 0x4],ECX       ; 0060c2e7
    MOV ECX,dword ptr [ESI + 0x8]       ; 0060c2ea
    MOV dword ptr [EDI + 0x8],ECX       ; 0060c2ed
    ADD ESI,0xc                         ; 0060c2f0
    ADD EDI,0xc                         ; 0060c2f3
    MOV EDI,dword ptr [ESP + 0xdc]      ; 0060c2f6
    JMP 0x0047bb41                      ; 0060c2fd
        ;   XREF to: 0047bb41 (UNCONDITIONAL_JUMP)  ; LAB_0047bb41
    MOV ECX,dword ptr [ESI]             ; 0060c302
        ;   Label: LAB_0060c302
    MOV dword ptr [EDI],ECX             ; 0060c304
    MOV ECX,dword ptr [ESI + 0x4]       ; 0060c306
    MOV dword ptr [EDI + 0x4],ECX       ; 0060c309
    MOV ECX,dword ptr [ESI + 0x8]       ; 0060c30c
    MOV dword ptr [EDI + 0x8],ECX       ; 0060c30f
    ADD ESI,0xc                         ; 0060c312
    ADD EDI,0xc                         ; 0060c315
    MOV EDI,dword ptr [ESP + 0xdc]      ; 0060c318
    JMP 0x0047bb52                      ; 0060c31f
        ;   XREF to: 0047bb52 (UNCONDITIONAL_JUMP)  ; LAB_0047bb52
    MOV ECX,dword ptr [ESI]             ; 0060c324
        ;   Label: LAB_0060c324
    MOV dword ptr [EDI],ECX             ; 0060c326
    MOV ECX,dword ptr [ESI + 0x4]       ; 0060c328
    MOV dword ptr [EDI + 0x4],ECX       ; 0060c32b
    MOV ECX,dword ptr [ESI + 0x8]       ; 0060c32e
    MOV dword ptr [EDI + 0x8],ECX       ; 0060c331
    ADD ESI,0xc                         ; 0060c334
    ADD EDI,0xc                         ; 0060c337
    MOV EDI,dword ptr [ESP + 0xdc]      ; 0060c33a
    JMP 0x0047bb63                      ; 0060c341
        ;   XREF to: 0047bb63 (UNCONDITIONAL_JUMP)  ; LAB_0047bb63
    MOV ECX,dword ptr [ESI]             ; 0060c346
        ;   Label: LAB_0060c346
    MOV dword ptr [EDI],ECX             ; 0060c348
    MOV ECX,dword ptr [ESI + 0x4]       ; 0060c34a
    MOV dword ptr [EDI + 0x4],ECX       ; 0060c34d
    MOV ECX,dword ptr [ESI + 0x8]       ; 0060c350
    MOV dword ptr [EDI + 0x8],ECX       ; 0060c353
    ADD ESI,0xc                         ; 0060c356
    ADD EDI,0xc                         ; 0060c359
    MOV dword ptr [EAX + 0x4],0x4       ; 0060c35c
    JMP 0x0047bb7b                      ; 0060c363
        ;   XREF to: 0047bb7b (UNCONDITIONAL_JUMP)  ; LAB_0047bb7b
