...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_dmodel_cpp_CKeyFramedModel_intersectCylinder_FUN_00478650(CKeyFramedModel *this_ptr,int frame_index,SIntersectXZCylinder *cylinder,CVector3f *transform_vector)
;
; Parameters:
...
section .text
    ...
    JL 0x00478671                       ; 0047866c
        ;   XREF to: 00478671 (CONDITIONAL_JUMP)  ; LAB_00478671
    LEA EBX,[ECX + -0x1]                ; 0047866e
    TEST EBX,EBX                        ; 00478671
        ;   Label: LAB_00478671
    JL 0x00478715                       ; 00478673
        ;   XREF to: 00478715 (CONDITIONAL_JUMP)  ; LAB_00478715
    ...
    FNSTSW AX                           ; 00478683
    SAHF                                ; 00478685
    JZ 0x0047871c                       ; 00478686
        ;   XREF to: 0047871c (CONDITIONAL_JUMP)  ; LAB_0047871c
    PUSH EDX                            ; 0047868c
        ;   Label: LAB_0047868c
    PUSH EDI                            ; 0047868d
    CALL core_dmodel.cpp_CKeyFramedModel_populateCollisionList_FUN_00478950 ; 0047868e
    ...
    CMP dword ptr [EDI + 0x5698],0x0    ; 00478696
        ;   Label: LAB_00478696
    JNZ 0x004786c2                      ; 0047869d
        ;   XREF to: 004786c2 (CONDITIONAL_JUMP)  ; LAB_004786c2
    PUSH EDI                            ; 0047869f
    MOV EAX,0x61f7a3                    ; 004786a0 | = "..\\core\\dmodel.cpp"
    MOV EDX,0x40e                       ; 004786a5
    PUSH 0x61f7b6                       ; 004786aa | = "Tried to call CKeyFramedModel::inters..."
    MOV [0x02f0ca48],EAX                ; 004786af | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 004786b4 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004786ba
    ...
    JLE 0x00478710                      ; 004786e7
        ;   XREF to: 00478710 (CONDITIONAL_JUMP)  ; LAB_00478710
    PUSH EBP                            ; 004786e9
        ;   Label: LAB_004786e9
    PUSH ESI                            ; 004786ea
    INC EBX                             ; 004786eb
    CALL core_dtri.cpp_cylinderTriangleTest_FUN_0049ad80 ; 004786ec
    ...
    JL 0x004786e9                       ; 004786ff
        ;   XREF to: 004786e9 (CONDITIONAL_JUMP)  ; LAB_004786e9
    ...
    XOR EBX,EBX                         ; 00478715
        ;   Label: LAB_00478715
    JMP 0x00478679                      ; 00478717
        ;   XREF to: 00478679 (UNCONDITIONAL_JUMP)  ; LAB_00478679
    FLD float ptr [ESI + 0x4]           ; 0047871c
        ;   Label: LAB_0047871c
    FCOMP float ptr [EDX + 0x4]         ; 0047871f
    FNSTSW AX                           ; 00478722
    SAHF                                ; 00478724
    JNZ 0x0047868c                      ; 00478725
        ;   XREF to: 0047868c (CONDITIONAL_JUMP)  ; LAB_0047868c
    FLD float ptr [ESI + 0x8]           ; 0047872b
    FCOMP float ptr [EDX + 0x8]         ; 0047872e
    FNSTSW AX                           ; 00478731
    SAHF                                ; 00478733
    JZ 0x00478696                       ; 00478734
        ;   XREF to: 00478696 (CONDITIONAL_JUMP)  ; LAB_00478696
    JMP 0x0047868c                      ; 0047873a
        ;   XREF to: 0047868c (UNCONDITIONAL_JUMP)  ; LAB_0047868c
