...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dmodel.cpp_CKeyFramedModel_scaleToHeight_FUN_0047c470(CKeyFramedModel * this_ptr, float desired_height)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0047c475
    CALL core_dmodel.cpp_CKeyFramedModel_calculateFrameBounds_FUN_00478010 ; 0047c476 | void core_dmodel.cpp_CKeyFramedModel_calculateFrameBounds_FUN_00478010(CKeyFramedModel * model_ptr)
    ...
    PUSH EBX                            ; 0047c494
    CALL core_dmodel.cpp_CKeyFramedModel_scaleUniform_FUN_0047c4a0 ; 0047c495 | void core_dmodel.cpp_CKeyFramedModel_scaleUniform_FUN_0047c4a0(CKeyFramedModel * this_ptr, float uniform_scale)
