...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dmodel.cpp_CKeyFramedModel_exportToS3D_FUN_00479f30(CKeyFramedModel * this_ptr, char * filename)
;
; Parameters:
...
section .text
    ...
    PUSH 0x75b                          ; 00479f40
    PUSH 0x62001b                       ; 00479f45 | = "..\\core\\dmodel.cpp" | s_core_dmodel_cpp_0062001b = ..\core\dmodel.cpp
    PUSH 0x62002e                       ; 00479f4a | = "wt" | s_wt_0062002e = wt
    PUSH 0x0                            ; 00479f4f
    PUSH ESI                            ; 00479f51
    CALL shape_memdbg.cpp_openFile_FUN_0050f7a0 ; 00479f52 | FILE * shape_memdbg.cpp_openFile_FUN_0050f7a0(char * filename, char * directory, char * mode, char * source_file, ...)
        ;   XREF to: 0050f7a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 00479f57
    MOV EBX,EAX                         ; 00479f5a
    MOV dword ptr [ESP + 0x134],EAX     ; 00479f5c
    TEST EAX,EAX                        ; 00479f63
    JZ 0x0047a345                       ; 00479f65 | LAB_0047a345
        ;   XREF to: 0047a345 (CONDITIONAL_JUMP)
    PUSH EDI                            ; 00479f6b
    PUSH 0x620041                       ; 00479f6c | = "// .S3D version\n" | s_S3D_version_00620041 = // .S3D version

    PUSH EAX                            ; 00479f71
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00479f72 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00479f77
    PUSH 0x620052                       ; 00479f7a | = "103\n" | s_s_103_00620052 = 103

    PUSH EBX                            ; 00479f7f
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00479f80 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JLE 0x00479fc0                      ; 00479f9b | LAB_00479fc0
    ...
    JL 0x00479fa3                       ; 00479fbe | LAB_00479fa3
        ;   XREF to: 00479fa3 (CONDITIONAL_JUMP)
    PUSH 0x620057                       ; 00479fc0 | = "// numTextures,numTris,numVerts,numPa..." | s_numTextures_numTris_numV_00620057 = // numTextures,numTris,numVerts,numParts,numFrames,numLights,numCameras

        ;   Label: LAB_00479fc0
    MOV EAX,dword ptr [ESP + 0x13c]     ; 00479fc5
    PUSH EAX                            ; 00479fcc
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00479fcd | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH EBX                            ; 00479ff1
    PUSH 0x6200a0                       ; 00479ff2 | = "%d,%d,%d,1,%d,0,0\n" | s_d_d_d_1_d_0_0_006200a0 = %d,%d,%d,1,%d,0,0

    MOV EDI,dword ptr [ESP + 0x14c]     ; 00479ff7
    PUSH EDI                            ; 00479ffe
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00479fff | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH 0x0                            ; 0047a010
    PUSH ESI                            ; 0047a012
    CALL crt_string.c_splitpath_FUN_005ff178 ; 0047a013 | void crt_string.c_splitpath_FUN_005ff178(char * path, char * drive, char * dir, char * fname, ...)
        ;   XREF to: 005ff178 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0047a018
    PUSH 0x6200b3                       ; 0047a01b | = "// partList: firstVert,numVerts,first..." | s_partList_firstVert_numVe_006200b3 = // partList: firstVert,numVerts,firstTri,numTris,"name"

    PUSH EDI                            ; 0047a020
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0047a021 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDX                            ; 0047a03c
    PUSH 0x6200ec                       ; 0047a03d | = "0,%d,0,%d,\"%s\"\n" | s_s_0_d_0_d_s_006200ec = 0,%d,0,%d,"%s"

    PUSH EDI                            ; 0047a042
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0047a043 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0047a048
    PUSH 0x6200fc                       ; 0047a04b | = "// texture list: name\n" | s_texture_list_name_006200fc = // texture list: name

    PUSH EDI                            ; 0047a050
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0047a051 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JLE 0x0047a0a0                      ; 0047a06c | LAB_0047a0a0
    ...
    PUSH EDI                            ; 0047a081
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0047a082 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JL 0x0047a07b                       ; 0047a09d | LAB_0047a07b
        ;   XREF to: 0047a07b (CONDITIONAL_JUMP)
    NOP                                 ; 0047a09f
    PUSH 0x620117                       ; 0047a0a0 | = "// triList: materialIndex,vertices(in..." | s_triList_materialIndex_ve_00620117 = // triList: materialIndex,vertices(index, texX, texY)

        ;   Label: LAB_0047a0a0
    MOV ECX,dword ptr [ESP + 0x13c]     ; 0047a0a5
    PUSH ECX                            ; 0047a0ac
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0047a0ad | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JLE 0x0047a2c0                      ; 0047a0cd | LAB_0047a2c0
    ...
    JGE 0x0047a27a                      ; 0047a106 | LAB_0047a27a
    ...
    MOVSD ES:EDI,ESI                    ; 0047a135
    MOVSD ES:EDI,ESI                    ; 0047a136
    MOVSD ES:EDI,ESI                    ; 0047a137
    LEA EDI,[ESP + 0x110]               ; 0047a138
    LEA ESI,[EBX + 0x18]                ; 0047a13f
    MOVSD ES:EDI,ESI                    ; 0047a142
    MOVSD ES:EDI,ESI                    ; 0047a143
    MOVSD ES:EDI,ESI                    ; 0047a144
    LEA EDI,[ESP + 0x11c]               ; 0047a145
    LEA ESI,[EBX + 0x24]                ; 0047a14c
    MOVSD ES:EDI,ESI                    ; 0047a14f
    MOVSD ES:EDI,ESI                    ; 0047a150
    MOVSD ES:EDI,ESI                    ; 0047a151
    MOV EAX,dword ptr [ESP + 0x124]     ; 0047a152
    ...
    FMUL double ptr [0x0062021b]        ; 0047a171 | double DOUBLE_0062021b
    MOV dword ptr [ESP + 0x148],EAX     ; 0047a177
    FILD dword ptr [ESP + 0x148]        ; 0047a17e
    FMUL double ptr [0x0062021b]        ; 0047a185 | double DOUBLE_0062021b
    FXCH                                ; 0047a18b
    ...
    FMUL double ptr [0x0062021b]        ; 0047a1bd | double DOUBLE_0062021b
    MOV dword ptr [ESP + 0x15c],EAX     ; 0047a1c3
    FILD dword ptr [ESP + 0x15c]        ; 0047a1ca
    FMUL double ptr [0x0062021b]        ; 0047a1d1 | double DOUBLE_0062021b
    FXCH                                ; 0047a1d7
    ...
    FMUL double ptr [0x0062021b]        ; 0047a209 | double DOUBLE_0062021b
    MOV dword ptr [ESP + 0x170],EAX     ; 0047a20f
    FILD dword ptr [ESP + 0x170]        ; 0047a216
    FMUL double ptr [0x0062021b]        ; 0047a21d | double DOUBLE_0062021b
    FXCH                                ; 0047a223
    ...
    PUSH EDX                            ; 0047a24e
    PUSH 0x62014e                       ; 0047a24f | = "%d, %d,%g,%g, %d,%g,%g, %d,%g,%g\n" | s_d_d_g_g_d_g_g_d_g_g_0062014e = %d, %d,%g,%g, %d,%g,%g, %d,%g,%g

    MOV ECX,dword ptr [ESP + 0x17c]     ; 0047a254
    PUSH ECX                            ; 0047a25b
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0047a25c | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JL 0x0047a124                       ; 0047a274 | LAB_0047a124
    ...
    JL 0x0047a0e1                       ; 0047a2ba | LAB_0047a0e1
        ;   XREF to: 0047a0e1 (CONDITIONAL_JUMP)
    PUSH 0x620170                       ; 0047a2c0 | = "// vertList: x,y,z\n" | s_vertList_x_y_z_00620170 = // vertList: x,y,z

        ;   Label: LAB_0047a2c0
    MOV EBX,dword ptr [ESP + 0x13c]     ; 0047a2c5
    PUSH EBX                            ; 0047a2cc
    XOR EBP,EBP                         ; 0047a2cd
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0047a2cf | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JGE 0x0047a364                      ; 0047a2f9 | LAB_0047a364
        ;   XREF to: 0047a364 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EDX + 0x10c]     ; 0047a2fb
    FLD double ptr [0x00620213]         ; 0047a301 | double DOUBLE_00620213
    ...
    PUSH 0x620184                       ; 0047a32a | = "%g,%g,%g\n" | s_g_g_g_00620184 = %g,%g,%g

    MOV EAX,dword ptr [ESP + 0x150]     ; 0047a32f
    PUSH EAX                            ; 0047a336
    ADD EBX,0xc                         ; 0047a337
    INC EBP                             ; 0047a33a
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0047a33b | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x20                        ; 0047a340
    JMP 0x0047a2da                      ; 0047a343 | LAB_0047a2da
        ;   XREF to: 0047a2da (UNCONDITIONAL_JUMP)
    PUSH ESI                            ; 0047a345
        ;   Label: LAB_0047a345
    PUSH 0x620031                       ; 0047a346 | = "Can't create %s" | s_Can_t_create_s_00620031 = Can't create %s
    MOV EBX,dword ptr [0x00678a60]      ; 0047a34b | CEditorTools * g_CEditorToolsPtr
    PUSH EBX                            ; 0047a351 | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_showError_FUN_0049e740 ; 0047a352 | void shape_edittool.cpp_CEditorTools_showError_FUN_0049e740(CEditorTools * this_ptr, char * format)
    ...
    POP EBX                             ; 0047a362
    RET                                 ; 0047a363
    PUSH 0x62018e                       ; 0047a364 | = "// lightList: \"name\", type, x,y,z, ..." | s_lightList_name_type_x_y__0062018e = // lightList: "name", type, x,y,z, r,g,b, (type-specific info)

        ;   Label: LAB_0047a364
    MOV EBX,dword ptr [ESP + 0x138]     ; 0047a369
    PUSH EBX                            ; 0047a370
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0047a371 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0047a376
    PUSH 0x6201ce                       ; 0047a379 | = "// cameraList: \"name\", x,y,z, p,b,h..." | s_cameraList_name_x_y_z_p__006201ce = // cameraList: "name", x,y,z, p,b,h, fov(rad)

    PUSH EBX                            ; 0047a37e
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0047a37f | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0047a384
    PUSH 0x7a0                          ; 0047a387
    PUSH 0x6201fd                       ; 0047a38c | = "..\\core\\dmodel.cpp" | s_core_dmodel_cpp_006201fd = ..\core\dmodel.cpp
    PUSH EBX                            ; 0047a391
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 0047a392 | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
