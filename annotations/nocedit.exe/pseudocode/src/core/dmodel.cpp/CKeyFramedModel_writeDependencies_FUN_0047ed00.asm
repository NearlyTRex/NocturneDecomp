...
;   core_boxactor.cpp_FUN_00422900 at 00422938
...
section .text
    ...
    JLE 0x0047edb8                      ; 0047ed1b | LAB_0047edb8
    ...
    CMP AL,0x0                          ; 0047ed32
    JZ 0x0047ed46                       ; 0047ed34 | LAB_0047ed46
    ...
    CMP AL,0x0                          ; 0047ed42
    JNZ 0x0047ed2e                      ; 0047ed44 | LAB_0047ed2e
    ...
    MOV AL,byte ptr [ESI]               ; 0047ed49
        ;   Label: LAB_0047ed49
    CMP AL,DL                           ; 0047ed4b
    JZ 0x0047ed61                       ; 0047ed4d | LAB_0047ed61
        ;   XREF to: 0047ed61 (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 0047ed4f
    JZ 0x0047ed5f                       ; 0047ed51 | LAB_0047ed5f
        ;   XREF to: 0047ed5f (CONDITIONAL_JUMP)
    INC ESI                             ; 0047ed53
    MOV AL,byte ptr [ESI]               ; 0047ed54
    CMP AL,DL                           ; 0047ed56
    JZ 0x0047ed61                       ; 0047ed58 | LAB_0047ed61
        ;   XREF to: 0047ed61 (CONDITIONAL_JUMP)
    INC ESI                             ; 0047ed5a
    CMP AL,0x0                          ; 0047ed5b
    JNZ 0x0047ed49                      ; 0047ed5d | LAB_0047ed49
        ;   XREF to: 0047ed49 (CONDITIONAL_JUMP)
    SUB ESI,ESI                         ; 0047ed5f
        ;   Label: LAB_0047ed5f
    TEST ESI,ESI                        ; 0047ed61
        ;   Label: LAB_0047ed61
    JNZ 0x0047edc3                      ; 0047ed63 | LAB_0047edc3
        ;   XREF to: 0047edc3 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0xe4],0x0      ; 0047ed65
        ;   Label: LAB_0047ed65
    JNZ 0x0047ed87                      ; 0047ed6d | LAB_0047ed87
        ;   XREF to: 0047ed87 (CONDITIONAL_JUMP)
    MOV ESI,ESP                         ; 0047ed6f
    PUSH ESI                            ; 0047ed71
    PUSH 0x620f0b                       ; 0047ed72 | = "ART\\%s.RAW\n" | s_ART_s_RAW_00620f0b = ART\%s.RAW

    MOV EDX,dword ptr [ESP + 0xe8]      ; 0047ed77
    PUSH EDX                            ; 0047ed7e
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0047ed7f | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0047ed84
    MOV ESI,ESP                         ; 0047ed87
        ;   Label: LAB_0047ed87
    PUSH ESI                            ; 0047ed89
    PUSH 0x620f17                       ; 0047ed8a | = "ART\\%s.ACT\n" | s_ART_s_ACT_00620f17 = ART\%s.ACT

    MOV ECX,dword ptr [ESP + 0xe8]      ; 0047ed8f
    PUSH ECX                            ; 0047ed96
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0047ed97 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JL 0x0047ed27                       ; 0047edb2 | LAB_0047ed27
    ...
    MOV byte ptr [ESI],0x0              ; 0047edc3
        ;   Label: LAB_0047edc3
    JMP 0x0047ed65                      ; 0047edc6 | LAB_0047ed65
