...
;                               FUNCTION
; *****************************************************************************
; __cdecl CFlashlight * __cdecl core_flashlit_cpp_CFlashlight_ctor_FUN_004cbbc0(CFlashlight *this_ptr)
;
; Parameters:
; CFlashlight *    Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_flashlit.cpp_factoryFunc_FUN_004cbb80 at 004cbb9a
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004cbbc0
        ;   Label: core_flashlit.cpp_CFlashlight_ctor_FUN_004cbbc0
    MOV EDX,dword ptr [ESP + 0x8]       ; 004cbbc1
    PUSH EDX                            ; 004cbbc5
    CALL core_weapon.cpp_CWeapon_ctor_FUN_005ede70 ; 004cbbc6
    ...
    PUSH 0x62a3c9                       ; 004cbbce | = "flashlit.kfm"
    MOV EBX,EAX                         ; 004cbbd3
    ADD EAX,0x158                       ; 004cbbd5
    PUSH EAX                            ; 004cbbda
    MOV dword ptr [EAX + -0x4],0x65e3d4 ; 004cbbdb | g_CFlashlightVTable
    CALL core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0 ; 004cbbe2
    ...
    FLD float ptr [0x0065e3cc]          ; 004cbc19 | FLOAT_0065e3cc
