...

{
  ...
  fVar18 = (float10)-(fVar3 * fVar4 - fVar12 * fVar8) * (float10)fVar13;
  fVar19 = (float10)fVar2 * (float10)fVar13;
  dVar21 = crt_math_c_round_FUN_005fe6b0((double)(fVar5 * fVar13));
  *(int *)(extraout_EAX + 0x19c) = (int)ROUND(dVar21);
  fVar20 = (float10)fVar1 * (float10)6.319857e-39;
  dVar21 = crt_math_c_round_FUN_005fe6b0((double)fVar14);
  *(int *)(extraout_EAX_00 + 0x1a0) = (int)ROUND(dVar21);
  ...
  dVar21 = crt_math_c_round_FUN_005fe6b0((double)fVar14);
  *(int *)(extraout_EAX_01 + 0x1a4) = (int)ROUND(fVar15);
  *(int *)(extraout_EAX_01 + 0x1a8) = (int)ROUND(fVar16);
  *(int *)(extraout_EAX_01 + 0x1ac) = (int)ROUND(fVar17);
  *(int *)(extraout_EAX_01 + 0x1b0) = (int)ROUND(fVar18);
  *(int *)(extraout_EAX_01 + 0x1b4) = (int)ROUND(fVar19);
  *(int *)(extraout_EAX_01 + 0x1b8) = (int)ROUND(fVar20);
  *(int *)(extraout_EAX_01 + 0x1bc) = (int)ROUND(dVar21);
  return;
}
