...
section .text
    ...
    PUSH 0x61a491                       ; 00453f1b | = "fogR,fogG,fogB\n" | s_fogR_fogG_fogB_0061a491 = fogR,fogG,fogB

    PUSH ESI                            ; 00453f20
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00453f21 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    PUSH EDI                            ; 00453f33
    PUSH 0x61a4a1                       ; 00453f34 | = "%d,%d,%d\n" | s_d_d_d_0061a4a1 = %d,%d,%d

    PUSH ESI                            ; 00453f39
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00453f3a | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 00453f3f
    PUSH 0x61a4ab                       ; 00453f42 | = "fogVel\n" | s_fogVel_0061a4ab = fogVel

    PUSH ESI                            ; 00453f47
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00453f48 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH 0x61a4b3                       ; 00453f6b | = "%f,%f,%f\n" | s_f_f_f_0061a4b3 = %f,%f,%f

    PUSH ESI                            ; 00453f70
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00453f71 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 00453f90
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00453f91 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 00453fa7
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00453fa8 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
