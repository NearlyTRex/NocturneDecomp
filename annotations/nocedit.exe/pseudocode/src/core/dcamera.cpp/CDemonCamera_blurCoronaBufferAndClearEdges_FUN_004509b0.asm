...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dcamera.cpp_CDemonCamera_blurCoronaBufferAndClearEdges_FUN_004509b0(CDemonCamera * this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EAX,0xbbb9b8                    ; 004509bb | char[241][320] g_CoronaBlurWorkBuffer
    MOV EBP,0xba8c78                    ; 004509c0 | char[241][320] g_CoronaBlurOutputBuffer
    MOV EDI,0x1                         ; 004509c5
    ADD EAX,0x140                       ; 004509ca
        ;   Label: LAB_004509ca
    ADD EBP,0x140                       ; 004509cf
    MOV dword ptr [ESP],EAX             ; 004509d5 | DAT_00bbbaf8
    MOV EAX,dword ptr [ESI + 0x154]     ; 004509d8
    DEC EAX                             ; 004509de
    CMP EDI,EAX                         ; 004509df
    JL 0x00450a68                       ; 004509e1 | LAB_00450a68
        ;   XREF to: 00450a68 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [ESI + 0x154]     ; 004509e7
    XOR EDX,EDX                         ; 004509ed
    TEST ECX,ECX                        ; 004509ef
    JLE 0x00450a20                      ; 004509f1 | LAB_00450a20
        ;   XREF to: 00450a20 (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 004509f3
    XOR BL,BL                           ; 004509f5
        ;   Label: LAB_004509f5
    MOV byte ptr [EAX + 0xbbb9b8],BL    ; 004509f7 | char[241][320] g_CoronaBlurWorkBuffer
    MOV EDI,dword ptr [ESI + 0x150]     ; 004509fd
    MOV byte ptr [EDI + EAX*0x1 + 0xbbb9b7],BL ; 00450a03 | DAT_00bbb9b7
    INC EDX                             ; 00450a0a
    MOV ECX,dword ptr [ESI + 0x154]     ; 00450a0b
    ADD EAX,0x140                       ; 00450a11
    CMP EDX,ECX                         ; 00450a16
    JL 0x004509f5                       ; 00450a18 | LAB_004509f5
    ...
    JLE 0x00450a60                      ; 00450a2a | LAB_00450a60
        ;   XREF to: 00450a60 (CONDITIONAL_JUMP)
    XOR CL,CL                           ; 00450a2c
        ;   Label: LAB_00450a2c
    MOV byte ptr [EAX + 0xbbb9b8],CL    ; 00450a2e | char[241][320] g_CoronaBlurWorkBuffer
    MOV EDX,dword ptr [ESI + 0x154]     ; 00450a34
    DEC EDX                             ; 00450a3a
    IMUL EDX,EDX,0x140                  ; 00450a3b
    MOV byte ptr [EDX + EAX*0x1 + 0xbbb9b8],CL ; 00450a41 | char[241][320] g_CoronaBlurWorkBuffer
    INC EAX                             ; 00450a48
    CMP EAX,dword ptr [ESI + 0x150]     ; 00450a49
    JL 0x00450a2c                       ; 00450a4f | LAB_00450a2c
    ...
    CALL core_dstrender.cpp_verticalBlur3TapMMXStride320_FUN_00492042 ; 00450a75 | void core_dstrender.cpp_verticalBlur3TapMMXStride320_FUN_00492042(ulonglong * output_buffer, ulonglong * input_buffer, int pixel_count)
        ;   XREF to: 00492042 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00450a7a
    MOV EAX,dword ptr [ESP]             ; 00450a7d
    INC EDI                             ; 00450a80
    JMP 0x004509ca                      ; 00450a81 | LAB_004509ca
