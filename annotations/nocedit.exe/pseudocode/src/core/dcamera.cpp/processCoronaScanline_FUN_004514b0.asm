...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dcamera.cpp_processCoronaScanline_FUN_004514b0(int row, int x_start, int x_end, SCorona * corona_buffer)
;
; Parameters:
; int              Stack[0x4]:4   row
...
section .text
    ...
    MOV ECX,0x902f74                    ; 004514c3 | CVector3i[15360] g_PrecomputedWorldPositions
    ...
    MOV EDX,0x1577728                   ; 004514eb | int[240][320] g_CoronaDepthBuffer
    ...
    MOV CL,byte ptr [0x013bc260]        ; 00451500 | int g_CameraDownscaleIterations
    ...
    SHL EAX,CL                          ; 00451514
    SHL EDX,CL                          ; 00451516
    MOV EAX,dword ptr [EAX*0x4 + 0x2cf7d5c] ; 00451518 | uint *[1024] g_ZBufferScanlineArray
    ...
    JGE 0x00451684                      ; 00451556 | LAB_00451684
    ...
    MOV EDX,dword ptr [0x015c4170]      ; 004515ab | CDemonGlobe * g_CurrentGlobe
    MOV EBP,dword ptr [EDX + 0xc]       ; 004515b1
    MOV EBX,EAX                         ; 004515b4
    CMP EAX,EBP                         ; 004515b6
    JGE 0x0045162e                      ; 004515b8 | LAB_0045162e
        ;   XREF to: 0045162e (CONDITIONAL_JUMP)
    ...
    MOV EDX,dword ptr [0x015c4170]      ; 004515cb | CDemonGlobe * g_CurrentGlobe
    CMP EAX,dword ptr [EDX + 0xc]       ; 004515d1
    JGE 0x0045162e                      ; 004515d4 | LAB_0045162e
        ;   XREF to: 0045162e (CONDITIONAL_JUMP)
    ...
    MOV CL,byte ptr [0x013bc260]        ; 00451642 | int g_CameraDownscaleIterations
    ...
    JL 0x0045155c                       ; 0045167e | LAB_0045155c
    ...
    JGE 0x004516c5                      ; 004516ba | LAB_004516c5
        ;   XREF to: 004516c5 (CONDITIONAL_JUMP)
    CMP byte ptr [ECX],0x0              ; 004516bc
        ;   Label: LAB_004516bc
    JZ 0x004517d4                       ; 004516bf | LAB_004517d4
    ...
    JLE 0x004516f3                      ; 004516e6 | LAB_004516f3
        ;   XREF to: 004516f3 (CONDITIONAL_JUMP)
    CMP byte ptr [ECX],0x0              ; 004516e8
        ;   Label: LAB_004516e8
    JNZ 0x004516f3                      ; 004516eb | LAB_004516f3
        ;   XREF to: 004516f3 (CONDITIONAL_JUMP)
    DEC EDX                             ; 004516ed
    DEC ECX                             ; 004516ee
    CMP EDX,EAX                         ; 004516ef
    JG 0x004516e8                       ; 004516f1 | LAB_004516e8
    ...
    POP EBX                             ; 0045170f
    RET                                 ; 00451710
    MOV EBP,dword ptr [0x015c4178]      ; 00451711 | int g_CoronaTargetX
        ;   Label: LAB_00451711
    MOV EAX,[0x015c417c]                ; 00451717 | int g_CoronaTargetY
    MOV EDI,dword ptr [0x015c4180]      ; 0045171c | int g_CoronaTargetDepth
    XOR EDX,EDX                         ; 00451722
    MOV dword ptr [ESP],EAX             ; 00451724
    MOV dword ptr [ESP + 0x4],EDX       ; 00451727
    TEST ECX,ECX                        ; 0045172b
    JZ 0x004517a1                       ; 0045172d | LAB_004517a1
    ...
    MOV ESI,dword ptr [EDI + ESI*0x4 + 0xbce6f8] ; 0045178a | int[76800] g_PrecomputedDepthBuffer
    LEA EDI,[ECX + -0x80]               ; 00451791
    CMP ESI,EDI                         ; 00451794
    JGE 0x004517a8                      ; 00451796 | LAB_004517a8
        ;   XREF to: 004517a8 (CONDITIONAL_JUMP)
    TEST EAX,EAX                        ; 00451798
    JNZ 0x004517c4                      ; 0045179a | LAB_004517c4
        ;   XREF to: 004517c4 (CONDITIONAL_JUMP)
    JMP 0x00451609                      ; 0045179c | LAB_00451609
        ;   XREF to: 00451609 (UNCONDITIONAL_JUMP)
    MOV ECX,0x7fffffff                  ; 004517a1
        ;   Label: LAB_004517a1
    JMP 0x0045173d                      ; 004517a6 | LAB_0045173d
    ...
    JG 0x0045177a                       ; 004517b9 | LAB_0045177a
        ;   XREF to: 0045177a (CONDITIONAL_JUMP)
    TEST EAX,EAX                        ; 004517bb
    JNZ 0x004517c4                      ; 004517bd | LAB_004517c4
        ;   XREF to: 004517c4 (CONDITIONAL_JUMP)
    JMP 0x00451609                      ; 004517bf | LAB_00451609
        ;   XREF to: 00451609 (UNCONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x4],0x0       ; 004517c4
        ;   Label: LAB_004517c4
    JNZ 0x00451609                      ; 004517c9 | LAB_00451609
        ;   XREF to: 00451609 (CONDITIONAL_JUMP)
    JMP 0x0045162e                      ; 004517cf | LAB_0045162e
        ;   XREF to: 0045162e (UNCONDITIONAL_JUMP)
    INC EAX                             ; 004517d4
        ;   Label: LAB_004517d4
    INC ECX                             ; 004517d5
    CMP EAX,EDX                         ; 004517d6
    JL 0x004516bc                       ; 004517d8 | LAB_004516bc
        ;   XREF to: 004516bc (CONDITIONAL_JUMP)
    JMP 0x004516c5                      ; 004517de | LAB_004516c5
