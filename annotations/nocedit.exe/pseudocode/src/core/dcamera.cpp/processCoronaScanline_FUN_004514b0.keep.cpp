...

{
  ...
  do {
    ...
    if ((((*puVar13 < (uint)*piVar14) &&
         (uVar2 = pCVar6->x - (g_CurrentGlobe->position_scaled).x,
         iVar3 = ABS((int)uVar2), iVar3 < g_CurrentGlobe->linear_radius_scaled)) &&
        (uVar3 = pCVar6->y - (g_CurrentGlobe->position_scaled).y,
        iVar4 = ABS((int)uVar3), iVar4 < g_CurrentGlobe->linear_radius_scaled)) &&
       ((uVar3 = pCVar6->z - (g_CurrentGlobe->position_scaled).z,
        iVar5 = ABS((int)uVar3), iVar5 < g_CurrentGlobe->linear_radius_scaled &&
