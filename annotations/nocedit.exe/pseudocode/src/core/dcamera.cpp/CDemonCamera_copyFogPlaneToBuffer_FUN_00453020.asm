...
section .text
    ...
    JGE 0x0045308a                      ; 00453053 | LAB_0045308a
    ...
    JGE 0x00453081                      ; 0045306e | LAB_00453081
        ;   XREF to: 00453081 (CONDITIONAL_JUMP)
    INC EAX                             ; 00453070
    MOV BL,byte ptr [ECX + 0x13da778]   ; 00453071 | DAT_013da8b9
    INC ECX                             ; 00453077
    INC EDX                             ; 00453078
    MOV byte ptr [EAX + 0x13ed377],BL   ; 00453079 | DAT_013ed377 | DAT_013ed379
    JMP 0x00453065                      ; 0045307f | LAB_00453065
        ;   XREF to: 00453065 (UNCONDITIONAL_JUMP)
    INC EDI                             ; 00453081
        ;   Label: LAB_00453081
    ADD EBP,0x140                       ; 00453082
    JMP 0x0045304a                      ; 00453088 | LAB_0045304a
        ;   XREF to: 0045304a (UNCONDITIONAL_JUMP)
    MOV EDX,dword ptr [ESI + 0x154]     ; 0045308a
        ;   Label: LAB_0045308a
    XOR EAX,EAX                         ; 00453090
    TEST EDX,EDX                        ; 00453092
    JLE 0x004530f0                      ; 00453094 | LAB_004530f0
    ...
    IMUL EBX,EAX,0x140                  ; 004530ad
        ;   Label: LAB_004530ad
    MOV CL,byte ptr [EBX + 0x13da778]   ; 004530b3 | DAT_013da8b8 | g_CameraPlaneWorkBuffer
    MOV byte ptr [EDX + 0x13ed378],CL   ; 004530b9 | SFogImagePlane[16] g_CameraImageDecompressBuffer | DAT_013ed4b8
    MOV ECX,dword ptr [ESI + 0x150]     ; 004530bf
    MOV BL,byte ptr [ECX + EBX*0x1 + 0x13da777] ; 004530c5 | DAT_013da774+3
    ...
    JL 0x004530ad                       ; 004530e2 | LAB_004530ad
    ...
    JGE 0x00452f72                      ; 0045311e | LAB_00452f72
        ;   XREF to: 00452f72 (CONDITIONAL_JUMP)
    MOV BL,byte ptr [EAX + 0x13da778]   ; 00453124 | DAT_013da779
    MOV byte ptr [EDX + 0x13ed378],BL   ; 0045312a | SFogImagePlane[16] g_CameraImageDecompressBuffer | DAT_013ed379
    ...
    MOV BL,byte ptr [EBX + 0x13da778]   ; 00453143 | DAT_013da779
    INC EDX                             ; 00453149
    MOV byte ptr [ECX + EAX*0x1 + 0x13ed377],BL ; 0045314a | DAT_013ed379
    JMP 0x00453114                      ; 00453151 | LAB_00453114
