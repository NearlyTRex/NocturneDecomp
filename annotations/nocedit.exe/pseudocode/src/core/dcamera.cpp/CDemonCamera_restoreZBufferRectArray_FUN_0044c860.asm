...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dcamera.cpp_CDemonCamera_restoreZBufferRectArray_FUN_0044c860(CDemonCamera * this_ptr)
;
; Parameters:
...
;
; XREF[2]:
;   core_msnedit.cpp_PrepareMissionMaybe_FUN_005390f0 at 00539541
...
section .text
    ...
    MOV EDX,dword ptr [0x02d03e94]      ; 0044c867 | int g_UseExternalRenderer
    TEST EDX,EDX                        ; 0044c86d
    JNZ 0x0044caa0                      ; 0044c86f | LAB_0044caa0
    ...
    JL 0x0044cafd                       ; 0044c89d | LAB_0044cafd
    ...
    JGE 0x0044cb08                      ; 0044c8b2 | LAB_0044cb08
        ;   XREF to: 0044cb08 (CONDITIONAL_JUMP)
    CMP dword ptr [EAX + 0x8],0x0       ; 0044c8b8
        ;   Label: LAB_0044c8b8
    JL 0x0044cb13                       ; 0044c8bc | LAB_0044cb13
    ...
    JL 0x0044c8d9                       ; 0044c8d1 | LAB_0044c8d9
    ...
    JL 0x0044c897                       ; 0044c8e9 | LAB_0044c897
    ...
    JLE 0x0044c93c                      ; 0044c909 | LAB_0044c93c
    ...
    JLE 0x0044c91b                      ; 0044c917 | LAB_0044c91b
    ...
    JLE 0x0044c92a                      ; 0044c924 | LAB_0044c92a
    ...
    JL 0x0044c910                       ; 0044c93a | LAB_0044c910
    ...
    JG 0x0044ca98                       ; 0044c946 | LAB_0044ca98
    ...
    MOV dword ptr [0x0151a3ac],ECX      ; 0044c970 | int g_ScanlineSpanCount
    TEST ESI,ESI                        ; 0044c976
    JLE 0x0044ca00                      ; 0044c978 | LAB_0044ca00
    ...
    JL 0x0044c9e6                       ; 0044c98f | LAB_0044c9e6
        ;   XREF to: 0044c9e6 (CONDITIONAL_JUMP)
    CMP EAX,dword ptr [EDI + 0xc]       ; 0044c991
    JG 0x0044c9e6                       ; 0044c994 | LAB_0044c9e6
        ;   XREF to: 0044c9e6 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [0x0151a3ac]      ; 0044c996 | int g_ScanlineSpanCount
    XOR ECX,ECX                         ; 0044c99c
    TEST EBX,EBX                        ; 0044c99e
    JLE 0x0044c9c1                      ; 0044c9a0 | LAB_0044c9c1
        ;   XREF to: 0044c9c1 (CONDITIONAL_JUMP)
    LEA ESI,[EBX*0x4 + 0x0]             ; 0044c9a2
    XOR EAX,EAX                         ; 0044c9a9
    MOV EBX,dword ptr [EDX + 0x4]       ; 0044c9ab
        ;   Label: LAB_0044c9ab
    CMP EBX,dword ptr [EAX + 0x151a3b0] ; 0044c9ae | int[256] g_ScanlineSpanLeft
    JGE 0x0044cb1f                      ; 0044c9b4 | LAB_0044cb1f
        ;   XREF to: 0044cb1f (CONDITIONAL_JUMP)
    ADD EAX,0x4                         ; 0044c9ba
        ;   Label: LAB_0044c9ba
    CMP EAX,ESI                         ; 0044c9bd
    JL 0x0044c9ab                       ; 0044c9bf | LAB_0044c9ab
        ;   XREF to: 0044c9ab (CONDITIONAL_JUMP)
    TEST ECX,ECX                        ; 0044c9c1
        ;   Label: LAB_0044c9c1
    JNZ 0x0044c9e6                      ; 0044c9c3 | LAB_0044c9e6
        ;   XREF to: 0044c9e6 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EDX]             ; 0044c9c5
    MOV dword ptr [EBP + 0x151a3b0],EAX ; 0044c9c7 | int[256] g_ScanlineSpanLeft
    MOV EAX,dword ptr [EDX + 0x4]       ; 0044c9cd
    MOV EDX,dword ptr [0x0151a3ac]      ; 0044c9d0 | int g_ScanlineSpanCount
    ADD EBP,0x4                         ; 0044c9d6
    INC EDX                             ; 0044c9d9
    MOV dword ptr [EBP + 0x151a7ac],EAX ; 0044c9da | int[256] g_ScanlineSpanRight
    MOV dword ptr [0x0151a3ac],EDX      ; 0044c9e0 | int g_ScanlineSpanCount
    ...
    JL 0x0044c984                       ; 0044c9fe | LAB_0044c984
        ;   XREF to: 0044c984 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [0x0151a3ac]      ; 0044ca00 | int g_ScanlineSpanCount
        ;   Label: LAB_0044ca00
    XOR EDI,EDI                         ; 0044ca06
    TEST EBX,EBX                        ; 0044ca08
    JLE 0x0044ca78                      ; 0044ca0a | LAB_0044ca78
        ;   XREF to: 0044ca78 (CONDITIONAL_JUMP)
    MOV EBP,dword ptr [ESP + 0x14]      ; 0044ca0c
    XOR ESI,ESI                         ; 0044ca10
    MOV EAX,dword ptr [ESI + 0x151a3b0] ; 0044ca12 | int[256] g_ScanlineSpanLeft
        ;   Label: LAB_0044ca12
    MOV EDX,dword ptr [EBP + 0x2cf7d5c] ; 0044ca18 | uint *[1024] g_ZBufferScanlineArray
    ...
    ADD EAX,dword ptr [ESI + 0x151a3b0] ; 0044ca33 | int[256] g_ScanlineSpanLeft
    LEA EDX,[EAX*0x4 + 0x0]             ; 0044ca39
    MOV EAX,dword ptr [ESP + 0x38]      ; 0044ca40
    MOV EAX,dword ptr [EAX + 0x15c]     ; 0044ca44
    MOV EBX,dword ptr [ESI + 0x151a3b0] ; 0044ca4a | int[256] g_ScanlineSpanLeft
    ADD EDX,EAX                         ; 0044ca50
    MOV EAX,dword ptr [ESI + 0x151a7b0] ; 0044ca52 | int[256] g_ScanlineSpanRight
    ...
    INC EDI                             ; 0044ca66
    CALL core_dstrender.cpp_memcpyMMX_FUN_00492001 ; 0044ca67 | void * core_dstrender.cpp_memcpyMMX_FUN_00492001(void * dest, void * src, int byte_count)
        ;   XREF to: 00492001 (UNCONDITIONAL_CALL)
    MOV EAX,[0x0151a3ac]                ; 0044ca6c | int g_ScanlineSpanCount
    ADD ESP,0xc                         ; 0044ca71
    CMP EDI,EAX                         ; 0044ca74
    JL 0x0044ca12                       ; 0044ca76 | LAB_0044ca12
    ...
    JLE 0x0044c960                      ; 0044ca92 | LAB_0044c960
    ...
    POP EBX                             ; 0044ca9e
    RET                                 ; 0044ca9f
    MOV EAX,[0x00679398]                ; 0044caa0 | int g_WindowHeight
        ;   Label: LAB_0044caa0
    DEC EAX                             ; 0044caa5
    PUSH EAX                            ; 0044caa6
    MOV EAX,[0x00679394]                ; 0044caa7 | int g_WindowWidth
    DEC EAX                             ; 0044caac
    PUSH EAX                            ; 0044caad
    PUSH 0x0                            ; 0044caae
    PUSH 0x0                            ; 0044cab0
    PUSH 0x0                            ; 0044cab2
    CALL wincore_windll.cpp_restoreZBuffer_FUN_005b7d20 ; 0044cab4 | int wincore_windll.cpp_restoreZBuffer_FUN_005b7d20(int left, int top, int mode, int right, ...)
    ...
    PUSH EAX                            ; 0044caec
    CALL core_dcamera.cpp_CDemonCamera_restoreZBufferRect_FUN_0044c780 ; 0044caed | void core_dcamera.cpp_CDemonCamera_restoreZBufferRect_FUN_0044c780(CDemonCamera * this_ptr, CRect * rect_ptr)
    ...
    JLE 0x0044cb6f                      ; 0044cb62 | LAB_0044cb6f
        ;   XREF to: 0044cb6f (CONDITIONAL_JUMP)
    MOV dword ptr [EAX + 0x151a7b0],EBX ; 0044cb64 | DAT_0151a7b4
    JMP 0x0044c9e6                      ; 0044cb6a | LAB_0044c9e6
        ;   XREF to: 0044c9e6 (UNCONDITIONAL_JUMP)
    TEST ECX,ECX                        ; 0044cb6f
        ;   Label: LAB_0044cb6f
    JNZ 0x0044c9c1                      ; 0044cb71 | LAB_0044c9c1
        ;   XREF to: 0044c9c1 (CONDITIONAL_JUMP)
    JMP 0x0044c9ba                      ; 0044cb77 | LAB_0044c9ba
