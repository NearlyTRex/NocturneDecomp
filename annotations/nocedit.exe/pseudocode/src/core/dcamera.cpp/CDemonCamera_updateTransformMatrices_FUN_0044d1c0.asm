...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dcamera.cpp_CDemonCamera_updateTransformMatrices_FUN_0044d1c0(CDemonCamera * this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV ESI,dword ptr [0x02d052e8]      ; 0044d1ca | CMatrix3x3i g_TransformMatrix
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 0044d224 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    MOV dword ptr [EBX + 0x194],ESI     ; 0044d22a
    MOV ESI,dword ptr [0x02d05308]      ; 0044d230 | g_TransformMatrix[2][2]
    PUSH EDX                            ; 0044d236 | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EBX + 0x198],ESI     ; 0044d237
    LEA ESI,[ESP + 0x4]                 ; 0044d23d
    CALL engine_drender.cpp_CDemonRenderer_getCameraOriginToBuffer_FUN_0048c760 ; 0044d241 | void engine_drender.cpp_CDemonRenderer_getCameraOriginToBuffer_FUN_0048c760(CDemonRenderer * this_ptr, CVector3i * output)
    ...
    MOV ESI,dword ptr [0x02d02548]      ; 0044d256 | int g_ViewportCenterXFixed
    MOV dword ptr [EBX + 0x1c0],ESI     ; 0044d25c
    MOV ESI,dword ptr [0x02d0254c]      ; 0044d262 | int g_ViewportCenterYFixed
    MOV dword ptr [EBX + 0x1c4],ESI     ; 0044d268
    MOV ESI,dword ptr [0x02d02550]      ; 0044d26e | int g_ViewportRightFixed
    MOV dword ptr [EBX + 0x1c8],ESI     ; 0044d274
    MOV ESI,dword ptr [0x02d02554]      ; 0044d27a | int g_ViewportBottomFixed
    PUSH EBX                            ; 0044d280
    MOV dword ptr [EBX + 0x1cc],ESI     ; 0044d281
    CALL core_dcamera.cpp_CDemonCamera_calculateInverseTransform_FUN_0044cf20 ; 0044d287 | void core_dcamera.cpp_CDemonCamera_calculateInverseTransform_FUN_0044cf20(CDemonCamera * this_ptr)
