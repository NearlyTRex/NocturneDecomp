...
section .text
    ...
    MOV EBX,0x902f74                    ; 00451355 | CVector3i[15360] g_PrecomputedWorldPositions
    ...
    ADD EAX,0xba8c78                    ; 0045137c | char[241][320] g_CoronaBlurOutputBuffer
    LEA EBP,[EDX + EAX*0x1]             ; 00451381
    LEA EAX,[ESI*0x4 + 0x0]             ; 00451384
    ADD EAX,ESI                         ; 0045138b
    SHL EAX,0x8                         ; 0045138d
    SHL EDX,0x2                         ; 00451390
    ADD EAX,0x1577728                   ; 00451393 | int[240][320] g_CoronaDepthBuffer
    ADD EAX,EDX                         ; 00451398
    MOV CL,byte ptr [0x013bc260]        ; 0045139a | int g_CameraDownscaleIterations
    MOV dword ptr [ESP + 0x4],EAX       ; 004513a0
    MOV EAX,dword ptr [ESP + 0x24]      ; 004513a4
    SHL ESI,CL                          ; 004513a8
    SHL EAX,CL                          ; 004513aa
    MOV EDX,dword ptr [ESI*0x4 + 0x2cf7d5c] ; 004513ac | uint *[1024] g_ZBufferScanlineArray
    ...
    JGE 0x0045140e                      ; 004513c4 | LAB_0045140e
    ...
    JA 0x00451416                       ; 004513d2 | LAB_00451416
    ...
    MOV CL,byte ptr [0x013bc260]        ; 004513e5 | int g_CameraDownscaleIterations
    ...
    JL 0x004513c6                       ; 0045140c | LAB_004513c6
    ...
    POP EBX                             ; 00451414
    RET                                 ; 00451415
    MOV ECX,dword ptr [0x015c4170]      ; 00451416 | CDemonGlobe * g_CurrentGlobe
        ;   Label: LAB_00451416
    ...
    JGE 0x004513d4                      ; 0045142c | LAB_004513d4
        ;   XREF to: 004513d4 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [0x015c4170]      ; 0045142e | CDemonGlobe * g_CurrentGlobe
    ...
    JGE 0x004513d4                      ; 00451446 | LAB_004513d4
        ;   XREF to: 004513d4 (CONDITIONAL_JUMP)
    MOV EAX,[0x015c4170]                ; 00451448 | CDemonGlobe * g_CurrentGlobe
    ...
    JGE 0x004513d4                      ; 00451463 | LAB_004513d4
        ;   XREF to: 004513d4 (CONDITIONAL_JUMP)
    ...
    MOV ECX,dword ptr [0x015c4170]      ; 00451476 | CDemonGlobe * g_CurrentGlobe
    ADD EDX,ESI                         ; 0045147c
    MOV ESI,dword ptr [ECX + 0x10]      ; 0045147e
    ADD EAX,EDX                         ; 00451481
    CMP EAX,ESI                         ; 00451483
    JGE 0x004513d4                      ; 00451485 | LAB_004513d4
        ;   XREF to: 004513d4 (CONDITIONAL_JUMP)
    ...
    JMP 0x004513d4                      ; 004514a0 | LAB_004513d4
