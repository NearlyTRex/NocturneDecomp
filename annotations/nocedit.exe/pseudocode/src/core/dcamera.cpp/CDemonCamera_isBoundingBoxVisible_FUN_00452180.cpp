...

{
  ...
  local_f4.x = (int)ROUND(local_124 * 256f);
  local_f4.y = (int)ROUND(local_120 * 256f);
  local_f4.z = (int)ROUND(local_11c * 256f);
  local_78 = local_124;
  local_74 = local_120;
  local_60 = local_11c;
  ...
  local_dc.x = (int)ROUND(local_e8 * 256f);
  local_dc.y = (int)ROUND(local_e4 * 256f);
  local_dc.z = (int)ROUND(local_e0 * 256f);
  local_7c = local_e8;
  local_70 = local_e4;
  local_6c = local_e0;
  wincore_windll_cpp_transformAndProjectPoint_FUN_005b575c
  ...
  local_100.x = (int)ROUND(local_94 * 256f);
  local_100.y = (int)ROUND(local_90 * 256f);
  local_100.z = (int)ROUND(local_8c * 256f);
  local_68 = local_94;
  local_58 = local_90;
  local_34 = local_8c;
  wincore_windll_cpp_transformAndProjectPoint_FUN_005b575c
  ...
  local_118.x = (int)ROUND(local_130 * 256f);
  local_118.y = (int)ROUND(local_12c * 256f);
  local_118.z = (int)ROUND(local_128 * 256f);
  local_64 = local_12c;
  local_24 = local_130;
  local_20 = local_128;
  wincore_windll_cpp_transformAndProjectPoint_FUN_005b575c
  ...
  CStack_13c.x = (int)ROUND(local_ac * 256f);
  CStack_13c.y = (int)ROUND(local_a8 * 256f);
  CStack_13c.z = (int)ROUND(local_a4 * 256f);
  local_5c = local_a4;
  local_48 = local_ac;
  local_44 = local_a8;
  wincore_windll_cpp_transformAndProjectPoint_FUN_005b575c
  ...
  local_b8.x = (int)ROUND(local_a0 * 256f);
  local_b8.y = (int)ROUND(local_9c * 256f);
  local_b8.z = (int)ROUND(local_98 * 256f);
  local_54 = local_a0;
  local_50 = local_9c;
  local_4c = local_98;
  wincore_windll_cpp_transformAndProjectPoint_FUN_005b575c
  ...
  local_88.x = (int)ROUND(local_10c * 256f);
  local_88.y = (int)ROUND(local_108 * 256f);
  local_88.z = (int)ROUND(local_104 * 256f);
  local_30 = local_10c;
  local_2c = local_108;
  local_28 = local_104;
  wincore_windll_cpp_transformAndProjectPoint_FUN_005b575c
  ...
  local_c4.x = (int)ROUND(local_d0 * 256f);
  local_c4.y = (int)ROUND(local_cc * 256f);
  local_c4.z = (int)ROUND(local_c8 * 256f);
  local_40 = local_d0;
  local_3c = local_cc;
  local_38 = local_c8;
  wincore_windll_cpp_transformAndProjectPoint_FUN_005b575c
