...
section .text
    ...
    CMP dword ptr [0x015c4174],0x0      ; 00451259 | g_CoronaVisibilityEnabled
    JZ 0x00451316                       ; 00451260
        ;   XREF to: 00451316 (CONDITIONAL_JUMP)  ; LAB_00451316
    PUSH EDI                            ; 00451266
    PUSH EBX                            ; 00451267
    MOV EDI,dword ptr [0x015c4178]      ; 00451268 | g_CoronaTargetX
    XOR ECX,ECX                         ; 0045126e
    MOV EBX,dword ptr [0x015c4180]      ; 00451270 | g_CoronaTargetDepth
    MOV dword ptr [ESP + 0x8],ECX       ; 00451276
    MOV ECX,dword ptr [0x015c417c]      ; 0045127a | g_CoronaTargetY
    TEST ESI,ESI                        ; 00451280
    JZ 0x0045131d                       ; 00451282
    ...
    MOV ESI,dword ptr [EDI + ESI*0x4 + 0xbce6f8] ; 004512f0 | g_PrecomputedDepthBuffer
    LEA EDI,[EDX + -0x80]               ; 004512f7
    CMP ESI,EDI                         ; 004512fa
    JGE 0x00451327                      ; 004512fc
        ;   XREF to: 00451327 (CONDITIONAL_JUMP)  ; LAB_00451327
    TEST EAX,EAX                        ; 004512fe
        ;   Label: LAB_004512fe
    JNZ 0x0045130a                      ; 00451300
        ;   XREF to: 0045130a (CONDITIONAL_JUMP)  ; LAB_0045130a
    ...
    MOV EAX,0x1                         ; 00451316
        ;   Label: LAB_00451316
    JMP 0x00451310                      ; 0045131b
        ;   XREF to: 00451310 (UNCONDITIONAL_JUMP)  ; LAB_00451310
    MOV ESI,0x7fffffff                  ; 0045131d
        ;   Label: LAB_0045131d
    JMP 0x00451296                      ; 00451322
        ;   XREF to: 00451296 (UNCONDITIONAL_JUMP)  ; LAB_00451296
    ...
    JG 0x004512e0                       ; 00451338
        ;   XREF to: 004512e0 (CONDITIONAL_JUMP)  ; LAB_004512e0
    JMP 0x004512fe                      ; 0045133a
        ;   XREF to: 004512fe (UNCONDITIONAL_JUMP)  ; LAB_004512fe
