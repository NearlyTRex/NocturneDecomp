...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dcamera.cpp_CDemonCamera_init_FUN_0044c190(CDemonCamera * this_ptr, int screen_height)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0044c19b
    CALL core_dcamera.cpp_CDemonCamera_free_FUN_0044c360 ; 0044c19c | void core_dcamera.cpp_CDemonCamera_free_FUN_0044c360(CDemonCamera * this_ptr)
    ...
    MOV dword ptr [0x0151a3a8],ESI      ; 0044c1b7 | int g_CameraScreenHeight
    MOV [0x0151a3a4],EAX                ; 0044c1bd | int g_CameraScreenWidth
    CMP ESI,0x1e0                       ; 0044c1c2
    JLE 0x0044c1cf                      ; 0044c1c8 | LAB_0044c1cf
    ...
    MOV dword ptr [0x013bc260],EDX      ; 0044c206 | int g_CameraDownscaleIterations
    ...
    JLE 0x0044c27c                      ; 0044c224 | LAB_0044c27c
    ...
    MOV EDI,dword ptr [0x013bc260]      ; 0044c252 | int g_CameraDownscaleIterations
    ADD ESI,ESI                         ; 0044c258
    INC EDI                             ; 0044c25a
    MOV dword ptr [EBX + 0x14c],ESI     ; 0044c25b
    MOV dword ptr [0x013bc260],EDI      ; 0044c261 | int g_CameraDownscaleIterations
    MOV EBP,dword ptr [EBX + 0x150]     ; 0044c267
    MOV dword ptr [EBX + 0x154],EAX     ; 0044c26d
    CMP EBP,0x140                       ; 0044c273
    JG 0x0044c22c                       ; 0044c279 | LAB_0044c22c
    ...
    PUSH 0x619eda                       ; 0044c295 | = "..\\core\\dcamera.cpp" | s_core_dcamera_cpp_00619eda = ..\core\dcamera.cpp
    ADD EAX,0x1010                      ; 0044c29a
    PUSH EAX                            ; 0044c29f
    CALL shape_memdbg.cpp_debugMalloc_FUN_0050f250 ; 0044c2a0 | void * shape_memdbg.cpp_debugMalloc_FUN_0050f250(int size, char * filename, int line_number)
        ;   XREF to: 0050f250 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0044c2a5
    MOV dword ptr [EBX + 0x160],EAX     ; 0044c2a8
    TEST EAX,EAX                        ; 0044c2ae
    JNZ 0x0044c2d5                      ; 0044c2b0 | LAB_0044c2d5
        ;   XREF to: 0044c2d5 (CONDITIONAL_JUMP)
    MOV ECX,0x619eee                    ; 0044c2b2 | = "..\\core\\dcamera.cpp" | s_core_dcamera_cpp_00619eee = ..\core\dcamera.cpp
    MOV ESI,0x241                       ; 0044c2b7
    PUSH 0x619f02                       ; 0044c2bc | = "CDemonCamera::init - Unable to alloc ..." | s_CDemonCamera_init_Unable_00619f02 = CDemonCamera::init - Unable to alloc frame buffer
    MOV dword ptr [0x02f0ca48],ECX      ; 0044c2c1 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 0044c2c7 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0044c2cd | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    PUSH 0x619f34                       ; 0044c2ee | = "..\\core\\dcamera.cpp" | s_core_dcamera_cpp_00619f34 = ..\core\dcamera.cpp
    ADD EAX,0x1010                      ; 0044c2f3
    PUSH EAX                            ; 0044c2f8
    CALL shape_memdbg.cpp_debugMalloc_FUN_0050f250 ; 0044c2f9 | void * shape_memdbg.cpp_debugMalloc_FUN_0050f250(int size, char * filename, int line_number)
        ;   XREF to: 0050f250 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0044c2fe
    MOV dword ptr [EBX + 0x164],EAX     ; 0044c301
    TEST EAX,EAX                        ; 0044c307
    JZ 0x0044c331                       ; 0044c309 | LAB_0044c331
    ...
    POP EBX                             ; 0044c32f
    RET                                 ; 0044c330
    MOV EAX,0x619f48                    ; 0044c331 | = "..\\core\\dcamera.cpp" | s_core_dcamera_cpp_00619f48 = ..\core\dcamera.cpp
        ;   Label: LAB_0044c331
    MOV EDX,0x246                       ; 0044c336
    PUSH 0x619f5c                       ; 0044c33b | = "CDemonCamera::init - Unable to alloc ..." | s_CDemonCamera_init_Unable_00619f5c = CDemonCamera::init - Unable to alloc z buffer
    MOV [0x02f0ca48],EAX                ; 0044c340 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 0044c345 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0044c34b | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0044c350
    JMP 0x0044c30b                      ; 0044c353 | LAB_0044c30b
