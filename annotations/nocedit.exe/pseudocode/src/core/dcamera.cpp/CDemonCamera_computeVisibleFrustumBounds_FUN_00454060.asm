...
section .text
    ...
    CMP EAX,0x3f87558                   ; 0045407d | CVector3f g_ZeroVector
    JNZ 0x00454154                      ; 00454082 | LAB_00454154
        ;   XREF to: 00454154 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [ESP + 0xf4]      ; 00454088
        ;   Label: LAB_00454088
    CMP EBX,EDX                         ; 0045408f
    JNZ 0x00454173                      ; 00454091 | LAB_00454173
    ...
    JLE 0x00454430                      ; 004540d0 | LAB_00454430
    ...
    JG 0x00454188                       ; 0045412f | LAB_00454188
    ...
    JMP 0x004540c0                      ; 0045414f | LAB_004540c0
        ;   XREF to: 004540c0 (UNCONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x03f87558]      ; 00454154 | CVector3f g_ZeroVector
        ;   Label: LAB_00454154
    ...
    JMP 0x00454088                      ; 0045416e | LAB_00454088
    ...
    JMP 0x00454097                      ; 00454183 | LAB_00454097
    ...
    CALL core_dcamera.cpp_CDemonCamera_screenToWorldCoord_FUN_0044d2a0 ; 0045419a | void core_dcamera.cpp_CDemonCamera_screenToWorldCoord_FUN_0044d2a0(CDemonCamera * this_ptr, CVector3i * output_ptr, int screen_x, int screen_y)
    ...
    JG 0x00454390                       ; 004541e7 | LAB_00454390
    ...
    JG 0x004543d5                       ; 00454200 | LAB_004543d5
        ;   XREF to: 004543d5 (CONDITIONAL_JUMP)
    INC EBX                             ; 00454206
        ;   Label: LAB_00454206
    CMP EBX,0x4                         ; 00454207
        ;   Label: LAB_00454207
    JL 0x004542d1                       ; 0045420a | LAB_004542d1
    ...
    CALL core_dcamera.cpp_CDemonCamera_screenToWorldTransform_FUN_0044d370 ; 0045422d | CVector3i * core_dcamera.cpp_CDemonCamera_screenToWorldTransform_FUN_0044d370(CDemonCamera * this_ptr, CVector3i * output_ptr, CVector3i * input_ptr)
    ...
    FMUL float ptr [0x0065c644]         ; 00454245 | float g_WorldToFloat
    FSTP float ptr [EBX]                ; 0045424b
    FILD dword ptr [EAX + 0x4]          ; 0045424d
    FMUL float ptr [0x0065c644]         ; 00454250 | float g_WorldToFloat
    FSTP float ptr [EBX + 0x4]          ; 00454256
    FILD dword ptr [EAX + 0x8]          ; 00454259
    FMUL float ptr [0x0065c644]         ; 0045425c | float g_WorldToFloat
    ...
    CALL core_dirmat.cpp_CMatrix3x3f_transformVectorTranspose_FUN_00472030 ; 004542b1 | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVectorTranspose_FUN_00472030(CMatrix3x3f * matrix, CVector3f * output, CVector3f * input)
    ...
    PUSH ECX                            ; 004542c8
    CALL core_box.cpp_CBoundingBox3D_expand_FUN_00420240 ; 004542c9 | void core_box.cpp_CBoundingBox3D_expand_FUN_00420240(CBoundingBox3D * this_ptr, CVector3f * point)
    ...
    JMP 0x0045411f                      ; 004542ef | LAB_0045411f
        ;   XREF to: 0045411f (UNCONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0xd4],0x1      ; 004542f4
        ;   Label: LAB_004542f4
    JLE 0x004541c5                      ; 004542fc | LAB_004541c5
    ...
    CALL core_dcamera.cpp_CDemonCamera_screenToWorldCoord_FUN_0044d2a0 ; 0045431b | void core_dcamera.cpp_CDemonCamera_screenToWorldCoord_FUN_0044d2a0(CDemonCamera * this_ptr, CVector3i * output_ptr, int screen_x, int screen_y)
        ;   XREF to: 0044d2a0 (UNCONDITIONAL_CALL)
    ...
    JG 0x004541c5                       ; 00454332 | LAB_004541c5
        ;   XREF to: 004541c5 (CONDITIONAL_JUMP)
    JMP 0x004541c6                      ; 00454338 | LAB_004541c6
    ...
    JLE 0x004541d4                      ; 0045434f | LAB_004541d4
    ...
    CALL core_dcamera.cpp_CDemonCamera_screenToWorldCoord_FUN_0044d2a0 ; 0045436e | void core_dcamera.cpp_CDemonCamera_screenToWorldCoord_FUN_0044d2a0(CDemonCamera * this_ptr, CVector3i * output_ptr, int screen_x, int screen_y)
        ;   XREF to: 0044d2a0 (UNCONDITIONAL_CALL)
    ...
    JG 0x004541d4                       ; 00454385 | LAB_004541d4
        ;   XREF to: 004541d4 (CONDITIONAL_JUMP)
    JMP 0x004541d5                      ; 0045438b | LAB_004541d5
        ;   XREF to: 004541d5 (UNCONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0xd4],0x1      ; 00454390
        ;   Label: LAB_00454390
    JLE 0x004541ed                      ; 00454398 | LAB_004541ed
    ...
    CALL core_dcamera.cpp_CDemonCamera_screenToWorldCoord_FUN_0044d2a0 ; 004543b3 | void core_dcamera.cpp_CDemonCamera_screenToWorldCoord_FUN_0044d2a0(CDemonCamera * this_ptr, CVector3i * output_ptr, int screen_x, int screen_y)
        ;   XREF to: 0044d2a0 (UNCONDITIONAL_CALL)
    ...
    JG 0x004541ed                       ; 004543ca | LAB_004541ed
        ;   XREF to: 004541ed (CONDITIONAL_JUMP)
    JMP 0x004541ee                      ; 004543d0 | LAB_004541ee
    ...
    JLE 0x00454206                      ; 004543e7 | LAB_00454206
    ...
    CALL core_dcamera.cpp_CDemonCamera_screenToWorldCoord_FUN_0044d2a0 ; 00454408 | void core_dcamera.cpp_CDemonCamera_screenToWorldCoord_FUN_0044d2a0(CDemonCamera * this_ptr, CVector3i * output_ptr, int screen_x, int screen_y)
        ;   XREF to: 0044d2a0 (UNCONDITIONAL_CALL)
    ...
    JG 0x00454206                       ; 00454425 | LAB_00454206
        ;   XREF to: 00454206 (CONDITIONAL_JUMP)
    JMP 0x00454207                      ; 0045442b | LAB_00454207
