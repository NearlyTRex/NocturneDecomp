...

{
  ...
  this_ptr->framebuffer_aligned = (void *)(((uintptr_t)this_ptr->framebuffer_raw + 0x10U) & ~(uintptr_t)0xF);
  this_ptr->zbuffer_aligned = (void *)(((uintptr_t)this_ptr->zbuffer_raw + 0x10U) & ~(uintptr_t)0xF);
  return;
}
