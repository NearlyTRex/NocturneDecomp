...
;                               FUNCTION
; *****************************************************************************
; __cdecl CDemonCamera * __cdecl core_dcamera_cpp_CDemonCamera_precomputeNormals_FUN_0044e360(CDemonCamera *this_ptr)
;
; Parameters:
...
section .text
    ...
    MOVSD ES:EDI,ESI                    ; 0044e470 | DAT_009e5d80
    MOVSD ES:EDI,ESI                    ; 0044e471 | DAT_009e5d84
    MOVSD ES:EDI,ESI                    ; 0044e472 | DAT_009e5d88
