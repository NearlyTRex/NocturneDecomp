...

{
  ...
  this_ptr->transform_state.saved_camera_origin = this_ptr->camera_origin;
  this_ptr->transform_state.saved_camera_position = (this_ptr->base).position;
  this_ptr->transform_state.saved_source_matrix = this_ptr->source_matrix;
