...
section .text
    ...
    PUSH 0x61a0aa                       ; 0044de24 | = "movscrn.raw" | s_movscrn_raw_0061a0aa = movscrn.raw
    LEA EAX,[EBX + 0x1c74]              ; 0044de29
    XOR ECX,ECX                         ; 0044de2f
    PUSH EAX                            ; 0044de31
    MOV dword ptr [ESP + 0x48],EDX      ; 0044de32
    MOV dword ptr [ESP + 0x4c],ECX      ; 0044de36
    CALL crt_string.c_strcmp_FUN_005fef20 ; 0044de3a | int crt_string.c_strcmp_FUN_005fef20(char * str1, char * str2)
        ;   XREF to: 005fef20 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0044de3f
    TEST EAX,EAX                        ; 0044de42
    JZ 0x0044e141                       ; 0044de44 | LAB_0044e141
        ;   XREF to: 0044e141 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + 0x1c]      ; 0044de4a
        ;   Label: LAB_0044de4a
    TEST EAX,EAX                        ; 0044de4d
    JNZ 0x0044de5b                      ; 0044de4f | LAB_0044de5b
        ;   XREF to: 0044de5b (CONDITIONAL_JUMP)
    MOV [0x01322208],EAX                ; 0044de51 | g_LightBufferPool[24][0]
    MOV [0x00c1a204],EAX                ; 0044de56 | int g_LightBufferPoolIndex
    MOV ESI,dword ptr [0x00c1a204]      ; 0044de5b | int g_LightBufferPoolIndex
        ;   Label: LAB_0044de5b
    ...
    MOV ESI,dword ptr [0x00c1a204]      ; 0044de74 | int g_LightBufferPoolIndex
    INC ESI                             ; 0044de7a
    ADD EAX,0xc1a208                    ; 0044de7b | char[25][307200] g_LightBufferPool
    MOV dword ptr [0x00c1a204],ESI      ; 0044de80 | int g_LightBufferPoolIndex
    CMP ESI,0x18                        ; 0044de86
    JBE 0x0044de8d                      ; 0044de89 | LAB_0044de8d
        ;   XREF to: 0044de8d (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 0044de8b
    MOV ESI,dword ptr [0x00c1a204]      ; 0044de8d | int g_LightBufferPoolIndex
        ;   Label: LAB_0044de8d
    MOV dword ptr [EBX + 0x1c48],EAX    ; 0044de93
    LEA EAX,[ESI*0x4 + 0x0]             ; 0044de99
    ADD EAX,ESI                         ; 0044dea0
    SHL EAX,0xc                         ; 0044dea2
    MOV EDX,dword ptr [0x00c1a204]      ; 0044dea5 | int g_LightBufferPoolIndex
    MOV ESI,EAX                         ; 0044deab
    SHL EAX,0x4                         ; 0044dead
    INC EDX                             ; 0044deb0
    SUB EAX,ESI                         ; 0044deb1
    MOV dword ptr [0x00c1a204],EDX      ; 0044deb3 | int g_LightBufferPoolIndex
    ADD EAX,0xc1a208                    ; 0044deb9 | char[25][307200] g_LightBufferPool
    CMP EDX,0x18                        ; 0044debe
    JBE 0x0044dec5                      ; 0044dec1 | LAB_0044dec5
        ;   XREF to: 0044dec5 (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 0044dec3
    MOV ESI,dword ptr [0x00c1a204]      ; 0044dec5 | int g_LightBufferPoolIndex
        ;   Label: LAB_0044dec5
    ...
    MOV ESI,dword ptr [0x00c1a204]      ; 0044dee4 | int g_LightBufferPoolIndex
    INC ESI                             ; 0044deea
    ADD EAX,0xc1a208                    ; 0044deeb | char[25][307200] g_LightBufferPool
    MOV dword ptr [0x00c1a204],ESI      ; 0044def0 | int g_LightBufferPoolIndex
    CMP ESI,0x18                        ; 0044def6
    JBE 0x0044defd                      ; 0044def9 | LAB_0044defd
    ...
    JNZ 0x0044e158                      ; 0044df0a | LAB_0044e158
        ;   XREF to: 0044e158 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + 0x14]      ; 0044df10
        ;   Label: LAB_0044df10
    ADD EAX,0x40                        ; 0044df13
    PUSH EAX                            ; 0044df16
    MOV ESI,0x61a0b6                    ; 0044df17 | = "..\\core\\dcamera.cpp" | s_core_dcamera_cpp_0061a0b6 = ..\core\dcamera.cpp
    MOV EDI,0x6ba                       ; 0044df1c
    PUSH 0x61a0ca                       ; 0044df21 | = "CDemonCamera::precomputeLight - Too m..." | s_CDemonCamera_precomputeL_0061a0ca = CDemonCamera::precomputeLight - Too many lights visible from camera %s
    MOV dword ptr [0x02f0ca48],ESI      ; 0044df26 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 0044df2c | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0044df32 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0044df37
    PUSH EBX                            ; 0044df3a
        ;   Label: LAB_0044df3a
    CALL core_dlight.cpp_CDemonLight_initializeVisibilityBuffer_FUN_00475fc0 ; 0044df3b | void core_dlight.cpp_CDemonLight_initializeVisibilityBuffer_FUN_00475fc0(CDemonLight * this_ptr)
        ;   XREF to: 00475fc0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0044df40
    CMP dword ptr [EBP + 0x1c],0x0      ; 0044df43
    JNZ 0x0044e177                      ; 0044df47 | LAB_0044e177
    ...
    JG 0x0044e133                       ; 0044df8e | LAB_0044e133
    ...
    ADD EAX,0x902f74                    ; 0044dfd2 | CVector3i[15360] g_PrecomputedWorldPositions
    MOV dword ptr [ESP + 0x30],EAX      ; 0044dfd7
    MOV EAX,dword ptr [ESP + 0x8]       ; 0044dfdb
    SHL EAX,0x2                         ; 0044dfdf
    ADD ESI,0xac6d74                    ; 0044dfe2 | CVector3f[76800] g_PrecomputedSurfaceNormals
    ...
    JLE 0x0044e062                      ; 0044e0d3 | LAB_0044e062
    ...
    JLE 0x0044dff2                      ; 0044e12d | LAB_0044dff2
    ...
    JLE 0x0044e1c0                      ; 0044e19b | LAB_0044e1c0
    ...
    JL 0x0044e1a3                       ; 0044e1bd | LAB_0044e1a3
    ...
    JGE 0x0044df80                      ; 0044e1ce | LAB_0044df80
    ...
    JG 0x0044e06f                       ; 0044e229 | LAB_0044e06f
        ;   XREF to: 0044e06f (CONDITIONAL_JUMP)
    ...
    JG 0x0044e06f                       ; 0044e246 | LAB_0044e06f
        ;   XREF to: 0044e06f (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x44],0x0      ; 0044e24c
    JZ 0x0044e313                       ; 0044e251 | LAB_0044e313
    ...
    CALL core_dcamera.cpp_CDemonCamera_worldToScreenWithFrustumCull_FUN_0044d7d0 ; 0044e265 | CVector3i * core_dcamera.cpp_CDemonCamera_worldToScreenWithFrustumCull_FUN_0044d7d0(CDemonCamera * this_ptr, CVector3i * output_ptr, CVector3i * input_ptr)
    ...
    JLE 0x0044e06f                      ; 0044e27a | LAB_0044e06f
        ;   XREF to: 0044e06f (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 0044e29c
    PUSH EBX                            ; 0044e29d
    CALL core_dlight.cpp_CDemonLight_projectLightAndMarkVisibility_FUN_00473270 ; 0044e29e | ushort * core_dlight.cpp_CDemonLight_projectLightAndMarkVisibility_FUN_00473270(CDemonLight * this_ptr, CVector3i * projected_coord, uchar x_round_flag, uchar y_round_flag)
    ...
    JZ 0x0044e33e                       ; 0044e2ae | LAB_0044e33e
    ...
    JLE 0x0044e2fc                      ; 0044e2f6 | LAB_0044e2fc
    ...
    JGE 0x0044e08d                      ; 0044e304 | LAB_0044e08d
        ;   XREF to: 0044e08d (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x4c],EAX      ; 0044e30a
    JMP 0x0044e08d                      ; 0044e30e | LAB_0044e08d
    ...
    FNSTSW AX                           ; 0044e330
    SAHF                                ; 0044e332
    JBE 0x0044e257                      ; 0044e333 | LAB_0044e257
        ;   XREF to: 0044e257 (CONDITIONAL_JUMP)
    JMP 0x0044e06f                      ; 0044e339 | LAB_0044e06f
    ...
    JMP 0x0044e087                      ; 0044e352 | LAB_0044e087
