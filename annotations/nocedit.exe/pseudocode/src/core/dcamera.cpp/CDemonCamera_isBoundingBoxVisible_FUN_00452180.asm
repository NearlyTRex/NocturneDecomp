...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_dcamera.cpp_CDemonCamera_isBoundingBoxVisible_FUN_00452180(CDemonCamera * this_ptr, CVector3f * position, CVector3f * min_corner, CVector3f * max_corner)
;
; Parameters:
...
;
; XREF[2]:
;   core_lightgun.cpp_FUN_00505c70 at 00505f4c
...
section .text
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 004521a6 | CDemonRenderer * g_CDemonRendererPtr
    PUSH EDX                            ; 004521ac | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_matrixPush_FUN_0050d620 ; 004521ad | void engine_drender.cpp_CDemonRenderer_matrixPush_FUN_0050d620()
        ;   XREF to: 0048c630 (UNCONDITIONAL_CALL)
    FLD float ptr [EBX + 0x4]           ; 004521b2
    FSUB float ptr [EBP]                ; 004521b5
    FLD double ptr [0x0061a332]         ; 004521b8 | double g_CameraFixedPointScale
    FXCH                                ; 004521be
    FMUL ST1                            ; 004521c0
    ...
    MOV [0x02d052e8],EAX                ; 004521e1 | CMatrix3x3i g_TransformMatrix
    ...
    FXCH                                ; 00452217
    CALL crt_math.c_round_FUN_005fe6b0  ; 00452219 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    MOV [0x02d052f8],EAX                ; 0045221e | g_TransformMatrix[1][1]
    MOV EAX,dword ptr [EBX + 0x18c]     ; 00452223
    FXCH                                ; 00452229
    CALL crt_math.c_round_FUN_005fe6b0  ; 0045222b | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    MOV [0x02d052fc],EAX                ; 00452230 | g_TransformMatrix[1][2]
    MOV EAX,dword ptr [EBX + 0x190]     ; 00452235
    FXCH ST2                            ; 0045223b
    CALL crt_math.c_round_FUN_005fe6b0  ; 0045223d | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    MOV [0x02d05300],EAX                ; 00452242 | g_TransformMatrix[2][0]
    MOV EAX,dword ptr [EBX + 0x194]     ; 00452247
    FXCH                                ; 0045224d
    FISTP dword ptr [0x02d052b8]        ; 0045224f | int g_RelativeX
    MOV [0x02d05304],EAX                ; 00452255 | g_TransformMatrix[2][1]
    MOV EAX,dword ptr [EBX + 0x198]     ; 0045225a
    MOV EBX,dword ptr [0x006703ec]      ; 00452260 | CDemonRenderer * g_CDemonRendererPtr
    FXCH                                ; 00452266
    FISTP dword ptr [0x02d052bc]        ; 00452268 | int g_RelativeY
    PUSH EBX                            ; 0045226e | CDemonRenderer g_CDemonRendererInstance
    FISTP dword ptr [0x02d052c0]        ; 0045226f | int g_RelativeZ
    MOV [0x02d05308],EAX                ; 00452275 | g_TransformMatrix[2][2]
    CALL engine_drender.cpp_CDemonRenderer_applyScaledTransform_FUN_0048c4f0 ; 0045227a | void engine_drender.cpp_CDemonRenderer_applyScaledTransform_FUN_0048c4f0(CDemonRenderer * this_ptr, CVector3i * position, CVector3i * rotation)
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 004522c8 | CDemonRenderer * g_CDemonRendererPtr
    FLD float ptr [EAX]                 ; 004522ce
    FMUL float ptr [0x0065c63c]         ; 004522d0 | float g_CameraFixedPointScale
    FISTP dword ptr [EBX]               ; 004522d6
    FLD float ptr [EAX + 0x4]           ; 004522d8
    FMUL float ptr [0x0065c63c]         ; 004522db | float g_CameraFixedPointScale
    FISTP dword ptr [EBX + 0x4]         ; 004522e1
    FLD float ptr [EAX + 0x8]           ; 004522e4
    FMUL float ptr [0x0065c63c]         ; 004522e7 | float g_CameraFixedPointScale
    FISTP dword ptr [EBX + 0x8]         ; 004522ed
    LEA EAX,[ESP + 0x48]                ; 004522f0
    PUSH EAX                            ; 004522f4
    MOV EAX,dword ptr [EDX]             ; 004522f5 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0xea480                     ; 004522f7
    PUSH EAX                            ; 004522fc
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 004522fd | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 0045233f | CDemonRenderer * g_CDemonRendererPtr
    MOV dword ptr [ESP + 0x5c],EAX      ; 00452345
    LEA EBX,[ESP + 0x60]                ; 00452349
    LEA EAX,[ESP + 0x54]                ; 0045234d
    FLD float ptr [EAX]                 ; 00452351
    FMUL float ptr [0x0065c63c]         ; 00452353 | float g_CameraFixedPointScale
    FISTP dword ptr [EBX]               ; 00452359
    FLD float ptr [EAX + 0x4]           ; 0045235b
    FMUL float ptr [0x0065c63c]         ; 0045235e | float g_CameraFixedPointScale
    FISTP dword ptr [EBX + 0x4]         ; 00452364
    FLD float ptr [EAX + 0x8]           ; 00452367
    FMUL float ptr [0x0065c63c]         ; 0045236a | float g_CameraFixedPointScale
    FISTP dword ptr [EBX + 0x8]         ; 00452370
    LEA EAX,[ESP + 0x60]                ; 00452373
    PUSH EAX                            ; 00452377
    MOV EAX,dword ptr [EDX]             ; 00452378 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0xea4b0                     ; 0045237a
    PUSH EAX                            ; 0045237f
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 00452380 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 004523da | CDemonRenderer * g_CDemonRendererPtr
    FLD float ptr [EAX]                 ; 004523e0
    FMUL float ptr [0x0065c63c]         ; 004523e2 | float g_CameraFixedPointScale
    FISTP dword ptr [EBX]               ; 004523e8
    FLD float ptr [EAX + 0x4]           ; 004523ea
    FMUL float ptr [0x0065c63c]         ; 004523ed | float g_CameraFixedPointScale
    FISTP dword ptr [EBX + 0x4]         ; 004523f3
    FLD float ptr [EAX + 0x8]           ; 004523f6
    FMUL float ptr [0x0065c63c]         ; 004523f9 | float g_CameraFixedPointScale
    FISTP dword ptr [EBX + 0x8]         ; 004523ff
    LEA EAX,[ESP + 0x3c]                ; 00452402
    PUSH EAX                            ; 00452406
    MOV EAX,dword ptr [EDX]             ; 00452407 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0xea4e0                     ; 00452409
    PUSH EAX                            ; 0045240e
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 0045240f | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 0045245d | CDemonRenderer * g_CDemonRendererPtr
    FLD float ptr [EAX]                 ; 00452463
    FMUL float ptr [0x0065c63c]         ; 00452465 | float g_CameraFixedPointScale
    FISTP dword ptr [EBX]               ; 0045246b
    FLD float ptr [EAX + 0x4]           ; 0045246d
    FMUL float ptr [0x0065c63c]         ; 00452470 | float g_CameraFixedPointScale
    FISTP dword ptr [EBX + 0x4]         ; 00452476
    FLD float ptr [EAX + 0x8]           ; 00452479
    FMUL float ptr [0x0065c63c]         ; 0045247c | float g_CameraFixedPointScale
    FISTP dword ptr [EBX + 0x8]         ; 00452482
    LEA EAX,[ESP + 0x24]                ; 00452485
    PUSH EAX                            ; 00452489
    MOV EAX,dword ptr [EDX]             ; 0045248a | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0xea510                     ; 0045248c
    PUSH EAX                            ; 00452491
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 00452492 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 004524ea | CDemonRenderer * g_CDemonRendererPtr
    FLD float ptr [EAX]                 ; 004524f0
    FMUL float ptr [0x0065c63c]         ; 004524f2 | float g_CameraFixedPointScale
    FISTP dword ptr [EBX]               ; 004524f8
    FLD float ptr [EAX + 0x4]           ; 004524fa
    FMUL float ptr [0x0065c63c]         ; 004524fd | float g_CameraFixedPointScale
    FISTP dword ptr [EBX + 0x4]         ; 00452503
    FLD float ptr [EAX + 0x8]           ; 00452506
    FMUL float ptr [0x0065c63c]         ; 00452509 | float g_CameraFixedPointScale
    FISTP dword ptr [EBX + 0x8]         ; 0045250f
    MOV EAX,ESP                         ; 00452512
    PUSH EAX                            ; 00452514
    MOV EAX,dword ptr [EDX]             ; 00452515 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0xea540                     ; 00452517
    PUSH EAX                            ; 0045251c
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 0045251d | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 0045257a | CDemonRenderer * g_CDemonRendererPtr
    FLD float ptr [EAX]                 ; 00452580
    FMUL float ptr [0x0065c63c]         ; 00452582 | float g_CameraFixedPointScale
    FISTP dword ptr [EBX]               ; 00452588
    FLD float ptr [EAX + 0x4]           ; 0045258a
    FMUL float ptr [0x0065c63c]         ; 0045258d | float g_CameraFixedPointScale
    FISTP dword ptr [EBX + 0x4]         ; 00452593
    FLD float ptr [EAX + 0x8]           ; 00452596
    FMUL float ptr [0x0065c63c]         ; 00452599 | float g_CameraFixedPointScale
    FISTP dword ptr [EBX + 0x8]         ; 0045259f
    LEA EAX,[ESP + 0x84]                ; 004525a2
    PUSH EAX                            ; 004525a9
    MOV EAX,dword ptr [EDX]             ; 004525aa | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0xea570                     ; 004525ac
    PUSH EAX                            ; 004525b1
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 004525b2 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 00452603 | CDemonRenderer * g_CDemonRendererPtr
    FLD float ptr [EAX]                 ; 00452609
    FMUL float ptr [0x0065c63c]         ; 0045260b | float g_CameraFixedPointScale
    FISTP dword ptr [EBX]               ; 00452611
    FLD float ptr [EAX + 0x4]           ; 00452613
    FMUL float ptr [0x0065c63c]         ; 00452616 | float g_CameraFixedPointScale
    FISTP dword ptr [EBX + 0x4]         ; 0045261c
    FLD float ptr [EAX + 0x8]           ; 0045261f
    FMUL float ptr [0x0065c63c]         ; 00452622 | float g_CameraFixedPointScale
    FISTP dword ptr [EBX + 0x8]         ; 00452628
    LEA EAX,[ESP + 0xb4]                ; 0045262b
    PUSH EAX                            ; 00452632
    MOV EAX,dword ptr [EDX]             ; 00452633 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0xea5a0                     ; 00452635
    PUSH EAX                            ; 0045263a
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 0045263b | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 00452689 | CDemonRenderer * g_CDemonRendererPtr
    FLD float ptr [EAX]                 ; 0045268f
    FMUL float ptr [0x0065c63c]         ; 00452691 | float g_CameraFixedPointScale
    FISTP dword ptr [EBX]               ; 00452697
    FLD float ptr [EAX + 0x4]           ; 00452699
    FMUL float ptr [0x0065c63c]         ; 0045269c | float g_CameraFixedPointScale
    FISTP dword ptr [EBX + 0x4]         ; 004526a2
    FLD float ptr [EAX + 0x8]           ; 004526a5
    FMUL float ptr [0x0065c63c]         ; 004526a8 | float g_CameraFixedPointScale
    FISTP dword ptr [EBX + 0x8]         ; 004526ae
    LEA EAX,[ESP + 0x78]                ; 004526b1
    PUSH EAX                            ; 004526b5
    MOV EAX,dword ptr [EDX]             ; 004526b6 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0xea5d0                     ; 004526b8
    PUSH EAX                            ; 004526bd
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 004526be | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    MOV EDX,0xffffffff                  ; 004526c3
    MOV EAX,0xea480                     ; 004526c8
    ADD ESP,0x8                         ; 004526cd
    MOV ECX,dword ptr [0x006703ec]      ; 004526d0 | CDemonRenderer * g_CDemonRendererPtr
        ;   Label: LAB_004526d0
    MOV ECX,dword ptr [ECX]             ; 004526d6 | CDemonRenderer g_CDemonRendererInstance
    MOV ESI,dword ptr [ECX + EAX*0x1 + 0x10] ; 004526d8
    ADD EAX,0x30                        ; 004526dc
    AND EDX,ESI                         ; 004526df
    CMP EAX,0xea600                     ; 004526e1
    JNZ 0x004526d0                      ; 004526e6 | LAB_004526d0
        ;   XREF to: 004526d0 (CONDITIONAL_JUMP)
    MOV EBX,0x1                         ; 004526e8
    TEST EDX,0x80000000                 ; 004526ed
    JZ 0x004526fc                       ; 004526f3 | LAB_004526fc
        ;   XREF to: 004526fc (CONDITIONAL_JUMP)
    TEST DL,0xff                        ; 004526f5
    JZ 0x004526fc                       ; 004526f8 | LAB_004526fc
        ;   XREF to: 004526fc (CONDITIONAL_JUMP)
    XOR EBX,EBX                         ; 004526fa
    MOV EDI,dword ptr [0x006703ec]      ; 004526fc | CDemonRenderer * g_CDemonRendererPtr
        ;   Label: LAB_004526fc
    PUSH EDI                            ; 00452702 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_matrixPop_FUN_0050d720 ; 00452703 | void engine_drender.cpp_CDemonRenderer_matrixPop_FUN_0050d720()
