...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dcamera.cpp_CDemonCamera_free_FUN_0044c360(CDemonCamera * this_ptr)
;
; Parameters:
...
section .text
    ...
    JNZ 0x0044c3af                      ; 0044c36e | LAB_0044c3af
    ...
    JNZ 0x0044c3c4                      ; 0044c38c | LAB_0044c3c4
    ...
    PUSH 0x25a                          ; 0044c3af
        ;   Label: LAB_0044c3af
    PUSH 0x619f8a                       ; 0044c3b4 | = "..\\core\\dcamera.cpp" | s_core_dcamera_cpp_00619f8a = ..\core\dcamera.cpp
    PUSH EDX                            ; 0044c3b9
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 0044c3ba | void shape_memdbg.cpp_debugFree_FUN_0050f460(void * ptr, char * filename, int line_number)
        ;   XREF to: 0050f460 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0044c3bf
    JMP 0x0044c370                      ; 0044c3c2 | LAB_0044c370
        ;   XREF to: 0044c370 (UNCONDITIONAL_JUMP)
    PUSH 0x25e                          ; 0044c3c4
        ;   Label: LAB_0044c3c4
    PUSH 0x619f9e                       ; 0044c3c9 | = "..\\core\\dcamera.cpp" | s_core_dcamera_cpp_00619f9e = ..\core\dcamera.cpp
    PUSH ESI                            ; 0044c3ce
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 0044c3cf | void shape_memdbg.cpp_debugFree_FUN_0050f460(void * ptr, char * filename, int line_number)
        ;   XREF to: 0050f460 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0044c3d4
    JMP 0x0044c38e                      ; 0044c3d7 | LAB_0044c38e
