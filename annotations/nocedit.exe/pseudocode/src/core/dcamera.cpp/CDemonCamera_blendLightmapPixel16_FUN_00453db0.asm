...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dcamera.cpp_CDemonCamera_blendLightmapPixel16_FUN_00453db0(CDemonCamera * this_ptr, int screen_x, int screen_y, int offset)
;
; Parameters:
...
section .text
    ...
    MOV ESI,dword ptr [EDX*0x4 + 0x2cf6a9c] ; 00453dc6 | void *[1024] g_ScreenBufferArray
    ...
    MOV EAX,0xbbb9b8                    ; 00453e08 | char[241][320] g_CoronaBlurWorkBuffer
    ...
    ADD ESI,0x13da778                   ; 00453e22 | SFogImagePlane g_CameraPlaneWorkBuffer
    ...
    PUSH EDI                            ; 00453e39
    PUSH EBP                            ; 00453e3a
    CALL core_dstrender.cpp_blendSinglePixelLightmapMMX_FUN_004937b6 ; 00453e3b | void core_dstrender.cpp_blendSinglePixelLightmapMMX_FUN_004937b6(ushort * output_pixel, uint * texture_pixel, byte * texture_index, byte * lightmap_index)
