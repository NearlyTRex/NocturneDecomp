...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_platfrm.cpp_FUN_0054df80()
;
; Local Variables:
; undefined4       Stack[-0x88]:4  local_88
;
; XREF[1]:
;   core_platfrm.cpp_FUN_0054cc30 at 0054d4ce
;
; Referenced Globals:
...
section .text
    ...
    JNZ 0x0054df9f                      ; 0054df94 | LAB_0054df9f
    ...
    LEA EAX,[ESP + 0x8]                 ; 0054df9f
        ;   Label: LAB_0054df9f
    PUSH EAX                            ; 0054dfa3
    CALL core_setcolid.cpp_SCollisionInfo_ctor_FUN_005743c0 ; 0054dfa4 | SCollisionInfo * core_setcolid.cpp_SCollisionInfo_ctor_FUN_005743c0(SCollisionInfo * this_ptr)
    ...
    JNZ 0x0054df96                      ; 0054dfc7 | LAB_0054df96
        ;   XREF to: 0054df96 (CONDITIONAL_JUMP)
    PUSH dword ptr [EBX + 0x30]         ; 0054dfc9
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 0054dfcc | float core_actor.cpp_normalizeAngleToPi_FUN_0040cd70(float angle_radians)
    ...
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 0054dfe2 | float core_actor.cpp_normalizeAngleToPi_FUN_0040cd70(float angle_radians)
        ;   XREF to: 0040cd70 (UNCONDITIONAL_CALL)
    ...
    FCOMP double ptr [0x0063f97e]       ; 0054dffa | double DOUBLE_0063f97e
    FNSTSW AX                           ; 0054e000
    SAHF                                ; 0054e002
    JA 0x0054df96                       ; 0054e003 | LAB_0054df96
        ;   XREF to: 0054df96 (CONDITIONAL_JUMP)
    FLD float ptr [EBX + 0x38]          ; 0054e005
    FABS                                ; 0054e008
    FCOMP double ptr [0x0063f97e]       ; 0054e00a | double DOUBLE_0063f97e
    FNSTSW AX                           ; 0054e010
    SAHF                                ; 0054e012
    JA 0x0054df96                       ; 0054e013 | LAB_0054df96
        ;   XREF to: 0054df96 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 0054e02f
    PUSH EBX                            ; 0054e030
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 0054e031 | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
    ...
    FNSTSW AX                           ; 0054e045
    SAHF                                ; 0054e047
    JC 0x0054df96                       ; 0054e048 | LAB_0054df96
        ;   XREF to: 0054df96 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0054e05a
    SAHF                                ; 0054e05c
    JA 0x0054df96                       ; 0054e05d | LAB_0054df96
        ;   XREF to: 0054df96 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0054e06f
    SAHF                                ; 0054e071
    JC 0x0054df96                       ; 0054e072 | LAB_0054df96
        ;   XREF to: 0054df96 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0054e084
    SAHF                                ; 0054e086
    JA 0x0054df96                       ; 0054e087 | LAB_0054df96
        ;   XREF to: 0054df96 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0054e099
    SAHF                                ; 0054e09b
    JC 0x0054df96                       ; 0054e09c | LAB_0054df96
        ;   XREF to: 0054df96 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0054e0ae
    SAHF                                ; 0054e0b0
    JA 0x0054df96                       ; 0054e0b1 | LAB_0054df96
        ;   XREF to: 0054df96 (CONDITIONAL_JUMP)
    LEA EAX,[EBX + 0x158]               ; 0054e0b7
    PUSH EAX                            ; 0054e0bd
    CALL core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80 ; 0054e0be | CKeyFramedModel * core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80(CKeyFramedModelInstance * this_ptr)
        ;   XREF to: 00478d80 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [EAX + 0x5698]    ; 0054e0c3
    ADD ESP,0x4                         ; 0054e0c9
    TEST ECX,ECX                        ; 0054e0cc
    JNZ 0x0054e0dc                      ; 0054e0ce | LAB_0054e0dc
    ...
    PUSH EAX                            ; 0054e11f
    FADD float ptr [0x0063f986]         ; 0054e120 | float FLOAT_0063f986
    PUSH ESI                            ; 0054e126
    FADD float ptr [ESP + 0x5c]         ; 0054e127
    PUSH EBX                            ; 0054e12b
    FSTP float ptr [ESP + 0x60]         ; 0054e12c
    CALL core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80 ; 0054e130 | CKeyFramedModel * core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80(CKeyFramedModelInstance * this_ptr)
        ;   XREF to: 00478d80 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0054e135
    PUSH EAX                            ; 0054e138
    CALL core_dmodel.cpp_CKeyFramedModel_intersectRay_FUN_004781d0 ; 0054e139 | float core_dmodel.cpp_CKeyFramedModel_intersectRay_FUN_004781d0(CKeyFramedModel * this_ptr, int frame_index, CVector3f * ray_origin, CVector3f * ray_direction, ...)
    ...
    FNSTSW AX                           ; 0054e159
    SAHF                                ; 0054e15b
    JA 0x0054df96                       ; 0054e15c | LAB_0054df96
        ;   XREF to: 0054df96 (CONDITIONAL_JUMP)
    FLD1                                ; 0054e162
    FCOMP double ptr [ESP]              ; 0054e164
    FNSTSW AX                           ; 0054e167
    SAHF                                ; 0054e169
    JNC 0x0054e0d0                      ; 0054e16a | LAB_0054e0d0
