...

{
  ...
  if (pCVar1->course_filename[0] == '\0') {
    _sprintf(local_d4,"Select a course for platform %s",this_ptr->base.actor_name);
  ...
  _sprintf(local_19c,"Change course setting for platform %s",this_ptr->base.actor_name);
