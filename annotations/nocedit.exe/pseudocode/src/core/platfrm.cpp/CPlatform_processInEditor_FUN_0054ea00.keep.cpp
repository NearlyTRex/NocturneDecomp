    ...
    if (this_ptr->course_filename[0] == '\0') {
      ...
      if ((iVar2 != 0) &&
        ...
        if ((CLocation *)pCVar4 != pCVar1) {
          *pCVar4 = pCVar1->position;
        }
        if (&this_ptr->start_pos != pCVar4) {
          this_ptr->start_pos = *pCVar4;
        }
        core_xform_cpp_eulerToQuaternion_FUN_005f7b20(&(this_ptr->base).orient.vec,&CStack_9c);
        this_ptr->end_orient = CStack_9c;
        this_ptr->orig_orient = this_ptr->end_orient;
      }
      ...
      case PLATFORM_TYPE_START:
        if (&auStack_104 != (CSlew *)&this_ptr->start_pos) {
          auStack_104.position = this_ptr->start_pos;
        }
      ...
      case PLATFORM_TYPE_BOTH:
        ...
        core_xform_cpp_multiplyMatrix3x4_FUN_005f4f10(&CStack_164,&CStack_224,&CStack_284);
        pCStack_1c->x = CStack_284.m[0].z;
        pCStack_1c->y = CStack_284.m[1].z;
        pCStack_1c->z = CStack_284.m[2].z;
        core_xform_cpp_matrixToQuaternion_FUN_005f7420((CMatrix3x3f *)&CStack_284,&CStack_8c);
        this_ptr->orig_orient = CStack_8c;
        core_xform_cpp_multiplyMatrix3x4_FUN_005f4f10(&CStack_2e4,&CStack_224,&CStack_1c4);
        ...
        core_xform_cpp_matrixToQuaternion_FUN_005f7420((CMatrix3x3f *)&CStack_1c4,&CStack_cc);
        this_ptr->end_orient = CStack_cc;
      }
    }
    else {
