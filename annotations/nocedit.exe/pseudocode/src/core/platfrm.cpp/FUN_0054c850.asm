...
;                               FUNCTION
; *****************************************************************************
; __cdecl CPlatform * core_platfrm.cpp_FUN_0054c850(CPlatform * this_ptr)
;
; Parameters:
...
;
; XREF[4]:
;   core_conveyor.cpp_ctor_FUN_00441ca0 at 00441ca7
;   core_minecar.cpp_FUN_00520e50 at 00520e6a
;   core_minecar.cpp_FUN_00520f20 at 00520f25
;   core_platfrm.cpp_FUN_0054c810 at 0054c82a
;
; Referenced Globals:
...
section .text
    ...
    PUSH ESI                            ; 0054c859
    PUSH EBX                            ; 0054c85a
    CALL core_actor.cpp_CDemonActor_ctor_FUN_004088b0 ; 0054c85b | CDemonActor * core_actor.cpp_CDemonActor_ctor_FUN_004088b0(CDemonActor * this_ptr)
        ;   XREF to: 004088b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0054c860
    ADD EAX,0x158                       ; 0054c863
    PUSH EAX                            ; 0054c868
    CALL core_dmodel.cpp_CKeyFramedModelInstance_ctor_FUN_00478ce0 ; 0054c869 | CKeyFramedModelInstance * core_dmodel.cpp_CKeyFramedModelInstance_ctor_FUN_00478ce0(CKeyFramedModelInstance * this_ptr)
        ;   XREF to: 00478ce0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0054c86e
    ADD EAX,0x1b8                       ; 0054c871
    PUSH EAX                            ; 0054c876
    CALL core_course.cpp_CCourse_ctor_FUN_004424c0 ; 0054c877 | CCourse * core_course.cpp_CCourse_ctor_FUN_004424c0(CCourse * this_ptr)
        ;   XREF to: 004424c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0054c87c
    LEA EBX,[EAX + 0xfffffcf0]          ; 0054c87f
    PUSH 0x63f774                       ; 0054c885 | = "slider1.kfm" | s_slider1_kfm_0063f774 = slider1.kfm
    LEA EAX,[EBX + 0x158]               ; 0054c88a
    PUSH EAX                            ; 0054c890
    MOV dword ptr [EBX + 0x154],0x6622a4 ; 0054c891 | CDemonActor_vtable PTR_core_platfrm.cpp_CPlatform_LoadCourseSomething_FUN_006622a4
    CALL core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0 ; 0054c89b | void core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0(CKeyFramedModelInstance * this_ptr, char * filename)
    ...
    JNZ 0x0054c9f3                      ; 0054c913 | LAB_0054c9f3
        ;   XREF to: 0054c9f3 (CONDITIONAL_JUMP)
    LEA EAX,[EBX + 0x31c]               ; 0054c919
        ;   Label: LAB_0054c919
    CMP EAX,ECX                         ; 0054c91f
    JNZ 0x0054ca08                      ; 0054c921 | LAB_0054ca08
        ;   XREF to: 0054ca08 (CONDITIONAL_JUMP)
    LEA EAX,[EBX + 0x30]                ; 0054c927
        ;   Label: LAB_0054c927
    PUSH EAX                            ; 0054c92a
    LEA ESI,[ESP + 0xc]                 ; 0054c92b
    CALL core_xform.cpp_eulerToQuaternion_FUN_005f7b20 ; 0054c92f | CQuaternion4f * core_xform.cpp_eulerToQuaternion_FUN_005f7b20(CQuaternion4f * quat_out, CVector3f * euler_angles)
    ...
    JNZ 0x0054c9bd                      ; 0054c9cc | LAB_0054c9bd
    ...
    JMP 0x0054c919                      ; 0054ca03 | LAB_0054c919
    ...
    JMP 0x0054c927                      ; 0054ca18 | LAB_0054c927
