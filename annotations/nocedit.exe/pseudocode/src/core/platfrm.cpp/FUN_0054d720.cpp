...
// Convention: __cdecl
// Signature: int __cdecl core_platfrm_cpp_FUN_0054d720(void)
...
LAB_0054d802:
  ...
  if (((*(int *)(g_CDemonMissionPtr->unk1 + 4) != 0) &&
      (iVar6 = engine_drender_cpp_CDemonRenderer_getFaceCount_FUN_0048cae0(g_CDemonRendererPtr2),
      iVar6 == 0)) &&
     ((pCVar2 = *(CDemonActor **)(g_CDemonMissionPtr->unk2 + 0x1c), in_stack_00000004 == pCVar2 &&
      (*(char *)&pCVar2[2].orient_matrix.m[0].y == '\0')))) {
    ...
    (pCVar2->location).position.x = (float)in_stack_00000004[2].unk1;
