...
;
; XREF[1]:
;   core_minecar.cpp_FUN_00520eb0 at 00520eba
;
; Referenced Globals:
...
section .text
    ...
    JGE 0x0054d681                      ; 0054cc49 | LAB_0054d681
    ...
    JA 0x0054cccf                       ; 0054cc78 | default
        ;   XREF to: 0054cccf (CONDITIONAL_JUMP)
    JMP dword ptr [EAX*0x4 + 0x54cc10]  ; 0054cc7a | void * switchdataD_0054cc10
        ;   Label: switchD
    MOV EAX,dword ptr [EBP + 0x14]      ; 0054cc81
        ;   Label: caseD_0
    ADD EAX,0x3b8                       ; 0054cc84
    PUSH EAX                            ; 0054cc89
    MOV EAX,[0x006793d0]                ; 0054cc8a | CEventList g_CEventListInstance | CEventList * g_CEventListPtr
    PUSH EAX                            ; 0054cc8f | CEventList g_CEventListInstance
    CALL core_event.cpp_CEventList_evaluateCondition_FUN_004adca0 ; 0054cc90 | int core_event.cpp_CEventList_evaluateCondition_FUN_004adca0(CEventList * this_ptr, char * condition_expression)
        ;   XREF to: 004adca0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0054cc95
    TEST EAX,EAX                        ; 0054cc98
    JZ 0x0054ccc2                       ; 0054cc9a | LAB_0054ccc2
    ...
    CALL core_platfrm.cpp_FUN_0054d690  ; 0054ccba | undefined core_platfrm.cpp_FUN_0054d690()
    ...
    JZ 0x0054cdc9                       ; 0054ccd9 | LAB_0054cdc9
        ;   XREF to: 0054cdc9 (CONDITIONAL_JUMP)
    TEST EBX,EBX                        ; 0054ccdf
    JZ 0x0054cdb0                       ; 0054cce1 | LAB_0054cdb0
    ...
    CMP AL,0x0                          ; 0054ccfa
    JZ 0x0054cd0e                       ; 0054ccfc | LAB_0054cd0e
    ...
    CMP AL,0x0                          ; 0054cd0a
    JNZ 0x0054ccf6                      ; 0054cd0c | LAB_0054ccf6
    ...
    TEST CL,CL                          ; 0054cd17
    JZ 0x0054cd70                       ; 0054cd19 | LAB_0054cd70
        ;   XREF to: 0054cd70 (CONDITIONAL_JUMP)
    CMP byte ptr [EBX],0x3b             ; 0054cd1b
        ;   Label: LAB_0054cd1b
    JNZ 0x0054d18b                      ; 0054cd1e | LAB_0054d18b
        ;   XREF to: 0054d18b (CONDITIONAL_JUMP)
    PUSH ESI                            ; 0054cd24
    MOV EDI,dword ptr [0x006810c8]      ; 0054cd25 | CDemonSet * g_CDemonSetPtr
    PUSH EDI                            ; 0054cd2b | CDemonSet g_CDemonSetInstance
    MOV byte ptr [EBX],0x0              ; 0054cd2c
    CALL core_set.cpp_CDemonSet_FUN_0056b790 ; 0054cd2f | int core_set.cpp_CDemonSet_FUN_0056b790(CDemonSet * this_ptr)
        ;   XREF to: 0056b790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0054cd34
    CMP EAX,-0x1                        ; 0054cd37
    JZ 0x0054d17a                       ; 0054cd3a | LAB_0054d17a
        ;   XREF to: 0054d17a (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x006810c8]      ; 0054cd40 | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
    MOV EDI,dword ptr [EDX + 0x15aea4]  ; 0054cd46 | g_CDemonSetInstance.selected_camera_index
    CMP EAX,EDI                         ; 0054cd4c
    JZ 0x0054d17a                       ; 0054cd4e | LAB_0054d17a
        ;   XREF to: 0054d17a (CONDITIONAL_JUMP)
    PUSH 0x4479c000                     ; 0054cd54
    PUSH EAX                            ; 0054cd59
    PUSH EDX                            ; 0054cd5a | CDemonSet g_CDemonSetInstance
    CALL core_setdir.cpp_CDemonSet_setPendingCamera_FUN_00575b00 ; 0054cd5b | void core_setdir.cpp_CDemonSet_setPendingCamera_FUN_00575b00(CDemonSet * this_ptr, int camera_index, float hold_time)
    ...
    PUSH ESI                            ; 0054cd70
        ;   Label: LAB_0054cd70
    MOV EAX,[0x006810c8]                ; 0054cd71 | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
    PUSH EAX                            ; 0054cd76 | CDemonSet g_CDemonSetInstance
    CALL core_set.cpp_CDemonSet_FUN_0056b790 ; 0054cd77 | int core_set.cpp_CDemonSet_FUN_0056b790(CDemonSet * this_ptr)
        ;   XREF to: 0056b790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0054cd7c
    CMP EAX,-0x1                        ; 0054cd7f
    JZ 0x0054cdb0                       ; 0054cd82 | LAB_0054cdb0
        ;   XREF to: 0054cdb0 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x006810c8]      ; 0054cd84 | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
    MOV EBX,dword ptr [EDX + 0x15aea4]  ; 0054cd8a | g_CDemonSetInstance.selected_camera_index
    CMP EAX,EBX                         ; 0054cd90
    JZ 0x0054cdb0                       ; 0054cd92 | LAB_0054cdb0
        ;   XREF to: 0054cdb0 (CONDITIONAL_JUMP)
    PUSH 0x4479c000                     ; 0054cd94
    PUSH EAX                            ; 0054cd99
    PUSH EDX                            ; 0054cd9a | CDemonSet g_CDemonSetInstance
    CALL core_setdir.cpp_CDemonSet_setPendingCamera_FUN_00575b00 ; 0054cd9b | void core_setdir.cpp_CDemonSet_setPendingCamera_FUN_00575b00(CDemonSet * this_ptr, int camera_index, float hold_time)
        ;   XREF to: 00575b00 (UNCONDITIONAL_CALL)
    ...
    CMP dword ptr [ESP + 0x300],0x0     ; 0054cdb0
        ;   Label: LAB_0054cdb0
    JZ 0x0054cdc9                       ; 0054cdb8 | LAB_0054cdc9
        ;   XREF to: 0054cdc9 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x006810c8]      ; 0054cdba | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
    PUSH ECX                            ; 0054cdc0 | CDemonSet g_CDemonSetInstance
    CALL core_setdir.cpp_CDemonSet_clearCameraSwitchCooldown_FUN_00575b20 ; 0054cdc1 | void core_setdir.cpp_CDemonSet_clearCameraSwitchCooldown_FUN_00575b20(CDemonSet * this_ptr)
    ...
    FNSTSW AX                           ; 0054cdd9
    SAHF                                ; 0054cddb
    JZ 0x0054d681                       ; 0054cddc | LAB_0054d681
        ;   XREF to: 0054d681 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x304],0x0     ; 0054cde2
    JZ 0x0054d1c1                       ; 0054cdea | LAB_0054d1c1
        ;   XREF to: 0054d1c1 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + 0x14]      ; 0054cdf0
    CMP byte ptr [EAX + 0x4a8],0x0      ; 0054cdf3
    JZ 0x0054d1c1                       ; 0054cdfa | LAB_0054d1c1
        ;   XREF to: 0054d1c1 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [EAX + 0x4bc]     ; 0054ce00
    PUSH EDX                            ; 0054ce06
    MOV ECX,dword ptr [0x00681ef8]      ; 0054ce07 | CSound g_CSoundInstance | CSound * g_CSoundPtr
    PUSH ECX                            ; 0054ce0d | CSound g_CSoundInstance
    CALL core_sound.cpp_CSound_isSoundPlaying_FUN_005b3b80 ; 0054ce0e | void core_sound.cpp_CSound_isSoundPlaying_FUN_005b3b80(CSound * this_ptr, uint sfx_handle)
        ;   XREF to: 005b3b80 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0054ce13
    TEST EAX,EAX                        ; 0054ce16
    JZ 0x0054d19a                       ; 0054ce18 | LAB_0054d19a
    ...
    PUSH EAX                            ; 0054ce40
    CALL core_xform.cpp_buildMatrixFromEulerAndPosition_FUN_005f5390 ; 0054ce41 | void core_xform.cpp_buildMatrixFromEulerAndPosition_FUN_005f5390(CMatrix3x4f * output_matrix, CVector3f * position, CVector3f * euler_angles)
        ;   XREF to: 005f5390 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0054ce46
    MOV EDI,dword ptr [EBP + 0x14]      ; 0054ce49
    PUSH EDI                            ; 0054ce4c
    CALL core_platfrm.cpp_FUN_0054cab0  ; 0054ce4d | undefined core_platfrm.cpp_FUN_0054cab0()
    ...
    PUSH EAX                            ; 0054ce5e
    CALL core_xform.cpp_buildMatrixFromEulerAndPositionDirect_FUN_005f54c0 ; 0054ce5f | void core_xform.cpp_buildMatrixFromEulerAndPositionDirect_FUN_005f54c0(CMatrix3x4f * output_matrix, CVector3f * position, CVector3f * euler_angles)
    ...
    MOV EAX,[0x006810c8]                ; 0054ce80 | CDemonSet * g_CDemonSetPtr
        ;   Label: LAB_0054ce80
    CMP EDI,dword ptr [EAX + 0x14f098]  ; 0054ce85 | g_CDemonSetInstance.damage_listener_count
    JL 0x0054d1df                       ; 0054ce8b | LAB_0054d1df
    ...
    JMP 0x0054cea1                      ; 0054cef5 | LAB_0054cea1
        ;   XREF to: 0054cea1 (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + 0x14]      ; 0054cef7
        ;   Label: caseD_1
    ADD EAX,0x354                       ; 0054cefa
    PUSH EAX                            ; 0054ceff
    MOV ESI,dword ptr [0x006793d0]      ; 0054cf00 | CEventList * g_CEventListPtr
    PUSH ESI                            ; 0054cf06 | CEventList g_CEventListInstance
    CALL core_event.cpp_CEventList_evaluateCondition_FUN_004adca0 ; 0054cf07 | int core_event.cpp_CEventList_evaluateCondition_FUN_004adca0(CEventList * this_ptr, char * condition_expression)
        ;   XREF to: 004adca0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0054cf0c
    TEST EAX,EAX                        ; 0054cf0f
    JZ 0x0054cf36                       ; 0054cf11 | LAB_0054cf36
    ...
    CALL core_platfrm.cpp_FUN_0054d690  ; 0054cf2e | undefined core_platfrm.cpp_FUN_0054d690()
        ;   XREF to: 0054d690 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0054cf33
    MOV EAX,dword ptr [EBP + 0x14]      ; 0054cf36
        ;   Label: LAB_0054cf36
    MOV dword ptr [EAX + 0x2dc],0x3f800000 ; 0054cf39
    JMP 0x0054cccf                      ; 0054cf43 | default
        ;   XREF to: 0054cccf (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + 0x14]      ; 0054cf48
        ;   Label: caseD_2
    ADD EAX,0x3b8                       ; 0054cf4b
    PUSH EAX                            ; 0054cf50
    MOV EDI,dword ptr [0x006793d0]      ; 0054cf51 | CEventList * g_CEventListPtr
    PUSH EDI                            ; 0054cf57 | CEventList g_CEventListInstance
    CALL core_event.cpp_CEventList_evaluateCondition_FUN_004adca0 ; 0054cf58 | int core_event.cpp_CEventList_evaluateCondition_FUN_004adca0(CEventList * this_ptr, char * condition_expression)
        ;   XREF to: 004adca0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0054cf5d
    TEST EAX,EAX                        ; 0054cf60
    JZ 0x0054cf8a                       ; 0054cf62 | LAB_0054cf8a
    ...
    PUSH EAX                            ; 0054cf7c
    CALL core_platfrm.cpp_FUN_0054d690  ; 0054cf7d | undefined core_platfrm.cpp_FUN_0054d690()
        ;   XREF to: 0054d690 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0054cf82
    JMP 0x0054cccf                      ; 0054cf85 | default
        ;   XREF to: 0054cccf (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + 0x14]      ; 0054cf8a
        ;   Label: LAB_0054cf8a
    ADD EAX,0x354                       ; 0054cf8d
    PUSH EAX                            ; 0054cf92
    MOV EAX,[0x006793d0]                ; 0054cf93 | CEventList g_CEventListInstance | CEventList * g_CEventListPtr
    PUSH EAX                            ; 0054cf98 | CEventList g_CEventListInstance
    CALL core_event.cpp_CEventList_evaluateCondition_FUN_004adca0 ; 0054cf99 | int core_event.cpp_CEventList_evaluateCondition_FUN_004adca0(CEventList * this_ptr, char * condition_expression)
        ;   XREF to: 004adca0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0054cf9e
    TEST EAX,EAX                        ; 0054cfa1
    JZ 0x0054cccf                       ; 0054cfa3 | default
        ;   XREF to: 0054cccf (CONDITIONAL_JUMP)
    ...
    PUSH 0x0                            ; 0054cfbc
    PUSH EAX                            ; 0054cfbe
    CALL core_platfrm.cpp_FUN_0054d690  ; 0054cfbf | undefined core_platfrm.cpp_FUN_0054d690()
        ;   XREF to: 0054d690 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0054cfc4
    JMP 0x0054cccf                      ; 0054cfc7 | default
        ;   XREF to: 0054cccf (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + 0x14]      ; 0054cfcc
        ;   Label: caseD_3
    ADD EAX,0x41c                       ; 0054cfcf
    PUSH EAX                            ; 0054cfd4
    MOV EDI,dword ptr [0x006793d0]      ; 0054cfd5 | CEventList * g_CEventListPtr
    PUSH EDI                            ; 0054cfdb | CEventList g_CEventListInstance
    CALL core_event.cpp_CEventList_evaluateCondition_FUN_004adca0 ; 0054cfdc | int core_event.cpp_CEventList_evaluateCondition_FUN_004adca0(CEventList * this_ptr, char * condition_expression)
        ;   XREF to: 004adca0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0054cfe1
    TEST EAX,EAX                        ; 0054cfe4
    JZ 0x0054d01e                       ; 0054cfe6 | LAB_0054d01e
    ...
    TEST DH,DH                          ; 0054cffb
    JZ 0x0054cccf                       ; 0054cffd | default
        ;   XREF to: 0054cccf (CONDITIONAL_JUMP)
    ...
    JMP 0x0054cccf                      ; 0054d019 | default
        ;   XREF to: 0054cccf (UNCONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0054d03c
    SAHF                                ; 0054d03e
    JBE 0x0054d0a2                      ; 0054d03f | LAB_0054d0a2
    ...
    FNSTSW AX                           ; 0054d05a
    SAHF                                ; 0054d05c
    JA 0x0054d090                       ; 0054d05d | LAB_0054d090
    ...
    JZ 0x0054d080                       ; 0054d074 | LAB_0054d080
        ;   XREF to: 0054d080 (CONDITIONAL_JUMP)
    MOV dword ptr [EAX + 0x4c0],0x2     ; 0054d076
    MOV dword ptr [ESP + 0x300],0x1     ; 0054d080
        ;   Label: LAB_0054d080
    JMP 0x0054cccf                      ; 0054d08b | default
        ;   XREF to: 0054cccf (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + 0x14]      ; 0054d090
        ;   Label: LAB_0054d090
    MOV dword ptr [EAX + 0x2d4],0x2     ; 0054d093
    JMP 0x0054cccf                      ; 0054d09d | default
        ;   XREF to: 0054cccf (UNCONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x304],0x1     ; 0054d0a2
        ;   Label: LAB_0054d0a2
    JMP 0x0054cccf                      ; 0054d0ad | default
        ;   XREF to: 0054cccf (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + 0x14]      ; 0054d0b2
        ;   Label: caseD_4
    ADD EAX,0x41c                       ; 0054d0b5
    PUSH EAX                            ; 0054d0ba
    MOV EDI,dword ptr [0x006793d0]      ; 0054d0bb | CEventList * g_CEventListPtr
    PUSH EDI                            ; 0054d0c1 | CEventList g_CEventListInstance
    CALL core_event.cpp_CEventList_evaluateCondition_FUN_004adca0 ; 0054d0c2 | int core_event.cpp_CEventList_evaluateCondition_FUN_004adca0(CEventList * this_ptr, char * condition_expression)
        ;   XREF to: 004adca0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0054d0c7
    TEST EAX,EAX                        ; 0054d0ca
    JZ 0x0054d104                       ; 0054d0cc | LAB_0054d104
    ...
    TEST DL,DL                          ; 0054d0e1
    JZ 0x0054cccf                       ; 0054d0e3 | default
        ;   XREF to: 0054cccf (CONDITIONAL_JUMP)
    ...
    JMP 0x0054cccf                      ; 0054d0ff | default
        ;   XREF to: 0054cccf (UNCONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0054d122
    SAHF                                ; 0054d124
    JNC 0x0054d0a2                      ; 0054d125 | LAB_0054d0a2
        ;   XREF to: 0054d0a2 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0054d144
    SAHF                                ; 0054d146
    JC 0x0054d090                       ; 0054d147 | LAB_0054d090
        ;   XREF to: 0054d090 (CONDITIONAL_JUMP)
    ...
    JMP 0x0054ce1e                      ; 0054d1bc | LAB_0054ce1e
        ;   XREF to: 0054ce1e (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + 0x14]      ; 0054d1c1
        ;   Label: LAB_0054d1c1
    MOV ESI,dword ptr [EAX + 0x4bc]     ; 0054d1c4
    PUSH ESI                            ; 0054d1ca
    MOV EDI,dword ptr [0x00681ef8]      ; 0054d1cb | CSound * g_CSoundPtr
    PUSH EDI                            ; 0054d1d1 | CSound g_CSoundInstance
    CALL core_sound.cpp_CSound_killSound_FUN_005b3b90 ; 0054d1d2 | void core_sound.cpp_CSound_killSound_FUN_005b3b90(CSound * this_ptr, uint sfx_handle)
        ;   XREF to: 005b3b90 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0054d1d7
    JMP 0x0054ce1e                      ; 0054d1da | LAB_0054ce1e
        ;   XREF to: 0054ce1e (UNCONDITIONAL_JUMP)
    ...
    JG 0x0054d4f3                       ; 0054d1f8 | LAB_0054d4f3
    ...
    JNZ 0x0054d4f3                      ; 0054d20d | LAB_0054d4f3
        ;   XREF to: 0054d4f3 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + 0x14]      ; 0054d213
    CMP dword ptr [EAX + 0x510],0x0     ; 0054d216
    JZ 0x0054d4ba                       ; 0054d21d | LAB_0054d4ba
    ...
    PUSH EAX                            ; 0054d232
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 0054d233 | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
    ...
    FNSTSW AX                           ; 0054d249
    SAHF                                ; 0054d24b
    JA 0x0054d4f3                       ; 0054d24c | LAB_0054d4f3
        ;   XREF to: 0054d4f3 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x288]         ; 0054d252
    FADD double ptr [0x0063f786]        ; 0054d259 | double DOUBLE_0063f786
    FLD float ptr [ESP + 0x2e8]         ; 0054d25f
    FCOMPP                              ; 0054d266
    FNSTSW AX                           ; 0054d268
    SAHF                                ; 0054d26a
    JC 0x0054d4f3                       ; 0054d26b | LAB_0054d4f3
        ;   XREF to: 0054d4f3 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 0054d288
    CALL core_box.cpp_CBoundingBox3D_clampPoint_FUN_00421550 ; 0054d289 | CVector3f * core_box.cpp_CBoundingBox3D_clampPoint_FUN_00421550(CBoundingBox3D * this_ptr, CVector3f * out_point, CVector3f * in_point)
    ...
    FCOMP double ptr [0x0063f78e]       ; 0054d2d6 | double DOUBLE_0063f78e
    FNSTSW AX                           ; 0054d2dc
    SAHF                                ; 0054d2de
    JA 0x0054d4f3                       ; 0054d2df | LAB_0054d4f3
        ;   XREF to: 0054d4f3 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x2f8]         ; 0054d2e5
    FABS                                ; 0054d2ec
    FCOMP double ptr [0x0063f78e]       ; 0054d2ee | double DOUBLE_0063f78e
    FNSTSW AX                           ; 0054d2f4
    SAHF                                ; 0054d2f6
    JA 0x0054d4f3                       ; 0054d2f7 | LAB_0054d4f3
        ;   XREF to: 0054d4f3 (CONDITIONAL_JUMP)
    LEA EAX,[ESP + 0x25c]               ; 0054d2fd
    XOR EDX,EDX                         ; 0054d304
    PUSH EAX                            ; 0054d306
    MOV dword ptr [ESP + 0x2f8],EDX     ; 0054d307
    CALL core_setcolid.cpp_SCollisionInfo_ctor_FUN_005743c0 ; 0054d30e | SCollisionInfo * core_setcolid.cpp_SCollisionInfo_ctor_FUN_005743c0(SCollisionInfo * this_ptr)
    ...
    JNZ 0x0054d4f3                      ; 0054d337 | LAB_0054d4f3
        ;   XREF to: 0054d4f3 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0054d352
    SAHF                                ; 0054d354
    JA 0x0054d4f3                       ; 0054d355 | LAB_0054d4f3
        ;   XREF to: 0054d4f3 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0054d370
    SAHF                                ; 0054d372
    JC 0x0054d4f3                       ; 0054d373 | LAB_0054d4f3
        ;   XREF to: 0054d4f3 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0054d3a7
    SAHF                                ; 0054d3a9
    JC 0x0054d4f3                       ; 0054d3aa | LAB_0054d4f3
        ;   XREF to: 0054d4f3 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0054d3c4
    SAHF                                ; 0054d3c6
    JNC 0x0054d4f3                      ; 0054d3c7 | LAB_0054d4f3
        ;   XREF to: 0054d4f3 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x278]         ; 0054d3cd
    FADD double ptr [0x0063f796]        ; 0054d3d4 | double DOUBLE_0063f796
    ...
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 0054d486 | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
    ...
    JMP 0x0054ce80                      ; 0054d4b5 | LAB_0054ce80
    ...
    FNSTSW AX                           ; 0054d4c4
    SAHF                                ; 0054d4c6
    JNC 0x0054d4f3                      ; 0054d4c7 | LAB_0054d4f3
        ;   XREF to: 0054d4f3 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 0054d4c9
    MOV ECX,dword ptr [EBP + 0x14]      ; 0054d4ca
    PUSH ECX                            ; 0054d4cd
    CALL core_platfrm.cpp_FUN_0054df80  ; 0054d4ce | undefined core_platfrm.cpp_FUN_0054df80()
        ;   XREF to: 0054df80 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0054d4d3
    TEST EAX,EAX                        ; 0054d4d6
    JZ 0x0054d4f3                       ; 0054d4d8 | LAB_0054d4f3
        ;   XREF to: 0054d4f3 (CONDITIONAL_JUMP)
    ...
    JMP 0x0054ce80                      ; 0054d4f7 | LAB_0054ce80
        ;   XREF to: 0054ce80 (UNCONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 0054d512
    CALL core_xform.cpp_buildMatrixFromEulerAndPositionDirect_FUN_005f54c0 ; 0054d513 | void core_xform.cpp_buildMatrixFromEulerAndPositionDirect_FUN_005f54c0(CMatrix3x4f * output_matrix, CVector3f * position, CVector3f * euler_angles)
        ;   XREF to: 005f54c0 (UNCONDITIONAL_CALL)
    ...
    CALL core_xform.cpp_multiplyMatrix3x4_FUN_005f4f10 ; 0054d539 | CMatrix3x4f * core_xform.cpp_multiplyMatrix3x4_FUN_005f4f10(CMatrix3x4f * output_matrix, CMatrix3x4f * matrix_a, CMatrix3x4f * matrix_b)
    ...
    CALL core_xform.cpp_multiplyMatrix3x4_FUN_005f4f10 ; 0054d56d | CMatrix3x4f * core_xform.cpp_multiplyMatrix3x4_FUN_005f4f10(CMatrix3x4f * output_matrix, CMatrix3x4f * matrix_a, CMatrix3x4f * matrix_b)
        ;   XREF to: 005f4f10 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0054d5bc
    CALL core_xform.cpp_matrixToEulerAngles_FUN_005f5690 ; 0054d5bd | CVector3f * core_xform.cpp_matrixToEulerAngles_FUN_005f5690(CVector3f * euler_out, CMatrix3x3f * matrix_ptr)
    ...
    JZ 0x0054d630                       ; 0054d611 | LAB_0054d630
    ...
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 0054d654 | float core_actor.cpp_normalizeAngleToPi_FUN_0040cd70(float angle_radians)
    ...
    JMP 0x0054ced5                      ; 0054d670 | LAB_0054ced5
        ;   XREF to: 0054ced5 (UNCONDITIONAL_JUMP)
    MOV EBX,dword ptr [EBP + 0x14]      ; 0054d675
        ;   Label: LAB_0054d675
    PUSH EBX                            ; 0054d678
    CALL core_platfrm.cpp_FUN_0054e320  ; 0054d679 | undefined core_platfrm.cpp_FUN_0054e320()
