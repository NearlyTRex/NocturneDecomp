...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_platfrm_cpp_CPlatform_writeDependencies_FUN_0054f2a0(CPlatform *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0054f2a0
        ;   Label: core_platfrm.cpp_CPlatform_writeDependencies_FUN_0054f2a0
