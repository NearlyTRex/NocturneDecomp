...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_platfrm_cpp_CPlatform_propertyDisplaySlewCallback_FUN_0054e400 (CPlatform *this_ptr,CActorProperty *property,char *output_buffer)
;
; Parameters:
...
;
; XREF[1]:
;   core_platfrm.cpp_CPlatform_getPropertyList_FUN_0054e7d0 at 0054e8ea
;
; Referenced Globals:
...
section .text
    ...
    PUSH ESI                            ; 0054e400
        ;   Label: core_platfrm.cpp_CPlatform_propertyDisplaySlewCallback_FUN_0054e400
    PUSH EDI                            ; 0054e401
    ...
    PUSH ECX                            ; 0054e411
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 0054e412
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)  ; CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
    MOV EAX,dword ptr [EAX + 0x724]     ; 0054e417
    ADD ESP,0x8                         ; 0054e41d
    CMP EAX,0x3                         ; 0054e420
    JA 0x0054e42c                       ; 0054e423
        ;   XREF to: 0054e42c (CONDITIONAL_JUMP)  ; caseD_0
    JMP dword ptr [EAX*0x4 + 0x54e3e8]  ; 0054e425 | caseD_0 | caseD_1 | caseD_2
        ;   Label: switchD
    MOV ESI,0x63f9c1                    ; 0054e42c | = "Disabled"
        ;   Label: caseD_0
    PUSH EDI                            ; 0054e431
        ;   Label: LAB_0054e431
    ...
    CMP AL,0x0                          ; 0054e446
    JNZ 0x0054e432                      ; 0054e448
        ;   XREF to: 0054e432 (CONDITIONAL_JUMP)  ; LAB_0054e432
    POP EDI                             ; 0054e44a
        ;   Label: LAB_0054e44a
    POP EDI                             ; 0054e44b
    POP ESI                             ; 0054e44c
    RET                                 ; 0054e44d
    MOV ESI,0x63f9ca                    ; 0054e44e | = "Start"
        ;   Label: caseD_1
    JMP 0x0054e431                      ; 0054e453
        ;   XREF to: 0054e431 (UNCONDITIONAL_JUMP)  ; LAB_0054e431
    MOV ESI,0x63f9d0                    ; 0054e455 | = "End"
        ;   Label: caseD_2
    JMP 0x0054e431                      ; 0054e45a
        ;   XREF to: 0054e431 (UNCONDITIONAL_JUMP)  ; LAB_0054e431
    MOV ESI,0x63f9d4                    ; 0054e45c | = "Both"
        ;   Label: caseD_3
    JMP 0x0054e431                      ; 0054e461
        ;   XREF to: 0054e431 (UNCONDITIONAL_JUMP)  ; LAB_0054e431
