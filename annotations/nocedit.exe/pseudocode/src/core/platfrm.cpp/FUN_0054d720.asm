...
section .text
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 0054d72a | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH EDX                            ; 0054d730 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_getFaceCount_FUN_0048cae0 ; 0054d731 | int engine_drender.cpp_CDemonRenderer_getFaceCount_FUN_0048cae0(CDemonRenderer * this_ptr)
        ;   XREF to: 0048cae0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0054d736
    TEST EAX,EAX                        ; 0054d739
    JZ 0x0054d74a                       ; 0054d73b | LAB_0054d74a
        ;   XREF to: 0054d74a (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x518],0x0     ; 0054d73d
    JZ 0x0054d963                       ; 0054d744 | LAB_0054d963
        ;   XREF to: 0054d963 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x4c0],0x2     ; 0054d74a
        ;   Label: LAB_0054d74a
    JG 0x0054d96c                       ; 0054d751 | LAB_0054d96c
        ;   XREF to: 0054d96c (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x4c8],0x0     ; 0054d757
        ;   Label: LAB_0054d757
    JZ 0x0054d79c                       ; 0054d75e | LAB_0054d79c
        ;   XREF to: 0054d79c (CONDITIONAL_JUMP)
    MOV EAX,[0x0067d550]                ; 0054d760 | CDemonMission * g_CDemonMissionPtr
    MOV EAX,dword ptr [EAX + 0x4]       ; 0054d765 | DAT_02f33744
    TEST EAX,EAX                        ; 0054d768
    JNZ 0x0054d79c                      ; 0054d76a | LAB_0054d79c
        ;   XREF to: 0054d79c (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0x2d4]     ; 0054d76c
    CMP EAX,0x3                         ; 0054d772
    JZ 0x0054d79c                       ; 0054d775 | LAB_0054d79c
        ;   XREF to: 0054d79c (CONDITIONAL_JUMP)
    CMP EAX,0x4                         ; 0054d777
    JZ 0x0054d79c                       ; 0054d77a | LAB_0054d79c
        ;   XREF to: 0054d79c (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x728],0x0     ; 0054d77c
    JZ 0x0054d79c                       ; 0054d783 | LAB_0054d79c
        ;   XREF to: 0054d79c (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [0x006703ec]      ; 0054d785 | CDemonRenderer * g_CDemonRendererPtr
    PUSH ESI                            ; 0054d78b | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_getFaceCount_FUN_0048cae0 ; 0054d78c | int engine_drender.cpp_CDemonRenderer_getFaceCount_FUN_0048cae0(CDemonRenderer * this_ptr)
        ;   XREF to: 0048cae0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0054d791
    TEST EAX,EAX                        ; 0054d794
    JZ 0x0054d95c                       ; 0054d796 | LAB_0054d95c
        ;   XREF to: 0054d95c (CONDITIONAL_JUMP)
    PUSH EBX                            ; 0054d79c
        ;   Label: LAB_0054d79c
    CALL core_actor.cpp_CDemonActor_setupRenderState_FUN_00408b00 ; 0054d79d | void core_actor.cpp_CDemonActor_setupRenderState_FUN_00408b00(CDemonActor * actor)
    ...
    PUSH EAX                            ; 0054d7b7
    CALL core_box.cpp_CBoundingBox3D_isVisible_FUN_004204f0 ; 0054d7b8 | int core_box.cpp_CBoundingBox3D_isVisible_FUN_004204f0(CBoundingBox3D * this_ptr)
        ;   XREF to: 004204f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0054d7bd
    MOV EDI,EAX                         ; 0054d7c0
    TEST EAX,EAX                        ; 0054d7c2
    JZ 0x0054d802                       ; 0054d7c4 | LAB_0054d802
        ;   XREF to: 0054d802 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x50c],0x0     ; 0054d7c6
    JZ 0x0054d98a                       ; 0054d7cd | LAB_0054d98a
        ;   XREF to: 0054d98a (CONDITIONAL_JUMP)
    MOV EAX,[0x006703ec]                ; 0054d7d3 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH EAX                            ; 0054d7d8 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_getFaceCount_FUN_0048cae0 ; 0054d7d9 | int engine_drender.cpp_CDemonRenderer_getFaceCount_FUN_0048cae0(CDemonRenderer * this_ptr)
        ;   XREF to: 0048cae0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0054d7de
    TEST EAX,EAX                        ; 0054d7e1
    JZ 0x0054d98a                       ; 0054d7e3 | LAB_0054d98a
        ;   XREF to: 0054d98a (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 0054d7f9
    CALL core_box.cpp_CBoundingBox3D_render_FUN_004210b0 ; 0054d7fa | void core_box.cpp_CBoundingBox3D_render_FUN_004210b0(CBoundingBox3D * this_ptr, int param1, int param2, int param3)
        ;   XREF to: 004210b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0054d7ff
    PUSH EBX                            ; 0054d802
        ;   Label: LAB_0054d802
    CALL core_actor.cpp_CDemonActor_restoreRenderState_FUN_00408b40 ; 0054d803 | void core_actor.cpp_CDemonActor_restoreRenderState_FUN_00408b40(CDemonActor * this_ptr)
        ;   XREF to: 00408b40 (UNCONDITIONAL_CALL)
    MOV EAX,[0x0067d550]                ; 0054d808 | CDemonMission g_CDemonMissionInstance | CDemonMission * g_CDemonMissionPtr
    MOV EDX,dword ptr [EAX + 0x4]       ; 0054d80d | DAT_02f33744
    ADD ESP,0x4                         ; 0054d810
    TEST EDX,EDX                        ; 0054d813
    JZ 0x0054d95a                       ; 0054d815 | LAB_0054d95a
        ;   XREF to: 0054d95a (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x006703ec]      ; 0054d81b | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH ECX                            ; 0054d821 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_getFaceCount_FUN_0048cae0 ; 0054d822 | int engine_drender.cpp_CDemonRenderer_getFaceCount_FUN_0048cae0(CDemonRenderer * this_ptr)
        ;   XREF to: 0048cae0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0054d827
    TEST EAX,EAX                        ; 0054d82a
    JNZ 0x0054d95a                      ; 0054d82c | LAB_0054d95a
        ;   XREF to: 0054d95a (CONDITIONAL_JUMP)
    MOV EAX,[0x0067d550]                ; 0054d832 | CDemonMission * g_CDemonMissionPtr
    MOV ESI,dword ptr [EAX + 0x28]      ; 0054d837 | DAT_02f33768
    CMP EBX,ESI                         ; 0054d83a
    JNZ 0x0054d95a                      ; 0054d83c | LAB_0054d95a
        ;   XREF to: 0054d95a (CONDITIONAL_JUMP)
    CMP byte ptr [ESI + 0x2f0],0x0      ; 0054d842
    JNZ 0x0054d95a                      ; 0054d849 | LAB_0054d95a
        ;   XREF to: 0054d95a (CONDITIONAL_JUMP)
    ...
    CALL core_xform.cpp_quaternionToEulerAngles_FUN_005f7ac0 ; 0054d8a8 | CVector3f * core_xform.cpp_quaternionToEulerAngles_FUN_005f7ac0(CVector3f * euler_out, CQuaternion4f * quat_ptr)
        ;   XREF to: 005f7ac0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0054d8ad
    CMP ESI,EAX                         ; 0054d8b0
    JZ 0x0054d8c4                       ; 0054d8b2 | LAB_0054d8c4
    ...
    PUSH 0xfa                           ; 0054d8c4
        ;   Label: LAB_0054d8c4
    PUSH EBX                            ; 0054d8c9
    CALL core_actor.cpp_CDemonActor_renderBoundingBox_FUN_0040d940 ; 0054d8ca | void core_actor.cpp_CDemonActor_renderBoundingBox_FUN_0040d940(CDemonActor * this_ptr, uint32_t color)
    ...
    CALL core_xform.cpp_quaternionToEulerAngles_FUN_005f7ac0 ; 0054d8f7 | CVector3f * core_xform.cpp_quaternionToEulerAngles_FUN_005f7ac0(CVector3f * euler_out, CQuaternion4f * quat_ptr)
        ;   XREF to: 005f7ac0 (UNCONDITIONAL_CALL)
    LEA EDX,[EBX + 0x30]                ; 0054d8fc
    ADD ESP,0x8                         ; 0054d8ff
    CMP EDX,EAX                         ; 0054d902
    JZ 0x0054d916                       ; 0054d904 | LAB_0054d916
    ...
    PUSH 0xf9                           ; 0054d916
        ;   Label: LAB_0054d916
    PUSH EBX                            ; 0054d91b
    CALL core_actor.cpp_CDemonActor_renderBoundingBox_FUN_0040d940 ; 0054d91c | void core_actor.cpp_CDemonActor_renderBoundingBox_FUN_0040d940(CDemonActor * this_ptr, uint32_t color)
        ;   XREF to: 0040d940 (UNCONDITIONAL_CALL)
    ...
    JZ 0x0054d95a                       ; 0054d944 | LAB_0054d95a
        ;   XREF to: 0054d95a (CONDITIONAL_JUMP)
    ...
    POP EBX                             ; 0054d96a
    RET                                 ; 0054d96b
    MOV EDI,dword ptr [0x006703ec]      ; 0054d96c | CDemonRenderer * g_CDemonRendererPtr
        ;   Label: LAB_0054d96c
    PUSH EDI                            ; 0054d972 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_getFaceCount_FUN_0048cae0 ; 0054d973 | int engine_drender.cpp_CDemonRenderer_getFaceCount_FUN_0048cae0(CDemonRenderer * this_ptr)
        ;   XREF to: 0048cae0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0054d978
    TEST EAX,EAX                        ; 0054d97b
    JNZ 0x0054d757                      ; 0054d97d | LAB_0054d757
    ...
    PUSH 0x0                            ; 0054d992
    PUSH EAX                            ; 0054d994
    CALL core_dmodel.cpp_CKeyFramedModelInstance_prepareForRendering_FUN_00478d20 ; 0054d995 | void core_dmodel.cpp_CKeyFramedModelInstance_prepareForRendering_FUN_00478d20(CKeyFramedModelInstance * this_ptr, float animation_frame, int render_flags)
        ;   XREF to: 00478d20 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0054d99a
    JMP 0x0054d802                      ; 0054d99d | LAB_0054d802
