...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_platfrm.cpp_FUN_0054e480()
;
;
; XREF[2]:
;   core_platfrm.cpp_FUN_0054e7d0 at 0054e8e5
;   core_platfrm.cpp_FUN_0054ea00 at 0054eb47
;
; Referenced Globals:
...
section .text
    ...
    PUSH ECX                            ; 0054e48b
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 0054e48c | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0054e491
    MOV EDX,dword ptr [EAX + 0x724]     ; 0054e494
    MOV ECX,EAX                         ; 0054e49a
    CMP EDX,0x3                         ; 0054e49c
    JA 0x0054e4d0                       ; 0054e49f | caseD_3
        ;   XREF to: 0054e4d0 (CONDITIONAL_JUMP)
    JMP dword ptr [EDX*0x4 + 0x54e464]  ; 0054e4a1 | void * switchdataD_0054e464
        ;   Label: switchD
    ...
    MOV dword ptr [EAX + 0x724],0x2     ; 0054e4b8
        ;   Label: caseD_1
    JMP 0x0054e4b2                      ; 0054e4c2 | LAB_0054e4b2
        ;   XREF to: 0054e4b2 (UNCONDITIONAL_JUMP)
    MOV dword ptr [EAX + 0x724],0x3     ; 0054e4c4
        ;   Label: caseD_2
    JMP 0x0054e4b2                      ; 0054e4ce | LAB_0054e4b2
        ;   XREF to: 0054e4b2 (UNCONDITIONAL_JUMP)
