...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_platfrm_cpp_CPlatform_propertyActionTypeCallback_FUN_0054e530 (CPlatform *this_ptr,CActorProperty *property)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0054e530
        ;   Label: core_platfrm.cpp_CPlatform_propertyActionTypeCallback_FUN_0054e530
    PUSH ESI                            ; 0054e531
    PUSH EDI                            ; 0054e532
