...
;
; XREF[1]:
;   core_platfrm.cpp_CPlatform_getPropertyList_FUN_0054e7d0 at 0054e902
;
; Referenced Globals:
...
section .text
    ...
    PUSH ESI                            ; 0054e700
        ;   Label: core_platfrm.cpp_CPlatform_propertyDisplayStateCallback_FUN_0054e700
    PUSH EDI                            ; 0054e701
    ...
    PUSH ECX                            ; 0054e711
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 0054e712
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)  ; CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
    MOV EAX,dword ptr [EAX + 0x2d4]     ; 0054e717
    ADD ESP,0x8                         ; 0054e71d
    TEST EAX,EAX                        ; 0054e720
    JBE 0x0054e74b                      ; 0054e722
        ;   XREF to: 0054e74b (CONDITIONAL_JUMP)  ; LAB_0054e74b
    CMP EAX,0x1                         ; 0054e724
    JNZ 0x0054e752                      ; 0054e727
        ;   XREF to: 0054e752 (CONDITIONAL_JUMP)  ; LAB_0054e752
    MOV ESI,0x63faab                    ; 0054e729 | = "At end"
    PUSH EDI                            ; 0054e72e
        ;   Label: LAB_0054e72e
    MOV AL,byte ptr [ESI]               ; 0054e72f | = "At start" | s_At_end_0063faab | s_end_0063faad
        ;   Label: LAB_0054e72f
    MOV byte ptr [EDI],AL               ; 0054e731
    CMP AL,0x0                          ; 0054e733
    JZ 0x0054e747                       ; 0054e735
        ;   XREF to: 0054e747 (CONDITIONAL_JUMP)  ; LAB_0054e747
    MOV AL,byte ptr [ESI + 0x1]         ; 0054e737 | s_t_start_0063faa3 | s_t_end_0063faac | s_end_0063faae
    ADD ESI,0x2                         ; 0054e73a
    MOV byte ptr [EDI + 0x1],AL         ; 0054e73d
    ADD EDI,0x2                         ; 0054e740
    CMP AL,0x0                          ; 0054e743
    JNZ 0x0054e72f                      ; 0054e745
        ;   XREF to: 0054e72f (CONDITIONAL_JUMP)  ; LAB_0054e72f
    POP EDI                             ; 0054e747
        ;   Label: LAB_0054e747
    POP EDI                             ; 0054e748
    POP ESI                             ; 0054e749
    RET                                 ; 0054e74a
    MOV ESI,0x63faa2                    ; 0054e74b | = "At start"
        ;   Label: LAB_0054e74b
    JMP 0x0054e72e                      ; 0054e750
        ;   XREF to: 0054e72e (UNCONDITIONAL_JUMP)  ; LAB_0054e72e
    MOV ESI,0x63fab2                    ; 0054e752 | = "WTF"
        ;   Label: LAB_0054e752
    JMP 0x0054e72e                      ; 0054e757
        ;   XREF to: 0054e72e (UNCONDITIONAL_JUMP)  ; LAB_0054e72e
