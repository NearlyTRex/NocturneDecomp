...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_dog_cpp_CZombieDog_getPropertyList_FUN_0047f920 (CZombieDog *this_ptr,CActorPropertyList *property_list)
;
; Parameters:
...
section .text
    ...
    PUSH ESI                            ; 0047f92a
    PUSH EBX                            ; 0047f92b
    CALL core_enemy.cpp_CEnemy_getPropertyList_FUN_004aa170 ; 0047f92c
