...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dog.cpp_CZombieDog_FUN_0047f960(CZombieDog * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 0047f964
    CALL core_enemy.cpp_CEnemy_FUN_004aa250 ; 0047f965 | void core_enemy.cpp_CEnemy_FUN_004aa250(CEnemy * this_ptr)
