...
section .text
    ...
    PUSH 0x620f8c                       ; 0047f012 | = "..\\core\\dog.cpp" | s_core_dog_cpp_00620f8c = ..\core\dog.cpp
    PUSH 0xbec8                         ; 0047f017
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1b0 ; 0047f01c | void * shape_memdbg.cpp_debugAlloc_FUN_0050f1b0(int size, char * filename, int line_number)
        ;   XREF to: 0050f1b0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0047f021
    TEST EAX,EAX                        ; 0047f024
    JNZ 0x0047f029                      ; 0047f026 | LAB_0047f029
        ;   XREF to: 0047f029 (CONDITIONAL_JUMP)
    RET                                 ; 0047f028
    PUSH EAX                            ; 0047f029
        ;   Label: LAB_0047f029
    CALL core_dog.cpp_CZombieDog_ctor_FUN_0047f050 ; 0047f02a | CZombieDog * core_dog.cpp_CZombieDog_ctor_FUN_0047f050(CZombieDog * this_ptr)
