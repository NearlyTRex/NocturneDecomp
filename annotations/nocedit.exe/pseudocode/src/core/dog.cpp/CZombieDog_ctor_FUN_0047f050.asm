...
;                               FUNCTION
; *****************************************************************************
; __cdecl CZombieDog * __cdecl core_dog_cpp_CZombieDog_ctor_FUN_0047f050(CZombieDog *this_ptr)
;
; Parameters:
...
;   float FLOAT_0065ca2c = 50
;   float FLOAT_0065ca30 = 100
...
section .text
    ...
    PUSH EAX                            ; 0047f06a
    MOV dword ptr [EAX + -0x4],0x65ca44 ; 0047f06b | g_CZombieDogVTable
    CALL core_skeleton.cpp_CDeformableModelInstance_init_FUN_005a0840 ; 0047f072
        ;   XREF to: 005a0840 (UNCONDITIONAL_CALL)  ; void core_skeleton.cpp_CDeformableModelInstance_init_FUN_005a0840(CDeformableModelInstance * this_ptr, char * model_name)
    FLD float ptr [0x0065ca2c]          ; 0047f077 | FLOAT_0065ca2c
    MOV dword ptr [EBX + 0x2ddc],0x3f400000 ; 0047f07d
    FLD float ptr [0x0065ca30]          ; 0047f087 | FLOAT_0065ca30
