...
section .text
    ...
    PUSH EBX                            ; 0047f9b8
    CALL core_armour.cpp_CFlame_arrdtor50_FUN_00412720 ; 0047f9b9
    ...
    PUSH EAX                            ; 0047f9c8
    CALL core_armour.cpp_SFire_arrdtor50_FUN_00412700 ; 0047f9c9
    ...
    PUSH EAX                            ; 0047f9d8
    CALL core_armour.cpp_CVector3f_arrdtor15_FUN_004126e0 ; 0047f9d9
    ...
    PUSH EAX                            ; 0047f9e8
    CALL core_armour.cpp_CVector3f_arrdtor15_FUN_004126e0 ; 0047f9e9
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; CVector3f * core_armour.cpp_CVector3f_arrdtor15_FUN_004126e0(CVector3f * this_ptr, uint flags)
