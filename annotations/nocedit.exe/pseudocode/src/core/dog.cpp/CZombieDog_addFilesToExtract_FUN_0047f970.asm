...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_dog_cpp_CZombieDog_addFilesToExtract_FUN_0047f970(CZombieDog *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0047f970
        ;   Label: core_dog.cpp_CZombieDog_addFilesToExtract_FUN_0047f970
    MOV EDX,dword ptr [ESP + 0xc]       ; 0047f971
    PUSH EDX                            ; 0047f975
    MOV ECX,dword ptr [ESP + 0xc]       ; 0047f976
    PUSH ECX                            ; 0047f97a
    CALL core_actor.cpp_CDemonActor_addFilesToExtract_FUN_0040cfd0 ; 0047f97b
    ...
    PUSH EAX                            ; 0047f991
    CALL core_skeledit.cpp_CDeformableModelInstance_addFilesToExtract_FUN_0058a260 ; 0047f992
