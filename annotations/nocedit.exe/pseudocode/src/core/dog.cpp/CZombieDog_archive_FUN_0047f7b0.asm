...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_dog_cpp_CZombieDog_archive_FUN_0047f7b0(CZombieDog *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0047f7b0
        ;   Label: core_dog.cpp_CZombieDog_archive_FUN_0047f7b0
    MOV EBX,dword ptr [ESP + 0x8]       ; 0047f7b1
    PUSH EBX                            ; 0047f7b5
    CALL core_enemy.cpp_CEnemy_archive_FUN_004a9660 ; 0047f7b6
    ...
    PUSH EAX                            ; 0047f7c9
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 0047f7ca
    ...
    PUSH EAX                            ; 0047f7dd
    CALL core_actor.cpp_archiveDeformableModelInstance_FUN_0040b970 ; 0047f7de
    ...
    PUSH EBX                            ; 0047f7fc
    CALL core_actor.cpp_archiveMotionState_FUN_0040b9f0 ; 0047f7fd
    ...
    PUSH EAX                            ; 0047f812
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 0047f813
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
