...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dog.cpp_CZombieDog_writeDependencies_FUN_0047f970(CZombieDog * this_ptr, FILE * file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH ECX                            ; 0047f97a
    CALL core_actor.cpp_CDemonActor_writeDependencies_FUN_0040cfd0 ; 0047f97b | void core_actor.cpp_CDemonActor_writeDependencies_FUN_0040cfd0(CDemonActor * this_ptr, FILE * file_handle)
    ...
    PUSH EAX                            ; 0047f991
    CALL core_skeledit.cpp_GetModelPtrOfFile_FUN_0058a260 ; 0047f992 | undefined core_skeledit.cpp_GetModelPtrOfFile_FUN_0058a260()
