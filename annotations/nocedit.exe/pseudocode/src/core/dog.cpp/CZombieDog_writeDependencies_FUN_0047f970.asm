...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_dog_cpp_CZombieDog_writeDependencies_FUN_0047f970(CZombieDog *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 0047f991
    CALL core_skeledit.cpp_CDeformableModelInstance_writeDependencies_FUN_0058a260 ; 0047f992
