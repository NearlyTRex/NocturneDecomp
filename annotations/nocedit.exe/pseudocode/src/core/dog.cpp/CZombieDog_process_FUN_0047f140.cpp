  ...
  *(float *)((this_ptr->base).base.unk1 + 0x2c) = delta_time * fVar5 * fVar3;
  if (iVar7 == 2) {
    *(float *)((this_ptr->base).base.unk1 + 0x2c) =
         *(float *)((this_ptr->base).base.unk1 + 0x2c) * (float)2;
  }
  ...
  if (iVar9 == 0) {
    ...
    case 0:
      ...
      if (extraout_EAX_00 == 0) {
        ...
        if (iVar7 != 0) {
          ...
          local_70 = *(float *)(iVar7 + 0x24) - (this_ptr->base).base.base.location.position.y;
          local_6c = *(float *)(iVar7 + 0x28) - (this_ptr->base).base.base.location.position.z;
    ...
    case 2:
      ...
      if (iVar9 == 0) {
        ...
        local_5c = (this_ptr->base).base.base.location.position.x - *(float *)(iVar9 + 0x20);
        local_58 = (this_ptr->base).base.base.location.position.y - *(float *)(iVar9 + 0x24);
        local_54 = (this_ptr->base).base.base.location.position.z - *(float *)(iVar9 + 0x28);
...
switchD_0047f7a3_caseD_5:
  ...
  if (iVar7 != 0) {
    ...
    *(float *)((this_ptr->base).base.unk1 + 0x20) =
    ...
    local_68 = *(float *)((this_ptr->base).base.unk1 + 0x1c) * delta_time;
    local_64 = *(float *)((this_ptr->base).base.unk1 + 0x20) * delta_time;
    pcVar2 = (this_ptr->base).base.unk1 + 0x10;
    local_60 = delta_time * *(float *)((this_ptr->base).base.unk1 + 0x24);
    pCVar12 = &(this_ptr->base).base.model.accumulated_root_motion;
    local_38 = local_68 + *(float *)pcVar2;
    local_34 = local_64 + *(float *)((this_ptr->base).base.unk1 + 0x14);
    local_30 = local_60 + *(float *)((this_ptr->base).base.unk1 + 0x18);
