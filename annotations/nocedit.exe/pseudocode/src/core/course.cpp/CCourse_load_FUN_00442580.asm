...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_course.cpp_CCourse_load_FUN_00442580(CCourse * this_ptr, char * filename)
;
; Parameters:
...
section .text
    ...
    PUSH EDI                            ; 0044258f
    CALL core_course.cpp_CCourse_free_FUN_004426c0 ; 00442590 | void core_course.cpp_CCourse_free_FUN_004426c0(CCourse * this_ptr)
        ;   XREF to: 004426c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00442595
    PUSH 0x618f25                       ; 00442598 | = "rt" | s_rt_00618f25 = rt
    PUSH EBX                            ; 0044259d
    PUSH 0x618f28                       ; 0044259e | = "data" | s_data_00618f28 = data
    CALL engine_dosio.c_getFile_FUN_00481a50 ; 004425a3 | FILE * engine_dosio.c_getFile_FUN_00481a50(char * directory, char * filename, char * mode)
        ;   XREF to: 00481a50 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004425a8
    MOV EBP,EAX                         ; 004425ab
    TEST EAX,EAX                        ; 004425ad
    JZ 0x0044268b                       ; 004425af | LAB_0044268b
        ;   XREF to: 0044268b (CONDITIONAL_JUMP)
    MOV EBX,EBP                         ; 004425b5
        ;   Label: LAB_004425b5
    PUSH EBX                            ; 004425b7
        ;   Label: LAB_004425b7
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 004425b8 | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004425bd
    TEST EAX,EAX                        ; 004425c0
    JL 0x004425c9                       ; 004425c2 | LAB_004425c9
        ;   XREF to: 004425c9 (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 004425c4
    JNZ 0x004425b7                      ; 004425c7 | LAB_004425b7
    ...
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004425d4 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004425d9
    PUSH EBX                            ; 004425dc
        ;   Label: LAB_004425dc
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 004425dd | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004425e2
    TEST EAX,EAX                        ; 004425e5
    JL 0x004425ee                       ; 004425e7 | LAB_004425ee
        ;   XREF to: 004425ee (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 004425e9
    JNZ 0x004425dc                      ; 004425ec | LAB_004425dc
    ...
    PUSH EBP                            ; 004425fc
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004425fd | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00442602
    MOV EBX,dword ptr [ESP + 0x4]       ; 00442605
    PUSH EBX                            ; 00442609
    PUSH EDI                            ; 0044260a
    CALL core_course.cpp_CCourse_allocMemory_FUN_00442500 ; 0044260b | void core_course.cpp_CCourse_allocMemory_FUN_00442500(CCourse * this_ptr)
        ;   XREF to: 00442500 (UNCONDITIONAL_CALL)
    MOV EBX,EBP                         ; 00442610
    ADD ESP,0x8                         ; 00442612
    PUSH EBX                            ; 00442615
        ;   Label: LAB_00442615
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 00442616 | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0044261b
    TEST EAX,EAX                        ; 0044261e
    JL 0x00442627                       ; 00442620 | LAB_00442627
        ;   XREF to: 00442627 (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 00442622
    JNZ 0x00442615                      ; 00442625 | LAB_00442615
        ;   XREF to: 00442615 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [EDI]             ; 00442627
        ;   Label: LAB_00442627
    XOR EBX,EBX                         ; 00442629
    TEST ESI,ESI                        ; 0044262b
    JLE 0x00442670                      ; 0044262d | LAB_00442670
    ...
    PUSH EDX                            ; 0044264d
    PUSH EAX                            ; 0044264e
    PUSH 0x618f6e                       ; 0044264f | = "%f,%f,%f, %f,%f,%f,%f\n" | s_f_f_f_f_f_f_f_00618f6e = %f,%f,%f, %f,%f,%f,%f

    PUSH EBP                            ; 00442654
    INC EBX                             ; 00442655
    ADD ESI,0x1c                        ; 00442656
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 00442659 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EDI]             ; 0044265e
    ADD ESP,0x24                        ; 00442660
    CMP EBX,EAX                         ; 00442663
    JL 0x00442631                       ; 00442665 | LAB_00442631
        ;   XREF to: 00442631 (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 00442667
    LEA EDX,[EDX]                       ; 0044266d
    PUSH 0x9e                           ; 00442670
        ;   Label: LAB_00442670
    PUSH 0x618f85                       ; 00442675 | = "..\\core\\course.cpp" | s_core_course_cpp_00618f85 = ..\core\course.cpp
    PUSH EBP                            ; 0044267a
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 0044267b | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
    ...
    PUSH EBX                            ; 0044268b
        ;   Label: LAB_0044268b
    MOV EDX,0x618f2d                    ; 0044268c | = "..\\core\\course.cpp" | s_core_course_cpp_00618f2d = ..\core\course.cpp
    MOV ECX,0x7c                        ; 00442691
    PUSH 0x618f40                       ; 00442696 | = "CCourse::load - can't open data\\%s" | s_CCourse_load_can_t_open__00618f40 = CCourse::load - can't open data\%s
    MOV dword ptr [0x02f0ca48],EDX      ; 0044269b | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 004426a1 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004426a7 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004426ac
    JMP 0x004425b5                      ; 004426af | LAB_004425b5
