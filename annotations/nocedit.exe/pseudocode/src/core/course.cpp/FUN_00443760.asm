...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_course.cpp_FUN_00443760()
;
; Local Variables:
...
section .text
    ...
    JZ 0x0044378d                       ; 00443777 | LAB_0044378d
    ...
    FLD float ptr [EDI]                 ; 0044378d
        ;   Label: LAB_0044378d
    CALL crt_math.c_round_FUN_005fe6b0  ; 0044378f | double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 004437b2 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 004437df | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    MOV EDX,dword ptr [0x006703e8]      ; 00443820 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    MOV dword ptr [ESP + 0x88],EAX      ; 00443826
    PUSH EDX                            ; 0044382d | CDemonRenderer g_CDemonRendererInstance
    FILD dword ptr [ESP + 0x8c]         ; 0044382e
    FSTP float ptr [EDI + 0x8]          ; 00443835
    CALL engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450 ; 00443838 | void engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450(CDemonRenderer * this_ptr, CVector3f * world_position)
    ...
    MOV EDX,dword ptr [0x006703e8]      ; 00443871 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    ...
    FMUL float ptr [0x0065c060]         ; 004438bf | float FLOAT_0065c060
    FISTP dword ptr [EBX]               ; 004438c5
    FLD float ptr [EAX + 0x4]           ; 004438c7
    FMUL float ptr [0x0065c060]         ; 004438ca | float FLOAT_0065c060
    FISTP dword ptr [EBX + 0x4]         ; 004438d0
    FLD float ptr [EAX + 0x8]           ; 004438d3
    FMUL float ptr [0x0065c060]         ; 004438d6 | float FLOAT_0065c060
    FISTP dword ptr [EBX + 0x8]         ; 004438dc
    LEA EAX,[ESP + 0x64]                ; 004438df
    PUSH EAX                            ; 004438e3
    MOV EAX,dword ptr [EDX]             ; 004438e4 | CDemonRenderer g_CDemonRendererInstance
    PUSH EAX                            ; 004438e6
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 004438e7 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    MOV EBX,dword ptr [0x006703e8]      ; 004438ec | CDemonRenderer * g_CDemonRendererPtr
    MOV EBX,dword ptr [EBX]             ; 004438f2 | CDemonRenderer g_CDemonRendererInstance
    MOV AH,byte ptr [EBX + 0x13]        ; 004438f4
    ADD ESP,0x8                         ; 004438f7
    TEST AH,0x80                        ; 004438fa
    JZ 0x00443b38                       ; 004438fd | LAB_00443b38
        ;   XREF to: 00443b38 (CONDITIONAL_JUMP)
    ADD ESI,0x10                        ; 00443903
        ;   Label: LAB_00443903
    CMP ESI,0x90                        ; 00443906
    JNZ 0x00443866                      ; 0044390c | LAB_00443866
    ...
    JNZ 0x0044385d                      ; 0044391f | LAB_0044385d
    ...
    JNZ 0x00443849                      ; 00443932 | LAB_00443849
        ;   XREF to: 00443849 (CONDITIONAL_JUMP)
    LEA EAX,[ESP + 0x58]                ; 00443938
    PUSH EAX                            ; 0044393c
    MOV EDI,dword ptr [0x006703e8]      ; 0044393d | CDemonRenderer * g_CDemonRendererPtr
    PUSH EDI                            ; 00443943 | CDemonRenderer g_CDemonRendererInstance
    LEA EBX,[ESP + 0x24]                ; 00443944
    XOR EBP,EBP                         ; 00443948
    CALL engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450 ; 0044394a | void engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450(CDemonRenderer * this_ptr, CVector3f * world_position)
        ;   XREF to: 0048c450 (UNCONDITIONAL_CALL)
    LEA EAX,[ESP + 0x54]                ; 0044394f
    ADD ESP,0x8                         ; 00443953
    MOV EDX,dword ptr [0x006703e8]      ; 00443956 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    ...
    FMUL float ptr [0x0065c060]         ; 0044396a | float FLOAT_0065c060
    FISTP dword ptr [EBX]               ; 00443970
    FLD float ptr [EAX + 0x4]           ; 00443972
    FMUL float ptr [0x0065c060]         ; 00443975 | float FLOAT_0065c060
    FISTP dword ptr [EBX + 0x4]         ; 0044397b
    FLD float ptr [EAX + 0x8]           ; 0044397e
    FMUL float ptr [0x0065c060]         ; 00443981 | float FLOAT_0065c060
    FISTP dword ptr [EBX + 0x8]         ; 00443987
    LEA EAX,[ESP + 0x1c]                ; 0044398a
    PUSH EAX                            ; 0044398e
    MOV EAX,dword ptr [EDX]             ; 0044398f | CDemonRenderer g_CDemonRendererInstance
    PUSH EAX                            ; 00443991
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 00443992 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    MOV ECX,0x40400000                  ; 00443997
    LEA EBX,[ESP + 0x48]                ; 0044399c
    LEA EAX,[ESP + 0x54]                ; 004439a0
    ADD ESP,0x8                         ; 004439a4
    MOV EDX,dword ptr [0x006703e8]      ; 004439a7 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    ...
    FMUL float ptr [0x0065c060]         ; 004439bb | float FLOAT_0065c060
    FISTP dword ptr [EBX]               ; 004439c1
    FLD float ptr [EAX + 0x4]           ; 004439c3
    FMUL float ptr [0x0065c060]         ; 004439c6 | float FLOAT_0065c060
    FISTP dword ptr [EBX + 0x4]         ; 004439cc
    FLD float ptr [EAX + 0x8]           ; 004439cf
    FMUL float ptr [0x0065c060]         ; 004439d2 | float FLOAT_0065c060
    FISTP dword ptr [EBX + 0x8]         ; 004439d8
    LEA EAX,[ESP + 0x40]                ; 004439db
    PUSH EAX                            ; 004439df
    MOV EAX,dword ptr [EDX]             ; 004439e0 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0x30                        ; 004439e2
    PUSH EAX                            ; 004439e5
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 004439e6 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    LEA EBX,[ESP + 0x30]                ; 004439eb
    MOV EDX,dword ptr [0x006703e8]      ; 004439ef | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    ...
    FMUL float ptr [0x0065c060]         ; 00443a11 | float FLOAT_0065c060
    FISTP dword ptr [EBX]               ; 00443a17
    FLD float ptr [EAX + 0x4]           ; 00443a19
    FMUL float ptr [0x0065c060]         ; 00443a1c | float FLOAT_0065c060
    FISTP dword ptr [EBX + 0x4]         ; 00443a22
    FLD float ptr [EAX + 0x8]           ; 00443a25
    FMUL float ptr [0x0065c060]         ; 00443a28 | float FLOAT_0065c060
    FISTP dword ptr [EBX + 0x8]         ; 00443a2e
    LEA EAX,[ESP + 0x28]                ; 00443a31
    PUSH EAX                            ; 00443a35
    MOV EAX,dword ptr [EDX]             ; 00443a36 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0x60                        ; 00443a38
    PUSH EAX                            ; 00443a3b
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 00443a3c | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ...
    MOV EDX,dword ptr [0x006703e8]      ; 00443a5a | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    FLD float ptr [EAX]                 ; 00443a60
    FMUL float ptr [0x0065c060]         ; 00443a62 | float FLOAT_0065c060
    FISTP dword ptr [EBX]               ; 00443a68
    FLD float ptr [EAX + 0x4]           ; 00443a6a
    FMUL float ptr [0x0065c060]         ; 00443a6d | float FLOAT_0065c060
    FISTP dword ptr [EBX + 0x4]         ; 00443a73
    FLD float ptr [EAX + 0x8]           ; 00443a76
    FMUL float ptr [0x0065c060]         ; 00443a79 | float FLOAT_0065c060
    FISTP dword ptr [EBX + 0x8]         ; 00443a7f
    LEA EAX,[ESP + 0x34]                ; 00443a82
    PUSH EAX                            ; 00443a86
    MOV EAX,dword ptr [EDX]             ; 00443a87 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,ESI                         ; 00443a89
    PUSH EAX                            ; 00443a8b
    XOR EDI,EDI                         ; 00443a8c
    MOV EBP,0x1                         ; 00443a8e
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 00443a93 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ...
    CALL engine_3d.c_processPolygonColor_FUN_00403e30 ; 00443aba | SMRGLHeaderExtended * engine_3d.c_processPolygonColor_FUN_00403e30(SMRGLHeaderPrimitive * polygon_info)
        ;   XREF to: 00403e30 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00443abf
    MOV EAX,ESP                         ; 00443ac2
    PUSH EAX                            ; 00443ac4
    CALL engine_3d.c_drawLineStrip2D_FUN_00404570 ; 00443ac5 | SMRGLHeaderExtended * engine_3d.c_drawLineStrip2D_FUN_00404570(SLineStrip * line_strip)
        ;   XREF to: 00404570 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00443aca
    MOV EAX,ESP                         ; 00443acd
    PUSH EAX                            ; 00443acf
    MOV dword ptr [ESP + 0x10],ESI      ; 00443ad0
    CALL engine_3d.c_drawLineStrip2D_FUN_00404570 ; 00443ad4 | SMRGLHeaderExtended * engine_3d.c_drawLineStrip2D_FUN_00404570(SLineStrip * line_strip)
        ;   XREF to: 00404570 (UNCONDITIONAL_CALL)
    ...
    CALL engine_3d.c_drawLineStrip2D_FUN_00404570 ; 00443ae8 | SMRGLHeaderExtended * engine_3d.c_drawLineStrip2D_FUN_00404570(SLineStrip * line_strip)
        ;   XREF to: 00404570 (UNCONDITIONAL_CALL)
    MOV EAX,[0x006703e8]                ; 00443aed | CDemonRenderer * g_CDemonRendererPtr
    MOV ESI,0x4                         ; 00443af2
    MOV EBX,dword ptr [EAX]             ; 00443af7 | CDemonRenderer g_CDemonRendererInstance
    ADD ESP,0x4                         ; 00443af9
    ADD EBX,0x30                        ; 00443afc
    TEST byte ptr [EBX + 0x13],0x80     ; 00443aff
        ;   Label: LAB_00443aff
    JNZ 0x00443b22                      ; 00443b03 | LAB_00443b22
    ...
    PUSH EAX                            ; 00443b12
    MOV EDI,dword ptr [ESI + 0x66ec50]  ; 00443b13 | void * PTR_s_x_0066ec54 | PTR_s_y_0066ec58 = 00619451
    PUSH EDI                            ; 00443b19 | = "x" | s_x_0061944f = x | s_y_00619451 = y
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 00443b1a | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
    ...
    JNZ 0x00443aff                      ; 00443b2b | LAB_00443aff
    ...
    JL 0x00443bb4                       ; 00443b51 | LAB_00443bb4
        ;   XREF to: 00443bb4 (CONDITIONAL_JUMP)
    CMP EDX,0xff                        ; 00443b53
    JLE 0x00443b60                      ; 00443b59 | LAB_00443b60
    ...
    MOV AL,byte ptr [EDX + EAX*0x1 + 0x2cf9020] ; 00443b79 | uchar[32768] g_ColorCubeLookup
    PUSH 0x1                            ; 00443b80
    AND EAX,0xff                        ; 00443b82
    PUSH EBX                            ; 00443b87
    MOV [0x02d02570],EAX                ; 00443b88 | int g_ActiveRenderColor
    CALL engine_prim.c_replaceWWithDepth_FUN_00552110 ; 00443b8d | void engine_prim.c_replaceWWithDepth_FUN_00552110(SRenderVertex * vertices, int vertex_count)
    ...
    PUSH EAX                            ; 00443ba6
    CALL engine_2d.c_plotPixelWithDepth_FUN_00401290 ; 00443ba7 | void engine_2d.c_plotPixelWithDepth_FUN_00401290(int x_coord, int y_coord, uint depth_value)
        ;   XREF to: 00401290 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00443bac
    JMP 0x00443903                      ; 00443baf | LAB_00443903
        ;   XREF to: 00443903 (UNCONDITIONAL_JUMP)
    XOR EDX,EDX                         ; 00443bb4
        ;   Label: LAB_00443bb4
    JMP 0x00443b60                      ; 00443bb6 | LAB_00443b60
