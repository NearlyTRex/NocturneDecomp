...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_course.cpp_CCourse_save_FUN_00442a90(CCourse * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH 0x618fb3                       ; 00442a9c | = "wt" | s_wt_00618fb3 = wt
    PUSH ESI                            ; 00442aa1
    PUSH 0x618fb6                       ; 00442aa2 | = "data" | s_data_00618fb6 = data
    CALL engine_dosio.c_getFile_FUN_00481a50 ; 00442aa7 | FILE * engine_dosio.c_getFile_FUN_00481a50(char * directory, char * filename, char * mode)
        ;   XREF to: 00481a50 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 00442aac
    ADD ESP,0xc                         ; 00442aae
    MOV EBP,EAX                         ; 00442ab1
    TEST EAX,EAX                        ; 00442ab3
    JZ 0x00442b98                       ; 00442ab5 | LAB_00442b98
        ;   XREF to: 00442b98 (CONDITIONAL_JUMP)
    PUSH 0x618fd0                       ; 00442abb | = "// version\n" | s_version_00618fd0 = // version

    PUSH EAX                            ; 00442ac0
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00442ac1 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    PUSH EBX                            ; 00442ad0
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00442ad1 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00442ad6
    PUSH 0x618fe0                       ; 00442ad9 | = "// len,loop\n" | s_len_loop_00618fe0 = // len,loop

    PUSH EBX                            ; 00442ade
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00442adf | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH EBX                            ; 00442af3
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00442af4 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00442af9
    PUSH 0x618ff4                       ; 00442afc | = "// frameList: pos(x,y,z), orient(w,x,..." | s_frameList_pos_x_y_z_orie_00618ff4 = // frameList: pos(x,y,z), orient(w,x,y,z)

    PUSH EBX                            ; 00442b01
    XOR ESI,ESI                         ; 00442b02
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00442b04 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    MOV EBX,dword ptr [EDI]             ; 00442b09
    ADD ESP,0x8                         ; 00442b0b
    TEST EBX,EBX                        ; 00442b0e
    JLE 0x00442b80                      ; 00442b10 | LAB_00442b80
    ...
    PUSH 0x61901f                       ; 00442b5c | = "%g,%g,%g, %g,%g,%g,%g\n" | s_g_g_g_g_g_g_g_0061901f = %g,%g,%g, %g,%g,%g,%g

    PUSH EBP                            ; 00442b61
    ADD EBX,0x1c                        ; 00442b62
    INC ESI                             ; 00442b65
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00442b66 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EDI]             ; 00442b6b
    ADD ESP,0x40                        ; 00442b6d
    CMP ESI,EAX                         ; 00442b70
    JL 0x00442b14                       ; 00442b72 | LAB_00442b14
        ;   XREF to: 00442b14 (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 00442b74
    LEA EDX,[EDX]                       ; 00442b7a
    PUSH 0x140                          ; 00442b80
        ;   Label: LAB_00442b80
    PUSH 0x619036                       ; 00442b85 | = "..\\core\\course.cpp" | s_core_course_cpp_00619036 = ..\core\course.cpp
    PUSH EBP                            ; 00442b8a
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 00442b8b | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
    ...
    PUSH ESI                            ; 00442b98
        ;   Label: LAB_00442b98
    PUSH 0x618fbb                       ; 00442b99 | = "Can't create data\\%s" | s_Can_t_create_data_s_00618fbb = Can't create data\%s
    MOV ESI,dword ptr [0x00678a60]      ; 00442b9e | CEditorTools * g_CEditorToolsPtr
    PUSH ESI                            ; 00442ba4 | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_showError_FUN_0049e740 ; 00442ba5 | void shape_edittool.cpp_CEditorTools_showError_FUN_0049e740(CEditorTools * this_ptr, char * format)
