...
section .text
    ...
    PUSH EBX                            ; 00442bc0
        ;   Label: core_course.cpp_CCourse_importBON_FUN_00442bc0
    PUSH ESI                            ; 00442bc1
    PUSH EDI                            ; 00442bc2
    PUSH EBP                            ; 00442bc3
    ...
    PUSH EAX                            ; 00442ca7
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 00442ca8
    ...
    CALL core_course.cpp_CCourse_importMatrices_FUN_00442ea0 ; 00442cd3
        ;   XREF to: 00442ea0 (UNCONDITIONAL_CALL)  ; void core_course.cpp_CCourse_importMatrices_FUN_00442ea0(CCourse * this_ptr, _FILE * file_handle, int count)
