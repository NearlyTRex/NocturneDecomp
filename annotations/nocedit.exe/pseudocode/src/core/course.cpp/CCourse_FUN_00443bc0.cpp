// Name: core_course.cpp_CCourse_FUN_00443bc0
// Address: 00443bc0
// Address Range: [[00443bc0, 00443f2b] [00443f2f, 004440c9]]
// Convention: __cdecl
// Signature: void __cdecl core_course_cpp_CCourse_FUN_00443bc0(CCourse *this_ptr,CKeyFramedModel *param_2)
...

{
  ...
  while( true ) {
    ...
    while (local_34 < this_ptr->len) {
      ...
      vertex1.light = (int)in_stack_fffffe94;
      vertex1.color = (int)in_stack_fffffe98;
    ...
    in_stack_fffffebc = SUB84(dVar8,0);
    if (iVar2 != 0) {
