...
// Convention: __cdecl
// Signature: int __cdecl core_course_cpp_CCourse_FUN_00442bc0(CCourse *this_ptr)

#include "nocturne.h"

int __cdecl core_course_cpp_CCourse_FUN_00442bc0(CCourse *this_ptr)

{
  ...
  _sprintf(local_184,"Importing %s");
