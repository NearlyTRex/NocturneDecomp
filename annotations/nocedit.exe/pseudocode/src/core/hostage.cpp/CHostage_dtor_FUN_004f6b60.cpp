// Name: core_hostage.cpp_CHostage_dtor_FUN_004f6b60
// Address: 004f6b60
// Address Range: [[004f6b60, 004f6c28]]
// Convention: __cdecl
// Signature: CHostage * __cdecl core_hostage_cpp_CHostage_dtor_FUN_004f6b60(CHostage *this_ptr,uint flags)
...
{
  CHostage_ptr_48676 pCVar1;
  CHostage_ptr_13260 pCVar2;
  CHostage_ptr_12060 pSVar1;
  CHostage_ptr_11536 pCVar3;
  CHostage_ptr_11356 pCVar4;
  CHostage_ptr_10900 pCVar5;
  CHostage_ptr_344 pCVar6;
  CHostage *ptr;
  void *ptr_00;
  ...
  ptr = (CHostage *)core_actor_cpp_CDemonActor_dtor_FUN_00408a30((CDemonActor *)ADJ(pCVar6),1);
  if ((flags & 2) == 0) {
    return ptr;
  }
