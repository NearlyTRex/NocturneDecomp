...
; Local Variables:
; float[12]        Stack[-0x294]:48  local_294
; CMatrix3x4f[2]   Stack[-0x264]:96  local_264
; CMatrix3x4f      Stack[-0x204]:48  local_204
; CMatrix3x4f[2]   Stack[-0x1d4]:96  local_1d4
...
; CVector3f[2]     Stack[-0x78]:24  local_78
...
section .text
    ...
    PUSH EBX                            ; 004f6550
        ;   Label: core_hostage.cpp_CHostage_getCarryObjToBodyXForm_FUN_004f6550
    PUSH EDI                            ; 004f6551
    PUSH EBP                            ; 004f6552
    ...
    JMP 0x03fc58b4                      ; 004f6696
        ;   XREF to: 03fc58b4 (UNCONDITIONAL_JUMP)  ; LAB_03fc58b4
        ;   Label: LAB_004f6696
    JMP 0x03fc52d7                      ; 004f669b
        ;   XREF to: 03fc52d7 (UNCONDITIONAL_JUMP)  ; LAB_03fc52d7
        ;   Label: LAB_004f669b
    ...
    JMP 0x004f6696                      ; 004f69b4
        ;   XREF to: 004f6696 (UNCONDITIONAL_JUMP)  ; LAB_004f6696
    MOV ECX,0xc                         ; 03fc52d7
        ;   Label: LAB_03fc52d7
    MOV ESI,ESP                         ; 03fc52dc
    MOV EDI,EBX                         ; 03fc52de
    MOV ECX,dword ptr [ESI]             ; 03fc52e0
    MOV dword ptr [EDI],ECX             ; 03fc52e2
    MOV ECX,dword ptr [ESI + 0x4]       ; 03fc52e4
    MOV dword ptr [EDI + 0x4],ECX       ; 03fc52e7
    MOV ECX,dword ptr [ESI + 0x8]       ; 03fc52ea
    MOV dword ptr [EDI + 0x8],ECX       ; 03fc52ed
    MOV ECX,dword ptr [ESI + 0xc]       ; 03fc52f0
    MOV dword ptr [EDI + 0xc],ECX       ; 03fc52f3
    MOV ECX,dword ptr [ESI + 0x10]      ; 03fc52f6
    MOV dword ptr [EDI + 0x10],ECX      ; 03fc52f9
    MOV ECX,dword ptr [ESI + 0x14]      ; 03fc52fc
    MOV dword ptr [EDI + 0x14],ECX      ; 03fc52ff
    MOV ECX,dword ptr [ESI + 0x18]      ; 03fc5302
    MOV dword ptr [EDI + 0x18],ECX      ; 03fc5305
    MOV ECX,dword ptr [ESI + 0x1c]      ; 03fc5308
    MOV dword ptr [EDI + 0x1c],ECX      ; 03fc530b
    MOV ECX,dword ptr [ESI + 0x20]      ; 03fc530e
    MOV dword ptr [EDI + 0x20],ECX      ; 03fc5311
    MOV ECX,dword ptr [ESI + 0x24]      ; 03fc5314
    MOV dword ptr [EDI + 0x24],ECX      ; 03fc5317
    MOV ECX,dword ptr [ESI + 0x28]      ; 03fc531a
    MOV dword ptr [EDI + 0x28],ECX      ; 03fc531d
    MOV ECX,dword ptr [ESI + 0x2c]      ; 03fc5320
    MOV dword ptr [EDI + 0x2c],ECX      ; 03fc5323
    ADD ESI,0x30                        ; 03fc5326
    ADD EDI,0x30                        ; 03fc5329
    XOR ECX,ECX                         ; 03fc532c
    JMP 0x004f66a6                      ; 03fc532e
        ;   XREF to: 004f66a6 (UNCONDITIONAL_JUMP)  ; LAB_004f66a6
    ADD ESP,0x8                         ; 03fc58b4
        ;   Label: LAB_03fc58b4
    MOV ECX,dword ptr [ESI]             ; 03fc58b7
    MOV dword ptr [EDI],ECX             ; 03fc58b9
    MOV ECX,dword ptr [ESI + 0x4]       ; 03fc58bb
    MOV dword ptr [EDI + 0x4],ECX       ; 03fc58be
    MOV ECX,dword ptr [ESI + 0x8]       ; 03fc58c1
    MOV dword ptr [EDI + 0x8],ECX       ; 03fc58c4
    MOV ECX,dword ptr [ESI + 0xc]       ; 03fc58c7
    MOV dword ptr [EDI + 0xc],ECX       ; 03fc58ca
    MOV ECX,dword ptr [ESI + 0x10]      ; 03fc58cd
    MOV dword ptr [EDI + 0x10],ECX      ; 03fc58d0
    MOV ECX,dword ptr [ESI + 0x14]      ; 03fc58d3
    MOV dword ptr [EDI + 0x14],ECX      ; 03fc58d6
    MOV ECX,dword ptr [ESI + 0x18]      ; 03fc58d9
    MOV dword ptr [EDI + 0x18],ECX      ; 03fc58dc
    MOV ECX,dword ptr [ESI + 0x1c]      ; 03fc58df
    MOV dword ptr [EDI + 0x1c],ECX      ; 03fc58e2
    MOV ECX,dword ptr [ESI + 0x20]      ; 03fc58e5
    MOV dword ptr [EDI + 0x20],ECX      ; 03fc58e8
    MOV ECX,dword ptr [ESI + 0x24]      ; 03fc58eb
    MOV dword ptr [EDI + 0x24],ECX      ; 03fc58ee
    MOV ECX,dword ptr [ESI + 0x28]      ; 03fc58f1
    MOV dword ptr [EDI + 0x28],ECX      ; 03fc58f4
    MOV ECX,dword ptr [ESI + 0x2c]      ; 03fc58f7
    MOV dword ptr [EDI + 0x2c],ECX      ; 03fc58fa
    ADD ESI,0x30                        ; 03fc58fd
    ADD EDI,0x30                        ; 03fc5900
    XOR ECX,ECX                         ; 03fc5903
    JMP 0x004f669b                      ; 03fc5905
        ;   XREF to: 004f669b (UNCONDITIONAL_JUMP)  ; LAB_004f669b
