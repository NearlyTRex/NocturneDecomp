...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_hostage_cpp_CHostage_writeDependencies_FUN_004f6b30(CHostage *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004f6b30
        ;   Label: core_hostage.cpp_CHostage_writeDependencies_FUN_004f6b30
    ...
    PUSH EAX                            ; 004f6b51
    CALL core_skeledit.cpp_CDeformableModelInstance_writeDependencies_FUN_0058a260 ; 004f6b52
