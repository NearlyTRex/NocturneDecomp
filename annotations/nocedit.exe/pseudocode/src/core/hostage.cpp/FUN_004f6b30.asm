...
section .text
    ...
    PUSH ECX                            ; 004f6b3a
    CALL core_actor.cpp_CDemonActor_writeDependencies_FUN_0040cfd0 ; 004f6b3b | void core_actor.cpp_CDemonActor_writeDependencies_FUN_0040cfd0(CDemonActor * this_ptr, FILE * file_handle)
    ...
    PUSH EAX                            ; 004f6b51
    CALL core_skeledit.cpp_GetModelPtrOfFile_FUN_0058a260 ; 004f6b52 | undefined core_skeledit.cpp_GetModelPtrOfFile_FUN_0058a260()
