...

{
  ...
  while (0.0 < local_1a0) {
    uVar14 = core_motion_cpp_CMotionController_advance_FUN_0052d610(local_28,&local_1a0);
    if (uVar14 < 0xb) {
      if (uVar14 == 6) {
...
LAB_004f4dd2:
      ...
      if (pCVar20 != (CDemonActor *)0x0) {
        ...
        core_inv_cpp_CInventory_addItem_FUN_004fd600
                  (&g_HeroActors[g_LocalHeroIndex]->inventory,pCVar20,1);
      }
    }
    else {
      core_charactr_cpp_CCharacter_processMotion_FUN_0042ec40((CCharacter *)this_ptr,uVar14);
  ...
  if (pCVar20 == (CDemonActor *)0x0) {
    ...
    if (iVar13 == 0) {
      ...
      case 0:
        ...
        break;
      case 1:
        pCVar20 = this_ptr->goal_way_point;
        if ((pCVar20 != (CDemonActor *)0x0) &&
           (fVar3 = (this_ptr->base).base.base.location.position.x - (pCVar20->location).position.x,
           fVar4 = (this_ptr->base).base.base.location.position.z - (pCVar20->location).position.z,
           SQRT(fVar4 * fVar4 + fVar3 * fVar3) < (float)40)) {
          pCVar20 = (CDemonActor *)
                    core_waypoint_cpp_CWayPoint_FUN_005ec320
                              ((CWayPoint *)&(this_ptr->base).base.base.location);
          this_ptr->next_way_point = pCVar20;
        }
        pCVar12 = g_CConsolePtr;
...
LAB_004f579d:
      ...
      case 4:
        ...
        if (this_ptr->sit_down_way_point != (CDemonActor *)0x0) {
          ...
          if (pCVar16 != pCVar17) {
            pCVar16->x = pCVar17->x;
            (this_ptr->base).base.position_delta.y = pCVar17->y;
            (this_ptr->base).base.position_delta.z = pCVar17->z;
          }
          pCVar16 = &(this_ptr->base).base.position_delta;
          local_a4 = pCVar16->x;
          ...
          if (fVar3 < 1.0) {
            ...
            (this_ptr->base).base.turn_angle_accumulator =
                 (1.0 - fVar3) * local_18 + (this_ptr->base).base.turn_angle_accumulator;
          }
          local_18 = core_actor_cpp_normalizeAngleToPi_FUN_0040cd70
                               ((this_ptr->base).base.turn_angle_accumulator);
...
LAB_004f54c2:
    ...
    pCVar16 = core_actor_cpp_CDemonActor_worldToLocalPoint_FUN_00408f10
                        ((CDemonActor *)this_ptr,&local_d4,&(pCVar20->location).position);
    ...
    iVar13 = (*(pCVar6->_uc).attractActorToward)(pCVar5,(CDemonActor *)this_ptr,pCVar16);
    if (iVar13 == 0) {
...
switchD_004f5c7d_caseD_5:
  ...
  if (local_2c == 0) {
    ...
    local_b0.x = local_128 + pCVar17->x;
...
LAB_004f50f1:
  ...
  if (this_ptr->hostage_type == 1) {
    ...
    if (((pCVar19 != (CWeapon *)0x0) &&
       ...
       (local_4c != 0)) {
      fVar3 = delta_time / local_48 + this_ptr->gun_blend_weight;
    }
    else {
      fVar3 = this_ptr->gun_blend_weight - delta_time / local_48;
    }
    this_ptr->gun_blend_weight = fVar3;
    if (0.0 < this_ptr->gun_blend_weight) {
      ...
      if (((1.0 <= this_ptr->gun_blend_weight) && (0.0 < this_ptr->gun_raise_progress)) &&
         (fVar3 = delta_time / local_54 + this_ptr->gun_raise_progress,
         this_ptr->gun_raise_progress = fVar3, 1.0 < fVar3)) {
  ...
  if ((1.0 <= this_ptr->gun_raise_progress) &&
    ...
    iVar13 = pCVar18->ammo_type;
    pCVar18->ammo_type = 6;
    (*(((pCVar18->base).vtable._uw)->_uw).fire)(pCVar18);
    pCVar18->ammo_type = iVar13;
    core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
  ...
  if (((this_ptr->hostage_type == 1) &&
      (pCVar20 = core_actor_cpp_castToClassHash_FUN_0040c790
                           ((this_ptr->base).base.carry_hands[1].carry_actor,
                            g_CWeaponClassInfo.name_hash), pCVar20 != (CDemonActor *)0x0)) &&
     (iVar13 = core_event_cpp_CEventList_evaluateCondition_FUN_004adca0
