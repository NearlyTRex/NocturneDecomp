    ...
    if (uVar15 < 0xb) {
      if (uVar15 == 6) {
        ...
        if (pCVar18 != (CDemonActor *)0x0) {
          ...
          pCVar19 = (CCharacter *)(this_ptr->base).base.grabbed_by;
          local_18 = local_194.damage_amount;
          (*(((pCVar19->base).vtable._uc)->_uc).processDamage)(pCVar19,&local_194);
        }
      }
      else {
      ...
      while (iVar14 < (int)g_CDemonSetPtr->actor_list_ptr) {
        pCVar16 = (CDoor *)core_actor_cpp_castToClassHash_FUN_0040c790
                                     (*(CDemonActor **)(g_CDemonSetPtr->actor_list_data + iVar22),
...
LAB_004f4dd2:
      ...
      if (pCVar18 != (CDemonActor *)0x0) {
        ...
        in_stack_fffffe40 = CONCAT44(pCVar18,&g_HeroActors[g_LocalHeroIndex]->inventory);
  ...
  if (pCVar18 == (CDemonActor *)0x0) {
    ...
    if (iVar14 == 0) {
      ...
      case 1:
        ...
        if ((pCVar18 != (CDemonActor *)0x0) &&
           (fVar5 = (this_ptr->base).base.base.location.position.x - (pCVar18->location).position.x,
...
LAB_004f579d:
      ...
      case 4:
        ...
        if (this_ptr->sit_down_way_point != (CDemonActor *)0x0) {
          ...
          if (pCVar17 != pCVar20) {
            pCVar17->x = pCVar20->x;
            (this_ptr->base).base.field6_0x241c.y = pCVar20->y;
            (this_ptr->base).base.field6_0x241c.z = pCVar20->z;
          }
          pCVar17 = &(this_ptr->base).base.field6_0x241c;
          local_a4 = pCVar17->x;
...
LAB_004f54c2:
    ...
    pCVar19 = (CCharacter *)(this_ptr->base).base.grabbed_by;
    pCVar6 = (pCVar19->base).vtable._uc;
    ...
    iVar14 = (*(pCVar6->_uc).attractActorToward)(pCVar19,(CDemonActor *)this_ptr,pCVar17);
    if (iVar14 == 0) {
...
switchD_004f5c7d_caseD_5:
     ...
     (iVar14 = core_actor_cpp_randomChance_FUN_0040cd10(delta_time * 0.2f), iVar14 != 0))
  {
    ...
    iVar14 = core_skeleton_cpp_CSkeleton_findBone_FUN_00599fc0(this_ptr_00,bone_name);
    if (-1 < iVar14) {
  ...
  if (local_2c == 0) {
    ...
    *(float *)((this_ptr->base).base.field53_0x2dc4 + 0x10) =
    ...
    if ((dVar23 * 0.59999999999999998 <=
       ...
       SQRT(dVar11 * dVar11 + dVar10 * dVar10 + dVar9 * dVar9) <= dVar23 * 0.40000000000000002))
    goto LAB_004f50f1;
  }
  else {
  ...
  if ((1.0 <= (float)this_ptr->unk4) &&
     (pCVar19 = (CCharacter *)
                core_actor_cpp_castToClassHash_FUN_0040c790
                          ((this_ptr->base).base.carry_hands[1].carry_actor,
                           g_CWeaponClassInfo.name_hash), pCVar19 != (CCharacter *)0x0)) {
    fVar5 = (pCVar19->model).transformed_vertices[0x4f].z;
    (pCVar19->model).transformed_vertices[0x4f].z = 8.40779e-45;
    (*(((pCVar19->base).vtable._uc)->_uc).isGrabbable)(pCVar19);
