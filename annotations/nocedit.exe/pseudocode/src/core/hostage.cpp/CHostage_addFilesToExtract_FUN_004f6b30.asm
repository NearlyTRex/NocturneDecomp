...
section .text
    ...
    PUSH EBX                            ; 004f6b30
        ;   Label: core_hostage.cpp_CHostage_addFilesToExtract_FUN_004f6b30
    MOV EDX,dword ptr [ESP + 0xc]       ; 004f6b31
    PUSH EDX                            ; 004f6b35
    MOV ECX,dword ptr [ESP + 0xc]       ; 004f6b36
    PUSH ECX                            ; 004f6b3a
    CALL core_actor.cpp_CDemonActor_addFilesToExtract_FUN_0040cfd0 ; 004f6b3b
    ...
    PUSH EAX                            ; 004f6b51
    CALL core_skeledit.cpp_CDeformableModelInstance_addFilesToExtract_FUN_0058a260 ; 004f6b52
