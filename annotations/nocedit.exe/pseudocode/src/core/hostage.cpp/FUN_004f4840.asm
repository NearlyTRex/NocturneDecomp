...
;                               FUNCTION
; *****************************************************************************
; __cdecl CHostage * core_hostage.cpp_FUN_004f4840(CHostage * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 004f4847
    CALL core_npc.cpp_FUN_005447e0      ; 004f4848 | CNPC * core_npc.cpp_FUN_005447e0(CNPC * this_ptr)
        ;   XREF to: 005447e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004f484d
    PUSH 0x62ee2f                       ; 004f4850 | = "hickdad.dfm" | s_hickdad_dfm_0062ee2f = hickdad.dfm
    MOV EBX,EAX                         ; 004f4855
    LEA EDI,[EAX + 0x158]               ; 004f4857
    PUSH EDI                            ; 004f485d
    MOV dword ptr [EAX + 0x154],0x65fb34 ; 004f485e | CDemonActor_vtable PTR_core_hostage.cpp_NPCSFromZombieTown_FUN_0065fb34
    CALL core_skeleton.cpp_CDeformableModelInstance_init_FUN_005a0840 ; 004f4868 | void core_skeleton.cpp_CDeformableModelInstance_init_FUN_005a0840(CDeformableModelInstance * this_ptr, char * model_name)
        ;   XREF to: 005a0840 (UNCONDITIONAL_CALL)
    MOV dword ptr [EBX + 0x1fab4],0x0   ; 004f486d
    MOV dword ptr [EBX + 0x1fabc],0x0   ; 004f4877
    MOV ESI,0x62ee3b                    ; 004f4881 | = "true" | s_true_0062ee3b = true
    ...
    PUSH EDI                            ; 004f48ad
    MOV AL,byte ptr [ESI]               ; 004f48ae | = "true" | s_true_0062ee3b = true
        ;   Label: LAB_004f48ae
    MOV byte ptr [EDI],AL               ; 004f48b0
    CMP AL,0x0                          ; 004f48b2
    JZ 0x004f48c6                       ; 004f48b4 | LAB_004f48c6
        ;   XREF to: 004f48c6 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 004f48b6 | s_rue_0062ee3c
    ADD ESI,0x2                         ; 004f48b9
    MOV byte ptr [EDI + 0x1],AL         ; 004f48bc
    ADD EDI,0x2                         ; 004f48bf
    CMP AL,0x0                          ; 004f48c2
    JNZ 0x004f48ae                      ; 004f48c4 | LAB_004f48ae
