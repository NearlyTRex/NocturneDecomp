...

{
  ...
  *(float *)(this_ptr->unk4 + 0xc) = fVar1;
  if ((0.0 < fVar1) &&
     (*(float *)((this_ptr->base).base.cloth_data + 0x33c) <= (float)1.5)) {
    ...
    fVar1 = *(float *)((this_ptr->base).base.unk1 + 0x2c);
    *(float *)((this_ptr->base).base.unk1 + 0xc) = local_8;
    if (*(float *)((this_ptr->base).base.unk1 + 0xc) < -fVar1) {
      *(uint *)((this_ptr->base).base.unk1 + 0xc) =
           *(uint *)((this_ptr->base).base.unk1 + 0x2c);
    }
    if (*(float *)((this_ptr->base).base.unk1 + 0x2c) < *(float *)((this_ptr->base).base.unk1 + 0xc)
       ) {
      *(uint *)((this_ptr->base).base.unk1 + 0xc) =
           *(uint *)((this_ptr->base).base.unk1 + 0x2c);
    }
