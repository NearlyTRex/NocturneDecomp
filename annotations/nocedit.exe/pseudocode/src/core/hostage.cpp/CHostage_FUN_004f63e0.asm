...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_hostage.cpp_CHostage_FUN_004f63e0(CHostage * this_ptr)
;
; Parameters:
...
section .text
    ...
    JZ 0x004f6418                       ; 004f63fb | LAB_004f6418
    ...
    PUSH EAX                            ; 004f6422
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 004f6423 | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004f6428
    LEA EAX,[EBX + 0x1f8bc]             ; 004f642b
    PUSH EAX                            ; 004f6431
    MOV EDX,dword ptr [0x006793d0]      ; 004f6432 | CEventList g_CEventListInstance | CEventList * g_CEventListPtr
    PUSH EDX                            ; 004f6438 | CEventList g_CEventListInstance
    CALL core_event.cpp_CEventList_FUN_004aabe0 ; 004f6439 | void core_event.cpp_CEventList_FUN_004aabe0(CEventList * this_ptr)
        ;   XREF to: 004aabe0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004f643e
    JMP 0x004f63fd                      ; 004f6441 | LAB_004f63fd
