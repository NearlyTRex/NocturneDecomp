...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_hostage.cpp_CHostage_FUN_004f6450(CHostage * this_ptr)
;
; Parameters:
...
section .text
    ...
    JZ 0x004f64df                       ; 004f6463 | LAB_004f64df
    ...
    FNSTSW AX                           ; 004f6482
    SAHF                                ; 004f6484
    JNC 0x004f64e4                      ; 004f6485 | LAB_004f64e4
    ...
    FNSTSW AX                           ; 004f648e
    SAHF                                ; 004f6490
    JNC 0x004f64d1                      ; 004f6491 | LAB_004f64d1
        ;   XREF to: 004f64d1 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x2598],0x0    ; 004f6493
    JNZ 0x004f64be                      ; 004f649a | LAB_004f64be
        ;   XREF to: 004f64be (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 004f649c
    PUSH 0x4                            ; 004f649e
    PUSH EDX                            ; 004f64a0
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 004f64a1 | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    MOV EAX,[0x00821ff4]                ; 004f64a6 | undefined4 DAT_00821ff4
    ...
    MOV EDI,dword ptr [EBX + 0x1fab0]   ; 004f64be
        ;   Label: LAB_004f64be
    PUSH EDI                            ; 004f64c4
    CALL sound_sndmain.cpp_isSfxPlaying_FUN_005a9660 ; 004f64c5 | int sound_sndmain.cpp_isSfxPlaying_FUN_005a9660(uint sfx_handle)
        ;   XREF to: 005a9660 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004f64ca
    TEST EAX,EAX                        ; 004f64cd
    JZ 0x004f6528                       ; 004f64cf | LAB_004f6528
        ;   XREF to: 004f6528 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 004f64d1
        ;   Label: LAB_004f64d1
    PUSH EBX                            ; 004f64d2
    CALL core_npc.cpp_CNPC_FUN_00544d30 ; 004f64d3 | void core_npc.cpp_CNPC_FUN_00544d30(CNPC * this_ptr)
    ...
    MOV dword ptr [ESI + 0x4],EDX       ; 004f64df
        ;   Label: LAB_004f64df
    JMP 0x004f6469                      ; 004f64e2 | LAB_004f6469
    ...
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 004f64f3 | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ...
    JMP 0x004f64d1                      ; 004f6526 | LAB_004f64d1
    ...
    PUSH ESI                            ; 004f6542
    PUSH EBX                            ; 004f6543
    CALL core_npc.cpp_CNPC_FUN_00544d30 ; 004f6544 | void core_npc.cpp_CNPC_FUN_00544d30(CNPC * this_ptr)
        ;   XREF to: 00544d30 (UNCONDITIONAL_CALL)
