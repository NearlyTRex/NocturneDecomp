...
section .text
    ...
    ADD EAX,0x158                       ; 004f63b0
        ;   Label: LAB_004f63b0
    PUSH EAX                            ; 004f63b5
    CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0 ; 004f63b6 | SMotion * core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0(CMotionController * this_ptr)
        ;   XREF to: 0052dab0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EAX + 0x24]      ; 004f63bb
    ADD ESP,0x4                         ; 004f63be
    CMP EAX,0xa                         ; 004f63c1
    JZ 0x004f63ad                       ; 004f63c4 | LAB_004f63ad
        ;   XREF to: 004f63ad (CONDITIONAL_JUMP)
