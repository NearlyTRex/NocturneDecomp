...
section .text
    ...
    JGE 0x004f613c                      ; 004f6138 | LAB_004f613c
        ;   XREF to: 004f613c (CONDITIONAL_JUMP)
    POP EBX                             ; 004f613a
        ;   Label: LAB_004f613a
    RET                                 ; 004f613b
    PUSH 0x62f0f2                       ; 004f613c | = "ScatDazzle" | s_ScatDazzle_0062f0f2 = ScatDazzle
        ;   Label: LAB_004f613c
    PUSH EBX                            ; 004f6141
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 004f6142 | int crt_string.c_stricmp_FUN_005fe7f0(char * str1, char * str2)
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004f6147
    TEST EAX,EAX                        ; 004f614a
    JZ 0x004f613a                       ; 004f614c | LAB_004f613a
        ;   XREF to: 004f613a (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0xc],0x0       ; 004f614e
    JZ 0x004f615f                       ; 004f6153 | LAB_004f615f
    ...
    PUSH ECX                            ; 004f6163
    PUSH EBX                            ; 004f6164
    CALL core_npc.cpp_CNPC_FUN_00544b70 ; 004f6165 | void core_npc.cpp_CNPC_FUN_00544b70(CNPC * this_ptr)
