...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_hostage_cpp_CHostage_processDamage_FUN_004f6450(CHostage *this_ptr,SDamageInfo *damage_info)
;
; Parameters:
...
;   core_npc.cpp_CNPC_processDamage_FUN_00544d30
...
section .text
    ...
    PUSH EBX                            ; 004f6450
        ;   Label: core_hostage.cpp_CHostage_processDamage_FUN_004f6450
    PUSH ESI                            ; 004f6451
    PUSH EDI                            ; 004f6452
    ...
    PUSH ESI                            ; 004f64d1
        ;   Label: LAB_004f64d1
    PUSH EBX                            ; 004f64d2
    CALL core_npc.cpp_CNPC_processDamage_FUN_00544d30 ; 004f64d3
        ;   XREF to: 00544d30 (UNCONDITIONAL_CALL)  ; void core_npc.cpp_CNPC_processDamage_FUN_00544d30(CNPC * this_ptr, SDamageInfo * damage_info)
    ...
    PUSH ESI                            ; 004f6542
    PUSH EBX                            ; 004f6543
    CALL core_npc.cpp_CNPC_processDamage_FUN_00544d30 ; 004f6544
        ;   XREF to: 00544d30 (UNCONDITIONAL_CALL)  ; void core_npc.cpp_CNPC_processDamage_FUN_00544d30(CNPC * this_ptr, SDamageInfo * damage_info)
