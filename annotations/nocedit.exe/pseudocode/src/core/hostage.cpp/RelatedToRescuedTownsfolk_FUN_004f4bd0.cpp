...

{
  ...
  while (0.0 < in_stack_00000008) {
    uVar11 = core_motion_cpp_CMotionController_advance_FUN_0052d610(local_28);
    if (uVar11 < 0xb) {
      if (uVar11 == 6) {
        if (in_stack_00000004->grabbed_by != (CDemonActor *)0x0) {
          ...
          local_194.attacker = &in_stack_00000004->base_actor;
          local_194.wielder = &in_stack_00000004->base_actor;
          local_18 = local_194.damage_amount;
          (*in_stack_00000004->grabbed_by->vtable[1].playAmbientSoundWithVolume)
                    (in_stack_00000004->grabbed_by,(char *)&local_194,(float)in_stack_fffffe40);
        }
      }
      else {
      ...
      core_actor_cpp_CDemonActor_localToWorldPoint_FUN_00408ec0
                (&in_stack_00000004->base_actor,&local_ec,&local_140);
...
LAB_004f4dd2:
          ...
          local_110 = (pCVar12->base_actor).location.position.x - local_ec.x;
          local_10c = (pCVar12->base_actor).location.position.y - local_ec.y;
          local_108 = (pCVar12->base_actor).location.position.z - local_ec.z;
      ...
      pCVar14 = in_stack_00000004->carry_hands[1].carry_actor;
      if (pCVar14 != (CDemonActor *)0x0) {
        ...
        core_inv_cpp_CInventory_addItem_FUN_004fd600
                  (&g_HeroActors[g_LocalHeroIndex]->inventory,pCVar14,1);
      }
    }
    else {
      core_charactr_cpp_CCharacter_FUN_0042ec40(in_stack_00000004);
  ...
  *(float *)(in_stack_00000004->field2_0x240c + 0x28) =
       (in_stack_00000004->model).accumulated_root_motion.z;
  local_2c = 0;
  *(float *)(in_stack_00000004->field2_0x240c + 0x2c) = in_stack_00000008 * fVar15;
      ...
      if (iVar10 == 0) {
        ...
        case 0:
          ...
          if (iVar10 == 0) {
            ...
            local_e0 = (pCVar4->base_character).base_actor.location.position.x -
            ...
            local_d8 = (pCVar4->base_character).base_actor.location.position.z -
        ...
        case 1:
          ...
          if ((iVar10 != 0) &&
             (fVar15 = (in_stack_00000004->base_actor).location.position.x -
                       *(float *)(iVar10 + 0x20),
             fVar5 = (in_stack_00000004->base_actor).location.position.z - *(float *)(iVar10 + 0x28)
             , SQRT(fVar5 * fVar5 + fVar15 * fVar15) < (float)40)) {
...
LAB_004f579d:
              ...
              in_stack_00000004[2].cloth_data[0x53df] = '\0';
              core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                        (&pCVar2->motion_controller,iVar10,1);
            }
            else {
              if (uVar11 < 2) {
                iVar10 = 1;
        ...
        case 4:
          ...
          if (*(int *)(in_stack_00000004[2].cloth_data + 0x53e4) != 0) {
            ...
            pCVar13 = core_actor_cpp_CDemonActor_worldToLocalPoint_FUN_00408f10
                                (&in_stack_00000004->base_actor,&local_8c,
                                 (CVector3f *)
            ...
            pcVar19 = in_stack_00000004->field2_0x240c + 0x10;
            local_a4 = *(float *)pcVar19;
            local_9c = *(float *)(in_stack_00000004->field2_0x240c + 0x18);
            fVar15 = SQRT(local_9c * local_9c + local_a4 * local_a4);
            local_a0 = 0;
            if (*(float *)(in_stack_00000004->field2_0x240c + 0x28) < fVar15) {
              local_30 = *(float *)(in_stack_00000004->field2_0x240c + 0x28) / fVar15;
            ...
            *(float *)(in_stack_00000004->field2_0x240c + 0xc) = pCVar13->y;
            if (fVar15 * fVar5 < 1.0) {
              ...
              local_18 = core_actor_cpp_normalizeAngleToPi_FUN_0040cd70
                                   (local_18 - *(float *)(in_stack_00000004->field2_0x240c + 0xc));
              *(float *)(in_stack_00000004->field2_0x240c + 0xc) =
                   (1.0 - fVar15 * fVar5) * local_18 +
                   *(float *)(in_stack_00000004->field2_0x240c + 0xc);
            }
            local_18 = core_actor_cpp_normalizeAngleToPi_FUN_0040cd70
                                 (*(float *)(in_stack_00000004->field2_0x240c + 0xc));
            *(float *)(in_stack_00000004->field2_0x240c + 0xc) = local_18;
            if ((fVar15 < (float)0.01) &&
            ...
            local_40 = -local_3c;
            if (*(float *)(in_stack_00000004->field2_0x240c + 0xc) < local_40) {
              *(float *)(in_stack_00000004->field2_0x240c + 0xc) = local_40;
            }
            if (local_3c < *(float *)(in_stack_00000004->field2_0x240c + 0xc)) {
...
LAB_004f54c2:
    ...
    pCVar13 = core_actor_cpp_CDemonActor_worldToLocalPoint_FUN_00408f10
                        (&in_stack_00000004->base_actor,&local_d4,
                         &(in_stack_00000004->grabbed_by->location).position);
    pCVar13 = core_vehicle_cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(&local_c8,pCVar13);
    local_18 = core_actor_cpp_normalizeAngleToPi_FUN_0040cd70(pCVar13->y);
    local_19c = local_18;
    ...
    (in_stack_00000004->base_actor).orient.bank =
         (in_stack_00000004->base_actor).orient.bank + local_19c;
    core_actor_cpp_CDemonActor_updateOrientationMatrix_FUN_00408c10(&in_stack_00000004->base_actor);
    pCVar14 = in_stack_00000004->grabbed_by;
    pCVar3 = pCVar14->vtable;
    ...
    fVar15 = (*pCVar3[1].cylinderGroundCheck)(pCVar14,(float)in_stack_00000004,pCVar13);
    if (fVar15 == 0.0) {
...
switchD_004f5c7d_caseD_5:
  if (((0.0 < in_stack_00000004->hit_points) &&
    ...
    iVar10 = core_skeleton_cpp_CSkeleton_findBone_FUN_00599fc0(this_ptr,pcVar19);
    if (-1 < iVar10) {
      pCVar13 = core_skeleton_cpp_CDeformableModelInstance_getBoneWorldPosition_FUN_0059fa20
                          (&in_stack_00000004->model,&local_bc,iVar10);
      core_actor_cpp_CDemonActor_localToWorldPoint_FUN_00408ec0
                (&in_stack_00000004->base_actor,&local_158,pCVar13);
      local_11c.x = 3.0;
      local_11c.y = 0.0;
      local_11c.z = 0.0;
  ...
  if (local_2c == 0) {
    ...
    dVar20 = (double)in_stack_00000008;
    *(float *)(in_stack_00000004->field2_0x240c + 0x20) =
         *(float *)(in_stack_00000004->field2_0x240c + 0x20) -
         in_stack_00000008 * (float)32;
    local_104 = *(float *)(in_stack_00000004->field2_0x240c + 0x1c) * in_stack_00000008;
    local_100 = *(float *)(in_stack_00000004->field2_0x240c + 0x20) * in_stack_00000008;
    local_fc = *(float *)(in_stack_00000004->field2_0x240c + 0x24) * in_stack_00000008;
    pCVar13 = &(in_stack_00000004->model).accumulated_root_motion;
    local_128 = local_104 + *(float *)(in_stack_00000004->field2_0x240c + 0x10);
    local_124 = local_100 + *(float *)(in_stack_00000004->field2_0x240c + 0x14);
    local_120 = local_fc + *(float *)(in_stack_00000004->field2_0x240c + 0x18);
    local_b0 = local_128 + pCVar13->x;
    ...
    *(float *)(in_stack_00000004->field2_0x240c + 0x10) =
    ...
    local_f4 = (in_stack_00000004->base_actor).location.position.y;
    local_f0 = (in_stack_00000004->base_actor).location.position.z;
    ...
    *(float *)(in_stack_00000004->cloth_data + 0x33c) =
    ...
    if ((dVar20 * 0.59999999999999998 <=
         SQRT((double)local_a8 * (double)local_a8 +
              (double)local_b0 * (double)local_b0 + (double)local_ac * (double)local_ac)) &&
       (dVar6 = (double)(pCVar1->position).x - (double)local_f8,
       dVar7 = (double)(in_stack_00000004->base_actor).location.position.y - (double)local_f4,
       dVar8 = (double)(in_stack_00000004->base_actor).location.position.z - (double)local_f0,
       SQRT(dVar8 * dVar8 + dVar7 * dVar7 + dVar6 * dVar6) <= dVar20 * 0.40000000000000002))
    goto LAB_004f50f1;
  }
  else {
    pCVar13 = core_actor_cpp_CDemonActor_transformVector_FUN_00408e80
                        (&in_stack_00000004->base_actor,local_80,
...
LAB_004f50f1:
  ...
  if (*(int *)(in_stack_00000004[2].cloth_data + 0x53d8) == 1) {
    ...
    if (((pCVar14 != (CDemonActor *)0x0) &&
      ...
      fVar15 = in_stack_00000008 / local_48 + *(float *)(in_stack_00000004[2].cloth_data + 0x5404);
    }
    else {
      fVar15 = *(float *)(in_stack_00000004[2].cloth_data + 0x5404) - in_stack_00000008 / local_48;
    }
    *(float *)(in_stack_00000004[2].cloth_data + 0x5404) = fVar15;
    if (0.0 < *(float *)(in_stack_00000004[2].cloth_data + 0x5404)) {
      ...
      if (((1.0 <= *(float *)(in_stack_00000004[2].cloth_data + 0x5404)) &&
         ...
         (fVar15 = in_stack_00000008 / local_54 +
                   *(float *)(in_stack_00000004[2].cloth_data + 0x5400),
         *(float *)(in_stack_00000004[2].cloth_data + 0x5400) = fVar15, 1.0 < fVar15)) {
  ...
  if ((1.0 <= *(float *)(in_stack_00000004[2].cloth_data + 0x5400)) &&
     (pCVar14 = core_actor_cpp_castToClassHash_FUN_0040c790
                          (in_stack_00000004->carry_hands[1].carry_actor,
                           g_CWeaponClassInfo.name_hash), pCVar14 != (CDemonActor *)0x0)) {
    uVar16 = *(uint *)(pCVar14[4].actor_name + 0xc);
    pCVar14[4].actor_name[0xc] = '\x06';
    pCVar14[4].actor_name[0xd] = '\0';
    pCVar14[4].actor_name[0xe] = '\0';
    pCVar14[4].actor_name[0xf] = '\0';
    (*pCVar14->vtable[1].renderTransparent)(pCVar14);
    *(uint *)(pCVar14[4].actor_name + 0xc) = uVar16;
    core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
