...
section .text
    ...
    PUSH 0x649bda                       ; 00588d02 | = "..\\core\\simbox.cpp" | s_core_simbox_cpp_00649bda = ..\core\simbox.cpp
    PUSH 0x5cc                          ; 00588d07
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1b0 ; 00588d0c | void * shape_memdbg.cpp_debugAlloc_FUN_0050f1b0(int size, char * filename, int line_number)
        ;   XREF to: 0050f1b0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00588d11
    TEST EAX,EAX                        ; 00588d14
    JNZ 0x00588d19                      ; 00588d16 | LAB_00588d19
        ;   XREF to: 00588d19 (CONDITIONAL_JUMP)
    RET                                 ; 00588d18
    PUSH EAX                            ; 00588d19
        ;   Label: LAB_00588d19
    CALL core_simbox.cpp_CSimBox_ctor_FUN_00588d40 ; 00588d1a | CSimBox * core_simbox.cpp_CSimBox_ctor_FUN_00588d40(CSimBox * this_ptr)
