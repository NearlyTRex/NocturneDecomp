...

{
  ...
  core_actor_cpp_archiveFloat_FUN_0040b770((float *)(this_ptr->unk + 0x180),"weight");
  if (g_CSimBoxClassVersion < 2) {
    ...
    core_actor_cpp_archiveString_FUN_0040b5c0(this_ptr->unk + 0x184,"triggerEvent");
    if (g_CSimBoxClassVersion < 3) {
      return;
    }
  }
  core_actor_cpp_archiveInteger_FUN_0040b7f0((int *)(this_ptr->unk + 0x17c),"type");
  return;
}
