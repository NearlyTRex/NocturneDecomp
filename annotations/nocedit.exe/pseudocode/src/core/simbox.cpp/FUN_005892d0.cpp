...
// Convention: __cdecl
// Signature: int __cdecl core_simbox_cpp_FUN_005892d0(CSimBox *this_ptr)
...

{
  ...
  pCVar1 = core_actor_cpp_castToClassHash_FUN_0040c790(&this_ptr->base,g_CSimBoxClassInfo.name_hash)
  ;
