...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_simbox_cpp_CSimBox_propertyDisplayCallback_FUN_00589270 (CSimBox *this_ptr,CActorProperty *property,char *output_buffer)
;
; Parameters:
...
;
; XREF[1]:
;   core_simbox.cpp_CSimBox_getPropertyList_FUN_00589310 at 00589357
;
; Referenced Globals:
...
section .text
    ...
    PUSH ESI                            ; 00589270
        ;   Label: core_simbox.cpp_CSimBox_propertyDisplayCallback_FUN_00589270
    PUSH EDI                            ; 00589271
