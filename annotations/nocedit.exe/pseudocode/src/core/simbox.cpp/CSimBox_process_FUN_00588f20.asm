...
section .text
    ...
    JNZ 0x00588fe0                      ; 00588f30 | LAB_00588fe0
        ;   XREF to: 00588fe0 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x5ac],0x0     ; 00588f36
    JNZ 0x00588fe0                      ; 00588f3d | LAB_00588fe0
        ;   XREF to: 00588fe0 (CONDITIONAL_JUMP)
    LEA EAX,[EBX + 0x2dc]               ; 00588f43
    PUSH EAX                            ; 00588f49
    MOV ESI,dword ptr [0x006793d0]      ; 00588f4a | CEventList * g_CEventListPtr
    PUSH ESI                            ; 00588f50 | CEventList g_CEventListInstance
    CALL core_event.cpp_CEventList_evaluateCondition_FUN_004adca0 ; 00588f51 | int core_event.cpp_CEventList_evaluateCondition_FUN_004adca0(CEventList * this_ptr, char * condition_expression)
        ;   XREF to: 004adca0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00588f56
    TEST EAX,EAX                        ; 00588f59
    JZ 0x00588fe0                       ; 00588f5b | LAB_00588fe0
        ;   XREF to: 00588fe0 (CONDITIONAL_JUMP)
    LEA EAX,[EBX + 0x3a4]               ; 00588f61
    LEA ESI,[EBX + 0x340]               ; 00588f67
    MOV dword ptr [EBX + 0x5ac],0x1     ; 00588f6d
    CMP EAX,ESI                         ; 00588f77
    JZ 0x00588f8b                       ; 00588f79 | LAB_00588f8b
    ...
    JZ 0x00588fab                       ; 00588f99 | LAB_00588fab
    ...
    PUSH EAX                            ; 00588fbd
    CALL core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0 ; 00588fbe | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0(CMatrix3x3f * this_ptr, CVector3f * output, CVector3f * input)
        ;   XREF to: 00471fd0 (UNCONDITIONAL_CALL)
    LEA ESI,[EBX + 0x398]               ; 00588fc3
    ADD ESP,0xc                         ; 00588fc9
    CMP ESI,EAX                         ; 00588fcc
    JZ 0x00588fe0                       ; 00588fce | LAB_00588fe0
        ;   XREF to: 00588fe0 (CONDITIONAL_JUMP)
    ...
    CMP dword ptr [EBX + 0x2d4],0x0     ; 00588fe0
        ;   Label: LAB_00588fe0
    JNZ 0x0058908f                      ; 00588fe7 | LAB_0058908f
        ;   XREF to: 0058908f (CONDITIONAL_JUMP)
    PUSH 0x13                           ; 00588fed
    MOV EAX,[0x0067cf44]                ; 00588fef | CKeys * g_CKeysPtr
    PUSH EAX                            ; 00588ff4 | void * g_CKeysPtr
    MOV ESI,dword ptr [EAX]             ; 00588ff5 | void * g_CKeysPtr
    CALL dword ptr [ESI]                ; 00588ff7
    ADD ESP,0x8                         ; 00588ff9
    TEST EAX,EAX                        ; 00588ffc
    JZ 0x0058908f                       ; 00588ffe | LAB_0058908f
        ;   XREF to: 0058908f (CONDITIONAL_JUMP)
    ...
    CALL crt_stdlib.c_rand_FUN_005feb5c ; 0058901d | int crt_stdlib.c_rand_FUN_005feb5c()
        ;   XREF to: 005feb5c (UNCONDITIONAL_CALL)
    MOV dword ptr [ESP + 0xc],EAX       ; 00589022
    FILD dword ptr [ESP + 0xc]          ; 00589026
    FMUL float ptr [0x00649c02]         ; 0058902a | float FLOAT_00649c02
    FADD double ptr [0x00649c0a]        ; 00589030 | double DOUBLE_00649c0a
    FMUL double ptr [0x00649c12]        ; 00589036 | double DOUBLE_00649c12
    FSTP float ptr [EBX + 0x30]         ; 0058903c
    CALL crt_stdlib.c_rand_FUN_005feb5c ; 0058903f | int crt_stdlib.c_rand_FUN_005feb5c()
        ;   XREF to: 005feb5c (UNCONDITIONAL_CALL)
    MOV dword ptr [ESP + 0xc],EAX       ; 00589044
    FILD dword ptr [ESP + 0xc]          ; 00589048
    FMUL float ptr [0x00649c02]         ; 0058904c | float FLOAT_00649c02
    FMUL double ptr [0x00649c12]        ; 00589052 | double DOUBLE_00649c12
    FMUL double ptr [0x00649c1a]        ; 00589058 | double DOUBLE_00649c1a
    FSTP float ptr [EBX + 0x38]         ; 0058905e
    CALL crt_stdlib.c_rand_FUN_005feb5c ; 00589061 | int crt_stdlib.c_rand_FUN_005feb5c()
        ;   XREF to: 005feb5c (UNCONDITIONAL_CALL)
    MOV dword ptr [ESP + 0xc],EAX       ; 00589066
    FILD dword ptr [ESP + 0xc]          ; 0058906a
    FMUL float ptr [0x00649c02]         ; 0058906e | float FLOAT_00649c02
    FMUL double ptr [0x00649c12]        ; 00589074 | double DOUBLE_00649c12
    FMUL double ptr [0x00649c1a]        ; 0058907a | double DOUBLE_00649c1a
    PUSH EBX                            ; 00589080
    ...
    CMP dword ptr [EBX + 0x5ac],0x0     ; 0058908f
        ;   Label: LAB_0058908f
    JNZ 0x0058909e                      ; 00589096 | LAB_0058909e
    ...
    PUSH ESI                            ; 005890a8
    CALL core_box.cpp_CBox_process_FUN_0041e2f0 ; 005890a9 | void core_box.cpp_CBox_process_FUN_0041e2f0(CBox * this_ptr, float delta_time)
    ...
    JZ 0x00589098                       ; 005890cf | LAB_00589098
