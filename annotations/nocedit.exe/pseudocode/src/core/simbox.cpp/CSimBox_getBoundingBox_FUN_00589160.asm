...
;                               FUNCTION
; *****************************************************************************
; __cdecl CBoundingBox3D * __cdecl core_simbox_cpp_CSimBox_getBoundingBox_FUN_00589160(CSimBox *this_ptr,CBoundingBox3D *out_box)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00589160
        ;   Label: core_simbox.cpp_CSimBox_getBoundingBox_FUN_00589160
