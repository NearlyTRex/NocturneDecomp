...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_simbox.cpp_FUN_005892d0(CSimBox * this_ptr)
;
; Parameters:
; CSimBox *        Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_simbox.cpp_CSimBox_FUN_00589310 at 00589352
;
; Referenced Globals:
...
section .text
    ...
    PUSH ECX                            ; 005892dc
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 005892dd | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
