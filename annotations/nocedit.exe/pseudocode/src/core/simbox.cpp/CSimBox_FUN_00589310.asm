...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_simbox_cpp_CSimBox_FUN_00589310(CSimBox *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH ESI                            ; 00589332
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e3b0 ; 00589333
    ...
    PUSH ESI                            ; 00589349
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e160 ; 0058934a
    ...
    PUSH ESI                            ; 00589361
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e670 ; 00589362
    ...
    PUSH ESI                            ; 00589384
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e460 ; 00589385
    ...
    PUSH ESI                            ; 0058939b
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e260 ; 0058939c
    ...
    PUSH ESI                            ; 005893b2
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e260 ; 005893b3
        ;   XREF to: 0040e260 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_CActorPropertyList_FUN_0040e260(CActorPropertyList * this_ptr)
