...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_simbox_cpp_CSimBox_archive_FUN_005891b0(CSimBox *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005891b0
        ;   Label: core_simbox.cpp_CSimBox_archive_FUN_005891b0
    MOV EBX,dword ptr [ESP + 0x8]       ; 005891b1
    PUSH EBX                            ; 005891b5
    CALL core_actor.cpp_CDemonActor_archive_FUN_0040c1c0 ; 005891b6
    ...
    PUSH EAX                            ; 005891c9
    CALL core_actor.cpp_archiveKeyframedModelInstance_FUN_0040b8f0 ; 005891ca
    ...
    PUSH EAX                            ; 005891dd
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 005891de
    ...
    PUSH EAX                            ; 00589207
    CALL core_actor.cpp_archiveVector_FUN_0040b340 ; 00589208
    ...
    PUSH EAX                            ; 0058921b
    CALL core_actor.cpp_archiveVector_FUN_0040b340 ; 0058921c
        ;   XREF to: 0040b340 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveVector_FUN_0040b340(CVector3f * vector_ptr, char * property_name)
    ADD ESP,0x8                         ; 00589221
    PUSH 0x649c4e                       ; 00589224 | = "triggerEvent"
    LEA EAX,[EBX + 0x2dc]               ; 00589229
    PUSH EAX                            ; 0058922f
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 00589230
    ...
    PUSH EBX                            ; 0058924e
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 0058924f
