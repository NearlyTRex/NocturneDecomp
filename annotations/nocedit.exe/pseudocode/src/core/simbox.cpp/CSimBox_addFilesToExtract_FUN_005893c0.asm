...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_simbox_cpp_CSimBox_addFilesToExtract_FUN_005893c0(CSimBox *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x8]       ; 005893c0
        ;   Label: core_simbox.cpp_CSimBox_addFilesToExtract_FUN_005893c0
