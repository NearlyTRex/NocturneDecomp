    ...
    if (iStack_3c != 0) {
      ...
      if (0 < *(int *)(in_stack_0000000c[1].actor_name + 0x14)) {
        ...
        do {
          ...
          vertex2.z = (int)pCVar13;
          vertex2.r = uVar14;
          vertex2.g = (int)pCVar15;
          ...
          vertex2_00.z = (int)pCVar13;
          vertex2_00.r = uVar14;
          vertex2_00.g = (int)pCVar15;
          ...
          vertex2_01.z = (int)pCVar13;
          vertex2_01.r = uVar14;
          vertex2_01.g = (int)pCVar15;
          ...
          vertex2_02.z = (int)pCVar13;
          vertex2_02.r = uVar14;
          vertex2_02.g = (int)pCVar15;
          ...
          vertex2_03.z = (int)pCVar13;
          vertex2_03.r = uVar14;
          vertex2_03.g = (int)pCVar15;
          ...
          vertex2_04.z = (int)pCVar13;
          vertex2_04.r = uVar14;
          vertex2_04.g = (int)pCVar15;
      ...
      vertex2_05.z = (int)pCVar13;
      vertex2_05.r = uVar14;
      vertex2_05.g = (int)pCVar15;
      ...
      for (iVar3 = 0; pCVar15 = g_CDemonRendererPtr2,
        ...
        *(uint *)((int)&g_CDemonRendererPtr2->vertex_buffer_ptr->z + iVar1) = 0;
        *(uint *)((int)&pCVar15->vertex_buffer_ptr->r + iVar1) = 0;
        *(uint *)((int)&pCVar15->vertex_buffer_ptr->g + iVar1) = 0xff00;
        *(uint *)((int)&pCVar15->vertex_buffer_ptr->fog + iVar1) = 0x8000;
      ...
      for (iStack_8 = 0; iStack_8 < *(int *)(in_stack_0000000c[1].actor_name + 0x14) * 2;
        ...
        do {
          pCVar15 = g_CDemonRendererPtr2;
          *(uint *)((int)&g_CDemonRendererPtr2->vertex_buffer_ptr->z + iVar1) = 0;
          *(uint *)((int)&pCVar15->vertex_buffer_ptr->r + iVar1) = 0xff00;
