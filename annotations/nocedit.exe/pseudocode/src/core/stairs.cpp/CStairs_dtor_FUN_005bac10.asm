...
;                               FUNCTION
; *****************************************************************************
; __cdecl CStairs * __cdecl core_stairs_cpp_CStairs_dtor_FUN_005bac10(CStairs *this_ptr,uint d1,uint d2,uint d3)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005bac24
    CALL core_stairs.cpp_FUN_005bac80   ; 005bac25
        ;   XREF to: 005bac80 (UNCONDITIONAL_CALL)  ; undefined core_stairs.cpp_FUN_005bac80()
    ...
    PUSH 0x6635c0                       ; 005bac4d | g_CStairsTypeInfo
        ;   Label: LAB_005bac4d
    PUSH EBX                            ; 005bac52
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 005bac53
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 005bac58
    PUSH EAX                            ; 005bac5b
    CALL crt_memory.c_free_FUN_005fe659 ; 005bac5c
    ...
    PUSH EAX                            ; 005bac68
        ;   Label: LAB_005bac68
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 005bac69
