...
;                               FUNCTION
; *****************************************************************************
; __cdecl CStairs * __cdecl core_stairs_cpp_CStairs_dtor_FUN_005bac10(CStairs *this_ptr,uint flags)
;
; Parameters:
...
;   core_stairs.cpp_freeTriangles_FUN_005bac80
...
section .text
    ...
    PUSH EBX                            ; 005bac24
    CALL core_stairs.cpp_freeTriangles_FUN_005bac80 ; 005bac25
        ;   XREF to: 005bac80 (UNCONDITIONAL_CALL)  ; CDemonTriangle * core_stairs.cpp_freeTriangles_FUN_005bac80(CDemonTriangle * objs)
