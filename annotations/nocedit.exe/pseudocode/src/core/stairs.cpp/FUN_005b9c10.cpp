...

{
  ...
  if ((*(int *)(g_CDemonMissionPtr->unk1 + 4) != 0) &&
    ...
    if (iStack_3c != 0) {
      ...
      if (-1 < *(int *)(param_1[1].actor_name + 0x14)) {
        iStack_1c = 0x60;
        iStack_20 = 0x90;
        iVar5 = 0x30;
        iVar9 = 0;
        do {
          fStack_90 = -*(float *)(param_3[1].actor_name + 8) * (float)0.5;
          fStack_8c = *(float *)param_3[1].actor_name * (float)iVar3;
          fStack_88 = (float)iVar3 * *(float *)(param_3[1].actor_name + 4);
          ...
          fStack_88 = fStack_88 + *(float *)(param_3[1].actor_name + 4);
          ...
          fStack_88 = fStack_88 - *(float *)(param_3[1].actor_name + 4);
          fStack_90 = fStack_90 + *(float *)(param_3[1].actor_name + 8);
        ...
        } while (iVar3 <= *(int *)(param_3[1].actor_name + 0x14));
      }
      iStack_14 = 0;
      g_ActiveRenderColor = 3;
      if (0 < *(int *)(param_3[1].actor_name + 0x14)) {
        iVar5 = 0x90;
        iStack_18 = 0x120;
        iStack_24 = 0xc0;
        iStack_c = 0;
        ...
        do {
          ...
          vertex2_00.light = (float)param_1;
          ...
          vertex2_01.light = (float)param_1;
          ...
          vertex2_02.light = (float)param_1;
          ...
          vertex2_03.light = (float)param_1;
          ...
          vertex2_04.light = (float)param_1;
        ...
        } while (iStack_14 < *(int *)(param_3[1].actor_name + 0x14));
      }
      pSVar8 = g_CDemonRendererPtr2->vertex_buffer_ptr;
      pSVar7 = pSVar8 + *(int *)(param_3[1].actor_name + 0x14) * 4 + 2;
      pfVar10 = &local_144.w_recip;
      ...
      pSVar8 = pSVar8 + *(int *)(param_3[1].actor_name + 0x14) * 4;
      ...
      vertex2_05.light = (float)param_1;
      ...
      for (iVar5 = 0; pCVar1 = g_CDemonRendererPtr2,
          iVar5 <= *(int *)(param_3[1].actor_name + 0x14) * 4; iVar5 = iVar5 + 1) {
      ...
      SStack_dc.surface_normal.A = 0;
      pcStack_30 = param_3[1].actor_name + 0x18;
      iStack_c4 = 0;
      iStack_c0 = 1;
      pCStack_28 = &param_3[1].orient;
      pfStack_2c = &param_3[1].location.position.y;
      for (iStack_8 = 0; iStack_8 < *(int *)(param_3[1].actor_name + 0x14) * 2;
          iStack_8 = iStack_8 + 1) {
        ...
        CStack_54.x = (int)ROUND(pCStack_28->pitch * 256.0f);
        CStack_54.y = (int)ROUND(pCStack_28->bank * 256.0f);
        CStack_54.z = (int)ROUND(pCStack_28->heading * 256.0f);
        wincore_windll_cpp_transformAndProjectPoint_FUN_005b575c
    ...
    core_actor_cpp_CDemonActor_restoreRenderState_FUN_00408b40(param_3);
    return iStack_3c;
  }
  return 0;
}
