...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_stairs_cpp_FUN_005ba4f0(void)
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 005ba4f5
    CALL core_actor.cpp_CDemonActor_serialize_FUN_0040c1c0 ; 005ba4f6
    ...
    PUSH EAX                            ; 005ba509
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 005ba50a
    ...
    PUSH EAX                            ; 005ba51d
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 005ba51e
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ADD ESP,0x8                         ; 005ba523
    PUSH 0x653073                       ; 005ba526 | = "width"
    LEA EAX,[EBX + 0x160]               ; 005ba52b
    PUSH EAX                            ; 005ba531
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 005ba532
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ADD ESP,0x8                         ; 005ba537
    PUSH 0x653079                       ; 005ba53a | = "count"
    LEA EAX,[EBX + 0x16c]               ; 005ba53f
    PUSH EAX                            ; 005ba545
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 005ba546
    ...
    PUSH EBX                            ; 005ba559
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 005ba55a
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
