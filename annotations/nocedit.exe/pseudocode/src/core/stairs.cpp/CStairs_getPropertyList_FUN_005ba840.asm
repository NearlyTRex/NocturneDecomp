...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_stairs_cpp_CStairs_getPropertyList_FUN_005ba840 (CStairs *this_ptr,CActorPropertyList *property_list)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005ba840
        ;   Label: core_stairs.cpp_CStairs_getPropertyList_FUN_005ba840
    PUSH ESI                            ; 005ba841
