...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_stairs_cpp_CStairs_FUN_005ba700(CStairs *this_ptr)
;
; Parameters:
...
;
; XREF[1]:
;   core_stairs.cpp_CStairs_processInEditor_FUN_005ba900 at 005baa5d
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 005ba700
        ;   Label: core_stairs.cpp_CStairs_FUN_005ba700
    PUSH ESI                            ; 005ba701
    PUSH EBP                            ; 005ba702
