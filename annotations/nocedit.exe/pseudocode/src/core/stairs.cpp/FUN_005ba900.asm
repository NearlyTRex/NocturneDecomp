...
section .text
    ...
    MOV EAX,[0x0067cf44]                ; 005ba923 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 005ba928 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 005ba929 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 005ba92b
    ADD ESP,0x8                         ; 005ba92d
    TEST EAX,EAX                        ; 005ba930
    JNZ 0x005baa6a                      ; 005ba932 | LAB_005baa6a
        ;   XREF to: 005baa6a (CONDITIONAL_JUMP)
    PUSH EBX                            ; 005ba938
    CALL core_actor.cpp_CDemonActor_processInEditor_FUN_0040d040 ; 005ba939 | void core_actor.cpp_CDemonActor_processInEditor_FUN_0040d040(CDemonActor * this_ptr)
        ;   XREF to: 0040d040 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005ba93e
    FLD float ptr [EBX + 0x160]         ; 005ba941
        ;   Label: LAB_005ba941
    FCOMP double ptr [0x006530da]       ; 005ba947 | double DOUBLE_006530da
    FNSTSW AX                           ; 005ba94d
    SAHF                                ; 005ba94f
    JNC 0x005ba95c                      ; 005ba950 | LAB_005ba95c
        ;   XREF to: 005ba95c (CONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0x160],0x3e4ccccd ; 005ba952
    FLD float ptr [EBX + 0x158]         ; 005ba95c
        ;   Label: LAB_005ba95c
    FCOMP double ptr [0x006530da]       ; 005ba962 | double DOUBLE_006530da
    FNSTSW AX                           ; 005ba968
    SAHF                                ; 005ba96a
    JNC 0x005ba977                      ; 005ba96b | LAB_005ba977
        ;   XREF to: 005ba977 (CONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0x158],0x3e4ccccd ; 005ba96d
    FLD float ptr [EBX + 0x15c]         ; 005ba977
        ;   Label: LAB_005ba977
    FCOMP double ptr [0x006530da]       ; 005ba97d | double DOUBLE_006530da
    FNSTSW AX                           ; 005ba983
    SAHF                                ; 005ba985
    JNC 0x005ba992                      ; 005ba986 | LAB_005ba992
    ...
    JGE 0x005bab73                      ; 005ba99b | LAB_005bab73
        ;   XREF to: 005bab73 (CONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0x16c],0x1     ; 005ba9a1
    FLD float ptr [EBX + 0x164]         ; 005ba9ab
        ;   Label: LAB_005ba9ab
    FCOMP double ptr [0x006530d2]       ; 005ba9b1 | double DOUBLE_006530d2
    FNSTSW AX                           ; 005ba9b7
    SAHF                                ; 005ba9b9
    JNC 0x005ba9c6                      ; 005ba9ba | LAB_005ba9c6
    ...
    FNSTSW AX                           ; 005ba9d2
    SAHF                                ; 005ba9d4
    JBE 0x005ba9e3                      ; 005ba9d5 | LAB_005ba9e3
    ...
    FLD float ptr [EBX + 0x168]         ; 005ba9e3
        ;   Label: LAB_005ba9e3
    FCOMP double ptr [0x006530d2]       ; 005ba9e9 | double DOUBLE_006530d2
    FNSTSW AX                           ; 005ba9ef
    SAHF                                ; 005ba9f1
    JNC 0x005ba9fe                      ; 005ba9f2 | LAB_005ba9fe
    ...
    FNSTSW AX                           ; 005baa0a
    SAHF                                ; 005baa0c
    JBE 0x005baa1b                      ; 005baa0d | LAB_005baa1b
    ...
    CALL core_actor.cpp_CDemonActor_updateOrientationMatrix_FUN_00408c10 ; 005baa54 | void core_actor.cpp_CDemonActor_updateOrientationMatrix_FUN_00408c10(CDemonActor * this_ptr)
        ;   XREF to: 00408c10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005baa59
    PUSH EBX                            ; 005baa5c
    CALL core_stairs.cpp_FUN_005ba700   ; 005baa5d | undefined core_stairs.cpp_FUN_005ba700()
    ...
    POP EBX                             ; 005baa68
    RET                                 ; 005baa69
    MOV EAX,[0x0067b654]                ; 005baa6a | CGame * g_CGamePtr
        ;   Label: LAB_005baa6a
    PUSH 0x38                           ; 005baa6f
    FLD float ptr [EAX + 0x264]         ; 005baa71 | g_CGameInstance.delta_time_float
    MOV EAX,[0x0067cf44]                ; 005baa77 | CKeys * g_CKeysPtr
    FMUL double ptr [0x006530ca]        ; 005baa7c | double DOUBLE_006530ca
    PUSH EAX                            ; 005baa82 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 005baa83 | void * g_CKeysPtr
    FSTP float ptr [ESP + 0x8]          ; 005baa85
    CALL dword ptr [EDX]                ; 005baa89
    ADD ESP,0x8                         ; 005baa8b
    TEST EAX,EAX                        ; 005baa8e
    JZ 0x005baa9e                       ; 005baa90 | LAB_005baa9e
        ;   XREF to: 005baa9e (CONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 005baa92
    FMUL double ptr [0x006530d2]        ; 005baa95 | double DOUBLE_006530d2
    FSTP float ptr [ESP]                ; 005baa9b
    PUSH 0x4b                           ; 005baa9e
        ;   Label: LAB_005baa9e
    MOV EAX,[0x0067cf44]                ; 005baaa0 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 005baaa5 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 005baaa6 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 005baaa8
    ADD ESP,0x8                         ; 005baaaa
    TEST EAX,EAX                        ; 005baaad
    JZ 0x005baac0                       ; 005baaaf | LAB_005baac0
    ...
    PUSH 0x4d                           ; 005baac0
        ;   Label: LAB_005baac0
    MOV EAX,[0x0067cf44]                ; 005baac2 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 005baac7 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 005baac8 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 005baaca
    ADD ESP,0x8                         ; 005baacc
    TEST EAX,EAX                        ; 005baacf
    JZ 0x005baae2                       ; 005baad1 | LAB_005baae2
    ...
    PUSH 0x1e                           ; 005baae2
        ;   Label: LAB_005baae2
    MOV EAX,[0x0067cf44]                ; 005baae4 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 005baae9 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 005baaea | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 005baaec
    ADD ESP,0x8                         ; 005baaee
    TEST EAX,EAX                        ; 005baaf1
    JZ 0x005bab04                       ; 005baaf3 | LAB_005bab04
    ...
    PUSH 0x10                           ; 005bab04
        ;   Label: LAB_005bab04
    MOV EAX,[0x0067cf44]                ; 005bab06 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 005bab0b | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 005bab0c | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 005bab0e
    ADD ESP,0x8                         ; 005bab10
    TEST EAX,EAX                        ; 005bab13
    JZ 0x005bab26                       ; 005bab15 | LAB_005bab26
    ...
    PUSH 0x50                           ; 005bab26
        ;   Label: LAB_005bab26
    MOV EAX,[0x0067cf44]                ; 005bab28 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 005bab2d | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 005bab2e | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 005bab30
    ADD ESP,0x8                         ; 005bab32
    TEST EAX,EAX                        ; 005bab35
    JZ 0x005bab48                       ; 005bab37 | LAB_005bab48
    ...
    PUSH 0x48                           ; 005bab48
        ;   Label: LAB_005bab48
    MOV EAX,[0x0067cf44]                ; 005bab4a | CKeys * g_CKeysPtr
    PUSH EAX                            ; 005bab4f | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 005bab50 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 005bab52
    ADD ESP,0x8                         ; 005bab54
    TEST EAX,EAX                        ; 005bab57
    JZ 0x005ba941                       ; 005bab59 | LAB_005ba941
