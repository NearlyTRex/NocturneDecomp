...
// Convention: __cdecl
// Signature: void __cdecl core_weapon_cpp_CWeapon_FUN_005ee830(CWeapon *this_ptr)
...

{
  ...
  local_94.unk[10] = '\0';
  local_94.unk[0xb] = '\0';
  local_94.unk._12_4_ = *(uint *)this_ptr->unk2;
  local_94.unk._16_4_ = *(uint *)(this_ptr->unk2 + 4);
  local_94.unk._20_4_ = *(uint *)(this_ptr->unk2 + 8);
  local_94.unk[0] = '\0';
  local_94.unk[1] = '\0';
  local_94.unk[2] = -0x80;
  local_94.unk[3] = '?';
