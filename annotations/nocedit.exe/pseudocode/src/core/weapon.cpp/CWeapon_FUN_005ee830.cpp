...

{
  ...
  local_94[10] = '\0';
  local_94[0xb] = '\0';
  local_94._12_4_ = *(undefined4 *)this_ptr->field7_0x2f4;
  local_94._16_4_ = *(undefined4 *)(this_ptr->field7_0x2f4 + 4);
  local_94._20_4_ = *(undefined4 *)(this_ptr->field7_0x2f4 + 8);
  local_94[0] = '\0';
  local_94[1] = '\0';
  local_94[2] = -0x80;
  local_94[3] = '?';
...
// 005ee879: PUSH EAX
// 005ee87a: PUSH EBX
// 005ee87b: CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0
...
// 005ee89d: CALL core_actor.cpp_CDemonActor_transformVector_FUN_00408e80
