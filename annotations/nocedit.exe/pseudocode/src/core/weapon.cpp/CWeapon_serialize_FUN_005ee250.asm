...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_weapon_cpp_CWeapon_serialize_FUN_005ee250(CWeapon *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005ee25e
    CALL core_actor.cpp_CDemonActor_serialize_FUN_0040c1c0 ; 005ee25f
    ...
    PUSH EAX                            ; 005ee272
    CALL core_actor.cpp_serializeKeyframedModelInstance_FUN_0040b8f0 ; 005ee273
    ...
    PUSH EAX                            ; 005ee29a
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 005ee29b
    ...
    PUSH EAX                            ; 005ee2ae
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 005ee2af
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ADD ESP,0x8                         ; 005ee2b4
    PUSH 0x657ae8                       ; 005ee2b7 | = "ammoType"
    LEA EAX,[EBX + 0x56c]               ; 005ee2bc
    PUSH EAX                            ; 005ee2c2
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 005ee2c3
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    PUSH EAX                            ; 005ee2dd
    CALL core_actor.cpp_serializeLocalizedString_FUN_0040b6e0 ; 005ee2de
    ...
    PUSH EAX                            ; 005ee302
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 005ee303
    ...
    PUSH EBX                            ; 005ee31b
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 005ee31c
