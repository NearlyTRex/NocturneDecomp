...
section .text
    ...
    JNZ 0x005ee386                      ; 005ee34d | LAB_005ee386
        ;   XREF to: 005ee386 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x2d4],0x0     ; 005ee34f
    JNZ 0x005ee386                      ; 005ee356 | LAB_005ee386
        ;   XREF to: 005ee386 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x55c],0x0     ; 005ee358
    JZ 0x005ee386                       ; 005ee35f | LAB_005ee386
        ;   XREF to: 005ee386 (CONDITIONAL_JUMP)
    ...
    FADDP                               ; 005ee377
    FSQRT                               ; 005ee379
    FCOMP double ptr [0x00657b19]       ; 005ee37b | double DOUBLE_00657b19
    FNSTSW AX                           ; 005ee381
    SAHF                                ; 005ee383
    JA 0x005ee38f                       ; 005ee384 | LAB_005ee38f
        ;   XREF to: 005ee38f (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x304],0x0     ; 005ee386
        ;   Label: LAB_005ee386
    JZ 0x005ee394                       ; 005ee38d | LAB_005ee394
    ...
    POP EBX                             ; 005ee392
    RET                                 ; 005ee393
    PUSH 0x657b0a                       ; 005ee394 | = "CIcePick" | s_CIcePick_00657b0a = CIcePick
        ;   Label: LAB_005ee394
    MOV EBP,dword ptr [ESP + 0x14]      ; 005ee399
    PUSH EBP                            ; 005ee39d
    CALL core_actor.cpp_isOfClass_FUN_0040c6d0 ; 005ee39e | int core_actor.cpp_isOfClass_FUN_0040c6d0(CDemonActor * actor_ptr, char * class_name)
        ;   XREF to: 0040c6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005ee3a3
    TEST EAX,EAX                        ; 005ee3a6
    JZ 0x005ee3b2                       ; 005ee3a8 | LAB_005ee3b2
    ...
    POP EBX                             ; 005ee3b0
    RET                                 ; 005ee3b1
    PUSH 0x657b13                       ; 005ee3b2 | = "CHero" | s_CHero_00657b13 = CHero
        ;   Label: LAB_005ee3b2
    PUSH EBP                            ; 005ee3b7
    CALL core_actor.cpp_isOfClass_FUN_0040c6d0 ; 005ee3b8 | int core_actor.cpp_isOfClass_FUN_0040c6d0(CDemonActor * actor_ptr, char * class_name)
        ;   XREF to: 0040c6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005ee3bd
    TEST EAX,EAX                        ; 005ee3c0
    JNZ 0x005ee3d6                      ; 005ee3c2 | LAB_005ee3d6
        ;   XREF to: 005ee3d6 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [EBX + 0x2d4]     ; 005ee3c4
    TEST EDX,EDX                        ; 005ee3ca
    JZ 0x005ee3aa                       ; 005ee3cc | LAB_005ee3aa
        ;   XREF to: 005ee3aa (CONDITIONAL_JUMP)
    CMP EDX,0x3                         ; 005ee3ce
    JZ 0x005ee3aa                       ; 005ee3d1 | LAB_005ee3aa
        ;   XREF to: 005ee3aa (CONDITIONAL_JUMP)
    POP EBP                             ; 005ee3d3
    POP EBX                             ; 005ee3d4
    RET                                 ; 005ee3d5
