...

{
  ...
  if (((((iVar2 == 0) && (this_ptr->weapon_state == 0)) &&
       (*(int *)(this_ptr->field8_0x305 + 599) != 0)) &&
      ((float)DOUBLE_00657b19 <
       SQRT(*(float *)(this_ptr->field8_0x305 + 0x57) * *(float *)(this_ptr->field8_0x305 + 0x57) +
            *(float *)(this_ptr->field8_0x305 + 0x4f) * *(float *)(this_ptr->field8_0x305 + 0x4f) +
            *(float *)(this_ptr->field8_0x305 + 0x53) * *(float *)(this_ptr->field8_0x305 + 0x53))))
     || (iVar1._0_1_ = this_ptr->carried_by_actor, iVar1._1_1_ = this_ptr->field8_0x305[0],
        iVar1._2_1_ = this_ptr->field8_0x305[1], iVar1._3_1_ = this_ptr->field8_0x305[2], iVar1 != 0
        )) {
    return 0;
  }
