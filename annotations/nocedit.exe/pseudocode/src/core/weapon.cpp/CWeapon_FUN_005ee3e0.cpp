...
// Convention: __cdecl
// Signature: void __cdecl core_weapon_cpp_CWeapon_FUN_005ee3e0(CWeapon *this_ptr)
...

{
  ...
  this_ptr->unk3[0] = uStack00000009;
  this_ptr->unk3[1] = uStack0000000a;
  this_ptr->unk3[2] = uStack0000000b;
  return;
}
