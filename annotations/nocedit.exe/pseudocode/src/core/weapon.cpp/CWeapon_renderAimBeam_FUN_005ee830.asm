...
; Local Variables:
; SLaserInfo       Stack[-0xe8]:84  local_e8
; SLaserInfo       Stack[-0x94]:84  local_94
...
section .text
    ...
    PUSH EBX                            ; 005ee830
        ;   Label: core_weapon.cpp_CWeapon_renderAimBeam_FUN_005ee830
    PUSH ESI                            ; 005ee831
    PUSH EDI                            ; 005ee832
    PUSH EBP                            ; 005ee833
    ...
    CALL engine_drender.cpp_CDemonRenderer_isShadowPass_FUN_0048cae0 ; 005ee84c
    ...
    CALL core_setcolid.cpp_CDemonSet_init_FUN_00574180 ; 005ee8ac
    ...
    CALL core_fire.cpp_CFireEffect_traceLaser_FUN_004c8230 ; 005ee9c5
    ...
    CALL core_setcolid.cpp_CDemonSet_init_FUN_00574180 ; 005ee9d4
        ;   XREF to: 00574180 (UNCONDITIONAL_CALL)  ; void core_setcolid.cpp_CDemonSet_init_FUN_00574180(CDemonSet * this_ptr)
