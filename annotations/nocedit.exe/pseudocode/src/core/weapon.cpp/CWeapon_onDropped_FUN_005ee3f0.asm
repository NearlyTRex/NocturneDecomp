...
section .text
    ...
    PUSH EBX                            ; 005ee3f0
        ;   Label: core_weapon.cpp_CWeapon_onDropped_FUN_005ee3f0
    PUSH ESI                            ; 005ee3f1
    ...
    CALL core_weapon.cpp_CWeapon_setupPhysicsBox_FUN_005ee740 ; 005ee408
    ...
    JNZ 0x005ee436                      ; 005ee412
        ;   XREF to: 005ee436 (CONDITIONAL_JUMP)  ; LAB_005ee436
    PUSH 0x0                            ; 005ee414
        ;   Label: LAB_005ee414
    ...
    PUSH EAX                            ; 005ee442
    CALL core_dirmat.cpp_CMatrix3x3f_transformVectorTranspose_FUN_00472030 ; 005ee443
    ...
    JZ 0x005ee465                       ; 005ee453
        ;   XREF to: 005ee465 (CONDITIONAL_JUMP)  ; LAB_005ee465
    ...
    JZ 0x005ee414                       ; 005ee46d
        ;   XREF to: 005ee414 (CONDITIONAL_JUMP)  ; LAB_005ee414
    ...
    JMP 0x005ee414                      ; 005ee47f
        ;   XREF to: 005ee414 (UNCONDITIONAL_JUMP)  ; LAB_005ee414
