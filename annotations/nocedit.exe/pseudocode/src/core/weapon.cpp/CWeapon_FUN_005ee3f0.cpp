...

{
  ...
  this_ptr->field8_0x305[0] = '\0';
  this_ptr->field8_0x305[1] = '\0';
  this_ptr->field8_0x305[2] = '\0';
  ...
  if (in_stack_00000008 != (CVector3f *)0x0) {
    pCVar1 = core_dirmat_cpp_CMatrix3x3f_transformVectorTranspose_FUN_00472030
                       ((CMatrix3x3f *)(this_ptr->field8_0x305 + 0x1b),(CVector3f *)&fStack_10,
                        in_stack_00000008);
    if ((CVector3f *)(this_ptr->field8_0x305 + 0x4f) != pCVar1) {
      ((CVector3f *)(this_ptr->field8_0x305 + 0x4f))->x = pCVar1->x;
      *(float *)(this_ptr->field8_0x305 + 0x53) = pCVar1->y;
      *(float *)(this_ptr->field8_0x305 + 0x57) = pCVar1->z;
    }
    if ((CVector3f *)(this_ptr->field8_0x305 + 0x43) != in_stack_00000008) {
      ((CVector3f *)(this_ptr->field8_0x305 + 0x43))->x = in_stack_00000008->x;
      *(float *)(this_ptr->field8_0x305 + 0x47) = in_stack_00000008->y;
      *(float *)(this_ptr->field8_0x305 + 0x4b) = in_stack_00000008->z;
    }
  }
  fStack_10 = 0.0;
  (*(this_ptr->base_actor).metadata.vtable[1].process)(&this_ptr->base_actor);
