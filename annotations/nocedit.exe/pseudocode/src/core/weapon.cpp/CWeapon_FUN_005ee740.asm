...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_weapon_cpp_CWeapon_FUN_005ee740(CWeapon *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005ee740
        ;   Label: core_weapon.cpp_CWeapon_FUN_005ee740
    ...
    FLD float ptr [0x00657b2d]          ; 005ee78c | FLOAT_00657b2d
    FXCH                                ; 005ee792
    FMUL ST1                            ; 005ee794
    FXCH ST2                            ; 005ee796
    ...
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 005ee7c7
    ...
    PUSH EBX                            ; 005ee816
    CALL core_box.cpp_CBox_setupCorners_FUN_0041dd20 ; 005ee817
