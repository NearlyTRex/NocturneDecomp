...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_weapon_cpp_CWeapon_canPickup_FUN_005ee340(CWeapon *this_ptr,CDemonActor *picker)
;
; Parameters:
...
;
; XREF[1]:
;   core_turret.cpp_CTurret_canPickup_FUN_005e3c70 at 005e3c8c
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 005ee340
        ;   Label: core_weapon.cpp_CWeapon_canPickup_FUN_005ee340
    PUSH EBP                            ; 005ee341
