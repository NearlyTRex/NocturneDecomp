...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_weapon_cpp_CWeapon_FUN_005eea60(CWeapon *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 005eea6e
    CALL core_dmodel.cpp_CKeyFramedModelInstance_writeDependencies_FUN_0047edd0 ; 005eea6f
