// Name: core_weapon.cpp_CWeapon_renderOpaque_FUN_005ee030
// Address: 005ee030
// Address Range: [[005ee030, 005ee0b7]]
// Convention: __cdecl
// Signature: int __cdecl core_weapon_cpp_CWeapon_renderOpaque_FUN_005ee030(CWeapon *this_ptr)
...

{
  ...
  iVar2 = engine_drender_cpp_CDemonRenderer_isShadowPass_FUN_0048cae0(this_ptr_00);
  if ((iVar2 == 0) && (iVar1 != 0)) {
