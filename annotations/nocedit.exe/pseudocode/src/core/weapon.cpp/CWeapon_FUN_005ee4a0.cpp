...

{
  ...
  input_local_point = (CVector3f *)(*(((this_ptr->base_actor).vtable._uc)->_uc).cfunc3)();
  ...
  CStack_2c.y = (this_ptr->base_actor).orient.bank;
  CStack_2c.z = (this_ptr->base_actor).orient.heading;
  CStack_2c.x = (this_ptr->base_actor).orient.pitch + 0.3490658f;
  ...
  pCVar1 = (*((this_ptr->base_actor).vtable._ub)->getCarrier)(&this_ptr->base_actor);
