...

{
  ...
  core_actor_cpp_CDemonActor_localToWorldPoint_FUN_00408ec0
            (&this_ptr->base_actor,(CVector3f *)auStack_1c,input_local_point);
  ...
  CStack_28.y = (this_ptr->base_actor).orient.bank;
  CStack_28.z = (this_ptr->base_actor).orient.heading;
  CStack_28.x = (this_ptr->base_actor).orient.pitch + 0.3490658f;
