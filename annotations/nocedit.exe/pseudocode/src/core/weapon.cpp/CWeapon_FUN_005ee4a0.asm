...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_weapon.cpp_CWeapon_FUN_005ee4a0(CWeapon * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 005ee4c2
    PUSH EBX                            ; 005ee4c3
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 005ee4c4 | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
    ...
    MOV dword ptr [0x02d807ac],EDX      ; 005ee4db | g_CDemonLightInstance.field17_0x1cbc
    CMP EAX,0x2d7eaf4                   ; 005ee4e1 | g_CDemonLightInstance.base.base.position.x
    JZ 0x005ee503                       ; 005ee4e6 | LAB_005ee503
    ...
    PUSH EAX                            ; 005ee530
    FADD float ptr [0x00657b21]         ; 005ee531 | float FLOAT_00657b21
    PUSH 0x2d7eb00                      ; 005ee537 | DAT_02d7eb00
    FSTP float ptr [ESP + 0x14]         ; 005ee53c
    CALL core_dirmat.cpp_CMatrix3x3f_buildRotationMatrix_FUN_00471d30 ; 005ee540 | void core_dirmat.cpp_CMatrix3x3f_buildRotationMatrix_FUN_00471d30(CMatrix3x3f * this_ptr, CVector3f * euler_angles)
    ...
    PUSH EAX                            ; 005ee57a
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 005ee57b | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005ee580
    TEST EAX,EAX                        ; 005ee583
    JZ 0x005ee5ae                       ; 005ee585 | LAB_005ee5ae
    ...
    FCOMP float ptr [0x00657b25]        ; 005ee595 | float FLOAT_00657b25
    FNSTSW AX                           ; 005ee59b
    SAHF                                ; 005ee59d
    JNC 0x005ee5ae                      ; 005ee59e | LAB_005ee5ae
        ;   XREF to: 005ee5ae (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x24]          ; 005ee5a0
    FMUL float ptr [0x00657b29]         ; 005ee5a4 | float FLOAT_00657b29
    FSTP float ptr [ESP + 0x28]         ; 005ee5aa
    PUSH dword ptr [ESP + 0x28]         ; 005ee5ae
        ;   Label: LAB_005ee5ae
    PUSH 0x2d7eaf0                      ; 005ee5b2 | CDemonLight g_CDemonLightInstance
    CALL core_dlight.cpp_CDemonLight_setVolumetricIntensity_FUN_004765e0 ; 005ee5b7 | void core_dlight.cpp_CDemonLight_setVolumetricIntensity_FUN_004765e0(CDemonLight * this_ptr, float intensity)
        ;   XREF to: 004765e0 (UNCONDITIONAL_CALL)
    MOV EAX,[0x0067b654]                ; 005ee5bc | CGame g_CGameInstance | CGame * g_CGamePtr
    MOV ECX,dword ptr [EAX + 0x244]     ; 005ee5c1 | g_CGameInstance.auto_save_blocked
    ADD ESP,0x8                         ; 005ee5c7
    TEST ECX,ECX                        ; 005ee5ca
    JNZ 0x005ee5d5                      ; 005ee5cc | LAB_005ee5d5
    ...
    CALL core_dglobe.cpp_CDemonGlobe_setColor_FUN_00471310 ; 005ee5e0 | void core_dglobe.cpp_CDemonGlobe_setColor_FUN_00471310(CDemonGlobe * this_ptr, CColor3f * color)
    ...
    MOV dword ptr [0x03f95db8],EBX      ; 005ee5f9 | DAT_03f95db8
    MOV byte ptr [0x03f95d98],AH        ; 005ee5ff | DAT_03f95d98
    CALL core_dglobe.cpp_CDemonGlobe_precomputeAttenuation_FUN_00471360 ; 005ee605 | void core_dglobe.cpp_CDemonGlobe_precomputeAttenuation_FUN_00471360(CDemonGlobe * this_ptr, float radius)
        ;   XREF to: 00471360 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005ee60a
    PUSH 0x3f95d7c                      ; 005ee60d | DAT_03f95d7c
    MOV EDI,dword ptr [0x006810c8]      ; 005ee612 | CDemonSet * g_CDemonSetPtr
    XOR ESI,ESI                         ; 005ee618
    PUSH EDI                            ; 005ee61a | CDemonSet g_CDemonSetInstance
    MOV dword ptr [0x03f95d9c],ESI      ; 005ee61b | DAT_03f95d9c
    CALL core_set.cpp_CDemonSet_FUN_0056d110 ; 005ee621 | void core_set.cpp_CDemonSet_FUN_0056d110(CDemonSet * this_ptr)
