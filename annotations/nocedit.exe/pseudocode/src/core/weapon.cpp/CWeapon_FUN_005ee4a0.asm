...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_weapon_cpp_CWeapon_FUN_005ee4a0(CWeapon *this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV dword ptr [0x03f95db8],EBX      ; 005ee5f9 | INT_03f95db8
    ...
    MOV dword ptr [0x03f95d9c],ESI      ; 005ee61b | INT_03f95d9c
