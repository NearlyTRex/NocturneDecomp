...

{
  ...
  if (0 < this_ptr->vertex_count) {
    ...
    do {
      ...
      if (0 < local_64->neighbor_count) {
        do {
          iVar9 = local_64->neighbor_indices[iVar10];
          ...
          local_64->rest_distances[iVar10] = SQRT(fVar8 * fVar8 + fVar6 * fVar6 + fVar7 * fVar7);
          iVar10 = iVar10 + 1;
  ...
  if (0 < this_ptr->vertex_count) {
    do {
      ...
      pSVar14->local_position = pSVar14->initial_position;
      (pSVar14->velocity).z = 0.0;
      (pSVar14->velocity).y = 0.0;
      (pSVar14->velocity).x = 0.0;
      iVar9 = iVar9 + 1;
    ...
    do {
      ...
      if (0 < (this_ptr->mesh).grid_cols) {
        do {
          ...
          pSVar15->vertices[0] = pSVar9->vertices[2];
          pSVar15->vertices[1] = pSVar9->vertices[1];
          pSVar15->vertices[2] = pSVar9->vertices[0];
          ...
          pSVar15[1].vertices[0] = pSVar9[1].vertices[2];
          pSVar15[1].vertices[1] = pSVar9[1].vertices[1];
          pSVar15[1].vertices[2] = pSVar9[1].vertices[0];
          pSVar9 = pSVar9 + 2;
          pSVar15 = pSVar15 + 2;
          local_20 = local_20 + 1;
