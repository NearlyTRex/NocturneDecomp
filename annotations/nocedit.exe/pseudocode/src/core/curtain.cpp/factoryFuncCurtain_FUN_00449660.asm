...
section .text
    ...
    PUSH 0x36                           ; 00449660
        ;   Label: core_curtain.cpp_factoryFuncCurtain_FUN_00449660
    ...
    PUSH EAX                            ; 00449679
        ;   Label: LAB_00449679
    CALL core_curtain.cpp_CCurtain_ctor_FUN_004496a0 ; 0044967a
        ;   XREF to: 004496a0 (UNCONDITIONAL_CALL)  ; CCurtain * core_curtain.cpp_CCurtain_ctor_FUN_004496a0(CCurtain * this_ptr)
