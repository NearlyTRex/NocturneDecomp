...

{
  ...
  pSVar1 = core_curtain_cpp_SCurtainVertex_arrdtor_FUN_0044bad0(this_ptr->unk3,0);
  ptr = (CCurtain *)
        core_actor_cpp_CDemonActor_dtor_FUN_00408a30((CDemonActor *)(pSVar1[-5].unk + 0x3c),1);
  if ((flags & 2) == 0) {
    return ptr;
  }
