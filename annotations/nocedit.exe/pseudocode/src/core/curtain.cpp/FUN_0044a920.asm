...
section .text
    ...
    JNZ 0x0044a948                      ; 0044a939 | LAB_0044a948
        ;   XREF to: 0044a948 (CONDITIONAL_JUMP)
    CMP dword ptr [EDI + 0x190],0x0     ; 0044a93b
    JZ 0x0044ad91                       ; 0044a942 | LAB_0044ad91
    ...
    JZ 0x0044ad91                       ; 0044a95a | LAB_0044ad91
        ;   XREF to: 0044ad91 (CONDITIONAL_JUMP)
    LEA EAX,[EDI + 0x194]               ; 0044a960
    PUSH EAX                            ; 0044a966
    MOV ESI,dword ptr [0x006793d0]      ; 0044a967 | CEventList * g_CEventListPtr
    PUSH ESI                            ; 0044a96d | CEventList g_CEventListInstance
    CALL core_event.cpp_CEventList_evaluateCondition_FUN_004adca0 ; 0044a96e | int core_event.cpp_CEventList_evaluateCondition_FUN_004adca0(CEventList * this_ptr, char * condition_expression)
        ;   XREF to: 004adca0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0044a973
    TEST EAX,EAX                        ; 0044a976
    JZ 0x0044a984                       ; 0044a978 | LAB_0044a984
        ;   XREF to: 0044a984 (CONDITIONAL_JUMP)
    MOV dword ptr [EDI + 0x190],0x1     ; 0044a97a
    PUSH 0x619c1a                       ; 0044a984 | = "none" | s_none_00619c1a = none
        ;   Label: LAB_0044a984
    LEA EAX,[EDI + 0x194]               ; 0044a989
    PUSH EAX                            ; 0044a98f
    CALL crt_string.c_strcmp_FUN_005fef20 ; 0044a990 | int crt_string.c_strcmp_FUN_005fef20(char * str1, char * str2)
        ;   XREF to: 005fef20 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0044a995
    TEST EAX,EAX                        ; 0044a998
    JZ 0x0044a9a9                       ; 0044a99a | LAB_0044a9a9
        ;   XREF to: 0044a9a9 (CONDITIONAL_JUMP)
    CMP dword ptr [EDI + 0x190],0x0     ; 0044a99c
    JZ 0x0044ad91                       ; 0044a9a3 | LAB_0044ad91
        ;   XREF to: 0044ad91 (CONDITIONAL_JUMP)
    CMP dword ptr [EDI + 0x65b2c],0x0   ; 0044a9a9
        ;   Label: LAB_0044a9a9
    JZ 0x0044a9da                       ; 0044a9b0 | LAB_0044a9da
    ...
    JLE 0x0044aaa7                      ; 0044aa15 | LAB_0044aaa7
    ...
    FNSTSW AX                           ; 0044aa2a
    SAHF                                ; 0044aa2c
    JNC 0x0044aa36                      ; 0044aa2d | LAB_0044aa36
    ...
    FNSTSW AX                           ; 0044aa3d
    SAHF                                ; 0044aa3f
    JNC 0x0044aa49                      ; 0044aa40 | LAB_0044aa49
    ...
    FNSTSW AX                           ; 0044aa50
    SAHF                                ; 0044aa52
    JNC 0x0044aa5c                      ; 0044aa53 | LAB_0044aa5c
    ...
    FNSTSW AX                           ; 0044aa63
    SAHF                                ; 0044aa65
    JBE 0x0044aa6f                      ; 0044aa66 | LAB_0044aa6f
    ...
    FNSTSW AX                           ; 0044aa76
    SAHF                                ; 0044aa78
    JBE 0x0044aa82                      ; 0044aa79 | LAB_0044aa82
    ...
    FNSTSW AX                           ; 0044aa89
    SAHF                                ; 0044aa8b
    JBE 0x0044aa95                      ; 0044aa8c | LAB_0044aa95
    ...
    JL 0x0044aa21                       ; 0044aaa1 | LAB_0044aa21
    ...
    MOV dword ptr [0x008879bc],EDX      ; 0044aab7 | undefined4 DAT_008879bc
    MOV EDX,dword ptr [0x006810c8]      ; 0044aabd | CDemonSet * g_CDemonSetPtr
        ;   Label: LAB_0044aabd
    MOV EAX,dword ptr [ESP + 0xc0]      ; 0044aac3
    CMP EAX,dword ptr [EDX + 0x14f098]  ; 0044aaca | g_CDemonSetInstance.damage_listener_count
    JGE 0x0044abb1                      ; 0044aad0 | LAB_0044abb1
        ;   XREF to: 0044abb1 (CONDITIONAL_JUMP)
    MOV EAX,[0x008879bc]                ; 0044aad6 | undefined4 DAT_008879bc
    IMUL ESI,EAX,0x28                   ; 0044aadb
    ADD EDX,dword ptr [ESP + 0xb8]      ; 0044aade
    MOV EBX,dword ptr [EDX + 0x14f09c]  ; 0044aae5 | g_CDemonSetInstance.damage_listeners
    IMUL EDX,EAX,0xc                    ; 0044aaeb
    ADD EDX,0x8879c0                    ; 0044aaee | CVector3f[100] DAT_008879c0
    LEA EAX,[EBX + 0x20]                ; 0044aaf4
    ADD ESI,0x887e70                    ; 0044aaf7 | SCollisionInfo[100] DAT_00887e70
    CMP EDX,EAX                         ; 0044aafd
    JZ 0x0044ab11                       ; 0044aaff | LAB_0044ab11
        ;   XREF to: 0044ab11 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [EAX]             ; 0044ab01
    MOV dword ptr [EDX],ECX             ; 0044ab03 | CVector3f[100] DAT_008879c0
    ...
    PUSH ESI                            ; 0044ab11 | SCollisionInfo[100] DAT_00887e70
        ;   Label: LAB_0044ab11
    MOV dword ptr [ESI],0x0             ; 0044ab12 | SCollisionInfo[100] DAT_00887e70
    PUSH EBX                            ; 0044ab18
    MOV EAX,dword ptr [EBX + 0x154]     ; 0044ab19
    CALL dword ptr [EAX + 0x34]         ; 0044ab1f
    ADD ESP,0x8                         ; 0044ab22
    CMP EAX,0x2                         ; 0044ab25
    JZ 0x0044ab4f                       ; 0044ab28 | LAB_0044ab4f
    ...
    JMP 0x0044aabd                      ; 0044ab4a | LAB_0044aabd
    ...
    FNSTSW AX                           ; 0044ab56
    SAHF                                ; 0044ab58
    JA 0x0044ab2a                       ; 0044ab59 | LAB_0044ab2a
    ...
    FNSTSW AX                           ; 0044ab65
    SAHF                                ; 0044ab67
    JC 0x0044ab2a                       ; 0044ab68 | LAB_0044ab2a
        ;   XREF to: 0044ab2a (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0044ab74
    SAHF                                ; 0044ab76
    JC 0x0044ab2a                       ; 0044ab77 | LAB_0044ab2a
        ;   XREF to: 0044ab2a (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0044ab83
    SAHF                                ; 0044ab85
    JA 0x0044ab2a                       ; 0044ab86 | LAB_0044ab2a
        ;   XREF to: 0044ab2a (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0044ab92
    SAHF                                ; 0044ab94
    JC 0x0044ab2a                       ; 0044ab95 | LAB_0044ab2a
        ;   XREF to: 0044ab2a (CONDITIONAL_JUMP)
    ...
    JL 0x0044ac17                       ; 0044ac2d | LAB_0044ac17
    ...
    JLE 0x0044ac72                      ; 0044ac41 | LAB_0044ac72
    ...
    JZ 0x0044ae1c                       ; 0044ac50 | LAB_0044ae1c
    ...
    JL 0x0044ac49                       ; 0044ac70 | LAB_0044ac49
    ...
    JL 0x0044ac9b                       ; 0044acb1 | LAB_0044ac9b
    ...
    JZ 0x0044ad06                       ; 0044aceb | LAB_0044ad06
    ...
    JZ 0x0044ad2e                       ; 0044ad1c | LAB_0044ad2e
    ...
    JLE 0x0044ad76                      ; 0044ad51 | LAB_0044ad76
    ...
    FNSTSW AX                           ; 0044ad62
    SAHF                                ; 0044ad64
    JA 0x0044ad68                       ; 0044ad65 | LAB_0044ad68
    ...
    JL 0x0044ad59                       ; 0044ad74 | LAB_0044ad59
        ;   XREF to: 0044ad59 (CONDITIONAL_JUMP)
    CMP ECX,dword ptr [EDI + 0x204]     ; 0044ad76
        ;   Label: LAB_0044ad76
    JNZ 0x0044ad88                      ; 0044ad7c | LAB_0044ad88
        ;   XREF to: 0044ad88 (CONDITIONAL_JUMP)
    MOV dword ptr [EDI + 0x1f8],0x0     ; 0044ad7e
    PUSH EDI                            ; 0044ad88
        ;   Label: LAB_0044ad88
    CALL core_curtain.cpp_FUN_00449f10  ; 0044ad89 | undefined core_curtain.cpp_FUN_00449f10()
    ...
    FADDP                               ; 0044adab
    FSQRT                               ; 0044adad
    FCOMP double ptr [0x00619c42]       ; 0044adaf | double DOUBLE_00619c42
    FNSTSW AX                           ; 0044adb5
    SAHF                                ; 0044adb7
    JBE 0x0044adc9                      ; 0044adb8 | LAB_0044adc9
        ;   XREF to: 0044adc9 (CONDITIONAL_JUMP)
    MOV dword ptr [EDI + 0x65b34],0x1   ; 0044adba
    JMP 0x0044ac09                      ; 0044adc4 | LAB_0044ac09
    ...
    FADDP                               ; 0044adfa
    FSQRT                               ; 0044adfc
    FCOMP double ptr [0x00619c42]       ; 0044adfe | double DOUBLE_00619c42
    FNSTSW AX                           ; 0044ae04
    SAHF                                ; 0044ae06
    JBE 0x0044abee                      ; 0044ae07 | LAB_0044abee
        ;   XREF to: 0044abee (CONDITIONAL_JUMP)
    MOV dword ptr [EDI + 0x65b34],0x1   ; 0044ae0d
    JMP 0x0044ac09                      ; 0044ae17 | LAB_0044ac09
        ;   XREF to: 0044ac09 (UNCONDITIONAL_JUMP)
    FLD float ptr [EBX + 0x2c]          ; 0044ae1c
        ;   Label: LAB_0044ae1c
    FLD ST0                             ; 0044ae1f
    FLD double ptr [0x00619c22]         ; 0044ae21 | double DOUBLE_00619c22
    FXCH                                ; 0044ae27
    FMUL ST1                            ; 0044ae29
    ...
    JZ 0x0044ae76                       ; 0044ae68 | LAB_0044ae76
        ;   XREF to: 0044ae76 (CONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 0044ae6a
    FMUL double ptr [0x00619c2a]        ; 0044ae6d | double DOUBLE_00619c2a
    ...
    FLD ST0                             ; 0044ae7e
    FMUL double ptr [0x00619c32]        ; 0044ae80 | double DOUBLE_00619c32
    ...
    FLD float ptr [0x00619c3a]          ; 0044af0b | float FLOAT_00619c3a
    FXCH                                ; 0044af11
    FMUL ST1                            ; 0044af13
    FXCH ST4                            ; 0044af15
    ...
    JZ 0x0044afb8                       ; 0044af95 | LAB_0044afb8
    ...
    CALL core_curtain.cpp_FUN_00449fc0  ; 0044b043 | undefined core_curtain.cpp_FUN_00449fc0()
        ;   XREF to: 00449fc0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0044b048
    JMP 0x0044ac56                      ; 0044b04b | LAB_0044ac56
        ;   XREF to: 0044ac56 (UNCONDITIONAL_JUMP)
    PUSH EBX                            ; 0044b050
        ;   Label: LAB_0044b050
    PUSH EDI                            ; 0044b051
    CALL core_curtain.cpp_FUN_00449fc0  ; 0044b052 | undefined core_curtain.cpp_FUN_00449fc0()
        ;   XREF to: 00449fc0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0044b057
    JMP 0x0044aca5                      ; 0044b05a | LAB_0044aca5
