...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_curtain_cpp_CCurtain_addFilesToExtract_FUN_0044b960(CCurtain *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH ESI                            ; 0044b960
        ;   Label: core_curtain.cpp_CCurtain_addFilesToExtract_FUN_0044b960
    PUSH EDI                            ; 0044b961
