...
;                               FUNCTION
; *****************************************************************************
; __cdecl CBoundingBox3D * __cdecl core_curtain_cpp_CCurtain_getBoundingBox_FUN_0044b380(CCurtain *this_ptr,CBoundingBox3D *out_box)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x4]       ; 0044b380
        ;   Label: core_curtain.cpp_CCurtain_getBoundingBox_FUN_0044b380
    MOV EAX,dword ptr [ESP + 0x8]       ; 0044b384
    FLD float ptr [EDX + 0x158]         ; 0044b388
    FCHS                                ; 0044b38e
    FLD double ptr [0x00619c4a]         ; 0044b390 | DOUBLE_00619c4a
    FXCH                                ; 0044b396
    FMUL ST1                            ; 0044b398
    ...
    FADD double ptr [0x00619c52]        ; 0044b3c1 | DOUBLE_00619c52
