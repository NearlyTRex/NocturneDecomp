...
;                               FUNCTION
; *****************************************************************************
; __cdecl CCurtain * __cdecl core_curtain_cpp_CCurtain_dtor_FUN_0044ba30(CCurtain *this_ptr,uint flags)
;
; Parameters:
...
;   core_curtain.cpp_freeCurtainVertices_FUN_0044bad0
...
section .text
    ...
    PUSH EBX                            ; 0044ba44
    CALL core_curtain.cpp_freeCurtainVertices_FUN_0044bad0 ; 0044ba45
        ;   XREF to: 0044bad0 (UNCONDITIONAL_CALL)  ; SCurtainVertex * core_curtain.cpp_freeCurtainVertices_FUN_0044bad0(SCurtainVertex * objs)
    ...
    PUSH EAX                            ; 0044ba88
        ;   Label: LAB_0044ba88
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 0044ba89
