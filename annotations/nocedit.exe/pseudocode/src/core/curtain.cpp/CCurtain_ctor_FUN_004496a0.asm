...
;                               FUNCTION
; *****************************************************************************
; __cdecl CCurtain * __cdecl core_curtain_cpp_CCurtain_ctor_FUN_004496a0(CCurtain *this_ptr)
;
; Parameters:
; CCurtain *       Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_curtain.cpp_factoryFunc_FUN_00449660 at 0044967a
;
; Referenced Globals:
...
section .text
    ...
    PUSH ESI                            ; 004496a0
        ;   Label: core_curtain.cpp_CCurtain_ctor_FUN_004496a0
    PUSH EDI                            ; 004496a1
