...

{
  ...
  if (((this_ptr->is_visible != 0) || (this_ptr->falling != 0)) &&
    ...
    if ((iVar6 == 0) || (this_ptr->falling != 0)) {
      ...
      iStack_28 = 0;
      INT_008879bc = 0;
      for (iStack_20 = 0; iVar6 = INT_008879bc, iStack_20 < g_CDemonSetPtr->character_count;
          iStack_20 = iStack_20 + 1) {
        iVar10 = *(int *)((int)g_CDemonSetPtr->characters + iStack_28);
        pSVar11 = SCollisionInfo_ARRAY_00887e70 + INT_008879bc;
        if (CVector3f_ARRAY_008879c0 + INT_008879bc != (CVector3f *)(iVar10 + 0x20)) {
          CVector3f_ARRAY_008879c0[INT_008879bc].x = ((CVector3f *)(iVar10 + 0x20))->x;
          CVector3f_ARRAY_008879c0[iVar6].y = *(float *)(iVar10 + 0x24);
          CVector3f_ARRAY_008879c0[iVar6].z = *(float *)(iVar10 + 0x28);
        }
        pSVar11->ray_type = 0;
        iVar7 = (**(code **)(*(int *)(iVar10 + 0x154) + 0x34))(iVar10,pSVar11);
        if (((iVar7 == 2) && (*(float *)(iVar10 + 0x24) <= local_78)) &&
           ((local_a8 <=
             *(float *)(iVar10 + 0x24) + SCollisionInfo_ARRAY_00887e70[iVar6].cylinder_top_y &&
            ((((local_ac <=
                *(float *)(iVar10 + 0x20) + SCollisionInfo_ARRAY_00887e70[iVar6].cylinder_radius &&
               (*(float *)(iVar10 + 0x20) - SCollisionInfo_ARRAY_00887e70[iVar6].cylinder_radius <=
                local_7c)) &&
              (local_a4 <=
               *(float *)(iVar10 + 0x28) + SCollisionInfo_ARRAY_00887e70[iVar6].cylinder_radius)) &&
             (*(float *)(iVar10 + 0x28) - SCollisionInfo_ARRAY_00887e70[iVar6].cylinder_radius <=
              local_74)))))) {
      ...
      if (0 < this_ptr->vertex_count) {
        ...
        do {
          if (pSVar9->is_pinned == 0) {
            ...
            core_curtain_cpp_CCurtain_solveConstraints_FUN_00449fc0(this_ptr,pSVar9);
          }
          pSVar9 = pSVar9 + 1;
