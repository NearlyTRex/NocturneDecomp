...

{
  ...
  if (((iVar4 != 0) && (this_ptr->cinched_top != 0)) && (*(int *)(this_ptr->unk6 + 4) == 0)) {
    pCVar2 = (*((this_ptr->base).vtable._ub)->getBoundingBox)
  ...
  pcVar5 = this_ptr->unk4 + 0xc;
  if (0 < this_ptr->unk2) {
    do {
      *(int *)pcVar5 = (int)ROUND(*(float *)pSVar6->unk * 256.0f);
      *(int *)(pcVar5 + 4) = (int)ROUND(*(float *)(pSVar6->unk + 4) * 256.0f);
      *(int *)(pcVar5 + 8) = (int)ROUND(*(float *)(pSVar6->unk + 8) * 256.0f);
      iVar4 = iVar4 + 1;
      pSVar6 = pSVar6 + 1;
      pcVar5 = pcVar5 + 0xc;
