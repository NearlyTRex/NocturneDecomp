...

{
  ...
  if (0 < *(int *)(in_stack_00000004 + 0x204)) {
    local_18 = in_stack_00000004 + 0x208;
    local_14 = (CMatrix3x3f *)(in_stack_00000004 + 0x3c);
    pfVar2 = (float *)(in_stack_00000004 + 0x228);
    do {
      input = (CVector3f *)(iVar3 * 0x74 + local_18);
      pCVar1 = core_dirmat_cpp_CMatrix3x3f_transformVector_FUN_00471fd0(local_14,&local_30,input);
      local_24 = pCVar1->x + *(float *)(in_stack_00000004 + 0x20);
      local_20 = pCVar1->y + *(float *)(in_stack_00000004 + 0x24);
      local_1c = pCVar1->z + *(float *)(in_stack_00000004 + 0x28);
      if (pfVar2 != &local_24) {
        *pfVar2 = local_24;
        pfVar2[1] = local_20;
        pfVar2[2] = local_1c;
