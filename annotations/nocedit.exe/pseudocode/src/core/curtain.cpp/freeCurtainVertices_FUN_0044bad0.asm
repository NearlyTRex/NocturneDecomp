...
;                               FUNCTION
; *****************************************************************************
; __cdecl SCurtainVertex * __cdecl core_curtain_cpp_freeCurtainVertices_FUN_0044bad0(SCurtainVertex *objs)
;
; Parameters:
...
section .text
    ...
    PUSH 0x65c5f0                       ; 0044bad0 | g_SCurtainVertexTypeInfo
        ;   Label: core_curtain.cpp_freeCurtainVertices_FUN_0044bad0
    PUSH 0x3e8                          ; 0044bad5
