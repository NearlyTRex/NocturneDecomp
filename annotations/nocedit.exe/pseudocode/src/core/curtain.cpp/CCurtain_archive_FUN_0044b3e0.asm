...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_curtain_cpp_CCurtain_archive_FUN_0044b3e0(CCurtain *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0044b3e0
        ;   Label: core_curtain.cpp_CCurtain_archive_FUN_0044b3e0
    SUB ESP,0x4                         ; 0044b3e1
    MOV EBX,dword ptr [ESP + 0xc]       ; 0044b3e4
    PUSH EBX                            ; 0044b3e8
    CALL core_actor.cpp_CDemonActor_archive_FUN_0040c1c0 ; 0044b3e9
    ...
    PUSH EAX                            ; 0044b3fc
    CALL core_actor.cpp_archiveVector_FUN_0040b340 ; 0044b3fd
    ...
    PUSH EAX                            ; 0044b410
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 0044b411
    ...
    PUSH EAX                            ; 0044b424
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 0044b425
    ...
    PUSH EAX                            ; 0044b44f
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 0044b450
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    PUSH EAX                            ; 0044b4ab
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 0044b4ac
    ...
    PUSH EAX                            ; 0044b52c
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 0044b52d
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    PUSH EAX                            ; 0044b5ca
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 0044b5cb
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH EBX                            ; 0044b5ec
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 0044b5ed
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
