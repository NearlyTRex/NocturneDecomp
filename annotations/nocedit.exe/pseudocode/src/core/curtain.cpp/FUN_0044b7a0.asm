...
section .text
    ...
    PUSH 0x1d                           ; 0044b7a8
    MOV EAX,[0x0067cf44]                ; 0044b7aa | CKeys * g_CKeysPtr
    PUSH EAX                            ; 0044b7af | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 0044b7b0 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 0044b7b2
    ADD ESP,0x8                         ; 0044b7b4
    TEST EAX,EAX                        ; 0044b7b7
    JZ 0x0044b8aa                       ; 0044b7b9 | LAB_0044b8aa
        ;   XREF to: 0044b8aa (CONDITIONAL_JUMP)
    MOV EAX,[0x0067b654]                ; 0044b7bf | CGame * g_CGamePtr
    PUSH 0x4b                           ; 0044b7c4
    FLD float ptr [EAX + 0x264]         ; 0044b7c6 | g_CGameInstance.delta_time_float
    MOV EAX,[0x0067cf44]                ; 0044b7cc | CKeys * g_CKeysPtr
    FMUL double ptr [0x00619de2]        ; 0044b7d1 | double DOUBLE_00619de2
    PUSH EAX                            ; 0044b7d7 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 0044b7d8 | void * g_CKeysPtr
    FSTP float ptr [ESP + 0xc]          ; 0044b7da
    CALL dword ptr [EDX]                ; 0044b7de
    ADD ESP,0x8                         ; 0044b7e0
    TEST EAX,EAX                        ; 0044b7e3
    JZ 0x0044b7f7                       ; 0044b7e5 | LAB_0044b7f7
    ...
    PUSH 0x4d                           ; 0044b7f7
        ;   Label: LAB_0044b7f7
    MOV EAX,[0x0067cf44]                ; 0044b7f9 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 0044b7fe | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 0044b7ff | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 0044b801
    ADD ESP,0x8                         ; 0044b803
    TEST EAX,EAX                        ; 0044b806
    JZ 0x0044b81a                       ; 0044b808 | LAB_0044b81a
    ...
    PUSH 0x50                           ; 0044b81a
        ;   Label: LAB_0044b81a
    MOV EAX,[0x0067cf44]                ; 0044b81c | CKeys * g_CKeysPtr
    PUSH EAX                            ; 0044b821 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 0044b822 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 0044b824
    ADD ESP,0x8                         ; 0044b826
    TEST EAX,EAX                        ; 0044b829
    JZ 0x0044b83d                       ; 0044b82b | LAB_0044b83d
    ...
    PUSH 0x48                           ; 0044b83d
        ;   Label: LAB_0044b83d
    MOV EAX,[0x0067cf44]                ; 0044b83f | CKeys * g_CKeysPtr
    PUSH EAX                            ; 0044b844 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 0044b845 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 0044b847
    ADD ESP,0x8                         ; 0044b849
    TEST EAX,EAX                        ; 0044b84c
    JZ 0x0044b860                       ; 0044b84e | LAB_0044b860
    ...
    JGE 0x0044b878                      ; 0044b870 | LAB_0044b878
    ...
    FNSTSW AX                           ; 0044b881
    SAHF                                ; 0044b883
    JNC 0x0044b88f                      ; 0044b884 | LAB_0044b88f
    ...
    PUSH EBX                            ; 0044b8aa
        ;   Label: LAB_0044b8aa
    CALL core_actor.cpp_CDemonActor_processInEditor_FUN_0040d040 ; 0044b8ab | void core_actor.cpp_CDemonActor_processInEditor_FUN_0040d040(CDemonActor * this_ptr)
