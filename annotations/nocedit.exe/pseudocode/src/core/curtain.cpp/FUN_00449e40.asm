...
section .text
    ...
    JLE 0x00449eeb                      ; 00449e55 | LAB_00449eeb
    ...
    PUSH EDX                            ; 00449e91
    CALL core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0 ; 00449e92 | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0(CMatrix3x3f * this_ptr, CVector3f * output, CVector3f * input)
    ...
    JL 0x00449e80                       ; 00449ee9 | LAB_00449e80
    ...
    JMP 0x00449ebf                      ; 00449f07 | LAB_00449ebf
