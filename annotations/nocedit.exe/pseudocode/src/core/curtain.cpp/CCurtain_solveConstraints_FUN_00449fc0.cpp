  ...
  if (0 < INT_008879bc) {
    ...
    do {
      if (((((float)-0.5 <= (vertex->velocity).y) ||
           (fVar7 = *(float *)((int)&CVector3f_ARRAY_008879c0[0].y + iVar11) +
                    SCollisionInfo_ARRAY_00887e70[local_18].cylinder_top_y,
           fVar7 <= (vertex->world_position).y)) ||
          ((vertex->world_position).y <= *(float *)((int)&CVector3f_ARRAY_008879c0[0].y + iVar11)))
         || (fVar5 = (vertex->world_position).x -
                     *(float *)((int)&CVector3f_ARRAY_008879c0[0].x + iVar11),
            fVar3 = (vertex->world_position).z -
                    *(float *)((int)&CVector3f_ARRAY_008879c0[0].z + iVar11),
            SCollisionInfo_ARRAY_00887e70[local_18].cylinder_radius <=
            SQRT(fVar3 * fVar3 + fVar5 * fVar5))) {
        if ((*(float *)((int)&CVector3f_ARRAY_008879c0[0].y + iVar11) <= (vertex->world_position).y)
           && (fVar7 = *(float *)((int)&CVector3f_ARRAY_008879c0[0].y + iVar11) +
                       SCollisionInfo_ARRAY_00887e70[local_18].cylinder_top_y,
          ...
          if (fVar5 <= SCollisionInfo_ARRAY_00887e70[local_18].cylinder_radius) {
            if ((vertex->last_world_position).y < fVar7) {
              if (*(float *)((int)&CVector3f_ARRAY_008879c0[0].y + iVar11) <
                ...
                fVar6 = pCVar1->x;
                fVar8 = *pfVar10;
                fVar9 = *(float *)((int)&CVector3f_ARRAY_008879c0[0].y + iVar11);
                fVar7 = (vertex->world_position).y;
                fVar5 = (vertex->world_position).z;
                fVar3 = pSVar12->inv_delta_time;
                fVar4 = pSVar12->inv_delta_time;
