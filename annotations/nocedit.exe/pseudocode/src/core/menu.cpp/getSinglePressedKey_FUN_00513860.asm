...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_menu.cpp_getSinglePressedKey_FUN_00513860(void)
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH ESI                            ; 00513861
    MOV EAX,[0x0067b654]                ; 00513862 | CGame g_CGameInstance | CGame * g_CGamePtr
    CMP dword ptr [EAX + 0xbc],0x2      ; 00513867 | g_CGameInstance.game_control
    JZ 0x00513895                       ; 0051386e | LAB_00513895
    ...
    PUSH EBX                            ; 00513877
        ;   Label: LAB_00513877
    MOV EAX,[0x0067cf44]                ; 00513878 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 0051387d | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 0051387e | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 00513880
    ADD ESP,0x8                         ; 00513882
    TEST EAX,EAX                        ; 00513885
    JZ 0x005138a0                       ; 00513887 | LAB_005138a0
        ;   XREF to: 005138a0 (CONDITIONAL_JUMP)
    TEST ESI,ESI                        ; 00513889
    JL 0x005138ae                       ; 0051388b | LAB_005138ae
        ;   XREF to: 005138ae (CONDITIONAL_JUMP)
    MOV EAX,0xfffffffe                  ; 0051388d
    POP ESI                             ; 00513892
    POP EBX                             ; 00513893
    RET                                 ; 00513894
    PUSH EAX                            ; 00513895 | CGame g_CGameInstance
        ;   Label: LAB_00513895
    CALL core_game.cpp_CGame_resetKeyState_FUN_004dbe60 ; 00513896 | undefined core_game.cpp_CGame_resetKeyState_FUN_004dbe60()
        ;   XREF to: 004dbe60 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0051389b
    JMP 0x00513870                      ; 0051389e | LAB_00513870
        ;   XREF to: 00513870 (UNCONDITIONAL_JUMP)
    INC EBX                             ; 005138a0
        ;   Label: LAB_005138a0
    CMP EBX,0x258                       ; 005138a1
    JL 0x00513877                       ; 005138a7 | LAB_00513877
    ...
    JL 0x00513877                       ; 005138b7 | LAB_00513877
        ;   XREF to: 00513877 (CONDITIONAL_JUMP)
