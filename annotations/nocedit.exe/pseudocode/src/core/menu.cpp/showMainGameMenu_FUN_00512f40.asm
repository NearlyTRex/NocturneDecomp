...
section .text
    ...
    CMP dword ptr [0x03f6b878],0x0      ; 00512f54 | g_UseDirect3D
    ...
    JZ 0x00513243                       ; 0051321b
        ;   XREF to: 00513243 (CONDITIONAL_JUMP)  ; LAB_00513243
    CALL sound_sndmain.cpp_isSoundMuted_FUN_005a96b0 ; 0051321d
    ...
    PUSH EAX                            ; 0051322c
    CALL sound_sndmain.cpp_setSoundMuted_FUN_005a96c0 ; 0051322d
    ...
    CMP dword ptr [0x03f6b878],0x0      ; 00513272 | g_UseDirect3D
        ;   Label: LAB_00513272
    ...
    MOV dword ptr [0x03f6b878],ECX      ; 005132ba | g_UseDirect3D
