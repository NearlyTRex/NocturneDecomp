...
LAB_005119ab:
    ...
    do {
      ...
      if (iVar5 == 0) break;
      iVar5 = iVar5 + -1;
      pacVar12 = (char (*) [256])((int)pacVar12 + (uint)bVar13 * -2 + 1);
      pcVar3 = *pacVar12;
      pacVar12 = pacVar12;
    } while (*pcVar3 != '\0');
    pcVar3 = pacVar12[-1] + 0xff;
    do {
      cVar2 = *pcVar9;
      *pcVar3 = cVar2;
      if (cVar2 == '\0') break;
    ...
    pcVar7 = g_ControlsMenuTextBuffers[6];
    do {
      cVar2 = *pcVar3;
      *pcVar7 = cVar2;
      if (cVar2 == '\0') break;
    ...
    do {
      ...
      if (iVar6 == 0) break;
      iVar6 = iVar6 + -1;
      pacVar8 = (char (*) [256])((int)pacVar9 + (uint)bVar13 * -2 + 1);
      pcVar3 = *pacVar9;
      pacVar9 = pacVar8;
    } while (*pcVar3 != '\0');
    pcVar3 = pacVar8[-1] + 0xff;
    do {
      cVar2 = *pcVar10;
      *pcVar3 = cVar2;
      if (cVar2 == '\0') break;
