...
// Convention: unknown
// Signature: undefined core_menu.cpp_GetGameMainMenuChoice_FUN_00510000()
// Cross-references:
...
//   undefined4 DAT_02f26cb8
//   int g_MessageCount
// Function calls:
//   core_moon.cpp_FUN_0052a3f0
...
undefined4
core_menu_cpp_GetGameMainMenuChoice_FUN_00510000
          (undefined4 param_1,undefined4 param_2,CBitFont *unaff_EBX,undefined4 param_4,
          undefined4 param_5,int *param_6,undefined4 *param_7,int param_8,char *param_9,
...

{
  ...
  iVar4 = param_8;
  if (param_9 != (char *)0x0) {
    engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80(g_ThemeFont,param_9,0xa0,param_8,7,0);
    iVar4 = engine_font_cpp_CBitFont_getCharWidth_FUN_004d01d0(pCVar8,0x58);
    iVar4 = param_8 + iVar4 * 2;
  }
  pCVar8 = (CBitFont *)0x0;
  if (0 < param_8) {
    do {
      engine_font_cpp_CBitFont_getTextWidth_FUN_004cfe80(unaff_EDI,(char *)*param_7);
      engine_font_cpp_CBitFont_getCharWidth_FUN_004d01d0(in_stack_ffffffe4,0x58);
      iVar7 = 0xf8;
      if (in_stack_ffffffdc == *param_6) {
        iVar1 = core_moon_cpp_FUN_0052a3f0();
        if (iVar1 == 0) {
...
// 0051008e: CALL core_moon.cpp_FUN_0052a3f0
