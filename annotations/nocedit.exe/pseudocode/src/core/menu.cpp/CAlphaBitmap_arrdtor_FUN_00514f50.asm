...
;                               FUNCTION
; *****************************************************************************
; __cdecl CAlphaBitmap * __cdecl core_menu_cpp_CAlphaBitmap_arrdtor_FUN_00514f50(CAlphaBitmap *objs,uint flags)
;
; Parameters:
...
section .text
    ...
    PUSH 0x65e9f0                       ; 00514f50 | g_CAlphaBitmapTypeInfo
        ;   Label: core_menu.cpp_CAlphaBitmap_arrdtor_FUN_00514f50
    PUSH 0x8                            ; 00514f55
