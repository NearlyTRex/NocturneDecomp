...
; SSoundDeviceInfo Stack[-0x678]:280  local_678
; SSoundDeviceInfo Stack[-0x560]:280  local_560
; char[256]        Stack[-0x448]:256  local_448
; char[256]        Stack[-0x348]:256  local_348
; char[256]        Stack[-0x248]:256  local_248
; char[252]        Stack[-0x148]:252  local_148
; undefined8       Stack[-0x4c]:8  uStack_4c
; int              Stack[-0x40]:4  local_40
; int[2]           Stack[-0x3c]:8  local_3c
