...

{
  ...
  do {
    ...
    do {
      ...
      if (iVar7 == 0) break;
      iVar7 = iVar7 + -1;
      pacVar10 = (char (*) [256])((int)pacVar10 + (uint)bVar15 * -2 + 1);
      pcVar12 = *pacVar10;
      pacVar10 = pacVar10;
    } while (*pcVar12 != '\0');
    ...
    if (iVar3 == 0) {
      ...
      pcVar4 = local_348;
      iVar3 = -1;
      pacVar13 = g_SoundMenuTextBuffers + 1;
      do {
        pacVar13 = pacVar13;
        if (iVar3 == 0) break;
        iVar3 = iVar3 + -1;
        pacVar13 = (char (*) [256])((int)pacVar13 + (uint)bVar15 * -2 + 1);
        pcVar12 = *pacVar13;
        pacVar13 = pacVar13;
      } while (*pcVar12 != '\0');
      ...
      iVar3 = -1;
      pacVar11 = g_SoundMenuTextBuffers + 1;
      do {
        pacVar14 = pacVar11;
        if (iVar3 == 0) break;
        iVar3 = iVar3 + -1;
        pacVar14 = (char (*) [256])((int)pacVar11 + (uint)bVar15 * -2 + 1);
        pcVar12 = *pacVar11;
        pacVar11 = pacVar14;
      } while (*pcVar12 != '\0');
      pcVar12 = pacVar14[-1] + 0xff;
      do {
        cVar2 = *pcVar4;
        *pcVar12 = cVar2;
        if (cVar2 == '\0') break;
    ...
    if (iVar3 == 0) {
      ...
      do {
        ...
        if (iVar3 == 0) break;
        iVar3 = iVar3 + -1;
        pcVar15 = pcVar4 + (uint)bVar15 * -2 + 1;
        cVar2 = *pcVar4;
        pcVar4 = pcVar15;
      } while (cVar2 != '\0');
      pcVar15 = pcVar15 + -1;
    ...
    if (iVar3 == 0) {
      ...
      do {
        ...
        if (iVar3 == 0) break;
        iVar3 = iVar3 + -1;
        pcVar16 = pcVar15 + (uint)bVar15 * -2 + 1;
        cVar2 = *pcVar15;
        pcVar15 = pcVar16;
      } while (cVar2 != '\0');
      pcVar16 = pcVar16 + -1;
    ...
    do {
      ...
      if (iVar3 == 0) break;
      iVar3 = iVar3 + -1;
      pcVar12 = pcVar4 + (uint)bVar15 * -2 + 1;
      cVar2 = *pcVar4;
      pcVar4 = pcVar12;
    } while (cVar2 != '\0');
    pcVar12 = pcVar12 + -1;
    do {
      cVar2 = pSVar9->device_name[0];
      *pcVar12 = cVar2;
      if (cVar2 == '\0') break;
      cVar2 = pSVar9->device_name[1];
