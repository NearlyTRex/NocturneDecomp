...
section .text
    ...
    PUSH 0x280                          ; 00510ba5
    PUSH 0x636688                       ; 00510baa | = "brightness"
    PUSH 0x2f26cbc                      ; 00510baf | g_CalibrationBitmap
    CALL engine_alphabit.cpp_CAlphaBitmap_load_FUN_004105d0 ; 00510bb4
    ...
    PUSH EAX                            ; 00510bda
    CALL core_menu.cpp_showCalibrationTestPattern_FUN_00510a50 ; 00510bdb
        ;   XREF to: 00510a50 (UNCONDITIONAL_CALL)  ; void core_menu.cpp_showCalibrationTestPattern_FUN_00510a50(char * message_text)
    ADD ESP,0x4                         ; 00510be0
    PUSH 0x6366bc                       ; 00510be3 | = "2. Turn your brightness up, so that y..."
    CALL support_newmsg.cpp_getLocalizedString_FUN_005441f0 ; 00510be8
        ;   XREF to: 005441f0 (UNCONDITIONAL_CALL)  ; char * support_newmsg.cpp_getLocalizedString_FUN_005441f0(char * key)
    ADD ESP,0x4                         ; 00510bed
    PUSH EAX                            ; 00510bf0
    CALL core_menu.cpp_showCalibrationTestPattern_FUN_00510a50 ; 00510bf1
        ;   XREF to: 00510a50 (UNCONDITIONAL_CALL)  ; void core_menu.cpp_showCalibrationTestPattern_FUN_00510a50(char * message_text)
    ADD ESP,0x4                         ; 00510bf6
    PUSH 0x63670f                       ; 00510bf9 | = "3. Turn down the brightness, so that ..."
    CALL support_newmsg.cpp_getLocalizedString_FUN_005441f0 ; 00510bfe
        ;   XREF to: 005441f0 (UNCONDITIONAL_CALL)  ; char * support_newmsg.cpp_getLocalizedString_FUN_005441f0(char * key)
    ADD ESP,0x4                         ; 00510c03
    PUSH EAX                            ; 00510c06
    CALL core_menu.cpp_showCalibrationTestPattern_FUN_00510a50 ; 00510c07
        ;   XREF to: 00510a50 (UNCONDITIONAL_CALL)  ; void core_menu.cpp_showCalibrationTestPattern_FUN_00510a50(char * message_text)
    ADD ESP,0x4                         ; 00510c0c
    PUSH 0x63675b                       ; 00510c0f | = "4. Turn your contrast all the way up."
    CALL support_newmsg.cpp_getLocalizedString_FUN_005441f0 ; 00510c14
        ;   XREF to: 005441f0 (UNCONDITIONAL_CALL)  ; char * support_newmsg.cpp_getLocalizedString_FUN_005441f0(char * key)
    ADD ESP,0x4                         ; 00510c19
    PUSH EAX                            ; 00510c1c
    CALL core_menu.cpp_showCalibrationTestPattern_FUN_00510a50 ; 00510c1d
        ;   XREF to: 00510a50 (UNCONDITIONAL_CALL)  ; void core_menu.cpp_showCalibrationTestPattern_FUN_00510a50(char * message_text)
    ADD ESP,0x4                         ; 00510c22
    PUSH 0x636781                       ; 00510c25 | = "You're done with calibration."
    CALL support_newmsg.cpp_getLocalizedString_FUN_005441f0 ; 00510c2a
        ;   XREF to: 005441f0 (UNCONDITIONAL_CALL)  ; char * support_newmsg.cpp_getLocalizedString_FUN_005441f0(char * key)
    ADD ESP,0x4                         ; 00510c2f
    PUSH EAX                            ; 00510c32
    CALL core_menu.cpp_showCalibrationTestPattern_FUN_00510a50 ; 00510c33
        ;   XREF to: 00510a50 (UNCONDITIONAL_CALL)  ; void core_menu.cpp_showCalibrationTestPattern_FUN_00510a50(char * message_text)
    ADD ESP,0x4                         ; 00510c38
    PUSH 0x2f26cbc                      ; 00510c3b | g_CalibrationBitmap
    CALL engine_alphabit.cpp_CAlphaBitmap_free_FUN_00410560 ; 00510c40
