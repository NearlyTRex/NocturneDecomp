...
section .text
    ...
    MOV EAX,[0x0067b654]                ; 005b187f | CGame * g_CGamePtr
    CMP dword ptr [EAX + 0x240],0x0     ; 005b1884 | g_CGameInstance.block_auto_save
    JNZ 0x005b1b09                      ; 005b188b | LAB_005b1b09
    ...
    JZ 0x005b18f7                       ; 005b18cb | LAB_005b18f7
    ...
    FXCH                                ; 005b190b
    FSUB float ptr [0x03f6af70]         ; 005b190d | CVector3f g_SoundListenerPrev
    FXCH                                ; 005b1913
    ...
    FADDP                               ; 005b1952
    FSQRT                               ; 005b1954
    FCOMP double ptr [0x0065250e]       ; 005b1956 | double DOUBLE_0065250e
    FNSTSW AX                           ; 005b195c
    SAHF                                ; 005b195e
    JC 0x005b1b02                       ; 005b195f | LAB_005b1b02
    ...
    MOVSD.REP ES:EDI,ESI                ; 005b1973 | g_CDemonCameraInstance.base.rotation_matrix.m[0].x
    ...
    CALL sound_sndmain.cpp_set3DListenerPos_FUN_005aa020 ; 005b19ab | void sound_sndmain.cpp_set3DListenerPos_FUN_005aa020(double pos_x, double pos_y, double pos_z)
    ...
    CALL core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0 ; 005b19e4 | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0(CMatrix3x3f * this_ptr, CVector3f * output, CVector3f * input)
    ...
    CALL core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0 ; 005b1a1b | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0(CMatrix3x3f * this_ptr, CVector3f * output, CVector3f * input)
        ;   XREF to: 00471fd0 (UNCONDITIONAL_CALL)
    ...
    CALL core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0 ; 005b1a52 | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0(CMatrix3x3f * this_ptr, CVector3f * output, CVector3f * input)
        ;   XREF to: 00471fd0 (UNCONDITIONAL_CALL)
    ...
    CALL sound_sndmain.cpp_set3DListenerOrient_FUN_005aa0a0 ; 005b1acf | void sound_sndmain.cpp_set3DListenerOrient_FUN_005aa0a0(double front_x, double front_y, double front_z, double up_x, ...)
        ;   XREF to: 005aa0a0 (UNCONDITIONAL_CALL)
    MOV EAX,[0x0067b654]                ; 005b1ad4 | CGame * g_CGamePtr
    ADD ESP,0x48                        ; 005b1ad9
    MOV EDX,dword ptr [EAX + 0x240]     ; 005b1adc | g_CGameInstance.block_auto_save
    MOV dword ptr [0x03f6af7c],EBX      ; 005b1ae2 | CVector3f CVector3f_03f6af7c
    TEST EDX,EDX                        ; 005b1ae8
    JZ 0x005b1b91                       ; 005b1aea | LAB_005b1b91
        ;   XREF to: 005b1b91 (CONDITIONAL_JUMP)
    LEA EAX,[ESP + 0xa4]                ; 005b1af0
        ;   Label: LAB_005b1af0
    CMP EAX,0x3f6af70                   ; 005b1af7 | CVector3f g_SoundListenerPrev
    JNZ 0x005b1e9c                      ; 005b1afc | LAB_005b1e9c
    ...
    JZ 0x005b1b6f                       ; 005b1b43 | LAB_005b1b6f
    ...
    MOVSD.REP ES:EDI,ESI                ; 005b1b7d | DAT_02d7eb00
    MOV ECX,0xa                         ; 005b1b7f
    LEA EDI,[ESP + 0x14]                ; 005b1b84
    LEA ESI,[ESP + 0x3c]                ; 005b1b88
    JMP 0x005b1982                      ; 005b1b8c | LAB_005b1982
        ;   XREF to: 005b1982 (UNCONDITIONAL_JUMP)
    PUSH 0x6                            ; 005b1b91
        ;   Label: LAB_005b1b91
    MOV EAX,[0x006810c8]                ; 005b1b93 | CDemonSet * g_CDemonSetPtr
    PUSH 0x652506                       ; 005b1b98 | = "castle" | s_castle_00652506 = castle
    ADD EAX,0x14d0f0                    ; 005b1b9d
    PUSH EAX                            ; 005b1ba2 | DAT_03261368
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 005b1ba3 | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005b1ba8
    TEST EAX,EAX                        ; 005b1bab
    JNZ 0x005b1cc0                      ; 005b1bad | LAB_005b1cc0
    ...
    PUSH EAX                            ; 005b1c06
    PUSH ESI                            ; 005b1c07
    PUSH 0x32758e4                      ; 005b1c08 | CDemonCamera g_CDemonCameraInstance
    LEA ESI,[ESP + 0x140]               ; 005b1c0d
    LEA EDI,[ESP + 0x98]                ; 005b1c14
    CALL core_dcamera.cpp_CDemonCamera_screenToWorldCoord_FUN_0044d2a0 ; 005b1c1b | void core_dcamera.cpp_CDemonCamera_screenToWorldCoord_FUN_0044d2a0(CDemonCamera * this_ptr, CVector3i * output_ptr, int screen_x, int screen_y)
    ...
    JL 0x005b1d0b                       ; 005b1c40 | LAB_005b1d0b
    ...
    FNSTSW AX                           ; 005b1c56
    SAHF                                ; 005b1c58
    JNC 0x005b1c69                      ; 005b1c59 | LAB_005b1c69
        ;   XREF to: 005b1c69 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x10]          ; 005b1c5b
    FADD float ptr [0x00652556]         ; 005b1c5f | float FLOAT_00652556
    ...
    FNSTSW AX                           ; 005b1c77
    SAHF                                ; 005b1c79
    JNC 0x005b1c84                      ; 005b1c7a | LAB_005b1c84
        ;   XREF to: 005b1c84 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x10],0x3f800000 ; 005b1c7c
    FLD float ptr [ESP + 0x10]          ; 005b1c84
        ;   Label: LAB_005b1c84
    FMUL float ptr [0x0065252e]         ; 005b1c88 | float FLOAT_0065252e
    FADD float ptr [0x03f6af7c]         ; 005b1c8e | CVector3f CVector3f_03f6af7c
    ADD EBX,0x2                         ; 005b1c94
    FSTP float ptr [0x03f6af7c]         ; 005b1c97 | CVector3f CVector3f_03f6af7c
    CMP EBX,0x21                        ; 005b1c9d
    JNZ 0x005b1bd1                      ; 005b1ca0 | LAB_005b1bd1
    ...
    JNZ 0x005b1bbe                      ; 005b1cba | LAB_005b1bbe
        ;   XREF to: 005b1bbe (CONDITIONAL_JUMP)
    FLD float ptr [0x03f6af7c]          ; 005b1cc0 | CVector3f CVector3f_03f6af7c
        ;   Label: LAB_005b1cc0
    FMUL ST0                            ; 005b1cc6
    FST float ptr [0x03f6af7c]          ; 005b1cc8 | CVector3f CVector3f_03f6af7c
    FLDZ                                ; 005b1cce
    FCOMPP                              ; 005b1cd0
    FNSTSW AX                           ; 005b1cd2
    SAHF                                ; 005b1cd4
    JNC 0x005b1ce9                      ; 005b1cd5 | LAB_005b1ce9
        ;   XREF to: 005b1ce9 (CONDITIONAL_JUMP)
    FLD float ptr [0x03f6af7c]          ; 005b1cd7 | CVector3f CVector3f_03f6af7c
    FADD float ptr [0x00652532]         ; 005b1cdd | float FLOAT_00652532
    FSTP float ptr [0x03f6af7c]         ; 005b1ce3 | CVector3f CVector3f_03f6af7c
    FLD float ptr [0x03f6af7c]          ; 005b1ce9 | CVector3f CVector3f_03f6af7c
        ;   Label: LAB_005b1ce9
    FLD1                                ; 005b1cef
    FCOMPP                              ; 005b1cf1
    FNSTSW AX                           ; 005b1cf3
    SAHF                                ; 005b1cf5
    JNC 0x005b1af0                      ; 005b1cf6 | LAB_005b1af0
        ;   XREF to: 005b1af0 (CONDITIONAL_JUMP)
    MOV dword ptr [0x03f6af7c],0x3f800000 ; 005b1cfc | CVector3f CVector3f_03f6af7c
    JMP 0x005b1af0                      ; 005b1d06 | LAB_005b1af0
    ...
    JGE 0x005b1d28                      ; 005b1d1b | LAB_005b1d28
        ;   XREF to: 005b1d28 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x94],0x1      ; 005b1d1d
    LEA EAX,[ESP + 0x8c]                ; 005b1d28
        ;   Label: LAB_005b1d28
    PUSH EAX                            ; 005b1d2f
    PUSH 0x32758e4                      ; 005b1d30 | CDemonCamera g_CDemonCameraInstance
    LEA ESI,[ESP + 0x124]               ; 005b1d35
    LEA EDI,[ESP + 0xe8]                ; 005b1d3c
    CALL core_dcamera.cpp_CDemonCamera_screenToWorldTransform_FUN_0044d370 ; 005b1d43 | CVector3i * core_dcamera.cpp_CDemonCamera_screenToWorldTransform_FUN_0044d370(CDemonCamera * this_ptr, CVector3i * output_ptr, CVector3i * input_ptr)
    ...
    FLD double ptr [0x00652516]         ; 005b1d71 | double DOUBLE_00652516
    FXCH                                ; 005b1d77
    FMUL ST1                            ; 005b1d79
    ...
    FCOMP double ptr [0x00652536]       ; 005b1e0f | double DOUBLE_00652536
    FNSTSW AX                           ; 005b1e15
    SAHF                                ; 005b1e17
    JBE 0x005b1e31                      ; 005b1e18 | LAB_005b1e31
        ;   XREF to: 005b1e31 (CONDITIONAL_JUMP)
    FLD double ptr [ESP]                ; 005b1e1a
    FADD double ptr [0x0065253e]        ; 005b1e1d | double DOUBLE_0065253e
    FMUL double ptr [0x0065251e]        ; 005b1e23 | double DOUBLE_0065251e
    ...
    FLD1                                ; 005b1e38
    PUSH EAX                            ; 005b1e3a
    MOV EAX,[0x006810c8]                ; 005b1e3b | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
    FADD float ptr [ESP + 0xf4]         ; 005b1e40
    PUSH EAX                            ; 005b1e47 | CDemonSet g_CDemonSetInstance
    FSTP float ptr [ESP + 0xf8]         ; 005b1e48
    CALL core_setcolid.cpp_CDemonSet_rayVoxelHeightQuery_FUN_00572340 ; 005b1e4f | float core_setcolid.cpp_CDemonSet_rayVoxelHeightQuery_FUN_00572340(CDemonSet * this_ptr, CVector3f * position)
    ...
    FCOMP double ptr [0x00652546]       ; 005b1e70 | double DOUBLE_00652546
    FNSTSW AX                           ; 005b1e76
    SAHF                                ; 005b1e78
    JBE 0x005b1c4e                      ; 005b1e79 | LAB_005b1c4e
        ;   XREF to: 005b1c4e (CONDITIONAL_JUMP)
    FLD double ptr [ESP + 0x8]          ; 005b1e7f
    FADD double ptr [0x0065254e]        ; 005b1e83 | double DOUBLE_0065254e
    FMUL double ptr [0x00652526]        ; 005b1e89 | double DOUBLE_00652526
    FADD float ptr [ESP + 0x10]         ; 005b1e8f
    FSTP float ptr [ESP + 0x10]         ; 005b1e93
    JMP 0x005b1c4e                      ; 005b1e97 | LAB_005b1c4e
        ;   XREF to: 005b1c4e (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0xa4]      ; 005b1e9c
        ;   Label: LAB_005b1e9c
    MOV [0x03f6af70],EAX                ; 005b1ea3 | CVector3f g_SoundListenerPrev
