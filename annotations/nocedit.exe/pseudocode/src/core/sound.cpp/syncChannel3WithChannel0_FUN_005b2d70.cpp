...

{
  ...
  if (iVar1 != 0) {
    ...
    fStack00000008 = sound_sndmain_cpp_getSfxChannelVol_FUN_005a9d90(0);
    sound_sndmain_cpp_setSfxChannelVol_FUN_005a9cf0(3,fStack00000008 * g_CurrentVolumeMultiplier);
    return;
  }
