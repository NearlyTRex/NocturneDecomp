...
section .text
    ...
    PUSH EAX                            ; 005b3bb0
    CALL sound_sndmain.cpp_CSfxSample_init_FUN_005a8480 ; 005b3bb1 | CSfxSample * sound_sndmain.cpp_CSfxSample_init_FUN_005a8480(CSfxSample * this_ptr)
        ;   XREF to: 005a8480 (UNCONDITIONAL_CALL)
    LEA EAX,[ESP + 0x4]                 ; 005b3bb6
    MOV DL,byte ptr [EBX]               ; 005b3bba
    ADD ESP,0x4                         ; 005b3bbc
    TEST DL,DL                          ; 005b3bbf
    JZ 0x005b3bcf                       ; 005b3bc1 | LAB_005b3bcf
        ;   XREF to: 005b3bcf (CONDITIONAL_JUMP)
    MOV CL,byte ptr [EBX]               ; 005b3bc3
        ;   Label: LAB_005b3bc3
    CMP CL,0x40                         ; 005b3bc5
    JZ 0x005b3bcf                       ; 005b3bc8 | LAB_005b3bcf
        ;   XREF to: 005b3bcf (CONDITIONAL_JUMP)
    CMP CL,0x2a                         ; 005b3bca
    JNZ 0x005b3bfb                      ; 005b3bcd | LAB_005b3bfb
        ;   XREF to: 005b3bfb (CONDITIONAL_JUMP)
    MOV byte ptr [EAX],0x0              ; 005b3bcf
        ;   Label: LAB_005b3bcf
    MOV EAX,ESP                         ; 005b3bd2
    PUSH EAX                            ; 005b3bd4
    CALL sound_sndmain.cpp_getSampleInfo_FUN_005aa3f0 ; 005b3bd5 | int sound_sndmain.cpp_getSampleInfo_FUN_005aa3f0(CSfxSample * out_sample)
        ;   XREF to: 005aa3f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005b3bda
    TEST EAX,EAX                        ; 005b3bdd
    JNZ 0x005b3c1c                      ; 005b3bdf | LAB_005b3c1c
    ...
    TEST byte ptr [EDX + 0x6849c4],0x2  ; 005b3c05 | char[256] g_CharacterClassificationTable
    JNZ 0x005b3bcf                      ; 005b3c0c | LAB_005b3bcf
        ;   XREF to: 005b3bcf (CONDITIONAL_JUMP)
    ...
    INC EAX                             ; 005b3c15
    TEST DH,DH                          ; 005b3c16
    JNZ 0x005b3bc3                      ; 005b3c18 | LAB_005b3bc3
        ;   XREF to: 005b3bc3 (CONDITIONAL_JUMP)
    JMP 0x005b3bcf                      ; 005b3c1a | LAB_005b3bcf
        ;   XREF to: 005b3bcf (UNCONDITIONAL_JUMP)
    MOV EAX,ESP                         ; 005b3c1c
        ;   Label: LAB_005b3c1c
    PUSH EAX                            ; 005b3c1e
    CALL sound_sndmain.cpp_CSampleInfo_getSampleDuration_FUN_005a84d0 ; 005b3c1f | double sound_sndmain.cpp_CSampleInfo_getSampleDuration_FUN_005a84d0(CSampleInfo * this_ptr)
