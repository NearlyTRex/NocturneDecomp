...

{
  ...
  if (g_CGamePtr->block_auto_save == 0) {
    if (g_TrainLastCameraIndex != g_CDemonSetPtr->selected_camera_index) {
      ...
      local_28 = 0;
      local_3c.y = g_SoundListenerPrev.y + FLOAT_00652756;
  ...
  if (iVar5 == 0) {
    sound_sndmain_cpp_pushSfxOptions_FUN_005a8c30();
    sound_sndmain_cpp_setNextSfxVolume_FUN_005a8a60(in_stack_ffffff1c * (float)DOUBLE_0065275e);
  ...
  do {
    ...
    if (iVar6 != 0) {
      ...
      if ((float)DOUBLE_00652776 < ABS(g_TrainNoiseArray[iVar5].position.z)) {
  ...
  if ((g_TrainNoiseCooldown <= 0.0) && (iStack00000030 != 0)) {
    ...
    puVar11 = (undefined4 *)&stack0xffffff34;
    ...
    *(undefined4 *)((int)fStack0000003c + 4) = 0;
...
// 005b2893: PUSH 0x1
// 005b2895: CALL sound_sndmain.cpp_setNextSfxFlags_FUN_005a8b70
...
// 005b28cf: CALL sound_sndmain.cpp_killSfx_FUN_005a9c40
...
// 005b28df: PUSH EAX
// 005b28e0: CALL sound_sndmain.cpp_isSfxPlaying_FUN_005a9660
...
// 005b294c: PUSH ECX
// 005b294d: CALL sound_sndmain.cpp_isSfxPlaying_FUN_005a9660
//   XREF to: 005a9660 (UNCONDITIONAL_CALL)
...
//   XREF to: 03f6b7c8 (READ)
// 005b29d5: PUSH EAX
// 005b29d6: CALL sound_sndmain.cpp_killSfx_FUN_005a9c40
//   XREF to: 005a9c40 (UNCONDITIONAL_CALL)
...
// 005b2a55: CALL sound_sndmain.cpp_isSfxPlaying_FUN_005a9660
//   XREF to: 005a9660 (UNCONDITIONAL_CALL)
...
// 005b2a6f: CALL sound_sndmain.cpp_setNextSfxVolume_FUN_005a8a60
...
// 005b2aa7: CALL sound_sndmain.cpp_setNextSfxVolume_FUN_005a8a60
//   XREF to: 005a8a60 (UNCONDITIONAL_CALL)
...
//   XREF to: Stack[-0x124] (DATA)
// 005b2ae0: PUSH EBX
// 005b2ae1: CALL sound_sndmain.cpp_setSfxVolume_FUN_005a9ae0
...
// 005b2b8a: CALL sound_sndmain.cpp_setNextSfxTrackedVelocity_FUN_005a8a00
...
// 005b2bc9: CALL core_sound.cpp_CSound_playTrackedActorSound_FUN_005b3a70
