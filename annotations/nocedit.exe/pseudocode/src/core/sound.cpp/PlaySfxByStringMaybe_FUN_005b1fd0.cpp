// Name: core_sound.cpp_PlaySfxByStringMaybe_FUN_005b1fd0
// Address: 005b1fd0
// Address Range: [[005b1fd0, 005b26e9]]
// Convention: unknown
// Signature: undefined core_sound.cpp_PlaySfxByStringMaybe_FUN_005b1fd0()
// Cross-references:
...
//   undefined1 DAT_00652591
//   undefined1 DAT_00652592
//   undefined1 DAT_00652593
//   undefined1 DAT_00652594
...
/* Signature: undefined1 core_sound.cpp_PlaySfxByStringMaybe(undefined4 param_1, undefined4 param_2,
   undefined4 param_3, undefined4 param_4, undefined4 param_5, undefined4 param_6, undefined4
   param_7) */

undefined4 core_sound_cpp_PlaySfxByStringMaybe_FUN_005b1fd0(void)

{
  ...
  if ((in_stack_00000008 != (char *)0x0) && (*in_stack_00000008 != '\0')) {
    cVar6 = *in_stack_00000008;
    local_34 = in_stack_00000008;
    pcVar8 = acStack_110;
    while ((((cVar6 != '\0' && ((g_CharacterClassificationTable[(byte)(*local_34 + 1)] & 2U) == 0))
            && (cVar6 = *local_34, cVar6 != '@')) && (cVar6 != '*'))) {
      if (cVar6 == '[') {
        uVar13 = CONCAT44(&local_30,local_28);
        ...
        iVar3 = crt_stdio_c_sprintf_FUN_005fdbd0(pcVar8,&DAT_0065258d,uVar13);
        pcVar7 = pcVar8 + iVar3;
        if (9 < (int)local_2c) {
          iVar3 = crt_stdio_c_sprintf_FUN_005fdbd0(pcVar7,&DAT_0065258f);
          pcVar7 = pcVar7 + iVar3;
        }
...
LAB_005b20b2:
    if (pcVar7 == (char *)0x0) {
      ...
      pcVar8 = (char *)core_set_cpp_CDemonSet_FUN_0056fac0(g_CDemonSetPtr);
      pcStack_14 = pcVar8;
      local_38 = pcVar8 + 5;
      do {
        iVar3 = 0;
        ...
        do {
          ...
          if ((-1 < (int)pcVar7) && ((int)pcVar7 < 6)) {
            pcVar10 = acStack_110 + 4;
            pcVar5 = &stack0xfffffe90;
            cVar6 = acStack_110[4];
            while (cVar6 != '\0') {
              cVar6 = *pcVar10;
              if (cVar6 == '!') {
    ...
    if (cStack_a8 == '\0') {
      ...
      if (iVar3 < 0) {
        ...
        if (file != (FILE *)0x0) {
          ...
          timeptr = crt_time_c_localtime_FUN_00600288(&stack0x00000004);
          crt_time_c_asctime_FUN_00601768(timeptr);
          crt_stdio_c_fprintf_FUN_005fe6d0(file,"Time: %s");
          pcVar8 = crt_env_c_getenv_FUN_006013f0("USERNAME");
          if (pcVar8 != (char *)0x0) {
            crt_stdio_c_fprintf_FUN_005fe6d0(file,"USERNAME: %s\n");
          }
          pcVar8 = crt_env_c_getenv_FUN_006013f0("COMPUTERNAME");
          if (pcVar8 != (char *)0x0) {
    ...
    while (in_stack_00000018 = pfVar2, cVar6 != '\0') {
    ...
    sound_sndmain_cpp_setNextSfxUserData_FUN_005a8aa0();
    sound_sndmain_cpp_FUN_005a8a60();
    sound_sndmain_cpp_FUN_005a8a80();
    uVar4 = sound_sndmain_cpp_startSfx_FUN_005a8e90();
...
// Assembly code:
// 005b1fd0: PUSH EBX
//   Label: core_sound.cpp_PlaySfxByStringMaybe_FUN_005b1fd0
// 005b1fd1: PUSH ESI
// 005b1fd2: PUSH EDI
// 005b1fd3: PUSH EBP
...
// 005b23d2: CALL core_sound.cpp_FUN_005b1ed0
...
// 005b2400: PUSH ECX
//   XREF to: 03f6af64 (DATA)
// 005b2401: CALL core_sound.cpp_FUN_005b1ed0
//   XREF to: 005b1ed0 (UNCONDITIONAL_CALL)
