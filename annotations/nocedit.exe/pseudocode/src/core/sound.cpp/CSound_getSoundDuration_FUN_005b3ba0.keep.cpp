...

{
  ...
  CSampleInfo *pCVar3;
  double dVar4;
  CSfxSample local_160;
  char cVar1;

  sound_sndmain_cpp_CSfxSample_init_FUN_005a8480(&local_160);
  pCVar3 = &local_160.sample_info;
  cVar1 = *sound_name;
  ...
  pCVar3->name[0] = '\0';
  iVar2 = sound_sndmain_cpp_getSampleInfo_FUN_005aa3f0(&local_160);
  if (iVar2 == 0) {
    return -1.0;
  }
  dVar4 = sound_sndmain_cpp_CSampleInfo_getSampleDuration_FUN_005a84d0(&local_160.sample_info);
  return (float)dVar4;
}
