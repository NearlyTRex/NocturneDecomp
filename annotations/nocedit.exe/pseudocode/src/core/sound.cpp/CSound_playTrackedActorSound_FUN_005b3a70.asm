...
;                               FUNCTION
; *****************************************************************************
; __cdecl uint __cdecl core_sound_cpp_CSound_playTrackedActorSound_FUN_005b3a70 (CSound *this_ptr,CDemonActor *actor,char *sound_name,CVector3f *position_tracker)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005b3a87
    CALL core_sound.cpp_playSfxInternal_FUN_005b1fd0 ; 005b3a88
