// Name: core_sound.cpp_FUN_005b2fd0
// Address: 005b2fd0
// Address Range: [[005b2fd0, 005b382a]]
// Convention: unknown
// Signature: undefined core_sound.cpp_FUN_005b2fd0()
// Cross-references:
...
//   undefined4 s_wind-ctl.wav_0065277e
//   TerminatedCString s_NDUN_0065278b
//   TerminatedCString s_water_2_wav_00652790
//   undefined4 DAT_0065279e
//   undefined4 DAT_006527a6
//   undefined4 DAT_006527ae
//   undefined4 DAT_006527b6
//   undefined4 DAT_006527be
//   undefined4 DAT_006527c6
//   undefined4 DAT_006527ce
//   undefined4 DAT_006527d6
//   undefined4 DAT_006527de
//   undefined4 DAT_006527e6
...
/* WARNING: Removing unreachable block (ram,0x005b37c1) */
/* WARNING: Removing unreachable block (ram,0x005b3801) */
/* WARNING: Removing unreachable block (ram,0x005b3803) */
/* WARNING: Removing unreachable block (ram,0x005b3824) */
/* WARNING: Removing unreachable block (ram,0x005b3780) */
/* WARNING: Removing unreachable block (ram,0x005b37a3) */
/* WARNING: Removing unreachable block (ram,0x005b37ab) */
/* WARNING: Removing unreachable block (ram,0x005b37bb) */
/* WARNING: Removing unreachable block (ram,0x005b3692) */
/* WARNING: Removing unreachable block (ram,0x005b36c5) */
/* WARNING: Recovered jumptable eliminated as dead code */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Signature: undefined1 core_sound.cpp_FUN_005b2fd0(undefined4 param_1) */

CDemonSet * core_sound_cpp_FUN_005b2fd0(void)

{
  ...
  local_38.z = g_CGamePtr->delta_time_float;
  local_20 = local_38.z * (float)_DAT_0065279e;
  ...
  if (DAT_03f6af80 <= (float)_DAT_006527a6) {
  ...
  if (((0.0 < g_CWaterPtr->visible_area_sqft) &&
     ...
     (fVar8 = SQRT(g_CWaterPtr->visible_area_sqft) * (float)_DAT_006527ae + (float)_DAT_006527b6,
     (float)_DAT_006527be < fVar8)) {
    fVar8 = 0.7;
  }
  local_2c.x = -local_18;
  local_20 = fVar8 - DAT_03f6af84;
  ...
  if (DAT_03f6af84 <= (float)_DAT_006527a6) {
    core_sound_cpp_FUN_005b3b90();
    DAT_03f6af84 = 0.0;
  }
  else {
  ...
  if (_DAT_03f6b7b8 <= local_2c.z) {
    ...
    fVar8 = local_2c.z / _DAT_03f6b7b8;
    _DAT_03f6b7b8 = _DAT_03f6b7b8 - local_2c.z;
    _DAT_03f6b7b0 = fVar8 * (_DAT_03f6b7b4 - _DAT_03f6b7b0) + _DAT_03f6b7b0;
  }
  ...
  if (g_CDemonSetPtr->field25_0x15aca8 != 0) {
    if (g_CGamePtr->block_auto_save == 0) {
      if (DAT_03f6b86c != g_CDemonSetPtr->selected_camera_index) {
        ...
        local_2c.y = DAT_03f6af74 + _DAT_006527c6;
    ...
    iVar3 = crt_string_c_stricmp_FUN_005fe7f0((char *)PTR_s_int_00681ef0,"int");
    if (iVar3 == 0) {
    ...
    if (iVar3 == 0) {
      ...
      iVar3 = crt_string_c_stricmp_FUN_005fe7f0((char *)PTR_s_x_00681ef4,(char *)PTR_s_int_00681ef0)
      ;
      if (iVar3 != 0) {
        sound_sndmain_cpp_CallComputingDelay2_FUN_005a9ae0();
      }
    ...
    do {
      ...
      if (iVar4 == 0) {
        uVar6 = 0;
        in_stack_00000048 = pSVar7;
      }
      else {
        fVar1 = _DAT_03f6b860 * in_stack_0000004c;
        fVar2 = _DAT_03f6b864 * in_stack_0000004c;
        fVar8 = *(float *)(pSVar7->field0_0x0 + 4);
        *(float *)pSVar7->field0_0x0 =
             *(float *)pSVar7->field0_0x0 + _DAT_03f6b85c * in_stack_0000004c;
        *(float *)(pSVar7->field0_0x0 + 4) = fVar8 + fVar1;
        *(float *)(pSVar7->field0_0x0 + 8) = *(float *)(pSVar7->field0_0x0 + 8) + fVar2;
        uVar6 = (undefined2)((uint)iVar4 >> 0x10);
        if ((float)_DAT_006527e6 < ABS(*(float *)(STrainNoise_ARRAY_03f6b7bc[iVar3].field0_0x0 + 8))
           ) {
          sound_sndmain_cpp_RelatedToSoundSlotKill_FUN_005a9c40();
          uVar6 = extraout_var;
        }
    ...
    pCVar5 = (CDemonSet *)
             CONCAT22(uVar6,(ushort)(0.0 < _DAT_03f6b868) << 8 | (ushort)NAN(_DAT_03f6b868) << 10 |
...
// Assembly code:
// 005b2fd0: PUSH EBX
//   Label: core_sound.cpp_FUN_005b2fd0
// 005b2fd1: PUSH ESI
// 005b2fd2: PUSH EDI
// 005b2fd3: PUSH EBP
...
// 005b3094: PUSH ESI
// 005b3095: PUSH EBX
// 005b3096: CALL core_sound.cpp_FUN_005b3b80
...
//   XREF to: 03f6af80 (READ)
// 005b30b2: PUSH EDI
// 005b30b3: CALL sound_sndmain.cpp_CallComputingDelay2_FUN_005a9ae0
...
// 005b31a5: PUSH ESI
// 005b31a6: PUSH EBX
// 005b31a7: CALL core_sound.cpp_FUN_005b3b80
//   XREF to: 005b3b80 (UNCONDITIONAL_CALL)
...
//   XREF to: 03f6af84 (READ)
// 005b31c3: PUSH EDI
// 005b31c4: CALL sound_sndmain.cpp_CallComputingDelay2_FUN_005a9ae0
//   XREF to: 005a9ae0 (UNCONDITIONAL_CALL)
...
// 005b3389: PUSH 0x1
// 005b338b: CALL sound_sndmain.cpp_FUN_005a8b70
...
// 005b33bf: PUSH EDI
// 005b33c0: CALL sound_sndmain.cpp_RelatedToSoundSlotKill_FUN_005a9c40
...
// 005b33d7: PUSH EDX
// 005b33d8: CALL sound_sndmain.cpp_SoundLockKillBlah_FUN_005a9660
...
// 005b3447: PUSH EAX
// 005b3448: CALL sound_sndmain.cpp_SoundLockKillBlah_FUN_005a9660
//   XREF to: 005a9660 (UNCONDITIONAL_CALL)
...
//   XREF to: 03f6b7c8 (READ)
// 005b34d0: PUSH EDX
// 005b34d1: CALL sound_sndmain.cpp_RelatedToSoundSlotKill_FUN_005a9c40
//   XREF to: 005a9c40 (UNCONDITIONAL_CALL)
...
// 005b3547: PUSH EDX
// 005b3548: PUSH EBX
// 005b3549: CALL core_sound.cpp_FUN_005b3b90
...
// 005b357b: PUSH ECX
// 005b357c: PUSH EBX
// 005b357d: CALL core_sound.cpp_FUN_005b3b90
//   XREF to: 005b3b90 (UNCONDITIONAL_CALL)
...
// 005b35e7: CALL sound_sndmain.cpp_SoundLockKillBlah_FUN_005a9660
//   XREF to: 005a9660 (UNCONDITIONAL_CALL)
...
// 005b3605: CALL sound_sndmain.cpp_FUN_005a8a60
...
//   XREF to: Stack[-0x144] (DATA)
// 005b363e: CALL sound_sndmain.cpp_FUN_005a8a60
//   XREF to: 005a8a60 (UNCONDITIONAL_CALL)
...
//   XREF to: Stack[-0x144] (DATA)
// 005b3678: PUSH ESI
// 005b3679: CALL sound_sndmain.cpp_CallComputingDelay2_FUN_005a9ae0
//   XREF to: 005a9ae0 (UNCONDITIONAL_CALL)
...
// 005b3724: CALL sound_sndmain.cpp_FUN_005a8a00
