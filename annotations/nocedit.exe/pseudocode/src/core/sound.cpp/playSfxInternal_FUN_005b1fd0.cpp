...
LAB_005b20b2:
    ...
    if (acStack_ac[0] == '\0') {
      ...
      iVar2 = shape_edittool_cpp_CStrList_findString_FUN_004a3030(&g_MissingSoundsList,acStack_110);
      if (iVar2 < 0) {
    ...
    while (cVar5 != '\0') {
      if ((g_CharacterClassificationTable[(byte)(*local_34 + 1)] & 2U) == 0) {
        if (*local_34 == '@') {
          local_20 = -1;
          crt_stdio_c_sscanf_FUN_0060013c(local_34,"@%f%n",&local_178);
          if ((local_20 < 2) || (local_178 < 0.0)) {
            g_CurrentFilename = "..\\core\\sound.cpp";
          ...
          local_1c = -1;
          crt_stdio_c_sscanf_FUN_0060013c(local_34,"*%f%n",&local_17c);
          if ((local_1c < 2) || (local_17c <= 0.0)) {
            g_CurrentFilename = "..\\core\\sound.cpp";
    ...
    sound_sndmain_cpp_setNextSfxVolume_FUN_005a8a60(local_178);
    sound_sndmain_cpp_setNextSfxBaseFrequency_FUN_005a8a80(local_17c);
    uVar3 = sound_sndmain_cpp_startSfx_FUN_005a8e90(acStack_ac);
