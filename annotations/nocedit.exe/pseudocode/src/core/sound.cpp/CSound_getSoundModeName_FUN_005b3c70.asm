...
section .text
    ...
    JL 0x005b3c7d                       ; 005b3c76 | LAB_005b3c7d
        ;   XREF to: 005b3c7d (CONDITIONAL_JUMP)
    CMP EAX,0x1b                        ; 005b3c78
    JL 0x005b3c83                       ; 005b3c7b | LAB_005b3c83
        ;   XREF to: 005b3c83 (CONDITIONAL_JUMP)
    MOV EAX,0x652816                    ; 005b3c7d | = "????" | s_anon_00652816 = ????
        ;   Label: LAB_005b3c7d
    RET                                 ; 005b3c82
    SHL EAX,0x4                         ; 005b3c83
        ;   Label: LAB_005b3c83
    MOV EAX,dword ptr [EAX + 0x681efc]  ; 005b3c86 | SSoundModeEntry[27] g_SoundModeTable
    RET                                 ; 005b3c8c
