...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_sound.cpp_CSound_playSound_FUN_005b3a20(CSound * this_ptr, void * user_data, char * sound_name)
;
; Parameters:
...
;   core_msnedit.cpp_FUN_0053eb40 at 0053eb7d
;   core_script.cpp_FUN_0055ff00 at 0056007a
...
section .text
    ...
    PUSH ECX                            ; 005b3a33
    CALL core_sound.cpp_playSfxInternal_FUN_005b1fd0 ; 005b3a34 | uint core_sound.cpp_playSfxInternal_FUN_005b1fd0(void * user_data, char * sound_name, float x, float y, ...)
