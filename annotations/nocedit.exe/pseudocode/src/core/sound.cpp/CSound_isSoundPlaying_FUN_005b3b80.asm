...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_sound_cpp_CSound_isSoundPlaying_FUN_005b3b80(CSound *this_ptr,uint sfx_handle)
;
; Parameters:
...
;   core_dog.cpp_CZombieDog_processDamage_FUN_0047f820 at 0047f863
;   core_dog.cpp_CZombieDog_process_FUN_0047f140 at 0047f47d
;   core_flame.cpp_CFlame_process_FUN_004c9c00 at 004c9d8b
