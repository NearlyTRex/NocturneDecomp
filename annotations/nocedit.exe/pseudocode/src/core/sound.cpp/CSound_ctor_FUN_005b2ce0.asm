...
section .text
    ...
    CALL sound_sndmain.cpp_setNumberOfSfxChannels_FUN_005a9de0 ; 005b2ced
        ;   XREF to: 005a9de0 (UNCONDITIONAL_CALL)  ; void sound_sndmain.cpp_setNumberOfSfxChannels_FUN_005a9de0(int channel_count)
    ADD ESP,0x4                         ; 005b2cf2
    CALL sound_sndmain.cpp_resetSoundSystemDefaults_FUN_005aae00 ; 005b2cf5
        ;   XREF to: 005aae00 (UNCONDITIONAL_CALL)  ; void sound_sndmain.cpp_resetSoundSystemDefaults_FUN_005aae00()
