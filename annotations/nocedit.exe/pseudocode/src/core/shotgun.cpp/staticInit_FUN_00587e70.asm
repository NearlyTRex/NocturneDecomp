...
section .text
    ...
    PUSH 0x3f95d40                      ; 00587e70 | g_CWeaponClassInfo
        ;   Label: core_shotgun.cpp_staticInit_FUN_00587e70
    PUSH 0x1                            ; 00587e75
    PUSH 0x681814                       ; 00587e77 | g_CShotgunClassVersion
    PUSH 0x587ea0                       ; 00587e7c
    PUSH 0x649adf                       ; 00587e81 | = "CShotgun"
    PUSH 0x3659770                      ; 00587e86 | g_CShotgunClassInfo
    CALL core_actor.cpp_registerActorClass_FUN_0040c2e0 ; 00587e8b
