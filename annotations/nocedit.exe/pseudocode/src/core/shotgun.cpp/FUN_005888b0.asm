...
section .text
    ...
    JNZ 0x005888cc                      ; 005888be | LAB_005888cc
    ...
    CALL core_actor.cpp_getRandomFloat_FUN_0040cc10 ; 005888d6 | float core_actor.cpp_getRandomFloat_FUN_0040cc10(float min_value, float max_value)
