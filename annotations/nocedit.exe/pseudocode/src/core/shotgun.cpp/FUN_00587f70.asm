...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_shotgun.cpp_FUN_00587f70()
;
; Local Variables:
...
section .text
    ...
    JNZ 0x00587f9f                      ; 00587f80 | LAB_00587f9f
        ;   XREF to: 00587f9f (CONDITIONAL_JUMP)
    PUSH dword ptr [ESP + 0x28]         ; 00587f82
        ;   Label: LAB_00587f82
    PUSH EBX                            ; 00587f86
    MOV dword ptr [EBX + 0x57c],0x0     ; 00587f87
    CALL core_weapon.cpp_CWeapon_process_FUN_005ee110 ; 00587f91 | void core_weapon.cpp_CWeapon_process_FUN_005ee110(CWeapon * this_ptr)
    ...
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 00587fca | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
    ...
    JZ 0x00587ffe                       ; 00587fe1 | LAB_00587ffe
    ...
    CALL core_dirmat.cpp_CMatrix3x3f_buildRotationMatrix_FUN_00471d30 ; 00588007 | void core_dirmat.cpp_CMatrix3x3f_buildRotationMatrix_FUN_00471d30(CMatrix3x3f * this_ptr, CVector3f * euler_angles)
        ;   XREF to: 00471d30 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0058800c
    MOV EDI,0x42e00000                  ; 0058800f
    PUSH 0x3f800000                     ; 00588014
    FLD float ptr [EBX + 0x580]         ; 00588019
    PUSH 0x2d7eaf0                      ; 0058801f | CDemonLight g_CDemonLightInstance
    ...
    CALL core_dlight.cpp_CDemonLight_setVolumetricIntensity_FUN_004765e0 ; 00588030 | void core_dlight.cpp_CDemonLight_setVolumetricIntensity_FUN_004765e0(CDemonLight * this_ptr, float intensity)
        ;   XREF to: 004765e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00588035
    PUSH 0x2d7eaf0                      ; 00588038 | CDemonLight g_CDemonLightInstance
    MOV EAX,[0x006810c8]                ; 0058803d | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
    XOR EBP,EBP                         ; 00588042
    PUSH EAX                            ; 00588044 | CDemonSet g_CDemonSetInstance
    MOV dword ptr [0x02d807c0],EBP      ; 00588045 | g_CDemonLightInstance.antialiasing_enabled
    CALL core_set.cpp_CDemonSet_SomethingDynamicLights_FUN_0056d090 ; 0058804b | void core_set.cpp_CDemonSet_SomethingDynamicLights_FUN_0056d090(CDemonSet * this_ptr)
        ;   XREF to: 0056d090 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00588050
    POP ESI                             ; 00588053
    POP EDI                             ; 00588054
    JMP 0x00587f82                      ; 00588055 | LAB_00587f82
