...
section .text
    ...
    JNZ 0x00588b06                      ; 00588aea | LAB_00588b06
        ;   XREF to: 00588b06 (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 00588aec
    PUSH EBX                            ; 00588aee
    CALL core_weapon.cpp_CWeapon_dtor_FUN_005edf80 ; 00588aef | CWeapon * core_weapon.cpp_CWeapon_dtor_FUN_005edf80(CWeapon * this_ptr, uint d1, uint d2, uint d3)
    ...
    JNZ 0x00588b21                      ; 00588b00 | LAB_00588b21
        ;   XREF to: 00588b21 (CONDITIONAL_JUMP)
    MOV EAX,EBX                         ; 00588b02
    POP EBX                             ; 00588b04
    RET                                 ; 00588b05
    PUSH 0x662b90                       ; 00588b06 | WatcomTypeInfo g_CShotgunTypeInfo
        ;   Label: LAB_00588b06
    PUSH EBX                            ; 00588b0b
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 00588b0c | void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00588b11
    PUSH EAX                            ; 00588b14
    CALL crt_memory.c_free_FUN_005fe659 ; 00588b15 | void crt_memory.c_free_FUN_005fe659(void * ptr)
    ...
    PUSH EAX                            ; 00588b21
        ;   Label: LAB_00588b21
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 00588b22 | void shape_memdbg.cpp_debugFree_FUN_0050f210(void * ptr)
