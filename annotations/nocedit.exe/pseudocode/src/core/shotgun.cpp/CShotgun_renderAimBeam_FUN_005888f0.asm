...
;                               FUNCTION
; *****************************************************************************
; void __cdecl core_shotgun_cpp_CShotgun_renderAimBeam_FUN_005888f0(CShotgun *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005888f0
        ;   Label: core_shotgun.cpp_CShotgun_renderAimBeam_FUN_005888f0
    PUSH EDI                            ; 005888f1
    PUSH EBP                            ; 005888f2
    ...
    CALL engine_drender.cpp_CDemonRenderer_isShadowPass_FUN_0048cae0 ; 00588905
    ...
    CALL core_fire.cpp_CFireEffect_createLaserCone_FUN_004c7f20 ; 00588a64
