...
// Convention: __cdecl
// Signature: int __cdecl core_vessel_cpp_FUN_005e98b0(CCryptVessel *this_ptr)
...

{
  ...
  if (this_ptr->visual_type == 1) {
    core_flame_cpp_CFlame_FUN_004ca110((CFlame *)(this_ptr->unk3 + 4));
  }
  ...
  local_20.x = 0;
  local_20.z = 0;
  local_20.y = *(int *)(this_ptr->unk3 + 0x2a8);
  local_2c.x = 0;
  ...
  if (this_ptr->visual_type == 2) {
    uVar6 = 0x5e9a3e;
    dVar5 = round((double)*(float *)(this_ptr->unk3 + 0x42c));
  ...
  core_dmodel_cpp_CKeyFramedModelInstance_prepareForRendering_FUN_00478d20
            ((CKeyFramedModelInstance *)(this_ptr->unk3 + 0x2ac),0.0,0x267);
