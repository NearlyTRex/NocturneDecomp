...
;                               FUNCTION
; *****************************************************************************
; __cdecl CCryptVessel * __cdecl core_vessel_cpp_CCryptVessel_dtor_FUN_005e9d30(CCryptVessel *this_ptr,uint d1,uint d2,uint d3)
;
; Parameters:
...
section .text
    ...
    PUSH 0x6652a0                       ; 005e9d6d | g_CCryptVesselTypeInfo
        ;   Label: LAB_005e9d6d
    PUSH EBX                            ; 005e9d72
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 005e9d73
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 005e9d78
    PUSH EAX                            ; 005e9d7b
    CALL crt_memory.c_free_FUN_005fe659 ; 005e9d7c
    ...
    PUSH EAX                            ; 005e9d88
        ;   Label: LAB_005e9d88
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 005e9d89
