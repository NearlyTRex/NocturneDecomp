...
section .text
    ...
    JZ 0x005e944a                       ; 005e91b4
        ;   XREF to: 005e944a (CONDITIONAL_JUMP)  ; LAB_005e944a
    TEST EDX,EDX                        ; 005e91ba
    JNZ 0x005e94b0                      ; 005e91bc
        ;   XREF to: 005e94b0 (CONDITIONAL_JUMP)  ; LAB_005e94b0
    FLD float ptr [ESP + 0x50]          ; 005e91c2
    FMUL double ptr [0x00657051]        ; 005e91c6 | DOUBLE_00657051
    ...
    JNZ 0x005e9442                      ; 005e91e0
        ;   XREF to: 005e9442 (CONDITIONAL_JUMP)  ; LAB_005e9442
    CMP dword ptr [EBX + 0x3c0],0x0     ; 005e91e6
    JNZ 0x005e94ec                      ; 005e91ed
        ;   XREF to: 005e94ec (CONDITIONAL_JUMP)  ; LAB_005e94ec
    LEA EDI,[EBX + 0x30]                ; 005e91f3
    MOV EBP,dword ptr [EBX + 0x3b8]     ; 005e91f6
    LEA ESI,[EBX + 0x20]                ; 005e91fc
    CMP EBP,0x1                         ; 005e91ff
    JNZ 0x005e95b2                      ; 005e9202
        ;   XREF to: 005e95b2 (CONDITIONAL_JUMP)  ; LAB_005e95b2
    ...
    JZ 0x005e9294                       ; 005e924e
        ;   XREF to: 005e9294 (CONDITIONAL_JUMP)  ; LAB_005e9294
    ...
    JZ 0x005e96ca                       ; 005e92a1
        ;   XREF to: 005e96ca (CONDITIONAL_JUMP)  ; LAB_005e96ca
    MOV EAX,[0x02db87d0]                ; 005e92a7 | g_LocalHeroIndex
        ;   Label: LAB_005e92a7
    MOV EAX,dword ptr [EAX*0x4 + 0x2db87c0] ; 005e92ac | g_HeroActors
    ...
    JZ 0x005e933b                       ; 005e9302
        ;   XREF to: 005e933b (CONDITIONAL_JUMP)  ; LAB_005e933b
    ...
    JZ 0x005e9381                       ; 005e9343
        ;   XREF to: 005e9381 (CONDITIONAL_JUMP)  ; LAB_005e9381
    ...
    PUSH EAX                            ; 005e93e8
    MOV EDI,dword ptr [0x006793d0]      ; 005e93e9 | g_CEventListPtr
    PUSH EDI                            ; 005e93ef | g_CEventListInstance
    CALL core_event.cpp_CEventList_FUN_004aabe0 ; 005e93f0
    ...
    FADD float ptr [0x00657059]         ; 005e9475 | FLOAT_00657059
    LEA ESI,[EBX + 0x30]                ; 005e947b
    FSTP float ptr [EBX + 0x3e8]        ; 005e947e
    CMP EAX,ESI                         ; 005e9484
    JZ 0x005e9498                       ; 005e9486
        ;   XREF to: 005e9498 (CONDITIONAL_JUMP)  ; LAB_005e9498
    ...
    PUSH EAX                            ; 005e94a2
    CALL core_flame.cpp_CFlame_process_FUN_004c9c00 ; 005e94a3
    ...
    FLD float ptr [ESP + 0x50]          ; 005e94b0
        ;   Label: LAB_005e94b0
    FMUL double ptr [0x00657039]        ; 005e94b4 | DOUBLE_00657039
    FADD float ptr [EBX + 0x7ec]        ; 005e94ba
    FST float ptr [EBX + 0x7ec]         ; 005e94c0
    FCOMP double ptr [0x00657041]       ; 005e94c6 | DOUBLE_00657041
    FNSTSW AX                           ; 005e94cc
    SAHF                                ; 005e94ce
    JC 0x005e91d8                       ; 005e94cf
        ;   XREF to: 005e91d8 (CONDITIONAL_JUMP)  ; LAB_005e91d8
    FLD float ptr [EBX + 0x7ec]         ; 005e94d5
    FADD float ptr [0x00657049]         ; 005e94db | FLOAT_00657049
    FSTP float ptr [EBX + 0x7ec]        ; 005e94e1
    JMP 0x005e91d8                      ; 005e94e7
        ;   XREF to: 005e91d8 (UNCONDITIONAL_JUMP)  ; LAB_005e91d8
    ...
    JMP 0x005e9294                      ; 005e9568
        ;   XREF to: 005e9294 (UNCONDITIONAL_JUMP)  ; LAB_005e9294
    ...
    JZ 0x005e959a                       ; 005e957e
        ;   XREF to: 005e959a (CONDITIONAL_JUMP)  ; LAB_005e959a
    ...
    JNZ 0x005e9580                      ; 005e95ab
        ;   XREF to: 005e9580 (CONDITIONAL_JUMP)  ; LAB_005e9580
    JMP 0x005e951a                      ; 005e95ad
        ;   XREF to: 005e951a (UNCONDITIONAL_JUMP)  ; LAB_005e951a
    CMP EBP,0x2                         ; 005e95b2
        ;   Label: LAB_005e95b2
    JNZ 0x005e95ed                      ; 005e95b5
        ;   XREF to: 005e95ed (CONDITIONAL_JUMP)  ; LAB_005e95ed
    ...
    CALL core_fire.cpp_CFireEffect_FUN_004c8c10 ; 005e9660
    ...
    JNZ 0x005e96ab                      ; 005e969a
        ;   XREF to: 005e96ab (CONDITIONAL_JUMP)  ; LAB_005e96ab
    MOV dword ptr [EBX + 0x3b8],0x2     ; 005e969c
    JMP 0x005e9294                      ; 005e96a6
        ;   XREF to: 005e9294 (UNCONDITIONAL_JUMP)  ; LAB_005e9294
    ...
    JMP 0x005e9294                      ; 005e96c5
        ;   XREF to: 005e9294 (UNCONDITIONAL_JUMP)  ; LAB_005e9294
    MOV EAX,dword ptr [EBX + 0x3ac]     ; 005e96ca
        ;   Label: LAB_005e96ca
    CMP dword ptr [EAX + 0x184],0x0     ; 005e96d0
    JNZ 0x005e92a7                      ; 005e96d7
        ;   XREF to: 005e92a7 (CONDITIONAL_JUMP)  ; LAB_005e92a7
    CMP dword ptr [EBX + 0x3b8],0x0     ; 005e96dd
    JNZ 0x005e9442                      ; 005e96e4
        ;   XREF to: 005e9442 (CONDITIONAL_JUMP)  ; LAB_005e9442
    ...
    LEA EAX,[EBX + 0x344]               ; 005e9706
        ;   Label: LAB_005e9706
    PUSH EAX                            ; 005e970c
    MOV EDI,dword ptr [0x006793d0]      ; 005e970d | g_CEventListPtr
    PUSH EDI                            ; 005e9713 | g_CEventListInstance
    CALL core_event.cpp_CEventList_FUN_004aabe0 ; 005e9714
        ;   XREF to: 004aabe0 (UNCONDITIONAL_CALL)  ; void core_event.cpp_CEventList_FUN_004aabe0(CEventList * this_ptr)
