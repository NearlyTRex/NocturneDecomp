...
;                               FUNCTION
; *****************************************************************************
; __cdecl CCryptVessel * __cdecl core_vessel_cpp_CCryptVessel_ctor_FUN_005e8e60(CCryptVessel *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005e8e67
    CALL core_actor.cpp_CDemonActor_ctor_FUN_004088b0 ; 005e8e68
    ...
    PUSH EAX                            ; 005e8e75
    CALL core_dmodel.cpp_CKeyFramedModelInstance_ctor_FUN_00478ce0 ; 005e8e76
    ...
    PUSH EAX                            ; 005e8e83
    CALL core_flame.cpp_CFlame_ctor_FUN_004c9aa0 ; 005e8e84
    ...
    PUSH EAX                            ; 005e8e91
    CALL core_dmodel.cpp_CKeyFramedModelInstance_ctor_FUN_00478ce0 ; 005e8e92
        ;   XREF to: 00478ce0 (UNCONDITIONAL_CALL)  ; CKeyFramedModelInstance * core_dmodel.cpp_CKeyFramedModelInstance_ctor_FUN_00478ce0(CKeyFramedModelInstance * this_ptr)
    ADD ESP,0x4                         ; 005e8e97
    LEA EBX,[EAX + 0xfffff994]          ; 005e8e9a
    PUSH 0x657001                       ; 005e8ea0 | = "vsslbase.kfm"
    LEA EAX,[EBX + 0x158]               ; 005e8ea5
    PUSH EAX                            ; 005e8eab
    MOV ESI,0x65700e                    ; 005e8eac | = "none"
    MOV dword ptr [EBX + 0x154],0x6651b4 ; 005e8eb1 | g_CCryptVesselVTable
    CALL core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0 ; 005e8ebb
    ...
    PUSH EDI                            ; 005e8ee7
    MOV AL,byte ptr [ESI]               ; 005e8ee8 | = "none" | s_ne_00657010
        ;   Label: LAB_005e8ee8
    MOV byte ptr [EDI],AL               ; 005e8eea
    CMP AL,0x0                          ; 005e8eec
    JZ 0x005e8f00                       ; 005e8eee
        ;   XREF to: 005e8f00 (CONDITIONAL_JUMP)  ; LAB_005e8f00
    MOV AL,byte ptr [ESI + 0x1]         ; 005e8ef0 | s_one_0065700f | s_e_00657011
    ADD ESI,0x2                         ; 005e8ef3
    MOV byte ptr [EDI + 0x1],AL         ; 005e8ef6
    ADD EDI,0x2                         ; 005e8ef9
    CMP AL,0x0                          ; 005e8efc
    JNZ 0x005e8ee8                      ; 005e8efe
        ;   XREF to: 005e8ee8 (CONDITIONAL_JUMP)  ; LAB_005e8ee8
    POP EDI                             ; 005e8f00
        ;   Label: LAB_005e8f00
    MOV dword ptr [EBX + 0x3a8],0x0     ; 005e8f01
    MOV dword ptr [EBX + 0x3ac],0x0     ; 005e8f0b
    MOV ESI,0x657013                    ; 005e8f15 | = "none"
    MOV dword ptr [EBX + 0x3bc],0x0     ; 005e8f1a
    LEA EDI,[EBX + 0x344]               ; 005e8f24
    MOV dword ptr [EBX + 0x3b8],0x0     ; 005e8f2a
    PUSH EDI                            ; 005e8f34
    MOV AL,byte ptr [ESI]               ; 005e8f35 | = "none" | s_ne_00657015
        ;   Label: LAB_005e8f35
    MOV byte ptr [EDI],AL               ; 005e8f37
    CMP AL,0x0                          ; 005e8f39
    JZ 0x005e8f4d                       ; 005e8f3b
        ;   XREF to: 005e8f4d (CONDITIONAL_JUMP)  ; LAB_005e8f4d
    MOV AL,byte ptr [ESI + 0x1]         ; 005e8f3d | s_one_00657014 | s_e_00657016
    ADD ESI,0x2                         ; 005e8f40
    MOV byte ptr [EDI + 0x1],AL         ; 005e8f43
    ADD EDI,0x2                         ; 005e8f46
    CMP AL,0x0                          ; 005e8f49
    JNZ 0x005e8f35                      ; 005e8f4b
        ;   XREF to: 005e8f35 (CONDITIONAL_JUMP)  ; LAB_005e8f35
    POP EDI                             ; 005e8f4d
        ;   Label: LAB_005e8f4d
    MOV dword ptr [EBX + 0x3b0],0x41200000 ; 005e8f4e
    PUSH 0x657018                       ; 005e8f58 | = "vsslorb.kfm"
    ...
    CALL core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0 ; 005e8f82
        ;   XREF to: 00478dd0 (UNCONDITIONAL_CALL)  ; void core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0(CKeyFramedModelInstance * this_ptr, char * filename)
