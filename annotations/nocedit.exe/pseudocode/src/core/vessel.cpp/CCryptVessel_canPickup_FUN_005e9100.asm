...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_vessel_cpp_CCryptVessel_canPickup_FUN_005e9100(CCryptVessel *this_ptr,CDemonActor *picker)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005e9100
        ;   Label: core_vessel.cpp_CCryptVessel_canPickup_FUN_005e9100
