...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_vessel.cpp_CCryptVessel_FUN_005e9100(CCryptVessel * this_ptr)
;
; Parameters:
...
section .text
    ...
    JNZ 0x005e9117                      ; 005e910c | LAB_005e9117
        ;   XREF to: 005e9117 (CONDITIONAL_JUMP)
    CMP dword ptr [EAX + 0x3b8],0x0     ; 005e910e
    JZ 0x005e911b                       ; 005e9115 | LAB_005e911b
    ...
    POP EBX                             ; 005e9119
        ;   Label: LAB_005e9119
    RET                                 ; 005e911a
    PUSH 0x657031                       ; 005e911b | = "CHero" | s_CHero_00657031 = CHero
        ;   Label: LAB_005e911b
    MOV EBX,dword ptr [ESP + 0x10]      ; 005e9120
    PUSH EBX                            ; 005e9124
    CALL core_actor.cpp_isOfClass_FUN_0040c6d0 ; 005e9125 | int core_actor.cpp_isOfClass_FUN_0040c6d0(CDemonActor * actor_ptr, char * class_name)
        ;   XREF to: 0040c6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005e912a
    TEST EAX,EAX                        ; 005e912d
    JZ 0x005e9119                       ; 005e912f | LAB_005e9119
