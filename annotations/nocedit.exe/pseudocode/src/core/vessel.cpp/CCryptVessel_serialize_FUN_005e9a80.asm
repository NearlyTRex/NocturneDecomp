...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_vessel_cpp_CCryptVessel_serialize_FUN_005e9a80(CCryptVessel *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005e9a85
    CALL core_actor.cpp_CDemonActor_serialize_FUN_0040c1c0 ; 005e9a86
    ...
    PUSH EAX                            ; 005e9a99
    CALL core_actor.cpp_serializeKeyframedModelInstance_FUN_0040b8f0 ; 005e9a9a
    ...
    PUSH EAX                            ; 005e9aad
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 005e9aae
    ...
    PUSH EAX                            ; 005e9ac1
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 005e9ac2
        ;   XREF to: 0040b870 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeActor_FUN_0040b870(CDemonActor * actor_ptr, char * property_name)
    ADD ESP,0x8                         ; 005e9ac7
    PUSH 0x65709a                       ; 005e9aca | = "destroyedEvent"
    LEA EAX,[EBX + 0x2e0]               ; 005e9acf
    PUSH EAX                            ; 005e9ad5
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 005e9ad6
    ...
    PUSH EAX                            ; 005e9ae9
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 005e9aea
        ;   XREF to: 0040b870 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeActor_FUN_0040b870(CDemonActor * actor_ptr, char * property_name)
    ADD ESP,0x8                         ; 005e9aef
    PUSH 0x6570b2                       ; 005e9af2 | = "endLoc"
    LEA EAX,[EBX + 0x3ac]               ; 005e9af7
    PUSH EAX                            ; 005e9afd
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 005e9afe
        ;   XREF to: 0040b870 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeActor_FUN_0040b870(CDemonActor * actor_ptr, char * property_name)
    ADD ESP,0x8                         ; 005e9b03
    PUSH 0x6570b9                       ; 005e9b06 | = "state"
    LEA EAX,[EBX + 0x3b8]               ; 005e9b0b
    PUSH EAX                            ; 005e9b11
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 005e9b12
    ...
    PUSH EAX                            ; 005e9b25
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 005e9b26
    ...
    PUSH EAX                            ; 005e9b4d
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 005e9b4e
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH EAX                            ; 005e9b6c
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 005e9b6d
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeString_FUN_0040b5c0(char * * string_buffer, char * property_type)
    ...
    PUSH EBX                            ; 005e9b82
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 005e9b83
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
