...
section .text
    ...
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 0057479f
        ;   XREF to: 005fe667 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
    ADD ESP,0xc                         ; 005747a4
    PUSH 0x6814c4                       ; 005747a7 | g_CZThumbPoolDestructorNode
    CALL crt_stdlib.c_atexit_FUN_005ff060 ; 005747ac
    ...
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 005747c3
        ;   XREF to: 005fe667 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
