...
section .text
    ...
    PUSH EDI                            ; 00575df2
    PUSH EBP                            ; 00575df3
    MOV EBP,0x3347108                   ; 00575df4 | g_CZThumbPool
    ...
    JNZ 0x00575e0f                      ; 00575e1d
        ;   XREF to: 00575e0f (CONDITIONAL_JUMP)  ; LAB_00575e0f
    INC EDI                             ; 00575e1f
    ADD EBP,0xf0                        ; 00575e20
    CMP EDI,0xfa                        ; 00575e26
    JL 0x00575e01                       ; 00575e2c
        ;   XREF to: 00575e01 (CONDITIONAL_JUMP)  ; LAB_00575e01
    POP EBP                             ; 00575e2e
    POP EDI                             ; 00575e2f
    POP ESI                             ; 00575e30
    POP EBX                             ; 00575e31
