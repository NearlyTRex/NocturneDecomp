...
section .text
    ...
    PUSH 0x6629f0                       ; 00576910 | WatcomTypeInfo g_CZThumbTypeInfo
        ;   Label: core_setdir.cpp_freeCZThumbs_FUN_00576910
    PUSH 0x5dc                          ; 00576915
    MOV EDX,dword ptr [ESP + 0xc]       ; 0057691a
    PUSH EDX                            ; 0057691e
    CALL crt_memory.c_freeTypeArray_FUN_005feee9 ; 0057691f | int crt_memory.c_freeTypeArray_FUN_005feee9(void * * obj_array, int obj_count, WatcomTypeInfo * type_info)
