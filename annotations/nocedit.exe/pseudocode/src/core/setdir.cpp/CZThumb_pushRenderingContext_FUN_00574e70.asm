...
section .text
    ...
    PUSH 0x0                            ; 00574ea0
    PUSH 0x0                            ; 00574ea2
    MOV EDX,dword ptr [0x006703ec]      ; 00574ea4 | g_CDemonRendererInstance | g_CDemonRendererPtr
    ...
    PUSH EAX                            ; 00574eb6
    MOV ECX,dword ptr [0x006703ec]      ; 00574eb7 | g_CDemonRendererInstance | g_CDemonRendererPtr
    ...
    MOV ESI,dword ptr [0x006703ec]      ; 00574ec6 | g_CDemonRendererPtr
    ...
    PUSH EBX                            ; 00574edb
    MOV EDI,dword ptr [0x006703ec]      ; 00574edc | g_CDemonRendererPtr
