...
;   core_setedit.cpp_CDemonSet_showVdirBoxEditor_FUN_00583170 at 00583258
;
; Called Functions:
;   core_setdir.cpp_CDemonSet_findVdirBoxRoot_FUN_00576820
;   core_setdir.cpp_testOBBIntersection_FUN_005763a0
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 00576710
        ;   Label: core_setdir.cpp_CDemonSet_buildVdirBoxGroups_FUN_00576710
    PUSH ESI                            ; 00576711
    PUSH EDI                            ; 00576712
    PUSH EBP                            ; 00576713
    ...
    PUSH EBX                            ; 00576771
    PUSH EDI                            ; 00576772
    CALL core_setdir.cpp_CDemonSet_findVdirBoxRoot_FUN_00576820 ; 00576773
    ...
    PUSH EBP                            ; 005767c2
        ;   Label: LAB_005767c2
    PUSH ESI                            ; 005767c3
    CALL core_setdir.cpp_testOBBIntersection_FUN_005763a0 ; 005767c4
        ;   XREF to: 005763a0 (UNCONDITIONAL_CALL)  ; int core_setdir.cpp_testOBBIntersection_FUN_005763a0(SVDBox * obb_a, SVDBox * obb_b)
    ...
    PUSH EBX                            ; 005767de
        ;   Label: LAB_005767de
    PUSH EDI                            ; 005767df
    CALL core_setdir.cpp_CDemonSet_findVdirBoxRoot_FUN_00576820 ; 005767e0
        ;   XREF to: 00576820 (UNCONDITIONAL_CALL)  ; int core_setdir.cpp_CDemonSet_findVdirBoxRoot_FUN_00576820(CDemonSet * this_ptr, int box_index)
    ...
    PUSH EBP                            ; 005767ff
    CALL core_setdir.cpp_testOBBIntersection_FUN_005763a0 ; 00576800
        ;   XREF to: 005763a0 (UNCONDITIONAL_CALL)  ; int core_setdir.cpp_testOBBIntersection_FUN_005763a0(SVDBox * obb_a, SVDBox * obb_b)
