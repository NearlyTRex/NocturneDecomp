...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_setdir.cpp_CDemonSet_FUN_00576340(CDemonSet * this_ptr)
;
; Parameters:
...
section .text
    ...
    CALL core_setdir.cpp_CDemonSet_FUN_00576820 ; 00576354 | int core_setdir.cpp_CDemonSet_FUN_00576820(CDemonSet * this_ptr)
    ...
    JLE 0x0057637f                      ; 00576366 | LAB_0057637f
        ;   XREF to: 0057637f (CONDITIONAL_JUMP)
    PUSH EBX                            ; 00576368
        ;   Label: LAB_00576368
    PUSH ESI                            ; 00576369
    CALL core_setdir.cpp_CDemonSet_FUN_00576820 ; 0057636a | int core_setdir.cpp_CDemonSet_FUN_00576820(CDemonSet * this_ptr)
        ;   XREF to: 00576820 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0057636f
    CMP EAX,EDI                         ; 00576372
    JZ 0x00576386                       ; 00576374 | LAB_00576386
        ;   XREF to: 00576386 (CONDITIONAL_JUMP)
    INC EBX                             ; 00576376
        ;   Label: LAB_00576376
    CMP EBX,dword ptr [ESI + 0x15b410]  ; 00576377
    JL 0x00576368                       ; 0057637d | LAB_00576368
    ...
    PUSH EBX                            ; 00576387
    PUSH ESI                            ; 00576388
    CALL core_setdir.cpp_CDemonSet_FUN_005762a0 ; 00576389 | int core_setdir.cpp_CDemonSet_FUN_005762a0(CDemonSet * this_ptr)
        ;   XREF to: 005762a0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0057638e
    TEST EAX,EAX                        ; 00576391
    JZ 0x00576376                       ; 00576393 | LAB_00576376
