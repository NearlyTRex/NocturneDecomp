...
; CVector3f *      Stack[0xc]:4   point
;
; XREF[1]:
;   core_setedit.cpp_CDemonSet_showVdirBoxEditor_FUN_00583170 at 005836c6
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 00576340
        ;   Label: core_setdir.cpp_CDemonSet_isPointInVdirGroup_FUN_00576340
    PUSH ESI                            ; 00576341
    PUSH EDI                            ; 00576342
    PUSH EBP                            ; 00576343
    ...
    CALL core_setdir.cpp_CDemonSet_findVdirBoxRoot_FUN_00576820 ; 00576354
    ...
    PUSH EBX                            ; 00576368
        ;   Label: LAB_00576368
    PUSH ESI                            ; 00576369
    CALL core_setdir.cpp_CDemonSet_findVdirBoxRoot_FUN_00576820 ; 0057636a
        ;   XREF to: 00576820 (UNCONDITIONAL_CALL)  ; int core_setdir.cpp_CDemonSet_findVdirBoxRoot_FUN_00576820(CDemonSet * this_ptr, int box_index)
    ...
    PUSH EBX                            ; 00576387
    PUSH ESI                            ; 00576388
    CALL core_setdir.cpp_CDemonSet_isPointInVdirBox_FUN_005762a0 ; 00576389
