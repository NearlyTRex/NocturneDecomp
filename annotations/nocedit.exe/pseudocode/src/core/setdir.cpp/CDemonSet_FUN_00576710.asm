...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_setdir.cpp_CDemonSet_FUN_00576710(CDemonSet * this_ptr)
;
; Parameters:
...
section .text
    ...
    JLE 0x00576750                      ; 00576725 | LAB_00576750
    ...
    JL 0x00576729                       ; 0057673f | LAB_00576729
    ...
    JLE 0x005767aa                      ; 0057675e | LAB_005767aa
    ...
    PUSH EBX                            ; 00576771
    PUSH EDI                            ; 00576772
    CALL core_setdir.cpp_CDemonSet_FUN_00576820 ; 00576773 | int core_setdir.cpp_CDemonSet_FUN_00576820(CDemonSet * this_ptr)
    ...
    JL 0x005767b2                       ; 00576788 | LAB_005767b2
    ...
    JL 0x0057676d                       ; 005767a8 | LAB_0057676d
    ...
    JMP 0x005767de                      ; 005767c0 | LAB_005767de
        ;   XREF to: 005767de (UNCONDITIONAL_JUMP)
    PUSH EBP                            ; 005767c2
        ;   Label: LAB_005767c2
    PUSH ESI                            ; 005767c3
    CALL core_setdir.cpp_FUN_005763a0   ; 005767c4 | undefined core_setdir.cpp_FUN_005763a0()
        ;   XREF to: 005763a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005767c9
    TEST EAX,EAX                        ; 005767cc
    JNZ 0x0057680c                      ; 005767ce | LAB_0057680c
    ...
    JGE 0x0057678e                      ; 005767dc | LAB_0057678e
        ;   XREF to: 0057678e (CONDITIONAL_JUMP)
    PUSH EBX                            ; 005767de
        ;   Label: LAB_005767de
    PUSH EDI                            ; 005767df
    CALL core_setdir.cpp_CDemonSet_FUN_00576820 ; 005767e0 | int core_setdir.cpp_CDemonSet_FUN_00576820(CDemonSet * this_ptr)
        ;   XREF to: 00576820 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005767e5
    MOV EDX,dword ptr [ESP + 0x14]      ; 005767e8
    MOV dword ptr [ESP + 0x10],EAX      ; 005767ec
    CMP EAX,EDX                         ; 005767f0
    JZ 0x005767d0                       ; 005767f2 | LAB_005767d0
    ...
    PUSH EBP                            ; 005767ff
    CALL core_setdir.cpp_FUN_005763a0   ; 00576800 | undefined core_setdir.cpp_FUN_005763a0()
        ;   XREF to: 005763a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00576805
    TEST EAX,EAX                        ; 00576808
    JZ 0x005767c2                       ; 0057680a | LAB_005767c2
    ...
    JMP 0x005767d0                      ; 0057681c | LAB_005767d0
