...

{
  ...
  if (&this_ptr->camera_position != camera_pos) {
    this_ptr->camera_position = *camera_pos;
  }
  if (&this_ptr->look_at_position != look_at_pos) {
    this_ptr->look_at_position = *look_at_pos;
  }
  ...
  if (0 < iVar1) {
    ...
    do {
      iVar3 = iVar4 + 4;
      g_ZBufferScanlineArrayBackup[iVar4 / 4] = g_ZBufferScanlineArray[iVar4 / 4];
      iVar4 = iVar3;
    } while (iVar3 < iVar1 * 4);
  }
  ...
  if (0 < iVar1) {
    ...
    do {
      iVar3 = iVar4 + 4;
      g_ZBufferScanlineArray[iVar4 / 4] = g_ZBufferScanlineArrayBackup[iVar4 / 4];
      iVar4 = iVar3;
    } while (iVar3 < iVar1 * 4);
  }
