...
section .text
    ...
    PUSH 0x646526                       ; 00575e47 | = "wb" | s_wb_00646526 = wb
    MOV EDX,dword ptr [ESP + 0x28]      ; 00575e4c
    PUSH EDX                            ; 00575e50
    PUSH 0x646529                       ; 00575e51 | = "data" | s_data_00646529 = data
    CALL engine_dosio.c_getFile_FUN_00481a50 ; 00575e56 | FILE * engine_dosio.c_getFile_FUN_00481a50(char * directory, char * filename, char * mode)
        ;   XREF to: 00481a50 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00575e5b
    MOV EBP,EAX                         ; 00575e5e
    TEST EAX,EAX                        ; 00575e60
    JZ 0x00575f05                       ; 00575e62 | LAB_00575f05
    ...
    JLE 0x00575ee4                      ; 00575e76 | LAB_00575ee4
        ;   XREF to: 00575ee4 (CONDITIONAL_JUMP)
    MOV EBX,0x3347108                   ; 00575e78 | CZThumb[1500] g_CZThumbPool
    MOV dword ptr [ESP + 0x4],EAX       ; 00575e7d
    MOV dword ptr [ESP],EBX             ; 00575e81 | CZThumb[1500] g_CZThumbPool
    MOV EAX,dword ptr [ESP + 0x4]       ; 00575e84
        ;   Label: LAB_00575e84
    MOV ESI,dword ptr [EAX + 0x144]     ; 00575e88
    MOV EDI,0x1                         ; 00575e8e
    TEST ESI,ESI                        ; 00575e93
    JZ 0x00575e9c                       ; 00575e95 | LAB_00575e9c
        ;   XREF to: 00575e9c (CONDITIONAL_JUMP)
    MOV EDI,0x6                         ; 00575e97
    XOR ESI,ESI                         ; 00575e9c
        ;   Label: LAB_00575e9c
    TEST EDI,EDI                        ; 00575e9e
    JLE 0x00575eb7                      ; 00575ea0 | LAB_00575eb7
        ;   XREF to: 00575eb7 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [ESP]             ; 00575ea2 | CZThumb[1500] g_CZThumbPool
    PUSH EBP                            ; 00575ea5
        ;   Label: LAB_00575ea5
    PUSH EBX                            ; 00575ea6 | CZThumb[1500] g_CZThumbPool
    INC ESI                             ; 00575ea7
    CALL core_setdir.cpp_CZThumb_write_FUN_00574b20 ; 00575ea8 | void core_setdir.cpp_CZThumb_write_FUN_00574b20(CZThumb * this_ptr, FILE * file_handle)
        ;   XREF to: 00574b20 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00575ead
    ADD EBX,0x28                        ; 00575eb0 | DAT_03347130
    CMP ESI,EDI                         ; 00575eb3
    JL 0x00575ea5                       ; 00575eb5 | LAB_00575ea5
    ...
    MOV dword ptr [ESP],EBX             ; 00575ece | DAT_033471f8
    ...
    JL 0x00575e84                       ; 00575ee2 | LAB_00575e84
        ;   XREF to: 00575e84 (CONDITIONAL_JUMP)
    TEST byte ptr [EBP + 0xc],0x20      ; 00575ee4
        ;   Label: LAB_00575ee4
    JNZ 0x00575f32                      ; 00575ee8 | LAB_00575f32
        ;   XREF to: 00575f32 (CONDITIONAL_JUMP)
    PUSH 0x3cb                          ; 00575eea
        ;   Label: LAB_00575eea
    PUSH 0x646575                       ; 00575eef | = "..\\core\\setdir.cpp" | s_core_setdir_cpp_00646575 = ..\core\setdir.cpp
    PUSH EBP                            ; 00575ef4
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 00575ef5 | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
    ...
    MOV ESI,dword ptr [ESP + 0x24]      ; 00575f05
        ;   Label: LAB_00575f05
    PUSH ESI                            ; 00575f09
    MOV ECX,0x64652e                    ; 00575f0a | = "..\\core\\setdir.cpp" | s_core_setdir_cpp_0064652e = ..\core\setdir.cpp
    MOV EBX,0x3bf                       ; 00575f0f
    PUSH 0x646541                       ; 00575f14 | = "Can't create %s" | s_Can_t_create_s_00646541 = Can't create %s
    MOV dword ptr [0x02f0ca48],ECX      ; 00575f19 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 00575f1f | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00575f25 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00575f2a
    JMP 0x00575e68                      ; 00575f2d | LAB_00575e68
        ;   XREF to: 00575e68 (UNCONDITIONAL_JUMP)
    MOV ECX,dword ptr [ESP + 0x24]      ; 00575f32
        ;   Label: LAB_00575f32
    PUSH ECX                            ; 00575f36
    MOV EAX,0x646551                    ; 00575f37 | = "..\\core\\setdir.cpp" | s_core_setdir_cpp_00646551 = ..\core\setdir.cpp
    MOV EDX,0x3ca                       ; 00575f3c
    PUSH 0x646564                       ; 00575f41 | = "Error writing %s" | s_Error_writing_s_00646564 = Error writing %s
    MOV [0x02f0ca48],EAX                ; 00575f46 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 00575f4b | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00575f51 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00575f56
    JMP 0x00575eea                      ; 00575f59 | LAB_00575eea
