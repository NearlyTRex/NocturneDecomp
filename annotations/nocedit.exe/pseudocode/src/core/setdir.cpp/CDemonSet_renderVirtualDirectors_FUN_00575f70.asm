...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_setdir_cpp_CDemonSet_renderVirtualDirectors_FUN_00575f70(CDemonSet *this_ptr)
;
; Parameters:
...
section .text
    ...
    JL 0x00575f8b                       ; 00575f99
        ;   XREF to: 00575f8b (CONDITIONAL_JUMP)  ; LAB_00575f8b
    ...
    JGE 0x0057600e                      ; 00575fab
        ;   XREF to: 0057600e (CONDITIONAL_JUMP)  ; LAB_0057600e
    LEA ECX,[EBP + 0x1]                 ; 00575fad
    CMP ECX,dword ptr [EDI]             ; 00575fb0
    JGE 0x00576000                      ; 00575fb2
    ...
    JL 0x00575fbf                       ; 00575ffe
        ;   XREF to: 00575fbf (CONDITIONAL_JUMP)  ; LAB_00575fbf
    MOV EDX,dword ptr [ESP + 0x70]      ; 00576000
        ;   Label: LAB_00576000
    ADD EDX,0x4                         ; 00576004
    INC EBP                             ; 00576007
    MOV dword ptr [ESP + 0x70],EDX      ; 00576008
    JMP 0x00575fa6                      ; 0057600c
        ;   XREF to: 00575fa6 (UNCONDITIONAL_JUMP)  ; LAB_00575fa6
    MOV EBX,0x2                         ; 0057600e
        ;   Label: LAB_0057600e
    MOV ECX,0x9                         ; 00576013
    MOV ESI,dword ptr [0x00679398]      ; 00576018 | g_WindowHeight
    MOV EBP,dword ptr [EDI]             ; 0057601e
    SUB ESI,0xb2                        ; 00576020
    CMP EBP,ECX                         ; 00576026
    JGE 0x0057602c                      ; 00576028
        ;   XREF to: 0057602c (CONDITIONAL_JUMP)  ; LAB_0057602c
    MOV ECX,EBP                         ; 0057602a
    TEST ECX,ECX                        ; 0057602c
        ;   Label: LAB_0057602c
    JLE 0x00576175                      ; 0057602e
        ;   XREF to: 00576175 (CONDITIONAL_JUMP)  ; LAB_00576175
    ...
    MOV EDX,0x3347108                   ; 00576078 | g_CZThumbPool
    ...
    JNZ 0x00576180                      ; 00576093
        ;   XREF to: 00576180 (CONDITIONAL_JUMP)  ; LAB_00576180
    PUSH ESI                            ; 00576099
    PUSH EBX                            ; 0057609a
    MOV ECX,dword ptr [ESP + 0x88]      ; 0057609b
    PUSH ECX                            ; 005760a2
    CALL core_setdir.cpp_CZThumb_render_FUN_00574f20 ; 005760a3
    ...
    MOV EAX,dword ptr [EBP + 0x3347108] ; 005760a8 | g_CZThumbPool
    ...
    FLD float ptr [EAX*0x4 + 0x3346d20] ; 005760c0 | g_VDCameraScores
    ...
    PUSH EAX                            ; 005760f9
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 005760fa
    ...
    PUSH EAX                            ; 0057611d
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 0057611e
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)  ; void engine_2d.c_drawText_FUN_00401fd0(char * text, int x, int y)
    MOV EBP,dword ptr [0x00679394]      ; 00576123 | g_WindowWidth
    LEA EAX,[EBX + 0x42]                ; 00576129
    ADD ESP,0xc                         ; 0057612c
    ADD EBX,0x2                         ; 0057612f
    CMP EAX,EBP                         ; 00576132
    JLE 0x0057615e                      ; 00576134
        ;   XREF to: 0057615e (CONDITIONAL_JUMP)  ; LAB_0057615e
    MOV EAX,dword ptr [ESP + 0x74]      ; 00576136
    MOV EDX,dword ptr [ESP + 0x78]      ; 0057613a
    MOV EBX,0x2                         ; 0057613e
    MOV EBP,dword ptr [0x00679398]      ; 00576143 | g_WindowHeight
    ...
    JL 0x00576059                       ; 0057616f
        ;   XREF to: 00576059 (CONDITIONAL_JUMP)  ; LAB_00576059
    ...
    PUSH EAX                            ; 005761a9
    CALL core_setdir.cpp_CZThumb_render_FUN_00574f20 ; 005761aa
        ;   XREF to: 00574f20 (UNCONDITIONAL_CALL)  ; void core_setdir.cpp_CZThumb_render_FUN_00574f20(CZThumb * this_ptr, int screen_x, int screen_y)
    MOV EAX,dword ptr [EBP + 0x3347108] ; 005761af | g_CZThumbPool
