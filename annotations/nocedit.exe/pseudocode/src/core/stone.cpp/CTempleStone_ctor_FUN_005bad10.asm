...
section .text
    ...
    PUSH EDX                            ; 005bad14
    CALL core_boxactor.cpp_CBoxActor_ctor_FUN_00421700 ; 005bad15 | CBoxActor * core_boxactor.cpp_CBoxActor_ctor_FUN_00421700(CBoxActor * this_ptr)
        ;   XREF to: 00421700 (UNCONDITIONAL_CALL)
    MOV dword ptr [EAX + 0x154],0x663604 ; 005bad1a | CDemonActor_vtable g_CTempleStoneVTable
