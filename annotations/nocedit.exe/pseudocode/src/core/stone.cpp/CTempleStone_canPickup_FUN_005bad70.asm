...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_stone_cpp_CTempleStone_canPickup_FUN_005bad70(CTempleStone *this_ptr,CDemonActor *picker)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005bad70
        ;   Label: core_stone.cpp_CTempleStone_canPickup_FUN_005bad70
    PUSH EBP                            ; 005bad71
