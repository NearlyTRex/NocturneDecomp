...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_stone.cpp_FUN_005bad70()
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH ECX                            ; 005bad83
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 005bad84 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005bad89
    TEST EAX,EAX                        ; 005bad8c
    JZ 0x005bad99                       ; 005bad8e | LAB_005bad99
        ;   XREF to: 005bad99 (CONDITIONAL_JUMP)
    CMP dword ptr [EAX + 0x184],0x0     ; 005bad90
    JNZ 0x005badab                      ; 005bad97 | LAB_005badab
        ;   XREF to: 005badab (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x314],0x3     ; 005bad99
        ;   Label: LAB_005bad99
    JNZ 0x005badb0                      ; 005bada0 | LAB_005badb0
    ...
    POP EBX                             ; 005badae
    RET                                 ; 005badaf
    PUSH 0x653164                       ; 005badb0 | = "CHero" | s_CHero_00653164 = CHero
        ;   Label: LAB_005badb0
    MOV EBP,dword ptr [ESP + 0x14]      ; 005badb5
    PUSH EBP                            ; 005badb9
    CALL core_actor.cpp_isOfClass_FUN_0040c6d0 ; 005badba | int core_actor.cpp_isOfClass_FUN_0040c6d0(CDemonActor * actor_ptr, char * class_name)
        ;   XREF to: 0040c6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005badbf
    TEST EAX,EAX                        ; 005badc2
    JNZ 0x005bada2                      ; 005badc4 | LAB_005bada2
