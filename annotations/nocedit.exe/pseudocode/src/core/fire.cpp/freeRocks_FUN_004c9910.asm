...
section .text
    ...
    PUSH 0x65deb0                       ; 004c9910 | WatcomTypeInfo g_CRockTypeInfo
        ;   Label: core_fire.cpp_freeRocks_FUN_004c9910
    PUSH 0x40                           ; 004c9915
    MOV EDX,dword ptr [ESP + 0xc]       ; 004c9917
    PUSH EDX                            ; 004c991b
    CALL crt_memory.c_freeTypeArray_FUN_005feee9 ; 004c991c | int crt_memory.c_freeTypeArray_FUN_005feee9(void * * obj_array, int obj_count, WatcomTypeInfo * type_info)
