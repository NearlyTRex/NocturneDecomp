...
section .text
    ...
    PUSH EDX                            ; 004c9714
    CALL core_particle.cpp_CParticle_ctor_FUN_00545650 ; 004c9715 | CParticle * core_particle.cpp_CParticle_ctor_FUN_00545650(CParticle * this_ptr)
        ;   XREF to: 00545650 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004c971a
    MOV dword ptr [EAX + 0x34],0x65dd94 ; 004c971d | CParticle_vtable g_CSparkVTable
    RET                                 ; 004c9724
