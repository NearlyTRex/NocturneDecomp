...
;                               FUNCTION
; *****************************************************************************
; __cdecl CShell * core_fire.cpp_CShell_dtor_FUN_004c9510(CShell * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 004c9516
    CALL core_particle.cpp_CParticle_dtor_FUN_00545670 ; 004c9517 | CParticle * core_particle.cpp_CParticle_dtor_FUN_00545670(CParticle * this_ptr)
