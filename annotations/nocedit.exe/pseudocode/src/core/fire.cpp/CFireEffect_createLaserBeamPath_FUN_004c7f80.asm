...
section .text
    ...
    PUSH EBX                            ; 004c7f80
        ;   Label: core_fire.cpp_CFireEffect_createLaserBeamPath_FUN_004c7f80
    PUSH ESI                            ; 004c7f81
    PUSH EDI                            ; 004c7f82
    PUSH EBP                            ; 004c7f83
    ...
    PUSH EAX                            ; 004c8125
    PUSH ESI                            ; 004c8126
    CALL core_fire.cpp_CFireEffect_createLaserSegment_FUN_004c7eb0 ; 004c8127
    ...
    PUSH EAX                            ; 004c81d9
    PUSH ESI                            ; 004c81da
    CALL core_fire.cpp_CFireEffect_createLaserSegment_FUN_004c7eb0 ; 004c81db
        ;   XREF to: 004c7eb0 (UNCONDITIONAL_CALL)  ; void core_fire.cpp_CFireEffect_createLaserSegment_FUN_004c7eb0(CFireEffect * this_ptr, CVector3f * origin, CVector3f * hit_position, float beam_width, ...)
