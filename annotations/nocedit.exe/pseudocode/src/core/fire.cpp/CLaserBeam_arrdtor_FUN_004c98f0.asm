...
;                               FUNCTION
; *****************************************************************************
; __cdecl CLaserBeam * __cdecl core_fire_cpp_CLaserBeam_arrdtor_FUN_004c98f0(CLaserBeam *objs,uint flags)
;
; Parameters:
...
section .text
    ...
    PUSH 0x65ded0                       ; 004c98f0 | g_CLaserBeamTypeInfo
        ;   Label: core_fire.cpp_CLaserBeam_arrdtor_FUN_004c98f0
    PUSH 0x40                           ; 004c98f5
