...
;
; Called Functions:
;   core_fire.cpp_CCrater_activate_FUN_004c4200
;
; *****************************************************************************
...
section .text
    ...
    PUSH dword ptr [ESP + 0xc]          ; 004c8ea0
        ;   Label: core_fire.cpp_CFireEffect_createCrater_FUN_004c8ea0
    MOV EAX,[0x02d6c6a0]                ; 004c8ea4 | g_CraterAllocIndex
    ...
    PUSH EAX                            ; 004c8ebd
    CALL core_fire.cpp_CCrater_activate_FUN_004c4200 ; 004c8ebe
        ;   XREF to: 004c4200 (UNCONDITIONAL_CALL)  ; void core_fire.cpp_CCrater_activate_FUN_004c4200(CCrater * this_ptr, CVector3f * center_position, float radius)
    MOV ECX,dword ptr [0x02d6c6a0]      ; 004c8ec3 | g_CraterAllocIndex
    INC ECX                             ; 004c8ec9
    ADD ESP,0xc                         ; 004c8eca
    MOV dword ptr [0x02d6c6a0],ECX      ; 004c8ecd | g_CraterAllocIndex
    ...
    MOV dword ptr [0x02d6c6a0],ESI      ; 004c8edc | g_CraterAllocIndex
    POP ESI                             ; 004c8ee2
    RET                                 ; 004c8ee3
