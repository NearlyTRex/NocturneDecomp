...
section .text
    ...
    PUSH ESI                            ; 004c3871
    MOV ECX,dword ptr [0x02cf6a80]      ; 004c3872 | int g_GlobalDeltaTimeInt
    MOV EBX,dword ptr [0x02d13564]      ; 004c3878 | undefined4 DAT_02d13564
    MOV ESI,dword ptr [0x02d13560]      ; 004c387e | undefined4 DAT_02d13560
    ...
    MOV dword ptr [0x02d13564],EBX      ; 004c38af | undefined4 DAT_02d13564
    MOV dword ptr [0x02d13560],ESI      ; 004c38b5 | undefined4 DAT_02d13560
    POP ESI                             ; 004c38bb
    POP EBX                             ; 004c38bc
    RET                                 ; 004c38bd
