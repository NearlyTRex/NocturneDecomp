...

{
  ...
  do {
    ...
    pCVar1 = pCVar2;
  } while (pCVar2 != (CSpark *)&g_MuzzleFlashAllocIndex);
  pCVar3 = g_MuzzleFlashPool;
  do {
    pCVar3->frames_remaining = 0;
    pCVar3 = pCVar3 + 1;
  } while (pCVar3 != (CMuzzleFlash *)&g_GlassParticleAllocIndex);
  ...
  do {
    ...
    pCVar4 = pCVar5;
  } while (pCVar5 != (CGlassParticle *)&g_BulletTrailAllocIndex);
  pCVar6 = g_BulletTrailPool;
  do {
    pCVar7 = pCVar6 + 1;
    pCVar6->frames_remaining = 0;
    pCVar6 = pCVar7;
  } while (pCVar7 != (CBulletTrail *)&g_FireballAllocIndex);
  ...
  do {
    ...
    pCVar8 = pCVar9;
  } while (pCVar9 != (CFireball *)&g_RockAllocIndex);
  g_RockAllocIndex = 0;
  pCVar10 = g_RockPool;
  do {
    pCVar11 = pCVar10 + 1;
  ...
  } while (this_ptr_03 != (CCrater *)&g_GunFlameAllocIndex);
  ...
  } while (this_ptr_04 != (CGunFlame *)&g_LightningBoltAllocIndex);
  ...
  do {
    ...
    pCVar12 = pCVar13;
  } while (pCVar13 != (CShell *)&g_PopcornAllocIndex);
  ...
  do {
    ...
    pCVar14 = pCVar15;
  } while (pCVar15 != (CPopcorn *)&g_RainDropAllocIndex);
