...
section .text
    ...
    PUSH EBX                            ; 004c8dd0
        ;   Label: core_fire.cpp_CFireEffect_createToss_FUN_004c8dd0
    PUSH ESI                            ; 004c8dd1
    PUSH EDI                            ; 004c8dd2
    PUSH EBP                            ; 004c8dd3
    ...
    PUSH EDI                            ; 004c8e04
    CALL core_fire.cpp_CFireEffect_allocateToss_FUN_004c8e40 ; 004c8e05
        ;   XREF to: 004c8e40 (UNCONDITIONAL_CALL)  ; int core_fire.cpp_CFireEffect_allocateToss_FUN_004c8e40(CFireEffect * this_ptr, int toss_type, CVector3f * position, UOrientationVector * orientation, ...)
