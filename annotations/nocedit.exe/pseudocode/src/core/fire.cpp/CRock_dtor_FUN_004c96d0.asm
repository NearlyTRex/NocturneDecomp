...
;                               FUNCTION
; *****************************************************************************
; __cdecl CRock * core_fire.cpp_CRock_dtor_FUN_004c96d0(CRock * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 004c96d6
    CALL core_particle.cpp_CParticle_dtor_FUN_00545670 ; 004c96d7 | CParticle * core_particle.cpp_CParticle_dtor_FUN_00545670(CParticle * this_ptr)
