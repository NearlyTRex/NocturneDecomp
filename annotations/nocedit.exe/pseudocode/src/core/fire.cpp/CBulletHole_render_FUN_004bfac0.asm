...
section .text
    ...
    ADD EBX,0x780000                    ; 004bfb1a | g_RenderBufferPool[194].texture_data.texture_name[4]
    LEA EDX,[EAX + 0x780000]            ; 004bfb20 | g_RenderBufferPool[194].texture_data.texture_name[4]
