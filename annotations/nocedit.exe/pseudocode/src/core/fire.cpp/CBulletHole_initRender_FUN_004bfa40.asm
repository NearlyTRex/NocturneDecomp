...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_fire.cpp_CBulletHole_initRender_FUN_004bfa40(CBulletHole * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH 0x67a794                       ; 004bfa57 | SMRGLTextureBasic g_FireEffectBlackHoleTexture
    ...
    MOV EBX,dword ptr [0x006703ec]      ; 004bfa88 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    MOV EDX,0xffff                      ; 004bfa8e
    PUSH EBX                            ; 004bfa93 | CDemonRenderer g_CDemonRendererInstance
    ...
    CALL engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80 ; 004bfaa0 | void engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80(CDemonRenderer * this_ptr, SMRGLTextureBasic * texture)
        ;   XREF to: 0048db80 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004bfaa5
    PUSH 0x8000                         ; 004bfaa8
    MOV ESI,dword ptr [0x006703ec]      ; 004bfaad | CDemonRenderer * g_CDemonRendererPtr
    PUSH ESI                            ; 004bfab3 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_setRenderAlpha_FUN_0048ca60 ; 004bfab4 | void engine_drender.cpp_CDemonRenderer_setRenderAlpha_FUN_0048ca60(CDemonRenderer * this_ptr, int render_alpha)
