// Name: core_fire.cpp_CStake_FUN_004bfe90
// Address: 004bfe90
// Address Range: [[004bfe90, 004c00b4] [004c0111, 004c0136]]
// Convention: __cdecl
// Signature: void core_fire.cpp_CStake_FUN_004bfe90(CStake * this_ptr)
// Cross-references:
//   core_fire.cpp_CFireEffect_FUN_004c7bb0 (004c7bb0) at 004c7c56 [UNCONDITIONAL_CALL]
// Globals:
...
void __cdecl core_fire_cpp_CStake_FUN_004bfe90(CStake *this_ptr)

{
  ...
  core_dirmat_cpp_CMatrix3x3f_buildRotationMatrix_FUN_00471d30
            ((CMatrix3x3f *)&stack0xffffff4c,in_stack_0000000c);
  local_34.x = 0.0;
  local_34.y = 0.0;
  local_34.z = 10.0;
  core_dirmat_cpp_CMatrix3x3f_transformVector_FUN_00471fd0
            ((CMatrix3x3f *)&stack0xffffff50,&local_40,&local_34);
  local_58 = (in_stack_00000010[2] * local_34.x +
             *in_stack_00000010 * local_40.y + in_stack_00000010[1] * local_40.z) * FLOAT_00629c5f;
  local_68.z = *in_stack_00000010 * local_58;
  local_5c = in_stack_00000010[1] * local_58;
  local_58 = in_stack_00000010[2] * local_58;
  local_20.z = local_68.z - local_40.y;
  local_14 = local_5c - local_40.z;
  local_10 = local_58 - local_34.x;
  if (&local_40.y != &local_20.z) {
    local_40.y = local_20.z;
    local_40.z = local_14;
    local_34.x = local_10;
  }
  local_48 = -local_40.y;
  ...
  if (&local_40.y != &local_48) {
    local_40.y = local_48;
    local_40.z = local_44;
    local_34.x = local_40.x;
  }
  in_stack_0000000c->x = 0.0;
  pCVar1 = core_dmodel_cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80(&DAT_02d12df4);
  ...
  core_box_cpp_CBox_setupCorners_FUN_0041dd20
            ((CBox *)(in_stack_00000010 + 1),in_stack_00000014,in_stack_00000018,&local_68,2.0);
  local_48 = core_actor_cpp_getRandomFloat_FUN_0040cc10(-9.424778,9.424778);
  local_40.x = 0.0;
  fStack00000008 = core_actor_cpp_getRandomFloat_FUN_0040cc10(-9.424778,9.424778);
  local_40.x = fStack00000008;
  core_box_cpp_CBox_FUN_00420180((CBox *)(in_stack_00000010 + 1));
  return;
}
...
// Assembly code:
// 004bfe90: PUSH EBX
//   Label: core_fire.cpp_CStake_FUN_004bfe90
// 004bfe91: PUSH EDI
// 004bfe92: PUSH EBP
