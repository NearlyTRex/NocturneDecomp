...
section .text
    ...
    PUSH EDX                            ; 004c91e7
    MOV EDX,dword ptr [0x02d72588]      ; 004c91e8 | CTrail * g_TrailActiveListHead
    ...
    PUSH EAX                            ; 004c9213
    CALL core_fire.cpp_FUN_004c6170     ; 004c9214 | undefined core_fire.cpp_FUN_004c6170()
        ;   XREF to: 004c6170 (UNCONDITIONAL_CALL)
    MOV EDI,dword ptr [0x02d72588]      ; 004c9219 | CTrail * g_TrailActiveListHead
    INC EDI                             ; 004c921f
    ADD ESP,0x14                        ; 004c9220
    MOV dword ptr [0x02d72588],EDI      ; 004c9223 | CTrail * g_TrailActiveListHead
    CMP EDI,0x32                        ; 004c9229
    JGE 0x004c9232                      ; 004c922c | LAB_004c9232
    ...
    XOR EAX,EAX                         ; 004c9232
        ;   Label: LAB_004c9232
    MOV [0x02d72588],EAX                ; 004c9234 | CTrail * g_TrailActiveListHead
    POP EDI                             ; 004c9239
    POP ESI                             ; 004c923a
    POP EBX                             ; 004c923b
    RET                                 ; 004c923c
