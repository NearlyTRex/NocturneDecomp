...
section .text
    ...
    PUSH ESI                            ; 004c9291
    MOV EBX,dword ptr [0x02d76ec0]      ; 004c9292 | CPopcorn * g_CFireEffectPopcornsEnd
