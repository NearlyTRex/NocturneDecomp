...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_fire.cpp_FUN_004c24d0()
;
; Local Variables:
...
section .text
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 004c24ec | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    FLD float ptr [EAX]                 ; 004c24f2
    FMUL float ptr [0x0065dca8]         ; 004c24f4 | float FLOAT_0065dca8
    FISTP dword ptr [EBX]               ; 004c24fa
    FLD float ptr [EAX + 0x4]           ; 004c24fc
    FMUL float ptr [0x0065dca8]         ; 004c24ff | float FLOAT_0065dca8
    FISTP dword ptr [EBX + 0x4]         ; 004c2505
    FLD float ptr [EAX + 0x8]           ; 004c2508
    FMUL float ptr [0x0065dca8]         ; 004c250b | float FLOAT_0065dca8
    FISTP dword ptr [EBX + 0x8]         ; 004c2511
    MOV EAX,ESP                         ; 004c2514
    PUSH EAX                            ; 004c2516
    MOV EAX,dword ptr [EDX]             ; 004c2517 | CDemonRenderer g_CDemonRendererInstance
    PUSH EAX                            ; 004c2519
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 004c251a | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    MOV EAX,[0x006703ec]                ; 004c251f | CDemonRenderer * g_CDemonRendererPtr
    MOV EAX,dword ptr [EAX]             ; 004c2524 | CDemonRenderer g_CDemonRendererInstance
    FILD dword ptr [EAX + 0x8]          ; 004c2526
    FMUL double ptr [0x00629d03]        ; 004c2529 | double DOUBLE_00629d03
    FLD double ptr [0x00629d0b]         ; 004c252f | double DOUBLE_00629d0b
    FILD dword ptr [0x006793c0]         ; 004c2535 | int g_ProjectionScale
    FMUL ST1                            ; 004c253b
    FDIVP ST2,ST0                       ; 004c253d
    FILD dword ptr [0x02d02548]         ; 004c253f | int g_ViewportCenterXFixed
    FMUL ST1                            ; 004c2545
    ADD ESP,0x8                         ; 004c2547
    FXCH ST2                            ; 004c254a
    FMUL float ptr [0x00629d13]         ; 004c254c | float FLOAT_00629d13
    FXCH ST2                            ; 004c2552
    FDIVR ST0,ST2                       ; 004c2554
    MOV EAX,dword ptr [ESP + 0x3c]      ; 004c2556
    MOV dword ptr [ESP + 0x2c],EAX      ; 004c255a
    FABS                                ; 004c255e
    FILD dword ptr [0x02d0254c]         ; 004c2560 | int g_ViewportCenterYFixed
    FMULP ST2                           ; 004c2566
    FXCH                                ; 004c2568
    ...
    FNSTSW AX                           ; 004c2582
    SAHF                                ; 004c2584
    JC 0x004c259d                       ; 004c2585 | LAB_004c259d
    ...
    FNSTSW AX                           ; 004c258f
    SAHF                                ; 004c2591
    JC 0x004c25a7                       ; 004c2592 | LAB_004c25a7
    ...
    JMP 0x004c2587                      ; 004c25a5 | LAB_004c2587
