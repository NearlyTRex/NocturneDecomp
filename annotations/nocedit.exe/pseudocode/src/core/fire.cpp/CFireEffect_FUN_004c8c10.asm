...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_fire_cpp_CFireEffect_FUN_004c8c10(CFireEffect *this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EAX,[0x02d677b0]                ; 004c8c17 | g_LaserBeamActiveListHead
    ...
    MOV EDX,dword ptr [0x02d677b0]      ; 004c8c3a | g_LaserBeamActiveListHead
    INC EDX                             ; 004c8c40
    ADD ESP,0x10                        ; 004c8c41
    MOV dword ptr [0x02d677b0],EDX      ; 004c8c44 | g_LaserBeamActiveListHead
    CMP EDX,0xa                         ; 004c8c4a
    JL 0x004c8c59                       ; 004c8c4d
        ;   XREF to: 004c8c59 (CONDITIONAL_JUMP)  ; LAB_004c8c59
    PUSH ESI                            ; 004c8c4f
    XOR ESI,ESI                         ; 004c8c50
    MOV dword ptr [0x02d677b0],ESI      ; 004c8c52 | g_LaserBeamActiveListHead
    POP ESI                             ; 004c8c58
    PUSH EBX                            ; 004c8c59
        ;   Label: LAB_004c8c59
