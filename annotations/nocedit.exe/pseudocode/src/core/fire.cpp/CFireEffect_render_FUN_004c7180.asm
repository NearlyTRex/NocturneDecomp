...
;   core_set.cpp_CDemonSet_renderGogglesView_FUN_0056c990 at 0056cb86
...
section .text
    ...
    CMP dword ptr [EBX + 0x2d2ddfc],0x0 ; 004c7197 | g_StakePool | g_StakePool[1].active
        ;   Label: LAB_004c7197
    ...
    MOV EBX,0x2d655ac                   ; 004c71b5 | g_RockPool
        ;   Label: LAB_004c71b5
    LEA ESI,[EBX + 0x1200]              ; 004c71ba | g_LaserBeamActiveCount
    FLD float ptr [EBX + 0x18]          ; 004c71c0 | g_RockPool[0].base.lifetime_remaining | g_RockPool[1].base.lifetime_remaining
        ;   Label: LAB_004c71c0
    FLDZ                                ; 004c71c3
    FCOMPP                              ; 004c71c5
    FNSTSW AX                           ; 004c71c7
    ...
    PUSH EBX                            ; 004c71cc | g_RockPool | g_RockPool[1].base.position.x
    MOV EAX,dword ptr [EBX + 0x34]      ; 004c71cd | g_RockPool[0].base.vtable | g_RockPool[1].base.vtable
    ...
    PUSH EBX                            ; 004c7201 | g_FireballPool | g_FireballPool[1].base.position.x
    MOV EAX,dword ptr [EBX + 0x34]      ; 004c7202 | g_FireballPool[0].base.vtable | g_FireballPool[1].base.vtable
    ...
    LEA ESI,[EBX + 0x1130]              ; 004c721a | g_PopcornAllocIndex
    PUSH EBX                            ; 004c7220 | g_ShellPool | g_ShellPool[1].base.position.x
        ;   Label: LAB_004c7220
    MOV EAX,dword ptr [EBX + 0x34]      ; 004c7221 | g_ShellPool[0].base.vtable | g_ShellPool[1].base.vtable
    CALL dword ptr [EAX + 0x8]          ; 004c7224
    ADD EBX,0x58                        ; 004c7227 | g_ShellPool[1].base.position.x
    ...
    CALL engine_drender.cpp_CDemonRenderer_isShadowPass_FUN_0048cae0 ; 004c7237
    ...
    CMP dword ptr [EBX + 0x2d2a204],0x0 ; 004c7276 | g_BulletHolePool[0].actor_ptr | g_BulletHolePool[1].actor_ptr
        ;   Label: LAB_004c7276
    JZ 0x004c728f                       ; 004c727d
        ;   XREF to: 004c728f (CONDITIONAL_JUMP)  ; LAB_004c728f
    MOV EAX,0x2d2a1f4                   ; 004c727f | g_BulletHolePool
    ADD EAX,EBX                         ; 004c7284 | g_BulletHolePool | g_BulletHolePool[1].position.x
    PUSH EAX                            ; 004c7286 | g_BulletHolePool | g_BulletHolePool[1].position.x
    ...
    PUSH EBX                            ; 004c72bb | g_SmokeParticlePool | g_SmokeParticlePool[1].active
    ...
    ADD EBX,0x2c                        ; 004c72c4 | g_SmokeParticlePool[1].active
        ;   Label: LAB_004c72c4
    ...
    LEA ESI,[EBX + 0x730]               ; 004c72d0 | g_GlassParticleAllocIndex
    MOV EAX,dword ptr [EBX]             ; 004c72d6 | g_MuzzleFlashPool | g_MuzzleFlashPool[1].frames_remaining
        ;   Label: LAB_004c72d6
    TEST EAX,EAX                        ; 004c72d8
    JZ 0x004c72e5                       ; 004c72da
        ;   XREF to: 004c72e5 (CONDITIONAL_JUMP)  ; LAB_004c72e5
    PUSH EBX                            ; 004c72dc | g_MuzzleFlashPool | g_MuzzleFlashPool[1].frames_remaining
    ...
    ADD EBX,0x5c                        ; 004c72e5 | g_MuzzleFlashPool[1].frames_remaining
        ;   Label: LAB_004c72e5
    CMP EBX,ESI                         ; 004c72e8
    JNZ 0x004c72d6                      ; 004c72ea
        ;   XREF to: 004c72d6 (CONDITIONAL_JUMP)  ; LAB_004c72d6
    MOV EDX,dword ptr [0x02d667ac]      ; 004c72ec | g_LaserBeamActiveCount
    ...
    PUSH ESI                            ; 004c72fd | g_LaserBeamPool | g_LaserBeamPool[1].origin.x
        ;   Label: LAB_004c72fd
    ...
    INC EBX                             ; 004c7303
    MOV ECX,dword ptr [0x02d667ac]      ; 004c7304 | g_LaserBeamActiveCount
    ...
    PUSH EBX                            ; 004c7344 | g_SparkPool | g_SparkPool[1].base.position.x
    MOV EAX,dword ptr [EBX + 0x34]      ; 004c7345 | g_SparkPool[0].base.vtable | g_SparkPool[1].base.vtable
    ...
    LEA ESI,[EBX + 0x9c00]              ; 004c735a | g_BulletTrailAllocIndex
    FLD float ptr [EBX + 0x18]          ; 004c7360 | g_GlassParticlePool[0].base.lifetime_remaining | g_GlassParticlePool[1].base.lifetime_remaining
        ;   Label: LAB_004c7360
    FLDZ                                ; 004c7363
    FCOMPP                              ; 004c7365
    FNSTSW AX                           ; 004c7367
    ...
    PUSH EBX                            ; 004c736c | g_GlassParticlePool | g_GlassParticlePool[1].base.position.x
    MOV EAX,dword ptr [EBX + 0x34]      ; 004c736d | g_GlassParticlePool[0].base.vtable | g_GlassParticlePool[1].base.vtable
    ...
    LEA ESI,[EBX + 0x168]               ; 004c7385 | g_FireballAllocIndex
    MOV EAX,dword ptr [EBX + 0x20]      ; 004c738b | g_BulletTrailPool[0].frames_remaining | g_BulletTrailPool[1].frames_remaining
        ;   Label: LAB_004c738b
    TEST EAX,EAX                        ; 004c738e
    JZ 0x004c739b                       ; 004c7390
        ;   XREF to: 004c739b (CONDITIONAL_JUMP)  ; LAB_004c739b
    PUSH EBX                            ; 004c7392 | g_BulletTrailPool | g_BulletTrailPool[1].start_position.x
    ...
    ADD EBX,0x24                        ; 004c739b | g_BulletTrailPool[1].start_position.x
        ;   Label: LAB_004c739b
    ...
    LEA ESI,[EBX + 0x118]               ; 004c73a7 | g_TossAllocIndex
    PUSH EBX                            ; 004c73ad | g_ExplosionPool | g_ExplosionPool[1].position.x
        ;   Label: LAB_004c73ad
    ...
    ADD EBX,0x1c                        ; 004c73b3 | g_ExplosionPool[1].position.x
    ...
    LEA ESI,[EBX + 0x4dd0]              ; 004c73c2 | g_CraterAllocIndex
    PUSH EBX                            ; 004c73c8 | g_TossPool | g_TossPool[1].toss_type
        ;   Label: LAB_004c73c8
    ...
    ADD EBX,0x3e4                       ; 004c73ce | g_TossPool[1].toss_type
    ...
    LEA ESI,[EBX + 0x4650]              ; 004c73e0 | g_LightningBoltAllocIndex
    PUSH EBX                            ; 004c73e6 | g_GunFlamePool | g_GunFlamePool[1].lifetime
        ;   Label: LAB_004c73e6
    ...
    ADD EBX,0x24                        ; 004c73ec | g_GunFlamePool[1].lifetime
    ...
    LEA ESI,[EBX + 0x1b8]               ; 004c73fb | g_TrailAllocIndex
    PUSH EBX                            ; 004c7401 | g_LightningBoltPool | g_LightningBoltPool[1].mode
        ;   Label: LAB_004c7401
    ...
    ADD EBX,0x2c                        ; 004c7407 | g_LightningBoltPool[1].mode
    ...
    LEA ESI,[EBX + 0xe10]               ; 004c7416 | g_ShellAllocIndex
    PUSH EBX                            ; 004c741c | g_TrailPool | g_TrailPool[1].position.x
        ;   Label: LAB_004c741c
    ...
    ADD EBX,0x24                        ; 004c7422 | g_TrailPool[1].position.x
    ...
    LEA ESI,[EBX + 0x3800]              ; 004c7431 | g_RainDropAllocIndex
    FLD float ptr [EBX + 0x18]          ; 004c7437 | g_PopcornPool[0].base.lifetime_remaining | g_PopcornPool[1].base.lifetime_remaining
        ;   Label: LAB_004c7437
    FLDZ                                ; 004c743a
    FCOMPP                              ; 004c743c
    FNSTSW AX                           ; 004c743e
    ...
    PUSH EBX                            ; 004c7443 | g_PopcornPool | g_PopcornPool[1].base.position.x
    MOV EAX,dword ptr [EBX + 0x34]      ; 004c7444 | g_PopcornPool[0].base.vtable | g_PopcornPool[1].base.vtable
    ...
    FLD float ptr [EBX + 0x18]          ; 004c745f | g_RainDropPool[0].base.lifetime_remaining | g_RainDropPool[1].base.lifetime_remaining
        ;   Label: LAB_004c745f
    FLDZ                                ; 004c7462
    FCOMPP                              ; 004c7464
    FNSTSW AX                           ; 004c7466
    ...
    PUSH EBX                            ; 004c746b | g_RainDropPool | g_RainDropPool[1].base.position.x
    MOV EAX,dword ptr [EBX + 0x34]      ; 004c746c | g_RainDropPool[0].base.vtable | g_RainDropPool[1].base.vtable
    ...
    MOV EAX,0x2d2ddfc                   ; 004c7483 | g_StakePool
        ;   Label: LAB_004c7483
    ADD EAX,EBX                         ; 004c7488 | g_StakePool[1].active
    PUSH EAX                            ; 004c748a | g_StakePool[1].active
