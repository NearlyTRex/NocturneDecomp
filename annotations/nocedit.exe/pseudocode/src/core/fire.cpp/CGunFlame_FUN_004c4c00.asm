...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_fire.cpp_CGunFlame_FUN_004c4c00(CGunFlame * this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [0x02d13eb4]      ; 004c4c0c | undefined4 DAT_02d13eb4
    XOR EDI,EDI                         ; 004c4c12
    TEST EDX,EDX                        ; 004c4c14
    JLE 0x004c4c5e                      ; 004c4c16 | LAB_004c4c5e
    ...
    MOV EBX,dword ptr [EBX + 0x2d13eb8] ; 004c4c2c | undefined4 DAT_02d13eb8
    CMP EDX,0x2                         ; 004c4c32
    JZ 0x004c4cc3                       ; 004c4c35 | LAB_004c4cc3
        ;   XREF to: 004c4cc3 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x2624],0x0    ; 004c4c3b
    JNZ 0x004c4cc3                      ; 004c4c42 | LAB_004c4cc3
        ;   XREF to: 004c4cc3 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [ESP + 0x20]      ; 004c4c48
        ;   Label: LAB_004c4c48
    MOV EBX,dword ptr [0x02d13eb4]      ; 004c4c4c | undefined4 DAT_02d13eb4
        ;   Label: LAB_004c4c4c
    ADD ECX,0x4                         ; 004c4c52
    INC EDI                             ; 004c4c55
    MOV dword ptr [ESP + 0x20],ECX      ; 004c4c56
    CMP EDI,EBX                         ; 004c4c5a
    JL 0x004c4c22                       ; 004c4c5c | LAB_004c4c22
        ;   XREF to: 004c4c22 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [0x02d13f80]      ; 004c4c5e | undefined4 DAT_02d13f80
        ;   Label: LAB_004c4c5e
    XOR ESI,ESI                         ; 004c4c64
    TEST EDI,EDI                        ; 004c4c66
    JLE 0x004c4cbc                      ; 004c4c68 | LAB_004c4cbc
    ...
    MOV EDX,dword ptr [EDI + 0x2d13f84] ; 004c4c76 | undefined4 DAT_02d13f84 | DAT_02d13f88
        ;   Label: LAB_004c4c76
    ...
    FMUL ST0                            ; 004c4c9b
    FADDP                               ; 004c4c9d
    FCOMP double ptr [0x00629f2b]       ; 004c4c9f | double DOUBLE_00629f2b
    FNSTSW AX                           ; 004c4ca5
    SAHF                                ; 004c4ca7
    JBE 0x004c4d3b                      ; 004c4ca8 | LAB_004c4d3b
        ;   XREF to: 004c4d3b (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x02d13f80]      ; 004c4cae | undefined4 DAT_02d13f80
        ;   Label: LAB_004c4cae
    INC ESI                             ; 004c4cb4
    ADD EDI,0x4                         ; 004c4cb5
    CMP ESI,ECX                         ; 004c4cb8
    JL 0x004c4c76                       ; 004c4cba | LAB_004c4c76
    ...
    FMUL ST0                            ; 004c4cde
    FADDP                               ; 004c4ce0
    FCOMP float ptr [0x00629f23]        ; 004c4ce2 | float FLOAT_00629f23
    FNSTSW AX                           ; 004c4ce8
    SAHF                                ; 004c4cea
    JA 0x004c4c48                       ; 004c4ceb | LAB_004c4c48
        ;   XREF to: 004c4c48 (CONDITIONAL_JUMP)
    LEA EAX,[EBX + 0x158]               ; 004c4cf1
    PUSH EAX                            ; 004c4cf7
    CALL core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0 ; 004c4cf8 | CDeformableModel * core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0(CDeformableModelInstance * this_ptr)
    ...
    PUSH EAX                            ; 004c4d05
    PUSH EBX                            ; 004c4d06
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 004c4d07 | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
    ...
    PUSH EAX                            ; 004c4d2c
    PUSH EBX                            ; 004c4d2d
    CALL core_charactr.cpp_CCharacter_FUN_0042b5b0 ; 004c4d2e | void core_charactr.cpp_CCharacter_FUN_0042b5b0(CCharacter * this_ptr)
        ;   XREF to: 0042b5b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x18                        ; 004c4d33
    JMP 0x004c4c48                      ; 004c4d36 | LAB_004c4c48
        ;   XREF to: 004c4c48 (UNCONDITIONAL_JUMP)
    PUSH EDX                            ; 004c4d3b
        ;   Label: LAB_004c4d3b
    CALL core_flamecan.cpp_FUN_004cb340 ; 004c4d3c | undefined core_flamecan.cpp_FUN_004cb340()
        ;   XREF to: 004cb340 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004c4d41
    JMP 0x004c4cae                      ; 004c4d44 | LAB_004c4cae
