...
// Convention: __cdecl
// Signature: void __cdecl core_fire_cpp_CFireEffect_createExplosion_FUN_004c8c10(CFireEffect *this_ptr,CVector3f *position,float scale,float gore_multiplier,float radius)
...

{
  core_fire_cpp_CExplosion_activate_FUN_004c3970
            (g_ExplosionPool + g_ExplosionPoolIndex,position,scale,gore_multiplier);
  ...
  core_fire_cpp_CFireEffect_createCrater_FUN_004c8ea0(this_ptr,position,radius);
  return;
}
