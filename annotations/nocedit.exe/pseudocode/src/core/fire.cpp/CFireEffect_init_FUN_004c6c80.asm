...
section .text
    ...
    MOV dword ptr [0x02d53dfc],ECX      ; 004c6cbb | g_StakeActiveListHead
    LEA EBX,[EAX + 0x4c00]              ; 004c6cc1 | g_SparkActiveCount
    ...
    LEA EBX,[EAX + 0x730]               ; 004c6cda | g_GlassParticleNextIndex
    ...
    MOV [0x02d59134],EAX                ; 004c6cf8 | g_GlassParticleNextIndex
    MOV EAX,0x2d59138                   ; 004c6cfd | g_GlassParticlePool
    MOV dword ptr [0x02d2ddf8],EDI      ; 004c6d02 | g_StakeAllocIndex
    LEA EBX,[EAX + 0x9c00]              ; 004c6d08 | g_CFireEffectGlassParticlesEnd
    ...
    LEA EBX,[EAX + 0x168]               ; 004c6d26 | g_BulletTrailActiveListHead
    ...
    LEA ESI,[EBX + 0x4650]              ; 004c6df5 | g_GunFlameActiveListHead
    ...
    LEA ESI,[EBX + 0x1b8]               ; 004c6e18 | g_LightningBoltActiveListHead
    ...
    LEA ESI,[EBX + 0xe10]               ; 004c6e3a | g_TrailActiveListHead
    ...
    MOV dword ptr [0x02d72588],ECX      ; 004c6e5d | g_TrailActiveListHead
    LEA EBX,[EAX + 0x1130]              ; 004c6e63 | g_CFireEffectShellsEnd
    ...
    MOV dword ptr [0x02d736bc],EBX      ; 004c6e7e | g_CFireEffectShellsEnd
    LEA EBX,[EAX + 0x3800]              ; 004c6e84 | g_CFireEffectPopcornsEnd
    ...
    MOV dword ptr [0x02d76ec0],ESI      ; 004c6e9f | g_CFireEffectPopcornsEnd
