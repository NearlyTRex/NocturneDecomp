...
section .text
    ...
    PUSH 0x65de30                       ; 004c9990 | WatcomTypeInfo g_CMuzzleFlashTypeInfo
        ;   Label: core_fire.cpp_freeMuzzleFlashes_FUN_004c9990
    PUSH 0x14                           ; 004c9995
    MOV EDX,dword ptr [ESP + 0xc]       ; 004c9997
    PUSH EDX                            ; 004c999b
    CALL crt_memory.c_freeTypeArray_FUN_005feee9 ; 004c999c | int crt_memory.c_freeTypeArray_FUN_005feee9(void * * obj_array, int obj_count, WatcomTypeInfo * type_info)
