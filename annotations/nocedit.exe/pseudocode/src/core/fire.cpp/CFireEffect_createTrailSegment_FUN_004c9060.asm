...
;
; Called Functions:
;   core_fire.cpp_CTrail_activate_FUN_004c5df0
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 004c9060
        ;   Label: core_fire.cpp_CFireEffect_createTrailSegment_FUN_004c9060
    MOV EDX,dword ptr [ESP + 0x1c]      ; 004c9061
    PUSH EDX                            ; 004c9065
    MOV ECX,dword ptr [ESP + 0x10]      ; 004c9066
    MOV EDX,dword ptr [0x02d71774]      ; 004c906a | g_TrailAllocIndex
    ...
    PUSH EAX                            ; 004c908e
    CALL core_fire.cpp_CTrail_activate_FUN_004c5df0 ; 004c908f
        ;   XREF to: 004c5df0 (UNCONDITIONAL_CALL)  ; void core_fire.cpp_CTrail_activate_FUN_004c5df0(CTrail * this_ptr, CVector3f * position, float size, float alpha, ...)
    MOV EBX,dword ptr [0x02d71774]      ; 004c9094 | g_TrailAllocIndex
    INC EBX                             ; 004c909a
    ADD ESP,0x18                        ; 004c909b
    MOV dword ptr [0x02d71774],EBX      ; 004c909e | g_TrailAllocIndex
    ...
    MOV dword ptr [0x02d71774],EDI      ; 004c90ae | g_TrailAllocIndex
    POP EDI                             ; 004c90b4
    POP EBX                             ; 004c90b5
    RET                                 ; 004c90b6
