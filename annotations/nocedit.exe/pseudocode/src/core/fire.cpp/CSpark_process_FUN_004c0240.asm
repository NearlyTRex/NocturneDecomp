...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_fire_cpp_CSpark_process_FUN_004c0240(CSpark *this_ptr)
;
; Parameters:
...
section .text
    ...
    JNZ 0x004c02b9                      ; 004c024e
        ;   XREF to: 004c02b9 (CONDITIONAL_JUMP)  ; LAB_004c02b9
    MOV dword ptr [EBX + 0x40],0x1      ; 004c0250
    MOV EAX,[0x0067b654]                ; 004c0257 | g_CGamePtr
        ;   Label: LAB_004c0257
    MOV EAX,dword ptr [EAX + 0x264]     ; 004c025c | g_CGameInstance.delta_time_float
    MOV EDX,dword ptr [0x02cf6a80]      ; 004c0262 | g_GlobalDeltaTimeInt
    ...
    FMUL double ptr [0x00629c63]        ; 004c027c | DOUBLE_00629c63
    SUB ESP,0x4                         ; 004c0282
    MOV EDI,dword ptr [0x0067b654]      ; 004c0285 | g_CGamePtr
    FSTP float ptr [ESP]                ; 004c028b
    PUSH EDI                            ; 004c028e | g_CGameInstance
    CALL core_game.cpp_CGame_slamDT_FUN_004e3080 ; 004c028f
    ...
    PUSH EBX                            ; 004c0297
    CALL core_particle.cpp_CParticle_process_FUN_00545760 ; 004c0298
    ...
    MOV EBP,dword ptr [0x0067b654]      ; 004c02a0 | g_CGamePtr
    PUSH dword ptr [ESP]                ; 004c02a6
    PUSH EBP                            ; 004c02a9 | g_CGameInstance
    CALL core_game.cpp_CGame_slamDT_FUN_004e3080 ; 004c02aa
        ;   XREF to: 004e3080 (UNCONDITIONAL_CALL)  ; void core_game.cpp_CGame_slamDT_FUN_004e3080(CGame * this_ptr, float delta_time)
    ...
    POP EBX                             ; 004c02b7
    RET                                 ; 004c02b8
    MOV EAX,[0x02cf6a80]                ; 004c02b9 | g_GlobalDeltaTimeInt
        ;   Label: LAB_004c02b9
    ...
    JGE 0x004c0257                      ; 004c02de
        ;   XREF to: 004c0257 (CONDITIONAL_JUMP)  ; LAB_004c0257
    MOV dword ptr [EBX + 0x18],0x0      ; 004c02e4
    MOV dword ptr [EBX + 0x38],0x0      ; 004c02eb
    JMP 0x004c0257                      ; 004c02f2
        ;   XREF to: 004c0257 (UNCONDITIONAL_JUMP)  ; LAB_004c0257
