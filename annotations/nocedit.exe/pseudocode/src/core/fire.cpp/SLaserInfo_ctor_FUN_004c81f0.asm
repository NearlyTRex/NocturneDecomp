...
;                               FUNCTION
; *****************************************************************************
; __cdecl SLaserInfo * __cdecl core_fire_cpp_SLaserInfo_ctor_FUN_004c81f0(SLaserInfo *this_ptr)
;
; Parameters:
...
;   core_weapon.cpp_CWeapon_fireProjectile_FUN_005ee830 at 005ee8e6
;
; Referenced Globals:
