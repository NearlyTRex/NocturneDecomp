...
;
; XREF[1]:
;   core_fire.cpp_CFireEffect_createToss_FUN_004c8dd0 at 004c8e05
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004c8e40
        ;   Label: core_fire.cpp_CFireEffect_allocateToss_FUN_004c8e40
    PUSH ESI                            ; 004c8e41
    PUSH EDI                            ; 004c8e42
    PUSH EBP                            ; 004c8e43
    MOV EBX,dword ptr [0x02d678cc]      ; 004c8e44 | g_TossAllocIndex
    ...
    CALL core_fire.cpp_CToss_create_FUN_004c3ee0 ; 004c8e6e
        ;   XREF to: 004c3ee0 (UNCONDITIONAL_CALL)  ; void core_fire.cpp_CToss_create_FUN_004c3ee0(CToss * this_ptr, int toss_type, CVector3f * position, UOrientationVector * orientation, ...)
    MOV EBP,dword ptr [0x02d678cc]      ; 004c8e73 | g_TossAllocIndex
    INC EBP                             ; 004c8e79
    ADD ESP,0x18                        ; 004c8e7a
    MOV dword ptr [0x02d678cc],EBP      ; 004c8e7d | g_TossAllocIndex
    ...
    XOR EDX,EDX                         ; 004c8e8f
        ;   Label: LAB_004c8e8f
    MOV dword ptr [0x02d678cc],EDX      ; 004c8e91 | g_TossAllocIndex
