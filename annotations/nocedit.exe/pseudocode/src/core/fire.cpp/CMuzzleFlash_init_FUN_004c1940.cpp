...

{
  ...
  core_dglobe_cpp_CDemonGlobe_setColor_FUN_00471310(&this_ptr->light,(CColor3f *)position);
  (this_ptr->light).intensity_multiplier = 0x8000;
  (this_ptr->light).intensity.bytes[0] = ' ';
  core_dglobe_cpp_CDemonGlobe_precomputeAttenuation_FUN_00471360(&this_ptr->light,8.0);
