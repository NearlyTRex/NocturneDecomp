...
;
; XREF[3]:
;   core_elephant.cpp_CElephantGun_renderAimBeam_FUN_004a79f0 at 004a7b64
;   core_lightgun.cpp_CLightGun_renderAimBeam_FUN_005066b0 at 0050684a
;   core_shotgun.cpp_CShotgun_renderAimBeam_FUN_005888f0 at 00588a64
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBP                            ; 004c7f20
        ;   Label: core_fire.cpp_CFireEffect_createLaserCone_FUN_004c7f20
    MOV EDX,dword ptr [0x02d667ac]      ; 004c7f21 | g_LaserBeamActiveCount
    ...
    PUSH EAX                            ; 004c7f66
    CALL core_fire.cpp_CLaserBeam_init_FUN_004c2420 ; 004c7f67
    ...
    MOV EAX,[0x02d667ac]                ; 004c7f6c | g_LaserBeamActiveCount
    INC EAX                             ; 004c7f71
    ADD ESP,0x2c                        ; 004c7f72
    MOV [0x02d667ac],EAX                ; 004c7f75 | g_LaserBeamActiveCount
    POP EBX                             ; 004c7f7a
    POP ESI                             ; 004c7f7b
    POP EDI                             ; 004c7f7c
    POP EBP                             ; 004c7f7d
