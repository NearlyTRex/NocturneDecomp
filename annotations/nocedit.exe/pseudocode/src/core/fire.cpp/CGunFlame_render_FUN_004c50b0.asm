...
; CVector3i[2]     Stack[-0x48]:24  local_48
...
section .text
    ...
    PUSH EAX                            ; 004c50fb
    MOV EDX,dword ptr [0x006703ec]      ; 004c50fc | g_CDemonRendererPtr2
    ...
    PUSH EBX                            ; 004c510e
    MOV ECX,dword ptr [0x006703ec]      ; 004c510f | g_CDemonRendererPtr2
    ...
    PUSH EAX                            ; 004c5122
    MOV EDI,dword ptr [0x006703ec]      ; 004c5123 | g_CDemonRendererPtr2
    PUSH EDI                            ; 004c5129 | g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_getCameraRotationRadians_FUN_0048c800 ; 004c512a
    ...
    PUSH EAX                            ; 004c5138
    MOV EAX,[0x006703ec]                ; 004c5139 | g_CDemonRendererPtr2
    ...
    PUSH EAX                            ; 004c5188
    MOV EDX,dword ptr [0x006703ec]      ; 004c5189 | g_CDemonRendererPtr2
    PUSH EDX                            ; 004c518f | g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_getCameraOriginWorld_FUN_0048c780 ; 004c5190
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 004c5255 | g_CDemonRendererPtr2
    ...
    PUSH EAX                            ; 004c52a7
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 004c52a8
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 004c52cb | g_CDemonRendererPtr2
    ...
    PUSH EAX                            ; 004c5304
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 004c5305
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 004c5327 | g_CDemonRendererPtr2
    ...
    PUSH EAX                            ; 004c535d
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 004c535e
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 004c5379 | g_CDemonRendererPtr2
    ...
    PUSH EAX                            ; 004c53ad
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 004c53ae
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 004c53e4 | g_CDemonRendererPtr2
    FLD ST3                             ; 004c53ea
    ...
    PUSH EAX                            ; 004c55c2
    MOV EDX,dword ptr [0x006703ec]      ; 004c55c3 | g_CDemonRendererPtr2
    PUSH EDX                            ; 004c55c9 | g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_renderVertexAlphaDirect_FUN_0048bad0 ; 004c55ca
    ...
    PUSH EBX                            ; 004c55d4
    MOV ECX,dword ptr [0x006703ec]      ; 004c55d5 | g_CDemonRendererPtr2
    ...
    MOV EBX,dword ptr [0x006703ec]      ; 004c55e4 | g_CDemonRendererPtr2
    PUSH EBX                            ; 004c55ea | g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_matrixPop_FUN_0048c640 ; 004c55eb
        ;   XREF to: 0048c640 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_matrixPop_FUN_0048c640(CDemonRenderer * this_ptr)
    ADD ESP,0x4                         ; 004c55f0
    MOV ESP,EBP                         ; 004c55f3
    POP EBP                             ; 004c55f5
    POP EDI                             ; 004c55f6
    POP ESI                             ; 004c55f7
    POP EBX                             ; 004c55f8
