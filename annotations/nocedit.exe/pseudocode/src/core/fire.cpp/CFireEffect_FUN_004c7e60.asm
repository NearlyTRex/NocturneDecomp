...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_fire_cpp_CFireEffect_FUN_004c7e60(CFireEffect *this_ptr)
;
; Parameters:
...
section .text
    ...
    CALL core_fire.cpp_FUN_004c17c0     ; 004c7ea0
        ;   XREF to: 004c17c0 (UNCONDITIONAL_CALL)  ; undefined core_fire.cpp_FUN_004c17c0()
