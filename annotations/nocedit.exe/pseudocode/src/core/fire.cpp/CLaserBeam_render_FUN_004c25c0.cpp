...

{
  ...
  if ((0.0 < local_2e8) && (g_CGamePtr->halo_mode != 0)) {
    ...
    do {
      ...
      g_CDemonRendererPtr2->vertex_buffer_ptr->a = local_74;
      ...
      local_22c = 1;
      pCVar3->vertex_buffer_ptr[1].a = local_74;
      ...
      local_228 = 2;
      pCVar3->vertex_buffer_ptr[2].a = local_74;
      ...
      local_224 = 3;
      pCVar3->vertex_buffer_ptr[3].a = local_74;
      ...
      do {
        ...
        if (local_20 != 0) {
          ...
          if (local_40 == 0) {
            ...
            pCVar3->vertex_buffer_ptr[3].a = local_2c;
