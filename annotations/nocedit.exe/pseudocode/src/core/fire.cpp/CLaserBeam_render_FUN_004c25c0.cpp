...

{
  ...
  if ((0.0 < local_2e8) && (g_CGamePtr->halo_mode != 0)) {
    ...
    do {
      ...
      local_230 = 0;
      local_74 = (int)ROUND(ROUND(local_2e8 * fVar1 * (float)8192));
      g_CDemonRendererPtr2->vertex_buffer_ptr->fog = local_74;
      pCVar3->vertex_buffer_ptr->z = (this_ptr->color).r;
      pCVar3->vertex_buffer_ptr->r = (this_ptr->color).g;
      pCVar3->vertex_buffer_ptr->g = (this_ptr->color).b;
      local_22c = 1;
      pCVar3->vertex_buffer_ptr[1].fog = local_74;
      pCVar3->vertex_buffer_ptr[1].z = (this_ptr->color).r;
      pCVar3->vertex_buffer_ptr[1].r = (this_ptr->color).g;
      pCVar3->vertex_buffer_ptr[1].g = (this_ptr->color).b;
      local_228 = 2;
      pCVar3->vertex_buffer_ptr[2].fog = local_74;
      pCVar3->vertex_buffer_ptr[2].z = (this_ptr->color).r;
      pCVar3->vertex_buffer_ptr[2].r = (this_ptr->color).g;
      pCVar3->vertex_buffer_ptr[2].g = (this_ptr->color).b;
      local_224 = 3;
      pCVar3->vertex_buffer_ptr[3].fog = local_74;
      pCVar3->vertex_buffer_ptr[3].z = (this_ptr->color).r;
      pCVar3->vertex_buffer_ptr[3].r = (this_ptr->color).g;
      pCVar3->vertex_buffer_ptr[3].g = (this_ptr->color).b;
    ...
    if (-1 < (int)local_24) {
      ...
      do {
        ...
        if (local_20 != 0) {
          ...
          g_CDemonRendererPtr2->vertex_buffer_ptr->z = (this_ptr->color).r;
          pCVar3->vertex_buffer_ptr->r = (this_ptr->color).g;
          pCVar3->vertex_buffer_ptr->g = (this_ptr->color).b;
          pCVar3->vertex_buffer_ptr[1].z = (this_ptr->color).r;
          pCVar3->vertex_buffer_ptr[1].r = (this_ptr->color).g;
          ...
          pCVar3 = g_CDemonRendererPtr2;
          local_2c = (int)ROUND(ROUND(local_2e0 * (float)32767.5));
          if (local_40 == 0) {
            ...
            pCVar3->vertex_buffer_ptr[1].fog = 0;
            pCVar3->vertex_buffer_ptr[2].fog = 0;
            pCVar3->vertex_buffer_ptr[3].fog = local_2c;
