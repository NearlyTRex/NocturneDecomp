...
// Address Range: [[004c25c0, 004c386d] [03fc55e4, 03fc5641]]
// Convention: __cdecl
...

{
  ...
  if ((0.0 < local_2e8) && (g_CGamePtr->halo_mode != 0)) {
    ...
    do {
      ...
      local_248.base.surface_normal.D.i = 0;
      local_248.base.surface_normal.C.i = 0;
      local_248.base.surface_normal.B.i = 0;
      local_248.base.surface_normal.A.i = 0;
      ...
      for (int i = 0; i < 4; i = i + 1) {
        pCVar3->vertex_buffer_ptr[i].a = iVar9;
        pCVar3->vertex_buffer_ptr[i].r = (this_ptr->color).r;
  ...
  if (0.0 < local_2e0) {
    ...
    do {
      ...
      if (local_20 != 0) {
        ...
        local_2d8.base.surface_normal.D.i = 0;
        local_2d8.base.surface_normal.C.i = 0;
        local_2d8.base.surface_normal.B.i = 0;
        local_2d8.base.surface_normal.A.i = 0;
        ...
        for (int ci = 0; ci < 4; ci = ci + 1) {
          ...
          pCVar4->vertex_buffer_ptr[ci].g = (this_ptr->color).g;
          pCVar4->vertex_buffer_ptr[ci].b = (this_ptr->color).b;
        }
        ...
        if (0.0 < fVar8) {
          ...
          engine_drender_cpp_CDemonRenderer_renderVertexAlphaPoly_FUN_0048bba0
                    (pCVar4,(SMRGLPrimitivePoly *)&local_2d8);
        }
        else {
          ...
          engine_drender_cpp_CDemonRenderer_renderBlendedPoly_FUN_0048bdc0
                    (g_CDemonRendererPtr2,(SMRGLPrimitivePoly *)&local_2d8);
        }
      }
  ...
  if (0.0 < local_2f4) {
    ...
    local_290.base.surface_normal.D.i = 0;
    local_290.base.surface_normal.C.i = 0;
    local_290.base.surface_normal.B.i = 0;
    ...
    engine_drender_cpp_CDemonRenderer_renderBlendedPoly_FUN_0048bdc0
              (g_CDemonRendererPtr2,(SMRGLPrimitivePoly *)&local_290);
    engine_drender_cpp_CDemonRenderer_matrixPop_FUN_0048c640(g_CDemonRendererPtr2);
  }
  engine_drender_cpp_CDemonRenderer_setBlendMode_FUN_0048ca50(g_CDemonRendererPtr2,0);
