...
;
; Called Functions:
;   core_fire.cpp_CGunFlame_activate_FUN_004c4db0
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 004c8ef0
        ;   Label: core_fire.cpp_CFireEffect_createGunFlames_FUN_004c8ef0
    PUSH ESI                            ; 004c8ef1
    PUSH EDI                            ; 004c8ef2
    PUSH EBP                            ; 004c8ef3
    MOV ESI,dword ptr [0x02d6cf64]      ; 004c8ef4 | g_GunFlameAllocIndex
    ...
    MOV dword ptr [0x02d6cf64],ESI      ; 004c8f1a | g_GunFlameAllocIndex
    CALL core_fire.cpp_CGunFlame_activate_FUN_004c4db0 ; 004c8f20
        ;   XREF to: 004c4db0 (UNCONDITIONAL_CALL)  ; void core_fire.cpp_CGunFlame_activate_FUN_004c4db0(CGunFlame * this_ptr, CVector3f * position, CVector3f * euler_angles, int flame_type)
    MOV ESI,dword ptr [0x02d6cf64]      ; 004c8f25 | g_GunFlameAllocIndex
    INC ESI                             ; 004c8f2b
    ...
    MOV dword ptr [0x02d6cf64],ESI      ; 004c8f3e | g_GunFlameAllocIndex
        ;   Label: LAB_004c8f3e
    POP EBP                             ; 004c8f44
    POP EDI                             ; 004c8f45
    POP ESI                             ; 004c8f46
