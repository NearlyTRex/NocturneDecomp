...

{
  ...
  local_b0 = 0;
  local_b4 = -0.4;
  local_4c.x = (int)ROUND(256f * 0.4);
  local_4c.y = (int)ROUND(256f * -0.4);
...
LAB_004c04af:
  ...
  do {
    ...
    local_b0 = 0;
    CStack_58.x = (int)ROUND(local_b8 * 256f);
    CStack_58.y = (int)ROUND(local_b8 * 256f);
    CStack_58.z = (int)ROUND(256f * 0.0);
    local_b4 = local_b8;
    fStack_1c = local_b8;
    wincore_windll_cpp_transformAndProjectPoint_FUN_005b575c
    ...
    local_b4 = fStack_1c;
    local_b0 = 0;
    aCStack_40[0].x = (int)ROUND(local_b8 * 256f);
    aCStack_40[0].y = (int)ROUND(fStack_1c * 256f);
    aCStack_40[0].z = (int)ROUND(256f * 0.0);
    fStack_18 = local_b8;
    wincore_windll_cpp_transformAndProjectPoint_FUN_005b575c
    ...
    local_b8 = fStack_18;
    local_b4 = fStack_18;
    CStack_c4.x = (int)ROUND(fStack_18 * 256f);
    CStack_c4.y = (int)ROUND(fStack_18 * 256f);
    CStack_c4.z = (int)ROUND(256f * 0.0);
    wincore_windll_cpp_transformAndProjectPoint_FUN_005b575c
              (&g_CDemonRendererPtr->vertex_buffer_ptr[2].projected_vertex,&CStack_c4);
    local_b8 = fStack_1c;
    local_b4 = fStack_18;
    local_b0 = 0;
    CStack_94.x = (int)ROUND(fStack_1c * 256f);
    CStack_94.y = (int)ROUND(fStack_18 * 256f);
