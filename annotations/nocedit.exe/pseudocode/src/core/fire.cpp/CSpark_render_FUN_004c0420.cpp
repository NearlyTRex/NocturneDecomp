...

{
  ...
  local_60.x = (int)ROUND((this_ptr->base).position.x * 256f);
  local_60.y = (int)ROUND((this_ptr->base).position.y * 256f);
  local_60.z = (int)ROUND((this_ptr->base).position.z * 256f);
  fStack_1c = 0.4;
  wincore_windll_cpp_transformPoint_FUN_005b5a25(&vertex_ptr->projected_vertex,&local_60);
  ...
  local_b0 = -0.4;
  uStack_ac = 0;
  local_cc.x = (int)ROUND(256f * -0.4);
  local_cc.y = (int)ROUND(256f * -0.4);
  local_cc.z = (int)ROUND(256f * 0.0);
  wincore_windll_cpp_transformAndProjectPoint_FUN_005b575c
            (&g_CDemonRendererPtr->vertex_buffer_ptr->projected_vertex,&local_cc);
  local_b4 = 0.4;
  uStack_ac = 0;
  local_b0 = -0.4;
  local_48.x = (int)ROUND(256f * 0.4);
  local_48.y = (int)ROUND(256f * -0.4);
  local_48.z = (int)ROUND(256f * 0.0);
  wincore_windll_cpp_transformAndProjectPoint_FUN_005b575c
            (&g_CDemonRendererPtr->vertex_buffer_ptr[1].projected_vertex,&local_48);
  local_b4 = 0.4;
  local_b0 = 0.4;
  uStack_ac = 0;
  local_9c.x = (int)ROUND(256f * 0.4);
  local_9c.y = (int)ROUND(256f * 0.4);
  local_9c.z = (int)ROUND(256f * 0.0);
  wincore_windll_cpp_transformAndProjectPoint_FUN_005b575c
            (&g_CDemonRendererPtr->vertex_buffer_ptr[2].projected_vertex,&local_9c);
  local_b4 = -0.4;
  local_b0 = 0.4;
  uStack_ac = 0;
  local_6c.x = (int)ROUND(256f * -0.4);
  local_6c.y = (int)ROUND(256f * 0.4);
...
LAB_004c04af:
  ...
  local_70 = (this_ptr->base).velocity.z;
  local_d0 = 1.0;
  iVar3 = 0;
  fStack_d4 = 0.025;
  do {
    ...
    local_a0 = local_70 * fStack_d4;
    fStack_a4 = fStack_74 * fStack_d4;
    CStack_84.x = CStack_84.x - fStack_a8;
    CStack_84.z = CStack_84.z - local_a0;
    CStack_84.y = CStack_84.y - fStack_a4;
    engine_drender_cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450
              (g_CDemonRendererPtr,&CStack_84);
    engine_drender_cpp_CDemonRenderer_applyDirectTransform_FUN_0048c4a0
              (g_CDemonRendererPtr,&g_BillboardCameraRight,(CVector3i *)0x0);
    local_b4 = -fStack_1c * local_d0;
    uStack_ac = 0;
    CStack_54.x = (int)ROUND(local_b4 * 256f);
    CStack_54.y = (int)ROUND(local_b4 * 256f);
    CStack_54.z = (int)ROUND(256f * 0.0);
    local_b0 = local_b4;
    fStack_18 = local_b4;
    wincore_windll_cpp_transformAndProjectPoint_FUN_005b575c
              (&g_CDemonRendererPtr->vertex_buffer_ptr->projected_vertex,&CStack_54);
    local_b4 = fStack_1c * local_d0;
    local_b0 = fStack_18;
    uStack_ac = 0;
