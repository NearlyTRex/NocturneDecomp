...
;
; Called Functions:
;   core_fire.cpp_CRock_setup_FUN_004c17c0
;
; *****************************************************************************
...
section .text
    ...
    PUSH ESI                            ; 004c7e60
        ;   Label: core_fire.cpp_CFireEffect_createRock_FUN_004c7e60
    PUSH EDI                            ; 004c7e61
    PUSH EBP                            ; 004c7e62
    MOV EDX,dword ptr [0x02d655a8]      ; 004c7e63 | g_RockAllocIndex
    LEA EAX,[EDX*0x8 + 0x0]             ; 004c7e69
    ADD EAX,EDX                         ; 004c7e70
    SHL EAX,0x3                         ; 004c7e72
    INC EDX                             ; 004c7e75
    ADD EAX,0x2d655ac                   ; 004c7e76
    MOV dword ptr [0x02d655a8],EDX      ; 004c7e7b | g_RockAllocIndex
    CMP EDX,0x40                        ; 004c7e81
    JL 0x004c7e90                       ; 004c7e84
        ;   XREF to: 004c7e90 (CONDITIONAL_JUMP)  ; LAB_004c7e90
    PUSH EBX                            ; 004c7e86
    XOR EBX,EBX                         ; 004c7e87
    MOV dword ptr [0x02d655a8],EBX      ; 004c7e89 | g_RockAllocIndex
    POP EBX                             ; 004c7e8f
    ...
    PUSH EBP                            ; 004c7e9e
    PUSH EAX                            ; 004c7e9f
    CALL core_fire.cpp_CRock_setup_FUN_004c17c0 ; 004c7ea0
        ;   XREF to: 004c17c0 (UNCONDITIONAL_CALL)  ; void core_fire.cpp_CRock_setup_FUN_004c17c0(CRock * this_ptr, CVector3f * position, CVector3f * velocity, CKeyFramedModel * model_ptr)
