...
section .text
    ...
    PUSH 0x65dff0                       ; 004c97d0 | WatcomTypeInfo g_CRainDropTypeInfo
        ;   Label: core_fire.cpp_freeRainDrops_FUN_004c97d0
    PUSH 0x100                          ; 004c97d5
    MOV EDX,dword ptr [ESP + 0xc]       ; 004c97da
    PUSH EDX                            ; 004c97de
    CALL crt_memory.c_freeTypeArray_FUN_005feee9 ; 004c97df | int crt_memory.c_freeTypeArray_FUN_005feee9(void * * obj_array, int obj_count, WatcomTypeInfo * type_info)
