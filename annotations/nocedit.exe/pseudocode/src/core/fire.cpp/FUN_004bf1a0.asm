...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_fire.cpp_FUN_004bf1a0()
;
; Local Variables:
...
section .text
    ...
    FCOMP double ptr [0x00629bfb]       ; 004bf1af | double DOUBLE_00629bfb
    FNSTSW AX                           ; 004bf1b5
    SAHF                                ; 004bf1b7
    JBE 0x004bf1d2                      ; 004bf1b8 | LAB_004bf1d2
        ;   XREF to: 004bf1d2 (CONDITIONAL_JUMP)
    FLD1                                ; 004bf1ba
    FCOMP double ptr [ESP]              ; 004bf1bc
    FNSTSW AX                           ; 004bf1bf
    SAHF                                ; 004bf1c1
    JA 0x004bf1dc                       ; 004bf1c2 | LAB_004bf1dc
    ...
    MOV dword ptr [ESP + 0x8],0x40490fdb ; 004bf1d2
        ;   Label: LAB_004bf1d2
    JMP 0x004bf1ca                      ; 004bf1da | LAB_004bf1ca
        ;   XREF to: 004bf1ca (UNCONDITIONAL_JUMP)
    FLD double ptr [ESP]                ; 004bf1dc
        ;   Label: LAB_004bf1dc
    CALL crt_math.c_acos_FUN_00600162   ; 004bf1df | double crt_math.c_acos_FUN_00600162(double x)
