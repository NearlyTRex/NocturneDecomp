...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_fire.cpp_CFireball_initRender_FUN_004c0d80(CFireball * this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EBX,dword ptr [0x006703ec]      ; 004c0d94 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    MOV EDI,0x2d12db4                   ; 004c0d9a | CVector3i g_BillboardCameraRight
    ...
    PUSH EBX                            ; 004c0dca | CDemonRenderer g_CDemonRendererInstance
    ...
    CALL engine_drender.cpp_CDemonRenderer_getCameraRotationToBuffer_FUN_0048c7e0 ; 004c0de1 | void engine_drender.cpp_CDemonRenderer_getCameraRotationToBuffer_FUN_0048c7e0(CDemonRenderer * this_ptr, CVector3i * output)
        ;   XREF to: 0048c7e0 (UNCONDITIONAL_CALL)
    LEA ESI,[ESP + 0x54]                ; 004c0de6
    ADD ESP,0x4                         ; 004c0dea
    MOVSD ES:EDI,ESI                    ; 004c0ded | CVector3i g_BillboardCameraRight
    ...
    MOV ESI,dword ptr [0x00823a74]      ; 004c0df8 | CDemonCamera * g_CurrentSceneCamera
    ...
    FLD double ptr [0x00629ca3]         ; 004c0e19 | double DOUBLE_00629ca3
    ...
    FMULP ST3                           ; 004c0e2f
    FXCH                                ; 004c0e31
    CALL crt_math.c_round_FUN_005fe6b0  ; 004c0e33 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH                                ; 004c0e38
    CALL crt_math.c_round_FUN_005fe6b0  ; 004c0e3a | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH ST2                            ; 004c0e3f
    CALL crt_math.c_round_FUN_005fe6b0  ; 004c0e41 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH                                ; 004c0e46
    FISTP dword ptr [0x02d12dc0]        ; 004c0e48 | CVector3i g_BillboardCameraUp
    FXCH                                ; 004c0e4e
