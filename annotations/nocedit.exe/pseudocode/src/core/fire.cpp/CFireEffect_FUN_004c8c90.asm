...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_fire.cpp_CFireEffect_FUN_004c8c90(CFireEffect * this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EDX,0x2d677b4                   ; 004c8ca6 | CExplosion[10] g_ExplosionPool
    XOR ECX,ECX                         ; 004c8cab
    FLD float ptr [EDX + 0xc]           ; 004c8cad | DAT_02d677c0
        ;   Label: LAB_004c8cad
    MOV ESI,EDX                         ; 004c8cb0
    FCOMP double ptr [0x0062a0a3]       ; 004c8cb2 | double DOUBLE_0062a0a3
    FNSTSW AX                           ; 004c8cb8
    SAHF                                ; 004c8cba
    JA 0x004c8ccf                       ; 004c8cbb | LAB_004c8ccf
        ;   XREF to: 004c8ccf (CONDITIONAL_JUMP)
    INC ECX                             ; 004c8cbd
        ;   Label: LAB_004c8cbd
    ADD EDX,0x1c                        ; 004c8cbe
    CMP ECX,0xa                         ; 004c8cc1
    JL 0x004c8cad                       ; 004c8cc4 | LAB_004c8cad
    ...
    FADDP                               ; 004c8d23
    FSQRT                               ; 004c8d25
    FLD float ptr [ESI + 0x10]          ; 004c8d27 | DAT_02d677c4
    FMUL double ptr [0x0062a0a3]        ; 004c8d2a | double DOUBLE_0062a0a3
    ...
    FLD float ptr [0x0062a0ab]          ; 004c8d6c | float FLOAT_0062a0ab
    FXCH                                ; 004c8d72
    FMUL ST1                            ; 004c8d74
    FXCH ST2                            ; 004c8d76
    ...
    JZ 0x004c8db2                       ; 004c8d9c | LAB_004c8db2
        ;   XREF to: 004c8db2 (CONDITIONAL_JUMP)
    ...
    JZ 0x004c8dbe                       ; 004c8db7 | LAB_004c8dbe
        ;   XREF to: 004c8dbe (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESI + 0x14]      ; 004c8db9 | DAT_02d677c8
