...
section .text
    ...
    MOV EDX,dword ptr [0x02d58a04]      ; 004c93d0 | CMuzzleFlash[20] g_MuzzleFlashPool
        ;   Label: core_fire.cpp_CFireEffect_FUN_004c93d0
    XOR EAX,EAX                         ; 004c93d6
    CMP EDX,0x1                         ; 004c93d8
    JZ 0x004c93f4                       ; 004c93db | LAB_004c93f4
    ...
    CMP dword ptr [EAX + 0x2d58a04],0x1 ; 004c93eb | DAT_02d58a60
    JNZ 0x004c93dd                      ; 004c93f2 | LAB_004c93dd
