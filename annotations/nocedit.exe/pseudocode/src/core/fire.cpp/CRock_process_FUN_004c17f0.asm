...
section .text
    ...
    PUSH EBX                            ; 004c17f8
    CALL core_particle.cpp_CParticle_process_FUN_00545760 ; 004c17f9 | void core_particle.cpp_CParticle_process_FUN_00545760(CParticle * this_ptr)
    ...
    FADDP                               ; 004c1811
    FSQRT                               ; 004c1813
    MOV EAX,[0x02cf6a80]                ; 004c1815 | int g_GlobalDeltaTimeInt
    MOV EDX,EAX                         ; 004c181a
    SAR EDX,0x1f                        ; 004c181c
    SHL EDX,0x2                         ; 004c181f
    SBB EAX,EDX                         ; 004c1822
    SAR EAX,0x2                         ; 004c1824
    FMUL double ptr [0x00629ccb]        ; 004c1827 | double DOUBLE_00629ccb
    ADD ESP,0x4                         ; 004c182d
    CALL crt_math.c_round_FUN_005fe6b0  ; 004c1830 | double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    MOV EAX,[0x02cf6a80]                ; 004c1846 | int g_GlobalDeltaTimeInt
