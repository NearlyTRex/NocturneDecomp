...
;   undefined4 g_FireEffectLightningBoltTextures[1].base.type
...
section .text
    ...
    PUSH EBX                            ; 004c560d | g_FireEffectLightningBoltTextures | g_FireEffectLightningBoltTextures[1].base.type
        ;   Label: LAB_004c560d
    ...
    ADD EBX,0x18                        ; 004c561a | g_FireEffectLightningBoltTextures[1].base.type
