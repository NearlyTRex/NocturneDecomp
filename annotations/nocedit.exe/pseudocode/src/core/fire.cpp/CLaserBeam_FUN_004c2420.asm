...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_fire_cpp_CLaserBeam_FUN_004c2420(CLaserBeam *this_ptr)
;
; Parameters:
; CLaserBeam *     Stack[0x4]:4   this_ptr
;
; XREF[2]:
;   core_fire.cpp_CFireEffect_FUN_004c7eb0 at 004c7ef8
;   core_fire.cpp_CFireEffect_FUN_004c7f20 at 004c7f67
;
; *****************************************************************************
