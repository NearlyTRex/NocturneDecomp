...
section .text
    ...
    PUSH 0x65df90                       ; 004c9830 | WatcomTypeInfo g_CTrailTypeInfo
        ;   Label: core_fire.cpp_freeTrails_FUN_004c9830
    PUSH 0x64                           ; 004c9835
    MOV EDX,dword ptr [ESP + 0xc]       ; 004c9837
    PUSH EDX                            ; 004c983b
    CALL crt_memory.c_freeTypeArray_FUN_005feee9 ; 004c983c | int crt_memory.c_freeTypeArray_FUN_005feee9(void * * obj_array, int obj_count, WatcomTypeInfo * type_info)
