...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_fire.cpp_CFireEffect_createGlassParticle_FUN_004c7d00(CFireEffect * this_ptr, STriangleVertices * triangle_vertices, CVector3f * uv_u_per_vertex, CVector3f * uv_v_per_vertex, SMRGLTextureBasic * texture, int lifetime)
;
; Parameters:
...
section .text
    ...
    PUSH EDI                            ; 004c7d01
    PUSH EBP                            ; 004c7d02
    MOV EDX,dword ptr [0x02d59134]      ; 004c7d03 | int g_GlassParticleNextIndex
    ...
    INC EDX                             ; 004c7d1a
    ADD EAX,0x2d59138                   ; 004c7d1b | CGlassParticle[256] g_GlassParticlePool
    MOV dword ptr [0x02d59134],EDX      ; 004c7d20 | int g_GlassParticleNextIndex
    CMP EDX,0x100                       ; 004c7d26
    JL 0x004c7d38                       ; 004c7d2c | LAB_004c7d38
        ;   XREF to: 004c7d38 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 004c7d2e
    XOR EBX,EBX                         ; 004c7d2f
    MOV dword ptr [0x02d59134],EBX      ; 004c7d31 | int g_GlassParticleNextIndex
    POP EBX                             ; 004c7d37
    ...
    PUSH ECX                            ; 004c7d50
    PUSH EAX                            ; 004c7d51
    CALL core_fire.cpp_CGlassParticle_init_FUN_004c1c00 ; 004c7d52 | void core_fire.cpp_CGlassParticle_init_FUN_004c1c00(CGlassParticle * this_ptr, STriangleVertices * triangle_vertices, CVector3f * uv_u_per_vertex, CVector3f * uv_v_per_vertex, ...)
