...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_fire.cpp_CCrater_save_FUN_004c49c0(CCrater * this_ptr, FILE * file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH ECX                            ; 004c49e5
    PUSH 0x629e98                       ; 004c49e6 | = "%d,%d,%f,%f\n" | s_d_d_f_f_00629e98 = %d,%d,%f,%f

    PUSH ESI                            ; 004c49eb
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 004c49ec | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    PUSH 0x629ea5                       ; 004c4a0f | = "%f,%f,%f\n" | s_f_f_f_00629ea5 = %f,%f,%f

    PUSH ESI                            ; 004c4a14
    MOV EBX,EBP                         ; 004c4a15
    LEA EDI,[EBP + 0x24]                ; 004c4a17
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 004c4a1a | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH 0x629eaf                       ; 004c4a3d | = "%f,%f,%f\n" | s_f_f_f_00629eaf = %f,%f,%f

    PUSH ESI                            ; 004c4a42
    ADD EBX,0xc                         ; 004c4a43
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 004c4a46 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x20                        ; 004c4a4b
    CMP EBX,EDI                         ; 004c4a4e
    JNZ 0x004c4a22                      ; 004c4a50 | LAB_004c4a22
    ...
    PUSH 0x629eb9                       ; 004c4a6d | = "%f,%f,%f\n" | s_f_f_f_00629eb9 = %f,%f,%f

    PUSH ESI                            ; 004c4a72
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 004c4a73 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH 0x629ec3                       ; 004c4a96 | = "%f,%f,%f\n" | s_f_f_f_00629ec3 = %f,%f,%f

    PUSH ESI                            ; 004c4a9b
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 004c4a9c | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH 0x629ecd                       ; 004c4abf | = "%f,%f,%f\n" | s_f_f_f_00629ecd = %f,%f,%f

    PUSH ESI                            ; 004c4ac4
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 004c4ac5 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH 0x629ed7                       ; 004c4ae8 | = "%f,%f,%f\n" | s_f_f_f_00629ed7 = %f,%f,%f

    PUSH ESI                            ; 004c4aed
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 004c4aee | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
