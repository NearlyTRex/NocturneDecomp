...
section .text
    ...
    PUSH EAX                            ; 004c1f56
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 004c1f57
    ...
    PUSH EAX                            ; 004c1f9b
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 004c1f9c
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    PUSH EAX                            ; 004c1fe0
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 004c1fe1
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    CALL engine_drender.cpp_CDemonRenderer_renderBlendedDirect_FUN_0048bcf0 ; 004c20cd
    ...
    ADD ESP,0x4                         ; 004c20e1
    ADD ESP,0x58                        ; 004c20e4
    POP EBP                             ; 004c20e7
    POP EDI                             ; 004c20e8
    POP ESI                             ; 004c20e9
    POP EBX                             ; 004c20ea
