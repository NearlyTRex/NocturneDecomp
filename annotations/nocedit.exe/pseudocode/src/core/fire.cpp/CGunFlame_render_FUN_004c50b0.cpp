...

{
  ...
  this_ptr_00->vertex_buffer_ptr->z = local_20;
  local_18 = (int)ROUND(ROUND(fVar6 * (fVar4 + fVar2)));
  this_ptr_00->vertex_buffer_ptr->r = local_24;
  local_1c = (int)ROUND(ROUND(fVar5));
  ...
  this_ptr_00->vertex_buffer_ptr[1].r = local_24;
  ...
  this_ptr_00->vertex_buffer_ptr[2].r = local_24;
  ...
  this_ptr_00->vertex_buffer_ptr[3].r = local_24;
