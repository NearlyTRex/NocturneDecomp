...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_fire.cpp_CFireEffect_FUN_004c7db0(CFireEffect * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EDI                            ; 004c7db1
    PUSH EBP                            ; 004c7db2
    MOV EAX,[0x02d62ea4]                ; 004c7db3 | CBulletTrail * g_BulletTrailActiveListHead
    ...
    ADD EBX,0x2d62ea8                   ; 004c7dcc | CFireball[64] g_FireballPool
    MOV dword ptr [0x02d62ea4],EDX      ; 004c7dd2 | CBulletTrail * g_BulletTrailActiveListHead
    CMP EDX,0x40                        ; 004c7dd8
    JL 0x004c7de7                       ; 004c7ddb | LAB_004c7de7
        ;   XREF to: 004c7de7 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 004c7ddd
    XOR ESI,ESI                         ; 004c7dde
    MOV dword ptr [0x02d62ea4],ESI      ; 004c7de0 | CBulletTrail * g_BulletTrailActiveListHead
    POP ESI                             ; 004c7de6
    ...
    CALL core_actor.cpp_getRandomInt_FUN_0040cc70 ; 004c7e04 | int core_actor.cpp_getRandomInt_FUN_0040cc70(int min_value, int max_value)
    ...
    JNZ 0x004c7e50                      ; 004c7e14 | LAB_004c7e50
    ...
    CALL sound_sndmain.cpp_setSfxTrackedFloatPosition_FUN_005a98b0 ; 004c7e34 | int sound_sndmain.cpp_setSfxTrackedFloatPosition_FUN_005a98b0(uint sfx_handle, CVector3f * position_source_ptr)
    ...
    PUSH ECX                            ; 004c7e43
    CALL sound_sndmain.cpp_setSfxTrackedFloatVelocity_FUN_005a9a00 ; 004c7e44 | int sound_sndmain.cpp_setSfxTrackedFloatVelocity_FUN_005a9a00(uint sfx_handle, CVector3f * velocity_source_ptr)
    ...
    MOV dword ptr [EBX + 0x3c],0x8000   ; 004c7e50 | DAT_02d62ee4
        ;   Label: LAB_004c7e50
    JMP 0x004c7e1d                      ; 004c7e57 | LAB_004c7e1d
