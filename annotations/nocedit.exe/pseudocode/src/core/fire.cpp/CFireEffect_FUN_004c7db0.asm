...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_fire_cpp_CFireEffect_FUN_004c7db0(CFireEffect *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EDI                            ; 004c7db1
    PUSH EBP                            ; 004c7db2
    MOV EAX,[0x02d62ea4]                ; 004c7db3 | g_BulletTrailActiveListHead
    ...
    MOV dword ptr [0x02d62ea4],EDX      ; 004c7dd2 | g_BulletTrailActiveListHead
    CMP EDX,0x40                        ; 004c7dd8
    JL 0x004c7de7                       ; 004c7ddb
        ;   XREF to: 004c7de7 (CONDITIONAL_JUMP)  ; LAB_004c7de7
    PUSH ESI                            ; 004c7ddd
    XOR ESI,ESI                         ; 004c7dde
    MOV dword ptr [0x02d62ea4],ESI      ; 004c7de0 | g_BulletTrailActiveListHead
    POP ESI                             ; 004c7de6
