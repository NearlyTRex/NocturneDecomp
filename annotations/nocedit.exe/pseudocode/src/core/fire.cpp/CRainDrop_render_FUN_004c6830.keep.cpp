...

{
  ...
  g_RenderVertexBuffer[1].u = 0xd0 << 16;
  g_RenderVertexBuffer[0].u = 0x80 << 16;
  g_RenderVertexBuffer[0].v = 0xdc << 16;
  g_RenderVertexBuffer[1].v = 0xdc << 16;
  g_RenderVertexBuffer[2].u = 0x80 << 16;
  g_RenderVertexBuffer[3].u = 0x80 << 16;
  g_RenderVertexBuffer[2].v = 0x90 << 16;
  g_RenderVertexBuffer[0].a =
       (int)ROUND(ROUND((float)(0xffff - g_PerspectiveReciprocal) *
                        (this_ptr->base).lifetime_remaining * (float)4));
  g_RenderVertexBuffer[3].v = 0x90 << 16;
