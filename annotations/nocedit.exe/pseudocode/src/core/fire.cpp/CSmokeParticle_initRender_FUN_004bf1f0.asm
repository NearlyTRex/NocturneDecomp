...
section .text
    ...
    MOV EBX,dword ptr [0x006703ec]      ; 004bf204 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    MOV EDI,0x2d12db4                   ; 004bf20a | CVector3i g_BillboardCameraRight
    ...
    PUSH EBX                            ; 004bf23a | CDemonRenderer g_CDemonRendererInstance
    ...
    CALL engine_drender.cpp_CDemonRenderer_getCameraRotationToBuffer_FUN_0048c7e0 ; 004bf251 | void engine_drender.cpp_CDemonRenderer_getCameraRotationToBuffer_FUN_0048c7e0(CDemonRenderer * this_ptr, CVector3i * output)
        ;   XREF to: 0048c7e0 (UNCONDITIONAL_CALL)
    LEA ESI,[ESP + 0x54]                ; 004bf256
    ADD ESP,0x4                         ; 004bf25a
    MOVSD ES:EDI,ESI                    ; 004bf25d | CVector3i g_BillboardCameraRight
    ...
    MOV ESI,dword ptr [0x00823a74]      ; 004bf268 | CDemonCamera * g_CurrentSceneCamera
    ...
    FLD double ptr [0x00629c03]         ; 004bf289 | double DOUBLE_00629c03
    ...
    FMULP ST3                           ; 004bf29f
    FXCH                                ; 004bf2a1
    CALL crt_math.c_round_FUN_005fe6b0  ; 004bf2a3 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH                                ; 004bf2a8
    CALL crt_math.c_round_FUN_005fe6b0  ; 004bf2aa | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH ST2                            ; 004bf2af
    CALL crt_math.c_round_FUN_005fe6b0  ; 004bf2b1 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH                                ; 004bf2b6
    FISTP dword ptr [0x02d12dc0]        ; 004bf2b8 | CVector3i g_BillboardCameraUp
    FXCH                                ; 004bf2be
