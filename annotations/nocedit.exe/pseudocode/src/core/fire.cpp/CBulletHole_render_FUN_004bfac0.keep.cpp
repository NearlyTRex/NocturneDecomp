...

{
  ...
  engine_drender_cpp_CDemonRenderer_applyScaledTransform_FUN_0048c4f0
            (g_CDemonRendererPtr2,&this_ptr->euler_angles,translation);
  iVar2 = (this_ptr->texture_index & 1U) * (0x80 << 16);
  g_RenderVertexBuffer[0].u = iVar2 + (0x8 << 16);
  iVar1 = (this_ptr->texture_index & 2U) * (0x40 << 16);
  g_RenderVertexBuffer[1].u = iVar2 + (0x78 << 16);
  g_RenderVertexBuffer[0].v = iVar1 + (0x78 << 16);
  g_RenderVertexBuffer[2].v = iVar1 + (0x8 << 16);
