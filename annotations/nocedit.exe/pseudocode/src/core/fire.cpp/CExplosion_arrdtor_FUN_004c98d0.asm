...
;                               FUNCTION
; *****************************************************************************
; __cdecl CExplosion * __cdecl core_fire_cpp_CExplosion_arrdtor_FUN_004c98d0(CExplosion *objs,uint flags)
;
; Parameters:
...
section .text
    ...
    PUSH 0x65def0                       ; 004c98d0 | g_CExplosionTypeInfo
        ;   Label: core_fire.cpp_CExplosion_arrdtor_FUN_004c98d0
    PUSH 0xa                            ; 004c98d5
