...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_fire.cpp_CFireEffect_FUN_004c9240(CFireEffect * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH ESI                            ; 004c9241
    PUSH EBP                            ; 004c9242
    MOV EAX,[0x02d736bc]                ; 004c9243 | CShell * g_CFireEffectShellsEnd
    ...
    PUSH EBX                            ; 004c925b
    ADD EAX,0x2d736c0                   ; 004c925c | CPopcorn[256] g_PopcornPool
    PUSH EAX                            ; 004c9261
    MOV EDX,dword ptr [EAX + 0x34]      ; 004c9262 | DAT_02d736f4
    CALL dword ptr [EDX]                ; 004c9265
    MOV ESI,dword ptr [0x02d736bc]      ; 004c9267 | CShell * g_CFireEffectShellsEnd
    INC ESI                             ; 004c926d
    ADD ESP,0xc                         ; 004c926e
    MOV dword ptr [0x02d736bc],ESI      ; 004c9271 | CShell * g_CFireEffectShellsEnd
    CMP ESI,0x100                       ; 004c9277
    JGE 0x004c9283                      ; 004c927d | LAB_004c9283
    ...
    XOR EBP,EBP                         ; 004c9283
        ;   Label: LAB_004c9283
    MOV dword ptr [0x02d736bc],EBP      ; 004c9285 | CShell * g_CFireEffectShellsEnd
    POP EBP                             ; 004c928b
    POP ESI                             ; 004c928c
    POP EBX                             ; 004c928d
    RET                                 ; 004c928e
