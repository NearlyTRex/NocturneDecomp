...
section .text
    ...
    PUSH EDX                            ; 004c94c4
    CALL core_particle.cpp_CParticle_ctor_FUN_00545650 ; 004c94c5 | CParticle * core_particle.cpp_CParticle_ctor_FUN_00545650(CParticle * this_ptr)
        ;   XREF to: 00545650 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004c94ca
    MOV dword ptr [EAX + 0x34],0x65dcf4 ; 004c94cd | CParticle_vtable g_CPopcornVTable
    RET                                 ; 004c94d4
