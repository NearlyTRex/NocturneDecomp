...
// Convention: __cdecl
// Signature: CFireball * __cdecl core_fire_cpp_CFireball_arrdtor_FUN_004c9930(CFireball *this_ptr,uint flags)
...

{
  ...
  pCVar1 = (CFireball *)__arrfini(this_ptr,0x40,&g_CFireballTypeInfo);
  return pCVar1;
}
