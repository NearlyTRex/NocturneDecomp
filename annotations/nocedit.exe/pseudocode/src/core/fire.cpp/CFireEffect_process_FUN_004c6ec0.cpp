...

{
  ...
  core_fire_cpp_updateTextureAnimCounts_FUN_004c3870();
  do {
  ...
  } while (this_ptr_01 != (CSpark *)&g_MuzzleFlashAllocIndex);
  ...
  } while (this_ptr_02 != (CMuzzleFlash *)&g_GlassParticleAllocIndex);
  iVar2 = 0;
  ...
  } while (this_ptr_04 != (CGlassParticle *)&g_BulletTrailAllocIndex);
  ...
  } while (this_ptr_05 != (CBulletTrail *)&g_FireballAllocIndex);
  ...
  } while (this_ptr_06 != (CFireball *)&g_RockAllocIndex);
  ...
  } while (this_ptr_07 != (CRock *)&g_LaserBeamActiveCount);
  iVar2 = 0;
  ...
  } while (this_ptr_10 != (CCrater *)&g_GunFlameAllocIndex);
