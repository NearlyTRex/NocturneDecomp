...
;
; Called Functions:
;   core_fire.cpp_CLightningBolt_activateDirectional_FUN_004c5680
...
section .text
    ...
    PUSH EBX                            ; 004c8fd0
        ;   Label: core_fire.cpp_CFireEffect_createLightningBoltDirectional_FUN_004c8fd0
    PUSH dword ptr [ESP + 0x1c]         ; 004c8fd1
    MOV EDX,dword ptr [ESP + 0x14]      ; 004c8fd5
    PUSH dword ptr [ESP + 0x1c]         ; 004c8fd9
    PUSH EDX                            ; 004c8fdd
    MOV EDX,dword ptr [0x02d715b8]      ; 004c8fde | g_LightningBoltAllocIndex
    ...
    PUSH EAX                            ; 004c8fff
    CALL core_fire.cpp_CLightningBolt_activateDirectional_FUN_004c5680 ; 004c9000
        ;   XREF to: 004c5680 (UNCONDITIONAL_CALL)  ; void core_fire.cpp_CLightningBolt_activateDirectional_FUN_004c5680(CLightningBolt * this_ptr, CVector3f * start_position, CVector3f * end_position, float end_width, ...)
    MOV EBX,dword ptr [0x02d715b8]      ; 004c9005 | g_LightningBoltAllocIndex
    INC EBX                             ; 004c900b
    ADD ESP,0x14                        ; 004c900c
    MOV dword ptr [0x02d715b8],EBX      ; 004c900f | g_LightningBoltAllocIndex
    ...
    MOV dword ptr [0x02d715b8],EDI      ; 004c9026 | g_LightningBoltAllocIndex
    POP EDI                             ; 004c902c
