...
;                               FUNCTION
; *****************************************************************************
; __cdecl CToss * __cdecl core_fire_cpp_CToss_ctor_FUN_004c3ea0(CToss *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 004c3ea7
    CALL core_dmodel.cpp_CKeyFramedModelInstance_ctor_FUN_00478ce0 ; 004c3ea8
    ...
    PUSH EAX                            ; 004c3eb5
    CALL core_box.cpp_CBox_ctor_FUN_0041dc50 ; 004c3eb6
