...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_fire.cpp_CBulletHole_process_FUN_004bfa00(CBulletHole * this_ptr)
;
; Parameters:
...
section .text
    ...
    JNZ 0x004bfa14                      ; 004bfa0d | LAB_004bfa14
    ...
    PUSH EAX                            ; 004bfa1c
    PUSH EDX                            ; 004bfa1d
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 004bfa1e | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
        ;   XREF to: 00408ec0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004bfa23
    CMP EBX,EAX                         ; 004bfa26
    JZ 0x004bfa0f                       ; 004bfa28 | LAB_004bfa0f
