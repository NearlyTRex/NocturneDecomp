...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_fire.cpp_CFireEffect_FUN_004c7a60(CFireEffect * this_ptr)
;
; Parameters:
...
;   core_gun.cpp_FUN_004f0350 at 004f0596
...
section .text
    ...
    PUSH EDI                            ; 004c7a61
    MOV EDX,dword ptr [0x02d58a00]      ; 004c7a62 | int g_SparkActiveCount
    ...
    INC EDX                             ; 004c7a79
    ADD EAX,0x2d58a04                   ; 004c7a7a | CMuzzleFlash[20] g_MuzzleFlashPool
    MOV dword ptr [0x02d58a00],EDX      ; 004c7a7f | int g_SparkActiveCount
    CMP EDX,0x14                        ; 004c7a85
    JL 0x004c7a94                       ; 004c7a88 | LAB_004c7a94
        ;   XREF to: 004c7a94 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 004c7a8a
    XOR EBX,EBX                         ; 004c7a8b
    MOV dword ptr [0x02d58a00],EBX      ; 004c7a8d | int g_SparkActiveCount
    POP EBX                             ; 004c7a93
    ...
    PUSH EDI                            ; 004c7a9d
    PUSH EAX                            ; 004c7a9e
    CALL core_fire.cpp_FUN_004c1940     ; 004c7a9f | undefined core_fire.cpp_FUN_004c1940()
