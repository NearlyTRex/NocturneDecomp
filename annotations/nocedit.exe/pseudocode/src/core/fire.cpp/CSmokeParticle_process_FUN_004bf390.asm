...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_fire.cpp_CSmokeParticle_process_FUN_004bf390(CSmokeParticle * this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EAX,[0x0067b654]                ; 004bf398 | CGame * g_CGamePtr
    ...
    CALL core_actor.cpp_getRandomFloat_FUN_0040cc10 ; 004bf3e5 | float core_actor.cpp_getRandomFloat_FUN_0040cc10(float min_value, float max_value)
