...
section .text
    ...
    PUSH 0x65de90                       ; 004c9930 | WatcomTypeInfo g_CFireballTypeInfo
        ;   Label: core_fire.cpp_freeFireballs_FUN_004c9930
    PUSH 0x40                           ; 004c9935
    MOV EDX,dword ptr [ESP + 0xc]       ; 004c9937
    PUSH EDX                            ; 004c993b
    CALL crt_memory.c_freeTypeArray_FUN_005feee9 ; 004c993c | int crt_memory.c_freeTypeArray_FUN_005feee9(void * * obj_array, int obj_count, WatcomTypeInfo * type_info)
