// Name: core_fire.cpp_loadGunFlameAssets_FUN_004c4d50
// Address: 004c4d50
// Address Range: [[004c4d50, 004c4d9a]]
// Convention: __cdecl
// Signature: void __cdecl core_fire_cpp_loadGunFlameAssets_FUN_004c4d50(void)
...

{
  ...
  do {
    ...
    _sprintf(buffer,"fr46%03d.raw",iVar2);
    iVar2 = iVar2 + 1;
    buffer = buffer + 0x18;
    iVar1 = iVar1 + 1;
