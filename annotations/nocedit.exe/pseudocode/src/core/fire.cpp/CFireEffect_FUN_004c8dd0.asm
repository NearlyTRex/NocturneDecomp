...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_fire.cpp_CFireEffect_FUN_004c8dd0(CFireEffect * this_ptr)
;
; Parameters:
...
section .text
    ...
    FCOMP double ptr [0x0062a0b3]       ; 004c8dd8 | double DOUBLE_0062a0b3
    FNSTSW AX                           ; 004c8dde
    SAHF                                ; 004c8de0
    JNC 0x004c8deb                      ; 004c8de1 | LAB_004c8deb
    ...
    PUSH EDI                            ; 004c8e04
    CALL core_fire.cpp_CFireEffect_FUN_004c8e40 ; 004c8e05 | int core_fire.cpp_CFireEffect_FUN_004c8e40(CFireEffect * this_ptr)
    ...
    MOV EDX,0x2d678d0                   ; 004c8e1d | CToss[20] g_TossPool
    ADD EDX,EAX                         ; 004c8e22
    ADD EDX,0x180                       ; 004c8e24
    PUSH EDX                            ; 004c8e2a
    MOV EBP,dword ptr [EAX + 0x2d67cb0] ; 004c8e2b | DAT_02d67cb0
    PUSH EBP                            ; 004c8e31
    CALL sound_sndmain.cpp_setSfxTrackedFloatPosition_FUN_005a98b0 ; 004c8e32 | int sound_sndmain.cpp_setSfxTrackedFloatPosition_FUN_005a98b0(uint sfx_handle, CVector3f * position_source_ptr)
