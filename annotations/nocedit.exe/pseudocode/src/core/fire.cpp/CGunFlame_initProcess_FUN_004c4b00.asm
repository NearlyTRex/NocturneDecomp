...
section .text
    ...
    JZ 0x004c4b8c                       ; 004c4b6c
        ;   XREF to: 004c4b8c (CONDITIONAL_JUMP)  ; LAB_004c4b8c
    CMP dword ptr [0x02d13eb4],0x32     ; 004c4b6e | DAT_02d13eb4
    JGE 0x004c4b95                      ; 004c4b75
        ;   XREF to: 004c4b95 (CONDITIONAL_JUMP)  ; LAB_004c4b95
    MOV EAX,[0x02d13eb4]                ; 004c4b77 | DAT_02d13eb4
        ;   Label: LAB_004c4b77
    LEA ECX,[EAX + 0x1]                 ; 004c4b7c
    MOV dword ptr [EAX*0x4 + 0x2d13eb8],EBX ; 004c4b7f | DAT_02d13eb8
    MOV dword ptr [0x02d13eb4],ECX      ; 004c4b86 | DAT_02d13eb4
    INC EDI                             ; 004c4b8c
        ;   Label: LAB_004c4b8c
    ...
    MOV ECX,dword ptr [0x02d13f80]      ; 004c4bd4 | DAT_02d13f80
    CMP ECX,0x96                        ; 004c4bda
    JGE 0x004c4bf2                      ; 004c4be0
        ;   XREF to: 004c4bf2 (CONDITIONAL_JUMP)  ; LAB_004c4bf2
    LEA EDI,[ECX + 0x1]                 ; 004c4be2
    MOV dword ptr [ECX*0x4 + 0x2d13f84],EAX ; 004c4be5 | DAT_02d13f84
    MOV dword ptr [0x02d13f80],EDI      ; 004c4bec | DAT_02d13f80
    INC EBX                             ; 004c4bf2
        ;   Label: LAB_004c4bf2
