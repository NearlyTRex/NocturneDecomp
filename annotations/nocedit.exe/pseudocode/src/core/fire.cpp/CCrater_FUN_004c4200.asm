...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_fire.cpp_CCrater_FUN_004c4200(CCrater * this_ptr)
;
; Parameters:
...
;
; XREF[1]:
;   core_fire.cpp_CFireEffect_FUN_004c8ea0 at 004c8ebe
;
; Referenced Globals:
...
section .text
    ...
    JZ 0x004c4229                       ; 004c4217 | LAB_004c4229
    ...
    PUSH ESI                            ; 004c4229
        ;   Label: LAB_004c4229
    CALL core_fire.cpp_CCrater_render_FUN_004c4620 ; 004c422a | void core_fire.cpp_CCrater_render_FUN_004c4620(CCrater * this_ptr)
    ...
    PUSH EAX                            ; 004c423d
    MOV EDX,dword ptr [0x006810c8]      ; 004c423e | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
    MOV dword ptr [ESI + 0x4],0x0       ; 004c4244
    PUSH EDX                            ; 004c424b | CDemonSet g_CDemonSetInstance
    MOV dword ptr [ESI + 0x8],0x3dcccccd ; 004c424c
    MOV EBX,ESI                         ; 004c4253
    CALL core_setcolid.cpp_CDemonSet_processCollisionTypes_FUN_005716b0 ; 004c4255 | float core_setcolid.cpp_CDemonSet_processCollisionTypes_FUN_005716b0(CDemonSet * this_ptr, CVector3f * position, float radius)
    ...
    CALL core_actor.cpp_getRandomFloat_FUN_0040cc10 ; 004c4283 | float core_actor.cpp_getRandomFloat_FUN_0040cc10(float min_value, float max_value)
