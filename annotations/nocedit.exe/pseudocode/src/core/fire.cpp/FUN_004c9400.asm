...
section .text
    ...
    FMUL float ptr [0x0065dca8]         ; 004c940c | float FLOAT_0065dca8
    FISTP dword ptr [EBX]               ; 004c9412
    FLD float ptr [EAX + 0x4]           ; 004c9414
    FMUL float ptr [0x0065dca8]         ; 004c9417 | float FLOAT_0065dca8
    FISTP dword ptr [EBX + 0x4]         ; 004c941d
    FLD float ptr [EAX + 0x8]           ; 004c9420
    FMUL float ptr [0x0065dca8]         ; 004c9423 | float FLOAT_0065dca8
    FISTP dword ptr [EBX + 0x8]         ; 004c9429
    MOV EBX,ESP                         ; 004c942c
    PUSH EBX                            ; 004c942e
    MOV EDX,dword ptr [ESP + 0x1c]      ; 004c942f
    PUSH EDX                            ; 004c9433
    CALL wincore_windll.cpp_transformPoint_FUN_005b5a25 ; 004c9434 | int wincore_windll.cpp_transformPoint_FUN_005b5a25(SProjectedVertex * output, CVector3i * input)
