...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_fire.cpp_FUN_004c2170()
;
;
; XREF[1]:
...
section .text
    ...
    JMP 0x004c2181                      ; 004c21af | LAB_004c2181
    ...
    JMP 0x004c2188                      ; 004c21c1 | LAB_004c2188
