...
section .text
    ...
    JL 0x004c1a13                       ; 004c1a0b | LAB_004c1a13
        ;   XREF to: 004c1a13 (CONDITIONAL_JUMP)
    CMP EDX,0x1                         ; 004c1a0d
    JZ 0x004c1a1a                       ; 004c1a10 | LAB_004c1a1a
    ...
    PUSH EAX                            ; 004c1a1e
    MOV ESI,dword ptr [0x0067a3d0]      ; 004c1a1f | CFireEffect * g_CFireEffectPtr
    PUSH ESI                            ; 004c1a25 | CFireEffect g_CFireEffectInstance
    CALL core_fire.cpp_CFireEffect_FUN_004c7620 ; 004c1a26 | void core_fire.cpp_CFireEffect_FUN_004c7620(CFireEffect * this_ptr)
