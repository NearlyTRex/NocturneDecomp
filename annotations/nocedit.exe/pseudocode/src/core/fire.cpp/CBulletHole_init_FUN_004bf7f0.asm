...
section .text
    ...
    JMP 0x03fc453e                      ; 004bf95b
        ;   XREF to: 03fc453e (UNCONDITIONAL_JUMP)  ; LAB_03fc453e
    ...
    POP EBX                             ; 004bf9f3
    RET                                 ; 004bf9f4
    MOV ECX,0xc                         ; 03fc453e
        ;   Label: LAB_03fc453e
    PUSH EAX                            ; 03fc4543
    LEA EAX,[ESP + 0x64]                ; 03fc4544
    LEA ESI,[ESP + 0x94]                ; 03fc4548
    PUSH EAX                            ; 03fc454f
    MOV ECX,dword ptr [ESI]             ; 03fc4550
    MOV dword ptr [EDI],ECX             ; 03fc4552
    MOV ECX,dword ptr [ESI + 0x4]       ; 03fc4554
    MOV dword ptr [EDI + 0x4],ECX       ; 03fc4557
    MOV ECX,dword ptr [ESI + 0x8]       ; 03fc455a
    MOV dword ptr [EDI + 0x8],ECX       ; 03fc455d
    MOV ECX,dword ptr [ESI + 0xc]       ; 03fc4560
    MOV dword ptr [EDI + 0xc],ECX       ; 03fc4563
    MOV ECX,dword ptr [ESI + 0x10]      ; 03fc4566
    MOV dword ptr [EDI + 0x10],ECX      ; 03fc4569
    MOV ECX,dword ptr [ESI + 0x14]      ; 03fc456c
    MOV dword ptr [EDI + 0x14],ECX      ; 03fc456f
    MOV ECX,dword ptr [ESI + 0x18]      ; 03fc4572
    MOV dword ptr [EDI + 0x18],ECX      ; 03fc4575
    MOV ECX,dword ptr [ESI + 0x1c]      ; 03fc4578
    MOV dword ptr [EDI + 0x1c],ECX      ; 03fc457b
    MOV ECX,dword ptr [ESI + 0x20]      ; 03fc457e
    MOV dword ptr [EDI + 0x20],ECX      ; 03fc4581
    MOV ECX,dword ptr [ESI + 0x24]      ; 03fc4584
    MOV dword ptr [EDI + 0x24],ECX      ; 03fc4587
    MOV ECX,dword ptr [ESI + 0x28]      ; 03fc458a
    MOV dword ptr [EDI + 0x28],ECX      ; 03fc458d
    MOV ECX,dword ptr [ESI + 0x2c]      ; 03fc4590
    MOV dword ptr [EDI + 0x2c],ECX      ; 03fc4593
    ADD ESI,0x30                        ; 03fc4596
    ADD EDI,0x30                        ; 03fc4599
    XOR ECX,ECX                         ; 03fc459c
    JMP 0x004bf96f                      ; 03fc459e
        ;   XREF to: 004bf96f (UNCONDITIONAL_JUMP)  ; LAB_004bf96f
