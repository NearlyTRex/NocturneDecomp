...
;   undefined4 g_SparkPool[1].base.position.x
...
section .text
    ...
    MOV EAX,dword ptr [EBX]             ; 004c6ee1 | g_SmokeParticlePool | g_SmokeParticlePool[1].active
        ;   Label: LAB_004c6ee1
    TEST EAX,EAX                        ; 004c6ee3
    JNZ 0x004c7170                      ; 004c6ee5
        ;   XREF to: 004c7170 (CONDITIONAL_JUMP)  ; LAB_004c7170
    ADD EBX,0x2c                        ; 004c6eeb | g_SmokeParticlePool[1].active
        ;   Label: LAB_004c6eeb
    ...
    FLD float ptr [EBX + 0x18]          ; 004c6efd | g_SparkPool[0].base.lifetime_remaining | g_SparkPool[1].base.lifetime_remaining
        ;   Label: LAB_004c6efd
    FLDZ                                ; 004c6f00
    FCOMPP                              ; 004c6f02
    FNSTSW AX                           ; 004c6f04
    ...
    PUSH EBX                            ; 004c6f09 | g_SparkPool | g_SparkPool[1].base.position.x
    MOV EAX,dword ptr [EBX + 0x34]      ; 004c6f0a | g_SparkPool[0].base.vtable | g_SparkPool[1].base.vtable
    ...
    MOV EAX,dword ptr [EBX]             ; 004c6f25 | g_MuzzleFlashPool | g_MuzzleFlashPool[1].frames_remaining
        ;   Label: LAB_004c6f25
    TEST EAX,EAX                        ; 004c6f27
    JZ 0x004c6f34                       ; 004c6f29
        ;   XREF to: 004c6f34 (CONDITIONAL_JUMP)  ; LAB_004c6f34
    PUSH EBX                            ; 004c6f2b | g_MuzzleFlashPool | g_MuzzleFlashPool[1].frames_remaining
    ...
    ADD EBX,0x5c                        ; 004c6f34 | g_MuzzleFlashPool[1].frames_remaining
        ;   Label: LAB_004c6f34
    ...
    MOV EAX,dword ptr [EBX + 0x258]     ; 004c6f4c | g_StakePool[0].physics_box.is_valid | g_StakePool[1].physics_box.is_valid
        ;   Label: LAB_004c6f4c
    TEST EAX,EAX                        ; 004c6f52
    JZ 0x004c6f5f                       ; 004c6f54
        ;   XREF to: 004c6f5f (CONDITIONAL_JUMP)  ; LAB_004c6f5f
    PUSH EBX                            ; 004c6f56 | g_StakePool | g_StakePool[1].active
    ...
    MOV EDI,dword ptr [0x02d2ddf4]      ; 004c6f5f | g_StakeActiveCount
        ;   Label: LAB_004c6f5f
    INC ESI                             ; 004c6f65
    ADD EBX,0x260                       ; 004c6f66 | g_StakePool[1].active
    ...
    FLD float ptr [EBX + 0x18]          ; 004c6f7b | g_GlassParticlePool[0].base.lifetime_remaining | g_GlassParticlePool[1].base.lifetime_remaining
        ;   Label: LAB_004c6f7b
    FLDZ                                ; 004c6f7e
    FCOMPP                              ; 004c6f80
    FNSTSW AX                           ; 004c6f82
    ...
    PUSH EBX                            ; 004c6f87 | g_GlassParticlePool | g_GlassParticlePool[1].base.position.x
    MOV EAX,dword ptr [EBX + 0x34]      ; 004c6f88 | g_GlassParticlePool[0].base.vtable | g_GlassParticlePool[1].base.vtable
    ...
    MOV EAX,dword ptr [EBX + 0x20]      ; 004c6fa6 | g_BulletTrailPool[0].frames_remaining | g_BulletTrailPool[1].frames_remaining
        ;   Label: LAB_004c6fa6
    TEST EAX,EAX                        ; 004c6fa9
    JZ 0x004c6fb6                       ; 004c6fab
        ;   XREF to: 004c6fb6 (CONDITIONAL_JUMP)  ; LAB_004c6fb6
    PUSH EBX                            ; 004c6fad | g_BulletTrailPool | g_BulletTrailPool[1].start_position.x
    ...
    ADD EBX,0x24                        ; 004c6fb6 | g_BulletTrailPool[1].start_position.x
        ;   Label: LAB_004c6fb6
    ...
    FLD float ptr [EBX + 0x18]          ; 004c6fc8 | g_FireballPool[0].base.lifetime_remaining | g_FireballPool[1].base.lifetime_remaining
        ;   Label: LAB_004c6fc8
    FLDZ                                ; 004c6fcb
    FCOMPP                              ; 004c6fcd
    FNSTSW AX                           ; 004c6fcf
    ...
    PUSH EBX                            ; 004c6fd4 | g_FireballPool | g_FireballPool[1].base.position.x
    MOV EAX,dword ptr [EBX + 0x34]      ; 004c6fd5 | g_FireballPool[0].base.vtable | g_FireballPool[1].base.vtable
    ...
    FLD float ptr [EBX + 0x18]          ; 004c6ff3 | g_RockPool[0].base.lifetime_remaining | g_RockPool[1].base.lifetime_remaining
        ;   Label: LAB_004c6ff3
    FLDZ                                ; 004c6ff6
    FCOMPP                              ; 004c6ff8
    FNSTSW AX                           ; 004c6ffa
    ...
    PUSH EBX                            ; 004c6fff | g_RockPool | g_RockPool[1].base.position.x
    MOV EAX,dword ptr [EBX + 0x34]      ; 004c7000 | g_RockPool[0].base.vtable | g_RockPool[1].base.vtable
    ...
    PUSH ESI                            ; 004c7020 | g_BulletHolePool | g_BulletHolePool[1].position.x
        ;   Label: LAB_004c7020
    ...
    PUSH EBX                            ; 004c704b | g_ExplosionPool | g_ExplosionPool[1].position.x
        ;   Label: LAB_004c704b
    ...
    ADD EBX,0x1c                        ; 004c7051 | g_ExplosionPool[1].position.x
    ...
    PUSH EBX                            ; 004c7066 | g_TossPool | g_TossPool[1].toss_type
        ;   Label: LAB_004c7066
    ...
    ADD EBX,0x3e4                       ; 004c706c | g_TossPool[1].toss_type
    ...
    PUSH EBX                            ; 004c7084 | g_CraterPool | g_CraterPool[1].active
        ;   Label: LAB_004c7084
    ...
    ADD EBX,0x70                        ; 004c708a | g_CraterPool[1].active
    ...
    TEST dword ptr [EBX],0x7fffffff     ; 004c70a1 | g_GunFlamePool | g_GunFlamePool[1].lifetime
        ;   Label: LAB_004c70a1
    ...
    PUSH EBX                            ; 004c70b7 | g_GunFlamePool | g_GunFlamePool[1].lifetime
        ;   Label: LAB_004c70b7
    ...
    ADD EBX,0x24                        ; 004c70c0 | g_GunFlamePool[1].lifetime
        ;   Label: LAB_004c70c0
    ...
    PUSH EBX                            ; 004c70d2 | g_LightningBoltPool | g_LightningBoltPool[1].mode
        ;   Label: LAB_004c70d2
    ...
    ADD EBX,0x2c                        ; 004c70d8 | g_LightningBoltPool[1].mode
    ...
    PUSH EBX                            ; 004c70ed | g_TrailPool | g_TrailPool[1].position.x
        ;   Label: LAB_004c70ed
    ...
    ADD EBX,0x24                        ; 004c70f3 | g_TrailPool[1].position.x
    ...
    PUSH EBX                            ; 004c7108 | g_ShellPool | g_ShellPool[1].base.position.x
        ;   Label: LAB_004c7108
    MOV EAX,dword ptr [EBX + 0x34]      ; 004c7109 | g_ShellPool[0].base.vtable | g_ShellPool[1].base.vtable
    ...
    FLD float ptr [EBX + 0x18]          ; 004c7124 | g_PopcornPool[0].base.lifetime_remaining | g_PopcornPool[1].base.lifetime_remaining
        ;   Label: LAB_004c7124
    FLDZ                                ; 004c7127
    FCOMPP                              ; 004c7129
    FNSTSW AX                           ; 004c712b
    ...
    PUSH EBX                            ; 004c7130 | g_PopcornPool | g_PopcornPool[1].base.position.x
    MOV EAX,dword ptr [EBX + 0x34]      ; 004c7131 | g_PopcornPool[0].base.vtable | g_PopcornPool[1].base.vtable
    ...
    FLD float ptr [EBX + 0x18]          ; 004c714c | g_RainDropPool[0].base.lifetime_remaining | g_RainDropPool[1].base.lifetime_remaining
        ;   Label: LAB_004c714c
    FLDZ                                ; 004c714f
    FCOMPP                              ; 004c7151
    FNSTSW AX                           ; 004c7153
    ...
    PUSH EBX                            ; 004c7158 | g_RainDropPool | g_RainDropPool[1].base.position.x
    MOV EAX,dword ptr [EBX + 0x34]      ; 004c7159 | g_RainDropPool[0].base.vtable | g_RainDropPool[1].base.vtable
    ...
    POP EBX                             ; 004c716e
    RET                                 ; 004c716f
    PUSH EBX                            ; 004c7170 | g_SmokeParticlePool | g_SmokeParticlePool[1].active
        ;   Label: LAB_004c7170
