...

{
  ...
  if (this_ptr->field0_0x0 + 0xc != (char *)in_stack_0000000c) {
    ...
    *(uint *)(this_ptr->field0_0x0 + 0x10) = in_stack_0000000c[1];
    *(uint *)(this_ptr->field0_0x0 + 0x14) = in_stack_0000000c[2];
  }
  *(uint *)(this_ptr->field0_0x0 + 0x18) = in_stack_00000010;
  *(uint *)(this_ptr->field0_0x0 + 0x1c) = in_stack_00000014;
  if ((0.0 < *(float *)(this_ptr->field0_0x0 + 0x1c)) &&
    ...
    *(uint *)(this_ptr->field0_0x0 + 0x24) = in_stack_00000018[1];
    *(uint *)(this_ptr->field0_0x0 + 0x28) = in_stack_00000018[2];
  }
  ...
  *(uint *)(this_ptr->field0_0x0 + 0x38) = in_stack_00000028;
  *(uint *)(this_ptr->field0_0x0 + 0x3c) = in_stack_0000002c;
  return;
}
