...
;                               FUNCTION
; *****************************************************************************
; __cdecl CCrater * core_fire.cpp_CCrater_dtor_FUN_004c95a0(CCrater * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 004c95a9
    CALL core_cloth.cpp_freeVectors_FUN_0043e460 ; 004c95aa | int core_cloth.cpp_freeVectors_FUN_0043e460(CVector3f * * array)
