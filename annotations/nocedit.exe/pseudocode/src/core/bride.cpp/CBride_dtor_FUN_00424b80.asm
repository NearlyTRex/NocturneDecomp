...
section .text
    ...
    PUSH EBX                            ; 00424b98
    CALL core_backgnd.cpp_freeFlames_FUN_00412720 ; 00424b99
    ...
    PUSH EAX                            ; 00424ba8
    CALL core_backgnd.cpp_freeFires_FUN_00412700 ; 00424ba9
    ...
    PUSH EAX                            ; 00424bb8
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 00424bb9
    ...
    PUSH EAX                            ; 00424bc8
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 00424bc9
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; int core_backgnd.cpp_cleanupVector_FUN_004126e0(CVector3f * * objs)
    ADD ESP,0x8                         ; 00424bce
    PUSH 0x0                            ; 00424bd1
    SUB EAX,0x1c8                       ; 00424bd3
    PUSH EAX                            ; 00424bd8
    CALL core_cloth.cpp_FUN_0043bf80    ; 00424bd9
    ...
    PUSH 0x65b590                       ; 00424c11 | g_CBrideTypeInfo
        ;   Label: LAB_00424c11
    PUSH EBX                            ; 00424c16
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 00424c17
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 00424c1c
    PUSH EAX                            ; 00424c1f
    CALL crt_memory.c_free_FUN_005fe659 ; 00424c20
    ...
    PUSH EAX                            ; 00424c2c
        ;   Label: LAB_00424c2c
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 00424c2d
