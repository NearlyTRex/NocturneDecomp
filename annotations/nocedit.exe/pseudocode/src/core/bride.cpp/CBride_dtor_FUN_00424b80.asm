...
;                               FUNCTION
; *****************************************************************************
; __cdecl CBride * __cdecl core_bride_cpp_CBride_dtor_FUN_00424b80(CBride *this_ptr,uint flags)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00424b98
    CALL core_armour.cpp_freeFlames_FUN_00412720 ; 00424b99
    ...
    PUSH EAX                            ; 00424ba8
    CALL core_armour.cpp_freeFires_FUN_00412700 ; 00424ba9
    ...
    PUSH EAX                            ; 00424bb8
    CALL core_armour.cpp_freeVectors_FUN_004126e0 ; 00424bb9
    ...
    PUSH EAX                            ; 00424bc8
    CALL core_armour.cpp_freeVectors_FUN_004126e0 ; 00424bc9
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; CVector3f * core_armour.cpp_freeVectors_FUN_004126e0(CVector3f * objs)
