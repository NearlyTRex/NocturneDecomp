...
section .text
    ...
    PUSH 0x2cf2bb8                      ; 00423701 | CDemonActorType g_CEnemyClassInfo
    PUSH 0x4                            ; 00423706
    MOV EDX,0xbf19999a                  ; 00423708
    PUSH 0x66e648                       ; 0042370d | int g_CBrideClassVersion
    ...
    PUSH 0x616a9d                       ; 0042372a | = "CBride" | s_CBride_00616a9d = CBride
    MOV dword ptr [0x00822c90],ECX      ; 0042372f | DAT_00822c90
    MOV dword ptr [0x00822c94],ESI      ; 00423735 | DAT_00822c94
    PUSH 0x822ca0                       ; 0042373b | CDemonActorType g_CBrideClassInfo
    MOV dword ptr [0x00822c98],ECX      ; 00423740 | DAT_00822c98
    MOV dword ptr [0x00822c9c],ECX      ; 00423746 | DAT_00822c9c
    CALL core_actor.cpp_registerActorClass_FUN_0040c2e0 ; 0042374c | CDemonActorType * core_actor.cpp_registerActorClass_FUN_0040c2e0(CDemonActorType * this_ptr, char * class_name, CDemonActor_FactoryFunc * factor_func, int * max_version, ...)
