...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_bride.cpp_staticInit_FUN_00423700(void)
;
;
; Referenced Globals:
...
section .text
    ...
    MOV dword ptr [0x00822c88],EDX      ; 0042371e | FLOAT_00822c88
    MOV dword ptr [0x00822c8c],ECX      ; 00423724 | FLOAT_00822c8c
    PUSH 0x616a9d                       ; 0042372a | = "CBride"
    MOV dword ptr [0x00822c90],ECX      ; 0042372f | FLOAT_00822c90
    MOV dword ptr [0x00822c94],ESI      ; 00423735 | FLOAT_00822c94
    PUSH 0x822ca0                       ; 0042373b | g_CBrideClassInfo
    MOV dword ptr [0x00822c98],ECX      ; 00423740 | FLOAT_00822c98
    MOV dword ptr [0x00822c9c],ECX      ; 00423746 | FLOAT_00822c9c
