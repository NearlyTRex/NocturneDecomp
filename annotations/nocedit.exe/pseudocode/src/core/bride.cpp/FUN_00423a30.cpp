...

{
  ...
  if (iVar5 != 0) {
      ...
      if (uVar1 == 0) {
        ...
        if (extraout_EAX_00 == 0) {
          ...
          if (*(int *)(in_stack_00000004->field6_0xbe38 + 4) != 0) {
            ...
            if ((iVar5 == 0) &&
              ...
              fVar6 = (float)(*((in_stack_00000004->base_character).base_actor.metadata.vtable)->
                               playSound)((CDemonActor *)in_stack_00000004,"ub-attack?.wav")
              ;
              in_stack_00000004[1].base_character.base_actor.orient.bank = fVar6;
            }
          }
        }
        else {
        ...
        if ((float)in_stack_00000004[1].base_character.base_actor.location.area_id <= 0.0) {
          ...
          if ((iVar5 == 0) &&
             (iVar5 = sound_sndmain_cpp_SoundLockKillBlah_FUN_005a9660(), iVar5 == 0)) {
            fVar6 = (float)(*((in_stack_00000004->base_character).base_actor.metadata.vtable)->
                             playSound)((CDemonActor *)in_stack_00000004,"ub-howl?.wav");
            in_stack_00000004[1].base_character.base_actor.orient.bank = fVar6;
          }
        }
        fVar6 = in_stack_00000004->speed;
        fVar3 = (float)DOUBLE_00616c2d;
        pCVar2 = (in_stack_00000004->base_character).base_actor.metadata.vtable;
        ...
        *(float *)((in_stack_00000004->base_character).field2_0x240c + 0x2c) =
             fVar6 * fVar3 * in_stack_00000008;
        (*pCVar2[1].getAllowedMeleeAttackTypes)((CDemonActor *)in_stack_00000004);
        if (*(int *)(in_stack_00000004->field6_0xbe38 + 4) == 0) {
          core_enemy_cpp_CEnemy_FUN_004a9fd0(in_stack_00000004);
          if (extraout_EAX == 0) {
            core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00();
    ...
    else if ((uVar1 == 0xe) && (in_stack_00000004->pool_me == 0)) {
      core_skeleton_cpp_CDeformableModelInstance_FUN_0059fa20();
      core_actor_cpp_CDemonActor_FUN_00408ec0((CDemonActor *)in_stack_00000004);
      core_gore_cpp_FUN_004ede30();
      (*((in_stack_00000004->base_character).base_actor.metadata.vtable)->spawnFlies)
    ...
    pCVar4 = &in_stack_00000004->base_character;
    ...
    *(undefined4 *)((in_stack_00000004->base_character).model.padding_0x0 + 0x2254) =
    ...
    (in_stack_00000004->base_character).base_actor.orient.bank =
         *(float *)((in_stack_00000004->base_character).field2_0x240c + 0xc) +
         (in_stack_00000004->base_character).base_actor.orient.bank;
    core_actor_cpp_CDemonActor_FUN_00408c10((CDemonActor *)in_stack_00000004);
    ...
    if (iVar5 != 0) {
      *(float *)((in_stack_00000004->base_character).field2_0x240c + 0x20) =
      ...
      if (*(int *)(iVar5 + 0x24) != 1) {
        local_ec = local_ec +
                   *(float *)((in_stack_00000004->base_character).model.padding_0x0 + 0x2254);
        local_e8 = local_e8 +
    ...
    if (in_stack_00000004->pool_me == 0) {
      ...
      if (*(int *)((in_stack_00000004->base_character).model.padding_0x0 +
                  *(int *)(in_stack_00000004[1].base_character.base_actor.actor_name + 8) * 4 +
                  0x2140) != 0) {
        core_charactr_cpp_CCharacter_FUN_0042b760(&in_stack_00000004->base_character);
      }
      core_charactr_cpp_CCharacter_FUN_0042b760(&in_stack_00000004->base_character);
      if (*(int *)((in_stack_00000004->base_character).model.padding_0x0 +
                  *(int *)(in_stack_00000004[1].base_character.base_actor.actor_name + 0x10) * 4 +
                  0x2140) != 0) {
        core_charactr_cpp_CCharacter_FUN_0042b760(&in_stack_00000004->base_character);
      }
...
// 00423beb: PUSH EAX
// 00423bec: PUSH ESI
// 00423bed: CALL core_skeleton.cpp_CDeformableModelInstance_FUN_0059fa20
...
// 00423bf9: PUSH EAX
// 00423bfa: PUSH EBX
// 00423bfb: CALL core_actor.cpp_CDemonActor_FUN_00408ec0
...
// 00423db7: CALL core_actor.cpp_FUN_0040cd10
...
// 004243b1: CALL core_actor.cpp_CDemonActor_FUN_00408c10
...
//   Label: LAB_00424471
// 00424477: PUSH EAX
// 00424478: CALL core_skeleton.cpp_CDeformableModelInstance_FUN_0059e020
