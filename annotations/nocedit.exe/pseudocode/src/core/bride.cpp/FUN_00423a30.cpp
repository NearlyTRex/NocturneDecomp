...

{
  ...
  if (iVar5 != 0) {
    if (0.0 <= (float)in_stack_00000004[1].base.base.location.area_id) {
      in_stack_00000004[1].base.base.location.area_id =
           (int)((float)in_stack_00000004[1].base.base.location.area_id - in_stack_00000008);
    }
    ...
    if (uVar2 < 5) {
      if (uVar2 == 0) {
        ...
        if (extraout_EAX_00 == 0) {
          ...
          if (*(int *)(in_stack_00000004->unk2 + 4) != 0) {
            ...
            iVar5 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660
                              ((uint)in_stack_00000004[1].base.base.orient.pitch);
            if ((iVar5 == 0) &&
               (iVar5 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660
                                  ((uint)in_stack_00000004[1].base.base.orient.bank), iVar5 == 0)) {
              fVar8 = (float)(*((in_stack_00000004->base).base.vtable._ub)->playSound)
                                       ((CDemonActor *)in_stack_00000004,"ub-attack?.wav");
              in_stack_00000004[1].base.base.orient.bank = fVar8;
            }
          }
        }
        else {
        ...
        if ((float)in_stack_00000004[1].base.base.location.area_id <= 0.0) {
          local_14 = core_actor_cpp_getRandomFloat_FUN_0040cc10(10.0,20.0);
          in_stack_00000004[1].base.base.location.area_id = (int)local_14;
          core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
        ...
        *(float *)((in_stack_00000004->base).unk1 + 0x2c) = fVar8 * fVar4 * in_stack_00000008;
        (*(pCVar3->_ue).field_4)();
        if (*(int *)(in_stack_00000004->unk2 + 4) == 0) {
          core_enemy_cpp_CEnemy_FUN_004a9fd0(in_stack_00000004);
          if (extraout_EAX == 0) {
          ...
          else if (((0 < iVar5) && (*(float *)in_stack_00000004->unk2 <= 0.0)) &&
                  (iVar5 = (**(code **)(*(int *)(*(int *)(in_stack_00000004->unk2 + 4) + 0x154) +
                                       0x108))(), iVar5 == 0)) {
      ...
      if (*(int *)(in_stack_00000004->unk2 + 4) == 0) {
        ...
        iVar5 = (**(code **)(*(int *)(*(int *)(in_stack_00000004->unk2 + 4) + 0x154) + 0x108))();
        if (iVar5 == 0) {
          ...
          *(float *)in_stack_00000004->unk2 = local_14;
          ...
          if (local_20 <= (float)3) {
            ...
            else if ((in_stack_00000004->base).model.part_visibility_flags
    ...
    if ((*(int *)(in_stack_00000004->unk2 + 4) != 0) && (0.0 <= local_18)) {
      fVar8 = in_stack_00000004->speed;
      fVar4 = (float)2.5;
      *(float *)((in_stack_00000004->base).unk1 + 0x2c) =
           in_stack_00000004->speed * (float)1.57079632675 * in_stack_00000008;
      *(float *)((in_stack_00000004->base).unk1 + 0x28) = in_stack_00000008 * fVar4 * fVar8;
      local_8c = 0;
      local_84 = local_18;
      local_88 = 0;
      (**(code **)(*(int *)(*(int *)(in_stack_00000004->unk2 + 4) + 0x154) + 0xbc))();
    ...
    (in_stack_00000004->base).base.orient.bank =
         *(float *)((in_stack_00000004->base).unk1 + 0xc) +
         (in_stack_00000004->base).base.orient.bank;
    ...
    if (iVar5 != 0) {
      *(float *)((in_stack_00000004->base).unk1 + 0x20) =
      ...
      local_ec = local_bc + *(float *)((in_stack_00000004->base).unk1 + 0x10);
      local_e8 = local_b8 + *(float *)((in_stack_00000004->base).unk1 + 0x14);
      local_e4 = local_b4 + *(float *)((in_stack_00000004->base).unk1 + 0x18);
      pSVar6 = core_motion_cpp_CMotionController_getCurrentMotion_FUN_0052dab0
                         (&(in_stack_00000004->base).model.motion_controller);
      if (pSVar6->state_index != 1) {
        local_ec = local_ec + (in_stack_00000004->base).model.accumulated_root_motion.x;
        local_e8 = local_e8 + (in_stack_00000004->base).model.accumulated_root_motion.y;
        local_e4 = local_e4 + (in_stack_00000004->base).model.accumulated_root_motion.z;
      }
    ...
    if (in_stack_00000004->pool_me == 0) {
      ...
      if ((in_stack_00000004->base).model.part_visibility_flags
          [*(int *)(in_stack_00000004[1].base.base.actor_name + 8)] != 0) {
        core_charactr_cpp_CCharacter_FUN_0042b760(&in_stack_00000004->base);
      }
      core_charactr_cpp_CCharacter_FUN_0042b760(&in_stack_00000004->base);
      if ((in_stack_00000004->base).model.part_visibility_flags
          [*(int *)(in_stack_00000004[1].base.base.actor_name + 0x10)] != 0) {
        core_charactr_cpp_CCharacter_FUN_0042b760(&in_stack_00000004->base);
      }
