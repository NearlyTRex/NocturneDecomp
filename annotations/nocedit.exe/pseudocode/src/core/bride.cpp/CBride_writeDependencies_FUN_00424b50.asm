...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_bride_cpp_CBride_writeDependencies_FUN_00424b50(CBride *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00424b50
        ;   Label: core_bride.cpp_CBride_writeDependencies_FUN_00424b50
    ...
    PUSH EAX                            ; 00424b71
    CALL core_skeledit.cpp_CDeformableModelInstance_writeDependencies_FUN_0058a260 ; 00424b72
