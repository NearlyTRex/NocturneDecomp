  ...
  if (iVar7 != 0) {
    ...
    if (uVar3 < 5) {
      if (uVar3 == 0) {
        ...
        if (extraout_EAX_00 == 0) {
          ...
          if (*(int *)((this_ptr->base).unk2 + 4) != 0) {
            ...
            iVar7 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660(*(uint *)(this_ptr->unk + 0x30));
            if ((iVar7 == 0) &&
               (iVar7 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660(*(uint *)(this_ptr->unk + 0x34))
               , iVar7 == 0)) {
              uVar10 = (*((this_ptr->base).base.base.vtable._ub)->playSound)
                                 ((CDemonActor *)this_ptr,"ub-attack?.wav");
              *(uint *)(this_ptr->unk + 0x34) = uVar10;
            }
          }
        }
        else {
        ...
        *(float *)((this_ptr->base).base.unk1 + 0x2c) = fVar2 * fVar5 * delta_time;
        ...
        if (*(int *)((this_ptr->base).unk2 + 4) == 0) {
          ...
          if (iVar7 < 0) {
            core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                  ...
                  (iVar7 = (**(code **)(*(int *)(*(int *)((this_ptr->base).unk2 + 4) + 0x154) +
                                       0x108))(), iVar7 == 0)) {
      ...
      if (iVar7 == 0) {
        ...
        iVar7 = (**(code **)(*(int *)(iVar7 + 0x154) + 0x108))();
        if (iVar7 == 0) {
            ...
            if ((local_4c < 1.0) || (2 < local_4c)) {
              ...
              if (((float)3 <= local_20) &&
                ...
                core_actor_cpp_CDemonActor_localToWorldPoint_FUN_00408ec0
                          ((CDemonActor *)this_ptr,&local_68,pCVar9);
              ...
              if ((this_ptr->base).base.model.part_visibility_flags[*(int *)(this_ptr->unk + 0x14)]
                ...
                pCVar9 = core_xform_cpp_transformVector3x4_FUN_005f4dc0
                                   (&local_80,(CVector3f *)&FLOAT_00822c94,
                                    ...
                                    [INT_00822ce4].m);
                core_actor_cpp_CDemonActor_localToWorldPoint_FUN_00408ec0
                          ((CDemonActor *)this_ptr,&local_b0,pCVar9);
                core_enemy_cpp_CEnemy_FUN_004a9880(&this_ptr->base);
              }
            }
            else {
      ...
      pCVar9 = core_skeleton_cpp_CDeformableModelInstance_getBoneWorldPosition_FUN_0059fa20
                         (pCVar1,&local_c8,0);
      core_actor_cpp_CDemonActor_localToWorldPoint_FUN_00408ec0
                ((CDemonActor *)this_ptr,&local_d4,pCVar9);
    ...
    if ((*(int *)((this_ptr->base).unk2 + 4) != 0) && (0.0 <= local_18)) {
      ...
      *(float *)((this_ptr->base).base.unk1 + 0x28) = delta_time * fVar5 * fVar2;
      local_8c = 0;
      local_84 = local_18;
      local_88 = 0;
      (**(code **)(*(int *)(*(int *)((this_ptr->base).unk2 + 4) + 0x154) + 0xbc))();
      ...
      if (iVar7 != 1) {
        ...
        (pCVar6->base).unk1[0xc] = '\0';
        (pCVar6->base).unk1[0xd] = '\0';
        (pCVar6->base).unk1[0xe] = '\0';
        (pCVar6->base).unk1[0xf] = '\0';
      }
    }
    ...
    (this_ptr->base).base.base.orient.bank =
         *(float *)((this_ptr->base).base.unk1 + 0xc) + (this_ptr->base).base.base.orient.bank;
    ...
    if (iVar7 != 0) {
      *(float *)((this_ptr->base).base.unk1 + 0x20) =
      ...
      local_ec = local_bc + *(float *)((this_ptr->base).base.unk1 + 0x10);
      local_e8 = local_b8 + *(float *)((this_ptr->base).base.unk1 + 0x14);
      local_e4 = local_b4 + *(float *)((this_ptr->base).base.unk1 + 0x18);
      pSVar8 = core_motion_cpp_CMotionController_getCurrentMotion_FUN_0052dab0
                         (&(this_ptr->base).base.model.motion_controller);
      if (pSVar8->state_index != 1) {
