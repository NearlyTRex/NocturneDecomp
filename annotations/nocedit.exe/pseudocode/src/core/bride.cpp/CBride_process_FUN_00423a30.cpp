  ...
  if (iVar7 != 0) {
    ...
    if (uVar3 < 5) {
      if (uVar3 == 0) {
        ...
        if (extraout_EAX_00 == 0) {
          ...
          if ((this_ptr->base).victim != (CDemonActor *)0x0) {
            ...
            iVar7 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660(*(uint *)(this_ptr->unk + 0x28));
            if ((iVar7 == 0) &&
               (iVar7 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660(*(uint *)(this_ptr->unk + 0x2c))
               , iVar7 == 0)) {
              uVar10 = (*((this_ptr->base).base.base.vtable._ub)->playSound)
                                 ((CDemonActor *)this_ptr,"ub-attack?.wav");
              *(uint *)(this_ptr->unk + 0x2c) = uVar10;
            }
          }
        }
        else {
        ...
        if (*(float *)(this_ptr->unk + 0x24) <= 0.0) {
          ...
          *(float *)(this_ptr->unk + 0x24) = local_14;
          core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
        ...
        (this_ptr->base).base.turn_speed = fVar2 * fVar6 * delta_time;
        ...
        if ((this_ptr->base).victim == (CDemonActor *)0x0) {
          ...
          if (iVar7 < 0) {
            core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                  ...
                  (iVar7 = (*(((((this_ptr->base).victim)->vtable)._uc)->_uc).cfunc8)(), iVar7 == 0)
                  ) {
      ...
      if (pCVar5 == (CDemonActor *)0x0) {
        ...
        iVar7 = (*(((pCVar5->vtable)._uc)->_uc).cfunc8)();
        if (iVar7 == 0) {
          ...
          *(float *)(this_ptr->base).unk2 = local_14;
          ...
          if (local_20 <= (float)3) {
            ...
            if ((local_4c < 1.0) || (2 < local_4c)) {
              ...
              if (((float)3 <= local_20) &&
                 ((local_44 <= 4 &&
                  ((this_ptr->base).base.model.part_visibility_flags[*(int *)(this_ptr->unk + 4)] !=
                   0)))) {
          ...
          if (local_1c <= (float)8) {
            ...
            if (((1.0 <= local_54) && (local_54 <= 2)) ||
               ((local_2c = (double)local_1c, (float)5 <= local_1c &&
                (local_2c <= 6)))) {
              if ((this_ptr->base).base.model.part_visibility_flags[*(int *)(this_ptr->unk + 0xc)]
                  != 0) {
    ...
    if (((this_ptr->base).victim != (CDemonActor *)0x0) && (0.0 <= local_18)) {
      ...
      (this_ptr->base).base.walk_step_speed = delta_time * fVar6 * fVar2;
      local_8c = 0;
      local_84 = local_18;
      local_88 = 0;
      pCVar5 = (this_ptr->base).victim;
