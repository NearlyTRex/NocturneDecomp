...
section .text
    ...
    FNSTSW AX                           ; 00424619
    SAHF                                ; 0042461b
    JNC 0x00424648                      ; 0042461c | default
        ;   XREF to: 00424648 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX],-0x1            ; 0042461e
    JNZ 0x00424648                      ; 00424621 | default
        ;   XREF to: 00424648 (CONDITIONAL_JUMP)
    CALL crt_stdlib.c_rand_FUN_005feb5c ; 00424623 | int crt_stdlib.c_rand_FUN_005feb5c()
    ...
    JA 0x00424648                       ; 00424637 | default
        ;   XREF to: 00424648 (CONDITIONAL_JUMP)
    JMP dword ptr [EDX*0x4 + 0x4245e8]  ; 00424639 | void * switchdataD_004245e8
        ;   Label: switchD
    ...
    JNZ 0x004247bc                      ; 00424652 | LAB_004247bc
    ...
    JNZ 0x00424678                      ; 00424666 | LAB_00424678
        ;   XREF to: 00424678 (CONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 00424668
    FLD ST0                             ; 0042466b
    FMUL double ptr [0x00616c75]        ; 0042466d | double DOUBLE_00616c75
    FSTP ST1                            ; 00424673
    FSTP float ptr [ESP]                ; 00424675
    MOV EAX,[0x0067b654]                ; 00424678 | CGame g_CGameInstance | CGame * g_CGamePtr
        ;   Label: LAB_00424678
    CMP dword ptr [EAX + 0x1e0],0x0     ; 0042467d | g_CGameInstance.field57_0x1e0
    JZ 0x0042468d                       ; 00424684 | LAB_0042468d
        ;   XREF to: 0042468d (CONDITIONAL_JUMP)
    MOV dword ptr [ESP],0x3f800000      ; 00424686
    MOV EAX,[0x0067b654]                ; 0042468d | CGame g_CGameInstance | CGame * g_CGamePtr
        ;   Label: LAB_0042468d
    MOV EDX,dword ptr [EAX + 0x14]      ; 00424692 | g_CGameInstance.blood_flag
    TEST EDX,EDX                        ; 00424695
    JNZ 0x0042469c                      ; 00424697 | LAB_0042469c
        ;   XREF to: 0042469c (CONDITIONAL_JUMP)
    MOV dword ptr [ESP],EDX             ; 00424699
    PUSH dword ptr [ESP]                ; 0042469c
        ;   Label: LAB_0042469c
    CALL core_actor.cpp_randomChance_FUN_0040cd10 ; 0042469f | int core_actor.cpp_randomChance_FUN_0040cd10(float probability_threshold)
        ;   XREF to: 0040cd10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004246a4
    TEST EAX,EAX                        ; 004246a7
    JZ 0x0042475f                       ; 004246a9 | LAB_0042475f
    ...
    PUSH EAX                            ; 004246c1
    CALL core_bodypart.cpp_CreateBodyPart_FUN_00418e10 ; 004246c2 | undefined core_bodypart.cpp_CreateBodyPart_FUN_00418e10()
    ...
    PUSH EDI                            ; 004246d5
    PUSH ESI                            ; 004246d6
    CALL core_charactr.cpp_CCharacter_FUN_0042bd30 ; 004246d7 | void core_charactr.cpp_CCharacter_FUN_0042bd30(CCharacter * this_ptr)
    ...
    JNZ 0x004246fe                      ; 004246e9 | LAB_004246fe
    ...
    PUSH EDI                            ; 004246f4
    PUSH ESI                            ; 004246f5
    CALL core_charactr.cpp_CCharacter_FUN_0042bd30 ; 004246f6 | void core_charactr.cpp_CCharacter_FUN_0042bd30(CCharacter * this_ptr)
        ;   XREF to: 0042bd30 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004246fb
    MOV EDI,dword ptr [ESI + 0xbec4]    ; 004246fe
        ;   Label: LAB_004246fe
    CMP EDI,dword ptr [EBX]             ; 00424704
    JNZ 0x0042471f                      ; 00424706 | LAB_0042471f
    ...
    PUSH EDX                            ; 00424715
    PUSH ESI                            ; 00424716
    CALL core_charactr.cpp_CCharacter_FUN_0042bd30 ; 00424717 | void core_charactr.cpp_CCharacter_FUN_0042bd30(CCharacter * this_ptr)
        ;   XREF to: 0042bd30 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0042471c
    PUSH 0x616c69                       ; 0042471f | = "limb?.wav" | s_limb_wav_00616c69 = limb?.wav
        ;   Label: LAB_0042471f
    PUSH ESI                            ; 00424724
    CALL core_charactr.cpp_CCharacter_FUN_0042f300 ; 00424725 | void core_charactr.cpp_CCharacter_FUN_0042f300(CCharacter * this_ptr)
        ;   XREF to: 0042f300 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0042472a
    MOV ECX,dword ptr [ESP + 0xc]       ; 0042472d
    PUSH ECX                            ; 00424731
    CALL core_bodypart.cpp_FUN_0041a050 ; 00424732 | undefined core_bodypart.cpp_FUN_0041a050()
    ...
    JZ 0x004247f1                       ; 00424749 | LAB_004247f1
        ;   XREF to: 004247f1 (CONDITIONAL_JUMP)
    FLD float ptr [EBX + 0x8]           ; 0042474f
        ;   Label: LAB_0042474f
    FLD ST0                             ; 00424752
    FMUL double ptr [0x00616c7d]        ; 00424754 | double DOUBLE_00616c7d
    FSTP ST1                            ; 0042475a
    ...
    FLD float ptr [EBX + 0x4]           ; 00424814
        ;   Label: LAB_00424814
    FLD ST0                             ; 00424817
    FMUL double ptr [0x00616c85]        ; 00424819 | double DOUBLE_00616c85
    FSTP ST1                            ; 0042481f
