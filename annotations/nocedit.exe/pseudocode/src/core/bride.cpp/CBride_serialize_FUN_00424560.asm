...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_bride_cpp_CBride_serialize_FUN_00424560(CBride *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00424560
        ;   Label: core_bride.cpp_CBride_serialize_FUN_00424560
    MOV EBX,dword ptr [ESP + 0x8]       ; 00424561
    PUSH EBX                            ; 00424565
    CALL core_enemy.cpp_CEnemy_serialize_FUN_004a9660 ; 00424566
        ;   XREF to: 004a9660 (UNCONDITIONAL_CALL)  ; void core_enemy.cpp_CEnemy_serialize_FUN_004a9660(CEnemy * this_ptr)
    MOV EDX,dword ptr [0x0066e648]      ; 0042456b | g_CBrideClassVersion
    ADD ESP,0x4                         ; 00424571
    CMP EDX,0x2                         ; 00424574
    JL 0x004245bc                       ; 00424577
        ;   XREF to: 004245bc (CONDITIONAL_JUMP)  ; LAB_004245bc
    PUSH 0x616c4b                       ; 00424579 | = "modelName"
        ;   Label: LAB_00424579
    LEA EAX,[EBX + 0x158]               ; 0042457e
    PUSH EAX                            ; 00424584
    CALL core_actor.cpp_serializedDeformableModelInstance_FUN_0040b970 ; 00424585
    ...
    MOV ECX,dword ptr [0x0066e648]      ; 0042458a | g_CBrideClassVersion
    ADD ESP,0x8                         ; 00424590
    CMP ECX,0x2                         ; 00424593
    JL 0x004245b1                       ; 00424596
        ;   XREF to: 004245b1 (CONDITIONAL_JUMP)  ; LAB_004245b1
    CMP ECX,0x4                         ; 00424598
    JGE 0x004245b1                      ; 0042459b
        ;   XREF to: 004245b1 (CONDITIONAL_JUMP)  ; LAB_004245b1
    PUSH 0x616c55                       ; 0042459d | = "guardDistance"
    LEA EAX,[EBX + 0xbe34]              ; 004245a2
    PUSH EAX                            ; 004245a8
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 004245a9
    ...
    CMP dword ptr [0x0066e648],0x3      ; 004245b1 | g_CBrideClassVersion
        ;   Label: LAB_004245b1
    JGE 0x004245d2                      ; 004245b8
        ;   XREF to: 004245d2 (CONDITIONAL_JUMP)  ; LAB_004245d2
    POP EBX                             ; 004245ba
    RET                                 ; 004245bb
    PUSH 0x616c45                       ; 004245bc | = "speed"
        ;   Label: LAB_004245bc
    LEA EAX,[EBX + 0xbe24]              ; 004245c1
    PUSH EAX                            ; 004245c7
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 004245c8
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ADD ESP,0x8                         ; 004245cd
    JMP 0x00424579                      ; 004245d0
        ;   XREF to: 00424579 (UNCONDITIONAL_JUMP)  ; LAB_00424579
    PUSH 0x616c63                       ; 004245d2 | = "state"
        ;   Label: LAB_004245d2
    ADD EBX,0x158                       ; 004245d7
    PUSH EBX                            ; 004245dd
    CALL core_actor.cpp_serializeMotionState_FUN_0040b9f0 ; 004245de
