...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_bride_cpp_FUN_00423810(void)
;
; Local Variables:
...
section .text
    ...
    PUSH ESI                            ; 0042384b
    MOV [0x00822cdc],EAX                ; 0042384c | DAT_00822cdc
    ...
    PUSH ESI                            ; 00423860
    MOV [0x00822ce8],EAX                ; 00423861 | DAT_00822ce8
    ...
    PUSH ESI                            ; 00423875
    MOV [0x00822cec],EAX                ; 00423876 | DAT_00822cec
    ...
    PUSH ESI                            ; 004238b4
    MOV [0x00822ce0],EAX                ; 004238b5 | DAT_00822ce0
    ...
    PUSH ESI                            ; 004238c9
    MOV [0x00822ce4],EAX                ; 004238ca | DAT_00822ce4
    ...
    PUSH ESI                            ; 00423908
    MOV [0x00822d00],EAX                ; 00423909 | DAT_00822d00
    ...
    CALL core_enemy.cpp_CEnemy_FUN_004a9650 ; 004239ee
