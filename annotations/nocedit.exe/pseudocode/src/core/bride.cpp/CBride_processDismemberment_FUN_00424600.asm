...
section .text
    ...
    PUSH EBX                            ; 00424600
        ;   Label: core_bride.cpp_CBride_processDismemberment_FUN_00424600
    PUSH ESI                            ; 00424601
    PUSH EDI                            ; 00424602
    PUSH EBP                            ; 00424603
    ...
    MOV EAX,[0x0067b654]                ; 00424678 | g_CGamePtr
        ;   Label: LAB_00424678
    CMP dword ptr [EAX + 0x1e0],0x0     ; 0042467d | g_CGameInstance.gratuitous_dismemberment
    JZ 0x0042468d                       ; 00424684
        ;   XREF to: 0042468d (CONDITIONAL_JUMP)  ; LAB_0042468d
    MOV dword ptr [ESP],0x3f800000      ; 00424686
    MOV EAX,[0x0067b654]                ; 0042468d | g_CGamePtr
        ;   Label: LAB_0042468d
