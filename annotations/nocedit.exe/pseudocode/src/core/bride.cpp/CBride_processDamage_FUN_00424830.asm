...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_bride_cpp_CBride_processDamage_FUN_00424830(CBride *this_ptr,SDamageInfo *damage_info)
;
; Parameters:
...
section .text
    ...
    INC EBX                             ; 004249a6
    CALL core_fire.cpp_CFireEffect_FUN_004c79d0 ; 004249a7
