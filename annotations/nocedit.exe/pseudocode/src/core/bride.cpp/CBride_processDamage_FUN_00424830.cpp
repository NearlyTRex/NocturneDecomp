...

{
  ...
  sound_sndmain_cpp_killSfx_FUN_005a9c40(*(uint *)(this_ptr->unk3 + 4));
  ...
  if (0.0 < (this_ptr->base).base.hit_points) {
    ...
    iVar2 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660(*(uint *)this_ptr->unk3);
