...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_bride_cpp_CBride_archive_FUN_00424560(CBride *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00424560
        ;   Label: core_bride.cpp_CBride_archive_FUN_00424560
    MOV EBX,dword ptr [ESP + 0x8]       ; 00424561
    PUSH EBX                            ; 00424565
    CALL core_enemy.cpp_CEnemy_archive_FUN_004a9660 ; 00424566
    ...
    PUSH EAX                            ; 00424584
    CALL core_actor.cpp_archiveDeformableModelInstance_FUN_0040b970 ; 00424585
    ...
    PUSH EAX                            ; 004245a8
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 004245a9
    ...
    PUSH EAX                            ; 004245c7
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 004245c8
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH EBX                            ; 004245dd
    CALL core_actor.cpp_archiveMotionState_FUN_0040b9f0 ; 004245de
