...
void __cdecl
core_bride_cpp_CBride_getPropertyList_FUN_00424b10
          (CBride *this_ptr,CActorPropertyList *property_list)

{
  CActorPropertyList *in_stack_00000010;
  
  core_enemy_cpp_CEnemy_getPropertyList_FUN_004aa170(&this_ptr->base,property_list);
  core_actor_cpp_CActorPropertyList_FUN_0040e4a0(in_stack_00000010);
  return;
}
