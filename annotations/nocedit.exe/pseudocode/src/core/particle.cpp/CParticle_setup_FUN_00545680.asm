...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_particle.cpp_CParticle_setup_FUN_00545680(CParticle * this_ptr, CVector3f * position, CVector3f * velocity)
;
; Parameters:
...
;   core_gore.cpp_FUN_004eb9a0 at 004eb9c6
;
; Called Functions:
...
section .text
    ...
    JMP 0x0054569b                      ; 005456c9 | LAB_0054569b
    ...
    JMP 0x005456a6                      ; 005456db | LAB_005456a6
        ;   XREF to: 005456a6 (UNCONDITIONAL_JUMP)
    PUSH 0x3fc90fdb                     ; 005456dd
        ;   Label: LAB_005456dd
    PUSH 0x3f490fdb                     ; 005456e2
    CALL core_actor.cpp_getRandomFloat_FUN_0040cc10 ; 005456e7 | float core_actor.cpp_getRandomFloat_FUN_0040cc10(float min_value, float max_value)
