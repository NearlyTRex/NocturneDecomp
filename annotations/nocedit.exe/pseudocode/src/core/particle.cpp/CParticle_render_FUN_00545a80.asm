...
section .text
    ...
    MOV EDX,0x63e734                    ; 00545a80 | = "..\\core\\particle.cpp"
        ;   Label: core_particle.cpp_CParticle_render_FUN_00545a80
    MOV ECX,0xc5                        ; 00545a85
    PUSH 0x63e749                       ; 00545a8a | = "Base class shouldn't render"
    MOV dword ptr [0x02f0ca48],EDX      ; 00545a8f | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 00545a95 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00545a9b
