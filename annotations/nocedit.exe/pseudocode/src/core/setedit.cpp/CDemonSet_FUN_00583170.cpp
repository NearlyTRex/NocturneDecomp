  ...
  do {
      ...
      do {
        ...
        if (fVar6 == local_18) {
          ...
          shape_edittool_cpp_CEditorTools_draw3DAxisLabels_FUN_004a1ca0
                    (g_CEditorToolsPtr,2.0,CONCAT31(extraout_var,uVar2));
          ...
          shape_edittool_cpp_CEditorTools_draw3DWireframeCube_FUN_004a2050
                    (g_CEditorToolsPtr,(CVector3f *)corner1,corner2,CONCAT31(extraout_var,uVar2));
        }
        else {
          do {
            fVar16 = fVar14;
    ...
    if (0 < this_ptr->camera_count) {
      ...
      do {
        ...
        fVar6 = -fVar6;
        local_104 = (int)ROUND(fVar6 * FLOAT_00662a28);
        local_100 = (int)ROUND(fVar16 * FLOAT_00662a28);
        wincore_windll_cpp_transformAndProjectPoint_FUN_005b575c
                  (&g_CDemonRendererPtr->vertex_buffer_ptr[1].projected_vertex,
                   (CVector3i *)&local_104);
        local_1b8 = (int)ROUND(fVar6 * FLOAT_00662a28);
        wincore_windll_cpp_transformAndProjectPoint_FUN_005b575c
        ...
        local_a4 = (int)ROUND(-fVar6 * FLOAT_00662a28);
        local_a0 = (int)ROUND(fVar16 * FLOAT_00662a28);
        wincore_windll_cpp_transformAndProjectPoint_FUN_005b575c
    ...
    if (local_3c == (SVDBox *)0x0) {
      ...
      if (iVar7 == 0) {
        ...
        if (iVar7 != 0) {
          fVar19 = fVar20 * (float)DOUBLE_00648dfd;
        }
      }
      else {
        fVar19 = fVar20 * (float)DOUBLE_00648e05;
      }
      fVar19 = (float)pCVar21 * (float)DOUBLE_00648e15 * fVar19;
      local_1e8.z = 8.105933e-39;
      (*g_CKeysPtr->vtable->isKeyDown)(g_CKeysPtr,0x4a);
      local_1cc = 8.105972e-39;
      (*g_CKeysPtr->vtable->isKeyDown)(g_CKeysPtr,0x4e);
      local_1b8 = 0x584443;
      (*g_CKeysPtr->vtable->isKeyDown)(g_CKeysPtr,0x52);
      (*g_CKeysPtr->vtable->isKeyDown)(g_CKeysPtr,0x53);
      ...
      if ((float)pCVar21 < (float)DOUBLE_00648e15) {
    ...
    iVar7 = (*g_CKeysPtr->vtable->isKeyPressed)(g_CKeysPtr,0x13);
    if (iVar7 != 0) {
      ...
      if (iVar7 < 0xfa) {
        if ((-1 < (int)local_18) && ((int)local_18 < iVar7)) {
          ...
          *(undefined4 *)pSVar5->field3_0x3c = *(undefined4 *)pSVar10->field3_0x3c;
          *(undefined4 *)(pSVar5->field3_0x3c + 4) = *(undefined4 *)(pSVar10->field3_0x3c + 4);
...
LAB_00583c6f:
    iVar7 = (*g_CKeysPtr->vtable->isKeyPressed)(g_CKeysPtr,0x20);
    ...
    if (((uVar17 & 1) != 0) && ((g_MouseButtonFlags & 1U) == 0)) {
      ...
      local_1e8.x = pCVar3->x * FLOAT_00648e2d;
      local_1e8.y = pCVar3->y * FLOAT_00648e2d;
      local_1e8.z = FLOAT_00648e2d * pCVar3->z;
      fVar6 = 0.0;
      local_38 = 1e+30;
      if (0 < this_ptr->vdir_box_count) {
...
// 005831c5: CALL core_slew.cpp_CSlew_init_FUN_005a2060
...
// 00583b32: PUSH EAX
// 00583b33: CALL core_slew.cpp_CSlew_processInput_FUN_005a20b0
...
// 0058469f: CALL core_slew.cpp_CSlew_init_FUN_005a2060
//   XREF to: 005a2060 (UNCONDITIONAL_CALL)
...
// 00584711: CALL core_slew.cpp_CSlew_processInput_FUN_005a20b0
//   XREF to: 005a20b0 (UNCONDITIONAL_CALL)
