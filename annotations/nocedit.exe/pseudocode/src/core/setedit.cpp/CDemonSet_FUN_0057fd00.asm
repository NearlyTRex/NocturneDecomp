...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_setedit_cpp_CDemonSet_FUN_0057fd00(CDemonSet *this_ptr)
;
; Parameters:
...
;
; XREF[2]:
;   core_setedit.cpp_CDemonSet_FUN_0057a940 at 0057adcc
;   core_setedit.cpp_CDemonSet_FUN_0057d660 at 0057e188
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0057fd00
        ;   Label: core_setedit.cpp_CDemonSet_FUN_0057fd00
    PUSH ESI                            ; 0057fd01
    PUSH EDI                            ; 0057fd02
    PUSH EBP                            ; 0057fd03
    ...
    PUSH EDX                            ; 0057fd0c
    CALL core_setedit.cpp_CDemonSet_FUN_00580310 ; 0057fd0d
