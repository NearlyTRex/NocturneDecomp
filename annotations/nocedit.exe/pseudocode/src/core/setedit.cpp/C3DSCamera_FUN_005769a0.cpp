// Name: core_setedit.cpp_C3DSCamera_FUN_005769a0
// Address: 005769a0
// Address Range: [[005769a0, 00576d90]]
// Convention: __cdecl
// Signature: void __cdecl core_setedit_cpp_C3DSCamera_FUN_005769a0(C3DSCamera *this_ptr)
...

{
  ...
  _sprintf(local_5c,"%s%s.raw",this_ptr);
  _sprintf(local_4c,"%s%s.act",this_ptr);
