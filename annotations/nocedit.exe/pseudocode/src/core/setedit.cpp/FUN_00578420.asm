...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_setedit_cpp_FUN_00578420(void)
;
; Local Variables:
...
;   core_setedit.cpp_FUN_00578630 at 00578648
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00578420
        ;   Label: core_setedit.cpp_FUN_00578420
    PUSH EBP                            ; 00578421
    ...
    PUSH EAX                            ; 00578582
    CALL core_setedit.cpp_FUN_00578290  ; 00578583
