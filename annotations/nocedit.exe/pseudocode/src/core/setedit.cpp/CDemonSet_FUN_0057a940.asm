...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_setedit_cpp_CDemonSet_FUN_0057a940(CDemonSet *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0057a940
        ;   Label: core_setedit.cpp_CDemonSet_FUN_0057a940
    PUSH ESI                            ; 0057a941
    PUSH EDI                            ; 0057a942
    PUSH EBP                            ; 0057a943
    ...
    MOV ESI,dword ptr [0x00681ab8]      ; 0057a96b | PTR_DAT_00681ab8
    PUSH ESI                            ; 0057a971 | g_SkeletonPoolEnd
    ...
    MOV EBX,dword ptr [0x00681ab8]      ; 0057a9eb | g_SkeletonPoolEnd | PTR_DAT_00681ab8
    ADD ESP,0x4                         ; 0057a9f1
    MOV EAX,dword ptr [EBX]             ; 0057a9f4 | g_SkeletonPoolEnd
    ...
    PUSH EBX                            ; 0057aa3c | g_SkeletonPoolEnd
    ...
    MOV EAX,[0x00681ab8]                ; 0057aa49 | PTR_DAT_00681ab8
    ...
    FLD float ptr [EAX]                 ; 0057aa58 | g_SkeletonPoolEnd
    ...
    MOV EAX,[0x00681ab8]                ; 0057aa72 | PTR_DAT_00681ab8
        ;   Label: LAB_0057aa72
    ...
    MOV EAX,[0x00681ab8]                ; 0057aa85 | g_SkeletonPoolEnd | PTR_DAT_00681ab8
    ...
    MOV EBX,dword ptr [0x00681ab8]      ; 0057aae5 | g_SkeletonPoolEnd | PTR_DAT_00681ab8
    FLD float ptr [ESP + 0x4ec]         ; 0057aaeb
    FCOMP float ptr [EBX]               ; 0057aaf2 | g_SkeletonPoolEnd
    FNSTSW AX                           ; 0057aaf4
    SAHF                                ; 0057aaf6
    ...
    PUSH EBX                            ; 0057ab2d
    CALL core_setedit.cpp_CDemonSet_FUN_0057ff70 ; 0057ab2e
    ...
    PUSH EDI                            ; 0057ab4a
    PUSH EBX                            ; 0057ab4b
    CALL core_setedit.cpp_CDemonSet_FUN_005800d0 ; 0057ab4c
    ...
    FLD float ptr [EAX]                 ; 0057ac15 | g_SkeletonPoolEnd
    ...
    CALL core_game.cpp_CGame_updateDeltaTime_FUN_004d7d90 ; 0057acb0
    ...
    PUSH EAX                            ; 0057adcb
    CALL core_setedit.cpp_CDemonSet_FUN_0057fd00 ; 0057adcc
        ;   XREF to: 0057fd00 (UNCONDITIONAL_CALL)  ; void core_setedit.cpp_CDemonSet_FUN_0057fd00(CDemonSet * this_ptr)
    ...
    PUSH ECX                            ; 0057ae0d
    CALL core_setedit.cpp_CDemonSet_FUN_00580560 ; 0057ae0e
        ;   XREF to: 00580560 (UNCONDITIONAL_CALL)  ; void core_setedit.cpp_CDemonSet_FUN_00580560(CDemonSet * this_ptr)
    ADD ESP,0x4                         ; 0057ae13
    MOV EBX,dword ptr [0x00681ab8]      ; 0057ae16 | g_SkeletonPoolEnd | PTR_DAT_00681ab8
    PUSH EBX                            ; 0057ae1c | g_SkeletonPoolEnd
