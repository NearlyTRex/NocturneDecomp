...
section .text
    ...
    MOV EDX,dword ptr [0x03654368]      ; 005782b3 | DAT_03654368
    ...
    MOV EAX,ESP                         ; 005782c5
        ;   Label: LAB_005782c5
    PUSH EAX                            ; 005782c7
    PUSH ESI                            ; 005782c8 | DAT_03654370 | DAT_03654398
    ...
    JL 0x0057830a                       ; 005782d7
        ;   XREF to: 0057830a (CONDITIONAL_JUMP)  ; LAB_0057830a
    MOV AL,byte ptr [EBX + 0x3659190]   ; 005782d9 | DAT_03659190
    ...
    POP EBX                             ; 005782fa
    RET                                 ; 005782fb
    MOV ECX,dword ptr [0x03654368]      ; 005782fc | DAT_03654368
        ;   Label: LAB_005782fc
    INC EBX                             ; 00578302
    ...
    CALL engine_dosio.c_splitPath_FUN_00481f20 ; 0057831a
        ;   XREF to: 00481f20 (UNCONDITIONAL_CALL)  ; void engine_dosio.c_splitPath_FUN_00481f20(char * full_path, char * drive, char * directory, char * filename, ...)
    MOV EBX,dword ptr [0x03654368]      ; 0057831f | DAT_03654368
    ...
    MOV EBX,dword ptr [0x03654368]      ; 00578391 | DAT_03654368
        ;   Label: LAB_00578391
    ...
    MOV AL,byte ptr [ESI]               ; 005783b2
        ;   Label: LAB_005783b2
    MOV byte ptr [EDI],AL               ; 005783b4 | DAT_03654370 | DAT_03654372
    CMP AL,0x0                          ; 005783b6
    ...
    POP EDI                             ; 005783ca
        ;   Label: LAB_005783ca
    MOV EAX,[0x03654368]                ; 005783cb | DAT_03654368
    INC EAX                             ; 005783d0
    MOV BL,byte ptr [ESP + 0x218]       ; 005783d1
    MOV byte ptr [EAX + 0x365918f],BL   ; 005783d8 | DAT_0365918f | DAT_03659190
    MOV [0x03654368],EAX                ; 005783de | DAT_03654368
    POP EDI                             ; 005783e3
