...
section .text
    ...
    PUSH EBX                            ; 00578a05
        ;   Label: LAB_00578a05
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 00578a06 | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00578a0b
    TEST EAX,EAX                        ; 00578a0e
    JL 0x00578a17                       ; 00578a10 | LAB_00578a17
        ;   XREF to: 00578a17 (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 00578a12
    JNZ 0x00578a05                      ; 00578a15 | LAB_00578a05
