...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_setedit_cpp_CDemonSet_FUN_005805a0(CDemonSet *this_ptr)
;
; Parameters:
...
;
; XREF[2]:
;   core_setedit.cpp_CDemonSet_FUN_00580730 at 00580df7
...
section .text
    ...
    PUSH EBX                            ; 005805a0
        ;   Label: core_setedit.cpp_CDemonSet_FUN_005805a0
    PUSH ESI                            ; 005805a1
    PUSH EDI                            ; 005805a2
    PUSH EBP                            ; 005805a3
