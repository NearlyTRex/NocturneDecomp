...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_setedit_cpp_CDemonSet_FUN_00580560(CDemonSet *this_ptr)
;
; Parameters:
; CDemonSet *      Stack[0x4]:4   this_ptr
;
; XREF[3]:
;   core_setedit.cpp_CDemonSet_FUN_00576da0 at 00576db2
;   core_setedit.cpp_CDemonSet_FUN_0057a940 at 0057ae0e
;   core_setedit.cpp_CDemonSet_FUN_0057e7c0 at 0057eb5a
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00580560
        ;   Label: core_setedit.cpp_CDemonSet_FUN_00580560
    PUSH ESI                            ; 00580561
