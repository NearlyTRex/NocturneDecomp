...
; Local Variables:
; CPickList        Stack[-0xc8c]:936  local_c8c
; CPickList        Stack[-0x8e4]:936  local_8e4
; CPickList        Stack[-0x53c]:936  local_53c
; char[100]        Stack[-0x194]:100  local_194
; CMatrix3x3f      Stack[-0x130]:36  local_130
; undefined1[16]   Stack[-0x108]:16  local_108
; float            Stack[-0xf8]:4  local_f8
; float            Stack[-0xf4]:4  local_f4
; float            Stack[-0xf0]:4  local_f0
; undefined1[16]   Stack[-0xec]:16  local_ec
...
section .text
    ...
    PUSH EBX                            ; 00581aa0
        ;   Label: core_setedit.cpp_CDemonSet_showRoomEditor_FUN_00581aa0
    PUSH ESI                            ; 00581aa1
    PUSH EDI                            ; 00581aa2
    PUSH EBP                            ; 00581aa3
    ...
    MOV [0x0327591c],EAX                ; 00581c8a | g_CDemonCameraInstance.base.focal_length
    ...
    CALL core_setedit.cpp_renderColoredBox_FUN_005817d0 ; 00581d54
    ...
    CALL core_game.cpp_CGame_updateDT_FUN_004d7d90 ; 00581e29
    ...
    CALL core_setedit.cpp_renderColoredBox_FUN_005817d0 ; 005824b5
        ;   XREF to: 005817d0 (UNCONDITIONAL_CALL)  ; void core_setedit.cpp_renderColoredBox_FUN_005817d0(CVector3f * corner_a, CVector3f * corner_b, float opacity, int r, ...)
