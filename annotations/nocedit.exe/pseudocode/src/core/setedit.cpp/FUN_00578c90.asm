...
section .text
    ...
    JZ 0x00578d53                       ; 00578ca2 | LAB_00578d53
    ...
    PUSH ECX                            ; 00578cb6
    PUSH 0x646bc0                       ; 00578cb7 | = "%s? [%c] " | s_s_c_00646bc0 = %s? [%c]
    LEA EAX,[ESP + 0x19c]               ; 00578cbc
    PUSH EAX                            ; 00578cc3
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 00578cc4 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH EAX                            ; 00578cdd
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 00578cde | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00578ce3
    MOV EDI,dword ptr [0x0067cf44]      ; 00578ce6 | CKeys * g_CKeysPtr
        ;   Label: LAB_00578ce6
    PUSH EDI                            ; 00578cec | void * g_CKeysPtr
    CALL engine_keys.cpp_CKeys_getUppercasedInputKey_FUN_00502470 ; 00578ced | int engine_keys.cpp_CKeys_getUppercasedInputKey_FUN_00502470(CKeys * this)
        ;   XREF to: 00502470 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00578cf2
    MOV EDX,EAX                         ; 00578cf5
    CMP EAX,0x1b                        ; 00578cf7
    JZ 0x00578d5a                       ; 00578cfa | LAB_00578d5a
        ;   XREF to: 00578d5a (CONDITIONAL_JUMP)
    CMP EAX,0xd                         ; 00578cfc
    JNZ 0x00578d03                      ; 00578cff | LAB_00578d03
        ;   XREF to: 00578d03 (CONDITIONAL_JUMP)
    MOV EDX,EBX                         ; 00578d01
    CMP EDX,0x59                        ; 00578d03
        ;   Label: LAB_00578d03
    JZ 0x00578d66                       ; 00578d06 | LAB_00578d66
        ;   XREF to: 00578d66 (CONDITIONAL_JUMP)
    CMP EDX,0x4e                        ; 00578d08
    JNZ 0x00578ce6                      ; 00578d0b | LAB_00578ce6
        ;   XREF to: 00578ce6 (CONDITIONAL_JUMP)
    MOV EAX,0x646bd0                    ; 00578d0d | = "N" | s_N_00646bd0 = N
    XOR EBX,EBX                         ; 00578d12
    PUSH EAX                            ; 00578d14 | = "N" | s_ESC_00646bca = ESC | s_Y_00646bce = Y
        ;   Label: LAB_00578d14
    LEA EAX,[ESP + 0x194]               ; 00578d15
    PUSH EAX                            ; 00578d1c
    PUSH 0x646bd2                       ; 00578d1d | = "%s %s" | s_s_s_00646bd2 = %s %s
    LEA EAX,[ESP + 0xc]                 ; 00578d22
    PUSH EAX                            ; 00578d26
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 00578d27 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00578d3d
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 00578d3e | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ...
    MOV AL,0x4e                         ; 00578d53
        ;   Label: LAB_00578d53
    JMP 0x00578caa                      ; 00578d55 | LAB_00578caa
        ;   XREF to: 00578caa (UNCONDITIONAL_JUMP)
    MOV EAX,0x646bca                    ; 00578d5a | = "ESC" | s_ESC_00646bca = ESC
        ;   Label: LAB_00578d5a
    MOV EBX,0xffffffff                  ; 00578d5f
    JMP 0x00578d14                      ; 00578d64 | LAB_00578d14
        ;   XREF to: 00578d14 (UNCONDITIONAL_JUMP)
    MOV EAX,0x646bce                    ; 00578d66 | = "Y" | s_Y_00646bce = Y
        ;   Label: LAB_00578d66
    MOV EBX,0x1                         ; 00578d6b
    JMP 0x00578d14                      ; 00578d70 | LAB_00578d14
        ;   XREF to: 00578d14 (UNCONDITIONAL_JUMP)
