...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_setedit_cpp_CDemonSet_FUN_00584e70(CDemonSet *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH 0x64903a                       ; 00584f34 | = ".zth"
        ;   Label: LAB_00584f34
    PUSH EBX                            ; 00584f39
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 00584f3a
    ...
    PUSH EBX                            ; 00584f5d
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 00584f5e
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c__sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH EDX                            ; 00584fc1
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 00584fc2
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c__sprintf_FUN_005fdbd0(char * buffer, char * format)
