...
;
; Parameters:
; CVector3i *      Stack[0x4]:4   position
; CVector3f *      Stack[0x8]:4   orientation
; char *           Stack[0xc]:4   name
; int              Stack[0x10]:4   output_width
; int              Stack[0x14]:4   output_height
; int              Stack[0x18]:4   render_width
...
section .text
    ...
    PUSH EBX                            ; 0057ce80
        ;   Label: core_setedit.cpp_renderBackdropImage_FUN_0057ce80
    PUSH ESI                            ; 0057ce81
    PUSH EDI                            ; 0057ce82
    PUSH EBP                            ; 0057ce83
