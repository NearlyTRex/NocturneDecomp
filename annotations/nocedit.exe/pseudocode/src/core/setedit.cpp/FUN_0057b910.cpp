...
// Convention: unknown
// Signature: void core_setedit_cpp_FUN_0057b910(void)

#include "nocturne.h"

/* Signature: byte core_setedit.cpp_FUN_0057b910(uint param_1, uint param_2) */
  ...
  if (-1 < in_stack_00000008) {
    if (in_stack_00000008 < *(int *)(in_stack_00000004 + 0x19a2c)) {
      ...
      if (in_stack_00000008 < *(int *)(in_stack_00000004 + 0x19a2c)) {
        ...
        puVar3 = (uint *)(in_stack_00000008 + 0x199c + iVar1);
        puVar2 = (uint *)(in_stack_00000008 + 0x104 + iVar1);
        local_c = (uint *)(iVar1 + in_stack_00000008);
        local_8 = (uint *)(in_stack_00000008 + 0x1898 + iVar1);
        do {
          *local_c = *local_8;
          iVar1 = 0x40;
          puVar4 = local_8;
