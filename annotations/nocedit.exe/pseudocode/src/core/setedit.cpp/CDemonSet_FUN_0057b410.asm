...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_setedit_cpp_CDemonSet_FUN_0057b410(CDemonSet *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0057b410
        ;   Label: core_setedit.cpp_CDemonSet_FUN_0057b410
    PUSH ESI                            ; 0057b411
    PUSH EDI                            ; 0057b412
    ...
    CALL core_setedit.cpp_CDemonSet_FUN_0057ae50 ; 0057b465
