...
section .text
    ...
    CMP dword ptr [0x03659384],0x0      ; 00580317 | undefined4 DAT_03659384
    JNZ 0x0058032b                      ; 0058031e | LAB_0058032b
        ;   XREF to: 0058032b (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x2c]      ; 00580320
    MOV ECX,dword ptr [EAX]             ; 00580324
    CMP ECX,0x1                         ; 00580326
    JGE 0x00580333                      ; 00580329 | LAB_00580333
    ...
    PUSH 0x648567                       ; 0058033e | = "..\\core\\setedit.cpp" | s_core_setedit_cpp_00648567 = ..\core\setedit.cpp
    PUSH EAX                            ; 00580343
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1f0 ; 00580344 | void * shape_memdbg.cpp_debugAlloc_FUN_0050f1f0(int size, char * filename, int line_number)
        ;   XREF to: 0050f1f0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00580349
    MOV [0x03659384],EAX                ; 0058034c | undefined4 DAT_03659384
    TEST EAX,EAX                        ; 00580351
    JNZ 0x00580378                      ; 00580353 | LAB_00580378
        ;   XREF to: 00580378 (CONDITIONAL_JUMP)
    MOV ESI,0x64857b                    ; 00580355 | = "..\\core\\setedit.cpp" | s_core_setedit_cpp_0064857b = ..\core\setedit.cpp
    MOV EDI,0x1008                      ; 0058035a
    PUSH 0x64858f                       ; 0058035f | = "Out of memory!" | s_Out_of_memory_0064858f = Out of memory!
    MOV dword ptr [0x02f0ca48],ESI      ; 00580364 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 0058036a | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00580370 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    JLE 0x0058032b                      ; 00580386 | LAB_0058032b
        ;   XREF to: 0058032b (CONDITIONAL_JUMP)
    ...
    MOV EAX,[0x03659384]                ; 005803c4 | undefined4 DAT_03659384
    PUSH 0x0                            ; 005803c9
    MOV EBP,dword ptr [0x006703ec]      ; 005803cb | CDemonRenderer * g_CDemonRendererPtr
    ADD ECX,EAX                         ; 005803d1
    PUSH EBP                            ; 005803d3 | CDemonRenderer g_CDemonRendererInstance
    MOV EDI,dword ptr [ESP + 0x14]      ; 005803d4
    MOV dword ptr [ESP + 0x28],ECX      ; 005803d8
    CALL engine_drender.cpp_CDemonRenderer_pushViewport_FUN_0048c890 ; 005803dc | void engine_drender.cpp_CDemonRenderer_pushViewport_FUN_0048c890(CDemonRenderer * this_ptr, int x, int y, int width, ...)
        ;   XREF to: 0048c890 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 005803e1
    MOV EAX,dword ptr [ESP + 0x8]       ; 005803e4
    PUSH EAX                            ; 005803e8
    MOV EDX,dword ptr [0x006703ec]      ; 005803e9 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH EDX                            ; 005803ef | CDemonRenderer g_CDemonRendererInstance
    ADD EBX,EDI                         ; 005803f0
    CALL engine_drender.cpp_CDemonRenderer_setCameraOriginFromScaledPoint_FUN_0048c150 ; 005803f2 | void engine_drender.cpp_CDemonRenderer_setCameraOriginFromScaledPoint_FUN_0048c150(CDemonRenderer * this_ptr, CVector3i * point_ptr)
        ;   XREF to: 0048c150 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005803f7
    MOV ECX,dword ptr [0x006703ec]      ; 005803fa | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH dword ptr [EBX + 0x144]        ; 00580400
    PUSH ECX                            ; 00580406 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_setProjectionScale_FUN_0048c650 ; 00580407 | void engine_drender.cpp_CDemonRenderer_setProjectionScale_FUN_0048c650(CDemonRenderer * this_ptr, float field_of_view)
        ;   XREF to: 0048c650 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0058040c
    MOV EBX,dword ptr [ESP + 0xc]       ; 0058040f
    PUSH EBX                            ; 00580413
    MOV ESI,dword ptr [0x006703ec]      ; 00580414 | CDemonRenderer * g_CDemonRendererPtr
    PUSH ESI                            ; 0058041a | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_setupSceneRendering_FUN_0048c1d0 ; 0058041b | void engine_drender.cpp_CDemonRenderer_setupSceneRendering_FUN_0048c1d0(CDemonRenderer * this_ptr)
        ;   XREF to: 0048c1d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00580420
    MOV ECX,dword ptr [ESP + 0x14]      ; 00580423
    MOV EAX,[0x02d052e8]                ; 00580427 | CMatrix3x3i g_TransformMatrix
    ...
    MOV EAX,[0x02d052c4]                ; 0058046f | int g_CameraOriginX
    MOV EDI,dword ptr [0x006703ec]      ; 00580474 | CDemonRenderer * g_CDemonRendererPtr
    MOV dword ptr [ECX],EAX             ; 0058047a
    MOV EAX,[0x02d052c8]                ; 0058047c | int g_CameraOriginY
    PUSH 0x3f87558                      ; 00580481 | CVector3f g_ZeroVector
    MOV dword ptr [ECX + 0x4],EAX       ; 00580486
    MOV EAX,[0x02d052cc]                ; 00580489 | int g_CameraOriginZ
    PUSH EDI                            ; 0058048e | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [ECX + 0x8],EAX       ; 0058048f
    CALL engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450 ; 00580492 | void engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450(CDemonRenderer * this_ptr, CVector3f * world_position)
    ...
    PUSH EBP                            ; 005804a5
    CALL core_set.cpp_CDemonSet_renderSceneGeometry_FUN_0056a190 ; 005804a6 | void core_set.cpp_CDemonSet_renderSceneGeometry_FUN_0056a190(CDemonSet * this_ptr, float frustum_param, int render_mode)
    ...
    MOV EAX,dword ptr [EDI + 0x2cf7d5c] ; 005804ba | uint *[1024] g_ZBufferScanlineArray
        ;   Label: LAB_005804ba
    MOV ESI,dword ptr [EBX + EAX*0x1]   ; 005804c0
    TEST ESI,ESI                        ; 005804c3
    JLE 0x0058054b                      ; 005804c5 | LAB_0058054b
    ...
    JNZ 0x005804ba                      ; 005804e9 | LAB_005804ba
        ;   XREF to: 005804ba (CONDITIONAL_JUMP)
    ADD EBP,0x4                         ; 005804eb
    CMP EBP,0x3c0                       ; 005804ee
    JNZ 0x005804b0                      ; 005804f4 | LAB_005804b0
        ;   XREF to: 005804b0 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x006703ec]      ; 005804f6 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH ECX                            ; 005804fc | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_popViewport_FUN_0050e480 ; 005804fd | void engine_drender.cpp_CDemonRenderer_popViewport_FUN_0050e480(CDemonRenderer * this_ptr)
    ...
    JGE 0x0058032b                      ; 00580540 | LAB_0058032b
        ;   XREF to: 0058032b (CONDITIONAL_JUMP)
    JMP 0x005803ac                      ; 00580546 | LAB_005803ac
        ;   XREF to: 005803ac (UNCONDITIONAL_JUMP)
    MOV dword ptr [ECX + 0x30],0x7fffffff ; 0058054b
        ;   Label: LAB_0058054b
    JMP 0x005804da                      ; 00580552 | LAB_005804da
