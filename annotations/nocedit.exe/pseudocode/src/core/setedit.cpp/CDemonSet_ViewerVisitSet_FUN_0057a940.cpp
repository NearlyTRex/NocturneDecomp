...
// Convention: __cdecl
// Signature: void __cdecl core_setedit_cpp_CDemonSet_ViewerVisitSet_FUN_0057a940(CDemonSet *this_ptr)
...

{
  ...
  n2 = (CGame *)((ulonglong)in_stack_fffffad8 >> 0x20);
  local_18 = 0;
  local_1c = (void *)0x0;
  ...
  while( true ) {
    ...
    fStack_34 = *(float *)PTR_DAT_00681ab8;
    ...
    fStack_20 = *(float *)((int)PTR_DAT_00681ab8 + 0x14);
    local_1c = *(void **)((int)PTR_DAT_00681ab8 + 0x18);
    ...
    if ((((fStack_34 != *(float *)PTR_DAT_00681ab8) ||
         (fStack_30 != *(float *)((int)PTR_DAT_00681ab8 + 4))) ||
        (fStack_2c != *(float *)((int)PTR_DAT_00681ab8 + 8))) ||
       (((fStack_28 != *(float *)((int)PTR_DAT_00681ab8 + 0xc) ||
         (fStack_24 != *(float *)((int)PTR_DAT_00681ab8 + 0x10))) ||
        ((fStack_20 != *(float *)((int)PTR_DAT_00681ab8 + 0x14) ||
         ((float)local_1c != *(float *)((int)PTR_DAT_00681ab8 + 0x18))))))) {
      iStack_14 = 0;
    }
    if (ptr != (C3DSCamera *)0x0) {
      if (iStack_14 == 0) {
