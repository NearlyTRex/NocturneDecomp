...

{
  ...
  while( true ) {
    ...
    this_ptr_00 = *(CDemonSet **)((int)PTR_DAT_00681ab8 + 0x10);
    ...
    if (((((float)pCStack00000010 != *(float *)PTR_DAT_00681ab8) ||
         (in_stack_00000014 != *(float *)((int)PTR_DAT_00681ab8 + 4))) ||
        (in_stack_00000018 != *(float *)((int)PTR_DAT_00681ab8 + 8))) ||
       (((in_stack_0000001c != *(float *)((int)PTR_DAT_00681ab8 + 0xc) ||
         (in_stack_00000020 != *(float *)((int)PTR_DAT_00681ab8 + 0x10))) ||
        ((in_stack_00000024 != *(float *)((int)PTR_DAT_00681ab8 + 0x14) ||
         (in_stack_00000028 != *(float *)((int)PTR_DAT_00681ab8 + 0x18))))))) {
      in_stack_00000030 = 0;
    }
    if (in_stack_00000034 != 0) {
      ...
      if (0 < iVar3) {
        ...
        iVar4 = 0;
        do {
          piVar1 = (int *)(&stack0xfffffb34 + iVar4);
          iVar4 = iVar4 + 4;
          engine_2d_c_drawTextXY_FUN_00402130(0,y_pos,(char *)(*piVar1 * 0x1a4 + in_stack_00000044))
          ;
          y_pos = y_pos + 0xb;
        } while (iVar4 < iVar3 * 4);
      }
    ...
    crt_stdio_c_sprintf_FUN_005fdbd0
              (acStack_e0,"Visit %d, rotate: %d, zcheck %d, render %d",g_CubesTestedCount,
               g_CubesWithVoxelsCount,g_CubesVisibleCount);
    engine_2d_c_drawText_FUN_00401fd0(acStack_dc,0,0x16);
    crt_stdio_c_sprintf_FUN_005fdbd0
              (acStack_d8,"Viewer pos: %8.4f,%8.4f,%8.4f pbh: %6.3f,%6.3f,%6.3f",(double)*(float *)PTR_DAT_00681ab8,
    ...
    engine_2d_c_drawText_FUN_00401fd0(acStack_d4,0,g_WindowHeight + -0x2c);
    crt_stdio_c_sprintf_FUN_005fdbd0(acStack_d0,"%f");
    engine_2d_c_drawText_FUN_00401fd0(acStack_cc,0,g_WindowHeight + -0xb);
  ...
  crt_memory_c_free_FUN_005fe659(in_stack_00000078);
