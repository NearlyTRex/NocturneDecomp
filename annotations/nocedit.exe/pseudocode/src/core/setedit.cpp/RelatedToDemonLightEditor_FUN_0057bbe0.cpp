  ...
  do {
    ...
    case 0x48:
      ...
      if (iVar5 != 0) {
        ...
        dVar8 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44 /* combine 2-byte values */(extraout_EDX,param_25));
        *(int *)(SUB84 /* extract 2-byte value */(dVar8,0) + 0x17f8) = (int)ROUND(fVar7);
    ...
    case 0x49:
      ...
      if (iVar5 != 0) {
        ...
        dVar8 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44 /* combine 2-byte values */(extraout_EDX_00,param_25));
        *(int *)(SUB84 /* extract 2-byte value */(dVar8,0) + 0x17fc) = (int)ROUND(fVar7);
...
LAB_0057c050:
    ...
    case 0x4b:
      max_value = 1.0;
      uVar10 = CONCAT44 /* combine 2-byte values */(1,param_15);
      pcVar9 = "Enter light intensity (0..1)";
LAB_0057c056:
      shape_edittool_cpp_CEditorTools_promptForValidFloat_FUN_004a00f0
                (g_CEditorToolsPtr,pcVar9,(float *)uVar10,SUB81 /* extract 2-byte value */(uVar10 >> 0x20,0),0.0,max_value,true
                );
    }
    if (local_30 == 0x1b) {
