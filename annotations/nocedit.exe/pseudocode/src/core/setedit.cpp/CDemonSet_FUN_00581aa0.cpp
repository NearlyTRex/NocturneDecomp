...

{
  ...
  int iVar8;
  char *pcVar9;
  CKeys *in_stack_fffff2de;
  CVector3f *in_stack_fffff2e2;
  uint d4;
  CKeys *d5;
  CKeys *d6;
  CGame *in_stack_fffff2f6;
  CKeys *d2;
  CSlew *this_ptr_00;
  CPickList *in_stack_fffff2fe;
  uint in_stack_fffff302;
  CKeys *in_stack_fffff306;
  uint d2_00;
  ...
  local_98 = 0.0;
  local_28 = 40.0;
  core_game_cpp_CGame_saveClockTime_FUN_004d7d80(g_CGamePtr,in_stack_fffff2f6);
  ...
  do {
    ...
    pCVar4 = (CVector3f *)(local_108 + 0xc);
    d2_00 = 0x32758f4;
    core_dirmat_cpp_CMatrix3x3f_buildRotationMatrix_FUN_00471d30
              ((CMatrix3x3f *)&g_CDemonCameraInstance.base.rotation_matrix,pCVar4);
    ...
    if (0 < this_ptr->room_count) {
      ...
      pCVar6 = &local_20->extents;
      do {
        world_position = &local_20[iVar8].position;
        ...
        if (iVar8 == local_1c) {
          in_stack_fffff2de = &local_64;
          local_64.vtable = (CKeys_vtable *)-pCVar6->x;
          local_60 = -pCVar6->y;
          local_5c = -pCVar6->z;
          core_setedit_cpp_FUN_005817d0(in_stack_fffff2de);
          ...
          local_ac.y = -pCVar6->y;
          local_ac.z = -pCVar6->z;
          in_stack_fffff2e2 = (CVector3f *)0x581daa;
          shape_edittool_cpp_CEditorTools_draw3DWireframeCube_FUN_004a2050
                    (g_CEditorToolsPtr,&local_ac,pCVar6,CONCAT31 /* combine 2-byte values */(extraout_var,uVar3));
        }
        else {
          in_stack_fffff2de = &local_c4;
          local_c4.vtable = (CKeys_vtable *)-pCVar6->x;
          local_c0 = -pCVar6->y;
          local_bc = -pCVar6->z;
          in_stack_fffff2e2 = pCVar6;
          core_setedit_cpp_FUN_005817d0(in_stack_fffff2de);
        }
        engine_drender_cpp_CDemonRenderer_matrixPop_FUN_0050d720();
        local_14 = (CMatrix3x3f *)((int)(local_14 + 1) + 0x20);
        pCVar6 = (CVector3f *)&pCVar6[5].z;
        iVar8 = iVar8 + 1;
      } while (iVar8 < this_ptr->room_count);
    }
    if (local_18 == (SRoom *)0x0) {
      pcVar7 = "No room selected";
      pcVar9 = local_194;
      do {
        cVar1 = *pcVar7;
        *pcVar9 = cVar1;
    ...
    if (local_18 == (SRoom *)0x0) {
      ...
      this_ptr_00 = (CSlew *)0x38;
      d2 = g_CKeysPtr;
      local_34 = local_38;
      iVar8 = (*g_CKeysPtr->vtable->getKeyState)(g_CKeysPtr,0x38);
      if (iVar8 == 0) {
        in_stack_fffff302 = 0x2a;
        this_ptr_00 = (CSlew *)0x5827bc;
        in_stack_fffff2fe = (CPickList *)g_CKeysPtr;
      ...
      if (iVar8 == 0) {
        ...
        pSVar2 = local_18;
        if ((CVector3f *)(local_ec + 0xc) != pCVar6) {
          local_ec._12_4_ = pCVar6->x;
          local_dc = pCVar6->y;
          local_d8 = pCVar6->z;
        }
        ...
        in_stack_fffff2de = (CKeys *)0x5826f1;
        in_stack_fffff2e2 = (CVector3f *)g_CKeysPtr;
        ...
        in_stack_fffff2fe = (CPickList *)&DAT_00000048;
        d2 = (CKeys *)0x58274e;
        this_ptr_00 = (CSlew *)g_CKeysPtr;
    ...
    if (iVar8 != 0) {
      ...
      shape_edittool_cpp_CPickList_dtor_FUN_004a3c80
                (&local_8e4,0,(uint)in_stack_fffff2de,(uint)in_stack_fffff2e2,d4,(uint)d5,(uint)d6);
    }
    iVar8 = (*g_CKeysPtr->vtable->getAndClearKeyState)(g_CKeysPtr,0xf);
    if (iVar8 != 0) {
      in_stack_fffff2de = g_CKeysPtr;
      iVar8 = (*g_CKeysPtr->vtable->getKeyState)(g_CKeysPtr,0x2a);
      if (iVar8 == 0) {
        local_1c = local_1c + 1;
    ...
    in_stack_fffff2e2 = (CVector3f *)0x581f6b;
    ...
    if (iVar8 != 0) {
      if (this_ptr->room_count < 0x14) {
        ...
        in_stack_fffff2e2 = (CVector3f *)0x582016;
        iVar8 = shape_edittool_cpp_CPickList_displayChoicesAndWaitForInput_FUN_004a3e20
                          (&local_53c,"Create new room",DAT_03365cbc,0);
        if (iVar8 < 0) {
          shape_edittool_cpp_CPickList_dtor_FUN_004a3c80
                    (&local_53c,0,(uint)d2,(uint)this_ptr_00,(uint)in_stack_fffff2fe,
                     in_stack_fffff302,(uint)in_stack_fffff306);
        }
        else {
          DAT_03365cbc = iVar8;
          shape_edittool_cpp_CPickList_dtor_FUN_004a3c80
    ...
    if ((((iVar5 != 0) && (-1 < local_1c)) && (local_1c < this_ptr->room_count)) &&
      ...
      crt_string_c_memmove_FUN_005fe5e0
                (local_20 + iVar8,local_20 + iVar8 + 1,(iVar5 - iVar8) * 0x44);
      if (this_ptr->room_count <= iVar8) {
        local_1c = 0;
      }
      local_18 = (SRoom *)0x0;
    }
    ...
    in_stack_fffff2fe = (CPickList *)g_CKeysPtr;
    iVar8 = (*g_CKeysPtr->vtable->getAndClearKeyState)(g_CKeysPtr,0x1c);
    pSVar2 = local_18;
    if ((iVar8 != 0) && (local_18 != (SRoom *)0x0)) {
      shape_edittool_cpp_CPickList_ctor_FUN_004a3b90(&local_c8c);
      shape_edittool_cpp_CStrList_add_FUN_004a2b80(&local_c8c.base_strlist,"Outside");
      shape_edittool_cpp_CStrList_add_FUN_004a2b80(&local_c8c.base_strlist,"Small");
      shape_edittool_cpp_CStrList_add_FUN_004a2b80
                (&local_c8c.base_strlist,"Medium (e.g. Mausoleum)");
      shape_edittool_cpp_CStrList_add_FUN_004a2b80
                (&local_c8c.base_strlist,"Large (e.g. Warehouse)");
      shape_edittool_cpp_CStrList_add_FUN_004a2b80(&local_c8c.base_strlist,"Humongous");
      in_stack_fffff2fe = &local_c8c;
      iVar8 = shape_edittool_cpp_CPickList_displayChoicesAndWaitForInput_FUN_004a3e20
                        (in_stack_fffff2fe,"Choose room size",pSVar2->field4_0x40,0);
      if (-1 < iVar8) {
        pSVar2->field4_0x40 = iVar8;
      }
      shape_edittool_cpp_CPickList_dtor_FUN_004a3c80
                (&local_c8c,0,d2_00,(uint)pCVar4,in_stack_fffff316,in_stack_fffff31a,
                 in_stack_fffff31e);
    }
    in_stack_fffff302 = 0x582260;
    in_stack_fffff306 = g_CKeysPtr;
    ...
    if (iVar8 != 0) {
      ...
      in_stack_fffff306 = (CKeys *)0x582465;
