...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_setedit_cpp_showDementedLightEditor_FUN_0057c5d0(CDemonSet *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 0057c5e4
    CALL core_setedit.cpp_CDemonSet_BuildingThumbnailImages_FUN_00576da0 ; 0057c5e5
    ...
    DEC EDI                             ; 0057cd09
    MOV AL,byte ptr [ESI]               ; 0057cd0a | = ".set" | DAT_00647c8c
        ;   Label: LAB_0057cd0a
    MOV byte ptr [EDI],AL               ; 0057cd0c
    CMP AL,0x0                          ; 0057cd0e
    JZ 0x0057cd22                       ; 0057cd10
        ;   XREF to: 0057cd22 (CONDITIONAL_JUMP)  ; LAB_0057cd22
    MOV AL,byte ptr [ESI + 0x1]         ; 0057cd12 | DAT_00647c8b | DAT_00647c8d
