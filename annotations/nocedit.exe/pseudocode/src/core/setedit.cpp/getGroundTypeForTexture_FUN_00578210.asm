...
section .text
    ...
    PUSH EBX                            ; 00578210
        ;   Label: core_setedit.cpp_getGroundTypeForTexture_FUN_00578210
    PUSH ESI                            ; 00578211
    PUSH EDI                            ; 00578212
    ...
    CALL engine_dosio.cpp_splitPath_FUN_00481f20 ; 0057822e
    ...
    MOV ECX,dword ptr [0x03654368]      ; 00578233 | g_GroundTextureCount
    ADD ESP,0x14                        ; 00578239
    TEST ECX,ECX                        ; 0057823c
    JLE 0x00578277                      ; 0057823e
        ;   XREF to: 00578277 (CONDITIONAL_JUMP)  ; LAB_00578277
    MOV ESI,0x3654370                   ; 00578240 | g_GroundTextureNames
    MOV EAX,ESP                         ; 00578245
        ;   Label: LAB_00578245
    PUSH EAX                            ; 00578247
    PUSH ESI                            ; 00578248 | g_GroundTextureNames | g_GroundTextureNames[1][0]
    CALL crt_string.c__stricmp_FUN_005fe7f0 ; 00578249
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)  ; int crt_string.c__stricmp_FUN_005fe7f0(char * str1, char * str2)
    ADD ESP,0x8                         ; 0057824e
    TEST EAX,EAX                        ; 00578251
    JNZ 0x00578269                      ; 00578253
        ;   XREF to: 00578269 (CONDITIONAL_JUMP)  ; LAB_00578269
    TEST EBX,EBX                        ; 00578255
    JL 0x00578277                       ; 00578257
        ;   XREF to: 00578277 (CONDITIONAL_JUMP)  ; LAB_00578277
    MOV AL,byte ptr [EBX + 0x3659190]   ; 00578259 | g_GroundTextureTypes
    ADD ESP,0x100                       ; 0057825f
    POP EDI                             ; 00578265
    POP ESI                             ; 00578266
    POP EBX                             ; 00578267
    RET                                 ; 00578268
    MOV EDI,dword ptr [0x03654368]      ; 00578269 | g_GroundTextureCount
        ;   Label: LAB_00578269
    INC EBX                             ; 0057826f
    ADD ESI,0x28                        ; 00578270
    CMP EBX,EDI                         ; 00578273
    JL 0x00578245                       ; 00578275
        ;   XREF to: 00578245 (CONDITIONAL_JUMP)  ; LAB_00578245
