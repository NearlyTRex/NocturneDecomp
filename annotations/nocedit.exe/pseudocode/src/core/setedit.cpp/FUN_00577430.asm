...
section .text
    ...
    JL 0x0057759a                       ; 00577441 | LAB_0057759a
        ;   XREF to: 0057759a (CONDITIONAL_JUMP)
    TEST ECX,ECX                        ; 00577447
    JL 0x0057759a                       ; 00577449 | LAB_0057759a
        ;   XREF to: 0057759a (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x00679394]      ; 0057744f | int g_WindowWidth
    LEA EAX,[EBX + 0x40]                ; 00577455
    CMP EAX,EDX                         ; 00577458
    JG 0x0057759a                       ; 0057745a | LAB_0057759a
        ;   XREF to: 0057759a (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [0x00679398]      ; 00577460 | int g_WindowHeight
    LEA EAX,[ECX + 0x30]                ; 00577466
    CMP EAX,ESI                         ; 00577469
    JG 0x0057759a                       ; 0057746b | LAB_0057759a
        ;   XREF to: 0057759a (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [ESP + 0x5c]      ; 00577471
    LEA EAX,[EDX*0x4 + 0x0]             ; 00577475
    SUB EAX,EDX                         ; 0057747c
    MOV EDI,dword ptr [0x0067939c]      ; 0057747e | int g_BitsPerPixel
    SHL EAX,0xc                         ; 00577484
    SHL ECX,0x2                         ; 00577487
    LEA EDX,[EAX + 0x100]               ; 0057748a
    CMP EDI,0x8                         ; 00577490
    JZ 0x005775a2                       ; 00577493 | LAB_005775a2
        ;   XREF to: 005775a2 (CONDITIONAL_JUMP)
    CMP EDI,0x10                        ; 00577499
    JNZ 0x00577651                      ; 0057749c | LAB_00577651
    ...
    MOV EAX,dword ptr [EAX + 0x2cf6a9c] ; 005774c2 | void *[1024] g_ScreenBufferArray
    ...
    MOV ESI,dword ptr [EBX + 0x3365cc0] ; 005774e6 | DAT_03365cc0
        ;   Label: LAB_005774e6
    XOR EDX,EDX                         ; 005774ec
    MOV EAX,ESI                         ; 005774ee
    MOV ECX,ESI                         ; 005774f0
    MOV EBP,ESI                         ; 005774f2
    MOV ESI,dword ptr [0x02d01f28]      ; 005774f4 | int g_RedScaleFactor
    ...
    DIV dword ptr [0x02d01f34]          ; 00577510 | int g_GreenScaleFactor
    ...
    DIV dword ptr [0x02d01f40]          ; 00577528 | int g_BlueScaleFactor
    MOV CL,byte ptr [0x02d01f24]        ; 0057752e | int g_RedBitPosition
    MOV dword ptr [ESP],EAX             ; 00577534
    MOV EAX,EDI                         ; 00577537
    SHL EAX,CL                          ; 00577539
    MOV CL,byte ptr [0x02d01f30]        ; 0057753b | int g_GreenBitPosition
    MOV EDX,dword ptr [ESP]             ; 00577541
    SHL ESI,CL                          ; 00577544
    MOV CL,byte ptr [0x02d01f3c]        ; 00577546 | int g_BlueBitPosition
    OR EAX,ESI                          ; 0057754c
    SHL EDX,CL                          ; 0057754e
    OR EAX,EDX                          ; 00577550
    ...
    JNZ 0x005774e6                      ; 00577569 | LAB_005774e6
    ...
    JL 0x005774ba                       ; 00577594 | LAB_005774ba
    ...
    MOV EAX,dword ptr [ESP + 0x28]      ; 005775bc
        ;   Label: LAB_005775bc
    MOV EAX,dword ptr [EAX + 0x2cf6a9c] ; 005775c0 | void *[1024] g_ScreenBufferArray
    ...
    MOV ECX,dword ptr [EAX + 0x3365cc0] ; 005775dc | DAT_03365cc0
        ;   Label: LAB_005775dc
    ...
    INC EBX                             ; 0057760f
    MOV CL,byte ptr [ECX + ESI*0x1 + 0x2cf9020] ; 00577610 | uchar[32768] g_ColorCubeLookup
    ADD EAX,0x4                         ; 00577617
    MOV byte ptr [EBX + -0x1],CL        ; 0057761a
    CMP EAX,EDX                         ; 0057761d
    JNZ 0x005775dc                      ; 0057761f | LAB_005775dc
    ...
    JGE 0x0057759a                      ; 00577646 | LAB_0057759a
        ;   XREF to: 0057759a (CONDITIONAL_JUMP)
    JMP 0x005775bc                      ; 0057764c | LAB_005775bc
        ;   XREF to: 005775bc (UNCONDITIONAL_JUMP)
    CMP EDI,0x20                        ; 00577651
        ;   Label: LAB_00577651
    JNZ 0x0057759a                      ; 00577654 | LAB_0057759a
        ;   XREF to: 0057759a (CONDITIONAL_JUMP)
    ...
    MOV EAX,dword ptr [EAX + 0x2cf6a9c] ; 0057767b | void *[1024] g_ScreenBufferArray
    ...
    MOV ECX,dword ptr [EAX + 0x3365cc0] ; 00577697 | DAT_03365cc0
        ;   Label: LAB_00577697
    MOV EDI,ECX                         ; 0057769d
    MOV ESI,ECX                         ; 0057769f
    MOV EBP,ECX                         ; 005776a1
    MOV ECX,dword ptr [0x0067939c]      ; 005776a3 | int g_BitsPerPixel
    ...
    JNZ 0x00577721                      ; 005776c4 | LAB_00577721
        ;   XREF to: 00577721 (CONDITIONAL_JUMP)
    MOV CL,byte ptr [0x02d01f24]        ; 005776c6 | int g_RedBitPosition
    SHL EDI,CL                          ; 005776cc
    MOV CL,byte ptr [0x02d01f30]        ; 005776ce | int g_GreenBitPosition
    SHL ESI,CL                          ; 005776d4
    MOV CL,byte ptr [0x02d01f3c]        ; 005776d6 | int g_BlueBitPosition
    SHL EBP,CL                          ; 005776dc
    OR ESI,EDI                          ; 005776de
    ...
    JNZ 0x00577697                      ; 005776ef | LAB_00577697
    ...
    JGE 0x0057759a                      ; 00577716 | LAB_0057759a
        ;   XREF to: 0057759a (CONDITIONAL_JUMP)
    JMP 0x00577673                      ; 0057771c | LAB_00577673
    ...
    OR ECX,EDI                          ; 00577729
    OR ECX,EBP                          ; 0057772b
    JMP 0x005776e4                      ; 0057772d | LAB_005776e4
