...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_setedit_cpp_CDemonSet_FUN_00578a20(CDemonSet *this_ptr)
;
; Parameters:
...
;
; Called Functions:
;   core_setedit.cpp_CDemonSet_FUN_00578c60
...
section .text
    ...
    PUSH EBX                            ; 00578a20
        ;   Label: core_setedit.cpp_CDemonSet_FUN_00578a20
    PUSH ESI                            ; 00578a21
    PUSH EDI                            ; 00578a22
    PUSH EBP                            ; 00578a23
    ...
    PUSH EBX                            ; 00578b14
    PUSH EBP                            ; 00578b15
    CALL core_setedit.cpp_CDemonSet_FUN_00578c60 ; 00578b16
        ;   XREF to: 00578c60 (UNCONDITIONAL_CALL)  ; void core_setedit.cpp_CDemonSet_FUN_00578c60(CDemonSet * this_ptr)
