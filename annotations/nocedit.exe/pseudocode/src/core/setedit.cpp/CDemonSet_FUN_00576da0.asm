...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_setedit_cpp_CDemonSet_FUN_00576da0(CDemonSet *this_ptr)
;
; Parameters:
...
;   core_setedit.cpp_CDemonSet_FUN_0057e7c0 at 0057f200
;   core_setedit.cpp_CDemonSet_FUN_00580730 at 00580745
...
;   core_setedit.cpp_C3DSCamera_FUN_005769a0
...
section .text
    ...
    PUSH EBX                            ; 00576da0
        ;   Label: core_setedit.cpp_CDemonSet_FUN_00576da0
    PUSH ESI                            ; 00576da1
    PUSH EDI                            ; 00576da2
    PUSH EBP                            ; 00576da3
    ...
    PUSH EDX                            ; 00576db1
    CALL core_setedit.cpp_CDemonSet_FUN_00580560 ; 00576db2
    ...
    PUSH 0x3653fc0                      ; 00576e82 | CPickList_03653fc0
    ...
    PUSH EDI                            ; 00576ee0
    CALL core_setedit.cpp_C3DSCamera_FUN_005769a0 ; 00576ee1
        ;   XREF to: 005769a0 (UNCONDITIONAL_CALL)  ; void core_setedit.cpp_C3DSCamera_FUN_005769a0(C3DSCamera * this_ptr)
    ADD ESP,0xc                         ; 00576ee6
    PUSH EBP                            ; 00576ee9
    PUSH 0x646720                       ; 00576eea | = "n"
    PUSH EDI                            ; 00576eef
    CALL core_setedit.cpp_C3DSCamera_FUN_005769a0 ; 00576ef0
        ;   XREF to: 005769a0 (UNCONDITIONAL_CALL)  ; void core_setedit.cpp_C3DSCamera_FUN_005769a0(C3DSCamera * this_ptr)
    ...
    PUSH EDI                            ; 00576f01
    CALL core_setedit.cpp_C3DSCamera_FUN_005769a0 ; 00576f02
        ;   XREF to: 005769a0 (UNCONDITIONAL_CALL)  ; void core_setedit.cpp_C3DSCamera_FUN_005769a0(C3DSCamera * this_ptr)
    ...
    PUSH EDI                            ; 00576f11
    INC ESI                             ; 00576f12
    CALL core_setedit.cpp_C3DSCamera_FUN_005769a0 ; 00576f13
        ;   XREF to: 005769a0 (UNCONDITIONAL_CALL)  ; void core_setedit.cpp_C3DSCamera_FUN_005769a0(C3DSCamera * this_ptr)
        ;   Label: LAB_00576f13
    ...
    PUSH 0x0                            ; 00576f88
    PUSH 0x3653fc0                      ; 00576f8a | CPickList_03653fc0
    ...
    PUSH 0x3653fc0                      ; 00576fa0 | CPickList_03653fc0
    ...
    PUSH 0x3653fc0                      ; 00576fad | CPickList_03653fc0
        ;   Label: LAB_00576fad
    ...
    CALL core_setdir.cpp_CDemonSet_saveThumbs_FUN_00575f60 ; 0057702e
