      ...
      if (0 < g_MasterLightCount) {
        ...
        do {
          core_dlight_cpp_CDemonLight_renderShadowMapDebugView_FUN_00473390
                    (*(CDemonLight **)((int)g_MasterLightList + local_18),iVar9,iVar6,iVar8);
          if ((((iVar9 <= g_MouseX) && (g_MouseX < iVar9 + iVar8)) && (iVar6 <= g_MouseY)) &&
             (g_MouseY < iVar6 + iVar8)) {
            local_24 = local_1c;
            local_34 = iVar9 + iVar8 + -1;
            g_ActiveRenderColor = 1;
            local_30 = iVar6 + iVar8 + -1;
            engine_2d_c_drawLine_FUN_004011b0(iVar9,iVar6,local_34,iVar6);
            engine_2d_c_drawLine_FUN_004011b0(iVar9,local_30,local_34,local_30);
            engine_2d_c_drawLine_FUN_004011b0(iVar9,iVar6,iVar9,local_30);
            engine_2d_c_drawLine_FUN_004011b0(local_34,iVar6,local_34,local_30);
          }
          iVar4 = iVar9 + iVar8;
          engine_2d_c_drawText_FUN_00401fd0
                    ((char *)(*(int *)((int)g_MasterLightList + local_18) + 0x40),iVar9,iVar6);
    ...
    if (0 < g_MasterLightCount) {
      ...
      do {
        crt_stdio_c_sprintf_FUN_005fdbd0
                  (local_134,"%2d. %s",iVar9,
                   *(int *)((int)g_MasterLightList + local_20) + 0x40);
        engine_2d_c_drawText_FUN_00401fd0(local_134,iVar6,iVar8);
        iVar8 = iVar8 + 0xb;
      ...
      if (local_28 < 0x34) {
        ...
        iVar6 = shape_edittool_cpp_CEditorTools_promptForValidFloat_FUN_004a00f0
                          (g_CEditorToolsPtr,"Set ambient level (0..100)",
                           (float *)&stack0xfffff028,true,0.0,100.0,true);
        if (iVar6 != 0) {
        ...
        bVar3 = shape_edittool_cpp_CEditorTools_showFilenameInputDialog_FUN_0049fb70
                          (g_CEditorToolsPtr,"Save set","models",0x647c8f,
                           SUB41 /* extract 2-byte value */(local_134,0));
