...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_setedit.cpp_CDemonSet_save_FUN_0057a2a0(CDemonSet * this_ptr, char * filename)
;
; Parameters:
...
;   core_setedit.cpp_DementedCameraEditor_FUN_0057e7c0 at 0057ed41
;   core_setedit.cpp_DementedFogEditor_FUN_00580730 at 00580e54
;   core_setedit.cpp_showDementedLightEditor_FUN_0057c5d0 at 0057cd6f
;
; Referenced Globals:
...
section .text
    ...
    PUSH 0x64741d                       ; 0057a2af | = "wt" | s_wt_0064741d = wt
    MOV EDX,dword ptr [EBP + 0x18]      ; 0057a2b4
    PUSH EDX                            ; 0057a2b7
    MOV EAX,dword ptr [EBP + 0x14]      ; 0057a2b8
    PUSH 0x647420                       ; 0057a2bb | = "models" | s_models_00647420 = models
    MOV dword ptr [EAX + 0x15acac],0x1c ; 0057a2c0
    CALL engine_dosio.c_getFile_FUN_00481a50 ; 0057a2ca | FILE * engine_dosio.c_getFile_FUN_00481a50(char * directory, char * filename, char * mode)
        ;   XREF to: 00481a50 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0057a2cf
    MOV ESI,EAX                         ; 0057a2d2
    TEST EAX,EAX                        ; 0057a2d4
    JZ 0x0057a8bc                       ; 0057a2d6 | LAB_0057a8bc
    ...
    PUSH ESI                            ; 0057a2eb
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a2ec | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    PUSH ESI                            ; 0057a308
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a309 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0057a30e
    PUSH 0x647464                       ; 0057a311 | = "unused.act\n" | s_unused_act_00647464 = unused.act

    PUSH ESI                            ; 0057a316
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a317 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 0057a32d
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a32e | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 0057a34a
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a34b | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0057a35c
    CALL core_dcamera.cpp_saveCameraFog_FUN_00453f10 ; 0057a35d | void core_dcamera.cpp_saveCameraFog_FUN_00453f10(SFog * fog, FILE * file_handle)
        ;   XREF to: 00453f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0057a362
    PUSH 0x647478                       ; 0057a365 | = "waterHeight,waterTileSize\n" | s_waterHeight_waterTileSiz_00647478 = waterHeight,waterTileSize

    PUSH ESI                            ; 0057a36a
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a36b | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0057a370
    MOV EAX,[0x006844f0]                ; 0057a373 | CWater g_CWaterInstance | CWater * g_CWaterPtr
    ...
    PUSH ESI                            ; 0057a38f
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a390 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x18                        ; 0057a395
    PUSH 0x64749a                       ; 0057a398 | = "useEnviroModel,enviroModelName\n" | s_useEnviroModel_enviroMod_0064749a = useEnviroModel,enviroModelName

    PUSH ESI                            ; 0057a39d
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a39e | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 0057a3be
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a3bf | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0057a3c4
    PUSH 0x6474c1                       ; 0057a3c7 | = "transparentWaterFlag\n" | s_transparentWaterFlag_006474c1 = transparentWaterFlag

    PUSH ESI                            ; 0057a3cc
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a3cd | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    MOV EAX,[0x006844f0]                ; 0057a3d2 | CWater g_CWaterInstance | CWater * g_CWaterPtr
    ADD ESP,0x8                         ; 0057a3d7
    MOV ECX,dword ptr [EAX]             ; 0057a3da | CWater g_CWaterInstance
    PUSH ECX                            ; 0057a3dc
    PUSH 0x6474d7                       ; 0057a3dd | = "%d\n" | s_d_006474d7 = %d

    PUSH ESI                            ; 0057a3e2
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a3e3 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0057a3e8
    PUSH 0x6474db                       ; 0057a3eb | = "hasSky\n" | s_hasSky_006474db = hasSky

    PUSH ESI                            ; 0057a3f0
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a3f1 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 0057a408
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a409 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0057a40e
    MOV EAX,dword ptr [EBP + 0x14]      ; 0057a411
    CMP dword ptr [EAX + 0x161628],0x0  ; 0057a414
    JNZ 0x0057a8e4                      ; 0057a41b | LAB_0057a8e4
        ;   XREF to: 0057a8e4 (CONDITIONAL_JUMP)
    PUSH 0x6474e7                       ; 0057a421 | = "0,none\n" | s_s_0_none_006474e7 = 0,none

    PUSH ESI                            ; 0057a426
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a427 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0057a42c
    PUSH 0x6474f6                       ; 0057a42f | = "useWorldGeometryFlag,worldGeometryName\n" | s_useWorldGeometryFlag_wor_006474f6 = useWorldGeometryFlag,worldGeometryName

        ;   Label: LAB_0057a42f
    PUSH ESI                            ; 0057a434
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a435 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0057a43a
    MOV EAX,dword ptr [EBP + 0x14]      ; 0057a43d
    CMP dword ptr [EAX + 0x15ae4c],0x0  ; 0057a440
    JZ 0x0057a907                       ; 0057a447 | LAB_0057a907
        ;   XREF to: 0057a907 (CONDITIONAL_JUMP)
    ADD EAX,0x15ae50                    ; 0057a44d
    PUSH EAX                            ; 0057a452
    PUSH 0x64751e                       ; 0057a453 | = "1,%s\n" | s_s_1_s_0064751e = 1,%s

    PUSH ESI                            ; 0057a458
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a459 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0057a45e
    PUSH 0x64752c                       ; 0057a461 | = "weatherType\n" | s_weatherType_0064752c = weatherType

        ;   Label: LAB_0057a461
    PUSH ESI                            ; 0057a466
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a467 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 0057a47e
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a47f | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0057a484
    PUSH 0x64753d                       ; 0057a487 | = "lightCount\n" | s_lightCount_0064753d = lightCount

    PUSH ESI                            ; 0057a48c
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a48d | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 0057a4a4
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a4a5 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JLE 0x0057a4e0                      ; 0057a4ba | LAB_0057a4e0
        ;   XREF to: 0057a4e0 (CONDITIONAL_JUMP)
    LEA EBX,[EAX + 0x19a30]             ; 0057a4bc
    PUSH ESI                            ; 0057a4c2
        ;   Label: LAB_0057a4c2
    PUSH EBX                            ; 0057a4c3
    CALL core_setutil.cpp_C3DSLight_save_FUN_00587090 ; 0057a4c4 | void core_setutil.cpp_C3DSLight_save_FUN_00587090(C3DSLight * this_ptr, FILE * file_ptr)
    ...
    JL 0x0057a4c2                       ; 0057a4de | LAB_0057a4c2
        ;   XREF to: 0057a4c2 (CONDITIONAL_JUMP)
    PUSH 0x64754d                       ; 0057a4e0 | = "cameraCount\n" | s_cameraCount_0064754d = cameraCount

        ;   Label: LAB_0057a4e0
    PUSH ESI                            ; 0057a4e5
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a4e6 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 0057a4f9
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a4fa | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JLE 0x0057a530                      ; 0057a50b | LAB_0057a530
        ;   XREF to: 0057a530 (CONDITIONAL_JUMP)
    LEA EDI,[EAX + 0x4]                 ; 0057a50d
    PUSH ESI                            ; 0057a510
        ;   Label: LAB_0057a510
    PUSH EDI                            ; 0057a511
    CALL core_setutil.cpp_C3DSCamera_save_FUN_00585a40 ; 0057a512 | void core_setutil.cpp_C3DSCamera_save_FUN_00585a40(C3DSCamera * this_ptr, FILE * file_handle)
    ...
    JL 0x0057a510                       ; 0057a528 | LAB_0057a510
        ;   XREF to: 0057a510 (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 0057a52a
    PUSH 0x64755e                       ; 0057a530 | = "Room size info\n" | s_Room_size_info_0064755e = Room size info

        ;   Label: LAB_0057a530
    PUSH ESI                            ; 0057a535
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a536 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 0057a54d
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a54e | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 0057a565
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a566 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JLE 0x0057a680                      ; 0057a57b | LAB_0057a680
    ...
    PUSH 0x647576                       ; 0057a5c0 | = "%g,%g,%g\n" | s_g_g_g_00647576 = %g,%g,%g

    PUSH ESI                            ; 0057a5c5
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a5c6 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH 0x647580                       ; 0057a5e9 | = "%g,%g,%g\n" | s_g_g_g_00647580 = %g,%g,%g

    PUSH ESI                            ; 0057a5ee
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a5ef | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0057a603
    CALL core_dirmat.cpp_CMatrix3x3f_getEulerAngles_FUN_00472160 ; 0057a604 | CVector3f * core_dirmat.cpp_CMatrix3x3f_getEulerAngles_FUN_00472160(CMatrix3x3f * this_ptr, CVector3f * euler_angles)
    ...
    PUSH 0x64758a                       ; 0057a630 | = "%g,%g,%g\n" | s_g_g_g_0064758a = %g,%g,%g

    PUSH ESI                            ; 0057a635
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a636 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 0057a647
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a648 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JL 0x0057a59c                       ; 0057a66d | LAB_0057a59c
        ;   XREF to: 0057a59c (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 0057a673
    LEA EDX,[EDX]                       ; 0057a679
    NOP                                 ; 0057a67f
    PUSH 0x647598                       ; 0057a680 | = "Default ground type\n" | s_Default_ground_type_00647598 = Default ground type

        ;   Label: LAB_0057a680
    PUSH ESI                            ; 0057a685
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a686 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 0057a69d
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a69e | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0057a6a3
    PUSH 0x6475b1                       ; 0057a6a6 | = "Default master reverb\n" | s_Default_master_reverb_006475b1 = Default master reverb

    PUSH ESI                            ; 0057a6ab
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a6ac | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 0057a6c3
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a6c4 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0057a6c9
    PUSH 0x6475cc                       ; 0057a6cc | = "Virtual director boxes\n" | s_Virtual_director_boxes_006475cc = Virtual director boxes

    PUSH ESI                            ; 0057a6d1
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a6d2 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 0057a6e9
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a6ea | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JLE 0x0057a7e0                      ; 0057a6ff | LAB_0057a7e0
    ...
    PUSH 0x6475e8                       ; 0057a73e | = "%g,%g,%g\n" | s_g_g_g_006475e8 = %g,%g,%g

    PUSH ESI                            ; 0057a743
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a744 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH 0x6475f2                       ; 0057a767 | = "%g,%g,%g\n" | s_g_g_g_006475f2 = %g,%g,%g

    PUSH ESI                            ; 0057a76c
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a76d | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDX                            ; 0057a781
    CALL core_dirmat.cpp_CMatrix3x3f_getEulerAngles_FUN_00472160 ; 0057a782 | CVector3f * core_dirmat.cpp_CMatrix3x3f_getEulerAngles_FUN_00472160(CMatrix3x3f * this_ptr, CVector3f * euler_angles)
        ;   XREF to: 00472160 (UNCONDITIONAL_CALL)
    ...
    PUSH 0x6475fc                       ; 0057a7a8 | = "%g,%g,%g\n" | s_g_g_g_006475fc = %g,%g,%g

    PUSH ESI                            ; 0057a7ad
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a7ae | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JL 0x0057a71d                       ; 0057a7d3 | LAB_0057a71d
        ;   XREF to: 0057a71d (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 0057a7d9
    NOP                                 ; 0057a7df
    PUSH 0x647606                       ; 0057a7e0 | = "PVS list\n" | s_PVS_list_00647606 = PVS list

        ;   Label: LAB_0057a7e0
    PUSH ESI                            ; 0057a7e5
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a7e6 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JLE 0x0057a820                      ; 0057a7f7 | LAB_0057a820
        ;   XREF to: 0057a820 (CONDITIONAL_JUMP)
    LEA EBX,[EAX + 0x4]                 ; 0057a7f9
    PUSH ESI                            ; 0057a7fc
        ;   Label: LAB_0057a7fc
    PUSH EBX                            ; 0057a7fd
    CALL core_setutil.cpp_C3DSCamera_savePVS_FUN_00587450 ; 0057a7fe | int core_setutil.cpp_C3DSCamera_savePVS_FUN_00587450(C3DSCamera * this_ptr, FILE * file_handle)
    ...
    JL 0x0057a7fc                       ; 0057a814 | LAB_0057a7fc
        ;   XREF to: 0057a7fc (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 0057a816
    LEA EDX,[EDX]                       ; 0057a81c
    PUSH 0x74d                          ; 0057a820
        ;   Label: LAB_0057a820
    PUSH 0x647610                       ; 0057a825 | = "..\\core\\setedit.cpp" | s_core_setedit_cpp_00647610 = ..\core\setedit.cpp
    PUSH ESI                            ; 0057a82a
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 0057a82b | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
    ...
    CMP AL,0x0                          ; 0057a845
    JZ 0x0057a859                       ; 0057a847 | LAB_0057a859
    ...
    CMP AL,0x0                          ; 0057a855
    JNZ 0x0057a841                      ; 0057a857 | LAB_0057a841
    ...
    MOV AL,byte ptr [ESI]               ; 0057a85c
        ;   Label: LAB_0057a85c
    CMP AL,DL                           ; 0057a85e
    JZ 0x0057a874                       ; 0057a860 | LAB_0057a874
        ;   XREF to: 0057a874 (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 0057a862
    JZ 0x0057a872                       ; 0057a864 | LAB_0057a872
        ;   XREF to: 0057a872 (CONDITIONAL_JUMP)
    INC ESI                             ; 0057a866
    MOV AL,byte ptr [ESI]               ; 0057a867
    CMP AL,DL                           ; 0057a869
    JZ 0x0057a874                       ; 0057a86b | LAB_0057a874
        ;   XREF to: 0057a874 (CONDITIONAL_JUMP)
    INC ESI                             ; 0057a86d
    CMP AL,0x0                          ; 0057a86e
    JNZ 0x0057a85c                      ; 0057a870 | LAB_0057a85c
    ...
    JZ 0x0057a91a                       ; 0057a878 | LAB_0057a91a
        ;   XREF to: 0057a91a (CONDITIONAL_JUMP)
    MOV ESI,0x647624                    ; 0057a87e | = ".zth" | s_zth_00647624 = .zth
        ;   Label: LAB_0057a87e
    MOV EBX,dword ptr [EBP + 0x14]      ; 0057a883
    PUSH EDI                            ; 0057a886
    MOV AL,byte ptr [ESI]               ; 0057a887 | = ".zth" | s_zth_00647624 = .zth
        ;   Label: LAB_0057a887
    MOV byte ptr [EDI],AL               ; 0057a889
    CMP AL,0x0                          ; 0057a88b
    JZ 0x0057a89f                       ; 0057a88d | LAB_0057a89f
        ;   XREF to: 0057a89f (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0057a88f | DAT_00647625
    ADD ESI,0x2                         ; 0057a892
    MOV byte ptr [EDI + 0x1],AL         ; 0057a895
    ADD EDI,0x2                         ; 0057a898
    CMP AL,0x0                          ; 0057a89b
    JNZ 0x0057a887                      ; 0057a89d | LAB_0057a887
        ;   XREF to: 0057a887 (CONDITIONAL_JUMP)
    POP EDI                             ; 0057a89f
        ;   Label: LAB_0057a89f
    PUSH EBX                            ; 0057a8a0
    CALL core_setdir.cpp_CDemonSet_saveThumbs_FUN_00575f60 ; 0057a8a1 | void core_setdir.cpp_CDemonSet_saveThumbs_FUN_00575f60(CDemonSet * this_ptr)
        ;   XREF to: 00575f60 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0057a8a6
    MOV EAX,ESP                         ; 0057a8a9
    PUSH EAX                            ; 0057a8ab
    PUSH EBX                            ; 0057a8ac
    CALL core_setdir.cpp_CDemonSet_writeThumbs_FUN_00575e40 ; 0057a8ad | void core_setdir.cpp_CDemonSet_writeThumbs_FUN_00575e40(CDemonSet * this_ptr, char * filename)
    ...
    POP EBX                             ; 0057a8ba
    RET                                 ; 0057a8bb
    MOV ECX,0x647427                    ; 0057a8bc | = "..\\core\\setedit.cpp" | s_core_setedit_cpp_00647427 = ..\core\setedit.cpp
        ;   Label: LAB_0057a8bc
    MOV EBX,0x6d6                       ; 0057a8c1
    PUSH 0x64743b                       ; 0057a8c6 | = "CDemonSet::Unable to save output" | s_CDemonSet_Unable_to_save_0064743b = CDemonSet::Unable to save output
    MOV dword ptr [0x02f0ca48],ECX      ; 0057a8cb | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 0057a8d1 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0057a8d7 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0057a8dc
    JMP 0x0057a2dc                      ; 0057a8df | LAB_0057a2dc
    ...
    PUSH ESI                            ; 0057a8f9
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a8fa | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0057a8ff
    JMP 0x0057a42f                      ; 0057a902 | LAB_0057a42f
        ;   XREF to: 0057a42f (UNCONDITIONAL_JUMP)
    PUSH 0x647524                       ; 0057a907 | = "0,none\n" | s_s_0_none_00647524 = 0,none

        ;   Label: LAB_0057a907
    PUSH ESI                            ; 0057a90c
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0057a90d | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0057a912
    JMP 0x0057a461                      ; 0057a915 | LAB_0057a461
    ...
    MOV AL,byte ptr [ESI]               ; 0057a91e
        ;   Label: LAB_0057a91e
    CMP AL,DL                           ; 0057a920
    JZ 0x0057a936                       ; 0057a922 | LAB_0057a936
        ;   XREF to: 0057a936 (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 0057a924
    JZ 0x0057a934                       ; 0057a926 | LAB_0057a934
        ;   XREF to: 0057a934 (CONDITIONAL_JUMP)
    INC ESI                             ; 0057a928
    MOV AL,byte ptr [ESI]               ; 0057a929
    CMP AL,DL                           ; 0057a92b
    JZ 0x0057a936                       ; 0057a92d | LAB_0057a936
        ;   XREF to: 0057a936 (CONDITIONAL_JUMP)
    INC ESI                             ; 0057a92f
    CMP AL,0x0                          ; 0057a930
    JNZ 0x0057a91e                      ; 0057a932 | LAB_0057a91e
        ;   XREF to: 0057a91e (CONDITIONAL_JUMP)
    SUB ESI,ESI                         ; 0057a934
        ;   Label: LAB_0057a934
    MOV EDI,ESI                         ; 0057a936
        ;   Label: LAB_0057a936
    JMP 0x0057a87e                      ; 0057a938 | LAB_0057a87e
