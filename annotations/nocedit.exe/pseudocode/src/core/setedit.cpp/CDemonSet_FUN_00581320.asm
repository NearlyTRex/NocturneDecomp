...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_setedit_cpp_CDemonSet_FUN_00581320(CDemonSet *this_ptr)
;
; Parameters:
...
;
; XREF[1]:
;   core_setedit.cpp_CDemonSet_FUN_00580730 at 00580de6
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00581320
        ;   Label: core_setedit.cpp_CDemonSet_FUN_00581320
    PUSH ESI                            ; 00581321
    PUSH EDI                            ; 00581322
    PUSH EBP                            ; 00581323
