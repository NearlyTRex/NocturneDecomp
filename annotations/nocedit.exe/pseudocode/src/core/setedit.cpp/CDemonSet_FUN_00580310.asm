...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_setedit_cpp_CDemonSet_FUN_00580310(CDemonSet *this_ptr)
;
; Parameters:
...
;
; XREF[3]:
;   core_setedit.cpp_CDemonSet_FUN_0057a940 at 0057a99d
;   core_setedit.cpp_CDemonSet_FUN_0057fd00 at 0057fd0d
...
section .text
    ...
    PUSH EBX                            ; 00580310
        ;   Label: core_setedit.cpp_CDemonSet_FUN_00580310
    PUSH ESI                            ; 00580311
    PUSH EDI                            ; 00580312
    PUSH EBP                            ; 00580313
