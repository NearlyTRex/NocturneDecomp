...
undefined4 core_setedit_cpp_CDemonSet_unk201_FUN_0057ae50(void)

{
  ...
  local_20 = *(undefined4 *)(in_stack_00000008 + 0x11e0);
  local_18 = 1;
  local_14 = 0;
  local_1c = 0;
  *(undefined4 *)(in_stack_00000008 + 0x11e0) = 0;
  ...
  pvVar2 = PTR_DAT_00681ab8;
  if ((undefined4 *)PTR_DAT_00681ab8 != (undefined4 *)(in_stack_00000008 + 0x104)) {
    *(undefined4 *)PTR_DAT_00681ab8 = *(undefined4 *)(in_stack_00000008 + 0x104);
    *(undefined4 *)((int)pvVar2 + 4) = *(undefined4 *)(in_stack_00000008 + 0x108);
    *(undefined4 *)((int)pvVar2 + 8) = *(undefined4 *)(in_stack_00000008 + 0x10c);
  }
  pvVar2 = PTR_DAT_00681ab8;
  if ((undefined4 *)((int)PTR_DAT_00681ab8 + 0xc) != (undefined4 *)(in_stack_00000008 + 0x110)) {
    *(undefined4 *)((int)PTR_DAT_00681ab8 + 0xc) = *(undefined4 *)(in_stack_00000008 + 0x110);
    *(undefined4 *)((int)pvVar2 + 0x10) = *(undefined4 *)(in_stack_00000008 + 0x114);
    *(undefined4 *)((int)pvVar2 + 0x14) = *(undefined4 *)(in_stack_00000008 + 0x118);
  }
  pcVar5 = acStack_6c;
  pcVar4 = (char *)(in_stack_00000008 + 4);
  *(undefined4 *)((int)PTR_DAT_00681ab8 + 0x18) = *(undefined4 *)(in_stack_00000008 + 0x11c);
  do {
    cVar1 = *pcVar4;
    *pcVar5 = cVar1;
    if (cVar1 == '\0') break;
...
LAB_0057af67:
  ...
  if (in_stack_0000001c != 0) {
    ...
    fVar6 = (float10)*(float *)(in_stack_00000008 + 0x120) * (float10)DOUBLE_0064777d;
    this_ptr = *(CDemonLight **)(in_stack_00000008 + 0x124);
    crt_math_c_round_FUN_005fe6b0((double)CONCAT44(extraout_EDX,in_stack_00000008));
  ...
  goto LAB_0057af67;
LAB_0057b341:
  if ((undefined4 *)(in_stack_00000008 + 0x104) != (undefined4 *)PTR_DAT_00681ab8) {
                    /* WARNING: Load size is inaccurate */
    *(undefined4 *)(in_stack_00000008 + 0x104) = *PTR_DAT_00681ab8;
    *(undefined4 *)(in_stack_00000008 + 0x108) = *(undefined4 *)((int)pvVar2 + 4);
    *(undefined4 *)(in_stack_00000008 + 0x10c) = *(undefined4 *)((int)pvVar2 + 8);
  }
  pvVar2 = PTR_DAT_00681ab8;
  if ((undefined4 *)(in_stack_00000008 + 0x110) != (undefined4 *)((int)PTR_DAT_00681ab8 + 0xc)) {
    *(undefined4 *)(in_stack_00000008 + 0x110) = *(undefined4 *)((int)PTR_DAT_00681ab8 + 0xc);
    *(undefined4 *)(in_stack_00000008 + 0x114) = *(undefined4 *)((int)pvVar2 + 0x10);
    *(undefined4 *)(in_stack_00000008 + 0x118) = *(undefined4 *)((int)pvVar2 + 0x14);
  }
  pcVar5 = &stack0x00000058;
  in_stack_000000c0 = 1;
  pcVar4 = (char *)(in_stack_00000008 + 4);
  *(undefined4 *)(in_stack_00000008 + 0x11c) = *(undefined4 *)((int)PTR_DAT_00681ab8 + 0x18);
  do {
    cVar1 = *pcVar5;
    *pcVar4 = cVar1;
    if (cVar1 == '\0') break;
...
LAB_0057b3c9:
  ...
  *(undefined4 *)(in_stack_00000008 + 0x11e0) = in_stack_000000c4;
...
// 0057aecb: CALL core_slew.cpp_CSlew_init_FUN_005a2060
...
// 0057af8b: PUSH EAX
//   XREF to: 03f48f84 (DATA)
// 0057af8c: CALL core_slew.cpp_CSlew_processInput_FUN_005a20b0
...
// 0057b3cf: PUSH EDX
//   XREF to: 03f48f84 (DATA)
// 0057b3d0: CALL core_slew.cpp_CSlew_free_FUN_005a20a0
