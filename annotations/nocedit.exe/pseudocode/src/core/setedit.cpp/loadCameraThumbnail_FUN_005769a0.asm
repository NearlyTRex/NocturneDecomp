...
section .text
    ...
    PUSH EBX                            ; 005769a0
        ;   Label: core_setedit.cpp_loadCameraThumbnail_FUN_005769a0
    PUSH ESI                            ; 005769a1
    PUSH EDI                            ; 005769a2
    PUSH EBP                            ; 005769a3
    ...
    PUSH EAX                            ; 00576a2f
    PUSH 0x3653fc0                      ; 00576a30 | g_MissingBackdropFiles
    ...
    PUSH 0x1                            ; 00576aff
    PUSH 0x300                          ; 00576b01
    PUSH 0x3653cc0                      ; 00576b06 | g_ThumbnailPalette
