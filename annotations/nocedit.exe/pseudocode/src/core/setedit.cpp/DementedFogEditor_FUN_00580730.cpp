...
//   core_sound.cpp_CSound_unk1_FUN_005b3c70
//   core_sound.cpp_FUN_005b3d20
  ...
  *(undefined4 *)((int)unk + 0x15aea4) = 0;
  ...
  do {
    do {
      ...
      dVar16 = (double)*(float *)(iVar8 + 0x10);
      crt_stdio_c_sprintf_FUN_005fdbd0
                (acStack_124,"3.  Fog velocity : %f,%f,%f",(double)*(float *)(iVar8 + 0xc),
                 dVar16,(double)*(float *)(iVar8 + 0x14));
      uVar4 = SUB84(dVar16,0);
      engine_2d_c_drawText_FUN_00401fd0(acStack_120,0,0x37);
      in_stack_fffffa24 = CONCAT44(0x5808b9,uVar4);
      crt_stdio_c_sprintf_FUN_005fdbd0
      ...
      if (*(int *)((int)unk + *(int *)((int)unk + 0x15aea4) * 0x1a4 + 0x154) == 0) {
        uVar4 = core_sound_cpp_CSound_unk1_FUN_005b3c70();
        crt_stdio_c_sprintf_FUN_005fdbd0
                  (acStack_ec,"R.  Reverb for camera %s : %s",
                   *(int *)((int)unk + 0x15aea4) * 0x1a4 + in_stack_0000002c,uVar4);
      }
      else {
        uVar4 = core_sound_cpp_CSound_unk1_FUN_005b3c70();
        crt_stdio_c_sprintf_FUN_005fdbd0(acStack_ec,"R.  Default set reverb : %s",uVar4);
      }
    ...
    if (uVar7 < 0x37) {
      ...
      while( true ) {
        ...
        pcVar6 = (char *)core_sound_cpp_CSound_unk1_FUN_005b3c70();
        iVar8 = shape_edittool_cpp_CPickList_displayChoicesAndWaitForInput_FUN_004a3e20
                          ((CPickList *)&stack0xfffffadc,pcVar6,(int)config_param1,
        ...
        shape_edittool_cpp_CStrList_getStringAt_FUN_004a2f70((CStrList *)&stack0xfffffae8,iVar8);
...
// 005809bc: CALL core_sound.cpp_CSound_unk1_FUN_005b3c70
...
// 00580b44: PUSH ECX
//   XREF to: 03f6af64 (DATA)
// 00580b45: CALL core_sound.cpp_CSound_unk1_FUN_005b3c70
//   XREF to: 005b3c70 (UNCONDITIONAL_CALL)
...
// 00580eef: PUSH EDI
//   XREF to: 03f6af64 (DATA)
// 00580ef0: CALL core_sound.cpp_FUN_005b3d20
...
// 00580f3f: PUSH EBX
//   XREF to: 03f6af64 (DATA)
// 00580f40: CALL core_sound.cpp_FUN_005b3d20
//   XREF to: 005b3d20 (UNCONDITIONAL_CALL)
...
// 00580f86: CALL sound_sndmain.cpp_FUN_005aaef0
...
// 005810e7: PUSH EBX
//   XREF to: 03f6af64 (DATA)
// 005810e8: CALL core_sound.cpp_CSound_unk1_FUN_005b3c70
//   XREF to: 005b3c70 (UNCONDITIONAL_CALL)
