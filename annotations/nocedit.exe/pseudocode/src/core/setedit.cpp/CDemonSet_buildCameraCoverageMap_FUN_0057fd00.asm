...
;   core_setedit.cpp_CDemonSet_showScenePreview_FUN_0057a940 at 0057adcc
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0057fd00
        ;   Label: core_setedit.cpp_CDemonSet_buildCameraCoverageMap_FUN_0057fd00
    PUSH ESI                            ; 0057fd01
    PUSH EDI                            ; 0057fd02
    PUSH EBP                            ; 0057fd03
    ...
    PUSH EDX                            ; 0057fd0c
    CALL core_setedit.cpp_CDemonSet_buildCameraDepthData_FUN_00580310 ; 0057fd0d
    ...
    PUSH EAX                            ; 0057fd54
    CALL shape_memdbg.cpp_debugAllocTracked2_FUN_0050f1f0 ; 0057fd55
    ...
    JMP 0x0060c692                      ; 0057fdcd
        ;   XREF to: 0060c692 (UNCONDITIONAL_JUMP)  ; LAB_0060c692
    ...
    JMP 0x0060c41c                      ; 0057fdfc
        ;   XREF to: 0060c41c (UNCONDITIONAL_JUMP)  ; LAB_0060c41c
    ...
    MOV dword ptr [EDI],ECX             ; 0060c421
    MOV ECX,dword ptr [ESI + 0x4]       ; 0060c423
    MOV dword ptr [EDI + 0x4],ECX       ; 0060c426
    MOV ECX,dword ptr [ESI + 0x8]       ; 0060c429
    MOV dword ptr [EDI + 0x8],ECX       ; 0060c42c
    ADD ESI,0xc                         ; 0060c42f
    ADD EDI,0xc                         ; 0060c432
    JMP 0x0057fe02                      ; 0060c435
        ;   XREF to: 0057fe02 (UNCONDITIONAL_JUMP)  ; LAB_0057fe02
    MOV ECX,dword ptr [ESI]             ; 0060c692
        ;   Label: LAB_0060c692
    MOV dword ptr [EDI],ECX             ; 0060c694
    MOV ECX,dword ptr [ESI + 0x4]       ; 0060c696
    MOV dword ptr [EDI + 0x4],ECX       ; 0060c699
    MOV ECX,dword ptr [ESI + 0x8]       ; 0060c69c
    MOV dword ptr [EDI + 0x8],ECX       ; 0060c69f
    ADD ESI,0xc                         ; 0060c6a2
    ADD EDI,0xc                         ; 0060c6a5
    MOV ESI,dword ptr [EBP + -0x2c]     ; 0060c6a8
    JMP 0x0057fdd3                      ; 0060c6ab
        ;   XREF to: 0057fdd3 (UNCONDITIONAL_JUMP)  ; LAB_0057fdd3
