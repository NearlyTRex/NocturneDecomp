...
;
; XREF[3]:
;   core_setedit.cpp_CDemonSet_buildCameraCoverageMap_FUN_0057fd00 at 0057fd0d
;   core_setedit.cpp_CDemonSet_isPointVisibleFromCamera_FUN_005801b0 at 005801c0
;   core_setedit.cpp_CDemonSet_showScenePreview_FUN_0057a940 at 0057a99d
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00580310
        ;   Label: core_setedit.cpp_CDemonSet_buildCameraDepthData_FUN_00580310
    PUSH ESI                            ; 00580311
    PUSH EDI                            ; 00580312
    PUSH EBP                            ; 00580313
    SUB ESP,0x18                        ; 00580314
    CMP dword ptr [0x03659384],0x0      ; 00580317 | g_CameraDepthData
    ...
    MOV EAX,[0x03659384]                ; 005803c4 | g_CameraDepthData
    PUSH 0x0                            ; 005803c9
