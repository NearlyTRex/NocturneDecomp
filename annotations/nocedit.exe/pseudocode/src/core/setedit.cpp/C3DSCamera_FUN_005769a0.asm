...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_setedit_cpp_C3DSCamera_FUN_005769a0(C3DSCamera *this_ptr)
;
; Parameters:
...
;
; XREF[1]:
;   core_setedit.cpp_CDemonSet_FUN_00576da0 at 00576ee1
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 005769a0
        ;   Label: core_setedit.cpp_C3DSCamera_FUN_005769a0
    PUSH ESI                            ; 005769a1
    PUSH EDI                            ; 005769a2
    PUSH EBP                            ; 005769a3
