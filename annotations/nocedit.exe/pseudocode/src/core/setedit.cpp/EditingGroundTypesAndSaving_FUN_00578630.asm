...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_setedit_cpp_EditingGroundTypesAndSaving_FUN_00578630(void)
;
; Local Variables:
...
section .text
    ...
    MOV ESI,dword ptr [0x03654368]      ; 0057868b | DAT_03654368
    ...
    XOR EAX,EAX                         ; 0057869d
        ;   Label: LAB_0057869d
    MOV AL,byte ptr [EBX + 0x3659190]   ; 0057869f | DAT_03659190 | DAT_03659191
    PUSH EAX                            ; 005786a5
    ...
    MOV EAX,[0x03654368]                ; 005786db | DAT_03654368
    ...
    MOV EDX,dword ptr [0x03654368]      ; 00578748 | DAT_03654368
    ...
    LEA EAX,[ESP + 0xa78]               ; 0057875e
        ;   Label: LAB_0057875e
    PUSH EAX                            ; 00578765
    PUSH ESI                            ; 00578766 | DAT_03654370 | DAT_03654398
    ...
    MOV EBP,dword ptr [0x03654368]      ; 00578911 | DAT_03654368
        ;   Label: LAB_00578911
    ...
    XOR EAX,EAX                         ; 00578922
        ;   Label: LAB_00578922
    MOV AL,byte ptr [EBX + 0x3659190]   ; 00578924 | DAT_03659190 | DAT_03659191
    PUSH EAX                            ; 0057892a
    ...
    MOV EBP,dword ptr [0x03654368]      ; 00578944 | DAT_03654368
    ...
    MOV EAX,[0x03654368]                ; 005789b3 | DAT_03654368
        ;   Label: LAB_005789b3
    INC EBX                             ; 005789b8
