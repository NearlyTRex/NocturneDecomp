...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_setedit_cpp_FUN_00578210(void)
;
; Local Variables:
...
section .text
    ...
    MOV ECX,dword ptr [0x03654368]      ; 00578233 | DAT_03654368
    ...
    MOV EAX,ESP                         ; 00578245
        ;   Label: LAB_00578245
    PUSH EAX                            ; 00578247
    PUSH ESI                            ; 00578248 | DAT_03654370 | DAT_03654398
    ...
    JL 0x00578277                       ; 00578257
        ;   XREF to: 00578277 (CONDITIONAL_JUMP)  ; LAB_00578277
    MOV AL,byte ptr [EBX + 0x3659190]   ; 00578259 | DAT_03659190
    ADD ESP,0x100                       ; 0057825f
    POP EDI                             ; 00578265
    POP ESI                             ; 00578266
    POP EBX                             ; 00578267
    RET                                 ; 00578268
    MOV EDI,dword ptr [0x03654368]      ; 00578269 | DAT_03654368
        ;   Label: LAB_00578269
    INC EBX                             ; 0057826f
