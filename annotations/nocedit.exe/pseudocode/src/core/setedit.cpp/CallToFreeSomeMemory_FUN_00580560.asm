...
section .text
    ...
    PUSH ESI                            ; 00580561
    MOV EDX,0x64859e                    ; 00580562 | = "..\\core\\setedit.cpp" | s_core_setedit_cpp_0064859e = ..\core\setedit.cpp
    MOV ECX,0x1036                      ; 00580567
    MOV EBX,dword ptr [0x03659384]      ; 0058056c | undefined4 DAT_03659384
    XOR ESI,ESI                         ; 00580572
    PUSH EBX                            ; 00580574
    MOV dword ptr [0x0067d20c],EDX      ; 00580575 | char * g_CurrentDebugFilename
    MOV dword ptr [0x02f0d944],ECX      ; 0058057b | int g_CurrentDebugLine
    CALL crt_memory.c_free_FUN_005fe659 ; 00580581 | void crt_memory.c_free_FUN_005fe659(void * ptr)
        ;   XREF to: 005fe659 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00580586
    MOV dword ptr [0x03659384],ESI      ; 00580589 | undefined4 DAT_03659384
    POP ESI                             ; 0058058f
    POP EBX                             ; 00580590
    RET                                 ; 00580591
