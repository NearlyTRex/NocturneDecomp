  ...
  if ((DAT_03659384 == (void *)0x0) && (0 < *in_stack_00000004)) {
    ...
    if (0 < *in_stack_0000000c) {
      ...
      do {
        ...
        in_stack_00000004[3] = g_TransformMatrix.m[0][0];
        in_stack_00000004[4] = g_TransformMatrix.m[0][1];
        in_stack_00000004[5] = g_TransformMatrix.m[0][2];
        in_stack_00000004[6] = g_TransformMatrix.m[1][0];
        in_stack_00000004[7] = g_TransformMatrix.m[1][1];
        in_stack_00000004[8] = g_TransformMatrix.m[1][2];
        in_stack_00000004[9] = g_TransformMatrix.m[2][0];
        in_stack_00000004[10] = g_TransformMatrix.m[2][1];
        in_stack_00000004[0xb] = g_TransformMatrix.m[2][2];
