...
;
; Parameters:
; CVector3f *      Stack[0x4]:4   corner_a
; CVector3f *      Stack[0x8]:4   corner_b
; float            Stack[0xc]:4   opacity
; int              Stack[0x10]:4   r
; int              Stack[0x14]:4   g
; int              Stack[0x18]:4   b
; Local Variables:
; float            Stack[-0x60]:4  local_60
; SMRGLPrimitiveQuadIndex Stack[-0x54]:40  local_54
...
;
; XREF[2]:
;   core_setedit.cpp_CDemonSet_showRoomEditor_FUN_00581aa0 at 00581d54
;   core_setedit.cpp_CDemonSet_showVdirBoxEditor_FUN_00583170 at 00583514
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 005817d0
        ;   Label: core_setedit.cpp_renderColoredBox_FUN_005817d0
    PUSH ESI                            ; 005817d1
    PUSH EDI                            ; 005817d2
    PUSH EBP                            ; 005817d3
    ...
    PUSH EAX                            ; 005818a1
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 005818a2
    ...
    PUSH 0x6816c0                       ; 00581937 | g_SolidWhiteTexture
        ;   Label: LAB_00581937
    ...
    CALL engine_drender.cpp_CDemonRenderer_renderVertexAlphaDirect_FUN_0048bad0 ; 00581995
    ...
    CALL engine_drender.cpp_CDemonRenderer_renderVertexAlphaDirect_FUN_0048bad0 ; 005819c8
        ;   XREF to: 0048bad0 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_renderVertexAlphaDirect_FUN_0048bad0(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * prim)
    ...
    CALL engine_drender.cpp_CDemonRenderer_renderVertexAlphaDirect_FUN_0048bad0 ; 005819f7
        ;   XREF to: 0048bad0 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_renderVertexAlphaDirect_FUN_0048bad0(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * prim)
    ...
    CALL engine_drender.cpp_CDemonRenderer_renderVertexAlphaDirect_FUN_0048bad0 ; 00581a25
        ;   XREF to: 0048bad0 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_renderVertexAlphaDirect_FUN_0048bad0(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * prim)
    ...
    CALL engine_drender.cpp_CDemonRenderer_renderVertexAlphaDirect_FUN_0048bad0 ; 00581a55
        ;   XREF to: 0048bad0 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_renderVertexAlphaDirect_FUN_0048bad0(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * prim)
    ...
    CALL engine_drender.cpp_CDemonRenderer_renderVertexAlphaDirect_FUN_0048bad0 ; 00581a88
        ;   XREF to: 0048bad0 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_renderVertexAlphaDirect_FUN_0048bad0(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * prim)
