...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_setedit_cpp_CDemonSet_FUN_0057c550(CDemonSet *this_ptr)
;
; Parameters:
; CDemonSet *      Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_setedit.cpp_CDemonSet_showLightEditor_FUN_0057c5d0 at 0057cc12
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0057c550
        ;   Label: core_setedit.cpp_CDemonSet_FUN_0057c550
    PUSH ESI                            ; 0057c551
    PUSH EDI                            ; 0057c552
    PUSH EBP                            ; 0057c553
