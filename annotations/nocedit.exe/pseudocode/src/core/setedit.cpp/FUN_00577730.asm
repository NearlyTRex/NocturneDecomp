...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_setedit.cpp_FUN_00577730()
;
; Local Variables:
...
section .text
    ...
    JL 0x0057776b                       ; 005777a6 | LAB_0057776b
    ...
    PUSH EBP                            ; 005777c8
    PUSH EDI                            ; 005777c9
    CALL engine_2d.c_drawRect_FUN_00403120 ; 005777ca | void engine_2d.c_drawRect_FUN_00403120(int x1, int y1, int x2, int y2)
        ;   XREF to: 00403120 (UNCONDITIONAL_CALL)
    MOV EAX,[0x02cf6a8c]                ; 005777cf | int g_MouseX
    ADD ESP,0x10                        ; 005777d4
    CMP EAX,EDI                         ; 005777d7
    JL 0x00577ad6                       ; 005777d9 | LAB_00577ad6
        ;   XREF to: 00577ad6 (CONDITIONAL_JUMP)
    CMP EBX,EAX                         ; 005777df
    JLE 0x00577ad6                      ; 005777e1 | LAB_00577ad6
        ;   XREF to: 00577ad6 (CONDITIONAL_JUMP)
    MOV EAX,[0x02cf6a90]                ; 005777e7 | int g_MouseY
    CMP EAX,EBP                         ; 005777ec
    JL 0x00577ad6                       ; 005777ee | LAB_00577ad6
        ;   XREF to: 00577ad6 (CONDITIONAL_JUMP)
    CMP EAX,dword ptr [ESP + 0xc]       ; 005777f4
    JGE 0x00577ad6                      ; 005777f8 | LAB_00577ad6
        ;   XREF to: 00577ad6 (CONDITIONAL_JUMP)
    ...
    MOV EAX,dword ptr [ESP + 0xc]       ; 0057780d
        ;   Label: LAB_0057780d
    CMP EAX,dword ptr [0x00679398]      ; 00577811 | int g_WindowHeight
    JG 0x0057778c                       ; 00577817 | LAB_0057778c
        ;   XREF to: 0057778c (CONDITIONAL_JUMP)
    IMUL EAX,dword ptr [ESP + 0x10],0x3000 ; 0057781d
    MOV ESI,dword ptr [0x0067939c]      ; 00577825 | int g_BitsPerPixel
    LEA EDX,[EAX + 0x3000]              ; 0057782b
    LEA EBX,[EBP*0x4 + 0x0]             ; 00577831
    LEA ECX,[EAX + 0x100]               ; 00577838
    CMP ESI,0x8                         ; 0057783e
    JNZ 0x005778f8                      ; 00577841 | LAB_005778f8
    ...
    MOV EAX,dword ptr [EAX + 0x2cf6a9c] ; 00577863 | void *[1024] g_ScreenBufferArray
    MOV EBX,dword ptr [ESP + 0x4c]      ; 00577869
    ADD EAX,EBP                         ; 0057786d
    MOV EBP,dword ptr [ESP + 0x38]      ; 0057786f
    LEA EDX,[EAX + 0x1]                 ; 00577873
    MOV EAX,dword ptr [EBX + 0x3365cc0] ; 00577876 | DAT_03365cc0
        ;   Label: LAB_00577876
    ...
    INC EDX                             ; 005778af
    MOV AL,byte ptr [ESI + EAX*0x1 + 0x2cf9020] ; 005778b0 | uchar[32768] g_ColorCubeLookup
    ADD EBX,0x4                         ; 005778b7
    MOV byte ptr [EDX + -0x1],AL        ; 005778ba
    CMP EBX,EBP                         ; 005778bd
    JNZ 0x00577876                      ; 005778bf | LAB_00577876
    ...
    JZ 0x0057778c                       ; 005778ed | LAB_0057778c
        ;   XREF to: 0057778c (CONDITIONAL_JUMP)
    JMP 0x0057785b                      ; 005778f3 | LAB_0057785b
        ;   XREF to: 0057785b (UNCONDITIONAL_JUMP)
    CMP ESI,0x10                        ; 005778f8
        ;   Label: LAB_005778f8
    JNZ 0x005779fc                      ; 005778fb | LAB_005779fc
    ...
    MOV EAX,dword ptr [EAX + 0x2cf6a9c] ; 00577920 | void *[1024] g_ScreenBufferArray
    ...
    MOV EDX,dword ptr [EBX + 0x3365cc0] ; 0057793b | DAT_03365cc0
        ;   Label: LAB_0057793b
    MOV ESI,dword ptr [0x02d01f28]      ; 00577941 | int g_RedScaleFactor
    ...
    MOV EDI,dword ptr [0x02d01f34]      ; 00577959 | int g_GreenScaleFactor
    ...
    DIV dword ptr [0x02d01f40]          ; 0057797f | int g_BlueScaleFactor
    MOV CL,byte ptr [0x02d01f24]        ; 00577985 | int g_RedBitPosition
    SHL ESI,CL                          ; 0057798b
    MOV CL,byte ptr [0x02d01f30]        ; 0057798d | int g_GreenBitPosition
    SHL EDI,CL                          ; 00577993
    MOV dword ptr [ESP],EAX             ; 00577995
    MOV CL,byte ptr [0x02d01f3c]        ; 00577998 | int g_BlueBitPosition
    ...
    JNZ 0x0057793b                      ; 005779be | LAB_0057793b
    ...
    JZ 0x0057778c                       ; 005779f1 | LAB_0057778c
        ;   XREF to: 0057778c (CONDITIONAL_JUMP)
    JMP 0x00577918                      ; 005779f7 | LAB_00577918
        ;   XREF to: 00577918 (UNCONDITIONAL_JUMP)
    CMP ESI,0x20                        ; 005779fc
        ;   Label: LAB_005779fc
    JNZ 0x0057778c                      ; 005779ff | LAB_0057778c
        ;   XREF to: 0057778c (CONDITIONAL_JUMP)
    ...
    MOV EAX,dword ptr [EAX + 0x2cf6a9c] ; 00577a28 | void *[1024] g_ScreenBufferArray
    MOV EBX,dword ptr [ESP + 0x48]      ; 00577a2e
    ADD EAX,EDX                         ; 00577a32
    MOV EBP,dword ptr [ESP + 0x34]      ; 00577a34
    LEA EDX,[EAX + 0x4]                 ; 00577a38
    MOV EAX,dword ptr [EBX + 0x3365cc0] ; 00577a3b | DAT_03365cc0
        ;   Label: LAB_00577a3b
    MOV ECX,dword ptr [0x0067939c]      ; 00577a41 | int g_BitsPerPixel
    ...
    JNZ 0x00577aca                      ; 00577a65 | LAB_00577aca
        ;   XREF to: 00577aca (CONDITIONAL_JUMP)
    MOV CL,byte ptr [0x02d01f24]        ; 00577a67 | int g_RedBitPosition
    SHL ESI,CL                          ; 00577a6d
    MOV CL,byte ptr [0x02d01f30]        ; 00577a6f | int g_GreenBitPosition
    SHL EDI,CL                          ; 00577a75
    MOV CL,byte ptr [0x02d01f3c]        ; 00577a77 | int g_BlueBitPosition
    OR ESI,EDI                          ; 00577a7d
    SHL EAX,CL                          ; 00577a7f
    ...
    JNZ 0x00577a3b                      ; 00577a90 | LAB_00577a3b
    ...
    JZ 0x0057778c                       ; 00577abf | LAB_0057778c
        ;   XREF to: 0057778c (CONDITIONAL_JUMP)
    JMP 0x00577a20                      ; 00577ac5 | LAB_00577a20
    ...
    OR ECX,EDI                          ; 00577ad2
    JMP 0x00577a83                      ; 00577ad4 | LAB_00577a83
