// Name: core_setedit.cpp_CDemonSet_FUN_00576da0
// Address: 00576da0
// Address Range: [[00576da0, 00577113]]
// Convention: __cdecl
// Signature: void __cdecl core_setedit_cpp_CDemonSet_FUN_00576da0(CDemonSet *this_ptr)
  ...
  if (0 < this_ptr->camera_count) {
    ...
    do {
      if (local_18->cameras[0].is_panning != 0) {
        core_setedit_cpp_C3DSCamera_FUN_005769a0(this_ptr_00);
        core_setedit_cpp_C3DSCamera_FUN_005769a0(this_ptr_00);
        core_setedit_cpp_C3DSCamera_FUN_005769a0(this_ptr_00);
      }
      core_setedit_cpp_C3DSCamera_FUN_005769a0(this_ptr_00);
