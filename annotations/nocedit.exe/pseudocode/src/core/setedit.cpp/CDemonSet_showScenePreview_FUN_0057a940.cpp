...

{
  ...
  (pCVar2->position).z = 0.0;
  (pCVar2->position).y = (pCVar2->position).z;
  (pCVar2->position).x = (pCVar2->position).y;
  pCVar2->roll = 0.0;
  pCVar2->yaw = pCVar2->roll;
  pCVar2->pitch = pCVar2->yaw;
  pCVar2->slew_rate = 28.0;
  ...
  while( true ) {
    ...
    if (pCStack_14 != (C3DSCamera *)0x0) {
      ...
      iVar3 = core_setedit_cpp_CDemonSet_findVisibleCamerasAtScreenPoint_FUN_005800d0
