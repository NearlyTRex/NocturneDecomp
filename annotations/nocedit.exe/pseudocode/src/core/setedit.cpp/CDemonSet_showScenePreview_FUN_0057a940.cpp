...

{
  ...
  local_1c = shape_memdbg_cpp_debugAlloc_FUN_0050f1f0
  ...
  while( true ) {
    ...
    fStack_34 = (g_CSlewPtr->position).x;
    fStack_30 = (g_CSlewPtr->position).y;
    fStack_2c = (g_CSlewPtr->position).z;
    fStack_28 = g_CSlewPtr->pitch;
    fStack_24 = g_CSlewPtr->yaw;
    fStack_20 = g_CSlewPtr->roll;
    local_1c = (void *)g_CSlewPtr->slew_rate;
    ...
    if ((((fStack_34 != (g_CSlewPtr->position).x) || (fStack_30 != (g_CSlewPtr->position).y)) ||
        (fStack_2c != (g_CSlewPtr->position).z)) ||
       (((fStack_28 != g_CSlewPtr->pitch || (fStack_24 != g_CSlewPtr->yaw)) ||
        ((fStack_20 != g_CSlewPtr->roll || ((float)local_1c != g_CSlewPtr->slew_rate)))))) {
      iStack_14 = 0;
    }
    if (ptr != (C3DSCamera *)0x0) {
      if (iStack_14 == 0) {
        core_setedit_cpp_CDemonSet_buildCameraCoverageMap_FUN_0057fd00(this_ptr,local_18,-1);
        iStack_14 = 1;
      }
      core_setedit_cpp_CDemonSet_drawCameraCoverageMap_FUN_0057ff70(this_ptr,local_18);
      iVar2 = core_setedit_cpp_CDemonSet_findVisibleCamerasAtScreenPoint_FUN_005800d0
                        (this_ptr,g_MouseX,g_MouseY,(int *)&stack0xfffffae4,-1);
      if (0 < iVar2) {
        y = 0x21;
        iVar3 = 0;
        do {
    ...
    _sprintf
              (acStack_134,"Viewer pos: %8.4f,%8.4f,%8.4f pbh: %6.3f,%6.3f,%6.3f",(double)(g_CSlewPtr->position).x,
