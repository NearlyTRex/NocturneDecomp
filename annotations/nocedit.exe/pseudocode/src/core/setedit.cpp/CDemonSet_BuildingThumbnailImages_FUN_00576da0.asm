...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_setedit_cpp_CDemonSet_BuildingThumbnailImages_FUN_00576da0(CDemonSet *this_ptr)
;
; Parameters:
...
;
; XREF[7]:
;   core_msnedit.cpp_CDemonMission_FUN_005390f0 at 00539193
...
section .text
    ...
    PUSH EDX                            ; 00576db1
    CALL core_setedit.cpp_CallToFreeSomeMemory_FUN_00580560 ; 00576db2
    ...
    PUSH EDI                            ; 00576ee0
    CALL core_setedit.cpp_OpenSomethingBackdropThumbs_FUN_005769a0 ; 00576ee1
        ;   XREF to: 005769a0 (UNCONDITIONAL_CALL)  ; void core_setedit.cpp_OpenSomethingBackdropThumbs_FUN_005769a0()
    ADD ESP,0xc                         ; 00576ee6
    PUSH EBP                            ; 00576ee9
    PUSH 0x646720                       ; 00576eea | = "n"
    PUSH EDI                            ; 00576eef
    CALL core_setedit.cpp_OpenSomethingBackdropThumbs_FUN_005769a0 ; 00576ef0
        ;   XREF to: 005769a0 (UNCONDITIONAL_CALL)  ; void core_setedit.cpp_OpenSomethingBackdropThumbs_FUN_005769a0()
    ...
    PUSH EDI                            ; 00576f01
    CALL core_setedit.cpp_OpenSomethingBackdropThumbs_FUN_005769a0 ; 00576f02
        ;   XREF to: 005769a0 (UNCONDITIONAL_CALL)  ; void core_setedit.cpp_OpenSomethingBackdropThumbs_FUN_005769a0()
    ...
    PUSH EDI                            ; 00576f11
    INC ESI                             ; 00576f12
    CALL core_setedit.cpp_OpenSomethingBackdropThumbs_FUN_005769a0 ; 00576f13
        ;   XREF to: 005769a0 (UNCONDITIONAL_CALL)  ; void core_setedit.cpp_OpenSomethingBackdropThumbs_FUN_005769a0()
        ;   Label: LAB_00576f13
