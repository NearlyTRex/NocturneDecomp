...

{
  ...
  if (g_ModalDialogActive == 0) {
    ...
    if (((this_ptr->developer_mode_enabled != 0) && (g_MovieRecordingArmed == 0)) &&
       ((iVar4 = (*g_CKeysPtr->vtable->getKeyState)(g_CKeysPtr,DIK_LCONTROL), iVar4 != 0 &&
    ...
    if ((this_ptr->subtitle_system_enabled == 0) &&
      ...
      if (file_ptr == (_FILE *)0x0) {
        ...
        shape_memdbg_cpp_closeFile_FUN_0050f9b0(file_ptr,"..\\core\\game.cpp",2421);
        pcVar6 = support_newmsg_cpp_getLocalizedString_FUN_005441f0
    ...
    if (iVar4 != 0) {
      ...
      _sprintf(acStack_118,"Gamma : %f",(double)this_ptr->gamma * 1.52587890625e-05);
    ...
    if (iVar4 != 0) {
      ...
      _sprintf(&stack0xfffffe58,"Gamma : %f",(double)this_ptr->gamma * 1.52587890625e-05);
