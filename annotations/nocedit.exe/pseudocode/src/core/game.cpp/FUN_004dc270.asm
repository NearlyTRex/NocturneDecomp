...
section .text
    ...
    MOV AL,byte ptr [EDX + 0x2d82670]   ; 004dc274 | char[600] g_PrevKeyboardState
    CMP AL,byte ptr [EDX + 0x2d03e98]   ; 004dc27a | char[256] g_KeyboardState
    JNZ 0x004dc283                      ; 004dc280 | LAB_004dc283
        ;   XREF to: 004dc283 (CONDITIONAL_JUMP)
    RET                                 ; 004dc282
    XOR EAX,EAX                         ; 004dc283
        ;   Label: LAB_004dc283
    MOV AL,byte ptr [EDX + 0x2d03e98]   ; 004dc285 | char[256] g_KeyboardState
