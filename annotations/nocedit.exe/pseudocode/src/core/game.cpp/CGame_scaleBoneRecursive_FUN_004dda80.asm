...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_game_cpp_CGame_scaleBoneRecursive_FUN_004dda80(CGame *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004dda80
        ;   Label: core_game.cpp_CGame_scaleBoneRecursive_FUN_004dda80
    PUSH ESI                            ; 004dda81
    PUSH EDI                            ; 004dda82
    PUSH EBP                            ; 004dda83
    ...
    PUSH ECX                            ; 004ddadc
    CALL core_game.cpp_CGame_scaleBoneRecursive_FUN_004dda80 ; 004ddadd
