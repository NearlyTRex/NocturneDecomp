...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_game.cpp_CGame_FUN_004d85a0(CGame * this_ptr)
;
; Parameters:
...
section .text
    ...
    FNSTSW AX                           ; 004d85c5
    SAHF                                ; 004d85c7
    JA 0x004d867f                       ; 004d85c8 | LAB_004d867f
        ;   XREF to: 004d867f (CONDITIONAL_JUMP)
    FLD float ptr [EBX + 0x264]         ; 004d85ce
        ;   Label: LAB_004d85ce
    FSUBR float ptr [0x02d831ac]        ; 004d85d4 | float g_OverlayDisplayTimer
    FST float ptr [0x02d831ac]          ; 004d85da | float g_OverlayDisplayTimer
    FLDZ                                ; 004d85e0
    FCOMPP                              ; 004d85e2
    FNSTSW AX                           ; 004d85e4
    SAHF                                ; 004d85e6
    JBE 0x004d85f1                      ; 004d85e7 | LAB_004d85f1
        ;   XREF to: 004d85f1 (CONDITIONAL_JUMP)
    XOR EDX,EDX                         ; 004d85e9
    MOV dword ptr [0x02d831ac],EDX      ; 004d85eb | float g_OverlayDisplayTimer
    MOV ECX,dword ptr [EBX + 0x388]     ; 004d85f1
        ;   Label: LAB_004d85f1
    XOR ESI,ESI                         ; 004d85f7
    TEST ECX,ECX                        ; 004d85f9
    JLE 0x004d8678                      ; 004d85fb | LAB_004d8678
    ...
    FNSTSW AX                           ; 004d864b
    SAHF                                ; 004d864d
    JNC 0x004d868e                      ; 004d864e | LAB_004d868e
    ...
    JL 0x004d862a                       ; 004d8676 | LAB_004d862a
    ...
    MOV dword ptr [EBX + 0x384],0x0     ; 004d867f
        ;   Label: LAB_004d867f
    JMP 0x004d85ce                      ; 004d8689 | LAB_004d85ce
    ...
    PUSH ECX                            ; 004d86aa
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 004d86ab | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
    ...
    PUSH EAX                            ; 004d86dd
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 004d86de | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
        ;   XREF to: 005fe5e0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 004d8706
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 004d8707 | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
        ;   XREF to: 005fe5e0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004d870c
    CMP ESI,dword ptr [EBX + 0x388]     ; 004d870f
    JL 0x004d862a                       ; 004d8715 | LAB_004d862a
        ;   XREF to: 004d862a (CONDITIONAL_JUMP)
