...
section .text
    ...
    CMP dword ptr [0x02d831b0],0x0      ; 004d781a | int g_CheatFlags
    JNZ 0x004d782e                      ; 004d7821 | LAB_004d782e
    ...
    PUSH 0x1d                           ; 004d782e
        ;   Label: LAB_004d782e
    MOV EAX,[0x0067cf44]                ; 004d7830 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 004d7835 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004d7836 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 004d7838
    ADD ESP,0x8                         ; 004d783a
    TEST EAX,EAX                        ; 004d783d
    JZ 0x004d786b                       ; 004d783f | LAB_004d786b
        ;   XREF to: 004d786b (CONDITIONAL_JUMP)
    PUSH 0x2f                           ; 004d7841
    MOV EAX,[0x0067cf44]                ; 004d7843 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 004d7848 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004d7849 | void * g_CKeysPtr
    CALL dword ptr [EDX + 0x4]          ; 004d784b
    ADD ESP,0x8                         ; 004d784e
    TEST EAX,EAX                        ; 004d7851
    JZ 0x004d786b                       ; 004d7853 | LAB_004d786b
        ;   XREF to: 004d786b (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x02d831b4]      ; 004d7855 | int g_DebugRecording
    TEST ECX,ECX                        ; 004d785b
    JZ 0x004d7b17                       ; 004d785d | LAB_004d7b17
        ;   XREF to: 004d7b17 (CONDITIONAL_JUMP)
    XOR EDI,EDI                         ; 004d7863
    MOV dword ptr [0x02d831b4],EDI      ; 004d7865 | int g_DebugRecording
    MOV EBP,dword ptr [0x02d831b8]      ; 004d786b | g_DebugRecordingParams
        ;   Label: LAB_004d786b
    TEST EBP,EBP                        ; 004d7871
    JLE 0x004d7881                      ; 004d7873 | LAB_004d7881
        ;   XREF to: 004d7881 (CONDITIONAL_JUMP)
    CMP EBP,dword ptr [0x02d831bc]      ; 004d7875 | DAT_02d831bc
    JLE 0x004d7b2d                      ; 004d787b | LAB_004d7b2d
        ;   XREF to: 004d7b2d (CONDITIONAL_JUMP)
    CMP dword ptr [0x02d831b4],0x0      ; 004d7881 | int g_DebugRecording
        ;   Label: LAB_004d7881
    JZ 0x004d7823                       ; 004d7888 | LAB_004d7823
        ;   XREF to: 004d7823 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [0x02d831bc]      ; 004d788a | DAT_02d831bc
    PUSH EBX                            ; 004d7890
    PUSH 0x62b201                       ; 004d7891 | = "noc%05d.raw" | s_noc_05d_raw_0062b201 = noc%05d.raw
    LEA EAX,[ESP + 0xd0]                ; 004d7896
    PUSH EAX                            ; 004d789d
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 004d789e | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004d78a3
    LEA EAX,[ESP + 0xc8]                ; 004d78a6
    PUSH EAX                            ; 004d78ad
    PUSH 0x62b20d                       ; 004d78ae | = "Movie recording active: movie\\%s" | s_Movie_recording_active_m_0062b20d = Movie recording active: movie\%s
    LEA EAX,[ESP + 0x8]                 ; 004d78b3
    PUSH EAX                            ; 004d78b7
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 004d78b8 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004d78bd
    PUSH 0x62b22e                       ; 004d78c0 | = "wb" | s_wb_0062b22e = wb
    LEA EAX,[ESP + 0xcc]                ; 004d78c5
    PUSH EAX                            ; 004d78cc
    PUSH 0x62b231                       ; 004d78cd | = "movie" | s_movie_0062b231 = movie
    CALL engine_dosio.c_getFile_FUN_00481a50 ; 004d78d2 | FILE * engine_dosio.c_getFile_FUN_00481a50(char * directory, char * filename, char * mode)
        ;   XREF to: 00481a50 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004d78d7
    MOV dword ptr [ESP + 0x134],EAX     ; 004d78da
    TEST EAX,EAX                        ; 004d78e1
    JZ 0x004d7823                       ; 004d78e3 | LAB_004d7823
        ;   XREF to: 004d7823 (CONDITIONAL_JUMP)
    XOR ESI,ESI                         ; 004d78e9
    MOV EDI,dword ptr [0x0067b668]      ; 004d78eb | undefined4 DAT_0067b668
    MOV dword ptr [ESP + 0x130],ESI     ; 004d78f1
    TEST EDI,EDI                        ; 004d78f8
    JLE 0x004d7ad4                      ; 004d78fa | LAB_004d7ad4
        ;   XREF to: 004d7ad4 (CONDITIONAL_JUMP)
    XOR ESI,ESI                         ; 004d7900
        ;   Label: LAB_004d7900
    MOV EDI,dword ptr [0x0067b664]      ; 004d7902 | undefined4 DAT_0067b664
    MOV dword ptr [ESP + 0x138],ESI     ; 004d7908
    TEST EDI,EDI                        ; 004d790f
    JLE 0x004d7ab7                      ; 004d7911 | LAB_004d7ab7
    ...
    MOV EDX,dword ptr [ESP + 0x138]     ; 004d7926
        ;   Label: LAB_004d7926
    MOV ESI,dword ptr [0x00679394]      ; 004d792d | int g_WindowWidth
    IMUL EDX,ESI                        ; 004d7933
    MOV EDI,dword ptr [0x0067b664]      ; 004d7936 | undefined4 DAT_0067b664
    ...
    IDIV EDI                            ; 004d795a
    MOV EBX,dword ptr [0x00679398]      ; 004d795c | int g_WindowHeight
    MOV EDX,dword ptr [ESP + 0x130]     ; 004d7962
    IMUL EDX,EBX                        ; 004d7969
    MOV ESI,dword ptr [0x0067b668]      ; 004d796c | undefined4 DAT_0067b668
    ...
    JGE 0x004d7a4d                      ; 004d79a6 | LAB_004d7a4d
    ...
    JGE 0x004d7a2d                      ; 004d79d4 | LAB_004d7a2d
        ;   XREF to: 004d7a2d (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x144]     ; 004d79d6
    LEA EDX,[ECX*0x4 + 0x0]             ; 004d79dd
    MOV EAX,dword ptr [EAX + 0x2cf6a9c] ; 004d79e4 | void *[1024] g_ScreenBufferArray
    ...
    JL 0x004d79ec                       ; 004d7a2b | LAB_004d79ec
    ...
    JL 0x004d79c4                       ; 004d7a47 | LAB_004d79c4
    ...
    CALL crt_stdio.c_fputc_FUN_006007a0 ; 004d7a7e | int crt_stdio.c_fputc_FUN_006007a0(int character, FILE * file)
        ;   XREF to: 006007a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004d7a83
    PUSH EBP                            ; 004d7a86
    PUSH ESI                            ; 004d7a87
    CALL crt_stdio.c_fputc_FUN_006007a0 ; 004d7a88 | int crt_stdio.c_fputc_FUN_006007a0(int character, FILE * file)
        ;   XREF to: 006007a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004d7a8d
    PUSH EBP                            ; 004d7a90
    PUSH EDI                            ; 004d7a91
    CALL crt_stdio.c_fputc_FUN_006007a0 ; 004d7a92 | int crt_stdio.c_fputc_FUN_006007a0(int character, FILE * file)
        ;   XREF to: 006007a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004d7a97
    MOV ECX,dword ptr [ESP + 0x138]     ; 004d7a9a
    INC ECX                             ; 004d7aa1
    MOV EBX,dword ptr [0x0067b664]      ; 004d7aa2 | undefined4 DAT_0067b664
    MOV dword ptr [ESP + 0x138],ECX     ; 004d7aa8
    CMP ECX,EBX                         ; 004d7aaf
    JL 0x004d7926                       ; 004d7ab1 | LAB_004d7926
        ;   XREF to: 004d7926 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x130]     ; 004d7ab7
        ;   Label: LAB_004d7ab7
    INC EAX                             ; 004d7abe
    MOV EDX,dword ptr [0x0067b668]      ; 004d7abf | undefined4 DAT_0067b668
    MOV dword ptr [ESP + 0x130],EAX     ; 004d7ac5
    CMP EAX,EDX                         ; 004d7acc
    JL 0x004d7900                       ; 004d7ace | LAB_004d7900
        ;   XREF to: 004d7900 (CONDITIONAL_JUMP)
    PUSH 0x110                          ; 004d7ad4
        ;   Label: LAB_004d7ad4
    PUSH 0x62b237                       ; 004d7ad9 | = "..\\core\\game.cpp" | s_core_game_cpp_0062b237 = ..\core\game.cpp
    MOV ECX,dword ptr [ESP + 0x13c]     ; 004d7ade
    PUSH ECX                            ; 004d7ae5
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 004d7ae6 | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
    ...
    PUSH EAX                            ; 004d7af6
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 004d7af7 | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
    ...
    MOV dword ptr [0x02d831b4],ESI      ; 004d7b22 | int g_DebugRecording
    JMP 0x004d786b                      ; 004d7b28 | LAB_004d786b
        ;   XREF to: 004d786b (UNCONDITIONAL_JUMP)
    XOR EBP,EBP                         ; 004d7b2d
        ;   Label: LAB_004d7b2d
    MOV dword ptr [0x02d831b4],EBP      ; 004d7b2f | int g_DebugRecording
