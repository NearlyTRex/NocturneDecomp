...

{
  ...
  crt_stdio_c_sprintf_FUN_005fdbd0(local_1810,"%s = %s",pcVar2,pcVar1);
  engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80
            (g_ThemeFont,local_1810,DAT_02d831c4,DAT_02d831c8,7,-1);
  DAT_02d831c8 = DAT_02d831c8 + DAT_02d831cc;
  if (g_WindowHeight + DAT_02d831cc * -4 < DAT_02d831c8) {
    DAT_02d831c8 = DAT_02d831cc * 6;
    DAT_02d831c4 = DAT_02d831c4 + g_WindowWidth / 3;
  ...
  crt_stdio_c_sprintf_FUN_005fdbd0(local_1110,"%s = %s",pcVar2,pcVar1);
  engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80
            (g_ThemeFont,local_1110,DAT_02d831c4,DAT_02d831c8,7,-1);
  DAT_02d831c8 = DAT_02d831c8 + DAT_02d831cc;
  if (g_WindowHeight + DAT_02d831cc * -4 < DAT_02d831c8) {
    DAT_02d831c8 = DAT_02d831cc * 6;
    DAT_02d831c4 = DAT_02d831c4 + g_WindowWidth / 3;
  ...
  if (g_CGamePtr->always_run == 0) {
    ...
    crt_stdio_c_sprintf_FUN_005fdbd0(local_610,"%s = %s",pcVar2,pcVar1);
    engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80
              (g_ThemeFont,local_610,DAT_02d831c4,DAT_02d831c8,7,-1);
    DAT_02d831c8 = DAT_02d831c8 + DAT_02d831cc;
    ...
    pcVar2 = core_menu_cpp_getKeyDisplayName_FUN_005134e0(this_ptr->key_run);
    crt_stdio_c_sprintf_FUN_005fdbd0(local_910,"%s = %s",pcVar2,pcVar1);
    engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80
              (g_ThemeFont,local_910,DAT_02d831c4,DAT_02d831c8,7,-1);
    DAT_02d831c8 = DAT_02d831c8 + DAT_02d831cc;
    iVar3 = g_WindowHeight + DAT_02d831cc * -4;
  }
  ...
  crt_stdio_c_sprintf_FUN_005fdbd0(local_1a10,"%s = %s",pcVar2,pcVar1);
  engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80
            (g_ThemeFont,local_1a10,DAT_02d831c4,DAT_02d831c8,7,-1);
  DAT_02d831c8 = DAT_02d831c8 + DAT_02d831cc;
  if (g_WindowHeight + DAT_02d831cc * -4 < DAT_02d831c8) {
    DAT_02d831c8 = DAT_02d831cc * 6;
    DAT_02d831c4 = DAT_02d831c4 + g_WindowWidth / 3;
  ...
  crt_stdio_c_sprintf_FUN_005fdbd0(local_1310,"%s = %s",pcVar2,pcVar1);
  engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80
            (g_ThemeFont,local_1310,DAT_02d831c4,DAT_02d831c8,7,-1);
  DAT_02d831c8 = DAT_02d831c8 + DAT_02d831cc;
  if (g_WindowHeight + DAT_02d831cc * -4 < DAT_02d831c8) {
    DAT_02d831c8 = DAT_02d831cc * 6;
    DAT_02d831c4 = DAT_02d831c4 + g_WindowWidth / 3;
  ...
  crt_stdio_c_sprintf_FUN_005fdbd0(local_c10,"%s = %s",pcVar2,pcVar1);
  engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80
            (g_ThemeFont,local_c10,DAT_02d831c4,DAT_02d831c8,7,-1);
  DAT_02d831c8 = DAT_02d831c8 + DAT_02d831cc;
  if (g_WindowHeight + DAT_02d831cc * -4 < DAT_02d831c8) {
    DAT_02d831c8 = DAT_02d831cc * 6;
    DAT_02d831c4 = DAT_02d831c4 + g_WindowWidth / 3;
  ...
  crt_stdio_c_sprintf_FUN_005fdbd0(local_510,"%s = %s",pcVar2,pcVar1);
  engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80
            (g_ThemeFont,local_510,DAT_02d831c4,DAT_02d831c8,7,-1);
  DAT_02d831c8 = DAT_02d831c8 + DAT_02d831cc;
  if (g_WindowHeight + DAT_02d831cc * -4 < DAT_02d831c8) {
    DAT_02d831c8 = DAT_02d831cc * 6;
    DAT_02d831c4 = DAT_02d831c4 + g_WindowWidth / 3;
  ...
  crt_stdio_c_sprintf_FUN_005fdbd0(local_710,"%s = %s",pcVar2,pcVar1);
  engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80
            (g_ThemeFont,local_710,DAT_02d831c4,DAT_02d831c8,7,-1);
  DAT_02d831c8 = DAT_02d831c8 + DAT_02d831cc;
  if (g_WindowHeight + DAT_02d831cc * -4 < DAT_02d831c8) {
    DAT_02d831c8 = DAT_02d831cc * 6;
    DAT_02d831c4 = DAT_02d831c4 + g_WindowWidth / 3;
  ...
  crt_stdio_c_sprintf_FUN_005fdbd0(local_810,"%s = %s",pcVar2,pcVar1);
  engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80
            (g_ThemeFont,local_810,DAT_02d831c4,DAT_02d831c8,7,-1);
  DAT_02d831c8 = DAT_02d831c8 + DAT_02d831cc;
  if (g_WindowHeight + DAT_02d831cc * -4 < DAT_02d831c8) {
    DAT_02d831c8 = DAT_02d831cc * 6;
    DAT_02d831c4 = DAT_02d831c4 + g_WindowWidth / 3;
  ...
  crt_stdio_c_sprintf_FUN_005fdbd0(local_210,"%s = %s",pcVar2,pcVar1);
  engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80
            (g_ThemeFont,local_210,DAT_02d831c4,DAT_02d831c8,7,-1);
  DAT_02d831c8 = DAT_02d831c8 + DAT_02d831cc;
  if (g_WindowHeight + DAT_02d831cc * -4 < DAT_02d831c8) {
    DAT_02d831c8 = DAT_02d831cc * 6;
    DAT_02d831c4 = DAT_02d831c4 + g_WindowWidth / 3;
  ...
  crt_stdio_c_sprintf_FUN_005fdbd0(local_a10,"%s = %s",pcVar2,pcVar1);
  engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80
            (g_ThemeFont,local_a10,DAT_02d831c4,DAT_02d831c8,7,-1);
  DAT_02d831c8 = DAT_02d831c8 + DAT_02d831cc;
  if (g_WindowHeight + DAT_02d831cc * -4 < DAT_02d831c8) {
    DAT_02d831c8 = DAT_02d831cc * 6;
    DAT_02d831c4 = DAT_02d831c4 + g_WindowWidth / 3;
  ...
  crt_stdio_c_sprintf_FUN_005fdbd0(local_310,"%s = %s",pcVar2,pcVar1);
  engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80
            (g_ThemeFont,local_310,DAT_02d831c4,DAT_02d831c8,7,-1);
  DAT_02d831c8 = DAT_02d831c8 + DAT_02d831cc;
  if (g_WindowHeight + DAT_02d831cc * -4 < DAT_02d831c8) {
    DAT_02d831c8 = DAT_02d831cc * 6;
    DAT_02d831c4 = DAT_02d831c4 + g_WindowWidth / 3;
  ...
  crt_stdio_c_sprintf_FUN_005fdbd0(local_1b10,"%s = %s",pcVar2,pcVar1);
  engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80
            (g_ThemeFont,local_1b10,DAT_02d831c4,DAT_02d831c8,7,-1);
  DAT_02d831c8 = DAT_02d831c8 + DAT_02d831cc;
  if (g_WindowHeight + DAT_02d831cc * -4 < DAT_02d831c8) {
    DAT_02d831c8 = DAT_02d831cc * 6;
    DAT_02d831c4 = DAT_02d831c4 + g_WindowWidth / 3;
  ...
  crt_stdio_c_sprintf_FUN_005fdbd0(local_1410,"%s = %s",pcVar2,pcVar1);
  engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80
            (g_ThemeFont,local_1410,DAT_02d831c4,DAT_02d831c8,7,-1);
  DAT_02d831c8 = DAT_02d831c8 + DAT_02d831cc;
  if (g_WindowHeight + DAT_02d831cc * -4 < DAT_02d831c8) {
    DAT_02d831c8 = DAT_02d831cc * 6;
    DAT_02d831c4 = DAT_02d831c4 + g_WindowWidth / 3;
  ...
  crt_stdio_c_sprintf_FUN_005fdbd0(local_d10,"%s = %s",pcVar2,pcVar1);
  engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80
            (g_ThemeFont,local_d10,DAT_02d831c4,DAT_02d831c8,7,-1);
  DAT_02d831c8 = DAT_02d831c8 + DAT_02d831cc;
  if (g_WindowHeight + DAT_02d831cc * -4 < DAT_02d831c8) {
    DAT_02d831c8 = DAT_02d831cc * 6;
    DAT_02d831c4 = DAT_02d831c4 + g_WindowWidth / 3;
  ...
  crt_stdio_c_sprintf_FUN_005fdbd0(local_1610,"%s = %s",pcVar2,pcVar1);
  engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80
            (g_ThemeFont,local_1610,DAT_02d831c4,DAT_02d831c8,7,-1);
  DAT_02d831c8 = DAT_02d831c8 + DAT_02d831cc;
  if (g_WindowHeight + DAT_02d831cc * -4 < DAT_02d831c8) {
    DAT_02d831c8 = DAT_02d831cc * 6;
    DAT_02d831c4 = DAT_02d831c4 + g_WindowWidth / 3;
  ...
  crt_stdio_c_sprintf_FUN_005fdbd0(local_f10,"%s = %s",pcVar2,pcVar1);
  engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80
            (g_ThemeFont,local_f10,DAT_02d831c4,DAT_02d831c8,7,-1);
  DAT_02d831c8 = DAT_02d831c8 + DAT_02d831cc;
  if (g_WindowHeight + DAT_02d831cc * -4 < DAT_02d831c8) {
    DAT_02d831c8 = DAT_02d831cc * 6;
    DAT_02d831c4 = DAT_02d831c4 + g_WindowWidth / 3;
  ...
  crt_stdio_c_sprintf_FUN_005fdbd0(local_1910,"%s = %s",pcVar2,pcVar1);
  engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80
            (g_ThemeFont,local_1910,DAT_02d831c4,DAT_02d831c8,7,-1);
  DAT_02d831c8 = DAT_02d831c8 + DAT_02d831cc;
  if (g_WindowHeight + DAT_02d831cc * -4 < DAT_02d831c8) {
    DAT_02d831c8 = DAT_02d831cc * 6;
    DAT_02d831c4 = DAT_02d831c4 + g_WindowWidth / 3;
  ...
  crt_stdio_c_sprintf_FUN_005fdbd0(local_1210,"%s = %s",pcVar2,pcVar1);
  engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80
            (g_ThemeFont,local_1210,DAT_02d831c4,DAT_02d831c8,7,-1);
  DAT_02d831c8 = DAT_02d831c8 + DAT_02d831cc;
  if (g_WindowHeight + DAT_02d831cc * -4 < DAT_02d831c8) {
    DAT_02d831c8 = DAT_02d831cc * 6;
    DAT_02d831c4 = DAT_02d831c4 + g_WindowWidth / 3;
  ...
  crt_stdio_c_sprintf_FUN_005fdbd0(local_b10,"%s = %s",pcVar2,pcVar1);
  engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80
            (g_ThemeFont,local_b10,DAT_02d831c4,DAT_02d831c8,7,-1);
  DAT_02d831c8 = DAT_02d831c8 + DAT_02d831cc;
  if (g_WindowHeight + DAT_02d831cc * -4 < DAT_02d831c8) {
    DAT_02d831c8 = DAT_02d831cc * 6;
    DAT_02d831c4 = DAT_02d831c4 + g_WindowWidth / 3;
  ...
  crt_stdio_c_sprintf_FUN_005fdbd0(local_410,"%s = %s",pcVar2,pcVar1);
  engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80
            (g_ThemeFont,local_410,DAT_02d831c4,DAT_02d831c8,7,-1);
  DAT_02d831c8 = DAT_02d831c8 + DAT_02d831cc;
  if (g_WindowHeight + DAT_02d831cc * -4 < DAT_02d831c8) {
    DAT_02d831c8 = DAT_02d831cc * 6;
    DAT_02d831c4 = DAT_02d831c4 + g_WindowWidth / 3;
  ...
  crt_stdio_c_sprintf_FUN_005fdbd0(local_1c10,"%s = %s",pcVar2,pcVar1);
  engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80
            (g_ThemeFont,local_1c10,DAT_02d831c4,DAT_02d831c8,7,-1);
  DAT_02d831c8 = DAT_02d831c8 + DAT_02d831cc;
  if (g_WindowHeight + DAT_02d831cc * -4 < DAT_02d831c8) {
    DAT_02d831c8 = DAT_02d831cc * 6;
    DAT_02d831c4 = DAT_02d831c4 + g_WindowWidth / 3;
  ...
  crt_stdio_c_sprintf_FUN_005fdbd0(local_1510,"%s = %s",pcVar2,pcVar1);
  engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80
            (g_ThemeFont,local_1510,DAT_02d831c4,DAT_02d831c8,7,-1);
  DAT_02d831c8 = DAT_02d831c8 + DAT_02d831cc;
  if (g_WindowHeight + DAT_02d831cc * -4 < DAT_02d831c8) {
    DAT_02d831c8 = DAT_02d831cc * 6;
    DAT_02d831c4 = DAT_02d831c4 + g_WindowWidth / 3;
  ...
  crt_stdio_c_sprintf_FUN_005fdbd0(local_e10,"%s = %s",pcVar2,pcVar1);
  engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80
            (g_ThemeFont,local_e10,DAT_02d831c4,DAT_02d831c8,7,-1);
  DAT_02d831c8 = DAT_02d831c8 + DAT_02d831cc;
  if (g_WindowHeight + DAT_02d831cc * -4 < DAT_02d831c8) {
    DAT_02d831c8 = DAT_02d831cc * 6;
    DAT_02d831c4 = DAT_02d831c4 + g_WindowWidth / 3;
  ...
  crt_stdio_c_sprintf_FUN_005fdbd0(local_1710,"%s = %s",pcVar2,pcVar1);
  engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80
            (g_ThemeFont,local_1710,DAT_02d831c4,DAT_02d831c8,7,-1);
  DAT_02d831c8 = DAT_02d831c8 + DAT_02d831cc;
  if (g_WindowHeight + DAT_02d831cc * -4 < DAT_02d831c8) {
    DAT_02d831c8 = DAT_02d831cc * 6;
    DAT_02d831c4 = DAT_02d831c4 + g_WindowWidth / 3;
  ...
  crt_stdio_c_sprintf_FUN_005fdbd0(local_1010,"%s = %s",pcVar2,pcVar1);
  engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80
            (g_ThemeFont,local_1010,DAT_02d831c4,DAT_02d831c8,7,-1);
  DAT_02d831c8 = DAT_02d831c8 + DAT_02d831cc;
  if (g_WindowHeight + DAT_02d831cc * -4 < DAT_02d831c8) {
    DAT_02d831c8 = DAT_02d831cc * 6;
    DAT_02d831c4 = DAT_02d831c4 + g_WindowWidth / 3;
  ...
  crt_stdio_c_sprintf_FUN_005fdbd0(local_110,"%s = %s",pcVar2,pcVar1);
  engine_font_cpp_CBitFont_drawTextLeft_FUN_004cda80
