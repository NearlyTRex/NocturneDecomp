    ...
    while( true ) {
      ...
      if (local_298 == local_29c) {
        ...
        if (this_ptr->field67_0x208 == 0) {
          ...
          uStack_2b0 = dVar7;
          crt_stdio_c_sprintf_FUN_005fdbd0(acStack_45c,"FPS: %3.2lf",uVar9,uVar8);
          core_game_cpp_CGame_displayMessage_FUN_004d7f20(this_ptr,acStack_45c,5.0);
        }
      }
