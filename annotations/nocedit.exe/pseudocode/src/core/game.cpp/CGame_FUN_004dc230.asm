...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_game_cpp_CGame_FUN_004dc230(CGame *this_ptr,SPlayerControl *player_control)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004dc230
        ;   Label: core_game.cpp_CGame_FUN_004dc230
    ...
    PUSH EBX                            ; 004dc247
    CALL core_game.cpp_CGame_FUN_004dc3e0 ; 004dc248
