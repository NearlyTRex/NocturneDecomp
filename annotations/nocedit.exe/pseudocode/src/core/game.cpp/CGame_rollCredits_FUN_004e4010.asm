...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_game_cpp_CGame_rollCredits_FUN_004e4010(CGame *this_ptr)
;
; Parameters:
...
section .text
    ...
    CALL engine_2d.c_clearInputAndWait_FUN_00403260 ; 004e402d
    ...
    JNZ 0x004e4034                      ; 004e4042
        ;   XREF to: 004e4034 (CONDITIONAL_JUMP)  ; LAB_004e4034
    LEA EAX,[ESP + 0x1100]              ; 004e4044
    PUSH EAX                            ; 004e404b
    CALL engine_alphabit.cpp_CAlphaBitmap_ctor_FUN_00410520 ; 004e404c
    ...
    PUSH 0x1e0                          ; 004e4054
    PUSH 0x280                          ; 004e4059
    PUSH 0x62d5d5                       ; 004e405e | = "stats"
    LEA EAX,[ESP + 0x110c]              ; 004e4063
    PUSH EAX                            ; 004e406a
    CALL engine_alphabit.cpp_CAlphaBitmap_load_FUN_004105d0 ; 004e406b
    ...
    JZ 0x004e42e1                       ; 004e408e
        ;   XREF to: 004e42e1 (CONDITIONAL_JUMP)  ; LAB_004e42e1
    PUSH EDI                            ; 004e4094
    PUSH ESI                            ; 004e4095
    ...
    TEST byte ptr [EBP + 0xc],0x10      ; 004e40a0
        ;   Label: LAB_004e40a0
    JNZ 0x004e40e1                      ; 004e40a4
        ;   XREF to: 004e40e1 (CONDITIONAL_JUMP)  ; LAB_004e40e1
    CMP EBX,0x1000                      ; 004e40a6
    JGE 0x004e40e1                      ; 004e40ac
        ;   XREF to: 004e40e1 (CONDITIONAL_JUMP)  ; LAB_004e40e1
    PUSH EBP                            ; 004e40ae
    PUSH 0xff                           ; 004e40af
    ...
    JNZ 0x004e42fb                      ; 004e40db
        ;   XREF to: 004e42fb (CONDITIONAL_JUMP)  ; LAB_004e42fb
    ...
    CALL sound_sndmain.cpp_enableSoundSystem_FUN_005aaef0 ; 004e40f9
    ...
    CALL sound_sndmain.cpp_isSfxChannelEnabled_FUN_005a9ea0 ; 004e4109
    ...
    JNZ 0x004e438a                      ; 004e4113
        ;   XREF to: 004e438a (CONDITIONAL_JUMP)  ; LAB_004e438a
    CALL engine_2d.c_clearInputAndWait_FUN_00403260 ; 004e4119
        ;   XREF to: 00403260 (UNCONDITIONAL_CALL)  ; void engine_2d.c_clearInputAndWait_FUN_00403260()
        ;   Label: LAB_004e4119
    PUSH 0x58                           ; 004e411e
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 004e4182
    ...
    PUSH EAX                            ; 004e41b9
    CALL engine_alphabit.cpp_CAlphaBitmap_display_FUN_00410950 ; 004e41ba
    ...
    JLE 0x004e423d                      ; 004e41cb
        ;   XREF to: 004e423d (CONDITIONAL_JUMP)  ; LAB_004e423d
    ...
    JNZ 0x004e41f8                      ; 004e41e8
        ;   XREF to: 004e41f8 (CONDITIONAL_JUMP)  ; LAB_004e41f8
    CMP byte ptr [EAX + 0x1],0x62       ; 004e41ea
    JNZ 0x004e41f5                      ; 004e41ee
        ;   XREF to: 004e41f5 (CONDITIONAL_JUMP)  ; LAB_004e41f5
    ...
    JL 0x004e421f                       ; 004e4201
        ;   XREF to: 004e421f (CONDITIONAL_JUMP)  ; LAB_004e421f
    CMP EBP,ECX                         ; 004e4203
    JLE 0x004e421f                      ; 004e4205
        ;   XREF to: 004e421f (CONDITIONAL_JUMP)  ; LAB_004e421f
    PUSH EAX                            ; 004e4207
    PUSH 0x0                            ; 004e4208
    PUSH EDX                            ; 004e420a
    ...
    JL 0x004e41da                       ; 004e423b
        ;   XREF to: 004e41da (CONDITIONAL_JUMP)  ; LAB_004e41da
    MOV ECX,dword ptr [ESP + 0x111c]    ; 004e423d
        ;   Label: LAB_004e423d
    TEST ECX,ECX                        ; 004e4244
    JZ 0x004e4259                       ; 004e4246
        ;   XREF to: 004e4259 (CONDITIONAL_JUMP)  ; LAB_004e4259
    PUSH ECX                            ; 004e4248
    CALL sound_sndmain.cpp_isSfxPlaying_FUN_005a9660 ; 004e4249
        ;   XREF to: 005a9660 (UNCONDITIONAL_CALL)  ; int sound_sndmain.cpp_isSfxPlaying_FUN_005a9660(uint sfx_handle)
    ADD ESP,0x4                         ; 004e424e
    TEST EAX,EAX                        ; 004e4251
    JZ 0x004e43c1                       ; 004e4253
    ...
    PUSH 0x0                            ; 004e4262
    PUSH 0x19e                          ; 004e4264
    CALL engine_2d.c_fillRectColor_FUN_00403170 ; 004e4269
    ...
    PUSH 0x1b7                          ; 004e427d
    PUSH 0x19e                          ; 004e4282
    CALL engine_2d.c_fillRectColor_FUN_00403170 ; 004e4287
        ;   XREF to: 00403170 (UNCONDITIONAL_CALL)  ; void engine_2d.c_fillRectColor_FUN_00403170(int x1, int y1, int x2, int y2, ...)
    ADD ESP,0x14                        ; 004e428c
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 004e428f
    ...
    FMUL float ptr [0x0062d66d]         ; 004e42c8 | FLOAT_0062d66d
    FSUBR float ptr [ESP + 0x1124]      ; 004e42ce
    FSTP float ptr [ESP + 0x1124]       ; 004e42d5
    JMP 0x004e4174                      ; 004e42dc
        ;   XREF to: 004e4174 (UNCONDITIONAL_JUMP)  ; LAB_004e4174
    PUSH EBX                            ; 004e42e1
        ;   Label: LAB_004e42e1
    ...
    PUSH 0x1237                         ; 004e42fb
        ;   Label: LAB_004e42fb
    PUSH 0x62d5f4                       ; 004e4300 | = "..\\core\\game.cpp"
    ...
    PUSH ECX                            ; 004e4319
    CALL shape_memdbg.cpp_debugMalloc_FUN_0050f250 ; 004e431a
    ...
    JZ 0x004e4366                       ; 004e4328
        ;   XREF to: 004e4366 (CONDITIONAL_JUMP)  ; LAB_004e4366
    ...
    CMP AL,0x0                          ; 004e4341
    JZ 0x004e4355                       ; 004e4343
        ;   XREF to: 004e4355 (CONDITIONAL_JUMP)  ; LAB_004e4355
    MOV AL,byte ptr [ESI + 0x1]         ; 004e4345
    ADD ESI,0x2                         ; 004e4348
    MOV byte ptr [EDI + 0x1],AL         ; 004e434b
    ADD EDI,0x2                         ; 004e434e
    CMP AL,0x0                          ; 004e4351
    JNZ 0x004e433d                      ; 004e4353
        ;   XREF to: 004e433d (CONDITIONAL_JUMP)  ; LAB_004e433d
    POP EDI                             ; 004e4355
        ;   Label: LAB_004e4355
    INC EDX                             ; 004e4356
    ADD EBX,0x4                         ; 004e4357
    MOV dword ptr [ESP + 0x1128],EDX    ; 004e435a
    JMP 0x004e40a0                      ; 004e4361
        ;   XREF to: 004e40a0 (UNCONDITIONAL_JUMP)  ; LAB_004e40a0
    MOV EDI,0x62d605                    ; 004e4366 | = "..\\core\\game.cpp"
        ;   Label: LAB_004e4366
    MOV EAX,0x1239                      ; 004e436b
    PUSH 0x62d616                       ; 004e4370 | = "CGame::rollCredits - Out of memory"
    MOV dword ptr [0x02f0ca48],EDI      ; 004e4375 | g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 004e437b | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004e4380
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ADD ESP,0x4                         ; 004e4385
    JMP 0x004e432a                      ; 004e4388
        ;   XREF to: 004e432a (UNCONDITIONAL_JUMP)  ; LAB_004e432a
    CALL sound_sndmain.cpp_pushSfxOptions_FUN_005a8c30 ; 004e438a
        ;   XREF to: 005a8c30 (UNCONDITIONAL_CALL)  ; void sound_sndmain.cpp_pushSfxOptions_FUN_005a8c30()
        ;   Label: LAB_004e438a
    PUSH 0x1                            ; 004e438f
    CALL sound_sndmain.cpp_setNextSfxChannel_FUN_005a8af0 ; 004e4391
    ...
    PUSH 0x1                            ; 004e4399
    CALL sound_sndmain.cpp_setNextSfxFlags_FUN_005a8b70 ; 004e439b
        ;   XREF to: 005a8b70 (UNCONDITIONAL_CALL)  ; void sound_sndmain.cpp_setNextSfxFlags_FUN_005a8b70(uint flags)
    ADD ESP,0x4                         ; 004e43a0
    PUSH 0x62d64a                       ; 004e43a3 | = "faded-remix.mp3"
    CALL sound_sndmain.cpp_startSfx_FUN_005a8e90 ; 004e43a8
    ...
    CALL sound_sndmain.cpp_popSfxOptions_FUN_005a8cb0 ; 004e43b7
    ...
    CALL sound_sndmain.cpp_resetSoundDevice_FUN_005ab130 ; 004e43d4
        ;   XREF to: 005ab130 (UNCONDITIONAL_CALL)  ; int sound_sndmain.cpp_resetSoundDevice_FUN_005ab130()
        ;   Label: LAB_004e43d4
    MOV EBX,dword ptr [ESP + 0x1128]    ; 004e43d9
    CALL engine_2d.c_clearInputAndWait_FUN_00403260 ; 004e43e0
        ;   XREF to: 00403260 (UNCONDITIONAL_CALL)  ; void engine_2d.c_clearInputAndWait_FUN_00403260()
    TEST EBX,EBX                        ; 004e43e5
    JLE 0x004e4420                      ; 004e43e7
        ;   XREF to: 004e4420 (CONDITIONAL_JUMP)  ; LAB_004e4420
    MOV ESI,dword ptr [ESP + 0x1128]    ; 004e43e9
    XOR EBX,EBX                         ; 004e43f0
    SHL ESI,0x2                         ; 004e43f2
    PUSH 0x1294                         ; 004e43f5
        ;   Label: LAB_004e43f5
    PUSH 0x62d65a                       ; 004e43fa | = "..\\core\\game.cpp"
    MOV EDI,dword ptr [ESP + EBX*0x1 + 0x10] ; 004e43ff
    PUSH EDI                            ; 004e4403
    ADD EBX,0x4                         ; 004e4404
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 004e4407
        ;   XREF to: 0050f460 (UNCONDITIONAL_CALL)  ; void shape_memdbg.cpp_debugFree_FUN_0050f460(void * ptr, char * filename, int line_number)
    ADD ESP,0xc                         ; 004e440c
    CMP EBX,ESI                         ; 004e440f
    JL 0x004e43f5                       ; 004e4411
        ;   XREF to: 004e43f5 (CONDITIONAL_JUMP)  ; LAB_004e43f5
