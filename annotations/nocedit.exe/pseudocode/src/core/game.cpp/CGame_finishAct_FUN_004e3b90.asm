...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_game.cpp_CGame_finishAct_FUN_004e3b90()
;
; Local Variables:
...
section .text
    ...
    JNZ 0x004e3c6c                      ; 004e3ba9 | LAB_004e3c6c
        ;   XREF to: 004e3c6c (CONDITIONAL_JUMP)
    MOV EAX,[0x03275a28]                ; 004e3baf | g_ScreenHeightForFonts
    MOV EDI,dword ptr [0x020a5720]      ; 004e3bb4 | CBitFont * g_ThemeFont
    CMP EAX,0x1e0                       ; 004e3bba
    JGE 0x004e3bc7                      ; 004e3bbf | LAB_004e3bc7
        ;   XREF to: 004e3bc7 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [0x020a5724]      ; 004e3bc1 | CBitFont * g_SmallEditorFont
    PUSH 0x58                           ; 004e3bc7
        ;   Label: LAB_004e3bc7
    PUSH EDI                            ; 004e3bc9
    CALL engine_font.cpp_CBitFont_getCharWidth_FUN_004d01d0 ; 004e3bca | int engine_font.cpp_CBitFont_getCharWidth_FUN_004d01d0(CBitFont * this_ptr, int char_code)
        ;   XREF to: 004d01d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004e3bcf
    MOV EDX,dword ptr [EBP + 0x14]      ; 004e3bd2
    PUSH EDX                            ; 004e3bd5
    MOV ESI,EAX                         ; 004e3bd6
    CALL core_game.cpp_CGame_saveClockTime_FUN_004d7d80 ; 004e3bd8 | void core_game.cpp_CGame_saveClockTime_FUN_004d7d80(CGame * n1, CGame * n2)
    ...
    FNSTSW AX                           ; 004e3bef
    SAHF                                ; 004e3bf1
    JNC 0x004e3c54                      ; 004e3bf2 | LAB_004e3c54
        ;   XREF to: 004e3c54 (CONDITIONAL_JUMP)
    CALL wincore_windll.cpp_clearScreen_FUN_005b3e70 ; 004e3bf4 | void wincore_windll.cpp_clearScreen_FUN_005b3e70()
        ;   XREF to: 005b3e70 (UNCONDITIONAL_CALL)
    PUSH 0x62d555                       ; 004e3bf9 | = "To be continued..." | s_To_be_continued_0062d555 = To be continued...
    CALL support_newmsg.cpp_getLocalizedString_FUN_005441f0 ; 004e3bfe | char * support_newmsg.cpp_getLocalizedString_FUN_005441f0(char * key)
        ;   XREF to: 005441f0 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [0x00679398]      ; 004e3c03 | int g_WindowHeight
    ...
    PUSH 0xf8                           ; 004e3c1a
    PUSH EAX                            ; 004e3c1f
    MOV EAX,[0x00679394]                ; 004e3c20 | int g_WindowWidth
    DEC EAX                             ; 004e3c25
    PUSH EAX                            ; 004e3c26
    PUSH 0x0                            ; 004e3c27
    PUSH EDI                            ; 004e3c29
    CALL engine_font.cpp_CBitFont_drawTextCenterInBounds_FUN_004cdee0 ; 004e3c2a | int engine_font.cpp_CBitFont_drawTextCenterInBounds_FUN_004cdee0(CBitFont * this_ptr, int left_x, int right_x, int y_pos, ...)
        ;   XREF to: 004cdee0 (UNCONDITIONAL_CALL)
    ADD ESP,0x1c                        ; 004e3c2f
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 004e3c32 | void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20()
        ;   XREF to: 005eda20 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EBP + 0x14]      ; 004e3c37
    PUSH EAX                            ; 004e3c3a
    CALL core_game.cpp_CGame_updateDeltaTime_FUN_004d7d90 ; 004e3c3b | void core_game.cpp_CGame_updateDeltaTime_FUN_004d7d90(CGame * this_ptr)
    ...
    JMP 0x004e3be8                      ; 004e3c52 | LAB_004e3be8
        ;   XREF to: 004e3be8 (UNCONDITIONAL_JUMP)
    MOV EBX,dword ptr [EBP + 0x14]      ; 004e3c54
        ;   Label: LAB_004e3c54
    CALL engine_2d.c_clearInputAndWait_FUN_00403260 ; 004e3c57 | void engine_2d.c_clearInputAndWait_FUN_00403260()
        ;   XREF to: 00403260 (UNCONDITIONAL_CALL)
    PUSH EBX                            ; 004e3c5c
    CALL core_game.cpp_CGame_rollCredits_FUN_004e4010 ; 004e3c5d | void core_game.cpp_CGame_rollCredits_FUN_004e4010(CGame * this_ptr)
    ...
    CALL engine_alphabit.cpp_CAlphaBitmap_ctor_FUN_00410520 ; 004e3c9d | void engine_alphabit.cpp_CAlphaBitmap_ctor_FUN_00410520(CAlphaBitmap * this_ptr)
        ;   XREF to: 00410520 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004e3ca2
    PUSH 0x1e0                          ; 004e3ca5
    PUSH 0x280                          ; 004e3caa
    PUSH 0x62d568                       ; 004e3caf | = "stats" | s_stats_0062d568 = stats
    LEA EAX,[ESP + 0x510]               ; 004e3cb4
    PUSH EAX                            ; 004e3cbb
    CALL engine_alphabit.cpp_CAlphaBitmap_load_FUN_004105d0 ; 004e3cbc | void engine_alphabit.cpp_CAlphaBitmap_load_FUN_004105d0(CAlphaBitmap * this_ptr, char * filename, int width, int height)
        ;   XREF to: 004105d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004e3cc1
    CALL wincore_windll.cpp_clearScreen_FUN_005b3e70 ; 004e3cc4 | void wincore_windll.cpp_clearScreen_FUN_005b3e70()
        ;   XREF to: 005b3e70 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 004e3cd9
    CALL engine_alphabit.cpp_CAlphaBitmap_display_FUN_00410950 ; 004e3cda | void engine_alphabit.cpp_CAlphaBitmap_display_FUN_00410950(CAlphaBitmap * this_ptr, int x, int y, int alpha)
    ...
    FLD ST0                             ; 004e3ceb
    FMUL double ptr [0x0062d5ad]        ; 004e3ced | double DOUBLE_0062d5ad
    CALL crt_math.c_round_FUN_005fe6b0  ; 004e3cf3 | double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    FMUL double ptr [0x0062d5b5]        ; 004e3d14 | double DOUBLE_0062d5b5
    FSUBP                               ; 004e3d1a
    MOV EAX,dword ptr [EBP + 0x14]      ; 004e3d1c
    FST float ptr [EAX + 0x248]         ; 004e3d1f
    FLD ST0                             ; 004e3d25
    FMUL double ptr [0x0062d5bd]        ; 004e3d27 | double DOUBLE_0062d5bd
    CALL crt_math.c_round_FUN_005fe6b0  ; 004e3d2d | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    FMUL double ptr [0x0062d5c5]        ; 004e3d4e | double DOUBLE_0062d5c5
    FSUBP                               ; 004e3d54
    MOV EAX,dword ptr [EBP + 0x14]      ; 004e3d56
    FST float ptr [EAX + 0x248]         ; 004e3d59
    CALL crt_math.c_round_FUN_005fe6b0  ; 004e3d5f | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    FMUL double ptr [0x0062d5cd]        ; 004e3d8f | double DOUBLE_0062d5cd
    PUSH 0x62d56e                       ; 004e3d95 | = "Mission time" | s_Mission_time_0062d56e = Mission time
    CALL crt_math.c_round_FUN_005fe6b0  ; 004e3d9a | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x528]       ; 004e3d9f
    CALL support_newmsg.cpp_getLocalizedString_FUN_005441f0 ; 004e3da6 | char * support_newmsg.cpp_getLocalizedString_FUN_005441f0(char * key)
        ;   XREF to: 005441f0 (UNCONDITIONAL_CALL)
    ...
    CMP AL,0x0                          ; 004e3db9
    JZ 0x004e3dcd                       ; 004e3dbb | LAB_004e3dcd
    ...
    CMP AL,0x0                          ; 004e3dc9
    JNZ 0x004e3db5                      ; 004e3dcb | LAB_004e3db5
    ...
    CMP AL,0x0                          ; 004e3deb
    JZ 0x004e3dff                       ; 004e3ded | LAB_004e3dff
    ...
    CMP AL,0x0                          ; 004e3dfb
    JNZ 0x004e3de7                      ; 004e3dfd | LAB_004e3de7
    ...
    PUSH EAX                            ; 004e3e18
    PUSH 0x62d57e                       ; 004e3e19 | = "%2d:%2d:%2d.%2d\n\n" | s_s_2d_2d_2d_2d_0062d57e = %2d:%2d:%2d.%2d


    LEA EAX,[ESP + 0x418]               ; 004e3e1e
    PUSH EAX                            ; 004e3e25
    XOR ESI,ESI                         ; 004e3e26
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 004e3e28 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    CMP AL,0x0                          ; 004e3e75
    JZ 0x004e3e89                       ; 004e3e77 | LAB_004e3e89
    ...
    CMP AL,0x0                          ; 004e3e85
    JNZ 0x004e3e71                      ; 004e3e87 | LAB_004e3e71
        ;   XREF to: 004e3e71 (CONDITIONAL_JUMP)
    POP EDI                             ; 004e3e89
        ;   Label: LAB_004e3e89
    PUSH 0x62d590                       ; 004e3e8a | = "Total body count" | s_Total_body_count_0062d590 = Total body count
    CALL support_newmsg.cpp_getLocalizedString_FUN_005441f0 ; 004e3e8f | char * support_newmsg.cpp_getLocalizedString_FUN_005441f0(char * key)
        ;   XREF to: 005441f0 (UNCONDITIONAL_CALL)
    ...
    CMP AL,0x0                          ; 004e3eaa
    JZ 0x004e3ebe                       ; 004e3eac | LAB_004e3ebe
    ...
    CMP AL,0x0                          ; 004e3eba
    JNZ 0x004e3ea6                      ; 004e3ebc | LAB_004e3ea6
    ...
    CMP AL,0x0                          ; 004e3ed5
    JZ 0x004e3ee9                       ; 004e3ed7 | LAB_004e3ee9
    ...
    CMP AL,0x0                          ; 004e3ee5
    JNZ 0x004e3ed1                      ; 004e3ee7 | LAB_004e3ed1
    ...
    PUSH EAX                            ; 004e3f00
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 004e3f01 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ...
    CMP AL,0x0                          ; 004e3f21
    JZ 0x004e3f35                       ; 004e3f23 | LAB_004e3f35
    ...
    CMP AL,0x0                          ; 004e3f31
    JNZ 0x004e3f1d                      ; 004e3f33 | LAB_004e3f1d
        ;   XREF to: 004e3f1d (CONDITIONAL_JUMP)
    POP EDI                             ; 004e3f35
        ;   Label: LAB_004e3f35
    MOV EAX,[0x020a5720]                ; 004e3f36 | CBitFont * g_ThemeFont
    PUSH 0xffff                         ; 004e3f3b
    MOV dword ptr [ESP + 0x538],EAX     ; 004e3f40
    CALL engine_3d.c_setRenderAlpha_FUN_00406d80 ; 004e3f47 | void engine_3d.c_setRenderAlpha_FUN_00406d80(int alpha_color_value)
        ;   XREF to: 00406d80 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004e3f4c
    PUSH 0xc0                           ; 004e3f4f
    PUSH 0x100                          ; 004e3f54
    PUSH 0x14                           ; 004e3f59
    PUSH 0x2d7d6f0                      ; 004e3f5b | DAT_02d7d6f0
    LEA EAX,[ESP + 0x14]                ; 004e3f60
    PUSH EAX                            ; 004e3f64
    MOV ESI,dword ptr [ESP + 0x548]     ; 004e3f65
    PUSH ESI                            ; 004e3f6c
    CALL engine_font.cpp_CBitFont_wrapText_FUN_004d0010 ; 004e3f6d | int engine_font.cpp_CBitFont_wrapText_FUN_004d0010(CBitFont * this_ptr, char * source_text, char * dest_buffer, int max_lines, ...)
    ...
    CALL engine_font.cpp_CBitFont_getCharWidth_FUN_004d01d0 ; 004e3f83 | int engine_font.cpp_CBitFont_getCharWidth_FUN_004d01d0(CBitFont * this_ptr, int char_code)
        ;   XREF to: 004d01d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004e3f88
    MOV ESI,0xf0                        ; 004e3f8b
    MOV dword ptr [ESP + 0x530],EAX     ; 004e3f90
    TEST EBX,EBX                        ; 004e3f97
    JLE 0x004e3fe0                      ; 004e3f99 | LAB_004e3fe0
        ;   XREF to: 004e3fe0 (CONDITIONAL_JUMP)
    MOV EBX,0x2d7d6f0                   ; 004e3f9b | DAT_02d7d6f0
    PUSH EBX                            ; 004e3fa0 | DAT_02d7d6f0
        ;   Label: LAB_004e3fa0
    PUSH 0x0                            ; 004e3fa1
    PUSH 0xf8                           ; 004e3fa3
    PUSH ESI                            ; 004e3fa8
    ...
    PUSH EAX                            ; 004e3fba
    INC EDI                             ; 004e3fbb
    CALL engine_font.cpp_CBitFont_drawTextCenterInBounds_FUN_004cdee0 ; 004e3fbc | int engine_font.cpp_CBitFont_drawTextCenterInBounds_FUN_004cdee0(CBitFont * this_ptr, int left_x, int right_x, int y_pos, ...)
        ;   XREF to: 004cdee0 (UNCONDITIONAL_CALL)
    ...
    JL 0x004e3fa0                       ; 004e3fdc | LAB_004e3fa0
        ;   XREF to: 004e3fa0 (CONDITIONAL_JUMP)
    MOV EAX,EAX                         ; 004e3fde
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 004e3fe0 | void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20()
        ;   Label: LAB_004e3fe0
        ;   XREF to: 005eda20 (UNCONDITIONAL_CALL)
    CALL engine_2d.c_clearInputAndWait_FUN_00403260 ; 004e3fe5 | void engine_2d.c_clearInputAndWait_FUN_00403260()
        ;   XREF to: 00403260 (UNCONDITIONAL_CALL)
    CALL wincore_winrun.cpp_getNextKeypress_FUN_005f2e90 ; 004e3fea | int wincore_winrun.cpp_getNextKeypress_FUN_005f2e90()
        ;   XREF to: 005f2e90 (UNCONDITIONAL_CALL)
    CALL engine_2d.c_clearInputAndWait_FUN_00403260 ; 004e3fef | void engine_2d.c_clearInputAndWait_FUN_00403260()
        ;   XREF to: 00403260 (UNCONDITIONAL_CALL)
    PUSH 0x0                            ; 004e3ff4
    LEA EAX,[ESP + 0x508]               ; 004e3ff6
    PUSH EAX                            ; 004e3ffd
    CALL engine_alphabit.cpp_CAlphaBitmap_dtor_FUN_00410540 ; 004e3ffe | CAlphaBitmap * engine_alphabit.cpp_CAlphaBitmap_dtor_FUN_00410540(CAlphaBitmap * this_ptr)
