...
; CBitFont *       Stack[-0x40]:4  local_40
; int              Stack[-0x3c]:4  local_3c
; CBitFont *       Stack[-0x38]:4  local_38
...
section .text
    ...
    PUSH 0x58                           ; 004d80cb
        ;   Label: LAB_004d80cb
    PUSH EBX                            ; 004d80cd
    CALL engine_font.cpp_CBitFont_getCharHeight_FUN_004d01d0 ; 004d80ce
    ...
    CALL core_script.cpp_CScript_getLetterboxHeight_FUN_00559ac0 ; 004d80eb
        ;   XREF to: 00559ac0 (UNCONDITIONAL_CALL)  ; int core_script.cpp_CScript_getLetterboxHeight_FUN_00559ac0(CScript * this_ptr)
    ...
    CALL core_script.cpp_CScript_getLetterboxHeight_FUN_00559ac0 ; 004d80fa
        ;   XREF to: 00559ac0 (UNCONDITIONAL_CALL)  ; int core_script.cpp_CScript_getLetterboxHeight_FUN_00559ac0(CScript * this_ptr)
    ...
    PUSH EAX                            ; 004d814c
    PUSH EBX                            ; 004d814d
    CALL engine_font.cpp_CBitFont_drawText_FUN_004cda80 ; 004d814e
    ...
    PUSH EDX                            ; 004d81e2
    CALL engine_font.cpp_CBitFont_getCharHeight_FUN_004d01d0 ; 004d81e3
        ;   XREF to: 004d01d0 (UNCONDITIONAL_CALL)  ; int engine_font.cpp_CBitFont_getCharHeight_FUN_004d01d0(CBitFont * this_ptr, int char_code)
    ...
    PUSH ESI                            ; 004d81fd
    CALL engine_font.cpp_CBitFont_getCharHeight_FUN_004d01d0 ; 004d81fe
        ;   XREF to: 004d01d0 (UNCONDITIONAL_CALL)  ; int engine_font.cpp_CBitFont_getCharHeight_FUN_004d01d0(CBitFont * this_ptr, int char_code)
    ...
    PUSH EAX                            ; 004d83a6
    CALL engine_font.cpp_CBitFont_drawText_FUN_004cda80 ; 004d83a7
        ;   XREF to: 004cda80 (UNCONDITIONAL_CALL)  ; int engine_font.cpp_CBitFont_drawText_FUN_004cda80(CBitFont * this_ptr, char * text, int x, int y, ...)
    ...
    CALL engine_font.cpp_CBitFont_getCharHeight_FUN_004d01d0 ; 004d84b0
        ;   XREF to: 004d01d0 (UNCONDITIONAL_CALL)  ; int engine_font.cpp_CBitFont_getCharHeight_FUN_004d01d0(CBitFont * this_ptr, int char_code)
    ...
    CALL core_script.cpp_CScript_getLetterboxHeight_FUN_00559ac0 ; 004d84d4
        ;   XREF to: 00559ac0 (UNCONDITIONAL_CALL)  ; int core_script.cpp_CScript_getLetterboxHeight_FUN_00559ac0(CScript * this_ptr)
    ...
    PUSH EDX                            ; 004d854d
    INC EDI                             ; 004d854e
    CALL engine_font.cpp_CBitFont_drawText_FUN_004cda80 ; 004d854f
        ;   XREF to: 004cda80 (UNCONDITIONAL_CALL)  ; int engine_font.cpp_CBitFont_drawText_FUN_004cda80(CBitFont * this_ptr, char * text, int x, int y, ...)
