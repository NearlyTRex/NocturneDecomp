...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_game.cpp_CGame_renderOverlay_FUN_004d8040(CGame * this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EAX,[0x00679394]                ; 004d804f | int g_WindowWidth
    MOV dword ptr [ESP + 0x110],EAX     ; 004d8054
    MOV EAX,[0x00679398]                ; 004d805b | int g_WindowHeight
    ...
    JNZ 0x004d83fd                      ; 004d807b | LAB_004d83fd
        ;   XREF to: 004d83fd (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 004d8081
    LEA EDX,[EDX]                       ; 004d8087
    LEA EAX,[EAX]                       ; 004d808d
    FLD float ptr [0x02d831ac]          ; 004d8090 | float g_OverlayDisplayTimer
        ;   Label: LAB_004d8090
    FLDZ                                ; 004d8096
    FCOMPP                              ; 004d8098
    FNSTSW AX                           ; 004d809a
    SAHF                                ; 004d809c
    JNC 0x004d8156                      ; 004d809d | LAB_004d8156
        ;   XREF to: 004d8156 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x00679398]      ; 004d80a3 | int g_WindowHeight
    MOV EBX,dword ptr [0x020a5718]      ; 004d80a9 | CBitFont * g_MediumFont
    CMP EDX,0x1e0                       ; 004d80af
    JGE 0x004d80cb                      ; 004d80b5 | LAB_004d80cb
        ;   XREF to: 004d80cb (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [0x020a571c]      ; 004d80b7 | CBitFont * g_TinyFont
    CMP EDX,0x180                       ; 004d80bd
    JGE 0x004d80cb                      ; 004d80c3 | LAB_004d80cb
        ;   XREF to: 004d80cb (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [0x020a5724]      ; 004d80c5 | CBitFont * g_SmallEditorFont
    PUSH 0x58                           ; 004d80cb
        ;   Label: LAB_004d80cb
    PUSH EBX                            ; 004d80cd
    CALL engine_font.cpp_CBitFont_getCharWidth_FUN_004d01d0 ; 004d80ce | int engine_font.cpp_CBitFont_getCharWidth_FUN_004d01d0(CBitFont * this_ptr, int char_code)
        ;   XREF to: 004d01d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004d80d3
    PUSH 0x58                           ; 004d80d6
    PUSH EBX                            ; 004d80d8
    MOV EDI,EAX                         ; 004d80d9
    CALL engine_font.cpp_CBitFont_getCharWidth_FUN_004d01a0 ; 004d80db | int engine_font.cpp_CBitFont_getCharWidth_FUN_004d01a0(CBitFont * font, int char_code)
        ;   XREF to: 004d01a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004d80e0
    MOV ESI,EAX                         ; 004d80e3
    MOV EAX,[0x00680d50]                ; 004d80e5 | CScript g_CScriptInstance | CScript * g_CScriptPtr
    PUSH EAX                            ; 004d80ea | CScript g_CScriptInstance
    CALL core_script.cpp_FUN_00559ac0   ; 004d80eb | undefined core_script.cpp_FUN_00559ac0()
        ;   XREF to: 00559ac0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004d80f0
    MOV EDX,dword ptr [0x00680d50]      ; 004d80f3 | CScript g_CScriptInstance | CScript * g_CScriptPtr
    PUSH EDX                            ; 004d80f9 | CScript g_CScriptInstance
    CALL core_script.cpp_FUN_00559ac0   ; 004d80fa | undefined core_script.cpp_FUN_00559ac0()
        ;   XREF to: 00559ac0 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [0x00679398]      ; 004d80ff | int g_WindowHeight
    ...
    CALL engine_3d.c_setRenderAlpha_FUN_00406d80 ; 004d8115 | void engine_3d.c_setRenderAlpha_FUN_00406d80(int alpha_color_value)
        ;   XREF to: 00406d80 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004d811a
    PUSH 0x2d830a8                      ; 004d811d | undefined1 DAT_02d830a8
    MOV ECX,dword ptr [0x02d831a8]      ; 004d8122 | char * g_CurrentDisplayText
    PUSH ECX                            ; 004d8128
    PUSH 0x62b265                       ; 004d8129 | = "%d - %s" | s_d_s_0062b265 = %d - %s
    LEA EAX,[ESP + 0x18]                ; 004d812e
    PUSH EAX                            ; 004d8132
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 004d8133 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH EAX                            ; 004d814c
    PUSH EBX                            ; 004d814d
    CALL engine_font.cpp_CBitFont_drawTextLeft_FUN_004cda80 ; 004d814e | int engine_font.cpp_CBitFont_drawTextLeft_FUN_004cda80(CBitFont * this_ptr, char * text_string, int x_pos, int y_pos, ...)
    ...
    JNZ 0x004d83f6                      ; 004d8160 | LAB_004d83f6
        ;   XREF to: 004d83f6 (CONDITIONAL_JUMP)
    CMP dword ptr [EAX + 0x388],0x0     ; 004d8166
    JLE 0x004d83f6                      ; 004d816d | LAB_004d83f6
        ;   XREF to: 004d83f6 (CONDITIONAL_JUMP)
    ...
    MOV EAX,[0x020a5724]                ; 004d81a3 | CBitFont * g_SmallEditorFont
    MOV EDI,dword ptr [0x00679394]      ; 004d81a8 | int g_WindowWidth
    MOV dword ptr [ESP + 0x130],EAX     ; 004d81ae
    CMP EDI,0x280                       ; 004d81b5
    JG 0x004d8580                       ; 004d81bb | LAB_004d8580
        ;   XREF to: 004d8580 (CONDITIONAL_JUMP)
    CMP dword ptr [0x00679394],0x320    ; 004d81c1 | int g_WindowWidth
        ;   Label: LAB_004d81c1
    JLE 0x004d81d9                      ; 004d81cb | LAB_004d81d9
        ;   XREF to: 004d81d9 (CONDITIONAL_JUMP)
    MOV EAX,[0x020a5718]                ; 004d81cd | CBitFont * g_MediumFont
    MOV dword ptr [ESP + 0x130],EAX     ; 004d81d2
    PUSH 0x58                           ; 004d81d9
        ;   Label: LAB_004d81d9
    MOV EDX,dword ptr [ESP + 0x134]     ; 004d81db
    PUSH EDX                            ; 004d81e2
    CALL engine_font.cpp_CBitFont_getCharWidth_FUN_004d01d0 ; 004d81e3 | int engine_font.cpp_CBitFont_getCharWidth_FUN_004d01d0(CBitFont * this_ptr, int char_code)
        ;   XREF to: 004d01d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004d81e8
    CMP EAX,dword ptr [ESP + 0x12c]     ; 004d81eb
    JLE 0x004d820d                      ; 004d81f2 | LAB_004d820d
        ;   XREF to: 004d820d (CONDITIONAL_JUMP)
    PUSH 0x58                           ; 004d81f4
    MOV ESI,dword ptr [ESP + 0x134]     ; 004d81f6
    PUSH ESI                            ; 004d81fd
    CALL engine_font.cpp_CBitFont_getCharWidth_FUN_004d01d0 ; 004d81fe | int engine_font.cpp_CBitFont_getCharWidth_FUN_004d01d0(CBitFont * this_ptr, int char_code)
        ;   XREF to: 004d01d0 (UNCONDITIONAL_CALL)
    ...
    JLE 0x004d83f6                      ; 004d825b | LAB_004d83f6
        ;   XREF to: 004d83f6 (CONDITIONAL_JUMP)
    ...
    FCOMP double ptr [0x0062b275]       ; 004d82e7 | double g_StatusThresholdHigh
    FNSTSW AX                           ; 004d82ed
    SAHF                                ; 004d82ef
    JNC 0x004d82f7                      ; 004d82f0 | LAB_004d82f7
        ;   XREF to: 004d82f7 (CONDITIONAL_JUMP)
    MOV EDI,0xfb                        ; 004d82f2
    FLD float ptr [ESP + 0x8]           ; 004d82f7
        ;   Label: LAB_004d82f7
    FCOMP double ptr [0x0062b27d]       ; 004d82fb | double g_StatusThresholdLow
    FNSTSW AX                           ; 004d8301
    SAHF                                ; 004d8303
    JNC 0x004d830b                      ; 004d8304 | LAB_004d830b
    ...
    PUSH ECX                            ; 004d8326
    PUSH EBX                            ; 004d8327
    CALL engine_2d.c_fillRectWithBorder_FUN_00403200 ; 004d8328 | void engine_2d.c_fillRectWithBorder_FUN_00403200(int x1, int y1, int x2, int y2, ...)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 004d834c | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x144]       ; 004d8351
    MOV EAX,dword ptr [ESP + 0x144]     ; 004d8358
    TEST EAX,EAX                        ; 004d835f
    JLE 0x004d8380                      ; 004d8361 | LAB_004d8380
    ...
    PUSH ECX                            ; 004d8376
    PUSH EBX                            ; 004d8377
    CALL engine_2d.c_fillRectColor_FUN_00403170 ; 004d8378 | void engine_2d.c_fillRectColor_FUN_00403170(int x1, int y1, int x2, int y2, ...)
    ...
    PUSH EAX                            ; 004d83a6
    CALL engine_font.cpp_CBitFont_drawTextLeft_FUN_004cda80 ; 004d83a7 | int engine_font.cpp_CBitFont_drawTextLeft_FUN_004cda80(CBitFont * this_ptr, char * text_string, int x_pos, int y_pos, ...)
        ;   XREF to: 004cda80 (UNCONDITIONAL_CALL)
    ...
    JL 0x004d8298                       ; 004d83f0 | LAB_004d8298
    ...
    FNSTSW AX                           ; 004d840b
    SAHF                                ; 004d840d
    JBE 0x004d8576                      ; 004d840e | LAB_004d8576
        ;   XREF to: 004d8576 (CONDITIONAL_JUMP)
    FLD double ptr [ESP]                ; 004d8414
    FMUL double ptr [0x0062b26d]        ; 004d8417 | double g_AlphaConversionFactor
    CALL crt_math.c_round_FUN_005fe6b0  ; 004d841d | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x15c]       ; 004d8422
    MOV ECX,dword ptr [ESP + 0x15c]     ; 004d8429
    PUSH ECX                            ; 004d8430
    CALL engine_3d.c_setRenderAlpha_FUN_00406d80 ; 004d8431 | void engine_3d.c_setRenderAlpha_FUN_00406d80(int alpha_color_value)
        ;   Label: LAB_004d8431
        ;   XREF to: 00406d80 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004d8436
    MOV EAX,[0x020a5720]                ; 004d8439 | CBitFont * g_ThemeFont
    MOV dword ptr [ESP + 0x138],EAX     ; 004d843e
    MOV EAX,[0x03275a28]                ; 004d8445 | g_ScreenHeightForFonts
    CMP EAX,0x1e0                       ; 004d844a
    JGE 0x004d845d                      ; 004d844f | LAB_004d845d
        ;   XREF to: 004d845d (CONDITIONAL_JUMP)
    MOV EAX,[0x020a5724]                ; 004d8451 | CBitFont * g_SmallEditorFont
    ...
    PUSH 0x2d7b8e0                      ; 004d8482 | char * g_WrappedTextBuffer
    ADD EAX,0x284                       ; 004d8487
    PUSH EAX                            ; 004d848c
    MOV EBX,dword ptr [ESP + 0x14c]     ; 004d848d
    PUSH EBX                            ; 004d8494
    CALL engine_font.cpp_CBitFont_wrapText_FUN_004d0010 ; 004d8495 | int engine_font.cpp_CBitFont_wrapText_FUN_004d0010(CBitFont * this_ptr, char * source_text, char * dest_buffer, int max_lines, ...)
    ...
    CALL engine_font.cpp_CBitFont_getCharWidth_FUN_004d01d0 ; 004d84b0 | int engine_font.cpp_CBitFont_getCharWidth_FUN_004d01d0(CBitFont * this_ptr, int char_code)
        ;   XREF to: 004d01d0 (UNCONDITIONAL_CALL)
    IMUL EBX,EAX                        ; 004d84b5
    ADD ESP,0x8                         ; 004d84b8
    MOV ESI,EAX                         ; 004d84bb
    MOV dword ptr [ESP + 0x11c],EAX     ; 004d84bd
    MOV EAX,[0x00679398]                ; 004d84c4 | int g_WindowHeight
    MOV EDI,dword ptr [0x00680d50]      ; 004d84c9 | CScript * g_CScriptPtr
    SUB EAX,EBX                         ; 004d84cf
    PUSH EDI                            ; 004d84d1 | CScript g_CScriptInstance
    MOV EBX,EAX                         ; 004d84d2
    CALL core_script.cpp_FUN_00559ac0   ; 004d84d4 | undefined core_script.cpp_FUN_00559ac0()
        ;   XREF to: 00559ac0 (UNCONDITIONAL_CALL)
    SUB EBX,EAX                         ; 004d84d9
    MOV EAX,EBX                         ; 004d84db
    MOV EDX,dword ptr [0x020a5724]      ; 004d84dd | CBitFont * g_SmallEditorFont
    SUB EAX,ESI                         ; 004d84e3
    ADD ESP,0x4                         ; 004d84e5
    MOV ESI,EAX                         ; 004d84e8
    CMP EDX,dword ptr [ESP + 0x138]     ; 004d84ea
    JNZ 0x004d84f6                      ; 004d84f1 | LAB_004d84f6
        ;   XREF to: 004d84f6 (CONDITIONAL_JUMP)
    SUB ESI,0x7                         ; 004d84f3
    MOV ECX,dword ptr [ESP + 0x128]     ; 004d84f6
        ;   Label: LAB_004d84f6
    MOV EAX,[0x00679394]                ; 004d84fd | int g_WindowWidth
    XOR EDI,EDI                         ; 004d8502
    DEC EAX                             ; 004d8504
    TEST ECX,ECX                        ; 004d8505
    JLE 0x004d8090                      ; 004d8507 | LAB_004d8090
        ;   XREF to: 004d8090 (CONDITIONAL_JUMP)
    MOV EBX,0x2d7b8e0                   ; 004d850d | char * g_WrappedTextBuffer
    MOV dword ptr [ESP + 0x124],EAX     ; 004d8512
    PUSH EBX                            ; 004d8519 | char * g_WrappedTextBuffer
        ;   Label: LAB_004d8519
    MOV EAX,dword ptr [ESP + 0x13c]     ; 004d851a
    PUSH EAX                            ; 004d8521
    CALL engine_font.cpp_CBitFont_getTextWidth_FUN_004cfe80 ; 004d8522 | int engine_font.cpp_CBitFont_getTextWidth_FUN_004cfe80(CBitFont * this_ptr, char * text)
    ...
    PUSH ESI                            ; 004d8543
    PUSH EAX                            ; 004d8544
    PUSH EBX                            ; 004d8545 | char * g_WrappedTextBuffer
    MOV EDX,dword ptr [ESP + 0x14c]     ; 004d8546
    PUSH EDX                            ; 004d854d
    INC EDI                             ; 004d854e
    CALL engine_font.cpp_CBitFont_drawTextLeft_FUN_004cda80 ; 004d854f | int engine_font.cpp_CBitFont_drawTextLeft_FUN_004cda80(CBitFont * this_ptr, char * text_string, int x_pos, int y_pos, ...)
        ;   XREF to: 004cda80 (UNCONDITIONAL_CALL)
    ...
    JL 0x004d8519                       ; 004d856f | LAB_004d8519
        ;   XREF to: 004d8519 (CONDITIONAL_JUMP)
    JMP 0x004d8090                      ; 004d8571 | LAB_004d8090
        ;   XREF to: 004d8090 (UNCONDITIONAL_JUMP)
    PUSH 0xffff                         ; 004d8576
        ;   Label: LAB_004d8576
    JMP 0x004d8431                      ; 004d857b | LAB_004d8431
        ;   XREF to: 004d8431 (UNCONDITIONAL_JUMP)
    MOV EAX,[0x020a571c]                ; 004d8580 | CBitFont * g_TinyFont
        ;   Label: LAB_004d8580
    MOV dword ptr [ESP + 0x130],EAX     ; 004d8585
    JMP 0x004d81c1                      ; 004d858c | LAB_004d81c1
