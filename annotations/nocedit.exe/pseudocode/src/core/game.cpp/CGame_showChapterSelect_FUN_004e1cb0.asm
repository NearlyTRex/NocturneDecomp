...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_game_cpp_CGame_showChapterSelect_FUN_004e1cb0(CGame *this_ptr,int unknown)
;
; Parameters:
...
section .text
    ...
    CALL core_game.cpp_CGame_loadSaveGame_FUN_004e12b0 ; 004e2087
