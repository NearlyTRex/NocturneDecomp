...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_game_cpp_CGame_playerControls_FUN_004dbd80(CGame *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 004dbdb4
        ;   Label: LAB_004dbdb4
    PUSH ESI                            ; 004dbdb5
    CALL core_game.cpp_KeypressesAndCGame_FUN_004dc3e0 ; 004dbdb6
    ...
    PUSH EDX                            ; 004dbdfb
        ;   Label: LAB_004dbdfb
    PUSH ESI                            ; 004dbdfc
    CALL core_game.cpp_CallToJoystickStuff_FUN_004dc230 ; 004dbdfd
        ;   XREF to: 004dc230 (UNCONDITIONAL_CALL)  ; void core_game.cpp_CallToJoystickStuff_FUN_004dc230(CGame * this_ptr, int unk1, SPlayerControl * unk)
    JMP 0x004dbdbb                      ; 004dbe02
        ;   XREF to: 004dbdbb (UNCONDITIONAL_JUMP)  ; LAB_004dbdbb
    PUSH EDX                            ; 004dbe04
        ;   Label: LAB_004dbe04
    PUSH ESI                            ; 004dbe05
    CALL core_game.cpp_SettingCursorPos_FUN_004dccc0 ; 004dbe06
        ;   XREF to: 004dccc0 (UNCONDITIONAL_CALL)  ; void core_game.cpp_SettingCursorPos_FUN_004dccc0(CGame * game, SPlayerControl * ctrl)
