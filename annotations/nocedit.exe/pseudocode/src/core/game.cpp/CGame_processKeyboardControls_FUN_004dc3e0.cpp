...

{
  ...
  if (g_KeyboardState[this_ptr->key_strafe] == '\0') {
    if ((g_KeyboardState[this_ptr->key_left] != '\0') ||
      ...
      if (g_KeyboardState[this_ptr->key_left] == '\0') {
        if (((g_KeyboardState[this_ptr->key_right] != '\0') && ((int)*pfVar2 < 0x3e800000)) &&
           (*pfVar2 = (g_CGamePtr->delta_time_float * 0.25f) / fVar3 + *pfVar2,
           0x3e800000 < (int)*pfVar2)) {
          *pfVar2 = 0.25;
        }
      }
...
LAB_004dc4d6:
    ...
    if (g_KeyboardState[this_ptr->key_left] == '\0') {
      if (((g_KeyboardState[this_ptr->key_right] != '\0') && ((int)*pfVar2 < 0x3f800000)) &&
         (*pfVar2 = g_CGamePtr->delta_time_float / 0.01f + *pfVar2,
         0x3f800000 < (int)*pfVar2)) {
        *pfVar2 = 1.0;
      }
    }
    else if ((-1.0f < *pfVar2) &&
...
LAB_004dc4e9:
  if ((g_KeyboardState[this_ptr->key_point_up] == '\0') &&
    ...
    pfVar2 = &player_control->look_up_down_speed;
    if (g_KeyboardState[this_ptr->key_point_up] == '\0') {
      if (((g_KeyboardState[this_ptr->key_point_down] != '\0') && ((int)*pfVar2 < 0x3e800000)) &&
         (*pfVar2 = (g_CGamePtr->delta_time_float * 0.25f) / fVar3 + *pfVar2,
         0x3e800000 < (int)*pfVar2)) {
        *pfVar2 = 0.25;
      }
