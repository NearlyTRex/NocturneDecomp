...
section .text
    ...
    PUSH ESI                            ; 004dbea1 | g_CKeysPtr
    CALL engine_keys.cpp_CKeys_setKeyAsPressed_FUN_00502490 ; 004dbea2
        ;   XREF to: 00502490 (UNCONDITIONAL_CALL)  ; void engine_keys.cpp_CKeys_setKeyAsPressed_FUN_00502490(CKeys * this, int keyCode)
    ...
    PUSH 0x204                          ; 004dbee4
    MOV EDX,dword ptr [0x0067cf44]      ; 004dbee9 | g_CKeysPtr
    PUSH EDX                            ; 004dbeef | g_CKeysPtr
    ...
    PUSH 0x207                          ; 004dbf59
    MOV EDX,dword ptr [0x0067cf44]      ; 004dbf5e | g_CKeysPtr
    PUSH EDX                            ; 004dbf64 | g_CKeysPtr
    ...
    PUSH 0x20a                          ; 004dbfcf
    MOV EDX,dword ptr [0x0067cf44]      ; 004dbfd4 | g_CKeysPtr
    PUSH EDX                            ; 004dbfda | g_CKeysPtr
    ...
    PUSH EDI                            ; 004dc016 | g_CKeysPtr
    CALL engine_keys.cpp_CKeys_clearKeyPressState_FUN_005024a0 ; 004dc017
        ;   XREF to: 005024a0 (UNCONDITIONAL_CALL)  ; void engine_keys.cpp_CKeys_clearKeyPressState_FUN_005024a0(CKeys * this, int keyCode)
    ADD ESP,0x8                         ; 004dc01c
    PUSH 0x252                          ; 004dc01f
    MOV EBP,dword ptr [0x0067cf44]      ; 004dc024 | g_CKeysPtr
    PUSH EBP                            ; 004dc02a | g_CKeysPtr
    CALL engine_keys.cpp_CKeys_clearKeyPressState_FUN_005024a0 ; 004dc02b
        ;   XREF to: 005024a0 (UNCONDITIONAL_CALL)  ; void engine_keys.cpp_CKeys_clearKeyPressState_FUN_005024a0(CKeys * this, int keyCode)
    ADD ESP,0x8                         ; 004dc030
    PUSH 0x253                          ; 004dc033
    MOV EAX,[0x0067cf44]                ; 004dc038 | g_CKeysPtr
    PUSH EAX                            ; 004dc03d | g_CKeysPtr
    CALL engine_keys.cpp_CKeys_clearKeyPressState_FUN_005024a0 ; 004dc03e
        ;   XREF to: 005024a0 (UNCONDITIONAL_CALL)  ; void engine_keys.cpp_CKeys_clearKeyPressState_FUN_005024a0(CKeys * this, int keyCode)
    ADD ESP,0x8                         ; 004dc043
    PUSH 0x254                          ; 004dc046
    MOV EDX,dword ptr [0x0067cf44]      ; 004dc04b | g_CKeysPtr
    PUSH EDX                            ; 004dc051 | g_CKeysPtr
    ...
    PUSH 0x253                          ; 004dc0f7
    MOV EAX,[0x0067cf44]                ; 004dc0fc | g_CKeysPtr
    PUSH EAX                            ; 004dc101 | g_CKeysPtr
    ...
    PUSH 0x202                          ; 004dc139
        ;   Label: LAB_004dc139
    MOV ECX,dword ptr [0x0067cf44]      ; 004dc13e | g_CKeysPtr
    PUSH ECX                            ; 004dc144 | g_CKeysPtr
    ...
    PUSH 0x204                          ; 004dc165
        ;   Label: LAB_004dc165
    MOV EAX,[0x0067cf44]                ; 004dc16a | g_CKeysPtr
    PUSH EAX                            ; 004dc16f | g_CKeysPtr
    ...
    PUSH 0x205                          ; 004dc17a
        ;   Label: LAB_004dc17a
    MOV ECX,dword ptr [0x0067cf44]      ; 004dc17f | g_CKeysPtr
    PUSH ECX                            ; 004dc185 | g_CKeysPtr
    ...
    PUSH 0x207                          ; 004dc1a6
        ;   Label: LAB_004dc1a6
    MOV EAX,[0x0067cf44]                ; 004dc1ab | g_CKeysPtr
    PUSH EAX                            ; 004dc1b0 | g_CKeysPtr
    ...
    PUSH 0x208                          ; 004dc1bb
        ;   Label: LAB_004dc1bb
    MOV ECX,dword ptr [0x0067cf44]      ; 004dc1c0 | g_CKeysPtr
    PUSH ECX                            ; 004dc1c6 | g_CKeysPtr
    ...
    PUSH 0x20a                          ; 004dc1e7
        ;   Label: LAB_004dc1e7
    MOV EAX,[0x0067cf44]                ; 004dc1ec | g_CKeysPtr
    PUSH EAX                            ; 004dc1f1 | g_CKeysPtr
    ...
    PUSH 0x20b                          ; 004dc1fc
        ;   Label: LAB_004dc1fc
    MOV ECX,dword ptr [0x0067cf44]      ; 004dc201 | g_CKeysPtr
    PUSH ECX                            ; 004dc207 | g_CKeysPtr
