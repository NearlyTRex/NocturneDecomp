...
section .text
    ...
    JNZ 0x004e28dc                      ; 004e28a2 | LAB_004e28dc
    ...
    CMP AL,0x0                          ; 004e28af
    JZ 0x004e28c3                       ; 004e28b1 | LAB_004e28c3
    ...
    CMP AL,0x0                          ; 004e28bf
    JNZ 0x004e28ab                      ; 004e28c1 | LAB_004e28ab
    ...
    PUSH EDI                            ; 004e28e2
    PUSH ESI                            ; 004e28e3
    MOV EDX,0x62d24b                    ; 004e28e4 | = "..\\core\\game.cpp" | s_core_game_cpp_0062d24b = ..\core\game.cpp
    MOV ECX,0xfc6                       ; 004e28e9
    PUSH 0x62d25c                       ; 004e28ee | = "CGame::displayBitmap - tried to queue..." | s_CGame_displayBitmap_trie_0062d25c = CGame::displayBitmap - tried to queue %s, but %s already queued!
    MOV dword ptr [0x02f0ca48],EDX      ; 004e28f3 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 004e28f9 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004e28ff | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004e2904
    JMP 0x004e28a4                      ; 004e2907 | LAB_004e28a4
