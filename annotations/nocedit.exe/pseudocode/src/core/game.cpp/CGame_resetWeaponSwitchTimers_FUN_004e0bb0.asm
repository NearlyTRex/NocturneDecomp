...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_game_cpp_CGame_resetWeaponSwitchTimers_FUN_004e0bb0(CGame *this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EAX,[0x02db87d0]                ; 004e0bb0 | g_LocalHeroIndex
        ;   Label: core_game.cpp_CGame_resetWeaponSwitchTimers_FUN_004e0bb0
