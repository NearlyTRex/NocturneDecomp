...

{
  ...
  if (p_Var2 != (_FILE *)0x0) {
    shape_memdbg_cpp_closeFile_FUN_0050f9b0(p_Var2,"..\\core\\game.cpp",3791);
  }
  ...
  if (p_Var3 != (_FILE *)0x0) {
    shape_memdbg_cpp_closeFile_FUN_0050f9b0(p_Var3,"..\\core\\game.cpp",3820);
  }
  bVar8 = select_mode == 1;
  if (local_14 != 0) {
    select_mode = 1;
        ...
        if (0 < local_6ec.base.item_count) {
          do {
            p_Var3 = engine_dosio_cpp_getFile_FUN_00481a50
                               ("world",g_ChapterMissionFiles[iVar7][0],
                                "rt");
            if (p_Var3 == (_FILE *)0x0) {
              shape_edittool_cpp_CPickList_enableItem_FUN_004a5410(&local_6ec,iVar7,0);
            }
            else {
              shape_memdbg_cpp_closeFile_FUN_0050f9b0(p_Var3,"..\\core\\game.cpp",3881);
            }
            iVar7 = iVar7 + 1;
...
LAB_004e2250:
        ...
        if (iVar3 == 0) {
          ...
          while (iVar4 < local_6ec.base.item_count) {
            p_Var3 = engine_dosio_cpp_getFile_FUN_00481a50
                               ("world",g_ChapterMissionFiles[0][iVar4],
                                "rt");
            if (p_Var3 == (_FILE *)0x0) {
              shape_edittool_cpp_CPickList_enableItem_FUN_004a5410(&local_6ec,iVar4,0);
            }
            else {
              shape_memdbg_cpp_closeFile_FUN_0050f9b0(p_Var3,"..\\core\\game.cpp",3777);
            }
            iVar4 = iVar4 + 1;
          }
          uVar10 = 0;
        ...
        if (iVar3 == 1) {
          ...
          for (iVar4 = 0; iVar4 < local_6ec.base.item_count; iVar4 = iVar4 + 1) {
            p_Var3 = engine_dosio_cpp_getFile_FUN_00481a50
                               ("world",g_ChapterMissionFiles[1][iVar4],
                                "rt");
            if (p_Var3 == (_FILE *)0x0) {
              shape_edittool_cpp_CPickList_enableItem_FUN_004a5410(&local_6ec,iVar4,0);
            }
        ...
        if (iVar3 == 2) {
          ...
          for (iVar4 = 0; iVar4 < local_6ec.base.item_count; iVar4 = iVar4 + 1) {
            p_Var3 = engine_dosio_cpp_getFile_FUN_00481a50
                               ("world",g_ChapterMissionFiles[2][iVar4],
                                "rt");
            if (p_Var3 == (_FILE *)0x0) {
              shape_edittool_cpp_CPickList_enableItem_FUN_004a5410(&local_6ec,iVar4,0);
            }
        ...
        if (iVar3 == 3) {
          ...
          for (iVar4 = 0; iVar4 < local_6ec.base.item_count; iVar4 = iVar4 + 1) {
            p_Var3 = engine_dosio_cpp_getFile_FUN_00481a50
                               ("world",g_ChapterMissionFiles[3][iVar4],
                                "rt");
            if (p_Var3 == (_FILE *)0x0) {
              shape_edittool_cpp_CPickList_enableItem_FUN_004a5410(&local_6ec,iVar4,0);
            }
        ...
        for (iVar4 = 0; iVar4 < local_6ec.base.item_count; iVar4 = iVar4 + 1) {
          p_Var3 = engine_dosio_cpp_getFile_FUN_00481a50
                             ("world",g_ChapterMissionFiles[4][iVar4],
                              "rt");
          if (p_Var3 == (_FILE *)0x0) {
            shape_edittool_cpp_CPickList_enableItem_FUN_004a5410(&local_6ec,iVar4,0);
          }
...
LAB_004e2376:
    ...
    strcpy(local_144, g_ChapterMissionFiles[iVar3][iVar6]);
    p_Var3 = engine_dosio_cpp_getFile_FUN_00481a50("world",local_144,"rt");
    if (p_Var3 == (_FILE *)0x0) {
      g_EditorFont = local_1c;
      return;
    }
    shape_memdbg_cpp_closeFile_FUN_0050f9b0(p_Var3,"..\\core\\game.cpp",3959);
    g_ChapterDisplayYear = g_ChapterDisplayYears[iVar3];
    strcpy(g_ChapterDisplayName, local_40[iVar3]);
  ...
  if (iVar4 != 0) {
    strcpy(g_CurrentSaveFile, local_144);
    iVar5 = 0;
  }
