...
section .text
    ...
    PUSH -0x1                           ; 004d8945
    PUSH 0x7                            ; 004d8947
    MOV EBX,dword ptr [0x02d831c8]      ; 004d8949 | DAT_02d831c8
    PUSH EBX                            ; 004d894f
    MOV ESI,dword ptr [0x02d831c4]      ; 004d8950 | DAT_02d831c4
    PUSH ESI                            ; 004d8956
    ...
    MOV EAX,[0x02d831cc]                ; 004d8968 | DAT_02d831cc
    MOV EBP,dword ptr [0x02d831c8]      ; 004d896d | DAT_02d831c8
    ...
    MOV dword ptr [0x02d831c8],EBP      ; 004d8983 | DAT_02d831c8
