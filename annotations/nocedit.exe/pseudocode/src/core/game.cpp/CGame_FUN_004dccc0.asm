...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_game_cpp_CGame_FUN_004dccc0(CGame *this_ptr,SPlayerControl *player_control)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004dccc0
        ;   Label: core_game.cpp_CGame_FUN_004dccc0
    PUSH ESI                            ; 004dccc1
    PUSH EDI                            ; 004dccc2
    PUSH EBP                            ; 004dccc3
    ...
    PUSH EBX                            ; 004dccd2
    PUSH EDI                            ; 004dccd3
    CALL core_game.cpp_CGame_FUN_004dc3e0 ; 004dccd4
