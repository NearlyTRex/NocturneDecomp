...
section .text
    ...
    PUSH 0x1d                           ; 004d875d
    MOV EAX,[0x0067cf44]                ; 004d875f | CKeys * g_CKeysPtr
    PUSH EAX                            ; 004d8764 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004d8765 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 004d8767
    ADD ESP,0x8                         ; 004d8769
    TEST EAX,EAX                        ; 004d876c
    JZ 0x004d8779                       ; 004d876e | LAB_004d8779
        ;   XREF to: 004d8779 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x9bc],0x0     ; 004d8770
    JNZ 0x004d877e                      ; 004d8777 | LAB_004d877e
    ...
    MOV EAX,[0x0067cf44]                ; 004d878a | CKeys * g_CKeysPtr
    PUSH EAX                            ; 004d878f | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004d8790 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 004d8792
    ADD ESP,0x8                         ; 004d8794
    TEST EAX,EAX                        ; 004d8797
    JZ 0x004d87ab                       ; 004d8799 | LAB_004d87ab
        ;   XREF to: 004d87ab (CONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 004d879b
    FLD ST0                             ; 004d879e
    FMUL double ptr [0x0062b285]        ; 004d87a0 | double DOUBLE_0062b285
    FSTP ST1                            ; 004d87a6
    FSTP float ptr [ESP]                ; 004d87a8
    PUSH 0x4b                           ; 004d87ab
        ;   Label: LAB_004d87ab
    MOV EAX,[0x0067cf44]                ; 004d87ad | CKeys * g_CKeysPtr
    PUSH EAX                            ; 004d87b2 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004d87b3 | void * g_CKeysPtr
    CALL dword ptr [EDX + 0x4]          ; 004d87b5
    ADD ESP,0x8                         ; 004d87b8
    TEST EAX,EAX                        ; 004d87bb
    JZ 0x004d87cc                       ; 004d87bd | LAB_004d87cc
    ...
    PUSH 0x4d                           ; 004d87cc
        ;   Label: LAB_004d87cc
    MOV EAX,[0x0067cf44]                ; 004d87ce | CKeys * g_CKeysPtr
    PUSH EAX                            ; 004d87d3 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004d87d4 | void * g_CKeysPtr
    CALL dword ptr [EDX + 0x4]          ; 004d87d6
    ADD ESP,0x8                         ; 004d87d9
    TEST EAX,EAX                        ; 004d87dc
    JZ 0x004d87ed                       ; 004d87de | LAB_004d87ed
    ...
    PUSH 0x48                           ; 004d87ed
        ;   Label: LAB_004d87ed
    MOV EAX,[0x0067cf44]                ; 004d87ef | CKeys * g_CKeysPtr
    PUSH EAX                            ; 004d87f4 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004d87f5 | void * g_CKeysPtr
    CALL dword ptr [EDX + 0x4]          ; 004d87f7
    ADD ESP,0x8                         ; 004d87fa
    TEST EAX,EAX                        ; 004d87fd
    JZ 0x004d8810                       ; 004d87ff | LAB_004d8810
    ...
    PUSH 0x50                           ; 004d8810
        ;   Label: LAB_004d8810
    MOV EAX,[0x0067cf44]                ; 004d8812 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 004d8817 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004d8818 | void * g_CKeysPtr
    CALL dword ptr [EDX + 0x4]          ; 004d881a
    ADD ESP,0x8                         ; 004d881d
    TEST EAX,EAX                        ; 004d8820
    JZ 0x004d8833                       ; 004d8822 | LAB_004d8833
    ...
    PUSH 0x1e                           ; 004d8833
        ;   Label: LAB_004d8833
    MOV EAX,[0x0067cf44]                ; 004d8835 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 004d883a | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004d883b | void * g_CKeysPtr
    CALL dword ptr [EDX + 0x4]          ; 004d883d
    ADD ESP,0x8                         ; 004d8840
    TEST EAX,EAX                        ; 004d8843
    JZ 0x004d8856                       ; 004d8845 | LAB_004d8856
    ...
    PUSH 0x10                           ; 004d8856
        ;   Label: LAB_004d8856
    MOV EAX,[0x0067cf44]                ; 004d8858 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 004d885d | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004d885e | void * g_CKeysPtr
    CALL dword ptr [EDX + 0x4]          ; 004d8860
    ADD ESP,0x8                         ; 004d8863
    TEST EAX,EAX                        ; 004d8866
    JZ 0x004d8779                       ; 004d8868 | LAB_004d8779
        ;   XREF to: 004d8779 (CONDITIONAL_JUMP)
