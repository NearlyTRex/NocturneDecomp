...
section .text
    ...
    MOV EAX,[0x0067b654]                ; 004e3113 | CGame g_CGameInstance | CGame * g_CGamePtr
    CMP dword ptr [EAX + 0x20c],0x1     ; 004e3118 | DAT_02d81ca8
    JZ 0x004e3125                       ; 004e311f | LAB_004e3125
    ...
    PUSH ESI                            ; 004e3125
        ;   Label: LAB_004e3125
    PUSH EBX                            ; 004e3126
    CALL wincore_winrun.cpp_getTime_FUN_005f2dc0 ; 004e3127 | int wincore_winrun.cpp_getTime_FUN_005f2dc0()
        ;   XREF to: 005f2dc0 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [0x02d831fc]      ; 004e312c | int g_ProfileStartTime
    SUB EAX,ECX                         ; 004e3132
    MOV dword ptr [ESP + 0x10],EAX      ; 004e3134
    FILD dword ptr [ESP + 0x10]         ; 004e3138
    FMUL double ptr [0x0062d3fd]        ; 004e313c | double DOUBLE_0062d3fd
    MOV EAX,[0x0067b654]                ; 004e3142 | CGame * g_CGamePtr
    FMUL double ptr [0x0062d405]        ; 004e3147 | double DOUBLE_0062d405
    FLD float ptr [EAX + 0x264]         ; 004e314d | g_CGameInstance.delta_time_float
    FXCH                                ; 004e3153
    FMUL double ptr [0x0062d40d]        ; 004e3155 | double DOUBLE_0062d40d
    FDIVRP                              ; 004e315b
    ...
    MOV ESI,dword ptr [0x0066e8e0]      ; 004e316d | CConsole * g_CConsolePtr
    PUSH ESI                            ; 004e3173 | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 004e3174 | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
