...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_game_cpp_CGame_loadAssets_FUN_004e07a0(CGame *this_ptr)
;
; Parameters:
...
;   core_set.cpp_CDemonSet_loadAssets_FUN_0056fb80
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 004e07a0
        ;   Label: core_game.cpp_CGame_loadAssets_FUN_004e07a0
    MOV EDX,dword ptr [0x006810c8]      ; 004e07a1 | g_CDemonSetInstance | g_CDemonSetPtr
    PUSH EDX                            ; 004e07a7 | g_CDemonSetInstance
    CALL core_set.cpp_CDemonSet_loadAssets_FUN_0056fb80 ; 004e07a8
        ;   XREF to: 0056fb80 (UNCONDITIONAL_CALL)  ; void core_set.cpp_CDemonSet_loadAssets_FUN_0056fb80(CDemonSet * this_ptr)
    ...
    CALL core_gore.cpp_CGore_loadAssets_FUN_004ede60 ; 004e07c6
        ;   XREF to: 004ede60 (UNCONDITIONAL_CALL)  ; void core_gore.cpp_CGore_loadAssets_FUN_004ede60(CGore * this_ptr)
    ADD ESP,0x4                         ; 004e07cb
    CALL core_inv.cpp_loadAssets_FUN_004fd220 ; 004e07ce
