...
section .text
    ...
    FXCH                                ; 004e07f8
    FLD float ptr [0x0062c92d]          ; 004e07fa | float FLOAT_0062c92d
    FXCH                                ; 004e0800
    FMUL ST1                            ; 004e0802
    FXCH ST2                            ; 004e0804
    ...
    PUSH EAX                            ; 004e0831
    MOV EAX,[0x00680d50]                ; 004e0832 | CScript * g_CScriptPtr
    FSTP float ptr [ESP + 0x40]         ; 004e0837
    MOV ECX,dword ptr [EAX + 0xc]       ; 004e083b
    PUSH ECX                            ; 004e083e
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 004e083f | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
        ;   XREF to: 00408ec0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004e0844
    LEA EBX,[ESP + 0x18]                ; 004e0847
    LEA EAX,[ESP + 0x24]                ; 004e084b
    FLD float ptr [EAX]                 ; 004e084f
    FMUL float ptr [0x0065e9b4]         ; 004e0851 | float FLOAT_0065e9b4
    FISTP dword ptr [EBX]               ; 004e0857
    FLD float ptr [EAX + 0x4]           ; 004e0859
    FMUL float ptr [0x0065e9b4]         ; 004e085c | float FLOAT_0065e9b4
    FISTP dword ptr [EBX + 0x4]         ; 004e0862
    FLD float ptr [EAX + 0x8]           ; 004e0865
    FMUL float ptr [0x0065e9b4]         ; 004e0868 | float FLOAT_0065e9b4
    FISTP dword ptr [EBX + 0x8]         ; 004e086e
    LEA EAX,[ESP + 0x18]                ; 004e0871
    PUSH EAX                            ; 004e0875
    PUSH 0x32758e4                      ; 004e0876 | CDemonCamera g_CDemonCameraInstance
    LEA ESI,[ESP + 0x50]                ; 004e087b
    LEA EDI,[ESP + 0x44]                ; 004e087f
    CALL core_dcamera.cpp_CDemonCamera_worldToScreenWithFrustumCull_FUN_0044d7d0 ; 004e0883 | CVector3i * core_dcamera.cpp_CDemonCamera_worldToScreenWithFrustumCull_FUN_0044d7d0(CDemonCamera * this_ptr, CVector3i * output_ptr, CVector3i * input_ptr)
    ...
    JZ 0x004e09b6                       ; 004e0897 | LAB_004e09b6
    ...
    MOV [0x02d831f4],EAX                ; 004e08ae | undefined4 DAT_02d831f4
    ...
    MOV ESI,dword ptr [0x00679398]      ; 004e08c4 | int g_WindowHeight
    MOV [0x02d831f8],EAX                ; 004e08ca | undefined4 DAT_02d831f8
    CMP ESI,0x1e0                       ; 004e08cf
    JLE 0x004e09b6                      ; 004e08d5 | LAB_004e09b6
        ;   XREF to: 004e09b6 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [0x00679394]      ; 004e08db | int g_WindowWidth
    MOV EDX,dword ptr [0x02d831f4]      ; 004e08e1 | undefined4 DAT_02d831f4
    IMUL EDX,EDI                        ; 004e08e7
    MOV EBX,0x280                       ; 004e08ea
    MOV EAX,EDX                         ; 004e08ef
    SAR EDX,0x1f                        ; 004e08f1
    IDIV EBX                            ; 004e08f4
    MOV EDX,dword ptr [0x02d831f8]      ; 004e08f6 | undefined4 DAT_02d831f8
    IMUL EDX,ESI                        ; 004e08fc
    MOV EBX,0x1e0                       ; 004e08ff
    MOV [0x02d831f4],EAX                ; 004e0904 | undefined4 DAT_02d831f4
    MOV EAX,EDX                         ; 004e0909
    SAR EDX,0x1f                        ; 004e090b
    IDIV EBX                            ; 004e090e
    MOV [0x02d831f8],EAX                ; 004e0910 | undefined4 DAT_02d831f8
    ADD ESP,0x60                        ; 004e0915
    POP EDI                             ; 004e0918
    POP ESI                             ; 004e0919
    POP EBX                             ; 004e091a
    RET                                 ; 004e091b
    MOV dword ptr [0x02d831ec],0x1      ; 004e0920 | undefined4 DAT_02d831ec
        ;   Label: core_game.cpp_CGame_beginFadeIn_FUN_004e0920
    MOV EDX,dword ptr [0x00679394]      ; 004e092a | int g_WindowWidth
    MOV EAX,EDX                         ; 004e0930
    SAR EDX,0x1f                        ; 004e0932
    SUB EAX,EDX                         ; 004e0935
    SAR EAX,0x1                         ; 004e0937
    MOV EDX,dword ptr [0x00679398]      ; 004e0939 | int g_WindowHeight
    MOV [0x02d831f4],EAX                ; 004e093f | undefined4 DAT_02d831f4
    MOV EAX,EDX                         ; 004e0944
    SAR EDX,0x1f                        ; 004e0946
    SUB EAX,EDX                         ; 004e0949
    SAR EAX,0x1                         ; 004e094b
    XOR ECX,ECX                         ; 004e094d
    MOV dword ptr [0x02d831f0],ECX      ; 004e094f | undefined4 DAT_02d831f0
    MOV [0x02d831f8],EAX                ; 004e0955 | undefined4 DAT_02d831f8
