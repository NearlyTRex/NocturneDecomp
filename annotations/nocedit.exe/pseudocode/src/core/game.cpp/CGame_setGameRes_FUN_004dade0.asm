...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_game_cpp_CGame_setGameRes_FUN_004dade0(CGame *this_ptr)
;
; Parameters:
...
;   core_setedit.cpp_CDemonSet_FUN_005805a0 at 00580651
;   core_setedit.cpp_CDemonSet_FUN_00581320 at 0058135b
