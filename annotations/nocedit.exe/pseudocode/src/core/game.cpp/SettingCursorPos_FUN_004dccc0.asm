...
section .text
    ...
    PUSH EBX                            ; 004dccd2
    PUSH EDI                            ; 004dccd3
    CALL core_game.cpp_KeypressesAndCGame_FUN_004dc3e0 ; 004dccd4 | void core_game.cpp_KeypressesAndCGame_FUN_004dc3e0(CGame * game, SPlayerControl * ctrl)
        ;   XREF to: 004dc3e0 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [EDI + 0x27c]     ; 004dccd9
    ADD ESP,0x8                         ; 004dccdf
    TEST EDX,EDX                        ; 004dcce2
    JZ 0x004dcced                       ; 004dcce4 | LAB_004dcced
    ...
    POP EBX                             ; 004dcceb
    RET                                 ; 004dccec
    MOV EAX,[0x00679394]                ; 004dcced | int g_WindowWidth
        ;   Label: LAB_004dcced
    ...
    MOV EAX,[0x00679398]                ; 004dccff | int g_WindowHeight
    ...
    MOV EAX,[0x02cf6a8c]                ; 004dcd13 | int g_MouseX
    SUB EAX,ECX                         ; 004dcd18
    MOV dword ptr [ESP + 0x18],EAX      ; 004dcd1a
    MOV EAX,[0x02cf6a90]                ; 004dcd1e | int g_MouseY
    PUSH ESI                            ; 004dcd23
    SUB EAX,ESI                         ; 004dcd24
    PUSH ECX                            ; 004dcd26
    MOV dword ptr [ESP + 0x24],EAX      ; 004dcd27
    CALL wincore_winrun.cpp_setCursorPosition_FUN_005f30d0 ; 004dcd2b | void wincore_winrun.cpp_setCursorPosition_FUN_005f30d0(int x, int y)
        ;   XREF to: 005f30d0 (UNCONDITIONAL_CALL)
    MOV EAX,[0x006810c8]                ; 004dcd30 | CDemonSet * g_CDemonSetPtr
    MOV EDX,dword ptr [0x02d828cc]      ; 004dcd35 | int g_StoredCameraValue
    ...
    JNZ 0x004dcce6                      ; 004dcd46 | LAB_004dcce6
    ...
    FDIVP                               ; 004dcd76
    FLD double ptr [0x0062b8a5]         ; 004dcd78 | double DOUBLE_0062b8a5
    FILD dword ptr [EDI + 0x9c]         ; 004dcd7e
    FMUL ST1                            ; 004dcd84
    FILD dword ptr [EDI + 0xa0]         ; 004dcd86
    FMULP ST2                           ; 004dcd8c
    FMUL double ptr [0x0062b8ad]        ; 004dcd8e | double DOUBLE_0062b8ad
    FMUL ST3                            ; 004dcd94
    FXCH ST2                            ; 004dcd96
    FXCH                                ; 004dcd98
    FMUL ST1                            ; 004dcd9a
    ...
    FCOMP double ptr [0x0062b8b5]       ; 004dcdaf | double DOUBLE_0062b8b5
    FNSTSW AX                           ; 004dcdb5
    SAHF                                ; 004dcdb7
    JNC 0x004dcdc2                      ; 004dcdb8 | LAB_004dcdc2
    ...
    FNSTSW AX                           ; 004dcdca
    SAHF                                ; 004dcdcc
    JNC 0x004dcdd7                      ; 004dcdcd | LAB_004dcdd7
        ;   XREF to: 004dcdd7 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x4],0x3f800000 ; 004dcdcf
    FLD float ptr [ESP]                 ; 004dcdd7
        ;   Label: LAB_004dcdd7
    FCOMP double ptr [0x0062b8b5]       ; 004dcdda | double DOUBLE_0062b8b5
    FNSTSW AX                           ; 004dcde0
    SAHF                                ; 004dcde2
    JNC 0x004dcdec                      ; 004dcde3 | LAB_004dcdec
    ...
    FNSTSW AX                           ; 004dce26
    SAHF                                ; 004dce28
    JBE 0x004dce32                      ; 004dce29 | LAB_004dce32
    ...
    FNSTSW AX                           ; 004dce3e
    SAHF                                ; 004dce40
    JBE 0x004dcce6                      ; 004dce41 | LAB_004dcce6
        ;   XREF to: 004dcce6 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 004dce61
    SAHF                                ; 004dce63
    JBE 0x004dce32                      ; 004dce64 | LAB_004dce32
        ;   XREF to: 004dce32 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x4]       ; 004dce66
    MOV dword ptr [EBX + 0x24],EAX      ; 004dce6a
    JMP 0x004dce32                      ; 004dce6d | LAB_004dce32
