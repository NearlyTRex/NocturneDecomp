...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_game_cpp_CGame_FUN_004e2910(CGame *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004e2910
        ;   Label: core_game.cpp_CGame_FUN_004e2910
    PUSH ESI                            ; 004e2911
    PUSH EDI                            ; 004e2912
    PUSH EBP                            ; 004e2913
    ...
    CALL engine_dosio.c_getFileSize_FUN_00481880 ; 004e294b
    ...
    CALL engine_dosio.c_getFile_FUN_00481a50 ; 004e29d9
    ...
    CALL engine_dosio.c_getFile_FUN_00481a50 ; 004e2b51
        ;   XREF to: 00481a50 (UNCONDITIONAL_CALL)  ; _FILE * engine_dosio.c_getFile_FUN_00481a50(char * directory, char * filename, char * mode)
