...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_game.cpp_CGame_displayActStats_FUN_004e3800(CGame * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 004e3811
    CALL engine_alphabit.cpp_CAlphaBitmap_ctor_FUN_00410520 ; 004e3812 | void engine_alphabit.cpp_CAlphaBitmap_ctor_FUN_00410520(CAlphaBitmap * this_ptr)
        ;   XREF to: 00410520 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004e3817
    PUSH 0x1e0                          ; 004e381a
    PUSH 0x280                          ; 004e381f
    PUSH 0x62d4ed                       ; 004e3824 | = "stats" | s_stats_0062d4ed = stats
    LEA EAX,[ESP + 0x50c]               ; 004e3829
    PUSH EAX                            ; 004e3830
    CALL engine_alphabit.cpp_CAlphaBitmap_load_FUN_004105d0 ; 004e3831 | void engine_alphabit.cpp_CAlphaBitmap_load_FUN_004105d0(CAlphaBitmap * this_ptr, char * filename, int width, int height)
        ;   XREF to: 004105d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004e3836
    CALL wincore_windll.cpp_clearScreen_FUN_005b3e70 ; 004e3839 | void wincore_windll.cpp_clearScreen_FUN_005b3e70()
    ...
    PUSH EAX                            ; 004e384e
    CALL engine_alphabit.cpp_CAlphaBitmap_display_FUN_00410950 ; 004e384f | void engine_alphabit.cpp_CAlphaBitmap_display_FUN_00410950(CAlphaBitmap * this_ptr, int x, int y, int alpha)
    ...
    FLD ST0                             ; 004e3889
    FMUL double ptr [0x0062d52d]        ; 004e388b | double DOUBLE_0062d52d
    ADD EDX,EAX                         ; 004e3891
    CALL crt_math.c_round_FUN_005fe6b0  ; 004e3893 | double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    FMUL double ptr [0x0062d535]        ; 004e38b4 | double DOUBLE_0062d535
    FSUBP                               ; 004e38ba
    FLD ST0                             ; 004e38bc
    FMUL double ptr [0x0062d53d]        ; 004e38be | double DOUBLE_0062d53d
    CALL crt_math.c_round_FUN_005fe6b0  ; 004e38c4 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    FMUL double ptr [0x0062d545]        ; 004e38e5 | double DOUBLE_0062d545
    FSUBP                               ; 004e38eb
    FST float ptr [ECX + 0x250]         ; 004e38ed
    CALL crt_math.c_round_FUN_005fe6b0  ; 004e38f3 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    FMUL double ptr [0x0062d54d]        ; 004e3920 | double DOUBLE_0062d54d
    PUSH 0x62d4f3                       ; 004e3926 | = "Level time" | s_Level_time_0062d4f3 = Level time
    MOV dword ptr [ECX + 0x254],EDX     ; 004e392b
    CALL crt_math.c_round_FUN_005fe6b0  ; 004e3931 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x528]       ; 004e3936
    CALL support_newmsg.cpp_getLocalizedString_FUN_005441f0 ; 004e393d | char * support_newmsg.cpp_getLocalizedString_FUN_005441f0(char * key)
    ...
    CMP AL,0x0                          ; 004e394e
    JZ 0x004e3962                       ; 004e3950 | LAB_004e3962
    ...
    CMP AL,0x0                          ; 004e395e
    JNZ 0x004e394a                      ; 004e3960 | LAB_004e394a
    ...
    CMP AL,0x0                          ; 004e3977
    JZ 0x004e398b                       ; 004e3979 | LAB_004e398b
        ;   XREF to: 004e398b (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 004e397b | DAT_0062d4ff | = "%2d:%2d:%2d.%2d\n\n"
    ADD ESI,0x2                         ; 004e397e
    MOV byte ptr [EDI + 0x1],AL         ; 004e3981
    ADD EDI,0x2                         ; 004e3984
    CMP AL,0x0                          ; 004e3987
    JNZ 0x004e3973                      ; 004e3989 | LAB_004e3973
    ...
    PUSH EDI                            ; 004e39ab
    PUSH 0x62d501                       ; 004e39ac | = "%2d:%2d:%2d.%2d\n\n" | s_s_2d_2d_2d_2d_0062d501 = %2d:%2d:%2d.%2d


    LEA EAX,[ESP + 0x414]               ; 004e39b1
    PUSH EAX                            ; 004e39b8
    XOR ESI,ESI                         ; 004e39b9
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 004e39bb | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    CMP AL,0x0                          ; 004e3a06
    JZ 0x004e3a1a                       ; 004e3a08 | LAB_004e3a1a
    ...
    CMP AL,0x0                          ; 004e3a16
    JNZ 0x004e3a02                      ; 004e3a18 | LAB_004e3a02
        ;   XREF to: 004e3a02 (CONDITIONAL_JUMP)
    POP EDI                             ; 004e3a1a
        ;   Label: LAB_004e3a1a
    PUSH 0x62d513                       ; 004e3a1b | = "Body count" | s_Body_count_0062d513 = Body count
    CALL support_newmsg.cpp_getLocalizedString_FUN_005441f0 ; 004e3a20 | char * support_newmsg.cpp_getLocalizedString_FUN_005441f0(char * key)
        ;   XREF to: 005441f0 (UNCONDITIONAL_CALL)
    ...
    CMP AL,0x0                          ; 004e3a39
    JZ 0x004e3a4d                       ; 004e3a3b | LAB_004e3a4d
    ...
    CMP AL,0x0                          ; 004e3a49
    JNZ 0x004e3a35                      ; 004e3a4b | LAB_004e3a35
    ...
    CMP AL,0x0                          ; 004e3a62
    JZ 0x004e3a76                       ; 004e3a64 | LAB_004e3a76
        ;   XREF to: 004e3a76 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 004e3a66 | DAT_0062d51f | = "%d\n\n"
    ADD ESI,0x2                         ; 004e3a69
    MOV byte ptr [EDI + 0x1],AL         ; 004e3a6c
    ADD EDI,0x2                         ; 004e3a6f
    CMP AL,0x0                          ; 004e3a72
    JNZ 0x004e3a5e                      ; 004e3a74 | LAB_004e3a5e
    ...
    PUSH EAX                            ; 004e3a91
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 004e3a92 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ...
    CMP AL,0x0                          ; 004e3ab0
    JZ 0x004e3ac4                       ; 004e3ab2 | LAB_004e3ac4
    ...
    CMP AL,0x0                          ; 004e3ac0
    JNZ 0x004e3aac                      ; 004e3ac2 | LAB_004e3aac
        ;   XREF to: 004e3aac (CONDITIONAL_JUMP)
    POP EDI                             ; 004e3ac4
        ;   Label: LAB_004e3ac4
    PUSH 0xffff                         ; 004e3ac5
    MOV EBP,dword ptr [0x020a5720]      ; 004e3aca | CBitFont * g_ThemeFont
    CALL engine_3d.c_setRenderAlpha_FUN_00406d80 ; 004e3ad0 | void engine_3d.c_setRenderAlpha_FUN_00406d80(int alpha_color_value)
    ...
    PUSH EAX                            ; 004e3aed
    PUSH EBP                            ; 004e3aee
    CALL engine_font.cpp_CBitFont_wrapText_FUN_004d0010 ; 004e3aef | int engine_font.cpp_CBitFont_wrapText_FUN_004d0010(CBitFont * this_ptr, char * source_text, char * dest_buffer, int max_lines, ...)
    ...
    CALL engine_font.cpp_CBitFont_getCharWidth_FUN_004d01d0 ; 004e3b05 | int engine_font.cpp_CBitFont_getCharWidth_FUN_004d01d0(CBitFont * this_ptr, int char_code)
    ...
    PUSH EBP                            ; 004e3b35
    INC EBX                             ; 004e3b36
    CALL engine_font.cpp_CBitFont_drawTextCenterInBounds_FUN_004cdee0 ; 004e3b37 | int engine_font.cpp_CBitFont_drawTextCenterInBounds_FUN_004cdee0(CBitFont * this_ptr, int left_x, int right_x, int y_pos, ...)
    ...
    JL 0x004e3b22                       ; 004e3b57 | LAB_004e3b22
    ...
    PUSH EAX                            ; 004e3b7a
    CALL engine_alphabit.cpp_CAlphaBitmap_dtor_FUN_00410540 ; 004e3b7b | CAlphaBitmap * engine_alphabit.cpp_CAlphaBitmap_dtor_FUN_00410540(CAlphaBitmap * this_ptr)
