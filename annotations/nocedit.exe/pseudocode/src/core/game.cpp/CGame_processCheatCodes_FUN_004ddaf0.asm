...
section .text
    ...
    MOV EBX,dword ptr [0x0067cf44]      ; 004ddbac | g_CKeysPtr
    PUSH EBX                            ; 004ddbb2 | g_CKeysPtr
    ...
    PUSH EDI                            ; 004de357 | g_CEditorToolsPtr
    ...
    MOV EAX,[0x00678a60]                ; 004de388 | g_CEditorToolsPtr
    PUSH EAX                            ; 004de38d | g_CEditorToolsPtr
    ...
    MOV EDX,dword ptr [0x00678a60]      ; 004de3af | g_CEditorToolsPtr
    PUSH EDX                            ; 004de3b5 | g_CEditorToolsPtr
    ...
    MOV ECX,dword ptr [0x00678a60]      ; 004de3d7 | g_CEditorToolsPtr
    PUSH ECX                            ; 004de3dd | g_CEditorToolsPtr
    ...
    MOV EBX,dword ptr [0x00678a60]      ; 004de3ef | g_CEditorToolsPtr
    PUSH EBX                            ; 004de3f5 | g_CEditorToolsPtr
    ...
    CALL core_game.cpp_FUN_004dd930     ; 004def88
        ;   XREF to: 004dd930 (UNCONDITIONAL_CALL)  ; void core_game.cpp_FUN_004dd930(char * p1, int p2)
    ADD ESP,0x8                         ; 004def8d
    PUSH 0x7                            ; 004def90
    PUSH 0x62c17c                       ; 004def92 | = "CGun"
    CALL core_game.cpp_FUN_004dd930     ; 004def97
        ;   XREF to: 004dd930 (UNCONDITIONAL_CALL)  ; void core_game.cpp_FUN_004dd930(char * p1, int p2)
    ADD ESP,0x8                         ; 004def9c
    PUSH 0x8                            ; 004def9f
    PUSH 0x62c181                       ; 004defa1 | = "CGun"
    CALL core_game.cpp_FUN_004dd930     ; 004defa6
        ;   XREF to: 004dd930 (UNCONDITIONAL_CALL)  ; void core_game.cpp_FUN_004dd930(char * p1, int p2)
    ...
    CALL core_game.cpp_FUN_004dd930     ; 004defcf
        ;   XREF to: 004dd930 (UNCONDITIONAL_CALL)  ; void core_game.cpp_FUN_004dd930(char * p1, int p2)
    ...
    MOV EAX,[0x00678a60]                ; 004df1ff | g_CEditorToolsPtr
    PUSH EAX                            ; 004df204 | g_CEditorToolsPtr
    ...
    PUSH EAX                            ; 004df22d
    MOV ECX,dword ptr [0x00678a60]      ; 004df22e | g_CEditorToolsPtr
    PUSH ECX                            ; 004df234 | g_CEditorToolsPtr
    ...
    PUSH EAX                            ; 004df246 | g_CKeysPtr
    MOV EBX,dword ptr [EAX]             ; 004df247 | g_CKeysPtr
    ...
    PUSH EAX                            ; 004df270
    MOV ECX,dword ptr [0x00678a60]      ; 004df271 | g_CEditorToolsPtr
    PUSH ECX                            ; 004df277 | g_CEditorToolsPtr
    ...
    PUSH EAX                            ; 004df3e4 | g_CKeysPtr
    MOV EBX,dword ptr [EAX]             ; 004df3e5 | g_CKeysPtr
    ...
    PUSH EAX                            ; 004df3f7 | g_CKeysPtr
    MOV EBX,dword ptr [EAX]             ; 004df3f8 | g_CKeysPtr
    ...
    PUSH EDI                            ; 004df731 | g_CEditorToolsPtr
    ...
    CALL core_game.cpp_FUN_004dd930     ; 004e05a9
        ;   XREF to: 004dd930 (UNCONDITIONAL_CALL)  ; void core_game.cpp_FUN_004dd930(char * p1, int p2)
    ...
    CALL core_game.cpp_FUN_004dd930     ; 004e063b
        ;   XREF to: 004dd930 (UNCONDITIONAL_CALL)  ; void core_game.cpp_FUN_004dd930(char * p1, int p2)
    ...
    CALL core_game.cpp_FUN_004dd930     ; 004e06ce
        ;   XREF to: 004dd930 (UNCONDITIONAL_CALL)  ; void core_game.cpp_FUN_004dd930(char * p1, int p2)
