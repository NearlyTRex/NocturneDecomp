...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_game.cpp_FUN_004dc370()
;
; Local Variables:
...
section .text
    ...
    MOV EAX,[0x0067b654]                ; 004dc377 | CGame * g_CGamePtr
    ...
    FNSTSW AX                           ; 004dc393
    SAHF                                ; 004dc395
    JBE 0x004dc3b8                      ; 004dc396 | LAB_004dc3b8
    ...
    FNSTSW AX                           ; 004dc3a5
    SAHF                                ; 004dc3a7
    JC 0x004dc3ae                       ; 004dc3a8 | LAB_004dc3ae
    ...
    FNSTSW AX                           ; 004dc3c5
    SAHF                                ; 004dc3c7
    JBE 0x004dc3aa                      ; 004dc3c8 | LAB_004dc3aa
