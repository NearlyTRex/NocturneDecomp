...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_game_cpp_CGame_FUN_004dc3e0(CGame *this_ptr,SPlayerControl *player_control)
;
; Parameters:
...
;
; XREF[3]:
;   core_game.cpp_CGame_FUN_004dc230 at 004dc248
;   core_game.cpp_CGame_FUN_004dccc0 at 004dccd4
...
section .text
    ...
    PUSH EBX                            ; 004dc3e0
        ;   Label: core_game.cpp_CGame_FUN_004dc3e0
    PUSH ESI                            ; 004dc3e1
    PUSH EDI                            ; 004dc3e2
    PUSH EBP                            ; 004dc3e3
