...
section .text
    ...
    PUSH EBX                            ; 004d8910
        ;   Label: core_game.cpp_drawKeyBindingEntry_FUN_004d8910
    PUSH ESI                            ; 004d8911
    PUSH EDI                            ; 004d8912
    PUSH EBP                            ; 004d8913
    ...
    PUSH -0x1                           ; 004d8945
    PUSH 0x7                            ; 004d8947
    MOV EBX,dword ptr [0x02d831c8]      ; 004d8949 | g_HelpCursorY
    PUSH EBX                            ; 004d894f
    MOV ESI,dword ptr [0x02d831c4]      ; 004d8950 | g_HelpCursorX
    PUSH ESI                            ; 004d8956
    ...
    MOV EAX,[0x02d831cc]                ; 004d8968 | g_HelpLineHeight
    MOV EBP,dword ptr [0x02d831c8]      ; 004d896d | g_HelpCursorY
    ...
    MOV dword ptr [0x02d831c8],EBP      ; 004d8983 | g_HelpCursorY
