...
section .text
    ...
    CALL core_game.cpp_CGame_processFudge_FUN_004d8750 ; 004db38f
        ;   XREF to: 004d8750 (UNCONDITIONAL_CALL)  ; void core_game.cpp_CGame_processFudge_FUN_004d8750(CGame * this_ptr)
    ...
    CALL shape_edittool.cpp_CEditorTools_showDestructiveActionConfirmDialog_FUN_0049f060 ; 004db92f
