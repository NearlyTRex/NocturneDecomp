...
section .text
    ...
    PUSH -0x1                           ; 004d8893
    PUSH 0x7                            ; 004d8895
    MOV EDX,dword ptr [0x02d831c8]      ; 004d8897 | DAT_02d831c8
    PUSH EDX                            ; 004d889d
    MOV ECX,dword ptr [0x02d831c4]      ; 004d889e | DAT_02d831c4
    PUSH ECX                            ; 004d88a4
    ...
    MOV EAX,[0x02d831cc]                ; 004d88b6 | DAT_02d831cc
    MOV EDI,dword ptr [0x02d831c8]      ; 004d88bb | DAT_02d831c8
    ...
    MOV dword ptr [0x02d831c8],EDI      ; 004d88d1 | DAT_02d831c8
