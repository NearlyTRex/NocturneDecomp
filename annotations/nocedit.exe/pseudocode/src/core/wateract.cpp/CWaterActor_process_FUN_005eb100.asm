...
section .text
    ...
    FMUL double ptr [0x006572ef]        ; 005eb10e | double DOUBLE_006572ef
    FMUL double ptr [0x006572f7]        ; 005eb114 | double DOUBLE_006572f7
    MOV EDX,dword ptr [EBX + 0x2b22c]   ; 005eb11a
    CALL crt_math.c_round_FUN_005fe6b0  ; 005eb120 | double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    JLE 0x005eb163                      ; 005eb139 | LAB_005eb163
    ...
    JL 0x005eb163                       ; 005eb157 | LAB_005eb163
        ;   XREF to: 005eb163 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 005eb171
    MOV EAX,[0x006793d0]                ; 005eb172 | CEventList g_CEventListInstance | CEventList * g_CEventListPtr
    PUSH EAX                            ; 005eb177 | CEventList g_CEventListInstance
    FSTP float ptr [EBX + 0x7f9c]       ; 005eb178
    CALL core_event.cpp_CEventList_evaluateCondition_FUN_004adca0 ; 005eb17e | int core_event.cpp_CEventList_evaluateCondition_FUN_004adca0(CEventList * this_ptr, char * condition_expression)
        ;   XREF to: 004adca0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005eb183
    TEST EAX,EAX                        ; 005eb186
    JZ 0x005eb194                       ; 005eb188 | LAB_005eb194
        ;   XREF to: 005eb194 (CONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0x280],0x1     ; 005eb18a
    LEA EAX,[EBX + 0x218]               ; 005eb194
        ;   Label: LAB_005eb194
    PUSH EAX                            ; 005eb19a
    MOV EDX,dword ptr [0x006793d0]      ; 005eb19b | CEventList g_CEventListInstance | CEventList * g_CEventListPtr
    PUSH EDX                            ; 005eb1a1 | CEventList g_CEventListInstance
    CALL core_event.cpp_CEventList_evaluateCondition_FUN_004adca0 ; 005eb1a2 | int core_event.cpp_CEventList_evaluateCondition_FUN_004adca0(CEventList * this_ptr, char * condition_expression)
        ;   XREF to: 004adca0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005eb1a7
    TEST EAX,EAX                        ; 005eb1aa
    JZ 0x005eb1b8                       ; 005eb1ac | LAB_005eb1b8
    ...
    JA 0x005eb252                       ; 005eb1c1 | default
        ;   XREF to: 005eb252 (CONDITIONAL_JUMP)
    JMP dword ptr [EAX*0x4 + 0x5eb0ec]  ; 005eb1c7 | void * PTR_caseD_3_005eb0f8 | PTR_caseD_1_005eb0f0 = 005eb1ce
        ;   Label: switchD
    ...
    FNSTSW AX                           ; 005eb21d
    SAHF                                ; 005eb21f
    JBE 0x005eb236                      ; 005eb220 | LAB_005eb236
        ;   XREF to: 005eb236 (CONDITIONAL_JUMP)
    ...
    POP EBX                             ; 005eb250
    RET                                 ; 005eb251
    MOV ECX,0x6572b7                    ; 005eb252 | = "..\\core\\wateract.cpp" | s_core_wateract_cpp_006572b7 = ..\core\wateract.cpp
        ;   Label: default
    MOV ESI,0x1a5                       ; 005eb257
    PUSH 0x6572cc                       ; 005eb25c | = "CWaterActor::process - Bad state" | s_CWaterActor_process_Bad__006572cc = CWaterActor::process - Bad state
    MOV dword ptr [0x02f0ca48],ECX      ; 005eb261 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 005eb267 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005eb26d | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005eb272
    JMP 0x005eb236                      ; 005eb275 | LAB_005eb236
        ;   XREF to: 005eb236 (UNCONDITIONAL_JUMP)
