...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_wateract_cpp_CWaterActor_FUN_005eb710(CWaterActor *this_ptr)
;
; Parameters:
...
section .text
    ...
    JNZ 0x005eb71e                      ; 005eb719
        ;   XREF to: 005eb71e (CONDITIONAL_JUMP)  ; LAB_005eb71e
