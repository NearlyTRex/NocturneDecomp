      ...
      if (0 < this_ptr->vertex_count) {
        do {
          core_set_cpp_CDemonSet_computeVertexOmniLighting_FUN_0056e3e0
                    (g_CDemonSetPtr,&this_ptr->vertices[iVar3].world_position,&g_ZeroVector.f,iVar3);
          pSVar1 = g_CDemonRendererPtr2->vertex_buffer_ptr;
          lVar2 = (longlong)((this_ptr->color).r << 8) * (longlong)pSVar1[iVar3].r;
          pSVar1[iVar3].r = (uint)lVar2 >> 0x10 | (int)((ulonglong)lVar2 >> 0x20) << 0x10;
          lVar2 = (longlong)((this_ptr->color).g << 8) * (longlong)pSVar1[iVar3].g;
          pSVar1[iVar3].g = (uint)lVar2 >> 0x10 | (int)((ulonglong)lVar2 >> 0x20) << 0x10;
          lVar2 = (longlong)((this_ptr->color).b << 8) * (longlong)pSVar1[iVar3].b;
          pSVar1[iVar3].b = (uint)lVar2 >> 0x10 | (int)((ulonglong)lVar2 >> 0x20) << 0x10;
          iVar3 = iVar3 + 1;
        } while (iVar3 < this_ptr->vertex_count);
      }
