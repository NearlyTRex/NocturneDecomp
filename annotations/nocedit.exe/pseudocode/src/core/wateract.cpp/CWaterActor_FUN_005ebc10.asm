...
section .text
    ...
    PUSH EDX                            ; 005ebc1c
    CALL core_actor.cpp_CDemonActor_showEditorHelp_FUN_0040d150 ; 005ebc1d | void core_actor.cpp_CDemonActor_showEditorHelp_FUN_0040d150(CDemonActor * this_ptr, int * y_pos)
        ;   XREF to: 0040d150 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [EBX]             ; 005ebc22
    ADD ESP,0x8                         ; 005ebc24
    ADD ECX,0xb                         ; 005ebc27
    PUSH ECX                            ; 005ebc2a
    MOV EDI,dword ptr [0x02d02558]      ; 005ebc2b | int g_ClipLeft
    PUSH EDI                            ; 005ebc31
    PUSH 0x6574bf                       ; 005ebc32 | = "With CTRL held down, use slew keys to..." | s_With_CTRL_held_down_use__006574bf = With CTRL held down, use slew keys to size water plane.
    MOV dword ptr [EBX],ECX             ; 005ebc37
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 005ebc39 | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
