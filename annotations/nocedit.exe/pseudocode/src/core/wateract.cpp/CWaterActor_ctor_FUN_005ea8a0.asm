...
section .text
    ...
    PUSH EDX                            ; 005ea8a6
    CALL core_actor.cpp_CDemonActor_ctor_FUN_004088b0 ; 005ea8a7 | CDemonActor * core_actor.cpp_CDemonActor_ctor_FUN_004088b0(CDemonActor * this_ptr)
        ;   XREF to: 004088b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005ea8ac
    PUSH 0x665420                       ; 005ea8af | WatcomTypeInfo g_SWaterVertexTypeInfo
    PUSH 0x3e8                          ; 005ea8b4
    ADD EAX,0x29c                       ; 005ea8b9
    PUSH EAX                            ; 005ea8be
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 005ea8bf | void * crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
        ;   XREF to: 005fe667 (UNCONDITIONAL_CALL)
    LEA EDX,[EAX + 0xfffffd64]          ; 005ea8c4
    MOV dword ptr [EDX + 0x154],0x665334 ; 005ea8ca | CDemonActor_vtable PTR_core_wateract.cpp_FUN_00665334
    ...
    MOV ESI,0x657268                    ; 005ea942 | = "none" | s_none_00657268 = none
    ...
    PUSH EDI                            ; 005ea968
    MOV AL,byte ptr [ESI]               ; 005ea969 | = "none" | s_none_00657268 = none
        ;   Label: LAB_005ea969
    MOV byte ptr [EDI],AL               ; 005ea96b
    CMP AL,0x0                          ; 005ea96d
    JZ 0x005ea981                       ; 005ea96f | LAB_005ea981
        ;   XREF to: 005ea981 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 005ea971 | s_one_00657269
    ADD ESI,0x2                         ; 005ea974
    MOV byte ptr [EDI + 0x1],AL         ; 005ea977
    ADD EDI,0x2                         ; 005ea97a
    CMP AL,0x0                          ; 005ea97d
    JNZ 0x005ea969                      ; 005ea97f | LAB_005ea969
        ;   XREF to: 005ea969 (CONDITIONAL_JUMP)
    POP EDI                             ; 005ea981
        ;   Label: LAB_005ea981
    MOV ESI,0x65726d                    ; 005ea982 | = "none" | s_none_0065726d = none
    LEA EDI,[EDX + 0x218]               ; 005ea987
    PUSH EDI                            ; 005ea98d
    MOV AL,byte ptr [ESI]               ; 005ea98e | = "none" | s_none_0065726d = none
        ;   Label: LAB_005ea98e
    MOV byte ptr [EDI],AL               ; 005ea990
    CMP AL,0x0                          ; 005ea992
    JZ 0x005ea9a6                       ; 005ea994 | LAB_005ea9a6
        ;   XREF to: 005ea9a6 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 005ea996 | s_one_0065726e
    ADD ESI,0x2                         ; 005ea999
    MOV byte ptr [EDI + 0x1],AL         ; 005ea99c
    ADD EDI,0x2                         ; 005ea99f
    CMP AL,0x0                          ; 005ea9a2
    JNZ 0x005ea98e                      ; 005ea9a4 | LAB_005ea98e
