...
section .text
    ...
    PUSH 0x665420                       ; 005ebcf0 | WatcomTypeInfo g_SWaterVertexTypeInfo
        ;   Label: core_wateract.cpp_FUN_005ebcf0
    PUSH 0x3e8                          ; 005ebcf5
    MOV EDX,dword ptr [ESP + 0xc]       ; 005ebcfa
    PUSH EDX                            ; 005ebcfe
    CALL crt_memory.c_freeTypeArray_FUN_005feee9 ; 005ebcff | int crt_memory.c_freeTypeArray_FUN_005feee9(void * * obj_array, int obj_count, WatcomTypeInfo * type_info)
