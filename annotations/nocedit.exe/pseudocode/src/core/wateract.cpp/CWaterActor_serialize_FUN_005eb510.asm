...
section .text
    ...
    PUSH EBX                            ; 005eb515
    CALL core_actor.cpp_CDemonActor_serialize_FUN_0040c1c0 ; 005eb516
    ...
    PUSH EAX                            ; 005eb529
    CALL core_actor.cpp_serializeVector_FUN_0040b340 ; 005eb52a
    ...
    PUSH EAX                            ; 005eb53d
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 005eb53e
    ...
    PUSH EAX                            ; 005eb56d
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 005eb56e
    ...
    PUSH EAX                            ; 005eb581
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 005eb582
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ADD ESP,0x8                         ; 005eb587
    PUSH 0x657366                       ; 005eb58a | = "timeToMoveDown"
    LEA EAX,[EBX + 0x170]               ; 005eb58f
    PUSH EAX                            ; 005eb595
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 005eb596
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ADD ESP,0x8                         ; 005eb59b
    PUSH 0x657375                       ; 005eb59e | = "moveUpSound"
    LEA EAX,[EBX + 0x174]               ; 005eb5a3
    PUSH EAX                            ; 005eb5a9
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 005eb5aa
    ...
    PUSH EAX                            ; 005eb62a
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 005eb62b
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH EAX                            ; 005eb647
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 005eb648
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    PUSH EAX                            ; 005eb6cf
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 005eb6d0
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ADD ESP,0x8                         ; 005eb6d5
    PUSH 0x6573ce                       ; 005eb6d8 | = "colG"
    LEA EAX,[EBX + 0x290]               ; 005eb6dd
    PUSH EAX                            ; 005eb6e3
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 005eb6e4
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ADD ESP,0x8                         ; 005eb6e9
    PUSH 0x6573d3                       ; 005eb6ec | = "colB"
    ADD EBX,0x294                       ; 005eb6f1
    PUSH EBX                            ; 005eb6f7
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 005eb6f8
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
