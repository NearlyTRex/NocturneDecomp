...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_wateract.cpp_CWaterActor_FUN_005eb4b0(CWaterActor * this_ptr)
;
; Parameters:
...
section .text
    ...
    FCHS                                ; 005eb4be
    FLD double ptr [0x006572ff]         ; 005eb4c0 | double DOUBLE_006572ff
    FXCH                                ; 005eb4c6
    FMUL ST1                            ; 005eb4c8
    ...
    FADD double ptr [0x00657307]        ; 005eb4f1 | double DOUBLE_00657307
