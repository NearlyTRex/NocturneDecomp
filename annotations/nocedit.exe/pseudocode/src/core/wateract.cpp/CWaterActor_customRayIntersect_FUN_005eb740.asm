...
;                               FUNCTION
; *****************************************************************************
; __cdecl float core_wateract.cpp_CWaterActor_customRayIntersect_FUN_005eb740(CWaterActor * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 005eb76e
    CALL core_box.cpp_CBoundingBox3D_doesRayIntersect_FUN_00420940 ; 005eb76f | float core_box.cpp_CBoundingBox3D_doesRayIntersect_FUN_00420940(CBoundingBox3D * this_ptr, CVector3f * ray_origin, CVector3f * ray_direction, CVector3f * out_normal)
    ...
    FNSTSW AX                           ; 005eb78f
    SAHF                                ; 005eb791
    JA 0x005eb87a                       ; 005eb792 | LAB_005eb87a
        ;   XREF to: 005eb87a (CONDITIONAL_JUMP)
    FLD1                                ; 005eb798
    FCOMP double ptr [ESP]              ; 005eb79a
    FNSTSW AX                           ; 005eb79d
    SAHF                                ; 005eb79f
    JC 0x005eb87a                       ; 005eb7a0 | LAB_005eb87a
        ;   XREF to: 005eb87a (CONDITIONAL_JUMP)
    ...
    JLE 0x005eb835                      ; 005eb7c6 | LAB_005eb835
    ...
    PUSH EAX                            ; 005eb7ed
    CALL core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790 ; 005eb7ee | void core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790(CDemonTriangle * this_ptr, CVector3f * vertex1, CVector3f * vertex2, CVector3f * vertex3)
    ...
    PUSH EAX                            ; 005eb802
    CALL core_dtri.cpp_rayTriangleIntersection_FUN_0049a800 ; 005eb803 | float core_dtri.cpp_rayTriangleIntersection_FUN_0049a800(CDemonTriangle * triangle, CVector3f * rayOrigin, CVector3f * rayDirection)
    ...
    FNSTSW AX                           ; 005eb821
    SAHF                                ; 005eb823
    JC 0x005eb887                       ; 005eb824 | LAB_005eb887
    ...
    JL 0x005eb7ce                       ; 005eb833 | LAB_005eb7ce
    ...
    MOV dword ptr [ESP + 0x80],0x40000000 ; 005eb87a
        ;   Label: LAB_005eb87a
    JMP 0x005eb86c                      ; 005eb885 | LAB_005eb86c
    ...
    FNSTSW AX                           ; 005eb897
    SAHF                                ; 005eb899
    JA 0x005eb826                       ; 005eb89a | LAB_005eb826
        ;   XREF to: 005eb826 (CONDITIONAL_JUMP)
    FLD1                                ; 005eb89c
    FCOMP double ptr [ESP + 0x8]        ; 005eb89e
    FNSTSW AX                           ; 005eb8a2
    SAHF                                ; 005eb8a4
    JC 0x005eb826                       ; 005eb8a5 | LAB_005eb826
        ;   XREF to: 005eb826 (CONDITIONAL_JUMP)
    ...
    JZ 0x005eb826                       ; 005eb8e5 | LAB_005eb826
        ;   XREF to: 005eb826 (CONDITIONAL_JUMP)
    ...
    JMP 0x005eb826                      ; 005eb903 | LAB_005eb826
