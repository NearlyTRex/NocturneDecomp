...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_door.cpp_CDoor_process_FUN_004800c0(CDoor * this_ptr)
;
; Parameters:
...
section .text
    ...
    JGE 0x0048021d                      ; 00480102 | LAB_0048021d
        ;   XREF to: 0048021d (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESI + 0x2e0]     ; 00480108
    CMP EAX,0x3                         ; 0048010e
    JA 0x00480176                       ; 00480111 | default
        ;   XREF to: 00480176 (CONDITIONAL_JUMP)
    JMP dword ptr [EAX*0x4 + 0x4800b0]  ; 00480113 | void * switchdataD_004800b0
        ;   Label: switchD
    LEA EAX,[ESI + 0x2e8]               ; 0048011a
        ;   Label: caseD_0
    PUSH EAX                            ; 00480120
    MOV EBX,dword ptr [0x006793d0]      ; 00480121 | CEventList g_CEventListInstance | CEventList * g_CEventListPtr
    PUSH EBX                            ; 00480127 | CEventList g_CEventListInstance
    CALL core_event.cpp_CEventList_evaluateCondition_FUN_004adca0 ; 00480128 | int core_event.cpp_CEventList_evaluateCondition_FUN_004adca0(CEventList * this_ptr, char * condition_expression)
        ;   XREF to: 004adca0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0048012d
    TEST EAX,EAX                        ; 00480130
    JZ 0x0048016c                       ; 00480132 | LAB_0048016c
        ;   XREF to: 0048016c (CONDITIONAL_JUMP)
    MOV DL,byte ptr [ESI + 0x864]       ; 00480134
    MOV dword ptr [ESI + 0x2e0],0x1     ; 0048013a
    TEST DL,DL                          ; 00480144
    JZ 0x0048015c                       ; 00480146 | LAB_0048015c
    ...
    PUSH ESI                            ; 0048015c
        ;   Label: LAB_0048015c
    MOV EDI,dword ptr [0x006810c8]      ; 0048015d | CDemonSet * g_CDemonSetPtr
    PUSH EDI                            ; 00480163 | CDemonSet g_CDemonSetInstance
    CALL core_setcolid.cpp_CDemonSet_FUN_005744d0 ; 00480164 | void core_setcolid.cpp_CDemonSet_FUN_005744d0(CDemonSet * this_ptr)
    ...
    JBE 0x00480410                      ; 0048017e | LAB_00480410
        ;   XREF to: 00480410 (CONDITIONAL_JUMP)
    CMP EAX,0x2                         ; 00480184
    JNZ 0x004801a8                      ; 00480187 | LAB_004801a8
        ;   XREF to: 004801a8 (CONDITIONAL_JUMP)
    CMP byte ptr [ESI + 0x3b0],0x0      ; 00480189
    JZ 0x004801a8                       ; 00480190 | LAB_004801a8
        ;   XREF to: 004801a8 (CONDITIONAL_JUMP)
    LEA EAX,[ESI + 0x3b0]               ; 00480192
    PUSH EAX                            ; 00480198
    MOV EBP,dword ptr [0x006793d0]      ; 00480199 | CEventList * g_CEventListPtr
    PUSH EBP                            ; 0048019f | CEventList g_CEventListInstance
    CALL core_event.cpp_CEventList_FUN_004aabe0 ; 004801a0 | void core_event.cpp_CEventList_FUN_004aabe0(CEventList * this_ptr)
        ;   Label: LAB_004801a0
        ;   XREF to: 004aabe0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004801a5
    PUSH ESI                            ; 004801a8
        ;   Label: LAB_004801a8
    CALL core_door.cpp_CDoor_reposition_FUN_0047fd20 ; 004801a9 | void core_door.cpp_CDoor_reposition_FUN_0047fd20(CDoor * this_ptr)
    ...
    FNSTSW AX                           ; 004801be
    SAHF                                ; 004801c0
    JZ 0x0048021d                       ; 004801c1 | LAB_0048021d
        ;   XREF to: 0048021d (CONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0x2d8],0x3     ; 004801c3
    JZ 0x0048021d                       ; 004801ca | LAB_0048021d
        ;   XREF to: 0048021d (CONDITIONAL_JUMP)
    ...
    LEA EAX,[ESI + 0x34c]               ; 00480228
        ;   Label: caseD_2
    PUSH EAX                            ; 0048022e
    MOV EAX,[0x006793d0]                ; 0048022f | CEventList g_CEventListInstance | CEventList * g_CEventListPtr
    PUSH EAX                            ; 00480234 | CEventList g_CEventListInstance
    CALL core_event.cpp_CEventList_evaluateCondition_FUN_004adca0 ; 00480235 | int core_event.cpp_CEventList_evaluateCondition_FUN_004adca0(CEventList * this_ptr, char * condition_expression)
        ;   XREF to: 004adca0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0048023a
    TEST EAX,EAX                        ; 0048023d
    JZ 0x00480269                       ; 0048023f | LAB_00480269
        ;   XREF to: 00480269 (CONDITIONAL_JUMP)
    MOV AH,byte ptr [ESI + 0x8c8]       ; 00480241
    MOV dword ptr [ESI + 0x2e0],0x3     ; 00480247
    TEST AH,AH                          ; 00480251
    JZ 0x00480269                       ; 00480253 | LAB_00480269
        ;   XREF to: 00480269 (CONDITIONAL_JUMP)
    ...
    JMP 0x00480176                      ; 00480275 | default
    ...
    JZ 0x00480176                       ; 004802e0 | default
        ;   XREF to: 00480176 (CONDITIONAL_JUMP)
    MOV dword ptr [ESI + 0x9c8],0x2     ; 004802e6
    JMP 0x00480176                      ; 004802f0 | default
        ;   XREF to: 00480176 (UNCONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 00480301
    SAHF                                ; 00480303
    JNC 0x00480176                      ; 00480304 | default
        ;   XREF to: 00480176 (CONDITIONAL_JUMP)
    ...
    JZ 0x00480176                       ; 00480328 | default
        ;   XREF to: 00480176 (CONDITIONAL_JUMP)
    MOV dword ptr [ESI + 0x9c8],0x2     ; 0048032e
    JMP 0x00480176                      ; 00480338 | default
        ;   XREF to: 00480176 (UNCONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0048036b
    SAHF                                ; 0048036d
    JNC 0x004803c0                      ; 0048036e | LAB_004803c0
    ...
    FNSTSW AX                           ; 0048037a
    SAHF                                ; 0048037c
    JBE 0x00480176                      ; 0048037d | default
        ;   XREF to: 00480176 (CONDITIONAL_JUMP)
    ...
    JZ 0x004803ab                       ; 0048039f | LAB_004803ab
        ;   XREF to: 004803ab (CONDITIONAL_JUMP)
    MOV dword ptr [ESI + 0x9c8],0x2     ; 004803a1
    PUSH ESI                            ; 004803ab
        ;   Label: LAB_004803ab
    MOV EBP,dword ptr [0x006810c8]      ; 004803ac | CDemonSet * g_CDemonSetPtr
    PUSH EBP                            ; 004803b2 | CDemonSet g_CDemonSetInstance
    CALL core_setcolid.cpp_CDemonSet_FUN_00574440 ; 004803b3 | void core_setcolid.cpp_CDemonSet_FUN_00574440(CDemonSet * this_ptr)
        ;   XREF to: 00574440 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004803b8
    JMP 0x00480176                      ; 004803bb | default
        ;   XREF to: 00480176 (UNCONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 004803ca
    SAHF                                ; 004803cc
    JNC 0x00480176                      ; 004803cd | default
        ;   XREF to: 00480176 (CONDITIONAL_JUMP)
    ...
    JZ 0x004803fb                       ; 004803ef | LAB_004803fb
        ;   XREF to: 004803fb (CONDITIONAL_JUMP)
    MOV dword ptr [ESI + 0x9c8],0x2     ; 004803f1
    PUSH ESI                            ; 004803fb
        ;   Label: LAB_004803fb
    MOV EBX,dword ptr [0x006810c8]      ; 004803fc | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
    PUSH EBX                            ; 00480402 | CDemonSet g_CDemonSetInstance
    CALL core_setcolid.cpp_CDemonSet_FUN_00574440 ; 00480403 | void core_setcolid.cpp_CDemonSet_FUN_00574440(CDemonSet * this_ptr)
        ;   XREF to: 00574440 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00480408
    JMP 0x00480176                      ; 0048040b | default
        ;   XREF to: 00480176 (UNCONDITIONAL_JUMP)
    CMP byte ptr [ESI + 0x414],0x0      ; 00480410
        ;   Label: LAB_00480410
    JZ 0x004801a8                       ; 00480417 | LAB_004801a8
        ;   XREF to: 004801a8 (CONDITIONAL_JUMP)
    LEA EAX,[ESI + 0x414]               ; 0048041d
    PUSH EAX                            ; 00480423
    MOV EAX,[0x006793d0]                ; 00480424 | CEventList g_CEventListInstance | CEventList * g_CEventListPtr
    PUSH EAX                            ; 00480429 | CEventList g_CEventListInstance
    JMP 0x004801a0                      ; 0048042a | LAB_004801a0
    ...
    JMP 0x004801fa                      ; 00480441 | LAB_004801fa
    ...
    PUSH EAX                            ; 0048044f
    CALL core_setcolid.cpp_SCollisionInfo_ctor_FUN_005743c0 ; 00480450 | SCollisionInfo * core_setcolid.cpp_SCollisionInfo_ctor_FUN_005743c0(SCollisionInfo * this_ptr)
    ...
    JNZ 0x0048042f                      ; 0048046b | LAB_0048042f
    ...
    FNSTSW AX                           ; 0048047d
    SAHF                                ; 0048047f
    JC 0x0048042f                       ; 00480480 | LAB_0048042f
        ;   XREF to: 0048042f (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 00480492
    SAHF                                ; 00480494
    JA 0x0048042f                       ; 00480495 | LAB_0048042f
        ;   XREF to: 0048042f (CONDITIONAL_JUMP)
    ...
    CALL core_dirmat.cpp_CMatrix3x3f_transformVectorTranspose_FUN_00472030 ; 004804c7 | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVectorTranspose_FUN_00472030(CMatrix3x3f * matrix, CVector3f * output, CVector3f * input)
        ;   XREF to: 00472030 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 004804cc
    LEA EAX,[ESP + 0x70]                ; 004804ce
    ADD ESP,0xc                         ; 004804d2
    CMP EAX,EBX                         ; 004804d5
    JZ 0x004804ed                       ; 004804d7 | LAB_004804ed
    ...
    FNSTSW AX                           ; 00480500
    SAHF                                ; 00480502
    JC 0x0048042f                       ; 00480503 | LAB_0048042f
        ;   XREF to: 0048042f (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0048051c
    SAHF                                ; 0048051e
    JA 0x0048042f                       ; 0048051f | LAB_0048042f
        ;   XREF to: 0048042f (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 00480538
    SAHF                                ; 0048053a
    JC 0x0048042f                       ; 0048053b | LAB_0048042f
        ;   XREF to: 0048042f (CONDITIONAL_JUMP)
    ...
    CALL core_door.cpp_CDoor_reposition_FUN_0047fd20 ; 004805c2 | void core_door.cpp_CDoor_reposition_FUN_0047fd20(CDoor * this_ptr)
        ;   XREF to: 0047fd20 (UNCONDITIONAL_CALL)
    ...
    FNSTSW AX                           ; 0048079f
    SAHF                                ; 004807a1
    JC 0x0048042f                       ; 004807a2 | LAB_0048042f
        ;   XREF to: 0048042f (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x98]          ; 004807a8
    FCOMP float ptr [ESP + 0x34]        ; 004807af
    FNSTSW AX                           ; 004807b3
    SAHF                                ; 004807b5
    JA 0x0048042f                       ; 004807b6 | LAB_0048042f
        ;   XREF to: 0048042f (CONDITIONAL_JUMP)
    JMP 0x0048059d                      ; 004807bc | LAB_0048059d
