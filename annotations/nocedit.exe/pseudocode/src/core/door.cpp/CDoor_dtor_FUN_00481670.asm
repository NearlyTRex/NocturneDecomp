...
;                               FUNCTION
; *****************************************************************************
; __cdecl CDoor * __cdecl core_door_cpp_CDoor_dtor_FUN_00481670(CDoor *this_ptr,uint d1,uint d2)
;
; Parameters:
...
section .text
    ...
    PUSH 0x65cce0                       ; 00481696 | g_CDoorTypeInfo
        ;   Label: LAB_00481696
    PUSH EBX                            ; 0048169b
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 0048169c
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 004816a1
    PUSH EAX                            ; 004816a4
    CALL crt_memory.c_free_FUN_005fe659 ; 004816a5
    ...
    PUSH EAX                            ; 004816b1
        ;   Label: LAB_004816b1
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 004816b2
