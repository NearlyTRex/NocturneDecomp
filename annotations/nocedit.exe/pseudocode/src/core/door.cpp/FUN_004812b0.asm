...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_door.cpp_FUN_004812b0(void)
;
;
; XREF[1]:
...
section .text
    ...
    PUSH ECX                            ; 004812bc
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 004812bd | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004812c2
    MOV EBX,dword ptr [EAX + 0x2e0]     ; 004812c5
    MOV EDX,EAX                         ; 004812cb
    CMP EBX,0x2                         ; 004812cd
    JNZ 0x004812f6                      ; 004812d0 | LAB_004812f6
        ;   XREF to: 004812f6 (CONDITIONAL_JUMP)
    MOV dword ptr [EAX + 0x9ac],0x0     ; 004812d2
    MOV dword ptr [EAX + 0x2e0],0x0     ; 004812dc
    PUSH EDX                            ; 004812e6
    CALL core_door.cpp_CDoor_reposition_FUN_0047fd20 ; 004812e7 | void core_door.cpp_CDoor_reposition_FUN_0047fd20(CDoor * this_ptr)
    ...
    PUSH EDX                            ; 0048130c
    CALL core_door.cpp_CDoor_reposition_FUN_0047fd20 ; 0048130d | void core_door.cpp_CDoor_reposition_FUN_0047fd20(CDoor * this_ptr)
        ;   XREF to: 0047fd20 (UNCONDITIONAL_CALL)
