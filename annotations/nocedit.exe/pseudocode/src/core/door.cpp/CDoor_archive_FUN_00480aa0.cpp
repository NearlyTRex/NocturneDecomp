...

{
  ...
  core_actor_cpp_archiveString_FUN_0040b5c0(this_ptr->unk1,"openEvent");
  core_actor_cpp_archiveString_FUN_0040b5c0(this_ptr->unk1 + 100,"closeEvent");
  core_actor_cpp_archiveString_FUN_0040b5c0(this_ptr->unk2 + 1000,"openSound");
  core_actor_cpp_archiveString_FUN_0040b5c0(this_ptr->unk2 + 0x44c,"closeSound");
  ...
  if (2 < g_CDoorClassVersion) {
    core_actor_cpp_archiveString_FUN_0040b5c0
              (this_ptr->unk1 + 200,"eventToTriggerWhenOpen");
    core_actor_cpp_archiveString_FUN_0040b5c0
              (this_ptr->unk1 + 300,"eventToTriggerWhenClosed");
  }
  ...
  if (g_CDoorClassVersion < 7) {
    if (4 < g_CDoorClassVersion) {
      core_actor_cpp_archiveString_FUN_0040b5c0(this_ptr->unk2 + 500,"scriptOpenEvent");
    ...
    core_actor_cpp_archiveRules_FUN_0040c000(&this_ptr->open_rules,"openRules");
  }
  ...
  core_actor_cpp_archiveString_FUN_0040b5c0(this_ptr->unk2 + 0x4b0,"lockedSound");
  return;
}
