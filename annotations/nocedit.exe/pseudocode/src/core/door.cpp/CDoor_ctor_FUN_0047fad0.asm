...
;                               FUNCTION
; *****************************************************************************
; __cdecl CDoor * core_door.cpp_CDoor_ctor_FUN_0047fad0(CDoor * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0047fad7
    CALL core_actor.cpp_CDemonActor_ctor_FUN_004088b0 ; 0047fad8 | CDemonActor * core_actor.cpp_CDemonActor_ctor_FUN_004088b0(CDemonActor * this_ptr)
        ;   XREF to: 004088b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0047fadd
    ADD EAX,0x158                       ; 0047fae0
    PUSH EAX                            ; 0047fae5
    CALL core_dmodel.cpp_CKeyFramedModelInstance_ctor_FUN_00478ce0 ; 0047fae6 | CKeyFramedModelInstance * core_dmodel.cpp_CKeyFramedModelInstance_ctor_FUN_00478ce0(CKeyFramedModelInstance * this_ptr)
        ;   XREF to: 00478ce0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0047faeb
    LEA EBX,[EAX + 0x320]               ; 0047faee
    PUSH EBX                            ; 0047faf4
    CALL core_event.cpp_FUN_004b1670    ; 0047faf5 | undefined core_event.cpp_FUN_004b1670()
        ;   XREF to: 004b1670 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0047fafa
    SUB EBX,0x478                       ; 0047fafd
    PUSH 0x621096                       ; 0047fb03 | = "churchd01.kfm" | s_churchd01_kfm_00621096 = churchd01.kfm
    LEA EAX,[EBX + 0x158]               ; 0047fb08
    PUSH EAX                            ; 0047fb0e
    MOV dword ptr [EBX + 0x154],0x65cbf4 ; 0047fb0f | CDemonActor_vtable PTR_core_door.cpp_FUN_0065cbf4
    CALL core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0 ; 0047fb19 | void core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0(CKeyFramedModelInstance * this_ptr, char * filename)
    ...
    JZ 0x0047fb66                       ; 0047fb54 | LAB_0047fb66
    ...
    MOV ESI,0x6210a4                    ; 0047fb66 | = "defaultDoorOpen" | s_defaultDoorOpen_006210a4 = defaultDoorOpen
        ;   Label: LAB_0047fb66
    LEA EDI,[EBX + 0x2e8]               ; 0047fb6b
    PUSH EDI                            ; 0047fb71
    MOV AL,byte ptr [ESI]               ; 0047fb72 | = "defaultDoorOpen" | s_defaultDoorOpen_006210a4 = defaultDoorOpen
        ;   Label: LAB_0047fb72
    MOV byte ptr [EDI],AL               ; 0047fb74
    CMP AL,0x0                          ; 0047fb76
    JZ 0x0047fb8a                       ; 0047fb78 | LAB_0047fb8a
        ;   XREF to: 0047fb8a (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0047fb7a | s_efaultDoorOpen_006210a5
    ADD ESI,0x2                         ; 0047fb7d
    MOV byte ptr [EDI + 0x1],AL         ; 0047fb80
    ADD EDI,0x2                         ; 0047fb83
    CMP AL,0x0                          ; 0047fb86
    JNZ 0x0047fb72                      ; 0047fb88 | LAB_0047fb72
        ;   XREF to: 0047fb72 (CONDITIONAL_JUMP)
    POP EDI                             ; 0047fb8a
        ;   Label: LAB_0047fb8a
    MOV ESI,0x6210b4                    ; 0047fb8b | = "defaultDoorClose" | s_defaultDoorClose_006210b4 = defaultDoorClose
    LEA EDI,[EBX + 0x34c]               ; 0047fb90
    PUSH EDI                            ; 0047fb96
    MOV AL,byte ptr [ESI]               ; 0047fb97 | = "defaultDoorClose" | s_defaultDoorClose_006210b4 = defaultDoorClose
        ;   Label: LAB_0047fb97
    MOV byte ptr [EDI],AL               ; 0047fb99
    CMP AL,0x0                          ; 0047fb9b
    JZ 0x0047fbaf                       ; 0047fb9d | LAB_0047fbaf
        ;   XREF to: 0047fbaf (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0047fb9f | s_efaultDoorClose_006210b5
    ADD ESI,0x2                         ; 0047fba2
    MOV byte ptr [EDI + 0x1],AL         ; 0047fba5
    ADD EDI,0x2                         ; 0047fba8
    CMP AL,0x0                          ; 0047fbab
    JNZ 0x0047fb97                      ; 0047fbad | LAB_0047fb97
        ;   XREF to: 0047fb97 (CONDITIONAL_JUMP)
    POP EDI                             ; 0047fbaf
        ;   Label: LAB_0047fbaf
    MOV ESI,0x6210c5                    ; 0047fbb0 | = "door-locked.wav" | s_door_locked_wav_006210c5 = door-locked.wav
    MOV byte ptr [EBX + 0x864],0x0      ; 0047fbb5
    LEA EDI,[EBX + 0x92c]               ; 0047fbbc
    MOV byte ptr [EBX + 0x8c8],0x0      ; 0047fbc2
    PUSH EDI                            ; 0047fbc9
    MOV AL,byte ptr [ESI]               ; 0047fbca | = "door-locked.wav" | s_door_locked_wav_006210c5 = door-locked.wav
        ;   Label: LAB_0047fbca
    MOV byte ptr [EDI],AL               ; 0047fbcc
    CMP AL,0x0                          ; 0047fbce
    JZ 0x0047fbe2                       ; 0047fbd0 | LAB_0047fbe2
        ;   XREF to: 0047fbe2 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0047fbd2 | s_oor-locked.wav_006210c6
    ADD ESI,0x2                         ; 0047fbd5
    MOV byte ptr [EDI + 0x1],AL         ; 0047fbd8
    ADD EDI,0x2                         ; 0047fbdb
    CMP AL,0x0                          ; 0047fbde
    JNZ 0x0047fbca                      ; 0047fbe0 | LAB_0047fbca
