...
section .text
    ...
    PUSH EBX                            ; 004115a7
    CALL core_actor.cpp_CDemonActor_ctor_FUN_004088b0 ; 004115a8 | CDemonActor * core_actor.cpp_CDemonActor_ctor_FUN_004088b0(CDemonActor * this_ptr)
        ;   XREF to: 004088b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004115ad
    ADD EAX,0x158                       ; 004115b0
    PUSH EAX                            ; 004115b5
    CALL core_dmodel.cpp_CKeyFramedModelInstance_ctor_FUN_00478ce0 ; 004115b6 | CKeyFramedModelInstance * core_dmodel.cpp_CKeyFramedModelInstance_ctor_FUN_00478ce0(CKeyFramedModelInstance * this_ptr)
        ;   XREF to: 00478ce0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004115bb
    LEA EBX,[EAX + 0xfffffea8]          ; 004115be
    PUSH 0x614bc0                       ; 004115c4 | = "ammobag.kfm" | s_ammobag_kfm_00614bc0 = ammobag.kfm
    LEA EAX,[EBX + 0x158]               ; 004115c9
    PUSH EAX                            ; 004115cf
    MOV dword ptr [EBX + 0x154],0x659ad4 ; 004115d0 | CDemonActor_vtable g_CAmmoBoxVTable
    CALL core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0 ; 004115da | void core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0(CKeyFramedModelInstance * this_ptr, char * filename)
        ;   XREF to: 00478dd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004115df
    MOV ESI,0x614bcc                    ; 004115e2 | = "CGun" | s_CGun_00614bcc = CGun
    LEA EDI,[EBX + 0x2d4]               ; 004115e7
    PUSH EDI                            ; 004115ed
    MOV AL,byte ptr [ESI]               ; 004115ee | = "CGun" | s_CGun_00614bcc = CGun
        ;   Label: LAB_004115ee
    MOV byte ptr [EDI],AL               ; 004115f0
    CMP AL,0x0                          ; 004115f2
    JZ 0x00411606                       ; 004115f4 | LAB_00411606
        ;   XREF to: 00411606 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 004115f6 | s_Gun_00614bcd
    ADD ESI,0x2                         ; 004115f9
    MOV byte ptr [EDI + 0x1],AL         ; 004115fc
    ADD EDI,0x2                         ; 004115ff
    CMP AL,0x0                          ; 00411602
    JNZ 0x004115ee                      ; 00411604 | LAB_004115ee
