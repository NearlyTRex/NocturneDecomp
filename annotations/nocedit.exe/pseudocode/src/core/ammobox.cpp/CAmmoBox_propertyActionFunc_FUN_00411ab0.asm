...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_ammobox_cpp_CAmmoBox_propertyActionFunc_FUN_00411ab0 (CAmmoBox *this_ptr,CActorProperty *property)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [0x008223e0]      ; 00411ab0 | g_CAmmoBoxClassInfo.name_hash
        ;   Label: core_ammobox.cpp_CAmmoBox_propertyActionFunc_FUN_00411ab0
    PUSH EDX                            ; 00411ab6
