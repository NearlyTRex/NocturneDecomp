...
section .text
    ...
    PUSH 0x25                           ; 00411560
        ;   Label: core_ammobox.cpp_factoryFuncAmmoBox_FUN_00411560
    PUSH 0x614bac                       ; 00411562 | = "..\\core\\ammobox.cpp"
    PUSH 0x34c                          ; 00411567
    CALL shape_memdbg.cpp_debugAllocTracked1_FUN_0050f1b0 ; 0041156c
        ;   XREF to: 0050f1b0 (UNCONDITIONAL_CALL)  ; void * shape_memdbg.cpp_debugAllocTracked1_FUN_0050f1b0(int size, char * filename, int line_number)
    ADD ESP,0xc                         ; 00411571
    TEST EAX,EAX                        ; 00411574
    JNZ 0x00411579                      ; 00411576
        ;   XREF to: 00411579 (CONDITIONAL_JUMP)  ; LAB_00411579
    RET                                 ; 00411578
    PUSH EAX                            ; 00411579
        ;   Label: LAB_00411579
    CALL core_ammobox.cpp_CAmmoBox_ctor_FUN_004115a0 ; 0041157a
        ;   XREF to: 004115a0 (UNCONDITIONAL_CALL)  ; CAmmoBox * core_ammobox.cpp_CAmmoBox_ctor_FUN_004115a0(CAmmoBox * this_ptr)
