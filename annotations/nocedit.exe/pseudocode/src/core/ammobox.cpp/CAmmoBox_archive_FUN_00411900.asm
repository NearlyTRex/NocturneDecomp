...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_ammobox_cpp_CAmmoBox_archive_FUN_00411900(CAmmoBox *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00411900
        ;   Label: core_ammobox.cpp_CAmmoBox_archive_FUN_00411900
    MOV EBX,dword ptr [ESP + 0x8]       ; 00411901
    PUSH EBX                            ; 00411905
    CALL core_actor.cpp_CDemonActor_archive_FUN_0040c1c0 ; 00411906
    ...
    PUSH EAX                            ; 00411919
    CALL core_actor.cpp_archiveKeyframedModelInstance_FUN_0040b8f0 ; 0041191a
    ...
    PUSH EAX                            ; 0041192d
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 0041192e
    ...
    PUSH EAX                            ; 00411941
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 00411942
    ...
    PUSH EAX                            ; 00411955
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 00411956
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ADD ESP,0x8                         ; 0041195b
    PUSH 0x0                            ; 0041195e
    LEA EAX,[EBX + 0x31c]               ; 00411960
    PUSH EAX                            ; 00411966
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 00411967
    ...
    PUSH EAX                            ; 0041198e
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 0041198f
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    PUSH EAX                            ; 004119ad
    CALL core_actor.cpp_archiveActor_FUN_0040b870 ; 004119ae
    ...
    PUSH EBX                            ; 004119c3
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 004119c4
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveString_FUN_0040b5c0(char * string_buffer, char * property_type)
