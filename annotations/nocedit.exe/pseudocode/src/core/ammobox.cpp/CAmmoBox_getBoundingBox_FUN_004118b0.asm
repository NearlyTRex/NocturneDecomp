...
;                               FUNCTION
; *****************************************************************************
; __cdecl CBoundingBox3D * __cdecl core_ammobox_cpp_CAmmoBox_getBoundingBox_FUN_004118b0(CAmmoBox *this_ptr,CBoundingBox3D *out_box)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004118b0
        ;   Label: core_ammobox.cpp_CAmmoBox_getBoundingBox_FUN_004118b0
    MOV EBX,dword ptr [ESP + 0xc]       ; 004118b1
    MOV EAX,dword ptr [ESP + 0x8]       ; 004118b5
    ADD EAX,0x158                       ; 004118b9
    PUSH EAX                            ; 004118be
    CALL core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80 ; 004118bf
