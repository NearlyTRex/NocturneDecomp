...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_ammobox_cpp_CAmmoBox_writeDependencies_FUN_00411c00(CAmmoBox *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x8]       ; 00411c00
        ;   Label: core_ammobox.cpp_CAmmoBox_writeDependencies_FUN_00411c00
    MOV EAX,dword ptr [ESP + 0x4]       ; 00411c04
    PUSH EDX                            ; 00411c08
    ADD EAX,0x158                       ; 00411c09
    PUSH EAX                            ; 00411c0e
    CALL core_dmodel.cpp_CKeyFramedModelInstance_writeDependencies_FUN_0047edd0 ; 00411c0f
