...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_texlist_cpp_CTextureList_renderTexture_FUN_005dca30(CTextureList *this_ptr)
;
; Parameters:
...
section .text
    ...
    CALL engine_2d.c_drawTextRightAlignedColorFormatted_FUN_00402580 ; 005dca76
        ;   XREF to: 00402580 (UNCONDITIONAL_CALL)  ; void engine_2d.c_drawTextRightAlignedColorFormatted_FUN_00402580(int x, int y, char * format_string)
