...
section .text
    ...
    CMP dword ptr [0x006842f4],0x0      ; 005dca36 | int g_TexturePreviewEnabled
    JZ 0x005dca7e                       ; 005dca3d | LAB_005dca7e
        ;   XREF to: 005dca7e (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x00679394]      ; 005dca3f | int g_WindowWidth
    MOV EBX,dword ptr [0x03f87340]      ; 005dca45 | int g_TexturePreviewFullscreen
    LEA EDX,[EAX + 0x6d68]              ; 005dca4b
    SUB ECX,0x7                         ; 005dca51
    TEST EBX,EBX                        ; 005dca54
    JNZ 0x005dca81                      ; 005dca56 | LAB_005dca81
    ...
    PUSH EAX                            ; 005dca66
    MOV EAX,[0x03f87348]                ; 005dca67 | int g_TexturePreviewY
    PUSH 0x655134                       ; 005dca6c | = "%s  %d" | s_s_d_00655134 = %s  %d
    SUB EAX,0xb                         ; 005dca71
    PUSH EAX                            ; 005dca74
    PUSH ECX                            ; 005dca75
    CALL engine_2d.c_drawTextRightAlignedColorFormatted_FUN_00402580 ; 005dca76 | void engine_2d.c_drawTextRightAlignedColorFormatted_FUN_00402580(char * format_string, int y_pos, int right_x)
    ...
    PUSH EAX                            ; 005dca90
    MOV EAX,[0x00679398]                ; 005dca91 | int g_WindowHeight
    PUSH 0x65513b                       ; 005dca96 | = "%s  %d" | s_s_d_0065513b = %s  %d
    SUB EAX,0xb                         ; 005dca9b
    PUSH EAX                            ; 005dca9e
    PUSH ECX                            ; 005dca9f
    CALL engine_2d.c_drawTextRightAlignedColorFormatted_FUN_00402580 ; 005dcaa0 | void engine_2d.c_drawTextRightAlignedColorFormatted_FUN_00402580(char * format_string, int y_pos, int right_x)
        ;   XREF to: 00402580 (UNCONDITIONAL_CALL)
