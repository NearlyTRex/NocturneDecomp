...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_texlist.cpp_CTextureList_load_FUN_005dbe00(CTextureList * this_ptr, char * filename)
;
; Parameters:
...
section .text
    ...
    CMP AL,0x0                          ; 005dbe21
    JZ 0x005dbe35                       ; 005dbe23 | LAB_005dbe35
    ...
    CMP AL,0x0                          ; 005dbe31
    JNZ 0x005dbe1d                      ; 005dbe33 | LAB_005dbe1d
    ...
    MOV AL,byte ptr [ESI]               ; 005dbe38
        ;   Label: LAB_005dbe38
    CMP AL,DL                           ; 005dbe3a
    JZ 0x005dbe50                       ; 005dbe3c | LAB_005dbe50
        ;   XREF to: 005dbe50 (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 005dbe3e
    JZ 0x005dbe4e                       ; 005dbe40 | LAB_005dbe4e
        ;   XREF to: 005dbe4e (CONDITIONAL_JUMP)
    INC ESI                             ; 005dbe42
    MOV AL,byte ptr [ESI]               ; 005dbe43
    CMP AL,DL                           ; 005dbe45
    JZ 0x005dbe50                       ; 005dbe47 | LAB_005dbe50
        ;   XREF to: 005dbe50 (CONDITIONAL_JUMP)
    INC ESI                             ; 005dbe49
    CMP AL,0x0                          ; 005dbe4a
    JNZ 0x005dbe38                      ; 005dbe4c | LAB_005dbe38
    ...
    JZ 0x005dbfd6                       ; 005dbe54 | LAB_005dbfd6
        ;   XREF to: 005dbfd6 (CONDITIONAL_JUMP)
    MOV ESI,0x654ef4                    ; 005dbe5a | = ".tex" | s_tex_00654ef4 = .tex
        ;   Label: LAB_005dbe5a
    PUSH EDI                            ; 005dbe5f
    MOV AL,byte ptr [ESI]               ; 005dbe60 | = ".tex" | s_tex_00654ef4 = .tex
        ;   Label: LAB_005dbe60
    MOV byte ptr [EDI],AL               ; 005dbe62
    CMP AL,0x0                          ; 005dbe64
    JZ 0x005dbe78                       ; 005dbe66 | LAB_005dbe78
        ;   XREF to: 005dbe78 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 005dbe68 | DAT_00654ef5
    ADD ESI,0x2                         ; 005dbe6b
    MOV byte ptr [EDI + 0x1],AL         ; 005dbe6e
    ADD EDI,0x2                         ; 005dbe71
    CMP AL,0x0                          ; 005dbe74
    JNZ 0x005dbe60                      ; 005dbe76 | LAB_005dbe60
        ;   XREF to: 005dbe60 (CONDITIONAL_JUMP)
    POP EDI                             ; 005dbe78
        ;   Label: LAB_005dbe78
    PUSH 0x654ef9                       ; 005dbe79 | = "rt" | s_rt_00654ef9 = rt
    LEA EAX,[ESP + 0x4]                 ; 005dbe7e
    PUSH EAX                            ; 005dbe82
    PUSH 0x654efc                       ; 005dbe83 | = "data" | s_data_00654efc = data
    CALL engine_dosio.c_getFile_FUN_00481a50 ; 005dbe88 | FILE * engine_dosio.c_getFile_FUN_00481a50(char * directory, char * filename, char * mode)
        ;   XREF to: 00481a50 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005dbe8d
    MOV dword ptr [ESP + 0x100],EAX     ; 005dbe90
    TEST EAX,EAX                        ; 005dbe97
    JNZ 0x005dbebe                      ; 005dbe99 | LAB_005dbebe
        ;   XREF to: 005dbebe (CONDITIONAL_JUMP)
    MOV EBX,0x654f01                    ; 005dbe9b | = "..\\core\\texlist.cpp" | s_core_texlist_cpp_00654f01 = ..\core\texlist.cpp
    MOV ESI,0x6a                        ; 005dbea0
    PUSH 0x654f15                       ; 005dbea5 | = "CTextureList::load - Bad filename!" | s_CTextureList_load_Bad_fi_00654f15 = CTextureList::load - Bad filename!
    MOV dword ptr [0x02f0ca48],EBX      ; 005dbeaa | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 005dbeb0 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005dbeb6 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    PUSH EDI                            ; 005dbecb
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 005dbecc | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
    ...
    JLE 0x005dc05c                      ; 005dbee2 | LAB_005dc05c
    ...
    PUSH EBX                            ; 005dbf22
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 005dbf23 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ...
    MOV AL,byte ptr [ESI]               ; 005dbf2f
        ;   Label: LAB_005dbf2f
    CMP AL,DL                           ; 005dbf31
    JZ 0x005dbf47                       ; 005dbf33 | LAB_005dbf47
        ;   XREF to: 005dbf47 (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 005dbf35
    JZ 0x005dbf45                       ; 005dbf37 | LAB_005dbf45
        ;   XREF to: 005dbf45 (CONDITIONAL_JUMP)
    INC ESI                             ; 005dbf39
    MOV AL,byte ptr [ESI]               ; 005dbf3a
    CMP AL,DL                           ; 005dbf3c
    JZ 0x005dbf47                       ; 005dbf3e | LAB_005dbf47
        ;   XREF to: 005dbf47 (CONDITIONAL_JUMP)
    INC ESI                             ; 005dbf40
    CMP AL,0x0                          ; 005dbf41
    JNZ 0x005dbf2f                      ; 005dbf43 | LAB_005dbf2f
        ;   XREF to: 005dbf2f (CONDITIONAL_JUMP)
    SUB ESI,ESI                         ; 005dbf45
        ;   Label: LAB_005dbf45
    TEST ESI,ESI                        ; 005dbf47
        ;   Label: LAB_005dbf47
    JZ 0x005dc0b5                       ; 005dbf49 | LAB_005dc0b5
        ;   XREF to: 005dc0b5 (CONDITIONAL_JUMP)
    MOV byte ptr [ESI],0x0              ; 005dbf4f
    INC ESI                             ; 005dbf52
    PUSH ESI                            ; 005dbf53
    CALL crt_stdlib.c_atoi_FUN_005ffef0 ; 005dbf54 | int crt_stdlib.c_atoi_FUN_005ffef0(char * string_ptr)
    ...
    CMP AL,0x0                          ; 005dbf77
    JZ 0x005dbf8b                       ; 005dbf79 | LAB_005dbf8b
    ...
    CMP AL,0x0                          ; 005dbf87
    JNZ 0x005dbf73                      ; 005dbf89 | LAB_005dbf73
    ...
    JNC 0x005dbffe                      ; 005dbfbb | LAB_005dbffe
    ...
    PUSH EAX                            ; 005dbfc6
    INC EBX                             ; 005dbfc7
    CALL crt_ctype.c_toupper_FUN_005ff9e0 ; 005dbfc8 | int crt_ctype.c_toupper_FUN_005ff9e0(int c)
        ;   XREF to: 005ff9e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005dbfcd
    MOV byte ptr [EDI + EBX*0x1 + 0xb],AL ; 005dbfd0
    JMP 0x005dbfa3                      ; 005dbfd4 | LAB_005dbfa3
        ;   XREF to: 005dbfa3 (UNCONDITIONAL_JUMP)
    MOV EDX,0x654eb8                    ; 005dbfd6 | = "..\\core\\texlist.cpp" | s_core_texlist_cpp_00654eb8 = ..\core\texlist.cpp
        ;   Label: LAB_005dbfd6
    MOV ECX,0x61                        ; 005dbfdb
    PUSH 0x654ecc                       ; 005dbfe0 | = "CTextureList::load - No extension found" | s_CTextureList_load_No_ext_00654ecc = CTextureList::load - No extension found
    MOV dword ptr [0x02f0ca48],EDX      ; 005dbfe5 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 005dbfeb | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005dbff1 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005dbff6
    JMP 0x005dbe5a                      ; 005dbff9 | LAB_005dbe5a
    ...
    JL 0x005dc070                       ; 005dc084 | LAB_005dc070
        ;   XREF to: 005dc070 (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 005dc086
    LEA EDX,[EDX]                       ; 005dc08c
    PUSH 0x96                           ; 005dc090
        ;   Label: LAB_005dc090
    PUSH 0x654f40                       ; 005dc095 | = "..\\core\\texlist.cpp" | s_core_texlist_cpp_00654f40 = ..\core\texlist.cpp
    MOV ESI,dword ptr [ESP + 0x108]     ; 005dc09a
    PUSH ESI                            ; 005dc0a1
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 005dc0a2 | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
    ...
    JMP 0x005dbf69                      ; 005dc0c2 | LAB_005dbf69
