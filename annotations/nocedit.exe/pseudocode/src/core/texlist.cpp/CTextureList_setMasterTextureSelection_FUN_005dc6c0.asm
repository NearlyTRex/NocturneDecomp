...
section .text
    ...
    MOV dword ptr [ESP],EBX             ; 005dc71c
        ;   Label: LAB_005dc71c
    JMP 0x005dc705                      ; 005dc71f | LAB_005dc705
        ;   XREF to: 005dc705 (UNCONDITIONAL_JUMP)
    PUSH EBP                            ; 005dc721
        ;   Label: LAB_005dc721
    MOV ECX,0x6550e0                    ; 005dc722 | = "..\\core\\texlist.cpp" | s_core_texlist_cpp_006550e0 = ..\core\texlist.cpp
    MOV EBX,0x18f                       ; 005dc727
    PUSH 0x6550f4                       ; 005dc72c | = "CTextureList::setMasterTextureSelecti..." | s_CTextureList_setMasterTe_006550f4 = CTextureList::setMasterTextureSelection - Texture %s not found!
    MOV dword ptr [0x02f0ca48],ECX      ; 005dc731 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 005dc737 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005dc73d | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
