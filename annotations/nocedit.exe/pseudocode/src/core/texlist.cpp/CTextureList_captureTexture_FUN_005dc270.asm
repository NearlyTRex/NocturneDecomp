...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_texlist_cpp_CTextureList_captureTexture_FUN_005dc270(CTextureList *this_ptr,uint texture_index)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 005dc28f
    MOV EDX,dword ptr [0x006703ec]      ; 005dc290 | g_CDemonRendererInstance | g_CDemonRendererPtr2
