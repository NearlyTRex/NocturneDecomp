...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_texlist.cpp_CTextureList_buildMasterTextureList_FUN_005dc2a0(CTextureList * this_ptr)
;
; Parameters:
...
section .text
    ...
    JZ 0x005dc2c6                       ; 005dc2b9 | LAB_005dc2c6
    ...
    PUSH EAX                            ; 005dc2ce
    PUSH 0x654ff3                       ; 005dc2cf | = "art\\*.raw" | s_art_raw_00654ff3 = art\*.raw
    CALL crt_io.c_findFirstFileWrapper_FUN_006021f0 ; 005dc2d4 | HANDLE crt_io.c_findFirstFileWrapper_FUN_006021f0(char * filespec, LPWIN32_FIND_DATAA find_data)
        ;   XREF to: 006021f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005dc2d9
    MOV dword ptr [ESP + 0x1bc],EAX     ; 005dc2dc
    CMP EAX,-0x1                        ; 005dc2e3
    JZ 0x005dc4d6                       ; 005dc2e6 | LAB_005dc4d6
        ;   XREF to: 005dc4d6 (CONDITIONAL_JUMP)
    PUSH 0x655036                       ; 005dc2ec | = "Please wait, building texture list..." | s_Please_wait_building_tex_00655036 = Please wait, building texture list...
        ;   Label: LAB_005dc2ec
    MOV ESI,dword ptr [0x00678a60]      ; 005dc2f1 | CEditorTools * g_CEditorToolsPtr
    PUSH ESI                            ; 005dc2f7 | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_createCenteredDialog_FUN_0049e940 ; 005dc2f8 | void shape_edittool.cpp_CEditorTools_createCenteredDialog_FUN_0049e940(CEditorTools * this_ptr, char * dialog_text)
    ...
    CMP AL,0x0                          ; 005dc31d
    JZ 0x005dc331                       ; 005dc31f | LAB_005dc331
    ...
    CMP AL,0x0                          ; 005dc367
    JZ 0x005dc37b                       ; 005dc369 | LAB_005dc37b
    ...
    CMP AL,0x0                          ; 005dc377
    JNZ 0x005dc363                      ; 005dc379 | LAB_005dc363
    ...
    JZ 0x005dc3a3                       ; 005dc38a | LAB_005dc3a3
    ...
    PUSH EDX                            ; 005dc3c8
    PUSH 0x65505c                       ; 005dc3c9 | = "[%4d] %s" | s_s_4d_s_0065505c = [%4d] %s
    MOV ECX,dword ptr [0x00678a60]      ; 005dc3ce | CEditorTools g_CEditorToolsPtr | CEditorTools * g_CEditorToolsPtr
    PUSH ECX                            ; 005dc3d4 | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_drawWindowStatusMessage_FUN_0049e870 ; 005dc3d5 | void shape_edittool.cpp_CEditorTools_drawWindowStatusMessage_FUN_0049e870(CEditorTools * this_ptr, char * format_string)
    ...
    JL 0x005dc41b                       ; 005dc3f7 | LAB_005dc41b
        ;   XREF to: 005dc41b (CONDITIONAL_JUMP)
    MOV EDI,0x655065                    ; 005dc3f9 | = "..\\core\\texlist.cpp" | s_core_texlist_cpp_00655065 = ..\core\texlist.cpp
    MOV EAX,0x124                       ; 005dc3fe
    PUSH 0x655079                       ; 005dc403 | = "Too many editable textures!" | s_Too_many_editable_textur_00655079 = Too many editable textures!
    MOV dword ptr [0x02f0ca48],EDI      ; 005dc408 | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 005dc40e | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005dc413 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    PUSH EDX                            ; 005dc425
    CALL crt_io.c_findNextFileWrapper_FUN_00602300 ; 005dc426 | int crt_io.c_findNextFileWrapper_FUN_00602300(HANDLE find_handle, LPWIN32_FIND_DATAA find_data)
        ;   XREF to: 00602300 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005dc42b
    TEST EAX,EAX                        ; 005dc42e
    JZ 0x005dc30d                       ; 005dc430 | LAB_005dc30d
        ;   XREF to: 005dc30d (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x00678a60]      ; 005dc436 | CEditorTools g_CEditorToolsPtr | CEditorTools * g_CEditorToolsPtr
    PUSH ECX                            ; 005dc43c | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_restoreWindowAndCleanup_FUN_004a0dd0 ; 005dc43d | void shape_edittool.cpp_CEditorTools_restoreWindowAndCleanup_FUN_004a0dd0(CEditorTools * this_ptr)
        ;   XREF to: 004a0dd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005dc442
    MOV EBX,dword ptr [ESP + 0x1bc]     ; 005dc445
    PUSH EBX                            ; 005dc44c
    CALL crt_io.c_findCloseWrapper_FUN_00602380 ; 005dc44d | int crt_io.c_findCloseWrapper_FUN_00602380(HANDLE find_handle)
    ...
    JLE 0x005dc2bb                      ; 005dc48f | LAB_005dc2bb
    ...
    JL 0x005dc5b9                       ; 005dc4ae | LAB_005dc5b9
    ...
    JMP 0x005dc478                      ; 005dc4d4 | LAB_005dc478
        ;   XREF to: 005dc478 (UNCONDITIONAL_JUMP)
    MOV ECX,0x654ffd                    ; 005dc4d6 | = "..\\core\\texlist.cpp" | s_core_texlist_cpp_00654ffd = ..\core\texlist.cpp
        ;   Label: LAB_005dc4d6
    MOV EBX,0xff                        ; 005dc4db
    PUSH 0x655011                       ; 005dc4e0 | = "Unable to build list of *.raw files!" | s_Unable_to_build_list_of__00655011 = Unable to build list of *.raw files!
    MOV dword ptr [0x02f0ca48],ECX      ; 005dc4e5 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 005dc4eb | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005dc4f1 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005dc4f6
    JMP 0x005dc2ec                      ; 005dc4f9 | LAB_005dc2ec
        ;   XREF to: 005dc2ec (UNCONDITIONAL_JUMP)
    CMP EDI,0x10000                     ; 005dc4fe
        ;   Label: LAB_005dc4fe
    JZ 0x005dc342                       ; 005dc504 | LAB_005dc342
        ;   XREF to: 005dc342 (CONDITIONAL_JUMP)
    JMP 0x005dc41b                      ; 005dc50a | LAB_005dc41b
    ...
    JGE 0x005dc4b4                      ; 005dc530 | LAB_005dc4b4
    ...
    PUSH EBP                            ; 005dc543
    CALL crt_string.c_strcmp_FUN_005fef20 ; 005dc544 | int crt_string.c_strcmp_FUN_005fef20(char * str1, char * str2)
        ;   XREF to: 005fef20 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005dc549
    TEST EAX,EAX                        ; 005dc54c
    JLE 0x005dc50f                      ; 005dc54e | LAB_005dc50f
    ...
    CMP AL,0x0                          ; 005dc55e
    JZ 0x005dc572                       ; 005dc560 | LAB_005dc572
    ...
    CMP AL,0x0                          ; 005dc56e
    JNZ 0x005dc55a                      ; 005dc570 | LAB_005dc55a
    ...
    CMP AL,0x0                          ; 005dc57c
    JZ 0x005dc590                       ; 005dc57e | LAB_005dc590
    ...
    CMP AL,0x0                          ; 005dc58c
    JNZ 0x005dc578                      ; 005dc58e | LAB_005dc578
    ...
    CMP AL,0x0                          ; 005dc59f
    JZ 0x005dc5b3                       ; 005dc5a1 | LAB_005dc5b3
    ...
    CMP AL,0x0                          ; 005dc5af
    JNZ 0x005dc59b                      ; 005dc5b1 | LAB_005dc59b
        ;   XREF to: 005dc59b (CONDITIONAL_JUMP)
    POP EDI                             ; 005dc5b3
        ;   Label: LAB_005dc5b3
    JMP 0x005dc50f                      ; 005dc5b4 | LAB_005dc50f
    ...
    JMP 0x005dc532                      ; 005dc5da | LAB_005dc532
