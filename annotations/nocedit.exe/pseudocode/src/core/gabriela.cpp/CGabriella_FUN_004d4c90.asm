...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_gabriela_cpp_CGabriella_FUN_004d4c90(CGabriella *this_ptr)
;
; Parameters:
...
;
; XREF[2]:
;   core_gabriela.cpp_CGabriella_FUN_004d4d80 at 004d4ea0
...
section .text
    ...
    PUSH EBX                            ; 004d4c90
        ;   Label: core_gabriela.cpp_CGabriella_FUN_004d4c90
