...
;
; XREF[1]:
;   core_gabriela.cpp_CGabriella_process_FUN_004d2ea0 at 004d366c
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004d5fe0
        ;   Label: core_gabriela.cpp_CGabriella_tryFireWeapon_FUN_004d5fe0
    PUSH ESI                            ; 004d5fe1
    MOV ESI,dword ptr [ESP + 0xc]       ; 004d5fe2
    PUSH ESI                            ; 004d5fe6
    MOV EDX,dword ptr [0x006810c8]      ; 004d5fe7 | g_CDemonSetInstance | g_CDemonSetPtr
    PUSH EDX                            ; 004d5fed | g_CDemonSetInstance
    LEA EBX,[ESI + 0x1f738]             ; 004d5fee
    CALL core_setcolid.cpp_CDemonSet_ignore_FUN_005741b0 ; 004d5ff4
    ...
    JZ 0x004d602f                       ; 004d6014
        ;   XREF to: 004d602f (CONDITIONAL_JUMP)  ; LAB_004d602f
    MOV EAX,dword ptr [EBX + 0x330]     ; 004d6016
    CMP dword ptr [EAX + 0x2dc],0x1     ; 004d601c
    JNZ 0x004d602f                      ; 004d6023
        ;   XREF to: 004d602f (CONDITIONAL_JUMP)  ; LAB_004d602f
