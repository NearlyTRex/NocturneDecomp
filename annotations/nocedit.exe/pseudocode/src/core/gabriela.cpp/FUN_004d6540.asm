...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_gabriela.cpp_FUN_004d6540()
;
; Local Variables:
...
section .text
    ...
    FLD float ptr [0x0065e7c0]          ; 004d65c2 | DAT_0065e7c0
        ;   Label: LAB_004d65c2
    FMUL double ptr [0x0062b0cd]        ; 004d65c8 | double DOUBLE_0062b0cd
    ...
    FNSTSW AX                           ; 004d65e7
    SAHF                                ; 004d65e9
    JNC 0x004d65f6                      ; 004d65ea | LAB_004d65f6
    ...
    FNSTSW AX                           ; 004d6600
    SAHF                                ; 004d6602
    JBE 0x004d6623                      ; 004d6603 | LAB_004d6623
    ...
    FNSTSW AX                           ; 004d662d
    SAHF                                ; 004d662f
    JC 0x004d69e7                       ; 004d6630 | LAB_004d69e7
    ...
    LEA EAX,[EBX + 0x158]               ; 004d6655
        ;   Label: LAB_004d6655
    PUSH EAX                            ; 004d665b
    CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0 ; 004d665c | SMotion * core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0(CMotionController * this_ptr)
        ;   XREF to: 0052dab0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EAX + 0x24]      ; 004d6661
    ADD ESP,0x4                         ; 004d6664
    CMP EAX,0x2                         ; 004d6667
    JNZ 0x004d655d                      ; 004d666a | LAB_004d655d
        ;   XREF to: 004d655d (CONDITIONAL_JUMP)
    MOV ESI,0x1                         ; 004d6670
    JMP 0x004d655d                      ; 004d6675 | LAB_004d655d
        ;   XREF to: 004d655d (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0xbe28],0x2    ; 004d667a
        ;   Label: LAB_004d667a
    JZ 0x004d656a                       ; 004d6681 | LAB_004d656a
        ;   XREF to: 004d656a (CONDITIONAL_JUMP)
    FLD float ptr [EBX + 0xbe54]        ; 004d6687
    FMUL double ptr [0x0062b0b5]        ; 004d668d | double DOUBLE_0062b0b5
    FMUL double ptr [0x0062b0bd]        ; 004d6693 | double DOUBLE_0062b0bd
    ...
    FCOMP float ptr [0x0062b0c5]        ; 004d66ba | float FLOAT_0062b0c5
    FNSTSW AX                           ; 004d66c0
    SAHF                                ; 004d66c2
    JNC 0x004d66cf                      ; 004d66c3 | LAB_004d66cf
    ...
    FNSTSW AX                           ; 004d66dc
    SAHF                                ; 004d66de
    JBE 0x004d66ee                      ; 004d66df | LAB_004d66ee
    ...
    MOV EAX,[0x006810c8]                ; 004d673d | CDemonSet * g_CDemonSetPtr
        ;   Label: LAB_004d673d
    MOV ESI,dword ptr [ESP + 0x118]     ; 004d6742
    CMP ESI,dword ptr [EAX + 0x14d154]  ; 004d6749 | g_CDemonSetInstance.actor_list_ptr
    JGE 0x004d67c5                      ; 004d674f | LAB_004d67c5
        ;   XREF to: 004d67c5 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [EDI + EAX*0x1 + 0x14d158] ; 004d6755 | g_CDemonSetInstance.actor_list_data[0]
    ...
    PUSH ESI                            ; 004d676b
    PUSH EBX                            ; 004d676c
    CALL core_gabriela.cpp_FUN_004d6260 ; 004d676d | undefined core_gabriela.cpp_FUN_004d6260()
    ...
    FNSTSW AX                           ; 004d678a
    SAHF                                ; 004d678c
    JBE 0x004d67a3                      ; 004d678d | LAB_004d67a3
    ...
    JMP 0x004d673d                      ; 004d67a1 | LAB_004d673d
    ...
    FNSTSW AX                           ; 004d67ad
    SAHF                                ; 004d67af
    JNC 0x004d678f                      ; 004d67b0 | LAB_004d678f
    ...
    JMP 0x004d678f                      ; 004d67c3 | LAB_004d678f
        ;   XREF to: 004d678f (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x110]     ; 004d67c5
        ;   Label: LAB_004d67c5
    MOV dword ptr [EBX + 0x1fbf8],EAX   ; 004d67cc
    JMP 0x004d6581                      ; 004d67d2 | LAB_004d6581
        ;   XREF to: 004d6581 (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x1fbf8],0x0   ; 004d67d7
        ;   Label: LAB_004d67d7
    JZ 0x004d69c0                       ; 004d67de | LAB_004d69c0
        ;   XREF to: 004d69c0 (CONDITIONAL_JUMP)
    PUSH 0x6598c0                       ; 004d67e4 | WatcomTypeInfo g_CVectorTypeInfo
    PUSH 0xa                            ; 004d67e9
    LEA EAX,[ESP + 0xc]                 ; 004d67eb
    PUSH EAX                            ; 004d67ef
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 004d67f0 | void * crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
    ...
    PUSH EDX                            ; 004d685e
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 004d685f | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
    ...
    PUSH EAX                            ; 004d686f
    PUSH EBX                            ; 004d6870
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 004d6871 | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
        ;   XREF to: 00408f10 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004d6876
    MOV ECX,dword ptr [0x02d7b860]      ; 004d6879 | undefined4 DAT_02d7b860
    PUSH ECX                            ; 004d687f
    LEA EAX,[ESP + 0xbc]                ; 004d6880
    PUSH EAX                            ; 004d6887
    LEA EAX,[EBX + 0x158]               ; 004d6888
    PUSH EAX                            ; 004d688e
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneWorldPosition_FUN_0059fa20 ; 004d688f | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneWorldPosition_FUN_0059fa20(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
    ...
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 004d68dd | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
    ...
    JMP 0x004d65d7                      ; 004d690e | LAB_004d65d7
        ;   XREF to: 004d65d7 (UNCONDITIONAL_JUMP)
    ...
    FXCH                                ; 004d693f
    FLD float ptr [0x0062b0c9]          ; 004d6941 | float FLOAT_0062b0c9
    FXCH                                ; 004d6947
    FMUL ST1                            ; 004d6949
    FXCH ST2                            ; 004d694b
    ...
    JZ 0x004d6848                       ; 004d6992 | LAB_004d6848
        ;   XREF to: 004d6848 (CONDITIONAL_JUMP)
    ...
    JMP 0x004d6841                      ; 004d69bb | LAB_004d6841
    ...
    FNSTSW AX                           ; 004d69ca
    SAHF                                ; 004d69cc
    JC 0x004d65dd                       ; 004d69cd | LAB_004d65dd
    ...
    JMP 0x004d65d7                      ; 004d69e2 | LAB_004d65d7
        ;   XREF to: 004d65d7 (UNCONDITIONAL_JUMP)
    ...
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 004d69f9 | float core_actor.cpp_normalizeAngleToPi_FUN_0040cd70(float angle_radians)
    ...
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 004d6a2c | float core_actor.cpp_normalizeAngleToPi_FUN_0040cd70(float angle_radians)
        ;   XREF to: 0040cd70 (UNCONDITIONAL_CALL)
    MOV dword ptr [ESP + 0x124],EAX     ; 004d6a31
    FLD float ptr [ESP + 0x124]         ; 004d6a38
    ADD ESP,0x4                         ; 004d6a3f
    FLD float ptr [EBP + 0x18]          ; 004d6a42
    FMUL double ptr [0x0062b0b5]        ; 004d6a45 | double DOUBLE_0062b0b5
    FMUL double ptr [0x0062b0d5]        ; 004d6a4b | double DOUBLE_0062b0d5
    ...
    FNSTSW AX                           ; 004d6a78
    SAHF                                ; 004d6a7a
    JNC 0x004d6a8b                      ; 004d6a7b | LAB_004d6a8b
    ...
    FNSTSW AX                           ; 004d6a99
    SAHF                                ; 004d6a9b
    JBE 0x004d6aac                      ; 004d6a9c | LAB_004d6aac
    ...
    FNSTSW AX                           ; 004d6aca
    SAHF                                ; 004d6acc
    JNC 0x004d6add                      ; 004d6acd | LAB_004d6add
    ...
    FNSTSW AX                           ; 004d6aeb
    SAHF                                ; 004d6aed
    JBE 0x004d6afe                      ; 004d6aee | LAB_004d6afe
