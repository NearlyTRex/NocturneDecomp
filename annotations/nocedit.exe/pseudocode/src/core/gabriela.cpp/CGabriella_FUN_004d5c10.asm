...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_gabriela_cpp_CGabriella_FUN_004d5c10(CGabriella *this_ptr)
;
; Parameters:
; CGabriella *     Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_gabriela.cpp_CGabriella_FUN_004d4890 at 004d4c4e
;
; Referenced Globals:
...
;   core_ammobox.cpp_CAmmoBox_FUN_00411700
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 004d5c10
        ;   Label: core_gabriela.cpp_CGabriella_FUN_004d5c10
    ...
    PUSH EDX                            ; 004d5c3b
    PUSH EAX                            ; 004d5c3c
    CALL core_ammobox.cpp_CAmmoBox_FUN_00411700 ; 004d5c3d
        ;   XREF to: 00411700 (UNCONDITIONAL_CALL)  ; void core_ammobox.cpp_CAmmoBox_FUN_00411700(CAmmoBox * this_ptr, CInventory * inventory)
