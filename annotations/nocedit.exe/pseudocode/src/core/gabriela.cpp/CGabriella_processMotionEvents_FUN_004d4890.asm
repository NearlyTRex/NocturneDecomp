...
section .text
    ...
    PUSH EBX                            ; 004d4890
        ;   Label: core_gabriela.cpp_CGabriella_processMotionEvents_FUN_004d4890
    PUSH ESI                            ; 004d4891
    PUSH EDI                            ; 004d4892
    PUSH EBP                            ; 004d4893
    ...
    CALL core_gore.cpp_CGore_spawnBloodBurst_FUN_004edbb0 ; 004d4bc5
    ...
    PUSH EBX                            ; 004d4c4d
        ;   Label: caseD_13
    CALL core_gabriela.cpp_CGabriella_collectAmmo_FUN_004d5c10 ; 004d4c4e
        ;   XREF to: 004d5c10 (UNCONDITIONAL_CALL)  ; void core_gabriela.cpp_CGabriella_collectAmmo_FUN_004d5c10(CGabriella * this_ptr)
