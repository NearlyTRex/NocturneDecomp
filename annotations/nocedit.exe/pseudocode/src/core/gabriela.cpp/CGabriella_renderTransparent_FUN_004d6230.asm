...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_gabriela_cpp_CGabriella_renderTransparent_FUN_004d6230(CGabriella *this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EAX,dword ptr [ESP + 0x4]       ; 004d6230
        ;   Label: core_gabriela.cpp_CGabriella_renderTransparent_FUN_004d6230
    ...
    PUSH EDX                            ; 004d624b
    CALL core_charactr.cpp_CCharacter_renderTransparent_FUN_0042b0e0 ; 004d624c
