...

{
  ...
  do {
    ...
    if (this_ptr != (CDemonActor *)0x0) {
      fVar5 = (pCVar1->position).x - (this_ptr->location).position.x;
      fVar2 = (pCVar3->location).position.z - (this_ptr->location).position.z;
      if ((((ABS((pCVar3->location).position.y - (this_ptr->location).position.y) <=
             (float)DOUBLE_0062affd) &&
           (SQRT(fVar2 * fVar2 + fVar5 * fVar5) <= (float)DOUBLE_0062b005)) &&
          (core_actor_cpp_CDemonActor_FUN_00408f10(param_5),
          ABS((float)local_88) <= (float)DOUBLE_0062b00d)) &&
        ...
        pCVar4 = core_vehicle_cpp_convertDirectionVectorToEulerAngles_FUN_005e7830
                           (aCStack_4c,(CVector3f *)&local_88);
        fVar5 = core_actor_cpp_FUN_0040cd70(pCVar4->y);
        if (ABS(fVar5) <= (float)DOUBLE_0062b01d) {
          pCVar4 = core_actor_cpp_CDemonActor_FUN_00408f10(this_ptr);
          if ((CVector3f *)&stack0xffffff84 != pCVar4) {
            in_stack_ffffff84 = pCVar4->x;
            fStack_74 = pCVar4->z;
          }
          if (fStack_74 < 0.0) {
            fStack_74 = -fStack_74;
          ...
          if (ABS(in_stack_ffffff84) <= (float)DOUBLE_0062b00d) {
            local_88 = (CVector3f *)((ulonglong)(double)fStack_74 >> 0x20);
            if (((float)DOUBLE_0062b015 <= fStack_74) && ((double)fStack_74 <= DOUBLE_0062b005)) {
              pCVar4 = core_vehicle_cpp_convertDirectionVectorToEulerAngles_FUN_005e7830
                                 ((CVector3f *)(local_24 + 8),(CVector3f *)&stack0xffffff84);
              param_5 = (CDemonActor *)core_actor_cpp_FUN_0040cd70(pCVar4->y);
              if (ABS((float)param_5) <= (float)DOUBLE_0062b01d) {
                local_88 = (CVector3f *)0x1;
                param_5[0x179].field19_0x114 = (int)fVar5;
                ...
                local_88 = aCStack_4c;
                pfVar6 = core_actor_cpp_CDemonActor_FUN_00408ec0(unaff_EBX);
                (param_5->location).position.x = *pfVar6;
                (param_5->location).position.y = pfVar6[1];
                (param_5->location).position.z = pfVar6[2];
                ...
                local_88 = (CVector3f *)0x4d5f43;
                pCVar4 = core_vehicle_cpp_convertDirectionVectorToEulerAngles_FUN_005e7830
                                   ((CVector3f *)(local_24 + 0xc),(CVector3f *)local_24);
                (param_5->orient).bank = pCVar4->y;
...
//   XREF to: Stack[0x4] (READ)
// 004d5d35: PUSH EAX
// 004d5d36: CALL core_actor.cpp_CDemonActor_FUN_00408f10
...
// 004d5d92: CALL core_actor.cpp_FUN_0040cd70
...
// 004d5dc9: CALL core_actor.cpp_CDemonActor_FUN_00408f10
//   XREF to: 00408f10 (UNCONDITIONAL_CALL)
...
// 004d5e65: CALL core_actor.cpp_FUN_0040cd70
//   XREF to: 0040cd70 (UNCONDITIONAL_CALL)
...
//   XREF to: Stack[-0x24] (READ)
// 004d5ef3: PUSH ECX
// 004d5ef4: CALL core_actor.cpp_CDemonActor_FUN_00408ec0
...
// 004d5f50: CALL core_actor.cpp_CDemonActor_FUN_00408c10
