  ...
  do {
    ...
    case 7:
      ...
      if (*(int *)(in_stack_00000004[2].cloth_data + 0x54cc) == 0) {
        ...
        (**(code **)(*(int *)(*(int *)(in_stack_00000004[2].cloth_data + 0x54cc) + 0x154) + 0x3c))()
        ;
        pCVar4 = core_actor_cpp_CDemonActor_localToWorldPoint_FUN_00408ec0
                           (&in_stack_00000004->base_actor,(CVector3f *)auStack_44,
                            (CVector3f *)(auStack_54 + 4));
        (*pCVar1->handleFootstep)
                  (&in_stack_00000004->base_actor,pCVar4,SUB84 /* extract 2-byte value */(in_stack_ffffff5c,0),
                   (float)((ulonglong)in_stack_ffffff5c >> 0x20));
      }
      break;
    case 2:
