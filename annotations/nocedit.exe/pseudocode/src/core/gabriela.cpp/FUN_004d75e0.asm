...
section .text
    ...
    PUSH EDX                            ; 004d75e9
    PUSH EBX                            ; 004d75ea
    CALL core_charactr.cpp_CCharacter_FUN_0042f8a0 ; 004d75eb | void core_charactr.cpp_CCharacter_FUN_0042f8a0(CCharacter * this_ptr)
    ...
    JZ 0x004d7601                       ; 004d75fd | LAB_004d7601
