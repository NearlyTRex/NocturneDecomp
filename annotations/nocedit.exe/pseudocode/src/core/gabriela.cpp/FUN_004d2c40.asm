...
section .text
    ...
    PUSH EBX                            ; 004d2cb5
    MOV [0x02d7b848],EAX                ; 004d2cb6 | DAT_02d7b848
    ...
    PUSH EBX                            ; 004d2cca
    MOV [0x02d7b84c],EAX                ; 004d2ccb | DAT_02d7b84c
    ...
    PUSH EBX                            ; 004d2cdf
    MOV [0x02d7b850],EAX                ; 004d2ce0 | DAT_02d7b850
    ...
    PUSH EBX                            ; 004d2d09
    MOV [0x02d7b858],EAX                ; 004d2d0a | DAT_02d7b858
    ...
    PUSH EBX                            ; 004d2d33
    MOV [0x02d7b860],EAX                ; 004d2d34 | DAT_02d7b860
    ...
    PUSH EBX                            ; 004d2d48
    MOV [0x02d7b864],EAX                ; 004d2d49 | DAT_02d7b864
    ...
    PUSH EBX                            ; 004d2d5d
    MOV [0x02d7b868],EAX                ; 004d2d5e | DAT_02d7b868
    ...
    PUSH EBX                            ; 004d2d87
    MOV [0x02d7b870],EAX                ; 004d2d88 | DAT_02d7b870
    ...
    PUSH EBX                            ; 004d2db1
    MOV [0x02d7b878],EAX                ; 004d2db2 | DAT_02d7b878
    ...
    PUSH EBX                            ; 004d2dc6
    MOV [0x02d7b888],EAX                ; 004d2dc7 | DAT_02d7b888
    ...
    PUSH EDI                            ; 004d2e05
    MOV [0x02d7b894],EAX                ; 004d2e06 | DAT_02d7b894
    ...
    PUSH EDI                            ; 004d2e23
    MOV [0x02d7b87c],EAX                ; 004d2e24 | DAT_02d7b87c
    ...
    PUSH EDI                            ; 004d2e41
    MOV [0x02d7b884],EAX                ; 004d2e42 | DAT_02d7b884
    ...
    MOV [0x02d7b880],EAX                ; 004d2e69 | DAT_02d7b880
    MOV dword ptr [ESI + 0x1fbac],0x0   ; 004d2e6e
    MOV EAX,[0x02d7b888]                ; 004d2e78 | DAT_02d7b888
