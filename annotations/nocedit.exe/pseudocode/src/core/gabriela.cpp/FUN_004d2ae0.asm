...
section .text
    ...
    PUSH EAX                            ; 004d2afc
        ;   Label: LAB_004d2afc
    CALL core_gabriela.cpp_constructorMaybe_FUN_004d2b20 ; 004d2afd
        ;   XREF to: 004d2b20 (UNCONDITIONAL_CALL)  ; CGabriella * core_gabriela.cpp_constructorMaybe_FUN_004d2b20(CGabriella * this_ptr)
