...
; CBoundingBox3D   Stack[-0x114]:24  CStack_114
; CBoundingBox3D   Stack[-0xfc]:24  local_fc
...
; float[3]         Stack[-0xb4]:12  local_b4
...
section .text
    ...
    PUSH EBX                            ; 004d4190
        ;   Label: core_gabriela.cpp_CGabriella_processAI_FUN_004d4190
    PUSH ESI                            ; 004d4191
    PUSH EDI                            ; 004d4192
    PUSH EBP                            ; 004d4193
    ...
    PUSH EAX                            ; 004d4267
    PUSH EBX                            ; 004d4268
    CALL core_hero.cpp_CHero_findNearestEnemy_FUN_004f3960 ; 004d4269
