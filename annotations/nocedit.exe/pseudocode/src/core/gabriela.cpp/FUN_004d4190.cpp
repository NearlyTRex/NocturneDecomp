...

{
  ...
  if (in_stack_00000004->ai_task != 0) {
    ...
    local_84 = (in_stack_00000004->base).base.location.position.x -
               (pCVar1->base).base.location.position.x;
    local_80 = (in_stack_00000004->base).base.location.position.y -
               (pCVar1->base).base.location.position.y;
    local_7c = (in_stack_00000004->base).base.location.position.z -
    ...
    if ((float)4 <= fVar6) {
      iVar5 = core_path_cpp_CPathMap_findPathWithRetry_FUN_00547d00
                        (&g_HeroActors[g_LocalHeroIndex]->path_map,
                         &(in_stack_00000004->base).base.location.position,&local_c0,
                         (in_stack_00000004->base).base.unk1);
      if (iVar5 != 0) {
        fVar6 = core_actor_cpp_normalizeAngleToPi_FUN_0040cd70
                          (local_c0.y - (in_stack_00000004->base).base.orient.bank);
        ...
        *(float *)(in_stack_00000004->unk2 + 0x24) = fVar6;
        ...
        if (&local_9c != local_b4) {
          local_9c = (in_stack_00000004->base).base.location.position.x -
                     (pCVar1->base).base.location.position.x;
          local_98.x = (in_stack_00000004->base).base.location.position.y -
                       (pCVar1->base).base.location.position.y;
          local_98.y = (in_stack_00000004->base).base.location.position.z -
                       (pCVar1->base).base.location.position.z;
        }
        if ((float)10 <
      ...
      if ((in_stack_00000004->ai_task == 2) || (in_stack_00000004->ai_task == 3)) {
        this_ptr_00 = (CDemonActor *)core_hero_cpp_CHero_FUN_004f3960(in_stack_00000004);
      }
      if ((this_ptr_00 == (CDemonActor *)0x0) || ((float)30 <= fVar6)) {
        ...
        local_6c._0_4_ =
             (this_ptr_00->location).position.x - (in_stack_00000004->base).base.location.position.x
        ;
        local_6c._4_4_ =
             (this_ptr_00->location).position.y - (in_stack_00000004->base).base.location.position.y
        ;
        local_64 = (this_ptr_00->location).position.z -
        ...
        *(float *)(in_stack_00000004->unk2 + 0x24) = fVar6;
        ...
        if (((float)-0.050000000000000003 < *(float *)(in_stack_00000004->unk2 + 0x24)) &&
           ((double)*(float *)(in_stack_00000004->unk2 + 0x24) < 0.050000000000000003)) {
          pCVar4 = (*((in_stack_00000004->base).base.vtable._ub)->getBoundingBox)
                             ((CDemonActor *)in_stack_00000004,
                              (CBoundingBox3D *)(auStack_10c + 0x10));
          ...
          fStack_70 = (in_stack_00000004->base).base.location.position.x + fStack_4c;
          local_6c._0_4_ = (in_stack_00000004->base).base.location.position.y + fStack_48;
          local_6c._4_4_ = (in_stack_00000004->base).base.location.position.z + fStack_44;
