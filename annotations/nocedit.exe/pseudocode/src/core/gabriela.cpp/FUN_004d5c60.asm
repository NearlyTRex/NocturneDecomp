...
;
; XREF[1]:
;   core_gabriela.cpp_FUN_004d2ea0 at 004d4067
;
; Referenced Globals:
...
section .text
    ...
    MOV EAX,[0x006810c8]                ; 004d5c88 | CDemonSet * g_CDemonSetPtr
        ;   Label: LAB_004d5c88
    CMP EDI,dword ptr [EAX + 0x14d154]  ; 004d5c8d | g_CDemonSetInstance.actor_list_ptr
    JL 0x004d5cb2                       ; 004d5c93 | LAB_004d5cb2
    ...
    JMP 0x004d5c88                      ; 004d5cb0 | LAB_004d5c88
    ...
    PUSH EAX                            ; 004d5cc8
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 004d5cc9 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004d5cce
    MOV EBX,EAX                         ; 004d5cd1
    MOV dword ptr [ESP + 0x7c],EAX      ; 004d5cd3
    TEST EAX,EAX                        ; 004d5cd7
    JZ 0x004d5c9e                       ; 004d5cd9 | LAB_004d5c9e
    ...
    FCOMP double ptr [0x0062affd]       ; 004d5cfc | double DOUBLE_0062affd
    FNSTSW AX                           ; 004d5d02
    SAHF                                ; 004d5d04
    JA 0x004d5c9e                       ; 004d5d05 | LAB_004d5c9e
        ;   XREF to: 004d5c9e (CONDITIONAL_JUMP)
    ...
    FCOMP double ptr [0x0062b005]       ; 004d5d1d | double DOUBLE_0062b005
    FNSTSW AX                           ; 004d5d23
    SAHF                                ; 004d5d25
    JA 0x004d5c9e                       ; 004d5d26 | LAB_004d5c9e
        ;   XREF to: 004d5c9e (CONDITIONAL_JUMP)
    PUSH EDX                            ; 004d5d2c
    ...
    PUSH EAX                            ; 004d5d35
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 004d5d36 | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
        ;   XREF to: 00408f10 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004d5d3b
    FLD float ptr [ESP + 0x10]          ; 004d5d3e
    FABS                                ; 004d5d42
    FCOMP double ptr [0x0062b00d]       ; 004d5d44 | double DOUBLE_0062b00d
    FNSTSW AX                           ; 004d5d4a
    SAHF                                ; 004d5d4c
    JA 0x004d5c9e                       ; 004d5d4d | LAB_004d5c9e
        ;   XREF to: 004d5c9e (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x18]          ; 004d5d53
    FST double ptr [ESP + 0x8]          ; 004d5d57
    FCOMP double ptr [0x0062b015]       ; 004d5d5b | double DOUBLE_0062b015
    FNSTSW AX                           ; 004d5d61
    SAHF                                ; 004d5d63
    JC 0x004d5c9e                       ; 004d5d64 | LAB_004d5c9e
        ;   XREF to: 004d5c9e (CONDITIONAL_JUMP)
    FLD double ptr [ESP + 0x8]          ; 004d5d6a
    FCOMP double ptr [0x0062b005]       ; 004d5d6e | double DOUBLE_0062b005
    FNSTSW AX                           ; 004d5d74
    SAHF                                ; 004d5d76
    JA 0x004d5c9e                       ; 004d5d77 | LAB_004d5c9e
        ;   XREF to: 004d5c9e (CONDITIONAL_JUMP)
    LEA EAX,[ESP + 0x10]                ; 004d5d7d
    PUSH EAX                            ; 004d5d81
    LEA EAX,[ESP + 0x50]                ; 004d5d82
    PUSH EAX                            ; 004d5d86
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 004d5d87 | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004d5d8c
    PUSH dword ptr [EAX + 0x4]          ; 004d5d8f
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 004d5d92 | float core_actor.cpp_normalizeAngleToPi_FUN_0040cd70(float angle_radians)
        ;   XREF to: 0040cd70 (UNCONDITIONAL_CALL)
    MOV dword ptr [ESP + 0x8c],EAX      ; 004d5d97
    FLD float ptr [ESP + 0x8c]          ; 004d5d9e
    FABS                                ; 004d5da5
    ADD ESP,0x4                         ; 004d5da7
    FCOMP double ptr [0x0062b01d]       ; 004d5daa | double DOUBLE_0062b01d
    FNSTSW AX                           ; 004d5db0
    SAHF                                ; 004d5db2
    JA 0x004d5c9e                       ; 004d5db3 | LAB_004d5c9e
        ;   XREF to: 004d5c9e (CONDITIONAL_JUMP)
    PUSH ESI                            ; 004d5db9
    ...
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 004d5dc9 | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
        ;   XREF to: 00408f10 (UNCONDITIONAL_CALL)
    MOV EDX,EAX                         ; 004d5dce
    LEA EAX,[ESP + 0x1c]                ; 004d5dd0
    ADD ESP,0xc                         ; 004d5dd4
    CMP EAX,EDX                         ; 004d5dd7
    JZ 0x004d5def                       ; 004d5dd9 | LAB_004d5def
    ...
    FNSTSW AX                           ; 004d5df7
    SAHF                                ; 004d5df9
    JBE 0x004d5e13                      ; 004d5dfa | LAB_004d5e13
    ...
    FLD float ptr [ESP + 0x10]          ; 004d5e13
        ;   Label: LAB_004d5e13
    FABS                                ; 004d5e17
    FCOMP double ptr [0x0062b00d]       ; 004d5e19 | double DOUBLE_0062b00d
    FNSTSW AX                           ; 004d5e1f
    SAHF                                ; 004d5e21
    JA 0x004d5c9e                       ; 004d5e22 | LAB_004d5c9e
        ;   XREF to: 004d5c9e (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x18]          ; 004d5e28
    FST double ptr [ESP]                ; 004d5e2c
    FCOMP double ptr [0x0062b015]       ; 004d5e2f | double DOUBLE_0062b015
    FNSTSW AX                           ; 004d5e35
    SAHF                                ; 004d5e37
    JC 0x004d5c9e                       ; 004d5e38 | LAB_004d5c9e
        ;   XREF to: 004d5c9e (CONDITIONAL_JUMP)
    FLD double ptr [ESP]                ; 004d5e3e
    FCOMP double ptr [0x0062b005]       ; 004d5e41 | double DOUBLE_0062b005
    FNSTSW AX                           ; 004d5e47
    SAHF                                ; 004d5e49
    JA 0x004d5c9e                       ; 004d5e4a | LAB_004d5c9e
        ;   XREF to: 004d5c9e (CONDITIONAL_JUMP)
    LEA EAX,[ESP + 0x10]                ; 004d5e50
    PUSH EAX                            ; 004d5e54
    LEA EAX,[ESP + 0x74]                ; 004d5e55
    PUSH EAX                            ; 004d5e59
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 004d5e5a | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004d5e5f
    PUSH dword ptr [EAX + 0x4]          ; 004d5e62
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 004d5e65 | float core_actor.cpp_normalizeAngleToPi_FUN_0040cd70(float angle_radians)
        ;   XREF to: 0040cd70 (UNCONDITIONAL_CALL)
    MOV dword ptr [ESP + 0x8c],EAX      ; 004d5e6a
    FLD float ptr [ESP + 0x8c]          ; 004d5e71
    FABS                                ; 004d5e78
    ADD ESP,0x4                         ; 004d5e7a
    FCOMP double ptr [0x0062b01d]       ; 004d5e7d | double DOUBLE_0062b01d
    FNSTSW AX                           ; 004d5e83
    SAHF                                ; 004d5e85
    JA 0x004d5c9e                       ; 004d5e86 | LAB_004d5c9e
        ;   XREF to: 004d5c9e (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 004d5e8c
    ...
    PUSH EAX                            ; 004d5ea6
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 004d5ea7 | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
    ...
    JZ 0x004d5ee2                       ; 004d5ed8 | LAB_004d5ee2
    ...
    PUSH ECX                            ; 004d5ef3
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 004d5ef4 | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
    ...
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 004d5f3e | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)
    ...
    CALL core_actor.cpp_CDemonActor_updateOrientationMatrix_FUN_00408c10 ; 004d5f50 | void core_actor.cpp_CDemonActor_updateOrientationMatrix_FUN_00408c10(CDemonActor * this_ptr)
