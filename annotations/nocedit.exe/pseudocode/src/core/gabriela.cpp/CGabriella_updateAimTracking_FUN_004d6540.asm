...
;   undefined4 g_GabriellaIndices[6]
...
section .text
    ...
    PUSH EBX                            ; 004d6540
        ;   Label: core_gabriela.cpp_CGabriella_updateAimTracking_FUN_004d6540
    PUSH ESI                            ; 004d6541
    PUSH EDI                            ; 004d6542
    PUSH EBP                            ; 004d6543
    ...
    CMP ESI,dword ptr [EAX + 0x14d154]  ; 004d6749 | g_CDemonSetInstance.actor_count
    JGE 0x004d67c5                      ; 004d674f
        ;   XREF to: 004d67c5 (CONDITIONAL_JUMP)  ; LAB_004d67c5
    MOV ESI,dword ptr [EDI + EAX*0x1 + 0x14d158] ; 004d6755 | g_CDemonSetInstance.actors[0] | g_CDemonSetInstance.actors[1]
    ...
    PUSH ESI                            ; 004d676b
    PUSH EBX                            ; 004d676c
    CALL core_gabriela.cpp_CGabriella_scoreTargetVisibility_FUN_004d6260 ; 004d676d
        ;   XREF to: 004d6260 (UNCONDITIONAL_CALL)  ; float core_gabriela.cpp_CGabriella_scoreTargetVisibility_FUN_004d6260(CGabriella * this_ptr, CDemonActor * target_actor, int use_wider_fov)
    ...
    MOV ECX,dword ptr [0x02d7b860]      ; 004d6879 | g_GabriellaIndices[6]
    PUSH ECX                            ; 004d687f
