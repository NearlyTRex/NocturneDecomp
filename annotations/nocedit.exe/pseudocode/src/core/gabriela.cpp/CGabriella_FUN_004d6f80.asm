...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_gabriela_cpp_CGabriella_FUN_004d6f80(CGabriella *this_ptr)
;
; Parameters:
...
;
; XREF[1]:
;   core_gabriela.cpp_CGabriella_FUN_004d6d40 at 004d6ee6
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004d6f80
        ;   Label: core_gabriela.cpp_CGabriella_FUN_004d6f80
    PUSH ESI                            ; 004d6f81
    PUSH EDI                            ; 004d6f82
    PUSH EBP                            ; 004d6f83
