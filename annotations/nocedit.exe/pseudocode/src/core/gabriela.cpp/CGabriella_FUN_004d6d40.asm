...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_gabriela_cpp_CGabriella_FUN_004d6d40(CGabriella *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004d6d40
        ;   Label: core_gabriela.cpp_CGabriella_FUN_004d6d40
    PUSH ESI                            ; 004d6d41
    PUSH EDI                            ; 004d6d42
    PUSH EBP                            ; 004d6d43
    ...
    PUSH EBX                            ; 004d6e76
    CALL core_gabriela.cpp_CGabriella_FUN_004d6f80 ; 004d6e77
        ;   XREF to: 004d6f80 (UNCONDITIONAL_CALL)  ; void core_gabriela.cpp_CGabriella_FUN_004d6f80(CGabriella * this_ptr)
    ...
    PUSH EBX                            ; 004d6ee5
    CALL core_gabriela.cpp_CGabriella_FUN_004d6f80 ; 004d6ee6
        ;   XREF to: 004d6f80 (UNCONDITIONAL_CALL)  ; void core_gabriela.cpp_CGabriella_FUN_004d6f80(CGabriella * this_ptr)
