...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_gabriela.cpp_PickupSomething_FUN_004d5870()
;
; Local Variables:
...
;
; XREF[1]:
;   core_gabriela.cpp_FUN_004d2ea0 at 004d3ba1
;
; Referenced Globals:
...
section .text
    ...
    PUSH 0x6598c0                       ; 004d5882 | WatcomTypeInfo g_CVectorTypeInfo
    PUSH 0x4                            ; 004d5887
    LEA EAX,[ESP + 0xc]                 ; 004d5889
    PUSH EAX                            ; 004d588d
    MOV dword ptr [ESI + 0x1fba0],0x0   ; 004d588e
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 004d5898 | void * crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
    ...
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 004d58c6 | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
        ;   XREF to: 00408ec0 (UNCONDITIONAL_CALL)
    MOV EDX,EAX                         ; 004d58cb
    LEA EAX,[ESP + 0x1c]                ; 004d58cd
    ADD ESP,0xc                         ; 004d58d1
    CMP EAX,EDX                         ; 004d58d4
    JZ 0x004d58ec                       ; 004d58d6 | LAB_004d58ec
    ...
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 004d5915 | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
        ;   XREF to: 00408ec0 (UNCONDITIONAL_CALL)
    MOV EDX,EAX                         ; 004d591a
    LEA EAX,[ESP + 0x28]                ; 004d591c
    ADD ESP,0xc                         ; 004d5920
    CMP EAX,EDX                         ; 004d5923
    JZ 0x004d593b                       ; 004d5925 | LAB_004d593b
    ...
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 004d5959 | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
        ;   XREF to: 00408ec0 (UNCONDITIONAL_CALL)
    MOV EDX,EAX                         ; 004d595e
    LEA EAX,[ESP + 0x34]                ; 004d5960
    ADD ESP,0xc                         ; 004d5964
    CMP EAX,EDX                         ; 004d5967
    JNZ 0x004d59d7                      ; 004d5969 | LAB_004d59d7
    ...
    JMP 0x004d598c                      ; 004d59d5 | LAB_004d598c
    ...
    JMP 0x004d596b                      ; 004d59eb | LAB_004d596b
        ;   XREF to: 004d596b (UNCONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0x24b4],0x0    ; 004d59f0
        ;   Label: LAB_004d59f0
    JNZ 0x004d59c3                      ; 004d59f7 | LAB_004d59c3
    ...
    FCOMP double ptr [0x0062aff5]       ; 004d5a32 | double DOUBLE_0062aff5
    FNSTSW AX                           ; 004d5a38
    SAHF                                ; 004d5a3a
    JA 0x004d59c3                       ; 004d5a3b | LAB_004d59c3
        ;   XREF to: 004d59c3 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 004d5a5c
    SAHF                                ; 004d5a5e
    JA 0x004d59c3                       ; 004d5a5f | LAB_004d59c3
        ;   XREF to: 004d59c3 (CONDITIONAL_JUMP)
    ...
    JMP 0x004d59c3                      ; 004d5a87 | LAB_004d59c3
        ;   XREF to: 004d59c3 (UNCONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0x24b4],0x0    ; 004d5a8c
        ;   Label: LAB_004d5a8c
    JNZ 0x004d59c3                      ; 004d5a93 | LAB_004d59c3
        ;   XREF to: 004d59c3 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 004d5aa5
    PUSH EBX                            ; 004d5aa6
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 004d5aa7 | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
    ...
    FNSTSW AX                           ; 004d5ace
    SAHF                                ; 004d5ad0
    JNC 0x004d5b14                      ; 004d5ad1 | LAB_004d5b14
    ...
    FLD float ptr [ESP + 0x60]          ; 004d5afc
        ;   Label: LAB_004d5afc
    FCOMP double ptr [0x0062afed]       ; 004d5b00 | double DOUBLE_0062afed
    FNSTSW AX                           ; 004d5b06
    SAHF                                ; 004d5b08
    JA 0x004d59c3                       ; 004d5b09 | LAB_004d59c3
        ;   XREF to: 004d59c3 (CONDITIONAL_JUMP)
    JMP 0x004d59f9                      ; 004d5b0f | LAB_004d59f9
    ...
    JMP 0x004d5afc                      ; 004d5b22 | LAB_004d5afc
    ...
    JNC 0x004d5b4c                      ; 004d5b3c | LAB_004d5b4c
        ;   XREF to: 004d5b4c (CONDITIONAL_JUMP)
    CMP EAX,0x1                         ; 004d5b3e
    JZ 0x004d5a8c                       ; 004d5b41 | LAB_004d5a8c
        ;   XREF to: 004d5a8c (CONDITIONAL_JUMP)
    JMP 0x004d59c3                      ; 004d5b47 | LAB_004d59c3
        ;   XREF to: 004d59c3 (UNCONDITIONAL_JUMP)
    JBE 0x004d59f0                      ; 004d5b4c | LAB_004d59f0
        ;   Label: LAB_004d5b4c
        ;   XREF to: 004d59f0 (CONDITIONAL_JUMP)
    CMP EAX,0x3                         ; 004d5b52
    JZ 0x004d59f0                       ; 004d5b55 | LAB_004d59f0
        ;   XREF to: 004d59f0 (CONDITIONAL_JUMP)
    JMP 0x004d59c3                      ; 004d5b5b | LAB_004d59c3
        ;   XREF to: 004d59c3 (UNCONDITIONAL_JUMP)
    MOV EBX,dword ptr [ESI + 0x1fba0]   ; 004d5b60
        ;   Label: LAB_004d5b60
    TEST EBX,EBX                        ; 004d5b66
    JZ 0x004d5bc9                       ; 004d5b68 | LAB_004d5bc9
    ...
    JNC 0x004d5c06                      ; 004d5baa | LAB_004d5c06
        ;   XREF to: 004d5c06 (CONDITIONAL_JUMP)
    CMP ESI,0x1                         ; 004d5bac
    JNZ 0x004d5bd9                      ; 004d5baf | LAB_004d5bd9
        ;   XREF to: 004d5bd9 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 004d5bb1
    PUSH 0xe                            ; 004d5bb2
    PUSH EAX                            ; 004d5bb4
        ;   Label: LAB_004d5bb4
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 004d5bb5 | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
    ...
    XOR EAX,EAX                         ; 004d5bc9
        ;   Label: LAB_004d5bc9
    JMP 0x004d5bc2                      ; 004d5bcb | LAB_004d5bc2
        ;   XREF to: 004d5bc2 (UNCONDITIONAL_JUMP)
    PUSH 0x1                            ; 004d5bcd
        ;   Label: LAB_004d5bcd
    PUSH 0xf                            ; 004d5bcf
    JMP 0x004d5bb4                      ; 004d5bd1 | LAB_004d5bb4
        ;   XREF to: 004d5bb4 (UNCONDITIONAL_JUMP)
    PUSH 0x1                            ; 004d5bd3
        ;   Label: LAB_004d5bd3
    PUSH 0x4                            ; 004d5bd5
    JMP 0x004d5bb4                      ; 004d5bd7 | LAB_004d5bb4
        ;   XREF to: 004d5bb4 (UNCONDITIONAL_JUMP)
    MOV EDI,dword ptr [ESP + 0x98]      ; 004d5bd9
        ;   Label: LAB_004d5bd9
    PUSH EDI                            ; 004d5be0
    MOV EBX,0x62afaf                    ; 004d5be1 | = "..\\core\\gabriela.cpp" | s_core_gabriela_cpp_0062afaf = ..\core\gabriela.cpp
    MOV ESI,0x638                       ; 004d5be6
    PUSH 0x62afc4                       ; 004d5beb | = "Hell froze - invalid pickUpType: %d" | s_Hell_froze_invalid_pickU_0062afc4 = Hell froze - invalid pickUpType: %d
    MOV dword ptr [0x02f0ca48],EBX      ; 004d5bf0 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 004d5bf6 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004d5bfc | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004d5c01
    JMP 0x004d5bbd                      ; 004d5c04 | LAB_004d5bbd
        ;   XREF to: 004d5bbd (UNCONDITIONAL_JUMP)
    JBE 0x004d5bcd                      ; 004d5c06 | LAB_004d5bcd
        ;   Label: LAB_004d5c06
        ;   XREF to: 004d5bcd (CONDITIONAL_JUMP)
    CMP ESI,0x3                         ; 004d5c08
    JZ 0x004d5bd3                       ; 004d5c0b | LAB_004d5bd3
        ;   XREF to: 004d5bd3 (CONDITIONAL_JUMP)
    JMP 0x004d5bd9                      ; 004d5c0d | LAB_004d5bd9
