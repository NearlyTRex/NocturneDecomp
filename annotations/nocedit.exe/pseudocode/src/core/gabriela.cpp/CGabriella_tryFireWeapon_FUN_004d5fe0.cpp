// Name: core_gabriela.cpp_CGabriella_tryFireWeapon_FUN_004d5fe0
// Address: 004d5fe0
// Address Range: [[004d5fe0, 004d604a]]
// Convention: __cdecl
// Signature: void __cdecl core_gabriela_cpp_CGabriella_tryFireWeapon_FUN_004d5fe0(CGabriella *this_ptr)
...

{
  ...
  iVar1 = (*(((this_ptr_00->base).vtable._uw)->_uw).fire)(this_ptr_00);
