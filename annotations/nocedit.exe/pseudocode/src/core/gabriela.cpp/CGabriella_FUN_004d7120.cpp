...
// Convention: __cdecl
// Signature: void __cdecl core_gabriela_cpp_CGabriella_FUN_004d7120(CGabriella *this_ptr)
...

{
  ...
  local_18 = 0.0;
  local_1c = 0.0;
  pCVar1 = (CLightActor *)core_actor_cpp_castToClassHash_FUN_0040c790(actor_ptr,g_CLightActorClassInfo.name_hash);
