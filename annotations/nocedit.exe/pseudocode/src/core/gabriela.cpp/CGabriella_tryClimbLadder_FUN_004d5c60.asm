...
section .text
    ...
    PUSH EBX                            ; 004d5c60
        ;   Label: core_gabriela.cpp_CGabriella_tryClimbLadder_FUN_004d5c60
    PUSH ESI                            ; 004d5c61
    PUSH EDI                            ; 004d5c62
    PUSH EBP                            ; 004d5c63
    ...
    MOV EAX,[0x006810c8]                ; 004d5c88 | g_CDemonSetPtr
        ;   Label: LAB_004d5c88
    CMP EDI,dword ptr [EAX + 0x14d154]  ; 004d5c8d | g_CDemonSetInstance.actor_count
    ...
    PUSH EDX                            ; 004d5cc1
    MOV EAX,dword ptr [EAX + 0x14d158]  ; 004d5cc2 | g_CDemonSetInstance.actors[0]
    PUSH EAX                            ; 004d5cc8
    ...
    PUSH EAX                            ; 004d5d86
    CALL core_vecdir.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 004d5d87
    ...
    PUSH EAX                            ; 004d5e59
    CALL core_vecdir.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 004d5e5a
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)  ; CVector3f * core_vecdir.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
    ...
    CALL core_vecdir.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 004d5f3e
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)  ; CVector3f * core_vecdir.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
