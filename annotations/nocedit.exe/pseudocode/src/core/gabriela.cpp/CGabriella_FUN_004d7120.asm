...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_gabriela.cpp_CGabriella_FUN_004d7120(CGabriella * this_ptr)
;
; Parameters:
...
section .text
    ...
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 004d7188 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004d718d
    MOV ESI,EAX                         ; 004d7190
    TEST EAX,EAX                        ; 004d7192
    JNZ 0x004d72da                      ; 004d7194 | LAB_004d72da
        ;   XREF to: 004d72da (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [EBP + 0x14]      ; 004d719a
        ;   Label: LAB_004d719a
    TEST EDI,EDI                        ; 004d719d
    JNZ 0x004d751b                      ; 004d719f | LAB_004d751b
    ...
    JZ 0x004d71eb                       ; 004d71cf | LAB_004d71eb
    ...
    PUSH EAX                            ; 004d7211
    CALL core_xform.cpp_transformVector3x4InPlace_FUN_005f4e20 ; 004d7212 | CVector3f * core_xform.cpp_transformVector3x4InPlace_FUN_005f4e20(CVector3f * input_output_vector, CMatrix3x4f * matrix)
    ...
    PUSH EAX                            ; 004d722e
    CALL core_xform.cpp_buildMatrixFromEulerAndPositionDirect_FUN_005f54c0 ; 004d722f | void core_xform.cpp_buildMatrixFromEulerAndPositionDirect_FUN_005f54c0(CMatrix3x4f * output_matrix, CVector3f * position, CVector3f * euler_angles)
    ...
    CALL core_xform.cpp_transformVector3x4_FUN_005f4dc0 ; 004d7252 | CVector3f * core_xform.cpp_transformVector3x4_FUN_005f4dc0(CVector3f * output_vector, CVector3f * input_vector, CMatrix3x4f * matrix)
    ...
    FLD float ptr [0x0062b145]          ; 004d7304 | float FLOAT_0062b145
    FXCH                                ; 004d730a
    FMUL ST1                            ; 004d730c
    ...
    JZ 0x004d7395                       ; 004d7369 | LAB_004d7395
    ...
    CALL core_xform.cpp_multiplyMatrix3x4_FUN_005f4f10 ; 004d741c | CMatrix3x4f * core_xform.cpp_multiplyMatrix3x4_FUN_005f4f10(CMatrix3x4f * output_matrix, CMatrix3x4f * matrix_a, CMatrix3x4f * matrix_b)
    ...
    CALL core_xform.cpp_matrixToEulerAngles_FUN_005f5690 ; 004d743f | CVector3f * core_xform.cpp_matrixToEulerAngles_FUN_005f5690(CVector3f * euler_out, CMatrix3x3f * matrix_ptr)
    ...
    JZ 0x004d7471                       ; 004d7452 | LAB_004d7471
    ...
    FLD float ptr [ESP + 0xf8]          ; 004d7471
        ;   Label: LAB_004d7471
    FMUL double ptr [0x0062b14d]        ; 004d7478 | double DOUBLE_0062b14d
    FLD float ptr [ESP + 0x104]         ; 004d747e
    FMUL double ptr [0x0062b155]        ; 004d7485 | double DOUBLE_0062b155
    FADDP                               ; 004d748b
    FSTP float ptr [ESP + 0x17c]        ; 004d748d
    JMP 0x004d719a                      ; 004d7494 | LAB_004d719a
        ;   XREF to: 004d719a (UNCONDITIONAL_JUMP)
    CMP ECX,EDX                         ; 004d7499
        ;   Label: LAB_004d7499
    JNZ 0x004d74c6                      ; 004d749b | LAB_004d74c6
        ;   XREF to: 004d74c6 (CONDITIONAL_JUMP)
    PUSH 0x3fc90fdb                     ; 004d749d
    LEA ESI,[ESP + 0x94]                ; 004d74a2
    LEA EDI,[ESP + 0xc4]                ; 004d74a9
    CALL core_xform.cpp_buildRotationY_FUN_005f6cc0 ; 004d74b0 | void core_xform.cpp_buildRotationY_FUN_005f6cc0(CMatrix3x4f * output_matrix, float angle_radians)
        ;   XREF to: 005f6cc0 (UNCONDITIONAL_CALL)
    MOV ECX,0xc                         ; 004d74b5
    LEA ESI,[ESP + 0x94]                ; 004d74ba
    JMP 0x004d73e5                      ; 004d74c1 | LAB_004d73e5
        ;   XREF to: 004d73e5 (UNCONDITIONAL_JUMP)
    LEA EAX,[ESP + 0xc0]                ; 004d74c6
        ;   Label: LAB_004d74c6
    PUSH EAX                            ; 004d74cd
    CALL core_xform.cpp_setIdentityMatrix3x4_FUN_005f5100 ; 004d74ce | void core_xform.cpp_setIdentityMatrix3x4_FUN_005f5100(CMatrix3x4f * matrix)
        ;   XREF to: 005f5100 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004d74d3
    JMP 0x004d73ea                      ; 004d74d6 | LAB_004d73ea
        ;   XREF to: 004d73ea (UNCONDITIONAL_JUMP)
    CMP EDX,0x3                         ; 004d74db
        ;   Label: LAB_004d74db
    JNZ 0x004d74f3                      ; 004d74de | LAB_004d74f3
        ;   XREF to: 004d74f3 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x100]     ; 004d74e0
    MOV dword ptr [ESP + 0x178],EAX     ; 004d74e7
    JMP 0x004d719a                      ; 004d74ee | LAB_004d719a
        ;   XREF to: 004d719a (UNCONDITIONAL_JUMP)
    PUSH ESI                            ; 004d74f3
        ;   Label: LAB_004d74f3
    MOV EAX,0x62b10d                    ; 004d74f4 | = "..\\core\\gabriela.cpp" | s_core_gabriela_cpp_0062b10d = ..\core\gabriela.cpp
    MOV EDX,0x945                       ; 004d74f9
    PUSH 0x62b122                       ; 004d74fe | = "Don't know how to carry light %s" | s_Don_t_know_how_to_carry__0062b122 = Don't know how to carry light %s
    MOV [0x02f0ca48],EAX                ; 004d7503 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 004d7508 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004d750e | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004d7513
    JMP 0x004d719a                      ; 004d7516 | LAB_004d719a
        ;   XREF to: 004d719a (UNCONDITIONAL_JUMP)
    CMP EDI,0x1                         ; 004d751b
        ;   Label: LAB_004d751b
    JNZ 0x004d756e                      ; 004d751e | LAB_004d756e
    ...
    JZ 0x004d71eb                       ; 004d754c | LAB_004d71eb
        ;   XREF to: 004d71eb (CONDITIONAL_JUMP)
    ...
    JMP 0x004d71eb                      ; 004d7569 | LAB_004d71eb
    ...
    JMP 0x004d71eb                      ; 004d7585 | LAB_004d71eb
        ;   XREF to: 004d71eb (UNCONDITIONAL_JUMP)
