...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_gabriela_cpp_CGabriella_load_FUN_004d6090(void)
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004d6095
    CALL core_hero.cpp_CHero_serialize_FUN_004f2610 ; 004d6096
    ...
    PUSH EAX                            ; 004d60b9
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 004d60ba
    ...
    PUSH EAX                            ; 004d60cd
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 004d60ce
        ;   XREF to: 0040b870 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeActor_FUN_0040b870(CDemonActor * actor_ptr, char * property_name)
    ADD ESP,0x8                         ; 004d60d3
    PUSH 0x62b03f                       ; 004d60d6 | = "leverToPull"
    LEA EAX,[EBX + 0x1fba8]             ; 004d60db
    PUSH EAX                            ; 004d60e1
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 004d60e2
        ;   XREF to: 0040b870 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeActor_FUN_0040b870(CDemonActor * actor_ptr, char * property_name)
    ADD ESP,0x8                         ; 004d60e7
    PUSH 0x62b04b                       ; 004d60ea | = "ladderToClimb"
    LEA EAX,[EBX + 0x1fbac]             ; 004d60ef
    PUSH EAX                            ; 004d60f5
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 004d60f6
        ;   XREF to: 0040b870 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeActor_FUN_0040b870(CDemonActor * actor_ptr, char * property_name)
    ...
    PUSH EAX                            ; 004d6114
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 004d6115
        ;   XREF to: 0040b870 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeActor_FUN_0040b870(CDemonActor * actor_ptr, char * property_name)
    ADD ESP,0x8                         ; 004d611a
    PUSH 0x62b067                       ; 004d611d | = "rhCarryObject"
    ADD EBX,0x24f8                      ; 004d6122
    PUSH EBX                            ; 004d6128
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 004d6129
        ;   XREF to: 0040b870 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeActor_FUN_0040b870(CDemonActor * actor_ptr, char * property_name)
