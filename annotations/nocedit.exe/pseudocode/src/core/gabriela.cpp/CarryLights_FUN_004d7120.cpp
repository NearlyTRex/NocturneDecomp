// Name: core_gabriela.cpp_CarryLights_FUN_004d7120
// Address: 004d7120
// Address Range: [[004d7120, 004d7589]]
// Convention: unknown
// Signature: undefined core_gabriela.cpp_CarryLights_FUN_004d7120()
// Globals:
...
/* Signature: undefined1 actors_hero_gabriella.cpp_CarryLights(undefined4 param_1, undefined4
   param_2) */

void core_gabriela_cpp_CarryLights_FUN_004d7120
...

{
  ...
  bVar6 = 0;
  iVar1 = (int)param_6 * 0x44 + (int)param_5;
  actor_ptr = *(CDemonActor **)(iVar1 + 0x24b4);
  local_10 = *(float *)(iVar1 + 0x24ac);
  local_50 = 0;
  local_54 = 0;
  local_58 = 0;
  local_14 = 0.0;
  ...
  fStack_68 = unaff_EDI * FLOAT_0062b145;
  if ((float *)&stack0xfffffffc != &local_70) {
    param_5 = fStack_68;
    unaff_EBX = local_70;
  }
  iVar1 = pCVar2[4].scale.y;
  if (iVar1 == 2) goto LAB_004d719a;
  if (iVar1 != 1) {
    if (iVar1 != 3) {
...
LAB_004d73e5:
  ...
  core_xform_cpp_multiplyMatrix3x4_FUN_005f4f10
            ((CMatrix3x4f *)auStack_bc,(CMatrix3x4f *)((int)param_5 * 0x31 + 0xfd8),matrix);
  puVar4 = auStack_118;
  ...
  if ((CVector3f *)local_3c != pCVar3) {
    local_3c._0_4_ = pCVar3->x;
    local_3c._4_4_ = pCVar3->y;
    local_34._0_4_ = pCVar3->z;
  }
  param_6 = local_70 * (float)DOUBLE_0062b155 + local_7c * (float)DOUBLE_0062b14d;
LAB_004d719a:
  if (param_6 == 0.0) {
    CStack_4c.z = param_6;
    CStack_4c.y = -0.4;
  ...
  core_xform_cpp_transformVector3x4InPlace_FUN_005f4e20
            ((CVector3f *)(local_34 + 0x1c),
             (CMatrix3x4f *)((int)param_7 * 0x30 + (int)param_5 + 0xfd8));
  ...
  pCVar3 = core_xform_cpp_transformVector3x4_FUN_005f4dc0
                     (&CStack_4c,(CVector3f *)&param_6,(CMatrix3x4f *)(auStack_140 + 4));
  local_34._28_4_ = unaff_EBP - pCVar3->x;
  local_14 = unaff_EDI - pCVar3->y;
  local_10 = unaff_EBX - pCVar3->z;
...
// Assembly code:
// 004d7120: PUSH EBX
//   Label: core_gabriela.cpp_CarryLights_FUN_004d7120
// 004d7121: PUSH EDI
// 004d7122: PUSH EBP
