...
section .text
    ...
    JNZ 0x004d769d                      ; 004d766a | LAB_004d769d
        ;   XREF to: 004d769d (CONDITIONAL_JUMP)
    PUSH 0x0                            ; 004d766c
    ADD EBX,0x1fc14                     ; 004d766e
    PUSH EBX                            ; 004d7674
    CALL core_cloth.cpp_CallToUnknownSomethingFreeMem_FUN_00438c00 ; 004d7675 | undefined core_cloth.cpp_CallToUnknownSomethingFreeMem_FUN_00438c00()
        ;   XREF to: 00438c00 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004d767a
    PUSH 0x1                            ; 004d767d
    LEA EBX,[EAX + 0xfffe03ec]          ; 004d767f
    PUSH EBX                            ; 004d7685
    CALL core_hero.cpp_CHero_dtor_FUN_004f2470 ; 004d7686 | void core_hero.cpp_CHero_dtor_FUN_004f2470(CHero * this_ptr, uint d1, uint d2, uint d3, ...)
    ...
    JNZ 0x004d76b8                      ; 004d7697 | LAB_004d76b8
        ;   XREF to: 004d76b8 (CONDITIONAL_JUMP)
    MOV EAX,EBX                         ; 004d7699
    POP EBX                             ; 004d769b
    RET                                 ; 004d769c
    PUSH 0x65e970                       ; 004d769d | WatcomTypeInfo g_CGabriellaTypeInfo
        ;   Label: LAB_004d769d
    PUSH EBX                            ; 004d76a2
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 004d76a3 | void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004d76a8
    PUSH EAX                            ; 004d76ab
    CALL crt_memory.c_free_FUN_005fe659 ; 004d76ac | void crt_memory.c_free_FUN_005fe659(void * ptr)
    ...
    PUSH EAX                            ; 004d76b8
        ;   Label: LAB_004d76b8
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 004d76b9 | void shape_memdbg.cpp_debugFree_FUN_0050f210(void * ptr)
