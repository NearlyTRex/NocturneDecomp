...
section .text
    ...
    PUSH EAX                            ; 005ea533
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 005ea534
    ...
    PUSH EAX                            ; 005ea5d6
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 005ea5d7
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    PUSH EAX                            ; 005ea67b
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 005ea67c
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    PUSH EAX                            ; 005ea71d
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 005ea71e
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    PUSH 0x684678                       ; 005ea75b | g_WaterRenderQuad
    ...
    PUSH 0x684678                       ; 005ea7bc | g_WaterRenderQuad
    ...
    PUSH 0x684678                       ; 005ea7e0 | g_WaterRenderQuad
    ...
    JMP 0x005ea76c                      ; 005ea7f0
        ;   XREF to: 005ea76c (UNCONDITIONAL_JUMP)  ; LAB_005ea76c
    PUSH 0x684678                       ; 005ea7f5 | g_WaterRenderQuad
        ;   Label: LAB_005ea7f5
