...
section .text
    ...
    FLD double ptr [0x006571af]         ; 005e9dcb | double DOUBLE_006571af
    FILD dword ptr [ESP + 0x4]          ; 005e9dd1
    FMUL ST1                            ; 005e9dd5
    MOV EAX,dword ptr [ESP + 0xc]       ; 005e9dd7
    FMUL double ptr [0x006571b7]        ; 005e9ddb | double DOUBLE_006571b7
    MOV dword ptr [ESP + 0x4],EAX       ; 005e9de1
    FILD dword ptr [ESP + 0x4]          ; 005e9de5
    FMULP ST2                           ; 005e9de9
    FADDP                               ; 005e9deb
    FADD float ptr [0x03f8f630]         ; 005e9ded | float g_WaterAnimationPhase
    FSIN                                ; 005e9df3
    FMUL double ptr [0x006571bf]        ; 005e9df5 | double DOUBLE_006571bf
