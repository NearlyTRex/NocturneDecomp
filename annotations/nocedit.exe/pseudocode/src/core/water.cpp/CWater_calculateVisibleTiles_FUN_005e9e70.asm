...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_water.cpp_CWater_calculateVisibleTiles_FUN_005e9e70(CWater * this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV CL,byte ptr [ESI + EAX*0x1 + 0x2cf901f] ; 005e9e8e | uchar[32768] g_ColorCubeLookup
    ADD EBX,0x400                       ; 005e9e95
    MOV byte ptr [EAX + 0x3f8f607],CL   ; 005e9e9b | undefined1 DAT_03f8f608 | DAT_03f8f609
    CMP EAX,0x20                        ; 005e9ea1
    JL 0x005e9e87                       ; 005e9ea4 | LAB_005e9e87
    ...
    JNZ 0x005e9ed1                      ; 005e9eb6 | LAB_005e9ed1
    ...
    LEA EAX,[ESP + 0x70]                ; 005e9ed1
        ;   Label: LAB_005e9ed1
    PUSH EAX                            ; 005e9ed5
    PUSH 0x3277d14                      ; 005e9ed6 | CDemonRaytrace g_CDemonRaytraceInstance
    CALL core_dtrace.cpp_CDemonRaytrace_getBBoxMin_FUN_00499b40 ; 005e9edb | CVector3f * core_dtrace.cpp_CDemonRaytrace_getBBoxMin_FUN_00499b40(CDemonRaytrace * this_ptr, CVector3f * output_vector)
        ;   XREF to: 00499b40 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005e9ee0
    LEA EAX,[ESP + 0x28]                ; 005e9ee3
    PUSH EAX                            ; 005e9ee7
    PUSH 0x3277d14                      ; 005e9ee8 | CDemonRaytrace g_CDemonRaytraceInstance
    CALL core_dtrace.cpp_CDemonRaytrace_getBBoxMax_FUN_00499b70 ; 005e9eed | CVector3f * core_dtrace.cpp_CDemonRaytrace_getBBoxMax_FUN_00499b70(CDemonRaytrace * this_ptr, CVector3f * output_vector)
        ;   XREF to: 00499b70 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005e9ef2
    FLD float ptr [ESP + 0x70]          ; 005e9ef5
    FADD float ptr [ESP + 0x28]         ; 005e9ef9
    FLD double ptr [0x00657217]         ; 005e9efd | double DOUBLE_00657217
    FXCH                                ; 005e9f03
    FMUL ST1                            ; 005e9f05
    ...
    FXCH                                ; 005e9f1d
    FMULP ST3                           ; 005e9f1f
    FMUL double ptr [0x0065721f]        ; 005e9f21 | double DOUBLE_0065721f
    ...
    FNSTSW AX                           ; 005e9f58
    SAHF                                ; 005e9f5a
    JNC 0x005e9f6b                      ; 005e9f5b | LAB_005e9f6b
    ...
    FNSTSW AX                           ; 005e9f81
    SAHF                                ; 005e9f83
    JBE 0x005e9f94                      ; 005e9f84 | LAB_005e9f94
    ...
    FMUL double ptr [0x00657217]        ; 005e9f9c | double DOUBLE_00657217
    FMUL double ptr [0x0065721f]        ; 005e9fa2 | double DOUBLE_0065721f
    FST float ptr [ESP + 0x88]          ; 005e9fa8
    FCOMP float ptr [ESP + 0x94]        ; 005e9faf
    FNSTSW AX                           ; 005e9fb6
    SAHF                                ; 005e9fb8
    JBE 0x005e9fc9                      ; 005e9fb9 | LAB_005e9fc9
    ...
    FLD1                                ; 005e9fd3
    FADDP                               ; 005e9fd5
    CALL crt_math.c_round_FUN_005fe6b0  ; 005e9fd7 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x9c]        ; 005e9fdc
    MOV EAX,dword ptr [ESP + 0x9c]      ; 005e9fe3
    XOR ESI,ESI                         ; 005e9fea
    MOV EBP,EAX                         ; 005e9fec
    MOV dword ptr [0x03f87604],ESI      ; 005e9fee | int g_VisibleWaterTileCount
    NEG EBP                             ; 005e9ff4
    MOV dword ptr [ESP + 0x98],EAX      ; 005e9ff6
    CMP EBP,EAX                         ; 005e9ffd
    JGE 0x005ea22f                      ; 005e9fff | LAB_005ea22f
    ...
    JGE 0x005ea21f                      ; 005ea017 | LAB_005ea21f
    ...
    MOV ECX,dword ptr [0x006703ec]      ; 005ea04a | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    ...
    PUSH ECX                            ; 005ea083 | CDemonRenderer g_CDemonRendererInstance
    FSTP float ptr [ESP + 0x74]         ; 005ea084
    CALL engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450 ; 005ea088 | void engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450(CDemonRenderer * this_ptr, CVector3f * world_position)
        ;   XREF to: 0048c450 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005ea08d
    LEA EBX,[ESP + 0x40]                ; 005ea090
    LEA EAX,[ESP + 0x64]                ; 005ea094
    FLD float ptr [EAX]                 ; 005ea098
    FMUL float ptr [0x006652cc]         ; 005ea09a | float FLOAT_006652cc
    FISTP dword ptr [EBX]               ; 005ea0a0
    FLD float ptr [EAX + 0x4]           ; 005ea0a2
    FMUL float ptr [0x006652cc]         ; 005ea0a5 | float FLOAT_006652cc
    FISTP dword ptr [EBX + 0x4]         ; 005ea0ab
    FLD float ptr [EAX + 0x8]           ; 005ea0ae
    FMUL float ptr [0x006652cc]         ; 005ea0b1 | float FLOAT_006652cc
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 005ea0d0 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    FLD float ptr [EAX]                 ; 005ea0d6
    FMUL float ptr [0x006652cc]         ; 005ea0d8 | float FLOAT_006652cc
    FISTP dword ptr [EBX]               ; 005ea0de
    FLD float ptr [EAX + 0x4]           ; 005ea0e0
    FMUL float ptr [0x006652cc]         ; 005ea0e3 | float FLOAT_006652cc
    FISTP dword ptr [EBX + 0x4]         ; 005ea0e9
    FLD float ptr [EAX + 0x8]           ; 005ea0ec
    FMUL float ptr [0x006652cc]         ; 005ea0ef | float FLOAT_006652cc
    FISTP dword ptr [EBX + 0x8]         ; 005ea0f5
    LEA EAX,[ESP + 0x58]                ; 005ea0f8
    PUSH EAX                            ; 005ea0fc
    MOV EAX,dword ptr [EDX]             ; 005ea0fd | CDemonRenderer g_CDemonRendererInstance
    PUSH EAX                            ; 005ea0ff
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 005ea100 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 005ea117 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    FLD float ptr [EAX]                 ; 005ea11d
    FMUL float ptr [0x006652cc]         ; 005ea11f | float FLOAT_006652cc
    FISTP dword ptr [EBX]               ; 005ea125
    FLD float ptr [EAX + 0x4]           ; 005ea127
    FMUL float ptr [0x006652cc]         ; 005ea12a | float FLOAT_006652cc
    FISTP dword ptr [EBX + 0x4]         ; 005ea130
    FLD float ptr [EAX + 0x8]           ; 005ea133
    FMUL float ptr [0x006652cc]         ; 005ea136 | float FLOAT_006652cc
    FISTP dword ptr [EBX + 0x8]         ; 005ea13c
    LEA EAX,[ESP + 0x34]                ; 005ea13f
    PUSH EAX                            ; 005ea143
    MOV EAX,dword ptr [EDX]             ; 005ea144 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0x30                        ; 005ea146
    PUSH EAX                            ; 005ea149
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 005ea14a | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 005ea161 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    FLD float ptr [EAX]                 ; 005ea167
    FMUL float ptr [0x006652cc]         ; 005ea169 | float FLOAT_006652cc
    FISTP dword ptr [EBX]               ; 005ea16f
    FLD float ptr [EAX + 0x4]           ; 005ea171
    FMUL float ptr [0x006652cc]         ; 005ea174 | float FLOAT_006652cc
    FISTP dword ptr [EBX + 0x4]         ; 005ea17a
    FLD float ptr [EAX + 0x8]           ; 005ea17d
    FMUL float ptr [0x006652cc]         ; 005ea180 | float FLOAT_006652cc
    FISTP dword ptr [EBX + 0x8]         ; 005ea186
    LEA EAX,[ESP + 0x7c]                ; 005ea189
    PUSH EAX                            ; 005ea18d
    MOV EAX,dword ptr [EDX]             ; 005ea18e | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0x60                        ; 005ea190
    PUSH EAX                            ; 005ea193
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 005ea194 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    LEA EBX,[ESP + 0x54]                ; 005ea199
    LEA EAX,[ESP + 0x6c]                ; 005ea19d
    ADD ESP,0x8                         ; 005ea1a1
    XOR ECX,ECX                         ; 005ea1a4
    MOV EDX,dword ptr [0x006703ec]      ; 005ea1a6 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    MOV dword ptr [ESP + 0x64],ECX      ; 005ea1ac
    FLD float ptr [EAX]                 ; 005ea1b0
    FMUL float ptr [0x006652cc]         ; 005ea1b2 | float FLOAT_006652cc
    FISTP dword ptr [EBX]               ; 005ea1b8
    FLD float ptr [EAX + 0x4]           ; 005ea1ba
    FMUL float ptr [0x006652cc]         ; 005ea1bd | float FLOAT_006652cc
    FISTP dword ptr [EBX + 0x4]         ; 005ea1c3
    FLD float ptr [EAX + 0x8]           ; 005ea1c6
    FMUL float ptr [0x006652cc]         ; 005ea1c9 | float FLOAT_006652cc
    FISTP dword ptr [EBX + 0x8]         ; 005ea1cf
    LEA EAX,[ESP + 0x4c]                ; 005ea1d2
    PUSH EAX                            ; 005ea1d6
    MOV EAX,dword ptr [EDX]             ; 005ea1d7 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0x90                        ; 005ea1d9
    PUSH EAX                            ; 005ea1de
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 005ea1df | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ...
    JZ 0x005ea26a                       ; 005ea209 | LAB_005ea26a
        ;   XREF to: 005ea26a (CONDITIONAL_JUMP)
    TEST AL,0xff                        ; 005ea20b
    JZ 0x005ea26a                       ; 005ea20d | LAB_005ea26a
        ;   XREF to: 005ea26a (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [ESP + 0x9c]      ; 005ea20f
        ;   Label: LAB_005ea20f
    INC ESI                             ; 005ea216
    CMP ESI,EDX                         ; 005ea217
    JL 0x005ea01d                       ; 005ea219 | LAB_005ea01d
        ;   XREF to: 005ea01d (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [ESP + 0x98]      ; 005ea21f
        ;   Label: LAB_005ea21f
    INC EBP                             ; 005ea226
    CMP EBP,EDX                         ; 005ea227
    JL 0x005ea005                       ; 005ea229 | LAB_005ea005
        ;   XREF to: 005ea005 (CONDITIONAL_JUMP)
    FILD dword ptr [0x03f87604]         ; 005ea22f | int g_VisibleWaterTileCount
        ;   Label: LAB_005ea22f
    FMUL float ptr [EDI + 0x8]          ; 005ea235
    FMUL float ptr [EDI + 0x8]          ; 005ea238
    SUB ESP,0x8                         ; 005ea23b
    MOV ECX,dword ptr [0x03f87604]      ; 005ea23e | int g_VisibleWaterTileCount
    FST float ptr [EDI + 0xc]           ; 005ea244
    FSTP double ptr [ESP]               ; 005ea247
    PUSH ECX                            ; 005ea24a
    PUSH 0x6571f7                       ; 005ea24b | = "Vis water tiles : %d, SqFt : %f" | s_Vis_water_tiles_d_SqFt_f_006571f7 = Vis water tiles : %d, SqFt : %f
    MOV EBX,dword ptr [0x0066e8e0]      ; 005ea250 | CConsole g_ConsolePtr | CConsole * g_CConsolePtr
    PUSH EBX                            ; 005ea256 | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 005ea257 | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
    ...
    MOV EBX,dword ptr [0x006703f0]      ; 005ea29c | int g_RenderPixelBudget
    MOV [0x006703f0],EAX                ; 005ea2a2 | int g_RenderPixelBudget
    MOV EAX,ESP                         ; 005ea2a7
    MOV dword ptr [ESP + 0x1c],EDX      ; 005ea2a9
    PUSH EAX                            ; 005ea2ad
    MOV EDX,dword ptr [0x006703ec]      ; 005ea2ae | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    MOV ECX,0x2                         ; 005ea2b4
    PUSH EDX                            ; 005ea2b9 | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [ESP + 0x28],ECX      ; 005ea2ba
    CALL engine_drender.cpp_CDemonRenderer_renderTexturedBasic_FUN_0048ab50 ; 005ea2be | int engine_drender.cpp_CDemonRenderer_renderTexturedBasic_FUN_0048ab50(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * prim)
        ;   XREF to: 0048ab50 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005ea2c3
    TEST EAX,EAX                        ; 005ea2c6
    JZ 0x005ea314                       ; 005ea2c8 | LAB_005ea314
        ;   XREF to: 005ea314 (CONDITIONAL_JUMP)
    CMP dword ptr [0x03f87604],0x1000   ; 005ea2ca | int g_VisibleWaterTileCount
    JL 0x005ea2f8                       ; 005ea2d4 | LAB_005ea2f8
        ;   XREF to: 005ea2f8 (CONDITIONAL_JUMP)
    MOV EAX,0x6571c7                    ; 005ea2d6 | = "..\\core\\water.cpp" | s_core_water_cpp_006571c7 = ..\core\water.cpp
    MOV EDX,0x136                       ; 005ea2db
    PUSH 0x6571d9                       ; 005ea2e0 | = "Too many visible water tiles!" | s_Too_many_visible_water_t_006571d9 = Too many visible water tiles!
    MOV [0x02f0ca48],EAX                ; 005ea2e5 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 005ea2ea | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005ea2f0 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005ea2f5
    MOV EAX,[0x03f87604]                ; 005ea2f8 | int g_VisibleWaterTileCount
        ;   Label: LAB_005ea2f8
    LEA ECX,[EAX + 0x1]                 ; 005ea2fd
    MOV dword ptr [EAX*0x4 + 0x3f87608],EBP ; 005ea300 | int[4096] g_VisibleWaterTilesX
    MOV dword ptr [EAX*0x4 + 0x3f8b608],ESI ; 005ea307 | int[4096] g_VisibleWaterTilesY
    MOV dword ptr [0x03f87604],ECX      ; 005ea30e | int g_VisibleWaterTileCount
    MOV dword ptr [0x006703f0],EBX      ; 005ea314 | int g_RenderPixelBudget
        ;   Label: LAB_005ea314
    JMP 0x005ea20f                      ; 005ea31a | LAB_005ea20f
