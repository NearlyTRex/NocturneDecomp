...
;                               FUNCTION
; *****************************************************************************
; __cdecl CTrash * __cdecl core_trash_cpp_CTrash_dtor_FUN_005df780(CTrash *this_ptr,uint flags)
;
; Parameters:
...
section .text
    ...
    PUSH 0x6649e0                       ; 005df7a6 | g_CTrashTypeInfo
        ;   Label: LAB_005df7a6
    PUSH EBX                            ; 005df7ab
    CALL crt_memory.c___vec_delete_FUN_005fe632 ; 005df7ac
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c___vec_delete_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 005df7b1
    PUSH EAX                            ; 005df7b4
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 005df7b5
