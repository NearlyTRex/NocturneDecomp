...
section .text
    ...
    MOV EDI,dword ptr [0x006703ec]      ; 005df5c6 | g_CDemonRendererPtr
    ...
    MOV EBP,dword ptr [0x006703ec]      ; 005df5e8 | g_CDemonRendererPtr
    PUSH EBP                            ; 005df5ee | g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_matrixPop_FUN_0050d720 ; 005df5ef
