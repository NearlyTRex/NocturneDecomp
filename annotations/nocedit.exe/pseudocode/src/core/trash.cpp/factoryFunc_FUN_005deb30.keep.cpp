...
// Convention: __cdecl
// Signature: CTrash * __cdecl core_trash_cpp_factoryFunc_FUN_005deb30(void)
...

{
  ...
  pCVar1 = (CTrash *)shape_memdbg_cpp_debugAllocTracked1_FUN_0050f1b0(sizeof(CTrash),"..\\core\\trash.cpp",0x43);
