...
// Convention: __cdecl
// Signature: float * __cdecl core_trash_cpp_CTrash_FUN_005df610(CTrash *this_ptr)
...

{
  ...
  *in_stack_00000008 = *in_stack_00000008 + local_20.x;
  ...
  in_stack_00000008[3] = in_stack_00000008[3] + local_20.x;
  in_stack_00000008[4] = in_stack_00000008[4] + local_20.y;
  in_stack_00000008[5] = in_stack_00000008[5] + local_20.z;
