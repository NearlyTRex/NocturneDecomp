...
// Convention: __cdecl
// Signature: void __cdecl core_trash_cpp_CTrash_FUN_005df720(CTrash *this_ptr)
...

{
  ...
  core_actor_cpp_CDemonActor_addFilesToExtract_FUN_0040cfd0(&this_ptr->base,in_stack_00000008);
