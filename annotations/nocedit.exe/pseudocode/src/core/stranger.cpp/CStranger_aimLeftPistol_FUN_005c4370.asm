...
section .text
    ...
    JZ 0x005c4715                       ; 005c4389 | LAB_005c4715
    ...
    PUSH ECX                            ; 005c43cb
    MOV EDI,dword ptr [0x03f6bad8]      ; 005c43cc | undefined4 DAT_03f6bad8
    MOV dword ptr [ESP + 0xc8],EDX      ; 005c43d2
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 005c43d9 | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
    ...
    PUSH EAX                            ; 005c4410
    CALL core_actor.cpp_CDemonActor_transformVector_FUN_00408e80 ; 005c4411 | CVector3f * core_actor.cpp_CDemonActor_transformVector_FUN_00408e80(CDemonActor * this_ptr, CVector3f * output, CVector3f * input)
        ;   XREF to: 00408e80 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005c4416
    MOV EDX,dword ptr [0x006810c8]      ; 005c4419 | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
    ...
    PUSH EDX                            ; 005c4454 | CDemonSet g_CDemonSetInstance
    FSTP float ptr [ESP + 0x74]         ; 005c4455
    CALL core_setcolid.cpp_CDemonSet_setRayTypeLaser_FUN_00574270 ; 005c4459 | void core_setcolid.cpp_CDemonSet_setRayTypeLaser_FUN_00574270(CDemonSet * this_ptr, float f1, float f2, float f3, ...)
        ;   XREF to: 00574270 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 005c445e
    MOV ECX,dword ptr [EBX + 0x1fc2c]   ; 005c4461
    PUSH ECX                            ; 005c4467
    MOV EAX,[0x006810c8]                ; 005c4468 | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
    PUSH EAX                            ; 005c446d | CDemonSet g_CDemonSetInstance
    CALL core_setcolid.cpp_CDemonSet_ignore_FUN_005741b0 ; 005c446e | void core_setcolid.cpp_CDemonSet_ignore_FUN_005741b0(CDemonSet * this_ptr, CDemonActor * actor)
        ;   XREF to: 005741b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005c4473
    LEA ESI,[EBX + 0x1fc08]             ; 005c4476
    PUSH EBX                            ; 005c447c
    MOV EDX,dword ptr [0x006810c8]      ; 005c447d | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
    PUSH EDX                            ; 005c4483 | CDemonSet g_CDemonSetInstance
    CALL core_setcolid.cpp_CDemonSet_ignore_FUN_005741b0 ; 005c4484 | void core_setcolid.cpp_CDemonSet_ignore_FUN_005741b0(CDemonSet * this_ptr, CDemonActor * actor)
        ;   XREF to: 005741b0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 005c4495
    MOV ECX,dword ptr [0x006810c8]      ; 005c4496 | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
    PUSH ECX                            ; 005c449c | CDemonSet g_CDemonSetInstance
    CALL core_setcolid.cpp_CDemonSet_raycast_FUN_00572530 ; 005c449d | float core_setcolid.cpp_CDemonSet_raycast_FUN_00572530(CDemonSet * this_ptr, CVector3f * ray_origin, CVector3f * ray_target)
    ...
    MOV EAX,[0x006810c8]                ; 005c44b3 | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
    PUSH EAX                            ; 005c44b8 | CDemonSet g_CDemonSetInstance
    FSTP float ptr [ESP + 0x30]         ; 005c44b9
    CALL core_setcolid.cpp_CDemonSet_initMaybe_FUN_00574180 ; 005c44bd | void core_setcolid.cpp_CDemonSet_initMaybe_FUN_00574180(CDemonSet * this_ptr)
    ...
    FNSTSW AX                           ; 005c44d3
    SAHF                                ; 005c44d5
    JBE 0x005c473d                      ; 005c44d6 | LAB_005c473d
    ...
    JZ 0x005c456e                       ; 005c4554 | LAB_005c456e
    ...
    PUSH EAX                            ; 005c457d
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneWorldPosition_FUN_0059fa20 ; 005c457e | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneWorldPosition_FUN_0059fa20(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
    ...
    PUSH EAX                            ; 005c4592
    PUSH EBX                            ; 005c4593
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 005c4594 | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
    ...
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 005c45ec | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
    ...
    FCOMP double ptr [0x00653d14]       ; 005c461b | double DOUBLE_00653d14
    FNSTSW AX                           ; 005c4621
    SAHF                                ; 005c4623
    JBE 0x005c4650                      ; 005c4624 | LAB_005c4650
        ;   XREF to: 005c4650 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x4c]          ; 005c4626
    FCHS                                ; 005c462a
    FSTP float ptr [ESP + 0xc8]         ; 005c462c
    JNC 0x005c4751                      ; 005c4633 | LAB_005c4751
        ;   XREF to: 005c4751 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x30]          ; 005c4639
        ;   Label: LAB_005c4639
    FST double ptr [ESP + 0x10]         ; 005c463d
    FCOMP double ptr [0x00653d14]       ; 005c4641 | double DOUBLE_00653d14
    FNSTSW AX                           ; 005c4647
    SAHF                                ; 005c4649
    JNC 0x005c47f9                      ; 005c464a | LAB_005c47f9
    ...
    FCOMP float ptr [0x00663770]        ; 005c4673 | undefined4 DAT_00663770
    FNSTSW AX                           ; 005c4679
    SAHF                                ; 005c467b
    JNC 0x005c468a                      ; 005c467c | LAB_005c468a
        ;   XREF to: 005c468a (CONDITIONAL_JUMP)
    MOV EAX,[0x00663770]                ; 005c467e | undefined4 DAT_00663770
    MOV dword ptr [ESP + 0xcc],EAX      ; 005c4683
    FLD float ptr [ESP + 0xcc]          ; 005c468a
        ;   Label: LAB_005c468a
    FCOMP float ptr [0x00663774]        ; 005c4691 | undefined4 DAT_00663774
    FNSTSW AX                           ; 005c4697
    SAHF                                ; 005c4699
    JBE 0x005c46a8                      ; 005c469a | LAB_005c46a8
        ;   XREF to: 005c46a8 (CONDITIONAL_JUMP)
    MOV EAX,[0x00663774]                ; 005c469c | undefined4 DAT_00663774
    ...
    FNSTSW AX                           ; 005c46b6
    SAHF                                ; 005c46b8
    JNC 0x005c46c9                      ; 005c46b9 | LAB_005c46c9
    ...
    FNSTSW AX                           ; 005c46d7
    SAHF                                ; 005c46d9
    JA 0x005c489c                       ; 005c46da | LAB_005c489c
    ...
    POP EBX                             ; 005c4713
    RET                                 ; 005c4714
    MOV ECX,0x653cd4                    ; 005c4715 | = "..\\core\\stranger.cpp" | s_core_stranger_cpp_00653cd4 = ..\core\stranger.cpp
        ;   Label: LAB_005c4715
    MOV ESI,0x10c0                      ; 005c471a
    PUSH 0x653ce9                       ; 005c471f | = "CStranger::aimLeftPistol - no weapon?" | s_CStranger_aimLeftPistol__00653ce9 = CStranger::aimLeftPistol - no weapon?
    MOV dword ptr [0x02f0ca48],ECX      ; 005c4724 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 005c472a | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005c4730 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005c4735
    JMP 0x005c438f                      ; 005c4738 | LAB_005c438f
    ...
    FNSTSW AX                           ; 005c4743
    SAHF                                ; 005c4745
    JC 0x005c44dc                       ; 005c4746 | LAB_005c44dc
        ;   XREF to: 005c44dc (CONDITIONAL_JUMP)
    JMP 0x005c44e4                      ; 005c474c | LAB_005c44e4
    ...
    FNSTSW AX                           ; 005c4773
    SAHF                                ; 005c4775
    JBE 0x005c4639                      ; 005c4776 | LAB_005c4639
        ;   XREF to: 005c4639 (CONDITIONAL_JUMP)
    FLDZ                                ; 005c477c
    FCOMP double ptr [ESP + 0x20]       ; 005c477e
    FNSTSW AX                           ; 005c4782
    SAHF                                ; 005c4784
    JA 0x005c4639                       ; 005c4785 | LAB_005c4639
        ;   XREF to: 005c4639 (CONDITIONAL_JUMP)
    FLD double ptr [ESP + 0x20]         ; 005c478b
    CALL crt_math.c_acos_FUN_00600162   ; 005c478f | double crt_math.c_acos_FUN_00600162(double x)
    ...
    FNSTSW AX                           ; 005c47a6
    SAHF                                ; 005c47a8
    JBE 0x005c47e9                      ; 005c47a9 | LAB_005c47e9
    ...
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 005c47c7 | float core_actor.cpp_normalizeAngleToPi_FUN_0040cd70(float angle_radians)
    ...
    FNSTSW AX                           ; 005c4819
    SAHF                                ; 005c481b
    JBE 0x005c4650                      ; 005c481c | LAB_005c4650
        ;   XREF to: 005c4650 (CONDITIONAL_JUMP)
    FLDZ                                ; 005c4822
    FCOMP double ptr [ESP + 0x8]        ; 005c4824
    FNSTSW AX                           ; 005c4828
    SAHF                                ; 005c482a
    JA 0x005c4650                       ; 005c482b | LAB_005c4650
        ;   XREF to: 005c4650 (CONDITIONAL_JUMP)
    FLD double ptr [ESP + 0x8]          ; 005c4831
    CALL crt_math.c_acos_FUN_00600162   ; 005c4835 | double crt_math.c_acos_FUN_00600162(double x)
        ;   XREF to: 00600162 (UNCONDITIONAL_CALL)
    FLDZ                                ; 005c483a
    FXCH                                ; 005c483c
    ...
    FNSTSW AX                           ; 005c4849
    SAHF                                ; 005c484b
    JBE 0x005c488c                      ; 005c484c | LAB_005c488c
