...
section .text
    ...
    PUSH EBX                            ; 005c5f10
        ;   Label: core_stranger.cpp_CStranger_handleFireButton_FUN_005c5f10
    PUSH ESI                            ; 005c5f11
    PUSH EDI                            ; 005c5f12
    PUSH EBP                            ; 005c5f13
    ...
    PUSH 0x0                            ; 005c61af
        ;   Label: LAB_005c61af
    PUSH EBX                            ; 005c61b1
    CALL core_stranger.cpp_CStranger_updateWeaponPosition_FUN_005c06b0 ; 005c61b2
    ...
    PUSH EBP                            ; 005c61f1
    PUSH EBX                            ; 005c61f2
    CALL core_stranger.cpp_CStranger_updateWeaponPosition_FUN_005c06b0 ; 005c61f3
        ;   XREF to: 005c06b0 (UNCONDITIONAL_CALL)  ; void core_stranger.cpp_CStranger_updateWeaponPosition_FUN_005c06b0(CStranger * this_ptr, int hand_index)
