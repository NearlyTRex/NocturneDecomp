...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_stranger.cpp_CStranger_FUN_005c68f0(CStranger * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH ECX                            ; 005c68f9
    CALL core_hero.cpp_CHero_FUN_004f3f20 ; 005c68fa | void core_hero.cpp_CHero_FUN_004f3f20(CHero * this_ptr)
