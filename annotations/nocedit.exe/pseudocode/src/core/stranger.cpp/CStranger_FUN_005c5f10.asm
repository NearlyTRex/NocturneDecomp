...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_stranger.cpp_CStranger_FUN_005c5f10()
;
; Local Variables:
...
section .text
    ...
    JNZ 0x005c5fe0                      ; 005c5fc4 | LAB_005c5fe0
        ;   XREF to: 005c5fe0 (CONDITIONAL_JUMP)
    CMP EBP,dword ptr [EDX + 0x1c]      ; 005c5fc6
    JZ 0x005c5fe0                       ; 005c5fc9 | LAB_005c5fe0
        ;   XREF to: 005c5fe0 (CONDITIONAL_JUMP)
    ...
    JZ 0x005c614d                       ; 005c5fe8 | caseD_6
        ;   XREF to: 005c614d (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EAX + 0x2e0]     ; 005c5fee
    CMP EAX,0x8                         ; 005c5ff4
    JA 0x005c614d                       ; 005c5ff7 | caseD_6
        ;   XREF to: 005c614d (CONDITIONAL_JUMP)
    JMP dword ptr [EAX*0x4 + 0x5c5ee4]  ; 005c5ffd | void * switchdataD_005c5ee4
        ;   Label: switchD
    ...
    FNSTSW AX                           ; 005c6052
    SAHF                                ; 005c6054
    JA 0x005c6067                       ; 005c6055 | LAB_005c6067
        ;   XREF to: 005c6067 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 005c605e
    SAHF                                ; 005c6060
    JNC 0x005c6154                      ; 005c6061 | LAB_005c6154
    ...
    CMP dword ptr [EAX + 0x2e0],0x7     ; 005c606f
        ;   Label: LAB_005c606f
    JZ 0x005c5f6e                       ; 005c6076 | LAB_005c5f6e
        ;   XREF to: 005c5f6e (CONDITIONAL_JUMP)
    JMP 0x005c5f76                      ; 005c607c | LAB_005c5f76
    ...
    JZ 0x005c5f76                       ; 005c6092 | LAB_005c5f76
    ...
    JLE 0x005c60d5                      ; 005c60ab | LAB_005c60d5
    ...
    CMP EBP,0x2                         ; 005c60d5
        ;   Label: LAB_005c60d5
    JL 0x005c60b3                       ; 005c60d8 | LAB_005c60b3
        ;   XREF to: 005c60b3 (CONDITIONAL_JUMP)
    JMP 0x005c60ad                      ; 005c60da | LAB_005c60ad
        ;   XREF to: 005c60ad (UNCONDITIONAL_JUMP)
    MOV EAX,0x1                         ; 005c60dc
        ;   Label: LAB_005c60dc
    JMP 0x005c60c3                      ; 005c60e1 | LAB_005c60c3
        ;   XREF to: 005c60c3 (UNCONDITIONAL_JUMP)
    MOV EAX,0x2                         ; 005c60e3
        ;   Label: LAB_005c60e3
    JMP 0x005c60c3                      ; 005c60e8 | LAB_005c60c3
        ;   XREF to: 005c60c3 (UNCONDITIONAL_JUMP)
    JBE 0x005c60dc                      ; 005c60ea | LAB_005c60dc
        ;   Label: LAB_005c60ea
        ;   XREF to: 005c60dc (CONDITIONAL_JUMP)
    CMP EDX,0xd                         ; 005c60ec
    JZ 0x005c60e3                       ; 005c60ef | LAB_005c60e3
        ;   XREF to: 005c60e3 (CONDITIONAL_JUMP)
    JMP 0x005c60c3                      ; 005c60f1 | LAB_005c60c3
        ;   XREF to: 005c60c3 (UNCONDITIONAL_JUMP)
    ...
    MOV EDX,ECX                         ; 005c611e
        ;   Label: LAB_005c611e
    JMP 0x005c5fbe                      ; 005c6120 | LAB_005c5fbe
        ;   XREF to: 005c5fbe (UNCONDITIONAL_JUMP)
    MOV EAX,0x4                         ; 005c6125
        ;   Label: caseD_1
    JMP 0x005c6009                      ; 005c612a | LAB_005c6009
        ;   XREF to: 005c6009 (UNCONDITIONAL_JUMP)
    MOV EAX,0x7                         ; 005c612f
        ;   Label: caseD_4
    JMP 0x005c6009                      ; 005c6134 | LAB_005c6009
        ;   XREF to: 005c6009 (UNCONDITIONAL_JUMP)
    MOV EAX,0x5                         ; 005c6139
        ;   Label: caseD_2
    JMP 0x005c6009                      ; 005c613e | LAB_005c6009
        ;   XREF to: 005c6009 (UNCONDITIONAL_JUMP)
    MOV EAX,0x8                         ; 005c6143
        ;   Label: caseD_7
    JMP 0x005c6009                      ; 005c6148 | LAB_005c6009
        ;   XREF to: 005c6009 (UNCONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 005c614d
        ;   Label: caseD_8
    JMP 0x005c6009                      ; 005c614f | LAB_005c6009
        ;   XREF to: 005c6009 (UNCONDITIONAL_JUMP)
    ...
    JZ 0x005c61af                       ; 005c61a3 | LAB_005c61af
        ;   XREF to: 005c61af (CONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0x1fc34],0x1   ; 005c61a5
    PUSH 0x0                            ; 005c61af
        ;   Label: LAB_005c61af
    PUSH EBX                            ; 005c61b1
    CALL core_stranger.cpp_CStranger_FUN_005c06b0 ; 005c61b2 | undefined core_stranger.cpp_CStranger_FUN_005c06b0()
    ...
    JNZ 0x005c6067                      ; 005c61c9 | LAB_005c6067
        ;   XREF to: 005c6067 (CONDITIONAL_JUMP)
    ...
    PUSH EBP                            ; 005c61f1
    PUSH EBX                            ; 005c61f2
    CALL core_stranger.cpp_CStranger_FUN_005c06b0 ; 005c61f3 | undefined core_stranger.cpp_CStranger_FUN_005c06b0()
        ;   XREF to: 005c06b0 (UNCONDITIONAL_CALL)
    ...
    JMP 0x005c6181                      ; 005c6211 | LAB_005c6181
