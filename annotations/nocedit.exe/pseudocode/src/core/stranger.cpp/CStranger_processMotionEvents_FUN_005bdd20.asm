...
; Local Variables:
; SDamageInfo      Stack[-0xb0]:60  local_b0
...
; CEnemy *         Stack[-0x18]:4  local_18
; float            Stack[-0x14]:4  local_14
;
; XREF[1]:
;   core_stranger.cpp_CStranger_processFrame_FUN_005bb960 at 005bbb4b
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 005bdd20
        ;   Label: core_stranger.cpp_CStranger_processMotionEvents_FUN_005bdd20
    PUSH ESI                            ; 005bdd21
    PUSH EDI                            ; 005bdd22
    PUSH EBP                            ; 005bdd23
    ...
    MOV EAX,[0x03f6baec]                ; 005bdd8e | g_StrangerIndices[8]
    PUSH EAX                            ; 005bdd93
        ;   Label: LAB_005bdd93
    ...
    CALL core_stranger.cpp_CStranger_dropRightHandObject_FUN_005c1f80 ; 005bde10
        ;   XREF to: 005c1f80 (UNCONDITIONAL_CALL)  ; void core_stranger.cpp_CStranger_dropRightHandObject_FUN_005c1f80(CStranger * this_ptr)
    ...
    PUSH 0x1                            ; 005bdf67
        ;   Label: LAB_005bdf67
    PUSH EBX                            ; 005bdf69
    CALL core_hero.cpp_CHero_executeObjectPickup_FUN_004f3890 ; 005bdf6a
    ...
    PUSH 0x1                            ; 005bdfc0
        ;   Label: LAB_005bdfc0
    PUSH EBX                            ; 005bdfc2
    CALL core_hero.cpp_CHero_addCarriedItemToInventory_FUN_004f38d0 ; 005bdfc3
    ...
    MOV EAX,[0x03f6bae8]                ; 005be001 | g_StrangerIndices[7]
        ;   Label: LAB_005be001
    ...
    MOV EDX,dword ptr [0x03f6bafc]      ; 005be14f | g_StrangerIndices[12]
    PUSH EDX                            ; 005be155
    ...
    PUSH EBX                            ; 005be2cd
        ;   Label: LAB_005be2cd
    CALL core_stranger.cpp_CStranger_processPickupComplete_FUN_005c1f00 ; 005be2ce
        ;   XREF to: 005c1f00 (UNCONDITIONAL_CALL)  ; void core_stranger.cpp_CStranger_processPickupComplete_FUN_005c1f00(CStranger * this_ptr)
    ...
    PUSH EBX                            ; 005be2fa
        ;   Label: LAB_005be2fa
    CALL core_hero.cpp_CHero_executeLeverPull_FUN_004f30f0 ; 005be2fb
    ...
    PUSH EBX                            ; 005be3a8
        ;   Label: LAB_005be3a8
    CALL core_hero.cpp_CHero_tryOpenDoor_FUN_004f2ed0 ; 005be3a9
