...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_stranger_cpp_CStranger_writeDependencies_FUN_005c6910(CStranger *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x8]       ; 005c6910
        ;   Label: core_stranger.cpp_CStranger_writeDependencies_FUN_005c6910
    PUSH EDX                            ; 005c6914
    MOV ECX,dword ptr [ESP + 0x8]       ; 005c6915
    PUSH ECX                            ; 005c6919
    CALL core_hero.cpp_CHero_writeDependencies_FUN_004f3fa0 ; 005c691a
