...
; CActorDestination * Stack[-0x30]:4  local_30
; CActorDestination * Stack[-0x2c]:4  pCStack_2c
...
;
; XREF[1]:
;   core_stranger.cpp_CStranger_handleActionButton_FUN_005c5b90 at 005c5c37
;
; Referenced Globals:
...
;   core_dest.cpp_CActorDestination_acceptsActor_FUN_0046fd50
...
section .text
    ...
    PUSH EBX                            ; 005c2850
        ;   Label: core_stranger.cpp_CStranger_tryPlaceObject_FUN_005c2850
    PUSH ESI                            ; 005c2851
    PUSH EDI                            ; 005c2852
    PUSH EBP                            ; 005c2853
    ...
    CMP ESI,dword ptr [EAX + 0x14d154]  ; 005c2903 | g_CDemonSetInstance.actor_count
    ...
    CMP ESI,dword ptr [EAX + 0x14d154]  ; 005c299c | g_CDemonSetInstance.actor_count
    ...
    PUSH EDI                            ; 005c29f5
    PUSH EAX                            ; 005c29f6
    CALL core_dest.cpp_CActorDestination_acceptsActor_FUN_0046fd50 ; 005c29f7
        ;   XREF to: 0046fd50 (UNCONDITIONAL_CALL)  ; int core_dest.cpp_CActorDestination_acceptsActor_FUN_0046fd50(CActorDestination * this_ptr, CDemonActor * actor)
    ...
    CALL core_stranger.cpp_getCarriedObjectVerticalOffset_FUN_005bb010 ; 005c2b09
    ...
    PUSH EAX                            ; 005c2bba
    PUSH ESI                            ; 005c2bbb
    CALL core_dest.cpp_CActorDestination_acceptsActor_FUN_0046fd50 ; 005c2bbc
        ;   XREF to: 0046fd50 (UNCONDITIONAL_CALL)  ; int core_dest.cpp_CActorDestination_acceptsActor_FUN_0046fd50(CActorDestination * this_ptr, CDemonActor * actor)
    ...
    MOV EDX,dword ptr [0x0066e8e0]      ; 005c2c33 | g_CConsoleInstance | g_CConsolePtr
    PUSH EDX                            ; 005c2c39 | g_CConsoleInstance
    ...
    MOV EAX,[0x006810c8]                ; 005c2ece | g_CDemonSetInstance | g_CDemonSetPtr
        ;   Label: LAB_005c2ece
    CMP ESI,dword ptr [EAX + 0x14d154]  ; 005c2ed3 | g_CDemonSetInstance.actor_count
    ...
    MOV EDX,dword ptr [0x0088797c]      ; 005c2f36 | g_CCrateClassInfo.name_hash
        ;   Label: LAB_005c2f36
    PUSH EDX                            ; 005c2f3c
    MOV ECX,dword ptr [EDI + EAX*0x1 + 0x14d158] ; 005c2f3d | g_CDemonSetInstance.actors[0]
    PUSH ECX                            ; 005c2f44
