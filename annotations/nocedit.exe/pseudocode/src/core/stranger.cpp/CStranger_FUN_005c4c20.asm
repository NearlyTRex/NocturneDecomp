...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_stranger_cpp_CStranger_FUN_005c4c20(CStranger *this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EBX,dword ptr [EDI + EAX*0x1 + 0x14f09c] ; 005c4c62 | g_CDemonSetInstance.damage_listeners | DAT_03263318
