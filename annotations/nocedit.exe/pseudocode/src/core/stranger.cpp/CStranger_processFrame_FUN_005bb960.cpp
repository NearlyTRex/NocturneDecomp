...

{
  ...
  if ((pCVar10 != (CDemonActor *)0x0) && ((this_ptr->carry_object_bbox).max.x < -999999.0f)) {
    ...
    pCVar17 = core_actor_cpp_CDemonActor_worldToLocalPoint_FUN_00408f10
                        ((CDemonActor *)this_ptr,&auStack_134,pCVar17);
  ...
  fVar18 = (this_ptr->base).invincibility_timer - delta_time;
  (this_ptr->base).invincibility_timer = fVar18;
  if (fVar18 < 0.0) {
    (this_ptr->base).invincibility_timer = 0.0;
  }
  fVar18 = this_ptr->action_timer - delta_time;
  ...
  (this_ptr->base).base.model.accumulated_root_motion.x =
       (this_ptr->base).base.model.accumulated_root_motion.y;
  pCVar17 = core_stranger_cpp_CStranger_getHandsMidpoint_FUN_005be490(this_ptr,aCStack_194);
  ...
  (this_ptr->base).base.turn_speed = delta_time * fVar18;
  ...
  if ((this_ptr->base).nearby_interactive_actor == (CDemonActor *)0x0) {
    fVar18 = this_ptr->interact_blend - delta_time * (float)2;
    ...
    fVar18 = delta_time * (float)2 + this_ptr->interact_blend;
    this_ptr->interact_blend = fVar18;
    if (1.0 < fVar18) {
                ...
                case 5:
                  if ((this_ptr->base).base.is_on_ground != 0) {
                    ...
                    (this_ptr->base).base.position_delta.x =
                         fVar18 * delta_time * (fVar22 + UStack_84.vec.z) + fVar4;
...
LAB_005bd19f:
          ...
          iVar21 = (*(pCVar12->_uc).attractActorToward)(this_ptr_00,(CDemonActor *)this_ptr,pCVar17)
          ;
          if (iVar21 == 0) {
            (this_ptr->base).base.grabbed_by = (CDemonActor *)0x0;
          }
          else if ((this_ptr->base).base.grabbed_by != (CDemonActor *)0x0) {
            fVar18 = this_ptr->grab_timer + delta_time;
        ...
        if (((float)auStack_280._8_4_ == 0.0) || (this_ptr != (CStranger *)auStack_280._12_4_)) {
          ...
          pCVar10 = (this_ptr->base).nearby_interactive_actor;
          iVar21 = (*((pCVar10->vtable)._ub)->updateInteraction)
          ...
          if (iVar21 == 0) {
            ...
            core_actor_cpp_CDemonActor_localToWorldPoint_FUN_00408ec0
                      ((this_ptr->base).nearby_interactive_actor,&CStack_fc,
                       (CVector3f *)&auStack_1dc.z);
            auStack_134.z = CStack_fc.x - (this_ptr->base).base.base.location.position.x;
      ...
      if (0.0 < this_ptr->ladder_blend_time) {
        ...
        fVar18 = (this_ptr->ladder_offset).y;
        ...
        (pCVar1->position).x = (pCVar1->position).x + pCVar17->x * fStack_2c0;
        fVar5 = (this_ptr->base).base.base.location.position.z;
        (this_ptr->base).base.base.location.position.y = fVar4 + fVar18 * fStack_2c0;
    ...
    if (0.0 < this_ptr->ladder_blend_time) {
      ...
      pCVar17 = &this_ptr->ladder_offset;
      fVar18 = (this_ptr->ladder_offset).y;
      fVar4 = (this_ptr->ladder_offset).z;
      pCVar1 = &(this_ptr->base).base.base.location;
      fStack_3c = 1.0 - fStack_2d8;
      fVar5 = (this_ptr->base).base.base.location.position.y;
      (pCVar1->position).x = (pCVar1->position).x + pCVar17->x * fStack_2d8;
      fVar6 = (this_ptr->base).base.base.location.position.z;
      (this_ptr->base).base.base.location.position.y = fVar5 + fVar18 * fStack_2d8;
      (this_ptr->base).base.base.location.position.z = fVar6 + fVar4 * fStack_2d8;
  ...
  if (((this_ptr->base).ladder_to_climb == (CLadder *)0x0) &&
    ...
    if (fStack_20 == 9.80909e-45) {
      ...
      if (fStack_20 == 1.12104e-44) {
        ...
        this_ptr->jump_speed = 18.0f;
        fVar18 = fVar18 - delta_time * fVar4;
        this_ptr->airborne_timer = 0.0;
        CStack_218.z = fStack_44;
        goto LAB_005bd5e4;
      }
      if (fStack_20 == 1.26117e-44) {
        ...
        this_ptr->airborne_timer = 0.0;
        fVar18 = (this_ptr->base).base.velocity.y;
        this_ptr->jump_speed = this_ptr->jump_speed - fVar4 * delta_time;
        fVar4 = this_ptr->jump_speed;
        (this_ptr->base).base.velocity.y = fVar18 - delta_time * fVar5;
        if (fVar4 < 0.0) {
...
LAB_005bd5e6:
        ...
        if (fStack_20 != 1.96182e-44) {
          if (fStack_20 == 2.10195e-44) {
            CStack_218.z = 0.0;
            fVar18 = (this_ptr->base).base.velocity.y - delta_time * (float)32;
    ...
    if (((fStack_20 == 2.10195e-44) || (fStack_20 == 1.26117e-44)) || (fStack_20 == 1.82169e-44)) {
      if ((this_ptr->base).base.is_on_ground != 0) {
        ...
        uVar25 = SUB84(__BITCAST_UINT64((double)fVar18),0);
...
LAB_005bc1a6:
  ...
  if (this_ptr->guns_drawn == 0) {
    fVar18 = this_ptr->guns_drawn_blend - delta_time / 1.2f;
    ...
    fVar18 = delta_time / 1.1f + this_ptr->guns_drawn_blend;
    this_ptr->guns_drawn_blend = fVar18;
    if (1.0 < fVar18) {
      this_ptr->guns_drawn_blend = 1.0;
    }
  }
  fVar18 = (this_ptr->right_arm_aim).recoil_timer - delta_time / 0.2f;
  this_ptr->frame_cleared = 0.0;
  (this_ptr->right_arm_aim).recoil_timer = fVar18;
  if (fVar18 <= 0.0) {
    (this_ptr->right_arm_aim).recoil_timer = 0.0;
  }
  fVar18 = (this_ptr->left_arm_aim).recoil_timer - delta_time / 0.2f;
