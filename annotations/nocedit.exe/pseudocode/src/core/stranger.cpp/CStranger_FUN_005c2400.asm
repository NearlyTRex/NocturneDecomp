...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_stranger.cpp_CStranger_FUN_005c2400()
;
; Local Variables:
...
section .text
    ...
    CALL core_charactr.cpp_CCharacter_FUN_0042e840 ; 005c241f | undefined core_charactr.cpp_CCharacter_FUN_0042e840()
    ...
    FCOMP double ptr [0x00653b34]       ; 005c2435 | double DOUBLE_00653b34
    FNSTSW AX                           ; 005c243b
    SAHF                                ; 005c243d
    JC 0x005c247f                       ; 005c243e | LAB_005c247f
        ;   XREF to: 005c247f (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [EDI + 0x24b4]    ; 005c2440
    TEST EDX,EDX                        ; 005c2446
    JNZ 0x005c247f                      ; 005c2448 | LAB_005c247f
        ;   XREF to: 005c247f (CONDITIONAL_JUMP)
    CMP dword ptr [EDI + 0x24f8],0x0    ; 005c244a
    JNZ 0x005c247f                      ; 005c2451 | LAB_005c247f
        ;   XREF to: 005c247f (CONDITIONAL_JUMP)
    ...
    JMP 0x005c246b                      ; 005c24a8 | LAB_005c246b
    ...
    PUSH EAX                            ; 005c24c0
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 005c24c1 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 005c24c6
    ADD ESP,0x8                         ; 005c24c8
    MOV ESI,EAX                         ; 005c24cb
    TEST EAX,EAX                        ; 005c24cd
    JZ 0x005c2488                       ; 005c24cf | LAB_005c2488
    ...
    FABS                                ; 005c24dd
    FCOMP double ptr [0x00653b44]       ; 005c24df | double DOUBLE_00653b44
    FNSTSW AX                           ; 005c24e5
    SAHF                                ; 005c24e7
    JA 0x005c2488                       ; 005c24e8 | LAB_005c2488
        ;   XREF to: 005c2488 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 005c24f6
    PUSH EBX                            ; 005c24f7
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 005c24f8 | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
        ;   XREF to: 00408f10 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005c24fd
    FLD float ptr [ESP + 0x30]          ; 005c2500
    FST double ptr [ESP + 0x8]          ; 005c2504
    FABS                                ; 005c2508
    FCOMP double ptr [0x00653b4c]       ; 005c250a | double DOUBLE_00653b4c
    FNSTSW AX                           ; 005c2510
    SAHF                                ; 005c2512
    JA 0x005c2488                       ; 005c2513 | LAB_005c2488
        ;   XREF to: 005c2488 (CONDITIONAL_JUMP)
    FLDZ                                ; 005c2519
    FCOMP double ptr [ESP + 0x8]        ; 005c251b
    FNSTSW AX                           ; 005c251f
    SAHF                                ; 005c2521
    JC 0x005c2488                       ; 005c2522 | LAB_005c2488
        ;   XREF to: 005c2488 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 005c2542
    SAHF                                ; 005c2544
    JBE 0x005c2566                      ; 005c2545 | LAB_005c2566
    ...
    FNSTSW AX                           ; 005c2555
    SAHF                                ; 005c2557
    JA 0x005c2488                       ; 005c2558 | LAB_005c2488
        ;   XREF to: 005c2488 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 005c256e
    SAHF                                ; 005c2570
    JNC 0x005c2594                      ; 005c2571 | LAB_005c2594
        ;   XREF to: 005c2594 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x10]          ; 005c2573
    FADD double ptr [0x00653b54]        ; 005c2577 | double DOUBLE_00653b54
    FLD float ptr [ESP + 0x28]          ; 005c257d
    FCOMPP                              ; 005c2581
    FNSTSW AX                           ; 005c2583
    SAHF                                ; 005c2585
    JC 0x005c2488                       ; 005c2586 | LAB_005c2488
        ;   XREF to: 005c2488 (CONDITIONAL_JUMP)
    ...
    FLD float ptr [0x00653b3c]          ; 005c25a0 | float FLOAT_00653b3c
    FXCH                                ; 005c25a6
    FMUL ST1                            ; 005c25a8
    ...
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 005c25f1 | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
        ;   XREF to: 00408ec0 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 005c25f6
    LEA EAX,[ESP + 0x34]                ; 005c25f8
    ADD ESP,0xc                         ; 005c25fc
    CMP EAX,EBX                         ; 005c25ff
    JZ 0x005c2617                       ; 005c2601 | LAB_005c2617
    ...
    FLD double ptr [0x00653b5c]         ; 005c269f | double DOUBLE_00653b5c
    ...
    FNSTSW AX                           ; 005c26e1
    SAHF                                ; 005c26e3
    JA 0x005c2488                       ; 005c26e4 | LAB_005c2488
        ;   XREF to: 005c2488 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 005c26f5
    PUSH EDI                            ; 005c26f6
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 005c26f7 | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
        ;   XREF to: 00408f10 (UNCONDITIONAL_CALL)
    ...
    FNSTSW AX                           ; 005c2706
    SAHF                                ; 005c2708
    JNC 0x005c2488                      ; 005c2709 | LAB_005c2488
        ;   XREF to: 005c2488 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [ESP + 0x4]       ; 005c270f
    PUSH EDX                            ; 005c2713
    MOV ECX,dword ptr [ESP + 0x4]       ; 005c2714
    PUSH ECX                            ; 005c2718
    PUSH 0x653b1c                       ; 005c2719 | = "Ladder dot : %f\n" | s_Ladder_dot_f_00653b1c = Ladder dot : %f

    MOV EBX,dword ptr [0x0066e8e0]      ; 005c271e | CConsole g_ConsolePtr | CConsole * g_CConsolePtr
    PUSH EBX                            ; 005c2724 | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 005c2725 | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
    ...
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 005c273e | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
    ...
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 005c2788 | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
        ;   XREF to: 00408ec0 (UNCONDITIONAL_CALL)
    ...
    JZ 0x005c27e3                       ; 005c27c4 | LAB_005c27e3
    ...
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 005c2820 | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
