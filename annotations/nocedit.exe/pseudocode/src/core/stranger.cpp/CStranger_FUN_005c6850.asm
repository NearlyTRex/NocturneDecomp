...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_stranger.cpp_CStranger_FUN_005c6850(CStranger * this_ptr)
;
; Parameters:
...
section .text
    ...
    JZ 0x005c6878                       ; 005c6860 | LAB_005c6878
    ...
    PUSH ESI                            ; 005c686b
    PUSH EBX                            ; 005c686c
    CALL core_charactr.cpp_CCharacter_FUN_0042bf90 ; 005c686d | void core_charactr.cpp_CCharacter_FUN_0042bf90(CCharacter * this_ptr)
    ...
    JMP 0x005c6862                      ; 005c6894 | LAB_005c6862
