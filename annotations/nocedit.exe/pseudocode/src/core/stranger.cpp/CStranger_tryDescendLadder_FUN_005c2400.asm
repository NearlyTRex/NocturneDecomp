...
section .text
    ...
    PUSH EBX                            ; 005c2400
        ;   Label: core_stranger.cpp_CStranger_tryDescendLadder_FUN_005c2400
    PUSH ESI                            ; 005c2401
    PUSH EDI                            ; 005c2402
    PUSH EBP                            ; 005c2403
    ...
    CMP EDX,dword ptr [EAX + 0x14d154]  ; 005c2477 | g_CDemonSetInstance.actor_count
    ...
    PUSH ESI                            ; 005c24b9
    MOV EAX,dword ptr [EAX + 0x14d158]  ; 005c24ba | g_CDemonSetInstance.actors[0]
    PUSH EAX                            ; 005c24c0
