...
section .text
    ...
    PUSH EAX                            ; 005c1f27
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 005c1f28 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005c1f2d
    TEST EAX,EAX                        ; 005c1f30
    JZ 0x005c1f44                       ; 005c1f32 | LAB_005c1f44
        ;   XREF to: 005c1f44 (CONDITIONAL_JUMP)
    LEA EDX,[EBX + 0x1f738]             ; 005c1f34
    PUSH EDX                            ; 005c1f3a
    PUSH EAX                            ; 005c1f3b
    CALL core_ammobox.cpp_AllocateMemoryMaybe_FUN_00411700 ; 005c1f3c | undefined core_ammobox.cpp_AllocateMemoryMaybe_FUN_00411700()
    ...
    PUSH 0xd52                          ; 005c1f5c
    PUSH ECX                            ; 005c1f61
    PUSH 0x653aac                       ; 005c1f62 | = "actionPending = %d\nstranger.cpp line %d" | s_actionPending_d_stranger_00653aac = actionPending = %d
        ; stranger.cpp line %d
    MOV EDI,dword ptr [0x00678a60]      ; 005c1f67 | CEditorTools * g_CEditorToolsPtr
    PUSH EDI                            ; 005c1f6d | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_showWarning_FUN_0049e6f0 ; 005c1f6e | void shape_edittool.cpp_CEditorTools_showWarning_FUN_0049e6f0(CEditorTools * this_ptr, char * format)
        ;   XREF to: 0049e6f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 005c1f73
    POP EDI                             ; 005c1f76
    JMP 0x005c1f1a                      ; 005c1f77 | LAB_005c1f1a
