...
;
; XREF[1]:
;   core_stranger.cpp_CStranger_processMotionEvents_FUN_005bdd20 at 005bde10
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 005c1f80
        ;   Label: core_stranger.cpp_CStranger_dropRightHandObject_FUN_005c1f80
    ...
    JNZ 0x005c1fa9                      ; 005c1f9d
        ;   XREF to: 005c1fa9 (CONDITIONAL_JUMP)  ; LAB_005c1fa9
    ...
    PUSH EBX                            ; 005c1fc7
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 005c1fc8
