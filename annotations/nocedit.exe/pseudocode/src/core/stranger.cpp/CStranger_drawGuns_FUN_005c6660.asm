...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_stranger_cpp_CStranger_drawGuns_FUN_005c6660(CStranger *this_ptr,int drawn)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x4]       ; 005c6660
        ;   Label: core_stranger.cpp_CStranger_drawGuns_FUN_005c6660
