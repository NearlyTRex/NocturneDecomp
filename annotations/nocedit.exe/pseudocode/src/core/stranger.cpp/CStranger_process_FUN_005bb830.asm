...
section .text
    ...
    PUSH EBX                            ; 005bb83c
    CALL core_charactr.cpp_CCharacter_FUN_00429870 ; 005bb83d | int core_charactr.cpp_CCharacter_FUN_00429870(CCharacter * this_ptr)
        ;   XREF to: 00429870 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005bb842
    TEST EAX,EAX                        ; 005bb845
    JNZ 0x005bb8bb                      ; 005bb847 | LAB_005bb8bb
    ...
    CMP dword ptr [EBX + 0x1fc38],0x7   ; 005bb853
        ;   Label: caseD_1a
    JNZ 0x005bb8f2                      ; 005bb85a | LAB_005bb8f2
        ;   XREF to: 005bb8f2 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x18]          ; 005bb860
        ;   Label: LAB_005bb860
    FMUL double ptr [0x006534ac]        ; 005bb864 | double DOUBLE_006534ac
    FSTP float ptr [ESP + 0x4]          ; 005bb86a
    PUSH dword ptr [ESP + 0x4]          ; 005bb86e
    PUSH EBX                            ; 005bb872
    CALL core_stranger.cpp_CStranger_FUN_005bb960 ; 005bb873 | undefined core_stranger.cpp_CStranger_FUN_005bb960()
        ;   XREF to: 005bb960 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005bb878
    PUSH dword ptr [ESP + 0x4]          ; 005bb87b
    PUSH EBX                            ; 005bb87f
    CALL core_stranger.cpp_CStranger_FUN_005bb960 ; 005bb880 | undefined core_stranger.cpp_CStranger_FUN_005bb960()
        ;   XREF to: 005bb960 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005bb885
    PUSH dword ptr [ESP + 0x4]          ; 005bb888
    PUSH EBX                            ; 005bb88c
    CALL core_stranger.cpp_CStranger_FUN_005bb960 ; 005bb88d | undefined core_stranger.cpp_CStranger_FUN_005bb960()
        ;   XREF to: 005bb960 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005bb892
    PUSH dword ptr [ESP + 0x4]          ; 005bb895
    PUSH EBX                            ; 005bb899
        ;   Label: LAB_005bb899
    CALL core_stranger.cpp_CStranger_FUN_005bb960 ; 005bb89a | undefined core_stranger.cpp_CStranger_FUN_005bb960()
        ;   XREF to: 005bb960 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005bb89f
    MOV ECX,dword ptr [0x0067b654]      ; 005bb8a2 | CGame g_CGameInstance | CGame * g_CGamePtr
    PUSH dword ptr [ESP + 0x8]          ; 005bb8a8
    PUSH ECX                            ; 005bb8ac | CGame g_CGameInstance
    CALL core_game.cpp_CGame_slamDT_FUN_004e3080 ; 005bb8ad | void core_game.cpp_CGame_slamDT_FUN_004e3080(CGame * this_ptr, float delta_time)
    ...
    PUSH ESI                            ; 005bb8bb
        ;   Label: LAB_005bb8bb
    MOV EAX,[0x0067b654]                ; 005bb8bc | CGame * g_CGamePtr
    ...
    CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0 ; 005bb8d2 | SMotion * core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0(CMotionController * this_ptr)
    ...
    JA 0x005bb853                       ; 005bb8e5 | caseD_18
        ;   XREF to: 005bb853 (CONDITIONAL_JUMP)
    JMP dword ptr [EAX*0x4 + 0x5bb7dc]  ; 005bb8eb | void * switchdataD_005bb7dc
        ;   Label: switchD
    TEST ESI,ESI                        ; 005bb8f2
        ;   Label: LAB_005bb8f2
    JNZ 0x005bb860                      ; 005bb8f4 | LAB_005bb860
        ;   XREF to: 005bb860 (CONDITIONAL_JUMP)
    PUSH dword ptr [ESP + 0x18]         ; 005bb8fa
    JMP 0x005bb899                      ; 005bb8fe | LAB_005bb899
