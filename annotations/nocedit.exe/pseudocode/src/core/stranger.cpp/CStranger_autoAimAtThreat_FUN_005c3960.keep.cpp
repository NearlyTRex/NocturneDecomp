...

{
    ...
    for (iStack_40 = 0; iStack_40 < g_CDemonSetPtr->threat_count; iStack_40 = iStack_40 + 1) {
      pCVar7 = (CCharacter *)
               core_actor_cpp_castToClassHash_FUN_0040c790
                         (g_CDemonSetPtr->threats[iStack_40],
      ...
      if ((pCVar7 == (CCharacter *)0x0) ||
         ((EVar8 = (*(((pCVar7->base).vtable._uc)->_uc).getDeathState)(pCVar7),
          ...
          iVar9 == 0)))) {
        this_ptr_03 = g_CDemonSetPtr->threats[iStack_40];
        __arrinit(aCStack_1a0,10,&g_CVectorTypeInfo);
        iVar2 = (*((this_ptr_03->vtable)._ub)->getTargetPoints)(this_ptr_03,aCStack_1a0);
        if ((0 < iVar2) && (iVar4 = 0, 0 < iVar2)) {
          pCVar1 = aCStack_1a0;
          do {
            core_actor_cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(this_ptr_03,&CStack_88,pCVar1)
            ;
            ...
            if ((0.0 < (double)CStack_b8.z) && ((double)CStack_b8.z <= 30)) {
              ...
              if (((ABS(aCStack_f4[0].x) <= fStack_1a8) && (local_30 <= aCStack_f4[0].y)) &&
                ...
                fVar3 = SQRT(CStack_b8.z * CStack_b8.z +
                ...
                fVar3 = fVar3 * (float)0.033333333333333298 +
                        ((float)2 -
                ...
                if (fVar3 < fStack_20) {
                  ...
                  core_setcolid_cpp_CDemonSet_ignore_FUN_005741b0(g_CDemonSetPtr,this_ptr_03);
  ...
  fStack_50 = core_actor_cpp_normalizeAngleToPi_FUN_0040cd70(fStack_34 - local_24->target_pitch);
  if (fStack_4c < -fStack_44) {
    fStack_4c = -fStack_44;
  }
  if (fStack_44 < fStack_4c) {
    fStack_4c = fStack_44;
  }
  if (fStack_50 < -fStack_44) {
    fStack_50 = -fStack_44;
  }
  if (fStack_44 < fStack_50) {
    fStack_50 = fStack_44;
  }
  fVar3 = core_actor_cpp_normalizeAngleToPi_FUN_0040cd70(local_24->target_yaw + fStack_4c);
  local_24->target_yaw = fVar3;
