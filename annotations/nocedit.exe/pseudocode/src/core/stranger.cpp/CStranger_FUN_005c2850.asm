...
section .text
    ...
    JNZ 0x005c2fab                      ; 005c286a | LAB_005c2fab
        ;   XREF to: 005c2fab (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x24f8],0x0    ; 005c2870
    JZ 0x005c2fab                       ; 005c2877 | LAB_005c2fab
        ;   XREF to: 005c2fab (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x2a8c],0xe    ; 005c287d
    JZ 0x005c28ad                       ; 005c2884 | LAB_005c28ad
        ;   XREF to: 005c28ad (CONDITIONAL_JUMP)
    PUSH EDX                            ; 005c2886
    PUSH EBX                            ; 005c2887
    CALL core_charactr.cpp_CCharacter_FUN_0042e840 ; 005c2888 | undefined core_charactr.cpp_CCharacter_FUN_0042e840()
    ...
    FCOMP double ptr [0x00653bb4]       ; 005c289e | double DOUBLE_00653bb4
    FNSTSW AX                           ; 005c28a4
    SAHF                                ; 005c28a6
    JC 0x005c2fab                       ; 005c28a7 | LAB_005c2fab
        ;   XREF to: 005c2fab (CONDITIONAL_JUMP)
    PUSH 0x0                            ; 005c28ad
        ;   Label: LAB_005c28ad
    LEA EAX,[EBX + 0x158]               ; 005c28af
    PUSH EAX                            ; 005c28b5
    CALL core_motion.cpp_CMotionController_getStateBlendWeight_FUN_0052dd20 ; 005c28b6 | float core_motion.cpp_CMotionController_getStateBlendWeight_FUN_0052dd20(CMotionController * this_ptr, int desired_state_index)
    ...
    FNSTSW AX                           ; 005c28d0
    SAHF                                ; 005c28d2
    JA 0x005c2fab                       ; 005c28d3 | LAB_005c2fab
        ;   XREF to: 005c2fab (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0x24f8]    ; 005c28d9
    TEST EAX,EAX                        ; 005c28df
    JNZ 0x005c2961                      ; 005c28e1 | LAB_005c2961
    ...
    MOV EAX,[0x006810c8]                ; 005c28f7 | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
        ;   Label: LAB_005c28f7
    MOV ESI,dword ptr [ESP + 0xc8]      ; 005c28fc
    CMP ESI,dword ptr [EAX + 0x14d154]  ; 005c2903 | g_CDemonSetInstance.actor_list_ptr
    JGE 0x005c2d0c                      ; 005c2909 | LAB_005c2d0c
    ...
    PUSH ECX                            ; 005c291e
    MOV EDI,dword ptr [EAX + 0x14d158]  ; 005c291f | g_CDemonSetInstance.actor_list_data[0]
    PUSH EDI                            ; 005c2925
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 005c2926 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005c292b
    MOV ESI,EAX                         ; 005c292e
    MOV dword ptr [ESP + 0xb8],EAX      ; 005c2930
    TEST EAX,EAX                        ; 005c2937
    JNZ 0x005c2bb4                      ; 005c2939 | LAB_005c2bb4
    ...
    JMP 0x005c28f7                      ; 005c295f | LAB_005c28f7
    ...
    JZ 0x005c28e7                       ; 005c297a | LAB_005c28e7
    ...
    MOV dword ptr [ESP + 0xd0],EDI      ; 005c2989
        ;   Label: LAB_005c2989
    MOV EAX,[0x006810c8]                ; 005c2990 | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
    MOV ESI,dword ptr [ESP + 0xc4]      ; 005c2995
    CMP ESI,dword ptr [EAX + 0x14d154]  ; 005c299c | g_CDemonSetInstance.actor_list_ptr
    JGE 0x005c2d0c                      ; 005c29a2 | LAB_005c2d0c
        ;   XREF to: 005c2d0c (CONDITIONAL_JUMP)
    ...
    PUSH EDX                            ; 005c29b7
    MOV ESI,dword ptr [EAX + 0x14d158]  ; 005c29b8 | g_CDemonSetInstance.actor_list_data[0]
    PUSH ESI                            ; 005c29be
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 005c29bf | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005c29c4
    MOV ESI,EAX                         ; 005c29c7
    MOV dword ptr [ESP + 0xbc],EAX      ; 005c29c9
    TEST EAX,EAX                        ; 005c29d0
    JNZ 0x005c29ef                      ; 005c29d2 | LAB_005c29ef
    ...
    JMP 0x005c2989                      ; 005c29ed | LAB_005c2989
        ;   XREF to: 005c2989 (UNCONDITIONAL_JUMP)
    MOV EDI,dword ptr [EBX + 0x24f8]    ; 005c29ef
        ;   Label: LAB_005c29ef
    PUSH EDI                            ; 005c29f5
    PUSH EAX                            ; 005c29f6
    CALL core_dest.cpp_FUN_0046fd50     ; 005c29f7 | undefined core_dest.cpp_FUN_0046fd50()
        ;   XREF to: 0046fd50 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005c29fc
    TEST EAX,EAX                        ; 005c29ff
    JZ 0x005c29d4                       ; 005c2a01 | LAB_005c29d4
    ...
    PUSH EAX                            ; 005c2a11
    PUSH EBX                            ; 005c2a12
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 005c2a13 | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
    ...
    PUSH EAX                            ; 005c2a28
    PUSH EBX                            ; 005c2a29
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 005c2a2a | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
        ;   XREF to: 00408f10 (UNCONDITIONAL_CALL)
    ...
    FNSTSW AX                           ; 005c2a56
    SAHF                                ; 005c2a58
    JNC 0x005c29d4                      ; 005c2a59 | LAB_005c29d4
        ;   XREF to: 005c29d4 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x60]          ; 005c2a5f
    FCOMP double ptr [0x00653bbc]       ; 005c2a63 | double DOUBLE_00653bbc
    FNSTSW AX                           ; 005c2a69
    SAHF                                ; 005c2a6b
    JNC 0x005c29d4                      ; 005c2a6c | LAB_005c29d4
        ;   XREF to: 005c29d4 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x58]          ; 005c2a72
    FABS                                ; 005c2a76
    FCOMP double ptr [0x00653bc4]       ; 005c2a78 | double DOUBLE_00653bc4
    FNSTSW AX                           ; 005c2a7e
    SAHF                                ; 005c2a80
    JNC 0x005c29d4                      ; 005c2a81 | LAB_005c29d4
        ;   XREF to: 005c29d4 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 005c2a95
    SAHF                                ; 005c2a97
    JNC 0x005c29d4                      ; 005c2a98 | LAB_005c29d4
        ;   XREF to: 005c29d4 (CONDITIONAL_JUMP)
    FLD double ptr [ESP]                ; 005c2a9e
    FCOMP double ptr [0x00653bcc]       ; 005c2aa1 | double DOUBLE_00653bcc
    FNSTSW AX                           ; 005c2aa7
    SAHF                                ; 005c2aa9
    JNC 0x005c29d4                      ; 005c2aaa | LAB_005c29d4
        ;   XREF to: 005c29d4 (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 005c2ab0
    PUSH 0x1a                           ; 005c2ab2
    LEA EAX,[EBX + 0x158]               ; 005c2ab4
    PUSH EAX                            ; 005c2aba
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 005c2abb | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
    ...
    PUSH EAX                            ; 005c2acb
    PUSH EBX                            ; 005c2acc
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 005c2acd | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
        ;   XREF to: 00408f10 (UNCONDITIONAL_CALL)
    LEA ESI,[EBX + 0x1fc98]             ; 005c2ad2
    ADD ESP,0xc                         ; 005c2ad8
    CMP ESI,EAX                         ; 005c2adb
    JZ 0x005c2aef                       ; 005c2add | LAB_005c2aef
    ...
    CALL core_stranger.cpp_FUN_005bb010 ; 005c2b09 | undefined core_stranger.cpp_FUN_005bb010()
    ...
    JZ 0x005c2b56                       ; 005c2b3a | LAB_005c2b56
        ;   XREF to: 005c2b56 (CONDITIONAL_JUMP)
    PUSH 0xe78                          ; 005c2b3c
    PUSH EDX                            ; 005c2b41
    PUSH 0x653b64                       ; 005c2b42 | = "actionPending = %d\nstranger.cpp line %d" | s_actionPending_d_stranger_00653b64 = actionPending = %d
        ; stranger.cpp line %d
    MOV ESI,dword ptr [0x00678a60]      ; 005c2b47 | CEditorTools * g_CEditorToolsPtr
    PUSH ESI                            ; 005c2b4d | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_showWarning_FUN_0049e6f0 ; 005c2b4e | void shape_edittool.cpp_CEditorTools_showWarning_FUN_0049e6f0(CEditorTools * this_ptr, char * format)
    ...
    JZ 0x005c2b84                       ; 005c2b72 | LAB_005c2b84
    ...
    JZ 0x005c2ba8                       ; 005c2b96 | LAB_005c2ba8
    ...
    PUSH EAX                            ; 005c2bba
    PUSH ESI                            ; 005c2bbb
    CALL core_dest.cpp_FUN_0046fd50     ; 005c2bbc | undefined core_dest.cpp_FUN_0046fd50()
        ;   XREF to: 0046fd50 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005c2bc1
    TEST EAX,EAX                        ; 005c2bc4
    JZ 0x005c293f                       ; 005c2bc6 | LAB_005c293f
    ...
    PUSH EAX                            ; 005c2bda
    PUSH EBX                            ; 005c2bdb
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 005c2bdc | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
        ;   XREF to: 00408f10 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 005c2bee
    PUSH EBX                            ; 005c2bef
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 005c2bf0 | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
        ;   XREF to: 00408f10 (UNCONDITIONAL_CALL)
    ...
    PUSH 0x653b8c                       ; 005c2c2e | = "Delta to dest : %3.2f,%3.2f,%3.2f\n" | s_Delta_to_dest_3_2f_3_2f__00653b8c = Delta to dest : %3.2f,%3.2f,%3.2f

    MOV EDX,dword ptr [0x0066e8e0]      ; 005c2c33 | CConsole g_ConsolePtr | CConsole * g_CConsolePtr
    PUSH EDX                            ; 005c2c39 | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 005c2c3a | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
    ...
    FNSTSW AX                           ; 005c2c48
    SAHF                                ; 005c2c4a
    JNC 0x005c293f                      ; 005c2c4b | LAB_005c293f
        ;   XREF to: 005c293f (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x18]          ; 005c2c51
    FCOMP double ptr [0x00653bbc]       ; 005c2c55 | double DOUBLE_00653bbc
    FNSTSW AX                           ; 005c2c5b
    SAHF                                ; 005c2c5d
    JNC 0x005c293f                      ; 005c2c5e | LAB_005c293f
        ;   XREF to: 005c293f (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x10]          ; 005c2c64
    FABS                                ; 005c2c68
    FCOMP double ptr [0x00653bc4]       ; 005c2c6a | double DOUBLE_00653bc4
    FNSTSW AX                           ; 005c2c70
    SAHF                                ; 005c2c72
    JNC 0x005c293f                      ; 005c2c73 | LAB_005c293f
        ;   XREF to: 005c293f (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 005c2c89
    SAHF                                ; 005c2c8b
    JNC 0x005c293f                      ; 005c2c8c | LAB_005c293f
        ;   XREF to: 005c293f (CONDITIONAL_JUMP)
    FLD double ptr [ESP + 0x8]          ; 005c2c92
    FCOMP double ptr [0x00653bcc]       ; 005c2c96 | double DOUBLE_00653bcc
    FNSTSW AX                           ; 005c2c9c
    SAHF                                ; 005c2c9e
    JNC 0x005c293f                      ; 005c2c9f | LAB_005c293f
        ;   XREF to: 005c293f (CONDITIONAL_JUMP)
    LEA EAX,[EBX + 0x1fbb8]             ; 005c2ca5
    MOV dword ptr [EBX + 0x1fc38],0x2   ; 005c2cab
    CMP EAX,ESI                         ; 005c2cb5
    JZ 0x005c2cc9                       ; 005c2cb7 | LAB_005c2cc9
    ...
    JZ 0x005c2ced                       ; 005c2cdb | LAB_005c2ced
    ...
    PUSH EBX                            ; 005c2cf7
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 005c2cf8 | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ...
    PUSH EBX                            ; 005c2d0c
        ;   Label: LAB_005c2d0c
    MOV EDI,dword ptr [0x006810c8]      ; 005c2d0d | CDemonSet * g_CDemonSetPtr
    PUSH EDI                            ; 005c2d13 | CDemonSet g_CDemonSetInstance
    CALL core_setcolid.cpp_CDemonSet_ignore_FUN_005741b0 ; 005c2d14 | void core_setcolid.cpp_CDemonSet_ignore_FUN_005741b0(CDemonSet * this_ptr, CDemonActor * actor)
        ;   XREF to: 005741b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005c2d19
    MOV EAX,dword ptr [EBX + 0x24f8]    ; 005c2d1c
    PUSH EAX                            ; 005c2d22
    MOV EDX,dword ptr [0x006810c8]      ; 005c2d23 | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
    PUSH EDX                            ; 005c2d29 | CDemonSet g_CDemonSetInstance
    CALL core_setcolid.cpp_CDemonSet_ignore_FUN_005741b0 ; 005c2d2a | void core_setcolid.cpp_CDemonSet_ignore_FUN_005741b0(CDemonSet * this_ptr, CDemonActor * actor)
        ;   XREF to: 005741b0 (UNCONDITIONAL_CALL)
    ...
    CALL core_actor.cpp_CDemonActor_transformVector_FUN_00408e80 ; 005c2d78 | CVector3f * core_actor.cpp_CDemonActor_transformVector_FUN_00408e80(CDemonActor * this_ptr, CVector3f * output, CVector3f * input)
    ...
    CALL core_actor.cpp_CDemonActor_transformVector_FUN_00408e80 ; 005c2de4 | CVector3f * core_actor.cpp_CDemonActor_transformVector_FUN_00408e80(CDemonActor * this_ptr, CVector3f * output, CVector3f * input)
        ;   XREF to: 00408e80 (UNCONDITIONAL_CALL)
    ...
    MOV ESI,dword ptr [0x006810c8]      ; 005c2e10 | CDemonSet * g_CDemonSetPtr
    PUSH dword ptr [ESP + 0x94]         ; 005c2e16
    PUSH ESI                            ; 005c2e1d | CDemonSet g_CDemonSetInstance
    CALL core_setcolid.cpp_CDemonSet_testCapsuleCollision_FUN_00573470 ; 005c2e1e | float core_setcolid.cpp_CDemonSet_testCapsuleCollision_FUN_00573470(CDemonSet * this_ptr, float start_x, float start_z, float dir_x, ...)
    ...
    FNSTSW AX                           ; 005c2e38
    SAHF                                ; 005c2e3a
    JA 0x005c2f1c                       ; 005c2e3b | LAB_005c2f1c
    ...
    MOV EDI,dword ptr [0x006810c8]      ; 005c2e5c | CDemonSet * g_CDemonSetPtr
    FXCH ST2                            ; 005c2e62
    ...
    PUSH EDI                            ; 005c2e81 | CDemonSet g_CDemonSetInstance
    FSTP float ptr [ESP + 0x30]         ; 005c2e82
    CALL core_setcolid.cpp_CDemonSet_processCollisionTypes_FUN_005716b0 ; 005c2e86 | float core_setcolid.cpp_CDemonSet_processCollisionTypes_FUN_005716b0(CDemonSet * this_ptr, CVector3f * position, float radius)
    ...
    MOV EAX,[0x006810c8]                ; 005c2e9c | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
    PUSH EAX                            ; 005c2ea1 | CDemonSet g_CDemonSetInstance
    FSTP float ptr [ESP + 0xc4]         ; 005c2ea2
    CALL core_setcolid.cpp_CDemonSet_initMaybe_FUN_00574180 ; 005c2ea9 | void core_setcolid.cpp_CDemonSet_initMaybe_FUN_00574180(CDemonSet * this_ptr)
    ...
    FNSTSW AX                           ; 005c2ec1
    SAHF                                ; 005c2ec3
    JC 0x005c2fab                       ; 005c2ec4 | LAB_005c2fab
        ;   XREF to: 005c2fab (CONDITIONAL_JUMP)
    XOR ESI,ESI                         ; 005c2eca
    XOR EDI,EDI                         ; 005c2ecc
    MOV EAX,[0x006810c8]                ; 005c2ece | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
        ;   Label: LAB_005c2ece
    CMP ESI,dword ptr [EAX + 0x14d154]  ; 005c2ed3 | g_CDemonSetInstance.actor_list_ptr
    JL 0x005c2f36                       ; 005c2ed9 | LAB_005c2f36
    ...
    JNZ 0x005c2fb4                      ; 005c2eed | LAB_005c2fb4
    ...
    LEA EAX,[EBX + 0x158]               ; 005c2ef7
        ;   Label: LAB_005c2ef7
    PUSH EAX                            ; 005c2efd
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 005c2efe | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ...
    POP EBX                             ; 005c2f1a
    RET                                 ; 005c2f1b
    MOV EDX,dword ptr [0x006810c8]      ; 005c2f1c | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
        ;   Label: LAB_005c2f1c
    PUSH EDX                            ; 005c2f22 | CDemonSet g_CDemonSetInstance
    CALL core_setcolid.cpp_CDemonSet_initMaybe_FUN_00574180 ; 005c2f23 | void core_setcolid.cpp_CDemonSet_initMaybe_FUN_00574180(CDemonSet * this_ptr)
        ;   XREF to: 00574180 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005c2f28
    JMP 0x005c2fab                      ; 005c2f2b | LAB_005c2fab
        ;   XREF to: 005c2fab (UNCONDITIONAL_JUMP)
    INC ESI                             ; 005c2f30
        ;   Label: LAB_005c2f30
    ADD EDI,0x4                         ; 005c2f31
    JMP 0x005c2ece                      ; 005c2f34 | LAB_005c2ece
    ...
    PUSH ECX                            ; 005c2f44
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 005c2f45 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005c2f4a
    TEST EAX,EAX                        ; 005c2f4d
    JZ 0x005c2f30                       ; 005c2f4f | LAB_005c2f30
    ...
    FADDP                               ; 005c2f9c
    FSQRT                               ; 005c2f9e
    FCOMP double ptr [0x00653bc4]       ; 005c2fa0 | double DOUBLE_00653bc4
    FNSTSW AX                           ; 005c2fa6
    SAHF                                ; 005c2fa8
    JNC 0x005c2f30                      ; 005c2fa9 | LAB_005c2f30
        ;   XREF to: 005c2f30 (CONDITIONAL_JUMP)
    ...
    JZ 0x005c2ef3                       ; 005c2fcd | LAB_005c2ef3
        ;   XREF to: 005c2ef3 (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 005c2fd3
    PUSH 0x19                           ; 005c2fd5
    JMP 0x005c2ef7                      ; 005c2fd7 | LAB_005c2ef7
