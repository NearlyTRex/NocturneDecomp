...
// Convention: unknown
// Signature: void core_stranger_cpp_CStranger_FUN_005c5270(void)
...
switchD_005c56f5_caseD_8:
    ...
    case 6:
      ...
      if ((local_24 != (CDemonActor *)0x0) && (iVar6 = core_dynamite_cpp_FUN_0049cf70(), iVar6 == 0)
        ...
        fVar1 = *(float *)(in_stack_00000004->unk3 + 0x470);
    ...
    case 7:
      if (*(int *)(in_stack_00000004[2].cloth_data + 0x5558) == 3) {
        ...
        if ((float)(int)fStack_14 <= *(float *)(in_stack_00000004->unk3 + 0x470)) {
