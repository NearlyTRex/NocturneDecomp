...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_stranger_cpp_CStranger_getDeathState_FUN_005c67c0(CStranger *this_ptr)
;
; Parameters:
...
;
; Called Functions:
;   core_charactr.cpp_CCharacter_getDeathState_FUN_0042c580
...
section .text
    ...
    PUSH 0x653fa7                       ; 005c67c0 | = "strangerCannotDie"
        ;   Label: core_stranger.cpp_CStranger_getDeathState_FUN_005c67c0
