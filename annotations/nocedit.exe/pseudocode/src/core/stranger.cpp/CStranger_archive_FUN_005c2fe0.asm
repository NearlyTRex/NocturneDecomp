...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_stranger_cpp_CStranger_archive_FUN_005c2fe0(CStranger *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005c2fe0
        ;   Label: core_stranger.cpp_CStranger_archive_FUN_005c2fe0
    MOV EBX,dword ptr [ESP + 0x8]       ; 005c2fe1
    PUSH EBX                            ; 005c2fe5
    CALL core_hero.cpp_CHero_archive_FUN_004f2610 ; 005c2fe6
    ...
    PUSH EAX                            ; 005c3009
    CALL core_actor.cpp_archiveActor_FUN_0040b870 ; 005c300a
    ...
    PUSH EAX                            ; 005c3062
    CALL core_actor.cpp_archiveActor_FUN_0040b870 ; 005c3063
        ;   XREF to: 0040b870 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveActor_FUN_0040b870(CDemonActor * actor_ptr, char * property_name)
    ADD ESP,0x8                         ; 005c3068
    PUSH 0x653c16                       ; 005c306b | = "rhCarryObject"
    LEA EAX,[EBX + 0x24f8]              ; 005c3070
    PUSH EAX                            ; 005c3076
    CALL core_actor.cpp_archiveActor_FUN_0040b870 ; 005c3077
        ;   XREF to: 0040b870 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveActor_FUN_0040b870(CDemonActor * actor_ptr, char * property_name)
    ...
    PUSH EAX                            ; 005c3093
    CALL core_actor.cpp_archiveActor_FUN_0040b870 ; 005c3094
        ;   XREF to: 0040b870 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveActor_FUN_0040b870(CDemonActor * actor_ptr, char * property_name)
    ...
    PUSH EAX                            ; 005c30b0
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 005c30b1
    ...
    PUSH EAX                            ; 005c30cd
    CALL core_actor.cpp_archiveActor_FUN_0040b870 ; 005c30ce
        ;   XREF to: 0040b870 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveActor_FUN_0040b870(CDemonActor * actor_ptr, char * property_name)
    ...
    PUSH EAX                            ; 005c30ea
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 005c30eb
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    PUSH EAX                            ; 005c3109
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 005c310a
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ADD ESP,0x8                         ; 005c310f
    PUSH 0x653c64                       ; 005c3112 | = "layerActionT"
    ADD EBX,0x2a90                      ; 005c3117
    PUSH EBX                            ; 005c311d
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 005c311e
