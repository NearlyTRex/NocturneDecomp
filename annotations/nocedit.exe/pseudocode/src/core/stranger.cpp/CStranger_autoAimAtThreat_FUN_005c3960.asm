...
section .text
    ...
    PUSH EBX                            ; 005c3960
        ;   Label: core_stranger.cpp_CStranger_autoAimAtThreat_FUN_005c3960
    PUSH ESI                            ; 005c3961
    PUSH EDI                            ; 005c3962
    PUSH EBP                            ; 005c3963
    ...
    MOV ESI,dword ptr [0x03f6bb00]      ; 005c3a10 | g_StrangerIndices[13]
    MOV EDI,dword ptr [0x03f6bad8]      ; 005c3a16 | g_StrangerIndices[3]
    ...
    MOV EAX,dword ptr [ESP + 0x170]     ; 005c3d85
        ;   Label: LAB_005c3d85
    MOV ESI,dword ptr [0x03f6bb04]      ; 005c3d8c | g_StrangerIndices[14]
    MOV EDI,dword ptr [0x03f6badc]      ; 005c3d92 | g_StrangerIndices[4]
    ...
    PUSH EAX                            ; 005c3f7f
    CALL core_vecdir.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 005c3f80
    ...
    CALL core_setcolid.cpp_CDemonSet_init_FUN_00574180 ; 005c408f
    ...
    CALL core_setcolid.cpp_CDemonSet_init_FUN_00574180 ; 005c40f9
        ;   XREF to: 00574180 (UNCONDITIONAL_CALL)  ; void core_setcolid.cpp_CDemonSet_init_FUN_00574180(CDemonSet * this_ptr)
