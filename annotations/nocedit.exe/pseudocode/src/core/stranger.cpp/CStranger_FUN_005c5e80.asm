...
section .text
    ...
    JNZ 0x005c5ec3                      ; 005c5e90 | LAB_005c5ec3
        ;   XREF to: 005c5ec3 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [EBX + 0x1fc2c]   ; 005c5e92
        ;   Label: LAB_005c5e92
    TEST ECX,ECX                        ; 005c5e98
    JZ 0x005c5ed8                       ; 005c5e9a | LAB_005c5ed8
        ;   XREF to: 005c5ed8 (CONDITIONAL_JUMP)
    CMP dword ptr [ECX + 0x2e0],0x3     ; 005c5e9c
    JNZ 0x005c5ed8                      ; 005c5ea3 | LAB_005c5ed8
        ;   XREF to: 005c5ed8 (CONDITIONAL_JUMP)
    FLD float ptr [0x00663744]          ; 005c5ea5 | undefined4 DAT_00663744
        ;   Label: LAB_005c5ea5
    ...
    JZ 0x005c5e92                       ; 005c5ed4 | LAB_005c5e92
        ;   XREF to: 005c5e92 (CONDITIONAL_JUMP)
    JMP 0x005c5ea5                      ; 005c5ed6 | LAB_005c5ea5
        ;   XREF to: 005c5ea5 (UNCONDITIONAL_JUMP)
    TEST ESI,ESI                        ; 005c5ed8
        ;   Label: LAB_005c5ed8
    JNZ 0x005c5ea5                      ; 005c5eda | LAB_005c5ea5
