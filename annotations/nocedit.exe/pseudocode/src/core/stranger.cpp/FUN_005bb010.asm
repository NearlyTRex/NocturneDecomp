...
;
; XREF[3]:
;   core_stranger.cpp_CStranger_FUN_005be520 at 005bf218
;   core_stranger.cpp_CStranger_FUN_005c07b0 at 005c1416
;   core_stranger.cpp_CStranger_FUN_005c2850 at 005c2b09
;
; Referenced Globals:
...
section .text
    ...
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 005bb024 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005bb029
    TEST EAX,EAX                        ; 005bb02c
    JNZ 0x005bb093                      ; 005bb02e | LAB_005bb093
        ;   XREF to: 005bb093 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x03f875d8]      ; 005bb030 | g_CCryptVesselClassInfo.name_hash
        ;   Label: LAB_005bb030
    PUSH ECX                            ; 005bb036
    PUSH ESI                            ; 005bb037
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 005bb038 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005bb03d
    TEST EAX,EAX                        ; 005bb040
    JZ 0x005bb054                       ; 005bb042 | LAB_005bb054
        ;   XREF to: 005bb054 (CONDITIONAL_JUMP)
    ADD EAX,0x158                       ; 005bb044
    PUSH EAX                            ; 005bb049
    CALL core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80 ; 005bb04a | CKeyFramedModel * core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80(CKeyFramedModelInstance * this_ptr)
        ;   XREF to: 00478d80 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005bb04f
    MOV EBX,EAX                         ; 005bb052
    TEST EBX,EBX                        ; 005bb054
        ;   Label: LAB_005bb054
    JZ 0x005bb0a5                       ; 005bb056 | LAB_005bb0a5
    ...
    JGE 0x005bb0b6                      ; 005bb06d | LAB_005bb0b6
    ...
    JGE 0x005bb086                      ; 005bb07b | LAB_005bb086
    ...
    JL 0x005bb0b2                       ; 005bb08b | LAB_005bb0b2
        ;   XREF to: 005bb0b2 (CONDITIONAL_JUMP)
    INC ECX                             ; 005bb08d
        ;   Label: LAB_005bb08d
    ADD EDX,0xc                         ; 005bb08e
    JMP 0x005bb065                      ; 005bb091 | LAB_005bb065
        ;   XREF to: 005bb065 (UNCONDITIONAL_JUMP)
    ADD EAX,0x158                       ; 005bb093
        ;   Label: LAB_005bb093
    PUSH EAX                            ; 005bb098
    CALL core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80 ; 005bb099 | CKeyFramedModel * core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80(CKeyFramedModelInstance * this_ptr)
        ;   XREF to: 00478d80 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005bb09e
    MOV EBX,EAX                         ; 005bb0a1
    JMP 0x005bb030                      ; 005bb0a3 | LAB_005bb030
    ...
    MOV ESI,EBP                         ; 005bb0b2
        ;   Label: LAB_005bb0b2
    JMP 0x005bb08d                      ; 005bb0b4 | LAB_005bb08d
    ...
    FMUL double ptr [0x006531ac]        ; 005bb0c4 | double DOUBLE_006531ac
