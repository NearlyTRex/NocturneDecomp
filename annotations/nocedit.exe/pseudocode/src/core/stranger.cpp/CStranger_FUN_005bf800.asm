...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_stranger_cpp_CStranger_FUN_005bf800(CStranger *this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EAX,[0x03f6bb1c]                ; 005bf874 | DAT_03f6bb1c
        ;   Label: LAB_005bf874
    ...
    MOV EAX,[0x03f6bb20]                ; 005bf892 | DAT_03f6bb20
