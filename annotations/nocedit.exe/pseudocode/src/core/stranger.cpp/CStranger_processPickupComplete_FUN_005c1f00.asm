...
;
; XREF[1]:
;   core_stranger.cpp_CStranger_processMotionEvents_FUN_005bdd20 at 005be2ce
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 005c1f00
        ;   Label: core_stranger.cpp_CStranger_processPickupComplete_FUN_005c1f00
    PUSH EBP                            ; 005c1f01
    ...
    PUSH EDX                            ; 005c1f3a
    PUSH EAX                            ; 005c1f3b
    CALL core_ammobox.cpp_CAmmoBox_FUN_00411700 ; 005c1f3c
