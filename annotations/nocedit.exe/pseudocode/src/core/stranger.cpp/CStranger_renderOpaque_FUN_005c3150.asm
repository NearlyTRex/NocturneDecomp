...
section .text
    ...
    PUSH EBX                            ; 005c3150
        ;   Label: core_stranger.cpp_CStranger_renderOpaque_FUN_005c3150
    PUSH ESI                            ; 005c3151
    PUSH EDI                            ; 005c3152
    PUSH EBP                            ; 005c3153
    ...
    CALL core_setcolid.cpp_CDemonSet_init_FUN_00574180 ; 005c31d4
    ...
    CALL core_setcolid.cpp_CDemonSet_init_FUN_00574180 ; 005c32ac
        ;   XREF to: 00574180 (UNCONDITIONAL_CALL)  ; void core_setcolid.cpp_CDemonSet_init_FUN_00574180(CDemonSet * this_ptr)
    ...
    ADD ESP,0x8                         ; 005c349f
        ;   Label: LAB_005c349f
    JMP 0x03fc5960                      ; 005c34a2
        ;   XREF to: 03fc5960 (UNCONDITIONAL_JUMP)  ; LAB_03fc5960
    PUSH EAX                            ; 005c34a7
        ;   Label: LAB_005c34a7
    ...
    CALL engine_drender.cpp_CDemonRenderer_matrixPop_FUN_0048c640 ; 005c34f7
    ...
    CALL engine_drender.cpp_CDemonRenderer_isShadowPass_FUN_0048cae0 ; 005c351e
    ...
    JMP 0x03fc4cbe                      ; 005c35cd
        ;   XREF to: 03fc4cbe (UNCONDITIONAL_JUMP)  ; LAB_03fc4cbe
    ...
    CALL engine_drender.cpp_CDemonRenderer_matrixPop_FUN_0048c640 ; 005c362e
        ;   XREF to: 0048c640 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_matrixPop_FUN_0048c640(CDemonRenderer * this_ptr)
    ...
    MOV ECX,0xc                         ; 03fc4cbe
        ;   Label: LAB_03fc4cbe
    PUSH EAX                            ; 03fc4cc3
    LEA EAX,[EBP + 0xffffff52]          ; 03fc4cc4
    LEA ESI,[EBP + 0xfffffe62]          ; 03fc4cca
    PUSH EAX                            ; 03fc4cd0
    MOV ECX,dword ptr [ESI]             ; 03fc4cd1
    MOV dword ptr [EDI],ECX             ; 03fc4cd3
    MOV ECX,dword ptr [ESI + 0x4]       ; 03fc4cd5
    MOV dword ptr [EDI + 0x4],ECX       ; 03fc4cd8
    MOV ECX,dword ptr [ESI + 0x8]       ; 03fc4cdb
    MOV dword ptr [EDI + 0x8],ECX       ; 03fc4cde
    MOV ECX,dword ptr [ESI + 0xc]       ; 03fc4ce1
    MOV dword ptr [EDI + 0xc],ECX       ; 03fc4ce4
    MOV ECX,dword ptr [ESI + 0x10]      ; 03fc4ce7
    MOV dword ptr [EDI + 0x10],ECX      ; 03fc4cea
    MOV ECX,dword ptr [ESI + 0x14]      ; 03fc4ced
    MOV dword ptr [EDI + 0x14],ECX      ; 03fc4cf0
    MOV ECX,dword ptr [ESI + 0x18]      ; 03fc4cf3
    MOV dword ptr [EDI + 0x18],ECX      ; 03fc4cf6
    MOV ECX,dword ptr [ESI + 0x1c]      ; 03fc4cf9
    MOV dword ptr [EDI + 0x1c],ECX      ; 03fc4cfc
    MOV ECX,dword ptr [ESI + 0x20]      ; 03fc4cff
    MOV dword ptr [EDI + 0x20],ECX      ; 03fc4d02
    MOV ECX,dword ptr [ESI + 0x24]      ; 03fc4d05
    MOV dword ptr [EDI + 0x24],ECX      ; 03fc4d08
    MOV ECX,dword ptr [ESI + 0x28]      ; 03fc4d0b
    MOV dword ptr [EDI + 0x28],ECX      ; 03fc4d0e
    MOV ECX,dword ptr [ESI + 0x2c]      ; 03fc4d11
    MOV dword ptr [EDI + 0x2c],ECX      ; 03fc4d14
    ADD ESI,0x30                        ; 03fc4d17
    ADD EDI,0x30                        ; 03fc4d1a
    XOR ECX,ECX                         ; 03fc4d1d
    JMP 0x005c35e2                      ; 03fc4d1f
        ;   XREF to: 005c35e2 (UNCONDITIONAL_JUMP)  ; LAB_005c35e2
    MOV ECX,dword ptr [ESI]             ; 03fc5960
        ;   Label: LAB_03fc5960
    MOV dword ptr [EDI],ECX             ; 03fc5962
    MOV ECX,dword ptr [ESI + 0x4]       ; 03fc5964
    MOV dword ptr [EDI + 0x4],ECX       ; 03fc5967
    MOV ECX,dword ptr [ESI + 0x8]       ; 03fc596a
    MOV dword ptr [EDI + 0x8],ECX       ; 03fc596d
    MOV ECX,dword ptr [ESI + 0xc]       ; 03fc5970
    MOV dword ptr [EDI + 0xc],ECX       ; 03fc5973
    MOV ECX,dword ptr [ESI + 0x10]      ; 03fc5976
    MOV dword ptr [EDI + 0x10],ECX      ; 03fc5979
    MOV ECX,dword ptr [ESI + 0x14]      ; 03fc597c
    MOV dword ptr [EDI + 0x14],ECX      ; 03fc597f
    MOV ECX,dword ptr [ESI + 0x18]      ; 03fc5982
    MOV dword ptr [EDI + 0x18],ECX      ; 03fc5985
    MOV ECX,dword ptr [ESI + 0x1c]      ; 03fc5988
    MOV dword ptr [EDI + 0x1c],ECX      ; 03fc598b
    MOV ECX,dword ptr [ESI + 0x20]      ; 03fc598e
    MOV dword ptr [EDI + 0x20],ECX      ; 03fc5991
    MOV ECX,dword ptr [ESI + 0x24]      ; 03fc5994
    MOV dword ptr [EDI + 0x24],ECX      ; 03fc5997
    MOV ECX,dword ptr [ESI + 0x28]      ; 03fc599a
    MOV dword ptr [EDI + 0x28],ECX      ; 03fc599d
    MOV ECX,dword ptr [ESI + 0x2c]      ; 03fc59a0
    MOV dword ptr [EDI + 0x2c],ECX      ; 03fc59a3
    ADD ESI,0x30                        ; 03fc59a6
    ADD EDI,0x30                        ; 03fc59a9
    XOR ECX,ECX                         ; 03fc59ac
    LEA EAX,[EBP + 0x4e]                ; 03fc59ae
    JMP 0x005c34a7                      ; 03fc59b1
        ;   XREF to: 005c34a7 (UNCONDITIONAL_JUMP)  ; LAB_005c34a7
