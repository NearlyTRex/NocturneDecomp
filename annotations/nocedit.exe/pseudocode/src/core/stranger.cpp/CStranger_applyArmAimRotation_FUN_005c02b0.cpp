  ...
  *puVar5 = *puVar4;
  ...
  if (0.0 < local_1e0) {
    ...
    local_34 = core_motion_cpp_CMotionController_markerPositionToFrame_FUN_0052e3a0
                         (&local_1c->motion_controller,iVar1,(this_ptr->base).base.layer_action_t);
    local_18 = local_34;
    ...
    *puVar4 = *puVar3;
    puVar4[(uint)bVar7 * -2 + 1] = puVar3[(uint)bVar7 * -2 + 1];
    core_xform_cpp_slerpQuaternion_FUN_005f77e0(&CQuaternion4f_00665998,pCVar2,fVar8,&local_9c);
    pCVar2 = &local_18c;
