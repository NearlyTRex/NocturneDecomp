...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_stranger.cpp_CStranger_FUN_005c1fe0()
;
; Local Variables:
...
section .text
    ...
    CALL core_charactr.cpp_CCharacter_FUN_0042e840 ; 005c1fff | undefined core_charactr.cpp_CCharacter_FUN_0042e840()
    ...
    FCOMP double ptr [0x00653aec]       ; 005c2015 | double DOUBLE_00653aec
    FNSTSW AX                           ; 005c201b
    SAHF                                ; 005c201d
    JC 0x005c205f                       ; 005c201e | LAB_005c205f
        ;   XREF to: 005c205f (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [EDI + 0x24b4]    ; 005c2020
    TEST EDX,EDX                        ; 005c2026
    JNZ 0x005c205f                      ; 005c2028 | LAB_005c205f
        ;   XREF to: 005c205f (CONDITIONAL_JUMP)
    CMP dword ptr [EDI + 0x24f8],0x0    ; 005c202a
    JNZ 0x005c205f                      ; 005c2031 | LAB_005c205f
        ;   XREF to: 005c205f (CONDITIONAL_JUMP)
    ...
    JMP 0x005c204b                      ; 005c2088 | LAB_005c204b
    ...
    PUSH EAX                            ; 005c20a0
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 005c20a1 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 005c20a6
    ADD ESP,0x8                         ; 005c20a8
    MOV ESI,EAX                         ; 005c20ab
    TEST EAX,EAX                        ; 005c20ad
    JZ 0x005c2068                       ; 005c20af | LAB_005c2068
        ;   XREF to: 005c2068 (CONDITIONAL_JUMP)
    FLD float ptr [EDI + 0x24]          ; 005c20b1
    FSUB float ptr [EAX + 0x24]         ; 005c20b4
    FABS                                ; 005c20b7
    FCOMP double ptr [0x00653afc]       ; 005c20b9 | double DOUBLE_00653afc
    FNSTSW AX                           ; 005c20bf
    SAHF                                ; 005c20c1
    JA 0x005c2068                       ; 005c20c2 | LAB_005c2068
        ;   XREF to: 005c2068 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 005c20d0
    PUSH EBX                            ; 005c20d1
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 005c20d2 | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
        ;   XREF to: 00408f10 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005c20d7
    FLD float ptr [ESP + 0x4c]          ; 005c20da
    FST double ptr [ESP]                ; 005c20de
    FABS                                ; 005c20e1
    FCOMP double ptr [0x00653b04]       ; 005c20e3 | double DOUBLE_00653b04
    FNSTSW AX                           ; 005c20e9
    SAHF                                ; 005c20eb
    JA 0x005c2068                       ; 005c20ec | LAB_005c2068
        ;   XREF to: 005c2068 (CONDITIONAL_JUMP)
    FLDZ                                ; 005c20f2
    FCOMP double ptr [ESP]              ; 005c20f4
    FNSTSW AX                           ; 005c20f7
    SAHF                                ; 005c20f9
    JA 0x005c2068                       ; 005c20fa | LAB_005c2068
        ;   XREF to: 005c2068 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 005c211a
    SAHF                                ; 005c211c
    JBE 0x005c213e                      ; 005c211d | LAB_005c213e
    ...
    FNSTSW AX                           ; 005c212d
    SAHF                                ; 005c212f
    JA 0x005c2068                       ; 005c2130 | LAB_005c2068
        ;   XREF to: 005c2068 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 005c2146
    SAHF                                ; 005c2148
    JNC 0x005c216c                      ; 005c2149 | LAB_005c216c
        ;   XREF to: 005c216c (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x8]           ; 005c214b
    FADD double ptr [0x00653b0c]        ; 005c214f | double DOUBLE_00653b0c
    FLD float ptr [ESP + 0x44]          ; 005c2155
    FCOMPP                              ; 005c2159
    FNSTSW AX                           ; 005c215b
    SAHF                                ; 005c215d
    JC 0x005c2068                       ; 005c215e | LAB_005c2068
        ;   XREF to: 005c2068 (CONDITIONAL_JUMP)
    ...
    FLD float ptr [0x00653af4]          ; 005c2178 | float FLOAT_00653af4
    FXCH                                ; 005c217e
    FMUL ST1                            ; 005c2180
    ...
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 005c21c3 | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
        ;   XREF to: 00408ec0 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 005c21c8
    LEA EAX,[ESP + 0x50]                ; 005c21ca
    ADD ESP,0xc                         ; 005c21ce
    CMP EAX,EBX                         ; 005c21d1
    JZ 0x005c21e9                       ; 005c21d3 | LAB_005c21e9
    ...
    FABS                                ; 005c229e
    FLD double ptr [0x00653b14]         ; 005c22a0 | double DOUBLE_00653b14
    FCOS                                ; 005c22a6
    FCOMPP                              ; 005c22a8
    FNSTSW AX                           ; 005c22aa
    SAHF                                ; 005c22ac
    JA 0x005c2068                       ; 005c22ad | LAB_005c2068
        ;   XREF to: 005c2068 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 005c22bb
    PUSH EDI                            ; 005c22bc
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 005c22bd | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
        ;   XREF to: 00408f10 (UNCONDITIONAL_CALL)
    ...
    FNSTSW AX                           ; 005c22cc
    SAHF                                ; 005c22ce
    JNC 0x005c2068                      ; 005c22cf | LAB_005c2068
        ;   XREF to: 005c2068 (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 005c22d5
    PUSH 0x2a                           ; 005c22d7
    ...
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 005c22e6 | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
    ...
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 005c2328 | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
        ;   XREF to: 00408ec0 (UNCONDITIONAL_CALL)
    ...
    JZ 0x005c2383                       ; 005c2364 | LAB_005c2383
    ...
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 005c23b7 | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005c23bc
    PUSH ESI                            ; 005c23bf
    MOV EDX,dword ptr [0x0066e8e0]      ; 005c23c0 | CConsole g_ConsolePtr | CConsole * g_CConsolePtr
    PUSH 0x653ad4                       ; 005c23c6 | = "Climbing ladder %s\n" | s_Climbing_ladder_s_00653ad4 = Climbing ladder %s

    FLD float ptr [EAX + 0x4]           ; 005c23cb
    PUSH EDX                            ; 005c23ce | CConsole g_ConsolePtr
    FSTP float ptr [EDI + 0x1fe60]      ; 005c23cf
    MOV dword ptr [EDI + 0x1fe64],0x3f800000 ; 005c23d5
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 005c23df | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
