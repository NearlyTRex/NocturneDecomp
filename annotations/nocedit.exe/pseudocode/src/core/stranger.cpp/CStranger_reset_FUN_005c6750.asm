...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_stranger_cpp_CStranger_reset_FUN_005c6750(CStranger *this_ptr)
;
; Parameters:
...
;
; Called Functions:
;   core_hero.cpp_CHero_reset_FUN_004f3b20
...
section .text
    ...
    PUSH EBX                            ; 005c6750
        ;   Label: core_stranger.cpp_CStranger_reset_FUN_005c6750
    MOV EBX,dword ptr [ESP + 0x8]       ; 005c6751
    PUSH EBX                            ; 005c6755
    ADD EBX,0x158                       ; 005c6756
    CALL core_hero.cpp_CHero_reset_FUN_004f3b20 ; 005c675c
        ;   XREF to: 004f3b20 (UNCONDITIONAL_CALL)  ; void core_hero.cpp_CHero_reset_FUN_004f3b20(CHero * this_ptr)
