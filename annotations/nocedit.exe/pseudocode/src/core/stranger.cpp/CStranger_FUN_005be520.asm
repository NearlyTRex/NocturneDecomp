...
section .text
    ...
    MOV EDX,dword ptr [0x03f6badc]      ; 005be64c | DAT_03f6badc
    PUSH EDX                            ; 005be652
    ...
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 005be6c4
    ...
    MOV ESI,dword ptr [0x03f6bb10]      ; 005be729 | DAT_03f6bb10
    PUSH ESI                            ; 005be72f
    ...
    MOV EAX,[0x03f6badc]                ; 005be76d | DAT_03f6badc
    PUSH EAX                            ; 005be772
    ...
    PUSH 0x59ddb0                       ; 005be7e9
        ;   Label: LAB_005be7e9
    MOV ESI,dword ptr [0x03f6bacc]      ; 005be7ee | DAT_03f6bacc
    PUSH ESI                            ; 005be7f4
    ...
    MOV ECX,dword ptr [0x03f6badc]      ; 005be926 | DAT_03f6badc
    ...
    PUSH EAX                            ; 005be9cf
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 005be9d0
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)  ; CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
    ...
    MOV EAX,[0x03f6badc]                ; 005bea6f | DAT_03f6badc
    PUSH EAX                            ; 005bea74
    ...
    MOV ECX,dword ptr [0x03f6bae4]      ; 005beacc | DAT_03f6bae4
    ...
    MOV EDI,dword ptr [0x03f6badc]      ; 005beb2e | DAT_03f6badc
    PUSH EDI                            ; 005beb34
    ...
    MOV EDX,dword ptr [0x03f6badc]      ; 005beb72 | DAT_03f6badc
    PUSH EDX                            ; 005beb78
    ...
    MOV EAX,[0x03f6badc]                ; 005bebbb | DAT_03f6badc
    PUSH EAX                            ; 005bebc0
    ...
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 005bec2b
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)  ; CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
    ...
    MOV ECX,dword ptr [0x03f6badc]      ; 005bec82 | DAT_03f6badc
    PUSH ECX                            ; 005bec88
    ...
    MOV EDI,dword ptr [0x03f6badc]      ; 005becea | DAT_03f6badc
    PUSH EDI                            ; 005becf0
    ...
    MOV EDI,dword ptr [0x03f6badc]      ; 005bee6f | DAT_03f6badc
    PUSH EDI                            ; 005bee75
    ...
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 005beee6
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)  ; CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
    ...
    MOV EDX,dword ptr [0x03f6bb10]      ; 005bef35 | DAT_03f6bb10
    PUSH EDX                            ; 005bef3b
    ...
    MOV ESI,dword ptr [0x03f6badc]      ; 005befa0 | DAT_03f6badc
    PUSH ESI                            ; 005befa6
    ...
    MOV EDI,dword ptr [0x03f6badc]      ; 005bf0ff | DAT_03f6badc
    PUSH EDI                            ; 005bf105
    ...
    MOV EDX,dword ptr [0x03f6bad8]      ; 005bf14b | DAT_03f6bad8
    PUSH EDX                            ; 005bf151
    ...
    MOV ECX,dword ptr [0x03f6badc]      ; 005bf1d6 | DAT_03f6badc
        ;   Label: LAB_005bf1d6
    PUSH ECX                            ; 005bf1dc
    ...
    MOV EAX,[0x03f6badc]                ; 005bf27e | DAT_03f6badc
    PUSH EAX                            ; 005bf283
    ...
    MOV ECX,dword ptr [0x03f6bad8]      ; 005bf2bd | DAT_03f6bad8
    PUSH ECX                            ; 005bf2c3
    ...
    MOV EDI,dword ptr [0x03f6badc]      ; 005bf324 | DAT_03f6badc
    PUSH EDI                            ; 005bf32a
    ...
    MOV EDX,dword ptr [0x03f6bad8]      ; 005bf36a | DAT_03f6bad8
    PUSH EDX                            ; 005bf370
    ...
    MOV EDX,dword ptr [0x03f6badc]      ; 005bf427 | DAT_03f6badc
    PUSH EDX                            ; 005bf42d
    ...
    MOV ESI,dword ptr [0x03f6bad8]      ; 005bf497 | DAT_03f6bad8
    PUSH ESI                            ; 005bf49d
    ...
    MOV EDI,dword ptr [0x03f6badc]      ; 005bf524 | DAT_03f6badc
        ;   Label: LAB_005bf524
    PUSH EDI                            ; 005bf52a
    ...
    MOV EDX,dword ptr [0x03f6badc]      ; 005bf57d | DAT_03f6badc
    PUSH EDX                            ; 005bf583
    ...
    MOV ESI,dword ptr [0x03f6bad8]      ; 005bf5b7 | DAT_03f6bad8
    PUSH ESI                            ; 005bf5bd
    ...
    MOV EAX,[0x03f6badc]                ; 005bf60c | DAT_03f6badc
    PUSH EAX                            ; 005bf611
    ...
    MOV ECX,dword ptr [0x03f6bad8]      ; 005bf663 | DAT_03f6bad8
    ...
    MOV EAX,[0x03f6bb0c]                ; 005bf6e7 | DAT_03f6bb0c
    PUSH EAX                            ; 005bf6ec
