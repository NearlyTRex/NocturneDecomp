...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_stranger.cpp_CStranger_FUN_005c48b0()
;
; Local Variables:
...
section .text
    ...
    MOV EAX,[0x0067b654]                ; 005c48bf | CGame * g_CGamePtr
    CMP dword ptr [EAX + 0x1d0],0x0     ; 005c48c4 | DAT_02d81c6c
    JNZ 0x005c4b0c                      ; 005c48cb | LAB_005c4b0c
        ;   XREF to: 005c4b0c (CONDITIONAL_JUMP)
    MOV EAX,[0x0067b654]                ; 005c48d1 | CGame g_CGameInstance | CGame * g_CGamePtr
        ;   Label: LAB_005c48d1
    MOV ECX,dword ptr [EAX + 0x22c]     ; 005c48d6 | DAT_02d81cc8
    TEST ECX,ECX                        ; 005c48dc
    JNZ 0x005c48e3                      ; 005c48de | LAB_005c48e3
        ;   XREF to: 005c48e3 (CONDITIONAL_JUMP)
    MOV dword ptr [ESI + 0x4],ECX       ; 005c48e0
    PUSH EBX                            ; 005c48e3
        ;   Label: LAB_005c48e3
    CALL core_hero.cpp_FUN_004f3580     ; 005c48e4 | undefined core_hero.cpp_FUN_004f3580()
    ...
    FNSTSW AX                           ; 005c48f6
    SAHF                                ; 005c48f8
    JNC 0x005c4905                      ; 005c48f9 | LAB_005c4905
        ;   XREF to: 005c4905 (CONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0x30],0xb      ; 005c48fb
    JG 0x005c4b18                       ; 005c48ff | LAB_005c4b18
        ;   XREF to: 005c4b18 (CONDITIONAL_JUMP)
    FLD float ptr [0x00663738]          ; 005c4905 | DAT_00663738
        ;   Label: LAB_005c4905
    PUSH 0x653d1c                       ; 005c490b | = "CBugs" | s_CBugs_00653d1c = CBugs
    FSTP float ptr [EBX + 0xbe24]       ; 005c4910
    MOV EAX,dword ptr [ESI + 0x38]      ; 005c4916
    PUSH EAX                            ; 005c4919
    CALL core_actor.cpp_isOfClass_FUN_0040c6d0 ; 005c491a | int core_actor.cpp_isOfClass_FUN_0040c6d0(CDemonActor * actor_ptr, char * class_name)
        ;   XREF to: 0040c6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005c491f
    TEST EAX,EAX                        ; 005c4922
    JZ 0x005c4930                       ; 005c4924 | LAB_005c4930
    ...
    FNSTSW AX                           ; 005c495d
    SAHF                                ; 005c495f
    JC 0x005c49ae                       ; 005c4960 | LAB_005c49ae
        ;   XREF to: 005c49ae (CONDITIONAL_JUMP)
    PUSH 0x653d22                       ; 005c4962 | = "Using auto health\n" | s_Using_auto_health_00653d22 = Using auto health

    MOV EDI,dword ptr [0x0066e8e0]      ; 005c4967 | CConsole * g_CConsolePtr
    PUSH EDI                            ; 005c496d | CConsole g_ConsolePtr
    MOV dword ptr [EBX + 0x243c],0x0    ; 005c496e
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 005c4978 | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
        ;   XREF to: 00441890 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005c497d
    LEA EAX,[EBX + 0x1f738]             ; 005c4980
    PUSH EAX                            ; 005c4986
    CALL core_inv.cpp_CInventory_autoUseHealthItem_FUN_00501570 ; 005c4987 | void core_inv.cpp_CInventory_autoUseHealthItem_FUN_00501570(CInventory * this_ptr)
    ...
    PUSH 0x653d35                       ; 005c499b | = "hit points: %3.2f\n" | s_hit_points_3_2f_00653d35 = hit points: %3.2f

    MOV EAX,[0x0066e8e0]                ; 005c49a0 | CConsole * g_CConsolePtr
    PUSH EAX                            ; 005c49a5 | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 005c49a6 | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
        ;   XREF to: 00441890 (UNCONDITIONAL_CALL)
    ...
    FNSTSW AX                           ; 005c49be
    SAHF                                ; 005c49c0
    JC 0x005c4b7c                       ; 005c49c1 | LAB_005c4b7c
    ...
    PUSH EDI                            ; 005c49e1
    CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0 ; 005c49e2 | SMotion * core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0(CMotionController * this_ptr)
        ;   XREF to: 0052dab0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EAX + 0x24]      ; 005c49e7
    ADD ESP,0x4                         ; 005c49ea
    CMP EAX,0x29                        ; 005c49ed
    JZ 0x005c4a86                       ; 005c49f0 | LAB_005c4a86
        ;   XREF to: 005c4a86 (CONDITIONAL_JUMP)
    PUSH EDI                            ; 005c49f6
    CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0 ; 005c49f7 | SMotion * core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0(CMotionController * this_ptr)
        ;   XREF to: 0052dab0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EAX + 0x24]      ; 005c49fc
    ADD ESP,0x4                         ; 005c49ff
    CMP EAX,0x28                        ; 005c4a02
    JZ 0x005c4a86                       ; 005c4a05 | LAB_005c4a86
        ;   XREF to: 005c4a86 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x1fbac],0x0   ; 005c4a0b
    JZ 0x005c4b26                       ; 005c4a12 | LAB_005c4b26
    ...
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 005c4a37 | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   Label: LAB_005c4a37
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005c4a3c
    MOV ECX,dword ptr [EBX + 0x1fe68]   ; 005c4a3f
    PUSH ECX                            ; 005c4a45
    CALL sound_sndmain.cpp_killSfx_FUN_005a9c40 ; 005c4a46 | int sound_sndmain.cpp_killSfx_FUN_005a9c40(uint sfx_handle)
        ;   XREF to: 005a9c40 (UNCONDITIONAL_CALL)
    MOV EDI,dword ptr [ESI + 0x30]      ; 005c4a4b
    ADD ESP,0x4                         ; 005c4a4e
    CMP EDI,0x1                         ; 005c4a51
    JZ 0x005c4a6e                       ; 005c4a54 | LAB_005c4a6e
        ;   XREF to: 005c4a6e (CONDITIONAL_JUMP)
    PUSH 0x653d48                       ; 005c4a56 | = "stranger_die??.wav" | s_stranger_die_wav_00653d48 = stranger_die??.wav
    ...
    PUSH 0x32                           ; 005c4a75
    PUSH EBX                            ; 005c4a77
    MOV EAX,[0x0067b9a0]                ; 005c4a78 | CGore g_CGoreInstance | CGore * g_CGorePtr
    PUSH EAX                            ; 005c4a7d | CGore g_CGoreInstance
    CALL core_gore.cpp_CGore_FUN_004ee030 ; 005c4a7e | void core_gore.cpp_CGore_FUN_004ee030(CGore * this_ptr, CDemonActor * actor)
    ...
    JNZ 0x005c4a9e                      ; 005c4a92 | LAB_005c4a9e
    ...
    JNZ 0x005c4acc                      ; 005c4ac0 | LAB_005c4acc
    ...
    FNSTSW AX                           ; 005c4ae7
    SAHF                                ; 005c4ae9
    JNC 0x005c4afb                      ; 005c4aea | LAB_005c4afb
        ;   XREF to: 005c4afb (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [0x0067b654]      ; 005c4aec | CGame * g_CGamePtr
    PUSH EDI                            ; 005c4af2 | CGame g_CGameInstance
    CALL core_game.cpp_CGame_FUN_004e0bd0 ; 005c4af3 | void core_game.cpp_CGame_FUN_004e0bd0(CGame * this_ptr)
        ;   XREF to: 004e0bd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005c4af8
    PUSH ESI                            ; 005c4afb
        ;   Label: LAB_005c4afb
    PUSH EBX                            ; 005c4afc
    CALL core_charactr.cpp_CCharacter_FUN_0042c3c0 ; 005c4afd | void core_charactr.cpp_CCharacter_FUN_0042c3c0(CCharacter * this_ptr)
    ...
    MOV dword ptr [ESI + 0x4],0x0       ; 005c4b0c
        ;   Label: LAB_005c4b0c
    JMP 0x005c48d1                      ; 005c4b13 | LAB_005c48d1
    ...
    CMP dword ptr [EBX + 0x1fc28],0x0   ; 005c4b26
        ;   Label: LAB_005c4b26
    JNZ 0x005c4a18                      ; 005c4b2d | LAB_005c4a18
        ;   XREF to: 005c4a18 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [ESI + 0x30]      ; 005c4b33
    CMP EDX,0x1                         ; 005c4b36
    JNZ 0x005c4b44                      ; 005c4b39 | LAB_005c4b44
        ;   XREF to: 005c4b44 (CONDITIONAL_JUMP)
    PUSH EDX                            ; 005c4b3b
    PUSH 0x27                           ; 005c4b3c
    PUSH EDI                            ; 005c4b3e
    JMP 0x005c4a37                      ; 005c4b3f | LAB_005c4a37
        ;   XREF to: 005c4a37 (UNCONDITIONAL_JUMP)
    PUSH 0x1                            ; 005c4b44
        ;   Label: LAB_005c4b44
    PUSH 0x42c80000                     ; 005c4b46
    PUSH 0x0                            ; 005c4b4b
    CALL core_actor.cpp_getRandomFloat_FUN_0040cc10 ; 005c4b4d | float core_actor.cpp_getRandomFloat_FUN_0040cc10(float min_value, float max_value)
    ...
    FNSTSW AX                           ; 005c4b83
    SAHF                                ; 005c4b85
    JNC 0x005c4ae0                      ; 005c4b86 | LAB_005c4ae0
        ;   XREF to: 005c4ae0 (CONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0x30],0x69     ; 005c4b8c
    JZ 0x005c4be2                       ; 005c4b90 | LAB_005c4be2
        ;   XREF to: 005c4be2 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x1fbac],0x0   ; 005c4b92
    JNZ 0x005c4be2                      ; 005c4b99 | LAB_005c4be2
        ;   XREF to: 005c4be2 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x1fc28],0x0   ; 005c4b9b
    JNZ 0x005c4be2                      ; 005c4ba2 | LAB_005c4be2
        ;   XREF to: 005c4be2 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x1fc38],0x0   ; 005c4ba4
    JNZ 0x005c4be2                      ; 005c4bab | LAB_005c4be2
        ;   XREF to: 005c4be2 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x03f873dc]      ; 005c4bad | g_CTommyGunClassInfo.name_hash
    PUSH ECX                            ; 005c4bb3
    MOV EAX,dword ptr [ESI + 0x34]      ; 005c4bb4
    PUSH EAX                            ; 005c4bb7
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 005c4bb8 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005c4bbd
    TEST EAX,EAX                        ; 005c4bc0
    JZ 0x005c4bd5                       ; 005c4bc2 | LAB_005c4bd5
        ;   XREF to: 005c4bd5 (CONDITIONAL_JUMP)
    PUSH 0x3eaa7efa                     ; 005c4bc4
    CALL core_actor.cpp_randomChance_FUN_0040cd10 ; 005c4bc9 | int core_actor.cpp_randomChance_FUN_0040cd10(float probability_threshold)
        ;   XREF to: 0040cd10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005c4bce
    TEST EAX,EAX                        ; 005c4bd1
    JZ 0x005c4be2                       ; 005c4bd3 | LAB_005c4be2
        ;   XREF to: 005c4be2 (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 005c4bd5
        ;   Label: LAB_005c4bd5
    PUSH 0x24                           ; 005c4bd7
    PUSH EDI                            ; 005c4bd9
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 005c4bda | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005c4bdf
    MOV EDX,dword ptr [EBX + 0x1fe68]   ; 005c4be2
        ;   Label: LAB_005c4be2
    PUSH EDX                            ; 005c4be8
    CALL sound_sndmain.cpp_isSfxPlaying_FUN_005a9660 ; 005c4be9 | int sound_sndmain.cpp_isSfxPlaying_FUN_005a9660(uint sfx_handle)
        ;   XREF to: 005a9660 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005c4bee
    TEST EAX,EAX                        ; 005c4bf1
    JNZ 0x005c4ae0                      ; 005c4bf3 | LAB_005c4ae0
        ;   XREF to: 005c4ae0 (CONDITIONAL_JUMP)
    PUSH 0x653d5b                       ; 005c4bf9 | = "stranger_hit??.wav" | s_stranger_hit_wav_00653d5b = stranger_hit??.wav
    ...
    JMP 0x005c4ae0                      ; 005c4c11 | LAB_005c4ae0
