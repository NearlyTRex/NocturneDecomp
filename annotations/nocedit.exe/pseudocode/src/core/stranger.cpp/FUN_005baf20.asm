...
section .text
    ...
    PUSH ECX                            ; 005baf46
    PUSH EDX                            ; 005baf47
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 005baf48 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005baf4d
    TEST EAX,EAX                        ; 005baf50
    JZ 0x005baf3d                       ; 005baf52 | caseD_8
        ;   XREF to: 005baf3d (CONDITIONAL_JUMP)
    CMP dword ptr [EAX + 0x588],0x0     ; 005baf54
    JZ 0x005baf3d                       ; 005baf5b | caseD_8
        ;   XREF to: 005baf3d (CONDITIONAL_JUMP)
    MOV EAX,0x3                         ; 005baf5d
    RET                                 ; 005baf62
    JBE 0x005baf40                      ; 005baf63 | LAB_005baf40
        ;   Label: LAB_005baf63
        ;   XREF to: 005baf40 (CONDITIONAL_JUMP)
    CMP EAX,0x8                         ; 005baf65
    JZ 0x005baf40                       ; 005baf68 | LAB_005baf40
        ;   XREF to: 005baf40 (CONDITIONAL_JUMP)
