...
section .text
    ...
    PUSH EBX                            ; 005bb4eb
    MOV [0x03f6bacc],EAX                ; 005bb4ec | g_StrangerIndices
    ...
    PUSH EBX                            ; 005bb500
    MOV [0x03f6bad0],EAX                ; 005bb501 | g_StrangerIndices[1]
    ...
    PUSH EBX                            ; 005bb515
    MOV [0x03f6bad4],EAX                ; 005bb516 | g_StrangerIndices[2]
    ...
    PUSH EBX                            ; 005bb52a
    MOV [0x03f6bad8],EAX                ; 005bb52b | g_StrangerIndices[3]
    ...
    PUSH EBX                            ; 005bb53f
    MOV [0x03f6badc],EAX                ; 005bb540 | g_StrangerIndices[4]
    ...
    PUSH EBX                            ; 005bb554
    MOV [0x03f6bae0],EAX                ; 005bb555 | g_StrangerIndices[5]
    ...
    PUSH EBX                            ; 005bb569
    MOV [0x03f6bae4],EAX                ; 005bb56a | g_StrangerIndices[6]
    ...
    PUSH EBX                            ; 005bb57e
    MOV [0x03f6bae8],EAX                ; 005bb57f | g_StrangerIndices[7]
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 005bb584
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 005bb589
    MOV [0x03f6baec],EAX                ; 005bb58c | g_StrangerIndices[8]
    PUSH 0x1                            ; 005bb591
    ...
    PUSH EBX                            ; 005bb5a8
    MOV [0x03f6baf0],EAX                ; 005bb5a9 | g_StrangerIndices[9]
    ...
    PUSH EBX                            ; 005bb5bd
    MOV [0x03f6baf4],EAX                ; 005bb5be | g_StrangerIndices[10]
    ...
    PUSH EBX                            ; 005bb5d2
    MOV [0x03f6baf8],EAX                ; 005bb5d3 | g_StrangerIndices[11]
    ...
    PUSH EBX                            ; 005bb5e7
    MOV [0x03f6bafc],EAX                ; 005bb5e8 | g_StrangerIndices[12]
    ...
    PUSH EBX                            ; 005bb5fc
    MOV [0x03f6bb00],EAX                ; 005bb5fd | g_StrangerIndices[13]
    ...
    PUSH EBX                            ; 005bb611
    MOV [0x03f6bb04],EAX                ; 005bb612 | g_StrangerIndices[14]
    ...
    PUSH EBX                            ; 005bb626
    MOV [0x03f6bb08],EAX                ; 005bb627 | g_StrangerIndices[15]
    ...
    PUSH EBX                            ; 005bb63b
    MOV [0x03f6bb0c],EAX                ; 005bb63c | g_StrangerIndices[16]
    ...
    PUSH EBX                            ; 005bb650
    MOV [0x03f6bb10],EAX                ; 005bb651 | g_StrangerIndices[17]
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 005bb656
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 005bb65b
    MOV [0x03f6bb14],EAX                ; 005bb65e | g_StrangerIndices[18]
    PUSH 0x1                            ; 005bb663
    ...
    PUSH 0x1                            ; 005bb673
    MOV [0x03f6bb18],EAX                ; 005bb675 | g_StrangerIndices[19]
    MOV EAX,[0x03f6bb00]                ; 005bb67a | g_StrangerIndices[13]
    PUSH 0x653471                       ; 005bb67f | = "turnlstart"
    MOV dword ptr [ESI + 0x24ac],EAX    ; 005bb684
    MOV EAX,[0x03f6bb04]                ; 005bb68a | g_StrangerIndices[14]
    PUSH EDI                            ; 005bb68f
    ...
    PUSH EDI                            ; 005bb6ae
    MOV [0x03f6bb1c],EAX                ; 005bb6af | g_StrangerIndices[20]
    ...
    PUSH EDI                            ; 005bb6cc
    MOV [0x03f6bb20],EAX                ; 005bb6cd | g_StrangerIndices[21]
    ...
    MOV EDX,dword ptr [0x03f6bb04]      ; 005bb6f2 | g_StrangerIndices[14]
    PUSH EDX                            ; 005bb6f8
    ...
    MOV ECX,dword ptr [0x03f6badc]      ; 005bb721 | g_StrangerIndices[4]
        ;   Label: LAB_005bb721
    PUSH ECX                            ; 005bb727
    ...
    MOV [0x03f6bb24],EAX                ; 005bb7cd | g_StrangerIndices[22]
