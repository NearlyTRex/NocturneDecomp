...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_stranger.cpp_CStranger_FUN_005c68a0(CStranger * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH ESI                            ; 005c68aa
    PUSH EBX                            ; 005c68ab
    CALL core_charactr.cpp_CCharacter_FUN_0042f8a0 ; 005c68ac | void core_charactr.cpp_CCharacter_FUN_0042f8a0(CCharacter * this_ptr)
        ;   XREF to: 0042f8a0 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [EBX + 0x1fc00]   ; 005c68b1
    ADD ESP,0x8                         ; 005c68b7
    CMP ESI,EDX                         ; 005c68ba
    JZ 0x005c68c9                       ; 005c68bc | LAB_005c68c9
        ;   XREF to: 005c68c9 (CONDITIONAL_JUMP)
    CMP ESI,dword ptr [EBX + 0x1fc20]   ; 005c68be
    JZ 0x005c68de                       ; 005c68c4 | LAB_005c68de
    ...
    JZ 0x005c68de                       ; 005c68d9 | LAB_005c68de
        ;   XREF to: 005c68de (CONDITIONAL_JUMP)
    POP ESI                             ; 005c68db
    POP EBX                             ; 005c68dc
    RET                                 ; 005c68dd
