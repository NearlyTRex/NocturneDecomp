...
// Convention: __cdecl
// Signature: int __cdecl core_stranger_cpp_CStranger_getDeathState_FUN_005c67c0(CStranger *this_ptr)
...

{
  ...
  iVar1 = core_charactr_cpp_CCharacter_getDeathState_FUN_0042c580((CCharacter *)this_ptr);
  return iVar1;
}
