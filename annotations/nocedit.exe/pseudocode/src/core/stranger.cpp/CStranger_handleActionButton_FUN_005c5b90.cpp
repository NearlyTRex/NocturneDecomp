...

{
  ...
  if (((((this_ptr->base).player_control.action_states[3] != 0) && (this_ptr->action_pending == 0))
    ...
    if ((float)0.99990000000000001 < fVar5 + fVar4) {
      iVar3 = core_hero_cpp_CHero_tryOpenNearbyDoor_FUN_004f2d70(&this_ptr->base);
      switch(iVar3) {
      case 0:
    ...
    iVar3 = core_stranger_cpp_CStranger_tryPlaceObject_FUN_005c2850(this_ptr);
    if (iVar3 != 0) {
      (this_ptr->base).player_control.action_states[3] = 0;
      return;
    }
    iVar3 = core_stranger_cpp_CStranger_tryPickupObject_FUN_005c1680(this_ptr,"!CBodyPart");
    if (iVar3 != 0) {
      (this_ptr->base).player_control.action_states[3] = 0;
      return;
    }
    iVar3 = core_hero_cpp_CHero_tryInteract_FUN_004f2af0(&this_ptr->base);
    if (iVar3 == 0) {
      iVar3 = core_hero_cpp_CHero_tryTalkToNearbyCharacter_FUN_004f2c40(&this_ptr->base);
      if (iVar3 != 0) {
        (this_ptr->base).player_control.action_states[3] = 0;
        return;
      }
      iVar3 = core_hero_cpp_CHero_tryPushNearbyBox_FUN_004f3120(&this_ptr->base);
      pCVar1 = &(this_ptr->base).base.model;
      if (iVar3 != 0) {
        core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
      ...
      if (((this_ptr->base).base.carry_hands[1].carry_actor == (CDemonActor *)0x0) &&
        ...
        iVar3 = core_hero_cpp_CHero_tryPullLever_FUN_004f2f50(&this_ptr->base);
        if (iVar3 != 0) {
          (this_ptr->base).player_control.action_states[3] = 0;
          core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
        ...
        iVar3 = core_stranger_cpp_CStranger_tryClimbLadder_FUN_005c1fe0(this_ptr);
        if (iVar3 != 0) {
          (this_ptr->base).player_control.action_states[3] = 0;
          return;
        }
        iVar3 = core_stranger_cpp_CStranger_tryDescendLadder_FUN_005c2400(this_ptr);
        if (iVar3 != 0) {
          (this_ptr->base).player_control.action_states[3] = 0;
          return;
        }
        iVar3 = core_hero_cpp_CHero_tryApproachNearbyActor_FUN_004f33b0(&this_ptr->base);
        if (iVar3 != 0) {
          (this_ptr->base).player_control.action_states[3] = 0;
          return;
        }
        iVar3 = core_stranger_cpp_CStranger_tryPickupObject_FUN_005c1680
                          (this_ptr,"CBodyPart");
        if (iVar3 != 0) {
          (this_ptr->base).player_control.action_states[3] = 0;
          return;
