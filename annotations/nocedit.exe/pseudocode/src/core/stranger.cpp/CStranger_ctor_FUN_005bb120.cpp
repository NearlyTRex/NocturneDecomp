...

{
  ...
  *(uint *)(pCVar5[-1].model_name + 0x10) = uVar1;
  ...
  uVar1 = *(uint *)(pCVar5[-1].model_name + 0x14);
  uVar2 = *(uint *)(pCVar5[-1].model_name + 0x3c);
  uVar3 = *(uint *)(pCVar5[-1].model_name + 0x34);
  *(uint *)(pCVar5[-1].model_name + 0x20) = *(uint *)(pCVar5[-1].model_name + 0x1c);
  *(uint *)(pCVar5[-1].model_name + 0x18) = uVar1;
  *(uint *)(pCVar5[-1].model_name + 0x40) = uVar2;
  *(uint *)(pCVar5[-1].model_name + 0x38) = uVar3;
  ...
  *(uint *)(pCVar5[-1].animation_state + 0x44) =
       *(uint *)(pCVar5[-1].animation_state + 0x48);
  *(uint *)(pCVar5[-1].animation_state + 0x40) =
       *(uint *)(pCVar5[-1].animation_state + 0x44);
