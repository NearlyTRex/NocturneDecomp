...
;
; XREF[1]:
;   core_stranger.cpp_CStranger_processFrame_FUN_005bb960 at 005bbb2d
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 005be490
        ;   Label: core_stranger.cpp_CStranger_getHandsMidpoint_FUN_005be490
    PUSH ESI                            ; 005be491
    PUSH EDI                            ; 005be492
    SUB ESP,0x24                        ; 005be493
    MOV ESI,dword ptr [ESP + 0x38]      ; 005be496
    MOV EDX,dword ptr [0x03f6bb04]      ; 005be49a | g_StrangerIndices[14]
    PUSH EDX                            ; 005be4a0
