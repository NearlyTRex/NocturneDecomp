...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_stranger.cpp_CStranger_FUN_005c3710(CStranger * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005c3715
    CALL core_charactr.cpp_CCharacter_FUN_0042b0e0 ; 005c3716 | int core_charactr.cpp_CCharacter_FUN_0042b0e0(CCharacter * this_ptr)
        ;   XREF to: 0042b0e0 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [EBX + 0x1fc2c]   ; 005c371b
    ADD ESP,0x4                         ; 005c3721
    TEST EDX,EDX                        ; 005c3724
    JNZ 0x005c372f                      ; 005c3726 | LAB_005c372f
