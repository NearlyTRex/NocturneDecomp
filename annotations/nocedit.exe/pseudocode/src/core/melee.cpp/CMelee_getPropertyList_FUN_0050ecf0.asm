...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_melee_cpp_CMelee_getPropertyList_FUN_0050ecf0(CMelee *this_ptr,CActorPropertyList *property_list)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0050ecf0
        ;   Label: core_melee.cpp_CMelee_getPropertyList_FUN_0050ecf0
    PUSH ESI                            ; 0050ecf1
    MOV EBX,dword ptr [ESP + 0xc]       ; 0050ecf2
    MOV ESI,dword ptr [ESP + 0x10]      ; 0050ecf6
    PUSH ESI                            ; 0050ecfa
    PUSH EBX                            ; 0050ecfb
    CALL core_weapon.cpp_CWeapon_getPropertyList_FUN_005ee9f0 ; 0050ecfc
    ...
    PUSH EAX                            ; 0050ed0a
    PUSH 0x635ced                       ; 0050ed0b | = "Allowed attack types"
    PUSH ESI                            ; 0050ed10
    CALL core_actor.cpp_CActorPropertyList_addFlags_FUN_0040e6a0 ; 0050ed11
    ...
    PUSH EAX                            ; 0050ed4d
    PUSH 0x635d28                       ; 0050ed4e | = "Can attach light"
    PUSH ESI                            ; 0050ed53
    CALL core_actor.cpp_CActorPropertyList_addBool_FUN_0040e330 ; 0050ed54
    ...
    PUSH 0x0                            ; 0050ed69
    PUSH EAX                            ; 0050ed6b
    PUSH 0x635d39                       ; 0050ed6c | = "Dismember prob 0.0 to 1.0"
    PUSH ESI                            ; 0050ed71
    CALL core_actor.cpp_CActorPropertyList_addFloatRange_FUN_0040e1a0 ; 0050ed72
    ...
    PUSH EAX                            ; 0050ed80
    PUSH 0x635d53                       ; 0050ed81 | = "Can go in inventory"
    PUSH ESI                            ; 0050ed86
    CALL core_actor.cpp_CActorPropertyList_addBool_FUN_0040e330 ; 0050ed87
        ;   XREF to: 0040e330 (UNCONDITIONAL_CALL)  ; CActorProperty * core_actor.cpp_CActorPropertyList_addBool_FUN_0040e330(CActorPropertyList * this_ptr, char * property_name, int * data_ptr)
    ...
    PUSH EAX                            ; 0050edb1
    PUSH 0x635db0                       ; 0050edb2 | = "thrustHitCharacterSound"
    PUSH ESI                            ; 0050edb7
    CALL core_actor.cpp_CActorPropertyList_addSound_FUN_0040e2d0 ; 0050edb8
    ...
    PUSH EAX                            ; 0050edc6
    PUSH 0x635dc8                       ; 0050edc7 | = "swingHitCharacterSound"
    PUSH ESI                            ; 0050edcc
    CALL core_actor.cpp_CActorPropertyList_addSound_FUN_0040e2d0 ; 0050edcd
        ;   XREF to: 0040e2d0 (UNCONDITIONAL_CALL)  ; CActorProperty * core_actor.cpp_CActorPropertyList_addSound_FUN_0040e2d0(CActorPropertyList * this_ptr, char * property_name, void * data_ptr)
    ADD ESP,0xc                         ; 0050edd2
    ADD EBX,0x668                       ; 0050edd5
    PUSH EBX                            ; 0050eddb
    PUSH 0x635ddf                       ; 0050eddc | = "hitOtherSound"
    PUSH ESI                            ; 0050ede1
    CALL core_actor.cpp_CActorPropertyList_addSound_FUN_0040e2d0 ; 0050ede2
        ;   XREF to: 0040e2d0 (UNCONDITIONAL_CALL)  ; CActorProperty * core_actor.cpp_CActorPropertyList_addSound_FUN_0040e2d0(CActorPropertyList * this_ptr, char * property_name, void * data_ptr)
