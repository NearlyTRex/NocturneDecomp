...
;                               FUNCTION
; *****************************************************************************
; __cdecl CMelee * core_melee.cpp_FUN_0050e7d0(CMelee * this_ptr)
;
; Parameters:
; CMelee *         Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_melee.cpp_FUN_0050e790 at 0050e7aa
;
; Referenced Globals:
...
section .text
    ...
    PUSH EDX                            ; 0050e7d7
    CALL core_weapon.cpp_CWeapon_ctor_FUN_005ede70 ; 0050e7d8 | CWeapon * core_weapon.cpp_CWeapon_ctor_FUN_005ede70(CWeapon * this_ptr)
        ;   XREF to: 005ede70 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0050e7dd
    PUSH 0x635bd6                       ; 0050e7e0 | = "melee.kfm" | s_melee_kfm_00635bd6 = melee.kfm
    MOV EBX,EAX                         ; 0050e7e5
    LEA EDI,[EAX + 0x158]               ; 0050e7e7
    PUSH EDI                            ; 0050e7ed
    MOV dword ptr [EAX + 0x154],0x661174 ; 0050e7ee | CDemonActor_vtable PTR_core_weapon.cpp_ActorModelSomething_FUN_00661174
    CALL core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0 ; 0050e7f8 | void core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0(CKeyFramedModelInstance * this_ptr, char * filename)
    ...
    MOV ESI,0x635be0                    ; 0050e889 | = "shovel?.wav" | s_shovel_wav_00635be0 = shovel?.wav
    ...
    PUSH EDI                            ; 0050e8b5
    MOV AL,byte ptr [ESI]               ; 0050e8b6 | = "shovel?.wav" | s_shovel_wav_00635be0 = shovel?.wav
        ;   Label: LAB_0050e8b6
    MOV byte ptr [EDI],AL               ; 0050e8b8
    CMP AL,0x0                          ; 0050e8ba
    JZ 0x0050e8ce                       ; 0050e8bc | LAB_0050e8ce
        ;   XREF to: 0050e8ce (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0050e8be | s_hovel?.wav_00635be1
    ADD ESI,0x2                         ; 0050e8c1
    MOV byte ptr [EDI + 0x1],AL         ; 0050e8c4
    ADD EDI,0x2                         ; 0050e8c7
    CMP AL,0x0                          ; 0050e8ca
    JNZ 0x0050e8b6                      ; 0050e8cc | LAB_0050e8b6
        ;   XREF to: 0050e8b6 (CONDITIONAL_JUMP)
    POP EDI                             ; 0050e8ce
        ;   Label: LAB_0050e8ce
    MOV ESI,0x635bec                    ; 0050e8cf | = "shvl-f?.wav" | s_shvl_f_wav_00635bec = shvl-f?.wav
    LEA EDI,[EBX + 0x604]               ; 0050e8d4
    PUSH EDI                            ; 0050e8da
    MOV AL,byte ptr [ESI]               ; 0050e8db | = "shvl-f?.wav" | s_shvl_f_wav_00635bec = shvl-f?.wav
        ;   Label: LAB_0050e8db
    MOV byte ptr [EDI],AL               ; 0050e8dd
    CMP AL,0x0                          ; 0050e8df
    JZ 0x0050e8f3                       ; 0050e8e1 | LAB_0050e8f3
        ;   XREF to: 0050e8f3 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0050e8e3 | s_hvl-f?.wav_00635bed
    ADD ESI,0x2                         ; 0050e8e6
    MOV byte ptr [EDI + 0x1],AL         ; 0050e8e9
    ADD EDI,0x2                         ; 0050e8ec
    CMP AL,0x0                          ; 0050e8ef
    JNZ 0x0050e8db                      ; 0050e8f1 | LAB_0050e8db
        ;   XREF to: 0050e8db (CONDITIONAL_JUMP)
    POP EDI                             ; 0050e8f3
        ;   Label: LAB_0050e8f3
    MOV ESI,0x635bf8                    ; 0050e8f4 | = "shvl-s?.wav" | s_shvl_s_wav_00635bf8 = shvl-s?.wav
    LEA EDI,[EBX + 0x668]               ; 0050e8f9
    PUSH EDI                            ; 0050e8ff
    MOV AL,byte ptr [ESI]               ; 0050e900 | = "shvl-s?.wav" | s_shvl_s_wav_00635bf8 = shvl-s?.wav
        ;   Label: LAB_0050e900
    MOV byte ptr [EDI],AL               ; 0050e902
    CMP AL,0x0                          ; 0050e904
    JZ 0x0050e918                       ; 0050e906 | LAB_0050e918
        ;   XREF to: 0050e918 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0050e908 | s_hvl-s?.wav_00635bf9
    ADD ESI,0x2                         ; 0050e90b
    MOV byte ptr [EDI + 0x1],AL         ; 0050e90e
    ADD EDI,0x2                         ; 0050e911
    CMP AL,0x0                          ; 0050e914
    JNZ 0x0050e900                      ; 0050e916 | LAB_0050e900
