...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_melee_cpp_CMelee_archive_FUN_0050e920(CMelee *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0050e920
        ;   Label: core_melee.cpp_CMelee_archive_FUN_0050e920
    MOV EBX,dword ptr [ESP + 0x8]       ; 0050e921
    PUSH EBX                            ; 0050e925
    CALL core_weapon.cpp_CWeapon_archive_FUN_005ee250 ; 0050e926
    ...
    PUSH EAX                            ; 0050e951
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 0050e952
    ...
    PUSH EAX                            ; 0050e965
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 0050e966
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ADD ESP,0x8                         ; 0050e96b
    PUSH 0x635c2d                       ; 0050e96e | = "canAttachLight"
    LEA EAX,[EBX + 0x2f0]               ; 0050e973
    PUSH EAX                            ; 0050e979
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 0050e97a
    ...
    PUSH EAX                            ; 0050e996
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 0050e997
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH EAX                            ; 0050e9b3
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 0050e9b4
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    PUSH EAX                            ; 0050e9d0
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 0050e9d1
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    PUSH EAX                            ; 0050e9ef
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 0050e9f0
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    PUSH EAX                            ; 0050ea08
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 0050ea09
    ...
    PUSH EAX                            ; 0050ea1c
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 0050ea1d
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveString_FUN_0040b5c0(char * string_buffer, char * property_type)
    ADD ESP,0x8                         ; 0050ea22
    PUSH 0x635c93                       ; 0050ea25 | = "hitOtherSound"
    ADD EBX,0x668                       ; 0050ea2a
    PUSH EBX                            ; 0050ea30
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 0050ea31
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveString_FUN_0040b5c0(char * string_buffer, char * property_type)
