...
section .text
    ...
    PUSH 0x6cc                          ; 0050e797
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1b0 ; 0050e79c
    ...
    PUSH EAX                            ; 0050e7a9
        ;   Label: LAB_0050e7a9
    CALL core_melee.cpp_FUN_0050e7d0    ; 0050e7aa
        ;   XREF to: 0050e7d0 (UNCONDITIONAL_CALL)  ; CMelee * core_melee.cpp_FUN_0050e7d0(CMelee * this_ptr)
