...
void __cdecl
core_melee_cpp_CMelee_getPropertyList_FUN_0050ecf0
          (CMelee *this_ptr,CActorPropertyList *property_list)

{
  ...
  core_actor_cpp_CActorPropertyList_addEnumPair_FUN_0040e640
            (property_list,"Damage type",9,(int *)&PTR_s_Generic_0067d178);
