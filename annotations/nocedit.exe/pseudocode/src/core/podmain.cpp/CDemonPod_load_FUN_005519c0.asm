...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_podmain.cpp_CDemonPod_load_FUN_005519c0(CDemonPod * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH 0x2f                           ; 005519cf
    PUSH 0x6408f7                       ; 005519d1 | = "..\\core\\podmain.cpp" | s_core_podmain_cpp_006408f7 = ..\core\podmain.cpp
    PUSH 0x64090b                       ; 005519d6 | = "rt" | s_rt_0064090b = rt
    PUSH 0x0                            ; 005519db
    PUSH 0x64090e                       ; 005519dd | = "pod.ini" | s_pod_ini_0064090e = pod.ini
    CALL shape_memdbg.cpp_openFile_FUN_0050f7a0 ; 005519e2 | FILE * shape_memdbg.cpp_openFile_FUN_0050f7a0(char * filename, char * directory, char * mode, char * source_file, ...)
        ;   XREF to: 0050f7a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 005519e7
    MOV EDI,EAX                         ; 005519ea
    TEST EAX,EAX                        ; 005519ec
    JNZ 0x00551a6c                      ; 005519ee | LAB_00551a6c
        ;   XREF to: 00551a6c (CONDITIONAL_JUMP)
    MOV EAX,ESP                         ; 005519f4
    PUSH EAX                            ; 005519f6
    CALL engine_dosio.c_CFileFinder_ctor_FUN_00481c30 ; 005519f7 | CFileFinder * engine_dosio.c_CFileFinder_ctor_FUN_00481c30(CFileFinder * this_ptr)
        ;   XREF to: 00481c30 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005519fc
    PUSH 0x640916                       ; 005519ff | = "*.pod" | s_pod_00640916 = *.pod
    LEA EAX,[ESP + 0x4]                 ; 00551a04
    PUSH EAX                            ; 00551a08
    CALL engine_dosio.c_CFileFinder_openSearch_FUN_00481c70 ; 00551a09 | int engine_dosio.c_CFileFinder_openSearch_FUN_00481c70(CFileFinder * this_ptr, char * search_pattern)
        ;   XREF to: 00481c70 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00551a0e
    CMP byte ptr [ESP],0x0              ; 00551a11
    JZ 0x00551a40                       ; 00551a15 | LAB_00551a40
    ...
    PUSH EAX                            ; 00551a29
    CALL engine_dosio.c_CFileFinder_findNext_FUN_00481cf0 ; 00551a2a | int engine_dosio.c_CFileFinder_findNext_FUN_00481cf0(CFileFinder * this_ptr)
        ;   XREF to: 00481cf0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00551a2f
    CMP byte ptr [ESP],0x0              ; 00551a32
    JNZ 0x00551a17                      ; 00551a36 | LAB_00551a17
    ...
    MOV EAX,ESP                         ; 00551a40
        ;   Label: LAB_00551a40
    PUSH EAX                            ; 00551a42
    CALL engine_dosio.c_CFileFinder_closeSearch_FUN_00481d70 ; 00551a43 | void engine_dosio.c_CFileFinder_closeSearch_FUN_00481d70(CFileFinder * this_ptr)
        ;   XREF to: 00481d70 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00551a48
    PUSH 0x0                            ; 00551a4b
    LEA EAX,[ESP + 0x4]                 ; 00551a4d
    PUSH EAX                            ; 00551a51
    CALL engine_dosio.c_CFileFinder_dtor_FUN_00481c50 ; 00551a52 | CFileFinder * engine_dosio.c_CFileFinder_dtor_FUN_00481c50(CFileFinder * this_ptr, uint d1)
        ;   XREF to: 00481c50 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00551a57
    PUSH EBX                            ; 00551a5a
    CALL engine_pod.cpp_CPod_resolveDependenciesAndSort_FUN_005513d0 ; 00551a5b | void engine_pod.cpp_CPod_resolveDependenciesAndSort_FUN_005513d0(CPod * this_ptr)
    ...
    PUSH EAX                            ; 00551a7a
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 00551a7b | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00551a80
    MOV EDX,dword ptr [ESP + 0x168]     ; 00551a83
    XOR ESI,ESI                         ; 00551a8a
    TEST EDX,EDX                        ; 00551a8c
    JLE 0x00551ad0                      ; 00551a8e | LAB_00551ad0
    ...
    PUSH EDI                            ; 00551a9d
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 00551a9e | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ...
    JL 0x00551a90                       ; 00551ac3 | LAB_00551a90
    ...
    PUSH 0x43                           ; 00551ad0
        ;   Label: LAB_00551ad0
    PUSH 0x640924                       ; 00551ad2 | = "..\\core\\podmain.cpp" | s_core_podmain_cpp_00640924 = ..\core\podmain.cpp
    PUSH EDI                            ; 00551ad7
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 00551ad8 | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
        ;   XREF to: 0050f9b0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00551add
    POP ESI                             ; 00551ae0
    PUSH EBX                            ; 00551ae1
    CALL engine_pod.cpp_CPod_resolveDependenciesAndSort_FUN_005513d0 ; 00551ae2 | void engine_pod.cpp_CPod_resolveDependenciesAndSort_FUN_005513d0(CPod * this_ptr)
        ;   XREF to: 005513d0 (UNCONDITIONAL_CALL)
