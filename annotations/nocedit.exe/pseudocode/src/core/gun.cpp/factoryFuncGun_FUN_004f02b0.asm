...
;
; Called Functions:
;   core_gun.cpp_CGun_ctor_FUN_004f02f0
...
section .text
    ...
    PUSH 0x29                           ; 004f02b0
        ;   Label: core_gun.cpp_factoryFuncGun_FUN_004f02b0
    PUSH 0x62e788                       ; 004f02b2 | = "..\\core\\gun.cpp"
    PUSH 0x578                          ; 004f02b7
    CALL shape_memdbg.cpp_debugAllocTracked1_FUN_0050f1b0 ; 004f02bc
    ...
    PUSH EAX                            ; 004f02c9
        ;   Label: LAB_004f02c9
    CALL core_gun.cpp_CGun_ctor_FUN_004f02f0 ; 004f02ca
        ;   XREF to: 004f02f0 (UNCONDITIONAL_CALL)  ; CGun * core_gun.cpp_CGun_ctor_FUN_004f02f0(CGun * this_ptr)
