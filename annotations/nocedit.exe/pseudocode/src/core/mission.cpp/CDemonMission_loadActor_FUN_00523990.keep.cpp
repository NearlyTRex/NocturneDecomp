...

{
        ...
        if (iVar1 == 0) {
          ...
          if (local_e1 == (CDemonActor *)0x0) {
            shape_edittool_cpp_CEditorTools_showError_FUN_0049e740
                      (g_CEditorToolsPtr,"WARNING.  Can't find actor '%s' in %s property %s.  (Please note this in a bug report...)",local_dc,current_actor->actor_name,
  ...
  do {
    ...
    core_main_c_displayErrorAndQuit_FUN_00506f10
              ("Error reading actor pointer.\nOwner: %s\nDescription: %s\n",current_actor->actor_name,property_description);
    pCVar1 = local_e1;
LAB_00523a18:
