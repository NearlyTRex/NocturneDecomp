...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_mission_cpp_CDemonMission_FUN_00524660(CDemonMission *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00524660
        ;   Label: core_mission.cpp_CDemonMission_FUN_00524660
    PUSH ESI                            ; 00524661
    PUSH EDI                            ; 00524662
    PUSH EBP                            ; 00524663
    ...
    PUSH EBX                            ; 005246c2
    PUSH EDI                            ; 005246c3
    CALL core_mission.cpp_CDemonMission_FUN_00524030 ; 005246c4
