...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_mission_cpp_CDemonMission_countDamageableEnemies_FUN_00524e00(CDemonMission *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00524e00
        ;   Label: core_mission.cpp_CDemonMission_countDamageableEnemies_FUN_00524e00
    PUSH ESI                            ; 00524e01
