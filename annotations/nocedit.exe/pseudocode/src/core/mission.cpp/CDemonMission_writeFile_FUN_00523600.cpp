...
// Convention: __cdecl
// Signature: void __cdecl core_mission_cpp_CDemonMission_writeFile_FUN_00523600(CDemonMission *this_ptr)
...

{
  ...
  _fprintf(in_stack_00000008,"// mission version, actor version\n");
  _fprintf(in_stack_00000008,"%d,%d\n",this_ptr->mission_version_num,4)
  ;
  _fprintf(in_stack_00000008,"// Root name of mission\n");
  _fprintf(in_stack_00000008,"%s\n",this_ptr->unk2 + 0x38);
  _fprintf(in_stack_00000008,"// setList\n");
  iVar5 = 0;
  ...
  _fprintf(in_stack_00000008,"// actorTypeList\n");
  ...
  if (0 < g_NumActorClassTypes) {
    ...
    do {
      ...
      iVar7 = iVar7 + 4;
      iVar5 = iVar5 + 1;
      _fprintf(in_stack_00000008,"%s %d\n",*piVar1,*(uint *)(*piVar1 + 0x34));
    } while (iVar5 < g_NumActorClassTypes);
  }
  _fprintf(in_stack_00000008,"// actor count\n");
  iVar5 = core_mission_cpp_CDemonMission_FUN_00523cc0(this_ptr);
  _fprintf(in_stack_00000008,"%d\n",iVar5);
  iVar5 = 0;
  _fprintf(in_stack_00000008,"// inventory actor count\n");
  ...
  _fprintf(in_stack_00000008,"%d\n",iVar5);
  _fprintf(in_stack_00000008,"// actor name list\n");
  ...
  for (; pCVar2 != (CDemonActor *)0x0; pCVar2 = pCVar2->next_actor) {
    ...
    _fprintf(in_stack_00000008,"%s \"%s\"\n",pcVar4,pCVar3);
  ...
  _fprintf(in_stack_00000008,"// actor data list\n");
  for (pCVar2 = this_ptr->first_actor; pCVar2 != (CDemonActor *)0x0; pCVar2 = pCVar2->next_actor) {
