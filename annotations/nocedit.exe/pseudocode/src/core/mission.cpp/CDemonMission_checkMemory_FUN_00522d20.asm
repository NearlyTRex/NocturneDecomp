...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_mission.cpp_CDemonMission_checkMemory_FUN_00522d20(CDemonMission * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 00522d24
    CALL core_mission.cpp_CDemonMission_checkMemory2_FUN_00522d30 ; 00522d25 | void core_mission.cpp_CDemonMission_checkMemory2_FUN_00522d30(CDemonMission * this_ptr)
