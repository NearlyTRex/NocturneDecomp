...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_mission.cpp_CDemonMission_FUN_005235b0(CDemonMission * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH 0x638e4c                       ; 005235bd | = "scr" | s_scr_00638e4c = scr
    ...
    PUSH EAX                            ; 005235ce
    CALL crt_file.c_makepath_FUN_005febfc ; 005235cf | void crt_file.c_makepath_FUN_005febfc(char * path_buffer, char * drive, char * directory, char * filename, ...)
    ...
    PUSH EAX                            ; 005235e3
    MOV ECX,dword ptr [0x00680d50]      ; 005235e4 | CScript g_CScriptInstance | CScript * g_CScriptPtr
    PUSH ECX                            ; 005235ea | CScript g_CScriptInstance
    CALL core_script.cpp_CScript_ScriptErrorStartNotepad_FUN_00559f80 ; 005235eb | undefined core_script.cpp_CScript_ScriptErrorStartNotepad_FUN_00559f80()
