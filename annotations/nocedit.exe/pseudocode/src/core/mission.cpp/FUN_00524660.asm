...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_mission.cpp_FUN_00524660(void)
;
; Local Variables:
; undefined4       Stack[-0x14]:4  local_14
;
; XREF[2]:
;   core_mission.cpp_CDemonMission_initNewActorMaybe_FUN_00524700 at 0052472d
;   core_msnedit.cpp_DuplicateActorCheckMaybe_FUN_0053bd80 at 0053bf11
;
; Referenced Globals:
...
section .text
    ...
    JZ 0x005246a5                       ; 0052468a | LAB_005246a5
        ;   XREF to: 005246a5 (CONDITIONAL_JUMP)
    PUSH EDI                            ; 0052468c
        ;   Label: LAB_0052468c
    PUSH EBP                            ; 0052468d
    PUSH EBX                            ; 0052468e
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 0052468f | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00524694
    TEST EAX,EAX                        ; 00524697
    JZ 0x005246d8                       ; 00524699 | LAB_005246d8
        ;   XREF to: 005246d8 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [EBX + 0x14c]     ; 0052469b
        ;   Label: LAB_0052469b
    TEST EBX,EBX                        ; 005246a1
    JNZ 0x0052468c                      ; 005246a3 | LAB_0052468c
    ...
    PUSH ESI                            ; 005246ae
    PUSH EBP                            ; 005246af
    PUSH 0x639341                       ; 005246b0 | = "%s%d" | s_s_d_00639341 = %s%d
    MOV ECX,dword ptr [ESP + 0x28]      ; 005246b5
    PUSH ECX                            ; 005246b9
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005246ba | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 005246bf
    PUSH EBX                            ; 005246c2
    PUSH EDI                            ; 005246c3
    CALL core_mission.cpp_CDemonMission_FUN_00524030 ; 005246c4 | char * core_mission.cpp_CDemonMission_FUN_00524030(CDemonMission * this_ptr)
        ;   XREF to: 00524030 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005246c9
    TEST EAX,EAX                        ; 005246cc
    JNZ 0x005246ad                      ; 005246ce | LAB_005246ad
    ...
    MOV EAX,ESP                         ; 005246d8
        ;   Label: LAB_005246d8
    PUSH EAX                            ; 005246da
    PUSH 0x63933e                       ; 005246db | = "%d" | s_d_0063933e = %d
    LEA EAX,[EBX + EDI*0x1]             ; 005246e0
    PUSH EAX                            ; 005246e3
    CALL crt_stdio.c_sscanf_FUN_0060013c ; 005246e4 | int crt_stdio.c_sscanf_FUN_0060013c(char * str, char * format)
        ;   XREF to: 0060013c (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005246e9
    CMP EAX,0x1                         ; 005246ec
    JNZ 0x0052469b                      ; 005246ef | LAB_0052469b
        ;   XREF to: 0052469b (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [ESP]             ; 005246f1
    CMP ESI,EDX                         ; 005246f4
    JGE 0x0052469b                      ; 005246f6 | LAB_0052469b
        ;   XREF to: 0052469b (CONDITIONAL_JUMP)
    MOV ESI,EDX                         ; 005246f8
    JMP 0x0052469b                      ; 005246fa | LAB_0052469b
