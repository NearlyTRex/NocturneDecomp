...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_mission.cpp_CDemonMission_checkMemory2_FUN_00522d30(CDemonMission * this_ptr)
;
; Parameters:
; CDemonMission *  Stack[0x4]:4   this_ptr
;
; XREF[4]:
;   core_mission.cpp_CDemonMission_checkMemory_FUN_00522d20 at 00522d25
...
section .text
    ...
    PUSH 0x84                           ; 00522d35
    PUSH 0x63899d                       ; 00522d3a | = "..\\core\\mission.cpp" | s_core_mission_cpp_0063899d = ..\core\mission.cpp
    CALL shape_memdbg.cpp_SMemHead_checkAllMemory_FUN_0050efe0 ; 00522d3f | void shape_memdbg.cpp_SMemHead_checkAllMemory_FUN_0050efe0(char * filename, int context)
        ;   XREF to: 0050efe0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00522d44
    PUSH EBX                            ; 00522d47
    CALL core_mission.cpp_CDemonMission_FUN_00523f50 ; 00522d48 | void core_mission.cpp_CDemonMission_FUN_00523f50(CDemonMission * this_ptr)
    ...
    PUSH 0x6389b1                       ; 00522d74 | = "..\\core\\mission.cpp" | s_core_mission_cpp_006389b1 = ..\core\mission.cpp
    MOV dword ptr [EBX + 0x88c],0x0     ; 00522d79
    CALL shape_memdbg.cpp_SMemHead_checkAllMemory_FUN_0050efe0 ; 00522d83 | void shape_memdbg.cpp_SMemHead_checkAllMemory_FUN_0050efe0(char * filename, int context)
        ;   XREF to: 0050efe0 (UNCONDITIONAL_CALL)
