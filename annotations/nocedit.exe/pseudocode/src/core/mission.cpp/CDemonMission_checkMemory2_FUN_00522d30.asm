...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_mission_cpp_CDemonMission_checkMemory2_FUN_00522d30(CDemonMission *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00522d47
    CALL core_mission.cpp_CDemonMission_FUN_00523f50 ; 00522d48
