// Name: core_mission.cpp_CDemonMission_startMission_FUN_00524760
// Address: 00524760
// Address Range: [[00524760, 00524893]]
// Convention: __cdecl
// Signature: int __cdecl core_mission_cpp_CDemonMission_startMission_FUN_00524760(CDemonMission *this_ptr)
...

{
  ...
  if (g_HeroActors[g_LocalHeroIndex] != (CHero *)0x0) {
    ...
    iVar1 = core_mission_cpp_CDemonMission_loadScript_FUN_005235b0(this_ptr,g_CGamePtr->is_loading);
    if (iVar1 == 0) {
      return 0;
    }
    core_script_cpp_CScript_initRuntime_FUN_0055a540(g_CScriptPtr);
    core_script_cpp_CScript_executeInitSection_FUN_0055a6c0(g_CScriptPtr);
