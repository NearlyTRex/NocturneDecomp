...
section .text
    ...
    JNC 0x00523b49                      ; 00523b00 | LAB_00523b49
        ;   XREF to: 00523b49 (CONDITIONAL_JUMP)
    MOV EAX,0x67d690                    ; 00523b02 | = "(none)" | s_none_0067d690 = (none)
    TEST EBX,EBX                        ; 00523b07
    JZ 0x00523b20                       ; 00523b09 | LAB_00523b20
        ;   XREF to: 00523b20 (CONDITIONAL_JUMP)
    PUSH 0x273                          ; 00523b0b
    PUSH 0x639063                       ; 00523b10 | = "..\\core\\mission.cpp" | s_core_mission_cpp_00639063 = ..\core\mission.cpp
    PUSH EBX                            ; 00523b15
    CALL core_actor.cpp_CDemonActor_doCheckForInvalidPointers_FUN_0040ac80 ; 00523b16 | void core_actor.cpp_CDemonActor_doCheckForInvalidPointers_FUN_0040ac80(CDemonActor * this_ptr, char * context_file, int context_line)
        ;   XREF to: 0040ac80 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00523b1b
    MOV EAX,EBX                         ; 00523b1e
    PUSH EAX                            ; 00523b20 | = "(none)" | s_none_0067d690 = (none)
        ;   Label: LAB_00523b20
    PUSH 0x639077                       ; 00523b21 | = "\"%s\"" | s_s_00639077 = "%s"
    PUSH ESI                            ; 00523b26
        ;   Label: LAB_00523b26
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00523b27 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00523b2c
    MOV EDX,dword ptr [ESP + 0x1c]      ; 00523b2f
    TEST EDX,EDX                        ; 00523b33
    JZ 0x00523b51                       ; 00523b35 | LAB_00523b51
        ;   XREF to: 00523b51 (CONDITIONAL_JUMP)
    PUSH EDX                            ; 00523b37
    PUSH 0x63907c                       ; 00523b38 | = "\t\t// %s\n" | s_s_0063907c = 		// %s

    PUSH ESI                            ; 00523b3d
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00523b3e | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH EBX                            ; 00523b49
        ;   Label: LAB_00523b49
    PUSH 0x63905e                       ; 00523b4a | = "%08x" | s_s_08x_0063905e = %08x
    JMP 0x00523b26                      ; 00523b4f | LAB_00523b26
        ;   XREF to: 00523b26 (UNCONDITIONAL_JUMP)
    PUSH 0x639085                       ; 00523b51 | = "\n" | s_anon_00639085 =

        ;   Label: LAB_00523b51
    PUSH ESI                            ; 00523b56
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00523b57 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
