...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_mission.cpp_CDemonMission_initNewActorMaybe_FUN_00524700(CDemonMission * this_ptr)
;
; Parameters:
...
;   core_gore.cpp_CreateFlies_FUN_004edf30 at 004edff6
...
;   core_mission.cpp_CDemonMission_FUN_00523b70 at 00523baa
;   ... and 7 more
;
; Called Functions:
...
section .text
    ...
    CALL core_actor.cpp_CDemonActor_getActorClassName_FUN_00408b90 ; 0052470e | char * core_actor.cpp_CDemonActor_getActorClassName_FUN_00408b90(CDemonActor * this_ptr)
    ...
    JNZ 0x00524722                      ; 0052471d | LAB_00524722
    ...
    PUSH EDX                            ; 0052472c
    CALL core_mission.cpp_FUN_00524660  ; 0052472d | void core_mission.cpp_FUN_00524660()
    ...
    CMP AL,0x0                          ; 0052473c
    JZ 0x00524750                       ; 0052473e | LAB_00524750
    ...
    CMP AL,0x0                          ; 0052474c
    JNZ 0x00524738                      ; 0052474e | LAB_00524738
