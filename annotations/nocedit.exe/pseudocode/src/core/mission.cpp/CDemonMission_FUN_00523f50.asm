...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_mission.cpp_CDemonMission_FUN_00523f50(CDemonMission * this_ptr)
;
; Parameters:
...
section .text
    ...
    JZ 0x00523f7e                       ; 00523f5e | LAB_00523f7e
    ...
    PUSH ECX                            ; 00523f69
    PUSH EBX                            ; 00523f6a
    CALL core_mission.cpp_CDemonMission_FUN_00523f20 ; 00523f6b | void core_mission.cpp_CDemonMission_FUN_00523f20(CDemonMission * this_ptr)
        ;   XREF to: 00523f20 (UNCONDITIONAL_CALL)
    MOV ESI,dword ptr [EBX + 0x548]     ; 00523f70
    ADD ESP,0xc                         ; 00523f76
    TEST ESI,ESI                        ; 00523f79
    JNZ 0x00523f61                      ; 00523f7b | LAB_00523f61
        ;   XREF to: 00523f61 (CONDITIONAL_JUMP)
    POP ESI                             ; 00523f7d
    PUSH EBX                            ; 00523f7e
        ;   Label: LAB_00523f7e
    CALL core_mission.cpp_CDemonMission_buildSetActorList_FUN_00523e60 ; 00523f7f | void core_mission.cpp_CDemonMission_buildSetActorList_FUN_00523e60(CDemonMission * this_ptr)
        ;   XREF to: 00523e60 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00523f84
    MOV EBP,dword ptr [0x006810c8]      ; 00523f87 | CDemonSet * g_CDemonSetPtr
    XOR EDI,EDI                         ; 00523f8d
    PUSH EBP                            ; 00523f8f | CDemonSet g_CDemonSetInstance
    MOV dword ptr [0x02db87bc],EDI      ; 00523f90 | int g_HeroCount
    MOV dword ptr [EBX + 0x884],EDI     ; 00523f96
    CALL core_setcolid.cpp_CDemonSet_FUN_00574560 ; 00523f9c | void core_setcolid.cpp_CDemonSet_FUN_00574560(CDemonSet * this_ptr)
