...

{
  ...
  CHeroPlaceholder *fallback_placeholder;
...
#if !NOCTURNE_AUTHENTIC_NETPLAY
        if (((0 < index) && (existing_actor == (CCharacter *)0x0)) &&
            (fallback_placeholder != (CHeroPlaceholder *)0x0)) {
...
#if !NOCTURNE_AUTHENTIC_NETPLAY
      if (fallback_placeholder == (CHeroPlaceholder *)0x0) {
        fallback_placeholder = this_ptr_00;
        nocturne_net_respawn_note_placeholder
                  ((this_ptr_00->base).location.position.x,
                   (this_ptr_00->base).location.position.y,
                   (this_ptr_00->base).location.position.z,
                   (this_ptr_00->base).location.area_id);
      }
#endif
