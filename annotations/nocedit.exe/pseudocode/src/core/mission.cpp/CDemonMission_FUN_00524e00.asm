...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_mission.cpp_CDemonMission_FUN_00524e00(CDemonMission * this_ptr)
;
; Parameters:
...
section .text
    ...
    JZ 0x00524e30                       ; 00524e10 | LAB_00524e30
        ;   XREF to: 00524e30 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x02cf2bf0]      ; 00524e12 | g_CEnemyClassInfo.name_hash
        ;   Label: LAB_00524e12
    PUSH EDX                            ; 00524e18
    PUSH EBX                            ; 00524e19
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 00524e1a | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00524e1f
    TEST EAX,EAX                        ; 00524e22
    JNZ 0x00524e35                      ; 00524e24 | LAB_00524e35
        ;   XREF to: 00524e35 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [EBX + 0x14c]     ; 00524e26
        ;   Label: LAB_00524e26
    TEST EBX,EBX                        ; 00524e2c
    JNZ 0x00524e12                      ; 00524e2e | LAB_00524e12
