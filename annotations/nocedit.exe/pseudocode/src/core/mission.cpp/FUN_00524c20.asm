...
section .text
    ...
    PUSH EAX                            ; 00524cbe
    PUSH EDI                            ; 00524cbf
    CALL core_mission.cpp_CDemonMission_FUN_00524030 ; 00524cc0
    ...
    PUSH EBP                            ; 00524d57
        ;   Label: LAB_00524d57
    PUSH EDI                            ; 00524d58
    CALL core_mission.cpp_CDemonMission_initNewActorMaybe_FUN_00524700 ; 00524d59
    ...
    PUSH ESI                            ; 00524d63
    PUSH EDI                            ; 00524d64
    CALL core_mission.cpp_CDemonMission_FUN_00523f20 ; 00524d65
    ...
    PUSH EBP                            ; 00524d6d
    PUSH EDI                            ; 00524d6e
    CALL core_mission.cpp_CDemonMission_FUN_00523b70 ; 00524d6f
