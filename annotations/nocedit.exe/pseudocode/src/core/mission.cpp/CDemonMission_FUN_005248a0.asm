...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_mission.cpp_CDemonMission_FUN_005248a0(CDemonMission * this_ptr)
;
; Parameters:
...
section .text
    ...
    JZ 0x005248d0                       ; 005248b2 | LAB_005248d0
    ...
    JNZ 0x005248b4                      ; 005248cd | LAB_005248b4
