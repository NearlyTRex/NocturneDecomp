...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_skeleton.cpp_skipToEndOfLine_FUN_005996c0(FILE * file_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005996c5
        ;   Label: LAB_005996c5
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 005996c6 | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005996cb
    TEST EAX,EAX                        ; 005996ce
    JL 0x005996d7                       ; 005996d0 | LAB_005996d7
        ;   XREF to: 005996d7 (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 005996d2
    JNZ 0x005996c5                      ; 005996d5 | LAB_005996c5
