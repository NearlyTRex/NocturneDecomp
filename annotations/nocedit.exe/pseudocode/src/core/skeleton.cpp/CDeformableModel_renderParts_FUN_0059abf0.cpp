        ...
        if ((iVar12 == 0) && (iVar1 != 0)) {
          ...
          while (local_b0 < iVar9) {
            ...
            if (iVar2 != local_68) {
              engine_drender_cpp_CDemonRenderer_captureTexture_FUN_0048db80
                        (g_CDemonRendererPtr2,
                         (SMRGLTextureBasic *)(this_ptr->texture_sets[*local_b8].textures + iVar2));
              local_68 = iVar2;
            }
            core_set_cpp_CDemonSet_renderFaceListOrEnvMap_FUN_00570870
      ...
      if (((*local_cc & 1) != 0) && (local_b0 < iVar13)) {
        ...
        do {
          ...
          if ((*(byte *)(part_visibility_flags +
            ...
            if ((((iVar12 == 0) && (skip_texture_capture == 0)) && (iVar1 == 0)) &&
               (iVar4 = *(int *)((int)this_ptr->index_data_ptr[lod_index] + local_4c),
               iVar4 != local_64)) {
              engine_drender_cpp_CDemonRenderer_captureTexture_FUN_0048db80
                        (g_CDemonRendererPtr2,
                         (SMRGLTextureBasic *)
            ...
            core_set_cpp_CDemonSet_renderFaceListOrEnvMap_FUN_00570870
                      (g_CDemonSetPtr,
                       (SInputFace *)((int)&(pSVar2->vertex_indices).vertex_index_0 + local_48),1,
                       render_flags);
          }
          local_b0 = local_b0 + 1;
