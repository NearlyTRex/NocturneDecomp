...
section .text
    ...
    PUSH 0x662ef0                       ; 005a1fd0 | WatcomTypeInfo g_CDeformableModelTypeInfo
        ;   Label: core_skeleton.cpp_freeDeformableModels_FUN_005a1fd0
    PUSH 0x40                           ; 005a1fd5
    MOV EDX,dword ptr [ESP + 0xc]       ; 005a1fd7
    PUSH EDX                            ; 005a1fdb
    CALL crt_memory.c_freeTypeArray_FUN_005feee9 ; 005a1fdc | int crt_memory.c_freeTypeArray_FUN_005feee9(void * * obj_array, int obj_count, WatcomTypeInfo * type_info)
