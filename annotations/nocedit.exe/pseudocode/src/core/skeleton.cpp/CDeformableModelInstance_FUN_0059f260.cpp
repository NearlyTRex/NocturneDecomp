// Name: core_skeleton.cpp_CDeformableModelInstance_FUN_0059f260
// Address: 0059f260
// Address Range: [[0059f260, 0059f6dc]]
// Convention: __cdecl
// Signature: void core_skeleton.cpp_CDeformableModelInstance_FUN_0059f260(CDeformableModelInstance * this_ptr)
// Cross-references:
//   core_skeleton.cpp_CDeformableModelInstance_FUN_0059f230 (0059f230) at 0059f24d [UNCONDITIONAL_CALL]
// Globals:
...
void __cdecl
core_skeleton_cpp_CDeformableModelInstance_FUN_0059f260(CDeformableModelInstance *this_ptr)

{
  ...
  bVar12 = 0;
  if ((float)DOUBLE_0064ee18 < (float)in_stack_00000010) {
    core_skeleton_cpp_CDeformableModelInstance_FUN_005a0820(this_ptr);
    local_34 = (CQuaternion4f *)(this_ptr->field3_0x508 + 0x1a8);
    if (this_ptr->field9_0x2250 == 0) {
      ...
      if (0 < this_ptr_00->bone_count) {
        ...
        local_2c = local_34;
        do {
          iVar4 = core_skeleton_cpp_CSkeleton_getHierarchyDistance_FUN_0059a100
                            (this_ptr_00,iVar5,in_stack_00000014);
          if (-1 < iVar4) {
            local_14 = (CQuaternion4f *)(*in_stack_00000018)();
            core_xform_cpp_slerpQuaternion_FUN_005f77e0
                      (local_2c,local_1c,local_14,(float)in_stack_ffffff18);
            puVar8 = (undefined4 *)((int)local_24 + (uint)bVar12 * -8 + 0x6b4);
            *(CQuaternion4f **)(local_24->field3_0x508 + 0x1a8) = in_stack_ffffff18;
            puVar7 = puVar8 + (uint)bVar12 * -2 + 1;
            *puVar8 = *(undefined4 *)(&stack0xffffff1c + (uint)bVar12 * -8);
            *puVar7 = *(undefined4 *)(&stack0xffffff20 + (uint)bVar12 * -8 + (uint)bVar12 * -8);
            puVar7[(uint)bVar12 * -2 + 1] =
                 *(undefined4 *)
                  ((int)(&stack0xffffff20 + (uint)bVar12 * -8 + (uint)bVar12 * -8) +
                  ((uint)bVar12 * -2 + 1) * 4);
          }
          iVar5 = iVar5 + 1;
          ...
          local_2c = local_2c + 1;
          local_1c = local_1c + 1;
        } while (iVar5 < this_ptr_00->bone_count);
      }
    }
      ...
      if (0 < this_ptr_00->bone_count) {
        ...
        do {
          iVar5 = core_skeleton_cpp_CSkeleton_getHierarchyDistance_FUN_0059a100
                            (this_ptr_00,local_18,in_stack_00000014);
          if (-1 < iVar5) {
            iVar5 = local_20->bone_list[0].parent_index;
            pCVar6 = result_out;
            if (-1 < iVar5) {
              local_14 = (CQuaternion4f *)(iVar5 * 0x10);
              core_xform_cpp_negateFirstComponent_FUN_005f75e0
                        (in_stack_00000008 + iVar5,in_stack_ffffff18);
              pCVar6 = &local_a8;
              local_a8.w = local_c8;
              pfVar10 = (float *)((int)&local_a8 + (uint)bVar12 * -8 + (uint)bVar12 * -8 + 8);
              *(float *)((int)&local_a8 + (uint)bVar12 * -8 + 4) = afStack_c4[(uint)bVar12 * -2];
              *pfVar10 = afStack_c4[(uint)bVar12 * -2 + (uint)bVar12 * -2 + 1];
              pfVar10[(uint)bVar12 * -2 + 1] =
                   (afStack_c4 + (uint)bVar12 * -2 + (uint)bVar12 * -2 + 1)[(uint)bVar12 * -2 + 1];
              core_xform_cpp_multiplyQuaternion_FUN_005f7640(result_out,pCVar6,in_stack_ffffff18);
              local_b8.w = afStack_84[3];
              pfVar10 = (float *)((int)&local_b8 + (uint)bVar12 * -8 + (uint)bVar12 * -8 + 8);
              *(float *)((int)&local_b8 + (uint)bVar12 * -8 + 4) = afStack_84[(uint)bVar12 * -2 + 4]
              ;
              *pfVar10 = afStack_84[(uint)bVar12 * -2 + (uint)bVar12 * -2 + 5];
              pfVar10[(uint)bVar12 * -2 + 1] =
                   (afStack_84 + (uint)bVar12 * -2 + (uint)bVar12 * -2 + 5)[(uint)bVar12 * -2 + 1];
              core_xform_cpp_multiplyQuaternion_FUN_005f7640
                        (&local_b8,(CQuaternion4f *)((int)&local_14->w + (int)&local_34->w),
                         in_stack_ffffff18);
              pCVar6 = &local_98;
            }
            puVar8 = (undefined4 *)((int)pCVar6 + (uint)bVar12 * -8 + 4);
            local_d8.w = pCVar6->w;
            puVar9 = (undefined4 *)((int)&local_d8 + (uint)bVar12 * -8 + (uint)bVar12 * -8 + 8);
            puVar7 = puVar8 + (uint)bVar12 * -2 + 1;
            *(undefined4 *)((int)&local_d8 + (uint)bVar12 * -8 + 4) = *puVar8;
            *puVar9 = *puVar7;
            puVar9[(uint)bVar12 * -2 + 1] = puVar7[(uint)bVar12 * -2 + 1];
            core_xform_cpp_slerpQuaternion_FUN_005f77e0
                      (local_30,&local_d8,in_stack_00000010,(float)in_stack_ffffff18);
            pfVar10 = (float *)((int)local_28 + (uint)bVar12 * -8 + 0x6b4);
            *(undefined4 *)(local_28->field3_0x508 + 0x1a8) = local_88;
            pfVar11 = pfVar10 + (uint)bVar12 * -2 + 1;
            *pfVar10 = afStack_84[(uint)bVar12 * -2];
            *pfVar11 = afStack_84[(uint)bVar12 * -2 + (uint)bVar12 * -2 + 1];
            pfVar11[(uint)bVar12 * -2 + 1] =
                 (afStack_84 + (uint)bVar12 * -2 + (uint)bVar12 * -2 + 1)[(uint)bVar12 * -2 + 1];
          }
    ...
    if (in_stack_00000014 < 0) {
      ...
      if ((float *)(this_ptr->field3_0x508 + 0x19c) != afStack_44) {
        *(float *)(this_ptr->field3_0x508 + 0x19c) =
             *(float *)(this_ptr->field3_0x508 + 0x19c) * fVar3 +
             *(float *)this_ptr->field3_0x508 * *in_stack_0000000c * (float)in_stack_00000010;
        *(float *)(this_ptr->field3_0x508 + 0x1a0) =
             *(float *)(this_ptr->field3_0x508 + 0x1a0) * fVar3 +
             *(float *)(this_ptr->field3_0x508 + 4) * fVar1 * (float)in_stack_00000010;
        *(float *)(this_ptr->field3_0x508 + 0x1a4) =
             *(float *)(this_ptr->field3_0x508 + 0x1a4) * fVar3 +
             *(float *)(this_ptr->field3_0x508 + 8) * fVar2 * (float)in_stack_00000010;
        return;
      }
    }
  }
...
// Assembly code:
// 0059f260: PUSH EBX
//   Label: core_skeleton.cpp_CDeformableModelInstance_FUN_0059f260
// 0059f261: PUSH ESI
// 0059f262: PUSH EDI
// 0059f263: PUSH EBP
...
// 0059f28e: PUSH EDX
// 0059f28f: CALL core_skeleton.cpp_CDeformableModelInstance_FUN_005a0820
