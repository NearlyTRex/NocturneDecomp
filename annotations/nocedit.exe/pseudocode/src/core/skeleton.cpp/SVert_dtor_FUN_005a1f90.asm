...
;                               FUNCTION
; *****************************************************************************
; __cdecl SVert * core_skeleton.cpp_SVert_dtor_FUN_005a1f90(SVert * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 005a1f99
    CALL core_cloth.cpp_freeVectors_FUN_0043e460 ; 005a1f9a | int core_cloth.cpp_freeVectors_FUN_0043e460(CVector3f * * array)
