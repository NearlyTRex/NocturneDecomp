...
section .text
    ...
    JNZ 0x005a1061                      ; 005a1050
        ;   XREF to: 005a1061 (CONDITIONAL_JUMP)  ; LAB_005a1061
    ...
    PUSH ESI                            ; 005a1061
        ;   Label: LAB_005a1061
    PUSH EBX                            ; 005a1062
    CALL core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0 ; 005a1063
    ...
    JL 0x005a1095                       ; 005a1079
        ;   XREF to: 005a1095 (CONDITIONAL_JUMP)  ; LAB_005a1095
    ...
    TEST EAX,EAX                        ; 005a1086
        ;   Label: LAB_005a1086
    JLE 0x005a1099                      ; 005a1088
        ;   XREF to: 005a1099 (CONDITIONAL_JUMP)  ; LAB_005a1099
    CMP ECX,dword ptr [EDX + 0x8]       ; 005a108a
    JZ 0x005a1099                       ; 005a108d
        ;   XREF to: 005a1099 (CONDITIONAL_JUMP)  ; LAB_005a1099
    DEC EAX                             ; 005a108f
    SUB EDX,0x8                         ; 005a1090
    JMP 0x005a1086                      ; 005a1093
        ;   XREF to: 005a1086 (UNCONDITIONAL_JUMP)  ; LAB_005a1086
    XOR EAX,EAX                         ; 005a1095
        ;   Label: LAB_005a1095
    JMP 0x005a107b                      ; 005a1097
        ;   XREF to: 005a107b (UNCONDITIONAL_JUMP)  ; LAB_005a107b
    CMP EAX,dword ptr [EBX + 0x2230]    ; 005a1099
        ;   Label: LAB_005a1099
    JZ 0x005a10ab                       ; 005a109f
        ;   XREF to: 005a10ab (CONDITIONAL_JUMP)  ; LAB_005a10ab
    PUSH EAX                            ; 005a10a1
    PUSH EBX                            ; 005a10a2
    CALL core_skeleton.cpp_CDeformableModelInstance_skinVerticesForLOD_FUN_005a01d0 ; 005a10a3
    ...
    PUSH EDX                            ; 005a10c6
    PUSH ESI                            ; 005a10c7
    CALL core_skeleton.cpp_CDeformableModel_dismember_FUN_0059c5e0 ; 005a10c8
        ;   XREF to: 0059c5e0 (UNCONDITIONAL_CALL)  ; void core_skeleton.cpp_CDeformableModel_dismember_FUN_0059c5e0(CDeformableModel * this_ptr, int lod_index, CBodyPart * body_part_ptr, int part_index, ...)
