...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_skeleton_cpp_CDeformableModelInstance_initializeFromModel_FUN_005a0480(CDeformableModelInstance *this_ptr,CDeformableModel *model_ptr)
;
; Parameters:
...
section .text
    ...
    CALL core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_005a0820 ; 005a0496
    ...
    CALL core_motion.cpp_CMotionController_setMotionList_FUN_0052dcb0 ; 005a04a8
        ;   XREF to: 0052dcb0 (UNCONDITIONAL_CALL)  ; void core_motion.cpp_CMotionController_setMotionList_FUN_0052dcb0(CMotionController * this_ptr, CMotionList * motion_list)
    ...
    JNZ 0x005a05ad                      ; 005a04f8
        ;   XREF to: 005a05ad (CONDITIONAL_JUMP)  ; LAB_005a05ad
    MOV EBX,dword ptr [ESP + 0x10]      ; 005a04fe
        ;   Label: LAB_005a04fe
    XOR ESI,ESI                         ; 005a0502
    TEST EBX,EBX                        ; 005a0504
    JLE 0x005a057e                      ; 005a0506
        ;   XREF to: 005a057e (CONDITIONAL_JUMP)  ; LAB_005a057e
    ...
    PUSH ECX                            ; 005a052d
    CALL core_skeleton.cpp_CDeformableModel_getVertexPoolPtr_FUN_0059a860 ; 005a052e
        ;   XREF to: 0059a860 (UNCONDITIONAL_CALL)  ; CVector3f * core_skeleton.cpp_CDeformableModel_getVertexPoolPtr_FUN_0059a860(CDeformableModel * this_ptr, int index)
    ADD ESP,0x8                         ; 005a0533
    CMP EBX,EAX                         ; 005a0536
    JZ 0x005a054a                       ; 005a0538
        ;   XREF to: 005a054a (CONDITIONAL_JUMP)  ; LAB_005a054a
    ...
    JL 0x005a05c5                       ; 005a0562
        ;   XREF to: 005a05c5 (CONDITIONAL_JUMP)  ; LAB_005a05c5
    ...
    JL 0x005a0522                       ; 005a057c
        ;   XREF to: 005a0522 (CONDITIONAL_JUMP)  ; LAB_005a0522
    MOV EDX,dword ptr [ESP + 0x28]      ; 005a057e
        ;   Label: LAB_005a057e
    PUSH EDX                            ; 005a0582
    CALL core_skeleton.cpp_CDeformableModelInstance_allocPointList_FUN_0059deb0 ; 005a0583
        ;   XREF to: 0059deb0 (UNCONDITIONAL_CALL)  ; void core_skeleton.cpp_CDeformableModelInstance_allocPointList_FUN_0059deb0(CDeformableModelInstance * this_ptr)
    ...
    PUSH EBX                            ; 005a059c
    CALL core_skeleton.cpp_CDeformableModelInstance_updateAnimationAndTransforms_FUN_0059e000 ; 005a059d
    ...
    JMP 0x005a04fe                      ; 005a05c0
        ;   XREF to: 005a04fe (UNCONDITIONAL_JUMP)  ; LAB_005a04fe
    ...
    JMP 0x005a0564                      ; 005a05db
        ;   XREF to: 005a0564 (UNCONDITIONAL_JUMP)  ; LAB_005a0564
