...
// Convention: __cdecl
// Signature: void __cdecl core_skeleton_cpp_CDeformableModelInstance_getBoneTransform_FUN_005a1510(CDeformableModelInstance *this_ptr,SPose *bone_transform)
  ...
  if (0 < iVar1) {
    ...
    do {
      ...
      *puVar10 = *puVar7;
      ...
      bone_transform = (SPose *)&bone_transform->bone_rotations[0].x;
      ...
      local_c = (SPose *)&(local_c->root_position).y;
      local_14 = (CDeformableModelInstance *)&(local_14->motion_controller).tween_speed;
      pSVar3 = (SPose *)&pSVar3->bone_rotations[2].x;
    } while (iVar5 < iVar1);
  }
  return;
}
