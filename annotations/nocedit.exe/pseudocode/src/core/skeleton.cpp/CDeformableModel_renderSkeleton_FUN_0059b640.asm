...
section .text
    ...
    PUSH EDX                            ; 0059b64b
    CALL core_skeleton.cpp_CDeformableModel_getSkeletonPtr_FUN_0059a810 ; 0059b64c | CSkeleton * core_skeleton.cpp_CDeformableModel_getSkeletonPtr_FUN_0059a810(CDeformableModel * this_ptr)
    ...
    CALL core_xform.cpp_getTranslation_FUN_005f6110 ; 0059b688 | void core_xform.cpp_getTranslation_FUN_005f6110(CVector3f * output_vector, CMatrix3x4f * input_matrix)
        ;   XREF to: 005f6110 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0059b68d
    LEA EAX,[ESP + 0x24]                ; 0059b690
    MOV EDX,dword ptr [0x006703ec]      ; 0059b694 | CDemonRenderer * g_CDemonRendererPtr
    FLD float ptr [EAX]                 ; 0059b69a
    FMUL float ptr [0x00662e98]         ; 0059b69c | float FLOAT_00662e98
    FISTP dword ptr [EBX]               ; 0059b6a2
    FLD float ptr [EAX + 0x4]           ; 0059b6a4
    FMUL float ptr [0x00662e98]         ; 0059b6a7 | float FLOAT_00662e98
    FISTP dword ptr [EBX + 0x4]         ; 0059b6ad
    FLD float ptr [EAX + 0x8]           ; 0059b6b0
    FMUL float ptr [0x00662e98]         ; 0059b6b3 | float FLOAT_00662e98
    FISTP dword ptr [EBX + 0x8]         ; 0059b6b9
    MOV EAX,ESP                         ; 0059b6bc
    MOV EBX,dword ptr [ESP + 0x30]      ; 0059b6be
    PUSH EAX                            ; 0059b6c2
    MOV EAX,dword ptr [EDX]             ; 0059b6c3 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,EBX                         ; 0059b6c5
    PUSH EAX                            ; 0059b6c7
    ADD EDI,0x30                        ; 0059b6c8
    INC ESI                             ; 0059b6cb
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 0059b6cc | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EBP + 0x28558]   ; 0059b6d1
    ADD ESP,0x8                         ; 0059b6d7
    CMP ESI,EAX                         ; 0059b6da
    JL 0x0059b677                       ; 0059b6dc | LAB_0059b677
    ...
    MOV [0x02d02570],EAX                ; 0059b6f0 | int g_ActiveRenderColor
    TEST ECX,ECX                        ; 0059b6f5
    JLE 0x0059b75d                      ; 0059b6f7 | LAB_0059b75d
        ;   XREF to: 0059b75d (CONDITIONAL_JUMP)
    ...
    JL 0x0059b73c                       ; 0059b70b | LAB_0059b73c
        ;   XREF to: 0059b73c (CONDITIONAL_JUMP)
    IMUL ESI,EAX,0x30                   ; 0059b70d
    MOV EAX,[0x006703ec]                ; 0059b710 | CDemonRenderer * g_CDemonRendererPtr
    MOV ECX,0xc                         ; 0059b715
    SUB ESP,0x30                        ; 0059b71a
    MOV EAX,dword ptr [EAX]             ; 0059b71d | CDemonRenderer g_CDemonRendererInstance
    ...
    CALL engine_3d.c_clipAndDrawLine2D_FUN_00407d70 ; 0059b734 | void engine_3d.c_clipAndDrawLine2D_FUN_00407d70(SRenderVertex * vertex1, SRenderVertex * vertex2)
    ...
    PUSH EAX                            ; 0059b780
    PUSH ESI                            ; 0059b781
    CALL core_xform.cpp_matrixToEulerAngles_FUN_005f5690 ; 0059b782 | CVector3f * core_xform.cpp_matrixToEulerAngles_FUN_005f5690(CVector3f * euler_out, CMatrix3x3f * matrix_ptr)
        ;   XREF to: 005f5690 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0059b787
    LEA EAX,[ESP + 0x18]                ; 0059b78a
    PUSH EAX                            ; 0059b78e
    PUSH ESI                            ; 0059b78f
    CALL core_xform.cpp_getTranslation_FUN_005f6110 ; 0059b790 | void core_xform.cpp_getTranslation_FUN_005f6110(CVector3f * output_vector, CMatrix3x4f * input_matrix)
        ;   XREF to: 005f6110 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0059b7a1
    MOV EDI,dword ptr [0x006703ec]      ; 0059b7a2 | CDemonRenderer * g_CDemonRendererPtr
    PUSH EDI                            ; 0059b7a8 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_applyScaledTransform_FUN_0048c4f0 ; 0059b7a9 | void engine_drender.cpp_CDemonRenderer_applyScaledTransform_FUN_0048c4f0(CDemonRenderer * this_ptr, CVector3i * position, CVector3i * rotation)
        ;   XREF to: 0048c4f0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0059b7ae
    PUSH 0xff                           ; 0059b7b1
    MOV EAX,[0x00678a60]                ; 0059b7b6 | CEditorTools * g_CEditorToolsPtr
    PUSH 0x3f000000                     ; 0059b7bb
    PUSH EAX                            ; 0059b7c0 | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_draw3DAxisLabels_FUN_004a1ca0 ; 0059b7c1 | void shape_edittool.cpp_CEditorTools_draw3DAxisLabels_FUN_004a1ca0(CEditorTools * this_ptr, float scale_factor, int text_color)
        ;   XREF to: 004a1ca0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0059b7c6
    MOV EDX,dword ptr [0x006703ec]      ; 0059b7c9 | CDemonRenderer * g_CDemonRendererPtr
    PUSH EDX                            ; 0059b7cf | CDemonRenderer g_CDemonRendererInstance
    INC EBX                             ; 0059b7d0
    ADD ESI,0x30                        ; 0059b7d1
    CALL engine_drender.cpp_CDemonRenderer_matrixPop_FUN_0050d720 ; 0059b7d4 | void engine_drender.cpp_CDemonRenderer_matrixPop_FUN_0050d720()
