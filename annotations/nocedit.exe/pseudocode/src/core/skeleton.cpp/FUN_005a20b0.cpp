// Name: core_skeleton.cpp_FUN_005a20b0
// Address: 005a20b0
// Address Range: [[005a20b0, 005a23b8]]
// Convention: unknown
// Signature: undefined core_skeleton.cpp_FUN_005a20b0()
// Cross-references:
...

{
  ...
  if (iVar1 != 0) {
    in_stack_00000004[4] = in_stack_00000004[4] - in_stack_00000028;
  }
  iVar1 = (*g_CKeysPtr->vtable->isKeyDown)(g_CKeysPtr,0x51);
  if (iVar1 != 0) {
    in_stack_00000004[4] = in_stack_00000004[4] + in_stack_0000003c;
  }
  iVar1 = (*g_CKeysPtr->vtable->isKeyDown)(g_CKeysPtr,0x48);
  if (iVar1 != 0) {
    fVar3 = (float10)fcos((float10)in_stack_00000004[4]);
    fVar2 = (float10)fsin((float10)in_stack_00000004[4]);
    *in_stack_00000004 = (float)(fVar2 * (float10)in_stack_00000034 + (float10)*in_stack_00000004);
    in_stack_00000004[2] =
         (float)(fVar3 * (float10)in_stack_00000034 + (float10)in_stack_00000004[2]);
  }
  iVar1 = (*g_CKeysPtr->vtable->isKeyDown)(g_CKeysPtr,0x50);
  if (iVar1 != 0) {
    fVar3 = (float10)fcos((float10)in_stack_00000004[4]);
    fVar2 = (float10)fsin((float10)in_stack_00000004[4]);
    *in_stack_00000004 = (float)((float10)*in_stack_00000004 - fVar2 * (float10)in_stack_00000048);
    in_stack_00000004[2] =
         (float)((float10)in_stack_00000004[2] - fVar3 * (float10)in_stack_00000048);
  }
  ...
  if (iVar1 != 0) {
    fVar3 = (float10)fsin((float10)in_stack_00000004[4] + (float10)DOUBLE_0064f142);
    fVar2 = (float10)fcos((float10)in_stack_00000004[4] + (float10)DOUBLE_0064f142);
    *in_stack_00000004 = (float)(fVar3 * (float10)in_stack_00000070 + (float10)*in_stack_00000004);
    in_stack_00000004[2] =
         (float)(fVar2 * (float10)in_stack_00000070 + (float10)in_stack_00000004[2]);
  }
  iVar1 = (*g_CKeysPtr->vtable->isKeyDown)(g_CKeysPtr,0x10);
  if (iVar1 != 0) {
    in_stack_00000004[1] = in_stack_00000004[1] + in_stack_00000084;
  }
  iVar1 = (*g_CKeysPtr->vtable->isKeyDown)(g_CKeysPtr,0x1e);
  if (iVar1 != 0) {
    in_stack_00000004[1] = in_stack_00000004[1] - in_stack_00000098;
  }
  iVar1 = (*g_CKeysPtr->vtable->isKeyDown)(g_CKeysPtr,0x3f);
  if (iVar1 != 0) {
    in_stack_00000004[3] = in_stack_00000004[3] - in_stack_000000c8;
  }
  iVar1 = (*g_CKeysPtr->vtable->isKeyDown)(g_CKeysPtr,0x42);
  if (iVar1 != 0) {
    in_stack_00000004[3] = in_stack_00000004[3] + in_stack_000000dc;
  }
  iVar1 = (*g_CKeysPtr->vtable->isKeyDown)(g_CKeysPtr,0x47);
  if (iVar1 != 0) {
    in_stack_00000004[5] = in_stack_00000004[5] - in_stack_000000f0;
  }
  iVar1 = (*g_CKeysPtr->vtable->isKeyDown)(g_CKeysPtr,0x49);
  if (iVar1 != 0) {
    in_stack_00000004[5] = in_stack_00000004[5] + in_stack_00000104;
  }
  iVar1 = (*g_CKeysPtr->vtable->isKeyDown)(g_CKeysPtr,0xc);
  if (iVar1 != 0) {
    in_stack_00000004[6] = in_stack_00000004[6] - in_stack_0000011c;
  }
  iVar1 = (*g_CKeysPtr->vtable->isKeyDown)(g_CKeysPtr,0xd);
  if (iVar1 != 0) {
    in_stack_00000004[6] = in_stack_00000004[6] + in_stack_00000130;
  }
  iVar1 = (*g_CKeysPtr->vtable->isKeyDown)(g_CKeysPtr,0x4c);
  if (iVar1 != 0) {
    in_stack_00000004[5] = 0.0;
...
// Assembly code:
// 005a20b0: PUSH EBX
//   Label: core_skeleton.cpp_FUN_005a20b0
// 005a20b1: PUSH EBP
