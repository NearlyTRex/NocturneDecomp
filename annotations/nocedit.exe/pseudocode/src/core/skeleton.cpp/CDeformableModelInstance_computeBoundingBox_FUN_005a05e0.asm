...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_skeleton.cpp_CDeformableModelInstance_computeBoundingBox_FUN_005a05e0(CDeformableModelInstance * this_ptr)
;
; Parameters:
...
section .text
    ...
    CALL core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0 ; 005a060e | CDeformableModel * core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0(CDeformableModelInstance * this_ptr)
    ...
    CALL core_skeleton.cpp_CDeformableModelInstance_updateMotionAtFrame_FUN_0059e070 ; 005a061e | void core_skeleton.cpp_CDeformableModelInstance_updateMotionAtFrame_FUN_0059e070(CDeformableModelInstance * this_ptr, int motion_index, float frame_number)
        ;   XREF to: 0059e070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005a0623
    PUSH 0x0                            ; 005a0626
    PUSH EBP                            ; 005a0628
    CALL core_skeleton.cpp_CDeformableModelInstance_skinVerticesForLOD_FUN_005a01d0 ; 005a0629 | void core_skeleton.cpp_CDeformableModelInstance_skinVerticesForLOD_FUN_005a01d0(CDeformableModelInstance * this_ptr, int lod_index)
        ;   XREF to: 005a01d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005a062e
    TEST ESI,ESI                        ; 005a0631
    JLE 0x005a06b1                      ; 005a0633 | LAB_005a06b1
    ...
    JGE 0x005a0666                      ; 005a0660 | LAB_005a0666
    ...
    JLE 0x005a0672                      ; 005a066d | LAB_005a0672
    ...
    JGE 0x005a0680                      ; 005a067a | LAB_005a0680
    ...
    JLE 0x005a068e                      ; 005a0688 | LAB_005a068e
    ...
    JGE 0x005a069c                      ; 005a0696 | LAB_005a069c
    ...
    FMUL float ptr [0x00662ea0]         ; 005a06bf | float FLOAT_00662ea0
    FSTP float ptr [EBX]                ; 005a06c5
    FILD dword ptr [EAX + 0x4]          ; 005a06c7
    FMUL float ptr [0x00662ea0]         ; 005a06ca | float FLOAT_00662ea0
    FSTP float ptr [EBX + 0x4]          ; 005a06d0
    FILD dword ptr [EAX + 0x8]          ; 005a06d3
    FMUL float ptr [0x00662ea0]         ; 005a06d6 | float FLOAT_00662ea0
    ...
    FMUL float ptr [0x00662ea0]         ; 005a06eb | float FLOAT_00662ea0
    FSTP float ptr [EBX]                ; 005a06f1
    FILD dword ptr [EAX + 0x4]          ; 005a06f3
    FMUL float ptr [0x00662ea0]         ; 005a06f6 | float FLOAT_00662ea0
    FSTP float ptr [EBX + 0x4]          ; 005a06fc
    FILD dword ptr [EAX + 0x8]          ; 005a06ff
    FMUL float ptr [0x00662ea0]         ; 005a0702 | float FLOAT_00662ea0
    ...
    FXCH                                ; 005a071a
    FLD float ptr [0x0064eeec]          ; 005a071c | float FLOAT_0064eeec
    FXCH                                ; 005a0722
    FMUL ST1                            ; 005a0724
    FXCH ST2                            ; 005a0726
