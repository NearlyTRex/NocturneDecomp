...
;                               FUNCTION
; *****************************************************************************
; __cdecl CSkeleton * __cdecl core_skeleton_cpp_CDeformableModel_getSkeletonPtr_FUN_0059a810(CDeformableModel *this_ptr)
;
; Parameters:
...
section .text
    ...
    JZ 0x0059a828                       ; 0059a81b
        ;   XREF to: 0059a828 (CONDITIONAL_JUMP)  ; LAB_0059a828
    MOV EAX,dword ptr [ESP + 0x4]       ; 0059a81d
    MOV EAX,dword ptr [EAX + 0x8fac]    ; 0059a821
    RET                                 ; 0059a827
    PUSH EBX                            ; 0059a828
        ;   Label: LAB_0059a828
    MOV ECX,0x64e7f7                    ; 0059a829 | = "..\\core\\skeleton.cpp"
    MOV EBX,0x2e6                       ; 0059a82e
    PUSH 0x64e80c                       ; 0059a833 | = "Tried to do something with the skelet..."
    MOV dword ptr [0x02f0ca48],ECX      ; 0059a838 | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 0059a83e | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0059a844
