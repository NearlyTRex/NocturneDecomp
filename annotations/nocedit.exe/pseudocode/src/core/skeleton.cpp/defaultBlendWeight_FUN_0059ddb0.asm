...
;                               FUNCTION
; *****************************************************************************
; __cdecl float core_skeleton.cpp_defaultBlendWeight_FUN_0059ddb0(int current_bone_index, int target_bone_index, float blend_weight, int hierarchy_distance, CDeformableModelInstance * instance)
;
; Parameters:
...
;   core_charactr.cpp_FUN_0042e570 at 0042e584
;   core_colonel.cpp_FUN_0043fa00 at 0043fc47
...
;   core_haystack.cpp_FUN_004f0e40 at 004f1099
;   core_hostage.cpp_RelatedToRescuedTownsfolk_FUN_004f4bd0 at 004f5ef0
;   ... and 12 more
;
; *****************************************************************************
