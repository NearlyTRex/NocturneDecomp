...
section .text
    ...
    CALL crt_memory.c___arrinit_FUN_005fe667 ; 0059969d
        ;   XREF to: 005fe667 (UNCONDITIONAL_CALL)  ; void * crt_memory.c___arrinit_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
    ADD ESP,0xc                         ; 005996a2
    PUSH 0x681a5f                       ; 005996a5 | g_SkeletonPoolDestructorNode
    CALL crt_stdlib.c__atexit_FUN_005ff060 ; 005996aa
        ;   XREF to: 005ff060 (UNCONDITIONAL_CALL)  ; void crt_stdlib.c__atexit_FUN_005ff060(WatcomStaticDestructorNode * exit_node)
