// Name: core_skeleton.cpp_FUN_005a0d10
// Address: 005a0d10
// Address Range: [[005a0d10, 005a0f46]]
// Convention: unknown
// Signature: undefined core_skeleton.cpp_FUN_005a0d10()
// Cross-references:
//   core_skeleton.cpp_FUN_005a0c90 (005a0c90) at 005a0ca5 [UNCONDITIONAL_CALL]
...
float * core_skeleton_cpp_FUN_005a0d10(void)

{
  ...
  if (iVar1 < iVar2) {
    iVar11 = iVar1 * 0xc;
    do {
      iVar9 = *(int *)(iVar10 + 0x29378);
      local_2c = local_2c + *(float *)(iVar9 + iVar11);
      local_28 = local_28 + *(float *)(iVar9 + 4 + iVar11);
      local_24 = local_24 + *(float *)(iVar9 + 8 + iVar11);
      iVar11 = iVar11 + 0xc;
    } while (iVar11 < iVar2 * 0xc);
  }
  iVar11 = iVar1 * 0xc;
  in_stack_00000010 = in_stack_00000010 - (float)iVar1;
  iVar9 = *(int *)(iVar10 + 0x29378);
  fVar3 = *(float *)(iVar11 + 4 + iVar9);
  fVar4 = *(float *)(iVar11 + 8 + iVar9);
  iVar1 = iVar2 + -1;
  in_stack_00000014 = (float)iVar2 - in_stack_00000014;
  iVar2 = *(int *)(iVar10 + 0x29378);
  fVar5 = *(float *)(iVar2 + 4 + iVar1 * 0xc);
  fVar6 = *(float *)(iVar2 + 8 + iVar1 * 0xc);
  fVar7 = *(float *)(in_stack_00000004 + 0x50c);
  fVar8 = *(float *)(in_stack_00000004 + 0x510);
  *in_stack_00000008 =
       ((local_2c - *(float *)(iVar11 + iVar9) * in_stack_00000010) -
       *(float *)(iVar2 + iVar1 * 0xc) * in_stack_00000014) * *(float *)(in_stack_00000004 + 0x508);
  in_stack_00000008[1] =
       ((local_28 - fVar3 * in_stack_00000010) - fVar5 * in_stack_00000014) * fVar7;
  in_stack_00000008[2] =
       ((local_24 - fVar4 * in_stack_00000010) - fVar6 * in_stack_00000014) * fVar8;
  return in_stack_00000008;
}
...
// Assembly code:
// 005a0d10: PUSH ESI
//   Label: core_skeleton.cpp_FUN_005a0d10
// 005a0d11: PUSH EDI
...
//   Label: LAB_005a0d4d
// 005a0d4e: PUSH EDI
// 005a0d4f: CALL core_skeleton.cpp_CDeformableModelInstance_GetModelPtrAndSomething_FUN_005a0820
