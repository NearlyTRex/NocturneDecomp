// Name: core_skeleton.cpp_CDeformableModelInstance_GetModelPtrDoSomething20_FUN_005a1510
// Address: 005a1510
// Address Range: [[005a1510, 005a15d8]]
// Convention: unknown
// Signature: undefined core_skeleton.cpp_CDeformableModelInstance_GetModelPtrDoSomething20_FUN_005a1510()
// Cross-references:
...
//   core_skeledit.cpp_DefinitelyRelatedToEditorMode_FUN_005968b0 (005968b0) at 005972ee [UNCONDITIONAL_CALL]
...
/* Signature: undefined1
   core_skeleton.cpp_CDeformableModelInstance_GetModelPtrDoSomething20(undefined4 param_1,
   undefined4 param_2) */

void core_skeleton_cpp_CDeformableModelInstance_GetModelPtrDoSomething20_FUN_005a1510(void)

{
  ...
  bVar8 = 0;
  if (in_stack_00000008 != (undefined4 *)(in_stack_00000004 + 0x6a4)) {
    *in_stack_00000008 = *(undefined4 *)(in_stack_00000004 + 0x6a4);
    in_stack_00000008[1] = *(undefined4 *)(in_stack_00000004 + 0x6a8);
    in_stack_00000008[2] = *(undefined4 *)(in_stack_00000004 + 0x6ac);
  }
  ...
  if (0 < iVar1) {
    ...
    do {
      puVar6 = in_stack_00000008 + (uint)bVar8 * -2 + 4;
      puVar5 = (undefined4 *)(local_10 + 0x6b4 + (uint)bVar8 * -8);
      in_stack_00000008[3] = *(undefined4 *)(local_10 + 0x6b0);
      puVar7 = puVar5 + (uint)bVar8 * -2 + 1;
      *puVar6 = *puVar5;
      puVar6[(uint)bVar8 * -2 + 1] = *puVar7;
      (puVar6 + (uint)bVar8 * -2 + 1)[(uint)bVar8 * -2 + 1] = puVar7[(uint)bVar8 * -2 + 1];
      puVar9[0x193] = *(undefined4 *)(in_stack_00000004 + 0xcf0);
      in_stack_00000004 = in_stack_00000004 + 4;
      in_stack_00000008 = in_stack_00000008 + 4;
      puVar5 = (undefined4 *)(local_c + 0xe80);
      puVar7 = puVar2 + 0x1f7;
...
// Assembly code:
// 005a1510: PUSH EDI
//   Label: core_skeleton.cpp_CDeformableModelInstance_GetModelPtrDoSomething20_FUN_005a1510
// 005a1511: PUSH EBP
...
// 005a1538: PUSH EDI
//   Label: LAB_005a1538
// 005a1539: CALL core_skeleton.cpp_CDeformableModelInstance_GetModelPtrAndSomething_FUN_005a0820
