...

{
  ...
  if (body_part_ptr != (CBodyPart *)0x0) {
    ...
    memset(g_VertexRemapTable,0,this_ptr->vertex_count[lod_index] * sizeof(*g_VertexRemapTable));
    if (local_2c < iVar8) {
      iVar3 = local_2c;
      do {
      ...
      do {
        ...
        iVar10 = core_bodypart_cpp_CBodyPart_addTexture_FUN_0041af90
                           (body_part_ptr,
                            ...
                            [this_ptr->index_data_ptr[lod_index][iVar5]]
                            .texture_name);
    ...
    if (local_30 < iVar12) {
      ...
      do {
        ...
        iVar10 = core_bodypart_cpp_CBodyPart_addTexture_FUN_0041af90
                           (body_part_ptr,
                            this_ptr->texture_sets[texture_set_index].textures
                            [this_ptr->index_data_ptr[lod_index][iVar13]].
                            texture_name);
        body_part_ptr->face_texture_indices[local_14] = iVar10;
        iVar13 = iVar13 + 1;
        local_14 = local_14 + 1;
