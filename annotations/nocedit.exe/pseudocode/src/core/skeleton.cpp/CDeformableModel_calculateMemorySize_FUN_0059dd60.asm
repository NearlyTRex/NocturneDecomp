...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_skeleton.cpp_CDeformableModel_calculateMemorySize_FUN_0059dd60(CDeformableModel * this_ptr)
;
; Parameters:
...
section .text
    ...
    JLE 0x0059dd9d                      ; 0059dd6f | LAB_0059dd9d
    ...
    JL 0x0059dd74                       ; 0059dd9a | LAB_0059dd74
