...
;                               FUNCTION
; *****************************************************************************
; __cdecl CDeformableModel * core_skeleton.cpp_CDeformableModel_ctor_FUN_0059a160(CDeformableModel * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH 0x6598c0                       ; 0059a165 | WatcomTypeInfo g_CVectorTypeInfo
    PUSH 0x64                           ; 0059a16a
    ADD EBX,0x7c90                      ; 0059a16c
    PUSH EBX                            ; 0059a172
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 0059a173 | void * crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
        ;   XREF to: 005fe667 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0059a178
    PUSH 0x659900                       ; 0059a17b | WatcomTypeInfo g_CBoundingBox3DTypeInfo
    PUSH 0x64                           ; 0059a180
    ADD EAX,0x4bc                       ; 0059a182
    PUSH EAX                            ; 0059a187
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 0059a188 | void * crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
        ;   XREF to: 005fe667 (UNCONDITIONAL_CALL)
    ...
    JNZ 0x0059a19d                      ; 0059a1bd | LAB_0059a19d
    ...
    CALL crt_memory.c_memset_FUN_005fde40 ; 0059a1e1 | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
    ...
    CALL crt_memory.c_memset_FUN_005fde40 ; 0059a201 | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
        ;   XREF to: 005fde40 (UNCONDITIONAL_CALL)
    ...
    CALL crt_memory.c_memset_FUN_005fde40 ; 0059a24a | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
        ;   XREF to: 005fde40 (UNCONDITIONAL_CALL)
