...
;                               FUNCTION
; *****************************************************************************
; __cdecl CBoundingBox3D * core_skeleton.cpp_CDeformableModelInstance_computeBoundingBox_FUN_005a16c0(CDeformableModelInstance * this_ptr, CBoundingBox3D * output_bbox)
;
; Parameters:
...
section .text
    ...
    PUSH ESI                            ; 005a16cf
    CALL core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0 ; 005a16d0 | CDeformableModel * core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0(CDeformableModelInstance * this_ptr)
        ;   XREF to: 005a07a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005a16d5
    PUSH EAX                            ; 005a16d8
    MOV EBX,EAX                         ; 005a16d9
    CALL core_skeleton.cpp_CDeformableModel_getSkeletonPtr_FUN_0059a810 ; 005a16db | CSkeleton * core_skeleton.cpp_CDeformableModel_getSkeletonPtr_FUN_0059a810(CDeformableModel * this_ptr)
    ...
    CALL core_box.cpp_CBoundingBox3D_reset_FUN_00420fb0 ; 005a16ee | void core_box.cpp_CBoundingBox3D_reset_FUN_00420fb0(CBoundingBox3D * this_ptr)
    ...
    JLE 0x005a1797                      ; 005a1702 | LAB_005a1797
    ...
    JNZ 0x005a1765                      ; 005a172b | LAB_005a1765
    ...
    PUSH EAX                            ; 005a173d
    PUSH ESI                            ; 005a173e
    CALL core_box.cpp_CBoundingBox3D_getCorner_FUN_004202b0 ; 005a173f | CVector3f * core_box.cpp_CBoundingBox3D_getCorner_FUN_004202b0(CBoundingBox3D * this_ptr, CVector3f * out_point, uint corner_index)
        ;   XREF to: 004202b0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005a1744
    PUSH EAX                            ; 005a1747
    LEA EAX,[ESP + 0x14]                ; 005a1748
    PUSH EAX                            ; 005a174c
    CALL core_xform.cpp_transformVector3x4_FUN_005f4dc0 ; 005a174d | CVector3f * core_xform.cpp_transformVector3x4_FUN_005f4dc0(CVector3f * output_vector, CVector3f * input_vector, CMatrix3x4f * matrix)
        ;   XREF to: 005f4dc0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005a1752
    PUSH EAX                            ; 005a1755
    PUSH EBP                            ; 005a1756
    INC EBX                             ; 005a1757
    CALL core_box.cpp_CBoundingBox3D_expand_FUN_00420240 ; 005a1758 | void core_box.cpp_CBoundingBox3D_expand_FUN_00420240(CBoundingBox3D * this_ptr, CVector3f * point)
        ;   XREF to: 00420240 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005a175d
    CMP EBX,0x8                         ; 005a1760
    JL 0x005a1737                       ; 005a1763 | LAB_005a1737
    ...
    JL 0x005a1720                       ; 005a1795 | LAB_005a1720
