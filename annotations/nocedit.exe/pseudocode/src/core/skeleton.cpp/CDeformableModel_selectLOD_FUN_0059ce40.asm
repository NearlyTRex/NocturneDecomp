...
section .text
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 0059ce49 | g_CDemonRendererInstance | g_CDemonRendererPtr
    ...
    JNZ 0x0059ce67                      ; 0059ce5a
        ;   XREF to: 0059ce67 (CONDITIONAL_JUMP)  ; LAB_0059ce67
    CMP dword ptr [EBX],0x1             ; 0059ce5c
    JG 0x0059ce6c                       ; 0059ce5f
        ;   XREF to: 0059ce6c (CONDITIONAL_JUMP)  ; LAB_0059ce6c
    ...
    MOV EAX,dword ptr [EBX]             ; 0059ce67
        ;   Label: LAB_0059ce67
    DEC EAX                             ; 0059ce69
    JMP 0x0059ce61                      ; 0059ce6a
        ;   XREF to: 0059ce61 (UNCONDITIONAL_JUMP)  ; LAB_0059ce61
    PUSH ESI                            ; 0059ce6c
        ;   Label: LAB_0059ce6c
    MOV ESI,dword ptr [ESP + 0x1c]      ; 0059ce6d
    PUSH ESI                            ; 0059ce71
    CALL core_box.cpp_CBoundingBox3D_getBoundingBoxScreenSize_FUN_00420840 ; 0059ce72
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 0059ce81
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_005fe6b0(double value)
    ADD ESP,0x4                         ; 0059ce86
    DEC ECX                             ; 0059ce89
    FISTP dword ptr [ESP + 0x4]         ; 0059ce8a
    TEST ECX,ECX                        ; 0059ce8e
    JLE 0x0059cead                      ; 0059ce90
        ;   XREF to: 0059cead (CONDITIONAL_JUMP)  ; LAB_0059cead
    LEA EDX,[ECX*0x8 + 0x0]             ; 0059ce92
    MOV EBP,dword ptr [ESP + 0x4]       ; 0059ce99
    ADD EDX,EBX                         ; 0059ce9d
    CMP dword ptr [EDX + 0x8],0x0       ; 0059ce9f
        ;   Label: LAB_0059ce9f
    JZ 0x0059ceb6                       ; 0059cea3
        ;   XREF to: 0059ceb6 (CONDITIONAL_JUMP)  ; LAB_0059ceb6
    DEC ECX                             ; 0059cea5
        ;   Label: LAB_0059cea5
    SUB EDX,0x8                         ; 0059cea6
    TEST ECX,ECX                        ; 0059cea9
    JG 0x0059ce9f                       ; 0059ceab
        ;   XREF to: 0059ce9f (CONDITIONAL_JUMP)  ; LAB_0059ce9f
    ...
    CMP EBP,dword ptr [EDX + 0x4]       ; 0059ceb6
        ;   Label: LAB_0059ceb6
    JL 0x0059cead                       ; 0059ceb9
        ;   XREF to: 0059cead (CONDITIONAL_JUMP)  ; LAB_0059cead
    JMP 0x0059cea5                      ; 0059cebb
        ;   XREF to: 0059cea5 (UNCONDITIONAL_JUMP)  ; LAB_0059cea5
