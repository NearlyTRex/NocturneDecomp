...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_skeleton.cpp_CDeformableModel_skinVertices_FUN_0059a880(CDeformableModel * this_ptr, int lod_index, CMatrix3x4f * bone_matrices, int * output_buffer)
;
; Parameters:
...
section .text
    ...
    JGE 0x0059a9ee                      ; 0059a8b3 | LAB_0059a9ee
    ...
    JZ 0x0059a9ac                       ; 0059a8cc | LAB_0059a9ac
    ...
    JGE 0x0059a962                      ; 0059a8f5 | LAB_0059a962
    ...
    PUSH EAX                            ; 0059a909
    CALL core_xform.cpp_transformVector3x4_FUN_005f4dc0 ; 0059a90a | CVector3f * core_xform.cpp_transformVector3x4_FUN_005f4dc0(CVector3f * output_vector, CVector3f * input_vector, CMatrix3x4f * matrix)
    ...
    JMP 0x0059a8eb                      ; 0059a960 | LAB_0059a8eb
    ...
    FMUL float ptr [0x00662e98]         ; 0059a970 | float FLOAT_00662e98
    FISTP dword ptr [EBX]               ; 0059a976
    FLD float ptr [EAX + 0x4]           ; 0059a978
    FMUL float ptr [0x00662e98]         ; 0059a97b | float FLOAT_00662e98
    FISTP dword ptr [EBX + 0x4]         ; 0059a981
    FLD float ptr [EAX + 0x8]           ; 0059a984
    FMUL float ptr [0x00662e98]         ; 0059a987 | float FLOAT_00662e98
    ...
    JMP 0x0059a8a4                      ; 0059a9a7 | LAB_0059a8a4
    ...
    PUSH EAX                            ; 0059a9c2
    CALL core_xform.cpp_transformVector3x4_FUN_005f4dc0 ; 0059a9c3 | CVector3f * core_xform.cpp_transformVector3x4_FUN_005f4dc0(CVector3f * output_vector, CVector3f * input_vector, CMatrix3x4f * matrix)
        ;   XREF to: 005f4dc0 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 0059a9c8
    LEA EAX,[ESP + 0x30]                ; 0059a9ca
    ADD ESP,0xc                         ; 0059a9ce
    CMP EAX,EBX                         ; 0059a9d1
    JZ 0x0059a962                       ; 0059a9d3 | LAB_0059a962
        ;   XREF to: 0059a962 (CONDITIONAL_JUMP)
    ...
    JMP 0x0059a962                      ; 0059a9e9 | LAB_0059a962
