...
// Convention: __cdecl
// Signature: void core_skeleton.cpp_freeAllSkeletons_FUN_005a1ea0(void)
// Cross-references:
...

{
  ...
  do {
    ...
    this_ptr = this_ptr + 1;
  } while (this_ptr != (CSkeleton *)&g_SkeletonPoolEnd);
...
// 005a1ea7: CALL core_skeleton.cpp_freeAllModels_FUN_005a1dc0
