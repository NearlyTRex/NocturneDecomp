...
//   core_skeleton.cpp_CDeformableModelInstance_updateAnimation_FUN_0059e020 (0059e020) at 0059e02f [UNCONDITIONAL_CALL]
//   core_skeleton.cpp_CDeformableModelInstance_updateMotionAtFrame_FUN_0059e070 (0059e070) at 0059e081 [UNCONDITIONAL_CALL]
...

{
  ...
  if (bone_index < 0) {
    ...
    if (0 < this_ptr_00->bone_count) {
      ...
      do {
        ...
        local_54->bone_rotations[0].w = afStack_250[3];
        ...
        *pfVar12 = afStack_250[(uint)bVar18 * -2 + (uint)bVar18 * -2 + 5];
        ...
        pCVar13->current_pose_data[0] = pCVar13->rest_pose_data[1];
        local_2c = local_2c + 1;
    ...
    if (&this_ptr->root_position != (CVector3f *)local_8c) {
      (this_ptr->root_position).x =
           pCVar5[local_7c].x * fVar6 + pCVar4[local_80].x * (float)in_stack_ffffe798;
      (this_ptr->root_position).y = fVar2 * fVar6 + fVar19 * (float)in_stack_ffffe798;
      (this_ptr->root_position).z = fVar3 * fVar6 + fVar1 * (float)in_stack_ffffe798;
    }
    fVar19 = (float)this_ptr->field3_0x508;
    fVar1 = this_ptr->rest_pose_data[0];
    (this_ptr->root_position).y = (float)this_ptr->field4_0x50c * (this_ptr->root_position).y;
    (this_ptr->root_position).z = fVar1 * (this_ptr->root_position).z;
    (this_ptr->root_position).x = fVar19 * (this_ptr->root_position).x;
    return;
  }
  if (this_ptr->field16_0x2250 == 1) {
      ...
      do {
        ...
        *(int *)((int)aiStack_5a8 + (int)local_34) = iVar20;
        if (-1 < iVar20) {
          ...
          puVar11 = (undefined4 *)(auStack_be4 + (uint)bVar18 * -8 + local_4c + 4);
          *(float *)(auStack_be4 + local_4c) = CStack_c4.w;
          puVar10 = (undefined4 *)((int)&CStack_c4 + (uint)bVar18 * -8 + (uint)bVar18 * -8 + 8);
          *puVar11 = *(undefined4 *)((int)&CStack_c4 + (uint)bVar18 * -8 + 4);
    ...
    if (0 < this_ptr_00->bone_count) {
      local_50 = 0;
      local_6c = this_ptr->bone_rotations;
      ...
      do {
        if (-1 < *(int *)((int)aiStack_5a8 + local_50 + 4)) {
          ...
          if (local_78 < 0) {
            ...
            puVar10 = (undefined4 *)((int)&CStack_200 + (uint)bVar18 * -8 + (uint)bVar18 * -8 + 4);
            ...
            *puVar10 = auStack_138[(uint)bVar18 * -2 + (uint)bVar18 * -2 + -4];
            ...
            puVar10 = (undefined4 *)((int)local_ac + (uint)bVar18 * -8 + (uint)bVar18 * -8 + 8);
            *(undefined4 *)((int)local_ac + (uint)bVar18 * -8 + 4) = auStack_138[(uint)bVar18 * -2];
          ...
          pfVar12 = pfVar17 + (uint)bVar18 * -2 + 1;
          pCVar13->bone_rotations[0].w = *pfVar17;
  ...
  else if (this_ptr->field16_0x2250 == 2) {
      ...
      do {
        ...
        *(int *)((int)aiStack_418 + local_3c) = iVar7;
        if (-1 < iVar7) {
          ...
          puVar14 = (undefined4 *)((int)&CStack_1220 + (uint)bVar18 * -8 + local_3c);
          puVar10 = (undefined4 *)((int)pCVar9 + (uint)bVar18 * -8 + 4);
    ...
    if (-1 < (int)local_6c) {
      ...
      puVar14 = (undefined4 *)((int)&CStack_1220 + (uint)bVar18 * -8 + iVar20);
      puVar10 = (undefined4 *)((int)pCVar9 + (uint)bVar18 * -8 + 4);
      ...
      *puVar15 = *puVar11;
      ...
      puVar10 = (undefined4 *)(&stack0xffffe7a4 + (uint)bVar18 * -8 + local_74);
    ...
    if (0 < this_ptr_00->bone_count) {
      ...
      local_60 = this_ptr->bone_rotations;
      local_44 = this_ptr_00;
      pCStack_14 = this_ptr;
      do {
        if (-1 < *(int *)((int)aiStack_418 + (int)local_58 + 8)) {
          ...
          (afStack_1b8 + (uint)bVar18 * -2 + (uint)bVar18 * -2)[(uint)bVar18 * -2 + 1] =
               pfVar12[(uint)bVar18 * -2 + 1];
          puVar10 = (undefined4 *)(&stack0xffffe7a4 + (uint)bVar18 * -8 + iVar20);
          auStack_d8._8_4_ = *(float *)(&stack0xffffe7a0 + iVar20);
          *(undefined4 *)(auStack_d8 + (uint)bVar18 * -8 + 0xc) = *puVar10;
          iVar20 = local_1c;
          ...
          puVar10 = (undefined4 *)((int)pCStack_14 + (uint)bVar18 * -8 + 0x6b4);
          afStack_e8[2] = pCStack_14->bone_rotations[0].w;
          puVar11 = puVar10 + (uint)bVar18 * -2 + 1;
          *(undefined4 *)(auStack_d8 + (uint)bVar18 * -8 + -4) = *puVar10;
          *(undefined4 *)(auStack_d8 + (uint)bVar18 * -8 + (uint)bVar18 * -8) = *puVar11;
          *(undefined4 *)
          ...
          if (-1 < iVar20) {
            ...
            *(float *)((int)&CStack_274 + (uint)bVar18 * -8) = afStack_1e0[(uint)bVar18 * -2];
            ...
            puVar10 = (undefined4 *)((int)&CStack_c4 + (uint)bVar18 * -8 + (uint)bVar18 * -8 + 0xc);
            *(undefined4 *)((int)&CStack_c4 + (uint)bVar18 * -8 + 8) = local_17c[(uint)bVar18 * -2];
...
// 0059e0b5: PUSH EDX
// 0059e0b6: CALL core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_005a0820
...
//   XREF to: Stack[0x4] (READ)
// 0059e0dc: PUSH ECX
// 0059e0dd: CALL core_motion.cpp_CMotionController_getFramesForInterpolation_FUN_0052e4c0
...
//   Label: LAB_0059e633
// 0059e639: PUSH EAX
// 0059e63a: CALL core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_005a0820
//   XREF to: 005a0820 (UNCONDITIONAL_CALL)
