...
section .text
    ...
    CALL crt_stack.c_stack_probe_FUN_005ff9f3 ; 005998e5 | uint crt_stack.c_stack_probe_FUN_005ff9f3(uint stack_size)
        ;   XREF to: 005ff9f3 (UNCONDITIONAL_CALL)
    PUSH EBX                            ; 005998ea
    MOV EBX,dword ptr [ESP + 0x8]       ; 005998eb
    PUSH EBX                            ; 005998ef
    CALL core_skeleton.cpp_CSkeleton_free_FUN_00599a50 ; 005998f0 | void core_skeleton.cpp_CSkeleton_free_FUN_00599a50(CSkeleton * this_ptr)
        ;   XREF to: 00599a50 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005998f5
    PUSH 0x0                            ; 005998f8
    ADD EBX,0x2937c                     ; 005998fa
    PUSH EBX                            ; 00599900
    CALL core_curtain.cpp_freeVectors_FUN_0044baf0 ; 00599901 | void core_curtain.cpp_freeVectors_FUN_0044baf0(CVector3f * * array)
