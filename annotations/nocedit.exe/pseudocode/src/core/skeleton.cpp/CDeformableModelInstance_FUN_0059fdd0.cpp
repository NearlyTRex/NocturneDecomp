// Name: core_skeleton.cpp_CDeformableModelInstance_FUN_0059fdd0
// Address: 0059fdd0
// Address Range: [[0059fdd0, 0059ff14]]
// Convention: __cdecl
// Signature: void core_skeleton.cpp_CDeformableModelInstance_FUN_0059fdd0(CDeformableModelInstance * this_ptr)
// Globals:
...
void __cdecl
core_skeleton_cpp_CDeformableModelInstance_FUN_0059fdd0(CDeformableModelInstance *this_ptr)

{
  ...
  float afStackY_187c [28];
  CQuaternion4f *apCStackY_180c [488];
  float afStackY_106c [21];
  CQuaternion4f *apCStackY_1018 [984];
  ...
  bVar3 = 0;
  if (in_stack_0000000c <= (float)DOUBLE_0064ee28) {
    return;
  }
  core_skeleton_cpp_CDeformableModelInstance_FUN_005a0820(this_ptr);
  pCVar1 = core_skeleton_cpp_CDeformableModelInstance_FUN_0059fa20(this_ptr);
  local_24.x = *in_stack_00000008 - pCVar1->x;
  local_24.y = in_stack_00000008[1] - pCVar1->y;
  local_24.z = in_stack_00000008[2] - pCVar1->z;
  ...
  *(undefined4 *)(&stack0xffffff68 + (uint)bVar3 * -8 + (uint)bVar3 * -8) = *puVar2;
  quat2_ptr = local_2c[0];
  *(undefined4 *)
   ((int)(&stack0xffffff68 + (uint)bVar3 * -8 + (uint)bVar3 * -8) + ((uint)bVar3 * -2 + 1) * 4) =
       puVar2[(uint)bVar3 * -2 + 1];
  core_xform_cpp_quaternionFromAngleY_FUN_005f79f0(pCStack_c,(float)angle_radians);
  quat1_ptr = &CStack_78;
  local_7c = CStack_64.z;
  puVar2 = (undefined4 *)((int)&CStack_78 + (uint)bVar3 * -8 + (uint)bVar3 * -8 + 4);
  *(undefined4 *)((int)&CStack_78 + (uint)bVar3 * -8) = auStack_54[(uint)bVar3 * -2];
  *puVar2 = auStack_54[(uint)bVar3 * -2 + (uint)bVar3 * -2 + 1];
  puVar2[(uint)bVar3 * -2 + 1] =
  ...
  *(undefined4 *)((int)&CStack_64 + (uint)bVar3 * -8) = auStack_40[(uint)bVar3 * -2];
  ...
  uStack_84 = uStack_30;
  *(CQuaternion4f **)(&stack0xffffff80 + (uint)bVar3 * -8) = local_2c[(uint)bVar3 * -2];
  (&local_7c)[(uint)bVar3 * -2 + (uint)bVar3 * -2] =
       (float)local_2c[(uint)bVar3 * -2 + (uint)bVar3 * -2 + 1];
  (&local_7c + (uint)bVar3 * -2 + (uint)bVar3 * -2)[(uint)bVar3 * -2 + 1] =
       (float)(local_2c + (uint)bVar3 * -2 + (uint)bVar3 * -2 + 1)[(uint)bVar3 * -2 + 1];
...
// Assembly code:
// 0059fdd0: PUSH EBX
//   Label: core_skeleton.cpp_CDeformableModelInstance_FUN_0059fdd0
// 0059fdd1: PUSH ESI
...
//   Label: LAB_0059fe01
// 0059fe02: PUSH EBX
// 0059fe03: CALL core_skeleton.cpp_CDeformableModelInstance_FUN_005a0820
...
// 0059fe1a: PUSH EAX
// 0059fe1b: PUSH EBX
// 0059fe1c: CALL core_skeleton.cpp_CDeformableModelInstance_FUN_0059fa20
...
// 0059ff01: PUSH EAX
// 0059ff02: PUSH EBX
// 0059ff03: CALL core_skeleton.cpp_CDeformableModelInstance_FUN_0059f750
