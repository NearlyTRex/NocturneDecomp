...
;                               FUNCTION
; *****************************************************************************
; __cdecl float core_skeleton.cpp_CDeformableModel_exactRayTrace_FUN_0059cba0(CDeformableModel * this_ptr, int lod_index, CVector3f * ray_origin, CVector3f * ray_direction, CVector3i * skinned_vertices, byte * part_visibility_flags)
;
; Parameters:
...
section .text
    ...
    MOV AH,byte ptr [0x03683bdc]        ; 0059cbac | uchar g_FloatVertexArrayInitialized
    TEST AH,0x1                         ; 0059cbb2
    JZ 0x0059ce18                       ; 0059cbb5 | LAB_0059ce18
    ...
    JLE 0x0059cbf2                      ; 0059cbcd | LAB_0059cbf2
        ;   XREF to: 0059cbf2 (CONDITIONAL_JUMP)
    MOV EBX,0x64ec1b                    ; 0059cbcf | = "..\\core\\skeleton.cpp" | s_core_skeleton_cpp_0064ec1b = ..\core\skeleton.cpp
    MOV ESI,0x6d2                       ; 0059cbd4
    PUSH 0x64ec30                       ; 0059cbd9 | = "CDeformableModel::exactRayTrace - too..." | s_CDeformableModel_exactRa_0064ec30 = CDeformableModel::exactRayTrace - too many vertices!
    MOV dword ptr [0x02f0ca48],EBX      ; 0059cbde | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 0059cbe4 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0059cbea | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    MOV ECX,0x367517c                   ; 0059cbfd | CVector3f[5000] g_FloatVertexArray
    MOV EDX,dword ptr [EBP + 0x24]      ; 0059cc02
    MOV EBX,dword ptr [EDI + 0x2c]      ; 0059cc05
    XOR ESI,ESI                         ; 0059cc08
    TEST EBX,EBX                        ; 0059cc0a
    JLE 0x0059cc50                      ; 0059cc0c | LAB_0059cc50
        ;   XREF to: 0059cc50 (CONDITIONAL_JUMP)
    MOV EAX,EDX                         ; 0059cc0e
        ;   Label: LAB_0059cc0e
    MOV EBX,ECX                         ; 0059cc10
    FILD dword ptr [EAX]                ; 0059cc12
    FMUL float ptr [0x00662ea0]         ; 0059cc14 | float FLOAT_00662ea0
    FSTP float ptr [EBX]                ; 0059cc1a | CVector3f[5000] g_FloatVertexArray
    FILD dword ptr [EAX + 0x4]          ; 0059cc1c
    FMUL float ptr [0x00662ea0]         ; 0059cc1f | float FLOAT_00662ea0
    FSTP float ptr [EBX + 0x4]          ; 0059cc25 | DAT_03675180
    FILD dword ptr [EAX + 0x8]          ; 0059cc28
    FMUL float ptr [0x00662ea0]         ; 0059cc2b | float FLOAT_00662ea0
    FSTP float ptr [EBX + 0x8]          ; 0059cc31 | DAT_03675184
    INC ESI                             ; 0059cc34
    ADD ECX,0xc                         ; 0059cc35
    MOV EAX,dword ptr [EDI + 0x2c]      ; 0059cc38
    ADD EDX,0xc                         ; 0059cc3b
    CMP ESI,EAX                         ; 0059cc3e
    JL 0x0059cc0e                       ; 0059cc40 | LAB_0059cc0e
    ...
    JLE 0x0059ce0d                      ; 0059cc67 | LAB_0059ce0d
    ...
    ADD EAX,0x367517c                   ; 0059ccd6 | CVector3f[5000] g_FloatVertexArray
    MOV CX,word ptr [EDX + ESI*0x1 + 0x2] ; 0059ccdb
    PUSH EAX                            ; 0059cce0
    LEA EAX,[ECX*0x4 + 0x0]             ; 0059cce1
    SUB EAX,ECX                         ; 0059cce8
    SHL EAX,0x2                         ; 0059ccea
    ADD EAX,0x367517c                   ; 0059cced | CVector3f[5000] g_FloatVertexArray
    ...
    ADD EAX,0x367517c                   ; 0059cd09 | CVector3f[5000] g_FloatVertexArray
    PUSH EAX                            ; 0059cd0e
    LEA EAX,[ESP + 0x18]                ; 0059cd0f
    PUSH EAX                            ; 0059cd13
    CALL core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790 ; 0059cd14 | void core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790(CDemonTriangle * this_ptr, CVector3f * vertex1, CVector3f * vertex2, CVector3f * vertex3)
    ...
    PUSH EAX                            ; 0059cd28
    CALL core_dtri.cpp_rayTriangleIntersection_FUN_0049a800 ; 0059cd29 | float core_dtri.cpp_rayTriangleIntersection_FUN_0049a800(CDemonTriangle * triangle, CVector3f * rayOrigin, CVector3f * rayDirection)
    ...
    FNSTSW AX                           ; 0059cd41
    SAHF                                ; 0059cd43
    JNC 0x0059cdd1                      ; 0059cd44 | LAB_0059cdd1
    ...
    FNSTSW AX                           ; 0059cd58
    SAHF                                ; 0059cd5a
    JA 0x0059cdd1                       ; 0059cd5b | LAB_0059cdd1
        ;   XREF to: 0059cdd1 (CONDITIONAL_JUMP)
    FLD1                                ; 0059cd5d
    FCOMP double ptr [ESP]              ; 0059cd5f
    FNSTSW AX                           ; 0059cd62
    SAHF                                ; 0059cd64
    JC 0x0059cdd1                       ; 0059cd65 | LAB_0059cdd1
        ;   XREF to: 0059cdd1 (CONDITIONAL_JUMP)
    ...
    CMP EAX,0x368c888                   ; 0059cd9b | CVector3f g_DeformableModelRayHitNormal
    JZ 0x0059cdbd                       ; 0059cda0 | LAB_0059cdbd
        ;   XREF to: 0059cdbd (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x44]      ; 0059cda2
    MOV [0x0368c888],EAX                ; 0059cda6 | CVector3f g_DeformableModelRayHitNormal
    ...
    MOV EAX,dword ptr [EBP + 0x18]      ; 0059cdbd
        ;   Label: LAB_0059cdbd
    MOV dword ptr [0x0368c898],EBX      ; 0059cdc0 | int g_DeformableModelRayHitTriangleIndex
    MOV dword ptr [0x0368c884],EDI      ; 0059cdc6 | int g_DeformableModelRayHitPartIndex
    MOV [0x0368c894],EAX                ; 0059cdcc | int g_DeformableModelRayHitLodIndex
    MOV EAX,dword ptr [ESP + 0x5c]      ; 0059cdd1
        ;   Label: LAB_0059cdd1
    INC EBX                             ; 0059cdd5
    ADD ESI,0x12                        ; 0059cdd6
    CMP EBX,EAX                         ; 0059cdd9
    JL 0x0059ccba                       ; 0059cddb | LAB_0059ccba
    ...
    JL 0x0059cc8c                       ; 0059ce07 | LAB_0059cc8c
    ...
    POP EBX                             ; 0059ce16
    RET                                 ; 0059ce17
    PUSH 0x6598c0                       ; 0059ce18 | WatcomTypeInfo g_CVectorTypeInfo
        ;   Label: LAB_0059ce18
    MOV DL,AH                           ; 0059ce1d
    PUSH 0x1388                         ; 0059ce1f
    OR DL,0x1                           ; 0059ce24
    PUSH 0x367517c                      ; 0059ce27 | CVector3f[5000] g_FloatVertexArray
    MOV byte ptr [0x03683bdc],DL        ; 0059ce2c | uchar g_FloatVertexArrayInitialized
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 0059ce32 | void * crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
        ;   XREF to: 005fe667 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0059ce37
    JMP 0x0059cbbb                      ; 0059ce3a | LAB_0059cbbb
