// Name: core_skeleton.cpp_FUN_005a08a0
// Address: 005a08a0
// Address Range: [[005a08a0, 005a0ac3]]
// Convention: unknown
// Signature: undefined core_skeleton.cpp_FUN_005a08a0()
// Function calls:
//   core_motion.cpp_CMotionController_getMotionList_FUN_0052dce0
//   core_skeleton.cpp_CDeformableModelInstance_GetModelPtrAndSomething_FUN_005a0820
//   core_skeleton.cpp_FUN_005a0ad0
//   core_skeleton.cpp_FUN_005a1950

#include "nocturne.h"

int core_skeleton_cpp_FUN_005a08a0(void)
  ...
  if (0 < unaff_EBP) {
    do {
      ...
      if (0 < iVar1) {
        ...
        puVar4 = auStack_1310;
        do {
          local_44 = *(float *)(puVar2 + 0xc);
          local_40 = *(float *)(puVar2 + 0x1c);
          local_3c = *(float *)(puVar2 + 0x2c);
          local_50 = *(float *)(puVar4 + 0xc);
          local_4c = *(float *)(puVar4 + 0x1c);
          local_48 = *(float *)(puVar4 + 0x2c);
          puVar4 = puVar4 + 0x30;
          puVar2 = puVar2 + 0x30;
          iVar3 = iVar3 + 1;
          fVar7 = (local_48 - local_3c) * (local_48 - local_3c) +
                  (local_4c - local_40) * (local_4c - local_40) +
                  (local_50 - local_44) * (local_50 - local_44) + fVar7;
          local_38 = local_44;
          local_34 = local_40;
          fStack_30 = local_3c;
          fStack_2c = local_50;
...
// Assembly code:
// 005a08a0: PUSH EBX
//   Label: core_skeleton.cpp_FUN_005a08a0
// 005a08a1: PUSH ESI
// 005a08a2: PUSH EDI
// 005a08a3: PUSH EBP
...
// 005a08d4: CALL core_skeleton.cpp_CDeformableModelInstance_GetModelPtrAndSomething_FUN_005a0820
...
// 005a08f8: PUSH ESI
// 005a08f9: PUSH EDI
// 005a08fa: CALL core_skeleton.cpp_FUN_005a0ad0
...
// 005a095a: PUSH EBP
// 005a095b: PUSH EDI
// 005a095c: CALL core_skeleton.cpp_FUN_005a0ad0
//   XREF to: 005a0ad0 (UNCONDITIONAL_CALL)
