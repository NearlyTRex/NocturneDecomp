...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_skeleton.cpp_CDeformableModel_shatter_FUN_0059cec0(CDeformableModel * this_ptr, CVector3f * center_position, CVector3f * orientation_vector, int lod_index, CVector3i * skinned_vertices, int * part_visibility_flags, int * texture_set_indices, int particle_lifetime)
;
; Parameters:
...
section .text
    ...
    CALL core_dirmat.cpp_CMatrix3x3f_buildRotationMatrix_FUN_00471d30 ; 0059cee3 | void core_dirmat.cpp_CMatrix3x3f_buildRotationMatrix_FUN_00471d30(CMatrix3x3f * this_ptr, CVector3f * euler_angles)
        ;   XREF to: 00471d30 (UNCONDITIONAL_CALL)
    MOV AH,byte ptr [0x0368c880]        ; 0059cee8 | uchar g_ShatterVertexArrayInitialized
    ADD ESP,0x8                         ; 0059ceee
    TEST AH,0x1                         ; 0059cef1
    JZ 0x0059d2fd                       ; 0059cef4 | LAB_0059d2fd
    ...
    JLE 0x0059cf39                      ; 0059cf14 | LAB_0059cf39
        ;   XREF to: 0059cf39 (CONDITIONAL_JUMP)
    MOV EDI,0x64ec65                    ; 0059cf16 | = "..\\core\\skeleton.cpp" | s_core_skeleton_cpp_0064ec65 = ..\core\skeleton.cpp
    MOV EBP,0x748                       ; 0059cf1b
    PUSH 0x64ec7a                       ; 0059cf20 | = "CDeformableModel::shatter - too many ..." | s_CDeformableModel_shatter_0064ec7a = CDeformableModel::shatter - too many vertices!
    MOV dword ptr [0x02f0ca48],EDI      ; 0059cf25 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBP      ; 0059cf2b | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0059cf31 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    MOV ESI,0x3683be0                   ; 0059cf4a | CVector3f[3000] g_ShatterVertexArray
    ...
    JLE 0x0059cffd                      ; 0059cf66 | LAB_0059cffd
        ;   XREF to: 0059cffd (CONDITIONAL_JUMP)
    MOV EAX,EDI                         ; 0059cf6c
        ;   Label: LAB_0059cf6c
    MOV EBX,ESI                         ; 0059cf6e | CVector3f[3000] g_ShatterVertexArray
    FILD dword ptr [EAX]                ; 0059cf70
    FMUL float ptr [0x00662ea0]         ; 0059cf72 | float FLOAT_00662ea0
    FSTP float ptr [EBX]                ; 0059cf78 | CVector3f[3000] g_ShatterVertexArray
    FILD dword ptr [EAX + 0x4]          ; 0059cf7a
    FMUL float ptr [0x00662ea0]         ; 0059cf7d | float FLOAT_00662ea0
    FSTP float ptr [EBX + 0x4]          ; 0059cf83 | DAT_03683be4
    FILD dword ptr [EAX + 0x8]          ; 0059cf86
    FMUL float ptr [0x00662ea0]         ; 0059cf89 | float FLOAT_00662ea0
    FSTP float ptr [EBX + 0x8]          ; 0059cf8f | DAT_03683be8
    PUSH ESI                            ; 0059cf92 | CVector3f[3000] g_ShatterVertexArray
    LEA EAX,[ESP + 0x74]                ; 0059cf93
    PUSH EAX                            ; 0059cf97
    LEA EAX,[ESP + 0x8]                 ; 0059cf98
    PUSH EAX                            ; 0059cf9c
    CALL core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0 ; 0059cf9d | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0(CMatrix3x3f * this_ptr, CVector3f * output, CVector3f * input)
    ...
    JZ 0x0059cfe4                       ; 0059cfce | LAB_0059cfe4
        ;   XREF to: 0059cfe4 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x64]      ; 0059cfd0
    MOV dword ptr [ESI],EAX             ; 0059cfd4 | CVector3f[3000] g_ShatterVertexArray
    ...
    JL 0x0059cf6c                       ; 0059cff7 | LAB_0059cf6c
        ;   XREF to: 0059cf6c (CONDITIONAL_JUMP)
    PUSH 0x6598c0                       ; 0059cffd | WatcomTypeInfo g_CVectorTypeInfo
        ;   Label: LAB_0059cffd
    PUSH 0x3                            ; 0059d002
    LEA EAX,[ESP + 0x30]                ; 0059d004
    PUSH EAX                            ; 0059d008
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 0059d009 | void * crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
    ...
    JLE 0x0059d209                      ; 0059d029 | LAB_0059d209
    ...
    ADD EBX,0x3683be0                   ; 0059d117 | CVector3f[3000] g_ShatterVertexArray
    CMP EAX,EBX                         ; 0059d11d
    JZ 0x0059d131                       ; 0059d11f | LAB_0059d131
        ;   XREF to: 0059d131 (CONDITIONAL_JUMP)
    MOV EBP,dword ptr [EBX]             ; 0059d121 | CVector3f[3000] g_ShatterVertexArray
    ...
    JNZ 0x0059d10f                      ; 0059d151 | LAB_0059d10f
    ...
    PUSH EAX                            ; 0059d184
    MOV EBX,dword ptr [0x0067a3d0]      ; 0059d185 | CFireEffect g_CFireEffectInstance | CFireEffect * g_CFireEffectPtr
    PUSH EBX                            ; 0059d18b | CFireEffect g_CFireEffectInstance
    CALL core_fire.cpp_CFireEffect_createGlassParticle_FUN_004c7d00 ; 0059d18c | void core_fire.cpp_CFireEffect_createGlassParticle_FUN_004c7d00(CFireEffect * this_ptr, STriangleVertices * triangle_vertices, CVector3f * uv_u_per_vertex, CVector3f * uv_v_per_vertex, ...)
    ...
    JL 0x0059d0fc                       ; 0059d1a3 | LAB_0059d0fc
    ...
    JL 0x0059d090                       ; 0059d203 | LAB_0059d090
    ...
    JLE 0x0059d2f2                      ; 0059d221 | LAB_0059d2f2
    ...
    JNZ 0x0059d324                      ; 0059d2a3 | LAB_0059d324
    ...
    JL 0x0059d277                       ; 0059d2f0 | LAB_0059d277
    ...
    POP EBX                             ; 0059d2fb
    RET                                 ; 0059d2fc
    PUSH 0x6598c0                       ; 0059d2fd | WatcomTypeInfo g_CVectorTypeInfo
        ;   Label: LAB_0059d2fd
    MOV DL,AH                           ; 0059d302
    PUSH 0xbb8                          ; 0059d304
    OR DL,0x1                           ; 0059d309
    PUSH 0x3683be0                      ; 0059d30c | CVector3f[3000] g_ShatterVertexArray
    MOV byte ptr [0x0368c880],DL        ; 0059d311 | uchar g_ShatterVertexArrayInitialized
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 0059d317 | void * crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
        ;   XREF to: 005fe667 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0059d31c
    JMP 0x0059cefa                      ; 0059d31f | LAB_0059cefa
    ...
    JGE 0x0059d2a9                      ; 0059d349 | LAB_0059d2a9
    ...
    JNZ 0x0059d42c                      ; 0059d38f | LAB_0059d42c
    ...
    ADD EBX,0x3683be0                   ; 0059d3a3 | CVector3f[3000] g_ShatterVertexArray
    CMP EAX,EBX                         ; 0059d3a9
    JZ 0x0059d3bd                       ; 0059d3ab | LAB_0059d3bd
        ;   XREF to: 0059d3bd (CONDITIONAL_JUMP)
    MOV EBP,dword ptr [EBX]             ; 0059d3ad | CVector3f[3000] g_ShatterVertexArray
    ...
    JNZ 0x0059d39b                      ; 0059d3e3 | LAB_0059d39b
    ...
    PUSH EAX                            ; 0059d41c
    MOV EBP,dword ptr [0x0067a3d0]      ; 0059d41d | CFireEffect * g_CFireEffectPtr
    PUSH EBP                            ; 0059d423 | CFireEffect g_CFireEffectInstance
    CALL core_fire.cpp_CFireEffect_createGlassParticle_FUN_004c7d00 ; 0059d424 | void core_fire.cpp_CFireEffect_createGlassParticle_FUN_004c7d00(CFireEffect * this_ptr, STriangleVertices * triangle_vertices, CVector3f * uv_u_per_vertex, CVector3f * uv_v_per_vertex, ...)
        ;   XREF to: 004c7d00 (UNCONDITIONAL_CALL)
    ...
    JGE 0x0059d2a9                      ; 0059d44a | LAB_0059d2a9
        ;   XREF to: 0059d2a9 (CONDITIONAL_JUMP)
    JMP 0x0059d35c                      ; 0059d450 | LAB_0059d35c
