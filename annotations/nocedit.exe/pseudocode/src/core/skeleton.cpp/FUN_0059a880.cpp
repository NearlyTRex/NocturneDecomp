// Name: core_skeleton.cpp_FUN_0059a880
// Address: 0059a880
// Address Range: [[0059a880, 0059a9f5]]
// Convention: unknown
// Signature: undefined core_skeleton.cpp_FUN_0059a880()
// Cross-references:
//   core_skeleton.cpp_CDeformableModelInstance_GetModelPtrAndSomething5_FUN_005a01d0 (005a01d0) at 005a01f9 [UNCONDITIONAL_CALL]
// Globals:
...
/* Signature: undefined1 core_skeleton.cpp_FUN_0059a880(undefined4 param_1, undefined4 param_2,
   undefined4 param_3, undefined4 param_4) */

void core_skeleton_cpp_FUN_0059a880(void)

{
  ...
  local_2c.z = (float)(in_stack_00000008 << 2);
  local_1c = 0;
  for (local_20 = 0; local_20 < *(int *)(in_stack_00000004 + (int)local_2c.z + 0x2c);
      local_20 = local_20 + 1) {
    pfVar3 = (float *)(local_1c + *(int *)(in_stack_00000004 + (int)local_2c.z + 0x40));
    ...
    if (*(char *)pfVar3 == '\x01') {
      pCVar2 = core_xform_cpp_transformVector3x4_FUN_005f4dc0
                         (&local_3c,pCVar2,
                          (CMatrix3x4f *)
                          ((uint)*(byte *)((int)pfVar3 + 1) * 0x30 + in_stack_0000000c));
      if (&local_2c != pCVar2) {
        local_2c.x = pCVar2->x;
        local_2c.y = pCVar2->y;
        local_2c.z = pCVar2->z;
    ...
    *local_18 = (int)ROUND(local_30 * _DAT_00662e98);
    local_18[1] = (int)ROUND(local_2c.x * _DAT_00662e98);
    local_18[2] = (int)ROUND(local_2c.y * _DAT_00662e98);
    local_18 = local_18 + 3;
...
// Assembly code:
// 0059a880: PUSH EBX
//   Label: core_skeleton.cpp_FUN_0059a880
// 0059a881: PUSH ESI
// 0059a882: PUSH EDI
// 0059a883: PUSH EBP
