  ...
  if (bone_index < 0) {
    ...
    if (0 < this_ptr_00->bone_count) {
      do {
        ...
        (this_ptr->bone_transform).pose_data.bone_rotations[local_34] = local_24c;
        (this_ptr->bone_transform).bone_scales[local_34] = this_ptr->rest_pose_data[local_34];
        local_34 = local_34 + 1;
  ...
  if (this_ptr->bone_update_mode == 1) {
    ...
    if (0 < this_ptr_00->bone_count) {
      ...
      do {
        if (-1 < aiStack_5ac[local_2c]) {
          iVar10 = this_ptr_00->bone_list[local_2c].parent_index;
          if (iVar10 < 0) {
            ...
            core_xform_cpp_multiplyQuaternion_FUN_005f7640
                      (local_bec + local_2c,&local_15c,&local_14c);
            core_xform_cpp_multiplyQuaternion_FUN_005f7640
                      (&local_14c,local_74 + iVar10,&local_23c);
            pCVar11 = &local_23c;
          }
          (this_ptr->bone_transform).pose_data.bone_rotations[local_2c] = *pCVar11;
        }
        local_2c = local_2c + 1;
    ...
    if (0 < this_ptr_00->bone_count) {
      do {
        ...
        if (-1 < iVar9) {
          core_skeleton_cpp_CSkeleton_getBoneAngleInterpolated_FUN_0059a070
                    (this_ptr_00,local_24,local_84,local_88,local_1870,&local_21c);
          (this_ptr->bone_transform).pose_data.bone_rotations[local_24] = local_21c;
        }
        local_24 = local_24 + 1;
