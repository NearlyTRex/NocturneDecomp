// Name: core_skeleton.cpp_CDeformableModel_LoadingSomethingMemory_FUN_0059c2f0
// Address: 0059c2f0
// Address Range: [[0059c2f0, 0059c5d1]]
// Convention: unknown
// Signature: undefined core_skeleton.cpp_CDeformableModel_LoadingSomethingMemory_FUN_0059c2f0()
// Cross-references:
...
/* Signature: undefined1 core_skeleton.cpp_CDeformableModel_LoadingSomethingMemory(undefined4
   param_1, undefined4 param_2) */

int core_skeleton_cpp_CDeformableModel_LoadingSomethingMemory_FUN_0059c2f0(void)

{
  ...
  local_30 = 0;
  local_44 = 0;
  if (1 < *(int *)(in_stack_00000004 + 0x7140)) {
    ...
    if (0 < *(int *)(in_stack_00000004 + 0x7140)) {
      ...
      do {
        ...
        if (0 < *(int *)(local_3c + 0x7164)) {
          do {
            puVar4 = (ushort *)(*(int *)(in_stack_00000004 + 0x7c) + local_2c);
            puVar5 = puVar4 + 3;
            do {
              pbVar10 = (byte *)(*(int *)(in_stack_00000004 + 0x40) + (uint)*puVar4 * 0x34);
              iVar6 = 0;
              pbVar8 = pbVar10;
              pbVar9 = pbVar10;
              while (iVar6 < (int)(uint)*pbVar10) {
                if (pbVar9[1] == in_stack_00000008) {
                  local_14 = local_14 + *(float *)(pbVar8 + 4);
                  pbVar8 = pbVar8 + 4;
                  iVar6 = iVar6 + 1;
                  pbVar9 = pbVar9 + 1;
                }
              ...
              piVar7 = (int *)(*(int *)(this_ptr->padding_0x0 + 0x2234) + (uint)*puVar4 * 0xc);
              fVar1 = (float)*piVar7 * _DAT_00662ea0 - local_6c;
              fVar3 = (float)piVar7[1] * _DAT_00662ea0 - local_68;
              fVar2 = (float)piVar7[2] * _DAT_00662ea0 - local_64;
              puVar4 = puVar4 + 1;
              local_1c = local_1c + 1;
            ...
            local_28 = local_28 + 1;
          } while (local_28 < *(int *)(local_3c + 0x7164));
        }
        ...
        local_38 = local_38 + 1;
      } while (local_38 < *(int *)(in_stack_00000004 + 0x7140));
    }
...
// Assembly code:
// 0059c2f0: PUSH EBX
//   Label: core_skeleton.cpp_CDeformableModel_LoadingSomethingMemory_FUN_0059c2f0
// 0059c2f1: PUSH EDI
// 0059c2f2: PUSH EBP
...
// 0059c38a: PUSH EBX
// 0059c38b: CALL core_skeleton.cpp_CDeformableModel_GetModelPtrSomethingMaybe_FUN_0059df80
...
// 0059c39c: PUSH 0x0
// 0059c39e: PUSH EBX
// 0059c39f: CALL core_skeleton.cpp_CDeformableModelInstance_GetModelPtrAndSomething5_FUN_005a01d0
