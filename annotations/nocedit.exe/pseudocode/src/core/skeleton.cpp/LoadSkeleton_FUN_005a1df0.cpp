...
// Convention: unknown
// Signature: undefined core_skeleton.cpp_LoadSkeleton_FUN_005a1df0()
// Cross-references:
//   core_skeleton.cpp_CDeformableModel_LoadSkeletonAndRenderTexture_FUN_0059a780 (0059a780) at 0059a792 [UNCONDITIONAL_CALL]
// Globals:
...
/* Signature: undefined1 core_skeleton.cpp_LoadSkeleton(undefined4 param_1) */

CSkeleton * core_skeleton_cpp_LoadSkeleton_FUN_005a1df0(void)

{
  ...
  if (0 < (int)g_DeformableModelPoolEnd) {
    str1 = g_SkeletonPool[0].padding_0x0 + 0x28508;
    do {
      ...
      iVar2 = iVar2 + 1;
      str1 = str1 + 0x2982c;
    } while (iVar2 < (int)g_DeformableModelPoolEnd);
  }
  if (0x27 < (int)g_DeformableModelPoolEnd) {
    g_CurrentFilename = "..\\core\\skeleton.cpp";
    g_CurrentLineNumber = 0x1093;
    core_main_c_displayErrorAndQuit_FUN_00506f10
              ("Can't load %s because skeleton manager is full.  (Size is %d)",in_stack_00000004,0x28);
  }
  pCVar3 = g_SkeletonPool + (int)g_DeformableModelPoolEnd;
  g_DeformableModelPoolEnd = (CDeformableModel *)((int)&g_DeformableModelPoolEnd->num_lods + 1);
  core_skeleton_cpp_CSkeleton_load_FUN_00599b10();
  return pCVar3;
}
