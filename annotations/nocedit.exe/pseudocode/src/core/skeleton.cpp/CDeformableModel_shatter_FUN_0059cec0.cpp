...

{
  ...
  if (0 < (int)local_54[0xb]) {
    do {
      pCVar8->x = (float)*piVar10 * FLOAT_00662ea0;
      pCVar8->y = (float)piVar10[1] * FLOAT_00662ea0;
      pCVar8->z = (float)piVar10[2] * FLOAT_00662ea0;
...
// 0059d18c: CALL core_fire.cpp_CFireEffect_createGlassParticle_FUN_004c7d00
...
// 0059d423: PUSH EBP
//   XREF to: 02d12db0 (DATA)
// 0059d424: CALL core_fire.cpp_CFireEffect_createGlassParticle_FUN_004c7d00
//   XREF to: 004c7d00 (UNCONDITIONAL_CALL)
