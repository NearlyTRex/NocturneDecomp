...
;   core_mission.cpp_FUN_005248e0 at 005248fc
...
section .text
    ...
    PUSH ESI                            ; 005a1dc1
    MOV EBX,0x368c8a0                   ; 005a1dc2 | CDeformableModel[64] g_DeformableModelPool
    LEA ESI,[EBX + 0x240000]            ; 005a1dc7 | int g_SkeletonPoolCount
    PUSH EBX                            ; 005a1dcd | CDeformableModel[64] g_DeformableModelPool
        ;   Label: LAB_005a1dcd
    CALL core_skeleton.cpp_CDeformableModel_free_FUN_0059a2b0 ; 005a1dce | void core_skeleton.cpp_CDeformableModel_free_FUN_0059a2b0(CDeformableModel * this_ptr)
        ;   XREF to: 0059a2b0 (UNCONDITIONAL_CALL)
    ADD EBX,0x9000                      ; 005a1dd3 | DAT_036958a0
    ADD ESP,0x4                         ; 005a1dd9
    CMP EBX,ESI                         ; 005a1ddc
    JNZ 0x005a1dcd                      ; 005a1dde | LAB_005a1dcd
        ;   XREF to: 005a1dcd (CONDITIONAL_JUMP)
    XOR EDX,EDX                         ; 005a1de0
    MOV dword ptr [0x0368c89c],EDX      ; 005a1de2 | int g_DeformableModelCount
    POP ESI                             ; 005a1de8
    POP EBX                             ; 005a1de9
    RET                                 ; 005a1dea
