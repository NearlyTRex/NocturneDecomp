...
;
; XREF[6]:
;   core_bride.cpp_FUN_00424aa0 at 00424ac3
;   core_gabriela.cpp_FUN_004d6f80 at 004d706b
;   core_ghoul.cpp_FUN_004e84a0 at 004e84c3
;   core_mimic.cpp_FUN_0051fcc0 at 0051ff64
...
section .text
    ...
    JL 0x0059f92e                       ; 0059f83a | LAB_0059f92e
        ;   XREF to: 0059f92e (CONDITIONAL_JUMP)
    PUSH EBX                            ; 0059f840
    CALL core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_005a0820 ; 0059f841 | CSkeleton * core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_005a0820(CDeformableModelInstance * this_ptr)
    ...
    JL 0x0059f95b                       ; 0059f877 | LAB_0059f95b
        ;   XREF to: 0059f95b (CONDITIONAL_JUMP)
    PUSH ESI                            ; 0059f87d
    PUSH EBX                            ; 0059f87e
    LEA ESI,[ESP + 0x8]                 ; 0059f87f
    LEA EDI,[ESP + 0x68]                ; 0059f883
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneWorldMatrix_FUN_0059f820 ; 0059f887 | void core_skeleton.cpp_CDeformableModelInstance_getBoneWorldMatrix_FUN_0059f820(CDeformableModelInstance * this_ptr, int bone_index, CMatrix3x4f * out_matrix)
    ...
    PUSH EAX                            ; 0059f8b3
    CALL core_xform.cpp_transformVector3x4_FUN_005f4dc0 ; 0059f8b4 | CVector3f * core_xform.cpp_transformVector3x4_FUN_005f4dc0(CVector3f * output_vector, CVector3f * input_vector, CMatrix3x4f * matrix)
    ...
    PUSH EAX                            ; 0059f8f4
    CALL core_xform.cpp_quaternionToMatrix3x3_FUN_005f7280 ; 0059f8f5 | void core_xform.cpp_quaternionToMatrix3x3_FUN_005f7280(CMatrix3x3f * matrix_ptr, CQuaternion4f * quat_ptr)
    ...
    JNZ 0x0059f98a                      ; 0059f913 | LAB_0059f98a
    ...
    LEA EAX,[ESP + 0x30]                ; 0059f92e
        ;   Label: LAB_0059f92e
    PUSH EAX                            ; 0059f932
    CALL core_xform.cpp_setRotationScaleIdentity_FUN_005f5190 ; 0059f933 | void core_xform.cpp_setRotationScaleIdentity_FUN_005f5190(CMatrix3x4f * matrix)
    ...
    JMP 0x0059f915                      ; 0059f959 | LAB_0059f915
    ...
    JMP 0x0059f8dd                      ; 0059f985 | LAB_0059f8dd
    ...
    JMP 0x0059f915                      ; 0059fa18 | LAB_0059f915
        ;   XREF to: 0059f915 (UNCONDITIONAL_JUMP)
