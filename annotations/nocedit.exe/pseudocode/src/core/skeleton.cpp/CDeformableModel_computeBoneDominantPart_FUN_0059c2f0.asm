...
section .text
    ...
    JGE 0x0059c329                      ; 0059c31e | LAB_0059c329
    ...
    PUSH 0x5ef                          ; 0059c329
        ;   Label: LAB_0059c329
    PUSH 0x64eab7                       ; 0059c32e | = "..\\core\\skeleton.cpp" | s_core_skeleton_cpp_0064eab7 = ..\core\skeleton.cpp
    PUSH 0x22b4                         ; 0059c333
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1b0 ; 0059c338 | void * shape_memdbg.cpp_debugAlloc_FUN_0050f1b0(int size, char * filename, int line_number)
        ;   XREF to: 0050f1b0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0059c33d
    TEST EAX,EAX                        ; 0059c340
    JZ 0x0059c34d                       ; 0059c342 | LAB_0059c34d
        ;   XREF to: 0059c34d (CONDITIONAL_JUMP)
    PUSH EAX                            ; 0059c344
    CALL core_skeleton.cpp_CDeformableModelInstance_ctor_FUN_0059ddc0 ; 0059c345 | CDeformableModelInstance * core_skeleton.cpp_CDeformableModelInstance_ctor_FUN_0059ddc0(CDeformableModelInstance * this_ptr)
        ;   XREF to: 0059ddc0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0059c34a
    MOV dword ptr [ESP + 0x48],EAX      ; 0059c34d
        ;   Label: LAB_0059c34d
    TEST EAX,EAX                        ; 0059c351
    JNZ 0x0059c377                      ; 0059c353 | LAB_0059c377
        ;   XREF to: 0059c377 (CONDITIONAL_JUMP)
    MOV EAX,0x64eacc                    ; 0059c355 | = "..\\core\\skeleton.cpp" | s_core_skeleton_cpp_0064eacc = ..\core\skeleton.cpp
    MOV EDX,0x5f0                       ; 0059c35a
    PUSH 0x64eae1                       ; 0059c35f | = "Out of memory" | s_Out_of_memory_0064eae1 = Out of memory
    MOV [0x02f0ca48],EAX                ; 0059c364 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 0059c369 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0059c36f | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    PUSH EBX                            ; 0059c381
    CALL core_skeleton.cpp_CDeformableModelInstance_initializeFromModel_FUN_005a0480 ; 0059c382 | void core_skeleton.cpp_CDeformableModelInstance_initializeFromModel_FUN_005a0480(CDeformableModelInstance * this_ptr, CDeformableModel * model_ptr)
        ;   XREF to: 005a0480 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0059c387
    PUSH EBX                            ; 0059c38a
    CALL core_skeleton.cpp_CDeformableModelInstance_resetToRestPose_FUN_0059df80 ; 0059c38b | void core_skeleton.cpp_CDeformableModelInstance_resetToRestPose_FUN_0059df80(CDeformableModelInstance * this_ptr)
        ;   XREF to: 0059df80 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0059c390
    PUSH EBX                            ; 0059c393
    CALL core_skeleton.cpp_CDeformableModelInstance_computeBoneTransforms_FUN_0059fb40 ; 0059c394 | void core_skeleton.cpp_CDeformableModelInstance_computeBoneTransforms_FUN_0059fb40(CDeformableModelInstance * this_ptr)
        ;   XREF to: 0059fb40 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0059c399
    PUSH 0x0                            ; 0059c39c
    PUSH EBX                            ; 0059c39e
    CALL core_skeleton.cpp_CDeformableModelInstance_skinVerticesForLOD_FUN_005a01d0 ; 0059c39f | void core_skeleton.cpp_CDeformableModelInstance_skinVerticesForLOD_FUN_005a01d0(CDeformableModelInstance * this_ptr, int lod_index)
    ...
    PUSH EAX                            ; 0059c3ac
    PUSH EBX                            ; 0059c3ad
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneWorldPosition_FUN_0059fa20 ; 0059c3ae | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneWorldPosition_FUN_0059fa20(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
    ...
    JLE 0x0059c59d                      ; 0059c3c8 | LAB_0059c59d
    ...
    JLE 0x0059c481                      ; 0059c402 | LAB_0059c481
    ...
    JL 0x0059c408                       ; 0059c47f | LAB_0059c408
    ...
    FNSTSW AX                           ; 0059c489
    SAHF                                ; 0059c48b
    JBE 0x0059c540                      ; 0059c48c | LAB_0059c540
    ...
    JMP 0x0059c577                      ; 0059c4a2 | LAB_0059c577
    ...
    FMUL float ptr [0x00662ea0]         ; 0059c4c2 | float FLOAT_00662ea0
    FSTP float ptr [EBX]                ; 0059c4c8
    FILD dword ptr [EAX + 0x4]          ; 0059c4ca
    FMUL float ptr [0x00662ea0]         ; 0059c4cd | float FLOAT_00662ea0
    FSTP float ptr [EBX + 0x4]          ; 0059c4d3
    FILD dword ptr [EAX + 0x8]          ; 0059c4d6
    FMUL float ptr [0x00662ea0]         ; 0059c4d9 | float FLOAT_00662ea0
    ...
    JZ 0x0059c456                       ; 0059c520 | LAB_0059c456
        ;   XREF to: 0059c456 (CONDITIONAL_JUMP)
    JMP 0x0059c41e                      ; 0059c526 | LAB_0059c41e
    ...
    INC EAX                             ; 0059c539
    INC EBX                             ; 0059c53a
    JMP 0x0059c436                      ; 0059c53b | LAB_0059c436
        ;   XREF to: 0059c436 (UNCONDITIONAL_JUMP)
    TEST dword ptr [ESP + 0x30],0x7fffffff ; 0059c540
        ;   Label: LAB_0059c540
    JNZ 0x0059c577                      ; 0059c548 | LAB_0059c577
    ...
    FNSTSW AX                           ; 0059c562
    SAHF                                ; 0059c564
    JNC 0x0059c577                      ; 0059c565 | LAB_0059c577
        ;   XREF to: 0059c577 (CONDITIONAL_JUMP)
    ...
    JL 0x0059c3d2                       ; 0059c597 | LAB_0059c3d2
        ;   XREF to: 0059c3d2 (CONDITIONAL_JUMP)
    MOV ESI,0x628                       ; 0059c59d
        ;   Label: LAB_0059c59d
    MOV EBX,0x64eaef                    ; 0059c5a2 | = "..\\core\\skeleton.cpp" | s_core_skeleton_cpp_0064eaef = ..\core\skeleton.cpp
    MOV EDI,dword ptr [ESP + 0x4c]      ; 0059c5a7
    MOV dword ptr [0x02f0d944],ESI      ; 0059c5ab | int g_CurrentDebugLine
    MOV dword ptr [0x0067d20c],EBX      ; 0059c5b1 | char * g_CurrentDebugFilename
    TEST EDI,EDI                        ; 0059c5b7
    JZ 0x0059c5c6                       ; 0059c5b9 | LAB_0059c5c6
