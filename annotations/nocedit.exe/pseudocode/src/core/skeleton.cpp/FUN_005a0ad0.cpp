// Name: core_skeleton.cpp_FUN_005a0ad0
// Address: 005a0ad0
// Address Range: [[005a0ad0, 005a0c8f]]
// Convention: unknown
// Signature: undefined core_skeleton.cpp_FUN_005a0ad0()
// Cross-references:
//   core_skeleton.cpp_FUN_005a08a0 (005a08a0) at 005a08fa [UNCONDITIONAL_CALL]
// Function calls:
...
void core_skeleton_cpp_FUN_005a0ad0(void)

{
  ...
  if (0 < *(int *)(iVar6 + 0x28558)) {
    do {
      ...
      pfVar10[3] = afStack_1830[0x5f7];
      *pfVar8 = local_38[(uint)bVar9 * -2 + -6];
      pfVar8[(uint)bVar9 * -2 + 1] = local_38[(uint)bVar9 * -2 + (uint)bVar9 * -2 + -5];
      (pfVar8 + (uint)bVar9 * -2 + 1)[(uint)bVar9 * -2 + 1] =
           (local_38 + (uint)bVar9 * -2 + (uint)bVar9 * -2 + -5)[(uint)bVar9 * -2 + 1];
      pfVar11[0x193] = 1.0;
      pfVar10 = pfVar10 + 4;
      pfVar11 = pfVar11 + 1;
    } while (iVar7 < *(int *)(local_14 + 0x28558));
  }
  iVar6 = *(int *)(local_14 + 0x29374);
  fVar1 = *(float *)(iVar6 + 4 + local_1c * 0xc);
  fVar2 = *(float *)(iVar6 + 8 + local_1c * 0xc);
  fVar5 = 1.0 - afStack_1830[0x5f6];
  iVar7 = *(int *)(local_14 + 0x29374);
  fVar3 = *(float *)(iVar7 + 4 + local_20 * 0xc);
  fVar4 = *(float *)(iVar7 + 8 + local_20 * 0xc);
  if (local_38 != in_stack_00000010) {
    *in_stack_00000010 =
         *(float *)(iVar7 + local_20 * 0xc) * fVar5 +
         *(float *)(iVar6 + local_1c * 0xc) * afStack_1830[0x5f6];
    in_stack_00000010[1] = fVar3 * fVar5 + fVar1 * afStack_1830[0x5f6];
    in_stack_00000010[2] = fVar4 * fVar5 + fVar2 * afStack_1830[0x5f6];
  }
  *in_stack_00000010 = *(float *)(in_stack_00000004 + 0x508) * *in_stack_00000010;
  in_stack_00000010[1] = *(float *)(in_stack_00000004 + 0x50c) * in_stack_00000010[1];
  in_stack_00000010[2] = *(float *)(in_stack_00000004 + 0x510) * in_stack_00000010[2];
  return;
}
...
// Assembly code:
// 005a0ad0: PUSH EBX
//   Label: core_skeleton.cpp_FUN_005a0ad0
// 005a0ad1: PUSH ESI
// 005a0ad2: PUSH EDI
// 005a0ad3: PUSH EBP
...
// 005a0adf: PUSH EDX
// 005a0ae0: CALL core_skeleton.cpp_CDeformableModelInstance_GetModelPtrAndSomething_FUN_005a0820
...
// 005a0b3c: CALL core_skeleton.cpp_CDeformableModel_FUN_0059a070
