...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_skeleton.cpp_CDeformableModelInstance_free_FUN_0059df40(CDeformableModelInstance * this_ptr)
;
; Parameters:
...
section .text
    ...
    JNZ 0x0059df51                      ; 0059df4d | LAB_0059df51
        ;   XREF to: 0059df51 (CONDITIONAL_JUMP)
    POP EBX                             ; 0059df4f
    RET                                 ; 0059df50
    PUSH ESI                            ; 0059df51
        ;   Label: LAB_0059df51
    MOV ECX,0x64edae                    ; 0059df52 | = "..\\core\\skeleton.cpp" | s_core_skeleton_cpp_0064edae = ..\core\skeleton.cpp
    MOV ESI,0x905                       ; 0059df57
    PUSH EDX                            ; 0059df5c
    MOV dword ptr [0x0067d20c],ECX      ; 0059df5d | char * g_CurrentDebugFilename
    MOV dword ptr [0x02f0d944],ESI      ; 0059df63 | int g_CurrentDebugLine
    CALL crt_memory.c_free_FUN_005fe659 ; 0059df69 | void crt_memory.c_free_FUN_005fe659(void * ptr)
