...
section .text
    ...
    CALL core_skeleton.cpp_CDeformableModel_computeBoneBoundsAndFlags_FUN_0059d9e0 ; 0059c200 | void core_skeleton.cpp_CDeformableModel_computeBoneBoundsAndFlags_FUN_0059d9e0(CDeformableModel * this_ptr)
        ;   XREF to: 0059d9e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0059c205
    PUSH EBX                            ; 0059c208
    CALL core_skeleton.cpp_CDeformableModel_computeFarthestChildBones_FUN_0059dbe0 ; 0059c209 | void core_skeleton.cpp_CDeformableModel_computeFarthestChildBones_FUN_0059dbe0(CDeformableModel * this_ptr)
