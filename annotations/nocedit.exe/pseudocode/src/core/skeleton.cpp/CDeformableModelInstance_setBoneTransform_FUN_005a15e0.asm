...
; Local Variables:
; SPose *          Stack[-0x14]:4  local_14
; SPose *          Stack[-0x10]:4  local_10
; CDeformableModelInstance * Stack[-0xc]:4  local_c
;
; XREF[4]:
;   core_charactr.cpp_CCharacter_renderEthereal_FUN_0042af60 at 0042b0bd
;   core_gabriela.cpp_CGabriella_binarySearchClavicleBlend_FUN_004d6f80 at 004d7035
;   core_skeledit.cpp_CDeformableModelInstance_viewModel_FUN_005968b0 at 005972fc
;   core_stranger.cpp_CStranger_extractTurnPose_FUN_005bf720 at 005bf7ed
;
; Called Functions:
...
section .text
    ...
    JMP 0x00604b88                      ; 005a164e
        ;   XREF to: 00604b88 (UNCONDITIONAL_JUMP)  ; LAB_00604b88
    ...
    POP EDI                             ; 005a16bb
    RET                                 ; 005a16bc
    MOV ECX,dword ptr [ESI]             ; 00604b88
        ;   Label: LAB_00604b88
    MOV dword ptr [EDI],ECX             ; 00604b8a
    MOV ECX,dword ptr [ESI + 0x4]       ; 00604b8c
    MOV dword ptr [EDI + 0x4],ECX       ; 00604b8f
    MOV ECX,dword ptr [ESI + 0x8]       ; 00604b92
    MOV dword ptr [EDI + 0x8],ECX       ; 00604b95
    MOV ECX,dword ptr [ESI + 0xc]       ; 00604b98
    MOV dword ptr [EDI + 0xc],ECX       ; 00604b9b
    ADD ESI,0x10                        ; 00604b9e
    ADD EDI,0x10                        ; 00604ba1
    ADD EAX,0x30                        ; 00604ba4
    JMP 0x005a1655                      ; 00604ba7
        ;   XREF to: 005a1655 (UNCONDITIONAL_JUMP)  ; LAB_005a1655
