...
// Convention: unknown
// Signature: undefined core_skeleton.cpp_CDeformableModelInstance_FUN_005a16c0()
// Cross-references:
...
/* Signature: undefined1 core_skeleton.cpp_CDeformableModelInstance_FUN_005a16c0(undefined4 param_1,
   undefined4 param_2) */

CBoundingBox3D * core_skeleton_cpp_CDeformableModelInstance_FUN_005a16c0(void)

{
  ...
  local_20.y = *(float *)(iVar2 + 0x28558);
  core_box_cpp_CBoundingBox3D_reset_FUN_00420fb0(in_stack_00000008);
  iVar2 = 0;
  if (0 < (int)local_20.z) {
    local_14 = (CBoundingBox3D *)(iVar1 + 0x814c);
    do {
      this_ptr = local_14;
      if (*(int *)(iVar1 + 0x8aac) == 2) {
        corner_index = 0;
        do {
          pCVar3 = core_box_cpp_CBoundingBox3D_getCorner_FUN_004202b0
                             (this_ptr,(CVector3f *)&stack0xffffffd0,corner_index);
          pCVar3 = core_xform_cpp_transformVector3x4_FUN_005f4dc0
                             (&local_20,pCVar3,(CMatrix3x4f *)in_stack_ffffffd0);
...
// 005a16db: CALL core_skeleton.cpp_CDeformableModel_SkeletonPtrNotSet_FUN_0059a810
