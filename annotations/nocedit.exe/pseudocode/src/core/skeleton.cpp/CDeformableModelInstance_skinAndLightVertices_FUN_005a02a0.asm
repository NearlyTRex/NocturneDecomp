...
section .text
    ...
    JNZ 0x005a02d5                      ; 005a02b0 | LAB_005a02d5
    ...
    PUSH ESI                            ; 005a02bf
    PUSH EBX                            ; 005a02c0
    CALL core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0 ; 005a02c1 | CDeformableModel * core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0(CDeformableModelInstance * this_ptr)
        ;   XREF to: 005a07a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005a02c6
    PUSH EAX                            ; 005a02c9
    CALL core_skeleton.cpp_CDeformableModel_lightVertices_FUN_0059ab50 ; 005a02ca | void core_skeleton.cpp_CDeformableModel_lightVertices_FUN_0059ab50(CDeformableModel * this_ptr, int lod_index, int render_flags)
    ...
    PUSH EAX                            ; 005a02d5
        ;   Label: LAB_005a02d5
    PUSH EBX                            ; 005a02d6
    CALL core_skeleton.cpp_CDeformableModelInstance_skinVerticesForLOD_FUN_005a01d0 ; 005a02d7 | void core_skeleton.cpp_CDeformableModelInstance_skinVerticesForLOD_FUN_005a01d0(CDeformableModelInstance * this_ptr, int lod_index)
        ;   XREF to: 005a01d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005a02dc
    JMP 0x005a02b2                      ; 005a02df | LAB_005a02b2
