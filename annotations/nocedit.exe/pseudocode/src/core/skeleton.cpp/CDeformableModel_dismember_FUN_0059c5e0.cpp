...
// Convention: unknown
// Signature: undefined core_skeleton.cpp_CDeformableModel_dismember_FUN_0059c5e0()
// Cross-references:
...
//   undefined4 DAT_036712fc
//   undefined4 DAT_03671300
// Function calls:
//   core_bodypart.cpp_CBodyPart_setCounts_FUN_004191d0
//   core_bodypart.cpp_TooManyBodyPartTexturesCheck_FUN_0041af90
//   core_main.c_displayErrorAndQuit_FUN_00506f10
//   crt_memory.c_memset_FUN_005fde40

#include "nocturne.h"

/* Signature: undefined1 core_skeleton.cpp_CDeformableModel_dismember(CDeformableModel* param_1,
   undefined4 param_2, undefined4 param_3, undefined4 param_4, undefined4 param_5, undefined4
   param_6) */

void core_skeleton_cpp_CDeformableModel_dismember_FUN_0059c5e0
...

{
  ...
  if (param_7 != 0) {
    ...
    iVar4 = param_7 * 4;
    local_2c = *(int *)(param_6 + iVar4 + 0x54);
    local_28 = 0;
    iVar5 = 0;
    iVar2 = param_6 + iVar4;
    if (0 < param_9) {
    ...
    iVar2 = param_9 * 0x60 + param_6;
    local_2c = local_2c + *(int *)(iVar4 + 0x7178 + iVar2);
    if (4000 < *(int *)(iVar4 + param_6 + 0x2c)) {
      g_CurrentFilename = "..\\core\\skeleton.cpp";
      g_CurrentLineNumber = 0x652;
      core_main_c_displayErrorAndQuit_FUN_00506f10
                ("CDeformableModel::dismember - too many vertices!",local_28 + *(int *)(iVar4 + 0x7164 + iVar2));
    }
    param_6 = param_7 * 4 + param_6;
    crt_memory_c_memset_FUN_005fde40(&DAT_036712fc,0,*(int *)(param_6 + 0x2c) << 2);
    if (local_24 < local_2c) {
      iVar2 = local_24 * 0x12;
      do {
        iVar4 = *(int *)(param_6 + 0x7c);
        (&DAT_036712fc)[*(ushort *)(iVar4 + iVar2)] = 1;
        (&DAT_036712fc)[*(ushort *)(iVar4 + 2 + iVar2)] = 1;
        puVar6 = (ushort *)(iVar4 + 4 + iVar2);
        iVar2 = iVar2 + 0x12;
        (&DAT_036712fc)[*puVar6] = 1;
      } while (SBORROW4(iVar2,local_2c * 0x12) != iVar2 + local_2c * -0x12 < 0);
    }
    if (local_28 < in_stack_ffffffb8) {
      local_28 = local_28 * 0x12;
      do {
        iVar2 = *(int *)(param_8 * 4 + param_7 + 0x7c);
        (&DAT_036712fc)[*(ushort *)(iVar2 + local_28)] = 1;
        (&DAT_036712fc)[*(ushort *)(iVar2 + 2 + local_28)] = 1;
    ...
    iVar2 = *(int *)(param_7 + 0x174);
    for (iVar4 = 0; iVar4 < *(int *)(param_8 * 4 + 0x2c + param_7); iVar4 = iVar4 + 1) {
    }
    core_bodypart_cpp_CBodyPart_setCounts_FUN_004191d0();
    param_8 = param_8 + param_9 * 4;
    iVar11 = 0;
    iVar5 = 0;
    iVar4 = iVar2 * 0xc;
    if (0 < *(int *)(param_8 + 0x2c)) {
      do {
        if (*(int *)((int)&DAT_036712fc + iVar5) == 0) {
          *(undefined4 *)((int)&DAT_036712fc + iVar5) = 0xffffffff;
        }
        else {
          *(int *)((int)&DAT_036712fc + iVar5) = iVar2;
          puVar8 = (undefined4 *)(*(int *)(param_7 + 0x178) + iVar4);
          iVar2 = iVar2 + 1;
          iVar4 = iVar4 + 0xc;
          puVar9 = puVar8 + (uint)bVar10 * -2 + 1;
          *puVar8 = *param_12;
          *puVar9 = param_12[(uint)bVar10 * -2 + 1];
          puVar9[(uint)bVar10 * -2 + 1] = (param_12 + (uint)bVar10 * -2 + 1)[(uint)bVar10 * -2 + 1];
        }
        iVar11 = iVar11 + 1;
        iVar5 = iVar5 + 4;
        param_12 = param_12 + 3;
      } while (iVar11 < *(int *)(param_8 + 0x2c));
    }
    if (iVar2 != *(int *)(param_7 + 0x174)) {
      g_CurrentFilename = "..\\core\\skeleton.cpp";
    ...
    if (local_1c < local_44) {
      ...
      iVar2 = local_1c * 4;
      do {
        iVar11 = *(int *)(param_7 + 0x184) + iVar5;
        puVar6 = (ushort *)(*(int *)(param_9 + param_10 * 4 + 0x7c) + iVar4);
        *(undefined4 *)(iVar11 + 4) = 3;
        puVar7 = puVar6 + 3;
        do {
          *(undefined4 *)(iVar11 + 0x18) = (&DAT_036712fc)[*puVar6];
          *(uint *)(iVar11 + 0x1c) = (uint)puVar6[3] << 8;
          puVar1 = puVar6 + 6;
          puVar6 = puVar6 + 1;
          *(uint *)(iVar11 + 0x20) = (uint)*puVar1 << 8;
          iVar11 = iVar11 + 0xc;
        } while (puVar6 != puVar7);
        iVar5 = iVar5 + 0x3c;
        uVar3 = core_bodypart_cpp_TooManyBodyPartTexturesCheck_FUN_0041af90();
        iVar4 = iVar4 + 0x12;
        iVar2 = iVar2 + 4;
        *(undefined4 *)(*(int *)(param_7 + 0x188) + local_18) = uVar3;
        local_18 = local_18 + 4;
    ...
    if (local_20 < local_40) {
      ...
      iVar4 = local_20 << 2;
      do {
        iVar11 = *(int *)(param_7 + 0x184) + iVar2;
        puVar6 = (ushort *)(*(int *)(param_9 + param_10 * 4 + 0x7c) + local_14);
        *(undefined4 *)(iVar11 + 4) = 3;
        puVar7 = puVar6 + 3;
        do {
          *(undefined4 *)(iVar11 + 0x18) = (&DAT_036712fc)[*puVar6];
        ...
        iVar4 = iVar4 + 4;
        uVar3 = core_bodypart_cpp_TooManyBodyPartTexturesCheck_FUN_0041af90();
        *(undefined4 *)(*(int *)(param_7 + 0x188) + -4 + iVar5) = uVar3;
        iVar2 = iVar2 + 0x3c;
        unaff_EBX = unaff_EBX + 1;
        local_14 = local_14 + 0x12;
      } while (iVar4 < local_40 << 2);
    }
    if (unaff_EBX != *(int *)(param_7 + 0x180)) {
      g_CurrentFilename = "..\\core\\skeleton.cpp";
...
// 0059c9d9: CALL core_bodypart.cpp_TooManyBodyPartTexturesCheck_FUN_0041af90
...
// 0059cb10: CALL core_bodypart.cpp_TooManyBodyPartTexturesCheck_FUN_0041af90
//   XREF to: 0041af90 (UNCONDITIONAL_CALL)
