    ...
    if (0 < this_ptr->vertex_count[lod_index]) {
      do {
        if (*(int *)((int)g_VertexRemapTable + iVar4) == 0) {
          ...
          *(int *)((int)g_VertexRemapTable + iVar4) = iVar3;
    ...
    if (local_2c < iVar8) {
      ...
      do {
        ...
        *(uint *)(iVar6 + 4) = 3;
        puVar10 = puVar5 + 3;
        do {
          *(int *)(iVar6 + 0x18) = g_VertexRemapTable[*puVar5];
        ...
        iVar3 = iVar3 + 0x3c;
        iVar6 = core_bodypart_cpp_CBodyPart_addTexture_FUN_0041af90
                          (body_part_ptr,
    ...
    if (local_30 < iVar7) {
      ...
      do {
        ...
        *(uint *)(iVar3 + 4) = 3;
        puVar10 = puVar5 + 3;
        do {
          *(int *)(iVar3 + 0x18) = g_VertexRemapTable[*puVar5];
        ...
        local_30 = local_30 + 4;
        iVar3 = core_bodypart_cpp_CBodyPart_addTexture_FUN_0041af90
                          (body_part_ptr,
