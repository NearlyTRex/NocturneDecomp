...

{
  ...
  if (body_part_ptr != (CBodyPart *)0x0) {
    ...
    local_14 = *(int *)(body_part_ptr->field1_0x158 + 0x28);
    iVar3 = *(int *)(body_part_ptr->field1_0x158 + 0x1c);
      ...
      do {
        if (*(int *)((int)g_VertexRemapTable + iVar5) == 0) {
          ...
          *(int *)((int)g_VertexRemapTable + iVar5) = iVar3;
          puVar10 = (uint *)(*(int *)(body_part_ptr->field1_0x158 + 0x20) + iVar4);
          iVar3 = iVar3 + 1;
          iVar4 = iVar4 + 0xc;
    ...
    if (iVar3 != *(int *)(body_part_ptr->field1_0x158 + 0x1c)) {
      g_CurrentFilename = "..\\core\\skeleton.cpp";
    ...
    if (local_2c < iVar8) {
      ...
      local_2c = local_2c * 4;
      do {
        iVar4 = *(int *)(body_part_ptr->field1_0x158 + 0x2c) + iVar3;
        puVar6 = (ushort *)
        ...
        *(uint *)(iVar4 + 4) = 3;
        ...
        local_2c = local_2c + 4;
        *(int *)(*(int *)(body_part_ptr->field1_0x158 + 0x30) + local_28) = iVar4;
        local_28 = local_28 + 4;
        local_14 = local_14 + 1;
    ...
    if (local_30 < iVar7) {
      ...
      local_30 = local_30 << 2;
      do {
        iVar3 = *(int *)(body_part_ptr->field1_0x158 + 0x2c) + local_1c;
        puVar6 = (ushort *)
                 ((int)&(this_ptr->tri_data_ptr[lod_index]->vertex_indices).vertex_index_0 +
                 local_24);
        *(uint *)(iVar3 + 4) = 3;
        ...
        *(int *)(*(int *)(body_part_ptr->field1_0x158 + 0x30) + -4 + iVar8) = iVar3;
        local_1c = local_1c + 0x3c;
        local_14 = local_14 + 1;
        local_24 = local_24 + 0x12;
      } while (local_30 < iVar7 * 4);
    }
    if (local_14 != *(int *)(body_part_ptr->field1_0x158 + 0x28)) {
      g_CurrentFilename = "..\\core\\skeleton.cpp";
