// Name: core_skeleton.cpp_CDeformableModel_FUN_0059ab90
// Address: 0059ab90
// Address Range: [[0059ab90, 0059abe0]]
// Convention: unknown
// Signature: undefined core_skeleton.cpp_CDeformableModel_FUN_0059ab90()
// Cross-references:
//   core_skeleton.cpp_CDeformableModelInstance_GetModelPtrsAndSomething_FUN_005a02f0 (005a02f0) at 005a031a [UNCONDITIONAL_CALL]
// Globals:
...
/* Signature: undefined1 core_skeleton.cpp_CDeformableModel_FUN_0059ab90(undefined4 param_1,
   undefined4 param_2) */

int core_skeleton_cpp_CDeformableModel_FUN_0059ab90(void)
  ...
  if (0 < *(int *)(in_stack_00000004 + 0x2c)) {
    do {
      *(float *)((int)&g_CDemonRendererPtr->vertex_buffer_ptr->w_recip + iVar1) =
      ...
      iVar2 = iVar2 + 1;
      iVar1 = iVar1 + 0x30;
    } while (iVar2 < *(int *)(in_stack_00000004 + 0x2c));
  }
  return iVar1;
}
...
// Assembly code:
// 0059ab90: PUSH EBX
//   Label: core_skeleton.cpp_CDeformableModel_FUN_0059ab90
// 0059ab91: PUSH ESI
// 0059ab92: PUSH EDI
// 0059ab93: PUSH EBP
