...
//   core_skeleton.cpp_CDeformableModelInstance_updateAnimation_FUN_0059e020 (0059e020) at 0059e059 [UNCONDITIONAL_CALL]
...

{
  ...
  bVar19 = 0;
  if ((float)DOUBLE_0064edf0 < blend_weight) {
    ...
    if (this_ptr->field16_0x2250 == 0) {
      if (0 < this_ptr_00->bone_count) {
        local_24 = (CSkeleton *)this_ptr->bone_rotations;
        local_2c = this_ptr;
        ...
        do {
          ...
          if (-1 < iVar12) {
            ...
            (*callback_func)((int)unaff_EBP,bone_index,blend_weight,iVar12,this_ptr);
            uStack_918 = 0x59ec55;
            ...
            pCVar20 = (CQuaternion4f *)(auStack_110 + 0xc);
            auStack_110._8_4_ = local_124[0];
            afStack_100[(uint)bVar19 * -2 + -1] = local_124[(uint)bVar19 * -2 + 1];
            afStack_100[(uint)bVar19 * -2 + (uint)bVar19 * -2] =
                 local_124[(uint)bVar19 * -2 + (uint)bVar19 * -2 + 2];
            (afStack_100 + (uint)bVar19 * -2 + (uint)bVar19 * -2)[(uint)bVar19 * -2 + 1] =
                 (local_124 + (uint)bVar19 * -2 + (uint)bVar19 * -2 + 2)[(uint)bVar19 * -2 + 1];
            core_xform_cpp_slerpQuaternion_FUN_005f77e0
                      ((CQuaternion4f *)bone_index,pCVar20,in_stack_fffff704,in_stack_fffff708);
            puVar14 = (undefined4 *)((int)blend_weight + 0x6b4 + (uint)bVar19 * -8);
            *(undefined4 *)((int)blend_weight + 0x6b0) = auStack_110._0_4_;
            puVar15 = puVar14 + (uint)bVar19 * -2 + 1;
            *puVar14 = *(undefined4 *)(auStack_110 + (uint)bVar19 * -8 + 4);
            *puVar15 = *(undefined4 *)(auStack_110 + (uint)bVar19 * -8 + (uint)bVar19 * -8 + 8);
            puVar15[(uint)bVar19 * -2 + 1] =
                 *(undefined4 *)
                  ((int)(auStack_110 + (uint)bVar19 * -8 + (uint)bVar19 * -8 + 8) +
                  ((uint)bVar19 * -2 + 1) * 4);
          }
    ...
    else if (this_ptr->field16_0x2250 == 1) {
      local_18 = 0;
      if (0 < this_ptr_00->bone_count) {
        local_3c = 0;
        local_20 = 0;
        do {
          ...
          *(int *)((int)aiStack_2e8 + local_18 + 4) = iVar12;
          if (-1 < iVar12) {
            quat2_ptr = unaff_EBP;
            ...
            puVar14 = (undefined4 *)(&stack0xfffff6e4 + (uint)bVar19 * -8 + local_30);
            *(undefined4 *)(&stack0xfffff6e0 + local_30) = auStack_110._0_4_;
            *puVar14 = *(undefined4 *)(auStack_110 + (uint)bVar19 * -8 + 4);
            puVar14[(uint)bVar19 * -2 + 1] =
                 *(undefined4 *)(auStack_110 + (uint)bVar19 * -8 + (uint)bVar19 * -8 + 8);
            (puVar14 + (uint)bVar19 * -2 + 1)[(uint)bVar19 * -2 + 1] =
                 *(undefined4 *)
                  ((int)(auStack_110 + (uint)bVar19 * -8 + (uint)bVar19 * -8 + 8) +
                  ((uint)bVar19 * -2 + 1) * 4);
          }
      ...
      if (-1 < iVar12) {
        ...
        pCVar21 = in_stack_fffff6d4;
        core_skeleton_cpp_CSkeleton_getBoneAngleInterpolated_FUN_0059a070
                  (this_ptr_00,iVar12,(int)local_4c,(int)pCStack_50,(float)in_stack_fffff6d4);
        pfVar18 = (float *)(&stack0xfffff6dc + (uint)bVar19 * -8 + iVar12 * 0x10);
        *(undefined4 *)(&stack0xfffff6d8 + iVar12 * 0x10) = uStack_e8;
        *pfVar18 = local_e4[(uint)bVar19 * -2];
        pfVar18[(uint)bVar19 * -2 + 1] = local_e4[(uint)bVar19 * -2 + (uint)bVar19 * -2 + 1];
        ...
        in_stack_fffff6d4 = pCVar21;
      }
      local_18 = 0;
      if (0 < this_ptr_00->bone_count) {
        local_40 = this_ptr->bone_rotations;
        local_30 = 0;
        local_2c = this_ptr;
        local_24 = this_ptr_00;
        local_34 = this_ptr->bone_rotations;
        do {
          if (-1 < *(int *)((int)aiStack_2e8 + local_30)) {
            iVar12 = local_24->bone_list[0].parent_index;
            local_3c = local_18 * 0x10;
            if (iVar12 < 0) {
              pfVar16 = afStack_c8;
              pfVar18 = (float *)(&stack0xfffff6d8 + local_18 * 0x10);
            }
            else {
              in_stack_fffff6d0 = (CSkeleton *)(&stack0xfffff6d8 + iVar12 * 0x10);
              ...
              afStack_a4[(uint)bVar19 * -2] = local_e4[(uint)bVar19 * -2 + 1];
              afStack_a4[(uint)bVar19 * -2 + (uint)bVar19 * -2 + 1] =
                   local_e4[(uint)bVar19 * -2 + (uint)bVar19 * -2 + 2];
              (afStack_a4 + (uint)bVar19 * -2 + (uint)bVar19 * -2 + 1)[(uint)bVar19 * -2 + 1] =
                   (local_e4 + (uint)bVar19 * -2 + (uint)bVar19 * -2 + 2)[(uint)bVar19 * -2 + 1];
              core_xform_cpp_multiplyQuaternion_FUN_005f7640
                        (result_out,pCVar20,(CQuaternion4f *)quat2_ptr);
              pCVar20 = (CQuaternion4f *)((int)&pCStack_14->w + (int)&local_48->w);
              auStack_110._0_4_ = fStack_c0;
              *(undefined4 *)(auStack_110 + (uint)bVar19 * -8 + 4) = auStack_bc[(uint)bVar19 * -2];
              *(undefined4 *)(auStack_110 + (uint)bVar19 * -8 + (uint)bVar19 * -8 + 8) =
                   auStack_bc[(uint)bVar19 * -2 + (uint)bVar19 * -2 + 1];
              *(undefined4 *)
               ((int)(auStack_110 + (uint)bVar19 * -8 + (uint)bVar19 * -8 + 8) +
               ((uint)bVar19 * -2 + 1) * 4) =
                   (auStack_bc + (uint)bVar19 * -2 + (uint)bVar19 * -2 + 1)[(uint)bVar19 * -2 + 1];
              pfVar16 = local_e4 + 5;
              core_xform_cpp_multiplyQuaternion_FUN_005f7640
                        ((CQuaternion4f *)auStack_110,pCVar20,in_stack_fffff6cc);
              pfVar18 = afStack_100 + 1;
            }
            pfVar17 = pfVar16 + (uint)bVar19 * -2 + 1;
            pfVar13 = pfVar18 + (uint)bVar19 * -2 + 1;
            *pfVar16 = *pfVar18;
            *pfVar17 = *pfVar13;
            pfVar17[(uint)bVar19 * -2 + 1] = pfVar13[(uint)bVar19 * -2 + 1];
            (pfVar17 + (uint)bVar19 * -2 + 1)[(uint)bVar19 * -2 + 1] =
                 (pfVar13 + (uint)bVar19 * -2 + 1)[(uint)bVar19 * -2 + 1];
            ...
            pfVar18 = (float *)((int)local_2c + (uint)bVar19 * -8 + 0x6b4);
            local_2c->bone_rotations[0].w = fStack_128;
            pfVar16 = pfVar18 + (uint)bVar19 * -2 + 1;
            *pfVar18 = local_124[(uint)bVar19 * -2];
            *pfVar16 = local_124[(uint)bVar19 * -2 + (uint)bVar19 * -2 + 1];
            pfVar16[(uint)bVar19 * -2 + 1] =
                 (local_124 + (uint)bVar19 * -2 + (uint)bVar19 * -2 + 1)[(uint)bVar19 * -2 + 1];
          }
          local_18 = local_18 + 1;
          local_30 = local_30 + 4;
    ...
    if (bone_index < 0) {
      ...
      fVar2 = pCVar8[(int)pCStack_50].y;
      fVar3 = pCVar8[(int)pCStack_50].z;
      fVar10 = 1.0 - (float)in_stack_fffff6d4;
      pCVar9 = this_ptr_00->frame_positions_1;
      fVar4 = pCVar9[(int)local_4c].y;
      fVar5 = pCVar9[(int)local_4c].z;
      fVar6 = (float)this_ptr->field4_0x50c;
      fVar7 = this_ptr->rest_pose_data[0];
      fVar11 = 1.0 - blend_weight;
      pCVar1 = &this_ptr->root_position;
      if (pCVar1 != (CVector3f *)&local_5c) {
        pCVar1->x = pCVar1->x * fVar11 +
                    (pCVar9[(int)local_4c].x * fVar10 +
                    pCVar8[(int)pCStack_50].x * (float)in_stack_fffff6d4) *
                    (float)this_ptr->field3_0x508 * blend_weight;
        (this_ptr->root_position).y =
             (this_ptr->root_position).y * fVar11 +
             (fVar4 * fVar10 + fVar2 * (float)in_stack_fffff6d4) * fVar6 * blend_weight;
        (this_ptr->root_position).z =
             (this_ptr->root_position).z * fVar11 +
             (fVar5 * fVar10 + fVar3 * (float)in_stack_fffff6d4) * fVar7 * blend_weight;
        return;
      }
    }
  }
...
// 0059eb91: PUSH ECX
// 0059eb92: CALL core_motion.cpp_CMotionController_getFramesForInterpolation_FUN_0052e4c0
//   XREF to: 0052e4c0 (UNCONDITIONAL_CALL)
// 0059eb97: ADD ESP,0x18
// 0059eb9a: MOV EBX,dword ptr [EBP + 0x14]
//   XREF to: Stack[0x4] (READ)
// 0059eb9d: PUSH EBX
// 0059eb9e: CALL core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_005a0820
