  ...
  if ((float)DOUBLE_0064edf0 < blend_weight) {
    ...
    if (this_ptr->field11_0x2250 == 0) {
      if (0 < this_ptr_00->bone_count) {
        ...
        do {
          ...
          if (-1 < iVar14) {
            ...
            puVar16 = (undefined4 *)((int)blend_weight + 0x6b4 + (uint)bVar21 * -8);
            *(undefined4 *)((int)blend_weight + 0x6b0) = auStack_110._0_4_;
            puVar17 = puVar16 + (uint)bVar21 * -2 + 1;
            *puVar16 = *(undefined4 *)(auStack_110 + (uint)bVar21 * -8 + 4);
            *puVar17 = *(undefined4 *)(auStack_110 + (uint)bVar21 * -8 + (uint)bVar21 * -8 + 8);
        ...
        do {
          ...
          *(int *)((int)aiStack_2e8 + local_18 + 4) = iVar14;
          if (-1 < iVar14) {
            ...
            puVar16 = (undefined4 *)(&stack0xfffff6e4 + (uint)bVar21 * -8 + local_30);
            *(undefined4 *)(&stack0xfffff6e0 + local_30) = auStack_110._0_4_;
            *puVar16 = *(undefined4 *)(auStack_110 + (uint)bVar21 * -8 + 4);
            puVar16[(uint)bVar21 * -2 + 1] =
                 *(undefined4 *)(auStack_110 + (uint)bVar21 * -8 + (uint)bVar21 * -8 + 8);
      ...
      if (-1 < iVar14) {
        ...
        *(undefined4 *)(&stack0xfffff6d8 + iVar14 * 0x10) = uStack_e8;
        ...
        do {
          if (-1 < *(int *)((int)aiStack_2e8 + local_30)) {
            ...
            if (iVar14 < 0) {
              ...
              *(undefined4 *)(auStack_110 + (uint)bVar21 * -8 + 4) = auStack_bc[(uint)bVar21 * -2];
              *(undefined4 *)(auStack_110 + (uint)bVar21 * -8 + (uint)bVar21 * -8 + 8) =
