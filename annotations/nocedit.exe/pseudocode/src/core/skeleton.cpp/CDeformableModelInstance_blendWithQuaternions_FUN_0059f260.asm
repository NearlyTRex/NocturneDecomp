...
section .text
    ...
    JMP 0x0060fbe8                      ; 0059f359
        ;   XREF to: 0060fbe8 (UNCONDITIONAL_JUMP)  ; LAB_0060fbe8
    ...
    JMP 0x005b3e15                      ; 0059f5a9
        ;   XREF to: 005b3e15 (UNCONDITIONAL_JUMP)  ; CAVE_cave_00415045
        ;   Label: LAB_0059f5a9
    ...
    JMP 0x0060fc0f                      ; 0059f5d8
        ;   XREF to: 0060fc0f (UNCONDITIONAL_JUMP)  ; LAB_0060fc0f
    ...
    PUSH EAX                            ; 0059f66b
    JMP 0x0060e438                      ; 0059f66c
        ;   XREF to: 0060e438 (UNCONDITIONAL_JUMP)  ; LAB_0060e438
    ...
    JMP 0x005b3e3a                      ; 0059f685
        ;   XREF to: 005b3e3a (UNCONDITIONAL_JUMP)  ; LAB_005b3e3a
    ...
    MOV ECX,dword ptr [ESI]             ; 005b3e15
        ;   Label: CAVE_cave_00415045
    MOV dword ptr [EDI],ECX             ; 005b3e17
    MOV ECX,dword ptr [ESI + 0x4]       ; 005b3e19
    MOV dword ptr [EDI + 0x4],ECX       ; 005b3e1c
    MOV ECX,dword ptr [ESI + 0x8]       ; 005b3e1f
    MOV dword ptr [EDI + 0x8],ECX       ; 005b3e22
    MOV ECX,dword ptr [ESI + 0xc]       ; 005b3e25
    MOV dword ptr [EDI + 0xc],ECX       ; 005b3e28
    ADD ESI,0x10                        ; 005b3e2b
    ADD EDI,0x10                        ; 005b3e2e
    LEA EAX,[ESP + 0x10]                ; 005b3e31
    JMP 0x0059f5b1                      ; 005b3e35
        ;   XREF to: 0059f5b1 (UNCONDITIONAL_JUMP)  ; LAB_0059f5b1
    MOV ECX,dword ptr [ESI]             ; 005b3e3a
        ;   Label: LAB_005b3e3a
    MOV dword ptr [EDI],ECX             ; 005b3e3c
    MOV ECX,dword ptr [ESI + 0x4]       ; 005b3e3e
    MOV dword ptr [EDI + 0x4],ECX       ; 005b3e41
    MOV ECX,dword ptr [ESI + 0x8]       ; 005b3e44
    MOV dword ptr [EDI + 0x8],ECX       ; 005b3e47
    MOV ECX,dword ptr [ESI + 0xc]       ; 005b3e4a
    MOV dword ptr [EDI + 0xc],ECX       ; 005b3e4d
    ADD ESI,0x10                        ; 005b3e50
    ADD EDI,0x10                        ; 005b3e53
    MOV EAX,dword ptr [ESP + 0xb4]      ; 005b3e56
    JMP 0x0059f690                      ; 005b3e5d
        ;   XREF to: 0059f690 (UNCONDITIONAL_JUMP)  ; LAB_0059f690
    MOV ECX,dword ptr [ESI]             ; 0060e438
        ;   Label: LAB_0060e438
    MOV dword ptr [EDI],ECX             ; 0060e43a
    MOV ECX,dword ptr [ESI + 0x4]       ; 0060e43c
    MOV dword ptr [EDI + 0x4],ECX       ; 0060e43f
    MOV ECX,dword ptr [ESI + 0x8]       ; 0060e442
    MOV dword ptr [EDI + 0x8],ECX       ; 0060e445
    MOV ECX,dword ptr [ESI + 0xc]       ; 0060e448
    MOV dword ptr [EDI + 0xc],ECX       ; 0060e44b
    ADD ESI,0x10                        ; 0060e44e
    ADD EDI,0x10                        ; 0060e451
    PUSH EBX                            ; 0060e454
    JMP 0x0059f671                      ; 0060e455
        ;   XREF to: 0059f671 (UNCONDITIONAL_JUMP)  ; LAB_0059f671
    LEA EDI,[EDI + 0x6b0]               ; 0060fbe8
        ;   Label: LAB_0060fbe8
    MOV ECX,dword ptr [ESI]             ; 0060fbee
    MOV dword ptr [EDI],ECX             ; 0060fbf0
    MOV ECX,dword ptr [ESI + 0x4]       ; 0060fbf2
    MOV dword ptr [EDI + 0x4],ECX       ; 0060fbf5
    MOV ECX,dword ptr [ESI + 0x8]       ; 0060fbf8
    MOV dword ptr [EDI + 0x8],ECX       ; 0060fbfb
    MOV ECX,dword ptr [ESI + 0xc]       ; 0060fbfe
    MOV dword ptr [EDI + 0xc],ECX       ; 0060fc01
    ADD ESI,0x10                        ; 0060fc04
    ADD EDI,0x10                        ; 0060fc07
    JMP 0x0059f363                      ; 0060fc0a
        ;   XREF to: 0059f363 (UNCONDITIONAL_JUMP)  ; LAB_0059f363
    LEA EDI,[EDI + 0x6b0]               ; 0060fc0f
        ;   Label: LAB_0060fc0f
    MOV ECX,dword ptr [ESI]             ; 0060fc15
    MOV dword ptr [EDI],ECX             ; 0060fc17
    MOV ECX,dword ptr [ESI + 0x4]       ; 0060fc19
    MOV dword ptr [EDI + 0x4],ECX       ; 0060fc1c
    MOV ECX,dword ptr [ESI + 0x8]       ; 0060fc1f
    MOV dword ptr [EDI + 0x8],ECX       ; 0060fc22
    MOV ECX,dword ptr [ESI + 0xc]       ; 0060fc25
    MOV dword ptr [EDI + 0xc],ECX       ; 0060fc28
    ADD ESI,0x10                        ; 0060fc2b
    ADD EDI,0x10                        ; 0060fc2e
    JMP 0x0059f5e2                      ; 0060fc31
        ;   XREF to: 0059f5e2 (UNCONDITIONAL_JUMP)  ; LAB_0059f5e2
