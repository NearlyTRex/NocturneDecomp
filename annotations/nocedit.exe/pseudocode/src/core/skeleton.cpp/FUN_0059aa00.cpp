// Name: core_skeleton.cpp_FUN_0059aa00
// Address: 0059aa00
// Address Range: [[0059aa00, 0059ab16]]
// Convention: unknown
// Signature: undefined core_skeleton.cpp_FUN_0059aa00()
// Cross-references:
//   core_skeledit.cpp_ExportModel_FUN_00595fc0 (00595fc0) at 0059623a [UNCONDITIONAL_CALL]
//   core_skeleton.cpp_FUN_005a0210 (005a0210) at 005a0236 [UNCONDITIONAL_CALL]
// Function calls:
//   core_xform.cpp_transformVector3x4_FUN_005f4dc0

#include "nocturne.h"

/* Signature: undefined1 core_skeleton.cpp_FUN_0059aa00(undefined4 param_1, undefined4 param_2,
   undefined4 param_3, undefined4 param_4, undefined4 param_5) */

undefined4 * core_skeleton_cpp_FUN_0059aa00(void)

{
  ...
  pfVar1 = (float *)(*(int *)(in_stack_00000004 + (int)in_stack_0000000c * 4 + 0x40) +
                    in_stack_00000010 * 0x34);
  input_vector = (CVector3f *)(pfVar1 + 4);
  local_14 = pfVar1;
  if (*(char *)pfVar1 == '\x01') {
    core_xform_cpp_transformVector3x4_FUN_005f4dc0
              (in_stack_00000008,input_vector,
               (CMatrix3x4f *)((uint)*(byte *)((int)pfVar1 + 1) * 0x30 + in_stack_00000014));
  }
  else {
    iVar4 = 0;
    local_28 = 0;
    ...
    while( true ) {
      ...
      pCVar2 = core_xform_cpp_transformVector3x4_FUN_005f4dc0
                         (&CStack_34,input_vector,
                          (CMatrix3x4f *)
                          ((uint)*(byte *)((int)pfVar1 + 1) * 0x30 + in_stack_00000018));
      local_18 = pCVar2->x * *pfVar3;
      local_14 = (float *)(pCVar2->y * *pfVar3);
      unaff_EBP = (byte *)(pCVar2->z * *pfVar3);
    ...
    *in_stack_0000000c = local_28;
    in_stack_0000000c[1] = local_24;
    in_stack_0000000c[2] = local_20;
  }
...
// Assembly code:
// 0059aa00: PUSH EBX
//   Label: core_skeleton.cpp_FUN_0059aa00
// 0059aa01: PUSH ESI
// 0059aa02: PUSH EDI
// 0059aa03: PUSH EBP
