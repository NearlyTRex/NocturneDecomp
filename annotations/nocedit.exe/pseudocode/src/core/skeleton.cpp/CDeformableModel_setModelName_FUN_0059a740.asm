...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_skeleton.cpp_CDeformableModel_setModelName_FUN_0059a740(CDeformableModel * this_ptr, char * model_name)
;
; Parameters:
...
section .text
    ...
    CMP AL,0x0                          ; 0059a755
    JZ 0x0059a769                       ; 0059a757 | LAB_0059a769
    ...
    CMP AL,0x0                          ; 0059a765
    JNZ 0x0059a751                      ; 0059a767 | LAB_0059a751
