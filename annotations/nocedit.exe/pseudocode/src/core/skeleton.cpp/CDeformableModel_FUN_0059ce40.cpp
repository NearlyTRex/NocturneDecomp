// Name: core_skeleton.cpp_CDeformableModel_FUN_0059ce40
// Address: 0059ce40
// Address Range: [[0059ce40, 0059cebc]]
// Convention: unknown
// Signature: undefined core_skeleton.cpp_CDeformableModel_FUN_0059ce40()
// Cross-references:
//   core_charactr.cpp_CCharacter_FUN_0042af60 (0042af60) at 0042b045 [UNCONDITIONAL_CALL]
//   core_skeleton.cpp_CDeformableModelInstance_GetPtr_RotateVerts_Render_FUN_005a0150 (005a0150) at 005a01a8 [UNCONDITIONAL_CALL]
// Globals:
...
/* Signature: undefined1 core_skeleton.cpp_CDeformableModel_FUN_0059ce40(undefined4 param_1,
   undefined4 param_2) */

int core_skeleton_cpp_CDeformableModel_FUN_0059ce40(void)

{
  ...
  if (iVar1 == 0) {
    ...
    if (1 < *in_stack_00000004) {
      ...
      if (0 < iVar1) {
        in_stack_00000004 = in_stack_00000004 + iVar1 * 2;
        do {
          if ((in_stack_00000004[2] == 0) && ((int)ROUND(fVar3) < in_stack_00000004[1])) {
            return iVar1;
          }
          iVar1 = iVar1 + -1;
...
// Assembly code:
// 0059ce40: PUSH EBX
//   Label: core_skeleton.cpp_CDeformableModel_FUN_0059ce40
// 0059ce41: PUSH EBP
