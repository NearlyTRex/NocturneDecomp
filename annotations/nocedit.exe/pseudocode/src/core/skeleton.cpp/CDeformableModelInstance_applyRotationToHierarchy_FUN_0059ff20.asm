...
section .text
    ...
    PUSH EDX                            ; 0059ff32
    CALL core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_005a0820 ; 0059ff33 | CSkeleton * core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_005a0820(CDeformableModelInstance * this_ptr)
    ...
    CALL core_xform.cpp_quaternionToAxisAngle_FUN_005f7730 ; 0059ff5a | void core_xform.cpp_quaternionToAxisAngle_FUN_005f7730(CQuaternion4f * quat_ptr, float * angle_out, CVector3f * axis_out)
        ;   XREF to: 005f7730 (UNCONDITIONAL_CALL)
    MOV EDI,dword ptr [ESI + 0x28558]   ; 0059ff5f
    ADD ESP,0xc                         ; 0059ff65
    TEST EDI,EDI                        ; 0059ff68
    JLE 0x0059ffd2                      ; 0059ff6a | LAB_0059ffd2
    ...
    PUSH EDI                            ; 0059ff91
    CALL core_skeleton.cpp_CSkeleton_getHierarchyDistance_FUN_0059a100 ; 0059ff92 | int core_skeleton.cpp_CSkeleton_getHierarchyDistance_FUN_0059a100(CSkeleton * this_ptr, int start_bone_index, int target_bone_index)
        ;   XREF to: 0059a100 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0059ff97
    TEST EAX,EAX                        ; 0059ff9a
    JGE 0x0059ffe3                      ; 0059ff9c | LAB_0059ffe3
    ...
    JL 0x0059ff85                       ; 0059ffd0 | LAB_0059ff85
        ;   XREF to: 0059ff85 (CONDITIONAL_JUMP)
    CMP dword ptr [EBP + 0x20],0x0      ; 0059ffd2
        ;   Label: LAB_0059ffd2
    JL 0x005a007b                       ; 0059ffd6 | LAB_005a007b
    ...
    FABS                                ; 005a000b
    FCOMP double ptr [0x0064ee30]       ; 005a000d | double DOUBLE_0064ee30
    FNSTSW AX                           ; 005a0013
    SAHF                                ; 005a0015
    JBE 0x0059ff9e                      ; 005a0016 | LAB_0059ff9e
    ...
    CALL core_xform.cpp_quaternionFromAxisAngle_FUN_005f7a70 ; 005a0032 | void core_xform.cpp_quaternionFromAxisAngle_FUN_005f7a70(CQuaternion4f * quat_ptr, float angle_radians, CVector3f * axis_ptr)
    ...
    CALL core_xform.cpp_multiplyQuaternion_FUN_005f7640 ; 005a0059 | CQuaternion4f * core_xform.cpp_multiplyQuaternion_FUN_005f7640(CQuaternion4f * result_out, CQuaternion4f * quat1_ptr, CQuaternion4f * quat2_ptr)
    ...
    JMP 0x0059ff9e                      ; 005a0076 | LAB_0059ff9e
    ...
    CALL core_xform.cpp_quaternionFromAxisAngle_FUN_005f7a70 ; 005a009e | void core_xform.cpp_quaternionFromAxisAngle_FUN_005f7a70(CQuaternion4f * quat_ptr, float angle_radians, CVector3f * axis_ptr)
        ;   XREF to: 005f7a70 (UNCONDITIONAL_CALL)
    ...
    CALL core_xform.cpp_quaternionToMatrix3x4_FUN_005f73e0 ; 005a00ba | CMatrix3x4f * core_xform.cpp_quaternionToMatrix3x4_FUN_005f73e0(CMatrix3x4f * matrix_out, CQuaternion4f * quat_ptr)
    ...
    CALL core_xform.cpp_transformVector3x4InPlace_FUN_005f4e20 ; 005a00df | CVector3f * core_xform.cpp_transformVector3x4InPlace_FUN_005f4e20(CVector3f * input_output_vector, CMatrix3x4f * matrix)
