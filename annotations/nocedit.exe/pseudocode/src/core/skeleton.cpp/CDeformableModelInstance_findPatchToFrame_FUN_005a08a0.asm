...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_skeleton_cpp_CDeformableModelInstance_findPatchToFrame_FUN_005a08a0 (CMotionController *this_ptr,int source_motion_index,float source_frame, int target_motion_index)
;
; Parameters:
...
; undefined1       Stack[-0x3598]:1  local_3598
; undefined1       Stack[-0x2dbc]:1  local_2dbc
; undefined4       Stack[-0x2db0]:4  local_2db0
; undefined4       Stack[-0x2da0]:4  local_2da0
; undefined4       Stack[-0x2d90]:4  local_2d90
; undefined1       Stack[-0x1afc]:1  local_1afc
; undefined1       Stack[-0x1320]:1  local_1320
