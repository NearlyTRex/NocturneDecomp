...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_skeleton.cpp_CDeformableModelInstance_computeCylindricalUVs_FUN_005a1800(CDeformableModelInstance * this_ptr)
;
; Parameters:
...
section .text
    ...
    JL 0x005a18e4                       ; 005a1812 | LAB_005a18e4
        ;   XREF to: 005a18e4 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [ESP + 0x1c]      ; 005a1818
        ;   Label: LAB_005a1818
    PUSH ESI                            ; 005a181c
    CALL core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0 ; 005a181d | CDeformableModel * core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0(CDeformableModelInstance * this_ptr)
    ...
    JNZ 0x005a191b                      ; 005a188e | LAB_005a191b
        ;   XREF to: 005a191b (CONDITIONAL_JUMP)
    CMP dword ptr [EDX + 0x8],0x0       ; 005a1894
    JNZ 0x005a191b                      ; 005a1898 | LAB_005a191b
        ;   XREF to: 005a191b (CONDITIONAL_JUMP)
    MOV EAX,[0x006703ec]                ; 005a189e | CDemonRenderer * g_CDemonRendererPtr
    MOV EAX,dword ptr [EAX]             ; 005a18a3 | CDemonRenderer g_CDemonRendererInstance
    ...
    MOV EAX,[0x006703ec]                ; 005a18c3 | CDemonRenderer * g_CDemonRendererPtr
    ADD ECX,0x30                        ; 005a18c8
    MOV EAX,dword ptr [EAX]             ; 005a18cb | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [ECX + EAX*0x1 + -0x14],EDX ; 005a18cd
    MOV EAX,dword ptr [ESP + 0x4]       ; 005a18d1
    ADD EDI,0xc                         ; 005a18d5
    CMP ECX,EAX                         ; 005a18d8
    JL 0x005a187f                       ; 005a18da | LAB_005a187f
    ...
    POP EBX                             ; 005a18e2
    RET                                 ; 005a18e3
    MOV ECX,0x64efd4                    ; 005a18e4 | = "..\\core\\skeleton.cpp" | s_core_skeleton_cpp_0064efd4 = ..\core\skeleton.cpp
        ;   Label: LAB_005a18e4
    MOV EBX,0xfa7                       ; 005a18e9
    PUSH 0x64efe9                       ; 005a18ee | = "CDeformableModelInstance::computeCyli..." | s_CDeformableModelInstance_0064efe9 = CDeformableModelInstance::computeCylindricalUVs - points not generated
    MOV dword ptr [0x02f0ca48],ECX      ; 005a18f3 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 005a18f9 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005a18ff | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005a1904
    JMP 0x005a1818                      ; 005a1907 | LAB_005a1818
        ;   XREF to: 005a1818 (UNCONDITIONAL_JUMP)
    CMP EDX,EBP                         ; 005a190c
        ;   Label: LAB_005a190c
    JLE 0x005a1855                      ; 005a190e | LAB_005a1855
        ;   XREF to: 005a1855 (CONDITIONAL_JUMP)
    MOV EBP,EDX                         ; 005a1914
    JMP 0x005a1855                      ; 005a1916 | LAB_005a1855
        ;   XREF to: 005a1855 (UNCONDITIONAL_JUMP)
    FILD dword ptr [EDX + 0x8]          ; 005a191b
        ;   Label: LAB_005a191b
    FILD dword ptr [EDX]                ; 005a191e
    CALL crt_math.c_atan2_FUN_006013b1  ; 005a1920 | float10 crt_math.c_atan2_FUN_006013b1(float10 y, float10 x)
        ;   XREF to: 006013b1 (UNCONDITIONAL_CALL)
    FMUL double ptr [0x0064f030]        ; 005a1925 | double DOUBLE_0064f030
    MOV EAX,dword ptr [ESP + 0x20]      ; 005a192b
    CALL crt_math.c_round_FUN_005fe6b0  ; 005a192f | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP]               ; 005a1934
    MOV EBX,dword ptr [ESP]             ; 005a1937
    ADD EAX,EBX                         ; 005a193a
    MOV dword ptr [ESP],EAX             ; 005a193c
    MOV EAX,[0x006703ec]                ; 005a193f | CDemonRenderer * g_CDemonRendererPtr
    MOV EAX,dword ptr [EAX]             ; 005a1944 | CDemonRenderer g_CDemonRendererInstance
    MOV EBX,dword ptr [ESP]             ; 005a1946
    JMP 0x005a18a9                      ; 005a1949 | LAB_005a18a9
