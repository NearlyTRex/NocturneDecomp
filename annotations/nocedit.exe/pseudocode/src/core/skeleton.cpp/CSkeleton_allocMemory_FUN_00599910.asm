...
section .text
    ...
    PUSH EAX                            ; 00599957
    CALL shape_memdbg.cpp_debugAllocTracked2_FUN_0050f1f0 ; 00599958
    ...
    PUSH EAX                            ; 00599985
    CALL shape_memdbg.cpp_debugAllocTracked2_FUN_0050f1f0 ; 00599986
        ;   XREF to: 0050f1f0 (UNCONDITIONAL_CALL)  ; void * shape_memdbg.cpp_debugAllocTracked2_FUN_0050f1f0(int size, char * filename, int line_number)
    ...
    PUSH EAX                            ; 005999bd
    CALL shape_memdbg.cpp_debugAllocTracked2_FUN_0050f1f0 ; 005999be
        ;   XREF to: 0050f1f0 (UNCONDITIONAL_CALL)  ; void * shape_memdbg.cpp_debugAllocTracked2_FUN_0050f1f0(int size, char * filename, int line_number)
