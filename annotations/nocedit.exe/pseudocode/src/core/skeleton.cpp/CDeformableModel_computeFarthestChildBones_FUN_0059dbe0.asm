...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_skeleton.cpp_CDeformableModel_computeFarthestChildBones_FUN_0059dbe0(CDeformableModel * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0059dbeb
    CALL core_skeleton.cpp_CDeformableModel_getSkeletonPtr_FUN_0059a810 ; 0059dbec | CSkeleton * core_skeleton.cpp_CDeformableModel_getSkeletonPtr_FUN_0059a810(CDeformableModel * this_ptr)
    ...
    JLE 0x0059dc67                      ; 0059dc00 | LAB_0059dc67
    ...
    JLE 0x0059dc51                      ; 0059dc2d | LAB_0059dc51
    ...
    CMP ESI,dword ptr [EBX + 0x2857c]   ; 0059dc38
        ;   Label: LAB_0059dc38
    JZ 0x0059dc6f                       ; 0059dc3e | LAB_0059dc6f
    ...
    JL 0x0059dc38                       ; 0059dc4f | LAB_0059dc38
    ...
    JL 0x0059dc0f                       ; 0059dc65 | LAB_0059dc0f
    ...
    FNSTSW AX                           ; 0059dc8b
    SAHF                                ; 0059dc8d
    JBE 0x0059dc40                      ; 0059dc8e | LAB_0059dc40
    ...
    JMP 0x0059dc40                      ; 0059dc9e | LAB_0059dc40
