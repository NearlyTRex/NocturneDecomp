...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_skeleton.cpp_CDeformableModel_captureTextures_FUN_0059a780(CDeformableModel * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 0059a791
    CALL core_skeleton.cpp_loadSkeleton_FUN_005a1df0 ; 0059a792 | CSkeleton * core_skeleton.cpp_loadSkeleton_FUN_005a1df0(char * filename)
        ;   XREF to: 005a1df0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0059a797
    PUSH EAX                            ; 0059a79a
    PUSH EDI                            ; 0059a79b
    XOR EBP,EBP                         ; 0059a79c
    CALL core_skeleton.cpp_CDeformableModel_bindSkeleton_FUN_0059c1f0 ; 0059a79e | void core_skeleton.cpp_CDeformableModel_bindSkeleton_FUN_0059c1f0(CDeformableModel * this_ptr, CSkeleton * skeleton_ptr)
        ;   XREF to: 0059c1f0 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [EDI + 0xb8]      ; 0059a7a3
    ADD ESP,0x8                         ; 0059a7a9
    TEST EDX,EDX                        ; 0059a7ac
    JLE 0x0059a7fc                      ; 0059a7ae | LAB_0059a7fc
    ...
    JLE 0x0059a7e5                      ; 0059a7c3 | LAB_0059a7e5
        ;   XREF to: 0059a7e5 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [ESP]             ; 0059a7c5
    PUSH ESI                            ; 0059a7c8
        ;   Label: LAB_0059a7c8
    MOV EAX,[0x006703ec]                ; 0059a7c9 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH EAX                            ; 0059a7ce | CDemonRenderer g_CDemonRendererInstance
    INC EBX                             ; 0059a7cf
    CALL engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80 ; 0059a7d0 | void engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80(CDemonRenderer * this_ptr, SMRGLTextureBasic * texture)
        ;   XREF to: 0048db80 (UNCONDITIONAL_CALL)
    ADD ESI,0x48                        ; 0059a7d5
    MOV EDX,dword ptr [EDI + 0xbc]      ; 0059a7d8
    ADD ESP,0x8                         ; 0059a7de
    CMP EBX,EDX                         ; 0059a7e1
    JL 0x0059a7c8                       ; 0059a7e3 | LAB_0059a7c8
    ...
    JL 0x0059a7b9                       ; 0059a7fa | LAB_0059a7b9
