...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_skeleton.cpp_CDeformableModel_findMinWeightBone_FUN_0059dca0(CDeformableModel * this_ptr, int lod_level, int triangle_index)
;
; Parameters:
...
section .text
    ...
    JNZ 0x0059dcac                      ; 0059dcba | LAB_0059dcac
    ...
    FNSTSW AX                           ; 0059dd2d
    SAHF                                ; 0059dd2f
    JBE 0x0059dd34                      ; 0059dd30 | LAB_0059dd34
    ...
    JL 0x0059dd27                       ; 0059dd3b | LAB_0059dd27
    ...
    JMP 0x0059dd05                      ; 0059dd5d | LAB_0059dd05
