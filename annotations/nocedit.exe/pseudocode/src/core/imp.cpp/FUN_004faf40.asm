...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_imp.cpp_FUN_004faf40()
;
; Local Variables:
...
section .text
    ...
    JNZ 0x004fb06c                      ; 004faf5f | LAB_004fb06c
        ;   XREF to: 004fb06c (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESI + 0xbec8]    ; 004faf65
        ;   Label: LAB_004faf65
    CMP dword ptr [ESI + EAX*0x4 + 0x2298],0x0 ; 004faf6b
    JZ 0x004fafb4                       ; 004faf73 | LAB_004fafb4
        ;   XREF to: 004fafb4 (CONDITIONAL_JUMP)
    MOV EAX,[0x02db8a08]                ; 004faf75 | undefined4 DAT_02db8a08
    PUSH EAX                            ; 004faf7a
    LEA EAX,[ESP + 0x10]                ; 004faf7b
    PUSH EAX                            ; 004faf7f
    LEA EAX,[ESI + 0x158]               ; 004faf80
    PUSH EAX                            ; 004faf86
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00 ; 004faf87 | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
    ...
    JZ 0x004fafb3                       ; 004fafa1 | LAB_004fafb3
    ...
    JZ 0x004fb004                       ; 004fafc2 | LAB_004fb004
        ;   XREF to: 004fb004 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x02db8a0c]      ; 004fafc4 | undefined4 DAT_02db8a0c
    PUSH ECX                            ; 004fafca
    LEA EAX,[ESP + 0x34]                ; 004fafcb
    PUSH EAX                            ; 004fafcf
    LEA EAX,[ESI + 0x158]               ; 004fafd0
    PUSH EAX                            ; 004fafd6
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00 ; 004fafd7 | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
        ;   XREF to: 0059fb00 (UNCONDITIONAL_CALL)
    ...
    JZ 0x004fb003                       ; 004faff1 | LAB_004fb003
    ...
    JZ 0x004fb053                       ; 004fb012 | LAB_004fb053
        ;   XREF to: 004fb053 (CONDITIONAL_JUMP)
    MOV EAX,[0x02db8a18]                ; 004fb014 | undefined4 DAT_02db8a18
    PUSH EAX                            ; 004fb019
    LEA EAX,[ESP + 0x4]                 ; 004fb01a
    PUSH EAX                            ; 004fb01e
    LEA EAX,[ESI + 0x158]               ; 004fb01f
    PUSH EAX                            ; 004fb025
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00 ; 004fb026 | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
        ;   XREF to: 0059fb00 (UNCONDITIONAL_CALL)
    ...
    JZ 0x004fb052                       ; 004fb040 | LAB_004fb052
    ...
    JNZ 0x004fb0a1                      ; 004fb061 | LAB_004fb0a1
    ...
    POP EBX                             ; 004fb06a
    RET                                 ; 004fb06b
    MOV ECX,dword ptr [0x02db89f4]      ; 004fb06c | undefined4 DAT_02db89f4
        ;   Label: LAB_004fb06c
    PUSH ECX                            ; 004fb072
    ...
    PUSH EAX                            ; 004fb07e
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00 ; 004fb07f | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
        ;   XREF to: 0059fb00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004fb084
    CMP EDI,EAX                         ; 004fb087
    JZ 0x004fb09b                       ; 004fb089 | LAB_004fb09b
    ...
    INC EBX                             ; 004fb09b
        ;   Label: LAB_004fb09b
    JMP 0x004faf65                      ; 004fb09c | LAB_004faf65
        ;   XREF to: 004faf65 (UNCONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x02db8a20]      ; 004fb0a1 | undefined4 DAT_02db8a20
        ;   Label: LAB_004fb0a1
    PUSH ECX                            ; 004fb0a7
    ...
    PUSH ESI                            ; 004fb0b3
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00 ; 004fb0b4 | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
        ;   XREF to: 0059fb00 (UNCONDITIONAL_CALL)
    ...
    JZ 0x004fb0e0                       ; 004fb0ce | LAB_004fb0e0
