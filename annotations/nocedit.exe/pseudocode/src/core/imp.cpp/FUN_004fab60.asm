...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_imp.cpp_FUN_004fab60()
;
; Local Variables:
; undefined4       Stack[-0x14]:4  local_14
;
; XREF[1]:
;   core_imp.cpp_FUN_004fae00 at 004fae82
;
; Referenced Globals:
...
section .text
    ...
    FNSTSW AX                           ; 004fab76
    SAHF                                ; 004fab78
    JNC 0x004faba5                      ; 004fab79 | default
        ;   XREF to: 004faba5 (CONDITIONAL_JUMP)
    CMP dword ptr [ESI],-0x1            ; 004fab7b
    JNZ 0x004faba5                      ; 004fab7e | default
        ;   XREF to: 004faba5 (CONDITIONAL_JUMP)
    CALL crt_stdlib.c_rand_FUN_005feb5c ; 004fab80 | int crt_stdlib.c_rand_FUN_005feb5c()
    ...
    JA 0x004faba5                       ; 004fab94 | default
        ;   XREF to: 004faba5 (CONDITIONAL_JUMP)
    JMP dword ptr [EDX*0x4 + 0x4fab48]  ; 004fab96 | void * switchdataD_004fab48
        ;   Label: switchD
    ...
    JNZ 0x004fad85                      ; 004fabaf | LAB_004fad85
    ...
    JNZ 0x004fabce                      ; 004fabc4 | LAB_004fabce
    ...
    JNZ 0x004fabe0                      ; 004fabd6 | LAB_004fabe0
        ;   XREF to: 004fabe0 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x8],0x3ca3d70a ; 004fabd8
    MOV EAX,[0x0067b654]                ; 004fabe0 | CGame g_CGameInstance | CGame * g_CGamePtr
        ;   Label: LAB_004fabe0
    CMP dword ptr [EAX + 0x1e0],0x0     ; 004fabe5 | g_CGameInstance.field57_0x1e0
    JZ 0x004fabf6                       ; 004fabec | LAB_004fabf6
        ;   XREF to: 004fabf6 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x8],0x3f800000 ; 004fabee
    MOV EAX,[0x0067b654]                ; 004fabf6 | CGame g_CGameInstance | CGame * g_CGamePtr
        ;   Label: LAB_004fabf6
    MOV EDX,dword ptr [EAX + 0x14]      ; 004fabfb | g_CGameInstance.blood_flag
    TEST EDX,EDX                        ; 004fabfe
    JNZ 0x004fac06                      ; 004fac00 | LAB_004fac06
        ;   XREF to: 004fac06 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x8],EDX       ; 004fac02
    PUSH dword ptr [ESP + 0x8]          ; 004fac06
        ;   Label: LAB_004fac06
    CALL core_actor.cpp_randomChance_FUN_0040cd10 ; 004fac0a | int core_actor.cpp_randomChance_FUN_0040cd10(float probability_threshold)
        ;   XREF to: 0040cd10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004fac0f
    TEST EAX,EAX                        ; 004fac12
    JZ 0x004fad1c                       ; 004fac14 | LAB_004fad1c
    ...
    PUSH EAX                            ; 004fac31
    CALL core_bodypart.cpp_CreateBodyPart_FUN_00418e10 ; 004fac32 | undefined core_bodypart.cpp_CreateBodyPart_FUN_00418e10()
    ...
    PUSH EDI                            ; 004fac43
    PUSH EBX                            ; 004fac44
    CALL core_charactr.cpp_CCharacter_FUN_0042bd30 ; 004fac45 | void core_charactr.cpp_CCharacter_FUN_0042bd30(CCharacter * this_ptr)
    ...
    JNZ 0x004fac6c                      ; 004fac57 | LAB_004fac6c
    ...
    PUSH EDI                            ; 004fac62
    PUSH EBX                            ; 004fac63
    CALL core_charactr.cpp_CCharacter_FUN_0042bd30 ; 004fac64 | void core_charactr.cpp_CCharacter_FUN_0042bd30(CCharacter * this_ptr)
        ;   XREF to: 0042bd30 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004fac69
    MOV EDI,dword ptr [EBX + 0xbed0]    ; 004fac6c
        ;   Label: LAB_004fac6c
    CMP EDI,dword ptr [ESI]             ; 004fac72
    JNZ 0x004fac89                      ; 004fac74 | LAB_004fac89
    ...
    PUSH EBP                            ; 004fac7f
    PUSH EBX                            ; 004fac80
    CALL core_charactr.cpp_CCharacter_FUN_0042bd30 ; 004fac81 | void core_charactr.cpp_CCharacter_FUN_0042bd30(CCharacter * this_ptr)
        ;   XREF to: 0042bd30 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004fac86
    MOV EDX,dword ptr [EBX + 0xbeec]    ; 004fac89
        ;   Label: LAB_004fac89
    CMP EDX,dword ptr [ESI]             ; 004fac8f
    JNZ 0x004facf5                      ; 004fac91 | LAB_004facf5
    ...
    PUSH ECX                            ; 004fac9f
    PUSH EBX                            ; 004faca0
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 004faca1 | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
    ...
    PUSH EAX                            ; 004facb2
    PUSH EBX                            ; 004facb3
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 004facb4 | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDX                            ; 004facc5
    PUSH EBX                            ; 004facc6
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 004facc7 | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ...
    PUSH ECX                            ; 004facd8
    PUSH EBX                            ; 004facd9
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 004facda | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDI                            ; 004faceb
    PUSH EBX                            ; 004facec
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 004faced | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004facf2
    PUSH 0x62fa4b                       ; 004facf5 | = "limb?.wav" | s_limb_wav_0062fa4b = limb?.wav
        ;   Label: LAB_004facf5
    PUSH EBX                            ; 004facfa
    CALL core_charactr.cpp_CCharacter_FUN_0042f300 ; 004facfb | void core_charactr.cpp_CCharacter_FUN_0042f300(CCharacter * this_ptr)
        ;   XREF to: 0042f300 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004fad00
    PUSH EBP                            ; 004fad03
    CALL core_bodypart.cpp_FUN_0041a050 ; 004fad04 | undefined core_bodypart.cpp_FUN_0041a050()
        ;   XREF to: 0041a050 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004fad09
    FLD float ptr [ESI + 0x8]           ; 004fad0c
    FLD ST0                             ; 004fad0f
    FMUL double ptr [0x0062fa56]        ; 004fad11 | double DOUBLE_0062fa56
    FSTP ST1                            ; 004fad17
    ...
    FLD float ptr [ESI + 0x4]           ; 004fadde
        ;   Label: LAB_004fadde
    FLD ST0                             ; 004fade1
    FMUL double ptr [0x0062fa5e]        ; 004fade3 | double DOUBLE_0062fa5e
    FSTP ST1                            ; 004fade9
