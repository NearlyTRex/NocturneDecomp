...
section .text
    ...
    PUSH EBX                            ; 004fb150
        ;   Label: core_imp.cpp_CImp_addFilesToExtract_FUN_004fb150
    MOV EDX,dword ptr [ESP + 0xc]       ; 004fb151
    PUSH EDX                            ; 004fb155
    MOV ECX,dword ptr [ESP + 0xc]       ; 004fb156
    PUSH ECX                            ; 004fb15a
    CALL core_actor.cpp_CDemonActor_addFilesToExtract_FUN_0040cfd0 ; 004fb15b
    ...
    PUSH EAX                            ; 004fb171
    CALL core_skeledit.cpp_CDeformableModelInstance_addFilesToExtract_FUN_0058a260 ; 004fb172
