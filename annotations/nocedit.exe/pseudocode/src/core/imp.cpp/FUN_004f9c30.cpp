...

{
  ...
  if (((in_stack_00000004->base).model.part_visibility_flags
     ...
     (iVar7 = (*(((in_stack_00000004->base).base.vtable._uc)->_uc).isDamageable)
                        (&in_stack_00000004->base), iVar7 == 0)) {
...
LAB_004f9c99:
  if (0.0 < local_34) {
    ...
    if (uVar8 < 0x29b) {
      if ((((*(int *)(in_stack_00000004->unk2 + 4) != 0) &&
           (iVar7 = (**(code **)(*(int *)(*(int *)(in_stack_00000004->unk2 + 4) + 0x154) + 0x120))()
           , iVar7 == 0)) &&
          (iVar7 = (**(code **)(*(int *)(*(int *)(in_stack_00000004->unk2 + 4) + 0x154) + 0x108))(),
          iVar7 == 0)) &&
         (iVar7 = (**(code **)(*(int *)(*(int *)(in_stack_00000004->unk2 + 4) + 0x154) + 0xfc))(),
         iVar7 != 0)) {
        local_50.z = 2.0f;
        local_50.x = 0.0;
        local_50.y = 0.0;
        ...
        fVar3 = local_68.x - *(float *)(*(int *)(in_stack_00000004->unk2 + 4) + 0x20);
        fVar5 = local_68.z - *(float *)(*(int *)(in_stack_00000004->unk2 + 4) + 0x28);
        bVar4 = (float)0.80000000000000004 < SQRT(fVar5 * fVar5 + fVar3 * fVar3);
        if (((ABS(local_68.y - *(float *)(*(int *)(in_stack_00000004->unk2 + 4) + 0x24)) <=
              (float)4) &&
            ((bVar4 || (iVar7 = (**(code **)(*(int *)(*(int *)(in_stack_00000004->unk2 + 4) + 0x154)
                                            + 0x100))(), iVar7 != 0)))) && (!bVar4)) {
          core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
  ...
  *(float *)((in_stack_00000004->base).unk1 + 0x28) =
       (in_stack_00000004->base).model.accumulated_root_motion.z;
  *(float *)((in_stack_00000004->base).unk1 + 0x2c) = in_stack_00000008 * fVar5 * fVar3;
  ...
  if (iVar11 == 0) {
    ...
    case 0:
      ...
      if (iVar7 == 0) {
        ...
        if (iVar7 == 0) {
          ...
          local_80.x = *(float *)(iVar7 + 0x20) - (in_stack_00000004->base).base.location.position.x
          ;
          local_80.y = *(float *)(iVar7 + 0x24) - (in_stack_00000004->base).base.location.position.y
          ;
          local_80.z = *(float *)(iVar7 + 0x28) - (in_stack_00000004->base).base.location.position.z
          ;
          ...
          if (local_20 < 2.0f) {
            ...
            local_14 = core_actor_cpp_normalizeAngleToPi_FUN_0040cd70
                                 (local_e0.y - (in_stack_00000004->base).base.orient.bank);
    ...
    case 2:
      ...
      if (*(int *)(in_stack_00000004->unk2 + 4) == 0) {
        ...
        iVar7 = *(int *)(*(int *)(in_stack_00000004->unk2 + 4) + 0x2598);
        if (iVar7 == 0) {
          local_28 = 2.0f;
          (in_stack_00000004->base).model.accumulated_root_motion.z = 0.0;
          (in_stack_00000004->base).model.accumulated_root_motion.y =
          ...
          if (-1 < iVar7) {
            local_a4 = (in_stack_00000004->base).base.location.position.x -
                       *(float *)(*(int *)(in_stack_00000004->unk2 + 4) + 0x20);
            local_9c = (in_stack_00000004->base).base.location.position.z -
            ...
            if (((local_1c < 4.0f) &&
                (iVar7 = (**(code **)(*(int *)(*(int *)(in_stack_00000004->unk2 + 4) + 0x154) +
                                     0x108))(), iVar7 == 0)) &&
               ((in_stack_00000004->base).model.part_visibility_flags
                [(int)in_stack_00000004[1].base.base.orient_matrix.m[0].x] != 0)) {
              iVar7 = *(int *)(in_stack_00000004->unk2 + 4);
              ...
              ;
              local_14 = core_actor_cpp_normalizeAngleToPi_FUN_0040cd70
                                   (local_ec.y - (in_stack_00000004->base).base.orient.bank);
              if ((ABS(local_14) < (float)0.52359877558333301) &&
                 (iVar7 = core_actor_cpp_randomChance_FUN_0040cd10(0.1), iVar7 != 0)) {
                core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                          (&(in_stack_00000004->base).model.motion_controller,8,1);
                iVar7 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660
                                  (*(uint *)(in_stack_00000004[1].base.base.actor_name + 8));
                if (iVar7 == 0) {
                  uVar13 = (*((in_stack_00000004->base).base.vtable._ub)->playSound)
                                     ((CDemonActor *)in_stack_00000004,"imp-jump?.wav");
                  *(uint *)(in_stack_00000004[1].base.base.actor_name + 8) = uVar13;
                }
              }
            }
            if ((local_1c <= local_28) && (*(float *)in_stack_00000004->unk2 <= 0.0)) {
              iVar7 = *(int *)(in_stack_00000004->unk2 + 4);
              ...
              core_vehicle_cpp_convertDirectionVectorToEulerAngles_FUN_005e7830
                        (&local_11c,&local_d4);
              local_14 = core_actor_cpp_normalizeAngleToPi_FUN_0040cd70
                                   (local_11c.y - (in_stack_00000004->base).base.orient.bank);
              if (ABS(local_14) < (float)0.52359877558333301) {
                core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
            ...
            fVar3 = *(float *)(in_stack_00000004[1].base.base.actor_name + 0x10) - in_stack_00000008
            ;
            *(float *)(in_stack_00000004[1].base.base.actor_name + 0x10) = fVar3;
            if (fVar3 < 0.0) {
              uVar8 = *(uint *)(in_stack_00000004[1].base.base.actor_name + 8);
              pCVar6 = &in_stack_00000004[1].base;
              (pCVar6->base).actor_name[0x10] = '\0';
              (pCVar6->base).actor_name[0x11] = '\0';
              (pCVar6->base).actor_name[0x12] = '\0';
              (pCVar6->base).actor_name[0x13] = '\0';
              iVar7 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660(uVar8);
              if ((iVar7 == 0) &&
                 (iVar7 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660
                                    (*(uint *)(in_stack_00000004[1].base.base.actor_name + 0xc)),
                 iVar7 == 0)) {
                uVar13 = (*((in_stack_00000004->base).base.vtable._ub)->playSound)
                                   ((CDemonActor *)in_stack_00000004,"imp-laugh?.wav");
                *(uint *)(in_stack_00000004[1].base.base.actor_name + 8) = uVar13;
                local_14 = core_actor_cpp_getRandomFloat_FUN_0040cc10(10.0,20.0);
                *(float *)(in_stack_00000004[1].base.base.actor_name + 0x10) = local_14;
              }
            }
          }
        }
      ...
      break;
    case 3:
      fVar3 = *(float *)(in_stack_00000004[1].base.base.actor_name + 0x10) -
      ...
      if (iVar7 != 0) {
        ...
        while (iVar7 < *(int *)(g_CDemonSetPtr->unk4 + 0x1f3c)) {
          ...
          if (((pCVar12 == (CEnemy *)0x0) || (pCVar12 == in_stack_00000004)) ||
             (*(int *)(in_stack_00000004->unk2 + 4) != *(int *)(pCVar12->unk2 + 4))) {
            iVar7 = iVar7 + 1;
            iVar11 = iVar11 + 4;
          }
          else {
    ...
    case 9:
      if ((*(int *)(in_stack_00000004->unk2 + 4) != 0) &&
         (iVar7 = (**(code **)(*(int *)(*(int *)(in_stack_00000004->unk2 + 4) + 0x154) + 0x120))(),
         iVar7 == 0)) {
        pCVar12 = *(CEnemy **)(*(int *)(in_stack_00000004->unk2 + 4) + 0x2598);
        if (in_stack_00000004 == pCVar12) {
          fVar3 = (float)0.75;
          iVar7 = *(int *)(pCVar12->unk2 + 4);
          (pCVar12->base).base.location.position.x =
               *(float *)(*(int *)(in_stack_00000004->unk2 + 4) + 0x20) -
               (pCVar12->base).base.orient_matrix.m[0].z * fVar3;
          (pCVar12->base).base.location.position.z =
               *(float *)(iVar7 + 0x28) - (pCVar12->base).base.orient_matrix.m[2].z * fVar3;
          break;
        }
      }
  ...
  uVar8 = *(uint *)((in_stack_00000004->base).unk2 + 0x10);
  if (uVar8 < 2) {
    if (uVar8 == 1) {
LAB_004f9fc4:
      iVar7 = 1;
...
switchD_004fa8ed_caseD_8:
  ...
  if ((iVar7 != 0) && (local_24 != 9)) {
    *(float *)((in_stack_00000004->base).unk1 + 0x20) =
    ...
    local_bc = *(float *)((in_stack_00000004->base).unk1 + 0x1c) * in_stack_00000008;
    local_b8 = *(float *)((in_stack_00000004->base).unk1 + 0x20) * in_stack_00000008;
    pcVar2 = (in_stack_00000004->base).unk1 + 0x10;
    local_b4 = in_stack_00000008 * *(float *)((in_stack_00000004->base).unk1 + 0x24);
    pCVar9 = &(in_stack_00000004->base).model.accumulated_root_motion;
    local_128 = local_bc + *(float *)pcVar2;
    local_124 = local_b8 + *(float *)((in_stack_00000004->base).unk1 + 0x14);
    local_120 = local_b4 + *(float *)((in_stack_00000004->base).unk1 + 0x18);
    local_110 = local_128 + pCVar9->x;
    local_10c = local_124 + (in_stack_00000004->base).model.accumulated_root_motion.y;
    local_108 = local_120 + (in_stack_00000004->base).model.accumulated_root_motion.z;
    ...
    *(float *)pcVar2 = *(float *)((in_stack_00000004->base).unk1 + 0x14);
    ...
    (in_stack_00000004->base).model.accumulated_root_motion.y =
         (in_stack_00000004->base).model.accumulated_root_motion.z;
    pCVar9->x = (in_stack_00000004->base).model.accumulated_root_motion.y;
