...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_imp_cpp_CImp_archive_FUN_004fab00(CImp *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004fab00
        ;   Label: core_imp.cpp_CImp_archive_FUN_004fab00
    PUSH ESI                            ; 004fab01
    MOV ESI,dword ptr [ESP + 0xc]       ; 004fab02
    PUSH ESI                            ; 004fab06
    CALL core_enemy.cpp_CEnemy_archive_FUN_004a9660 ; 004fab07
    ...
    PUSH EBX                            ; 004fab1a
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 004fab1b
    ...
    PUSH EBX                            ; 004fab2e
    CALL core_actor.cpp_archiveDeformableModelInstance_FUN_0040b970 ; 004fab2f
    ...
    PUSH EBX                            ; 004fab3c
    CALL core_actor.cpp_archiveMotionState_FUN_0040b9f0 ; 004fab3d
