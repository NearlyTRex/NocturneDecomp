...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_imp_cpp_CImp_writeDependencies_FUN_004fb150(CImp *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004fb150
        ;   Label: core_imp.cpp_CImp_writeDependencies_FUN_004fb150
    ...
    PUSH EAX                            ; 004fb171
    CALL core_skeledit.cpp_CDeformableModelInstance_writeDependencies_FUN_0058a260 ; 004fb172
