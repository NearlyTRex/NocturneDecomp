...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_imp_cpp_CImp_getPropertyList_FUN_004fb110(CImp *this_ptr,CActorPropertyList *property_list)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004fb110
        ;   Label: core_imp.cpp_CImp_getPropertyList_FUN_004fb110
    PUSH ESI                            ; 004fb111
    MOV EBX,dword ptr [ESP + 0xc]       ; 004fb112
    MOV ESI,dword ptr [ESP + 0x10]      ; 004fb116
    PUSH ESI                            ; 004fb11a
    PUSH EBX                            ; 004fb11b
    CALL core_enemy.cpp_CEnemy_getPropertyList_FUN_004aa170 ; 004fb11c
