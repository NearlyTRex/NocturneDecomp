...
;                               FUNCTION
; *****************************************************************************
; __cdecl CImp * __cdecl core_imp_cpp_CImp_dtor_FUN_004fb180(CImp *this_ptr,uint flags)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004fb180
        ;   Label: core_imp.cpp_CImp_dtor_FUN_004fb180
    ...
    PUSH EBX                            ; 004fb198
    CALL core_armour.cpp_CFlame_arrdtor_FUN_00412720 ; 004fb199
    ...
    PUSH EAX                            ; 004fb1a8
    CALL core_armour.cpp_SFire_arrdtor_FUN_00412700 ; 004fb1a9
    ...
    PUSH EAX                            ; 004fb1b8
    CALL core_armour.cpp_CVector3f_arrdtor_FUN_004126e0 ; 004fb1b9
    ...
    PUSH EAX                            ; 004fb1c8
    CALL core_armour.cpp_CVector3f_arrdtor_FUN_004126e0 ; 004fb1c9
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; CVector3f * core_armour.cpp_CVector3f_arrdtor_FUN_004126e0(CVector3f * objs, uint flags)
    ADD ESP,0x8                         ; 004fb1ce
    PUSH 0x0                            ; 004fb1d1
    SUB EAX,0x1c8                       ; 004fb1d3
    PUSH EAX                            ; 004fb1d8
    CALL core_cloth.cpp_CClothList_dtor_FUN_0043bf80 ; 004fb1d9
    ...
    PUSH 0x660360                       ; 004fb211 | g_CImpTypeInfo
        ;   Label: LAB_004fb211
    PUSH EBX                            ; 004fb216
    CALL crt_memory.c___vec_delete_FUN_005fe632 ; 004fb217
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c___vec_delete_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 004fb21c
    PUSH EAX                            ; 004fb21f
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 004fb220
