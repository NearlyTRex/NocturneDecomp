...
section .text
    ...
    PUSH EBX                            ; 004bea47
    CALL core_dest.cpp_FUN_0046f900     ; 004bea48
        ;   XREF to: 0046f900 (UNCONDITIONAL_CALL)  ; CActorDestination * core_dest.cpp_FUN_0046f900(CActorDestination * this_ptr)
    ...
    MOV dword ptr [EBX + 0x154],0x65db04 ; 004bea75 | PTR_core_filmreel.cpp_FUN_0065db04
