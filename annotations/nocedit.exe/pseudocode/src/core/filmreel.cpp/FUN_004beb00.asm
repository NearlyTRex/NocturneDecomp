...
section .text
    ...
    PUSH EBX                            ; 004beb05
    CALL core_dest.cpp_FUN_0046f970     ; 004beb06 | undefined core_dest.cpp_FUN_0046f970()
        ;   XREF to: 0046f970 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004beb0b
    LEA EAX,[EBX + 0x1f4]               ; 004beb0e
    PUSH EAX                            ; 004beb14
    CALL core_dmodel.cpp_CKeyFramedModelInstance_preCache_FUN_00478d60 ; 004beb15 | CKeyFramedModel * core_dmodel.cpp_CKeyFramedModelInstance_preCache_FUN_00478d60(CKeyFramedModelInstance * this_ptr)
