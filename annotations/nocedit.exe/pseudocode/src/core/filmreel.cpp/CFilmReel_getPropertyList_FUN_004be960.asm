...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_filmreel_cpp_CFilmReel_getPropertyList_FUN_004be960(CFilmReel *this_ptr,CActorPropertyList *property_list)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004be960
        ;   Label: core_filmreel.cpp_CFilmReel_getPropertyList_FUN_004be960
    PUSH ESI                            ; 004be961
