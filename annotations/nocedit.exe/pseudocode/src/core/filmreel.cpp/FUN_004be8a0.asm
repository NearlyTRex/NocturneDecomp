...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_filmreel_cpp_FUN_004be8a0(void)
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004be8a5
    CALL core_actor.cpp_CDemonActor_serialize_FUN_0040c1c0 ; 004be8a6
    ...
    PUSH EAX                            ; 004be8b9
    CALL core_actor.cpp_serializeKeyframedModelInstance_FUN_0040b8f0 ; 004be8ba
    ...
    PUSH EAX                            ; 004be8da
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 004be8db
