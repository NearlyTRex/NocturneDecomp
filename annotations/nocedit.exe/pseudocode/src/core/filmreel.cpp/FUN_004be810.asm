...
section .text
    ...
    PUSH EAX                            ; 004be81c
    MOV EDX,dword ptr [0x006703ec]      ; 004be81d | g_CDemonRendererPtr
    ...
    PUSH EAX                            ; 004be831
    MOV ECX,dword ptr [0x006703ec]      ; 004be832 | g_CDemonRendererPtr
    ...
    MOV EBX,dword ptr [0x006703ec]      ; 004be860 | g_CDemonRendererPtr
        ;   Label: LAB_004be860
