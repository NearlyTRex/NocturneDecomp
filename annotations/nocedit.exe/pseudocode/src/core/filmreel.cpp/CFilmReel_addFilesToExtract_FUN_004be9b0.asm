...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_filmreel_cpp_CFilmReel_addFilesToExtract_FUN_004be9b0(CFilmReel *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004be9b0
        ;   Label: core_filmreel.cpp_CFilmReel_addFilesToExtract_FUN_004be9b0
    PUSH ESI                            ; 004be9b1
    MOV EBX,dword ptr [ESP + 0xc]       ; 004be9b2
    MOV ESI,dword ptr [ESP + 0x10]      ; 004be9b6
    PUSH ESI                            ; 004be9ba
    PUSH EBX                            ; 004be9bb
    CALL core_actor.cpp_CDemonActor_addFilesToExtract_FUN_0040cfd0 ; 004be9bc
    ...
    PUSH EAX                            ; 004be9ee
    CALL core_dmodel.cpp_CKeyFramedModel_addFilesToExtract_FUN_0047ed00 ; 004be9ef
