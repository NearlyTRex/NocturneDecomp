...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_filmreel_cpp_CFilmReel_renderOpaque_FUN_004be810(CFilmReel *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004be810
        ;   Label: core_filmreel.cpp_CFilmReel_renderOpaque_FUN_004be810
    PUSH ESI                            ; 004be811
