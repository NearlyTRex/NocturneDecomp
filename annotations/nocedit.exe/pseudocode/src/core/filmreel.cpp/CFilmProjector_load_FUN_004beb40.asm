...
section .text
    ...
    JNZ 0x004beb83                      ; 004beb53 | LAB_004beb83
        ;   XREF to: 004beb83 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x3dc],0x0     ; 004beb55
    JNZ 0x004bec91                      ; 004beb5c | LAB_004bec91
    ...
    CALL core_dest.cpp_FUN_0046f9b0     ; 004beb73 | undefined core_dest.cpp_FUN_0046f9b0()
    ...
    FMUL double ptr [0x00629bc5]        ; 004beb8d | double DOUBLE_00629bc5
    ...
    JZ 0x004bec11                       ; 004bebb9 | LAB_004bec11
        ;   XREF to: 004bec11 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [EBX + 0x3e0]     ; 004bebbb
    PUSH EDX                            ; 004bebc1
    CALL sound_sndmain.cpp_isSfxPlaying_FUN_005a9660 ; 004bebc2 | int sound_sndmain.cpp_isSfxPlaying_FUN_005a9660(uint sfx_handle)
        ;   XREF to: 005a9660 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004bebc7
    TEST EAX,EAX                        ; 004bebca
    JZ 0x004bebf7                       ; 004bebcc | LAB_004bebf7
        ;   XREF to: 004bebf7 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [EBX + 0x370]     ; 004bebce
        ;   Label: LAB_004bebce
    CMP ECX,dword ptr [EBX + 0x158]     ; 004bebd4
    JNZ 0x004beb62                      ; 004bebda | LAB_004beb62
        ;   XREF to: 004beb62 (CONDITIONAL_JUMP)
    LEA EAX,[EBX + 0x374]               ; 004bebdc
    PUSH EAX                            ; 004bebe2
    MOV ESI,dword ptr [0x006793d0]      ; 004bebe3 | CEventList * g_CEventListPtr
    PUSH ESI                            ; 004bebe9 | CEventList g_CEventListInstance
    CALL core_event.cpp_CEventList_FUN_004aabe0 ; 004bebea | void core_event.cpp_CEventList_FUN_004aabe0(CEventList * this_ptr)
        ;   XREF to: 004aabe0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004bebef
    JMP 0x004beb62                      ; 004bebf2 | LAB_004beb62
        ;   XREF to: 004beb62 (UNCONDITIONAL_JUMP)
    PUSH 0x629b58                       ; 004bebf7 | = "35-loop.wav" | s_s_35_loop_wav_00629b58 = 35-loop.wav
        ;   Label: LAB_004bebf7
    ...
    JMP 0x004bebce                      ; 004bec0f | LAB_004bebce
    ...
    PUSH EDX                            ; 004bec1d
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 004bec1e | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004bec23
    MOV ESI,EAX                         ; 004bec26
    TEST EAX,EAX                        ; 004bec28
    JNZ 0x004bec4f                      ; 004bec2a | LAB_004bec4f
        ;   XREF to: 004bec4f (CONDITIONAL_JUMP)
    MOV ECX,0x629b64                    ; 004bec2c | = "..\\core\\filmreel.cpp" | s_core_filmreel_cpp_00629b64 = ..\core\filmreel.cpp
    MOV EDI,0x11e                       ; 004bec31
    PUSH 0x629b79                       ; 004bec36 | = "CFilmProjector::Need to put CFilmReel..." | s_CFilmProjector_Need_to_p_00629b79 = CFilmProjector::Need to put CFilmReel in place
    MOV dword ptr [0x02f0ca48],ECX      ; 004bec3b | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 004bec41 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004bec47 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004bec4c
    LEA EAX,[ESI + 0x2d8]               ; 004bec4f
        ;   Label: LAB_004bec4f
    PUSH EAX                            ; 004bec55
    MOV EBP,dword ptr [0x0066efd0]      ; 004bec56 | CFilterFx * g_CFilterFXPtr
    PUSH EBP                            ; 004bec5c | CFilterFx g_CFilterFXInstance
    CALL core_dfilter.cpp_CFilterFX_openMovie_FUN_00470730 ; 004bec5d | void core_dfilter.cpp_CFilterFX_openMovie_FUN_00470730(CFilterFx * this_ptr, char * filename)
        ;   XREF to: 00470730 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004bec62
    MOV EAX,dword ptr [EBX + 0x3e0]     ; 004bec65
    PUSH EAX                            ; 004bec6b
    CALL sound_sndmain.cpp_killSfx_FUN_005a9c40 ; 004bec6c | int sound_sndmain.cpp_killSfx_FUN_005a9c40(uint sfx_handle)
        ;   XREF to: 005a9c40 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004bec71
    PUSH 0x629ba8                       ; 004bec74 | = "35-start.wav" | s_s_35_start_wav_00629ba8 = 35-start.wav
    ...
    JMP 0x004bebce                      ; 004bec8c | LAB_004bebce
        ;   XREF to: 004bebce (UNCONDITIONAL_JUMP)
    PUSH EDX                            ; 004bec91
        ;   Label: LAB_004bec91
    MOV ESI,dword ptr [0x0066efd0]      ; 004bec92 | CFilterFx * g_CFilterFXPtr
    PUSH ESI                            ; 004bec98 | CFilterFx g_CFilterFXInstance
    CALL core_dfilter.cpp_CFilterFX_openMovie_FUN_00470730 ; 004bec99 | void core_dfilter.cpp_CFilterFX_openMovie_FUN_00470730(CFilterFx * this_ptr, char * filename)
        ;   XREF to: 00470730 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004bec9e
    MOV EDI,dword ptr [EBX + 0x3e0]     ; 004beca1
    PUSH EDI                            ; 004beca7
    CALL sound_sndmain.cpp_killSfx_FUN_005a9c40 ; 004beca8 | int sound_sndmain.cpp_killSfx_FUN_005a9c40(uint sfx_handle)
        ;   XREF to: 005a9c40 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004becad
    PUSH 0x629bb5                       ; 004becb0 | = "35-end.wav" | s_s_35_end_wav_00629bb5 = 35-end.wav
    ...
    JMP 0x004beb62                      ; 004becc8 | LAB_004beb62
        ;   XREF to: 004beb62 (UNCONDITIONAL_JUMP)
