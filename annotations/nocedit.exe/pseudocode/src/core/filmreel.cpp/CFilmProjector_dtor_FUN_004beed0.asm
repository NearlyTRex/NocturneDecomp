...
;                               FUNCTION
; *****************************************************************************
; __cdecl CFilmProjector * core_filmreel.cpp_CFilmProjector_dtor_FUN_004beed0(CFilmProjector * this_ptr, uint d1, uint d2)
;
; Parameters:
...
section .text
    ...
    PUSH 0x65dc10                       ; 004beef6 | g_CFilmProjectorTypeInfo
        ;   Label: LAB_004beef6
    PUSH EBX                            ; 004beefb
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 004beefc
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 004bef01
    PUSH EAX                            ; 004bef04
    CALL crt_memory.c_free_FUN_005fe659 ; 004bef05
