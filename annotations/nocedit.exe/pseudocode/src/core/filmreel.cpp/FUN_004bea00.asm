...
section .text
    ...
    PUSH EAX                            ; 004bea1c
        ;   Label: LAB_004bea1c
    CALL core_filmreel.cpp_ctor_FUN_004bea40 ; 004bea1d
        ;   XREF to: 004bea40 (UNCONDITIONAL_CALL)  ; CFilmProjector * core_filmreel.cpp_ctor_FUN_004bea40(CFilmProjector * this_ptr)
