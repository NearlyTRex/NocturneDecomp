...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_batcreat_cpp_CBatCreature_FUN_00415150(CBatCreature *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EDI                            ; 00415156
    PUSH EBX                            ; 00415157
    CALL core_enemy.cpp_CEnemy_FUN_004a9650 ; 00415158
    ...
    PUSH ESI                            ; 00415191
    MOV [0x0082274c],EAX                ; 00415192 | DAT_0082274c
    ...
    PUSH ESI                            ; 0041528d
    MOV [0x0082274c],EAX                ; 0041528e | DAT_0082274c
