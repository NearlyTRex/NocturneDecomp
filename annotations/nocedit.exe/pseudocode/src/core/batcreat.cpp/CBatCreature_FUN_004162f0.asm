...
section .text
    ...
    PUSH ECX                            ; 004162fa
    CALL core_actor.cpp_CDemonActor_writeDependencies_FUN_0040cfd0 ; 004162fb | void core_actor.cpp_CDemonActor_writeDependencies_FUN_0040cfd0(CDemonActor * this_ptr, FILE * file_handle)
    ...
    PUSH EAX                            ; 00416311
    CALL core_skeledit.cpp_GetModelPtrOfFile_FUN_0058a260 ; 00416312 | undefined core_skeledit.cpp_GetModelPtrOfFile_FUN_0058a260()
