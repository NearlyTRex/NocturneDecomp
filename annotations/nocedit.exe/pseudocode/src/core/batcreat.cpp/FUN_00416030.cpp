...
// Globals:
//   undefined4 s_batman-die.wav_00615691
//   TerminatedCString s_batman_hurt_wav_006156a0
//   undefined4 DAT_006156b1
...

{
  ...
  if (*(int *)(in_stack_00000008 + 0x28) == 7) {
    iVar2 = 0;
    *(float *)(in_stack_00000008 + 4) = *(float *)(in_stack_00000008 + 4) * (float)_DAT_006156b1;
  ...
  if (fVar1 <= 0.0) {
    ...
    if ((*(int *)(iVar2 + 0x24) != 7) && (*(int *)(iVar2 + 0x24) != 8)) {
      ...
      uVar3 = (*((in_stack_00000004->base_actor).metadata.vtable)->playSound)
                        (&in_stack_00000004->base_actor,"@batman-die.wav" + 1);
      *(undefined4 *)(in_stack_00000004[1].base_actor.create_event + 0x5c) = uVar3;
...
// 00416083: PUSH EAX
// 00416084: CALL core_skeleton.cpp_CDeformableModelInstance_FUN_0059fb00
...
// 00416091: PUSH EAX
// 00416092: PUSH ESI
// 00416093: CALL core_actor.cpp_CDemonActor_FUN_00408ec0
...
// 004160e0: PUSH 0x2
// 004160e2: PUSH 0x0
// 004160e4: CALL core_actor.cpp_FUN_0040cc70
...
// 00416173: CALL core_actor.cpp_CDemonActor_FUN_00408ec0
//   XREF to: 00408ec0 (UNCONDITIONAL_CALL)
...
// 004161b4: CALL core_motion.cpp_CMotionController_FUN_0052dab0
