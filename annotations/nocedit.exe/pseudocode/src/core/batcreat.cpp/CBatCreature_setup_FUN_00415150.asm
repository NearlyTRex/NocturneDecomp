...
section .text
    ...
    PUSH ESI                            ; 00415191
    MOV [0x0082274c],EAX                ; 00415192 | g_BatCreatureIndices
    ...
    PUSH ESI                            ; 004151a6
    MOV [0x00822758],EAX                ; 004151a7 | g_BatCreatureIndices[3]
    ...
    PUSH ESI                            ; 004151bb
    MOV [0x0082275c],EAX                ; 004151bc | g_BatCreatureIndices[4]
    ...
    PUSH ESI                            ; 004151d0
    MOV [0x00822760],EAX                ; 004151d1 | g_BatCreatureIndices[5]
    ...
    PUSH ESI                            ; 004151e5
    MOV [0x00822764],EAX                ; 004151e6 | g_BatCreatureIndices[6]
    ...
    PUSH ESI                            ; 004151fa
    MOV [0x00822768],EAX                ; 004151fb | g_BatCreatureIndices[7]
    ...
    PUSH ESI                            ; 0041520f
    MOV [0x0082276c],EAX                ; 00415210 | g_BatCreatureIndices[8]
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 00415215
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 0041521a
    MOV [0x00822750],EAX                ; 0041521d | g_BatCreatureIndices[1]
    PUSH 0x1                            ; 00415222
    ...
    PUSH ESI                            ; 00415239
    MOV [0x00822754],EAX                ; 0041523a | g_BatCreatureIndices[2]
    ...
    PUSH ESI                            ; 0041524e
    MOV [0x00822770],EAX                ; 0041524f | g_BatCreatureIndices[9]
    ...
    PUSH ESI                            ; 00415263
    MOV [0x00822774],EAX                ; 00415264 | g_BatCreatureIndices[10]
    ...
    PUSH ESI                            ; 00415278
    MOV [0x00822778],EAX                ; 00415279 | g_BatCreatureIndices[11]
    ...
    PUSH ESI                            ; 0041528d
    MOV [0x0082274c],EAX                ; 0041528e | g_BatCreatureIndices
    ...
    PUSH ESI                            ; 004152a2
    MOV [0x00822760],EAX                ; 004152a3 | g_BatCreatureIndices[5]
    ...
    PUSH ESI                            ; 004152b7
    MOV [0x00822764],EAX                ; 004152b8 | g_BatCreatureIndices[6]
    ...
    PUSH ESI                            ; 004152cc
    MOV [0x00822770],EAX                ; 004152cd | g_BatCreatureIndices[9]
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 004152d2
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 004152d7
    PUSH EDI                            ; 004152da
    MOV [0x00822778],EAX                ; 004152db | g_BatCreatureIndices[11]
