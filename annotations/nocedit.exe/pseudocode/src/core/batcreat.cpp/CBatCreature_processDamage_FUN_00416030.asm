...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_batcreat_cpp_CBatCreature_processDamage_FUN_00416030 (CBatCreature *this_ptr,SDamageInfo *damage_info)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00416030
        ;   Label: core_batcreat.cpp_CBatCreature_processDamage_FUN_00416030
    PUSH ESI                            ; 00416031
    PUSH EDI                            ; 00416032
    PUSH EBP                            ; 00416033
    ...
    PUSH EDI                            ; 00416145
        ;   Label: LAB_00416145
    PUSH ESI                            ; 00416146
    CALL core_enemy.cpp_CEnemy_processDamage_FUN_004a9f10 ; 00416147
    ...
    PUSH EDI                            ; 00416201
    PUSH ESI                            ; 00416202
    CALL core_enemy.cpp_CEnemy_processDamage_FUN_004a9f10 ; 00416203
        ;   XREF to: 004a9f10 (UNCONDITIONAL_CALL)  ; void core_enemy.cpp_CEnemy_processDamage_FUN_004a9f10(CEnemy * this_ptr, SDamageInfo * damage_info)
    ...
    PUSH EDI                            ; 0041622b
    PUSH ESI                            ; 0041622c
    CALL core_enemy.cpp_CEnemy_processDamage_FUN_004a9f10 ; 0041622d
        ;   XREF to: 004a9f10 (UNCONDITIONAL_CALL)  ; void core_enemy.cpp_CEnemy_processDamage_FUN_004a9f10(CEnemy * this_ptr, SDamageInfo * damage_info)
