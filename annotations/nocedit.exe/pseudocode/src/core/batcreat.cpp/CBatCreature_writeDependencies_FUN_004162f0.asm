...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_batcreat_cpp_CBatCreature_writeDependencies_FUN_004162f0 (CBatCreature *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004162f0
        ;   Label: core_batcreat.cpp_CBatCreature_writeDependencies_FUN_004162f0
    ...
    PUSH EAX                            ; 00416311
    CALL core_skeledit.cpp_CDeformableModelInstance_writeDependencies_FUN_0058a260 ; 00416312
