...
section .text
    ...
    MOV EDX,dword ptr [0x0082274c]      ; 00416249 | undefined4 DAT_0082274c
    PUSH EDX                            ; 0041624f
    ...
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00 ; 00416264 | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
        ;   XREF to: 0059fb00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00416269
    CMP ESI,EAX                         ; 0041626c
    JNZ 0x00416278                      ; 0041626e | LAB_00416278
