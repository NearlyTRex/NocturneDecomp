...
section .text
    ...
    PUSH EBX                            ; 00416338
    CALL core_backgnd.cpp_freeFlames_FUN_00412720 ; 00416339
    ...
    PUSH EAX                            ; 00416348
    CALL core_backgnd.cpp_freeFires_FUN_00412700 ; 00416349
    ...
    PUSH EAX                            ; 00416358
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 00416359
    ...
    PUSH EAX                            ; 00416368
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 00416369
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; int core_backgnd.cpp_cleanupVector_FUN_004126e0(CVector3f * * objs)
    ADD ESP,0x8                         ; 0041636e
    PUSH 0x0                            ; 00416371
    SUB EAX,0x1c8                       ; 00416373
    PUSH EAX                            ; 00416378
    CALL core_cloth.cpp_FUN_0043bf80    ; 00416379
    ...
    PUSH 0x65a730                       ; 004163b1 | g_CBatCreatureTypeInfo
        ;   Label: LAB_004163b1
    PUSH EBX                            ; 004163b6
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 004163b7
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 004163bc
    PUSH EAX                            ; 004163bf
    CALL crt_memory.c_free_FUN_005fe659 ; 004163c0
    ...
    PUSH EAX                            ; 004163cc
        ;   Label: LAB_004163cc
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 004163cd
