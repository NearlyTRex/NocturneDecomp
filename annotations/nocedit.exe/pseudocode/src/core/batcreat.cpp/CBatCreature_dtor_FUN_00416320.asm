...
;                               FUNCTION
; *****************************************************************************
; __cdecl CDemonActor * __cdecl core_batcreat_cpp_CBatCreature_dtor_FUN_00416320(CBatCreature *this_ptr,uint flags)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00416338
    CALL core_armour.cpp_freeFlames_FUN_00412720 ; 00416339
    ...
    PUSH EAX                            ; 00416348
    CALL core_armour.cpp_freeFires_FUN_00412700 ; 00416349
    ...
    PUSH EAX                            ; 00416358
    CALL core_armour.cpp_freeVectors_FUN_004126e0 ; 00416359
    ...
    PUSH EAX                            ; 00416368
    CALL core_armour.cpp_freeVectors_FUN_004126e0 ; 00416369
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; CVector3f * core_armour.cpp_freeVectors_FUN_004126e0(CVector3f * objs)
