...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_batcreat_cpp_CBatCreature_archive_FUN_00415d70(CBatCreature *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00415d70
        ;   Label: core_batcreat.cpp_CBatCreature_archive_FUN_00415d70
    PUSH ESI                            ; 00415d71
    MOV ESI,dword ptr [ESP + 0xc]       ; 00415d72
    PUSH ESI                            ; 00415d76
    CALL core_enemy.cpp_CEnemy_archive_FUN_004a9660 ; 00415d77
    ...
    PUSH EBX                            ; 00415d8a
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 00415d8b
    ...
    PUSH EBX                            ; 00415d9e
    CALL core_actor.cpp_archiveDeformableModelInstance_FUN_0040b970 ; 00415d9f
    ...
    PUSH EBX                            ; 00415dac
    CALL core_actor.cpp_archiveMotionState_FUN_0040b9f0 ; 00415dad
