    ...
    case 0:
      ...
      if (local_28 < 3.5f) {
        ...
        if (ABS(local_14) < (float)0.52359877558333301) {
          ...
          if ((iVar4 == 0) &&
             (iVar4 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660(this_ptr->sfx_handles[2]),
             iVar4 == 0)) {
...
LAB_004158fb:
      ...
      if ((((this_ptr->alert_played == 0) &&
           (iVar4 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660(this_ptr->sfx_handles[1]),
           iVar4 == 0)) &&
          (iVar4 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660(this_ptr->sfx_handles[2]), iVar4 == 0
