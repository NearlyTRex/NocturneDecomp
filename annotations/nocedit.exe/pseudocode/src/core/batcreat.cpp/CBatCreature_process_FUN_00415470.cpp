...
LAB_004156d6:
    ...
    if (uVar5 < 3) goto LAB_00415540;
    if (uVar5 != 3) goto LAB_004156d6;
    core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
              (&(this_ptr->base_enemy).base_character.model.motion_controller,0,1);
...
switchD_00415d62_caseD_2:
  ...
  if (iVar9 != 0) {
    *(float *)((this_ptr->base_enemy).base_character.field2_0x240c + 0x20) =
    ...
    pcVar3 = (this_ptr->base_enemy).base_character.model.field17_0x2254;
    ...
    local_6c = local_54 + *(float *)((this_ptr->base_enemy).base_character.model.field17_0x2254 + 4)
    ;
    local_68 = local_50 + *(float *)((this_ptr->base_enemy).base_character.model.field17_0x2254 + 8)
    ;
