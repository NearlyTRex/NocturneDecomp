...

{
  ...
  if (iVar9 == 0) {
    ...
    case 0:
      ...
      local_f4.x = (pCVar5->location).position.x - (this_ptr->base).base.base.location.position.x;
      local_f4.y = (pCVar5->location).position.y - (this_ptr->base).base.base.location.position.y;
      local_f4.z = (pCVar5->location).position.z - (this_ptr->base).base.base.location.position.z;
      ...
      if (local_28 < 3.5f) {
        ...
        if (ABS(local_14) < (float)0.52359877558333301) {
          ...
          iVar7 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660(*(uint *)(this_ptr->unk + 0x3c));
          if ((iVar7 == 0) &&
      ...
      if (local_1c < 10.0f) {
        ...
        if (iVar7 != 0) {
          pCVar5 = (this_ptr->base).victim;
          local_e8.x = (pCVar5->location).position.x -
                       (this_ptr->base).base.base.location.position.x;
          local_e8.y = (pCVar5->location).position.y -
                       (this_ptr->base).base.base.location.position.y;
          local_e8.z = (pCVar5->location).position.z -
...
LAB_004158fb:
      ...
      if ((((*(int *)(this_ptr->unk + 0x44) == 0) &&
          ...
          (iVar7 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660(*(uint *)(this_ptr->unk + 0x40)),
          iVar7 == 0)) &&
         (iVar7 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660(*(uint *)(this_ptr->unk + 0x38)),
         iVar7 == 0)) {
        uVar11 = (*((this_ptr->base).base.base.vtable._ub)->playSound)
    ...
    case 1:
      ...
      if ((this_ptr->base).victim == (CDemonActor *)0x0) {
        ...
        if (-1 < iVar9) {
          ...
          pCVar5 = (this_ptr->base).victim;
          local_a0 = (pCVar1->position).x - (pCVar5->location).position.x;
          local_98 = (this_ptr->base).base.base.location.position.z - (pCVar5->location).position.z;
          local_9c = 0;
          ...
          if ((10.0f < local_20) &&
            ...
            pCVar5 = (this_ptr->base).victim;
            local_94.x = (pCVar5->location).position.x - (pCVar1->position).x;
            local_94.y = (pCVar5->location).position.y -
                         (this_ptr->base).base.base.location.position.y;
            local_94.z = (pCVar5->location).position.z -
                         (this_ptr->base).base.base.location.position.z;
            ...
            if ((ABS(local_14) < (float)0.52359877558333301) &&
              ...
              if ((iVar7 == 0) &&
                 (iVar7 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660
                                    (*(uint *)(this_ptr->unk + 0x40)), iVar7 == 0)) {
                uVar11 = (*((this_ptr->base).base.base.vtable._ub)->playSound)
                                   ((CDemonActor *)this_ptr,"batman-attack?.wav");
                *(uint *)(this_ptr->unk + 0x40) = uVar11;
              }
          ...
          if ((local_20 <= local_24) && (*(float *)(this_ptr->base).unk2 <= 0.0)) {
            pCVar5 = (this_ptr->base).victim;
            local_88.x = (pCVar5->location).position.x -
                         (this_ptr->base).base.base.location.position.x;
            local_88.y = (pCVar5->location).position.y -
                         (this_ptr->base).base.base.location.position.y;
            local_88.z = (pCVar5->location).position.z -
                         (this_ptr->base).base.base.location.position.z;
