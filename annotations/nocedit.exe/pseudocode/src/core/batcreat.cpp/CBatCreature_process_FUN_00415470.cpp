  ...
  *(float *)((this_ptr->base).base.unk1 + 0x2c) = delta_time * fVar5 * fVar3;
  ...
  if (iVar9 == 0) {
    ...
    case 0:
      ...
      local_f4.x = *(float *)(iVar7 + 0x20) - (this_ptr->base).base.base.location.position.x;
      local_f4.y = *(float *)(iVar7 + 0x24) - (this_ptr->base).base.base.location.position.y;
      local_f4.z = *(float *)(iVar7 + 0x28) - (this_ptr->base).base.base.location.position.z;
      ...
      if (local_28 < 3.5f) {
        ...
        if (ABS(local_14) < (float)0.52359877558333301) {
          ...
          iVar7 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660(*(uint *)(this_ptr->unk + 0x44));
          if ((iVar7 == 0) &&
             (iVar7 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660(*(uint *)(this_ptr->unk + 0x48)),
             iVar7 == 0)) {
            uVar11 = (*((this_ptr->base).base.base.vtable._ub)->playSound)
                               ((CDemonActor *)this_ptr,"batman-attack?.wav");
            *(uint *)(this_ptr->unk + 0x48) = uVar11;
          }
        }
      }
      ...
      if (local_1c < 10.0f) {
        ...
        if (iVar7 != 0) {
          iVar7 = *(int *)((this_ptr->base).unk2 + 4);
          local_e8.x = *(float *)(iVar7 + 0x20) - (this_ptr->base).base.base.location.position.x;
          local_e8.y = *(float *)(iVar7 + 0x24) - (this_ptr->base).base.base.location.position.y;
          local_e8.z = *(float *)(iVar7 + 0x28) - (this_ptr->base).base.base.location.position.z;
...
LAB_004158fb:
      ...
      if ((((*(int *)(this_ptr->unk + 0x4c) == 0) &&
          ...
          (iVar7 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660(*(uint *)(this_ptr->unk + 0x48)),
          iVar7 == 0)) &&
         (iVar7 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660(*(uint *)(this_ptr->unk + 0x40)),
         iVar7 == 0)) {
        uVar11 = (*((this_ptr->base).base.base.vtable._ub)->playSound)
    ...
    case 1:
      ...
      if (*(int *)((this_ptr->base).unk2 + 4) == 0) {
        ...
        if (-1 < iVar9) {
          ...
          local_98 = (this_ptr->base).base.base.location.position.z - *(float *)(iVar9 + 0x28);
          local_9c = 0;
          local_20 = SQRT(local_98 * local_98 + local_a0 * local_a0);
          local_18 = local_20;
          if ((10.0f < local_20) &&
             ((this_ptr->base).unk2[0] = '\0', (this_ptr->base).unk2[1] = '\0',
             (this_ptr->base).unk2[2] = '\0', (this_ptr->base).unk2[3] = '\0', iVar7 == 1)) {
            iVar7 = *(int *)((this_ptr->base).unk2 + 4);
            local_94.x = *(float *)(iVar7 + 0x20) - (pCVar1->position).x;
            local_94.y = *(float *)(iVar7 + 0x24) - (this_ptr->base).base.base.location.position.y;
            local_94.z = *(float *)(iVar7 + 0x28) - (this_ptr->base).base.base.location.position.z;
            ...
            if ((ABS(local_14) < (float)0.52359877558333301) &&
              ...
              if ((iVar7 == 0) &&
                 (iVar7 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660
                                    (*(uint *)(this_ptr->unk + 0x48)), iVar7 == 0)) {
                uVar11 = (*((this_ptr->base).base.base.vtable._ub)->playSound)
                                   ((CDemonActor *)this_ptr,"batman-attack?.wav");
                *(uint *)(this_ptr->unk + 0x48) = uVar11;
              }
          ...
          if ((local_20 <= local_24) && (*(float *)(this_ptr->base).unk2 <= 0.0)) {
            iVar7 = *(int *)((this_ptr->base).unk2 + 4);
            local_88.x = *(float *)(iVar7 + 0x20) - (this_ptr->base).base.base.location.position.x;
            local_88.y = *(float *)(iVar7 + 0x24) - (this_ptr->base).base.base.location.position.y;
            local_88.z = *(float *)(iVar7 + 0x28) - (this_ptr->base).base.base.location.position.z;
...
switchD_00415d62_caseD_2:
  ...
  if (iVar7 != 0) {
    *(float *)((this_ptr->base).base.unk1 + 0x20) =
    ...
    local_c4 = *(float *)((this_ptr->base).base.unk1 + 0x1c) * delta_time;
    local_c0 = *(float *)((this_ptr->base).base.unk1 + 0x20) * delta_time;
    pcVar2 = (this_ptr->base).base.unk1 + 0x10;
    local_bc = delta_time * *(float *)((this_ptr->base).base.unk1 + 0x24);
    pCVar10 = &(this_ptr->base).base.model.accumulated_root_motion;
    local_58 = local_c4 + *(float *)pcVar2;
    local_54 = local_c0 + *(float *)((this_ptr->base).base.unk1 + 0x14);
    local_50 = local_bc + *(float *)((this_ptr->base).base.unk1 + 0x18);
