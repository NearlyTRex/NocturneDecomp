    ...
    *(float *)((this_ptr->base_enemy).base_character.field2_0x240c + 0x2c) =
          ...
          if (local_28 < DAT_0065a5ac) {
            ...
            if (ABS(local_14) < (float)_DAT_00615649) {
              ...
              if ((iVar9 == 0) &&
                ...
                uVar11 = (*((this_ptr->base_enemy).base_character.base_actor.metadata.vtable)->
                           playSound)((CDemonActor *)this_ptr,"batman-attack?.wav");
                *(undefined4 *)(this_ptr->field1_0xbeb4 + 0x48) = uVar11;
              }
            }
          }
          if (local_1c < (this_ptr->base_enemy).guard_distance) {
            if (local_1c < _DAT_0065a5b8) {
              ...
              if (iVar9 != 0) {
                iVar9 = *(int *)((this_ptr->base_enemy).field6_0xbe38 + 4);
                local_e8.x = *(float *)(iVar9 + 0x20) -
                             (this_ptr->base_enemy).base_character.base_actor.location.position.x;
                local_e8.y = *(float *)(iVar9 + 0x24) -
                             (this_ptr->base_enemy).base_character.base_actor.location.position.y;
                local_e8.z = *(float *)(iVar9 + 0x28) -
                             (this_ptr->base_enemy).base_character.base_actor.location.position.z;
            ...
            if ((((*(int *)(this_ptr->field1_0xbeb4 + 0x4c) == 0) &&
               ...
               (iVar9 = sound_sndmain_cpp_SoundLockKillBlah_FUN_005a9660(), iVar9 == 0)) {
              uVar11 = (*((this_ptr->base_enemy).base_character.base_actor.metadata.vtable)->
                         playSound)((CDemonActor *)this_ptr,"batman-alert.wav");
        ...
        if (*(int *)((this_ptr->base_enemy).field6_0xbe38 + 4) == 0) {
          ...
          *(undefined4 *)((this_ptr->base_enemy).base_character.model.padding_0x0 + 0x2254) =
          ...
          if (-1 < iVar10) {
            ...
            local_a0 = (pCVar1->position).x - *(float *)(iVar10 + 0x20);
            ...
            if ((_DAT_0065a5b8 < local_20) &&
               ...
               (this_ptr->base_enemy).field6_0xbe38[1] = '\0',
               (this_ptr->base_enemy).field6_0xbe38[2] = '\0',
               (this_ptr->base_enemy).field6_0xbe38[3] = '\0', iVar9 == 1)) {
              iVar9 = *(int *)((this_ptr->base_enemy).field6_0xbe38 + 4);
              local_94.x = *(float *)(iVar9 + 0x20) - (pCVar1->position).x;
              local_94.y = *(float *)(iVar9 + 0x24) -
                           (this_ptr->base_enemy).base_character.base_actor.location.position.y;
              local_94.z = *(float *)(iVar9 + 0x28) -
                           (this_ptr->base_enemy).base_character.base_actor.location.position.z;
            ...
            if ((local_20 <= local_24) && (*(float *)(this_ptr->base_enemy).field6_0xbe38 <= 0.0)) {
              iVar9 = *(int *)((this_ptr->base_enemy).field6_0xbe38 + 4);
              local_88.x = *(float *)(iVar9 + 0x20) -
                           (this_ptr->base_enemy).base_character.base_actor.location.position.x;
              local_88.y = *(float *)(iVar9 + 0x24) -
                           (this_ptr->base_enemy).base_character.base_actor.location.position.y;
              local_88.z = *(float *)(iVar9 + 0x28) -
                           (this_ptr->base_enemy).base_character.base_actor.location.position.z;
    ...
    if (iVar9 != 0) {
      *(float *)((this_ptr->base_enemy).base_character.field2_0x240c + 0x20) =
      ...
      pcVar3 = (this_ptr->base_enemy).base_character.model.padding_0x0 + 0x2254;
      ...
      local_70 = local_58 + *(float *)pcVar3;
      local_6c = local_54 +
...
// 00415664: PUSH EAX
// 00415665: CALL core_skeleton.cpp_CDeformableModelInstance_FUN_0059e020
...
// 004156fd: PUSH EAX
// 004156fe: PUSH ESI
// 004156ff: CALL core_skeleton.cpp_CDeformableModelInstance_FUN_0059fa20
...
// 0041570b: PUSH EAX
// 0041570c: PUSH EBX
// 0041570d: CALL core_actor.cpp_CDemonActor_FUN_00408ec0
...
// 004157a8: PUSH EAX
// 004157a9: PUSH EBX
// 004157aa: CALL core_actor.cpp_CDemonActor_FUN_00408ec0
//   XREF to: 00408ec0 (UNCONDITIONAL_CALL)
...
// 0041586b: CALL core_actor.cpp_FUN_0040cd10
...
// 004158ba: CALL core_actor.cpp_FUN_0040cd70
...
// 00415916: PUSH EDI
// 00415917: CALL sound_sndmain.cpp_SoundLockKillBlah_FUN_005a9660
...
// 0041592d: PUSH EAX
// 0041592e: CALL sound_sndmain.cpp_SoundLockKillBlah_FUN_005a9660
//   XREF to: 005a9660 (UNCONDITIONAL_CALL)
...
// 00415944: PUSH EDX
// 00415945: CALL sound_sndmain.cpp_SoundLockKillBlah_FUN_005a9660
//   XREF to: 005a9660 (UNCONDITIONAL_CALL)
...
// 00415998: CALL core_actor.cpp_FUN_0040cd70
//   XREF to: 0040cd70 (UNCONDITIONAL_CALL)
...
// 004159ca: PUSH EDX
// 004159cb: CALL sound_sndmain.cpp_SoundLockKillBlah_FUN_005a9660
//   XREF to: 005a9660 (UNCONDITIONAL_CALL)
...
// 004159e1: PUSH ECX
// 004159e2: CALL sound_sndmain.cpp_SoundLockKillBlah_FUN_005a9660
//   XREF to: 005a9660 (UNCONDITIONAL_CALL)
...
// 00415bbe: CALL core_actor.cpp_FUN_0040cd70
//   XREF to: 0040cd70 (UNCONDITIONAL_CALL)
...
// 00415c0f: CALL sound_sndmain.cpp_SoundLockKillBlah_FUN_005a9660
//   XREF to: 005a9660 (UNCONDITIONAL_CALL)
...
// 00415c80: CALL core_actor.cpp_FUN_0040cd70
//   XREF to: 0040cd70 (UNCONDITIONAL_CALL)
...
// 00415cbf: CALL sound_sndmain.cpp_SoundLockKillBlah_FUN_005a9660
//   XREF to: 005a9660 (UNCONDITIONAL_CALL)
...
//   Label: LAB_00415cf5
// 00415cfb: PUSH ECX
// 00415cfc: CALL sound_sndmain.cpp_SoundLockKillBlah_FUN_005a9660
//   XREF to: 005a9660 (UNCONDITIONAL_CALL)
...
//   Label: LAB_00415d29
// 00415d2f: PUSH EDI
// 00415d30: CALL sound_sndmain.cpp_SoundLockKillBlah_FUN_005a9660
//   XREF to: 005a9660 (UNCONDITIONAL_CALL)
