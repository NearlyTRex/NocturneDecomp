...
;                               FUNCTION
; *****************************************************************************
; __cdecl CBatCreature * __cdecl core_batcreat_cpp_CBatCreature_ctor_FUN_004150f0(CBatCreature *this_ptr)
;
; Parameters:
; CBatCreature *   Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_batcreat.cpp_factoryFunc_FUN_004150b0 at 004150ca
;
; Referenced Globals:
