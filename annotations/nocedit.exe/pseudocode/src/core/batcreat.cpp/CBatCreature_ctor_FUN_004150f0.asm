...
section .text
    ...
    PUSH EDX                            ; 004150f5
    CALL core_enemy.cpp_CEnemy_ctor_FUN_004a9500 ; 004150f6 | CEnemy * core_enemy.cpp_CEnemy_ctor_FUN_004a9500(CEnemy * this_ptr)
        ;   XREF to: 004a9500 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004150fb
    PUSH 0x61546b                       ; 004150fe | = "batcreat.dfm" | s_batcreat_dfm_0061546b = batcreat.dfm
    MOV EBX,EAX                         ; 00415103
    ADD EAX,0x158                       ; 00415105
    PUSH EAX                            ; 0041510a
    MOV dword ptr [EAX + -0x4],0x65a5c4 ; 0041510b | CDemonActor_vtable g_CBatCreatureVTable
    CALL core_skeleton.cpp_CDeformableModelInstance_init_FUN_005a0840 ; 00415112 | void core_skeleton.cpp_CDeformableModelInstance_init_FUN_005a0840(CDeformableModelInstance * this_ptr, char * model_name)
