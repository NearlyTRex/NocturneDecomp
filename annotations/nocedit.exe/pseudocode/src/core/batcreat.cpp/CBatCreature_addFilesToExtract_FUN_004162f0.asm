...
section .text
    ...
    PUSH EBX                            ; 004162f0
        ;   Label: core_batcreat.cpp_CBatCreature_addFilesToExtract_FUN_004162f0
    MOV EDX,dword ptr [ESP + 0xc]       ; 004162f1
    PUSH EDX                            ; 004162f5
    MOV ECX,dword ptr [ESP + 0xc]       ; 004162f6
    PUSH ECX                            ; 004162fa
    CALL core_actor.cpp_CDemonActor_addFilesToExtract_FUN_0040cfd0 ; 004162fb
    ...
    PUSH EAX                            ; 00416311
    CALL core_skeledit.cpp_CDeformableModelInstance_addFilesToExtract_FUN_0058a260 ; 00416312
