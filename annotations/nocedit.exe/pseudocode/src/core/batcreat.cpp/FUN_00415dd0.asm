...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_batcreat.cpp_FUN_00415dd0()
;
; Local Variables:
; undefined4       Stack[-0x14]:4  local_14
;
; XREF[1]:
;   core_batcreat.cpp_FUN_00416030 at 004160b6
;
; Referenced Globals:
...
section .text
    ...
    FNSTSW AX                           ; 00415de6
    SAHF                                ; 00415de8
    JNC 0x00415e15                      ; 00415de9 | default
        ;   XREF to: 00415e15 (CONDITIONAL_JUMP)
    CMP dword ptr [ESI],-0x1            ; 00415deb
    JNZ 0x00415e15                      ; 00415dee | default
        ;   XREF to: 00415e15 (CONDITIONAL_JUMP)
    CALL crt_stdlib.c_rand_FUN_005feb5c ; 00415df0 | int crt_stdlib.c_rand_FUN_005feb5c()
    ...
    JA 0x00415e15                       ; 00415e04 | default
        ;   XREF to: 00415e15 (CONDITIONAL_JUMP)
    JMP dword ptr [EDX*0x4 + 0x415db8]  ; 00415e06 | void * switchdataD_00415db8
        ;   Label: switchD
    ...
    JNZ 0x00415ec9                      ; 00415e1f | LAB_00415ec9
    ...
    JNZ 0x00415e3e                      ; 00415e34 | LAB_00415e3e
    ...
    JNZ 0x00415e50                      ; 00415e46 | LAB_00415e50
        ;   XREF to: 00415e50 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x8],0x3ca3d70a ; 00415e48
    MOV EAX,[0x0067b654]                ; 00415e50 | CGame g_CGameInstance | CGame * g_CGamePtr
        ;   Label: LAB_00415e50
    CMP dword ptr [EAX + 0x1e0],0x0     ; 00415e55 | g_CGameInstance.field57_0x1e0
    JZ 0x00415e66                       ; 00415e5c | LAB_00415e66
        ;   XREF to: 00415e66 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x8],0x3f800000 ; 00415e5e
    MOV EAX,[0x0067b654]                ; 00415e66 | CGame g_CGameInstance | CGame * g_CGamePtr
        ;   Label: LAB_00415e66
    MOV EDX,dword ptr [EAX + 0x14]      ; 00415e6b | g_CGameInstance.blood_flag
    TEST EDX,EDX                        ; 00415e6e
    JNZ 0x00415e76                      ; 00415e70 | LAB_00415e76
        ;   XREF to: 00415e76 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x8],EDX       ; 00415e72
    PUSH dword ptr [ESP + 0x8]          ; 00415e76
        ;   Label: LAB_00415e76
    CALL core_actor.cpp_randomChance_FUN_0040cd10 ; 00415e7a | int core_actor.cpp_randomChance_FUN_0040cd10(float probability_threshold)
        ;   XREF to: 0040cd10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00415e7f
    TEST EAX,EAX                        ; 00415e82
    JNZ 0x00415f0d                      ; 00415e84 | LAB_00415f0d
    ...
    PUSH EAX                            ; 00415f24
    CALL core_bodypart.cpp_CreateBodyPart_FUN_00418e10 ; 00415f25 | undefined core_bodypart.cpp_CreateBodyPart_FUN_00418e10()
    ...
    PUSH EDI                            ; 00415f36
    PUSH EBX                            ; 00415f37
    CALL core_charactr.cpp_CCharacter_FUN_0042bd30 ; 00415f38 | void core_charactr.cpp_CCharacter_FUN_0042bd30(CCharacter * this_ptr)
    ...
    JNZ 0x00415f5f                      ; 00415f4a | LAB_00415f5f
    ...
    PUSH EDI                            ; 00415f55
    PUSH EBX                            ; 00415f56
    CALL core_charactr.cpp_CCharacter_FUN_0042bd30 ; 00415f57 | void core_charactr.cpp_CCharacter_FUN_0042bd30(CCharacter * this_ptr)
        ;   XREF to: 0042bd30 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00415f5c
    MOV EDI,dword ptr [EBX + 0xbee4]    ; 00415f5f
        ;   Label: LAB_00415f5f
    CMP EDI,dword ptr [ESI]             ; 00415f65
    JNZ 0x00415f7c                      ; 00415f67 | LAB_00415f7c
    ...
    PUSH EBP                            ; 00415f72
    PUSH EBX                            ; 00415f73
    CALL core_charactr.cpp_CCharacter_FUN_0042bd30 ; 00415f74 | void core_charactr.cpp_CCharacter_FUN_0042bd30(CCharacter * this_ptr)
        ;   XREF to: 0042bd30 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00415f79
    MOV EDX,dword ptr [EBX + 0xbec0]    ; 00415f7c
        ;   Label: LAB_00415f7c
    CMP EDX,dword ptr [ESI]             ; 00415f82
    JNZ 0x00415fe8                      ; 00415f84 | LAB_00415fe8
    ...
    PUSH ECX                            ; 00415f92
    PUSH EBX                            ; 00415f93
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 00415f94 | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
    ...
    PUSH EAX                            ; 00415fa5
    PUSH EBX                            ; 00415fa6
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 00415fa7 | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDX                            ; 00415fb8
    PUSH EBX                            ; 00415fb9
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 00415fba | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ...
    PUSH ECX                            ; 00415fcb
    PUSH EBX                            ; 00415fcc
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 00415fcd | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDI                            ; 00415fde
    PUSH EBX                            ; 00415fdf
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 00415fe0 | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00415fe5
    PUSH 0x61567e                       ; 00415fe8 | = "limb?.wav" | s_limb_wav_0061567e = limb?.wav
        ;   Label: LAB_00415fe8
    PUSH EBX                            ; 00415fed
    CALL core_charactr.cpp_CCharacter_FUN_0042f300 ; 00415fee | void core_charactr.cpp_CCharacter_FUN_0042f300(CCharacter * this_ptr)
        ;   XREF to: 0042f300 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00415ff3
    PUSH EBP                            ; 00415ff6
    CALL core_bodypart.cpp_FUN_0041a050 ; 00415ff7 | undefined core_bodypart.cpp_FUN_0041a050()
