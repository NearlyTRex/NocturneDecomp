// Name: core_batcreat.cpp_CBatCreature_processDamage_FUN_00416030
// Address: 00416030
...

{
  ...
  sound_sndmain_cpp_killSfx_FUN_005a9c40(*(uint *)(this_ptr->unk + 0x48));
  sound_sndmain_cpp_killSfx_FUN_005a9c40(*(uint *)(this_ptr->unk + 0x40));
  ...
  if (fVar1 <= 0.0) {
    ...
    if ((pSVar3->state_index != 7) && (pSVar3->state_index != 8)) {
      ...
      sound_sndmain_cpp_killSfx_FUN_005a9c40(*(uint *)(this_ptr->unk + 0x44));
      uVar4 = (*((this_ptr->base).base.base.vtable._ub)->playSound)
                        ((CDemonActor *)this_ptr,"batman-die.wav");
      *(uint *)(this_ptr->unk + 0x44) = uVar4;
    ...
    iVar2 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660(*(uint *)(this_ptr->unk + 0x44));
    if (iVar2 == 0) {
      uVar4 = (*((this_ptr->base).base.base.vtable._ub)->playSound)
