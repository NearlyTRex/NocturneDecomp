// Name: core_glass.cpp_CGlass_FUN_004e9930
// Address: 004e9930
// Address Range: [[004e9930, 004e9ae4]]
// Convention: __cdecl
// Signature: int core_glass.cpp_CGlass_FUN_004e9930(CGlass * this_ptr)
// Globals:
...
int __cdecl core_glass_cpp_CGlass_FUN_004e9930(CGlass *this_ptr)

{
  ...
  if ((((this_ptr->background_flag == 0) && ((this_ptr->base_actor).is_transparent == 0)) &&
    ...
    this_ptr_01 = (*((this_ptr->base_actor).metadata.vtable)->getBoundingBox)
                            (&this_ptr->base_actor,(CBoundingBox3D *)&fStack_20);
    iStack00000010 = core_box_cpp_CBoundingBox3D_isVisible_FUN_004204f0(this_ptr_01);
    engine_drender_cpp_CDemonRenderer_captureTexture_FUN_0048db80
              (g_CDemonRendererPtr,(SMRGLTextureBasic *)this_ptr->field2_0x164);
    pCVar4 = this_ptr->broken_vertices;
    pcVar3 = this_ptr->field14_0x4b8;
    iVar2 = 0;
    if (0 < *(int *)(this_ptr->field14_0x4b8 + 0x67c)) {
      do {
        ...
        *(int *)(pcVar3 + 8) = (int)ROUND(pCVar4->z * FLOAT_0065eed0);
        ...
        pCVar4 = pCVar4 + 1;
        pcVar3 = pcVar3 + 0xc;
      } while (iVar2 < *(int *)(this_ptr->field14_0x4b8 + 0x67c));
    }
    core_set_cpp_CDemonSet_rotateVertices_FUN_0056e7c0
              (g_CDemonSetPtr,*(int *)(this_ptr->field14_0x4b8 + 0x67c));
    ...
    polygon_info = (SMRGLHeaderPrimitive *)(this_ptr->field14_0x4b8 + 500);
    iVar2 = 0;
    fStack_20 = 7.218582e-39;
    core_set_cpp_CDemonSet_lightVerticies_FUN_0056eac0(g_CDemonSetPtr);
    pCVar5 = this_ptr;
    if (0 < *(int *)(this_ptr->field14_0x4b8 + 0x680)) {
      do {
        this_ptr_00 = g_CDemonRendererPtr;
        pCVar5->field14_0x4b8[0x1fc] = '\0';
        pCVar5->field14_0x4b8[0x1fd] = '\0';
        pCVar5->field14_0x4b8[0x1fe] = '\0';
        pCVar5->field14_0x4b8[0x1ff] = '\0';
        pCVar5->field14_0x4b8[0x200] = '\0';
        pCVar5->field14_0x4b8[0x201] = '\0';
        pCVar5->field14_0x4b8[0x202] = '\0';
        pCVar5->field14_0x4b8[0x203] = '\0';
        iVar2 = iVar2 + 1;
        pCVar5->field14_0x4b8[0x204] = '\0';
        pCVar5->field14_0x4b8[0x205] = '\0';
        pCVar5->field14_0x4b8[0x206] = '\0';
        pCVar5->field14_0x4b8[0x207] = '\0';
        pCVar5->field14_0x4b8[0x208] = '\0';
        pCVar5->field14_0x4b8[0x209] = '\0';
        pCVar5->field14_0x4b8[0x20a] = '\0';
        pCVar5->field14_0x4b8[0x20b] = '\0';
        ...
        pCVar5 = (CGlass *)((pCVar5->base_actor).orient_matrix.m + 1);
      } while (iVar2 < *(int *)(this_ptr->field14_0x4b8 + 0x680));
    }
...
// Assembly code:
// 004e9930: PUSH ESI
//   Label: core_glass.cpp_CGlass_FUN_004e9930
// 004e9931: PUSH EDI
// 004e9932: PUSH EBP
