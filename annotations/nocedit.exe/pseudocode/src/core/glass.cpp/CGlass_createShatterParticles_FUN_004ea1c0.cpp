...

{
  ...
  if (((subdivision_level < 3) ||
    ...
    if (&local_1e4 != quad_vertices) {
      local_1e4.vertices[0].x = quad_vertices->vertices[0].x;
      local_1e4.vertices[0].y = quad_vertices->vertices[0].y;
    ...
    if (local_1e4.vertices + 1 != quad_vertices->vertices + 1) {
      local_1e4.vertices[1].x = quad_vertices->vertices[1].x;
      local_1e4.vertices[1].y = quad_vertices->vertices[1].y;
    ...
    if (local_1e4.vertices + 2 != quad_vertices->vertices + 2) {
      local_1e4.vertices[2].x = quad_vertices->vertices[2].x;
      local_1e4.vertices[2].y = quad_vertices->vertices[2].y;
    ...
    if (local_1e4.vertices + 3 != quad_vertices->vertices + 3) {
      local_1e4.vertices[3].x = quad_vertices->vertices[3].x;
      local_1e4.vertices[3].y = quad_vertices->vertices[3].y;
  ...
  if (local_1e4.vertices + 1 != quad_vertices->vertices + 2) {
    ...
    local_1e4.vertices[1].z = quad_vertices->vertices[2].z;
  }
  if (local_1e4.vertices + 2 != quad_vertices->vertices + 3) {
    local_1e4.vertices[2].x = quad_vertices->vertices[3].x;
    local_1e4.vertices[2].y = quad_vertices->vertices[3].y;
    local_1e4.vertices[2].z = quad_vertices->vertices[3].z;
  }
