...
//   core_crossbow.cpp_CCrossbow_FUN_00448f20 (00448f20) at 004494e5 [UNCONDITIONAL_CALL]
...

{
  ...
  if (this_ptr->shattered == 0) {
    ...
    local_14 = (this_ptr->glass_size).x * (float)DOUBLE_0062e109;
...
// 004eb190: PUSH EAX
// 004eb191: PUSH EBX
// 004eb192: CALL core_glass.cpp_CGlass_createShatterParticles_FUN_004ea1c0
