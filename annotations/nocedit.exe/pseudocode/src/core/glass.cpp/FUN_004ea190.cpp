// Name: core_glass.cpp_FUN_004ea190
// Address: 004ea190
// Address Range: [[004ea190, 004ea1b8]]
// Convention: unknown
// Signature: undefined core_glass.cpp_FUN_004ea190()

#include "nocturne.h"

undefined4 core_glass_cpp_FUN_004ea190(void)

{
  int in_stack_00000004;
  
  if ((*(int *)(in_stack_00000004 + 0x180) != 0) && (*(int *)(in_stack_00000004 + 0x1e8) == 0)) {
    *(undefined4 *)(in_stack_00000004 + 0x100) = 1;
    return 0;
  }
  return 1;
}
...
//   Label: core_glass.cpp_FUN_004ea190
