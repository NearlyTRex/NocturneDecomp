...
section .text
    ...
    PUSH 0x1d                           ; 004eb49d
    MOV EAX,[0x0067cf44]                ; 004eb49f | CKeys * g_CKeysPtr
    PUSH EAX                            ; 004eb4a4 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004eb4a5 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 004eb4a7
    ADD ESP,0x8                         ; 004eb4a9
    TEST EAX,EAX                        ; 004eb4ac
    JZ 0x004eb5e0                       ; 004eb4ae | LAB_004eb5e0
        ;   XREF to: 004eb5e0 (CONDITIONAL_JUMP)
    MOV EAX,[0x0067b654]                ; 004eb4b4 | CGame * g_CGamePtr
    PUSH 0x38                           ; 004eb4b9
    FLD float ptr [EAX + 0x264]         ; 004eb4bb | g_CGameInstance.delta_time_float
    MOV EAX,[0x0067cf44]                ; 004eb4c1 | CKeys * g_CKeysPtr
    FMUL double ptr [0x0062e191]        ; 004eb4c6 | double DOUBLE_0062e191
    PUSH EAX                            ; 004eb4cc | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004eb4cd | void * g_CKeysPtr
    FSTP float ptr [ESP + 0x8]          ; 004eb4cf
    CALL dword ptr [EDX]                ; 004eb4d3
    ADD ESP,0x8                         ; 004eb4d5
    TEST EAX,EAX                        ; 004eb4d8
    JZ 0x004eb4e8                       ; 004eb4da | LAB_004eb4e8
        ;   XREF to: 004eb4e8 (CONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 004eb4dc
    FMUL double ptr [0x0062e199]        ; 004eb4df | double DOUBLE_0062e199
    FSTP float ptr [ESP]                ; 004eb4e5
    PUSH 0x2a                           ; 004eb4e8
        ;   Label: LAB_004eb4e8
    MOV EAX,[0x0067cf44]                ; 004eb4ea | CKeys * g_CKeysPtr
    PUSH EAX                            ; 004eb4ef | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004eb4f0 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 004eb4f2
    ADD ESP,0x8                         ; 004eb4f4
    TEST EAX,EAX                        ; 004eb4f7
    JZ 0x004eb50b                       ; 004eb4f9 | LAB_004eb50b
        ;   XREF to: 004eb50b (CONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 004eb4fb
    FLD ST0                             ; 004eb4fe
    FMUL double ptr [0x0062e1a1]        ; 004eb500 | double DOUBLE_0062e1a1
    FSTP ST1                            ; 004eb506
    FSTP float ptr [ESP]                ; 004eb508
    PUSH 0x4b                           ; 004eb50b
        ;   Label: LAB_004eb50b
    MOV EAX,[0x0067cf44]                ; 004eb50d | CKeys * g_CKeysPtr
    PUSH EAX                            ; 004eb512 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004eb513 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 004eb515
    ADD ESP,0x8                         ; 004eb517
    TEST EAX,EAX                        ; 004eb51a
    JZ 0x004eb52d                       ; 004eb51c | LAB_004eb52d
    ...
    PUSH 0x4d                           ; 004eb52d
        ;   Label: LAB_004eb52d
    MOV EAX,[0x0067cf44]                ; 004eb52f | CKeys * g_CKeysPtr
    PUSH EAX                            ; 004eb534 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004eb535 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 004eb537
    ADD ESP,0x8                         ; 004eb539
    TEST EAX,EAX                        ; 004eb53c
    JZ 0x004eb54f                       ; 004eb53e | LAB_004eb54f
    ...
    PUSH 0x50                           ; 004eb54f
        ;   Label: LAB_004eb54f
    MOV EAX,[0x0067cf44]                ; 004eb551 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 004eb556 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004eb557 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 004eb559
    ADD ESP,0x8                         ; 004eb55b
    TEST EAX,EAX                        ; 004eb55e
    JZ 0x004eb571                       ; 004eb560 | LAB_004eb571
    ...
    PUSH 0x48                           ; 004eb571
        ;   Label: LAB_004eb571
    MOV EAX,[0x0067cf44]                ; 004eb573 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 004eb578 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004eb579 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 004eb57b
    ADD ESP,0x8                         ; 004eb57d
    TEST EAX,EAX                        ; 004eb580
    JZ 0x004eb593                       ; 004eb582 | LAB_004eb593
    ...
    JGE 0x004eb5ac                      ; 004eb5a4 | LAB_004eb5ac
    ...
    FNSTSW AX                           ; 004eb5b6
    SAHF                                ; 004eb5b8
    JNC 0x004eb5c5                      ; 004eb5b9 | LAB_004eb5c5
    ...
    PUSH EBX                            ; 004eb5e0
        ;   Label: LAB_004eb5e0
    CALL core_actor.cpp_CDemonActor_processInEditor_FUN_0040d040 ; 004eb5e1 | void core_actor.cpp_CDemonActor_processInEditor_FUN_0040d040(CDemonActor * this_ptr)
