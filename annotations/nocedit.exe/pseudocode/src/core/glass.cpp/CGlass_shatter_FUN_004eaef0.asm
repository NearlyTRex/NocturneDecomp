...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_glass.cpp_CGlass_shatter_FUN_004eaef0(CGlass * this_ptr, CVector3f * location)
;
; Parameters:
...
;   core_gun.cpp_FUN_004f0350 at 004f0a57
;   core_hiram.cpp_FUN_004f4550 at 004f4644
...
section .text
    ...
    JNZ 0x004eb1b6                      ; 004eaf08 | LAB_004eb1b6
    ...
    JNZ 0x004eb1c1                      ; 004eaf20 | LAB_004eb1c1
        ;   XREF to: 004eb1c1 (CONDITIONAL_JUMP)
    PUSH 0x6598c0                       ; 004eaf26 | WatcomTypeInfo g_CVectorTypeInfo
        ;   Label: LAB_004eaf26
    PUSH 0x4                            ; 004eaf2b
    LEA EAX,[ESP + 0x8]                 ; 004eaf2d
    PUSH EAX                            ; 004eaf31
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 004eaf32 | void * crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
        ;   XREF to: 005fe667 (UNCONDITIONAL_CALL)
    FLD float ptr [EBX + 0x158]         ; 004eaf37
    FMUL double ptr [0x0062e109]        ; 004eaf3d | double DOUBLE_0062e109
    ...
    CALL core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0 ; 004eaf71 | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0(CMatrix3x3f * this_ptr, CVector3f * output, CVector3f * input)
    ...
    JZ 0x004eafce                       ; 004eafac | LAB_004eafce
    ...
    CALL core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0 ; 004eaff3 | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0(CMatrix3x3f * this_ptr, CVector3f * output, CVector3f * input)
        ;   XREF to: 00471fd0 (UNCONDITIONAL_CALL)
    ...
    JZ 0x004eb03e                       ; 004eb024 | LAB_004eb03e
    ...
    PUSH EAX                            ; 004eb056
    CALL core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0 ; 004eb057 | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0(CMatrix3x3f * this_ptr, CVector3f * output, CVector3f * input)
        ;   XREF to: 00471fd0 (UNCONDITIONAL_CALL)
    ...
    JZ 0x004eb0b7                       ; 004eb094 | LAB_004eb0b7
    ...
    PUSH EAX                            ; 004eb0d0
    CALL core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0 ; 004eb0d1 | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0(CMatrix3x3f * this_ptr, CVector3f * output, CVector3f * input)
        ;   XREF to: 00471fd0 (UNCONDITIONAL_CALL)
    ...
    JZ 0x004eb131                       ; 004eb10e | LAB_004eb131
    ...
    LEA EAX,[EBX + 0x164]               ; 004eb131
        ;   Label: LAB_004eb131
    PUSH EAX                            ; 004eb137
    MOV EDX,dword ptr [0x006703ec]      ; 004eb138 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH EDX                            ; 004eb13e | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80 ; 004eb13f | void engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80(CDemonRenderer * this_ptr, SMRGLTextureBasic * texture)
        ;   XREF to: 0048db80 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [0x006793a4]      ; 004eb144 | int g_CurrentTextureDimension
    ADD ESP,0x8                         ; 004eb14a
    CMP ECX,0x40                        ; 004eb14d
    JNZ 0x004eb204                      ; 004eb150 | LAB_004eb204
    ...
    PUSH EAX                            ; 004eb190
    PUSH EBX                            ; 004eb191
    CALL core_glass.cpp_CGlass_createShatterParticles_FUN_004ea1c0 ; 004eb192 | void core_glass.cpp_CGlass_createShatterParticles_FUN_004ea1c0(CGlass * this_ptr, SQuadVertices * quad_vertices, CVector4i * quad_uv_u, CVector4i * quad_uv_v, ...)
        ;   XREF to: 004ea1c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 004eb197
    PUSH 0x62e0f4                       ; 004eb19a | = "glass-1.wav@2.0" | s_glass_1_wav_2_0_0062e0f4 = glass-1.wav@2.0
    ...
    JNZ 0x004eb233                      ; 004eb1b4 | LAB_004eb233
    ...
    POP EBX                             ; 004eb1bf
    RET                                 ; 004eb1c0
    MOV ESI,0x62e0e9                    ; 004eb1c1 | = "7YEARS.RAW" | s_s_7YEARS_RAW_0062e0e9 = 7YEARS.RAW
        ;   Label: LAB_004eb1c1
    LEA EDI,[EBX + 0x16c]               ; 004eb1c6
    MOV dword ptr [EBX + 0x17c],0xffff  ; 004eb1cc
    PUSH EDI                            ; 004eb1d6
    MOV AL,byte ptr [ESI]               ; 004eb1d7 | = "7YEARS.RAW" | s_s_7YEARS_RAW_0062e0e9 = 7YEARS.RAW
        ;   Label: LAB_004eb1d7
    MOV byte ptr [EDI],AL               ; 004eb1d9
    CMP AL,0x0                          ; 004eb1db
    JZ 0x004eb1ef                       ; 004eb1dd | LAB_004eb1ef
        ;   XREF to: 004eb1ef (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 004eb1df | s_YEARS.RAW_0062e0ea
    ADD ESI,0x2                         ; 004eb1e2
    MOV byte ptr [EDI + 0x1],AL         ; 004eb1e5
    ADD EDI,0x2                         ; 004eb1e8
    CMP AL,0x0                          ; 004eb1eb
    JNZ 0x004eb1d7                      ; 004eb1ed | LAB_004eb1d7
        ;   XREF to: 004eb1d7 (CONDITIONAL_JUMP)
    POP EDI                             ; 004eb1ef
        ;   Label: LAB_004eb1ef
    MOV ESI,dword ptr [0x006810c8]      ; 004eb1f0 | CDemonSet * g_CDemonSetPtr
    PUSH ESI                            ; 004eb1f6 | CDemonSet g_CDemonSetInstance
    CALL core_set.cpp_CDemonSet_FUN_00570c60 ; 004eb1f7 | void core_set.cpp_CDemonSet_FUN_00570c60(CDemonSet * this_ptr)
        ;   XREF to: 00570c60 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004eb1fc
    JMP 0x004eaf26                      ; 004eb1ff | LAB_004eaf26
    ...
    JMP 0x004eb180                      ; 004eb22e | LAB_004eb180
