...
;                               FUNCTION
; *****************************************************************************
; __cdecl CBoundingBox3D * __cdecl core_glass_cpp_CGlass_getBoundingBox_FUN_004ea030(CGlass *this_ptr,CBoundingBox3D *out_box)
;
; Parameters:
...
section .text
    ...
    FCHS                                ; 004ea03e
    FLD double ptr [0x0062e059]         ; 004ea040 | DOUBLE_0062e059
    FXCH                                ; 004ea046
    FMUL ST1                            ; 004ea048
    ...
    FADD double ptr [0x0062e061]        ; 004ea071 | DOUBLE_0062e061
