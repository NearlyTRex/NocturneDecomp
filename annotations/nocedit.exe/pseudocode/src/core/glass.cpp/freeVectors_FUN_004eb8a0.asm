...
section .text
    ...
    PUSH 0x6598c0                       ; 004eb8a0 | WatcomTypeInfo g_CVectorTypeInfo
        ;   Label: core_glass.cpp_freeVectors_FUN_004eb8a0
    PUSH 0x19                           ; 004eb8a5
    MOV EDX,dword ptr [ESP + 0xc]       ; 004eb8a7
    PUSH EDX                            ; 004eb8ab
    CALL crt_memory.c_freeTypeArray_FUN_005feee9 ; 004eb8ac | int crt_memory.c_freeTypeArray_FUN_005feee9(void * * obj_array, int obj_count, WatcomTypeInfo * type_info)
