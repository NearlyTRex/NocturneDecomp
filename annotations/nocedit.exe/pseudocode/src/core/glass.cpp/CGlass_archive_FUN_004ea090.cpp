// Name: core_glass.cpp_CGlass_archive_FUN_004ea090
// Address: 004ea090
// Address Range: [[004ea090, 004ea18d]]
// Convention: __cdecl
// Signature: void __cdecl core_glass_cpp_CGlass_archive_FUN_004ea090(CGlass *this_ptr)
...

{
  ...
  core_actor_cpp_archiveVector_FUN_0040b340(&this_ptr->glass_size,"glassSize");
  ...
  if (2 < g_CGlassClassVersion) {
    core_actor_cpp_archiveInteger_FUN_0040b7f0(&this_ptr->shattered,"shattered");
    core_actor_cpp_archiveString_FUN_0040b5c0(this_ptr->break_event,"breakEvent");
  }
  if (3 < g_CGlassClassVersion) {
    core_actor_cpp_archiveInteger_FUN_0040b7f0(&this_ptr->mirror_flag,"mirrorFlag");
  }
  ...
  core_actor_cpp_archiveInteger_FUN_0040b7f0(&this_ptr->background_flag,"backgroundFlag");
  core_actor_cpp_archiveString_FUN_0040b5c0
