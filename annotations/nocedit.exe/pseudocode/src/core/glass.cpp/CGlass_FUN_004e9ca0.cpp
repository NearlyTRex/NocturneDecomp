// Name: core_glass.cpp_CGlass_FUN_004e9ca0
// Address: 004e9ca0
// Address Range: [[004e9ca0, 004e9e88]]
// Convention: __cdecl
// Signature: void core_glass.cpp_CGlass_FUN_004e9ca0(CGlass * this_ptr)
// Cross-references:
//   core_glass.cpp_FUN_004e9e90 (004e9e90) at 004ea01a [UNCONDITIONAL_CALL]
...
void __cdecl core_glass_cpp_CGlass_FUN_004e9ca0(CGlass *this_ptr)

{
  ...
  this_ptr_00 = (*((in_stack_00000008->metadata).vtable)->getBoundingBox)
  ...
  if (0 < *(int *)in_stack_0000002c[8].create_event) {
    polygon_info = (SMRGLHeaderPrimitive *)&in_stack_0000002c[4].metadata.next_actor;
    pCVar4 = in_stack_0000002c;
    do {
      pCVar4[4].metadata.vtable = (CDemonActor_vtable *)0x0;
...
// Assembly code:
// 004e9ca0: PUSH EBP
//   Label: core_glass.cpp_CGlass_FUN_004e9ca0
