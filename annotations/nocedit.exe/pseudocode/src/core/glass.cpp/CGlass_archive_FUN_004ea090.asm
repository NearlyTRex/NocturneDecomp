...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_glass_cpp_CGlass_archive_FUN_004ea090(CGlass *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004ea090
        ;   Label: core_glass.cpp_CGlass_archive_FUN_004ea090
    MOV EBX,dword ptr [ESP + 0x8]       ; 004ea091
    PUSH EBX                            ; 004ea095
    CALL core_actor.cpp_CDemonActor_archive_FUN_0040c1c0 ; 004ea096
    ...
    PUSH EAX                            ; 004ea0a9
    CALL core_actor.cpp_archiveVector_FUN_0040b340 ; 004ea0aa
    ...
    PUSH EAX                            ; 004ea0bd
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 004ea0be
    ...
    PUSH EAX                            ; 004ea0e9
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 004ea0ea
    ...
    PUSH EAX                            ; 004ea0fd
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 004ea0fe
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveString_FUN_0040b5c0(char * string_buffer, char * property_type)
    ...
    PUSH EAX                            ; 004ea11a
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 004ea11b
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    PUSH EAX                            ; 004ea137
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 004ea138
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveString_FUN_0040b5c0(char * string_buffer, char * property_type)
    ...
    PUSH EAX                            ; 004ea156
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 004ea157
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    PUSH EAX                            ; 004ea16f
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 004ea170
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ADD ESP,0x8                         ; 004ea175
    PUSH 0x62e0ca                       ; 004ea178 | = "brokenTexture"
    ADD EBX,0x37c                       ; 004ea17d
    PUSH EBX                            ; 004ea183
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 004ea184
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveString_FUN_0040b5c0(char * string_buffer, char * property_type)
