...

{
  ...
  if (this_ptr->mirror_flag != 0) {
    ...
    pCVar5 = core_dirmat_cpp_CMatrix3x3f_transformVector_FUN_00471fd0
                       (&(this_ptr->base).orient_matrix,(CVector3f *)(local_a8 + 8),
                        (CVector3f *)local_7c);
    local_6c = (this_ptr->base).location.position.x + pCVar5->x;
    fStack_68 = (this_ptr->base).location.position.y + pCVar5->y;
    fStack_64 = (this_ptr->base).location.position.z + pCVar5->z;
    ...
    local_30.y = (this_ptr->base).location.position.x + pCVar5->x;
    local_30.z = (this_ptr->base).location.position.y + pCVar5->y;
    local_24 = (this_ptr->base).location.position.z + pCVar5->z;
    ...
    if (&local_ac != (float *)&stack0xffffff48) {
      local_ac = (this_ptr->base).location.position.x + pCVar5->x;
      local_a8._0_4_ = (this_ptr->base).location.position.y + pCVar5->y;
      local_a8._4_4_ = (this_ptr->base).location.position.z + pCVar5->z;
    }
    local_74._4_4_ = local_74._4_4_ ^ 0x80000000;
    pCVar5 = core_dirmat_cpp_CMatrix3x3f_transformVector_FUN_00471fd0
                       (&(this_ptr->base).orient_matrix,&local_88,(CVector3f *)(local_74 + 4));
    local_7c._4_4_ = (this_ptr->base).location.position.x + pCVar5->x;
    local_74._0_4_ = (this_ptr->base).location.position.y + pCVar5->y;
    local_74._4_4_ = (this_ptr->base).location.position.z + pCVar5->z;
  ...
  for (iVar3 = 0; iVar3 < this_ptr->field15_0xb30 + 1; iVar3 = iVar3 + 1) {
    ...
    pCVar5 = local_14 + iVar9;
    for (iVar7 = 0; iVar7 < this_ptr->field14_0xb2c + 1; iVar7 = iVar7 + 1) {
      if (pCVar5 != (CVector3f *)&stack0xffffff3c) {
        pCVar5->x = fVar14;
        pCVar5->y = fVar15;
        pCVar5->z = fVar16;
      }
      ...
      dVar13 = crt_math_c_round_FUN_005fe6b0
                         ((double)(((float10)iVar7 / (float10)this_ptr->field14_0xb2c) * fVar11 +
                                  fVar12));
      *(int *)(extraout_ECX + 0x5e4) = (int)ROUND(dVar13);
      dVar13 = crt_math_c_round_FUN_005fe6b0
                         ((double)(fVar12 + ((float10)(this_ptr->field15_0xb30 - (int)fVar2) /
                                            (float10)this_ptr->field15_0xb30) * fVar11));
      pCVar5 = (CVector3f *)(extraout_EDX + 0xc);
      *(int *)(extraout_ECX_00 + 0x644) = (int)ROUND(dVar13);
      iVar9 = iVar9 + 1;
      fVar14 = fVar14 + fVar2;
    }
  ...
  if (0 < this_ptr->field15_0xb30) {
    ...
    do {
      ...
      if (0 < this_ptr->field14_0xb2c) {
        pSVar4 = local_18 + iVar9;
        do {
          (pSVar4->base).base.count = 4;
          (pSVar4->base).surface_normal.D = 0;
          iVar6 = (pSVar4->base).surface_normal.D;
          (pSVar4->base).surface_normal.C = iVar6;
          (pSVar4->base).surface_normal.B = iVar6;
          (pSVar4->base).surface_normal.A = iVar6;
          iVar6 = (this_ptr->field14_0xb2c + 1) * iVar3 + iVar7;
          pSVar4->vertices[0].vertex_index = iVar6;
          pSVar4->vertices[0].texture_u = *(int *)(this_ptr->field12_0x4b8 + iVar6 * 4 + 300);
          pSVar4->vertices[0].texture_v =
               *(int *)((int)this_ptr->broken_quads[0].vertices + iVar6 * 4 + -0x7c);
          pSVar4->vertices[1].vertex_index = iVar6 + 1;
          pSVar4->vertices[1].texture_u = *(int *)(this_ptr->field12_0x4b8 + iVar6 * 4 + 0x130);
          pSVar4->vertices[1].texture_v =
               *(int *)((int)(this_ptr->broken_quads[0].vertices + -10) + iVar6 * 4);
          pSVar4->vertices[2].vertex_index = this_ptr->field14_0xb2c + iVar6 + 2;
          ...
          pSVar4->vertices[3].vertex_index = this_ptr->field14_0xb2c + iVar6 + 1;
