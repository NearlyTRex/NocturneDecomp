...
;                               FUNCTION
; *****************************************************************************
; __cdecl CGlass * core_glass.cpp_CGlass_ctor_FUN_004e9040(CGlass * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 004e9046
    CALL core_actor.cpp_CDemonActor_ctor_FUN_004088b0 ; 004e9047 | CDemonActor * core_actor.cpp_CDemonActor_ctor_FUN_004088b0(CDemonActor * this_ptr)
        ;   XREF to: 004088b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004e904c
    ADD EAX,0x1ec                       ; 004e904f
    PUSH EAX                            ; 004e9054
    CALL core_mirror.cpp_CMirror_ctor_FUN_005213c0 ; 004e9055 | CMirror * core_mirror.cpp_CMirror_ctor_FUN_005213c0(CMirror * this_ptr)
        ;   XREF to: 005213c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004e905a
    PUSH 0x6598c0                       ; 004e905d | WatcomTypeInfo g_CVectorTypeInfo
    PUSH 0x19                           ; 004e9062
    ADD EAX,0x1a0                       ; 004e9064
    PUSH EAX                            ; 004e9069
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 004e906a | void * crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
        ;   XREF to: 005fe667 (UNCONDITIONAL_CALL)
    LEA EDX,[EAX + 0xfffffc74]          ; 004e906f
    MOV dword ptr [EDX + 0x154],0x65eef4 ; 004e9075 | CDemonActor_vtable g_CGlassVTable
    MOV ESI,0x62df62                    ; 004e907f | = "HEADLITE.RAW" | s_HEADLITE_RAW_0062df62 = HEADLITE.RAW
    ...
    PUSH EDI                            ; 004e90ab
    MOV AL,byte ptr [ESI]               ; 004e90ac | = "HEADLITE.RAW" | s_HEADLITE_RAW_0062df62 = HEADLITE.RAW
        ;   Label: LAB_004e90ac
    MOV byte ptr [EDI],AL               ; 004e90ae
    CMP AL,0x0                          ; 004e90b0
    JZ 0x004e90c4                       ; 004e90b2 | LAB_004e90c4
        ;   XREF to: 004e90c4 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 004e90b4 | s_EADLITE.RAW_0062df63
    ADD ESI,0x2                         ; 004e90b7
    MOV byte ptr [EDI + 0x1],AL         ; 004e90ba
    ADD EDI,0x2                         ; 004e90bd
    CMP AL,0x0                          ; 004e90c0
    JNZ 0x004e90ac                      ; 004e90c2 | LAB_004e90ac
    ...
    MOV ESI,0x62df6f                    ; 004e90ed | = "true" | s_true_0062df6f = true
    MOV byte ptr [EDX + 0x184],0x0      ; 004e90f2
    LEA EDI,[EDX + 0x30c]               ; 004e90f9
    MOV dword ptr [EDX + 0x1e8],0x0     ; 004e90ff
    PUSH EDI                            ; 004e9109
    MOV AL,byte ptr [ESI]               ; 004e910a | = "true" | s_true_0062df6f = true
        ;   Label: LAB_004e910a
    MOV byte ptr [EDI],AL               ; 004e910c
    CMP AL,0x0                          ; 004e910e
    JZ 0x004e9122                       ; 004e9110 | LAB_004e9122
        ;   XREF to: 004e9122 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 004e9112 | s_rue_0062df70
    ADD ESI,0x2                         ; 004e9115
    MOV byte ptr [EDI + 0x1],AL         ; 004e9118
    ADD EDI,0x2                         ; 004e911b
    CMP AL,0x0                          ; 004e911e
    JNZ 0x004e910a                      ; 004e9120 | LAB_004e910a
        ;   XREF to: 004e910a (CONDITIONAL_JUMP)
    POP EDI                             ; 004e9122
        ;   Label: LAB_004e9122
    MOV ESI,0x62df74                    ; 004e9123 | = "7YEARS.RAW" | s_s_7YEARS_RAW_0062df74 = 7YEARS.RAW
    LEA EDI,[EDX + 0x37c]               ; 004e9128
    MOV dword ptr [EDX + 0x370],0x0     ; 004e912e
    PUSH EDI                            ; 004e9138
    MOV AL,byte ptr [ESI]               ; 004e9139 | = "7YEARS.RAW" | s_s_7YEARS_RAW_0062df74 = 7YEARS.RAW
        ;   Label: LAB_004e9139
    MOV byte ptr [EDI],AL               ; 004e913b
    CMP AL,0x0                          ; 004e913d
    JZ 0x004e9151                       ; 004e913f | LAB_004e9151
        ;   XREF to: 004e9151 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 004e9141 | s_YEARS.RAW_0062df75
    ADD ESI,0x2                         ; 004e9144
    MOV byte ptr [EDI + 0x1],AL         ; 004e9147
    ADD EDI,0x2                         ; 004e914a
    CMP AL,0x0                          ; 004e914d
    JNZ 0x004e9139                      ; 004e914f | LAB_004e9139
