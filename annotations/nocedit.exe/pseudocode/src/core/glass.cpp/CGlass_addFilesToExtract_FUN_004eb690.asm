...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_glass_cpp_CGlass_addFilesToExtract_FUN_004eb690(CGlass *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004eb690
        ;   Label: core_glass.cpp_CGlass_addFilesToExtract_FUN_004eb690
    PUSH ESI                            ; 004eb691
    PUSH EDI                            ; 004eb692
    PUSH EBP                            ; 004eb693
    ...
    CMP AL,0x0                          ; 004eb6c6
    JZ 0x004eb6da                       ; 004eb6c8
        ;   XREF to: 004eb6da (CONDITIONAL_JUMP)  ; LAB_004eb6da
    MOV AL,byte ptr [ESI + 0x1]         ; 004eb6ca
    ADD ESI,0x2                         ; 004eb6cd
    MOV byte ptr [EDI + 0x1],AL         ; 004eb6d0
    ADD EDI,0x2                         ; 004eb6d3
    CMP AL,0x0                          ; 004eb6d6
    JNZ 0x004eb6c2                      ; 004eb6d8
        ;   XREF to: 004eb6c2 (CONDITIONAL_JUMP)  ; LAB_004eb6c2
    POP EDI                             ; 004eb6da
        ;   Label: LAB_004eb6da
    ...
    MOV AL,byte ptr [ESI]               ; 004eb6dd
        ;   Label: LAB_004eb6dd
    CMP AL,DL                           ; 004eb6df
    JZ 0x004eb6f5                       ; 004eb6e1
        ;   XREF to: 004eb6f5 (CONDITIONAL_JUMP)  ; LAB_004eb6f5
    CMP AL,0x0                          ; 004eb6e3
    JZ 0x004eb6f3                       ; 004eb6e5
        ;   XREF to: 004eb6f3 (CONDITIONAL_JUMP)  ; LAB_004eb6f3
    INC ESI                             ; 004eb6e7
    MOV AL,byte ptr [ESI]               ; 004eb6e8
    CMP AL,DL                           ; 004eb6ea
    JZ 0x004eb6f5                       ; 004eb6ec
        ;   XREF to: 004eb6f5 (CONDITIONAL_JUMP)  ; LAB_004eb6f5
    INC ESI                             ; 004eb6ee
    CMP AL,0x0                          ; 004eb6ef
    JNZ 0x004eb6dd                      ; 004eb6f1
        ;   XREF to: 004eb6dd (CONDITIONAL_JUMP)  ; LAB_004eb6dd
    SUB ESI,ESI                         ; 004eb6f3
        ;   Label: LAB_004eb6f3
    MOV EDI,ESI                         ; 004eb6f5
        ;   Label: LAB_004eb6f5
    TEST ESI,ESI                        ; 004eb6f7
    JNZ 0x004eb71e                      ; 004eb6f9
        ;   XREF to: 004eb71e (CONDITIONAL_JUMP)  ; LAB_004eb71e
    MOV EDX,0x62e254                    ; 004eb6fb | = "..\\core\\glass.cpp"
    MOV ECX,0x3cd                       ; 004eb700
    PUSH 0x62e266                       ; 004eb705 | = "Cannot find glass texture extension"
    MOV dword ptr [0x02f0ca48],EDX      ; 004eb70a | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 004eb710 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004eb716
    ...
    CMP AL,0x0                          ; 004eb738
    JNZ 0x004eb724                      ; 004eb73a
        ;   XREF to: 004eb724 (CONDITIONAL_JUMP)  ; LAB_004eb724
    POP EDI                             ; 004eb73c
        ;   Label: LAB_004eb73c
    ...
    JNZ 0x004eb763                      ; 004eb756
        ;   XREF to: 004eb763 (CONDITIONAL_JUMP)  ; LAB_004eb763
    ...
    CMP AL,0x0                          ; 004eb781
    JZ 0x004eb795                       ; 004eb783
        ;   XREF to: 004eb795 (CONDITIONAL_JUMP)  ; LAB_004eb795
    MOV AL,byte ptr [ESI + 0x1]         ; 004eb785
    ADD ESI,0x2                         ; 004eb788
    MOV byte ptr [EDI + 0x1],AL         ; 004eb78b
    ADD EDI,0x2                         ; 004eb78e
    CMP AL,0x0                          ; 004eb791
    JNZ 0x004eb77d                      ; 004eb793
        ;   XREF to: 004eb77d (CONDITIONAL_JUMP)  ; LAB_004eb77d
    POP EDI                             ; 004eb795
        ;   Label: LAB_004eb795
    ...
    MOV AL,byte ptr [ESI]               ; 004eb798
        ;   Label: LAB_004eb798
    CMP AL,DL                           ; 004eb79a
    JZ 0x004eb7b0                       ; 004eb79c
        ;   XREF to: 004eb7b0 (CONDITIONAL_JUMP)  ; LAB_004eb7b0
    CMP AL,0x0                          ; 004eb79e
    JZ 0x004eb7ae                       ; 004eb7a0
        ;   XREF to: 004eb7ae (CONDITIONAL_JUMP)  ; LAB_004eb7ae
    INC ESI                             ; 004eb7a2
    MOV AL,byte ptr [ESI]               ; 004eb7a3
    CMP AL,DL                           ; 004eb7a5
    JZ 0x004eb7b0                       ; 004eb7a7
        ;   XREF to: 004eb7b0 (CONDITIONAL_JUMP)  ; LAB_004eb7b0
    INC ESI                             ; 004eb7a9
    CMP AL,0x0                          ; 004eb7aa
    JNZ 0x004eb798                      ; 004eb7ac
        ;   XREF to: 004eb798 (CONDITIONAL_JUMP)  ; LAB_004eb798
    SUB ESI,ESI                         ; 004eb7ae
        ;   Label: LAB_004eb7ae
    MOV EDI,ESI                         ; 004eb7b0
        ;   Label: LAB_004eb7b0
    TEST ESI,ESI                        ; 004eb7b2
    JNZ 0x004eb7d8                      ; 004eb7b4
        ;   XREF to: 004eb7d8 (CONDITIONAL_JUMP)  ; LAB_004eb7d8
    MOV EBP,0x62e29f                    ; 004eb7b6 | = "..\\core\\glass.cpp"
    MOV EAX,0x3d4                       ; 004eb7bb
    PUSH 0x62e2b1                       ; 004eb7c0 | = "Cannot find glass texture extension"
    MOV dword ptr [0x02f0ca48],EBP      ; 004eb7c5 | g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 004eb7cb | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004eb7d0
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    CMP AL,0x0                          ; 004eb7f2
    JNZ 0x004eb7de                      ; 004eb7f4
        ;   XREF to: 004eb7de (CONDITIONAL_JUMP)  ; LAB_004eb7de
    POP EDI                             ; 004eb7f6
        ;   Label: LAB_004eb7f6
