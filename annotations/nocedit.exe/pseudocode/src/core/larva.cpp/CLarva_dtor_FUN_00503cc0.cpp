...
// Convention: __cdecl
// Signature: CLarva * __cdecl core_larva_cpp_CLarva_dtor_FUN_00503cc0(CLarva *this_ptr,uint flags)
...

{
  ...
  if ((flags & 4) != 0) {
    ptr_00 = __vec_delete(this_ptr,&g_CLarvaTypeInfo);
  ...
  ptr = (CLarva *)core_actor_cpp_CDemonActor_dtor_FUN_00408a30((CDemonActor *)ADJ(pCVar5),1);
  if ((flags & 2) == 0) {
    return ptr;
  }
