...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_larva_cpp_CLarva_addFilesToExtract_FUN_00503c90(CLarva *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00503c90
        ;   Label: core_larva.cpp_CLarva_addFilesToExtract_FUN_00503c90
    MOV EDX,dword ptr [ESP + 0xc]       ; 00503c91
    PUSH EDX                            ; 00503c95
    MOV ECX,dword ptr [ESP + 0xc]       ; 00503c96
    PUSH ECX                            ; 00503c9a
    CALL core_actor.cpp_CDemonActor_addFilesToExtract_FUN_0040cfd0 ; 00503c9b
    ...
    PUSH EAX                            ; 00503cb1
    CALL core_skeledit.cpp_CDeformableModelInstance_addFilesToExtract_FUN_0058a260 ; 00503cb2
