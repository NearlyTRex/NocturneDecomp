...
section .text
    ...
    PUSH EBX                            ; 00503020
        ;   Label: core_larva.cpp_CLarva_setup_FUN_00503020
    PUSH ESI                            ; 00503021
    ...
    CALL core_enemy.cpp_CEnemy_setup_FUN_004a9650 ; 0050304c
    ...
    MOV dword ptr [ESP + 0x8],EAX       ; 00503060
    MOV EAX,dword ptr [ESP + 0x8]       ; 00503064
    MOV dword ptr [ESI + 0xbe38],EAX    ; 00503068
    ADD ESP,0x8                         ; 0050306e
    ADD ESP,0x4                         ; 00503071
    POP ESI                             ; 00503074
    POP EBX                             ; 00503075
    RET                                 ; 00503076
