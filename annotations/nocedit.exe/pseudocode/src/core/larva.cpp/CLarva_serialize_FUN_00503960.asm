...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_larva_cpp_CLarva_serialize_FUN_00503960(CLarva *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00503960
        ;   Label: core_larva.cpp_CLarva_serialize_FUN_00503960
    MOV EBX,dword ptr [ESP + 0x8]       ; 00503961
    PUSH EBX                            ; 00503965
    CALL core_enemy.cpp_CEnemy_serialize_FUN_004a9660 ; 00503966
    ...
    PUSH EAX                            ; 00503979
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 0050397a
    ...
    PUSH EAX                            ; 0050398d
    CALL core_actor.cpp_serializedDeformableModelInstance_FUN_0040b970 ; 0050398e
    ...
    PUSH EBX                            ; 005039ac
    CALL core_actor.cpp_serializeMotionState_FUN_0040b9f0 ; 005039ad
    ...
    PUSH EAX                            ; 005039c2
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 005039c3
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
