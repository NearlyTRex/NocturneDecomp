...

{
  ...
  while (0.0 < local_18) {
    ...
    if ((iVar7 == 100) && (iVar7 = *(int *)(in_stack_00000004->field6_0xbe38 + 4), iVar7 != 0)) {
      ...
      fVar15 = fVar12 * (float10)FLOAT_00630f7b * fVar12 *
...
LAB_00503184:
  ...
  if (local_30 == 1) {
    ...
    if (iVar7 == 0) {
      ...
      *(undefined4 *)(in_stack_00000004[1].base_character.base_actor.actor_name + 0x10) = uVar11;
    }
  }
  else {
...
// 00503119: CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0
...
// 005031b5: PUSH EDX
// 005031b6: CALL sound_sndmain.cpp_isSfxPlaying_FUN_005a9660
...
//   Label: LAB_0050393e
// 00503944: PUSH EAX
// 00503945: CALL sound_sndmain.cpp_killSfx_FUN_005a9c40
