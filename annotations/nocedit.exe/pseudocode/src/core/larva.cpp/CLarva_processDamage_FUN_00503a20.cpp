...

{
  ...
  if (0.0 < fVar2) {
    ...
    if (iVar5 == 0) {
      fVar2 = (this_ptr->base).base.size_scale;
      if ((float)0.29999999999999999 <= fVar2) {
        if (0.69999999999999996 <= (double)fVar2) {
          pcVar4 = "big";
        }
        else {
          pcVar4 = "med";
      ...
      _sprintf(local_84,"l%s-shot?.wav",pcVar4);
    ...
    if ((pSVar2->state_index != 5) && (pSVar2->state_index != 4)) {
      core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                (&this_ptr_01->motion_controller,4,1);
    }
  ...
  core_gore_cpp_CGore_spawnBloodBurst_FUN_004edbb0
            (g_CGorePtr,&CStack_20,(CVector3f *)0x0,10,(this_ptr->base).base.blood_type);
