...

{
  ...
  while (0.0 < local_18) {
    ...
    if ((iVar8 == 100) && (pCVar5 = (this_ptr->base).victim, pCVar5 != (CDemonActor *)0x0)) {
  ...
  fVar7 = (float)0.39269908168750001;
  fVar6 = (float)3;
...
LAB_00503184:
  ...
  if (local_30 == 1) {
    iVar8 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660(*(uint *)(this_ptr->unk + 8));
    if (iVar8 == 0) {
      fVar15 = (float10)1;
  ...
  if (iVar8 != 0) {
    pCVar5 = (this_ptr->base).victim;
    if ((pCVar5 != (CDemonActor *)0x0) &&
       (pCVar10 = (CLarva *)(*(((pCVar5->vtable)._uc)->_uc).cfunc8)(), pCVar10 == this_ptr)) {
