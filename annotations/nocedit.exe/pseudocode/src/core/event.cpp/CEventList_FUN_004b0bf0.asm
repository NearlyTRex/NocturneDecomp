...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_event.cpp_CEventList_FUN_004b0bf0(CEventList * this_ptr)
;
; Parameters:
; CEventList *     Stack[0x4]:4   this_ptr
;
; XREF[2]:
;   core_event.cpp_CEventList_FUN_004b0b80 at 004b0b8e
...
section .text
    ...
    PUSH EBX                            ; 004b0bf0
        ;   Label: core_event.cpp_CEventList_FUN_004b0bf0
    PUSH ESI                            ; 004b0bf1
    PUSH EDI                            ; 004b0bf2
    PUSH EBP                            ; 004b0bf3
