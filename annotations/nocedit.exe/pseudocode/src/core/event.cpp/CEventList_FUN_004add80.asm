...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_event_cpp_CEventList_FUN_004add80(CEventList *this_ptr)
;
; Parameters:
...
section .text
    ...
    XOR AH,AH                           ; 004add84
    MOV byte ptr [0x02d0a460],AH        ; 004add86 | DAT_02d0a460
    ...
    CALL core_event.cpp_CEventList_FUN_004b0270 ; 004add9f
    ...
    MOV EDI,0x2d0a460                   ; 004addc3 | DAT_02d0a460
    PUSH EDI                            ; 004addc8 | DAT_02d0a460
    MOV AL,byte ptr [ESI]               ; 004addc9 | = "Syntax error" | s_ntax_error_006252b9
        ;   Label: LAB_004addc9
    MOV byte ptr [EDI],AL               ; 004addcb | DAT_02d0a460 | DAT_02d0a462
    CMP AL,0x0                          ; 004addcd
    ...
    MOV byte ptr [EDI + 0x1],AL         ; 004addd7 | DAT_02d0a461 | DAT_02d0a463
