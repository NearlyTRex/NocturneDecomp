...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_event_cpp_CEventList_FUN_004b0c40(CEventList *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004b0c45
    CALL core_event.cpp_CEventList_FUN_004b0db0 ; 004b0c46
    ...
    PUSH EDX                            ; 004b0c52
    PUSH EBX                            ; 004b0c53
    CALL core_event.cpp_CEventList_FUN_004b0d60 ; 004b0c54
