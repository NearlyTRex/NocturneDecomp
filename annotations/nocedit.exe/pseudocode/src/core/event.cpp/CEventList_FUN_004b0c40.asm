...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_event.cpp_CEventList_FUN_004b0c40(CEventList * this_ptr)
;
; Parameters:
; CEventList *     Stack[0x4]:4   this_ptr
;
; XREF[2]:
;   core_event.cpp_CEventList_FUN_004aacc0 at 004ab68c
;   core_event.cpp_CEventList_FUN_004ae140 at 004afc09
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 004b0c45
    CALL core_event.cpp_CEventList_FUN_004b0db0 ; 004b0c46 | void core_event.cpp_CEventList_FUN_004b0db0(CEventList * this_ptr)
        ;   XREF to: 004b0db0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004b0c4b
    MOV EDX,dword ptr [ESP + 0xc]       ; 004b0c4e
    PUSH EDX                            ; 004b0c52
    PUSH EBX                            ; 004b0c53
    CALL core_event.cpp_CEventList_FUN_004b0d60 ; 004b0c54 | int core_event.cpp_CEventList_FUN_004b0d60(CEventList * this_ptr)
        ;   XREF to: 004b0d60 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004b0c59
    TEST EAX,EAX                        ; 004b0c5c
    JL 0x004b0c73                       ; 004b0c5e | LAB_004b0c73
