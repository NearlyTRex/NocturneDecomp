// Name: core_event.cpp_CEvent_LoggingSomethingToConsole_FUN_004adca0
// Address: 004adca0
// Address Range: [[004adca0, 004adcfa]]
// Convention: __cdecl
// Signature: int core_event.cpp_CEvent_LoggingSomethingToConsole_FUN_004adca0(CEventList * this_ptr, char * n1)
// Cross-references:
...
//   core_event.cpp_LargeEventHandler_FUN_004aacc0 (004aacc0) at 004acdc2 [UNCONDITIONAL_CALL]
...
//   core_glass.cpp_FUN_004eb3a0 (004eb3a0) at 004eb3b1 [UNCONDITIONAL_CALL]
...
/* Signature: undefined1 core_event.cpp_CEvent_LoggingSomethingToConsole(CEventList* param_1,
   undefined4 param_2) */

int __cdecl
core_event_cpp_CEvent_LoggingSomethingToConsole_FUN_004adca0(CEventList *this_ptr,char *n1)

{
  ...
  if ((n1 == (char *)0x0) || (*n1 == '\0')) {
    ...
    iVar1 = crt_string_c_stricmp_FUN_005fe7f0(n1,"none");
    if (iVar1 != 0) {
      DAT_02d0a45c = 0;
...
// Assembly code:
// 004adca0: PUSH EBX
//   Label: core_event.cpp_CEvent_LoggingSomethingToConsole_FUN_004adca0
...
// 004adcd2: CALL core_event.cpp_CEvent_SyntaxErrorSomething_FUN_004add80
