// Name: core_event.cpp_WritingEventFile_FUN_004b1380
// Address: 004b1380
// Address Range: [[004b1380, 004b1667]]
// Convention: unknown
// Signature: undefined core_event.cpp_WritingEventFile_FUN_004b1380()
// Cross-references:
...
/* Signature: int core_event.cpp_WritingEventFile_FUN_004b1380(CEventList* pEventList, FILE*
   pFilePtr) */

int core_event_cpp_WritingEventFile_FUN_004b1380(void)

{
  ...
  piVar4 = (int *)((ulonglong)in_stack_00000000 >> 0x20);
  crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"// CEventList version\n");
  crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"%d\n",5);
  crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"// eventCount, list\n");
  iVar1 = 0;
  crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"%d\n",*piVar4);
  if (0 < *piVar4) {
    piVar2 = piVar4 + 1;
  ...
  crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"// currentEventCount, list\n");
  iVar1 = 0;
  crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"%d\n",piVar4[0x321]);
  if (0 < piVar4[0x321]) {
    piVar2 = piVar4 + 0x322;
    do {
      ...
      crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"%s\n","%s\n",piVar2);
      piVar2 = piVar2 + 8;
    } while (iVar1 < piVar4[0x321]);
  }
  crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"// persistentEventCount, list\n");
  iVar1 = 0;
  crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"%d\n",piVar4[0x963]);
  if (0 < piVar4[0x963]) {
    do {
      iVar1 = iVar1 + 1;
      crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"%s\n");
    } while (iVar1 < piVar4[0x963]);
  }
  crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"// timerCount, list(duration, name)\n");
  crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"%d\n");
  iVar1 = 0;
  if (0 < piVar4[0xc84]) {
    do {
      crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"%f, %s\n");
      iVar1 = iVar1 + 1;
    } while (iVar1 < piVar4[0xc84]);
  }
  crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"// counterCount, list(value, name)\n");
  crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"%d\n");
  iVar1 = 0;
  if (0 < piVar4[0xcdf]) {
    do {
      crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"%d, %s\n");
      iVar1 = iVar1 + 1;
    } while (iVar1 < piVar4[0xcdf]);
  }
  crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"// actorVarCount, list(varName, actorName)\n");
  iVar1 = 0;
  crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"%d\n");
  if (0 < piVar4[0xd3a]) {
    do {
      ...
      iVar1 = iVar1 + 1;
    } while (iVar1 < piVar4[0xd3a]);
  }
  crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"// gameFlagCount, list\n");
  iVar3 = 0;
  iVar1 = crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"%d\n");
  if (0 < piVar4[0x642]) {
    do {
      iVar3 = iVar3 + 1;
      crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"%s\n");
...
// Assembly code:
// 004b1380: PUSH EBX
//   Label: core_event.cpp_WritingEventFile_FUN_004b1380
// 004b1381: PUSH ESI
// 004b1382: PUSH EDI
// 004b1383: PUSH EBP
