...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_event_cpp_CEventList_FUN_004aac00(CEventList *this_ptr)
;
; Parameters:
...
section .text
    ...
    CALL core_event.cpp_CEventList_FUN_004aacc0 ; 004aac74
        ;   XREF to: 004aacc0 (UNCONDITIONAL_CALL)  ; CDemonActor * core_event.cpp_CEventList_FUN_004aacc0(CEventList * this_ptr)
    ADD ESP,0x8                         ; 004aac79
    TEST EAX,EAX                        ; 004aac7c
    JNZ 0x004aac0d                      ; 004aac7e
        ;   XREF to: 004aac0d (CONDITIONAL_JUMP)  ; LAB_004aac0d
    CMP dword ptr [0x02d0a45c],0x0      ; 004aac80 | DAT_02d0a45c
