...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_event_cpp_parseIntOrCounter_FUN_004aa3c0(char *str)
;
; Parameters:
...
section .text
    ...
    SUB ESP,0x4                         ; 004aa3c0
        ;   Label: core_event.cpp_parseIntOrCounter_FUN_004aa3c0
    MOV EAX,ESP                         ; 004aa3c3
    PUSH EAX                            ; 004aa3c5
    PUSH 0x624449                       ; 004aa3c6 | = "%d"
    MOV EDX,dword ptr [ESP + 0x10]      ; 004aa3cb
    PUSH EDX                            ; 004aa3cf
    CALL crt_stdio.c_sscanf_FUN_0060013c ; 004aa3d0
    ...
    JNZ 0x004aa3e4                      ; 004aa3db
        ;   XREF to: 004aa3e4 (CONDITIONAL_JUMP)  ; LAB_004aa3e4
    ...
    PUSH ECX                            ; 004aa3e9
    MOV EBX,dword ptr [0x006793d0]      ; 004aa3ea | g_CEventListPtr | g_CEventListInstance
    PUSH EBX                            ; 004aa3f0 | g_CEventListInstance
    CALL core_event.cpp_CEventList_getCounterValue_FUN_004b0830 ; 004aa3f1
