...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_event_cpp_CEventList_findTimer_FUN_004b0900(CEventList *this_ptr,char *name)
;
; Parameters:
...
;
; XREF[2]:
;   core_event.cpp_CEventList_resolveVariable_FUN_004adc10 at 004adc84
...
section .text
    ...
    PUSH EBX                            ; 004b0900
        ;   Label: core_event.cpp_CEventList_findTimer_FUN_004b0900
    PUSH ESI                            ; 004b0901
    PUSH EDI                            ; 004b0902
    PUSH EBP                            ; 004b0903
