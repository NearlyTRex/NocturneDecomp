...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_event_cpp_CEventList_addOrRemoveGameFlag_FUN_004b0470(CEventList *this_ptr,char *name,int add_flag)
;
; Parameters:
...
;
; XREF[1]:
;   core_event.cpp_CEventList_executeCommand_FUN_004aacc0 at 004ab84b
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004b0470
        ;   Label: core_event.cpp_CEventList_addOrRemoveGameFlag_FUN_004b0470
    PUSH ESI                            ; 004b0471
    PUSH EBP                            ; 004b0472
    ...
    PUSH ESI                            ; 004b0488
        ;   Label: LAB_004b0488
    PUSH EBX                            ; 004b0489
    CALL core_event.cpp_CEventList_findGameFlag_FUN_004b08b0 ; 004b048a
