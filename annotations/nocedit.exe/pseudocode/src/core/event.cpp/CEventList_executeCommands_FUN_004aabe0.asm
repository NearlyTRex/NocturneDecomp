...
;   core_filmreel.cpp_CFilmProjector_process_FUN_004beb40 at 004bebea
;   core_game.cpp_CGame_processCheatCodes_FUN_004ddaf0 at 004df54f
;   core_hero.cpp_CHero_tryTalkToNearbyCharacter_FUN_004f2c40 at 004f2d4a
...
section .text
    ...
    PUSH EBX                            ; 004aabe0
        ;   Label: core_event.cpp_CEventList_executeCommands_FUN_004aabe0
    MOV ECX,dword ptr [ESP + 0xc]       ; 004aabe1
    PUSH ECX                            ; 004aabe5
    MOV EBX,dword ptr [ESP + 0xc]       ; 004aabe6
    XOR EDX,EDX                         ; 004aabea
    PUSH EBX                            ; 004aabec
    MOV dword ptr [0x02d0a45c],EDX      ; 004aabed | g_EventDryRun
    CALL core_event.cpp_CEventList_executeCommandString_FUN_004aac00 ; 004aabf3
