...

{
  ...
  float local_a84;
  char acStack_a80 [255];
  char acStack_981 [100];
  char acStack_91d [101];
  char acStack_8b8 [99];
  char acStack_855 [101];
  byte auStack_7f0 [99];
  char acStack_78d [100];
  char acStack_729 [101];
  byte auStack_6c4 [99];
  char acStack_661 [101];
  byte auStack_5fc [99];
  char acStack_599 [101];
  byte auStack_534 [99];
  char acStack_4d1 [100];
  char acStack_46d [101];
  byte auStack_408 [99];
  char acStack_3a5 [100];
  char acStack_341 [101];
  byte auStack_2dc [99];
  char acStack_279 [101];
  byte auStack_214 [99];
  char acStack_1b1 [101];
  char acStack_14c [64];
  CVector3f local_10c;
  float local_100;
  float local_fc;
  ...
  *pcVar14 = '\0';
  if (*(char *)(in_stack_00000008 + *in_stack_0000000c) != '(') {
    ...
    iVar6 = core_event_cpp_CEventList_FUN_004adc10(this_ptr,acStack_14c);
    return iVar6;
  }
  local_dc = 0xffffffff;
  iVar6 = crt_string_c_stricmp_FUN_005fe7f0(acStack_14c,"cmp");
  if (iVar6 != 0) {
    iVar6 = crt_string_c_stricmp_FUN_005fe7f0(acStack_14c,"exists");
    if (iVar6 == 0) {
      local_68 = -1;
      crt_stdio_c_sscanf_FUN_0060013c
                ((char *)(in_stack_00000008 + *in_stack_0000000c)," ( %[^ )] )%n",acStack_341 + 1,
                 &local_68);
      if (local_68 < 3) {
      ...
      *in_stack_0000000c = *in_stack_0000000c + local_68;
      ...
      iVar6 = crt_string_c_stricmp_FUN_005fe7f0(acStack_14c,"hasItem");
      if (iVar6 == 0) {
        ...
        local_b4 = -1;
        crt_stdio_c_sscanf_FUN_0060013c
                  ((char *)(in_stack_00000008 + *in_stack_0000000c)," (%[^)])%n",acStack_855 + 1,
                   &local_b4);
        if (local_b4 < 3) {
        ...
        *in_stack_0000000c = *in_stack_0000000c + local_b4;
        ...
        iVar6 = crt_string_c_stricmp_FUN_005fe7f0(acStack_14c,"hasItemType");
        if (iVar6 == 0) {
          local_a8 = -1;
          crt_stdio_c_sscanf_FUN_0060013c
                    ((char *)(in_stack_00000008 + *in_stack_0000000c)," (%[^,], %[^)] )%n",acStack_599 + 1,
                     acStack_729 + 1,&local_a8);
          if (local_a8 < 5) {
        ...
        iVar6 = crt_string_c_stricmp_FUN_005fe7f0(acStack_14c,"hasKeyMask");
        if (iVar6 == 0) {
          if (g_CNetGameInstance->connection_type != 0) {
          ...
          local_a0 = -1;
          crt_stdio_c_sscanf_FUN_0060013c
                    ((char *)(in_stack_00000008 + *in_stack_0000000c)," ( %d )%n",&local_9c,
                     &local_a0);
          if (local_a0 < 3) {
          ...
          *in_stack_0000000c = *in_stack_0000000c + local_a0;
          ...
          iVar6 = crt_string_c_stricmp_FUN_005fe7f0(acStack_14c,"isBroken");
          if (iVar6 == 0) {
            local_98 = -1;
            crt_stdio_c_sscanf_FUN_0060013c
                      ((char *)(in_stack_00000008 + *in_stack_0000000c)," (%[^)])%n",acStack_279 + 1
                       ,&local_98);
            if (local_98 < 3) {
          ...
          iVar6 = crt_string_c_stricmp_FUN_005fe7f0(acStack_14c,"isCurrentCamera");
          if (iVar6 == 0) {
            local_90 = -1;
            crt_stdio_c_sscanf_FUN_0060013c
                      ((char *)(in_stack_00000008 + *in_stack_0000000c)," ( %[^ )] )%n",acStack_8b8,
                       &local_90);
            if (local_90 < 3) {
            ...
            *in_stack_0000000c = *in_stack_0000000c + local_90;
            ...
            iVar6 = crt_string_c_stricmp_FUN_005fe7f0(acStack_14c,"isDead");
            if (iVar6 == 0) {
              local_8c = -1;
              crt_stdio_c_sscanf_FUN_0060013c
                        ((char *)(in_stack_00000008 + *in_stack_0000000c)," ( %[^ )] )%n",auStack_6c4,
                         &local_8c);
              if (local_8c < 3) {
            ...
            iVar6 = crt_string_c_stricmp_FUN_005fe7f0(acStack_14c,"isFadeFinished");
            if (iVar6 == 0) {
              local_88 = -1;
              crt_stdio_c_sscanf_FUN_0060013c
              ...
              *in_stack_0000000c = *in_stack_0000000c + local_88;
              ...
              iVar6 = crt_string_c_stricmp_FUN_005fe7f0(acStack_14c,"isInRange");
              if (iVar6 == 0) {
                local_84 = -1;
                crt_stdio_c_sscanf_FUN_0060013c
              ...
              iVar6 = crt_string_c_stricmp_FUN_005fe7f0(acStack_14c,"isOfType");
              if (iVar6 == 0) {
                local_6c = -1;
                crt_stdio_c_sscanf_FUN_0060013c
                          ((char *)(in_stack_00000008 + *in_stack_0000000c)," ( %[^ ,] , %[^ )] )%n",
                           acStack_46d + 1,acStack_661 + 1,&local_6c);
                if (local_6c < 3) {
              ...
              iVar6 = crt_string_c_stricmp_FUN_005fe7f0(acStack_14c,"isFacing");
              if (iVar6 == 0) {
                local_5c = -1;
                crt_stdio_c_sscanf_FUN_0060013c
                          ((char *)(in_stack_00000008 + *in_stack_0000000c)," (%[^,], %[^,)]%n",
                           acStack_1b1 + 1,acStack_4d1 + 1,&local_5c);
                if (local_5c < 5) {
                ...
                *in_stack_0000000c = *in_stack_0000000c + 1;
                ...
                iVar6 = crt_string_c_stricmp_FUN_005fe7f0(acStack_14c,"isLightOn");
                if (iVar6 == 0) {
                  local_50 = -1;
                  crt_stdio_c_sscanf_FUN_0060013c
                            ((char *)(in_stack_00000008 + *in_stack_0000000c)," ( %[^ )] )%n",
                             auStack_214,&local_50);
                  if (local_50 < 3) {
                  ...
                  *in_stack_0000000c = *in_stack_0000000c + local_50;
                  ...
                  iVar6 = crt_string_c_stricmp_FUN_005fe7f0(acStack_14c,"isNudityEnabled");
                  if (iVar6 == 0) {
                    local_40 = -1;
                    crt_stdio_c_sscanf_FUN_0060013c
                              ((char *)(in_stack_00000008 + *in_stack_0000000c)," ( )%n",
                    ...
                    *in_stack_0000000c = *in_stack_0000000c + local_40;
                    ...
                    iVar6 = crt_string_c_stricmp_FUN_005fe7f0(acStack_14c,"isSfxActive");
                    if (iVar6 == 0) {
                      local_3c = -1;
                      crt_stdio_c_sscanf_FUN_0060013c
                                ((char *)(in_stack_00000008 + *in_stack_0000000c)," ( %[^ )] )%n",
                                 acStack_78d + 1,&local_3c);
                      if (local_3c < 3) {
                      ...
                      *in_stack_0000000c = *in_stack_0000000c + local_3c;
                      ...
                      iVar6 = crt_string_c_stricmp_FUN_005fe7f0(acStack_14c,"isTalking");
                      if (iVar6 == 0) {
                        local_34 = -1;
                        crt_stdio_c_sscanf_FUN_0060013c
                                  ((char *)(in_stack_00000008 + *in_stack_0000000c)," ( %[^ )] )%n",
                                   auStack_534,&local_34);
                        if (local_34 < 3) {
                        ...
                        *in_stack_0000000c = *in_stack_0000000c + local_34;
                        ...
                        iVar6 = crt_string_c_stricmp_FUN_005fe7f0(acStack_14c,"isVictim");
                        if (iVar6 == 0) {
                          local_30 = -1;
                          crt_stdio_c_sscanf_FUN_0060013c
                                    ((char *)(in_stack_00000008 + *in_stack_0000000c)," ( %[^ )] )%n",
                                     auStack_408,&local_30);
                          if (local_30 < 3) {
                        ...
                        iVar6 = crt_string_c_stricmp_FUN_005fe7f0
                                          (acStack_14c,"isWeaponDrawn");
                        if (iVar6 == 0) {
                          local_1c = -1;
                          crt_stdio_c_sscanf_FUN_0060013c
                                    ((char *)(in_stack_00000008 + *in_stack_0000000c)," ( %[^ )] )%n",
                                     auStack_2dc,&local_1c);
                          if (local_1c < 3) {
                          ...
                          *in_stack_0000000c = *in_stack_0000000c + local_1c;
                          ...
                          iVar6 = crt_string_c_stricmp_FUN_005fe7f0
                                            (acStack_14c,"isWearingGasMask");
                          if (iVar6 == 0) {
                            local_18 = -1;
                            crt_stdio_c_sscanf_FUN_0060013c
                                      ((char *)(in_stack_00000008 + *in_stack_0000000c)," ( %[^ )] )%n"
                                       ,auStack_5fc,&local_18);
                            if (local_18 < 3) {
                            ...
                            iVar6 = crt_string_c_stricmp_FUN_005fe7f0
                                              (acStack_14c,"randBool");
                            if (iVar6 != 0) {
                              iVar6 = crt_string_c_stricmp_FUN_005fe7f0
                                                (acStack_14c,"reachedDest");
                              if (iVar6 != 0) {
  ...
  local_d8 = -1;
  crt_stdio_c_sscanf_FUN_0060013c
            ((char *)(in_stack_00000008 + *in_stack_0000000c)," ( %s %s %[^ )] )%n",acStack_91d + 1,
             acStack_981 + 1,acStack_3a5 + 1,&local_d8);
  if (local_d8 < 3) {
