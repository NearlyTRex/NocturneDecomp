...
section .text
    ...
    CALL core_event.cpp_CEventList_FUN_004b0b80 ; 004aa41f
    ...
    MOV EAX,[0x0065d95c]                ; 004aa42d | DAT_0065d95c
        ;   Label: LAB_004aa42d
    POP EBP                             ; 004aa432
    POP EDI                             ; 004aa433
    POP ESI                             ; 004aa434
    ...
    MOV ESI,0x62444c                    ; 004aa437 | = "Must specify actor name"
        ;   Label: LAB_004aa437
    MOV EDI,0x2d0a460                   ; 004aa43c | DAT_02d0a460
    PUSH EDI                            ; 004aa441 | DAT_02d0a460
    MOV AL,byte ptr [ESI]               ; 004aa442 | = "Must specify actor name" | s_st_specify_actor_name_0062444e
        ;   Label: LAB_004aa442
    MOV byte ptr [EDI],AL               ; 004aa444 | DAT_02d0a460 | DAT_02d0a462
    CMP AL,0x0                          ; 004aa446
    ...
    MOV byte ptr [EDI + 0x1],AL         ; 004aa450 | DAT_02d0a461 | DAT_02d0a463
    ...
    MOV EAX,[0x0065d95c]                ; 004aa4aa | DAT_0065d95c
    POP EBP                             ; 004aa4af
    POP EDI                             ; 004aa4b0
    POP ESI                             ; 004aa4b1
    POP EBX                             ; 004aa4b2
    ...
    PUSH 0x624466                       ; 004aa4b4 | = "Can't use '$' actor specifier in mult..."
        ;   Label: LAB_004aa4b4
    PUSH 0x2d0a460                      ; 004aa4b9 | DAT_02d0a460
    ...
    CALL core_mission.cpp_CDemonMission_FUN_00524030 ; 004aa4d5
    ...
    PUSH 0x2d0a460                      ; 004aa4e9 | DAT_02d0a460
    ...
    PUSH 0x2d0a460                      ; 004aa512 | DAT_02d0a460
