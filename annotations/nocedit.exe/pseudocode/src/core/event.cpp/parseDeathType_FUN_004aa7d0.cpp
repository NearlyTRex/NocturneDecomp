...

{
  ...
  iVar1 = stricmp(type_name,"drown");
  if (iVar1 == 0) {
    *out_type_id = 1;
    return 1;
  }
  iVar1 = stricmp(type_name,"fall");
  if (iVar1 == 0) {
    *out_type_id = 2;
    return 1;
  }
  iVar1 = stricmp(type_name,"explode");
  if (iVar1 == 0) {
    *out_type_id = 3;
    return 1;
  }
  iVar1 = stricmp(type_name,"fallApart");
  if (iVar1 == 0) {
    *out_type_id = 4;
    return 1;
  }
  iVar1 = stricmp(type_name,"shatter");
  if (iVar1 == 0) {
    *out_type_id = 5;
    return 1;
  }
  ...
  iVar1 = stricmp(type_name,"Chopped");
  if (iVar1 == 0) {
    *out_type_id = 7;
    return 1;
  }
  iVar1 = stricmp(type_name,"Crushed");
  if (iVar1 == 0) {
    *out_type_id = 8;
    return 1;
  }
  iVar1 = stricmp(type_name,"Impale");
  if (iVar1 == 0) {
    *out_type_id = 9;
    return 1;
  }
