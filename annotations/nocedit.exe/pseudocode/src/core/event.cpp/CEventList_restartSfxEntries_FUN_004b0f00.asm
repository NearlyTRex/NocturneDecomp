...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_event_cpp_CEventList_restartSfxEntries_FUN_004b0f00(CEventList *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004b0f00
        ;   Label: core_event.cpp_CEventList_restartSfxEntries_FUN_004b0f00
    PUSH EBP                            ; 004b0f01
    ...
    PUSH EBP                            ; 004b0f7b
        ;   Label: LAB_004b0f7b
    CALL core_event.cpp_CEventList_updateSfxEntries_FUN_004b0db0 ; 004b0f7c
