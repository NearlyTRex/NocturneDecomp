...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_event_cpp_CEventList_findSfxEntry_FUN_004b0d60(CEventList *this_ptr,char *name)
;
; Parameters:
...
;
; XREF[2]:
;   core_event.cpp_CEventList_getSfxHandle_FUN_004b0c40 at 004b0c54
...
section .text
    ...
    PUSH EBX                            ; 004b0d60
        ;   Label: core_event.cpp_CEventList_findSfxEntry_FUN_004b0d60
    PUSH ESI                            ; 004b0d61
    PUSH EDI                            ; 004b0d62
    PUSH EBP                            ; 004b0d63
