...
section .text
    ...
    JZ 0x004b0484                       ; 004b047d | LAB_004b0484
        ;   XREF to: 004b0484 (CONDITIONAL_JUMP)
    CMP byte ptr [ESI],0x0              ; 004b047f
    JNZ 0x004b0488                      ; 004b0482 | LAB_004b0488
    ...
    PUSH ESI                            ; 004b0488
        ;   Label: LAB_004b0488
    PUSH EBX                            ; 004b0489
    CALL core_event.cpp_CEventList_FUN_004b08b0 ; 004b048a | int core_event.cpp_CEventList_FUN_004b08b0(CEventList * this_ptr)
        ;   XREF to: 004b08b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004b048f
    CMP dword ptr [ESP + 0x18],0x0      ; 004b0492
    JZ 0x004b055c                       ; 004b0497 | LAB_004b055c
        ;   XREF to: 004b055c (CONDITIONAL_JUMP)
    TEST EAX,EAX                        ; 004b049d
    JGE 0x004b0484                      ; 004b049f | LAB_004b0484
        ;   XREF to: 004b0484 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x1908],0xa    ; 004b04a1
    JGE 0x004b0535                      ; 004b04a8 | LAB_004b0535
    ...
    JC 0x004b04e4                       ; 004b04be | LAB_004b04e4
        ;   XREF to: 004b04e4 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 004b04c0
    MOV EDX,0x625b08                    ; 004b04c1 | = "..\\core\\event.cpp" | s_core_event_cpp_00625b08 = ..\core\event.cpp
    MOV ECX,0xa3d                       ; 004b04c6
    PUSH 0x625b1a                       ; 004b04cb | = "Event name %s too long!" | s_Event_name_s_too_long_00625b1a = Event name %s too long!
    MOV dword ptr [0x02f0ca48],EDX      ; 004b04d0 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 004b04d6 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004b04dc | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    CMP AL,0x0                          ; 004b04fa
    JZ 0x004b050e                       ; 004b04fc | LAB_004b050e
    ...
    CMP AL,0x0                          ; 004b050a
    JNZ 0x004b04f6                      ; 004b050c | LAB_004b04f6
    ...
    PUSH EDX                            ; 004b051a
    CALL crt_string.c_strupr_FUN_00600770 ; 004b051b | char * crt_string.c_strupr_FUN_00600770(char * string)
    ...
    POP EBX                             ; 004b0533
    RET                                 ; 004b0534
    MOV EBP,0x625ae1                    ; 004b0535 | = "..\\core\\event.cpp" | s_core_event_cpp_00625ae1 = ..\core\event.cpp
        ;   Label: LAB_004b0535
    MOV EAX,0xa37                       ; 004b053a
    PUSH 0x625af3                       ; 004b053f | = "Too many game flags!" | s_Too_many_game_flags_00625af3 = Too many game flags!
    MOV dword ptr [0x02f0ca48],EBP      ; 004b0544 | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 004b054a | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004b054f | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004b0554
    JMP 0x004b04ae                      ; 004b0557 | LAB_004b04ae
        ;   XREF to: 004b04ae (UNCONDITIONAL_JUMP)
    TEST EAX,EAX                        ; 004b055c
        ;   Label: LAB_004b055c
    JL 0x004b0484                       ; 004b055e | LAB_004b0484
        ;   XREF to: 004b0484 (CONDITIONAL_JUMP)
    ...
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 004b0588 | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
