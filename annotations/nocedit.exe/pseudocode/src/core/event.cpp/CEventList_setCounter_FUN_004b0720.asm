...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_event.cpp_CEventList_setCounter_FUN_004b0720(CEventList * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 004b0730
    PUSH EBX                            ; 004b0731
    CALL core_event.cpp_CEventList_FUN_004b0950 ; 004b0732 | int core_event.cpp_CEventList_FUN_004b0950(CEventList * this_ptr)
        ;   XREF to: 004b0950 (UNCONDITIONAL_CALL)
    MOV ESI,EAX                         ; 004b0737
    ADD ESP,0x8                         ; 004b0739
    TEST EAX,EAX                        ; 004b073c
    JL 0x004b07ae                       ; 004b073e | LAB_004b07ae
        ;   XREF to: 004b07ae (CONDITIONAL_JUMP)
    LEA EDI,[EAX*0x4 + 0x0]             ; 004b0740
    TEST EBP,EBP                        ; 004b0747
    JZ 0x004b0757                       ; 004b0749 | LAB_004b0757
    ...
    PUSH EAX                            ; 004b077d
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 004b077e | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
    ...
    PUSH EBX                            ; 004b07a0
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 004b07a1 | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
        ;   XREF to: 005fe5e0 (UNCONDITIONAL_CALL)
    ...
    TEST EBP,EBP                        ; 004b07ae
        ;   Label: LAB_004b07ae
    JZ 0x004b0752                       ; 004b07b0 | LAB_004b0752
        ;   XREF to: 004b0752 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x337c],0xa    ; 004b07b2
    JL 0x004b07de                       ; 004b07b9 | LAB_004b07de
        ;   XREF to: 004b07de (CONDITIONAL_JUMP)
    MOV ESI,0x625bbb                    ; 004b07bb | = "..\\core\\event.cpp" | s_core_event_cpp_00625bbb = ..\core\event.cpp
    MOV EDI,0xab2                       ; 004b07c0
    PUSH 0x625bcd                       ; 004b07c5 | = "CEventList::setCounter - too many cou..." | s_CEventList_setCounter_to_00625bcd = CEventList::setCounter - too many counters!
    MOV dword ptr [0x02f0ca48],ESI      ; 004b07ca | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 004b07d0 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004b07d6 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    CMP AL,0x0                          ; 004b07f8
    JZ 0x004b080c                       ; 004b07fa | LAB_004b080c
    ...
    CMP AL,0x0                          ; 004b0808
    JNZ 0x004b07f4                      ; 004b080a | LAB_004b07f4
