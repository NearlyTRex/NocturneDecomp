...
;                               FUNCTION
; *****************************************************************************
; __cdecl CEventList * __cdecl core_event_cpp_CEventList_ctor_FUN_004aaa50(CEventList *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004aaa55
    CALL core_event.cpp_CEventList_reset_FUN_004aaa70 ; 004aaa56
    ...
    PUSH EBX                            ; 004aaa5e
    CALL core_event.cpp_CEventList_resetGameFlags_FUN_004b0460 ; 004aaa5f
