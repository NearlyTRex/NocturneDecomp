...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_event_cpp_CEventList_FUN_004b0270(CEventList *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH ESI                            ; 004b0281
    PUSH EBP                            ; 004b0282
    CALL core_event.cpp_CEventList_FUN_004ae140 ; 004b0283
    ...
    PUSH ESI                            ; 004b02c4
    PUSH EBP                            ; 004b02c5
    CALL core_event.cpp_CEventList_FUN_004ae140 ; 004b02c6
        ;   XREF to: 004ae140 (UNCONDITIONAL_CALL)  ; int core_event.cpp_CEventList_FUN_004ae140(CEventList * this_ptr)
    ...
    PUSH ESI                            ; 004b02f6
    PUSH EBP                            ; 004b02f7
    CALL core_event.cpp_CEventList_FUN_004ae140 ; 004b02f8
        ;   XREF to: 004ae140 (UNCONDITIONAL_CALL)  ; int core_event.cpp_CEventList_FUN_004ae140(CEventList * this_ptr)
