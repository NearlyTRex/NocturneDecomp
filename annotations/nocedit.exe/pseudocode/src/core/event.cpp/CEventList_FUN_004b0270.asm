...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_event.cpp_CEventList_FUN_004b0270(CEventList * this_ptr)
;
; Parameters:
; CEventList *     Stack[0x4]:4   this_ptr
;
; XREF[2]:
;   core_event.cpp_CEventList_FUN_004add80 at 004add9f
;   core_event.cpp_CEventList_FUN_004ae140 at 004ae1fe
;
; Called Functions:
;   core_event.cpp_CEventList_FUN_004ae140
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 004b0270
        ;   Label: core_event.cpp_CEventList_FUN_004b0270
    PUSH ESI                            ; 004b0271
    PUSH EDI                            ; 004b0272
    PUSH EBP                            ; 004b0273
    ...
    PUSH ESI                            ; 004b0281
    PUSH EBP                            ; 004b0282
    CALL core_event.cpp_CEventList_FUN_004ae140 ; 004b0283 | int core_event.cpp_CEventList_FUN_004ae140(CEventList * this_ptr)
        ;   XREF to: 004ae140 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004b0288
    MOV EDI,EAX                         ; 004b028b
    TEST EAX,EAX                        ; 004b028d
    JL 0x004ae1bc                       ; 004b028f | LAB_004ae1bc
    ...
    TEST DL,DL                          ; 004b029b
    JZ 0x004b0323                       ; 004b029d | LAB_004b0323
        ;   XREF to: 004b0323 (CONDITIONAL_JUMP)
    CMP DL,0x7c                         ; 004b02a3
    JZ 0x004b02e5                       ; 004b02a6 | LAB_004b02e5
        ;   XREF to: 004b02e5 (CONDITIONAL_JUMP)
    CMP DL,0x26                         ; 004b02a8
    JNZ 0x004b0323                      ; 004b02ab | LAB_004b0323
        ;   XREF to: 004b0323 (CONDITIONAL_JUMP)
    ...
    JNZ 0x004b02c3                      ; 004b02bc | LAB_004b02c3
    ...
    PUSH ESI                            ; 004b02c4
    PUSH EBP                            ; 004b02c5
    CALL core_event.cpp_CEventList_FUN_004ae140 ; 004b02c6 | int core_event.cpp_CEventList_FUN_004ae140(CEventList * this_ptr)
        ;   XREF to: 004ae140 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004b02cb
    TEST EAX,EAX                        ; 004b02ce
    JL 0x004ae1bc                       ; 004b02d0 | LAB_004ae1bc
        ;   XREF to: 004ae1bc (CONDITIONAL_JUMP)
    TEST EDI,EDI                        ; 004b02d6
    JZ 0x004b031c                       ; 004b02d8 | LAB_004b031c
        ;   XREF to: 004b031c (CONDITIONAL_JUMP)
    TEST EAX,EAX                        ; 004b02da
    JZ 0x004b031c                       ; 004b02dc | LAB_004b031c
        ;   XREF to: 004b031c (CONDITIONAL_JUMP)
    MOV EDI,0x1                         ; 004b02de
    JMP 0x004b0295                      ; 004b02e3 | LAB_004b0295
    ...
    JNZ 0x004b02f5                      ; 004b02ee | LAB_004b02f5
    ...
    PUSH ESI                            ; 004b02f6
    PUSH EBP                            ; 004b02f7
    CALL core_event.cpp_CEventList_FUN_004ae140 ; 004b02f8 | int core_event.cpp_CEventList_FUN_004ae140(CEventList * this_ptr)
        ;   XREF to: 004ae140 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004b02fd
    TEST EAX,EAX                        ; 004b0300
    JL 0x004ae1bc                       ; 004b0302 | LAB_004ae1bc
        ;   XREF to: 004ae1bc (CONDITIONAL_JUMP)
    TEST EDI,EDI                        ; 004b0308
    JZ 0x004b0313                       ; 004b030a | LAB_004b0313
        ;   XREF to: 004b0313 (CONDITIONAL_JUMP)
    MOV EDI,0x1                         ; 004b030c
        ;   Label: LAB_004b030c
    JMP 0x004b0295                      ; 004b0311 | LAB_004b0295
        ;   XREF to: 004b0295 (UNCONDITIONAL_JUMP)
    TEST EAX,EAX                        ; 004b0313
        ;   Label: LAB_004b0313
    JNZ 0x004b030c                      ; 004b0315 | LAB_004b030c
        ;   XREF to: 004b030c (CONDITIONAL_JUMP)
    JMP 0x004b0295                      ; 004b0317 | LAB_004b0295
        ;   XREF to: 004b0295 (UNCONDITIONAL_JUMP)
    XOR EDI,EDI                         ; 004b031c
        ;   Label: LAB_004b031c
    JMP 0x004b0295                      ; 004b031e | LAB_004b0295
        ;   XREF to: 004b0295 (UNCONDITIONAL_JUMP)
