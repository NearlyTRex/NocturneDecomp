...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_event.cpp_CEventList_FUN_004b0f00(CEventList * this_ptr)
;
; Parameters:
...
section .text
    ...
    JLE 0x004b0f7b                      ; 004b0f13 | LAB_004b0f7b
    ...
    CALL sound_sndmain.cpp_pushSfxOptions_FUN_005a8c30 ; 004b0f31 | void sound_sndmain.cpp_pushSfxOptions_FUN_005a8c30()
    ...
    PUSH EDX                            ; 004b0f45
    CALL sound_sndmain.cpp_setNextSfxTriggerTime_FUN_005a8be0 ; 004b0f46 | void sound_sndmain.cpp_setNextSfxTriggerTime_FUN_005a8be0(double trigger_time, int trigger_id)
        ;   XREF to: 005a8be0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004b0f4b
    PUSH 0x1                            ; 004b0f4e
    CALL sound_sndmain.cpp_setNextSfxFlagBits_FUN_005a8b90 ; 004b0f50 | void sound_sndmain.cpp_setNextSfxFlagBits_FUN_005a8b90(uint flag_mask)
        ;   XREF to: 005a8b90 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004b0f55
    PUSH EDI                            ; 004b0f58
    CALL sound_sndmain.cpp_startSfx_FUN_005a8e90 ; 004b0f59 | uint sound_sndmain.cpp_startSfx_FUN_005a8e90(char * filename)
        ;   XREF to: 005a8e90 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004b0f5e
    INC EBX                             ; 004b0f61
    MOV dword ptr [ESI],EAX             ; 004b0f62
    CALL sound_sndmain.cpp_popSfxOptions_FUN_005a8cb0 ; 004b0f64 | void sound_sndmain.cpp_popSfxOptions_FUN_005a8cb0()
        ;   XREF to: 005a8cb0 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [EBP + 0x3ac8]    ; 004b0f69
    ADD EDI,0x120                       ; 004b0f6f
    CMP EBX,ECX                         ; 004b0f75
    JL 0x004b0f27                       ; 004b0f77 | LAB_004b0f27
        ;   XREF to: 004b0f27 (CONDITIONAL_JUMP)
    POP ESI                             ; 004b0f79
    POP EDI                             ; 004b0f7a
    PUSH EBP                            ; 004b0f7b
        ;   Label: LAB_004b0f7b
    CALL core_event.cpp_CEventList_FUN_004b0db0 ; 004b0f7c | void core_event.cpp_CEventList_FUN_004b0db0(CEventList * this_ptr)
