...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_event_cpp_CEventList_getCounterValue_FUN_004b0830(CEventList *this_ptr,char *str)
;
; Parameters:
...
;
; XREF[4]:
;   core_event.cpp_CEventList_evaluateAtom_FUN_004ae140 at 004ae717
;   core_event.cpp_CEventList_executeCommand_FUN_004aacc0 at 004abbfc
;   core_event.cpp_parseIntOrCounter_FUN_004aa3c0 at 004aa3f1
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x8]       ; 004b0830
        ;   Label: core_event.cpp_CEventList_getCounterValue_FUN_004b0830
    PUSH EDX                            ; 004b0834
    MOV ECX,dword ptr [ESP + 0x8]       ; 004b0835
    PUSH ECX                            ; 004b0839
    CALL core_event.cpp_CEventList_findCounter_FUN_004b0950 ; 004b083a
