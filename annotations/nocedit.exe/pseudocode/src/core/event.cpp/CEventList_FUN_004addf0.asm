...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_event_cpp_CEventList_FUN_004addf0(CEventList *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 004ade25
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 004ade26
    ...
    PUSH EAX                            ; 004ade7c
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 004ade7d
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c__sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH EAX                            ; 004adeed
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 004adeee
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c__sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH EAX                            ; 004adf96
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 004adf97
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c__sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH EAX                            ; 004ae014
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 004ae015
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c__sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH ESI                            ; 004ae060
        ;   Label: LAB_004ae060
    CALL core_event.cpp_CEventList_FUN_004b0db0 ; 004ae061
    ...
    PUSH EAX                            ; 004ae0b8
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 004ae0b9
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c__sprintf_FUN_005fdbd0(char * buffer, char * format)
