...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_event.cpp_CEventList_FUN_004addf0(CEventList * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004addf0
        ;   Label: core_event.cpp_CEventList_FUN_004addf0
    PUSH ESI                            ; 004addf1
    PUSH EDI                            ; 004addf2
    PUSH EBP                            ; 004addf3
    ...
    JLE 0x004ade60                      ; 004ade10 | LAB_004ade60
        ;   XREF to: 004ade60 (CONDITIONAL_JUMP)
    LEA EBP,[ESI + 0x190c]              ; 004ade12
    PUSH EBP                            ; 004ade18
        ;   Label: LAB_004ade18
    PUSH 0x6252c4                       ; 004ade19 | = "Game Flag: %s" | s_Game_Flag_s_006252c4 = Game Flag: %s
    LEA EAX,[ESP + 0x198]               ; 004ade1e
    PUSH EAX                            ; 004ade25
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 004ade26 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 004ade40 | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [ESI + 0x1908]    ; 004ade45
    ADD ESP,0xc                         ; 004ade4b
    CMP EDI,ECX                         ; 004ade4e
    JL 0x004ade18                       ; 004ade50 | LAB_004ade18
    ...
    JLE 0x004adeb0                      ; 004ade6a | LAB_004adeb0
        ;   XREF to: 004adeb0 (CONDITIONAL_JUMP)
    LEA EDI,[ESI + 0x2590]              ; 004ade6c
    PUSH EDI                            ; 004ade72
        ;   Label: LAB_004ade72
    PUSH 0x6252d2                       ; 004ade73 | = "Persistent: %s" | s_Persistent_s_006252d2 = Persistent: %s
    LEA EAX,[ESP + 0x8]                 ; 004ade78
    PUSH EAX                            ; 004ade7c
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 004ade7d | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ...
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 004ade94 | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [ESI + 0x258c]    ; 004ade99
    ADD ESP,0xc                         ; 004ade9f
    CMP EBP,EAX                         ; 004adea2
    JL 0x004ade72                       ; 004adea4 | LAB_004ade72
    ...
    JLE 0x004adf30                      ; 004adeba | LAB_004adf30
    ...
    PUSH 0x6252e1                       ; 004adee1 | = "Timer: %5.2f %s" | s_Timer_5_2f_s_006252e1 = Timer: %5.2f %s
    LEA EAX,[ESP + 0xd8]                ; 004adee6
    PUSH EAX                            ; 004adeed
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 004adeee | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 004adf00
    INC EDI                             ; 004adf01
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 004adf02 | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ...
    JL 0x004adecd                       ; 004adf29 | LAB_004adecd
    ...
    JLE 0x004adf60                      ; 004adf3a | LAB_004adf60
    ...
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 004adf4a | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004adf4f
    MOV ECX,dword ptr [ESI + 0xc84]     ; 004adf52
    ADD EDI,0x20                        ; 004adf58
    CMP EBP,ECX                         ; 004adf5b
    JL 0x004adf42                       ; 004adf5d | LAB_004adf42
    ...
    JLE 0x004adfe0                      ; 004adf6a | LAB_004adfe0
    ...
    PUSH EDX                            ; 004adf89
    PUSH 0x6252f1                       ; 004adf8a | = "%s=%d" | s_s_d_006252f1 = %s=%d
    LEA EAX,[ESP + 0x32c]               ; 004adf8f
    PUSH EAX                            ; 004adf96
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 004adf97 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ...
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 004adfad | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ...
    JL 0x004adf7b                       ; 004adfd2 | LAB_004adf7b
    ...
    JLE 0x004ae060                      ; 004adfea | LAB_004ae060
    ...
    PUSH ECX                            ; 004ae007
    PUSH 0x6252f7                       ; 004ae008 | = "%s=%s" | s_s_s_006252f7 = %s=%s
    LEA EAX,[ESP + 0x2c8]               ; 004ae00d
    PUSH EAX                            ; 004ae014
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 004ae015 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 004ae027
    INC EBP                             ; 004ae028
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 004ae029 | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ...
    JL 0x004adfff                       ; 004ae050 | LAB_004adfff
    ...
    PUSH ESI                            ; 004ae060
        ;   Label: LAB_004ae060
    CALL core_event.cpp_CEventList_FUN_004b0db0 ; 004ae061 | void core_event.cpp_CEventList_FUN_004b0db0(CEventList * this_ptr)
    ...
    JLE 0x004ae110                      ; 004ae07a | LAB_004ae110
    ...
    PUSH ECX                            ; 004ae0ab
    PUSH 0x6252fd                       ; 004ae0ac | = "%s=%s %.1f" | s_s_s_1f_006252fd = %s=%s %.1f
    LEA EAX,[ESP + 0x26c]               ; 004ae0b1
    PUSH EAX                            ; 004ae0b8
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 004ae0b9 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ...
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 004ae0db | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ...
    JL 0x004ae095                       ; 004ae10d | LAB_004ae095
