...
// Convention: __cdecl
// Signature: int __cdecl core_event_cpp_CEventList_loadState_FUN_004b0fc0(CEventList *this_ptr)
...

{
  ...
  _fgets(local_120,0xff,in_stack_00000008);
  ...
  if (1 < local_20) {
    ...
    if (0 < iVar1) {
      ...
      do {
        iVar1 = _fscanf(in_stack_00000008,"%f, %[^\n]\n",pcVar3,piVar4);
        piVar4 = piVar4 + 8;
        pcVar3 = pcVar3 + 4;
        local_14 = local_14 + 1;
