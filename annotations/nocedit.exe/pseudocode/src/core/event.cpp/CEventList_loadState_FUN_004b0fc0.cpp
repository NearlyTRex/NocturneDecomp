...

{
  ...
  if (0 < this_ptr->persistent_event_count) {
    pCVar4 = this_ptr->persistent_event_list;
    do {
      iVar2 = iVar2 + 1;
  ...
  if (1 < local_20) {
    ...
    local_14 = 0;
    if (0 < iVar1) {
      piVar5 = &this_ptr->timer_list;
      pcVar3 = this_ptr->field14_0x3218 + 0x13c;
      do {
  ...
  if (2 < local_20) {
    ...
    if (0 < iVar1) {
      local_18 = this_ptr->field16_0x3380;
      pcVar3 = this_ptr->field16_0x3380 + 0x140;
      do {
        crt_stdio_c_fscanf_FUN_005fe7c0(in_stack_00000008,"%d, %[^\n]\n",pcVar3,local_18);
        iVar2 = iVar2 + 1;
        pcVar3 = pcVar3 + 4;
  ...
  if (4 < local_20) {
    ...
    if (0 < this_ptr->game_flag_count) {
      pCVar4 = this_ptr->game_flag_list;
      do {
        iVar2 = iVar2 + 1;
        crt_stdio_c_fscanf_FUN_005fe7c0(in_stack_00000008,"%[^\n]\n",pCVar4);
        pCVar4 = pCVar4 + 0x20;
