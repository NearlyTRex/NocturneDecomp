...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_event.cpp_CEventList_loadState_FUN_004b0fc0(CEventList * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004b0fd8
    CALL core_event.cpp_CEventList_FUN_004aaa70 ; 004b0fd9 | void core_event.cpp_CEventList_FUN_004aaa70(CEventList * this_ptr)
    ...
    PUSH EAX                            ; 004b0feb
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 004b0fec | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
    ...
    PUSH ESI                            ; 004b1001
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004b1002 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004b1007
    MOV EDX,dword ptr [ESP + 0x100]     ; 004b100a
    CMP EDX,0x5                         ; 004b1011
    JG 0x004b12eb                       ; 004b1014 | LAB_004b12eb
    ...
    PUSH EAX                            ; 004b1024
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 004b1025 | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004b1036 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EBX]             ; 004b103b
    ADD ESP,0xc                         ; 004b103d
    TEST EAX,EAX                        ; 004b1040
    JLE 0x004b1060                      ; 004b1042 | LAB_004b1060
    ...
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004b1052 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [EBX]             ; 004b1057
    ADD ESP,0xc                         ; 004b1059
    CMP EBP,EDX                         ; 004b105c
    JL 0x004b1047                       ; 004b105e | LAB_004b1047
    ...
    PUSH EDI                            ; 004b106a
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 004b106b | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004b1082 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [EBX + 0xc84]     ; 004b1087
    ADD ESP,0xc                         ; 004b108d
    TEST ECX,ECX                        ; 004b1090
    JLE 0x004b10c0                      ; 004b1092 | LAB_004b10c0
    ...
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004b10a5 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EBX + 0xc84]     ; 004b10aa
    ADD ESP,0xc                         ; 004b10b0
    CMP EBP,EAX                         ; 004b10b3
    JL 0x004b109a                       ; 004b10b5 | LAB_004b109a
    ...
    PUSH EDI                            ; 004b10ca
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 004b10cb | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004b10e2 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [EBX + 0x258c]    ; 004b10e7
    ADD ESP,0xc                         ; 004b10ed
    TEST EDX,EDX                        ; 004b10f0
    JLE 0x004b1120                      ; 004b10f2 | LAB_004b1120
    ...
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004b1105 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [EBX + 0x258c]    ; 004b110a
    ADD ESP,0xc                         ; 004b1110
    CMP EBP,ECX                         ; 004b1113
    JL 0x004b10fa                       ; 004b1115 | LAB_004b10fa
        ;   XREF to: 004b10fa (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 004b1117
    LEA EDX,[EDX]                       ; 004b111d
    CMP dword ptr [ESP + 0x100],0x2     ; 004b1120
        ;   Label: LAB_004b1120
    JL 0x004b11b0                       ; 004b1128 | LAB_004b11b0
        ;   XREF to: 004b11b0 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 004b112e
    PUSH 0xff                           ; 004b112f
    LEA EDI,[ESP + 0x8]                 ; 004b1134
    PUSH EDI                            ; 004b1138
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 004b1139 | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004b1150 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004b1155
    MOV EAX,dword ptr [EBX + 0x3210]    ; 004b1158
    MOV dword ptr [ESP + 0x10c],EBP     ; 004b115e
    TEST EAX,EAX                        ; 004b1165
    JLE 0x004b11b0                      ; 004b1167 | LAB_004b11b0
        ;   XREF to: 004b11b0 (CONDITIONAL_JUMP)
    ...
    PUSH ESI                            ; 004b117c
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004b117d | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ...
    JL 0x004b1175                       ; 004b11a2 | LAB_004b1175
        ;   XREF to: 004b1175 (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 004b11a4
    LEA EDX,[EDX]                       ; 004b11aa
    CMP dword ptr [ESP + 0x100],0x3     ; 004b11b0
        ;   Label: LAB_004b11b0
    JL 0x004b1240                       ; 004b11b8 | LAB_004b1240
        ;   XREF to: 004b1240 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 004b11be
    PUSH 0xff                           ; 004b11bf
    LEA EDI,[ESP + 0x8]                 ; 004b11c4
    PUSH EDI                            ; 004b11c8
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 004b11c9 | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004b11e0 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EBX + 0x337c]    ; 004b11e5
    ADD ESP,0xc                         ; 004b11eb
    TEST EAX,EAX                        ; 004b11ee
    JLE 0x004b1240                      ; 004b11f0 | LAB_004b1240
        ;   XREF to: 004b1240 (CONDITIONAL_JUMP)
    ...
    PUSH ESI                            ; 004b1213
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004b1214 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ...
    JL 0x004b1205                       ; 004b1239 | LAB_004b1205
        ;   XREF to: 004b1205 (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 004b123b
    MOV ECX,ECX                         ; 004b123e
    CMP dword ptr [ESP + 0x100],0x4     ; 004b1240
        ;   Label: LAB_004b1240
    JL 0x004b12d0                       ; 004b1248 | LAB_004b12d0
        ;   XREF to: 004b12d0 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 004b124e
    PUSH 0xff                           ; 004b124f
    LEA EDI,[ESP + 0x8]                 ; 004b1254
    PUSH EDI                            ; 004b1258
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 004b1259 | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004b1270 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [EBX + 0x34e8]    ; 004b1275
    ADD ESP,0xc                         ; 004b127b
    TEST ECX,ECX                        ; 004b127e
    JLE 0x004b12d0                      ; 004b1280 | LAB_004b12d0
        ;   XREF to: 004b12d0 (CONDITIONAL_JUMP)
    ...
    PUSH ESI                            ; 004b12a3
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004b12a4 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ...
    PUSH 0x5                            ; 004b12eb
        ;   Label: LAB_004b12eb
    PUSH EDX                            ; 004b12ed
    MOV ECX,0x625d47                    ; 004b12ee | = "..\\core\\event.cpp" | s_core_event_cpp_00625d47 = ..\core\event.cpp
    MOV EDI,0xc2c                       ; 004b12f3
    PUSH 0x625d59                       ; 004b12f8 | = "CEventList::loadState - file version ..." | s_CEventList_loadState_fil_00625d59 = CEventList::loadState - file version %d is newer than .EXE, which can only handle up to version %d
    MOV dword ptr [0x02f0ca48],ECX      ; 004b12fd | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 004b1303 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004b1309 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004b130e
    JMP 0x004b101a                      ; 004b1311 | LAB_004b101a
    ...
    PUSH EDI                            ; 004b1320
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 004b1321 | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004b1338 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    MOV EBP,dword ptr [EBX + 0x1908]    ; 004b133d
    ADD ESP,0xc                         ; 004b1343
    TEST EBP,EBP                        ; 004b1346
    JLE 0x004b12e0                      ; 004b1348 | LAB_004b12e0
    ...
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004b135b | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EBX + 0x1908]    ; 004b1360
    ADD ESP,0xc                         ; 004b1366
    CMP EDI,EAX                         ; 004b1369
    JL 0x004b1350                       ; 004b136b | LAB_004b1350
