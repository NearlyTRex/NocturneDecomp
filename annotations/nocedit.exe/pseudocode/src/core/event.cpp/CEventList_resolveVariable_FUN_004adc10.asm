...
;
; XREF[1]:
;   core_event.cpp_CEventList_evaluateAtom_FUN_004ae140 at 004ae31e
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004adc10
        ;   Label: core_event.cpp_CEventList_resolveVariable_FUN_004adc10
    PUSH ESI                            ; 004adc11
    PUSH EDI                            ; 004adc12
    PUSH EBP                            ; 004adc13
    ...
    PUSH EBP                            ; 004adc5c
        ;   Label: LAB_004adc5c
    PUSH EDI                            ; 004adc5d
    CALL core_event.cpp_CEventList_findPersistentEvent_FUN_004b0860 ; 004adc5e
    ...
    PUSH EBP                            ; 004adc74
        ;   Label: LAB_004adc74
    PUSH EDI                            ; 004adc75
    CALL core_event.cpp_CEventList_findGameFlag_FUN_004b08b0 ; 004adc76
        ;   XREF to: 004b08b0 (UNCONDITIONAL_CALL)  ; int core_event.cpp_CEventList_findGameFlag_FUN_004b08b0(CEventList * this_ptr, char * name)
    ...
    PUSH EBP                            ; 004adc82
    PUSH EDI                            ; 004adc83
    CALL core_event.cpp_CEventList_findTimer_FUN_004b0900 ; 004adc84
