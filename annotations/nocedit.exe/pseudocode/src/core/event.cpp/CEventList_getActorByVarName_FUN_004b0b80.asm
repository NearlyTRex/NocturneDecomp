...
;
; XREF[2]:
;   core_event.cpp_resolveActorByName_FUN_004aa400 at 004aa41f
...
section .text
    ...
    PUSH EBX                            ; 004b0b80
        ;   Label: core_event.cpp_CEventList_getActorByVarName_FUN_004b0b80
    PUSH ESI                            ; 004b0b81
    PUSH EDI                            ; 004b0b82
    PUSH EBP                            ; 004b0b83
    ...
    PUSH EDX                            ; 004b0b8c
    PUSH EDI                            ; 004b0b8d
    CALL core_event.cpp_CEventList_findActorVariable_FUN_004b0bf0 ; 004b0b8e
    ...
    MOV EAX,[0x006810c8]                ; 004b0baf | g_CDemonSetInstance | g_CDemonSetPtr
        ;   Label: LAB_004b0baf
    CMP ESI,dword ptr [EAX + 0x14d154]  ; 004b0bb4 | g_CDemonSetInstance.actor_count
    ...
    MOV EAX,dword ptr [EBX + EAX*0x1 + 0x14d158] ; 004b0be3 | g_CDemonSetInstance.actors[0]
    POP EBP                             ; 004b0bea
    POP EDI                             ; 004b0beb
    POP ESI                             ; 004b0bec
    POP EBX                             ; 004b0bed
