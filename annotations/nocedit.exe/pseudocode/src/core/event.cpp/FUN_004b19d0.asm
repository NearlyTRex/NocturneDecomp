...
section .text
    ...
    JBE 0x004b1a18                      ; 004b19ec | LAB_004b1a18
    ...
    JMP dword ptr [EBX*0x4 + 0x679d10]  ; 004b19f9 | pointer switchdataD_00679d10
        ;   Label: switchD
    ...
    MOV dword ptr [ECX + -0x4],EDX      ; 004b1a07
        ;   Label: caseD_4
    JBE 0x004b1a18                      ; 004b1a0a | LAB_004b1a18
        ;   XREF to: 004b1a18 (CONDITIONAL_JUMP)
    FLD ST0                             ; 004b1a0c
        ;   Label: caseD_0
    ...
    JA 0x004b1a0c                       ; 004b1a16 | caseD_0
    ...
    JA 0x004b1a0c                       ; 004b1a26 | caseD_0
        ;   XREF to: 004b1a0c (CONDITIONAL_JUMP)
    JMP 0x004b1a18                      ; 004b1a28 | LAB_004b1a18
        ;   XREF to: 004b1a18 (UNCONDITIONAL_JUMP)
    MOV byte ptr [ECX + -0x3],DL        ; 004b1a2c
        ;   Label: caseD_3
    MOV word ptr [ECX + -0x2],DX        ; 004b1a2f
        ;   Label: caseD_2
    JA 0x004b1a0c                       ; 004b1a33 | caseD_0
        ;   XREF to: 004b1a0c (CONDITIONAL_JUMP)
    JMP 0x004b1a18                      ; 004b1a35 | LAB_004b1a18
        ;   XREF to: 004b1a18 (UNCONDITIONAL_JUMP)
    MOV byte ptr [ECX + -0x1],DL        ; 004b1a38
        ;   Label: caseD_1
    JA 0x004b1a0c                       ; 004b1a3b | caseD_0
        ;   XREF to: 004b1a0c (CONDITIONAL_JUMP)
    JMP 0x004b1a18                      ; 004b1a3d | LAB_004b1a18
        ;   XREF to: 004b1a18 (UNCONDITIONAL_JUMP)
