...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_event.cpp_FUN_004aa6c0()
;
;
; XREF[1]:
;   core_event.cpp_CEventList_FUN_004aacc0 at 004ab821
;
; Referenced Globals:
...
section .text
    ...
    TEST byte ptr [EAX + 0x6849c4],0x2  ; 004aa6d7 | char[256] g_CharacterClassificationTable
    JZ 0x004aa6e3                       ; 004aa6de | LAB_004aa6e3
        ;   XREF to: 004aa6e3 (CONDITIONAL_JUMP)
    INC ECX                             ; 004aa6e0
    JMP 0x004aa6ce                      ; 004aa6e1 | LAB_004aa6ce
        ;   XREF to: 004aa6ce (UNCONDITIONAL_JUMP)
    MOV dword ptr [ESI],ECX             ; 004aa6e3
        ;   Label: LAB_004aa6e3
    CMP byte ptr [ECX],0x28             ; 004aa6e5
    JNZ 0x004aa724                      ; 004aa6e8 | LAB_004aa724
        ;   XREF to: 004aa724 (CONDITIONAL_JUMP)
    XOR EBX,EBX                         ; 004aa6ea
    XOR ECX,ECX                         ; 004aa6ec
    TEST EDI,EDI                        ; 004aa6ee
    JLE 0x004aa71a                      ; 004aa6f0 | LAB_004aa71a
    ...
    JL 0x004aa6f2                       ; 004aa718 | LAB_004aa6f2
        ;   XREF to: 004aa6f2 (CONDITIONAL_JUMP)
    MOV EAX,0x624549                    ; 004aa71a | = "Argument too long" | s_Argument_too_long_00624549 = Argument too long
        ;   Label: LAB_004aa71a
    POP EBP                             ; 004aa71f
    POP EDI                             ; 004aa720
    POP ESI                             ; 004aa721
    POP EBX                             ; 004aa722
    RET                                 ; 004aa723
    MOV EAX,0x624532                    ; 004aa724 | = "No opening parenthesis" | s_No_opening_parenthesis_00624532 = No opening parenthesis
        ;   Label: LAB_004aa724
    POP EBP                             ; 004aa729
    POP EDI                             ; 004aa72a
    POP ESI                             ; 004aa72b
    POP EBX                             ; 004aa72c
    RET                                 ; 004aa72d
    MOV EAX,0x62455b                    ; 004aa72e | = "Can't find closing parenthesis" | s_Can_t_find_closing_paren_0062455b = Can't find closing parenthesis
        ;   Label: LAB_004aa72e
    POP EBP                             ; 004aa733
    POP EDI                             ; 004aa734
    POP ESI                             ; 004aa735
    ...
    CMP DH,0x29                         ; 004aa738
        ;   Label: LAB_004aa738
    JNZ 0x004aa706                      ; 004aa73b | LAB_004aa706
        ;   XREF to: 004aa706 (CONDITIONAL_JUMP)
    TEST EBX,EBX                        ; 004aa73d
    JZ 0x004aa744                       ; 004aa73f | LAB_004aa744
        ;   XREF to: 004aa744 (CONDITIONAL_JUMP)
    DEC EBX                             ; 004aa741
    JMP 0x004aa706                      ; 004aa742 | LAB_004aa706
    ...
    JLE 0x004aa77d                      ; 004aa764 | LAB_004aa77d
    ...
    TEST byte ptr [EDX + 0x6849c4],0x2  ; 004aa774 | char[256] g_CharacterClassificationTable
    JNZ 0x004aa7a7                      ; 004aa77b | LAB_004aa7a7
    ...
    TEST byte ptr [EAX + 0x6849c4],0x2  ; 004aa790 | char[256] g_CharacterClassificationTable
    JZ 0x004aa7af                       ; 004aa797 | LAB_004aa7af
        ;   XREF to: 004aa7af (CONDITIONAL_JUMP)
    PUSH EBX                            ; 004aa799
    PUSH EDI                            ; 004aa79a
    PUSH EBP                            ; 004aa79b
    DEC EBX                             ; 004aa79c
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 004aa79d | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
        ;   XREF to: 005fe5e0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004aa7a2
    JMP 0x004aa786                      ; 004aa7a5 | LAB_004aa786
        ;   XREF to: 004aa786 (UNCONDITIONAL_JUMP)
    DEC EBX                             ; 004aa7a7
        ;   Label: LAB_004aa7a7
    DEC EAX                             ; 004aa7a8
    TEST EBX,EBX                        ; 004aa7a9
    JG 0x004aa769                       ; 004aa7ab | LAB_004aa769
        ;   XREF to: 004aa769 (CONDITIONAL_JUMP)
    JMP 0x004aa77d                      ; 004aa7ad | LAB_004aa77d
    ...
    INC BL                              ; 004aa7b5
    MOV CL,BL                           ; 004aa7b7
    TEST byte ptr [ECX + 0x6849c4],0x2  ; 004aa7b9 | char[256] g_CharacterClassificationTable
    JZ 0x004aa7c5                       ; 004aa7c0 | LAB_004aa7c5
        ;   XREF to: 004aa7c5 (CONDITIONAL_JUMP)
    INC EAX                             ; 004aa7c2
    JMP 0x004aa7b1                      ; 004aa7c3 | LAB_004aa7b1
