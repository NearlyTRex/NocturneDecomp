...
section .text
    ...
    JL 0x004b1697                       ; 004b1691 | LAB_004b1697
        ;   XREF to: 004b1697 (CONDITIONAL_JUMP)
    CMP ESI,dword ptr [EBX]             ; 004b1693
    JLE 0x004b16ba                      ; 004b1695 | LAB_004b16ba
        ;   XREF to: 004b16ba (CONDITIONAL_JUMP)
    MOV ECX,0x625f5d                    ; 004b1697 | = "..\\core\\event.cpp" | s_core_event_cpp_00625f5d = ..\core\event.cpp
        ;   Label: LAB_004b1697
    MOV EDI,0xcd9                       ; 004b169c
    PUSH 0x625f6f                       ; 004b16a1 | = "CRuleList::insert - invalid index" | s_CRuleList_insert_invalid_00625f6f = CRuleList::insert - invalid index
    MOV dword ptr [0x02f0ca48],ECX      ; 004b16a6 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 004b16ac | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004b16b2 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004b16b7
    CMP dword ptr [EBX],0x5             ; 004b16ba
        ;   Label: LAB_004b16ba
    JGE 0x004b1794                      ; 004b16bd | LAB_004b1794
    ...
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 004b1710 | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
    ...
    PUSH EAX                            ; 004b1740
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 004b1741 | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
        ;   XREF to: 005fe5e0 (UNCONDITIONAL_CALL)
    ...
    CMP AL,0x0                          ; 004b1757
    JZ 0x004b176b                       ; 004b1759 | LAB_004b176b
    ...
    CMP AL,0x0                          ; 004b1767
    JNZ 0x004b1753                      ; 004b1769 | LAB_004b1753
    ...
    CMP AL,0x0                          ; 004b1777
    JZ 0x004b178b                       ; 004b1779 | LAB_004b178b
    ...
    CMP AL,0x0                          ; 004b1787
    JNZ 0x004b1773                      ; 004b1789 | LAB_004b1773
    ...
    POP EBX                             ; 004b1792
    RET                                 ; 004b1793
    MOV EAX,0x625f91                    ; 004b1794 | = "..\\core\\event.cpp" | s_core_event_cpp_00625f91 = ..\core\event.cpp
        ;   Label: LAB_004b1794
    MOV EDX,0xcda                       ; 004b1799
    PUSH 0x625fa3                       ; 004b179e | = "CRuleList::insert - list full" | s_CRuleList_insert_list_fu_00625fa3 = CRuleList::insert - list full
    MOV [0x02f0ca48],EAX                ; 004b17a3 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 004b17a8 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004b17ae | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004b17b3
    JMP 0x004b16c3                      ; 004b17b6 | LAB_004b16c3
