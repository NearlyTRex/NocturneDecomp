...
;
; XREF[2]:
;   core_event.cpp_CEventList_addOrRemoveGameFlag_FUN_004b0470 at 004b048a
;   core_event.cpp_CEventList_resolveVariable_FUN_004adc10 at 004adc76
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 004b08b0
        ;   Label: core_event.cpp_CEventList_findGameFlag_FUN_004b08b0
    PUSH ESI                            ; 004b08b1
    PUSH EDI                            ; 004b08b2
    PUSH EBP                            ; 004b08b3
    ...
    PUSH EBP                            ; 004b08ce
        ;   Label: LAB_004b08ce
    PUSH ESI                            ; 004b08cf
    CALL crt_string.c__stricmp_FUN_005fe7f0 ; 004b08d0
