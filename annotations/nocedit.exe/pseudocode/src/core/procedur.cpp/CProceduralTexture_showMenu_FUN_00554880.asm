...
section .text
    ...
    PUSH EBX                            ; 00554880
        ;   Label: core_procedur.cpp_CProceduralTexture_showMenu_FUN_00554880
    PUSH ESI                            ; 00554881
    PUSH EDI                            ; 00554882
    ...
    PUSH ESI                            ; 005548e3
        ;   Label: LAB_005548e3
    CALL core_procedur.cpp_CProceduralTexture_createWaterFrames_FUN_005542b0 ; 005548e4
        ;   XREF to: 005542b0 (UNCONDITIONAL_CALL)  ; void core_procedur.cpp_CProceduralTexture_createWaterFrames_FUN_005542b0(CProceduralTexture * this_ptr)
