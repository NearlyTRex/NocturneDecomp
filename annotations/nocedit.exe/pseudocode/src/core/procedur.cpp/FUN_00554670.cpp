...

{
  ...
  do {
    ...
    do {
      ...
      if ((fVar1 <= local_28) && (in_stack_00000010 <= fVar1)) {
        fVar6 = (float10)fsin(((float10)local_38 - (float10)SQRT(fVar1)) * (float10)0.03125f *
        ...
        local_14 = (byte)(int)ROUND(dVar7);
        (&DAT_030f6158)[extraout_ECX_00] = local_14;
  ...
  do {
    ...
    do {
      ...
      uVar3 = (uint)*(byte *)(iVar5 + 8) + (uint)(byte)(&DAT_030f6158)[local_1c * 0x100 + local_18];
      if (0xff < uVar3) {
        uVar3 = 0xff;
      }
      iVar5 = iVar5 + 1;
