...
;
; XREF[1]:
;   core_procedur.cpp_CreateProceduralWaterFrame_FUN_005542b0 at 005543e5
;
; Referenced Globals:
...
section .text
    ...
    FLD double ptr [0x006409f8]         ; 00554629 | double DOUBLE_006409f8
    FLD float ptr [EBP + 0x10]          ; 0055462f
    FMUL ST1                            ; 00554632
    FMUL double ptr [0x00640a00]        ; 00554634 | double DOUBLE_00640a00
    FADD float ptr [EBP + 0xc]          ; 0055463a
    FST float ptr [ESP]                 ; 0055463d
    FCOMPP                              ; 00554640
    FNSTSW AX                           ; 00554642
    SAHF                                ; 00554644
    JA 0x0055464e                       ; 00554645 | LAB_0055464e
    ...
    FLD float ptr [ESP]                 ; 0055464e
        ;   Label: LAB_0055464e
    FADD float ptr [0x00640a08]         ; 00554651 | float FLOAT_00640a08
