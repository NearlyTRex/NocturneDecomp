...

{
  ...
  if (*(int *)this_ptr->field1_0x578 < 1) {
    ...
    iStack_1c = SUB84 /* extract 2-byte value */(dVar3,0);
    local_18 = (int)((ulonglong)dVar3 >> 0x20);
    local_1dc[0] = (float)dVar3;
    if (0.0 <= local_1dc[0]) {
      sound_sndmain_cpp_lockSound_FUN_005abd30();
      local_1dc[0] = local_1dc[0] * 6f;
      uStack_24 = (double)local_1dc[0];
      dVar4 = crt_math_c_floor_FUN_005feb90(uStack_24);
      uStack_24._4_4_ = SUB84 /* extract 2-byte value */(dVar4,0);
      iStack_1c = (int)((ulonglong)dVar4 >> 0x20);
      dVar3 = (double)CONCAT44 /* combine 2-byte values */((uint)uStack_24,local_28);
      sound_sndmain_cpp_CSfxSample_init_FUN_005a8480((CSfxSample *)local_1dc);
      iVar1 = sound_sndmain_cpp_getSfxSampleInfo_FUN_005a96e0
                        (*(uint *)(extraout_EBX + 0x57c),(CSfxSample *)local_1dc);
      if (iVar1 != 0) {
        local_18 = local_cc;
        dVar3 = crt_math_c_round_FUN_005fe6b0
                          ((double)((float)local_cc * (float)((float10)dVar3 - (float10)dVar4) *
                                   0.1666667f));
  ...
  *(int *)this_ptr->field1_0x578 = *(int *)this_ptr->field1_0x578 + -1;
  ...
  sound_sndmain_cpp_killSfx_FUN_005a9c40(*(uint *)(this_ptr->field1_0x578 + 4));
  crt_stdio_c_sprintf_FUN_005fdbd0(acStack_88,"m-gun1.wav @ 2.3 * %f",(double)base_frequency);
  ...
  uVar2 = (*((this_ptr->base_weapon).base_actor.vtable)->playAmbientSound)
                    ((CDemonActor *)this_ptr,acStack_88);
