...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_tommygun.cpp_CTommyGun_process_FUN_005de360(CTommyGun * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005de375
    CALL core_weapon.cpp_CWeapon_process_FUN_005ee110 ; 005de376 | void core_weapon.cpp_CWeapon_process_FUN_005ee110(CWeapon * this_ptr)
        ;   XREF to: 005ee110 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [EBX + 0x578]     ; 005de37b
    ADD ESP,0x8                         ; 005de381
    TEST EDX,EDX                        ; 005de384
    JLE 0x005de436                      ; 005de386 | LAB_005de436
    ...
    CALL core_actor.cpp_getRandomFloat_FUN_0040cc10 ; 005de39f | float core_actor.cpp_getRandomFloat_FUN_0040cc10(float min_value, float max_value)
        ;   XREF to: 0040cc10 (UNCONDITIONAL_CALL)
    PUSH 0x2                            ; 005de436
        ;   Label: LAB_005de436
    MOV ECX,dword ptr [EBX + 0x57c]     ; 005de438
    PUSH ECX                            ; 005de43e
    CALL sound_sndmain.cpp_getSfxPlaybackPosition_FUN_005a9720 ; 005de43f | double sound_sndmain.cpp_getSfxPlaybackPosition_FUN_005a9720(uint sfx_handle, uint output_format)
    ...
    FNSTSW AX                           ; 005de464
    SAHF                                ; 005de466
    JA 0x005de580                       ; 005de467 | LAB_005de580
        ;   XREF to: 005de580 (CONDITIONAL_JUMP)
    CALL sound_sndmain.cpp_lockSound_FUN_005abd30 ; 005de46d | void sound_sndmain.cpp_lockSound_FUN_005abd30()
        ;   XREF to: 005abd30 (UNCONDITIONAL_CALL)
    FLD float ptr [ESP + 0x10]          ; 005de472
    FMUL float ptr [0x0065550d]         ; 005de476 | float FLOAT_0065550d
    ...
    PUSH EAX                            ; 005de496
    CALL crt_math.c_floor_FUN_005feb90  ; 005de497 | double crt_math.c_floor_FUN_005feb90(double input_value)
    ...
    CALL sound_sndmain.cpp_CSfxSample_init_FUN_005a8480 ; 005de4c4 | CSfxSample * sound_sndmain.cpp_CSfxSample_init_FUN_005a8480(CSfxSample * this_ptr)
    ...
    PUSH EDX                            ; 005de4d7
    CALL sound_sndmain.cpp_getSfxSampleInfo_FUN_005a96e0 ; 005de4d8 | int sound_sndmain.cpp_getSfxSampleInfo_FUN_005a96e0(uint sfx_handle, CSfxSample * output_buffer)
        ;   XREF to: 005a96e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005de4dd
    TEST EAX,EAX                        ; 005de4e0
    JZ 0x005de565                       ; 005de4e2 | LAB_005de565
    ...
    FMUL float ptr [0x00655511]         ; 005de501 | float FLOAT_00655511
    CALL crt_math.c_round_FUN_005fe6b0  ; 005de507 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x8]         ; 005de50c
    CALL sound_sndmain.cpp_pushSfxOptions_FUN_005a8c30 ; 005de510 | void sound_sndmain.cpp_pushSfxOptions_FUN_005a8c30()
    ...
    FNSTSW AX                           ; 005de52f
    SAHF                                ; 005de531
    JNC 0x005de548                      ; 005de532 | LAB_005de548
    ...
    PUSH ESI                            ; 005de53f
    CALL sound_sndmain.cpp_setNextSfxTriggerTime_FUN_005a8be0 ; 005de540 | void sound_sndmain.cpp_setNextSfxTriggerTime_FUN_005a8be0(double trigger_time, int trigger_id)
        ;   XREF to: 005a8be0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005de545
    PUSH 0x6554ff                       ; 005de548 | = "m-gun-t.wav" | s_m_gun_t_wav_006554ff = m-gun-t.wav
        ;   Label: LAB_005de548
    ...
    CALL sound_sndmain.cpp_popSfxOptions_FUN_005a8cb0 ; 005de560 | void sound_sndmain.cpp_popSfxOptions_FUN_005a8cb0()
        ;   XREF to: 005a8cb0 (UNCONDITIONAL_CALL)
    MOV EDI,dword ptr [EBX + 0x57c]     ; 005de565
        ;   Label: LAB_005de565
    PUSH EDI                            ; 005de56b
    CALL sound_sndmain.cpp_killSfx_FUN_005a9c40 ; 005de56c | int sound_sndmain.cpp_killSfx_FUN_005a9c40(uint sfx_handle)
        ;   XREF to: 005a9c40 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005de571
    CALL sound_sndmain.cpp_unlockSound_FUN_005abdc0 ; 005de574 | void sound_sndmain.cpp_unlockSound_FUN_005abdc0()
    ...
    MOV ESI,dword ptr [EBX + 0x57c]     ; 005de580
        ;   Label: LAB_005de580
    PUSH ESI                            ; 005de586
    CALL sound_sndmain.cpp_killSfx_FUN_005a9c40 ; 005de587 | int sound_sndmain.cpp_killSfx_FUN_005a9c40(uint sfx_handle)
        ;   XREF to: 005a9c40 (UNCONDITIONAL_CALL)
