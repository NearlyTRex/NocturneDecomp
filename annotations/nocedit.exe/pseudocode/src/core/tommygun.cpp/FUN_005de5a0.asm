...
section .text
    ...
    PUSH EDX                            ; 005de5ab
    CALL sound_sndmain.cpp_killSfx_FUN_005a9c40 ; 005de5ac | int sound_sndmain.cpp_killSfx_FUN_005a9c40(uint sfx_handle)
    ...
    PUSH EBX                            ; 005de5bd
    CALL core_weapon.cpp_CWeapon_FUN_005ee640 ; 005de5be | void core_weapon.cpp_CWeapon_FUN_005ee640(CWeapon * this_ptr)
