// Name: core_weather.cpp_CWeather_FUN_005eeeb0
// Address: 005eeeb0
// Address Range: [[005eeeb0, 005eeecf]]
// Convention: __cdecl
// Signature: void __cdecl core_weather_cpp_CWeather_FUN_005eeeb0(CWeather *this_ptr)
...

{
  ...
  *(float *)(this_ptr->unk + 0x20) = local_14;
  local_14 = core_actor_cpp_getRandomFloat_FUN_0040cc10(2.0,*(float *)(this_ptr->unk + 0x34));
  *(uint *)(this_ptr->unk + 0x28) = in_stack_00000008;
  ...
  *(float *)(this_ptr->unk + 0x2c) = local_14;
  ...
  core_dirmat_cpp_CMatrix3x3f_buildRotationMatrix_FUN_00471d30
            (&local_94,(CVector3f *)(this_ptr->unk + 0x14));
  local_6c.z = local_18;
  local_6c.x = 0.0;
  local_6c.y = 0.0;
  pCVar3 = core_dirmat_cpp_CMatrix3x3f_transformVector_FUN_00471fd0(&local_94,&local_3c,&local_6c);
  local_48.x = pCVar3->x + *(float *)(this_ptr->unk + 8);
  local_48.y = pCVar3->y + *(float *)(this_ptr->unk + 0xc);
  local_48.z = pCVar3->z + *(float *)(this_ptr->unk + 0x10);
  ...
  *(float *)(this_ptr->unk + 0x30) = fVar2 * fVar1;
