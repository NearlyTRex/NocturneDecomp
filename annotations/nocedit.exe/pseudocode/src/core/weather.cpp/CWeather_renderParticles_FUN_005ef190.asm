...
; Local Variables:
; SMRGLPrimitiveQuadIndex Stack[-0xf0]:40  local_f0
...
;   undefined4 g_RenderBufferPool[194].texture_data.texture_name[4]
...
section .text
    ...
    CALL engine_drender.cpp_CDemonRenderer_getCameraRotationRadians_FUN_0048c800 ; 005ef1bb
    ...
    MOV dword ptr [EDX + 0x48],0x780000 ; 005ef20e | g_RenderBufferPool[194].texture_data.texture_name[4]
    ...
    MOV dword ptr [EDX + 0x78],0x780000 ; 005ef220 | g_RenderBufferPool[194].texture_data.texture_name[4]
    ...
    PUSH EAX                            ; 005ef32a
    PUSH EBP                            ; 005ef32b
    CALL engine_special.cpp_transformPoint_FUN_005b5a25 ; 005ef32c
    ...
    PUSH EAX                            ; 005ef4b6
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 005ef4b7
    ...
    PUSH EAX                            ; 005ef513
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 005ef514
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    PUSH EAX                            ; 005ef570
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 005ef571
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    PUSH EAX                            ; 005ef5c9
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 005ef5ca
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    CALL engine_drender.cpp_CDemonRenderer_renderBlendedDirect_FUN_0048bcf0 ; 005ef5dd
    ...
    CALL engine_drender.cpp_CDemonRenderer_matrixPop_FUN_0048c640 ; 005ef5ec
        ;   XREF to: 0048c640 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_matrixPop_FUN_0048c640(CDemonRenderer * this_ptr)
    ADD ESP,0x4                         ; 005ef5f1
    INC EDI                             ; 005ef5f4
        ;   Label: LAB_005ef5f4
    ...
    MOV dword ptr [EDX + 0x48],0x780000 ; 005ef63e | g_RenderBufferPool[194].texture_data.texture_name[4]
    ...
    MOV dword ptr [EDX + 0x78],0x780000 ; 005ef650 | g_RenderBufferPool[194].texture_data.texture_name[4]
    ...
    PUSH EAX                            ; 005ef79e
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 005ef79f
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    PUSH EAX                            ; 005ef7ec
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 005ef7ed
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    PUSH EAX                            ; 005ef838
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 005ef839
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    PUSH EAX                            ; 005ef88e
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 005ef88f
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    CALL engine_drender.cpp_CDemonRenderer_renderBlendedDirect_FUN_0048bcf0 ; 005ef8a3
        ;   XREF to: 0048bcf0 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_renderBlendedDirect_FUN_0048bcf0(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * prim)
    ADD ESP,0x8                         ; 005ef8a8
    MOV EBX,dword ptr [0x006703ec]      ; 005ef8ab | g_CDemonRendererPtr2
    PUSH EBX                            ; 005ef8b1 | g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_matrixPop_FUN_0048c640 ; 005ef8b2
        ;   XREF to: 0048c640 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_matrixPop_FUN_0048c640(CDemonRenderer * this_ptr)
    ADD ESP,0x4                         ; 005ef8b7
    JMP 0x005ef690                      ; 005ef8ba
        ;   XREF to: 005ef690 (UNCONDITIONAL_JUMP)  ; LAB_005ef690
