...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_weather_cpp_CWeather_FUN_005eeaf0(CWeather *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005eeaf0
        ;   Label: core_weather.cpp_CWeather_FUN_005eeaf0
    PUSH ESI                            ; 005eeaf1
    PUSH EDI                            ; 005eeaf2
    PUSH EBP                            ; 005eeaf3
    ...
    XOR AH,AH                           ; 005eeb2e
        ;   Label: LAB_005eeb2e
    MOV byte ptr [ESI + 0x3f96a78],AH   ; 005eeb30 | DAT_03f96a78 | DAT_03f96a79
    ...
    FCOMP float ptr [EDI + 0x3f96758]   ; 005eeb4c | DAT_03f96758 | DAT_03f9675c
    FNSTSW AX                           ; 005eeb52
    SAHF                                ; 005eeb54
    ...
    JNZ 0x005eebf9                      ; 005eeb73
        ;   XREF to: 005eebf9 (CONDITIONAL_JUMP)  ; LAB_005eebf9
    MOV EDX,0x3f95df8                   ; 005eeb79 | DAT_03f95df8
    ADD EDX,EBX                         ; 005eeb7e | DAT_03f95df8
    MOV EAX,dword ptr [EDX]             ; 005eeb80 | DAT_03f95df8
    ...
    MOV EAX,dword ptr [EDI + 0x3f96758] ; 005eeb98 | DAT_03f96758
    PUSH 0x0                            ; 005eeb9e
    ...
    CALL core_fire.cpp_CFireEffect_FUN_004c9290 ; 005eebb0
        ;   XREF to: 004c9290 (UNCONDITIONAL_CALL)  ; void core_fire.cpp_CFireEffect_FUN_004c9290(CFireEffect * this_ptr)
    ...
    CALL core_fire.cpp_CFireEffect_FUN_004c9290 ; 005eebc5
        ;   XREF to: 004c9290 (UNCONDITIONAL_CALL)  ; void core_fire.cpp_CFireEffect_FUN_004c9290(CFireEffect * this_ptr)
    ...
    CALL core_fire.cpp_CFireEffect_FUN_004c9290 ; 005eebdb
        ;   XREF to: 004c9290 (UNCONDITIONAL_CALL)  ; void core_fire.cpp_CFireEffect_FUN_004c9290(CFireEffect * this_ptr)
    ...
    CALL core_fire.cpp_CFireEffect_FUN_004c9290 ; 005eebf1
        ;   XREF to: 004c9290 (UNCONDITIONAL_CALL)  ; void core_fire.cpp_CFireEffect_FUN_004c9290(CFireEffect * this_ptr)
