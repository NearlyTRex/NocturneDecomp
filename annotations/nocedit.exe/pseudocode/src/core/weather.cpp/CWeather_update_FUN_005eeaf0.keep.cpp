...
LAB_005eeb1c:
  ...
  do {
    ...
    fVar2 = g_WeatherParticlePositions[iVar5].y - this_ptr->particle_speed * fVar4;
    g_WeatherParticlePositions[iVar5].y = fVar2;
    if ((fVar2 < g_WeatherParticleGroundHeights[iVar5]) &&
       (g_WeatherParticlePositions[iVar5].y = g_WeatherParticlePositions[iVar5].y + 100.0f,
       this_ptr->weather_type == WEATHER_TYPE_RAIN)) {
      local_28.x = g_WeatherParticlePositions[iVar5].x;
      local_28.z = g_WeatherParticlePositions[iVar5].z;
      local_28.y = g_WeatherParticleGroundHeights[iVar5];
