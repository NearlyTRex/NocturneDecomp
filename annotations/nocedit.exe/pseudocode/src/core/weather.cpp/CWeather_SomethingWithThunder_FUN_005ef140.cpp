...

{
  ...
  *(float *)(in_stack_00000004 + 0x20) = fVar1;
  core_sound_cpp_CSound_playSfx_FUN_005b3a20(this_ptr,in_stack_00000004,"thndr?.wav");
  *(undefined4 *)(in_stack_00000004 + 0x2c) = 0;
  *(undefined4 *)(in_stack_00000004 + 0x34) = 0x3f800000;
  return;
}
