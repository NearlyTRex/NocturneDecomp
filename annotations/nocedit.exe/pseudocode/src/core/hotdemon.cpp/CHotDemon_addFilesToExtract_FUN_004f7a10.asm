...
section .text
    ...
    PUSH EBX                            ; 004f7a10
        ;   Label: core_hotdemon.cpp_CHotDemon_addFilesToExtract_FUN_004f7a10
    MOV EDX,dword ptr [ESP + 0xc]       ; 004f7a11
    PUSH EDX                            ; 004f7a15
    MOV ECX,dword ptr [ESP + 0xc]       ; 004f7a16
    PUSH ECX                            ; 004f7a1a
    CALL core_actor.cpp_CDemonActor_addFilesToExtract_FUN_0040cfd0 ; 004f7a1b
    ...
    PUSH EAX                            ; 004f7a31
    CALL core_skeledit.cpp_CDeformableModelInstance_addFilesToExtract_FUN_0058a260 ; 004f7a32
