  ...
  *(float *)((in_stack_00000004->base_character).field2_0x240c + 0x2c) =
  ...
  case 6:
    ...
    if (iVar7 != 0) {
      ...
      local_28 = SQRT(local_c4[0].z * local_c4[0].z +
                      local_c4[0].x * local_c4[0].x + local_c4[0].y * local_c4[0].y);
      local_24 = local_28;
      if (local_28 < DAT_0065fccc) {
        ...
        if (ABS(local_14) < (float)_DAT_0062f4c8) {
          ...
          if (iVar7 == 0) {
            uVar9 = (*((in_stack_00000004->base_character).base_actor.metadata.vtable)->playSound)
                              ((CDemonActor *)in_stack_00000004,"hotdemon-attack.wav");
            *(undefined4 *)(in_stack_00000004[1].base_character.base_actor.actor_name + 8) = uVar9;
          }
        }
      }
    ...
    if (*(int *)(in_stack_00000004->field6_0xbe38 + 4) != 0) {
      ...
      *(undefined4 *)((in_stack_00000004->base_character).model.padding_0x0 + 0x2254) =
      ...
      if (-1 < iVar8) {
        ...
        local_18 = local_20;
        if ((_DAT_0065fcd8 < local_20) && (iVar7 != 7)) {
          in_stack_00000004->field6_0xbe38[0] = '\0';
          in_stack_00000004->field6_0xbe38[1] = '\0';
          in_stack_00000004->field6_0xbe38[2] = '\0';
          in_stack_00000004->field6_0xbe38[3] = '\0';
  ...
  case 8:
    ...
    core_xform_cpp_transformVector3x4_FUN_005f4dc0
              (&local_4c,&g_ZeroVector,
               (CMatrix3x4f *)
               ((in_stack_00000004->base_character).model.padding_0x0 + DAT_02db88d0 * 0x30 + 0xe80)
              );
...
switchD_004f7654_caseD_e:
  ...
  if (iVar7 != 0) {
    *(float *)((in_stack_00000004->base_character).field2_0x240c + 0x20) =
    ...
    local_7c = local_58 + *(float *)pcVar1;
    ...
    local_a0 = local_7c + *(float *)pcVar2;
    local_9c = local_78 + *(float *)((in_stack_00000004->base_character).model.padding_0x0 + 0x2258)
    ;
    local_98 = local_74 + *(float *)((in_stack_00000004->base_character).model.padding_0x0 + 0x225c)
    ;
...
// 004f71b5: PUSH EAX
// 004f71b6: PUSH EBX
// 004f71b7: CALL core_actor.cpp_CDemonActor_FUN_00408ec0
...
// 004f724e: PUSH EAX
// 004f724f: PUSH EBX
// 004f7250: CALL core_actor.cpp_CDemonActor_FUN_00408ec0
//   XREF to: 00408ec0 (UNCONDITIONAL_CALL)
...
// 004f733c: CALL core_actor.cpp_FUN_0040cd70
...
// 004f7584: CALL core_actor.cpp_FUN_0040cd70
//   XREF to: 0040cd70 (UNCONDITIONAL_CALL)
