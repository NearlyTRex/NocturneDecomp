...
LAB_004f7178:
      ...
      core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                (&(in_stack_00000004->base).model.motion_controller,iVar6,1);
    }
    else {
  ...
  case 6:
    ...
    if (iVar8 != 0) {
      local_c4.x = *(float *)(iVar8 + 0x20) - (in_stack_00000004->base).base.location.position.x;
      local_c4.y = *(float *)(iVar8 + 0x24) - (in_stack_00000004->base).base.location.position.y;
      local_c4.z = *(float *)(iVar8 + 0x28) - (in_stack_00000004->base).base.location.position.z;
      ...
      if (local_28 < 2.0f) {
        ...
        local_14 = core_actor_cpp_normalizeAngleToPi_FUN_0040cd70
                             (local_40.y - (in_stack_00000004->base).base.orient.bank);
        if (ABS(local_14) < (float)0.52359877558333301) {
          ...
          if (iVar6 == 0) {
            uVar10 = (*((in_stack_00000004->base).base.vtable._ub)->playSound)
                               ((CDemonActor *)in_stack_00000004,"hotdemon-attack.wav");
            *(uint *)(in_stack_00000004[1].base.base.actor_name + 8) = uVar10;
          }
        }
      }
  ...
  case 0xf:
    ...
    if (*(int *)(in_stack_00000004->unk2 + 4) != 0) {
      ...
      if (-1 < iVar8) {
        local_94 = (in_stack_00000004->base).base.location.position.x -
                   *(float *)(*(int *)(in_stack_00000004->unk2 + 4) + 0x20);
        local_8c = (in_stack_00000004->base).base.location.position.z -
                   *(float *)(*(int *)(in_stack_00000004->unk2 + 4) + 0x28);
        local_90 = 0;
        local_20 = SQRT(local_8c * local_8c + local_94 * local_94);
        local_18 = local_20;
        if ((10.0f < local_20) && (iVar6 != 7)) {
          in_stack_00000004->unk2[0] = '\0';
          in_stack_00000004->unk2[1] = '\0';
          in_stack_00000004->unk2[2] = '\0';
          in_stack_00000004->unk2[3] = '\0';
        ...
        if ((local_20 <= local_1c) && (*(float *)in_stack_00000004->unk2 <= 0.0)) {
          iVar8 = *(int *)(in_stack_00000004->unk2 + 4);
          local_70.x = *(float *)(iVar8 + 0x20) - (in_stack_00000004->base).base.location.position.x
          ;
          local_70.y = *(float *)(iVar8 + 0x24) - (in_stack_00000004->base).base.location.position.y
          ;
          local_70.z = *(float *)(iVar8 + 0x28) - (in_stack_00000004->base).base.location.position.z
          ;
          core_vehicle_cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(&local_88,&local_70);
          local_14 = core_actor_cpp_normalizeAngleToPi_FUN_0040cd70
                               (local_88.y - (in_stack_00000004->base).base.orient.bank);
          if (ABS(local_14) < (float)0.52359877558333301) {
            if (iVar6 == 7) {
              iVar8 = 8;
            }
  ...
  case 0xb:
    if ((in_stack_00000004->pool_me == 0) && ((in_stack_00000004->base).base.unk2 == 0)) {
      pCVar9 = core_skeleton_cpp_CDeformableModelInstance_getBoneWorldPosition_FUN_0059fa20
                         (&(in_stack_00000004->base).model,&local_ac,0);
      core_actor_cpp_CDemonActor_localToWorldPoint_FUN_00408ec0
...
switchD_004f7654_caseD_e:
  ...
  if (iVar6 != 0) {
    *(float *)((in_stack_00000004->base).unk1 + 0x20) =
    ...
    local_58 = *(float *)((in_stack_00000004->base).unk1 + 0x1c) * in_stack_00000008;
    local_54 = *(float *)((in_stack_00000004->base).unk1 + 0x20) * in_stack_00000008;
    pcVar2 = (in_stack_00000004->base).unk1 + 0x10;
    local_50 = in_stack_00000008 * *(float *)((in_stack_00000004->base).unk1 + 0x24);
    pCVar9 = &(in_stack_00000004->base).model.accumulated_root_motion;
    local_7c = local_58 + *(float *)pcVar2;
    local_78 = local_54 + *(float *)((in_stack_00000004->base).unk1 + 0x14);
    local_74 = local_50 + *(float *)((in_stack_00000004->base).unk1 + 0x18);
    local_a0 = local_7c + pCVar9->x;
    local_9c = local_78 + (in_stack_00000004->base).model.accumulated_root_motion.y;
    local_98 = local_74 + (in_stack_00000004->base).model.accumulated_root_motion.z;
