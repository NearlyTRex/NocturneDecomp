...
section .text
    ...
    PUSH EDI                            ; 004f6d2c
    CALL core_enemy.cpp_CEnemy_FUN_004a9650 ; 004f6d2d
    ...
    PUSH EBX                            ; 004f6d66
    MOV [0x02db88c8],EAX                ; 004f6d67 | DAT_02db88c8
    ...
    PUSH EBX                            ; 004f6e0e
    MOV [0x02db88d0],EAX                ; 004f6e0f | DAT_02db88d0
    ...
    PUSH EBX                            ; 004f6e23
    MOV [0x02db88ec],EAX                ; 004f6e24 | DAT_02db88ec
    ...
    PUSH EBX                            ; 004f6e4d
    MOV [0x02db88f4],EAX                ; 004f6e4e | DAT_02db88f4
    ...
    PUSH EBX                            ; 004f6e62
    MOV [0x02db88c8],EAX                ; 004f6e63 | DAT_02db88c8
