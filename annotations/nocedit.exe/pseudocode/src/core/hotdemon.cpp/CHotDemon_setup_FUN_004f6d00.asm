...
section .text
    ...
    PUSH EBX                            ; 004f6d66
    MOV [0x02db88c8],EAX                ; 004f6d67 | g_HotDemonIndices
    ...
    PUSH EBX                            ; 004f6d7b
    MOV [0x02db88d4],EAX                ; 004f6d7c | g_HotDemonIndices[3]
    ...
    PUSH EBX                            ; 004f6d90
    MOV [0x02db88d8],EAX                ; 004f6d91 | g_HotDemonIndices[4]
    ...
    PUSH EBX                            ; 004f6da5
    MOV [0x02db88dc],EAX                ; 004f6da6 | g_HotDemonIndices[5]
    ...
    PUSH EBX                            ; 004f6dba
    MOV [0x02db88e0],EAX                ; 004f6dbb | g_HotDemonIndices[6]
    ...
    PUSH EBX                            ; 004f6dcf
    MOV [0x02db88e4],EAX                ; 004f6dd0 | g_HotDemonIndices[7]
    ...
    PUSH EBX                            ; 004f6de4
    MOV [0x02db88e8],EAX                ; 004f6de5 | g_HotDemonIndices[8]
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 004f6dea
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 004f6def
    MOV [0x02db88cc],EAX                ; 004f6df2 | g_HotDemonIndices[1]
    PUSH 0x1                            ; 004f6df7
    ...
    PUSH EBX                            ; 004f6e0e
    MOV [0x02db88d0],EAX                ; 004f6e0f | g_HotDemonIndices[2]
    ...
    PUSH EBX                            ; 004f6e23
    MOV [0x02db88ec],EAX                ; 004f6e24 | g_HotDemonIndices[9]
    ...
    PUSH EBX                            ; 004f6e38
    MOV [0x02db88f0],EAX                ; 004f6e39 | g_HotDemonIndices[10]
    ...
    PUSH EBX                            ; 004f6e4d
    MOV [0x02db88f4],EAX                ; 004f6e4e | g_HotDemonIndices[11]
    ...
    PUSH EBX                            ; 004f6e62
    MOV [0x02db88c8],EAX                ; 004f6e63 | g_HotDemonIndices
    ...
    PUSH EBX                            ; 004f6e77
    MOV [0x02db88dc],EAX                ; 004f6e78 | g_HotDemonIndices[5]
    ...
    PUSH EBX                            ; 004f6e8c
    MOV [0x02db88e0],EAX                ; 004f6e8d | g_HotDemonIndices[6]
    ...
    PUSH EBX                            ; 004f6ea1
    MOV [0x02db88ec],EAX                ; 004f6ea2 | g_HotDemonIndices[9]
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 004f6ea7
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 004f6eac
    PUSH ESI                            ; 004f6eaf
    MOV [0x02db88f4],EAX                ; 004f6eb0 | g_HotDemonIndices[11]
