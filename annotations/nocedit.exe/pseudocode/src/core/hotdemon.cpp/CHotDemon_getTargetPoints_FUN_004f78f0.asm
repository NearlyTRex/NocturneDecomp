...
;
; Referenced Globals:
;   int[12] g_HotDemonIndices
;   undefined4 g_HotDemonIndices[9]
...
section .text
    ...
    PUSH EBX                            ; 004f78f0
        ;   Label: core_hotdemon.cpp_CHotDemon_getTargetPoints_FUN_004f78f0
    PUSH ESI                            ; 004f78f1
    PUSH EDI                            ; 004f78f2
    PUSH EBP                            ; 004f78f3
    ...
    MOV EDX,dword ptr [0x02db88c8]      ; 004f78ff | g_HotDemonIndices
    PUSH EDX                            ; 004f7905
    ...
    MOV ECX,dword ptr [0x02db88ec]      ; 004f7933 | g_HotDemonIndices[9]
        ;   Label: LAB_004f7933
    PUSH ECX                            ; 004f7939
    ...
    MOV EBP,dword ptr [0x02db88f4]      ; 004f7965 | g_HotDemonIndices[11]
        ;   Label: LAB_004f7965
    PUSH EBP                            ; 004f796b
