...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_hotdemon.cpp_FUN_004f7a10()
;
;
; Called Functions:
...
section .text
    ...
    PUSH ECX                            ; 004f7a1a
    CALL core_actor.cpp_CDemonActor_writeDependencies_FUN_0040cfd0 ; 004f7a1b | void core_actor.cpp_CDemonActor_writeDependencies_FUN_0040cfd0(CDemonActor * this_ptr, FILE * file_handle)
    ...
    PUSH EAX                            ; 004f7a31
    CALL core_skeledit.cpp_GetModelPtrOfFile_FUN_0058a260 ; 004f7a32 | undefined core_skeledit.cpp_GetModelPtrOfFile_FUN_0058a260()
