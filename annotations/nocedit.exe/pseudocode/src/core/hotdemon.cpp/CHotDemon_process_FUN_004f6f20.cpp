...
LAB_004f7178:
  ...
  case 6:
    ...
    if (iVar9 != 0) {
      local_c4.x = *(float *)(iVar9 + 0x20) - (this_ptr->base).base.base.location.position.x;
      local_c4.y = *(float *)(iVar9 + 0x24) - (this_ptr->base).base.base.location.position.y;
      local_c4.z = *(float *)(iVar9 + 0x28) - (this_ptr->base).base.base.location.position.z;
  ...
  case 0xf:
    ...
    if (*(int *)((this_ptr->base).unk2 + 4) != 0) {
      ...
      if (-1 < iVar9) {
        iVar9 = *(int *)((this_ptr->base).unk2 + 4);
        local_94 = (this_ptr->base).base.base.location.position.x - *(float *)(iVar9 + 0x20);
        local_8c = (this_ptr->base).base.base.location.position.z - *(float *)(iVar9 + 0x28);
        local_90 = 0;
        ...
        if ((local_20 <= local_1c) && (*(float *)(this_ptr->base).unk2 <= 0.0)) {
          iVar9 = *(int *)((this_ptr->base).unk2 + 4);
          local_70.x = *(float *)(iVar9 + 0x20) - (this_ptr->base).base.base.location.position.x;
          local_70.y = *(float *)(iVar9 + 0x24) - (this_ptr->base).base.base.location.position.y;
          local_70.z = *(float *)(iVar9 + 0x28) - (this_ptr->base).base.base.location.position.z;
          ...
          if (ABS(local_14) < (float)0.52359877558333301) {
            ...
            iVar9 = sound_sndmain_cpp_isSfxPlaying_FUN_005a9660(*(uint *)(this_ptr->unk + 8));
            if (iVar9 == 0) {
              uVar11 = (*((this_ptr->base).base.base.vtable._ub)->playSound)
                                 ((CDemonActor *)this_ptr,"hotdemon-attack.wav");
              *(uint *)(this_ptr->unk + 8) = uVar11;
...
switchD_004f7654_caseD_e:
  ...
  if (iVar7 != 0) {
    *(float *)((this_ptr->base).base.unk1 + 0x20) =
    ...
    local_58 = *(float *)((this_ptr->base).base.unk1 + 0x1c) * delta_time;
    local_54 = *(float *)((this_ptr->base).base.unk1 + 0x20) * delta_time;
    pcVar2 = (this_ptr->base).base.unk1 + 0x10;
    local_50 = delta_time * *(float *)((this_ptr->base).base.unk1 + 0x24);
    pCVar10 = &(this_ptr->base).base.model.accumulated_root_motion;
    local_7c = local_58 + *(float *)pcVar2;
    local_78 = local_54 + *(float *)((this_ptr->base).base.unk1 + 0x14);
    local_74 = local_50 + *(float *)((this_ptr->base).base.unk1 + 0x18);
    local_a0 = local_7c + pCVar10->x;
