...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_hotdemon_cpp_CHotDemon_archive_FUN_004f76c0(CHotDemon *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004f76c0
        ;   Label: core_hotdemon.cpp_CHotDemon_archive_FUN_004f76c0
    PUSH ESI                            ; 004f76c1
    MOV ESI,dword ptr [ESP + 0xc]       ; 004f76c2
    PUSH ESI                            ; 004f76c6
    CALL core_enemy.cpp_CEnemy_archive_FUN_004a9660 ; 004f76c7
    ...
    PUSH EBX                            ; 004f76da
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 004f76db
    ...
    PUSH EBX                            ; 004f76ee
    CALL core_actor.cpp_archiveDeformableModelInstance_FUN_0040b970 ; 004f76ef
    ...
    PUSH EBX                            ; 004f76fc
    CALL core_actor.cpp_archiveMotionState_FUN_0040b9f0 ; 004f76fd
