...
section .text
    ...
    MOV EDX,dword ptr [0x02db88c8]      ; 004f78ff | DAT_02db88c8
    PUSH EDX                            ; 004f7905
    ...
    MOV ECX,dword ptr [0x02db88ec]      ; 004f7933 | DAT_02db88ec
        ;   Label: LAB_004f7933
    PUSH ECX                            ; 004f7939
    ...
    MOV EBP,dword ptr [0x02db88f4]      ; 004f7965 | DAT_02db88f4
        ;   Label: LAB_004f7965
    PUSH EBP                            ; 004f796b
