...
section .text
    ...
    MOV EDX,dword ptr [0x02db88c8]      ; 004f78ff | undefined4 DAT_02db88c8
    PUSH EDX                            ; 004f7905
    ...
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00 ; 004f7917 | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
        ;   XREF to: 0059fb00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004f791c
    CMP EBX,EAX                         ; 004f791f
    JZ 0x004f7933                       ; 004f7921 | LAB_004f7933
    ...
    MOV ECX,dword ptr [0x02db88ec]      ; 004f7933 | undefined4 DAT_02db88ec
        ;   Label: LAB_004f7933
    PUSH ECX                            ; 004f7939
    ...
    PUSH EAX                            ; 004f7945
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00 ; 004f7946 | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
        ;   XREF to: 0059fb00 (UNCONDITIONAL_CALL)
    LEA EDX,[EBX + 0xc]                 ; 004f794b
    ADD ESP,0xc                         ; 004f794e
    CMP EDX,EAX                         ; 004f7951
    JZ 0x004f7965                       ; 004f7953 | LAB_004f7965
    ...
    MOV EBP,dword ptr [0x02db88f4]      ; 004f7965 | undefined4 DAT_02db88f4
        ;   Label: LAB_004f7965
    PUSH EBP                            ; 004f796b
    ...
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00 ; 004f797b | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
        ;   XREF to: 0059fb00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004f7980
    CMP EBX,EAX                         ; 004f7983
    JNZ 0x004f7991                      ; 004f7985 | LAB_004f7991
