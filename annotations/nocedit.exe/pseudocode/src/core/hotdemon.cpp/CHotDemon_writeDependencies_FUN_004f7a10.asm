...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_hotdemon_cpp_CHotDemon_writeDependencies_FUN_004f7a10(CHotDemon *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004f7a10
        ;   Label: core_hotdemon.cpp_CHotDemon_writeDependencies_FUN_004f7a10
    ...
    PUSH EAX                            ; 004f7a31
    CALL core_skeledit.cpp_CDeformableModelInstance_writeDependencies_FUN_0058a260 ; 004f7a32
