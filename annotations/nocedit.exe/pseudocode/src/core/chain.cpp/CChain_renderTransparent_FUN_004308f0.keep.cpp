    ...
    if (this_ptr->is_visible != 0) {
      ...
      for (iVar4 = 0; pSVar4 = pSVar4 + 1, iVar4 < this_ptr->vertex_count + -1; iVar4 = iVar4 + 1) {
        ...
        *piVar2 = *piVar2 + -0x40;
        ...
        pCVar3->vertex_buffer_ptr->u = 0x8 << 16;
        pCVar3->vertex_buffer_ptr->v = 0x8 << 16;
        pCVar3->vertex_buffer_ptr[1].u = 0x8 << 16;
        pCVar3->vertex_buffer_ptr[1].v = 0xf8 << 16;
        pCVar3->vertex_buffer_ptr[2].u = 0xf8 << 16;
        pCVar3->vertex_buffer_ptr[2].v = 0xf8 << 16;
