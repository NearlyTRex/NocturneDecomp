...

{
  ...
  core_actor_cpp_archiveActor_FUN_0040b870((CDemonActor *)(this_ptr->unk1 + 4),"target");
  ...
  if (1 < g_CChainClassVersion) {
    core_actor_cpp_archiveString_FUN_0040b5c0(this_ptr->unk2 + 8,"textureName");
  }
  if (2 < g_CChainClassVersion) {
    core_actor_cpp_archiveString_FUN_0040b5c0(this_ptr->unk2 + 0x48,"pullWavName");
    core_actor_cpp_archiveString_FUN_0040b5c0(this_ptr->unk2 + 0xb0,"moveWavName");
  }
