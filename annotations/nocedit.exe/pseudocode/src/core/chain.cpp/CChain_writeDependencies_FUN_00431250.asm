...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_chain_cpp_CChain_writeDependencies_FUN_00431250(CChain *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH ESI                            ; 00431250
        ;   Label: core_chain.cpp_CChain_writeDependencies_FUN_00431250
