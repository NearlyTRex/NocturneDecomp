...

{
  ...
  *(uint *)(this_ptr->unk6[0].unk + 0xc) = *(uint *)(this_ptr->unk6[0].unk + 0x10);
  local_4c = this_ptr->unk6;
  local_34 = &this_ptr->dampen;
  local_28 = this_ptr->unk6 + 2;
  ...
  local_1c = this_ptr->unk6[0].unk + 0xc;
  pSStack_18 = this_ptr->unk6;
  local_20 = &(this_ptr->base).location;
  local_40 = this_ptr->unk6 + 2;
  local_3c = this_ptr->unk6 + 1;
  local_30 = 0;
  do {
    pCVar3 = core_chain_cpp_CChain_FUN_0042fcc0(this_ptr);
  ...
  if (*(int *)(this_ptr->unk7 + 8) != 0) {
    ...
    iVar8 = this_ptr->vertex_count;
    local_94 = local_58 - *(float *)this_ptr->unk6[iVar8 + -1].unk;
    local_90 = local_54 - *(float *)(this_ptr->unk6[iVar8 + -1].unk + 4);
    local_8c = local_50 - *(float *)(this_ptr->unk6[iVar8 + -1].unk + 8);
    if (delta_time * (float)0.10000000000000001 <
        SQRT(local_8c * local_8c + local_94 * local_94 + local_90 * local_90)) {
      local_48 = 1;
    }
  }
  if ((local_44 != 0) && (this_ptr->pull_wav_name[0] != '\0')) {
