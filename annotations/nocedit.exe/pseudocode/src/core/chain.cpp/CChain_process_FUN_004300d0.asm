...
; SChainVertex *   Stack[-0x58]:4  local_58
; int              Stack[-0x54]:4  local_54
; int              Stack[-0x50]:4  local_50
; SChainVertex *   Stack[-0x4c]:4  local_4c
; SChainVertex *   Stack[-0x48]:4  local_48
; float            Stack[-0x44]:4  local_44
; float *          Stack[-0x40]:4  local_40
; int              Stack[-0x3c]:4  local_3c
; SChainVertex *   Stack[-0x38]:4  local_38
; SChainVertex *   Stack[-0x34]:4  local_34
; int              Stack[-0x30]:4  local_30
; SChainVertex *   Stack[-0x2c]:4  local_2c
; CVector3f *      Stack[-0x28]:4  local_28
; SChainVertex *   Stack[-0x24]:4  local_24
; SChainVertex *   Stack[-0x20]:4  local_20
...
;
; Called Functions:
;   core_chain.cpp_CChain_constrainSegmentDistance_FUN_0042fed0
...
section .text
    ...
    PUSH EBX                            ; 004300d0
        ;   Label: core_chain.cpp_CChain_process_FUN_004300d0
    PUSH ESI                            ; 004300d1
    PUSH EDI                            ; 004300d2
    PUSH EBP                            ; 004300d3
    ...
    PUSH EAX                            ; 004301d5
    PUSH ESI                            ; 004301d6
    CALL core_chain.cpp_CChain_getTargetBoneWorldPosition_FUN_0042fcc0 ; 004301d7
    ...
    PUSH EAX                            ; 00430316
    PUSH ESI                            ; 00430317
    CALL core_chain.cpp_CChain_getTargetBoneWorldPosition_FUN_0042fcc0 ; 00430318
        ;   XREF to: 0042fcc0 (UNCONDITIONAL_CALL)  ; CVector3f * core_chain.cpp_CChain_getTargetBoneWorldPosition_FUN_0042fcc0(CChain * this_ptr, CVector3f * out_point)
    ...
    PUSH EBX                            ; 004303d9
    PUSH ESI                            ; 004303da
    CALL core_chain.cpp_CChain_constrainSegmentDistance_FUN_0042fed0 ; 004303db
        ;   XREF to: 0042fed0 (UNCONDITIONAL_CALL)  ; void core_chain.cpp_CChain_constrainSegmentDistance_FUN_0042fed0(CChain * this_ptr, SChainVertex * vertex_a, SChainVertex * vertex_b)
    ADD ESP,0xc                         ; 004303e0
    PUSH EDI                            ; 004303e3
    PUSH EBX                            ; 004303e4
    PUSH ESI                            ; 004303e5
    ADD EDI,0x24                        ; 004303e6
    CALL core_chain.cpp_CChain_constrainSegmentDistance_FUN_0042fed0 ; 004303e9
        ;   XREF to: 0042fed0 (UNCONDITIONAL_CALL)  ; void core_chain.cpp_CChain_constrainSegmentDistance_FUN_0042fed0(CChain * this_ptr, SChainVertex * vertex_a, SChainVertex * vertex_b)
    ...
    CALL core_chain.cpp_CChain_constrainSegmentDistance_FUN_0042fed0 ; 0043054c
        ;   XREF to: 0042fed0 (UNCONDITIONAL_CALL)  ; void core_chain.cpp_CChain_constrainSegmentDistance_FUN_0042fed0(CChain * this_ptr, SChainVertex * vertex_a, SChainVertex * vertex_b)
    ...
    PUSH EBX                            ; 0043055c
    PUSH ESI                            ; 0043055d
    CALL core_chain.cpp_CChain_constrainSegmentDistance_FUN_0042fed0 ; 0043055e
        ;   XREF to: 0042fed0 (UNCONDITIONAL_CALL)  ; void core_chain.cpp_CChain_constrainSegmentDistance_FUN_0042fed0(CChain * this_ptr, SChainVertex * vertex_a, SChainVertex * vertex_b)
    ...
    PUSH EAX                            ; 004305ba
    PUSH ESI                            ; 004305bb
    CALL core_chain.cpp_CChain_getTargetBoneWorldPosition_FUN_0042fcc0 ; 004305bc
        ;   XREF to: 0042fcc0 (UNCONDITIONAL_CALL)  ; CVector3f * core_chain.cpp_CChain_getTargetBoneWorldPosition_FUN_0042fcc0(CChain * this_ptr, CVector3f * out_point)
