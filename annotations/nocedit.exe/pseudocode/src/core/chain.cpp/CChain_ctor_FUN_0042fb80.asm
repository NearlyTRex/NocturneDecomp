...
;
; XREF[1]:
;   core_chain.cpp_FUN_0042fb40 at 0042fb5a
;
; Referenced Globals:
...
section .text
    ...
    PUSH EDX                            ; 0042fb86
    CALL core_actor.cpp_CDemonActor_ctor_FUN_004088b0 ; 0042fb87 | CDemonActor * core_actor.cpp_CDemonActor_ctor_FUN_004088b0(CDemonActor * this_ptr)
        ;   XREF to: 004088b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0042fb8c
    PUSH 0x65baf0                       ; 0042fb8f | WatcomTypeInfo g_SChainVertexTypeInfo
    PUSH 0x14                           ; 0042fb94
    ADD EAX,0x28c                       ; 0042fb96
    PUSH EAX                            ; 0042fb9b
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 0042fb9c | void * crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
        ;   XREF to: 005fe667 (UNCONDITIONAL_CALL)
    LEA EDX,[EAX + 0xfffffd74]          ; 0042fba1
    MOV dword ptr [EDX + 0x154],0x65ba04 ; 0042fba7 | CDemonActor_vtable PTR_core_chain.cpp_FUN_0042fd20_0065ba04
    ...
    MOV ESI,0x6177a3                    ; 0042fbe3 | = "CHAINLINK.RAW" | s_CHAINLINK_RAW_006177a3 = CHAINLINK.RAW
    ...
    PUSH EDI                            ; 0042fc0f
    MOV AL,byte ptr [ESI]               ; 0042fc10 | = "CHAINLINK.RAW" | s_CHAINLINK_RAW_006177a3 = CHAINLINK.RAW
        ;   Label: LAB_0042fc10
    MOV byte ptr [EDI],AL               ; 0042fc12
    CMP AL,0x0                          ; 0042fc14
    JZ 0x0042fc28                       ; 0042fc16 | LAB_0042fc28
        ;   XREF to: 0042fc28 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0042fc18 | s_HAINLINK.RAW_006177a4
    ADD ESI,0x2                         ; 0042fc1b
    MOV byte ptr [EDI + 0x1],AL         ; 0042fc1e
    ADD EDI,0x2                         ; 0042fc21
    CMP AL,0x0                          ; 0042fc24
    JNZ 0x0042fc10                      ; 0042fc26 | LAB_0042fc10
        ;   XREF to: 0042fc10 (CONDITIONAL_JUMP)
    POP EDI                             ; 0042fc28
        ;   Label: LAB_0042fc28
    MOV dword ptr [EDX + 0x16c],0xd     ; 0042fc29
    MOV dword ptr [EDX + 0x170],0x0     ; 0042fc33
    MOV ESI,0x6177b1                    ; 0042fc3d | = "chain-pull.wav" | s_chain_pull_wav_006177b1 = chain-pull.wav
    MOV dword ptr [EDX + 0xfc],0x1      ; 0042fc42
    LEA EDI,[EDX + 0x1b4]               ; 0042fc4c
    MOV dword ptr [EDX + 0xf8],0x0      ; 0042fc52
    PUSH EDI                            ; 0042fc5c
    MOV AL,byte ptr [ESI]               ; 0042fc5d | = "chain-pull.wav" | s_chain_pull_wav_006177b1 = chain-pull.wav
        ;   Label: LAB_0042fc5d
    MOV byte ptr [EDI],AL               ; 0042fc5f
    CMP AL,0x0                          ; 0042fc61
    JZ 0x0042fc75                       ; 0042fc63 | LAB_0042fc75
        ;   XREF to: 0042fc75 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0042fc65 | s_hain-pull.wav_006177b2
    ADD ESI,0x2                         ; 0042fc68
    MOV byte ptr [EDI + 0x1],AL         ; 0042fc6b
    ADD EDI,0x2                         ; 0042fc6e
    CMP AL,0x0                          ; 0042fc71
    JNZ 0x0042fc5d                      ; 0042fc73 | LAB_0042fc5d
        ;   XREF to: 0042fc5d (CONDITIONAL_JUMP)
    POP EDI                             ; 0042fc75
        ;   Label: LAB_0042fc75
    MOV ESI,0x6177c0                    ; 0042fc76 | = "chain-move.wav" | s_chain_move_wav_006177c0 = chain-move.wav
    LEA EDI,[EDX + 0x21c]               ; 0042fc7b
    PUSH EDI                            ; 0042fc81
    MOV AL,byte ptr [ESI]               ; 0042fc82 | = "chain-move.wav" | s_chain_move_wav_006177c0 = chain-move.wav
        ;   Label: LAB_0042fc82
    MOV byte ptr [EDI],AL               ; 0042fc84
    CMP AL,0x0                          ; 0042fc86
    JZ 0x0042fc9a                       ; 0042fc88 | LAB_0042fc9a
        ;   XREF to: 0042fc9a (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0042fc8a | s_hain-move.wav_006177c1
    ADD ESI,0x2                         ; 0042fc8d
    MOV byte ptr [EDI + 0x1],AL         ; 0042fc90
    ADD EDI,0x2                         ; 0042fc93
    CMP AL,0x0                          ; 0042fc96
    JNZ 0x0042fc82                      ; 0042fc98 | LAB_0042fc82
