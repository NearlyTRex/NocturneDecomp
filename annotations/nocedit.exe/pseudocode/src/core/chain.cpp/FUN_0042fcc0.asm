...
section .text
    ...
    PUSH EAX                            ; 0042fced
    PUSH 0x3f87558                      ; 0042fcee | CVector3f g_ZeroVector
    LEA EAX,[ESP + 0x8]                 ; 0042fcf3
    PUSH EAX                            ; 0042fcf7
    CALL core_xform.cpp_transformVector3x4_FUN_005f4dc0 ; 0042fcf8 | CVector3f * core_xform.cpp_transformVector3x4_FUN_005f4dc0(CVector3f * output_vector, CVector3f * input_vector, CMatrix3x4f * matrix)
    ...
    PUSH EDX                            ; 0042fd08
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 0042fd09 | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
