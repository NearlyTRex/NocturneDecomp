...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_chain_cpp_CChain_archive_FUN_00430fe0(CChain *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00430fe0
        ;   Label: core_chain.cpp_CChain_archive_FUN_00430fe0
    MOV EBX,dword ptr [ESP + 0x8]       ; 00430fe1
    PUSH EBX                            ; 00430fe5
    CALL core_actor.cpp_CDemonActor_archive_FUN_0040c1c0 ; 00430fe6
    ...
    PUSH EAX                            ; 00430ff9
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 00430ffa
    ...
    PUSH EAX                            ; 0043100d
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 0043100e
    ...
    PUSH EAX                            ; 004310ad
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 004310ae
    ...
    PUSH EAX                            ; 004310c1
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 004310c2
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveString_FUN_0040b5c0(char * string_buffer, char * property_type)
    ...
    PUSH EAX                            ; 004310e0
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 004310e1
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveString_FUN_0040b5c0(char * string_buffer, char * property_type)
    ...
    PUSH EBX                            ; 004310f6
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 004310f7
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
