...
;                               FUNCTION
; *****************************************************************************
; __cdecl CBoundingBox3D * __cdecl core_chain_cpp_CChain_getBoundingBox_FUN_00430eb0(CChain *this_ptr,CBoundingBox3D *out_box)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00430eb0
        ;   Label: core_chain.cpp_CChain_getBoundingBox_FUN_00430eb0
    PUSH ESI                            ; 00430eb1
    PUSH EDI                            ; 00430eb2
    PUSH EBP                            ; 00430eb3
