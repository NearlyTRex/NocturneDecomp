...
;   core_chain.cpp_SChainVertex_arrdtor20_FUN_004313f0
...
section .text
    ...
    PUSH EBX                            ; 00431374
    CALL core_chain.cpp_SChainVertex_arrdtor20_FUN_004313f0 ; 00431375
        ;   XREF to: 004313f0 (UNCONDITIONAL_CALL)  ; SChainVertex * core_chain.cpp_SChainVertex_arrdtor20_FUN_004313f0(SChainVertex * objs, uint flags)
    ...
    PUSH 0x65bb10                       ; 0043139d | g_CChainTypeInfo
        ;   Label: LAB_0043139d
    PUSH EBX                            ; 004313a2
    CALL crt_memory.c___vec_delete_FUN_005fe632 ; 004313a3
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c___vec_delete_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 004313a8
    PUSH EAX                            ; 004313ab
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 004313ac
    ...
    PUSH EAX                            ; 004313b8
        ;   Label: LAB_004313b8
    CALL shape_memdbg.cpp_debugFreeChecked_FUN_0050f210 ; 004313b9
