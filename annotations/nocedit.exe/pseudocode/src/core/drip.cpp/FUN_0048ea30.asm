...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_drip.cpp_FUN_0048ea30()
;
;
; Called Functions:
...
section .text
    ...
    JZ 0x0048ea53                       ; 0048ea3f | LAB_0048ea53
    ...
    PUSH ECX                            ; 0048ea53
        ;   Label: LAB_0048ea53
    CALL core_actor.cpp_CDemonActor_processInEditor_FUN_0040d040 ; 0048ea54 | void core_actor.cpp_CDemonActor_processInEditor_FUN_0040d040(CDemonActor * this_ptr)
