...
;                               FUNCTION
; *****************************************************************************
; __cdecl CBoundingBox3D * __cdecl core_drip_cpp_CDrip_getBoundingBox_FUN_0048e740(CDrip *this_ptr,CBoundingBox3D *out_box)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0048e740
        ;   Label: core_drip.cpp_CDrip_getBoundingBox_FUN_0048e740
    PUSH ESI                            ; 0048e741
    PUSH EDI                            ; 0048e742
    PUSH EBP                            ; 0048e743
