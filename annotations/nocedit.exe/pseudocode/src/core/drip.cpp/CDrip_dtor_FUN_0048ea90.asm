...
;                               FUNCTION
; *****************************************************************************
; __cdecl CDrip * __cdecl core_drip_cpp_CDrip_dtor_FUN_0048ea90(CDrip *this_ptr,uint flags)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0048ea90
        ;   Label: core_drip.cpp_CDrip_dtor_FUN_0048ea90
    ...
    PUSH 0x65d070                       ; 0048eab6 | g_CDripTypeInfo
        ;   Label: LAB_0048eab6
    PUSH EBX                            ; 0048eabb
    CALL crt_memory.c___vec_delete_FUN_005fe632 ; 0048eabc
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c___vec_delete_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 0048eac1
    PUSH EAX                            ; 0048eac4
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 0048eac5
