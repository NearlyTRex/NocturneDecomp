...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_drip.cpp_FUN_0048e8d0()
;
;
; XREF[1]:
...
section .text
    ...
    PUSH ECX                            ; 0048e8dc
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 0048e8dd | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    MOV EBX,dword ptr [EAX + 0x2d4]     ; 0048e8e2
    ADD ESP,0x8                         ; 0048e8e8
    TEST EBX,EBX                        ; 0048e8eb
    JZ 0x0048e905                       ; 0048e8ed | LAB_0048e905
        ;   XREF to: 0048e905 (CONDITIONAL_JUMP)
    CMP EBX,0x1                         ; 0048e8ef
    JNZ 0x0048e911                      ; 0048e8f2 | LAB_0048e911
    ...
    MOV dword ptr [EAX + 0x2d4],0x1     ; 0048e905
        ;   Label: LAB_0048e905
    JMP 0x0048e8fe                      ; 0048e90f | LAB_0048e8fe
