...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_drip_cpp_CDrip_writeDependencies_FUN_0048ea60(CDrip *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0048ea60
        ;   Label: core_drip.cpp_CDrip_writeDependencies_FUN_0048ea60
