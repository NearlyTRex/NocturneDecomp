...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_drip.cpp_FUN_0048e830()
;
;
; XREF[1]:
;   core_drip.cpp_FUN_0048e930 at 0048e949
;
; Referenced Globals:
...
section .text
    ...
    PUSH ECX                            ; 0048e841
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 0048e842 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    MOV ESI,dword ptr [EAX + 0x2d4]     ; 0048e847
    ADD ESP,0x8                         ; 0048e84d
    CMP ESI,0x1                         ; 0048e850
    JNC 0x0048e8c2                      ; 0048e853 | LAB_0048e8c2
        ;   XREF to: 0048e8c2 (CONDITIONAL_JUMP)
    TEST ESI,ESI                        ; 0048e855
    JZ 0x0048e85c                       ; 0048e857 | LAB_0048e85c
        ;   XREF to: 0048e85c (CONDITIONAL_JUMP)
    POP EDI                             ; 0048e859
    POP ESI                             ; 0048e85a
    RET                                 ; 0048e85b
    MOV ESI,0x6222bb                    ; 0048e85c | = "Water" | s_Water_006222bb = Water
        ;   Label: LAB_0048e85c
    PUSH EDI                            ; 0048e861
    MOV AL,byte ptr [ESI]               ; 0048e862 | = "Water" | s_Water_006222bb = Water
        ;   Label: LAB_0048e862
    MOV byte ptr [EDI],AL               ; 0048e864
    CMP AL,0x0                          ; 0048e866
    JZ 0x0048e87a                       ; 0048e868 | LAB_0048e87a
        ;   XREF to: 0048e87a (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0048e86a | s_ater_006222bc
    ADD ESI,0x2                         ; 0048e86d
    MOV byte ptr [EDI + 0x1],AL         ; 0048e870
    ADD EDI,0x2                         ; 0048e873
    CMP AL,0x0                          ; 0048e876
    JNZ 0x0048e862                      ; 0048e878 | LAB_0048e862
    ...
    POP ESI                             ; 0048e87c
    RET                                 ; 0048e87d
    MOV ESI,0x6222c1                    ; 0048e87e | = "Lava" | s_Lava_006222c1 = Lava
        ;   Label: LAB_0048e87e
    PUSH EDI                            ; 0048e883
    MOV AL,byte ptr [ESI]               ; 0048e884 | = "Lava" | s_Lava_006222c1 = Lava
        ;   Label: LAB_0048e884
    MOV byte ptr [EDI],AL               ; 0048e886
    CMP AL,0x0                          ; 0048e888
    JZ 0x0048e89c                       ; 0048e88a | LAB_0048e89c
        ;   XREF to: 0048e89c (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0048e88c | DAT_006222c2
    ADD ESI,0x2                         ; 0048e88f
    MOV byte ptr [EDI + 0x1],AL         ; 0048e892
    ADD EDI,0x2                         ; 0048e895
    CMP AL,0x0                          ; 0048e898
    JNZ 0x0048e884                      ; 0048e89a | LAB_0048e884
    ...
    POP ESI                             ; 0048e89e
    RET                                 ; 0048e89f
    MOV ESI,0x6222c6                    ; 0048e8a0 | = "Stalagwhatever" | s_Stalagwhatever_006222c6 = Stalagwhatever
        ;   Label: LAB_0048e8a0
    PUSH EDI                            ; 0048e8a5
    MOV AL,byte ptr [ESI]               ; 0048e8a6 | = "Stalagwhatever" | s_Stalagwhatever_006222c6 = Stalagwhatever
        ;   Label: LAB_0048e8a6
    MOV byte ptr [EDI],AL               ; 0048e8a8
    CMP AL,0x0                          ; 0048e8aa
    JZ 0x0048e8be                       ; 0048e8ac | LAB_0048e8be
        ;   XREF to: 0048e8be (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0048e8ae | s_talagwhatever_006222c7
    ADD ESI,0x2                         ; 0048e8b1
    MOV byte ptr [EDI + 0x1],AL         ; 0048e8b4
    ADD EDI,0x2                         ; 0048e8b7
    CMP AL,0x0                          ; 0048e8ba
    JNZ 0x0048e8a6                      ; 0048e8bc | LAB_0048e8a6
    ...
    POP ESI                             ; 0048e8c0
    RET                                 ; 0048e8c1
    JBE 0x0048e87e                      ; 0048e8c2 | LAB_0048e87e
        ;   Label: LAB_0048e8c2
        ;   XREF to: 0048e87e (CONDITIONAL_JUMP)
    CMP ESI,0x2                         ; 0048e8c4
    JZ 0x0048e8a0                       ; 0048e8c7 | LAB_0048e8a0
