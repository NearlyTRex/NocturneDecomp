...
;                               FUNCTION
; *****************************************************************************
; unknown void core_script_cpp_CScript_checkInitSection_FUN_0055a6c0(void)
;
; Local Variables:
...
section .text
    ...
    PUSH 0x641a99                       ; 0055a6e7 | = "initSection"
        ;   Label: LAB_0055a6e7
    PUSH EBX                            ; 0055a6ec
    CALL core_script.cpp_FUN_00560160   ; 0055a6ed
    ...
    PUSH EBX                            ; 0055a701
    CALL core_script.cpp_FUN_00560160   ; 0055a702
        ;   XREF to: 00560160 (UNCONDITIONAL_CALL)  ; undefined core_script.cpp_FUN_00560160()
