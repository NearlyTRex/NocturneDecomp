...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_script_cpp_CScript_FUN_00566a90(CScript *this_ptr,int param_2,int param_3)
;
; Parameters:
...
;   core_script.cpp_CScript_FUN_00566910 at 00566959
...
section .text
    ...
    PUSH EBX                            ; 00566a90
        ;   Label: core_script.cpp_CScript_FUN_00566a90
    PUSH ESI                            ; 00566a91
    PUSH EDI                            ; 00566a92
