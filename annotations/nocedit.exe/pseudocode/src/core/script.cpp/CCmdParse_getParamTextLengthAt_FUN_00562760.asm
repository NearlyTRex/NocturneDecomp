...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_script_cpp_CCmdParse_getParamTextLengthAt_FUN_00562760(CCmdParse *this_pointer,int param_index)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00562760
        ;   Label: core_script.cpp_CCmdParse_getParamTextLengthAt_FUN_00562760
    PUSH ESI                            ; 00562761
    PUSH EDI                            ; 00562762
    PUSH EBP                            ; 00562763
    ...
    JL 0x0056277c                       ; 00562777
        ;   XREF to: 0056277c (CONDITIONAL_JUMP)  ; LAB_0056277c
    ...
    JL 0x005627e0                       ; 0056279e
        ;   XREF to: 005627e0 (CONDITIONAL_JUMP)  ; LAB_005627e0
    ...
    JLE 0x005627af                      ; 005627db
        ;   XREF to: 005627af (CONDITIONAL_JUMP)  ; LAB_005627af
