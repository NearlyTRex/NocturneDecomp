...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_renderSubtitles_FUN_00559b20(CScript *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00559b20
        ;   Label: core_script.cpp_CScript_renderSubtitles_FUN_00559b20
    PUSH ESI                            ; 00559b21
    PUSH EDI                            ; 00559b22
    PUSH EBP                            ; 00559b23
    ...
    CALL core_script.cpp_CScript_getLetterboxHeight_FUN_00559ac0 ; 00559ba3
