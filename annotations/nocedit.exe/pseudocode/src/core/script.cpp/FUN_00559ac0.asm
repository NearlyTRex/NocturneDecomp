...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_script.cpp_FUN_00559ac0()
;
; Local Variables:
...
;   core_script.cpp_FUN_00559b20 at 00559ba3
;
; Referenced Globals:
...
section .text
    ...
    MOV EDX,dword ptr [0x00679394]      ; 00559ac4 | int g_WindowWidth
    ...
    IDIV EBX                            ; 00559ae5
    MOV ECX,dword ptr [0x00679398]      ; 00559ae7 | int g_WindowHeight
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 00559b08 | double crt_math.c_round_FUN_005fe6b0(double value)
