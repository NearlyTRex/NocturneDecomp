...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_drawLine_FUN_005664d0(CScript *this_ptr,int line_number)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005664d0
        ;   Label: core_script.cpp_CScript_drawLine_FUN_005664d0
    PUSH ESI                            ; 005664d1
    PUSH EDI                            ; 005664d2
    PUSH EBP                            ; 005664d3
