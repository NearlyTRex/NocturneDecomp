...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_clear_FUN_00559870(CScript *this_ptr)
;
; Parameters:
...
;   core_script.cpp_CScript_loadScript_FUN_00559f80 at 0055a2f1
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00559870
        ;   Label: core_script.cpp_CScript_clear_FUN_00559870
    PUSH ESI                            ; 00559871
    ...
    PUSH EBX                            ; 00559882
    CALL core_script.cpp_CScript_freeParsedLines_FUN_005598f0 ; 00559883
