...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_script.cpp_CScript_RelatedToSubtitles_FUN_00559d80()
;
; Local Variables:
...
section .text
    ...
    PUSH EAX                            ; 00559dbd
    CALL cockpit_drawsurf.cpp_CDrawSurface_ctor_FUN_00486ea0 ; 00559dbe | CDrawSurface * cockpit_drawsurf.cpp_CDrawSurface_ctor_FUN_00486ea0(CDrawSurface * this_ptr, int x, int y, int width, ...)
        ;   XREF to: 00486ea0 (UNCONDITIONAL_CALL)
    ADD ESP,0x18                        ; 00559dc3
    PUSH 0x0                            ; 00559dc6
    CALL cockpit_drawsurf.cpp_CDrawSurface_setColor_FUN_00487010 ; 00559dc8 | void cockpit_drawsurf.cpp_CDrawSurface_setColor_FUN_00487010(int color_value)
        ;   XREF to: 00487010 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00559dcd
    LEA EAX,[ESP + 0x64]                ; 00559dd0
    PUSH EAX                            ; 00559dd4
    CALL cockpit_drawsurf.cpp_CDrawSurface_fillFullSurface_FUN_00488c70 ; 00559dd5 | void cockpit_drawsurf.cpp_CDrawSurface_fillFullSurface_FUN_00488c70(CDrawSurface * this_ptr)
        ;   XREF to: 00488c70 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00559dda
    PUSH 0x0                            ; 00559ddd
    CALL cockpit_drawsurf.cpp_setCurrentFont_FUN_004874c0 ; 00559ddf | void cockpit_drawsurf.cpp_setCurrentFont_FUN_004874c0(CBitFont * font_ptr)
        ;   XREF to: 004874c0 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [EBP + 0x30]      ; 00559de4
    ADD ESP,0x4                         ; 00559de7
    TEST EDX,EDX                        ; 00559dea
    JLE 0x00559f56                      ; 00559dec | LAB_00559f56
    ...
    JL 0x00559f2c                       ; 00559e36 | LAB_00559f2c
    ...
    JLE 0x00559f07                      ; 00559e5d | LAB_00559f07
        ;   XREF to: 00559f07 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [ESP + 0x90]      ; 00559e63
        ;   Label: LAB_00559e63
    PUSH EDI                            ; 00559e6a
    CALL shape_edittool.cpp_getFontBitmapCount_FUN_004a6ed0 ; 00559e6b | int shape_edittool.cpp_getFontBitmapCount_FUN_004a6ed0(CBitFont * font_ptr)
        ;   XREF to: 004a6ed0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00559e70
    CMP EBX,EAX                         ; 00559e73
    JGE 0x00559f07                      ; 00559e75 | LAB_00559f07
        ;   XREF to: 00559f07 (CONDITIONAL_JUMP)
    CMP EBX,dword ptr [ESP + 0x84]      ; 00559e7b
    JNZ 0x00559f4c                      ; 00559e82 | LAB_00559f4c
        ;   XREF to: 00559f4c (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [EBP + 0x18]      ; 00559e88
    TEST EDX,EDX                        ; 00559e8b
    JNZ 0x00559f33                      ; 00559e8d | LAB_00559f33
        ;   XREF to: 00559f33 (CONDITIONAL_JUMP)
    PUSH 0xfa                           ; 00559e93
    CALL cockpit_drawsurf.cpp_CDrawSurface_setColor_FUN_00487010 ; 00559e98 | void cockpit_drawsurf.cpp_CDrawSurface_setColor_FUN_00487010(int color_value)
        ;   Label: LAB_00559e98
        ;   XREF to: 00487010 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00559e9d
    LEA EDI,[EBX + 0x1]                 ; 00559ea0
    PUSH EDI                            ; 00559ea3
    PUSH 0x641798                       ; 00559ea4 | = "%d" | s_d_00641798 = %d
    LEA EAX,[ESP + 0x8]                 ; 00559ea9
    PUSH EAX                            ; 00559ead
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 00559eae | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH EAX                            ; 00559ec2
    CALL cockpit_drawsurf.cpp_CDrawSurface_drawTextRightAligned_FUN_004893f0 ; 00559ec3 | void cockpit_drawsurf.cpp_CDrawSurface_drawTextRightAligned_FUN_004893f0(CDrawSurface * this_ptr, int x, int y, char * text)
    ...
    PUSH EAX                            ; 00559ed6
    CALL shape_edittool.cpp_CStrList_getStringAt_FUN_004a2f70 ; 00559ed7 | char * shape_edittool.cpp_CStrList_getStringAt_FUN_004a2f70(CStrList * this_ptr, int index)
        ;   XREF to: 004a2f70 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00559edc
    PUSH EAX                            ; 00559edf
    LEA EAX,[ESP + 0x70]                ; 00559ee0
    PUSH EAX                            ; 00559ee4
    CALL cockpit_drawsurf.cpp_CDrawSurface_drawTextRightAligned_FUN_004893f0 ; 00559ee5 | void cockpit_drawsurf.cpp_CDrawSurface_drawTextRightAligned_FUN_004893f0(CDrawSurface * this_ptr, int x, int y, char * text)
        ;   XREF to: 004893f0 (UNCONDITIONAL_CALL)
    ...
    JL 0x00559e63                       ; 00559f01 | LAB_00559e63
        ;   XREF to: 00559e63 (CONDITIONAL_JUMP)
    PUSH 0xff                           ; 00559f07
        ;   Label: LAB_00559f07
    CALL cockpit_drawsurf.cpp_CDrawSurface_setColor_FUN_00487010 ; 00559f0c | void cockpit_drawsurf.cpp_CDrawSurface_setColor_FUN_00487010(int color_value)
        ;   XREF to: 00487010 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00559f11
    LEA EAX,[ESP + 0x64]                ; 00559f14
    PUSH EAX                            ; 00559f18
    CALL cockpit_drawsurf.cpp_CDrawSurface_drawSurfaceBorder_FUN_00488530 ; 00559f19 | void cockpit_drawsurf.cpp_CDrawSurface_drawSurfaceBorder_FUN_00488530(CDrawSurface * this_ptr)
    ...
    XOR EBX,EBX                         ; 00559f2c
        ;   Label: LAB_00559f2c
    JMP 0x00559e3c                      ; 00559f2e | LAB_00559e3c
        ;   XREF to: 00559e3c (UNCONDITIONAL_JUMP)
    CMP EDX,0x1                         ; 00559f33
        ;   Label: LAB_00559f33
    JNZ 0x00559f42                      ; 00559f36 | LAB_00559f42
        ;   XREF to: 00559f42 (CONDITIONAL_JUMP)
    PUSH 0xfb                           ; 00559f38
    JMP 0x00559e98                      ; 00559f3d | LAB_00559e98
        ;   XREF to: 00559e98 (UNCONDITIONAL_JUMP)
    PUSH 0xf9                           ; 00559f42
        ;   Label: LAB_00559f42
    JMP 0x00559e98                      ; 00559f47 | LAB_00559e98
        ;   XREF to: 00559e98 (UNCONDITIONAL_JUMP)
    PUSH 0xff                           ; 00559f4c
        ;   Label: LAB_00559f4c
    JMP 0x00559e98                      ; 00559f51 | LAB_00559e98
        ;   XREF to: 00559e98 (UNCONDITIONAL_JUMP)
    PUSH 0xf9                           ; 00559f56
        ;   Label: LAB_00559f56
    CALL cockpit_drawsurf.cpp_CDrawSurface_setColor_FUN_00487010 ; 00559f5b | void cockpit_drawsurf.cpp_CDrawSurface_setColor_FUN_00487010(int color_value)
        ;   XREF to: 00487010 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00559f60
    PUSH 0x64179b                       ; 00559f63 | = "(No script loaded.)" | s_No_script_loaded_0064179b = (No script loaded.)
    LEA EAX,[ESP + 0x68]                ; 00559f68
    PUSH EAX                            ; 00559f6c
    CALL cockpit_drawsurf.cpp_CDrawSurface_drawTextCenteredFullSurface_FUN_00489c20 ; 00559f6d | void cockpit_drawsurf.cpp_CDrawSurface_drawTextCenteredFullSurface_FUN_00489c20(CDrawSurface * this_ptr, char * text)
        ;   XREF to: 00489c20 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00559f72
    JMP 0x00559f07                      ; 00559f75 | LAB_00559f07
