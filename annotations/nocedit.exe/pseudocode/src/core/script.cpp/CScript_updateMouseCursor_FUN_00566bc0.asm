...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_updateMouseCursor_FUN_00566bc0(CScript *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00566bc0
        ;   Label: core_script.cpp_CScript_updateMouseCursor_FUN_00566bc0
