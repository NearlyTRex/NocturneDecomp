...
section .text
    ...
    PUSH EDI                            ; 00566fb8
    CALL core_script.cpp_CScript_LoadingScriptFile_FUN_0055a370 ; 00566fb9 | undefined core_script.cpp_CScript_LoadingScriptFile_FUN_0055a370()
    ...
    JLE 0x00566ff4                      ; 00566fc8 | LAB_00566ff4
    ...
    PUSH 0x644042                       ; 00566fd2 | = ": %s" | s_s_00644042 = : %s
    MOV EDX,dword ptr [ESI + EAX*0x1 + 0x4] ; 00566fd7
    PUSH EDX                            ; 00566fdb
    CALL crt_stdio.c_sscanf_FUN_0060013c ; 00566fdc | int crt_stdio.c_sscanf_FUN_0060013c(char * str, char * format)
        ;   XREF to: 0060013c (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00566fe1
    CMP EAX,0x1                         ; 00566fe4
    JZ 0x00566fff                       ; 00566fe7 | LAB_00566fff
    ...
    JL 0x00566fcc                       ; 00566ff2 | LAB_00566fcc
    ...
    PUSH EAX                            ; 00567001
    PUSH EBP                            ; 00567002
    CALL shape_edittool.cpp_CStrList_add_FUN_004a2b80 ; 00567003 | void shape_edittool.cpp_CStrList_add_FUN_004a2b80(CStrList * this_ptr, char * string_data)
        ;   XREF to: 004a2b80 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00567008
    JMP 0x00566fe9                      ; 0056700b | LAB_00566fe9
