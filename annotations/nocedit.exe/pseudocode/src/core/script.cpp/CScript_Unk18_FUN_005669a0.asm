...
section .text
    ...
    MOV EAX,[0x0310fcdc]                ; 005669ae | DAT_0310fcdc
    MOV ECX,dword ptr [0x0310fce0]      ; 005669b3 | DAT_0310fce0
    MOV EBX,dword ptr [0x0310fcd8]      ; 005669b9 | DAT_0310fcd8
    ...
    MOV ESI,dword ptr [0x0310fd48]      ; 005669cc | DAT_0310fd48
        ;   Label: LAB_005669cc
    CMP ESI,dword ptr [0x0310fcd8]      ; 005669d2 | DAT_0310fcd8
    JGE 0x005669e0                      ; 005669d8
        ;   XREF to: 005669e0 (CONDITIONAL_JUMP)  ; LAB_005669e0
    MOV dword ptr [0x0310fcd8],ESI      ; 005669da | DAT_0310fcd8
    MOV EDI,dword ptr [0x0310fce0]      ; 005669e0 | DAT_0310fce0
        ;   Label: LAB_005669e0
    MOV EAX,[0x0310fd48]                ; 005669e6 | DAT_0310fd48
    SUB EAX,EDI                         ; 005669eb
    MOV EBP,dword ptr [0x0310fcd8]      ; 005669ed | DAT_0310fcd8
    INC EAX                             ; 005669f3
    CMP EAX,EBP                         ; 005669f4
    JLE 0x005669fd                      ; 005669f6
        ;   XREF to: 005669fd (CONDITIONAL_JUMP)  ; LAB_005669fd
    MOV [0x0310fcd8],EAX                ; 005669f8 | DAT_0310fcd8
    CMP dword ptr [0x0310fcd8],0x0      ; 005669fd | DAT_0310fcd8
        ;   Label: LAB_005669fd
    JL 0x00566a6b                       ; 00566a04
        ;   XREF to: 00566a6b (CONDITIONAL_JUMP)  ; LAB_00566a6b
    MOV ECX,dword ptr [0x0310fd14]      ; 00566a06 | DAT_0310fd14
        ;   Label: LAB_00566a06
    MOV EAX,[0x0310fd10]                ; 00566a0c | DAT_0310fd10
    MOV EBX,dword ptr [0x0310fd0c]      ; 00566a11 | DAT_0310fd0c
    SUB EAX,ECX                         ; 00566a17
    CMP EAX,EBX                         ; 00566a19
    JGE 0x00566a22                      ; 00566a1b
        ;   XREF to: 00566a22 (CONDITIONAL_JUMP)  ; LAB_00566a22
    MOV [0x0310fd0c],EAX                ; 00566a1d | DAT_0310fd0c
    MOV ESI,dword ptr [0x0310fd44]      ; 00566a22 | DAT_0310fd44
        ;   Label: LAB_00566a22
    CMP ESI,dword ptr [0x0310fd0c]      ; 00566a28 | DAT_0310fd0c
    JGE 0x00566a36                      ; 00566a2e
        ;   XREF to: 00566a36 (CONDITIONAL_JUMP)  ; LAB_00566a36
    MOV dword ptr [0x0310fd0c],ESI      ; 00566a30 | DAT_0310fd0c
    MOV EDI,dword ptr [0x0310fd14]      ; 00566a36 | DAT_0310fd14
        ;   Label: LAB_00566a36
    MOV EAX,[0x0310fd44]                ; 00566a3c | DAT_0310fd44
    SUB EAX,EDI                         ; 00566a41
    MOV EBP,dword ptr [0x0310fd0c]      ; 00566a43 | DAT_0310fd0c
    INC EAX                             ; 00566a49
    CMP EAX,EBP                         ; 00566a4a
    JLE 0x00566a53                      ; 00566a4c
        ;   XREF to: 00566a53 (CONDITIONAL_JUMP)  ; LAB_00566a53
    MOV [0x0310fd0c],EAX                ; 00566a4e | DAT_0310fd0c
    CMP dword ptr [0x0310fd0c],0x0      ; 00566a53 | DAT_0310fd0c
        ;   Label: LAB_00566a53
