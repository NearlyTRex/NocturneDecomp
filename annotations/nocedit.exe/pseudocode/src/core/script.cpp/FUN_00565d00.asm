...
;                               FUNCTION
; *****************************************************************************
; unknown void core_script_cpp_FUN_00565d00(void)
;
;
; XREF[1]:
...
section .text
    ...
    LEA ESI,[EBX + 0x38]                ; 00565d15
        ;   Label: LAB_00565d15
    PUSH ESI                            ; 00565d18
    CALL shape_edittool.cpp_getFontBitmapCount_FUN_004a6ed0 ; 00565d19
    ...
    PUSH 0x78                           ; 00565d34
    PUSH 0x680e28                       ; 00565d36 | PTR_s_label_006441c0_00680e28
    PUSH EAX                            ; 00565d3b
    PUSH EDI                            ; 00565d3c
    PUSH ESI                            ; 00565d3d
    ...
    CALL core_script.cpp_SCmdParse_bestParse_FUN_00561db0 ; 00565d4c
    ...
    CALL core_msnedit.cpp_UndoTmp_BuildActorList_CreateTmp_FUN_0053c140 ; 00565dc3
    ...
    PUSH EBX                            ; 00565dd0
        ;   Label: caseD_5
    CALL core_script.cpp_CScript_LoadingScriptFile_FUN_0055a370 ; 00565dd1
    ...
    PUSH EAX                            ; 00565de9
    PUSH EBX                            ; 00565dea
    CALL core_script.cpp_FUN_00560160   ; 00565deb
    ...
    MOV [0x0310fd48],EAX                ; 00565e00 | DAT_0310fd48
    MOV dword ptr [0x0310fd44],ESI      ; 00565e05 | DAT_0310fd44
    CALL core_script.cpp_FUN_005644e0   ; 00565e0b
        ;   XREF to: 005644e0 (UNCONDITIONAL_CALL)  ; undefined core_script.cpp_FUN_005644e0()
    PUSH EBX                            ; 00565e10
    CALL core_script.cpp_CScript_CallingScriptEditorX2_2_FUN_00566910 ; 00565e11
    ...
    PUSH EBX                            ; 00565e19
    CALL core_script.cpp_CScript_Unk18_FUN_005669a0 ; 00565e1a
    ...
    CALL core_msnedit.cpp_FUN_0053eb40  ; 00565e63
