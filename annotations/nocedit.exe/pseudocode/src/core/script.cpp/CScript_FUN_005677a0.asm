...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_script_cpp_CScript_FUN_005677a0(CScript *this_ptr,char *param_2,char *param_3)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005677a0
        ;   Label: core_script.cpp_CScript_FUN_005677a0
    PUSH ESI                            ; 005677a1
    PUSH EDI                            ; 005677a2
    PUSH EBP                            ; 005677a3
