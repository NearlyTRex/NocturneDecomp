...
;                               FUNCTION
; *****************************************************************************
; unknown void core_script_cpp_FUN_00565f70(void)
;
;
; XREF[1]:
...
section .text
    ...
    CALL core_script.cpp_SCmdParse_bestParse_FUN_00561db0 ; 00565fcf
    ...
    CALL core_script.cpp_FUN_005624f0   ; 00566013
        ;   XREF to: 005624f0 (UNCONDITIONAL_CALL)  ; undefined core_script.cpp_FUN_005624f0()
    ...
    CALL core_script.cpp_FUN_00562760   ; 00566031
        ;   XREF to: 00562760 (UNCONDITIONAL_CALL)  ; undefined core_script.cpp_FUN_00562760()
    ...
    PUSH EBX                            ; 00566054
    CALL core_script.cpp_CScript_CallingScriptEditorX2_2_FUN_00566910 ; 00566055
    ...
    PUSH EBX                            ; 0056605d
    CALL core_script.cpp_CScript_Unk18_FUN_005669a0 ; 0056605e
    ...
    PUSH ESI                            ; 0056606d
    PUSH EBX                            ; 0056606e
    CALL core_script.cpp_FUN_00566390   ; 0056606f
