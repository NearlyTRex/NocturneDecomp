...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_script_cpp_CScript_FUN_00567310(CScript *this_ptr,int param_2,CBitFont *param_3,int *param_4)
;
; Parameters:
; CScript *        Stack[0x4]:4   this_ptr
; int              Stack[0x8]:4   param_2
; CBitFont *       Stack[0xc]:4   param_3
...
section .text
    ...
    PUSH EBX                            ; 00567310
        ;   Label: core_script.cpp_CScript_FUN_00567310
    PUSH ESI                            ; 00567311
    PUSH EDI                            ; 00567312
    PUSH EBP                            ; 00567313
