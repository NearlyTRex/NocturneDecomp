...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_FUN_00567630(CScript *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00567630
        ;   Label: core_script.cpp_CScript_FUN_00567630
    PUSH ESI                            ; 00567631
    PUSH EDI                            ; 00567632
    PUSH EBP                            ; 00567633
    ...
    CALL core_script.cpp_CScript_FUN_0055a370 ; 00567649
    ...
    INC EDI                             ; 00567681
    CALL core_script.cpp_CScript_FUN_00567080 ; 00567682
        ;   XREF to: 00567080 (UNCONDITIONAL_CALL)  ; void core_script.cpp_CScript_FUN_00567080(CScript * this_ptr, char * param_2, int * param_3)
