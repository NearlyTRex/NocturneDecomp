...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_drawEditor_FUN_005645d0(CScript *this_ptr)
;
; Parameters:
; CScript *        Stack[0x4]:4   this_ptr
; Local Variables:
; char[500]        Stack[-0x204]:500  local_204
;
; XREF[1]:
...
section .text
    ...
    PUSH EBX                            ; 005645d0
        ;   Label: core_script.cpp_CScript_drawEditor_FUN_005645d0
    PUSH ESI                            ; 005645d1
    PUSH EDI                            ; 005645d2
    PUSH EBP                            ; 005645d3
    ...
    PUSH EBX                            ; 005647a9
        ;   Label: LAB_005647a9
    PUSH ESI                            ; 005647aa
    CALL core_script.cpp_CScript_drawLine_FUN_005664d0 ; 005647ab
        ;   XREF to: 005664d0 (UNCONDITIONAL_CALL)  ; void core_script.cpp_CScript_drawLine_FUN_005664d0(CScript * this_ptr, int line_number)
    INC EBX                             ; 005647b0
