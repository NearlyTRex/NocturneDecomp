...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_script.cpp_SetTemplateText_TemplateBugCantShowUsage_FUN_005643d0()
;
; Local Variables:
...
section .text
    ...
    TEST DL,DL                          ; 00564401
    JZ 0x0056448e                       ; 00564403 | LAB_0056448e
        ;   XREF to: 0056448e (CONDITIONAL_JUMP)
    CMP DL,0x3c                         ; 00564409
    JZ 0x0056442e                       ; 0056440c | LAB_0056442e
    ...
    JMP 0x005643f3                      ; 0056442c | LAB_005643f3
    ...
    PUSH EAX                            ; 0056443b
    CALL core_script.cpp_SCmdParm_setTemplateText_FUN_00560de0 ; 0056443c | undefined core_script.cpp_SCmdParm_setTemplateText_FUN_00560de0()
        ;   XREF to: 00560de0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00564441
    TEST EAX,EAX                        ; 00564444
    JZ 0x00564462                       ; 00564446 | LAB_00564462
        ;   XREF to: 00564462 (CONDITIONAL_JUMP)
    LEA EAX,[ESP + 0x2c0]               ; 00564448
    PUSH EAX                            ; 0056444f
    PUSH 0x643d6f                       ; 00564450 | = "<%s>" | s_s_00643d6f = <%s>
    PUSH EBX                            ; 00564455
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 00564456 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0056445b
    ADD ESI,EAX                         ; 0056445e
    JMP 0x005643f3                      ; 00564460 | LAB_005643f3
        ;   XREF to: 005643f3 (UNCONDITIONAL_JUMP)
    MOV ESI,0x643d50                    ; 00564462 | = "Template bug, can't show usage" | s_Template_bug_can_t_show__00643d50 = Template bug, can't show usage
        ;   Label: LAB_00564462
    MOV EDI,EBP                         ; 00564467
    PUSH EDI                            ; 00564469
    MOV AL,byte ptr [ESI]               ; 0056446a | = "Template bug, can't show usage" | s_Template_bug_can_t_show__00643d50 = Template bug, can't show usage
        ;   Label: LAB_0056446a
    MOV byte ptr [EDI],AL               ; 0056446c
    CMP AL,0x0                          ; 0056446e
    JZ 0x00564482                       ; 00564470 | LAB_00564482
        ;   XREF to: 00564482 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 00564472 | s_emplate_bug,_can't_show_usage_00643d51
    ADD ESI,0x2                         ; 00564475
    MOV byte ptr [EDI + 0x1],AL         ; 00564478
    ADD EDI,0x2                         ; 0056447b
    CMP AL,0x0                          ; 0056447e
    JNZ 0x0056446a                      ; 00564480 | LAB_0056446a
