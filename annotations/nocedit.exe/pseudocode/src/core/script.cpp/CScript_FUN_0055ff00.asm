...
;                               FUNCTION
; *****************************************************************************
; __cdecl float __cdecl core_script_cpp_CScript_FUN_0055ff00(CScript *this_ptr,int param_2,char *param_3,char *param_4)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0055ff00
        ;   Label: core_script.cpp_CScript_FUN_0055ff00
    PUSH ESI                            ; 0055ff01
    PUSH EDI                            ; 0055ff02
    PUSH EBP                            ; 0055ff03
    ...
    PUSH EDI                            ; 0055ff3d
    CALL core_script.cpp_GetDemonActor_FUN_005594e0 ; 0055ff3e
    ...
    CMP dword ptr [0x0310f4ac],0x0      ; 0055ff51 | DAT_0310f4ac
    ...
    CMP dword ptr [0x0310ec9c],0x0      ; 0055ffac | DAT_0310ec9c
        ;   Label: LAB_0055ffac
    ...
    CMP dword ptr [0x0310ec9c],0x0      ; 00560020 | DAT_0310ec9c
        ;   Label: LAB_00560020
