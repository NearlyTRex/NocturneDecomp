...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_saveToFile_FUN_00566180(CScript *this_ptr,char *filename)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00566180
        ;   Label: core_script.cpp_CScript_saveToFile_FUN_00566180
    PUSH ESI                            ; 00566181
    PUSH EDI                            ; 00566182
    PUSH EBP                            ; 00566183
