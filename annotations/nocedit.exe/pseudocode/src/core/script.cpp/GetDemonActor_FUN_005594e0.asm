...
section .text
    ...
    MOV dword ptr [0x0310f4ac],EDX      ; 005594ea | DAT_0310f4ac
    ...
    MOV ESI,0x641566                    ; 00559515 | = "Must specify actor name"
        ;   Label: LAB_00559515
    MOV EDI,0x310eca0                   ; 0055951a | DAT_0310eca0
    PUSH EDI                            ; 0055951f | DAT_0310eca0
    MOV AL,byte ptr [ESI]               ; 00559520 | = "Must specify actor name" | s_st_specify_actor_name_00641568
        ;   Label: LAB_00559520
    MOV byte ptr [EDI],AL               ; 00559522 | DAT_0310eca0 | DAT_0310eca2
    CMP AL,0x0                          ; 00559524
    ...
    MOV dword ptr [0x0310f4ac],EBP      ; 0055954c | DAT_0310f4ac
    ...
    PUSH 0x310eca0                      ; 00559583 | DAT_0310eca0
    ...
    PUSH 0x310eca0                      ; 005595ce | DAT_0310eca0
    MOV dword ptr [0x0310f4ac],EDI      ; 005595d3 | DAT_0310f4ac
    ...
    PUSH 0x6415c6                       ; 005595e8 | = "Can't use '$' actor specifier in mult..."
        ;   Label: LAB_005595e8
    PUSH 0x310eca0                      ; 005595ed | DAT_0310eca0
    ...
    PUSH 0x310eca0                      ; 00559621 | DAT_0310eca0
    ...
    PUSH 0x310eca0                      ; 0055964a | DAT_0310eca0
