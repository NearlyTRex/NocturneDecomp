...
section .text
    ...
    FNSTSW AX                           ; 005600d2
    SAHF                                ; 005600d4
    JA 0x00560108                       ; 005600d5 | LAB_00560108
    ...
    FNSTSW AX                           ; 005600dc
    SAHF                                ; 005600de
    JBE 0x005600e8                      ; 005600df | LAB_005600e8
    ...
    FNSTSW AX                           ; 005600ed
    SAHF                                ; 005600ef
    JA 0x0056012d                       ; 005600f0 | LAB_0056012d
    ...
    POP EBX                             ; 00560106
    RET                                 ; 00560107
    MOV EDX,0x6431b8                    ; 00560108 | = "..\\core\\script.cpp" | s_core_script_cpp_006431b8 = ..\core\script.cpp
        ;   Label: LAB_00560108
    MOV ECX,0xdf7                       ; 0056010d
    PUSH 0x6431cb                       ; 00560112 | = "CScript::processTimer - invalidTimeTo..." | s_CScript_processTimer_inv_006431cb = CScript::processTimer - invalidTimeToWait
    MOV dword ptr [0x02f0ca48],EDX      ; 00560117 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 0056011d | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00560123 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00560128
    JMP 0x005600d7                      ; 0056012b | LAB_005600d7
