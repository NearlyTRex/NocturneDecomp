...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_FUN_00565130(CScript *this_ptr)
;
; Parameters:
...
;   core_script.cpp_CScript_FUN_00566880
;   core_script.cpp_CScript_FUN_00566cc0
...
section .text
    ...
    PUSH EBX                            ; 00565130
        ;   Label: core_script.cpp_CScript_FUN_00565130
    PUSH ESI                            ; 00565131
    PUSH EDI                            ; 00565132
    PUSH EBP                            ; 00565133
    ...
    PUSH EBP                            ; 00565196
    CALL core_script.cpp_CScript_FUN_00566880 ; 00565197
        ;   XREF to: 00566880 (UNCONDITIONAL_CALL)  ; void core_script.cpp_CScript_FUN_00566880(CScript * this_ptr)
    ...
    PUSH EBP                            ; 005654f9
    CALL core_script.cpp_CScript_FUN_00566cc0 ; 005654fa
        ;   XREF to: 00566cc0 (UNCONDITIONAL_CALL)  ; int core_script.cpp_CScript_FUN_00566cc0(CScript * this_ptr, char * param_2, int param_3, int param_4, ...)
    ...
    PUSH EBP                            ; 005655d6
    CALL core_script.cpp_CScript_FUN_00566cc0 ; 005655d7
        ;   XREF to: 00566cc0 (UNCONDITIONAL_CALL)  ; int core_script.cpp_CScript_FUN_00566cc0(CScript * this_ptr, char * param_2, int param_3, int param_4, ...)
