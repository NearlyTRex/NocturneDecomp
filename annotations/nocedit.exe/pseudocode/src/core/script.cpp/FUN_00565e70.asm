...
;                               FUNCTION
; *****************************************************************************
; unknown void core_script_cpp_FUN_00565e70(void)
;
; Local Variables:
...
section .text
    ...
    CALL core_script.cpp_SetTemplateText_TemplateBugCantShowUsage_FUN_005643d0 ; 00565efd
        ;   XREF to: 005643d0 (UNCONDITIONAL_CALL)  ; undefined core_script.cpp_SetTemplateText_TemplateBugCantShowUsage_FUN_005643d0()
    ...
    PUSH EAX                            ; 00565f26
    CALL core_script.cpp_SCmdParse_bestParse_FUN_00561db0 ; 00565f27
    ...
    MOV EDI,0x310fdc0                   ; 00565f38 | DAT_0310fdc0
    PUSH EDI                            ; 00565f3d | DAT_0310fdc0
    MOV AL,byte ptr [ESI]               ; 00565f3e | = "Not enough context to show usage.  (T..." | s_t_enough_context_to_show_usage._(_00643ebd
        ;   Label: LAB_00565f3e
    MOV byte ptr [EDI],AL               ; 00565f40 | DAT_0310fdc0 | DAT_0310fdc2
    CMP AL,0x0                          ; 00565f42
