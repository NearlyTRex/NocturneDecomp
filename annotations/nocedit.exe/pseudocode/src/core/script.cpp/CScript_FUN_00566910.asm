...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_FUN_00566910(CScript *this_ptr)
;
; Parameters:
...
;   core_script.cpp_CScript_FUN_005669a0 at 005669a9
...
section .text
    ...
    PUSH EBX                            ; 00566910
        ;   Label: core_script.cpp_CScript_FUN_00566910
    PUSH EBP                            ; 00566911
    ...
    PUSH EDX                            ; 00566957
    PUSH EBX                            ; 00566958
    CALL core_script.cpp_CScript_FUN_00566a90 ; 00566959
    ...
    CALL core_script.cpp_CScript_FUN_00566b30 ; 0056696f
