...
section .text
    ...
    PUSH ESI                            ; 0055966f
    CALL crt_string.c__stricmp_FUN_005fe7f0 ; 00559670
    ...
    PUSH 0x641670                       ; 00559681 | = "backup"
        ;   Label: LAB_00559681
    PUSH ESI                            ; 00559686
    CALL crt_string.c__stricmp_FUN_005fe7f0 ; 00559687
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)  ; int crt_string.c__stricmp_FUN_005fe7f0(char * str1, char * str2)
    ...
    PUSH 0x641677                       ; 00559699 | = "run"
        ;   Label: LAB_00559699
    PUSH ESI                            ; 0055969e
    CALL crt_string.c__stricmp_FUN_005fe7f0 ; 0055969f
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)  ; int crt_string.c__stricmp_FUN_005fe7f0(char * str1, char * str2)
    ...
    PUSH 0x64167b                       ; 005596b1 | = "fire"
        ;   Label: LAB_005596b1
    PUSH ESI                            ; 005596b6
    CALL crt_string.c__stricmp_FUN_005fe7f0 ; 005596b7
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)  ; int crt_string.c__stricmp_FUN_005fe7f0(char * str1, char * str2)
    ...
    PUSH 0x641680                       ; 005596c9 | = "useItem"
        ;   Label: LAB_005596c9
    PUSH ESI                            ; 005596ce
    CALL crt_string.c__stricmp_FUN_005fe7f0 ; 005596cf
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)  ; int crt_string.c__stricmp_FUN_005fe7f0(char * str1, char * str2)
    ...
    PUSH 0x641688                       ; 005596e1 | = "light"
        ;   Label: LAB_005596e1
    PUSH ESI                            ; 005596e6
    CALL crt_string.c__stricmp_FUN_005fe7f0 ; 005596e7
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)  ; int crt_string.c__stricmp_FUN_005fe7f0(char * str1, char * str2)
    ...
    PUSH 0x64168e                       ; 005596f9 | = "draw"
        ;   Label: LAB_005596f9
    PUSH ESI                            ; 005596fe
    CALL crt_string.c__stricmp_FUN_005fe7f0 ; 005596ff
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)  ; int crt_string.c__stricmp_FUN_005fe7f0(char * str1, char * str2)
    ...
    PUSH 0x641693                       ; 00559711 | = "jump"
        ;   Label: LAB_00559711
    PUSH ESI                            ; 00559716
    CALL crt_string.c__stricmp_FUN_005fe7f0 ; 00559717
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)  ; int crt_string.c__stricmp_FUN_005fe7f0(char * str1, char * str2)
