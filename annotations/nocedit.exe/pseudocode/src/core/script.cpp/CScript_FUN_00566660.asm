...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_FUN_00566660 (CScript *this_ptr,int param_2,int param_3,int param_4,int param_5)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00566660
        ;   Label: core_script.cpp_CScript_FUN_00566660
    PUSH ESI                            ; 00566661
    PUSH EDI                            ; 00566662
    PUSH EBP                            ; 00566663
    ...
    MOV dword ptr [0x03114204],EBX      ; 00566694 | INT_03114204
    ...
    MOV dword ptr [0x031141d4],EDX      ; 005666ad | INT_031141d4
    MOV EDX,dword ptr [ESP + 0x20]      ; 005666b3
    INC EDX                             ; 005666b7
    MOV dword ptr [0x031141d8],EDX      ; 005666b8 | INT_031141d8
    MOV EDX,dword ptr [ESP + 0x24]      ; 005666be
    INC EDX                             ; 005666c2
    MOV dword ptr [0x031141dc],EDX      ; 005666c3 | INT_031141dc
    MOV EDX,dword ptr [0x031141d8]      ; 005666c9 | INT_031141d8
    MOV [0x03114208],EAX                ; 005666cf | DAT_03114208
    MOV dword ptr [0x031141f8],EDX      ; 005666d4 | DAT_031141f8
    MOV EDX,dword ptr [0x031141dc]      ; 005666da | INT_031141dc
    MOV dword ptr [0x031141d0],ESI      ; 005666e0 | INT_031141d0
    ...
    MOV EDX,dword ptr [0x031141d0]      ; 00566706 | INT_031141d0
    MOV dword ptr [0x031141e0],EDX      ; 0056670c | INT_031141e0
    MOV EDX,dword ptr [0x031141d4]      ; 00566712 | INT_031141d4
    INC EDX                             ; 00566718
    MOV ESI,dword ptr [0x031141f4]      ; 00566719 | DAT_031141f4
    MOV dword ptr [0x031141e4],EDX      ; 0056671f | INT_031141e4
    MOV EDX,dword ptr [0x031141d8]      ; 00566725 | INT_031141d8
    PUSH ESI                            ; 0056672b
    ...
    MOV EDX,dword ptr [0x031141e0]      ; 0056673d | INT_031141e0
    PUSH EDX                            ; 00566743
    ...
    PUSH ECX                            ; 0056675c
    MOV EBX,dword ptr [0x031141d8]      ; 0056675d | INT_031141d8
    PUSH EBX                            ; 00566763
    MOV ESI,dword ptr [0x031141e4]      ; 00566764 | INT_031141e4
    PUSH ESI                            ; 0056676a
    ...
    SUB EDX,dword ptr [0x031141e4]      ; 00566782 | INT_031141e4
    MOV EBX,dword ptr [0x03114208]      ; 00566788 | DAT_03114208
    MOV EAX,EDX                         ; 0056678e
    SAR EDX,0x1f                        ; 00566790
    IDIV EBX                            ; 00566793
    MOV ECX,dword ptr [0x031141e0]      ; 00566795 | INT_031141e0
    MOV EDX,dword ptr [0x031141e8]      ; 0056679b | DAT_031141e8
    MOV EBX,dword ptr [0x03114204]      ; 005667a1 | INT_03114204
    ...
    PUSH EBX                            ; 005667ed
        ;   Label: LAB_005667ed
    PUSH EDI                            ; 005667ee
    CALL core_script.cpp_CScript_FUN_00566800 ; 005667ef
