...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_script_cpp_CScript_FUN_005602e0(CScript *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005602e0
        ;   Label: core_script.cpp_CScript_FUN_005602e0
    PUSH EBP                            ; 005602e1
    ...
    PUSH ESI                            ; 005602fb
    PUSH EBX                            ; 005602fc
    CALL core_script.cpp_CScript_FUN_005602b0 ; 005602fd
