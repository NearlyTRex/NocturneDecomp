...
; CPickList        Stack[-0x3754]:936  local_3754
; CPickList        Stack[-0x33ac]:936  local_33ac
; CPickList        Stack[-0x3004]:936  local_3004
; CPickList        Stack[-0x2c5c]:936  local_2c5c
; CPickList        Stack[-0x28b4]:936  local_28b4
; CPickList        Stack[-0x250c]:936  local_250c
; CPickList        Stack[-0x2164]:936  local_2164
; CPickList        Stack[-0x1dbc]:936  local_1dbc
; CPickList        Stack[-0x1a14]:936  local_1a14
; CPickList        Stack[-0x166c]:936  local_166c
; CPickList        Stack[-0x12c4]:936  local_12c4
; CPickList        Stack[-0xf1c]:936  local_f1c
; CPickList        Stack[-0xb74]:936  local_b74
; char[300]        Stack[-0x7cc]:300  local_7cc
; char[300]        Stack[-0x6a0]:300  local_6a0
...
section .text
    ...
    PUSH EBX                            ; 00562920
        ;   Label: core_script.cpp_editParameterValue_FUN_00562920
    PUSH ESI                            ; 00562921
    PUSH EDI                            ; 00562922
    PUSH EBP                            ; 00562923
    ...
    PUSH EAX                            ; 0056294b
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 0056294c
    ...
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 005629d3
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c__sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 00562a41
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c__sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    LEA EAX,[ESP + 0x754]               ; 00562b43
        ;   Label: LAB_00562b43
    PUSH EAX                            ; 00562b4a
    CALL shape_edittool.cpp_CStrList_sortAll_FUN_004a2ec0 ; 00562b4b
    ...
    PUSH EAX                            ; 0056388e
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 0056388f
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c__sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    MOV EAX,[0x00680d50]                ; 00563a50 | g_CScriptInstance | g_CScriptPtr
        ;   Label: caseD_19
    CMP dword ptr [EAX + 0x1c],0x1      ; 00563a55 | g_CScriptInstance.dialog_entry_count
    ...
    MOV EAX,[0x00680d50]                ; 00563a6f | g_CScriptPtr
        ;   Label: LAB_00563a6f
    CMP EDI,dword ptr [EAX + 0x1c]      ; 00563a74 | g_CScriptInstance.dialog_entry_count
    JGE 0x00563ad9                      ; 00563a77
        ;   XREF to: 00563ad9 (CONDITIONAL_JUMP)  ; LAB_00563ad9
    MOV EAX,dword ptr [EAX + 0x20]      ; 00563a79 | g_CScriptInstance.dialog_entries
    ...
    PUSH 0x31099e8                      ; 00563a8f | g_ScriptFormatBuffer
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 00563a94
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c__sprintf_FUN_005fdbd0(char * buffer, char * format)
    ADD ESP,0x14                        ; 00563a99
    PUSH 0x31099e8                      ; 00563a9c | g_ScriptFormatBuffer
    ...
    PUSH 0x310a9e8                      ; 00563af1 | g_ScriptTempBuffer
    ...
    MOV ESI,dword ptr [ESI + 0x20]      ; 00563b36 | g_CScriptInstance.dialog_entries
    ...
    MOV ESI,dword ptr [EAX + 0x20]      ; 00563b5d | g_CScriptInstance.dialog_entries
    MOV EDI,0x310a9e8                   ; 00563b60 | g_ScriptTempBuffer
    ...
    PUSH EBX                            ; 00563d8a
    PUSH EAX                            ; 00563d8b
    CALL core_script.cpp_parseBodyPartMask_FUN_00559730 ; 00563d8c
    ...
    PUSH 0x310eca0                      ; 00563d98 | g_ScriptErrorBuffer
    ...
    PUSH EAX                            ; 00563e31
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 00563e32
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c__sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH EAX                            ; 00563e9e
    CALL shape_edittool.cpp_CStrList_getItemCount_FUN_004a6ed0 ; 00563e9f
    ...
    MOV ECX,0x643d07                    ; 00563eb0 | s_EmptyChar_00643d07
    XOR EBX,EBX                         ; 00563eb5
    MOV EAX,dword ptr [EBP + 0x14]      ; 00563eb7
    MOV dword ptr [ESP + 0x3744],EBX    ; 00563eba
    MOV dword ptr [ESP + 0x373c],ECX    ; 00563ec1 | s_EmptyChar_00643d07
    ...
    MOV AL,byte ptr [ESI + 0x1]         ; 00563f3f | = " " | s_WARNING_chooseParm_unkno_00643d0a
    ...
    MOV EDI,0x643d08                    ; 00563f58 | = " "
    PUSH EAX                            ; 00563f5d
    MOV dword ptr [ESP + 0x3744],EDI    ; 00563f5e | = " "
