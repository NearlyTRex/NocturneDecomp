...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_script.cpp_FUN_005627f0()
;
; Local Variables:
...
section .text
    ...
    PUSH 0x823c14                       ; 00562836 | CDemonActorType g_CCharacterClassInfo
    ...
    PUSH EAX                            ; 0056284d
    CALL core_script.cpp_GetDemonActor_FUN_005594e0 ; 0056284e | undefined core_script.cpp_GetDemonActor_FUN_005594e0()
