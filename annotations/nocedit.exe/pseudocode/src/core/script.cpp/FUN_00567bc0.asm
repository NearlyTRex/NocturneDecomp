...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_script.cpp_FUN_00567bc0()
;
; Local Variables:
...
section .text
    ...
    PUSH EDI                            ; 00567bd1
    CALL core_script.cpp_CScript_LoadingScriptFile_FUN_0055a370 ; 00567bd2 | undefined core_script.cpp_CScript_LoadingScriptFile_FUN_0055a370()
    ...
    JLE 0x00567cf0                      ; 00567be8 | LAB_00567cf0
    ...
    MOV ECX,dword ptr [EAX + 0x680e28]  ; 00567c1a | void * PTR_s_label_006441c0_00680e28 | PTR_s_anon_006441c9_00680e2c = 006441c9
    ...
    PUSH EAX                            ; 00567c68
    PUSH 0x6441ae                       ; 00567c69 | = "%s\tScript line %d" | s_s_Script_line_d_006441ae = %s	Script line %d
    LEA EAX,[ESP + 0x2134]              ; 00567c6e
    PUSH EAX                            ; 00567c75
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 00567c76 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH ECX                            ; 00567c8d
    CALL shape_edittool.cpp_CStrList_add_FUN_004a2b80 ; 00567c8e | void shape_edittool.cpp_CStrList_add_FUN_004a2b80(CStrList * this_ptr, char * string_data)
    ...
    JL 0x00567c4b                       ; 00567ca6 | LAB_00567c4b
    ...
    JNZ 0x00567c0c                      ; 00567cbf | LAB_00567c0c
    ...
    JL 0x00567bf5                       ; 00567cea | LAB_00567bf5
