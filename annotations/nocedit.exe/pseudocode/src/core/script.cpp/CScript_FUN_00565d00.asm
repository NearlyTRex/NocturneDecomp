...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_FUN_00565d00(CScript *this_ptr,int param_2,int param_3)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00565d00
        ;   Label: core_script.cpp_CScript_FUN_00565d00
    PUSH ESI                            ; 00565d01
    PUSH EDI                            ; 00565d02
    PUSH EBP                            ; 00565d03
    ...
    PUSH EDI                            ; 00565d2a
    PUSH EBX                            ; 00565d2b
    CALL core_script.cpp_CScript_FUN_00566a90 ; 00565d2c
    ...
    PUSH EAX                            ; 00565de9
    PUSH EBX                            ; 00565dea
    CALL core_script.cpp_CScript_FUN_00560160 ; 00565deb
