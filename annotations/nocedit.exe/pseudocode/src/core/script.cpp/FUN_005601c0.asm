...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_script.cpp_FUN_005601c0()
;
; Local Variables:
...
section .text
    ...
    JGE 0x00560200                      ; 005601de | LAB_00560200
    ...
    INC EBX                             ; 00560229
        ;   Label: LAB_00560229
    DEC ESI                             ; 0056022a
    JMP 0x005601f0                      ; 0056022b | LAB_005601f0
        ;   XREF to: 005601f0 (UNCONDITIONAL_JUMP)
    TEST ESI,ESI                        ; 0056022d
        ;   Label: LAB_0056022d
    JG 0x00560237                       ; 0056022f | LAB_00560237
        ;   XREF to: 00560237 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP],0x0             ; 00560231
    JZ 0x0056024b                       ; 00560235 | LAB_0056024b
        ;   XREF to: 0056024b (CONDITIONAL_JUMP)
    PUSH 0x2                            ; 00560237
        ;   Label: LAB_00560237
    PUSH 0x6431f5                       ; 00560239 | = "if" | s_if_006431f5 = if
    PUSH EDI                            ; 0056023e
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 0056023f | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00560244
    TEST EAX,EAX                        ; 00560247
    JZ 0x0056027f                       ; 00560249 | LAB_0056027f
        ;   XREF to: 0056027f (CONDITIONAL_JUMP)
    TEST ESI,ESI                        ; 0056024b
        ;   Label: LAB_0056024b
    JG 0x00560256                       ; 0056024d | LAB_00560256
        ;   XREF to: 00560256 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x20],0x0      ; 0056024f
    JZ 0x0056026a                       ; 00560254 | LAB_0056026a
        ;   XREF to: 0056026a (CONDITIONAL_JUMP)
    PUSH 0x4                            ; 00560256
        ;   Label: LAB_00560256
    PUSH 0x6431f8                       ; 00560258 | = "else" | s_else_006431f8 = else
    PUSH EDI                            ; 0056025d
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 0056025e | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00560263
    TEST EAX,EAX                        ; 00560266
    JZ 0x00560293                       ; 00560268 | LAB_00560293
        ;   XREF to: 00560293 (CONDITIONAL_JUMP)
    TEST ESI,ESI                        ; 0056026a
        ;   Label: LAB_0056026a
    JNZ 0x005602a7                      ; 0056026c | LAB_005602a7
        ;   XREF to: 005602a7 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP],0x0             ; 0056026e
    JZ 0x00560205                       ; 00560272 | LAB_00560205
        ;   XREF to: 00560205 (CONDITIONAL_JUMP)
    INC EBX                             ; 00560274
    ...
    PUSH EBX                            ; 00560282
    PUSH EBP                            ; 00560283
    CALL core_script.cpp_FUN_005601c0   ; 00560284 | undefined core_script.cpp_FUN_005601c0()
        ;   XREF to: 005601c0 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 00560289
    ADD ESP,0xc                         ; 0056028b
    JMP 0x005601f0                      ; 0056028e | LAB_005601f0
        ;   XREF to: 005601f0 (UNCONDITIONAL_JUMP)
    PUSH 0x1                            ; 00560293
        ;   Label: LAB_00560293
    INC EBX                             ; 00560295
    PUSH EBX                            ; 00560296
    PUSH EBP                            ; 00560297
    CALL core_script.cpp_FUN_005601c0   ; 00560298 | undefined core_script.cpp_FUN_005601c0()
        ;   XREF to: 005601c0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0056029d
    MOV EBX,EAX                         ; 005602a0
    JMP 0x005601f0                      ; 005602a2 | LAB_005601f0
        ;   XREF to: 005601f0 (UNCONDITIONAL_JUMP)
    INC EBX                             ; 005602a7
        ;   Label: LAB_005602a7
    JMP 0x005601f0                      ; 005602a8 | LAB_005601f0
        ;   XREF to: 005601f0 (UNCONDITIONAL_JUMP)
