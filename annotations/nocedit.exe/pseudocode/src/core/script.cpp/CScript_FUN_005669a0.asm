...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_FUN_005669a0(CScript *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005669a0
        ;   Label: core_script.cpp_CScript_FUN_005669a0
    PUSH ESI                            ; 005669a1
    PUSH EDI                            ; 005669a2
    PUSH EBP                            ; 005669a3
    MOV EDX,dword ptr [ESP + 0x14]      ; 005669a4
    PUSH EDX                            ; 005669a8
    CALL core_script.cpp_CScript_FUN_00566910 ; 005669a9
