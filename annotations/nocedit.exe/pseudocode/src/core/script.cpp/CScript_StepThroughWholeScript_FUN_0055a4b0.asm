...
section .text
    ...
    PUSH EBX                            ; 0055a4bf
    MOV dword ptr [0x0310ec9c],EDX      ; 0055a4c0 | undefined4 DAT_0310ec9c
    CALL core_script.cpp_FUN_0055a540   ; 0055a4c6 | undefined core_script.cpp_FUN_0055a540()
        ;   XREF to: 0055a540 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0055a4cb
    PUSH 0x310f4b0                      ; 0055a4ce | DAT_0310f4b0
    CALL shape_edittool.cpp_CPickList_clear_FUN_004a5770 ; 0055a4d3 | void shape_edittool.cpp_CPickList_clear_FUN_004a5770(CPickList * this_ptr)
    ...
    JGE 0x0055a50c                      ; 0055a4e3 | LAB_0055a50c
    ...
    CALL core_script.cpp_CScript_step_FUN_0055a810 ; 0055a4f5 | undefined core_script.cpp_CScript_step_FUN_0055a810()
        ;   XREF to: 0055a810 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0055a4fa
    TEST EAX,EAX                        ; 0055a4fd
    JL 0x0055a51f                       ; 0055a4ff | LAB_0055a51f
    ...
    JL 0x0055a4ea                       ; 0055a50a | LAB_0055a4ea
        ;   XREF to: 0055a4ea (CONDITIONAL_JUMP)
    PUSH EDI                            ; 0055a50c
        ;   Label: LAB_0055a50c
    XOR EDI,EDI                         ; 0055a50d
    XOR EAX,EAX                         ; 0055a50f
    MOV dword ptr [0x0310ec9c],EDI      ; 0055a511 | undefined4 DAT_0310ec9c
    POP EDI                             ; 0055a517
    ...
    MOV EAX,0x310eca0                   ; 0055a52c | undefined1 DAT_0310eca0
