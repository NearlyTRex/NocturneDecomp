...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_FUN_00560b50(CScript *this_ptr,_FILE *param_2)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00560b50
        ;   Label: core_script.cpp_CScript_FUN_00560b50
    PUSH ESI                            ; 00560b51
    PUSH EDI                            ; 00560b52
    PUSH EBP                            ; 00560b53
    ...
    CALL core_script.cpp_FUN_005607e0   ; 00560cb7
        ;   XREF to: 005607e0 (UNCONDITIONAL_CALL)  ; void core_script.cpp_FUN_005607e0(_FILE * param_1, int * param_2)
