...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_FUN_00566330(CScript *this_ptr,int param_2,int param_3)
;
; Parameters:
...
;
; XREF[1]:
;   core_script.cpp_CScript_FUN_00566390 at 00566476
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00566330
        ;   Label: core_script.cpp_CScript_FUN_00566330
    PUSH ESI                            ; 00566331
    PUSH EDI                            ; 00566332
    PUSH EBP                            ; 00566333
    ...
    PUSH EBP                            ; 00566340
    PUSH ESI                            ; 00566341
    CALL core_script.cpp_CScript_FUN_00566230 ; 00566342
    ...
    MOV EDI,0x31101c0                   ; 0056634a | DAT_031101c0
    SUB ECX,ECX                         ; 0056634f
    DEC ECX                             ; 00566351
    XOR EAX,EAX                         ; 00566352
    SCASB.REPNE ES:EDI                  ; 00566354 | DAT_031101c0 | DAT_031101c1
    NOT ECX                             ; 00566356
    DEC ECX                             ; 00566358
    ...
    MOV ECX,0x31101c0                   ; 0056635f | DAT_031101c0
        ;   Label: LAB_0056635f
    ADD ECX,EBX                         ; 00566364
    PUSH ECX                            ; 00566366 | DAT_031101c0 | DAT_031101c1
    ...
    XOR AH,AH                           ; 00566378
    PUSH ESI                            ; 0056637a
    MOV byte ptr [EBX + 0x31101c0],AH   ; 0056637b | DAT_031101c0
