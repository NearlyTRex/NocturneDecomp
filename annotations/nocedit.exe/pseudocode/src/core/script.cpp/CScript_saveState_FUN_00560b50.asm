...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_saveState_FUN_00560b50(CScript *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00560b50
        ;   Label: core_script.cpp_CScript_saveState_FUN_00560b50
    PUSH ESI                            ; 00560b51
    PUSH EDI                            ; 00560b52
    PUSH EBP                            ; 00560b53
