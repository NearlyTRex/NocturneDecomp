...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_script.cpp_CScript_editorIndex2X_FUN_00566b30()
;
;
; XREF[7]:
...
section .text
    ...
    JL 0x00566b75                       ; 00566b3d | LAB_00566b75
        ;   XREF to: 00566b75 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [ESP + 0x10]      ; 00566b3f
        ;   Label: LAB_00566b3f
    ADD EBX,0x38                        ; 00566b43
    PUSH EBX                            ; 00566b46
    CALL shape_edittool.cpp_getFontBitmapCount_FUN_004a6ed0 ; 00566b47 | int shape_edittool.cpp_getFontBitmapCount_FUN_004a6ed0(CBitFont * font_ptr)
        ;   XREF to: 004a6ed0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00566b4c
    CMP EDI,EAX                         ; 00566b4f
    JGE 0x00566b9a                      ; 00566b51 | LAB_00566b9a
        ;   XREF to: 00566b9a (CONDITIONAL_JUMP)
    PUSH EDI                            ; 00566b53
    PUSH EBX                            ; 00566b54
    CALL shape_edittool.cpp_CStrList_getStringAt_FUN_004a2f70 ; 00566b55 | char * shape_edittool.cpp_CStrList_getStringAt_FUN_004a2f70(CStrList * this_ptr, int index)
    ...
    JLE 0x00566b71                      ; 00566b65 | LAB_00566b71
        ;   XREF to: 00566b71 (CONDITIONAL_JUMP)
    MOV BL,byte ptr [EDX]               ; 00566b67
        ;   Label: LAB_00566b67
    TEST BL,BL                          ; 00566b69
    JNZ 0x00566ba0                      ; 00566b6b | LAB_00566ba0
    ...
    POP EBX                             ; 00566b73
    RET                                 ; 00566b74
    MOV EDX,0x64400c                    ; 00566b75 | = "..\\core\\script.cpp" | s_core_script_cpp_0064400c = ..\core\script.cpp
        ;   Label: LAB_00566b75
    MOV ECX,0x1bde                      ; 00566b7a
    PUSH 0x64401f                       ; 00566b7f | = "CScript::editorIndex2X - invalid y" | s_CScript_editorIndex2X_in_0064401f = CScript::editorIndex2X - invalid y
    MOV dword ptr [0x02f0ca48],EDX      ; 00566b84 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 00566b8a | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00566b90 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00566b95
    JMP 0x00566b3f                      ; 00566b98 | LAB_00566b3f
    ...
    CMP BL,0x9                          ; 00566ba0
        ;   Label: LAB_00566ba0
    JNZ 0x00566bb4                      ; 00566ba3 | LAB_00566bb4
    ...
    JL 0x00566b67                       ; 00566bae | LAB_00566b67
    ...
    JL 0x00566b67                       ; 00566bb9 | LAB_00566b67
        ;   XREF to: 00566b67 (CONDITIONAL_JUMP)
    POP EDI                             ; 00566bbb
    POP ESI                             ; 00566bbc
    POP EBX                             ; 00566bbd
