...
;   core_script.cpp_CScript_rebuildEventXRefs_FUN_00567630 at 00567682
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00567080
        ;   Label: core_script.cpp_CScript_parseCommand_FUN_00567080
    PUSH ESI                            ; 00567081
    PUSH EBP                            ; 00567082
    ...
    CALL core_script.cpp_CScript_addEventXRef_FUN_00567510 ; 00567188
