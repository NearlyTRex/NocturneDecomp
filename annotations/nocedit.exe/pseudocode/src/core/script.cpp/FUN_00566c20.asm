...
;                               FUNCTION
; *****************************************************************************
; unknown undefined4 core_script_cpp_FUN_00566c20(void)
;
;
; XREF[2]:
...
section .text
    ...
    XOR EAX,EAX                         ; 00566c55
        ;   Label: LAB_00566c55
    MOV dword ptr [0x03114204],ECX      ; 00566c57 | DAT_03114204
    POP EDI                             ; 00566c5d
    POP ESI                             ; 00566c5e
    POP EBX                             ; 00566c5f
    RET                                 ; 00566c60
    ...
    MOV dword ptr [0x03114204],ECX      ; 00566caa | DAT_03114204
    POP EDI                             ; 00566cb0
    POP ESI                             ; 00566cb1
    POP EBX                             ; 00566cb2
    RET                                 ; 00566cb3
