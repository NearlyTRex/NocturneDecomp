...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_script_cpp_CScript_FUN_00566c20 (CScript *this_ptr,int param_2,int param_3,int *param_4,int *param_5)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00566c20
        ;   Label: core_script.cpp_CScript_FUN_00566c20
    PUSH ESI                            ; 00566c21
    PUSH EDI                            ; 00566c22
    MOV ECX,dword ptr [0x03114204]      ; 00566c23 | INT_03114204
    MOV ESI,dword ptr [ESP + 0x14]      ; 00566c29
    MOV EBX,dword ptr [ESP + 0x18]      ; 00566c2d
    MOV EDX,dword ptr [0x031141e0]      ; 00566c31 | INT_031141e0
    CMP ESI,EDX                         ; 00566c37
    JL 0x00566c55                       ; 00566c39
        ;   XREF to: 00566c55 (CONDITIONAL_JUMP)  ; LAB_00566c55
    MOV EDI,dword ptr [0x031141e4]      ; 00566c3b | INT_031141e4
    CMP EBX,EDI                         ; 00566c41
    JL 0x00566c55                       ; 00566c43
        ;   XREF to: 00566c55 (CONDITIONAL_JUMP)  ; LAB_00566c55
    CMP ESI,dword ptr [0x031141e8]      ; 00566c45 | DAT_031141e8
    JGE 0x00566c55                      ; 00566c4b
        ;   XREF to: 00566c55 (CONDITIONAL_JUMP)  ; LAB_00566c55
    CMP EBX,dword ptr [0x031141ec]      ; 00566c4d | DAT_031141ec
    JL 0x00566c61                       ; 00566c53
        ;   XREF to: 00566c61 (CONDITIONAL_JUMP)  ; LAB_00566c61
    XOR EAX,EAX                         ; 00566c55
        ;   Label: LAB_00566c55
    MOV dword ptr [0x03114204],ECX      ; 00566c57 | INT_03114204
    POP EDI                             ; 00566c5d
    POP ESI                             ; 00566c5e
    POP EBX                             ; 00566c5f
    RET                                 ; 00566c60
    ...
    MOV EDI,dword ptr [0x03114208]      ; 00566c8a | DAT_03114208
    ...
    MOV dword ptr [0x03114204],ECX      ; 00566caa | INT_03114204
    POP EDI                             ; 00566cb0
    POP ESI                             ; 00566cb1
    POP EBX                             ; 00566cb2
    RET                                 ; 00566cb3
