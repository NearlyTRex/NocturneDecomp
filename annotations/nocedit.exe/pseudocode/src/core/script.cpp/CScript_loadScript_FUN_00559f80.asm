...
section .text
    ...
    PUSH EBX                            ; 00559f80
        ;   Label: core_script.cpp_CScript_loadScript_FUN_00559f80
    PUSH ESI                            ; 00559f81
    PUSH EDI                            ; 00559f82
    PUSH EBP                            ; 00559f83
    ...
    PUSH EBP                            ; 00559f9b
        ;   Label: LAB_00559f9b
    CALL core_script.cpp_CScript_clear_FUN_00559870 ; 00559f9c
    ...
    PUSH EBP                            ; 0055a0c3
    CALL core_script.cpp_CScript_buildParsedLines_FUN_0055a370 ; 0055a0c4
    ...
    CALL core_script.cpp_CScript_clear_FUN_00559870 ; 0055a2db
        ;   XREF to: 00559870 (UNCONDITIONAL_CALL)  ; void core_script.cpp_CScript_clear_FUN_00559870(CScript * this_ptr)
    ...
    PUSH EBP                            ; 0055a2f0
        ;   Label: LAB_0055a2f0
    CALL core_script.cpp_CScript_clear_FUN_00559870 ; 0055a2f1
        ;   XREF to: 00559870 (UNCONDITIONAL_CALL)  ; void core_script.cpp_CScript_clear_FUN_00559870(CScript * this_ptr)
    ...
    CALL core_script.cpp_CScript_initRuntime_FUN_0055a540 ; 0055a350
