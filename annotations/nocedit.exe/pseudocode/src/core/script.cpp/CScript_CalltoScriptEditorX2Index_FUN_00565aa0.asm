...
;
; XREF[1]:
;   core_script.cpp_CScript_Unk20_FUN_00565130 at 0056590f
;
; Called Functions:
...
section .text
    ...
    JGE 0x00565aab                      ; 00565aa7 | LAB_00565aab
    ...
    PUSH EAX                            ; 00565ab2
    CALL shape_edittool.cpp_getFontBitmapCount_FUN_004a6ed0 ; 00565ab3 | int shape_edittool.cpp_getFontBitmapCount_FUN_004a6ed0(CBitFont * font_ptr)
        ;   XREF to: 004a6ed0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00565ab8
    CMP EBX,EAX                         ; 00565abb
    JGE 0x00565aa9                      ; 00565abd | LAB_00565aa9
    ...
    PUSH ECX                            ; 00565ac9
    CALL core_script.cpp_CScript_editorX2Index_FUN_00566a90 ; 00565aca | undefined core_script.cpp_CScript_editorX2Index_FUN_00566a90()
