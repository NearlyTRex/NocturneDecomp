...
;                               FUNCTION
; *****************************************************************************
; __cdecl uint __cdecl core_script_cpp_CScript_FUN_00566b30(CScript *this_ptr,int param_2,uint param_3)
;
; Parameters:
...
;   core_script.cpp_CScript_FUN_00565ae0 at 00565c3e
;   core_script.cpp_CScript_FUN_00565f70 at 00566042
;   core_script.cpp_CScript_FUN_00566390 at 005664aa
;   core_script.cpp_CScript_FUN_00566910 at 0056696f
...
section .text
    ...
    PUSH EBX                            ; 00566b30
        ;   Label: core_script.cpp_CScript_FUN_00566b30
    PUSH ESI                            ; 00566b31
    PUSH EDI                            ; 00566b32
