...
;
; XREF[2]:
;   core_script.cpp_CScript_WriteScriptFile_FUN_00560b50 at 00560d5f
...
section .text
    ...
    JLE 0x00560dcb                      ; 00560d97 | LAB_00560dcb
    ...
    JZ 0x00560dc0                       ; 00560da5 | LAB_00560dc0
    ...
    PUSH EAX                            ; 00560db0
    INC EBX                             ; 00560db1
    CALL core_actor.cpp_crc32ProcessByte_FUN_0040ce30 ; 00560db2 | void core_actor.cpp_crc32ProcessByte_FUN_0040ce30(uint * crc_state, byte input_byte)
        ;   XREF to: 0040ce30 (UNCONDITIONAL_CALL)
    MOV DL,byte ptr [EBX]               ; 00560db7
    ADD ESP,0x8                         ; 00560db9
    TEST DL,DL                          ; 00560dbc
    JNZ 0x00560da7                      ; 00560dbe | LAB_00560da7
    ...
    JL 0x00560d9b                       ; 00560dc9 | LAB_00560d9b
