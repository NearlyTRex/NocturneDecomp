...
section .text
    ...
    JLE 0x00562697                      ; 0056265c | LAB_00562697
    ...
    JLE 0x005626a9                      ; 00562674 | LAB_005626a9
    ...
    JL 0x00562682                       ; 005626ba | LAB_00562682
