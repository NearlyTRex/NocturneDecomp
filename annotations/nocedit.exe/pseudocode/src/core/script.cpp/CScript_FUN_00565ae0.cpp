...

{
  ...
  if (-1 < param_3) {
    ...
    if (param_3 < iVar2) {
      iVar2 = core_script_cpp_CScript_editorX2Index_FUN_00566a90(this_ptr,param_3,param_2);
      parse_out = &CStack_2a38;
      parm_out = &local_910;
      pcVar5 = local_5e8;
      pcVar6 = local_3f4;
      pcVar7 = local_200;
      input_text = shape_edittool_cpp_CStrList_getStringAt_FUN_004a2f70
                             (&this_ptr->script_text,param_3);
        ...
        if (iVar2 != 0) {
          ...
          g_CurrentEditingColumn =
               core_script_cpp_CScript_editorIndex2X_FUN_00566b30
                         (this_ptr,param_3,~uVar4 + (~uVar3 - 2));
