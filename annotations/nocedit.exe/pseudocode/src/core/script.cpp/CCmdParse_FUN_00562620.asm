...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_script_cpp_CCmdParse_FUN_00562620(CCmdParse *this_ptr,int param_2)
;
; Parameters:
...
;
; XREF[1]:
;   core_script.cpp_CCmdParse_bestParse_FUN_00561db0 at 00561ee6
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 00562620
        ;   Label: core_script.cpp_CCmdParse_FUN_00562620
    PUSH ESI                            ; 00562621
    PUSH EDI                            ; 00562622
    PUSH EBP                            ; 00562623
