...
;                               FUNCTION
; *****************************************************************************
; __cdecl int * __cdecl core_script_cpp_CScript_validateSyntax_FUN_0055a4b0(CScript *this_ptr,int *error_line_out)
;
; Parameters:
...
;   core_script.cpp_CScript_loadScript_FUN_00559f80 at 0055a146
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0055a4b0
        ;   Label: core_script.cpp_CScript_validateSyntax_FUN_0055a4b0
    PUSH ESI                            ; 0055a4b1
    PUSH EBP                            ; 0055a4b2
    ...
    PUSH EBX                            ; 0055a4bf
    MOV dword ptr [0x0310ec9c],EDX      ; 0055a4c0 | g_ScriptEventsEnabled
    CALL core_script.cpp_CScript_initRuntime_FUN_0055a540 ; 0055a4c6
    ...
    PUSH 0x310f4b0                      ; 0055a4ce | g_ScriptPickList
    ...
    MOV dword ptr [0x0310ec9c],EDI      ; 0055a511 | g_ScriptEventsEnabled
    POP EDI                             ; 0055a517
    ...
    MOV EAX,0x310eca0                   ; 0055a52c | g_ScriptErrorBuffer
