...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_script.cpp_FUN_00561cb0()
;
; Local Variables:
...
section .text
    ...
    JLE 0x00561d09                      ; 00561cd7 | LAB_00561d09
    ...
    MOV CL,BL                           ; 00561ce6
    TEST byte ptr [ECX + 0x6849c4],0x2  ; 00561ce8 | char[256] g_CharacterClassificationTable
    JZ 0x00561d09                       ; 00561cef | LAB_00561d09
        ;   XREF to: 00561d09 (CONDITIONAL_JUMP)
    ...
    JL 0x00561cdd                       ; 00561d07 | LAB_00561cdd
    ...
    TEST EAX,EAX                        ; 00561d38
        ;   Label: LAB_00561d38
    JLE 0x00561d8f                      ; 00561d3a | LAB_00561d8f
        ;   XREF to: 00561d8f (CONDITIONAL_JUMP)
    MOV BL,byte ptr [ECX + 0x63]        ; 00561d3c
    INC BL                              ; 00561d3f
    MOVZX ESI,BL                        ; 00561d41
    TEST byte ptr [ESI + 0x6849c4],0x2  ; 00561d44 | char[256] g_CharacterClassificationTable
    JZ 0x00561d8f                       ; 00561d4b | LAB_00561d8f
        ;   XREF to: 00561d8f (CONDITIONAL_JUMP)
    ...
    JL 0x00561d1b                       ; 00561d8b | LAB_00561d1b
        ;   XREF to: 00561d1b (CONDITIONAL_JUMP)
    JMP 0x00561d30                      ; 00561d8d | LAB_00561d30
