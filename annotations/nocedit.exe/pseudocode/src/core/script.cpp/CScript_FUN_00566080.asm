...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_FUN_00566080(CScript *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00566080
        ;   Label: core_script.cpp_CScript_FUN_00566080
    PUSH ESI                            ; 00566081
    PUSH EDI                            ; 00566082
    SUB ESP,0x4                         ; 00566083
    MOV EBX,dword ptr [ESP + 0x14]      ; 00566086
    PUSH EBX                            ; 0056608a
    CALL core_script.cpp_CScript_FUN_0055a370 ; 0056608b
    ...
    PUSH EAX                            ; 00566095
    PUSH EBX                            ; 00566096
    CALL core_script.cpp_CScript_FUN_0055a4b0 ; 00566097
