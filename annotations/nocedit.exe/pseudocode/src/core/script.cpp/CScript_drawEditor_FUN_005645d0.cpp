// Name: core_script.cpp_CScript_drawEditor_FUN_005645d0
// Address: 005645d0
// Address Range: [[005645d0, 005647cd]]
// Convention: __cdecl
// Signature: void __cdecl core_script_cpp_CScript_drawEditor_FUN_005645d0(CScript *this_ptr)
...

{
  ...
  for (iVar1 = g_ScriptEditorVScrollBar.scroll_position;
      ...
      iVar1 = iVar1 + 1) {
    core_script_cpp_CScript_drawLine_FUN_005664d0(this_ptr,iVar1);
  }
  if ((g_CursorBlinkTimer.bytes[1] & 0x40) == 0) {
