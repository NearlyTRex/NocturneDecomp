...
;                               FUNCTION
; *****************************************************************************
; unknown void core_script_cpp_FUN_00567080(void)
;
; Local Variables:
...
section .text
    ...
    PUSH EAX                            ; 005670a5
    CALL core_script.cpp_SCmdParse_parse_FUN_00561fd0 ; 005670a6
    ...
    CALL core_script.cpp_FUN_00564090   ; 005670d9
        ;   XREF to: 00564090 (UNCONDITIONAL_CALL)  ; undefined core_script.cpp_FUN_00564090() | = ":<label>"
    ...
    CALL core_script.cpp_CScript_ReallocSomething_FUN_00567510 ; 00567188
