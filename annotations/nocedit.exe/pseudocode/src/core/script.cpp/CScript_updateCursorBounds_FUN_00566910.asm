...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_updateCursorBounds_FUN_00566910(CScript *this_ptr)
;
; Parameters:
...
;   core_script.cpp_CScript_FUN_00565ae0 at 00565c51
;   core_script.cpp_CScript_FUN_00565d00 at 00565e11
...
section .text
    ...
    PUSH EBX                            ; 00566910
        ;   Label: core_script.cpp_CScript_updateCursorBounds_FUN_00566910
    PUSH EBP                            ; 00566911
    MOV EBX,dword ptr [ESP + 0xc]       ; 00566912
    LEA EAX,[EBX + 0x38]                ; 00566916
    PUSH EAX                            ; 00566919
    CALL shape_edittool.cpp_CStrList_getItemCount_FUN_004a6ed0 ; 0056691a
    ...
    MOV [0x0310fcdc],EAX                ; 00566922 | g_ScriptEditorVScrollBar.current_value
    MOV EAX,[0x0310fd48]                ; 00566927 | g_CurrentEditingLine
    MOV EDX,dword ptr [0x0310fcdc]      ; 0056692c | g_ScriptEditorVScrollBar.current_value
    ADD ESP,0x4                         ; 00566932
    CMP EAX,EDX                         ; 00566935
    JGE 0x0056697f                      ; 00566937
        ;   XREF to: 0056697f (CONDITIONAL_JUMP)  ; LAB_0056697f
    CMP dword ptr [0x0310fd48],0x0      ; 00566939 | g_CurrentEditingLine
        ;   Label: LAB_00566939
    JL 0x00566989                       ; 00566940
        ;   XREF to: 00566989 (CONDITIONAL_JUMP)  ; LAB_00566989
    CMP dword ptr [0x0310fd44],0x0      ; 00566942 | g_CurrentEditingColumn
        ;   Label: LAB_00566942
    JL 0x00566995                       ; 00566949
        ;   XREF to: 00566995 (CONDITIONAL_JUMP)  ; LAB_00566995
    MOV EAX,[0x0310fd44]                ; 0056694b | g_CurrentEditingColumn
        ;   Label: LAB_0056694b
    PUSH EAX                            ; 00566950
    MOV EDX,dword ptr [0x0310fd48]      ; 00566951 | g_CurrentEditingLine
    PUSH EDX                            ; 00566957
    PUSH EBX                            ; 00566958
    ...
    PUSH EAX                            ; 00566961
    MOV ECX,dword ptr [0x0310fd48]      ; 00566962 | g_CurrentEditingLine
    PUSH ECX                            ; 00566968
    PUSH EBX                            ; 00566969
    MOV [0x0310fd44],EAX                ; 0056696a | g_CurrentEditingColumn
    ...
    MOV [0x0310fd44],EAX                ; 00566977 | g_CurrentEditingColumn
    POP EBP                             ; 0056697c
    POP EBX                             ; 0056697d
    RET                                 ; 0056697e
    LEA EAX,[EDX + -0x1]                ; 0056697f
        ;   Label: LAB_0056697f
    MOV [0x0310fd48],EAX                ; 00566982 | g_CurrentEditingLine
    JMP 0x00566939                      ; 00566987
        ;   XREF to: 00566939 (UNCONDITIONAL_JUMP)  ; LAB_00566939
    PUSH ESI                            ; 00566989
        ;   Label: LAB_00566989
    XOR ESI,ESI                         ; 0056698a
    MOV dword ptr [0x0310fd48],ESI      ; 0056698c | g_CurrentEditingLine
    POP ESI                             ; 00566992
    JMP 0x00566942                      ; 00566993
        ;   XREF to: 00566942 (UNCONDITIONAL_JUMP)  ; LAB_00566942
    XOR EBP,EBP                         ; 00566995
        ;   Label: LAB_00566995
    MOV dword ptr [0x0310fd44],EBP      ; 00566997 | g_CurrentEditingColumn
