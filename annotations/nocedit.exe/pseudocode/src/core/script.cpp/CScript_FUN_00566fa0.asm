...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_FUN_00566fa0(CScript *this_ptr,CStrList *param_2)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00566fa0
        ;   Label: core_script.cpp_CScript_FUN_00566fa0
    PUSH ESI                            ; 00566fa1
    PUSH EDI                            ; 00566fa2
    PUSH EBP                            ; 00566fa3
    ...
    PUSH EDI                            ; 00566fb8
    CALL core_script.cpp_CScript_FUN_0055a370 ; 00566fb9
