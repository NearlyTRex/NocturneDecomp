...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_script.cpp_FUN_00559730()
;
; Local Variables:
...
;   core_script.cpp_FUN_00562920 at 00563d8c
;
; Referenced Globals:
...
section .text
    ...
    JNZ 0x00559746                      ; 00559751 | LAB_00559746
        ;   XREF to: 00559746 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x78]      ; 00559753
    ADD EAX,0x158                       ; 00559757
    PUSH EAX                            ; 0055975c
    CALL core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0 ; 0055975d | CDeformableModel * core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0(CDeformableModelInstance * this_ptr)
    ...
    PUSH EAX                            ; 00559770
    PUSH 0x641698                       ; 00559771 | = " %[^ \t),]%n" | s_n_00641698 =  %[^ 	),]%n
    MOV EDX,0xffffffff                  ; 00559776
    PUSH EBX                            ; 0055977b
    MOV dword ptr [ESP + 0x74],EDX      ; 0055977c
    CALL crt_stdio.c_sscanf_FUN_0060013c ; 00559780 | int crt_stdio.c_sscanf_FUN_0060013c(char * str, char * format)
        ;   XREF to: 0060013c (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00559785
    MOV ECX,dword ptr [ESP + 0x64]      ; 00559788
    CMP ECX,0x1                         ; 0055978c
    JGE 0x0055979d                      ; 0055978f | LAB_0055979d
    ...
    CALL core_skeleton.cpp_CDeformableModel_findPartByName_FUN_0059c240 ; 005597a7 | int core_skeleton.cpp_CDeformableModel_findPartByName_FUN_0059c240(CDeformableModel * this_ptr, char * part_name, int error_if_not_found)
        ;   XREF to: 0059c240 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005597ac
    TEST EAX,EAX                        ; 005597af
    JL 0x005597bc                       ; 005597b1 | LAB_005597bc
        ;   XREF to: 005597bc (CONDITIONAL_JUMP)
    MOV dword ptr [EDI + EAX*0x4],0x1   ; 005597b3
    JMP 0x00559767                      ; 005597ba | LAB_00559767
        ;   XREF to: 00559767 (UNCONDITIONAL_JUMP)
    MOV EAX,ESP                         ; 005597bc
        ;   Label: LAB_005597bc
    PUSH EAX                            ; 005597be
    PUSH ESI                            ; 005597bf
    CALL core_script.cpp_FUN_00567d30   ; 005597c0 | undefined core_script.cpp_FUN_00567d30()
        ;   XREF to: 00567d30 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005597c5
    PUSH EAX                            ; 005597c8
    MOV EAX,dword ptr [ESP + 0x80]      ; 005597c9
    PUSH EAX                            ; 005597d0
    PUSH 0x6416a4                       ; 005597d1 | = "Character %s model %s does not have a..." | s_Character_s_model_s_does_006416a4 = Character %s model %s does not have a part '%s'
    PUSH 0x310eca0                      ; 005597d6 | undefined1 DAT_0310eca0
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005597db | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
