...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_script.cpp_FUN_00564090()
;
; Local Variables:
...
;
; XREF[2]:
;   core_script.cpp_CScript_ParseCounterUsed_FUN_00567490 at 005674f2
;   core_script.cpp_FUN_00567080 at 005670d9
;
; Referenced Globals:
...
section .text
    ...
    JL 0x005640c3                       ; 005640eb | LAB_005640c3
    ...
    CMP AL,0x0                          ; 00564102
    JZ 0x00564116                       ; 00564104 | LAB_00564116
    ...
    CMP AL,0x0                          ; 00564112
    JNZ 0x005640fe                      ; 00564114 | LAB_005640fe
        ;   XREF to: 005640fe (CONDITIONAL_JUMP)
    POP EDI                             ; 00564116
        ;   Label: LAB_00564116
    CMP byte ptr [EBX + 0x64],0x40      ; 00564117
    JNZ 0x0056413b                      ; 0056411b | LAB_0056413b
        ;   XREF to: 0056413b (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x100],0xb     ; 0056411d
    MOV ESI,ESP                         ; 00564128
        ;   Label: LAB_00564128
    PUSH ESI                            ; 0056412a
    MOV EAX,[0x00680d50]                ; 0056412b | CScript g_CScriptInstance | CScript * g_CScriptPtr
    PUSH EAX                            ; 00564130 | CScript g_CScriptInstance
    CALL core_script.cpp_CScript_ReallocSomething_FUN_00567510 ; 00564131 | undefined core_script.cpp_CScript_ReallocSomething_FUN_00567510()
        ;   XREF to: 00567510 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00564136
    JMP 0x005640d5                      ; 00564139 | caseD_e
        ;   XREF to: 005640d5 (UNCONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x100],0x7     ; 0056413b
        ;   Label: LAB_0056413b
    JMP 0x00564128                      ; 00564146 | LAB_00564128
    ...
    PUSH ESI                            ; 0056414e
    MOV ECX,dword ptr [0x00680d50]      ; 0056414f | CScript g_CScriptInstance | CScript * g_CScriptPtr
    PUSH ECX                            ; 00564155 | CScript g_CScriptInstance
    CALL core_script.cpp_FUN_005671a0   ; 00564156 | undefined core_script.cpp_FUN_005671a0()
        ;   XREF to: 005671a0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0056415b
    JMP 0x005640d5                      ; 0056415e | caseD_e
        ;   XREF to: 005640d5 (UNCONDITIONAL_JUMP)
    ...
    CMP AL,0x0                          ; 0056416d
    JZ 0x00564181                       ; 0056416f | LAB_00564181
    ...
    CMP AL,0x0                          ; 0056417d
    JNZ 0x00564169                      ; 0056417f | LAB_00564169
        ;   XREF to: 00564169 (CONDITIONAL_JUMP)
    POP EDI                             ; 00564181
        ;   Label: LAB_00564181
    MOV ESI,ESP                         ; 00564182
    PUSH ESI                            ; 00564184
    MOV EDX,dword ptr [0x00680d50]      ; 00564185 | CScript g_CScriptInstance | CScript * g_CScriptPtr
    MOV EAX,0xa                         ; 0056418b
    PUSH EDX                            ; 00564190 | CScript g_CScriptInstance
    MOV dword ptr [ESP + 0x108],EAX     ; 00564191
    CALL core_script.cpp_CScript_ReallocSomething_FUN_00567510 ; 00564198 | undefined core_script.cpp_CScript_ReallocSomething_FUN_00567510()
        ;   XREF to: 00567510 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0056419d
    JMP 0x005640d5                      ; 005641a0 | caseD_e
        ;   XREF to: 005640d5 (UNCONDITIONAL_JUMP)
    ...
    PUSH ESI                            ; 005641ab
    MOV EDX,dword ptr [0x00680d50]      ; 005641ac | CScript g_CScriptInstance | CScript * g_CScriptPtr
    PUSH EDX                            ; 005641b2 | CScript g_CScriptInstance
    CALL core_script.cpp_FUN_00567010   ; 005641b3 | undefined core_script.cpp_FUN_00567010()
        ;   XREF to: 00567010 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005641b8
    JMP 0x005640d5                      ; 005641bb | caseD_e
        ;   XREF to: 005640d5 (UNCONDITIONAL_JUMP)
    ...
    CMP AL,0x0                          ; 005641ca
    JZ 0x005641de                       ; 005641cc | LAB_005641de
    ...
    CMP AL,0x0                          ; 005641da
    JNZ 0x005641c6                      ; 005641dc | LAB_005641c6
        ;   XREF to: 005641c6 (CONDITIONAL_JUMP)
    POP EDI                             ; 005641de
        ;   Label: LAB_005641de
    MOV ESI,ESP                         ; 005641df
    PUSH ESI                            ; 005641e1
    MOV EAX,[0x00680d50]                ; 005641e2 | CScript g_CScriptInstance | CScript * g_CScriptPtr
    MOV EDI,0x2                         ; 005641e7
    PUSH EAX                            ; 005641ec | CScript g_CScriptInstance
    MOV dword ptr [ESP + 0x108],EDI     ; 005641ed
    CALL core_script.cpp_CScript_ReallocSomething_FUN_00567510 ; 005641f4 | undefined core_script.cpp_CScript_ReallocSomething_FUN_00567510()
        ;   XREF to: 00567510 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005641f9
    JMP 0x005640d5                      ; 005641fc | caseD_e
        ;   XREF to: 005640d5 (UNCONDITIONAL_JUMP)
    ...
    CMP AL,0x0                          ; 0056420b
    JZ 0x0056421f                       ; 0056420d | LAB_0056421f
    ...
    CMP AL,0x0                          ; 0056421b
    JNZ 0x00564207                      ; 0056421d | LAB_00564207
        ;   XREF to: 00564207 (CONDITIONAL_JUMP)
    POP EDI                             ; 0056421f
        ;   Label: LAB_0056421f
    MOV ESI,ESP                         ; 00564220
    PUSH ESI                            ; 00564222
    MOV ESI,dword ptr [0x00680d50]      ; 00564223 | CScript * g_CScriptPtr
    MOV ECX,0x3                         ; 00564229
    PUSH ESI                            ; 0056422e | CScript g_CScriptInstance
    MOV dword ptr [ESP + 0x108],ECX     ; 0056422f
    CALL core_script.cpp_CScript_ReallocSomething_FUN_00567510 ; 00564236 | undefined core_script.cpp_CScript_ReallocSomething_FUN_00567510()
        ;   XREF to: 00567510 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0056423b
    JMP 0x005640d5                      ; 0056423e | caseD_e
        ;   XREF to: 005640d5 (UNCONDITIONAL_JUMP)
    ...
    CMP AL,0x0                          ; 0056424d
    JZ 0x00564261                       ; 0056424f | LAB_00564261
    ...
    CMP AL,0x0                          ; 0056425d
    JNZ 0x00564249                      ; 0056425f | LAB_00564249
        ;   XREF to: 00564249 (CONDITIONAL_JUMP)
    POP EDI                             ; 00564261
        ;   Label: LAB_00564261
    MOV ESI,ESP                         ; 00564262
    PUSH ESI                            ; 00564264
    MOV EDX,dword ptr [0x00680d50]      ; 00564265 | CScript g_CScriptInstance | CScript * g_CScriptPtr
    MOV EAX,0x4                         ; 0056426b
    PUSH EDX                            ; 00564270 | CScript g_CScriptInstance
    MOV dword ptr [ESP + 0x108],EAX     ; 00564271
    CALL core_script.cpp_CScript_ReallocSomething_FUN_00567510 ; 00564278 | undefined core_script.cpp_CScript_ReallocSomething_FUN_00567510()
        ;   XREF to: 00567510 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0056427d
    JMP 0x005640d5                      ; 00564280 | caseD_e
        ;   XREF to: 005640d5 (UNCONDITIONAL_JUMP)
    ...
    CMP AL,0x0                          ; 0056428f
    JZ 0x005642a3                       ; 00564291 | LAB_005642a3
    ...
    CMP AL,0x0                          ; 0056429f
    JNZ 0x0056428b                      ; 005642a1 | LAB_0056428b
        ;   XREF to: 0056428b (CONDITIONAL_JUMP)
    POP EDI                             ; 005642a3
        ;   Label: LAB_005642a3
    MOV ESI,ESP                         ; 005642a4
    PUSH ESI                            ; 005642a6
    MOV EAX,[0x00680d50]                ; 005642a7 | CScript g_CScriptInstance | CScript * g_CScriptPtr
    MOV EDI,0x5                         ; 005642ac
    PUSH EAX                            ; 005642b1 | CScript g_CScriptInstance
    MOV dword ptr [ESP + 0x108],EDI     ; 005642b2
    CALL core_script.cpp_CScript_ReallocSomething_FUN_00567510 ; 005642b9 | undefined core_script.cpp_CScript_ReallocSomething_FUN_00567510()
        ;   XREF to: 00567510 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005642be
    JMP 0x005640d5                      ; 005642c1 | caseD_e
        ;   XREF to: 005640d5 (UNCONDITIONAL_JUMP)
    ...
    CMP AL,0x0                          ; 005642d0
    JZ 0x005642e4                       ; 005642d2 | LAB_005642e4
    ...
    CMP AL,0x0                          ; 005642e0
    JNZ 0x005642cc                      ; 005642e2 | LAB_005642cc
        ;   XREF to: 005642cc (CONDITIONAL_JUMP)
    POP EDI                             ; 005642e4
        ;   Label: LAB_005642e4
    MOV ESI,ESP                         ; 005642e5
    PUSH ESI                            ; 005642e7
    MOV ESI,dword ptr [0x00680d50]      ; 005642e8 | CScript * g_CScriptPtr
    MOV ECX,0x6                         ; 005642ee
    PUSH ESI                            ; 005642f3 | CScript g_CScriptInstance
    MOV dword ptr [ESP + 0x108],ECX     ; 005642f4
    CALL core_script.cpp_CScript_ReallocSomething_FUN_00567510 ; 005642fb | undefined core_script.cpp_CScript_ReallocSomething_FUN_00567510()
        ;   XREF to: 00567510 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00564300
    JMP 0x005640d5                      ; 00564303 | caseD_e
        ;   XREF to: 005640d5 (UNCONDITIONAL_JUMP)
    ...
    CMP AL,0x0                          ; 00564312
    JZ 0x00564326                       ; 00564314 | LAB_00564326
    ...
    CMP AL,0x0                          ; 00564322
    JNZ 0x0056430e                      ; 00564324 | LAB_0056430e
    ...
    PUSH ESI                            ; 00564334
    MOV EDI,dword ptr [0x00680d50]      ; 00564335 | CScript * g_CScriptPtr
    PUSH EDI                            ; 0056433b | CScript g_CScriptInstance
    CALL core_script.cpp_CScript_ReallocSomething_FUN_00567510 ; 0056433c | undefined core_script.cpp_CScript_ReallocSomething_FUN_00567510()
        ;   XREF to: 00567510 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00564341
    JMP 0x005640d5                      ; 00564344 | caseD_e
        ;   XREF to: 005640d5 (UNCONDITIONAL_JUMP)
    ...
    CMP AL,0x0                          ; 00564353
    JZ 0x00564367                       ; 00564355 | LAB_00564367
    ...
    CMP AL,0x0                          ; 00564363
    JNZ 0x0056434f                      ; 00564365 | LAB_0056434f
        ;   XREF to: 0056434f (CONDITIONAL_JUMP)
    POP EDI                             ; 00564367
        ;   Label: LAB_00564367
    MOV ESI,ESP                         ; 00564368
    PUSH ESI                            ; 0056436a
    MOV ECX,dword ptr [0x00680d50]      ; 0056436b | CScript g_CScriptInstance | CScript * g_CScriptPtr
    MOV EDX,0x9                         ; 00564371
    PUSH ECX                            ; 00564376 | CScript g_CScriptInstance
    MOV dword ptr [ESP + 0x108],EDX     ; 00564377
    CALL core_script.cpp_CScript_ReallocSomething_FUN_00567510 ; 0056437e | undefined core_script.cpp_CScript_ReallocSomething_FUN_00567510()
        ;   XREF to: 00567510 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00564383
    JMP 0x005640d5                      ; 00564386 | caseD_e
        ;   XREF to: 005640d5 (UNCONDITIONAL_JUMP)
    ...
    CMP AL,0x0                          ; 00564395
    JZ 0x005643a9                       ; 00564397 | LAB_005643a9
    ...
    CMP AL,0x0                          ; 005643a5
    JNZ 0x00564391                      ; 005643a7 | LAB_00564391
    ...
    PUSH ESI                            ; 005643b7
    MOV EDI,dword ptr [0x00680d50]      ; 005643b8 | CScript * g_CScriptPtr
    PUSH EDI                            ; 005643be | CScript g_CScriptInstance
    CALL core_script.cpp_CScript_ReallocSomething_FUN_00567510 ; 005643bf | undefined core_script.cpp_CScript_ReallocSomething_FUN_00567510()
        ;   XREF to: 00567510 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005643c4
    JMP 0x005640d5                      ; 005643c7 | caseD_e
        ;   XREF to: 005640d5 (UNCONDITIONAL_JUMP)
