...
;                               FUNCTION
; *****************************************************************************
; unknown void core_script_cpp_FUN_005671a0(void)
;
; Local Variables:
...
section .text
    ...
    CALL core_script.cpp_FUN_00567310   ; 005671df
    ...
    PUSH EDI                            ; 00567257
    PUSH EBP                            ; 00567258
    CALL core_script.cpp_CScript_ParseCounterUsed_FUN_00567490 ; 00567259
        ;   XREF to: 00567490 (UNCONDITIONAL_CALL)  ; undefined core_script.cpp_CScript_ParseCounterUsed_FUN_00567490()
    ...
    CALL core_script.cpp_CScript_ReallocSomething_FUN_00567510 ; 005672fe
