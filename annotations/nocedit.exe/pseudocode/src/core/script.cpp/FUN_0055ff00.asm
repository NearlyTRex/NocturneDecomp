...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_script.cpp_FUN_0055ff00()
;
; Local Variables:
...
section .text
    ...
    MOV EAX,ESP                         ; 0055ff6d
        ;   Label: LAB_0055ff6d
    PUSH EAX                            ; 0055ff6f
    PUSH 0x6431a0                       ; 0055ff70 | DAT_006431a0
    MOV ECX,dword ptr [EBP + 0x1c]      ; 0055ff75
    PUSH ECX                            ; 0055ff78
    CALL crt_stdio.c_sscanf_FUN_0060013c ; 0055ff79 | int crt_stdio.c_sscanf_FUN_0060013c(char * str, char * format)
        ;   XREF to: 0060013c (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0055ff7e
    CMP EAX,0x1                         ; 0055ff81
    JZ 0x0055ff2e                       ; 0055ff84 | LAB_0055ff2e
        ;   XREF to: 0055ff2e (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [EBP + 0x1c]      ; 0055ff86
    PUSH EDI                            ; 0055ff89
    MOV EAX,[0x00681ef8]                ; 0055ff8a | CSound g_CSoundInstance | CSound * g_CSoundPtr
    PUSH EAX                            ; 0055ff8f | CSound g_CSoundInstance
    CALL core_sound.cpp_CSound_getSoundDuration_FUN_005b3ba0 ; 0055ff90 | float core_sound.cpp_CSound_getSoundDuration_FUN_005b3ba0(CSound * this_ptr, char * sound_name)
    ...
    FNSTSW AX                           ; 0055ffa7
    SAHF                                ; 0055ffa9
    JA 0x0055ffc6                       ; 0055ffaa | LAB_0055ffc6
        ;   XREF to: 0055ffc6 (CONDITIONAL_JUMP)
    CMP dword ptr [0x0310ec9c],0x0      ; 0055ffac | undefined4 DAT_0310ec9c
        ;   Label: LAB_0055ffac
    JNZ 0x0055ff2e                      ; 0055ffb3 | LAB_0055ff2e
        ;   XREF to: 0055ff2e (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x10],0x1      ; 0055ffb9
    JMP 0x0055ff2e                      ; 0055ffc1 | LAB_0055ff2e
        ;   XREF to: 0055ff2e (UNCONDITIONAL_JUMP)
    PUSH EDI                            ; 0055ffc6
        ;   Label: LAB_0055ffc6
    PUSH 0x310f4b0                      ; 0055ffc7 | DAT_0310f4b0
    CALL shape_edittool.cpp_CStrList_add_FUN_004a2b80 ; 0055ffcc | void shape_edittool.cpp_CStrList_add_FUN_004a2b80(CStrList * this_ptr, char * string_data)
    ...
    FMUL double ptr [0x006431a8]        ; 0055ffee | double DOUBLE_006431a8
    FADD double ptr [0x006431b0]        ; 0055fff4 | double DOUBLE_006431b0
    FSTP float ptr [ESP]                ; 0055fffa
    JMP 0x0055ffac                      ; 0055fffd | LAB_0055ffac
    ...
    JZ 0x0056009c                       ; 0056001a | LAB_0056009c
        ;   XREF to: 0056009c (CONDITIONAL_JUMP)
    CMP dword ptr [0x0310ec9c],0x0      ; 00560020 | undefined4 DAT_0310ec9c
        ;   Label: LAB_00560020
    JNZ 0x0056008a                      ; 00560027 | LAB_0056008a
    ...
    CMP AL,0x0                          ; 00560031
    JZ 0x00560045                       ; 00560033 | LAB_00560045
    ...
    CMP dword ptr [ESP + 0x10],0x0      ; 00560058
        ;   Label: LAB_00560058
    JZ 0x0056008a                       ; 0056005d | LAB_0056008a
        ;   XREF to: 0056008a (CONDITIONAL_JUMP)
    CALL sound_sndmain.cpp_pushSfxOptions_FUN_005a8c30 ; 0056005f | void sound_sndmain.cpp_pushSfxOptions_FUN_005a8c30()
        ;   XREF to: 005a8c30 (UNCONDITIONAL_CALL)
    PUSH 0x2                            ; 00560064
    CALL sound_sndmain.cpp_setNextSfxChannel_FUN_005a8af0 ; 00560066 | void sound_sndmain.cpp_setNextSfxChannel_FUN_005a8af0(int channel_index)
        ;   XREF to: 005a8af0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0056006b
    MOV ECX,dword ptr [EBP + 0x1c]      ; 0056006e
    PUSH ECX                            ; 00560071
    PUSH EBX                            ; 00560072
    MOV ESI,dword ptr [0x00681ef8]      ; 00560073 | CSound * g_CSoundPtr
    PUSH ESI                            ; 00560079 | CSound g_CSoundInstance
    CALL core_sound.cpp_CSound_playSound_FUN_005b3a20 ; 0056007a | void core_sound.cpp_CSound_playSound_FUN_005b3a20(CSound * this_ptr, void * user_data, char * sound_name)
        ;   XREF to: 005b3a20 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0056007f
    MOV dword ptr [EBX + 0x24],EAX      ; 00560082
    CALL sound_sndmain.cpp_popSfxOptions_FUN_005a8cb0 ; 00560085 | void sound_sndmain.cpp_popSfxOptions_FUN_005a8cb0()
    ...
    JZ 0x00560020                       ; 005600a2 | LAB_00560020
    ...
    JMP 0x00560020                      ; 005600b5 | LAB_00560020
