...
;                               FUNCTION
; *****************************************************************************
; __cdecl int * __cdecl core_script_cpp_CScript_FUN_0055a4b0(CScript *this_ptr,int *param_2)
;
; Parameters:
...
;
; XREF[2]:
;   core_script.cpp_CScript_FUN_00559f80 at 0055a146
;   core_script.cpp_CScript_FUN_00566080 at 00566097
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0055a4b0
        ;   Label: core_script.cpp_CScript_FUN_0055a4b0
    PUSH ESI                            ; 0055a4b1
    PUSH EBP                            ; 0055a4b2
    ...
    CALL core_script.cpp_CScript_FUN_0055a540 ; 0055a4c6
