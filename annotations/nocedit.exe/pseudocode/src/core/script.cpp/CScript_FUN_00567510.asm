...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_FUN_00567510(CScript *this_ptr,int *param_2)
;
; Parameters:
...
;   core_script.cpp_CScript_FUN_00567080 at 00567188
;   core_script.cpp_CScript_FUN_005671a0 at 005672fe
;   core_script.cpp_FUN_00564090 at 00564131
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00567510
        ;   Label: core_script.cpp_CScript_FUN_00567510
    PUSH ESI                            ; 00567511
    PUSH EDI                            ; 00567512
