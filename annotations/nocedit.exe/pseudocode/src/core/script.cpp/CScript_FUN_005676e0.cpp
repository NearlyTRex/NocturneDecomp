...

{
  ...
  if ((param_2 < 0) || (*(int *)(this_ptr->unk4 + 0x10) <= param_2)) {
    g_CurrentFilename = "..\\core\\script.cpp";
    g_CurrentLineNumber = 0x1d77;
    core_main_c_displayErrorAndQuit_FUN_00506f10("CDemonMission::removeEventXRef - invalid index");
  }
  iVar1 = *(int *)(this_ptr->unk4 + 0x10) + -1;
  *(int *)(this_ptr->unk4 + 0x10) = iVar1;
  memmove
            ((void *)(param_2 * 0x114 + *(int *)(this_ptr->unk4 + 0x14)),
             (void *)((param_2 + 1) * 0x114 + *(int *)(this_ptr->unk4 + 0x14)),
             (iVar1 - param_2) * 0x114);
  return;
}
