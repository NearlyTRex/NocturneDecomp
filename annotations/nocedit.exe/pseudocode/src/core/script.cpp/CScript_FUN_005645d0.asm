...
section .text
    ...
    MOV EAX,[0x031141dc]                ; 005645e6 | INT_031141dc
    MOV EDX,dword ptr [0x031141d4]      ; 005645eb | INT_031141d4
    SUB EAX,EDX                         ; 005645f1
    DEC EAX                             ; 005645f3
    MOV ECX,dword ptr [0x031141d0]      ; 005645f4 | INT_031141d0
    PUSH EAX                            ; 005645fa
    MOV EAX,[0x031141d8]                ; 005645fb | INT_031141d8
    ...
    MOV EAX,[0x031141dc]                ; 0056460e | INT_031141dc
    PUSH 0x0                            ; 00564613
    DEC EAX                             ; 00564615
    PUSH EAX                            ; 00564616
    MOV EAX,[0x031141d8]                ; 00564617 | INT_031141d8
    DEC EAX                             ; 0056461c
    PUSH EAX                            ; 0056461d
    MOV EBP,dword ptr [0x031141d4]      ; 0056461e | INT_031141d4
    PUSH EBP                            ; 00564624
    MOV EAX,[0x031141d0]                ; 00564625 | INT_031141d0
    PUSH EAX                            ; 0056462a
    ...
    MOV EAX,[0x031141d8]                ; 00564630 | INT_031141d8
    ADD ESP,0x14                        ; 00564635
    DEC EAX                             ; 00564638
    PUSH EAX                            ; 00564639
    MOV ECX,dword ptr [0x031141d4]      ; 0056463a | INT_031141d4
    PUSH ECX                            ; 00564640
    MOV EBX,dword ptr [0x031141d0]      ; 00564641 | INT_031141d0
    ...
    MOV EDI,dword ptr [0x031141e4]      ; 00564677 | INT_031141e4
    SUB EAX,EDI                         ; 0056467d
    ADD ESP,0x4                         ; 0056467f
    DEC EAX                             ; 00564682
    MOV EBP,dword ptr [0x031141e0]      ; 00564683 | INT_031141e0
    PUSH EAX                            ; 00564689
    ...
    MOV ESI,dword ptr [0x031141e0]      ; 005646f2 | INT_031141e0
    MOV EDX,dword ptr [0x031141e4]      ; 005646f8 | INT_031141e4
    ...
    MOV EAX,[0x03114204]                ; 005647b9 | INT_03114204
        ;   Label: LAB_005647b9
