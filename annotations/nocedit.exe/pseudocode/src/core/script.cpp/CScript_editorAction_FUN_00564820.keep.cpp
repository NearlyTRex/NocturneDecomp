...

{
  ...
  case ACTION_TYPE_CURSOR_LEFT:
    if (0 < g_CurrentEditingColumn) {
      ...
      if ((uVar9 <= strlen(g_CurrentLineBuffer + 1)) && (g_CurrentLineBuffer[uVar9] == '\t')) {
      ...
      if (g_CurrentEditingLine < iVar3) {
        ...
        g_CurrentEditingColumn =
             core_script_cpp_CScript_editorIndex2X_FUN_00566b30
                       (this_ptr,g_CurrentEditingLine,strlen(pcVar11));
        break;
      }
    }
    g_CurrentEditingColumn = 0;
  ...
  case ACTION_TYPE_COPY:
    ...
    if (g_SelectionStartLine <= g_SelectionEndLine) {
      do {
        ...
        uVar9 = strlen(g_CurrentLineBuffer + 1);
        if (local_2c < 0) {
          local_2c = 0;
        }
        if ((int)uVar9 < local_28) {
          local_28 = uVar9;
        }
        ...
        memcpy(local_14 + iVar12,g_CurrentLineBuffer + local_2c + 1,local_28 - local_2c);
        iVar2 = g_SelectionEndLine;
        iVar3 = iVar3 + 1;
        local_14[local_20 + -1] = '\n';
        iVar12 = local_20;
      } while (iVar3 <= iVar2);
  ...
  case ACTION_TYPE_CUT:
    ...
    for (iVar12 = strlen(g_CurrentLineBuffer + 1); iVar12 < iVar3; iVar12 = iVar12 + 1) {
  ...
  case ACTION_TYPE_BACKSPACE:
    if (g_CurrentEditingColumn < 1) {
      if (0 < g_CurrentEditingLine) {
        ...
        if (g_CurrentEditingLine <= iVar3) {
          ...
          if (g_CurrentEditingLine < iVar3) {
            ...
            uVar6 = strlen(local_1c);
            if (0x3fff < (int)(uVar6 + uVar9)) {
              uVar6 = 0x3fff - uVar9;
            }
            memcpy(g_CurrentLineBuffer + uVar9 + 1,local_1c,uVar6);
      ...
      if ((int)uVar6 < (int)uVar9) {
        memmove
                  (g_CurrentLineBuffer + iVar3,g_CurrentLineBuffer + iVar3 + 1,uVar9 - uVar6)
        ;
  ...
  case ACTION_TYPE_DELETE:
    ...
    core_script_cpp_CScript_loadLineToBuffer_FUN_00566230(this_ptr,g_CurrentEditingLine);
    iVar6 = strlen(g_CurrentLineBuffer + 1);
    iVar3 = core_script_cpp_CScript_editorX2Index_FUN_00566a90
                      (this_ptr,g_CurrentEditingLine,g_CurrentEditingColumn);
    if (iVar3 < iVar6) {
      memmove
      ...
      strcpy(g_CurrentLineBuffer + iVar6 + 1,pcVar8);
      core_script_cpp_CScript_editorPutLine_FUN_005662a0(this_ptr,g_CurrentEditingLine);
  ...
  case ACTION_TYPE_ENTER:
    ...
    if (g_AutoIndentEnabled == 0) {
      ...
      core_script_cpp_CScript_loadLineToBuffer_FUN_00566230(this_ptr,g_CurrentEditingLine);
      uVar7 = strlen(g_CurrentLineBuffer + 1);
      iVar3 = core_script_cpp_CScript_editorX2Index_FUN_00566a90
                        (this_ptr,g_CurrentEditingLine,g_CurrentEditingColumn);
      if ((int)uVar7 < iVar3) {
        iVar3 = uVar7;
