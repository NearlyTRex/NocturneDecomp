...
LAB_00560e30:
  ...
  *parse_cursor = *parse_cursor + 1;
  ...
  pcVar6 = (char *)0x0;
  iVar2 = _strnicmp(pcVar7,"kParmInt" + 5,3);
  if (iVar2 == 0) {
    ...
    iVar3 = _strnicmp(pcVar7,"kParmFloat" + 5,5);
    if (iVar3 == 0) {
      ...
      iVar3 = _strnicmp(pcVar7,"kParmText" + 5,4);
      if (iVar3 == 0) {
        ...
        iVar3 = _strnicmp(pcVar7,"kParmActorVariable" + 5,0xd);
        if (iVar3 == 0) {
          pcVar6 = this_ptr->template_name + 0xd;
          pcVar7 = "kParmActorVariable" + 5;
          this_ptr->param_type = PARM_TYPE_ACTOR_VARIABLE;
        }
        else {
          iVar3 = _strnicmp(pcVar7,"kParmActorClass" + 5,10);
          if (iVar3 == 0) {
            pcVar6 = this_ptr->template_name + 10;
            pcVar7 = "kParmActorClass" + 5;
            this_ptr->param_type = PARM_TYPE_ACTOR_CLASS;
          }
          else {
            iVar3 = _strnicmp(pcVar7,"kParmActor" + 5,5);
            if (iVar3 == 0) {
              pcVar6 = this_ptr->template_name + 5;
              pcVar7 = "kParmActor" + 5;
              ...
              iVar3 = _strnicmp(pcVar7,"kParmCondition" + 5,9);
              if (iVar3 == 0) {
                pcVar6 = this_ptr->template_name + 9;
                pcVar7 = "kParmCondition" + 5;
                this_ptr->param_type = PARM_TYPE_CONDITION;
              }
              else {
                iVar3 = _strnicmp(pcVar7,"kParmLabel" + 5,5);
                if (iVar3 == 0) {
                  pcVar6 = this_ptr->template_name + 5;
                  pcVar7 = "kParmLabel" + 5;
                  ...
                  iVar3 = _strnicmp(pcVar7,"kParmCamera" + 5,6);
                  if (iVar3 == 0) {
                    pcVar6 = this_ptr->template_name + 6;
                    pcVar7 = "kParmCamera" + 5;
                    this_ptr->param_type = PARM_TYPE_CAMERA;
                  }
                  else {
                    iVar3 = _strnicmp
                                      (pcVar7,"kParmControlButton" + 5,0xd);
                    if (iVar3 == 0) {
                      pcVar6 = this_ptr->template_name + 0xd;
                      pcVar7 = "kParmControlButton" + 5;
                      this_ptr->param_type = PARM_TYPE_CONTROL_BUTTON;
                    }
                    else {
                      iVar3 = _strnicmp
                                        (pcVar7,"kParmDamageType" + 5,10);
                      if (iVar3 == 0) {
                        pcVar6 = this_ptr->template_name + 10;
                        pcVar7 = "kParmDamageType" + 5;
                        this_ptr->param_type = PARM_TYPE_DAMAGE_TYPE;
                      }
                      else {
                        iVar3 = _strnicmp
                                          (pcVar7,"kParmDeathType" + 5,9);
                        if (iVar3 == 0) {
                          pcVar6 = this_ptr->template_name + 9;
                          pcVar7 = "kParmDeathType" + 5;
                          this_ptr->param_type = PARM_TYPE_DEATH_TYPE;
                        }
                        else {
                          iVar3 = _strnicmp
                                            (pcVar7,"kParmSfxSet" + 5,6);
                          if (iVar3 == 0) {
                            pcVar6 = this_ptr->template_name + 6;
                            pcVar7 = "kParmSfxSet" + 5;
                            this_ptr->param_type = PARM_TYPE_SFX_SET;
                          }
                          else {
                            iVar3 = _strnicmp
                                              (pcVar7,"kParmSfxUsed" + 5,7);
                            if (iVar3 == 0) {
                              pcVar6 = this_ptr->template_name + 7;
                              pcVar7 = "kParmSfxUsed" + 5;
                              ...
                              if (iVar3 == 0) {
                                ...
                                iVar3 = _strnicmp
                                                  (pcVar7,"kParmWeather" + 5,7);
                                if (iVar3 == 0) {
                                  pcVar6 = this_ptr->template_name + 7;
                                  pcVar7 = "kParmWeather" + 5;
                                  this_ptr->param_type = PARM_TYPE_WEATHER;
                                }
                                else {
                                  iVar3 = _strnicmp
                                                    (pcVar7,"kParmCounterSet" + 5,10);
                                  if (iVar3 == 0) {
                                    pcVar6 = this_ptr->template_name + 10;
                                    pcVar7 = "kParmCounterSet" + 5;
                                    this_ptr->param_type = PARM_TYPE_COUNTER_SET;
                                  }
                                  else {
                                    iVar3 = _strnicmp
                                                      (pcVar7,"kParmCounterUsed" + 5,0xb);
                                    if (iVar3 == 0) {
                                      pcVar6 = this_ptr->template_name + 0xb;
                                      pcVar7 = "kParmCounterUsed" + 5;
                                      this_ptr->param_type = PARM_TYPE_COUNTER_USED;
                                    }
                                    else {
                                      iVar3 = _strnicmp
                                                        (pcVar7,"kParmLetterBoxMode" + 5,
                                                         0xd);
                                      if (iVar3 == 0) {
                                        pcVar6 = this_ptr->template_name + 0xd;
                                        pcVar7 = "kParmLetterBoxMode" + 5;
                                        ...
                                        iVar3 = _strnicmp
                                                          (pcVar7,"kParmFilename" + 5,8);
                                        if (iVar3 == 0) {
                                          pcVar6 = this_ptr->template_name + 8;
                                          pcVar7 = "kParmFilename" + 5;
                                          this_ptr->param_type = PARM_TYPE_FILENAME;
                                        }
                                        else {
                                          iVar3 = _strnicmp
                                                            (pcVar7,"kParmSpotLight" + 5,9)
                                          ;
                                          if (iVar3 == 0) {
                                            pcVar6 = this_ptr->template_name + 9;
                                            pcVar7 = "kParmSpotLight" + 5;
                                            this_ptr->param_type = PARM_TYPE_SPOT_LIGHT;
                                          }
                                          else {
                                            iVar3 = _strnicmp
                                                              (pcVar7,"kParmEventCommand" +
                                                                      5,0xc);
                                            if (iVar3 == 0) {
                                              pcVar6 = this_ptr->template_name + 0xc;
                                              pcVar7 = "kParmEventCommand" + 5;
                                              ...
                                              if (iVar3 == 0) {
                                                ...
                                                pcVar7 = "kParmPersistentEventName" + 5;
                                                this_ptr->param_type =
