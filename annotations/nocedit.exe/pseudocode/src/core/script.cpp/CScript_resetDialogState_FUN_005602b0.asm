...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_resetDialogState_FUN_005602b0(CScript *this_ptr)
;
; Parameters:
; CScript *        Stack[0x4]:4   this_ptr
;
; XREF[2]:
;   core_game.cpp_CGame_processHotkeys_FUN_004dcee0 at 004dd6ee
...
section .text
    ...
    PUSH EBX                            ; 005602b0
        ;   Label: core_script.cpp_CScript_resetDialogState_FUN_005602b0
