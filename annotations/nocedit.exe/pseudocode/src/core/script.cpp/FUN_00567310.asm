...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_script.cpp_FUN_00567310()
;
; Local Variables:
...
section .text
    ...
    MOV DL,byte ptr [EAX + 0x6849c4]    ; 0056733b | char[256] g_CharacterClassificationTable
    LEA EBP,[EBX + 0x1]                 ; 00567341
    TEST DL,0x2                         ; 00567344
    JZ 0x0056734d                       ; 00567347 | LAB_0056734d
        ;   XREF to: 0056734d (CONDITIONAL_JUMP)
    MOV EBX,EBP                         ; 00567349
    JMP 0x0056732f                      ; 0056734b | LAB_0056732f
        ;   XREF to: 0056732f (UNCONDITIONAL_JUMP)
    MOV DH,byte ptr [ESI]               ; 0056734d
        ;   Label: LAB_0056734d
    TEST DH,DH                          ; 0056734f
    JZ 0x00567471                       ; 00567351 | LAB_00567471
        ;   XREF to: 00567471 (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 00567357
    MOV AL,DH                           ; 00567359
    PUSH EAX                            ; 0056735b
    CALL core_event.cpp_FUN_004b0f90    ; 0056735c | undefined core_event.cpp_FUN_004b0f90()
        ;   XREF to: 004b0f90 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00567361
    TEST EAX,EAX                        ; 00567364
    JZ 0x005673b1                       ; 00567366 | LAB_005673b1
    ...
    JZ 0x005673bd                       ; 00567379 | LAB_005673bd
    ...
    PUSH EAX                            ; 00567383
    CALL core_event.cpp_FUN_004b0f90    ; 00567384 | undefined core_event.cpp_FUN_004b0f90()
        ;   XREF to: 004b0f90 (UNCONDITIONAL_CALL)
    ...
    JZ 0x005673c0                       ; 0056739b | LAB_005673c0
    ...
    TEST CL,CL                          ; 005673e4
    JZ 0x00567409                       ; 005673e6 | LAB_00567409
        ;   XREF to: 00567409 (CONDITIONAL_JUMP)
    CMP byte ptr [EDX],0x28             ; 005673e8
        ;   Label: LAB_005673e8
    JNZ 0x005673ee                      ; 005673eb | LAB_005673ee
        ;   XREF to: 005673ee (CONDITIONAL_JUMP)
    INC EAX                             ; 005673ed
    CMP byte ptr [EDX],0x29             ; 005673ee
        ;   Label: LAB_005673ee
    JNZ 0x005673f4                      ; 005673f1 | LAB_005673f4
    ...
    JLE 0x00567409                      ; 00567402 | LAB_00567409
        ;   XREF to: 00567409 (CONDITIONAL_JUMP)
    CMP byte ptr [EDX],0x0              ; 00567404
    JNZ 0x005673e8                      ; 00567407 | LAB_005673e8
        ;   XREF to: 005673e8 (CONDITIONAL_JUMP)
    CMP ESI,0x1                         ; 00567409
        ;   Label: LAB_00567409
    JL 0x0056732f                       ; 0056740c | LAB_0056732f
    ...
    PUSH ECX                            ; 00567421
    CALL shape_edittool.cpp_CStrList_add_FUN_004a2b80 ; 00567422 | void shape_edittool.cpp_CStrList_add_FUN_004a2b80(CStrList * this_ptr, char * string_data)
        ;   XREF to: 004a2b80 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00567427
    MOV ESI,dword ptr [ESP + 0x1bc]     ; 0056742a
    TEST ESI,ESI                        ; 00567431
    JZ 0x0056732f                       ; 00567433 | LAB_0056732f
        ;   XREF to: 0056732f (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x194]     ; 00567439
    MOV EBP,dword ptr [ESI]             ; 00567440
    CMP EAX,EBP                         ; 00567442
    JG 0x0056732f                       ; 00567444 | LAB_0056732f
        ;   XREF to: 0056732f (CONDITIONAL_JUMP)
    CMP EBX,EBP                         ; 0056744a
    JL 0x0056732f                       ; 0056744c | LAB_0056732f
        ;   XREF to: 0056732f (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [ESP + 0x1b8]     ; 00567452
    PUSH ECX                            ; 00567459
    MOV dword ptr [ESI],EAX             ; 0056745a
    CALL shape_edittool.cpp_getFontBitmapCount_FUN_004a6ed0 ; 0056745c | int shape_edittool.cpp_getFontBitmapCount_FUN_004a6ed0(CBitFont * font_ptr)
        ;   XREF to: 004a6ed0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00567461
    DEC EAX                             ; 00567464
    MOV dword ptr [ESP + 0x190],EAX     ; 00567465
    JMP 0x0056732f                      ; 0056746c | LAB_0056732f
        ;   XREF to: 0056732f (UNCONDITIONAL_JUMP)
