...

{
  ...
  do {
    ...
    memcpy(pSVar9->data + 0x00,local_334,60);
    memcpy(pSVar9->data + 0x3c,local_2f8,60);
    memcpy(pSVar9->data + 0x78,local_2bc,30);
    memcpy(pSVar9->data + 0x96,local_29e,400);
  } while( true );
}
