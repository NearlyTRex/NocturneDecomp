...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_script.cpp_SCmdParse_parse_FUN_00561fd0()
;
; Local Variables:
...
;
; XREF[4]:
;   core_script.cpp_CScript_ParseCounterUsed_FUN_00567490 at 005674b1
;   core_script.cpp_FUN_00567080 at 005670a6
;   core_script.cpp_FUN_00567bc0 at 00567c2f
;   core_script.cpp_SCmdParse_bestParse_FUN_00561db0 at 00561ed5
;
; Referenced Globals:
...
section .text
    ...
    TEST byte ptr [EAX + 0x6849c4],0x2  ; 0056201a | char[256] g_CharacterClassificationTable
    JNZ 0x005620e8                      ; 00562021 | LAB_005620e8
    ...
    JNZ 0x0056212a                      ; 00562080 | LAB_0056212a
    ...
    JGE 0x00562207                      ; 005620b0 | LAB_00562207
        ;   XREF to: 00562207 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [EAX + EBP*0x1]     ; 005620b6
    INC AL                              ; 005620b9
    AND EAX,0xff                        ; 005620bb
    TEST byte ptr [EAX + 0x6849c4],0x2  ; 005620c0 | char[256] g_CharacterClassificationTable
    JZ 0x00562207                       ; 005620c7 | LAB_00562207
        ;   XREF to: 00562207 (CONDITIONAL_JUMP)
    ...
    JMP 0x005620a2                      ; 005620e6 | LAB_005620a2
    ...
    JMP 0x00562009                      ; 00562105 | LAB_00562009
    ...
    TEST CL,CL                          ; 0056211d
    JNZ 0x00562044                      ; 0056211f | LAB_00562044
        ;   XREF to: 00562044 (CONDITIONAL_JUMP)
    JMP 0x00562058                      ; 00562125 | LAB_00562058
        ;   XREF to: 00562058 (UNCONDITIONAL_JUMP)
    CMP AH,0x3c                         ; 0056212a
        ;   Label: LAB_0056212a
    JZ 0x00562086                       ; 0056212d | LAB_00562086
        ;   XREF to: 00562086 (CONDITIONAL_JUMP)
    MOV AL,AH                           ; 00562133
    INC AL                              ; 00562135
    AND EAX,0xff                        ; 00562137
    TEST byte ptr [EAX + 0x6849c4],0x2  ; 0056213c | char[256] g_CharacterClassificationTable
    JNZ 0x00562086                      ; 00562143 | LAB_00562086
        ;   XREF to: 00562086 (CONDITIONAL_JUMP)
    CMP byte ptr [ESI],0x0              ; 00562149
    JZ 0x00562086                       ; 0056214c | LAB_00562086
        ;   XREF to: 00562086 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x12c]     ; 00562152
    CMP EAX,dword ptr [ESP + 0x140]     ; 00562159
    JGE 0x005621bf                      ; 00562160 | LAB_005621bf
        ;   XREF to: 005621bf (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 00562162
    MOV AL,byte ptr [ESI]               ; 00562164
    PUSH EAX                            ; 00562166
    CALL crt_ctype.c_toupper_FUN_005ff9e0 ; 00562167 | int crt_ctype.c_toupper_FUN_005ff9e0(int c)
    ...
    PUSH EAX                            ; 00562180
    CALL crt_ctype.c_toupper_FUN_005ff9e0 ; 00562181 | int crt_ctype.c_toupper_FUN_005ff9e0(int c)
        ;   XREF to: 005ff9e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00562186
    CMP ESI,EAX                         ; 00562189
    JNZ 0x005621fa                      ; 0056218b | LAB_005621fa
    ...
    JMP 0x00562061                      ; 005621ba | LAB_00562061
    ...
    CMP AL,0x0                          ; 005621d5
    JZ 0x005621e9                       ; 005621d7 | LAB_005621e9
    ...
    CMP AL,0x0                          ; 005621e5
    JNZ 0x005621d1                      ; 005621e7 | LAB_005621d1
    ...
    TEST byte ptr [EAX + 0x6849c4],0x2  ; 00562220 | char[256] g_CharacterClassificationTable
    JZ 0x00562238                       ; 00562227 | LAB_00562238
        ;   XREF to: 00562238 (CONDITIONAL_JUMP)
    LEA EDX,[ECX + 0x1]                 ; 00562229
    MOV dword ptr [ESP + 0x130],EDX     ; 0056222c
    JMP 0x005620a2                      ; 00562233 | LAB_005620a2
        ;   XREF to: 005620a2 (UNCONDITIONAL_JUMP)
    CMP byte ptr [EDI],0x3c             ; 00562238
        ;   Label: LAB_00562238
    JNZ 0x00562392                      ; 0056223b | LAB_00562392
        ;   XREF to: 00562392 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0xcc],0xa      ; 00562241
    JL 0x0056226d                       ; 00562248 | LAB_0056226d
        ;   XREF to: 0056226d (CONDITIONAL_JUMP)
    MOV EDX,0x643b59                    ; 0056224a | = "..\\core\\script.cpp" | s_core_script_cpp_00643b59 = ..\core\script.cpp
    MOV ECX,0x1302                      ; 0056224f
    PUSH 0x643b6c                       ; 00562254 | = "SCmdParse::parse - too many parms!" | s_SCmdParse_parse_too_many_00643b6c = SCmdParse::parse - too many parms!
    MOV dword ptr [0x02f0ca48],EDX      ; 00562259 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 0056225f | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00562265 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    PUSH EAX                            ; 00562292
    CALL core_script.cpp_SCmdParm_setTemplateText_FUN_00560de0 ; 00562293 | undefined core_script.cpp_SCmdParm_setTemplateText_FUN_00560de0()
        ;   XREF to: 00560de0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00562298
    TEST EAX,EAX                        ; 0056229b
    JZ 0x00562325                       ; 0056229d | LAB_00562325
    ...
    CMP AL,0x0                          ; 005622c9
    JZ 0x005622dd                       ; 005622cb | LAB_005622dd
    ...
    CMP AL,0x0                          ; 005622d9
    JNZ 0x005622c5                      ; 005622db | LAB_005622c5
    ...
    CALL core_script.cpp_FUN_00561cb0   ; 0056230e | undefined core_script.cpp_FUN_00561cb0()
        ;   XREF to: 00561cb0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00562313
    TEST EAX,EAX                        ; 00562316
    JZ 0x00562335                       ; 00562318 | LAB_00562335
        ;   XREF to: 00562335 (CONDITIONAL_JUMP)
    INC dword ptr [EBX + 0xcc]          ; 0056231a
    JMP 0x005620a2                      ; 00562320 | LAB_005620a2
        ;   XREF to: 005620a2 (UNCONDITIONAL_JUMP)
    ...
    CMP AL,0x0                          ; 00562342
    JZ 0x00562356                       ; 00562344 | LAB_00562356
    ...
    CMP AL,0x0                          ; 00562352
    JNZ 0x0056233e                      ; 00562354 | LAB_0056233e
    ...
    CMP AL,0x0                          ; 0056236d
    JZ 0x00562381                       ; 0056236f | LAB_00562381
    ...
    CMP AL,0x0                          ; 0056237d
    JNZ 0x00562369                      ; 0056237f | LAB_00562369
    ...
    JGE 0x00562466                      ; 005623a0 | LAB_00562466
        ;   XREF to: 00562466 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [EAX + EBP*0x1]     ; 005623a6
    AND EAX,0xff                        ; 005623a9
    PUSH EAX                            ; 005623ae
    CALL crt_ctype.c_toupper_FUN_005ff9e0 ; 005623af | int crt_ctype.c_toupper_FUN_005ff9e0(int c)
        ;   XREF to: 005ff9e0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 005623ce
    CALL crt_ctype.c_toupper_FUN_005ff9e0 ; 005623cf | int crt_ctype.c_toupper_FUN_005ff9e0(int c)
        ;   XREF to: 005ff9e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005623d4
    CMP EDI,EAX                         ; 005623d7
    JNZ 0x00562408                      ; 005623d9 | LAB_00562408
    ...
    JMP 0x005620a2                      ; 00562403 | LAB_005620a2
        ;   XREF to: 005620a2 (UNCONDITIONAL_JUMP)
    ...
    CMP AL,0x0                          ; 00562416
    JZ 0x0056242a                       ; 00562418 | LAB_0056242a
    ...
    CMP AL,0x0                          ; 00562426
    JNZ 0x00562412                      ; 00562428 | LAB_00562412
    ...
    CMP AL,0x0                          ; 00562441
    JZ 0x00562455                       ; 00562443 | LAB_00562455
    ...
    CMP AL,0x0                          ; 00562451
    JNZ 0x0056243d                      ; 00562453 | LAB_0056243d
    ...
    CMP AL,0x0                          ; 00562479
    JZ 0x0056248d                       ; 0056247b | LAB_0056248d
    ...
    CMP AL,0x0                          ; 00562489
    JNZ 0x00562475                      ; 0056248b | LAB_00562475
    ...
    CMP AL,0x0                          ; 005624a4
    JZ 0x005624b8                       ; 005624a6 | LAB_005624b8
    ...
    CMP AL,0x0                          ; 005624b4
    JNZ 0x005624a0                      ; 005624b6 | LAB_005624a0
    ...
    JZ 0x005624dc                       ; 005624ca | LAB_005624dc
