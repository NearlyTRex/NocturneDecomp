...
;                               FUNCTION
; *****************************************************************************
; unknown undefined4 core_script_cpp_SCmdParse_parse_FUN_00561fd0(void)
;
; Local Variables:
...
section .text
    ...
    PUSH EAX                            ; 00562292
    CALL core_script.cpp_SCmdParm_setTemplateText_FUN_00560de0 ; 00562293
    ...
    CALL core_script.cpp_FUN_00561cb0   ; 0056230e
        ;   XREF to: 00561cb0 (UNCONDITIONAL_CALL)  ; undefined core_script.cpp_FUN_00561cb0()
