...
section .text
    ...
    CALL core_script.cpp_FUN_00564500   ; 005645e1
        ;   XREF to: 00564500 (UNCONDITIONAL_CALL)  ; undefined core_script.cpp_FUN_00564500()
    MOV EAX,[0x031141dc]                ; 005645e6 | DAT_031141dc
    MOV EDX,dword ptr [0x031141d4]      ; 005645eb | DAT_031141d4
    SUB EAX,EDX                         ; 005645f1
    DEC EAX                             ; 005645f3
    MOV ECX,dword ptr [0x031141d0]      ; 005645f4 | DAT_031141d0
    PUSH EAX                            ; 005645fa
    MOV EAX,[0x031141d8]                ; 005645fb | DAT_031141d8
    ...
    MOV EAX,[0x031141dc]                ; 0056460e | DAT_031141dc
    PUSH 0x0                            ; 00564613
    DEC EAX                             ; 00564615
    PUSH EAX                            ; 00564616
    MOV EAX,[0x031141d8]                ; 00564617 | DAT_031141d8
    DEC EAX                             ; 0056461c
    PUSH EAX                            ; 0056461d
    MOV EBP,dword ptr [0x031141d4]      ; 0056461e | DAT_031141d4
    PUSH EBP                            ; 00564624
    MOV EAX,[0x031141d0]                ; 00564625 | DAT_031141d0
    PUSH EAX                            ; 0056462a
    ...
    MOV EAX,[0x031141d8]                ; 00564630 | DAT_031141d8
    ADD ESP,0x14                        ; 00564635
    DEC EAX                             ; 00564638
    PUSH EAX                            ; 00564639
    MOV ECX,dword ptr [0x031141d4]      ; 0056463a | DAT_031141d4
    PUSH ECX                            ; 00564640
    MOV EBX,dword ptr [0x031141d0]      ; 00564641 | DAT_031141d0
    ...
    PUSH 0x310fd0c                      ; 0056465b | DAT_0310fd0c
    ...
    PUSH 0x310fcd8                      ; 00564668 | DAT_0310fcd8
    CALL shape_edittool.cpp_CEdScrollBar_render_FUN_004a5c10 ; 0056466d
        ;   XREF to: 004a5c10 (UNCONDITIONAL_CALL)  ; void shape_edittool.cpp_CEdScrollBar_render_FUN_004a5c10(CEdScrollBar * this_ptr)
    MOV EAX,[0x031141ec]                ; 00564672 | DAT_031141ec
    MOV EDI,dword ptr [0x031141e4]      ; 00564677 | DAT_031141e4
    SUB EAX,EDI                         ; 0056467d
    ADD ESP,0x4                         ; 0056467f
    DEC EAX                             ; 00564682
    MOV EBP,dword ptr [0x031141e0]      ; 00564683 | DAT_031141e0
    PUSH EAX                            ; 00564689
    MOV EAX,[0x031141e8]                ; 0056468a | DAT_031141e8
    ...
    CALL engine_matrix.c_pushViewport_FUN_0050e320 ; 00564695
        ;   XREF to: 0050e320 (UNCONDITIONAL_CALL)  ; void engine_matrix.c_pushViewport_FUN_0050e320(int x, int y, int width, int height)
    MOV EBX,dword ptr [0x0310fcd8]      ; 0056469a | DAT_0310fcd8
    ADD ESP,0x10                        ; 005646a0
    MOV ECX,dword ptr [0x0310fce0]      ; 005646a3 | DAT_0310fce0
        ;   Label: LAB_005646a3
    MOV EAX,[0x0310fcd8]                ; 005646a9 | DAT_0310fcd8
    ...
    MOV EBX,dword ptr [0x0310fd0c]      ; 005646c1 | DAT_0310fd0c
    MOV EAX,[0x0310fd44]                ; 005646c7 | DAT_0310fd44
    SUB EAX,EBX                         ; 005646cc
    MOV EBX,dword ptr [0x03114204]      ; 005646ce | DAT_03114204
    IMUL EBX,EAX                        ; 005646d4
    MOV EDI,dword ptr [0x0310fcd8]      ; 005646d7 | DAT_0310fcd8
    ...
    MOV ESI,dword ptr [0x031141e0]      ; 005646f2 | DAT_031141e0
    MOV EDX,dword ptr [0x031141e4]      ; 005646f8 | DAT_031141e4
    ...
    PUSH -0x1                           ; 0056474d
    PUSH 0xff                           ; 0056474f
    MOV EBP,dword ptr [0x031141f4]      ; 00564754 | DAT_031141f4
    PUSH EBP                            ; 0056475a
    MOV EAX,[0x031141f8]                ; 0056475b | DAT_031141f8
    PUSH EAX                            ; 00564760
    ...
    PUSH -0x1                           ; 00564775
    PUSH 0xff                           ; 00564777
    MOV ECX,dword ptr [0x031141f4]      ; 0056477c | DAT_031141f4
    PUSH ECX                            ; 00564782
    MOV EBX,dword ptr [0x031141f0]      ; 00564783 | DAT_031141f0
    PUSH EBX                            ; 00564789
    ...
    PUSH EBX                            ; 005647a9
        ;   Label: LAB_005647a9
    PUSH ESI                            ; 005647aa
    CALL core_script.cpp_FUN_005664d0   ; 005647ab
        ;   XREF to: 005664d0 (UNCONDITIONAL_CALL)  ; undefined core_script.cpp_FUN_005664d0()
    INC EBX                             ; 005647b0
    ADD ESP,0x8                         ; 005647b1
    JMP 0x005646a3                      ; 005647b4
        ;   XREF to: 005646a3 (UNCONDITIONAL_JUMP)  ; LAB_005646a3
    MOV EAX,[0x03114204]                ; 005647b9 | DAT_03114204
        ;   Label: LAB_005647b9
