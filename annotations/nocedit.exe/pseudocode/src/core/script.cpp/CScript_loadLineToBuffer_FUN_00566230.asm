...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_loadLineToBuffer_FUN_00566230(CScript *this_ptr,int line_number)
;
; Parameters:
...
;   core_script.cpp_CScript_processEditorInput_FUN_00565130 at 00565990
...
section .text
    ...
    PUSH EBX                            ; 00566230
        ;   Label: core_script.cpp_CScript_loadLineToBuffer_FUN_00566230
    PUSH ESI                            ; 00566231
    PUSH EDI                            ; 00566232
    ...
    PUSH EBX                            ; 00566247
    CALL shape_edittool.cpp_CStrList_getItemCount_FUN_004a6ed0 ; 00566248
    ...
    MOV EDI,0x31101c0                   ; 0056627b | g_CurrentLineBuffer
        ;   Label: LAB_0056627b
    MOV ECX,EDX                         ; 00566280
    PUSH EDI                            ; 00566282 | g_CurrentLineBuffer
