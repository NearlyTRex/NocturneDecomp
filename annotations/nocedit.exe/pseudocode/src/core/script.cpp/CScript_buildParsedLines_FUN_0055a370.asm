...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_buildParsedLines_FUN_0055a370(CScript *this_ptr)
;
; Parameters:
...
;   core_script.cpp_CScript_collectLabels_FUN_00566fa0 at 00566fb9
;   core_script.cpp_CScript_collectSoundReferences_FUN_00567bc0 at 00567bd2
;   core_script.cpp_CScript_executeContextAction_FUN_00565d00 at 00565dd1
;   core_script.cpp_CScript_loadScript_FUN_00559f80 at 0055a0c4
;   core_script.cpp_CScript_rebuildEventXRefs_FUN_00567630 at 00567649
;
; Referenced Globals:
...
;   core_script.cpp_CScript_freeParsedLines_FUN_005598f0
...
section .text
    ...
    PUSH EBX                            ; 0055a370
        ;   Label: core_script.cpp_CScript_buildParsedLines_FUN_0055a370
    PUSH ESI                            ; 0055a371
    PUSH EDI                            ; 0055a372
    PUSH EBP                            ; 0055a373
    ...
    PUSH EBX                            ; 0055a37b
    CALL core_script.cpp_CScript_freeParsedLines_FUN_005598f0 ; 0055a37c
        ;   XREF to: 005598f0 (UNCONDITIONAL_CALL)  ; void core_script.cpp_CScript_freeParsedLines_FUN_005598f0(CScript * this_ptr)
