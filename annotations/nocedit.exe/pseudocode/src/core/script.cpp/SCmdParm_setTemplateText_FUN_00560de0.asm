...
;
; XREF[2]:
;   core_script.cpp_SCmdParse_parse_FUN_00561fd0 at 00562293
...
section .text
    ...
    JNZ 0x00560e23                      ; 00560dfa | LAB_00560e23
    ...
    JZ 0x00560e54                       ; 00560e0f | LAB_00560e54
        ;   XREF to: 00560e54 (CONDITIONAL_JUMP)
    TEST BH,BH                          ; 00560e11
    JZ 0x00560e44                       ; 00560e13 | LAB_00560e44
    ...
    JMP 0x00560e07                      ; 00560e21 | LAB_00560e07
        ;   XREF to: 00560e07 (UNCONDITIONAL_JUMP)
    PUSH EDX                            ; 00560e23
        ;   Label: LAB_00560e23
    PUSH 0x643649                       ; 00560e24 | = "SCmdParm::setTemplateText - expected ..." | s_SCmdParm_setTemplateText_00643649 = SCmdParm::setTemplateText - expected opening '<' in %s
    MOV ECX,dword ptr [0x00678a60]      ; 00560e29 | CEditorTools * g_CEditorToolsPtr
    PUSH ECX                            ; 00560e2f | CEditorTools g_CEditorToolsPtr
    XOR ESI,ESI                         ; 00560e30
        ;   Label: LAB_00560e30
    CALL shape_edittool.cpp_CEditorTools_showError_FUN_0049e740 ; 00560e32 | void shape_edittool.cpp_CEditorTools_showError_FUN_0049e740(CEditorTools * this_ptr, char * format)
    ...
    PUSH EDI                            ; 00560e44
        ;   Label: LAB_00560e44
    MOV EAX,0x643680                    ; 00560e45 | = "SCmdParm::setTemplateText - expected ..." | s_SCmdParm_setTemplateText_00643680 = SCmdParm::setTemplateText - expected closing '>' in %s
    PUSH EAX                            ; 00560e4a | = "SCmdParm::setTemplateText - expected ..." | s_SCmdParm_setTemplateText_00643680 = SCmdParm::setTemplateText - expected closing '>' in %s
    MOV EBX,dword ptr [0x00678a60]      ; 00560e4b | CEditorTools * g_CEditorToolsPtr
    PUSH EBX                            ; 00560e51 | CEditorTools g_CEditorToolsPtr
    JMP 0x00560e30                      ; 00560e52 | LAB_00560e30
    ...
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 00560e6c | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00560e71
    TEST EAX,EAX                        ; 00560e74
    JNZ 0x00560f1e                      ; 00560e76 | LAB_00560f1e
    ...
    PUSH EDI                            ; 00560e93
        ;   Label: LAB_00560e93
    MOV AL,byte ptr [ESI]               ; 00560e94 | s_Int_006436c5
        ;   Label: LAB_00560e94
    MOV byte ptr [EDI],AL               ; 00560e96
    CMP AL,0x0                          ; 00560e98
    JZ 0x00560eac                       ; 00560e9a | LAB_00560eac
        ;   XREF to: 00560eac (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 00560e9c | s_nt_006436c6
    ADD ESI,0x2                         ; 00560e9f
    MOV byte ptr [EDI + 0x1],AL         ; 00560ea2
    ADD EDI,0x2                         ; 00560ea5
    CMP AL,0x0                          ; 00560ea8
    JNZ 0x00560e94                      ; 00560eaa | LAB_00560e94
    ...
    PUSH ESI                            ; 00560f25
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 00560f26 | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00560f2b
    TEST EAX,EAX                        ; 00560f2e
    JNZ 0x00560f52                      ; 00560f30 | LAB_00560f52
    ...
    JMP 0x00560e93                      ; 00560f4d | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0x4                            ; 00560f52
        ;   Label: LAB_00560f52
    PUSH 0x6436e4                       ; 00560f54 | s_Text_006436e4
    PUSH ESI                            ; 00560f59
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 00560f5a | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00560f5f
    TEST EAX,EAX                        ; 00560f62
    JNZ 0x00560f86                      ; 00560f64 | LAB_00560f86
    ...
    JMP 0x00560e93                      ; 00560f81 | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0xd                            ; 00560f86
        ;   Label: LAB_00560f86
    PUSH 0x6436f8                       ; 00560f88 | s_ActorVariable_006436f8
    PUSH ESI                            ; 00560f8d
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 00560f8e | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00560f93
    TEST EAX,EAX                        ; 00560f96
    JNZ 0x00560fba                      ; 00560f98 | LAB_00560fba
    ...
    JMP 0x00560e93                      ; 00560fb5 | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0xa                            ; 00560fba
        ;   Label: LAB_00560fba
    PUSH 0x64371e                       ; 00560fbc | s_ActorClass_0064371e
    PUSH ESI                            ; 00560fc1
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 00560fc2 | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00560fc7
    TEST EAX,EAX                        ; 00560fca
    JNZ 0x00560fee                      ; 00560fcc | LAB_00560fee
    ...
    JMP 0x00560e93                      ; 00560fe9 | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0x5                            ; 00560fee
        ;   Label: LAB_00560fee
    PUSH 0x64373e                       ; 00560ff0 | s_Actor_0064373e
    PUSH ESI                            ; 00560ff5
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 00560ff6 | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00560ffb
    TEST EAX,EAX                        ; 00560ffe
    JNZ 0x00561022                      ; 00561000 | LAB_00561022
    ...
    JMP 0x00560e93                      ; 0056101d | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0x9                            ; 00561022
        ;   Label: LAB_00561022
    PUSH 0x643754                       ; 00561024 | s_Condition_00643754
    PUSH ESI                            ; 00561029
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 0056102a | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0056102f
    TEST EAX,EAX                        ; 00561032
    JNZ 0x00561056                      ; 00561034 | LAB_00561056
    ...
    JMP 0x00560e93                      ; 00561051 | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0x5                            ; 00561056
        ;   Label: LAB_00561056
    PUSH 0x643772                       ; 00561058 | s_Label_00643772
    PUSH ESI                            ; 0056105d
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 0056105e | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00561063
    TEST EAX,EAX                        ; 00561066
    JNZ 0x0056108a                      ; 00561068 | LAB_0056108a
    ...
    JMP 0x00560e93                      ; 00561085 | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0x6                            ; 0056108a
        ;   Label: LAB_0056108a
    PUSH 0x643788                       ; 0056108c | s_Camera_00643788
    PUSH ESI                            ; 00561091
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 00561092 | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00561097
    TEST EAX,EAX                        ; 0056109a
    JNZ 0x005610be                      ; 0056109c | LAB_005610be
    ...
    JMP 0x00560e93                      ; 005610b9 | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0xd                            ; 005610be
        ;   Label: LAB_005610be
    PUSH 0x6437a0                       ; 005610c0 | s_ControlButton_006437a0
    PUSH ESI                            ; 005610c5
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 005610c6 | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005610cb
    TEST EAX,EAX                        ; 005610ce
    JNZ 0x005610f2                      ; 005610d0 | LAB_005610f2
    ...
    JMP 0x00560e93                      ; 005610ed | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0xa                            ; 005610f2
        ;   Label: LAB_005610f2
    PUSH 0x6437c6                       ; 005610f4 | s_DamageType_006437c6
    PUSH ESI                            ; 005610f9
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 005610fa | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005610ff
    TEST EAX,EAX                        ; 00561102
    JNZ 0x00561126                      ; 00561104 | LAB_00561126
    ...
    JMP 0x00560e93                      ; 00561121 | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0x9                            ; 00561126
        ;   Label: LAB_00561126
    PUSH 0x6437e6                       ; 00561128 | s_DeathType_006437e6
    PUSH ESI                            ; 0056112d
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 0056112e | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00561133
    TEST EAX,EAX                        ; 00561136
    JNZ 0x0056115a                      ; 00561138 | LAB_0056115a
    ...
    JMP 0x00560e93                      ; 00561155 | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0x6                            ; 0056115a
        ;   Label: LAB_0056115a
    PUSH 0x643804                       ; 0056115c | s_SfxSet_00643804
    PUSH ESI                            ; 00561161
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 00561162 | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00561167
    TEST EAX,EAX                        ; 0056116a
    JNZ 0x0056118e                      ; 0056116c | LAB_0056118e
    ...
    JMP 0x00560e93                      ; 00561189 | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0x7                            ; 0056118e
        ;   Label: LAB_0056118e
    PUSH 0x64381c                       ; 00561190 | s_SfxUsed_0064381c
    PUSH ESI                            ; 00561195
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 00561196 | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0056119b
    TEST EAX,EAX                        ; 0056119e
    JNZ 0x005611c2                      ; 005611a0 | LAB_005611c2
    ...
    JMP 0x00560e93                      ; 005611bd | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0x3                            ; 005611c2
        ;   Label: LAB_005611c2
    PUSH 0x643836                       ; 005611c4 | s_Wav_00643836
    PUSH ESI                            ; 005611c9
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 005611ca | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005611cf
    TEST EAX,EAX                        ; 005611d2
    JNZ 0x005611f6                      ; 005611d4 | LAB_005611f6
    ...
    JMP 0x00560e93                      ; 005611f1 | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0x7                            ; 005611f6
        ;   Label: LAB_005611f6
    PUSH 0x643848                       ; 005611f8 | s_Weather_00643848
    PUSH ESI                            ; 005611fd
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 005611fe | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00561203
    TEST EAX,EAX                        ; 00561206
    JNZ 0x0056122a                      ; 00561208 | LAB_0056122a
    ...
    JMP 0x00560e93                      ; 00561225 | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0xa                            ; 0056122a
        ;   Label: LAB_0056122a
    PUSH 0x643862                       ; 0056122c | s_CounterSet_00643862
    PUSH ESI                            ; 00561231
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 00561232 | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00561237
    TEST EAX,EAX                        ; 0056123a
    JNZ 0x0056125e                      ; 0056123c | LAB_0056125e
    ...
    JMP 0x00560e93                      ; 00561259 | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0xb                            ; 0056125e
        ;   Label: LAB_0056125e
    PUSH 0x643882                       ; 00561260 | s_CounterUsed_00643882
    PUSH ESI                            ; 00561265
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 00561266 | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0056126b
    TEST EAX,EAX                        ; 0056126e
    JNZ 0x00561292                      ; 00561270 | LAB_00561292
    ...
    JMP 0x00560e93                      ; 0056128d | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0xd                            ; 00561292
        ;   Label: LAB_00561292
    PUSH 0x6438a4                       ; 00561294 | s_LetterBoxMode_006438a4
    PUSH ESI                            ; 00561299
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 0056129a | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0056129f
    TEST EAX,EAX                        ; 005612a2
    JNZ 0x005612c6                      ; 005612a4 | LAB_005612c6
    ...
    JMP 0x00560e93                      ; 005612c1 | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0x8                            ; 005612c6
        ;   Label: LAB_005612c6
    PUSH 0x6438ca                       ; 005612c8 | s_Filename_006438ca
    PUSH ESI                            ; 005612cd
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 005612ce | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005612d3
    TEST EAX,EAX                        ; 005612d6
    JNZ 0x005612fa                      ; 005612d8 | LAB_005612fa
    ...
    JMP 0x00560e93                      ; 005612f5 | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0x9                            ; 005612fa
        ;   Label: LAB_005612fa
    PUSH 0x6438e6                       ; 005612fc | s_SpotLight_006438e6
    PUSH ESI                            ; 00561301
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 00561302 | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00561307
    TEST EAX,EAX                        ; 0056130a
    JNZ 0x0056132e                      ; 0056130c | LAB_0056132e
    ...
    JMP 0x00560e93                      ; 00561329 | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0xc                            ; 0056132e
        ;   Label: LAB_0056132e
    PUSH 0x643904                       ; 00561330 | s_EventCommand_00643904
    PUSH ESI                            ; 00561335
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 00561336 | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0056133b
    TEST EAX,EAX                        ; 0056133e
    JNZ 0x00561362                      ; 00561340 | LAB_00561362
    ...
    JMP 0x00560e93                      ; 0056135d | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0x13                           ; 00561362
        ;   Label: LAB_00561362
    PUSH 0x643928                       ; 00561364 | s_PersistentEventName_00643928
    PUSH ESI                            ; 00561369
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 0056136a | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0056136f
    TEST EAX,EAX                        ; 00561372
    JNZ 0x00561396                      ; 00561374 | LAB_00561396
    ...
    JMP 0x00560e93                      ; 00561391 | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0xc                            ; 00561396
        ;   Label: LAB_00561396
    PUSH 0x64395a                       ; 00561398 | s_GameFlagName_0064395a
    PUSH ESI                            ; 0056139d
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 0056139e | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005613a3
    TEST EAX,EAX                        ; 005613a6
    JNZ 0x005613ca                      ; 005613a8 | LAB_005613ca
    ...
    JMP 0x00560e93                      ; 005613c5 | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0xa                            ; 005613ca
        ;   Label: LAB_005613ca
    PUSH 0x64397e                       ; 005613cc | s_MotionName_0064397e
    PUSH ESI                            ; 005613d1
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 005613d2 | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005613d7
    TEST EAX,EAX                        ; 005613da
    JNZ 0x005613fe                      ; 005613dc | LAB_005613fe
    ...
    JMP 0x00560e93                      ; 005613f9 | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0xb                            ; 005613fe
        ;   Label: LAB_005613fe
    PUSH 0x64399e                       ; 00561400 | s_MotionState_0064399e
    PUSH ESI                            ; 00561405
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 00561406 | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0056140b
    TEST EAX,EAX                        ; 0056140e
    JNZ 0x00561432                      ; 00561410 | LAB_00561432
    ...
    JMP 0x00560e93                      ; 0056142d | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0x5                            ; 00561432
        ;   Label: LAB_00561432
    PUSH 0x6439c0                       ; 00561434 | s_DBTag_006439c0
    PUSH ESI                            ; 00561439
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 0056143a | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0056143f
    TEST EAX,EAX                        ; 00561442
    JNZ 0x00561466                      ; 00561444 | LAB_00561466
    ...
    JMP 0x00560e93                      ; 00561461 | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0x8                            ; 00561466
        ;   Label: LAB_00561466
    PUSH 0x6439d6                       ; 00561468 | s_HeroTask_006439d6
    PUSH ESI                            ; 0056146d
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 0056146e | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00561473
    TEST EAX,EAX                        ; 00561476
    JNZ 0x0056149a                      ; 00561478 | LAB_0056149a
    ...
    JMP 0x00560e93                      ; 00561495 | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0x5                            ; 0056149a
        ;   Label: LAB_0056149a
    PUSH 0x6439f2                       ; 0056149c | s_Timer_006439f2
    PUSH ESI                            ; 005614a1
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 005614a2 | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005614a7
    TEST EAX,EAX                        ; 005614aa
    JNZ 0x005614ce                      ; 005614ac | LAB_005614ce
    ...
    JMP 0x00560e93                      ; 005614c9 | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0x5                            ; 005614ce
        ;   Label: LAB_005614ce
    PUSH 0x643a08                       ; 005614d0 | s_RelOp_00643a08
    PUSH ESI                            ; 005614d5
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 005614d6 | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005614db
    TEST EAX,EAX                        ; 005614de
    JNZ 0x00561502                      ; 005614e0 | LAB_00561502
    ...
    JMP 0x00560e93                      ; 005614fd | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0xc                            ; 00561502
        ;   Label: LAB_00561502
    PUSH 0x643a1e                       ; 00561504 | s_BodyPartList_00643a1e
    PUSH ESI                            ; 00561509
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 0056150a | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0056150f
    TEST EAX,EAX                        ; 00561512
    JNZ 0x00561536                      ; 00561514 | LAB_00561536
    ...
    JMP 0x00560e93                      ; 00561531 | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH 0xb                            ; 00561536
        ;   Label: LAB_00561536
    ...
    PUSH EAX                            ; 00561544
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 00561545 | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0056154a
    TEST EAX,EAX                        ; 0056154d
    JNZ 0x00560ead                      ; 0056154f | LAB_00560ead
    ...
    JMP 0x00560e93                      ; 00561570 | LAB_00560e93
        ;   XREF to: 00560e93 (UNCONDITIONAL_JUMP)
    PUSH ESI                            ; 00561575
        ;   Label: LAB_00561575
    PUSH 0x643a5f                       ; 00561576 | = "SCmdParm::setTemplateText - %s unknow..." | s_SCmdParm_setTemplateText_00643a5f = SCmdParm::setTemplateText - %s unknown template type!
    MOV EDI,dword ptr [0x00678a60]      ; 0056157b | CEditorTools * g_CEditorToolsPtr
    PUSH EDI                            ; 00561581 | CEditorTools g_CEditorToolsPtr
    XOR ESI,ESI                         ; 00561582
    CALL shape_edittool.cpp_CEditorTools_showError_FUN_0049e740 ; 00561584 | void shape_edittool.cpp_CEditorTools_showError_FUN_0049e740(CEditorTools * this_ptr, char * format)
        ;   XREF to: 0049e740 (UNCONDITIONAL_CALL)
    ...
    CMP AH,0x27                         ; 00561596
        ;   Label: LAB_00561596
    JNZ 0x005615e4                      ; 00561599 | LAB_005615e4
        ;   XREF to: 005615e4 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [ESP]             ; 0056159b
    MOV CH,byte ptr [EDX]               ; 0056159e
    MOV EBX,EDX                         ; 005615a0
    CMP CH,AH                           ; 005615a2
    JZ 0x005615db                       ; 005615a4 | LAB_005615db
        ;   XREF to: 005615db (CONDITIONAL_JUMP)
    CMP byte ptr [EBX],0x0              ; 005615a6
        ;   Label: LAB_005615a6
    JNZ 0x005615ce                      ; 005615a9 | LAB_005615ce
        ;   XREF to: 005615ce (CONDITIONAL_JUMP)
    PUSH EDI                            ; 005615ab
    MOV EAX,0x643a95                    ; 005615ac | = "..\\core\\script.cpp" | s_core_script_cpp_00643a95 = ..\core\script.cpp
    MOV EDX,0x1188                      ; 005615b1
    PUSH 0x643aa8                       ; 005615b6 | = "Missing closing ' in template string: %s" | s_Missing_closing_in_templ_00643aa8 = Missing closing ' in template string: %s
    MOV [0x02f0ca48],EAX                ; 005615bb | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 005615c0 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005615c6 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    JNZ 0x005615a6                      ; 005615d9 | LAB_005615a6
        ;   XREF to: 005615a6 (CONDITIONAL_JUMP)
    INC EBX                             ; 005615db
        ;   Label: LAB_005615db
    MOV byte ptr [ESI],0x0              ; 005615dc
    JMP 0x00560f0a                      ; 005615df | LAB_00560f0a
        ;   XREF to: 00560f0a (UNCONDITIONAL_JUMP)
    ADD EBP,0x1f4                       ; 005615e4
        ;   Label: LAB_005615e4
    PUSH EBP                            ; 005615ea
    PUSH 0x643ad1                       ; 005615eb | = "SCmdParm::setTemplateText - Invalid t..." | s_SCmdParm_setTemplateText_00643ad1 = SCmdParm::setTemplateText - Invalid template string: %s
    MOV ESI,dword ptr [0x00678a60]      ; 005615f0 | CEditorTools * g_CEditorToolsPtr
    PUSH ESI                            ; 005615f6 | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_showError_FUN_0049e740 ; 005615f7 | void shape_edittool.cpp_CEditorTools_showError_FUN_0049e740(CEditorTools * this_ptr, char * format)
        ;   XREF to: 0049e740 (UNCONDITIONAL_CALL)
