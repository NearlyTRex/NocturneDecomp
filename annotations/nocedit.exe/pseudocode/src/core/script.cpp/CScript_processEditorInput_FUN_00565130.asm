...
;   core_script.cpp_CScript_clampCursorToView_FUN_00566880
...
;   core_script.cpp_CScript_editParameterAtPosition_FUN_00565ae0
;   core_script.cpp_CScript_executeContextAction_FUN_00565d00
;   core_script.cpp_CScript_findText_FUN_00566cc0
;   core_script.cpp_CScript_gotoPosition_FUN_00565aa0
...
;   core_script.cpp_CScript_showSyntaxHelp_FUN_00565e70
...
section .text
    ...
    PUSH EBX                            ; 00565130
        ;   Label: core_script.cpp_CScript_processEditorInput_FUN_00565130
    PUSH ESI                            ; 00565131
    PUSH EDI                            ; 00565132
    PUSH EBP                            ; 00565133
    ...
    MOV EAX,[0x0310fd40]                ; 00565154 | g_CursorBlinkTimer
    ADD EAX,EDX                         ; 00565159
    AND EAX,0xfffff                     ; 0056515b
    PUSH EBP                            ; 00565160
    MOV [0x0310fd40],EAX                ; 00565161 | g_CursorBlinkTimer
    CALL core_script.cpp_CScript_updateCursorBounds_FUN_00566910 ; 00565166
    ...
    PUSH EBP                            ; 0056516e
    CALL core_script.cpp_CScript_updateScrollPosition_FUN_005669a0 ; 0056516f
    ...
    CALL core_script.cpp_updateSelection_FUN_00564500 ; 00565177
        ;   XREF to: 00564500 (UNCONDITIONAL_CALL)  ; void core_script.cpp_updateSelection_FUN_00564500()
    PUSH 0x310fd0c                      ; 0056517c | g_ScriptEditorHScrollBar
    ...
    PUSH 0x310fcd8                      ; 00565189 | g_ScriptEditorVScrollBar
    CALL shape_edittool.cpp_CEdScrollBar_handleInput_FUN_004a5fc0 ; 0056518e
        ;   XREF to: 004a5fc0 (UNCONDITIONAL_CALL)  ; void shape_edittool.cpp_CEdScrollBar_handleInput_FUN_004a5fc0(CEdScrollBar * this_ptr)
    ADD ESP,0x4                         ; 00565193
    PUSH EBP                            ; 00565196
    CALL core_script.cpp_CScript_clampCursorToView_FUN_00566880 ; 00565197
        ;   XREF to: 00566880 (UNCONDITIONAL_CALL)  ; void core_script.cpp_CScript_clampCursorToView_FUN_00566880(CScript * this_ptr)
    MOV EAX,[0x0310fd44]                ; 0056519c | g_CurrentEditingColumn
    ADD ESP,0x4                         ; 005651a1
    MOV dword ptr [ESP + 0x20],EAX      ; 005651a4
    MOV EAX,[0x0310fd48]                ; 005651a8 | g_CurrentEditingLine
    PUSH 0x4b                           ; 005651ad
    ...
    MOV ECX,dword ptr [0x0310fd4c]      ; 005652f4 | g_SelectionAnchorColumn
    ...
    JZ 0x00565469                       ; 00565411
        ;   XREF to: 00565469 (CONDITIONAL_JUMP)  ; LAB_00565469
    MOV EAX,[0x0310fd48]                ; 00565413 | g_CurrentEditingLine
    INC EAX                             ; 00565418
    PUSH 0x1                            ; 00565419
    MOV dword ptr [ESP + 0xc],EAX       ; 0056541b
    LEA EAX,[EBP + 0x38]                ; 0056541f
    PUSH EAX                            ; 00565422
    CALL shape_edittool.cpp_CStrList_getItemCount_FUN_004a6ed0 ; 00565423
    ...
    DEC EAX                             ; 00565452
    MOV [0x0310fd48],EAX                ; 00565453 | g_CurrentEditingLine
    XOR EAX,EAX                         ; 00565458
    MOV ESI,0x1                         ; 0056545a
    MOV [0x0310fd44],EAX                ; 0056545f | g_CurrentEditingColumn
    ...
    PUSH 0x1                            ; 005654b5
        ;   Label: LAB_005654b5
    PUSH 0x64                           ; 005654b7
    PUSH 0x310fd58                      ; 005654b9 | g_ScriptFindText
    ...
    PUSH EAX                            ; 005654e5
    MOV ECX,dword ptr [0x0310fd48]      ; 005654e6 | g_CurrentEditingLine
    PUSH ECX                            ; 005654ec
    MOV EBX,dword ptr [0x0310fd44]      ; 005654ed | g_CurrentEditingColumn
    PUSH EBX                            ; 005654f3
    PUSH 0x310fd58                      ; 005654f4 | g_ScriptFindText
    PUSH EBP                            ; 005654f9
    CALL core_script.cpp_CScript_findText_FUN_00566cc0 ; 005654fa
        ;   XREF to: 00566cc0 (UNCONDITIONAL_CALL)  ; int core_script.cpp_CScript_findText_FUN_00566cc0(CScript * this_ptr, char * search_str, int start_col, int start_line, ...)
    ...
    MOV [0x0310fd44],EAX                ; 00565532 | g_CurrentEditingColumn
    MOV EAX,dword ptr [ESP + 0x4]       ; 00565537
    XOR ESI,ESI                         ; 0056553b
    MOV [0x0310fd4c],EAX                ; 0056553d | g_SelectionAnchorColumn
    MOV EAX,dword ptr [ESP]             ; 00565542
    MOV dword ptr [ESP + 0x24],EDI      ; 00565545
    MOV [0x0310fd50],EAX                ; 00565549 | g_SelectionAnchorLine
    PUSH 0x3d                           ; 0056554e
        ;   Label: LAB_0056554e
    ...
    CMP byte ptr [0x0310fd58],0x0       ; 00565583 | g_ScriptFindText
        ;   Label: LAB_00565583
    JNZ 0x005655a8                      ; 0056558a
        ;   XREF to: 005655a8 (CONDITIONAL_JUMP)  ; LAB_005655a8
    PUSH 0x1                            ; 0056558c
    PUSH 0x64                           ; 0056558e
    PUSH 0x310fd58                      ; 00565590 | g_ScriptFindText
    ...
    CMP byte ptr [0x0310fd58],0x0       ; 005655a8 | g_ScriptFindText
        ;   Label: LAB_005655a8
    ...
    PUSH EAX                            ; 005655c0
    MOV EDX,dword ptr [0x0310fd48]      ; 005655c1 | g_CurrentEditingLine
    MOV ECX,dword ptr [0x0310fd44]      ; 005655c7 | g_CurrentEditingColumn
    PUSH EDX                            ; 005655cd
    ADD EBX,ECX                         ; 005655ce
    PUSH EBX                            ; 005655d0
    PUSH 0x310fd58                      ; 005655d1 | g_ScriptFindText
    PUSH EBP                            ; 005655d6
    CALL core_script.cpp_CScript_findText_FUN_00566cc0 ; 005655d7
        ;   XREF to: 00566cc0 (UNCONDITIONAL_CALL)  ; int core_script.cpp_CScript_findText_FUN_00566cc0(CScript * this_ptr, char * search_str, int start_col, int start_line, ...)
    ...
    MOV [0x0310fd44],EAX                ; 00565610 | g_CurrentEditingColumn
    MOV EAX,dword ptr [ESP + 0x18]      ; 00565615
    XOR ESI,ESI                         ; 00565619
    MOV [0x0310fd4c],EAX                ; 0056561b | g_SelectionAnchorColumn
    MOV EAX,dword ptr [ESP + 0x14]      ; 00565620
    MOV dword ptr [ESP + 0x24],EBX      ; 00565624
    MOV [0x0310fd50],EAX                ; 00565628 | g_SelectionAnchorLine
    PUSH 0x3e                           ; 0056562d
        ;   Label: LAB_0056562d
    ...
    MOV ESI,dword ptr [0x0310fd48]      ; 00565641 | g_CurrentEditingLine
    PUSH ESI                            ; 00565647
    MOV EDI,dword ptr [0x0310fd44]      ; 00565648 | g_CurrentEditingColumn
    PUSH EDI                            ; 0056564e
    PUSH EBP                            ; 0056564f
    MOV ESI,0x1                         ; 00565650
    CALL core_script.cpp_CScript_editParameterAtPosition_FUN_00565ae0 ; 00565655
        ;   XREF to: 00565ae0 (UNCONDITIONAL_CALL)  ; void core_script.cpp_CScript_editParameterAtPosition_FUN_00565ae0(CScript * this_ptr, int column, int line)
    ...
    MOV EAX,[0x0310fd48]                ; 00565671 | g_CurrentEditingLine
    PUSH EAX                            ; 00565676
    MOV EDX,dword ptr [0x0310fd44]      ; 00565677 | g_CurrentEditingColumn
    PUSH EDX                            ; 0056567d
    PUSH EBP                            ; 0056567e
    MOV ESI,0x1                         ; 0056567f
    CALL core_script.cpp_CScript_executeContextAction_FUN_00565d00 ; 00565684
        ;   XREF to: 00565d00 (UNCONDITIONAL_CALL)  ; void core_script.cpp_CScript_executeContextAction_FUN_00565d00(CScript * this_ptr, int column, int line)
    ...
    MOV ECX,dword ptr [0x0310fd48]      ; 005656a0 | g_CurrentEditingLine
    PUSH ECX                            ; 005656a6
    MOV EBX,dword ptr [0x0310fd44]      ; 005656a7 | g_CurrentEditingColumn
    PUSH EBX                            ; 005656ad
    PUSH EBP                            ; 005656ae
    CALL core_script.cpp_CScript_showSyntaxHelp_FUN_00565e70 ; 005656af
        ;   XREF to: 00565e70 (UNCONDITIONAL_CALL)  ; void core_script.cpp_CScript_showSyntaxHelp_FUN_00565e70(CScript * this_ptr, int column, int line)
    ADD ESP,0xc                         ; 005656b4
    MOV EDI,dword ptr [0x02cf2b00]      ; 005656b7 | g_ActiveControl
        ;   Label: LAB_005656b7
    ...
    PUSH 0x310fd48                      ; 005656d2 | g_CurrentEditingLine
    PUSH 0x310fd44                      ; 005656d7 | g_CurrentEditingColumn
    MOV EDX,dword ptr [0x02cf6a90]      ; 005656dc | g_MouseY
    PUSH EDX                            ; 005656e2
    MOV ECX,dword ptr [0x02cf6a8c]      ; 005656e3 | g_MouseX
    PUSH ECX                            ; 005656e9
    PUSH EDI                            ; 005656ea
    CALL core_script.cpp_CScript_screenToScriptPosition_FUN_00566c20 ; 005656eb
    ...
    MOV EBX,dword ptr [0x031141e0]      ; 005656f5 | g_ScriptTextAreaLeft
    ...
    MOV EDI,dword ptr [0x031141e8]      ; 0056570f | g_ScriptTextAreaRight
        ;   Label: LAB_0056570f
    ...
    MOV EDX,dword ptr [0x031141e4]      ; 0056572a | g_ScriptTextAreaTop
        ;   Label: LAB_0056572a
    ...
    MOV ECX,dword ptr [0x031141ec]      ; 00565745 | g_ScriptTextAreaBottom
        ;   Label: LAB_00565745
    ...
    PUSH EBP                            ; 00565768
        ;   Label: LAB_00565768
    CALL core_script.cpp_CScript_updateCursorBounds_FUN_00566910 ; 00565769
        ;   XREF to: 00566910 (UNCONDITIONAL_CALL)  ; void core_script.cpp_CScript_updateCursorBounds_FUN_00566910(CScript * this_ptr)
    ...
    CMP dword ptr [0x0068105c],0x0      ; 005657f2 | g_AutoIndentEnabled
        ;   Label: LAB_005657f2
    SETZ AL                             ; 005657f9
    AND EAX,0xff                        ; 005657fc
    MOV [0x0068105c],EAX                ; 00565801 | g_AutoIndentEnabled
    JMP 0x00565363                      ; 00565806
        ;   XREF to: 00565363 (UNCONDITIONAL_JUMP)  ; LAB_00565363
    PUSH 0x310fd58                      ; 0056580b | g_ScriptFindText
        ;   Label: LAB_0056580b
    ...
    PUSH 0x310fd58                      ; 00565827 | g_ScriptFindText
        ;   Label: LAB_00565827
    ...
    XOR EAX,EAX                         ; 00565843
        ;   Label: LAB_00565843
    MOV [0x02cf2b00],EAX                ; 00565845 | g_ActiveControl
    ...
    PUSH 0x310fd48                      ; 00565862 | g_CurrentEditingLine
    PUSH 0x310fd44                      ; 00565867 | g_CurrentEditingColumn
    MOV EDX,dword ptr [0x02cf6a90]      ; 0056586c | g_MouseY
    PUSH EDX                            ; 00565872
    MOV ECX,dword ptr [0x02cf6a8c]      ; 00565873 | g_MouseX
    PUSH ECX                            ; 00565879
    PUSH EBP                            ; 0056587a
    CALL core_script.cpp_CScript_screenToScriptPosition_FUN_00566c20 ; 0056587b
        ;   XREF to: 00566c20 (UNCONDITIONAL_CALL)  ; int core_script.cpp_CScript_screenToScriptPosition_FUN_00566c20(CScript * this_ptr, int pixel_x, int pixel_y, int * column_out, ...)
    ...
    MOV EBX,dword ptr [0x0310fd48]      ; 0056589a | g_CurrentEditingLine
    PUSH EBX                            ; 005658a0
    MOV ESI,dword ptr [0x0310fd44]      ; 005658a1 | g_CurrentEditingColumn
    PUSH ESI                            ; 005658a7
    PUSH EBP                            ; 005658a8
    CALL core_script.cpp_CScript_editParameterAtPosition_FUN_00565ae0 ; 005658a9
        ;   XREF to: 00565ae0 (UNCONDITIONAL_CALL)  ; void core_script.cpp_CScript_editParameterAtPosition_FUN_00565ae0(CScript * this_ptr, int column, int line)
    ...
    JMP 0x00565768                      ; 005658bc
        ;   XREF to: 00565768 (UNCONDITIONAL_JUMP)  ; LAB_00565768
    MOV dword ptr [0x02cf2b00],EBP      ; 005658c1 | g_ActiveControl
        ;   Label: LAB_005658c1
    ...
    JZ 0x00565768                       ; 005658cc
        ;   XREF to: 00565768 (CONDITIONAL_JUMP)  ; LAB_00565768
    PUSH 0x310fd48                      ; 005658d2 | g_CurrentEditingLine
    PUSH 0x310fd44                      ; 005658d7 | g_CurrentEditingColumn
    ...
    CALL core_script.cpp_CScript_screenToScriptPosition_FUN_00566c20 ; 005658f1
        ;   XREF to: 00566c20 (UNCONDITIONAL_CALL)  ; int core_script.cpp_CScript_screenToScriptPosition_FUN_00566c20(CScript * this_ptr, int pixel_x, int pixel_y, int * column_out, ...)
    ADD ESP,0x14                        ; 005658f6
    TEST EAX,EAX                        ; 005658f9
    JZ 0x00565768                       ; 005658fb
        ;   XREF to: 00565768 (CONDITIONAL_JUMP)  ; LAB_00565768
    MOV EDI,dword ptr [0x0310fd48]      ; 00565901 | g_CurrentEditingLine
    PUSH EDI                            ; 00565907
    MOV EAX,[0x0310fd44]                ; 00565908 | g_CurrentEditingColumn
    PUSH EAX                            ; 0056590d
    PUSH EBP                            ; 0056590e
    CALL core_script.cpp_CScript_gotoPosition_FUN_00565aa0 ; 0056590f
        ;   XREF to: 00565aa0 (UNCONDITIONAL_CALL)  ; void core_script.cpp_CScript_gotoPosition_FUN_00565aa0(CScript * this_ptr, int column, int line)
    ...
    CALL core_script.cpp_CScript_editorAction_FUN_00564820 ; 00565948
        ;   XREF to: 00564820 (UNCONDITIONAL_CALL)  ; void core_script.cpp_CScript_editorAction_FUN_00564820(CScript * this_ptr, EEditorActionType action_type)
    MOV ESI,dword ptr [0x0068105c]      ; 0056594d | g_AutoIndentEnabled
    ...
    CALL core_script.cpp_CScript_insertText_FUN_00566390 ; 0056596c
    ...
    JMP 0x00565771                      ; 00565983
        ;   XREF to: 00565771 (UNCONDITIONAL_JUMP)  ; LAB_00565771
    MOV EDI,dword ptr [0x0310fd48]      ; 00565988 | g_CurrentEditingLine
        ;   Label: LAB_00565988
    PUSH EDI                            ; 0056598e
    PUSH EBP                            ; 0056598f
    CALL core_script.cpp_CScript_loadLineToBuffer_FUN_00566230 ; 00565990
    ...
    MOV EDI,0x31101c0                   ; 00565998 | g_CurrentLineBuffer
    ...
    PUSH EAX                            ; 005659ac
    MOV EDX,dword ptr [0x0310fd48]      ; 005659ad | g_CurrentEditingLine
    PUSH EDX                            ; 005659b3
    PUSH EBP                            ; 005659b4
    ...
    MOV byte ptr [EAX + 0x31101c0],BL   ; 005659d2 | g_CurrentLineBuffer
        ;   Label: LAB_005659d2
    ...
    INC EAX                             ; 005659dd
        ;   Label: LAB_005659dd
    PUSH EAX                            ; 005659de
    MOV ECX,dword ptr [0x0310fd48]      ; 005659df | g_CurrentEditingLine
    PUSH ECX                            ; 005659e5
    XOR DH,DH                           ; 005659e6
    PUSH EBP                            ; 005659e8
    ...
    MOV EBX,dword ptr [0x0310fd48]      ; 005659f7 | g_CurrentEditingLine
    PUSH EBX                            ; 005659fd
    PUSH EBP                            ; 005659fe
    MOV [0x0310fd44],EAX                ; 005659ff | g_CurrentEditingColumn
    ...
    PUSH EBP                            ; 00565a16
        ;   Label: LAB_00565a16
    CALL core_script.cpp_CScript_updateScrollPosition_FUN_005669a0 ; 00565a17
        ;   XREF to: 005669a0 (UNCONDITIONAL_CALL)  ; void core_script.cpp_CScript_updateScrollPosition_FUN_005669a0(CScript * this_ptr)
    ...
    CMP EAX,dword ptr [0x0310fd44]      ; 00565a27 | g_CurrentEditingColumn
    ...
    CMP dword ptr [0x0310fd4c],0x0      ; 00565a36 | g_SelectionAnchorColumn
    JL 0x00565a77                       ; 00565a3d
        ;   XREF to: 00565a77 (CONDITIONAL_JUMP)  ; LAB_00565a77
    XOR ECX,ECX                         ; 00565a3f
        ;   Label: LAB_00565a3f
    MOV dword ptr [0x0310fd40],ECX      ; 00565a41 | g_CursorBlinkTimer
    MOV ESI,dword ptr [ESP + 0x1c]      ; 00565a47
        ;   Label: LAB_00565a47
    PUSH ESI                            ; 00565a4b
    PUSH EBP                            ; 00565a4c
    CALL core_script.cpp_CScript_updateLineMetrics_FUN_00566800 ; 00565a4d
    ...
    CALL core_script.cpp_updateSelection_FUN_00564500 ; 00565a55
        ;   XREF to: 00564500 (UNCONDITIONAL_CALL)  ; void core_script.cpp_updateSelection_FUN_00564500()
    ...
    POP EBX                             ; 00565a60
    RET                                 ; 00565a61
    CALL core_script.cpp_clearSelections_FUN_005644e0 ; 00565a62
    ...
    MOV EAX,dword ptr [ESP + 0x1c]      ; 00565a69
        ;   Label: LAB_00565a69
    CMP EAX,dword ptr [0x0310fd48]      ; 00565a6d | g_CurrentEditingLine
    ...
    MOV EAX,dword ptr [ESP + 0x20]      ; 00565a77
        ;   Label: LAB_00565a77
    MOV [0x0310fd4c],EAX                ; 00565a7b | g_SelectionAnchorColumn
    MOV EAX,dword ptr [ESP + 0x1c]      ; 00565a80
    MOV [0x0310fd50],EAX                ; 00565a84 | g_SelectionAnchorLine
    JMP 0x00565a3f                      ; 00565a89
        ;   XREF to: 00565a3f (UNCONDITIONAL_JUMP)  ; LAB_00565a3f
    CALL core_script.cpp_clearSelections_FUN_005644e0 ; 00565a8b
        ;   XREF to: 005644e0 (UNCONDITIONAL_CALL)  ; void core_script.cpp_clearSelections_FUN_005644e0()
        ;   Label: LAB_00565a8b
