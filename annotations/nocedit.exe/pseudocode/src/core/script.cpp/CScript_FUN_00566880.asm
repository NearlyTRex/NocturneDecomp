...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_FUN_00566880(CScript *this_ptr)
;
; Parameters:
; CScript *        Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_script.cpp_CScript_FUN_00565130 at 00565197
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00566880
        ;   Label: core_script.cpp_CScript_FUN_00566880
    PUSH ESI                            ; 00566881
    PUSH EDI                            ; 00566882
    PUSH EBP                            ; 00566883
    MOV EDX,dword ptr [ESP + 0x14]      ; 00566884
    PUSH EDX                            ; 00566888
    CALL core_script.cpp_CScript_FUN_00566910 ; 00566889
    ...
    MOV ECX,dword ptr [ESP + 0x14]      ; 005668ed
        ;   Label: LAB_005668ed
    PUSH ECX                            ; 005668f1
    CALL core_script.cpp_CScript_FUN_00566910 ; 005668f2
        ;   XREF to: 00566910 (UNCONDITIONAL_CALL)  ; void core_script.cpp_CScript_FUN_00566910(CScript * this_ptr)
