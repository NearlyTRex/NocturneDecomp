...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_script.cpp_FUN_005593f0()
;
;
; XREF[2]:
;   core_script.cpp_CScript_step_FUN_0055a810 at 0055c1ab
;   core_script.cpp_FUN_005594a0 at 005594ac
;
; Referenced Globals:
...
section .text
    ...
    PUSH EDX                            ; 005593fe
    CALL core_script.cpp_FUN_005593d0   ; 005593ff | undefined core_script.cpp_FUN_005593d0()
    ...
    JNZ 0x0055944b                      ; 0055940e | LAB_0055944b
    ...
    JLE 0x00559441                      ; 0055941a | LAB_00559441
    ...
    TEST CL,CL                          ; 00559425
    JZ 0x00559455                       ; 00559427 | LAB_00559455
        ;   XREF to: 00559455 (CONDITIONAL_JUMP)
    CMP CL,0x28                         ; 00559429
    JNZ 0x0055945f                      ; 0055942c | LAB_0055945f
    ...
    JL 0x0055941c                       ; 0055943f | LAB_0055941c
        ;   XREF to: 0055941c (CONDITIONAL_JUMP)
    MOV EAX,0x641535                    ; 00559441 | = "Argument too long" | s_Argument_too_long_00641535 = Argument too long
        ;   Label: LAB_00559441
    POP EBP                             ; 00559446
    POP EDI                             ; 00559447
    POP ESI                             ; 00559448
    POP EBX                             ; 00559449
    RET                                 ; 0055944a
    MOV EAX,0x64151e                    ; 0055944b | = "No opening parenthesis" | s_No_opening_parenthesis_0064151e = No opening parenthesis
        ;   Label: LAB_0055944b
    POP EBP                             ; 00559450
    POP EDI                             ; 00559451
    POP ESI                             ; 00559452
    POP EBX                             ; 00559453
    RET                                 ; 00559454
    MOV EAX,0x641547                    ; 00559455 | = "Can't find closing parenthesis" | s_Can_t_find_closing_paren_00641547 = Can't find closing parenthesis
        ;   Label: LAB_00559455
    POP EBP                             ; 0055945a
    POP EDI                             ; 0055945b
    POP ESI                             ; 0055945c
    ...
    CMP CL,0x29                         ; 0055945f
        ;   Label: LAB_0055945f
    JNZ 0x0055942f                      ; 00559462 | LAB_0055942f
        ;   XREF to: 0055942f (CONDITIONAL_JUMP)
    TEST EAX,EAX                        ; 00559464
    JZ 0x0055946b                       ; 00559466 | LAB_0055946b
        ;   XREF to: 0055946b (CONDITIONAL_JUMP)
    DEC EAX                             ; 00559468
    JMP 0x0055942f                      ; 00559469 | LAB_0055942f
    ...
    CALL core_script.cpp_FUN_00559360   ; 00559475 | undefined core_script.cpp_FUN_00559360()
        ;   XREF to: 00559360 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0055947a
    MOV EBP,dword ptr [EBX]             ; 0055947d
    PUSH EBP                            ; 0055947f
    CALL core_script.cpp_FUN_005593d0   ; 00559480 | undefined core_script.cpp_FUN_005593d0()
        ;   XREF to: 005593d0 (UNCONDITIONAL_CALL)
