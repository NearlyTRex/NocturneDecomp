...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_FUN_005598f0(CScript *this_ptr)
;
; Parameters:
; CScript *        Stack[0x4]:4   this_ptr
;
; XREF[2]:
;   core_script.cpp_CScript_FUN_00559870 at 00559883
;   core_script.cpp_CScript_FUN_0055a370 at 0055a37c
;
; Referenced Globals:
...
section .text
    ...
    PUSH EDI                            ; 005598f0
        ;   Label: core_script.cpp_CScript_FUN_005598f0
    PUSH EBP                            ; 005598f1
