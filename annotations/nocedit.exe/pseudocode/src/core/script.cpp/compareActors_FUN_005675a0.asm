...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_script_cpp_compareActors_FUN_005675a0(CDemonActor *a,CDemonActor *b)
;
; Parameters:
; CDemonActor *    Stack[0x4]:4   a
; CDemonActor *    Stack[0x8]:4   b
;
; XREF[1]:
...
section .text
    ...
    PUSH EBX                            ; 005675a0
        ;   Label: core_script.cpp_compareActors_FUN_005675a0
    PUSH ESI                            ; 005675a1
    PUSH EDI                            ; 005675a2
