...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_parseActionTemplate_FUN_00567490(CScript *this_ptr,char *text,SScriptXRef *xref_data)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00567490
        ;   Label: core_script.cpp_CScript_parseActionTemplate_FUN_00567490
    PUSH ESI                            ; 00567491
    PUSH EDI                            ; 00567492
