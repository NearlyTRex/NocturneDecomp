...
;   core_script.cpp_CScript_splitLineAtColumn_FUN_00566330
...
section .text
    ...
    PUSH EBX                            ; 00566390
        ;   Label: core_script.cpp_CScript_insertText_FUN_00566390
    PUSH ESI                            ; 00566391
    PUSH EDI                            ; 00566392
    PUSH EBP                            ; 00566393
    ...
    CALL core_script.cpp_CScript_splitLineAtColumn_FUN_00566330 ; 00566476
        ;   XREF to: 00566330 (UNCONDITIONAL_CALL)  ; void core_script.cpp_CScript_splitLineAtColumn_FUN_00566330(CScript * this_ptr, int column, int line)
