...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_FUN_00567010(CScript *this_ptr,char *param_2,int *param_3)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00567010
        ;   Label: core_script.cpp_CScript_FUN_00567010
    PUSH ESI                            ; 00567011
    PUSH EDI                            ; 00567012
    ...
    PUSH EAX                            ; 00567057
    PUSH ESI                            ; 00567058
    CALL core_script.cpp_CScript_FUN_00567080 ; 00567059
