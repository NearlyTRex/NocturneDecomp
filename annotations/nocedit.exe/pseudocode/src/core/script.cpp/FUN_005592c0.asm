...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_script.cpp_FUN_005592c0()
;
;
; XREF[1]:
...
section .text
    ...
    TEST byte ptr [EAX + 0x6849c4],0x2  ; 005592d7 | char[256] g_CharacterClassificationTable
    JZ 0x005592e3                       ; 005592de | LAB_005592e3
        ;   XREF to: 005592e3 (CONDITIONAL_JUMP)
    INC ESI                             ; 005592e0
    JMP 0x005592ce                      ; 005592e1 | LAB_005592ce
    ...
    CMP AL,0x0                          ; 005592ea
    JZ 0x005592fe                       ; 005592ec | LAB_005592fe
    ...
    CMP AL,0x0                          ; 005592fa
    JNZ 0x005592e6                      ; 005592fc | LAB_005592e6
        ;   XREF to: 005592e6 (CONDITIONAL_JUMP)
    POP EDI                             ; 005592fe
        ;   Label: LAB_005592fe
    PUSH 0x64151b                       ; 005592ff | = "//" | s_anon_0064151b = //
    PUSH EBX                            ; 00559304
    CALL crt_string.c_strstr_FUN_005fedd0 ; 00559305 | char * crt_string.c_strstr_FUN_005fedd0(char * haystack_str, char * needle_str)
        ;   XREF to: 005fedd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0055930a
    TEST EAX,EAX                        ; 0055930d
    JZ 0x00559314                       ; 0055930f | LAB_00559314
    ...
    MOV AL,byte ptr [ESI]               ; 00559318
        ;   Label: LAB_00559318
    CMP AL,DL                           ; 0055931a
    JZ 0x00559330                       ; 0055931c | LAB_00559330
        ;   XREF to: 00559330 (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 0055931e
    JZ 0x0055932e                       ; 00559320 | LAB_0055932e
        ;   XREF to: 0055932e (CONDITIONAL_JUMP)
    INC ESI                             ; 00559322
    MOV AL,byte ptr [ESI]               ; 00559323
    CMP AL,DL                           ; 00559325
    JZ 0x00559330                       ; 00559327 | LAB_00559330
        ;   XREF to: 00559330 (CONDITIONAL_JUMP)
    INC ESI                             ; 00559329
    CMP AL,0x0                          ; 0055932a
    JNZ 0x00559318                      ; 0055932c | LAB_00559318
    ...
    JBE 0x0055934f                      ; 00559334 | LAB_0055934f
        ;   XREF to: 0055934f (CONDITIONAL_JUMP)
    MOV DL,byte ptr [EAX + -0x1]        ; 00559336
        ;   Label: LAB_00559336
    INC DL                              ; 00559339
    MOVZX ESI,DL                        ; 0055933b
    TEST byte ptr [ESI + 0x6849c4],0x2  ; 0055933e | char[256] g_CharacterClassificationTable
    JZ 0x0055934f                       ; 00559345 | LAB_0055934f
        ;   XREF to: 0055934f (CONDITIONAL_JUMP)
    DEC EAX                             ; 00559347
    MOV byte ptr [EAX],0x0              ; 00559348
    CMP EAX,EBX                         ; 0055934b
    JA 0x00559336                       ; 0055934d | LAB_00559336
