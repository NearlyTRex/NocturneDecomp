...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_updateLineMetrics_FUN_00566800(CScript *this_ptr,int line_number)
;
; Parameters:
...
;   core_script.cpp_CScript_processEditorInput_FUN_00565130 at 00565a4d
;   core_script.cpp_CScript_saveToFile_FUN_00566180 at 005661d4
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00566800
        ;   Label: core_script.cpp_CScript_updateLineMetrics_FUN_00566800
    PUSH ESI                            ; 00566801
    PUSH EDI                            ; 00566802
    PUSH EBP                            ; 00566803
    ...
    PUSH EBX                            ; 00566818
    CALL shape_edittool.cpp_CStrList_getItemCount_FUN_004a6ed0 ; 00566819
    ...
    NOT ECX                             ; 0056683c
    DEC ECX                             ; 0056683e
    MOV EBX,dword ptr [0x0310fd48]      ; 0056683f | g_CurrentEditingLine
    ...
    MOV byte ptr [EAX + EBP*0x1],0x0    ; 00566867
        ;   Label: LAB_00566867
    CMP EAX,dword ptr [0x0310fd10]      ; 0056686b | g_ScriptEditorHScrollBar.current_value
        ;   Label: LAB_0056686b
    JLE 0x0056680c                      ; 00566871
        ;   XREF to: 0056680c (CONDITIONAL_JUMP)  ; LAB_0056680c
    MOV [0x0310fd10],EAX                ; 00566873 | g_ScriptEditorHScrollBar.current_value
    POP EBP                             ; 00566878
    POP EDI                             ; 00566879
    POP ESI                             ; 0056687a
    POP EBX                             ; 0056687b
