...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_FUN_005671a0(CScript *this_ptr,int param_2,int *param_3)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005671a0
        ;   Label: core_script.cpp_CScript_FUN_005671a0
    PUSH ESI                            ; 005671a1
    PUSH EDI                            ; 005671a2
    PUSH EBP                            ; 005671a3
    ...
    PUSH EDI                            ; 00567257
    PUSH EBP                            ; 00567258
    CALL core_script.cpp_CScript_FUN_00567490 ; 00567259
        ;   XREF to: 00567490 (UNCONDITIONAL_CALL)  ; void core_script.cpp_CScript_FUN_00567490(CScript * this_ptr, int param_2, int param_3)
    ...
    CALL core_script.cpp_CScript_FUN_00567510 ; 005672fe
