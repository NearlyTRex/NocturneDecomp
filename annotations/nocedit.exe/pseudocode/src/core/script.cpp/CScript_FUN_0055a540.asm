...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_FUN_0055a540(CScript *this_ptr)
;
; Parameters:
...
;   core_script.cpp_CScript_FUN_00559f80 at 0055a350
;   core_script.cpp_CScript_FUN_0055a4b0 at 0055a4c6
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0055a540
        ;   Label: core_script.cpp_CScript_FUN_0055a540
    PUSH ESI                            ; 0055a541
    PUSH EDI                            ; 0055a542
