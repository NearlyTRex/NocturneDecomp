...

{
  ...
  if ((0 < *(int *)(this_ptr->unk4 + 0x18)) && (*(int *)(this_ptr->unk4 + 0x1c) != 0)) {
    ...
    iVar3 = 0;
    local_18 = (float)core_charactr_cpp_FUN_0042f9e0(g_CGamePtr);
    DAT_0310f4a4 = 0;
    local_14 = local_18;
    do {
      if (((local_18 <= 0.0) || (*(int *)this_ptr->unk4 == 2)) || (*(int *)this_ptr->unk1 != 0))
      goto LAB_005599d3;
      iVar1 = this_ptr->next_cmd;
      iVar2 = core_script_cpp_CScript_step_FUN_0055a810(this_ptr,(int)&local_18);
...
LAB_005599d3:
    ...
    if (this_ptr->who_is_speaking != 0) {
      iVar3 = (**(code **)(*(int *)(this_ptr->who_is_speaking + 0x154) + 0x120))();
      if (0 < iVar3) {
