...
section .text
    ...
    PUSH EDX                            ; 005663d3
    CALL core_script.cpp_FUN_00566230   ; 005663d4
    ...
    CALL core_script.cpp_CScript_insertAndEditorPutLine_FUN_00566330 ; 00566476
        ;   XREF to: 00566330 (UNCONDITIONAL_CALL)  ; undefined core_script.cpp_CScript_insertAndEditorPutLine_FUN_00566330()
