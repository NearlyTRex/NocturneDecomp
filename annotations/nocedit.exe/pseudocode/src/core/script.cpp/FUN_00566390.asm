...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_script.cpp_FUN_00566390()
;
; Local Variables:
...
;
; XREF[3]:
;   core_script.cpp_CScript_Unk20_FUN_00565130 at 0056596c
;   core_script.cpp_CScript_editorAction_FUN_00564820 at 00564bc0
;   core_script.cpp_FUN_00565f70 at 0056606f
;
; Referenced Globals:
...
section .text
    ...
    MOV EDX,dword ptr [0x0310fd44]      ; 0056639b | undefined4 DAT_0310fd44
    PUSH EDX                            ; 005663a1
    MOV ECX,dword ptr [0x0310fd48]      ; 005663a2 | undefined4 DAT_0310fd48
    PUSH ECX                            ; 005663a8
    MOV EBX,dword ptr [ESP + 0x24]      ; 005663a9
    PUSH EBX                            ; 005663ad
    CALL core_script.cpp_CScript_editorX2Index_FUN_00566a90 ; 005663ae | undefined core_script.cpp_CScript_editorX2Index_FUN_00566a90()
        ;   XREF to: 00566a90 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005663b3
    MOV EBP,EAX                         ; 005663b6
    MOV EAX,[0x0310fd48]                ; 005663b8 | undefined4 DAT_0310fd48
    MOV dword ptr [ESP + 0x4],EAX       ; 005663bd
    CMP byte ptr [ESI],0x0              ; 005663c1
    JZ 0x00566490                       ; 005663c4 | LAB_00566490
    ...
    PUSH EDX                            ; 005663d3
    CALL core_script.cpp_FUN_00566230   ; 005663d4 | undefined core_script.cpp_FUN_00566230()
        ;   XREF to: 00566230 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005663d9
    MOV EDI,0x31101c0                   ; 005663dc | undefined1 DAT_031101c0
    SUB ECX,ECX                         ; 005663e1
    DEC ECX                             ; 005663e3
    XOR EAX,EAX                         ; 005663e4
    SCASB.REPNE ES:EDI                  ; 005663e6 | undefined1 DAT_031101c0 | DAT_031101c1
    NOT ECX                             ; 005663e8
    DEC ECX                             ; 005663ea
    MOV EBX,ECX                         ; 005663eb
    CMP ECX,EBP                         ; 005663ed
    JGE 0x005663fe                      ; 005663ef | LAB_005663fe
        ;   XREF to: 005663fe (CONDITIONAL_JUMP)
    MOV DH,0x20                         ; 005663f1
    INC EBX                             ; 005663f3
        ;   Label: LAB_005663f3
    MOV byte ptr [EBX + 0x31101bf],DH   ; 005663f4 | undefined1 DAT_031101c0 | DAT_031101c1
    CMP EBX,EBP                         ; 005663fa
    JL 0x005663f3                       ; 005663fc | LAB_005663f3
        ;   XREF to: 005663f3 (CONDITIONAL_JUMP)
    LEA EAX,[EBP + 0x1]                 ; 005663fe
        ;   Label: LAB_005663fe
    ADD EAX,0x31101c0                   ; 00566401 | undefined1 DAT_031101c0
    MOV EDI,EBP                         ; 00566406
    MOV dword ptr [ESP],EAX             ; 00566408
    ADD EDI,0x31101c0                   ; 0056640b | undefined1 DAT_031101c0
    MOV CL,byte ptr [ESI]               ; 00566411
        ;   Label: LAB_00566411
    TEST CL,CL                          ; 00566413
    JZ 0x0056644b                       ; 00566415 | LAB_0056644b
        ;   XREF to: 0056644b (CONDITIONAL_JUMP)
    CMP CL,0xa                          ; 00566417
    JZ 0x0056644b                       ; 0056641a | LAB_0056644b
        ;   XREF to: 0056644b (CONDITIONAL_JUMP)
    CMP CL,0xd                          ; 0056641c
    JNZ 0x00566424                      ; 0056641f | LAB_00566424
        ;   XREF to: 00566424 (CONDITIONAL_JUMP)
    INC ESI                             ; 00566421
        ;   Label: LAB_00566421
    JMP 0x00566411                      ; 00566422 | LAB_00566411
    ...
    INC EBX                             ; 0056642f
    INC EBP                             ; 00566430
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 00566431 | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
    ...
    INC ECX                             ; 0056643f
    MOV byte ptr [EBP + 0x31101bf],AL   ; 00566440 | DAT_031101bf | undefined1 DAT_031101c0
    MOV dword ptr [ESP],ECX             ; 00566446
    JMP 0x00566421                      ; 00566449 | LAB_00566421
        ;   XREF to: 00566421 (UNCONDITIONAL_JUMP)
    MOV ECX,dword ptr [ESP + 0x4]       ; 0056644b
        ;   Label: LAB_0056644b
    XOR AL,AL                           ; 0056644f
    PUSH ECX                            ; 00566451
    MOV byte ptr [EBX + 0x31101c0],AL   ; 00566452 | undefined1 DAT_031101c1
    MOV EBX,dword ptr [ESP + 0x20]      ; 00566458
    PUSH EBX                            ; 0056645c
    CALL core_script.cpp_CScript_editorPutLine_FUN_005662a0 ; 0056645d | undefined core_script.cpp_CScript_editorPutLine_FUN_005662a0()
        ;   XREF to: 005662a0 (UNCONDITIONAL_CALL)
    MOV AH,byte ptr [ESI]               ; 00566462
    ADD ESP,0x8                         ; 00566464
    CMP AH,0xa                          ; 00566467
    JNZ 0x00566487                      ; 0056646a | LAB_00566487
    ...
    CALL core_script.cpp_CScript_insertAndEditorPutLine_FUN_00566330 ; 00566476 | undefined core_script.cpp_CScript_insertAndEditorPutLine_FUN_00566330()
    ...
    CMP byte ptr [ESI],0x0              ; 00566487
        ;   Label: LAB_00566487
    JNZ 0x005663ca                      ; 0056648a | LAB_005663ca
        ;   XREF to: 005663ca (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x24],0x0      ; 00566490
        ;   Label: LAB_00566490
    JNZ 0x0056649f                      ; 00566495 | LAB_0056649f
    ...
    PUSH EBP                            ; 005664a9
    CALL core_script.cpp_CScript_editorIndex2X_FUN_00566b30 ; 005664aa | undefined core_script.cpp_CScript_editorIndex2X_FUN_00566b30()
        ;   XREF to: 00566b30 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005664af
    MOV [0x0310fd44],EAX                ; 005664b2 | undefined4 DAT_0310fd44
    MOV dword ptr [0x0310fd48],EDI      ; 005664b7 | undefined4 DAT_0310fd48
