...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_script_cpp_CScript_FUN_00567bc0(CScript *this_ptr,CStrList *param_2)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00567bc0
        ;   Label: core_script.cpp_CScript_FUN_00567bc0
    PUSH ESI                            ; 00567bc1
    PUSH EDI                            ; 00567bc2
    PUSH EBP                            ; 00567bc3
    ...
    PUSH EDI                            ; 00567bd1
    CALL core_script.cpp_CScript_FUN_0055a370 ; 00567bd2
