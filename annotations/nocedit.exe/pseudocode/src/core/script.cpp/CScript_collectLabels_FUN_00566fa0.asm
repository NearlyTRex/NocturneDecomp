...
; CStrList *       Stack[0x8]:4   labels_out
;
; XREF[1]:
...
section .text
    ...
    PUSH EBX                            ; 00566fa0
        ;   Label: core_script.cpp_CScript_collectLabels_FUN_00566fa0
    PUSH ESI                            ; 00566fa1
    PUSH EDI                            ; 00566fa2
    PUSH EBP                            ; 00566fa3
    ...
    PUSH EDI                            ; 00566fb8
    CALL core_script.cpp_CScript_buildParsedLines_FUN_0055a370 ; 00566fb9
