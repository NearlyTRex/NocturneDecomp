...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_script.cpp_FUN_00560160()
;
;
; XREF[3]:
;   core_script.cpp_CScript_checkInitSection_FUN_0055a6c0 at 0055a702
;   core_script.cpp_CScript_step_FUN_0055a810 at 0055a9b5
;   core_script.cpp_FUN_00565d00 at 00565deb
;
; Called Functions:
