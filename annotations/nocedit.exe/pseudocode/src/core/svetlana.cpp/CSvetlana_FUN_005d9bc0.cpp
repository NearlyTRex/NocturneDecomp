...
// Convention: __cdecl
// Signature: int __cdecl core_svetlana_cpp_CSvetlana_FUN_005d9bc0(CSvetlana *this_ptr)
...

{
  ...
  if ((iVar3 == 0) && ((int)g_PerspectiveReciprocal < 0x4000)) {
    ...
    (this_ptr->base).base.model.part_visibility_flags[*(int *)(this_ptr->unk + 0x7fcfc)] = 1;
    this_ptr_00 = g_CDemonRendererPtr2;
    (this_ptr->base).base.model.part_visibility_flags[*(int *)(this_ptr->unk + 0x7fd00)] = 1;
