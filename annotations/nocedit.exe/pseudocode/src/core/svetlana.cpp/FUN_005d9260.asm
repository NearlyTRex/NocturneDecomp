...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_svetlana.cpp_FUN_005d9260()
;
; Local Variables:
...
section .text
    ...
    MOV EDI,dword ptr [0x02db87d0]      ; 005d9280 | int g_LocalHeroIndex
    PUSH ESI                            ; 005d9286
    LEA EAX,[EBX + 0xbe2c]              ; 005d9287
    MOV dword ptr [ESP + 0xa4],EDX      ; 005d928d
    PUSH EAX                            ; 005d9294
    MOV dword ptr [ESP + 0xa0],ECX      ; 005d9295
    MOV EDI,dword ptr [EDI*0x4 + 0x2db87c0] ; 005d929c | CHero *[4] g_HeroActors
    CALL crt_memory.c_memset_FUN_005fde40 ; 005d92a3 | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
        ;   XREF to: 005fde40 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EBX + 0x1fbd0]   ; 005d92a8
    ADD ESP,0xc                         ; 005d92ae
    TEST EAX,EAX                        ; 005d92b1
    JZ 0x005d96a7                       ; 005d92b3 | LAB_005d96a7
        ;   XREF to: 005d96a7 (CONDITIONAL_JUMP)
    MOV EAX,[0x02db87d0]                ; 005d92b9 | int g_LocalHeroIndex
    LEA EDX,[EBX + 0x20]                ; 005d92be
    MOV EAX,dword ptr [EAX*0x4 + 0x2db87c0] ; 005d92c1 | CHero *[4] g_HeroActors
    ...
    JZ 0x005d93f1                       ; 005d93d7 | LAB_005d93f1
    ...
    FCOMP double ptr [0x00654aca]       ; 005d942c | double DOUBLE_00654aca
    FNSTSW AX                           ; 005d9432
    SAHF                                ; 005d9434
    JNC 0x005d9791                      ; 005d9435 | LAB_005d9791
        ;   XREF to: 005d9791 (CONDITIONAL_JUMP)
    LEA EAX,[EBX + 0x158]               ; 005d943b
    CMP ESI,0x1                         ; 005d9441
    JNZ 0x005d9700                      ; 005d9444 | LAB_005d9700
        ;   XREF to: 005d9700 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x1fbd4],0x0   ; 005d944a
    JNZ 0x005d96d8                      ; 005d9451 | LAB_005d96d8
    ...
    CMP ESI,0x1                         ; 005d9467
        ;   Label: LAB_005d9467
    JNZ 0x005d9535                      ; 005d946a | LAB_005d9535
        ;   XREF to: 005d9535 (CONDITIONAL_JUMP)
    LEA EAX,[ESP + 0x4c]                ; 005d9470
    PUSH EAX                            ; 005d9474
    LEA EAX,[ESP + 0x68]                ; 005d9475
    PUSH EAX                            ; 005d9479
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 005d947a | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
    ...
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 005d948e | float core_actor.cpp_normalizeAngleToPi_FUN_0040cd70(float angle_radians)
        ;   XREF to: 0040cd70 (UNCONDITIONAL_CALL)
    MOV dword ptr [ESP + 0xa8],EAX      ; 005d9493
    FLD float ptr [ESP + 0xa8]          ; 005d949a
    FMUL double ptr [0x00654ad2]        ; 005d94a1 | double DOUBLE_00654ad2
    ADD ESP,0x4                         ; 005d94a7
    FMUL double ptr [0x00654ada]        ; 005d94aa | double DOUBLE_00654ada
    ...
    FNSTSW AX                           ; 005d94cd
    SAHF                                ; 005d94cf
    JNC 0x005d94df                      ; 005d94d0 | LAB_005d94df
    ...
    FNSTSW AX                           ; 005d94ec
    SAHF                                ; 005d94ee
    JBE 0x005d94fe                      ; 005d94ef | LAB_005d94fe
    ...
    FCOMP double ptr [0x00654aea]       ; 005d9508 | double DOUBLE_00654aea
    FNSTSW AX                           ; 005d950e
    SAHF                                ; 005d9510
    JBE 0x005d9535                      ; 005d9511 | LAB_005d9535
        ;   XREF to: 005d9535 (CONDITIONAL_JUMP)
    FLD double ptr [ESP + 0x18]         ; 005d9513
    FCOMP double ptr [0x00654af2]       ; 005d9517 | double DOUBLE_00654af2
    FNSTSW AX                           ; 005d951d
    SAHF                                ; 005d951f
    JNC 0x005d9535                      ; 005d9520 | LAB_005d9535
        ;   XREF to: 005d9535 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0xbe38],0x0    ; 005d9522
    JZ 0x005d9535                       ; 005d9529 | LAB_005d9535
        ;   XREF to: 005d9535 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 005d9545
    SAHF                                ; 005d9547
    JNC 0x005d9945                      ; 005d9548 | LAB_005d9945
    ...
    JZ 0x005d95a9                       ; 005d958f | LAB_005d95a9
    ...
    PUSH EAX                            ; 005d95b2
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 005d95b3 | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)
    MOV EDX,EAX                         ; 005d95b8
    LEA EAX,[ESP + 0x54]                ; 005d95ba
    ADD ESP,0x8                         ; 005d95be
    CMP EAX,EDX                         ; 005d95c1
    JZ 0x005d95d9                       ; 005d95c3 | LAB_005d95d9
    ...
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 005d95e6 | float core_actor.cpp_normalizeAngleToPi_FUN_0040cd70(float angle_radians)
        ;   XREF to: 0040cd70 (UNCONDITIONAL_CALL)
    ...
    FNSTSW AX                           ; 005d9607
    SAHF                                ; 005d9609
    JBE 0x005d9617                      ; 005d960a | LAB_005d9617
    ...
    FNSTSW AX                           ; 005d9632
    SAHF                                ; 005d9634
    JNC 0x005d9642                      ; 005d9635 | LAB_005d9642
    ...
    FXCH                                ; 005d9651
    FMUL double ptr [0x00654afa]        ; 005d9653 | double DOUBLE_00654afa
    FXCH                                ; 005d9659
    ...
    FNSTSW AX                           ; 005d9667
    SAHF                                ; 005d9669
    JBE 0x005d9673                      ; 005d966a | LAB_005d9673
    ...
    FLD float ptr [EBP + 0x18]          ; 005d9673
        ;   Label: LAB_005d9673
    FMUL double ptr [0x00654b02]        ; 005d9676 | double DOUBLE_00654b02
    ...
    FNSTSW AX                           ; 005d968a
    SAHF                                ; 005d968c
    JNC 0x005d9697                      ; 005d968d | LAB_005d9697
    ...
    CMP ECX,0x3                         ; 005d96ae
        ;   Label: LAB_005d96ae
    JZ 0x005d936c                       ; 005d96b1 | LAB_005d936c
        ;   XREF to: 005d936c (CONDITIONAL_JUMP)
    JMP 0x005d93ab                      ; 005d96b7 | LAB_005d93ab
        ;   XREF to: 005d93ab (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x1fbd4],0x0   ; 005d96bc
        ;   Label: LAB_005d96bc
    JZ 0x005d93ab                       ; 005d96c3 | LAB_005d93ab
        ;   XREF to: 005d93ab (CONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0xbe44],0x1    ; 005d96c9
    JMP 0x005d93ab                      ; 005d96d3 | LAB_005d93ab
        ;   XREF to: 005d93ab (UNCONDITIONAL_JUMP)
    PUSH EAX                            ; 005d96d8
        ;   Label: LAB_005d96d8
    CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0 ; 005d96d9 | SMotion * core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0(CMotionController * this_ptr)
        ;   XREF to: 0052dab0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EAX + 0x24]      ; 005d96de
    ADD ESP,0x4                         ; 005d96e1
    CMP EAX,0x2                         ; 005d96e4
    JZ 0x005d945d                       ; 005d96e7 | LAB_005d945d
        ;   XREF to: 005d945d (CONDITIONAL_JUMP)
    CMP EAX,ESI                         ; 005d96ed
    JZ 0x005d945d                       ; 005d96ef | LAB_005d945d
        ;   XREF to: 005d945d (CONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0xbe38],ESI    ; 005d96f5
    JMP 0x005d945d                      ; 005d96fb | LAB_005d945d
        ;   XREF to: 005d945d (UNCONDITIONAL_JUMP)
    PUSH EAX                            ; 005d9700
        ;   Label: LAB_005d9700
    CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0 ; 005d9701 | SMotion * core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0(CMotionController * this_ptr)
        ;   XREF to: 0052dab0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EAX + 0x24]      ; 005d9706
    ADD ESP,0x4                         ; 005d9709
    CMP EAX,0xa                         ; 005d970c
    JNZ 0x005d9724                      ; 005d970f | LAB_005d9724
        ;   XREF to: 005d9724 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x1fbd4],0x0   ; 005d9711
    JZ 0x005d9724                       ; 005d9718 | LAB_005d9724
        ;   XREF to: 005d9724 (CONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0xbe44],0x1    ; 005d971a
    MOV EAX,[0x02db87d0]                ; 005d9724 | int g_LocalHeroIndex
        ;   Label: LAB_005d9724
    MOV EAX,dword ptr [EAX*0x4 + 0x2db87c0] ; 005d9729 | CHero *[4] g_HeroActors
    PUSH EAX                            ; 005d9730
    MOV EDX,dword ptr [EAX + 0x154]     ; 005d9731
    CALL dword ptr [EDX + 0x15c]        ; 005d9737
    ADD ESP,0x4                         ; 005d973d
    TEST EAX,EAX                        ; 005d9740
    JNZ 0x005d9467                      ; 005d9742 | LAB_005d9467
        ;   XREF to: 005d9467 (CONDITIONAL_JUMP)
    PUSH dword ptr [EBP + 0x18]         ; 005d9748
    PUSH EBX                            ; 005d974b
    CALL core_charactr.cpp_CCharacter_FUN_0042ede0 ; 005d974c | int core_charactr.cpp_CCharacter_FUN_0042ede0(CCharacter * this_ptr)
        ;   XREF to: 0042ede0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005d9751
    CMP EAX,0x1                         ; 005d9754
    JC 0x005d9467                       ; 005d9757 | LAB_005d9467
        ;   XREF to: 005d9467 (CONDITIONAL_JUMP)
    JA 0x005d9787                       ; 005d975d | LAB_005d9787
        ;   XREF to: 005d9787 (CONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0xbe2c],0x1    ; 005d975f
    JMP 0x005d9467                      ; 005d9769 | LAB_005d9467
        ;   XREF to: 005d9467 (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0xbe34],0x1    ; 005d976e
        ;   Label: LAB_005d976e
    MOV dword ptr [EBX + 0xbe2c],0x1    ; 005d9778
    JMP 0x005d9467                      ; 005d9782 | LAB_005d9467
        ;   XREF to: 005d9467 (UNCONDITIONAL_JUMP)
    CMP EAX,0x2                         ; 005d9787
        ;   Label: LAB_005d9787
    JZ 0x005d976e                       ; 005d978a | LAB_005d976e
        ;   XREF to: 005d976e (CONDITIONAL_JUMP)
    JMP 0x005d9467                      ; 005d978c | LAB_005d9467
        ;   XREF to: 005d9467 (UNCONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 005d9791
        ;   Label: LAB_005d9791
    MOV dword ptr [ESP + 0x98],EAX      ; 005d9793
    TEST ESI,ESI                        ; 005d979a
    JNZ 0x005d990f                      ; 005d979c | LAB_005d990f
        ;   XREF to: 005d990f (CONDITIONAL_JUMP)
    MOV EAX,[0x02db87d0]                ; 005d97a2 | int g_LocalHeroIndex
    MOV EAX,dword ptr [EAX*0x4 + 0x2db87c0] ; 005d97a7 | CHero *[4] g_HeroActors
    PUSH EAX                            ; 005d97ae
    ...
    MOV EAX,[0x02db87d0]                ; 005d97c5 | int g_LocalHeroIndex
    MOV EAX,dword ptr [EAX*0x4 + 0x2db87c0] ; 005d97ca | CHero *[4] g_HeroActors
    PUSH EAX                            ; 005d97d1
    MOV EDX,dword ptr [EAX + 0x154]     ; 005d97d2
    CALL dword ptr [EDX + 0x15c]        ; 005d97d8
    ADD ESP,0x4                         ; 005d97de
    TEST EAX,EAX                        ; 005d97e1
    JZ 0x005d98ee                       ; 005d97e3 | LAB_005d98ee
        ;   XREF to: 005d98ee (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x98],0x0      ; 005d97e9
        ;   Label: LAB_005d97e9
    JNZ 0x005d9806                      ; 005d97f1 | LAB_005d9806
        ;   XREF to: 005d9806 (CONDITIONAL_JUMP)
    LEA EAX,[EDI + 0x20]                ; 005d97f3
    PUSH EAX                            ; 005d97f6
    CALL core_path.cpp_FUN_00548500     ; 005d97f7 | undefined core_path.cpp_FUN_00548500()
    ...
    PUSH EAX                            ; 005d981a
    CALL core_path.cpp_CPathMap_findPathWithRetry_FUN_00547d00 ; 005d981b | int core_path.cpp_CPathMap_findPathWithRetry_FUN_00547d00(CPathMap * this_ptr, CVector3f * dest_position, CVector3f * out_euler_angles, int direction_hint)
        ;   XREF to: 00547d00 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 005d9820
    TEST EAX,EAX                        ; 005d9823
    JZ 0x005d9535                       ; 005d9825 | LAB_005d9535
        ;   XREF to: 005d9535 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x74]          ; 005d982b
    FSUB float ptr [EBX + 0x34]         ; 005d982f
    SUB ESP,0x4                         ; 005d9832
    FSTP float ptr [ESP]                ; 005d9835
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 005d9838 | float core_actor.cpp_normalizeAngleToPi_FUN_0040cd70(float angle_radians)
        ;   XREF to: 0040cd70 (UNCONDITIONAL_CALL)
    MOV dword ptr [ESP + 0xa8],EAX      ; 005d983d
    FLD float ptr [ESP + 0xa8]          ; 005d9844
    FMUL double ptr [0x00654ad2]        ; 005d984b | double DOUBLE_00654ad2
    ADD ESP,0x4                         ; 005d9851
    FMUL double ptr [0x00654ada]        ; 005d9854 | double DOUBLE_00654ada
    ...
    FNSTSW AX                           ; 005d9877
    SAHF                                ; 005d9879
    JC 0x005d991a                       ; 005d987a | LAB_005d991a
    ...
    FNSTSW AX                           ; 005d988d
    SAHF                                ; 005d988f
    JBE 0x005d989f                      ; 005d9890 | LAB_005d989f
    ...
    JMP 0x005d9565                      ; 005d9964 | LAB_005d9565
