...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_svetlana_cpp_CSVetlana_archive_FUN_005d9bb0(CSvetlana *this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x4]       ; 005d9bb0
        ;   Label: core_svetlana.cpp_CSVetlana_archive_FUN_005d9bb0
    PUSH EDX                            ; 005d9bb4
    CALL core_hero.cpp_CHero_archive_FUN_004f2610 ; 005d9bb5
