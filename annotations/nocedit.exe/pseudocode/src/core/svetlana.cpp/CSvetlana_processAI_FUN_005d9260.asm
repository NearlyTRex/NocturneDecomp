...
section .text
    ...
    PUSH EBX                            ; 005d9260
        ;   Label: core_svetlana.cpp_CSvetlana_processAI_FUN_005d9260
    PUSH ESI                            ; 005d9261
    PUSH EDI                            ; 005d9262
    PUSH EBP                            ; 005d9263
    ...
    CALL core_hero.cpp_CHero_findNearestEnemy_FUN_004f3960 ; 005d937e
    ...
    PUSH EAX                            ; 005d9479
    CALL core_vecdir.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 005d947a
    ...
    PUSH EAX                            ; 005d95b2
    CALL core_vecdir.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 005d95b3
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)  ; CVector3f * core_vecdir.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
