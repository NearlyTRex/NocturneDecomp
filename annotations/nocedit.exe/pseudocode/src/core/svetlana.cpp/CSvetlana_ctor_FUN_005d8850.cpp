...

{
  ...
  (ADJ(pCVar4)->head_euler_angles).z = 0.0;
  (ADJ(pCVar4)->head_euler_angles).y = (ADJ(pCVar4)->head_euler_angles).z;
  (ADJ(pCVar4)->head_euler_angles).x = (ADJ(pCVar4)->head_euler_angles).y;
  return ADJ(pCVar4);
}
