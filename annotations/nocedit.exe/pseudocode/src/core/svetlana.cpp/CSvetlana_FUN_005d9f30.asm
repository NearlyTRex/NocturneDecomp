...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_svetlana.cpp_CSvetlana_FUN_005d9f30(CSvetlana * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH ECX                            ; 005d9f39
    CALL core_hero.cpp_CHero_FUN_004f3fa0 ; 005d9f3a | void core_hero.cpp_CHero_FUN_004f3fa0(CHero * this_ptr)
