...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_svetlana_cpp_CSvetlana_FUN_005d9970(CSvetlana *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005d9970
        ;   Label: core_svetlana.cpp_CSvetlana_FUN_005d9970
    PUSH ESI                            ; 005d9971
    PUSH EDI                            ; 005d9972
    PUSH EBP                            ; 005d9973
    ...
    PUSH EDI                            ; 005d999e
    PUSH EBX                            ; 005d999f
    CALL core_svetlana.cpp_CSvetlana_FUN_005d9a10 ; 005d99a0
        ;   XREF to: 005d9a10 (UNCONDITIONAL_CALL)  ; void core_svetlana.cpp_CSvetlana_FUN_005d9a10(CSvetlana * this_ptr)
    ...
    PUSH EDX                            ; 005d99d7
    PUSH EBX                            ; 005d99d8
    CALL core_svetlana.cpp_CSvetlana_FUN_005d9a10 ; 005d99d9
        ;   XREF to: 005d9a10 (UNCONDITIONAL_CALL)  ; void core_svetlana.cpp_CSvetlana_FUN_005d9a10(CSvetlana * this_ptr)
