...
section .text
    ...
    PUSH EBX                            ; 005d88e0
        ;   Label: core_svetlana.cpp_CSvetlana_setup_FUN_005d88e0
    PUSH ESI                            ; 005d88e1
    PUSH EDI                            ; 005d88e2
    PUSH EBP                            ; 005d88e3
    ...
    PUSH EBX                            ; 005d8941
    MOV [0x03f6cb90],EAX                ; 005d8942 | g_SvetlanaBoneIndices
    ...
    PUSH EBX                            ; 005d8956
    MOV [0x03f6cb94],EAX                ; 005d8957 | g_SvetlanaBoneIndices[1]
    ...
    PUSH EBX                            ; 005d896b
    MOV [0x03f6cb98],EAX                ; 005d896c | g_SvetlanaBoneIndices[2]
    ...
    PUSH EBX                            ; 005d8980
    MOV [0x03f6cb9c],EAX                ; 005d8981 | g_SvetlanaBoneIndices[3]
    ...
    PUSH EBX                            ; 005d8995
    MOV [0x03f6cba0],EAX                ; 005d8996 | g_SvetlanaBoneIndices[4]
    ...
    PUSH EBX                            ; 005d89aa
    MOV [0x03f6cba4],EAX                ; 005d89ab | g_SvetlanaBoneIndices[5]
    ...
    PUSH EBX                            ; 005d89bf
    MOV [0x03f6cba8],EAX                ; 005d89c0 | g_SvetlanaBoneIndices[6]
    ...
    PUSH EBX                            ; 005d89d4
    MOV [0x03f6cbac],EAX                ; 005d89d5 | g_SvetlanaBoneIndices[7]
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 005d89da
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 005d89df
    MOV [0x03f6cbb0],EAX                ; 005d89e2 | g_SvetlanaBoneIndices[8]
    PUSH 0x1                            ; 005d89e7
    ...
    PUSH EBX                            ; 005d89fe
    MOV [0x03f6cbb4],EAX                ; 005d89ff | g_SvetlanaBoneIndices[9]
    ...
    PUSH EBX                            ; 005d8a13
    MOV [0x03f6cbb8],EAX                ; 005d8a14 | g_SvetlanaBoneIndices[10]
    ...
    PUSH EBX                            ; 005d8a28
    MOV [0x03f6cbbc],EAX                ; 005d8a29 | g_SvetlanaBoneIndices[11]
    ...
    PUSH EBX                            ; 005d8a3d
    MOV [0x03f6cbc0],EAX                ; 005d8a3e | g_SvetlanaBoneIndices[12]
    ...
    PUSH EBX                            ; 005d8a52
    MOV [0x03f6cbc4],EAX                ; 005d8a53 | g_SvetlanaBoneIndices[13]
    ...
    PUSH EBX                            ; 005d8a67
    MOV [0x03f6cbc8],EAX                ; 005d8a68 | g_SvetlanaBoneIndices[14]
    ...
    PUSH EBX                            ; 005d8a7c
    MOV [0x03f6cbcc],EAX                ; 005d8a7d | g_SvetlanaBoneIndices[15]
    ...
    PUSH EBX                            ; 005d8a91
    MOV [0x03f6cbd0],EAX                ; 005d8a92 | g_SvetlanaBoneIndices[16]
    ...
    PUSH EBX                            ; 005d8aa6
    MOV [0x03f6cbd4],EAX                ; 005d8aa7 | g_SvetlanaBoneIndices[17]
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 005d8aac
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 005d8ab1
    MOV [0x03f6cbd8],EAX                ; 005d8ab4 | g_SvetlanaBoneIndices[18]
