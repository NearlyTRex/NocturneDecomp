...

{
  ...
  if (((this_ptr->base).base.hit_points < (float)100) &&
     (fVar4 = (this_ptr->base).base.hit_points + delta_time,
     (this_ptr->base).base.hit_points = fVar4, (float)100 < fVar4)) {
...
LAB_005d9032:
        ...
        pSVar9 = core_motion_cpp_CMotionController_getCurrentMotion_FUN_0052dab0
                           (&(this_ptr->base).base.model.motion_controller);
        if (iVar5 != pSVar9->state_index) goto LAB_005d8cdd;
      }
      break;
    case 9:
...
switchD_005d8f77_caseD_8:
  ...
  if ((this_ptr->base).base.grabbed_type == 0) {
    ...
    pCVar7 = core_vecdir_cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(&local_50,pCVar6);
  ...
  iVar5 = (*(pCVar2->_uc).attractActorToward)(this_ptr_00,(CDemonActor *)this_ptr,pCVar7);
  if (iVar5 == 0) {
  ...
  if (EVar7 == DEATH_STATE_ALIVE) {
    ...
    *puVar11 = *puVar10;
    ...
    core_skeleton_cpp_CDeformableModelInstance_blendBoneRotations_FUN_0059f750
              (this_ptr_01,&CStack_94,fVar13,iVar5,
