...

{
  ...
  float afStackY_1870 [1522];
  CDeformableModelInstance *in_stack_ffffff68;
...
switchD_005d8f77_caseD_8:
  ...
  if (pCVar1 == (CDemonActor *)0x0) {
    ...
    afStack_78[1] = local_44 + *(float *)((this_ptr->base_hero).base_character.field2_0x240c + 0x10)
    ;
    afStack_78[2] = local_40 + *(float *)((this_ptr->base_hero).base_character.field2_0x240c + 0x14)
    ;
    local_5c = local_5c + afStack_78[1];
    afStack_78[3] = local_3c + *(float *)((this_ptr->base_hero).base_character.field2_0x240c + 0x18)
    ;
    local_58 = local_58 + afStack_78[2];
    local_54 = local_54 + afStack_78[3];
    pSVar5 = core_motion_cpp_CMotionController_getCurrentMotion_FUN_0052dab0
                       (&(this_ptr->base_hero).base_character.model.motion_controller);
  ...
  if ((this_ptr->base_hero).base_character.grabbed_type == 0) {
    ...
    unaff_EBP = (CDeformableModelInstance *)
                core_actor_cpp_normalizeAngleToPi_FUN_0040cd70(pCVar6->y);
    in_stack_ffffff68 = unaff_EBP;
    if ((float)unaff_EBP < (float)-1.57079632675) {
      in_stack_ffffff68 = (CDeformableModelInstance *)((float)unaff_EBP + 3.141593f);
    }
    if ((float)1.57079632675 < (float)in_stack_ffffff68) {
      in_stack_ffffff68 = (CDeformableModelInstance *)((float)in_stack_ffffff68 + -3.141593f);
    }
...
LAB_005d8e27:
  ...
  iVar4 = (*(this_ptr->base_hero).base_character.base_actor.vtable[1].hasCollision)
                    ((CDemonActor *)this_ptr,(SCollisionInfo *)in_stack_ffffff68);
  if (iVar4 == 0) {
    core_xform_cpp_eulerToQuaternion_FUN_005f7b20
              ((CQuaternion4f *)(this_ptr->field1_0x1fbd4 + 0x7fcec),
               *(CVector3f **)(this_ptr->field1_0x1fbd4 + 0x7fcf8));
    *(float *)(&stack0xffffff70 + (uint)bVar10 * -8) = afStack_78[(uint)bVar10 * -2 + -1];
    *(float *)(&stack0xffffff74 + (uint)bVar10 * -8 + (uint)bVar10 * -8) =
         afStack_78[(uint)bVar10 * -2 + (uint)bVar10 * -2];
    *(float *)((int)(&stack0xffffff74 + (uint)bVar10 * -8 + (uint)bVar10 * -8) +
              ((uint)bVar10 * -2 + 1) * 4) =
         (afStack_78 + (uint)bVar10 * -2 + (uint)bVar10 * -2)[(uint)bVar10 * -2 + 1];
    core_skeleton_cpp_CDeformableModelInstance_blendBoneRotations_FUN_0059f750
              (unaff_EBP,&CStack_88,(float)in_stack_ffffff68,(int)CStack_88.y,in_stack_ffffff70);
  }
