...
section .text
    ...
    PUSH EBX                            ; 005d9a10
        ;   Label: core_svetlana.cpp_CSvetlana_performBladeAttack_FUN_005d9a10
    PUSH ESI                            ; 005d9a11
    PUSH EDI                            ; 005d9a12
    PUSH EBP                            ; 005d9a13
    ...
    CALL core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_005a0820 ; 005d9a2e
    ...
    JLE 0x005d9a65                      ; 005d9a49
        ;   XREF to: 005d9a65 (CONDITIONAL_JUMP)  ; LAB_005d9a65
    CMP EDI,dword ptr [ESI + 0x2857c]   ; 005d9a4b
        ;   Label: LAB_005d9a4b
    JZ 0x005d9ae2                       ; 005d9a51
        ;   XREF to: 005d9ae2 (CONDITIONAL_JUMP)  ; LAB_005d9ae2
    INC EBX                             ; 005d9a57
    MOV EDX,dword ptr [EAX + 0x28558]   ; 005d9a58
    ADD ESI,0x24                        ; 005d9a5e
    CMP EBX,EDX                         ; 005d9a61
    JL 0x005d9a4b                       ; 005d9a63
        ;   XREF to: 005d9a4b (CONDITIONAL_JUMP)  ; LAB_005d9a4b
    CMP dword ptr [ESP + 0x6c],-0x1     ; 005d9a65
        ;   Label: LAB_005d9a65
    JZ 0x005d9aeb                       ; 005d9a6a
        ;   XREF to: 005d9aeb (CONDITIONAL_JUMP)  ; LAB_005d9aeb
    PUSH EDI                            ; 005d9a70
        ;   Label: LAB_005d9a70
    ...
    PUSH EAX                            ; 005d9a8a
    PUSH EBP                            ; 005d9a8b
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 005d9a8c
    ...
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 005d9ab0
        ;   XREF to: 00408ec0 (UNCONDITIONAL_CALL)  ; CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
    ...
    MOV EBX,dword ptr [ESI + EAX*0x1 + 0x14f09c] ; 005d9ad1 | g_CDemonSetInstance.characters[0] | g_CDemonSetInstance.characters[1] | g_CDemonSetInstance.characters[2]
    ...
    JMP 0x005d9ac0                      ; 005d9ae0
        ;   XREF to: 005d9ac0 (UNCONDITIONAL_JUMP)  ; LAB_005d9ac0
    MOV dword ptr [ESP + 0x6c],EBX      ; 005d9ae2
        ;   Label: LAB_005d9ae2
    JMP 0x005d9a65                      ; 005d9ae6
        ;   XREF to: 005d9a65 (UNCONDITIONAL_JUMP)  ; LAB_005d9a65
    MOV ESI,0x654b0a                    ; 005d9aeb | = "..\\core\\svetlana.cpp"
        ;   Label: LAB_005d9aeb
    MOV EAX,0x2f0                       ; 005d9af0
    PUSH 0x654b1f                       ; 005d9af5 | = "Can't find svetlana's parent bone"
    MOV dword ptr [0x02f0ca48],ESI      ; 005d9afa | g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 005d9b00 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005d9b05
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ADD ESP,0x4                         ; 005d9b0a
    JMP 0x005d9a70                      ; 005d9b0d
        ;   XREF to: 005d9a70 (UNCONDITIONAL_JUMP)  ; LAB_005d9a70
    MOV EAX,ESP                         ; 005d9b12
        ;   Label: LAB_005d9b12
    PUSH EAX                            ; 005d9b14
    CALL core_charactr.cpp_SDamageInfo_ctor_FUN_00427db0 ; 005d9b15
    ...
    JZ 0x005d9adc                       ; 005d9b64
        ;   XREF to: 005d9adc (CONDITIONAL_JUMP)  ; LAB_005d9adc
    MOV dword ptr [ESP + 0x70],0x1      ; 005d9b6a
    INC EDI                             ; 005d9b72
    ADD ESI,0x4                         ; 005d9b73
    JMP 0x005d9ac0                      ; 005d9b76
        ;   XREF to: 005d9ac0 (UNCONDITIONAL_JUMP)  ; LAB_005d9ac0
    CMP dword ptr [ESP + 0x70],0x0      ; 005d9b7b
        ;   Label: LAB_005d9b7b
    JZ 0x005d9b9c                       ; 005d9b80
        ;   XREF to: 005d9b9c (CONDITIONAL_JUMP)  ; LAB_005d9b9c
    PUSH 0x654b41                       ; 005d9b82 | = "svetlana-attack?.wav"
    ...
    POP EBX                             ; 005d9b9a
    RET                                 ; 005d9b9b
    PUSH 0x654b56                       ; 005d9b9c | = "svetlana-miss?.wav"
        ;   Label: LAB_005d9b9c
    JMP 0x005d9b87                      ; 005d9ba1
        ;   XREF to: 005d9b87 (UNCONDITIONAL_JUMP)  ; LAB_005d9b87
