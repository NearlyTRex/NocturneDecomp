// Name: core_svetlana.cpp_CSvetlana_processAI_FUN_005d9260
// Address: 005d9260
// Address Range: [[005d9260, 005d9968]]
// Convention: __cdecl
// Signature: void __cdecl core_svetlana_cpp_CSvetlana_processAI_FUN_005d9260(CSvetlana *this_ptr,float delta_time)
  ...
  if ((this_ptr->base).ai_task != 0) {
    ...
    if ((float)6 <= fVar1) {
      ...
      if (pCStack_20 == (CPathMap *)0x0) {
        pCStack_20 = core_path_cpp_getPathMap_FUN_00548500(&(pCVar9->base).base.location);
      }
