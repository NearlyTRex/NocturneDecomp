...

{
  ...
  if (in_stack_00000004->ai_task != 0) {
    ...
    local_6c.x = (in_stack_00000004->base).base.location.position.x -
                 (pCVar5->base).base.location.position.x;
    local_6c.y = (in_stack_00000004->base).base.location.position.y -
                 (pCVar5->base).base.location.position.y;
    local_6c.z = (in_stack_00000004->base).base.location.position.z -
    ...
    if ((local_30 < local_28) &&
      ...
      fStack_3c = 9999.9;
      pCVar5 = (CHero *)core_hero_cpp_CHero_FUN_004f3960(in_stack_00000004);
    ...
    if ((float)6 <= fVar1) {
      ...
      if (bVar2) {
        (in_stack_00000004->base).field53_0x2dc4[0] = '\0';
        (in_stack_00000004->base).field53_0x2dc4[1] = '\0';
        (in_stack_00000004->base).field53_0x2dc4[2] = '\0';
        (in_stack_00000004->base).field53_0x2dc4[3] = '\0';
      }
      else {
        ...
        iVar4 = (*(((g_HeroActors[g_LocalHeroIndex]->base).base.vtable._ue)->_ue).enemyfunc3)();
        if ((iVar4 == 0) &&
           (uVar8 = core_charactr_cpp_CCharacter_FUN_0042ede0(&in_stack_00000004->base), uVar8 != 0)
           ) {
          if (uVar8 < 2) {
      ...
      iVar4 = core_path_cpp_CPathMap_findPathWithRetry_FUN_00547d00
                        (pCStack_20,&(in_stack_00000004->base).base.location.position,&CStack_48,
                         (in_stack_00000004->base).base.unk1);
      if (iVar4 != 0) {
        fStack_14 = core_actor_cpp_normalizeAngleToPi_FUN_0040cd70
                              (CStack_48.y - (in_stack_00000004->base).base.orient.bank);
        fVar3 = fStack_14 * (float)0.31830988619288902 * (float)4;
        fStack_38 = -(float)local_1c;
        *(float *)(in_stack_00000004->unk2 + 4) = fVar3;
        if (fVar3 < fStack_38) {
          *(float *)(in_stack_00000004->unk2 + 4) = fStack_38;
        }
        if ((float)local_1c < *(float *)(in_stack_00000004->unk2 + 4)) {
          *(CPathMap **)(in_stack_00000004->unk2 + 4) = local_1c;
        }
      ...
      if (bVar2) {
        ...
        pSVar7 = core_motion_cpp_CMotionController_getCurrentMotion_FUN_0052dab0
                           (&this_ptr->motion_controller);
        if ((pSVar7->state_index == 10) && (*(int *)in_stack_00000004[1].base.base.actor_name != 0))
        {
          (in_stack_00000004->action_bindings).draw_key = 1;
        }
        iVar4 = (*(((g_HeroActors[g_LocalHeroIndex]->base).base.vtable._ue)->_ue).enemyfunc3)();
      ...
      if (bVar2) {
        pCVar6 = core_vehicle_cpp_convertDirectionVectorToEulerAngles_FUN_005e7830
                           (&CStack_54,&local_6c);
        fStack_14 = core_actor_cpp_normalizeAngleToPi_FUN_0040cd70
                              (pCVar6->y - (in_stack_00000004->base).base.orient.bank);
        fVar1 = fStack_14 * (float)0.31830988619288902 * (float)4;
        fStack_34 = -(float)local_1c;
        *(float *)(in_stack_00000004->unk2 + 4) = fVar1;
        if (fVar1 < fStack_34) {
          *(float *)(in_stack_00000004->unk2 + 4) = fStack_34;
        }
        if ((float)local_1c < *(float *)(in_stack_00000004->unk2 + 4)) {
          *(CPathMap **)(in_stack_00000004->unk2 + 4) = local_1c;
        }
    ...
    fVar1 = (in_stack_00000004->base).turn_angle_accumulator;
    if (fVar1 <= 0.0) {
      if (fVar1 < 0.0) {
        (in_stack_00000004->base).turn_angle_accumulator = 0.0;
        *(float *)(in_stack_00000004->unk2 + 4) = -(float)local_1c;
      }
    }
    else {
      (in_stack_00000004->base).turn_angle_accumulator = 0.0;
    ...
    fStack_8c = core_actor_cpp_normalizeAngleToPi_FUN_0040cd70
                          (local_6c.y - (in_stack_00000004->base).base.orient.bank);
    ...
    fStack_98 = fStack_8c - in_stack_00000004[5].base.model.bone_transform.bone_rotations[0x59].y;
    ...
    in_stack_00000004[5].base.model.bone_transform.bone_rotations[0x59].y =
         in_stack_00000004[5].base.model.bone_transform.bone_rotations[0x59].y + fStack_98;
  }
  return;
}
