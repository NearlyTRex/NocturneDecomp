...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_dtri.cpp_rayTriangleFloorTest_FUN_0049b2f0(CDemonTriangle * triangle, float x, float z, float * out_height)
;
; Parameters:
...
section .text
    ...
    FCOMP double ptr [0x00622e1a]       ; 0049b305 | double g_MinFloorNormal
    FNSTSW AX                           ; 0049b30b
    SAHF                                ; 0049b30d
    JA 0x0049b554                       ; 0049b30e | LAB_0049b554
    ...
    FNSTSW AX                           ; 0049b36b
    SAHF                                ; 0049b36d
    JC 0x0049b55d                       ; 0049b36e | LAB_0049b55d
    ...
    FNSTSW AX                           ; 0049b37c
    SAHF                                ; 0049b37e
    JNC 0x0049b3e1                      ; 0049b37f | LAB_0049b3e1
    ...
    JZ 0x0049b3bd                       ; 0049b3a3 | LAB_0049b3bd
    ...
    JZ 0x0049b3e1                       ; 0049b3c7 | LAB_0049b3e1
        ;   XREF to: 0049b3e1 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0049b3e8
    SAHF                                ; 0049b3ea
    JA 0x0049b554                       ; 0049b3eb | LAB_0049b554
        ;   XREF to: 0049b554 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x40]          ; 0049b3f1
    FCOMP float ptr [ESP + 0x34]        ; 0049b3f5
    FNSTSW AX                           ; 0049b3f9
    SAHF                                ; 0049b3fb
    JNC 0x0049b45e                      ; 0049b3fc | LAB_0049b45e
    ...
    JZ 0x0049b43a                       ; 0049b420 | LAB_0049b43a
    ...
    JZ 0x0049b45e                       ; 0049b444 | LAB_0049b45e
        ;   XREF to: 0049b45e (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0049b467
    SAHF                                ; 0049b469
    JC 0x0049b554                       ; 0049b46a | LAB_0049b554
        ;   XREF to: 0049b554 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0049b487
    SAHF                                ; 0049b489
    JA 0x0049b5c6                       ; 0049b48a | LAB_0049b5c6
    ...
    PUSH EAX                            ; 0049b4a0
    CALL core_dtri.cpp_rayEdgeHeightTest_FUN_0049b180 ; 0049b4a1 | int core_dtri.cpp_rayEdgeHeightTest_FUN_0049b180(CVector3f * vertex1, CVector3f * vertex2, float rayRadius, float * outHeight)
    ...
    PUSH EAX                            ; 0049b4bb
    CALL core_dtri.cpp_rayEdgeHeightTest_FUN_0049b180 ; 0049b4bc | int core_dtri.cpp_rayEdgeHeightTest_FUN_0049b180(CVector3f * vertex1, CVector3f * vertex2, float rayRadius, float * outHeight)
        ;   XREF to: 0049b180 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0049b4d6
    CALL core_dtri.cpp_rayEdgeHeightTest_FUN_0049b180 ; 0049b4d7 | int core_dtri.cpp_rayEdgeHeightTest_FUN_0049b180(CVector3f * vertex1, CVector3f * vertex2, float rayRadius, float * outHeight)
        ;   XREF to: 0049b180 (UNCONDITIONAL_CALL)
    ...
    MOV AH,byte ptr [0x02cee5c8]        ; 0049b4ef | byte g_FloorCacheValid
    FSTP double ptr [ESP]               ; 0049b4f5
    TEST AH,0x1                         ; 0049b4f8
    JZ 0x0049b5db                       ; 0049b4fb | LAB_0049b5db
        ;   XREF to: 0049b5db (CONDITIONAL_JUMP)
    FLD double ptr [ESP]                ; 0049b501
        ;   Label: LAB_0049b501
    FCOMP double ptr [0x00622e22]       ; 0049b504 | double g_Epsilon
    FNSTSW AX                           ; 0049b50a
    SAHF                                ; 0049b50c
    JNC 0x0049b604                      ; 0049b50d | LAB_0049b604
        ;   XREF to: 0049b604 (CONDITIONAL_JUMP)
    TEST EDI,EDI                        ; 0049b513
    JNZ 0x0049b54b                      ; 0049b515 | LAB_0049b54b
        ;   XREF to: 0049b54b (CONDITIONAL_JUMP)
    PUSH 0x2cee5bc                      ; 0049b517 | CVector3f g_FloorRayDirection
    PUSH ESI                            ; 0049b51c
    PUSH EBX                            ; 0049b51d
    CALL core_dtri.cpp_rayTriangleIntersection_FUN_0049a800 ; 0049b51e | float core_dtri.cpp_rayTriangleIntersection_FUN_0049a800(CDemonTriangle * triangle, CVector3f * rayOrigin, CVector3f * rayDirection)
    ...
    FNSTSW AX                           ; 0049b538
    SAHF                                ; 0049b53a
    JA 0x0049b54b                       ; 0049b53b | LAB_0049b54b
        ;   XREF to: 0049b54b (CONDITIONAL_JUMP)
    ...
    JZ 0x0049b599                       ; 0049b57f | LAB_0049b599
    ...
    JZ 0x0049b374                       ; 0049b5a3 | LAB_0049b374
    ...
    JMP 0x0049b374                      ; 0049b5c1 | LAB_0049b374
    ...
    MOV byte ptr [0x02cee5c8],DL        ; 0049b5e5 | byte g_FloorCacheValid
    XOR EDX,EDX                         ; 0049b5eb
    MOV dword ptr [0x02cee5c0],ECX      ; 0049b5ed | g_FloorCacheHeight
    MOV dword ptr [0x02cee5bc],EDX      ; 0049b5f3 | CVector3f g_FloorRayDirection
    MOV dword ptr [0x02cee5c4],EDX      ; 0049b5f9 | g_FloorCacheReserved
    JMP 0x0049b501                      ; 0049b5ff | LAB_0049b501
    ...
    PUSH 0x2cee5bc                      ; 0049b624 | CVector3f g_FloorRayDirection
    MOV dword ptr [ESP + 0x2c],EAX      ; 0049b629
    LEA EAX,[ESP + 0x28]                ; 0049b62d
    PUSH EAX                            ; 0049b631
    PUSH EBX                            ; 0049b632
    CALL core_dtri.cpp_rayTriangleIntersection_FUN_0049a800 ; 0049b633 | float core_dtri.cpp_rayTriangleIntersection_FUN_0049a800(CDemonTriangle * triangle, CVector3f * rayOrigin, CVector3f * rayDirection)
        ;   XREF to: 0049a800 (UNCONDITIONAL_CALL)
    ...
    FNSTSW AX                           ; 0049b651
    SAHF                                ; 0049b653
    JA 0x0049b54b                       ; 0049b654 | LAB_0049b54b
        ;   XREF to: 0049b54b (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0049b671
    SAHF                                ; 0049b673
    JBE 0x0049b54b                      ; 0049b674 | LAB_0049b54b
        ;   XREF to: 0049b54b (CONDITIONAL_JUMP)
