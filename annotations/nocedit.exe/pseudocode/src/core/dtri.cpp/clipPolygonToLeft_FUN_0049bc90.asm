...
section .text
    ...
    MOV EBX,dword ptr [0x02cee8dc]      ; 0049bc9c | int g_ClipBuffer4VertexCount
    MOV EDX,dword ptr [EBP + 0x14]      ; 0049bca2
    MOV dword ptr [ESP],EDX             ; 0049bca5
    MOV EDX,dword ptr [0x02cee818]      ; 0049bca8 | int g_ClipBuffer3VertexCount
    XOR EDI,EDI                         ; 0049bcae
    TEST EDX,EDX                        ; 0049bcb0
    JLE 0x0049bd35                      ; 0049bcb2 | LAB_0049bd35
        ;   XREF to: 0049bd35 (CONDITIONAL_JUMP)
    MOV ESI,0x2cee81c                   ; 0049bcb8 | CVector3f[16] g_ClipBuffer3Vertices
    MOV EAX,[0x02cee818]                ; 0049bcbd | int g_ClipBuffer3VertexCount
        ;   Label: LAB_0049bcbd
    LEA ECX,[EDI + 0x1]                 ; 0049bcc2
    CMP ECX,EAX                         ; 0049bcc5
    JNZ 0x0049bccb                      ; 0049bcc7 | LAB_0049bccb
        ;   XREF to: 0049bccb (CONDITIONAL_JUMP)
    XOR ECX,EAX                         ; 0049bcc9
    IMUL ECX,ECX,0xc                    ; 0049bccb
        ;   Label: LAB_0049bccb
    MOV EAX,0x2cee81c                   ; 0049bcce | CVector3f[16] g_ClipBuffer3Vertices
    FLD float ptr [ESI]                 ; 0049bcd3 | CVector3f[16] g_ClipBuffer3Vertices
    ADD EAX,ECX                         ; 0049bcd5
    MOV EDX,ESI                         ; 0049bcd7 | CVector3f[16] g_ClipBuffer3Vertices
    MOV dword ptr [ESP + 0x4],EAX       ; 0049bcd9 | DAT_02cee834
    XOR ECX,ECX                         ; 0049bcdd
    FCOMP float ptr [ESP]               ; 0049bcdf
    FNSTSW AX                           ; 0049bce2
    SAHF                                ; 0049bce4
    JNC 0x0049bcec                      ; 0049bce5 | LAB_0049bcec
        ;   XREF to: 0049bcec (CONDITIONAL_JUMP)
    MOV ECX,0x1                         ; 0049bce7
    MOV EAX,dword ptr [ESP + 0x4]       ; 0049bcec
        ;   Label: LAB_0049bcec
    FLD float ptr [EAX]                 ; 0049bcf0 | CVector3f[16] g_ClipBuffer3Vertices
    FCOMP float ptr [ESP]               ; 0049bcf2
    FNSTSW AX                           ; 0049bcf5
    SAHF                                ; 0049bcf7
    JNC 0x0049bcfd                      ; 0049bcf8 | LAB_0049bcfd
        ;   XREF to: 0049bcfd (CONDITIONAL_JUMP)
    OR CL,0x2                           ; 0049bcfa
    CMP ECX,0x3                         ; 0049bcfd
        ;   Label: LAB_0049bcfd
    JA 0x0049bd27                       ; 0049bd00 | caseD_3
        ;   XREF to: 0049bd27 (CONDITIONAL_JUMP)
    JMP dword ptr [ECX*0x4 + 0x49bc7c]  ; 0049bd02 | pointer PTR_caseD_3_0049bc88 | PTR_caseD_1_0049bc80 = 0049bd42
        ;   Label: switchD
    IMUL ECX,EBX,0xc                    ; 0049bd09
        ;   Label: caseD_0
    ADD ECX,0x2cee8e0                   ; 0049bd0c | CVector3f[16] g_ClipBuffer4Vertices
    CMP ECX,EDX                         ; 0049bd12
    JZ 0x0049bd26                       ; 0049bd14 | LAB_0049bd26
        ;   XREF to: 0049bd26 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EDX]             ; 0049bd16 | CVector3f[16] g_ClipBuffer3Vertices
    MOV dword ptr [ECX],EAX             ; 0049bd18 | CVector3f[16] g_ClipBuffer4Vertices
    ...
    INC EBX                             ; 0049bd26
        ;   Label: LAB_0049bd26
    MOV ECX,dword ptr [0x02cee818]      ; 0049bd27 | int g_ClipBuffer3VertexCount
        ;   Label: caseD_3
    INC EDI                             ; 0049bd2d
    ADD ESI,0xc                         ; 0049bd2e
    CMP EDI,ECX                         ; 0049bd31
    JL 0x0049bcbd                       ; 0049bd33 | LAB_0049bcbd
        ;   XREF to: 0049bcbd (CONDITIONAL_JUMP)
    MOV dword ptr [0x02cee8dc],EBX      ; 0049bd35 | int g_ClipBuffer4VertexCount
        ;   Label: LAB_0049bd35
    ...
    PUSH 0x0                            ; 0049bd5b
    ADD ECX,0x2cee8e0                   ; 0049bd5d | CVector3f[16] g_ClipBuffer4Vertices
    PUSH ECX                            ; 0049bd63
    PUSH EDX                            ; 0049bd64 | CVector3f[16] g_ClipBuffer3Vertices
    MOV EAX,dword ptr [ESP + 0x2c]      ; 0049bd65
    PUSH EAX                            ; 0049bd69
    MOV dword ptr [0x02cee8dc],EBX      ; 0049bd6a | int g_ClipBuffer4VertexCount
    CALL core_dtri.cpp_clipLineToPlane_FUN_0049b6c0 ; 0049bd70 | void core_dtri.cpp_clipLineToPlane_FUN_0049b6c0(CVector3f * point1_ptr, CVector3f * point2_ptr, CVector3f * result_ptr, double plane_nx, ...)
        ;   XREF to: 0049b6c0 (UNCONDITIONAL_CALL)
    MOV EBX,dword ptr [0x02cee8dc]      ; 0049bd75 | int g_ClipBuffer4VertexCount
    ADD ESP,0x2c                        ; 0049bd7b
    JMP 0x0049bd26                      ; 0049bd7e | LAB_0049bd26
        ;   XREF to: 0049bd26 (UNCONDITIONAL_JUMP)
    IMUL ECX,EBX,0xc                    ; 0049bd80
        ;   Label: caseD_2
    ADD ECX,0x2cee8e0                   ; 0049bd83 | CVector3f[16] g_ClipBuffer4Vertices
    CMP ECX,EDX                         ; 0049bd89
    JZ 0x0049bd9d                       ; 0049bd8b | LAB_0049bd9d
        ;   XREF to: 0049bd9d (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EDX]             ; 0049bd8d | CVector3f[16] g_ClipBuffer3Vertices
    MOV dword ptr [ECX],EAX             ; 0049bd8f | CVector3f[16] g_ClipBuffer4Vertices
    ...
    PUSH 0x0                            ; 0049bdb7
    ADD ECX,0x2cee8e0                   ; 0049bdb9 | CVector3f[16] g_ClipBuffer4Vertices
    PUSH ECX                            ; 0049bdbf
    MOV ECX,dword ptr [ESP + 0x28]      ; 0049bdc0
    PUSH ECX                            ; 0049bdc4
    PUSH EDX                            ; 0049bdc5 | CVector3f[16] g_ClipBuffer3Vertices
    MOV dword ptr [0x02cee8dc],EBX      ; 0049bdc6 | int g_ClipBuffer4VertexCount
    CALL core_dtri.cpp_clipLineToPlane_FUN_0049b6c0 ; 0049bdcc | void core_dtri.cpp_clipLineToPlane_FUN_0049b6c0(CVector3f * point1_ptr, CVector3f * point2_ptr, CVector3f * result_ptr, double plane_nx, ...)
        ;   XREF to: 0049b6c0 (UNCONDITIONAL_CALL)
    MOV EBX,dword ptr [0x02cee8dc]      ; 0049bdd1 | int g_ClipBuffer4VertexCount
    ADD ESP,0x2c                        ; 0049bdd7
    JMP 0x0049bd26                      ; 0049bdda | LAB_0049bd26
        ;   XREF to: 0049bd26 (UNCONDITIONAL_JUMP)
