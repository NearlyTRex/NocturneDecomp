...

{
  ...
  if (0.0 <= (triangle->normal).y) {
    ...
    if (bVar13) {
      ...
      local_7c[9] = ((triangle->vertex2).z - (triangle->vertex1).z) * fVar5 + (triangle->vertex1).z;
    }
    uVar7 = (uint)bVar13;
    uVar8 = uVar7;
    if (((bVar6 ^ bVar7) & 1) != 0) {
    ...
    if (1 < uVar9) {
      ...
      cylinder->edge_z1 = local_7c[9];
      cylinder->edge_x2 = local_7c[1];
      cylinder->edge_z2 = local_7c[10];
  ...
  if ((triangle->normal).y <= 0.0) {
    ...
    if (bVar14) {
      ...
      local_7c[6] = ((triangle->vertex2).z - (triangle->vertex1).z) * fVar5 + (triangle->vertex1).z;
    }
    uVar10 = (uint)bVar14;
    uVar7 = uVar10;
    if (((bVar6 ^ bVar7) & 2) != 0) {
    ...
    if (1 < uVar10) {
      ...
      cylinder->edge_z1 = local_7c[6];
      cylinder->edge_x2 = local_7c[4];
      cylinder->edge_z2 = local_7c[7];
