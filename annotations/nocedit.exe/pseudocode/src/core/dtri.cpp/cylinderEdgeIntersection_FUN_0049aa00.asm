...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_dtri.cpp_cylinderEdgeIntersection_FUN_0049aa00(SIntersectXZCylinder * cylinder)
;
; Parameters:
...
section .text
    ...
    FNSTSW AX                           ; 0049aa43
    SAHF                                ; 0049aa45
    JNC 0x0049ac60                      ; 0049aa46 | LAB_0049ac60
    ...
    FNSTSW AX                           ; 0049aa8a
    SAHF                                ; 0049aa8c
    JC 0x0049ac67                       ; 0049aa8d | LAB_0049ac67
    ...
    FNSTSW AX                           ; 0049aaab
    SAHF                                ; 0049aaad
    JNC 0x0049ac60                      ; 0049aaae | LAB_0049ac60
        ;   XREF to: 0049ac60 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0049aadc
    SAHF                                ; 0049aade
    JA 0x0049ac60                       ; 0049aadf | LAB_0049ac60
        ;   XREF to: 0049ac60 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0049ab1f
    SAHF                                ; 0049ab21
    JA 0x0049ac60                       ; 0049ab22 | LAB_0049ac60
        ;   XREF to: 0049ac60 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0049ab36
    SAHF                                ; 0049ab38
    JNC 0x0049ac60                      ; 0049ab39 | LAB_0049ac60
        ;   XREF to: 0049ac60 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0049ab6d
    SAHF                                ; 0049ab6f
    JNC 0x0049ac82                      ; 0049ab70 | LAB_0049ac82
    ...
    FNSTSW AX                           ; 0049ab90
    SAHF                                ; 0049ab92
    JBE 0x0049ac91                      ; 0049ab93 | LAB_0049ac91
    ...
    FMUL float ptr [0x00622dfe]         ; 0049abe2 | float g_CylinderScale1
    FXCH ST4                            ; 0049abe8
    ...
    FMUL ST0                            ; 0049abf1
    FXCH                                ; 0049abf3
    FMUL float ptr [0x00622dfa]         ; 0049abf5 | float g_CylinderScale2
    FXCH                                ; 0049abfb
    ...
    FNSTSW AX                           ; 0049ac1b
    SAHF                                ; 0049ac1d
    JA 0x0049ac60                       ; 0049ac1e | LAB_0049ac60
        ;   XREF to: 0049ac60 (CONDITIONAL_JUMP)
    ...
    FMUL float ptr [0x00622e02]         ; 0049ac32 | float g_CylinderInvScale
    FDIVP                               ; 0049ac38
    FLDZ                                ; 0049ac3a
    FXCH                                ; 0049ac3c
    ...
    FNSTSW AX                           ; 0049ac47
    SAHF                                ; 0049ac49
    JA 0x0049ac60                       ; 0049ac4a | LAB_0049ac60
        ;   XREF to: 0049ac60 (CONDITIONAL_JUMP)
    FLD1                                ; 0049ac4c
    FCOMP double ptr [ESP]              ; 0049ac4e
    FNSTSW AX                           ; 0049ac51
    SAHF                                ; 0049ac53
    JC 0x0049ac60                       ; 0049ac54 | LAB_0049ac60
        ;   XREF to: 0049ac60 (CONDITIONAL_JUMP)
    FLD float ptr [EDX + 0x4c]          ; 0049ac56
    FCOMP float ptr [EDX]               ; 0049ac59
    FNSTSW AX                           ; 0049ac5b
    SAHF                                ; 0049ac5d
    JC 0x0049acc8                       ; 0049ac5e | LAB_0049acc8
    ...
    JMP 0x0049aa93                      ; 0049ac7d | LAB_0049aa93
    ...
    JMP 0x0049ab80                      ; 0049ac8c | LAB_0049ab80
    ...
    FNSTSW AX                           ; 0049ac97
    SAHF                                ; 0049ac99
    JNC 0x0049acae                      ; 0049ac9a | LAB_0049acae
    ...
    JMP 0x0049aba6                      ; 0049aca9 | LAB_0049aba6
    ...
    FNSTSW AX                           ; 0049acb6
    SAHF                                ; 0049acb8
    JBE 0x0049acc1                      ; 0049acb9 | LAB_0049acc1
