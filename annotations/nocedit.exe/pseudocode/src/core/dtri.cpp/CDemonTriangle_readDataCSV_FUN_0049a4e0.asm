...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dtri.cpp_CDemonTriangle_readDataCSV_FUN_0049a4e0(CDemonTriangle * this_ptr, FILE * file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 0049a504
    PUSH EBX                            ; 0049a505
    PUSH 0x622dc2                       ; 0049a506 | = "%f,%f,%f,%f,%f,%f,%f,%f,%f\n" | s_f_f_f_f_f_f_f_f_f_00622dc2 = %f,%f,%f,%f,%f,%f,%f,%f,%f

    MOV EDX,dword ptr [ESP + 0x34]      ; 0049a50b
    PUSH EDX                            ; 0049a50f
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0049a510 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x2c                        ; 0049a515
    PUSH EBX                            ; 0049a518
    CALL core_dtri.cpp_CDemonTriangle_calculateData_FUN_0049a640 ; 0049a519 | void core_dtri.cpp_CDemonTriangle_calculateData_FUN_0049a640(CDemonTriangle * triangle)
