...
section .text
    ...
    PUSH 0x662110                       ; 00548c30 | WatcomTypeInfo g_CPathMapTypeInfo
        ;   Label: core_path.cpp_freePathMaps_FUN_00548c30
    PUSH 0xc                            ; 00548c35
    MOV EDX,dword ptr [ESP + 0xc]       ; 00548c37
    PUSH EDX                            ; 00548c3b
    CALL crt_memory.c_freeTypeArray_FUN_005feee9 ; 00548c3c | int crt_memory.c_freeTypeArray_FUN_005feee9(void * * obj_array, int obj_count, WatcomTypeInfo * type_info)
