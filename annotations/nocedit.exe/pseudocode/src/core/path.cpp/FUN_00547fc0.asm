...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_path.cpp_FUN_00547fc0()
;
; Local Variables:
...
;
; XREF[3]:
;   core_path.cpp_FUN_005485f0 at 0054866a
;   core_path.cpp_FUN_00548680 at 0054873b
;   core_waypoint.cpp_CWaypoint_FUN_005ebf70 at 005ec138
;
; Referenced Globals:
...
section .text
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 00547fcc | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH EDX                            ; 00547fd2 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_getFaceCount_FUN_0048cae0 ; 00547fd3 | int engine_drender.cpp_CDemonRenderer_getFaceCount_FUN_0048cae0(CDemonRenderer * this_ptr)
        ;   XREF to: 0048cae0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00547fd8
    TEST EAX,EAX                        ; 00547fdb
    JZ 0x00547fe6                       ; 00547fdd | LAB_00547fe6
    ...
    MOV EBX,dword ptr [0x006703ec]      ; 0054800f | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH EAX                            ; 00548015
    FADD float ptr [0x03277d2c]         ; 00548016 | g_CDemonRaytraceInstance.bbox_min.z
    PUSH EBX                            ; 0054801c | CDemonRenderer g_CDemonRendererInstance
    FSTP float ptr [ESP + 0x1c]         ; 0054801d
    CALL engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450 ; 00548021 | void engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450(CDemonRenderer * this_ptr, CVector3f * world_position)
        ;   XREF to: 0048c450 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00548026
    PUSH 0x680bb0                       ; 00548029 | SMRGLTextureBasic DAT_00680bb0
    MOV ESI,dword ptr [0x006703ec]      ; 0054802e | CDemonRenderer * g_CDemonRendererPtr
    PUSH ESI                            ; 00548034 | CDemonRenderer g_CDemonRendererInstance
    MOV EDI,0x4                         ; 00548035
    CALL engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80 ; 0054803a | void engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80(CDemonRenderer * this_ptr, SMRGLTextureBasic * texture)
        ;   XREF to: 0048db80 (UNCONDITIONAL_CALL)
    MOV EDX,0x1                         ; 0054803f
    MOV ESI,0x2                         ; 00548044
    ADD ESP,0x8                         ; 00548049
    MOV dword ptr [0x030d4fd4],EDI      ; 0054804c | DAT_030d4fd0.base.count
    XOR EAX,EAX                         ; 00548052
    MOV EDI,0x800000                    ; 00548054 | DAT_00800000
    MOV [0x030d4fd8],EAX                ; 00548059 | DAT_030d4fd0.surface_normal.A
    ...
    MOV ESI,dword ptr [0x006703ec]      ; 00548084 | CDemonRenderer * g_CDemonRendererPtr
    ...
    PUSH ESI                            ; 005480b4 | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [0x030d5014],EDI      ; 005480b5 | DAT_030d5014
    MOV dword ptr [0x030d500c],EDX      ; 005480bb | DAT_030d500c
    CALL engine_drender.cpp_CDemonRenderer_setPlaneCullingEnabled_FUN_0048c9f0 ; 005480c1 | void engine_drender.cpp_CDemonRenderer_setPlaneCullingEnabled_FUN_0048c9f0(CDemonRenderer * this_ptr, int enabled)
    ...
    JGE 0x0054816d                      ; 0054811e | LAB_0054816d
    ...
    JL 0x0054810e                       ; 0054813a | LAB_0054810e
    ...
    JL 0x005480fb                       ; 00548153 | LAB_005480fb
        ;   XREF to: 005480fb (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 00548155
    MOV EDI,dword ptr [0x006703ec]      ; 00548157 | CDemonRenderer * g_CDemonRendererPtr
    PUSH EDI                            ; 0054815d | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_setPlaneCullingEnabled_FUN_0048c9f0 ; 0054815e | void engine_drender.cpp_CDemonRenderer_setPlaneCullingEnabled_FUN_0048c9f0(CDemonRenderer * this_ptr, int enabled)
        ;   XREF to: 0048c9f0 (UNCONDITIONAL_CALL)
    ...
    CMP EBX,0x3e7                       ; 0054816d
        ;   Label: LAB_0054816d
    JG 0x00548120                       ; 00548173 | LAB_00548120
        ;   XREF to: 00548120 (CONDITIONAL_JUMP)
    FLD float ptr [0x0063ea38]          ; 00548175 | float FLOAT_0063ea38
    ...
    FLD double ptr [0x0063ea40]         ; 005481a8 | double DOUBLE_0063ea40
    FXCH                                ; 005481ae
    FMUL ST1                            ; 005481b0
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 005481f7 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    FXCH ST2                            ; 005481fd
    CALL crt_math.c_round_FUN_005fe6b0  ; 005481ff | double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    PUSH EAX                            ; 0054820d
    CALL crt_math.c_round_FUN_005fe6b0  ; 0054820e | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH ST2                            ; 00548213
    FADDP                               ; 00548215
    FXCH                                ; 00548217
    FISTP dword ptr [ESP + 0xc]         ; 00548219
    CALL crt_math.c_round_FUN_005fe6b0  ; 0054821d | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x8]         ; 00548222
    MOV EAX,dword ptr [EDX]             ; 00548226 | CDemonRenderer g_CDemonRendererInstance
    PUSH EAX                            ; 00548228
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 00548229 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0054822e
    MOV EAX,dword ptr [ESP]             ; 00548231
    MOV dword ptr [ESP + 0x5c],EAX      ; 00548234
    MOV EDX,dword ptr [0x006703ec]      ; 00548238 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    ...
    PUSH EAX                            ; 0054824a
    FSTP ST1                            ; 0054824b
    CALL crt_math.c_round_FUN_005fe6b0  ; 0054824d | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x4]         ; 00548252
    MOV EAX,dword ptr [EDX]             ; 00548256 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0x30                        ; 00548258
    PUSH EAX                            ; 0054825b
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 0054825c | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00548261
    MOV EAX,dword ptr [ESP + 0x8]       ; 00548264
    MOV dword ptr [ESP + 0x5c],EAX      ; 00548268
    MOV EDX,dword ptr [0x006703ec]      ; 0054826c | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    ...
    PUSH EAX                            ; 0054827e
    FSTP ST1                            ; 0054827f
    CALL crt_math.c_round_FUN_005fe6b0  ; 00548281 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0xc]         ; 00548286
    MOV EAX,dword ptr [EDX]             ; 0054828a | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0x60                        ; 0054828c
    PUSH EAX                            ; 0054828f
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 00548290 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ...
    MOV EAX,[0x006703ec]                ; 005482ab | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    FSTP ST1                            ; 005482b0
    CALL crt_math.c_round_FUN_005fe6b0  ; 005482b2 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP]               ; 005482b7
    MOV EAX,dword ptr [EAX]             ; 005482ba | CDemonRenderer g_CDemonRendererInstance
    PUSH EDX                            ; 005482bc
    ADD EAX,0x90                        ; 005482bd
    PUSH EAX                            ; 005482c2
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 005482c3 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005482c8
    MOV EAX,[0x006703ec]                ; 005482cb | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    MOV EDX,dword ptr [EAX]             ; 005482d0 | CDemonRenderer g_CDemonRendererInstance
    MOV ECX,dword ptr [ESP + 0x50]      ; 005482d2
    MOV dword ptr [EDX + 0x20],ECX      ; 005482d6
    MOV EDX,dword ptr [EAX]             ; 005482d9 | CDemonRenderer g_CDemonRendererInstance
    MOV ECX,dword ptr [ESP + 0x48]      ; 005482db
    MOV dword ptr [EDX + 0x24],ECX      ; 005482df
    MOV EDX,dword ptr [EAX]             ; 005482e2 | CDemonRenderer g_CDemonRendererInstance
    MOV ECX,dword ptr [ESP + 0x4c]      ; 005482e4
    MOV dword ptr [EDX + 0x28],ECX      ; 005482e8
    MOV EDX,dword ptr [EAX]             ; 005482eb | CDemonRenderer g_CDemonRendererInstance
    MOV ECX,dword ptr [ESP + 0x54]      ; 005482ed
    MOV dword ptr [EDX + 0x2c],ECX      ; 005482f1
    MOV EDX,dword ptr [EAX]             ; 005482f4 | CDemonRenderer g_CDemonRendererInstance
    MOV ECX,dword ptr [ESP + 0x50]      ; 005482f6
    MOV dword ptr [EDX + 0x50],ECX      ; 005482fa
    MOV EDX,dword ptr [EAX]             ; 005482fd | CDemonRenderer g_CDemonRendererInstance
    MOV ECX,dword ptr [ESP + 0x48]      ; 005482ff
    MOV dword ptr [EDX + 0x54],ECX      ; 00548303
    MOV EDX,dword ptr [EAX]             ; 00548306 | CDemonRenderer g_CDemonRendererInstance
    MOV ECX,dword ptr [ESP + 0x4c]      ; 00548308
    MOV dword ptr [EDX + 0x58],ECX      ; 0054830c
    MOV EDX,dword ptr [EAX]             ; 0054830f | CDemonRenderer g_CDemonRendererInstance
    MOV ECX,dword ptr [ESP + 0x54]      ; 00548311
    MOV dword ptr [EDX + 0x5c],ECX      ; 00548315
    MOV EDX,dword ptr [EAX]             ; 00548318 | CDemonRenderer g_CDemonRendererInstance
    MOV ECX,dword ptr [ESP + 0x50]      ; 0054831a
    MOV dword ptr [EDX + 0x80],ECX      ; 0054831e
    MOV EDX,dword ptr [EAX]             ; 00548324 | CDemonRenderer g_CDemonRendererInstance
    MOV ECX,dword ptr [ESP + 0x48]      ; 00548326
    MOV dword ptr [EDX + 0x84],ECX      ; 0054832a
    MOV EDX,dword ptr [EAX]             ; 00548330 | CDemonRenderer g_CDemonRendererInstance
    MOV ECX,dword ptr [ESP + 0x4c]      ; 00548332
    MOV dword ptr [EDX + 0x88],ECX      ; 00548336
    MOV EDX,dword ptr [EAX]             ; 0054833c | CDemonRenderer g_CDemonRendererInstance
    MOV ECX,dword ptr [ESP + 0x54]      ; 0054833e
    MOV dword ptr [EDX + 0x8c],ECX      ; 00548342
    MOV EDX,dword ptr [EAX]             ; 00548348 | CDemonRenderer g_CDemonRendererInstance
    MOV ECX,dword ptr [ESP + 0x50]      ; 0054834a
    MOV dword ptr [EDX + 0xb0],ECX      ; 0054834e
    MOV EDX,dword ptr [EAX]             ; 00548354 | CDemonRenderer g_CDemonRendererInstance
    MOV ECX,dword ptr [ESP + 0x48]      ; 00548356
    MOV dword ptr [EDX + 0xb4],ECX      ; 0054835a
    MOV EDX,dword ptr [EAX]             ; 00548360 | CDemonRenderer g_CDemonRendererInstance
    MOV ECX,dword ptr [ESP + 0x4c]      ; 00548362
    MOV dword ptr [EDX + 0xb8],ECX      ; 00548366
    PUSH 0x30d4fd0                      ; 0054836c | SMRGLHeaderPrimitive DAT_030d4fd0
    MOV EDX,dword ptr [EAX]             ; 00548371 | CDemonRenderer g_CDemonRendererInstance
    MOV ECX,dword ptr [ESP + 0x58]      ; 00548373
    PUSH EAX                            ; 00548377 | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EDX + 0xbc],ECX      ; 00548378
    CALL engine_drender.cpp_CDemonRenderer_renderMaximumQualityVariant_FUN_0048bba0 ; 0054837e | void engine_drender.cpp_CDemonRenderer_renderMaximumQualityVariant_FUN_0048bba0(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * polygon_info)
        ;   XREF to: 0048bba0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00548383
    JMP 0x00548120                      ; 00548386 | LAB_00548120
