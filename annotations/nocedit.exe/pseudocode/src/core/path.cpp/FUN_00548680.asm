...
section .text
    ...
    PUSH EDX                            ; 0054868f
    PUSH 0x3277d14                      ; 00548690 | CDemonRaytrace g_CDemonRaytraceInstance
    LEA ESI,[ESP + 0x14]                ; 00548695
    LEA EDI,[ESP + 0x8]                 ; 00548699
    CALL core_dtrace.cpp_CDemonRaytrace_worldPositionToVoxelCoords_FUN_00499880 ; 0054869d | void core_dtrace.cpp_CDemonRaytrace_worldPositionToVoxelCoords_FUN_00499880(CDemonRaytrace * this_ptr, CVector3f * world_position, CVector3i * output_voxel_coords)
    ...
    MOV ECX,dword ptr [0x030c3ab8]      ; 005486ac | int g_PathMapCount
    XOR ESI,ESI                         ; 005486b2
    TEST ECX,ECX                        ; 005486b4
    JLE 0x005486e3                      ; 005486b6 | LAB_005486e3
        ;   XREF to: 005486e3 (CONDITIONAL_JUMP)
    XOR EBX,EBX                         ; 005486b8
    CMP dword ptr [EBX + 0x30c3abc],0x0 ; 005486ba | CPathMap *[200] g_PathMapList
        ;   Label: LAB_005486ba
    JZ 0x005486eb                       ; 005486c1 | LAB_005486eb
        ;   XREF to: 005486eb (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [EBX + 0x30c3abc] ; 005486c3 | CPathMap *[200] g_PathMapList
        ;   Label: LAB_005486c3
    CMP dword ptr [EDX + 0x138c0],0x461c3c00 ; 005486c9
    JLE 0x00548710                      ; 005486d3 | LAB_00548710
        ;   XREF to: 00548710 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [0x030c3ab8]      ; 005486d5 | int g_PathMapCount
        ;   Label: LAB_005486d5
    INC ESI                             ; 005486db
    ADD EBX,0x4                         ; 005486dc
    CMP ESI,EDI                         ; 005486df
    JL 0x005486ba                       ; 005486e1 | LAB_005486ba
    ...
    POP EBX                             ; 005486e9
    RET                                 ; 005486ea
    MOV EDX,0x63eaa8                    ; 005486eb | = "..\\core\\path.cpp" | s_core_path_cpp_0063eaa8 = ..\core\path.cpp
        ;   Label: LAB_005486eb
    MOV ECX,0x6b5                       ; 005486f0
    PUSH 0x63eab9                       ; 005486f5 | = "Global pathmap list corruption" | s_Global_pathmap_list_corr_0063eab9 = Global pathmap list corruption
    MOV dword ptr [0x02f0ca48],EDX      ; 005486fa | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 00548700 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00548706 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0054870b
    JMP 0x005486c3                      ; 0054870e | LAB_005486c3
        ;   XREF to: 005486c3 (UNCONDITIONAL_JUMP)
    MOV ECX,dword ptr [ESP]             ; 00548710
        ;   Label: LAB_00548710
    CMP ECX,dword ptr [EDX + 0xc]       ; 00548713
    JNZ 0x005486d5                      ; 00548716 | LAB_005486d5
        ;   XREF to: 005486d5 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [ESP + 0x4]       ; 00548718
    CMP EDI,dword ptr [EDX + 0x10]      ; 0054871c
    JNZ 0x005486d5                      ; 0054871f | LAB_005486d5
        ;   XREF to: 005486d5 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [ESP + 0x8]       ; 00548721
    CMP ECX,dword ptr [EDX + 0x14]      ; 00548725
    JNZ 0x005486d5                      ; 00548728 | LAB_005486d5
        ;   XREF to: 005486d5 (CONDITIONAL_JUMP)
    ...
    PUSH ECX                            ; 00548739
    PUSH EDX                            ; 0054873a
    CALL core_path.cpp_FUN_00547fc0     ; 0054873b | undefined core_path.cpp_FUN_00547fc0()
        ;   XREF to: 00547fc0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 00548740
    JMP 0x005486d5                      ; 00548743 | LAB_005486d5
