...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_path.cpp_CPathMap_previewPathfinding_FUN_00547c00(CPathMap * this_ptr)
;
; Parameters:
...
section .text
    ...
    XOR EAX,EAX                         ; 00547c38
        ;   Label: LAB_00547c38
    MOV AL,byte ptr [EDI + 0x30d2858]   ; 00547c3a | char[101][100] g_PathfindingVisited
    MOV EDX,dword ptr [EAX*0x4 + 0x680c50] ; 00547c40 | char *[9] g_DirectionCharacters
    PUSH EDX                            ; 00547c47
    PUSH 0x63ea24                       ; 00547c48 | = "%s" | s_s_0063ea24 = %s
    LEA EAX,[ESP + 0x8]                 ; 00547c4d
    PUSH EAX                            ; 00547c51
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 00547c52 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [0x030c3ddc]      ; 00547c57 | int g_PathfindingCurrentX
    ADD ESP,0xc                         ; 00547c5d
    CMP EBX,ECX                         ; 00547c60
    JNZ 0x00547c70                      ; 00547c62 | LAB_00547c70
        ;   XREF to: 00547c70 (CONDITIONAL_JUMP)
    CMP EBP,dword ptr [0x030c3de0]      ; 00547c64 | int g_PathfindingCurrentZ
    JNZ 0x00547c70                      ; 00547c6a | LAB_00547c70
        ;   XREF to: 00547c70 (CONDITIONAL_JUMP)
    MOV byte ptr [ESP],0x73             ; 00547c6c
    CMP EBX,dword ptr [0x030c3de4]      ; 00547c70 | int g_PathfindingDestX
        ;   Label: LAB_00547c70
    JNZ 0x00547c84                      ; 00547c76 | LAB_00547c84
        ;   XREF to: 00547c84 (CONDITIONAL_JUMP)
    CMP EBP,dword ptr [0x030c3de8]      ; 00547c78 | int g_PathfindingDestZ
    JNZ 0x00547c84                      ; 00547c7e | LAB_00547c84
        ;   XREF to: 00547c84 (CONDITIONAL_JUMP)
    MOV byte ptr [ESP],0x64             ; 00547c80
    MOV EAX,dword ptr [ESP + 0x100]     ; 00547c84
        ;   Label: LAB_00547c84
    PUSH EAX                            ; 00547c8b
    MOV EAX,[0x00679394]                ; 00547c8c | int g_WindowWidth
    ...
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 00547ca7 | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00547cac
    CMP EBX,0x64                        ; 00547caf
    JL 0x00547c38                       ; 00547cb2 | LAB_00547c38
    ...
    JL 0x00547c1f                       ; 00547cda | LAB_00547c1f
