...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_path.cpp_CPathMap_checkAxisAlignedPath_FUN_00546e90(CPathMap * this_ptr, int start_x, int start_z, int start_height, int end_x, int end_z)
;
; Parameters:
...
section .text
    ...
    PUSH ECX                            ; 00546efd
    PUSH EBX                            ; 00546efe
    CALL core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0 ; 00546eff | int core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0(CPathMap * this_ptr, int grid_z, int grid_x, int current_height)
        ;   XREF to: 00546ba0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00546f04
    MOV ESI,EAX                         ; 00546f07
    CMP dword ptr [ESP + 0x40],0x0      ; 00546f09
    JLE 0x00546f51                      ; 00546f0e | LAB_00546f51
    ...
    CALL core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0 ; 00546f34 | int core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0(CPathMap * this_ptr, int grid_z, int grid_x, int current_height)
        ;   XREF to: 00546ba0 (UNCONDITIONAL_CALL)
    ...
    CMP EAX,dword ptr [0x030c3ab4]      ; 00546f45 | int g_PathfindingMaxClimbHeight
    JLE 0x0054700a                      ; 00546f4b | LAB_0054700a
        ;   XREF to: 0054700a (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x40],0x0      ; 00546f51
        ;   Label: LAB_00546f51
    JZ 0x00547080                       ; 00546f56 | LAB_00547080
    ...
    CALL core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0 ; 00546f8a | int core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0(CPathMap * this_ptr, int grid_z, int grid_x, int current_height)
        ;   XREF to: 00546ba0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00546f8f
    MOV ESI,EAX                         ; 00546f92
    CMP dword ptr [ESP],0x0             ; 00546f94
    JLE 0x00546fdb                      ; 00546f98 | LAB_00546fdb
    ...
    CALL core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0 ; 00546fbe | int core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0(CPathMap * this_ptr, int grid_z, int grid_x, int current_height)
        ;   XREF to: 00546ba0 (UNCONDITIONAL_CALL)
    ...
    CMP EAX,dword ptr [0x030c3ab4]      ; 00546fcf | int g_PathfindingMaxClimbHeight
    JLE 0x0054717e                      ; 00546fd5 | LAB_0054717e
        ;   XREF to: 0054717e (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x38],0x0      ; 00546fdb
        ;   Label: LAB_00546fdb
    JZ 0x005471f4                       ; 00546fe0 | LAB_005471f4
    ...
    PUSH ECX                            ; 00547010
    PUSH EBX                            ; 00547011
    CALL core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0 ; 00547012 | int core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0(CPathMap * this_ptr, int grid_z, int grid_x, int current_height)
        ;   XREF to: 00546ba0 (UNCONDITIONAL_CALL)
    ...
    CMP EAX,dword ptr [0x030c3ab4]      ; 00547023 | int g_PathfindingMaxClimbHeight
    JG 0x00546f51                       ; 00547029 | LAB_00546f51
        ;   XREF to: 00546f51 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 0054702f
    PUSH EBP                            ; 00547030
    ...
    PUSH ECX                            ; 00547035
    PUSH EBX                            ; 00547036
    CALL core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0 ; 00547037 | int core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0(CPathMap * this_ptr, int grid_z, int grid_x, int current_height)
        ;   XREF to: 00546ba0 (UNCONDITIONAL_CALL)
    ...
    CMP EAX,dword ptr [0x030c3ab4]      ; 00547048 | int g_PathfindingMaxClimbHeight
    JG 0x00546f51                       ; 0054704e | LAB_00546f51
        ;   XREF to: 00546f51 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 00547054
    ...
    PUSH ECX                            ; 0054705e
    PUSH EBX                            ; 0054705f
    CALL core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0 ; 00547060 | int core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0(CPathMap * this_ptr, int grid_z, int grid_x, int current_height)
        ;   XREF to: 00546ba0 (UNCONDITIONAL_CALL)
    ...
    JG 0x00546f22                       ; 00547075 | LAB_00546f22
        ;   XREF to: 00546f22 (CONDITIONAL_JUMP)
    JMP 0x00546f51                      ; 0054707b | LAB_00546f51
    ...
    JLE 0x005470ca                      ; 0054708f | LAB_005470ca
    ...
    CALL core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0 ; 005470b1 | int core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0(CPathMap * this_ptr, int grid_z, int grid_x, int current_height)
        ;   XREF to: 00546ba0 (UNCONDITIONAL_CALL)
    ...
    CMP EAX,dword ptr [0x030c3ab4]      ; 005470c2 | int g_PathfindingMaxClimbHeight
    JLE 0x00547104                      ; 005470c8 | LAB_00547104
        ;   XREF to: 00547104 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x3c],0x0      ; 005470ca
        ;   Label: LAB_005470ca
    JNZ 0x00546f5c                      ; 005470cf | LAB_00546f5c
    ...
    PUSH EAX                            ; 005470e5
    PUSH EBX                            ; 005470e6
    CALL core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0 ; 005470e7 | int core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0(CPathMap * this_ptr, int grid_z, int grid_x, int current_height)
        ;   XREF to: 00546ba0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 005470ec
    CMP EDI,EAX                         ; 005470ef
    JNZ 0x00546f5c                      ; 005470f1 | LAB_00546f5c
        ;   XREF to: 00546f5c (CONDITIONAL_JUMP)
    ...
    PUSH EDI                            ; 0054710e
    PUSH EBX                            ; 0054710f
    CALL core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0 ; 00547110 | int core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0(CPathMap * this_ptr, int grid_z, int grid_x, int current_height)
        ;   XREF to: 00546ba0 (UNCONDITIONAL_CALL)
    ...
    CMP EAX,dword ptr [0x030c3ab4]      ; 00547121 | int g_PathfindingMaxClimbHeight
    JG 0x005470ca                       ; 00547127 | LAB_005470ca
        ;   XREF to: 005470ca (CONDITIONAL_JUMP)
    PUSH ESI                            ; 00547129
    ...
    PUSH EDI                            ; 00547133
    PUSH EBX                            ; 00547134
    CALL core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0 ; 00547135 | int core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0(CPathMap * this_ptr, int grid_z, int grid_x, int current_height)
        ;   XREF to: 00546ba0 (UNCONDITIONAL_CALL)
    ...
    CMP EAX,dword ptr [0x030c3ab4]      ; 00547146 | int g_PathfindingMaxClimbHeight
    JG 0x005470ca                       ; 0054714c | LAB_005470ca
        ;   XREF to: 005470ca (CONDITIONAL_JUMP)
    PUSH ESI                            ; 00547152
    PUSH EBP                            ; 00547153
    ...
    CALL core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0 ; 0054715e | int core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0(CPathMap * this_ptr, int grid_z, int grid_x, int current_height)
        ;   XREF to: 00546ba0 (UNCONDITIONAL_CALL)
    ...
    JG 0x0054709f                       ; 00547173 | LAB_0054709f
        ;   XREF to: 0054709f (CONDITIONAL_JUMP)
    JMP 0x005470ca                      ; 00547179 | LAB_005470ca
    ...
    PUSH EBP                            ; 00547184
    PUSH EBX                            ; 00547185
    CALL core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0 ; 00547186 | int core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0(CPathMap * this_ptr, int grid_z, int grid_x, int current_height)
        ;   XREF to: 00546ba0 (UNCONDITIONAL_CALL)
    ...
    CMP EAX,dword ptr [0x030c3ab4]      ; 00547197 | int g_PathfindingMaxClimbHeight
    JG 0x00546fdb                       ; 0054719d | LAB_00546fdb
        ;   XREF to: 00546fdb (CONDITIONAL_JUMP)
    PUSH ESI                            ; 005471a3
    ...
    PUSH EBP                            ; 005471a9
    PUSH EBX                            ; 005471aa
    CALL core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0 ; 005471ab | int core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0(CPathMap * this_ptr, int grid_z, int grid_x, int current_height)
        ;   XREF to: 00546ba0 (UNCONDITIONAL_CALL)
    ...
    CMP EAX,dword ptr [0x030c3ab4]      ; 005471bc | int g_PathfindingMaxClimbHeight
    JG 0x00546fdb                       ; 005471c2 | LAB_00546fdb
        ;   XREF to: 00546fdb (CONDITIONAL_JUMP)
    PUSH ESI                            ; 005471c8
    ...
    PUSH EBP                            ; 005471d2
    PUSH EBX                            ; 005471d3
    CALL core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0 ; 005471d4 | int core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0(CPathMap * this_ptr, int grid_z, int grid_x, int current_height)
        ;   XREF to: 00546ba0 (UNCONDITIONAL_CALL)
    ...
    JG 0x00546fac                       ; 005471e9 | LAB_00546fac
        ;   XREF to: 00546fac (CONDITIONAL_JUMP)
    JMP 0x00546fdb                      ; 005471ef | LAB_00546fdb
    ...
    JLE 0x0054723e                      ; 00547203 | LAB_0054723e
    ...
    CALL core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0 ; 00547225 | int core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0(CPathMap * this_ptr, int grid_z, int grid_x, int current_height)
        ;   XREF to: 00546ba0 (UNCONDITIONAL_CALL)
    ...
    CMP EAX,dword ptr [0x030c3ab4]      ; 00547236 | int g_PathfindingMaxClimbHeight
    JLE 0x00547278                      ; 0054723c | LAB_00547278
        ;   XREF to: 00547278 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x34],0x0      ; 0054723e
        ;   Label: LAB_0054723e
    JNZ 0x00546fe6                      ; 00547243 | LAB_00546fe6
    ...
    PUSH EAX                            ; 00547259
    PUSH EBX                            ; 0054725a
    CALL core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0 ; 0054725b | int core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0(CPathMap * this_ptr, int grid_z, int grid_x, int current_height)
        ;   XREF to: 00546ba0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00547260
    CMP EDI,EAX                         ; 00547263
    JNZ 0x00546fe6                      ; 00547265 | LAB_00546fe6
        ;   XREF to: 00546fe6 (CONDITIONAL_JUMP)
    ...
    PUSH EDI                            ; 00547282
    PUSH EBX                            ; 00547283
    CALL core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0 ; 00547284 | int core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0(CPathMap * this_ptr, int grid_z, int grid_x, int current_height)
        ;   XREF to: 00546ba0 (UNCONDITIONAL_CALL)
    ...
    CMP EAX,dword ptr [0x030c3ab4]      ; 00547295 | int g_PathfindingMaxClimbHeight
    JG 0x0054723e                       ; 0054729b | LAB_0054723e
        ;   XREF to: 0054723e (CONDITIONAL_JUMP)
    PUSH ESI                            ; 0054729d
    ...
    PUSH EDI                            ; 005472a7
    PUSH EBX                            ; 005472a8
    CALL core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0 ; 005472a9 | int core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0(CPathMap * this_ptr, int grid_z, int grid_x, int current_height)
        ;   XREF to: 00546ba0 (UNCONDITIONAL_CALL)
    ...
    CMP EAX,dword ptr [0x030c3ab4]      ; 005472ba | int g_PathfindingMaxClimbHeight
    JG 0x0054723e                       ; 005472c0 | LAB_0054723e
        ;   XREF to: 0054723e (CONDITIONAL_JUMP)
    PUSH ESI                            ; 005472c6
    ...
    CALL core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0 ; 005472d2 | int core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0(CPathMap * this_ptr, int grid_z, int grid_x, int current_height)
        ;   XREF to: 00546ba0 (UNCONDITIONAL_CALL)
    ...
    JG 0x00547213                       ; 005472e7 | LAB_00547213
        ;   XREF to: 00547213 (CONDITIONAL_JUMP)
    JMP 0x0054723e                      ; 005472ed | LAB_0054723e
