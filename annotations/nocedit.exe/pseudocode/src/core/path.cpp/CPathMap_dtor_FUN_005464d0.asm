...
section .text
    ...
    PUSH ECX                            ; 0054651a
    ADD EDX,0x30c3abc                   ; 0054651b | CPathMap *[200] g_PathMapList
    PUSH EDX                            ; 00546521 | DAT_030c3ac4
    ADD EAX,0x30c3abc                   ; 00546522 | CPathMap *[200] g_PathMapList
    PUSH EAX                            ; 00546527 | DAT_030c3ac0
    MOV dword ptr [0x030c3ab8],EDI      ; 00546528 | int g_PathMapCount
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 0054652e | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
        ;   XREF to: 005fe5e0 (UNCONDITIONAL_CALL)
    MOV EDI,dword ptr [0x030c3ab8]      ; 00546533 | int g_PathMapCount
    XOR EAX,EAX                         ; 00546539
    ADD ESP,0xc                         ; 0054653b
    MOV dword ptr [EDI*0x4 + 0x30c3abc],EAX ; 0054653e | CPathMap *[200] g_PathMapList
    MOV EAX,ESI                         ; 00546545
    MOV dword ptr [0x030c3ab8],EDI      ; 00546547 | int g_PathMapCount
    POP EBP                             ; 0054654d
    POP EDI                             ; 0054654e
    POP ESI                             ; 0054654f
    POP EBX                             ; 00546550
