...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_path.cpp_CPathMap_findPathToDestination_FUN_00547320(CPathMap * this_ptr, CVector3f * dest_position, CVector3f * out_euler_angles, int direction_hint)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 0054733f
    PUSH 0x3277d14                      ; 00547340 | CDemonRaytrace g_CDemonRaytraceInstance
    LEA ESI,[ESP + 0xc8]                ; 00547345
    CALL core_dtrace.cpp_CDemonRaytrace_worldPositionToVoxelCoords_FUN_00499880 ; 0054734c | void core_dtrace.cpp_CDemonRaytrace_worldPositionToVoxelCoords_FUN_00499880(CDemonRaytrace * this_ptr, CVector3f * world_position, CVector3i * output_voxel_coords)
    ...
    JA 0x0054738c                       ; 00547383 | caseD_0
        ;   XREF to: 0054738c (CONDITIONAL_JUMP)
    JMP dword ptr [EDX*0x4 + 0x5472f4]  ; 00547385 | void * switchdataD_005472f4
        ;   Label: switchD
    ...
    JL 0x005474ab                       ; 005473a0 | LAB_005474ab
    ...
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 005473e0 | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
        ;   Label: LAB_005473e0
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005473e5
    MOV ECX,dword ptr [ESP + 0x124]     ; 005473e8
    CMP EAX,ECX                         ; 005473ef
    JZ 0x00547403                       ; 005473f1 | LAB_00547403
    ...
    JMP 0x0054738c                      ; 005474a6 | caseD_0
        ;   XREF to: 0054738c (UNCONDITIONAL_JUMP)
    ...
    JL 0x00547535                       ; 005474bf | LAB_00547535
    ...
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 005474fe | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00547503
    MOV EDX,dword ptr [ESP + 0x124]     ; 00547506
    CMP EAX,EDX                         ; 0054750d
    JZ 0x00547403                       ; 0054750f | LAB_00547403
        ;   XREF to: 00547403 (CONDITIONAL_JUMP)
    ...
    MOV dword ptr [0x030c3de8],EBX      ; 00547545 | int g_PathfindingDestZ
    MOV [0x030c3ddc],EAX                ; 0054754b | int g_PathfindingCurrentX
    MOV EAX,dword ptr [EBP + 0x20]      ; 00547550
    MOV dword ptr [0x030c3de4],EBX      ; 00547553 | int g_PathfindingDestX
    SUB EAX,EDX                         ; 00547559
    MOV ECX,dword ptr [0x030c3ddc]      ; 0054755b | int g_PathfindingCurrentX
    MOV [0x030c3de0],EAX                ; 00547561 | int g_PathfindingCurrentZ
    TEST ECX,ECX                        ; 00547566
    JL 0x0054756f                       ; 00547568 | LAB_0054756f
        ;   XREF to: 0054756f (CONDITIONAL_JUMP)
    CMP ECX,0x64                        ; 0054756a
    JL 0x005475d5                       ; 0054756d | LAB_005475d5
    ...
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 0054759d | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005475a2
    MOV EBP,dword ptr [ESP + 0x124]     ; 005475a5
    CMP EAX,EBP                         ; 005475ac
    JZ 0x00547403                       ; 005475ae | LAB_00547403
        ;   XREF to: 00547403 (CONDITIONAL_JUMP)
    ...
    TEST EAX,EAX                        ; 005475d5
        ;   Label: LAB_005475d5
    JL 0x0054756f                       ; 005475d7 | LAB_0054756f
        ;   XREF to: 0054756f (CONDITIONAL_JUMP)
    CMP EAX,0x64                        ; 005475d9
    JGE 0x0054756f                      ; 005475dc | LAB_0054756f
        ;   XREF to: 0054756f (CONDITIONAL_JUMP)
    CMP ECX,EBX                         ; 005475de
    JNZ 0x005475ea                      ; 005475e0 | LAB_005475ea
        ;   XREF to: 005475ea (CONDITIONAL_JUMP)
    CMP EAX,EBX                         ; 005475e2
    JZ 0x005477cc                       ; 005475e4 | LAB_005477cc
        ;   XREF to: 005477cc (CONDITIONAL_JUMP)
    FLD float ptr [EBP]                 ; 005475ea
        ;   Label: LAB_005475ea
    MOV EAX,dword ptr [ESP + 0x120]     ; 005475ed
    CALL crt_math.c_round_FUN_005fe6b0  ; 005475f4 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x104]       ; 005475f9
    FLD float ptr [EAX]                 ; 00547600
    CALL crt_math.c_round_FUN_005fe6b0  ; 00547602 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 0054762b | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x104]       ; 00547630
    FLD float ptr [EAX + 0x8]           ; 00547637
    CALL crt_math.c_round_FUN_005fe6b0  ; 0054763a | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 0054765c
    MOV EDI,dword ptr [0x030c3ddc]      ; 0054765d | int g_PathfindingCurrentX
    PUSH EDI                            ; 00547663
    MOV EAX,[0x030c3de0]                ; 00547664 | int g_PathfindingCurrentZ
    PUSH EAX                            ; 00547669
    PUSH EBP                            ; 0054766a
    CALL core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0 ; 0054766b | int core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0(CPathMap * this_ptr, int grid_z, int grid_x, int current_height)
        ;   XREF to: 00546ba0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00547670
    MOV EDX,dword ptr [EBP + 0x10]      ; 00547673
    PUSH EDX                            ; 00547676
    MOV ECX,dword ptr [0x030c3de4]      ; 00547677 | int g_PathfindingDestX
    PUSH ECX                            ; 0054767d
    MOV ESI,dword ptr [0x030c3de8]      ; 0054767e | int g_PathfindingDestZ
    PUSH ESI                            ; 00547684
    PUSH EBP                            ; 00547685
    MOV EBX,EAX                         ; 00547686
    CALL core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0 ; 00547688 | int core_path.cpp_CPathMap_getCachedVoxelHeight_FUN_00546ba0(CPathMap * this_ptr, int grid_z, int grid_x, int current_height)
        ;   XREF to: 00546ba0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0054768d
    PUSH EAX                            ; 00547690
    MOV EDI,dword ptr [0x030c3de8]      ; 00547691 | int g_PathfindingDestZ
    PUSH EDI                            ; 00547697
    MOV EAX,[0x030c3de4]                ; 00547698 | int g_PathfindingDestX
    PUSH EAX                            ; 0054769d
    PUSH EBX                            ; 0054769e
    MOV EDX,dword ptr [0x030c3de0]      ; 0054769f | int g_PathfindingCurrentZ
    PUSH EDX                            ; 005476a5
    MOV ECX,dword ptr [0x030c3ddc]      ; 005476a6 | int g_PathfindingCurrentX
    PUSH ECX                            ; 005476ac
    PUSH EBP                            ; 005476ad
    CALL core_path.cpp_CPathMap_isLineWalkable_FUN_00546c40 ; 005476ae | int core_path.cpp_CPathMap_isLineWalkable_FUN_00546c40(CPathMap * this_ptr, int start_x, int start_z, int start_height, ...)
        ;   XREF to: 00546c40 (UNCONDITIONAL_CALL)
    ADD ESP,0x1c                        ; 005476b3
    TEST EAX,EAX                        ; 005476b6
    JZ 0x0054783c                       ; 005476b8 | LAB_0054783c
    ...
    JZ 0x00547711                       ; 005476f1 | LAB_00547711
    ...
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 00547799 | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0054779e
    MOV ESI,dword ptr [ESP + 0x124]     ; 005477a1
    CMP EAX,ESI                         ; 005477a8
    JZ 0x005477bc                       ; 005477aa | LAB_005477bc
    ...
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 00547809 | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0054780e
    MOV EDI,dword ptr [ESP + 0x124]     ; 00547811
    CMP EAX,EDI                         ; 00547818
    JZ 0x0054782c                       ; 0054781a | LAB_0054782c
    ...
    POP EBX                             ; 0054783a
    RET                                 ; 0054783b
    MOV EBX,dword ptr [0x030c3de0]      ; 0054783c | int g_PathfindingCurrentZ
        ;   Label: LAB_0054783c
    PUSH EBX                            ; 00547842
    MOV ESI,dword ptr [0x030c3ddc]      ; 00547843 | int g_PathfindingCurrentX
    PUSH ESI                            ; 00547849
    MOV EDI,dword ptr [0x030c3de8]      ; 0054784a | int g_PathfindingDestZ
    PUSH EDI                            ; 00547850
    MOV EAX,[0x030c3de4]                ; 00547851 | int g_PathfindingDestX
    PUSH EAX                            ; 00547856
    PUSH EBP                            ; 00547857
    CALL core_path.cpp_CPathMap_checkAxisAlignedPath_FUN_00546e90 ; 00547858 | int core_path.cpp_CPathMap_checkAxisAlignedPath_FUN_00546e90(CPathMap * this_ptr, int start_x, int start_z, int start_height, ...)
        ;   XREF to: 00546e90 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0054785d
    TEST EAX,EAX                        ; 00547860
    JZ 0x0054793d                       ; 00547862 | LAB_0054793d
        ;   XREF to: 0054793d (CONDITIONAL_JUMP)
    CMP EAX,0x1                         ; 00547868
    JNZ 0x005478fc                      ; 0054786b | LAB_005478fc
        ;   XREF to: 005478fc (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [0x030c3ddc]      ; 00547871 | int g_PathfindingCurrentX
    MOV EAX,[0x030c3de4]                ; 00547877 | int g_PathfindingDestX
    CMP EAX,EDI                         ; 0054787c
    JLE 0x005478d7                      ; 0054787e | LAB_005478d7
    ...
    CALL core_path.cpp_CPathMap_getDirection_FUN_005465b0 ; 005478a7 | float core_path.cpp_CPathMap_getDirection_FUN_005465b0(CPathMap * this_ptr, int current_direction, int next_direction, int prev_direction, ...)
    ...
    POP EBX                             ; 005478d5
    RET                                 ; 005478d6
    JGE 0x005478e0                      ; 005478d7 | LAB_005478e0
        ;   Label: LAB_005478d7
        ;   XREF to: 005478e0 (CONDITIONAL_JUMP)
    MOV EAX,0x4                         ; 005478d9
    JMP 0x00547885                      ; 005478de | LAB_00547885
        ;   XREF to: 00547885 (UNCONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x030c3de0]      ; 005478e0 | int g_PathfindingCurrentZ
        ;   Label: LAB_005478e0
    CMP ECX,dword ptr [0x030c3de8]      ; 005478e6 | int g_PathfindingDestZ
    JGE 0x005478f5                      ; 005478ec | LAB_005478f5
        ;   XREF to: 005478f5 (CONDITIONAL_JUMP)
    MOV EAX,0x1                         ; 005478ee
    JMP 0x00547885                      ; 005478f3 | LAB_00547885
        ;   XREF to: 00547885 (UNCONDITIONAL_JUMP)
    MOV EAX,0x2                         ; 005478f5
        ;   Label: LAB_005478f5
    JMP 0x00547885                      ; 005478fa | LAB_00547885
        ;   XREF to: 00547885 (UNCONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x030c3de0]      ; 005478fc | int g_PathfindingCurrentZ
        ;   Label: LAB_005478fc
    MOV EAX,[0x030c3de8]                ; 00547902 | int g_PathfindingDestZ
    CMP EAX,ECX                         ; 00547907
    JLE 0x00547915                      ; 00547909 | LAB_00547915
        ;   XREF to: 00547915 (CONDITIONAL_JUMP)
    MOV EAX,0x1                         ; 0054790b
    JMP 0x00547885                      ; 00547910 | LAB_00547885
        ;   XREF to: 00547885 (UNCONDITIONAL_JUMP)
    JGE 0x00547921                      ; 00547915 | LAB_00547921
        ;   Label: LAB_00547915
        ;   XREF to: 00547921 (CONDITIONAL_JUMP)
    MOV EAX,0x2                         ; 00547917
    JMP 0x00547885                      ; 0054791c | LAB_00547885
        ;   XREF to: 00547885 (UNCONDITIONAL_JUMP)
    MOV ESI,dword ptr [0x030c3ddc]      ; 00547921 | int g_PathfindingCurrentX
        ;   Label: LAB_00547921
    CMP ESI,dword ptr [0x030c3de4]      ; 00547927 | int g_PathfindingDestX
    JL 0x00547880                       ; 0054792d | LAB_00547880
        ;   XREF to: 00547880 (CONDITIONAL_JUMP)
    MOV EAX,0x4                         ; 00547933
    JMP 0x00547885                      ; 00547938 | LAB_00547885
        ;   XREF to: 00547885 (UNCONDITIONAL_JUMP)
    MOV EDX,dword ptr [EBP + 0x1c]      ; 0054793d
        ;   Label: LAB_0054793d
    PUSH EDX                            ; 00547940
    PUSH EBP                            ; 00547941
    CALL core_path.cpp_CPathMap_queuePop_FUN_005487a0 ; 00547942 | uint core_path.cpp_CPathMap_queuePop_FUN_005487a0(CPathMap * this_ptr, int start_height)
        ;   XREF to: 005487a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00547947
    TEST EAX,EAX                        ; 0054794a
    JNZ 0x00547981                      ; 0054794c | LAB_00547981
    ...
    JMP 0x005473e0                      ; 0054797c | LAB_005473e0
        ;   XREF to: 005473e0 (UNCONDITIONAL_JUMP)
    MOV EBX,dword ptr [0x030c3de8]      ; 00547981 | int g_PathfindingDestZ
        ;   Label: LAB_00547981
    ...
    MOV EAX,[0x030c3de4]                ; 0054799b | int g_PathfindingDestX
    ...
    JG 0x00547add                       ; 005479b1 | LAB_00547add
        ;   XREF to: 00547add (CONDITIONAL_JUMP)
    MOV EDI,0xffffffff                  ; 005479b7
    MOV ESI,dword ptr [0x030c3de8]      ; 005479bc | int g_PathfindingDestZ
    MOV EBX,dword ptr [0x030c3de4]      ; 005479c2 | int g_PathfindingDestX
    ...
    JZ 0x00547b4e                       ; 005479f1 | LAB_00547b4e
        ;   XREF to: 00547b4e (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EDI*0x4 + 0x680c08] ; 005479f7 | int[9] g_PathfindingDeltaX
    MOV EDX,dword ptr [EDI*0x4 + 0x680c2c] ; 005479fe | int[9] g_PathfindingDeltaZ
    SUB EBX,EAX                         ; 00547a05
    SUB ESI,EDX                         ; 00547a07
    TEST EBX,EBX                        ; 00547a09
    JL 0x00547bb0                       ; 00547a0b | LAB_00547bb0
        ;   XREF to: 00547bb0 (CONDITIONAL_JUMP)
    TEST ESI,ESI                        ; 00547a11
        ;   Label: LAB_00547a11
    JL 0x00547bd7                       ; 00547a13 | LAB_00547bd7
        ;   XREF to: 00547bd7 (CONDITIONAL_JUMP)
    CMP EBX,0x64                        ; 00547a19
        ;   Label: LAB_00547a19
    JL 0x00547a40                       ; 00547a1c | LAB_00547a40
        ;   XREF to: 00547a40 (CONDITIONAL_JUMP)
    MOV EAX,0x63e9e2                    ; 00547a1e | = "..\\core\\path.cpp" | s_core_path_cpp_0063e9e2 = ..\core\path.cpp
    MOV EDX,0x549                       ; 00547a23
    PUSH 0x63e9f3                       ; 00547a28 | = "Out of bounds3!" | s_Out_of_bounds3_0063e9f3 = Out of bounds3!
    MOV [0x02f0ca48],EAX                ; 00547a2d | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 00547a32 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00547a38 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00547a3d
    CMP ESI,0x64                        ; 00547a40
        ;   Label: LAB_00547a40
    JL 0x00547a67                       ; 00547a43 | LAB_00547a67
        ;   XREF to: 00547a67 (CONDITIONAL_JUMP)
    MOV ECX,0x63ea03                    ; 00547a45 | = "..\\core\\path.cpp" | s_core_path_cpp_0063ea03 = ..\core\path.cpp
    MOV EAX,0x54a                       ; 00547a4a
    PUSH 0x63ea14                       ; 00547a4f | = "Out of bounds4!" | s_Out_of_bounds4_0063ea14 = Out of bounds4!
    MOV dword ptr [0x02f0ca48],ECX      ; 00547a54 | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 00547a5a | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00547a5f | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00547a64
    CMP EBX,dword ptr [0x030c3ddc]      ; 00547a67 | int g_PathfindingCurrentX
        ;   Label: LAB_00547a67
    JNZ 0x005479cf                      ; 00547a6d | LAB_005479cf
        ;   XREF to: 005479cf (CONDITIONAL_JUMP)
    CMP ESI,dword ptr [0x030c3de0]      ; 00547a73 | int g_PathfindingCurrentZ
    JNZ 0x005479cf                      ; 00547a79 | LAB_005479cf
        ;   XREF to: 005479cf (CONDITIONAL_JUMP)
    ...
    PUSH EDI                            ; 00547aab
    PUSH EBP                            ; 00547aac
    CALL core_path.cpp_CPathMap_getDirection_FUN_005465b0 ; 00547aad | float core_path.cpp_CPathMap_getDirection_FUN_005465b0(CPathMap * this_ptr, int current_direction, int next_direction, int prev_direction, ...)
        ;   XREF to: 005465b0 (UNCONDITIONAL_CALL)
    ...
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 00547b17 | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00547b1c
    MOV EDX,dword ptr [ESP + 0x124]     ; 00547b1f
    CMP EAX,EDX                         ; 00547b26
    JZ 0x00547403                       ; 00547b28 | LAB_00547403
        ;   XREF to: 00547403 (CONDITIONAL_JUMP)
    ...
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 00547b79 | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00547b7e
    MOV EDX,dword ptr [ESP + 0x124]     ; 00547b81
    CMP EAX,EDX                         ; 00547b88
    JZ 0x00547403                       ; 00547b8a | LAB_00547403
        ;   XREF to: 00547403 (CONDITIONAL_JUMP)
    ...
    POP EBX                             ; 00547bae
    RET                                 ; 00547baf
    MOV ECX,0x63e9a0                    ; 00547bb0 | = "..\\core\\path.cpp" | s_core_path_cpp_0063e9a0 = ..\core\path.cpp
        ;   Label: LAB_00547bb0
    MOV EAX,0x547                       ; 00547bb5
    PUSH 0x63e9b1                       ; 00547bba | = "Out of bounds1!" | s_Out_of_bounds1_0063e9b1 = Out of bounds1!
    MOV dword ptr [0x02f0ca48],ECX      ; 00547bbf | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 00547bc5 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00547bca | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00547bcf
    JMP 0x00547a11                      ; 00547bd2 | LAB_00547a11
        ;   XREF to: 00547a11 (UNCONDITIONAL_JUMP)
    MOV EDX,0x63e9c1                    ; 00547bd7 | = "..\\core\\path.cpp" | s_core_path_cpp_0063e9c1 = ..\core\path.cpp
        ;   Label: LAB_00547bd7
    MOV ECX,0x548                       ; 00547bdc
    PUSH 0x63e9d2                       ; 00547be1 | = "Out of bounds2!" | s_Out_of_bounds2_0063e9d2 = Out of bounds2!
    MOV dword ptr [0x02f0ca48],EDX      ; 00547be6 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 00547bec | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00547bf2 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00547bf7
    JMP 0x00547a19                      ; 00547bfa | LAB_00547a19
