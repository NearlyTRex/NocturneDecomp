...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_path_cpp_FUN_00546350(void)
;
;
; Referenced Globals:
...
section .text
    ...
    MOV ECX,dword ptr [0x030d2850]      ; 00546351 | g_PathfindingQueueTail
    ...
    MOV byte ptr [EAX + 0x30d2858],DL   ; 00546376 | g_PathfindingVisited
    LEA EAX,[ECX*0x4 + 0x0]             ; 0054637c
    MOV EBX,dword ptr [0x030d4fcc]      ; 00546383 | g_PathfindingNodesExpanded
    SUB EAX,ECX                         ; 00546389
    MOV EDX,dword ptr [ESP + 0x8]       ; 0054638b
    INC EBX                             ; 0054638f
    MOV dword ptr [EAX*0x4 + 0x30c3dec],EDX ; 00546390 | g_PathfindingQueue
    MOV EDX,dword ptr [ESP + 0xc]       ; 00546397
    MOV dword ptr [0x030d4fcc],EBX      ; 0054639b | g_PathfindingNodesExpanded
    ...
    JL 0x005463be                       ; 005463ba
        ;   XREF to: 005463be (CONDITIONAL_JUMP)  ; LAB_005463be
    XOR ECX,ECX                         ; 005463bc
    MOV dword ptr [0x030d2850],ECX      ; 005463be | g_PathfindingQueueTail
        ;   Label: LAB_005463be
    POP EBX                             ; 005463c4
    RET                                 ; 005463c5
