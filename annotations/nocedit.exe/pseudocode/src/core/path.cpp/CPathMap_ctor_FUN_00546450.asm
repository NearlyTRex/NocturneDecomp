...
;                               FUNCTION
; *****************************************************************************
; __cdecl CPathMap * core_path.cpp_CPathMap_ctor_FUN_00546450(CPathMap * this_ptr)
;
; Parameters:
; CPathMap *       Stack[0x4]:4   this_ptr
;
; XREF[2]:
;   core_hero.cpp_FUN_004f2340 at 004f2354
;   core_npc.cpp_FUN_005447e0 at 005447f4
;
; Referenced Globals:
