...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_path_cpp_FUN_00548590(void)
;
;
; XREF[4]:
;   core_set.cpp_CDemonSet_load_FUN_00569410 at 00569d40
;   core_setcolid.cpp_CDemonSet_FUN_00574440 at 005744a2
;   core_setcolid.cpp_CDemonSet_FUN_005744d0 at 00574532
;   core_setcolid.cpp_CDemonSet_FUN_00574560 at 0057456d
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00548590
        ;   Label: core_path.cpp_FUN_00548590
    PUSH ESI                            ; 00548591
    PUSH EDI                            ; 00548592
