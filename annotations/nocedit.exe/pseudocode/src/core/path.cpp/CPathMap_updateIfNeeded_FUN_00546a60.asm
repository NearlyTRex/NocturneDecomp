...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_path.cpp_CPathMap_updateIfNeeded_FUN_00546a60(CPathMap * this_ptr, CVector3f * source_position, int force_update)
;
; Parameters:
...
;   core_set.cpp_CDemonSet_FUN_0056b810 at 0056ba45
;
; Referenced Globals:
...
section .text
    ...
    FCOMP double ptr [0x0063e998]       ; 00546ac3 | double g_PathUpdateDistanceThreshold
    FNSTSW AX                           ; 00546ac9
    SAHF                                ; 00546acb
    JNC 0x00546af0                      ; 00546acc | LAB_00546af0
        ;   XREF to: 00546af0 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x4]           ; 00546ace
    FABS                                ; 00546ad2
    FCOMP double ptr [0x0063e998]       ; 00546ad4 | double g_PathUpdateDistanceThreshold
    FNSTSW AX                           ; 00546ada
    SAHF                                ; 00546adc
    JNC 0x00546af0                      ; 00546add | LAB_00546af0
        ;   XREF to: 00546af0 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x8]           ; 00546adf
    FABS                                ; 00546ae3
    FCOMP double ptr [0x0063e998]       ; 00546ae5 | double g_PathUpdateDistanceThreshold
    FNSTSW AX                           ; 00546aeb
    SAHF                                ; 00546aed
    JC 0x00546b41                       ; 00546aee | LAB_00546b41
        ;   XREF to: 00546b41 (CONDITIONAL_JUMP)
    CMP EBX,ESI                         ; 00546af0
        ;   Label: LAB_00546af0
    JZ 0x00546b04                       ; 00546af2 | LAB_00546b04
    ...
    PUSH EBX                            ; 00546b04
        ;   Label: LAB_00546b04
    PUSH 0x3277d14                      ; 00546b05 | CDemonRaytrace g_CDemonRaytraceInstance
    LEA ESI,[ESP + 0x14]                ; 00546b0a
    CALL core_dtrace.cpp_CDemonRaytrace_worldPositionToVoxelCoords_FUN_00499880 ; 00546b0e | void core_dtrace.cpp_CDemonRaytrace_worldPositionToVoxelCoords_FUN_00499880(CDemonRaytrace * this_ptr, CVector3f * world_position, CVector3i * output_voxel_coords)
    ...
    CALL core_path.cpp_CPathMap_reset_FUN_00548510 ; 00546b8d | void core_path.cpp_CPathMap_reset_FUN_00548510(CPathMap * this_ptr)
