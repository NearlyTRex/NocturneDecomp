// Name: core_mirror.cpp_allocMirrorClipPlanes_FUN_005213c0
// Address: 005213c0
// Address Range: [[005213c0, 005213de]]
// Convention: __cdecl
// Signature: SMirror * core_mirror.cpp_allocMirrorClipPlanes_FUN_005213c0(SMirror * mirror)
// Cross-references:
...
SMirror * __cdecl core_mirror_cpp_allocMirrorClipPlanes_FUN_005213c0(SMirror *mirror)

{
  void *pvVar1;
  
  pvVar1 = crt_memory_c_constructObjectArray_DefaultCtor_FUN_005fe667
                     (mirror->clip_planes,5,&g_SClipPlaneTypeInfo);
  return (SMirror *)((int)pvVar1 + -0x98);
}


// Assembly code:
// 005213c0: MOV EAX,dword ptr [ESP + 0x4]
//   Label: core_mirror.cpp_allocMirrorClipPlanes_FUN_005213c0
