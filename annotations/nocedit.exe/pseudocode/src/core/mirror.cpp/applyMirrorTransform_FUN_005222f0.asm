...
;                               FUNCTION
; *****************************************************************************
; __cdecl CVector3f * __cdecl core_mirror_cpp_applyMirrorTransform_FUN_005222f0 (SMirrorReflection *reflection,CVector3f *output_buffer,CVector3f *input_vector)
;
; Parameters:
...
;
; XREF[2]:
;   core_mirror.cpp_transformMirrorEdgeToIntegerSpace_FUN_00522a50 at 00522b0b
;   core_mirror.cpp_transformMirrorVertex_FUN_005229b0 at 005229ed
;
; Called Functions:
