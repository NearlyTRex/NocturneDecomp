...
// Signature: CVector3i * __stack3_esi core_mirror_cpp_transformMirrorEdgeToIntegerSpace_FUN_00522a50 (SMirrorReflection *reflection,CVector3i *point_a,CVector3i *point_b,CVector3i *output)

#include "nocturne.h"

CVector3i * __stack3_esi
core_mirror_cpp_transformMirrorEdgeToIntegerSpace_FUN_00522a50
          (SMirrorReflection *reflection,CVector3i *point_a,CVector3i *point_b,CVector3i *output)

{
  ...
  pCVar1 = core_mirror_cpp_applyMirrorTransform_FUN_005222f0(reflection,&local_48,&local_24);
  if (&local_24 != pCVar1) {
    local_24.x = pCVar1->x;
    local_24.y = pCVar1->y;
    local_24.z = pCVar1->z;
  }
  pCVar1 = core_mirror_cpp_applyMirrorTransform_FUN_005222f0(reflection,&local_18,&local_54);
  if (&local_54 != pCVar1) {
    local_54.x = pCVar1->x;
    local_54.y = pCVar1->y;
    local_54.z = pCVar1->z;
