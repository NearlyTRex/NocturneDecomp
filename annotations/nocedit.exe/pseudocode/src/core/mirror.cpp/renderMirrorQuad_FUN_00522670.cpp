// Name: core_mirror.cpp_renderMirrorQuad_FUN_00522670
// Address: 00522670
// Address Range: [[00522670, 005227f9]]
// Convention: __cdecl
// Signature: int core_mirror.cpp_renderMirrorQuad_FUN_00522670(CVector3f * vertices)
// Globals:
...
int __cdecl core_mirror_cpp_renderMirrorQuad_FUN_00522670(CVector3f *vertices)

{
  ...
  local_24[0].x = (int)ROUND(vertices->x * g_MirrorProjectionScale);
  local_24[0].y = (int)ROUND(vertices->y * g_MirrorProjectionScale);
  local_24[0].z = (int)ROUND(vertices->z * g_MirrorProjectionScale);
  wincore_windll_cpp_transformPoint_FUN_005b5a25
            (&g_CDemonRendererPtr->vertex_buffer_ptr->projected_vertex,local_24);
  local_34._8_4_ = (undefined4)ROUND(vertices[1].x * g_MirrorProjectionScale);
  local_28 = (int)ROUND(vertices[1].y * g_MirrorProjectionScale);
  local_24[0].x = (int)ROUND(vertices[1].z * g_MirrorProjectionScale);
  wincore_windll_cpp_transformPoint_FUN_005b5a25
            (&g_CDemonRendererPtr->vertex_buffer_ptr[1].projected_vertex,(CVector3i *)(local_34 + 8)
            );
  local_34._0_4_ = (undefined4)ROUND(vertices[2].x * g_MirrorProjectionScale);
  local_34._4_4_ = (undefined4)ROUND(vertices[2].y * g_MirrorProjectionScale);
  local_34._8_4_ = (undefined4)ROUND(vertices[2].z * g_MirrorProjectionScale);
  wincore_windll_cpp_transformPoint_FUN_005b5a25
...
// Assembly code:
// 00522670: PUSH EBX
//   Label: core_mirror.cpp_renderMirrorQuad_FUN_00522670
// 00522671: PUSH ESI
// 00522672: PUSH EDI
