...
;
; Called Functions:
;   engine_drender.cpp_CDemonRenderer_renderZPrepassPoly_FUN_0048a950
...
section .text
    ...
    PUSH EAX                            ; 00522842
    PUSH EDX                            ; 00522843
    CALL engine_special.cpp_transformPoint_FUN_005b5a25 ; 00522844
    ...
    PUSH EAX                            ; 00522884
    PUSH EDX                            ; 00522885
    CALL engine_special.cpp_transformPoint_FUN_005b5a25 ; 00522886
        ;   XREF to: 005b5a25 (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformPoint_FUN_005b5a25(SProjectedVertex * output, CVector3i * input)
    ...
    PUSH EAX                            ; 005228c6
    PUSH EDX                            ; 005228c7
    CALL engine_special.cpp_transformPoint_FUN_005b5a25 ; 005228c8
        ;   XREF to: 005b5a25 (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformPoint_FUN_005b5a25(SProjectedVertex * output, CVector3i * input)
    ...
    PUSH EAX                            ; 0052290b
    PUSH EDX                            ; 0052290c
    CALL engine_special.cpp_transformPoint_FUN_005b5a25 ; 0052290d
        ;   XREF to: 005b5a25 (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformPoint_FUN_005b5a25(SProjectedVertex * output, CVector3i * input)
    ...
    CALL engine_drender.cpp_CDemonRenderer_renderZPrepassPoly_FUN_0048a950 ; 0052298e
        ;   XREF to: 0048a950 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_renderZPrepassPoly_FUN_0048a950(CDemonRenderer * this_ptr, SMRGLPrimitivePoly * poly)
