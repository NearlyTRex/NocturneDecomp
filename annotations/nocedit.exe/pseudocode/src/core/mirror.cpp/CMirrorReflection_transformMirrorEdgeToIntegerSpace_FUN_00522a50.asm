...
section .text
    ...
    PUSH EBX                            ; 00522a50
        ;   Label: core_mirror.cpp_CMirrorReflection_transformMirrorEdgeToIntegerSpace_FUN_00522a50
    PUSH EDI                            ; 00522a51
    PUSH EBP                            ; 00522a52
    ...
    PUSH EAX                            ; 00522b09
    PUSH ESI                            ; 00522b0a
    CALL core_mirror.cpp_CMirrorReflection_applyMirrorTransform_FUN_005222f0 ; 00522b0b
    ...
    PUSH EAX                            ; 00522b3a
    PUSH ESI                            ; 00522b3b
    CALL core_mirror.cpp_CMirrorReflection_applyMirrorTransform_FUN_005222f0 ; 00522b3c
        ;   XREF to: 005222f0 (UNCONDITIONAL_CALL)  ; CVector3f * core_mirror.cpp_CMirrorReflection_applyMirrorTransform_FUN_005222f0(CMirrorReflection * this_ptr, CVector3f * output_buffer, CVector3f * input_vector)
