...
;                               FUNCTION
; *****************************************************************************
; __stack3_esi CVector3i * core_mirror.cpp_transformMirrorEdgeToIntegerSpace_FUN_00522a50(SMirrorReflection * reflection, CVector3i * point_a, CVector3i * point_b, CVector3i * output)
;
; Parameters:
