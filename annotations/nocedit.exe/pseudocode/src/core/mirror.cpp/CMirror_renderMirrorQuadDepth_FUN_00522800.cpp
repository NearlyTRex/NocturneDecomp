...

{
  ...
  local_3c._8_4_ = (undefined4)ROUND((this_ptr->reflection).corner1.x * g_MirrorProjectionScale);
  local_30 = (int)ROUND((this_ptr->reflection).corner1.y * g_MirrorProjectionScale);
  local_2c = (int)ROUND((this_ptr->reflection).corner1.z * g_MirrorProjectionScale);
  ...
  local_3c._0_4_ = (undefined4)ROUND((this_ptr->reflection).corner2.x * g_MirrorProjectionScale);
  local_3c._4_4_ = (undefined4)ROUND((this_ptr->reflection).corner2.y * g_MirrorProjectionScale);
  local_3c._8_4_ = (undefined4)ROUND((this_ptr->reflection).corner2.z * g_MirrorProjectionScale);
  wincore_windll_cpp_transformPoint_FUN_005b5a25
            (&g_CDemonRendererPtr->vertex_buffer_ptr[1].projected_vertex,(CVector3i *)local_3c);
  local_1c.z = (int)ROUND((this_ptr->reflection).corner3.x * g_MirrorProjectionScale);
  wincore_windll_cpp_transformPoint_FUN_005b5a25
            (&g_CDemonRendererPtr->vertex_buffer_ptr[2].projected_vertex,(CVector3i *)&local_1c.z);
  local_1c.x = (int)ROUND((this_ptr->reflection).corner4.x * g_MirrorProjectionScale);
  local_1c.y = (int)ROUND((this_ptr->reflection).corner4.y * g_MirrorProjectionScale);
  local_1c.z = (int)ROUND((this_ptr->reflection).corner4.z * g_MirrorProjectionScale);
  wincore_windll_cpp_transformPoint_FUN_005b5a25
