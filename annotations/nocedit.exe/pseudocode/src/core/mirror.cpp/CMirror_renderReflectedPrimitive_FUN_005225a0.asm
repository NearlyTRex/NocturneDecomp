...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_mirror_cpp_CMirror_renderReflectedPrimitive_FUN_005225a0 (CMirror *this_ptr,SMRGLHeaderPrimitive *prim)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 005225c1
    MOV EBX,dword ptr [0x006703ec]      ; 005225c2 | g_CDemonRendererInstance | g_CDemonRendererPtr2
