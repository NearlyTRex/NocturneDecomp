...
section .text
    ...
    PUSH ECX                            ; 005225a9
    CALL core_mirror.cpp_CMirror_reflectAndClipPrimitive_FUN_00522310 ; 005225aa | uint core_mirror.cpp_CMirror_reflectAndClipPrimitive_FUN_00522310(CMirror * this_ptr, SMRGLHeaderPrimitive * primitive)
        ;   XREF to: 00522310 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005225af
    TEST EAX,EAX                        ; 005225b2
    JNZ 0x005225b7                      ; 005225b4 | LAB_005225b7
    ...
    PUSH EAX                            ; 005225c1
    MOV EBX,dword ptr [0x006703ec]      ; 005225c2 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH EBX                            ; 005225c8 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_renderTexturedBasic_FUN_0048ab50 ; 005225c9 | int engine_drender.cpp_CDemonRenderer_renderTexturedBasic_FUN_0048ab50(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * prim)
