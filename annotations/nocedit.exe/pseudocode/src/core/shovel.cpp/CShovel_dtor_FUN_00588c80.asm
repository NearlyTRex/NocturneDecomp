...
section .text
    ...
    PUSH 0x662ce0                       ; 00588ca6 | g_CShovelTypeInfo
        ;   Label: LAB_00588ca6
    PUSH EBX                            ; 00588cab
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 00588cac
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 00588cb1
    PUSH EAX                            ; 00588cb4
    CALL crt_memory.c_free_FUN_005fe659 ; 00588cb5
    ...
    PUSH EAX                            ; 00588cc1
        ;   Label: LAB_00588cc1
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 00588cc2
