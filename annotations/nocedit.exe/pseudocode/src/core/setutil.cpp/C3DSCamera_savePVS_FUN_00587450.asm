...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_setutil.cpp_C3DSCamera_savePVS_FUN_00587450(C3DSCamera * this_ptr, FILE * file_handle)
;
; Parameters:
...
section .text
    ...
    JNZ 0x005874b5                      ; 00587463 | LAB_005874b5
    ...
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00587474 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    MOV ESI,dword ptr [EDI + 0x194]     ; 00587479
    ADD ESP,0xc                         ; 0058747f
    TEST ESI,ESI                        ; 00587482
    JLE 0x005874b0                      ; 00587484 | LAB_005874b0
    ...
    INC EBX                             ; 0058749b
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058749c | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [EDI + 0x194]     ; 005874a1
    ADD ESP,0xc                         ; 005874a7
    CMP EBX,ECX                         ; 005874aa
    JL 0x00587488                       ; 005874ac | LAB_00587488
    ...
    PUSH 0x649955                       ; 005874b5 | = "0\n" | s_s_0_00649955 = 0
        ...
        ;   Label: LAB_005874b5
    PUSH EBP                            ; 005874ba
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 005874bb | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
