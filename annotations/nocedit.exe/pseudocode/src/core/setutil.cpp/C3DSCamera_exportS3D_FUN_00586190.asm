...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_setutil_cpp_C3DSCamera_exportS3D_FUN_00586190(C3DSCamera *this_ptr,FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    JZ 0x005861ad                       ; 005861a1
        ;   XREF to: 005861ad (CONDITIONAL_JUMP)  ; LAB_005861ad
    MOV dword ptr [EBX + 0x144],0x41280000 ; 005861a3
    FLD float ptr [EBX + 0x144]         ; 005861ad
        ;   Label: LAB_005861ad
    FDIVR double ptr [0x00649533]       ; 005861b3 | g_S3DProjectionScale
    FLD1                                ; 005861b9
    FPATAN                              ; 005861bb
    FMUL double ptr [0x0064953b]        ; 005861bd | DOUBLE_0064953b
    ...
    PUSH ESI                            ; 00586217
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00586218
    ...
    PUSH ESI                            ; 00586249
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058624a
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    PUSH ESI                            ; 0058627b
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058627c
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    PUSH ESI                            ; 005862ad
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 005862ae
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    PUSH ESI                            ; 005862df
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 005862e0
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
