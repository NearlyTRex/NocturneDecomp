...
;                               FUNCTION
; *****************************************************************************
; __cdecl CDemonLight * core_setutil.cpp_C3DSLight_create_FUN_00586a90(C3DSLight * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH 0x2f8                          ; 00586a9b
    PUSH 0x64961f                       ; 00586aa0 | = "..\\core\\setutil.cpp" | s_core_setutil_cpp_0064961f = ..\core\setutil.cpp
    PUSH 0x2fac                         ; 00586aa5
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1b0 ; 00586aaa | void * shape_memdbg.cpp_debugAlloc_FUN_0050f1b0(int size, char * filename, int line_number)
        ;   XREF to: 0050f1b0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00586aaf
    TEST EAX,EAX                        ; 00586ab2
    JNZ 0x00586bbe                      ; 00586ab4 | LAB_00586bbe
        ;   XREF to: 00586bbe (CONDITIONAL_JUMP)
    MOV dword ptr [ESP],EAX             ; 00586aba
        ;   Label: LAB_00586aba
    TEST EAX,EAX                        ; 00586abd
    JNZ 0x00586ae4                      ; 00586abf | LAB_00586ae4
        ;   XREF to: 00586ae4 (CONDITIONAL_JUMP)
    MOV EBX,0x649633                    ; 00586ac1 | = "..\\core\\setutil.cpp" | s_core_setutil_cpp_00649633 = ..\core\setutil.cpp
    MOV ESI,0x2f9                       ; 00586ac6
    PUSH 0x649647                       ; 00586acb | = "C3DSLight::create - Out of memory!" | s_C3DSLight_create_Out_of__00649647 = C3DSLight::create - Out of memory!
    MOV dword ptr [0x02f0ca48],EBX      ; 00586ad0 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 00586ad6 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00586adc | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00586ae1
    MOV EDI,dword ptr [ESP]             ; 00586ae4
        ;   Label: LAB_00586ae4
    PUSH EDI                            ; 00586ae7
    CALL core_dlight.cpp_CDemonLight_init_FUN_004727c0 ; 00586ae8 | void core_dlight.cpp_CDemonLight_init_FUN_004727c0(CDemonLight * this_ptr)
        ;   XREF to: 004727c0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EBP + 0x11ec]    ; 00586aed
    ADD ESP,0x4                         ; 00586af3
    TEST EAX,EAX                        ; 00586af6
    JLE 0x00586bda                      ; 00586af8 | LAB_00586bda
    ...
    JZ 0x00586b2a                       ; 00586b18 | LAB_00586b2a
    ...
    PUSH EAX                            ; 00586b38
    CALL core_dirmat.cpp_CMatrix3x3f_buildRotationMatrix_FUN_00471d30 ; 00586b39 | void core_dirmat.cpp_CMatrix3x3f_buildRotationMatrix_FUN_00471d30(CMatrix3x3f * this_ptr, CVector3f * euler_angles)
    ...
    JLE 0x00586b90                      ; 00586b57 | LAB_00586b90
    ...
    PUSH ECX                            ; 00586b67
    PUSH EDI                            ; 00586b68
    MOV EAX,[0x0066efcc]                ; 00586b69 | CFilterCache g_CFilterCacheInstance | CFilterCache * g_CFilterCachePtr
    PUSH EAX                            ; 00586b6e | CFilterCache g_CFilterCacheInstance
    ADD EBX,0x4                         ; 00586b6f
    INC ESI                             ; 00586b72
    CALL core_dfilter.cpp_CFilterCache_getFilter_FUN_00470060 ; 00586b73 | CDemonFilter * core_dfilter.cpp_CFilterCache_getFilter_FUN_00470060(CFilterCache * this_ptr, char * filter_name, char * filter_filename, int enable_init)
    ...
    JL 0x00586b61                       ; 00586b8c | LAB_00586b61
    ...
    CMP AL,0x0                          ; 00586b9e
    JZ 0x00586bb2                       ; 00586ba0 | LAB_00586bb2
    ...
    CMP AL,0x0                          ; 00586bae
    JNZ 0x00586b9a                      ; 00586bb0 | LAB_00586b9a
    ...
    PUSH ECX                            ; 00586bcb
    PUSH EAX                            ; 00586bcc
    CALL core_dlight.cpp_CDemonLight_ctor_FUN_004726a0 ; 00586bcd | CDemonLight * core_dlight.cpp_CDemonLight_ctor_FUN_004726a0(CDemonLight * this_ptr)
        ;   XREF to: 004726a0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00586bd2
    JMP 0x00586aba                      ; 00586bd5 | LAB_00586aba
        ;   XREF to: 00586aba (UNCONDITIONAL_JUMP)
    MOV dword ptr [EDI + 0x1cb8],0x1    ; 00586bda
        ;   Label: LAB_00586bda
    JMP 0x00586b0a                      ; 00586be4 | LAB_00586b0a
