...
section .text
    ...
    FMUL float ptr [0x00649a83]         ; 00587a51 | float FLOAT_00649a83
    FLD double ptr [0x00649a8b]         ; 00587a57 | double DOUBLE_00649a8b
    FXCH                                ; 00587a5d
    FMUL ST1                            ; 00587a5f
    MOV EAX,dword ptr [ESP + 0x4c]      ; 00587a61
    FMUL double ptr [0x00649a93]        ; 00587a65 | double DOUBLE_00649a93
    ...
    FMUL float ptr [0x00649a9b]         ; 00587a7b | float FLOAT_00649a9b
    FMULP ST3                           ; 00587a81
    FLD float ptr [ESP + 0x54]          ; 00587a83
    FXCH ST2                            ; 00587a87
    FMUL ST2                            ; 00587a89
    FXCH ST3                            ; 00587a8b
    FMUL double ptr [0x00649aa3]        ; 00587a8d | double DOUBLE_00649aa3
    FLD ST0                             ; 00587a93
    FCOS                                ; 00587a95
    FXCH                                ; 00587a97
    FSIN                                ; 00587a99
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 00587aad | CDemonRenderer * g_CDemonRendererPtr
    FXCH ST2                            ; 00587ab3
    ...
    FMUL float ptr [0x00662a40]         ; 00587ac6 | float FLOAT_00662a40
    FISTP dword ptr [EBX]               ; 00587acc
    FLD float ptr [EAX + 0x4]           ; 00587ace
    FMUL float ptr [0x00662a40]         ; 00587ad1 | float FLOAT_00662a40
    FISTP dword ptr [EBX + 0x4]         ; 00587ad7
    FLD float ptr [EAX + 0x8]           ; 00587ada
    FMUL float ptr [0x00662a40]         ; 00587add | float FLOAT_00662a40
    ...
    MOV EAX,dword ptr [EDX]             ; 00587af8 | CDemonRenderer g_CDemonRendererInstance
    SHL ESI,0x4                         ; 00587afa
    ADD EAX,ESI                         ; 00587afd
    PUSH EAX                            ; 00587aff
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 00587b00 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    MOV EAX,[0x006703ec]                ; 00587b05 | CDemonRenderer * g_CDemonRendererPtr
    MOV EDX,dword ptr [EAX]             ; 00587b0a | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EDX + ESI*0x1 + 0x18],0x800000 ; 00587b0c | DAT_00800000
    MOV EAX,dword ptr [EAX]             ; 00587b14 | CDemonRenderer g_CDemonRendererInstance
