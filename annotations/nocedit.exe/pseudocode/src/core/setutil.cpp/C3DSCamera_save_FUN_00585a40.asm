...
section .text
    ...
    PUSH 0x649353                       ; 00585a4b | = "-- camera name ----------------------..." | s_camera_name_00649353 = -- camera name ------------------------

    PUSH ESI                            ; 00585a50
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00585a51 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    PUSH ESI                            ; 00585a5f
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00585a60 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00585a65
    PUSH 0x649380                       ; 00585a68 | = "pos\n" | s_pos_00649380 = pos

    PUSH ESI                            ; 00585a6d
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00585a6e | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH 0x649385                       ; 00585a9a | = "%f,%f,%f\n" | s_f_f_f_00649385 = %f,%f,%f

    PUSH ESI                            ; 00585a9f
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00585aa0 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x20                        ; 00585aa5
    PUSH 0x64938f                       ; 00585aa8 | = "orient\n" | s_orient_0064938f = orient

    PUSH ESI                            ; 00585aad
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00585aae | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH 0x649397                       ; 00585ada | = "%f,%f,%f\n" | s_f_f_f_00649397 = %f,%f,%f

    PUSH ESI                            ; 00585adf
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00585ae0 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x20                        ; 00585ae5
    PUSH 0x6493a1                       ; 00585ae8 | = "fov\n" | s_fov_006493a1 = fov

    PUSH ESI                            ; 00585aed
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00585aee | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 00585b07
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00585b08 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00585b0d
    PUSH 0x6493aa                       ; 00585b10 | = "vmat\n" | s_vmat_006493aa = vmat

    PUSH ESI                            ; 00585b15
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00585b16 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH 0x6493b0                       ; 00585b42 | = "%f,%f,%f\n" | s_f_f_f_006493b0 = %f,%f,%f

    PUSH ESI                            ; 00585b47
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00585b48 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH 0x6493ba                       ; 00585b74 | = "%f,%f,%f\n" | s_f_f_f_006493ba = %f,%f,%f

    PUSH ESI                            ; 00585b79
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00585b7a | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH 0x6493c4                       ; 00585ba6 | = "%f,%f,%f\n" | s_f_f_f_006493c4 = %f,%f,%f

    PUSH ESI                            ; 00585bab
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00585bac | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 00585bc0
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00585bc1 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [EBX + 0x150]     ; 00585bc6
    ADD ESP,0xc                         ; 00585bcc
    TEST ECX,ECX                        ; 00585bcf
    JZ 0x00585c70                       ; 00585bd1 | LAB_00585c70
        ;   XREF to: 00585c70 (CONDITIONAL_JUMP)
    PUSH 0x6493d2                       ; 00585bd7 | = "box min, max\n" | s_box_min_max_006493d2 = box min, max

        ;   Label: LAB_00585bd7
    PUSH ESI                            ; 00585bdc
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00585bdd | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH 0x6493e0                       ; 00585c09 | = "%g,%g,%g\n" | s_g_g_g_006493e0 = %g,%g,%g

    PUSH ESI                            ; 00585c0e
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00585c0f | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH 0x6493ea                       ; 00585c3b | = "%g,%g,%g\n" | s_g_g_g_006493ea = %g,%g,%g

    PUSH ESI                            ; 00585c40
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00585c41 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x20                        ; 00585c46
    PUSH 0x6493f4                       ; 00585c49 | = "reverbPreset\n" | s_reverbPreset_006493f4 = reverbPreset

    PUSH ESI                            ; 00585c4e
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00585c4f | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 00585c63
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00585c64 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00585c77
    CALL core_dcamera.cpp_saveCameraFog_FUN_00453f10 ; 00585c78 | void core_dcamera.cpp_saveCameraFog_FUN_00453f10(SFog * fog, FILE * file_handle)
        ;   XREF to: 00453f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00585c7d
    JMP 0x00585bd7                      ; 00585c80 | LAB_00585bd7
