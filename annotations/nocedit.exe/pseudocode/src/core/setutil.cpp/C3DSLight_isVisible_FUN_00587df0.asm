...
section .text
    ...
    JNZ 0x00587e0c                      ; 00587e01 | LAB_00587e0c
    ...
    MOV EBX,dword ptr [0x006703ec]      ; 00587e13 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    FCHS                                ; 00587e19
    ...
    PUSH EBX                            ; 00587e44 | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [ESP + 0x18],EAX      ; 00587e45
    MOV dword ptr [ESP + 0x1c],EAX      ; 00587e49
    MOV dword ptr [ESP + 0x20],EAX      ; 00587e4d
    CALL engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450 ; 00587e51 | void engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450(CDemonRenderer * this_ptr, CVector3f * world_position)
        ;   XREF to: 0048c450 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00587e56
    LEA EAX,[ESP + 0x4]                 ; 00587e59
    PUSH EAX                            ; 00587e5d
    CALL core_box.cpp_CBoundingBox3D_isVisible_FUN_004204f0 ; 00587e5e | int core_box.cpp_CBoundingBox3D_isVisible_FUN_004204f0(CBoundingBox3D * this_ptr)
