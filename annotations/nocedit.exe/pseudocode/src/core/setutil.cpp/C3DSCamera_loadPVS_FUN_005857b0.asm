...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_setutil.cpp_C3DSCamera_loadPVS_FUN_005857b0(C3DSCamera * this_ptr, FILE * file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBP                            ; 005857c7
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 005857c8 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005857cd
    PUSH 0xe2                           ; 005857d0
    MOV EAX,dword ptr [EDI + 0x194]     ; 005857d5
    PUSH 0x649267                       ; 005857db | = "..\\core\\setutil.cpp" | s_core_setutil_cpp_00649267 = ..\core\setutil.cpp
    SHL EAX,0x2                         ; 005857e0
    PUSH EAX                            ; 005857e3
    MOV EDX,dword ptr [EDI + 0x198]     ; 005857e4
    PUSH EDX                            ; 005857ea
    CALL shape_memdbg.cpp_debugRealloc_FUN_0050f540 ; 005857eb | void * shape_memdbg.cpp_debugRealloc_FUN_0050f540(void * ptr, int new_size, char * filename, int line_number)
    ...
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 00585829 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EDI + 0x194]     ; 0058582e
    ADD ESP,0xc                         ; 00585834
    CMP ESI,EAX                         ; 00585837
    JL 0x00585816                       ; 00585839 | LAB_00585816
    ...
    PUSH ECX                            ; 00585840
        ;   Label: LAB_00585840
    MOV ESI,0x64927b                    ; 00585841 | = "..\\core\\setutil.cpp" | s_core_setutil_cpp_0064927b = ..\core\setutil.cpp
    MOV EAX,0xe4                        ; 00585846
    PUSH 0x64928f                       ; 0058584b | = "Out of memory for pvsList - %d" | s_Out_of_memory_for_pvsLis_0064928f = Out of memory for pvsList - %d
    MOV dword ptr [0x02f0ca48],ESI      ; 00585850 | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 00585856 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0058585b | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00585860
    JMP 0x00585807                      ; 00585863 | LAB_00585807
