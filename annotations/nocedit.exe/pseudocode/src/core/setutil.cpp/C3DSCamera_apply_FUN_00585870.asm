...
section .text
    ...
    JNZ 0x0058592d                      ; 00585883
        ;   XREF to: 0058592d (CONDITIONAL_JUMP)  ; LAB_0058592d
    LEA EAX,[EBP + 0x4]                 ; 00585889
        ;   Label: LAB_00585889
    LEA EDX,[EBX + 0x100]               ; 0058588c
    CMP EAX,EDX                         ; 00585892
    JZ 0x005858a6                       ; 00585894
        ;   XREF to: 005858a6 (CONDITIONAL_JUMP)  ; LAB_005858a6
    ...
    JMP 0x03fc401f                      ; 005858a6
        ;   XREF to: 03fc401f (UNCONDITIONAL_JUMP)  ; LAB_03fc401f
        ;   Label: LAB_005858a6
    ...
    CMP AL,0x0                          ; 005858c9
    JZ 0x005858dd                       ; 005858cb
        ;   XREF to: 005858dd (CONDITIONAL_JUMP)  ; LAB_005858dd
    MOV AL,byte ptr [ESI + 0x1]         ; 005858cd
    ADD ESI,0x2                         ; 005858d0
    MOV byte ptr [EDI + 0x1],AL         ; 005858d3
    ADD EDI,0x2                         ; 005858d6
    CMP AL,0x0                          ; 005858d9
    JNZ 0x005858c5                      ; 005858db
        ;   XREF to: 005858c5 (CONDITIONAL_JUMP)  ; LAB_005858c5
    POP EDI                             ; 005858dd
        ;   Label: LAB_005858dd
    PUSH dword ptr [EBX + 0x148]        ; 005858de
    PUSH EBP                            ; 005858e4
    CALL core_dcamera.cpp_CDemonCamera_setEffectIntensity_FUN_004528e0 ; 005858e5
    ...
    FLD float ptr [EBX + 0x148]         ; 00585917
        ;   Label: LAB_00585917
    FCOMP double ptr [0x0064934b]       ; 0058591d | g_MaxRecommendedAmbient
    FNSTSW AX                           ; 00585923
    SAHF                                ; 00585925
    JA 0x00585956                       ; 00585926
        ;   XREF to: 00585956 (CONDITIONAL_JUMP)  ; LAB_00585956
    POP EBP                             ; 00585928
    POP EDI                             ; 00585929
    POP ESI                             ; 0058592a
    POP EBX                             ; 0058592b
    ...
    PUSH EBX                            ; 0058592d
        ;   Label: LAB_0058592d
    MOV ECX,0x6492b3                    ; 0058592e | = "..\\core\\setutil.cpp"
    MOV ESI,0xf7                        ; 00585933
    PUSH 0x6492c7                       ; 00585938 | = "C3DSCamera::apply - shouldn't ever do..."
    MOV dword ptr [0x02f0ca48],ECX      ; 0058593d | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 00585943 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00585949
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ADD ESP,0x8                         ; 0058594e
    JMP 0x00585889                      ; 00585951
        ;   XREF to: 00585889 (UNCONDITIONAL_JUMP)  ; LAB_00585889
    ...
    POP EBX                             ; 0058596d
    RET                                 ; 0058596e
    MOV ECX,0xa                         ; 03fc401f
        ;   Label: LAB_03fc401f
    LEA ESI,[EBX + 0x118]               ; 03fc4024
    LEA EDI,[EBP + 0x10]                ; 03fc402a
    MOV ECX,dword ptr [ESI]             ; 03fc402d
    MOV dword ptr [EDI],ECX             ; 03fc402f
    MOV ECX,dword ptr [ESI + 0x4]       ; 03fc4031
    MOV dword ptr [EDI + 0x4],ECX       ; 03fc4034
    MOV ECX,dword ptr [ESI + 0x8]       ; 03fc4037
    MOV dword ptr [EDI + 0x8],ECX       ; 03fc403a
    MOV ECX,dword ptr [ESI + 0xc]       ; 03fc403d
    MOV dword ptr [EDI + 0xc],ECX       ; 03fc4040
    MOV ECX,dword ptr [ESI + 0x10]      ; 03fc4043
    MOV dword ptr [EDI + 0x10],ECX      ; 03fc4046
    MOV ECX,dword ptr [ESI + 0x14]      ; 03fc4049
    MOV dword ptr [EDI + 0x14],ECX      ; 03fc404c
    MOV ECX,dword ptr [ESI + 0x18]      ; 03fc404f
    MOV dword ptr [EDI + 0x18],ECX      ; 03fc4052
    MOV ECX,dword ptr [ESI + 0x1c]      ; 03fc4055
    MOV dword ptr [EDI + 0x1c],ECX      ; 03fc4058
    MOV ECX,dword ptr [ESI + 0x20]      ; 03fc405b
    MOV dword ptr [EDI + 0x20],ECX      ; 03fc405e
    MOV ECX,dword ptr [ESI + 0x24]      ; 03fc4061
    MOV dword ptr [EDI + 0x24],ECX      ; 03fc4064
    ADD ESI,0x28                        ; 03fc4067
    ADD EDI,0x28                        ; 03fc406a
    XOR ECX,ECX                         ; 03fc406d
    JMP 0x005858b6                      ; 03fc406f
        ;   XREF to: 005858b6 (UNCONDITIONAL_JUMP)  ; LAB_005858b6
