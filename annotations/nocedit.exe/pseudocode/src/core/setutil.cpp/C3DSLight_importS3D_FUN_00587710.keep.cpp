...

{
  ...
  iVar1 = _fscanf(file_handle,"\"%[^\"]\",%d,%f,%f,%f,%f,%f,%f ",this_ptr->name,
                     &this_ptr->light_type,&(this_ptr->pos).x,&(this_ptr->pos).y,
                     &(this_ptr->pos).z,(float *)&(this_ptr->color).r,
                     (float *)&(this_ptr->color).g,(float *)&(this_ptr->color).b);
