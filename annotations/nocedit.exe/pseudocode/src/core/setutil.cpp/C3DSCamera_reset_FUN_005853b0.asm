...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_setutil.cpp_C3DSCamera_reset_FUN_005853b0(C3DSCamera * this_ptr)
;
; Parameters:
; C3DSCamera *     Stack[0x4]:4   this_ptr
;
; XREF[3]:
;   core_setedit.cpp_DementedCameraEditor_FUN_0057e7c0 at 0057eab2
...
section .text
    ...
    PUSH EBX                            ; 005853b5
    CALL core_setutil.cpp_C3DSCamera_free_FUN_00585360 ; 005853b6 | void core_setutil.cpp_C3DSCamera_free_FUN_00585360(C3DSCamera * this_ptr)
        ;   XREF to: 00585360 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005853bb
    PUSH 0x1a4                          ; 005853be
    PUSH 0x0                            ; 005853c3
    PUSH EBX                            ; 005853c5
    CALL crt_memory.c_memset_FUN_005fde40 ; 005853c6 | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
