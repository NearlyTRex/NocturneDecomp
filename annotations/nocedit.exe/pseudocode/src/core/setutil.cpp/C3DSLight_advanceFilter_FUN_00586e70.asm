...
section .text
    ...
    JZ 0x00586ed5                       ; 00586e7c | LAB_00586ed5
        ;   XREF to: 00586ed5 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x11ec],0x0    ; 00586e7e
        ;   Label: LAB_00586e7e
    JLE 0x00586ed1                      ; 00586e85 | LAB_00586ed1
    ...
    JL 0x00586ea8                       ; 00586e9c | LAB_00586ea8
    ...
    PUSH EDI                            ; 00586ec7
    CALL core_dlight.cpp_CDemonLight_applyFilter_FUN_00474770 ; 00586ec8 | void core_dlight.cpp_CDemonLight_applyFilter_FUN_00474770(CDemonLight * this_ptr, CDemonFilter * filter_ptr, int filter_index, int filter_pos_x, ...)
    ...
    POP EBX                             ; 00586ed3
    RET                                 ; 00586ed4
    MOV ECX,0x6496b6                    ; 00586ed5 | = "..\\core\\setutil.cpp" | s_core_setutil_cpp_006496b6 = ..\core\setutil.cpp
        ;   Label: LAB_00586ed5
    MOV ESI,0x387                       ; 00586eda
    PUSH 0x6496ca                       ; 00586edf | = "C3DSLight::advanceFilter - NULL CDemo..." | s_C3DSLight_advanceFilter__006496ca = C3DSLight::advanceFilter - NULL CDemonLight pointer!
    MOV dword ptr [0x02f0ca48],ECX      ; 00586ee4 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 00586eea | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00586ef0 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00586ef5
    JMP 0x00586e7e                      ; 00586ef8 | LAB_00586e7e
