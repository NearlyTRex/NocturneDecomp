...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_setutil.cpp_C3DSCamera_load_FUN_00585420(C3DSCamera * this_ptr, FILE * file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00585438
    CALL core_setutil.cpp_C3DSCamera_reset_FUN_005853b0 ; 00585439 | void core_setutil.cpp_C3DSCamera_reset_FUN_005853b0(C3DSCamera * this_ptr)
        ;   XREF to: 005853b0 (UNCONDITIONAL_CALL)
    MOV EAX,[0x006810c8]                ; 0058543e | CDemonSet * g_CDemonSetPtr
    MOV EDX,dword ptr [EAX + 0x15acac]  ; 00585443 | DAT_0326ef24
    ADD ESP,0x4                         ; 00585449
    CMP EDX,0xb                         ; 0058544c
    JGE 0x005856ce                      ; 0058544f | LAB_005856ce
    ...
    PUSH EAX                            ; 0058545f
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 00585460 | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
    ...
    PUSH EAX                            ; 00585472
    CALL crt_stdio.c_sscanf_FUN_0060013c ; 00585473 | int crt_stdio.c_sscanf_FUN_0060013c(char * str, char * format)
        ;   XREF to: 0060013c (UNCONDITIONAL_CALL)
    MOV EAX,[0x006810c8]                ; 00585478 | CDemonSet * g_CDemonSetPtr
    MOV ECX,dword ptr [EAX + 0x15acac]  ; 0058547d | DAT_0326ef24
    ADD ESP,0xc                         ; 00585483
    CMP ECX,0xb                         ; 00585486
    JL 0x0058549e                       ; 00585489 | LAB_0058549e
        ;   XREF to: 0058549e (CONDITIONAL_JUMP)
    PUSH ESI                            ; 0058548b
    PUSH 0xff                           ; 0058548c
    LEA EAX,[ESP + 0x8]                 ; 00585491
    PUSH EAX                            ; 00585495
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 00585496 | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 005854b2
    PUSH 0x6491d3                       ; 005854b3 | = "%f,%f,%f\n" | s_f_f_f_006491d3 = %f,%f,%f

    PUSH ESI                            ; 005854b8
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 005854b9 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    MOV EAX,[0x006810c8]                ; 005854be | CDemonSet * g_CDemonSetPtr
    MOV EDI,dword ptr [EAX + 0x15acac]  ; 005854c3 | DAT_0326ef24
    ADD ESP,0x14                        ; 005854c9
    CMP EDI,0xb                         ; 005854cc
    JL 0x005854e4                       ; 005854cf | LAB_005854e4
        ;   XREF to: 005854e4 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 005854d1
    PUSH 0xff                           ; 005854d2
    LEA EAX,[ESP + 0x8]                 ; 005854d7
    PUSH EAX                            ; 005854db
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 005854dc | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 005854f8
    PUSH 0x6491dd                       ; 005854f9 | = "%f,%f,%f\n" | s_f_f_f_006491dd = %f,%f,%f

    PUSH ESI                            ; 005854fe
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 005854ff | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    MOV EAX,[0x006810c8]                ; 00585504 | CDemonSet * g_CDemonSetPtr
    MOV EBP,dword ptr [EAX + 0x15acac]  ; 00585509 | DAT_0326ef24
    ADD ESP,0x14                        ; 0058550f
    CMP EBP,0xb                         ; 00585512
    JL 0x0058552a                       ; 00585515 | LAB_0058552a
        ;   XREF to: 0058552a (CONDITIONAL_JUMP)
    PUSH ESI                            ; 00585517
    PUSH 0xff                           ; 00585518
    LEA EAX,[ESP + 0x8]                 ; 0058551d
    PUSH EAX                            ; 00585521
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 00585522 | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 00585536
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 00585537 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00585549
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 0058554a | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00585566
    PUSH 0x6491eb                       ; 00585567 | = "%f,%f,%f\n" | s_f_f_f_006491eb = %f,%f,%f

    PUSH ESI                            ; 0058556c
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0058556d | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00585589
    PUSH 0x6491f5                       ; 0058558a | = "%f,%f,%f\n" | s_f_f_f_006491f5 = %f,%f,%f

    PUSH ESI                            ; 0058558f
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 00585590 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 005855ac
    PUSH 0x6491ff                       ; 005855ad | = "%f,%f,%f\n" | s_f_f_f_006491ff = %f,%f,%f

    PUSH ESI                            ; 005855b2
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 005855b3 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    MOV EAX,[0x006810c8]                ; 005855b8 | CDemonSet * g_CDemonSetPtr
    LEA EDI,[EBX + 0x154]               ; 005855bd
    MOV EDX,dword ptr [EAX + 0x15acac]  ; 005855c3 | DAT_0326ef24
    ADD ESP,0x14                        ; 005855c9
    CMP EDX,0x12                        ; 005855cc
    JL 0x005856e6                       ; 005855cf | LAB_005856e6
    ...
    PUSH ESI                            ; 005855e1
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 005855e2 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [EBX + 0x150]     ; 005855e7
    ADD ESP,0xc                         ; 005855ed
    TEST ECX,ECX                        ; 005855f0
    JNZ 0x0058560a                      ; 005855f2 | LAB_0058560a
        ;   XREF to: 0058560a (CONDITIONAL_JUMP)
    MOV EAX,[0x006810c8]                ; 005855f4 | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
    MOV EBP,dword ptr [EAX + 0x15acac]  ; 005855f9 | DAT_0326ef24
    PUSH EBP                            ; 005855ff
    PUSH ESI                            ; 00585600
    PUSH EDI                            ; 00585601
    CALL core_dcamera.cpp_loadCameraFog_FUN_00453e50 ; 00585602 | void core_dcamera.cpp_loadCameraFog_FUN_00453e50(SFog * fog, FILE * file_handle, int file_version)
        ;   XREF to: 00453e50 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00585607
    MOV EAX,[0x006810c8]                ; 0058560a | CDemonSet * g_CDemonSetPtr
        ;   Label: LAB_0058560a
    CMP dword ptr [EAX + 0x15acac],0x17 ; 0058560f | DAT_0326ef24
    JL 0x00585671                       ; 00585616 | LAB_00585671
        ;   XREF to: 00585671 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 00585618
    PUSH 0xff                           ; 00585619
    LEA EAX,[ESP + 0x8]                 ; 0058561e
    PUSH EAX                            ; 00585622
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 00585623 | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0058563f
    PUSH 0x64920d                       ; 00585640 | = "%f,%f,%f\n" | s_f_f_f_0064920d = %f,%f,%f

    PUSH ESI                            ; 00585645
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 00585646 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00585662
    PUSH 0x649217                       ; 00585663 | = "%f,%f,%f\n" | s_f_f_f_00649217 = %f,%f,%f

    PUSH ESI                            ; 00585668
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 00585669 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0058566e
    MOV EAX,[0x006810c8]                ; 00585671 | CDemonSet * g_CDemonSetPtr
        ;   Label: LAB_00585671
    CMP dword ptr [EAX + 0x15acac],0x17 ; 00585676 | DAT_0326ef24
    JL 0x005856a7                       ; 0058567d | LAB_005856a7
        ;   XREF to: 005856a7 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 0058567f
    PUSH 0xff                           ; 00585680
    LEA EAX,[ESP + 0x8]                 ; 00585685
    PUSH EAX                            ; 00585689
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 0058568a | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 0058569e
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0058569f | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005856a4
    MOV EAX,[0x006810c8]                ; 005856a7 | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
        ;   Label: LAB_005856a7
    CMP dword ptr [EAX + 0x15acac],0x1b ; 005856ac | DAT_0326ef24
    JZ 0x0058573e                       ; 005856b3 | LAB_0058573e
    ...
    PUSH EAX                            ; 005856d8
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 005856d9 | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005856de
    JMP 0x00585455                      ; 005856e1 | LAB_00585455
    ...
    JZ 0x00585727                       ; 00585715 | LAB_00585727
    ...
    JMP 0x0058560a                      ; 00585739 | LAB_0058560a
    ...
    PUSH EAX                            ; 00585748
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 00585749 | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 0058575d
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0058575e | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    MOV EBP,dword ptr [EBX + 0x140]     ; 00585763
    ADD ESP,0xc                         ; 00585769
    TEST EBP,EBP                        ; 0058576c
    JZ 0x005856c3                       ; 0058576e | LAB_005856c3
        ;   XREF to: 005856c3 (CONDITIONAL_JUMP)
    MOV EAX,0x649229                    ; 00585774 | = "..\\core\\setutil.cpp" | s_core_setutil_cpp_00649229 = ..\core\setutil.cpp
    MOV EDX,0xd5                        ; 00585779
    PUSH 0x64923d                       ; 0058577e | = "Panning cameras not supported, bucko!" | s_Panning_cameras_not_supp_0064923d = Panning cameras not supported, bucko!
    MOV [0x02f0ca48],EAX                ; 00585783 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 00585788 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0058578e | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
