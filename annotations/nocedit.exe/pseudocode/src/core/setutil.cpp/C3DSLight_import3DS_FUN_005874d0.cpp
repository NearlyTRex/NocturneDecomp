...
void __cdecl
core_setutil_cpp_C3DSLight_import3DS_FUN_005874d0(C3DSLight *this_ptr,_FILE *file_handle)

{
  ...
  fVar7 = atan2((float10)fStack_2c,(float10)fStack_24);
  (this_ptr->orient).y = (float)fVar7;
  fVar7 = atan2((float10)fStack_2c,x);
