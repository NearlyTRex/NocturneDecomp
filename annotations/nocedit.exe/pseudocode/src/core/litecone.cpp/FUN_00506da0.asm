...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_litecone_cpp_FUN_00506da0(void)
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH ESI                            ; 00506dc2
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e160 ; 00506dc3
    ...
    PUSH ESI                            ; 00506dd9
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e160 ; 00506dda
        ;   XREF to: 0040e160 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_CActorPropertyList_FUN_0040e160(CActorPropertyList * this_ptr)
    ...
    PUSH ESI                            ; 00506dee
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e330 ; 00506def
    ...
    PUSH ESI                            ; 00506e03
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e460 ; 00506e04
    ...
    PUSH ESI                            ; 00506e18
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e460 ; 00506e19
        ;   XREF to: 0040e460 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_CActorPropertyList_FUN_0040e460(CActorPropertyList * this_ptr)
