...
section .text
    ...
    PUSH 0x660ca0                       ; 00506e56 | g_CLightConeTypeInfo
        ;   Label: LAB_00506e56
    PUSH EBX                            ; 00506e5b
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 00506e5c
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 00506e61
    PUSH EAX                            ; 00506e64
    CALL crt_memory.c_free_FUN_005fe659 ; 00506e65
    ...
    PUSH EAX                            ; 00506e71
        ;   Label: LAB_00506e71
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 00506e72
