...
// Convention: __cdecl
// Signature: CLightCone * __cdecl core_litecone_cpp_CLightCone_dtor_FUN_00506e30(CLightCone *this_ptr,uint d1,uint d2)

#include "nocturne.h"

CLightCone * __cdecl
core_litecone_cpp_CLightCone_dtor_FUN_00506e30(CLightCone *this_ptr,uint d1,uint d2)
