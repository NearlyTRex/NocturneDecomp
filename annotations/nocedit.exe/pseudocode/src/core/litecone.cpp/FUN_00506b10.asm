...
;                               FUNCTION
; *****************************************************************************
; __cdecl CLightCone * core_litecone.cpp_FUN_00506b10(CLightCone * this_ptr)
;
; Parameters:
; CLightCone *     Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_litecone.cpp_FUN_00506ad0 at 00506aea
;
; Referenced Globals:
...
section .text
    ...
    PUSH EDX                            ; 00506b16
    CALL core_actor.cpp_CDemonActor_ctor_FUN_004088b0 ; 00506b17 | CDemonActor * core_actor.cpp_CDemonActor_ctor_FUN_004088b0(CDemonActor * this_ptr)
        ;   XREF to: 004088b0 (UNCONDITIONAL_CALL)
    MOV dword ptr [EAX + 0x154],0x660bb4 ; 00506b1c | CDemonActor_vtable PTR_core_litecone.cpp_FUN_00660bb4
    MOV ESI,0x631556                    ; 00506b26 | = "none" | s_none_00631556 = none
    ...
    PUSH EDI                            ; 00506b5e
    MOV AL,byte ptr [ESI]               ; 00506b5f | = "none" | s_none_00631556 = none
        ;   Label: LAB_00506b5f
    MOV byte ptr [EDI],AL               ; 00506b61
    CMP AL,0x0                          ; 00506b63
    JZ 0x00506b77                       ; 00506b65 | LAB_00506b77
        ;   XREF to: 00506b77 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 00506b67 | s_one_00631557
    ADD ESI,0x2                         ; 00506b6a
    MOV byte ptr [EDI + 0x1],AL         ; 00506b6d
    ADD EDI,0x2                         ; 00506b70
    CMP AL,0x0                          ; 00506b73
    JNZ 0x00506b5f                      ; 00506b75 | LAB_00506b5f
        ;   XREF to: 00506b5f (CONDITIONAL_JUMP)
    POP EDI                             ; 00506b77
        ;   Label: LAB_00506b77
    MOV ESI,0x63155b                    ; 00506b78 | = "none" | s_none_0063155b = none
    LEA EDI,[EDX + 0x1c8]               ; 00506b7d
    PUSH EDI                            ; 00506b83
    MOV AL,byte ptr [ESI]               ; 00506b84 | = "none" | s_none_0063155b = none
        ;   Label: LAB_00506b84
    MOV byte ptr [EDI],AL               ; 00506b86
    CMP AL,0x0                          ; 00506b88
    JZ 0x00506b9c                       ; 00506b8a | LAB_00506b9c
        ;   XREF to: 00506b9c (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 00506b8c | s_one_0063155c
    ADD ESI,0x2                         ; 00506b8f
    MOV byte ptr [EDI + 0x1],AL         ; 00506b92
    ADD EDI,0x2                         ; 00506b95
    CMP AL,0x0                          ; 00506b98
    JNZ 0x00506b84                      ; 00506b9a | LAB_00506b84
