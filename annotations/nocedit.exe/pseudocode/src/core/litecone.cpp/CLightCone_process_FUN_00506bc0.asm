...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_litecone_cpp_CLightCone_process_FUN_00506bc0(CLightCone *this_ptr,float delta_time)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00506bc0
        ;   Label: core_litecone.cpp_CLightCone_process_FUN_00506bc0
    PUSH ESI                            ; 00506bc1
