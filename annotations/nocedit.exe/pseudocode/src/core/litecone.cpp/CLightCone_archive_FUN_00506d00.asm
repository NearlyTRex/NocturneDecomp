...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_litecone_cpp_CLightCone_archive_FUN_00506d00(CLightCone *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00506d00
        ;   Label: core_litecone.cpp_CLightCone_archive_FUN_00506d00
    MOV EBX,dword ptr [ESP + 0x8]       ; 00506d01
    PUSH EBX                            ; 00506d05
    CALL core_actor.cpp_CDemonActor_archive_FUN_0040c1c0 ; 00506d06
    ...
    PUSH EAX                            ; 00506d19
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 00506d1a
    ...
    PUSH EAX                            ; 00506d2d
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 00506d2e
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH EAX                            ; 00506d4e
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 00506d4f
    ...
    PUSH EAX                            ; 00506d62
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 00506d63
    ...
    PUSH EBX                            ; 00506d76
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 00506d77
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveString_FUN_0040b5c0(char * string_buffer, char * property_type)
