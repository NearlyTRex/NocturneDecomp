...
section .text
    ...
    PUSH 0x22c                          ; 00506ad7
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1b0 ; 00506adc
    ...
    PUSH EAX                            ; 00506ae9
        ;   Label: LAB_00506ae9
    CALL core_litecone.cpp_FUN_00506b10 ; 00506aea
        ;   XREF to: 00506b10 (UNCONDITIONAL_CALL)  ; CLightCone * core_litecone.cpp_FUN_00506b10(CLightCone * this_ptr)
