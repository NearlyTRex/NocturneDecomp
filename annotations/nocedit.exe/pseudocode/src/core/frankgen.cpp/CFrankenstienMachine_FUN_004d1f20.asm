...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_frankgen_cpp_CFrankenstienMachine_FUN_004d1f20(CFrankenstienMachine *this_ptr)
;
; Parameters:
...
section .text
    ...
    FLD float ptr [ESP + 0x8]           ; 004d1f20
        ;   Label: core_frankgen.cpp_CFrankenstienMachine_FUN_004d1f20
