...
section .text
    ...
    PUSH EBX                            ; 004d2330
        ;   Label: core_frankgen.cpp_findLeader_FUN_004d2330
    PUSH ESI                            ; 004d2331
    PUSH EDI                            ; 004d2332
    PUSH EBP                            ; 004d2333
    ...
    PUSH EDI                            ; 004d234b
    MOV EBP,dword ptr [ESI + EAX*0x1 + 0x14d158] ; 004d234c | g_CDemonSetInstance.actors[0] | g_CDemonSetInstance.actors[1]
    PUSH EBP                            ; 004d2353
    ...
    JNZ 0x004d2260                      ; 004d235e
        ;   XREF to: 004d2260 (CONDITIONAL_JUMP)  ; LAB_004d2260
    INC EBX                             ; 004d2364
    ADD ESI,0x4                         ; 004d2365
    JMP 0x004d2338                      ; 004d2368
        ;   XREF to: 004d2338 (UNCONDITIONAL_JUMP)  ; LAB_004d2338
    MOV ECX,0x62ab4f                    ; 004d236a | = "..\\core\\frankgen.cpp"
        ;   Label: LAB_004d236a
    MOV EBX,0x1cf                       ; 004d236f
    PUSH 0x62ab64                       ; 004d2374 | = "CFrankenstienMachine::findLeader - no..."
    MOV dword ptr [0x02f0ca48],ECX      ; 004d2379 | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 004d237f | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004d2385
