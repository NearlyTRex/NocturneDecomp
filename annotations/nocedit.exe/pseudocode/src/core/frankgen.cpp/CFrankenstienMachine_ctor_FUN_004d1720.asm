...
;                               FUNCTION
; *****************************************************************************
; __cdecl CFrankenstienMachine * __cdecl core_frankgen_cpp_CFrankenstienMachine_ctor_FUN_004d1720(CFrankenstienMachine *this_ptr)
;
; Parameters:
; CFrankenstienMachine * Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_frankgen.cpp_factoryFunc_FUN_004d16e0 at 004d16fa
;
; Referenced Globals:
...
section .text
    ...
    MOV EAX,dword ptr [ESP + 0x4]       ; 004d1720
        ;   Label: core_frankgen.cpp_CFrankenstienMachine_ctor_FUN_004d1720
    PUSH EAX                            ; 004d1724
    ...
    CALL core_dmodel.cpp_CKeyFramedModelInstance_ctor_FUN_00478ce0 ; 004d174d
        ;   XREF to: 00478ce0 (UNCONDITIONAL_CALL)  ; CKeyFramedModelInstance * core_dmodel.cpp_CKeyFramedModelInstance_ctor_FUN_00478ce0(CKeyFramedModelInstance * this_ptr)
    MOV dword ptr [EAX + 0xfffffe48],0x65e684 ; 004d1752 | g_CFrankenstienMachineVTable
