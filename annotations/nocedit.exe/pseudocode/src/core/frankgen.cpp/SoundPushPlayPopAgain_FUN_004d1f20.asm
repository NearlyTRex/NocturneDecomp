...
section .text
    ...
    FNSTSW AX                           ; 004d1f2a
    SAHF                                ; 004d1f2c
    JC 0x004d1f42                       ; 004d1f2d | LAB_004d1f42
    ...
    FNSTSW AX                           ; 004d1f3d
    SAHF                                ; 004d1f3f
    JC 0x004d1f43                       ; 004d1f40 | LAB_004d1f43
        ;   XREF to: 004d1f43 (CONDITIONAL_JUMP)
    RET                                 ; 004d1f42
        ;   Label: LAB_004d1f42
    CALL sound_sndmain.cpp_pushSfxOptions_FUN_005a8c30 ; 004d1f43 | void sound_sndmain.cpp_pushSfxOptions_FUN_005a8c30()
        ;   Label: LAB_004d1f43
        ;   XREF to: 005a8c30 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [ESP + 0x4]       ; 004d1f48
    ADD EAX,0x490                       ; 004d1f4c
    PUSH EAX                            ; 004d1f51
    CALL sound_sndmain.cpp_setNextSfxTrackedFloatPosition_FUN_005a8940 ; 004d1f52 | void sound_sndmain.cpp_setNextSfxTrackedFloatPosition_FUN_005a8940(CVector3f * position_source_ptr)
        ;   XREF to: 005a8940 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004d1f57
    MOV EDX,dword ptr [ESP + 0xc]       ; 004d1f5a
    PUSH EDX                            ; 004d1f5e
    CALL sound_sndmain.cpp_startSfx_FUN_005a8e90 ; 004d1f5f | uint sound_sndmain.cpp_startSfx_FUN_005a8e90(char * filename)
