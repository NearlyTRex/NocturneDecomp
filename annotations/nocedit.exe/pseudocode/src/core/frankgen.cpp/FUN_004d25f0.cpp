...
// Convention: __cdecl
// Signature: void __cdecl core_frankgen_cpp_FUN_004d25f0(void)
...

{
  ...
  if (iVar2 != 0) {
    *(float *)(pCVar1[1].actor_name + 4) = *(float *)(pCVar1[1].actor_name + 4) + unaff_retaddr;
  }
  iVar2 = (*g_CKeysPtr->vtable->getAndClearKeyState)(g_CKeysPtr,0x33);
  if (iVar2 != 0) {
    *(float *)(pCVar1[1].actor_name + 4) = *(float *)(pCVar1[1].actor_name + 4) - in_stack_00000008;
  }
  if (*(float *)(pCVar1[1].actor_name + 4) < 0.0) {
    *(float *)(pCVar1[1].actor_name + 4) = 2300.0f + *(float *)(pCVar1[1].actor_name + 4);
  }
  if (2300.0f <= *(float *)(pCVar1[1].actor_name + 4)) {
    *(float *)(pCVar1[1].actor_name + 4) = *(float *)(pCVar1[1].actor_name + 4) - 2300.0f;
  }
