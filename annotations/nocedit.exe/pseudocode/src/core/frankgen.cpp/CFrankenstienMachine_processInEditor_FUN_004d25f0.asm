...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_frankgen_cpp_CFrankenstienMachine_processInEditor_FUN_004d25f0(CFrankenstienMachine *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004d25f0
        ;   Label: core_frankgen.cpp_CFrankenstienMachine_processInEditor_FUN_004d25f0
    PUSH ESI                            ; 004d25f1
    PUSH EDI                            ; 004d25f2
    PUSH EBP                            ; 004d25f3
