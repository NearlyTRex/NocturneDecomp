...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_frankgen.cpp_FUN_004d2500()
;
; Local Variables:
...
section .text
    ...
    PUSH ECX                            ; 004d250d
    CALL core_actor.cpp_CDemonActor_getPropertyList_FUN_0040d290 ; 004d250e | void core_actor.cpp_CDemonActor_getPropertyList_FUN_0040d290(CDemonActor * this_ptr, CActorPropertyList * property_list)
    ...
    PUSH 0x62abdf                       ; 004d2522 | = "Master frame (%0..%g)" | s_Master_frame_0_g_0062abdf = Master frame (%0..%g)
    LEA EAX,[ESP + 0xc]                 ; 004d2527
    PUSH EAX                            ; 004d252b
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 004d252c | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004d2531
    PUSH 0x0                            ; 004d2534
    CALL core_frankgen.cpp_CFrankenstienMachine_findLeader_FUN_004d2330 ; 004d2536 | undefined core_frankgen.cpp_CFrankenstienMachine_findLeader_FUN_004d2330()
    ...
    PUSH EBX                            ; 004d254a
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e160 ; 004d254b | void core_actor.cpp_CActorPropertyList_FUN_0040e160(CActorPropertyList * this_ptr)
