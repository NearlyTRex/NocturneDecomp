...
section .text
    ...
    JA 0x004d2611                       ; 004d2608 | caseD_6
        ;   XREF to: 004d2611 (CONDITIONAL_JUMP)
    JMP dword ptr [ESI*0x4 + 0x4d25c8]  ; 004d260a | void * switchdataD_004d25c8
        ;   Label: switchD
    PUSH 0x2a                           ; 004d2611
        ;   Label: caseD_7
    MOV EAX,[0x0067cf44]                ; 004d2613 | CKeys * g_CKeysPtr
    MOV EDX,0x3f800000                  ; 004d2618
    PUSH EAX                            ; 004d261d | void * g_CKeysPtr
    MOV dword ptr [ESP + 0x8],EDX       ; 004d261e
    MOV EDX,dword ptr [EAX]             ; 004d2622 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 004d2624
    ADD ESP,0x8                         ; 004d2626
    TEST EAX,EAX                        ; 004d2629
    JZ 0x004d2634                       ; 004d262b | LAB_004d2634
        ;   XREF to: 004d2634 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP],0x40800000      ; 004d262d
    PUSH 0x38                           ; 004d2634
        ;   Label: LAB_004d2634
    MOV EAX,[0x0067cf44]                ; 004d2636 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 004d263b | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004d263c | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 004d263e
    ADD ESP,0x8                         ; 004d2640
    TEST EAX,EAX                        ; 004d2643
    JZ 0x004d2653                       ; 004d2645 | LAB_004d2653
        ;   XREF to: 004d2653 (CONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 004d2647
    FMUL double ptr [0x0062ac05]        ; 004d264a | double DOUBLE_0062ac05
    FSTP float ptr [ESP]                ; 004d2650
    CALL core_frankgen.cpp_CFrankenstienMachine_findLeader_FUN_004d2330 ; 004d2653 | undefined core_frankgen.cpp_CFrankenstienMachine_findLeader_FUN_004d2330()
        ;   Label: LAB_004d2653
        ;   XREF to: 004d2330 (UNCONDITIONAL_CALL)
    PUSH 0x34                           ; 004d2658
    MOV EDI,EAX                         ; 004d265a
    MOV ESI,EAX                         ; 004d265c
    MOV EAX,[0x0067cf44]                ; 004d265e | CKeys * g_CKeysPtr
    PUSH EAX                            ; 004d2663 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 004d2664 | void * g_CKeysPtr
    CALL dword ptr [EDX + 0x4]          ; 004d2666
    ADD ESP,0x8                         ; 004d2669
    TEST EAX,EAX                        ; 004d266c
    JZ 0x004d267f                       ; 004d266e | LAB_004d267f
    ...
    PUSH 0x33                           ; 004d267f
        ;   Label: LAB_004d267f
    MOV EAX,[0x0067cf44]                ; 004d2681 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 004d2686 | void * g_CKeysPtr
    MOV EDI,dword ptr [EAX]             ; 004d2687 | void * g_CKeysPtr
    CALL dword ptr [EDI + 0x4]          ; 004d2689
    ADD ESP,0x8                         ; 004d268c
    TEST EAX,EAX                        ; 004d268f
    JZ 0x004d26a2                       ; 004d2691 | LAB_004d26a2
    ...
    FNSTSW AX                           ; 004d26ac
    SAHF                                ; 004d26ae
    JBE 0x004d26c3                      ; 004d26af | LAB_004d26c3
    ...
    FNSTSW AX                           ; 004d26cf
    SAHF                                ; 004d26d1
    JC 0x004d26e6                       ; 004d26d2 | LAB_004d26e6
    ...
    CALL core_frankgen.cpp_LoadModel_FUN_004d2190 ; 004d26f3 | undefined core_frankgen.cpp_LoadModel_FUN_004d2190()
    ...
    CALL core_actor.cpp_CDemonActor_processInEditor_FUN_0040d040 ; 004d2706 | void core_actor.cpp_CDemonActor_processInEditor_FUN_0040d040(CDemonActor * this_ptr)
    ...
    JMP 0x004d2611                      ; 004d2720 | caseD_6
        ;   XREF to: 004d2611 (UNCONDITIONAL_JUMP)
    PUSH EBX                            ; 004d2725
        ;   Label: caseD_5
    CALL core_actor.cpp_CDemonActor_processInEditor_FUN_0040d040 ; 004d2726 | void core_actor.cpp_CDemonActor_processInEditor_FUN_0040d040(CDemonActor * this_ptr)
        ;   XREF to: 0040d040 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004d272b
    JMP 0x004d2611                      ; 004d272e | caseD_6
        ;   XREF to: 004d2611 (UNCONDITIONAL_JUMP)
