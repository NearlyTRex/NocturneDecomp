...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_frankgen_cpp_CFrankenstienMachine_FUN_004d23a0(CFrankenstienMachine *this_ptr)
;
; Parameters:
...
;
; XREF[1]:
;   core_frankgen.cpp_CFrankenstienMachine_FUN_004d2190 at 004d22c4
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 004d23a0
        ;   Label: core_frankgen.cpp_CFrankenstienMachine_FUN_004d23a0
