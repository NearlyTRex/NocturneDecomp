...
;                               FUNCTION
; *****************************************************************************
; __cdecl CFrankenstienMachine * __cdecl core_frankgen_cpp_CFrankenstienMachine_dtor_FUN_004d28a0(CFrankenstienMachine *this_ptr,uint flags)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 004d28f8
        ;   Label: LAB_004d28f8
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 004d28f9
