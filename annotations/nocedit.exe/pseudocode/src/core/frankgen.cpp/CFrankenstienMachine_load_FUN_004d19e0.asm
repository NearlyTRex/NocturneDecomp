...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_frankgen_cpp_CFrankenstienMachine_load_FUN_004d19e0(void)
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004d19e5
    CALL core_actor.cpp_CDemonActor_serialize_FUN_0040c1c0 ; 004d19e6
    ...
    PUSH EAX                            ; 004d19f9
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 004d19fa
    ...
    PUSH EAX                            ; 004d1a0d
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 004d1a0e
