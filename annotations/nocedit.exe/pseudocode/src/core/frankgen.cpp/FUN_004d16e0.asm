...
section .text
    ...
    PUSH EAX                            ; 004d16f9
        ;   Label: LAB_004d16f9
    CALL core_frankgen.cpp_FUN_004d1720 ; 004d16fa
        ;   XREF to: 004d1720 (UNCONDITIONAL_CALL)  ; CFrankenstienMachine * core_frankgen.cpp_FUN_004d1720(CFrankenstienMachine * this_ptr)
