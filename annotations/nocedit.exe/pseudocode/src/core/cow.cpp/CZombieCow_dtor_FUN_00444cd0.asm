...
section .text
    ...
    PUSH EBX                            ; 00444ce8
    CALL core_armour.cpp_CFlame_arrdtor50_FUN_00412720 ; 00444ce9
    ...
    PUSH EAX                            ; 00444cf8
    CALL core_armour.cpp_SFire_arrdtor50_FUN_00412700 ; 00444cf9
    ...
    PUSH EAX                            ; 00444d08
    CALL core_armour.cpp_CVector3f_arrdtor15_FUN_004126e0 ; 00444d09
    ...
    PUSH EAX                            ; 00444d18
    CALL core_armour.cpp_CVector3f_arrdtor15_FUN_004126e0 ; 00444d19
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; CVector3f * core_armour.cpp_CVector3f_arrdtor15_FUN_004126e0(CVector3f * this_ptr, uint flags)
    ...
    PUSH EAX                            ; 00444d7c
        ;   Label: LAB_00444d7c
    CALL shape_memdbg.cpp_debugFreeChecked_FUN_0050f210 ; 00444d7d
