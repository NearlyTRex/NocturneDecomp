...
section .text
    ...
    PUSH 0x36                           ; 00444100
        ;   Label: core_cow.cpp_factoryFuncZombieCow_FUN_00444100
    ...
    PUSH EAX                            ; 00444119
        ;   Label: LAB_00444119
    CALL core_cow.cpp_CZombieCow_ctor_FUN_00444140 ; 0044411a
        ;   XREF to: 00444140 (UNCONDITIONAL_CALL)  ; CZombieCow * core_cow.cpp_CZombieCow_ctor_FUN_00444140(CZombieCow * this_ptr)
