...

{
  ...
  *(float *)((in_stack_00000004->base).unk1 + 0x28) =
       (in_stack_00000004->base).model.accumulated_root_motion.z;
  *(float *)((in_stack_00000004->base).unk1 + 0x2c) = in_stack_00000008 * fVar5 * fVar2 * fVar4;
      ...
      if (extraout_EAX == 0) {
        ...
        if (*(int *)(in_stack_00000004->unk2 + 4) != 0) {
          ...
          if (extraout_EAX_00 == 0) {
            uVar11 = (*((in_stack_00000004->base).base.vtable._ub)->playSound)
...
switchD_0044482d_caseD_3:
  ...
  if (iVar6 != 0) {
    ...
    *(float *)((in_stack_00000004->base).unk1 + 0x20) =
    ...
    local_48 = *(float *)((in_stack_00000004->base).unk1 + 0x1c) * in_stack_00000008;
    local_44 = *(float *)((in_stack_00000004->base).unk1 + 0x20) * in_stack_00000008;
    pcVar1 = (in_stack_00000004->base).unk1 + 0x10;
    local_40 = in_stack_00000008 * *(float *)((in_stack_00000004->base).unk1 + 0x24);
    pCVar10 = &(in_stack_00000004->base).model.accumulated_root_motion;
    local_60 = local_48 + *(float *)pcVar1;
    local_5c = local_44 + *(float *)((in_stack_00000004->base).unk1 + 0x14);
    local_58 = local_40 + *(float *)((in_stack_00000004->base).unk1 + 0x18);
    local_6c = local_60 + pCVar10->x;
    local_68 = local_5c + (in_stack_00000004->base).model.accumulated_root_motion.y;
    local_64 = local_58 + (in_stack_00000004->base).model.accumulated_root_motion.z;
