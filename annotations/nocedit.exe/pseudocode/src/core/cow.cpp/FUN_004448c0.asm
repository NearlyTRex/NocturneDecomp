...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_cow.cpp_FUN_004448c0()
;
; Local Variables:
; undefined4       Stack[-0x14]:4  local_14
;
; XREF[1]:
;   core_cow.cpp_FUN_00444b40 at 00444b4d
;
; Referenced Globals:
...
section .text
    ...
    FNSTSW AX                           ; 004448d6
    SAHF                                ; 004448d8
    JNC 0x00444905                      ; 004448d9 | default
        ;   XREF to: 00444905 (CONDITIONAL_JUMP)
    CMP dword ptr [ESI],-0x1            ; 004448db
    JNZ 0x00444905                      ; 004448de | default
        ;   XREF to: 00444905 (CONDITIONAL_JUMP)
    CALL crt_stdlib.c_rand_FUN_005feb5c ; 004448e0 | int crt_stdlib.c_rand_FUN_005feb5c()
    ...
    JA 0x00444905                       ; 004448f4 | default
        ;   XREF to: 00444905 (CONDITIONAL_JUMP)
    JMP dword ptr [EDX*0x4 + 0x4448b0]  ; 004448f6 | void * switchdataD_004448b0
        ;   Label: switchD
    ...
    JNZ 0x00444ad4                      ; 0044490f | LAB_00444ad4
        ;   XREF to: 00444ad4 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESI + 0x2c]      ; 00444915
        ;   Label: LAB_00444915
    MOV dword ptr [ESP + 0x8],EAX       ; 00444918
    MOV EAX,[0x0067b654]                ; 0044491c | CGame g_CGameInstance | CGame * g_CGamePtr
    CMP dword ptr [EAX + 0x1e0],0x0     ; 00444921 | g_CGameInstance.field57_0x1e0
    JZ 0x00444932                       ; 00444928 | LAB_00444932
        ;   XREF to: 00444932 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x8],0x3f800000 ; 0044492a
    MOV EAX,[0x0067b654]                ; 00444932 | CGame g_CGameInstance | CGame * g_CGamePtr
        ;   Label: LAB_00444932
    MOV EDX,dword ptr [EAX + 0x14]      ; 00444937 | g_CGameInstance.blood_flag
    TEST EDX,EDX                        ; 0044493a
    JNZ 0x00444942                      ; 0044493c | LAB_00444942
        ;   XREF to: 00444942 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x8],EDX       ; 0044493e
    PUSH dword ptr [ESP + 0x8]          ; 00444942
        ;   Label: LAB_00444942
    CALL core_actor.cpp_randomChance_FUN_0040cd10 ; 00444946 | int core_actor.cpp_randomChance_FUN_0040cd10(float probability_threshold)
        ;   XREF to: 0040cd10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0044494b
    TEST EAX,EAX                        ; 0044494e
    JZ 0x00444a8d                       ; 00444950 | LAB_00444a8d
    ...
    PUSH EAX                            ; 00444968
    CALL core_bodypart.cpp_CreateBodyPart_FUN_00418e10 ; 00444969 | undefined core_bodypart.cpp_CreateBodyPart_FUN_00418e10()
    ...
    CALL core_charactr.cpp_CCharacter_FUN_0042bd30 ; 0044497a | void core_charactr.cpp_CCharacter_FUN_0042bd30(CCharacter * this_ptr)
    ...
    JNZ 0x00444a3d                      ; 0044498c | LAB_00444a3d
    ...
    PUSH EAX                            ; 0044499b
    PUSH EBX                            ; 0044499c
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 0044499d | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
    ...
    PUSH EDX                            ; 004449ae
    PUSH EBX                            ; 004449af
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 004449b0 | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ...
    PUSH ECX                            ; 004449c1
    PUSH EBX                            ; 004449c2
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 004449c3 | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 004449d4
    PUSH EBX                            ; 004449d5
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 004449d6 | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDX                            ; 004449e7
    PUSH EBX                            ; 004449e8
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 004449e9 | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ...
    PUSH ECX                            ; 004449fa
    PUSH EBX                            ; 004449fb
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 004449fc | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00444a0d
    PUSH EBX                            ; 00444a0e
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 00444a0f | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDX                            ; 00444a20
    PUSH EBX                            ; 00444a21
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 00444a22 | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ...
    PUSH ECX                            ; 00444a33
    PUSH EBX                            ; 00444a34
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 00444a35 | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00444a3a
    PUSH 0x619588                       ; 00444a3d | = "limb?.wav" | s_limb_wav_00619588 = limb?.wav
        ;   Label: LAB_00444a3d
    PUSH EBX                            ; 00444a42
    CALL core_charactr.cpp_CCharacter_FUN_0042f300 ; 00444a43 | void core_charactr.cpp_CCharacter_FUN_0042f300(CCharacter * this_ptr)
        ;   XREF to: 0042f300 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00444a48
    PUSH EBP                            ; 00444a4b
    CALL core_bodypart.cpp_FUN_0041a050 ; 00444a4c | undefined core_bodypart.cpp_FUN_0041a050()
