...
section .text
    ...
    PUSH EBX                            ; 00444ca0
        ;   Label: core_cow.cpp_CZombieCow_addFilesToExtract_FUN_00444ca0
    MOV EDX,dword ptr [ESP + 0xc]       ; 00444ca1
    PUSH EDX                            ; 00444ca5
    MOV ECX,dword ptr [ESP + 0xc]       ; 00444ca6
    PUSH ECX                            ; 00444caa
    CALL core_actor.cpp_CDemonActor_addFilesToExtract_FUN_0040cfd0 ; 00444cab
    ...
    PUSH EAX                            ; 00444cc1
    CALL core_skeledit.cpp_CDeformableModelInstance_addFilesToExtract_FUN_0058a260 ; 00444cc2
