...
;                               FUNCTION
; *****************************************************************************
; __cdecl CZombieCow * __cdecl core_cow_cpp_FUN_00444cd0 (CZombieCow *this_ptr,uint d1,uint d2,uint d3,uint d4,uint d5,uint d6,uint d7,uint d8)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00444ce8
    CALL core_backgnd.cpp_freeFlames_FUN_00412720 ; 00444ce9
    ...
    PUSH EAX                            ; 00444cf8
    CALL core_backgnd.cpp_freeFires_FUN_00412700 ; 00444cf9
    ...
    PUSH EAX                            ; 00444d08
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 00444d09
    ...
    PUSH EAX                            ; 00444d18
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 00444d19
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; int core_backgnd.cpp_cleanupVector_FUN_004126e0(CVector3f * * objs)
    ADD ESP,0x8                         ; 00444d1e
    PUSH 0x0                            ; 00444d21
    SUB EAX,0x1c8                       ; 00444d23
    PUSH EAX                            ; 00444d28
    CALL core_cloth.cpp_FUN_0043bf80    ; 00444d29
    ...
    PUSH 0x65c220                       ; 00444d61 | g_CZombieCowTypeInfo
        ;   Label: LAB_00444d61
    PUSH EBX                            ; 00444d66
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 00444d67
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 00444d6c
    PUSH EAX                            ; 00444d6f
    CALL crt_memory.c_free_FUN_005fe659 ; 00444d70
