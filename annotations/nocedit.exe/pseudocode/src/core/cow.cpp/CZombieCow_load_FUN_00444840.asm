...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_cow_cpp_CZombieCow_load_FUN_00444840(void)
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00444845
    CALL core_enemy.cpp_CEnemy_serialize_FUN_004a9660 ; 00444846
    ...
    PUSH EAX                            ; 00444859
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 0044485a
    ...
    PUSH EAX                            ; 0044486d
    CALL core_actor.cpp_serializedDeformableModelInstance_FUN_0040b970 ; 0044486e
    ...
    PUSH EBX                            ; 0044488c
    CALL core_actor.cpp_serializeMotionState_FUN_0040b9f0 ; 0044488d
    ...
    PUSH EAX                            ; 004448a2
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 004448a3
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
