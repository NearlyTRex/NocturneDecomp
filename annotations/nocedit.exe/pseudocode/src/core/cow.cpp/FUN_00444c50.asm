...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_cow_cpp_FUN_00444c50(void)
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH ESI                            ; 00444c5a
    PUSH EBX                            ; 00444c5b
    CALL core_enemy.cpp_CEnemy_FUN_004aa170 ; 00444c5c
    ...
    PUSH ESI                            ; 00444c72
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e4a0 ; 00444c73
    ...
    PUSH ESI                            ; 00444c81
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e4d0 ; 00444c82
