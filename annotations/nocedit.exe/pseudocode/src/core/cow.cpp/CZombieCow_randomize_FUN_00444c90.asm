...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_cow_cpp_CZombieCow_randomize_FUN_00444c90(CZombieCow *this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x4]       ; 00444c90
        ;   Label: core_cow.cpp_CZombieCow_randomize_FUN_00444c90
    PUSH EDX                            ; 00444c94
    CALL core_enemy.cpp_CEnemy_randomize_FUN_004aa250 ; 00444c95
