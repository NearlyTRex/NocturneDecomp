...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_setcolid.cpp_CDemonSet_testVoxelRaycast_FUN_00572510(CDemonSet * this_ptr, CVector3f * start_pos, CVector3f * end_pos)
;
; Parameters:
...
;
; XREF[2]:
;   core_enemy.cpp_FUN_004a9a50 at 004a9ae3
;   core_mimic.cpp_FUN_0051fcc0 at 0051ffc2
;
; Referenced Globals:
