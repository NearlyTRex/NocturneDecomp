...
; SCollisionInfo   Stack[-0xf0]:40  local_f0
; CBoundingBox3D   Stack[-0xc8]:24  CStack_c8
; CBoundingBox3D   Stack[-0xb0]:24  CStack_b0
; CBoundingBox3D   Stack[-0x98]:24  local_98
...
; CVector3f[4]     Stack[-0x50]:48  aCStack_50
...
;   core_stranger.cpp_CStranger_tryPlaceObject_FUN_005c2850 at 005c2e1e
;   core_trash.cpp_CTrash_process_FUN_005decf0 at 005df280
...
;   core_dtrace.cpp_CDemonRaytrace_testCylinderCollision_FUN_00496c60
;   core_dtrace.cpp_initIntersectionCylinder_FUN_00496b90
...
section .text
    ...
    PUSH EBX                            ; 00573470
        ;   Label: core_setcolid.cpp_CDemonSet_testCylinderCollision_FUN_00573470
    PUSH ESI                            ; 00573471
    PUSH EDI                            ; 00573472
    PUSH EBP                            ; 00573473
    ...
    PUSH EAX                            ; 0057349e
    CALL core_dtrace.cpp_initIntersectionCylinder_FUN_00496b90 ; 0057349f
        ;   XREF to: 00496b90 (UNCONDITIONAL_CALL)  ; void core_dtrace.cpp_initIntersectionCylinder_FUN_00496b90(SIntersectXZCylinder * this_ptr, float start_x, float start_z, float dir_x, ...)
    ...
    CALL core_dtrace.cpp_CDemonRaytrace_testCylinderCollision_FUN_00496c60 ; 005734c6
        ;   XREF to: 00496c60 (UNCONDITIONAL_CALL)  ; void core_dtrace.cpp_CDemonRaytrace_testCylinderCollision_FUN_00496c60(CDemonRaytrace * this_ptr, SIntersectXZCylinder * cylinder)
    ...
    PUSH EAX                            ; 00573831
    CALL core_dtrace.cpp_initIntersectionCylinder_FUN_00496b90 ; 00573832
        ;   XREF to: 00496b90 (UNCONDITIONAL_CALL)  ; void core_dtrace.cpp_initIntersectionCylinder_FUN_00496b90(SIntersectXZCylinder * this_ptr, float start_x, float start_z, float dir_x, ...)
    ...
    PUSH EAX                            ; 00573cae
    CALL core_dtrace.cpp_initIntersectionCylinder_FUN_00496b90 ; 00573caf
        ;   XREF to: 00496b90 (UNCONDITIONAL_CALL)  ; void core_dtrace.cpp_initIntersectionCylinder_FUN_00496b90(SIntersectXZCylinder * this_ptr, float start_x, float start_z, float dir_x, ...)
