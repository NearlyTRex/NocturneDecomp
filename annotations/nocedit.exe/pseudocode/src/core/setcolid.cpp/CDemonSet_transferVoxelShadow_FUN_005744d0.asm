...
;
; Called Functions:
;   core_dtrace.cpp_CDemonRaytrace_transferShadowVoxels_FUN_00499f10
...
section .text
    ...
    PUSH EBX                            ; 005744d0
        ;   Label: core_setcolid.cpp_CDemonSet_transferVoxelShadow_FUN_005744d0
    ...
    CALL core_dtrace.cpp_CDemonRaytrace_transferShadowVoxels_FUN_00499f10 ; 0057452a
        ;   XREF to: 00499f10 (UNCONDITIONAL_CALL)  ; void core_dtrace.cpp_CDemonRaytrace_transferShadowVoxels_FUN_00499f10(CDemonRaytrace * this_ptr, CVector3f * offset, CVector3f * rotation, CVector3f * start, ...)
    ADD ESP,0x14                        ; 0057452f
    CALL core_path.cpp_resetAllPathMaps_FUN_00548590 ; 00574532
