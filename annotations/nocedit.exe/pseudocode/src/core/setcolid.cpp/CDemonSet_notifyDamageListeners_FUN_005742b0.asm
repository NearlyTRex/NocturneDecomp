...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_setcolid.cpp_CDemonSet_notifyDamageListeners_FUN_005742b0(CDemonSet * this_ptr, SDamageInfo * damage_info, CVector3f * actor_position, void * unknown_param)
;
; Parameters:
...
section .text
    ...
    JLE 0x005743ae                      ; 005742c8 | LAB_005743ae
    ...
    JL 0x005742f9                       ; 005743a7 | LAB_005742f9
