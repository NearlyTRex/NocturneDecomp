...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_setcolid_cpp_CDemonSet_ignore_FUN_005741b0(CDemonSet *this_ptr,CDemonActor *actor)
;
; Parameters:
...
;   core_boneguy.cpp_CBoneGuy_process_FUN_0041bf90 at 0041c452
;   core_charactr.cpp_CCharacter_findSomethingToLookAt_FUN_0042d5a0 at 0042d8fd
;   core_charactr.cpp_CCharacter_moveAndCollide_FUN_00428f40 at 00429083
