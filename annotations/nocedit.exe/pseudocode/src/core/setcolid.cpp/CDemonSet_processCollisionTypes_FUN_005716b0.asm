...
;                               FUNCTION
; *****************************************************************************
; __cdecl float core_setcolid.cpp_CDemonSet_processCollisionTypes_FUN_005716b0(CDemonSet * this_ptr, CVector3f * position, float radius)
;
; Parameters:
...
section .text
    ...
    FNSTSW AX                           ; 005716e6
    SAHF                                ; 005716e8
    JC 0x00571945                       ; 005716e9 | LAB_00571945
        ;   XREF to: 00571945 (CONDITIONAL_JUMP)
    PUSH EDX                            ; 005716ef
    PUSH ESI                            ; 005716f0
    PUSH EBX                            ; 005716f1
    PUSH 0x3277d14                      ; 005716f2 | CDemonRaytrace g_CDemonRaytraceInstance
    CALL core_dtrace.cpp_CDemonRaytrace_getGroundHeight_FUN_004966f0 ; 005716f7 | float core_dtrace.cpp_CDemonRaytrace_getGroundHeight_FUN_004966f0(CDemonRaytrace * this_ptr, CVector3f * pos, int * hit_flag, CVector3f * normal_out)
    ...
    JNZ 0x00571737                      ; 00571722 | LAB_00571737
    ...
    JZ 0x0057175f                       ; 00571740 | LAB_0057175f
    ...
    FLD float ptr [ESP + 0x224]         ; 0057175f
        ;   Label: LAB_0057175f
    FADD float ptr [0x00646246]         ; 00571766 | float FLOAT_00646246
    ...
    JZ 0x00571875                       ; 00571849 | LAB_00571875
    ...
    FADD float ptr [0x0064624a]         ; 00571883 | float FLOAT_0064624a
    PUSH EAX                            ; 00571889
    FSTP float ptr [ESP + 0x210]        ; 0057188a
    CALL core_setcolid.cpp_SCollisionInfo_ctor_FUN_005743c0 ; 00571891 | SCollisionInfo * core_setcolid.cpp_SCollisionInfo_ctor_FUN_005743c0(SCollisionInfo * this_ptr)
    ...
    JLE 0x0057191e                      ; 005718b8 | LAB_0057191e
    ...
    PUSH ESI                            ; 005718dc
    CALL core_setcolid.cpp_CDemonSet_isActorIgnored_FUN_00572e20 ; 005718dd | int core_setcolid.cpp_CDemonSet_isActorIgnored_FUN_00572e20(CDemonSet * this_ptr, CDemonActor * actor)
        ;   XREF to: 00572e20 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005718e2
    TEST EAX,EAX                        ; 005718e5
    JZ 0x0057196f                       ; 005718e7 | LAB_0057196f
    ...
    JL 0x005718c7                       ; 0057191c | LAB_005718c7
    ...
    JNZ 0x00572314                      ; 0057192d | LAB_00572314
    ...
    PUSH EBX                            ; 0057194e
    PUSH 0x3277d14                      ; 0057194f | CDemonRaytrace g_CDemonRaytraceInstance
    CALL core_dtrace.cpp_CDemonRaytrace_cylinderGroundCheck_FUN_00496950 ; 00571954 | float core_dtrace.cpp_CDemonRaytrace_cylinderGroundCheck_FUN_00496950(CDemonRaytrace * this_ptr, CVector3f * pos, float radius, int * hit_flag, ...)
    ...
    JMP 0x0057170d                      ; 0057196a | LAB_0057170d
        ;   XREF to: 0057170d (UNCONDITIONAL_JUMP)
    MOV EAX,[0x03f6b9dc]                ; 0057196f | g_CSpikeClassInfo.name_hash
        ;   Label: LAB_0057196f
    PUSH EAX                            ; 00571974
    PUSH EDI                            ; 00571975
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 00571976 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0057197b
    TEST EAX,EAX                        ; 0057197e
    JNZ 0x005718ed                      ; 00571980 | LAB_005718ed
    ...
    JZ 0x005718ed                       ; 005719ad | LAB_005718ed
        ;   XREF to: 005718ed (CONDITIONAL_JUMP)
    PUSH EAX                            ; 005719b3
    ...
    PUSH EAX                            ; 005719c3
    PUSH EDI                            ; 005719c4
    CALL core_actor.cpp_CDemonActor_getWorldBoundingBox_FUN_00409270 ; 005719c5 | CBoundingBox3D * core_actor.cpp_CDemonActor_getWorldBoundingBox_FUN_00409270(CDemonActor * this_ptr, CBoundingBox3D * output_bbox, SCollisionInfo * collision_info, int bounding_box_type)
        ;   XREF to: 00409270 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 005719ca
    PUSH EAX                            ; 005719cd
    LEA EAX,[ESP + 0x20c]               ; 005719ce
    PUSH EAX                            ; 005719d5
    CALL core_box.cpp_CBoundingBox3D_doesBoxIntersect_FUN_00421010 ; 005719d6 | int core_box.cpp_CBoundingBox3D_doesBoxIntersect_FUN_00421010(CBoundingBox3D * this_ptr, CBoundingBox3D * other)
        ;   XREF to: 00421010 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 005719db
    TEST EAX,EAX                        ; 005719de
    JZ 0x005718ed                       ; 005719e0 | LAB_005718ed
        ;   XREF to: 005718ed (CONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0x15f6dc],0x0  ; 005719e6
    JZ 0x005720f8                       ; 005719ed | LAB_005720f8
        ;   XREF to: 005720f8 (CONDITIONAL_JUMP)
    CMP EBX,0x2                         ; 005719f3
        ;   Label: LAB_005719f3
    JNC 0x005722dd                      ; 005719f6 | LAB_005722dd
        ;   XREF to: 005722dd (CONDITIONAL_JUMP)
    CMP EBX,0x1                         ; 005719fc
    JNZ 0x005722ec                      ; 005719ff | LAB_005722ec
        ;   XREF to: 005722ec (CONDITIONAL_JUMP)
    PUSH 0x6598c0                       ; 00571a05 | WatcomTypeInfo g_CVectorTypeInfo
    PUSH 0x8                            ; 00571a0a
    LEA EAX,[ESP + 0x8]                 ; 00571a0c
    PUSH EAX                            ; 00571a10
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 00571a11 | void * crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
    ...
    PUSH EAX                            ; 00571a44
    CALL core_box.cpp_CBoundingBox3D_getCorner_FUN_004202b0 ; 00571a45 | CVector3f * core_box.cpp_CBoundingBox3D_getCorner_FUN_004202b0(CBoundingBox3D * this_ptr, CVector3f * out_point, uint corner_index)
    ...
    PUSH EAX                            ; 00571a55
    PUSH EDI                            ; 00571a56
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 00571a57 | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
        ;   XREF to: 00408ec0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00571a5c
    CMP EBX,EAX                         ; 00571a5f
    JZ 0x00571a73                       ; 00571a61 | LAB_00571a73
    ...
    JL 0x00571a34                       ; 00571a7a | LAB_00571a34
    ...
    PUSH EAX                            ; 00571a92
    CALL core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790 ; 00571a93 | void core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790(CDemonTriangle * this_ptr, CVector3f * vertex1, CVector3f * vertex2, CVector3f * vertex3)
    ...
    PUSH EAX                            ; 00571ab9
    CALL core_dtri.cpp_rayTriangleFloorTest_FUN_0049b2f0 ; 00571aba | int core_dtri.cpp_rayTriangleFloorTest_FUN_0049b2f0(CDemonTriangle * triangle, float x, float z, float * out_height)
    ...
    PUSH EAX                            ; 00571ada
    CALL core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790 ; 00571adb | void core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790(CDemonTriangle * this_ptr, CVector3f * vertex1, CVector3f * vertex2, CVector3f * vertex3)
        ;   XREF to: 0049a790 (UNCONDITIONAL_CALL)
    ...
    CALL core_dtri.cpp_rayTriangleFloorTest_FUN_0049b2f0 ; 00571b04 | int core_dtri.cpp_rayTriangleFloorTest_FUN_0049b2f0(CDemonTriangle * triangle, float x, float z, float * out_height)
        ;   XREF to: 0049b2f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00571b09
    OR ESI,EAX                          ; 00571b0c
    JZ 0x00571b86                       ; 00571b0e | LAB_00571b86
    ...
    JZ 0x00571b86                       ; 00571b5a | LAB_00571b86
        ;   XREF to: 00571b86 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 00571b9c
    CALL core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790 ; 00571b9d | void core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790(CDemonTriangle * this_ptr, CVector3f * vertex1, CVector3f * vertex2, CVector3f * vertex3)
        ;   XREF to: 0049a790 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00571bc3
    OR EBX,ESI                          ; 00571bc4
    CALL core_dtri.cpp_rayTriangleFloorTest_FUN_0049b2f0 ; 00571bc6 | int core_dtri.cpp_rayTriangleFloorTest_FUN_0049b2f0(CDemonTriangle * triangle, float x, float z, float * out_height)
        ;   XREF to: 0049b2f0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00571be6
    CALL core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790 ; 00571be7 | void core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790(CDemonTriangle * this_ptr, CVector3f * vertex1, CVector3f * vertex2, CVector3f * vertex3)
        ;   XREF to: 0049a790 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00571c0d
    CALL core_dtri.cpp_rayTriangleFloorTest_FUN_0049b2f0 ; 00571c0e | int core_dtri.cpp_rayTriangleFloorTest_FUN_0049b2f0(CDemonTriangle * triangle, float x, float z, float * out_height)
        ;   XREF to: 0049b2f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00571c13
    OR ESI,EAX                          ; 00571c16
    JZ 0x00571c90                       ; 00571c18 | LAB_00571c90
    ...
    JZ 0x00571c90                       ; 00571c64 | LAB_00571c90
        ;   XREF to: 00571c90 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 00571ca6
    CALL core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790 ; 00571ca7 | void core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790(CDemonTriangle * this_ptr, CVector3f * vertex1, CVector3f * vertex2, CVector3f * vertex3)
        ;   XREF to: 0049a790 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00571ccd
    OR EBX,ESI                          ; 00571cce
    CALL core_dtri.cpp_rayTriangleFloorTest_FUN_0049b2f0 ; 00571cd0 | int core_dtri.cpp_rayTriangleFloorTest_FUN_0049b2f0(CDemonTriangle * triangle, float x, float z, float * out_height)
        ;   XREF to: 0049b2f0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00571cf0
    CALL core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790 ; 00571cf1 | void core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790(CDemonTriangle * this_ptr, CVector3f * vertex1, CVector3f * vertex2, CVector3f * vertex3)
        ;   XREF to: 0049a790 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00571d17
    CALL core_dtri.cpp_rayTriangleFloorTest_FUN_0049b2f0 ; 00571d18 | int core_dtri.cpp_rayTriangleFloorTest_FUN_0049b2f0(CDemonTriangle * triangle, float x, float z, float * out_height)
        ;   XREF to: 0049b2f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00571d1d
    OR ESI,EAX                          ; 00571d20
    JZ 0x00571d9a                       ; 00571d22 | LAB_00571d9a
    ...
    JZ 0x00571d9a                       ; 00571d6e | LAB_00571d9a
        ;   XREF to: 00571d9a (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 00571db0
    CALL core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790 ; 00571db1 | void core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790(CDemonTriangle * this_ptr, CVector3f * vertex1, CVector3f * vertex2, CVector3f * vertex3)
        ;   XREF to: 0049a790 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00571dd7
    OR EBX,ESI                          ; 00571dd8
    CALL core_dtri.cpp_rayTriangleFloorTest_FUN_0049b2f0 ; 00571dda | int core_dtri.cpp_rayTriangleFloorTest_FUN_0049b2f0(CDemonTriangle * triangle, float x, float z, float * out_height)
        ;   XREF to: 0049b2f0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00571dfa
    CALL core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790 ; 00571dfb | void core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790(CDemonTriangle * this_ptr, CVector3f * vertex1, CVector3f * vertex2, CVector3f * vertex3)
        ;   XREF to: 0049a790 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00571e21
    CALL core_dtri.cpp_rayTriangleFloorTest_FUN_0049b2f0 ; 00571e22 | int core_dtri.cpp_rayTriangleFloorTest_FUN_0049b2f0(CDemonTriangle * triangle, float x, float z, float * out_height)
        ;   XREF to: 0049b2f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00571e27
    OR ESI,EAX                          ; 00571e2a
    JZ 0x00571ea4                       ; 00571e2c | LAB_00571ea4
    ...
    JZ 0x00571ea4                       ; 00571e78 | LAB_00571ea4
        ;   XREF to: 00571ea4 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 00571eb7
    CALL core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790 ; 00571eb8 | void core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790(CDemonTriangle * this_ptr, CVector3f * vertex1, CVector3f * vertex2, CVector3f * vertex3)
        ;   XREF to: 0049a790 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00571edb
    OR EBX,ESI                          ; 00571edc
    CALL core_dtri.cpp_rayTriangleFloorTest_FUN_0049b2f0 ; 00571ede | int core_dtri.cpp_rayTriangleFloorTest_FUN_0049b2f0(CDemonTriangle * triangle, float x, float z, float * out_height)
        ;   XREF to: 0049b2f0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00571efb
    CALL core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790 ; 00571efc | void core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790(CDemonTriangle * this_ptr, CVector3f * vertex1, CVector3f * vertex2, CVector3f * vertex3)
        ;   XREF to: 0049a790 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00571f1f
    CALL core_dtri.cpp_rayTriangleFloorTest_FUN_0049b2f0 ; 00571f20 | int core_dtri.cpp_rayTriangleFloorTest_FUN_0049b2f0(CDemonTriangle * triangle, float x, float z, float * out_height)
        ;   XREF to: 0049b2f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00571f25
    OR ESI,EAX                          ; 00571f28
    JZ 0x00571fa2                       ; 00571f2a | LAB_00571fa2
    ...
    JZ 0x00571fa2                       ; 00571f76 | LAB_00571fa2
        ;   XREF to: 00571fa2 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 00571fb8
    CALL core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790 ; 00571fb9 | void core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790(CDemonTriangle * this_ptr, CVector3f * vertex1, CVector3f * vertex2, CVector3f * vertex3)
        ;   XREF to: 0049a790 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00571fdf
    OR EBX,ESI                          ; 00571fe0
    CALL core_dtri.cpp_rayTriangleFloorTest_FUN_0049b2f0 ; 00571fe2 | int core_dtri.cpp_rayTriangleFloorTest_FUN_0049b2f0(CDemonTriangle * triangle, float x, float z, float * out_height)
        ;   XREF to: 0049b2f0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00572002
    CALL core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790 ; 00572003 | void core_dtri.cpp_CDemonTriangle_buildCollision_FUN_0049a790(CDemonTriangle * this_ptr, CVector3f * vertex1, CVector3f * vertex2, CVector3f * vertex3)
        ;   XREF to: 0049a790 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00572029
    CALL core_dtri.cpp_rayTriangleFloorTest_FUN_0049b2f0 ; 0057202a | int core_dtri.cpp_rayTriangleFloorTest_FUN_0049b2f0(CDemonTriangle * triangle, float x, float z, float * out_height)
        ;   XREF to: 0049b2f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0057202f
    OR ESI,EAX                          ; 00572032
    JZ 0x005720ac                       ; 00572034 | LAB_005720ac
    ...
    JZ 0x005720ac                       ; 00572080 | LAB_005720ac
        ;   XREF to: 005720ac (CONDITIONAL_JUMP)
    ...
    OR EBX,ESI                          ; 005720ac
        ;   Label: LAB_005720ac
    JZ 0x005718ed                       ; 005720ae | LAB_005718ed
        ;   XREF to: 005718ed (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 005720d0
    PUSH EDI                            ; 005720d1
    CALL core_actor.cpp_CDemonActor_transformVector_FUN_00408e80 ; 005720d2 | CVector3f * core_actor.cpp_CDemonActor_transformVector_FUN_00408e80(CDemonActor * this_ptr, CVector3f * output, CVector3f * input)
        ;   XREF to: 00408e80 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005720d7
    CMP EBP,EAX                         ; 005720da
    JZ 0x005718ed                       ; 005720dc | LAB_005718ed
        ;   XREF to: 005718ed (CONDITIONAL_JUMP)
    ...
    JMP 0x005718ed                      ; 005720f3 | LAB_005718ed
        ;   XREF to: 005718ed (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x1d4]     ; 005720f8
        ;   Label: LAB_005720f8
    TEST EAX,EAX                        ; 005720ff
    JZ 0x005719f3                       ; 00572101 | LAB_005719f3
        ;   XREF to: 005719f3 (CONDITIONAL_JUMP)
    PUSH EAX                            ; 00572107
    CALL core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80 ; 00572108 | CKeyFramedModel * core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80(CKeyFramedModelInstance * this_ptr)
        ;   XREF to: 00478d80 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0057210d
    MOV ECX,dword ptr [EAX + 0x5698]    ; 00572110
    MOV EBX,EAX                         ; 00572116
    TEST ECX,ECX                        ; 00572118
    JNZ 0x00572140                      ; 0057211a | LAB_00572140
        ;   XREF to: 00572140 (CONDITIONAL_JUMP)
    PUSH EAX                            ; 0057211c
    MOV ESI,0x6461b6                    ; 0057211d | = "..\\core\\setcolid.cpp" | s_core_setcolid_cpp_006461b6 = ..\core\setcolid.cpp
    MOV EDX,0xcb                        ; 00572122
    PUSH 0x6461cb                       ; 00572127 | = "info.keyFramedModelInstancePtr != NUL..." | s_info_keyFramedModelInsta_006461cb = info.keyFramedModelInstancePtr != NULL, but %s doesn't have exact collision
    MOV dword ptr [0x02f0ca48],ESI      ; 0057212c | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 00572132 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00572138 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    CALL core_dmodel.cpp_CKeyFramedModel_getFloorHeight_FUN_00478740 ; 005721aa | int core_dmodel.cpp_CKeyFramedModel_getFloorHeight_FUN_00478740(CKeyFramedModel * this_ptr, int frame_index, float x, float z, ...)
        ;   XREF to: 00478740 (UNCONDITIONAL_CALL)
    ADD ESP,0x18                        ; 005721af
    TEST EAX,EAX                        ; 005721b2
    JZ 0x005718ed                       ; 005721b4 | LAB_005718ed
        ;   XREF to: 005718ed (CONDITIONAL_JUMP)
    ...
    JZ 0x005718ed                       ; 005721fd | LAB_005718ed
        ;   XREF to: 005718ed (CONDITIONAL_JUMP)
    ...
    JMP 0x005718ed                      ; 0057221a | LAB_005718ed
        ;   XREF to: 005718ed (UNCONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 0057222e
    PUSH EDI                            ; 0057222f
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 00572230 | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
    ...
    JZ 0x005718ed                       ; 00572272 | LAB_005718ed
        ;   XREF to: 005718ed (CONDITIONAL_JUMP)
    ...
    JZ 0x005718ed                       ; 005722bb | LAB_005718ed
        ;   XREF to: 005718ed (CONDITIONAL_JUMP)
    ...
    JMP 0x005718ed                      ; 005722d8 | LAB_005718ed
        ;   XREF to: 005718ed (UNCONDITIONAL_JUMP)
    JBE 0x005718ed                      ; 005722dd | LAB_005718ed
        ;   Label: LAB_005722dd
        ;   XREF to: 005718ed (CONDITIONAL_JUMP)
    CMP EBX,0x3                         ; 005722e3
    JZ 0x0057221f                       ; 005722e6 | LAB_0057221f
        ;   XREF to: 0057221f (CONDITIONAL_JUMP)
    MOV ECX,0x646217                    ; 005722ec | = "..\\core\\setcolid.cpp" | s_core_setcolid_cpp_00646217 = ..\core\setcolid.cpp
        ;   Label: LAB_005722ec
    MOV EBX,0x12b                       ; 005722f1
    PUSH 0x64622c                       ; 005722f6 | = "Invalid collision type!" | s_Invalid_collision_type_0064622c = Invalid collision type!
    MOV dword ptr [0x02f0ca48],ECX      ; 005722fb | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 00572301 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00572307 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0057230c
    JMP 0x005718ed                      ; 0057230f | LAB_005718ed
        ;   XREF to: 005718ed (UNCONDITIONAL_JUMP)
    PUSH EBX                            ; 00572314
        ;   Label: LAB_00572314
