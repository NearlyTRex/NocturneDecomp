...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_setcolid.cpp_CDemonSet_FUN_005743e0(CDemonSet * this_ptr)
;
; Parameters:
...
;   core_msnedit.cpp_PrepareMissionAndEditGore_FUN_0053e220 at 0053e559
;   core_msnedit.cpp_PrepareMissionMaybe_FUN_005390f0 at 005399c3
...
section .text
    ...
    JLE 0x0057441b                      ; 005743fa | LAB_0057441b
    ...
    JZ 0x0057441e                       ; 0057440b | LAB_0057441e
    ...
    JL 0x005743fe                       ; 00574419 | LAB_005743fe
    ...
    JMP 0x0057440d                      ; 00574431 | LAB_0057440d
