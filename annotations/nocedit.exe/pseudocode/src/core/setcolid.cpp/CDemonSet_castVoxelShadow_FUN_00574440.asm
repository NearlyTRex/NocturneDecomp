...
;
; Called Functions:
;   core_dtrace.cpp_CDemonRaytrace_markShadowVoxels_FUN_00499c20
...
section .text
    ...
    PUSH EBX                            ; 00574440
        ;   Label: core_setcolid.cpp_CDemonSet_castVoxelShadow_FUN_00574440
    ...
    CALL core_dtrace.cpp_CDemonRaytrace_markShadowVoxels_FUN_00499c20 ; 0057449a
        ;   XREF to: 00499c20 (UNCONDITIONAL_CALL)  ; void core_dtrace.cpp_CDemonRaytrace_markShadowVoxels_FUN_00499c20(CDemonRaytrace * this_ptr, CVector3f * offset, CVector3f * rotation, CVector3f * extent, ...)
    ADD ESP,0x14                        ; 0057449f
    CALL core_path.cpp_resetAllPathMaps_FUN_00548590 ; 005744a2
