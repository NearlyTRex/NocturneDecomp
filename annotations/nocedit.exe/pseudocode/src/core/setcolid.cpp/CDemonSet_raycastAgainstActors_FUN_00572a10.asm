...
;                               FUNCTION
; *****************************************************************************
; __cdecl float core_setcolid.cpp_CDemonSet_raycastAgainstActors_FUN_00572a10(CDemonSet * this_ptr, float min_t, CVector3f * ray_origin, CVector3f * ray_target, float max_t)
;
; Parameters:
...
section .text
    ...
    JL 0x00572c1c                       ; 00572a4b | LAB_00572c1c
    ...
    FNSTSW AX                           ; 00572a58
    SAHF                                ; 00572a5a
    JNC 0x00572c34                      ; 00572a5b | LAB_00572c34
    ...
    FNSTSW AX                           ; 00572a68
    SAHF                                ; 00572a6a
    JA 0x00572c4b                       ; 00572a6b | LAB_00572c4b
    ...
    FNSTSW AX                           ; 00572a82
    SAHF                                ; 00572a84
    JNC 0x00572a92                      ; 00572a85 | LAB_00572a92
    ...
    JZ 0x00572af6                       ; 00572ae0 | LAB_00572af6
    ...
    JZ 0x00572b12                       ; 00572afc | LAB_00572b12
    ...
    CALL core_box.cpp_CBoundingBox3D_expand_FUN_00420240 ; 00572b48 | void core_box.cpp_CBoundingBox3D_expand_FUN_00420240(CBoundingBox3D * this_ptr, CVector3f * point)
        ;   XREF to: 00420240 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00572b4d
    LEA EAX,[ESP + 0x4]                 ; 00572b50
    PUSH EAX                            ; 00572b54
    CALL core_setcolid.cpp_SCollisionInfo_ctor_FUN_005743c0 ; 00572b55 | SCollisionInfo * core_setcolid.cpp_SCollisionInfo_ctor_FUN_005743c0(SCollisionInfo * this_ptr)
    ...
    JLE 0x00572bff                      ; 00572ba0 | LAB_00572bff
    ...
    PUSH ESI                            ; 00572bc3
    PUSH EDI                            ; 00572bc4
    CALL core_setcolid.cpp_CDemonSet_isActorIgnored_FUN_00572e20 ; 00572bc5 | int core_setcolid.cpp_CDemonSet_isActorIgnored_FUN_00572e20(CDemonSet * this_ptr, CDemonActor * actor)
        ;   XREF to: 00572e20 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00572bca
    TEST EAX,EAX                        ; 00572bcd
    JZ 0x00572c55                       ; 00572bcf | LAB_00572c55
    ...
    JMP 0x00572a71                      ; 00572c50 | LAB_00572a71
    ...
    JZ 0x00572bd5                       ; 00572c71 | LAB_00572bd5
    ...
    PUSH EBX                            ; 00572c8c
    PUSH ESI                            ; 00572c8d
    CALL core_actor.cpp_CDemonActor_rayIntersect_FUN_00409470 ; 00572c8e | float core_actor.cpp_CDemonActor_rayIntersect_FUN_00409470(CDemonActor * this_ptr, CVector3f * ray_origin, CVector3f * ray_direction, CVector3f * out_hit_normal, ...)
    ...
    FNSTSW AX                           ; 00572cab
    SAHF                                ; 00572cad
    JC 0x00572bd5                       ; 00572cae | LAB_00572bd5
        ;   XREF to: 00572bd5 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 00572cc4
    SAHF                                ; 00572cc6
    JNC 0x00572bd5                      ; 00572cc7 | LAB_00572bd5
        ;   XREF to: 00572bd5 (CONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 00572ccd
    FCOMP float ptr [EBP + 0x18]        ; 00572cd0
    FNSTSW AX                           ; 00572cd3
    SAHF                                ; 00572cd5
    JBE 0x00572bd5                      ; 00572cd6 | LAB_00572bd5
        ;   XREF to: 00572bd5 (CONDITIONAL_JUMP)
    ...
    JZ 0x00572d05                       ; 00572cef | LAB_00572d05
    ...
    JZ 0x00572d9a                       ; 00572d7d | LAB_00572d9a
    ...
    JZ 0x00572db8                       ; 00572da2 | LAB_00572db8
    ...
    JZ 0x00572dd4                       ; 00572dbe | LAB_00572dd4
    ...
    CALL core_box.cpp_CBoundingBox3D_expand_FUN_00420240 ; 00572e0a | void core_box.cpp_CBoundingBox3D_expand_FUN_00420240(CBoundingBox3D * this_ptr, CVector3f * point)
        ;   XREF to: 00420240 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00572e0f
    JMP 0x00572bd5                      ; 00572e12 | LAB_00572bd5
