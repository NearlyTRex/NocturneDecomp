...
;                               FUNCTION
; *****************************************************************************
; __cdecl SRaytraceState * __cdecl core_setcolid_cpp_freeRaytraceStates_FUN_00574770(SRaytraceState *objs)
;
; Parameters:
...
section .text
    ...
    PUSH 0x662950                       ; 00574770 | g_SRaytraceStateTypeInfo
        ;   Label: core_setcolid.cpp_freeRaytraceStates_FUN_00574770
    PUSH 0x5                            ; 00574775
