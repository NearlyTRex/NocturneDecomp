...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_setcolid.cpp_CDemonSet_FUN_00574580(CDemonSet * this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EAX,[0x006844f0]                ; 0057458b | CWater * g_CWaterPtr
    TEST dword ptr [EAX + 0x4],0x7fffffff ; 00574590 | DAT_03f875e4
    JZ 0x005745a8                       ; 00574597 | LAB_005745a8
    ...
    PUSH EDX                            ; 005745c2
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 005745c3 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 005745c8
    ADD ESP,0x8                         ; 005745ca
    TEST EAX,EAX                        ; 005745cd
    JNZ 0x005745f0                      ; 005745cf | LAB_005745f0
    ...
    JL 0x005745b6                       ; 005745dd | LAB_005745b6
    ...
    MOV EAX,0x1                         ; 005745e9
        ;   Label: LAB_005745e9
    JMP 0x005745e1                      ; 005745ee | LAB_005745e1
    ...
    PUSH EAX                            ; 005745f9
    PUSH EBX                            ; 005745fa
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 005745fb | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
    ...
    FADD float ptr [0x006463fa]         ; 00574617 | float FLOAT_006463fa
