...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_tbplayer_cpp_CDrummer_setup_FUN_005da2f0(CDrummer *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005da2f0
        ;   Label: core_tbplayer.cpp_CDrummer_setup_FUN_005da2f0
    PUSH ESI                            ; 005da2f1
    MOV EBX,dword ptr [ESP + 0xc]       ; 005da2f2
    PUSH EBX                            ; 005da2f6
    CALL core_npc.cpp_CNPC_setup_FUN_00544870 ; 005da2f7
