...
;                               FUNCTION
; *****************************************************************************
; __cdecl CBassPlayer * __cdecl core_tbplayer_cpp_CBassPlayer_dtor_FUN_005da610(CBassPlayer *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 005da638
    CALL core_backgnd.cpp_freeFlames_FUN_00412720 ; 005da639
    ...
    PUSH EAX                            ; 005da648
    CALL core_backgnd.cpp_freeFires_FUN_00412700 ; 005da649
    ...
    PUSH EAX                            ; 005da658
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 005da659
    ...
    PUSH EAX                            ; 005da668
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 005da669
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; int core_backgnd.cpp_cleanupVector_FUN_004126e0(CVector3f * * objs)
    ADD ESP,0x8                         ; 005da66e
    PUSH 0x0                            ; 005da671
    SUB EAX,0x1c8                       ; 005da673
    PUSH EAX                            ; 005da678
    CALL core_cloth.cpp_FUN_0043bf80    ; 005da679
    ...
    PUSH 0x6641f0                       ; 005da6b1 | g_CBassPlayerTypeInfo
        ;   Label: LAB_005da6b1
    PUSH EBX                            ; 005da6b6
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 005da6b7
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 005da6bc
    PUSH EAX                            ; 005da6bf
    CALL crt_memory.c_free_FUN_005fe659 ; 005da6c0
    ...
    PUSH EAX                            ; 005da6cc
        ;   Label: LAB_005da6cc
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 005da6cd
