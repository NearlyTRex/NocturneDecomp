...

{
  core_actor_cpp_registerActorClass_FUN_0040c2e0
            (&g_CBassPlayerClassInfo,"CBassPlayer",
             core_tbplayer_cpp_factoryFuncBassPlayer_FUN_005da020,&g_CBassPlayerClassVersion,1,
             &g_CNPCClassInfo);
  core_actor_cpp_registerActorClass_FUN_0040c2e0
            (&g_CDrummerClassInfo,"CDrummer",
             core_tbplayer_cpp_factoryFuncDrummer_FUN_005da280,&g_CDrummerClassVersion,1,
             &g_CNPCClassInfo);
  return;
}
