...
;                               FUNCTION
; *****************************************************************************
; __cdecl CDrummer * __cdecl core_tbplayer_cpp_CDrummer_dtor_FUN_005da540 (CDrummer *this_ptr,uint d1,uint d2,uint d3,uint d4,uint d5,uint d6,uint d7,uint d8, uint d9)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 005da568
    CALL core_backgnd.cpp_freeFlames_FUN_00412720 ; 005da569
    ...
    PUSH EAX                            ; 005da578
    CALL core_backgnd.cpp_freeFires_FUN_00412700 ; 005da579
    ...
    PUSH EAX                            ; 005da588
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 005da589
    ...
    PUSH EAX                            ; 005da598
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 005da599
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; int core_backgnd.cpp_cleanupVector_FUN_004126e0(CVector3f * * objs)
    ADD ESP,0x8                         ; 005da59e
    PUSH 0x0                            ; 005da5a1
    SUB EAX,0x1c8                       ; 005da5a3
    PUSH EAX                            ; 005da5a8
    CALL core_cloth.cpp_FUN_0043bf80    ; 005da5a9
    ...
    PUSH 0x6641d0                       ; 005da5e1 | g_CDrummerTypeInfo
        ;   Label: LAB_005da5e1
    PUSH EBX                            ; 005da5e6
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 005da5e7
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 005da5ec
    PUSH EAX                            ; 005da5ef
    CALL crt_memory.c_free_FUN_005fe659 ; 005da5f0
