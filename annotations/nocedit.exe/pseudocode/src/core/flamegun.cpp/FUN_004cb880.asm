...
section .text
    ...
    PUSH EDX                            ; 004cb885
    CALL core_weapon.cpp_CWeapon_ctor_FUN_005ede70 ; 004cb886 | CWeapon * core_weapon.cpp_CWeapon_ctor_FUN_005ede70(CWeapon * this_ptr)
        ;   XREF to: 005ede70 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004cb88b
    PUSH 0x62a38e                       ; 004cb88e | = "flamegun.kfm" | s_flamegun_kfm_0062a38e = flamegun.kfm
    MOV EBX,EAX                         ; 004cb893
    ADD EAX,0x158                       ; 004cb895
    PUSH EAX                            ; 004cb89a
    MOV dword ptr [EAX + -0x4],0x65e284 ; 004cb89b | CDemonActor_vtable PTR_core_weapon.cpp_ActorModelSomething_FUN_0065e284
    CALL core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0 ; 004cb8a2 | void core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0(CKeyFramedModelInstance * this_ptr, char * filename)
