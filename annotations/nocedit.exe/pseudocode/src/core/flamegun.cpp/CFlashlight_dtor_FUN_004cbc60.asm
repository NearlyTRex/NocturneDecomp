...
;                               FUNCTION
; *****************************************************************************
; __cdecl CFlashlight * __cdecl core_flamegun_cpp_CFlashlight_dtor_FUN_004cbc60(CFlashlight *this_ptr,uint d1,uint d2)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004cbc60
        ;   Label: core_flamegun.cpp_CFlashlight_dtor_FUN_004cbc60
    ...
    PUSH 0x65e4e0                       ; 004cbc86 | g_CFlashlightTypeInfo
        ;   Label: LAB_004cbc86
    PUSH EBX                            ; 004cbc8b
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 004cbc8c
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 004cbc91
    PUSH EAX                            ; 004cbc94
    CALL crt_memory.c_free_FUN_005fe659 ; 004cbc95
