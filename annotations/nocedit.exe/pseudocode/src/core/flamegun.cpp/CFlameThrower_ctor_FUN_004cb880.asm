...
;                               FUNCTION
; *****************************************************************************
; __cdecl CFlameThrower * __cdecl core_flamegun_cpp_CFlameThrower_ctor_FUN_004cb880(CFlameThrower *this_ptr)
;
; Parameters:
; CFlameThrower *  Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_flamegun.cpp_factoryFunc_FUN_004cb840 at 004cb85a
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004cb880
        ;   Label: core_flamegun.cpp_CFlameThrower_ctor_FUN_004cb880
    ...
    PUSH EAX                            ; 004cb89a
    MOV dword ptr [EAX + -0x4],0x65e284 ; 004cb89b | g_CFlameThrowerVTable
