...
section .text
    ...
    PUSH EAX                            ; 00411d9e
    MOV EDX,dword ptr [0x006793d0]      ; 00411d9f | CEventList g_CEventListInstance | CEventList * g_CEventListPtr
    PUSH EDX                            ; 00411da5 | CEventList g_CEventListInstance
    CALL core_event.cpp_CEventList_evaluateCondition_FUN_004adca0 ; 00411da6 | int core_event.cpp_CEventList_evaluateCondition_FUN_004adca0(CEventList * this_ptr, char * condition_expression)
        ;   XREF to: 004adca0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00411dab
    TEST EAX,EAX                        ; 00411dae
    JNZ 0x00411e23                      ; 00411db0 | LAB_00411e23
        ;   XREF to: 00411e23 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x33c],0x0     ; 00411db2
        ;   Label: LAB_00411db2
    JZ 0x00411e1e                       ; 00411db9 | LAB_00411e1e
        ;   XREF to: 00411e1e (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x50]          ; 00411dbb
    FMUL double ptr [0x00614d2b]        ; 00411dbf | double DOUBLE_00614d2b
    FSUBR float ptr [EBX + 0x340]       ; 00411dc5
    FST float ptr [EBX + 0x340]         ; 00411dcb
    FADD float ptr [EBX + 0x24]         ; 00411dd1
    MOV EDX,dword ptr [0x02db87d0]      ; 00411dd4 | int g_LocalHeroIndex
    FSTP float ptr [EBX + 0x24]         ; 00411dda
    MOV EDX,dword ptr [EDX*0x4 + 0x2db87c0] ; 00411ddd | CHero *[4] g_HeroActors
    FLD float ptr [EBX + 0x24]          ; 00411de4
    FCOMP float ptr [EDX + 0x24]        ; 00411de7
    FNSTSW AX                           ; 00411dea
    SAHF                                ; 00411dec
    JNC 0x00411dff                      ; 00411ded | LAB_00411dff
    ...
    MOV EAX,[0x02db87d0]                ; 00411dff | int g_LocalHeroIndex
        ;   Label: LAB_00411dff
    MOV EAX,dword ptr [EAX*0x4 + 0x2db87c0] ; 00411e04 | CHero *[4] g_HeroActors
    FLD float ptr [EAX + 0x24]          ; 00411e0b
    FADD double ptr [0x00614d33]        ; 00411e0e | double DOUBLE_00614d33
    FLD float ptr [EBX + 0x24]          ; 00411e14
    FCOMPP                              ; 00411e17
    FNSTSW AX                           ; 00411e19
    SAHF                                ; 00411e1b
    JC 0x00411e64                       ; 00411e1c | LAB_00411e64
        ;   XREF to: 00411e64 (CONDITIONAL_JUMP)
    ADD ESP,0x44                        ; 00411e1e
        ;   Label: LAB_00411e1e
    POP EBX                             ; 00411e21
    RET                                 ; 00411e22
    MOV EAX,[0x02db87d0]                ; 00411e23 | int g_LocalHeroIndex
        ;   Label: LAB_00411e23
    MOV dword ptr [EBX + 0x33c],0x1     ; 00411e28
    MOV EAX,dword ptr [EAX*0x4 + 0x2db87c0] ; 00411e32 | CHero *[4] g_HeroActors
    ...
    JMP 0x00411db2                      ; 00411e5f | LAB_00411db2
    ...
    CALL core_charactr.cpp_SDamageInfo_ctor_FUN_00427db0 ; 00411e75 | SDamageInfo * core_charactr.cpp_SDamageInfo_ctor_FUN_00427db0(SDamageInfo * this_ptr)
        ;   XREF to: 00427db0 (UNCONDITIONAL_CALL)
    LEA EDX,[ESP + 0xc]                 ; 00411e7a
    ADD ESP,0x4                         ; 00411e7e
    MOV EAX,[0x02db87d0]                ; 00411e81 | int g_LocalHeroIndex
    MOV dword ptr [ESP + 0xc],ESI       ; 00411e86
    MOV dword ptr [ESP + 0x38],EDI      ; 00411e8a
    MOV dword ptr [ESP + 0x3c],EBX      ; 00411e8e
    PUSH EDX                            ; 00411e92
    MOV EAX,dword ptr [EAX*0x4 + 0x2db87c0] ; 00411e93 | CHero *[4] g_HeroActors
