...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_anvil_cpp_CAnvil_archive_FUN_00411f50(CAnvil *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00411f50
        ;   Label: core_anvil.cpp_CAnvil_archive_FUN_00411f50
    MOV EBX,dword ptr [ESP + 0x8]       ; 00411f51
    PUSH EBX                            ; 00411f55
    CALL core_actor.cpp_CDemonActor_archive_FUN_0040c1c0 ; 00411f56
    ...
    PUSH EAX                            ; 00411f69
    CALL core_actor.cpp_archiveKeyframedModelInstance_FUN_0040b8f0 ; 00411f6a
    ...
    PUSH EAX                            ; 00411f7d
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 00411f7e
    ...
    PUSH EAX                            ; 00411f91
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 00411f92
    ...
    PUSH EAX                            ; 00411fa5
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 00411fa6
    ...
    PUSH EBX                            ; 00411fb9
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 00411fba
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
