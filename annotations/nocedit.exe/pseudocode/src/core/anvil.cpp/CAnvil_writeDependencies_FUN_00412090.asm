...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_anvil_cpp_CAnvil_writeDependencies_FUN_00412090(CAnvil *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00412090
        ;   Label: core_anvil.cpp_CAnvil_writeDependencies_FUN_00412090
    PUSH ESI                            ; 00412091
