...
section .text
    ...
    PUSH EBX                            ; 00412090
        ;   Label: core_anvil.cpp_CAnvil_addFilesToExtract_FUN_00412090
    PUSH ESI                            ; 00412091
    MOV EBX,dword ptr [ESP + 0xc]       ; 00412092
    MOV ESI,dword ptr [ESP + 0x10]      ; 00412096
    PUSH ESI                            ; 0041209a
    PUSH EBX                            ; 0041209b
    CALL core_actor.cpp_CDemonActor_addFilesToExtract_FUN_0040cfd0 ; 0041209c
    ...
    PUSH EAX                            ; 004120ce
    CALL core_dmodel.cpp_CKeyFramedModel_addFilesToExtract_FUN_0047ed00 ; 004120cf
