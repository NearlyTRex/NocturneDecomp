...
section .text
    ...
    PUSH 0x821ff8                       ; 00549320 | g_CDemonActorClassInfo
        ;   Label: core_pendulum.cpp_staticInit_FUN_00549320
    PUSH 0x8                            ; 00549325
    PUSH 0x680c84                       ; 00549327 | g_CPendulumClassVersion
    PUSH 0x549350                       ; 0054932c
    PUSH 0x63ec51                       ; 00549331 | = "CPendulum"
    PUSH 0x30d5018                      ; 00549336 | g_CPendulumClassInfo
    CALL core_actor.cpp_registerActorClass_FUN_0040c2e0 ; 0054933b
