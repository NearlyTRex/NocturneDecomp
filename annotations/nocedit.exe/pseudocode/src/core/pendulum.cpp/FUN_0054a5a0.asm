...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_pendulum.cpp_FUN_0054a5a0()
;
; Local Variables:
...
section .text
    ...
    PUSH ECX                            ; 0054a5ac
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 0054a5ad | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    FLD float ptr [EAX + 0x3a4]         ; 0054a5b2
    ADD ESP,0x8                         ; 0054a5b8
    FMUL double ptr [0x0063edb9]        ; 0054a5bb | double DOUBLE_0063edb9
    SUB ESP,0x8                         ; 0054a5c1
    FSTP double ptr [ESP]               ; 0054a5c4
    PUSH 0x63edb1                       ; 0054a5c7 | = "%f" | s_f_0063edb1 = %f
    MOV EBX,dword ptr [ESP + 0x1c]      ; 0054a5cc
    PUSH EBX                            ; 0054a5d0
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0054a5d1 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
