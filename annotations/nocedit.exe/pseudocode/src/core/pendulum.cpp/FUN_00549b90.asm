...
;
; XREF[2]:
;   core_pendulum.cpp_FUN_0054a180 at 0054a1d4
;   core_pendulum.cpp_FUN_0054a790 at 0054a7a4
;
; Referenced Globals:
...
section .text
    ...
    PUSH ECX                            ; 00549bb2
    CALL crt_math.c_floor_FUN_005feb90  ; 00549bb3 | double crt_math.c_floor_FUN_005feb90(double input_value)
    ...
    JZ 0x00549c15                       ; 00549bf2 | LAB_00549c15
    ...
    FNSTSW AX                           ; 00549bfe
    SAHF                                ; 00549c00
    JNC 0x00549c15                      ; 00549c01 | LAB_00549c15
        ;   XREF to: 00549c15 (CONDITIONAL_JUMP)
    FLD float ptr [EBX + 0x3a0]         ; 00549c03
    FADD float ptr [0x0063ecb5]         ; 00549c09 | float FLOAT_0063ecb5
    FSTP float ptr [EBX + 0x3a0]        ; 00549c0f
    SUB ESP,0x8                         ; 00549c15
        ;   Label: LAB_00549c15
    FLD float ptr [EBX + 0x3a0]         ; 00549c18
    FSTP double ptr [ESP]               ; 00549c1e
    CALL crt_math.c_floor_FUN_005feb90  ; 00549c21 | double crt_math.c_floor_FUN_005feb90(double input_value)
        ;   XREF to: 005feb90 (UNCONDITIONAL_CALL)
    ...
    FMUL double ptr [0x0063ecb9]        ; 00549c41 | double DOUBLE_0063ecb9
    FMUL double ptr [0x0063ecc1]        ; 00549c47 | double DOUBLE_0063ecc1
    FSIN                                ; 00549c4d
    ...
    FMUL double ptr [0x0063ecc9]        ; 00549c64 | double DOUBLE_0063ecc9
    FXCH                                ; 00549c6a
    ...
    CALL core_actor.cpp_CDemonActor_updateOrientationMatrix_FUN_00408c10 ; 00549c8c | void core_actor.cpp_CDemonActor_updateOrientationMatrix_FUN_00408c10(CDemonActor * this_ptr)
    ...
    PUSH EAX                            ; 00549c9f
    PUSH EBX                            ; 00549ca0
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 00549ca1 | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
        ;   XREF to: 00408ec0 (UNCONDITIONAL_CALL)
    LEA EDX,[EBX + 0x41c]               ; 00549ca6
    ADD ESP,0xc                         ; 00549cac
    CMP EDX,EAX                         ; 00549caf
    JZ 0x00549cc3                       ; 00549cb1 | LAB_00549cc3
    ...
    FLD float ptr [EBX + 0x430]         ; 00549cc3
        ;   Label: LAB_00549cc3
    FMUL double ptr [0x0063ecc9]        ; 00549cc9 | double DOUBLE_0063ecc9
    ...
    FNSTSW AX                           ; 00549cf6
    SAHF                                ; 00549cf8
    JNC 0x00549f4c                      ; 00549cf9 | LAB_00549f4c
        ;   XREF to: 00549f4c (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0xc]           ; 00549cff
    FCOMP double ptr [0x0063ecd1]       ; 00549d03 | double DOUBLE_0063ecd1
    FNSTSW AX                           ; 00549d09
    SAHF                                ; 00549d0b
    JBE 0x00549f4c                      ; 00549d0c | LAB_00549f4c
        ;   XREF to: 00549f4c (CONDITIONAL_JUMP)
    ...
    FCOMP double ptr [0x0063ecd9]       ; 00549d2e | double DOUBLE_0063ecd9
    FNSTSW AX                           ; 00549d34
    SAHF                                ; 00549d36
    JC 0x00549f53                       ; 00549d37 | LAB_00549f53
        ;   XREF to: 00549f53 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x34]          ; 00549d3d
        ;   Label: LAB_00549d3d
    FADD double ptr [0x0063ece1]        ; 00549d41 | double DOUBLE_0063ece1
    FLD float ptr [ESP + 0x20]          ; 00549d47
    FCOMPP                              ; 00549d4b
    FNSTSW AX                           ; 00549d4d
    SAHF                                ; 00549d4f
    JBE 0x00549d60                      ; 00549d50 | LAB_00549d60
        ;   XREF to: 00549d60 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x20]          ; 00549d52
    FADD float ptr [0x0063ece9]         ; 00549d56 | float FLOAT_0063ece9
    ...
    FNSTSW AX                           ; 00549d68
    SAHF                                ; 00549d6a
    JBE 0x00549f62                      ; 00549d6b | LAB_00549f62
        ;   XREF to: 00549f62 (CONDITIONAL_JUMP)
    FLD float ptr [EBX + 0x3cc]         ; 00549d71
        ;   Label: LAB_00549d71
    FADD double ptr [0x0063ecf1]        ; 00549d77 | double DOUBLE_0063ecf1
    ...
    FADD double ptr [0x0063ecd9]        ; 00549d91 | double DOUBLE_0063ecd9
    ...
    FNSTSW AX                           ; 00549dab
    SAHF                                ; 00549dad
    JNC 0x00549dba                      ; 00549dae | LAB_00549dba
    ...
    FLD float ptr [ESP + 0x2c]          ; 00549dba
        ;   Label: LAB_00549dba
    FADD double ptr [0x0063ece1]        ; 00549dbe | double DOUBLE_0063ece1
    FLD float ptr [ESP + 0x14]          ; 00549dc4
    FCOMPP                              ; 00549dc8
    FNSTSW AX                           ; 00549dca
    SAHF                                ; 00549dcc
    JBE 0x00549ddd                      ; 00549dcd | LAB_00549ddd
        ;   XREF to: 00549ddd (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x14]          ; 00549dcf
    FADD float ptr [0x0063ece9]         ; 00549dd3 | float FLOAT_0063ece9
    ...
    FNSTSW AX                           ; 00549de5
    SAHF                                ; 00549de7
    JBE 0x0054a004                      ; 00549de8 | LAB_0054a004
    ...
    FNSTSW AX                           ; 00549e11
    SAHF                                ; 00549e13
    JBE 0x00549e20                      ; 00549e14 | LAB_00549e20
    ...
    FLD float ptr [ESP + 0x10]          ; 00549e20
        ;   Label: LAB_00549e20
    FADD double ptr [0x0063ece1]        ; 00549e24 | double DOUBLE_0063ece1
    FLD float ptr [ESP + 0x1c]          ; 00549e2a
    FCOMPP                              ; 00549e2e
    FNSTSW AX                           ; 00549e30
    SAHF                                ; 00549e32
    JBE 0x00549e43                      ; 00549e33 | LAB_00549e43
        ;   XREF to: 00549e43 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x1c]          ; 00549e35
    FADD float ptr [0x0063ece9]         ; 00549e39 | float FLOAT_0063ece9
    ...
    FNSTSW AX                           ; 00549e4b
    SAHF                                ; 00549e4d
    JBE 0x0054a0af                      ; 00549e4e | LAB_0054a0af
        ;   XREF to: 0054a0af (CONDITIONAL_JUMP)
    FLD float ptr [EBX + 0x3cc]         ; 00549e54
        ;   Label: LAB_00549e54
    FADD double ptr [0x0063ecf9]        ; 00549e5a | double DOUBLE_0063ecf9
    ...
    FADD double ptr [0x0063ecd9]        ; 00549e74 | double DOUBLE_0063ecd9
    ...
    FNSTSW AX                           ; 00549e8d
    SAHF                                ; 00549e8f
    JNC 0x00549e9c                      ; 00549e90 | LAB_00549e9c
    ...
    FLD float ptr [ESP + 0x30]          ; 00549e9c
        ;   Label: LAB_00549e9c
    FADD double ptr [0x0063ece1]        ; 00549ea0 | double DOUBLE_0063ece1
    FLD float ptr [ESP + 0x18]          ; 00549ea6
    FCOMPP                              ; 00549eaa
    FNSTSW AX                           ; 00549eac
    SAHF                                ; 00549eae
    JBE 0x00549ebf                      ; 00549eaf | LAB_00549ebf
        ;   XREF to: 00549ebf (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x18]          ; 00549eb1
    FADD float ptr [0x0063ece9]         ; 00549eb5 | float FLOAT_0063ece9
    ...
    FNSTSW AX                           ; 00549ec7
    SAHF                                ; 00549ec9
    JA 0x00549f4c                       ; 00549eca | LAB_00549f4c
        ;   XREF to: 00549f4c (CONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 00549ed0
    FCOMP float ptr [ESP + 0x18]        ; 00549ed3
    FNSTSW AX                           ; 00549ed7
    SAHF                                ; 00549ed9
    JNC 0x00549ee4                      ; 00549eda | LAB_00549ee4
    ...
    FNSTSW AX                           ; 00549eeb
    SAHF                                ; 00549eed
    JNC 0x00549ef8                      ; 00549eee | LAB_00549ef8
    ...
    FNSTSW AX                           ; 00549f05
    SAHF                                ; 00549f07
    JBE 0x00549f16                      ; 00549f08 | LAB_00549f16
        ;   XREF to: 00549f16 (CONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 00549f0a
    FADD float ptr [0x0063ece9]         ; 00549f0d | float FLOAT_0063ece9
    ...
    FNSTSW AX                           ; 00549f23
    SAHF                                ; 00549f25
    JBE 0x00549f34                      ; 00549f26 | LAB_00549f34
        ;   XREF to: 00549f34 (CONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 00549f28
    FADD float ptr [0x0063ece9]         ; 00549f2b | float FLOAT_0063ece9
    ...
    JNZ 0x0054a151                      ; 00549f46 | LAB_0054a151
    ...
    JMP 0x00549d3d                      ; 00549f5d | LAB_00549d3d
    ...
    FNSTSW AX                           ; 00549f6a
    SAHF                                ; 00549f6c
    JNC 0x00549f79                      ; 00549f6d | LAB_00549f79
    ...
    FNSTSW AX                           ; 00549f81
    SAHF                                ; 00549f83
    JNC 0x00549f90                      ; 00549f84 | LAB_00549f90
    ...
    FNSTSW AX                           ; 00549f9e
    SAHF                                ; 00549fa0
    JBE 0x00549fb1                      ; 00549fa1 | LAB_00549fb1
        ;   XREF to: 00549fb1 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x28]          ; 00549fa3
    FADD float ptr [0x0063ece9]         ; 00549fa7 | float FLOAT_0063ece9
    ...
    FNSTSW AX                           ; 00549fbf
    SAHF                                ; 00549fc1
    JBE 0x00549fd2                      ; 00549fc2 | LAB_00549fd2
        ;   XREF to: 00549fd2 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x28]          ; 00549fc4
    FADD float ptr [0x0063ece9]         ; 00549fc8 | float FLOAT_0063ece9
    ...
    JZ 0x00549d71                       ; 00549fe5 | LAB_00549d71
    ...
    JMP 0x00549d71                      ; 00549fff | LAB_00549d71
    ...
    FNSTSW AX                           ; 0054a00c
    SAHF                                ; 0054a00e
    JNC 0x0054a01b                      ; 0054a00f | LAB_0054a01b
    ...
    FNSTSW AX                           ; 0054a023
    SAHF                                ; 0054a025
    JNC 0x0054a032                      ; 0054a026 | LAB_0054a032
    ...
    FNSTSW AX                           ; 0054a040
    SAHF                                ; 0054a042
    JBE 0x0054a053                      ; 0054a043 | LAB_0054a053
        ;   XREF to: 0054a053 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x4]           ; 0054a045
    FADD float ptr [0x0063ece9]         ; 0054a049 | float FLOAT_0063ece9
    ...
    FNSTSW AX                           ; 0054a061
    SAHF                                ; 0054a063
    JBE 0x0054a074                      ; 0054a064 | LAB_0054a074
        ;   XREF to: 0054a074 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x4]           ; 0054a066
    FADD float ptr [0x0063ece9]         ; 0054a06a | float FLOAT_0063ece9
    ...
    JZ 0x00549dee                       ; 0054a087 | LAB_00549dee
    ...
    PUSH EAX                            ; 0054a09a
    PUSH EBX                            ; 0054a09b
    MOV EAX,[0x00681ef8]                ; 0054a09c | CSound g_CSoundInstance | CSound * g_CSoundPtr
    PUSH EAX                            ; 0054a0a1 | CSound g_CSoundInstance
    CALL core_sound.cpp_CSound_playTrackedActorSound_FUN_005b3a70 ; 0054a0a2 | uint core_sound.cpp_CSound_playTrackedActorSound_FUN_005b3a70(CSound * this_ptr, CDemonActor * actor, char * sound_name, CVector3f * position_tracker)
        ;   XREF to: 005b3a70 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0054a0a7
    JMP 0x00549dee                      ; 0054a0aa | LAB_00549dee
    ...
    FNSTSW AX                           ; 0054a0b7
    SAHF                                ; 0054a0b9
    JNC 0x0054a0c6                      ; 0054a0ba | LAB_0054a0c6
    ...
    FNSTSW AX                           ; 0054a0ce
    SAHF                                ; 0054a0d0
    JNC 0x0054a0dd                      ; 0054a0d1 | LAB_0054a0dd
    ...
    FNSTSW AX                           ; 0054a0eb
    SAHF                                ; 0054a0ed
    JBE 0x0054a0fe                      ; 0054a0ee | LAB_0054a0fe
        ;   XREF to: 0054a0fe (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x8]           ; 0054a0f0
    FADD float ptr [0x0063ece9]         ; 0054a0f4 | float FLOAT_0063ece9
    ...
    FNSTSW AX                           ; 0054a10c
    SAHF                                ; 0054a10e
    JBE 0x0054a11f                      ; 0054a10f | LAB_0054a11f
        ;   XREF to: 0054a11f (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x8]           ; 0054a111
    FADD float ptr [0x0063ece9]         ; 0054a115 | float FLOAT_0063ece9
    ...
    JZ 0x00549e54                       ; 0054a132 | LAB_00549e54
    ...
    JMP 0x00549e54                      ; 0054a14c | LAB_00549e54
    ...
    PUSH EAX                            ; 0054a15e
    PUSH EBX                            ; 0054a15f
    MOV ECX,dword ptr [0x00681ef8]      ; 0054a160 | CSound g_CSoundInstance | CSound * g_CSoundPtr
    PUSH ECX                            ; 0054a166 | CSound g_CSoundInstance
    CALL core_sound.cpp_CSound_playTrackedActorSound_FUN_005b3a70 ; 0054a167 | uint core_sound.cpp_CSound_playTrackedActorSound_FUN_005b3a70(CSound * this_ptr, CDemonActor * actor, char * sound_name, CVector3f * position_tracker)
        ;   XREF to: 005b3a70 (UNCONDITIONAL_CALL)
