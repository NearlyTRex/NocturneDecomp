...
;                               FUNCTION
; *****************************************************************************
; __cdecl CPendulum * __cdecl core_pendulum_cpp_CPendulum_ctor_FUN_00549390(CPendulum *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00549397
    CALL core_actor.cpp_CDemonActor_ctor_FUN_004088b0 ; 00549398
    ...
    PUSH EAX                            ; 005493a5
    CALL core_dmodel.cpp_CKeyFramedModelInstance_ctor_FUN_00478ce0 ; 005493a6
    ...
    MOV ESI,0x63ec79                    ; 005493d2 | = "true"
    LEA EDI,[EBX + 0x2d4]               ; 005493d7
    PUSH EDI                            ; 005493dd
    MOV AL,byte ptr [ESI]               ; 005493de | = "true" | s_ue_0063ec7b
        ;   Label: LAB_005493de
    MOV byte ptr [EDI],AL               ; 005493e0
    CMP AL,0x0                          ; 005493e2
    JZ 0x005493f6                       ; 005493e4
        ;   XREF to: 005493f6 (CONDITIONAL_JUMP)  ; LAB_005493f6
    MOV AL,byte ptr [ESI + 0x1]         ; 005493e6 | s_rue_0063ec7a | s_e_0063ec7c
    ADD ESI,0x2                         ; 005493e9
    MOV byte ptr [EDI + 0x1],AL         ; 005493ec
    ADD EDI,0x2                         ; 005493ef
    CMP AL,0x0                          ; 005493f2
    JNZ 0x005493de                      ; 005493f4
        ;   XREF to: 005493de (CONDITIONAL_JUMP)  ; LAB_005493de
    POP EDI                             ; 005493f6
        ;   Label: LAB_005493f6
    MOV ESI,0x63ec7e                    ; 005493f7 | = "none"
    LEA EDI,[EBX + 0x338]               ; 005493fc
    PUSH EDI                            ; 00549402
    MOV AL,byte ptr [ESI]               ; 00549403 | = "none" | s_ne_0063ec80
        ;   Label: LAB_00549403
    MOV byte ptr [EDI],AL               ; 00549405
    CMP AL,0x0                          ; 00549407
    JZ 0x0054941b                       ; 00549409
        ;   XREF to: 0054941b (CONDITIONAL_JUMP)  ; LAB_0054941b
    MOV AL,byte ptr [ESI + 0x1]         ; 0054940b | s_one_0063ec7f | s_e_0063ec81
    ADD ESI,0x2                         ; 0054940e
    MOV byte ptr [EDI + 0x1],AL         ; 00549411
    ADD EDI,0x2                         ; 00549414
    CMP AL,0x0                          ; 00549417
    JNZ 0x00549403                      ; 00549419
        ;   XREF to: 00549403 (CONDITIONAL_JUMP)  ; LAB_00549403
    POP EDI                             ; 0054941b
        ;   Label: LAB_0054941b
