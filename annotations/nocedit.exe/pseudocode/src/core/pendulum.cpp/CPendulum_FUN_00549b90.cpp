...

{
  ...
  *(float *)(extraout_EBX + 0x3a0) =
  ...
  fVar2 = this_ptr_00[3].location.position.z;
  fVar7 = (float10)-1;
  this_ptr_00[3].location.area_id = (int)(float)fVar6;
  fVar4 = (float10)1;
  ...
  if ((CVector3f *)(this_ptr_00[3].actor_name + 0x14) != pCVar3) {
    ((CVector3f *)(this_ptr_00[3].actor_name + 0x14))->x = pCVar3->x;
    *(float *)(this_ptr_00[3].actor_name + 0x18) = pCVar3->y;
    *(float *)(this_ptr_00[3].actor_name + 0x1c) = pCVar3->z;
  }
  fVar4 = (float10)1;
