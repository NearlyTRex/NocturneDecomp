...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_pendulum.cpp_FUN_00549aa0()
;
;
; Referenced Globals:
...
section .text
    ...
    FADD double ptr [0x0063eca1]        ; 00549aa4 | double DOUBLE_0063eca1
    FLD float ptr [ESP + 0x8]           ; 00549aaa
    FCOMPP                              ; 00549aae
    FNSTSW AX                           ; 00549ab0
    SAHF                                ; 00549ab2
    JC 0x00549b71                       ; 00549ab3 | LAB_00549b71
        ;   XREF to: 00549b71 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x4]           ; 00549ab9
        ;   Label: LAB_00549ab9
    FADD double ptr [0x0063eca9]        ; 00549abd | double DOUBLE_0063eca9
    FLD float ptr [ESP + 0x8]           ; 00549ac3
    FCOMPP                              ; 00549ac7
    FNSTSW AX                           ; 00549ac9
    SAHF                                ; 00549acb
    JBE 0x00549adc                      ; 00549acc | LAB_00549adc
        ;   XREF to: 00549adc (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x8]           ; 00549ace
    FADD float ptr [0x0063ecb1]         ; 00549ad2 | float FLOAT_0063ecb1
    ...
    FNSTSW AX                           ; 00549b0c
    SAHF                                ; 00549b0e
    JNC 0x00549b1b                      ; 00549b0f | LAB_00549b1b
    ...
    FNSTSW AX                           ; 00549b29
    SAHF                                ; 00549b2b
    JBE 0x00549b3c                      ; 00549b2c | LAB_00549b3c
        ;   XREF to: 00549b3c (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0xc]           ; 00549b2e
    FADD float ptr [0x0063ecb1]         ; 00549b32 | float FLOAT_0063ecb1
    ...
    FNSTSW AX                           ; 00549b4a
    SAHF                                ; 00549b4c
    JBE 0x00549b5d                      ; 00549b4d | LAB_00549b5d
        ;   XREF to: 00549b5d (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0xc]           ; 00549b4f
    FADD float ptr [0x0063ecb1]         ; 00549b53 | float FLOAT_0063ecb1
    ...
    JMP 0x00549ab9                      ; 00549b7b | LAB_00549ab9
