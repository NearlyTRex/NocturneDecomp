...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_pendulum.cpp_FUN_005495c0()
;
;
; XREF[1]:
;   core_pendulum.cpp_FUN_0054a180 at 0054a2a3
;
; Referenced Globals:
...
section .text
    ...
    PUSH EAX                            ; 005495d4
    CALL core_setcolid.cpp_SCollisionInfo_ctor_FUN_005743c0 ; 005495d5 | SCollisionInfo * core_setcolid.cpp_SCollisionInfo_ctor_FUN_005743c0(SCollisionInfo * this_ptr)
        ;   XREF to: 005743c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005495da
    MOV EDX,dword ptr [EBP + 0x1c]      ; 005495dd
    TEST EDX,EDX                        ; 005495e0
    JNZ 0x00549606                      ; 005495e2 | LAB_00549606
        ;   XREF to: 00549606 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [EBP + 0x20]      ; 005495e4
        ;   Label: LAB_005495e4
    TEST ESI,ESI                        ; 005495e7
    JZ 0x0054961c                       ; 005495e9 | LAB_0054961c
    ...
    JZ 0x0054961c                       ; 005495fd | LAB_0054961c
        ;   XREF to: 0054961c (CONDITIONAL_JUMP)
    ...
    JNZ 0x005495ff                      ; 00549618 | LAB_005495ff
        ;   XREF to: 005495ff (CONDITIONAL_JUMP)
    JMP 0x005495e4                      ; 0054961a | LAB_005495e4
    ...
    JNZ 0x005495ff                      ; 00549635 | LAB_005495ff
        ;   XREF to: 005495ff (CONDITIONAL_JUMP)
    ...
    FXCH                                ; 00549663
    FLD float ptr [0x0063ec9d]          ; 00549665 | float FLOAT_0063ec9d
    FXCH                                ; 0054966b
    FMUL ST1                            ; 0054966d
    FXCH ST2                            ; 0054966f
    ...
    CALL core_dirmat.cpp_CMatrix3x3f_transformVectorTranspose_FUN_00472030 ; 0054972b | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVectorTranspose_FUN_00472030(CMatrix3x3f * matrix, CVector3f * output, CVector3f * input)
        ;   XREF to: 00472030 (UNCONDITIONAL_CALL)
    MOV EDX,EAX                         ; 00549730
    LEA EAX,[ESP + 0xa0]                ; 00549732
    ADD ESP,0xc                         ; 00549739
    CMP EAX,EDX                         ; 0054973c
    JZ 0x0054975d                       ; 0054973e | LAB_0054975d
    ...
    FNSTSW AX                           ; 0054977a
    SAHF                                ; 0054977c
    JA 0x005495ff                       ; 0054977d | LAB_005495ff
        ;   XREF to: 005495ff (CONDITIONAL_JUMP)
    FLD float ptr [EDX + 0x4]           ; 00549783
    FCOMP float ptr [ESP + 0x98]        ; 00549786
    FNSTSW AX                           ; 0054978d
    SAHF                                ; 0054978f
    JA 0x005495ff                       ; 00549790 | LAB_005495ff
        ;   XREF to: 005495ff (CONDITIONAL_JUMP)
    FLD float ptr [EDX + 0x8]           ; 00549796
    FCOMP float ptr [ESP + 0x9c]        ; 00549799
    FNSTSW AX                           ; 005497a0
    SAHF                                ; 005497a2
    JA 0x005495ff                       ; 005497a3 | LAB_005495ff
        ;   XREF to: 005495ff (CONDITIONAL_JUMP)
    FLD float ptr [EDX + 0xc]           ; 005497a9
    FCOMP float ptr [ESP + 0x94]        ; 005497ac
    FNSTSW AX                           ; 005497b3
    SAHF                                ; 005497b5
    JC 0x005495ff                       ; 005497b6 | LAB_005495ff
        ;   XREF to: 005495ff (CONDITIONAL_JUMP)
    FLD float ptr [EDX + 0x10]          ; 005497bc
    FCOMP float ptr [ESP + 0x98]        ; 005497bf
    FNSTSW AX                           ; 005497c6
    SAHF                                ; 005497c8
    JC 0x005495ff                       ; 005497c9 | LAB_005495ff
        ;   XREF to: 005495ff (CONDITIONAL_JUMP)
    FLD float ptr [EDX + 0x14]          ; 005497cf
    FCOMP float ptr [ESP + 0x9c]        ; 005497d2
    FNSTSW AX                           ; 005497d9
    SAHF                                ; 005497db
    JC 0x005495ff                       ; 005497dc | LAB_005495ff
        ;   XREF to: 005495ff (CONDITIONAL_JUMP)
    LEA EAX,[EBX + 0x158]               ; 005497e2
    PUSH EAX                            ; 005497e8
    CALL core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80 ; 005497e9 | CKeyFramedModel * core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80(CKeyFramedModelInstance * this_ptr)
    ...
    JLE 0x005495ff                      ; 0054981c | LAB_005495ff
        ;   XREF to: 005495ff (CONDITIONAL_JUMP)
    ...
    PUSH ECX                            ; 00549878
    CALL core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0 ; 00549879 | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0(CMatrix3x3f * this_ptr, CVector3f * output, CVector3f * input)
        ;   XREF to: 00471fd0 (UNCONDITIONAL_CALL)
    MOV EDX,EAX                         ; 0054987e
    LEA EAX,[ESP + 0x7c]                ; 00549880
    ADD ESP,0xc                         ; 00549884
    CMP EAX,EDX                         ; 00549887
    JNZ 0x00549917                      ; 00549889 | LAB_00549917
    ...
    FNSTSW AX                           ; 005498ea
    SAHF                                ; 005498ec
    JNC 0x00549930                      ; 005498ed | LAB_00549930
    ...
    JL 0x0054983c                       ; 0054990a | LAB_0054983c
    ...
    JMP 0x0054988f                      ; 0054992b | LAB_0054988f
    ...
    FNSTSW AX                           ; 0054993e
    SAHF                                ; 00549940
    JA 0x005498ef                       ; 00549941 | LAB_005498ef
    ...
    FNSTSW AX                           ; 00549958
    SAHF                                ; 0054995a
    JA 0x005498ef                       ; 0054995b | LAB_005498ef
        ;   XREF to: 005498ef (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [EBP + 0x1c]      ; 0054995d
    TEST EBX,EBX                        ; 00549960
    JZ 0x0054997d                       ; 00549962 | LAB_0054997d
    ...
    JZ 0x0054999d                       ; 00549982 | LAB_0054999d
    ...
    FXCH                                ; 005499c6
    FLD float ptr [0x0063ec9d]          ; 005499c8 | float FLOAT_0063ec9d
    FXCH                                ; 005499ce
    FMUL ST1                            ; 005499d0
    FXCH ST2                            ; 005499d2
    ...
    JZ 0x00549a6f                       ; 00549a4c | LAB_00549a6f
    ...
    PUSH EAX                            ; 00549a7c
    MOV EBX,dword ptr [0x0067b9a0]      ; 00549a7d | CGore g_CGoreInstance | CGore * g_CGorePtr
    PUSH EBX                            ; 00549a83 | CGore g_CGoreInstance
    CALL core_gore.cpp_FUN_004edbb0     ; 00549a84 | undefined core_gore.cpp_FUN_004edbb0()
