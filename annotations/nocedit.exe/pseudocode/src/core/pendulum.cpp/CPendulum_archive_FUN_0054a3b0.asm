...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_pendulum_cpp_CPendulum_archive_FUN_0054a3b0(CPendulum *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0054a3b0
        ;   Label: core_pendulum.cpp_CPendulum_archive_FUN_0054a3b0
    MOV EBX,dword ptr [ESP + 0x8]       ; 0054a3b1
    PUSH EBX                            ; 0054a3b5
    CALL core_actor.cpp_CDemonActor_archive_FUN_0040c1c0 ; 0054a3b6
    ...
    PUSH EAX                            ; 0054a3c9
    CALL core_actor.cpp_archiveKeyframedModelInstance_FUN_0040b8f0 ; 0054a3ca
    ...
    PUSH EAX                            ; 0054a3dd
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 0054a3de
    ...
    PUSH EAX                            ; 0054a3f1
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 0054a3f2
    ...
    PUSH EAX                            ; 0054a405
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 0054a406
    ...
    PUSH EAX                            ; 0054a419
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 0054a41a
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH EAX                            ; 0054a445
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 0054a446
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveString_FUN_0040b5c0(char * string_buffer, char * property_type)
    ADD ESP,0x8                         ; 0054a44b
    PUSH 0x63ed54                       ; 0054a44e | = "creak2Sound"
    LEA EAX,[EBX + 0x3f0]               ; 0054a453
    PUSH EAX                            ; 0054a459
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 0054a45a
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveString_FUN_0040b5c0(char * string_buffer, char * property_type)
    ADD ESP,0x8                         ; 0054a45f
    PUSH 0x63ed60                       ; 0054a462 | = "swooshPhaseBias"
    LEA EAX,[EBX + 0x3cc]               ; 0054a467
    PUSH EAX                            ; 0054a46d
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 0054a46e
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH EAX                            ; 0054a48a
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 0054a48b
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ADD ESP,0x8                         ; 0054a490
    PUSH 0x63ed79                       ; 0054a493 | = "killEnemy"
    LEA EAX,[EBX + 0x42c]               ; 0054a498
    PUSH EAX                            ; 0054a49e
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 0054a49f
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    PUSH EAX                            ; 0054a4bb
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 0054a4bc
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ADD ESP,0x8                         ; 0054a4c1
    PUSH 0x63ed89                       ; 0054a4c4 | = "decayTimer"
    LEA EAX,[EBX + 0x434]               ; 0054a4c9
    PUSH EAX                            ; 0054a4cf
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 0054a4d0
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH EAX                            ; 0054a4ec
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 0054a4ed
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    PUSH EAX                            ; 0054a509
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 0054a50a
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveString_FUN_0040b5c0(char * string_buffer, char * property_type)
    ...
    PUSH EAX                            ; 0054a528
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 0054a529
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveString_FUN_0040b5c0(char * string_buffer, char * property_type)
    ...
    PUSH EBX                            ; 0054a541
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 0054a542
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
