...

{
  ...
  core_actor_cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(in_stack_00000004,&CStack_80,pCVar1);
  iVar2 = core_weapon_cpp_FUN_005ee6e0();
  if (iVar2 == 0) {
    core_sound_cpp_CSound_playActorSound_FUN_005b3a40
              (g_CSoundPtr,in_stack_00000004,"shotgun-noammo.wav",&CStack_80);
    return 0;
  }
  ...
  if (0 < (int)fStack_38) {
    do {
      ...
      pCVar1 = core_actor_cpp_CDemonActor_transformVector_FUN_00408e80
                         (in_stack_00000004,&CStack_b0,&CStack_bc);
      if (&CStack_bc != pCVar1) {
      ...
      do {
        ...
        if ((this_ptr != (CCharacter *)0x0) &&
           (iVar2 = (*(((this_ptr->base_actor).vtable._uc)->_uc).isDamageable)(this_ptr), 0 < iVar2)
           ) {
        ...
        if (this_ptr == (CCharacter *)0x0) {
          ...
          pCVar1 = core_actor_cpp_CDemonActor_worldToLocalPoint_FUN_00408f10
                             (&this_ptr->base_actor,aCStack_ec,
  ...
  core_sound_cpp_CSound_playActorSound_FUN_005b3a40
            (g_CSoundPtr,in_stack_00000004,"elephantgun.wav",&CStack_80);
