...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_elephant.cpp_FUN_004a7070()
;
; Local Variables:
...
section .text
    ...
    JNZ 0x004a709f                      ; 004a7080 | LAB_004a709f
        ;   XREF to: 004a709f (CONDITIONAL_JUMP)
    PUSH dword ptr [ESP + 0x28]         ; 004a7082
        ;   Label: LAB_004a7082
    PUSH EBX                            ; 004a7086
    MOV dword ptr [EBX + 0x57c],0x0     ; 004a7087
    CALL core_weapon.cpp_CWeapon_process_FUN_005ee110 ; 004a7091 | void core_weapon.cpp_CWeapon_process_FUN_005ee110(CWeapon * this_ptr)
    ...
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 004a70ca | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
        ;   XREF to: 00408ec0 (UNCONDITIONAL_CALL)
    LEA EAX,[ESP + 0x14]                ; 004a70cf
    ADD ESP,0xc                         ; 004a70d3
    MOV dword ptr [0x02d807ac],ESI      ; 004a70d6 | g_CDemonLightInstance.field17_0x1cbc
    CMP EAX,0x2d7eaf4                   ; 004a70dc | g_CDemonLightInstance.base.base.position.x
    JZ 0x004a70fe                       ; 004a70e1 | LAB_004a70fe
    ...
    CALL core_dirmat.cpp_CMatrix3x3f_buildRotationMatrix_FUN_00471d30 ; 004a7107 | void core_dirmat.cpp_CMatrix3x3f_buildRotationMatrix_FUN_00471d30(CMatrix3x3f * this_ptr, CVector3f * euler_angles)
        ;   XREF to: 00471d30 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004a710c
    MOV EDI,0x42e00000                  ; 004a710f
    PUSH 0x3f800000                     ; 004a7114
    FLD float ptr [EBX + 0x580]         ; 004a7119
    PUSH 0x2d7eaf0                      ; 004a711f | CDemonLight g_CDemonLightInstance
    ...
    CALL core_dlight.cpp_CDemonLight_setVolumetricIntensity_FUN_004765e0 ; 004a7130 | void core_dlight.cpp_CDemonLight_setVolumetricIntensity_FUN_004765e0(CDemonLight * this_ptr, float intensity)
        ;   XREF to: 004765e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004a7135
    PUSH 0x2d7eaf0                      ; 004a7138 | CDemonLight g_CDemonLightInstance
    MOV EAX,[0x006810c8]                ; 004a713d | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
    XOR EBP,EBP                         ; 004a7142
    PUSH EAX                            ; 004a7144 | CDemonSet g_CDemonSetInstance
    MOV dword ptr [0x02d807c0],EBP      ; 004a7145 | g_CDemonLightInstance.antialiasing_enabled
    CALL core_set.cpp_CDemonSet_SomethingDynamicLights_FUN_0056d090 ; 004a714b | void core_set.cpp_CDemonSet_SomethingDynamicLights_FUN_0056d090(CDemonSet * this_ptr)
        ;   XREF to: 0056d090 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004a7150
    POP ESI                             ; 004a7153
    POP EDI                             ; 004a7154
    JMP 0x004a7082                      ; 004a7155 | LAB_004a7082
