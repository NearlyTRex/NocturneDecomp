...

{
  ...
  if (*(int *)(in_stack_00000004[1].base_actor.actor_name + 4) != 0) {
    ...
    (*(in_stack_00000004->base_actor).metadata.vtable[1].renderOpaque)
    ...
    if ((int *)&stack0x00000000 != g_CDemonLightInstance.base.base.rotation_matrix.m[0] + 1) {
      ...
      g_CDemonLightInstance.base.base.position.y = in_stack_fffffff4;
...
// 004a70ca: CALL core_actor.cpp_CDemonActor_FUN_00408ec0
