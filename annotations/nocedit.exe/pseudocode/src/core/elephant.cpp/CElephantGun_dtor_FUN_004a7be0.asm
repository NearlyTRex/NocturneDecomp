...
;                               FUNCTION
; *****************************************************************************
; __cdecl CElephantGun * __cdecl core_elephant_cpp_CElephantGun_dtor_FUN_004a7be0(CElephantGun *this_ptr,uint flags)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004a7be0
        ;   Label: core_elephant.cpp_CElephantGun_dtor_FUN_004a7be0
    ...
    PUSH 0x65d640                       ; 004a7c06 | g_CElephantGunTypeInfo
        ;   Label: LAB_004a7c06
    PUSH EBX                            ; 004a7c0b
    CALL crt_memory.c___vec_delete_FUN_005fe632 ; 004a7c0c
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c___vec_delete_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 004a7c11
    PUSH EAX                            ; 004a7c14
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 004a7c15
