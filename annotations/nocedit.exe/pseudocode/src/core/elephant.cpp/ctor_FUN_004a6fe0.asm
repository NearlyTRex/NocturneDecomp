...
;                               FUNCTION
; *****************************************************************************
; __cdecl CElephantGun * core_elephant.cpp_ctor_FUN_004a6fe0(CElephantGun * this_ptr)
;
; Parameters:
; CElephantGun *   Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_elephant.cpp_FUN_004a6fa0 at 004a6fba
;
; Referenced Globals:
...
section .text
    ...
    FLD float ptr [0x0065d52c]          ; 004a7043 | DAT_0065d52c
