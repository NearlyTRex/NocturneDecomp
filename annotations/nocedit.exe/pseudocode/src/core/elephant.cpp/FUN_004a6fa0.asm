...
section .text
    ...
    PUSH EAX                            ; 004a6fb9
        ;   Label: LAB_004a6fb9
    CALL core_elephant.cpp_ctor_FUN_004a6fe0 ; 004a6fba
        ;   XREF to: 004a6fe0 (UNCONDITIONAL_CALL)  ; CElephantGun * core_elephant.cpp_ctor_FUN_004a6fe0(CElephantGun * this_ptr)
