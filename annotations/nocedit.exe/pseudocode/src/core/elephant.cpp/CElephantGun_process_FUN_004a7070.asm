...
section .text
    ...
    PUSH EBX                            ; 004a7070
        ;   Label: core_elephant.cpp_CElephantGun_process_FUN_004a7070
    PUSH EBP                            ; 004a7071
    ...
    LEA EAX,[EBX + 0x30]                ; 004a70fe
        ;   Label: LAB_004a70fe
    PUSH EAX                            ; 004a7101
    PUSH 0x2d7eb00                      ; 004a7102 | g_CDemonLightInstance.base.base.rotation_matrix.m[0].x
    ...
    MOV dword ptr [0x02d7eb28],EDI      ; 004a712a | g_CDemonLightInstance.base.base.focal_length
    ...
    CALL core_set.cpp_CDemonSet_addDynamicLight_FUN_0056d090 ; 004a714b
