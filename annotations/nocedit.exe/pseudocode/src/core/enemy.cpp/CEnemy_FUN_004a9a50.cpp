...
// Convention: __cdecl
// Signature: int __cdecl core_enemy_cpp_CEnemy_FUN_004a9a50(CEnemy *this_ptr,CDemonActor *target)

#include "nocturne.h"

int __cdecl core_enemy_cpp_CEnemy_FUN_004a9a50(CEnemy *this_ptr,CDemonActor *target)
