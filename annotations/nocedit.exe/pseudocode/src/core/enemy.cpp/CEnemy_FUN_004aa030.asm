...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_enemy.cpp_CEnemy_FUN_004aa030(CEnemy * this_ptr)
;
; Parameters:
...
section .text
    ...
    JNZ 0x004aa047                      ; 004aa040 | LAB_004aa047
    ...
    JNZ 0x004aa042                      ; 004aa05b | LAB_004aa042
    ...
    CALL core_charactr.cpp_CCharacter_FUN_00428f40 ; 004aa0a6 | void core_charactr.cpp_CCharacter_FUN_00428f40(CCharacter * this_ptr)
