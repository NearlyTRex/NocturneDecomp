// Name: core_enemy.cpp_CEnemy_archive_FUN_004a9660
// Address: 004a9660
// Address Range: [[004a9660, 004a97b1]]
// Convention: __cdecl
// Signature: void __cdecl core_enemy_cpp_CEnemy_archive_FUN_004a9660(CEnemy *this_ptr)
...

{
  if (g_CEnemyClassVersion < 4) {
    ...
    if (4 < g_CEnemyClassVersion) {
      core_actor_cpp_archiveInteger_FUN_0040b7f0(&this_ptr->randomize_me,"randomizeMe");
    }
    ...
    if (9 < g_CEnemyClassVersion) {
      core_actor_cpp_archiveActor_FUN_0040b870
                ((CDemonActor *)(this_ptr->unk2 + 4),"victim");
      return;
    }
  }
  return;
