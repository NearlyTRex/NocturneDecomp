  ...
  if (pCVar2 == (CCharacter *)0x0) {
    ...
    if (fVar3 <= 0.0) {
      ...
      for (local_24 = 0; local_24 < g_CDemonSetPtr->character_count; local_24 = local_24 + 1) {
        ...
        iVar11 = (*(((iVar9->base).vtable._uc)->_uc).isGrabbable)(iVar9,(CDemonActor *)this_ptr);
        if (((iVar11 != 0) &&
            (EVar7 = (*(((iVar9->base).vtable._uc)->_uc).getDeathState)(iVar9),
            EVar7 == DEATH_STATE_ALIVE)) &&
           ((iVar11 = (*((iVar9->base).vtable._ub)->shouldIgnoreForTargeting)(&iVar9->base),
            iVar11 == 0 && (iVar9->speech_timer <= 0.0)))) {
      ...
      while( true ) {
        ...
        if (iVar11 < 0) break;
        local_1c = (CCharacter *)g_EnemyVictimCandidates[iVar11];
        iVar10 = core_enemy_cpp_CEnemy_canSeeTarget_FUN_004a9a50(this_ptr,(CDemonActor *)local_1c);
        ...
        if ((((this_ptr->allow_pathfind_to_new_targets != 0) ||
           ...
           (iVar10 = core_path_cpp_CPathMap_findPathWithRetry_FUN_00547d00
