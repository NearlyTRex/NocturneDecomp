...
// Convention: __cdecl
// Signature: int __cdecl core_enemy_cpp_CEnemy_FUN_004a9fd0(CEnemy *this_ptr)
  ...
  if (g_CGamePtr->debug_flag_2 == 0) {
    ...
    if (iVar1 == 0) {
      iVar1 = core_charactr_cpp_CCharacter_updateWanderToWaypoint_FUN_0042e050
                        (&this_ptr->base,in_stack_00000008,this_ptr->patrol_name_pattern);
      return iVar1;
    }
  }
  iVar1 = core_charactr_cpp_CCharacter_updateWanderToWaypoint_FUN_0042e050
                    (&this_ptr->base,in_stack_00000008,(char *)0x0);
  return iVar1;
}
