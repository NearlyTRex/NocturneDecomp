...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_enemy_cpp_CEnemy_serialize_FUN_004a9660(CEnemy *this_ptr)
;
; Parameters:
...
;   core_beast.cpp_CBeast_serialize_FUN_00418330 at 00418337
;   core_biggs.cpp_CBiggs_serialize_FUN_00418ac0 at 00418ac7
;   core_boneguy.cpp_CBoneGuy_serialize_FUN_0041d270 at 0041d27c
;   core_bride.cpp_CBride_serialize_FUN_00424560 at 00424566
...
section .text
    ...
    PUSH EBX                            ; 004a9677
    CALL core_actor.cpp_CDemonActor_serialize_FUN_0040c1c0 ; 004a9678
    ...
    PUSH ESI                            ; 004a9690
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 004a9691
    ...
    PUSH ESI                            ; 004a96b0
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 004a96b1
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ADD ESP,0x8                         ; 004a96b6
    PUSH 0x62431d                       ; 004a96b9 | = "poolMe"
    ADD EBX,0xbe28                      ; 004a96be
    PUSH EBX                            ; 004a96c4
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 004a96c5
    ...
    PUSH EBX                            ; 004a96d0
        ;   Label: LAB_004a96d0
    CALL core_charactr.cpp_CCharacter_serialize_FUN_004283a0 ; 004a96d1
    ...
    PUSH ESI                            ; 004a96de
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 004a96df
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ADD ESP,0x8                         ; 004a96e4
    PUSH 0x62432a                       ; 004a96e7 | = "poolMe"
    LEA ESI,[EBX + 0xbe28]              ; 004a96ec
    PUSH ESI                            ; 004a96f2
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 004a96f3
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    PUSH ESI                            ; 004a9711
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 004a9712
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    PUSH ESI                            ; 004a972e
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 004a972f
    ...
    PUSH ESI                            ; 004a974b
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 004a974c
    ...
    PUSH ESI                            ; 004a9768
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 004a9769
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH ESI                            ; 004a9785
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 004a9786
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH EBX                            ; 004a97a6
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 004a97a7
        ;   XREF to: 0040b870 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeActor_FUN_0040b870(CDemonActor * actor_ptr, char * property_name)
