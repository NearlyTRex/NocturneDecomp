...
section .text
    ...
    CALL core_actor.cpp_CDemonActor_getActorClassName_FUN_00408b90 ; 004aa100 | char * core_actor.cpp_CDemonActor_getActorClassName_FUN_00408b90(CDemonActor * this_ptr)
        ;   XREF to: 00408b90 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004aa105
    XOR EBP,EBP                         ; 004aa108
    MOV dword ptr [ESP],EAX             ; 004aa10a
    MOV EAX,[0x006810c8]                ; 004aa10d | CDemonSet * g_CDemonSetPtr
        ;   Label: LAB_004aa10d
    CMP EDI,dword ptr [EAX + 0x150fdc]  ; 004aa112 | g_CDemonSetInstance.field19_0x14f0a0[7996]
    JL 0x004aa124                       ; 004aa118 | LAB_004aa124
    ...
    PUSH EAX                            ; 004aa12e
    PUSH EBX                            ; 004aa12f
    CALL core_actor.cpp_isOfClass_FUN_0040c6d0 ; 004aa130 | int core_actor.cpp_isOfClass_FUN_0040c6d0(CDemonActor * actor_ptr, char * class_name)
        ;   XREF to: 0040c6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004aa135
    TEST EAX,EAX                        ; 004aa138
    JZ 0x004aa166                       ; 004aa13a | LAB_004aa166
    ...
    JNZ 0x004aa166                      ; 004aa14e | LAB_004aa166
        ;   XREF to: 004aa166 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x02db87d0]      ; 004aa150 | int g_LocalHeroIndex
    MOV EAX,dword ptr [EBX + 0xbe3c]    ; 004aa156
    CMP EAX,dword ptr [EDX*0x4 + 0x2db87c0] ; 004aa15c | CHero *[4] g_HeroActors
    JNZ 0x004aa166                      ; 004aa163 | LAB_004aa166
        ;   XREF to: 004aa166 (CONDITIONAL_JUMP)
    INC EBP                             ; 004aa165
    INC EDI                             ; 004aa166
        ;   Label: LAB_004aa166
    ADD ESI,0x4                         ; 004aa167
    JMP 0x004aa10d                      ; 004aa16a | LAB_004aa10d
