...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_enemy_cpp_CEnemy_setup_FUN_004a9650(CEnemy *this_ptr)
;
; Parameters:
; CEnemy *         Stack[0x4]:4   this_ptr
;
; XREF[27]:
;   core_armour.cpp_CArmour_setup_FUN_00412240 at 00412245
;   core_batcreat.cpp_CBatCreature_setup_FUN_00415150 at 00415158
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x4]       ; 004a9650
        ;   Label: core_enemy.cpp_CEnemy_setup_FUN_004a9650
    PUSH EDX                            ; 004a9654
    CALL core_charactr.cpp_CCharacter_setup_FUN_00428140 ; 004a9655
