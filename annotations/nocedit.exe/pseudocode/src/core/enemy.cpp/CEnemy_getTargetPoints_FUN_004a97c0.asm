...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_enemy_cpp_CEnemy_getTargetPoints_FUN_004a97c0(CEnemy *this_ptr,CVector3f *out_points_array)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004a97c0
        ;   Label: core_enemy.cpp_CEnemy_getTargetPoints_FUN_004a97c0
    PUSH EBP                            ; 004a97c1
