...

{
  ...
  (pCVar3->base_weapon).base_actor.metadata.vtable =
       &PTR_core_weapon_cpp_ActorModelSomething_FUN_00660a64;
  core_dmodel_cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0
            ((CKeyFramedModelInstance *)&(pCVar3->base_weapon).model_instance,"cre.kfm");
  ...
  (pCVar3->base_weapon).field4_0x2d8[0] = '\0';
  (pCVar3->base_weapon).field4_0x2d8[1] = '\0';
  (pCVar3->base_weapon).field4_0x2d8[2] = '\0';
  (pCVar3->base_weapon).field4_0x2d8[3] = '\0';
  (pCVar3->base_weapon).field4_0x2d8[4] = '\0';
  (pCVar3->base_weapon).field4_0x2d8[5] = '\0';
  (pCVar3->base_weapon).field4_0x2d8[6] = '\0';
  (pCVar3->base_weapon).field4_0x2d8[7] = '\0';
  (pCVar3->base_weapon).field4_0x2d8[8] = '\x02';
  (pCVar3->base_weapon).field4_0x2d8[9] = '\0';
  (pCVar3->base_weapon).field4_0x2d8[10] = '\0';
  (pCVar3->base_weapon).field4_0x2d8[0xb] = '\0';
  (pCVar3->base_weapon).field4_0x2d8[0xc] = '\0';
  (pCVar3->base_weapon).field4_0x2d8[0xd] = '\0';
  (pCVar3->base_weapon).field4_0x2d8[0xe] = '\0';
  (pCVar3->base_weapon).field4_0x2d8[0xf] = '\0';
  (pCVar3->base_weapon).field4_0x2d8[0x10] = '\0';
  (pCVar3->base_weapon).field4_0x2d8[0x11] = '\0';
  (pCVar3->base_weapon).field4_0x2d8[0x12] = '\0';
  (pCVar3->base_weapon).field4_0x2d8[0x13] = 'B';
  (pCVar3->base_weapon).field4_0x2d8[0x14] = '\x01';
  uVar1 = _DAT_00660a3c;
  (pCVar3->base_weapon).field4_0x2d8[0x15] = '\0';
  (pCVar3->base_weapon).field4_0x2d8[0x16] = '\0';
  (pCVar3->base_weapon).field4_0x2d8[0x17] = '\0';
  ...
  *(undefined4 *)((pCVar3->base_weapon).field8_0x305 + 0x25f) = uVar1;
