...
;                               FUNCTION
; *****************************************************************************
; __cdecl CLightGun * __cdecl core_lightgun_cpp_CLightGun_ctor_FUN_00505900(CLightGun *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00505900
        ;   Label: core_lightgun.cpp_CLightGun_ctor_FUN_00505900
    ...
    PUSH EAX                            ; 0050591a
    MOV dword ptr [EAX + -0x4],0x660a64 ; 0050591b | g_CLightGunVTable
