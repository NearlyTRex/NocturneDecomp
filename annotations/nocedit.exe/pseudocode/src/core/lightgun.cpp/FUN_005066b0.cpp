...

{
  ...
  if (iVar2 == 0) {
    ...
    fStack_48 = in_stack_00000004[2].orient.heading;
    fStack_50 = 0.0;
    fStack_4c = 0.0;
    ...
    if (in_stack_00000004[4].location.position.z != 0.0) {
      ...
      fStack_4c = fStack_1c - fStack_28;
      fStack_2c = fStack_20 - fStack_2c;
      fStack_48 = fStack_18 - fStack_24;
      fVar1 = SQRT(fStack_48 * fStack_48 + fStack_2c * fStack_2c + fStack_4c * fStack_4c);
      if (0.0 < fVar1) {
        fVar1 = 1.0 / fVar1;
        fStack_50 = fStack_2c * fVar1;
      ...
      fStack_54 = (float)in_stack_00000004[4].location.area_id * (float)g_CLightConeObj;
      fStack_5c = fStack_50 * fStack_54;
      fStack_58 = fStack_4c * fStack_54;
      fStack_54 = fStack_48 * fStack_54;
      if (&fStack_50 != &fStack_5c) {
        fStack_50 = fStack_5c;
        fStack_4c = fStack_58;
        fStack_48 = fStack_54;
      }
...
// 0050670b: PUSH EAX
// 0050670c: PUSH ESI
// 0050670d: CALL core_actor.cpp_CDemonActor_FUN_00408ec0
...
// 00506738: CALL core_actor.cpp_CDemonActor_FUN_00408e80
