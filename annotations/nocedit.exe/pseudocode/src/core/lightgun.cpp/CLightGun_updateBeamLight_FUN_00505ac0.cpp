...

{
  ...
  if ((float *)&local_res0 != &g_CDemonLightInstance.base.base.rotation_matrix.m[0].z) {
    g_CDemonLightInstance.base.base.position.f.x = CStack_14.x;
    g_CDemonLightInstance.base.base.position.f.y = CStack_14.y;
    g_CDemonLightInstance.base.base.position.f.z = CStack_14.z;
  }
