...
section .text
    ...
    CALL core_setcolid.cpp_CDemonSet_init_FUN_00574180 ; 00505e0b
    ...
    MOV ESI,dword ptr [EAX + 0x14f09c]  ; 00505eef | g_CDemonSetInstance.characters[0] | g_CDemonSetInstance.characters[1]
    PUSH ESI                            ; 00505ef5
    ...
    PUSH EAX                            ; 00505fb2
    CALL core_actor.cpp_CVector3f_ctor_FUN_00410340 ; 00505fb3
    ...
    CALL core_actor.cpp_CVector3f_ctor_FUN_00410340 ; 00505fef
        ;   XREF to: 00410340 (UNCONDITIONAL_CALL)  ; CVector3f * core_actor.cpp_CVector3f_ctor_FUN_00410340(CVector3f * this_ptr)
    ...
    MOV EDX,dword ptr [EAX + 0x14d144]  ; 00506075 | g_CDemonSetInstance.collision_actor
    ...
    MOV EDX,dword ptr [EAX + 0x14d144]  ; 00506112 | g_CDemonSetInstance.collision_actor
    PUSH EDX                            ; 00506118
    ...
    PUSH EBX                            ; 00506154
    MOV ESI,dword ptr [EAX + 0x14d144]  ; 00506155 | g_CDemonSetInstance.collision_actor
    PUSH ESI                            ; 0050615b
    ...
    MOV EDX,dword ptr [EAX + 0x14d144]  ; 00506171 | g_CDemonSetInstance.collision_actor
    PUSH EDX                            ; 00506177
    ...
    CALL core_setcolid.cpp_CDemonSet_init_FUN_00574180 ; 005061d9
        ;   XREF to: 00574180 (UNCONDITIONAL_CALL)  ; void core_setcolid.cpp_CDemonSet_init_FUN_00574180(CDemonSet * this_ptr)
    ...
    PUSH EAX                            ; 005061f2
    CALL core_trigger.cpp_CTrigger_onProjectileHit_FUN_005e0aa0 ; 005061f3
    ...
    PUSH EBX                            ; 00506230
    CALL core_trigger.cpp_CTrigger_applyDamage_FUN_005e0b00 ; 00506231
    ...
    MOV EAX,[0x006810c8]                ; 0050632e | g_CDemonSetInstance | g_CDemonSetPtr
        ;   Label: LAB_0050632e
    MOV ECX,dword ptr [EAX + 0x14d144]  ; 00506333 | g_CDemonSetInstance.collision_actor
    PUSH ECX                            ; 00506339
    ...
    PUSH EAX                            ; 005063e6 | g_CDemonSetInstance
        ;   Label: LAB_005063e6
    CALL core_setcolid.cpp_CDemonSet_init_FUN_00574180 ; 005063e7
        ;   XREF to: 00574180 (UNCONDITIONAL_CALL)  ; void core_setcolid.cpp_CDemonSet_init_FUN_00574180(CDemonSet * this_ptr)
