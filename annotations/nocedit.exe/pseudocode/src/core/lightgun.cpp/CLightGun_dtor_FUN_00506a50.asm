...
;                               FUNCTION
; *****************************************************************************
; __cdecl CLightGun * __cdecl core_lightgun_cpp_CLightGun_dtor_FUN_00506a50(CLightGun *this_ptr,uint d1,uint d2)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00506a50
        ;   Label: core_lightgun.cpp_CLightGun_dtor_FUN_00506a50
    ...
    PUSH 0x660b70                       ; 00506a76 | g_CLightGunTypeInfo
        ;   Label: LAB_00506a76
    PUSH EBX                            ; 00506a7b
    CALL crt_memory.c___vec_delete_FUN_005fe632 ; 00506a7c
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c___vec_delete_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 00506a81
    PUSH EAX                            ; 00506a84
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 00506a85
