...
section .text
    ...
    PUSH 0x3a                           ; 005058c0
        ;   Label: core_lightgun.cpp_factoryFuncLightGun_FUN_005058c0
    PUSH 0x631440                       ; 005058c2 | = "..\\core\\lightgun.cpp"
    PUSH 0x590                          ; 005058c7
    CALL shape_memdbg.cpp_debugAllocTracked1_FUN_0050f1b0 ; 005058cc
    ...
    PUSH EAX                            ; 005058d9
        ;   Label: LAB_005058d9
    CALL core_lightgun.cpp_CLightGun_ctor_FUN_00505900 ; 005058da
        ;   XREF to: 00505900 (UNCONDITIONAL_CALL)  ; CLightGun * core_lightgun.cpp_CLightGun_ctor_FUN_00505900(CLightGun * this_ptr)
