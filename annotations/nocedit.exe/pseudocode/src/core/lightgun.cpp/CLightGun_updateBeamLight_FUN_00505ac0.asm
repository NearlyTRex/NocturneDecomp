...
section .text
    ...
    PUSH EBX                            ; 00505ac0
        ;   Label: core_lightgun.cpp_CLightGun_updateBeamLight_FUN_00505ac0
    PUSH ESI                            ; 00505ac1
    ...
    MOV dword ptr [0x02d807ac],ECX      ; 00505afc | g_CDemonLightInstance.volumetric_enabled
    CMP EAX,0x2d7eaf4                   ; 00505b02 | g_CDemonLightInstance.base.base.position
    JZ 0x00505b24                       ; 00505b07
        ;   XREF to: 00505b24 (CONDITIONAL_JUMP)  ; LAB_00505b24
    MOV EAX,dword ptr [ESP + 0xc]       ; 00505b09
    MOV [0x02d7eaf4],EAX                ; 00505b0d | g_CDemonLightInstance.base.base.position
    MOV EAX,dword ptr [ESP + 0x10]      ; 00505b12
    MOV [0x02d7eaf8],EAX                ; 00505b16 | g_CDemonLightInstance.base.base.position+4
    MOV EAX,dword ptr [ESP + 0x14]      ; 00505b1b
    MOV [0x02d7eafc],EAX                ; 00505b1f | g_CDemonLightInstance.base.base.position+8
