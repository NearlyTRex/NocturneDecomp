...
section .text
    ...
    PUSH EDX                            ; 00505905
    CALL core_weapon.cpp_CWeapon_ctor_FUN_005ede70 ; 00505906 | CWeapon * core_weapon.cpp_CWeapon_ctor_FUN_005ede70(CWeapon * this_ptr)
        ;   XREF to: 005ede70 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0050590b
    PUSH 0x631455                       ; 0050590e | = "cre.kfm" | s_cre_kfm_00631455 = cre.kfm
    MOV EBX,EAX                         ; 00505913
    ADD EAX,0x158                       ; 00505915
    PUSH EAX                            ; 0050591a
    MOV dword ptr [EAX + -0x4],0x660a64 ; 0050591b | CDemonActor_vtable PTR_core_weapon.cpp_ActorModelSomething_FUN_00660a64
    CALL core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0 ; 00505922 | void core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0(CKeyFramedModelInstance * this_ptr, char * filename)
    ...
    FLD float ptr [0x00660a40]          ; 00505987 | undefined4 DAT_00660a40
