  ...
  do {
    ...
    if (((iVar6 == 0) &&
        ((((iVar6 = core_actor_cpp_isOfClass_FUN_0040c6d0(pCVar3,"CGhoul"), iVar6 != 0 ||
          ...
          (iVar6 = core_actor_cpp_isOfClass_FUN_0040c6d0(pCVar3,"CBatCreature"), iVar6 != 0
          )) || ((iVar6 = core_actor_cpp_isOfClass_FUN_0040c6d0(pCVar3,"CWerewolf"),
                 iVar6 != 0 ||
                 (iVar6 = core_actor_cpp_isOfClass_FUN_0040c6d0(pCVar3,"CSvetlana"),
                 iVar6 != 0)))))) ||
       ((iVar6 = core_actor_cpp_isOfClass_FUN_0040c6d0(pCVar3,"CDraculaBride"), iVar6 != 0
        || (((iVar6 = core_actor_cpp_isOfClass_FUN_0040c6d0(pCVar3,"CBatman"), iVar6 != 0
             || (iVar6 = core_actor_cpp_isOfClass_FUN_0040c6d0(pCVar3,"CBatCreature"),
                iVar6 != 0)) ||
      ...
      if (iVar6 != 0) {
        ...
        in_stack_0000007c = (pCVar2->min).z + in_stack_000000c0[2];
        ...
        do {
          ...
          if (pCVar4 == (CDemonActor *)0x0) break;
          if (pCVar3 == pCVar4) {
            in_stack_000000b8 = 1;
            break;
          }
          iVar5 = core_actor_cpp_isOfClass_FUN_0040c6d0(pCVar4,"CTrigger || CGlass");
          if (iVar5 == 0) break;
          iVar6 = iVar6 + 1;
          core_setcolid_cpp_CDemonSet_ignore_FUN_005741b0
...
// 00506406: CALL core_sound.cpp_CSound_FUN_005b3a40
...
// 0050641a: PUSH EDX
// 0050641b: CALL sound_sndmain.cpp_CallComputingDelay2_FUN_005a9ae0
