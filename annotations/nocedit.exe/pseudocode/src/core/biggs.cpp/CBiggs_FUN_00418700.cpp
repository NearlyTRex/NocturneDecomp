...
// Convention: __cdecl
// Signature: void __cdecl core_biggs_cpp_CBiggs_FUN_00418700(CBiggs *this_ptr)
...

{
  ...
  *(float *)((this_ptr->base).base.unk1 + 0x28) =
       (this_ptr->base).base.model.accumulated_root_motion.z;
  *(float *)((this_ptr->base).base.unk1 + 0x2c) = in_stack_00000008 * fVar3 * fVar1;
...
LAB_004187db:
  if (0.0 < *(float *)(this_ptr->base).unk2) {
    *(float *)(this_ptr->base).unk2 = *(float *)(this_ptr->base).unk2 - in_stack_00000008;
  }
  ...
  iVar5 = core_event_cpp_CEventList_evaluateCondition_FUN_004adca0
                    (g_CEventListPtr,this_ptr->unk2 + 0xc2c);
  if (iVar5 != 0) {
