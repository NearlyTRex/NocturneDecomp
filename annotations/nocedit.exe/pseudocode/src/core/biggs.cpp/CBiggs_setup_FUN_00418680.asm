...
;   core_morph.cpp_CMorph_setupModelFromKeyframed_FUN_0052b470
...
section .text
    ...
    PUSH ESI                            ; 004186b7
    CALL core_morph.cpp_CMorph_setupModelFromDeformable_FUN_0052b430 ; 004186b8
    ...
    PUSH 0x1                            ; 004186cc
    PUSH ESI                            ; 004186ce
    CALL core_morph.cpp_CMorph_setupModelFromKeyframed_FUN_0052b470 ; 004186cf
        ;   XREF to: 0052b470 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_CMorph_setupModelFromKeyframed_FUN_0052b470(CMorph * this_ptr, int model_index, CKeyFramedModel * model_ptr, int frame_index)
