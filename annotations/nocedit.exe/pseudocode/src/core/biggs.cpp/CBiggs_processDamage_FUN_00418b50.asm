...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_biggs_cpp_CBiggs_processDamage_FUN_00418b50(CBiggs *this_ptr,SDamageInfo *damage_info)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00418b50
        ;   Label: core_biggs.cpp_CBiggs_processDamage_FUN_00418b50
    PUSH ESI                            ; 00418b51
    PUSH EDI                            ; 00418b52
    ...
    PUSH EDX                            ; 00418bb8
    PUSH EBX                            ; 00418bb9
    CALL core_enemy.cpp_CEnemy_processDamage_FUN_004a9f10 ; 00418bba
    ...
    PUSH EDX                            ; 00418bf6
    PUSH EBX                            ; 00418bf7
    CALL core_enemy.cpp_CEnemy_processDamage_FUN_004a9f10 ; 00418bf8
        ;   XREF to: 004a9f10 (UNCONDITIONAL_CALL)  ; void core_enemy.cpp_CEnemy_processDamage_FUN_004a9f10(CEnemy * this_ptr, SDamageInfo * damage_info)
