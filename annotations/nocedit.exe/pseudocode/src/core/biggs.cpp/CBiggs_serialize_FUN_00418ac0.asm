...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_biggs_cpp_CBiggs_serialize_FUN_00418ac0(CBiggs *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00418ac0
        ;   Label: core_biggs.cpp_CBiggs_serialize_FUN_00418ac0
    PUSH ESI                            ; 00418ac1
    MOV EBX,dword ptr [ESP + 0xc]       ; 00418ac2
    PUSH EBX                            ; 00418ac6
    CALL core_enemy.cpp_CEnemy_serialize_FUN_004a9660 ; 00418ac7
    ...
    PUSH 0x615b19                       ; 00418acf | = "speed"
    LEA ESI,[EBX + 0xbe24]              ; 00418ad4
    PUSH ESI                            ; 00418ada
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 00418adb
    ...
    PUSH 0x615b1f                       ; 00418ae3 | = "modelName"
    LEA ESI,[EBX + 0x158]               ; 00418ae8
    PUSH ESI                            ; 00418aee
    CALL core_actor.cpp_serializedDeformableModelInstance_FUN_0040b970 ; 00418aef
    ...
    PUSH 0x615b29                       ; 00418af7 | = "motion state"
    PUSH ESI                            ; 00418afc
    CALL core_actor.cpp_serializeMotionState_FUN_0040b9f0 ; 00418afd
    ...
    PUSH 0x615b36                       ; 00418b05 | = "morphing"
    LEA ESI,[EBX + 0xc038]              ; 00418b0a
    PUSH ESI                            ; 00418b10
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 00418b11
    ...
    PUSH 0x615b3f                       ; 00418b19 | = "morphTimer"
    LEA ESI,[EBX + 0xc03c]              ; 00418b1e
    PUSH ESI                            ; 00418b24
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 00418b25
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ADD ESP,0x8                         ; 00418b2a
    PUSH 0x615b4a                       ; 00418b2d | = "morphEvent"
    ADD EBX,0xcc6c                      ; 00418b32
    PUSH EBX                            ; 00418b38
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 00418b39
