...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_biggs.cpp_CBiggs_FUN_00418700(CBiggs * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00418711
    CALL core_charactr.cpp_CCharacter_FUN_00429870 ; 00418712 | int core_charactr.cpp_CCharacter_FUN_00429870(CCharacter * this_ptr)
        ;   XREF to: 00429870 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00418717
    TEST EAX,EAX                        ; 0041871a
    JZ 0x00418944                       ; 0041871c | LAB_00418944
    ...
    FNSTSW AX                           ; 00418753
    SAHF                                ; 00418755
    JC 0x0041894a                       ; 00418756 | LAB_0041894a
        ;   XREF to: 0041894a (CONDITIONAL_JUMP)
    FLD float ptr [EBX + 0xbe24]        ; 0041875c
    FLD float ptr [EBP + 0x14]          ; 00418762
    FMUL double ptr [0x00615b09]        ; 00418765 | double DOUBLE_00615b09
    FMULP                               ; 0041876b
    FLD float ptr [EBX + 0x23b4]        ; 0041876d
    PUSH ESI                            ; 00418773
    FSTP float ptr [EBX + 0x2434]       ; 00418774
    FSTP float ptr [EBX + 0x2438]       ; 0041877a
    CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0 ; 00418780 | SMotion * core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0(CMotionController * this_ptr)
        ;   XREF to: 0052dab0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00418785
    PUSH dword ptr [EBP + 0x14]         ; 00418788
    PUSH EBX                            ; 0041878b
    CALL core_charactr.cpp_CCharacter_FUN_0042ca70 ; 0041878c | int core_charactr.cpp_CCharacter_FUN_0042ca70(CCharacter * this_ptr)
        ;   XREF to: 0042ca70 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00418791
    TEST EAX,EAX                        ; 00418794
    JZ 0x004187db                       ; 00418796 | LAB_004187db
        ;   XREF to: 004187db (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0x25b0]    ; 00418798
    CMP EAX,0x2                         ; 0041879e
    JNC 0x00418989                      ; 004187a1 | LAB_00418989
        ;   XREF to: 00418989 (CONDITIONAL_JUMP)
    CMP EAX,0x1                         ; 004187a7
    JNZ 0x00418994                      ; 004187aa | LAB_00418994
    ...
    LEA EAX,[EBX + 0x158]               ; 004187b4
        ;   Label: LAB_004187b4
    PUSH EAX                            ; 004187ba
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 004187bb | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
    ...
    FNSTSW AX                           ; 004187e5
    SAHF                                ; 004187e7
    JNC 0x004187f9                      ; 004187e8 | LAB_004187f9
    ...
    PUSH EBX                            ; 004187f9
        ;   Label: LAB_004187f9
    CALL core_charactr.cpp_CCharacter_FUN_004297e0 ; 004187fa | int core_charactr.cpp_CCharacter_FUN_004297e0(CCharacter * this_ptr)
        ;   XREF to: 004297e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004187ff
    TEST EAX,EAX                        ; 00418802
    JZ 0x004188cf                       ; 00418804 | LAB_004188cf
        ;   XREF to: 004188cf (CONDITIONAL_JUMP)
    FLD float ptr [EBP + 0x14]          ; 0041880a
    FLD ST0                             ; 0041880d
    FMUL double ptr [0x00615b11]        ; 0041880f | double DOUBLE_00615b11
    ...
    PUSH EAX                            ; 004188c5
    PUSH EBX                            ; 004188c6
    CALL core_charactr.cpp_CCharacter_FUN_00428f40 ; 004188c7 | void core_charactr.cpp_CCharacter_FUN_00428f40(CCharacter * this_ptr)
        ;   XREF to: 00428f40 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004188cc
    PUSH EBX                            ; 004188cf
        ;   Label: LAB_004188cf
    CALL core_charactr.cpp_CCharacter_FUN_00429820 ; 004188d0 | void core_charactr.cpp_CCharacter_FUN_00429820(CCharacter * this_ptr)
        ;   XREF to: 00429820 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004188d5
    LEA EAX,[EBX + 0x158]               ; 004188d8
    PUSH EAX                            ; 004188de
    CALL core_skeleton.cpp_CDeformableModelInstance_updateAnimation_FUN_0059e020 ; 004188df | void core_skeleton.cpp_CDeformableModelInstance_updateAnimation_FUN_0059e020(CDeformableModelInstance * this_ptr)
        ;   XREF to: 0059e020 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004188e4
    PUSH dword ptr [EBP + 0x14]         ; 004188e7
    PUSH EBX                            ; 004188ea
    CALL core_charactr.cpp_CCharacter_ApplyGestureLookAt_FUN_0042dfc0 ; 004188eb | void core_charactr.cpp_CCharacter_ApplyGestureLookAt_FUN_0042dfc0(CCharacter * this_ptr)
        ;   XREF to: 0042dfc0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004188f0
    LEA EAX,[EBX + 0xcc6c]              ; 004188f3
    PUSH EAX                            ; 004188f9
    MOV ECX,dword ptr [0x006793d0]      ; 004188fa | CEventList g_CEventListInstance | CEventList * g_CEventListPtr
    PUSH ECX                            ; 00418900 | CEventList g_CEventListInstance
    CALL core_event.cpp_CEventList_evaluateCondition_FUN_004adca0 ; 00418901 | int core_event.cpp_CEventList_evaluateCondition_FUN_004adca0(CEventList * this_ptr, char * condition_expression)
        ;   XREF to: 004adca0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00418906
    TEST EAX,EAX                        ; 00418909
    JZ 0x00418921                       ; 0041890b | LAB_00418921
    ...
    CMP dword ptr [EBX + 0xc038],0x0    ; 00418921
        ;   Label: LAB_00418921
    JZ 0x00418944                       ; 00418928 | LAB_00418944
        ;   XREF to: 00418944 (CONDITIONAL_JUMP)
    FLD float ptr [EBX + 0xc03c]        ; 0041892a
    FADD float ptr [EBP + 0x14]         ; 00418930
    FST float ptr [EBX + 0xc03c]        ; 00418933
    FCOMP float ptr [0x0065ac10]        ; 00418939 | undefined4 DAT_0065ac10
    FNSTSW AX                           ; 0041893f
    SAHF                                ; 00418941
    JA 0x0041899d                       ; 00418942 | LAB_0041899d
    ...
    PUSH EAX                            ; 0041894c
    PUSH ESI                            ; 0041894d
    CALL core_motion.cpp_CMotionController_advance_FUN_0052d610 ; 0041894e | int core_motion.cpp_CMotionController_advance_FUN_0052d610(CMotionController * this_ptr)
        ;   XREF to: 0052d610 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00418953
    PUSH EAX                            ; 00418956
    PUSH EBX                            ; 00418957
    CALL core_charactr.cpp_CCharacter_FUN_0042ec40 ; 00418958 | void core_charactr.cpp_CCharacter_FUN_0042ec40(CCharacter * this_ptr)
        ;   XREF to: 0042ec40 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0041895d
    JMP 0x0041874c                      ; 00418960 | LAB_0041874c
        ;   XREF to: 0041874c (UNCONDITIONAL_JUMP)
    PUSH 0x1                            ; 00418965
        ;   Label: LAB_00418965
    PUSH 0x0                            ; 00418967
    PUSH ESI                            ; 00418969
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 0041896a | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0041896f
    PUSH EBX                            ; 00418972
    PUSH 0x615ada                       ; 00418973 | = "%s confused while walking to scriptDe..." | s_s_confused_while_walking_00615ada = %s confused while walking to scriptDest!

    MOV EDX,dword ptr [0x0066e8e0]      ; 00418978 | CConsole g_ConsolePtr | CConsole * g_CConsolePtr
    PUSH EDX                            ; 0041897e | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 0041897f | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
        ;   XREF to: 00441890 (UNCONDITIONAL_CALL)
    JMP 0x004187c0                      ; 00418984 | LAB_004187c0
        ;   XREF to: 004187c0 (UNCONDITIONAL_JUMP)
    JBE 0x004187b0                      ; 00418989 | LAB_004187b0
        ;   Label: LAB_00418989
        ;   XREF to: 004187b0 (CONDITIONAL_JUMP)
    CMP EAX,0x3                         ; 0041898f
    JZ 0x00418965                       ; 00418992 | LAB_00418965
        ;   XREF to: 00418965 (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 00418994
        ;   Label: LAB_00418994
    PUSH 0x0                            ; 00418996
    JMP 0x004187b4                      ; 00418998 | LAB_004187b4
        ;   XREF to: 004187b4 (UNCONDITIONAL_JUMP)
    MOV EAX,[0x0065ac10]                ; 0041899d | undefined4 DAT_0065ac10
        ;   Label: LAB_0041899d
