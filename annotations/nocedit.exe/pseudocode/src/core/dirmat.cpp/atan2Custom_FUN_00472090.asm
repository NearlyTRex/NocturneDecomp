...
section .text
    ...
    FCOMP double ptr [0x0061edeb]       ; 0047209c | double g_Atan2SinCosThreshold
    FNSTSW AX                           ; 004720a2
    SAHF                                ; 004720a4
    JNC 0x00472107                      ; 004720a5 | LAB_00472107
        ;   XREF to: 00472107 (CONDITIONAL_JUMP)
    FLD double ptr [EBP + 0x8]          ; 004720a7
    FCOMP double ptr [0x0061edf3]       ; 004720aa | double g_Atan2SinCosThresholdNeg
    FNSTSW AX                           ; 004720b0
    SAHF                                ; 004720b2
    JBE 0x00472107                      ; 004720b3 | LAB_00472107
        ;   XREF to: 00472107 (CONDITIONAL_JUMP)
    FLD double ptr [EBP + 0x8]          ; 004720b5
    CALL crt_math.c_asin_FUN_00600b94   ; 004720b8 | float10 crt_math.c_asin_FUN_00600b94(float10 sine_value)
    ...
    FNSTSW AX                           ; 004720c7
    SAHF                                ; 004720c9
    JBE 0x004720d8                      ; 004720ca | LAB_004720d8
        ;   XREF to: 004720d8 (CONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 004720cc
    FSUBR double ptr [0x0061ee03]       ; 004720cf | double g_Atan2Pi
    FSTP float ptr [ESP]                ; 004720d5
    FLD float ptr [ESP]                 ; 004720d8
        ;   Label: LAB_004720d8
    FCOMP double ptr [0x0061ee0b]       ; 004720db | double g_Atan2NegativePi
    FNSTSW AX                           ; 004720e1
    SAHF                                ; 004720e3
    JNC 0x004720f2                      ; 004720e4 | LAB_004720f2
        ;   XREF to: 004720f2 (CONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 004720e6
    FADD float ptr [0x0061ee13]         ; 004720e9 | float g_Atan2TwoPi
    FSTP float ptr [ESP]                ; 004720ef
    FLD float ptr [ESP]                 ; 004720f2
        ;   Label: LAB_004720f2
    FCOMP double ptr [0x0061ee03]       ; 004720f5 | double g_Atan2Pi
    FNSTSW AX                           ; 004720fb
    SAHF                                ; 004720fd
    JA 0x0047214b                       ; 004720fe | LAB_0047214b
    ...
    FLD double ptr [EBP + 0x10]         ; 00472107
        ;   Label: LAB_00472107
    FCOMP double ptr [0x0061edfb]       ; 0047210a | double g_Atan2NegativeOne
    FNSTSW AX                           ; 00472110
    SAHF                                ; 00472112
    JA 0x0047212d                       ; 00472113 | LAB_0047212d
    ...
    FNSTSW AX                           ; 00472121
    SAHF                                ; 00472123
    JBE 0x004720d8                      ; 00472124 | LAB_004720d8
        ;   XREF to: 004720d8 (CONDITIONAL_JUMP)
    XOR byte ptr [ESP + 0x3],0x80       ; 00472126
    JMP 0x004720d8                      ; 0047212b | LAB_004720d8
    ...
    FNSTSW AX                           ; 00472132
    SAHF                                ; 00472134
    JA 0x0047213e                       ; 00472135 | LAB_0047213e
        ;   XREF to: 0047213e (CONDITIONAL_JUMP)
    XOR EDX,EDX                         ; 00472137
    MOV dword ptr [ESP],EDX             ; 00472139
    JMP 0x0047211c                      ; 0047213c | LAB_0047211c
        ;   XREF to: 0047211c (UNCONDITIONAL_JUMP)
    FLD double ptr [EBP + 0x10]         ; 0047213e
        ;   Label: LAB_0047213e
    CALL crt_math.c_acos_FUN_00600162   ; 00472141 | double crt_math.c_acos_FUN_00600162(double x)
        ;   XREF to: 00600162 (UNCONDITIONAL_CALL)
    FSTP float ptr [ESP]                ; 00472146
    JMP 0x0047211c                      ; 00472149 | LAB_0047211c
        ;   XREF to: 0047211c (UNCONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 0047214b
        ;   Label: LAB_0047214b
    FADD float ptr [0x0061ee17]         ; 0047214e | float g_Atan2NegativeTwoPi
