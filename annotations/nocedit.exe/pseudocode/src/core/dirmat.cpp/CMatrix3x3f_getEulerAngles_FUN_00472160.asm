...
;                               FUNCTION
; *****************************************************************************
; __cdecl CVector3f * core_dirmat.cpp_CMatrix3x3f_getEulerAngles_FUN_00472160(CMatrix3x3f * this_ptr, CVector3f * euler_angles)
;
; Parameters:
...
;   core_bugs.cpp_FUN_004268e0 at 00426f84
...
;   core_msnedit.cpp_PrepareMissionMaybe_FUN_005390f0 at 00539457
