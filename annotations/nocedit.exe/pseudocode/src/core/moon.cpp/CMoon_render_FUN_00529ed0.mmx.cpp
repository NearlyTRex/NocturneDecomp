...
__asm {
        ...
        call sound_sndmain.cpp_processAudio_FUN_005abe20
        call wincore_windll.cpp_clearScreen_FUN_005b3e70
        call wincore_windll.cpp_clearZBuffer_FUN_005b3ed4
        push 0x3f87558
        mov EDX,dword ptr [g_CDemonRendererPtr2]
        push EDX
        call engine_drender.cpp_CDemonRenderer_setCameraOriginFromScaledPoint_FUN_0048c150
        add ESP,0x8
        mov ECX,dword ptr [g_CDemonRendererPtr2]
        push 0x42e00000
        push ECX
        call engine_drender.cpp_CDemonRenderer_setProjectionScale_FUN_0048c650
        add ESP,0x8
        push 0x3f87558
        mov EBX,dword ptr [g_CDemonRendererPtr2]
        push EBX
        call engine_drender.cpp_CDemonRenderer_setupSceneRendering_FUN_0048c1d0
        ...
        call engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450
        ...
        call core_set.cpp_CDemonSet_FUN_00570ca0
        add ESP,0x10
        push 0x205
        push 0x0
        push 0x0
        lea EAX,[ESI + 0x8]
        push EAX
        call core_dmodel.cpp_CKeyFramedModel_prepareForRender_FUN_00477850
        mov EAX,[g_CDemonSetPtr]
    ...
    LAB_0052a009:
        ...
        push EAX
        call core_course.cpp_CCourse_FUN_00442710
        ...
        mov EAX,[g_CDemonRendererPtr2]
        push EAX
        call engine_drender.cpp_CDemonRenderer_applyScaledTransform_FUN_0048c4f0
        add ESP,0xc
        fld float ptr [DAT_02f38214 + EBX]
        push -0x1
        call crt_math.c_round_FUN_005fe6b0
        push 0x0
        ...
        mov ECX,dword ptr [g_CDemonRendererPtr2]
        push ECX
        call engine_drender.cpp_CDemonRenderer_matrixPop_FUN_0050d720
    LAB_0052a11f:
        add EBX,0x18
        cmp EBX,0x2d0
        jnz LAB_0052a009
    LAB_0052a12e:
        ...
        call engine_alphabit.cpp_CAlphaBitmap_initPalette_FUN_00410cf0
    ...
    LAB_0052a250:
        push 0x1
        call engine_3d.c_setBlendMode_FUN_00406dd0
    ...
    LAB_0052a275:
        ...
        add EAX,0x2f37f84
        push EAX
        call engine_alphabit.cpp_CAlphaBitmap_display_FUN_00410950
        add ESP,0x10
        push 0x0
        call engine_3d.c_setBlendMode_FUN_00406dd0
        add ESP,0x4
