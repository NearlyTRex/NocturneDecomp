...
section .text
    ...
    FMUL double ptr [0x00639f61]        ; 00529d77 | double DOUBLE_00639f61
    FADD float ptr [EDX + 0x4]          ; 00529d7d
    FST float ptr [EDX + 0x4]           ; 00529d80
    FCOMP double ptr [0x00639f69]       ; 00529d83 | double DOUBLE_00639f69
    FNSTSW AX                           ; 00529d89
    SAHF                                ; 00529d8b
    JA 0x00529e9c                       ; 00529d8c | LAB_00529e9c
        ;   XREF to: 00529e9c (CONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 00529d92
        ;   Label: LAB_00529d92
    FMUL double ptr [0x00639f71]        ; 00529d95 | double DOUBLE_00639f71
    FADD float ptr [0x02f381e4]         ; 00529d9b | float g_MoonAnimationTimer
    FST float ptr [0x02f381e4]          ; 00529da1 | float g_MoonAnimationTimer
    FCOMP double ptr [0x00639f79]       ; 00529da7 | double DOUBLE_00639f79
    FNSTSW AX                           ; 00529dad
    SAHF                                ; 00529daf
    JC 0x00529dc4                       ; 00529db0 | LAB_00529dc4
        ;   XREF to: 00529dc4 (CONDITIONAL_JUMP)
    FLD float ptr [0x02f381e4]          ; 00529db2 | float g_MoonAnimationTimer
    FADD float ptr [0x00639f81]         ; 00529db8 | float FLOAT_00639f81
    FSTP float ptr [0x02f381e4]         ; 00529dbe | float g_MoonAnimationTimer
    MOV EAX,[0x02cf6a80]                ; 00529dc4 | int g_GlobalDeltaTimeInt
        ;   Label: LAB_00529dc4
    MOV ECX,dword ptr [0x02f381dc]      ; 00529dc9 | int g_MoonCloudScrollX
    SHL EAX,0x5                         ; 00529dcf
    ADD ECX,EAX                         ; 00529dd2
    MOV EAX,[0x02cf6a80]                ; 00529dd4 | int g_GlobalDeltaTimeInt
    MOV EBX,dword ptr [0x02f381e0]      ; 00529dd9 | int g_MoonCloudScrollY
    SHL EAX,0x4                         ; 00529ddf
    MOV ESI,dword ptr [0x0067d7d0]      ; 00529de2 | int g_MoonBatsEnabled
    ADD EBX,EAX                         ; 00529de8
    MOV dword ptr [0x02f381dc],ECX      ; 00529dea | int g_MoonCloudScrollX
    MOV dword ptr [0x02f381e0],EBX      ; 00529df0 | int g_MoonCloudScrollY
    TEST ESI,ESI                        ; 00529df6
    JZ 0x00529e96                       ; 00529df8 | LAB_00529e96
        ;   XREF to: 00529e96 (CONDITIONAL_JUMP)
    XOR EDX,EDX                         ; 00529dfe
    MOV EAX,dword ptr [EDX + 0x2f3820c] ; 00529e00 | SBat[30] g_MoonBats
        ;   Label: LAB_00529e00
    IMUL EAX,EAX,0xc                    ; 00529e06
    FLD float ptr [ESP]                 ; 00529e09
    FMUL double ptr [0x00639f89]        ; 00529e0c | double DOUBLE_00639f89
    FADD float ptr [EDX + 0x2f38210]    ; 00529e12 | DAT_02f38210
    ADD EAX,0x2f381e8                   ; 00529e18 | CCourse[3] g_MoonBatCourses
    FSTP float ptr [EDX + 0x2f38210]    ; 00529e1d | DAT_02f38210
    MOV EAX,dword ptr [EAX]             ; 00529e23 | CCourse[3] g_MoonBatCourses
    MOV dword ptr [ESP + 0x14],EAX      ; 00529e25
    FLD float ptr [EDX + 0x2f38210]     ; 00529e29 | DAT_02f38210
    FILD dword ptr [ESP + 0x14]         ; 00529e2f
    FSTP float ptr [ESP + 0x10]         ; 00529e33
    FCOMP float ptr [ESP + 0x10]        ; 00529e37
    FNSTSW AX                           ; 00529e3b
    SAHF                                ; 00529e3d
    JNC 0x00529eb2                      ; 00529e3e | LAB_00529eb2
    ...
    FMUL double ptr [0x00639f91]        ; 00529e4c | double DOUBLE_00639f91
    FILD dword ptr [ESP + 0x14]         ; 00529e52
    FLD float ptr [EDX + 0x2f38214]     ; 00529e56 | DAT_02f38214
    FXCH ST2                            ; 00529e5c
    FADD ST0,ST2                        ; 00529e5e
    FXCH                                ; 00529e60
    FSTP float ptr [ESP + 0xc]          ; 00529e62
    FSTP ST1                            ; 00529e66
    FST float ptr [EDX + 0x2f38214]     ; 00529e68 | DAT_02f38214
    FCOMP float ptr [ESP + 0xc]         ; 00529e6e
    FNSTSW AX                           ; 00529e72
    SAHF                                ; 00529e74
    JC 0x00529e87                       ; 00529e75 | LAB_00529e87
    ...
    JNZ 0x00529e00                      ; 00529e90 | LAB_00529e00
    ...
    MOV dword ptr [EDX + 0x4],0x3f147ae1 ; 00529e9c
        ;   Label: LAB_00529e9c
    MOV dword ptr [0x0067d7d0],0x1      ; 00529ea3 | int g_MoonBatsEnabled
    JMP 0x00529d92                      ; 00529ead | LAB_00529d92
    ...
    JMP 0x00529e40                      ; 00529ec2 | LAB_00529e40
