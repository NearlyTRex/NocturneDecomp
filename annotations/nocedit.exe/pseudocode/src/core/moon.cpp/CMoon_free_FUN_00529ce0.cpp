...

{
  ...
  if (this_ptr->is_loaded != 0) {
    ...
    } while (this_ptr_01 != g_MoonAnimTextures + sizeof(g_MoonAnimTextures) / sizeof(g_MoonAnimTextures[0]));
  ...
  } while (this_ptr_00 != g_MoonBatCourses + sizeof(g_MoonBatCourses) / sizeof(g_MoonBatCourses[0]));
