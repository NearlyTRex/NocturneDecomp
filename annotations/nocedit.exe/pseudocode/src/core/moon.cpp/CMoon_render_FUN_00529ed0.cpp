...
// Cross-references:
//   core_menu.cpp_configureCustomKeys_FUN_00511890 (00511890) at 005118ff [UNCONDITIONAL_CALL]
//   core_menu.cpp_configureGraphicsOptions_FUN_00510c80 (00510c80) at 00510d65 [UNCONDITIONAL_CALL]
//   core_menu.cpp_configureSoundOptions_FUN_00511e50 (00511e50) at 00511ec4 [UNCONDITIONAL_CALL]
...
//   undefined4 g_MoonBats[1].random_offset.x
//   undefined4 g_MoonBats[1].random_offset.y
//   undefined4 g_MoonBats[1].random_offset.z
...

{
  ...
  local_5c = (this_ptr->rotation_phase + (float)DOUBLE_00639f99) * (float)DOUBLE_00639fa1;
      ...
      if (0.0 <= *(float *)((int)&g_MoonBats[0].course_position + iVar7)) {
        ...
        dVar11 = crt_math_c_round_FUN_005fe6b0
                           ((double)CONCAT44(g_CDemonSetPtr,
                                             CONCAT22((short)((uint)g_MoonBatCourses
