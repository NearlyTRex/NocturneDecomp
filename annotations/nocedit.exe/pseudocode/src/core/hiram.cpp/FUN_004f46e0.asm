...
section .text
    ...
    PUSH ECX                            ; 004f46e9
    CALL core_actor.cpp_CDemonActor_writeDependencies_FUN_0040cfd0 ; 004f46ea | void core_actor.cpp_CDemonActor_writeDependencies_FUN_0040cfd0(CDemonActor * this_ptr, FILE * file_handle)
