...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_hiram_cpp_CHiram_writeDependencies_FUN_004f46e0(CHiram *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x8]       ; 004f46e0
        ;   Label: core_hiram.cpp_CHiram_writeDependencies_FUN_004f46e0
    PUSH EDX                            ; 004f46e4
