...
;                               FUNCTION
; *****************************************************************************
; __cdecl CHiram * __cdecl core_hiram_cpp_CHiram_ctor_FUN_004f43f0(CHiram *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004f43f0
        ;   Label: core_hiram.cpp_CHiram_ctor_FUN_004f43f0
    PUSH ESI                            ; 004f43f1
    PUSH EDI                            ; 004f43f2
    MOV EDX,dword ptr [ESP + 0x10]      ; 004f43f3
    PUSH EDX                            ; 004f43f7
    CALL core_npc.cpp_CNPC_ctor_FUN_005447e0 ; 004f43f8
    ...
    PUSH EDI                            ; 004f440d
    MOV dword ptr [EAX + 0x154],0x65f974 ; 004f440e | g_CHiramVTable
