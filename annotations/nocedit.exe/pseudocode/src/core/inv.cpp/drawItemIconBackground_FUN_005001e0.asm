...
;   undefined4 g_LightBufferPool[9][273912]
...
section .text
    ...
    MOV EDX,dword ptr [EAX]             ; 00500224 | g_CDemonRendererInstance
    SHL EBX,0x10                        ; 00500226
    MOV dword ptr [EDX + 0x14],EBX      ; 00500229
    MOV EDX,dword ptr [EAX]             ; 0050022c | g_CDemonRendererInstance
    MOV dword ptr [EDX + 0x8],0x1000    ; 0050022e
    MOV EDX,dword ptr [EAX]             ; 00500235 | g_CDemonRendererInstance
    MOV dword ptr [EDX + 0x18],0x0      ; 00500237
    MOV EDX,dword ptr [EAX]             ; 0050023e | g_CDemonRendererInstance
    MOV dword ptr [EDX + 0x1c],0x0      ; 00500240
    MOV EDX,dword ptr [ESP + 0x54]      ; 00500247
    MOV ESI,dword ptr [EAX]             ; 0050024b | g_CDemonRendererInstance
    SHL EDX,0x10                        ; 0050024d
    MOV dword ptr [ESI + 0x40],EDX      ; 00500250
    MOV ESI,dword ptr [EAX]             ; 00500253 | g_CDemonRendererInstance
    MOV dword ptr [ESI + 0x44],EBX      ; 00500255
    MOV EBX,dword ptr [EAX]             ; 00500258 | g_CDemonRendererInstance
    MOV dword ptr [EBX + 0x38],0x1000   ; 0050025a
    MOV EBX,dword ptr [EAX]             ; 00500261 | g_CDemonRendererInstance
    MOV dword ptr [EBX + 0x48],0xf00000 ; 00500263 | g_LightBufferPool[9][273912]
    MOV EBX,dword ptr [EAX]             ; 0050026a | g_CDemonRendererInstance
    MOV dword ptr [EBX + 0x4c],0x0      ; 0050026c
    MOV EBX,dword ptr [EAX]             ; 00500273 | g_CDemonRendererInstance
    MOV dword ptr [EBX + 0x70],EDX      ; 00500275
    MOV EDX,dword ptr [ESP + 0x58]      ; 00500278
    MOV EBX,dword ptr [EAX]             ; 0050027c | g_CDemonRendererInstance
    SHL EDX,0x10                        ; 0050027e
    MOV dword ptr [EBX + 0x74],EDX      ; 00500281
    MOV EBX,dword ptr [EAX]             ; 00500284 | g_CDemonRendererInstance
    MOV dword ptr [EBX + 0x68],0x1000   ; 00500286
    MOV EBX,dword ptr [EAX]             ; 0050028d | g_CDemonRendererInstance
    MOV dword ptr [EBX + 0x78],0xf00000 ; 0050028f | g_LightBufferPool[9][273912]
    MOV EBX,dword ptr [EAX]             ; 00500296 | g_CDemonRendererInstance
    MOV dword ptr [EBX + 0x7c],0x600000 ; 00500298
    MOV EBX,dword ptr [EAX]             ; 0050029f | g_CDemonRendererInstance
    MOV dword ptr [EBX + 0xa0],ECX      ; 005002a1
    MOV ECX,dword ptr [EAX]             ; 005002a7 | g_CDemonRendererInstance
    MOV dword ptr [ECX + 0xa4],EDX      ; 005002a9
    MOV EDX,dword ptr [EAX]             ; 005002af | g_CDemonRendererInstance
    MOV dword ptr [EDX + 0x98],0x1000   ; 005002b1
    MOV EDX,dword ptr [EAX]             ; 005002bb | g_CDemonRendererInstance
    MOV ESI,0x4                         ; 005002bd
    MOV dword ptr [EDX + 0xa8],0x0      ; 005002c2
    MOV EBP,0x3                         ; 005002cc
    MOV EDX,dword ptr [EAX]             ; 005002d1 | g_CDemonRendererInstance
    PUSH 0xa3                           ; 005002d3
    ...
    PUSH EAX                            ; 0050030f | g_CDemonRendererInstance
    MOV dword ptr [ESP + 0x28],ESI      ; 00500310
    MOV dword ptr [ESP + 0x2c],EDI      ; 00500314
    CALL engine_drender.cpp_CDemonRenderer_renderTexturedDirect_FUN_0048ae10 ; 00500318
    ...
    PUSH EBX                            ; 0050034b
    PUSH 0x32758e4                      ; 0050034c | g_CDemonCameraInstance
    MOV dword ptr [ESP + 0x48],EAX      ; 00500351
    CALL core_dcamera.cpp_CDemonCamera_pushRect_FUN_0044c740 ; 00500355
