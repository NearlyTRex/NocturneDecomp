...
;   undefined4 g_ItemDefinitionArray[0].string2[0]
...
section .text
    ...
    PUSH EBX                            ; 004fcf26 | g_ItemDefinitionArray | g_ItemDefinitionArray[1].string1[0]
        ;   Label: LAB_004fcf26
    PUSH EDI                            ; 004fcf27
    ...
    POP EBX                             ; 004fcf5f
    RET                                 ; 004fcf60
    LEA EAX,[EBX + 0x100]               ; 004fcf61 | g_ItemDefinitionArray[0].string2[0]
        ;   Label: LAB_004fcf61
    POP EBP                             ; 004fcf67
    POP EDI                             ; 004fcf68
    POP ESI                             ; 004fcf69
