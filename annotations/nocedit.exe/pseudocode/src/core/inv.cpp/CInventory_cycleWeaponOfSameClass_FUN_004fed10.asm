...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_inv.cpp_CInventory_cycleWeaponOfSameClass_FUN_004fed10(CInventory * this_ptr, int direction)
;
; Parameters:
...
;
; XREF[1]:
;   core_game.cpp_KeypressesAndCGame_FUN_004dc3e0 at 004dc793
;
; Referenced Globals:
...
section .text
    ...
    PUSH 0x1                            ; 004fed1b
    PUSH ESI                            ; 004fed1d
    CALL core_inv.cpp_CInventory_resetWeaponSwitchTimers_FUN_004fffa0 ; 004fed1e | void core_inv.cpp_CInventory_resetWeaponSwitchTimers_FUN_004fffa0(CInventory * this_ptr, int reset_both)
        ;   XREF to: 004fffa0 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [ESI + 0x330]     ; 004fed23
    ADD ESP,0x8                         ; 004fed29
    TEST EDX,EDX                        ; 004fed2c
    JZ 0x004fed79                       ; 004fed2e | LAB_004fed79
        ;   XREF to: 004fed79 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [ESI + 0x8]       ; 004fed30
    XOR EBX,EBX                         ; 004fed33
    TEST ECX,ECX                        ; 004fed35
    JLE 0x004fed46                      ; 004fed37 | LAB_004fed46
    ...
    JNZ 0x004fed81                      ; 004fed44 | LAB_004fed81
    ...
    JL 0x004fed8e                       ; 004fed53 | LAB_004fed8e
    ...
    PUSH EDX                            ; 004fed61
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 004fed62 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004fed67
    MOV EDI,EAX                         ; 004fed6a
    MOV dword ptr [ESP],EAX             ; 004fed6c
    TEST EAX,EAX                        ; 004fed6f
    JNZ 0x004fed97                      ; 004fed71 | LAB_004fed97
        ;   XREF to: 004fed97 (CONDITIONAL_JUMP)
    INC EBP                             ; 004fed73
        ;   Label: LAB_004fed73
    CMP EBP,0x64                        ; 004fed74
    JL 0x004fed48                       ; 004fed77 | LAB_004fed48
    ...
    JL 0x004fed3b                       ; 004fed8a | LAB_004fed3b
        ;   XREF to: 004fed3b (CONDITIONAL_JUMP)
    JMP 0x004fed46                      ; 004fed8c | LAB_004fed46
        ;   XREF to: 004fed46 (UNCONDITIONAL_JUMP)
    TEST EBX,EBX                        ; 004fed8e
        ;   Label: LAB_004fed8e
    JGE 0x004fed57                      ; 004fed90 | LAB_004fed57
        ;   XREF to: 004fed57 (CONDITIONAL_JUMP)
    LEA EBX,[EDI + -0x1]                ; 004fed92
    JMP 0x004fed57                      ; 004fed95 | LAB_004fed57
        ;   XREF to: 004fed57 (UNCONDITIONAL_JUMP)
    MOV ECX,dword ptr [ESI + 0x330]     ; 004fed97
        ;   Label: LAB_004fed97
    PUSH ECX                            ; 004fed9d
    CALL core_actor.cpp_CDemonActor_getActorClassName_FUN_00408b90 ; 004fed9e | char * core_actor.cpp_CDemonActor_getActorClassName_FUN_00408b90(CDemonActor * this_ptr)
        ;   XREF to: 00408b90 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004feda3
    PUSH EAX                            ; 004feda6
    PUSH EDI                            ; 004feda7
    CALL core_actor.cpp_CDemonActor_getActorClassName_FUN_00408b90 ; 004feda8 | char * core_actor.cpp_CDemonActor_getActorClassName_FUN_00408b90(CDemonActor * this_ptr)
        ;   XREF to: 00408b90 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004fedad
    PUSH EAX                            ; 004fedb0
    CALL crt_string.c_strcmp_FUN_005fef20 ; 004fedb1 | int crt_string.c_strcmp_FUN_005fef20(char * str1, char * str2)
        ;   XREF to: 005fef20 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004fedb6
    TEST EAX,EAX                        ; 004fedb9
    JNZ 0x004fed73                      ; 004fedbb | LAB_004fed73
        ;   XREF to: 004fed73 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [ESI + 0x330]     ; 004fedbd
    CMP EDI,EBX                         ; 004fedc3
    JZ 0x004fed79                       ; 004fedc5 | LAB_004fed79
        ;   XREF to: 004fed79 (CONDITIONAL_JUMP)
    TEST EBX,EBX                        ; 004fedc7
    JZ 0x004feddf                       ; 004fedc9 | LAB_004feddf
    ...
    CALL core_inv.cpp_CInventory_updateSelectedWeaponAmmoDisplay_FUN_004ffe10 ; 004fedef | void core_inv.cpp_CInventory_updateSelectedWeaponAmmoDisplay_FUN_004ffe10(CInventory * this_ptr)
