...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_inv_cpp_CInventory_setupItems_FUN_004ff780(CInventory *this_ptr)
;
; Parameters:
...
section .text
    ...
    JNZ 0x004ff7d5                      ; 004ff78f
        ;   XREF to: 004ff7d5 (CONDITIONAL_JUMP)  ; LAB_004ff7d5
    MOV EBP,dword ptr [EDI + 0x8]       ; 004ff791
        ;   Label: LAB_004ff791
    XOR ESI,ESI                         ; 004ff794
    TEST EBP,EBP                        ; 004ff796
    JLE 0x004ff7d0                      ; 004ff798
        ;   XREF to: 004ff7d0 (CONDITIONAL_JUMP)  ; LAB_004ff7d0
    MOV EBX,EDI                         ; 004ff79a
    PUSH 0x573                          ; 004ff79c
        ;   Label: LAB_004ff79c
    PUSH 0x6309f1                       ; 004ff7a1 | = "..\\core\\inv.cpp"
    MOV EAX,dword ptr [EBX + 0xc]       ; 004ff7a6
    PUSH EAX                            ; 004ff7a9
    CALL core_actor.cpp_CDemonActor_doCheckForInvalidPointers_FUN_0040ac80 ; 004ff7aa
    ...
    POP EBX                             ; 004ff7d3
    RET                                 ; 004ff7d4
    MOV ECX,0x6309a1                    ; 004ff7d5 | = "..\\core\\inv.cpp"
        ;   Label: LAB_004ff7d5
    MOV EBX,0x56e                       ; 004ff7da
    PUSH 0x6309b1                       ; 004ff7df | = "CInventory::setupItems - we should ow..."
    MOV dword ptr [0x02f0ca48],ECX      ; 004ff7e4 | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 004ff7ea | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004ff7f0
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ADD ESP,0x4                         ; 004ff7f5
    JMP 0x004ff791                      ; 004ff7f8
        ;   XREF to: 004ff791 (UNCONDITIONAL_JUMP)  ; LAB_004ff791
