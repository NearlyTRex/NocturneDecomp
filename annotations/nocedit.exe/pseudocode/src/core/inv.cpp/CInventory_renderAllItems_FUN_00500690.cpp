...

{
  ...
  if (pCVar2 == (CDemonActor *)0x0) {
    ...
    sprintf(acStack_480,"%d%%",local_1c);
    pCVar11 = local_4c;
...
LAB_00500870:
  ...
  if (iVar7 == 0) {
    ...
    pcVar6 = "%s\n\n%s";
LAB_005008cd:
    sprintf(acStack_17c,pcVar6,uVar14);
  }
...
LAB_005009c0:
  ...
  if ((0.0 < this_ptr->item_highlight_timer) || (0.0 < this_ptr->inventory_display_timer)) {
    ...
    iVar12 = local_68 / 2;
    iVar3 = 0x500e4e;
    dVar10 = round((double)((float)local_18 - (float)local_18 * fStack_684))
    ;
