...

{
  ...
  if (pCVar2 == (CDemonActor *)0x0) {
    iVar12 = core_inv_cpp_CInventory_isWeaponInCategory_FUN_004ffe70
                       (this_ptr,&this_ptr->selected_weapon->base,3);
    if (iVar12 == 0) {
      iVar3 = g_WindowWidth - iVar7;
      ...
      if (this_ptr_00 != (CAlphaBitmap *)0x0) {
        engine_alphabit_cpp_CAlphaBitmap_display_FUN_00410950(this_ptr_00,iVar3,iVar7,local_6c);
      }
      if ((this_ptr->ammo_detail_timer <= 0.0) || (this_ptr->render_mode_flag != 0)) {
        crt_stdio_c_sprintf_FUN_005fdbd0(local_67c,"%d");
      }
      else {
        pcVar6 = core_inv_cpp_getItemDisplayName_FUN_004fcf00(&this_ptr->ammo_ptr->base);
        crt_stdio_c_sprintf_FUN_005fdbd0(local_67c,"%s %d",pcVar6);
      }
      iVar12 = engine_font_cpp_CBitFont_getCharWidth_FUN_004d01d0((CBitFont *)local_48,0x58);
      pCVar11 = (CBitFont *)local_48;
      iVar7 = engine_font_cpp_CBitFont_getTextWidth_FUN_004cfe80((CBitFont *)local_48,local_67c);
      lVar13 = 0xf8;
      iVar12 = (g_WindowHeight - (int)local_4c) - iVar12;
      iVar7 = (g_WindowWidth - (int)local_4c) - iVar7;
      pcVar6 = local_67c;
      goto LAB_00500870;
    }
  }
    ...
    crt_stdio_c_sprintf_FUN_005fdbd0(acStack_480,"%d%%",local_1c);
    pCVar11 = local_4c;
    iVar7 = engine_font_cpp_CBitFont_getCharWidth_FUN_004d01d0(local_4c,0x58);
    iVar3 = engine_font_cpp_CBitFont_getTextWidth_FUN_004cfe80(pCVar11,acStack_480);
    lVar13 = (ulonglong)uVar15 << 0x20;
    iVar12 = 0xf8;
    iVar7 = (g_WindowHeight - local_50) - iVar7;
...
LAB_00500870:
  ...
  if (iVar7 == 0) {
    ...
    if ((iVar7 == 0) &&
      ...
      pcVar4 = core_inv_cpp_getItemDisplayName_FUN_004fcf00(&this_ptr->selected_weapon->base);
      uVar14 = CONCAT44(pcVar6,pcVar4);
      pcVar6 = "%s\n\n%s";
      goto LAB_005008cd;
    }
    pcVar6 = core_inv_cpp_getItemDisplayName_FUN_004fcf00(&this_ptr->ammo_ptr->base);
    pcVar4 = core_inv_cpp_getItemIconName_FUN_004fcf70(&this_ptr->selected_weapon->base);
    uVar14 = CONCAT44(pcVar6,pcVar4);
...
LAB_005008cd:
  ...
  local_2c = (CBitFont *)local_48;
  iVar7 = engine_font_cpp_CBitFont_wrapText_FUN_004d0010
                    ((CBitFont *)local_48,acStack_17c,DAT_02db8c70,10,0x100,local_54 - local_5c);
  local_34 = iVar7;
  local_38 = engine_font_cpp_CBitFont_getCharWidth_FUN_004d01d0((CBitFont *)local_48,0x58);
  iVar12 = (g_WindowHeight - local_58) + (int)local_4c;
  local_30 = (int)local_4c + (g_WindowWidth - local_54);
  iVar3 = 0;
  if (0 < iVar7) {
    pcVar6 = DAT_02db8c70;
    do {
...
LAB_005009c0:
  if ((this_ptr->selected_item != (CDemonActor *)0x0) && (0.0 < this_ptr->item_highlight_timer)) {
    ...
    iVar12 = g_InventoryHeight;
    if ((g_WindowHeight < 0x180) && (this_ptr->render_mode_flag == 0)) {
      iVar7 = g_InventoryWidth / 2;
      iVar12 = g_InventoryHeight / 2;
      local_60 = 0x28;
      local_50 = 8;
    }
    pCVar2 = core_actor_cpp_castToClassHash_FUN_0040c790
    ...
    if (pCVar2 != (CDemonActor *)0x0) {
      crt_stdio_c_sprintf_FUN_005fdbd0
                (acStack_37c,"%d x%3.0f%%",pCVar2[2].location.position.y,
    ...
    if (pCVar2 != (CDemonActor *)0x0) {
      ...
      crt_stdio_c_sprintf_FUN_005fdbd0(acStack_27c,"%s");
      iVar3 = engine_font_cpp_CBitFont_getCharWidth_FUN_004d01d0((CBitFont *)local_48,0x58);
    ...
    if (this_ptr->render_mode_flag != 0) {
      ...
      pcVar6 = core_inv_cpp_getItemDisplayName_FUN_004fcf00(this_ptr->selected_item);
      crt_stdio_c_sprintf_FUN_005fdbd0(acStack_57c,"%s\n\n%s",pcVar6);
      local_28 = (CBitFont *)local_48;
      local_44 = engine_font_cpp_CBitFont_wrapText_FUN_004d0010
                           ((CBitFont *)local_48,acStack_57c,DAT_02db9670,10,0x100,iVar7 - local_60)
      ;
      local_18 = local_44;
      local_40 = engine_font_cpp_CBitFont_getCharWidth_FUN_004d01d0((CBitFont *)local_48,0x58);
      iVar12 = (g_WindowHeight - iVar12) + local_50;
      local_3c = local_50 + (g_WindowWidth - iVar7);
      iVar7 = 0;
      if (0 < local_18) {
        pcVar6 = DAT_02db9670;
        do {
  ...
  if ((g_CGamePtr->auto_save_blocked != 0) || (g_CGamePtr->block_auto_save != 0)) {
    iStack_7c = g_WindowHeight + -0x21;
    local_18 = g_WindowHeight + -6;
    iVar5 = 0x10;
    iVar3 = 0x500d05;
    iVar12 = local_18;
    dVar10 = crt_math_c_round_FUN_005fe6b0
                       ((double)((float)local_18 +
                                (float)(iStack_7c - local_18) * this_ptr->battery_charge *
                                (float)0.01));
    iVar7 = g_WindowHeight;
    iStack_80 = (int)ROUND(dVar10);
    engine_2d_c_fillRectColor_FUN_00403170(6,iStack_80,iVar3,iVar5,iVar12);
  ...
  if ((0.0 < this_ptr->item_highlight_timer) || (0.0 < this_ptr->inventory_display_timer)) {
    ...
    local_68 = 0xffff;
    if (local_680 < 1.0) {
      dVar10 = crt_math_c_round_FUN_005fe6b0((double)(local_680 * 65535.0f));
      local_6c = (int)ROUND(dVar10);
    }
    ...
    local_78 = (g_WindowWidth + -4) - iVar7;
    iVar12 = local_68 / 2;
    iVar3 = 0x500e4e;
    dVar10 = crt_math_c_round_FUN_005fe6b0((double)((float)local_18 - (float)local_18 * fStack_684))
    ;
    local_78 = (int)ROUND(dVar10);
    engine_alphabit_cpp_CAlphaBitmap_render_FUN_00410b00
              (&g_HealthBar1Bitmap,iStack_7c,local_78 + 4,0,local_78,iVar7 + -1,iVar3);
    engine_alphabit_cpp_CAlphaBitmap_display_FUN_00410950(&g_HealthBar2Bitmap,iStack_7c,4,iVar12);
  }
  ...
  if (0.0 < dVar10) {
    ...
    local_20 = iVar7;
    local_24 = engine_font_cpp_CBitFont_getCharWidth_FUN_004d01d0(pCVar11,0x58);
    iVar7 = (g_WindowHeight + -4) - local_24 * iVar7;
    if (((g_MicroFont != local_1c) || (g_MessageCount == 0)) && (iVar12 = 0, 0 < local_20)) {
      pcVar6 = DAT_02dba070;
      do {
        iVar12 = iVar12 + 1;
