...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_inv.cpp_CInventory_updateInventory_FUN_004ffad0(CInventory * this_ptr)
;
; Parameters:
...
;
; XREF[3]:
;   core_icepick.cpp_FUN_004f80b0 at 004f82ff
...
section .text
    ...
    JZ 0x004ffb29                       ; 004ffae7 | LAB_004ffb29
    ...
    JZ 0x004ffb17                       ; 004ffaf7 | LAB_004ffb17
        ;   XREF to: 004ffb17 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [0x02dd30f0]      ; 004ffaf9 | g_CLightGunClassInfo.name_hash
    PUSH ESI                            ; 004ffaff
    PUSH EAX                            ; 004ffb00
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 004ffb01 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004ffb06
    TEST EAX,EAX                        ; 004ffb09
    JNZ 0x004ffb17                      ; 004ffb0b | LAB_004ffb17
        ;   XREF to: 004ffb17 (CONDITIONAL_JUMP)
    PUSH EAX                            ; 004ffb0d
    PUSH EBX                            ; 004ffb0e
    CALL core_inv.cpp_CInventory_resetWeaponSwitchTimers_FUN_004fffa0 ; 004ffb0f | void core_inv.cpp_CInventory_resetWeaponSwitchTimers_FUN_004fffa0(CInventory * this_ptr, int reset_both)
    ...
    PUSH ECX                            ; 004ffb59
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 004ffb5a | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004ffb5f
    TEST EAX,EAX                        ; 004ffb62
    JNZ 0x004ffd38                      ; 004ffb64 | LAB_004ffd38
    ...
    JL 0x004ffb4f                       ; 004ffb73 | LAB_004ffb4f
        ;   XREF to: 004ffb4f (CONDITIONAL_JUMP)
    MOV EAX,[0x0067b654]                ; 004ffb75 | CGame * g_CGamePtr
        ;   Label: LAB_004ffb75
    FLD float ptr [EAX + 0x264]         ; 004ffb7a | g_CGameInstance.delta_time_float
    FMUL double ptr [0x00630aaa]        ; 004ffb80 | double DOUBLE_00630aaa
    ...
    FNSTSW AX                           ; 004ffb92
    SAHF                                ; 004ffb94
    JBE 0x004ffb9d                      ; 004ffb95 | LAB_004ffb9d
    ...
    JLE 0x004ffbce                      ; 004ffba4 | LAB_004ffbce
    ...
    PUSH ECX                            ; 004ffbb2
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 004ffbb3 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004ffbb8
    TEST EAX,EAX                        ; 004ffbbb
    JNZ 0x004ffd5d                      ; 004ffbbd | LAB_004ffd5d
    ...
    JL 0x004ffba8                       ; 004ffbcc | LAB_004ffba8
        ;   XREF to: 004ffba8 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x0067b654]      ; 004ffbce | CGame * g_CGamePtr
        ;   Label: LAB_004ffbce
    ...
    FNSTSW AX                           ; 004ffbee
    SAHF                                ; 004ffbf0
    JC 0x004ffbfd                       ; 004ffbf1 | LAB_004ffbfd
        ;   XREF to: 004ffbfd (CONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0x338],0x0     ; 004ffbf3
    MOV EDX,dword ptr [0x0067b654]      ; 004ffbfd | CGame * g_CGamePtr
        ;   Label: LAB_004ffbfd
    ...
    FNSTSW AX                           ; 004ffc1d
    SAHF                                ; 004ffc1f
    JC 0x004ffc2c                       ; 004ffc20 | LAB_004ffc2c
        ;   XREF to: 004ffc2c (CONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0x33c],0x0     ; 004ffc22
    MOV EDX,dword ptr [0x0067b654]      ; 004ffc2c | CGame * g_CGamePtr
        ;   Label: LAB_004ffc2c
    ...
    FNSTSW AX                           ; 004ffc4c
    SAHF                                ; 004ffc4e
    JC 0x004ffc5b                       ; 004ffc4f | LAB_004ffc5b
        ;   XREF to: 004ffc5b (CONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0x340],0x0     ; 004ffc51
    MOV EDX,dword ptr [0x0067b654]      ; 004ffc5b | CGame * g_CGamePtr
        ;   Label: LAB_004ffc5b
    ...
    FNSTSW AX                           ; 004ffcb1
    SAHF                                ; 004ffcb3
    JA 0x004ffd8e                       ; 004ffcb4 | LAB_004ffd8e
    ...
    CMP dword ptr [EAX + 0x240],0x0     ; 004ffcc1 | g_CGameInstance.block_auto_save
        ;   Label: LAB_004ffcc1
    JNZ 0x004ffb3b                      ; 004ffcc8 | LAB_004ffb3b
        ;   XREF to: 004ffb3b (CONDITIONAL_JUMP)
    FLD float ptr [0x00660484]          ; 004ffcce | float FLOAT_00660484
    FLD1                                ; 004ffcd4
    FDIVRP                              ; 004ffcd6
    ...
    JLE 0x004ffd08                      ; 004ffce2 | LAB_004ffd08
    ...
    PUSH ECX                            ; 004ffcf0
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 004ffcf1 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004ffcf6
    TEST EAX,EAX                        ; 004ffcf9
    JNZ 0x004ffd4b                      ; 004ffcfb | LAB_004ffd4b
    ...
    JL 0x004ffce6                       ; 004ffd06 | LAB_004ffce6
        ;   XREF to: 004ffce6 (CONDITIONAL_JUMP)
    MOV EAX,[0x0067b654]                ; 004ffd08 | CGame * g_CGamePtr
        ;   Label: LAB_004ffd08
    FLD double ptr [0x00630aaa]         ; 004ffd0d | double DOUBLE_00630aaa
    ...
    FNSTSW AX                           ; 004ffd24
    SAHF                                ; 004ffd26
    JBE 0x004ffb9d                      ; 004ffd27 | LAB_004ffb9d
        ;   XREF to: 004ffb9d (CONDITIONAL_JUMP)
    MOV dword ptr [EBX],0x42c80000      ; 004ffd2d
    JMP 0x004ffb9d                      ; 004ffd33 | LAB_004ffb9d
    ...
    JMP 0x004ffb6a                      ; 004ffd46 | LAB_004ffb6a
    ...
    JMP 0x004ffcfd                      ; 004ffd5b | LAB_004ffcfd
        ;   XREF to: 004ffcfd (UNCONDITIONAL_JUMP)
    CMP dword ptr [EAX + 0x2d4],0x2     ; 004ffd5d
        ;   Label: LAB_004ffd5d
    JZ 0x004ffbc3                       ; 004ffd64 | LAB_004ffbc3
        ;   XREF to: 004ffbc3 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x0067b654]      ; 004ffd6a | CGame * g_CGamePtr
    ...
    JMP 0x004ffbc3                      ; 004ffd89 | LAB_004ffbc3
