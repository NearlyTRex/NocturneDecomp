...
;                               FUNCTION
; *****************************************************************************
; __cdecl CLightGun * core_inv.cpp_CInventory_getActiveLightGun_FUN_004ffab0(CInventory * this_ptr)
;
; Parameters:
