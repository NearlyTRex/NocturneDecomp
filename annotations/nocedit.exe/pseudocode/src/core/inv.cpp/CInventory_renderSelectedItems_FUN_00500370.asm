...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_inv.cpp_CInventory_renderSelectedItems_FUN_00500370(CInventory * this_ptr)
;
; Parameters:
...
;
; XREF[1]:
;   core_set.cpp_CDemonSet_FUN_0056c1a0 at 0056c962
;
; Referenced Globals:
...
section .text
    ...
    MOV EAX,[0x0067b654]                ; 0050037b | CGame g_CGameInstance | CGame * g_CGamePtr
    CMP dword ptr [EAX + 0x228],0x0     ; 00500380 | DAT_02d81cc4
    JNZ 0x005005e9                      ; 00500387 | LAB_005005e9
        ;   XREF to: 005005e9 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x02db87d0]      ; 0050038d | int g_LocalHeroIndex
    MOV EAX,dword ptr [EBX + 0x4]       ; 00500393
    CMP EAX,dword ptr [EDX*0x4 + 0x2db87c0] ; 00500396 | CHero *[4] g_HeroActors
    JNZ 0x005005e9                      ; 0050039d | LAB_005005e9
        ;   XREF to: 005005e9 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [0x00679398]      ; 005003a3 | int g_WindowHeight
    CMP ESI,dword ptr [0x02dcd790]      ; 005003a9 | int g_InventoryScreenHeight
    JNZ 0x005005f1                      ; 005003af | LAB_005005f1
        ;   XREF to: 005005f1 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x330],0x0     ; 005003b5
        ;   Label: LAB_005003b5
    JZ 0x005004d1                       ; 005003bc | LAB_005004d1
    ...
    FNSTSW AX                           ; 005003cc
    SAHF                                ; 005003ce
    JNC 0x005004d1                      ; 005003cf | LAB_005004d1
        ;   XREF to: 005004d1 (CONDITIONAL_JUMP)
    MOV EAX,0x8                         ; 005003d5
    MOV EDI,0x50                        ; 005003da
    MOV ESI,dword ptr [0x0067ce40]      ; 005003df | int g_InventoryWidth
    MOV EBP,dword ptr [0x00679398]      ; 005003e5 | int g_WindowHeight
    MOV ECX,dword ptr [0x0067ce44]      ; 005003eb | int g_InventoryHeight
    CMP EBP,0x180                       ; 005003f1
    JGE 0x00500406                      ; 005003f7 | LAB_00500406
        ;   XREF to: 00500406 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x44c],0x0     ; 005003f9
    JZ 0x005005fb                       ; 00500400 | LAB_005005fb
        ;   XREF to: 005005fb (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x00679394]      ; 00500406 | int g_WindowWidth
        ;   Label: LAB_00500406
    SUB EDX,EDI                         ; 0050040c
    SUB EDX,EAX                         ; 0050040e
    FLD float ptr [EBX + 0x338]         ; 00500410
    MOV dword ptr [ESP],EDX             ; 00500416
    MOV EDX,dword ptr [0x00679398]      ; 00500419 | int g_WindowHeight
    ...
    FNSTSW AX                           ; 00500434
    SAHF                                ; 00500436
    JBE 0x0050044e                      ; 00500437 | LAB_0050044e
        ;   XREF to: 0050044e (CONDITIONAL_JUMP)
    FLD float ptr [EBX + 0x338]         ; 00500439
    FMUL float ptr [0x00630b0a]         ; 0050043f | float FLOAT_00630b0a
    CALL crt_math.c_round_FUN_005fe6b0  ; 00500445 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x20]        ; 0050044a
    MOV EAX,[0x00679394]                ; 0050044e | int g_WindowWidth
        ;   Label: LAB_0050044e
    DEC EAX                             ; 00500453
    MOV dword ptr [ESP + 0x10],EAX      ; 00500454
    MOV EAX,[0x00679398]                ; 00500458 | int g_WindowHeight
    DEC EAX                             ; 0050045d
    ...
    MOV EBP,dword ptr [0x00679398]      ; 0050047a | int g_WindowHeight
    MOV EDX,dword ptr [EBX + 0x44c]     ; 00500480
    SUB EBP,ECX                         ; 00500486
    TEST EDX,EDX                        ; 00500488
    JZ 0x00500624                       ; 0050048a | LAB_00500624
    ...
    PUSH ECX                            ; 0050049a
    MOV EAX,[0x00679394]                ; 0050049b | int g_WindowWidth
    PUSH EBP                            ; 005004a0
    SUB EAX,ESI                         ; 005004a1
    PUSH EAX                            ; 005004a3
    CALL core_inv.cpp_drawItemIconBackground_FUN_005001e0 ; 005004a4 | void core_inv.cpp_drawItemIconBackground_FUN_005001e0(int x1, int y1, int x2, int y2, ...)
    ...
    PUSH EAX                            ; 005004c7
    PUSH EBX                            ; 005004c8
    CALL core_inv.cpp_CInventory_renderItemModel_FUN_004fee00 ; 005004c9 | void core_inv.cpp_CInventory_renderItemModel_FUN_004fee00(CInventory * this_ptr, CDemonActor * item, int viewport_x, int viewport_y, ...)
        ;   XREF to: 004fee00 (UNCONDITIONAL_CALL)
    ADD ESP,0x1c                        ; 005004ce
    CMP dword ptr [EBX + 0x334],0x0     ; 005004d1
        ;   Label: LAB_005004d1
    JZ 0x005005e9                       ; 005004d8 | LAB_005005e9
        ;   XREF to: 005005e9 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 005004e8
    SAHF                                ; 005004ea
    JNC 0x005005e9                      ; 005004eb | LAB_005005e9
        ;   XREF to: 005005e9 (CONDITIONAL_JUMP)
    MOV EDX,0x10                        ; 005004f1
    MOV EDI,0x40                        ; 005004f6
    MOV ESI,dword ptr [0x0067ce40]      ; 005004fb | int g_InventoryWidth
    MOV EBP,dword ptr [0x00679398]      ; 00500501 | int g_WindowHeight
    MOV ECX,dword ptr [0x0067ce44]      ; 00500507 | int g_InventoryHeight
    CMP EBP,0x180                       ; 0050050d
    JGE 0x00500522                      ; 00500513 | LAB_00500522
        ;   XREF to: 00500522 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x44c],0x0     ; 00500515
    JZ 0x00500642                       ; 0050051c | LAB_00500642
        ;   XREF to: 00500642 (CONDITIONAL_JUMP)
    MOV EAX,[0x00679394]                ; 00500522 | int g_WindowWidth
        ;   Label: LAB_00500522
    SUB EAX,EDI                         ; 00500527
    SUB EAX,EDX                         ; 00500529
    MOV dword ptr [ESP + 0x8],EAX       ; 0050052b
    MOV EAX,[0x00679398]                ; 0050052f | int g_WindowHeight
    ...
    FNSTSW AX                           ; 0050054f
    SAHF                                ; 00500551
    JBE 0x00500569                      ; 00500552 | LAB_00500569
        ;   XREF to: 00500569 (CONDITIONAL_JUMP)
    FLD float ptr [EBX + 0x33c]         ; 00500554
    FMUL float ptr [0x00630b0a]         ; 0050055a | float FLOAT_00630b0a
    CALL crt_math.c_round_FUN_005fe6b0  ; 00500560 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x24]        ; 00500565
    MOV EAX,[0x00679394]                ; 00500569 | int g_WindowWidth
        ;   Label: LAB_00500569
    DEC EAX                             ; 0050056e
    MOV dword ptr [ESP + 0x18],EAX      ; 0050056f
    MOV EAX,[0x00679398]                ; 00500573 | int g_WindowHeight
    DEC EAX                             ; 00500578
    ...
    MOV EBP,dword ptr [0x00679398]      ; 00500595 | int g_WindowHeight
    MOV EDX,dword ptr [EBX + 0x44c]     ; 0050059b
    SUB EBP,ECX                         ; 005005a1
    TEST EDX,EDX                        ; 005005a3
    JZ 0x0050066b                       ; 005005a5 | LAB_0050066b
    ...
    PUSH ECX                            ; 005005b5
    MOV EAX,[0x00679394]                ; 005005b6 | int g_WindowWidth
    PUSH EBP                            ; 005005bb
    SUB EAX,ESI                         ; 005005bc
    PUSH EAX                            ; 005005be
    CALL core_inv.cpp_drawItemIconBackground_FUN_005001e0 ; 005005bf | void core_inv.cpp_drawItemIconBackground_FUN_005001e0(int x1, int y1, int x2, int y2, ...)
        ;   XREF to: 005001e0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 005005df
    PUSH EBX                            ; 005005e0
    CALL core_inv.cpp_CInventory_renderItemModel_FUN_004fee00 ; 005005e1 | void core_inv.cpp_CInventory_renderItemModel_FUN_004fee00(CInventory * this_ptr, CDemonActor * item, int viewport_x, int viewport_y, ...)
        ;   XREF to: 004fee00 (UNCONDITIONAL_CALL)
    ...
    POP EBX                             ; 005005ef
    RET                                 ; 005005f0
    CALL core_inv.cpp_loadInventory_FUN_004fd220 ; 005005f1 | void core_inv.cpp_loadInventory_FUN_004fd220()
        ;   Label: LAB_005005f1
        ;   XREF to: 004fd220 (UNCONDITIONAL_CALL)
    JMP 0x005003b5                      ; 005005f6 | LAB_005003b5
    ...
    JMP 0x00500406                      ; 0050061f | LAB_00500406
    ...
    PUSH EAX                            ; 0050062e
    MOV EAX,[0x00679394]                ; 0050062f | int g_WindowWidth
    PUSH EBP                            ; 00500634
    SUB EAX,ECX                         ; 00500635
    PUSH EAX                            ; 00500637
    CALL core_inv.cpp_drawWeaponIconBackground_FUN_00500050 ; 00500638 | void core_inv.cpp_drawWeaponIconBackground_FUN_00500050(int x1, int y1, int x2, int y2, ...)
        ;   XREF to: 00500050 (UNCONDITIONAL_CALL)
    JMP 0x005004a9                      ; 0050063d | LAB_005004a9
    ...
    JMP 0x00500522                      ; 00500666 | LAB_00500522
    ...
    PUSH EAX                            ; 00500675
    MOV EAX,[0x00679394]                ; 00500676 | int g_WindowWidth
    PUSH EBP                            ; 0050067b
    SUB EAX,ECX                         ; 0050067c
    PUSH EAX                            ; 0050067e
    CALL core_inv.cpp_drawWeaponIconBackground_FUN_00500050 ; 0050067f | void core_inv.cpp_drawWeaponIconBackground_FUN_00500050(int x1, int y1, int x2, int y2, ...)
        ;   XREF to: 00500050 (UNCONDITIONAL_CALL)
    JMP 0x005005c4                      ; 00500684 | LAB_005005c4
