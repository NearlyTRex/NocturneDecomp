...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_inv.cpp_CInventory_selectItem_FUN_004fec10(CInventory * this_ptr, int direction)
;
; Parameters:
...
;
; XREF[1]:
;   core_game.cpp_KeypressesAndCGame_FUN_004dc3e0 at 004dc729
;
; Referenced Globals:
...
section .text
    ...
    PUSH ESI                            ; 004fec18
    CALL core_inv.cpp_CInventory_resetItemSwitchTimers_FUN_004ffff0 ; 004fec19 | void core_inv.cpp_CInventory_resetItemSwitchTimers_FUN_004ffff0(CInventory * this_ptr)
        ;   XREF to: 004ffff0 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [ESI + 0x334]     ; 004fec1e
    ADD ESP,0x4                         ; 004fec24
    TEST EDX,EDX                        ; 004fec27
    JNZ 0x004fec7e                      ; 004fec29 | LAB_004fec7e
        ;   XREF to: 004fec7e (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [ESI + 0x8]       ; 004fec2b
    XOR EDI,EDI                         ; 004fec2e
    TEST EBX,EBX                        ; 004fec30
    JLE 0x004fec56                      ; 004fec32 | LAB_004fec56
        ;   XREF to: 004fec56 (CONDITIONAL_JUMP)
    MOV EBX,ESI                         ; 004fec34
    PUSH 0x630822                       ; 004fec36 | = "CWeapon" | s_CWeapon_00630822 = CWeapon
        ;   Label: LAB_004fec36
    MOV EBP,dword ptr [EBX + 0xc]       ; 004fec3b
    PUSH EBP                            ; 004fec3e
    CALL core_actor.cpp_isOfClass_FUN_0040c6d0 ; 004fec3f | int core_actor.cpp_isOfClass_FUN_0040c6d0(CDemonActor * actor_ptr, char * class_name)
        ;   XREF to: 0040c6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004fec44
    TEST EAX,EAX                        ; 004fec47
    JZ 0x004fec5b                       ; 004fec49 | LAB_004fec5b
    ...
    JL 0x004fec36                       ; 004fec54 | LAB_004fec36
    ...
    POP EBX                             ; 004fec59
    RET                                 ; 004fec5a
    PUSH 0x63082a                       ; 004fec5b | = "CAmmo" | s_CAmmo_0063082a = CAmmo
        ;   Label: LAB_004fec5b
    MOV EAX,dword ptr [EBX + 0xc]       ; 004fec60
    PUSH EAX                            ; 004fec63
    CALL core_actor.cpp_isOfClass_FUN_0040c6d0 ; 004fec64 | int core_actor.cpp_isOfClass_FUN_0040c6d0(CDemonActor * actor_ptr, char * class_name)
        ;   XREF to: 0040c6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004fec69
    TEST EAX,EAX                        ; 004fec6c
    JNZ 0x004fec4b                      ; 004fec6e | LAB_004fec4b
    ...
    JLE 0x004fec94                      ; 004fec85 | LAB_004fec94
    ...
    JNZ 0x004feccc                      ; 004fec92 | LAB_004feccc
    ...
    JL 0x004fecd9                       ; 004feca1 | LAB_004fecd9
        ;   XREF to: 004fecd9 (CONDITIONAL_JUMP)
    XOR EBX,EBX                         ; 004feca3
    LEA EBP,[EBX*0x4 + 0x0]             ; 004feca5
        ;   Label: LAB_004feca5
    ADD EBP,ESI                         ; 004fecac
    PUSH 0x630830                       ; 004fecae | = "CWeapon" | s_CWeapon_00630830 = CWeapon
    MOV EAX,dword ptr [EBP + 0xc]       ; 004fecb3
    PUSH EAX                            ; 004fecb6
    CALL core_actor.cpp_isOfClass_FUN_0040c6d0 ; 004fecb7 | int core_actor.cpp_isOfClass_FUN_0040c6d0(CDemonActor * actor_ptr, char * class_name)
        ;   XREF to: 0040c6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004fecbc
    TEST EAX,EAX                        ; 004fecbf
    JZ 0x004fece2                       ; 004fecc1 | LAB_004fece2
        ;   XREF to: 004fece2 (CONDITIONAL_JUMP)
    CMP EBX,EDI                         ; 004fecc3
        ;   Label: LAB_004fecc3
    JNZ 0x004fec96                      ; 004fecc5 | LAB_004fec96
    ...
    JL 0x004fec89                       ; 004fecd5 | LAB_004fec89
        ;   XREF to: 004fec89 (CONDITIONAL_JUMP)
    JMP 0x004fec94                      ; 004fecd7 | LAB_004fec94
        ;   XREF to: 004fec94 (UNCONDITIONAL_JUMP)
    TEST EBX,EBX                        ; 004fecd9
        ;   Label: LAB_004fecd9
    JGE 0x004feca5                      ; 004fecdb | LAB_004feca5
        ;   XREF to: 004feca5 (CONDITIONAL_JUMP)
    LEA EBX,[EBP + -0x1]                ; 004fecdd
    JMP 0x004feca5                      ; 004fece0 | LAB_004feca5
        ;   XREF to: 004feca5 (UNCONDITIONAL_JUMP)
    PUSH 0x630838                       ; 004fece2 | = "CAmmo" | s_CAmmo_00630838 = CAmmo
        ;   Label: LAB_004fece2
    MOV EDX,dword ptr [EBP + 0xc]       ; 004fece7
    PUSH EDX                            ; 004fecea
    CALL core_actor.cpp_isOfClass_FUN_0040c6d0 ; 004feceb | int core_actor.cpp_isOfClass_FUN_0040c6d0(CDemonActor * actor_ptr, char * class_name)
        ;   XREF to: 0040c6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004fecf0
    TEST EAX,EAX                        ; 004fecf3
    JNZ 0x004fecc3                      ; 004fecf5 | LAB_004fecc3
