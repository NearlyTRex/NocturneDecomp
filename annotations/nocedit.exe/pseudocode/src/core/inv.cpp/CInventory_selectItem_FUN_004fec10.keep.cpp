...
// Convention: __cdecl
// Signature: void __cdecl core_inv_cpp_CInventory_selectItem_FUN_004fec10(CInventory *this_ptr,int direction)
...

{
  ...
  if (this_ptr->selected_item == (CDemonActor *)0x0) {
    ...
    if (0 < this_ptr->item_count) {
      do {
        iVar1 = core_actor_cpp_isOfClass_FUN_0040c6d0(this_ptr->items[iVar4],"CWeapon");
        if ((iVar1 == 0) &&
           (iVar1 = core_actor_cpp_isOfClass_FUN_0040c6d0(this_ptr->items[iVar4],"CAmmo"),
           iVar1 == 0)) {
  ...
  if (0 < this_ptr->item_count) {
    do {
      iVar1 = iVar4;
      if (this_ptr->selected_item == this_ptr->items[iVar4]) break;
      iVar4 = iVar4 + 1;
      iVar1 = iVar4;
    } while (iVar4 < this_ptr->item_count);
  }
