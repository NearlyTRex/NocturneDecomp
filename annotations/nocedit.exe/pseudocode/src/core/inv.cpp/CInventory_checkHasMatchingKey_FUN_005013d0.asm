...
section .text
    ...
    PUSH EDX                            ; 005013fc
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 005013fd | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00501402
    TEST EAX,EAX                        ; 00501405
    JZ 0x0050145d                       ; 00501407 | LAB_0050145d
        ;   XREF to: 0050145d (CONDITIONAL_JUMP)
    TEST dword ptr [EAX + 0x2d4],EBP    ; 00501409
    JZ 0x0050145d                       ; 0050140f | LAB_0050145d
        ;   XREF to: 0050145d (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x1c],0x0      ; 00501411
    JZ 0x00501453                       ; 00501416 | LAB_00501453
        ;   XREF to: 00501453 (CONDITIONAL_JUMP)
    PUSH 0x40a00000                     ; 00501418
    PUSH 0x630b9a                       ; 0050141d | = "You used a key." | s_You_used_a_key_00630b9a = You used a key.
    CALL support_newmsg.cpp_getLocalizedString_FUN_005441f0 ; 00501422 | char * support_newmsg.cpp_getLocalizedString_FUN_005441f0(char * key)
        ;   XREF to: 005441f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00501427
    PUSH EAX                            ; 0050142a
    MOV ESI,dword ptr [0x0067b654]      ; 0050142b | CGame * g_CGamePtr
    PUSH ESI                            ; 00501431 | CGame g_CGameInstance
    CALL core_game.cpp_CGame_displayMessage_FUN_004d7f20 ; 00501432 | void core_game.cpp_CGame_displayMessage_FUN_004d7f20(CGame * this_ptr, char * message, float duration)
        ;   XREF to: 004d7f20 (UNCONDITIONAL_CALL)
    MOV EBP,dword ptr [EDI + 0x4]       ; 00501437
    ADD ESP,0xc                         ; 0050143a
    TEST EBP,EBP                        ; 0050143d
    JZ 0x00501453                       ; 0050143f | LAB_00501453
        ;   XREF to: 00501453 (CONDITIONAL_JUMP)
    PUSH 0x630baa                       ; 00501441 | = "key-unlock.wav" | s_key_unlock_wav_00630baa = key-unlock.wav
    ...
    JL 0x005013f3                       ; 00501466 | LAB_005013f3
        ;   XREF to: 005013f3 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x1c],0x0      ; 00501468
        ;   Label: LAB_00501468
    JZ 0x00501491                       ; 0050146d | LAB_00501491
        ;   XREF to: 00501491 (CONDITIONAL_JUMP)
    PUSH 0x40a00000                     ; 0050146f
    PUSH 0x630bb9                       ; 00501474 | = "You need the right key" | s_You_need_the_right_key_00630bb9 = You need the right key
    CALL support_newmsg.cpp_getLocalizedString_FUN_005441f0 ; 00501479 | char * support_newmsg.cpp_getLocalizedString_FUN_005441f0(char * key)
        ;   XREF to: 005441f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0050147e
    PUSH EAX                            ; 00501481
    MOV ESI,dword ptr [0x0067b654]      ; 00501482 | CGame * g_CGamePtr
    PUSH ESI                            ; 00501488 | CGame g_CGameInstance
    CALL core_game.cpp_CGame_displayMessage_FUN_004d7f20 ; 00501489 | void core_game.cpp_CGame_displayMessage_FUN_004d7f20(CGame * this_ptr, char * message, float duration)
        ;   XREF to: 004d7f20 (UNCONDITIONAL_CALL)
