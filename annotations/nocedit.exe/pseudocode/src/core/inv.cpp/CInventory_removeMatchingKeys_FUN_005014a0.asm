...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_inv_cpp_CInventory_removeMatchingKeys_FUN_005014a0(CInventory *this_ptr,uint key_mask)
;
; Parameters:
...
section .text
    ...
    JLE 0x005014e9                      ; 005014b3
        ;   XREF to: 005014e9 (CONDITIONAL_JUMP)  ; LAB_005014e9
    ...
    PUSH EDX                            ; 005014c0
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 005014c1
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)  ; CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
    ADD ESP,0x8                         ; 005014c6
    TEST EAX,EAX                        ; 005014c9
    JZ 0x005014ee                       ; 005014cb
        ;   XREF to: 005014ee (CONDITIONAL_JUMP)  ; LAB_005014ee
    TEST dword ptr [EAX + 0x2d4],EBP    ; 005014cd
    JZ 0x005014ee                       ; 005014d3
        ;   XREF to: 005014ee (CONDITIONAL_JUMP)  ; LAB_005014ee
    PUSH 0x1                            ; 005014d5
    MOV EAX,dword ptr [EBX + 0xc]       ; 005014d7
    PUSH EAX                            ; 005014da
    PUSH EDI                            ; 005014db
    CALL core_inv.cpp_CInventory_removeItem_FUN_004fea70 ; 005014dc
    ...
    JL 0x005014b7                       ; 005014e7
        ;   XREF to: 005014b7 (CONDITIONAL_JUMP)  ; LAB_005014b7
    POP EBP                             ; 005014e9
        ;   Label: LAB_005014e9
    POP EDI                             ; 005014ea
    POP ESI                             ; 005014eb
