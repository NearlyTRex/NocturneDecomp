...
;   undefined4 g_ItemDefinitionArray[0].description[0]
;   undefined4 g_ItemDefinitionArray[1].model_name[0]
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 004fcf70
        ;   Label: core_inv.cpp_getItemDescription_FUN_004fcf70
    PUSH ESI                            ; 004fcf71
    PUSH EDI                            ; 004fcf72
    PUSH EBP                            ; 004fcf73
    ...
    PUSH EBX                            ; 004fcf96 | g_ItemDefinitionArray | g_ItemDefinitionArray[1].model_name[0]
        ;   Label: LAB_004fcf96
    PUSH EDI                            ; 004fcf97
    ...
    PUSH 0x2db8b70                      ; 004fcfba | g_ErrorMessageBuffer_02db8b70
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 004fcfbf
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    MOV EAX,0x2db8b70                   ; 004fcfc4 | g_ErrorMessageBuffer_02db8b70
    ...
    POP EBX                             ; 004fcfcf
    RET                                 ; 004fcfd0
    LEA EAX,[EBX + 0x200]               ; 004fcfd1 | g_ItemDefinitionArray[0].description[0]
        ;   Label: LAB_004fcfd1
    POP EBP                             ; 004fcfd7
    POP EDI                             ; 004fcfd8
    POP ESI                             ; 004fcfd9
