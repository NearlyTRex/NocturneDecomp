...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_inv_cpp_CInventory_load_FUN_004ff400(CInventory *this_ptr)
;
; Parameters:
...
section .text
    ...
    CALL core_mission.cpp_CDemonMission_getNextLoadedInventoryActor_FUN_00523520 ; 004ff570
        ;   XREF to: 00523520 (UNCONDITIONAL_CALL)  ; void core_mission.cpp_CDemonMission_getNextLoadedInventoryActor_FUN_00523520(CDemonMission * this_ptr)
