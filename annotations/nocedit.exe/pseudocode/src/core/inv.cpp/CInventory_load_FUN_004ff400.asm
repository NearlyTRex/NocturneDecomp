...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_inv.cpp_CInventory_load_FUN_004ff400(CInventory * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 004ff411
    CALL core_inv.cpp_CInventory_clear_FUN_004fd0e0 ; 004ff412 | void core_inv.cpp_CInventory_clear_FUN_004fd0e0(CInventory * this_ptr)
        ;   XREF to: 004fd0e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004ff417
    MOV ECX,dword ptr [ESP + 0x1e0]     ; 004ff41a
    PUSH ECX                            ; 004ff421
    CALL core_inv.cpp_CInventory_initialize_FUN_004fd190 ; 004ff422 | void core_inv.cpp_CInventory_initialize_FUN_004fd190(CInventory * this_ptr)
    ...
    PUSH EAX                            ; 004ff43b
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 004ff43c | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
    ...
    PUSH EAX                            ; 004ff44e
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 004ff44f | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    PUSH EBX                            ; 004ff469
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004ff46a | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
    ...
    PUSH EAX                            ; 004ff47c
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 004ff47d | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    PUSH EBX                            ; 004ff495
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004ff496 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 004ff4a8
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 004ff4a9 | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    PUSH EBX                            ; 004ff4be
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004ff4bf | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004ff4c4
    MOV EAX,dword ptr [ESP + 0x1e0]     ; 004ff4c7
    CMP dword ptr [EAX + 0x32c],0x1     ; 004ff4ce
    JGE 0x004ff668                      ; 004ff4d5 | LAB_004ff668
    ...
    PUSH EAX                            ; 004ff4ec
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 004ff4ed | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    JLE 0x004ff591                      ; 004ff503 | LAB_004ff591
    ...
    MOV ESI,0x67ce48                    ; 004ff51e | undefined4 DAT_0067ce48
    PUSH EAX                            ; 004ff523
    LEA EAX,[ESP + 0x104]               ; 004ff524
    MOVSD.REP ES:EDI,ESI                ; 004ff52b | undefined4 DAT_0067ce48 | DAT_0067ce4c = 0x0
    PUSH EAX                            ; 004ff52d
    ...
    MOV ESI,0x67ceb0                    ; 004ff546 | undefined4 DAT_0067ceb0
    PUSH EAX                            ; 004ff54b
    MOVSD.REP ES:EDI,ESI                ; 004ff54c | undefined4 DAT_0067ceb0 | DAT_0067ceb4 = 0x0
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004ff54e | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    MOV ESI,dword ptr [0x0067d550]      ; 004ff553 | CDemonMission * g_CDemonMissionPtr
    MOV EDX,dword ptr [ESI + 0xc]       ; 004ff559 | DAT_02f3374c
    ADD ESP,0x10                        ; 004ff55c
    TEST EDX,EDX                        ; 004ff55f
    JZ 0x004ff69d                       ; 004ff561 | LAB_004ff69d
        ;   XREF to: 004ff69d (CONDITIONAL_JUMP)
    LEA EAX,[ESP + 0x164]               ; 004ff567
    PUSH EAX                            ; 004ff56e
    PUSH ESI                            ; 004ff56f | CDemonMission g_CDemonMissionInstance
    CALL core_mission.cpp_CDemonMission_getNextLoadedInventoryActor_FUN_00523520 ; 004ff570 | void core_mission.cpp_CDemonMission_getNextLoadedInventoryActor_FUN_00523520(CDemonMission * this_ptr)
    ...
    JL 0x004ff50b                       ; 004ff58b | LAB_004ff50b
    ...
    PUSH EAX                            ; 004ff5a2
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 004ff5a3 | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    JLE 0x004ff5f0                      ; 004ff5b9 | LAB_004ff5f0
    ...
    PUSH EDI                            ; 004ff5c8
    CALL core_actor.cpp_CDemonActor_load_FUN_0040b050 ; 004ff5c9 | void core_actor.cpp_CDemonActor_load_FUN_0040b050(CDemonActor * this_ptr, FILE * file_handle)
    ...
    JL 0x004ff5bd                       ; 004ff5e1 | LAB_004ff5bd
    ...
    JL 0x004ff61a                       ; 004ff5fe | LAB_004ff61a
    ...
    PUSH EAX                            ; 004ff611
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 004ff612 | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004ff617
    MOV EAX,[0x0067d550]                ; 004ff61a | CDemonMission * g_CDemonMissionPtr
        ;   Label: LAB_004ff61a
    ...
    JGE 0x004ff6da                      ; 004ff642 | LAB_004ff6da
        ;   XREF to: 004ff6da (CONDITIONAL_JUMP)
    PUSH 0x3e7                          ; 004ff648
        ;   Label: LAB_004ff648
    MOV ESI,dword ptr [ESP + 0x1e4]     ; 004ff64d
    PUSH ESI                            ; 004ff654
    CALL core_inv.cpp_CInventory_updateSelectedWeaponAmmoDisplay_FUN_004ffe10 ; 004ff655 | void core_inv.cpp_CInventory_updateSelectedWeaponAmmoDisplay_FUN_004ffe10(CInventory * this_ptr)
    ...
    PUSH EAX                            ; 004ff679
    CALL crt_stdio.c_fgets_FUN_005fefd0 ; 004ff67a | char * crt_stdio.c_fgets_FUN_005fefd0(char * str, int num, FILE * stream)
        ;   XREF to: 005fefd0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 004ff68f
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004ff690 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004ff695
    JMP 0x004ff4db                      ; 004ff698 | LAB_004ff4db
        ;   XREF to: 004ff4db (UNCONDITIONAL_JUMP)
    LEA EAX,[ESP + 0x100]               ; 004ff69d
        ;   Label: LAB_004ff69d
    PUSH EAX                            ; 004ff6a4
    LEA ESI,[ESP + 0x168]               ; 004ff6a5
    CALL core_actor.cpp_createActorByName_FUN_0040c430 ; 004ff6ac | CDemonActor * core_actor.cpp_createActorByName_FUN_0040c430(char * class_name)
    ...
    CMP AL,0x0                          ; 004ff6bd
    JZ 0x004ff6d1                       ; 004ff6bf | LAB_004ff6d1
    ...
    CMP AL,0x0                          ; 004ff6cd
    JNZ 0x004ff6b9                      ; 004ff6cf | LAB_004ff6b9
        ;   XREF to: 004ff6b9 (CONDITIONAL_JUMP)
    POP EDI                             ; 004ff6d1
        ;   Label: LAB_004ff6d1
    MOV dword ptr [EBX + 0xc],EDX       ; 004ff6d2
    JMP 0x004ff57b                      ; 004ff6d5 | LAB_004ff57b
    ...
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 004ff6f0 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
    ...
    JNZ 0x004ff648                      ; 004ff708 | LAB_004ff648
        ;   XREF to: 004ff648 (CONDITIONAL_JUMP)
    MOV ECX,0x630967                    ; 004ff70e | = "..\\core\\inv.cpp" | s_core_inv_cpp_00630967 = ..\core\inv.cpp
    MOV EBX,0x54b                       ; 004ff713
    PUSH 0x630977                       ; 004ff718 | = "CInventory::load - Can't find your we..." | s_CInventory_load_Can_t_fi_00630977 = CInventory::load - Can't find your weapon
    MOV dword ptr [0x02f0ca48],ECX      ; 004ff71d | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 004ff723 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004ff729 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004ff72e
    JMP 0x004ff648                      ; 004ff731 | LAB_004ff648
