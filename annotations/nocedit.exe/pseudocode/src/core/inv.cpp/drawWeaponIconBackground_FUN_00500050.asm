...
; Local Variables:
; SMRGLPrimitiveQuadIndex Stack[-0x48]:40  local_48
...
section .text
    ...
    PUSH 0x67cf14                       ; 00500057 | g_Inventory3DTextureAtlas
    MOV EDX,dword ptr [0x006703ec]      ; 0050005c | g_CDemonRendererInstance | g_CDemonRendererPtr2
    PUSH EDX                            ; 00500062 | g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80 ; 00500063
        ;   XREF to: 0048db80 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80(CDemonRenderer * this_ptr, SMRGLTextureBasic * texture)
    ADD ESP,0x8                         ; 00500068
    MOV ECX,dword ptr [ESP + 0x5c]      ; 0050006b
    PUSH ECX                            ; 0050006f
    MOV EBX,dword ptr [0x006703ec]      ; 00500070 | g_CDemonRendererInstance | g_CDemonRendererPtr2
    PUSH EBX                            ; 00500076 | g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_setRenderAlpha_FUN_0048ca60 ; 00500077
    ...
    MOV EAX,[0x006703ec]                ; 0050007f | g_CDemonRendererInstance | g_CDemonRendererPtr2
    MOV ECX,dword ptr [ESP + 0x4c]      ; 00500084
    MOV EDX,dword ptr [EAX]             ; 00500088 | g_CDemonRendererInstance
    SHL ECX,0x10                        ; 0050008a
    MOV dword ptr [EDX + 0x10],ECX      ; 0050008d
    MOV EBX,dword ptr [ESP + 0x50]      ; 00500090
    MOV EDX,dword ptr [EAX]             ; 00500094 | g_CDemonRendererInstance
    SHL EBX,0x10                        ; 00500096
    MOV dword ptr [EDX + 0x14],EBX      ; 00500099
    MOV EDX,dword ptr [EAX]             ; 0050009c | g_CDemonRendererInstance
    ...
    MOV ESI,dword ptr [EAX]             ; 005000c3 | g_CDemonRendererInstance
    MOV dword ptr [ESI + 0x44],EBX      ; 005000c5
    MOV EBX,dword ptr [EAX]             ; 005000c8 | g_CDemonRendererInstance
    ...
    MOV EBX,dword ptr [EAX]             ; 005000ec | g_CDemonRendererInstance
    SHL EDX,0x10                        ; 005000ee
    MOV dword ptr [EBX + 0x74],EDX      ; 005000f1
    MOV EBX,dword ptr [EAX]             ; 005000f4 | g_CDemonRendererInstance
    MOV dword ptr [EBX + 0x68],0x1000   ; 005000f6
    MOV EBX,dword ptr [EAX]             ; 005000fd | g_CDemonRendererInstance
    MOV dword ptr [EBX + 0x78],0x600000 ; 005000ff
    MOV EBX,dword ptr [EAX]             ; 00500106 | g_CDemonRendererInstance
    MOV dword ptr [EBX + 0x7c],0x1000000 ; 00500108 | g_LightBufferPool[13][93688]
    MOV EBX,dword ptr [EAX]             ; 0050010f | g_CDemonRendererInstance
    MOV dword ptr [EBX + 0xa0],ECX      ; 00500111
    MOV ECX,dword ptr [EAX]             ; 00500117 | g_CDemonRendererInstance
    MOV dword ptr [ECX + 0xa4],EDX      ; 00500119
    MOV EDX,dword ptr [EAX]             ; 0050011f | g_CDemonRendererInstance
    MOV dword ptr [EDX + 0x98],0x1000   ; 00500121
    MOV EDX,dword ptr [EAX]             ; 0050012b | g_CDemonRendererInstance
    MOV ESI,0x4                         ; 0050012d
    MOV dword ptr [EDX + 0xa8],0x0      ; 00500132
    MOV EBP,0x3                         ; 0050013c
    MOV EDX,dword ptr [EAX]             ; 00500141 | g_CDemonRendererInstance
    PUSH 0xa3                           ; 00500143
    XOR EDI,EDI                         ; 00500148
    MOV dword ptr [EDX + 0xac],0x1000000 ; 0050014a | g_LightBufferPool[13][93688]
    ...
    PUSH EBX                            ; 005001bb
    PUSH 0x32758e4                      ; 005001bc | g_CDemonCameraInstance
    MOV dword ptr [ESP + 0x48],EAX      ; 005001c1
    CALL core_dcamera.cpp_CDemonCamera_pushRect_FUN_0044c740 ; 005001c5
