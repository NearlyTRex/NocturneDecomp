...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_inv_cpp_CInventory_autoUseHealthItem_FUN_00501570(CInventory *this_ptr)
;
; Parameters:
...
section .text
    ...
    JNZ 0x005015c8                      ; 00501580
        ;   XREF to: 005015c8 (CONDITIONAL_JUMP)  ; LAB_005015c8
    ...
    PUSH EBP                            ; 00501597
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 00501598
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)  ; CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
    ADD ESP,0x8                         ; 0050159d
    TEST EAX,EAX                        ; 005015a0
    JNZ 0x005015fb                      ; 005015a2
        ;   XREF to: 005015fb (CONDITIONAL_JUMP)  ; LAB_005015fb
    INC EBX                             ; 005015a4
    MOV EAX,dword ptr [EDI + 0x8]       ; 005015a5
    ADD ESI,0x4                         ; 005015a8
    CMP EBX,EAX                         ; 005015ab
    JL 0x0050158d                       ; 005015ad
    ...
    PUSH ECX                            ; 005015ce
    PUSH EDX                            ; 005015cf
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 005015d0
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)  ; CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
    MOV EBX,EAX                         ; 005015d5
    ADD ESP,0x8                         ; 005015d7
    TEST EAX,EAX                        ; 005015da
    JZ 0x00501582                       ; 005015dc
    ...
    PUSH EBX                            ; 005015f2
    PUSH EDI                            ; 005015f3
    CALL core_inv.cpp_CInventory_select_FUN_004ff800 ; 005015f4
    ...
    JMP 0x005015c0                      ; 005015f9
        ;   XREF to: 005015c0 (UNCONDITIONAL_JUMP)  ; LAB_005015c0
    PUSH EAX                            ; 005015fb
        ;   Label: LAB_005015fb
    PUSH EDI                            ; 005015fc
    CALL core_inv.cpp_CInventory_select_FUN_004ff800 ; 005015fd
        ;   XREF to: 004ff800 (UNCONDITIONAL_CALL)  ; int core_inv.cpp_CInventory_select_FUN_004ff800(CInventory * this_ptr, CDemonActor * actor_ptr)
