...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_inv_cpp_CInventory_toggleDetailView_FUN_00501500(CInventory *this_ptr)
;
; Parameters:
; CInventory *     Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_game.cpp_CGame_processKeyboardControls_FUN_004dc3e0 at 004dc7c6
;
; Referenced Globals:
...
section .text
    ...
    MOV EDX,dword ptr [0x02db87d0]      ; 00501505 | g_LocalHeroIndex
    MOV EAX,dword ptr [EBX + 0x4]       ; 0050150b
    CMP EAX,dword ptr [EDX*0x4 + 0x2db87c0] ; 0050150e | g_HeroActors
    JNZ 0x0050154a                      ; 00501515
        ;   XREF to: 0050154a (CONDITIONAL_JUMP)  ; LAB_0050154a
    ...
    FNSTSW AX                           ; 00501536
    SAHF                                ; 00501538
    JC 0x0050154c                       ; 00501539
        ;   XREF to: 0050154c (CONDITIONAL_JUMP)  ; LAB_0050154c
    ...
    FNSTSW AX                           ; 00501545
    SAHF                                ; 00501547
    JC 0x00501557                       ; 00501548
        ;   XREF to: 00501557 (CONDITIONAL_JUMP)  ; LAB_00501557
    POP EBX                             ; 0050154a
        ;   Label: LAB_0050154a
    RET                                 ; 0050154b
    PUSH EBX                            ; 0050154c
        ;   Label: LAB_0050154c
    CALL core_inv.cpp_CInventory_resetItemSwitchTimers_FUN_004ffff0 ; 0050154d
    ...
    JMP 0x0050153b                      ; 00501555
        ;   XREF to: 0050153b (UNCONDITIONAL_JUMP)  ; LAB_0050153b
    PUSH 0x0                            ; 00501557
        ;   Label: LAB_00501557
    PUSH EBX                            ; 00501559
    CALL core_inv.cpp_CInventory_resetWeaponSwitchTimers_FUN_004fffa0 ; 0050155a
