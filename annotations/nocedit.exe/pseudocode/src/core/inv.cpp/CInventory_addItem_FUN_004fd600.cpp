...

{
  ...
  if ((((CHero *)this_ptr->owner == g_HeroActors[g_LocalHeroIndex]) && (show_tutorial_message != 0))
    ...
    core_inv_cpp_getItemDescription_FUN_004fcf70(item_actor);
    pCVar13 = (CAmmo *)core_actor_cpp_castToClassHash_FUN_0040c790
                                 (item_actor,g_CAmmoClassInfo.name_hash);
    pcVar16 = support_newmsg_cpp_getLocalizedString_FUN_005441f0("You've found : ");
    do {
      cVar1 = *pcVar16;
      *pcVar20 = cVar1;
      if (cVar1 == '\0') break;
    ...
    if (pCVar13 != (CAmmo *)0x0) {
      ...
      do {
        ...
        if (iVar18 == 0) break;
        iVar18 = iVar18 + -1;
        pcVar21 = pcVar16 + (uint)bVar22 * -2 + 1;
        cVar1 = *pcVar16;
        pcVar16 = pcVar21;
      } while (cVar1 != '\0');
      pcVar21 = pcVar21 + -1;
    ...
    do {
      ...
      if (iVar18 == 0) break;
      iVar18 = iVar18 + -1;
      pcVar16 = pcVar20 + (uint)bVar22 * -2 + 1;
      cVar1 = *pcVar20;
      pcVar20 = pcVar16;
    } while (cVar1 != '\0');
    pcVar16 = pcVar16 + -1;
    ...
    if (iVar18 != 0) {
      ...
      do {
        ...
        if (iVar18 == 0) break;
        iVar18 = iVar18 + -1;
        pcVar21 = pcVar20 + (uint)bVar22 * -2 + 1;
        cVar1 = *pcVar20;
        pcVar20 = pcVar21;
      } while (cVar1 != '\0');
      pcVar21 = pcVar21 + -1;
