...
;                               FUNCTION
; *****************************************************************************
; __cdecl CBoundingBox3D * __cdecl core_ladder_cpp_getBoundingBox_CLadder_FUN_005028c0(CLadder *this_ptr,CBoundingBox3D *out_box)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005028c0
        ;   Label: core_ladder.cpp_getBoundingBox_CLadder_FUN_005028c0
    PUSH ESI                            ; 005028c1
