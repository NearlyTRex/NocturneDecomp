...

{
  ...
  (ADJ(this_ptr_00)->relative_position).x = 0.0f;
  (ADJ(this_ptr_00)->relative_position).y = 0.0f;
  (ADJ(this_ptr_00)->relative_position).z = 0.0f;
  (ADJ(this_ptr_00)->cached_euler_angles).x = 0.0f;
  (ADJ(this_ptr_00)->cached_euler_angles).y = 0.0f;
  (ADJ(this_ptr_00)->cached_euler_angles).z = 0.0f;
