...
;                               FUNCTION
; *****************************************************************************
; __cdecl CLadder * __cdecl core_ladder_cpp_CLadder_dtor_FUN_00502ed0(CLadder *this_ptr,uint d1,uint d2)
;
; Parameters:
...
section .text
    ...
    PUSH 0x6606e0                       ; 00502ef6 | g_CLadderTypeInfo
        ;   Label: LAB_00502ef6
    PUSH EBX                            ; 00502efb
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 00502efc
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 00502f01
    PUSH EAX                            ; 00502f04
    CALL crt_memory.c_free_FUN_005fe659 ; 00502f05
    ...
    PUSH EAX                            ; 00502f11
        ;   Label: LAB_00502f11
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 00502f12
