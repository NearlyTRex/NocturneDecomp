...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_ladder_cpp_CLadder_serialize_FUN_005029c0(CLadder *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005029c0
        ;   Label: core_ladder.cpp_CLadder_serialize_FUN_005029c0
    MOV EBX,dword ptr [ESP + 0x8]       ; 005029c1
    PUSH EBX                            ; 005029c5
    CALL core_actor.cpp_CDemonActor_serialize_FUN_0040c1c0 ; 005029c6
    ...
    PUSH EAX                            ; 005029d9
    CALL core_actor.cpp_serializeKeyframedModelInstance_FUN_0040b8f0 ; 005029da
    ...
    PUSH EAX                            ; 005029ed
    CALL core_actor.cpp_serializeVector_FUN_0040b340 ; 005029ee
    ...
    PUSH EAX                            ; 00502a01
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 00502a02
    ...
    PUSH EBX                            ; 00502a2b
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 00502a2c
