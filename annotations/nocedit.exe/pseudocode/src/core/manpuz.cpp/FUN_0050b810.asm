...
section .text
    ...
    PUSH ECX                            ; 0050b81a
    CALL core_actor.cpp_CDemonActor_writeDependencies_FUN_0040cfd0 ; 0050b81b | void core_actor.cpp_CDemonActor_writeDependencies_FUN_0040cfd0(CDemonActor * this_ptr, FILE * file_handle)
    ...
    PUSH EAX                            ; 0050b831
    CALL core_dmodel.cpp_CKeyFramedModelInstance_writeDependencies_FUN_0047edd0 ; 0050b832 | void core_dmodel.cpp_CKeyFramedModelInstance_writeDependencies_FUN_0047edd0(CKeyFramedModelInstance * this_ptr, FILE * file_handle)
