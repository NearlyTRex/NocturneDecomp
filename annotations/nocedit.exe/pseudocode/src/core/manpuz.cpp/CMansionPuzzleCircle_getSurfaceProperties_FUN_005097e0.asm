...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_manpuz_cpp_CMansionPuzzleCircle_getSurfaceProperties_FUN_005097e0 (CMansionPuzzleCircle *this_ptr,SSurfaceInfo *surface_info)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005097e0
        ;   Label: core_manpuz.cpp_CMansionPuzzleCircle_getSurfaceProperties_FUN_005097e0
    PUSH ESI                            ; 005097e1
    PUSH EDI                            ; 005097e2
    PUSH EBP                            ; 005097e3
