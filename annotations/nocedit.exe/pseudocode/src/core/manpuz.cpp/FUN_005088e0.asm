...
section .text
    ...
    PUSH EAX                            ; 005088fc
        ;   Label: LAB_005088fc
    CALL core_manpuz.cpp_FUN_00508920   ; 005088fd
        ;   XREF to: 00508920 (UNCONDITIONAL_CALL)  ; CMansionPuzzleCircle * core_manpuz.cpp_FUN_00508920(CMansionPuzzleCircle * this_ptr)
