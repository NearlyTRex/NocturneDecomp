...
section .text
    ...
    PUSH EAX                            ; 005089aa
    MOV dword ptr [EBX + 0x154],0x660da4 ; 005089ab | PTR_core_manpuz.cpp_FUN_00660da4
    ...
    CALL core_manpuz.cpp_FUN_005098f0   ; 00508a55
        ;   XREF to: 005098f0 (UNCONDITIONAL_CALL)  ; undefined core_manpuz.cpp_FUN_005098f0()
