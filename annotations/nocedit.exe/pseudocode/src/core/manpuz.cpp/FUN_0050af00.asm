...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_manpuz.cpp_FUN_0050af00()
;
;
; XREF[1]:
;   core_manpuz.cpp_FUN_005091d0 at 0050920d
;
; Referenced Globals:
...
section .text
    ...
    JZ 0x0050af5d                       ; 0050af39 | LAB_0050af5d
        ;   XREF to: 0050af5d (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0xc]           ; 0050af3b
    FDIV float ptr [0x00660d9c]         ; 0050af3f | DAT_00660d9c
    ...
    FNSTSW AX                           ; 0050af4f
    SAHF                                ; 0050af51
    JA 0x0050af55                       ; 0050af52 | LAB_0050af55
    ...
    FLD float ptr [ESP + 0xc]           ; 0050af5d
        ;   Label: LAB_0050af5d
    FDIV float ptr [0x00660d9c]         ; 0050af61 | DAT_00660d9c
    ...
    FNSTSW AX                           ; 0050af71
    SAHF                                ; 0050af73
    JNC 0x0050af54                      ; 0050af74 | LAB_0050af54
