...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_manpuz_cpp_CMansionPuzzleCircle_archive_FUN_0050adf0(CMansionPuzzleCircle *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH ESI                            ; 0050adf0
        ;   Label: core_manpuz.cpp_CMansionPuzzleCircle_archive_FUN_0050adf0
    PUSH EBP                            ; 0050adf1
    SUB ESP,0x4                         ; 0050adf2
    MOV ESI,dword ptr [ESP + 0x10]      ; 0050adf5
    PUSH ESI                            ; 0050adf9
    CALL core_actor.cpp_CDemonActor_archive_FUN_0040c1c0 ; 0050adfa
    ...
    PUSH EAX                            ; 0050ae48
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 0050ae49
    ...
    PUSH ESI                            ; 0050ae56
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 0050ae57
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ADD ESP,0x8                         ; 0050ae5c
    PUSH 0x6358b6                       ; 0050ae5f | = "g"
    PUSH EDI                            ; 0050ae64
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 0050ae65
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 0050ae7a
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    PUSH EAX                            ; 0050ae9d
    CALL core_actor.cpp_archiveVector_FUN_0040b340 ; 0050ae9e
    ...
    PUSH EAX                            ; 0050aeb1
    CALL core_actor.cpp_archiveOrientation_FUN_0040b3e0 ; 0050aeb2
    ...
    PUSH EAX                            ; 0050aec5
    CALL core_actor.cpp_archiveVector_FUN_0040b340 ; 0050aec6
        ;   XREF to: 0040b340 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveVector_FUN_0040b340(CVector3f * vector_ptr, char * property_name)
