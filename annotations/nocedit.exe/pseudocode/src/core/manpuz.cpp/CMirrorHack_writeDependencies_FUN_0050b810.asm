...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_manpuz_cpp_CMirrorHack_writeDependencies_FUN_0050b810(CMirrorHack *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0050b810
        ;   Label: core_manpuz.cpp_CMirrorHack_writeDependencies_FUN_0050b810
