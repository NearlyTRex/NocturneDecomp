...
section .text
    ...
    PUSH EBX                            ; 0050b8a4
    CALL core_manpuz.cpp_FUN_0050bad0   ; 0050b8a5
        ;   XREF to: 0050bad0 (UNCONDITIONAL_CALL)  ; undefined core_manpuz.cpp_FUN_0050bad0()
    ADD ESP,0x8                         ; 0050b8aa
    PUSH 0x0                            ; 0050b8ad
    SUB EAX,0x8a0                       ; 0050b8af
    PUSH EAX                            ; 0050b8b4
    CALL core_manpuz.cpp_FUN_0050bab0   ; 0050b8b5
        ;   XREF to: 0050bab0 (UNCONDITIONAL_CALL)  ; undefined core_manpuz.cpp_FUN_0050bab0()
    ADD ESP,0x8                         ; 0050b8ba
    PUSH 0x0                            ; 0050b8bd
    SUB EAX,0x4b0                       ; 0050b8bf
    PUSH EAX                            ; 0050b8c4
    CALL core_manpuz.cpp_FUN_0050ba90   ; 0050b8c5
        ;   XREF to: 0050ba90 (UNCONDITIONAL_CALL)  ; undefined core_manpuz.cpp_FUN_0050ba90()
