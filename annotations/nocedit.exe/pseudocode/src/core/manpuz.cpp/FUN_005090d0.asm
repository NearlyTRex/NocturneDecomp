...
section .text
    ...
    PUSH EBX                            ; 0050915b
        ;   Label: LAB_0050915b
    PUSH ESI                            ; 0050915c
    CALL core_manpuz.cpp_FUN_00509bf0   ; 0050915d
        ;   XREF to: 00509bf0 (UNCONDITIONAL_CALL)  ; undefined core_manpuz.cpp_FUN_00509bf0()
    ADD ESP,0x8                         ; 00509162
    PUSH EBX                            ; 00509165
    PUSH ESI                            ; 00509166
    CALL core_manpuz.cpp_FUN_00509d50   ; 00509167
        ;   XREF to: 00509d50 (UNCONDITIONAL_CALL)  ; undefined core_manpuz.cpp_FUN_00509d50()
    INC EBX                             ; 0050916c
    ...
    PUSH EBX                            ; 00509182
        ;   Label: LAB_00509182
    PUSH ESI                            ; 00509183
    CALL core_manpuz.cpp_FUN_0050a1f0   ; 00509184
        ;   XREF to: 0050a1f0 (UNCONDITIONAL_CALL)  ; undefined core_manpuz.cpp_FUN_0050a1f0()
    INC EBX                             ; 00509189
    ...
    PUSH EBX                            ; 005091b9
        ;   Label: LAB_005091b9
    PUSH ESI                            ; 005091ba
    CALL core_manpuz.cpp_FUN_00509c60   ; 005091bb
        ;   XREF to: 00509c60 (UNCONDITIONAL_CALL)  ; undefined core_manpuz.cpp_FUN_00509c60()
    INC EBX                             ; 005091c0
