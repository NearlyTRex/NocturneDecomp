...
;
; XREF[1]:
;   core_manpuz.cpp_CMansionPuzzleCircle_process_FUN_005091d0 at 00509239
;
; Referenced Globals:
...
;   float FLOAT_00660d94 = 2
;   float FLOAT_00660d98 = 2
;
; Called Functions:
...
;   core_manpuz.cpp_updateGemHumChannel_FUN_0050a4f0
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 0050a610
        ;   Label: core_manpuz.cpp_CMansionPuzzleCircle_updateGem_FUN_0050a610
    PUSH ESI                            ; 0050a611
    PUSH EDI                            ; 0050a612
    PUSH EBP                            ; 0050a613
    ...
    FDIV float ptr [0x00660d94]         ; 0050a62d | FLOAT_00660d94
    ...
    PUSH EAX                            ; 0050a67b
    CALL core_manpuz.cpp_updateGemHumChannel_FUN_0050a4f0 ; 0050a67c
        ;   XREF to: 0050a4f0 (UNCONDITIONAL_CALL)  ; int core_manpuz.cpp_updateGemHumChannel_FUN_0050a4f0(float * hum_value, float target, float max_step, uint * sfx_handle, ...)
    ...
    CALL core_manpuz.cpp_updateGemHumChannel_FUN_0050a4f0 ; 0050a6a3
        ;   XREF to: 0050a4f0 (UNCONDITIONAL_CALL)  ; int core_manpuz.cpp_updateGemHumChannel_FUN_0050a4f0(float * hum_value, float target, float max_step, uint * sfx_handle, ...)
    ...
    PUSH EAX                            ; 0050a6c6
    CALL core_manpuz.cpp_updateGemHumChannel_FUN_0050a4f0 ; 0050a6c7
        ;   XREF to: 0050a4f0 (UNCONDITIONAL_CALL)  ; int core_manpuz.cpp_updateGemHumChannel_FUN_0050a4f0(float * hum_value, float target, float max_step, uint * sfx_handle, ...)
    ...
    CALL core_manpuz.cpp_CMansionPuzzleCircle_getPanelColor_FUN_0050a420 ; 0050a6f5
    ...
    FDIV float ptr [0x00660d98]         ; 0050a701 | FLOAT_00660d98
    ...
    PUSH EDI                            ; 0050a86d
    PUSH ESI                            ; 0050a86e
    CALL core_manpuz.cpp_CMansionPuzzleCircle_getPrevPanelIndex_FUN_0050aef0 ; 0050a86f
    ...
    CALL core_manpuz.cpp_CMansionPuzzleCircle_panelOccupied_FUN_0050b040 ; 0050a879
        ;   XREF to: 0050b040 (UNCONDITIONAL_CALL)  ; int core_manpuz.cpp_CMansionPuzzleCircle_panelOccupied_FUN_0050b040(CMansionPuzzleCircle * this_ptr, int panel_index)
    ...
    PUSH EDI                            ; 0050a885
    PUSH ESI                            ; 0050a886
    CALL core_manpuz.cpp_CMansionPuzzleCircle_getNextPanelIndex_FUN_0050aee0 ; 0050a887
    ...
    CALL core_manpuz.cpp_CMansionPuzzleCircle_shiftPanelLeft_FUN_0050aba0 ; 0050a8b5
        ;   XREF to: 0050aba0 (UNCONDITIONAL_CALL)  ; void core_manpuz.cpp_CMansionPuzzleCircle_shiftPanelLeft_FUN_0050aba0(CMansionPuzzleCircle * this_ptr, int panel_index)
