...
section .text
    ...
    CALL core_manpuz.cpp_CMansionPuzzleCircle_processPanel_FUN_0050a290 ; 005091f7
        ;   XREF to: 0050a290 (UNCONDITIONAL_CALL)  ; undefined core_manpuz.cpp_CMansionPuzzleCircle_processPanel_FUN_0050a290()
    INC ESI                             ; 005091fc
    ...
    PUSH ESI                            ; 0050920b
    PUSH EBX                            ; 0050920c
    CALL core_manpuz.cpp_FUN_0050af00   ; 0050920d
        ;   XREF to: 0050af00 (UNCONDITIONAL_CALL)  ; undefined core_manpuz.cpp_FUN_0050af00()
    INC ESI                             ; 00509212
    ...
    PUSH ESI                            ; 00509221
    PUSH EBX                            ; 00509222
    CALL core_manpuz.cpp_FUN_0050a8d0   ; 00509223
        ;   XREF to: 0050a8d0 (UNCONDITIONAL_CALL)  ; undefined core_manpuz.cpp_FUN_0050a8d0()
    INC ESI                             ; 00509228
    ...
    PUSH ESI                            ; 00509237
    PUSH EBX                            ; 00509238
    CALL core_manpuz.cpp_FUN_0050a610   ; 00509239
        ;   XREF to: 0050a610 (UNCONDITIONAL_CALL)  ; undefined core_manpuz.cpp_FUN_0050a610()
    INC ESI                             ; 0050923e
    ...
    PUSH ESI                            ; 00509249
        ;   Label: LAB_00509249
    PUSH EBX                            ; 0050924a
    CALL core_manpuz.cpp_FUN_00509b20   ; 0050924b
    ...
    PUSH ESI                            ; 0050925b
        ;   Label: LAB_0050925b
    PUSH EBX                            ; 0050925c
    CALL core_manpuz.cpp_FUN_0050af80   ; 0050925d
        ;   XREF to: 0050af80 (UNCONDITIONAL_CALL)  ; undefined core_manpuz.cpp_FUN_0050af80()
    INC ESI                             ; 00509262
