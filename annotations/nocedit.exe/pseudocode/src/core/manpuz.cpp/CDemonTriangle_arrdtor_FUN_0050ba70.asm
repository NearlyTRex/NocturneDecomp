...
;                               FUNCTION
; *****************************************************************************
; __cdecl CDemonTriangle * __cdecl core_manpuz_cpp_CDemonTriangle_arrdtor_FUN_0050ba70(CDemonTriangle *objs,uint flags)
;
; Parameters:
...
section .text
    ...
    PUSH 0x65c990                       ; 0050ba70 | g_CDemonTriangleTypeInfo
        ;   Label: core_manpuz.cpp_CDemonTriangle_arrdtor_FUN_0050ba70
    PUSH 0x2                            ; 0050ba75
