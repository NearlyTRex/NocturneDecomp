...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_manpuz_cpp_CMansionPuzzleCircle_panelOccupied_FUN_0050b040(CMansionPuzzleCircle *this_ptr)
;
; Parameters:
; CMansionPuzzleCircle * Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_manpuz.cpp_CMansionPuzzleCircle_FUN_0050a610 at 0050a891
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0050b099
        ;   Label: LAB_0050b099
    PUSH ESI                            ; 0050b09a
    CALL core_manpuz.cpp_CMansionPuzzleCircle_FUN_0050aef0 ; 0050b09b
