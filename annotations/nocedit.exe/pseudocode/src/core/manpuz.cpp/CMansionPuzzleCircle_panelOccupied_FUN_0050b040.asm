...
;
; XREF[1]:
;   core_manpuz.cpp_CMansionPuzzleCircle_updateGem_FUN_0050a610 at 0050a891
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0050b099
        ;   Label: LAB_0050b099
    PUSH ESI                            ; 0050b09a
    CALL core_manpuz.cpp_CMansionPuzzleCircle_getPrevPanelIndex_FUN_0050aef0 ; 0050b09b
