...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_manpuz_cpp_CMansionPuzzleCircle_writeDependencies_FUN_0050b7d0 (CMansionPuzzleCircle *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0050b7d0
        ;   Label: core_manpuz.cpp_CMansionPuzzleCircle_writeDependencies_FUN_0050b7d0
    PUSH ESI                            ; 0050b7d1
    MOV EBX,dword ptr [ESP + 0xc]       ; 0050b7d2
    MOV ESI,dword ptr [ESP + 0x10]      ; 0050b7d6
    PUSH ESI                            ; 0050b7da
    PUSH EBX                            ; 0050b7db
    CALL core_actor.cpp_CDemonActor_writeDependencies_FUN_0040cfd0 ; 0050b7dc
    ...
    PUSH EAX                            ; 0050b7eb
    CALL core_dmodel.cpp_CKeyFramedModelInstance_writeDependencies_FUN_0047edd0 ; 0050b7ec
    ...
    PUSH EAX                            ; 0050b7fb
    CALL core_dmodel.cpp_CKeyFramedModelInstance_writeDependencies_FUN_0047edd0 ; 0050b7fc
        ;   XREF to: 0047edd0 (UNCONDITIONAL_CALL)  ; void core_dmodel.cpp_CKeyFramedModelInstance_writeDependencies_FUN_0047edd0(CKeyFramedModelInstance * this_ptr, _FILE * file_handle)
