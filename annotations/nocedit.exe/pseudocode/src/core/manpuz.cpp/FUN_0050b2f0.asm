...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_manpuz.cpp_FUN_0050b2f0()
;
;
; Called Functions:
...
section .text
    ...
    PUSH EDX                            ; 0050b2fa
    CALL core_actor.cpp_CDemonActor_getInteractionInfo_FUN_0040a030 ; 0050b2fb | void core_actor.cpp_CDemonActor_getInteractionInfo_FUN_0040a030(CDemonActor * this_ptr, SInteractionInfo * out_info)
