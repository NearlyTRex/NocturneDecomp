...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_manpuz.cpp_CMansionPuzzleCircle_process_FUN_0050b1d0(CMansionPuzzleCircle * this_ptr, float delta_time)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0050b1d0
        ;   Label: core_manpuz.cpp_CMansionPuzzleCircle_process_FUN_0050b1d0
    PUSH EBP                            ; 0050b1d1
