...
;                               FUNCTION
; *****************************************************************************
; __cdecl CMirrorHack * core_manpuz.cpp_CMirrorHack_ctor_FUN_0050b110(CMirrorHack * this_ptr)
;
; Parameters:
; CMirrorHack *    Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_manpuz.cpp_CMirrorHack_factoryFunc_FUN_0050b0d0 at 0050b0ed
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0050b110
        ;   Label: core_manpuz.cpp_CMirrorHack_ctor_FUN_0050b110
    ...
    PUSH EAX                            ; 0050b13d
    MOV dword ptr [EBX + 0x154],0x660e94 ; 0050b13e | g_CMirrorHackVTable
