// Name: core_manpuz.cpp_CMansionPuzzleCircle_serialize_FUN_0050adf0
// Address: 0050adf0
// Address Range: [[0050adf0, 0050aed2]]
// Convention: __cdecl
// Signature: void __cdecl core_manpuz_cpp_CMansionPuzzleCircle_serialize_FUN_0050adf0(CMansionPuzzleCircle *this_ptr)

#include "nocturne.h"

void __cdecl
core_manpuz_cpp_CMansionPuzzleCircle_serialize_FUN_0050adf0(CMansionPuzzleCircle *this_ptr)

{
  ...
  if (1 < g_CMansionPuzzleCircleClassVersion) {
    ...
    core_actor_cpp_serializeVector_FUN_0040b340(&this_ptr->emitter_pos,"pEmitterPos");
  }
  if (2 < g_CMansionPuzzleCircleClassVersion) {
    ...
    do {
      ...
      core_actor_cpp_serializeInteger_FUN_0040b7f0(int_ptr,"b");
