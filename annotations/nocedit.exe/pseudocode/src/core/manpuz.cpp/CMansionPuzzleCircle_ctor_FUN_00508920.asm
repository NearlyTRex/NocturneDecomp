...
;                               FUNCTION
; *****************************************************************************
; __cdecl CMansionPuzzleCircle * core_manpuz.cpp_CMansionPuzzleCircle_ctor_FUN_00508920(CMansionPuzzleCircle * this_ptr)
;
; Parameters:
; CMansionPuzzleCircle * Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_manpuz.cpp_CMansionPuzzleCircle_factoryFunc_FUN_005088e0 at 005088fd
;
; Referenced Globals:
...
section .text
    ...
    CALL core_manpuz.cpp_CMansionPuzzleCircle_FUN_005098f0 ; 00508a55
        ;   XREF to: 005098f0 (UNCONDITIONAL_CALL)  ; void core_manpuz.cpp_CMansionPuzzleCircle_FUN_005098f0(CMansionPuzzleCircle * this_ptr)
