...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_manpuz_cpp_CMansionPuzzleCircle_serialize_FUN_0050adf0(CMansionPuzzleCircle *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH ESI                            ; 0050adf0
        ;   Label: core_manpuz.cpp_CMansionPuzzleCircle_serialize_FUN_0050adf0
    PUSH EBP                            ; 0050adf1
    SUB ESP,0x4                         ; 0050adf2
    MOV ESI,dword ptr [ESP + 0x10]      ; 0050adf5
    PUSH ESI                            ; 0050adf9
    CALL core_actor.cpp_CDemonActor_serialize_FUN_0040c1c0 ; 0050adfa
        ;   XREF to: 0040c1c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_CDemonActor_serialize_FUN_0040c1c0(CDemonActor * this_ptr)
    MOV EDX,dword ptr [0x0067d0d4]      ; 0050adff | g_CMansionPuzzleCircleClassVersion
    ADD ESP,0x4                         ; 0050ae05
    CMP EDX,0x2                         ; 0050ae08
    JGE 0x0050ae92                      ; 0050ae0b
        ;   XREF to: 0050ae92 (CONDITIONAL_JUMP)  ; LAB_0050ae92
    CMP dword ptr [0x0067d0d4],0x3      ; 0050ae11 | g_CMansionPuzzleCircleClassVersion
        ;   Label: LAB_0050ae11
    JL 0x0050ae8c                       ; 0050ae18
        ;   XREF to: 0050ae8c (CONDITIONAL_JUMP)  ; LAB_0050ae8c
    PUSH EDI                            ; 0050ae1a
    PUSH EBX                            ; 0050ae1b
    ...
    PUSH 0x6358ad                       ; 0050ae41 | = "exists"
    ADD EAX,EDX                         ; 0050ae46
    PUSH EAX                            ; 0050ae48
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 0050ae49
    ...
    PUSH 0x6358b4                       ; 0050ae51 | = "r"
    PUSH ESI                            ; 0050ae56
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 0050ae57
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ADD ESP,0x8                         ; 0050ae5c
    PUSH 0x6358b6                       ; 0050ae5f | = "g"
    PUSH EDI                            ; 0050ae64
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 0050ae65
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ADD ESP,0x8                         ; 0050ae6a
    PUSH 0x6358b8                       ; 0050ae6d | = "b"
    INC EBX                             ; 0050ae72
    PUSH EBP                            ; 0050ae73
    ADD ESI,0x64                        ; 0050ae74
    ADD EDI,0x64                        ; 0050ae77
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 0050ae7a
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ADD ESP,0x8                         ; 0050ae7f
    ADD EBP,0x64                        ; 0050ae82
    CMP EBX,0xc                         ; 0050ae85
    JL 0x0050ae3a                       ; 0050ae88
        ;   XREF to: 0050ae3a (CONDITIONAL_JUMP)  ; LAB_0050ae3a
    POP EBX                             ; 0050ae8a
    POP EDI                             ; 0050ae8b
    ...
    POP ESI                             ; 0050ae90
    RET                                 ; 0050ae91
    PUSH 0x63588e                       ; 0050ae92 | = "pGemPos"
        ;   Label: LAB_0050ae92
    LEA EAX,[ESI + 0x5cc]               ; 0050ae97
    PUSH EAX                            ; 0050ae9d
    CALL core_actor.cpp_serializeVector_FUN_0040b340 ; 0050ae9e
    ...
    PUSH 0x635896                       ; 0050aea6 | = "pGemOrient"
    LEA EAX,[ESI + 0x5d8]               ; 0050aeab
    PUSH EAX                            ; 0050aeb1
    CALL core_actor.cpp_serializeOrientation_FUN_0040b3e0 ; 0050aeb2
    ...
    PUSH 0x6358a1                       ; 0050aeba | = "pEmitterPos"
    LEA EAX,[ESI + 0x5e4]               ; 0050aebf
    PUSH EAX                            ; 0050aec5
    CALL core_actor.cpp_serializeVector_FUN_0040b340 ; 0050aec6
        ;   XREF to: 0040b340 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeVector_FUN_0040b340(CVector3f * vector_ptr, char * property_name)
    ADD ESP,0x8                         ; 0050aecb
    JMP 0x0050ae11                      ; 0050aece
        ;   XREF to: 0050ae11 (UNCONDITIONAL_JUMP)  ; LAB_0050ae11
