...

{
  ...
  engine_drender_cpp_CDemonRenderer_captureTexture_FUN_0048db80
            (g_CDemonRendererPtr2,(SMRGLTextureBasic *)&this_ptr->light_texture);
  ...
  do {
    ...
    core_manpuz_cpp_CMansionPuzzleCircle_getPanelColor_FUN_0050a420
              (this_ptr,local_38,&pSVar12->color.r,&pSVar12->color.g,&pSVar12->color.b);
  ...
  if (this_ptr->reflectors != (SReflector *)pCVar16) {
    this_ptr->reflectors[0].start_position = *pCVar16;
  }
