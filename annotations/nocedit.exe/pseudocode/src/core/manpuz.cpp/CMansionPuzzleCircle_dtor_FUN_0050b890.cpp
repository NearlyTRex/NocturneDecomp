...

{
  ...
  pSVar1 = core_manpuz_cpp_freeReflectors_FUN_0050bad0((SReflector *)(this_ptr->unk3 + 0xcf8));
  pSVar2 = core_manpuz_cpp_freeGems_FUN_0050bab0((SGem *)(pSVar1 + -0x17));
  pSVar3 = core_manpuz_cpp_freePanels_FUN_0050ba90((SPanel *)(pSVar2[-7].unk + 0x58));
