...
; Local Variables:
; SLaserInfo       Stack[-0x114]:84  local_114
; SLaserInfo       Stack[-0xc0]:84  local_c0
...
section .text
    ...
    PUSH EBX                            ; 0050a8d0
        ;   Label: core_manpuz.cpp_CMansionPuzzleCircle_updateLaser_FUN_0050a8d0
    PUSH ESI                            ; 0050a8d1
    PUSH EDI                            ; 0050a8d2
    PUSH EBP                            ; 0050a8d3
    ...
    CALL core_manpuz.cpp_CMansionPuzzleCircle_getPrevPanelIndex_FUN_0050aef0 ; 0050ab3c
