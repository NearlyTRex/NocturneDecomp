...
;                               FUNCTION
; *****************************************************************************
; __cdecl CMansionPuzzleCircle * core_manpuz.cpp_CMansionPuzzleCircle_factoryFunc_FUN_005088e0(void)
;
;
; XREF[1]:
...
section .text
    ...
    PUSH 0xeb                           ; 005088e0
        ;   Label: core_manpuz.cpp_CMansionPuzzleCircle_factoryFunc_FUN_005088e0
