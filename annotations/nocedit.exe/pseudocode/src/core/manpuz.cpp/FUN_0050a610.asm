...
section .text
    ...
    FMUL float ptr [0x006357d1]         ; 0050a623 | float FLOAT_006357d1
    ...
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 0050a65a | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
        ;   XREF to: 00408ec0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0050a65f
    MOV EAX,ESP                         ; 0050a662
    PUSH EAX                            ; 0050a664
    PUSH 0x635775                       ; 0050a665 | = "manpuz-chargegemloop-red.wav" | s_manpuz_chargegemloop_red_00635775 = manpuz-chargegemloop-red.wav
    ...
    PUSH EAX                            ; 0050a67b
    CALL core_manpuz.cpp_FUN_0050a4f0   ; 0050a67c | undefined core_manpuz.cpp_FUN_0050a4f0()
        ;   XREF to: 0050a4f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x18                        ; 0050a681
    MOV EBP,EAX                         ; 0050a684
    MOV EAX,ESP                         ; 0050a686
    PUSH EAX                            ; 0050a688
    PUSH 0x635792                       ; 0050a689 | = "manpuz-chargegemloop-green.wav" | s_manpuz_chargegemloop_gre_00635792 = manpuz-chargegemloop-green.wav
    ...
    CALL core_manpuz.cpp_FUN_0050a4f0   ; 0050a6a3 | undefined core_manpuz.cpp_FUN_0050a4f0()
        ;   XREF to: 0050a4f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x18                        ; 0050a6a8
    AND EBP,EAX                         ; 0050a6ab
    MOV EAX,ESP                         ; 0050a6ad
    PUSH EAX                            ; 0050a6af
    PUSH 0x6357b1                       ; 0050a6b0 | = "manpuz-chargegemloop-blue.wav" | s_manpuz_chargegemloop_blu_006357b1 = manpuz-chargegemloop-blue.wav
    ...
    PUSH EAX                            ; 0050a6c6
    CALL core_manpuz.cpp_FUN_0050a4f0   ; 0050a6c7 | undefined core_manpuz.cpp_FUN_0050a4f0()
        ;   XREF to: 0050a4f0 (UNCONDITIONAL_CALL)
    ...
    CALL core_manpuz.cpp_FUN_0050a420   ; 0050a6f5 | undefined core_manpuz.cpp_FUN_0050a420()
    ...
    FNSTSW AX                           ; 0050a75f
    SAHF                                ; 0050a761
    JBE 0x0050a803                      ; 0050a762 | LAB_0050a803
    ...
    FNSTSW AX                           ; 0050a78d
    SAHF                                ; 0050a78f
    JBE 0x0050a82b                      ; 0050a790 | LAB_0050a82b
    ...
    AND EDX,EAX                         ; 0050a7a0
        ;   Label: LAB_0050a7a0
    JZ 0x0050a7e3                       ; 0050a7a2 | LAB_0050a7e3
        ;   XREF to: 0050a7e3 (CONDITIONAL_JUMP)
    TEST EBP,EBP                        ; 0050a7a4
    JZ 0x0050a7e3                       ; 0050a7a6 | LAB_0050a7e3
        ;   XREF to: 0050a7e3 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0050a859
    SAHF                                ; 0050a85b
    JNZ 0x0050a7e3                      ; 0050a85c | LAB_0050a7e3
        ;   XREF to: 0050a7e3 (CONDITIONAL_JUMP)
    FILD dword ptr [EDX + 0x54]         ; 0050a85e
    FCOMP float ptr [EBX + 0x14]        ; 0050a861
    FNSTSW AX                           ; 0050a864
    SAHF                                ; 0050a866
    JNZ 0x0050a7e3                      ; 0050a867 | LAB_0050a7e3
        ;   XREF to: 0050a7e3 (CONDITIONAL_JUMP)
    PUSH EDI                            ; 0050a86d
    PUSH ESI                            ; 0050a86e
    CALL core_manpuz.cpp_FUN_0050aef0   ; 0050a86f | undefined core_manpuz.cpp_FUN_0050aef0()
        ;   XREF to: 0050aef0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0050a874
    PUSH EAX                            ; 0050a877
    PUSH ESI                            ; 0050a878
    CALL core_manpuz.cpp_CMansionPuzzleCircle_panelOccupied_FUN_0050b040 ; 0050a879 | undefined core_manpuz.cpp_CMansionPuzzleCircle_panelOccupied_FUN_0050b040()
        ;   XREF to: 0050b040 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0050a87e
    TEST EAX,EAX                        ; 0050a881
    JZ 0x0050a8b3                       ; 0050a883 | LAB_0050a8b3
        ;   XREF to: 0050a8b3 (CONDITIONAL_JUMP)
    PUSH EDI                            ; 0050a885
    PUSH ESI                            ; 0050a886
    CALL core_manpuz.cpp_FUN_0050aee0   ; 0050a887 | undefined core_manpuz.cpp_FUN_0050aee0()
        ;   XREF to: 0050aee0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0050a88c
    PUSH EAX                            ; 0050a88f
    PUSH ESI                            ; 0050a890
    CALL core_manpuz.cpp_CMansionPuzzleCircle_panelOccupied_FUN_0050b040 ; 0050a891 | undefined core_manpuz.cpp_CMansionPuzzleCircle_panelOccupied_FUN_0050b040()
        ;   XREF to: 0050b040 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0050a896
    TEST EAX,EAX                        ; 0050a899
    JNZ 0x0050a7e3                      ; 0050a89b | LAB_0050a7e3
        ;   XREF to: 0050a7e3 (CONDITIONAL_JUMP)
    PUSH EDI                            ; 0050a8a1
    PUSH ESI                            ; 0050a8a2
    CALL core_manpuz.cpp_CMansionPuzzleCircle_shiftPanelRight_FUN_0050ad40 ; 0050a8a3 | undefined core_manpuz.cpp_CMansionPuzzleCircle_shiftPanelRight_FUN_0050ad40()
    ...
    PUSH EDI                            ; 0050a8b3
        ;   Label: LAB_0050a8b3
    PUSH ESI                            ; 0050a8b4
    CALL core_manpuz.cpp_CMansionPuzzleCircle_shiftPanelLeft_FUN_0050aba0 ; 0050a8b5 | undefined core_manpuz.cpp_CMansionPuzzleCircle_shiftPanelLeft_FUN_0050aba0()
