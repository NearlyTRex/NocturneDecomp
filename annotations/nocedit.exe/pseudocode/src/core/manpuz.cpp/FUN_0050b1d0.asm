...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_manpuz.cpp_FUN_0050b1d0()
;
; Local Variables:
...
section .text
    ...
    FMUL double ptr [0x00635925]        ; 0050b1e0 | double DOUBLE_00635925
    FDIV double ptr [0x0063592d]        ; 0050b1e6 | double DOUBLE_0063592d
    PUSH 0x38                           ; 0050b1ec
    MOV EAX,[0x0067cf44]                ; 0050b1ee | CKeys * g_CKeysPtr
    PUSH EAX                            ; 0050b1f3 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 0050b1f4 | void * g_CKeysPtr
    FSTP float ptr [ESP + 0x8]          ; 0050b1f6
    CALL dword ptr [EDX]                ; 0050b1fa
    ADD ESP,0x8                         ; 0050b1fc
    TEST EAX,EAX                        ; 0050b1ff
    JZ 0x0050b20f                       ; 0050b201 | LAB_0050b20f
        ;   XREF to: 0050b20f (CONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 0050b203
    FMUL double ptr [0x00635935]        ; 0050b206 | double DOUBLE_00635935
    FSTP float ptr [ESP]                ; 0050b20c
    PUSH 0x33                           ; 0050b20f
        ;   Label: LAB_0050b20f
    MOV EAX,[0x0067cf44]                ; 0050b211 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 0050b216 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 0050b217 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 0050b219
    ADD ESP,0x8                         ; 0050b21b
    TEST EAX,EAX                        ; 0050b21e
    JZ 0x0050b22b                       ; 0050b220 | LAB_0050b22b
    ...
    PUSH 0x34                           ; 0050b22b
        ;   Label: LAB_0050b22b
    MOV EAX,[0x0067cf44]                ; 0050b22d | CKeys * g_CKeysPtr
    PUSH EAX                            ; 0050b232 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 0050b233 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 0050b235
    ADD ESP,0x8                         ; 0050b237
    TEST EAX,EAX                        ; 0050b23a
    JZ 0x0050b247                       ; 0050b23c | LAB_0050b247
    ...
    PUSH EBX                            ; 0050b247
        ;   Label: LAB_0050b247
    CALL core_actor.cpp_CDemonActor_updateOrientationMatrix_FUN_00408c10 ; 0050b248 | void core_actor.cpp_CDemonActor_updateOrientationMatrix_FUN_00408c10(CDemonActor * this_ptr)
