...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_manpuz_cpp_CMansionPuzzleCircle_FUN_00509d50(CMansionPuzzleCircle *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00509d50
        ;   Label: core_manpuz.cpp_CMansionPuzzleCircle_FUN_00509d50
    PUSH ESI                            ; 00509d51
    PUSH EDI                            ; 00509d52
    PUSH EBP                            ; 00509d53
