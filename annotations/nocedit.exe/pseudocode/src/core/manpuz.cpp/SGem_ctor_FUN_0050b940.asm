...
;                               FUNCTION
; *****************************************************************************
; __cdecl SGem * __cdecl core_manpuz_cpp_SGem_ctor_FUN_0050b940(SGem *this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EAX,dword ptr [ESP + 0x4]       ; 0050b940
        ;   Label: core_manpuz.cpp_SGem_ctor_FUN_0050b940
    PUSH 0x65c990                       ; 0050b944 | g_CDemonTriangleTypeInfo
    PUSH 0x2                            ; 0050b949
    ADD EAX,0x3c                        ; 0050b94b
    PUSH EAX                            ; 0050b94e
    CALL crt_memory.c___arrinit_FUN_005fe667 ; 0050b94f
