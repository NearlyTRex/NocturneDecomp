...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_manpuz_cpp_CMansionPuzzleCircle_FUN_00509c60(CMansionPuzzleCircle *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00509c60
        ;   Label: core_manpuz.cpp_CMansionPuzzleCircle_FUN_00509c60
    PUSH EDI                            ; 00509c61
    PUSH EBP                            ; 00509c62
