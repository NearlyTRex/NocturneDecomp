...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_manpuz_cpp_CMansionPuzzleCircle_FUN_00509bf0(CMansionPuzzleCircle *this_ptr)
;
; Parameters:
; CMansionPuzzleCircle * Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_manpuz.cpp_CMansionPuzzleCircle_renderOpaque_FUN_005090d0 at 0050915d
;
; Referenced Globals:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x8]       ; 00509bf0
        ;   Label: core_manpuz.cpp_CMansionPuzzleCircle_FUN_00509bf0
    ...
    PUSH EAX                            ; 00509c1e
    MOV ECX,dword ptr [0x006703ec]      ; 00509c1f | g_CDemonRendererPtr2
    ...
    MOV EBX,dword ptr [0x006703ec]      ; 00509c44 | g_CDemonRendererPtr2
