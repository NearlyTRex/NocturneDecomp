...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_manpuz_cpp_CMansionPuzzleCircle_FUN_00509b20(CMansionPuzzleCircle *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00509b20
        ;   Label: core_manpuz.cpp_CMansionPuzzleCircle_FUN_00509b20
    PUSH ESI                            ; 00509b21
    PUSH EDI                            ; 00509b22
