...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_hero_cpp_CHero_addFilesToExtract_FUN_004f3fa0(CHero *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004f3fa0
        ;   Label: core_hero.cpp_CHero_addFilesToExtract_FUN_004f3fa0
    ...
    PUSH EAX                            ; 004f3fda
    CALL core_skeledit.cpp_CDeformableModel_FUN_0058a2b0 ; 004f3fdb
