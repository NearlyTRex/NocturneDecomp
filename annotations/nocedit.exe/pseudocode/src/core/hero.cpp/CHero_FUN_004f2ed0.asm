...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_hero_cpp_CHero_FUN_004f2ed0(CHero *this_ptr)
;
; Parameters:
; CHero *          Stack[0x4]:4   this_ptr
;
; XREF[8]:
;   core_colonel.cpp_CColonel_FUN_0043fa00 at 0043fe0a
...
section .text
    ...
    PUSH EBX                            ; 004f2ed0
        ;   Label: core_hero.cpp_CHero_FUN_004f2ed0
    PUSH ESI                            ; 004f2ed1
    PUSH EBP                            ; 004f2ed2
