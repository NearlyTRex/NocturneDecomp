...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_hero.cpp_FUN_004f3120()
;
; Local Variables:
; undefined1       Stack[-0x80]:1  local_80
;
; XREF[2]:
;   core_gabriela.cpp_FUN_004d2ea0 at 004d4027
...
section .text
    ...
    JZ 0x004f31b0                       ; 004f3169 | LAB_004f31b0
        ;   XREF to: 004f31b0 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x008229e8]      ; 004f316b | g_CBoxActorClassInfo.name_hash
    PUSH ECX                            ; 004f3171
    PUSH EDX                            ; 004f3172
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 004f3173 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 004f3178
    ADD ESP,0x8                         ; 004f317a
    TEST EAX,EAX                        ; 004f317d
    JZ 0x004f31a4                       ; 004f317f | LAB_004f31a4
        ;   XREF to: 004f31a4 (CONDITIONAL_JUMP)
    ...
    XOR EAX,EAX                         ; 004f31b0
        ;   Label: LAB_004f31b0
    JMP 0x004f31a9                      ; 004f31b2 | LAB_004f31a9
        ;   XREF to: 004f31a9 (UNCONDITIONAL_JUMP)
    INC EDI                             ; 004f31b4
        ;   Label: LAB_004f31b4
    ADD ESI,0x4                         ; 004f31b5
    JMP 0x004f3150                      ; 004f31b8 | LAB_004f3150
    ...
    PUSH ECX                            ; 004f31c8
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 004f31c9 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 004f31ce
    ADD ESP,0x8                         ; 004f31d0
    TEST EAX,EAX                        ; 004f31d3
    JZ 0x004f31b4                       ; 004f31d5 | LAB_004f31b4
        ;   XREF to: 004f31b4 (CONDITIONAL_JUMP)
    CMP dword ptr [EAX + 0x31c],0x0     ; 004f31d7
    JZ 0x004f31b4                       ; 004f31de | LAB_004f31b4
        ;   XREF to: 004f31b4 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x320],0x0     ; 004f31e0
    JNZ 0x004f31b4                      ; 004f31e7 | LAB_004f31b4
        ;   XREF to: 004f31b4 (CONDITIONAL_JUMP)
    ...
    FMUL float ptr [0x0062ec56]         ; 004f3213 | float FLOAT_0062ec56
    FXCH                                ; 004f3219
    FST float ptr [ESP + 0x24]          ; 004f321b
    FMUL float ptr [0x0062ec56]         ; 004f321f | float FLOAT_0062ec56
    ...
    PUSH EAX                            ; 004f323a
    FMUL float ptr [0x0062ec56]         ; 004f323b | float FLOAT_0062ec56
    PUSH EBX                            ; 004f3241
    FXCH ST2                            ; 004f3242
    FSTP float ptr [ESP + 0x44]         ; 004f3244
    FSTP float ptr [ESP + 0x48]         ; 004f3248
    FSTP float ptr [ESP + 0x4c]         ; 004f324c
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 004f3250 | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
    ...
    PUSH ECX                            ; 004f3265
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 004f3266 | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
    ...
    FMUL float ptr [0x0062ec56]         ; 004f3286 | float FLOAT_0062ec56
    FXCH                                ; 004f328c
    FST float ptr [ESP + 0x70]          ; 004f328e
    FMUL float ptr [0x0062ec56]         ; 004f3292 | float FLOAT_0062ec56
    FXCH                                ; 004f3298
    ...
    FCOMP double ptr [0x0062ec5e]       ; 004f32ca | double DOUBLE_0062ec5e
    FNSTSW AX                           ; 004f32d0
    SAHF                                ; 004f32d2
    JA 0x004f31b4                       ; 004f32d3 | LAB_004f31b4
        ;   XREF to: 004f31b4 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 004f32e7
    SAHF                                ; 004f32e9
    JA 0x004f31b4                       ; 004f32ea | LAB_004f31b4
        ;   XREF to: 004f31b4 (CONDITIONAL_JUMP)
    FLD double ptr [ESP]                ; 004f32f0
    FCOMP double ptr [0x0062ec66]       ; 004f32f3 | double DOUBLE_0062ec66
    FNSTSW AX                           ; 004f32f9
    SAHF                                ; 004f32fb
    JA 0x004f31b4                       ; 004f32fc | LAB_004f31b4
        ;   XREF to: 004f31b4 (CONDITIONAL_JUMP)
    LEA EAX,[ESP + 0x50]                ; 004f3302
    PUSH EAX                            ; 004f3306
    LEA EAX,[ESP + 0x60]                ; 004f3307
    PUSH EAX                            ; 004f330b
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 004f330c | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004f3311
    PUSH dword ptr [EAX + 0x4]          ; 004f3314
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 004f3317 | float core_actor.cpp_normalizeAngleToPi_FUN_0040cd70(float angle_radians)
        ;   XREF to: 0040cd70 (UNCONDITIONAL_CALL)
    MOV dword ptr [ESP + 0x78],EAX      ; 004f331c
    FLD float ptr [ESP + 0x78]          ; 004f3320
    FABS                                ; 004f3324
    ADD ESP,0x4                         ; 004f3326
    FCOMP double ptr [0x0062ec6e]       ; 004f3329 | double DOUBLE_0062ec6e
    FNSTSW AX                           ; 004f332f
    SAHF                                ; 004f3331
    JA 0x004f31b4                       ; 004f3332 | LAB_004f31b4
        ;   XREF to: 004f31b4 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + 0x14]      ; 004f3338
    MOV dword ptr [EAX + 0x1fba4],EBX   ; 004f333b
    JMP 0x004f315e                      ; 004f3341 | LAB_004f315e
