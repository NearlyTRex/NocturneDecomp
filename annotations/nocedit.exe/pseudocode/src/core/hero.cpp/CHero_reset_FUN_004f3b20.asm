...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_hero_cpp_CHero_reset_FUN_004f3b20(CHero *this_ptr)
;
; Parameters:
; CHero *          Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_stranger.cpp_CStranger_reset_FUN_005c6750 at 005c675c
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 004f3b20
        ;   Label: core_hero.cpp_CHero_reset_FUN_004f3b20
