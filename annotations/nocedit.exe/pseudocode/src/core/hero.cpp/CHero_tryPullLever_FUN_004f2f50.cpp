// Name: core_hero.cpp_CHero_tryPullLever_FUN_004f2f50
// Address: 004f2f50
// Address Range: [[004f2f50, 004f30eb]]
// Convention: __cdecl
// Signature: int __cdecl core_hero_cpp_CHero_tryPullLever_FUN_004f2f50(CHero *this_ptr)
...

{
    ...
    if (this_ptr_00 != (CLever *)0x0) {
      ...
      if ((((ABS(local_3c.y) <= (float)5) && (0.0 <= (double)local_3c.z)) &&
        ...
        if (ABS(pCVar1->y) <= (float)1.04719755116667) {
          iVar2 = core_lever_cpp_CLever_isAccessibleFrom_FUN_00505080(this_ptr_00,local_1c);
          if (iVar2 != 0) {
  ...
  if (this_ptr->lever_to_pull != (CLever *)0x0) {
    iVar3 = core_event_cpp_CRuleList_evaluateAndRun_FUN_004b18e0(&this_ptr->lever_to_pull->rule);
    if (iVar3 == 0) {
