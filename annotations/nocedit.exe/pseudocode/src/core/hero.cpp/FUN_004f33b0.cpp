...
// Convention: __cdecl
// Signature: int __cdecl core_hero_cpp_FUN_004f33b0(void)
...

{
  ...
  if (iVar3 == 0) {
    ...
    input_world_point = &(in_stack_00000004->base).location;
    local_1c = 0;
    for (local_20 = 0; local_20 < (int)g_CDemonSetPtr->actor_list_ptr; local_20 = local_20 + 1) {
      ...
      local_60.x = (this_ptr->base).location.position.x - (input_world_point->position).x;
      local_60.z = (this_ptr->base).location.position.z -
                   (in_stack_00000004->base).location.position.z;
      if (((ABS((this_ptr->base).location.position.y - (in_stack_00000004->base).location.position.y
               ) <= (float)10) &&
          (local_60.y = 0.0,
        ...
        local_14 = core_actor_cpp_normalizeAngleToPi_FUN_0040cd70
                             (pCVar4->y - (in_stack_00000004->base).orient.bank);
        if ((((ABS(local_14) <= (float)1.04719755116667) &&
             (pCVar4 = core_actor_cpp_CDemonActor_worldToLocalPoint_FUN_00408f10
                                 (&this_ptr->base,(CVector3f *)(auStack_40 + 4),
                                  &input_world_point->position), pCVar4->z <= 0.0)) &&
            (((*((this_ptr->base).vtable._ub)->getInteractionInfo)
                        (&this_ptr->base,(SInteractionInfo *)&stack0xffffff80), fStack_78 != 0.0 &&
             ((fStack_74 == 0.0 &&
              (core_actor_cpp_CDemonActor_localToWorldPoint_FUN_00408ec0
                         (&this_ptr->base,&CStack_4c,(CVector3f *)auStack_40),
              fVar1 = CStack_4c.x - (input_world_point->position).x,
              fVar2 = CStack_4c.z - (in_stack_00000004->base).location.position.z,
              SQRT(fVar2 * fVar2 + fVar1 * fVar1) <= (float)5)))))) &&
           (iVar3 = (*((this_ptr->base).vtable._ub)->startInteraction)
                              (&this_ptr->base,&in_stack_00000004->base), iVar3 != 0)) {
