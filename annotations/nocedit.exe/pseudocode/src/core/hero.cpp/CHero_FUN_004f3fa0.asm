...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_hero.cpp_CHero_FUN_004f3fa0(CHero * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004f3fab
    CALL core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0 ; 004f3fac | CDeformableModel * core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0(CDeformableModelInstance * this_ptr)
        ;   XREF to: 005a07a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004f3fb1
    ADD EAX,0x8fb0                      ; 004f3fb4
    PUSH EAX                            ; 004f3fb9
    PUSH 0x62edc4                       ; 004f3fba | = "MODELS\\%s\n" | s_MODELS_s_0062edc4 = MODELS\%s

    MOV EDX,dword ptr [ESP + 0x14]      ; 004f3fbf
    PUSH EDX                            ; 004f3fc3
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 004f3fc4 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004f3fc9
    MOV ECX,dword ptr [ESP + 0xc]       ; 004f3fcc
    PUSH ECX                            ; 004f3fd0
    PUSH EBX                            ; 004f3fd1
    CALL core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0 ; 004f3fd2 | CDeformableModel * core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0(CDeformableModelInstance * this_ptr)
        ;   XREF to: 005a07a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004f3fd7
    PUSH EAX                            ; 004f3fda
    CALL core_skeledit.cpp_FUN_0058a2b0 ; 004f3fdb | undefined core_skeledit.cpp_FUN_0058a2b0()
