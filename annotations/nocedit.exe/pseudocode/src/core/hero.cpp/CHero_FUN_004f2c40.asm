...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_hero_cpp_CHero_FUN_004f2c40(CHero *this_ptr)
;
; Parameters:
...
;
; XREF[6]:
;   core_colonel.cpp_CColonel_FUN_0043fa00 at 0043fde7
...
section .text
    ...
    MOV EBX,dword ptr [EAX + 0x14f09c]  ; 004f2c91 | g_CDemonSetInstance.damage_listeners | DAT_03263318
