...
section .text
    ...
    PUSH EDX                            ; 004f3ef4
    CALL core_actor.cpp_CDemonActor_serialize_FUN_0040c1c0 ; 004f3ef5 | void core_actor.cpp_CDemonActor_serialize_FUN_0040c1c0(CDemonActor * this_ptr)
        ;   XREF to: 0040c1c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004f3efa
    MOV EAX,dword ptr [ESP + 0x4]       ; 004f3efd
    PUSH 0x62edb2                       ; 004f3f01 | = "index" | s_index_0062edb2 = index
    ADD EAX,0x158                       ; 004f3f06
    PUSH EAX                            ; 004f3f0b
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 004f3f0c | void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
