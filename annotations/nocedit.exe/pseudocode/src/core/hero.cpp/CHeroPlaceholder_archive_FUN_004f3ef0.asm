...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x4]       ; 004f3ef0
        ;   Label: core_hero.cpp_CHeroPlaceholder_archive_FUN_004f3ef0
    PUSH EDX                            ; 004f3ef4
    CALL core_actor.cpp_CDemonActor_archive_FUN_0040c1c0 ; 004f3ef5
    ...
    PUSH EAX                            ; 004f3f0b
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 004f3f0c
