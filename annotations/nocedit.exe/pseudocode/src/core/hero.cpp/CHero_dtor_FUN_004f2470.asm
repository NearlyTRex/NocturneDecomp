...
;                               FUNCTION
; *****************************************************************************
; __cdecl CHero * __cdecl core_hero_cpp_CHero_dtor_FUN_004f2470(CHero *this_ptr,uint flags)
;
; Parameters:
...
section .text
    ...
    CALL core_inv.cpp_CInventory_dtor_FUN_004fd0c0 ; 004f249e
        ;   XREF to: 004fd0c0 (UNCONDITIONAL_CALL)  ; CInventory * core_inv.cpp_CInventory_dtor_FUN_004fd0c0(CInventory * this_ptr, uint flags)
    ...
    PUSH EAX                            ; 004f24bd
    CALL core_armour.cpp_CFlame_arrdtor_FUN_00412720 ; 004f24be
    ...
    PUSH EAX                            ; 004f24cd
    CALL core_armour.cpp_SFire_arrdtor_FUN_00412700 ; 004f24ce
    ...
    PUSH EAX                            ; 004f24dd
    CALL core_armour.cpp_CVector3f_arrdtor_FUN_004126e0 ; 004f24de
    ...
    PUSH EAX                            ; 004f24ed
    CALL core_armour.cpp_CVector3f_arrdtor_FUN_004126e0 ; 004f24ee
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; CVector3f * core_armour.cpp_CVector3f_arrdtor_FUN_004126e0(CVector3f * objs, uint flags)
