...
;   core_icepick.cpp_FUN_004f97e0 at 004f97ef
...
section .text
    ...
    MOV dword ptr [EDX + 0x154],0x65f6d4 ; 004f2475 | CDemonActor_vtable g_CHeroVTable
    XOR EAX,EAX                         ; 004f247f
    CMP EDX,dword ptr [EAX + 0x2db87c0] ; 004f2481 | CHero *[4] g_HeroActors
        ;   Label: LAB_004f2481
    JZ 0x004f2529                       ; 004f2487 | LAB_004f2529
        ;   XREF to: 004f2529 (CONDITIONAL_JUMP)
    ADD EAX,0x4                         ; 004f248d
        ;   Label: LAB_004f248d
    CMP EAX,0x10                        ; 004f2490
    JNZ 0x004f2481                      ; 004f2493 | LAB_004f2481
        ;   XREF to: 004f2481 (CONDITIONAL_JUMP)
    PUSH 0x0                            ; 004f2495
    ADD EDX,0x1f738                     ; 004f2497
    PUSH EDX                            ; 004f249d
    CALL core_inv.cpp_CInventory_dtor_FUN_004fd0c0 ; 004f249e | int core_inv.cpp_CInventory_dtor_FUN_004fd0c0(CInventory * this_ptr)
        ;   XREF to: 004fd0c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004f24a3
    PUSH 0x0                            ; 004f24a6
    SUB EAX,0x138e0                     ; 004f24a8
    PUSH EAX                            ; 004f24ad
    CALL core_path.cpp_CPathMap_dtor_FUN_005464d0 ; 004f24ae | CPathMap * core_path.cpp_CPathMap_dtor_FUN_005464d0(CPathMap * this_ptr)
        ;   XREF to: 005464d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004f24b3
    PUSH 0x0                            ; 004f24b6
    SUB EAX,0x8a8c                      ; 004f24b8
    PUSH EAX                            ; 004f24bd
    CALL core_backgnd.cpp_freeFlames_FUN_00412720 ; 004f24be | int core_backgnd.cpp_freeFlames_FUN_00412720(CFlame * * array)
        ;   XREF to: 00412720 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004f24c3
    PUSH 0x0                            ; 004f24c6
    SUB EAX,0x4b0                       ; 004f24c8
    PUSH EAX                            ; 004f24cd
    CALL core_backgnd.cpp_freeFires_FUN_00412700 ; 004f24ce | int core_backgnd.cpp_freeFires_FUN_00412700(SFire * * objs)
        ;   XREF to: 00412700 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004f24d3
    PUSH 0x0                            ; 004f24d6
    SUB EAX,0x20c                       ; 004f24d8
    PUSH EAX                            ; 004f24dd
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 004f24de | int core_backgnd.cpp_cleanupVector_FUN_004126e0(CVector3f * * objs)
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004f24e3
    PUSH 0x0                            ; 004f24e6
    SUB EAX,0xb4                        ; 004f24e8
    PUSH EAX                            ; 004f24ed
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 004f24ee | int core_backgnd.cpp_cleanupVector_FUN_004126e0(CVector3f * * objs)
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004f24f3
    PUSH 0x0                            ; 004f24f6
    SUB EAX,0x1c8                       ; 004f24f8
    PUSH EAX                            ; 004f24fd
    CALL core_cloth.cpp_FUN_0043bf80    ; 004f24fe | undefined core_cloth.cpp_FUN_0043bf80()
        ;   XREF to: 0043bf80 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004f2503
    PUSH 0x0                            ; 004f2506
    SUB EAX,0x293c                      ; 004f2508
    PUSH EAX                            ; 004f250d
    CALL core_skeleton.cpp_CDeformableModelInstance_dtor_FUN_0059de40 ; 004f250e | CDeformableModelInstance * core_skeleton.cpp_CDeformableModelInstance_dtor_FUN_0059de40(CDeformableModelInstance * this_ptr, uint d1, uint d2, uint d3, ...)
        ;   XREF to: 0059de40 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004f2513
    PUSH 0x1                            ; 004f2516
    LEA EDX,[EAX + 0xfffffea8]          ; 004f2518
    PUSH EDX                            ; 004f251e
    CALL core_actor.cpp_CDemonActor_dtor_FUN_00408a30 ; 004f251f | CDemonActor * core_actor.cpp_CDemonActor_dtor_FUN_00408a30(CDemonActor * this_ptr, uint d1)
    ...
    JMP 0x004f248d                      ; 004f2531 | LAB_004f248d
