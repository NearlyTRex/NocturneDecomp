...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_hero_cpp_CHero_FUN_004f3760(CHero *this_ptr)
;
; Parameters:
...
;   core_hero.cpp_CHero_FUN_004f35b0
...
section .text
    ...
    PUSH EBX                            ; 004f3760
        ;   Label: core_hero.cpp_CHero_FUN_004f3760
    PUSH ESI                            ; 004f3761
    PUSH EBP                            ; 004f3762
    ...
    PUSH ESI                            ; 004f37bc
        ;   Label: LAB_004f37bc
    CALL core_hero.cpp_CHero_FUN_004f35b0 ; 004f37bd
        ;   XREF to: 004f35b0 (UNCONDITIONAL_CALL)  ; int core_hero.cpp_CHero_FUN_004f35b0(CHero * this_ptr)
