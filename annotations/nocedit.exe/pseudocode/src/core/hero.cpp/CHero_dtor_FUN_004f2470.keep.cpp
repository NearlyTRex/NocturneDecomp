...

{
  ...
  pSVar2 = (CHero_ptr_12060)core_armour_cpp_SFire_arrdtor_FUN_00412700(ADJ(pCVar4)->base.fires,0);
  pCVar5 = (CHero_ptr_11536)
           core_armour_cpp_CVector3f_arrdtor_FUN_004126e0(ADJ(pSVar2)->base.collision_test_normals,0)
  ;
  pCVar6 = (CHero_ptr_11356)
           core_armour_cpp_CVector3f_arrdtor_FUN_004126e0(ADJ(pCVar5)->base.collision_test_points,0);
