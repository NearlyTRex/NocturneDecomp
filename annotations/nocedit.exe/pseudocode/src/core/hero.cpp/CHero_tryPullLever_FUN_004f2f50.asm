...
;                               FUNCTION
; *****************************************************************************
; int __cdecl core_hero_cpp_CHero_tryPullLever_FUN_004f2f50(CHero *this_ptr)
;
; Parameters:
...
;   core_stranger.cpp_CStranger_handleActionButton_FUN_005c5b90 at 005c5de2
...
;   core_lever.cpp_CLever_isAccessibleFrom_FUN_00505080
...
section .text
    ...
    PUSH EBX                            ; 004f2f50
        ;   Label: core_hero.cpp_CHero_tryPullLever_FUN_004f2f50
    PUSH ESI                            ; 004f2f51
    PUSH EDI                            ; 004f2f52
    PUSH EBP                            ; 004f2f53
    ...
    PUSH EAX                            ; 004f3036
    CALL core_vecdir.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 004f3037
    ...
    PUSH EDX                            ; 004f3053
    PUSH EBX                            ; 004f3054
    CALL core_lever.cpp_CLever_isAccessibleFrom_FUN_00505080 ; 004f3055
        ;   XREF to: 00505080 (UNCONDITIONAL_CALL)  ; int core_lever.cpp_CLever_isAccessibleFrom_FUN_00505080(CLever * this_ptr, CVector3f * world_position)
