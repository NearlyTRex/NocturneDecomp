...
;   core_stranger.cpp_CStranger_handleActionButton_FUN_005c5b90 at 005c5bff
...
section .text
    ...
    PUSH EBX                            ; 004f2d70
        ;   Label: core_hero.cpp_CHero_tryOpenNearbyDoor_FUN_004f2d70
    PUSH ESI                            ; 004f2d71
    PUSH EDI                            ; 004f2d72
    PUSH EBP                            ; 004f2d73
    ...
    MOV EAX,[0x006810c8]                ; 004f2d92 | g_CDemonSetPtr
        ;   Label: LAB_004f2d92
    CMP ESI,dword ptr [EAX + 0x14d154]  ; 004f2d97 | g_CDemonSetInstance.actor_count
    ...
    PUSH EBX                            ; 004f2dc2
    MOV ECX,dword ptr [EAX + 0x14d158]  ; 004f2dc3 | g_CDemonSetInstance.actors[0]
    PUSH ECX                            ; 004f2dc9
    ...
    CALL core_door.cpp_CDoor_getMoveType_FUN_00481070 ; 004f2e80
        ;   XREF to: 00481070 (UNCONDITIONAL_CALL)  ; int core_door.cpp_CDoor_getMoveType_FUN_00481070(CDoor * this_ptr, CDemonActor * opener)
