...
section .text
    ...
    CALL core_actor.cpp_CDemonActor_testPointInCylinder_FUN_004090c0 ; 004f25ac
        ;   XREF to: 004090c0 (UNCONDITIONAL_CALL)  ; int core_actor.cpp_CDemonActor_testPointInCylinder_FUN_004090c0(CDemonActor * this_ptr, SCollisionReturnInfo * collision_result, float tolerance_radius)
