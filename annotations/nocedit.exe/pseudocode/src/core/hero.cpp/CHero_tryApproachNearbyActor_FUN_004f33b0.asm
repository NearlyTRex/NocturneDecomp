...
section .text
    ...
    PUSH EBX                            ; 004f33b0
        ;   Label: core_hero.cpp_CHero_tryApproachNearbyActor_FUN_004f33b0
    PUSH ESI                            ; 004f33b1
    PUSH EDI                            ; 004f33b2
    PUSH EBP                            ; 004f33b3
    ...
    MOV EBX,dword ptr [EAX + 0x14d158]  ; 004f33fd | g_CDemonSetInstance.actors[0] | g_CDemonSetInstance.actors[1]
    ...
    PUSH EAX                            ; 004f3487
    CALL core_vecdir.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 004f3488
