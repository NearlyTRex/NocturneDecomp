...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_hero_cpp_CHero_canBeGrabbed_FUN_004f2890(CHero *this_ptr,CDemonActor *grabber,int grab_type)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0xc]       ; 004f2890
        ;   Label: core_hero.cpp_CHero_canBeGrabbed_FUN_004f2890
    TEST EDX,EDX                        ; 004f2894
    JZ 0x004f28a6                       ; 004f2896
        ;   XREF to: 004f28a6 (CONDITIONAL_JUMP)  ; LAB_004f28a6
    LEA EAX,[EAX]                       ; 004f2898
    MOV EDX,EDX                         ; 004f289e
    PUSH EDX                            ; 004f28a6
        ;   Label: LAB_004f28a6
    MOV EAX,dword ptr [ESP + 0x8]       ; 004f28a7
    PUSH 0x62eb75                       ; 004f28ab | = "GETGRABBED"
    ADD EAX,0x158                       ; 004f28b0
    PUSH EAX                            ; 004f28b5
    CALL core_motion.cpp_CMotionController_getMotionList_FUN_0052dce0 ; 004f28b6
    ...
    PUSH EAX                            ; 004f28be
    CALL core_motion.cpp_CMotionList_findStateIndex_FUN_0052d4f0 ; 004f28bf
