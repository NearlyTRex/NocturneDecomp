...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_hero.cpp_FUN_004f35b0()
;
; Local Variables:
...
;
; XREF[1]:
;   core_hero.cpp_CallInventorySelectHealth_FUN_004f3760 at 004f37bd
;
; Referenced Globals:
...
section .text
    ...
    MOV EAX,[0x006810c8]                ; 004f35d6 | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
        ;   Label: LAB_004f35d6
    MOV EBX,dword ptr [EBP + -0x8]      ; 004f35db
    CMP EBX,dword ptr [EAX + 0x14d154]  ; 004f35de | g_CDemonSetInstance.actor_list_ptr
    JL 0x004f3625                       ; 004f35e4 | LAB_004f3625
        ;   XREF to: 004f3625 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + -0x10]     ; 004f35e6
    PUSH 0x62ec8e                       ; 004f35e9 | = "CTrap" | s_CTrap_0062ec8e = CTrap
    MOV EAX,dword ptr [EAX + 0x334]     ; 004f35ee
    PUSH EAX                            ; 004f35f4
    CALL core_actor.cpp_isOfClass_FUN_0040c6d0 ; 004f35f5 | int core_actor.cpp_isOfClass_FUN_0040c6d0(CDemonActor * actor_ptr, char * class_name)
        ;   XREF to: 0040c6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004f35fa
    TEST EAX,EAX                        ; 004f35fd
    JZ 0x004f3610                       ; 004f35ff | LAB_004f3610
    ...
    JMP 0x004f35d6                      ; 004f3623 | LAB_004f35d6
    ...
    PUSH EDX                            ; 004f3633
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 004f3634 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 004f3639
    ADD ESP,0x8                         ; 004f363b
    MOV dword ptr [EBP + -0x4],EAX      ; 004f363e
    TEST EAX,EAX                        ; 004f3641
    JZ 0x004f3619                       ; 004f3643 | LAB_004f3619
        ;   XREF to: 004f3619 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + -0x10]     ; 004f3645
    MOV EAX,dword ptr [EAX + 0x334]     ; 004f3648
    PUSH EAX                            ; 004f364e
    PUSH EBX                            ; 004f364f
    CALL core_dest.cpp_FUN_0046fd50     ; 004f3650 | undefined core_dest.cpp_FUN_0046fd50()
        ;   XREF to: 0046fd50 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004f3655
    TEST EAX,EAX                        ; 004f3658
    JZ 0x004f3619                       ; 004f365a | LAB_004f3619
        ;   XREF to: 004f3619 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 004f3668
    PUSH ESI                            ; 004f3669
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 004f366a | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
    ...
    FNSTSW AX                           ; 004f367f
    SAHF                                ; 004f3681
    JA 0x004f3619                       ; 004f3682 | LAB_004f3619
        ;   XREF to: 004f3619 (CONDITIONAL_JUMP)
    FLD double ptr [EBP + -0x20]        ; 004f3684
    FCOMP double ptr [0x0062ec96]       ; 004f3687 | double DOUBLE_0062ec96
    FNSTSW AX                           ; 004f368d
    SAHF                                ; 004f368f
    JA 0x004f3619                       ; 004f3690 | LAB_004f3619
        ;   XREF to: 004f3619 (CONDITIONAL_JUMP)
    FLD float ptr [EBP + -0x24]         ; 004f3692
    FST double ptr [EBP + -0x18]        ; 004f3695
    FCOMP double ptr [0x0062ec9e]       ; 004f3698 | double DOUBLE_0062ec9e
    FNSTSW AX                           ; 004f369e
    SAHF                                ; 004f36a0
    JC 0x004f3619                       ; 004f36a1 | LAB_004f3619
        ;   XREF to: 004f3619 (CONDITIONAL_JUMP)
    FLD double ptr [EBP + -0x18]        ; 004f36a7
    FCOMP double ptr [0x0062eca6]       ; 004f36aa | double DOUBLE_0062eca6
    FNSTSW AX                           ; 004f36b0
    SAHF                                ; 004f36b2
    JA 0x004f3619                       ; 004f36b3 | LAB_004f3619
        ;   XREF to: 004f3619 (CONDITIONAL_JUMP)
    FLD float ptr [EBP + -0x2c]         ; 004f36b9
    FABS                                ; 004f36bc
    FCOMP double ptr [0x0062eca6]       ; 004f36be | double DOUBLE_0062eca6
    FNSTSW AX                           ; 004f36c4
    SAHF                                ; 004f36c6
    JA 0x004f3619                       ; 004f36c7 | LAB_004f3619
        ;   XREF to: 004f3619 (CONDITIONAL_JUMP)
    LEA EAX,[EBP + -0x2c]               ; 004f36cd
    PUSH EAX                            ; 004f36d0
    LEA EAX,[EBP + -0x38]               ; 004f36d1
    PUSH EAX                            ; 004f36d4
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 004f36d5 | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)
    FLD float ptr [EAX + 0x4]           ; 004f36da
    FABS                                ; 004f36dd
    ADD ESP,0x8                         ; 004f36df
    FCOMP double ptr [0x0062ecae]       ; 004f36e2 | double DOUBLE_0062ecae
    FNSTSW AX                           ; 004f36e8
    SAHF                                ; 004f36ea
    JA 0x004f3619                       ; 004f36eb | LAB_004f3619
        ;   XREF to: 004f3619 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0x158]     ; 004f36f1
    MOV dword ptr [ESI + 0x1fbb4],EAX   ; 004f36f7
    TEST EAX,EAX                        ; 004f36fd
    JZ 0x004f3619                       ; 004f36ff | LAB_004f3619
        ;   XREF to: 004f3619 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [EBP + -0xc]      ; 004f3705
    LEA EAX,[ESI + 0x1fbb8]             ; 004f3708
    CMP EAX,EDI                         ; 004f370e
    JNZ 0x004f373e                      ; 004f3710 | LAB_004f373e
    ...
    JZ 0x004f3732                       ; 004f3720 | LAB_004f3732
    ...
    JMP 0x004f3712                      ; 004f3750 | LAB_004f3712
