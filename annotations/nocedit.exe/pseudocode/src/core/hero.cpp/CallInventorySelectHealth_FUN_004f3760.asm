...
;
; XREF[1]:
;   core_stranger.cpp_CStranger_FUN_005bb960 at 005bd421
;
; Referenced Globals:
...
section .text
    ...
    JNZ 0x004f377c                      ; 004f3776 | LAB_004f377c
        ;   XREF to: 004f377c (CONDITIONAL_JUMP)
    POP EBP                             ; 004f3778
    POP ESI                             ; 004f3779
    POP EBX                             ; 004f377a
    RET                                 ; 004f377b
    PUSH 0x62ecb6                       ; 004f377c | = "CHealthItem" | s_CHealthItem_0062ecb6 = CHealthItem
        ;   Label: LAB_004f377c
    PUSH EAX                            ; 004f3781
    CALL core_actor.cpp_isOfClass_FUN_0040c6d0 ; 004f3782 | int core_actor.cpp_isOfClass_FUN_0040c6d0(CDemonActor * actor_ptr, char * class_name)
        ;   XREF to: 0040c6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004f3787
    TEST EAX,EAX                        ; 004f378a
    JNZ 0x004f37a8                      ; 004f378c | LAB_004f37a8
    ...
    JZ 0x004f37bc                       ; 004f37a0 | LAB_004f37bc
    ...
    PUSH EAX                            ; 004f37ae
    PUSH EBX                            ; 004f37af
    CALL core_inv.cpp_CInventory_select_FUN_004ff800 ; 004f37b0 | int core_inv.cpp_CInventory_select_FUN_004ff800(CInventory * this_ptr, CDemonActor * actor_ptr)
    ...
    PUSH ESI                            ; 004f37bc
        ;   Label: LAB_004f37bc
    CALL core_hero.cpp_FUN_004f35b0     ; 004f37bd | undefined core_hero.cpp_FUN_004f35b0()
        ;   XREF to: 004f35b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004f37c2
    TEST EAX,EAX                        ; 004f37c5
    JZ 0x004f37a8                       ; 004f37c7 | LAB_004f37a8
        ;   XREF to: 004f37a8 (CONDITIONAL_JUMP)
