...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_hero.cpp_CHero_FUN_004f25c0(CHero * this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EAX,[0x0067b654]                ; 004f25c5 | CGame g_CGameInstance | CGame * g_CGamePtr
    CMP dword ptr [EAX + 0x1d0],0x0     ; 004f25ca | DAT_02d81c6c
    JNZ 0x004f25df                      ; 004f25d1 | LAB_004f25df
        ;   XREF to: 004f25df (CONDITIONAL_JUMP)
    TEST dword ptr [EDX + 0xbe24],0x7fffffff ; 004f25d3
    JZ 0x004f25e3                       ; 004f25dd | LAB_004f25e3
    ...
    PUSH EBP                            ; 004f25f3
    PUSH EDX                            ; 004f25f4
    CALL core_actor.cpp_CDemonActor_testLineIntersection_FUN_00409150 ; 004f25f5 | int core_actor.cpp_CDemonActor_testLineIntersection_FUN_00409150(CDemonActor * this_ptr, CVector3f * line_start, CVector3f * line_end, CVector3f * out_intersection_point)
