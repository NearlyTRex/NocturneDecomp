...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_hero_cpp_CHero_writeDependencies_FUN_004f3fa0(CHero *this_ptr,_FILE *file_handle)
;
; Parameters:
...
;
; XREF[9]:
;   core_baron.cpp_CBaron_writeDependencies_FUN_00414070 at 0041407a
...
section .text
    ...
    PUSH EBX                            ; 004f3fa0
        ;   Label: core_hero.cpp_CHero_writeDependencies_FUN_004f3fa0
