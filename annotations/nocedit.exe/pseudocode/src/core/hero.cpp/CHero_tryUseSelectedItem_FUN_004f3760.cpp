// Name: core_hero.cpp_CHero_tryUseSelectedItem_FUN_004f3760
// Address: 004f3760
// Address Range: [[004f3760, 004f37ce]]
// Convention: __cdecl
// Signature: int __cdecl core_hero_cpp_CHero_tryUseSelectedItem_FUN_004f3760(CHero *this_ptr)
...

{
  ...
  if (iVar1 == 0) {
    ...
    iVar1 = core_hero_cpp_CHero_findItemUseTarget_FUN_004f35b0(this_ptr);
    if (iVar1 != 0) {
      return 0;
    }
  }
