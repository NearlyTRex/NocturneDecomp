...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_hero.cpp_CHero_FUN_004f3af0(CHero * this_ptr)
;
; Parameters:
...
section .text
    ...
    CALL core_charactr.cpp_CCharacter_FUN_00428e30 ; 004f3b0d
        ;   XREF to: 00428e30 (UNCONDITIONAL_CALL)  ; void core_charactr.cpp_CCharacter_FUN_00428e30(CCharacter * this_ptr)
