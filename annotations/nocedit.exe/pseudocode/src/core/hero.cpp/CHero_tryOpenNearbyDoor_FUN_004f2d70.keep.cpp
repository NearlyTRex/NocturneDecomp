// Name: core_hero.cpp_CHero_tryOpenNearbyDoor_FUN_004f2d70
// Address: 004f2d70
// MANUAL RECONSTRUCTION
// Address Range: [[004f2d70, 004f2ec0]]
// Convention: __cdecl
// Signature: int __cdecl core_hero_cpp_CHero_tryOpenNearbyDoor_FUN_004f2d70(CHero *this_ptr)
...

{
  ...
  do {
    if (g_CDemonSetPtr->actor_count <= iVar7) {
      return 0;
    }
    ...
    if ((this_ptr_00 != (CDoor *)0x0) && (this_ptr_00->door_state == DOOR_STATE_CLOSED)) {
      ...
      if ((0.0 < pCVar5->z) &&
        ...
        iVar6 = core_event_cpp_CRuleList_evaluateAndRun_FUN_004b18e0(&this_ptr_00->open_rule);
        if (iVar6 != 0) {
          return 1;
        }
