...
;                               FUNCTION
; *****************************************************************************
; __cdecl CHeroPlaceholder * core_hero.cpp_FUN_004f3c00(CHeroPlaceholder * this_ptr)
;
; Parameters:
; CHeroPlaceholder * Stack[0x4]:4   this_ptr
;
; XREF[2]:
;   core_hero.cpp_FUN_004f3bc0 at 004f3bdd
;   core_mission.cpp_FUN_00524c20 at 00524d0d
;
; Referenced Globals:
