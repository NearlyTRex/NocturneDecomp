...
; CActorDestination * Stack[-0x14]:4  local_14
;
; XREF[1]:
;   core_hero.cpp_CHero_tryUseSelectedItem_FUN_004f3760 at 004f37bd
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004f35b0
        ;   Label: core_hero.cpp_CHero_findItemUseTarget_FUN_004f35b0
    PUSH ESI                            ; 004f35b1
    PUSH EDI                            ; 004f35b2
    PUSH EBP                            ; 004f35b3
    ...
    PUSH EAX                            ; 004f364e
    PUSH EBX                            ; 004f364f
    CALL core_dest.cpp_CActorDestination_acceptsActor_FUN_0046fd50 ; 004f3650
    ...
    PUSH EAX                            ; 004f36d4
    CALL core_vecdir.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 004f36d5
