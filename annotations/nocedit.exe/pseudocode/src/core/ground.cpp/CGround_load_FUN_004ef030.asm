...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_ground.cpp_CGround_load_FUN_004ef030(CGround * this_ptr, char * filename)
;
; Parameters:
...
section .text
    ...
    MOV EDX,0x62e74c                    ; 004ef041 | = "data" | s_data_0062e74c = data
    MOV EBP,0x62e748                    ; 004ef046 | = "raw" | s_raw_0062e748 = raw
    MOV ESI,dword ptr [ESP + 0xd4]      ; 004ef04b
    MOV EDI,ESP                         ; 004ef052
    MOV ECX,0x62e745                    ; 004ef054 | = "rb" | s_rb_0062e745 = rb
    PUSH EDI                            ; 004ef059
    MOV AL,byte ptr [ESI]               ; 004ef05a
        ;   Label: LAB_004ef05a
    MOV byte ptr [EDI],AL               ; 004ef05c
    CMP AL,0x0                          ; 004ef05e
    JZ 0x004ef072                       ; 004ef060 | LAB_004ef072
    ...
    CMP AL,0x0                          ; 004ef06e
    JNZ 0x004ef05a                      ; 004ef070 | LAB_004ef05a
        ;   XREF to: 004ef05a (CONDITIONAL_JUMP)
    POP EDI                             ; 004ef072
        ;   Label: LAB_004ef072
    MOV ESI,ESP                         ; 004ef073
    MOV dword ptr [ESP + 0xa8],EDX      ; 004ef075 | = "data" | s_data_0062e74c = data
    MOV DL,0x2e                         ; 004ef07c | s_cpp_0062e72e
    MOV dword ptr [ESP + 0xac],ECX      ; 004ef07e | = "rb" | s_rb_0062e745 = rb
    MOV AL,byte ptr [ESI]               ; 004ef085
        ;   Label: LAB_004ef085
    CMP AL,DL                           ; 004ef087
    JZ 0x004ef09d                       ; 004ef089 | LAB_004ef09d
        ;   XREF to: 004ef09d (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 004ef08b
    JZ 0x004ef09b                       ; 004ef08d | LAB_004ef09b
        ;   XREF to: 004ef09b (CONDITIONAL_JUMP)
    INC ESI                             ; 004ef08f
    MOV AL,byte ptr [ESI]               ; 004ef090
    CMP AL,DL                           ; 004ef092
    JZ 0x004ef09d                       ; 004ef094 | LAB_004ef09d
        ;   XREF to: 004ef09d (CONDITIONAL_JUMP)
    INC ESI                             ; 004ef096
    CMP AL,0x0                          ; 004ef097
    JNZ 0x004ef085                      ; 004ef099 | LAB_004ef085
    ...
    JZ 0x004ef331                       ; 004ef0a1 | LAB_004ef331
        ;   XREF to: 004ef331 (CONDITIONAL_JUMP)
    INC EDI                             ; 004ef0a7
        ;   Label: LAB_004ef0a7
    MOV ESI,EBP                         ; 004ef0a8
    MOV EDX,dword ptr [ESP + 0xac]      ; 004ef0aa | = "rb" | s_rb_0062e745 = rb
    PUSH EDI                            ; 004ef0b1
    MOV AL,byte ptr [ESI]               ; 004ef0b2 | = "raw" | s_raw_0062e748 = raw
        ;   Label: LAB_004ef0b2
    MOV byte ptr [EDI],AL               ; 004ef0b4
    CMP AL,0x0                          ; 004ef0b6
    JZ 0x004ef0ca                       ; 004ef0b8 | LAB_004ef0ca
        ;   XREF to: 004ef0ca (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 004ef0ba | DAT_0062e749
    ADD ESI,0x2                         ; 004ef0bd
    MOV byte ptr [EDI + 0x1],AL         ; 004ef0c0
    ADD EDI,0x2                         ; 004ef0c3
    CMP AL,0x0                          ; 004ef0c6
    JNZ 0x004ef0b2                      ; 004ef0c8 | LAB_004ef0b2
        ;   XREF to: 004ef0b2 (CONDITIONAL_JUMP)
    POP EDI                             ; 004ef0ca
        ;   Label: LAB_004ef0ca
    PUSH EDX                            ; 004ef0cb | = "rb" | s_rb_0062e745 = rb
    LEA EAX,[ESP + 0x4]                 ; 004ef0cc
    PUSH EAX                            ; 004ef0d0
    MOV ECX,dword ptr [ESP + 0xb0]      ; 004ef0d1 | = "data" | s_data_0062e74c = data
    PUSH ECX                            ; 004ef0d8 | = "data" | s_data_0062e74c = data
    CALL engine_dosio.c_getFile_FUN_00481a50 ; 004ef0d9 | FILE * engine_dosio.c_getFile_FUN_00481a50(char * directory, char * filename, char * mode)
        ;   XREF to: 00481a50 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004ef0de
    MOV ESI,EAX                         ; 004ef0e1
    TEST EAX,EAX                        ; 004ef0e3
    JNZ 0x004ef10a                      ; 004ef0e5 | LAB_004ef10a
        ;   XREF to: 004ef10a (CONDITIONAL_JUMP)
    MOV EDI,0x62e59b                    ; 004ef0e7 | = "..\\core\\ground.cpp" | s_core_ground_cpp_0062e59b = ..\core\ground.cpp
    MOV EBP,0x44                        ; 004ef0ec
    PUSH 0x62e5ae                       ; 004ef0f1 | = "eopen - Cannot open file" | s_eopen_Cannot_open_file_0062e5ae = eopen - Cannot open file
    MOV dword ptr [0x02f0ca48],EDI      ; 004ef0f6 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBP      ; 004ef0fc | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004ef102 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    JA 0x004ef358                       ; 004ef13a | LAB_004ef358
        ;   XREF to: 004ef358 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 004ef140
        ;   Label: LAB_004ef140
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 004ef141 | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
    ...
    JL 0x004ef122                       ; 004ef166 | LAB_004ef122
    ...
    JL 0x004ef11a                       ; 004ef17c | LAB_004ef11a
        ;   XREF to: 004ef11a (CONDITIONAL_JUMP)
    PUSH 0x102                          ; 004ef17e
        ;   Label: LAB_004ef17e
    PUSH 0x62e751                       ; 004ef183 | = "..\\core\\ground.cpp" | s_core_ground_cpp_0062e751 = ..\core\ground.cpp
    PUSH ESI                            ; 004ef188
    MOV EBP,0x62e76b                    ; 004ef189 | = "data" | s_data_0062e76b = data
    LEA EDI,[ESP + 0x5c]                ; 004ef18e
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 004ef192 | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
        ;   XREF to: 0050f9b0 (UNCONDITIONAL_CALL)
    MOV EAX,0x62e764                    ; 004ef197 | = "rb" | s_rb_0062e764 = rb
    ADD ESP,0xc                         ; 004ef19c
    MOV DL,0x2e                         ; 004ef19f
    MOV ESI,dword ptr [ESP + 0xd4]      ; 004ef1a1
    MOV dword ptr [ESP + 0xa4],EBP      ; 004ef1a8 | = "data" | s_data_0062e76b = data
    MOV dword ptr [ESP + 0xa0],EAX      ; 004ef1af | = "rb" | s_rb_0062e764 = rb
    PUSH EDI                            ; 004ef1b6
    MOV AL,byte ptr [ESI]               ; 004ef1b7
        ;   Label: LAB_004ef1b7
    MOV byte ptr [EDI],AL               ; 004ef1b9
    CMP AL,0x0                          ; 004ef1bb
    JZ 0x004ef1cf                       ; 004ef1bd | LAB_004ef1cf
    ...
    CMP AL,0x0                          ; 004ef1cb
    JNZ 0x004ef1b7                      ; 004ef1cd | LAB_004ef1b7
        ;   XREF to: 004ef1b7 (CONDITIONAL_JUMP)
    POP EDI                             ; 004ef1cf
        ;   Label: LAB_004ef1cf
    LEA ESI,[ESP + 0x50]                ; 004ef1d0
    MOV EBP,0x62e767                    ; 004ef1d4 | = "clr" | s_clr_0062e767 = clr
    MOV AL,byte ptr [ESI]               ; 004ef1d9
        ;   Label: LAB_004ef1d9
    CMP AL,DL                           ; 004ef1db
    JZ 0x004ef1f1                       ; 004ef1dd | LAB_004ef1f1
        ;   XREF to: 004ef1f1 (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 004ef1df
    JZ 0x004ef1ef                       ; 004ef1e1 | LAB_004ef1ef
        ;   XREF to: 004ef1ef (CONDITIONAL_JUMP)
    INC ESI                             ; 004ef1e3
    MOV AL,byte ptr [ESI]               ; 004ef1e4
    CMP AL,DL                           ; 004ef1e6
    JZ 0x004ef1f1                       ; 004ef1e8 | LAB_004ef1f1
        ;   XREF to: 004ef1f1 (CONDITIONAL_JUMP)
    INC ESI                             ; 004ef1ea
    CMP AL,0x0                          ; 004ef1eb
    JNZ 0x004ef1d9                      ; 004ef1ed | LAB_004ef1d9
    ...
    JNZ 0x004ef21a                      ; 004ef1f5 | LAB_004ef21a
        ;   XREF to: 004ef21a (CONDITIONAL_JUMP)
    MOV EDX,0x62e571                    ; 004ef1f7 | = "..\\core\\ground.cpp" | s_core_ground_cpp_0062e571 = ..\core\ground.cpp
    MOV ECX,0x40                        ; 004ef1fc
    PUSH 0x62e584                       ; 004ef201 | = "eopen - ext not found!" | s_eopen_ext_not_found_0062e584 = eopen - ext not found!
    MOV dword ptr [0x02f0ca48],EDX      ; 004ef206 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 004ef20c | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004ef212 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ...
    PUSH EDI                            ; 004ef21d
    MOV AL,byte ptr [ESI]               ; 004ef21e | = "clr" | s_clr_0062e767 = clr
        ;   Label: LAB_004ef21e
    MOV byte ptr [EDI],AL               ; 004ef220
    CMP AL,0x0                          ; 004ef222
    JZ 0x004ef236                       ; 004ef224 | LAB_004ef236
        ;   XREF to: 004ef236 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 004ef226 | DAT_0062e768
    ADD ESI,0x2                         ; 004ef229
    MOV byte ptr [EDI + 0x1],AL         ; 004ef22c
    ADD EDI,0x2                         ; 004ef22f
    CMP AL,0x0                          ; 004ef232
    JNZ 0x004ef21e                      ; 004ef234 | LAB_004ef21e
        ;   XREF to: 004ef21e (CONDITIONAL_JUMP)
    POP EDI                             ; 004ef236
        ;   Label: LAB_004ef236
    MOV ESI,dword ptr [ESP + 0xa0]      ; 004ef237
    PUSH ESI                            ; 004ef23e | = "rb" | s_rb_0062e764 = rb
    LEA EAX,[ESP + 0x54]                ; 004ef23f
    PUSH EAX                            ; 004ef243
    MOV EDI,dword ptr [ESP + 0xac]      ; 004ef244
    PUSH EDI                            ; 004ef24b | = "data" | s_data_0062e76b = data
    CALL engine_dosio.c_getFile_FUN_00481a50 ; 004ef24c | FILE * engine_dosio.c_getFile_FUN_00481a50(char * directory, char * filename, char * mode)
        ;   XREF to: 00481a50 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004ef251
    MOV ESI,EAX                         ; 004ef254
    TEST EAX,EAX                        ; 004ef256
    JNZ 0x004ef27c                      ; 004ef258 | LAB_004ef27c
        ;   XREF to: 004ef27c (CONDITIONAL_JUMP)
    MOV EBP,0x62e59b                    ; 004ef25a | = "..\\core\\ground.cpp" | s_core_ground_cpp_0062e59b = ..\core\ground.cpp
    MOV EAX,0x44                        ; 004ef25f
    PUSH 0x62e5ae                       ; 004ef264 | = "eopen - Cannot open file" | s_eopen_Cannot_open_file_0062e5ae = eopen - Cannot open file
    MOV dword ptr [0x02f0ca48],EBP      ; 004ef269 | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 004ef26f | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004ef274 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ...
    JLE 0x004ef2ea                      ; 004ef291 | LAB_004ef2ea
    ...
    JLE 0x004ef2d4                      ; 004ef29e | LAB_004ef2d4
    ...
    PUSH EAX                            ; 004ef2c4
    INC ESI                             ; 004ef2c5
    CALL crt_stdio.c_fread_FUN_005fd990 ; 004ef2c6 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [EBX]             ; 004ef2cb
    ADD ESP,0x10                        ; 004ef2cd
    CMP ESI,ECX                         ; 004ef2d0
    JL 0x004ef2a0                       ; 004ef2d2 | LAB_004ef2a0
    ...
    JL 0x004ef298                       ; 004ef2e8 | LAB_004ef298
        ;   XREF to: 004ef298 (CONDITIONAL_JUMP)
    PUSH 0x10c                          ; 004ef2ea
        ;   Label: LAB_004ef2ea
    PUSH 0x62e770                       ; 004ef2ef | = "..\\core\\ground.cpp" | s_core_ground_cpp_0062e770 = ..\core\ground.cpp
    MOV ESI,dword ptr [ESP + 0xb8]      ; 004ef2f4
    PUSH ESI                            ; 004ef2fb
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 004ef2fc | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
        ;   XREF to: 0050f9b0 (UNCONDITIONAL_CALL)
    ...
    PUSH EBP                            ; 004ef30f
    CALL core_texlist.cpp_CTextureList_load_FUN_005dbe00 ; 004ef310 | void core_texlist.cpp_CTextureList_load_FUN_005dbe00(CTextureList * this_ptr, char * filename)
    ...
    RET                                 ; 004ef330
    MOV ESI,0x62e571                    ; 004ef331 | = "..\\core\\ground.cpp" | s_core_ground_cpp_0062e571 = ..\core\ground.cpp
        ;   Label: LAB_004ef331
    MOV EAX,0x40                        ; 004ef336
    PUSH 0x62e584                       ; 004ef33b | = "eopen - ext not found!" | s_eopen_ext_not_found_0062e584 = eopen - ext not found!
    MOV dword ptr [0x02f0ca48],ESI      ; 004ef340 | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 004ef346 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004ef34b | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004ef350
    JMP 0x004ef0a7                      ; 004ef353 | LAB_004ef0a7
    ...
    JMP 0x004ef149                      ; 004ef36c | LAB_004ef149
