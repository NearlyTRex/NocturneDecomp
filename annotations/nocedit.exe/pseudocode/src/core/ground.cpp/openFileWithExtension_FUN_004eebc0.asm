...
;                               FUNCTION
; *****************************************************************************
; __cdecl FILE * core_ground.cpp_openFileWithExtension_FUN_004eebc0(char * base_filename, char * file_extension, char * open_mode)
;
; Parameters:
...
section .text
    ...
    CMP AL,0x0                          ; 004eebd4
    JZ 0x004eebe8                       ; 004eebd6 | LAB_004eebe8
    ...
    CMP AL,0x0                          ; 004eebe4
    JNZ 0x004eebd0                      ; 004eebe6 | LAB_004eebd0
    ...
    MOV AL,byte ptr [ESI]               ; 004eebeb
        ;   Label: LAB_004eebeb
    CMP AL,DL                           ; 004eebed
    JZ 0x004eec03                       ; 004eebef | LAB_004eec03
        ;   XREF to: 004eec03 (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 004eebf1
    JZ 0x004eec01                       ; 004eebf3 | LAB_004eec01
        ;   XREF to: 004eec01 (CONDITIONAL_JUMP)
    INC ESI                             ; 004eebf5
    MOV AL,byte ptr [ESI]               ; 004eebf6
    CMP AL,DL                           ; 004eebf8
    JZ 0x004eec03                       ; 004eebfa | LAB_004eec03
        ;   XREF to: 004eec03 (CONDITIONAL_JUMP)
    INC ESI                             ; 004eebfc
    CMP AL,0x0                          ; 004eebfd
    JNZ 0x004eebeb                      ; 004eebff | LAB_004eebeb
    ...
    JNZ 0x004eec2c                      ; 004eec07 | LAB_004eec2c
        ;   XREF to: 004eec2c (CONDITIONAL_JUMP)
    MOV EDX,0x62e571                    ; 004eec09 | = "..\\core\\ground.cpp" | s_core_ground_cpp_0062e571 = ..\core\ground.cpp
    MOV ECX,0x40                        ; 004eec0e
    PUSH 0x62e584                       ; 004eec13 | = "eopen - ext not found!" | s_eopen_ext_not_found_0062e584 = eopen - ext not found!
    MOV dword ptr [0x02f0ca48],EDX      ; 004eec18 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 004eec1e | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004eec24 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    CMP AL,0x0                          ; 004eec3a
    JZ 0x004eec4e                       ; 004eec3c | LAB_004eec4e
    ...
    CMP AL,0x0                          ; 004eec4a
    JNZ 0x004eec36                      ; 004eec4c | LAB_004eec36
    ...
    PUSH ESI                            ; 004eec59
    CALL engine_dosio.c_getFile_FUN_00481a50 ; 004eec5a | FILE * engine_dosio.c_getFile_FUN_00481a50(char * directory, char * filename, char * mode)
        ;   XREF to: 00481a50 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004eec5f
    MOV ESI,EAX                         ; 004eec62
    TEST EAX,EAX                        ; 004eec64
    JZ 0x004eec72                       ; 004eec66 | LAB_004eec72
    ...
    POP EBX                             ; 004eec70
    RET                                 ; 004eec71
    MOV EDI,0x62e59b                    ; 004eec72 | = "..\\core\\ground.cpp" | s_core_ground_cpp_0062e59b = ..\core\ground.cpp
        ;   Label: LAB_004eec72
    MOV EBP,0x44                        ; 004eec77
    PUSH 0x62e5ae                       ; 004eec7c | = "eopen - Cannot open file" | s_eopen_Cannot_open_file_0062e5ae = eopen - Cannot open file
    MOV dword ptr [0x02f0ca48],EDI      ; 004eec81 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBP      ; 004eec87 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004eec8d | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
