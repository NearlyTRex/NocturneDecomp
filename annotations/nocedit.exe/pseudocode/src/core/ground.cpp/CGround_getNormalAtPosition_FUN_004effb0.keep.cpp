...

{
  ...
  if ((uVar7 & 1) == (uVar3 & 1)) {
    if (iVar7 < iVar6) {
      ...
      iVar7 = (int)pvVar2[(this_ptr->width_minus_1 & uVar1) + iVar6].height *
              this_ptr->height_scale;
      local_3c.x = (int)pvVar2[iVar6 + uVar7].height * this_ptr->height_scale -
                   iVar7;
      local_3c.y = this_ptr->vertical_scale << 8;
      local_3c.z = iVar7 - this_ptr->height_scale *
                           (int)pvVar2[(uVar1 & this_ptr->height_minus_1) +
                                       (uVar2 & this_ptr->height_minus_1) * this_ptr->width].height
      ;
