...

{
  ...
  if ((uVar12 & 1) != (uVar4 & 1)) {
    ...
    if (iVar12 < iVar11) {
      ...
      iVar15 = (int)*(short *)((uVar12 + iVar13) * 4 + (int)pvVar3) * this_ptr->height_scale;
      iVar13 = this_ptr->height_scale *
               (int)*(short *)(((uVar2 & this_ptr->width_minus_1) + iVar13) * 4 + (int)pvVar3);
    ...
    pvVar3 = this_ptr->terrain_data;
    iVar15 = this_ptr->height_scale *
             (int)*(short *)((uVar4 * this_ptr->width + uVar11) * 4 + (int)pvVar3);
    iVar13 = this_ptr->width * (uVar1 & this_ptr->height_minus_1);
    iVar14 = this_ptr->height_scale * (int)*(short *)((int)pvVar3 + (iVar13 + uVar11) * 4);
    lVar6 = (longlong)iVar11 *
            (longlong)
            ((int)*(short *)((int)pvVar3 + (uVar12 + iVar13) * 4) * this_ptr->height_scale - iVar14)
    ;
  ...
  if (iVar12 < iVar11) {
    ...
    iVar15 = (int)*(short *)((int)pvVar1 + ((this_ptr->width_minus_1 & uVar2) + iVar8) * 4) *
             this_ptr->height_scale;
    ...
    lVar3 = (longlong)iVar12 *
            ...
            (this_ptr->height_scale *
             (int)*(short *)((int)pvVar1 +
                            ...
                            (uVar1 & this_ptr->height_minus_1) * this_ptr->width) * 4) - iVar15);
  ...
  iVar13 = this_ptr->height_scale * (int)*(short *)((uVar12 + iVar15) * 4 + (int)pvVar3);
  lVar6 = (longlong)iVar11 *
          (longlong)
          ((int)*(short *)(((uVar2 & this_ptr->width_minus_1) + iVar15) * 4 + (int)pvVar3) *
           this_ptr->height_scale - iVar13);
