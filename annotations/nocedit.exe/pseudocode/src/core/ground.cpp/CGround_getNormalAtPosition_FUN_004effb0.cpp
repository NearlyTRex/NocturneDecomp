...

{
  ...
  if ((void *)(uVar7 & 1) == local_1c) {
    if (local_10 < local_14) {
      ...
      local_24 = (int)*(short *)((int)pvVar2 + ((int)local_1c + uVar7) * 4) * this_ptr->height_scale
      ;
      ...
      local_24 = (int)*(short *)((uVar3 * this_ptr->width + uVar7) * 4 + (int)local_1c) *
                 this_ptr->height_scale;
  ...
  puVar8 = (uint *)((int)pCVar6 + ((uint)bVar9 * -2 + 1) * 4);
  local_3c.x = pCVar6->x;
  *(uint *)((int)&local_3c + (uint)bVar9 * -8 + 4) = *puVar8;
