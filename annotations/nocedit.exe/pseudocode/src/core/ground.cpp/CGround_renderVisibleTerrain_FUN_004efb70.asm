...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_ground.cpp_CGround_renderVisibleTerrain_FUN_004efb70(CGround * this_ptr)
;
; Parameters:
...
section .text
    ...
    JGE 0x004efb89                      ; 004efb85 | LAB_004efb89
    ...
    JGE 0x004efb9f                      ; 004efb99 | LAB_004efb9f
    ...
    JGE 0x004efbad                      ; 004efba9 | LAB_004efbad
    ...
    PUSH EBX                            ; 004efbf9
    DEC ESI                             ; 004efbfa
    CALL core_ground.cpp_CGround_renderTerrainQuad_FUN_004ef990 ; 004efbfb | void core_ground.cpp_CGround_renderTerrainQuad_FUN_004ef990(CGround * this_ptr, int world_column, int world_row)
        ;   XREF to: 004ef990 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004efc00
    TEST ESI,ESI                        ; 004efc03
    JGE 0x004efbed                      ; 004efc05 | LAB_004efbed
        ;   XREF to: 004efbed (CONDITIONAL_JUMP)
    DEC EDI                             ; 004efc07
        ;   Label: LAB_004efc07
    TEST EDI,EDI                        ; 004efc08
    JGE 0x004efbdb                      ; 004efc0a | LAB_004efbdb
    ...
    PUSH EBX                            ; 004efc33
    DEC ESI                             ; 004efc34
    CALL core_ground.cpp_CGround_renderTerrainQuad_FUN_004ef990 ; 004efc35 | void core_ground.cpp_CGround_renderTerrainQuad_FUN_004ef990(CGround * this_ptr, int world_column, int world_row)
        ;   XREF to: 004ef990 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004efc3a
    JMP 0x004efc23                      ; 004efc3d | LAB_004efc23
        ;   XREF to: 004efc23 (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x4]       ; 004efc3f
        ;   Label: LAB_004efc3f
    DEC EAX                             ; 004efc43
    MOV dword ptr [ESP + 0x8],EAX       ; 004efc44
    JMP 0x004efc19                      ; 004efc48 | LAB_004efc19
    ...
    PUSH EBX                            ; 004efc56
    INC ESI                             ; 004efc57
    CALL core_ground.cpp_CGround_renderTerrainQuad_FUN_004ef990 ; 004efc58 | void core_ground.cpp_CGround_renderTerrainQuad_FUN_004ef990(CGround * this_ptr, int world_column, int world_row)
        ;   XREF to: 004ef990 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004efc5d
    TEST ESI,ESI                        ; 004efc60
    JMP 0x004efc1d                      ; 004efc62 | LAB_004efc1d
    ...
    PUSH EBX                            ; 004efc70
    INC ESI                             ; 004efc71
    CALL core_ground.cpp_CGround_renderTerrainQuad_FUN_004ef990 ; 004efc72 | void core_ground.cpp_CGround_renderTerrainQuad_FUN_004ef990(CGround * this_ptr, int world_column, int world_row)
        ;   XREF to: 004ef990 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004efc77
    TEST ESI,ESI                        ; 004efc7a
    JMP 0x004efbdf                      ; 004efc7c | LAB_004efbdf
