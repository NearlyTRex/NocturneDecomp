...
section .text
    ...
    JNZ 0x00542ded                      ; 00542de6 | LAB_00542ded
        ;   XREF to: 00542ded (CONDITIONAL_JUMP)
    CMP EDX,dword ptr [EAX + 0x4]       ; 00542de8
    JZ 0x00542e10                       ; 00542deb | LAB_00542e10
        ;   XREF to: 00542e10 (CONDITIONAL_JUMP)
    MOV EBX,0x63dcac                    ; 00542ded | = "..\\core\\netgame.cpp" | s_core_netgame_cpp_0063dcac = ..\core\netgame.cpp
        ;   Label: LAB_00542ded
    MOV ESI,0x8a8                       ; 00542df2
    PUSH 0x63dcc0                       ; 00542df7 | = "CNetGame::sendGameSettingsPacket - sh..." | s_CNetGame_sendGameSetting_0063dcc0 = CNetGame::sendGameSettingsPacket - should only call this in server lobby mode
    MOV dword ptr [0x02f0ca48],EBX      ; 00542dfc | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 00542e02 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00542e08 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00542e0d
    MOV EDI,dword ptr [ESP + 0xd0]      ; 00542e10
        ;   Label: LAB_00542e10
    TEST EDI,EDI                        ; 00542e17
    JL 0x00542e27                       ; 00542e19 | LAB_00542e27
        ;   XREF to: 00542e27 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [ESP + 0xcc]      ; 00542e1b
    CMP EDI,dword ptr [EDX + 0x1c]      ; 00542e22
    JL 0x00542e49                       ; 00542e25 | LAB_00542e49
        ;   XREF to: 00542e49 (CONDITIONAL_JUMP)
    MOV EAX,0x63dd0e                    ; 00542e27 | = "..\\core\\netgame.cpp" | s_core_netgame_cpp_0063dd0e = ..\core\netgame.cpp
        ;   Label: LAB_00542e27
    MOV EDX,0x8ae                       ; 00542e2c
    PUSH 0x63dd22                       ; 00542e31 | = "CNetGame::send - invalid player index" | s_CNetGame_send_invalid_pl_0063dd22 = CNetGame::send - invalid player index
    MOV [0x02f0ca48],EAX                ; 00542e36 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 00542e3b | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00542e41 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00542e46
    PUSH 0x661ce0                       ; 00542e49 | WatcomTypeInfo g_SPlayerTypeInfo
        ;   Label: LAB_00542e49
    MOV AH,0xb                          ; 00542e4e
    PUSH 0x2                            ; 00542e50
    ...
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 00542e64 | void * crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
    ...
    MOV EAX,[0x02f7c8c4]                ; 00542e7d | undefined4 DAT_02f7c8c4
    ...
    CMP AL,0x0                          ; 00542eaa
    JZ 0x00542ebe                       ; 00542eac | LAB_00542ebe
    ...
    CMP AL,0x0                          ; 00542eba
    JNZ 0x00542ea6                      ; 00542ebc | LAB_00542ea6
    ...
    JLE 0x00542f60                      ; 00542ecd | LAB_00542f60
    ...
    CMP AL,0x0                          ; 00542ef9
    JZ 0x00542f0d                       ; 00542efb | LAB_00542f0d
    ...
    CMP AL,0x0                          ; 00542f09
    JNZ 0x00542ef5                      ; 00542f0b | LAB_00542ef5
    ...
    JL 0x00542ee8                       ; 00542f56 | LAB_00542ee8
    ...
    PUSH ESI                            ; 00542f72
    CALL core_netgame.cpp_CNetGame_send_FUN_005411c0 ; 00542f73 | undefined core_netgame.cpp_CNetGame_send_FUN_005411c0()
        ;   XREF to: 005411c0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00542f78
    CALL wincore_winrun.cpp_getTime_FUN_005f2dc0 ; 00542f7b | int wincore_winrun.cpp_getTime_FUN_005f2dc0()
        ;   XREF to: 005f2dc0 (UNCONDITIONAL_CALL)
    MOV EDX,EAX                         ; 00542f80
    MOV ECX,0x12                        ; 00542f82
    SAR EDX,0x1f                        ; 00542f87
    IDIV ECX                            ; 00542f8a
    MOV EDI,dword ptr [0x02f7c8b4]      ; 00542f8c | int g_LastPingTime
    MOV EDX,EAX                         ; 00542f92
    SUB EDX,EDI                         ; 00542f94
    MOV [0x02f7c8b4],EAX                ; 00542f96 | int g_LastPingTime
    TEST EDX,EDX                        ; 00542f9b
    JL 0x00542fe0                       ; 00542f9d | LAB_00542fe0
        ;   XREF to: 00542fe0 (CONDITIONAL_JUMP)
    CMP EDX,0x20000                     ; 00542f9f
    JLE 0x00542fac                      ; 00542fa5 | LAB_00542fac
        ;   XREF to: 00542fac (CONDITIONAL_JUMP)
    MOV EDX,0x20000                     ; 00542fa7
    MOV EAX,dword ptr [ESP + 0xd0]      ; 00542fac
        ;   Label: LAB_00542fac
    MOV EBP,dword ptr [0x02f7c8b8]      ; 00542fb3 | uint g_CurrentGameTime
    ...
    MOV dword ptr [0x02f7c8b8],EBP      ; 00542fcc | uint g_CurrentGameTime
    ...
    XOR EDX,EDX                         ; 00542fe0
        ;   Label: LAB_00542fe0
    JMP 0x00542fac                      ; 00542fe2 | LAB_00542fac
