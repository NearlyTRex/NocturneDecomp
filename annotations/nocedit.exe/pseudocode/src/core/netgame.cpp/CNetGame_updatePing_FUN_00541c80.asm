...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_netgame.cpp_CNetGame_updatePing_FUN_00541c80(CNetGame * this_ptr, int player_index, float max_ping)
;
; Parameters:
...
section .text
    ...
    JL 0x00541c9b                       ; 00541c94 | LAB_00541c9b
        ;   XREF to: 00541c9b (CONDITIONAL_JUMP)
    CMP EBX,dword ptr [ESI + 0x1c]      ; 00541c96
    JL 0x00541cbe                       ; 00541c99 | LAB_00541cbe
        ;   XREF to: 00541cbe (CONDITIONAL_JUMP)
    MOV ECX,0x63da65                    ; 00541c9b | = "..\\core\\netgame.cpp" | s_core_netgame_cpp_0063da65 = ..\core\netgame.cpp
        ;   Label: LAB_00541c9b
    MOV EDI,0x735                       ; 00541ca0
    PUSH 0x63da79                       ; 00541ca5 | = "CNetGame::updatePing - invalid player..." | s_CNetGame_updatePing_inva_0063da79 = CNetGame::updatePing - invalid player index
    MOV dword ptr [0x02f0ca48],ECX      ; 00541caa | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 00541cb0 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00541cb6 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00541cbb
    CALL wincore_winrun.cpp_getTime_FUN_005f2dc0 ; 00541cbe | int wincore_winrun.cpp_getTime_FUN_005f2dc0()
        ;   Label: LAB_00541cbe
    ...
    IDIV ECX                            ; 00541ccd
    MOV ECX,dword ptr [0x02f7c8b4]      ; 00541ccf | int g_LastPingTime
    MOV EDX,EAX                         ; 00541cd5
    SUB EAX,ECX                         ; 00541cd7
    MOV dword ptr [0x02f7c8b4],EDX      ; 00541cd9 | int g_LastPingTime
    TEST EAX,EAX                        ; 00541cdf
    JL 0x00541e1a                       ; 00541ce1 | LAB_00541e1a
        ;   XREF to: 00541e1a (CONDITIONAL_JUMP)
    CMP EAX,0x20000                     ; 00541ce7
    JLE 0x00541cf3                      ; 00541cec | LAB_00541cf3
        ;   XREF to: 00541cf3 (CONDITIONAL_JUMP)
    MOV EAX,0x20000                     ; 00541cee
    MOV EDI,dword ptr [0x02f7c8b8]      ; 00541cf3 | uint g_CurrentGameTime
        ;   Label: LAB_00541cf3
    ...
    MOV dword ptr [0x02f7c8b8],EDI      ; 00541d14 | uint g_CurrentGameTime
    CMP EBX,EAX                         ; 00541d1a
    JZ 0x00541e21                       ; 00541d1c | LAB_00541e21
    ...
    FMUL double ptr [0x0063daa5]        ; 00541d31 | double g_TimeToSeconds
    FST float ptr [ESP + 0x8]           ; 00541d37
    FLDZ                                ; 00541d3b
    FCOMPP                              ; 00541d3d
    FNSTSW AX                           ; 00541d3f
    SAHF                                ; 00541d41
    JBE 0x00541d4a                      ; 00541d42 | LAB_00541d4a
        ;   XREF to: 00541d4a (CONDITIONAL_JUMP)
    XOR ECX,ECX                         ; 00541d44
    MOV dword ptr [ESP + 0x8],ECX       ; 00541d46
    FLD float ptr [ESP + 0x8]           ; 00541d4a
        ;   Label: LAB_00541d4a
    FCOMP double ptr [0x0063daad]       ; 00541d4e | double g_MaxPingTime
    FNSTSW AX                           ; 00541d54
    SAHF                                ; 00541d56
    JBE 0x00541d61                      ; 00541d57 | LAB_00541d61
        ;   XREF to: 00541d61 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x8],0x41f00000 ; 00541d59
    FLD float ptr [ESP + 0x8]           ; 00541d61
        ;   Label: LAB_00541d61
    FCOMP double ptr [0x0063dab5]       ; 00541d65 | double g_PingCheckThreshold
    FNSTSW AX                           ; 00541d6b
    SAHF                                ; 00541d6d
    JC 0x00541e13                       ; 00541d6e | LAB_00541e13
        ;   XREF to: 00541e13 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x02f7c8b8]      ; 00541d74 | uint g_CurrentGameTime
    ...
    FMUL double ptr [0x0063daa5]        ; 00541d87 | double g_TimeToSeconds
    FST float ptr [ESP + 0x4]           ; 00541d8d
    FLDZ                                ; 00541d91
    FCOMPP                              ; 00541d93
    FNSTSW AX                           ; 00541d95
    SAHF                                ; 00541d97
    JBE 0x00541da0                      ; 00541d98 | LAB_00541da0
        ;   XREF to: 00541da0 (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 00541d9a
    MOV dword ptr [ESP + 0x4],EAX       ; 00541d9c
    FLD float ptr [ESP + 0x4]           ; 00541da0
        ;   Label: LAB_00541da0
    FCOMP double ptr [0x0063daad]       ; 00541da4 | double g_MaxPingTime
    FNSTSW AX                           ; 00541daa
    SAHF                                ; 00541dac
    JBE 0x00541db7                      ; 00541dad | LAB_00541db7
    ...
    FNSTSW AX                           ; 00541dc3
    SAHF                                ; 00541dc5
    JA 0x00541dd4                       ; 00541dc6 | LAB_00541dd4
        ;   XREF to: 00541dd4 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x4]           ; 00541dc8
    FCOMP float ptr [EBP + 0x1c]        ; 00541dcc
    FNSTSW AX                           ; 00541dcf
    SAHF                                ; 00541dd1
    JC 0x00541e13                       ; 00541dd2 | LAB_00541e13
        ;   XREF to: 00541e13 (CONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 00541dd4
        ;   Label: LAB_00541dd4
    FCOMP double ptr [0x0063dabd]       ; 00541dd7 | double g_BadConnectionTime
    FNSTSW AX                           ; 00541ddd
    SAHF                                ; 00541ddf
    JBE 0x00541de9                      ; 00541de0 | LAB_00541de9
    ...
    MOV EAX,[0x02f7c8b8]                ; 00541df4 | uint g_CurrentGameTime
    ...
    PUSH EBX                            ; 00541e09
    PUSH ESI                            ; 00541e0a
    CALL core_netgame.cpp_CNetGame_send_FUN_005411c0 ; 00541e0b | undefined core_netgame.cpp_CNetGame_send_FUN_005411c0()
    ...
    XOR EAX,EAX                         ; 00541e1a
        ;   Label: LAB_00541e1a
    JMP 0x00541cf3                      ; 00541e1c | LAB_00541cf3
