...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_netgame.cpp_CNetGame_receivePackets_FUN_005405b0(CNetGame * this_ptr)
;
; Parameters:
...
section .text
    ...
    CALL wincore_winrun.cpp_getTime_FUN_005f2dc0 ; 005405b9 | int wincore_winrun.cpp_getTime_FUN_005f2dc0()
        ;   XREF to: 005f2dc0 (UNCONDITIONAL_CALL)
    MOV EDX,EAX                         ; 005405be
    MOV EBX,0x12                        ; 005405c0
    SAR EDX,0x1f                        ; 005405c5
    IDIV EBX                            ; 005405c8
    MOV ECX,dword ptr [0x02f7c8b4]      ; 005405ca | int g_LastPingTime
    MOV EDX,EAX                         ; 005405d0
    SUB EAX,ECX                         ; 005405d2
    MOV dword ptr [0x02f7c8b4],EDX      ; 005405d4 | int g_LastPingTime
    TEST EAX,EAX                        ; 005405da
    JL 0x00540604                       ; 005405dc | LAB_00540604
        ;   XREF to: 00540604 (CONDITIONAL_JUMP)
    CMP EAX,0x20000                     ; 005405de
    JG 0x00540608                       ; 005405e3 | LAB_00540608
        ;   XREF to: 00540608 (CONDITIONAL_JUMP)
    ADD dword ptr [0x02f7c8b8],EAX      ; 005405e5 | uint g_CurrentGameTime
        ;   Label: LAB_005405e5
    LEA EBX,[ESI + 0x170]               ; 005405eb
    PUSH EBX                            ; 005405f1
        ;   Label: LAB_005405f1
    CALL support_trisock.cpp_isSocketValid_FUN_005e1b70 ; 005405f2 | int support_trisock.cpp_isSocketValid_FUN_005e1b70(SSocketContext * socket_ctx)
        ;   XREF to: 005e1b70 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005405f7
    TEST EAX,EAX                        ; 005405fa
    JNZ 0x0054060f                      ; 005405fc | LAB_0054060f
    ...
    XOR EAX,EAX                         ; 00540604
        ;   Label: LAB_00540604
    JMP 0x005405e5                      ; 00540606 | LAB_005405e5
        ;   XREF to: 005405e5 (UNCONDITIONAL_JUMP)
    MOV EAX,0x20000                     ; 00540608
        ;   Label: LAB_00540608
    JMP 0x005405e5                      ; 0054060d | LAB_005405e5
        ;   XREF to: 005405e5 (UNCONDITIONAL_JUMP)
    MOV EAX,ESP                         ; 0054060f
        ;   Label: LAB_0054060f
    PUSH EAX                            ; 00540611
    PUSH 0x404                          ; 00540612
    PUSH 0x2fa88cc                      ; 00540617 | char[1028] g_NetworkReceiveBuffer
    PUSH EBX                            ; 0054061c
    CALL support_trisock.cpp_receiveSocketData_FUN_005e1c20 ; 0054061d | int support_trisock.cpp_receiveSocketData_FUN_005e1c20(SSocketContext * socket_ctx, char * buffer, int length, SNetworkAddr * source_addr)
        ;   XREF to: 005e1c20 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00540622
    TEST EAX,EAX                        ; 00540625
    JLE 0x00540644                      ; 00540627 | LAB_00540644
        ;   XREF to: 00540644 (CONDITIONAL_JUMP)
    INC EAX                             ; 00540629
    PUSH 0x2fa88c8                      ; 0054062a | int g_NetworkPacketSize
    MOV [0x02fa88c8],EAX                ; 0054062f | int g_NetworkPacketSize
    LEA EAX,[ESP + 0x4]                 ; 00540634
    PUSH EAX                            ; 00540638
    PUSH ESI                            ; 00540639
    CALL core_netgame.cpp_CNetGame_allocSimFrame_FUN_005406a0 ; 0054063a | void core_netgame.cpp_CNetGame_allocSimFrame_FUN_005406a0(CNetGame * this_ptr, SNetworkAddr * source_addr, char * packet_data)
        ;   XREF to: 005406a0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0054063f
    JMP 0x005405f1                      ; 00540642 | LAB_005405f1
        ;   XREF to: 005405f1 (UNCONDITIONAL_JUMP)
    PUSH ESI                            ; 00540644
        ;   Label: LAB_00540644
    CALL core_netgame.cpp_CNetGame_removeChatOut_FUN_00541ff0 ; 00540645 | undefined core_netgame.cpp_CNetGame_removeChatOut_FUN_00541ff0()
