...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_netgame_cpp_CNetGame_receivePackets_FUN_005405b0(CNetGame *this_ptr)
;
; Parameters:
...
section .text
    ...
    INC EAX                             ; 00540629
    PUSH 0x2fa88c8                      ; 0054062a | g_NetworkPacketSize
    MOV [0x02fa88c8],EAX                ; 0054062f | g_NetworkPacketSize
    LEA EAX,[ESP + 0x4]                 ; 00540634
    PUSH EAX                            ; 00540638
    PUSH ESI                            ; 00540639
    CALL core_netgame.cpp_CNetGame_allocSimFrame_FUN_005406a0 ; 0054063a
        ;   XREF to: 005406a0 (UNCONDITIONAL_CALL)  ; void core_netgame.cpp_CNetGame_allocSimFrame_FUN_005406a0(CNetGame * this_ptr, SNetworkAddr * source_addr, char * packet_data)
