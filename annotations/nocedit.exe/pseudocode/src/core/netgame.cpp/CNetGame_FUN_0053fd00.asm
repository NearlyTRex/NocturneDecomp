...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_netgame_cpp_CNetGame_FUN_0053fd00(CNetGame *this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV dword ptr [0x02f98ad0],EDX      ; 0053fd53 | DAT_02f98ad0
    MOV dword ptr [0x02f7c8c0],EDX      ; 0053fd59 | g_RemoteSyncStage
    MOV dword ptr [ESI + 0x1c],EDX      ; 0053fd5f
    MOV dword ptr [0x02f7c8c4],EDX      ; 0053fd62 | DAT_02f7c8c4
