...
;                               FUNCTION
; *****************************************************************************
; __cdecl CNetGame * core_netgame.cpp_CNetGame_ctor_FUN_0053f6d0(CNetGame * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH 0x661d00                       ; 0053f6d6 | WatcomTypeInfo g_SNetPlayerTypeInfo
    PUSH 0x2                            ; 0053f6db
    ADD EDX,0x20                        ; 0053f6dd
    PUSH EDX                            ; 0053f6e0
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 0053f6e1 | void * crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667(void * array_start, int element_count, WatcomTypeInfo * type_info)
        ;   XREF to: 005fe667 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0053f6e6
    ADD EAX,0x150                       ; 0053f6e9
    PUSH EAX                            ; 0053f6ee
    CALL support_trisock.cpp_invalidateSocket_FUN_005e1ae0 ; 0053f6ef | void support_trisock.cpp_invalidateSocket_FUN_005e1ae0(SSocketContext * socket_ctx)
    ...
    MOV ESI,0x63d2b1                    ; 0053f707 | = "MyComputer" | s_MyComputer_0063d2b1 = MyComputer
    ...
    PUSH EDI                            ; 0053f72d
    MOV AL,byte ptr [ESI]               ; 0053f72e | = "MyComputer" | s_MyComputer_0063d2b1 = MyComputer
        ;   Label: LAB_0053f72e
    MOV byte ptr [EDI],AL               ; 0053f730
    CMP AL,0x0                          ; 0053f732
    JZ 0x0053f746                       ; 0053f734 | LAB_0053f746
        ;   XREF to: 0053f746 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0053f736 | s_yComputer_0063d2b2
    ADD ESI,0x2                         ; 0053f739
    MOV byte ptr [EDI + 0x1],AL         ; 0053f73c
    ADD EDI,0x2                         ; 0053f73f
    CMP AL,0x0                          ; 0053f742
    JNZ 0x0053f72e                      ; 0053f744 | LAB_0053f72e
