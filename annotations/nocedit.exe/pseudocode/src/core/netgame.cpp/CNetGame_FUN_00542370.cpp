...

{
  ...
  *(uint *)g_ChatHistory[g_ChatHistoryCount].field0_0x0 = *in_stack_0000000c;
  *(uint *)(iVar3 + 0x2f7c8d4 + (uint)bVar6 * -8) = in_stack_0000000c[(uint)bVar6 * -2 + 1];
  *(uint *)(g_ChatHistory[iVar2].field0_0x0 + 8) = in_stack_00000010;
