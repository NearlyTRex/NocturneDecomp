...
section .text
    ...
    JL 0x00542b18                       ; 00542b0d | LAB_00542b18
        ;   XREF to: 00542b18 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [ESP + 0x1c]      ; 00542b0f
    CMP EDX,dword ptr [EBX + 0x1c]      ; 00542b13
    JL 0x00542b3b                       ; 00542b16 | LAB_00542b3b
        ;   XREF to: 00542b3b (CONDITIONAL_JUMP)
    MOV EBX,0x63dbcc                    ; 00542b18 | = "..\\core\\netgame.cpp" | s_core_netgame_cpp_0063dbcc = ..\core\netgame.cpp
        ;   Label: LAB_00542b18
    MOV ESI,0x862                       ; 00542b1d
    PUSH 0x63dbe0                       ; 00542b22 | = "CNetGame::removePlayer - invalid play..." | s_CNetGame_removePlayer_in_0063dbe0 = CNetGame::removePlayer - invalid player index
    MOV dword ptr [0x02f0ca48],EBX      ; 00542b27 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 00542b2d | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00542b33 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    JNZ 0x00542b6d                      ; 00542b49 | LAB_00542b6d
        ;   XREF to: 00542b6d (CONDITIONAL_JUMP)
    MOV EBP,0x63dc0e                    ; 00542b4b | = "..\\core\\netgame.cpp" | s_core_netgame_cpp_0063dc0e = ..\core\netgame.cpp
    MOV EAX,0x869                       ; 00542b50
    PUSH 0x63dc22                       ; 00542b55 | = "CNetGame::removePlayer - tried to rem..." | s_CNetGame_removePlayer_tr_0063dc22 = CNetGame::removePlayer - tried to remove myself!
    MOV dword ptr [0x02f0ca48],EBP      ; 00542b5a | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 00542b60 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00542b65 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ...
    JNZ 0x00542b87                      ; 00542b7b | LAB_00542b87
    ...
    JNZ 0x00542ba1                      ; 00542b95 | LAB_00542ba1
    ...
    PUSH EAX                            ; 00542bea
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 00542beb | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
        ;   XREF to: 005fe5e0 (UNCONDITIONAL_CALL)
    XOR ESI,ESI                         ; 00542bf0
    MOV EDI,dword ptr [0x02f98ad0]      ; 00542bf2 | undefined4 DAT_02f98ad0
    ADD ESP,0xc                         ; 00542bf8
    TEST EDI,EDI                        ; 00542bfb
    JLE 0x00542ca0                      ; 00542bfd | LAB_00542ca0
    ...
    ADD EDI,0x2f98ad4                   ; 00542c1a | undefined4 DAT_02f98ad4
    ADD EAX,0x10                        ; 00542c20
    ADD EBX,0x2f98ad4                   ; 00542c23 | undefined4 DAT_02f98ad4
    ADD EAX,0x2f98ad4                   ; 00542c29 | undefined4 DAT_02f98ad4
    ADD EBP,0x2f98ad4                   ; 00542c2e | undefined4 DAT_02f98ad4
    ...
    PUSH EBX                            ; 00542c46
    PUSH EDI                            ; 00542c47
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 00542c48 | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
        ;   XREF to: 005fe5e0 (UNCONDITIONAL_CALL)
    ...
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 00542c6e | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
        ;   XREF to: 005fe5e0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00542c73
    ADD EDI,0x114                       ; 00542c76
    MOV EDX,dword ptr [ESP + 0x4]       ; 00542c7c
    MOV ECX,dword ptr [0x02f98ad0]      ; 00542c80 | undefined4 DAT_02f98ad0
    ADD EDX,0x114                       ; 00542c86
    ADD EBP,0x114                       ; 00542c8c
    MOV dword ptr [ESP + 0x4],EDX       ; 00542c92
    CMP ESI,ECX                         ; 00542c96
    JL 0x00542c38                       ; 00542c98 | LAB_00542c38
    ...
    JGE 0x00542cbb                      ; 00542cb0 | LAB_00542cbb
    ...
    JL 0x00542cd5                       ; 00542ccb | LAB_00542cd5
