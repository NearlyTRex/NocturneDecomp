...
section .text
    ...
    MOV EAX,[0x02f7c8b8]                ; 0053f44c | uint g_CurrentGameTime
    SUB EAX,EDX                         ; 0053f451
    MOV dword ptr [ESP + 0x4],EAX       ; 0053f453
    FILD dword ptr [ESP + 0x4]          ; 0053f457
    FMUL double ptr [0x0063d235]        ; 0053f45b | double DOUBLE_0063d235
    FST float ptr [ESP]                 ; 0053f461
    FLDZ                                ; 0053f464
    FCOMPP                              ; 0053f466
    FNSTSW AX                           ; 0053f468
    SAHF                                ; 0053f46a
    JA 0x0053f482                       ; 0053f46b | LAB_0053f482
        ;   XREF to: 0053f482 (CONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 0053f46d
        ;   Label: LAB_0053f46d
    FCOMP double ptr [0x0063d23d]       ; 0053f470 | double DOUBLE_0063d23d
    FNSTSW AX                           ; 0053f476
    SAHF                                ; 0053f478
    JA 0x0053f489                       ; 0053f479 | LAB_0053f489
    ...
    JMP 0x0053f46d                      ; 0053f487 | LAB_0053f46d
