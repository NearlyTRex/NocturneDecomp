...
section .text
    ...
    CALL wincore_winrun.cpp_getTime_FUN_005f2dc0 ; 00541fff | int wincore_winrun.cpp_getTime_FUN_005f2dc0()
        ;   XREF to: 005f2dc0 (UNCONDITIONAL_CALL)
    MOV EDX,EAX                         ; 00542004
    MOV EBX,0x12                        ; 00542006
    SAR EDX,0x1f                        ; 0054200b
    IDIV EBX                            ; 0054200e
    MOV ECX,dword ptr [0x02f7c8b4]      ; 00542010 | int g_LastPingTime
    MOV EDX,EAX                         ; 00542016
    SUB EAX,ECX                         ; 00542018
    MOV dword ptr [0x02f7c8b4],EDX      ; 0054201a | int g_LastPingTime
    TEST EAX,EAX                        ; 00542020
    JL 0x00542232                       ; 00542022 | LAB_00542232
        ;   XREF to: 00542232 (CONDITIONAL_JUMP)
    CMP EAX,0x20000                     ; 00542028
    JLE 0x00542034                      ; 0054202d | LAB_00542034
        ;   XREF to: 00542034 (CONDITIONAL_JUMP)
    MOV EAX,0x20000                     ; 0054202f
    MOV EBX,dword ptr [0x02f7c8b8]      ; 00542034 | uint g_CurrentGameTime
        ;   Label: LAB_00542034
    MOV EDI,dword ptr [0x02f98ad0]      ; 0054203a | undefined4 DAT_02f98ad0
    XOR ESI,ESI                         ; 00542040
    ADD EBX,EAX                         ; 00542042
    MOV dword ptr [ESP + 0x120],ESI     ; 00542044
    MOV dword ptr [0x02f7c8b8],EBX      ; 0054204b | uint g_CurrentGameTime
    TEST EDI,EDI                        ; 00542051
    JLE 0x0054222b                      ; 00542053 | LAB_0054222b
        ;   XREF to: 0054222b (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + 0x14]      ; 00542059
    MOV ECX,0x2f98ad4                   ; 0054205c | undefined4 DAT_02f98ad4
    ADD EAX,0x20                        ; 00542061
    MOV dword ptr [ESP + 0x11c],ECX     ; 00542064 | undefined4 DAT_02f98ad4
    MOV dword ptr [ESP + 0x118],EAX     ; 0054206b
    MOV EAX,dword ptr [ESP + 0x11c]     ; 00542072
        ;   Label: LAB_00542072
    MOV EDX,dword ptr [0x02f7c8b8]      ; 00542079 | uint g_CurrentGameTime
    MOV dword ptr [ESP + 0x12c],EAX     ; 0054207f | undefined4 DAT_02f98ad4
    MOV EAX,dword ptr [EAX]             ; 00542086 | undefined4 DAT_02f98ad4
    SUB EDX,EAX                         ; 00542088
    MOV dword ptr [ESP + 0x140],EDX     ; 0054208a
    MOV EBX,0x1                         ; 00542091
    FILD dword ptr [ESP + 0x140]        ; 00542096
    FMUL double ptr [0x0063db1d]        ; 0054209d | double DOUBLE_0063db1d
    ...
    FNSTSW AX                           ; 005420b2
    SAHF                                ; 005420b4
    JA 0x00542239                       ; 005420b5 | LAB_00542239
        ;   XREF to: 00542239 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x4]           ; 005420bb
        ;   Label: LAB_005420bb
    FCOMP double ptr [0x0063db2d]       ; 005420bf | double DOUBLE_0063db2d
    FNSTSW AX                           ; 005420c5
    SAHF                                ; 005420c7
    JBE 0x005420d2                      ; 005420c8 | LAB_005420d2
        ;   XREF to: 005420d2 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x4],0x41f00000 ; 005420ca
    FLD float ptr [ESP + 0x4]           ; 005420d2
        ;   Label: LAB_005420d2
    FCOMP double ptr [0x0063db35]       ; 005420d6 | double DOUBLE_0063db35
    FNSTSW AX                           ; 005420dc
    SAHF                                ; 005420de
    JNC 0x0054219a                      ; 005420df | LAB_0054219a
    ...
    JLE 0x0054219a                      ; 005420f5 | LAB_0054219a
        ;   XREF to: 0054219a (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x12c]     ; 005420fb
    ADD EAX,0x14                        ; 00542102
    MOV dword ptr [ESP + 0x124],EAX     ; 00542105 | undefined1 DAT_02f98ae8
    MOV EAX,dword ptr [ESP + 0x12c]     ; 0054210c
    MOV dword ptr [ESP + 0x138],EAX     ; 00542113 | undefined4 DAT_02f98ad4
    ...
    MOV EBX,dword ptr [ESP + 0x12c]     ; 0054212e | undefined4 DAT_02f98ad4
    MOV dword ptr [ESP + 0x13c],EAX     ; 00542135
    MOV EAX,dword ptr [ESP + 0x138]     ; 0054213c
        ;   Label: LAB_0054213c
    CMP byte ptr [EAX + 0x8],0x0        ; 00542143 | undefined1 DAT_02f98adc | DAT_02f98add
    JZ 0x00542244                       ; 00542147 | LAB_00542244
    ...
    ADD EBX,0x4                         ; 0054216c | undefined4 DAT_02f98ad8
    INC ECX                             ; 0054216f
    ADD ESI,0x78                        ; 00542170
    ADD EDI,0x78                        ; 00542173
    INC EAX                             ; 00542176
    MOV dword ptr [ESP + 0x138],ECX     ; 00542177 | DAT_02f98ad4+1
    ...
    JL 0x0054213c                       ; 00542198 | LAB_0054213c
        ;   XREF to: 0054213c (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x128],0x0     ; 0054219a
        ;   Label: LAB_0054219a
    JZ 0x00542348                       ; 005421a2 | LAB_00542348
        ;   XREF to: 00542348 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [ESP + 0x120]     ; 005421a8
    TEST EBX,EBX                        ; 005421af
    JL 0x005421bb                       ; 005421b1 | LAB_005421bb
        ;   XREF to: 005421bb (CONDITIONAL_JUMP)
    CMP EBX,dword ptr [0x02f98ad0]      ; 005421b3 | undefined4 DAT_02f98ad0
    JL 0x005421dd                       ; 005421b9 | LAB_005421dd
        ;   XREF to: 005421dd (CONDITIONAL_JUMP)
    MOV EAX,0x63d245                    ; 005421bb | = "..\\core\\netgame.cpp" | s_core_netgame_cpp_0063d245 = ..\core\netgame.cpp
        ;   Label: LAB_005421bb
    MOV EDX,0x107                       ; 005421c0
    PUSH 0x63d259                       ; 005421c5 | = "removeChatOut - invalid index" | s_removeChatOut_invalid_in_0063d259 = removeChatOut - invalid index
    MOV [0x02f0ca48],EAX                ; 005421ca | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 005421cf | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005421d5 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005421da
    MOV ECX,dword ptr [0x02f98ad0]      ; 005421dd | undefined4 DAT_02f98ad0
        ;   Label: LAB_005421dd
    DEC ECX                             ; 005421e3
    ...
    ADD EAX,0x2f98ad4                   ; 005421f8 | undefined4 DAT_02f98ad4
    PUSH EAX                            ; 005421fd
    IMUL EAX,EBX,0x114                  ; 005421fe
    ADD EAX,0x2f98ad4                   ; 00542204 | undefined4 DAT_02f98ad4
    PUSH EAX                            ; 00542209
    MOV dword ptr [0x02f98ad0],ECX      ; 0054220a | undefined4 DAT_02f98ad0
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 00542210 | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
        ;   XREF to: 005fe5e0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00542215
    MOV EAX,dword ptr [ESP + 0x120]     ; 00542218
        ;   Label: LAB_00542218
    CMP EAX,dword ptr [0x02f98ad0]      ; 0054221f | undefined4 DAT_02f98ad0
    JL 0x00542072                       ; 00542225 | LAB_00542072
    ...
    FMUL double ptr [0x0063db25]        ; 00542250 | double DOUBLE_0063db25
    MOV dword ptr [ESP + 0x128],ESI     ; 00542256
    FST float ptr [ESP + 0x8]           ; 0054225d
    FCOMP double ptr [0x0063db3d]       ; 00542261 | double DOUBLE_0063db3d
    FNSTSW AX                           ; 00542267
    SAHF                                ; 00542269
    JNC 0x00542274                      ; 0054226a | LAB_00542274
        ;   XREF to: 00542274 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x8],0x40000000 ; 0054226c
    FLD float ptr [ESP + 0x8]           ; 00542274
        ;   Label: LAB_00542274
    FCOMP double ptr [0x0063db45]       ; 00542278 | double DOUBLE_0063db45
    FNSTSW AX                           ; 0054227e
    SAHF                                ; 00542280
    JBE 0x0054228b                      ; 00542281 | LAB_0054228b
        ;   XREF to: 0054228b (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x8],0x40a00000 ; 00542283
    MOV EDX,dword ptr [0x02f7c8b8]      ; 0054228b | uint g_CurrentGameTime
        ;   Label: LAB_0054228b
    ...
    FMUL double ptr [0x0063db1d]        ; 005422a4 | double DOUBLE_0063db1d
    FST float ptr [ESP]                 ; 005422aa
    FLDZ                                ; 005422ad
    FCOMPP                              ; 005422af
    FNSTSW AX                           ; 005422b1
    SAHF                                ; 005422b3
    JBE 0x005422bb                      ; 005422b4 | LAB_005422bb
        ;   XREF to: 005422bb (CONDITIONAL_JUMP)
    XOR EDX,EDX                         ; 005422b6
    MOV dword ptr [ESP],EDX             ; 005422b8
    FLD float ptr [ESP]                 ; 005422bb
        ;   Label: LAB_005422bb
    FCOMP double ptr [0x0063db2d]       ; 005422be | double DOUBLE_0063db2d
    FNSTSW AX                           ; 005422c4
    SAHF                                ; 005422c6
    JBE 0x005422d0                      ; 005422c7 | LAB_005422d0
    ...
    FNSTSW AX                           ; 005422d7
    SAHF                                ; 005422d9
    JBE 0x0054214d                      ; 005422da | LAB_0054214d
    ...
    MOV EAX,dword ptr [EAX + 0x4]       ; 005422fa | undefined4 DAT_02f98ad8
    MOV ESI,dword ptr [ESP + 0x124]     ; 005422fd
    MOV dword ptr [ESP + 0x11],EAX      ; 00542304
    PUSH EDI                            ; 00542308
    MOV AL,byte ptr [ESI]               ; 00542309 | undefined1 DAT_02f98ae8 | DAT_02f98aea
        ;   Label: LAB_00542309
    MOV byte ptr [EDI],AL               ; 0054230b
    CMP AL,0x0                          ; 0054230d
    JZ 0x00542321                       ; 0054230f | LAB_00542321
        ;   XREF to: 00542321 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 00542311 | undefined1 DAT_02f98ae9 | DAT_02f98aeb
    ADD ESI,0x2                         ; 00542314
    MOV byte ptr [EDI + 0x1],AL         ; 00542317
    ADD EDI,0x2                         ; 0054231a
    CMP AL,0x0                          ; 0054231d
    JNZ 0x00542309                      ; 0054231f | LAB_00542309
    ...
    PUSH EAX                            ; 00542332
    CALL core_netgame.cpp_CNetGame_FUN_00541230 ; 00542333 | undefined core_netgame.cpp_CNetGame_FUN_00541230()
        ;   XREF to: 00541230 (UNCONDITIONAL_CALL)
    MOV EAX,[0x02f7c8b8]                ; 00542338 | uint g_CurrentGameTime
    ADD ESP,0xc                         ; 0054233d
    MOV dword ptr [EBX + 0xc],EAX       ; 00542340 | DAT_02f98ae0 | DAT_02f98ae4
    JMP 0x0054214d                      ; 00542343 | LAB_0054214d
    ...
    JMP 0x00542218                      ; 0054236b | LAB_00542218
