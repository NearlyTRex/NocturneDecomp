...
section .text
    ...
    PUSH ESI                            ; 0053f780
        ;   Label: core_netgame.cpp_CNetGame_init_FUN_0053f780
    PUSH EDI                            ; 0053f781
    ...
    MOV dword ptr [0x02f98ad0],ECX      ; 0053f800 | g_ChatOutCount
    CALL core_netgame.cpp_CNetGame_disconnect_FUN_0053fd00 ; 0053f806
