...
;   undefined4 s_Local_0063d9f8+1
;   undefined4 s_Local_0063d9f8+2
;   undefined4 s_Local_0063d9f8+3
;   TerminatedCString s_Local_0063da00
;   undefined4 s_Local_0063da00+1
;   ... and 49 more
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 00541390
        ;   Label: core_netgame.cpp_CNetGame_runLobby_FUN_00541390
    PUSH ESI                            ; 00541391
    PUSH EDI                            ; 00541392
    PUSH EBP                            ; 00541393
    ...
    MOV ESI,dword ptr [0x02f7c8c4]      ; 00541459 | INT_02f7c8c4
    PUSH ESI                            ; 0054145f
    ...
    MOV EAX,dword ptr [ESI + 0x1c]      ; 0054156d | g_CNetGameInstance.players[0].addr.ip_address
    ...
    PUSH EDI                            ; 00541584
    MOV AL,byte ptr [ESI]               ; 00541585 | = "(Local)" | s_Local_0063d9f8+2
        ;   Label: LAB_00541585
    MOV byte ptr [EDI],AL               ; 00541587
    CMP AL,0x0                          ; 00541589
    JZ 0x0054159d                       ; 0054158b
        ;   XREF to: 0054159d (CONDITIONAL_JUMP)  ; LAB_0054159d
    MOV AL,byte ptr [ESI + 0x1]         ; 0054158d | s_Local_0063d9f8+1 | s_Local_0063d9f8+3
    ...
    LEA EDI,[ESP + 0x8]                 ; 005415cb
        ;   Label: LAB_005415cb
    PUSH EDI                            ; 005415cf
    MOV AL,byte ptr [ESI]               ; 005415d0 | = "(Local)" | s_Local_0063da00+2 | s_anon_0063da0d
        ;   Label: LAB_005415d0
    MOV byte ptr [EDI],AL               ; 005415d2
    CMP AL,0x0                          ; 005415d4
    JZ 0x005415e8                       ; 005415d6
        ;   XREF to: 005415e8 (CONDITIONAL_JUMP)  ; LAB_005415e8
    MOV AL,byte ptr [ESI + 0x1]         ; 005415d8 | s_Local_0063da00+1 | s_Local_0063da00+3 | s_anon_0063da0d+1
    ...
    LEA EDI,[ESP + 0x8]                 ; 00541612
        ;   Label: LAB_00541612
    PUSH EDI                            ; 00541616
    MOV AL,byte ptr [ESI]               ; 00541617 | = "Ready" | s_Ready_0063da0f+2 | s_Not_ready_0063da15
        ;   Label: LAB_00541617
    MOV byte ptr [EDI],AL               ; 00541619
    CMP AL,0x0                          ; 0054161b
    JZ 0x0054162f                       ; 0054161d
        ;   XREF to: 0054162f (CONDITIONAL_JUMP)  ; LAB_0054162f
    MOV AL,byte ptr [ESI + 0x1]         ; 0054161f | s_Ready_0063da0f+1 | s_Ready_0063da0f+3 | s_Not_ready_0063da15+1
    ...
    PUSH EBX                            ; 005416db
    CALL core_netgame.cpp_CNetGame_disconnect_FUN_0053fd00 ; 005416dc
    ...
    MOV EAX,[0x02f7c8c4]                ; 0054188d | INT_02f7c8c4
    ...
    MOV EDX,dword ptr [0x02f7c8c4]      ; 005418b3 | INT_02f7c8c4
        ;   Label: LAB_005418b3
    ...
    CMP dword ptr [0x00680a04],0x0      ; 00541a16 | INT_00680a04
    ...
    MOV [0x02f7c8c8],EAX                ; 00541c0a | UINT_02f7c8c8
    ...
    CALL core_netgame.cpp_CNetGame_processChatOut_FUN_00541e40 ; 00541c6b
        ;   XREF to: 00541e40 (UNCONDITIONAL_CALL)  ; void core_netgame.cpp_CNetGame_processChatOut_FUN_00541e40(CNetGame * this_ptr, char * message, int target_player)
