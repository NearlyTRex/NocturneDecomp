...

{
  ...
  case '\x01':
    ...
    if ((int)uVar2 < 0) {
      ...
      if (((iVar5 != 0) || (*(int *)((int)local_24 + 0x21) != *(int *)(local_18 + 0x14))) ||
         (*(int *)((int)local_24 + 0x25) != *(int *)(local_18 + 0x18))) {
        pcVar7 = (char *)((int)local_24 + 0xd);
        pcVar8 = local_18;
        do {
          cVar1 = *pcVar7;
          *pcVar8 = cVar1;
        ...
        *(uint *)(local_18 + 0x14) = *(uint *)((int)local_24 + 0x21);
        *(uint *)(local_18 + 0x18) = *(uint *)((int)local_24 + 0x25);
    ...
    uStack_77 = source_addr->ip_address;
    *(uint *)(auStack_73 + (uint)bVar11 * -8) =
         *(uint *)&source_addr[-(uint)bVar11].port;
    core_netgame_cpp_CNetGame_send_FUN_005411c0();
    iVar5 = this_ptr->local_player_index;
    *(uint *)(this_ptr->players[iVar5].name + 0x1c) = *(uint *)(local_20 + 5);
    *(uint *)((int)this_ptr + (uint)bVar11 * -8 + iVar5 * 0x78 + 0x40) =
         *(uint *)(local_20 + 9 + (uint)bVar11 * -8);
    return;
  case '\x02':
...
LAB_00540df8:
  ...
  case '\r':
    ...
    if (((this_ptr->connection_type == 2) && (-1 < (int)uVar2)) &&
      ...
      support_trisock_cpp_createNetworkAddr_FUN_005e1940(&SStack_30,(uint32_t *)g_AnyAddressIP,0);
      core_netgame_cpp_CNetGame_FUN_00542370();
      return;
    }
    break;
  case '\x0f':
    ...
    SStack_30._4_4_ = *(uint *)(packet_data + 5);
    uVar2 = uVar2 ^ *(uint *)this_ptr->padding;
    if (0 < g_SimFrameCount) {
      local_14 = g_SimFrameCount;
      iVar5 = 0;
      do {
        if (SStack_30._4_4_ == *(int *)((int)&g_SimFrameHistory + iVar5)) {
          if (-1 < (int)uVar2) {
