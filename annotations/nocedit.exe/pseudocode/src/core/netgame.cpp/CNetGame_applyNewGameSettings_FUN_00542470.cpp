      ...
      if (iVar5 == local_113) {
        ...
        *(int *)((int)local_44 + local_44[2]) = iVar5;
        ...
        if (local_44[3] == this_ptr->local_player_index) {
          ...
          iVar13 = _strcmp(local_24->name,pcVar7);
          if (iVar13 != 0) {
            INT_00680a04 = 1;
          }
          if (local_28->players[0].ready_flag == aEStack_f3[iVar5 * 10 + 2]) {
          ...
          this_ptr->players[local_44[3]].ready_flag = aEStack_f3[iVar5 * 10 + 2];
          this_ptr->players[local_44[3]].hero_number = aEStack_f3[iVar5 * 10];
          this_ptr->players[local_44[3]].aim_mode = aEStack_f3[iVar5 * 10 + 1];
        }
LAB_005429ed:
        local_24 = local_24 + 1;
  ...
  if (0 < local_113) {
    iVar13 = 0;
    do {
      if (local_10f[iVar13] == '\0') break;
      iVar4 = core_netgame_cpp_CNetGame_addPlayer_FUN_005412b0
                        (this_ptr,(SNetworkAddr *)((int)&local_fb.ip_address + iVar13),
                         local_10f + iVar13,*(int *)((int)aEStack_f3 + iVar13),
                         *(int *)((int)aEStack_f3 + iVar13 + 4));
      this_ptr->players[iVar4].ready_flag = *(int *)((int)aEStack_f3 + iVar13 + 8);
        ...
        do {
          ...
          if (*(int *)((int)local_44 + local_44[4] + 4) < *(int *)((int)local_44 + local_44[4])) {
            ...
            *pEVar15 = *pEVar9;
            ...
            local_a8 = pSVar16->hero_number;
            local_a4 = pSVar16->aim_mode;
