...
section .text
    ...
    PUSH EDI                            ; 00541e42
    PUSH EBP                            ; 00541e43
    MOV EDI,dword ptr [0x02f7c8b8]      ; 00541e44 | uint g_CurrentGameTime
    MOV ESI,dword ptr [ESP + 0x14]      ; 00541e4a
    MOV EBX,dword ptr [ESP + 0x1c]      ; 00541e4e
    CMP dword ptr [0x02f98ad0],0x32     ; 00541e52 | undefined4 DAT_02f98ad0
    JGE 0x00541f7f                      ; 00541e59 | LAB_00541f7f
        ;   XREF to: 00541f7f (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x02f98ad0]      ; 00541e5f | undefined4 DAT_02f98ad0
        ;   Label: LAB_00541e5f
    ...
    MOV EBP,0x2f98ad4                   ; 00541e71 | undefined4 DAT_02f98ad4
    SHL EAX,0x2                         ; 00541e76
    ADD EBP,EAX                         ; 00541e79
    LEA EAX,[EDX + 0x1]                 ; 00541e7b
    MOV [0x02f98ad0],EAX                ; 00541e7e | undefined4 DAT_02f98ad0
    CALL wincore_winrun.cpp_getTime_FUN_005f2dc0 ; 00541e83 | int wincore_winrun.cpp_getTime_FUN_005f2dc0()
        ;   XREF to: 005f2dc0 (UNCONDITIONAL_CALL)
    MOV EDX,EAX                         ; 00541e88
    MOV ECX,0x12                        ; 00541e8a
    SAR EDX,0x1f                        ; 00541e8f
    IDIV ECX                            ; 00541e92
    MOV ECX,dword ptr [0x02f7c8b4]      ; 00541e94 | int g_LastPingTime
    MOV EDX,EAX                         ; 00541e9a
    SUB EAX,ECX                         ; 00541e9c
    MOV dword ptr [0x02f7c8b4],EDX      ; 00541e9e | int g_LastPingTime
    TEST EAX,EAX                        ; 00541ea4
    JL 0x00541fa7                       ; 00541ea6 | LAB_00541fa7
        ;   XREF to: 00541fa7 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [0x02f7c8b8]      ; 00541eac | uint g_CurrentGameTime
    CMP EAX,0x20000                     ; 00541eb2
    JLE 0x00541ebe                      ; 00541eb7 | LAB_00541ebe
        ;   XREF to: 00541ebe (CONDITIONAL_JUMP)
    MOV EAX,0x20000                     ; 00541eb9
    ADD EDI,EAX                         ; 00541ebe
        ;   Label: LAB_00541ebe
    MOV EAX,[0x02f9c0bc]                ; 00541ec0 | undefined4 DAT_02f9c0bc
    PUSH 0x2                            ; 00541ec5
    INC EAX                             ; 00541ec7
    PUSH 0x1                            ; 00541ec8
    MOV [0x02f9c0bc],EAX                ; 00541eca | undefined4 DAT_02f9c0bc
    MOV dword ptr [EBP + 0x4],EAX       ; 00541ecf | undefined4 DAT_02f98ad8
    LEA EAX,[EBP + 0x8]                 ; 00541ed2
    PUSH EAX                            ; 00541ed5
    MOV dword ptr [0x02f7c8b8],EDI      ; 00541ed6 | uint g_CurrentGameTime
    MOV dword ptr [EBP],EDI             ; 00541edc | undefined4 DAT_02f98ad4
    CALL crt_memory.c_memset_FUN_005fde40 ; 00541edf | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
        ;   XREF to: 005fde40 (UNCONDITIONAL_CALL)
    MOV EDI,dword ptr [0x02f7c8b8]      ; 00541ee4 | uint g_CurrentGameTime
    ADD ESP,0xc                         ; 00541eea
    TEST EBX,EBX                        ; 00541eed
    JL 0x00541fb4                       ; 00541eef | LAB_00541fb4
    ...
    PUSH EBX                            ; 00541f20
    MOV dword ptr [0x02f7c8b8],EDI      ; 00541f21 | uint g_CurrentGameTime
    MOV byte ptr [EAX + EBP*0x1 + 0x8],0x1 ; 00541f27
    CALL crt_memory.c_memset_FUN_005fde40 ; 00541f2c | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
        ;   XREF to: 005fde40 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00541f3d
    PUSH EBX                            ; 00541f3e
    CALL crt_string.c_strncpy_FUN_00600f40 ; 00541f3f | char * crt_string.c_strncpy_FUN_00600f40(char * dest, char * src, SIZE_T count)
    ...
    MOV EDX,dword ptr [EBP + 0x4]       ; 00541f52 | undefined4 DAT_02f98ad8
    ...
    PUSH EAX                            ; 00541f6a
    PUSH ESI                            ; 00541f6b
    CALL core_netgame.cpp_CNetGame_FUN_00542370 ; 00541f6c | undefined core_netgame.cpp_CNetGame_FUN_00542370()
        ;   XREF to: 00542370 (UNCONDITIONAL_CALL)
    MOV EDI,dword ptr [0x02f7c8b8]      ; 00541f71 | uint g_CurrentGameTime
    ...
    POP EBX                             ; 00541f7d
    RET                                 ; 00541f7e
    MOV ECX,0x63dac5                    ; 00541f7f | = "..\\core\\netgame.cpp" | s_core_netgame_cpp_0063dac5 = ..\core\netgame.cpp
        ;   Label: LAB_00541f7f
    MOV EBP,0x76c                       ; 00541f84
    PUSH 0x63dad9                       ; 00541f89 | = "CNetGame::processChatOut - too many p..." | s_CNetGame_processChatOut__0063dad9 = CNetGame::processChatOut - too many pending outgoing chat messages
    MOV dword ptr [0x02f0ca48],ECX      ; 00541f8e | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBP      ; 00541f94 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00541f9a | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00541f9f
    JMP 0x00541e5f                      ; 00541fa2 | LAB_00541e5f
        ;   XREF to: 00541e5f (UNCONDITIONAL_JUMP)
    MOV EDI,dword ptr [0x02f7c8b8]      ; 00541fa7 | uint g_CurrentGameTime
        ;   Label: LAB_00541fa7
    XOR EAX,EAX                         ; 00541fad
    JMP 0x00541ebe                      ; 00541faf | LAB_00541ebe
        ;   XREF to: 00541ebe (UNCONDITIONAL_JUMP)
    MOV EDX,dword ptr [ESI + 0x1c]      ; 00541fb4
        ;   Label: LAB_00541fb4
    XOR EAX,EAX                         ; 00541fb7
    TEST EDX,EDX                        ; 00541fb9
    JLE 0x00541f10                      ; 00541fbb | LAB_00541f10
