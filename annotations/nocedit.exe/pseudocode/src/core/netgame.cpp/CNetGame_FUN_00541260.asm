...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_netgame_cpp_CNetGame_FUN_00541260(CNetGame *this_ptr)
;
; Parameters:
...
section .text
    ...
    JLE 0x00541293                      ; 00541273
        ;   XREF to: 00541293 (CONDITIONAL_JUMP)  ; LAB_00541293
    LEA EAX,[EDI + 0x3c]                ; 00541275
    MOV CX,word ptr [EAX + 0x4]         ; 00541278
        ;   Label: LAB_00541278
    CMP CX,word ptr [ESI + 0x4]         ; 0054127c
    JNZ 0x00541288                      ; 00541280
        ;   XREF to: 00541288 (CONDITIONAL_JUMP)  ; LAB_00541288
    MOV EBP,dword ptr [EAX]             ; 00541282
    CMP EBP,dword ptr [ESI]             ; 00541284
    JZ 0x0054129d                       ; 00541286
        ;   XREF to: 0054129d (CONDITIONAL_JUMP)  ; LAB_0054129d
    INC EDX                             ; 00541288
        ;   Label: LAB_00541288
    MOV EBX,dword ptr [EDI + 0x1c]      ; 00541289
    ADD EAX,0x78                        ; 0054128c
    CMP EDX,EBX                         ; 0054128f
    JL 0x00541278                       ; 00541291
        ;   XREF to: 00541278 (CONDITIONAL_JUMP)  ; LAB_00541278
