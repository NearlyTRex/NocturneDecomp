...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_netgame_cpp_CNetGame_FUN_0053f780(CNetGame *this_ptr)
;
; Parameters:
...
section .text
    ...
    CALL wincore_winrun.cpp_getTime_FUN_005f2dc0 ; 0053f79a
    ...
    IDIV ESI                            ; 0053f7a9
    MOV [0x02f7c8b4],EAX                ; 0053f7ab | g_LastPingTime
    CALL support_trisock.cpp_startupWinsock_FUN_005e1ec0 ; 0053f7b0
        ;   XREF to: 005e1ec0 (UNCONDITIONAL_CALL)  ; int support_trisock.cpp_startupWinsock_FUN_005e1ec0()
    PUSH 0x63d2c7                       ; 0053f7b5 | = "USERNAME"
    CALL crt_env.c_getenv_FUN_006013f0  ; 0053f7ba
    ...
    JZ 0x0053f811                       ; 0053f7c6
        ;   XREF to: 0053f811 (CONDITIONAL_JUMP)  ; LAB_0053f811
    TEST ESI,ESI                        ; 0053f7c8
        ;   Label: LAB_0053f7c8
    JNZ 0x0053f7d1                      ; 0053f7ca
        ;   XREF to: 0053f7d1 (CONDITIONAL_JUMP)  ; LAB_0053f7d1
    MOV ESI,0x63d2dd                    ; 0053f7cc | = "MyComputer"
    MOV EDI,dword ptr [ESP + 0xc]       ; 0053f7d1
        ;   Label: LAB_0053f7d1
    ADD EDI,0x8                         ; 0053f7d5
    XOR ECX,ECX                         ; 0053f7d8
    PUSH EDI                            ; 0053f7da
    MOV AL,byte ptr [ESI]               ; 0053f7db | = "MyComputer" | s_Computer_0063d2df
        ;   Label: LAB_0053f7db
    MOV byte ptr [EDI],AL               ; 0053f7dd
    CMP AL,0x0                          ; 0053f7df
    JZ 0x0053f7f3                       ; 0053f7e1
        ;   XREF to: 0053f7f3 (CONDITIONAL_JUMP)  ; LAB_0053f7f3
    MOV AL,byte ptr [ESI + 0x1]         ; 0053f7e3 | s_yComputer_0063d2de | s_omputer_0063d2e0
    ADD ESI,0x2                         ; 0053f7e6
    MOV byte ptr [EDI + 0x1],AL         ; 0053f7e9
    ADD EDI,0x2                         ; 0053f7ec
    CMP AL,0x0                          ; 0053f7ef
    JNZ 0x0053f7db                      ; 0053f7f1
        ;   XREF to: 0053f7db (CONDITIONAL_JUMP)  ; LAB_0053f7db
    POP EDI                             ; 0053f7f3
        ;   Label: LAB_0053f7f3
    PUSH ECX                            ; 0053f7f4
    MOV ESI,dword ptr [ESP + 0x10]      ; 0053f7f5
    PUSH ESI                            ; 0053f7f9
    MOV dword ptr [0x02f7c8cc],ECX      ; 0053f7fa | g_ChatHistoryCount
    MOV dword ptr [0x02f98ad0],ECX      ; 0053f800 | DAT_02f98ad0
    CALL core_netgame.cpp_CNetGame_FUN_0053fd00 ; 0053f806
        ;   XREF to: 0053fd00 (UNCONDITIONAL_CALL)  ; void core_netgame.cpp_CNetGame_FUN_0053fd00(CNetGame * this_ptr)
    ADD ESP,0x8                         ; 0053f80b
    POP EDI                             ; 0053f80e
    POP ESI                             ; 0053f80f
    RET                                 ; 0053f810
    PUSH 0x63d2d0                       ; 0053f811 | = "COMPUTERNAME"
        ;   Label: LAB_0053f811
    CALL crt_env.c_getenv_FUN_006013f0  ; 0053f816
        ;   XREF to: 006013f0 (UNCONDITIONAL_CALL)  ; char * crt_env.c_getenv_FUN_006013f0(char * name)
    ADD ESP,0x4                         ; 0053f81b
    MOV ESI,EAX                         ; 0053f81e
    JMP 0x0053f7c8                      ; 0053f820
        ;   XREF to: 0053f7c8 (UNCONDITIONAL_JUMP)  ; LAB_0053f7c8
