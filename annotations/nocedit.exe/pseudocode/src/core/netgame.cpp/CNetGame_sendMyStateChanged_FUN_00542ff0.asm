...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_netgame.cpp_CNetGame_sendMyStateChanged_FUN_00542ff0()
;
; Local Variables:
...
section .text
    ...
    JNZ 0x00543006                      ; 00542ffe | LAB_00543006
        ;   XREF to: 00543006 (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x4],0x1       ; 00543000
    JZ 0x00543029                       ; 00543004 | LAB_00543029
        ;   XREF to: 00543029 (CONDITIONAL_JUMP)
    MOV ESI,0x63dd48                    ; 00543006 | = "..\\core\\netgame.cpp" | s_core_netgame_cpp_0063dd48 = ..\core\netgame.cpp
        ;   Label: LAB_00543006
    MOV EDI,0x8d0                       ; 0054300b
    PUSH 0x63dd5c                       ; 00543010 | = "CNetGame::sendMyStateChanged - should..." | s_CNetGame_sendMyStateChan_0063dd5c = CNetGame::sendMyStateChanged - should only call this in client lobby mode
    MOV dword ptr [0x02f0ca48],ESI      ; 00543015 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 0054301b | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00543021 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00543026
    CALL wincore_winrun.cpp_getTime_FUN_005f2dc0 ; 00543029 | int wincore_winrun.cpp_getTime_FUN_005f2dc0()
        ;   Label: LAB_00543029
    ...
    IDIV ESI                            ; 00543038
    MOV EBP,dword ptr [0x02f7c8b4]      ; 0054303a | int g_LastPingTime
    MOV EDX,EAX                         ; 00543040
    SUB EAX,EBP                         ; 00543042
    MOV dword ptr [0x02f7c8b4],EDX      ; 00543044 | int g_LastPingTime
    TEST EAX,EAX                        ; 0054304a
    JL 0x0054313e                       ; 0054304c | LAB_0054313e
        ;   XREF to: 0054313e (CONDITIONAL_JUMP)
    CMP EAX,0x20000                     ; 00543052
    JLE 0x0054305e                      ; 00543057 | LAB_0054305e
        ;   XREF to: 0054305e (CONDITIONAL_JUMP)
    MOV EAX,0x20000                     ; 00543059
    MOV EDX,dword ptr [0x02f7c8b8]      ; 0054305e | uint g_CurrentGameTime
        ;   Label: LAB_0054305e
    ...
    MOV dword ptr [0x02f7c8b8],EDX      ; 0054307d | uint g_CurrentGameTime
    ...
    MOV EAX,[0x02f7c8b8]                ; 00543092 | uint g_CurrentGameTime
    ...
    CMP AL,0x0                          ; 005430e9
    JZ 0x005430fd                       ; 005430eb | LAB_005430fd
    ...
    CMP AL,0x0                          ; 005430f9
    JNZ 0x005430e5                      ; 005430fb | LAB_005430e5
    ...
    PUSH ESI                            ; 00543107
    PUSH EBX                            ; 00543108
    CALL core_netgame.cpp_CNetGame_send_FUN_005411c0 ; 00543109 | undefined core_netgame.cpp_CNetGame_send_FUN_005411c0()
    ...
    MOV EAX,[0x02f7c8b8]                ; 00543128 | uint g_CurrentGameTime
    MOV dword ptr [0x00680a04],EDI      ; 0054312d | undefined4 DAT_00680a04
    ...
    XOR EAX,EAX                         ; 0054313e
        ;   Label: LAB_0054313e
    JMP 0x0054305e                      ; 00543140 | LAB_0054305e
