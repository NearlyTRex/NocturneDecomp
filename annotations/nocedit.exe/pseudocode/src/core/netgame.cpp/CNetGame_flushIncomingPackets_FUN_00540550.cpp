// Name: core_netgame.cpp_CNetGame_flushIncomingPackets_FUN_00540550
// Address: 00540550
// Address Range: [[00540550, 005405ac]]
// Convention: __cdecl
// Signature: void __cdecl core_netgame_cpp_CNetGame_flushIncomingPackets_FUN_00540550(CNetGame *this_ptr)
  ...
  do {
    ...
    do {
      iVar3 = support_trisock_cpp_receiveSocketData_FUN_005e1c20
                        (&this_ptr->socket,g_NetworkReceivePacket.raw,0x405,(SNetworkAddr *)0x0);
      if (iVar3 < 1) {
