...
section .text
    ...
    JNZ 0x00543720                      ; 005435b2 | LAB_00543720
        ;   XREF to: 00543720 (CONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0x4],0x3       ; 005435b8
    JNZ 0x00543720                      ; 005435bc | LAB_00543720
        ;   XREF to: 00543720 (CONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0x110],0x0     ; 005435c2
    JL 0x00543720                       ; 005435c9 | LAB_00543720
        ;   XREF to: 00543720 (CONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0x114],0x0     ; 005435cf
    JL 0x00543727                       ; 005435d6 | LAB_00543727
    ...
    PUSH ECX                            ; 005435e7
    PUSH ESI                            ; 005435e8
    CALL core_netgame.cpp_CNetGame_updatePing_FUN_00541c80 ; 005435e9 | void core_netgame.cpp_CNetGame_updatePing_FUN_00541c80(CNetGame * this_ptr, int player_index, float max_ping)
        ;   XREF to: 00541c80 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005435ee
    PUSH ESI                            ; 005435f1
    CALL core_netgame.cpp_CNetGame_receivePackets_FUN_005405b0 ; 005435f2 | void core_netgame.cpp_CNetGame_receivePackets_FUN_005405b0(CNetGame * this_ptr)
        ;   XREF to: 005405b0 (UNCONDITIONAL_CALL)
    MOV EBX,dword ptr [ESI]             ; 005435f7
    ADD ESP,0x4                         ; 005435f9
    CMP EBX,0x2                         ; 005435fc
    JNZ 0x00543720                      ; 005435ff | LAB_00543720
        ;   XREF to: 00543720 (CONDITIONAL_JUMP)
    IMUL EAX,dword ptr [ESI + 0x114],0x78 ; 00543605
        ;   Label: LAB_00543605
    MOV ECX,dword ptr [0x02f9c0c0]      ; 0054360c | int g_SimFrameCount
    MOV EBX,dword ptr [ESI + EAX*0x1 + 0x68] ; 00543612
    XOR EDX,EDX                         ; 00543616
    TEST ECX,ECX                        ; 00543618
    JLE 0x0054375a                      ; 0054361a | LAB_0054375a
        ;   XREF to: 0054375a (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 00543620
    IMUL ECX,ECX,0x64                   ; 00543622
    CMP EBX,dword ptr [EAX + 0x2f9c0c4] ; 00543625 | undefined4 g_SimFrameHistory | DAT_02f9c128
        ;   Label: LAB_00543625
    JNZ 0x0054374e                      ; 0054362b | LAB_0054374e
        ;   XREF to: 0054374e (CONDITIONAL_JUMP)
    TEST EDX,EDX                        ; 00543631
    JL 0x0054375a                       ; 00543633 | LAB_0054375a
        ;   XREF to: 0054375a (CONDITIONAL_JUMP)
    ADD EAX,0x2f9c0c4                   ; 00543639 | undefined4 DAT_02f9c128 | undefined4 g_SimFrameHistory
    PUSH EAX                            ; 0054363e | undefined4 g_SimFrameHistory | DAT_02f9c128
    PUSH ESI                            ; 0054363f
    CALL core_netgame.cpp_CNetGame_applySimFrameHistory_FUN_00543800 ; 00543640 | undefined core_netgame.cpp_CNetGame_applySimFrameHistory_FUN_00543800()
        ;   XREF to: 00543800 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00543645
    PUSH ESI                            ; 00543648
    CALL core_netgame.cpp_CNetGame_sendSimFrameAck_FUN_00543970 ; 00543649 | undefined core_netgame.cpp_CNetGame_sendSimFrameAck_FUN_00543970()
    ...
    MOV ECX,dword ptr [0x02f9c0c0]      ; 00543667 | int g_SimFrameCount
    MOV dword ptr [ESP + 0x4],EAX       ; 0054366d
    TEST ECX,ECX                        ; 00543671
    JLE 0x005436c5                      ; 00543673 | LAB_005436c5
        ;   XREF to: 005436c5 (CONDITIONAL_JUMP)
    MOV EAX,0x2f9c0c4                   ; 00543675 | undefined4 g_SimFrameHistory
    ADD EAX,0x64                        ; 0054367a
    XOR EBX,EBX                         ; 0054367d
    MOV dword ptr [ESP + 0x8],EAX       ; 0054367f | undefined4 DAT_02f9c128
    MOV ECX,dword ptr [ESP + 0x4]       ; 00543683
        ;   Label: LAB_00543683
    CMP ECX,dword ptr [EBX + 0x2f9c0c4] ; 00543687 | undefined4 g_SimFrameHistory
    JLE 0x005437cb                      ; 0054368d | LAB_005437cb
        ;   XREF to: 005437cb (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x02f9c0c0]      ; 00543693 | int g_SimFrameCount
    DEC EDX                             ; 00543699
    ...
    MOV EAX,0x2f9c0c4                   ; 005436a6 | undefined4 g_SimFrameHistory
    PUSH ECX                            ; 005436ab | undefined4 DAT_02f9c128
    ADD EAX,EBX                         ; 005436ac
    PUSH EAX                            ; 005436ae | undefined4 g_SimFrameHistory
    MOV dword ptr [0x02f9c0c0],EDX      ; 005436af | int g_SimFrameCount
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 005436b5 | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
        ;   XREF to: 005fe5e0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005436ba
    CMP EDI,dword ptr [0x02f9c0c0]      ; 005436bd | int g_SimFrameCount
        ;   Label: LAB_005436bd
    JL 0x00543683                       ; 005436c3 | LAB_00543683
    ...
    MOV EDX,dword ptr [0x02f9c0c0]      ; 005436e1 | int g_SimFrameCount
    MOV ECX,dword ptr [ESI + EAX*0x1 + 0x68] ; 005436e7
    TEST EDX,EDX                        ; 005436eb
    JLE 0x00543720                      ; 005436ed | LAB_00543720
        ;   XREF to: 00543720 (CONDITIONAL_JUMP)
    ...
    CMP ECX,dword ptr [EAX + 0x2f9c0c4] ; 00543706 | undefined4 g_SimFrameHistory | DAT_02f9c128
        ;   Label: LAB_00543706
    JNZ 0x005437df                      ; 0054370c | LAB_005437df
        ;   XREF to: 005437df (CONDITIONAL_JUMP)
    TEST EBX,EBX                        ; 00543712
    JL 0x00543720                       ; 00543714 | LAB_00543720
        ;   XREF to: 00543720 (CONDITIONAL_JUMP)
    ...
    POP EBX                             ; 00543725
    RET                                 ; 00543726
    MOV EAX,0x63df08                    ; 00543727 | = "..\\core\\netgame.cpp" | s_core_netgame_cpp_0063df08 = ..\core\netgame.cpp
        ;   Label: LAB_00543727
    MOV EDX,0x97c                       ; 0054372c
    PUSH 0x63df1c                       ; 00543731 | = "CNetGame::processClientFrame - I'm no..." | s_CNetGame_processClientFr_0063df1c = CNetGame::processClientFrame - I'm not in player list!
    MOV [0x02f0ca48],EAX                ; 00543736 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 0054373b | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00543741 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00543746
    JMP 0x005435dc                      ; 00543749 | LAB_005435dc
        ;   XREF to: 005435dc (UNCONDITIONAL_JUMP)
    ADD EAX,0x64                        ; 0054374e
        ;   Label: LAB_0054374e
    INC EDX                             ; 00543751
    CMP EAX,ECX                         ; 00543752
    JL 0x00543625                       ; 00543754 | LAB_00543625
        ;   XREF to: 00543625 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 0054375a
        ;   Label: LAB_0054375a
    CALL core_netgame.cpp_CNetGame_receivePackets_FUN_005405b0 ; 0054375b | void core_netgame.cpp_CNetGame_receivePackets_FUN_005405b0(CNetGame * this_ptr)
        ;   XREF to: 005405b0 (UNCONDITIONAL_CALL)
    MOV EBX,dword ptr [ESI]             ; 00543760
    ADD ESP,0x4                         ; 00543762
    CMP EBX,0x2                         ; 00543765
    JNZ 0x00543720                      ; 00543768 | LAB_00543720
        ;   XREF to: 00543720 (CONDITIONAL_JUMP)
    MOV EAX,[0x02f7c8c8]                ; 0054376a | undefined4 DAT_02f7c8c8
    MOV EDX,dword ptr [0x02f7c8b8]      ; 0054376f | uint g_CurrentGameTime
    SUB EDX,EAX                         ; 00543775
    MOV dword ptr [ESP + 0xc],EDX       ; 00543777
    FILD dword ptr [ESP + 0xc]          ; 0054377b
    FMUL double ptr [0x0063df55]        ; 0054377f | double DOUBLE_0063df55
    FST float ptr [ESP]                 ; 00543785
    FLDZ                                ; 00543788
    FCOMPP                              ; 0054378a
    FNSTSW AX                           ; 0054378c
    SAHF                                ; 0054378e
    JBE 0x00543796                      ; 0054378f | LAB_00543796
        ;   XREF to: 00543796 (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 00543791
    MOV dword ptr [ESP],EAX             ; 00543793
    FLD float ptr [ESP]                 ; 00543796
        ;   Label: LAB_00543796
    FCOMP double ptr [0x0063df5d]       ; 00543799 | double DOUBLE_0063df5d
    FNSTSW AX                           ; 0054379f
    SAHF                                ; 005437a1
    JBE 0x005437ab                      ; 005437a2 | LAB_005437ab
        ;   XREF to: 005437ab (CONDITIONAL_JUMP)
    MOV dword ptr [ESP],0x41f00000      ; 005437a4
    FLD float ptr [ESP]                 ; 005437ab
        ;   Label: LAB_005437ab
    FCOMP double ptr [0x0063df65]       ; 005437ae | double DOUBLE_0063df65
    FNSTSW AX                           ; 005437b4
    SAHF                                ; 005437b6
    JBE 0x00543605                      ; 005437b7 | LAB_00543605
        ;   XREF to: 00543605 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 005437bd
    CALL core_netgame.cpp_CNetGame_sendSimFrameAck_FUN_00543970 ; 005437be | undefined core_netgame.cpp_CNetGame_sendSimFrameAck_FUN_00543970()
        ;   XREF to: 00543970 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005437c3
    JMP 0x00543605                      ; 005437c6 | LAB_00543605
