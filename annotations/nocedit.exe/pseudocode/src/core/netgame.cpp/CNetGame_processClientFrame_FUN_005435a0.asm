...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_netgame_cpp_CNetGame_processClientFrame_FUN_005435a0(CNetGame *this_ptr)
;
; Parameters:
...
section .text
    ...
    CALL core_netgame.cpp_CNetGame_sendSimFrameAck_FUN_00543970 ; 00543649
        ;   XREF to: 00543970 (UNCONDITIONAL_CALL)  ; void core_netgame.cpp_CNetGame_sendSimFrameAck_FUN_00543970(CNetGame * this_ptr)
