...
;
; Called Functions:
;   core_netgame.cpp_assignInt2_FUN_00543e30
;
; *****************************************************************************
...
section .text
    ...
    JMP 0x006049c7                      ; 00543bc7
        ;   XREF to: 006049c7 (UNCONDITIONAL_JUMP)  ; LAB_006049c7
    JMP 0x03fc5b24                      ; 00543bcd
        ;   XREF to: 03fc5b24 (UNCONDITIONAL_JUMP)  ; LAB_03fc5b24
        ;   Label: LAB_00543bcd
    ...
    PUSH EAX                            ; 00543be4
    CALL core_netgame.cpp_assignInt2_FUN_00543e30 ; 00543be5
        ;   XREF to: 00543e30 (UNCONDITIONAL_CALL)  ; int * core_netgame.cpp_assignInt2_FUN_00543e30(int * dest, int * src)
    ...
    POP EBX                             ; 00543ca7
    RET                                 ; 00543ca8
    MOV ESI,EBX                         ; 006049c7
        ;   Label: LAB_006049c7
    MOV ECX,dword ptr [ESI]             ; 006049c9
    MOV dword ptr [EDI],ECX             ; 006049cb
    MOV ECX,dword ptr [ESI + 0x4]       ; 006049cd
    MOV dword ptr [EDI + 0x4],ECX       ; 006049d0
    MOV ECX,dword ptr [ESI + 0x8]       ; 006049d3
    MOV dword ptr [EDI + 0x8],ECX       ; 006049d6
    MOV ECX,dword ptr [ESI + 0xc]       ; 006049d9
    MOV dword ptr [EDI + 0xc],ECX       ; 006049dc
    ADD ESI,0x10                        ; 006049df
    ADD EDI,0x10                        ; 006049e2
    JMP 0x00543bcd                      ; 006049e5
        ;   XREF to: 00543bcd (UNCONDITIONAL_JUMP)  ; LAB_00543bcd
    MOV ECX,dword ptr [ESI]             ; 03fc5b24
        ;   Label: LAB_03fc5b24
    MOV dword ptr [EDI],ECX             ; 03fc5b26
    ADD ESI,0x4                         ; 03fc5b28
    ADD EDI,0x4                         ; 03fc5b2b
    MOV EAX,dword ptr [EBX + 0x14]      ; 03fc5b2e
    MOV dword ptr [ESP + 0x14],EAX      ; 03fc5b31
    JMP 0x00543bd5                      ; 03fc5b35
        ;   XREF to: 00543bd5 (UNCONDITIONAL_JUMP)  ; LAB_00543bd5
