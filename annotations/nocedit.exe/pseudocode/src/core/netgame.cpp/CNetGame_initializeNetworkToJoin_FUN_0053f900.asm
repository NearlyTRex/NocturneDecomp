...
section .text
    ...
    PUSH EBX                            ; 0053f900
        ;   Label: core_netgame.cpp_CNetGame_initializeNetworkToJoin_FUN_0053f900
    PUSH ESI                            ; 0053f901
    PUSH EDI                            ; 0053f902
    PUSH EBP                            ; 0053f903
    ...
    PUSH 0x0                            ; 0053f90f
    PUSH EBX                            ; 0053f911
    CALL core_netgame.cpp_CNetGame_disconnect_FUN_0053fd00 ; 0053f912
    ...
    CALL core_netgame.cpp_CNetGame_initializeNetwork_FUN_0053fbc0 ; 0053f960
    ...
    JMP 0x0060c4ce                      ; 0053fa5d
        ;   XREF to: 0060c4ce (UNCONDITIONAL_JUMP)  ; LAB_0060c4ce
    ...
    MOV EAX,[0x02f7c8bc]                ; 0053fac5 | g_ConnectionStatus
    ...
    PUSH 0x1                            ; 0053fb09
        ;   Label: LAB_0053fb09
    PUSH EBX                            ; 0053fb0b
    CALL core_netgame.cpp_CNetGame_disconnect_FUN_0053fd00 ; 0053fb0c
        ;   XREF to: 0053fd00 (UNCONDITIONAL_CALL)  ; void core_netgame.cpp_CNetGame_disconnect_FUN_0053fd00(CNetGame * this_ptr, int perform_handshake)
    ...
    PUSH 0x0                            ; 0053fb31
    PUSH EBX                            ; 0053fb33
    CALL core_netgame.cpp_CNetGame_disconnect_FUN_0053fd00 ; 0053fb34
        ;   XREF to: 0053fd00 (UNCONDITIONAL_CALL)  ; void core_netgame.cpp_CNetGame_disconnect_FUN_0053fd00(CNetGame * this_ptr, int perform_handshake)
    ...
    PUSH 0x0                            ; 0053fb59
    PUSH EBX                            ; 0053fb5b
    CALL core_netgame.cpp_CNetGame_disconnect_FUN_0053fd00 ; 0053fb5c
        ;   XREF to: 0053fd00 (UNCONDITIONAL_CALL)  ; void core_netgame.cpp_CNetGame_disconnect_FUN_0053fd00(CNetGame * this_ptr, int perform_handshake)
    ...
    PUSH 0x0                            ; 0053fb81
        ;   Label: LAB_0053fb81
    PUSH EBX                            ; 0053fb83
    CALL core_netgame.cpp_CNetGame_disconnect_FUN_0053fd00 ; 0053fb84
        ;   XREF to: 0053fd00 (UNCONDITIONAL_CALL)  ; void core_netgame.cpp_CNetGame_disconnect_FUN_0053fd00(CNetGame * this_ptr, int perform_handshake)
    ...
    POP EBX                             ; 0053fbb4
    RET                                 ; 0053fbb5
    MOV ECX,dword ptr [ESI]             ; 0060c4ce
        ;   Label: LAB_0060c4ce
    MOV dword ptr [EDI],ECX             ; 0060c4d0
    MOV ECX,dword ptr [ESI + 0x4]       ; 0060c4d2
    MOV dword ptr [EDI + 0x4],ECX       ; 0060c4d5
    ADD ESI,0x8                         ; 0060c4d8
    ADD EDI,0x8                         ; 0060c4db
    IMUL EAX,dword ptr [EBX + 0x114],0x78 ; 0060c4de
    JMP 0x0053fa66                      ; 0060c4e5
        ;   XREF to: 0053fa66 (UNCONDITIONAL_JUMP)  ; LAB_0053fa66
