...
section .text
    ...
    JL 0x00543890                       ; 0054380f | LAB_00543890
    ...
    MOV ESI,dword ptr [0x0067b654]      ; 00543826 | CGame * g_CGamePtr
    PUSH dword ptr [EAX + 0x8]          ; 0054382c
    PUSH ESI                            ; 0054382f | CGame g_CGameInstance
    CALL core_game.cpp_CGame_slamDT_FUN_004e3080 ; 00543830 | void core_game.cpp_CGame_slamDT_FUN_004e3080(CGame * this_ptr, float delta_time)
    ...
    JLE 0x00543870                      ; 0054383f | LAB_00543870
        ;   XREF to: 00543870 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x18]      ; 00543841
    XOR EBX,EBX                         ; 00543845
    MOV ESI,dword ptr [EBX + 0x2db87c0] ; 00543847 | CHero *[4] g_HeroActors
        ;   Label: LAB_00543847
    ...
    JL 0x00543847                       ; 00543869 | LAB_00543847
    ...
    POP EBX                             ; 0054388e
    RET                                 ; 0054388f
    MOV ECX,0x63df6d                    ; 00543890 | = "..\\core\\netgame.cpp" | s_core_netgame_cpp_0063df6d = ..\core\netgame.cpp
        ;   Label: LAB_00543890
    MOV EBX,0x9cd                       ; 00543895
    PUSH 0x63df81                       ; 0054389a | = "CNetGame::applySimFrameHistory - I'm ..." | s_CNetGame_applySimFrameHi_0063df81 = CNetGame::applySimFrameHistory - I'm not in the player list!
    MOV dword ptr [0x02f0ca48],ECX      ; 0054389f | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 005438a5 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005438ab | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005438b0
    JMP 0x00543815                      ; 005438b3 | LAB_00543815
