...
; Local Variables:
; EHeroType[1986]  Stack[-0x208c]:7944  aEStackY_208c
; uint             Stack[-0x167]:4  local_167
; char[80]         Stack[-0x163]:80  local_163
; int              Stack[-0x113]:4  local_113
; char[20]         Stack[-0x10f]:20  local_10f
; SNetworkAddr     Stack[-0xfb]:8  local_fb
; EHeroType[13]    Stack[-0xf3]:52  aEStack_f3
; undefined4       Stack[-0xbc]:4  local_bc
; EHeroType[4]     Stack[-0xb8]:16  aEStack_b8
; EHeroType        Stack[-0xa8]:4  local_a8
; int              Stack[-0xa4]:4  local_a4
; int              Stack[-0xa0]:4  local_a0
; ushort           Stack[-0x9c]:2  local_9c
...
; int[6]           Stack[-0x44]:24  local_44
; SNetworkAddr *   Stack[-0x2c]:4  local_2c
; CNetGame *       Stack[-0x28]:4  local_28
; SNetPlayer *     Stack[-0x24]:4  local_24
; SNetPlayer *     Stack[-0x20]:4  local_20
; int              Stack[-0x1c]:4  local_1c
; SNetworkAddr *   Stack[-0x18]:4  local_18
...
section .text
    ...
    JNZ 0x00542493                      ; 0054248b
        ;   XREF to: 00542493 (CONDITIONAL_JUMP)  ; LAB_00542493
    CMP dword ptr [EAX + 0x4],0x1       ; 0054248d
    JZ 0x005424b6                       ; 00542491
        ;   XREF to: 005424b6 (CONDITIONAL_JUMP)  ; LAB_005424b6
    MOV EBX,0x63db4d                    ; 00542493 | = "..\\core\\netgame.cpp"
        ;   Label: LAB_00542493
    MOV EDI,0x7e6                       ; 00542498
    PUSH 0x63db61                       ; 0054249d | = "CNetGame::applyNewGameSettings - shou..."
    MOV dword ptr [0x02f0ca48],EBX      ; 005424a2 | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 005424a8 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005424ae
    ...
    JLE 0x00542562                      ; 005424e5
        ;   XREF to: 00542562 (CONDITIONAL_JUMP)  ; LAB_00542562
    ...
    JL 0x0054252d                       ; 00542560
        ;   XREF to: 0054252d (CONDITIONAL_JUMP)  ; LAB_0054252d
    CMP dword ptr [ESP + 0x140],0x0     ; 00542562
        ;   Label: LAB_00542562
    JL 0x00542935                       ; 0054256a
        ;   XREF to: 00542935 (CONDITIONAL_JUMP)  ; LAB_00542935
    TEST EBP,EBP                        ; 00542570
    JL 0x00542935                       ; 00542572
        ;   XREF to: 00542935 (CONDITIONAL_JUMP)  ; LAB_00542935
    ...
    CMP AL,0x0                          ; 0054258e
    JZ 0x005425a2                       ; 00542590
        ;   XREF to: 005425a2 (CONDITIONAL_JUMP)  ; LAB_005425a2
    MOV AL,byte ptr [ESI + 0x1]         ; 00542592
    ADD ESI,0x2                         ; 00542595
    MOV byte ptr [EDI + 0x1],AL         ; 00542598
    ADD EDI,0x2                         ; 0054259b
    CMP AL,0x0                          ; 0054259e
    JNZ 0x0054258a                      ; 005425a0
        ;   XREF to: 0054258a (CONDITIONAL_JUMP)  ; LAB_0054258a
    POP EDI                             ; 005425a2
        ;   Label: LAB_005425a2
    ...
    JLE 0x00542694                      ; 005425b8
        ;   XREF to: 00542694 (CONDITIONAL_JUMP)  ; LAB_00542694
    ...
    JLE 0x00542623                      ; 005425f6
        ;   XREF to: 00542623 (CONDITIONAL_JUMP)  ; LAB_00542623
    ...
    JNZ 0x00542942                      ; 00542612
        ;   XREF to: 00542942 (CONDITIONAL_JUMP)  ; LAB_00542942
    MOV ESI,dword ptr [EAX]             ; 00542618
    CMP ESI,dword ptr [EBP]             ; 0054261a
    JNZ 0x00542942                      ; 0054261d
        ;   XREF to: 00542942 (CONDITIONAL_JUMP)  ; LAB_00542942
    CMP EBX,dword ptr [ESP + 0x5d]      ; 00542623
        ;   Label: LAB_00542623
    JNZ 0x00542953                      ; 00542627
        ;   XREF to: 00542953 (CONDITIONAL_JUMP)  ; LAB_00542953
    MOV EDX,dword ptr [ESP + 0x174]     ; 0054262d
    MOV EAX,dword ptr [ESP + 0x138]     ; 00542634
    CMP EAX,dword ptr [EDX + 0x114]     ; 0054263b
    JNZ 0x00542665                      ; 00542641
        ;   XREF to: 00542665 (CONDITIONAL_JUMP)  ; LAB_00542665
    MOV EAX,0x63dbad                    ; 00542643 | = "..\\core\\netgame.cpp"
    MOV EDX,0x811                       ; 00542648
    PUSH 0x63dbc1                       ; 0054264d | = "Hell froze"
    MOV [0x02f0ca48],EAX                ; 00542652 | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 00542657 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0054265d
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    PUSH EBX                            ; 00542674
    CALL core_netgame.cpp_CNetGame_removePlayer_FUN_00542b00 ; 00542675
    ...
    JL 0x005425ee                       ; 0054268e
        ;   XREF to: 005425ee (CONDITIONAL_JUMP)  ; LAB_005425ee
    MOV EDI,dword ptr [ESP + 0x5d]      ; 00542694
        ;   Label: LAB_00542694
    XOR ESI,ESI                         ; 00542698
    TEST EDI,EDI                        ; 0054269a
    JLE 0x005426b2                      ; 0054269c
        ;   XREF to: 005426b2 (CONDITIONAL_JUMP)  ; LAB_005426b2
    MOV EDI,dword ptr [ESP + 0x174]     ; 0054269e
    XOR EBX,EBX                         ; 005426a5
    CMP byte ptr [ESP + EBX*0x1 + 0x61],0x0 ; 005426a7
        ;   Label: LAB_005426a7
    JNZ 0x00542aa3                      ; 005426ac
        ;   XREF to: 00542aa3 (CONDITIONAL_JUMP)  ; LAB_00542aa3
    ...
    JL 0x00542925                       ; 005426f3
        ;   XREF to: 00542925 (CONDITIONAL_JUMP)  ; LAB_00542925
    ...
    JLE 0x0054290e                      ; 00542715
        ;   XREF to: 0054290e (CONDITIONAL_JUMP)  ; LAB_0054290e
    ...
    JGE 0x005428cb                      ; 00542759
        ;   XREF to: 005428cb (CONDITIONAL_JUMP)  ; LAB_005428cb
    ...
    JMP 0x006049a4                      ; 0054279f
        ;   XREF to: 006049a4 (UNCONDITIONAL_JUMP)  ; LAB_006049a4
    JMP 0x03fc5b0b                      ; 005427a5
        ;   XREF to: 03fc5b0b (UNCONDITIONAL_JUMP)  ; LAB_03fc5b0b
        ;   Label: LAB_005427a5
    ...
    JL 0x0054273d                       ; 00542908
        ;   XREF to: 0054273d (CONDITIONAL_JUMP)  ; LAB_0054273d
    MOV ESI,dword ptr [ESP + 0x154]     ; 0054290e
        ;   Label: LAB_0054290e
    DEC ESI                             ; 00542915
    MOV dword ptr [ESP + 0x154],ESI     ; 00542916
    TEST ESI,ESI                        ; 0054291d
    JGE 0x00542703                      ; 0054291f
        ;   XREF to: 00542703 (CONDITIONAL_JUMP)  ; LAB_00542703
    ...
    JL 0x0054260a                       ; 00542948
        ;   XREF to: 0054260a (CONDITIONAL_JUMP)  ; LAB_0054260a
    JMP 0x00542623                      ; 0054294e
        ;   XREF to: 00542623 (UNCONDITIONAL_JUMP)  ; LAB_00542623
    ...
    JNZ 0x00542a59                      ; 00542991
        ;   XREF to: 00542a59 (CONDITIONAL_JUMP)  ; LAB_00542a59
    PUSH ESI                            ; 00542997
    ...
    MOV EAX,dword ptr [ESP + 0x174]     ; 005429dd
        ;   Label: LAB_005429dd
    PUSH EAX                            ; 005429e4
    CALL core_netgame.cpp_CNetGame_sendMyStateChanged_FUN_00542ff0 ; 005429e5
    ...
    JMP 0x005429ed                      ; 00542a57
        ;   XREF to: 005429ed (UNCONDITIONAL_JUMP)  ; LAB_005429ed
    ...
    CMP AL,0x0                          ; 00542a65
    JZ 0x00542a79                       ; 00542a67
        ;   XREF to: 00542a79 (CONDITIONAL_JUMP)  ; LAB_00542a79
    MOV AL,byte ptr [ESI + 0x1]         ; 00542a69
    ADD ESI,0x2                         ; 00542a6c
    MOV byte ptr [EDI + 0x1],AL         ; 00542a6f
    ADD EDI,0x2                         ; 00542a72
    CMP AL,0x0                          ; 00542a75
    JNZ 0x00542a61                      ; 00542a77
        ;   XREF to: 00542a61 (CONDITIONAL_JUMP)  ; LAB_00542a61
    POP EDI                             ; 00542a79
        ;   Label: LAB_00542a79
    ...
    JL 0x005426a7                       ; 00542ae7
        ;   XREF to: 005426a7 (CONDITIONAL_JUMP)  ; LAB_005426a7
    JMP 0x005426b2                      ; 00542aed
        ;   XREF to: 005426b2 (UNCONDITIONAL_JUMP)  ; LAB_005426b2
    MOV ESI,EBP                         ; 006049a4
        ;   Label: LAB_006049a4
    MOV ECX,dword ptr [ESI]             ; 006049a6
    MOV dword ptr [EDI],ECX             ; 006049a8
    MOV ECX,dword ptr [ESI + 0x4]       ; 006049aa
    MOV dword ptr [EDI + 0x4],ECX       ; 006049ad
    MOV ECX,dword ptr [ESI + 0x8]       ; 006049b0
    MOV dword ptr [EDI + 0x8],ECX       ; 006049b3
    MOV ECX,dword ptr [ESI + 0xc]       ; 006049b6
    MOV dword ptr [EDI + 0xc],ECX       ; 006049b9
    ADD ESI,0x10                        ; 006049bc
    ADD EDI,0x10                        ; 006049bf
    JMP 0x005427a5                      ; 006049c2
        ;   XREF to: 005427a5 (UNCONDITIONAL_JUMP)  ; LAB_005427a5
    MOV ECX,dword ptr [ESI]             ; 03fc5b0b
        ;   Label: LAB_03fc5b0b
    MOV dword ptr [EDI],ECX             ; 03fc5b0d
    ADD ESI,0x4                         ; 03fc5b0f
    ADD EDI,0x4                         ; 03fc5b12
    MOV EAX,dword ptr [EBP + 0x14]      ; 03fc5b15
    MOV dword ptr [ESP + 0xc8],EAX      ; 03fc5b18
    JMP 0x005427b0                      ; 03fc5b1f
        ;   XREF to: 005427b0 (UNCONDITIONAL_JUMP)  ; LAB_005427b0
