...
section .text
    ...
    MOV ECX,dword ptr [0x02f9c0c0]      ; 0053f555 | int g_SimFrameCount
    XOR EDX,EDX                         ; 0053f55b
    TEST ECX,ECX                        ; 0053f55d
    JLE 0x0053f584                      ; 0053f55f | LAB_0053f584
    ...
    POP ESI                             ; 0053f573
    CMP EBX,dword ptr [EAX + 0x2f9c0c4] ; 0053f574 | undefined4 g_SimFrameHistory | DAT_02f9c128
        ;   Label: LAB_0053f574
    JZ 0x0053f58d                       ; 0053f57a | LAB_0053f58d
        ;   XREF to: 0053f58d (CONDITIONAL_JUMP)
    ADD EAX,0x64                        ; 0053f57c
    INC EDX                             ; 0053f57f
    CMP EAX,ECX                         ; 0053f580
    JL 0x0053f574                       ; 0053f582 | LAB_0053f574
