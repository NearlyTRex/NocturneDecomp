// Name: core_netgame.cpp_CNetGame_FUN_00541390
// Address: 00541390
// Address Range: [[00541390, 00541c77]]
// Convention: __cdecl
// Signature: int __cdecl core_netgame_cpp_CNetGame_FUN_00541390(CNetGame *this_ptr)
...

{
  ...
  if (this_ptr->connection_type != 0) {
    ...
    while (this_ptr->connection_type != 0) {
      ...
      _sprintf((char *)local_130,"MyGameSettigsId: %d",DAT_02f7c8c4)
      ;
      ...
      for (local_20 = 0; local_20 < g_CNetGamePtr->player_count; local_20 = local_20 + 1) {
        ...
        if (*(uchar (*) [4])(local_1c + 0x1c) == g_AnyAddressIP) {
          ...
          support_trisock_cpp_formatIPAddress_FUN_005e17c0(local_1c + 0x1c,local_130);
        }
...
LAB_005415cb:
        ...
        _sprintf
                  ((char *)local_130,"%d",*(uint *)(local_1c + 0x14));
