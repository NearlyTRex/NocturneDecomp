...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_netgame.cpp_CNetGame_FUN_00542370()
;
;
; XREF[2]:
...
section .text
    ...
    MOV EDX,dword ptr [0x02f7c8cc]      ; 00542377 | int g_ChatHistoryCount
    CMP EDX,0x190                       ; 0054237d
    JGE 0x00542435                      ; 00542383 | LAB_00542435
        ;   XREF to: 00542435 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x02f7c8cc]      ; 00542389 | int g_ChatHistoryCount
        ;   Label: LAB_00542389
    LEA EAX,[EDX*0x8 + 0x0]             ; 0054238f
    ADD EAX,EDX                         ; 00542396
    SHL EAX,0x5                         ; 00542398
    MOV ESI,dword ptr [ESP + 0x14]      ; 0054239b
    LEA EDI,[EAX + 0x2f7c8d0]           ; 0054239f | SChatHistory[400] g_ChatHistory
    MOV EDX,dword ptr [ESP + 0x18]      ; 005423a5
    MOVSD ES:EDI,ESI                    ; 005423a9 | SChatHistory[400] g_ChatHistory
    MOVSD ES:EDI,ESI                    ; 005423aa | DAT_02f7c8d4
    MOV dword ptr [EAX + 0x2f7c8d8],EDX ; 005423ab | DAT_02f7c8d8
    ADD EAX,0x2f7c8d0                   ; 005423b1 | SChatHistory[400] g_ChatHistory
    MOV ESI,dword ptr [ESP + 0x1c]      ; 005423b6
    LEA EDI,[EAX + 0xc]                 ; 005423ba
    PUSH EDI                            ; 005423bd
    MOV AL,byte ptr [ESI]               ; 005423be
        ;   Label: LAB_005423be
    MOV byte ptr [EDI],AL               ; 005423c0 | DAT_02f7c8dc
    CMP AL,0x0                          ; 005423c2
    JZ 0x005423d6                       ; 005423c4 | LAB_005423d6
        ;   XREF to: 005423d6 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 005423c6
    ADD ESI,0x2                         ; 005423c9
    MOV byte ptr [EDI + 0x1],AL         ; 005423cc | DAT_02f7c8dd
    ADD EDI,0x2                         ; 005423cf
    CMP AL,0x0                          ; 005423d2
    JNZ 0x005423be                      ; 005423d4 | LAB_005423be
        ;   XREF to: 005423be (CONDITIONAL_JUMP)
    POP EDI                             ; 005423d6
        ;   Label: LAB_005423d6
    MOV EDX,dword ptr [0x02f7c8cc]      ; 005423d7 | int g_ChatHistoryCount
    LEA EAX,[EDX*0x8 + 0x0]             ; 005423dd
    ADD EAX,EDX                         ; 005423e4
    MOV EDI,0x2f7c8d0                   ; 005423e6 | SChatHistory[400] g_ChatHistory
    ...
    MOV AL,byte ptr [ESI]               ; 005423f6
        ;   Label: LAB_005423f6
    MOV byte ptr [EDI],AL               ; 005423f8 | DAT_02f7c8f0
    CMP AL,0x0                          ; 005423fa
    JZ 0x0054240e                       ; 005423fc | LAB_0054240e
        ;   XREF to: 0054240e (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 005423fe
    ADD ESI,0x2                         ; 00542401
    MOV byte ptr [EDI + 0x1],AL         ; 00542404 | DAT_02f7c8f1
    ADD EDI,0x2                         ; 00542407
    CMP AL,0x0                          ; 0054240a
    JNZ 0x005423f6                      ; 0054240c | LAB_005423f6
        ;   XREF to: 005423f6 (CONDITIONAL_JUMP)
    POP EDI                             ; 0054240e
        ;   Label: LAB_0054240e
    PUSH 0x40a00000                     ; 0054240f
    MOV ESI,dword ptr [0x02f7c8cc]      ; 00542414 | int g_ChatHistoryCount
    PUSH EBX                            ; 0054241a
    MOV EBX,dword ptr [0x0067b654]      ; 0054241b | CGame g_CGameInstance | CGame * g_CGamePtr
    INC ESI                             ; 00542421
    PUSH EBX                            ; 00542422 | CGame g_CGameInstance
    MOV dword ptr [0x02f7c8cc],ESI      ; 00542423 | int g_ChatHistoryCount
    CALL core_game.cpp_CGame_displayMessage_FUN_004d7f20 ; 00542429 | void core_game.cpp_CGame_displayMessage_FUN_004d7f20(CGame * this_ptr, char * message, float duration)
    ...
    LEA ECX,[EDX + -0x1]                ; 00542435
        ;   Label: LAB_00542435
    MOV dword ptr [0x02f7c8cc],ECX      ; 00542438 | int g_ChatHistoryCount
    LEA EAX,[ECX*0x8 + 0x0]             ; 0054243e
    ADD EAX,ECX                         ; 00542445
    SHL EAX,0x5                         ; 00542447
    PUSH EAX                            ; 0054244a
    PUSH 0x2f7c9f0                      ; 0054244b | DAT_02f7c9f0
    PUSH 0x2f7c8d0                      ; 00542450 | SChatHistory[400] g_ChatHistory
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 00542455 | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
        ;   XREF to: 005fe5e0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0054245a
    JMP 0x00542389                      ; 0054245d | LAB_00542389
