...
section .text
    ...
    CALL core_xform.cpp_multiplyQuaternion_FUN_005f7640 ; 005f7716 | CQuaternion4f * core_xform.cpp_multiplyQuaternion_FUN_005f7640(CQuaternion4f * result_out, CQuaternion4f * quat1_ptr, CQuaternion4f * quat2_ptr)
