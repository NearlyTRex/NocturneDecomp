...
section .text
    ...
    FCOMP double ptr [0x006582ed]       ; 005f55cc | double g_Atan2SqrtTwoOverTwo
    FNSTSW AX                           ; 005f55d2
    SAHF                                ; 005f55d4
    JNC 0x005f5637                      ; 005f55d5 | LAB_005f5637
        ;   XREF to: 005f5637 (CONDITIONAL_JUMP)
    FLD double ptr [EBP + 0x8]          ; 005f55d7
    FCOMP double ptr [0x006582f5]       ; 005f55da | double g_Atan2NegativeSqrtTwoOverTwo
    FNSTSW AX                           ; 005f55e0
    SAHF                                ; 005f55e2
    JBE 0x005f5637                      ; 005f55e3 | LAB_005f5637
        ;   XREF to: 005f5637 (CONDITIONAL_JUMP)
    FLD double ptr [EBP + 0x8]          ; 005f55e5
    CALL crt_math.c_asin_FUN_00600b94   ; 005f55e8 | float10 crt_math.c_asin_FUN_00600b94(float10 sine_value)
    ...
    FNSTSW AX                           ; 005f55f7
    SAHF                                ; 005f55f9
    JBE 0x005f5608                      ; 005f55fa | LAB_005f5608
        ;   XREF to: 005f5608 (CONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 005f55fc
    FSUBR double ptr [0x00658305]       ; 005f55ff | double g_Atan2Pi
    FSTP float ptr [ESP]                ; 005f5605
    FLD float ptr [ESP]                 ; 005f5608
        ;   Label: LAB_005f5608
    FCOMP double ptr [0x0065830d]       ; 005f560b | double g_Atan2NegativePi
    FNSTSW AX                           ; 005f5611
    SAHF                                ; 005f5613
    JNC 0x005f5622                      ; 005f5614 | LAB_005f5622
        ;   XREF to: 005f5622 (CONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 005f5616
    FADD float ptr [0x00658315]         ; 005f5619 | float g_Atan2TwoPi
    FSTP float ptr [ESP]                ; 005f561f
    FLD float ptr [ESP]                 ; 005f5622
        ;   Label: LAB_005f5622
    FCOMP double ptr [0x00658305]       ; 005f5625 | double g_Atan2Pi
    FNSTSW AX                           ; 005f562b
    SAHF                                ; 005f562d
    JA 0x005f567b                       ; 005f562e | LAB_005f567b
    ...
    FLD double ptr [EBP + 0x10]         ; 005f5637
        ;   Label: LAB_005f5637
    FCOMP double ptr [0x006582fd]       ; 005f563a | double g_Atan2NegativeOne
    FNSTSW AX                           ; 005f5640
    SAHF                                ; 005f5642
    JA 0x005f565d                       ; 005f5643 | LAB_005f565d
    ...
    FNSTSW AX                           ; 005f5651
    SAHF                                ; 005f5653
    JBE 0x005f5608                      ; 005f5654 | LAB_005f5608
        ;   XREF to: 005f5608 (CONDITIONAL_JUMP)
    XOR byte ptr [ESP + 0x3],0x80       ; 005f5656
    JMP 0x005f5608                      ; 005f565b | LAB_005f5608
    ...
    FNSTSW AX                           ; 005f5662
    SAHF                                ; 005f5664
    JA 0x005f566e                       ; 005f5665 | LAB_005f566e
        ;   XREF to: 005f566e (CONDITIONAL_JUMP)
    XOR EDX,EDX                         ; 005f5667
    MOV dword ptr [ESP],EDX             ; 005f5669
    JMP 0x005f564c                      ; 005f566c | LAB_005f564c
        ;   XREF to: 005f564c (UNCONDITIONAL_JUMP)
    FLD double ptr [EBP + 0x10]         ; 005f566e
        ;   Label: LAB_005f566e
    CALL crt_math.c_acos_FUN_00600162   ; 005f5671 | double crt_math.c_acos_FUN_00600162(double x)
        ;   XREF to: 00600162 (UNCONDITIONAL_CALL)
    FSTP float ptr [ESP]                ; 005f5676
    JMP 0x005f564c                      ; 005f5679 | LAB_005f564c
        ;   XREF to: 005f564c (UNCONDITIONAL_JUMP)
    FLD float ptr [ESP]                 ; 005f567b
        ;   Label: LAB_005f567b
    FADD float ptr [0x00658319]         ; 005f567e | float g_Atan2NegativeTwoPi
