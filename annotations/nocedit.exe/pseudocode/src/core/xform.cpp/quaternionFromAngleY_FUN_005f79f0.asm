...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_xform.cpp_quaternionFromAngleY_FUN_005f79f0(CQuaternion4f * quat_ptr, float angle_radians)
;
; Parameters:
...
section .text
    ...
    FMUL double ptr [0x0065840d]        ; 005f79fa | double g_QuaternionHalfAngleFactor2
    FLD ST0                             ; 005f7a00
    FCOS                                ; 005f7a02
    FXCH                                ; 005f7a04
    FSIN                                ; 005f7a06
