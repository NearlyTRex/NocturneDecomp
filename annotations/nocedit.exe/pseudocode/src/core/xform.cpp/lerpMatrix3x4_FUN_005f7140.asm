...
;                               FUNCTION
; *****************************************************************************
; __stack3_esi CMatrix3x4f * core_xform.cpp_lerpMatrix3x4_FUN_005f7140(CMatrix3x4f * matrix_a, CMatrix3x4f * matrix_b, float t, CMatrix3x4f * matrix_out)
;
; Parameters:
...
;
; XREF[4]:
;   core_charactr.cpp_CCharacter_FUN_0042d090 at 0042d2ac
;   core_stranger.cpp_CStranger_FUN_005c07b0 at 005c0b63
;   core_tentacle.cpp_FUN_005db9d0 at 005dba11
;   core_tentacle.cpp_FUN_005dbb70 at 005dbbc2
;
; Called Functions:
