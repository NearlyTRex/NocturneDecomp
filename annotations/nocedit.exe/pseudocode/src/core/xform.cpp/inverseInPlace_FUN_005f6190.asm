...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_xform.cpp_inverseInPlace_FUN_005f6190(CMatrix3x4f * matrix)
;
; Parameters:
...
section .text
    ...
    CALL core_xform.cpp_inverse_FUN_005f6210 ; 005f619e | CMatrix3x4f * core_xform.cpp_inverse_FUN_005f6210(CMatrix3x4f * output_matrix, CMatrix3x4f * input_matrix)
