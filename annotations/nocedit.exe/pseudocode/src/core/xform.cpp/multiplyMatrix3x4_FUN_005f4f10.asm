...
;                               FUNCTION
; *****************************************************************************
; __cdecl CMatrix3x4f * core_xform.cpp_multiplyMatrix3x4_FUN_005f4f10(CMatrix3x4f * output_matrix, CMatrix3x4f * matrix_a, CMatrix3x4f * matrix_b)
;
; Parameters:
; CMatrix3x4f *    Stack[0x4]:4   output_matrix
; CMatrix3x4f *    Stack[0x8]:4   matrix_a
; CMatrix3x4f *    Stack[0xc]:4   matrix_b
; Local Variables:
...
;
; XREF[45]:
;   core_bodypart.cpp_FUN_0041a630 at 0041a9d3
;   core_boneguy.cpp_FUN_0041ca40 at 0041cbb5
;   core_boxactor.cpp_FUN_00422a50 at 00422c14
;   core_bugs.cpp_FUN_00425fe0 at 004260f9
