...

{
  ...
  if ((float)-1 < fVar2) {
    if ((double)fVar2 < 1.0) {
      ...
      if (0.0 < dVar6) {
        ...
        fVar2 = extraout_EDX->z * (float)(double)CONCAT44 /* combine 2-byte values */(local_98,uStack_9c) * (float)dVar6;
        dVar1 = (double)fVar2;
        uStack_34 = SUB84 /* extract 2-byte value */(dVar1,0);
        local_30 = (uint)((ulonglong)dVar1 >> 0x20);
        dVar6 = (double)(extraout_EDX[3].y * (float)(double)CONCAT44 /* combine 2-byte values */(local_88,uStack_8c) *
                        (float)dVar6);
        ...
        pCVar3->y = local_18;
        dVar6 = (double)pCVar4[1].y * dVar7 * (double)CONCAT44 /* combine 2-byte values */(uStack_3c,local_40);
        dVar7 = (double)pCVar4[1].z * dVar7 * (double)CONCAT44 /* combine 2-byte values */(uStack_3c,local_40);
        ...
        if ((0.70699999999999996 <= dVar6) ||
          ...
          if (-1 < dVar7) {
            if (dVar7 < 1.0) {
              ...
              dVar6 = (double)CONCAT44 /* combine 2-byte values */((float)dVar7,local_b0);
          ...
          crt_math_c_asin_FUN_00600b94((float10)dVar6);
  ...
  dVar7 = (double)fVar2;
  dVar6 = (double)(euler_out->x * (float)(double)CONCAT44 /* combine 2-byte values */(local_98,uStack_9c));
  if ((0.70699999999999996 <= dVar7) ||
     (dVar7 <= -0.70699999999999996)) {
    if (-1 < dVar6) {
      if (dVar6 < 1.0) {
        crt_math_c_acos_FUN_00600162(dVar6);
