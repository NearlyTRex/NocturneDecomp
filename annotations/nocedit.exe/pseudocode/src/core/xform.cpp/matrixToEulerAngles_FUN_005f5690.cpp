...

{
  ...
  local_88 = SUB84 /* extract 2-byte value */(dVar1,0);
  ...
  if ((float)-1 < fVar2) {
    if ((double)fVar2 < 1.0) {
      ...
      if (0.0 < dVar6) {
        ...
        dVar1 = (double)fVar2;
        x = (double)(extraout_EDX[3].y * (float)(double)CONCAT44 /* combine 2-byte values */(local_88,uStack_8c) * (float)dVar6)
        ;
        ...
        pCVar3->y = local_14;
        dVar1 = (double)pCVar4[1].y * (double)CONCAT44 /* combine 2-byte values */(local_80,uStack_84) * dVar6;
        dVar6 = (double)pCVar4[1].z * (double)CONCAT44 /* combine 2-byte values */(local_80,uStack_84) * dVar6;
  ...
  dVar6 = (double)fVar2;
  dVar1 = (double)(euler_out->x * (float)(double)CONCAT44 /* combine 2-byte values */(local_98,uStack_9c));
