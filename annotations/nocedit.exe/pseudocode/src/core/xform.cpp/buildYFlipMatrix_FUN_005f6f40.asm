...
;                               FUNCTION
; *****************************************************************************
; __stack_esi CMatrix3x4f * __stack_esi core_xform_cpp_buildYFlipMatrix_FUN_005f6f40(float y_offset,CMatrix3x4f *matrix_out)
;
; Parameters:
...
section .text
    ...
    FMUL double ptr [0x006583cd]        ; 005f6f4b | g_YFlipMatrixScaleFactor
