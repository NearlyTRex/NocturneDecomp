...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_xform.cpp_clipInterpolateBottomPlane_FUN_005f7e00(SRenderVertex * vertex_a, SRenderVertex * vertex_b, SRenderVertex * vertex_out)
;
; Parameters:
...
section .text
    ...
    JGE 0x005f7e3a                      ; 005f7e26 | LAB_005f7e3a
        ;   XREF to: 005f7e3a (CONDITIONAL_JUMP)
    NEG EBX                             ; 005f7e28
    CMP EDX,EBX                         ; 005f7e2a
    JLE 0x005f7e41                      ; 005f7e2c | LAB_005f7e41
    ...
    IDIV EBX                            ; 005f7e36
    JMP 0x005f7e48                      ; 005f7e38 | LAB_005f7e48
        ;   XREF to: 005f7e48 (UNCONDITIONAL_JUMP)
    MOV EAX,0x7fffffff                  ; 005f7e3a
        ;   Label: LAB_005f7e3a
    JMP 0x005f7e48                      ; 005f7e3f | LAB_005f7e48
        ;   XREF to: 005f7e48 (UNCONDITIONAL_JUMP)
    NEG EBX                             ; 005f7e41
        ;   Label: LAB_005f7e41
    ...
    MOV AH,byte ptr [0x02d052a0]        ; 005f7e83 | int g_RenderStateFlags
    MOV dword ptr [EDI + 0x10],0xffffffff ; 005f7e89
    TEST AH,0x4                         ; 005f7e90
    JNZ 0x005f7e9a                      ; 005f7e93 | LAB_005f7e9a
