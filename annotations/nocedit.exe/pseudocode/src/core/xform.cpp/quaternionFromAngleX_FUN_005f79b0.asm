...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_xform.cpp_quaternionFromAngleX_FUN_005f79b0(CQuaternion4f * quat_ptr, float angle_radians)
;
; Parameters:
...
;   core_icepick.cpp_FUN_004f8810 at 004f88f4
...
section .text
    ...
    FMUL double ptr [0x00658405]        ; 005f79ba | double g_QuaternionHalfAngleFactor1
    FLD ST0                             ; 005f79c0
    FCOS                                ; 005f79c2
    FXCH                                ; 005f79c4
    FSIN                                ; 005f79c6
