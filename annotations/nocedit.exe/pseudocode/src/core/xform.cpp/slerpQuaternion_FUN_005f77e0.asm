...
;                               FUNCTION
; *****************************************************************************
; __cdecl CQuaternion4f * core_xform.cpp_slerpQuaternion_FUN_005f77e0(CQuaternion4f * result_out, CQuaternion4f * quat1_ptr, CQuaternion4f * quat2_ptr, float t)
;
; Parameters:
; CQuaternion4f *  Stack[0x4]:4   result_out
; CQuaternion4f *  Stack[0x8]:4   quat1_ptr
; CQuaternion4f *  Stack[0xc]:4   quat2_ptr
; float            Stack[0x10]:4   t
; Local Variables:
...
;   core_platfrm.cpp_FUN_0054cab0 at 0054cb94
;   core_scat.cpp_FUN_005584a0 at 00558677
