...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_xform.cpp_clampClippedVertices_FUN_005f84a0(void)
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH EDI                            ; 005f84a2
    PUSH EBP                            ; 005f84a3
    MOV ESI,dword ptr [0x00824e24]      ; 005f84a4 | int g_ClippedVertexCount
    MOV EAX,0x824e28                    ; 005f84aa | SRenderVertex[16] g_ClippedVertexBuffer
    XOR ECX,ECX                         ; 005f84af
    TEST ESI,ESI                        ; 005f84b1
    JLE 0x005f84cd                      ; 005f84b3 | LAB_005f84cd
        ;   XREF to: 005f84cd (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [EAX + 0x8]       ; 005f84b5 | g_ClippedVertexBuffer[0].projected_vertex.transformed_z
        ;   Label: LAB_005f84b5
    TEST EDX,EDX                        ; 005f84b8
    JZ 0x005f84d8                       ; 005f84ba | LAB_005f84d8
        ;   XREF to: 005f84d8 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [EAX + 0x8]       ; 005f84bc | g_ClippedVertexBuffer[0].projected_vertex.transformed_z
    CMP EBX,dword ptr [EAX]             ; 005f84bf | SRenderVertex[16] g_ClippedVertexBuffer
    JGE 0x005f84e6                      ; 005f84c1 | LAB_005f84e6
        ;   XREF to: 005f84e6 (CONDITIONAL_JUMP)
    MOV dword ptr [EAX],EBX             ; 005f84c3 | SRenderVertex[16] g_ClippedVertexBuffer
    INC ECX                             ; 005f84c5
        ;   Label: LAB_005f84c5
    ADD EAX,0x30                        ; 005f84c6 | DAT_00824e58
    CMP ECX,ESI                         ; 005f84c9
    JL 0x005f84b5                       ; 005f84cb | LAB_005f84b5
        ;   XREF to: 005f84b5 (CONDITIONAL_JUMP)
    MOV dword ptr [0x00824e24],ESI      ; 005f84cd | int g_ClippedVertexCount
        ;   Label: LAB_005f84cd
    POP EBP                             ; 005f84d3
    POP EDI                             ; 005f84d4
    POP ESI                             ; 005f84d5
    ...
    JMP 0x005f84c5                      ; 005f84e4 | LAB_005f84c5
