...
section .text
    ...
    PUSH EBX                            ; 00545d30
        ;   Label: core_passngr.cpp_CPassenger_setup_FUN_00545d30
    PUSH ESI                            ; 00545d31
    PUSH EDI                            ; 00545d32
    ...
    PUSH EDI                            ; 00545da0
    CALL core_morph.cpp_CMorph_setupModelFromDeformable_FUN_0052b430 ; 00545da1
    ...
    PUSH 0x1                            ; 00545db5
    PUSH EDI                            ; 00545db7
    CALL core_morph.cpp_CMorph_setupModelFromDeformable_FUN_0052b430 ; 00545db8
        ;   XREF to: 0052b430 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_CMorph_setupModelFromDeformable_FUN_0052b430(CMorph * this_ptr, int model_index, CDeformableModelInstance * model_ptr)
