...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_passngr.cpp_FUN_00545d30()
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00545d37
    CALL core_npc.cpp_CNPC_FUN_00544870 ; 00545d38 | void core_npc.cpp_CNPC_FUN_00544870(CNPC * this_ptr)
        ;   XREF to: 00544870 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [EBX + 0x1f810]   ; 00545d3d
    ADD ESP,0x4                         ; 00545d43
    TEST EDX,EDX                        ; 00545d46
    JZ 0x00545df4                       ; 00545d48 | LAB_00545df4
        ;   XREF to: 00545df4 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0x1f810]   ; 00545d4e
        ;   Label: LAB_00545d4e
    ADD EAX,0x158                       ; 00545d54
    PUSH EAX                            ; 00545d59
    CALL core_skeleton.cpp_CDeformableModelInstance_resetToRestPose_FUN_0059df80 ; 00545d5a | void core_skeleton.cpp_CDeformableModelInstance_resetToRestPose_FUN_0059df80(CDeformableModelInstance * this_ptr)
        ;   XREF to: 0059df80 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EBX + 0x1f810]   ; 00545d5f
    ADD ESP,0x4                         ; 00545d65
    ADD EAX,0x158                       ; 00545d68
    PUSH EAX                            ; 00545d6d
    CALL core_skeleton.cpp_CDeformableModelInstance_computeBoneTransforms_FUN_0059fb40 ; 00545d6e | void core_skeleton.cpp_CDeformableModelInstance_computeBoneTransforms_FUN_0059fb40(CDeformableModelInstance * this_ptr)
        ;   XREF to: 0059fb40 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00545d73
    LEA ESI,[EBX + 0x158]               ; 00545d76
    PUSH ESI                            ; 00545d7c
    CALL core_skeleton.cpp_CDeformableModelInstance_resetToRestPose_FUN_0059df80 ; 00545d7d | void core_skeleton.cpp_CDeformableModelInstance_resetToRestPose_FUN_0059df80(CDeformableModelInstance * this_ptr)
        ;   XREF to: 0059df80 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00545d82
    PUSH ESI                            ; 00545d85
    CALL core_skeleton.cpp_CDeformableModelInstance_computeBoneTransforms_FUN_0059fb40 ; 00545d86 | void core_skeleton.cpp_CDeformableModelInstance_computeBoneTransforms_FUN_0059fb40(CDeformableModelInstance * this_ptr)
        ;   XREF to: 0059fb40 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00545d8b
    PUSH ESI                            ; 00545d8e
    CALL core_skeleton.cpp_CDeformableModelInstance_preCache_FUN_005a0450 ; 00545d8f | void core_skeleton.cpp_CDeformableModelInstance_preCache_FUN_005a0450(CDeformableModelInstance * this_ptr)
    ...
    PUSH EDI                            ; 00545da0
    CALL core_morph.cpp_FUN_0052b430    ; 00545da1 | void core_morph.cpp_FUN_0052b430()
    ...
    PUSH 0x1                            ; 00545db5
    PUSH EDI                            ; 00545db7
    CALL core_morph.cpp_FUN_0052b430    ; 00545db8 | void core_morph.cpp_FUN_0052b430()
        ;   XREF to: 0052b430 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00545dbd
    PUSH EDI                            ; 00545dc0
    CALL core_morph.cpp_CMorph_getReady_FUN_0052b680 ; 00545dc1 | void core_morph.cpp_CMorph_getReady_FUN_0052b680(CMorph * this_ptr)
        ;   XREF to: 0052b680 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00545dc6
    PUSH ESI                            ; 00545dc9
    MOV dword ptr [EBX + 0x20440],0x0   ; 00545dca
    CALL core_skeleton.cpp_CDeformableModelInstance_updateAnimationAndTransforms_FUN_0059e000 ; 00545dd4 | void core_skeleton.cpp_CDeformableModelInstance_updateAnimationAndTransforms_FUN_0059e000(CDeformableModelInstance * this_ptr)
        ;   XREF to: 0059e000 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EBX + 0x1f810]   ; 00545dd9
    ADD ESP,0x4                         ; 00545ddf
    ADD EAX,0x158                       ; 00545de2
    PUSH EAX                            ; 00545de7
    CALL core_skeleton.cpp_CDeformableModelInstance_updateAnimationAndTransforms_FUN_0059e000 ; 00545de8 | void core_skeleton.cpp_CDeformableModelInstance_updateAnimationAndTransforms_FUN_0059e000(CDeformableModelInstance * this_ptr)
        ;   XREF to: 0059e000 (UNCONDITIONAL_CALL)
    ...
    POP EBX                             ; 00545df2
    RET                                 ; 00545df3
    PUSH 0x63e7c4                       ; 00545df4 | = "CWerewolf" | s_CWerewolf_0063e7c4 = CWerewolf
        ;   Label: LAB_00545df4
    CALL core_actor.cpp_createActorByName_FUN_0040c430 ; 00545df9 | CDemonActor * core_actor.cpp_createActorByName_FUN_0040c430(char * class_name)
    ...
    CMP AL,0x0                          ; 00545e14
    JZ 0x00545e28                       ; 00545e16 | LAB_00545e28
    ...
    CMP AL,0x0                          ; 00545e24
    JNZ 0x00545e10                      ; 00545e26 | LAB_00545e10
    ...
    JZ 0x00545e69                       ; 00545e57 | LAB_00545e69
    ...
    PUSH EAX                            ; 00545e7b
    CALL core_skeleton.cpp_CDeformableModelInstance_init_FUN_005a0840 ; 00545e7c | void core_skeleton.cpp_CDeformableModelInstance_init_FUN_005a0840(CDeformableModelInstance * this_ptr, char * model_name)
    ...
    PUSH 0x63e7ce                       ; 00545eb0 | = "transform" | s_transform_0063e7ce = transform
    ADD EAX,0x158                       ; 00545eb5
    PUSH EAX                            ; 00545eba
    CALL core_motion.cpp_CMotionController_getMotionList_FUN_0052dce0 ; 00545ebb | CMotionList * core_motion.cpp_CMotionController_getMotionList_FUN_0052dce0(CMotionController * this_ptr)
        ;   XREF to: 0052dce0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00545ec0
    PUSH EAX                            ; 00545ec3
    CALL core_motion.cpp_CMotionList_findMotionIndex_FUN_0052d460 ; 00545ec4 | int core_motion.cpp_CMotionList_findMotionIndex_FUN_0052d460(CMotionList * this_ptr)
    ...
    PUSH EAX                            ; 00545eda
    CALL core_motion.cpp_CMotionController_jumpToMotion_FUN_0052dde0 ; 00545edb | void core_motion.cpp_CMotionController_jumpToMotion_FUN_0052dde0(CMotionController * this_ptr, int target_motion_index, float target_frame_number)
        ;   XREF to: 0052dde0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00545ee0
    JMP 0x00545d4e                      ; 00545ee3 | LAB_00545d4e
