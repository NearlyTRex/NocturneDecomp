...
section .text
    ...
    PUSH EBX                            ; 00546190
        ;   Label: core_passngr.cpp_CPassenger_archive_FUN_00546190
    PUSH ESI                            ; 00546191
    MOV EBX,dword ptr [ESP + 0xc]       ; 00546192
    PUSH EBX                            ; 00546196
    CALL core_npc.cpp_CNPC_archive_FUN_00544ba0 ; 00546197
    ...
    PUSH ESI                            ; 005461aa
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 005461ab
    ...
    PUSH ESI                            ; 005461be
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 005461bf
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveString_FUN_0040b5c0(char * string_buffer, char * property_type)
    ADD ESP,0x8                         ; 005461c4
    PUSH 0x63e7f5                       ; 005461c7 | = "morphTime"
    LEA ESI,[EBX + 0x20440]             ; 005461cc
    PUSH ESI                            ; 005461d2
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 005461d3
    ...
    PUSH ESI                            ; 005461f6
    CALL core_actor.cpp_archiveDeformableModelInstance_FUN_0040b970 ; 005461f7
    ...
    PUSH ESI                            ; 00546204
    CALL core_actor.cpp_archiveMotionState_FUN_0040b9f0 ; 00546205
    ...
    PUSH ESI                            ; 00546221
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 00546222
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ...
    PUSH ESI                            ; 0054623e
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 0054623f
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveString_FUN_0040b5c0(char * string_buffer, char * property_type)
    ...
    PUSH EBX                            ; 0054625e
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 0054625f
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveString_FUN_0040b5c0(char * string_buffer, char * property_type)
