...
section .text
    ...
    PUSH ECX                            ; 005462f9
    CALL core_actor.cpp_CDemonActor_writeDependencies_FUN_0040cfd0 ; 005462fa | void core_actor.cpp_CDemonActor_writeDependencies_FUN_0040cfd0(CDemonActor * this_ptr, FILE * file_handle)
