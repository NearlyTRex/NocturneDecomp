...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_passngr_cpp_CPassenger_renderOpaque_FUN_005460c0(CPassenger *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0054611f
    CALL core_charactr.cpp_CCharacter_FUN_00429aa0 ; 00546120
    ...
    PUSH ESI                            ; 00546173
    CALL core_morph.cpp_CMorphModel_FUN_0052bae0 ; 00546174
