...
;                               FUNCTION
; *****************************************************************************
; __cdecl CPassenger * core_passngr.cpp_factoryFunc_FUN_00545af0(void)
;
;
; XREF[1]:
...
section .text
    ...
    PUSH 0x43                           ; 00545af0
        ;   Label: core_passngr.cpp_factoryFunc_FUN_00545af0
    PUSH 0x63e770                       ; 00545af2 | = "..\\core\\passngr.cpp"
    PUSH 0x20448                        ; 00545af7
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1b0 ; 00545afc
