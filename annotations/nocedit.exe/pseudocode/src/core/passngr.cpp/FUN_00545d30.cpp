...

{
  ...
  if (in_stack_00000004[1].base.base.scale.x == 0) {
    ...
    in_stack_00000004[1].base.base.scale.x = (int)pCVar3;
    do {
      cVar2 = *pcVar5;
    ...
    iVar4 = in_stack_00000004[1].base.base.scale.x;
    *(float *)(iVar4 + 0x20) = (in_stack_00000004->base).base.location.position.x;
    *(float *)(iVar4 + 0x24) = (in_stack_00000004->base).base.location.position.y;
    *(float *)(iVar4 + 0x28) = (in_stack_00000004->base).base.location.position.z;
    *(int *)(iVar4 + 0x2c) = (in_stack_00000004->base).base.location.area_id;
    iVar4 = in_stack_00000004[1].base.base.scale.x;
    pCVar1 = &(in_stack_00000004->base).base.orient;
    if ((COrientation *)(iVar4 + 0x30) != pCVar1) {
      *(float *)(iVar4 + 0x30) = pCVar1->pitch;
      *(float *)(iVar4 + 0x34) = (in_stack_00000004->base).base.orient.bank;
      *(float *)(iVar4 + 0x38) = (in_stack_00000004->base).base.orient.heading;
    }
    core_skeleton_cpp_CDeformableModelInstance_init_FUN_005a0840
              ((CDeformableModelInstance *)(in_stack_00000004[1].base.base.scale.x + 0x158),
               (char *)&in_stack_00000004[1].base.base.health);
    *(float *)(in_stack_00000004[1].base.base.scale.x + 0x261c) =
         in_stack_00000004[1].base.model.bone_transform.bone_rotations[0x53].x;
    (*(code *)**(uint **)(in_stack_00000004[1].base.base.scale.x + 0x154))();
    this_ptr_00 = core_motion_cpp_CMotionController_getMotionList_FUN_0052dce0
                            ((CMotionController *)(in_stack_00000004[1].base.base.scale.x + 0x158));
    iVar4 = core_motion_cpp_CMotionList_findMotionIndex_FUN_0052d460(this_ptr_00);
    core_motion_cpp_CMotionController_jumpToMotion_FUN_0052dde0
              ((CMotionController *)(in_stack_00000004[1].base.base.scale.x + 0x158),iVar4,0.0);
  }
  ...
  core_morph_cpp_FUN_0052b430();
  core_morph_cpp_CMorph_getReady_FUN_0052b680((CMorph *)&in_stack_00000004[1].base.base.scale.y);
  in_stack_00000004[1].base.model.bone_transform.bone_rotations[0x53].w = 0.0;
