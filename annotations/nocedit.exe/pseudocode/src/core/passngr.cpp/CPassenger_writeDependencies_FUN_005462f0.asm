...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_passngr_cpp_CPassenger_writeDependencies_FUN_005462f0(CPassenger *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x8]       ; 005462f0
        ;   Label: core_passngr.cpp_CPassenger_writeDependencies_FUN_005462f0
    PUSH EDX                            ; 005462f4
