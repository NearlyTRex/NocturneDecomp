...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_bugs.cpp_FUN_00427ad0()
;
;
; Referenced Globals:
...
section .text
    ...
    FMUL float ptr [0x0065b5b8]         ; 00427adb | DAT_0065b5b8
    FSTP float ptr [EBX]                ; 00427ae1
    FILD dword ptr [EAX + 0x4]          ; 00427ae3
    FMUL float ptr [0x0065b5b8]         ; 00427ae6 | DAT_0065b5b8
    FSTP float ptr [EBX + 0x4]          ; 00427aec
    FILD dword ptr [EAX + 0x8]          ; 00427aef
    FMUL float ptr [0x0065b5b8]         ; 00427af2 | DAT_0065b5b8
