...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_bugs_cpp_CBugs_FUN_004270f0(CBugs *this_ptr)
;
; Parameters:
...
;
; XREF[1]:
;   core_bugs.cpp_CBugs_FUN_004268e0 at 0042704a
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004270f0
        ;   Label: core_bugs.cpp_CBugs_FUN_004270f0
    PUSH ESI                            ; 004270f1
    PUSH EDI                            ; 004270f2
    PUSH EBP                            ; 004270f3
