...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_bugs.cpp_FUN_00427400()
;
; Local Variables:
...
section .text
    ...
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 0042742b | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00427430
    TEST EAX,EAX                        ; 00427433
    JZ 0x00427446                       ; 00427435 | LAB_00427446
    ...
    PUSH ECX                            ; 0042744c
    PUSH EBX                            ; 0042744d
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 0042744e | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00427453
    TEST EAX,EAX                        ; 00427456
    JZ 0x00427474                       ; 00427458 | LAB_00427474
        ;   XREF to: 00427474 (CONDITIONAL_JUMP)
    MOV CL,byte ptr [EAX + 0x23b8]      ; 0042745a
    LEA EDX,[EAX + 0x158]               ; 00427460
    TEST CL,CL                          ; 00427466
    JZ 0x00427474                       ; 00427468 | LAB_00427474
        ;   XREF to: 00427474 (CONDITIONAL_JUMP)
    ...
    JZ 0x0042766a                       ; 0042747f | LAB_0042766a
    ...
    PUSH EDI                            ; 004274ba
    CALL core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0 ; 004274bb | CDeformableModel * core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0(CDeformableModelInstance * this_ptr)
    ...
    JG 0x00427672                       ; 004274d9 | LAB_00427672
        ;   XREF to: 00427672 (CONDITIONAL_JUMP)
    PUSH EAX                            ; 004274df
    PUSH EBX                            ; 004274e0
    MOV EBP,dword ptr [ESP + 0x24]      ; 004274e1
    PUSH EBP                            ; 004274e5
    PUSH 0x616e63                       ; 004274e6 | = "%s swarming on %s at LOD %d\n" | s_s_swarming_on_s_at_LOD_d_00616e63 = %s swarming on %s at LOD %d

    MOV EAX,[0x0066e8e0]                ; 004274eb | CConsole g_ConsolePtr | CConsole * g_CConsolePtr
    PUSH EAX                            ; 004274f0 | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 004274f1 | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
        ;   XREF to: 00441890 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 004274f6
    MOV EDX,dword ptr [EBP + 0x12afc]   ; 004274f9
    PUSH EDX                            ; 004274ff
    CALL core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0 ; 00427500 | CDeformableModel * core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0(CDeformableModelInstance * this_ptr)
        ;   XREF to: 005a07a0 (UNCONDITIONAL_CALL)
    ...
    PUSH EBX                            ; 00427517
    PUSH EBP                            ; 00427518
    CALL core_bugs.cpp_FUN_00425660     ; 00427519 | undefined core_bugs.cpp_FUN_00425660()
    ...
    CALL core_skeleton.cpp_CDeformableModelInstance_skinVerticesForLOD_FUN_005a01d0 ; 00427533 | void core_skeleton.cpp_CDeformableModelInstance_skinVerticesForLOD_FUN_005a01d0(CDeformableModelInstance * this_ptr, int lod_index)
    ...
    JL 0x004275d6                       ; 00427583 | LAB_004275d6
        ;   XREF to: 004275d6 (CONDITIONAL_JUMP)
    MOV EBP,dword ptr [ESP + 0x4]       ; 00427585
        ;   Label: LAB_00427585
    TEST EBP,EBP                        ; 00427589
    JL 0x004275c9                       ; 0042758b | LAB_004275c9
        ;   XREF to: 004275c9 (CONDITIONAL_JUMP)
    SHL EBP,0x2                         ; 0042758d
    XOR EAX,EAX                         ; 00427590
    IMUL EDX,dword ptr [EAX + 0x822f48],0xc ; 00427592 | undefined4 DAT_00822f48 | DAT_00822f4c
        ;   Label: LAB_00427592
    IMUL ECX,dword ptr [EAX + 0x822f4c],0xc ; 00427599 | undefined4 DAT_00822f4c | DAT_00822f50
    MOV EDX,dword ptr [EDX + EBX*0x1 + 0x4] ; 004275a0
    CMP EDX,dword ptr [ECX + EBX*0x1 + 0x4] ; 004275a4
    JLE 0x004275c2                      ; 004275a8 | LAB_004275c2
        ;   XREF to: 004275c2 (CONDITIONAL_JUMP)
    LEA ECX,[EAX + 0x4]                 ; 004275aa
    ADD ECX,0x822f48                    ; 004275ad | undefined4 DAT_00822f48
    MOV EDX,0x822f48                    ; 004275b3 | undefined4 DAT_00822f48
    MOV ESI,dword ptr [ECX]             ; 004275b8 | undefined4 DAT_00822f4c
    MOV EDI,dword ptr [EDX + EAX*0x1]   ; 004275ba | undefined4 DAT_00822f48
    MOV dword ptr [EDX + EAX*0x1],ESI   ; 004275bd | undefined4 DAT_00822f48
    MOV dword ptr [ECX],EDI             ; 004275c0 | undefined4 DAT_00822f4c
    ADD EAX,0x4                         ; 004275c2
        ;   Label: LAB_004275c2
    CMP EAX,EBP                         ; 004275c5
    JLE 0x00427592                      ; 004275c7 | LAB_00427592
    ...
    JGE 0x00427585                      ; 004275d4 | LAB_00427585
        ;   XREF to: 00427585 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x00822f48]      ; 004275d6 | undefined4 DAT_00822f48
        ;   Label: LAB_004275d6
    ...
    JLE 0x0042766a                      ; 004275ff | LAB_0042766a
        ;   XREF to: 0042766a (CONDITIONAL_JUMP)
    MOV EDI,EAX                         ; 00427601
    MOV dword ptr [EDI + 0xbef0],0xffffffff ; 00427603
        ;   Label: LAB_00427603
    MOV EAX,dword ptr [ESI*0x4 + 0x822f48] ; 0042760d | undefined4 DAT_00822f48
    ...
    PUSH EAX                            ; 00427638
    PUSH 0x0                            ; 00427639
    CALL core_actor.cpp_getRandomInt_FUN_0040cc70 ; 0042763b | int core_actor.cpp_getRandomInt_FUN_0040cc70(int min_value, int max_value)
    ...
    JL 0x004276aa                       ; 00427654 | LAB_004276aa
    ...
    JL 0x00427603                       ; 00427668 | LAB_00427603
    ...
    CALL core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0 ; 00427684 | CDeformableModel * core_skeleton.cpp_CDeformableModelInstance_getModelPtr_FUN_005a07a0(CDeformableModelInstance * this_ptr)
        ;   XREF to: 005a07a0 (UNCONDITIONAL_CALL)
    ...
    JG 0x004274b0                       ; 00427698 | LAB_004274b0
        ;   XREF to: 004274b0 (CONDITIONAL_JUMP)
    MOV dword ptr [EDX + 0x12afc],0x0   ; 0042769e
    JMP 0x0042766a                      ; 004276a8 | LAB_0042766a
        ;   XREF to: 0042766a (UNCONDITIONAL_JUMP)
    IMUL EAX,dword ptr [ESI*0x4 + 0x822f48],0xc ; 004276aa | undefined4 DAT_00822f4c
        ;   Label: LAB_004276aa
    MOV ECX,dword ptr [ESP]             ; 004276b2
    CMP ECX,dword ptr [EBX + EAX*0x1 + 0x4] ; 004276b5
    JL 0x00427656                       ; 004276b9 | LAB_00427656
        ;   XREF to: 00427656 (CONDITIONAL_JUMP)
    JMP 0x00427658                      ; 004276bb | LAB_00427658
