...
;   core_bugs.cpp_CBugs_updateBugRenderingData_FUN_004268e0 at 0042700a
;   core_bugs.cpp_CBugs_updateBugsBehavior_FUN_00425cc0 at 00425da0
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00426420
        ;   Label: core_bugs.cpp_CBugs_updateBugPathfinding_FUN_00426420
    PUSH ESI                            ; 00426421
    PUSH EDI                            ; 00426422
    PUSH EBP                            ; 00426423
    ...
    PUSH ECX                            ; 0042649a
    CALL core_bugs.cpp_CBugs_sampleGroundHeight_FUN_00425b70 ; 0042649b
    ...
    PUSH EDI                            ; 0042664e
    CALL core_bugs.cpp_CBugs_sampleGroundHeight_FUN_00425b70 ; 0042664f
        ;   XREF to: 00425b70 (UNCONDITIONAL_CALL)  ; float core_bugs.cpp_CBugs_sampleGroundHeight_FUN_00425b70(CBugs * this_ptr, float x, float z)
