...
;   core_bugs.cpp_CBugs_setSwarmTarget_FUN_00427400
...
section .text
    ...
    PUSH EBX                            ; 00425cc0
        ;   Label: core_bugs.cpp_CBugs_updateBugsBehavior_FUN_00425cc0
    PUSH ESI                            ; 00425cc1
    PUSH EDI                            ; 00425cc2
    PUSH EBP                            ; 00425cc3
    ...
    PUSH EBX                            ; 00425d5e
        ;   Label: LAB_00425d5e
    CALL core_bugs.cpp_CBugs_updateGroundHeightGrid_FUN_004257f0 ; 00425d5f
    ...
    PUSH ESI                            ; 00425d6d
    PUSH EBX                            ; 00425d6e
    CALL core_bugs.cpp_CBugs_setSwarmTarget_FUN_00427400 ; 00425d6f
        ;   XREF to: 00427400 (UNCONDITIONAL_CALL)  ; void core_bugs.cpp_CBugs_setSwarmTarget_FUN_00427400(CBugs * this_ptr, CDemonActor * target)
    ...
    PUSH EBX                            ; 00425d9e
    INC ESI                             ; 00425d9f
    CALL core_bugs.cpp_CBugs_updateBugPathfinding_FUN_00426420 ; 00425da0
    ...
    PUSH EBX                            ; 00425dc0
        ;   Label: LAB_00425dc0
    CALL core_bugs.cpp_CBugs_recalculateBoundingBox_FUN_004272f0 ; 00425dc1
    ...
    PUSH EAX                            ; 00425fae
    PUSH EBX                            ; 00425faf
    CALL core_bugs.cpp_CBugs_applySwarmTranslation_FUN_004276c0 ; 00425fb0
    ...
    PUSH EBX                            ; 00425fb8
        ;   Label: LAB_00425fb8
    CALL core_bugs.cpp_CBugs_updateGroundHeightGrid_FUN_004257f0 ; 00425fb9
        ;   XREF to: 004257f0 (UNCONDITIONAL_CALL)  ; void core_bugs.cpp_CBugs_updateGroundHeightGrid_FUN_004257f0(CBugs * this_ptr)
    ...
    PUSH dword ptr [EBP + 0x18]         ; 00425fc6
        ;   Label: LAB_00425fc6
    PUSH EBX                            ; 00425fc9
    CALL core_bugs.cpp_CBugs_attackSwarmTarget_FUN_00425fe0 ; 00425fca
