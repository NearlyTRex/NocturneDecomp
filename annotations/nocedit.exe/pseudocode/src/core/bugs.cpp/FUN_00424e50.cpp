...

{
  ...
  (pCVar3->base).cloth_data[0x397a] = '\0';
  (pCVar3->base).cloth_data[0x397b] = '\0';
  iVar7 = 0;
  if (0 < *(int *)(in_stack_00000004[1].base.cloth_data + 0x3978)) {
    pcVar9 = in_stack_00000004[1].base.cloth_data + 0x39f4;
    do {
      if (*pcVar9 == '\0') {
        iVar6 = *(int *)(in_stack_00000004[1].base.cloth_data + 0x3978) + -1;
        *(int *)(in_stack_00000004[1].base.cloth_data + 0x3978) = iVar6;
        if (iVar7 < iVar6) {
          local_20 = (CKeyFramedModelInstance *)
                     (in_stack_00000004[1].base.cloth_data + iVar7 * 0x17c + 0x397c);
          local_1c = in_stack_00000004[1].base.cloth_data + iVar7 * 0x17c + 0x3b70;
          iVar6 = iVar7;
          do {
          ...
          } while (iVar6 < *(int *)(in_stack_00000004[1].base.cloth_data + 0x3978));
        }
      }
      else {
    ...
    } while (iVar7 < *(int *)(in_stack_00000004[1].base.cloth_data + 0x3978));
  }
  local_28 = 0;
  if (0 < *(int *)(in_stack_00000004[1].base.base.actor_name + 0xc)) {
    fVar1 = 0.5f * 12.0f;
    fVar2 = 0.5f * -12.0f;
    pCVar10 = &in_stack_00000004[1].base.base.orient;
    pfVar8 = &in_stack_00000004[1].base.base.location.position.y;
    local_2c = (float *)(in_stack_00000004[1].base.base.actor_name + 0x18);
    do {
      pcVar9 = in_stack_00000004[1].base.base.actor_name + local_28 * 0x40 + 0x10;
      pcVar9[0] = '\0';
      pcVar9[1] = '\0';
      pcVar9[2] = '\0';
      pcVar9[3] = '\0';
      iVar7 = core_actor_cpp_getRandomInt_FUN_0040cc70
                        (0,*(int *)(in_stack_00000004[1].base.cloth_data + 0x3978) + -1);
      ...
      *(float *)(pcVar9 + 0x18) = fVar5;
      if (pCVar10 != (COrientation *)local_2c) {
      ...
      local_28 = local_28 + 1;
    } while (local_28 < *(int *)(in_stack_00000004[1].base.base.actor_name + 0xc));
  }
  core_bugs_cpp_FUN_004272f0();
  in_stack_00000004[2].base.model.bone_transform.bone_world_matrices[0x43].m[1].x = -NAN;
  in_stack_00000004[2].base.model.bone_transform.bone_world_matrices[0x43].m[1].y = -NAN;
  (in_stack_00000004->base).base.unk6 = 1;
  in_stack_00000004[2].base.model.bone_transform.bone_world_matrices[0x43].m[2].x = 0.0;
  return;
}
