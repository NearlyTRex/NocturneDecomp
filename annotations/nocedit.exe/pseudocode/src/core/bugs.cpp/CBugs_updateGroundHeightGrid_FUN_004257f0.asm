...
;
; XREF[3]:
;   core_bugs.cpp_CBugs_attackSwarmTarget_FUN_00425fe0 at 004263f4
;   core_bugs.cpp_CBugs_processInEditor_FUN_004278d0 at 00427951
;   core_bugs.cpp_CBugs_updateBugsBehavior_FUN_00425cc0 at 00425fb9
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004257f0
        ;   Label: core_bugs.cpp_CBugs_updateGroundHeightGrid_FUN_004257f0
    PUSH EBP                            ; 004257f1
    ...
    MOV EDI,0x822d08                    ; 00425990 | g_BugsGroundHeightGridTemp
