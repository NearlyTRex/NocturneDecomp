...
;
; XREF[3]:
;   core_bugs.cpp_CBugs_FUN_00425cc0 at 00425da0
;   core_bugs.cpp_CBugs_FUN_004268e0 at 0042700a
;   core_bugs.cpp_CBugs_processInEditor_FUN_004278d0 at 0042797f
;
; Referenced Globals:
...
;   core_bugs.cpp_CBugs_FUN_00425b70
...
section .text
    ...
    PUSH EBX                            ; 00426420
        ;   Label: core_bugs.cpp_CBugs_FUN_00426420
    PUSH ESI                            ; 00426421
    PUSH EDI                            ; 00426422
    PUSH EBP                            ; 00426423
    ...
    PUSH ECX                            ; 0042649a
    CALL core_bugs.cpp_CBugs_FUN_00425b70 ; 0042649b
        ;   XREF to: 00425b70 (UNCONDITIONAL_CALL)  ; int core_bugs.cpp_CBugs_FUN_00425b70(CBugs * this_ptr)
    ...
    PUSH EAX                            ; 004265b8
    CALL core_vecdir.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 004265b9
    ...
    PUSH EDI                            ; 0042664e
    CALL core_bugs.cpp_CBugs_FUN_00425b70 ; 0042664f
        ;   XREF to: 00425b70 (UNCONDITIONAL_CALL)  ; int core_bugs.cpp_CBugs_FUN_00425b70(CBugs * this_ptr)
