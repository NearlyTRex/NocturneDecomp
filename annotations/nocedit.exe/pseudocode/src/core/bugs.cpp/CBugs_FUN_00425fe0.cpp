...

{
  ...
  if ((int)pfVar6 < this_ptr->count) {
    ...
    if ((((float)2 < ABS(local_48)) || ((float)2 < ABS(local_4c))) ||
      ...
      if (iVar3 != 0) {
        ...
        CStack_90.z = 2.0f * in_stack_00000008;
        CStack_90.x = 0.0;
        CStack_90.y = 0.0;
        ...
        core_charactr_cpp_CCharacter_moveAndCollide_FUN_00428f40((CCharacter *)this_ptr,&CStack_78);
        ...
        (this_ptr->base).base.base.location.position.z = fStack_34;
  ...
  if ((0 < (int)pfVar6) &&
    ...
    if (this_ptr_00 != (CCharacter *)0x0) {
      ...
      (*(((this_ptr_00->base).vtable._uc)->_uc).processDamage)
                (this_ptr_00,(SDamageInfo *)&stack0xfffffe78);
    }
  }
  ...
  fStack_34 = (this_ptr->base).base.base.location.position.x + CStack_90.z;
