...
;   core_bugs.cpp_CBugs_initializeSwarmGraph_FUN_00425660
...
section .text
    ...
    PUSH EBX                            ; 00427400
        ;   Label: core_bugs.cpp_CBugs_setSwarmTarget_FUN_00427400
    PUSH ESI                            ; 00427401
    PUSH EDI                            ; 00427402
    PUSH EBP                            ; 00427403
    ...
    MOV EDX,dword ptr [0x00822f48]      ; 004275d6 | g_BugsSortedVertexIndices
        ;   Label: LAB_004275d6
    ...
    MOV dword ptr [EDI + 0xbef0],0xffffffff ; 00427603
        ;   Label: LAB_00427603
    MOV EAX,dword ptr [ESI*0x4 + 0x822f48] ; 0042760d | g_BugsSortedVertexIndices
