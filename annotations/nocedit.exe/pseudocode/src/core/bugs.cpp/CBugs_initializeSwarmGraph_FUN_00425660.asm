...
section .text
    ...
    PUSH ESI                            ; 00425660
        ;   Label: core_bugs.cpp_CBugs_initializeSwarmGraph_FUN_00425660
    PUSH EDI                            ; 00425661
    PUSH EBP                            ; 00425662
    ...
    CALL core_bugs.cpp_CBugs_addSwarmGraphEdge_FUN_00425740 ; 004256a9
        ;   XREF to: 00425740 (UNCONDITIONAL_CALL)  ; void core_bugs.cpp_CBugs_addSwarmGraphEdge_FUN_00425740(CBugs * this_ptr, int vertex_index, int neighbor_index, int first_edge_data)
