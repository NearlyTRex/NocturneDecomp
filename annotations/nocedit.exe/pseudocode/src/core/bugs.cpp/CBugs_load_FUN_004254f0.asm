...
section .text
    ...
    PUSH EDI                            ; 004254f8
    CALL core_enemy.cpp_CEnemy_serialize_FUN_004a9660 ; 004254f9
    ...
    PUSH EBX                            ; 0042550c
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 0042550d
    ...
    PUSH EBX                            ; 00425520
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 00425521
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    PUSH ESI                            ; 00425577
    INC EBX                             ; 00425578
    CALL core_actor.cpp_serializeKeyframedModelInstance_FUN_0040b8f0 ; 00425579
    ...
    PUSH EBX                            ; 004255ab
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 004255ac
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ADD ESP,0x8                         ; 004255b1
    PUSH 0x616d5a                       ; 004255b4 | = "allowSwarm"
    LEA EBX,[EDI + 0x1989c]             ; 004255b9
    PUSH EBX                            ; 004255bf
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 004255c0
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ADD ESP,0x8                         ; 004255c5
    PUSH 0x616d65                       ; 004255c8 | = "allowChaseEvent"
    LEA EBX,[EDI + 0x198a0]             ; 004255cd
    PUSH EBX                            ; 004255d3
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 004255d4
    ...
    PUSH EBX                            ; 004255e7
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 004255e8
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeString_FUN_0040b5c0(char * * string_buffer, char * property_type)
    ADD ESP,0x8                         ; 004255ed
    PUSH 0x616d85                       ; 004255f0 | = "animateEvent"
    ADD EDI,0x19968                     ; 004255f5
    PUSH EDI                            ; 004255fb
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 004255fc
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeString_FUN_0040b5c0(char * * string_buffer, char * property_type)
