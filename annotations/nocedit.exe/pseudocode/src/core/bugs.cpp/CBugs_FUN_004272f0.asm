...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_bugs_cpp_CBugs_FUN_004272f0(CBugs *this_ptr)
;
; Parameters:
; CBugs *          Stack[0x4]:4   this_ptr
;
; XREF[5]:
;   core_bugs.cpp_CBugs_FUN_00425cc0 at 00425dc1
;   core_bugs.cpp_CBugs_FUN_00425fe0 at 00426161
;   core_bugs.cpp_CBugs_FUN_00426410 at 00426415
...
section .text
    ...
    PUSH EBX                            ; 004272f0
        ;   Label: core_bugs.cpp_CBugs_FUN_004272f0
    PUSH ESI                            ; 004272f1
    PUSH EDI                            ; 004272f2
    PUSH EBP                            ; 004272f3
