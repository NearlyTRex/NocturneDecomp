...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_bugs_cpp_CBugs_FUN_00426410(CBugs *this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x4]       ; 00426410
        ;   Label: core_bugs.cpp_CBugs_FUN_00426410
    PUSH EDX                            ; 00426414
    CALL core_bugs.cpp_CBugs_FUN_004272f0 ; 00426415
