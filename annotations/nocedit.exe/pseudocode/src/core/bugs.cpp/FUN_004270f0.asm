...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_bugs.cpp_FUN_004270f0()
;
; Local Variables:
...
;
; XREF[1]:
;   core_bugs.cpp_FUN_004268e0 at 0042704a
;
; Referenced Globals:
...
section .text
    ...
    JLE 0x004271ba                      ; 00427168 | LAB_004271ba
    ...
    JNZ 0x004272af                      ; 0042719c | LAB_004272af
        ;   XREF to: 004272af (CONDITIONAL_JUMP)
    CMP EAX,dword ptr [ESP + 0x3c]      ; 004271a2
    JNZ 0x00427297                      ; 004271a6 | LAB_00427297
    ...
    JL 0x0042716e                       ; 004271b8 | LAB_0042716e
        ;   XREF to: 0042716e (CONDITIONAL_JUMP)
    TEST ESI,ESI                        ; 004271ba
        ;   Label: LAB_004271ba
    JLE 0x00427280                      ; 004271bc | LAB_00427280
    ...
    JL 0x004272e2                       ; 004271e8 | LAB_004272e2
    ...
    FSQRT                               ; 00427269
    FMUL double ptr [0x00616e53]        ; 0042726b | double DOUBLE_00616e53
