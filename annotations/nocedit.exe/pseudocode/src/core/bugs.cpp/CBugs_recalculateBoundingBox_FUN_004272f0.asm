...
;
; XREF[5]:
;   core_bugs.cpp_CBugs_attackSwarmTarget_FUN_00425fe0 at 00426161
;   core_bugs.cpp_CBugs_processInEditor_FUN_004278d0 at 004279a1
;   core_bugs.cpp_CBugs_setup_FUN_00424e50 at 00425087
;   core_bugs.cpp_CBugs_updateBoundingBox_FUN_00426410 at 00426415
;   core_bugs.cpp_CBugs_updateBugsBehavior_FUN_00425cc0 at 00425dc1
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004272f0
        ;   Label: core_bugs.cpp_CBugs_recalculateBoundingBox_FUN_004272f0
    PUSH ESI                            ; 004272f1
    PUSH EDI                            ; 004272f2
    PUSH EBP                            ; 004272f3
