...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_bugs.cpp_FUN_00425cc0()
;
;
; XREF[1]:
;   core_bugs.cpp_FUN_004250f0 at 00425130
;
; Referenced Globals:
...
section .text
    ...
    FCOMP double ptr [0x00616df3]       ; 00425d25 | double DOUBLE_00616df3
    FNSTSW AX                           ; 00425d2b
    SAHF                                ; 00425d2d
    JNC 0x00425dd0                      ; 00425d2e | LAB_00425dd0
        ;   XREF to: 00425dd0 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x34]          ; 00425d34
    FABS                                ; 00425d38
    FCOMP double ptr [0x00616df3]       ; 00425d3a | double DOUBLE_00616df3
    FNSTSW AX                           ; 00425d40
    SAHF                                ; 00425d42
    JNC 0x00425dd0                      ; 00425d43 | LAB_00425dd0
        ;   XREF to: 00425dd0 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x3c]          ; 00425d49
    FABS                                ; 00425d4d
    FCOMP double ptr [0x00616df3]       ; 00425d4f | double DOUBLE_00616df3
    FNSTSW AX                           ; 00425d55
    SAHF                                ; 00425d57
    JNC 0x00425dd0                      ; 00425d58 | LAB_00425dd0
        ;   XREF to: 00425dd0 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 00425d5e
        ;   Label: LAB_00425d5e
    CALL core_bugs.cpp_FUN_004257f0     ; 00425d5f | undefined core_bugs.cpp_FUN_004257f0()
        ;   XREF to: 004257f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00425d64
    MOV ESI,dword ptr [EBX + 0xbe3c]    ; 00425d67
    PUSH ESI                            ; 00425d6d
    PUSH EBX                            ; 00425d6e
    CALL core_bugs.cpp_FUN_00427400     ; 00425d6f | undefined core_bugs.cpp_FUN_00427400()
        ;   XREF to: 00427400 (UNCONDITIONAL_CALL)
    MOV EDI,dword ptr [EBX + 0xbebc]    ; 00425d74
    ADD ESP,0x8                         ; 00425d7a
    CMP EDI,0x1                         ; 00425d7d
    JZ 0x00425fc6                       ; 00425d80 | LAB_00425fc6
        ;   XREF to: 00425fc6 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0xbec0]    ; 00425d86
        ;   Label: LAB_00425d86
    XOR ESI,ESI                         ; 00425d8c
    TEST EAX,EAX                        ; 00425d8e
    JLE 0x00425dc0                      ; 00425d90 | LAB_00425dc0
    ...
    PUSH EBX                            ; 00425d9e
    INC ESI                             ; 00425d9f
    CALL core_bugs.cpp_FUN_00426420     ; 00425da0 | undefined core_bugs.cpp_FUN_00426420()
    ...
    JL 0x00425d98                       ; 00425db3 | LAB_00425d98
    ...
    PUSH EBX                            ; 00425dc0
        ;   Label: LAB_00425dc0
    CALL core_bugs.cpp_FUN_004272f0     ; 00425dc1 | undefined core_bugs.cpp_FUN_004272f0()
    ...
    JNZ 0x00425e19                      ; 00425e03 | LAB_00425e19
        ;   XREF to: 00425e19 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0xbe3c]    ; 00425e05
    ADD EAX,0x20                        ; 00425e0b
    PUSH EAX                            ; 00425e0e
    CALL core_path.cpp_FUN_00548500     ; 00425e0f | undefined core_path.cpp_FUN_00548500()
    ...
    PUSH ESI                            ; 00425e25
    PUSH EDI                            ; 00425e26
    CALL core_path.cpp_CPathMap_findPathWithRetry_FUN_00547d00 ; 00425e27 | int core_path.cpp_CPathMap_findPathWithRetry_FUN_00547d00(CPathMap * this_ptr, CVector3f * dest_position, CVector3f * out_euler_angles, int direction_hint)
        ;   XREF to: 00547d00 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00425e2c
    TEST EAX,EAX                        ; 00425e2f
    JZ 0x00425fb8                       ; 00425e31 | LAB_00425fb8
        ;   XREF to: 00425fb8 (CONDITIONAL_JUMP)
    LEA EAX,[ESP + 0x58]                ; 00425e37
    PUSH EAX                            ; 00425e3b
    LEA EAX,[ESP + 0x4]                 ; 00425e3c
    PUSH EAX                            ; 00425e40
    CALL core_dirmat.cpp_CMatrix3x3f_buildRotationMatrix_FUN_00471d30 ; 00425e41 | void core_dirmat.cpp_CMatrix3x3f_buildRotationMatrix_FUN_00471d30(CMatrix3x3f * this_ptr, CVector3f * euler_angles)
    ...
    CALL core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0 ; 00425e80 | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0(CMatrix3x3f * this_ptr, CVector3f * output, CVector3f * input)
    ...
    PUSH EAX                            ; 00425eab
    PUSH EBX                            ; 00425eac
    CALL core_charactr.cpp_CCharacter_FUN_00428f40 ; 00425ead | void core_charactr.cpp_CCharacter_FUN_00428f40(CCharacter * this_ptr)
    ...
    FXCH                                ; 00425f23
    FLD float ptr [0x00616dfb]          ; 00425f25 | float FLOAT_00616dfb
    FXCH                                ; 00425f2b
    FMUL ST1                            ; 00425f2d
    FXCH ST2                            ; 00425f2f
