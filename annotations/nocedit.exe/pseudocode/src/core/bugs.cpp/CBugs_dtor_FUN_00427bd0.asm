...
;                               FUNCTION
; *****************************************************************************
; __cdecl CBugs * __cdecl core_bugs_cpp_CBugs_dtor_FUN_00427bd0 (CBugs *this_ptr,uint d1,uint d2,uint d3,uint d4,uint d5,uint d6,uint d7,uint d8,uint d9)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00427be8
    CALL core_bugs.cpp_FUN_00427cc0     ; 00427be9
        ;   XREF to: 00427cc0 (UNCONDITIONAL_CALL)  ; int core_bugs.cpp_FUN_00427cc0(SBug * * objs)
    ADD ESP,0x8                         ; 00427bee
    PUSH 0x0                            ; 00427bf1
    SUB EAX,0x8af8                      ; 00427bf3
    PUSH EAX                            ; 00427bf8
    CALL core_backgnd.cpp_freeFlames_FUN_00412720 ; 00427bf9
    ...
    PUSH EAX                            ; 00427c08
    CALL core_backgnd.cpp_freeFires_FUN_00412700 ; 00427c09
    ...
    PUSH EAX                            ; 00427c18
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 00427c19
    ...
    PUSH EAX                            ; 00427c28
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 00427c29
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; int core_backgnd.cpp_cleanupVector_FUN_004126e0(CVector3f * * objs)
    ADD ESP,0x8                         ; 00427c2e
    PUSH 0x0                            ; 00427c31
    SUB EAX,0x1c8                       ; 00427c33
    PUSH EAX                            ; 00427c38
    CALL core_cloth.cpp_FUN_0043bf80    ; 00427c39
    ...
    PUSH 0x65b790                       ; 00427c71 | g_CBugsTypeInfo
        ;   Label: LAB_00427c71
    PUSH EBX                            ; 00427c76
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 00427c77
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 00427c7c
    PUSH EAX                            ; 00427c7f
    CALL crt_memory.c_free_FUN_005fe659 ; 00427c80
