...
section .text
    ...
    CALL core_enemy.cpp_CEnemy_FUN_004a9650 ; 00424e73 | void core_enemy.cpp_CEnemy_FUN_004a9650(CEnemy * this_ptr)
    ...
    JLE 0x00424f33                      ; 00424e92 | LAB_00424f33
    ...
    TEST AH,AH                          ; 00424eb2
    JNZ 0x004250be                      ; 00424eb4 | LAB_004250be
    ...
    JGE 0x00424f24                      ; 00424ece | LAB_00424f24
    ...
    PUSH EAX                            ; 00424ef1
    CALL core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0 ; 00424ef2 | void core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0(CKeyFramedModelInstance * this_ptr, char * filename)
    ...
    JLE 0x00425083                      ; 00424f43 | LAB_00425083
        ;   XREF to: 00425083 (CONDITIONAL_JUMP)
    FLD float ptr [0x0065b5c8]          ; 00424f49 | DAT_0065b5c8
    FLD ST0                             ; 00424f4f
    FMUL float ptr [0x00616d1b]         ; 00424f51 | float FLOAT_00616d1b
    FXCH                                ; 00424f57
    FMUL float ptr [0x00616d1f]         ; 00424f59 | float FLOAT_00616d1f
    ...
    PUSH EAX                            ; 00424fac
    PUSH 0x0                            ; 00424fad
    CALL core_actor.cpp_getRandomInt_FUN_0040cc70 ; 00424faf | int core_actor.cpp_getRandomInt_FUN_0040cc70(int min_value, int max_value)
        ;   XREF to: 0040cc70 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00424fb4
    FLD double ptr [0x00616d23]         ; 00424fb7 | double DOUBLE_00616d23
    ...
    CALL core_actor.cpp_getRandomFloat_FUN_0040cc10 ; 00424fdb | float core_actor.cpp_getRandomFloat_FUN_0040cc10(float min_value, float max_value)
        ;   XREF to: 0040cc10 (UNCONDITIONAL_CALL)
    MOV EBX,dword ptr [EBP + 0x14]      ; 00425083
        ;   Label: LAB_00425083
    PUSH EBX                            ; 00425086
    CALL core_bugs.cpp_FUN_004272f0     ; 00425087 | undefined core_bugs.cpp_FUN_004272f0()
    ...
    PUSH EDI                            ; 004250be
        ;   Label: LAB_004250be
    CALL core_dmodel.cpp_CKeyFramedModelInstance_preCache_FUN_00478d60 ; 004250bf | CKeyFramedModel * core_dmodel.cpp_CKeyFramedModelInstance_preCache_FUN_00478d60(CKeyFramedModelInstance * this_ptr)
        ;   XREF to: 00478d60 (UNCONDITIONAL_CALL)
    ADD ESI,0x17c                       ; 004250c4
    INC EBX                             ; 004250ca
    ADD ESP,0x4                         ; 004250cb
    JMP 0x00424f24                      ; 004250ce | LAB_00424f24
