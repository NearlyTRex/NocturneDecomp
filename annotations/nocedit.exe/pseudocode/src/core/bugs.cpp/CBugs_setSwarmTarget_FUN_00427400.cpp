      ...
      if (pCVar5->vertex_count[iVar3] < 0x2bd) {
        ...
        for (iVar3 = this_ptr->swarm_vertex_count + -2; -1 < iVar3; iVar3 = iVar3 + -1) {
          if (-1 < iVar3) {
            iVar4 = 0;
            do {
              if (pCVar1[*(int *)((int)g_BugsSortedVertexIndices + iVar4 + 4)].y <
                  pCVar1[*(int *)((int)g_BugsSortedVertexIndices + iVar4)].y) {
                puVar8 = (uint *)((int)g_BugsSortedVertexIndices + iVar4 + 4);
                uVar2 = *(uint *)((int)g_BugsSortedVertexIndices + iVar4);
                *(uint *)((int)g_BugsSortedVertexIndices + iVar4) = *puVar8;
                *puVar8 = uVar2;
              }
              iVar4 = iVar4 + 4;
            } while (iVar4 <= iVar3 * 4);
