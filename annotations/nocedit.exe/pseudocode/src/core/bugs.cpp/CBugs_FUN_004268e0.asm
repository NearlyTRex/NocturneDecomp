...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_bugs_cpp_CBugs_FUN_004268e0(CBugs *this_ptr)
;
; Parameters:
...
;
; XREF[1]:
;   core_bugs.cpp_CBugs_FUN_00425fe0 at 0042614b
;
; Referenced Globals:
...
;   core_bugs.cpp_CBugs_FUN_004270f0
...
section .text
    ...
    PUSH EBX                            ; 004268e0
        ;   Label: core_bugs.cpp_CBugs_FUN_004268e0
    PUSH ESI                            ; 004268e1
    PUSH EDI                            ; 004268e2
    PUSH EBP                            ; 004268e3
    ...
    PUSH ESI                            ; 00427008
    PUSH EDI                            ; 00427009
    CALL core_bugs.cpp_CBugs_FUN_00426420 ; 0042700a
    ...
    PUSH ESI                            ; 0042701a
    PUSH EDI                            ; 0042701b
    CALL core_bugs.cpp_CBugs_FUN_004270f0 ; 0042701c
        ;   XREF to: 004270f0 (UNCONDITIONAL_CALL)  ; void core_bugs.cpp_CBugs_FUN_004270f0(CBugs * this_ptr)
    ...
    PUSH ESI                            ; 00427032
        ;   Label: LAB_00427032
    PUSH EDI                            ; 00427033
    CALL core_bugs.cpp_CBugs_FUN_004270f0 ; 00427034
        ;   XREF to: 004270f0 (UNCONDITIONAL_CALL)  ; void core_bugs.cpp_CBugs_FUN_004270f0(CBugs * this_ptr)
    ...
    PUSH ESI                            ; 00427048
        ;   Label: LAB_00427048
    PUSH EDI                            ; 00427049
    CALL core_bugs.cpp_CBugs_FUN_004270f0 ; 0042704a
        ;   XREF to: 004270f0 (UNCONDITIONAL_CALL)  ; void core_bugs.cpp_CBugs_FUN_004270f0(CBugs * this_ptr)
