...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_bugs_cpp_CBugs_FUN_004257f0(CBugs *this_ptr)
;
; Parameters:
...
;
; XREF[3]:
;   core_bugs.cpp_CBugs_FUN_00425cc0 at 00425fb9
;   core_bugs.cpp_CBugs_FUN_00425fe0 at 004263f4
...
section .text
    ...
    PUSH EBX                            ; 004257f0
        ;   Label: core_bugs.cpp_CBugs_FUN_004257f0
    PUSH EBP                            ; 004257f1
