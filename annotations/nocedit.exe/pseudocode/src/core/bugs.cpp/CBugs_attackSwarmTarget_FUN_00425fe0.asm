...
;   core_bugs.cpp_CBugs_updateBugsBehavior_FUN_00425cc0 at 00425fca
;
; Referenced Globals:
...
;   core_bugs.cpp_CBugs_updateBugRenderingData_FUN_004268e0
...
section .text
    ...
    PUSH EBX                            ; 00425fe0
        ;   Label: core_bugs.cpp_CBugs_attackSwarmTarget_FUN_00425fe0
    PUSH ESI                            ; 00425fe1
    PUSH EDI                            ; 00425fe2
    PUSH EBP                            ; 00425fe3
    ...
    JMP 0x03fc4786                      ; 004260fe
        ;   XREF to: 03fc4786 (UNCONDITIONAL_JUMP)  ; LAB_03fc4786
    ...
    PUSH EBX                            ; 00426149
    INC EDI                             ; 0042614a
    CALL core_bugs.cpp_CBugs_updateBugRenderingData_FUN_004268e0 ; 0042614b
        ;   XREF to: 004268e0 (UNCONDITIONAL_CALL)  ; void core_bugs.cpp_CBugs_updateBugRenderingData_FUN_004268e0(CBugs * this_ptr, SBug * bug_data, float delta_time)
    ...
    PUSH EBX                            ; 00426160
        ;   Label: LAB_00426160
    CALL core_bugs.cpp_CBugs_recalculateBoundingBox_FUN_004272f0 ; 00426161
    ...
    CALL core_bugs.cpp_CBugs_applySwarmTranslation_FUN_004276c0 ; 00426207
    ...
    PUSH EAX                            ; 004263ab
    PUSH EBX                            ; 004263ac
    CALL core_bugs.cpp_CBugs_applySwarmTranslation_FUN_004276c0 ; 004263ad
        ;   XREF to: 004276c0 (UNCONDITIONAL_CALL)  ; void core_bugs.cpp_CBugs_applySwarmTranslation_FUN_004276c0(CBugs * this_ptr, CVector3f * new_position)
    ADD ESP,0x8                         ; 004263b2
    PUSH EBX                            ; 004263b5
        ;   Label: LAB_004263b5
    CALL core_bugs.cpp_CBugs_updateGroundHeightGrid_FUN_004257f0 ; 004263b6
    ...
    JA 0x00426267                       ; 004263ed
        ;   XREF to: 00426267 (CONDITIONAL_JUMP)  ; LAB_00426267
    PUSH EBX                            ; 004263f3
    CALL core_bugs.cpp_CBugs_updateGroundHeightGrid_FUN_004257f0 ; 004263f4
        ;   XREF to: 004257f0 (UNCONDITIONAL_CALL)  ; void core_bugs.cpp_CBugs_updateGroundHeightGrid_FUN_004257f0(CBugs * this_ptr)
    ADD ESP,0x4                         ; 004263f9
    JMP 0x00426034                      ; 004263fc
        ;   XREF to: 00426034 (UNCONDITIONAL_JUMP)  ; LAB_00426034
    MOV ECX,0xc                         ; 03fc4786
        ;   Label: LAB_03fc4786
    LEA ESI,[ESP + 0xa4]                ; 03fc478b
    LEA EDI,[EBX + 0x12b00]             ; 03fc4792
    ADD ESP,0x8                         ; 03fc4798
    MOV ECX,dword ptr [ESI]             ; 03fc479b
    MOV dword ptr [EDI],ECX             ; 03fc479d
    MOV ECX,dword ptr [ESI + 0x4]       ; 03fc479f
    MOV dword ptr [EDI + 0x4],ECX       ; 03fc47a2
    MOV ECX,dword ptr [ESI + 0x8]       ; 03fc47a5
    MOV dword ptr [EDI + 0x8],ECX       ; 03fc47a8
    MOV ECX,dword ptr [ESI + 0xc]       ; 03fc47ab
    MOV dword ptr [EDI + 0xc],ECX       ; 03fc47ae
    MOV ECX,dword ptr [ESI + 0x10]      ; 03fc47b1
    MOV dword ptr [EDI + 0x10],ECX      ; 03fc47b4
    MOV ECX,dword ptr [ESI + 0x14]      ; 03fc47b7
    MOV dword ptr [EDI + 0x14],ECX      ; 03fc47ba
    MOV ECX,dword ptr [ESI + 0x18]      ; 03fc47bd
    MOV dword ptr [EDI + 0x18],ECX      ; 03fc47c0
    MOV ECX,dword ptr [ESI + 0x1c]      ; 03fc47c3
    MOV dword ptr [EDI + 0x1c],ECX      ; 03fc47c6
    MOV ECX,dword ptr [ESI + 0x20]      ; 03fc47c9
    MOV dword ptr [EDI + 0x20],ECX      ; 03fc47cc
    MOV ECX,dword ptr [ESI + 0x24]      ; 03fc47cf
    MOV dword ptr [EDI + 0x24],ECX      ; 03fc47d2
    MOV ECX,dword ptr [ESI + 0x28]      ; 03fc47d5
    MOV dword ptr [EDI + 0x28],ECX      ; 03fc47d8
    MOV ECX,dword ptr [ESI + 0x2c]      ; 03fc47db
    MOV dword ptr [EDI + 0x2c],ECX      ; 03fc47de
    ADD ESI,0x30                        ; 03fc47e1
    ADD EDI,0x30                        ; 03fc47e4
    XOR ECX,ECX                         ; 03fc47e7
    JMP 0x00426115                      ; 03fc47e9
        ;   XREF to: 00426115 (UNCONDITIONAL_JUMP)  ; LAB_00426115
