...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_bugs_cpp_CBugs_FUN_00425660(CBugs *this_ptr)
;
; Parameters:
; CBugs *          Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_bugs.cpp_CBugs_FUN_00427400 at 00427519
;
; Called Functions:
...
section .text
    ...
    PUSH ESI                            ; 00425660
        ;   Label: core_bugs.cpp_CBugs_FUN_00425660
    PUSH EDI                            ; 00425661
    PUSH EBP                            ; 00425662
    ...
    CALL core_bugs.cpp_CBugs_addSwarmGraphEdge_FUN_00425740 ; 004256a9
        ;   XREF to: 00425740 (UNCONDITIONAL_CALL)  ; void core_bugs.cpp_CBugs_addSwarmGraphEdge_FUN_00425740(CBugs * this_ptr)
