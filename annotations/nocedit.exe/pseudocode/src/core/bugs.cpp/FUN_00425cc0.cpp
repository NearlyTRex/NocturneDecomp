...

{
  ...
  if ((in_stack_00000004[2].model.bone_transform.bone_world_matrices[0x42].m[1].y != 0.0) &&
    ...
    if (iVar3 != 0) {
      ...
      pfVar1 = &(in_stack_00000004->base).location.position.y;
      fStack_64 = *pfVar1;
      pfStack_14 = &(in_stack_00000004->base).location.position.z;
      ...
      (in_stack_00000004->base).location.position.y = fStack_64;
      (in_stack_00000004->base).location.position.z = fStack_60;
      fStack_44 = fStack_38 - (dest_position->position).x;
      fStack_3c = fStack_30 - (in_stack_00000004->base).location.position.z;
