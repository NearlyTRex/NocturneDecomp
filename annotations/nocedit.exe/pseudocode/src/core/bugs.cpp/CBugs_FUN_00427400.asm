...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_bugs_cpp_CBugs_FUN_00427400(CBugs *this_ptr)
;
; Parameters:
...
;
; XREF[1]:
;   core_bugs.cpp_CBugs_FUN_00425cc0 at 00425d6f
;
; Referenced Globals:
...
;   core_bugs.cpp_CBugs_FUN_00425660
...
section .text
    ...
    PUSH EBX                            ; 00427400
        ;   Label: core_bugs.cpp_CBugs_FUN_00427400
    PUSH ESI                            ; 00427401
    PUSH EDI                            ; 00427402
    PUSH EBP                            ; 00427403
    ...
    PUSH EBX                            ; 00427517
    PUSH EBP                            ; 00427518
    CALL core_bugs.cpp_CBugs_FUN_00425660 ; 00427519
        ;   XREF to: 00425660 (UNCONDITIONAL_CALL)  ; void core_bugs.cpp_CBugs_FUN_00425660(CBugs * this_ptr)
