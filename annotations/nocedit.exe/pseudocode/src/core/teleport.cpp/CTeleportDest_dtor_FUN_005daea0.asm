...
;                               FUNCTION
; *****************************************************************************
; __cdecl CTeleportDest * __cdecl core_teleport_cpp_CTeleportDest_dtor_FUN_005daea0(CTeleportDest *this_ptr,uint d1,uint d2)
;
; Parameters:
...
section .text
    ...
    PUSH 0x664430                       ; 005daec6 | g_CTeleportDestTypeInfo
        ;   Label: LAB_005daec6
    PUSH EBX                            ; 005daecb
    CALL crt_memory.c___vec_delete_FUN_005fe632 ; 005daecc
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c___vec_delete_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 005daed1
    PUSH EAX                            ; 005daed4
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 005daed5
