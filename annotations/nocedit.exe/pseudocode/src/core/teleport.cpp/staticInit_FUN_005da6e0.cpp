...

{
  core_actor_cpp_registerActorClass_FUN_0040c2e0
            (&g_CTeleportDestClassInfo,"CTeleportDest",
             core_teleport_cpp_factoryFuncTeleportDest_FUN_005da730,&g_CTeleportDestClassVersion,1,
             &g_CDemonActorClassInfo);
  core_actor_cpp_registerActorClass_FUN_0040c2e0
            (&g_CTeleportClassInfo,"CTeleport",
             core_teleport_cpp_factoryFuncTeleport_FUN_005da9a0,&g_CTeleportClassVersion,1,
             &g_CDemonActorClassInfo);
  return;
}
