...
section .text
    ...
    JNZ 0x005daa38                      ; 005daa30 | LAB_005daa38
    ...
    POP EBX                             ; 005daa36
    RET                                 ; 005daa37
    MOV EDX,dword ptr [0x02db87d0]      ; 005daa38 | int g_LocalHeroIndex
        ;   Label: LAB_005daa38
    MOV EDX,dword ptr [EDX*0x4 + 0x2db87c0] ; 005daa3e | CHero *[4] g_HeroActors
    ADD EDX,0x20                        ; 005daa45
    PUSH EDX                            ; 005daa48
    LEA EAX,[ESP + 0x1c]                ; 005daa49
    PUSH EAX                            ; 005daa4d
    PUSH ESI                            ; 005daa4e
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 005daa4f | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
    ...
    FNSTSW AX                           ; 005daa6f
    SAHF                                ; 005daa71
    JA 0x005daa32                       ; 005daa72 | LAB_005daa32
        ;   XREF to: 005daa32 (CONDITIONAL_JUMP)
    FLD float ptr [EDX + 0x4]           ; 005daa74
    FCOMP float ptr [EBX + 0x4]         ; 005daa77
    FNSTSW AX                           ; 005daa7a
    SAHF                                ; 005daa7c
    JA 0x005daa32                       ; 005daa7d | LAB_005daa32
        ;   XREF to: 005daa32 (CONDITIONAL_JUMP)
    FLD float ptr [EDX + 0x8]           ; 005daa7f
    FCOMP float ptr [EBX + 0x8]         ; 005daa82
    FNSTSW AX                           ; 005daa85
    SAHF                                ; 005daa87
    JA 0x005daa32                       ; 005daa88 | LAB_005daa32
        ;   XREF to: 005daa32 (CONDITIONAL_JUMP)
    FLD float ptr [EDX + 0xc]           ; 005daa8a
    FCOMP float ptr [EBX]               ; 005daa8d
    FNSTSW AX                           ; 005daa8f
    SAHF                                ; 005daa91
    JC 0x005daa32                       ; 005daa92 | LAB_005daa32
        ;   XREF to: 005daa32 (CONDITIONAL_JUMP)
    FLD float ptr [EDX + 0x10]          ; 005daa94
    FCOMP float ptr [EBX + 0x4]         ; 005daa97
    FNSTSW AX                           ; 005daa9a
    SAHF                                ; 005daa9c
    JC 0x005daa32                       ; 005daa9d | LAB_005daa32
        ;   XREF to: 005daa32 (CONDITIONAL_JUMP)
    FLD float ptr [EDX + 0x14]          ; 005daa9f
    FCOMP float ptr [EBX + 0x8]         ; 005daaa2
    FNSTSW AX                           ; 005daaa5
    SAHF                                ; 005daaa7
    JC 0x005daa32                       ; 005daaa8 | LAB_005daa32
        ;   XREF to: 005daa32 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [ESI + 0x164]     ; 005daaaa
    ADD EDX,0x20                        ; 005daab0
    PUSH EDX                            ; 005daab3
    MOV ECX,dword ptr [0x0067d550]      ; 005daab4 | CDemonMission g_CDemonMissionInstance | CDemonMission * g_CDemonMissionPtr
    PUSH ECX                            ; 005daaba | CDemonMission g_CDemonMissionInstance
    CALL core_mission.cpp_CDemonMission_FUN_00524070 ; 005daabb | void core_mission.cpp_CDemonMission_FUN_00524070(CDemonMission * this_ptr)
