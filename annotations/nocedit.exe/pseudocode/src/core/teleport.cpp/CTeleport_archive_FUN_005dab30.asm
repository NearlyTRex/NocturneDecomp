...
section .text
    ...
    PUSH EBX                            ; 005dab30
        ;   Label: core_teleport.cpp_CTeleport_archive_FUN_005dab30
    MOV EBX,dword ptr [ESP + 0x8]       ; 005dab31
    PUSH EBX                            ; 005dab35
    CALL core_actor.cpp_CDemonActor_archive_FUN_0040c1c0 ; 005dab36
    ...
    PUSH EAX                            ; 005dab46
    CALL core_actor.cpp_archiveVector_FUN_0040b340 ; 005dab47
