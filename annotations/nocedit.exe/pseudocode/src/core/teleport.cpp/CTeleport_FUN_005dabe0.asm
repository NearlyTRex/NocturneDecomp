...
section .text
    ...
    PUSH 0x1d                           ; 005dabea
    MOV EAX,[0x0067cf44]                ; 005dabec | CKeys * g_CKeysPtr
    PUSH EAX                            ; 005dabf1 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 005dabf2 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 005dabf4
    ADD ESP,0x8                         ; 005dabf6
    TEST EAX,EAX                        ; 005dabf9
    JZ 0x005dad3c                       ; 005dabfb | LAB_005dad3c
        ;   XREF to: 005dad3c (CONDITIONAL_JUMP)
    MOV EAX,[0x0067b654]                ; 005dac01 | CGame * g_CGamePtr
    PUSH 0x4b                           ; 005dac06
    FLD float ptr [EAX + 0x264]         ; 005dac08 | g_CGameInstance.delta_time_float
    MOV EAX,[0x0067cf44]                ; 005dac0e | CKeys * g_CKeysPtr
    FMUL double ptr [0x00654d3b]        ; 005dac13 | double DOUBLE_00654d3b
    PUSH EAX                            ; 005dac19 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 005dac1a | void * g_CKeysPtr
    FSTP float ptr [ESP + 0xc]          ; 005dac1c
    CALL dword ptr [EDX]                ; 005dac20
    ADD ESP,0x8                         ; 005dac22
    TEST EAX,EAX                        ; 005dac25
    JZ 0x005dac39                       ; 005dac27 | LAB_005dac39
    ...
    PUSH 0x4d                           ; 005dac39
        ;   Label: LAB_005dac39
    MOV EAX,[0x0067cf44]                ; 005dac3b | CKeys * g_CKeysPtr
    PUSH EAX                            ; 005dac40 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 005dac41 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 005dac43
    ADD ESP,0x8                         ; 005dac45
    TEST EAX,EAX                        ; 005dac48
    JZ 0x005dac5c                       ; 005dac4a | LAB_005dac5c
    ...
    PUSH 0x1e                           ; 005dac5c
        ;   Label: LAB_005dac5c
    MOV EAX,[0x0067cf44]                ; 005dac5e | CKeys * g_CKeysPtr
    PUSH EAX                            ; 005dac63 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 005dac64 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 005dac66
    ADD ESP,0x8                         ; 005dac68
    TEST EAX,EAX                        ; 005dac6b
    JZ 0x005dac7f                       ; 005dac6d | LAB_005dac7f
    ...
    PUSH 0x10                           ; 005dac7f
        ;   Label: LAB_005dac7f
    MOV EAX,[0x0067cf44]                ; 005dac81 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 005dac86 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 005dac87 | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 005dac89
    ADD ESP,0x8                         ; 005dac8b
    TEST EAX,EAX                        ; 005dac8e
    JZ 0x005daca2                       ; 005dac90 | LAB_005daca2
    ...
    PUSH 0x50                           ; 005daca2
        ;   Label: LAB_005daca2
    MOV EAX,[0x0067cf44]                ; 005daca4 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 005daca9 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 005dacaa | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 005dacac
    ADD ESP,0x8                         ; 005dacae
    TEST EAX,EAX                        ; 005dacb1
    JZ 0x005dacc5                       ; 005dacb3 | LAB_005dacc5
    ...
    PUSH 0x48                           ; 005dacc5
        ;   Label: LAB_005dacc5
    MOV EAX,[0x0067cf44]                ; 005dacc7 | CKeys * g_CKeysPtr
    PUSH EAX                            ; 005daccc | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 005daccd | void * g_CKeysPtr
    CALL dword ptr [EDX]                ; 005daccf
    ADD ESP,0x8                         ; 005dacd1
    TEST EAX,EAX                        ; 005dacd4
    JZ 0x005dace8                       ; 005dacd6 | LAB_005dace8
    ...
    JGE 0x005dad00                      ; 005dacf8 | LAB_005dad00
    ...
    FNSTSW AX                           ; 005dad09
    SAHF                                ; 005dad0b
    JNC 0x005dad17                      ; 005dad0c | LAB_005dad17
    ...
    FNSTSW AX                           ; 005dad20
    SAHF                                ; 005dad22
    JC 0x005dad2c                       ; 005dad23 | LAB_005dad2c
    ...
    PUSH 0x14                           ; 005dad3c
        ;   Label: LAB_005dad3c
    MOV EAX,[0x0067cf44]                ; 005dad3e | CKeys * g_CKeysPtr
    PUSH EAX                            ; 005dad43 | void * g_CKeysPtr
    MOV EDX,dword ptr [EAX]             ; 005dad44 | void * g_CKeysPtr
    CALL dword ptr [EDX + 0x4]          ; 005dad46
    ADD ESP,0x8                         ; 005dad49
    TEST EAX,EAX                        ; 005dad4c
    JZ 0x005dadac                       ; 005dad4e | LAB_005dadac
        ;   XREF to: 005dadac (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [EBX + 0x164]     ; 005dad50
    TEST EDX,EDX                        ; 005dad56
    JZ 0x005dad92                       ; 005dad58 | LAB_005dad92
        ;   XREF to: 005dad92 (CONDITIONAL_JUMP)
    PUSH EDX                            ; 005dad5a
    PUSH 0x654d22                       ; 005dad5b | = "Switch to destination %s" | s_Switch_to_destination_s_00654d22 = Switch to destination %s
    MOV ESI,dword ptr [0x00678a60]      ; 005dad60 | CEditorTools * g_CEditorToolsPtr
    PUSH ESI                            ; 005dad66 | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_showConfirmationDialog_FUN_0049f060 ; 005dad67 | int shape_edittool.cpp_CEditorTools_showConfirmationDialog_FUN_0049f060(CEditorTools * this_ptr, char * format_string)
        ;   XREF to: 0049f060 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 005dad6c
    TEST EAX,EAX                        ; 005dad6f
    JZ 0x005dad25                       ; 005dad71 | LAB_005dad25
        ;   XREF to: 005dad25 (CONDITIONAL_JUMP)
    PUSH EDI                            ; 005dad73
    MOV EDI,dword ptr [EBX + 0x164]     ; 005dad74
    PUSH EDI                            ; 005dad7a
    MOV EBP,dword ptr [0x0067d550]      ; 005dad7b | CDemonMission * g_CDemonMissionPtr
    PUSH EBP                            ; 005dad81 | CDemonMission g_CDemonMissionInstance
    CALL core_msnedit.cpp_UndoTmp_BuildActorList_CreateTmp_FUN_0053c140 ; 005dad82 | undefined core_msnedit.cpp_UndoTmp_BuildActorList_CreateTmp_FUN_0053c140()
    ...
    POP EBX                             ; 005dad90
    RET                                 ; 005dad91
    PUSH 0x654d05                       ; 005dad92 | = "Teleport has no destination!" | s_Teleport_has_no_destinat_00654d05 = Teleport has no destination!
        ;   Label: LAB_005dad92
    MOV EAX,[0x00678a60]                ; 005dad97 | CEditorTools g_CEditorToolsPtr | CEditorTools * g_CEditorToolsPtr
    PUSH EAX                            ; 005dad9c | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_showError_FUN_0049e740 ; 005dad9d | void shape_edittool.cpp_CEditorTools_showError_FUN_0049e740(CEditorTools * this_ptr, char * format)
    ...
    PUSH EBX                            ; 005dadac
        ;   Label: LAB_005dadac
    CALL core_actor.cpp_CDemonActor_processInEditor_FUN_0040d040 ; 005dadad | void core_actor.cpp_CDemonActor_processInEditor_FUN_0040d040(CDemonActor * this_ptr)
