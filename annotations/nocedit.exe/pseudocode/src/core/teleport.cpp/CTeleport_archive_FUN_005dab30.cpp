...

{
  ...
  core_actor_cpp_archiveVector_FUN_0040b340((CVector3f *)this_ptr->unk,(char *)0x0);
  core_actor_cpp_archiveActor_FUN_0040b870((CDemonActor *)(this_ptr->unk + 0xc),(char *)0x0);
  return;
}
