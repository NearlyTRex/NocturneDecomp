...
;                               FUNCTION
; *****************************************************************************
; __cdecl CTeleportDest * __cdecl core_teleport_cpp_factoryFunc_FUN_005da730(void)
;
;
; XREF[1]:
...
section .text
    ...
    PUSH 0x2a                           ; 005da730
        ;   Label: core_teleport.cpp_factoryFunc_FUN_005da730
    PUSH 0x654c2b                       ; 005da732 | = "..\\core\\teleport.cpp"
    PUSH 0x158                          ; 005da737
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1b0 ; 005da73c
