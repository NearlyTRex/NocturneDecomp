...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_teleport_cpp_CTeleportDest_FUN_005da870(CTeleportDest *this_ptr)
;
; Parameters:
...
section .text
    ...
    CALL core_msnedit.cpp_FUN_0053cc30  ; 005da8bb
    ...
    CALL core_mission.cpp_CDemonMission_FUN_00524030 ; 005da941
    ...
    CALL core_msnedit.cpp_UndoTmp_BuildActorList_CreateTmp_FUN_0053c140 ; 005da951
