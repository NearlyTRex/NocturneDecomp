...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_teleport_cpp_CTeleport_showEditorHelp_FUN_005dadc0(CTeleport *this_ptr,int *y_pos)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005dadc0
        ;   Label: core_teleport.cpp_CTeleport_showEditorHelp_FUN_005dadc0
    PUSH EDI                            ; 005dadc1
    PUSH EBP                            ; 005dadc2
