...
// Convention: __cdecl
// Signature: CTeleport * __cdecl core_teleport_cpp_factoryFunc_FUN_005da9a0(void)
...

{
  ...
  pCVar1 = (CTeleport *)shape_memdbg_cpp_debugAllocTracked_FUN_0050f1b0(0x168,"..\\core\\teleport.cpp",0x8b);
