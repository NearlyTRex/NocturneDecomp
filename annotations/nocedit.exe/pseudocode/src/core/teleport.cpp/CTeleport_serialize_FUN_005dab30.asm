...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_teleport_cpp_CTeleport_serialize_FUN_005dab30(CTeleport *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005dab35
    CALL core_actor.cpp_CDemonActor_serialize_FUN_0040c1c0 ; 005dab36
    ...
    PUSH EAX                            ; 005dab46
    CALL core_actor.cpp_serializeVector_FUN_0040b340 ; 005dab47
    ...
    PUSH EAX                            ; 005dab57
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 005dab58
