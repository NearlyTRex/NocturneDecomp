...
section .text
    ...
    PUSH 0x664410                       ; 005dae76 | g_CTeleportTypeInfo
        ;   Label: LAB_005dae76
    PUSH EBX                            ; 005dae7b
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 005dae7c
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 005dae81
    PUSH EAX                            ; 005dae84
    CALL crt_memory.c_free_FUN_005fe659 ; 005dae85
    ...
    PUSH EAX                            ; 005dae91
        ;   Label: LAB_005dae91
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 005dae92
