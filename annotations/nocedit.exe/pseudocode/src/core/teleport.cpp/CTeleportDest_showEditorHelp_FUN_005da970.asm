...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_teleport_cpp_CTeleportDest_showEditorHelp_FUN_005da970(CTeleportDest *this_ptr,int *y_pos)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005da970
        ;   Label: core_teleport.cpp_CTeleportDest_showEditorHelp_FUN_005da970
