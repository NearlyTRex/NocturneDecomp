...
section .text
    ...
    PUSH EBX                            ; 0052cd86
        ;   Label: LAB_0052cd86
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 0052cd87 | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052cd8c
    TEST EAX,EAX                        ; 0052cd8f
    JL 0x0052cd98                       ; 0052cd91 | LAB_0052cd98
        ;   XREF to: 0052cd98 (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 0052cd93
    JNZ 0x0052cd86                      ; 0052cd96 | LAB_0052cd86
    ...
    PUSH EDI                            ; 0052cda2
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0052cda3 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0052cda8
    CMP dword ptr [ESP + 0x4],0x0       ; 0052cdab
    JL 0x0052d109                       ; 0052cdb0 | LAB_0052d109
        ;   XREF to: 0052d109 (CONDITIONAL_JUMP)
    MOV EBP,dword ptr [ESP + 0x4]       ; 0052cdb6
        ;   Label: LAB_0052cdb6
    CMP EBP,0x2                         ; 0052cdba
    JG 0x0052d131                       ; 0052cdbd | LAB_0052d131
        ;   XREF to: 0052d131 (CONDITIONAL_JUMP)
    MOV EBX,EDI                         ; 0052cdc3
        ;   Label: LAB_0052cdc3
    PUSH EBX                            ; 0052cdc5
        ;   Label: LAB_0052cdc5
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 0052cdc6 | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052cdcb
    TEST EAX,EAX                        ; 0052cdce
    JL 0x0052cdd7                       ; 0052cdd0 | LAB_0052cdd7
        ;   XREF to: 0052cdd7 (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 0052cdd2
    JNZ 0x0052cdc5                      ; 0052cdd5 | LAB_0052cdc5
    ...
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0052cde4 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    MOV EBP,dword ptr [EBX]             ; 0052cde9
    ADD ESP,0xc                         ; 0052cdeb
    TEST EBP,EBP                        ; 0052cdee
    JLE 0x0052ce20                      ; 0052cdf0 | LAB_0052ce20
    ...
    PUSH EDI                            ; 0052cdfb
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0052cdfc | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ...
    JL 0x0052cdf5                       ; 0052ce10 | LAB_0052cdf5
    ...
    PUSH EBX                            ; 0052ce22
        ;   Label: LAB_0052ce22
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 0052ce23 | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052ce28
    TEST EAX,EAX                        ; 0052ce2b
    JL 0x0052ce34                       ; 0052ce2d | LAB_0052ce34
        ;   XREF to: 0052ce34 (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 0052ce2f
    JNZ 0x0052ce22                      ; 0052ce32 | LAB_0052ce22
    ...
    PUSH EDI                            ; 0052ce43
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0052ce44 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ...
    JLE 0x0052d101                      ; 0052ce5e | LAB_0052d101
    ...
    PUSH ESI                            ; 0052ce73
        ;   Label: LAB_0052ce73
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 0052ce74 | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052ce79
    TEST EAX,EAX                        ; 0052ce7c
    JL 0x0052ce85                       ; 0052ce7e | LAB_0052ce85
        ;   XREF to: 0052ce85 (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 0052ce80
    JNZ 0x0052ce73                      ; 0052ce83 | LAB_0052ce73
    ...
    PUSH EAX                            ; 0052ce94
    PUSH EBX                            ; 0052ce95
    PUSH 0x63a60b                       ; 0052ce96 | = "\"%[^\"]\",%f,%d,%d,%d\n" | s_f_d_d_d_0063a60b = "%[^"]",%f,%d,%d,%d

    PUSH EDI                            ; 0052ce9b
    MOV ESI,EDI                         ; 0052ce9c
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0052ce9e | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x1c                        ; 0052cea3
    PUSH ESI                            ; 0052cea6
        ;   Label: LAB_0052cea6
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 0052cea7 | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052ceac
    TEST EAX,EAX                        ; 0052ceaf
    JL 0x0052ceb8                       ; 0052ceb1 | LAB_0052ceb8
        ;   XREF to: 0052ceb8 (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 0052ceb3
    JNZ 0x0052cea6                      ; 0052ceb6 | LAB_0052cea6
    ...
    PUSH EAX                            ; 0052cec3
    PUSH 0x63a620                       ; 0052cec4 | = "%d,%d,%f\n" | s_d_d_f_0063a620 = %d,%d,%f

    PUSH EDI                            ; 0052cec9
    MOV ESI,EDI                         ; 0052ceca
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0052cecc | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0052ced1
    PUSH ESI                            ; 0052ced4
        ;   Label: LAB_0052ced4
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 0052ced5 | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052ceda
    TEST EAX,EAX                        ; 0052cedd
    JL 0x0052cee6                       ; 0052cedf | LAB_0052cee6
        ;   XREF to: 0052cee6 (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 0052cee1
    JNZ 0x0052ced4                      ; 0052cee4 | LAB_0052ced4
    ...
    PUSH EAX                            ; 0052cef2
    PUSH 0x63a62a                       ; 0052cef3 | = "%d,%f,%d\n" | s_d_f_d_0063a62a = %d,%f,%d

    PUSH EDI                            ; 0052cef8
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0052cef9 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 0052cf09
        ;   Label: LAB_0052cf09
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 0052cf0a | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052cf0f
    TEST EAX,EAX                        ; 0052cf12
    JL 0x0052cf1b                       ; 0052cf14 | LAB_0052cf1b
        ;   XREF to: 0052cf1b (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 0052cf16
    JNZ 0x0052cf09                      ; 0052cf19 | LAB_0052cf09
    ...
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0052cf2b | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0052cf30
    PUSH ESI                            ; 0052cf33
        ;   Label: LAB_0052cf33
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 0052cf34 | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052cf39
    TEST EAX,EAX                        ; 0052cf3c
    JL 0x0052cf45                       ; 0052cf3e | LAB_0052cf45
        ;   XREF to: 0052cf45 (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 0052cf40
    JNZ 0x0052cf33                      ; 0052cf43 | LAB_0052cf33
    ...
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0052cf51 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    MOV EBP,dword ptr [EBX + 0x68]      ; 0052cf56
    ADD ESP,0xc                         ; 0052cf59
    TEST EBP,EBP                        ; 0052cf5c
    JLE 0x0052cff1                      ; 0052cf5e | LAB_0052cff1
    ...
    PUSH EAX                            ; 0052cfac
    PUSH 0x63a63f                       ; 0052cfad | = "%d,%d,%d,%f,%f,%d\n" | s_d_d_d_f_f_d_0063a63f = %d,%d,%d,%f,%f,%d

    PUSH EDI                            ; 0052cfb2
    ADD EBP,0x18                        ; 0052cfb3
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0052cfb6 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ...
    JL 0x0052cf86                       ; 0052cfef | LAB_0052cf86
        ;   XREF to: 0052cf86 (CONDITIONAL_JUMP)
    MOV EBP,EDI                         ; 0052cff1
        ;   Label: LAB_0052cff1
    PUSH EBP                            ; 0052cff3
        ;   Label: LAB_0052cff3
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 0052cff4 | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052cff9
    TEST EAX,EAX                        ; 0052cffc
    JL 0x0052d005                       ; 0052cffe | LAB_0052d005
        ;   XREF to: 0052d005 (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 0052d000
    JNZ 0x0052cff3                      ; 0052d003 | LAB_0052cff3
    ...
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0052d014 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [EBX + 0x4a4]     ; 0052d019
    ADD ESP,0xc                         ; 0052d01f
    TEST ECX,ECX                        ; 0052d022
    JLE 0x0052d061                      ; 0052d024 | LAB_0052d061
    ...
    INC ESI                             ; 0052d04e
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0052d04f | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [EBX + 0x4a4]     ; 0052d054
    ADD ESP,0x10                        ; 0052d05a
    CMP ESI,ECX                         ; 0052d05d
    JL 0x0052d036                       ; 0052d05f | LAB_0052d036
        ;   XREF to: 0052d036 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x4],0x2       ; 0052d061
        ;   Label: LAB_0052d061
    JL 0x0052d15b                       ; 0052d066 | LAB_0052d15b
        ;   XREF to: 0052d15b (CONDITIONAL_JUMP)
    MOV EBP,EDI                         ; 0052d06c
    PUSH EBP                            ; 0052d06e
        ;   Label: LAB_0052d06e
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 0052d06f | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052d074
    TEST EAX,EAX                        ; 0052d077
    JL 0x0052d080                       ; 0052d079 | LAB_0052d080
        ;   XREF to: 0052d080 (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 0052d07b
    JNZ 0x0052d06e                      ; 0052d07e | LAB_0052d06e
        ;   XREF to: 0052d06e (CONDITIONAL_JUMP)
    LEA EAX,[EBX + 0x520]               ; 0052d080
        ;   Label: LAB_0052d080
    PUSH EAX                            ; 0052d086
    PUSH 0x63a65d                       ; 0052d087 | = "%d" | s_d_0063a65d = %d
    PUSH EDI                            ; 0052d08c
    XOR ESI,ESI                         ; 0052d08d
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0052d08f | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    MOV EBP,dword ptr [EBX + 0x520]     ; 0052d094
    ADD ESP,0xc                         ; 0052d09a
    TEST EBP,EBP                        ; 0052d09d
    JLE 0x0052d0c4                      ; 0052d09f | LAB_0052d0c4
        ;   XREF to: 0052d0c4 (CONDITIONAL_JUMP)
    LEA EBP,[EBX + 0x524]               ; 0052d0a1
    PUSH EBP                            ; 0052d0a7
        ;   Label: LAB_0052d0a7
    PUSH 0x63a660                       ; 0052d0a8 | = "%d" | s_d_0063a660 = %d
    PUSH EDI                            ; 0052d0ad
    INC ESI                             ; 0052d0ae
    ADD EBP,0x4                         ; 0052d0af
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0052d0b2 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EBX + 0x520]     ; 0052d0b7
    ADD ESP,0xc                         ; 0052d0bd
    CMP ESI,EAX                         ; 0052d0c0
    JL 0x0052d0a7                       ; 0052d0c2 | LAB_0052d0a7
        ;   XREF to: 0052d0a7 (CONDITIONAL_JUMP)
    MOV EBP,EDI                         ; 0052d0c4
        ;   Label: LAB_0052d0c4
    PUSH EBP                            ; 0052d0c6
        ;   Label: LAB_0052d0c6
    CALL crt_stdio.c_fgetc_FUN_005fe840 ; 0052d0c7 | int crt_stdio.c_fgetc_FUN_005fe840(FILE * file)
        ;   XREF to: 005fe840 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052d0cc
    TEST EAX,EAX                        ; 0052d0cf
    JL 0x0052d0d8                       ; 0052d0d1 | LAB_0052d0d8
        ;   XREF to: 0052d0d8 (CONDITIONAL_JUMP)
    CMP EAX,0xa                         ; 0052d0d3
    JNZ 0x0052d0c6                      ; 0052d0d6 | LAB_0052d0c6
    ...
    JL 0x0052ce6d                       ; 0052d0fb | LAB_0052ce6d
    ...
    POP EBX                             ; 0052d107
    RET                                 ; 0052d108
    MOV EBX,0x63a54b                    ; 0052d109 | = "..\\core\\motion.cpp" | s_core_motion_cpp_0063a54b = ..\core\motion.cpp
        ;   Label: LAB_0052d109
    MOV ESI,0x5b                        ; 0052d10e
    PUSH 0x63a55e                       ; 0052d113 | = "Error reading motion list." | s_Error_reading_motion_lis_0063a55e = Error reading motion list.
    MOV dword ptr [0x02f0ca48],EBX      ; 0052d118 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 0052d11e | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0052d124 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052d129
    JMP 0x0052cdb6                      ; 0052d12c | LAB_0052cdb6
        ;   XREF to: 0052cdb6 (UNCONDITIONAL_JUMP)
    PUSH 0x2                            ; 0052d131
        ;   Label: LAB_0052d131
    PUSH EBP                            ; 0052d133
    MOV EAX,0x63a579                    ; 0052d134 | = "..\\core\\motion.cpp" | s_core_motion_cpp_0063a579 = ..\core\motion.cpp
    MOV EDX,0x5d                        ; 0052d139
    PUSH 0x63a58c                       ; 0052d13e | = "Can't read motion list - it's version..." | s_Can_t_read_motion_list_i_0063a58c = Can't read motion list - it's version %d, and I can only handle up to version %d.  (Probably you have an old .exe)
    MOV [0x02f0ca48],EAX                ; 0052d143 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 0052d148 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0052d14e | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0052d153
    JMP 0x0052cdc3                      ; 0052d156 | LAB_0052cdc3
        ;   XREF to: 0052cdc3 (UNCONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0x520],0x0     ; 0052d15b
        ;   Label: LAB_0052d15b
    JMP 0x0052d0d8                      ; 0052d165 | LAB_0052d0d8
