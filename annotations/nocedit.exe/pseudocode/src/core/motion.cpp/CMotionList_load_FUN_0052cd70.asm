...
; Local Variables:
; EMotionTransitionCmd Stack[-0x38]:4  local_38
; int              Stack[-0x34]:4  local_34
; SMotionTransition * Stack[-0x30]:4  local_30
; SMotion *        Stack[-0x2c]:4  local_2c
; int              Stack[-0x28]:4  local_28
; SMotionTransition * Stack[-0x24]:4  local_24
; SMotionSignal *  Stack[-0x20]:4  local_20
