// Name: core_motion.cpp_CMotionController_FUN_0052e2b0
// Address: 0052e2b0
// Address Range: [[0052e2b0, 0052e391]]
// Convention: unknown
// Signature: undefined core_motion.cpp_CMotionController_FUN_0052e2b0()
// Cross-references:
...
/* Signature: undefined1 core_motion.cpp_CMotionController_FUN_0052e2b0(CMotionController* param_1)
    */

float core_motion_cpp_CMotionController_FUN_0052e2b0(void)

{
  ...
  iVar3 = in_stack_00000004[1] * 0x54c + *in_stack_00000004 + 0x968;
  if ((float)in_stack_00000004[2] <= 0.0) {
    local_1c = 0.0;
  }
  else if ((float)*(int *)(iVar3 + 100) <= (float)in_stack_00000004[2]) {
    ...
    if (0 < *(int *)(iVar3 + 0x520)) {
      do {
        if ((float)in_stack_00000004[2] < (float)*(int *)(iVar2 + 0x524)) {
          return (float)iVar1 +
                 ((float)in_stack_00000004[2] - (float)iVar4) /
                 (float)(*(int *)(iVar2 + 0x524) - iVar4);
        }
        iVar1 = iVar1 + 1;
    ...
    local_1c = (float)*(int *)(iVar3 + 0x520) +
               ((float)in_stack_00000004[2] - (float)iVar4) / (float)(*(int *)(iVar3 + 100) - iVar4)
    ;
  }
  return local_1c;
}
...
// Assembly code:
// 0052e2b0: PUSH EBX
//   Label: core_motion.cpp_CMotionController_FUN_0052e2b0
// 0052e2b1: PUSH ESI
// 0052e2b2: PUSH EDI
// 0052e2b3: PUSH EBP
