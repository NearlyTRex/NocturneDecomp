...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
;
; Parameters:
...
section .text
    ...
    CMP dword ptr [ESP + 0x14],0x0      ; 0052db36
        ;   Label: LAB_0052db36
    JNZ 0x0052db7c                      ; 0052db3b | LAB_0052db7c
    ...
    PUSH EDI                            ; 0052db4a
        ;   Label: LAB_0052db4a
    MOV ECX,0x63aa47                    ; 0052db4b | = "..\\core\\motion.cpp" | s_core_motion_cpp_0063aa47 = ..\core\motion.cpp
    MOV EDI,0x274                       ; 0052db50
    PUSH 0x63aa5a                       ; 0052db55 | = "CMotionController::setDesiredState - ..." | s_CMotionController_setDes_0063aa5a = CMotionController::setDesiredState - invalid state index
    MOV dword ptr [0x02f0ca48],ECX      ; 0052db5a | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 0052db60 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0052db66 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052db6b
    POP EDI                             ; 0052db6e
    JMP 0x0052db14                      ; 0052db6f | LAB_0052db14
        ;   XREF to: 0052db14 (UNCONDITIONAL_JUMP)
    PUSH EBX                            ; 0052db71
        ;   Label: LAB_0052db71
    CALL core_motion.cpp_CMotionController_reverseTransition_FUN_0052da50 ; 0052db72 | void core_motion.cpp_CMotionController_reverseTransition_FUN_0052da50(CMotionController * this_ptr)
        ;   XREF to: 0052da50 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052db77
    JMP 0x0052db25                      ; 0052db7a | LAB_0052db25
        ;   XREF to: 0052db25 (UNCONDITIONAL_JUMP)
    PUSH EBX                            ; 0052db7c
        ;   Label: LAB_0052db7c
    CALL core_motion.cpp_CMotionController_findAndStartTransition_FUN_0052d950 ; 0052db7d | int core_motion.cpp_CMotionController_findAndStartTransition_FUN_0052d950(CMotionController * this_ptr)
