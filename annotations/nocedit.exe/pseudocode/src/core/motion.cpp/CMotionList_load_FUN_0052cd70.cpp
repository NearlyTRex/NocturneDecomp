...
LAB_0052ce73:
    do {
      ...
      if (local_34 < 2) {
        ...
        iVar2 = 0;
        crt_stdio_c_fscanf_FUN_005fe7c0(file_handle,"%d",&pSVar1->marker_count);
        if (0 < pSVar1->marker_count) {
          piVar5 = pSVar1->markers;
          do {
            iVar2 = iVar2 + 1;
            crt_stdio_c_fscanf_FUN_005fe7c0(file_handle,"%d",piVar5);
            piVar5 = piVar5 + 1;
