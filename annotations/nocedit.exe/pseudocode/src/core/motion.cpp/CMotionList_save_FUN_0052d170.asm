...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_motion.cpp_CMotionList_save_FUN_0052d170(CMotionList * this_ptr, FILE * file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH 0x63a663                       ; 0052d17b | = "// motion list version\n" | s_motion_list_version_0063a663 = // motion list version

    PUSH ESI                            ; 0052d180
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0052d181 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    PUSH ESI                            ; 0052d190
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0052d191 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0052d196
    PUSH 0x63a67f                       ; 0052d199 | = "// state list\n" | s_state_list_0063a67f = // state list

    PUSH ESI                            ; 0052d19e
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0052d19f | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 0052d1b3
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0052d1b4 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JLE 0x0052d1f0                      ; 0052d1c6 | LAB_0052d1f0
    ...
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0052d1da | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EBP]             ; 0052d1df
    ADD ESP,0xc                         ; 0052d1e2
    CMP EBX,EAX                         ; 0052d1e5
    JL 0x0052d1cf                       ; 0052d1e7 | LAB_0052d1cf
        ;   XREF to: 0052d1cf (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 0052d1e9
    NOP                                 ; 0052d1ef
    PUSH 0x63a696                       ; 0052d1f0 | = "// motion count\n" | s_motion_count_0063a696 = // motion count

        ;   Label: LAB_0052d1f0
    PUSH ESI                            ; 0052d1f5
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0052d1f6 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 0052d20e
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0052d20f | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JLE 0x0052d44a                      ; 0052d224 | LAB_0052d44a
    ...
    MOV ECX,dword ptr [ESP]             ; 0052d234
        ;   Label: LAB_0052d234
    PUSH ECX                            ; 0052d237
    PUSH 0x63a6ab                       ; 0052d238 | = "// motion %d: \"name\",fps,state,fram..." | s_motion_d_name_fps_state__0063a6ab = // motion %d: "name",fps,state,frameStart,frameCount

    PUSH ESI                            ; 0052d23d
    MOV EDI,dword ptr [ESP + 0x10]      ; 0052d23e
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0052d242 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDI                            ; 0052d25f
    PUSH 0x63a6e1                       ; 0052d260 | = "\"%s\",%g,%d,%d,%d\n" | s_s_g_d_d_d_0063a6e1 = "%s",%g,%d,%d,%d

    PUSH ESI                            ; 0052d265
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0052d266 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x20                        ; 0052d26b
    MOV EBX,dword ptr [ESP]             ; 0052d26e
    PUSH EBX                            ; 0052d271
    PUSH 0x63a6f3                       ; 0052d272 | = "// motion %d: exitForwardFromFrameNum..." | s_motion_d_exitForwardFrom_0063a6f3 = // motion %d: exitForwardFromFrameNumber,exitForwardToMotionNumber,exitForwardToFrameNumber

    PUSH ESI                            ; 0052d277
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0052d278 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0052d290
    PUSH 0x63a750                       ; 0052d291 | = "%d,%d,%g\n" | s_d_d_g_0063a750 = %d,%d,%g

    PUSH ESI                            ; 0052d296
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0052d297 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x18                        ; 0052d29c
    PUSH EBX                            ; 0052d29f
    PUSH 0x63a75a                       ; 0052d2a0 | = "// motion %d: exitForwardCmd,exitForw..." | s_motion_d_exitForwardCmd__0063a75a = // motion %d: exitForwardCmd,exitForwardTweenTime,exitForwardsetNewStateAsDesired

    PUSH ESI                            ; 0052d2a5
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0052d2a6 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH EBP                            ; 0052d2be
    PUSH 0x63a7ad                       ; 0052d2bf | = "%d,%g,%d\n" | s_d_g_d_0063a7ad = %d,%g,%d

    PUSH ESI                            ; 0052d2c4
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0052d2c5 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x18                        ; 0052d2ca
    PUSH EBX                            ; 0052d2cd
    PUSH 0x63a7b7                       ; 0052d2ce | = "// motion %d: exitBackwardToMotionNum..." | s_motion_d_exitBackwardToM_0063a7b7 = // motion %d: exitBackwardToMotionNumber,exitBackwardToFrameNumber

    PUSH ESI                            ; 0052d2d3
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0052d2d4 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 0052d2ee
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0052d2ef | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0052d2f4
    PUSH EBX                            ; 0052d2f7
    PUSH 0x63a802                       ; 0052d2f8 | = "// motion %d transition count, list: ..." | s_motion_d_transition_coun_0063a802 = // motion %d transition count, list: desiredState, cmd, toMotionNumber, toFrameNumber, tweenTime, setNewStateAsDesired

    PUSH ESI                            ; 0052d2fd
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0052d2fe | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0052d312 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EDI + 0x68]      ; 0052d317
    ADD ESP,0xc                         ; 0052d31a
    TEST EAX,EAX                        ; 0052d31d
    JLE 0x0052d35e                      ; 0052d31f | LAB_0052d35e
    ...
    PUSH EDX                            ; 0052d344
    PUSH 0x63a87e                       ; 0052d345 | = "%d,%d,%d,%g,%g,%d\n" | s_d_d_d_g_g_d_0063a87e = %d,%d,%d,%g,%g,%d

    PUSH ESI                            ; 0052d34a
    ADD EBX,0x18                        ; 0052d34b
    INC EBP                             ; 0052d34e
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0052d34f | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [EDI + 0x68]      ; 0052d354
    ADD ESP,0x28                        ; 0052d357
    CMP EBP,ECX                         ; 0052d35a
    JL 0x0052d324                       ; 0052d35c | LAB_0052d324
        ;   XREF to: 0052d324 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [ESP]             ; 0052d35e
        ;   Label: LAB_0052d35e
    PUSH EBX                            ; 0052d361
    PUSH 0x63a891                       ; 0052d362 | = "// motion %d signal count, list: fram..." | s_motion_d_signal_count_li_0063a891 = // motion %d signal count, list: frameNumber, value

    PUSH ESI                            ; 0052d367
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0052d368 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0052d37f | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EDI + 0x4a4]     ; 0052d384
    ADD ESP,0xc                         ; 0052d38a
    TEST EAX,EAX                        ; 0052d38d
    JLE 0x0052d3bd                      ; 0052d38f | LAB_0052d3bd
    ...
    INC EBP                             ; 0052d3aa
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0052d3ab | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EDI + 0x4a4]     ; 0052d3b0
    ADD ESP,0x10                        ; 0052d3b6
    CMP EBP,EAX                         ; 0052d3b9
    JL 0x0052d393                       ; 0052d3bb | LAB_0052d393
        ;   XREF to: 0052d393 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [ESP]             ; 0052d3bd
        ;   Label: LAB_0052d3bd
    PUSH EDX                            ; 0052d3c0
    PUSH 0x63a8d1                       ; 0052d3c1 | = "// motion %d marker count, list\n" | s_motion_d_marker_count_li_0063a8d1 = // motion %d marker count, list

    PUSH ESI                            ; 0052d3c6
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0052d3c7 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0052d3cc
    MOV ECX,dword ptr [EDI + 0x520]     ; 0052d3cf
    PUSH ECX                            ; 0052d3d5
    PUSH 0x63a8f2                       ; 0052d3d6 | = "%d" | s_d_0063a8f2 = %d
    PUSH ESI                            ; 0052d3db
    XOR EBP,EBP                         ; 0052d3dc
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0052d3de | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    MOV EBX,dword ptr [EDI + 0x520]     ; 0052d3e3
    ADD ESP,0xc                         ; 0052d3e9
    TEST EBX,EBX                        ; 0052d3ec
    JLE 0x0052d415                      ; 0052d3ee | LAB_0052d415
        ;   XREF to: 0052d415 (CONDITIONAL_JUMP)
    MOV EBX,EDI                         ; 0052d3f0
    MOV EAX,dword ptr [EBX + 0x524]     ; 0052d3f2
        ;   Label: LAB_0052d3f2
    PUSH EAX                            ; 0052d3f8
    PUSH 0x63a8f5                       ; 0052d3f9 | = " %d" | s_d_0063a8f5 =  %d
    PUSH ESI                            ; 0052d3fe
    ADD EBX,0x4                         ; 0052d3ff
    INC EBP                             ; 0052d402
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0052d403 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [EDI + 0x520]     ; 0052d408
    ADD ESP,0xc                         ; 0052d40e
    CMP EBP,EDX                         ; 0052d411
    JL 0x0052d3f2                       ; 0052d413 | LAB_0052d3f2
        ;   XREF to: 0052d3f2 (CONDITIONAL_JUMP)
    PUSH 0x63a8f9                       ; 0052d415 | = "\n" | s_anon_0063a8f9 =

        ;   Label: LAB_0052d415
    PUSH ESI                            ; 0052d41a
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0052d41b | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JL 0x0052d234                       ; 0052d444 | LAB_0052d234
