// Name: core_motion.cpp_FUN_0052d170
// Address: 0052d170
// Address Range: [[0052d170, 0052d451]]
// Convention: unknown
// Signature: undefined core_motion.cpp_FUN_0052d170()
// Cross-references:
...
void core_motion_cpp_FUN_0052d170(void)

{
  ...
  uVar5 = CONCAT44(unaff_EDI,unaff_EBP);
  crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"// motion list version\n");
  crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"%d\n",2);
  crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"// state list\n",uVar5);
  crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"%d\n",*in_stack_00000010);
  iVar1 = 0;
  if (0 < *piStack00000014) {
    ...
    } while (iVar1 < *piStack00000014);
  }
  crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"// motion count\n");
  crt_stdio_c_fprintf_FUN_005fe6d0
            (in_stack_00000008,"%d\n",*(undefined4 *)(iStack00000018 + 0x964));
  pcVar2 = (char *)0x0;
  if (0 < *(int *)(iStack00000018 + 0x964)) {
    pcVar3 = (char *)(iStack00000018 + 0x968);
    do {
      crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"// motion %d: \"name\",fps,state,frameStart,frameCount\n",pcVar2)
      ;
      crt_stdio_c_fprintf_FUN_005fe6d0
                (in_stack_00000008,"\"%s\",%g,%d,%d,%d\n",pcVar3,(double)*(float *)(pcVar3 + 0x20),
                 *(undefined4 *)(pcVar3 + 0x24),*(undefined4 *)(pcVar3 + 0x60));
      crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"// motion %d: exitForwardFromFrameNumber,exitForwardToMotionNumber,exitForwardToFrameNumber\n");
      crt_stdio_c_fprintf_FUN_005fe6d0
                (in_stack_00000008,"%d,%d,%g\n",*(undefined4 *)(pcVar3 + 0x28));
      crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"// motion %d: exitForwardCmd,exitForwardTweenTime,exitForwardsetNewStateAsDesired\n");
      pcVar2 = "%d,%g,%d\n";
      crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"%d,%g,%d\n");
      crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"// motion %d: exitBackwardToMotionNumber,exitBackwardToFrameNumber\n");
      pcVar4 = (char *)0x52d2f4;
      crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"%d,%g\n");
      crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"// motion %d transition count, list: desiredState, cmd, toMotionNumber, toFrameNumber, tweenTime, setNewStateAsDesired\n");
      iVar1 = 0;
      crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"%d\n");
      if (0 < *(int *)(pcVar3 + 0x68)) {
        do {
          pcVar4 = "%d,%d,%d,%g,%g,%d\n";
          iVar1 = iVar1 + 1;
          pcVar2 = (char *)in_stack_00000008;
          crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"%d,%d,%d,%g,%g,%d\n");
        } while (iVar1 < *(int *)(pcVar3 + 0x68));
      }
      crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"// motion %d signal count, list: frameNumber, value\n");
      iVar1 = 0;
      crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"%d\n");
      if (0 < *(int *)(pcVar3 + 0x4a4)) {
        ...
        } while (iVar1 < *(int *)(pcVar3 + 0x4a4));
      }
      crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"// motion %d marker count, list\n");
      iVar1 = 0;
      crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"%d");
      if (0 < *(int *)(pcVar3 + 0x520)) {
        do {
          iVar1 = iVar1 + 1;
          crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008," %d");
        } while (iVar1 < *(int *)(pcVar3 + 0x520));
      }
      crt_stdio_c_fprintf_FUN_005fe6d0(in_stack_00000008,"\n");
      pcVar2 = (char *)((int)&((FILE *)pcVar2)->_ptr + 1);
      pcVar3 = pcVar4;
    } while ((int)pcVar2 < *(int *)(in_stack_00000058 + 0x964));
  }
  return;
}
...
// Assembly code:
// 0052d170: PUSH EBX
//   Label: core_motion.cpp_FUN_0052d170
// 0052d171: PUSH ESI
// 0052d172: PUSH EDI
// 0052d173: PUSH EBP
