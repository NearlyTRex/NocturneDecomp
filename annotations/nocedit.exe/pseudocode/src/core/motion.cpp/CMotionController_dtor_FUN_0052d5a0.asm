...
section .text
    ...
    JNZ 0x0052d5bc                      ; 0052d5ab | LAB_0052d5bc
        ;   XREF to: 0052d5bc (CONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0x50],0x661bc4 ; 0052d5ad | CMotionController_vtable g_CMotionControllerVTable
    TEST AL,0x2                         ; 0052d5b4
    JNZ 0x0052d5d7                      ; 0052d5b6 | LAB_0052d5d7
        ;   XREF to: 0052d5d7 (CONDITIONAL_JUMP)
    MOV EAX,EBX                         ; 0052d5b8
    POP EBX                             ; 0052d5ba
    RET                                 ; 0052d5bb
    PUSH 0x661bd0                       ; 0052d5bc | WatcomTypeInfo g_CMotionControllerTypeInfo
        ;   Label: LAB_0052d5bc
    PUSH EBX                            ; 0052d5c1
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 0052d5c2 | void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0052d5c7
    PUSH EAX                            ; 0052d5ca
    CALL crt_memory.c_free_FUN_005fe659 ; 0052d5cb | void crt_memory.c_free_FUN_005fe659(void * ptr)
    ...
    PUSH EBX                            ; 0052d5d7
        ;   Label: LAB_0052d5d7
    CALL shape_memdbg.cpp_debugFree_FUN_0050f210 ; 0052d5d8 | void shape_memdbg.cpp_debugFree_FUN_0050f210(void * ptr)
