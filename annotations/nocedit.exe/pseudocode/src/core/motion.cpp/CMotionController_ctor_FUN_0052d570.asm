...
;                               FUNCTION
; *****************************************************************************
; __cdecl CMotionController * __cdecl core_motion_cpp_CMotionController_ctor_FUN_0052d570(CMotionController *this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV dword ptr [EBX + 0x50],0x661bc4 ; 0052d575 | g_CMotionControllerVTable
    MOV byte ptr [EBX + 0x30],0x0       ; 0052d57c
    PUSH EBX                            ; 0052d580
    MOV dword ptr [EBX],0x0             ; 0052d581
    CALL core_motion.cpp_CMotionController_reset_FUN_0052dad0 ; 0052d587
