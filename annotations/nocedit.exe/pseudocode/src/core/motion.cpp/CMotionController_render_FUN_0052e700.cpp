...

{
  ...
  if ((INT_02f43978 != 0) &&
    ...
    if ((int)(pSVar2[19999].projected_vertex.screen_x & -0x80000000) == 0) {
      ...
      engine_2d_c_drawText_FUN_00401fd0(&stack0xffffff58,iVar3,iVar6 + -0x16);
      pSVar5 = core_motion_cpp_CMotionController_getCurrentMotion_FUN_0052dab0(this_ptr);
      _sprintf(&stack0xffffff58,"%s : %5.2f",pSVar5);
      engine_2d_c_drawText_FUN_00401fd0(&stack0xffffff58,iVar3,iVar6 + -0xb);
      return;
    }
  }
  return;
