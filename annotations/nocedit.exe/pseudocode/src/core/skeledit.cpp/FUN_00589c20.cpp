...

{
  ...
  if (*(int *)(in_stack_00000008 + 0x308) != 1) {
    ...
    iVar1 = shape_meshlod_cpp_CLodMesh_loadPrecomputeFile_FUN_0051b6f0(in_stack_00000004);
    if (iVar1 != 0) {
      ...
      if (iVar1 != 0) {
        if (iVar1 == 1) {
          ...
          shape_meshlod_cpp_CLodMesh_generateLOD_FUN_00516ba0(in_stack_00000004,0,in_stack_0000000c)
          ;
      ...
      iVar1 = shape_meshlod_cpp_CLodMesh_initializeLodGeneration_FUN_0051b8a0
                        (in_stack_00000004,in_stack_00000004->precompute_file);
      if (iVar1 == 0) {
