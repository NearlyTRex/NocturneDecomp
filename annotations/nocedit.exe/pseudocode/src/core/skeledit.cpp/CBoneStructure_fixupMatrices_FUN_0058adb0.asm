...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_skeledit_cpp_CBoneStructure_fixupMatrices_FUN_0058adb0(CBoneStructure *this_ptr)
;
; Parameters:
...
section .text
    ...
    CALL crt_stack.c_stack_probe_FUN_005ff9f3 ; 0058adb5
    ...
    JLE 0x0058ae8f                      ; 0058adcf
        ;   XREF to: 0058ae8f (CONDITIONAL_JUMP)  ; LAB_0058ae8f
    ...
    CALL core_xform.cpp_determinant_FUN_005f61c0 ; 0058ade9
    ...
    FNSTSW AX                           ; 0058ae07
    SAHF                                ; 0058ae09
    JBE 0x0058ae33                      ; 0058ae0a
        ;   XREF to: 0058ae33 (CONDITIONAL_JUMP)  ; LAB_0058ae33
    MOV ECX,dword ptr [ESP + 0x10]      ; 0058ae0c
    PUSH ECX                            ; 0058ae10
    MOV EAX,0x64a4d8                    ; 0058ae11 | = "..\\core\\skeledit.cpp"
    MOV EDX,0x3b2                       ; 0058ae16
    PUSH 0x64a4ed                       ; 0058ae1b | = "CBoneStructure::fixupMatrices - %s is..."
    MOV [0x02f0ca48],EAX                ; 0058ae20 | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 0058ae25 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0058ae2b
    ...
    JNZ 0x0058ae70                      ; 0058ae3f
        ;   XREF to: 0058ae70 (CONDITIONAL_JUMP)  ; LAB_0058ae70
    TEST EDX,EDX                        ; 0058ae41
    JNZ 0x0058ae70                      ; 0058ae43
        ;   XREF to: 0058ae70 (CONDITIONAL_JUMP)  ; LAB_0058ae70
    MOV dword ptr [0x02f0ca4c],0x3b6    ; 0058ae45 | g_CurrentLineNumber
    IMUL EAX,EBX,0x84                   ; 0058ae4f
    ADD EAX,EDI                         ; 0058ae55
    PUSH EAX                            ; 0058ae57
    MOV ECX,0x64a51d                    ; 0058ae58 | = "..\\core\\skeledit.cpp"
    PUSH 0x64a532                       ; 0058ae5d | = "CBoneStructure::fixupMatrices - %s is..."
    MOV dword ptr [0x02f0ca48],ECX      ; 0058ae62 | g_CurrentFilename
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0058ae68
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ADD ESP,0x8                         ; 0058ae6d
    PUSH 0x0                            ; 0058ae70
        ;   Label: LAB_0058ae70
    PUSH ESI                            ; 0058ae72
    CALL core_xform.cpp_orthonormalizeMatrix3x3_FUN_005f6690 ; 0058ae73
    ...
    JL 0x0058addb                       ; 0058ae89
        ;   XREF to: 0058addb (CONDITIONAL_JUMP)  ; LAB_0058addb
