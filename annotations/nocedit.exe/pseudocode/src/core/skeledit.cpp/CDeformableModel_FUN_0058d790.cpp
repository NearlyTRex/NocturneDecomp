// Name: core_skeledit.cpp_CDeformableModel_FUN_0058d790
// Address: 0058d790
// Address Range: [[0058d790, 0058ddd5]]
// Convention: __cdecl
// Signature: void __cdecl core_skeledit_cpp_CDeformableModel_FUN_0058d790(CDeformableModel *this_ptr,int param_2,CLodMesh *param_3)
...

{
  ...
  core_skeleton_cpp_CDeformableModel_allocLOD_FUN_0059a510
            (this_ptr,param_2,param_3->vertex_count,param_3->tri_count,0);
  local_38 = 0;
  local_4c = 0;
  local_3c = 0;
  local_58 = param_2 * 4;
  do {
    ...
    if (*(int *)((int)this_ptr->vertex_count + local_58) <= local_38) {
      shape_meshlod_cpp_CLodMesh_sortFacesByAttribute_FUN_0051bd30(param_3,0);
      shape_meshlod_cpp_CLodMesh_sortFacesByAttribute_FUN_0051bd30(param_3,1);
      shape_meshlod_cpp_CLodMesh_sortFacesByAttribute_FUN_0051bd30(param_3,2);
      iVar10 = 0;
      iVar16 = (int)this_ptr->lod_info + param_2 * 4 + -4;
      ...
      this_ptr->tri_count[param_2] = 0;
      this_ptr->cap_tri_count[param_2] = 0;
      local_30 = 0;
      if (0 < param_3->tri_count) {
        local_2c = param_2 * 4;
        local_48 = 0;
        local_40 = 0;
        ...
        local_50 = 0;
        do {
          puVar21 = (uint *)((int)param_3->tri_data->attribute_indices + local_50);
          ...
          *(uint *)(local_48 + *(int *)(local_54 + 0x90)) = *puVar21;
          ...
          if (puVar21[2] == 0) {
            piVar9 = this_ptr->parts[puVar21[1]].tri_counts + param_2;
            *piVar9 = *piVar9 + 1;
            this_ptr->tri_count[param_2] = this_ptr->tri_count[param_2] + 1;
          }
          else {
            piVar9 = this_ptr->parts[puVar21[1]].cap_tri_counts + param_2;
            *piVar9 = *piVar9 + 1;
            this_ptr->cap_tri_count[param_2] = this_ptr->cap_tri_count[param_2] + 1;
          }
          local_48 = local_48 + 4;
          local_40 = local_40 + 0x12;
          local_50 = local_50 + 0x8c;
          local_30 = local_30 + 1;
        } while (local_30 < param_3->tri_count);
      }
      iVar20 = 0;
      iVar11 = 0;
      iVar10 = 0;
      ...
      if ((iVar10 != this_ptr->tri_count[param_2]) || (iVar20 != this_ptr->cap_tri_count[param_2]))
      {
        g_CurrentFilename = "..\\core\\skeledit.cpp";
        g_CurrentLineNumber = 0x89c;
        core_main_c_displayErrorAndQuit_FUN_00506f10("BUG! Count mismatch!!");
      }
      if (0 < this_ptr->cap_tri_count[param_2]) {
        piVar9 = shape_memdbg_cpp_debugAlloc_FUN_0050f1f0
                           (this_ptr->cap_tri_count[param_2] * 4,"..\\core\\skeledit.cpp",0x8a1)
        ;
        this_ptr->cap_index_ptr[param_2] = piVar9;
        if (piVar9 == (int *)0x0) {
          g_CurrentFilename = "..\\core\\skeledit.cpp";
        ...
        local_1c = 0;
        local_34 = 0;
        iVar16 = this_ptr->tri_count[param_2];
        if (0 < this_ptr->num_parts) {
          local_44 = this_ptr;
          do {
            iVar20 = local_1c << 2;
            iVar10 = iVar16 * 0x8c;
            for (iVar11 = 0; iVar11 < local_44->parts[0].cap_tri_counts[param_2];
                iVar11 = iVar11 + 1) {
              iVar16 = iVar16 + 1;
              *(uint *)((int)this_ptr->cap_index_ptr[param_2] + iVar20) =
                   *(uint *)((int)param_3->tri_data->attribute_indices + iVar10 + 0xc);
              iVar10 = iVar10 + 0x8c;
              local_1c = local_1c + 1;
              iVar20 = iVar20 + 4;
            }
    ...
    pcVar13 = param_3->vertex_data->lod_workspace + local_3c + -0x10;
