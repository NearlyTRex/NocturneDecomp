...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_skeledit.cpp_FUN_0058e0b0()
;
; Local Variables:
...
section .text
    ...
    CALL crt_stack.c_stack_probe_FUN_005ff9f3 ; 0058e0b5 | uint crt_stack.c_stack_probe_FUN_005ff9f3(uint stack_size)
    ...
    JGE 0x0058e1f1                      ; 0058e0d2 | LAB_0058e1f1
    ...
    JLE 0x0058e1e6                      ; 0058e0ff | LAB_0058e1e6
    ...
    PUSH 0x0                            ; 0058e141
    PUSH EBX                            ; 0058e143
    CALL crt_string.c_splitpath_FUN_005ff178 ; 0058e144 | void crt_string.c_splitpath_FUN_005ff178(char * path, char * drive, char * dir, char * fname, ...)
    ...
    PUSH EAX                            ; 0058e163
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0058e164 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0058e169
    PUSH 0x64aef6                       ; 0058e16c | = ".tga" | s_tga_0064aef6 = .tga
    ...
    PUSH EAX                            ; 0058e181
    CALL crt_file.c_makepath_FUN_005febfc ; 0058e182 | void crt_file.c_makepath_FUN_005febfc(char * path_buffer, char * drive, char * directory, char * filename, ...)
        ;   XREF to: 005febfc (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0058e187
    MOV EAX,ESP                         ; 0058e18a
    PUSH EAX                            ; 0058e18c
    PUSH 0x64aefb                       ; 0058e18d | = "art" | s_art_0064aefb = art
    CALL engine_dosio.c_getFileSize_FUN_00481880 ; 0058e192 | int engine_dosio.c_getFileSize_FUN_00481880(char * directory, char * filename)
    ...
    JGE 0x0058e219                      ; 0058e1af | LAB_0058e219
    ...
    CMP AL,0x0                          ; 0058e1b8
    JZ 0x0058e1cc                       ; 0058e1ba | LAB_0058e1cc
    ...
    CMP AL,0x0                          ; 0058e1c8
    JNZ 0x0058e1b4                      ; 0058e1ca | LAB_0058e1b4
    ...
    JL 0x0058e132                       ; 0058e1e0 | LAB_0058e132
    ...
    POP EBX                             ; 0058e1ef
    RET                                 ; 0058e1f0
    MOV ECX,0x64aec2                    ; 0058e1f1 | = "..\\core\\skeledit.cpp" | s_core_skeledit_cpp_0064aec2 = ..\core\skeledit.cpp
        ;   Label: LAB_0058e1f1
    MOV EBX,0x912                       ; 0058e1f6
    PUSH 0x64aed7                       ; 0058e1fb | = "Can't add another texture set!" | s_Can_t_add_another_textur_0064aed7 = Can't add another texture set!
    MOV dword ptr [0x02f0ca48],ECX      ; 0058e200 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 0058e206 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0058e20c | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0058e211
    JMP 0x0058e0d8                      ; 0058e214 | LAB_0058e0d8
        ;   XREF to: 0058e0d8 (UNCONDITIONAL_JUMP)
    PUSH 0x64aeff                       ; 0058e219 | = ".raw" | s_raw_0064aeff = .raw
        ;   Label: LAB_0058e219
    ...
    PUSH 0x0                            ; 0058e228
    PUSH EDI                            ; 0058e22a
    CALL crt_file.c_makepath_FUN_005febfc ; 0058e22b | void crt_file.c_makepath_FUN_005febfc(char * path_buffer, char * drive, char * directory, char * filename, ...)
        ;   XREF to: 005febfc (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0058e230
    JMP 0x0058e1cd                      ; 0058e233 | LAB_0058e1cd
