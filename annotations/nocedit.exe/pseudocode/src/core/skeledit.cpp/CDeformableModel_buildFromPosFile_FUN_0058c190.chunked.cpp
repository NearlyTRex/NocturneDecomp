...
#include "nocturne.h"
typedef struct CDeformableModel_buildFromPosFile_Ctx {
...
static int CDeformableModel_buildFromPosFile_branch_0(CDeformableModel_buildFromPosFile_Ctx *ctx) {
    ...
    CSkeleton *&skeleton = ctx->skeleton;
    int &iVar5 = ctx->iVar5;
...
static int CDeformableModel_buildFromPosFile_check_0_1(CDeformableModel_buildFromPosFile_Ctx *ctx) {
    ...
    CMatrix3x4f &local_11c = ctx->local_11c;
...
static int CDeformableModel_buildFromPosFile_check_local_d28_2(CDeformableModel_buildFromPosFile_Ctx *ctx) {
    ...
    int &iVar5 = ctx->iVar5;
    _FILE *&file = ctx->file;
    _FILE *&file_ptr = ctx->file_ptr;
    char *&pcVar16 = ctx->pcVar16;
    char *&pcVar21 = ctx->pcVar21;
    auto &local_eb8 = ctx->local_eb8;
    auto &local_d28 = ctx->local_d28;
    auto &local_c24 = ctx->local_c24;
    auto &local_a1c = ctx->local_a1c;
    auto &local_918 = ctx->local_918;
    auto &local_818 = ctx->local_818;
    auto &local_618 = ctx->local_618;
    auto &local_518 = ctx->local_518;
    int &local_98 = ctx->local_98;
    STextureSet *&local_6c = ctx->local_6c;
...
static int CDeformableModel_buildFromPosFile_else_3(CDeformableModel_buildFromPosFile_Ctx *ctx) {
    ...
    auto &local_b20 = ctx->local_b20;
    int &local_a4 = ctx->local_a4;

    if (entry->skip_generation == 2) {
      pcVar15 = "$$BATCH";
      iVar5 = 0x1e;
      return GOTO_LAB_0058c4df;
    }
...
static int CDeformableModel_buildFromPosFile_check_0_4(CDeformableModel_buildFromPosFile_Ctx *ctx) {
    ...
    CLodMesh &local_1f4 = ctx->local_1f4;
    int &local_94 = ctx->local_94;
    int &local_90 = ctx->local_90;
    float &local_8c = ctx->local_8c;
    int &local_68 = ctx->local_68;
    int &local_64 = ctx->local_64;
    CBoneStructure *&local_24 = ctx->local_24;
    SVert *&pSVar2 = ctx->pSVar2;
...
static int CDeformableModel_buildFromPosFile_check_0_5(CDeformableModel_buildFromPosFile_Ctx *ctx) {
    CDeformableModel *&this_ptr = ctx->this_ptr;
    int &iVar5 = ctx->iVar5;
    uint *&puVar12 = ctx->puVar12;
    ushort *&puVar14 = ctx->puVar14;
    uint *&puVar17 = ctx->puVar17;
    ushort *&puVar16 = ctx->puVar16;
    CLodMesh &local_1f4 = ctx->local_1f4;
    int &local_88 = ctx->local_88;
    CDeformableModel *&local_84 = ctx->local_84;
    int &local_60 = ctx->local_60;
    int &local_5c = ctx->local_5c;
    int &local_58 = ctx->local_58;
    CDeformableModel *&local_54 = ctx->local_54;
    int &local_30 = ctx->local_30;
    uint &local_1c = ctx->local_1c;
...
static int CDeformableModel_buildFromPosFile_check_0_6(CDeformableModel_buildFromPosFile_Ctx *ctx) {
    ...
    int &iVar5 = ctx->iVar5;
    uint *&puVar10 = ctx->puVar10;
    ushort *&puVar14 = ctx->puVar14;
    ushort *&puVar11 = ctx->puVar11;
    uint *&puVar13 = ctx->puVar13;
    CLodMesh &local_1f4 = ctx->local_1f4;
    int &local_80 = ctx->local_80;
    CDeformableModel *&local_7c = ctx->local_7c;
    int &local_50 = ctx->local_50;
    int &local_4c = ctx->local_4c;
    int &local_48 = ctx->local_48;
    CDeformableModel *&local_44 = ctx->local_44;
...
static int CDeformableModel_buildFromPosFile_branch_2(CDeformableModel_buildFromPosFile_Ctx *ctx) {
    ...
    _FILE *&file = ctx->file;
    int &iVar9 = ctx->iVar9;
    CLodMesh &local_350 = ctx->local_350;
    CLodMesh &local_1f4 = ctx->local_1f4;
...
static int CDeformableModel_buildFromPosFile_chunk_8(CDeformableModel_buildFromPosFile_Ctx *ctx) {
    ...
    auto &local_b20 = ctx->local_b20;
    CLodMesh &local_350 = ctx->local_350;
    CLodMesh &local_2dc = ctx->local_2dc;
    CLodMesh &local_268 = ctx->local_268;
    CLodMesh &local_1f4 = ctx->local_1f4;
    auto &local_180 = ctx->local_180;
    auto &local_ec = ctx->local_ec;
    auto &local_d8 = ctx->local_d8;
    auto &local_c4 = ctx->local_c4;
    auto &local_bc = ctx->local_bc;
    int &local_a4 = ctx->local_a4;
    int &local_a0 = ctx->local_a0;
    int &local_9c = ctx->local_9c;
    STextureSet *&local_78 = ctx->local_78;
    int &local_74 = ctx->local_74;
    int &local_40 = ctx->local_40;
    STextureSet *&local_3c = ctx->local_3c;
...
{
  CDeformableModel_buildFromPosFile_Ctx _ctx_storage = {};
  CDeformableModel_buildFromPosFile_Ctx *ctx = &_ctx_storage;
  ctx->this_ptr = this_ptr;
  ctx->entry = entry;

    char &cVar2 = ctx->cVar2;
    float &fVar3 = ctx->fVar3;
    CBoneStructure *&pCVar4 = ctx->pCVar4;
    CBoneStructure *&pCVar5 = ctx->pCVar5;
    int &iVar6 = ctx->iVar6;
    CSkeleton *&skeleton = ctx->skeleton;
    int &iVar5 = ctx->iVar5;
    int &iVar8 = ctx->iVar8;
    ...
    ushort *&puVar14 = ctx->puVar14;
    ushort *&puVar11 = ctx->puVar11;
    CDeformableModel *&pCVar15 = ctx->pCVar15;
    char *&pcVar16 = ctx->pcVar16;
    int &iVar12 = ctx->iVar12;
    uint *&puVar17 = ctx->puVar17;
    uint *&puVar13 = ctx->puVar13;
    char *&pcVar19 = ctx->pcVar19;
    CMatrix3x4f *&pCVar14 = ctx->pCVar14;
    char *&pcVar15 = ctx->pcVar15;
    ushort *&puVar16 = ctx->puVar16;
    STextureSet *&pSVar17 = ctx->pSVar17;
    char *&pcVar18 = ctx->pcVar18;
    float *&pfVar19 = ctx->pfVar19;
    char *&pcVar20 = ctx->pcVar20;
    SMRGLTextureModel *&pSVar21 = ctx->pSVar21;
    char *&pcVar21 = ctx->pcVar21;
    byte &bVar22 = ctx->bVar22;
    byte &bVar23 = ctx->bVar23;
    auto &local_a228 = ctx->local_a228;
    auto &afStack_a1d0 = ctx->afStack_a1d0;
    auto &aiStack_6e94 = ctx->aiStack_6e94;
    CBoneStructure &local_6d04 = ctx->local_6d04;
    ...
    int &local_28 = ctx->local_28;
    CBoneStructure *&local_24 = ctx->local_24;
    auto &local_20 = ctx->local_20;
    uint &local_1c = ctx->local_1c;
    auto &local_18 = ctx->local_18;
    auto &local_14 = ctx->local_14;
    CBoneStructure *&this_ptr_00 = ctx->this_ptr_00;
    char &cVar1 = ctx->cVar1;
    int *&piVar9 = ctx->piVar9;
    float &fVar4 = ctx->fVar4;
    SVert *&pSVar2 = ctx->pSVar2;
    uint &uVar3 = ctx->uVar3;
...
LAB_0058c613:
  ...
  local_28 = 0;
    if (0 < (int)local_a228._0_4_) {
      CDeformableModel_buildFromPosFile_check_0_1(ctx);
    }
  splitpath
  ...
  if ((entry->skip_generation == 0) &&
    ...
    if (local_d28[0] != '\0') {
      CDeformableModel_buildFromPosFile_check_local_d28_2(ctx);
    }
  local_a4 = 2;
  iVar5 = 0;
...
LAB_0058c4df:
    ...
    do {
      ...
      *pcVar20 = cVar1;
      ...
      int _rc = CDeformableModel_buildFromPosFile_else_3(ctx);
      if (_rc == GOTO_LAB_0058c4df) goto LAB_0058c4df;
    }
  core_skeledit_cpp_CDeformableModel_cramModelTexture_FUN_0058de70
  ...
  iVar5 = 0;
    if (0 < this_ptr->vertex_count[0]) {
      int _rc = CDeformableModel_buildFromPosFile_check_0_4(ctx);
      if (_rc == GOTO_LAB_0058c613) goto LAB_0058c613;
    }
  iVar5 = 0;
  local_30 = 0;
    if (0 < this_ptr->num_parts) {
      CDeformableModel_buildFromPosFile_check_0_5(ctx);
    }
  local_34 = 0;
    if (0 < this_ptr->num_parts) {
      CDeformableModel_buildFromPosFile_check_0_6(ctx);
    }
  ...
  g_LodReplayMode = 0;
    if (entry->skip_generation == 2) {
      CDeformableModel_buildFromPosFile_branch_2(ctx);
    }
  entry->for_shadows = 0;
  local_9c = core_skeledit_cpp_CLodMesh_selectAndGenerateLods_FUN_00589c20(&local_1f4,entry,2);
    if (-1 < local_9c) {
      int _rc = CDeformableModel_buildFromPosFile_chunk_8(ctx);
      if (_rc == GOTO_LAB_0058d5ef) goto LAB_0058d5ef;
    }
LAB_0058d5ef:
  shape_meshlod_cpp_CLodMesh_dtor_FUN_00515950(&local_350,0);
  shape_meshlod_cpp_CLodMesh_dtor_FUN_00515950(&local_1f4,0);
