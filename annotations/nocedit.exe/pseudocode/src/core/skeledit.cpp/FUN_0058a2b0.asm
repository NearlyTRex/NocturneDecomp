...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_skeledit_cpp_FUN_0058a2b0(void)
;
; Local Variables:
...
;   core_hero.cpp_CHero_addFilesToExtract_FUN_004f3fa0 at 004f3fdb
;   core_skeledit.cpp_CDeformableModelInstance_addFilesToExtract_FUN_0058a260 at 0058a29a
;
; Referenced Globals:
