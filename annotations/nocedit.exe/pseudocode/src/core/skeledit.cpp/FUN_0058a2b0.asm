...
section .text
    ...
    CALL crt_stack.c_stack_probe_FUN_005ff9f3 ; 0058a2b5 | uint crt_stack.c_stack_probe_FUN_005ff9f3(uint stack_size)
    ...
    PUSH EBX                            ; 0058a2cb
    PUSH 0x64a258                       ; 0058a2cc | = "DATA\\%s\n" | s_DATA_s_0064a258 = DATA\%s

    MOV EDX,dword ptr [ESP + 0x3c]      ; 0058a2d1
    PUSH EDX                            ; 0058a2d5
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058a2d6 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    JLE 0x0058a3c1                      ; 0058a2f0 | LAB_0058a3c1
    ...
    JLE 0x0058a398                      ; 0058a30e | LAB_0058a398
    ...
    CMP AL,0x0                          ; 0058a326
    JZ 0x0058a33a                       ; 0058a328 | LAB_0058a33a
    ...
    CMP AL,0x0                          ; 0058a336
    JNZ 0x0058a322                      ; 0058a338 | LAB_0058a322
    ...
    MOV AL,byte ptr [ESI]               ; 0058a33d
        ;   Label: LAB_0058a33d
    CMP AL,DL                           ; 0058a33f
    JZ 0x0058a355                       ; 0058a341 | LAB_0058a355
        ;   XREF to: 0058a355 (CONDITIONAL_JUMP)
    CMP AL,0x0                          ; 0058a343
    JZ 0x0058a353                       ; 0058a345 | LAB_0058a353
        ;   XREF to: 0058a353 (CONDITIONAL_JUMP)
    INC ESI                             ; 0058a347
    MOV AL,byte ptr [ESI]               ; 0058a348
    CMP AL,DL                           ; 0058a34a
    JZ 0x0058a355                       ; 0058a34c | LAB_0058a355
        ;   XREF to: 0058a355 (CONDITIONAL_JUMP)
    INC ESI                             ; 0058a34e
    CMP AL,0x0                          ; 0058a34f
    JNZ 0x0058a33d                      ; 0058a351 | LAB_0058a33d
        ;   XREF to: 0058a33d (CONDITIONAL_JUMP)
    SUB ESI,ESI                         ; 0058a353
        ;   Label: LAB_0058a353
    TEST ESI,ESI                        ; 0058a355
        ;   Label: LAB_0058a355
    JZ 0x0058a35c                       ; 0058a357 | LAB_0058a35c
        ;   XREF to: 0058a35c (CONDITIONAL_JUMP)
    MOV byte ptr [ESI],0x0              ; 0058a359
    MOV ESI,ESP                         ; 0058a35c
        ;   Label: LAB_0058a35c
    PUSH ESI                            ; 0058a35e
    PUSH 0x64a261                       ; 0058a35f | = "ART\\%s.RAW\n" | s_ART_s_RAW_0064a261 = ART\%s.RAW

    MOV ECX,dword ptr [ESP + 0x3c]      ; 0058a364
    PUSH ECX                            ; 0058a368
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058a369 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0058a36e
    MOV ESI,ESP                         ; 0058a371
    PUSH ESI                            ; 0058a373
    PUSH 0x64a26d                       ; 0058a374 | = "ART\\%s.ACT\n" | s_ART_s_ACT_0064a26d = ART\%s.ACT

    MOV ESI,dword ptr [ESP + 0x3c]      ; 0058a379
    PUSH ESI                            ; 0058a37d
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058a37e | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JL 0x0058a31b                       ; 0058a396 | LAB_0058a31b
    ...
    JL 0x0058a300                       ; 0058a3bb | LAB_0058a300
