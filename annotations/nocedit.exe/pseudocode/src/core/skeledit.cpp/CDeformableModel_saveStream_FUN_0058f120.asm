...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_skeledit.cpp_CDeformableModel_saveStream_FUN_0058f120(CDeformableModel * this_ptr)
;
; Parameters:
...
section .text
    ...
    CALL crt_stack.c_stack_probe_FUN_005ff9f3 ; 0058f125 | uint crt_stack.c_stack_probe_FUN_005ff9f3(uint stack_size)
    ...
    PUSH EDX                            ; 0058f135
    CALL core_skeleton.cpp_CDeformableModel_getSkeletonPtr_FUN_0059a810 ; 0058f136 | CSkeleton * core_skeleton.cpp_CDeformableModel_getSkeletonPtr_FUN_0059a810(CDeformableModel * this_ptr)
        ;   XREF to: 0059a810 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0058f13b
    PUSH 0x64b1ef                       ; 0058f13e | = "// version\n" | s_version_0064b1ef = // version

    MOV ECX,dword ptr [ESP + 0x4c]      ; 0058f143
    MOV EAX,dword ptr [EAX + 0x28558]   ; 0058f147
    PUSH ECX                            ; 0058f14d
    MOV dword ptr [ESP + 0x8],EAX       ; 0058f14e
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058f152 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0058f157
    MOV EBX,dword ptr [0x00681864]      ; 0058f15a | undefined4 DAT_00681864
    PUSH EBX                            ; 0058f160
    PUSH 0x64b1fb                       ; 0058f161 | = "%d\n" | s_d_0064b1fb = %d

    MOV ESI,dword ptr [ESP + 0x50]      ; 0058f166
    PUSH ESI                            ; 0058f16a
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058f16b | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0058f170
    PUSH 0x64b1ff                       ; 0058f173 | = "// lodCount,textureSetCount,textureCo..." | s_lodCount_textureSetCount_0064b1ff = // lodCount,textureSetCount,textureCount,boneCount,partCount

    PUSH ESI                            ; 0058f178
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058f179 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH EBX                            ; 0058f1a5
    PUSH 0x64b23d                       ; 0058f1a6 | = "%d,%d,%d,%d,%d\n" | s_d_d_d_d_d_0064b23d = %d,%d,%d,%d,%d

    PUSH ESI                            ; 0058f1ab
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058f1ac | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x1c                        ; 0058f1b1
    PUSH 0x64b24d                       ; 0058f1b4 | = "// Lod list: VertexCount,triCount,cap..." | s_Lod_list_VertexCount_tri_0064b24d = // Lod list: VertexCount,triCount,capTriCount,pixelHeight,shadowOnlyFlag

    PUSH ESI                            ; 0058f1b9
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058f1ba | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JLE 0x0058f210                      ; 0058f1ce | LAB_0058f210
    ...
    PUSH EAX                            ; 0058f1e7
    PUSH 0x64b297                       ; 0058f1e8 | = "%d,%d,%d,%d,%d\n" | s_d_d_d_d_d_0064b297 = %d,%d,%d,%d,%d

    MOV EDX,dword ptr [ESP + 0x60]      ; 0058f1ed
    PUSH EDX                            ; 0058f1f1
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058f1f2 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JL 0x0058f1d4                       ; 0058f209 | LAB_0058f1d4
        ;   XREF to: 0058f1d4 (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 0058f20b
    MOV ECX,ECX                         ; 0058f20e
    PUSH 0x64b2a7                       ; 0058f210 | = "// skeleton file\n" | s_skeleton_file_0064b2a7 = // skeleton file

        ;   Label: LAB_0058f210
    MOV EBX,dword ptr [ESP + 0x4c]      ; 0058f215
    PUSH EBX                            ; 0058f219
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058f21a | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH EBX                            ; 0058f231
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058f232 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0058f237
    PUSH 0x64b2bd                       ; 0058f23a | = "// partList: \"name\", dominantBone, ..." | s_partList_name_dominantBo_0064b2bd = // partList: "name", dominantBone, adjPartCount, adjpartList, lods(triCount, capTriCount)

    PUSH EBX                            ; 0058f23f
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058f240 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JLE 0x0058f2f6                      ; 0058f25a | LAB_0058f2f6
    ...
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058f293 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JGE 0x0058f3cb                      ; 0058f2a7 | LAB_0058f3cb
    ...
    INC EBX                             ; 0058f2c2
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058f2c3 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0058f2c8
    JMP 0x0058f29b                      ; 0058f2cb | LAB_0058f29b
    ...
    JL 0x0058f26d                       ; 0058f2f0 | LAB_0058f26d
        ;   XREF to: 0058f26d (CONDITIONAL_JUMP)
    PUSH 0x64b330                       ; 0058f2f6 | = "// vertexList: boneCount, boneInfo(in..." | s_vertexList_boneCount_bon_0064b330 = // vertexList: boneCount, boneInfo(index, weight, x,y,z)

        ;   Label: LAB_0058f2f6
    MOV EDI,dword ptr [ESP + 0x4c]      ; 0058f2fb
    PUSH EDI                            ; 0058f2ff
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058f300 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JLE 0x0058f433                      ; 0058f316 | LAB_0058f433
    ...
    JGE 0x0058f411                      ; 0058f341 | LAB_0058f411
    ...
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058f363 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JGE 0x0058f4fd                      ; 0058f37f | LAB_0058f4fd
    ...
    INC ESI                             ; 0058f3c0
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058f3c1 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x2c                        ; 0058f3c6
    JMP 0x0058f375                      ; 0058f3c9 | LAB_0058f375
    ...
    JLE 0x0058f2cd                      ; 0058f3d5 | LAB_0058f2cd
    ...
    PUSH EDX                            ; 0058f3f4
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058f3f5 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JGE 0x0058f2cd                      ; 0058f409 | LAB_0058f2cd
        ;   XREF to: 0058f2cd (CONDITIONAL_JUMP)
    JMP 0x0058f3dd                      ; 0058f40f | LAB_0058f3dd
    ...
    JL 0x0058f320                       ; 0058f42d | LAB_0058f320
        ;   XREF to: 0058f320 (CONDITIONAL_JUMP)
    PUSH 0x64b380                       ; 0058f433 | = "// triList: textureIndex, verts(index..." | s_triList_textureIndex_ver_0064b380 = // triList: textureIndex, verts(index, u, v)

        ;   Label: LAB_0058f433
    MOV EBP,dword ptr [ESP + 0x4c]      ; 0058f438
    PUSH EBP                            ; 0058f43c
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058f43d | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JLE 0x0058f538                      ; 0058f452 | LAB_0058f538
    ...
    JGE 0x0058f516                      ; 0058f470 | LAB_0058f516
    ...
    PUSH ECX                            ; 0058f4de
    PUSH 0x64b3ae                       ; 0058f4df | = "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n" | s_d_d_d_d_d_d_d_d_d_d_0064b3ae = %d,%d,%d,%d,%d,%d,%d,%d,%d,%d
    ...
    INC EDI                             ; 0058f4ef
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058f4f0 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x30                        ; 0058f4f5
    JMP 0x0058f466                      ; 0058f4f8 | LAB_0058f466
    ...
    JMP 0x0058f332                      ; 0058f511 | LAB_0058f332
    ...
    JL 0x0058f45c                       ; 0058f532 | LAB_0058f45c
        ;   XREF to: 0058f45c (CONDITIONAL_JUMP)
    PUSH 0x64b3cd                       ; 0058f538 | = "// capTriList: matching part\n" | s_capTriList_matching_part_0064b3cd = // capTriList: matching part

        ;   Label: LAB_0058f538
    MOV EBX,dword ptr [ESP + 0x4c]      ; 0058f53d
    PUSH EBX                            ; 0058f541
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058f542 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JLE 0x0058f5a5                      ; 0058f554 | LAB_0058f5a5
    ...
    JGE 0x0058f58f                      ; 0058f56b | LAB_0058f58f
    ...
    INC ESI                             ; 0058f584
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058f585 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0058f58a
    JMP 0x0058f562                      ; 0058f58d | LAB_0058f562
    ...
    JL 0x0058f55a                       ; 0058f5a3 | LAB_0058f55a
        ;   XREF to: 0058f55a (CONDITIONAL_JUMP)
    PUSH 0x64b3ef                       ; 0058f5a5 | = "// texture list\n" | s_texture_list_0064b3ef = // texture list

        ;   Label: LAB_0058f5a5
    MOV EBX,dword ptr [ESP + 0x4c]      ; 0058f5aa
    PUSH EBX                            ; 0058f5ae
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058f5af | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JLE 0x0058f61a                      ; 0058f5c5 | LAB_0058f61a
    ...
    JLE 0x0058f605                      ; 0058f5db | LAB_0058f605
    ...
    PUSH EAX                            ; 0058f5ea
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058f5eb | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JL 0x0058f5e0                       ; 0058f603 | LAB_0058f5e0
    ...
    JL 0x0058f5cd                       ; 0058f618 | LAB_0058f5cd
        ;   XREF to: 0058f5cd (CONDITIONAL_JUMP)
    PUSH 0x64b404                       ; 0058f61a | = "// bone origin list\n" | s_bone_origin_list_0064b404 = // bone origin list

        ;   Label: LAB_0058f61a
    MOV ECX,dword ptr [ESP + 0x4c]      ; 0058f61f
    PUSH ECX                            ; 0058f623
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058f624 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0058f629
    MOV EBX,dword ptr [ESP]             ; 0058f62c
    XOR ESI,ESI                         ; 0058f62f
    TEST EBX,EBX                        ; 0058f631
    JLE 0x0058f680                      ; 0058f633 | LAB_0058f680
    ...
    PUSH 0x64b419                       ; 0058f65c | = "%g,%g,%g\n" | s_g_g_g_0064b419 = %g,%g,%g

    MOV ECX,dword ptr [ESP + 0x64]      ; 0058f661
    PUSH ECX                            ; 0058f665
    ADD EBX,0xc                         ; 0058f666
    INC ESI                             ; 0058f669
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058f66a | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x20                        ; 0058f66f
    CMP ESI,EDI                         ; 0058f672
    JL 0x0058f642                       ; 0058f674 | LAB_0058f642
        ;   XREF to: 0058f642 (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 0058f676
    LEA EDX,[EDX]                       ; 0058f67c
    PUSH 0x64b423                       ; 0058f680 | = "// defaultRootOffsetScale\n" | s_defaultRootOffsetScale_0064b423 = // defaultRootOffsetScale

        ;   Label: LAB_0058f680
    MOV EBP,dword ptr [ESP + 0x4c]      ; 0058f685
    PUSH EBP                            ; 0058f689
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058f68a | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH 0x64b43e                       ; 0058f6ba | = "%g,%g,%g\n" | s_g_g_g_0064b43e = %g,%g,%g

    PUSH EBP                            ; 0058f6bf
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058f6c0 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x20                        ; 0058f6c5
    PUSH 0x64b448                       ; 0058f6c8 | = "// biasUsed\n" | s_biasUsed_0064b448 = // biasUsed

    PUSH EBP                            ; 0058f6cd
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058f6ce | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    PUSH 0x64b455                       ; 0058f6fe | = "%g,%g,%g\n" | s_g_g_g_0064b455 = %g,%g,%g

    PUSH EBP                            ; 0058f703
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058f704 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x20                        ; 0058f709
    PUSH 0x64b45f                       ; 0058f70c | = "// partForBoneList\n" | s_partForBoneList_0064b45f = // partForBoneList

    PUSH EBP                            ; 0058f711
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058f712 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JLE 0x0058f750                      ; 0058f723 | LAB_0058f750
    ...
    PUSH EBP                            ; 0058f739
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058f73a | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ...
    JL 0x0058f72d                       ; 0058f74b | LAB_0058f72d
    ...
    JNZ 0x0058f762                      ; 0058f758 | LAB_0058f762
    ...
    POP EBX                             ; 0058f760
    RET                                 ; 0058f761
    MOV EDX,0x64b477                    ; 0058f762 | = "..\\core\\skeledit.cpp" | s_core_skeledit_cpp_0064b477 = ..\core\skeledit.cpp
        ;   Label: LAB_0058f762
    MOV ECX,0xbab                       ; 0058f767
    PUSH 0x64b48c                       ; 0058f76c | = "CDeformableModel::saveStream - error ..." | s_CDeformableModel_saveStr_0064b48c = CDeformableModel::saveStream - error writing file!
    MOV dword ptr [0x02f0ca48],EDX      ; 0058f771 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 0058f777 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0058f77d | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
