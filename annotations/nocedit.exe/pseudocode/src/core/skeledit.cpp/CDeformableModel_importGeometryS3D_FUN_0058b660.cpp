...
LAB_0058b7a0:
    ...
    iVar2 = core_skeledit_cpp_CDeformableModel_importTexturesS3D_FUN_0058b8e0(this_ptr,file);
    if (((iVar2 != 0) &&
        (iVar2 = core_skeledit_cpp_CDeformableModel_importFacesS3D_FUN_0058b9b0(this_ptr,file),
        iVar2 != 0)) &&
       (iVar2 = core_skeledit_cpp_CDeformableModel_importVerticesS3D_FUN_0058bc40(this_ptr,file),
       iVar2 != 0)) {
