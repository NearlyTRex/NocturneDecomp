...
section .text
    ...
    CALL crt_stack.c_stack_probe_FUN_005ff9f3 ; 0058f795 | uint crt_stack.c_stack_probe_FUN_005ff9f3(uint stack_size)
        ;   XREF to: 005ff9f3 (UNCONDITIONAL_CALL)
    PUSH EBX                            ; 0058f79a
    PUSH ESI                            ; 0058f79b
    PUSH EDI                            ; 0058f79c
    MOV EBX,dword ptr [ESP + 0x10]      ; 0058f79d
    MOV ESI,0x64b4bf                    ; 0058f7a1 | = "TheOnlyPart" | s_TheOnlyPart_0064b4bf = TheOnlyPart
    LEA EDI,[EBX + 0x7144]              ; 0058f7a6
    MOV dword ptr [EBX + 0x7140],0x1    ; 0058f7ac
    PUSH EDI                            ; 0058f7b6
    MOV AL,byte ptr [ESI]               ; 0058f7b7 | = "TheOnlyPart" | s_TheOnlyPart_0064b4bf = TheOnlyPart
        ;   Label: LAB_0058f7b7
    MOV byte ptr [EDI],AL               ; 0058f7b9
    CMP AL,0x0                          ; 0058f7bb
    JZ 0x0058f7cf                       ; 0058f7bd | LAB_0058f7cf
        ;   XREF to: 0058f7cf (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0058f7bf | s_heOnlyPart_0064b4c0
    ADD ESI,0x2                         ; 0058f7c2
    MOV byte ptr [EDI + 0x1],AL         ; 0058f7c5
    ADD EDI,0x2                         ; 0058f7c8
    CMP AL,0x0                          ; 0058f7cb
    JNZ 0x0058f7b7                      ; 0058f7cd | LAB_0058f7b7
    ...
    JLE 0x0058f800                      ; 0058f7d6 | LAB_0058f800
    ...
    JL 0x0058f7da                       ; 0058f7f5 | LAB_0058f7da
