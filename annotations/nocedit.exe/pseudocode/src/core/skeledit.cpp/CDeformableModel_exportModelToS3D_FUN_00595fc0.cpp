...

{
  ...
  uint in_stack_fffffc5a;
  double dVar8;
  uint uVar9;
  uint in_stack_fffffc5e;
  char acStack_338 [512];
  int aiStack_138 [30];
  CStrList CStack_c0;
  CStrList CStack_b0;
  CVector3f local_a0;
  ...
  if (local_68 == (FILE *)0x0) {
    shape_edittool_cpp_CEditorTools_showError_FUN_0049e740
              (g_CEditorToolsPtr,"Can't create %s",lod_level);
    return;
  }
  ...
  dVar8 = (double)((ulonglong)in_stack_fffffc5a << 0x20);
  iVar6 = (int)bone_matrices * 4;
  local_34 = 0;
  pcVar2 = output_filename + iVar6;
    ...
    do {
      ...
      if (0 < *(int *)(local_74 + 0x7164)) {
        do {
          iVar6 = 0;
          do {
            puVar3 = (ushort *)(*(int *)(local_10 + 0x7c) + local_1c + iVar6);
            iVar6 = iVar6 + 2;
            dest[*puVar3] = 1;
          } while (iVar6 != 6);
          local_28 = local_28 + 1;
      ...
      if (local_8c != 0) {
        ...
        if (0 < *(int *)(local_6c + 0x7178)) {
          do {
            iVar6 = 0;
            do {
              puVar3 = (ushort *)(*(int *)(pcVar2 + 0x7c) + local_2c + iVar6);
              iVar6 = iVar6 + 2;
              dest[*puVar3] = 1;
            } while (iVar6 != 6);
            local_18 = local_18 + 1;
      ...
      *(uint *)((int)aiStack_138 + local_70) = 0;
            ...
            *piVar7 = CStack_b0.item_count;
            core_skeleton_cpp_CDeformableModel_skinSingleVertex_FUN_0059aa00
                      ((CDeformableModel *)output_filename,&local_a0,(int)bone_matrices,local_14,
                       in_stack_00000018);
            dVar8 = (double)local_a0.z;
            crt_stdio_c_sprintf_FUN_005fdbd0
                      (acStack_338,"%g,%g,%g",SUB84 /* extract 2-byte value */((double)local_a0.x,0),
                       (int)((ulonglong)(double)local_a0.x >> 0x20),SUB84 /* extract 2-byte value */((double)local_a0.y,0),
                       (int)((ulonglong)(double)local_a0.y >> 0x20),SUB84 /* extract 2-byte value */(dVar8,0));
            shape_edittool_cpp_CStrList_add_FUN_004a2b80(&CStack_b0,acStack_338);
          }
          local_14 = local_14 + 1;
          piVar7 = piVar7 + 1;
      ...
      for (iVar6 = 0; uVar9 = (uint)((ulonglong)dVar8 >> 0x20),
          iVar6 < *(int *)(local_58 + local_48 + 0x7164); iVar6 = iVar6 + 1) {
        puVar3 = (ushort *)(*(int *)(output_filename + local_48 + 0x7c) + local_24);
        uStack_c = (uint)puVar3[3];
        crt_stdio_c_sprintf_FUN_005fdbd0
                  (acStack_338,"%d, %d,%g,%g, %d,%g,%g, %d,%g,%g",
                   *(uint *)(*(int *)(output_filename + local_48 + 0x90) + local_20),
                   dest[*puVar3],SUB84 /* extract 2-byte value */((double)uStack_c * 0.00390625,0),
                   (int)((ulonglong)((double)uStack_c * 0.00390625) >> 0x20),
                   SUB84 /* extract 2-byte value */((double)puVar3[6] * 0.00390625,0),
                   (int)((ulonglong)((double)puVar3[6] * 0.00390625) >> 0x20),dest[puVar3[1]],
                   SUB84 /* extract 2-byte value */((double)puVar3[4] * 0.00390625,0),
                   (int)((ulonglong)((double)puVar3[4] * 0.00390625) >> 0x20),
                   SUB84 /* extract 2-byte value */((double)puVar3[7] * 0.00390625,0),
                   (int)((ulonglong)((double)puVar3[7] * 0.00390625) >> 0x20),dest[puVar3[2]],
                   SUB84 /* extract 2-byte value */((double)puVar3[5] * 0.00390625,0),
                   (int)((ulonglong)((double)puVar3[5] * 0.00390625) >> 0x20),
                   SUB84 /* extract 2-byte value */((double)puVar3[8] * 0.00390625,0),
                   (int)((ulonglong)((double)puVar3[8] * 0.00390625) >> 0x20));
        shape_edittool_cpp_CStrList_add_FUN_004a2b80(&CStack_c0,acStack_338);
      ...
      if (local_8c != 0) {
        ...
        for (iVar6 = 0; iVar6 < *(int *)(local_5c + local_4c + 0x7178); iVar6 = iVar6 + 1) {
  ...
  crt_stdio_c_fprintf_FUN_005fe6d0
            (local_68,"%d,%d,%d,%d,1,0,0\n",*(uint *)(output_filename + 0xbc),
             CStack_c0.item_count,CStack_b0.item_count,*(uint *)(output_filename + 0x7140));
  local_80 = 0;
  ...
  if (0 < *(int *)(output_filename + 0x7140)) {
    ...
    pcVar4 = output_filename + (int)bone_matrices * 4;
    iVar5 = 0;
    do {
      local_94 = *(int *)(pcVar4 + 0x7164) + *(int *)(pcVar4 + 0x7178);
      pcVar4 = pcVar4 + 0x60;
      iVar6 = iVar6 + 1;
      crt_stdio_c_fprintf_FUN_005fe6d0
                (local_68,"%d,%d,%d,%d,\"%s\"\n",local_80,*(uint *)((int)aiStack_138 + iVar5),
                 local_84,local_94,local_88);
      local_80 = local_80 + *(int *)((int)aiStack_138 + iVar5);
      local_84 = local_84 + local_94;
      local_88 = local_88 + 0x60;
      iVar5 = iVar5 + 4;
    } while (iVar6 < *(int *)(output_filename + 0x7140));
  }
  crt_stdio_c_fprintf_FUN_005fe6d0(local_68,"// texture list: name\n");
  iVar6 = 0;
  if (0 < *(int *)(output_filename + 0xbc)) {
    pcVar4 = output_filename + 200;
    do {
      crt_stdio_c_fprintf_FUN_005fe6d0(local_68,"%s\n","%s\n",pcVar4);
      iVar6 = iVar6 + 1;
      pcVar4 = pcVar4 + 0x48;
    } while (iVar6 < *(int *)(output_filename + 0xbc));
  }
  ...
  if (0 < CStack_c0.item_count) {
    do {
      pcVar2 = shape_edittool_cpp_CStrList_getStringAt_FUN_004a2f70(&CStack_c0,iVar6);
      iVar6 = iVar6 + 1;
      crt_stdio_c_fprintf_FUN_005fe6d0(pFVar1,"%s\n",pcVar2);
    } while (iVar6 < CStack_c0.item_count);
  }
  iVar6 = 0;
  ...
  if (0 < CStack_b0.item_count) {
    do {
      pcVar2 = shape_edittool_cpp_CStrList_getStringAt_FUN_004a2f70(&CStack_b0,iVar6);
      iVar6 = iVar6 + 1;
      crt_stdio_c_fprintf_FUN_005fe6d0(pFVar1,"%s\n",pcVar2);
    } while (iVar6 < CStack_b0.item_count);
  }
  ...
  shape_edittool_cpp_CStrList_dtor_FUN_004a2a40(&CStack_c0,0,uVar9);
  shape_edittool_cpp_CStrList_dtor_FUN_004a2a40(&CStack_b0,0,in_stack_fffffc5e);
  return;
}
