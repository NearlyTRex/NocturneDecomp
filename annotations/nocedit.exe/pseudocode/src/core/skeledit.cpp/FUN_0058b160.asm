...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_skeledit.cpp_FUN_0058b160()
;
; Local Variables:
; undefined4       Stack[-0x10]:4  local_10
;
; XREF[1]:
;   core_skeledit.cpp_FUN_0058c190 at 0058c25f
;
; Called Functions:
...
section .text
    ...
    CALL crt_stack.c_stack_probe_FUN_005ff9f3 ; 0058b165 | uint crt_stack.c_stack_probe_FUN_005ff9f3(uint stack_size)
    ...
    JLE 0x0058b1ed                      ; 0058b184 | LAB_0058b1ed
    ...
    CMP AL,0x0                          ; 0058b1a5
    JZ 0x0058b1b9                       ; 0058b1a7 | LAB_0058b1b9
    ...
    CMP AL,0x0                          ; 0058b1b5
    JNZ 0x0058b1a1                      ; 0058b1b7 | LAB_0058b1a1
    ...
    JL 0x0058b19c                       ; 0058b1ea | LAB_0058b19c
