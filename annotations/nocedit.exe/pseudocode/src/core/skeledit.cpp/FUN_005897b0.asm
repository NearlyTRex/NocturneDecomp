...
;                               FUNCTION
; *****************************************************************************
; unknown void core_skeledit_cpp_FUN_005897b0(void)
;
; Local Variables:
...
section .text
    ...
    CALL crt_stack.c_stack_probe_FUN_005ff9f3 ; 005897b5
    ...
    JG 0x0058986a                       ; 0058987f
        ;   XREF to: 0058986a (CONDITIONAL_JUMP)  ; LAB_0058986a
    MOV EBX,0x3670950                   ; 00589881 | DAT_03670950
        ;   Label: LAB_00589881
    XOR DL,DL                           ; 00589886
    MOV ESI,EDI                         ; 00589888
    MOV byte ptr [0x03670950],DL        ; 0058988a | DAT_03670950
    PUSH ESI                            ; 00589890
        ;   Label: LAB_00589890
    ...
    JG 0x005898ad                       ; 005898c2
        ;   XREF to: 005898ad (CONDITIONAL_JUMP)  ; LAB_005898ad
    MOV EBX,0x3670a58                   ; 005898c4 | DAT_03670a58
        ;   Label: LAB_005898c4
    XOR DH,DH                           ; 005898c9
    MOV ESI,EDI                         ; 005898cb
    MOV byte ptr [0x03670a58],DH        ; 005898cd | DAT_03670a58
    PUSH ESI                            ; 005898d3
        ;   Label: LAB_005898d3
    ...
    CALL crt_io.c_deleteFile_FUN_005ff9d0 ; 0058996e
