...
LAB_0059722b:
    ...
    if (iVar7 != 0) {
      ...
      _sprintf(g_SkeletonViewModelScreenshotFilename,"noc%d.pcx",g_SkeletonViewModelScreenshotCounter);
    ...
    if (local_98 == 0) {
      if (local_9c != 0) {
        shape_edittool_cpp_CEditorTools_draw3DAxisLabels_FUN_004a1ca0
                  (g_CEditorToolsPtr,2.0,0xff);
      }
    }
    else {
      shape_edittool_cpp_CEditorTools_draw3DAxisLabels_FUN_004a1ca0
                (g_CEditorToolsPtr,2.0,
                 (int)shape_edittool_cpp_CEditorTools_getTimeCycledColorByte_FUN_004a1330
                               (g_CEditorToolsPtr));
    }
    _sprintf(local_46c,"%f, %d",(double)(1.0f / local_80),g_RenderedTriangleCount);
    engine_2d_c_drawText_FUN_00401fd0(local_46c,0,g_WindowHeight + -0xb);
    pSVar11 = core_motion_cpp_CMotionController_getCurrentMotion_FUN_0052dab0(&this_ptr->motion_controller);
    _sprintf(local_46c," %s %7.2f ",pSVar11->motion_name,(double)(this_ptr->motion_controller).current_frame_number);
    ...
    local_18 = core_motion_cpp_CMotionController_frameToMarkerPosition_FUN_0052e2b0
                         (&this_ptr->motion_controller);
    _sprintf(local_46c," Zone: %5.2f ",(double)local_18);
    ...
    _sprintf(local_46c," Selected part: %d \"%s\" Dominant bone: \"%s\"",
             iVar7,local_34->part_name,
             this_ptr_02->bone_list[local_34->dominant_bone].bone_name);
    ...
    _sprintf(local_46c," LOD: %d PixHeight: %d Polys %d",
             this_ptr->cached_skinned_lod_index,(int)local_18,
             this_ptr_01->tri_count[this_ptr->cached_skinned_lod_index]);
    engine_2d_c_drawText_FUN_00401fd0(local_46c,0,0x4d);
    _sprintf(local_46c," Current texture set: %d",local_9c);
    ...
    if (0 < g_SkeleditViewModel.poly_count) {
      ...
      _sprintf(local_46c," Item orient: P: %5.3f B: %5.3f H: %5.3f",
               (double)local_190.y,(double)local_184.x,(double)local_190.z);
    ...
    if (iVar7 != 0) {
      ...
      _sprintf(local_534,"Select LOD (0..%d), or -1 for auto-LOD",iVar7 - 1);
      shape_edittool_cpp_CEditorTools_promptForValidInteger_FUN_004a0020
    ...
    if (iVar7 != 0) {
      ...
      if (0 < this_ptr_02->bone_count) {
        do {
          local_bone_part = core_skeleton_cpp_CDeformableModel_getBonePart_FUN_0059c2d0(this_ptr_01,iVar7);
          _sprintf(local_46c,"%s\t%s",this_ptr_02->bone_list[iVar7].bone_name,
                   this_ptr_01->parts[local_bone_part].part_name);
