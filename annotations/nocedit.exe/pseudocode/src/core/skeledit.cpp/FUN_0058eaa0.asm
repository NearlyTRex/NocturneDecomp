...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_skeledit.cpp_FUN_0058eaa0()
;
; Local Variables:
...
section .text
    ...
    CALL crt_stack.c_stack_probe_FUN_005ff9f3 ; 0058eaa5 | uint crt_stack.c_stack_probe_FUN_005ff9f3(uint stack_size)
    ...
    PUSH 0x64b072                       ; 0058eab6 | = "Optimizing deformable model vertices..." | s_Optimizing_deformable_mo_0064b072 = Optimizing deformable model vertices...
    MOV EDX,dword ptr [0x00678a60]      ; 0058eabb | CEditorTools * g_CEditorToolsPtr
    PUSH EDX                            ; 0058eac1 | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_displayCenteredStatusMessage_FUN_0049e790 ; 0058eac2 | void shape_edittool.cpp_CEditorTools_displayCenteredStatusMessage_FUN_0049e790(CEditorTools * this_ptr, char * message)
    ...
    JLE 0x0058eb44                      ; 0058ead7 | LAB_0058eb44
    ...
    JGE 0x0058eb29                      ; 0058eafb | LAB_0058eb29
    ...
    JGE 0x0058eb5f                      ; 0058eb11 | LAB_0058eb5f
    ...
    JMP 0x0058eaed                      ; 0058eb27 | LAB_0058eaed
    ...
    JL 0x0058eadc                       ; 0058eb42 | LAB_0058eadc
        ;   XREF to: 0058eadc (CONDITIONAL_JUMP)
    PUSH 0x64b09a                       ; 0058eb44 | = "Optimized deformable model vertices OK" | s_Optimized_deformable_mod_0064b09a = Optimized deformable model vertices OK
        ;   Label: LAB_0058eb44
    MOV ECX,dword ptr [0x00678a60]      ; 0058eb49 | CEditorTools * g_CEditorToolsPtr
    PUSH ECX                            ; 0058eb4f | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_displayCenteredStatusMessage_FUN_0049e790 ; 0058eb50 | void shape_edittool.cpp_CEditorTools_displayCenteredStatusMessage_FUN_0049e790(CEditorTools * this_ptr, char * message)
        ;   XREF to: 0049e790 (UNCONDITIONAL_CALL)
    ...
    JGE 0x0058ec02                      ; 0058eb88 | LAB_0058ec02
        ;   XREF to: 0058ec02 (CONDITIONAL_JUMP)
    FLD float ptr [ESI + 0x4]           ; 0058eb8e
    FCOMP double ptr [0x0064b0c2]       ; 0058eb91 | double DOUBLE_0064b0c2
    FNSTSW AX                           ; 0058eb97
    SAHF                                ; 0058eb99
    JA 0x0058ebae                       ; 0058eb9a | LAB_0058ebae
    ...
    JMP 0x0058eb7a                      ; 0058ebac | LAB_0058eb7a
        ;   XREF to: 0058eb7a (UNCONDITIONAL_JUMP)
    CMP EBX,dword ptr [ESP + 0x24]      ; 0058ebae
        ;   Label: LAB_0058ebae
    JLE 0x0058ebe0                      ; 0058ebb2 | LAB_0058ebe0
    ...
    JZ 0x0058ebe0                       ; 0058ebce | LAB_0058ebe0
        ;   XREF to: 0058ebe0 (CONDITIONAL_JUMP)
    ...
    JGE 0x0058ec3a                      ; 0058ec28 | LAB_0058ec3a
    ...
    JMP 0x0058ec22                      ; 0058ec38 | LAB_0058ec22
    ...
    JGE 0x0058eb13                      ; 0058ec48 | LAB_0058eb13
        ;   XREF to: 0058eb13 (CONDITIONAL_JUMP)
    ...
    JMP 0x0058ec42                      ; 0058ec5b | LAB_0058ec42
