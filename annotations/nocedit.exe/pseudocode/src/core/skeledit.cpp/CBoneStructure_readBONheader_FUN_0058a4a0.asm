...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_skeledit_cpp_CBoneStructure_readBONheader_FUN_0058a4a0 (CBoneStructure *this_ptr,FILE *file,int *frame_count_out)
;
; Parameters:
...
section .text
    ...
    CALL crt_stack.c_stack_probe_FUN_005ff9f3 ; 0058a4a5
