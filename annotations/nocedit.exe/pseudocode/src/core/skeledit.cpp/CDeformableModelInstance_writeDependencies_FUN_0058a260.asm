...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_skeledit_cpp_CDeformableModelInstance_writeDependencies_FUN_0058a260 (CDeformableModelInstance *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH 0x14                           ; 0058a260
        ;   Label: core_skeledit.cpp_CDeformableModelInstance_writeDependencies_FUN_0058a260
