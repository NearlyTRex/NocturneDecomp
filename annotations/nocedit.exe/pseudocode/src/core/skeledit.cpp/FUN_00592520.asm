...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_skeledit.cpp_FUN_00592520()
;
;
; XREF[1]:
...
section .text
    ...
    CALL crt_stack.c_stack_probe_FUN_005ff9f3 ; 00592525 | uint crt_stack.c_stack_probe_FUN_005ff9f3(uint stack_size)
        ;   XREF to: 005ff9f3 (UNCONDITIONAL_CALL)
    PUSH EBX                            ; 0059252a
    PUSH ESI                            ; 0059252b
    MOV ESI,dword ptr [ESP + 0xc]       ; 0059252c
    MOV EBX,dword ptr [ESP + 0x10]      ; 00592530
    PUSH 0x64bff2                       ; 00592534 | = "(" | s_anon_0064bff2 = (
    PUSH ESI                            ; 00592539
    CALL crt_string.c_strcmp_FUN_005fef20 ; 0059253a | int crt_string.c_strcmp_FUN_005fef20(char * str1, char * str2)
        ;   XREF to: 005fef20 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0059253f
    TEST EAX,EAX                        ; 00592542
    JNZ 0x00592550                      ; 00592544 | LAB_00592550
    ...
    POP EBX                             ; 0059254e
    RET                                 ; 0059254f
    PUSH 0x64bff4                       ; 00592550 | = ")" | s_anon_0064bff4 = )
        ;   Label: LAB_00592550
    PUSH ESI                            ; 00592555
    CALL crt_string.c_strcmp_FUN_005fef20 ; 00592556 | int crt_string.c_strcmp_FUN_005fef20(char * str1, char * str2)
        ;   XREF to: 005fef20 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0059255b
    TEST EAX,EAX                        ; 0059255e
    JZ 0x005925a0                       ; 00592560 | LAB_005925a0
        ;   XREF to: 005925a0 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x18],0x0      ; 00592562
    JZ 0x0059257b                       ; 00592567 | LAB_0059257b
        ;   XREF to: 0059257b (CONDITIONAL_JUMP)
    PUSH 0x64bff6                       ; 00592569 | = "patch" | s_patch_0064bff6 = patch
    PUSH ESI                            ; 0059256e
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 0059256f | int crt_string.c_stricmp_FUN_005fe7f0(char * str1, char * str2)
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00592574
    TEST EAX,EAX                        ; 00592577
    JZ 0x005925af                       ; 00592579 | LAB_005925af
        ;   XREF to: 005925af (CONDITIONAL_JUMP)
    PUSH EBX                            ; 0059257b
        ;   Label: LAB_0059257b
    PUSH 0x64bffc                       ; 0059257c | = "%d" | s_d_0064bffc = %d
    PUSH ESI                            ; 00592581
    CALL crt_stdio.c_sscanf_FUN_0060013c ; 00592582 | int crt_stdio.c_sscanf_FUN_0060013c(char * str, char * format)
        ;   XREF to: 0060013c (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00592587
    CMP EAX,0x1                         ; 0059258a
    JNZ 0x0059259b                      ; 0059258d | LAB_0059259b
        ;   XREF to: 0059259b (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [EBX]             ; 0059258f
    TEST ECX,ECX                        ; 00592591
    JL 0x0059259b                       ; 00592593 | LAB_0059259b
        ;   XREF to: 0059259b (CONDITIONAL_JUMP)
    CMP ECX,dword ptr [ESP + 0x14]      ; 00592595
    JL 0x0059254d                       ; 00592599 | LAB_0059254d
