...
section .text
    ...
    PUSH 0x64d61a                       ; 00595fe4 | = "..\\core\\skeledit.cpp"
    PUSH 0x64d62f                       ; 00595fe9 | = "wt"
    PUSH 0x0                            ; 00595fee
    PUSH EBX                            ; 00595ff0
    CALL shape_memdbg.cpp_openFile_FUN_0050f7a0 ; 00595ff1
        ;   XREF to: 0050f7a0 (UNCONDITIONAL_CALL)  ; _FILE * shape_memdbg.cpp_openFile_FUN_0050f7a0(char * filename, char * directory, char * mode, char * source_file, ...)
    ADD ESP,0x14                        ; 00595ff6
    MOV dword ptr [EBP + 0x12],EAX      ; 00595ff9
    TEST EAX,EAX                        ; 00595ffc
    JZ 0x005963d8                       ; 00595ffe
        ;   XREF to: 005963d8 (CONDITIONAL_JUMP)  ; LAB_005963d8
    ...
    JNZ 0x00596057                      ; 00596032
        ;   XREF to: 00596057 (CONDITIONAL_JUMP)  ; LAB_00596057
    MOV ECX,0x64d657                    ; 00596034 | = "..\\core\\skeledit.cpp"
    MOV ESI,0x1566                      ; 00596039
    PUSH 0x64d66c                       ; 0059603e | = "Out of memory"
    MOV dword ptr [0x02f0ca48],ECX      ; 00596043 | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 00596049 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0059604f
    ...
    PUSH EAX                            ; 00596071
    CALL shape_edittool.cpp_CStrList_ctor_FUN_004a2a20 ; 00596072
    ...
    CALL shape_edittool.cpp_CStrList_ctor_FUN_004a2a20 ; 00596084
        ;   XREF to: 004a2a20 (UNCONDITIONAL_CALL)  ; CStrList * shape_edittool.cpp_CStrList_ctor_FUN_004a2a20(CStrList * this_ptr)
    ...
    JLE 0x005965cd                      ; 005960b5
        ;   XREF to: 005965cd (CONDITIONAL_JUMP)  ; LAB_005965cd
    ...
    PUSH 0x0                            ; 005960e4
    PUSH EBX                            ; 005960e6
    CALL crt_memory.c_memset_FUN_005fde40 ; 005960e7
    ...
    JLE 0x00596162                      ; 00596114
        ;   XREF to: 00596162 (CONDITIONAL_JUMP)  ; LAB_00596162
    ...
    JNZ 0x0059611b                      ; 0059613a
        ;   XREF to: 0059611b (CONDITIONAL_JUMP)  ; LAB_0059611b
    ...
    JL 0x00596116                       ; 00596160
        ;   XREF to: 00596116 (CONDITIONAL_JUMP)  ; LAB_00596116
    ...
    JZ 0x005961d8                       ; 0059616d
        ;   XREF to: 005961d8 (CONDITIONAL_JUMP)  ; LAB_005961d8
    ...
    JNZ 0x00596194                      ; 005961b0
        ;   XREF to: 00596194 (CONDITIONAL_JUMP)  ; LAB_00596194
    ...
    JL 0x0059618f                       ; 005961d6
        ;   XREF to: 0059618f (CONDITIONAL_JUMP)  ; LAB_0059618f
    ...
    JLE 0x0059629e                      ; 005961ef
        ;   XREF to: 0059629e (CONDITIONAL_JUMP)  ; LAB_0059629e
    MOV EAX,dword ptr [EBP + 0xa]       ; 005961f5
    MOV EDI,EBX                         ; 005961f8
    MOV dword ptr [EBP + 0x36],EAX      ; 005961fa
    CMP dword ptr [EDI],0x0             ; 005961fd
        ;   Label: LAB_005961fd
    JZ 0x005963f5                       ; 00596200
        ;   XREF to: 005963f5 (CONDITIONAL_JUMP)  ; LAB_005963f5
    ...
    PUSH ECX                            ; 00596239
    CALL core_skeleton.cpp_CDeformableModel_skinSingleVertex_FUN_0059aa00 ; 0059623a
    ...
    PUSH 0x64d68f                       ; 0059625d | = "%g,%g,%g"
    LEA EAX,[EBP + 0xfffffd42]          ; 00596262
    PUSH EAX                            ; 00596268
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 00596269
    ...
    PUSH EAX                            ; 0059627b
    CALL shape_edittool.cpp_CStrList_add_FUN_004a2b80 ; 0059627c
    ...
    JL 0x005961fd                       ; 00596298
        ;   XREF to: 005961fd (CONDITIONAL_JUMP)  ; LAB_005961fd
    ...
    JGE 0x00596400                      ; 005962c6
        ;   XREF to: 00596400 (CONDITIONAL_JUMP)  ; LAB_00596400
    ...
    FLD double ptr [0x0064d8e2]         ; 005962e5 | DOUBLE_0064d8e2
    ...
    PUSH EDX                            ; 00596391
    PUSH 0x64d698                       ; 00596392 | = "%d, %d,%g,%g, %d,%g,%g, %d,%g,%g"
    LEA EAX,[EBP + 0xfffffd42]          ; 00596397
    PUSH EAX                            ; 0059639d
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 0059639e
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c__sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH EAX                            ; 005963b0
    INC EDI                             ; 005963b1
    CALL shape_edittool.cpp_CStrList_add_FUN_004a2b80 ; 005963b2
        ;   XREF to: 004a2b80 (UNCONDITIONAL_CALL)  ; void shape_edittool.cpp_CStrList_add_FUN_004a2b80(CStrList * this_ptr, char * string_data)
    ...
    JMP 0x005962b8                      ; 005963d3
        ;   XREF to: 005962b8 (UNCONDITIONAL_JUMP)  ; LAB_005962b8
    PUSH EBX                            ; 005963d8
        ;   Label: LAB_005963d8
    ...
    MOV dword ptr [EDI],0xffffffff      ; 005963f5
        ;   Label: LAB_005963f5
    JMP 0x00596284                      ; 005963fb
        ;   XREF to: 00596284 (UNCONDITIONAL_JUMP)  ; LAB_00596284
    MOV EAX,dword ptr [EBP + 0x46]      ; 00596400
        ;   Label: LAB_00596400
    CMP EAX,dword ptr [EBP + 0x3e]      ; 00596403
    JZ 0x0059642a                       ; 00596406
        ;   XREF to: 0059642a (CONDITIONAL_JUMP)  ; LAB_0059642a
    MOV EAX,0x64d6b9                    ; 00596408 | = "..\\core\\skeledit.cpp"
    MOV EDX,0x15a8                      ; 0059640d
    PUSH 0x64d6ce                       ; 00596412 | = "Hell froze"
    MOV [0x02f0ca48],EAX                ; 00596417 | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 0059641c | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00596422
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ADD ESP,0x4                         ; 00596427
    CMP dword ptr [EBP + -0x12],0x0     ; 0059642a
        ;   Label: LAB_0059642a
    JZ 0x0059658e                       ; 0059642e
        ;   XREF to: 0059658e (CONDITIONAL_JUMP)  ; LAB_0059658e
    ...
    JGE 0x00596564                      ; 0059645a
        ;   XREF to: 00596564 (CONDITIONAL_JUMP)  ; LAB_00596564
    ...
    FLD double ptr [0x0064d8e2]         ; 0059647a | DOUBLE_0064d8e2
    ...
    PUSH EDX                            ; 00596526
    PUSH 0x64d6d9                       ; 00596527 | = "%d, %d,%g,%g, %d,%g,%g, %d,%g,%g"
    LEA EAX,[EBP + 0xfffffd42]          ; 0059652c
    PUSH EAX                            ; 00596532
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 00596533
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c__sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH EAX                            ; 00596545
    INC EDI                             ; 00596546
    CALL shape_edittool.cpp_CStrList_add_FUN_004a2b80 ; 00596547
        ;   XREF to: 004a2b80 (UNCONDITIONAL_CALL)  ; void shape_edittool.cpp_CStrList_add_FUN_004a2b80(CStrList * this_ptr, char * string_data)
    ...
    JMP 0x0059644e                      ; 0059655f
        ;   XREF to: 0059644e (UNCONDITIONAL_JUMP)  ; LAB_0059644e
    MOV EAX,dword ptr [EBP + 0x42]      ; 00596564
        ;   Label: LAB_00596564
    CMP EAX,dword ptr [EBP + 0x3a]      ; 00596567
    JZ 0x0059658e                       ; 0059656a
        ;   XREF to: 0059658e (CONDITIONAL_JUMP)  ; LAB_0059658e
    MOV EDI,0x64d6fa                    ; 0059656c | = "..\\core\\skeledit.cpp"
    MOV EAX,0x15b5                      ; 00596571
    PUSH 0x64d70f                       ; 00596576 | = "Hell froze"
    MOV dword ptr [0x02f0ca48],EDI      ; 0059657b | g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 00596581 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00596586
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    JL 0x005960da                       ; 005965c7
        ;   XREF to: 005960da (CONDITIONAL_JUMP)  ; LAB_005960da
    MOV ESI,0x64d71a                    ; 005965cd | = "..\\core\\skeledit.cpp"
        ;   Label: LAB_005965cd
    MOV EDI,0x15b9                      ; 005965d2
    PUSH EBX                            ; 005965d7
    MOV dword ptr [0x0067d20c],ESI      ; 005965d8 | g_CurrentDebugFilename
    MOV dword ptr [0x02f0d944],EDI      ; 005965de | g_CurrentDebugLine
    CALL shape_memdbg.cpp_free_FUN_005fe659 ; 005965e4
        ;   XREF to: 005fe659 (UNCONDITIONAL_CALL)  ; void shape_memdbg.cpp_free_FUN_005fe659(void * ptr)
    ADD ESP,0x4                         ; 005965e9
    PUSH 0x64d72f                       ; 005965ec | = "// S3D version\n"
    MOV EAX,dword ptr [EBP + 0x12]      ; 005965f1
    PUSH EAX                            ; 005965f4
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 005965f5
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(_FILE * file, char * format)
    ADD ESP,0x8                         ; 005965fa
    PUSH 0x64d73f                       ; 005965fd | = "103\n"
    MOV EDX,dword ptr [EBP + 0x12]      ; 00596602
    PUSH EDX                            ; 00596605
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00596606
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(_FILE * file, char * format)
    ADD ESP,0x8                         ; 0059660b
    PUSH 0x64d744                       ; 0059660e | = "// numTextures,numTris,numVerts,numPa..."
    MOV ECX,dword ptr [EBP + 0x12]      ; 00596613
    PUSH ECX                            ; 00596616
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00596617
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(_FILE * file, char * format)
    ...
    PUSH ECX                            ; 00596643
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00596644
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(_FILE * file, char * format)
    ADD ESP,0x18                        ; 00596649
    PUSH 0x64d7a0                       ; 0059664c | = "// partList: firstVert,numVerts,first..."
    MOV EBX,dword ptr [EBP + 0x12]      ; 00596651
    XOR ESI,ESI                         ; 00596654
    PUSH EBX                            ; 00596656
    MOV dword ptr [EBP + -0x6],ESI      ; 00596657
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0059665a
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(_FILE * file, char * format)
    ...
    JLE 0x00596710                      ; 00596675
        ;   XREF to: 00596710 (CONDITIONAL_JUMP)  ; LAB_00596710
    ...
    INC EDI                             ; 005966c7
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 005966c8
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(_FILE * file, char * format)
    ...
    JL 0x00596692                       ; 00596701
        ;   XREF to: 00596692 (CONDITIONAL_JUMP)  ; LAB_00596692
    ...
    PUSH ECX                            ; 00596718
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00596719
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(_FILE * file, char * format)
    ...
    JLE 0x00596760                      ; 00596731
        ;   XREF to: 00596760 (CONDITIONAL_JUMP)  ; LAB_00596760
    ...
    PUSH EDX                            ; 00596742
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00596743
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(_FILE * file, char * format)
    ...
    JL 0x00596739                       ; 0059675d
        ;   XREF to: 00596739 (CONDITIONAL_JUMP)  ; LAB_00596739
    NOP                                 ; 0059675f
    PUSH 0x64d806                       ; 00596760 | = "// triList: materialIndex,vertices(in..."
        ;   Label: LAB_00596760
    MOV EBX,dword ptr [EBP + 0x12]      ; 00596765
    PUSH EBX                            ; 00596768
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00596769
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(_FILE * file, char * format)
    MOV ESI,dword ptr [EBP + -0x46]     ; 0059676e
    ADD ESP,0x8                         ; 00596771
    XOR EBX,EBX                         ; 00596774
    TEST ESI,ESI                        ; 00596776
    JLE 0x005967b0                      ; 00596778
        ;   XREF to: 005967b0 (CONDITIONAL_JUMP)  ; LAB_005967b0
    MOV EDI,dword ptr [EBP + 0x12]      ; 0059677a
    PUSH EBX                            ; 0059677d
        ;   Label: LAB_0059677d
    LEA EAX,[EBP + -0x46]               ; 0059677e
    PUSH EAX                            ; 00596781
    CALL shape_edittool.cpp_CStrList_getStringAt_FUN_004a2f70 ; 00596782
    ...
    PUSH EDI                            ; 00596790
    INC EBX                             ; 00596791
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00596792
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(_FILE * file, char * format)
    MOV EAX,dword ptr [EBP + -0x46]     ; 00596797
    ADD ESP,0xc                         ; 0059679a
    CMP EBX,EAX                         ; 0059679d
    JL 0x0059677d                       ; 0059679f
        ;   XREF to: 0059677d (CONDITIONAL_JUMP)  ; LAB_0059677d
    ...
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 005967bb
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(_FILE * file, char * format)
    MOV ECX,dword ptr [EBP + -0x36]     ; 005967c0
    ADD ESP,0x8                         ; 005967c3
    TEST ECX,ECX                        ; 005967c6
    JLE 0x00596800                      ; 005967c8
        ;   XREF to: 00596800 (CONDITIONAL_JUMP)  ; LAB_00596800
    MOV ESI,dword ptr [EBP + 0x12]      ; 005967ca
    PUSH EBX                            ; 005967cd
        ;   Label: LAB_005967cd
    LEA EAX,[EBP + -0x36]               ; 005967ce
    PUSH EAX                            ; 005967d1
    CALL shape_edittool.cpp_CStrList_getStringAt_FUN_004a2f70 ; 005967d2
        ;   XREF to: 004a2f70 (UNCONDITIONAL_CALL)  ; char * shape_edittool.cpp_CStrList_getStringAt_FUN_004a2f70(CStrList * this_ptr, int index)
    ...
    PUSH ESI                            ; 005967e0
    INC EBX                             ; 005967e1
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 005967e2
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(_FILE * file, char * format)
    MOV EDI,dword ptr [EBP + -0x36]     ; 005967e7
    ADD ESP,0xc                         ; 005967ea
    CMP EBX,EDI                         ; 005967ed
    JL 0x005967cd                       ; 005967ef
        ;   XREF to: 005967cd (CONDITIONAL_JUMP)  ; LAB_005967cd
    LEA EAX,[EAX]                       ; 005967f1
    LEA EDX,[EDX]                       ; 005967f7
    LEA EAX,[EAX]                       ; 005967fd
    PUSH 0x64d859                       ; 00596800 | = "// lightList: \"name\", type, x,y,z, ..."
        ;   Label: LAB_00596800
    MOV EAX,dword ptr [EBP + 0x12]      ; 00596805
    PUSH EAX                            ; 00596808
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 00596809
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(_FILE * file, char * format)
    ADD ESP,0x8                         ; 0059680e
    PUSH 0x64d899                       ; 00596811 | = "// cameraList: \"name\", x,y,z, p,b,h..."
    MOV EDX,dword ptr [EBP + 0x12]      ; 00596816
    PUSH EDX                            ; 00596819
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0059681a
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(_FILE * file, char * format)
    ADD ESP,0x8                         ; 0059681f
    PUSH 0x15ea                         ; 00596822
    PUSH 0x64d8c8                       ; 00596827 | = "..\\core\\skeledit.cpp"
    MOV ECX,dword ptr [EBP + 0x12]      ; 0059682c
    PUSH ECX                            ; 0059682f
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 00596830
