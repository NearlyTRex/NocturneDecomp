...
;
; XREF[3]:
;   core_skeledit.cpp_CDeformableModel_buildFromPosFile_FUN_0058c190 at 0058d15d
;   core_skeledit.cpp_CLodMesh_selectAndGenerateLods_FUN_00589c20 at 00589e78
...
section .text
    ...
    PUSH 0x18                           ; 0058a0f0
        ;   Label: core_skeledit.cpp_CLodMeshPrecomputeEntry_save_FUN_0058a0f0
