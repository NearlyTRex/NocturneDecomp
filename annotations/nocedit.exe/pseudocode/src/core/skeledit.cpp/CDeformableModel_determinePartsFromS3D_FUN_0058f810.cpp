...
// Address: 0058f810
// Address Range: [[0058f810, 0059251f] [00605656, 006056e1]]
// Convention: __cdecl
...

{
  ...
  ushort auStack_2f0 [4];
  uint local_2e8;
  ushort auStack_2e4 [2];
  uint local_2e0;
  ushort auStack_2dc [4];
  uint local_2d4;
  ...
  if (local_ec == (_FILE *)0x0) {
    ...
    do {
      iVar15 = _fgetc(file);
      if (iVar15 < 0) break;
    } while ((iVar15 != 10) || (iVar25 = iVar25 + -1, 0 < iVar25));
    iVar25 = _fscanf(local_ec,"%d,%d,%d,%d,%d,%d,%d\n",&local_e4,&local_16c,&local_168,&local_e0,
                        local_164,local_dc);
    ...
    if (iVar25 == 7) {
      if (local_e0 < 0x1f) {
        ...
        if (0 < this_ptr->num_parts) {
          ...
          local_94 = local_478;
          local_90 = local_400;
          piVar24 = this_ptr->parts[0].tri_counts;
          do {
            local_140 = local_148 + iVar25;
            local_144 = iVar25 * 4;
            iVar15 = _fscanf(local_ec,"%d,%d,%*d,%d,\"%[^\"]\"\n",local_94,local_90,piVar24);
            if (iVar15 != 4) goto LAB_00590a70;
            this_ptr->parts[iVar25].adj_part_count = 0;
            ...
            local_94 = local_94 + 4;
            local_90 = local_90 + 1;
          } while (iVar25 < this_ptr->num_parts);
        }
        shape_edittool_cpp_CEditorTools_displayCenteredStatusMessage_FUN_0049e790
        ...
        if (0 < local_e4) {
          pcVar23 = local_a1ec;
          do {
            iVar15 = _fscanf(local_ec,"%[^\n]\n");
            if (iVar15 != 1) goto LAB_00590a70;
            splitpath
                      (local_844,(char *)0x0,(char *)0x0,pcVar23,(char *)0x0);
            iVar25 = iVar25 + 1;
            pcVar23 = pcVar23 + 0x100;
          } while (iVar25 < local_e4);
        }
        pcVar33 = "gore";
        pcVar30 = local_388;
        for (iVar25 = 0x19; iVar25 != 0; iVar25 = iVar25 + -1) {
          pcVar30 = pcVar30 + (uint)bVar34 * -8 + 4;
          *(uint *)pcVar30 = *(uint *)pcVar33;
          pcVar33 = pcVar33 + ((uint)bVar34 * -2 + 1) * 4;
          pcVar30 = pcVar30;
        }
        ...
        if (local_388[0] != '\0') {
          ...
          if (0 < this_ptr->num_textures) {
            pcVar33 = this_ptr->texture_sets[0].textures[0].textures[0].texture_name;
            do {
              splitpath
                        (pcVar33,(char *)0x0,(char *)0x0,local_640,(char *)0x0);
              iVar15 = _stricmp(local_388,local_640);
              if (iVar15 == 0) break;
              iVar25 = iVar25 + 1;
              pcVar33 = pcVar33 + 0x48;
            } while (iVar25 < this_ptr->num_textures);
          }
          if (this_ptr->num_textures <= iVar25) {
        ...
        if (0 < (int)local_16c) {
          do {
            iVar15 = _fscanf(local_ec,"%d,%d,%f,%f,%d,%f,%f,%d,%f,%f\n",local_13c,&local_278,
                                &local_194,&local_200,local_274,local_190,local_1fc,local_270,
                                local_18c);
            if (iVar15 != 10) goto LAB_00590a70;
            ...
            *(uint *)((int)pvVar30 + 0x14) = local_13c[0];
            ...
            pvVar17 = pvVar30;
            do {
              *(uint *)((int)pvVar17 + 0x18) = *(uint *)(local_274 + iVar15 + -4);
              local_18 = (int)ROUND(ROUND((double)*(float *)(local_190 + iVar15 + -4) * dVar7));
              *(int *)((int)pvVar17 + 0x1c) = local_18;
              local_18 = (int)ROUND(ROUND((double)*(float *)(local_1fc + iVar15 + -4) * dVar7));
              iVar15 = iVar15 + 4;
        ...
        if (0 < (int)local_168) {
          ...
          do {
            pCVar25 = &local_188->min + iVar25;
            iVar15 = _fscanf(local_ec,"%f,%f,%f\n");
            if (iVar15 != 3) goto LAB_00590a70;
            _fprintf(local_180,"\t%4d: %7.3f %7.3f %7.3f\n",iVar25,(double)pCVar25->x,
                       (double)pCVar25->y,(double)pCVar25->z);
            iVar25 = iVar25 + 1;
            local_8c = local_8c + 3;
          } while (iVar25 < (int)local_168);
        }
              ...
              do {
                if ((*(int *)((int)local_88 + 4) == 3) &&
                  ...
                  do {
                    ...
                    pvVar30 = local_84;
                    do {
                      pCVar23 = &local_188->min + *(int *)((int)pvVar30 + 0x18);
                      local_29c = pCVar23->x;
                      local_298 = pCVar23->y;
                      local_18 = 3;
                      local_294 = pCVar23->z;
                      pCVar23 = &local_188->min +
                                *(int *)((iVar25 % 3) * 0xc + 0x18 + (int)local_88);
                      local_1f4 = pCVar23->x;
                      local_1f0 = pCVar23->y;
...
LAB_005902c8:
        ...
        pCVar23 = &pSVar5->position;
        if (&local_324 != (CBoundingBox3D *)pCVar23) {
          local_324.min.x = pCVar23->x;
          local_324.min.y = (pSVar5->position).y;
          local_324.min.z = (pSVar5->position).z;
        }
        if (&local_324.max != pCVar23) {
          local_324.max.x = pCVar23->x;
        ...
        if (1 < this_ptr->vertex_count[0]) {
          ...
          do {
            core_box_cpp_CBoundingBox3D_expand_FUN_00420240
                      (&local_324,
                       (CVector3f *)((int)this_ptr->vertex_data_ptr[0]->bone_weights + iVar15 + 0xc)
                      );
            iVar25 = iVar25 + 1;
            iVar15 = iVar15 + 0x34;
          } while (iVar25 < this_ptr->vertex_count[0]);
        }
        ...
        _fprintf(local_180,"Scale = %7.3f %7.3f %7.3f\n",(double)local_1dc,(double)local_1d8,
                   (double)local_1d4);
        pfVar16 = (float *)shape_memdbg_cpp_debugAlloc_FUN_0050f1f0
        ...
        if (0 < (int)local_16c) {
          do {
            if (*(int *)((int)pvVar30 + 4) == 3) {
              ...
              pCVar23 = &local_188->min + *(int *)((int)pvVar30 + 0x24);
              local_2b4 = pCVar23->x - pCVar26->x;
              local_2b0 = pCVar23->y - pCVar26->y;
              local_2ac = pCVar23->z - pCVar26->z;
              pCVar27 = &local_188->min + *(int *)((int)pvVar30 + 0x30);
              local_254 = pCVar27->x - pCVar23->x;
              local_250 = pCVar27->y - pCVar23->y;
              local_24c = pCVar27->z - pCVar23->z;
        ...
        if (0 < this_ptr->tri_count[0]) {
          ...
          } while (iVar25 < this_ptr->tri_count[0]);
        }
        ...
        if (this_ptr->tri_count[0] <= (int)local_16c) {
          ...
          if (0 < this_ptr->num_parts) {
            ...
            do {
              pvVar30 = local_15c;
              for (iVar21 = 0; iVar21 < *(int *)((int)this_ptr->parts[0].tri_counts + iVar15);
                  iVar21 = iVar21 + 1) {
                *(uint *)((int)pvVar30 + 0xc) = 0xffffffff;
                *(int *)((int)pvVar30 + 8) = iVar25;
                pvVar30 = (void *)((int)pvVar30 + 0x3c);
              }
              local_15c = (void *)((int)local_15c +
                                  *(int *)((int)this_ptr->parts[0].tri_counts + iVar15) * 0x3c);
              iVar15 = iVar15 + 0x60;
              iVar25 = iVar25 + 1;
            } while (iVar25 < this_ptr->num_parts);
          }
          ...
          if (0 < this_ptr->tri_count[0]) {
            do {
              ...
              while (-1 < local_124) {
                ...
                pfVar16 = (float *)(local_124 * 4 + (int)local_174);
                *pfVar16 = 1e+30;
                local_11c = -1;
                local_118 = 0;
                if (0 < (int)local_16c) {
                    ...
                    if (*(int *)((int)local_7c + 4) == 3) {
                      ...
                      do {
                        ...
                        do {
                          ...
                          local_28c = pCVar23->y;
                          local_288 = pCVar23->z;
                          uVar5 = (&(local_120->vertex_indices).vertex_index_0)[iVar25 % 3];
                          pSVar8 = this_ptr->vertex_data_ptr[0];
                        ...
                        if (((2 < iVar15) &&
                            (local_104 = local_104 * local_110, local_104 <= *pfVar16)) &&
                ...
                iVar25 = *(int *)((int)local_184 + local_11c * 0x3c + 0xc);
          ...
          if (0 < (int)local_16c) {
            do {
              if (*(int *)((int)pvVar30 + 4) == 3) {
                iVar15 = *(int *)((int)pvVar30 + 8);
                iVar19 = *(int *)((int)pvVar30 + 0xc);
                if (iVar19 < 0) {
                  local_158 = local_158 + 1;
                  this_ptr->parts[iVar15].cap_tri_counts[0] =
                       this_ptr->parts[iVar15].cap_tri_counts[0] + 1;
                }
                else {
                  local_f4 = iVar19 * 4;
                  if (-1 < (int)local_170[iVar19]) {
                    pcVar33 = "Unable to generate one-to-one polygon matching from %s";
                    goto LAB_0058f8da;
                  }
                  local_f0[iVar19] = iVar15;
                  local_170[iVar19] = iVar25;
                  local_154 = local_154 + 1;
                  this_ptr->parts[iVar15].tri_counts[0] = this_ptr->parts[iVar15].tri_counts[0] + 1;
                }
              }
              iVar25 = iVar25 + 1;
              pvVar30 = (void *)((int)pvVar30 + 0x3c);
          ...
          local_170 = (uint *)0x0;
          while (piVar24 = local_f0, local_30 = local_30 + -1, local_f0 = piVar24, -1 < local_30) {
            iVar25 = 0;
            if (0 < local_30) {
              local_74 = 0;
              local_70 = 0x12;
              do {
                if (piVar24[1] < *piVar24) {
                  local_18 = iVar25 * 4 + 4;
                  piVar27 = this_ptr->index_data_ptr[0] + iVar25 + 1;
                  piVar17 = this_ptr->index_data_ptr[0] + iVar25;
                  iVar15 = *piVar17;
                  *piVar17 = *piVar27;
                  *piVar27 = iVar15;
                  puVar20 = (uint *)
                  ...
                  puVar18 = (uint *)
                            ...
                            local_74);
                  local_2e0 = *puVar18;
                  auStack_2dc[(uint)bVar34 * -4] = *(ushort *)(puVar18 + (uint)bVar34 * -2 + 1);
                  auStack_2dc[1] = (ushort)*(uint *)((int)puVar18 + 6);
                  auStack_2dc[2] = (ushort)((uint)*(uint *)((int)puVar18 + 6) >> 0x10);
                  auStack_2dc[(uint)bVar34 * -4 + 3] =
                       *(ushort *)((int)puVar18 + (uint)bVar34 * -8 + 10);
                  local_2d4 = puVar18[3];
                  auStack_2d0[(uint)bVar34 * -4] = *(ushort *)(puVar18 + (uint)bVar34 * -2 + 4);
                  *puVar18 = *puVar20;
                  puVar18[1] = puVar20[1];
                  puVar18[2] = puVar20[2];
                  puVar29 = (uint *)puVar20[3];
                  puVar18[3] = puVar29;
                  *(ushort *)(puVar18 + 4) = *(ushort *)(puVar20 + 4);
                  *puVar29 = local_2e0;
                  puVar29[1] = CONCAT22(auStack_2dc[1],auStack_2dc[0]);
                  puVar29[2] = CONCAT22(auStack_2dc[3],auStack_2dc[2]);
                  puVar29[3] = local_2d4;
                  *(ushort *)(puVar29 + 4) = auStack_2d0[0];
                  iVar15 = *piVar24;
                  *piVar24 = *(int *)((int)local_f0 + local_18);
                  *(int *)((int)local_f0 + local_18) = iVar15;
                }
                iVar25 = iVar25 + 1;
                piVar24 = piVar24 + 1;
          ...
          if (local_154 != this_ptr->tri_count[0]) {
            ...
            do {
              ...
              if (*(int *)(filename + 0x308) == 0) {
                ...
                do {
                  iVar25 = shape_edittool_cpp_CPickList_displayChoicesAndWaitForInput_FUN_004a3e20
                                     (&local_bec,local_540,iVar25,0);
                } while (iVar25 < 0);
              ...
              if (iVar25 == 0) {
                ...
                if (0 < this_ptr->tri_count[0]) {
                  ...
                  do {
                    ...
                    local_d4 = 0;
                    local_34 = iVar15;
                    if (iVar15 < this_ptr->tri_count[0]) {
                      local_5c = local_f0 + iVar15;
                      local_60 = local_44;
                      do {
                        if (0xf423e < *local_5c) {
...
LAB_00591f48:
                                ...
                                local_bc = psVar16;
                                if (1 < iVar25) {
                                  iVar25 = local_f0[local_c4];
                                  this_ptr->parts[iVar25].tri_counts[0] =
                                       this_ptr->parts[iVar25].tri_counts[0] + 1;
                                  local_154 = local_154 + 1;
                ...
                local_d0 = iVar15;
                while (piVar24 = local_f0, local_38 = local_38 + -1, local_f0 = piVar24,
                      -1 < local_38) {
                  iVar25 = 0;
                  if (0 < local_38) {
                    local_58 = 0;
                    ...
                    do {
                      if (piVar24[1] < *piVar24) {
                        local_18 = iVar25 * 4 + 4;
                        piVar31 = this_ptr->index_data_ptr[0] + iVar25 + 1;
                        piVar17 = this_ptr->index_data_ptr[0] + iVar25;
                        iVar15 = *piVar17;
                        *piVar17 = *piVar31;
                        *piVar31 = iVar15;
                        ...
                        puVar18 = (uint *)
                                  ...
                                  + local_58);
                        uVar1 = *puVar18;
                        auStack_2f0[(uint)bVar34 * -4] =
                             *(ushort *)(puVar18 + (uint)bVar34 * -2 + 1);
                        auStack_2f0[1] = (ushort)*(uint *)((int)puVar18 + 6);
                        auStack_2f0[2] =
                             (ushort)((uint)*(uint *)((int)puVar18 + 6) >> 0x10);
                        auStack_2f0[(uint)bVar34 * -4 + 3] =
                             *(ushort *)((int)puVar18 + (uint)bVar34 * -8 + 10);
                        local_2e8 = puVar18[3];
                        auStack_2e4[(uint)bVar34 * -4] =
                             *(ushort *)(puVar18 + (uint)bVar34 * -2 + 4);
                        *puVar18 = *puVar20;
                        puVar18[1] = puVar20[1];
                        puVar18[2] = puVar20[2];
                        puVar29 = (uint *)puVar20[3];
                        ...
                        *(ushort *)(puVar18 + 4) = *(ushort *)(puVar20 + 4);
                        *puVar29 = uVar1;
                        puVar29[1] = CONCAT22(auStack_2f0[1],auStack_2f0[0]);
                        puVar29[2] = CONCAT22(auStack_2f0[3],auStack_2f0[2]);
                        puVar29[3] = local_2e8;
                        *(ushort *)(puVar29 + 4) = auStack_2e4[0];
                        iVar15 = *piVar24;
                        *piVar24 = *(int *)((int)local_f0 + local_18);
                        *(int *)((int)local_f0 + local_18) = iVar15;
                      }
          ...
          pSVar32 = local_150;
          uVar21 = this_ptr->tri_count[0] * 0x12;
          ...
          for (uVar18 = uVar21 >> 2; uVar18 != 0; uVar18 = uVar18 - 1) {
            ...
            pSVar29 = (SInputFace *)((int)pSVar29 + (uint)bVar34 * -8 + 4);
            pSVar34 = (SInputFace *)((int)pSVar34 + (uint)bVar34 * -8 + 4);
          }
          for (uVar19 = uVar21 & 3; uVar19 != 0; uVar19 = uVar19 - 1) {
            pSVar34 = (SInputFace *)((int)pSVar34 + (uint)bVar34 * -2 + 1);
            pSVar29 = (SInputFace *)((int)pSVar29 + (uint)bVar34 * -2 + 1);
          ...
          this_ptr->tri_data_ptr[0] = pSVar32;
          piVar24 = this_ptr->index_data_ptr[0];
          piVar35 = local_14c;
          for (uVar21 = this_ptr->tri_count[0] & 0x3fffffff; uVar21 != 0; uVar21 = uVar21 - 1) {
            *piVar35 = *piVar24;
            piVar24 = piVar24 + (uint)bVar34 * -2 + 1;
            piVar35 = piVar35 + (uint)bVar34 * -2 + 1;
          }
          for (iVar25 = 0; iVar25 != 0; iVar25 = iVar25 + -1) {
            piVar35 = (int *)((int)piVar35 + (uint)bVar34 * -2 + 1);
            *(char *)piVar35 = (char)*piVar24;
            piVar24 = (int *)((int)piVar24 + (uint)bVar34 * -2 + 1);
            piVar35 = piVar35;
          }
          g_CurrentDebugFilename = "..\\core\\skeledit.cpp";
              ...
              if ((0 < local_48->parts[0].cap_tri_counts[0]) && (local_b8 = 0, 0 < (int)local_16c))
              {
                ...
                do {
                  ...
                  if (((*(int *)((int)local_4c + 4) == 3) &&
                    ...
                    iVar25 = this_ptr->tri_count[0] + this_ptr->cap_tri_count[0];
                    local_b0 = this_ptr->tri_data_ptr[0] + iVar25;
                    if (local_160 < 0) {
                      iVar25 = *(int *)((int)local_4c + 0x14);
                      if (iVar25 < 0) goto LAB_00591835;
                      iVar15 = 0;
                      if (0 < this_ptr->num_textures) {
                        pcVar33 = local_a8->textures[0].textures[0].texture_name;
                        do {
                          splitpath
                                    (pcVar33,(char *)0x0,(char *)0x0,local_740,(char *)0x0);
                          iVar19 = _stricmp
                                             (local_a1ec + iVar25 * 0x100,local_740);
                          if (iVar19 == 0) break;
                          iVar15 = iVar15 + 1;
                          pcVar33 = pcVar33 + 0x48;
                        } while (iVar15 < this_ptr->num_textures);
                      }
                      if (this_ptr->num_textures <= iVar15) {
                        if (0x4f < this_ptr->num_textures) {
                          g_CurrentFilename = "..\\core\\skeledit.cpp";
                      ...
                      [this_ptr->tri_count[0] + this_ptr->cap_tri_count[0]] = iVar15;
                    }
                    else {
                      this_ptr->index_data_ptr[0][iVar25] = local_160;
                    }
                    local_20 = 0;
                    pSVar32 = local_b0;
                    pvVar37 = local_b4;
                    do {
                      pCVar23 = &local_188->min + *(int *)((int)pvVar37 + 0x18);
                      local_1c4 = pCVar23->x;
                      local_1c0 = pCVar23->y;
                      local_1bc = pCVar23->z;
                      local_a1f0 = 1e+20;
                      ...
                      if (0 < this_ptr->vertex_count[0]) {
                        ...
                        do {
                          pSVar8 = this_ptr->vertex_data_ptr[0];
                          local_218 = *(float *)((int)pSVar8->bone_weights + iVar15 + 0xc) -
                                      local_1c4;
                          local_214 = *(float *)((int)pSVar8->bone_weights + iVar15 + 0x10) -
                                      local_1c0;
                          local_210 = *(float *)((int)pSVar8->bone_weights + iVar15 + 0x14) -
                                      local_1bc;
                          local_a0 = local_210 * local_210 +
                                     local_218 * local_218 + local_214 * local_214;
                          if (local_a0 < local_a1f0) {
                            (pSVar32->vertex_indices).vertex_index_0 = (ushort)iVar25;
                            local_a1f0 = local_a0;
                          }
                          iVar25 = iVar25 + 1;
                          iVar15 = iVar15 + 0x34;
                      ...
                      iVar25 = *(int *)((int)pvVar37 + 0x1c) >> 8;
                      iVar15 = *(int *)((int)pvVar37 + 0x20) >> 8;
                      if (iVar25 < 0) {
                        iVar25 = 0;
                      }
                      else if (0xffff < iVar25) {
                        iVar25 = 0xffff;
                      }
                      if (iVar15 < 0) {
                        iVar15 = 0;
                      ...
                      pSVar32->v_coord_0 = (ushort)iVar15;
                      local_20 = local_20 + 1;
                      pSVar32->u_coord_0 = (ushort)iVar25;
                      pSVar32 = (SInputFace *)&(pSVar32->vertex_indices).vertex_index_1;
                    } while (local_20 < 3);
                    local_ac = -1;
                    local_24 = 0;
                    local_1c = 1e+20;
                        ...
                        if (((*(int *)((int)local_50 + 4) == 3) &&
                          ...
                          do {
                            ...
                            do {
                              ...
                              local_240 = pCVar23->z;
                              pCVar23 = &local_188->min +
                                        *(int *)((int)local_50 + (iVar25 % 3) * 0xc + 0x18);
                              local_1ac = pCVar23->x;
                              local_1a8 = pCVar23->y;
...
LAB_00591835:
          ...
          if (0 < this_ptr->num_parts) {
            do {
              pCVar22->parts[0].adj_part_count = 0;
              iVar25 = iVar25 + 1;
              pCVar22 = (CDeformableModel *)(pCVar22->tri_count + 3);
            } while (iVar25 < this_ptr->num_parts);
          }
      ...
      pcVar33 = "Too many parts in %s";
    }
    else {
LAB_00590a70:
      pcVar33 = "%s is corrupt";
    }
  }
LAB_0058f8da:
  _sprintf(g_SkeleditStatusMessage,pcVar33);
LAB_0058f8e7:
  if (local_ec != (_FILE *)0x0) {
