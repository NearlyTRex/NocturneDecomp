...

{
  ...
  if (local_ec == (_FILE *)0x0) {
    ...
    iVar16 = _fscanf(local_ec,"%d,%d,%d,%d,%d,%d,%d\n",&local_e4,&local_16c,&local_168,&local_e0,
                        local_164,local_dc);
    ...
    if (iVar16 == 7) {
      if (local_e0 < 0x1f) {
        ...
        if (0 < in_stack_00000004[0x1c50]) {
          ...
          local_94 = local_478;
          local_90 = local_400;
          piVar29 = in_stack_00000004 + 0x1c59;
          do {
            local_140 = local_148 + iVar16 * 0x18;
            local_144 = iVar16 * 4;
            iVar6 = _fscanf(local_ec,"%d,%d,%*d,%d,\"%[^\"]\"\n",local_94,local_90,piVar29);
            if (iVar6 != 4) goto LAB_00590a70;
            in_stack_00000004[iVar16 * 0x18 + 0x1c63] = 0;
            ...
            local_94 = local_94 + 4;
            local_90 = local_90 + 1;
          } while (iVar16 < in_stack_00000004[0x1c50]);
        }
        shape_edittool_cpp_CEditorTools_displayCenteredStatusMessage_FUN_0049e790
        ...
        if (0 < local_e4) {
          pcVar17 = local_a1ec;
          do {
            iVar6 = _fscanf(local_ec,"%[^\n]\n");
            if (iVar6 != 1) goto LAB_00590a70;
            splitpath
                      (local_844,(char *)0x0,(char *)0x0,pcVar17,(char *)0x0);
            iVar16 = iVar16 + 1;
        ...
        for (iVar16 = 0x19; iVar16 != 0; iVar16 = iVar16 + -1) {
          *(uint *)pcVar25 = *(uint *)pcVar17;
          pcVar17 = pcVar17 + ((uint)bVar30 * -2 + 1) * 4;
          pcVar25 = pcVar25 + ((uint)bVar30 * -2 + 1) * 4;
        }
        ...
        if (local_388[0] != '\0') {
          ...
          if (0 < in_stack_00000004[0x2f]) {
            piVar29 = in_stack_00000004 + 0x32;
            do {
              splitpath
                        ((char *)piVar29,(char *)0x0,(char *)0x0,local_640,(char *)0x0);
              iVar6 = stricmp(local_388,local_640);
              if (iVar6 == 0) break;
              iVar16 = iVar16 + 1;
              piVar29 = piVar29 + 0x12;
            } while (iVar16 < in_stack_00000004[0x2f]);
          }
        ...
        if (0 < (int)local_16c) {
          do {
            iVar6 = _fscanf(local_ec,"%d,%d,%f,%f,%d,%f,%f,%d,%f,%f\n",local_13c,&local_278,
                               &local_194,local_200,local_274,local_190,local_1fc,local_270,
                               local_18c);
            if (iVar6 != 10) goto LAB_00590a70;
            *(uint *)((int)pvVar11 + 4) = 3;
            iVar6 = 0;
            *(uint *)((int)pvVar11 + 0x14) = local_13c[0];
            dVar5 = 65536;
            pvVar13 = pvVar11;
            do {
              *(uint *)((int)pvVar13 + 0x18) = *(uint *)(local_274 + iVar6 + -4);
              dVar31 = round
                                 ((double)*(float *)(local_190 + iVar6 + -4) * dVar5);
              local_1c = (float)(int)ROUND(dVar31);
              *(int *)((int)pvVar13 + 0x1c) = (int)ROUND(dVar31);
              dVar31 = round
                                 ((double)*(float *)(local_200 + iVar6 + -4) * dVar5);
              local_20 = (int)ROUND(dVar31);
              iVar6 = iVar6 + 4;
              *(int *)((int)pvVar13 + 0x20) = (int)ROUND(dVar31);
              pvVar13 = (void *)((int)pvVar13 + 0xc);
            } while (iVar6 != 0xc);
            _fprintf(local_188,"\t%4d: %4d %4d %4d\n");
            iVar16 = iVar16 + 1;
            pvVar11 = (void *)((int)pvVar11 + 0x3c);
          } while (iVar16 < (int)local_174);
        }
        p_Var7 = shape_memdbg_cpp_debugAlloc_FUN_0050f1f0
                           ((int)local_168 * 0xc + 4,"..\\core\\skeledit.cpp",0xc7c);
        local_188 = p_Var7;
        if (p_Var7 != (_FILE *)0x0) {
          local_188 = (_FILE *)&p_Var7->_cnt;
          p_Var7->_ptr = local_168;
        }
        ...
        if (0 < (int)local_168) {
          ...
          do {
            ppcVar20 = &local_188->_ptr + iVar16 * 3;
            iVar6 = _fscanf(local_ec,"%f,%f,%f\n");
            if (iVar6 != 3) goto LAB_00590a70;
            _fprintf(local_180,"\t%4d: %7.3f %7.3f %7.3f\n",iVar16,(double)(float)*ppcVar20,
                       (double)(float)ppcVar20[1],(double)(float)ppcVar20[2]);
            iVar16 = iVar16 + 1;
            local_8c = local_8c + 3;
          } while (iVar16 < (int)local_168);
        }
              ...
              do {
                if ((*(int *)((int)local_88 + 4) == 3) &&
                  ...
                  do {
                    ...
                    pvVar11 = local_84;
                    do {
                      ppcVar20 = &local_188->_ptr + *(int *)((int)pvVar11 + 0x18) * 3;
                      local_29c = *ppcVar20;
                      local_298 = (float)ppcVar20[1];
                      local_18 = 3;
                      local_294 = (streambuf *)ppcVar20[2];
                      ppcVar20 = &local_188->_ptr +
                                 *(int *)((iVar16 % 3) * 0xc + 0x18 + (int)local_88) * 3;
                      local_1f4 = *ppcVar20;
                      local_1f0 = (float)ppcVar20[1];
                      local_224 = (float)local_29c - (float)local_1f4;
                      local_1ec = (streambuf *)ppcVar20[2];
...
LAB_005902c8:
        ...
        if (1 < (int)local_168) {
          do {
            core_box_cpp_CBoundingBox3D_expand_FUN_00420240
                      ((CBoundingBox3D *)local_30c,(CVector3f *)&p_Var7->_flag);
            iVar16 = iVar16 + 1;
            p_Var7 = (_FILE *)&p_Var7->_flag;
          } while (iVar16 < (int)local_168);
        }
        iVar16 = in_stack_00000004[0x10];
        pCVar1 = (CBoundingBox3D *)(iVar16 + 0x10);
        if (&local_324 != pCVar1) {
          local_324.min.x = (pCVar1->min).x;
          local_324.min.y = *(float *)(iVar16 + 0x14);
          local_324.min.z = *(float *)(iVar16 + 0x18);
        }
        if ((CBoundingBox3D *)&local_324.max != pCVar1) {
          local_324.max.x = (pCVar1->min).x;
          local_324.max.y = *(float *)(iVar16 + 0x14);
          local_324.max.z = *(float *)(iVar16 + 0x18);
        }
        iVar16 = 1;
        if (1 < in_stack_00000004[0xb]) {
          ...
          do {
            core_box_cpp_CBoundingBox3D_expand_FUN_00420240
                      (&local_324,(CVector3f *)(in_stack_00000004[0x10] + iVar6 + 0x10));
            iVar16 = iVar16 + 1;
            iVar6 = iVar6 + 0x34;
        ...
        if (0 < (int)local_168) {
          do {
            p_Var7->_ptr = (char *)(((float)p_Var7->_ptr - (float)local_30c._0_4_) * local_1dc +
                                   local_324.min.x);
            p_Var7->_cnt = (int)(((float)p_Var7->_cnt - (float)local_30c._4_4_) * local_1d8 +
                                local_324.min.y);
            iVar16 = iVar16 + 1;
            p_Var7->_link =
                 (streambuf *)
                 (((float)p_Var7->_link - (float)local_30c._8_4_) * local_1d4 + local_324.min.z);
            p_Var7 = (_FILE *)&p_Var7->_flag;
          } while (iVar16 < (int)local_168);
        }
        local_284 = local_2a8;
        ...
        _fprintf(local_180,"Scale = %7.3f %7.3f %7.3f\n",(double)local_1dc,(double)local_1d8,
                   (double)local_1d4);
        pfVar8 = shape_memdbg_cpp_debugAlloc_FUN_0050f1f0
        ...
        fVar3 = (float)in_stack_00000004[0x15];
        pfVar8 = shape_memdbg_cpp_debugAlloc_FUN_0050f1f0
                           ((int)fVar3 * 0xc + 4,"..\\core\\skeledit.cpp",0xd10);
        local_178 = pfVar8;
        if (pfVar8 != (float *)0x0) {
          local_178 = pfVar8 + 1;
          *pfVar8 = fVar3;
        ...
        if (0 < (int)local_16c) {
          do {
            if (*(int *)((int)pvVar11 + 4) == 3) {
              ppcVar22 = &local_188->_ptr + *(int *)((int)pvVar11 + 0x18) * 3;
              ppcVar20 = &local_188->_ptr + *(int *)((int)pvVar11 + 0x24) * 3;
              local_2b4 = (float)*ppcVar20 - (float)*ppcVar22;
              local_2b0 = (float)ppcVar20[1] - (float)ppcVar22[1];
              local_2ac = (float)ppcVar20[2] - (float)ppcVar22[2];
              ppcVar22 = &local_188->_ptr + *(int *)((int)pvVar11 + 0x30) * 3;
              local_254 = (float)*ppcVar22 - (float)*ppcVar20;
              local_250 = (float)ppcVar22[1] - (float)ppcVar20[1];
              local_24c = (float)ppcVar22[2] - (float)ppcVar20[2];
              ...
              fVar3 = SQRT(local_198 * local_198 + local_1a0 * local_1a0 + local_19c * local_19c);
              if (fVar3 <= 0.0) {
                local_19c = 0.0;
                local_1a0 = 0.0;
                local_198 = 0.0;
                ...
                local_19c = local_19c * fVar3;
                local_198 = local_198 * fVar3;
              }
              if (pfVar8 != &local_1a0) {
                *pfVar8 = local_1a0;
                pfVar8[1] = local_19c;
        ...
        if (0 < in_stack_00000004[0x15]) {
          ...
          pfVar8 = local_178;
          do {
            puVar18 = (ushort *)(in_stack_00000004[0x1f] + local_80);
            iVar9 = (uint)puVar18[1] * 0x34;
            iVar21 = (uint)*puVar18 * 0x34;
            iVar6 = in_stack_00000004[0x10];
            iVar19 = (uint)puVar18[2] * 0x34;
            local_2cc = *(float *)(iVar6 + 0x10 + iVar9) - *(float *)(iVar6 + 0x10 + iVar21);
            local_2c8 = *(float *)(iVar6 + 0x14 + iVar9) - *(float *)(iVar6 + 0x14 + iVar21);
            local_2c4 = *(float *)(iVar6 + 0x18 + iVar9) - *(float *)(iVar6 + 0x18 + iVar21);
            local_260 = *(float *)(iVar6 + 0x10 + iVar19) - *(float *)(iVar6 + 0x10 + iVar9);
            local_25c = *(float *)(iVar6 + 0x14 + iVar19) - *(float *)(iVar6 + 0x14 + iVar9);
            local_258 = *(float *)(iVar6 + 0x18 + iVar19) - *(float *)(iVar6 + 0x18 + iVar9);
            ...
            fVar3 = SQRT(local_234 * local_234 + local_23c * local_23c + local_238 * local_238);
            if (fVar3 <= 0.0) {
              local_238 = 0.0;
              local_23c = 0.0;
              local_234 = 0.0;
              ...
              fVar3 = 1.0 / fVar3;
              local_23c = local_23c * fVar3;
              local_238 = local_238 * fVar3;
              local_234 = local_234 * fVar3;
            }
            if (pfVar8 != &local_23c) {
              *pfVar8 = local_23c;
              pfVar8[1] = local_238;
          ...
          } while (iVar16 < in_stack_00000004[0x15]);
        }
        ...
        if (in_stack_00000004[0x15] <= (int)local_16c) {
          ...
          if (0 < in_stack_00000004[0x1c50]) {
            ...
            do {
              pvVar11 = local_15c;
              for (iVar9 = 0; iVar9 < *(int *)((int)in_stack_00000004 + iVar6 + 0x7164);
                  iVar9 = iVar9 + 1) {
                *(uint *)((int)pvVar11 + 0xc) = 0xffffffff;
                *(int *)((int)pvVar11 + 8) = iVar16;
                pvVar11 = (void *)((int)pvVar11 + 0x3c);
              }
              local_15c = (void *)((int)local_15c +
                                  *(int *)((int)in_stack_00000004 + iVar6 + 0x7164) * 0x3c);
              iVar6 = iVar6 + 0x60;
              iVar16 = iVar16 + 1;
            } while (iVar16 < in_stack_00000004[0x1c50]);
          }
          ...
          if (0 < in_stack_00000004[0x15]) {
            do {
              ...
              while (-1 < local_124) {
                ...
                pfVar8 = (float *)(local_124 * 4 + (int)local_174);
                *pfVar8 = 1e+30;
                local_11c = -1;
                local_118 = 0;
                if (0 < (int)local_16c) {
                    ...
                    if (*(int *)((int)local_7c + 4) == 3) {
                      ...
                      do {
                        ...
                        do {
                          ppcVar20 = &local_188->_ptr + *(int *)((int)pvVar11 + 0x18) * 3;
                          local_290 = *ppcVar20;
                          local_28c = (float)ppcVar20[1];
                          local_288 = (streambuf *)ppcVar20[2];
                          iVar9 = in_stack_00000004[0x10] +
                                  (uint)*(ushort *)((iVar16 % 3) * 2 + local_120) * 0x34;
                          local_1d0 = *(float *)(iVar9 + 0x10);
                          local_1cc = *(float *)(iVar9 + 0x14);
                          local_20c = local_1d0 - (float)local_290;
                          local_1c8 = *(float *)(iVar9 + 0x18);
                          ...
                          fVar3 = local_204 * local_204 +
                                  local_20c * local_20c + local_208 * local_208;
                          iVar16 = iVar16 + 1;
                          pvVar11 = (void *)((int)pvVar11 + 0xc);
                          local_104 = fVar3 * fVar3 * fVar3 + local_104;
                          iVar6 = iVar6 + 1;
                        } while (iVar6 < 3);
                        if (((2 < iVar6) &&
                            (local_104 = local_104 * local_110, local_104 <= *pfVar8)) &&
                ...
                iVar16 = *(int *)((int)local_184 + local_11c * 0x3c + 0xc);
          ...
          if ((puVar10 == (uint *)0x0) || (local_f0 == (int *)0x0)) {
            g_CurrentFilename = "..\\core\\skeledit.cpp";
          ...
          if (0 < (int)local_16c) {
            do {
              if (*(int *)((int)pvVar11 + 4) == 3) {
                iVar6 = *(int *)((int)pvVar11 + 8);
                iVar9 = *(int *)((int)pvVar11 + 0xc);
                if (iVar9 < 0) {
                  local_158 = local_158 + 1;
                  in_stack_00000004[iVar6 * 0x18 + 0x1c5e] =
                       in_stack_00000004[iVar6 * 0x18 + 0x1c5e] + 1;
                }
                else {
                  local_f4 = iVar9 * 4;
                  if (-1 < (int)local_170[iVar9]) {
                    pcVar17 = "Unable to generate one-to-one polygon matching from %s";
                    goto LAB_0058f8da;
                  }
                  local_f0[iVar9] = iVar6;
                  local_170[iVar9] = iVar16;
                  local_154 = local_154 + 1;
                  in_stack_00000004[iVar6 * 0x18 + 0x1c59] =
                       in_stack_00000004[iVar6 * 0x18 + 0x1c59] + 1;
                }
              }
              iVar16 = iVar16 + 1;
              pvVar11 = (void *)((int)pvVar11 + 0x3c);
          ...
          local_170 = (uint *)0x0;
          piVar29 = local_f0;
          while (local_f0 = piVar29, -1 < local_30) {
            iVar16 = 0;
            if (0 < local_30) {
              local_74 = 0;
              local_70 = 0x12;
              do {
                if (piVar29[1] < *piVar29) {
                  local_18 = iVar16 * 4 + 4;
                  puVar23 = (uint *)(local_18 + in_stack_00000004[0x24]);
                  puVar10 = (uint *)(iVar16 * 4 + in_stack_00000004[0x24]);
                  uVar4 = *puVar10;
                  *puVar10 = *puVar23;
                  *puVar23 = uVar4;
                  puVar23 = (uint *)(local_70 + in_stack_00000004[0x1f]);
                  puVar10 = (uint *)(in_stack_00000004[0x1f] + local_74);
                  local_2e0 = *puVar10;
                  *(ushort *)(auStack_2dc + (uint)bVar30 * -8) =
                       *(ushort *)(puVar10 + (uint)bVar30 * -2 + 1);
                  stack0xfffffd26 = *(uint *)((int)puVar10 + 6);
                  *(ushort *)((int)&uStack_2d8 + (uint)bVar30 * -8 + 2) =
                       *(ushort *)((int)puVar10 + (uint)bVar30 * -8 + 10);
                  local_2d4 = puVar10[3];
                  auStack_2d0[(uint)bVar30 * -4] = *(ushort *)(puVar10 + (uint)bVar30 * -2 + 4);
                  puVar26 = puVar10 + (uint)bVar30 * -2 + 1;
                  puVar28 = puVar23 + (uint)bVar30 * -2 + 1;
                  *puVar10 = *puVar23;
                  puVar27 = puVar26 + (uint)bVar30 * -2 + 1;
                  puVar10 = puVar28 + (uint)bVar30 * -2 + 1;
                  *puVar26 = *puVar28;
                  *puVar27 = *puVar10;
                  puVar27[(uint)bVar30 * -2 + 1] = puVar10[(uint)bVar30 * -2 + 1];
                  *(ushort *)(puVar27 + (uint)bVar30 * -2 + 1 + (uint)bVar30 * -2 + 1) =
                       *(ushort *)(puVar10 + (uint)bVar30 * -2 + 1 + (uint)bVar30 * -2 + 1);
                  puVar28 = puVar23 + (uint)bVar30 * -2 + 1;
                  *puVar23 = local_2e0;
                  puVar23 = puVar28 + (uint)bVar30 * -2 + 1;
                  puVar10 = &uStack_2d8 + (uint)bVar30 * -2 + (uint)bVar30 * -2;
                  *puVar28 = *(uint *)(auStack_2dc + (uint)bVar30 * -8);
                  *puVar23 = *puVar10;
                  puVar23[(uint)bVar30 * -2 + 1] = puVar10[(uint)bVar30 * -2 + 1];
                  *(ushort *)(puVar23 + (uint)bVar30 * -2 + 1 + (uint)bVar30 * -2 + 1) =
                       *(ushort *)(puVar10 + (uint)bVar30 * -2 + 1 + (uint)bVar30 * -2 + 1);
                  iVar6 = *piVar29;
                  *piVar29 = *(int *)((int)local_f0 + local_18);
                  *(int *)((int)local_f0 + local_18) = iVar6;
                }
                iVar16 = iVar16 + 1;
                piVar29 = piVar29 + 1;
          ...
          if (local_154 != in_stack_00000004[0x15]) {
            ...
            do {
              ...
              if (iVar16 == 0) {
                ...
                piVar29 = local_d8 + in_stack_00000004[0x1c50] * 0x18;
                do {
                  cVar2 = *pcVar17;
                  *(char *)piVar29 = cVar2;
                  if (cVar2 == '\0') break;
                ...
                if (0 < in_stack_00000004[0x15]) {
                  ...
                  do {
                    ...
                    local_d4 = 0;
                    local_34 = iVar6;
                    if (iVar6 < in_stack_00000004[0x15]) {
                      local_5c = local_f0 + iVar6;
                      local_60 = local_44;
                      do {
                        if (0xf423e < *local_5c) {
                                ...
                                do {
                                  ...
                                  if (*psVar12 != *local_c0) {
                                    do {
                                      iVar9 = iVar9 + 1;
                                      psVar15 = psVar15 + 1;
                                      if (2 < iVar9) goto LAB_00591f48;
                                    } while (*psVar15 != *psVar12);
                                  }
                                  iVar16 = iVar16 + 1;
LAB_00591f48:
                                  psVar12 = psVar12 + 1;
                                } while (psVar12 != local_c8 + 3);
                                if (1 < iVar16) {
                                  iVar16 = local_f0[local_c4];
                                  in_stack_00000004[iVar16 * 0x18 + 0x1c59] =
                                       in_stack_00000004[iVar16 * 0x18 + 0x1c59] + 1;
                                  local_154 = local_154 + 1;
                ...
                piVar29 = local_f0;
                while (local_f0 = piVar29, -1 < local_38) {
                  iVar16 = 0;
                  if (0 < local_38) {
                    local_58 = 0;
                    local_54 = 0x12;
                    do {
                      if (piVar29[1] < *piVar29) {
                        local_18 = iVar16 * 4 + 4;
                        puVar23 = (uint *)(local_18 + in_stack_00000004[0x24]);
                        puVar10 = (uint *)(in_stack_00000004[0x24] + iVar16 * 4);
                        uVar4 = *puVar10;
                        *puVar10 = *puVar23;
                        *puVar23 = uVar4;
                        puVar23 = (uint *)(local_54 + in_stack_00000004[0x1f]);
                        puVar10 = (uint *)(in_stack_00000004[0x1f] + local_58);
                        local_2f4 = *puVar10;
                        *(ushort *)(auStack_2f0 + (uint)bVar30 * -8) =
                             *(ushort *)(puVar10 + (uint)bVar30 * -2 + 1);
                        stack0xfffffd12 = *(uint *)((int)puVar10 + 6);
                        *(ushort *)((int)&uStack_2ec + (uint)bVar30 * -8 + 2) =
                             *(ushort *)((int)puVar10 + (uint)bVar30 * -8 + 10);
                        local_2e8 = puVar10[3];
                        auStack_2e4[(uint)bVar30 * -4] =
                             *(ushort *)(puVar10 + (uint)bVar30 * -2 + 4);
                        puVar26 = puVar10 + (uint)bVar30 * -2 + 1;
                        puVar28 = puVar23 + (uint)bVar30 * -2 + 1;
                        *puVar10 = *puVar23;
                        puVar27 = puVar26 + (uint)bVar30 * -2 + 1;
                        ...
                        *(ushort *)(puVar27 + (uint)bVar30 * -2 + 1 + (uint)bVar30 * -2 + 1) =
                             *(ushort *)
                              (puVar10 + (uint)bVar30 * -2 + 1 + (uint)bVar30 * -2 + 1);
                        puVar28 = puVar23 + (uint)bVar30 * -2 + 1;
                        *puVar23 = local_2f4;
                        puVar23 = puVar28 + (uint)bVar30 * -2 + 1;
                        puVar10 = &uStack_2ec + (uint)bVar30 * -2 + (uint)bVar30 * -2;
                        *puVar28 = *(uint *)(auStack_2f0 + (uint)bVar30 * -8);
                        *puVar23 = *puVar10;
                        puVar23[(uint)bVar30 * -2 + 1] = puVar10[(uint)bVar30 * -2 + 1];
                        *(ushort *)(puVar23 + (uint)bVar30 * -2 + 1 + (uint)bVar30 * -2 + 1) =
                             *(ushort *)
          ...
          if ((puVar10 == (uint *)0x0) || (local_14c == (uint *)0x0)) {
            g_CurrentFilename = "..\\core\\skeledit.cpp";
            g_CurrentLineNumber = 0xf1c;
            core_main_c_displayErrorAndQuit_FUN_00506f10("out of memory in CDeformableModel::determinePartsFromS3D");
          }
          puVar10 = local_150;
          iVar16 = in_stack_00000004[0x15];
          puVar23 = (uint *)in_stack_00000004[0x1f];
          puVar28 = local_150;
          for (uVar14 = (uint)(iVar16 * 0x12) >> 2; uVar14 != 0; uVar14 = uVar14 - 1) {
            *puVar28 = *puVar23;
            puVar23 = puVar23 + (uint)bVar30 * -2 + 1;
            puVar28 = puVar28 + (uint)bVar30 * -2 + 1;
          }
          for (uVar14 = iVar16 * 0x12 & 3; uVar14 != 0; uVar14 = uVar14 - 1) {
            *(byte *)puVar28 = *(byte *)puVar23;
            puVar23 = (uint *)((int)puVar23 + (uint)bVar30 * -2 + 1);
            puVar28 = (uint *)((int)puVar28 + (uint)bVar30 * -2 + 1);
          }
          g_CurrentDebugFilename = "..\\core\\skeledit.cpp";
          g_CurrentDebugLine = 0xf1f;
          shape_memdbg_cpp_free_FUN_005fe659((void *)in_stack_00000004[0x1f]);
          in_stack_00000004[0x1f] = (int)puVar10;
          puVar10 = (uint *)in_stack_00000004[0x24];
          puVar23 = local_14c;
          for (uVar14 = in_stack_00000004[0x15] & 0x3fffffff; uVar14 != 0; uVar14 = uVar14 - 1) {
            *puVar23 = *puVar10;
            puVar10 = puVar10 + (uint)bVar30 * -2 + 1;
            puVar23 = puVar23 + (uint)bVar30 * -2 + 1;
          }
          for (iVar16 = 0; iVar16 != 0; iVar16 = iVar16 + -1) {
            *(byte *)puVar23 = *(byte *)puVar10;
            puVar10 = (uint *)((int)puVar10 + (uint)bVar30 * -2 + 1);
            puVar23 = (uint *)((int)puVar23 + (uint)bVar30 * -2 + 1);
          }
          g_CurrentDebugFilename = "..\\core\\skeledit.cpp";
          ...
          if (0 < local_158) {
            pvVar11 = shape_memdbg_cpp_debugAlloc_FUN_0050f1f0
                                (local_158 * 4,"..\\core\\skeledit.cpp",0xf2b);
            in_stack_00000004[0x29] = (int)pvVar11;
            if (pvVar11 == (void *)0x0) {
              g_CurrentFilename = "..\\core\\skeledit.cpp";
              ...
              if ((0 < local_48[0x1c5e]) && (local_b8 = 0, 0 < (int)local_16c)) {
                ...
                do {
                  ...
                  if (((*(int *)((int)local_4c + 4) == 3) &&
                    ...
                    if (local_160 < 0) {
                      iVar16 = *(int *)((int)local_4c + 0x14);
                      if (iVar16 < 0) goto LAB_00591835;
                      iVar6 = 0;
                      if (0 < in_stack_00000004[0x2f]) {
                        piVar29 = local_a8 + 2;
                        do {
                          splitpath
                                    ((char *)piVar29,(char *)0x0,(char *)0x0,local_740,(char *)0x0);
                          iVar9 = stricmp
                                            (local_a1ec + iVar16 * 0x100,local_740);
                          if (iVar9 == 0) break;
                          iVar6 = iVar6 + 1;
                          piVar29 = piVar29 + 0x12;
                        } while (iVar6 < in_stack_00000004[0x2f]);
                      }
                      if (in_stack_00000004[0x2f] <= iVar6) {
                        if (0x4f < in_stack_00000004[0x2f]) {
                          g_CurrentFilename = "..\\core\\skeledit.cpp";
                      ...
                      *(int *)(in_stack_00000004[0x24] +
                              (in_stack_00000004[0x15] + in_stack_00000004[0x1a]) * 4) = iVar6;
                    }
                    else {
                    ...
                    do {
                      ppcVar20 = &local_188->_ptr + *(int *)((int)pvVar11 + 0x18) * 3;
                      local_1c4 = *ppcVar20;
                      local_1c0 = (float)ppcVar20[1];
                      local_1bc = (streambuf *)ppcVar20[2];
                      local_a1f0 = 1e+20;
                      iVar16 = 0;
                      if (0 < in_stack_00000004[0xb]) {
                        ...
                        do {
                          iVar9 = in_stack_00000004[0x10];
                          local_218 = *(float *)(iVar6 + 0x10 + iVar9) - (float)local_1c4;
                          local_214 = *(float *)(iVar6 + 0x14 + iVar9) - local_1c0;
                          local_210 = *(float *)(iVar6 + 0x18 + iVar9) - (float)local_1bc;
                          local_a0 = local_210 * local_210 +
                                     local_218 * local_218 + local_214 * local_214;
                          if (local_a0 < local_a1f0) {
                            *puVar24 = (short)iVar16;
                            local_a1f0 = local_a0;
                          }
                          iVar16 = iVar16 + 1;
                          iVar6 = iVar6 + 0x34;
                      ...
                      iVar16 = *(int *)((int)pvVar11 + 0x1c) >> 8;
                      iVar6 = *(int *)((int)pvVar11 + 0x20) >> 8;
                      if (iVar16 < 0) {
                        iVar16 = 0;
                      }
                      ...
                      pvVar11 = (void *)((int)pvVar11 + 0xc);
                      puVar24[6] = (short)iVar6;
                      local_20 = local_20 + 1;
                      puVar24[3] = (short)iVar16;
                      puVar24 = puVar24 + 1;
                    } while (local_20 < 3);
                    local_ac = -1;
                    local_24 = 0;
...
LAB_00591835:
          ...
          if (local_180 != (_FILE *)0x0) {
            ...
            shape_memdbg_cpp_closeFile_FUN_0050f9b0(p_Var7,"..\\core\\skeledit.cpp",0xffc);
          }
          shape_edittool_cpp_CEditorTools_displayCenteredStatusMessage_FUN_0049e790
