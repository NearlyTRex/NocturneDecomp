...
// Chunk: branch_1_branch_0_check_0_0 (lines 341-373 of original)
static int CSkeleton_importSkeletonFile_branch_1_branch_0_check_0_0(CSkeleton_importSkeletonFile_Ctx *ctx) {
    _FILE *&file = ctx->file;
    int &iVar4 = ctx->iVar4;
    int &iVar5 = ctx->iVar5;
    SIZE_T &n = ctx->n;
    char *&pcVar13 = ctx->pcVar13;
    int &iVar15 = ctx->iVar15;
...
// Chunk: branch_1_branch_0_check_0_1 (lines 376-399 of original)
...
// Chunk: branch_1_branch_0_check_0_2_check_0_0_branch_0 (lines 485-656 of original)
...
// Chunk: branch_1_branch_0_check_0_2_check_0_0_else_1_branch_0 (lines 658-838 of original)
...
// Chunk: branch_1_branch_0_check_0_2_check_0_0_else_1_else_1_branch_0 (lines 840-881 of original)
...
// Chunk: branch_1_branch_0_check_0_2_check_0_0_else_1_else_1_else_1_branch_0 (lines 895-940 of original)
...
// Chunk: branch_1_branch_0_check_0_2_check_0_0_else_1_else_1_else_1_else_1_branch_0 (lines 943-1005 of original)
...
// Chunk: branch_1_branch_0_check_0_2_check_0_0_else_1_else_1_else_1_else_1_else_1_branch_0 (lines 1008-1070 of original)
...
// Chunk: branch_1_branch_0_check_0_2_check_0_0_else_1_else_1_else_1_else_1_else_1_else_1 (lines 1070-1254 of original)
...
// Chunk: branch_1_branch_0_check_0_2_chunk_1 (lines 1298-1444 of original)
static int CSkeleton_importSkeletonFile_branch_1_branch_0_check_0_2_chunk_1(CSkeleton_importSkeletonFile_Ctx *ctx) {
    CSkeleton *&this_ptr = ctx->this_ptr;
    int &iVar4 = ctx->iVar4;
    CVector3f *&pCVar9 = ctx->pCVar9;
    int &iVar15 = ctx->iVar15;
    float *&matrix_a = ctx->matrix_a;
    CQuaternion4f *&pCVar17 = ctx->pCVar17;
...
// Chunk: branch_1_branch_0_check_0_2_check_0_2 (lines 1449-1525 of original)
...
// Chunk: branch_1_check_iVar15_1 (lines 1663-1772 of original)
static int CSkeleton_importSkeletonFile_branch_1_check_iVar15_1(CSkeleton_importSkeletonFile_Ctx *ctx) {
    CSkeleton *&this_ptr = ctx->this_ptr;
    char *&filename = ctx->filename;
    char &cVar2 = ctx->cVar2;
    _FILE *&file = ctx->file;
    ...
    SMotion *&pSVar16 = ctx->pSVar16;
        ...
        if (iVar15 == 0) {
          ...
          if (((pcVar13 == (char *)0x0) ||
             ...
             && (iVar15 = shape_edittool_cpp_CEditorTools_showYesNoDialog1_FUN_0049f060
...
LAB_00595eb8:
    ...
    if (iVar15 != 0) {
      int _rc = CSkeleton_importSkeletonFile_branch_1_check_iVar15_1(ctx);
      if (_rc == GOTO_LAB_005927ee) goto LAB_005927ee;
