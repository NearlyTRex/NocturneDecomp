...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_skeledit.cpp_CDeformableModel_removeUnusedTextures_FUN_0058ec60(CDeformableModel * this_ptr)
;
; Parameters:
...
section .text
    ...
    CALL crt_stack.c_stack_probe_FUN_005ff9f3 ; 0058ec65 | uint crt_stack.c_stack_probe_FUN_005ff9f3(uint stack_size)
    ...
    JNZ 0x0058ecdf                      ; 0058ec7c | LAB_0058ecdf
    ...
    JLE 0x0058ed4a                      ; 0058ec8c | LAB_0058ed4a
    ...
    JLE 0x0058ed1c                      ; 0058ecb1 | LAB_0058ed1c
    ...
    JGE 0x0058ed07                      ; 0058eccc | LAB_0058ed07
        ;   XREF to: 0058ed07 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ECX + 0x90]      ; 0058ecce
    CMP ESI,dword ptr [EDX + EAX*0x1]   ; 0058ecd4
    JZ 0x0058ed23                       ; 0058ecd7 | LAB_0058ed23
        ;   XREF to: 0058ed23 (CONDITIONAL_JUMP)
    INC EBX                             ; 0058ecd9
    ADD EDX,0x4                         ; 0058ecda
    JMP 0x0058ecc4                      ; 0058ecdd | LAB_0058ecc4
        ;   XREF to: 0058ecc4 (UNCONDITIONAL_JUMP)
    MOV ECX,0x64b0ca                    ; 0058ecdf | = "..\\core\\skeledit.cpp" | s_core_skeledit_cpp_0064b0ca = ..\core\skeledit.cpp
        ;   Label: LAB_0058ecdf
    MOV EBX,0xa72                       ; 0058ece4
    PUSH 0x64b0df                       ; 0058ece9 | = "CDeformableModel::removeUnusedTexture..." | s_CDeformableModel_removeU_0064b0df = CDeformableModel::removeUnusedTextures() - textureSetCount must be 1.
    MOV dword ptr [0x02f0ca48],ECX      ; 0058ecee | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 0058ecf4 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0058ecfa | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0058ecff
    JMP 0x0058ec7e                      ; 0058ed02 | LAB_0058ec7e
    ...
    JL 0x0058eca2                       ; 0058ed44 | LAB_0058eca2
    ...
    PUSH EDX                            ; 0058ed74
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 0058ed75 | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
    ...
    JLE 0x0058ed3a                      ; 0058ed89 | LAB_0058ed3a
    ...
    JGE 0x0058edb3                      ; 0058ed9d | LAB_0058edb3
    ...
    JL 0x0058edcf                       ; 0058edab | LAB_0058edcf
        ;   XREF to: 0058edcf (CONDITIONAL_JUMP)
    INC ECX                             ; 0058edad
    ADD EBX,0x4                         ; 0058edae
    JMP 0x0058ed93                      ; 0058edb1 | LAB_0058ed93
    ...
    JGE 0x0058ed3a                      ; 0058edc7 | LAB_0058ed3a
        ;   XREF to: 0058ed3a (CONDITIONAL_JUMP)
    JMP 0x0058ed8d                      ; 0058edcd | LAB_0058ed8d
    ...
    JMP 0x0058ed93                      ; 0058edd6 | LAB_0058ed93
        ;   XREF to: 0058ed93 (UNCONDITIONAL_JUMP)
