...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_skeledit_cpp_CSkeleton_saveStream_FUN_0058b3a0(CSkeleton *this_ptr,FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    CALL crt_stack.c_stack_probe_FUN_005ff9f3 ; 0058b3a5
    ...
    PUSH EBP                            ; 0058b3be
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058b3bf
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ADD ESP,0x8                         ; 0058b3c4
    MOV EDX,dword ptr [0x00681860]      ; 0058b3c7 | g_CSkeletonVersion
    PUSH EDX                            ; 0058b3cd
    PUSH 0x64a66d                       ; 0058b3ce | = "%d\n"
    PUSH EBP                            ; 0058b3d3
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058b3d4
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ADD ESP,0xc                         ; 0058b3d9
    PUSH 0x64a671                       ; 0058b3dc | = "// bonecount, frameCount\n"
    PUSH EBP                            ; 0058b3e1
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058b3e2
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    PUSH EBP                            ; 0058b3fd
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058b3fe
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ADD ESP,0x10                        ; 0058b403
    PUSH 0x64a692                       ; 0058b406 | = "// boneList\n"
    PUSH EBP                            ; 0058b40b
    XOR ESI,ESI                         ; 0058b40c
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058b40e
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    MOV EAX,dword ptr [EDI + 0x28558]   ; 0058b413
    ADD ESP,0x8                         ; 0058b419
    TEST EAX,EAX                        ; 0058b41c
    JLE 0x0058b460                      ; 0058b41e
        ;   XREF to: 0058b460 (CONDITIONAL_JUMP)  ; LAB_0058b460
    ...
    PUSH EBP                            ; 0058b439
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058b43a
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    JL 0x0058b429                       ; 0058b457
        ;   XREF to: 0058b429 (CONDITIONAL_JUMP)  ; LAB_0058b429
    LEA EAX,[EAX]                       ; 0058b459
    NOP                                 ; 0058b45f
    PUSH 0x64a6a9                       ; 0058b460 | = "// angle list: w,x,y,z\n"
        ;   Label: LAB_0058b460
    PUSH EBP                            ; 0058b465
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058b466
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    JLE 0x0058b4e2                      ; 0058b482
        ;   XREF to: 0058b4e2 (CONDITIONAL_JUMP)  ; LAB_0058b4e2
    MOV EAX,dword ptr [EDI + 0x28558]   ; 0058b484
        ;   Label: LAB_0058b484
    XOR ESI,ESI                         ; 0058b48a
    TEST EAX,EAX                        ; 0058b48c
    JLE 0x0058b4cf                      ; 0058b48e
        ;   XREF to: 0058b4cf (CONDITIONAL_JUMP)  ; LAB_0058b4cf
    ...
    INC ESI                             ; 0058b4bc
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058b4bd
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    MOV EAX,dword ptr [EDI + 0x28558]   ; 0058b4c2
    ADD ESP,0x28                        ; 0058b4c8
    CMP ESI,EAX                         ; 0058b4cb
    JL 0x0058b490                       ; 0058b4cd
        ;   XREF to: 0058b490 (CONDITIONAL_JUMP)  ; LAB_0058b490
    ...
    JL 0x0058b484                       ; 0058b4e0
        ;   XREF to: 0058b484 (CONDITIONAL_JUMP)  ; LAB_0058b484
    PUSH 0x64a6ce                       ; 0058b4e2 | = "// root offset list: x,y,z\n"
        ;   Label: LAB_0058b4e2
    PUSH EBP                            ; 0058b4e7
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058b4e8
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    JLE 0x0058b550                      ; 0058b4fe
        ;   XREF to: 0058b550 (CONDITIONAL_JUMP)  ; LAB_0058b550
    ...
    PUSH EBP                            ; 0058b52a
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058b52b
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    JL 0x0058b502                       ; 0058b547
        ;   XREF to: 0058b502 (CONDITIONAL_JUMP)  ; LAB_0058b502
    ...
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058b558
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ADD ESP,0x8                         ; 0058b55d
    MOV ESI,dword ptr [EDI + 0x2936c]   ; 0058b560
    MOV dword ptr [ESP + 0xc],EBX       ; 0058b566
    TEST ESI,ESI                        ; 0058b56a
    JLE 0x0058b5c0                      ; 0058b56c
        ;   XREF to: 0058b5c0 (CONDITIONAL_JUMP)  ; LAB_0058b5c0
    ...
    PUSH EBP                            ; 0058b598
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058b599
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    ...
    JL 0x0058b570                       ; 0058b5b5
        ;   XREF to: 0058b570 (CONDITIONAL_JUMP)  ; LAB_0058b570
    LEA EAX,[EAX]                       ; 0058b5b7
    LEA EDX,[EDX]                       ; 0058b5bd
    PUSH EBP                            ; 0058b5c0
        ;   Label: LAB_0058b5c0
    PUSH EDI                            ; 0058b5c1
    CALL core_motion.cpp_CMotionList_save_FUN_0052d170 ; 0058b5c2
        ;   XREF to: 0052d170 (UNCONDITIONAL_CALL)  ; void core_motion.cpp_CMotionList_save_FUN_0052d170(CMotionList * this_ptr, FILE * file_handle)
    ADD ESP,0x8                         ; 0058b5c7
    PUSH 0x64a720                       ; 0058b5ca | = "// reference bone org list: x,y,z\n"
    PUSH EBP                            ; 0058b5cf
    XOR ESI,ESI                         ; 0058b5d0
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058b5d2
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    MOV ECX,dword ptr [EDI + 0x28558]   ; 0058b5d7
    ADD ESP,0x8                         ; 0058b5dd
    TEST ECX,ECX                        ; 0058b5e0
    JLE 0x0058b620                      ; 0058b5e2
        ;   XREF to: 0058b620 (CONDITIONAL_JUMP)  ; LAB_0058b620
    ...
    INC ESI                             ; 0058b60d
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 0058b60e
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
    MOV EAX,dword ptr [EDI + 0x28558]   ; 0058b613
    ADD ESP,0x20                        ; 0058b619
    CMP ESI,EAX                         ; 0058b61c
    JL 0x0058b5ea                       ; 0058b61e
        ;   XREF to: 0058b5ea (CONDITIONAL_JUMP)  ; LAB_0058b5ea
    TEST byte ptr [EBP + 0xc],0x20      ; 0058b620
        ;   Label: LAB_0058b620
    JNZ 0x0058b62e                      ; 0058b624
        ;   XREF to: 0058b62e (CONDITIONAL_JUMP)  ; LAB_0058b62e
    ...
    POP EBX                             ; 0058b62c
    RET                                 ; 0058b62d
    MOV EDX,0x64a74d                    ; 0058b62e | = "..\\core\\skeledit.cpp"
        ;   Label: LAB_0058b62e
    MOV ECX,0x49f                       ; 0058b633
    PUSH 0x64a762                       ; 0058b638 | = "CSkeleton::saveStream - error writing..."
    MOV dword ptr [0x02f0ca48],EDX      ; 0058b63d | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 0058b643 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0058b649
