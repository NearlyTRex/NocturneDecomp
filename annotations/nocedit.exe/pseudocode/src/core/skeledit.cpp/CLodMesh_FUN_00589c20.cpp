// Name: core_skeledit.cpp_CLodMesh_FUN_00589c20
// Address: 00589c20
// Address Range: [[00589c20, 00589f39]]
// Convention: __cdecl
// Signature: int __cdecl core_skeledit_cpp_CLodMesh_FUN_00589c20(CLodMesh *this_ptr)
...

{
  ...
  if (*(int *)(in_stack_00000008 + 0x308) != 1) {
    shape_meshlod_cpp_CLodMesh_previewLodGeneration_FUN_0051d520(this_ptr,0,in_stack_0000000c);
    ...
    if (iVar1 != 0) {
      ...
      if (iVar1 != 0) {
        if (iVar1 == 1) {
          ...
          shape_meshlod_cpp_CLodMesh_generateLOD_FUN_00516ba0(this_ptr,0,in_stack_0000000c);
