...
;
; Parameters:
; char *           Stack[0x4]:4   token
; int *            Stack[0x8]:4   out_index
; int              Stack[0xc]:4   bone_count
; int              Stack[0x10]:4   allow_patch
;
; XREF[1]:
;   core_skeledit.cpp_CSkeleton_importSkeletonFile_FUN_00592690 at 0059371b
;
; Referenced Globals:
...
section .text
    ...
    NOP                                 ; 00592520
        ;   Label: core_skeledit.cpp_parseBoneParentToken_FUN_00592520
    NOP                                 ; 00592521
    NOP                                 ; 00592522
    NOP                                 ; 00592523
    NOP                                 ; 00592524
    ...
    PUSH ESI                            ; 00592539
    CALL crt_string.c__strcmp_FUN_005fef20 ; 0059253a
    ...
    PUSH 0x64bff4                       ; 00592550 | = ")"
        ;   Label: LAB_00592550
    PUSH ESI                            ; 00592555
    CALL crt_string.c__strcmp_FUN_005fef20 ; 00592556
        ;   XREF to: 005fef20 (UNCONDITIONAL_CALL)  ; int crt_string.c__strcmp_FUN_005fef20(char * str1, char * str2)
    ...
    PUSH ESI                            ; 0059256e
    CALL crt_string.c__stricmp_FUN_005fe7f0 ; 0059256f
