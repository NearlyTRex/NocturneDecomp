...

{
  ...
  if (local_ec == (_FILE *)0x0) {
    ...
    if ((local_e8 < 0x65) || (0x67 < local_e8)) {
      _sprintf
                (g_SkeleditStatusMessage,"%s has incorrect S3D version %d",entry->s3d_filename,local_e8);
      goto LAB_0058f8e7;
    }
    iVar31 = 1;
    do {
    ...
    iVar31 = _fscanf(local_ec,"%d,%d,%d,%d,%d,%d,%d\n",&local_e4,&local_16c,&local_168,&local_e0,
                        &local_164_int,&local_dc,&local_d4);
        ...
        if (0 < (int)local_16c) {
          do {
            iVar20 = _fscanf(local_ec,"%d,%d,%f,%f,%d,%f,%f,%d,%f,%f\n",local_13c,&local_278,
                                &local_194,&local_200,&local_274,(float *)local_190,(float *)local_1fc,&local_270,
                                &local_18c,&local_164_float);
...
LAB_005902c8:
        ...
        if (this_ptr->tri_count[0] <= (int)local_16c) {
          ...
          if (local_154 != this_ptr->tri_count[0]) {
            ...
            do {
              _sprintf(local_540,"There are %d triangles I couldn't match.",this_ptr->tri_count[0] - local_154);
              if (entry->skip_generation == 0) {
                      ...
                      if (this_ptr->num_textures <= iVar20) {
                        ...
                        _sprintf
                                  (local_a4->textures[this_ptr->num_textures].textures[0].
                                   texture_name,"%s.raw",local_a1ec + iVar31 * 0x100);
                        this_ptr->num_textures = this_ptr->num_textures + 1;
                      }
