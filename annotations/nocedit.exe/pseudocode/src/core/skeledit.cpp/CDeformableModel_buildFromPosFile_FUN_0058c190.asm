...
; CMatrix3x4f[100] Stack[-0x2520]:4800  local_2520
; CPickList        Stack[-0x1260]:936  local_1260
; char[400]        Stack[-0xeb8]:400  local_eb8
; char[260]        Stack[-0xd28]:260  local_d28
; char[260]        Stack[-0xc24]:260  local_c24
; char[260]        Stack[-0xb20]:260  local_b20
; char[260]        Stack[-0xa1c]:260  local_a1c
; char[256]        Stack[-0x918]:256  local_918
; char[256]        Stack[-0x818]:256  local_818
; char[256]        Stack[-0x718]:256  local_718
; char[256]        Stack[-0x618]:256  local_618
; char[256]        Stack[-0x518]:256  local_518
; char[200]        Stack[-0x418]:200  local_418
; CLodMesh         Stack[-0x350]:116  local_350
; CLodMesh         Stack[-0x2dc]:116  local_2dc
; CLodMesh         Stack[-0x268]:116  local_268
; CLodMesh         Stack[-0x1f4]:116  local_1f4
; char[100]        Stack[-0x180]:100  local_180
; CMatrix3x4f      Stack[-0x11c]:48  local_11c
; int[5]           Stack[-0xec]:20  local_ec
; int[5]           Stack[-0xd8]:20  local_d8
; int[2]           Stack[-0xc4]:8  local_c4
; int[2]           Stack[-0xbc]:8  local_bc
...
; CDeformableModel * Stack[-0x84]:4  local_84
; int              Stack[-0x80]:4  local_80
; CDeformableModel * Stack[-0x7c]:4  local_7c
; STextureSet *    Stack[-0x78]:4  local_78
; int              Stack[-0x74]:4  local_74
; float *          Stack[-0x70]:4  local_70
; STextureSet *    Stack[-0x6c]:4  local_6c
...
; STextureSet *    Stack[-0x3c]:4  local_3c
; int              Stack[-0x38]:4  local_38
; int              Stack[-0x34]:4  local_34
; int              Stack[-0x30]:4  local_30
; int              Stack[-0x2c]:4  local_2c
; int              Stack[-0x28]:4  local_28
; CBoneStructure * Stack[-0x24]:4  local_24
...
section .text
    ...
    JMP 0x03fc3ef0                      ; 0058c3c4
        ;   XREF to: 03fc3ef0 (UNCONDITIONAL_JUMP)  ; LAB_03fc3ef0
    INC EAX                             ; 0058c3e6
        ;   Label: LAB_0058c3e6
    ...
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0058c625
    ...
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0058c66a
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0058c698
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH EAX                            ; 0058c6cc
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0058c6cd
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH EAX                            ; 0058c6fa
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0058c6fb
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH EAX                            ; 0058c98c
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0058c98d
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    CALL shape_edittool.cpp_CEditorTools_showDestructiveActionConfirmDialog_FUN_0049f060 ; 0058c9a4
    ...
    PUSH EAX                            ; 0058d4b7
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0058d4b8
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    MOV ECX,0xc                         ; 03fc3ef0
        ;   Label: LAB_03fc3ef0
    ADD ESP,0x4                         ; 03fc3ef5
    LEA ESI,[ESP + 0xa10c]              ; 03fc3ef8
    LEA EDI,[ESP + EBX*0x1 + 0x7d08]    ; 03fc3eff
    ADD EBX,0x30                        ; 03fc3f06
    MOV EAX,dword ptr [ESP + 0xa200]    ; 03fc3f09
    MOV ECX,dword ptr [ESI]             ; 03fc3f10
    MOV dword ptr [EDI],ECX             ; 03fc3f12
    MOV ECX,dword ptr [ESI + 0x4]       ; 03fc3f14
    MOV dword ptr [EDI + 0x4],ECX       ; 03fc3f17
    MOV ECX,dword ptr [ESI + 0x8]       ; 03fc3f1a
    MOV dword ptr [EDI + 0x8],ECX       ; 03fc3f1d
    MOV ECX,dword ptr [ESI + 0xc]       ; 03fc3f20
    MOV dword ptr [EDI + 0xc],ECX       ; 03fc3f23
    MOV ECX,dword ptr [ESI + 0x10]      ; 03fc3f26
    MOV dword ptr [EDI + 0x10],ECX      ; 03fc3f29
    MOV ECX,dword ptr [ESI + 0x14]      ; 03fc3f2c
    MOV dword ptr [EDI + 0x14],ECX      ; 03fc3f2f
    MOV ECX,dword ptr [ESI + 0x18]      ; 03fc3f32
    MOV dword ptr [EDI + 0x18],ECX      ; 03fc3f35
    MOV ECX,dword ptr [ESI + 0x1c]      ; 03fc3f38
    MOV dword ptr [EDI + 0x1c],ECX      ; 03fc3f3b
    MOV ECX,dword ptr [ESI + 0x20]      ; 03fc3f3e
    MOV dword ptr [EDI + 0x20],ECX      ; 03fc3f41
    MOV ECX,dword ptr [ESI + 0x24]      ; 03fc3f44
    MOV dword ptr [EDI + 0x24],ECX      ; 03fc3f47
    MOV ECX,dword ptr [ESI + 0x28]      ; 03fc3f4a
    MOV dword ptr [EDI + 0x28],ECX      ; 03fc3f4d
    MOV ECX,dword ptr [ESI + 0x2c]      ; 03fc3f50
    MOV dword ptr [EDI + 0x2c],ECX      ; 03fc3f53
    ADD ESI,0x30                        ; 03fc3f56
    ADD EDI,0x30                        ; 03fc3f59
    XOR ECX,ECX                         ; 03fc3f5c
    JMP 0x0058c3e6                      ; 03fc3f5e
        ;   XREF to: 0058c3e6 (UNCONDITIONAL_JUMP)  ; LAB_0058c3e6
