...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_skeledit.cpp_FUN_0058bd00()
;
; Local Variables:
...
section .text
    ...
    CALL crt_stack.c_stack_probe_FUN_005ff9f3 ; 0058bd05 | uint crt_stack.c_stack_probe_FUN_005ff9f3(uint stack_size)
    ...
    PUSH EDX                            ; 0058bd1c
    PUSH 0x64a90c                       ; 0058bd1d | = "Importing vertex assignments from %s..." | s_Importing_vertex_assignm_0064a90c = Importing vertex assignments from %s...
    MOV ECX,dword ptr [0x00678a60]      ; 0058bd22 | CEditorTools * g_CEditorToolsPtr
    PUSH ECX                            ; 0058bd28 | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_displayCenteredStatusMessage_FUN_0049e790 ; 0058bd29 | void shape_edittool.cpp_CEditorTools_displayCenteredStatusMessage_FUN_0049e790(CEditorTools * this_ptr, char * message)
        ;   XREF to: 0049e790 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0058bd2e
    PUSH 0x593                          ; 0058bd31
    PUSH 0x64a934                       ; 0058bd36 | = "..\\core\\skeledit.cpp" | s_core_skeledit_cpp_0064a934 = ..\core\skeledit.cpp
    PUSH 0x64a949                       ; 0058bd3b | = "rb" | s_rb_0064a949 = rb
    PUSH 0x0                            ; 0058bd40
    MOV EBX,dword ptr [EBP + 0x18]      ; 0058bd42
    PUSH EBX                            ; 0058bd45
    CALL shape_memdbg.cpp_openFile_FUN_0050f7a0 ; 0058bd46 | FILE * shape_memdbg.cpp_openFile_FUN_0050f7a0(char * filename, char * directory, char * mode, char * source_file, ...)
        ;   XREF to: 0050f7a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0058bd4b
    MOV dword ptr [ESP + 0x408],EAX     ; 0058bd4e
    TEST EAX,EAX                        ; 0058bd55
    JZ 0x0058c07b                       ; 0058bd57 | LAB_0058c07b
    ...
    PUSH EAX                            ; 0058bd70
    CALL crt_stdio.c_fread_FUN_005fd990 ; 0058bd71 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0058bd76
    MOV ECX,dword ptr [ESP + 0x322]     ; 0058bd79
    CMP ECX,0xc8                        ; 0058bd80
    JLE 0x0058bdb5                      ; 0058bd86 | LAB_0058bdb5
        ;   XREF to: 0058bdb5 (CONDITIONAL_JUMP)
    PUSH 0xc8                           ; 0058bd88
    PUSH ECX                            ; 0058bd8d
    MOV EAX,dword ptr [EBP + 0x18]      ; 0058bd8e
    PUSH EAX                            ; 0058bd91
    MOV EBX,0x64a99c                    ; 0058bd92 | = "..\\core\\skeledit.cpp" | s_core_skeledit_cpp_0064a99c = ..\core\skeledit.cpp
    MOV ESI,0x59b                       ; 0058bd97
    PUSH 0x64a9b1                       ; 0058bd9c | = "Too many links in %s: %d, max is %d" | s_Too_many_links_in_s_d_ma_0064a9b1 = Too many links in %s: %d, max is %d
    MOV dword ptr [0x02f0ca48],EBX      ; 0058bda1 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 0058bda7 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0058bdad | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    JLE 0x0058be50                      ; 0058bdc0 | LAB_0058be50
    ...
    PUSH EAX                            ; 0058bde0
    CALL crt_stdio.c_fread_FUN_005fd990 ; 0058bde1 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0058bde6
    PUSH 0x32                           ; 0058bde9
    PUSH 0x0                            ; 0058bdeb
    PUSH EBX                            ; 0058bded | DAT_0365a3e8
    CALL crt_memory.c_memset_FUN_005fde40 ; 0058bdee | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
    ...
    CALL crt_stdio.c_fread_FUN_005fd990 ; 0058be09 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0058be0e
    PUSH EBX                            ; 0058be11 | DAT_0365a3e8
    MOV ECX,dword ptr [EBP + 0x1c]      ; 0058be12
    PUSH ECX                            ; 0058be15
    CALL core_skeledit.cpp_FUN_0058ac30 ; 0058be16 | undefined core_skeledit.cpp_FUN_0058ac30()
    ...
    CALL crt_stdio.c_fseek_FUN_005ffacc ; 0058be34 | int crt_stdio.c_fseek_FUN_005ffacc(FILE * file, long offset, int whence)
    ...
    JL 0x0058bdcd                       ; 0058be49 | LAB_0058bdcd
    ...
    PUSH EAX                            ; 0058be63
    CALL crt_stdio.c_fread_FUN_005fd990 ; 0058be64 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0058be7f
    CALL crt_stdio.c_fread_FUN_005fd990 ; 0058be80 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 0058be91
    PUSH EBX                            ; 0058be92
    CALL crt_stdio.c_fseek_FUN_005ffacc ; 0058be93 | int crt_stdio.c_fseek_FUN_005ffacc(FILE * file, long offset, int whence)
        ;   XREF to: 005ffacc (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0058be98
    PUSH 0x1                            ; 0058be9b
    PUSH 0x30                           ; 0058be9d
    PUSH EBX                            ; 0058be9f
    CALL crt_stdio.c_fseek_FUN_005ffacc ; 0058bea0 | int crt_stdio.c_fseek_FUN_005ffacc(FILE * file, long offset, int whence)
        ;   XREF to: 005ffacc (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0058beb4
    CALL crt_stdio.c_fread_FUN_005fd990 ; 0058beb5 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ...
    JLE 0x0058c0d3                      ; 0058becf | LAB_0058c0d3
    ...
    PUSH EAX                            ; 0058bf12
    CALL crt_stdio.c_fread_FUN_005fd990 ; 0058bf13 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0058bf18
    MOV EAX,dword ptr [ESP + 0x3c8]     ; 0058bf1b
    TEST EAX,EAX                        ; 0058bf22
    JNZ 0x0058c10c                      ; 0058bf24 | LAB_0058c10c
    ...
    JLE 0x0058c15b                      ; 0058bf39 | LAB_0058c15b
        ;   XREF to: 0058c15b (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x3c8],0x0     ; 0058bf3f
    JLE 0x0058c15b                      ; 0058bf47 | LAB_0058c15b
        ;   XREF to: 0058c15b (CONDITIONAL_JUMP)
    ...
    JLE 0x0058c0a4                      ; 0058bfe6 | LAB_0058c0a4
    ...
    CALL core_xform.cpp_inverse_FUN_005f6210 ; 0058c010 | CMatrix3x4f * core_xform.cpp_inverse_FUN_005f6210(CMatrix3x4f * output_matrix, CMatrix3x4f * input_matrix)
    ...
    CALL core_xform.cpp_transformVector3x4_FUN_005f4dc0 ; 0058c045 | CVector3f * core_xform.cpp_transformVector3x4_FUN_005f4dc0(CVector3f * output_vector, CVector3f * input_vector, CMatrix3x4f * matrix)
        ;   XREF to: 005f4dc0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0058c04a
    CMP EBX,EAX                         ; 0058c04d
    JNZ 0x0058c174                      ; 0058c04f | LAB_0058c174
    ...
    JMP 0x0058bfd2                      ; 0058c076 | LAB_0058bfd2
        ;   XREF to: 0058bfd2 (UNCONDITIONAL_JUMP)
    PUSH EBX                            ; 0058c07b
        ;   Label: LAB_0058c07b
    MOV ESI,0x64a94c                    ; 0058c07c | = "..\\core\\skeledit.cpp" | s_core_skeledit_cpp_0064a94c = ..\core\skeledit.cpp
    MOV EDI,0x594                       ; 0058c081
    PUSH 0x64a961                       ; 0058c086 | = "CDeformableModel::importVertexAssignm..." | s_CDeformableModel_importV_0064a961 = CDeformableModel::importVertexAssignmentsVPH can't open %s
    MOV dword ptr [0x02f0ca48],ESI      ; 0058c08b | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 0058c091 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0058c097 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0058c09c
    JMP 0x0058bd5d                      ; 0058c09f | LAB_0058bd5d
    ...
    JL 0x0058bee9                       ; 0058c0cd | LAB_0058bee9
        ;   XREF to: 0058bee9 (CONDITIONAL_JUMP)
    PUSH 0x5f9                          ; 0058c0d3
        ;   Label: LAB_0058c0d3
    PUSH 0x64aa34                       ; 0058c0d8 | = "..\\core\\skeledit.cpp" | s_core_skeledit_cpp_0064aa34 = ..\core\skeledit.cpp
    MOV EDI,dword ptr [ESP + 0x410]     ; 0058c0dd
    PUSH EDI                            ; 0058c0e4
    CALL shape_memdbg.cpp_closeFile_FUN_0050f9b0 ; 0058c0e5 | int shape_memdbg.cpp_closeFile_FUN_0050f9b0(FILE * file_ptr, char * source_file, int line_number)
        ;   XREF to: 0050f9b0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0058c0ea
    MOV EAX,dword ptr [EBP + 0x18]      ; 0058c0ed
    PUSH EAX                            ; 0058c0f0
    PUSH 0x64aa49                       ; 0058c0f1 | = "Imported vertex assignments from %s OK" | s_Imported_vertex_assignme_0064aa49 = Imported vertex assignments from %s OK
    MOV EDX,dword ptr [0x00678a60]      ; 0058c0f6 | CEditorTools * g_CEditorToolsPtr
    PUSH EDX                            ; 0058c0fc | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_displayCenteredStatusMessage_FUN_0049e790 ; 0058c0fd | void shape_edittool.cpp_CEditorTools_displayCenteredStatusMessage_FUN_0049e790(CEditorTools * this_ptr, char * message)
        ;   XREF to: 0049e790 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 0058c129
    MOV EDX,0x64a9d5                    ; 0058c12a | = "..\\core\\skeledit.cpp" | s_core_skeledit_cpp_0064a9d5 = ..\core\skeledit.cpp
    MOV ECX,0x5cc                       ; 0058c12f
    PUSH 0x64a9ea                       ; 0058c134 | = "vertex %d is influenced by bone %s, b..." | s_vertex_d_is_influenced_b_0064a9ea = vertex %d is influenced by bone %s, but this bone isn't in the .BON file!
    MOV dword ptr [0x02f0ca48],EDX      ; 0058c139 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 0058c13f | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0058c145 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0058c14a
    JMP 0x0058bf2c                      ; 0058c14d | LAB_0058bf2c
        ;   XREF to: 0058bf2c (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x3b8]     ; 0058c152
        ;   Label: LAB_0058c152
    JMP 0x0058c10e                      ; 0058c159 | LAB_0058c10e
    ...
    JMP 0x0058bf8f                      ; 0058c16f | LAB_0058bf8f
    ...
    JMP 0x0058c055                      ; 0058c184 | LAB_0058c055
