...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_skeledit_cpp_CDeformableModel_FUN_0058b9b0(CDeformableModel *this_ptr)
;
; Parameters:
...
;
; XREF[2]:
;   core_skeledit.cpp_CDeformableModel_FUN_0058b660 at 0058b874
...
;
; Called Functions:
;   core_skeledit.cpp_CDeformableModel_FUN_0058ede0
...
section .text
    ...
    PUSH 0x88                           ; 0058b9b0
        ;   Label: core_skeledit.cpp_CDeformableModel_FUN_0058b9b0
    ...
    PUSH EBX                            ; 0058bbd4
        ;   Label: LAB_0058bbd4
    CALL core_skeledit.cpp_CDeformableModel_FUN_0058ede0 ; 0058bbd5
        ;   XREF to: 0058ede0 (UNCONDITIONAL_CALL)  ; void core_skeledit.cpp_CDeformableModel_FUN_0058ede0(CDeformableModel * this_ptr)
