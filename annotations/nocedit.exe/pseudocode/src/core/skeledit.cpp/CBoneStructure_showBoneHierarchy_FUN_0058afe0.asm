...
;   core_skeledit.cpp_CSkeleton_importSkeletonFile_FUN_00592690 at 0059386d
;
; Referenced Globals:
...
section .text
    ...
    PUSH EAX                            ; 0058b046
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 0058b047
    ...
    PUSH EAX                            ; 0058b09e
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 0058b09f
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c__sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH ESI                            ; 0058b121
    INC EBX                             ; 0058b122
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 0058b123
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c__sprintf_FUN_005fdbd0(char * buffer, char * format)
