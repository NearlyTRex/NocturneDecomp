...

{
  ...
  CBoneStructure *in_stack_fffeeb8e;
  uint in_stack_fffeeb92;
  uint in_stack_fffeeb96;
  ...
  local_114 = 0.0;
  crt_stdio_c_fscanf_FUN_005fe7c0(local_11c,"%d\n");
  ...
  if ((in_stack_00000004->motion_list).state_count < (int)local_114) {
    do {
      crt_stdio_c_fscanf_FUN_005fe7c0(local_11c,"%s\n");
  ...
  iVar13 = crt_stdio_c_fscanf_FUN_005fe7c0(local_11c,"\"%[^\"]\"\n");
  if (iVar13 == 1) {
    crt_string_c_splitpath_FUN_005ff178(local_1e74,local_18,local_1070,local_f70,local_1170);
    if ((local_1070[0] == '\0') && (local_18[0] == '\0')) {
      crt_string_c_splitpath_FUN_005ff178
                (in_stack_00000008,local_18,local_1070,(char *)0x0,(char *)0x0);
      crt_file_c_makepath_FUN_005febfc(local_1e74,local_18,local_1070,local_f70,local_1170);
    }
    crt_string_c_splitpath_FUN_005ff178(local_1e74,local_24,local_1370,local_e70,local_1770);
    if (local_1770[0] == '\0') {
      crt_file_c_makepath_FUN_005febfc(local_1e74,local_24,local_1370,local_e70,"pos");
    }
    shape_edittool_cpp_CEditorTools_displayCenteredStatusMessage_FUN_0049e790
    ...
    core_skeledit_cpp_CBoneStructure_importBON_FUN_0058a3d0
              ((CBoneStructure *)local_1e74,(char *)in_stack_fffeeb8e);
    ...
    local_110 = (float)crt_stdio_c_ftell_FUN_00601560(local_11c);
...
LAB_00592a67:
    do {
      ...
      local_c8 = core_skeledit_cpp_readNonEmptyLine_FUN_005895f0
                           ((char *)local_11c,(FILE *)0x0,(int)in_stack_fffeeb8e);
      if (((local_c8 == 0) ||
          (iVar3 = crt_string_c_strnicmp_FUN_005ff070(local_21d0,"animation",9), iVar3 == 0
          )) && (iVar13 != 0)) {
        ...
        if (pCVar7 == (CBoneStructure *)0x0) {
          ...
          shape_edittool_cpp_CPickList_dtor_FUN_004a3c80
                    (&local_2ca8,0,(uint)in_stack_fffeeb8e,in_stack_fffeeb92,in_stack_fffeeb96,
        ...
        core_skeledit_cpp_CBoneStructure_readBONheader_FUN_0058a4a0
                  (pCVar7,(FILE *)local_58,&in_stack_fffeeb8e->bone_count);
      ...
      if (local_c8 == 0) {
        ...
        crt_stdio_c_fseek_FUN_005ffacc(local_11c,(long)local_110,0);
        local_38 = 0;
          ...
          do {
            ...
            do {
              iVar13 = core_skeledit_cpp_readNonEmptyLine_FUN_005895f0
                                 ((char *)pFVar2,(FILE *)&DAT_00000001,(int)in_stack_fffeeb8e);
              if (iVar13 == 0) {
                g_CurrentFilename = "..\\core\\skeledit.cpp";
            ...
            if (0 < *(int *)((int)aiStack_2720 + (int)fVar15)) {
              do {
                core_skeledit_cpp_readNonEmptyLine_FUN_005895f0
                          ((char *)local_11c,(FILE *)&DAT_00000001,(int)in_stack_fffeeb8e);
                  ...
                  if (iVar13 != 1) {
                    shape_edittool_cpp_CEditorTools_showError_FUN_0049e740
                              (g_CEditorToolsPtr,"Error parsing \"fps\" statement for animation %s in %s:\n%s",local_ec,
                               in_stack_00000008);
                    shape_edittool_cpp_CPickList_dtor_FUN_004a3c80
                              (&local_2ca8,0,(uint)in_stack_fffeeb8e,in_stack_fffeeb92,
                               in_stack_fffeeb96,in_stack_fffeeb9a,in_stack_fffeeb9e);
                    goto LAB_005927ee;
                  }
                }
                else {
                  iVar13 = crt_string_c_strnicmp_FUN_005ff070(local_20a4,"if",2);
                  if (iVar13 == 0) {
                    ...
                    local_a0 = -NAN;
                    crt_stdio_c_sscanf_FUN_0060013c(pcVar11,"\"%[^\"]\"%n",local_918);
                    if ((int)local_a0 < 0) {
                      shape_edittool_cpp_CEditorTools_showError_FUN_0049e740
                    ...
                    if (*pcVar11 == '[') {
                      local_a0 = -NAN;
                      crt_stdio_c_sscanf_FUN_0060013c(pcVar11,"[ %[^]] ]%n",local_788);
                      if ((int)local_a0 < 0) {
                        shape_edittool_cpp_CEditorTools_showError_FUN_0049e740
                    ...
                    iVar13 = crt_string_c_strnicmp_FUN_005ff070(local_20a4,"->",2);
                    if (iVar13 == 0) {
                      pcVar11 = local_20a2;
                      while ((g_CharacterClassificationTable[(byte)(*pcVar11 + 1)] & 2U) != 0) {
                        pcVar11 = pcVar11 + 1;
                      ...
                      if (iVar13 == 0) {
                        ...
                        if (iVar13 == 0) {
                          ...
                          local_64 = -1;
                          crt_stdio_c_sscanf_FUN_0060013c(pcVar11," \"%[^\"]\" %n",local_b70);
                          if (local_64 < 0) {
                            shape_edittool_cpp_CEditorTools_showError_FUN_0049e740
                                  ...
                                  if (local_64 < 0) {
                                    shape_edittool_cpp_CEditorTools_showError_FUN_0049e740
                                              (g_CEditorToolsPtr,"Can't parse tween time for \"->\" statement for animation %s in %s:\n%s"
                                               ,local_ec,in_stack_00000008);
                                    shape_edittool_cpp_CPickList_dtor_FUN_004a3c80
                                              (&local_2ca8,0,(uint)in_stack_fffeeb8e,
                                               in_stack_fffeeb92,in_stack_fffeeb96,in_stack_fffeeb9a
                                               ,in_stack_fffeeb9e);
                                    goto LAB_005927ee;
                                  }
                                  ...
                                  if ((local_ec->exit_forward_cmd == 5) ||
                                    ...
                                    *(int *)(extraout_EAX + 0x28) = (int)ROUND(dVar25);
                                    if (*(int *)(extraout_EAX + 0x28) < 0) {
                                      ...
                                      shape_edittool_cpp_CPickList_dtor_FUN_004a3c80
                                                (&local_2ca8,0,(uint)in_stack_fffeeb8e,
                                                 in_stack_fffeeb92,in_stack_fffeeb96,
                                                 in_stack_fffeeb9a,in_stack_fffeeb9e);
                                      goto LAB_005927ee;
                                    }
                                  }
                      ...
                      iVar13 = crt_string_c_strnicmp_FUN_005ff070(local_20a4,"signal",6);
                      if (iVar13 == 0) {
                        ...
                        iVar13 = crt_stdio_c_sscanf_FUN_0060013c(pcVar11,"%d %*s %s",&local_88)
                        ;
                        if (iVar13 != 2) {
                          shape_edittool_cpp_CEditorTools_showError_FUN_0049e740
                        ...
                        iVar13 = crt_string_c_strnicmp_FUN_005ff070(local_20a4,"reverse",7)
                        ;
                        if (iVar13 == 0) {
                          local_e4 = 1;
                        }
...
LAB_00594f2a:
                                      do {
                                        ...
                                        pbVar5 = str + 1;
                                               ...
                                               2U) != 0);
                                      if (*str != 0) {
                                        local_74 = crt_ctype_c_toupper_FUN_005ff9e0((uint)*str);
                                        if (0x58 < local_74) {
...
LAB_0059518b:
            ...
            fVar15 = local_3c;
            core_skeledit_cpp_CBoneStructure_readBONheader_FUN_0058a4a0
                      (this_ptr_00,(FILE *)local_b8,&in_stack_fffeeb8e->bone_count);
            iVar13 = 0;
            ...
            if (-1 < local_ec->frame_count) {
              do {
                ...
                core_skeledit_cpp_CBoneStructure_readBONframe_FUN_0058aa10
                          (local_c0,local_d8,(int)in_stack_fffeeb8e);
                iVar13 = local_c4;
                core_skeledit_cpp_CBoneStructure_fixupMatrices_FUN_0058adb0(in_stack_fffeeb8e);
                if (iVar13 != 0) {
                  iVar13 = 0;
                  if (0 < local_748c) {
                    pfVar19 = (float *)local_7434;
                    do {
                      iVar13 = iVar13 + 1;
                      core_xform_cpp_multiplyMatrix3x4InPlace_FUN_005f50c0
                                ((CMatrix3x4f *)pfVar19,&local_434);
                ...
                if (local_dc == 0) {
                  ...
                  if (0 < in_stack_00000004->bone_count) {
                    ...
                    do {
                      core_xform_cpp_matrixToQuaternion_FUN_005f7420
                                ((CQuaternion4f *)local_58._16_4_,(CMatrix3x3f *)in_stack_fffeeb8e);
                      pfVar19 = (float *)((int)pCVar16 + (uint)bVar24 * -8 + 4);
                      pCVar16->w = afStack_220[3];
                      pfVar20 = pfVar19 + (uint)bVar24 * -2 + 1;
                      *pfVar19 = afStack_220[(uint)bVar24 * -2 + 4];
                      *pfVar20 = afStack_220[(uint)bVar24 * -2 + (uint)bVar24 * -2 + 5];
                      pfVar20[(uint)bVar24 * -2 + 1] =
                           (afStack_220 + (uint)bVar24 * -2 + (uint)bVar24 * -2 + 5)
                           [(uint)bVar24 * -2 + 1];
                      local_60 = local_60 + 1;
                  ...
                  core_xform_cpp_multiplyMatrix3x4_FUN_005f4f10
                            (local_7434,&local_3a4,(CMatrix3x4f *)in_stack_fffeeb8e);
                  pfVar19 = local_344;
                  pCVar21 = &local_3d4;
                  ...
                  core_xform_cpp_inverse_FUN_005f6210(&local_3d4,(CMatrix3x4f *)in_stack_fffeeb8e);
                  pfVar19 = local_374;
                  pCVar21 = &local_404;
                  for (iVar4 = 0xc; iVar4 != 0; iVar4 = iVar4 + -1) {
                    pCVar21->m[0].w = *pfVar19;
                  ...
                  if (0 < in_stack_00000004->bone_count) {
                    ...
                    do {
                      ...
                      core_xform_cpp_matrixToQuaternion_FUN_005f7420
                                (local_2e4,(CMatrix3x3f *)in_stack_fffeeb8e);
                      pfVar19 = (float *)((int)pCVar16 + (uint)bVar24 * -8 + 4);
                      pCVar16->w = local_224;
                      pfVar20 = pfVar19 + (uint)bVar24 * -2 + 1;
                      *pfVar19 = afStack_220[(uint)bVar24 * -2];
                      *pfVar20 = afStack_220[(uint)bVar24 * -2 + (uint)bVar24 * -2 + 1];
                      pfVar20[(uint)bVar24 * -2 + 1] =
                           (afStack_220 + (uint)bVar24 * -2 + (uint)bVar24 * -2 + 1)
                           [(uint)bVar24 * -2 + 1];
                      local_5c = local_5c + 1;
            ...
            shape_memdbg_cpp_closeFile_FUN_0050f9b0
                      ((FILE *)local_c0,"..\\core\\skeledit.cpp",0x147a);
            local_204 = 0.0;
            local_200 = 0.0;
            local_1fc = 0.0;
            iVar13 = 0;
...
LAB_00595723:
            ...
            if (0.0 < SQRT(local_1e4 * local_1e4 + local_1ec * local_1ec + local_1e8 * local_1e8)) {
              ...
              fVar15 = local_cc;
              while (bVar23 || SBORROW /* signed borrow */4((int)fVar15,(int)local_94) != iVar13 < 0) {
        ...
        local_118 = 0.0;
        local_11c = (FILE *)0x0;
        crt_memory_c_memset_FUN_005fde40(local_2540,0,0x1e0);
        if (0 < DAT_03670b5c) {
          iVar13 = 0;
          do {
...
LAB_00595eb8:
        ...
        do {
          ...
          iVar4 = (in_stack_00000004->motion_list).motions[*piVar18].frame_start +
          ...
          for (iVar3 = 0; iVar4 = DAT_03670b5c,
              iVar3 < (in_stack_00000004->motion_list).motions[*piVar18].frame_count;
              iVar3 = iVar3 + 1) {
            iVar4 = (in_stack_00000004->motion_list).motions[*piVar18].frame_start + iVar3;
            pCVar8 = in_stack_00000004->frame_positions_1;
      ...
      iVar13 = crt_string_c_strnicmp_FUN_005ff070(local_21d0,"animation",9);
      if (iVar13 != 0) {
        iVar13 = crt_string_c_strnicmp_FUN_005ff070(local_21d0,"checkout",8);
        if (iVar13 == 0) {
          crt_stdio_c_sscanf_FUN_0060013c(local_21ca + 2,"%s");
          uVar6 = 0xffffffff;
          ...
          while ((g_CharacterClassificationTable[(byte)(acStack_851[1] + 1)] & 2U) != 0) {
            crt_string_c_memmove_FUN_005fe5e0(acStack_851 + 1,acStack_851 + 2,n);
            n = n - 1;
          }
          pcVar11 = crt_env_c_getenv_FUN_006013f0("USERNAME");
          if (((pcVar11 == (char *)0x0) ||
              (iVar13 = crt_string_c_stricmp_FUN_005fe7f0(pcVar11,acStack_851 + 1), iVar13 != 0)) &&
          ...
          if (iVar3 == 0) {
            ...
            crt_string_c_splitpath_FUN_005ff178(pcVar11,local_1c,local_1470,local_1b70,local_c70);
            if ((local_1470[0] == '\0') && (local_1c[0] == '\0')) {
              crt_string_c_splitpath_FUN_005ff178
                        (in_stack_00000008,local_1c,local_1470,(char *)0x0,(char *)0x0);
              crt_file_c_makepath_FUN_005febfc(pcVar11,local_1c,local_1470,local_1b70,local_c70);
            }
            crt_string_c_splitpath_FUN_005ff178(pcVar11,local_20,local_1a70,local_1970,local_d70);
            if (local_d70[0] == '\0') {
            ...
            iVar13 = crt_string_c_strnicmp_FUN_005ff070(local_21d0,"frames",6);
            if (iVar13 == 0) {
              pcVar11 = local_21ca;
              while ((g_CharacterClassificationTable[(byte)(*pcVar11 + 1)] & 2U) != 0) {
                pcVar11 = pcVar11 + 1;
              ...
              local_f4 = -1;
              crt_stdio_c_sscanf_FUN_0060013c(pcVar11," %[^-] - %s%n",local_244,local_264);
              if (local_f4 < 3) {
                shape_edittool_cpp_CEditorTools_showError_FUN_0049e740
      ...
      iVar13 = crt_stdio_c_sscanf_FUN_0060013c(local_21ca + 3," \"%[^\"]\" : %s",local_1f78);
      if (iVar13 != 2) {
        shape_edittool_cpp_CEditorTools_showError_FUN_0049e740
      ...
      crt_string_c_splitpath_FUN_005ff178(local_1f78,local_28,local_1570,local_1670,local_1870);
      if ((local_1570[0] == '\0') && (local_28[0] == '\0')) {
        crt_string_c_splitpath_FUN_005ff178
                  (in_stack_00000008,local_28,local_1570,(char *)0x0,(char *)0x0);
        crt_file_c_makepath_FUN_005febfc(local_1f78,local_28,local_1570,local_1670,local_1870);
      }
      crt_string_c_splitpath_FUN_005ff178(local_1f78,local_14,local_1d70,local_1c70,local_1270);
      if (local_1270[0] == '\0') {
        crt_file_c_makepath_FUN_005febfc(local_1f78,local_14,local_1d70,local_1c70,"bon");
      }
      pSVar14 = local_f8 + (in_stack_00000004->motion_list).motion_count;
