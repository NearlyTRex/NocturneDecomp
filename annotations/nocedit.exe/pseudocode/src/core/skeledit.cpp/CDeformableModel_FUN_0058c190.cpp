// Name: core_skeledit.cpp_CDeformableModel_FUN_0058c190
// Address: 0058c190
// Address Range: [[0058c190, 0058d782]]
// Convention: __cdecl
// Signature: int __cdecl core_skeledit_cpp_CDeformableModel_FUN_0058c190(CDeformableModel *this_ptr,char *filename)
...

{
  ...
  if (iVar12 == 0) {
    ...
    if (*(int *)(filename + 0x308) != 2) {
      ...
      _sprintf(local_418,"Display %s",this_ptr->model_name);
      shape_edittool_cpp_CStrList_add_FUN_004a2b80(&local_1260.base,local_418);
      iVar12 = 0;
      while( true ) {
...
LAB_0058c613:
  ...
  pCVar5 = local_24;
  iVar12 = core_skeledit_cpp_CDeformableModel_FUN_0058b8e0(this_ptr,(_FILE *)local_24);
  if (((iVar12 == 0) ||
      (iVar12 = core_skeledit_cpp_CDeformableModel_FUN_0058b9b0(this_ptr,(_FILE *)pCVar5),
      iVar12 == 0)) ||
     (iVar12 = core_skeledit_cpp_CDeformableModel_FUN_0058bc40(this_ptr,(_FILE *)pCVar5),
     iVar12 == 0)) goto LAB_0058c613;
  if (filename[0x200] == '\0') {
  ...
  if (0 < in_stack_ffff5dd8) {
    ...
    do {
      ...
      pfVar19 = (float *)((int)local_2520 + iVar12);
      iVar12 = iVar12 + 0x30;
      pCVar14 = &local_11c;
  ...
  splitpath(filename,local_14,local_718,(char *)0x0,(char *)0x0);
  ...
  local_a4 = 2;
  if (*(int *)(filename + 0x308) == 1) {
    iVar12 = shape_edittool_cpp_CEditorTools_promptForValidInteger_FUN_004a0020
...
LAB_0058c4df:
    ...
    splitpath(filename,(char *)0x0,(char *)0x0,local_b20,(char *)0x0);
    shape_design_c_initializeTextureManager_FUN_0046a880(1);
    shape_design_c_setTextureQualityParameter_FUN_0046a8e0(0x40);
    iVar12 = shape_design_c_calculateTextureQualityLevel_FUN_0046a930(local_a4);
    if (1 < this_ptr->num_texture_sets) {
      iVar12 = iVar12 + -1;
    }
    local_b20[iVar12] = '\0';
    iVar12 = shape_edittool_cpp_CEditorTools_showTextInputDialog_FUN_004a03d0
                       (g_CEditorToolsPtr,"Enter crammed texture base name (no path or extension)",local_b20,iVar12 + 1,1
                       );
    if (iVar12 == 0) {
      return 0;
    }
...
LAB_0058c601:
  ...
  if (*(int *)(filename + 0x308) == 2) {
    ...
    shape_meshlod_cpp_CLodMesh_generateLOD_FUN_00516ba0(&local_1f4,*(int *)(filename + 0x300),2);
    filename[0x30c] = '\x01';
    filename[0x30d] = '\0';
    filename[0x30e] = '\0';
    filename[0x30f] = '\0';
    ...
    core_skeledit_cpp_FUN_0058a0f0();
    shape_meshlod_cpp_CLodMesh_generateLOD_FUN_00516ba0(&local_350,*(int *)(filename + 0x304),0);
  ...
  filename[0x30e] = '\0';
  filename[0x30f] = '\0';
  local_9c = core_skeledit_cpp_CLodMesh_FUN_00589c20(&local_1f4);
  if (-1 < local_9c) {
    if (local_9c != 0) {
    ...
    if (0 < this_ptr->num_lods) {
      ...
      do {
        ...
        core_skeledit_cpp_CDeformableModel_FUN_0058d790(this_ptr,iVar12,&local_2dc);
    ...
    if (this_ptr->num_lods < 5) {
      ...
      filename[0x30f] = '\0';
      g_LodReplayMode = 1;
      iVar12 = core_skeledit_cpp_CLodMesh_FUN_00589c20(&local_350);
      ...
      if (iVar12 != 0) {
        ...
        if (iVar12 == 2) {
          ...
          core_skeledit_cpp_CDeformableModel_FUN_0058d790
                    (this_ptr,this_ptr->num_lods + -1,&local_268);
