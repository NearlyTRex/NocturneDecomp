...
;   core_skeledit.cpp_CDeformableModel_buildFromPosFile_FUN_0058c190 at 0058c245
;   core_skeledit.cpp_CSkeleton_importSkeletonFile_FUN_00592690 at 0059548b
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBP                            ; 0058ab6b
        ;   Label: LAB_0058ab6b
    CALL core_skeledit.cpp_CBoneStructure_computeLocalMatrices_FUN_0058ac80 ; 0058ab6c
