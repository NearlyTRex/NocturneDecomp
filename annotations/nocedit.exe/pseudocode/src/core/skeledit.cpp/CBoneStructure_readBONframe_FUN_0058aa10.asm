...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_skeledit.cpp_CBoneStructure_readBONframe_FUN_0058aa10(CBoneStructure * this_ptr, FILE * file, int mirror_flag)
;
; Parameters:
...
;   core_skeledit.cpp_FUN_00592690 at 0059548b
;
; Referenced Globals:
...
section .text
    ...
    CALL crt_stack.c_stack_probe_FUN_005ff9f3 ; 0058aa15 | uint crt_stack.c_stack_probe_FUN_005ff9f3(uint stack_size)
    ...
    CMP ESI,dword ptr [EBP]             ; 0058aa28
        ;   Label: LAB_0058aa28
    JGE 0x0058ab6b                      ; 0058aa2b | LAB_0058ab6b
    ...
    PUSH EAX                            ; 0058aa51
    PUSH EBX                            ; 0058aa52
    PUSH 0x64a3db                       ; 0058aa53 | = "%f,%f,%f\n" | s_f_f_f_0064a3db = %f,%f,%f

    PUSH EDI                            ; 0058aa58
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0058aa59 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0058aa5e
    CMP EAX,0x3                         ; 0058aa61
    JZ 0x0058aa88                       ; 0058aa64 | LAB_0058aa88
        ;   XREF to: 0058aa88 (CONDITIONAL_JUMP)
    MOV EAX,0x64a3e5                    ; 0058aa66 | = "..\\core\\skeledit.cpp" | s_core_skeledit_cpp_0064a3e5 = ..\core\skeledit.cpp
        ;   Label: LAB_0058aa66
    MOV EDX,0x310                       ; 0058aa6b
    PUSH 0x64a3fa                       ; 0058aa70 | = "CBoneStructure::readBONframe - file i..." | s_CBoneStructure_readBONfr_0064a3fa = CBoneStructure::readBONframe - file is corrupt!
    MOV [0x02f0ca48],EAX                ; 0058aa75 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDX      ; 0058aa7a | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0058aa80 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    PUSH EAX                            ; 0058aa93
    PUSH 0x64a42a                       ; 0058aa94 | = "%f,%f,%f\n" | s_f_f_f_0064a42a = %f,%f,%f

    PUSH EDI                            ; 0058aa99
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0058aa9a | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0058aa9f
    CMP EAX,0x3                         ; 0058aaa2
    JNZ 0x0058aa66                      ; 0058aaa5 | LAB_0058aa66
    ...
    PUSH EAX                            ; 0058aab2
    PUSH 0x64a434                       ; 0058aab3 | = "%f,%f,%f\n" | s_f_f_f_0064a434 = %f,%f,%f

    PUSH EDI                            ; 0058aab8
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0058aab9 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0058aabe
    CMP EAX,0x3                         ; 0058aac1
    JNZ 0x0058aa66                      ; 0058aac4 | LAB_0058aa66
        ;   XREF to: 0058aa66 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 0058aad1
    PUSH 0x64a43e                       ; 0058aad2 | = "%f,%f,%f\n" | s_f_f_f_0064a43e = %f,%f,%f

    PUSH EDI                            ; 0058aad7
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 0058aad8 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0058aadd
    CMP EAX,0x3                         ; 0058aae0
    JNZ 0x0058aa66                      ; 0058aae3 | LAB_0058aa66
        ;   XREF to: 0058aa66 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x1c],0x0      ; 0058aae5
    JZ 0x0058ab33                       ; 0058aaea | LAB_0058ab33
    ...
    PUSH EBX                            ; 0058ab33
        ;   Label: LAB_0058ab33
    CALL core_xform.cpp_hasNegativeDeterminant_FUN_005f6be0 ; 0058ab34 | int core_xform.cpp_hasNegativeDeterminant_FUN_005f6be0(CMatrix3x4f * matrix)
        ;   XREF to: 005f6be0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0058ab39
    TEST EAX,EAX                        ; 0058ab3c
    JZ 0x0058ab5a                       ; 0058ab3e | LAB_0058ab5a
    ...
    PUSH EBX                            ; 0058ab5c
    INC ESI                             ; 0058ab5d
    CALL core_xform.cpp_orthonormalizeMatrix3x3_FUN_005f6690 ; 0058ab5e | void core_xform.cpp_orthonormalizeMatrix3x3_FUN_005f6690(CMatrix3x3f * matrix, int preserve_scale)
        ;   XREF to: 005f6690 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0058ab63
    JMP 0x0058aa28                      ; 0058ab66 | LAB_0058aa28
        ;   XREF to: 0058aa28 (UNCONDITIONAL_JUMP)
    PUSH EBP                            ; 0058ab6b
        ;   Label: LAB_0058ab6b
    CALL core_skeledit.cpp_FUN_0058ac80 ; 0058ab6c | undefined core_skeledit.cpp_FUN_0058ac80()
        ;   XREF to: 0058ac80 (UNCONDITIONAL_CALL)
    MOV AH,byte ptr [EDI + 0xc]         ; 0058ab71
    ADD ESP,0x4                         ; 0058ab74
    TEST AH,0x20                        ; 0058ab77
    JNZ 0x0058ab81                      ; 0058ab7a | LAB_0058ab81
    ...
    POP EBX                             ; 0058ab7f
    RET                                 ; 0058ab80
    MOV ECX,0x64a448                    ; 0058ab81 | = "..\\core\\skeledit.cpp" | s_core_skeledit_cpp_0064a448 = ..\core\skeledit.cpp
        ;   Label: LAB_0058ab81
    MOV EBX,0x33b                       ; 0058ab86
    PUSH 0x64a45d                       ; 0058ab8b | = "CBoneStructure::readBONframe - error ..." | s_CBoneStructure_readBONfr_0064a45d = CBoneStructure::readBONframe - error reading file!
    MOV dword ptr [0x02f0ca48],ECX      ; 0058ab90 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 0058ab96 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0058ab9c | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
