...
;
; XREF[2]:
;   core_skeledit.cpp_CDeformableModel_buildFromPosFile_FUN_0058c190 at 0058c339
;   core_skeledit.cpp_CDeformableModel_importGeometryS3D_FUN_0058b660 at 0058b886
;
; Referenced Globals:
