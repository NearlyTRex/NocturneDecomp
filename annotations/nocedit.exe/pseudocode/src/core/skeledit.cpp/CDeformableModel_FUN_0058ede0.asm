...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_skeledit_cpp_CDeformableModel_FUN_0058ede0(CDeformableModel *this_ptr)
;
; Parameters:
...
;
; XREF[1]:
;   core_skeledit.cpp_CDeformableModel_FUN_0058b9b0 at 0058bbd5
;
; Referenced Globals:
...
section .text
    ...
    PUSH 0x64                           ; 0058ede0
        ;   Label: core_skeledit.cpp_CDeformableModel_FUN_0058ede0
