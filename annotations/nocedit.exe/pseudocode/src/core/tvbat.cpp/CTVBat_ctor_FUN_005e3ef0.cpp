...
// Address: 005e3ef0
// Address Range: [[005e3ef0, 005e4049]]
// Convention: __cdecl
...

{
  ...
  fVar2 = core_actor_cpp_getRandomFloatFromRange_FUN_0040cc10(0.9,1.1);
  ADJ(this_ptr_00)->move_speed = fVar2 * 10.0f;
  fVar2 = core_actor_cpp_getRandomFloatFromRange_FUN_0040cc10(0.9,1.1);
  ADJ(this_ptr_00)->rot_speed = fVar2 * 2.0f;
  ...
  ADJ(this_ptr_00)->height_offset = fVar2;
