...
;                               FUNCTION
; *****************************************************************************
; __cdecl CTVBat * __cdecl core_tvbat_cpp_CTVBat_dtor_FUN_005e5460 (CTVBat *this_ptr,uint d1,uint d2,uint d3,uint d4,uint d5,uint d6,uint d7,uint d8)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005e5478
    CALL core_backgnd.cpp_freeFlames_FUN_00412720 ; 005e5479
    ...
    PUSH EAX                            ; 005e5488
    CALL core_backgnd.cpp_freeFires_FUN_00412700 ; 005e5489
    ...
    PUSH EAX                            ; 005e5498
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 005e5499
    ...
    PUSH EAX                            ; 005e54a8
    CALL core_backgnd.cpp_cleanupVector_FUN_004126e0 ; 005e54a9
        ;   XREF to: 004126e0 (UNCONDITIONAL_CALL)  ; int core_backgnd.cpp_cleanupVector_FUN_004126e0(CVector3f * * objs)
    ADD ESP,0x8                         ; 005e54ae
    PUSH 0x0                            ; 005e54b1
    SUB EAX,0x1c8                       ; 005e54b3
    PUSH EAX                            ; 005e54b8
    CALL core_cloth.cpp_FUN_0043bf80    ; 005e54b9
