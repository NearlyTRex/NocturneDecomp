...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_tvbat_cpp_CTVBat_archive_FUN_005e40c0(CTVBat *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005e40c0
        ;   Label: core_tvbat.cpp_CTVBat_archive_FUN_005e40c0
    ...
    PUSH EBX                            ; 005e40d2
    CALL core_enemy.cpp_CEnemy_archive_FUN_004a9660 ; 005e40d3
    ...
    PUSH EAX                            ; 005e40e6
    CALL core_actor.cpp_archiveVector_FUN_0040b340 ; 005e40e7
    ...
    PUSH EAX                            ; 005e40fa
    CALL core_actor.cpp_archiveKeyframedModelInstance_FUN_0040b8f0 ; 005e40fb
    ...
    PUSH EAX                            ; 005e4119
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 005e411a
    ...
    PUSH EAX                            ; 005e419a
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 005e419b
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ...
    PUSH EBX                            ; 005e41ae
        ;   Label: LAB_005e41ae
    CALL core_actor.cpp_CDemonActor_archive_FUN_0040c1c0 ; 005e41af
    ...
    PUSH EAX                            ; 005e41d6
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 005e41d7
    ...
    PUSH EAX                            ; 005e41ea
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 005e41eb
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
    ADD ESP,0x8                         ; 005e41f0
    PUSH 0x656918                       ; 005e41f3 | = "periodicSoundTimerMax"
    ADD EBX,0xc0e4                      ; 005e41f8
    PUSH EBX                            ; 005e41fe
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 005e41ff
        ;   XREF to: 0040b770 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveFloat_FUN_0040b770(float * float_ptr, char * property_name)
