...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_tvbat.cpp_FUN_005e5100()
;
;
; *****************************************************************************
...
section .text
    ...
    JZ 0x005e5129                       ; 005e510a | LAB_005e5129
    ...
    JZ 0x005e512c                       ; 005e5119 | LAB_005e512c
        ;   XREF to: 005e512c (CONDITIONAL_JUMP)
    CMP ECX,0x2                         ; 005e511b
    JZ 0x005e512c                       ; 005e511e | LAB_005e512c
        ;   XREF to: 005e512c (CONDITIONAL_JUMP)
