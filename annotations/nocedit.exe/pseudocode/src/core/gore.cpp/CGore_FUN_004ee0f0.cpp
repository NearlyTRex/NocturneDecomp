...

{
  ...
  if (0 < DAT_02da8720) {
    pCVar1 = DAT_02da8724;
    do {
      if (((ABS(in_stack_00000008[1] - *(float *)(pCVar1->field0_0x0 + 8)) <= (float)0.5
           ) && (ABS(*in_stack_00000008 - *(float *)(pCVar1->field0_0x0 + 4)) <=
                 (float)1.333)) &&
         (ABS(in_stack_00000008[2] - *(float *)(pCVar1->field0_0x0 + 0xc)) <= (float)1.333
         )) {
        *in_stack_0000000c = *(uint *)(pCVar1->field0_0x0 + 0x10);
        return 1;
      }
      iVar3 = iVar3 + 1;
      pCVar1 = pCVar1 + 1;
  ...
  if (0 < DAT_02d873d8) {
    ...
    do {
      if (((*(int *)(pCVar2->field0_0x0 + 0x10) == 0) &&
          (ABS(in_stack_00000008[1] - *(float *)(pCVar2->field0_0x0 + 8)) <= (float)0.5)
          ) && ((ABS(*in_stack_00000008 - *(float *)(pCVar2->field0_0x0 + 4)) <=
                 (float)0.5 &&
                (ABS(in_stack_00000008[2] - *(float *)(pCVar2->field0_0x0 + 0xc)) <=
                 (float)0.5)))) {
        *in_stack_0000000c = *(uint *)(pCVar2->field0_0x0 + 0x14);
        return 1;
      }
      iVar3 = iVar3 + 1;
      pCVar2 = pCVar2 + 1;
