...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_gore_cpp_CGore_FUN_004edbb0(CGore *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004edbb0
        ;   Label: core_gore.cpp_CGore_FUN_004edbb0
    PUSH ESI                            ; 004edbb1
    PUSH EDI                            ; 004edbb2
    PUSH EBP                            ; 004edbb3
    ...
    PUSH EDX                            ; 004edbde
    INC EBX                             ; 004edbdf
    CALL core_gore.cpp_CGore_FUN_004edaa0 ; 004edbe0
