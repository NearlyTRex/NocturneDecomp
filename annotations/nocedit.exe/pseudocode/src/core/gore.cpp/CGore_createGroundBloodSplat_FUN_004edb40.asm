...
;
; Called Functions:
;   core_gore.cpp_CBloodSplat_initGroundSplat_FUN_004ec2f0
...
section .text
    ...
    CMP dword ptr [ESP + 0xc],0x2       ; 004edb40
        ;   Label: core_gore.cpp_CGore_createGroundBloodSplat_FUN_004edb40
    ...
    PUSH ECX                            ; 004edb4e
    CALL core_gore.cpp_CGore_allocateBloodSplat_FUN_004edaf0 ; 004edb4f
    ...
    PUSH ESI                            ; 004edb60
    PUSH EAX                            ; 004edb61
    CALL core_gore.cpp_CBloodSplat_initGroundSplat_FUN_004ec2f0 ; 004edb62
        ;   XREF to: 004ec2f0 (UNCONDITIONAL_CALL)  ; void core_gore.cpp_CBloodSplat_initGroundSplat_FUN_004ec2f0(CBloodSplat * this_ptr, CVector3f * position, int blood_type)
