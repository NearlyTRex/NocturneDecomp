...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_gore_cpp_CBloodSplat_FUN_004ecb00(CBloodSplat *this_ptr)
;
; Parameters:
; CBloodSplat *    Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_gore.cpp_CGore_FUN_004ee1e0 at 004ee267
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004ecb00
        ;   Label: core_gore.cpp_CBloodSplat_FUN_004ecb00
    PUSH ESI                            ; 004ecb01
