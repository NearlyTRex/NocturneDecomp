...
;   undefined4 g_BloodPoolAnimTextures[1].base.type
;   undefined4 g_BloodPoolAnimTextures[29].base.type
...
section .text
    ...
    PUSH EDI                            ; 004ede62
    PUSH EBP                            ; 004ede63
    PUSH 0x67b9b0                       ; 004ede64 | g_BloodParticleTexture
    ...
    MOV EBX,0x67b9c8                    ; 004ede70 | g_BloodSplatTextures
    ...
    MOV EBP,0x67ba28                    ; 004ede97 | g_BloodSplatAnimTextures
    XOR EDI,EDI                         ; 004ede9c
    ADD EBP,0x180                       ; 004ede9e
    IMUL EBX,EDI,0x180                  ; 004edea4
        ;   Label: LAB_004edea4
    MOV ESI,EBP                         ; 004edeaa
    ADD EBX,0x67ba28                    ; 004edeac | g_BloodSplatAnimTextures[16].base.type
    PUSH EBX                            ; 004edeb2 | g_BloodSplatAnimTextures | g_BloodSplatAnimTextures[1].base.type | g_BloodSplatAnimTextures[16].base.type
        ;   Label: LAB_004edeb2
    ...
    CALL engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80 ; 004edeb9
        ;   XREF to: 0048db80 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80(CDemonRenderer * this_ptr, SMRGLTextureBasic * texture)
    ADD EBX,0x18                        ; 004edebe | g_BloodSplatAnimTextures[1].base.type
    ...
    MOV EBP,0x67c028                    ; 004eded4 | g_BloodPoolAnimTextures
    XOR EDI,EDI                         ; 004eded9
    ADD EBP,0x2b8                       ; 004ededb
    IMUL EBX,EDI,0x2b8                  ; 004edee1
        ;   Label: LAB_004edee1
    MOV ESI,EBP                         ; 004edee7
    ADD EBX,0x67c028                    ; 004edee9 | g_BloodPoolAnimTextures[29].base.type
    PUSH EBX                            ; 004edeef | g_BloodPoolAnimTextures | g_BloodPoolAnimTextures[1].base.type | g_BloodPoolAnimTextures[29].base.type
        ;   Label: LAB_004edeef
    ...
    CALL engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80 ; 004edef7
        ;   XREF to: 0048db80 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80(CDemonRenderer * this_ptr, SMRGLTextureBasic * texture)
    ADD EBX,0x18                        ; 004edefc | g_BloodPoolAnimTextures[1].base.type
    ...
    PUSH 0x67cb28                       ; 004edf12 | g_FootstepTexture
