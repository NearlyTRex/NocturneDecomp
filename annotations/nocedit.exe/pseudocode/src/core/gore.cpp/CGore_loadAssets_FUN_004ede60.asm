...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_gore_cpp_CGore_loadAssets_FUN_004ede60(CGore *this_ptr)
;
; Parameters:
; CGore *          Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_game.cpp_CGame_loadAssets_FUN_004e07a0 at 004e07c6
;
; Referenced Globals:
;   CDemonRenderer* g_CDemonRendererPtr2 = 02c6d578
;   SMRGLTextureBasic SMRGLTextureBasic_0067b9b0
;   SMRGLTextureBasic[4] SMRGLTextureBasic_ARRAY_0067b9c8
;   undefined4 DAT_0067b9e0
;   SMRGLTextureBasic SMRGLTextureBasic_0067ba28
;   SMRGLTextureBasic[15] SMRGLTextureBasic_ARRAY_0067ba40
;   SMRGLTextureBasic[48] SMRGLTextureBasic_ARRAY_0067bba8
;   SMRGLTextureBasic SMRGLTextureBasic_0067c028
;   SMRGLTextureBasic[28] SMRGLTextureBasic_ARRAY_0067c040
;   SMRGLTextureBasic[87] SMRGLTextureBasic_ARRAY_0067c2e0
...
section .text
    ...
    PUSH EBX                            ; 004ede60
        ;   Label: core_gore.cpp_CGore_loadAssets_FUN_004ede60
    PUSH ESI                            ; 004ede61
    PUSH EDI                            ; 004ede62
    PUSH EBP                            ; 004ede63
    PUSH 0x67b9b0                       ; 004ede64 | SMRGLTextureBasic_0067b9b0
    ...
    MOV EBX,0x67b9c8                    ; 004ede70 | SMRGLTextureBasic_ARRAY_0067b9c8
    CALL engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80 ; 004ede75
        ;   XREF to: 0048db80 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80(CDemonRenderer * this_ptr, SMRGLTextureBasic * texture)
    LEA ESI,[EBX + 0x60]                ; 004ede7a | SMRGLTextureBasic_0067ba28
    ADD ESP,0x8                         ; 004ede7d
    PUSH EBX                            ; 004ede80 | SMRGLTextureBasic_ARRAY_0067b9c8 | DAT_0067b9e0
        ;   Label: LAB_004ede80
    ...
    MOV EBP,0x67ba28                    ; 004ede97 | SMRGLTextureBasic_0067ba28
    XOR EDI,EDI                         ; 004ede9c
    ADD EBP,0x180                       ; 004ede9e
    IMUL EBX,EDI,0x180                  ; 004edea4
        ;   Label: LAB_004edea4
    MOV ESI,EBP                         ; 004edeaa
    ADD EBX,0x67ba28                    ; 004edeac | SMRGLTextureBasic_ARRAY_0067bba8 | SMRGLTextureBasic_0067ba28
    PUSH EBX                            ; 004edeb2 | SMRGLTextureBasic_0067ba28 | SMRGLTextureBasic_ARRAY_0067ba40 | SMRGLTextureBasic_ARRAY_0067bba8
        ;   Label: LAB_004edeb2
    ...
    CALL engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80 ; 004edeb9
        ;   XREF to: 0048db80 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80(CDemonRenderer * this_ptr, SMRGLTextureBasic * texture)
    ADD EBX,0x18                        ; 004edebe | SMRGLTextureBasic_ARRAY_0067ba40
    ...
    MOV EBP,0x67c028                    ; 004eded4 | SMRGLTextureBasic_0067c028
    XOR EDI,EDI                         ; 004eded9
    ADD EBP,0x2b8                       ; 004ededb
    IMUL EBX,EDI,0x2b8                  ; 004edee1
        ;   Label: LAB_004edee1
    MOV ESI,EBP                         ; 004edee7
    ADD EBX,0x67c028                    ; 004edee9 | SMRGLTextureBasic_ARRAY_0067c2e0 | SMRGLTextureBasic_0067c028
    PUSH EBX                            ; 004edeef | SMRGLTextureBasic_0067c028 | SMRGLTextureBasic_ARRAY_0067c040 | SMRGLTextureBasic_ARRAY_0067c2e0
        ;   Label: LAB_004edeef
    ...
    CALL engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80 ; 004edef7
        ;   XREF to: 0048db80 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80(CDemonRenderer * this_ptr, SMRGLTextureBasic * texture)
    ADD EBX,0x18                        ; 004edefc | SMRGLTextureBasic_ARRAY_0067c040
    ...
    PUSH 0x67cb28                       ; 004edf12 | SMRGLTextureBasic_0067cb28
