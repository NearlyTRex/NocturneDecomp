...
;                               FUNCTION
; *****************************************************************************
; __cdecl CBloodParticle * __cdecl core_gore_cpp_CBloodParticle_ctor_FUN_004ee3f0(CBloodParticle *this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x4]       ; 004ee3f0
        ;   Label: core_gore.cpp_CBloodParticle_ctor_FUN_004ee3f0
    PUSH EDX                            ; 004ee3f4
    CALL core_particle.cpp_CParticle_ctor_FUN_00545650 ; 004ee3f5
    ...
    MOV dword ptr [EAX + 0x34],0x65f044 ; 004ee3fd | PTR_core_particle.cpp_FUN_0065f044
    RET                                 ; 004ee404
