...
;   core_gore.cpp_CBloodSplat_load_FUN_004ecb00
...
section .text
    ...
    PUSH EBX                            ; 004ee1e0
        ;   Label: core_gore.cpp_CGore_load_FUN_004ee1e0
    PUSH ESI                            ; 004ee1e1
    PUSH EDI                            ; 004ee1e2
    PUSH EBP                            ; 004ee1e3
    ...
    PUSH 0x2d873d8                      ; 004ee240 | g_BloodSplatCount
        ;   Label: LAB_004ee240
    ...
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004ee24d
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fscanf_FUN_005fe7c0(_FILE * file, char * format)
    MOV EBX,dword ptr [0x02d873d8]      ; 004ee252 | g_BloodSplatCount
