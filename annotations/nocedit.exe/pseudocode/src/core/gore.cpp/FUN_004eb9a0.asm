...
section .text
    ...
    CALL core_actor.cpp_getRandomInt_FUN_0040cc70 ; 004eb9b0 | int core_actor.cpp_getRandomInt_FUN_0040cc70(int min_value, int max_value)
    ...
    CALL core_particle.cpp_CParticle_setup_FUN_00545680 ; 004eb9c6 | void core_particle.cpp_CParticle_setup_FUN_00545680(CParticle * this_ptr, CVector3f * position, CVector3f * velocity)
