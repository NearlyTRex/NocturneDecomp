...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_gore_cpp_CBloodSplat_FUN_004ec2f0(CBloodSplat *this_ptr)
;
; Parameters:
; CBloodSplat *    Stack[0x4]:4   this_ptr
;
; XREF[1]:
;   core_gore.cpp_CGore_FUN_004edb40 at 004edb62
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004ec2f0
        ;   Label: core_gore.cpp_CBloodSplat_FUN_004ec2f0
    PUSH ESI                            ; 004ec2f1
    PUSH EDI                            ; 004ec2f2
