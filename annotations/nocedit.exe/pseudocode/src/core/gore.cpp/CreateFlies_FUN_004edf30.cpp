...

{
  ...
  fVar2 = (float)60;
  (this_ptr_00->base_actor).location.position.x = *param_6;
  (this_ptr_00->base_actor).location.position.y = param_6[1];
  (this_ptr_00->base_actor).location.position.z = param_6[2];
  ...
  *(uint **)(this_ptr_00->field1_0x158 + 0x28b4) = param_9;
  *(float *)(this_ptr_00->field1_0x158 + 0x28bc) = fVar2 / param_10;
  if ((param_9 != (uint *)0x0) && (this_ptr_00->field1_0x158 != (char *)param_9)) {
    *(uint *)this_ptr_00->field1_0x158 = *param_9;
    *(uint *)(this_ptr_00->field1_0x158 + 4) = param_9[1];
    *(uint *)(this_ptr_00->field1_0x158 + 8) = param_9[2];
  }
