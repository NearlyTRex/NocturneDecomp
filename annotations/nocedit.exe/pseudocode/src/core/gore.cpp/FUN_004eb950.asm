...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_gore.cpp_FUN_004eb950()
;
;
; *****************************************************************************
...
section .text
    ...
    JC 0x004eb981                       ; 004eb964 | LAB_004eb981
        ;   XREF to: 004eb981 (CONDITIONAL_JUMP)
    JBE 0x004eb989                      ; 004eb966 | LAB_004eb989
        ;   XREF to: 004eb989 (CONDITIONAL_JUMP)
    CMP EAX,0x2                         ; 004eb968
    JNZ 0x004eb981                      ; 004eb96b | LAB_004eb981
        ;   XREF to: 004eb981 (CONDITIONAL_JUMP)
    ...
    MOV dword ptr [EDX],0x2000          ; 004eb981
        ;   Label: LAB_004eb981
    JMP 0x004eb973                      ; 004eb987 | LAB_004eb973
