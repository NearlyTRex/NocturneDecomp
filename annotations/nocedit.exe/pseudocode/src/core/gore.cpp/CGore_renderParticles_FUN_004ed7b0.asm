...
;   core_set.cpp_CDemonSet_renderGogglesView_FUN_0056c990 at 0056cb77
...
section .text
    ...
    PUSH EBX                            ; 004ed7b0
        ;   Label: core_gore.cpp_CGore_renderParticles_FUN_004ed7b0
    PUSH ESI                            ; 004ed7b1
    PUSH EBP                            ; 004ed7b2
    ...
    CALL core_gore.cpp_CBloodParticle_setupRenderState_FUN_004eb9d0 ; 004ed7fa
