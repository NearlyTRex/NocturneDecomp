...
;
; Parameters:
; int              Stack[0x4]:4   blood_type
; int *            Stack[0x8]:4   out_light
; int *            Stack[0xc]:4   out_color
; int *            Stack[0x10]:4   out_fog
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 004eb950
        ;   Label: core_gore.cpp_getBloodColorParams_FUN_004eb950
