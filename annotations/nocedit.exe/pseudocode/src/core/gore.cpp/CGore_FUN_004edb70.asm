...
;
; Called Functions:
;   core_gore.cpp_CBloodSplat_FUN_004ec390
...
section .text
    ...
    PUSH ECX                            ; 004edb7f
    CALL core_gore.cpp_CGore_FUN_004edaf0 ; 004edb80
    ...
    PUSH EDI                            ; 004edb96
    PUSH EAX                            ; 004edb97
    CALL core_gore.cpp_CBloodSplat_FUN_004ec390 ; 004edb98
        ;   XREF to: 004ec390 (UNCONDITIONAL_CALL)  ; void core_gore.cpp_CBloodSplat_FUN_004ec390(CBloodSplat * this_ptr)
