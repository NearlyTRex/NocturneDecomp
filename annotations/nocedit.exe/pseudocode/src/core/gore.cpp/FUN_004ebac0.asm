...
section .text
    ...
    MOV ESI,dword ptr [0x006703ec]      ; 004ebad2 | g_CDemonRendererPtr
    ...
    PUSH EAX                            ; 004ebb0c
    PUSH ESI                            ; 004ebb0d
    CALL wincore_windll.cpp_transformPoint_FUN_005b5a25 ; 004ebb0e
    ...
    PUSH EDI                            ; 004ebb25
        ;   Label: LAB_004ebb25
    MOV EDX,dword ptr [0x006703ec]      ; 004ebb26 | g_CDemonRendererPtr
    ...
    MOV ECX,dword ptr [0x006703ec]      ; 004ebb3c | g_CDemonRendererPtr
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 004ebb74 | g_CDemonRendererPtr
    ...
    PUSH EAX                            ; 004ebba3
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 004ebba4
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 004ebbd5 | g_CDemonRendererPtr
    ...
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 004ebc0d
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 004ebc37 | g_CDemonRendererPtr
    ...
    PUSH EAX                            ; 004ebc69
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 004ebc6a
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    MOV ECX,0xbdcccccd                  ; 004ebc6f
    LEA EBX,[ESP + 0x6c]                ; 004ebc74
    LEA EAX,[ESP + 0xb4]                ; 004ebc78
    ADD ESP,0x8                         ; 004ebc7f
    MOV EDX,dword ptr [0x006703ec]      ; 004ebc82 | g_CDemonRendererPtr
    ...
    PUSH 0x67b9b0                       ; 004ebcd6 | DAT_0067b9b0
    MOV EAX,[0x006703ec]                ; 004ebcdb | g_CDemonRendererPtr
    ...
    MOV EAX,dword ptr [ESP + 0xd0]      ; 004ebdb9
        ;   Label: LAB_004ebdb9
    MOV EDX,dword ptr [ECX + 0x688034]  ; 004ebdc0 | g_RenderVertexBuffer[0].light | g_RenderVertexBuffer[1].light
    IMUL EDX                            ; 004ebdc6
    SHRD EAX,EDX,0x10                   ; 004ebdc8
    MOV EDX,dword ptr [ECX + 0x688038]  ; 004ebdcc | g_RenderVertexBuffer[0].color | g_RenderVertexBuffer[1].color
    MOV dword ptr [ECX + 0x688034],EAX  ; 004ebdd2 | g_RenderVertexBuffer[0].light | g_RenderVertexBuffer[1].light
    MOV EAX,dword ptr [ESP + 0xd8]      ; 004ebdd8
    IMUL EDX                            ; 004ebddf
    SHRD EAX,EDX,0x10                   ; 004ebde1
    MOV EDX,dword ptr [ECX + 0x68803c]  ; 004ebde5 | g_RenderVertexBuffer[0].fog | g_RenderVertexBuffer[1].fog
    MOV dword ptr [ECX + 0x688038],EAX  ; 004ebdeb | g_RenderVertexBuffer[0].color | g_RenderVertexBuffer[1].color
    MOV EAX,dword ptr [ESP + 0xd4]      ; 004ebdf1
    ADD ECX,0x30                        ; 004ebdf8
    IMUL EDX                            ; 004ebdfb
    SHRD EAX,EDX,0x10                   ; 004ebdfd
    MOV dword ptr [ECX + 0x68800c],EAX  ; 004ebe01 | g_RenderVertexBuffer[0].fog | g_RenderVertexBuffer[1].fog
    ...
    PUSH EAX                            ; 004ebe2e
    MOV ESI,dword ptr [0x006703ec]      ; 004ebe2f | g_CDemonRendererPtr
    ...
    PUSH 0x2d83368                      ; 004ebe3e | DAT_02d83368
    MOV EAX,[0x006703ec]                ; 004ebe43 | g_CDemonRendererPtr
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 004ebe51 | g_CDemonRendererPtr
    PUSH EDX                            ; 004ebe57 | g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_matrixPop_FUN_0050d720 ; 004ebe58
