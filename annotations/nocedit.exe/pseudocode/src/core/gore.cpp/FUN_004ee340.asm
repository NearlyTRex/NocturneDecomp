...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_gore.cpp_FUN_004ee340()
;
;
; Referenced Globals:
...
section .text
    ...
    FMUL float ptr [0x0065f028]         ; 004ee34b | DAT_0065f028
    FISTP dword ptr [EBX]               ; 004ee351
    FLD float ptr [EAX + 0x4]           ; 004ee353
    FMUL float ptr [0x0065f028]         ; 004ee356 | DAT_0065f028
    FISTP dword ptr [EBX + 0x4]         ; 004ee35c
    FLD float ptr [EAX + 0x8]           ; 004ee35f
    FMUL float ptr [0x0065f028]         ; 004ee362 | DAT_0065f028
