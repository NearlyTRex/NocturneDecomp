...
;
; XREF[1]:
;   core_gore.cpp_CGore_renderDecals_FUN_004ed830 at 004ed85a
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004ec470
        ;   Label: core_gore.cpp_CBloodSplat_setupRenderState_FUN_004ec470
    PUSH ESI                            ; 004ec471
    PUSH EDI                            ; 004ec472
    PUSH EBP                            ; 004ec473
    ...
    MOV EAX,0xf80000                    ; 004ec48d | g_LightBufferPool[11][183800]
    PUSH 0xffff                         ; 004ec492
    XOR ECX,ECX                         ; 004ec497
    MOV dword ptr [0x02d8336c],EDX      ; 004ec499 | g_GoreQuadPrimitive.base.base.count
    MOV dword ptr [0x02d83380],ECX      ; 004ec49f | g_GoreQuadPrimitive.vertices[0]
    MOV dword ptr [0x02d83384],EBX      ; 004ec4a5 | g_GoreQuadPrimitive.vertices[1]
    MOV dword ptr [0x02d83388],ESI      ; 004ec4ab | g_GoreQuadPrimitive.vertices[2]
    MOV dword ptr [0x02d8338c],EDI      ; 004ec4b1 | g_GoreQuadPrimitive.vertices[3]
