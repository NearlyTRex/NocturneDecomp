...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_gore.cpp_FUN_004ed240()
;
; Local Variables:
...
;
; XREF[1]:
;   core_gore.cpp_CGore_FUN_004ee070 at 004ee0d0
;
; Referenced Globals:
...
section .text
    ...
    FCOS                                ; 004ed263
    FXCH                                ; 004ed265
    FLD double ptr [0x0062e3e2]         ; 004ed267 | double DOUBLE_0062e3e2
    FXCH                                ; 004ed26d
    FMUL ST1                            ; 004ed26f
    FXCH ST2                            ; 004ed271
    FMULP                               ; 004ed273
    FLD ST1                             ; 004ed275
    FMUL float ptr [EBX + 0x67cb08]     ; 004ed277 | undefined4 DAT_0067cb08 | DAT_0067cb0c = -0x40800000
    FLD ST1                             ; 004ed27d
    FCHS                                ; 004ed27f
    FMUL float ptr [EBX + 0x67cb08]     ; 004ed281 | undefined4 DAT_0067cb08 | DAT_0067cb0c = -0x40800000
    FXCH ST2                            ; 004ed287
    FMUL float ptr [EBX + 0x67cb18]     ; 004ed289 | undefined4 DAT_0067cb18
    XOR EDX,EDX                         ; 004ed28f
    FXCH ST3                            ; 004ed291
    FMUL float ptr [EBX + 0x67cb18]     ; 004ed293 | undefined4 DAT_0067cb18
    ...
    JZ 0x004ed2e6                       ; 004ed2cd | LAB_004ed2e6
    ...
    FXCH                                ; 004ed2ff
    FADD float ptr [0x0062e3f2]         ; 004ed301 | float FLOAT_0062e3f2
    PUSH EAX                            ; 004ed307
    FXCH                                ; 004ed308
    FSTP float ptr [ESP + 0x14]         ; 004ed30a
    PUSH 0x3277d14                      ; 004ed30e | CDemonRaytrace g_CDemonRaytraceInstance
    FSTP float ptr [ESP + 0x24]         ; 004ed313
    CALL core_dtrace.cpp_CDemonRaytrace_rayVoxelIntersection_FUN_00495b70 ; 004ed317 | float core_dtrace.cpp_CDemonRaytrace_rayVoxelIntersection_FUN_00495b70(CDemonRaytrace * this_ptr, CVector3f * ray_start, CVector3f * ray_end, CVector3f * out_intersection_point, ...)
        ;   XREF to: 00495b70 (UNCONDITIONAL_CALL)
    MOV dword ptr [ESP + 0x3c],EAX      ; 004ed31c
    FLD float ptr [ESP + 0x3c]          ; 004ed320
    FMUL double ptr [0x0062e3ea]        ; 004ed324 | double DOUBLE_0062e3ea
    ADD ESP,0x14                        ; 004ed32a
    FSUBR float ptr [ESP + 0x4]         ; 004ed32d
    FADD float ptr [0x0062e3f6]         ; 004ed331 | float FLOAT_0062e3f6
    MOV EAX,ESP                         ; 004ed337
    FSTP float ptr [ESP + 0x4]          ; 004ed339
    CMP ESI,EAX                         ; 004ed33d
    JZ 0x004ed354                       ; 004ed33f | LAB_004ed354
    ...
    JNZ 0x004ed257                      ; 004ed35d | LAB_004ed257
    ...
    FABS                                ; 004ed378
    FCOMP double ptr [0x0062e3e2]       ; 004ed37a | double DOUBLE_0062e3e2
    FNSTSW AX                           ; 004ed380
    SAHF                                ; 004ed382
    JBE 0x004ed38e                      ; 004ed383 | LAB_004ed38e
    ...
    JNZ 0x004ed36f                      ; 004ed393 | LAB_004ed36f
