...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_gore.cpp_FUN_004ed0a0()
;
;
; XREF[1]:
...
section .text
    ...
    MOV EDX,dword ptr [0x0067b654]      ; 004ed0a4 | CGame * g_CGamePtr
    ...
    FCOMP double ptr [0x0062e392]       ; 004ed0ba | double DOUBLE_0062e392
    FNSTSW AX                           ; 004ed0c0
    SAHF                                ; 004ed0c2
    JA 0x004ed0c6                       ; 004ed0c3 | LAB_004ed0c6
