...
section .text
    ...
    FMUL double ptr [0x0062e38a]        ; 004eccee | double DOUBLE_0062e38a
    CALL crt_math.c_round_FUN_005fe6b0  ; 004eccf4 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x3c]        ; 004eccf9
    MOV EDX,dword ptr [ESP + 0x3c]      ; 004eccfd
    TEST EDX,EDX                        ; 004ecd01
    JL 0x004ecf9f                       ; 004ecd03 | LAB_004ecf9f
        ;   XREF to: 004ecf9f (CONDITIONAL_JUMP)
    CMP EDX,0x1c                        ; 004ecd09
    JLE 0x004ecd25                      ; 004ecd0c | LAB_004ecd25
    ...
    JZ 0x004ecd25                       ; 004ecd1d | LAB_004ecd25
        ;   XREF to: 004ecd25 (CONDITIONAL_JUMP)
    MOV dword ptr [ESI],0x1             ; 004ecd1f
    LEA EAX,[ESI + 0x4]                 ; 004ecd25
        ;   Label: LAB_004ecd25
    PUSH EAX                            ; 004ecd28
    MOV EAX,[0x006703ec]                ; 004ecd29 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH EAX                            ; 004ecd2e | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450 ; 004ecd2f | void engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450(CDemonRenderer * this_ptr, CVector3f * world_position)
        ;   XREF to: 0048c450 (UNCONDITIONAL_CALL)
    IMUL EAX,dword ptr [ESI + 0x14],0x2b8 ; 004ecd34
    ADD ESP,0x8                         ; 004ecd3b
    MOV EBX,0x67c028                    ; 004ecd3e | SMRGLTextureBasic DAT_0067c028
    ...
    PUSH EAX                            ; 004ecd57
    MOV ECX,dword ptr [0x006703ec]      ; 004ecd58 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH ECX                            ; 004ecd5e | CDemonRenderer g_CDemonRendererInstance
    XOR EDI,EDI                         ; 004ecd5f
    MOV EBX,0xbfaa9fbe                  ; 004ecd61
    CALL engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80 ; 004ecd66 | void engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80(CDemonRenderer * this_ptr, SMRGLTextureBasic * texture)
        ;   XREF to: 0048db80 (UNCONDITIONAL_CALL)
    MOV EBP,EBX                         ; 004ecd6b
    LEA EAX,[ESP + 0x20]                ; 004ecd6d
    ADD ESP,0x8                         ; 004ecd71
    MOV EDX,dword ptr [0x006703ec]      ; 004ecd74 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    ...
    PUSH EAX                            ; 004ecdb0
    MOV EAX,dword ptr [EDX]             ; 004ecdb1 | CDemonRenderer g_CDemonRendererInstance
    PUSH EAX                            ; 004ecdb3
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 004ecdb4 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    MOV EAX,0x3faa9fbe                  ; 004ecdb9
    LEA EBX,[ESP + 0x14]                ; 004ecdbe
    MOV EDX,dword ptr [0x006703ec]      ; 004ecdc2 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    ...
    PUSH EAX                            ; 004ece03
    MOV EAX,dword ptr [EDX]             ; 004ece04 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0x30                        ; 004ece06
    PUSH EAX                            ; 004ece09
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 004ece0a | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    MOV EBX,0x3faa9fbe                  ; 004ece0f
    LEA EAX,[ESP + 0x20]                ; 004ece14
    ADD ESP,0x8                         ; 004ece18
    MOV EDX,dword ptr [0x006703ec]      ; 004ece1b | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    ...
    PUSH EAX                            ; 004ece59
    MOV EAX,dword ptr [EDX]             ; 004ece5a | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0x60                        ; 004ece5c
    PUSH EAX                            ; 004ece5f
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 004ece60 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    MOV EAX,0xbfaa9fbe                  ; 004ece65
    LEA EBX,[ESP + 0x8]                 ; 004ece6a
    MOV EDX,dword ptr [0x006703ec]      ; 004ece6e | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    ...
    PUSH EAX                            ; 004ecead
    MOV EAX,dword ptr [EDX]             ; 004eceae | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0x90                        ; 004eceb0
    PUSH EAX                            ; 004eceb5
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 004eceb6 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ...
    JNC 0x004ecfdd                      ; 004eced3 | LAB_004ecfdd
    ...
    JNC 0x004ed01e                      ; 004ecf00 | LAB_004ed01e
    ...
    JNC 0x004ed05f                      ; 004ecf2d | LAB_004ed05f
    ...
    JC 0x004ed06b                       ; 004ecf5a | LAB_004ed06b
        ;   XREF to: 004ed06b (CONDITIONAL_JUMP)
    JBE 0x004ed082                      ; 004ecf60 | LAB_004ed082
        ;   XREF to: 004ed082 (CONDITIONAL_JUMP)
    CMP EAX,0x2                         ; 004ecf66
    JNZ 0x004ed06b                      ; 004ecf69 | LAB_004ed06b
        ;   XREF to: 004ed06b (CONDITIONAL_JUMP)
    ...
    PUSH 0x2d83368                      ; 004ecf83 | SMRGLHeaderPrimitive DAT_02d83368
        ;   Label: LAB_004ecf83
    MOV ECX,dword ptr [0x006703ec]      ; 004ecf88 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH ECX                            ; 004ecf8e | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_renderEnhancedQuality_FUN_0048bcf0 ; 004ecf8f | void engine_drender.cpp_CDemonRenderer_renderEnhancedQuality_FUN_0048bcf0(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * polygon_info)
    ...
    JMP 0x004ecd25                      ; 004ecfa5 | LAB_004ecd25
    ...
    JMP 0x004eceeb                      ; 004ecfc1 | LAB_004eceeb
    ...
    JMP 0x004eceeb                      ; 004ecfd8 | LAB_004eceeb
        ;   XREF to: 004eceeb (UNCONDITIONAL_JUMP)
    JBE 0x004ecfaa                      ; 004ecfdd | LAB_004ecfaa
        ;   Label: LAB_004ecfdd
        ;   XREF to: 004ecfaa (CONDITIONAL_JUMP)
    CMP EAX,0x2                         ; 004ecfdf
    JZ 0x004ecfc6                       ; 004ecfe2 | LAB_004ecfc6
        ;   XREF to: 004ecfc6 (CONDITIONAL_JUMP)
    JMP 0x004eced9                      ; 004ecfe4 | LAB_004eced9
    ...
    JMP 0x004ecf18                      ; 004ed000 | LAB_004ecf18
    ...
    JMP 0x004ecf18                      ; 004ed019 | LAB_004ecf18
        ;   XREF to: 004ecf18 (UNCONDITIONAL_JUMP)
    JBE 0x004ecfe9                      ; 004ed01e | LAB_004ecfe9
        ;   Label: LAB_004ed01e
        ;   XREF to: 004ecfe9 (CONDITIONAL_JUMP)
    CMP EAX,0x2                         ; 004ed020
    JZ 0x004ed005                       ; 004ed023 | LAB_004ed005
        ;   XREF to: 004ed005 (CONDITIONAL_JUMP)
    JMP 0x004ecf06                      ; 004ed025 | LAB_004ecf06
    ...
    JMP 0x004ecf45                      ; 004ed041 | LAB_004ecf45
    ...
    JMP 0x004ecf45                      ; 004ed05a | LAB_004ecf45
        ;   XREF to: 004ecf45 (UNCONDITIONAL_JUMP)
    JBE 0x004ed02a                      ; 004ed05f | LAB_004ed02a
        ;   Label: LAB_004ed05f
        ;   XREF to: 004ed02a (CONDITIONAL_JUMP)
    CMP EAX,0x2                         ; 004ed061
    JZ 0x004ed046                       ; 004ed064 | LAB_004ed046
        ;   XREF to: 004ed046 (CONDITIONAL_JUMP)
    JMP 0x004ecf33                      ; 004ed066 | LAB_004ecf33
    ...
    JMP 0x004ecf83                      ; 004ed07d | LAB_004ecf83
    ...
    JMP 0x004ecf83                      ; 004ed09a | LAB_004ecf83
        ;   XREF to: 004ecf83 (UNCONDITIONAL_JUMP)
