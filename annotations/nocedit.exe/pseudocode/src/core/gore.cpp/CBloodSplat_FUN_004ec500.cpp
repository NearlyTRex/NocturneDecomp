// Name: core_gore.cpp_CBloodSplat_FUN_004ec500
// Address: 004ec500
// Address Range: [[004ec500, 004ecac1]]
// Convention: __cdecl
// Signature: void __cdecl core_gore_cpp_CBloodSplat_FUN_004ec500(CBloodSplat *this_ptr)
...

{
  ...
  dVar2 = round
                    ((double)(*(float *)(this_ptr->unk + 0x24) * (float)8 +
                             (float)4));
  ...
  if (*(int *)(this_ptr->unk + 0x10) == 1) {
    ...
    local_74 = 0xbf000000;
    local_70 = 0;
    local_6c.x = (int)ROUND(256.0f * -0.5);
    local_6c.y = (int)ROUND(256.0f * -0.5);
    ...
    local_3c.y = (int)ROUND(256.0f * 0.5);
    ...
    local_84.y = (int)ROUND(256.0f * 0.5);
    ...
    local_24.z = (int)ROUND(256.0f * -0.5);
    wincore_windll_cpp_transformAndProjectPoint_FUN_005b575c
    ...
    CStack_90.y = (int)ROUND(256.0f * 0.0);
    CStack_90.z = (int)ROUND(256.0f * -0.5);
    wincore_windll_cpp_transformAndProjectPoint_FUN_005b575c
