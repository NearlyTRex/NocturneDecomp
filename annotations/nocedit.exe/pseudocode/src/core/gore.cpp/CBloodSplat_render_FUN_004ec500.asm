...
;   undefined4 g_RenderVertexBuffer[2].b
;   ... and 9 more
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 004ec500
        ;   Label: core_gore.cpp_CBloodSplat_render_FUN_004ec500
    PUSH ESI                            ; 004ec501
    PUSH EDI                            ; 004ec502
    PUSH EBP                            ; 004ec503
    ...
    MOV dword ptr [0x02d83370],EDX      ; 004ec575 | g_GoreQuadPrimitive.base.surface_normal.A
    MOV dword ptr [0x02d83378],EBX      ; 004ec57b | g_GoreQuadPrimitive.base.surface_normal.C
    MOV EBX,dword ptr [ESI + 0x28]      ; 004ec581
    MOV dword ptr [0x02d83374],EDX      ; 004ec584 | g_GoreQuadPrimitive.base.surface_normal.B
    LEA EAX,[EBX*0x4 + 0x0]             ; 004ec58a
    MOV dword ptr [0x02d8337c],EDX      ; 004ec591 | g_GoreQuadPrimitive.base.surface_normal.D
    SUB EAX,EBX                         ; 004ec597
    MOV EDX,0x67ba28                    ; 004ec599 | g_BloodSplatAnimTextures
    ...
    FMUL float ptr [0x0065f024]         ; 004ec5fd | FLOAT_0065f024
    FISTP dword ptr [EBX]               ; 004ec603
    FLD float ptr [EAX + 0x4]           ; 004ec605
    FMUL float ptr [0x0065f024]         ; 004ec608 | FLOAT_0065f024
    FISTP dword ptr [EBX + 0x4]         ; 004ec60e
    FLD float ptr [EAX + 0x8]           ; 004ec611
    FMUL float ptr [0x0065f024]         ; 004ec614 | FLOAT_0065f024
    ...
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 004ec62f
    ...
    FMUL float ptr [0x0065f024]         ; 004ec655 | FLOAT_0065f024
    FISTP dword ptr [EBX]               ; 004ec65b
    FLD float ptr [EAX + 0x4]           ; 004ec65d
    FMUL float ptr [0x0065f024]         ; 004ec660 | FLOAT_0065f024
    FISTP dword ptr [EBX + 0x4]         ; 004ec666
    FLD float ptr [EAX + 0x8]           ; 004ec669
    FMUL float ptr [0x0065f024]         ; 004ec66c | FLOAT_0065f024
    ...
    PUSH EAX                            ; 004ec67f
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 004ec680
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    FMUL float ptr [0x0065f024]         ; 004ec6a6 | FLOAT_0065f024
    FISTP dword ptr [EBX]               ; 004ec6ac
    FLD float ptr [EAX + 0x4]           ; 004ec6ae
    FMUL float ptr [0x0065f024]         ; 004ec6b1 | FLOAT_0065f024
    FISTP dword ptr [EBX + 0x4]         ; 004ec6b7
    FLD float ptr [EAX + 0x8]           ; 004ec6ba
    FMUL float ptr [0x0065f024]         ; 004ec6bd | FLOAT_0065f024
    ...
    PUSH EAX                            ; 004ec6d0
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 004ec6d1
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    FMUL float ptr [0x0065f024]         ; 004ec6f7 | FLOAT_0065f024
    FISTP dword ptr [EBX]               ; 004ec6fd
    FLD float ptr [EAX + 0x4]           ; 004ec6ff
    FMUL float ptr [0x0065f024]         ; 004ec702 | FLOAT_0065f024
    FISTP dword ptr [EBX + 0x4]         ; 004ec708
    FLD float ptr [EAX + 0x8]           ; 004ec70b
    FMUL float ptr [0x0065f024]         ; 004ec70e | FLOAT_0065f024
    ...
    PUSH EAX                            ; 004ec723
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 004ec724
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ADD ESP,0x8                         ; 004ec729
    MOV EBX,0x688034                    ; 004ec72c | g_RenderVertexBuffer[0].r
    MOV EDX,0x688038                    ; 004ec731 | g_RenderVertexBuffer[0].g
    MOV EAX,dword ptr [ESI + 0x14]      ; 004ec736
    MOV ECX,0x68803c                    ; 004ec739 | g_RenderVertexBuffer[0].b
    CMP EAX,0x1                         ; 004ec73e
    JNC 0x004ec9e1                      ; 004ec741
        ;   XREF to: 004ec9e1 (CONDITIONAL_JUMP)  ; LAB_004ec9e1
    MOV dword ptr [EBX],0x2000          ; 004ec747 | g_RenderVertexBuffer[0].r
        ;   Label: LAB_004ec747
    MOV dword ptr [EDX],0x0             ; 004ec74d | g_RenderVertexBuffer[0].g
    MOV dword ptr [ECX],0x0             ; 004ec753 | g_RenderVertexBuffer[0].b
    MOV ECX,0x688064                    ; 004ec759 | g_RenderVertexBuffer[1].r
        ;   Label: LAB_004ec759
    MOV EBX,0x688068                    ; 004ec75e | g_RenderVertexBuffer[1].g
    MOV EAX,dword ptr [ESI + 0x14]      ; 004ec763
    MOV EDX,0x68806c                    ; 004ec766 | g_RenderVertexBuffer[1].b
    CMP EAX,0x1                         ; 004ec76b
    JNC 0x004eca24                      ; 004ec76e
        ;   XREF to: 004eca24 (CONDITIONAL_JUMP)  ; LAB_004eca24
    MOV dword ptr [ECX],0x2000          ; 004ec774 | g_RenderVertexBuffer[1].r
        ;   Label: LAB_004ec774
    MOV dword ptr [EBX],0x0             ; 004ec77a | g_RenderVertexBuffer[1].g
    MOV dword ptr [EDX],0x0             ; 004ec780 | g_RenderVertexBuffer[1].b
    MOV EDX,0x688094                    ; 004ec786 | g_RenderVertexBuffer[2].r
        ;   Label: LAB_004ec786
    MOV ECX,0x688098                    ; 004ec78b | g_RenderVertexBuffer[2].g
    MOV EAX,dword ptr [ESI + 0x14]      ; 004ec790
    MOV EBX,0x68809c                    ; 004ec793 | g_RenderVertexBuffer[2].b
    CMP EAX,0x1                         ; 004ec798
    JNC 0x004eca67                      ; 004ec79b
        ;   XREF to: 004eca67 (CONDITIONAL_JUMP)  ; LAB_004eca67
    MOV dword ptr [EDX],0x2000          ; 004ec7a1 | g_RenderVertexBuffer[2].r
        ;   Label: LAB_004ec7a1
    MOV dword ptr [ECX],0x0             ; 004ec7a7 | g_RenderVertexBuffer[2].g
    MOV dword ptr [EBX],0x0             ; 004ec7ad | g_RenderVertexBuffer[2].b
    MOV EBX,0x6880c4                    ; 004ec7b3 | g_RenderVertexBuffer[3].r
        ;   Label: LAB_004ec7b3
    MOV ECX,0x6880c8                    ; 004ec7b8 | g_RenderVertexBuffer[3].g
    MOV EAX,dword ptr [ESI + 0x14]      ; 004ec7bd
    MOV EDX,0x6880cc                    ; 004ec7c0 | g_RenderVertexBuffer[3].b
    CMP EAX,0x1                         ; 004ec7c5
    JNC 0x004ecaaa                      ; 004ec7c8
        ;   XREF to: 004ecaaa (CONDITIONAL_JUMP)  ; LAB_004ecaaa
    MOV dword ptr [EBX],0x2000          ; 004ec7ce | g_RenderVertexBuffer[3].r
        ;   Label: LAB_004ec7ce
    MOV dword ptr [ECX],0x0             ; 004ec7d4 | g_RenderVertexBuffer[3].g
    MOV dword ptr [EDX],0x0             ; 004ec7da | g_RenderVertexBuffer[3].b
    ...
    CALL engine_drender.cpp_CDemonRenderer_renderBlendedDirect_FUN_0048bcf0 ; 004ec7ec
    ...
    MOV dword ptr [0x02d83374],0xffff   ; 004ec81d | g_GoreQuadPrimitive.base.surface_normal.B
        ;   Label: LAB_004ec81d
    ...
    ADD EAX,0x67b9c8                    ; 004ec83a | g_BloodSplatTextures
    MOV dword ptr [0x02d83370],ECX      ; 004ec83f | g_GoreQuadPrimitive.base.surface_normal.A
    PUSH EAX                            ; 004ec845
    MOV EAX,[0x006703ec]                ; 004ec846 | g_CDemonRendererPtr2
    MOV dword ptr [0x02d83378],ECX      ; 004ec84b | g_GoreQuadPrimitive.base.surface_normal.C
    PUSH EAX                            ; 004ec851 | g_CDemonRendererInstance
    MOV dword ptr [0x02d8337c],ECX      ; 004ec852 | g_GoreQuadPrimitive.base.surface_normal.D
    ...
    FMUL float ptr [0x0065f024]         ; 004ec881 | FLOAT_0065f024
    FISTP dword ptr [EBX]               ; 004ec887
    FLD float ptr [EAX + 0x4]           ; 004ec889
    FMUL float ptr [0x0065f024]         ; 004ec88c | FLOAT_0065f024
    FISTP dword ptr [EBX + 0x4]         ; 004ec892
    FLD float ptr [EAX + 0x8]           ; 004ec895
    FMUL float ptr [0x0065f024]         ; 004ec898 | FLOAT_0065f024
    ...
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 004ec8b0
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    FMUL float ptr [0x0065f024]         ; 004ec8d9 | FLOAT_0065f024
    FISTP dword ptr [EBX]               ; 004ec8df
    FLD float ptr [EAX + 0x4]           ; 004ec8e1
    FMUL float ptr [0x0065f024]         ; 004ec8e4 | FLOAT_0065f024
    FISTP dword ptr [EBX + 0x4]         ; 004ec8ea
    FLD float ptr [EAX + 0x8]           ; 004ec8ed
    FMUL float ptr [0x0065f024]         ; 004ec8f0 | FLOAT_0065f024
    ...
    PUSH EAX                            ; 004ec901
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 004ec902
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    FMUL float ptr [0x0065f024]         ; 004ec928 | FLOAT_0065f024
    FISTP dword ptr [EBX]               ; 004ec92e
    FLD float ptr [EAX + 0x4]           ; 004ec930
    FMUL float ptr [0x0065f024]         ; 004ec933 | FLOAT_0065f024
    FISTP dword ptr [EBX + 0x4]         ; 004ec939
    FLD float ptr [EAX + 0x8]           ; 004ec93c
    FMUL float ptr [0x0065f024]         ; 004ec93f | FLOAT_0065f024
    ...
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 004ec958
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    FMUL float ptr [0x0065f024]         ; 004ec981 | FLOAT_0065f024
    FISTP dword ptr [EBX]               ; 004ec987
    FLD float ptr [EAX + 0x4]           ; 004ec989
    FMUL float ptr [0x0065f024]         ; 004ec98c | FLOAT_0065f024
    FISTP dword ptr [EBX + 0x4]         ; 004ec992
    FLD float ptr [EAX + 0x8]           ; 004ec995
    FMUL float ptr [0x0065f024]         ; 004ec998 | FLOAT_0065f024
    ...
    MOV dword ptr [0x00688038],EBP      ; 004ec9b1 | g_RenderVertexBuffer[0].g
    MOV dword ptr [0x0068803c],EDI      ; 004ec9b7 | g_RenderVertexBuffer[0].b
    MOV dword ptr [0x00688034],EDI      ; 004ec9bd | g_RenderVertexBuffer[0].r
    JMP 0x004ec759                      ; 004ec9c3
        ;   XREF to: 004ec759 (UNCONDITIONAL_JUMP)  ; LAB_004ec759
    XOR EDX,EDX                         ; 004ec9c8
        ;   Label: LAB_004ec9c8
    MOV dword ptr [0x00688038],EDX      ; 004ec9ca | g_RenderVertexBuffer[0].g
    MOV dword ptr [0x0068803c],EDX      ; 004ec9d0 | g_RenderVertexBuffer[0].b
    MOV dword ptr [0x00688034],EDX      ; 004ec9d6 | g_RenderVertexBuffer[0].r
    ...
    MOV dword ptr [0x00688068],EBP      ; 004ec9f4 | g_RenderVertexBuffer[1].g
    MOV dword ptr [0x0068806c],EDI      ; 004ec9fa | g_RenderVertexBuffer[1].b
    MOV dword ptr [0x00688064],EDI      ; 004eca00 | g_RenderVertexBuffer[1].r
    JMP 0x004ec786                      ; 004eca06
        ;   XREF to: 004ec786 (UNCONDITIONAL_JUMP)  ; LAB_004ec786
    XOR EDX,EDX                         ; 004eca0b
        ;   Label: LAB_004eca0b
    MOV dword ptr [0x00688068],EDX      ; 004eca0d | g_RenderVertexBuffer[1].g
    MOV dword ptr [0x0068806c],EDX      ; 004eca13 | g_RenderVertexBuffer[1].b
    MOV dword ptr [0x00688064],EDX      ; 004eca19 | g_RenderVertexBuffer[1].r
    ...
    MOV dword ptr [0x00688098],EBP      ; 004eca37 | g_RenderVertexBuffer[2].g
    MOV dword ptr [0x0068809c],EDI      ; 004eca3d | g_RenderVertexBuffer[2].b
    MOV dword ptr [0x00688094],EDI      ; 004eca43 | g_RenderVertexBuffer[2].r
    JMP 0x004ec7b3                      ; 004eca49
        ;   XREF to: 004ec7b3 (UNCONDITIONAL_JUMP)  ; LAB_004ec7b3
    XOR EDX,EDX                         ; 004eca4e
        ;   Label: LAB_004eca4e
    MOV dword ptr [0x00688098],EDX      ; 004eca50 | g_RenderVertexBuffer[2].g
    MOV dword ptr [0x0068809c],EDX      ; 004eca56 | g_RenderVertexBuffer[2].b
    MOV dword ptr [0x00688094],EDX      ; 004eca5c | g_RenderVertexBuffer[2].r
    ...
    MOV dword ptr [0x006880c8],EBP      ; 004eca7a | g_RenderVertexBuffer[3].g
    MOV dword ptr [0x006880cc],EDI      ; 004eca80 | g_RenderVertexBuffer[3].b
    MOV dword ptr [0x006880c4],EDI      ; 004eca86 | g_RenderVertexBuffer[3].r
    JMP 0x004ec7e0                      ; 004eca8c
        ;   XREF to: 004ec7e0 (UNCONDITIONAL_JUMP)  ; LAB_004ec7e0
    XOR EDX,EDX                         ; 004eca91
        ;   Label: LAB_004eca91
    MOV dword ptr [0x006880c8],EDX      ; 004eca93 | g_RenderVertexBuffer[3].g
    MOV dword ptr [0x006880cc],EDX      ; 004eca99 | g_RenderVertexBuffer[3].b
    MOV dword ptr [0x006880c4],EDX      ; 004eca9f | g_RenderVertexBuffer[3].r
    ...
    CALL engine_drender.cpp_CDemonRenderer_matrixPop_FUN_0048c640 ; 004ecabd
        ;   XREF to: 0048c640 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_matrixPop_FUN_0048c640(CDemonRenderer * this_ptr)
    ADD ESP,0x4                         ; 004ecac2
    ADD ESP,0x7c                        ; 004ecac5
    POP EBP                             ; 004ecac8
    POP EDI                             ; 004ecac9
    POP ESI                             ; 004ecaca
    POP EBX                             ; 004ecacb
