...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_gore.cpp_FUN_004ecad0()
;
;
; XREF[1]:
...
section .text
    ...
    MOV EDX,dword ptr [0x0067b654]      ; 004ecad4 | CGame * g_CGamePtr
    ...
    FCOMP double ptr [0x0062e31a]       ; 004ecaea | double DOUBLE_0062e31a
    FNSTSW AX                           ; 004ecaf0
    SAHF                                ; 004ecaf2
    JA 0x004ecaf6                       ; 004ecaf3 | LAB_004ecaf6
