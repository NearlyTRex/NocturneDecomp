...
section .text
    ...
    PUSH EAX                            ; 004ecb15
    PUSH 0x62e322                       ; 004ecb16 | = "%f,%f,%f\n" | s_f_f_f_0062e322 = %f,%f,%f

    PUSH ESI                            ; 004ecb1b
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004ecb1c | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
    ...
    PUSH EAX                            ; 004ecb2c
    PUSH 0x62e32c                       ; 004ecb2d | = "%d,%d,%d\n" | s_d_d_d_0062e32c = %d,%d,%d

    PUSH ESI                            ; 004ecb32
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004ecb33 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 004ecb46
    PUSH 0x62e336                       ; 004ecb47 | = "%f,%f,%f\n" | s_f_f_f_0062e336 = %f,%f,%f

    PUSH ESI                            ; 004ecb4c
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004ecb4d | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ...
    PUSH EBX                            ; 004ecb70
    PUSH 0x62e340                       ; 004ecb71 | = "%d,%d,%d,%d,%d,%d,%d\n" | s_d_d_d_d_d_d_d_0062e340 = %d,%d,%d,%d,%d,%d,%d

    PUSH ESI                            ; 004ecb76
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004ecb77 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
