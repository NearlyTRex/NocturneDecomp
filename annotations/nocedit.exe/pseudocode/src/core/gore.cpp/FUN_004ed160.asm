...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_gore.cpp_FUN_004ed160()
;
;
; XREF[1]:
...
section .text
    ...
    PUSH EAX                            ; 004ed175
    PUSH 0x62e39e                       ; 004ed176 | = "%f,%f,%f\n" | s_f_f_f_0062e39e = %f,%f,%f

    PUSH ESI                            ; 004ed17b
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004ed17c | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
    ...
    PUSH ESI                            ; 004ed18e
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004ed18f | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
    ...
    PUSH EBX                            ; 004ed1aa
    PUSH 0x62e3af                       ; 004ed1ab | = "%d,%f,%d,%d,%d\n" | s_d_f_d_d_d_0062e3af = %d,%f,%d,%d,%d

    PUSH ESI                            ; 004ed1b0
    CALL crt_stdio.c_fscanf_FUN_005fe7c0 ; 004ed1b1 | int crt_stdio.c_fscanf_FUN_005fe7c0(FILE * file, char * format)
        ;   XREF to: 005fe7c0 (UNCONDITIONAL_CALL)
