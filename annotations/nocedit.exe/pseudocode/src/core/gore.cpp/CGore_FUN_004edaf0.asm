...
;                               FUNCTION
; *****************************************************************************
; __cdecl CBloodSplat * __cdecl core_gore_cpp_CGore_FUN_004edaf0(CGore *this_ptr)
;
; Parameters:
; CGore *          Stack[0x4]:4   this_ptr
;
; XREF[2]:
;   core_gore.cpp_CGore_FUN_004edb40 at 004edb4f
;   core_gore.cpp_CGore_FUN_004edb70 at 004edb80
;
; Referenced Globals:
...
section .text
    ...
    MOV ECX,dword ptr [0x02d873d4]      ; 004edaf0 | DAT_02d873d4
        ;   Label: core_gore.cpp_CGore_FUN_004edaf0
    ...
    MOV EDX,dword ptr [0x02d873d8]      ; 004edb10 | INT_02d873d8
        ;   Label: LAB_004edb10
    ...
    MOV dword ptr [0x02d873d8],EBX      ; 004edb29 | INT_02d873d8
    POP EBX                             ; 004edb2f
