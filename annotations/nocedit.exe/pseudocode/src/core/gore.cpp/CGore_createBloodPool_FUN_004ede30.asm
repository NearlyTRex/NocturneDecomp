...
;   core_dracbrid.cpp_CDraculaBride_process_FUN_00484410 at 00484ffe
...
;
; Called Functions:
;   core_gore.cpp_CBloodPool_init_FUN_004ed0d0
;   core_gore.cpp_CGore_allocateBloodPool_FUN_004edde0
;
; *****************************************************************************
...
section .text
    ...
    CMP dword ptr [ESP + 0xc],0x2       ; 004ede30
        ;   Label: core_gore.cpp_CGore_createBloodPool_FUN_004ede30
    ...
    PUSH ECX                            ; 004ede3e
    CALL core_gore.cpp_CGore_allocateBloodPool_FUN_004edde0 ; 004ede3f
        ;   XREF to: 004edde0 (UNCONDITIONAL_CALL)  ; CBloodPool * core_gore.cpp_CGore_allocateBloodPool_FUN_004edde0(CGore * this_ptr)
    ...
    PUSH ESI                            ; 004ede50
    PUSH EAX                            ; 004ede51
    CALL core_gore.cpp_CBloodPool_init_FUN_004ed0d0 ; 004ede52
        ;   XREF to: 004ed0d0 (UNCONDITIONAL_CALL)  ; void core_gore.cpp_CBloodPool_init_FUN_004ed0d0(CBloodPool * this_ptr, CVector3f * position, int blood_type)
