...

{
  ...
  if (*(int *)(this_ptr->field2_0x38 + 4) == 0) {
    ...
    g_RenderVertexBuffer[0].fog = 0x7ff;
    g_RenderVertexBuffer[1].light = 0x7ff;
    g_RenderVertexBuffer[1].color = 0x7ff;
    g_RenderVertexBuffer[1].fog = 0x7ff;
    g_RenderVertexBuffer[2].light = 0x7ff;
    g_RenderVertexBuffer[2].color = 0x7ff;
    g_RenderVertexBuffer[2].fog = 0x7ff;
    g_RenderVertexBuffer[3].light = 0x7ff;
    g_RenderVertexBuffer[3].color = 0x7ff;
    g_RenderVertexBuffer[3].fog = 0x7ff;
    g_RenderVertexBuffer[0].light = 0x7ff;
    goto LAB_004ed595;
  }
