...

{
  ...
  do {
    ...
    local_40.x = (float)(fVar3 * (float10)g_FootstepCornerMultipliers[1][iVar2 / 4] +
                         -fVar4 * (float10)g_FootstepCornerMultipliers[0][iVar2 / 4] +
                        (float10)position->x);
    local_40.z = (float)(fVar4 * (float10)g_FootstepCornerMultipliers[1][iVar2 / 4] +
                        fVar3 * (float10)g_FootstepCornerMultipliers[0][iVar2 / 4]) +
                 position->z;
