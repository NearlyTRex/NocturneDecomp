...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_gore.cpp_FUN_004edb70()
;
;
; XREF[1]:
...
section .text
    ...
    JNZ 0x004edb78                      ; 004edb75 | LAB_004edb78
    ...
    PUSH ECX                            ; 004edb7f
    CALL core_gore.cpp_FUN_004edaf0     ; 004edb80 | undefined core_gore.cpp_FUN_004edaf0()
    ...
    PUSH EDI                            ; 004edb96
    PUSH EAX                            ; 004edb97
    CALL core_gore.cpp_FUN_004ec390     ; 004edb98 | undefined core_gore.cpp_FUN_004ec390()
