    ...
    do {
      ...
      do {
        ...
        do {
          ...
          this_ptr_00->vertex_buffer_ptr[1].u = (0x8 << 16);
          ...
          this_ptr_00->vertex_buffer_ptr[2].u = (0x8 << 16);
          this_ptr_00->vertex_buffer_ptr[2].v = (0x8 << 16);
          ...
          iVar2 = iVar2 + 1;
          this_ptr_00->vertex_buffer_ptr[3].v = (0x8 << 16);
          local_e0.base.surface_normal.D.i = 0;
          local_e0.base.surface_normal.C.i = 0;
          local_e0.base.base.count = 4;
          local_e0.base.surface_normal.B.i = 0;
          local_e0.vertices[1] = 1;
          local_e0.base.surface_normal.A.i = 0;
