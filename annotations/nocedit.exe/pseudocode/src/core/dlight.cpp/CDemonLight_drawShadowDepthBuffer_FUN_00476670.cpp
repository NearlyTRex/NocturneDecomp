...

{
  ...
  do {
    uVar4 = rand();
    iVar6 = iVar3 + 4;
    *(uint *)((int)g_NoiseTable + iVar3) = (uVar4 & 0x1f) - 0x10;
    iVar3 = iVar6;
  } while (iVar6 != 400);
  iVar7 = 0;
  if (0 < g_WindowHeight) {
    ...
    do {
      ...
      puVar1 = (uint *)((int)g_ScreenBufferArray + iVar3);
      iVar3 = iVar3 + 4;
      iVar7 = iVar7 + 1;
      memset
                ((void *)*puVar1,0,
  ...
  if (g_BitsPerPixel == 0x20) {
    ...
    if (0 < this_ptr->shadow_map_height) {
      do {
        ...
        if ((-1 < iVar3) && (iVar3 < g_WindowHeight)) {
          puVar8 = (uint *)((int)g_ScreenBufferArray[iVar3] + screen_x * 4);
    ...
    if (0 < this_ptr->shadow_map_height) {
      do {
        ...
        iVar3 = iVar3 + screen_y;
        if ((-1 < iVar3) && (iVar3 < g_WindowHeight)) {
          puVar9 = (ushort *)((int)g_ScreenBufferArray[iVar3] + screen_x * 2);
