...
section .text
    ...
    CALL engine_drender.cpp_CDemonRenderer_getCameraOriginWorld_FUN_0048c780 ; 00474b0c
    ...
    CALL engine_drender.cpp_CDemonRenderer_getCameraOriginFixed_FUN_0048c760 ; 00474c37
    ...
    JMP 0x0060c885                      ; 00474c4a
        ;   XREF to: 0060c885 (UNCONDITIONAL_JUMP)  ; LAB_0060c885
    ...
    CALL engine_drender.cpp_CDemonRenderer_getCameraRotationRadians_FUN_0048c800 ; 00474ebd
    ...
    PUSH EAX                            ; 00474f3c
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 00474f3d
    ...
    PUSH EAX                            ; 00474f99
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 00474f9a
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    PUSH EAX                            ; 00474ff0
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 00474ff1
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    PUSH EAX                            ; 00475049
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 0047504a
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    CALL engine_drender.cpp_CDemonRenderer_renderVertexAlphaDirect_FUN_0048bad0 ; 004751d5
    ...
    POP EBX                             ; 0047520b
    RET                                 ; 0047520c
    MOV ECX,dword ptr [ESI]             ; 0060c885
        ;   Label: LAB_0060c885
    MOV dword ptr [EDI],ECX             ; 0060c887
    MOV ECX,dword ptr [ESI + 0x4]       ; 0060c889
    MOV dword ptr [EDI + 0x4],ECX       ; 0060c88c
    MOV ECX,dword ptr [ESI + 0x8]       ; 0060c88f
    MOV dword ptr [EDI + 0x8],ECX       ; 0060c892
    ADD ESI,0xc                         ; 0060c895
    ADD EDI,0xc                         ; 0060c898
    FILD dword ptr [EAX]                ; 0060c89b
    JMP 0x00474c4f                      ; 0060c89d
        ;   XREF to: 00474c4f (UNCONDITIONAL_JUMP)  ; LAB_00474c4f
