...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dlight.cpp_CDemonLight_renderVolumetricLightShaft_FUN_00474ad0(CDemonLight * this_ptr)
;
; Parameters:
...
section .text
    ...
    JZ 0x00474af6                       ; 00474ae9 | LAB_00474af6
        ;   XREF to: 00474af6 (CONDITIONAL_JUMP)
    MOV EAX,[0x0067b654]                ; 00474aeb | CGame g_CGameInstance | CGame * g_CGamePtr
    CMP dword ptr [EAX + 0xc],0x2       ; 00474af0 | DAT_02d81aa8
    JZ 0x00474afd                       ; 00474af4 | LAB_00474afd
    ...
    LEA EAX,[ESP + 0xac]                ; 00474afd
        ;   Label: LAB_00474afd
    PUSH EAX                            ; 00474b04
    MOV EBX,dword ptr [0x006703ec]      ; 00474b05 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH EBX                            ; 00474b0b | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_getCameraOriginScaled_FUN_0048c780 ; 00474b0c | float * engine_drender.cpp_CDemonRenderer_getCameraOriginScaled_FUN_0048c780(CDemonRenderer * this_ptr, float * output)
    ...
    CALL core_dirmat.cpp_CMatrix3x3f_transformVectorTranspose_FUN_00472030 ; 00474b65 | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVectorTranspose_FUN_00472030(CMatrix3x3f * matrix, CVector3f * output, CVector3f * input)
        ;   XREF to: 00472030 (UNCONDITIONAL_CALL)
    MOV EDX,EAX                         ; 00474b6a
    LEA EAX,[ESP + 0xb8]                ; 00474b6c
    ADD ESP,0xc                         ; 00474b73
    CMP EAX,EDX                         ; 00474b76
    JZ 0x00474b97                       ; 00474b78 | LAB_00474b97
    ...
    FLD float ptr [ESP + 0xb4]          ; 00474b97
        ;   Label: LAB_00474b97
    FMUL double ptr [0x0061f1eb]        ; 00474b9e | double DOUBLE_0061f1eb
    ...
    FMUL ST0                            ; 00474bba
    FXCH ST2                            ; 00474bbc
    FMUL double ptr [0x0061f1f3]        ; 00474bbe | double DOUBLE_0061f1f3
    FXCH                                ; 00474bc4
    ...
    FNSTSW AX                           ; 00474bff
    SAHF                                ; 00474c01
    JA 0x00474af6                       ; 00474c02 | LAB_00474af6
        ;   XREF to: 00474af6 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x11c]         ; 00474c08
    FDIV float ptr [ESP + 0x114]        ; 00474c0f
    LEA EDI,[ESP + 0xdc]                ; 00474c16
    MOV ESI,dword ptr [0x006703ec]      ; 00474c1d | CDemonRenderer * g_CDemonRendererPtr
    LEA EBX,[ESP + 0xb8]                ; 00474c23
    PUSH ESI                            ; 00474c2a | CDemonRenderer g_CDemonRendererInstance
    FLD1                                ; 00474c2b
    FSUBRP                              ; 00474c2d
    LEA ESI,[ESP + 0x68]                ; 00474c2f
    FSTP float ptr [ESP + 0xc]          ; 00474c33
    CALL engine_drender.cpp_CDemonRenderer_getCameraOriginToBuffer_FUN_0048c760 ; 00474c37 | void engine_drender.cpp_CDemonRenderer_getCameraOriginToBuffer_FUN_0048c760(CDemonRenderer * this_ptr, CVector3i * output)
    ...
    FMUL float ptr [0x0065c908]         ; 00474c4f | float FLOAT_0065c908
    FSTP float ptr [EBX]                ; 00474c55
    FILD dword ptr [EAX + 0x4]          ; 00474c57
    FMUL float ptr [0x0065c908]         ; 00474c5a | float FLOAT_0065c908
    FSTP float ptr [EBX + 0x4]          ; 00474c60
    FILD dword ptr [EAX + 0x8]          ; 00474c63
    FMUL float ptr [0x0065c908]         ; 00474c66 | float FLOAT_0065c908
    ...
    FNSTSW AX                           ; 00474cd1
    SAHF                                ; 00474cd3
    JNC 0x00474af6                      ; 00474cd4 | LAB_00474af6
        ;   XREF to: 00474af6 (CONDITIONAL_JUMP)
    FLD1                                ; 00474cda
    ...
    MOV EDX,dword ptr [0x02d051f4]      ; 00474d09 | float g_PerspectiveReciprocal
    ...
    CALL core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0 ; 00474d5c | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0(CMatrix3x3f * this_ptr, CVector3f * output, CVector3f * input)
    ...
    FMUL float ptr [0x0061f1fb]         ; 00474d8c | float FLOAT_0061f1fb
    FLDZ                                ; 00474d92
    FCOMPP                              ; 00474d94
    FNSTSW AX                           ; 00474d96
    SAHF                                ; 00474d98
    JNC 0x00474af6                      ; 00474d99 | LAB_00474af6
        ;   XREF to: 00474af6 (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 00474d9f
    MOV EAX,[0x006703ec]                ; 00474da1 | CDemonRenderer * g_CDemonRendererPtr
    PUSH EAX                            ; 00474da6 | CDemonRenderer g_CDemonRendererInstance
    XOR ESI,ESI                         ; 00474da7
    CALL engine_drender.cpp_CDemonRenderer_setBlendMode_FUN_0048ca50 ; 00474da9 | void engine_drender.cpp_CDemonRenderer_setBlendMode_FUN_0048ca50(CDemonRenderer * this_ptr, int blend_mode)
    ...
    FMUL float ptr [0x0061f1ff]         ; 00474dbf | float FLOAT_0061f1ff
    ...
    FMUL double ptr [0x0061f1eb]        ; 00474dd6 | double DOUBLE_0061f1eb
    FDIVRP                              ; 00474ddc
    ...
    JZ 0x00474e9a                       ; 00474e77 | LAB_00474e9a
    ...
    LEA EAX,[ESP + 0x58]                ; 00474e9a
        ;   Label: LAB_00474e9a
    PUSH EAX                            ; 00474e9e
    MOV EDX,dword ptr [0x006703ec]      ; 00474e9f | CDemonRenderer * g_CDemonRendererPtr
    PUSH EDX                            ; 00474ea5 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450 ; 00474ea6 | void engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450(CDemonRenderer * this_ptr, CVector3f * world_position)
        ;   XREF to: 0048c450 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00474eab
    LEA EAX,[ESP + 0xa0]                ; 00474eae
    PUSH EAX                            ; 00474eb5
    MOV ECX,dword ptr [0x006703ec]      ; 00474eb6 | CDemonRenderer * g_CDemonRendererPtr
    PUSH ECX                            ; 00474ebc | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_getCameraRotationAsRadians_FUN_0048c800 ; 00474ebd | float * engine_drender.cpp_CDemonRenderer_getCameraRotationAsRadians_FUN_0048c800(CDemonRenderer * this_ptr, float * output)
        ;   XREF to: 0048c800 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00474ec2
    PUSH 0x0                            ; 00474ec5
    LEA EAX,[ESP + 0xa4]                ; 00474ec7
    PUSH EAX                            ; 00474ece
    MOV EBX,dword ptr [0x006703ec]      ; 00474ecf | CDemonRenderer * g_CDemonRendererPtr
    PUSH EBX                            ; 00474ed5 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_applyScaledTransform_FUN_0048c4f0 ; 00474ed6 | void engine_drender.cpp_CDemonRenderer_applyScaledTransform_FUN_0048c4f0(CDemonRenderer * this_ptr, CVector3i * position, CVector3i * rotation)
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 00474f0a | CDemonRenderer * g_CDemonRendererPtr
    FLD float ptr [EAX]                 ; 00474f10
    FMUL float ptr [0x0065c900]         ; 00474f12 | float FLOAT_0065c900
    FISTP dword ptr [EBX]               ; 00474f18
    FLD float ptr [EAX + 0x4]           ; 00474f1a
    FMUL float ptr [0x0065c900]         ; 00474f1d | float FLOAT_0065c900
    FISTP dword ptr [EBX + 0x4]         ; 00474f23
    FLD float ptr [EAX + 0x8]           ; 00474f26
    FMUL float ptr [0x0065c900]         ; 00474f29 | float FLOAT_0065c900
    FISTP dword ptr [EBX + 0x8]         ; 00474f2f
    LEA EAX,[ESP + 0xc4]                ; 00474f32
    PUSH EAX                            ; 00474f39
    MOV EAX,dword ptr [EDX]             ; 00474f3a | CDemonRenderer g_CDemonRendererInstance
    PUSH EAX                            ; 00474f3c
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 00474f3d | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 00474f64 | CDemonRenderer * g_CDemonRendererPtr
    FLD float ptr [EAX]                 ; 00474f6a
    FMUL float ptr [0x0065c900]         ; 00474f6c | float FLOAT_0065c900
    FISTP dword ptr [EBX]               ; 00474f72
    FLD float ptr [EAX + 0x4]           ; 00474f74
    FMUL float ptr [0x0065c900]         ; 00474f77 | float FLOAT_0065c900
    FISTP dword ptr [EBX + 0x4]         ; 00474f7d
    FLD float ptr [EAX + 0x8]           ; 00474f80
    FMUL float ptr [0x0065c900]         ; 00474f83 | float FLOAT_0065c900
    FISTP dword ptr [EBX + 0x8]         ; 00474f89
    LEA EAX,[ESP + 0xf4]                ; 00474f8c
    PUSH EAX                            ; 00474f93
    MOV EAX,dword ptr [EDX]             ; 00474f94 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0x30                        ; 00474f96
    PUSH EAX                            ; 00474f99
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 00474f9a | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 00474fbe | CDemonRenderer * g_CDemonRendererPtr
    FLD float ptr [EAX]                 ; 00474fc4
    FMUL float ptr [0x0065c900]         ; 00474fc6 | float FLOAT_0065c900
    FISTP dword ptr [EBX]               ; 00474fcc
    FLD float ptr [EAX + 0x4]           ; 00474fce
    FMUL float ptr [0x0065c900]         ; 00474fd1 | float FLOAT_0065c900
    FISTP dword ptr [EBX + 0x4]         ; 00474fd7
    FLD float ptr [EAX + 0x8]           ; 00474fda
    FMUL float ptr [0x0065c900]         ; 00474fdd | float FLOAT_0065c900
    FISTP dword ptr [EBX + 0x8]         ; 00474fe3
    LEA EAX,[ESP + 0x40]                ; 00474fe6
    PUSH EAX                            ; 00474fea
    MOV EAX,dword ptr [EDX]             ; 00474feb | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0x60                        ; 00474fed
    PUSH EAX                            ; 00474ff0
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 00474ff1 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 00475015 | CDemonRenderer * g_CDemonRendererPtr
    FLD float ptr [EAX]                 ; 0047501b
    FMUL float ptr [0x0065c900]         ; 0047501d | float FLOAT_0065c900
    FISTP dword ptr [EBX]               ; 00475023
    FLD float ptr [EAX + 0x4]           ; 00475025
    FMUL float ptr [0x0065c900]         ; 00475028 | float FLOAT_0065c900
    FISTP dword ptr [EBX + 0x4]         ; 0047502e
    FLD float ptr [EAX + 0x8]           ; 00475031
    FMUL float ptr [0x0065c900]         ; 00475034 | float FLOAT_0065c900
    FISTP dword ptr [EBX + 0x8]         ; 0047503a
    LEA EAX,[ESP + 0x70]                ; 0047503d
    PUSH EAX                            ; 00475041
    MOV EAX,dword ptr [EDX]             ; 00475042 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0x90                        ; 00475044
    PUSH EAX                            ; 00475049
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 0047504a | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0047504f
    PUSH 0x66fef0                       ; 00475052 | DAT_0066fef0
    MOV EDX,dword ptr [0x006703ec]      ; 00475057 | CDemonRenderer * g_CDemonRendererPtr
    PUSH EDX                            ; 0047505d | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80 ; 0047505e | void engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80(CDemonRenderer * this_ptr, SMRGLTextureBasic * texture)
    ...
    FMUL double ptr [0x0061f203]        ; 00475072 | double DOUBLE_0061f203
    FDIV float ptr [EAX + 0x140]        ; 00475078
    XOR EBX,EBX                         ; 0047507e
    MOV ECX,0x4                         ; 00475080
    MOV EDX,dword ptr [0x006703ec]      ; 00475085 | CDemonRenderer * g_CDemonRendererPtr
    ...
    MOV EBX,dword ptr [EDX]             ; 004750a7 | CDemonRenderer g_CDemonRendererInstance
    CALL crt_math.c_round_FUN_005fe6b0  ; 004750a9 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x10c]       ; 004750ae
    MOV EAX,dword ptr [ESP + 0x10c]     ; 004750b5
    MOV dword ptr [EBX + 0x2c],EAX      ; 004750bc
    MOV EAX,dword ptr [EDX]             ; 004750bf | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EAX + 0x20],0xffff   ; 004750c1
    MOV EAX,dword ptr [EDX]             ; 004750c8 | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EAX + 0x24],0xffff   ; 004750ca
    MOV EAX,dword ptr [EDX]             ; 004750d1 | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EAX + 0x28],0xffff   ; 004750d3
    MOV dword ptr [ESP + 0x28],0x1      ; 004750da
    MOV EBX,dword ptr [EDX]             ; 004750e2 | CDemonRenderer g_CDemonRendererInstance
    MOV EAX,dword ptr [ESP + 0x10c]     ; 004750e4
    MOV dword ptr [EBX + 0x5c],EAX      ; 004750eb
    MOV EAX,dword ptr [EDX]             ; 004750ee | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EAX + 0x50],0xffff   ; 004750f0
    MOV EAX,dword ptr [EDX]             ; 004750f7 | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EAX + 0x54],0xffff   ; 004750f9
    MOV EAX,dword ptr [EDX]             ; 00475100 | CDemonRenderer g_CDemonRendererInstance
    MOV ECX,0x2                         ; 00475102
    MOV dword ptr [EAX + 0x58],0xffff   ; 00475107
    MOV dword ptr [ESP + 0x2c],ECX      ; 0047510e
    MOV EBX,dword ptr [EDX]             ; 00475112 | CDemonRenderer g_CDemonRendererInstance
    MOV EAX,dword ptr [ESP + 0x10c]     ; 00475114
    MOV dword ptr [EBX + 0x8c],EAX      ; 0047511b
    MOV EAX,dword ptr [EDX]             ; 00475121 | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EAX + 0x80],0xffff   ; 00475123
    MOV EAX,dword ptr [EDX]             ; 0047512d | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EAX + 0x84],0xffff   ; 0047512f
    MOV EAX,dword ptr [EDX]             ; 00475139 | CDemonRenderer g_CDemonRendererInstance
    MOV EBX,0x3                         ; 0047513b
    MOV dword ptr [EAX + 0x88],0xffff   ; 00475140
    MOV dword ptr [ESP + 0x30],EBX      ; 0047514a
    MOV EBX,dword ptr [EDX]             ; 0047514e | CDemonRenderer g_CDemonRendererInstance
    MOV EAX,dword ptr [ESP + 0x10c]     ; 00475150
    MOV dword ptr [EBX + 0xbc],EAX      ; 00475157
    MOV EAX,dword ptr [EDX]             ; 0047515d | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EAX + 0xb0],0xffff   ; 0047515f
    MOV EAX,dword ptr [EDX]             ; 00475169 | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EAX + 0xb4],0xffff   ; 0047516b
    MOV EAX,dword ptr [EDX]             ; 00475175 | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EAX + 0xb8],0xffff   ; 00475177
    MOV EAX,dword ptr [EDX]             ; 00475181 | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EAX + 0x18],0xf80000 ; 00475183 | DAT_00f80000
    MOV EAX,dword ptr [EDX]             ; 0047518a | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EAX + 0x1c],0xf80000 ; 0047518c | DAT_00f80000
    MOV EAX,dword ptr [EDX]             ; 00475193 | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EAX + 0x48],0x80000  ; 00475195
    MOV EAX,dword ptr [EDX]             ; 0047519c | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EAX + 0x4c],0xf80000 ; 0047519e | DAT_00f80000
    MOV EAX,dword ptr [EDX]             ; 004751a5 | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EAX + 0x78],0x80000  ; 004751a7
    MOV EAX,dword ptr [EDX]             ; 004751ae | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EAX + 0x7c],0x80000  ; 004751b0
    MOV EAX,dword ptr [EDX]             ; 004751b7 | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EAX + 0xa8],0xf80000 ; 004751b9 | DAT_00f80000
    MOV EAX,dword ptr [EDX]             ; 004751c3 | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EAX + 0xac],0x80000  ; 004751c5
    LEA EAX,[ESP + 0xc]                 ; 004751cf
    PUSH EAX                            ; 004751d3
    PUSH EDX                            ; 004751d4 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_renderMaximumQuality_FUN_0048bad0 ; 004751d5 | void engine_drender.cpp_CDemonRenderer_renderMaximumQuality_FUN_0048bad0(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * polygon_info)
        ;   XREF to: 0048bad0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004751da
    MOV EAX,[0x006703ec]                ; 004751dd | CDemonRenderer * g_CDemonRendererPtr
    PUSH EAX                            ; 004751e2 | CDemonRenderer g_CDemonRendererInstance
    INC ESI                             ; 004751e3
    CALL engine_drender.cpp_CDemonRenderer_matrixPop_FUN_0050d720 ; 004751e4 | void engine_drender.cpp_CDemonRenderer_matrixPop_FUN_0050d720()
        ;   XREF to: 0048c640 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004751e9
    CMP ESI,0x19                        ; 004751ec
    JL 0x00474db1                       ; 004751ef | LAB_00474db1
        ;   XREF to: 00474db1 (CONDITIONAL_JUMP)
    PUSH 0x0                            ; 004751f5
    MOV EDX,dword ptr [0x006703ec]      ; 004751f7 | CDemonRenderer * g_CDemonRendererPtr
    PUSH EDX                            ; 004751fd | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_setBlendMode_FUN_0048ca50 ; 004751fe | void engine_drender.cpp_CDemonRenderer_setBlendMode_FUN_0048ca50(CDemonRenderer * this_ptr, int blend_mode)
        ;   XREF to: 0048ca50 (UNCONDITIONAL_CALL)
