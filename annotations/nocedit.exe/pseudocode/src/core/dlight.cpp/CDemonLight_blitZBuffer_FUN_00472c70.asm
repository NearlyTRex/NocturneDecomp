...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dlight.cpp_CDemonLight_blitZBuffer_FUN_00472c70(CDemonLight * this_ptr, CRect * source_rect)
;
; Parameters:
...
section .text
    ...
    PUSH ECX                            ; 00472ced
    INC EDI                             ; 00472cee
    CALL core_dstrender.cpp_memcpyMMX_FUN_00492001 ; 00472cef | void * core_dstrender.cpp_memcpyMMX_FUN_00492001(void * dest, void * src, int byte_count)
        ;   XREF to: 00492001 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [ESI + 0xc]       ; 00472cf4
    ADD ESP,0xc                         ; 00472cf7
    CMP EDI,EAX                         ; 00472cfa
    JLE 0x00472cc1                      ; 00472cfc | LAB_00472cc1
    ...
    POP EBX                             ; 00472d03
    RET                                 ; 00472d04
    MOV ECX,0x61efc4                    ; 00472d05 | = "..\\core\\dlight.cpp" | s_core_dlight_cpp_0061efc4 = ..\core\dlight.cpp
        ;   Label: LAB_00472d05
    MOV EBX,0x147                       ; 00472d0a
    PUSH 0x61efd7                       ; 00472d0f | = "CDemonLight::blitZBuffer - No master ..." | s_CDemonLight_blitZBuffer__0061efd7 = CDemonLight::blitZBuffer - No master Z buffer
    MOV dword ptr [0x02f0ca48],ECX      ; 00472d14 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 00472d1a | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00472d20 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00472d25
    JMP 0x00472c89                      ; 00472d28 | LAB_00472c89
