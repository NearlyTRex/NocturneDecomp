...
section .text
    ...
    PUSH EAX                            ; 004736d5
    MOV EDX,dword ptr [0x006703ec]      ; 004736d6 | CDemonRenderer * g_CDemonRendererPtr
    PUSH EDX                            ; 004736dc | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450 ; 004736dd | void engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450(CDemonRenderer * this_ptr, CVector3f * world_position)
    ...
    PUSH EAX                            ; 004736f0
    CALL core_dirmat.cpp_CMatrix3x3f_getEulerAngles_FUN_00472160 ; 004736f1 | CVector3f * core_dirmat.cpp_CMatrix3x3f_getEulerAngles_FUN_00472160(CMatrix3x3f * this_ptr, CVector3f * euler_angles)
        ;   XREF to: 00472160 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004736f6
    PUSH 0x0                            ; 004736f9
    LEA EAX,[ESP + 0x60]                ; 004736fb
    PUSH EAX                            ; 004736ff
    MOV ECX,dword ptr [0x006703ec]      ; 00473700 | CDemonRenderer * g_CDemonRendererPtr
    PUSH ECX                            ; 00473706 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_applyScaledTransform_FUN_0048c4f0 ; 00473707 | void engine_drender.cpp_CDemonRenderer_applyScaledTransform_FUN_0048c4f0(CDemonRenderer * this_ptr, CVector3i * position, CVector3i * rotation)
        ;   XREF to: 0048c4f0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0047370c
    MOV EAX,dword ptr [EBP + 0x14]      ; 0047370f
    FLD float ptr [EAX + 0x38]          ; 00473712
    FDIVR double ptr [0x0061f123]       ; 00473715 | double DOUBLE_0061f123
    ...
    FMUL double ptr [0x0061f12b]        ; 00473740 | double DOUBLE_0061f12b
    FMUL double ptr [0x0061f133]        ; 00473746 | double DOUBLE_0061f133
    FLD ST0                             ; 0047374c
    FCOS                                ; 0047374e
    FXCH                                ; 00473750
    FSIN                                ; 00473752
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 00473763 | CDemonRenderer * g_CDemonRendererPtr
    LEA EAX,[ESP + 0x68]                ; 00473769
    FSTP float ptr [ESP + 0x68]         ; 0047376d
    FSTP float ptr [ESP + 0x6c]         ; 00473771
    FLD float ptr [EAX]                 ; 00473775
    FMUL float ptr [0x0065c900]         ; 00473777 | float FLOAT_0065c900
    FISTP dword ptr [EBX]               ; 0047377d
    FLD float ptr [EAX + 0x4]           ; 0047377f
    FMUL float ptr [0x0065c900]         ; 00473782 | float FLOAT_0065c900
    FISTP dword ptr [EBX + 0x4]         ; 00473788
    FLD float ptr [EAX + 0x8]           ; 0047378b
    FMUL float ptr [0x0065c900]         ; 0047378e | float FLOAT_0065c900
    FISTP dword ptr [EBX + 0x8]         ; 00473794
    LEA EAX,[ESP + 0x44]                ; 00473797
    PUSH EAX                            ; 0047379b
    MOV EAX,dword ptr [EDX]             ; 0047379c | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,EDI                         ; 0047379e
    PUSH EAX                            ; 004737a0
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 004737a1 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [0x006703ec]      ; 004737a6 | CDemonRenderer * g_CDemonRendererPtr
    ADD EDI,0x30                        ; 004737ac
    MOV EAX,dword ptr [EDX]             ; 004737af | CDemonRenderer g_CDemonRendererInstance
    INC ESI                             ; 004737b1
    ADD ESP,0x8                         ; 004737b2
    MOV dword ptr [EDI + EAX*0x1 + -0x10],0x0 ; 004737b5
    CMP ESI,0x10                        ; 004737bd
    JL 0x00473732                       ; 004737c0 | LAB_00473732
        ;   XREF to: 00473732 (CONDITIONAL_JUMP)
    LEA EBX,[ESP + 0x2c]                ; 004737c6
    MOV EAX,0x26a72d8                   ; 004737ca | undefined4 DAT_026a72d8
    FLD float ptr [EAX]                 ; 004737cf | undefined4 DAT_026a72d8
    FMUL float ptr [0x0065c900]         ; 004737d1 | float FLOAT_0065c900
    FISTP dword ptr [EBX]               ; 004737d7
    FLD float ptr [EAX + 0x4]           ; 004737d9 | undefined4 DAT_026a72dc
    FMUL float ptr [0x0065c900]         ; 004737dc | float FLOAT_0065c900
    FISTP dword ptr [EBX + 0x4]         ; 004737e2
    FLD float ptr [EAX + 0x8]           ; 004737e5 | undefined4 DAT_026a72e0
    FMUL float ptr [0x0065c900]         ; 004737e8 | float FLOAT_0065c900
    FISTP dword ptr [EBX + 0x8]         ; 004737ee
    LEA EAX,[ESP + 0x2c]                ; 004737f1
    PUSH EAX                            ; 004737f5
    MOV EAX,dword ptr [EDX]             ; 004737f6 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0x300                       ; 004737f8
    PUSH EAX                            ; 004737fd
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 004737fe | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00473803
    MOV EAX,[0x006703ec]                ; 00473806 | CDemonRenderer * g_CDemonRendererPtr
    PUSH 0x1                            ; 0047380b
    MOV EDX,dword ptr [EAX]             ; 0047380d | CDemonRenderer g_CDemonRendererInstance
    PUSH EAX                            ; 0047380f | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EDX + 0x320],0xffff  ; 00473810
    CALL engine_drender.cpp_CDemonRenderer_setRenderingState_FUN_0048ca00 ; 0047381a | void engine_drender.cpp_CDemonRenderer_setRenderingState_FUN_0048ca00(CDemonRenderer * this_ptr, int state_flag)
        ;   XREF to: 0048ca00 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0047381f
    LEA EAX,[ESP + 0x50]                ; 00473822
    PUSH EAX                            ; 00473826
    MOV ESI,dword ptr [0x006703ec]      ; 00473827 | CDemonRenderer * g_CDemonRendererPtr
    PUSH ESI                            ; 0047382d | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_getCameraOriginScaled_FUN_0048c780 ; 0047382e | float * engine_drender.cpp_CDemonRenderer_getCameraOriginScaled_FUN_0048c780(CDemonRenderer * this_ptr, float * output)
    ...
    CALL core_dirmat.cpp_CMatrix3x3f_transformVectorTranspose_FUN_00472030 ; 00473869 | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVectorTranspose_FUN_00472030(CMatrix3x3f * matrix, CVector3f * output, CVector3f * input)
        ;   XREF to: 00472030 (UNCONDITIONAL_CALL)
    MOV EDX,EAX                         ; 0047386e
    LEA EAX,[ESP + 0x80]                ; 00473870
    ADD ESP,0xc                         ; 00473877
    CMP EAX,EDX                         ; 0047387a
    JNZ 0x004739f3                      ; 0047387c | LAB_004739f3
        ;   XREF to: 004739f3 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + 0x14]      ; 00473882
        ;   Label: LAB_00473882
    FLD double ptr [0x0061f13b]         ; 00473885 | double DOUBLE_0061f13b
    ...
    FNSTSW AX                           ; 004738b5
    SAHF                                ; 004738b7
    JNC 0x0047390b                      ; 004738b8 | LAB_0047390b
    ...
    FNSTSW AX                           ; 00473901
    SAHF                                ; 00473903
    JNC 0x0047390b                      ; 00473904 | LAB_0047390b
        ;   XREF to: 0047390b (CONDITIONAL_JUMP)
    ...
    JNZ 0x00473a14                      ; 00473928 | LAB_00473a14
    ...
    JNZ 0x00473a0c                      ; 0047393d | LAB_00473a0c
    ...
    PUSH EAX                            ; 00473952
    MOV EDX,dword ptr [0x006703ec]      ; 00473953 | CDemonRenderer * g_CDemonRendererPtr
    PUSH EDX                            ; 00473959 | CDemonRenderer g_CDemonRendererInstance
    INC EBX                             ; 0047395a
    CALL engine_drender.cpp_CDemonRenderer_renderCustomScanline_FUN_0048c8d0 ; 0047395b | void engine_drender.cpp_CDemonRenderer_renderCustomScanline_FUN_0048c8d0(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * prim, RenderScanlineFunc * scanline_renderer)
        ;   XREF to: 0048c8d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00473960
    CMP EBX,0x10                        ; 00473963
    JL 0x00473936                       ; 00473966 | LAB_00473936
    ...
    FMUL double ptr [0x0061f143]        ; 00473984 | double DOUBLE_0061f143
    XOR EBX,EBX                         ; 0047398a
    CALL crt_math.c_round_FUN_005fe6b0  ; 0047398c | double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    PUSH EAX                            ; 004739a4
    MOV EAX,[0x006703ec]                ; 004739a5 | CDemonRenderer * g_CDemonRendererPtr
    INC EBX                             ; 004739aa
    PUSH EAX                            ; 004739ab | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [ESP + 0x28],EDI      ; 004739ac
    MOV dword ptr [ESP + 0x30],EBX      ; 004739b0
    CALL engine_drender.cpp_CDemonRenderer_renderCustomScanline_FUN_0048c8d0 ; 004739b4 | void engine_drender.cpp_CDemonRenderer_renderCustomScanline_FUN_0048c8d0(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * prim, RenderScanlineFunc * scanline_renderer)
        ;   XREF to: 0048c8d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004739b9
    CMP EBX,0xe                         ; 004739bc
    JL 0x00473995                       ; 004739bf | LAB_00473995
        ;   XREF to: 00473995 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x006703ec]      ; 004739c1 | CDemonRenderer * g_CDemonRendererPtr
    PUSH EDX                            ; 004739c7 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_matrixPop_FUN_0050d720 ; 004739c8 | void engine_drender.cpp_CDemonRenderer_matrixPop_FUN_0050d720()
    ...
    JMP 0x00473882                      ; 00473a07 | LAB_00473882
        ;   XREF to: 00473882 (UNCONDITIONAL_JUMP)
    LEA EAX,[EBX + 0x1]                 ; 00473a0c
        ;   Label: LAB_00473a0c
    JMP 0x00473945                      ; 00473a0f | LAB_00473945
        ;   XREF to: 00473945 (UNCONDITIONAL_JUMP)
    CALL core_dcamera.cpp_initializeCoronaBuffers_FUN_004502e0 ; 00473a14 | void core_dcamera.cpp_initializeCoronaBuffers_FUN_004502e0()
        ;   Label: LAB_00473a14
        ;   XREF to: 004502e0 (UNCONDITIONAL_CALL)
    JMP 0x00473968                      ; 00473a19 | LAB_00473968
