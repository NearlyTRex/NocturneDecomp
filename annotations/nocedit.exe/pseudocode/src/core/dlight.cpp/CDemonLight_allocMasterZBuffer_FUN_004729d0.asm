...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_dlight_cpp_CDemonLight_allocMasterZBuffer_FUN_004729d0(CDemonLight *this_ptr)
;
; Parameters:
...
section .text
    ...
    JNZ 0x00472a21                      ; 004729dd
        ;   XREF to: 00472a21 (CONDITIONAL_JUMP)  ; LAB_00472a21
    ...
    PUSH ESI                            ; 00472a21
        ;   Label: LAB_00472a21
    MOV ECX,0x61ef3a                    ; 00472a22 | = "..\\core\\dlight.cpp"
    MOV ESI,0xcd                        ; 00472a27
    PUSH 0x61ef4d                       ; 00472a2c | = "CDemonLight::allocMasterZBuffer - We ..."
    MOV dword ptr [0x02f0ca48],ECX      ; 00472a31 | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 00472a37 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00472a3d
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ADD ESP,0x4                         ; 00472a42
    POP ESI                             ; 00472a45
    JMP 0x004729df                      ; 00472a46
        ;   XREF to: 004729df (UNCONDITIONAL_JUMP)  ; LAB_004729df
