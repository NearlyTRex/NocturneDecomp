        ...
        if (0.0 < local_140) {
          ...
          if (0.0 < (local_78 * pCVar2->z + local_80 * pCVar2->x + local_7c * pCVar2->y) * local_14
            ...
            do {
              ...
              pCVar5->vertex_buffer_ptr->light = 0xffff;
              pCVar5->vertex_buffer_ptr->color = 0xffff;
              pCVar5->vertex_buffer_ptr->fog = 0xffff;
              local_120 = 1;
              ...
              pCVar5->vertex_buffer_ptr[1].light = 0xffff;
              pCVar5->vertex_buffer_ptr[1].color = 0xffff;
              pCVar5->vertex_buffer_ptr[1].fog = 0xffff;
              local_11c = 2;
              ...
              pCVar5->vertex_buffer_ptr[2].light = 0xffff;
              pCVar5->vertex_buffer_ptr[2].color = 0xffff;
              pCVar5->vertex_buffer_ptr[2].fog = 0xffff;
              local_118 = 3;
              ...
              pCVar5->vertex_buffer_ptr[3].light = 0xffff;
              pCVar5->vertex_buffer_ptr[3].color = 0xffff;
              pCVar5->vertex_buffer_ptr[3].fog = 0xffff;
