...
LAB_004730f9:
        ...
        if (0 < g_DirtySpanCount) {
          iVar1 = 0;
          do {
            piVar1 = (int *)((int)g_DirtySpanStarts + iVar1);
            iVar5 = local_18 * this_ptr->shadow_map_width + *(int *)((int)g_DirtySpanStarts + iVar1)
            ;
            piVar2 = (int *)((int)g_DirtySpanEnds + iVar1);
            iVar1 = iVar1 + 4;
            iVar3 = iVar3 + 1;
