...
;                               FUNCTION
; *****************************************************************************
; __cdecl ushort * core_dlight.cpp_CDemonLight_projectLightAndMarkVisibility_FUN_00473270(CDemonLight * this_ptr, CVector3i * projected_coord, uchar x_round_flag, uchar y_round_flag)
;
; Parameters:
...
section .text
    ...
    JZ 0x004732eb                       ; 004732bc | LAB_004732eb
    ...
    JLE 0x00473303                      ; 004732e2 | LAB_00473303
    ...
    TEST ECX,ECX                        ; 004732eb
        ;   Label: LAB_004732eb
    JL 0x004732e6                       ; 004732ed | LAB_004732e6
        ;   XREF to: 004732e6 (CONDITIONAL_JUMP)
    CMP ECX,dword ptr [EBX + 0x1cc0]    ; 004732ef
    JGE 0x004732e6                      ; 004732f5 | LAB_004732e6
        ;   XREF to: 004732e6 (CONDITIONAL_JUMP)
    TEST ESI,ESI                        ; 004732f7
    JL 0x004732e6                       ; 004732f9 | LAB_004732e6
        ;   XREF to: 004732e6 (CONDITIONAL_JUMP)
    CMP ESI,dword ptr [EBX + 0x1cc4]    ; 004732fb
    JGE 0x004732e6                      ; 00473301 | LAB_004732e6
        ;   XREF to: 004732e6 (CONDITIONAL_JUMP)
    ...
    MOV DL,byte ptr [EDI + 0x66fed0]    ; 00473339 | uchar[8] g_LightBitMaskLookup
