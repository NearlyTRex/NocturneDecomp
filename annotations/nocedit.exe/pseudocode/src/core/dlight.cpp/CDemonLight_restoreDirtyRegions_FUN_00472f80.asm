...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dlight.cpp_CDemonLight_restoreDirtyRegions_FUN_00472f80(CDemonLight * this_ptr)
;
; Parameters:
...
;
; XREF[2]:
;   core_set.cpp_CDemonSet_FUN_0056c1a0 at 0056c6d7
...
section .text
    ...
    JL 0x004731f9                       ; 00472fcd | LAB_004731f9
    ...
    JGE 0x00472fff                      ; 00472ffa | LAB_00472fff
    ...
    JL 0x00472fc7                       ; 0047300b | LAB_00472fc7
    ...
    JLE 0x00473053                      ; 00473023 | LAB_00473053
    ...
    JLE 0x00473036                      ; 00473032 | LAB_00473036
    ...
    JLE 0x00473045                      ; 0047303f | LAB_00473045
    ...
    JL 0x0047302b                       ; 00473051 | LAB_0047302b
    ...
    JG 0x00473182                       ; 0047305d | LAB_00473182
        ;   XREF to: 00473182 (CONDITIONAL_JUMP)
    ...
    MOV dword ptr [0x026a6ad4],ECX      ; 00473079 | int g_DirtySpanCount
    TEST ESI,ESI                        ; 0047307f
    JLE 0x0047310f                      ; 00473081 | LAB_0047310f
    ...
    JL 0x004730f9                       ; 0047309a | LAB_004730f9
        ;   XREF to: 004730f9 (CONDITIONAL_JUMP)
    CMP EAX,dword ptr [EDI + 0xc]       ; 0047309c
    JG 0x004730f9                       ; 0047309f | LAB_004730f9
        ;   XREF to: 004730f9 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [0x026a6ad4]      ; 004730a1 | int g_DirtySpanCount
    XOR ECX,ECX                         ; 004730a7
    TEST EBX,EBX                        ; 004730a9
    JLE 0x004730cc                      ; 004730ab | LAB_004730cc
        ;   XREF to: 004730cc (CONDITIONAL_JUMP)
    LEA ESI,[EBX*0x4 + 0x0]             ; 004730ad
    XOR EAX,EAX                         ; 004730b4
    MOV EBX,dword ptr [EDX + 0x4]       ; 004730b6
        ;   Label: LAB_004730b6
    CMP EBX,dword ptr [EAX + 0x26a6ad8] ; 004730b9 | int[256] g_DirtySpanStarts
    JGE 0x00473210                      ; 004730bf | LAB_00473210
        ;   XREF to: 00473210 (CONDITIONAL_JUMP)
    ADD EAX,0x4                         ; 004730c5
        ;   Label: LAB_004730c5
    CMP EAX,ESI                         ; 004730c8
    JL 0x004730b6                       ; 004730ca | LAB_004730b6
        ;   XREF to: 004730b6 (CONDITIONAL_JUMP)
    TEST ECX,ECX                        ; 004730cc
        ;   Label: LAB_004730cc
    JNZ 0x004730f9                      ; 004730ce | LAB_004730f9
        ;   XREF to: 004730f9 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [ESP + 0x20]      ; 004730d0
    MOV EAX,dword ptr [EDX]             ; 004730d4
    MOV dword ptr [ECX + 0x26a6ad8],EAX ; 004730d6 | int[256] g_DirtySpanStarts | DAT_026a6adc
    MOV EAX,dword ptr [EDX + 0x4]       ; 004730dc
    LEA EDX,[ECX + 0x4]                 ; 004730df
    MOV dword ptr [ECX + 0x26a6ed8],EAX ; 004730e2 | int[256] g_DirtySpanEnds | DAT_026a6edc
    MOV ECX,dword ptr [0x026a6ad4]      ; 004730e8 | int g_DirtySpanCount
    INC ECX                             ; 004730ee
    MOV dword ptr [ESP + 0x20],EDX      ; 004730ef
    MOV dword ptr [0x026a6ad4],ECX      ; 004730f3 | int g_DirtySpanCount
    ...
    JL 0x0047308f                       ; 0047310d | LAB_0047308f
        ;   XREF to: 0047308f (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x026a6ad4]      ; 0047310f | int g_DirtySpanCount
        ;   Label: LAB_0047310f
    XOR EDI,EDI                         ; 00473115
    TEST ECX,ECX                        ; 00473117
    JLE 0x0047316d                      ; 00473119 | LAB_0047316d
    ...
    MOV ECX,dword ptr [ESI + 0x26a6ad8] ; 00473128 | int[256] g_DirtySpanStarts
    MOV EBX,dword ptr [ESI + 0x26a6ad8] ; 0047312e | int[256] g_DirtySpanStarts
    ...
    MOV EAX,dword ptr [ESI + 0x26a6ed8] ; 00473148 | int[256] g_DirtySpanEnds
    ...
    INC EDI                             ; 0047315b
    CALL core_dstrender.cpp_memcpyMMX_FUN_00492001 ; 0047315c | void * core_dstrender.cpp_memcpyMMX_FUN_00492001(void * dest, void * src, int byte_count)
        ;   XREF to: 00492001 (UNCONDITIONAL_CALL)
    MOV EAX,[0x026a6ad4]                ; 00473161 | int g_DirtySpanCount
    ADD ESP,0xc                         ; 00473166
    CMP EDI,EAX                         ; 00473169
    JL 0x0047311d                       ; 0047316b | LAB_0047311d
    ...
    JLE 0x0047306d                      ; 0047317c | LAB_0047306d
    ...
    PUSH EAX                            ; 004731b5
    PUSH EBP                            ; 004731b6
    CALL core_dlight.cpp_CDemonLight_blitZBuffer_FUN_00472c70 ; 004731b7 | void core_dlight.cpp_CDemonLight_blitZBuffer_FUN_00472c70(CDemonLight * this_ptr, CRect * source_rect)
    ...
    POP EBX                             ; 004731cf
    RET                                 ; 004731d0
    MOV ESI,0x61f0db                    ; 004731d1 | = "..\\core\\dlight.cpp" | s_core_dlight_cpp_0061f0db = ..\core\dlight.cpp
        ;   Label: LAB_004731d1
    MOV EDI,0x202                       ; 004731d6
    PUSH 0x61f0ee                       ; 004731db | = "CDemonLight::blitZBuffer - No master ..." | s_CDemonLight_blitZBuffer__0061f0ee = CDemonLight::blitZBuffer - No master Z buffer
    MOV dword ptr [0x02f0ca48],ESI      ; 004731e0 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 004731e6 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 004731ec | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004731f1
    JMP 0x00472fb5                      ; 004731f4 | LAB_00472fb5
        ;   XREF to: 00472fb5 (UNCONDITIONAL_JUMP)
    MOV dword ptr [EDX],0x0             ; 004731f9
        ;   Label: LAB_004731f9
    JMP 0x00472fd3                      ; 004731ff | LAB_00472fd3
        ;   XREF to: 00472fd3 (UNCONDITIONAL_JUMP)
    MOV dword ptr [EAX + 0x8],0x0       ; 00473204
        ;   Label: LAB_00473204
    JMP 0x00472fee                      ; 0047320b | LAB_00472fee
        ;   XREF to: 00472fee (UNCONDITIONAL_JUMP)
    MOV EBX,dword ptr [EDX]             ; 00473210
        ;   Label: LAB_00473210
    CMP EBX,dword ptr [EAX + 0x26a6ed8] ; 00473212 | DAT_026a6edc
    JG 0x004730c5                       ; 00473218 | LAB_004730c5
        ;   XREF to: 004730c5 (CONDITIONAL_JUMP)
    CMP EBX,dword ptr [EAX + 0x26a6ad8] ; 0047321e | DAT_026a6adc
    JL 0x00473235                       ; 00473224 | LAB_00473235
        ;   XREF to: 00473235 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [EDX + 0x4]       ; 00473226
    CMP EBX,dword ptr [EAX + 0x26a6ed8] ; 00473229 | DAT_026a6edc
    JLE 0x004730f9                      ; 0047322f | LAB_004730f9
        ;   XREF to: 004730f9 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [EDX]             ; 00473235
        ;   Label: LAB_00473235
    CMP EBX,dword ptr [EAX + 0x26a6ad8] ; 00473237 | DAT_026a6adc
    JGE 0x0047324a                      ; 0047323d | LAB_0047324a
    ...
    JLE 0x00473260                      ; 00473253 | LAB_00473260
        ;   XREF to: 00473260 (CONDITIONAL_JUMP)
    MOV dword ptr [EAX + 0x26a6ed8],EBX ; 00473255 | DAT_026a6edc
    JMP 0x004730f9                      ; 0047325b | LAB_004730f9
        ;   XREF to: 004730f9 (UNCONDITIONAL_JUMP)
    TEST ECX,ECX                        ; 00473260
        ;   Label: LAB_00473260
    JNZ 0x004730cc                      ; 00473262 | LAB_004730cc
        ;   XREF to: 004730cc (CONDITIONAL_JUMP)
    JMP 0x004730c5                      ; 00473268 | LAB_004730c5
