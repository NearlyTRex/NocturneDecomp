...
section .text
    ...
    JNZ 0x00472c11                      ; 00472a8f | LAB_00472c11
    ...
    CALL core_dcamera.cpp_CDemonCamera_setSceneCamera_FUN_0044c3e0 ; 00472aa5 | void core_dcamera.cpp_CDemonCamera_setSceneCamera_FUN_0044c3e0(CDemonCamera * this_ptr, int skip_clear_buffers)
    ...
    PUSH 0x0                            ; 00472abd
    PUSH 0x0                            ; 00472abf
    MOV EBP,dword ptr [0x006703ec]      ; 00472ac1 | CDemonRenderer * g_CDemonRendererPtr
    PUSH EBP                            ; 00472ac7 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_pushViewport_FUN_0048c890 ; 00472ac8 | void engine_drender.cpp_CDemonRenderer_pushViewport_FUN_0048c890(CDemonRenderer * this_ptr, int x, int y, int width, ...)
    ...
    PUSH EAX                            ; 00472b01
    MOV EAX,[0x006703ec]                ; 00472b02 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    MOV dword ptr [EBX + 0x1d0],0x0     ; 00472b07
    PUSH EAX                            ; 00472b11 | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EBX + 0x168],EDI     ; 00472b12
    CALL engine_drender.cpp_CDemonRenderer_setCameraOriginFromScaledPoint_FUN_0048c150 ; 00472b18 | void engine_drender.cpp_CDemonRenderer_setCameraOriginFromScaledPoint_FUN_0048c150(CDemonRenderer * this_ptr, CVector3i * point_ptr)
        ;   XREF to: 0048c150 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00472b1d
    MOV EDX,dword ptr [0x006703ec]      ; 00472b20 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH dword ptr [EBX + 0x38]         ; 00472b26
    PUSH EDX                            ; 00472b29 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_setProjectionScale_FUN_0048c650 ; 00472b2a | void engine_drender.cpp_CDemonRenderer_setProjectionScale_FUN_0048c650(CDemonRenderer * this_ptr, float field_of_view)
        ;   XREF to: 0048c650 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00472b2f
    LEA EAX,[EBX + 0x10]                ; 00472b32
    PUSH EAX                            ; 00472b35
    MOV ECX,dword ptr [0x006703ec]      ; 00472b36 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH ECX                            ; 00472b3c | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_setupCameraAndProjection_FUN_0048c200 ; 00472b3d | void engine_drender.cpp_CDemonRenderer_setupCameraAndProjection_FUN_0048c200(CDemonRenderer * this_ptr, CMatrix3x3f * transform_matrix, CVector3f * rotation_angles)
    ...
    MOV dword ptr [EAX*0x4 + 0x2cf6a9c],ESI ; 00472bc0 | void *[1024] g_ScreenBufferArray
    INC EAX                             ; 00472bc7
    MOV ECX,dword ptr [EBX + 0x1cc4]    ; 00472bc8
    ADD EDX,0x4                         ; 00472bce
    CMP EAX,ECX                         ; 00472bd1
    JL 0x00472ba0                       ; 00472bd3 | LAB_00472ba0
    ...
    PUSH EBX                            ; 00472be0
        ;   Label: LAB_00472be0
    CALL core_dcamera.cpp_CDemonCamera_updateTransformMatrices_FUN_0044d1c0 ; 00472be1 | void core_dcamera.cpp_CDemonCamera_updateTransformMatrices_FUN_0044d1c0(CDemonCamera * this_ptr)
        ;   XREF to: 0044d1c0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00472be6
    PUSH 0x1                            ; 00472be9
    MOV EBX,dword ptr [0x006703ec]      ; 00472beb | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH EBX                            ; 00472bf1 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_setFaceCount_FUN_0048cac0 ; 00472bf2 | void engine_drender.cpp_CDemonRenderer_setFaceCount_FUN_0048cac0(CDemonRenderer * this_ptr, int value)
        ;   XREF to: 0048cac0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00472bf7
    MOV ESI,dword ptr [ESP + 0x18]      ; 00472bfa
    TEST ESI,ESI                        ; 00472bfe
    JZ 0x00472c5e                       ; 00472c00 | LAB_00472c5e
        ;   XREF to: 00472c5e (CONDITIONAL_JUMP)
    MOV dword ptr [0x02c6d03c],0x8000   ; 00472c02 | int g_RasterizerDepthBias
    POP EBP                             ; 00472c0c
    POP EDI                             ; 00472c0d
    POP ESI                             ; 00472c0e
    POP EBX                             ; 00472c0f
    RET                                 ; 00472c10
    MOV ECX,0x61ef84                    ; 00472c11 | = "..\\core\\dlight.cpp" | s_core_dlight_cpp_0061ef84 = ..\core\dlight.cpp
        ;   Label: LAB_00472c11
    MOV ESI,0xf3                        ; 00472c16
    PUSH 0x61ef97                       ; 00472c1b | = "CDemonLight::beginScene - Scene alrea..." | s_CDemonLight_beginScene_S_0061ef97 = CDemonLight::beginScene - Scene already open
    MOV dword ptr [0x02f0ca48],ECX      ; 00472c20 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 00472c26 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00472c2c | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00472c31
    JMP 0x00472a95                      ; 00472c34 | LAB_00472a95
    ...
    CALL core_event.cpp_FUN_004b19d0    ; 00472c54 | void core_event.cpp_FUN_004b19d0()
        ;   XREF to: 004b19d0 (UNCONDITIONAL_CALL)
    JMP 0x00472b92                      ; 00472c59 | LAB_00472b92
        ;   XREF to: 00472b92 (UNCONDITIONAL_JUMP)
    MOV dword ptr [0x02c6d03c],ESI      ; 00472c5e | int g_RasterizerDepthBias
        ;   Label: LAB_00472c5e
    POP EBP                             ; 00472c64
    POP EDI                             ; 00472c65
    POP ESI                             ; 00472c66
