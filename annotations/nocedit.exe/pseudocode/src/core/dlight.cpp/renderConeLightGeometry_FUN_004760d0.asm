...
; CVector3f *      Stack[0x8]:4   rotation
...
section .text
    ...
    CALL engine_drender.cpp_CDemonRenderer_isShadowPass_FUN_0048cae0 ; 004760ed
    ...
    PUSH EAX                            ; 004762e1
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 004762e2
    ...
    PUSH EAX                            ; 00476355
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 00476356
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    PUSH EAX                            ; 004763c9
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 004763ca
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    PUSH EAX                            ; 0047643f
    CALL engine_special.cpp_transformAndProjectPoint_FUN_005b575c ; 00476440
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    MOV dword ptr [EAX + 0x18],0xf80000 ; 00476477 | g_LightBufferPool[11][183800]
    MOV EAX,dword ptr [EDX]             ; 0047647e | g_CDemonRendererInstance
    MOV dword ptr [EAX + 0x1c],0xf80000 ; 00476480 | g_LightBufferPool[11][183800]
    ...
    MOV dword ptr [EAX + 0x4c],0xf80000 ; 004764b9 | g_LightBufferPool[11][183800]
    ...
    MOV dword ptr [EAX + 0xa8],0xf80000 ; 0047653a | g_LightBufferPool[11][183800]
    ...
    CALL engine_drender.cpp_CDemonRenderer_renderVertexAlphaDirect_FUN_0048bad0 ; 00476590
    ...
    CALL engine_drender.cpp_CDemonRenderer_matrixPop_FUN_0048c640 ; 004765b4
        ;   XREF to: 0048c640 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_matrixPop_FUN_0048c640(CDemonRenderer * this_ptr)
    ADD ESP,0x4                         ; 004765b9
    PUSH 0x0                            ; 004765bc
    MOV ECX,dword ptr [0x006703ec]      ; 004765be | g_CDemonRendererPtr2
    PUSH ECX                            ; 004765c4 | g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_setBlendMode_FUN_0048ca50 ; 004765c5
        ;   XREF to: 0048ca50 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_setBlendMode_FUN_0048ca50(CDemonRenderer * this_ptr, int blend_mode)
    ADD ESP,0x8                         ; 004765ca
    MOV ESP,EBP                         ; 004765cd
    POP EBP                             ; 004765cf
    POP EDI                             ; 004765d0
    POP ESI                             ; 004765d1
    POP EBX                             ; 004765d2
