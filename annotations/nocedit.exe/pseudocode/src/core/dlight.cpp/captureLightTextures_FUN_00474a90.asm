...
;   undefined4 g_LightGlow.sprites[1].texture.base.type
;   undefined4 DAT_006700b8
...
section .text
    ...
    PUSH ESI                            ; 00474a91
    PUSH 0x66fef0                       ; 00474a92 | g_LightGlow.headlight.base.type
    ...
    MOV EBX,0x66ff08                    ; 00474a9e | g_LightGlow.sprites[0].texture.base.type
    CALL engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80 ; 00474aa3
        ;   XREF to: 0048db80 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80(CDemonRenderer * this_ptr, SMRGLTextureBasic * texture)
    LEA ESI,[EBX + 0x1b0]               ; 00474aa8 | DAT_006700b8
    ADD ESP,0x8                         ; 00474aae
    PUSH EBX                            ; 00474ab1 | g_LightGlow.sprites[0].texture.base.type | g_LightGlow.sprites[1].texture.base.type
        ;   Label: LAB_00474ab1
    ...
    CALL engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80 ; 00474ab9
        ;   XREF to: 0048db80 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80(CDemonRenderer * this_ptr, SMRGLTextureBasic * texture)
    ADD EBX,0x30                        ; 00474abe | g_LightGlow.sprites[1].texture.base.type
