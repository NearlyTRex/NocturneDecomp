...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dlight.cpp_CDemonLight_renderExternalVolumetricShafts_FUN_004758d0(CDemonLight * this_ptr)
;
; Parameters:
...
section .text
    ...
    JZ 0x0047590f                       ; 004758ec | LAB_0047590f
        ;   XREF to: 0047590f (CONDITIONAL_JUMP)
    MOV EAX,[0x006810c8]                ; 004758ee | CDemonSet * g_CDemonSetPtr
    FLD float ptr [EAX + 0x15ac70]      ; 004758f3 | DAT_0326eee8
    FCOMP double ptr [0x0061f24b]       ; 004758f9 | double DOUBLE_0061f24b
    FNSTSW AX                           ; 004758ff
    SAHF                                ; 00475901
    JC 0x0047590f                       ; 00475902 | LAB_0047590f
        ;   XREF to: 0047590f (CONDITIONAL_JUMP)
    MOV EAX,[0x0067b654]                ; 00475904 | CGame g_CGameInstance | CGame * g_CGamePtr
    CMP dword ptr [EAX + 0xc],0x0       ; 00475909 | DAT_02d81aa8
    JNZ 0x00475917                      ; 0047590d | LAB_00475917
    ...
    POP EBX                             ; 00475915
    RET                                 ; 00475916
    MOV EBX,dword ptr [0x006703ec]      ; 00475917 | CDemonRenderer * g_CDemonRendererPtr
        ;   Label: LAB_00475917
    PUSH EBX                            ; 0047591d | CDemonRenderer g_CDemonRendererInstance
    LEA ESI,[EBP + -0x62]               ; 0047591e
    LEA EDI,[EBP + -0xe]                ; 00475921
    CALL engine_drender.cpp_CDemonRenderer_getCameraOriginToBuffer_FUN_0048c760 ; 00475924 | void engine_drender.cpp_CDemonRenderer_getCameraOriginToBuffer_FUN_0048c760(CDemonRenderer * this_ptr, CVector3i * output)
    ...
    MOVSD ES:EDI,ESI                    ; 00475938
    MOVSD ES:EDI,ESI                    ; 00475939
    MOVSD ES:EDI,ESI                    ; 0047593a
    FILD dword ptr [EAX]                ; 0047593b
    FMUL float ptr [0x0065c908]         ; 0047593d | float FLOAT_0065c908
    FSTP float ptr [EBX]                ; 00475943
    FILD dword ptr [EAX + 0x4]          ; 00475945
    FMUL float ptr [0x0065c908]         ; 00475948 | float FLOAT_0065c908
    FSTP float ptr [EBX + 0x4]          ; 0047594e
    FILD dword ptr [EAX + 0x8]          ; 00475951
    FMUL float ptr [0x0065c908]         ; 00475954 | float FLOAT_0065c908
    ...
    FNSTSW AX                           ; 004759a3
    SAHF                                ; 004759a5
    JNC 0x0047590f                      ; 004759a6 | LAB_0047590f
        ;   XREF to: 0047590f (CONDITIONAL_JUMP)
    FLD1                                ; 004759ac
    ...
    CALL core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0 ; 004759fd | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_00471fd0(CMatrix3x3f * this_ptr, CVector3f * output, CVector3f * input)
        ;   XREF to: 00471fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00475a02
    LEA EAX,[EBP + 0xffffff56]          ; 00475a05
    PUSH EAX                            ; 00475a0b
    MOV EDX,dword ptr [0x006703ec]      ; 00475a0c | CDemonRenderer * g_CDemonRendererPtr
    PUSH EDX                            ; 00475a12 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_getCameraOriginScaled_FUN_0048c780 ; 00475a13 | float * engine_drender.cpp_CDemonRenderer_getCameraOriginScaled_FUN_0048c780(CDemonRenderer * this_ptr, float * output)
    ...
    CALL core_dirmat.cpp_CMatrix3x3f_transformVectorTranspose_FUN_00472030 ; 00475a55 | CVector3f * core_dirmat.cpp_CMatrix3x3f_transformVectorTranspose_FUN_00472030(CMatrix3x3f * matrix, CVector3f * output, CVector3f * input)
    ...
    JZ 0x00475a83                       ; 00475a67 | LAB_00475a83
    ...
    FLD float ptr [EBP + 0xffffff5e]    ; 00475a83
        ;   Label: LAB_00475a83
    FMUL double ptr [0x0061f253]        ; 00475a89 | double DOUBLE_0061f253
    ...
    FMUL ST0                            ; 00475aa6
    FXCH ST2                            ; 00475aa8
    FMUL double ptr [0x0061f25b]        ; 00475aaa | double DOUBLE_0061f25b
    FXCH ST2                            ; 00475ab0
    FADDP                               ; 00475ab2
    FLD ST0                             ; 00475ab4
    FLD ST2                             ; 00475ab6
    ...
    FNSTSW AX                           ; 00475ac5
    SAHF                                ; 00475ac7
    JNC 0x00475adc                      ; 00475ac8 | LAB_00475adc
        ;   XREF to: 00475adc (CONDITIONAL_JUMP)
    FLD float ptr [EBP + 0x36]          ; 00475aca
    FCOMP double ptr [0x0061f263]       ; 00475acd | double DOUBLE_0061f263
    FNSTSW AX                           ; 00475ad3
    SAHF                                ; 00475ad5
    JA 0x0047590f                       ; 00475ad6 | LAB_0047590f
        ;   XREF to: 0047590f (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBP + 0x92]      ; 00475adc
        ;   Label: LAB_00475adc
    ADD EAX,0x4                         ; 00475ae2
    PUSH EAX                            ; 00475ae5
    MOV ECX,dword ptr [0x006703ec]      ; 00475ae6 | CDemonRenderer * g_CDemonRendererPtr
    PUSH ECX                            ; 00475aec | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450 ; 00475aed | void engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450(CDemonRenderer * this_ptr, CVector3f * world_position)
    ...
    PUSH EAX                            ; 00475b02
    CALL core_dirmat.cpp_CMatrix3x3f_getEulerAngles_FUN_00472160 ; 00475b03 | CVector3f * core_dirmat.cpp_CMatrix3x3f_getEulerAngles_FUN_00472160(CMatrix3x3f * this_ptr, CVector3f * euler_angles)
        ;   XREF to: 00472160 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00475b08
    PUSH 0x0                            ; 00475b0b
    LEA EAX,[EBP + -0x26]               ; 00475b0d
    PUSH EAX                            ; 00475b10
    MOV EBX,dword ptr [0x006703ec]      ; 00475b11 | CDemonRenderer * g_CDemonRendererPtr
    MOV ESI,0x1                         ; 00475b17
    PUSH EBX                            ; 00475b1c | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EBP + 0x3e],ESI      ; 00475b1d
    CALL engine_drender.cpp_CDemonRenderer_applyScaledTransform_FUN_0048c4f0 ; 00475b20 | void engine_drender.cpp_CDemonRenderer_applyScaledTransform_FUN_0048c4f0(CDemonRenderer * this_ptr, CVector3i * position, CVector3i * rotation)
        ;   XREF to: 0048c4f0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00475b25
    MOV EAX,dword ptr [EBP + 0x92]      ; 00475b28
        ;   Label: LAB_00475b28
    FLD float ptr [EAX + 0x38]          ; 00475b2e
    FDIVR double ptr [0x0061f253]       ; 00475b31 | double DOUBLE_0061f253
    MOV EAX,dword ptr [EBP + 0x3e]      ; 00475b37
    MOV dword ptr [EBP + 0x76],EAX      ; 00475b3a
    FILD dword ptr [EBP + 0x76]         ; 00475b3d
    FMULP                               ; 00475b40
    FMUL double ptr [0x0061f26b]        ; 00475b42 | double DOUBLE_0061f26b
    ...
    FLD float ptr [0x0061f273]          ; 00475b6a | float FLOAT_0061f273
    FILD dword ptr [EBP + 0x76]         ; 00475b70
    FMUL ST1                            ; 00475b73
    FLD double ptr [0x0061f27b]         ; 00475b75 | double DOUBLE_0061f27b
    FXCH                                ; 00475b7b
    FMUL ST1                            ; 00475b7d
    INC EAX                             ; 00475b7f
    FLD double ptr [0x0061f25b]         ; 00475b80 | double DOUBLE_0061f25b
    FXCH                                ; 00475b86
    FMUL ST1                            ; 00475b88
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 00475c0e | double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    FMUL ST1                            ; 00475c2f
    FXCH ST2                            ; 00475c31
    CALL crt_math.c_round_FUN_005fe6b0  ; 00475c33 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    FMUL double ptr [0x0061f283]        ; 00475c5e | double DOUBLE_0061f283
    ...
    FMUL ST1                            ; 00475c96
    FLD float ptr [0x0061f28b]          ; 00475c98 | float FLOAT_0061f28b
    FXCH                                ; 00475c9e
    FMUL ST1                            ; 00475ca0
    ...
    FLD double ptr [0x0061f293]         ; 00475cba | double DOUBLE_0061f293
    FXCH                                ; 00475cc0
    FMUL ST1                            ; 00475cc2
    ...
    FNSTSW AX                           ; 00475d1f
    SAHF                                ; 00475d21
    JNC 0x00475f98                      ; 00475d22 | LAB_00475f98
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 00475d43 | CDemonRenderer * g_CDemonRendererPtr
    FXCH                                ; 00475d49
    FSTP float ptr [EBP + -0x6e]        ; 00475d4b
    FSTP float ptr [EBP + -0x6a]        ; 00475d4e
    FLD float ptr [EAX]                 ; 00475d51
    FMUL float ptr [0x0065c900]         ; 00475d53 | float FLOAT_0065c900
    FISTP dword ptr [EBX]               ; 00475d59
    FLD float ptr [EAX + 0x4]           ; 00475d5b
    FMUL float ptr [0x0065c900]         ; 00475d5e | float FLOAT_0065c900
    FISTP dword ptr [EBX + 0x4]         ; 00475d64
    FLD float ptr [EAX + 0x8]           ; 00475d67
    FMUL float ptr [0x0065c900]         ; 00475d6a | float FLOAT_0065c900
    FISTP dword ptr [EBX + 0x8]         ; 00475d70
    LEA EAX,[EBP + 0xffffff62]          ; 00475d73
    PUSH EAX                            ; 00475d79
    MOV EAX,dword ptr [EDX]             ; 00475d7a | CDemonRenderer g_CDemonRendererInstance
    PUSH EAX                            ; 00475d7c
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 00475d7d | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
    ...
    FNSTSW AX                           ; 00475d8b
    SAHF                                ; 00475d8d
    JNC 0x00475fa0                      ; 00475d8e | LAB_00475fa0
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 00475dac | CDemonRenderer * g_CDemonRendererPtr
    FXCH                                ; 00475db2
    FSTP float ptr [EBP + -0x6e]        ; 00475db4
    FSTP float ptr [EBP + -0x6a]        ; 00475db7
    FLD float ptr [EAX]                 ; 00475dba
    FMUL float ptr [0x0065c900]         ; 00475dbc | float FLOAT_0065c900
    FISTP dword ptr [EBX]               ; 00475dc2
    FLD float ptr [EAX + 0x4]           ; 00475dc4
    FMUL float ptr [0x0065c900]         ; 00475dc7 | float FLOAT_0065c900
    FISTP dword ptr [EBX + 0x4]         ; 00475dcd
    FLD float ptr [EAX + 0x8]           ; 00475dd0
    FMUL float ptr [0x0065c900]         ; 00475dd3 | float FLOAT_0065c900
    FISTP dword ptr [EBX + 0x8]         ; 00475dd9
    LEA EAX,[EBP + -0x1a]               ; 00475ddc
    PUSH EAX                            ; 00475ddf
    MOV EAX,dword ptr [EDX]             ; 00475de0 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0x30                        ; 00475de2
    PUSH EAX                            ; 00475de5
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 00475de6 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ...
    FNSTSW AX                           ; 00475df4
    SAHF                                ; 00475df6
    JNC 0x00475fa8                      ; 00475df7 | LAB_00475fa8
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 00475e15 | CDemonRenderer * g_CDemonRendererPtr
    FXCH                                ; 00475e1b
    FSTP float ptr [EBP + -0x6e]        ; 00475e1d
    FSTP float ptr [EBP + -0x6a]        ; 00475e20
    FLD float ptr [EAX]                 ; 00475e23
    FMUL float ptr [0x0065c900]         ; 00475e25 | float FLOAT_0065c900
    FISTP dword ptr [EBX]               ; 00475e2b
    FLD float ptr [EAX + 0x4]           ; 00475e2d
    FMUL float ptr [0x0065c900]         ; 00475e30 | float FLOAT_0065c900
    FISTP dword ptr [EBX + 0x4]         ; 00475e36
    FLD float ptr [EAX + 0x8]           ; 00475e39
    FMUL float ptr [0x0065c900]         ; 00475e3c | float FLOAT_0065c900
    FISTP dword ptr [EBX + 0x8]         ; 00475e42
    LEA EAX,[EBP + -0x4a]               ; 00475e45
    PUSH EAX                            ; 00475e48
    MOV EAX,dword ptr [EDX]             ; 00475e49 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0x60                        ; 00475e4b
    PUSH EAX                            ; 00475e4e
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 00475e4f | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ...
    FNSTSW AX                           ; 00475e5d
    SAHF                                ; 00475e5f
    JNC 0x00475fb0                      ; 00475e60 | LAB_00475fb0
    ...
    MOV EDX,dword ptr [0x006703ec]      ; 00475e7e | CDemonRenderer * g_CDemonRendererPtr
    FXCH                                ; 00475e84
    FSTP float ptr [EBP + -0x6e]        ; 00475e86
    FSTP float ptr [EBP + -0x6a]        ; 00475e89
    FLD float ptr [EAX]                 ; 00475e8c
    FMUL float ptr [0x0065c900]         ; 00475e8e | float FLOAT_0065c900
    FISTP dword ptr [EBX]               ; 00475e94
    FLD float ptr [EAX + 0x4]           ; 00475e96
    FMUL float ptr [0x0065c900]         ; 00475e99 | float FLOAT_0065c900
    FISTP dword ptr [EBX + 0x4]         ; 00475e9f
    FLD float ptr [EAX + 0x8]           ; 00475ea2
    FMUL float ptr [0x0065c900]         ; 00475ea5 | float FLOAT_0065c900
    FISTP dword ptr [EBX + 0x8]         ; 00475eab
    LEA EAX,[EBP + -0x32]               ; 00475eae
    PUSH EAX                            ; 00475eb1
    MOV EAX,dword ptr [EDX]             ; 00475eb2 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0x90                        ; 00475eb4
    PUSH EAX                            ; 00475eb9
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 00475eba | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [0x006703ec]      ; 00475ebf | CDemonRenderer * g_CDemonRendererPtr
    ADD ESP,0x8                         ; 00475ec5
    MOV EBX,dword ptr [EDX]             ; 00475ec8 | CDemonRenderer g_CDemonRendererInstance
    MOV EAX,dword ptr [EBP + 0x26]      ; 00475eca
    MOV dword ptr [EBX + 0x20],EAX      ; 00475ecd
    MOV EBX,dword ptr [EDX]             ; 00475ed0 | CDemonRenderer g_CDemonRendererInstance
    MOV EAX,dword ptr [EBP + 0x26]      ; 00475ed2
    MOV dword ptr [EBX + 0x50],EAX      ; 00475ed5
    MOV EBX,dword ptr [EDX]             ; 00475ed8 | CDemonRenderer g_CDemonRendererInstance
    MOV EAX,dword ptr [EBP + 0x2a]      ; 00475eda
    MOV dword ptr [EBX + 0x80],EAX      ; 00475edd
    MOV EBX,dword ptr [EDX]             ; 00475ee3 | CDemonRenderer g_CDemonRendererInstance
    ...
    PUSH EDX                            ; 00475f46 | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EBP + 0x6a],ESI      ; 00475f47
    MOV dword ptr [EBP + 0xffffff46],EDI ; 00475f4a
    CALL engine_drender.cpp_CDemonRenderer_renderCustomScanline_FUN_0048c8d0 ; 00475f50 | void engine_drender.cpp_CDemonRenderer_renderCustomScanline_FUN_0048c8d0(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * prim, RenderScanlineFunc * scanline_renderer)
        ;   XREF to: 0048c8d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00475f55
    CMP ESI,0x4                         ; 00475f58
    JL 0x00475c78                       ; 00475f5b | LAB_00475c78
    ...
    JL 0x00475b64                       ; 00475f6b | LAB_00475b64
    ...
    JL 0x00475b28                       ; 00475f7b | LAB_00475b28
        ;   XREF to: 00475b28 (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [0x006703ec]      ; 00475f81 | CDemonRenderer * g_CDemonRendererPtr
    PUSH ESI                            ; 00475f87 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_matrixPop_FUN_0050d720 ; 00475f88 | void engine_drender.cpp_CDemonRenderer_matrixPop_FUN_0050d720()
