...

{
  ...
  do {
    ...
    do {
      ...
      local_34 = (float)(int)ROUND(ROUND((falloff - local_1c) * local_30 * (float)1024));
      local_38 = (float)(int)ROUND(ROUND((falloff - local_88) * local_30 * (float)1024));
      ...
      g_CDemonRendererPtr2->vertex_buffer_ptr->w_recip = local_38;
      this_ptr->vertex_buffer_ptr->fog = 0xffff;
      this_ptr->vertex_buffer_ptr->color = 0xffff;
      this_ptr->vertex_buffer_ptr->light = 0xffff;
      this_ptr->vertex_buffer_ptr->u = 0xf80000;
      this_ptr->vertex_buffer_ptr->v = 0xf80000;
      this_ptr->vertex_buffer_ptr[1].w_recip = local_38;
      this_ptr->vertex_buffer_ptr[1].fog = 0xffff;
      this_ptr->vertex_buffer_ptr[1].color = 0xffff;
      this_ptr->vertex_buffer_ptr[1].light = 0xffff;
      this_ptr->vertex_buffer_ptr[1].u = 0x80000;
      this_ptr->vertex_buffer_ptr[1].v = 0xf80000;
      this_ptr->vertex_buffer_ptr[2].w_recip = local_34;
      this_ptr->vertex_buffer_ptr[2].fog = 0xffff;
      this_ptr->vertex_buffer_ptr[2].color = 0xffff;
      this_ptr->vertex_buffer_ptr[2].light = 0xffff;
      this_ptr->vertex_buffer_ptr[2].u = 0x80000;
      this_ptr->vertex_buffer_ptr[2].v = 0x80000;
      this_ptr->vertex_buffer_ptr[3].w_recip = local_34;
      this_ptr->vertex_buffer_ptr[3].fog = 0xffff;
      this_ptr->vertex_buffer_ptr[3].color = 0xffff;
      this_ptr->vertex_buffer_ptr[3].light = 0xffff;
