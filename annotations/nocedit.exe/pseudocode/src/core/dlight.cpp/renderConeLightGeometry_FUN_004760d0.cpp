...

{
  ...
  do {
    ...
    do {
      ...
      g_CDemonRendererPtr2->vertex_buffer_ptr->a = local_38;
      ...
      this_ptr->vertex_buffer_ptr[1].a = local_38;
      ...
      this_ptr->vertex_buffer_ptr[2].a = local_34;
      ...
      this_ptr->vertex_buffer_ptr[3].a = local_34;
