...

{
  ...
  do {
    ...
    do {
      ...
      this_ptr->vertex_buffer_ptr->u = (0xf8 << 16);
      this_ptr->vertex_buffer_ptr->v = (0xf8 << 16);
      ...
      this_ptr->vertex_buffer_ptr[1].u = (0x8 << 16);
      this_ptr->vertex_buffer_ptr[1].v = (0xf8 << 16);
      ...
      this_ptr->vertex_buffer_ptr[2].u = (0x8 << 16);
      this_ptr->vertex_buffer_ptr[2].v = (0x8 << 16);
      ...
      this_ptr->vertex_buffer_ptr[3].u = (0xf8 << 16);
      this_ptr->vertex_buffer_ptr[3].v = (0x8 << 16);
      ...
      engine_drender_cpp_CDemonRenderer_renderVertexAlphaDirect_FUN_0048bad0(this_ptr,&local_b8.base);
    } while (iVar2 < 8);
    iVar11 = iVar11 + 1;
  } while (iVar11 < 8);
