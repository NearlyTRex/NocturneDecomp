...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dskybox.cpp_generateSkyDomeVertex_FUN_004900b0(float * light_color, int u_coord, int v_coord, float * uv_offset)
;
; Parameters:
; float *          Stack[0x4]:4   light_color
; int              Stack[0x8]:4   u_coord
; int              Stack[0xc]:4   v_coord
; float *          Stack[0x10]:4   uv_offset
; Local Variables:
