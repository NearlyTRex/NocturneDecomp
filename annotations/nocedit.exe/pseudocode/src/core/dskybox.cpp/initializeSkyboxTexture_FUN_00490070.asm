...
;                               FUNCTION
; *****************************************************************************
; __cdecl SMRGLTextureBasic * core_dskybox.cpp_initializeSkyboxTexture_FUN_00490070(SMRGLTextureBasic * texture)
;
; Parameters:
...
section .text
    ...
    MOV ESI,0x622532                    ; 00490076 | = "NITESKY.RAW" | s_NITESKY_RAW_00622532 = NITESKY.RAW
    LEA EDI,[EDX + 0xc]                 ; 0049007b
    MOV dword ptr [EDX + 0x8],0x0       ; 0049007e
    PUSH EDI                            ; 00490085
    MOV AL,byte ptr [ESI]               ; 00490086 | = "NITESKY.RAW" | s_NITESKY_RAW_00622532 = NITESKY.RAW
        ;   Label: LAB_00490086
    MOV byte ptr [EDI],AL               ; 00490088
    CMP AL,0x0                          ; 0049008a
    JZ 0x0049009e                       ; 0049008c | LAB_0049009e
        ;   XREF to: 0049009e (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0049008e | s_ITESKY.RAW_00622533
    ADD ESI,0x2                         ; 00490091
    MOV byte ptr [EDI + 0x1],AL         ; 00490094
    ADD EDI,0x2                         ; 00490097
    CMP AL,0x0                          ; 0049009a
    JNZ 0x00490086                      ; 0049009c | LAB_00490086
