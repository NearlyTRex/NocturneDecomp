...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dskybox.cpp_renderSkyDome_FUN_004901f0(SMRGLTextureBasic * sky_texture, char * texture_name, float brightness_factor)
;
; Parameters:
; SMRGLTextureBasic * Stack[0x4]:4   sky_texture
; char *           Stack[0x8]:4   texture_name
; float            Stack[0xc]:4   brightness_factor
; Local Variables:
...
section .text
    ...
    CMP AL,0x0                          ; 00490210
    JZ 0x00490224                       ; 00490212 | LAB_00490224
    ...
    CMP AL,0x0                          ; 00490220
    JNZ 0x0049020c                      ; 00490222 | LAB_0049020c
    ...
    PUSH EAX                            ; 00490233
    PUSH 0x3277d14                      ; 00490234 | CDemonRaytrace g_CDemonRaytraceInstance
    CALL core_dtrace.cpp_CDemonRaytrace_getBBoxMin_FUN_00499b40 ; 00490239 | CVector3f * core_dtrace.cpp_CDemonRaytrace_getBBoxMin_FUN_00499b40(CDemonRaytrace * this_ptr, CVector3f * output_vector)
        ;   XREF to: 00499b40 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0049023e
    LEA EAX,[ESP + 0x60]                ; 00490241
    PUSH EAX                            ; 00490245
    PUSH 0x3277d14                      ; 00490246 | CDemonRaytrace g_CDemonRaytraceInstance
    CALL core_dtrace.cpp_CDemonRaytrace_getBBoxMax_FUN_00499b70 ; 0049024b | CVector3f * core_dtrace.cpp_CDemonRaytrace_getBBoxMax_FUN_00499b70(CDemonRaytrace * this_ptr, CVector3f * output_vector)
        ;   XREF to: 00499b70 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00490250
    FLD float ptr [ESP + 0x54]          ; 00490253
    FADD float ptr [ESP + 0x60]         ; 00490257
    FLD double ptr [0x0062256a]         ; 0049025b | double DOUBLE_0062256a
    FXCH                                ; 00490261
    FMUL ST1                            ; 00490263
    ...
    FXCH                                ; 0049027b
    FMULP ST3                           ; 0049027d
    FMUL double ptr [0x00622572]        ; 0049027f | double DOUBLE_00622572
    FLDZ                                ; 00490285
    XOR EDX,EDX                         ; 00490287
    MOV EAX,dword ptr [ESP + 0x58]      ; 00490289
    MOV dword ptr [0x00672360],EDX      ; 0049028d | float g_SkyDomeVertexScale
    MOV [0x02ca038c],EAX                ; 00490293 | CVector3i_02ca0388.y
    FXCH ST2                            ; 00490298
    FSTP float ptr [0x02ca0388]         ; 0049029a | CVector3i CVector3i_02ca0388
    FXCH ST2                            ; 004902a0
    ...
    FNSTSW AX                           ; 004902b8
    SAHF                                ; 004902ba
    JC 0x00490693                       ; 004902bb | LAB_00490693
        ;   XREF to: 00490693 (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x64]          ; 004902c1
        ;   Label: LAB_004902c1
    FSUB float ptr [ESP + 0x58]         ; 004902c5
    FMUL double ptr [0x00622572]        ; 004902c9 | double DOUBLE_00622572
    FST float ptr [ESP + 0x88]          ; 004902cf
    FCOMP float ptr [0x00672360]        ; 004902d6 | float g_SkyDomeVertexScale
    FNSTSW AX                           ; 004902dc
    SAHF                                ; 004902de
    JBE 0x004902ed                      ; 004902df | LAB_004902ed
        ;   XREF to: 004902ed (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x88]      ; 004902e1
    MOV [0x00672360],EAX                ; 004902e8 | float g_SkyDomeVertexScale
    FLD float ptr [ESP + 0x68]          ; 004902ed
        ;   Label: LAB_004902ed
    FSUB float ptr [ESP + 0x5c]         ; 004902f1
    FMUL double ptr [0x0062256a]        ; 004902f5 | double DOUBLE_0062256a
    FMUL double ptr [0x00622572]        ; 004902fb | double DOUBLE_00622572
    FST float ptr [ESP + 0x84]          ; 00490301
    FCOMP float ptr [0x00672360]        ; 00490308 | float g_SkyDomeVertexScale
    FNSTSW AX                           ; 0049030e
    SAHF                                ; 00490310
    JBE 0x0049031f                      ; 00490311 | LAB_0049031f
        ;   XREF to: 0049031f (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x84]      ; 00490313
    MOV [0x00672360],EAX                ; 0049031a | float g_SkyDomeVertexScale
    PUSH 0x2ca0388                      ; 0049031f | CVector3i CVector3i_02ca0388
        ;   Label: LAB_0049031f
    MOV ECX,dword ptr [0x006703ec]      ; 00490324 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH ECX                            ; 0049032a | CDemonRenderer g_CDemonRendererInstance
    MOV EBX,0x4                         ; 0049032b
    XOR ESI,ESI                         ; 00490330
    CALL engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450 ; 00490332 | void engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_0048c450(CDemonRenderer * this_ptr, CVector3f * world_position)
        ;   XREF to: 0048c450 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [0x006703ec]      ; 00490337 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    ...
    PUSH ECX                            ; 00490350 | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [ESP + 0x14],ESI      ; 00490351
    MOV dword ptr [ESP + 0x10],ESI      ; 00490355
    CALL engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80 ; 00490359 | void engine_drender.cpp_CDemonRenderer_captureTexture_FUN_0048db80(CDemonRenderer * this_ptr, SMRGLTextureBasic * texture)
        ;   XREF to: 0048db80 (UNCONDITIONAL_CALL)
    FLD double ptr [0x0062257a]         ; 0049035e | double DOUBLE_0062257a
    FSIN                                ; 00490364
    ADD ESP,0x8                         ; 00490366
    FLD float ptr [0x00672360]          ; 00490369 | float g_SkyDomeVertexScale
    FXCH                                ; 0049036f
    FMUL ST1                            ; 00490371
    FLD double ptr [0x00622582]         ; 00490373 | double DOUBLE_00622582
    FXCH                                ; 00490379
    FMUL ST1                            ; 0049037b
    FXCH ST2                            ; 0049037d
    FMULP                               ; 0049037f
    FXCH                                ; 00490381
    CALL crt_math.c_round_FUN_005fe6b0  ; 00490383 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x48]        ; 00490388
    MOV EAX,dword ptr [ESP + 0x48]      ; 0049038c
    MOV ECX,dword ptr [0x006703ec]      ; 00490390 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    MOV dword ptr [ESP + 0x50],EAX      ; 00490396
    LEA EAX,[ESP + 0x48]                ; 0049039a
    CALL crt_math.c_round_FUN_005fe6b0  ; 0049039e | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    PUSH EAX                            ; 004903a3
    FISTP dword ptr [ESP + 0x50]        ; 004903a4
    MOV EAX,dword ptr [ECX]             ; 004903a8 | CDemonRenderer g_CDemonRendererInstance
    PUSH EAX                            ; 004903aa
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 004903ab | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004903b0
    MOV EBX,dword ptr [ESP + 0x48]      ; 004903b3
    LEA EAX,[ESP + 0x48]                ; 004903b7
    NEG EBX                             ; 004903bb
    MOV ECX,dword ptr [0x006703ec]      ; 004903bd | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    MOV dword ptr [ESP + 0x48],EBX      ; 004903c3
    PUSH EAX                            ; 004903c7
    MOV EAX,dword ptr [ECX]             ; 004903c8 | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0x30                        ; 004903ca
    PUSH EAX                            ; 004903cd
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 004903ce | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004903d3
    MOV ESI,dword ptr [ESP + 0x50]      ; 004903d6
    LEA EAX,[ESP + 0x48]                ; 004903da
    NEG ESI                             ; 004903de
    MOV ECX,dword ptr [0x006703ec]      ; 004903e0 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    MOV dword ptr [ESP + 0x50],ESI      ; 004903e6
    PUSH EAX                            ; 004903ea
    MOV EAX,dword ptr [ECX]             ; 004903eb | CDemonRenderer g_CDemonRendererInstance
    ADD EAX,0x60                        ; 004903ed
    PUSH EAX                            ; 004903f0
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 004903f1 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004903f6
    MOV EDI,dword ptr [ESP + 0x48]      ; 004903f9
    NEG EDI                             ; 004903fd
    MOV EAX,[0x006703ec]                ; 004903ff | CDemonRenderer * g_CDemonRendererPtr
    MOV dword ptr [ESP + 0x48],EDI      ; 00490404
    LEA ECX,[ESP + 0x48]                ; 00490408
    MOV EAX,dword ptr [EAX]             ; 0049040c | CDemonRenderer g_CDemonRendererInstance
    PUSH ECX                            ; 0049040e
    ADD EAX,0x90                        ; 0049040f
    PUSH EAX                            ; 00490414
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c ; 00490415 | void wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c(SProjectedVertex * output, CVector3i * input)
        ;   XREF to: 005b575c (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0049041a
    MOV EAX,[0x006703ec]                ; 0049041d | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    MOV EBX,dword ptr [EAX]             ; 00490422 | CDemonRenderer g_CDemonRendererInstance
    MOV ECX,dword ptr [EBP]             ; 00490424
    MOV dword ptr [EBX + 0x20],ECX      ; 00490427
    MOV EBX,dword ptr [EAX]             ; 0049042a | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EBX + 0x24],ECX      ; 0049042c
    MOV EBX,dword ptr [EAX]             ; 0049042f | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EBX + 0x28],ECX      ; 00490431
    MOV ECX,dword ptr [EAX]             ; 00490434 | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [ECX + 0x2c],0x0      ; 00490436
    MOV ECX,dword ptr [EAX]             ; 0049043d | CDemonRenderer g_CDemonRendererInstance
    MOV EBX,dword ptr [EBP]             ; 0049043f
    MOV dword ptr [ECX + 0x50],EBX      ; 00490442
    MOV ECX,dword ptr [EAX]             ; 00490445 | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [ECX + 0x54],EBX      ; 00490447
    MOV EBX,dword ptr [EAX]             ; 0049044a | CDemonRenderer g_CDemonRendererInstance
    MOV ECX,dword ptr [EBP]             ; 0049044c
    MOV dword ptr [EBX + 0x58],ECX      ; 0049044f
    MOV ECX,dword ptr [EAX]             ; 00490452 | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [ECX + 0x5c],0x0      ; 00490454
    MOV EBX,dword ptr [EAX]             ; 0049045b | CDemonRenderer g_CDemonRendererInstance
    MOV ECX,dword ptr [EBP]             ; 0049045d
    MOV dword ptr [EBX + 0x80],ECX      ; 00490460
    MOV EBX,dword ptr [EAX]             ; 00490466 | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EBX + 0x84],ECX      ; 00490468
    MOV EBX,dword ptr [EAX]             ; 0049046e | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EBX + 0x88],ECX      ; 00490470
    MOV ECX,dword ptr [EAX]             ; 00490476 | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [ECX + 0x8c],0x0      ; 00490478
    MOV EBX,dword ptr [EAX]             ; 00490482 | CDemonRenderer g_CDemonRendererInstance
    MOV ECX,dword ptr [EBP]             ; 00490484
    MOV dword ptr [EBX + 0xb0],ECX      ; 00490487
    MOV EBX,dword ptr [EAX]             ; 0049048d | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [EBX + 0xb4],ECX      ; 0049048f
    MOV EBX,dword ptr [EAX]             ; 00490495 | CDemonRenderer g_CDemonRendererInstance
    MOV ESI,0x1                         ; 00490497
    MOV dword ptr [EBX + 0xb8],ECX      ; 0049049c
    MOV EDI,0x3                         ; 004904a2
    MOV ECX,dword ptr [EAX]             ; 004904a7 | CDemonRenderer g_CDemonRendererInstance
    PUSH 0x2c5                          ; 004904a9
    ...
    PUSH EAX                            ; 004904f5 | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [ESP + 0x4c],EBX      ; 004904f6
    MOV dword ptr [ESP + 0x50],EBX      ; 004904fa
    CALL engine_drender.cpp_CDemonRenderer_renderWireframeVariant_FUN_0048aeb0 ; 004904fe | void engine_drender.cpp_CDemonRenderer_renderWireframeVariant_FUN_0048aeb0(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * polygon_info, int render_flags)
    ...
    INC ESI                             ; 0049051a
    INC EBX                             ; 0049051b
    CALL core_dskybox.cpp_generateSkyDomeVertex_FUN_004900b0 ; 0049051c | void core_dskybox.cpp_generateSkyDomeVertex_FUN_004900b0(float * light_color, int u_coord, int v_coord, float * uv_offset)
        ;   XREF to: 004900b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00490521
    CMP EBX,0x4                         ; 00490524
    JL 0x00490516                       ; 00490527 | LAB_00490516
    ...
    JLE 0x0049050d                      ; 0049053e | LAB_0049050d
    ...
    ADD EAX,0x400000                    ; 00490585 | IMAGE_DOS_HEADER IMAGE_DOS_HEADER_00400000
    ...
    PUSH EAX                            ; 00490638
    MOV EAX,[0x006703ec]                ; 00490639 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    MOV dword ptr [ESP + 0x28],EBP      ; 0049063e
    PUSH EAX                            ; 00490642 | CDemonRenderer g_CDemonRendererInstance
    MOV dword ptr [ESP + 0x50],EBP      ; 00490643
    ADD ESI,0x1000000                   ; 00490647 | DAT_01000000
    CALL engine_drender.cpp_CDemonRenderer_renderWireframeVariant_FUN_0048aeb0 ; 0049064d | void engine_drender.cpp_CDemonRenderer_renderWireframeVariant_FUN_0048aeb0(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * polygon_info, int render_flags)
        ;   XREF to: 0048aeb0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00490652
    CMP EDI,0x3                         ; 00490655
    JL 0x00490593                       ; 00490658 | LAB_00490593
    ...
    JNZ 0x00490550                      ; 00490682 | LAB_00490550
    ...
    MOV EAX,dword ptr [ESP + 0x80]      ; 00490693
        ;   Label: LAB_00490693
    MOV [0x00672360],EAX                ; 0049069a | float g_SkyDomeVertexScale
    JMP 0x004902c1                      ; 0049069f | LAB_004902c1
