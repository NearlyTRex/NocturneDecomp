...
section .text
    ...
    PUSH 0x2ca0148                      ; 00490040 | SMRGLTextureBasic g_SkyDomeTextureData
        ;   Label: core_dskybox.cpp_staticInit_FUN_00490040
    CALL core_dskybox.cpp_initializeSkyboxTexture_FUN_00490070 ; 00490045 | SMRGLTextureBasic * core_dskybox.cpp_initializeSkyboxTexture_FUN_00490070(SMRGLTextureBasic * texture)
        ;   XREF to: 00490070 (UNCONDITIONAL_CALL)
    XOR EDX,EDX                         ; 0049004a
    ADD ESP,0x4                         ; 0049004c
    MOV dword ptr [0x02ca0388],EDX      ; 0049004f | CVector3i CVector3i_02ca0388
