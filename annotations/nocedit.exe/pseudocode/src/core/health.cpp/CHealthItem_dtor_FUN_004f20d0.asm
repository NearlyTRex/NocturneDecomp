...
;                               FUNCTION
; *****************************************************************************
; __cdecl CHealthItem * core_health.cpp_CHealthItem_dtor_FUN_004f20d0(CHealthItem * this_ptr, uint d1, uint d2)
;
; Parameters:
...
section .text
    ...
    PUSH 0x65f690                       ; 004f20f6 | g_CHealthItemTypeInfo
        ;   Label: LAB_004f20f6
    PUSH EBX                            ; 004f20fb
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 004f20fc
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 004f2101
    PUSH EAX                            ; 004f2104
    CALL crt_memory.c_free_FUN_005fe659 ; 004f2105
