...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_health_cpp_CHealthItem_getPropertyList_FUN_004f2040(CHealthItem *this_ptr,CActorPropertyList *property_list)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004f2040
        ;   Label: core_health.cpp_CHealthItem_getPropertyList_FUN_004f2040
    PUSH ESI                            ; 004f2041
