...
;                               FUNCTION
; *****************************************************************************
; __cdecl CBoundingBox3D * __cdecl core_health_cpp_CHealthItem_FUN_004f1ed0(CHealthItem *this_ptr,CBoundingBox3D *out_box)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004f1ed0
        ;   Label: core_health.cpp_CHealthItem_FUN_004f1ed0
    MOV EBX,dword ptr [ESP + 0xc]       ; 004f1ed1
    MOV EAX,dword ptr [ESP + 0x8]       ; 004f1ed5
    ADD EAX,0x158                       ; 004f1ed9
    PUSH EAX                            ; 004f1ede
    CALL core_dmodel.cpp_CKeyFramedModelInstance_getModelPtr_FUN_00478d80 ; 004f1edf
