...
section .text
    ...
    PUSH 0x2dc                          ; 004f1d97
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1b0 ; 004f1d9c
    ...
    PUSH EAX                            ; 004f1da9
        ;   Label: LAB_004f1da9
    CALL core_health.cpp_FUN_004f1dd0   ; 004f1daa
        ;   XREF to: 004f1dd0 (UNCONDITIONAL_CALL)  ; CHealthItem * core_health.cpp_FUN_004f1dd0(CHealthItem * this_ptr)
