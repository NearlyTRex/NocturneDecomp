...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_health_cpp_CHealthItem_canPickup_FUN_004f1fb0(CHealthItem *this_ptr,CDemonActor *picker)
;
; Parameters:
...
section .text
    ...
    PUSH 0x62ea29                       ; 004f1fb0 | = "CHero"
        ;   Label: core_health.cpp_CHealthItem_canPickup_FUN_004f1fb0
