...

{
  ...
  if (iVar6 == 0) {
    ...
    case 0:
      ...
      iVar4 = core_gargoyle_cpp_CGargoyle_shouldMove_FUN_004e48a0(this_ptr);
      if (iVar4 == 0) {
    ...
    case 3:
      ...
      core_enemy_cpp_CEnemy_testAttackRadius_FUN_004a9880(&this_ptr->base,pCVar7,fVar10,damage_info)
      ;
      break;
    case 5:
      (*(((this_ptr->base).base.base.vtable._ue)->_ue).updateVictim)(&this_ptr->base,delta_time);
