...
section .text
    ...
    PUSH ESI                            ; 004e45e7
    CALL core_enemy.cpp_CEnemy_FUN_004a9650 ; 004e45e8
    ...
    PUSH EBX                            ; 004e4621
    MOV [0x02d83200],EAX                ; 004e4622 | DAT_02d83200
    ...
    PUSH EBX                            ; 004e4660
    MOV [0x02d83214],EAX                ; 004e4661 | DAT_02d83214
    ...
    PUSH EBX                            ; 004e4675
    MOV [0x02d83218],EAX                ; 004e4676 | DAT_02d83218
    ...
    PUSH EBX                            ; 004e46c9
    MOV [0x02d83208],EAX                ; 004e46ca | DAT_02d83208
    ...
    PUSH EBX                            ; 004e46de
    MOV [0x02d83224],EAX                ; 004e46df | DAT_02d83224
    ...
    PUSH EBX                            ; 004e4708
    MOV [0x02d8322c],EAX                ; 004e4709 | DAT_02d8322c
    ...
    PUSH EBX                            ; 004e471d
    MOV [0x02d83200],EAX                ; 004e471e | DAT_02d83200
    ...
    PUSH EBX                            ; 004e4732
    MOV [0x02d83214],EAX                ; 004e4733 | DAT_02d83214
    ...
    PUSH EBX                            ; 004e4747
    MOV [0x02d83218],EAX                ; 004e4748 | DAT_02d83218
