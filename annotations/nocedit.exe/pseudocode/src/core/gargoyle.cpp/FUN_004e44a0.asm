...
section .text
    ...
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1b0 ; 004e44ac
    ...
    PUSH EAX                            ; 004e44b9
        ;   Label: LAB_004e44b9
    CALL core_gargoyle.cpp_FUN_004e44e0 ; 004e44ba
        ;   XREF to: 004e44e0 (UNCONDITIONAL_CALL)  ; CGargoyle * core_gargoyle.cpp_FUN_004e44e0(CGargoyle * this_ptr)
