...
section .text
    ...
    PUSH EBX                            ; 004e5476
    CALL core_enemy.cpp_CEnemy_serialize_FUN_004a9660 ; 004e5477
    ...
    PUSH ESI                            ; 004e548a
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 004e548b
    ...
    PUSH ESI                            ; 004e549e
    CALL core_actor.cpp_serializedDeformableModelInstance_FUN_0040b970 ; 004e549f
    ...
    PUSH ESI                            ; 004e54ac
    CALL core_actor.cpp_serializeMotionState_FUN_0040b9f0 ; 004e54ad
    ...
    PUSH ESI                            ; 004e54ce
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 004e54cf
    ...
    PUSH ESI                            ; 004e54e2
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 004e54e3
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ADD ESP,0x8                         ; 004e54e8
    PUSH 0x62d9f0                       ; 004e54eb | = "stoneBlue"
    LEA ESI,[EBX + 0xbef4]              ; 004e54f0
    PUSH ESI                            ; 004e54f6
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 004e54f7
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ADD ESP,0x8                         ; 004e54fc
    PUSH 0x62d9fa                       ; 004e54ff | = "homeBase"
    ADD EBX,0xbef8                      ; 004e5504
    PUSH EBX                            ; 004e550a
    CALL core_actor.cpp_serializeActor_FUN_0040b870 ; 004e550b
