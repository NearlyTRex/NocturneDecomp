...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_gargoyle.cpp_CGargoyle_unk4_FUN_004e5530()
;
; Local Variables:
; undefined4       Stack[-0x14]:4  local_14
;
; XREF[1]:
;   core_gargoyle.cpp_CGargoyle_unk3_FUN_004e57d0 at 004e583d
;
; Referenced Globals:
...
section .text
    ...
    FNSTSW AX                           ; 004e5546
    SAHF                                ; 004e5548
    JNC 0x004e5575                      ; 004e5549 | default
        ;   XREF to: 004e5575 (CONDITIONAL_JUMP)
    CMP dword ptr [ESI],-0x1            ; 004e554b
    JNZ 0x004e5575                      ; 004e554e | default
        ;   XREF to: 004e5575 (CONDITIONAL_JUMP)
    CALL crt_stdlib.c_rand_FUN_005feb5c ; 004e5550 | int crt_stdlib.c_rand_FUN_005feb5c()
    ...
    JA 0x004e5575                       ; 004e5564 | default
        ;   XREF to: 004e5575 (CONDITIONAL_JUMP)
    JMP dword ptr [EDX*0x4 + 0x4e5518]  ; 004e5566 | void * switchdataD_004e5518
        ;   Label: switchD
    ...
    JNZ 0x004e574c                      ; 004e557f | LAB_004e574c
    ...
    JNZ 0x004e559e                      ; 004e5594 | LAB_004e559e
    ...
    JNZ 0x004e55b0                      ; 004e55a6 | LAB_004e55b0
        ;   XREF to: 004e55b0 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x8],0x3ca3d70a ; 004e55a8
    MOV EAX,[0x0067b654]                ; 004e55b0 | CGame g_CGameInstance | CGame * g_CGamePtr
        ;   Label: LAB_004e55b0
    CMP dword ptr [EAX + 0x1e0],0x0     ; 004e55b5 | g_CGameInstance.field57_0x1e0
    JZ 0x004e55c6                       ; 004e55bc | LAB_004e55c6
        ;   XREF to: 004e55c6 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x8],0x3f800000 ; 004e55be
    PUSH dword ptr [ESP + 0x8]          ; 004e55c6
        ;   Label: LAB_004e55c6
    CALL core_actor.cpp_randomChance_FUN_0040cd10 ; 004e55ca | int core_actor.cpp_randomChance_FUN_0040cd10(float probability_threshold)
        ;   XREF to: 0040cd10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 004e55cf
    TEST EAX,EAX                        ; 004e55d2
    JZ 0x004e56e3                       ; 004e55d4 | LAB_004e56e3
    ...
    PUSH EAX                            ; 004e55f1
    CALL core_bodypart.cpp_CreateBodyPart_FUN_00418e10 ; 004e55f2 | undefined core_bodypart.cpp_CreateBodyPart_FUN_00418e10()
    ...
    CALL core_charactr.cpp_CCharacter_FUN_0042bd30 ; 004e5605 | void core_charactr.cpp_CCharacter_FUN_0042bd30(CCharacter * this_ptr)
    ...
    JNZ 0x004e562c                      ; 004e5617 | LAB_004e562c
    ...
    PUSH EDI                            ; 004e5622
    PUSH EBX                            ; 004e5623
    CALL core_charactr.cpp_CCharacter_FUN_0042bd30 ; 004e5624 | void core_charactr.cpp_CCharacter_FUN_0042bd30(CCharacter * this_ptr)
        ;   XREF to: 0042bd30 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004e5629
    MOV EDX,dword ptr [EBX + 0xbec4]    ; 004e562c
        ;   Label: LAB_004e562c
    CMP EDX,dword ptr [ESI]             ; 004e5632
    JNZ 0x004e5649                      ; 004e5634 | LAB_004e5649
    ...
    PUSH EBP                            ; 004e563f
    PUSH EBX                            ; 004e5640
    CALL core_charactr.cpp_CCharacter_FUN_0042bd30 ; 004e5641 | void core_charactr.cpp_CCharacter_FUN_0042bd30(CCharacter * this_ptr)
        ;   XREF to: 0042bd30 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004e5646
    MOV EDI,dword ptr [EBX + 0xbee0]    ; 004e5649
        ;   Label: LAB_004e5649
    CMP EDI,dword ptr [ESI]             ; 004e564f
    JNZ 0x004e56b5                      ; 004e5651 | LAB_004e56b5
    ...
    PUSH EAX                            ; 004e565f
    PUSH EBX                            ; 004e5660
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 004e5661 | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
    ...
    PUSH EDX                            ; 004e5672
    PUSH EBX                            ; 004e5673
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 004e5674 | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ...
    PUSH ECX                            ; 004e5685
    PUSH EBX                            ; 004e5686
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 004e5687 | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 004e5698
    PUSH EBX                            ; 004e5699
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 004e569a | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ...
    PUSH EDX                            ; 004e56ab
    PUSH EBX                            ; 004e56ac
    CALL core_charactr.cpp_CCharacter_FUN_0042bcc0 ; 004e56ad | void core_charactr.cpp_CCharacter_FUN_0042bcc0(CCharacter * this_ptr)
        ;   XREF to: 0042bcc0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004e56b2
    PUSH EBP                            ; 004e56b5
        ;   Label: LAB_004e56b5
    CALL core_bodypart.cpp_FUN_0041a050 ; 004e56b6 | undefined core_bodypart.cpp_FUN_0041a050()
    ...
    JZ 0x004e578d                       ; 004e56cd | LAB_004e578d
        ;   XREF to: 004e578d (CONDITIONAL_JUMP)
    FLD float ptr [ESI + 0x8]           ; 004e56d3
        ;   Label: LAB_004e56d3
    FLD ST0                             ; 004e56d6
    FMUL double ptr [0x0062da07]        ; 004e56d8 | double DOUBLE_0062da07
    FSTP ST1                            ; 004e56de
    ...
    FLD float ptr [ESI + 0x4]           ; 004e57b1
        ;   Label: LAB_004e57b1
    FLD ST0                             ; 004e57b4
    FMUL double ptr [0x0062da0f]        ; 004e57b6 | double DOUBLE_0062da0f
    FSTP ST1                            ; 004e57bc
