...
section .text
    ...
    JZ 0x004e4950                       ; 004e48bf | LAB_004e4950
    ...
    FNSTSW AX                           ; 004e494b
    SAHF                                ; 004e494d
    JBE 0x004e4957                      ; 004e494e | LAB_004e4957
    ...
    PUSH EAX                            ; 004e4974
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 004e4975 | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)
    MOV EDX,EAX                         ; 004e497a
    LEA EAX,[ESP + 0x1c]                ; 004e497c
    ADD ESP,0x8                         ; 004e4980
    CMP EAX,EDX                         ; 004e4983
    JZ 0x004e499b                       ; 004e4985 | LAB_004e499b
    ...
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 004e49ae | float core_actor.cpp_normalizeAngleToPi_FUN_0040cd70(float angle_radians)
        ;   XREF to: 0040cd70 (UNCONDITIONAL_CALL)
    MOV dword ptr [ESP + 0x30],EAX      ; 004e49b3
    FLD float ptr [ESP + 0x30]          ; 004e49b7
    ADD ESP,0x4                         ; 004e49bb
    FST double ptr [ESP]                ; 004e49be
    FCOMP double ptr [0x0062d92f]       ; 004e49c1 | double DOUBLE_0062d92f
    FNSTSW AX                           ; 004e49c7
    SAHF                                ; 004e49c9
    JC 0x004e49de                       ; 004e49ca | LAB_004e49de
        ;   XREF to: 004e49de (CONDITIONAL_JUMP)
    FLD double ptr [ESP]                ; 004e49cc
    FCOMP double ptr [0x0062d937]       ; 004e49cf | double DOUBLE_0062d937
    FNSTSW AX                           ; 004e49d5
    SAHF                                ; 004e49d7
    JBE 0x004e4950                      ; 004e49d8 | LAB_004e4950
        ;   XREF to: 004e4950 (CONDITIONAL_JUMP)
