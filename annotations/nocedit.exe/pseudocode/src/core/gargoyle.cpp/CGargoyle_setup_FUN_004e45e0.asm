...
section .text
    ...
    PUSH EBX                            ; 004e45e0
        ;   Label: core_gargoyle.cpp_CGargoyle_setup_FUN_004e45e0
    PUSH ESI                            ; 004e45e1
    PUSH EDI                            ; 004e45e2
    ...
    PUSH EBX                            ; 004e4621
    MOV [0x02d83200],EAX                ; 004e4622 | g_GargoyleIndices
    ...
    PUSH EBX                            ; 004e4636
    MOV [0x02d8320c],EAX                ; 004e4637 | g_GargoyleIndices[3]
    ...
    PUSH EBX                            ; 004e464b
    MOV [0x02d83210],EAX                ; 004e464c | g_GargoyleIndices[4]
    ...
    PUSH EBX                            ; 004e4660
    MOV [0x02d83214],EAX                ; 004e4661 | g_GargoyleIndices[5]
    ...
    PUSH EBX                            ; 004e4675
    MOV [0x02d83218],EAX                ; 004e4676 | g_GargoyleIndices[6]
    ...
    PUSH EBX                            ; 004e468a
    MOV [0x02d8321c],EAX                ; 004e468b | g_GargoyleIndices[7]
    ...
    PUSH EBX                            ; 004e469f
    MOV [0x02d83220],EAX                ; 004e46a0 | g_GargoyleIndices[8]
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 004e46a5
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 004e46aa
    MOV [0x02d83204],EAX                ; 004e46ad | g_GargoyleIndices[1]
    PUSH 0x1                            ; 004e46b2
    ...
    PUSH EBX                            ; 004e46c9
    MOV [0x02d83208],EAX                ; 004e46ca | g_GargoyleIndices[2]
    ...
    PUSH EBX                            ; 004e46de
    MOV [0x02d83224],EAX                ; 004e46df | g_GargoyleIndices[9]
    ...
    PUSH EBX                            ; 004e46f3
    MOV [0x02d83228],EAX                ; 004e46f4 | g_GargoyleIndices[10]
    ...
    PUSH EBX                            ; 004e4708
    MOV [0x02d8322c],EAX                ; 004e4709 | g_GargoyleIndices[11]
    ...
    PUSH EBX                            ; 004e471d
    MOV [0x02d83200],EAX                ; 004e471e | g_GargoyleIndices
    ...
    PUSH EBX                            ; 004e4732
    MOV [0x02d83214],EAX                ; 004e4733 | g_GargoyleIndices[5]
    ...
    PUSH EBX                            ; 004e4747
    MOV [0x02d83218],EAX                ; 004e4748 | g_GargoyleIndices[6]
    ...
    PUSH EBX                            ; 004e475c
    MOV [0x02d83224],EAX                ; 004e475d | g_GargoyleIndices[9]
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 004e4762
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 004e4767
    PUSH EDI                            ; 004e476a
    MOV [0x02d8322c],EAX                ; 004e476b | g_GargoyleIndices[11]
