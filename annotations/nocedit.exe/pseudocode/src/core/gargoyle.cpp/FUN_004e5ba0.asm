...
section .text
    ...
    PUSH ECX                            ; 004e5baa
    CALL core_actor.cpp_CDemonActor_writeDependencies_FUN_0040cfd0 ; 004e5bab
    ...
    PUSH EAX                            ; 004e5bc1
    CALL core_skeledit.cpp_CDeformableModelInstance_writeDependencies_FUN_0058a260 ; 004e5bc2
