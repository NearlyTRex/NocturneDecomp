...

{
  ...
  if ((0.0 < (float)in_stack_00000008[0xb]) && (*in_stack_00000008 == -1)) {
    ...
    switch(iVar1 % 6) {
    case 0:
      iVar1 = *(int *)(this_ptr->unk1 + 8);
      break;
    case 1:
      iVar1 = *(int *)(this_ptr->unk1 + 0xc);
      break;
    case 2:
      iVar1 = *(int *)(this_ptr->unk1 + 0x10);
      break;
    case 3:
      iVar1 = *(int *)(this_ptr->unk1 + 0x14);
      break;
    case 4:
      iVar1 = *(int *)(this_ptr->unk1 + 0x30);
      break;
    case 5:
      iVar1 = *(int *)(this_ptr->unk1 + 0x2c);
      break;
    default:
...
switchD_004e5566_default:
  ...
  if (((((iVar1 == *(int *)(this_ptr->unk1 + 8)) || (iVar1 == *(int *)(this_ptr->unk1 + 0xc))) ||
       (iVar1 == *(int *)(this_ptr->unk1 + 0x10))) ||
      ((iVar1 == *(int *)(this_ptr->unk1 + 0x14) || (iVar1 == *(int *)(this_ptr->unk1 + 0x2c))))) ||
     (iVar1 == *(int *)(this_ptr->unk1 + 0x30))) {
    local_14 = (float)in_stack_00000008[0xb];
    if (*(int *)(this_ptr->unk1 + 0x30) == *in_stack_00000008) {
      local_14 = 0.05;
    }
    if (*(int *)(this_ptr->unk1 + 0x2c) == *in_stack_00000008) {
      local_14 = 0.02;
    }
    ...
    if (iVar1 != 0) {
      ...
      if (*in_stack_00000008 == *(int *)(this_ptr->unk1 + 8)) {
        core_charactr_cpp_CCharacter_FUN_0042bd30((CCharacter *)this_ptr);
      }
      if (*(int *)(this_ptr->unk1 + 0x10) == *in_stack_00000008) {
        core_charactr_cpp_CCharacter_FUN_0042bd30((CCharacter *)this_ptr);
      }
      if (*(int *)(this_ptr->unk1 + 0x2c) == *in_stack_00000008) {
      ...
      if ((this_ptr->base).base.model.part_visibility_flags[*(int *)(this_ptr->unk1 + 0x30)] == 0) {
  ...
  iVar1 = *in_stack_00000008;
  if (iVar1 == *(int *)(this_ptr->unk1 + 0x30)) {
    in_stack_00000008[1] = (int)((float)in_stack_00000008[1] * (float)2.5);
    return;
  }
  if ((iVar1 != *(int *)(this_ptr->unk1 + 0x28)) && (iVar1 != *(int *)(this_ptr->unk1 + 0x2c))) {
