...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_dracbrid_cpp_CDraculaBride_FUN_004858f0(CDraculaBride *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004858f0
        ;   Label: core_dracbrid.cpp_CDraculaBride_FUN_004858f0
    PUSH ESI                            ; 004858f1
    PUSH EDI                            ; 004858f2
    PUSH EBP                            ; 004858f3
    ...
    PUSH ESI                            ; 00485964
        ;   Label: LAB_00485964
    PUSH EDI                            ; 00485965
    CALL core_dracbrid.cpp_CDraculaBride_FUN_00485b20 ; 00485966
        ;   XREF to: 00485b20 (UNCONDITIONAL_CALL)  ; void core_dracbrid.cpp_CDraculaBride_FUN_00485b20(CDraculaBride * this_ptr)
