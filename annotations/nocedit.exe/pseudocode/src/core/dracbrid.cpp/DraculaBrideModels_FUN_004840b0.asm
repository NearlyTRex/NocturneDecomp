...
section .text
    ...
    PUSH ESI                            ; 00484176
    MOV [0x02c6d0a0],EAX                ; 00484177 | DAT_02c6d0a0
    ...
    PUSH ESI                            ; 004841a0
    MOV [0x02c6d0a8],EAX                ; 004841a1 | DAT_02c6d0a8
    ...
    PUSH ESI                            ; 004841df
    MOV [0x02c6d0b4],EAX                ; 004841e0 | DAT_02c6d0b4
    ...
    PUSH EDI                            ; 00484202
    MOV [0x02c6d0bc],EAX                ; 00484203 | DAT_02c6d0bc
