...

{
  ...
  if (in_stack_00000004[1].base.base.previous_transform_state.position.z != 0.0) {
    fVar5 = in_stack_00000004[1].base.base.previous_transform_state.orientation.x -
            in_stack_00000008;
    in_stack_00000004[1].base.base.previous_transform_state.orientation.x = fVar5;
    if (0.0 <= fVar5) {
      iVar11 = 0;
      if (0 < *(int *)(in_stack_00000004[1].base.base.create_event + 0x3c)) {
        ...
        do {
          iVar10 = *(int *)(pCVar13[1].base.base.create_event + 0x40);
          *(uint *)(iVar10 + 0xfc) = 1;
          *(uint *)(iVar10 + 0xcb4) = 1;
          iVar11 = iVar11 + 1;
          dVar19 = round
                             ((double)(((float10)in_stack_00000004[1].base.base.
                                                 previous_transform_state.orientation.x * fVar18) /
                                      fVar17));
          *(int *)(iVar10 + 0xcc0) = (int)ROUND(dVar19);
      ...
      iVar11 = *(int *)(in_stack_00000004[1].base.base.create_event + 0x3c);
      ...
      if (0 < iVar11) {
        do {
          *(uint *)(*(int *)(pCVar13[1].base.base.create_event + 0x40) + 0x70) = 2;
          iVar10 = iVar10 + 1;
          pCVar13 = (CEnemy *)((pCVar13->base).base.actor_name + 4);
        } while (iVar10 < *(int *)(in_stack_00000004[1].base.base.create_event + 0x3c));
      }
    }
  }
  ...
  while (0.0 < local_38) {
    ...
    if (iVar11 == 0x29a) {
      (in_stack_00000004->base).cloth_data[0x35c] = '\0';
      (in_stack_00000004->base).cloth_data[0x35d] = '\0';
      (in_stack_00000004->base).cloth_data[0x35e] = '\0';
      (in_stack_00000004->base).cloth_data[0x35f] = '\0';
      local_178.x = 0.0;
      local_178.y = 20.0;
      local_178.z = 20.0;
      ...
      fVar5 = 5.0f;
      pCVar6 = (in_stack_00000004->base).base.vtable._ub;
  ...
  if (iVar11 == 9) {
    fVar8 = 6.0f * in_stack_00000008;
    fVar5 = in_stack_00000004->speed;
    *(float *)((in_stack_00000004->base).unk1 + 0x2c) =
         3.141593f * in_stack_00000008 * in_stack_00000004->speed;
    *(float *)((in_stack_00000004->base).unk1 + 0x28) = fVar5 * fVar8;
  }
  else {
    fVar8 = 1.570796f * in_stack_00000008;
    fVar5 = in_stack_00000004->speed;
    *(float *)((in_stack_00000004->base).unk1 + 0x28) =
         (in_stack_00000004->base).model.accumulated_root_motion.z;
    *(float *)((in_stack_00000004->base).unk1 + 0x2c) = fVar8 * fVar5;
  }
  iVar10 = core_charactr_cpp_CCharacter_FUN_0042ca70(&in_stack_00000004->base);
  if (iVar10 != 0) {
...
LAB_004848f9:
  ...
  case 0:
    ...
    if ((iVar11 != 0) &&
      ...
      if (iVar10 == *(int *)(g_CDemonSetPtr->unk4 + 0x1f3c)) {
        ...
        pcVar4 = in_stack_00000004[1].base.base.create_event + 0x2c;
  ...
  case 7:
    if (in_stack_00000004[1].base.base.previous_transform_state.position.z == 0.0) {
      ...
      core_actor_cpp_CDemonActor_localToWorldPoint_FUN_00408ec0
                ((CDemonActor *)in_stack_00000004,&local_f4,pCVar15);
  ...
  case 9:
    ...
    if (*(int *)(in_stack_00000004->unk2 + 4) != 0) {
      if (0.0 <= *(float *)(in_stack_00000004[1].base.base.create_event + 0x28)) {
        ...
        iVar11 = core_charactr_cpp_CCharacter_walkToPoint_FUN_004286e0(&in_stack_00000004->base);
        if (iVar11 < 0) {
          engine_console_cpp_CConsole_printf_FUN_00441890
...
LAB_004852f8:
    ...
    break;
  case 0xc:
    iVar11 = (*(((g_HeroActors[g_LocalHeroIndex]->base).base.vtable._uc)->_uc).isDamageable)
  ...
  case 0xe:
    ...
    if (*(int *)(in_stack_00000004->unk2 + 4) == 0) {
      ...
      else if ((0 < iVar11) && (*(float *)in_stack_00000004->unk2 <= 0.0)) {
  ...
  case 0x11:
    ...
    core_actor_cpp_CDemonActor_localToWorldPoint_FUN_00408ec0
              ((CDemonActor *)in_stack_00000004,&local_1cc,pCVar15);
  ...
  case 0x17:
    ...
    case 0:
      ...
      break;
    case 1:
      fVar5 = *(float *)(in_stack_00000004[1].base.base.create_event + 0x20) + in_stack_00000008;
      *(float *)(in_stack_00000004[1].base.base.create_event + 0x20) = fVar5;
      if (1.0f < fVar5) {
        pCVar9 = &in_stack_00000004[1].base;
      ...
      if (0 < pCVar14->bone_count) {
        ...
        do {
          ...
          core_actor_cpp_CDemonActor_localToWorldPoint_FUN_00408ec0
                    ((CDemonActor *)in_stack_00000004,&local_118,pCVar15);
          iVar11 = iVar11 + 1;
    ...
    case 2:
      ...
      for (local_18 = 0; fVar5 = 1.0f, local_18 < g_CDemonSetPtr->damage_listener_count;
        ...
        if (((pCVar13 != (CEnemy *)0x0) && (pCVar13 != in_stack_00000004)) &&
           (iVar11 = (*(((pCVar13->base).base.vtable._uc)->_uc).isDamageable)(&pCVar13->base),
           iVar11 < 1)) {
        ...
        *(float *)(in_stack_00000004[1].base.base.create_event + 0x20) = fVar5;
        ...
        if (iVar11 != 0) {
          ...
          if (pCVar2 != (COrientation *)pCVar15) {
            ...
            (in_stack_00000004->base).base.orient.bank = pCVar15->y;
            (in_stack_00000004->base).base.orient.heading = pCVar15->z;
          }
    ...
    case 3:
      ...
      if (0 < local_20->bone_count) {
        do {
          ...
          core_actor_cpp_CDemonActor_localToWorldPoint_FUN_00408ec0
                    ((CDemonActor *)in_stack_00000004,&local_130,pCVar15);
          core_fire_cpp_CFireEffect_createSmokeParticle_FUN_004c7b20
...
switchD_004858cd_caseD_1:
  ...
  if ((((local_28 != 0x11) && (local_28 != 0x10)) && (local_28 != 0xf)) ||
    ...
    *(float *)((in_stack_00000004->base).unk1 + 0x20) =
    ...
    local_160 = *(float *)((in_stack_00000004->base).unk1 + 0x1c) * in_stack_00000008;
    local_15c = *(float *)((in_stack_00000004->base).unk1 + 0x20) * in_stack_00000008;
    pcVar4 = (in_stack_00000004->base).unk1 + 0x10;
    local_158 = in_stack_00000008 * *(float *)((in_stack_00000004->base).unk1 + 0x24);
    pCVar15 = &(in_stack_00000004->base).model.accumulated_root_motion;
    local_1d8 = local_160 + *(float *)pcVar4;
    local_1d4 = local_15c + *(float *)((in_stack_00000004->base).unk1 + 0x14);
    local_1d0 = local_158 + *(float *)((in_stack_00000004->base).unk1 + 0x18);
    ...
    *(float *)pcVar4 = *(float *)((in_stack_00000004->base).unk1 + 0x14);
    (in_stack_00000004->base).model.accumulated_root_motion.z = 0.0;
    fVar5 = (in_stack_00000004->base).model.accumulated_root_motion.z;
    (in_stack_00000004->base).model.accumulated_root_motion.y = fVar5;
    pCVar15->x = fVar5;
