...
// Convention: __cdecl
// Signature: void __cdecl core_dracbrid_cpp_FUN_00484410(void)
...
void __cdecl core_dracbrid_cpp_FUN_00484410(void)

{
  ...
  if (in_stack_00000004[1].base.base.previous_transform_state.position.z != 0.0) {
    fVar6 = in_stack_00000004[1].base.base.previous_transform_state.orientation.x -
            in_stack_00000008;
    in_stack_00000004[1].base.base.previous_transform_state.orientation.x = fVar6;
    if (0.0 <= fVar6) {
      iVar12 = 0;
      if (0 < *(int *)(in_stack_00000004[1].base.base.create_event + 0x3c)) {
        ...
        do {
          iVar11 = *(int *)(pCVar14[1].base.base.create_event + 0x40);
          *(uint *)(iVar11 + 0xfc) = 1;
          *(uint *)(iVar11 + 0xcb4) = 1;
          iVar12 = iVar12 + 1;
          dVar20 = round
                             ((double)(((float10)in_stack_00000004[1].base.base.
                                                 previous_transform_state.orientation.x * fVar19) /
                                      fVar18));
          *(int *)(iVar11 + 0xcc0) = (int)ROUND(dVar20);
          pCVar14 = (CEnemy *)((pCVar14->base).base.actor_name + 4);
        } while (iVar12 < *(int *)(in_stack_00000004[1].base.base.create_event + 0x3c));
      }
    }
    else {
      in_stack_00000004[1].base.base.previous_transform_state.position.z = 0.0;
      (in_stack_00000004->base).base.was_created = 2;
      iVar12 = *(int *)(in_stack_00000004[1].base.base.create_event + 0x3c);
      in_stack_00000004[1].base.base.previous_transform_state.orientation.x = 0.0;
      iVar11 = 0;
      pCVar14 = in_stack_00000004;
      if (0 < iVar12) {
        do {
          *(uint *)(*(int *)(pCVar14[1].base.base.create_event + 0x40) + 0x70) = 2;
          iVar11 = iVar11 + 1;
          pCVar14 = (CEnemy *)((pCVar14->base).base.actor_name + 4);
        } while (iVar11 < *(int *)(in_stack_00000004[1].base.base.create_event + 0x3c));
      }
    }
  }
  core_dracbrid_cpp_FUN_004869a0();
  ...
  if (0.0 <= *(float *)(in_stack_00000004[1].base.base.create_event + 0x28)) {
    *(float *)(in_stack_00000004[1].base.base.create_event + 0x28) =
         *(float *)(in_stack_00000004[1].base.base.create_event + 0x28) - in_stack_00000008;
  }
  ...
  while (0.0 < local_38) {
    iVar12 = core_motion_cpp_CMotionController_advance_FUN_0052d610(&pCVar3->motion_controller);
    if (iVar12 == 0x29a) {
      (in_stack_00000004->base).field60_0x2df4 = 0;
      local_178.x = 0.0;
      local_178.y = 20.0;
      local_178.z = 20.0;
      ...
      in_stack_00000004[1].base.base.previous_transform_state.position.z = 1.4013e-45;
      in_stack_00000004[1].base.base.previous_transform_state.orientation.x = fVar6;
      (*pCVar7->playAmbientSound)((CDemonActor *)in_stack_00000004,"brideexplosion.wav");
    }
    else {
  ...
  if (iVar12 == 9) {
    fVar9 = 6.0f * in_stack_00000008;
    fVar6 = in_stack_00000004->speed;
    (in_stack_00000004->base).turn_speed =
         3.141593f * in_stack_00000008 * in_stack_00000004->speed;
    (in_stack_00000004->base).walk_step_speed = fVar6 * fVar9;
  }
  else {
    fVar9 = 1.570796f * in_stack_00000008;
    fVar6 = in_stack_00000004->speed;
    (in_stack_00000004->base).walk_step_speed =
         (in_stack_00000004->base).model.accumulated_root_motion.z;
    (in_stack_00000004->base).turn_speed = fVar9 * fVar6;
  }
  iVar11 = core_charactr_cpp_CCharacter_FUN_0042ca70(&in_stack_00000004->base);
  if (iVar11 != 0) {
    uVar8 = (in_stack_00000004->base).field22_0x25b0;
    if (uVar8 < 2) {
      if (uVar8 == 1) {
LAB_004846a6:
        iVar12 = 0xe;
...
LAB_004848f9:
      ...
      core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                (&(in_stack_00000004->base).model.motion_controller,iVar12,1);
    }
    else {
      if (uVar8 < 3) goto LAB_004846a6;
      if (uVar8 != 3) goto LAB_004848f9;
      core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
  ...
  case 0:
    ...
    if (*(int *)(in_stack_00000004->unk2 + 4) == 0) {
      ...
      if (extraout_EAX_01 != 0) {
        core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                  (&(in_stack_00000004->base).model.motion_controller,0xe,1);
      }
      break;
    }
    ...
    if ((iVar12 != 0) &&
       (iVar12 = core_actor_cpp_isOfClass_FUN_0040c6d0
                           (*(CDemonActor **)(in_stack_00000004->unk2 + 4),"CHero"),
       iVar12 != 0)) {
      iVar11 = 0;
      iVar12 = 0;
      ...
      if (iVar11 == *(int *)(g_CDemonSetPtr->unk4 + 0x1f3c)) {
        sprintf
                   ...
                   *(uint *)(in_stack_00000004[1].base.base.create_event + 0x18));
        core_dracbrid_cpp_FUN_004864c0();
        core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                  (&(in_stack_00000004->base).model.motion_controller,0x17,1);
        ...
        pcVar5 = in_stack_00000004[1].base.base.create_event + 0x2c;
        pCVar10 = &in_stack_00000004[1].base;
        (pCVar10->base).create_event[0x1c] = '\x01';
        (pCVar10->base).create_event[0x1d] = '\0';
        (pCVar10->base).create_event[0x1e] = '\0';
        (pCVar10->base).create_event[0x1f] = '\0';
        if (pcVar5 != (char *)(iVar12 + 0x20)) {
          *(uint *)pcVar5 = *(uint *)(iVar12 + 0x20);
          *(uint *)(in_stack_00000004[1].base.base.create_event + 0x30) =
               *(uint *)(iVar12 + 0x24);
          *(uint *)(in_stack_00000004[1].base.base.create_event + 0x34) =
               *(uint *)(iVar12 + 0x28);
        }
        pCVar10 = &in_stack_00000004[1].base;
        (pCVar10->base).create_event[0x20] = '\0';
        (pCVar10->base).create_event[0x21] = '\0';
        (pCVar10->base).create_event[0x22] = '\0';
        (pCVar10->base).create_event[0x23] = '\0';
        break;
      }
    }
    if (*(float *)(in_stack_00000004[1].base.base.create_event + 0x28) < 0.0) {
      local_14 = core_actor_cpp_getRandomFloat_FUN_0040cc10(2.0,20.0);
      *(float *)(in_stack_00000004[1].base.base.create_event + 0x28) = local_14;
      core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                (&(in_stack_00000004->base).model.motion_controller,0xd,1);
      break;
    }
    goto LAB_004852f8;
  case 2:
    ...
    pCVar10 = &in_stack_00000004[1].base;
    (pCVar10->base).create_event[0x38] = '\x01';
    (pCVar10->base).create_event[0x39] = '\0';
    (pCVar10->base).create_event[0x3a] = '\0';
    (pCVar10->base).create_event[0x3b] = '\0';
    break;
  case 3:
  ...
  case 7:
    if (in_stack_00000004[1].base.base.previous_transform_state.position.z == 0.0) {
      pCVar16 = core_skeleton_cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00
                          (&(in_stack_00000004->base).model,&local_d0,INT_02c6d0bc);
      core_actor_cpp_CDemonActor_localToWorldPoint_FUN_00408ec0
                ((CDemonActor *)in_stack_00000004,&local_f4,pCVar16);
      core_fire_cpp_CFireEffect_FUN_004c8ef0(g_CFireEffectPtr);
      local_9c = (in_stack_00000004->base).base.orient.bank;
      local_98 = (in_stack_00000004->base).base.orient.heading;
      local_a0 = (in_stack_00000004->base).base.orient.pitch + -1.570796f;
      core_fire_cpp_CFireEffect_FUN_004c8ef0(g_CFireEffectPtr);
    }
    break;
  case 8:
    ...
    if (*(int *)(in_stack_00000004->unk2 + 4) == 0) {
      ...
      pCVar3 = &(in_stack_00000004->base).model;
      if (*(int *)(in_stack_00000004[1].base.base.create_event + 0x38) == 0) {
        core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
        ...
        pCVar10 = &in_stack_00000004[1].base;
        (pCVar10->base).create_event[0x38] = '\0';
        (pCVar10->base).create_event[0x39] = '\0';
        (pCVar10->base).create_event[0x3a] = '\0';
        (pCVar10->base).create_event[0x3b] = '\0';
      }
  ...
  case 9:
    if (*(float *)(in_stack_00000004[1].base.base.create_event + 0x24) <= 0.0) {
      sprintf
                 ...
                 *(uint *)(in_stack_00000004[1].base.base.create_event + 0x18));
      core_dracbrid_cpp_FUN_004864c0();
      iVar12 = core_actor_cpp_randomChance_FUN_0040cd10(0.2);
      if (iVar12 != 0) {
        core_dracbrid_cpp_FUN_004864c0();
      }
    }
    ...
    if (*(int *)(in_stack_00000004->unk2 + 4) != 0) {
      if (0.0 <= *(float *)(in_stack_00000004[1].base.base.create_event + 0x28)) {
        ...
        iVar12 = core_charactr_cpp_CCharacter_walkToPoint_FUN_004286e0(&in_stack_00000004->base);
        if (iVar12 < 0) {
          engine_console_cpp_CConsole_printf_FUN_00441890
          ...
          if ((float)10 <
            ...
            if (ABS(local_14) < (float)0.39269908168750001) {
              ...
              (in_stack_00000004->base).base.orient.bank =
                   local_14 + (in_stack_00000004->base).base.orient.bank;
              core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
...
LAB_004852f8:
  ...
  case 0xc:
    ...
    if ((iVar12 == 0) &&
       (iVar12 = core_event_cpp_CEventList_evaluateCondition_FUN_004adca0
                           (g_CEventListPtr,(char *)&in_stack_00000004[1].base.base.location.area_id
                           ), iVar12 != 0)) {
      core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                (&(in_stack_00000004->base).model.motion_controller,0xd,1);
    }
  ...
  case 0xe:
    ...
    if (*(int *)(in_stack_00000004->unk2 + 4) == 0) {
      ...
      if (iVar12 < 0) {
      ...
      else if ((0 < iVar12) && (*(float *)in_stack_00000004->unk2 <= 0.0)) {
        ...
        if (iVar12 == 1) {
          core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                    (&(in_stack_00000004->base).model.motion_controller,0x14,1);
        }
        if (iVar12 == 2) {
          core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                    (&(in_stack_00000004->base).model.motion_controller,0x15,1);
          (*((in_stack_00000004->base).base.vtable._ub)->playSound)
  ...
  case 0xf:
    ...
    if (iVar12 != 0) {
      core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                (&(in_stack_00000004->base).model.motion_controller,0xb,1);
    }
    break;
  case 0x10:
  ...
  case 0x17:
    ...
    switch(*(uint *)(in_stack_00000004[1].base.base.create_event + 0x1c)) {
    case 0:
      core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                (&(in_stack_00000004->base).model.motion_controller,0,1);
      break;
    case 1:
      fVar6 = *(float *)(in_stack_00000004[1].base.base.create_event + 0x20) + in_stack_00000008;
      *(float *)(in_stack_00000004[1].base.base.create_event + 0x20) = fVar6;
      if (1.0f < fVar6) {
        pCVar10 = &in_stack_00000004[1].base;
        (pCVar10->base).create_event[0x1c] = '\x02';
        (pCVar10->base).create_event[0x1d] = '\0';
        (pCVar10->base).create_event[0x1e] = '\0';
        (pCVar10->base).create_event[0x1f] = '\0';
        *(float *)(in_stack_00000004[1].base.base.create_event + 0x20) = 1.0f;
      }
      local_2c = &(in_stack_00000004->base).model;
      iVar12 = 0;
      local_148.x = 0.0;
      local_148.y = 3.0;
      local_148.z = 0.0;
    ...
    case 2:
      ...
      local_1c = 0;
      pcVar5 = in_stack_00000004[1].base.base.create_event + 0x2c;
      for (local_18 = 0; fVar6 = 1.0f, local_18 < g_CDemonSetPtr->damage_listener_count;
          local_18 = local_18 + 1) {
        pCVar14 = *(CEnemy **)(g_CDemonSetPtr->unk4 + local_1c + -4);
        if (((pCVar14 != (CEnemy *)0x0) && (pCVar14 != in_stack_00000004)) &&
           (iVar12 = (*(((pCVar14->base).base.vtable._uc)->_uc).isDamageable)(&pCVar14->base),
           iVar12 < 1)) {
          local_19c = (pCVar14->base).base.location.position.x - *(float *)pcVar5;
          local_198 = (pCVar14->base).base.location.position.y -
                      *(float *)(in_stack_00000004[1].base.base.create_event + 0x30);
          local_194 = (pCVar14->base).base.location.position.z -
                      *(float *)(in_stack_00000004[1].base.base.create_event + 0x34);
      ...
      if (local_30 != 0) {
        pCVar10 = &in_stack_00000004[1].base;
        (pCVar10->base).create_event[0x1c] = '\x03';
        (pCVar10->base).create_event[0x1d] = '\0';
        (pCVar10->base).create_event[0x1e] = '\0';
        (pCVar10->base).create_event[0x1f] = '\0';
        pCVar1 = &(in_stack_00000004->base).base.location;
        *(float *)(in_stack_00000004[1].base.base.create_event + 0x20) = fVar6;
        (pCVar1->position).x = *(float *)pcVar5;
        (in_stack_00000004->base).base.location.position.y =
             *(float *)(in_stack_00000004[1].base.base.create_event + 0x30);
        (in_stack_00000004->base).base.location.position.z =
             *(float *)(in_stack_00000004[1].base.base.create_event + 0x34);
        iVar12 = *(int *)(in_stack_00000004->unk2 + 4);
        if (iVar12 != 0) {
          local_dc.x = *(float *)(iVar12 + 0x20) - (pCVar1->position).x;
          local_dc.y = *(float *)(iVar12 + 0x24) -
                       (in_stack_00000004->base).base.location.position.y;
          local_dc.z = *(float *)(iVar12 + 0x28) -
                       (in_stack_00000004->base).base.location.position.z;
          pCVar2 = &(in_stack_00000004->base).base.orient;
          ...
          if (pCVar2 != (COrientation *)pCVar16) {
            ...
            (in_stack_00000004->base).base.orient.bank = pCVar16->y;
            (in_stack_00000004->base).base.orient.heading = pCVar16->z;
          }
          (in_stack_00000004->base).base.orient.heading = 0.0;
          (in_stack_00000004->base).base.orient.pitch = 0.0;
        }
        (*((in_stack_00000004->base).base.vtable._ub)->playSound)
                  ((CDemonActor *)in_stack_00000004,"hotbride-disappear.wav");
      }
    ...
    case 3:
      ...
      *(float *)(in_stack_00000004[1].base.base.create_event + 0x20) = fVar6;
      if (fVar6 < 0.0) {
        ...
        (pCVar10->base).create_event[0x23] = '\0';
        pCVar10 = &in_stack_00000004[1].base;
        (pCVar10->base).create_event[0x1c] = '\0';
        (pCVar10->base).create_event[0x1d] = '\0';
        (pCVar10->base).create_event[0x1e] = '\0';
        (pCVar10->base).create_event[0x1f] = '\0';
        core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
...
switchD_004858cd_caseD_1:
  ...
  if ((((local_28 != 0x11) && (local_28 != 0x10)) && (local_28 != 0xf)) ||
    ...
    local_160 = (in_stack_00000004->base).field7_0x2428.x * in_stack_00000008;
    local_15c = (in_stack_00000004->base).field7_0x2428.y * in_stack_00000008;
    pCVar16 = &(in_stack_00000004->base).field6_0x241c;
    local_158 = in_stack_00000008 * (in_stack_00000004->base).field7_0x2428.z;
    pCVar4 = &(in_stack_00000004->base).model.accumulated_root_motion;
    local_1d8 = local_160 + pCVar16->x;
    local_1d4 = local_15c + (in_stack_00000004->base).field6_0x241c.y;
    local_1d0 = local_158 + (in_stack_00000004->base).field6_0x241c.z;
    local_e8 = local_1d8 + pCVar4->x;
    local_e4 = local_1d4 + (in_stack_00000004->base).model.accumulated_root_motion.y;
    local_e0 = local_1d0 + (in_stack_00000004->base).model.accumulated_root_motion.z;
    ...
    (in_stack_00000004->base).model.accumulated_root_motion.z = 0.0;
    fVar6 = (in_stack_00000004->base).model.accumulated_root_motion.z;
    (in_stack_00000004->base).model.accumulated_root_motion.y = fVar6;
    pCVar4->x = fVar6;
