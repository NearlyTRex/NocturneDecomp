...
section .text
    ...
    JZ 0x00485bd0                       ; 00485bcb | LAB_00485bd0
    ...
    PUSH ECX                            ; 00485bd4
    PUSH EAX                            ; 00485bd5
    CALL core_charactr.cpp_CCharacter_FUN_0042bc20 ; 00485bd6 | int core_charactr.cpp_CCharacter_FUN_0042bc20(CCharacter * this_ptr)
