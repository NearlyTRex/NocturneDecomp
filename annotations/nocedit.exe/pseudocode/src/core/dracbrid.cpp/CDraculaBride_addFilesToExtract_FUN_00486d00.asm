...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_dracbrid_cpp_CDraculaBride_addFilesToExtract_FUN_00486d00(CDraculaBride *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00486d00
        ;   Label: core_dracbrid.cpp_CDraculaBride_addFilesToExtract_FUN_00486d00
    MOV EDX,dword ptr [ESP + 0xc]       ; 00486d01
    PUSH EDX                            ; 00486d05
    MOV ECX,dword ptr [ESP + 0xc]       ; 00486d06
    PUSH ECX                            ; 00486d0a
    CALL core_actor.cpp_CDemonActor_addFilesToExtract_FUN_0040cfd0 ; 00486d0b
    ...
    PUSH EAX                            ; 00486d21
    CALL core_skeledit.cpp_CDeformableModelInstance_addFilesToExtract_FUN_0058a260 ; 00486d22
