...
;                               FUNCTION
; *****************************************************************************
; __cdecl CVector3f * __cdecl core_dracbrid_cpp_CVector3f_arrdtor_FUN_00486e30(CVector3f *objs,uint flags)
;
; Parameters:
...
section .text
    ...
    PUSH 0x6598c0                       ; 00486e30 | g_CVectorTypeInfo
        ;   Label: core_dracbrid.cpp_CVector3f_arrdtor_FUN_00486e30
    PUSH 0x4                            ; 00486e35
