...
section .text
    ...
    PUSH ESI                            ; 00484176
    MOV [0x02c6d0a0],EAX                ; 00484177 | g_DraculaBrideIndices
    ...
    PUSH ESI                            ; 0048418b
    MOV [0x02c6d0a4],EAX                ; 0048418c | g_DraculaBrideIndices[1]
    ...
    PUSH ESI                            ; 004841a0
    MOV [0x02c6d0a8],EAX                ; 004841a1 | g_DraculaBrideIndices[2]
    ...
    PUSH ESI                            ; 004841b5
    MOV [0x02c6d0ac],EAX                ; 004841b6 | g_DraculaBrideIndices[3]
    ...
    PUSH ESI                            ; 004841ca
    MOV [0x02c6d0b0],EAX                ; 004841cb | g_DraculaBrideIndices[4]
    ...
    PUSH ESI                            ; 004841df
    MOV [0x02c6d0b4],EAX                ; 004841e0 | g_DraculaBrideIndices[5]
    ...
    PUSH ESI                            ; 004841f4
    MOV [0x02c6d0b8],EAX                ; 004841f5 | g_DraculaBrideIndices[6]
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0 ; 004841fa
        ;   XREF to: 00599fc0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_00599fc0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ADD ESP,0xc                         ; 004841ff
    PUSH EDI                            ; 00484202
    MOV [0x02c6d0bc],EAX                ; 00484203 | g_DraculaBrideIndices[7]
