...
section .text
    ...
    PUSH EAX                            ; 00483f99
        ;   Label: LAB_00483f99
    CALL core_dracbrid.cpp_ctor_FUN_00483fc0 ; 00483f9a
        ;   XREF to: 00483fc0 (UNCONDITIONAL_CALL)  ; CDraculaBride * core_dracbrid.cpp_ctor_FUN_00483fc0(CDraculaBride * this_ptr)
