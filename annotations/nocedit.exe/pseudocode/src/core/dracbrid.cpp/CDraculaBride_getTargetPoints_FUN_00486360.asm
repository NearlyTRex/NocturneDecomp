...
;   undefined4 g_DraculaBrideIndices[5]
...
section .text
    ...
    PUSH EBX                            ; 00486360
        ;   Label: core_dracbrid.cpp_CDraculaBride_getTargetPoints_FUN_00486360
    PUSH ESI                            ; 00486361
    PUSH EBP                            ; 00486362
    ...
    JZ 0x00486380                       ; 00486375
        ;   XREF to: 00486380 (CONDITIONAL_JUMP)  ; LAB_00486380
    ...
    PUSH EDI                            ; 00486380
        ;   Label: LAB_00486380
    MOV ECX,dword ptr [0x02c6d0a0]      ; 00486381 | g_DraculaBrideIndices
    PUSH ECX                            ; 00486387
    ...
    JZ 0x004863b5                       ; 004863a3
        ;   XREF to: 004863b5 (CONDITIONAL_JUMP)  ; LAB_004863b5
    ...
    MOV EBP,dword ptr [0x02c6d0b4]      ; 004863b5 | g_DraculaBrideIndices[5]
        ;   Label: LAB_004863b5
    PUSH EBP                            ; 004863bb
    ...
    JZ 0x004863e7                       ; 004863d5
        ;   XREF to: 004863e7 (CONDITIONAL_JUMP)  ; LAB_004863e7
    ...
    MOV EAX,[0x02c6d0bc]                ; 004863e7 | g_DraculaBrideIndices[7]
        ;   Label: LAB_004863e7
    PUSH EAX                            ; 004863ec
    ...
    JZ 0x00486418                       ; 00486406
        ;   XREF to: 00486418 (CONDITIONAL_JUMP)  ; LAB_00486418
