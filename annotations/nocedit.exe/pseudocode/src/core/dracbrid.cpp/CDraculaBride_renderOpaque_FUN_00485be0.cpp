    ...
    if ((((iVar2 == 0) || (this_ptr->mistState == 0)) && (iVar1 == 0)) &&
      ...
      if (iVar1 != 0) {
        ...
        if (iVar2 == 0) {
          ...
          if (iVar2 == 1) {
            fVar4 = (1.0 - this_ptr->vanishTimer) / DAT_0065cd88;
          }
          else {
            fVar4 = ((float)DOUBLE_00621b16 - this_ptr->vanishTimer) / DAT_0065cd88;
            if (fVar4 < 0.0) {
              fVar4 = 0.0;
            }
          }
...
// 00485cb1: PUSH EAX
// 00485cb2: CALL core_motion.cpp_CMotionController_render_FUN_0052e700
