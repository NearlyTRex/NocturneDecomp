...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_dracbrid_cpp_CDraculaBride_FUN_00485b20(CDraculaBride *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00485b20
        ;   Label: core_dracbrid.cpp_CDraculaBride_FUN_00485b20
    PUSH EBP                            ; 00485b21
    ...
    CALL core_charactr.cpp_CCharacter_dismemberPartInternal_FUN_0042bd30 ; 00485b73
