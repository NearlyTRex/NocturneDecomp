// Name: core_dracbrid.cpp_CDraculaBride_explodeIntoParts_FUN_004858f0
// Address: 004858f0
// Address Range: [[004858f0, 00485a41] [00485aed, 00485b11]]
// Convention: __cdecl
// Signature: void __cdecl core_dracbrid_cpp_CDraculaBride_explodeIntoParts_FUN_004858f0(CDraculaBride *this_ptr,CVector3f *direction,float spread_angle,int render_in_background)
...

{
      ...
      if (0 < local_24) {
        do {
          ...
          core_dracbrid_cpp_CDraculaBride_dismemberPart_FUN_00485b20
                    (this_ptr,part_index,(int)flags,render_in_background);
  ...
  if ((this_ptr->base).base.is_fully_burned == 0) {
    core_gore_cpp_CGore_spawnBloodBurst_FUN_004edbb0
              (g_CGorePtr,&CStack_60,direction,100,(this_ptr->base).base.collision_layer);
    return;
  }
