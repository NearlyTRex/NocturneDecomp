  ...
  if (this_ptr->exploded != 0) {
    ...
    if (0.0 <= fVar18) {
      ...
      if (0 < this_ptr->part_count) {
        fVar15 = (float10)5.0f;
        fVar16 = (float10)65535;
        pCVar10 = this_ptr;
        do {
          iVar9 = *(int *)pCVar10->unk4;
          *(uint *)(iVar9 + 0xfc) = 1;
          *(uint *)(iVar9 + 0xcb4) = 1;
          iVar6 = iVar6 + 1;
          in_stack_fffffb6c = (char *)0x4845ee;
          dVar17 = round
        ...
        } while (iVar6 < this_ptr->part_count);
      }
    }
    else {
      this_ptr->exploded = 0;
...
LAB_004848f9:
  ...
  case 0:
    ...
    if ((iVar6 != 0) &&
       (iVar6 = core_actor_cpp_isOfClass_FUN_0040c6d0((this_ptr->base).victim,"CHero"),
       iVar6 != 0)) {
      iVar9 = 0;
      iVar6 = 0;
  ...
  case 9:
    if (*(float *)this_ptr->unk2 <= 0.0) {
      ...
      core_dracbrid_cpp_CDraculaBride_FUN_004864c0(this_ptr);
      iVar6 = core_actor_cpp_randomChance_FUN_0040cd10(0.2);
      if (iVar6 != 0) {
        core_dracbrid_cpp_CDraculaBride_FUN_004864c0(this_ptr);
      }
    }
      ...
      if (0.0 <= *(float *)(this_ptr->unk2 + 4)) {
        ...
        iVar6 = core_charactr_cpp_CCharacter_walkToPoint_FUN_004286e0
                          ((CCharacter *)this_ptr,&(((this_ptr->base).victim)->location).position,
                           pCVar14,pCVar12,fVar18,(float)in_stack_fffffb6c);
        if (iVar6 < 0) {
          engine_console_cpp_CConsole_printf_FUN_00441890
                    (g_CConsolePtr,"%s gave up chase - I'm confused\n");
          in_stack_fffffb6c = (char *)0x1;
          core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                    (&pCVar3->motion_controller,8,1);
        }
        else if (iVar6 < 1) {
          pCVar13 = (this_ptr->base).victim;
          local_124.x = (pCVar13->location).position.x -
                        (this_ptr->base).base.base.location.position.x;
          local_124.y = (pCVar13->location).position.y -
                        (this_ptr->base).base.base.location.position.y;
          local_124.z = (pCVar13->location).position.z -
          ...
          if ((float)10 <
            ...
            in_stack_fffffb6c = (char *)(local_70.y - (this_ptr->base).base.base.orient.vec.y);
            local_14 = core_actor_cpp_normalizeAngleToPi_FUN_0040cd70((float)in_stack_fffffb6c);
          ...
          in_stack_fffffb6c = "hotbride-bite?.wav";
          (*((this_ptr->base).base.base.vtable._ub)->playSound)
...
LAB_004852f8:
  ...
  case 0xc:
    ...
    if (iVar6 == 0) {
      in_stack_fffffb6c = this_ptr->rise_event;
      iVar6 = core_event_cpp_CEventList_evaluateCondition_FUN_004adca0
                        (g_CEventListPtr,in_stack_fffffb6c);
      if (iVar6 != 0) {
        in_stack_fffffb6c = (char *)0x1;
        core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
                  (&(this_ptr->base).base.model.motion_controller,0xd,1);
  ...
  case 0xe:
    ...
    if ((this_ptr->base).victim == (CDemonActor *)0x0) {
      ...
      iVar6 = core_charactr_cpp_CCharacter_walkToPoint_FUN_004286e0
                        ((CCharacter *)this_ptr,&(((this_ptr->base).victim)->location).position,
                         pCVar14,pCVar12,min_distance,fVar19);
      if (iVar6 < 0) {
        engine_console_cpp_CConsole_printf_FUN_00441890
                  (g_CConsolePtr,"%s gave up chase - I'm confused\n",this_ptr);
        core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
  ...
  case 0x17:
    ...
    case 1:
      ...
      if (0 < pCVar11->bone_count) {
        ...
        } while (iVar6 < pCVar11->bone_count);
      }
      break;
    case 2:
      local_30 = 1;
      ...
      if (local_30 != 0) {
        ...
        if (pCVar13 != (CDemonActor *)0x0) {
          local_dc.x = (pCVar13->location).position.x - (pCVar1->position).x;
          local_dc.y = (pCVar13->location).position.y -
                       (this_ptr->base).base.base.location.position.y;
...
switchD_004858cd_caseD_1:
  ...
  if ((((local_28 != 0x11) && (local_28 != 0x10)) && (local_28 != 0xf)) ||
    ...
    if ((this_ptr_00 != (CCharacter *)0x0) &&
       ...
       pCVar10 == this_ptr)) {
      in_stack_fffffb6c = ((this_ptr->base).victim)->actor_name;
