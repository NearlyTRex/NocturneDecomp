...

{
  ...
  if (in_stack_00000004[0x1a].create_event[0x50] != '\0') {
    ...
    if (1 < local_20) {
      if ((float)in_stack_0000000c < 0.0) {
        in_stack_0000000c = (CDemonActor *)0x41a00000;
      }
      fVar4 = 0.0;
      if (0 < local_20) {
        do {
          if ((in_stack_00000008 != (CVector3f *)0x0) && (0.0 < (float)in_stack_0000000c)) {
            ...
            auStack_a0._0_4_ = in_stack_00000010;
          }
  ...
  core_actor_cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(in_stack_00000004,&CStack_5c,aCStack_50)
  ;
