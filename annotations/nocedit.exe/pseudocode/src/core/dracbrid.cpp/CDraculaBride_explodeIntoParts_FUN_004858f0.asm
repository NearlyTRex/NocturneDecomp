...
section .text
    ...
    PUSH EBX                            ; 004858f0
        ;   Label: core_dracbrid.cpp_CDraculaBride_explodeIntoParts_FUN_004858f0
    PUSH ESI                            ; 004858f1
    PUSH EDI                            ; 004858f2
    PUSH EBP                            ; 004858f3
    ...
    CALL core_dracbrid.cpp_CDraculaBride_dismemberPart_FUN_00485b20 ; 00485966
        ;   XREF to: 00485b20 (UNCONDITIONAL_CALL)  ; void core_dracbrid.cpp_CDraculaBride_dismemberPart_FUN_00485b20(CDraculaBride * this_ptr, int part_index, int flags, int render_in_background)
