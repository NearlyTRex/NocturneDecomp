...
section .text
    ...
    PUSH ESI                            ; 0051f131
    PUSH EDI                            ; 0051f132
    CALL engine_matrix.c_matrixPush_FUN_0050d620 ; 0051f133 | void engine_matrix.c_matrixPush_FUN_0050d620()
        ;   XREF to: 0050d620 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [0x02d052b8]      ; 0051f138 | int g_RelativeX
    MOV ECX,dword ptr [0x02d052dc]      ; 0051f13e | int g_LightDirectionX
    MOV EBX,dword ptr [0x02d052e8]      ; 0051f144 | CMatrix3x3i g_TransformMatrix
    ...
    NEG ESI                             ; 0051f15c
    NEG EDI                             ; 0051f15e
    MOV dword ptr [0x02d052b8],EDX      ; 0051f160 | int g_RelativeX
    MOV dword ptr [0x02d052dc],ECX      ; 0051f166 | int g_LightDirectionX
    MOV dword ptr [0x02d052e8],EBX      ; 0051f16c | CMatrix3x3i g_TransformMatrix
