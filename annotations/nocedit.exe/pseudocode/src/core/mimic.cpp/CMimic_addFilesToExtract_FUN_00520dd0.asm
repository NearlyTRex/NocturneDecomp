...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_mimic_cpp_CMimic_addFilesToExtract_FUN_00520dd0(CMimic *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00520dd0
        ;   Label: core_mimic.cpp_CMimic_addFilesToExtract_FUN_00520dd0
    MOV EDX,dword ptr [ESP + 0xc]       ; 00520dd1
    PUSH EDX                            ; 00520dd5
    MOV ECX,dword ptr [ESP + 0xc]       ; 00520dd6
    PUSH ECX                            ; 00520dda
    CALL core_actor.cpp_CDemonActor_addFilesToExtract_FUN_0040cfd0 ; 00520ddb
    ...
    PUSH EAX                            ; 00520df1
    CALL core_skeledit.cpp_CDeformableModelInstance_addFilesToExtract_FUN_0058a260 ; 00520df2
