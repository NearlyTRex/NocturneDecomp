...
; Local Variables:
; SDamageInfo      Stack[-0x1e4]:60  local_1e4
; CMatrix3x4f      Stack[-0x1a8]:48  local_1a8
; CMatrix3x4f      Stack[-0x178]:48  local_178
; CBoundingBox3D   Stack[-0x148]:24  local_148
...
section .text
    ...
    PUSH EBX                            ; 0051fcc0
        ;   Label: core_mimic.cpp_CMimic_processAnimation_FUN_0051fcc0
    PUSH ESI                            ; 0051fcc1
    PUSH EDI                            ; 0051fcc2
    PUSH EBP                            ; 0051fcc3
    ...
    PUSH EBX                            ; 00520398
        ;   Label: LAB_00520398
    CALL core_charactr.cpp_CCharacter_preProcess_FUN_00429820 ; 00520399
    ...
    PUSH EAX                            ; 00520478
    PUSH EBX                            ; 00520479
    CALL core_charactr.cpp_CCharacter_moveAndCollide_FUN_00428f40 ; 0052047a
