...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_mimic.cpp_FUN_00520a00()
;
;
; Referenced Globals:
...
section .text
    ...
    JZ 0x00520a46                       ; 00520a20 | LAB_00520a46
        ;   XREF to: 00520a46 (CONDITIONAL_JUMP)
    MOV dword ptr [EAX + 0x14],0x40000000 ; 00520a22
    LEA EAX,[EDX + 0x158]               ; 00520a29
        ;   Label: LAB_00520a29
    PUSH EAX                            ; 00520a2f
    CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0 ; 00520a30 | SMotion * core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0(CMotionController * this_ptr)
        ;   XREF to: 0052dab0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EAX + 0x24]      ; 00520a35
    ADD ESP,0x4                         ; 00520a38
    CMP EAX,0xc                         ; 00520a3b
    JNZ 0x00520a71                      ; 00520a3e | LAB_00520a71
    ...
    FLD ST1                             ; 00520a53
    FXCH                                ; 00520a55
    FADD float ptr [0x0063883b]         ; 00520a57 | float FLOAT_0063883b
    FXCH                                ; 00520a5d
    FMUL double ptr [0x00638833]        ; 00520a5f | double DOUBLE_00638833
    FXCH                                ; 00520a65
    FSTP float ptr [EAX + 0x18]         ; 00520a67
    FSTP ST1                            ; 00520a6a
    FSTP float ptr [EAX + 0x1c]         ; 00520a6c
    JMP 0x00520a29                      ; 00520a6f | LAB_00520a29
