// Name: core_mimic.cpp_CMimic_serialize_FUN_00520930
// Address: 00520930
// Address Range: [[00520930, 005209fe]]
// Convention: __cdecl
// Signature: void __cdecl core_mimic_cpp_CMimic_serialize_FUN_00520930(CMimic *this_ptr)
...

{
  ...
  core_actor_cpp_serializeString_FUN_0040b5c0
            ((char **)this_ptr->attack_condition,"attackCondition");
  core_actor_cpp_serializeInteger_FUN_0040b7f0(&this_ptr->attack_mode,"attackMode");
  ...
  if (g_CMimicClassVersion < 2) {
    ...
    core_actor_cpp_serializeString_FUN_0040b5c0
              (&this_ptr->morph_actor_type,"morphActorType");
    if (g_CMimicClassVersion < 3) {
      return;
    }
  }
  core_actor_cpp_serializeString_FUN_0040b5c0
            ((char **)this_ptr->mirror_condition,"mirrorCondition");
  return;
}
