...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_mimic.cpp_FUN_00520da0()
;
;
; Called Functions:
...
section .text
    ...
    JNZ 0x00520dba                      ; 00520dae | LAB_00520dba
        ;   XREF to: 00520dba (CONDITIONAL_JUMP)
    MOV dword ptr [EAX + 0x4bdf8],0x0   ; 00520db0
    PUSH EDX                            ; 00520dba
        ;   Label: LAB_00520dba
    PUSH EAX                            ; 00520dbb
    CALL core_charactr.cpp_CCharacter_FUN_0042f8a0 ; 00520dbc | void core_charactr.cpp_CCharacter_FUN_0042f8a0(CCharacter * this_ptr)
