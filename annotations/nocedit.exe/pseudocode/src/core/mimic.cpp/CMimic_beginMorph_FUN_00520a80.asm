...
section .text
    ...
    JZ 0x00520b6a                       ; 00520a8d
        ;   XREF to: 00520b6a (CONDITIONAL_JUMP)  ; LAB_00520b6a
    ...
    JZ 0x00520b19                       ; 00520b07
        ;   XREF to: 00520b19 (CONDITIONAL_JUMP)  ; LAB_00520b19
    ...
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 00520b2e
    ...
    PUSH ESI                            ; 00520b6a
        ;   Label: LAB_00520b6a
    MOV ECX,0x63883f                    ; 00520b6b | = "..\\core\\mimic.cpp"
    MOV ESI,0x499                       ; 00520b70
    PUSH 0x638851                       ; 00520b75 | = "CMimic::beginMorph() - can't do this ..."
    MOV dword ptr [0x02f0ca48],ECX      ; 00520b7a | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 00520b80 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00520b86
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ADD ESP,0x4                         ; 00520b8b
    POP ESI                             ; 00520b8e
    JMP 0x00520a93                      ; 00520b8f
        ;   XREF to: 00520a93 (UNCONDITIONAL_JUMP)  ; LAB_00520a93
