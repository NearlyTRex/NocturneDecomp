...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_mimic_cpp_CMimic_writeDependencies_FUN_00520dd0(CMimic *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00520dd0
        ;   Label: core_mimic.cpp_CMimic_writeDependencies_FUN_00520dd0
    ...
    PUSH EAX                            ; 00520df1
    CALL core_skeledit.cpp_CDeformableModelInstance_writeDependencies_FUN_0058a260 ; 00520df2
