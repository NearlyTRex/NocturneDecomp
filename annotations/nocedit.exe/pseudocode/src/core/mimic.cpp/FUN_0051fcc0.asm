...
;
; XREF[1]:
;   core_mimic.cpp_CMimic_setup2_FUN_0051f780 at 0051f802
;
; Referenced Globals:
...
section .text
    ...
    PUSH EAX                            ; 0051fcdd
    MOV EAX,[0x02db87d0]                ; 0051fcde | int g_LocalHeroIndex
    MOV EAX,dword ptr [EAX*0x4 + 0x2db87c0] ; 0051fce3 | CHero *[4] g_HeroActors
    ADD EAX,0x158                       ; 0051fcea
    PUSH EAX                            ; 0051fcef
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneWorldPosition_FUN_0059fa20 ; 0051fcf0 | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneWorldPosition_FUN_0059fa20(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
        ;   XREF to: 0059fa20 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0051fcf5
    PUSH EAX                            ; 0051fcf8
    LEA EAX,[EBP + -0xa]                ; 0051fcf9
    PUSH EAX                            ; 0051fcfc
    MOV EAX,[0x02db87d0]                ; 0051fcfd | int g_LocalHeroIndex
    MOV EDX,dword ptr [EAX*0x4 + 0x2db87c0] ; 0051fd02 | CHero *[4] g_HeroActors
    PUSH EDX                            ; 0051fd09
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 0051fd0a | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
        ;   XREF to: 00408ec0 (UNCONDITIONAL_CALL)
    MOV EAX,[0x02db87d0]                ; 0051fd0f | int g_LocalHeroIndex
    MOV EAX,dword ptr [EAX*0x4 + 0x2db87c0] ; 0051fd14 | CHero *[4] g_HeroActors
    ...
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 0051fd32 | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
    ...
    CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0 ; 0051fd58 | SMotion * core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0(CMotionController * this_ptr)
        ;   XREF to: 0052dab0 (UNCONDITIONAL_CALL)
    MOV ESI,dword ptr [0x02db87d0]      ; 0051fd5d | int g_LocalHeroIndex
    ADD ESP,0x4                         ; 0051fd63
    MOV EAX,dword ptr [EAX + 0x24]      ; 0051fd66
    SHL ESI,0x2                         ; 0051fd69
    CMP EAX,0x2                         ; 0051fd6c
    JNC 0x0052029d                      ; 0051fd6f | LAB_0052029d
        ;   XREF to: 0052029d (CONDITIONAL_JUMP)
    TEST EAX,EAX                        ; 0051fd75
    JBE 0x0051fe9d                      ; 0051fd77 | LAB_0051fe9d
        ;   XREF to: 0051fe9d (CONDITIONAL_JUMP)
    MOV EAX,[0x02db87d0]                ; 0051fd7d | int g_LocalHeroIndex
        ;   Label: LAB_0051fd7d
    MOV EAX,dword ptr [EAX*0x4 + 0x2db87c0] ; 0051fd82 | CHero *[4] g_HeroActors
    PUSH EAX                            ; 0051fd89
    MOV EDX,dword ptr [EAX + 0x154]     ; 0051fd8a
    CALL dword ptr [EDX + 0x120]        ; 0051fd90
    ADD ESP,0x4                         ; 0051fd96
    TEST EAX,EAX                        ; 0051fd99
    JZ 0x0051fff9                       ; 0051fd9b | LAB_0051fff9
    ...
    PUSH EAX                            ; 0051fdab
        ;   Label: LAB_0051fdab
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 0051fdac | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   Label: LAB_0051fdac
    ...
    FNSTSW AX                           ; 0051fdbb
    SAHF                                ; 0051fdbd
    JBE 0x005202c0                      ; 0051fdbe | LAB_005202c0
    ...
    FNSTSW AX                           ; 0051fde0
    SAHF                                ; 0051fde2
    JNC 0x00520398                      ; 0051fde3 | LAB_00520398
        ;   XREF to: 00520398 (CONDITIONAL_JUMP)
    LEA EAX,[EBP + 0x5e]                ; 0051fde9
    PUSH EAX                            ; 0051fdec
    PUSH ESI                            ; 0051fded
    CALL core_motion.cpp_CMotionController_advance_FUN_0052d610 ; 0051fdee | int core_motion.cpp_CMotionController_advance_FUN_0052d610(CMotionController * this_ptr)
        ;   XREF to: 0052d610 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0051fdf3
    CMP EAX,0x1                         ; 0051fdf6
    JC 0x0051fdd9                       ; 0051fdf9 | LAB_0051fdd9
        ;   XREF to: 0051fdd9 (CONDITIONAL_JUMP)
    JA 0x0052038e                       ; 0051fdfb | LAB_0052038e
        ;   XREF to: 0052038e (CONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x2410],0x0    ; 0051fe01
    JZ 0x0051fdd9                       ; 0051fe08 | LAB_0051fdd9
        ;   XREF to: 0051fdd9 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x02f33394]      ; 0051fe0a | undefined4 DAT_02f33394
    PUSH EDX                            ; 0051fe10
    LEA EAX,[EBP + -0x3a]               ; 0051fe11
    PUSH EAX                            ; 0051fe14
    PUSH ESI                            ; 0051fe15
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneWorldPosition_FUN_0059fa20 ; 0051fe16 | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneWorldPosition_FUN_0059fa20(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
        ;   XREF to: 0059fa20 (UNCONDITIONAL_CALL)
    ...
    PUSH ESI                            ; 0051fe62
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneWorldPosition_FUN_0059fa20 ; 0051fe63 | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneWorldPosition_FUN_0059fa20(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
        ;   XREF to: 0059fa20 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0051fe6f
    PUSH EBX                            ; 0051fe70
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 0051fe71 | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
        ;   XREF to: 00408ec0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0051fe76
    PUSH 0x0                            ; 0051fe79
    LEA EAX,[EBP + 0xe]                 ; 0051fe7b
    PUSH EAX                            ; 0051fe7e
    MOV EDI,dword ptr [0x0067b9a0]      ; 0051fe7f | CGore * g_CGorePtr
    PUSH EDI                            ; 0051fe85 | CGore g_CGoreInstance
    CALL core_gore.cpp_FUN_004ede30     ; 0051fe86 | undefined core_gore.cpp_FUN_004ede30()
        ;   XREF to: 004ede30 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0051fe8b
    MOV dword ptr [EBX + 0xbe28],0x1    ; 0051fe8e
    JMP 0x0051fdb4                      ; 0051fe98 | LAB_0051fdb4
        ;   XREF to: 0051fdb4 (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESI + 0x2db87c0] ; 0051fe9d | CHero *[4] g_HeroActors
        ;   Label: LAB_0051fe9d
    PUSH EAX                            ; 0051fea3
    ...
    JNZ 0x0051fdb4                      ; 0051feb5 | LAB_0051fdb4
        ;   XREF to: 0051fdb4 (CONDITIONAL_JUMP)
    MOV EAX,[0x0067b654]                ; 0051febb | CGame * g_CGamePtr
    CMP dword ptr [EAX + 0x1d4],0x0     ; 0051fec0 | DAT_02d81c70
    JNZ 0x0051fdb4                      ; 0051fec7 | LAB_0051fdb4
        ;   XREF to: 0051fdb4 (CONDITIONAL_JUMP)
    MOV EAX,[0x02db87d0]                ; 0051fecd | int g_LocalHeroIndex
    MOV EAX,dword ptr [EAX*0x4 + 0x2db87c0] ; 0051fed2 | CHero *[4] g_HeroActors
    FLD float ptr [EBX + 0x24]          ; 0051fed9
    FSUB float ptr [EAX + 0x24]         ; 0051fedc
    FABS                                ; 0051fedf
    FCOMP double ptr [0x00638783]       ; 0051fee1 | double DOUBLE_00638783
    FNSTSW AX                           ; 0051fee7
    SAHF                                ; 0051fee9
    JA 0x0051fdb4                       ; 0051feea | LAB_0051fdb4
        ;   XREF to: 0051fdb4 (CONDITIONAL_JUMP)
    LEA EAX,[EBP + 0x1a]                ; 0051fef0
    PUSH EAX                            ; 0051fef3
    LEA EAX,[EBP + 0x32]                ; 0051fef4
    PUSH EAX                            ; 0051fef7
    CALL core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 0051fef8 | CVector3f * core_vehicle.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
        ;   XREF to: 005e7830 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0051fefd
    PUSH dword ptr [EAX + 0x4]          ; 0051ff00
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70 ; 0051ff03 | float core_actor.cpp_normalizeAngleToPi_FUN_0040cd70(float angle_radians)
    ...
    FSQRT                               ; 0051ff23
    FXCH                                ; 0051ff25
    FMUL double ptr [0x0063878b]        ; 0051ff27 | double DOUBLE_0063878b
    FLD1                                ; 0051ff2d
    FSUBRP                              ; 0051ff2f
    FMUL double ptr [0x00638793]        ; 0051ff31 | double DOUBLE_00638793
    FADD double ptr [0x0063879b]        ; 0051ff37 | double DOUBLE_0063879b
    ADD ESP,0x4                         ; 0051ff3d
    FXCH                                ; 0051ff40
    FCOMPP                              ; 0051ff42
    FNSTSW AX                           ; 0051ff44
    SAHF                                ; 0051ff46
    JNC 0x0051fdb4                      ; 0051ff47 | LAB_0051fdb4
        ;   XREF to: 0051fdb4 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x02f33378]      ; 0051ff4d | undefined4 DAT_02f33378
    PUSH ECX                            ; 0051ff53
    MOV ESI,dword ptr [EBP + 0x72]      ; 0051ff54
    PUSH ESI                            ; 0051ff57
    LEA ESI,[EBP + 0xfffffee2]          ; 0051ff58
    LEA EDI,[EBP + 0xffffff12]          ; 0051ff5e
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneWorldMatrix_FUN_0059f820 ; 0051ff64 | void core_skeleton.cpp_CDeformableModelInstance_getBoneWorldMatrix_FUN_0059f820(CDeformableModelInstance * this_ptr, int bone_index, CMatrix3x4f * out_matrix)
    ...
    CALL core_xform.cpp_transformVector3x4_FUN_005f4dc0 ; 0051ff9d | CVector3f * core_xform.cpp_transformVector3x4_FUN_005f4dc0(CVector3f * output_vector, CVector3f * input_vector, CMatrix3x4f * matrix)
    ...
    PUSH EAX                            ; 0051ffa9
    PUSH EBX                            ; 0051ffaa
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0 ; 0051ffab | CVector3f * core_actor.cpp_CDemonActor_localToWorldPoint_FUN_00408ec0(CDemonActor * this_ptr, CVector3f * output_world_point, CVector3f * input_local_point)
        ;   XREF to: 00408ec0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0051ffba
    MOV ECX,dword ptr [0x006810c8]      ; 0051ffbb | CDemonSet g_CDemonSetInstance | CDemonSet * g_CDemonSetPtr
    PUSH ECX                            ; 0051ffc1 | CDemonSet g_CDemonSetInstance
    CALL core_setcolid.cpp_CDemonSet_testVoxelRaycast_FUN_00572510 ; 0051ffc2 | int core_setcolid.cpp_CDemonSet_testVoxelRaycast_FUN_00572510(CDemonSet * this_ptr, CVector3f * start_pos, CVector3f * end_pos)
        ;   XREF to: 00572510 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0051ffc7
    TEST EAX,EAX                        ; 0051ffca
    JNZ 0x0051fdb4                      ; 0051ffcc | LAB_0051fdb4
        ;   XREF to: 0051fdb4 (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 0051ffd2
    PUSH 0x2                            ; 0051ffd4
    MOV ESI,dword ptr [EBP + 0x72]      ; 0051ffd6
    PUSH ESI                            ; 0051ffd9
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 0051ffda | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0051ffdf
    PUSH 0x63873c                       ; 0051ffe2 | = "gh-alrt[1,4].wav" | s_gh_alrt_1_4_wav_0063873c = gh-alrt[1,4].wav
    MOV EAX,dword ptr [EBX + 0x154]     ; 0051ffe7
    PUSH EBX                            ; 0051ffed
    CALL dword ptr [EAX + 0x24]         ; 0051ffee
    ADD ESP,0x8                         ; 0051fff1
    JMP 0x0051fdb4                      ; 0051fff4 | LAB_0051fdb4
        ;   XREF to: 0051fdb4 (UNCONDITIONAL_JUMP)
    MOV EAX,[0x0067b654]                ; 0051fff9 | CGame * g_CGamePtr
        ;   Label: LAB_0051fff9
    CMP dword ptr [EAX + 0x1d4],0x0     ; 0051fffe | DAT_02d81c70
    JNZ 0x0051fda1                      ; 00520005 | LAB_0051fda1
    ...
    PUSH ECX                            ; 0052001c
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 0052001d | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
        ;   XREF to: 00408f10 (UNCONDITIONAL_CALL)
    ...
    FNSTSW AX                           ; 00520079
    SAHF                                ; 0052007b
    JNC 0x0052008c                      ; 0052007c | LAB_0052008c
        ;   XREF to: 0052008c (CONDITIONAL_JUMP)
    PUSH EBX                            ; 0052007e
    CALL core_mimic.cpp_CMimic_beginMorph_FUN_00520a80 ; 0052007f | undefined core_mimic.cpp_CMimic_beginMorph_FUN_00520a80()
        ;   XREF to: 00520a80 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00520084
    JMP 0x0051fdb4                      ; 00520087 | LAB_0051fdb4
        ;   XREF to: 0051fdb4 (UNCONDITIONAL_JUMP)
    PUSH 0x1                            ; 0052008c
        ;   Label: LAB_0052008c
    LEA ESI,[EBX + 0x158]               ; 0052008e
    PUSH ESI                            ; 00520094
    CALL core_motion.cpp_CMotionController_getStateBlendWeight_FUN_0052dd20 ; 00520095 | float core_motion.cpp_CMotionController_getStateBlendWeight_FUN_0052dd20(CMotionController * this_ptr, int desired_state_index)
    ...
    PUSH 0x2                            ; 005200a3
    FMUL float ptr [0x0063876b]         ; 005200a5 | float FLOAT_0063876b
    PUSH ESI                            ; 005200ab
    FSTP float ptr [EBX + 0x2434]       ; 005200ac
    CALL core_motion.cpp_CMotionController_getStateBlendWeight_FUN_0052dd20 ; 005200b2 | float core_motion.cpp_CMotionController_getStateBlendWeight_FUN_0052dd20(CMotionController * this_ptr, int desired_state_index)
        ;   XREF to: 0052dd20 (UNCONDITIONAL_CALL)
    ...
    FMUL float ptr [0x0063876f]         ; 005200cd | float FLOAT_0063876f
    FLD float ptr [EBX + 0xbe24]        ; 005200d3
    FXCH ST3                            ; 005200d9
    FMUL double ptr [0x00638773]        ; 005200db | double DOUBLE_00638773
    FXCH                                ; 005200e1
    ...
    MOV EAX,[0x00661408]                ; 005200fc | undefined4 DAT_00661408
    ...
    PUSH EAX                            ; 0052011f
    MOV EAX,[0x02db87d0]                ; 00520120 | int g_LocalHeroIndex
    MOV EAX,dword ptr [EAX*0x4 + 0x2db87c0] ; 00520125 | CHero *[4] g_HeroActors
    ...
    CALL core_charactr.cpp_CCharacter_walkToPoint_FUN_004286e0 ; 00520140 | int core_charactr.cpp_CCharacter_walkToPoint_FUN_004286e0(CCharacter * this_ptr)
        ;   XREF to: 004286e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x18                        ; 00520145
    TEST EAX,EAX                        ; 00520148
    JL 0x0052015c                       ; 0052014a | LAB_0052015c
        ;   XREF to: 0052015c (CONDITIONAL_JUMP)
    JLE 0x00520165                      ; 0052014c | LAB_00520165
        ;   XREF to: 00520165 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 0052014e
    CALL core_mimic.cpp_CMimic_beginMorph_FUN_00520a80 ; 0052014f | undefined core_mimic.cpp_CMimic_beginMorph_FUN_00520a80()
        ;   XREF to: 00520a80 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00520154
    JMP 0x0051fdb4                      ; 00520157 | LAB_0051fdb4
        ;   XREF to: 0051fdb4 (UNCONDITIONAL_JUMP)
    PUSH 0x1                            ; 0052015c
        ;   Label: LAB_0052015c
    PUSH EDI                            ; 0052015e
    PUSH ESI                            ; 0052015f
    JMP 0x0051fdac                      ; 00520160 | LAB_0051fdac
    ...
    FABS                                ; 00520177
    FDIVRP                              ; 00520179
    FCOMP double ptr [0x0063877b]       ; 0052017b | double DOUBLE_0063877b
    FNSTSW AX                           ; 00520181
    SAHF                                ; 00520183
    JBE 0x00520190                      ; 00520184 | LAB_00520190
        ;   XREF to: 00520190 (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 00520186
    PUSH 0x1                            ; 00520188
    PUSH ESI                            ; 0052018a
    JMP 0x0051fdac                      ; 0052018b | LAB_0051fdac
        ;   XREF to: 0051fdac (UNCONDITIONAL_JUMP)
    PUSH 0x1                            ; 00520190
        ;   Label: LAB_00520190
    PUSH 0x2                            ; 00520192
    PUSH ESI                            ; 00520194
    JMP 0x0051fdac                      ; 00520195 | LAB_0051fdac
        ;   XREF to: 0051fdac (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESI + 0x2db87c0] ; 0052019a | CHero *[4] g_HeroActors
        ;   Label: LAB_0052019a
    CMP dword ptr [EAX + 0x2598],0x0    ; 005201a0
    JZ 0x005201b5                       ; 005201a7 | LAB_005201b5
        ;   XREF to: 005201b5 (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 005201a9
    PUSH 0x0                            ; 005201ab
    MOV EAX,dword ptr [EBP + 0x72]      ; 005201ad
    JMP 0x0051fdab                      ; 005201b0 | LAB_0051fdab
        ;   XREF to: 0051fdab (UNCONDITIONAL_JUMP)
    MOV ECX,dword ptr [EBP + 0x72]      ; 005201b5
        ;   Label: LAB_005201b5
    PUSH ECX                            ; 005201b8
    CALL core_motion.cpp_CMotionController_frameToMarkerPosition_FUN_0052e2b0 ; 005201b9 | float core_motion.cpp_CMotionController_frameToMarkerPosition_FUN_0052e2b0(CMotionController * this_ptr)
    ...
    FCOMP double ptr [0x00638763]       ; 005201d0 | double DOUBLE_00638763
    FNSTSW AX                           ; 005201d6
    SAHF                                ; 005201d8
    JA 0x0051fdb4                       ; 005201d9 | LAB_0051fdb4
        ;   XREF to: 0051fdb4 (CONDITIONAL_JUMP)
    MOV EAX,[0x00661408]                ; 005201df | undefined4 DAT_00661408
    FLD1                                ; 005201e4
    MOV dword ptr [EBP + 0x6e],EAX      ; 005201e6
    FCOMP double ptr [EBP + 0x52]       ; 005201e9
    FNSTSW AX                           ; 005201ec
    SAHF                                ; 005201ee
    JA 0x0051fdb4                       ; 005201ef | LAB_0051fdb4
        ;   XREF to: 0051fdb4 (CONDITIONAL_JUMP)
    PUSH 0x41700000                     ; 005201f5
    PUSH 0x40e00000                     ; 005201fa
    CALL core_actor.cpp_getRandomFloat_FUN_0040cc10 ; 005201ff | float core_actor.cpp_getRandomFloat_FUN_0040cc10(float min_value, float max_value)
        ;   XREF to: 0040cc10 (UNCONDITIONAL_CALL)
    JBE 0x0051fd7d                      ; 0052029d | LAB_0051fd7d
        ;   Label: LAB_0052029d
        ;   XREF to: 0051fd7d (CONDITIONAL_JUMP)
    CMP EAX,0xc                         ; 005202a3
    JC 0x005202b7                       ; 005202a6 | LAB_005202b7
        ;   XREF to: 005202b7 (CONDITIONAL_JUMP)
    JBE 0x0051fe3f                      ; 005202a8 | LAB_0051fe3f
        ;   XREF to: 0051fe3f (CONDITIONAL_JUMP)
    CMP EAX,0x13                        ; 005202ae
    JZ 0x0052019a                       ; 005202b1 | LAB_0052019a
        ;   XREF to: 0052019a (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 005202b7
        ;   Label: LAB_005202b7
    PUSH 0x2                            ; 005202b9
    JMP 0x0051fda5                      ; 005202bb | LAB_0051fda5
    ...
    FLD ST0                             ; 005202ce
    FMUL double ptr [0x006387a3]        ; 005202d0 | double DOUBLE_006387a3
    FXCH ST3                            ; 005202d6
    FMULP                               ; 005202d8
    FXCH ST2                            ; 005202da
    FMULP                               ; 005202dc
    ...
    PUSH EAX                            ; 005202ff
    MOV EAX,[0x02db87d0]                ; 00520300 | int g_LocalHeroIndex
    MOV EAX,dword ptr [EAX*0x4 + 0x2db87c0] ; 00520305 | CHero *[4] g_HeroActors
    ...
    CALL core_charactr.cpp_CCharacter_walkToPoint_FUN_004286e0 ; 00520320 | int core_charactr.cpp_CCharacter_walkToPoint_FUN_004286e0(CCharacter * this_ptr)
        ;   XREF to: 004286e0 (UNCONDITIONAL_CALL)
    ADD ESP,0x18                        ; 00520325
    CMP EAX,0x1                         ; 00520328
    JZ 0x0051fdc4                       ; 0052032b | LAB_0051fdc4
        ;   XREF to: 0051fdc4 (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 00520331
    PUSH 0x2                            ; 00520333
    LEA EAX,[EBX + 0x158]               ; 00520335
    PUSH EAX                            ; 0052033b
    CALL core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00 ; 0052033c | void core_motion.cpp_CMotionController_setDesiredState_FUN_0052db00(CMotionController * this_ptr, int desired_state_index, int force_immediate)
        ;   XREF to: 0052db00 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00520341
    JMP 0x0051fdc4                      ; 00520344 | LAB_0051fdc4
        ;   XREF to: 0051fdc4 (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBX + 0x2410],0x0    ; 00520349
        ;   Label: LAB_00520349
    JZ 0x0051fdd9                       ; 00520350 | LAB_0051fdd9
        ;   XREF to: 0051fdd9 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [0x02f33398]      ; 00520356 | undefined4 DAT_02f33398
    PUSH EDI                            ; 0052035c
    LEA EAX,[EBP + -0x76]               ; 0052035d
    PUSH EAX                            ; 00520360
    PUSH ESI                            ; 00520361
    CALL core_skeleton.cpp_CDeformableModelInstance_getBoneWorldPosition_FUN_0059fa20 ; 00520362 | CVector3f * core_skeleton.cpp_CDeformableModelInstance_getBoneWorldPosition_FUN_0059fa20(CDeformableModelInstance * this_ptr, CVector3f * out_position, int bone_index)
        ;   XREF to: 0059fa20 (UNCONDITIONAL_CALL)
    ...
    JMP 0x0051fdd9                      ; 00520389 | LAB_0051fdd9
        ;   XREF to: 0051fdd9 (UNCONDITIONAL_JUMP)
    CMP EAX,0x7                         ; 0052038e
        ;   Label: LAB_0052038e
    JZ 0x00520349                       ; 00520391 | LAB_00520349
        ;   XREF to: 00520349 (CONDITIONAL_JUMP)
    JMP 0x0051fdd9                      ; 00520393 | LAB_0051fdd9
        ;   XREF to: 0051fdd9 (UNCONDITIONAL_JUMP)
    PUSH EBX                            ; 00520398
        ;   Label: LAB_00520398
    CALL core_charactr.cpp_CCharacter_FUN_00429820 ; 00520399 | void core_charactr.cpp_CCharacter_FUN_00429820(CCharacter * this_ptr)
        ;   XREF to: 00429820 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052039e
    PUSH ESI                            ; 005203a1
    CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0 ; 005203a2 | SMotion * core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0(CMotionController * this_ptr)
        ;   XREF to: 0052dab0 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [EAX + 0x24]      ; 005203a7
    ADD ESP,0x4                         ; 005203aa
    MOV EAX,EDX                         ; 005203ad
    CMP EDX,0xc                         ; 005203af
    JZ 0x005204c6                       ; 005203b2 | LAB_005204c6
        ;   XREF to: 005204c6 (CONDITIONAL_JUMP)
    TEST EDX,EDX                        ; 005203b8
    JZ 0x005204c6                       ; 005203ba | LAB_005204c6
        ;   XREF to: 005204c6 (CONDITIONAL_JUMP)
    FLD float ptr [EBP + 0x92]          ; 005203c0
        ;   Label: LAB_005203c0
    FLD ST0                             ; 005203c6
    FMUL double ptr [0x006387ab]        ; 005203c8 | double DOUBLE_006387ab
    ...
    JNC 0x005204d5                      ; 0052042d | LAB_005204d5
        ;   XREF to: 005204d5 (CONDITIONAL_JUMP)
    CMP EAX,0x1                         ; 00520433
    JNC 0x00520472                      ; 00520436 | LAB_00520472
        ;   XREF to: 00520472 (CONDITIONAL_JUMP)
    TEST EAX,EAX                        ; 00520438
    JZ 0x00520472                       ; 0052043a | LAB_00520472
        ;   Label: LAB_0052043a
        ;   XREF to: 00520472 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 00520478
    PUSH EBX                            ; 00520479
    CALL core_charactr.cpp_CCharacter_FUN_00428f40 ; 0052047a | void core_charactr.cpp_CCharacter_FUN_00428f40(CCharacter * this_ptr)
        ;   XREF to: 00428f40 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0052047f
    LEA ESI,[EBX + 0x158]               ; 00520482
        ;   Label: LAB_00520482
    PUSH ESI                            ; 00520488
    CALL core_skeleton.cpp_CDeformableModelInstance_updateAnimation_FUN_0059e020 ; 00520489 | void core_skeleton.cpp_CDeformableModelInstance_updateAnimation_FUN_0059e020(CDeformableModelInstance * this_ptr)
        ;   XREF to: 0059e020 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0052048e
    PUSH ESI                            ; 00520491
    CALL core_skeleton.cpp_CDeformableModelInstance_computeBoneTransforms_FUN_0059fb40 ; 00520492 | void core_skeleton.cpp_CDeformableModelInstance_computeBoneTransforms_FUN_0059fb40(CDeformableModelInstance * this_ptr)
    ...
    PUSH EBX                            ; 005204b5
    CALL core_cloth.cpp_FUN_0043ab80    ; 005204b6 | undefined core_cloth.cpp_FUN_0043ab80()
    ...
    CMP dword ptr [EBX + 0xdc],0x0      ; 005204c6
        ;   Label: LAB_005204c6
    JNZ 0x005203c0                      ; 005204cd | LAB_005203c0
        ;   XREF to: 005203c0 (CONDITIONAL_JUMP)
    JMP 0x00520482                      ; 005204d3 | LAB_00520482
        ;   XREF to: 00520482 (UNCONDITIONAL_JUMP)
    JBE 0x00520472                      ; 005204d5 | LAB_00520472
        ;   Label: LAB_005204d5
        ;   XREF to: 00520472 (CONDITIONAL_JUMP)
    CMP EAX,0x11                        ; 005204d7
    JNC 0x005204e4                      ; 005204da | LAB_005204e4
        ;   XREF to: 005204e4 (CONDITIONAL_JUMP)
    CMP EAX,0x10                        ; 005204dc
    JMP 0x0052043a                      ; 005204df | LAB_0052043a
        ;   XREF to: 0052043a (UNCONDITIONAL_JUMP)
    JBE 0x00520472                      ; 005204e4 | LAB_00520472
        ;   Label: LAB_005204e4
        ;   XREF to: 00520472 (CONDITIONAL_JUMP)
    CMP EAX,0x14                        ; 005204e6
    JC 0x0052043c                       ; 005204e9 | LAB_0052043c
        ;   XREF to: 0052043c (CONDITIONAL_JUMP)
    JBE 0x00520472                      ; 005204ef | LAB_00520472
        ;   XREF to: 00520472 (CONDITIONAL_JUMP)
    CMP EAX,0x15                        ; 005204f1
    JMP 0x0052043a                      ; 005204f4 | LAB_0052043a
        ;   XREF to: 0052043a (UNCONDITIONAL_JUMP)
