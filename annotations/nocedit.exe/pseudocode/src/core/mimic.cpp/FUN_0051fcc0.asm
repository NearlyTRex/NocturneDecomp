...
section .text
    ...
    JZ 0x0051fdd9                       ; 0051fe08
        ;   XREF to: 0051fdd9 (CONDITIONAL_JUMP)  ; LAB_0051fdd9
    MOV EDX,dword ptr [0x02f33394]      ; 0051fe0a | DAT_02f33394
    PUSH EDX                            ; 0051fe10
    ...
    JNC 0x0051fdb4                      ; 0051ff47
        ;   XREF to: 0051fdb4 (CONDITIONAL_JUMP)  ; LAB_0051fdb4
    MOV ECX,dword ptr [0x02f33378]      ; 0051ff4d | DAT_02f33378
    PUSH ECX                            ; 0051ff53
    ...
    JZ 0x0051fdd9                       ; 00520350
        ;   XREF to: 0051fdd9 (CONDITIONAL_JUMP)  ; LAB_0051fdd9
    MOV EDI,dword ptr [0x02f33398]      ; 00520356 | DAT_02f33398
    PUSH EDI                            ; 0052035c
