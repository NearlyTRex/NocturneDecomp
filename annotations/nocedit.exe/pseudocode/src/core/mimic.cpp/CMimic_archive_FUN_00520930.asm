...
section .text
    ...
    PUSH EBX                            ; 00520930
        ;   Label: core_mimic.cpp_CMimic_archive_FUN_00520930
    PUSH ESI                            ; 00520931
    MOV EBX,dword ptr [ESP + 0xc]       ; 00520932
    PUSH EBX                            ; 00520936
    CALL core_enemy.cpp_CEnemy_archive_FUN_004a9660 ; 00520937
    ...
    PUSH ESI                            ; 0052094a
    CALL core_actor.cpp_archiveFloat_FUN_0040b770 ; 0052094b
    ...
    PUSH ESI                            ; 0052095e
    CALL core_actor.cpp_archiveDeformableModelInstance_FUN_0040b970 ; 0052095f
    ...
    PUSH EAX                            ; 00520972
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 00520973
    ...
    PUSH EAX                            ; 00520986
    CALL core_actor.cpp_archiveInteger_FUN_0040b7f0 ; 00520987
    ...
    PUSH 0x638802                       ; 005209ba | = "motion state"
        ;   Label: LAB_005209ba
    PUSH ESI                            ; 005209bf
    CALL core_actor.cpp_archiveMotionState_FUN_0040b9f0 ; 005209c0
    ...
    PUSH ESI                            ; 005209d3
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 005209d4
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveString_FUN_0040b5c0(char * string_buffer, char * property_type)
    ...
    PUSH EBX                            ; 005209f3
    CALL core_actor.cpp_archiveString_FUN_0040b5c0 ; 005209f4
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_archiveString_FUN_0040b5c0(char * string_buffer, char * property_type)
