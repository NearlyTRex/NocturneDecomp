...
;                               FUNCTION
; *****************************************************************************
; __cdecl CMimic * core_mimic.cpp_FUN_0051f1d0(CMimic * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 0051f1d6
    CALL core_enemy.cpp_CEnemy_ctor_FUN_004a9500 ; 0051f1d7 | CEnemy * core_enemy.cpp_CEnemy_ctor_FUN_004a9500(CEnemy * this_ptr)
        ;   XREF to: 004a9500 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0051f1dc
    ADD EAX,0xbf84                      ; 0051f1df
    PUSH EAX                            ; 0051f1e4
    CALL core_cloth.cpp_FUN_00438ba0    ; 0051f1e5 | undefined core_cloth.cpp_FUN_00438ba0()
        ;   XREF to: 00438ba0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0051f1ea
    ADD EAX,0x3fea0                     ; 0051f1ed
    PUSH EAX                            ; 0051f1f2
    CALL core_morph.cpp_FUN_0052b310    ; 0051f1f3 | undefined core_morph.cpp_FUN_0052b310()
        ;   XREF to: 0052b310 (UNCONDITIONAL_CALL)
    LEA EDX,[EAX + 0xfffb41dc]          ; 0051f1f8
    MOV dword ptr [EDX + 0x154],0x661424 ; 0051f1fe | CDemonActor_vtable PTR_core_mimic.cpp_CMimic_setup_FUN_0051f3e0_00661424
    MOV dword ptr [EDX + 0x2ddc],0x3f000000 ; 0051f208
    MOV ESI,0x638554                    ; 0051f212 | = "CGhoul" | s_CGhoul_00638554 = CGhoul
    MOV dword ptr [EDX + 0x2de0],0x3f800000 ; 0051f217
    FLD float ptr [0x0066140c]          ; 0051f221 | DAT_0066140c
    MOV byte ptr [EDX + 0xbebc],0x0     ; 0051f227
    FLD float ptr [0x00661410]          ; 0051f22e | PTR_FUN_0066140d+3
    ...
    PUSH EDI                            ; 0051f266
    MOV AL,byte ptr [ESI]               ; 0051f267 | = "CGhoul" | s_CGhoul_00638554 = CGhoul
        ;   Label: LAB_0051f267
    MOV byte ptr [EDI],AL               ; 0051f269
    CMP AL,0x0                          ; 0051f26b
    JZ 0x0051f27f                       ; 0051f26d | LAB_0051f27f
        ;   XREF to: 0051f27f (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0051f26f | s_Ghoul_00638555
    ADD ESI,0x2                         ; 0051f272
    MOV byte ptr [EDI + 0x1],AL         ; 0051f275
    ADD EDI,0x2                         ; 0051f278
    CMP AL,0x0                          ; 0051f27b
    JNZ 0x0051f267                      ; 0051f27d | LAB_0051f267
