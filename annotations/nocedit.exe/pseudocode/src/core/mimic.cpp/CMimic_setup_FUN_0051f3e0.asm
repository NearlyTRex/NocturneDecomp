...
section .text
    ...
    MOV EAX,[0x00680a00]                ; 0051f3eb | DAT_02f7c740 | g_CNetGameInstance
    CMP dword ptr [EAX],0x0             ; 0051f3f0 | DAT_02f7c740
    ...
    PUSH ESI                            ; 0051f456
    MOV [0x02f33378],EAX                ; 0051f457 | DAT_02f33378
