  ...
  while (0.0 < local_2c[0]) {
    ...
    if (uVar7 != 0) {
      if (uVar7 < 2) {
        ...
        core_skeleton_cpp_CDeformableModelInstance_getBoneWorldPosition_FUN_0059fa20
                  (pCVar13,&local_100,INT_02f33398);
...
LAB_00520482:
  pCVar13 = &(this_ptr->base).base.model;
  core_skeleton_cpp_CDeformableModelInstance_updateAnimation_FUN_0059e020(pCVar13);
  core_skeleton_cpp_CDeformableModelInstance_computeBoneTransforms_FUN_0059fb40(pCVar13);
