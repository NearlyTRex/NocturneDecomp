...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_mimic.cpp_CMimic_renderOpaque_FUN_00520870(CMimic * this_ptr)
;
; Parameters:
...
section .text
    ...
    JZ 0x00520880                       ; 0052087b | LAB_00520880
        ;   XREF to: 00520880 (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 0052087d
    RET                                 ; 0052087f
    PUSH EAX                            ; 00520880
        ;   Label: LAB_00520880
    CALL core_mimic.cpp_CMimic_FUN_005205f0 ; 00520881 | int core_mimic.cpp_CMimic_FUN_005205f0(CMimic * this_ptr)
