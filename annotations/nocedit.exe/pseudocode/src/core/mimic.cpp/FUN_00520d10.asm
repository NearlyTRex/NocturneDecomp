...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_mimic_cpp_FUN_00520d10(void)
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH ESI                            ; 00520d1a
    PUSH EBX                            ; 00520d1b
    CALL core_enemy.cpp_CEnemy_FUN_004aa170 ; 00520d1c
    ...
    PUSH ESI                            ; 00520d30
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e460 ; 00520d31
    ...
    PUSH ESI                            ; 00520d45
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e460 ; 00520d46
        ;   XREF to: 0040e460 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_CActorPropertyList_FUN_0040e460(CActorPropertyList * this_ptr)
    ...
    PUSH ESI                            ; 00520d5c
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e1e0 ; 00520d5d
    ...
    PUSH ESI                            ; 00520d77
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e350 ; 00520d78
    ...
    PUSH ESI                            ; 00520d90
    CALL core_actor.cpp_CActorPropertyList_FUN_0040e290 ; 00520d91
