...
section .text
    ...
    PUSH EDX                            ; 0053bf10
    CALL core_mission.cpp_FUN_00524660  ; 0053bf11
    ...
    PUSH EDI                            ; 0053bfa6
    CALL core_msnedit.cpp_UndoTmp_BuildActorList_CreateTmp_FUN_0053c140 ; 0053bfa7
    ...
    CALL core_msnedit.cpp_FUN_0053d220  ; 0053c077
