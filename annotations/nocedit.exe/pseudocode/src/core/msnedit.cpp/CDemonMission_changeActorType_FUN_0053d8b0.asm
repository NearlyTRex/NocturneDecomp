...
; Local Variables:
; CActorPropertyList Stack[-0x502c]:9476  CStack_502c
; CActorPropertyList Stack[-0x2b28]:9476  CStack_2b28
; CPickList        Stack[-0x624]:936  local_624
; char[500]        Stack[-0x27c]:500  local_27c
; char[100]        Stack[-0x88]:100  local_88
; int              Stack[-0x24]:4  iStack_24
; CDemonActor *    Stack[-0x20]:4  local_20
; int              Stack[-0x1c]:4  iStack_1c
; CActorProperty * Stack[-0x18]:4  pCStack_18
...
section .text
    ...
    PUSH EBX                            ; 0053d8b0
        ;   Label: core_msnedit.cpp_CDemonMission_changeActorType_FUN_0053d8b0
    PUSH ESI                            ; 0053d8b1
    PUSH EDI                            ; 0053d8b2
    PUSH EBP                            ; 0053d8b3
    ...
    LEA EAX,[ESP + 0x4a08]              ; 0053d949
        ;   Label: LAB_0053d949
    PUSH EAX                            ; 0053d950
    CALL shape_edittool.cpp_CStrList_sortAll_FUN_004a2ec0 ; 0053d951
    ...
    CALL core_msnedit.cpp_CDemonMission_selectActor_FUN_0053c140 ; 0053dbae
    ...
    PUSH EBX                            ; 0053dbed
    PUSH ESI                            ; 0053dbee
    CALL core_msnedit.cpp_CDemonMission_selectActor_FUN_0053c140 ; 0053dbef
        ;   XREF to: 0053c140 (UNCONDITIONAL_CALL)  ; void core_msnedit.cpp_CDemonMission_selectActor_FUN_0053c140(CDemonMission * this_ptr, CDemonActor * actor)
