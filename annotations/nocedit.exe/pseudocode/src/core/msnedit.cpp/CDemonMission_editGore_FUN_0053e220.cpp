  ...
  while( true ) {
    ...
    if (iVar3 != 0) {
      ...
      if ((0.0 < fVar4) && (fVar4 < 1.0)) {
        auStack_94._12_4_ = CStack_7c.x + (CStack_a0.x - CStack_7c.x) * fVar4;
        fStack_84 = CStack_7c.y + (CStack_a0.y - CStack_7c.y) * fVar4;
        fStack_80 = CStack_7c.z + (CStack_a0.z - CStack_7c.z) * fVar4;
