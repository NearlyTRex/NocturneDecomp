...
section .text
    ...
    JNZ 0x00538e3d                      ; 00538e25 | LAB_00538e3d
        ;   XREF to: 00538e3d (CONDITIONAL_JUMP)
    PUSH EBX                            ; 00538e27
    PUSH EDI                            ; 00538e28
    CALL core_msnedit.cpp_FUN_00538ea0  ; 00538e29 | undefined core_msnedit.cpp_FUN_00538ea0()
        ;   XREF to: 00538ea0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00538e2e
    PUSH 0x1                            ; 00538e31
    PUSH EBX                            ; 00538e33
    PUSH EDI                            ; 00538e34
    CALL core_mission.cpp_CDemonMission_FUN_00523f20 ; 00538e35 | void core_mission.cpp_CDemonMission_FUN_00523f20(CDemonMission * this_ptr)
        ;   XREF to: 00523f20 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00538e3a
    MOV EBX,ESI                         ; 00538e3d
        ;   Label: LAB_00538e3d
    TEST ESI,ESI                        ; 00538e3f
    JNZ 0x00538e1a                      ; 00538e41 | LAB_00538e1a
        ;   XREF to: 00538e1a (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [EDI + 0x548]     ; 00538e43
        ;   Label: LAB_00538e43
    TEST EBX,EBX                        ; 00538e49
    JZ 0x00538e70                       ; 00538e4b | LAB_00538e70
    ...
    JNZ 0x00538e4d                      ; 00538e66 | LAB_00538e4d
    ...
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 00538e91 | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
