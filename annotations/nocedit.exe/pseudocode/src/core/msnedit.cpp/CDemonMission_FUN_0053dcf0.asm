...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_msnedit_cpp_CDemonMission_FUN_0053dcf0(CDemonMission *this_ptr)
;
; Parameters:
...
;
; XREF[1]:
;   core_msnedit.cpp_CDemonMission_FUN_005390f0 at 0053a7f8
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0053dcf0
        ;   Label: core_msnedit.cpp_CDemonMission_FUN_0053dcf0
    PUSH ESI                            ; 0053dcf1
    PUSH EDI                            ; 0053dcf2
    PUSH EBP                            ; 0053dcf3
