...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_msnedit_cpp_CDemonMission_FUN_0053af50(CDemonMission *this_ptr,char *param_2)
;
; Parameters:
...
;
; XREF[1]:
;   core_msnedit.cpp_CDemonMission_FUN_005390f0 at 0053ad6a
;
; Referenced Globals:
...
;   core_msnedit.cpp_CDemonMission_FUN_0053b030
;   core_msnedit.cpp_CDemonMission_FUN_0053b510
...
section .text
    ...
    PUSH EBX                            ; 0053af50
        ;   Label: core_msnedit.cpp_CDemonMission_FUN_0053af50
    PUSH EDI                            ; 0053af51
    PUSH EBP                            ; 0053af52
    ...
    PUSH EAX                            ; 0053afc2
        ;   Label: caseD_b
    PUSH EBX                            ; 0053afc3
    CALL core_msnedit.cpp_CDemonMission_FUN_0053b030 ; 0053afc4
        ;   XREF to: 0053b030 (UNCONDITIONAL_CALL)  ; void core_msnedit.cpp_CDemonMission_FUN_0053b030(CDemonMission * this_ptr, int param_2)
    ...
    PUSH EAX                            ; 0053afd0
        ;   Label: caseD_c
    PUSH EBX                            ; 0053afd1
    CALL core_msnedit.cpp_CDemonMission_FUN_0053b510 ; 0053afd2
        ;   XREF to: 0053b510 (UNCONDITIONAL_CALL)  ; void core_msnedit.cpp_CDemonMission_FUN_0053b510(CDemonMission * this_ptr, int param_2)
