...
; Local Variables:
; char[260]        Stack[-0x420]:260  local_420
...
section .text
    ...
    PUSH EBX                            ; 00537f60
        ;   Label: core_msnedit.cpp_CDemonMission_saveWithNewName_FUN_00537f60
    PUSH ESI                            ; 00537f61
    PUSH EDI                            ; 00537f62
    PUSH EBP                            ; 00537f63
    ...
    PUSH EBX                            ; 00537fc5
    PUSH EBP                            ; 00537fc6
    CALL core_msnedit.cpp_CDemonMission_saveMissionAndScript_FUN_0053d190 ; 00537fc7
