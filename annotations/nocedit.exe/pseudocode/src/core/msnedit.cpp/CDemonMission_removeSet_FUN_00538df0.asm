...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_msnedit_cpp_CDemonMission_removeSet_FUN_00538df0(CDemonMission *this_ptr,int param_2)
;
; Parameters:
...
section .text
    ...
    PUSH EDI                            ; 00538df0
        ;   Label: core_msnedit.cpp_CDemonMission_removeSet_FUN_00538df0
    PUSH EBP                            ; 00538df1
    ...
    PUSH EBX                            ; 00538e27
    PUSH EDI                            ; 00538e28
    CALL core_msnedit.cpp_CDemonMission_deleteActor_FUN_00538ea0 ; 00538e29
    ...
    PUSH EBX                            ; 00538e33
    PUSH EDI                            ; 00538e34
    CALL core_mission.cpp_CDemonMission_removeActor_FUN_00523f20 ; 00538e35
