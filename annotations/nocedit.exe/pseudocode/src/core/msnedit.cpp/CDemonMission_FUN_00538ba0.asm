...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_msnedit_cpp_CDemonMission_FUN_00538ba0(CDemonMission *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00538ba0
        ;   Label: core_msnedit.cpp_CDemonMission_FUN_00538ba0
    PUSH EBP                            ; 00538ba1
    ...
    PUSH EBX                            ; 00538c29
    CALL core_mission.cpp_CDemonMission_FUN_00523cf0 ; 00538c2a
    ...
    PUSH EBP                            ; 00538c5b
    PUSH EBX                            ; 00538c5c
    CALL core_mission.cpp_CDemonMission_FUN_00523fb0 ; 00538c5d
