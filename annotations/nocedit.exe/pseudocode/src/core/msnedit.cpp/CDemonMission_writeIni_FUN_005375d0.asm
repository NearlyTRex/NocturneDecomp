...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_msnedit_cpp_CDemonMission_writeIni_FUN_005375d0(CDemonMission *this_ptr,CIniFile *ini_file)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 005375d0
        ;   Label: core_msnedit.cpp_CDemonMission_writeIni_FUN_005375d0
    PUSH ESI                            ; 005375d1
    PUSH EDI                            ; 005375d2
    PUSH EBP                            ; 005375d3
