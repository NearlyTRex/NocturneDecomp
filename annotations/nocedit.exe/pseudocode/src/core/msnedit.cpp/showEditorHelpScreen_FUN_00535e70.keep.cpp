// Name: core_msnedit.cpp_showEditorHelpScreen_FUN_00535e70
// Address: 00535e70
// MANUAL RECONSTRUCTION
// Address Range: [[00535e70, 00536bbc]]
// Convention: __cdecl
// Signature: void __cdecl core_msnedit_cpp_showEditorHelpScreen_FUN_00535e70(void)
...

{
  ...
  while( true ) {
    ...
    if (this_ptr != (CDemonActor *)0x0) {
      ...
      _sprintf
                (local_110,"Actor-specific help for selected actor %s (type %s):",this_ptr->actor_name,pcVar2);
