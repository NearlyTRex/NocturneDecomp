// Name: core_msnedit.cpp_CDemonMission_FUN_0053ccf0
// Address: 0053ccf0
// Address Range: [[0053ccf0, 0053d183]]
// Convention: __cdecl
// Signature: void __cdecl core_msnedit_cpp_CDemonMission_FUN_0053ccf0(CDemonMission *this_ptr)
...
LAB_0053ce9f:
      ...
      for (pCVar4 = local_10->first_actor; local_10 = pCVar1, pCVar4 != (CDemonActor *)0x0;
        ...
        core_msnedit_cpp_CDemonMission_FUN_00538ea0(this_ptr,(int)pCVar4);
        pCVar1 = local_10;
      }
    ...
    if (iVar2 == 0) {
      while( true ) {
        ...
        pcVar5 = core_mission_cpp_CDemonMission_FUN_00524030(this_ptr);
        if (pcVar5 != (char *)0x0) {
