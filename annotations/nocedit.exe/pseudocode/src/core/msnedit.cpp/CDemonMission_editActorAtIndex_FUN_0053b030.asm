...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_msnedit_cpp_CDemonMission_editActorAtIndex_FUN_0053b030(CDemonMission *this_ptr,int param_2)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 0053b1a2
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 0053b1a3
    ...
    PUSH EAX                            ; 0053b292
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 0053b293
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c__sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH EAX                            ; 0053b45e
    CALL crt_stdio.c__sprintf_FUN_005fdbd0 ; 0053b45f
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c__sprintf_FUN_005fdbd0(char * buffer, char * format)
