...
section .text
    ...
    JZ 0x0053c9ac                       ; 0053c986 | LAB_0053c9ac
        ;   XREF to: 0053c9ac (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x02f7c53c]      ; 0053c988 | undefined4 DAT_02f7c53c
    CMP ECX,0x3                         ; 0053c98e
    JZ 0x0053c9ac                       ; 0053c991 | LAB_0053c9ac
        ;   XREF to: 0053c9ac (CONDITIONAL_JUMP)
    CMP ECX,0x4                         ; 0053c993
    JZ 0x0053c9ac                       ; 0053c996 | LAB_0053c9ac
        ;   XREF to: 0053c9ac (CONDITIONAL_JUMP)
    CMP EBX,dword ptr [EAX + 0x14]      ; 0053c998
    JLE 0x0053c9ac                      ; 0053c99b | LAB_0053c9ac
        ;   XREF to: 0053c9ac (CONDITIONAL_JUMP)
    CMP EBX,dword ptr [EAX + 0x1c]      ; 0053c99d
    JGE 0x0053c9ac                      ; 0053c9a0 | LAB_0053c9ac
        ;   XREF to: 0053c9ac (CONDITIONAL_JUMP)
    CMP ESI,dword ptr [EAX + 0x18]      ; 0053c9a2
    JLE 0x0053c9ac                      ; 0053c9a5 | LAB_0053c9ac
        ;   XREF to: 0053c9ac (CONDITIONAL_JUMP)
    CMP ESI,dword ptr [EAX + 0x20]      ; 0053c9a7
    JL 0x0053c9b2                       ; 0053c9aa | LAB_0053c9b2
    ...
    PUSH 0x1                            ; 0053c9b2
        ;   Label: LAB_0053c9b2
    PUSH 0x32758e4                      ; 0053c9b4 | CDemonCamera g_CDemonCameraInstance
    CALL core_dcamera.cpp_CDemonCamera_beginScene_FUN_0044c430 ; 0053c9b9 | void core_dcamera.cpp_CDemonCamera_beginScene_FUN_0044c430(CDemonCamera * this_ptr, int skip_clear_buffers)
    ...
    PUSH EAX                            ; 0053c9c7
    CALL core_msnedit.cpp_FUN_00535c60  ; 0053c9c8 | undefined core_msnedit.cpp_FUN_00535c60()
    ...
    PUSH 0x32758e4                      ; 0053c9db | CDemonCamera g_CDemonCameraInstance
    ...
    CALL core_dcamera.cpp_CDemonCamera_endScene_FUN_0044cb80 ; 0053c9ec | void core_dcamera.cpp_CDemonCamera_endScene_FUN_0044cb80(CDemonCamera * this_ptr, int skip_zbuffer_copy)
