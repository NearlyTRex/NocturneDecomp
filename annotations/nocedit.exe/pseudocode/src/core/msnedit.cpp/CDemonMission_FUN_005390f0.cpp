// Name: core_msnedit.cpp_CDemonMission_FUN_005390f0
// Address: 005390f0
// Address Range: [[005390f0, 0053af22]]
// Convention: __cdecl
// Signature: int __cdecl core_msnedit_cpp_CDemonMission_FUN_005390f0(CDemonMission *this_ptr,int param_2)

#include "nocturne.h"

int __cdecl core_msnedit_cpp_CDemonMission_FUN_005390f0(CDemonMission *this_ptr,int param_2)

{
  ...
  bool bVar12;
  byte bVar13;
  CKeys *in_stack_fffff620;
  int in_stack_fffff624;
  CDemonMission *in_stack_fffff628;
  CKeys *in_stack_fffff630;
  CDemonMission *in_stack_fffff634;
  ...
  this_ptr->unk2[0x18] = -1;
  this_ptr->unk2[0x19] = -1;
  this_ptr->unk2[0x1a] = -1;
  this_ptr->unk2[0x1b] = -1;
  core_msnedit_cpp_CDemonMission_FUN_00539060(this_ptr,(uint)(400 < iVar10));
  ...
  do {
    ...
    if (DAT_02f7c634 != 2) {
      ...
      case 0:
        if ((g_CEdCheckInstance.checked_state != 0) && (g_MouseButtonFlags == 0)) {
          core_setdir_cpp_CDemonSet_evaluateVirtualDirector_FUN_005751d0
                    (g_CDemonSetPtr,*(CDemonActor **)(this_ptr->unk2 + 0x1c),0);
        }
      ...
      case 3:
        ...
        if (*(int *)(this_ptr->unk2 + 0x1c) != 0) {
          pfVar3 = (float *)(**(code **)(*(int *)(*(int *)(this_ptr->unk2 + 0x1c) + 0x154) + 0x14))
                                      ();
      ...
      case 4:
        ...
        if (*(int *)(this_ptr->unk2 + 0x1c) != 0) {
          ...
          local_160 = local_160 + *(float *)(*(int *)(this_ptr->unk2 + 0x1c) + 0x34);
          core_dirmat_cpp_CMatrix3x3f_buildRotationMatrix_FUN_00471d30
          ...
          local_88 = pCVar4->x + *(float *)(iVar10 + 0x20);
          local_84 = pCVar4->y + *(float *)(iVar10 + 0x24);
          local_b8 = local_88 + local_d0;
          local_80 = pCVar4->z + *(float *)(iVar10 + 0x28);
      ...
      if (DAT_02f7c53c == 0) {
        if (*(int *)(this_ptr->unk2 + 0x2c) == 0) {
          ...
          pCVar15->unk_lighting_param1 = 0;
        }
        else {
          g_CDemonCameraInstance.corona_blend_factor = 0xffff;
          g_CDemonSetPtr->lighting_quality_mode = 1;
          pCVar15->unk_lighting_param1 = 1;
        }
        pCVar15 = g_CDemonSetPtr;
        g_CDemonSetPtr->unk_lighting_param3 = (uint)(*(int *)(this_ptr->unk2 + 0x24) == 0);
        pCVar15->unk_lighting_param4 = (uint)(*(int *)(this_ptr->unk2 + 0x28) == 0);
        core_set_cpp_CDemonSet_FUN_0056c1a0(pCVar15);
        ...
        g_CDemonSetPtr->lighting_quality_mode = 1;
        pCVar15->unk_lighting_param3 = 0;
        pCVar15->unk_lighting_param4 = 0;
      ...
      iVar10 = local_14;
      if ((((*(int *)(this_ptr->unk2 + 0x18) != 0) && (iVar6 = DAT_02f7c634, DAT_02f7c634 == 0)) &&
          (iVar7 = core_setedit_cpp_CDemonSet_FUN_00577af0(g_CDemonSetPtr), local_38 = iVar7,
          iVar10 = local_14, -1 < iVar7)) &&
         (iVar2 = (*g_CKeysPtr->vtable->getKeyState)(g_CKeysPtr,0x38), iVar10 = iVar6, iVar2 != 0))
      {
      ...
      if ((DAT_02f7c538 == 0) && (g_ActiveButton == (CEdButton *)0x0)) {
        ...
        *(CDemonActor **)(this_ptr->unk2 + 0x20) = pCVar5;
        if (pCVar5 != (CDemonActor *)0x0) {
          ...
          core_actor_cpp_CDemonActor_renderBoundingBox_FUN_0040d940
                    (*(CDemonActor **)(this_ptr->unk2 + 0x20),CONCAT31(extraout_var_01,uVar1));
        }
      }
      else {
        this_ptr->unk2[0x20] = '\0';
      ...
      if (*(int *)(this_ptr->unk2 + 0x1c) != 0) {
        uVar1 = shape_edittool_cpp_CEditorTools_getTimeCycledColorByte_FUN_004a1330
                          (g_CEditorToolsPtr);
        core_actor_cpp_CDemonActor_renderBoundingBox_FUN_0040d940
                  (*(CDemonActor **)(this_ptr->unk2 + 0x1c),CONCAT31(extraout_var,uVar1));
        pfVar3 = (float *)(**(code **)(*(int *)(*(int *)(this_ptr->unk2 + 0x1c) + 0x154) + 0x14))();
        ...
        param5 = (void *)(*(int *)(this_ptr->unk2 + 0x1c) + 0x30);
        label_offset = (CQuaternion4f *)(*(int *)(this_ptr->unk2 + 0x1c) + 0x20);
        uVar1 = shape_edittool_cpp_CEditorTools_getTimeCycledColorByte_FUN_004a1330
                          (g_CEditorToolsPtr);
        in_stack_fffff638 = (CKeys *)0x5396f8;
        shape_edittool_cpp_CEditorTools_draw3DAxisLabelsAt_FUN_004a1e90
                  (g_CEditorToolsPtr,(int)local_40,(CQuaternion4f *)CONCAT31(extraout_var_00,uVar1),
                   label_offset,param5);
      }
      core_dcamera_cpp_CDemonCamera_endScene_FUN_0044cb80(&g_CDemonCameraInstance,0);
      ...
      if (*(char **)(this_ptr->unk2 + 0x20) != (char *)0x0) {
        engine_2d_c_drawText_FUN_00401fd0(*(char **)(this_ptr->unk2 + 0x20),g_MouseX,g_MouseY);
      }
      ...
      if (*(int *)(this_ptr->unk2 + 0x18) != 0) {
        ...
        in_stack_fffff638 = (CKeys *)0x5398c5;
        iVar10 = core_msnedit_cpp_FUN_00536cd0
    ...
    if (DAT_02f7c634 == 0) {
      ...
      else if (*(int *)(this_ptr->unk2 + 0x1c) != 0) {
        (**(code **)(*(int *)(*(int *)(this_ptr->unk2 + 0x1c) + 0x154) + 0xd0))();
      ...
      if (iVar10 != 0) {
        iVar10 = (*g_CKeysPtr->vtable->getKeyState)(g_CKeysPtr,0x2a);
        if (iVar10 == 0) {
          core_msnedit_cpp_CDemonMission_FUN_0053ca30(this_ptr,*(int *)(this_ptr->unk2 + 0x1c));
          iVar10 = extraout_EAX_00;
        }
        else {
          core_msnedit_cpp_CDemonMission_FUN_0053ca80(this_ptr,*(int *)(this_ptr->unk2 + 0x1c));
          iVar10 = extraout_EAX;
        }
        core_msnedit_cpp_CDemonMission_FUN_0053c140(this_ptr,iVar10);
      }
      ...
      if (iVar10 != 0) {
        ...
        if (iVar10 == 0) {
          iVar10 = 0x101;
          core_script_cpp_CScript_FUN_00566660
                    (g_CScriptPtr,0,0x101,(int)in_stack_fffff668,g_WindowHeight + -1);
          DAT_02f7c634 = 1;
        }
        else {
          iVar10 = 0;
          core_script_cpp_CScript_FUN_00566660
                    (g_CScriptPtr,0,0,(int)in_stack_fffff668,g_WindowHeight + -1);
          DAT_02f7c634 = 2;
        }
LAB_00539d68:
        core_msnedit_cpp_CDemonMission_FUN_00539060(g_CDemonMissionPtr,iVar10);
        engine_2d_c_clearInputAndWait_FUN_00403260();
      }
    }
    else {
    ...
    if (iVar10 != 0) {
      ...
      if (iVar10 != 0) {
        ...
        if (this_ptr->unk2[0x38] == '\0') {
          ...
          if (iVar10 != 0) {
            core_msnedit_cpp_CDemonMission_FUN_0053d190(this_ptr,local_3b4);
          }
        }
        engine_2d_c_clearInputAndWait_FUN_00403260();
      }
...
LAB_00539e00:
    ...
    if ((DAT_02f7c634 == 0) ||
      ...
      if (iVar10 != 0) {
        core_msnedit_cpp_CDemonMission_FUN_0053b9f0(this_ptr,(CDemonMission *)in_stack_fffff698);
      }
      ...
      if (iVar10 != 0) {
        ...
        if (iVar10 == 0) {
          ...
          core_msnedit_cpp_CDemonMission_FUN_0053bc80(this_ptr,*(int *)(this_ptr->unk2 + 0x1c),0);
        }
        else {
      ...
      if (iVar10 != 0) {
        core_msnedit_cpp_CDemonMission_FUN_00537680(this_ptr);
      }
      in_stack_fffff620 = g_CKeysPtr;
      ...
      if (iVar10 != 0) {
        ...
        pCVar15 = g_CDemonSetPtr;
        if (iVar10 == 0) {
          iVar10 = *(int *)(this_ptr->unk2 + 4) + 1;
          *(int *)(this_ptr->unk2 + 4) = iVar10;
          ...
          *(int *)(this_ptr->unk2 + 4) = iVar10;
          if (iVar10 < 0) {
            *(int *)(this_ptr->unk2 + 4) = g_CDemonSetPtr->camera_count + -1;
          }
        }
        core_set_cpp_CDemonSet_setCameraView_FUN_0056ae50
                  (g_CDemonSetPtr,*(int *)(this_ptr->unk2 + 4));
        local_14 = 0;
        local_64 = 0;
      }
      ...
      if (iVar10 != 0) {
        ...
        if (iVar10 == 0) {
          if (*(int *)(this_ptr->unk2 + 0x1c) != 0) {
            *(uint *)(*(int *)(this_ptr->unk2 + 0x1c) + 0x148) = 1;
      ...
      if (iVar10 != 0) {
        ...
        if (iVar6 == 0) {
          ...
          while( true ) {
            ...
            ;
            pcVar14 = core_mission_cpp_CDemonMission_FUN_00524030(this_ptr);
            if (pcVar14 == (char *)0x0) {
              g_CurrentFilename = "..\\core\\msnedit.cpp";
...
LAB_0053a88c:
      ...
      if (iVar10 != 0) {
        core_msnedit_cpp_CDemonMission_FUN_00539060
                  (this_ptr,(uint)(*(int *)(this_ptr->unk2 + 0x18) == 0));
      }
    ...
    if (-1 < local_14) {
      ...
      case 0:
        if (local_64 != 0) {
          core_setdir_cpp_CDemonSet_evaluateVirtualDirector_FUN_005751d0
                    (g_CDemonSetPtr,*(CDemonActor **)(this_ptr->unk2 + 0x1c),2);
        }
        in_stack_fffff698 = (CDemonSet *)this_ptr;
        core_msnedit_cpp_CDemonMission_FUN_00539060(this_ptr,*(int *)(this_ptr->unk2 + 0x18));
        break;
      case 1:
      case 2:
      case 3:
    ...
    if (((((g_MouseButtonFlags & 1) == 0) && ((local_30 & 1) != 0)) && (DAT_02f7c538 == 0)) &&
      ...
      if ((*(int *)(this_ptr->unk2 + 0x1c) == 0) || (DAT_02f7c528 < 0)) {
        if (*(int *)(this_ptr->unk2 + 0x20) != 0) {
          in_stack_fffff698 = (CDemonSet *)g_CKeysPtr;
          iVar10 = (*g_CKeysPtr->vtable->getKeyState)(g_CKeysPtr,0x38);
          if (iVar10 == 0) {
            if (*(int *)(this_ptr->unk2 + 0x20) == *(int *)(this_ptr->unk2 + 0x1c)) {
              ...
              core_msnedit_cpp_CDemonMission_FUN_0053c140(this_ptr,*(int *)(this_ptr->unk2 + 0x20));
              DAT_00680818 = 0.0;
            }
          }
          else {
            if (DAT_02f7c634 != 0) {
              core_script_cpp_CScript_FUN_00565f70(g_CScriptPtr,*(char **)(this_ptr->unk2 + 0x20));
            }
LAB_0053aea7:
            DAT_00680818 = 0.0;
          }
        ...
        if (iVar10 == 0) {
          ...
          core_msnedit_cpp_CDemonMission_FUN_0053af50(this_ptr,(char *)(&DAT_02f7a02c + iVar6));
LAB_0053ad72:
          DAT_00680818 = 1e+10;
        }
      }
