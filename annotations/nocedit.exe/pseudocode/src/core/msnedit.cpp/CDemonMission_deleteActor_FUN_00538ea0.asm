...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_msnedit_cpp_CDemonMission_deleteActor_FUN_00538ea0(CDemonMission *this_ptr,int param_2)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00538ea0
        ;   Label: core_msnedit.cpp_CDemonMission_deleteActor_FUN_00538ea0
    PUSH ESI                            ; 00538ea1
    PUSH EDI                            ; 00538ea2
