...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_msnedit_cpp_CDemonMission_FUN_00538f90(CDemonMission *this_ptr,char *param_2,int param_3)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00538f90
        ;   Label: core_msnedit.cpp_CDemonMission_FUN_00538f90
    PUSH ESI                            ; 00538f91
    PUSH EDI                            ; 00538f92
    PUSH EBP                            ; 00538f93
