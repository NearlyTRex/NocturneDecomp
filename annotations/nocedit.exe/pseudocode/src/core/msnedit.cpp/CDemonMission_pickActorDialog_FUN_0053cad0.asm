...
; CDemonActor *    Stack[0x8]:4   class_type
; char *           Stack[0xc]:4   title
; CDemonActor * *  Stack[0x10]:4   out_actor
; int              Stack[0x14]:4   allow_none
; char *           Stack[0x18]:4   class_name
...
section .text
    ...
    PUSH EBX                            ; 0053cad0
        ;   Label: core_msnedit.cpp_CDemonMission_pickActorDialog_FUN_0053cad0
    PUSH ESI                            ; 0053cad1
    PUSH EDI                            ; 0053cad2
    PUSH EBP                            ; 0053cad3
    ...
    PUSH ECX                            ; 0053cb2b
    CALL core_msnedit.cpp_CDemonMission_buildFilteredActorList_FUN_0053cc30 ; 0053cb2c
    ...
    PUSH EBX                            ; 0053cb76
    CALL core_mission.cpp_CDemonMission_findActorByName_FUN_00524030 ; 0053cb77
    ...
    PUSH EAX                            ; 0053cbf3
    CALL crt_string.c__stricmp_FUN_005fe7f0 ; 0053cbf4
