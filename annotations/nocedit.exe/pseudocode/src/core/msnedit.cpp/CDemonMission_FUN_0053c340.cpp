...

{
  ...
  if ((((*(int *)(this_ptr->unk2 + 8) < param_2) && (*(int *)(this_ptr->unk2 + 0xc) < param_3)) &&
      (param_2 < *(int *)(this_ptr->unk2 + 0x10) + -1)) &&
     (param_3 < *(int *)(this_ptr->unk2 + 0x14) + -1)) {
    ...
    for (; actor_ptr != (CDemonActor *)0x0; actor_ptr = actor_ptr->next_actor) {
      if (((*(int *)this_ptr->unk1 == (actor_ptr->location).area_id) && (actor_ptr->unk14 == 0)) &&
