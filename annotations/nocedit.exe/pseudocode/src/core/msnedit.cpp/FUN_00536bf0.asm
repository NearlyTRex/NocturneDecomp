...
section .text
    ...
    TEST AH,AH                          ; 00536c09
    JZ 0x00536c7b                       ; 00536c0b | LAB_00536c7b
    ...
    TEST byte ptr [EDX + 0x6849c4],0xe0 ; 00536c1f | char[256] g_CharacterClassificationTable
    JZ 0x00536c85                       ; 00536c26 | LAB_00536c85
    ...
    INC EBX                             ; 00536c46
    MOV CH,byte ptr [ESI + 0x6849c4]    ; 00536c47 | char[256] g_CharacterClassificationTable
    INC EDX                             ; 00536c4d
    TEST CH,0xe0                        ; 00536c4e
    JNZ 0x00536c2a                      ; 00536c51 | LAB_00536c2a
        ;   XREF to: 00536c2a (CONDITIONAL_JUMP)
    CMP EAX,0x2d                        ; 00536c53
    JZ 0x00536c2a                       ; 00536c56 | LAB_00536c2a
        ;   XREF to: 00536c2a (CONDITIONAL_JUMP)
    CMP EAX,0x5f                        ; 00536c58
    JZ 0x00536c2a                       ; 00536c5b | LAB_00536c2a
        ;   XREF to: 00536c2a (CONDITIONAL_JUMP)
    PUSH 0x63b6e0                       ; 00536c5d | = "none" | s_none_0063b6e0 = none
    LEA EAX,[ESP + 0x4]                 ; 00536c62
    PUSH EAX                            ; 00536c66
    MOV byte ptr [EDX],0x0              ; 00536c67
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 00536c6a | int crt_string.c_stricmp_FUN_005fe7f0(char * str1, char * str2)
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00536c6f
    TEST EAX,EAX                        ; 00536c72
    JNZ 0x00536c92                      ; 00536c74 | LAB_00536c92
        ;   XREF to: 00536c92 (CONDITIONAL_JUMP)
    CMP byte ptr [EBX],0x0              ; 00536c76
        ;   Label: LAB_00536c76
    JNZ 0x00536c11                      ; 00536c79 | LAB_00536c11
    ...
    CMP EAX,0x2d                        ; 00536c85
        ;   Label: LAB_00536c85
    JZ 0x00536c28                       ; 00536c88 | LAB_00536c28
        ;   XREF to: 00536c28 (CONDITIONAL_JUMP)
    CMP EAX,0x5f                        ; 00536c8a
    JZ 0x00536c28                       ; 00536c8d | LAB_00536c28
        ;   XREF to: 00536c28 (CONDITIONAL_JUMP)
    INC EBX                             ; 00536c8f
    JMP 0x00536c76                      ; 00536c90 | LAB_00536c76
        ;   XREF to: 00536c76 (UNCONDITIONAL_JUMP)
    PUSH 0x63b6e5                       ; 00536c92 | = "true" | s_true_0063b6e5 = true
        ;   Label: LAB_00536c92
    LEA EAX,[ESP + 0x4]                 ; 00536c97
    PUSH EAX                            ; 00536c9b
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 00536c9c | int crt_string.c_stricmp_FUN_005fe7f0(char * str1, char * str2)
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00536ca1
    TEST EAX,EAX                        ; 00536ca4
    JZ 0x00536c76                       ; 00536ca6 | LAB_00536c76
        ;   XREF to: 00536c76 (CONDITIONAL_JUMP)
    MOV EAX,ESP                         ; 00536ca8
    PUSH EAX                            ; 00536caa
    PUSH EDI                            ; 00536cab
    CALL shape_edittool.cpp_CStrList_add_FUN_004a2b80 ; 00536cac | void shape_edittool.cpp_CStrList_add_FUN_004a2b80(CStrList * this_ptr, char * string_data)
        ;   XREF to: 004a2b80 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00536cb1
    CMP byte ptr [EBX],0x0              ; 00536cb4
    JNZ 0x00536c11                      ; 00536cb7 | LAB_00536c11
        ;   XREF to: 00536c11 (CONDITIONAL_JUMP)
