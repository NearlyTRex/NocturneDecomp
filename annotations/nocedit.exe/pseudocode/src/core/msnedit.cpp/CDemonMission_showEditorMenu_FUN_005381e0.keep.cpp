      ...
      if (uVar2 < 0x34) {
        if (uVar2 < 0x32) {
          ...
          if (this_ptr->mission_name[0] == '\0') {
            ...
            iVar3 = shape_edittool_cpp_CEditorTools_showYesNoDialog_FUN_0049f060
