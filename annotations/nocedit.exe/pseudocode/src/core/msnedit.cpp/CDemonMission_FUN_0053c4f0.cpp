...

{
  ...
  if (this_ptr->show_3d_viewport != 0) {
    ...
    core_actor_cpp_CActorPropertyList_calculateLayout_FUN_0040e770
              ((CActorPropertyList *)&DAT_02f7a024,0x141,0,width);
    ...
    core_actor_cpp_CActorPropertyList_calculateLayout_FUN_0040e770
              ((CActorPropertyList *)&DAT_02f7a024,0x141,-DAT_02f797e4.scroll_position,width);
    if ((((g_ActiveButton == (CEdButton *)0x0) && (0x140 < g_MouseX)) && (g_MouseX <= width)) &&
    ...
    engine_2d_c_drawVLine_FUN_00402ff0(0x140,0,0xf0);
    engine_2d_c_drawHLine_FUN_00402ee0(0x140,0xf0,iVar1 + -1);
