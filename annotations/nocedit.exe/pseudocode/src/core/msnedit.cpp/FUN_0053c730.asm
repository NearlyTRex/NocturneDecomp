...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_msnedit.cpp_FUN_0053c730()
;
; Local Variables:
; undefined1       Stack[-0x6c]:1  local_6c
;
; XREF[1]:
;   core_msnedit.cpp_PrepareMissionMaybe_FUN_005390f0 at 0053a971
;
; Referenced Globals:
...
section .text
    ...
    CALL core_actor.cpp_FUN_0040e150    ; 0053c744 | void core_actor.cpp_FUN_0040e150()
        ;   XREF to: 0040e150 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [EBX + 0x28]      ; 0053c749
    ADD ESP,0x4                         ; 0053c74c
    TEST EDX,EDX                        ; 0053c74f
    JZ 0x0053c8bf                       ; 0053c751 | LAB_0053c8bf
        ;   XREF to: 0053c8bf (CONDITIONAL_JUMP)
    PUSH EDI                            ; 0053c757
    PUSH ESI                            ; 0053c758
    MOV ECX,0x19                        ; 0053c759
    LEA EDI,[ESP + 0x4dc]               ; 0053c75e
    MOV ESI,0x680908                    ; 0053c765 | undefined4 DAT_00680908
    MOVSD.REP ES:EDI,ESI                ; 0053c76a | undefined4 DAT_00680908 | DAT_0068090c = 0x0
    MOV EBP,0x2f79820                   ; 0053c76c | DAT_02f79820
    PUSH 0x2f7a024                      ; 0053c771 | DAT_02f7a024
        ;   Label: LAB_0053c771
    CALL core_actor.cpp_FUN_0040e150    ; 0053c776 | void core_actor.cpp_FUN_0040e150()
        ;   XREF to: 0040e150 (UNCONDITIONAL_CALL)
    ...
    CALL shape_edittool.cpp_CPickList_ctor_FUN_004a3b90 ; 0053c79d | CPickList * shape_edittool.cpp_CPickList_ctor_FUN_004a3b90(CPickList * this_ptr)
        ;   XREF to: 004a3b90 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [0x02f7a028]      ; 0053c7a2 | DAT_02f7a028
    ADD ESP,0x4                         ; 0053c7a8
    TEST ECX,ECX                        ; 0053c7ab
    JLE 0x0053c807                      ; 0053c7ad | LAB_0053c807
    ...
    PUSH EAX                            ; 0053c7c7 | DAT_02f7a02c
    CALL core_actor.cpp_CActorProperty_FUN_0040ea50 ; 0053c7c8 | undefined core_actor.cpp_CActorProperty_FUN_0040ea50()
        ;   XREF to: 0040ea50 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0053c7cd
    PUSH EBP                            ; 0053c7d0 | DAT_02f79820
    PUSH EDI                            ; 0053c7d1 | DAT_02f7a030
    PUSH 0x63c881                       ; 0053c7d2 | = "%s\t%s" | s_s_s_0063c881 = %s	%s
    PUSH 0x2f79c20                      ; 0053c7d7 | DAT_02f79c20
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0053c7dc | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    CALL shape_edittool.cpp_CStrList_add_FUN_004a2b80 ; 0053c7f5 | void shape_edittool.cpp_CStrList_add_FUN_004a2b80(CStrList * this_ptr, char * string_data)
        ;   XREF to: 004a2b80 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [0x02f7a028]      ; 0053c7fa | DAT_02f7a028
    ADD ESP,0x8                         ; 0053c800
    CMP ESI,EDX                         ; 0053c803
    JL 0x0053c7b7                       ; 0053c805 | LAB_0053c7b7
        ;   XREF to: 0053c7b7 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [EBX + 0x28]      ; 0053c807
        ;   Label: LAB_0053c807
    PUSH ECX                            ; 0053c80a
    PUSH 0x63c887                       ; 0053c80b | = "Edit %s properties" | s_Edit_s_properties_0063c887 = Edit %s properties
    LEA EAX,[ESP + 0x3b8]               ; 0053c810
    PUSH EAX                            ; 0053c817
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0053c818 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0053c82e
    CALL shape_edittool.cpp_CStrList_findByFirstField_FUN_004a3070 ; 0053c82f | int shape_edittool.cpp_CStrList_findByFirstField_FUN_004a3070(CStrList * this_ptr, char * search_field)
    ...
    PUSH EAX                            ; 0053c844
    CALL shape_edittool.cpp_CPickList_displayChoicesAndWaitForInput_FUN_004a3e20 ; 0053c845 | int shape_edittool.cpp_CPickList_displayChoicesAndWaitForInput_FUN_004a3e20(CPickList * this_ptr, char * dialog_title, int config_param1, int config_param2)
        ;   XREF to: 004a3e20 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0053c84a
    TEST EAX,EAX                        ; 0053c84d
    JL 0x0053c8ae                       ; 0053c84f | LAB_0053c8ae
    ...
    PUSH EDI                            ; 0053c868
    MOV AL,byte ptr [ESI]               ; 0053c869 | DAT_02f7a030
        ;   Label: LAB_0053c869
    MOV byte ptr [EDI],AL               ; 0053c86b
    CMP AL,0x0                          ; 0053c86d
    JZ 0x0053c881                       ; 0053c86f | LAB_0053c881
        ;   XREF to: 0053c881 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 0053c871 | DAT_02f7a031
    ADD ESI,0x2                         ; 0053c874
    MOV byte ptr [EDI + 0x1],AL         ; 0053c877
    ADD EDI,0x2                         ; 0053c87a
    CMP AL,0x0                          ; 0053c87d
    JNZ 0x0053c869                      ; 0053c87f | LAB_0053c869
        ;   XREF to: 0053c869 (CONDITIONAL_JUMP)
    POP EDI                             ; 0053c881
        ;   Label: LAB_0053c881
    CMP dword ptr [ECX + 0x2f7a080],0x0 ; 0053c882 | DAT_02f7a080
    JNZ 0x0053c89f                      ; 0053c889 | LAB_0053c89f
        ;   XREF to: 0053c89f (CONDITIONAL_JUMP)
    PUSH 0x0                            ; 0053c88b
        ;   Label: LAB_0053c88b
    LEA EAX,[ESP + 0xc]                 ; 0053c88d
    PUSH EAX                            ; 0053c891
    CALL shape_edittool.cpp_CPickList_dtor_FUN_004a3c80 ; 0053c892 | CPickList * shape_edittool.cpp_CPickList_dtor_FUN_004a3c80(CPickList * this_ptr, uint d1, uint d2, uint d3, ...)
        ;   XREF to: 004a3c80 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0053c897
    JMP 0x0053c771                      ; 0053c89a | LAB_0053c771
        ;   XREF to: 0053c771 (UNCONDITIONAL_JUMP)
    MOV EDI,dword ptr [EBX + 0x28]      ; 0053c89f
        ;   Label: LAB_0053c89f
    PUSH EDI                            ; 0053c8a2
    PUSH EDX                            ; 0053c8a3
    CALL core_actor.cpp_CActorProperty_editInteractive_FUN_0040eed0 ; 0053c8a4 | int core_actor.cpp_CActorProperty_editInteractive_FUN_0040eed0(CActorProperty * this_ptr, CDemonActor * actor)
        ;   XREF to: 0040eed0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0053c8a9
    JMP 0x0053c88b                      ; 0053c8ac | LAB_0053c88b
        ;   XREF to: 0053c88b (UNCONDITIONAL_JUMP)
    PUSH 0x0                            ; 0053c8ae
        ;   Label: LAB_0053c8ae
    LEA EAX,[ESP + 0xc]                 ; 0053c8b0
    PUSH EAX                            ; 0053c8b4
    CALL shape_edittool.cpp_CPickList_dtor_FUN_004a3c80 ; 0053c8b5 | CPickList * shape_edittool.cpp_CPickList_dtor_FUN_004a3c80(CPickList * this_ptr, uint d1, uint d2, uint d3, ...)
        ;   XREF to: 004a3c80 (UNCONDITIONAL_CALL)
