...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_msnedit_cpp_CDemonMission_FUN_0053c970 (CDemonMission *this_ptr,int param_2,int param_3,int param_4)
;
; Parameters:
...
;
; XREF[2]:
;   core_msnedit.cpp_CDemonMission_FUN_0053c930 at 0053c961
...
section .text
    ...
    PUSH EBX                            ; 0053c970
        ;   Label: core_msnedit.cpp_CDemonMission_FUN_0053c970
    PUSH ESI                            ; 0053c971
