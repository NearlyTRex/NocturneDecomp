...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_msnedit_cpp_CDemonMission_FUN_0053ca30(CDemonMission *this_ptr,int param_2)
;
; Parameters:
...
;
; XREF[1]:
;   core_msnedit.cpp_CDemonMission_editActorsInSet_FUN_005390f0 at 0053a48b
;
; *****************************************************************************
...
section .text
    ...
    PUSH ESI                            ; 0053ca30
        ;   Label: core_msnedit.cpp_CDemonMission_FUN_0053ca30
