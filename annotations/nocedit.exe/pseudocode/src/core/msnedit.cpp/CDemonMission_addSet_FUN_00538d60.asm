...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_msnedit_cpp_CDemonMission_addSet_FUN_00538d60(CDemonMission *this_ptr,char *param_2)
;
; Parameters:
...
;
; Called Functions:
;   core_msnedit.cpp_CDemonMission_findSetByName_FUN_00538f40
...
section .text
    ...
    PUSH EBX                            ; 00538d60
        ;   Label: core_msnedit.cpp_CDemonMission_addSet_FUN_00538d60
    PUSH ESI                            ; 00538d61
    MOV EBX,dword ptr [ESP + 0xc]       ; 00538d62
    MOV ESI,dword ptr [ESP + 0x10]      ; 00538d66
    PUSH ESI                            ; 00538d6a
    PUSH EBX                            ; 00538d6b
    CALL core_msnedit.cpp_CDemonMission_findSetByName_FUN_00538f40 ; 00538d6c
        ;   XREF to: 00538f40 (UNCONDITIONAL_CALL)  ; int core_msnedit.cpp_CDemonMission_findSetByName_FUN_00538f40(CDemonMission * this_ptr, char * set_name)
