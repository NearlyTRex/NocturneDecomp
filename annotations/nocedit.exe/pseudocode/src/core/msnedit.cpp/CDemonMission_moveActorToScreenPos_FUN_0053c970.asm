...
;   core_msnedit.cpp_CDemonMission_moveActorToViewportCenter_FUN_0053c930 at 0053c961
;
; Referenced Globals:
;   int INT_02f7c53c
...
section .text
    ...
    PUSH EBX                            ; 0053c970
        ;   Label: core_msnedit.cpp_CDemonMission_moveActorToScreenPos_FUN_0053c970
    PUSH ESI                            ; 0053c971
    ...
    MOV ECX,dword ptr [0x02f7c53c]      ; 0053c988 | INT_02f7c53c
    ...
    PUSH EAX                            ; 0053c9c7
    CALL core_msnedit.cpp_screenToWorldPosition_FUN_00535c60 ; 0053c9c8
