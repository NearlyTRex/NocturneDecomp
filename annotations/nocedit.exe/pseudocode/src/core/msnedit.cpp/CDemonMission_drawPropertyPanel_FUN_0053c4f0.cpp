...

{
  ...
  if ((DAT_02f79818 & 1) == 0) {
    ...
    shape_edittool_cpp_CEdScrollBar_ctor_FUN_004a5ae0(&CEdScrollBar_02f797e4);
  ...
  if (this_ptr->show_3d_viewport != 0) {
    ...
    shape_edittool_cpp_CEdScrollBar_setPosition_FUN_004a5b60
              (&CEdScrollBar_02f797e4,iVar1 + -0xb,1,iVar1 + -1,0xee);
    CEdScrollBar_02f797e4.max_value = 0xf0;
    CEdScrollBar_02f797e4.current_value = g_MsnEditPropertyList.total_height;
    CEdScrollBar_02f797e4.scroll_increment =
         g_MsnEditPropertyList.total_height / g_MsnEditPropertyList.count;
    shape_edittool_cpp_CEdScrollBar_handleInput_FUN_004a5fc0(&CEdScrollBar_02f797e4);
    core_actor_cpp_CActorPropertyList_calculateLayout_FUN_0040e770
              (&g_MsnEditPropertyList,0x141,-CEdScrollBar_02f797e4.scroll_position,iVar2);
    ...
    shape_edittool_cpp_CEdScrollBar_render_FUN_004a5c10(&CEdScrollBar_02f797e4);
    iVar2 = iStack_10 + -1;
  ...
  shape_edittool_cpp_CEdScrollBar_clearActiveButtonIfMatch_FUN_004a5b40(&CEdScrollBar_02f797e4);
  core_msnedit_cpp_drawMotionBar_FUN_00536e20();
  return;
}
