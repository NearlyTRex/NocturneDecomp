        ...
        if (iVar3 == 0) {
          ...
          if (-1 < iVar3) {
            ...
            for (pCVar1 = this_ptr->first_actor; pCVar1 != (CDemonActor *)0x0;
              ...
              if (((actor_ptr != (CEnemy *)0x0) &&
                 ...
                 && (iVar3 = shape_edittool_cpp_wildcardStringMatch_FUN_004a6e20
                                       (g_ActorWildcardBuffer,(actor_ptr->base).base.actor_name,0),
                    iVar3 != 0)) {
                ...
                _sprintf(local_208 + 4,"%s\n%7.3f",(actor_ptr->base).base.actor_name,
                         (double)actor_ptr->speed);
                shape_edittool_cpp_CStrList_add_FUN_004a2b80(&local_d00.base,local_208 + 4);
              }
            }
            if (local_d00.base.item_count < 1) {
              ...
              _sprintf(local_e0 + 4,"%d enemy speeds randomized",local_d00.base.item_count);
              shape_edittool_cpp_CPickList_displayChoicesAndWaitForInput_FUN_004a3e20
