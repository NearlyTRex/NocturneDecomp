// Name: core_msnedit.cpp_CDemonMission_FUN_0053b510
// Address: 0053b510
// Address Range: [[0053b510, 0053b9e7]]
// Convention: __cdecl
// Signature: void __cdecl core_msnedit_cpp_CDemonMission_FUN_0053b510(CDemonMission *this_ptr,int param_2)
    ...
    if (pCVar3 == (CDemonActor *)0x0) {
      if (local_6ac.base.item_count < 1) {
        ...
        if (-1 < (int)pcVar9) {
          ...
          pcVar9 = core_mission_cpp_CDemonMission_FUN_00524030(this_ptr);
