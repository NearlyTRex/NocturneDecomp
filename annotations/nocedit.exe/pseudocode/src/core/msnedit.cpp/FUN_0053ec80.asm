...
;                               FUNCTION
; *****************************************************************************
; unknown void core_msnedit_cpp_FUN_0053ec80(void)
;
; Local Variables:
...
section .text
    ...
    MOV EAX,ESP                         ; 0053ecea
        ;   Label: LAB_0053ecea
    PUSH EAX                            ; 0053ecec
    CALL core_actor.cpp_FUN_0040e130    ; 0053eced
    ...
    PUSH EDI                            ; 0053ed23
    PUSH EBX                            ; 0053ed24
    CALL core_actor.cpp_CActorProperty_FUN_0040ea50 ; 0053ed25
    ...
    CALL core_script.cpp_FUN_00567bc0   ; 0053edb1
        ;   XREF to: 00567bc0 (UNCONDITIONAL_CALL)  ; undefined core_script.cpp_FUN_00567bc0()
