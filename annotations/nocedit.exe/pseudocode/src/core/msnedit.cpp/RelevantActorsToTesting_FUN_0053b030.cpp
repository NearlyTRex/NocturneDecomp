...
// Convention: unknown
// Signature: void core_msnedit_cpp_RelevantActorsToTesting_FUN_0053b030(void)

#include "nocturne.h"

/* Signature: byte core_msnedit.cpp_RelevantActorsToTesting(uint param_1, uint
   param_2) */
    ...
    if (0 < CStack_30.item_count) {
      do {
        ...
        if (0 < (int)in_stack_ffffd45c) {
          ...
          do {
            if (*(int *)(auStack_2b9c + iVar4 * 0xec + -4) == 0xc) {
