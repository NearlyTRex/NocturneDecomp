...
;
; XREF[1]:
;   core_msnedit.cpp_PrepareMissionMaybe_FUN_005390f0 at 0053a3e1
;
; Referenced Globals:
...
section .text
    ...
    PUSH EAX                            ; 0053c39f
    PUSH 0x32758e4                      ; 0053c3a0 | CDemonCamera g_CDemonCameraInstance
    CALL core_dcamera.cpp_CDemonCamera_screenToWorldDirection_FUN_0044d480 ; 0053c3a5 | CVector3f * core_dcamera.cpp_CDemonCamera_screenToWorldDirection_FUN_0044d480(CDemonCamera * this_ptr, CVector3f * output_ptr, int screen_x, int screen_y)
    ...
    FADDP                               ; 0053c3c1
    FSQRT                               ; 0053c3c3
    FDIVR double ptr [0x0063c86c]       ; 0053c3c5 | double DOUBLE_0063c86c
    ...
    CMP dword ptr [EBX + 0x148],0x0     ; 0053c426
        ;   Label: LAB_0053c426
    JNZ 0x0053c413                      ; 0053c42d | LAB_0053c413
        ;   XREF to: 0053c413 (CONDITIONAL_JUMP)
    CMP dword ptr [0x02f7a020],0x0      ; 0053c42f | int g_DisableMouseHitOnBarrier
    JZ 0x0053c44a                       ; 0053c436 | LAB_0053c44a
        ;   XREF to: 0053c44a (CONDITIONAL_JUMP)
    PUSH 0x63c862                       ; 0053c438 | = "CBarrier" | s_CBarrier_0063c862 = CBarrier
    PUSH EBX                            ; 0053c43d
    CALL core_actor.cpp_isOfClass_FUN_0040c6d0 ; 0053c43e | int core_actor.cpp_isOfClass_FUN_0040c6d0(CDemonActor * actor_ptr, char * class_name)
        ;   XREF to: 0040c6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0053c443
    TEST EAX,EAX                        ; 0053c446
    JNZ 0x0053c413                      ; 0053c448 | LAB_0053c413
        ;   XREF to: 0053c413 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 0053c465
    PUSH EBX                            ; 0053c466
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10 ; 0053c467 | CVector3f * core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10(CDemonActor * this_ptr, CVector3f * output_local_point, CVector3f * input_world_point)
    ...
    PUSH EAX                            ; 0053c478
    PUSH EBX                            ; 0053c479
    CALL core_actor.cpp_CDemonActor_inverseTransformVector_FUN_00408ea0 ; 0053c47a | CVector3f * core_actor.cpp_CDemonActor_inverseTransformVector_FUN_00408ea0(CDemonActor * this_ptr, CVector3f * output_vector, CVector3f * input_vector)
    ...
    PUSH EAX                            ; 0053c492
    CALL core_box.cpp_CBoundingBox3D_doesRayIntersect_FUN_00420940 ; 0053c493 | float core_box.cpp_CBoundingBox3D_doesRayIntersect_FUN_00420940(CBoundingBox3D * this_ptr, CVector3f * ray_origin, CVector3f * ray_direction, CVector3f * out_normal)
