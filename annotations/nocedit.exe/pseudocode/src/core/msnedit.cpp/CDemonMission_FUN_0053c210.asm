...
;                               FUNCTION
; *****************************************************************************
; __cdecl char * __cdecl core_msnedit_cpp_CDemonMission_FUN_0053c210(CDemonMission *this_ptr,char *param_2,char *param_3)
;
; Parameters:
...
;
; XREF[1]:
;   core_msnedit.cpp_CDemonMission_FUN_005390f0 at 0053a904
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0053c210
        ;   Label: core_msnedit.cpp_CDemonMission_FUN_0053c210
    PUSH ESI                            ; 0053c211
    PUSH EDI                            ; 0053c212
    ...
    MOV EDX,dword ptr [ESI + EAX*0x1 + 0x14d158] ; 0053c24a | g_CDemonSetInstance.actor_list_data[0] | DAT_032613d4
    PUSH EDX                            ; 0053c251
    ...
    PUSH ESI                            ; 0053c2f4
    CALL core_mission.cpp_CDemonMission_FUN_00524030 ; 0053c2f5
