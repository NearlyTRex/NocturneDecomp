  ...
  do {
    ...
    if (DAT_02f7c634 == 0) {
      if (DAT_02f7c53c == 4) {
        ...
        if (local_7c < (float)_DAT_0063c5ac) {
          local_7c = -1.5707964;
        }
        if ((float)_DAT_0063c594 < local_7c) {
          local_7c = 1.5707964;
        }
        if (local_78 < (float)_DAT_0063c5ac) {
          local_78 = local_78 + _DAT_0063c5b4;
        }
        if ((float)_DAT_0063c594 < local_78) {
          local_78 = local_78 + _DAT_0063c5b8;
        }
