...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_msnedit_cpp_CDemonMission_FUN_0053df90(CDemonMission *this_ptr)
;
; Parameters:
...
;   core_msnedit.cpp_CDemonMission_FUN_0053bc80
...
section .text
    ...
    PUSH EBX                            ; 0053df90
        ;   Label: core_msnedit.cpp_CDemonMission_FUN_0053df90
    PUSH ESI                            ; 0053df91
    PUSH EDI                            ; 0053df92
    PUSH EBP                            ; 0053df93
    ...
    PUSH EDI                            ; 0053e0a3
    PUSH EBX                            ; 0053e0a4
    CALL core_msnedit.cpp_CDemonMission_FUN_0053bc80 ; 0053e0a5
    ...
    PUSH EBX                            ; 0053e149
    INC EBP                             ; 0053e14a
    CALL core_msnedit.cpp_CDemonMission_FUN_0053bc80 ; 0053e14b
        ;   XREF to: 0053bc80 (UNCONDITIONAL_CALL)  ; void core_msnedit.cpp_CDemonMission_FUN_0053bc80(CDemonMission * this_ptr, int param_2, int param_3)
    ...
    PUSH EBX                            ; 0053e1d6
    INC EBP                             ; 0053e1d7
    CALL core_msnedit.cpp_CDemonMission_FUN_0053bc80 ; 0053e1d8
        ;   XREF to: 0053bc80 (UNCONDITIONAL_CALL)  ; void core_msnedit.cpp_CDemonMission_FUN_0053bc80(CDemonMission * this_ptr, int param_2, int param_3)
