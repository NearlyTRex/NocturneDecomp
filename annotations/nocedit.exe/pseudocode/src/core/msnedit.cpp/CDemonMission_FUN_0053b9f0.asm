...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_msnedit_cpp_CDemonMission_FUN_0053b9f0(CDemonMission *this_ptr,CDemonMission *param_2)
;
; Parameters:
; CDemonMission *  Stack[0x4]:4   this_ptr
; CDemonMission *  Stack[0x8]:4   param_2
; Local Variables:
...
;
; XREF[1]:
;   core_msnedit.cpp_CDemonMission_FUN_005390f0 at 0053a6b3
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0053b9f0
        ;   Label: core_msnedit.cpp_CDemonMission_FUN_0053b9f0
    PUSH ESI                            ; 0053b9f1
    PUSH EDI                            ; 0053b9f2
    PUSH EBP                            ; 0053b9f3
