...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_msnedit_cpp_CDemonMission_FUN_0053bc80(CDemonMission *this_ptr,int param_2,int param_3)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0053bc80
        ;   Label: core_msnedit.cpp_CDemonMission_FUN_0053bc80
    PUSH ESI                            ; 0053bc81
    ...
    PUSH EBX                            ; 0053bc9a
    CALL core_msnedit.cpp_CDemonMission_FUN_0053bcf0 ; 0053bc9b
