...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_msnedit_cpp_CDemonMission_FUN_0053b030(CDemonMission *this_ptr,int param_2)
;
; Parameters:
...
;
; XREF[1]:
;   core_msnedit.cpp_CDemonMission_FUN_0053af50 at 0053afc4
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0053b030
        ;   Label: core_msnedit.cpp_CDemonMission_FUN_0053b030
    PUSH ESI                            ; 0053b031
    PUSH EDI                            ; 0053b032
    PUSH EBP                            ; 0053b033
    ...
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 0053b0ca
    ...
    MOV EDX,dword ptr [ESP + 0x2bb4]    ; 0053b0df
        ;   Label: LAB_0053b0df
    PUSH EDX                            ; 0053b0e6
    CALL core_mission.cpp_CDemonMission_FUN_00523cc0 ; 0053b0e7
    ...
    MOV EAX,ESP                         ; 0053b11b
        ;   Label: LAB_0053b11b
    PUSH EAX                            ; 0053b11d
    CALL core_actor.cpp_FUN_0040e130    ; 0053b11e
    ...
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 0053b182
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)  ; int crt_string.c_stricmp_FUN_005fe7f0(char * str1, char * str2)
    ...
    PUSH EDI                            ; 0053b2e5
    CALL core_mission.cpp_CDemonMission_FUN_00524030 ; 0053b2e6
    ...
    PUSH EAX                            ; 0053b34b
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 0053b34c
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)  ; int crt_string.c_stricmp_FUN_005fe7f0(char * str1, char * str2)
    ...
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 0053b3fc
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)  ; int crt_string.c_stricmp_FUN_005fe7f0(char * str1, char * str2)
    ...
    PUSH EAX                            ; 0053b42f
    PUSH EDI                            ; 0053b430
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 0053b431
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)  ; int crt_string.c_stricmp_FUN_005fe7f0(char * str1, char * str2)
    ...
    PUSH EAX                            ; 0053b4ba
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 0053b4bb
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)  ; int crt_string.c_stricmp_FUN_005fe7f0(char * str1, char * str2)
