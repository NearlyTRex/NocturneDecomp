...
; char *           Stack[0x8]:4   orig_name
; char *           Stack[0xc]:4   new_name
;
; XREF[4]:
...
;   core_msnedit.cpp_CDemonMission_replicateActor_FUN_0053bd80 at 0053c077
;   core_msnedit.cpp_confirmNewActorName_FUN_00537410 at 00537479
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0053d220
        ;   Label: core_msnedit.cpp_CDemonMission_validateNewActorName_FUN_0053d220
    PUSH ESI                            ; 0053d221
