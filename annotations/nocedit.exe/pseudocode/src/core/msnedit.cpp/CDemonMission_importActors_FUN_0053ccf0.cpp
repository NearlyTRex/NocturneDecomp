...

{
  ...
  do {
    pCVar1 = local_10;
    iVar2 = core_mission_cpp_CDemonMission_countActors_FUN_00523cc0(local_10);
    if (iVar2 < 1) {
...
LAB_0053ce9f:
      ...
      core_mission_cpp_CDemonMission_clearMission_FUN_00522d20(pCVar1);
    ...
    if (iVar2 == 0) {
      while( true ) {
        ...
        for (pCVar5 = local_10->first_actor; pCVar5 != (CDemonActor *)0x0;
            pCVar5 = pCVar5->next_actor) {
          shape_edittool_cpp_CStrList_add_FUN_004a2b80(&local_448.base,pCVar5->actor_name);
        }
