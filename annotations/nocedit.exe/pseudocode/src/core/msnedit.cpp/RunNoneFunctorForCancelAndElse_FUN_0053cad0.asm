...
section .text
    ...
    PUSH EAX                            ; 0053caea
    CALL shape_edittool.cpp_CPickList_ctor_FUN_004a3b90 ; 0053caeb | CPickList * shape_edittool.cpp_CPickList_ctor_FUN_004a3b90(CPickList * this_ptr)
        ;   XREF to: 004a3b90 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0053caf0
    MOV EDX,dword ptr [ESP + 0x3cc]     ; 0053caf3
    MOV EDI,0xffffffff                  ; 0053cafa
    TEST EDX,EDX                        ; 0053caff
    JNZ 0x0053cba2                      ; 0053cb01 | LAB_0053cba2
    ...
    PUSH ECX                            ; 0053cb2b
    CALL core_msnedit.cpp_FUN_0053cc30  ; 0053cb2c | undefined core_msnedit.cpp_FUN_0053cc30()
        ;   XREF to: 0053cc30 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0053cb31
    TEST EBX,EBX                        ; 0053cb34
    JZ 0x0053cb40                       ; 0053cb36 | LAB_0053cb40
        ;   XREF to: 0053cb40 (CONDITIONAL_JUMP)
    TEST EDI,EDI                        ; 0053cb38
    JL 0x0053cbcc                       ; 0053cb3a | LAB_0053cbcc
    ...
    PUSH EAX                            ; 0053cb4f
    CALL shape_edittool.cpp_CPickList_displayChoicesAndWaitForInput_FUN_004a3e20 ; 0053cb50 | int shape_edittool.cpp_CPickList_displayChoicesAndWaitForInput_FUN_004a3e20(CPickList * this_ptr, char * dialog_title, int config_param1, int config_param2)
        ;   XREF to: 004a3e20 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0053cb55
    TEST EAX,EAX                        ; 0053cb58
    JL 0x0053cc14                       ; 0053cb5a | LAB_0053cc14
        ;   XREF to: 0053cc14 (CONDITIONAL_JUMP)
    PUSH EAX                            ; 0053cb60
    LEA EAX,[ESP + 0x4]                 ; 0053cb61
    PUSH EAX                            ; 0053cb65
    CALL shape_edittool.cpp_CStrList_getStringAt_FUN_004a2f70 ; 0053cb66 | char * shape_edittool.cpp_CStrList_getStringAt_FUN_004a2f70(CStrList * this_ptr, int index)
        ;   XREF to: 004a2f70 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0053cb6b
    PUSH EAX                            ; 0053cb6e
    MOV EBX,dword ptr [ESP + 0x3c0]     ; 0053cb6f
    PUSH EBX                            ; 0053cb76
    CALL core_mission.cpp_CDemonMission_FUN_00524030 ; 0053cb77 | char * core_mission.cpp_CDemonMission_FUN_00524030(CDemonMission * this_ptr)
    ...
    CALL shape_edittool.cpp_CPickList_dtor_FUN_004a3c80 ; 0053cb8d | CPickList * shape_edittool.cpp_CPickList_dtor_FUN_004a3c80(CPickList * this_ptr, uint d1, uint d2, uint d3, ...)
        ;   Label: LAB_0053cb8d
    ...
    POP EBX                             ; 0053cba0
    RET                                 ; 0053cba1
    PUSH 0x63c89a                       ; 0053cba2 | = "(none)" | s_none_0063c89a = (none)
        ;   Label: LAB_0053cba2
    LEA EAX,[ESP + 0x4]                 ; 0053cba7
    PUSH EAX                            ; 0053cbab
    CALL shape_edittool.cpp_CStrList_add_FUN_004a2b80 ; 0053cbac | void shape_edittool.cpp_CStrList_add_FUN_004a2b80(CStrList * this_ptr, char * string_data)
        ;   XREF to: 004a2b80 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0053cbb1
    TEST EBX,EBX                        ; 0053cbb4
    JZ 0x0053cb07                       ; 0053cbb6 | LAB_0053cb07
        ;   XREF to: 0053cb07 (CONDITIONAL_JUMP)
    CMP dword ptr [ESI],0x0             ; 0053cbbc
    JNZ 0x0053cb07                      ; 0053cbbf | LAB_0053cb07
        ;   XREF to: 0053cb07 (CONDITIONAL_JUMP)
    XOR EDI,EDI                         ; 0053cbc5
    JMP 0x0053cb07                      ; 0053cbc7 | LAB_0053cb07
        ;   XREF to: 0053cb07 (UNCONDITIONAL_JUMP)
    CMP dword ptr [ESI],0x0             ; 0053cbcc
        ;   Label: LAB_0053cbcc
    JZ 0x0053cb40                       ; 0053cbcf | LAB_0053cb40
        ;   XREF to: 0053cb40 (CONDITIONAL_JUMP)
    MOV EBP,dword ptr [ESP]             ; 0053cbd5
    XOR EBX,EBX                         ; 0053cbd8
    TEST EBP,EBP                        ; 0053cbda
    JLE 0x0053cb40                      ; 0053cbdc | LAB_0053cb40
        ;   XREF to: 0053cb40 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 0053cbea
    CALL shape_edittool.cpp_CStrList_getStringAt_FUN_004a2f70 ; 0053cbeb | char * shape_edittool.cpp_CStrList_getStringAt_FUN_004a2f70(CStrList * this_ptr, int index)
        ;   XREF to: 004a2f70 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0053cbf0
    PUSH EAX                            ; 0053cbf3
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 0053cbf4 | int crt_string.c_stricmp_FUN_005fe7f0(char * str1, char * str2)
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0053cbf9
    TEST EAX,EAX                        ; 0053cbfc
    JNZ 0x0053cc07                      ; 0053cbfe | LAB_0053cc07
        ;   XREF to: 0053cc07 (CONDITIONAL_JUMP)
    MOV EDI,EBX                         ; 0053cc00
    JMP 0x0053cb40                      ; 0053cc02 | LAB_0053cb40
        ;   XREF to: 0053cb40 (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP]             ; 0053cc07
        ;   Label: LAB_0053cc07
    INC EBX                             ; 0053cc0a
    CMP EBX,EAX                         ; 0053cc0b
    JL 0x0053cbe2                       ; 0053cc0d | LAB_0053cbe2
        ;   XREF to: 0053cbe2 (CONDITIONAL_JUMP)
    JMP 0x0053cb40                      ; 0053cc0f | LAB_0053cb40
        ;   XREF to: 0053cb40 (UNCONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 0053cc1b
    JMP 0x0053cb8d                      ; 0053cc1c | LAB_0053cb8d
