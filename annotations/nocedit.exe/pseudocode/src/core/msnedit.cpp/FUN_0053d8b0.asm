...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_msnedit.cpp_FUN_0053d8b0()
;
; Local Variables:
...
;
; XREF[1]:
;   core_msnedit.cpp_PrepareMissionMaybe_FUN_005390f0 at 0053a756
;
; Referenced Globals:
...
section .text
    ...
    JNZ 0x0053d8d2                      ; 0053d8c5 | LAB_0053d8d2
    ...
    CALL shape_edittool.cpp_CPickList_ctor_FUN_004a3b90 ; 0053d8dc | CPickList * shape_edittool.cpp_CPickList_ctor_FUN_004a3b90(CPickList * this_ptr)
        ;   XREF to: 004a3b90 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [0x00822044]      ; 0053d8e1 | int g_NumActorClassTypes
    ADD ESP,0x4                         ; 0053d8e7
    TEST ECX,ECX                        ; 0053d8ea
    JLE 0x0053d949                      ; 0053d8ec | LAB_0053d949
        ;   XREF to: 0053d949 (CONDITIONAL_JUMP)
    XOR EBX,EBX                         ; 0053d8ee
    MOV EAX,dword ptr [EBX + 0x822048]  ; 0053d8f0 | CDemonActorType *[200] g_ActorClassRegistrations
        ;   Label: LAB_0053d8f0
    CMP dword ptr [EAX + 0x2c],0x0      ; 0053d8f6
    JZ 0x0053d93b                       ; 0053d8fa | LAB_0053d93b
        ;   XREF to: 0053d93b (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x5030]    ; 0053d8fc
    MOV EBP,dword ptr [EAX + 0x28]      ; 0053d903
    PUSH EBP                            ; 0053d906
    CALL core_actor.cpp_CDemonActor_getActorClassName_FUN_00408b90 ; 0053d907 | char * core_actor.cpp_CDemonActor_getActorClassName_FUN_00408b90(CDemonActor * this_ptr)
        ;   XREF to: 00408b90 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0053d90c
    PUSH EAX                            ; 0053d90f
    MOV EAX,dword ptr [EBX + 0x822048]  ; 0053d910 | CDemonActorType *[200] g_ActorClassRegistrations
    PUSH EAX                            ; 0053d916
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 0053d917 | int crt_string.c_stricmp_FUN_005fe7f0(char * str1, char * str2)
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0053d91c
    TEST EAX,EAX                        ; 0053d91f
    JZ 0x0053d93b                       ; 0053d921 | LAB_0053d93b
        ;   XREF to: 0053d93b (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX + 0x822048]  ; 0053d923 | CDemonActorType *[200] g_ActorClassRegistrations
    INC EAX                             ; 0053d929
    PUSH EAX                            ; 0053d92a
    LEA EAX,[ESP + 0x4a0c]              ; 0053d92b
    PUSH EAX                            ; 0053d932
    CALL shape_edittool.cpp_CStrList_add_FUN_004a2b80 ; 0053d933 | void shape_edittool.cpp_CStrList_add_FUN_004a2b80(CStrList * this_ptr, char * string_data)
        ;   XREF to: 004a2b80 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0053d938
    MOV EDI,dword ptr [0x00822044]      ; 0053d93b | int g_NumActorClassTypes
        ;   Label: LAB_0053d93b
    INC ESI                             ; 0053d941
    ADD EBX,0x4                         ; 0053d942
    CMP ESI,EDI                         ; 0053d945
    JL 0x0053d8f0                       ; 0053d947 | LAB_0053d8f0
        ;   XREF to: 0053d8f0 (CONDITIONAL_JUMP)
    LEA EAX,[ESP + 0x4a08]              ; 0053d949
        ;   Label: LAB_0053d949
    PUSH EAX                            ; 0053d950
    CALL shape_edittool.cpp_CStrList_sort_FUN_004a2ec0 ; 0053d951 | void shape_edittool.cpp_CStrList_sort_FUN_004a2ec0(CStrList * this_ptr)
    ...
    PUSH EBP                            ; 0053d963
    CALL core_actor.cpp_CDemonActor_getActorClassName_FUN_00408b90 ; 0053d964 | char * core_actor.cpp_CDemonActor_getActorClassName_FUN_00408b90(CDemonActor * this_ptr)
        ;   XREF to: 00408b90 (UNCONDITIONAL_CALL)
    ...
    PUSH EDX                            ; 0053d977
    PUSH 0x63cd31                       ; 0053d978 | = "Change %s of type %s to new type" | s_Change_s_of_type_s_to_ne_0063cd31 = Change %s of type %s to new type
    LEA EAX,[ESP + 0x4dbc]              ; 0053d97d
    PUSH EAX                            ; 0053d984
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0053d985 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH EAX                            ; 0053d9a0
    CALL shape_edittool.cpp_CPickList_displayChoicesAndWaitForInput_FUN_004a3e20 ; 0053d9a1 | int shape_edittool.cpp_CPickList_displayChoicesAndWaitForInput_FUN_004a3e20(CPickList * this_ptr, char * dialog_title, int config_param1, int config_param2)
        ;   XREF to: 004a3e20 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0053d9a6
    TEST EAX,EAX                        ; 0053d9a9
    JL 0x0053dbf7                       ; 0053d9ab | LAB_0053dbf7
        ;   XREF to: 0053dbf7 (CONDITIONAL_JUMP)
    PUSH EAX                            ; 0053d9b1
    LEA EAX,[ESP + 0x4a0c]              ; 0053d9b2
    PUSH EAX                            ; 0053d9b9
    CALL shape_edittool.cpp_CStrList_getStringAt_FUN_004a2f70 ; 0053d9ba | char * shape_edittool.cpp_CStrList_getStringAt_FUN_004a2f70(CStrList * this_ptr, int index)
        ;   XREF to: 004a2f70 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0053d9bf
    PUSH EAX                            ; 0053d9c2
    PUSH 0x63cd52                       ; 0053d9c3 | = "C%s" | s_C_s_0063cd52 = C%s
    LEA EAX,[ESP + 0x4fac]              ; 0053d9c8
    PUSH EAX                            ; 0053d9cf
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0053d9d0 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0053d9d5
    LEA EAX,[ESP + 0x4fa4]              ; 0053d9d8
    PUSH EAX                            ; 0053d9df
    CALL core_actor.cpp_createActorByName_FUN_0040c430 ; 0053d9e0 | CDemonActor * core_actor.cpp_createActorByName_FUN_0040c430(char * class_name)
    ...
    PUSH 0x63cd56                       ; 0053d9fd | = "Attempt to transfer properties?" | s_Attempt_to_transfer_prop_0063cd56 = Attempt to transfer properties?
    MOV ECX,dword ptr [0x00678a60]      ; 0053da02 | CEditorTools g_CEditorToolsPtr | CEditorTools * g_CEditorToolsPtr
    PUSH ECX                            ; 0053da08 | CEditorTools g_CEditorToolsPtr
    CALL shape_edittool.cpp_CEditorTools_showYesNoDialog_FUN_0049f0f0 ; 0053da09 | int shape_edittool.cpp_CEditorTools_showYesNoDialog_FUN_0049f0f0(CEditorTools * this_ptr, char * format_string)
        ;   XREF to: 0049f0f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0053da0e
    TEST EAX,EAX                        ; 0053da11
    JZ 0x0053db0f                       ; 0053da13 | LAB_0053db0f
        ;   XREF to: 0053db0f (CONDITIONAL_JUMP)
    LEA EAX,[ESP + 0x2504]              ; 0053da19
    PUSH EAX                            ; 0053da20
    CALL core_actor.cpp_FUN_0040e130    ; 0053da21 | void core_actor.cpp_FUN_0040e130()
        ;   XREF to: 0040e130 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0053da26
    MOV EAX,ESP                         ; 0053da29
    PUSH EAX                            ; 0053da2b
    CALL core_actor.cpp_FUN_0040e130    ; 0053da2c | void core_actor.cpp_FUN_0040e130()
        ;   XREF to: 0040e130 (UNCONDITIONAL_CALL)
    ...
    JLE 0x0053db0f                      ; 0053da7b | LAB_0053db0f
        ;   XREF to: 0053db0f (CONDITIONAL_JUMP)
    ...
    JLE 0x0053dae1                      ; 0053daa5 | LAB_0053dae1
    ...
    JZ 0x0053dc14                       ; 0053dabe | LAB_0053dc14
    ...
    JL 0x0053dab5                       ; 0053dadf | LAB_0053dab5
    ...
    JL 0x0053da8f                       ; 0053db0d | LAB_0053da8f
    ...
    CMP AL,0x0                          ; 0053db25
    JZ 0x0053db39                       ; 0053db27 | LAB_0053db39
    ...
    CMP AL,0x0                          ; 0053db35
    JNZ 0x0053db21                      ; 0053db37 | LAB_0053db21
    ...
    JZ 0x0053db80                       ; 0053db6e | LAB_0053db80
    ...
    CALL core_msnedit.cpp_UndoTmp_BuildActorList_CreateTmp_FUN_0053c140 ; 0053dbae | undefined core_msnedit.cpp_UndoTmp_BuildActorList_CreateTmp_FUN_0053c140()
        ;   XREF to: 0053c140 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0053dbb3
    PUSH EBX                            ; 0053dbb6
    PUSH ESI                            ; 0053dbb7
    CALL core_msnedit.cpp_FUN_00538ea0  ; 0053dbb8 | undefined core_msnedit.cpp_FUN_00538ea0()
        ;   XREF to: 00538ea0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0053dbbd
    PUSH 0x1                            ; 0053dbc0
    PUSH EBX                            ; 0053dbc2
    PUSH ESI                            ; 0053dbc3
    CALL core_mission.cpp_CDemonMission_FUN_00523f20 ; 0053dbc4 | void core_mission.cpp_CDemonMission_FUN_00523f20(CDemonMission * this_ptr)
        ;   XREF to: 00523f20 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0053dbc9
    MOV EAX,dword ptr [ESP + 0x500c]    ; 0053dbcc
    PUSH EAX                            ; 0053dbd3
    PUSH ESI                            ; 0053dbd4
    CALL core_mission.cpp_CDemonMission_FUN_00523b70 ; 0053dbd5 | void core_mission.cpp_CDemonMission_FUN_00523b70(CDemonMission * this_ptr)
        ;   XREF to: 00523b70 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0053dbda
    PUSH ESI                            ; 0053dbdd
    CALL core_mission.cpp_CDemonMission_buildSetActorList_FUN_00523e60 ; 0053dbde | void core_mission.cpp_CDemonMission_buildSetActorList_FUN_00523e60(CDemonMission * this_ptr)
        ;   XREF to: 00523e60 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0053dbe3
    MOV EBX,dword ptr [ESP + 0x500c]    ; 0053dbe6
    PUSH EBX                            ; 0053dbed
    PUSH ESI                            ; 0053dbee
    CALL core_msnedit.cpp_UndoTmp_BuildActorList_CreateTmp_FUN_0053c140 ; 0053dbef | undefined core_msnedit.cpp_UndoTmp_BuildActorList_CreateTmp_FUN_0053c140()
        ;   XREF to: 0053c140 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0053dc00
    CALL shape_edittool.cpp_CPickList_dtor_FUN_004a3c80 ; 0053dc01 | CPickList * shape_edittool.cpp_CPickList_dtor_FUN_004a3c80(CPickList * this_ptr, uint d1, uint d2, uint d3, ...)
    ...
    PUSH EAX                            ; 0053dc1f
    CALL crt_string.c_stricmp_FUN_005fe7f0 ; 0053dc20 | int crt_string.c_stricmp_FUN_005fe7f0(char * str1, char * str2)
        ;   XREF to: 005fe7f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0053dc25
    TEST EAX,EAX                        ; 0053dc28
    JNZ 0x0053dac4                      ; 0053dc2a | caseD_e
        ;   XREF to: 0053dac4 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [EBX]             ; 0053dc30
    CMP EAX,0x11                        ; 0053dc32
    JA 0x0053dac4                       ; 0053dc35 | caseD_e
        ;   XREF to: 0053dac4 (CONDITIONAL_JUMP)
    JMP dword ptr [EAX*0x4 + 0x53d85c]  ; 0053dc3b | void * switchdataD_0053d85c
        ;   Label: switchD
    ...
    JMP 0x0053dac4                      ; 0053dc4c | caseD_e
    ...
    JMP 0x0053dac4                      ; 0053dc7e | caseD_e
        ;   XREF to: 0053dac4 (UNCONDITIONAL_JUMP)
    ...
    JMP 0x0053dac4                      ; 0053dc8d | caseD_e
        ;   XREF to: 0053dac4 (UNCONDITIONAL_JUMP)
    ...
    CMP AL,0x0                          ; 0053dc9d
    JZ 0x0053dcb1                       ; 0053dc9f | LAB_0053dcb1
    ...
    CMP AL,0x0                          ; 0053dcad
    JNZ 0x0053dc99                      ; 0053dcaf | LAB_0053dc99
        ;   XREF to: 0053dc99 (CONDITIONAL_JUMP)
    POP EDI                             ; 0053dcb1
        ;   Label: LAB_0053dcb1
    JMP 0x0053dac4                      ; 0053dcb2 | caseD_e
        ;   XREF to: 0053dac4 (UNCONDITIONAL_JUMP)
    ...
    PUSH EDX                            ; 0053dcc1
    CALL core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0 ; 0053dcc2 | void core_dmodel.cpp_CKeyFramedModelInstance_setModelName_FUN_00478dd0(CKeyFramedModelInstance * this_ptr, char * filename)
        ;   XREF to: 00478dd0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0053dcc7
    JMP 0x0053dac4                      ; 0053dcca | caseD_e
        ;   XREF to: 0053dac4 (UNCONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 0053dcdb
    CALL core_skeleton.cpp_CDeformableModelInstance_init_FUN_005a0840 ; 0053dcdc | void core_skeleton.cpp_CDeformableModelInstance_init_FUN_005a0840(CDeformableModelInstance * this_ptr, char * model_name)
        ;   XREF to: 005a0840 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0053dce1
    JMP 0x0053dac4                      ; 0053dce4 | caseD_e
        ;   XREF to: 0053dac4 (UNCONDITIONAL_JUMP)
