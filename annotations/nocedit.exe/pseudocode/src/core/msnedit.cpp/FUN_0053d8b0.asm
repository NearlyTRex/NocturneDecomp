...
section .text
    ...
    CALL core_msnedit.cpp_UndoTmp_BuildActorList_CreateTmp_FUN_0053c140 ; 0053dbae
    ...
    PUSH EBX                            ; 0053dbb6
    PUSH ESI                            ; 0053dbb7
    CALL core_msnedit.cpp_FUN_00538ea0  ; 0053dbb8
    ...
    PUSH EBX                            ; 0053dbed
    PUSH ESI                            ; 0053dbee
    CALL core_msnedit.cpp_UndoTmp_BuildActorList_CreateTmp_FUN_0053c140 ; 0053dbef
        ;   XREF to: 0053c140 (UNCONDITIONAL_CALL)  ; undefined core_msnedit.cpp_UndoTmp_BuildActorList_CreateTmp_FUN_0053c140()
