...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_msnedit_cpp_CDemonMission_FUN_00538f40(CDemonMission *this_ptr,char *param_2)
;
; Parameters:
...
;
; XREF[1]:
;   core_msnedit.cpp_CDemonMission_FUN_00538d60 at 00538d6c
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 00538f40
        ;   Label: core_msnedit.cpp_CDemonMission_FUN_00538f40
    PUSH ESI                            ; 00538f41
    PUSH EDI                            ; 00538f42
    PUSH EBP                            ; 00538f43
