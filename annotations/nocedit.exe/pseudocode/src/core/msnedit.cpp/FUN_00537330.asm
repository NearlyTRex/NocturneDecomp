...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_msnedit.cpp_FUN_00537330()
;
; Local Variables:
...
section .text
    ...
    MOV ECX,dword ptr [0x00822044]      ; 00537340 | int g_NumActorClassTypes
    MOV dword ptr [ESP + 0x6c],EDX      ; 00537346
    TEST ECX,ECX                        ; 0053734a
    JLE 0x00537389                      ; 0053734c | LAB_00537389
    ...
    MOV EBX,dword ptr [EBP + 0x822048]  ; 00537361 | CDemonActorType *[200] g_ActorClassRegistrations
        ;   Label: LAB_00537361
    MOV EAX,dword ptr [ESP + 0x88]      ; 00537367
    CMP EAX,dword ptr [EBX + 0x28]      ; 0053736e
    JZ 0x00537391                       ; 00537371 | LAB_00537391
        ;   XREF to: 00537391 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [ESP + 0x6c]      ; 00537373
        ;   Label: LAB_00537373
    MOV ESI,dword ptr [0x00822044]      ; 00537377 | int g_NumActorClassTypes
    INC EBX                             ; 0053737d
    ADD EBP,0x4                         ; 0053737e
    MOV dword ptr [ESP + 0x6c],EBX      ; 00537381
    CMP EBX,ESI                         ; 00537385
    JL 0x00537361                       ; 00537387 | LAB_00537361
    ...
    PUSH EDI                            ; 00537399
    CALL crt_memory.c_memset_FUN_005fde40 ; 0053739a | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
        ;   XREF to: 005fde40 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0053739f
    MOV EDX,dword ptr [EBX + 0x34]      ; 005373a2
    PUSH EDX                            ; 005373a5
    PUSH EBX                            ; 005373a6
    PUSH 0x63b7a4                       ; 005373a7 | = "%s\t%d" | s_s_d_0063b7a4 = %s	%d
    MOV ECX,dword ptr [ESP + 0x70]      ; 005373ac
    PUSH ECX                            ; 005373b0
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 005373b1 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    MOV ESI,dword ptr [EBX + 0x2c]      ; 005373b6
    ADD ESP,0x10                        ; 005373b9
    TEST ESI,ESI                        ; 005373bc
    JNZ 0x005373e9                      ; 005373be | LAB_005373e9
        ;   XREF to: 005373e9 (CONDITIONAL_JUMP)
    MOV ESI,0x63b7aa                    ; 005373c0 | = "\t(abstract)" | s_abstract_0063b7aa = 	(abstract)
    ...
    DEC EDI                             ; 005373cf
    MOV AL,byte ptr [ESI]               ; 005373d0 | = "\t(abstract)" | s_abstract_0063b7aa = 	(abstract)
        ;   Label: LAB_005373d0
    MOV byte ptr [EDI],AL               ; 005373d2
    CMP AL,0x0                          ; 005373d4
    JZ 0x005373e8                       ; 005373d6 | LAB_005373e8
        ;   XREF to: 005373e8 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 005373d8 | s_(abstract)_0063b7ab
    ADD ESI,0x2                         ; 005373db
    MOV byte ptr [EDI + 0x1],AL         ; 005373de
    ADD EDI,0x2                         ; 005373e1
    CMP AL,0x0                          ; 005373e4
    JNZ 0x005373d0                      ; 005373e6 | LAB_005373d0
    ...
    PUSH EDI                            ; 005373f3
    CALL shape_edittool.cpp_CStrList_add_FUN_004a2b80 ; 005373f4 | void shape_edittool.cpp_CStrList_add_FUN_004a2b80(CStrList * this_ptr, char * string_data)
    ...
    PUSH EBX                            ; 00537401
    PUSH EDI                            ; 00537402
    CALL core_msnedit.cpp_FUN_00537330  ; 00537403 | undefined core_msnedit.cpp_FUN_00537330()
        ;   XREF to: 00537330 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00537408
    JMP 0x00537373                      ; 0053740b | LAB_00537373
