...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_msnedit_cpp_CDemonMission_FUN_0053d7b0(CDemonMission *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0053d7b0
        ;   Label: core_msnedit.cpp_CDemonMission_FUN_0053d7b0
    PUSH ESI                            ; 0053d7b1
    PUSH EDI                            ; 0053d7b2
    PUSH EBP                            ; 0053d7b3
    ...
    INC ESI                             ; 0053d853
    CALL core_waypoint.cpp_FUN_005ec4f0 ; 0053d854
