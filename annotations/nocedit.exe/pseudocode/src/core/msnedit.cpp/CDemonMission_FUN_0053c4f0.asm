...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_msnedit_cpp_CDemonMission_FUN_0053c4f0(CDemonMission *this_ptr)
;
; Parameters:
...
;   undefined4 DAT_02f797e4.current_value
...
section .text
    ...
    PUSH EBX                            ; 0053c4f0
        ;   Label: core_msnedit.cpp_CDemonMission_FUN_0053c4f0
    PUSH ESI                            ; 0053c4f1
    PUSH EBP                            ; 0053c4f2
    ...
    MOV [0x02f797f0],EAX                ; 0053c5ec | DAT_02f797e4.scroll_increment
    ...
    CALL core_msnedit.cpp_FUN_00536e20  ; 0053c6a7
        ;   XREF to: 00536e20 (UNCONDITIONAL_CALL)  ; void core_msnedit.cpp_FUN_00536e20()
    POP EDI                             ; 0053c6ac
