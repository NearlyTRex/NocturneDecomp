// Name: core_msnedit.cpp_CDemonMission_FUN_005379e0
// Address: 005379e0
// Address Range: [[005379e0, 00537cff] [00537d5f, 00537dc1]]
// Convention: __cdecl
// Signature: void __cdecl core_msnedit_cpp_CDemonMission_FUN_005379e0(CDemonMission *this_ptr)
            ...
            for (pCVar1 = this_ptr->first_actor; pCVar1 != (CDemonActor *)0x0;
              ...
              if (((pCVar3 != (CDemonActor *)0x0) &&
                ...
                *(float *)(pCVar3[0x8d].create_event + 0x34) = fStack_14;
                ...
                shape_edittool_cpp_CStrList_add_FUN_004a2b80
                          ((CStrList *)&stack0xfffff304,string_data);
              }
            }
