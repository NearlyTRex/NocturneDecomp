...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_msnedit.cpp_FUN_0053ca30()
;
;
; XREF[1]:
...
section .text
    ...
    CMP dword ptr [EAX + 0x148],0x0     ; 0053ca73
        ;   Label: LAB_0053ca73
    JNZ 0x0053ca67                      ; 0053ca7a | LAB_0053ca67
