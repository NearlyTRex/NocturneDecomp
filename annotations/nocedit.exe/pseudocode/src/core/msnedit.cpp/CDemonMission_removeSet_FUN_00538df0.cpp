...
// Convention: __cdecl
// Signature: void __cdecl core_msnedit_cpp_CDemonMission_removeSet_FUN_00538df0(CDemonMission *this_ptr,int param_2)
...

{
  ...
  if ((-1 < param_2) && (param_2 < this_ptr->num_sets)) {
    ...
    memmove
              (this_ptr->set_names + param_2,this_ptr->set_names + param_2,(iVar2 - param_2) * 0x100
              );
  }
  return;
}
