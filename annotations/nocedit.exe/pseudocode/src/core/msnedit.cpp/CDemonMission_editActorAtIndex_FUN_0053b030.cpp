...
void __cdecl
core_msnedit_cpp_CDemonMission_editActorAtIndex_FUN_0053b030(CDemonMission *this_ptr,int param_2)
  ...
  do {
    ...
    if (0 < CStack_30.item_count) {
      do {
        ...
        iVar3 = stricmp(pcVar9,unaff_EBP->actor_name);
        if (iVar3 == 0) {
