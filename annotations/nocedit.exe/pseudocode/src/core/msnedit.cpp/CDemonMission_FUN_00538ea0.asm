...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_msnedit_cpp_CDemonMission_FUN_00538ea0(CDemonMission *this_ptr,int param_2)
;
; Parameters:
...
;
; XREF[4]:
;   core_msnedit.cpp_CDemonMission_FUN_00538df0 at 00538e29
;   core_msnedit.cpp_CDemonMission_FUN_0053bc80 at 0053bca5
;   core_msnedit.cpp_CDemonMission_FUN_0053ccf0 at 0053cec8
...
section .text
    ...
    PUSH EBX                            ; 00538ea0
        ;   Label: core_msnedit.cpp_CDemonMission_FUN_00538ea0
    PUSH ESI                            ; 00538ea1
    PUSH EDI                            ; 00538ea2
