...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_msnedit_cpp_CDemonMission_FUN_0053cc30(CDemonMission *this_ptr,CStrList *param_2,uint param_3,char *param_4,int param_5)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0053cc30
        ;   Label: core_msnedit.cpp_CDemonMission_FUN_0053cc30
    PUSH ESI                            ; 0053cc31
    PUSH EDI                            ; 0053cc32
    PUSH EBP                            ; 0053cc33
