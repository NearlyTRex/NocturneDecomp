...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_msnedit_cpp_CDemonMission_showOptionsMenu_FUN_00537680(CDemonMission *this_ptr)
;
; Parameters:
...
;
; XREF[1]:
;   core_msnedit.cpp_CDemonMission_editActorsInSet_FUN_005390f0 at 0053a733
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00537680
        ;   Label: core_msnedit.cpp_CDemonMission_showOptionsMenu_FUN_00537680
    PUSH ESI                            ; 00537681
    PUSH EDI                            ; 00537682
    PUSH EBP                            ; 00537683
