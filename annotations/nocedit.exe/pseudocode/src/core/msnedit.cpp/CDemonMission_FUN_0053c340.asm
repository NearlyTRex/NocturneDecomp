...
;                               FUNCTION
; *****************************************************************************
; __cdecl CDemonActor * __cdecl core_msnedit_cpp_CDemonMission_FUN_0053c340(CDemonMission *this_ptr,int param_2,int param_3)
;
; Parameters:
...
;
; XREF[1]:
;   core_msnedit.cpp_CDemonMission_FUN_005390f0 at 0053a3e1
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0053c340
        ;   Label: core_msnedit.cpp_CDemonMission_FUN_0053c340
    PUSH ESI                            ; 0053c341
    PUSH EDI                            ; 0053c342
    PUSH EBP                            ; 0053c343
