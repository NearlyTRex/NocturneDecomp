...

{
  ...
  if ((((*(int *)(g_CDemonMissionPtr->field2_0xc + 0x1c) != 0) && (-1 < DAT_02f7c52c)) &&
    ...
    ;
    crt_stdio_c_sprintf_FUN_005fdbd0(&stack0xffffff18,"%s (%s)");
    ...
    crt_stdio_c_sprintf_FUN_005fdbd0(&stack0xffffff18,"%6.2f");
    iVar1 = core_msnedit_cpp_FUN_00536cd0();
    if (iVar1 != 0) {
      shape_edittool_cpp_CEditorTools_promptForValidFloat_FUN_004a00f0
                (g_CEditorToolsPtr,"Enter frame number",(float *)&stack0xffffff0c,true,0.0,
    ...
    iVar1 = core_msnedit_cpp_FUN_00536cd0();
    if (iVar1 != 0) {
      crt_math_c_ceil_FUN_006001b2((double)in_stack_ffffff18);
      DAT_02f7c530 = 0;
    }
    if (DAT_02f7c530 == 0) {
      iVar1 = core_msnedit_cpp_FUN_00536cd0();
    ...
    iVar1 = core_msnedit_cpp_FUN_00536cd0();
    if (iVar1 != 0) {
      crt_math_c_floor_FUN_005feb90((double)in_stack_ffffff1c);
      DAT_02f7c530 = 0;
    }
    iVar1 = core_msnedit_cpp_FUN_00536cd0();
    if (iVar1 != 0) {
      DAT_02f7c530 = 0;
      in_stack_ffffff1c = (float)(motion_name->frame_count + -1);
    }
    if ((DAT_02f7c530 != 0) &&
       (in_stack_ffffff1c = g_CGamePtr->delta_time_float * motion_name->fps + in_stack_ffffff1c,
       (float)motion_name->frame_count <= in_stack_ffffff1c)) {
      in_stack_ffffff1c = 0.0;
    }
    core_motion_cpp_CMotionController_jumpToMotionByName_FUN_0052ddb0
              (&this_ptr->motion_controller,motion_name->motion_name,in_stack_ffffff1c);
