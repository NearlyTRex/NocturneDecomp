...

{
  ...
  if ((((g_CDemonMissionPtr->selected_actor != (CDemonActor *)0x0) && (-1 < INT_02f7c52c)) &&
    ...
    iVar2 = core_msnedit_cpp_FUN_00536cd0(&DAT_0063b719,local_24 + 7,local_1c,1,0);
    if (iVar2 != 0) {
      INT_02f7c530 = 0;
      local_f8 = 0.0;
    }
    iVar2 = core_msnedit_cpp_FUN_00536cd0(&DAT_0063b71e,iVar1 + 0x23,local_1c,0,0);
    if (iVar2 != 0) {
    ...
    if (INT_02f7c530 == 0) {
      iVar2 = core_msnedit_cpp_FUN_00536cd0(&DAT_0063b727,iVar1 + 0x38,local_1c,1,0);
      if (iVar2 != 0) {
        INT_02f7c530 = 1;
      }
    }
    else {
      iVar2 = core_msnedit_cpp_FUN_00536cd0(&DAT_0063b722,iVar1 + 0x38,local_1c,1,0);
      if (iVar2 != 0) {
        INT_02f7c530 = 0;
      }
    }
    iVar2 = core_msnedit_cpp_FUN_00536cd0(&DAT_0063b72c,iVar1 + 0x54,local_1c,0,0);
    if (iVar2 != 0) {
      local_2c = floor((double)local_f8);
      local_f8 = (float)local_2c + 1.0;
      INT_02f7c530 = 0;
    }
    iVar1 = core_msnedit_cpp_FUN_00536cd0(&DAT_0063b730,iVar1 + 0x69,local_1c,1,0);
    if (iVar1 != 0) {
      local_18 = motion_name->frame_count + -1;
      INT_02f7c530 = 0;
      local_f8 = (float)local_18;
