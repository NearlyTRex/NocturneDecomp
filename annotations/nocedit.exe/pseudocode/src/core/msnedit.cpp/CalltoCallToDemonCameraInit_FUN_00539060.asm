...
section .text
    ...
    JZ 0x005390b4                       ; 0053906b | LAB_005390b4
    ...
    JNZ 0x005390b5                      ; 00539086 | LAB_005390b5
        ;   XREF to: 005390b5 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x00679394]      ; 00539088 | int g_WindowWidth
    MOV dword ptr [EAX + 0x1c],EDX      ; 0053908e
    MOV EDX,dword ptr [0x00679398]      ; 00539091 | int g_WindowHeight
    ...
    PUSH 0x0                            ; 0053909e
    PUSH 0x0                            ; 005390a0
    MOV EDI,dword ptr [0x006810c8]      ; 005390a2 | CDemonSet * g_CDemonSetPtr
    PUSH EDI                            ; 005390a8 | CDemonSet g_CDemonSetInstance
    CALL core_set.cpp_CDemonSet_CallToDemonCameraInitAndSetView_FUN_0056b7e0 ; 005390a9 | undefined core_set.cpp_CDemonSet_CallToDemonCameraInitAndSetView_FUN_0056b7e0()
    ...
    JMP 0x0053909a                      ; 005390c3 | LAB_0053909a
