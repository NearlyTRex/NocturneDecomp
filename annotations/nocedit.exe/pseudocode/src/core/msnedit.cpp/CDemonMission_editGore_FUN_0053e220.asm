...
section .text
    ...
    PUSH EBX                            ; 0053e220
        ;   Label: core_msnedit.cpp_CDemonMission_editGore_FUN_0053e220
    PUSH ESI                            ; 0053e221
    PUSH EDI                            ; 0053e222
    PUSH EBP                            ; 0053e223
    ...
    MOV dword ptr [EAX + 0x15ac84],0x1  ; 0053e4cb | g_CDemonSetInstance.disable_spotlight_shadows
    ...
    MOV dword ptr [EAX + 0x15ac8c],EBX  ; 0053e4e9 | g_CDemonSetInstance.disable_water_rendering
    ...
    CALL core_setcolid.cpp_CDemonSet_buildCollidableActorList_FUN_005743e0 ; 0053e559
    ...
    PUSH EAX                            ; 0053e600
    JMP 0x0060c5a0                      ; 0053e601
        ;   XREF to: 0060c5a0 (UNCONDITIONAL_JUMP)  ; CAVE_cave_0060c5a0
    ...
    JMP 0x0060c5c0                      ; 0053e62d
        ;   XREF to: 0060c5c0 (UNCONDITIONAL_JUMP)  ; LAB_0060c5c0
    ...
    CALL core_gore.cpp_CGore_spawnBloodParticles_FUN_004edaa0 ; 0053e6ce
    ...
    CALL core_gore.cpp_CGore_spawnBloodParticles_FUN_004edaa0 ; 0053e753
        ;   XREF to: 004edaa0 (UNCONDITIONAL_CALL)  ; void core_gore.cpp_CGore_spawnBloodParticles_FUN_004edaa0(CGore * this_ptr, CVector3f * position, CVector3f * velocity, int blood_type)
    ...
    CALL core_gore.cpp_CGore_createBloodPool_FUN_004ede30 ; 0053e896
    ...
    CALL core_gore.cpp_CGore_reset_FUN_004ed760 ; 0053e8d9
    ...
    MOV dword ptr [EAX + 0x15ac84],ECX  ; 0053e948 | g_CDemonSetInstance.disable_spotlight_shadows
    ...
    MOV dword ptr [EAX + 0x15ac84],0x0  ; 0053e9b2 | g_CDemonSetInstance.disable_spotlight_shadows
    MOV dword ptr [EAX + 0x15ac8c],0x0  ; 0053e9bc | g_CDemonSetInstance.disable_water_rendering
    ADD ESP,0x4                         ; 0053e9c6
    MOV dword ptr [EAX + 0x15ac90],0x0  ; 0053e9c9 | g_CDemonSetInstance.disable_sky_rendering
    ...
    POP EBX                             ; 0053e9d8
    RET                                 ; 0053e9d9
    MOV ECX,dword ptr [ESI]             ; 0060c5a0
        ;   Label: CAVE_cave_0060c5a0
    MOV dword ptr [EDI],ECX             ; 0060c5a2
    MOV ECX,dword ptr [ESI + 0x4]       ; 0060c5a4
    MOV dword ptr [EDI + 0x4],ECX       ; 0060c5a7
    MOV ECX,dword ptr [ESI + 0x8]       ; 0060c5aa
    MOV dword ptr [EDI + 0x8],ECX       ; 0060c5ad
    ADD ESI,0xc                         ; 0060c5b0
    ADD EDI,0xc                         ; 0060c5b3
    PUSH 0x32758e4                      ; 0060c5b6
    JMP 0x0053e609                      ; 0060c5bb
        ;   XREF to: 0053e609 (UNCONDITIONAL_JUMP)  ; LAB_0053e609
    MOV ECX,dword ptr [ESI]             ; 0060c5c0
        ;   Label: LAB_0060c5c0
    MOV dword ptr [EDI],ECX             ; 0060c5c2
    MOV ECX,dword ptr [ESI + 0x4]       ; 0060c5c4
    MOV dword ptr [EDI + 0x4],ECX       ; 0060c5c7
    MOV ECX,dword ptr [ESI + 0x8]       ; 0060c5ca
    MOV dword ptr [EDI + 0x8],ECX       ; 0060c5cd
    ADD ESI,0xc                         ; 0060c5d0
    ADD EDI,0xc                         ; 0060c5d3
    FILD dword ptr [EAX]                ; 0060c5d6
    JMP 0x0053e632                      ; 0060c5d8
        ;   XREF to: 0053e632 (UNCONDITIONAL_JUMP)  ; LAB_0053e632
