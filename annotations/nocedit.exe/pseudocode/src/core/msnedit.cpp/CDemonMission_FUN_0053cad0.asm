...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_msnedit_cpp_CDemonMission_FUN_0053cad0 (CDemonMission *this_ptr,int param_2,char *param_3,int *param_4,int param_5,int param_6, int param_7,int param_8)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 0053cad0
        ;   Label: core_msnedit.cpp_CDemonMission_FUN_0053cad0
    PUSH ESI                            ; 0053cad1
    PUSH EDI                            ; 0053cad2
    PUSH EBP                            ; 0053cad3
    ...
    PUSH ECX                            ; 0053cb2b
    CALL core_msnedit.cpp_CDemonMission_FUN_0053cc30 ; 0053cb2c
