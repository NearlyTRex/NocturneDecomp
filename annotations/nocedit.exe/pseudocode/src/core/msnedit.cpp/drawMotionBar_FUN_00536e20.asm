...
;   TerminatedCString s_anon_0063b719
;   TerminatedCString s_anon_0063b71e
;   TerminatedCString s_anon_0063b722
;   TerminatedCString s_anon_0063b727
;   TerminatedCString s_anon_0063b72c
;   TerminatedCString s_anon_0063b730
;   double DOUBLE_0063b73c = -1
...
;   core_msnedit.cpp_drawClickableButton_FUN_00536cd0
...
section .text
    ...
    PUSH EBX                            ; 00536e20
        ;   Label: core_msnedit.cpp_drawMotionBar_FUN_00536e20
    PUSH ESI                            ; 00536e21
    PUSH EDI                            ; 00536e22
    PUSH EBP                            ; 00536e23
    ...
    MOV EBX,dword ptr [0x02f7c52c]      ; 00536e48 | g_SelectedMotionPropertyIndex
    ...
    MOV EDI,dword ptr [0x02cf6a8c]      ; 00536eba | g_MouseX
    MOV dword ptr [ESP + 0xd4],ECX      ; 00536ec0
    CMP EDI,EDX                         ; 00536ec7
    JL 0x00536ee7                       ; 00536ec9
        ;   XREF to: 00536ee7 (CONDITIONAL_JUMP)  ; LAB_00536ee7
    CMP EDI,0x9b                        ; 00536ecb
    JG 0x00536ee7                       ; 00536ed1
        ;   XREF to: 00536ee7 (CONDITIONAL_JUMP)  ; LAB_00536ee7
    MOV EDI,dword ptr [0x02cf6a90]      ; 00536ed3 | g_MouseY
    CMP EBX,EDI                         ; 00536ed9
    JG 0x00536ee7                       ; 00536edb
        ;   XREF to: 00536ee7 (CONDITIONAL_JUMP)  ; LAB_00536ee7
    CMP EAX,EDI                         ; 00536edd
    JL 0x00536ee7                       ; 00536edf
        ;   XREF to: 00536ee7 (CONDITIONAL_JUMP)  ; LAB_00536ee7
    MOV dword ptr [0x02f7c538],EDX      ; 00536ee1 | INT_02f7c538
    PUSH 0xff                           ; 00536ee7
        ;   Label: LAB_00536ee7
    PUSH 0x0                            ; 00536eec
    PUSH EAX                            ; 00536eee
    ...
    PUSH EBX                            ; 00536ef7
    PUSH EDX                            ; 00536ef8
    CALL engine_2d.c_fillRectWithBorder_FUN_00403200 ; 00536ef9
    ...
    PUSH ESI                            ; 00536f01
    CALL core_motion.cpp_CMotionController_getCurrentMotion_FUN_0052dab0 ; 00536f02
    ...
    CALL core_motion.cpp_CMotionController_getCurrentStateName_FUN_0052dcf0 ; 00536f16
    ...
    PUSH EAX                            ; 00536f4a
    CALL core_msnedit.cpp_drawClickableButton_FUN_00536cd0 ; 00536f4b
    ...
    CALL core_msnedit.cpp_drawClickableButton_FUN_00536cd0 ; 00536f9f
        ;   XREF to: 00536cd0 (UNCONDITIONAL_CALL)  ; int core_msnedit.cpp_drawClickableButton_FUN_00536cd0(char * text, int x, int y, int consume_click, ...)
    ADD ESP,0x14                        ; 00536fa4
    TEST EAX,EAX                        ; 00536fa7
    JZ 0x00536fb5                       ; 00536fa9
        ;   XREF to: 00536fb5 (CONDITIONAL_JUMP)  ; LAB_00536fb5
    MOV dword ptr [0x02f7c52c],0xffffffff ; 00536fab | g_SelectedMotionPropertyIndex
    ...
    PUSH EAX                            ; 00536feb
    CALL core_msnedit.cpp_drawClickableButton_FUN_00536cd0 ; 00536fec
        ;   XREF to: 00536cd0 (UNCONDITIONAL_CALL)  ; int core_msnedit.cpp_drawClickableButton_FUN_00536cd0(char * text, int x, int y, int consume_click, ...)
    ADD ESP,0x14                        ; 00536ff1
    TEST EAX,EAX                        ; 00536ff4
    JZ 0x0053702f                       ; 00536ff6
        ;   XREF to: 0053702f (CONDITIONAL_JUMP)  ; LAB_0053702f
    ...
    PUSH EBX                            ; 00537048
    PUSH 0x63b719                       ; 00537049 | = " << "
    MOV dword ptr [ESP + 0xf0],EAX      ; 0053704e
    CALL core_msnedit.cpp_drawClickableButton_FUN_00536cd0 ; 00537055
        ;   XREF to: 00536cd0 (UNCONDITIONAL_CALL)  ; int core_msnedit.cpp_drawClickableButton_FUN_00536cd0(char * text, int x, int y, int consume_click, ...)
    ADD ESP,0x14                        ; 0053705a
    TEST EAX,EAX                        ; 0053705d
    JZ 0x0053706c                       ; 0053705f
        ;   XREF to: 0053706c (CONDITIONAL_JUMP)  ; LAB_0053706c
    XOR EDX,EDX                         ; 00537061
    MOV dword ptr [0x02f7c530],EDX      ; 00537063 | g_MotionPropertyEditState
    ...
    PUSH EBX                            ; 0053707b
    PUSH 0x63b71e                       ; 0053707c | = " < "
    CALL core_msnedit.cpp_drawClickableButton_FUN_00536cd0 ; 00537081
        ;   XREF to: 00536cd0 (UNCONDITIONAL_CALL)  ; int core_msnedit.cpp_drawClickableButton_FUN_00536cd0(char * text, int x, int y, int consume_click, ...)
    ADD ESP,0x14                        ; 00537086
    TEST EAX,EAX                        ; 00537089
    JZ 0x005370e2                       ; 0053708b
        ;   XREF to: 005370e2 (CONDITIONAL_JUMP)  ; LAB_005370e2
    FLD float ptr [ESP]                 ; 0053708d
    SUB ESP,0x8                         ; 00537090
    FSTP double ptr [ESP]               ; 00537093
    CALL crt_math.c_ceil_FUN_006001b2   ; 00537096
    ...
    FADD double ptr [0x0063b73c]        ; 005370b0 | DOUBLE_0063b73c
    ...
    FNSTSW AX                           ; 005370c0
    SAHF                                ; 005370c2
    JBE 0x005370da                      ; 005370c3
        ;   XREF to: 005370da (CONDITIONAL_JUMP)  ; LAB_005370da
    ...
    XOR EDX,EDX                         ; 005370da
        ;   Label: LAB_005370da
    MOV dword ptr [0x02f7c530],EDX      ; 005370dc | g_MotionPropertyEditState
    MOV ECX,dword ptr [0x02f7c530]      ; 005370e2 | g_MotionPropertyEditState
        ;   Label: LAB_005370e2
    ADD EBX,0x15                        ; 005370e8
    TEST ECX,ECX                        ; 005370eb
    JZ 0x005371f6                       ; 005370ed
        ;   XREF to: 005371f6 (CONDITIONAL_JUMP)  ; LAB_005371f6
    PUSH 0x0                            ; 005370f3
    PUSH 0x1                            ; 005370f5
    MOV ECX,dword ptr [ESP + 0xe4]      ; 005370f7
    PUSH ECX                            ; 005370fe
    PUSH EBX                            ; 005370ff
    PUSH 0x63b722                       ; 00537100 | = " || "
    CALL core_msnedit.cpp_drawClickableButton_FUN_00536cd0 ; 00537105
        ;   XREF to: 00536cd0 (UNCONDITIONAL_CALL)  ; int core_msnedit.cpp_drawClickableButton_FUN_00536cd0(char * text, int x, int y, int consume_click, ...)
    ADD ESP,0x14                        ; 0053710a
    TEST EAX,EAX                        ; 0053710d
    JZ 0x00537118                       ; 0053710f
        ;   XREF to: 00537118 (CONDITIONAL_JUMP)  ; LAB_00537118
    XOR EAX,EAX                         ; 00537111
    MOV [0x02f7c530],EAX                ; 00537113 | g_MotionPropertyEditState
    PUSH 0x0                            ; 00537118
        ;   Label: LAB_00537118
    PUSH 0x0                            ; 0053711a
    ...
    PUSH EBX                            ; 00537127
    PUSH 0x63b72c                       ; 00537128 | = " > "
    CALL core_msnedit.cpp_drawClickableButton_FUN_00536cd0 ; 0053712d
        ;   XREF to: 00536cd0 (UNCONDITIONAL_CALL)  ; int core_msnedit.cpp_drawClickableButton_FUN_00536cd0(char * text, int x, int y, int consume_click, ...)
    ADD ESP,0x14                        ; 00537132
    TEST EAX,EAX                        ; 00537135
    JZ 0x0053716e                       ; 00537137
        ;   XREF to: 0053716e (CONDITIONAL_JUMP)  ; LAB_0053716e
    FLD float ptr [ESP]                 ; 00537139
    SUB ESP,0x8                         ; 0053713c
    FSTP double ptr [ESP]               ; 0053713f
    CALL crt_math.c_floor_FUN_005feb90  ; 00537142
    ...
    FADDP                               ; 00537163
    MOV dword ptr [0x02f7c530],ECX      ; 00537165 | g_MotionPropertyEditState
    ...
    PUSH EBX                            ; 0053717d
    PUSH 0x63b730                       ; 0053717e | = " >> "
    CALL core_msnedit.cpp_drawClickableButton_FUN_00536cd0 ; 00537183
        ;   XREF to: 00536cd0 (UNCONDITIONAL_CALL)  ; int core_msnedit.cpp_drawClickableButton_FUN_00536cd0(char * text, int x, int y, int consume_click, ...)
    ADD ESP,0x14                        ; 00537188
    TEST EAX,EAX                        ; 0053718b
    JZ 0x005371ac                       ; 0053718d
        ;   XREF to: 005371ac (CONDITIONAL_JUMP)  ; LAB_005371ac
    MOV EAX,dword ptr [EDI + 0x64]      ; 0053718f
    DEC EAX                             ; 00537192
    XOR EDX,EDX                         ; 00537193
    MOV dword ptr [ESP + 0xe0],EAX      ; 00537195
    MOV dword ptr [0x02f7c530],EDX      ; 0053719c | g_MotionPropertyEditState
    FILD dword ptr [ESP + 0xe0]         ; 005371a2
    FSTP float ptr [ESP]                ; 005371a9
    CMP dword ptr [0x02f7c530],0x0      ; 005371ac | g_MotionPropertyEditState
        ;   Label: LAB_005371ac
    JZ 0x005371d9                       ; 005371b3
        ;   XREF to: 005371d9 (CONDITIONAL_JUMP)  ; LAB_005371d9
    MOV EAX,[0x0067b654]                ; 005371b5 | g_CGamePtr
    ...
    PUSH EDI                            ; 005371dc
    PUSH ESI                            ; 005371dd
    CALL core_motion.cpp_CMotionController_jumpToMotionByName_FUN_0052ddb0 ; 005371de
    ...
    PUSH ESI                            ; 005371e6
    CALL core_skeleton.cpp_CDeformableModelInstance_updateAnimationAndTransforms_FUN_0059e000 ; 005371e7
    ...
    PUSH EAX                            ; 00537200
    PUSH EBX                            ; 00537201
    PUSH 0x63b727                       ; 00537202 | = " |> "
    CALL core_msnedit.cpp_drawClickableButton_FUN_00536cd0 ; 00537207
        ;   XREF to: 00536cd0 (UNCONDITIONAL_CALL)  ; int core_msnedit.cpp_drawClickableButton_FUN_00536cd0(char * text, int x, int y, int consume_click, ...)
    ADD ESP,0x14                        ; 0053720c
    TEST EAX,EAX                        ; 0053720f
    JZ 0x00537118                       ; 00537211
        ;   XREF to: 00537118 (CONDITIONAL_JUMP)  ; LAB_00537118
    MOV dword ptr [0x02f7c530],0x1      ; 00537217 | g_MotionPropertyEditState
    JMP 0x00537118                      ; 00537221
        ;   XREF to: 00537118 (UNCONDITIONAL_JUMP)  ; LAB_00537118
