...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_msnedit_cpp_CDemonMission_FUN_0053bd80(CDemonMission *this_ptr,int param_2,int param_3,CDemonMission *param_4)
;
; Parameters:
; CDemonMission *  Stack[0x4]:4   this_ptr
; int              Stack[0x8]:4   param_2
; int              Stack[0xc]:4   param_3
; CDemonMission *  Stack[0x10]:4   param_4
; Local Variables:
...
section .text
    ...
    PUSH EBX                            ; 0053bd80
        ;   Label: core_msnedit.cpp_CDemonMission_FUN_0053bd80
    PUSH ESI                            ; 0053bd81
    PUSH EDI                            ; 0053bd82
    PUSH EBP                            ; 0053bd83
    ...
    PUSH EDI                            ; 0053bfa6
    CALL core_msnedit.cpp_CDemonMission_FUN_0053c140 ; 0053bfa7
    ...
    CALL core_msnedit.cpp_CDemonMission_FUN_0053d220 ; 0053c077
