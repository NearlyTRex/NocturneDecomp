...
section .text
    ...
    PUSH EBX                            ; 00537410
        ;   Label: core_msnedit.cpp_confirmNewActorName_FUN_00537410
    PUSH ESI                            ; 00537411
    PUSH EDI                            ; 00537412
    SUB ESP,0x20                        ; 00537413
    MOV EBX,dword ptr [ESP + 0x30]      ; 00537416
    CMP dword ptr [0x00680814],0x0      ; 0053741a | g_ConfirmNewActorNames
    JNZ 0x0053742f                      ; 00537421
        ;   XREF to: 0053742f (CONDITIONAL_JUMP)  ; LAB_0053742f
    ...
    CMP AL,0x0                          ; 00537438
    JZ 0x0053744c                       ; 0053743a
        ;   XREF to: 0053744c (CONDITIONAL_JUMP)  ; LAB_0053744c
    MOV AL,byte ptr [ESI + 0x1]         ; 0053743c
    ADD ESI,0x2                         ; 0053743f
    MOV byte ptr [EDI + 0x1],AL         ; 00537442
    ADD EDI,0x2                         ; 00537445
    CMP AL,0x0                          ; 00537448
    JNZ 0x00537434                      ; 0053744a
        ;   XREF to: 00537434 (CONDITIONAL_JUMP)  ; LAB_00537434
    POP EDI                             ; 0053744c
        ;   Label: LAB_0053744c
    PUSH 0x1                            ; 0053744d
        ;   Label: LAB_0053744d
    ...
    JZ 0x00537428                       ; 0053746c
        ;   XREF to: 00537428 (CONDITIONAL_JUMP)  ; LAB_00537428
    MOV EAX,ESP                         ; 0053746e
    PUSH EAX                            ; 00537470
    PUSH EBX                            ; 00537471
    MOV EDI,dword ptr [0x0067d550]      ; 00537472 | g_CDemonMissionPtr
    PUSH EDI                            ; 00537478 | g_CDemonMissionInstance
    CALL core_msnedit.cpp_CDemonMission_validateNewActorName_FUN_0053d220 ; 00537479
    ...
    JZ 0x0053744d                       ; 00537483
        ;   XREF to: 0053744d (CONDITIONAL_JUMP)  ; LAB_0053744d
    ...
    CMP AL,0x0                          ; 0053748e
    JZ 0x005374a2                       ; 00537490
        ;   XREF to: 005374a2 (CONDITIONAL_JUMP)  ; LAB_005374a2
    MOV AL,byte ptr [ESI + 0x1]         ; 00537492
    ADD ESI,0x2                         ; 00537495
    MOV byte ptr [EDI + 0x1],AL         ; 00537498
    ADD EDI,0x2                         ; 0053749b
    CMP AL,0x0                          ; 0053749e
    JNZ 0x0053748a                      ; 005374a0
        ;   XREF to: 0053748a (CONDITIONAL_JUMP)  ; LAB_0053748a
    POP EDI                             ; 005374a2
        ;   Label: LAB_005374a2
