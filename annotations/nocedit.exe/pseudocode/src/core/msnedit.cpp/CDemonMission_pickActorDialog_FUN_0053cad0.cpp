...

{
  ...
  if (((preselect != 0) && (iVar4 < 0)) &&
    ...
    do {
      ...
      iVar3 = _stricmp(str1,str2->actor_name);
  ...
  index_00 = shape_edittool_cpp_CPickList_displayChoicesAndWaitForInput_FUN_004a3e20
                       (&local_3b8,title,initial_selected_index,0);
  if (-1 < index_00) {
    pcVar1 = shape_edittool_cpp_CStrList_getStringAt_FUN_004a2f70(&local_3b8.base,index_00);
