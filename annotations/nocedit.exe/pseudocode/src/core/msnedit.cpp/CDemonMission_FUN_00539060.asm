...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_msnedit_cpp_CDemonMission_FUN_00539060(CDemonMission *this_ptr,int param_2)
;
; Parameters:
...
;
; XREF[2]:
;   core_msnedit.cpp_CDemonMission_FUN_005390f0 at 0053aa25
...
section .text
    ...
    MOV EAX,dword ptr [ESP + 0x4]       ; 00539060
        ;   Label: core_msnedit.cpp_CDemonMission_FUN_00539060
    ...
    CALL core_set.cpp_CDemonSet_FUN_0056b7e0 ; 005390a9
