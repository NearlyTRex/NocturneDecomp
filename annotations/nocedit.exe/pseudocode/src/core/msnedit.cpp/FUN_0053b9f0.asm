...
;                               FUNCTION
; *****************************************************************************
; unknown void core_msnedit_cpp_FUN_0053b9f0(void)
;
; Local Variables:
...
section .text
    ...
    PUSH 0x0                            ; 0053ba47
    MOV EBX,dword ptr [0x00680648]      ; 0053ba49 | DAT_00680648
    PUSH EBX                            ; 0053ba4f
    ...
    PUSH EAX                            ; 0053ba6a
    MOV [0x00680648],EAX                ; 0053ba6b | DAT_00680648
    ...
    CALL core_mission.cpp_CDemonMission_initNewActorMaybe_FUN_00524700 ; 0053bab0
    ...
    CALL core_msnedit.cpp_FUN_0053d220  ; 0053bb8a
    ...
    PUSH EDX                            ; 0053bbd9
    CALL core_mission.cpp_CDemonMission_FUN_00523b70 ; 0053bbda
    ...
    PUSH EBX                            ; 0053bc06
    CALL core_msnedit.cpp_UndoTmp_BuildActorList_CreateTmp_FUN_0053c140 ; 0053bc07
