...
; int              Stack[0xc]:4   skip_confirmation
;
; XREF[2]:
;   core_msnedit.cpp_CDemonMission_deleteMultipleActorsMenu_FUN_0053df90 at 0053e0a5
...
section .text
    ...
    PUSH EBX                            ; 0053bc80
        ;   Label: core_msnedit.cpp_CDemonMission_deleteActorWithConfirm_FUN_0053bc80
    PUSH ESI                            ; 0053bc81
    ...
    PUSH EBX                            ; 0053bc9a
    CALL core_msnedit.cpp_CDemonMission_selectNearestActor_FUN_0053bcf0 ; 0053bc9b
    ...
    CALL shape_edittool.cpp_CEditorTools_showYesNoDialog_FUN_0049f060 ; 0053bcd2
