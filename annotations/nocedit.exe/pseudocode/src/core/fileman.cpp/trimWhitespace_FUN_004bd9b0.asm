...
section .text
    ...
    JLE 0x004bd9e0                      ; 004bd9c7 | LAB_004bd9e0
    ...
    TEST byte ptr [EDX + 0x6849c4],0x2  ; 004bd9d7 | char[256] g_CharacterClassificationTable
    JNZ 0x004bd9ff                      ; 004bd9de | LAB_004bd9ff
    ...
    TEST byte ptr [EAX + 0x6849c4],0x2  ; 004bd9f2 | char[256] g_CharacterClassificationTable
    JNZ 0x004bda07                      ; 004bd9f9 | LAB_004bda07
    ...
    JG 0x004bd9cc                       ; 004bda03 | LAB_004bd9cc
        ;   XREF to: 004bd9cc (CONDITIONAL_JUMP)
    JMP 0x004bd9e0                      ; 004bda05 | LAB_004bd9e0
    ...
    PUSH ESI                            ; 004bda09
    DEC EBX                             ; 004bda0a
    CALL crt_string.c_memmove_FUN_005fe5e0 ; 004bda0b | void * crt_string.c_memmove_FUN_005fe5e0(void * dest, void * src, SIZE_T n)
        ;   XREF to: 005fe5e0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004bda10
    JMP 0x004bd9e9                      ; 004bda13 | LAB_004bd9e9
