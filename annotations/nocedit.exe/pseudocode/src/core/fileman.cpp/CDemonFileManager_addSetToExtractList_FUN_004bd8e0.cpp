...
// Convention: __cdecl
// Signature: void __cdecl core_fileman_cpp_CDemonFileManager_addSetToExtractList_FUN_004bd8e0(CDemonFileManager *this_ptr,char *set_filename)
...

{
  ...
  core_setedit_cpp_CDemonSet_writeFileDependencies_FUN_00584e70
            (g_CDemonSetPtr,(this_ptr->base).file_ptr);
  return;
}
