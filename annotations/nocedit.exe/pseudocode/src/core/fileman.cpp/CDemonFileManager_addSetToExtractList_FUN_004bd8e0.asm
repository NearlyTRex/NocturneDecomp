...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_fileman.cpp_CDemonFileManager_addSetToExtractList_FUN_004bd8e0(CDemonFileManager * file_manager_ptr, char * set_filename)
;
; Parameters:
...
section .text
    ...
    PUSH 0x629597                       ; 004bd8ed | = "models\\%s\n" | s_models_s_00629597 = models\%s

    MOV ECX,dword ptr [EAX]             ; 004bd8f2
    PUSH ECX                            ; 004bd8f4
    CALL crt_stdio.c_fprintf_FUN_005fe6d0 ; 004bd8f5 | int crt_stdio.c_fprintf_FUN_005fe6d0(FILE * file, char * format)
        ;   XREF to: 005fe6d0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004bd8fa
    MOV EBX,dword ptr [ESP + 0x18]      ; 004bd8fd
    PUSH EBX                            ; 004bd901
    MOV ESI,dword ptr [0x006810c8]      ; 004bd902 | CDemonSet * g_CDemonSetPtr
    PUSH ESI                            ; 004bd908 | CDemonSet g_CDemonSetInstance
    CALL core_set.cpp_CDemonSet_load_FUN_00569410 ; 004bd909 | void core_set.cpp_CDemonSet_load_FUN_00569410(CDemonSet * this_ptr, char * filename)
        ;   XREF to: 00569410 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004bd90e
    MOV EAX,dword ptr [ESP + 0x14]      ; 004bd911
    MOV EDI,dword ptr [EAX]             ; 004bd915
    PUSH EDI                            ; 004bd917
    MOV EBP,dword ptr [0x006810c8]      ; 004bd918 | CDemonSet * g_CDemonSetPtr
    PUSH EBP                            ; 004bd91e | CDemonSet g_CDemonSetInstance
    CALL core_setedit.cpp_CDemonSet_FUN_00584e70 ; 004bd91f | void core_setedit.cpp_CDemonSet_FUN_00584e70(CDemonSet * this_ptr)
