...

{
  ...
  core_skeleton_cpp_CDeformableModelInstance_init_FUN_005a0840
            ((CDeformableModelInstance *)this_ptr->unk1,pcVar1);
  ...
  pcVar1 = this_ptr->unk2;
  this_ptr->unk2[0xc28] = '\0';
  this_ptr->unk2[0xc29] = '\0';
  this_ptr->unk2[0xc2a] = '\0';
  this_ptr->unk2[0xc2b] = '\0';
  core_morph_cpp_CMorph_FUN_0052b430((CMorph *)pcVar1,0);
  core_morph_cpp_CMorph_FUN_0052b430((CMorph *)pcVar1,1);
  core_morph_cpp_CMorph_getReady_FUN_0052b680((CMorph *)pcVar1);
