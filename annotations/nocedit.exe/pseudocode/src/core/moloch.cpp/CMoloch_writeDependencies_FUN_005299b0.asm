...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_moloch_cpp_CMoloch_writeDependencies_FUN_005299b0(CMoloch *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x8]       ; 005299b0
        ;   Label: core_moloch.cpp_CMoloch_writeDependencies_FUN_005299b0
    PUSH EDX                            ; 005299b4
