...

{
  ...
  fVar9 = (float)(this_ptr->base_hero).field1_0xbe24 - (float)in_stack_00000008;
  (this_ptr->base_hero).field1_0xbe24 = (int)fVar9;
  if (fVar9 < 0.0) {
    (this_ptr->base_hero).field1_0xbe24 = 0;
  }
  pCVar4 = &(this_ptr->base_hero).base_character;
  (pCVar4->model).field17_0x2254[8] = '\0';
  (pCVar4->model).field17_0x2254[9] = '\0';
  (pCVar4->model).field17_0x2254[10] = '\0';
  (pCVar4->model).field17_0x2254[0xb] = '\0';
  ...
  *(undefined4 *)(this_ptr->base_hero).base_character.model.field17_0x2254 =
       *(undefined4 *)((this_ptr->base_hero).base_character.model.field17_0x2254 + 4);
  pCVar11 = in_stack_00000008;
  while (pCVar6 = g_CGamePtr, 0.0 < (float)pCVar11) {
  ...
  *(float *)((this_ptr->base_hero).base_character.field2_0x240c + 0x2c) =
       (float)in_stack_00000008 * fVar9;
  if (pCVar6->letterbox_mode != 0) {
    *(float *)((this_ptr->base_hero).base_character.field2_0x240c + 0x2c) =
         *(float *)((this_ptr->base_hero).base_character.field2_0x240c + 0x2c) *
         (float)DOUBLE_00639e0d;
  }
  pCVar11 = this_ptr;
  ...
  if (iVar7 == 0) {
    ...
    if ((((uVar10 == 0) || (uVar10 < 2)) || (uVar10 == 2)) &&
      ...
      *(float *)((this_ptr->base_hero).base_character.field2_0x240c + 0xc) =
      ...
      iVar7 = core_motion_cpp_CMotionController_FUN_0052dab0
                        (&(this_ptr->base_hero).base_character.model.motion_controller);
      if (uVar10 != *(uint *)(iVar7 + 0x24)) goto LAB_00528e32;
    }
  }
  else {
...
LAB_00528e3a:
  ...
  if (pCVar2 == (CDemonActor *)0x0) {
    *(float *)((this_ptr->base_hero).base_character.field2_0x240c + 0x20) =
         *(float *)((this_ptr->base_hero).base_character.field2_0x240c + 0x20) -
         (float)in_stack_00000008 * (float)DOUBLE_00639e15;
    ...
    *(undefined4 *)((this_ptr->base_hero).base_character.field2_0x240c + 0x14) =
         *(undefined4 *)((this_ptr->base_hero).base_character.field2_0x240c + 0x18);
    *(undefined4 *)((this_ptr->base_hero).base_character.field2_0x240c + 0x10) =
         *(undefined4 *)((this_ptr->base_hero).base_character.field2_0x240c + 0x14);
    ...
    if ((this_ptr->base_hero).base_character.grabbed_type == 0) {
      ...
      pCVar8 = core_vehicle_cpp_convertDirectionVectorToEulerAngles_FUN_005e7830(local_44,pCVar8);
      fVar9 = core_actor_cpp_normalizeAngleToPi_FUN_0040cd70(pCVar8->y);
      if (fVar9 < (float)DOUBLE_00639e1d) {
        fVar9 = fVar9 + FLOAT_00639e25;
      }
      if ((float)DOUBLE_00639e2d < fVar9) {
        fVar9 = fVar9 + FLOAT_00639e35;
      }
      fVar3 = (float)in_stack_00000008 * (float)DOUBLE_00639e3d;
      if (fVar9 < -fVar3) {
        fVar9 = -fVar3;
      }
      if (fVar3 < fVar9) {
    ...
    fVar9 = (**(code **)(local_14 + 0x124))(pCVar2,(float)this_ptr,pCVar8);
    if (fVar9 == 0.0) {
...
LAB_00528f8e:
  ...
  if (this_ptr->morphing == 0) {
    ...
    core_motion_cpp_CMotionController_FUN_0052dab0(&pCVar1->motion_controller);
    core_motion_cpp_FUN_0052ddb0();
    core_skeleton_cpp_CDeformableModelInstance_updateAnimationAndTransforms_FUN_0059e000
              ((CDeformableModelInstance *)this_ptr->field1_0x1fbd4);
    fVar9 = this_ptr->morph_timer + (float)in_stack_00000008;
    this_ptr->morph_timer = fVar9;
    if (_DAT_00661938 < fVar9) {
      if (this_ptr->in_human_form == 0) {
      ...
      iStack0000003c =
           core_motion_cpp_CMotionController_FUN_0052dab0((CMotionController *)this_ptr_00);
      pCVar1 = &(this_ptr->base_hero).base_character.model;
      uStack0000002c = *(undefined4 *)(this_ptr->field1_0x1fbd4 + 8);
...
// 00528e60: PUSH EAX
// 00528e61: PUSH EBX
// 00528e62: CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_00408f10
...
// 00528e7e: CALL core_actor.cpp_normalizeAngleToPi_FUN_0040cd70
...
// 00528f1f: CALL core_actor.cpp_CDemonActor_updateOrientationMatrix_FUN_00408c10
...
// 00528f4a: PUSH EDI
// 00528f4b: CALL core_skeleton.cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0059fb00
...
// 00528f9d: PUSH ESI
// 00528f9e: CALL core_skeleton.cpp_CDeformableModelInstance_updateAnimation_FUN_0059e020
...
// 00528feb: CALL core_event.cpp_CEventList_evaluateCondition_FUN_004adca0
...
// 00529241: PUSH ESI
// 00529242: CALL core_motion.cpp_FUN_0052ddb0
//   XREF to: 0052ddb0 (UNCONDITIONAL_CALL)
// 00529247: ADD ESP,0xc
// 0052924a: PUSH ESI
// 0052924b: CALL core_skeleton.cpp_CDeformableModelInstance_updateAnimationAndTransforms_FUN_0059e000
...
// 005292b9: CALL core_skeleton.cpp_CDeformableModelInstance_FUN_005a1510
...
// 005292e3: CALL core_skeleton.cpp_CDeformableModelInstance_FUN_005a0840
//   XREF to: 005a0840 (UNCONDITIONAL_CALL)
// 005292e8: ADD ESP,0x8
// 005292eb: PUSH EDI
// 005292ec: CALL core_skeleton.cpp_CDeformableModelInstance_FUN_005a0450
...
// 00529302: PUSH EAX
// 00529303: PUSH EDI
// 00529304: CALL core_motion.cpp_FUN_0052ddb0
//   XREF to: 0052ddb0 (UNCONDITIONAL_CALL)
...
//   XREF to: 00639ddc (DATA)
// 00529314: PUSH ESI
// 00529315: CALL core_skeleton.cpp_CDeformableModelInstance_FUN_005a0840
//   XREF to: 005a0840 (UNCONDITIONAL_CALL)
// 0052931a: ADD ESP,0x8
// 0052931d: PUSH ESI
// 0052931e: CALL core_skeleton.cpp_CDeformableModelInstance_FUN_005a0450
//   XREF to: 005a0450 (UNCONDITIONAL_CALL)
...
// 0052932f: PUSH EBX
// 00529330: CALL core_morph.cpp_FUN_0052b430
//   XREF to: 0052b430 (UNCONDITIONAL_CALL)
// 00529335: ADD ESP,0xc
// 00529338: PUSH ESI
// 00529339: PUSH 0x1
// 0052933b: PUSH EBX
// 0052933c: CALL core_morph.cpp_FUN_0052b430
//   XREF to: 0052b430 (UNCONDITIONAL_CALL)
...
// 00529381: PUSH ESI
//   XREF to: 02d05310 (DATA)
// 00529382: CALL core_event.cpp_CEventList_evaluateCondition_FUN_004adca0
//   XREF to: 004adca0 (UNCONDITIONAL_CALL)
