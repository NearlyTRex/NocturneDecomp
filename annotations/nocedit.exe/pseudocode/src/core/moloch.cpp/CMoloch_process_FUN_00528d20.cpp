...

{
  ...
  while (pCVar5 = g_CGamePtr, 0.0 < (float)pCVar10) {
  ...
  if (iVar6 == 0) {
    ...
    if ((((uVar9 == 0) || (uVar9 < 2)) || (uVar9 == 2)) &&
      ...
      *(float *)((this_ptr->base_hero).base_character.field2_0x240c + 0xc) =
      ...
      iVar6 = core_motion_cpp_CMotionController_FUN_0052dab0
                        (&(this_ptr->base_hero).base_character.model.motion_controller);
      if (uVar9 != *(uint *)(iVar6 + 0x24)) goto LAB_00528e32;
    }
  }
  else {
    uVar9 = *(uint *)((this_ptr->base_hero).base_character.field11_0x25a0 + 0x10);
    pCVar10 = (CMoloch *)&(this_ptr->base_hero).base_character.model;
    if (uVar9 < 2) {
...
LAB_00528e32:
    core_motion_cpp_CMotionController_setDesiredState_FUN_0052db00
              ((CMotionController *)pCVar10,(int)desired_state_index,0x528e37);
  }
LAB_00528e3a:
  ...
  if (pCVar2 == (CDemonActor *)0x0) {
    ...
    *(undefined4 *)((this_ptr->base_hero).base_character.field2_0x240c + 0x10) =
    ...
    if ((this_ptr->base_hero).base_character.grabbed_type == 0) {
      ...
      if (fVar8 < (float)DOUBLE_00639e1d) {
        fVar8 = fVar8 + FLOAT_00639e25;
      }
      if ((float)DOUBLE_00639e2d < fVar8) {
        fVar8 = fVar8 + FLOAT_00639e35;
      }
...
LAB_00528f8e:
  ...
  if (this_ptr->morphing == 0) {
    ...
    if (_DAT_00661938 < fVar8) {
      ...
      pcStack0000003c =
           (char *)core_motion_cpp_CMotionController_FUN_0052dab0((CMotionController *)this_ptr_00);
      pCVar1 = &(this_ptr->base_hero).base_character.model;
      ...
      core_skeleton_cpp_CDeformableModelInstance_init_FUN_005a0840
                ((CDeformableModelInstance *)this_ptr_00,pcStack0000003c);
...
// 005292e3: CALL core_skeleton.cpp_CDeformableModelInstance_init_FUN_005a0840
//   XREF to: 005a0840 (UNCONDITIONAL_CALL)
// 005292e8: ADD ESP,0x8
// 005292eb: PUSH EDI
// 005292ec: CALL core_skeleton.cpp_CDeformableModelInstance_preCache_FUN_005a0450
...
//   XREF to: 00639ddc (DATA)
// 00529314: PUSH ESI
// 00529315: CALL core_skeleton.cpp_CDeformableModelInstance_init_FUN_005a0840
//   XREF to: 005a0840 (UNCONDITIONAL_CALL)
// 0052931a: ADD ESP,0x8
// 0052931d: PUSH ESI
// 0052931e: CALL core_skeleton.cpp_CDeformableModelInstance_preCache_FUN_005a0450
//   XREF to: 005a0450 (UNCONDITIONAL_CALL)
