...

{
  ...
  fVar10 = (float)(this_ptr->base_hero).field1_0xbe24 - delta_time;
  (this_ptr->base_hero).field1_0xbe24 = (int)fVar10;
  if (fVar10 < 0.0) {
  ...
  *(float *)((this_ptr->base_hero).base_character.field2_0x240c + 0x28) =
       (this_ptr->base_hero).base_character.model.accumulated_root_motion.z;
  *(float *)((this_ptr->base_hero).base_character.field2_0x240c + 0x2c) = delta_time * fVar10;
...
LAB_00528e3a:
  ...
  if (pCVar2 == (CDemonActor *)0x0) {
    *(float *)((this_ptr->base_hero).base_character.field2_0x240c + 0x20) =
    ...
    pcVar8 = (this_ptr->base_hero).base_character.field2_0x240c + 0x10;
    ...
    *(float *)pcVar8 = *(float *)((this_ptr->base_hero).base_character.field2_0x240c + 0x14);
    ...
    if ((this_ptr->base_hero).base_character.grabbed_type == 0) {
      ...
      (this_ptr->base_hero).base_character.base_actor.orient.bank =
           (this_ptr->base_hero).base_character.base_actor.orient.bank + fVar10;
      core_actor_cpp_CDemonActor_updateOrientationMatrix_FUN_00408c10((CDemonActor *)this_ptr);
    }
    local_14 = (((this_ptr->base_hero).base_character.grabbed_by)->vtable)._uc;
...
LAB_00528f8e:
  ...
  (*(((this_ptr->base_hero).base_character.base_actor.vtable._uc)->_uc).isDamageable)
            ((CCharacter *)this_ptr);
  ...
  if (this_ptr->morphing == 0) {
    ...
    core_motion_cpp_CMotionController_jumpToMotionByName_FUN_0052ddb0
              ((CMotionController *)this_ptr->field1_0x1fbd4,pSVar7->motion_name,
    ...
    if (2.0f < fVar10) {
      ...
      pCVar1 = &(this_ptr->base_hero).base_character.model;
      fStack_20 = *(float *)(this_ptr->field1_0x1fbd4 + 8);
