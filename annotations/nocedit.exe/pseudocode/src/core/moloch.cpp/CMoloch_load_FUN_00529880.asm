...
section .text
    ...
    PUSH EBX                            ; 00529885
    CALL core_hero.cpp_CHero_serialize_FUN_004f2610 ; 00529886
    ...
    PUSH EAX                            ; 00529899
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 0052989a
    ...
    PUSH EAX                            ; 005298ad
    CALL core_actor.cpp_serializeString_FUN_0040b5c0 ; 005298ae
        ;   XREF to: 0040b5c0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeString_FUN_0040b5c0(char * * string_buffer, char * property_type)
    ADD ESP,0x8                         ; 005298b3
    PUSH 0x639e8f                       ; 005298b6 | = "inHumanForm"
    LEA EAX,[EBX + 0x21e88]             ; 005298bb
    PUSH EAX                            ; 005298c1
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 005298c2
    ...
    PUSH EAX                            ; 005298d5
    CALL core_actor.cpp_serializeInteger_FUN_0040b7f0 ; 005298d6
        ;   XREF to: 0040b7f0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_serializeInteger_FUN_0040b7f0(int * int_ptr, char * property_name)
    ADD ESP,0x8                         ; 005298db
    PUSH 0x639ea4                       ; 005298de | = "morphTimer"
    ADD EBX,0x21e90                     ; 005298e3
    PUSH EBX                            ; 005298e9
    CALL core_actor.cpp_serializeFloat_FUN_0040b770 ; 005298ea
