...

{
  ...
  if ((*(int *)(in_stack_00000004[2].cloth_data + 0x54f0) != 0) &&
    ...
    local_40.x = (pCVar2->base_character).base_actor.location.position.x - (pCVar1->position).x;
    local_40.y = (pCVar2->base_character).base_actor.location.position.y -
                 (in_stack_00000004->base_actor).location.position.y;
    local_40.z = (pCVar2->base_character).base_actor.location.position.z -
                 (in_stack_00000004->base_actor).location.position.z;
    local_70.x = (pCVar1->position).x - (pCVar3->base_character).base_actor.location.position.x;
    local_70.y = (in_stack_00000004->base_actor).location.position.y -
                 (pCVar3->base_character).base_actor.location.position.y;
    local_70.z = (in_stack_00000004->base_actor).location.position.z -
    ...
    if (SQRT(local_70.z * local_70.z + local_70.x * local_70.x + local_70.y * local_70.y) <=
      ...
      iVar6 = (*(g_HeroActors[iVar6]->base_character).base_actor.vtable[1].processMeleeHit)
                        ((CDemonActor *)g_HeroActors[iVar6],in_stack_ffffff74);
      if ((iVar6 == 0) &&
    ...
    CStack_34.x = (pCVar2->base_character).base_actor.location.position.x -
                  (in_stack_00000004->base_actor).location.position.x;
    CStack_34.y = (pCVar2->base_character).base_actor.location.position.y -
                  (in_stack_00000004->base_actor).location.position.y;
    CStack_34.z = (pCVar2->base_character).base_actor.location.position.z -
                  (in_stack_00000004->base_actor).location.position.z;
    ...
    fStack_54 = core_actor_cpp_normalizeAngleToPi_FUN_0040cd70
                          (local_70.y - (in_stack_00000004->base_actor).orient.bank);
