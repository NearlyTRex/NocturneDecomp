...
;   core_moloch.cpp_CMoloch_processAI_FUN_005293b0
;   core_moloch.cpp_CMoloch_startMorph_FUN_00529900
...
section .text
    ...
    PUSH EAX                            ; 00528daa
    PUSH EBX                            ; 00528dab
    CALL core_charactr.cpp_CCharacter_processMotion_FUN_0042ec40 ; 00528dac
    ...
    PUSH dword ptr [EBP + 0x18]         ; 00528dfd
        ;   Label: LAB_00528dfd
    PUSH EBX                            ; 00528e00
    CALL core_charactr.cpp_CCharacter_processWalking_FUN_0042ca70 ; 00528e01
    ...
    PUSH EAX                            ; 00528e72
    CALL core_vecdir.cpp_convertDirectionVectorToEulerAngles_FUN_005e7830 ; 00528e73
    ...
    PUSH EBX                            ; 00528f8e
        ;   Label: LAB_00528f8e
    CALL core_charactr.cpp_CCharacter_preProcess_FUN_00429820 ; 00528f8f
    ...
    JZ 0x00528d3b                       ; 00528ff5
        ;   XREF to: 00528d3b (CONDITIONAL_JUMP)  ; LAB_00528d3b
    PUSH EBX                            ; 00528ffb
    CALL core_moloch.cpp_CMoloch_startMorph_FUN_00529900 ; 00528ffc
        ;   XREF to: 00529900 (UNCONDITIONAL_CALL)  ; void core_moloch.cpp_CMoloch_startMorph_FUN_00529900(CMoloch * this_ptr)
    ...
    PUSH EBX                            ; 0052905a
    CALL core_moloch.cpp_CMoloch_processAI_FUN_005293b0 ; 0052905b
        ;   XREF to: 005293b0 (UNCONDITIONAL_CALL)  ; void core_moloch.cpp_CMoloch_processAI_FUN_005293b0(CMoloch * this_ptr, float delta_time)
    ...
    PUSH EBX                            ; 00529103
        ;   Label: LAB_00529103
    CALL core_moloch.cpp_CMoloch_startMorph_FUN_00529900 ; 00529104
        ;   XREF to: 00529900 (UNCONDITIONAL_CALL)  ; void core_moloch.cpp_CMoloch_startMorph_FUN_00529900(CMoloch * this_ptr)
    ...
    PUSH EAX                            ; 00529219
    PUSH EBX                            ; 0052921a
    CALL core_charactr.cpp_CCharacter_moveAndCollide_FUN_00428f40 ; 0052921b
    ...
    JZ 0x00528d3b                       ; 0052938c
        ;   XREF to: 00528d3b (CONDITIONAL_JUMP)  ; LAB_00528d3b
    PUSH EBX                            ; 00529392
    CALL core_moloch.cpp_CMoloch_startMorph_FUN_00529900 ; 00529393
        ;   XREF to: 00529900 (UNCONDITIONAL_CALL)  ; void core_moloch.cpp_CMoloch_startMorph_FUN_00529900(CMoloch * this_ptr)
