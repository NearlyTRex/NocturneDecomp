...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_moloch.cpp_PlaySoundAbtMolochMorphing_FUN_00529900()
;
;
; XREF[1]:
...
section .text
    ...
    JZ 0x00529935                       ; 00529920 | LAB_00529935
        ;   XREF to: 00529935 (CONDITIONAL_JUMP)
    PUSH 0x639eaf                       ; 00529922 | = "moloch-morph-todemon.wav" | s_moloch_morph_todemon_wav_00639eaf = moloch-morph-todemon.wav
    MOV EDX,dword ptr [EAX + 0x154]     ; 00529927
    PUSH EAX                            ; 0052992d
    CALL dword ptr [EDX + 0x24]         ; 0052992e
    ADD ESP,0x8                         ; 00529931
    RET                                 ; 00529934
    PUSH 0x639ec8                       ; 00529935 | = "moloch-morph-tohuman.wav" | s_moloch_morph_tohuman_wav_00639ec8 = moloch-morph-tohuman.wav
        ;   Label: LAB_00529935
