...
section .text
    ...
    PUSH ESI                            ; 005297d5
    CALL core_morph.cpp_CMorph_updateModelFromDeformable_FUN_0052b600 ; 005297d6
    ...
    PUSH 0x1                            ; 005297e7
    PUSH ESI                            ; 005297e9
    CALL core_morph.cpp_CMorph_updateModelFromDeformable_FUN_0052b600 ; 005297ea
        ;   XREF to: 0052b600 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_CMorph_updateModelFromDeformable_FUN_0052b600(CMorph * this_ptr, int model_index, CDeformableModelInstance * model_ptr, int part_index)
    ...
    PUSH ESI                            ; 00529804
    CALL core_morph.cpp_CMorph_render_FUN_0052bae0 ; 00529805
    ...
    CMP dword ptr [0x02f43978],0x0      ; 0052980d | INT_02f43978
        ;   Label: LAB_0052980d
    ...
    CALL engine_drender.cpp_CDemonRenderer_isShadowPass_FUN_0048cae0 ; 0052981c
