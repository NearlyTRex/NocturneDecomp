...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dpart.cpp_CDemonPart_free_FUN_004822b0(CDemonPart * this_ptr)
;
; Parameters:
...
section .text
    ...
    JNZ 0x004822ea                      ; 004822bc | LAB_004822ea
        ;   XREF to: 004822ea (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [EBX + 0x34]      ; 004822be
        ;   Label: LAB_004822be
    TEST ESI,ESI                        ; 004822c1
    JZ 0x004822df                       ; 004822c3 | LAB_004822df
        ;   XREF to: 004822df (CONDITIONAL_JUMP)
    PUSH 0xae                           ; 004822c5
    PUSH 0x621753                       ; 004822ca | = "..\\core\\dpart.cpp" | s_core_dpart_cpp_00621753 = ..\core\dpart.cpp
    PUSH ESI                            ; 004822cf
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 004822d0 | void shape_memdbg.cpp_debugFree_FUN_0050f460(void * ptr, char * filename, int line_number)
    ...
    JNZ 0x00482306                      ; 004822e4 | LAB_00482306
    ...
    PUSH 0xa9                           ; 004822ea
        ;   Label: LAB_004822ea
    PUSH 0x621741                       ; 004822ef | = "..\\core\\dpart.cpp" | s_core_dpart_cpp_00621741 = ..\core\dpart.cpp
    PUSH EDX                            ; 004822f4
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 004822f5 | void shape_memdbg.cpp_debugFree_FUN_0050f460(void * ptr, char * filename, int line_number)
        ;   XREF to: 0050f460 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 004822fa
    MOV dword ptr [EBX + 0x2c],0x0      ; 004822fd
    JMP 0x004822be                      ; 00482304 | LAB_004822be
        ;   XREF to: 004822be (UNCONDITIONAL_JUMP)
    PUSH 0xb3                           ; 00482306
        ;   Label: LAB_00482306
    PUSH 0x621765                       ; 0048230b | = "..\\core\\dpart.cpp" | s_core_dpart_cpp_00621765 = ..\core\dpart.cpp
    PUSH EBP                            ; 00482310
    CALL shape_memdbg.cpp_debugFree_FUN_0050f460 ; 00482311 | void shape_memdbg.cpp_debugFree_FUN_0050f460(void * ptr, char * filename, int line_number)
        ;   XREF to: 0050f460 (UNCONDITIONAL_CALL)
