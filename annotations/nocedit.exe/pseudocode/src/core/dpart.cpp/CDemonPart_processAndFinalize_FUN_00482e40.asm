...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dpart.cpp_CDemonPart_processAndFinalize_FUN_00482e40(CDemonPart * this_ptr, int enable_vertex_reduction, int enable_polygon_optimize)
;
; Parameters:
...
section .text
    ...
    CALL shape_design.c_calculateVertexNormals_FUN_0045be40 ; 00482e4b | void shape_design.c_calculateVertexNormals_FUN_0045be40()
        ;   XREF to: 0045be40 (UNCONDITIONAL_CALL)
    CMP dword ptr [ESP + 0x1c],0x0      ; 00482e50
    JNZ 0x00482f7e                      ; 00482e55 | LAB_00482f7e
        ;   XREF to: 00482f7e (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x20],0x0      ; 00482e5b
        ;   Label: LAB_00482e5b
    JZ 0x00482e73                       ; 00482e60 | LAB_00482e73
        ;   XREF to: 00482e73 (CONDITIONAL_JUMP)
    PUSH -0x1                           ; 00482e62
    PUSH 0x0                            ; 00482e64
    PUSH 0x3f800000                     ; 00482e66
    CALL shape_design.c_optimizePolygonMesh_FUN_004658e0 ; 00482e6b | void shape_design.c_optimizePolygonMesh_FUN_004658e0(float angle_tolerance, int strict_mode, int display_progress)
        ;   XREF to: 004658e0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00482e70
    CALL shape_design.c_calculateVertexNormals_FUN_0045be40 ; 00482e73 | void shape_design.c_calculateVertexNormals_FUN_0045be40()
        ;   Label: LAB_00482e73
        ;   XREF to: 0045be40 (UNCONDITIONAL_CALL)
    PUSH EBX                            ; 00482e78
    CALL core_dpart.cpp_CDemonPart_free_FUN_004822b0 ; 00482e79 | void core_dpart.cpp_CDemonPart_free_FUN_004822b0(CDemonPart * this_ptr)
        ;   XREF to: 004822b0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00482e7e
    MOV EAX,[0x01626408]                ; 00482e81 | int g_VertexCount
    PUSH EBX                            ; 00482e86
    MOV dword ptr [EBX + 0x20],EAX      ; 00482e87
    MOV EAX,[0x016e990c]                ; 00482e8a | int g_PolygonCount
    XOR ESI,ESI                         ; 00482e8f
    MOV dword ptr [EBX + 0x24],EAX      ; 00482e91
    CALL core_dpart.cpp_CDemonPart_alloc_FUN_00482180 ; 00482e94 | void core_dpart.cpp_CDemonPart_alloc_FUN_00482180(CDemonPart * this_ptr)
        ;   XREF to: 00482180 (UNCONDITIONAL_CALL)
    MOV EDI,dword ptr [EBX + 0x20]      ; 00482e99
    ADD ESP,0x4                         ; 00482e9c
    TEST EDI,EDI                        ; 00482e9f
    JLE 0x00482f10                      ; 00482ea1 | LAB_00482f10
        ;   XREF to: 00482f10 (CONDITIONAL_JUMP)
    FLD double ptr [0x0062183e]         ; 00482ea3 | double g_FloatToFixedPoint256v2
    XOR ECX,ECX                         ; 00482ea9
    XOR EDX,EDX                         ; 00482eab
    FLD float ptr [ECX + 0x162640c]     ; 00482ead | SVertexData[20000] g_LoadedVertices
        ;   Label: LAB_00482ead
    MOV EAX,dword ptr [EBX + 0x2c]      ; 00482eb3
    FMUL ST1                            ; 00482eb6
    LEA EDI,[EAX + EDX*0x1]             ; 00482eb8
    CALL crt_math.c_round_FUN_005fe6b0  ; 00482ebb | double crt_math.c_round_FUN_005fe6b0(double value)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 00482ed6 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 00482ef2 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    JL 0x00482ead                       ; 00482f0c | LAB_00482ead
    ...
    JL 0x00482f1d                       ; 00482f6b | LAB_00482f1d
        ;   XREF to: 00482f1d (CONDITIONAL_JUMP)
    PUSH EBX                            ; 00482f6d
        ;   Label: LAB_00482f6d
    CALL core_dpart.cpp_CDemonPart_calculateFaceNormals_FUN_004824f0 ; 00482f6e | void core_dpart.cpp_CDemonPart_calculateFaceNormals_FUN_004824f0(CDemonPart * this_ptr)
    ...
    CALL shape_design.c_vertexReducer_FUN_00467850 ; 00482f8a | void shape_design.c_vertexReducer_FUN_00467850(float tolerance, float angle_tolerance, int display_progress)
        ;   XREF to: 00467850 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00482f8f
    JMP 0x00482e5b                      ; 00482f92 | LAB_00482e5b
        ;   XREF to: 00482e5b (UNCONDITIONAL_JUMP)
    MOV ESI,dword ptr [EBX + 0x34]      ; 00482f97
        ;   Label: LAB_00482f97
    MOV dword ptr [ESI + EAX*0x1 + 0x1c],0xffffffff ; 00482f9a
    JMP 0x00482f5c                      ; 00482fa2 | LAB_00482f5c
