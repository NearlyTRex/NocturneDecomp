...

{
  ...
  if (iVar5 == 0) {
    ...
    if (0 < this_ptr->face_count) {
      do {
        this_ptr->face_data[iVar5].plane = g_FaceConversionBuffer[iVar5].base.surface_normal;
        this_ptr->face_data[iVar5].vertex_index_1 = g_FaceConversionBuffer[iVar5].vertices[0].vertex_index;
        this_ptr->face_data[iVar5].vertex_index_2 = g_FaceConversionBuffer[iVar5].vertices[1].vertex_index;
        this_ptr->face_data[iVar5].vertex_index_3 = g_FaceConversionBuffer[iVar5].vertices[2].vertex_index;
        if (g_FaceConversionBuffer[iVar5].base.base.count == 3) {
          this_ptr->face_data[iVar5].vertex_index_4 = 0xffffffff;
        }
        else {
          this_ptr->face_data[iVar5].vertex_index_4 = g_FaceConversionBuffer[iVar5].vertices[3].vertex_index;
        }
        iVar5 = iVar5 + 1;
  ...
  if (offset_position != (CVector3f *)0x0) {
    ...
    if (0 < this_ptr->vertex_count) {
      do {
        this_ptr->vertex_positions[iVar5].x = this_ptr->vertex_positions[iVar5].x - (int)ROUND(ROUND(dVar4));
        this_ptr->vertex_positions[iVar5].y = this_ptr->vertex_positions[iVar5].y - (int)ROUND(ROUND(dVar5));
        this_ptr->vertex_positions[iVar5].z = this_ptr->vertex_positions[iVar5].z - (int)ROUND(ROUND(dVar6));
        iVar5 = iVar5 + 1;
