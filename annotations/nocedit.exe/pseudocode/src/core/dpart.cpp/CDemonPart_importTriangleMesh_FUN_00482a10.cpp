  ...
  if (triangle_count != 0) {
    ...
    if (0 < triangle_count) {
      ...
      do {
        ...
        dVar12 = crt_math_c_round_FUN_005fe6b0((double)(*pfVar10 * fVar2));
        iVar4 = local_28;
        local_18 = (int)ROUND(dVar12);
        *piVar9 = local_18;
        pCVar3 = this_ptr->vertex_positions;
        dVar12 = crt_math_c_round_FUN_005fe6b0((double)(pfVar10[1] * fVar2));
        iVar6 = local_2c;
        local_1c = (int)ROUND(dVar12);
        *(int *)((int)&pCVar3->y + iVar4) = local_1c;
        pCVar3 = this_ptr->vertex_positions;
        dVar12 = crt_math_c_round_FUN_005fe6b0((double)(pfVar10[2] * fVar2));
        iVar5 = local_28;
        ...
        *(int *)((int)&pCVar3->z + iVar6) = iStack_40;
        ...
        pCVar3 = this_ptr->vertex_positions;
        dVar12 = crt_math_c_round_FUN_005fe6b0((double)(*pfVar8 * fVar2));
        iVar4 = local_2c;
        iStack_44 = (int)ROUND(dVar12);
        *(int *)((int)&pCVar3->x + iVar5) = iStack_44;
        pCVar3 = this_ptr->vertex_positions;
        dVar12 = crt_math_c_round_FUN_005fe6b0((double)(pfVar8[1] * fVar2));
        iVar6 = local_30;
        iStack_48 = (int)ROUND(dVar12);
        *(int *)((int)&pCVar3->y + iVar4) = iStack_48;
        pCVar3 = this_ptr->vertex_positions;
        dVar12 = crt_math_c_round_FUN_005fe6b0((double)(pfVar8[2] * fVar2));
        *(int *)((int)&pCVar3->z + iVar6) = (int)ROUND(dVar12);
        ...
        pCVar3 = this_ptr->vertex_positions;
        iStack_44 = iVar6;
        dVar13 = crt_math_c_round_FUN_005fe6b0((double)pfVar8[3] * 256);
        iVar4 = iStack_50;
        local_30 = (int)ROUND(dVar13);
        pCVar3[iVar6].x = local_30;
        pCVar3 = this_ptr->vertex_positions;
        dVar13 = crt_math_c_round_FUN_005fe6b0((double)pfVar8[4] * dVar12);
        iVar6 = iStack_54;
        ...
        *(int *)((int)&pCVar3->y + iVar4) = local_34;
        ...
        local_134[2] = 'H';
        local_134[3] = '\0';
        dVar12 = crt_math_c_round_FUN_005fe6b0((double)pfVar8[5] * dVar12);
