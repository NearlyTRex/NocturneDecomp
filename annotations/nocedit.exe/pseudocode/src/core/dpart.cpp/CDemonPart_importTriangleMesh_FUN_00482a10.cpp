  ...
  if (source_triangle_count != 0) {
    ...
    if (0 < (int)triangle_data) {
      ...
      do {
        ...
        *(undefined4 *)((int)g_ModelPolygonData[0].uv_u + iVar6) = 0;
        *(undefined4 *)((int)g_ModelPolygonData[0].uv_v + iVar6) = 0;
        *(undefined4 *)((int)g_ModelPolygonData[0].uv_u + iVar6 + 4) = 0;
        *(undefined4 *)((int)g_ModelPolygonData[0].uv_v + iVar6 + 4) = 0;
        *(undefined4 *)((int)g_ModelPolygonData[0].uv_u + iVar6 + 8) = 0;
        *(undefined4 *)((int)g_ModelPolygonData[0].uv_v + iVar6 + 8) = 0;
        *(undefined4 *)((int)g_ModelPolygonData[0].uv_v + iVar6 + 0x40) = 0;
        iVar8 = iVar8 + 0x20;
