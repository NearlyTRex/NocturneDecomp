...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dpart.cpp_CDemonPart_loadFromFile_FUN_004825c0(CDemonPart * this_ptr, FILE * file_handle, CVector3f * offset_position)
;
; Parameters:
...
section .text
    ...
    PUSH 0x20                           ; 004825d2
    PUSH EBX                            ; 004825d4
    CALL crt_stdio.c_fread_FUN_005fd990 ; 004825d5 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
    ...
    PUSH EAX                            ; 004825e5
    CALL crt_stdio.c_fread_FUN_005fd990 ; 004825e6 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 004825f6
    CALL crt_stdio.c_fread_FUN_005fd990 ; 004825f7 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004825fc
    PUSH EBX                            ; 004825ff
    CALL core_dpart.cpp_CDemonPart_alloc_FUN_00482180 ; 00482600 | void core_dpart.cpp_CDemonPart_alloc_FUN_00482180(CDemonPart * this_ptr)
    ...
    PUSH EAX                            ; 00482613
    CALL crt_stdio.c_fread_FUN_005fd990 ; 00482614 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 00482627
    CALL crt_stdio.c_fread_FUN_005fd990 ; 00482628 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0048263b
    CALL crt_stdio.c_fread_FUN_005fd990 ; 0048263c | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0048264f
    CALL crt_stdio.c_fread_FUN_005fd990 ; 00482650 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ...
    CALL crt_stdio.c_fread_FUN_005fd990 ; 00482663 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [EBX + 0x38]      ; 00482668
    ADD ESP,0x10                        ; 0048266b
    TEST EDX,EDX                        ; 0048266e
    JLE 0x00482690                      ; 00482670 | LAB_00482690
    ...
    PUSH EDI                            ; 0048267a
    INC ESI                             ; 0048267b
    CALL crt_stdio.c_fread_FUN_005fd990 ; 0048267c | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 00482681
    MOV ECX,dword ptr [EBX + 0x38]      ; 00482684
    ADD EDI,0x18                        ; 00482687
    CMP ESI,ECX                         ; 0048268a
    JL 0x00482675                       ; 0048268c | LAB_00482675
    ...
    PUSH EAX                            ; 00482698
    CALL crt_stdio.c_fread_FUN_005fd990 ; 00482699 | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ...
    PUSH EDI                            ; 004826ab
    CALL crt_stdio.c_fread_FUN_005fd990 ; 004826ac | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ...
    PUSH EDX                            ; 004826be
    CALL crt_stdio.c_fread_FUN_005fd990 ; 004826bf | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004826c4
    PUSH 0x6217ef                       ; 004826c7 | = "newformat" | s_newformat_006217ef = newformat
    PUSH EBX                            ; 004826cc
    CALL crt_string.c_strcmp_FUN_005fef20 ; 004826cd | int crt_string.c_strcmp_FUN_005fef20(char * str1, char * str2)
        ;   XREF to: 005fef20 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 004826d2
    TEST EAX,EAX                        ; 004826d5
    JZ 0x00482893                       ; 004826d7 | LAB_00482893
        ;   XREF to: 00482893 (CONDITIONAL_JUMP)
    PUSH EBP                            ; 004826dd
    MOV EDI,dword ptr [EBX + 0x24]      ; 004826de
    PUSH EDI                            ; 004826e1
    PUSH 0x48                           ; 004826e2
    PUSH 0x2c14d30                      ; 004826e4 | char[72] g_PolyDataConversionBuffer
    XOR EDI,EDI                         ; 004826e9
    CALL crt_stdio.c_fread_FUN_005fd990 ; 004826eb | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    MOV EBP,dword ptr [EBX + 0x24]      ; 004826f0
    ADD ESP,0x10                        ; 004826f3
    TEST EBP,EBP                        ; 004826f6
    JLE 0x0048278a                      ; 004826f8 | LAB_0048278a
    ...
    MOV ESI,dword ptr [EDX + 0x2c14d38] ; 00482708 | DAT_02c14d38 | DAT_02c14d80
    MOV dword ptr [ECX],ESI             ; 0048270e
    MOV ESI,dword ptr [EBX + 0x34]      ; 00482710
    LEA ECX,[ESI + EAX*0x1]             ; 00482713
    MOV ESI,dword ptr [EDX + 0x2c14d3c] ; 00482716 | DAT_02c14d3c | DAT_02c14d84
    MOV dword ptr [ECX + 0x4],ESI       ; 0048271c
    MOV ECX,dword ptr [EBX + 0x34]      ; 0048271f
    MOV ESI,dword ptr [EDX + 0x2c14d40] ; 00482722 | DAT_02c14d40 | DAT_02c14d88
    MOV dword ptr [ECX + EAX*0x1 + 0x8],ESI ; 00482728
    MOV ECX,dword ptr [EBX + 0x34]      ; 0048272c
    MOV ESI,dword ptr [EDX + 0x2c14d44] ; 0048272f | DAT_02c14d44 | DAT_02c14d8c
    MOV dword ptr [ECX + EAX*0x1 + 0xc],ESI ; 00482735
    MOV ECX,dword ptr [EBX + 0x34]      ; 00482739
    MOV ESI,dword ptr [EDX + 0x2c14d48] ; 0048273c | DAT_02c14d48 | DAT_02c14d90
    MOV dword ptr [ECX + EAX*0x1 + 0x10],ESI ; 00482742
    MOV ECX,dword ptr [EBX + 0x34]      ; 00482746
    MOV ESI,dword ptr [EDX + 0x2c14d54] ; 00482749 | DAT_02c14d54
    MOV dword ptr [ECX + EAX*0x1 + 0x14],ESI ; 0048274f
    MOV ECX,dword ptr [EBX + 0x34]      ; 00482753
    MOV ESI,dword ptr [EDX + 0x2c14d60] ; 00482756 | DAT_02c14d60
    MOV dword ptr [ECX + EAX*0x1 + 0x18],ESI ; 0048275c
    CMP dword ptr [EDX + 0x2c14d34],0x3 ; 00482760 | DAT_02c14d34
    JNZ 0x0048287f                      ; 00482767 | LAB_0048287f
    ...
    JL 0x00482702                       ; 00482784 | LAB_00482702
        ;   XREF to: 00482702 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [ESP + 0x28]      ; 0048278a
        ;   Label: LAB_0048278a
    TEST EDI,EDI                        ; 0048278e
    JZ 0x00482810                       ; 00482790 | LAB_00482810
        ;   XREF to: 00482810 (CONDITIONAL_JUMP)
    FLD double ptr [0x006217fe]         ; 00482796 | double g_WorldToVertexScale
    ...
    FXCH                                ; 004827af
    CALL crt_math.c_round_FUN_005fe6b0  ; 004827b1 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH                                ; 004827b6
    CALL crt_math.c_round_FUN_005fe6b0  ; 004827b8 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH ST2                            ; 004827bd
    CALL crt_math.c_round_FUN_005fe6b0  ; 004827bf | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FXCH ST2                            ; 004827c4
    ...
    JLE 0x00482810                      ; 004827d5 | LAB_00482810
        ;   XREF to: 00482810 (CONDITIONAL_JUMP)
    ...
    JL 0x004827d9                       ; 00482801 | LAB_004827d9
    ...
    PUSH EBX                            ; 00482810
        ;   Label: LAB_00482810
    CALL core_dpart.cpp_CDemonPart_calculateFaceNormals_FUN_004824f0 ; 00482811 | void core_dpart.cpp_CDemonPart_calculateFaceNormals_FUN_004824f0(CDemonPart * this_ptr)
        ;   XREF to: 004824f0 (UNCONDITIONAL_CALL)
    FLD double ptr [0x00621806]         ; 00482816 | double g_VertexToWorldScale
    ...
    MOV ESI,dword ptr [EDX + 0x2c14d6c] ; 00482885 | DAT_02c14d6c
    MOV dword ptr [ECX + 0x1c],ESI      ; 0048288b
    JMP 0x00482778                      ; 0048288e | LAB_00482778
    ...
    PUSH ESI                            ; 0048289d
    CALL crt_stdio.c_fread_FUN_005fd990 ; 0048289e | SIZE_T crt_stdio.c_fread_FUN_005fd990(void * buffer, SIZE_T size, SIZE_T count, FILE * file)
        ;   XREF to: 005fd990 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 004828a3
    JMP 0x0048278a                      ; 004828a6 | LAB_0048278a
