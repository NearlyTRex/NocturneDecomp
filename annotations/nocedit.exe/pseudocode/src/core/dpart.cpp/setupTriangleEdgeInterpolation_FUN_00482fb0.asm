...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_dpart.cpp_setupTriangleEdgeInterpolation_FUN_00482fb0(SEdgeData * vertex_a, SEdgeData * vertex_b)
;
; Parameters:
...
section .text
    ...
    MOV EAX,[0x02c6cb70]                ; 00482fe7 | int g_RenderTriangleEdgeCount
        ;   Label: LAB_00482fe7
    LEA ECX,[EAX*0x8 + 0x0]             ; 00482fec
    ADD ECX,EAX                         ; 00482ff3
    SHL ECX,0x3                         ; 00482ff5
    ADD ECX,0x2c6cb74                   ; 00482ff8 | SEdgeData[16] g_EdgeInterpolationArray
    MOV dword ptr [ECX],EDI             ; 00482ffe | SEdgeData[16] g_EdgeInterpolationArray
    MOV EAX,[0x02c6cff4]                ; 00483000 | int g_RenderTriangleMinScanlineY
    MOV dword ptr [ECX + 0x4],EBX       ; 00483005 | DAT_02c6cb78
    CMP EDI,EAX                         ; 00483008
    JGE 0x00483012                      ; 0048300a | LAB_00483012
        ;   XREF to: 00483012 (CONDITIONAL_JUMP)
    MOV dword ptr [0x02c6cff4],EDI      ; 0048300c | int g_RenderTriangleMinScanlineY
    CMP EBX,dword ptr [0x02c6cff8]      ; 00483012 | int g_RenderTriangleMaxScanlineY
        ;   Label: LAB_00483012
    JLE 0x00483020                      ; 00483018 | LAB_00483020
        ;   XREF to: 00483020 (CONDITIONAL_JUMP)
    MOV dword ptr [0x02c6cff8],EBX      ; 0048301a | int g_RenderTriangleMaxScanlineY
    MOV EDI,dword ptr [ESI + 0x14]      ; 00483020
        ;   Label: LAB_00483020
    MOV EBX,dword ptr [EBP + 0x14]      ; 00483023
    SUB EBX,EDI                         ; 00483026
    CMP EBX,0x10000                     ; 00483028
    JNC 0x004831c7                      ; 0048302e | LAB_004831c7
    ...
    CMP dword ptr [0x00772a74],0x0      ; 00483124 | int g_TexturesDisabled
    JZ 0x004831d7                       ; 0048312b | LAB_004831d7
    ...
    JZ 0x004831b9                       ; 00483165 | LAB_004831b9
    ...
    INC dword ptr [0x02c6cb70]          ; 004831b9 | int g_RenderTriangleEdgeCount
        ;   Label: LAB_004831b9
    ...
    JMP 0x00483036                      ; 004831d2 | LAB_00483036
    ...
    JMP 0x00483159                      ; 004831ff | LAB_00483159
