...

{
  ...
  if (0 < this_ptr->vertex_count) {
    ...
    do {
      ...
      dVar7 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44 /* combine 2-byte values */(iVar3,pCVar1));
      ...
      *(int *)((int)&pCVar1->x + iVar3) = (int)ROUND(fVar6);
      ...
      dVar7 = crt_math_c_round_FUN_005fe6b0((double)CONCAT44 /* combine 2-byte values */(iVar2,pCVar1));
