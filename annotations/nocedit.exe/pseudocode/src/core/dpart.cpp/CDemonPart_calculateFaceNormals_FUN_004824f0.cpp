...

{
  ...
  if (0 < this_ptr->face_count) {
    ...
    do {
      ...
      local_48.base.surface_normal.A = *(int *)((int)&(this_ptr->face_data->plane).A + iVar1);
      local_48.base.surface_normal.B = *(int *)((int)&(this_ptr->face_data->plane).B + iVar1);
      local_48.base.surface_normal.C = *(int *)((int)&(this_ptr->face_data->plane).C + iVar1);
      local_48.base.surface_normal.D = *(int *)((int)&(this_ptr->face_data->plane).D + iVar1);
      ...
      *(int *)((int)&(this_ptr->face_data->plane).A + iVar1) = local_48.base.surface_normal.A;
      *(int *)((int)&(this_ptr->face_data->plane).B + iVar1) = local_48.base.surface_normal.B;
      *(int *)((int)&(this_ptr->face_data->plane).C + iVar1) = local_48.base.surface_normal.C;
      *(int *)((int)&(this_ptr->face_data->plane).D + iVar1) = local_48.base.surface_normal.D;
      iVar2 = iVar2 + 1;
      iVar1 = iVar1 + 0x20;
