...
section .text
    ...
    PUSH EBX                            ; 0056e3e0
        ;   Label: core_set.cpp_CDemonSet_computeVertexOmniLighting_FUN_0056e3e0
    PUSH ESI                            ; 0056e3e1
    PUSH EBP                            ; 0056e3e2
    ...
    MOV EAX,[0x03277d80]                ; 0056e41c | g_OmniLightCount
    ...
    CMP dword ptr [0x03277d80],0x0      ; 0056e44d | g_OmniLightCount
        ;   Label: LAB_0056e44d
