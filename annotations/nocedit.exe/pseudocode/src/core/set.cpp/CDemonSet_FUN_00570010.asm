...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_set.cpp_CDemonSet_FUN_00570010(CDemonSet * this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH ESI                            ; 00570027
    CALL core_set.cpp_CDemonSet_FUN_00570040 ; 00570028 | void core_set.cpp_CDemonSet_FUN_00570040(CDemonSet * this_ptr)
