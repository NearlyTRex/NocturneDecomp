...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_set.cpp_CDemonSet_process_FUN_0056f940(CDemonSet * this_ptr)
;
; Parameters:
...
section .text
    ...
    JLE 0x0056f98a                      ; 0056f95b | LAB_0056f98a
    ...
    JZ 0x0056f995                       ; 0056f970 | LAB_0056f995
    ...
    JL 0x0056f96a                       ; 0056f988 | LAB_0056f96a
    ...
    MOV EBX,dword ptr [ESP + 0x104]     ; 0056f995
        ;   Label: LAB_0056f995
    MOV EBX,dword ptr [EBX + 0x3276db0] ; 0056f99c | CDemonLight *[96] g_MasterLightList
    TEST EBX,EBX                        ; 0056f9a2
    JZ 0x0056f98a                       ; 0056f9a4 | LAB_0056f98a
        ;   XREF to: 0056f98a (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x03276f30]      ; 0056f9a6 | int g_ActiveLightCount
    MOV dword ptr [ESP + 0x100],EAX     ; 0056f9ac
    TEST ECX,ECX                        ; 0056f9b3
    JLE 0x0056f9d5                      ; 0056f9b5 | LAB_0056f9d5
        ;   XREF to: 0056f9d5 (CONDITIONAL_JUMP)
    LEA EDX,[ECX*0x4 + 0x0]             ; 0056f9b7
    CMP EBX,dword ptr [EAX + 0x3276f34] ; 0056f9be | CDemonLight *[96] g_ActiveLightList
        ;   Label: LAB_0056f9be
    JNZ 0x0056fa91                      ; 0056f9c4 | LAB_0056fa91
    ...
    PUSH EBX                            ; 0056f9dd
    PUSH ESI                            ; 0056f9de
    CALL core_setutil.cpp_C3DSLight_process_FUN_00586cb0 ; 0056f9df | void core_setutil.cpp_C3DSLight_process_FUN_00586cb0(C3DSLight * this_ptr, CDemonLight * light, int apply_filter_flag)
        ;   XREF to: 00586cb0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0056f9e4
    LEA EAX,[ESI + 0x4]                 ; 0056f9e7
    PUSH EAX                            ; 0056f9ea
    PUSH 0x645fdb                       ; 0056f9eb | = "%son" | s_son_00645fdb = %son
    LEA EAX,[ESP + 0x8]                 ; 0056f9f0
    PUSH EAX                            ; 0056f9f4
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0056f9f5 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0056f9fa
    MOV EAX,ESP                         ; 0056f9fd
    PUSH EAX                            ; 0056f9ff
    MOV ECX,dword ptr [0x006793d0]      ; 0056fa00 | CEventList g_CEventListInstance | CEventList * g_CEventListPtr
    PUSH ECX                            ; 0056fa06 | CEventList g_CEventListInstance
    CALL core_event.cpp_CEventList_evaluateCondition_FUN_004adca0 ; 0056fa07 | int core_event.cpp_CEventList_evaluateCondition_FUN_004adca0(CEventList * this_ptr, char * condition_expression)
        ;   XREF to: 004adca0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0056fa0c
    TEST EAX,EAX                        ; 0056fa0f
    JZ 0x0056fa1d                       ; 0056fa11 | LAB_0056fa1d
        ;   XREF to: 0056fa1d (CONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0x1cb4],0x1    ; 0056fa13
    LEA EAX,[ESI + 0x4]                 ; 0056fa1d
        ;   Label: LAB_0056fa1d
    PUSH EAX                            ; 0056fa20
    PUSH 0x645fe0                       ; 0056fa21 | = "%soff" | s_soff_00645fe0 = %soff
    LEA EAX,[ESP + 0x8]                 ; 0056fa26
    PUSH EAX                            ; 0056fa2a
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0056fa2b | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0056fa30
    MOV EAX,ESP                         ; 0056fa33
    PUSH EAX                            ; 0056fa35
    MOV EAX,[0x006793d0]                ; 0056fa36 | CEventList g_CEventListInstance | CEventList * g_CEventListPtr
    PUSH EAX                            ; 0056fa3b | CEventList g_CEventListInstance
    CALL core_event.cpp_CEventList_evaluateCondition_FUN_004adca0 ; 0056fa3c | int core_event.cpp_CEventList_evaluateCondition_FUN_004adca0(CEventList * this_ptr, char * condition_expression)
        ;   XREF to: 004adca0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0056fa41
    TEST EAX,EAX                        ; 0056fa44
    JZ 0x0056fa52                       ; 0056fa46 | LAB_0056fa52
        ;   XREF to: 0056fa52 (CONDITIONAL_JUMP)
    MOV dword ptr [EBX + 0x1cb4],0x0    ; 0056fa48
    PUSH 0x4                            ; 0056fa52
        ;   Label: LAB_0056fa52
    PUSH 0x645fe6                       ; 0056fa54 | = "moon" | s_moon_00645fe6 = moon
    ADD ESI,0x4                         ; 0056fa59
    PUSH ESI                            ; 0056fa5c
    CALL crt_string.c_strnicmp_FUN_005ff070 ; 0056fa5d | int crt_string.c_strnicmp_FUN_005ff070(char * str1, char * str2, int count)
        ;   XREF to: 005ff070 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0056fa62
    TEST EAX,EAX                        ; 0056fa65
    JNZ 0x0056fa84                      ; 0056fa67 | LAB_0056fa84
