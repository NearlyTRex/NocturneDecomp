...

{
  ...
  if (g_CGamePtr->render_mode == 2) {
    ...
    lVar4 = (longlong)(0xffff - (int)g_PerspectiveReciprocal) * (longlong)alpha;
    ...
    do {
      ...
      if (0 < SStack_f4.base.count) {
        ...
        do {
          ...
          *(int *)((int)&local_ac + iVar4) = 0x8000 - (int)ROUND(fVar2);
          iVar4 = iVar4 + 4;
        } while (iVar7 < SStack_f4.base.count);
      }
      if (1 < SStack_f4.base.count) {
        ...
        do {
          ...
          iVar7 = iVar7 + 4;
        } while (iVar7 < SStack_f4.base.count * 4);
      }
      iVar7 = 0;
      if (0 < SStack_f4.base.count) {
        iVar4 = 0;
        iVar6 = 0;
        do {
          *(int *)((int)aiStack_dc + iVar6 + 4) = *(int *)((int)&local_6c + iVar4) << 8;
          *(int *)((int)aiStack_dc + iVar6 + 8) = *(int *)((int)&local_ac + iVar4) << 8;
          iVar7 = iVar7 + 1;
          iVar4 = iVar4 + 4;
          iVar6 = iVar6 + 0xc;
        } while (iVar7 < SStack_f4.base.count);
