...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_set_cpp_CDemonSet_FUN_0056c1a0(CDemonSet *this_ptr)
;
; Parameters:
...
section .text
    ...
    XOR ECX,ECX                         ; 0056c3b1
        ;   Label: LAB_0056c3b1
    MOV EDI,dword ptr [0x0327785c]      ; 0056c3b3 | DAT_0327785c
    MOV dword ptr [EBP + -0x14],ECX     ; 0056c3b9
    MOV dword ptr [0x03277b80],ECX      ; 0056c3bc | DAT_03277b80
    TEST EDI,EDI                        ; 0056c3c2
    JLE 0x0056c414                      ; 0056c3c4
        ;   XREF to: 0056c414 (CONDITIONAL_JUMP)  ; LAB_0056c414
    XOR ESI,ESI                         ; 0056c3c6
    MOV EAX,dword ptr [ESI + 0x32779f0] ; 0056c3c8 | DAT_032779f0 | DAT_032779f4
        ;   Label: LAB_0056c3c8
    MOV EDI,dword ptr [ESI + 0x3277860] ; 0056c3ce | DAT_03277860 | DAT_03277864
    ...
    CALL core_dcamera.cpp_CDemonCamera_renderLightCoronas_FUN_004518f0 ; 0056c3e3
        ;   XREF to: 004518f0 (UNCONDITIONAL_CALL)  ; void core_dcamera.cpp_CDemonCamera_renderLightCoronas_FUN_004518f0(CDemonCamera * this_ptr, void * p1, int p2)
    MOV EAX,[0x03277b80]                ; 0056c3e8 | DAT_03277b80
    MOV dword ptr [EAX*0x4 + 0x3277b84],EDI ; 0056c3ed | DAT_03277b84
    LEA EDI,[EAX + 0x1]                 ; 0056c3f4
    ADD ESP,0xc                         ; 0056c3f7
    MOV dword ptr [0x03277b80],EDI      ; 0056c3fa | DAT_03277b80
    MOV EDI,dword ptr [EBP + -0x14]     ; 0056c400
        ;   Label: LAB_0056c400
    MOV EDX,dword ptr [0x0327785c]      ; 0056c403 | DAT_0327785c
    INC EDI                             ; 0056c409
    ...
    XOR ECX,ECX                         ; 0056c414
        ;   Label: LAB_0056c414
    MOV dword ptr [0x0327785c],ECX      ; 0056c416 | DAT_0327785c
    ...
    PUSH EBX                            ; 0056c4e5
        ;   Label: LAB_0056c4e5
    CALL core_set.cpp_CDemonSet_FUN_0056cf00 ; 0056c4e6
