...
section .text
    ...
    JZ 0x0056d42c                       ; 0056d398 | LAB_0056d42c
        ;   XREF to: 0056d42c (CONDITIONAL_JUMP)
    PUSH EDI                            ; 0056d39e
    CMP EAX,0x32c1c68                   ; 0056d39f | undefined4 DAT_032c1c68
    JNZ 0x0056d433                      ; 0056d3a4 | LAB_0056d433
        ;   XREF to: 0056d433 (CONDITIONAL_JUMP)
    CMP ECX,0x32c1c74                   ; 0056d3aa | DAT_032c1c74
        ;   Label: LAB_0056d3aa
    JZ 0x0056d3cb                       ; 0056d3b0 | LAB_0056d3cb
    ...
    CMP EDX,0x32c1c80                   ; 0056d3cb | DAT_032c1c80
        ;   Label: LAB_0056d3cb
    JZ 0x0056d3ec                       ; 0056d3d1 | LAB_0056d3ec
    ...
    CMP EBX,0x32c1c8c                   ; 0056d3ec | DAT_032c1c8c
        ;   Label: LAB_0056d3ec
    JZ 0x0056d40d                       ; 0056d3f2 | LAB_0056d40d
    ...
    TEST ESI,ESI                        ; 0056d40d
        ;   Label: LAB_0056d40d
    JZ 0x0056d452                       ; 0056d40f | LAB_0056d452
        ;   XREF to: 0056d452 (CONDITIONAL_JUMP)
    MOV ECX,0xa                         ; 0056d411
    MOV EDI,0x32c1c98                   ; 0056d416 | undefined4 DAT_032c1c98
    MOVSD.REP ES:EDI,ESI                ; 0056d41b | undefined4 DAT_032c1c98 | DAT_032c1c9c
    MOV EDX,0x2                         ; 0056d41d
    POP EDI                             ; 0056d422
    MOV dword ptr [0x032c1c64],EDX      ; 0056d423 | int g_LightingSystemDirty
        ;   Label: LAB_0056d423
    POP ESI                             ; 0056d429
    POP EBX                             ; 0056d42a
    RET                                 ; 0056d42b
    MOV EDX,0x1                         ; 0056d42c
        ;   Label: LAB_0056d42c
    JMP 0x0056d423                      ; 0056d431 | LAB_0056d423
    ...
    MOV dword ptr [0x032c1c6c],EDI      ; 0056d43b | undefined4 DAT_032c1c6c
    FSTP float ptr [0x032c1c70]         ; 0056d441 | undefined4 DAT_032c1c70
    FSTP float ptr [0x032c1c68]         ; 0056d447 | undefined4 DAT_032c1c68
    JMP 0x0056d3aa                      ; 0056d44d | LAB_0056d3aa
        ;   XREF to: 0056d3aa (UNCONDITIONAL_JUMP)
    MOV EDX,0x3f800000                  ; 0056d452
        ;   Label: LAB_0056d452
    MOV dword ptr [0x032c1c9c],ESI      ; 0056d457 | undefined4 DAT_032c1c9c
    ...
    MOV dword ptr [0x032c1c98],EDX      ; 0056d487 | undefined4 DAT_032c1c98
    MOV EDX,0x2                         ; 0056d48d
    POP EDI                             ; 0056d492
    MOV dword ptr [0x032c1c64],EDX      ; 0056d493 | int g_LightingSystemDirty
    POP ESI                             ; 0056d499
    POP EBX                             ; 0056d49a
    RET                                 ; 0056d49b
