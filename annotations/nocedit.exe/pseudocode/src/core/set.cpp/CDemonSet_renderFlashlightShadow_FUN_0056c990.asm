...
section .text
    ...
    CALL core_set.cpp_CDemonSet_buildDisplayList_FUN_0056fbd0 ; 0056cb0d
    ...
    PUSH 0x1                            ; 0056cb15
    PUSH EDI                            ; 0056cb17
    CALL core_set.cpp_CDemonSet_renderBackgroundActors_FUN_0056aca0 ; 0056cb18
    ...
    CALL core_set.cpp_CDemonSet_buildDisplayList_FUN_0056fbd0 ; 0056cb27
        ;   XREF to: 0056fbd0 (UNCONDITIONAL_CALL)  ; void core_set.cpp_CDemonSet_buildDisplayList_FUN_0056fbd0(CDemonSet * this_ptr, uint dirty_flags_mask)
    ...
    PUSH 0x0                            ; 0056cbcc
    PUSH EDI                            ; 0056cbce
    CALL core_set.cpp_CDemonSet_setLightingParameters_FUN_0056d380 ; 0056cbcf
