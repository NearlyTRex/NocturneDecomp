...
section .text
    ...
    JLE 0x00570c4c                      ; 00570b8f | LAB_00570c4c
    ...
    PUSH EAX                            ; 00570ba4
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 00570ba5 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 00570baa
    ADD ESP,0x8                         ; 00570bac
    TEST EAX,EAX                        ; 00570baf
    JZ 0x00570c3a                       ; 00570bb1 | LAB_00570c3a
        ;   XREF to: 00570c3a (CONDITIONAL_JUMP)
    CMP dword ptr [EAX + 0x1e8],0x0     ; 00570bb7
    JZ 0x00570c3a                       ; 00570bbe | LAB_00570c3a
        ;   XREF to: 00570c3a (CONDITIONAL_JUMP)
    PUSH EBX                            ; 00570bc4
    CALL core_actor.cpp_CDemonActor_setupRenderState_FUN_00408b00 ; 00570bc5 | void core_actor.cpp_CDemonActor_setupRenderState_FUN_00408b00(CDemonActor * actor)
    ...
    PUSH EAX                            ; 00570bdd
    CALL core_box.cpp_CBoundingBox3D_isVisible_FUN_004204f0 ; 00570bde | int core_box.cpp_CBoundingBox3D_isVisible_FUN_004204f0(CBoundingBox3D * this_ptr)
        ;   XREF to: 004204f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00570be3
    TEST EAX,EAX                        ; 00570be6
    JZ 0x00570c2b                       ; 00570be8 | LAB_00570c2b
    ...
    JL 0x00570c2b                       ; 00570c07 | LAB_00570c2b
        ;   XREF to: 00570c2b (CONDITIONAL_JUMP)
    MOV EBX,0x64602b                    ; 00570c09 | = "..\\core\\set.cpp" | s_core_set_cpp_0064602b = ..\core\set.cpp
    MOV EAX,0x11d4                      ; 00570c0e
    PUSH 0x64603b                       ; 00570c13 | = "CDemonSet::buildMirrorList - Too many..." | s_CDemonSet_buildMirrorLis_0064603b = CDemonSet::buildMirrorList - Too many mirrors
    MOV dword ptr [0x02f0ca48],EBX      ; 00570c18 | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 00570c1e | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 00570c23 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 00570c28
    MOV EDX,dword ptr [0x006703ec]      ; 00570c2b | CDemonRenderer * g_CDemonRendererPtr
        ;   Label: LAB_00570c2b
    PUSH EDX                            ; 00570c31 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_matrixPop_FUN_0050d720 ; 00570c32 | void engine_drender.cpp_CDemonRenderer_matrixPop_FUN_0050d720()
    ...
    JL 0x00570b97                       ; 00570c46 | LAB_00570b97
