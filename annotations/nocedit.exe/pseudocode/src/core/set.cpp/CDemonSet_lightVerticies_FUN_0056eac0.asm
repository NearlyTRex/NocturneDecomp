...
;                               FUNCTION
; *****************************************************************************
; __cdecl float core_set.cpp_CDemonSet_lightVerticies_FUN_0056eac0(CDemonSet * this_ptr, int vertex_count, int tri_count, SInputFace * tri_data_ptr, int render_flags, int lighting_mode, int flags)
;
; Parameters:
...
section .text
    ...
    JLE 0x0056eb03                      ; 0056ead8 | LAB_0056eb03
        ;   XREF to: 0056eb03 (CONDITIONAL_JUMP)
    PUSH 0x4e20                         ; 0056eada
    PUSH EDX                            ; 0056eadf
    MOV ECX,0x645efa                    ; 0056eae0 | = "..\\core\\set.cpp" | s_core_set_cpp_00645efa = ..\core\set.cpp
    MOV EBX,0xde8                       ; 0056eae5
    PUSH 0x645f0a                       ; 0056eaea | = "CDemonSet::lightVerticies - tried to ..." | s_CDemonSet_lightVerticies_00645f0a = CDemonSet::lightVerticies - tried to light %d vertices, but GLOBAL_VERTEX_COUNT = %d
    MOV dword ptr [0x02f0ca48],ECX      ; 0056eaef | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 0056eaf5 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0056eafb | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0056eb00
    MOV EDI,dword ptr [0x006703ec]      ; 0056eb03 | CDemonRenderer * g_CDemonRendererPtr
        ;   Label: LAB_0056eb03
    PUSH EDI                            ; 0056eb09 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_getFaceCount_FUN_0048cae0 ; 0056eb0a | int engine_drender.cpp_CDemonRenderer_getFaceCount_FUN_0048cae0(CDemonRenderer * this_ptr)
        ;   XREF to: 0048cae0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0056eb0f
    TEST EAX,EAX                        ; 0056eb12
    JNZ 0x0056eb80                      ; 0056eb14 | LAB_0056eb80
    ...
    JZ 0x0056ec78                       ; 0056eb34 | LAB_0056ec78
        ;   XREF to: 0056ec78 (CONDITIONAL_JUMP)
    CMP dword ptr [0x032bd77c],0x0      ; 0056eb3a | int g_InMirrorRenderPass
    JZ 0x0056eb87                       ; 0056eb41 | LAB_0056eb87
        ;   XREF to: 0056eb87 (CONDITIONAL_JUMP)
    CMP dword ptr [EBP + 0x18],0x0      ; 0056eb43
    JLE 0x0056eb70                      ; 0056eb47 | LAB_0056eb70
    ...
    MOV dword ptr [EAX + 0x688004],EBX  ; 0056eb52 | g_RenderVertexBuffer[0].light
    MOV dword ptr [EAX + 0x688008],EBX  ; 0056eb58 | g_RenderVertexBuffer[0].color
    MOV dword ptr [EAX + 0x68800c],EBX  ; 0056eb5e | g_RenderVertexBuffer[0].fog
    MOV dword ptr [EAX + 0x688010],EBX  ; 0056eb64 | g_RenderVertexBuffer[0].w_recip
    CMP EAX,EDX                         ; 0056eb6a
    JL 0x0056eb4d                       ; 0056eb6c | LAB_0056eb4d
        ;   XREF to: 0056eb4d (CONDITIONAL_JUMP)
    MOV EAX,EAX                         ; 0056eb6e
    XOR EBX,EBX                         ; 0056eb70
        ;   Label: LAB_0056eb70
    MOV dword ptr [0x02d051f4],EBX      ; 0056eb72 | float g_PerspectiveReciprocal
    ...
    PUSH EAX                            ; 0056ebb0
    MOV dword ptr [ESI + 0x688010],ECX  ; 0056ebb1 | g_RenderVertexBuffer[0].w_recip
    CALL core_set.cpp_CDemonSet_lightVertexColor_FUN_0056ddb0 ; 0056ebb7 | void core_set.cpp_CDemonSet_lightVertexColor_FUN_0056ddb0(CDemonSet * this_ptr, CVector3i * world_position, CVector3i * surface_normal, int vertex_index, ...)
    ...
    JL 0x0056eba3                       ; 0056ebc8 | LAB_0056eba3
        ;   XREF to: 0056eba3 (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 0056ebca
    XOR ECX,ECX                         ; 0056ebd0
        ;   Label: LAB_0056ebd0
    MOV dword ptr [0x02d051f4],ECX      ; 0056ebd2 | float g_PerspectiveReciprocal
    ...
    CMP EDX,0x3                         ; 0056ebdf
        ;   Label: LAB_0056ebdf
    JNZ 0x0056ec39                      ; 0056ebe2 | LAB_0056ec39
        ;   XREF to: 0056ec39 (CONDITIONAL_JUMP)
    CMP dword ptr [EBP + 0x18],0x0      ; 0056ebe4
    JLE 0x0056ebd0                      ; 0056ebe8 | LAB_0056ebd0
        ;   XREF to: 0056ebd0 (CONDITIONAL_JUMP)
    ...
    MOV dword ptr [EAX + 0x688034],EDX  ; 0056ebf7 | g_RenderVertexBuffer[0].light
    MOV EDX,dword ptr [EBP + 0x14]      ; 0056ebfd
    MOV EDX,dword ptr [EDX + 0x15ae8c]  ; 0056ec00
    MOV dword ptr [EAX + 0x688038],EDX  ; 0056ec06 | g_RenderVertexBuffer[0].color
    MOV EDX,dword ptr [EBP + 0x14]      ; 0056ec0c
    ADD EAX,0x30                        ; 0056ec0f
    MOV EDX,dword ptr [EDX + 0x15ae90]  ; 0056ec12
    MOV dword ptr [EAX + 0x68800c],EDX  ; 0056ec18 | g_RenderVertexBuffer[0].fog
    XOR EDX,EDX                         ; 0056ec1e
    MOV dword ptr [EAX + 0x688010],EDX  ; 0056ec20 | g_RenderVertexBuffer[0].w_recip
    CMP EAX,ECX                         ; 0056ec26
    JL 0x0056ebee                       ; 0056ec28 | LAB_0056ebee
        ;   XREF to: 0056ebee (CONDITIONAL_JUMP)
    XOR ECX,ECX                         ; 0056ec2a
    MOV dword ptr [0x02d051f4],ECX      ; 0056ec2c | float g_PerspectiveReciprocal
    ...
    CMP dword ptr [EBP + 0x18],0x0      ; 0056ec39
        ;   Label: LAB_0056ec39
    JLE 0x0056ebd0                      ; 0056ec3d | LAB_0056ebd0
        ;   XREF to: 0056ebd0 (CONDITIONAL_JUMP)
    ...
    ADD EAX,0x30                        ; 0056ec48
        ;   Label: LAB_0056ec48
    MOV dword ptr [EAX + 0x688004],ECX  ; 0056ec4b | g_RenderVertexBuffer[0].light
    MOV dword ptr [EAX + 0x688008],ECX  ; 0056ec51 | g_RenderVertexBuffer[0].color
    XOR EDI,EDI                         ; 0056ec57
    MOV dword ptr [EAX + 0x68800c],ECX  ; 0056ec59 | g_RenderVertexBuffer[0].fog
    MOV dword ptr [EAX + 0x688010],EDI  ; 0056ec5f | g_RenderVertexBuffer[0].w_recip
    CMP EAX,EDX                         ; 0056ec65
    JL 0x0056ec48                       ; 0056ec67 | LAB_0056ec48
        ;   XREF to: 0056ec48 (CONDITIONAL_JUMP)
    XOR ECX,ECX                         ; 0056ec69
    MOV dword ptr [0x02d051f4],ECX      ; 0056ec6b | float g_PerspectiveReciprocal
    ...
    JZ 0x0056eccb                       ; 0056ec80 | LAB_0056eccb
        ;   XREF to: 0056eccb (CONDITIONAL_JUMP)
    CMP dword ptr [EBP + 0x18],0x0      ; 0056ec82
    JLE 0x0056eb80                      ; 0056ec86 | LAB_0056eb80
        ;   XREF to: 0056eb80 (CONDITIONAL_JUMP)
    ...
    MOV dword ptr [EAX + 0x688034],EDX  ; 0056ec99 | g_RenderVertexBuffer[0].light
    MOV EDX,dword ptr [EBP + 0x14]      ; 0056ec9f
    MOV EDX,dword ptr [EDX + 0x161660]  ; 0056eca2
    MOV dword ptr [EAX + 0x688038],EDX  ; 0056eca8 | g_RenderVertexBuffer[0].color
    MOV EDX,dword ptr [EBP + 0x14]      ; 0056ecae
    ADD EAX,0x30                        ; 0056ecb1
    MOV EDX,dword ptr [EDX + 0x161664]  ; 0056ecb4
    MOV dword ptr [EAX + 0x68800c],EDX  ; 0056ecba | g_RenderVertexBuffer[0].fog
    CMP EAX,ECX                         ; 0056ecc0
    JL 0x0056ec90                       ; 0056ecc2 | LAB_0056ec90
    ...
    JZ 0x0056ed6f                       ; 0056ecd3 | LAB_0056ed6f
    ...
    JLE 0x0056eb80                      ; 0056ece5 | LAB_0056eb80
        ;   XREF to: 0056eb80 (CONDITIONAL_JUMP)
    XOR EBX,EBX                         ; 0056eceb
    MOV EAX,dword ptr [EBX + 0x688014]  ; 0056eced | SRenderVertex[16] g_RenderVertexBuffer
        ;   Label: LAB_0056eced
    MOV dword ptr [ESP + 0x6c],EAX      ; 0056ecf3
    MOV EAX,dword ptr [EBX + 0x688018]  ; 0056ecf7 | g_RenderVertexBuffer[0].projected_vertex.transformed_y
    MOV dword ptr [ESP + 0x70],EAX      ; 0056ecfd
    MOV EAX,dword ptr [EBX + 0x68801c]  ; 0056ed01 | g_RenderVertexBuffer[0].projected_vertex.transformed_z
    MOV dword ptr [ESP + 0x74],EAX      ; 0056ed07
    LEA EAX,[ESP + 0x6c]                ; 0056ed0b
    PUSH EAX                            ; 0056ed0f
    LEA ESI,[ESP + 0x34]                ; 0056ed10
    CALL core_set.cpp_FUN_0056e890      ; 0056ed14 | undefined core_set.cpp_FUN_0056e890()
    ...
    CALL core_set.cpp_CDemonSet_lightVertexColor_FUN_0056ddb0 ; 0056ed3f | void core_set.cpp_CDemonSet_lightVertexColor_FUN_0056ddb0(CDemonSet * this_ptr, CVector3i * world_position, CVector3i * surface_normal, int vertex_index, ...)
        ;   XREF to: 0056ddb0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0056ed44
    MOV EAX,[0x02d051f4]                ; 0056ed47 | float g_PerspectiveReciprocal
    ...
    JL 0x0056eced                       ; 0056ed66 | LAB_0056eced
    ...
    IMUL ESI,EAX,0xc                    ; 0056ed95
        ;   Label: LAB_0056ed95
    LEA EDI,[ESI + 0x33081cc]           ; 0056ed98 | CVector3f[20000] g_VertexNormalArray
    MOV ESI,ECX                         ; 0056ed9e
    INC EAX                             ; 0056eda0
    ADD ECX,0xc                         ; 0056eda1
    MOVSD ES:EDI,ESI                    ; 0056eda4 | DAT_033081d8 | g_VertexNormalArray
    MOVSD ES:EDI,ESI                    ; 0056eda5 | DAT_033081dc
    MOVSD ES:EDI,ESI                    ; 0056eda6 | DAT_033081e0
    CMP EAX,EBX                         ; 0056eda7
    JL 0x0056ed95                       ; 0056eda9 | LAB_0056ed95
    ...
    JLE 0x0056eb80                      ; 0056edb7 | LAB_0056eb80
        ;   XREF to: 0056eb80 (CONDITIONAL_JUMP)
    MOV EDX,0x32cd84c                   ; 0056edbd | CVector3i[20000] g_TransformedVertexArray
    MOV EDI,0x33081cc                   ; 0056edc2 | CVector3f[20000] g_VertexNormalArray
    XOR ESI,ESI                         ; 0056edc7
    MOV dword ptr [ESP + 0x124],EDX     ; 0056edc9 | CVector3i[20000] g_TransformedVertexArray
    PUSH 0x0                            ; 0056edd0
        ;   Label: LAB_0056edd0
    PUSH EBX                            ; 0056edd2
    PUSH EDI                            ; 0056edd3 | CVector3f[20000] g_VertexNormalArray
    MOV EAX,dword ptr [ESP + 0x130]     ; 0056edd4 | CVector3i[20000] g_TransformedVertexArray
    PUSH EAX                            ; 0056eddb | CVector3i[20000] g_TransformedVertexArray
    MOV EDX,dword ptr [EBP + 0x14]      ; 0056eddc
    ADD ESI,0x30                        ; 0056eddf
    PUSH EDX                            ; 0056ede2
    INC EBX                             ; 0056ede3
    ADD EDI,0xc                         ; 0056ede4
    CALL core_set.cpp_CDemonSet_lightVertexColor_FUN_0056ddb0 ; 0056ede7 | void core_set.cpp_CDemonSet_lightVertexColor_FUN_0056ddb0(CDemonSet * this_ptr, CVector3i * world_position, CVector3i * surface_normal, int vertex_index, ...)
        ;   XREF to: 0056ddb0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0056edec
    MOV EAX,[0x02d051f4]                ; 0056edef | float g_PerspectiveReciprocal
    ...
    JL 0x0056edd0                       ; 0056ee10 | LAB_0056edd0
    ...
    CMP dword ptr [EBP + 0x18],0x0      ; 0056ee19
        ;   Label: LAB_0056ee19
    JLE 0x0056eea0                      ; 0056ee1d | LAB_0056eea0
        ;   XREF to: 0056eea0 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x108],EDI     ; 0056ee23
    MOV dword ptr [ESP + 0x11c],EDX     ; 0056ee2a
    MOV EAX,dword ptr [EBX + 0x688014]  ; 0056ee31 | SRenderVertex[16] g_RenderVertexBuffer
        ;   Label: LAB_0056ee31
    MOV dword ptr [ESP + 0x90],EAX      ; 0056ee37
    MOV EAX,dword ptr [EBX + 0x688018]  ; 0056ee3e | g_RenderVertexBuffer[0].projected_vertex.transformed_y
    MOV dword ptr [ESP + 0x94],EAX      ; 0056ee44
    MOV EAX,dword ptr [EBX + 0x68801c]  ; 0056ee4b | g_RenderVertexBuffer[0].projected_vertex.transformed_z
    MOV dword ptr [ESP + 0x98],EAX      ; 0056ee51
    LEA EAX,[ESP + 0x90]                ; 0056ee58
    PUSH EAX                            ; 0056ee5f
    LEA ESI,[ESP + 0x4c]                ; 0056ee60
    CALL core_set.cpp_FUN_0056e890      ; 0056ee64 | undefined core_set.cpp_FUN_0056e890()
        ;   XREF to: 0056e890 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0056ee69
    MOV EDI,dword ptr [ESP + 0x11c]     ; 0056ee6c
    LEA ESI,[ESP + 0x48]                ; 0056ee73
    LEA EDI,[EDI + 0x32cd84c]           ; 0056ee77 | CVector3i[20000] g_TransformedVertexArray
    ADD EBX,0x30                        ; 0056ee7d
    MOV ECX,dword ptr [ESP + 0x11c]     ; 0056ee80
    MOVSD ES:EDI,ESI                    ; 0056ee87 | CVector3i[20000] g_TransformedVertexArray
    ...
    JL 0x0056ee31                       ; 0056ee9d | LAB_0056ee31
    ...
    JLE 0x0056edb0                      ; 0056eea7 | LAB_0056edb0
        ;   XREF to: 0056edb0 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [EBP + 0x2c]      ; 0056eead
    IMUL EDI,EBX,0xc                    ; 0056eeb0
        ;   Label: LAB_0056eeb0
    MOV EAX,[0x02d052e8]                ; 0056eeb3 | CMatrix3x3i g_TransformMatrix
    ...
    MOV EAX,[0x02f0d364]                ; 0056ef55 | CMatrix3x3i g_InverseMatrix
    ...
    LEA EDI,[EDI + 0x33081cc]           ; 0056f014 | CVector3f[20000] g_VertexNormalArray
    MOV dword ptr [ESP + 0x5c],ESI      ; 0056f01a
    LEA ESI,[ESP + 0x54]                ; 0056f01e
    INC EBX                             ; 0056f022
    MOV EDX,dword ptr [EBP + 0x18]      ; 0056f023
    MOVSD ES:EDI,ESI                    ; 0056f026 | DAT_033081d8 | g_VertexNormalArray
    MOVSD ES:EDI,ESI                    ; 0056f027 | DAT_033081dc
    MOVSD ES:EDI,ESI                    ; 0056f028 | DAT_033081e0
    CMP EBX,EDX                         ; 0056f029
    JGE 0x0056edb0                      ; 0056f02b | LAB_0056edb0
        ;   XREF to: 0056edb0 (CONDITIONAL_JUMP)
    JMP 0x0056eeb0                      ; 0056f031 | LAB_0056eeb0
        ;   XREF to: 0056eeb0 (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBP + 0x1c],0x0      ; 0056f036
        ;   Label: LAB_0056f036
    JNZ 0x0056f0d1                      ; 0056f03a | LAB_0056f0d1
    ...
    JLE 0x0056eb80                      ; 0056f04c | LAB_0056eb80
        ;   XREF to: 0056eb80 (CONDITIONAL_JUMP)
    XOR EBX,EBX                         ; 0056f052
    MOV EAX,dword ptr [EBX + 0x688014]  ; 0056f054 | SRenderVertex[16] g_RenderVertexBuffer
        ;   Label: LAB_0056f054
    MOV dword ptr [ESP + 0xc],EAX       ; 0056f05a
    MOV EAX,dword ptr [EBX + 0x688018]  ; 0056f05e | g_RenderVertexBuffer[0].projected_vertex.transformed_y
    MOV dword ptr [ESP + 0x10],EAX      ; 0056f064
    MOV EAX,dword ptr [EBX + 0x68801c]  ; 0056f068 | g_RenderVertexBuffer[0].projected_vertex.transformed_z
    MOV dword ptr [ESP + 0x14],EAX      ; 0056f06e
    LEA EAX,[ESP + 0xc]                 ; 0056f072
    PUSH EAX                            ; 0056f076
    LEA ESI,[ESP + 0x28]                ; 0056f077
    LEA EDI,[ESP + 0x1c]                ; 0056f07b
    CALL core_set.cpp_FUN_0056e890      ; 0056f07f | undefined core_set.cpp_FUN_0056e890()
        ;   XREF to: 0056e890 (UNCONDITIONAL_CALL)
    ...
    CALL core_set.cpp_CDemonSet_lightVertexColor_FUN_0056ddb0 ; 0056f0a6 | void core_set.cpp_CDemonSet_lightVertexColor_FUN_0056ddb0(CDemonSet * this_ptr, CVector3i * world_position, CVector3i * surface_normal, int vertex_index, ...)
        ;   XREF to: 0056ddb0 (UNCONDITIONAL_CALL)
    MOV EAX,[0x02d051f4]                ; 0056f0ab | float g_PerspectiveReciprocal
    ...
    JL 0x0056f054                       ; 0056f0c8 | LAB_0056f054
    ...
    CMP dword ptr [EBP + 0x18],0x0      ; 0056f0d1
        ;   Label: LAB_0056f0d1
    JLE 0x0056f150                      ; 0056f0d5 | LAB_0056f150
        ;   XREF to: 0056f150 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x104],EDI     ; 0056f0db
    MOV dword ptr [ESP + 0x10c],ECX     ; 0056f0e2
    MOV EAX,dword ptr [EBX + 0x688014]  ; 0056f0e9 | SRenderVertex[16] g_RenderVertexBuffer
        ;   Label: LAB_0056f0e9
    MOV dword ptr [ESP + 0x3c],EAX      ; 0056f0ef
    MOV EAX,dword ptr [EBX + 0x688018]  ; 0056f0f3 | g_RenderVertexBuffer[0].projected_vertex.transformed_y
    MOV dword ptr [ESP + 0x40],EAX      ; 0056f0f9
    MOV EAX,dword ptr [EBX + 0x68801c]  ; 0056f0fd | g_RenderVertexBuffer[0].projected_vertex.transformed_z
    MOV dword ptr [ESP + 0x44],EAX      ; 0056f103
    LEA EAX,[ESP + 0x3c]                ; 0056f107
    PUSH EAX                            ; 0056f10b
    LEA ESI,[ESP + 0x64]                ; 0056f10c
    CALL core_set.cpp_FUN_0056e890      ; 0056f110 | undefined core_set.cpp_FUN_0056e890()
        ;   XREF to: 0056e890 (UNCONDITIONAL_CALL)
    ...
    JLE 0x0056f2c3                      ; 0056f164 | LAB_0056f2c3
    ...
    MOV ECX,0x32cd84c                   ; 0056f176 | CVector3i[20000] g_TransformedVertexArray
    ADD ECX,EDX                         ; 0056f17b
    MOV EDX,0x32cd84c                   ; 0056f17d | CVector3i[20000] g_TransformedVertexArray
    ADD EDX,EBX                         ; 0056f182
    MOV EBX,dword ptr [ECX]             ; 0056f184 | CVector3i[20000] g_TransformedVertexArray
    SUB EBX,dword ptr [EDX]             ; 0056f186 | CVector3i[20000] g_TransformedVertexArray
    ...
    ADD EBX,0x32cd84c                   ; 0056f1af | CVector3i[20000] g_TransformedVertexArray
    MOV ESI,dword ptr [ECX]             ; 0056f1b5 | CVector3i[20000] g_TransformedVertexArray
    MOV EDX,dword ptr [EBX]             ; 0056f1b7 | CVector3i[20000] g_TransformedVertexArray
    ...
    MOV ECX,dword ptr [0x02d7a7bc]      ; 0056f271 | int g_LightAttenuationMax
    SAR EDX,0x1                         ; 0056f277
    SUB ECX,EDX                         ; 0056f279
    MOV dword ptr [ESP + 0xc0],ECX      ; 0056f27b
    FLD float ptr [ESP + 0xc0]          ; 0056f282
    FMUL double ptr [0x00645fd3]        ; 0056f289 | double DOUBLE_00645fd3
    FXCH                                ; 0056f28f
    FMUL ST1                            ; 0056f291
    FXCH ST2                            ; 0056f293
    FMUL ST1                            ; 0056f295
    ...
    JNZ 0x0056f48d                      ; 0056f2ae | LAB_0056f48d
    ...
    JL 0x0056f16a                       ; 0056f2bd | LAB_0056f16a
    ...
    PUSH EAX                            ; 0056f2d2
    PUSH 0x0                            ; 0056f2d3
    PUSH 0x33081cc                      ; 0056f2d5 | CVector3f[20000] g_VertexNormalArray
    CALL crt_memory.c_memset_FUN_005fde40 ; 0056f2da | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
    ...
    JLE 0x0056f3a0                      ; 0056f2ec | LAB_0056f3a0
        ;   XREF to: 0056f3a0 (CONDITIONAL_JUMP)
    IMUL EAX,dword ptr [ECX + 0x18],0xc ; 0056f2f2
        ;   Label: LAB_0056f2f2
    LEA ESI,[ECX + 0x8]                 ; 0056f2f6
    ADD EAX,0x33081cc                   ; 0056f2f9 | CVector3f[20000] g_VertexNormalArray
    FLD float ptr [ESI]                 ; 0056f2fe
    FADD float ptr [EAX]                ; 0056f300 | CVector3f[20000] g_VertexNormalArray
    FSTP float ptr [EAX]                ; 0056f302 | CVector3f[20000] g_VertexNormalArray
    ...
    ADD EAX,0x33081cc                   ; 0056f31a | CVector3f[20000] g_VertexNormalArray
    FLD float ptr [ESI]                 ; 0056f31f
    FADD float ptr [EAX]                ; 0056f321 | CVector3f[20000] g_VertexNormalArray
    FSTP float ptr [EAX]                ; 0056f323 | CVector3f[20000] g_VertexNormalArray
    ...
    ADD EAX,0x33081cc                   ; 0056f33b | CVector3f[20000] g_VertexNormalArray
    FLD float ptr [ESI]                 ; 0056f340
    FADD float ptr [EAX]                ; 0056f342 | CVector3f[20000] g_VertexNormalArray
    FSTP float ptr [EAX]                ; 0056f344 | CVector3f[20000] g_VertexNormalArray
    ...
    JNZ 0x0056f37f                      ; 0056f35c | LAB_0056f37f
        ;   XREF to: 0056f37f (CONDITIONAL_JUMP)
    IMUL EAX,dword ptr [ECX + 0x3c],0xc ; 0056f35e
    ADD EAX,0x33081cc                   ; 0056f362 | CVector3f[20000] g_VertexNormalArray
    FLD float ptr [ESI]                 ; 0056f367
    FADD float ptr [EAX]                ; 0056f369 | CVector3f[20000] g_VertexNormalArray
    FSTP float ptr [EAX]                ; 0056f36b | CVector3f[20000] g_VertexNormalArray
    ...
    CMP dword ptr [EBP + 0x28],0x4      ; 0056f37f
        ;   Label: LAB_0056f37f
    JNZ 0x0056f495                      ; 0056f383 | LAB_0056f495
    ...
    JL 0x0056f2f2                       ; 0056f392 | LAB_0056f2f2
    ...
    JZ 0x0056f854                       ; 0056f3ab | LAB_0056f854
    ...
    JLE 0x0056eb80                      ; 0056f3bf | LAB_0056eb80
        ;   XREF to: 0056eb80 (CONDITIONAL_JUMP)
    MOV EDI,0x33081cc                   ; 0056f3c5 | CVector3f[20000] g_VertexNormalArray
    MOV EAX,0x32cd84c                   ; 0056f3ca | CVector3i[20000] g_TransformedVertexArray
    MOV dword ptr [ESP + 0x120],EDX     ; 0056f3cf
    MOV dword ptr [ESP + 0x118],EAX     ; 0056f3d6 | CVector3i[20000] g_TransformedVertexArray
    FLD float ptr [EDI]                 ; 0056f3dd | CVector3f[20000] g_VertexNormalArray
        ;   Label: LAB_0056f3dd
    FABS                                ; 0056f3df
    ...
    FNSTSW AX                           ; 0056f3f1
    SAHF                                ; 0056f3f3
    JBE 0x0056f7c2                      ; 0056f3f4 | LAB_0056f7c2
        ;   XREF to: 0056f7c2 (CONDITIONAL_JUMP)
    FLD float ptr [EDI + 0x4]           ; 0056f3fa | DAT_033081d0
    FABS                                ; 0056f3fd
    FLD1                                ; 0056f3ff
    FCOMPP                              ; 0056f401
    FNSTSW AX                           ; 0056f403
    SAHF                                ; 0056f405
    JBE 0x0056f7c2                      ; 0056f406 | LAB_0056f7c2
        ;   XREF to: 0056f7c2 (CONDITIONAL_JUMP)
    ...
    FNSTSW AX                           ; 0056f415
    SAHF                                ; 0056f417
    JBE 0x0056f7c2                      ; 0056f418 | LAB_0056f7c2
        ;   XREF to: 0056f7c2 (CONDITIONAL_JUMP)
    PUSH 0x0                            ; 0056f41e
    PUSH ECX                            ; 0056f420
    MOV EAX,0x32cd84c                   ; 0056f421 | CVector3i[20000] g_TransformedVertexArray
    PUSH 0x0                            ; 0056f426
    ADD EAX,EBX                         ; 0056f428
    PUSH EAX                            ; 0056f42a
    MOV ECX,dword ptr [EBP + 0x14]      ; 0056f42b
    PUSH ECX                            ; 0056f42e
    CALL core_set.cpp_CDemonSet_lightVertexColor_FUN_0056ddb0 ; 0056f42f | void core_set.cpp_CDemonSet_lightVertexColor_FUN_0056ddb0(CDemonSet * this_ptr, CVector3i * world_position, CVector3i * surface_normal, int vertex_index, ...)
        ;   Label: LAB_0056f42f
        ;   XREF to: 0056ddb0 (UNCONDITIONAL_CALL)
    ...
    MOV EAX,[0x02d051f4]                ; 0056f44f | float g_PerspectiveReciprocal
    ...
    MOV dword ptr [ESP + 0x118],EDX     ; 0056f479 | DAT_032cd858
    CMP EBX,ESI                         ; 0056f480
    JGE 0x0056eb80                      ; 0056f482 | LAB_0056eb80
        ;   XREF to: 0056eb80 (CONDITIONAL_JUMP)
    JMP 0x0056f3dd                      ; 0056f488 | LAB_0056f3dd
        ;   XREF to: 0056f3dd (UNCONDITIONAL_JUMP)
    ADD EAX,0x3c                        ; 0056f48d
        ;   Label: LAB_0056f48d
    JMP 0x0056f2b7                      ; 0056f490 | LAB_0056f2b7
        ;   XREF to: 0056f2b7 (UNCONDITIONAL_JUMP)
    ADD ECX,0x3c                        ; 0056f495
        ;   Label: LAB_0056f495
    JMP 0x0056f38c                      ; 0056f498 | LAB_0056f38c
    ...
    JLE 0x0056f4cd                      ; 0056f4a9 | LAB_0056f4cd
        ;   XREF to: 0056f4cd (CONDITIONAL_JUMP)
    MOV EDI,0x645f5f                    ; 0056f4ab | = "..\\core\\set.cpp" | s_core_set_cpp_00645f5f = ..\core\set.cpp
    MOV EAX,0xeaf                       ; 0056f4b0
    PUSH 0x645f6f                       ; 0056f4b5 | = "Too many normals on this packed tri list" | s_Too_many_normals_on_this_00645f6f = Too many normals on this packed tri list
    MOV dword ptr [0x02f0ca48],EDI      ; 0056f4ba | char * g_CurrentFilename
    MOV [0x02f0ca4c],EAX                ; 0056f4c0 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0056f4c5 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0056f4ca
    CMP dword ptr [EBP + 0x1c],0xfa0    ; 0056f4cd
        ;   Label: LAB_0056f4cd
    JLE 0x0056f4f9                      ; 0056f4d4 | LAB_0056f4f9
        ;   XREF to: 0056f4f9 (CONDITIONAL_JUMP)
    MOV ECX,0x645f98                    ; 0056f4d6 | = "..\\core\\set.cpp" | s_core_set_cpp_00645f98 = ..\core\set.cpp
    MOV ESI,0xeb1                       ; 0056f4db
    PUSH 0x645fa8                       ; 0056f4e0 | = "Need more normals for packed models" | s_Need_more_normals_for_pa_00645fa8 = Need more normals for packed models
    MOV dword ptr [0x02f0ca48],ECX      ; 0056f4e5 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 0056f4eb | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0056f4f1 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ...
    MOV EDX,0x32cd84c                   ; 0056f537 | CVector3i[20000] g_TransformedVertexArray
    ADD EAX,0x32cd84c                   ; 0056f53c | CVector3i[20000] g_TransformedVertexArray
    ADD EDX,ESI                         ; 0056f541
    MOV ESI,dword ptr [EAX]             ; 0056f543 | CVector3i[20000] g_TransformedVertexArray
    MOV dword ptr [ESP + 0x154],ESI     ; 0056f545
    MOV ESI,dword ptr [EDX]             ; 0056f54c | CVector3i[20000] g_TransformedVertexArray
    ...
    ADD ESI,0x32cd84c                   ; 0056f59e | CVector3i[20000] g_TransformedVertexArray
    MOV EDX,dword ptr [ESI]             ; 0056f5a4 | CVector3i[20000] g_TransformedVertexArray
    MOV dword ptr [ESP + 0x158],EDX     ; 0056f5a6
    MOV EDX,dword ptr [EAX]             ; 0056f5ad | CVector3i[20000] g_TransformedVertexArray
    ...
    MOV EDX,dword ptr [0x02d7a7bc]      ; 0056f6b0 | int g_LightAttenuationMax
    SAR EAX,0x1                         ; 0056f6b6
    SUB EDX,EAX                         ; 0056f6b8
    MOV dword ptr [ESP + 0xe8],EDX      ; 0056f6ba
    FLD float ptr [ESP + 0xe8]          ; 0056f6c1
    FMUL double ptr [0x00645fd3]        ; 0056f6c8 | double DOUBLE_00645fd3
    FLD ST1                             ; 0056f6ce
    FMUL ST1                            ; 0056f6d0
    FLD ST3                             ; 0056f6d2
    FMUL ST2                            ; 0056f6d4
    ...
    FXCH                                ; 0056f6e9
    FSTP float ptr [ECX + -0xc]         ; 0056f6eb | CVector3f[4000] g_FaceNormalArray
    FSTP float ptr [ECX + -0x8]         ; 0056f6ee | DAT_032c1cd0
    FSTP float ptr [ECX + -0x4]         ; 0056f6f1 | DAT_032c1cd4
    CMP EDI,EAX                         ; 0056f6f4
    JL 0x0056f519                       ; 0056f6f6 | LAB_0056f519
    ...
    PUSH EAX                            ; 0056f719
    PUSH 0x0                            ; 0056f71a
    PUSH 0x33081cc                      ; 0056f71c | CVector3f[20000] g_VertexNormalArray
    CALL crt_memory.c_memset_FUN_005fde40 ; 0056f721 | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
        ;   XREF to: 005fde40 (UNCONDITIONAL_CALL)
    ...
    JLE 0x0056f3a0                      ; 0056f733 | LAB_0056f3a0
        ;   XREF to: 0056f3a0 (CONDITIONAL_JUMP)
    MOV ECX,0x32c1ccc                   ; 0056f739 | CVector3f[4000] g_FaceNormalArray
    MOV EDI,dword ptr [EBP + 0x1c]      ; 0056f73e
    XOR EAX,EAX                         ; 0056f741
        ;   Label: LAB_0056f741
    MOV AX,word ptr [EBX]               ; 0056f743
    IMUL EAX,EAX,0xc                    ; 0056f746
    ADD EAX,0x33081cc                   ; 0056f749 | CVector3f[20000] g_VertexNormalArray
    FLD float ptr [ECX]                 ; 0056f74e | CVector3f[4000] g_FaceNormalArray
    FADD float ptr [EAX]                ; 0056f750 | CVector3f[20000] g_VertexNormalArray
    FSTP float ptr [EAX]                ; 0056f752 | CVector3f[20000] g_VertexNormalArray
    FLD float ptr [ECX + 0x4]           ; 0056f754 | DAT_032c1cd0
    FADD float ptr [EAX + 0x4]          ; 0056f757 | DAT_033081d0
    FSTP float ptr [EAX + 0x4]          ; 0056f75a | DAT_033081d0
    FLD float ptr [ECX + 0x8]           ; 0056f75d | DAT_032c1cd4
    ...
    ADD EAX,0x33081cc                   ; 0056f76f | CVector3f[20000] g_VertexNormalArray
    FLD float ptr [ECX]                 ; 0056f774 | CVector3f[4000] g_FaceNormalArray
    FADD float ptr [EAX]                ; 0056f776 | CVector3f[20000] g_VertexNormalArray
    FSTP float ptr [EAX]                ; 0056f778 | CVector3f[20000] g_VertexNormalArray
    FLD float ptr [ECX + 0x4]           ; 0056f77a | DAT_032c1cd0
    FADD float ptr [EAX + 0x4]          ; 0056f77d | DAT_033081d0
    FSTP float ptr [EAX + 0x4]          ; 0056f780 | DAT_033081d0
    FLD float ptr [ECX + 0x8]           ; 0056f783 | DAT_032c1cd4
    ...
    ADD EAX,0x33081cc                   ; 0056f795 | CVector3f[20000] g_VertexNormalArray
    FLD float ptr [ECX]                 ; 0056f79a | CVector3f[4000] g_FaceNormalArray
    FADD float ptr [EAX]                ; 0056f79c | CVector3f[20000] g_VertexNormalArray
    ADD EBX,0x12                        ; 0056f79e
    FSTP float ptr [EAX]                ; 0056f7a1 | CVector3f[20000] g_VertexNormalArray
    FLD float ptr [ECX + 0x4]           ; 0056f7a3 | DAT_032c1cd0
    FADD float ptr [EAX + 0x4]          ; 0056f7a6 | DAT_033081d0
    ADD ECX,0xc                         ; 0056f7a9
    FSTP float ptr [EAX + 0x4]          ; 0056f7ac | DAT_033081d0
    FLD float ptr [ECX + -0x4]          ; 0056f7af | DAT_032c1cd4
    FADD float ptr [EAX + 0x8]          ; 0056f7b2 | DAT_033081d4
    INC ESI                             ; 0056f7b5
    FSTP float ptr [EAX + 0x8]          ; 0056f7b6 | DAT_033081d4
    CMP ESI,EDI                         ; 0056f7b9
    JL 0x0056f741                       ; 0056f7bb | LAB_0056f741
        ;   XREF to: 0056f741 (CONDITIONAL_JUMP)
    JMP 0x0056f3a0                      ; 0056f7bd | LAB_0056f3a0
        ;   XREF to: 0056f3a0 (UNCONDITIONAL_JUMP)
    FLD float ptr [ESI + 0x4]           ; 0056f7c2 | DAT_033081d0
        ;   Label: LAB_0056f7c2
    FMUL ST0                            ; 0056f7c5
    FLD float ptr [ESI]                 ; 0056f7c7 | CVector3f[20000] g_VertexNormalArray
    FMUL ST0                            ; 0056f7c9
    FADDP                               ; 0056f7cb
    FLD float ptr [ESI + 0x8]           ; 0056f7cd | DAT_033081d4
    FMUL ST0                            ; 0056f7d0
    FADDP                               ; 0056f7d2
    FSTP float ptr [ESP + 0xf0]         ; 0056f7d4
    MOV EAX,dword ptr [ESP + 0xf0]      ; 0056f7db
    MOV EDX,dword ptr [0x02d7a7bc]      ; 0056f7e2 | int g_LightAttenuationMax
    SAR EAX,0x1                         ; 0056f7e8
    SUB EDX,EAX                         ; 0056f7ea
    MOV dword ptr [ESP + 0xf4],EDX      ; 0056f7ec
    FLD float ptr [ESP + 0xf4]          ; 0056f7f3
    FMUL double ptr [0x00645fd3]        ; 0056f7fa | double DOUBLE_00645fd3
    FLD float ptr [ESI]                 ; 0056f800 | CVector3f[20000] g_VertexNormalArray
    FMUL ST1                            ; 0056f802
    FLD float ptr [ESI + 0x4]           ; 0056f804 | DAT_033081d0
    FMUL ST2                            ; 0056f807
    FLD float ptr [ESI + 0x8]           ; 0056f809 | DAT_033081d4
    FMULP ST3                           ; 0056f80c
    LEA EBX,[ESP + 0x84]                ; 0056f80e
    MOV EAX,ESI                         ; 0056f815
    FXCH                                ; 0056f817
    FSTP float ptr [ESI]                ; 0056f819 | CVector3f[20000] g_VertexNormalArray
    FSTP float ptr [ESI + 0x4]          ; 0056f81b | DAT_033081d0
    FSTP float ptr [ESI + 0x8]          ; 0056f81e | DAT_033081d4
    FLD float ptr [EAX]                 ; 0056f821 | CVector3f[20000] g_VertexNormalArray
    FISTP dword ptr [EBX]               ; 0056f823
    FLD float ptr [EAX + 0x4]           ; 0056f825 | DAT_033081d0
    FISTP dword ptr [EBX + 0x4]         ; 0056f828
    FLD float ptr [EAX + 0x8]           ; 0056f82b | DAT_033081d4
    ...
    PUSH EAX                            ; 0056f84e
    JMP 0x0056f42f                      ; 0056f84f | LAB_0056f42f
        ;   XREF to: 0056f42f (UNCONDITIONAL_JUMP)
    CMP dword ptr [EBP + 0x18],0x0      ; 0056f854
        ;   Label: LAB_0056f854
    JLE 0x0056eb80                      ; 0056f858 | LAB_0056eb80
        ;   XREF to: 0056eb80 (CONDITIONAL_JUMP)
    MOV EAX,0x32cd84c                   ; 0056f85e | CVector3i[20000] g_TransformedVertexArray
    MOV ESI,0x33081cc                   ; 0056f863 | CVector3f[20000] g_VertexNormalArray
    MOV dword ptr [ESP + 0x114],EDI     ; 0056f868
    MOV dword ptr [ESP + 0x110],EAX     ; 0056f86f | CVector3i[20000] g_TransformedVertexArray
    FLD float ptr [ESI + 0x4]           ; 0056f876 | DAT_033081d0
        ;   Label: LAB_0056f876
    FMUL ST0                            ; 0056f879
    FLD float ptr [ESI]                 ; 0056f87b | CVector3f[20000] g_VertexNormalArray
    FMUL ST0                            ; 0056f87d
    FADDP                               ; 0056f87f
    FLD float ptr [ESI + 0x8]           ; 0056f881 | DAT_033081d4
    FMUL ST0                            ; 0056f884
    FADDP                               ; 0056f886
    FSTP float ptr [ESP + 0xfc]         ; 0056f888
    MOV EAX,dword ptr [ESP + 0xfc]      ; 0056f88f
    MOV EDX,dword ptr [0x02d7a7bc]      ; 0056f896 | int g_LightAttenuationMax
    SAR EAX,0x1                         ; 0056f89c
    SUB EDX,EAX                         ; 0056f89e
    MOV dword ptr [ESP + 0x100],EDX     ; 0056f8a0
    FLD float ptr [ESP + 0x100]         ; 0056f8a7
    FMUL double ptr [0x00645fd3]        ; 0056f8ae | double DOUBLE_00645fd3
    FLD float ptr [ESI]                 ; 0056f8b4 | CVector3f[20000] g_VertexNormalArray
    FMUL ST1                            ; 0056f8b6
    FLD float ptr [ESI + 0x4]           ; 0056f8b8 | DAT_033081d0
    FMUL ST2                            ; 0056f8bb
    FLD float ptr [ESI + 0x8]           ; 0056f8bd | DAT_033081d4
    FMULP ST3                           ; 0056f8c0
    LEA EBX,[ESP + 0x78]                ; 0056f8c2
    MOV EAX,ESI                         ; 0056f8c6
    FXCH                                ; 0056f8c8
    FSTP float ptr [ESI]                ; 0056f8ca | CVector3f[20000] g_VertexNormalArray
    FSTP float ptr [ESI + 0x4]          ; 0056f8cc | DAT_033081d0
    FSTP float ptr [ESI + 0x8]          ; 0056f8cf | DAT_033081d4
    FLD float ptr [EAX]                 ; 0056f8d2 | CVector3f[20000] g_VertexNormalArray
    FISTP dword ptr [EBX]               ; 0056f8d4
    FLD float ptr [EAX + 0x4]           ; 0056f8d6 | DAT_033081d0
    FISTP dword ptr [EBX + 0x4]         ; 0056f8d9
    FLD float ptr [EAX + 0x8]           ; 0056f8dc | DAT_033081d4
    FISTP dword ptr [EBX + 0x8]         ; 0056f8df
    PUSH 0x0                            ; 0056f8e2
    PUSH EDI                            ; 0056f8e4
    LEA EAX,[ESP + 0x80]                ; 0056f8e5
    PUSH EAX                            ; 0056f8ec
    MOV EBX,dword ptr [ESP + 0x11c]     ; 0056f8ed | CVector3i[20000] g_TransformedVertexArray
    PUSH EBX                            ; 0056f8f4 | CVector3i[20000] g_TransformedVertexArray
    MOV EAX,dword ptr [EBP + 0x14]      ; 0056f8f5
    PUSH EAX                            ; 0056f8f8
    ADD ESI,0xc                         ; 0056f8f9
    INC EDI                             ; 0056f8fc
    CALL core_set.cpp_CDemonSet_lightVertexColor_FUN_0056ddb0 ; 0056f8fd | void core_set.cpp_CDemonSet_lightVertexColor_FUN_0056ddb0(CDemonSet * this_ptr, CVector3i * world_position, CVector3i * surface_normal, int vertex_index, ...)
        ;   XREF to: 0056ddb0 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0056f902
    MOV EAX,[0x02d051f4]                ; 0056f905 | float g_PerspectiveReciprocal
    ...
    MOV dword ptr [EDX + 0x688010],EAX  ; 0056f921 | void * g_BackBuffer | g_RenderVertexBuffer[0].w_recip
    MOV dword ptr [ESP + 0x114],EDX     ; 0056f927
    CMP EDI,EBX                         ; 0056f92e
    JL 0x0056f876                       ; 0056f930 | LAB_0056f876
