...

{
  ...
  if ((g_RenderingShadows != 0) || (g_CGamePtr->shadow_flag != 0)) {
    ...
    if (0 < DAT_0327785c) {
      iVar7 = 0;
      do {
        p1 = *(void **)((int)&DAT_03277860 + iVar7);
        if (*(int *)((int)&DAT_032779f0 + iVar7) == 0) {
          core_dcamera_cpp_CDemonCamera_renderLightCoronas_FUN_004518f0
          ...
          core_set_cpp_CDemonSet_setupMirrorRendering_FUN_005709e0
                    (this_ptr,*(int *)((int)&DAT_032779f0 + iVar7) + -1,0);
          core_dcamera_cpp_CDemonCamera_renderLightCoronas_FUN_004518f0
  ...
  if (0 < this_ptr->actor_count) {
    do {
      ...
      pCVar2 = &(pCVar5->previous_transform_state).orientation;
      if (pCVar2 != (CVector3f *)&pCVar5->orient) {
        pCVar2->x = (pCVar5->orient).vec.x;
        (pCVar5->previous_transform_state).orientation.y = (pCVar5->orient).vec.y;
        (pCVar5->previous_transform_state).orientation.z = (pCVar5->orient).vec.z;
      }
      iVar7 = iVar7 + 1;
      pCVar6 = (CDemonSet *)pCVar6->cameras;
    } while (iVar7 < this_ptr->actor_count);
