...
section .text
    ...
    CALL core_set.cpp_freeVDBoxes_FUN_00571590 ; 00569367
        ;   XREF to: 00571590 (UNCONDITIONAL_CALL)  ; void core_set.cpp_freeVDBoxes_FUN_00571590(SVDBox * * array)
    ADD ESP,0x8                         ; 0056936c
    PUSH 0x0                            ; 0056936f
    SUB EAX,0x554                       ; 00569371
    PUSH EAX                            ; 00569376
    CALL core_set.cpp_freeRooms_FUN_00571570 ; 00569377
        ;   XREF to: 00571570 (UNCONDITIONAL_CALL)  ; void core_set.cpp_freeRooms_FUN_00571570(SRoom * * array)
    ADD ESP,0x8                         ; 0056937c
    PUSH 0x0                            ; 0056937f
    SUB EAX,0x141490                    ; 00569381
    PUSH EAX                            ; 00569386
    CALL core_set.cpp_free3DSLights_FUN_00571550 ; 00569387
        ;   XREF to: 00571550 (UNCONDITIONAL_CALL)  ; void core_set.cpp_free3DSLights_FUN_00571550(C3DSLight * * array)
    ADD ESP,0x8                         ; 0056938c
    PUSH 0x0                            ; 0056938f
    SUB EAX,0x19a2c                     ; 00569391
    PUSH EAX                            ; 00569396
    CALL core_set.cpp_free3DSCameras_FUN_00571530 ; 00569397
        ;   XREF to: 00571530 (UNCONDITIONAL_CALL)  ; void core_set.cpp_free3DSCameras_FUN_00571530(C3DSCamera * * array)
