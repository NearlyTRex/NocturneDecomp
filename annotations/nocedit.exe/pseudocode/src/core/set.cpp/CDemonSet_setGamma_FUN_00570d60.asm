...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_set.cpp_CDemonSet_setGamma_FUN_00570d60(CDemonSet * this_ptr, int gamma)
;
; Parameters:
...
section .text
    ...
    PUSH EDX                            ; 00570d6d
    PUSH 0x32758e4                      ; 00570d6e | CDemonCamera g_CDemonCameraInstance
    CALL core_dcamera.cpp_CDemonCamera_generateGammaPalette_FUN_00453bd0 ; 00570d73 | void core_dcamera.cpp_CDemonCamera_generateGammaPalette_FUN_00453bd0(CDemonCamera * this_ptr, int gamma_value)
    ...
    FMUL double ptr [0x0064606b]        ; 00570d86 | double DOUBLE_0064606b
    ...
    FXCH                                ; 00570da9
    CALL crt_math.c_pow_FUN_005ffd76    ; 00570dab | float10 crt_math.c_pow_FUN_005ffd76(float10 x, float10 y)
    ...
    JL 0x00570de4                       ; 00570dc7 | LAB_00570de4
        ;   XREF to: 00570de4 (CONDITIONAL_JUMP)
    ADD ECX,0x4                         ; 00570dc9
        ;   Label: LAB_00570dc9
    MOV EAX,dword ptr [ESP + 0x4]       ; 00570dcc
    INC EDX                             ; 00570dd0
    MOV dword ptr [ECX + 0x327d778],EAX ; 00570dd1 | DAT_0327d778 | int[65536] g_IntensityToValueLookupTable
    CMP EDX,0x10000                     ; 00570dd7
    JL 0x00570d98                       ; 00570ddd | LAB_00570d98
    ...
    MOV dword ptr [ESP + 0x4],ESI       ; 00570de4
        ;   Label: LAB_00570de4
    JMP 0x00570dc9                      ; 00570de8 | LAB_00570dc9
