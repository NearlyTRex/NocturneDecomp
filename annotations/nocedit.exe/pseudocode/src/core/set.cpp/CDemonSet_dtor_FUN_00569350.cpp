...

{
  ...
  pSVar1 = (CDemonSet_ptr_1422356)
           core_set_cpp_SVDBox_arrdtor250_FUN_00571590(this_ptr->vdir_boxes,0);
  pSVar2 = (CDemonSet_ptr_1420992)core_set_cpp_SRoom_arrdtor20_FUN_00571570(ADJ(pSVar1)->rooms,0);
  pCVar1 = (CDemonSet_ptr_105008)
           core_set_cpp_C3DSLight_arrdtor200_FUN_00571550(ADJ(pSVar2)->lights,0);
  pCVar2 = (CDemonSet_ptr_4)core_set_cpp_C3DSCamera_arrdtor250_FUN_00571530(ADJ(pCVar1)->cameras,0);
  return ADJ(pCVar2);
}
