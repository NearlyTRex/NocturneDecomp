...
;   core_curtain.cpp_CCurtain_renderMesh_FUN_0044b060 at 0044b305
;   core_dmodel.cpp_CKeyFramedModel_submitToRenderer_FUN_00477980 at 00477bb3
;   core_wateract.cpp_CWaterActor_renderTransparent_FUN_005eb280 at 005eb445
;
; Referenced Globals:
...
section .text
    ...
    CMP dword ptr [EAX + 0x1f0],0x0     ; 00570788 | g_CGameInstance.suppress_set_geometry
    ...
    CMP dword ptr [EBX + 0x15ac78],0x0  ; 005707a2
        ;   Label: LAB_005707a2
    JZ 0x00570820                       ; 005707a9
        ;   XREF to: 00570820 (CONDITIONAL_JUMP)  ; LAB_00570820
    MOV EBX,EBP                         ; 005707af
    XOR ESI,ESI                         ; 005707b1
    TEST EDI,EDI                        ; 005707b3
    JLE 0x00570820                      ; 005707b5
        ;   XREF to: 00570820 (CONDITIONAL_JUMP)  ; LAB_00570820
    ...
    JL 0x005707b7                       ; 00570815
        ;   XREF to: 005707b7 (CONDITIONAL_JUMP)  ; LAB_005707b7
    LEA EAX,[EAX]                       ; 00570817
    LEA EDX,[EDX]                       ; 0057081d | g_CDemonRendererInstance
    ...
    CALL engine_drender.cpp_CDemonRenderer_isShadowPass_FUN_0048cae0 ; 00570845
    ...
    JNZ 0x005707a2                      ; 0057084f
        ;   XREF to: 005707a2 (CONDITIONAL_JUMP)  ; LAB_005707a2
