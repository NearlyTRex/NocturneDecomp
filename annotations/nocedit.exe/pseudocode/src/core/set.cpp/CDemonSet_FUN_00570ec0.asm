...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_set.cpp_CDemonSet_FUN_00570ec0(CDemonSet * this_ptr)
;
; Parameters:
...
section .text
    ...
    JL 0x00570ed6                       ; 00570ee9 | LAB_00570ed6
    ...
    PUSH EBX                            ; 00570ef5
    PUSH EDI                            ; 00570ef6
    CALL core_set.cpp_CDemonSet_FUN_00570ea0 ; 00570ef7 | void core_set.cpp_CDemonSet_FUN_00570ea0(CDemonSet * this_ptr)
        ;   XREF to: 00570ea0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 00570efc
    JMP 0x00570ede                      ; 00570eff | LAB_00570ede
