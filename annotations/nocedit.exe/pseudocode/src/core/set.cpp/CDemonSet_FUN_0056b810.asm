...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_set.cpp_CDemonSet_FUN_0056b810(CDemonSet * this_ptr)
;
; Parameters:
...
section .text
    ...
    JLE 0x0056b860                      ; 0056b82c | LAB_0056b860
        ;   XREF to: 0056b860 (CONDITIONAL_JUMP)
    MOV EBX,EAX                         ; 0056b82e
    PUSH 0x593                          ; 0056b830
        ;   Label: LAB_0056b830
    PUSH 0x645cbf                       ; 0056b835 | = "..\\core\\set.cpp" | s_core_set_cpp_00645cbf = ..\core\set.cpp
    MOV ECX,dword ptr [EBX + 0x14d158]  ; 0056b83a
    PUSH ECX                            ; 0056b840
    CALL core_actor.cpp_CDemonActor_doCheckForInvalidPointers_FUN_0040ac80 ; 0056b841 | void core_actor.cpp_CDemonActor_doCheckForInvalidPointers_FUN_0040ac80(CDemonActor * this_ptr, char * context_file, int context_line)
    ...
    JL 0x0056b830                       ; 0056b858 | LAB_0056b830
        ;   XREF to: 0056b830 (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 0056b85a
    MOV EAX,[0x0067b654]                ; 0056b860 | CGame * g_CGamePtr
        ;   Label: LAB_0056b860
    CMP dword ptr [EAX + 0x20c],0x0     ; 0056b865 | DAT_02d81ca8
    JNZ 0x0056b95e                      ; 0056b86c | LAB_0056b95e
        ;   XREF to: 0056b95e (CONDITIONAL_JUMP)
    XOR EBX,EBX                         ; 0056b872
        ;   Label: LAB_0056b872
    MOV EAX,[0x0067b654]                ; 0056b874 | CGame * g_CGamePtr
    MOV dword ptr [0x032776b4],EBX      ; 0056b879 | int g_DynamicLightCount
    MOV EAX,dword ptr [EAX + 0x264]     ; 0056b87f | g_CGameInstance.delta_time_float
    MOV dword ptr [0x032776c8],EBX      ; 0056b885 | int g_CoronaGlobeCount
    ...
    FNSTSW AX                           ; 0056b89a
    SAHF                                ; 0056b89c
    JNC 0x0056be70                      ; 0056b89d | LAB_0056be70
        ;   XREF to: 0056be70 (CONDITIONAL_JUMP)
    MOV EDI,dword ptr [EBP + 0x14]      ; 0056b8a3
    PUSH EDI                            ; 0056b8a6
    CALL core_setcolid.cpp_CDemonSet_FUN_005743e0 ; 0056b8a7 | void core_setcolid.cpp_CDemonSet_FUN_005743e0(CDemonSet * this_ptr)
    ...
    JLE 0x0056b8e0                      ; 0056b8b9 | LAB_0056b8e0
    ...
    JL 0x0056b8bd                       ; 0056b8d5 | LAB_0056b8bd
    ...
    FNSTSW AX                           ; 0056b8e7
    SAHF                                ; 0056b8e9
    JNC 0x0056babf                      ; 0056b8ea | LAB_0056babf
    ...
    JLE 0x0056b942                      ; 0056b914 | LAB_0056b942
    ...
    JZ 0x0056b975                       ; 0056b92f | LAB_0056b975
    ...
    JL 0x0056b922                       ; 0056b940 | LAB_0056b922
        ;   XREF to: 0056b922 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [ESP + 0x8c]      ; 0056b942
        ;   Label: LAB_0056b942
    CMP EBX,0xf423f                     ; 0056b949
    JGE 0x0056babf                      ; 0056b94f | LAB_0056babf
        ;   XREF to: 0056babf (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x84],EBX      ; 0056b955
    JMP 0x0056b8fb                      ; 0056b95c | LAB_0056b8fb
        ;   XREF to: 0056b8fb (UNCONDITIONAL_JUMP)
    CALL wincore_winrun.cpp_getTime_FUN_005f2dc0 ; 0056b95e | int wincore_winrun.cpp_getTime_FUN_005f2dc0()
        ;   Label: LAB_0056b95e
    ...
    JMP 0x0056b872                      ; 0056b970 | LAB_0056b872
    ...
    JNZ 0x0056baa0                      ; 0056b981 | LAB_0056baa0
        ;   XREF to: 0056baa0 (CONDITIONAL_JUMP)
    MOV [0x00821ff4],EAX                ; 0056b987 | undefined4 DAT_00821ff4
    ...
    MOV EAX,[0x0067b654]                ; 0056b9a7 | CGame * g_CGamePtr
    CMP dword ptr [EAX + 0x20c],0x2     ; 0056b9ac | DAT_02d81ca8
    JNZ 0x0056b9be                      ; 0056b9b3 | LAB_0056b9be
        ;   XREF to: 0056b9be (CONDITIONAL_JUMP)
    CALL wincore_winrun.cpp_getTime_FUN_005f2dc0 ; 0056b9b5 | int wincore_winrun.cpp_getTime_FUN_005f2dc0()
        ;   XREF to: 005f2dc0 (UNCONDITIONAL_CALL)
    MOV dword ptr [ESP + 0x64],EAX      ; 0056b9ba
    MOV EAX,[0x00821ff4]                ; 0056b9be | undefined4 DAT_00821ff4
        ;   Label: LAB_0056b9be
    PUSH dword ptr [ESP]                ; 0056b9c3
    PUSH EAX                            ; 0056b9c6
    MOV EDX,dword ptr [EAX + 0x154]     ; 0056b9c7
    CALL dword ptr [EDX + 0x4]          ; 0056b9cd
    MOV EAX,[0x0067b654]                ; 0056b9d0 | CGame * g_CGamePtr
    MOV ECX,dword ptr [EAX + 0x20c]     ; 0056b9d5 | DAT_02d81ca8
    ADD ESP,0x8                         ; 0056b9db
    CMP ECX,0x2                         ; 0056b9de
    JNZ 0x0056b9ff                      ; 0056b9e1 | LAB_0056b9ff
        ;   XREF to: 0056b9ff (CONDITIONAL_JUMP)
    CALL wincore_winrun.cpp_getTime_FUN_005f2dc0 ; 0056b9e3 | int wincore_winrun.cpp_getTime_FUN_005f2dc0()
        ;   XREF to: 005f2dc0 (UNCONDITIONAL_CALL)
    MOV EDX,dword ptr [ESP + 0x64]      ; 0056b9e8
    SUB EAX,EDX                         ; 0056b9ec
    MOV dword ptr [EBX + 0x32bd794],EAX ; 0056b9ee | undefined4 DAT_032bd794
    MOV EAX,[0x00821ff4]                ; 0056b9f4 | undefined4 DAT_00821ff4
    MOV dword ptr [EBX + 0x32bf6d4],EAX ; 0056b9f9 | undefined4 DAT_032bf6d4
    MOV EAX,[0x0067b654]                ; 0056b9ff | CGame * g_CGamePtr
        ;   Label: LAB_0056b9ff
    CMP dword ptr [EAX + 0x20c],0x0     ; 0056ba04 | DAT_02d81ca8
    JZ 0x0056ba1f                       ; 0056ba0b | LAB_0056ba1f
    ...
    MOV EAX,[0x00821ff4]                ; 0056ba1f | undefined4 DAT_00821ff4
        ;   Label: LAB_0056ba1f
    PUSH EAX                            ; 0056ba24
    ...
    JZ 0x0056ba4d                       ; 0056ba36 | LAB_0056ba4d
        ;   XREF to: 0056ba4d (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x00821ff4]      ; 0056ba38 | undefined4 DAT_00821ff4
    PUSH 0x0                            ; 0056ba3e
    ADD EDX,0x20                        ; 0056ba40
    PUSH EDX                            ; 0056ba43
    PUSH EAX                            ; 0056ba44
    CALL core_path.cpp_CPathMap_updateIfNeeded_FUN_00546a60 ; 0056ba45 | void core_path.cpp_CPathMap_updateIfNeeded_FUN_00546a60(CPathMap * this_ptr, CVector3f * source_position, int force_update)
        ;   XREF to: 00546a60 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0056ba4a
    MOV EDX,dword ptr [0x00821ff4]      ; 0056ba4d | undefined4 DAT_00821ff4
        ;   Label: LAB_0056ba4d
    FLD float ptr [ESP + 0x44]          ; 0056ba53
    FCOMP float ptr [EDX + 0x34]        ; 0056ba57
    FNSTSW AX                           ; 0056ba5a
    SAHF                                ; 0056ba5c
    JZ 0x0056ba7b                       ; 0056ba5d | LAB_0056ba7b
        ;   XREF to: 0056ba7b (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x00821ff4]      ; 0056ba5f | undefined4 DAT_00821ff4
        ;   Label: LAB_0056ba5f
    PUSH EDX                            ; 0056ba65
    CALL core_actor.cpp_CDemonActor_updateOrientationMatrix_FUN_00408c10 ; 0056ba66 | void core_actor.cpp_CDemonActor_updateOrientationMatrix_FUN_00408c10(CDemonActor * this_ptr)
        ;   XREF to: 00408c10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0056ba6b
    XOR ECX,ECX                         ; 0056ba6e
    MOV dword ptr [0x00821ff4],ECX      ; 0056ba70 | undefined4 DAT_00821ff4
    JMP 0x0056b931                      ; 0056ba76 | LAB_0056b931
    ...
    FNSTSW AX                           ; 0056ba82
    SAHF                                ; 0056ba84
    JNZ 0x0056ba5f                      ; 0056ba85 | LAB_0056ba5f
        ;   XREF to: 0056ba5f (CONDITIONAL_JUMP)
    FLD float ptr [ESP + 0x48]          ; 0056ba87
    FCOMP float ptr [EDX + 0x38]        ; 0056ba8b
    FNSTSW AX                           ; 0056ba8e
    SAHF                                ; 0056ba90
    JNZ 0x0056ba5f                      ; 0056ba91 | LAB_0056ba5f
        ;   XREF to: 0056ba5f (CONDITIONAL_JUMP)
    XOR ECX,ECX                         ; 0056ba93
    MOV dword ptr [0x00821ff4],ECX      ; 0056ba95 | undefined4 DAT_00821ff4
    JMP 0x0056b931                      ; 0056ba9b | LAB_0056b931
        ;   XREF to: 0056b931 (UNCONDITIONAL_JUMP)
    JLE 0x0056b931                      ; 0056baa0 | LAB_0056b931
        ;   Label: LAB_0056baa0
        ;   XREF to: 0056b931 (CONDITIONAL_JUMP)
    CMP EDX,dword ptr [ESP + 0x8c]      ; 0056baa6
    JGE 0x0056b931                      ; 0056baad | LAB_0056b931
        ;   XREF to: 0056b931 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x8c],EDX      ; 0056bab3
    JMP 0x0056b931                      ; 0056baba | LAB_0056b931
        ;   XREF to: 0056b931 (UNCONDITIONAL_JUMP)
    ...
    JLE 0x0056bca6                      ; 0056bacc | LAB_0056bca6
    ...
    PUSH ECX                            ; 0056bae1
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 0056bae2 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0056bae7
    MOV EBX,EAX                         ; 0056baea
    MOV dword ptr [ESP + 0x74],EAX      ; 0056baec
    TEST EAX,EAX                        ; 0056baf0
    JZ 0x0056bb96                       ; 0056baf2 | LAB_0056bb96
    ...
    JNZ 0x0056bb96                      ; 0056bb0a | LAB_0056bb96
        ;   XREF to: 0056bb96 (CONDITIONAL_JUMP)
    ...
    PUSH 0x0                            ; 0056bb21
    PUSH EBX                            ; 0056bb23
    MOV EDX,dword ptr [0x0067a3d0]      ; 0056bb24 | CFireEffect g_CFireEffectInstance | CFireEffect * g_CFireEffectPtr
    PUSH EDX                            ; 0056bb2a | CFireEffect g_CFireEffectInstance
    CALL core_fire.cpp_CFireEffect_FUN_004c8c90 ; 0056bb2b | int core_fire.cpp_CFireEffect_FUN_004c8c90(CFireEffect * this_ptr)
        ;   XREF to: 004c8c90 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0056bb30
    TEST EAX,EAX                        ; 0056bb33
    JZ 0x0056bb96                       ; 0056bb35 | LAB_0056bb96
        ;   XREF to: 0056bb96 (CONDITIONAL_JUMP)
    LEA EAX,[ESP + 0x4]                 ; 0056bb37
    PUSH EAX                            ; 0056bb3b
    CALL core_charactr.cpp_SDamageInfo_ctor_FUN_00427db0 ; 0056bb3c | SDamageInfo * core_charactr.cpp_SDamageInfo_ctor_FUN_00427db0(SDamageInfo * this_ptr)
    ...
    JZ 0x0056bb79                       ; 0056bb5f | LAB_0056bb79
    ...
    PUSH EDX                            ; 0056bba2
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 0056bba3 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 0056bba8
    ADD ESP,0x8                         ; 0056bbaa
    TEST EAX,EAX                        ; 0056bbad
    JZ 0x0056bbef                       ; 0056bbaf | LAB_0056bbef
    ...
    MOV EAX,[0x0067a3d0]                ; 0056bbc2 | CFireEffect g_CFireEffectInstance | CFireEffect * g_CFireEffectPtr
    PUSH EAX                            ; 0056bbc7 | CFireEffect g_CFireEffectInstance
    CALL core_fire.cpp_CFireEffect_FUN_004c8c90 ; 0056bbc8 | int core_fire.cpp_CFireEffect_FUN_004c8c90(CFireEffect * this_ptr)
        ;   XREF to: 004c8c90 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0056bbcd
    TEST EAX,EAX                        ; 0056bbd0
    JZ 0x0056bbef                       ; 0056bbd2 | LAB_0056bbef
        ;   XREF to: 0056bbef (CONDITIONAL_JUMP)
    PUSH EBX                            ; 0056bbd4
    CALL core_glass.cpp_CGlass_checkBreakableCondition_FUN_004eb3a0 ; 0056bbd5 | void core_glass.cpp_CGlass_checkBreakableCondition_FUN_004eb3a0(CGlass * this_ptr)
        ;   XREF to: 004eb3a0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0056bbda
    TEST EAX,EAX                        ; 0056bbdd
    JZ 0x0056bbef                       ; 0056bbdf | LAB_0056bbef
        ;   XREF to: 0056bbef (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [ESP + 0x78]      ; 0056bbe1
    PUSH EDX                            ; 0056bbe5
    PUSH EBX                            ; 0056bbe6
    CALL core_glass.cpp_CGlass_shatter_FUN_004eaef0 ; 0056bbe7 | void core_glass.cpp_CGlass_shatter_FUN_004eaef0(CGlass * this_ptr, CVector3f * location)
    ...
    PUSH EBX                            ; 0056bbfc
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 0056bbfd | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 0056bc02
    ADD ESP,0x8                         ; 0056bc04
    TEST EAX,EAX                        ; 0056bc07
    JZ 0x0056bc4f                       ; 0056bc09 | LAB_0056bc4f
        ;   XREF to: 0056bc4f (CONDITIONAL_JUMP)
    CMP dword ptr [EAX + 0x174],0x7     ; 0056bc0b
    JNZ 0x0056bc4f                      ; 0056bc12 | LAB_0056bc4f
        ;   XREF to: 0056bc4f (CONDITIONAL_JUMP)
    CMP byte ptr [EBX + 0x304],0x0      ; 0056bc14
    JNZ 0x0056bc4f                      ; 0056bc1b | LAB_0056bc4f
        ;   XREF to: 0056bc4f (CONDITIONAL_JUMP)
    ...
    PUSH 0x0                            ; 0056bc28
    PUSH EAX                            ; 0056bc2a
    MOV ECX,dword ptr [0x0067a3d0]      ; 0056bc2b | CFireEffect g_CFireEffectInstance | CFireEffect * g_CFireEffectPtr
    PUSH ECX                            ; 0056bc31 | CFireEffect g_CFireEffectInstance
    MOV dword ptr [ESP + 0x74],EDX      ; 0056bc32
    CALL core_fire.cpp_CFireEffect_FUN_004c8c90 ; 0056bc36 | int core_fire.cpp_CFireEffect_FUN_004c8c90(CFireEffect * this_ptr)
        ;   XREF to: 004c8c90 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0056bc3b
    TEST EAX,EAX                        ; 0056bc3e
    JZ 0x0056bc4f                       ; 0056bc40 | LAB_0056bc4f
        ;   XREF to: 0056bc4f (CONDITIONAL_JUMP)
    PUSH dword ptr [ESP + 0x60]         ; 0056bc42
    PUSH EBX                            ; 0056bc46
    CALL core_trigger.cpp_SomethingReceivedDamage_FUN_005e0b00 ; 0056bc47 | undefined core_trigger.cpp_SomethingReceivedDamage_FUN_005e0b00()
    ...
    PUSH EAX                            ; 0056bc5c
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 0056bc5d | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    MOV EBX,EAX                         ; 0056bc62
    ADD ESP,0x8                         ; 0056bc64
    TEST EAX,EAX                        ; 0056bc67
    JZ 0x0056bc91                       ; 0056bc69 | LAB_0056bc91
    ...
    PUSH 0x0                            ; 0056bc72
    PUSH EAX                            ; 0056bc74
    MOV EDX,dword ptr [0x0067a3d0]      ; 0056bc75 | CFireEffect g_CFireEffectInstance | CFireEffect * g_CFireEffectPtr
    PUSH EDX                            ; 0056bc7b | CFireEffect g_CFireEffectInstance
    CALL core_fire.cpp_CFireEffect_FUN_004c8c90 ; 0056bc7c | int core_fire.cpp_CFireEffect_FUN_004c8c90(CFireEffect * this_ptr)
        ;   XREF to: 004c8c90 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 0056bc81
    TEST EAX,EAX                        ; 0056bc84
    JZ 0x0056bc91                       ; 0056bc86 | LAB_0056bc91
        ;   XREF to: 0056bc91 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 0056bc88
    CALL core_flamecan.cpp_FUN_004cb340 ; 0056bc89 | undefined core_flamecan.cpp_FUN_004cb340()
    ...
    JLE 0x0056bd7d                      ; 0056bcdd | LAB_0056bd7d
    ...
    JGE 0x0056bd57                      ; 0056bd02 | LAB_0056bd57
    ...
    MOV EDI,dword ptr [EAX + 0x32bd794] ; 0056bd13 | undefined4 DAT_032bd794 | DAT_032bd798
        ;   Label: LAB_0056bd13
    MOV ESI,dword ptr [EDX + 0x32bd794] ; 0056bd19 | undefined4 DAT_032bd794 | DAT_032bd798
    CMP ESI,EDI                         ; 0056bd1f
    JGE 0x0056bd4f                      ; 0056bd21 | LAB_0056bd4f
        ;   XREF to: 0056bd4f (CONDITIONAL_JUMP)
    MOV EDI,ESI                         ; 0056bd23
    MOV ESI,dword ptr [EAX + 0x32bd794] ; 0056bd25 | undefined4 DAT_032bd794
    MOV dword ptr [EDX + 0x32bd794],ESI ; 0056bd2b | undefined4 DAT_032bd794 | undefined4 DAT_032bd798
    MOV dword ptr [EAX + 0x32bd794],EDI ; 0056bd31 | undefined4 DAT_032bd794
    MOV EDI,dword ptr [EAX + 0x32bf6d4] ; 0056bd37 | undefined4 DAT_032bf6d4
    MOV ESI,dword ptr [EDX + 0x32bf6d4] ; 0056bd3d | undefined4 DAT_032bf6d4
    MOV dword ptr [EDX + 0x32bf6d4],EDI ; 0056bd43 | undefined4 DAT_032bf6d4
    MOV dword ptr [EAX + 0x32bf6d4],ESI ; 0056bd49 | undefined4 DAT_032bf6d4
    ADD EAX,0x4                         ; 0056bd4f
        ;   Label: LAB_0056bd4f
    INC EBX                             ; 0056bd52
    CMP EAX,ECX                         ; 0056bd53
    JL 0x0056bd13                       ; 0056bd55 | LAB_0056bd13
    ...
    JL 0x0056bcf1                       ; 0056bd77 | LAB_0056bcf1
        ;   XREF to: 0056bcf1 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x88]      ; 0056bd7d
        ;   Label: LAB_0056bd7d
    MOV EDI,0x14                        ; 0056bd84
    CMP EAX,EDI                         ; 0056bd89
    JGE 0x0056bd8f                      ; 0056bd8b | LAB_0056bd8f
        ;   XREF to: 0056bd8f (CONDITIONAL_JUMP)
    MOV EDI,EAX                         ; 0056bd8d
    XOR ESI,ESI                         ; 0056bd8f
        ;   Label: LAB_0056bd8f
    TEST EDI,EDI                        ; 0056bd91
    JLE 0x0056bde0                      ; 0056bd93 | LAB_0056bde0
        ;   XREF to: 0056bde0 (CONDITIONAL_JUMP)
    XOR EBX,EBX                         ; 0056bd95
    FILD dword ptr [EBX + 0x32bd794]    ; 0056bd97 | undefined4 DAT_032bd794 | DAT_032bd798
        ;   Label: LAB_0056bd97
    FMUL double ptr [0x00645d1b]        ; 0056bd9d | double DOUBLE_00645d1b
    FMUL double ptr [0x00645d23]        ; 0056bda3 | double DOUBLE_00645d23
    FMUL double ptr [0x00645d2b]        ; 0056bda9 | double DOUBLE_00645d2b
    FDIV float ptr [ESP]                ; 0056bdaf
    SUB ESP,0x8                         ; 0056bdb2
    FSTP double ptr [ESP]               ; 0056bdb5
    MOV ECX,dword ptr [EBX + 0x32bf6d4] ; 0056bdb8 | undefined4 DAT_032bf6d4 | DAT_032bf6d8
    PUSH ECX                            ; 0056bdbe
    PUSH ESI                            ; 0056bdbf
    PUSH 0x645ccf                       ; 0056bdc0 | = "%d. %s : %3.2f ms\n" | s_d_s_3_2f_ms_00645ccf = %d. %s : %3.2f ms

    MOV EAX,[0x0066e8e0]                ; 0056bdc5 | CConsole g_ConsolePtr | CConsole * g_CConsolePtr
    PUSH EAX                            ; 0056bdca | CConsole g_ConsolePtr
    ADD EBX,0x4                         ; 0056bdcb
    INC ESI                             ; 0056bdce
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 0056bdcf | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
        ;   XREF to: 00441890 (UNCONDITIONAL_CALL)
    ADD ESP,0x18                        ; 0056bdd4
    CMP ESI,EDI                         ; 0056bdd7
    JL 0x0056bd97                       ; 0056bdd9 | LAB_0056bd97
        ;   XREF to: 0056bd97 (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 0056bddb
    MOV ECX,ECX                         ; 0056bdde
    CALL wincore_winrun.cpp_getTime_FUN_005f2dc0 ; 0056bde0 | int wincore_winrun.cpp_getTime_FUN_005f2dc0()
        ;   Label: LAB_0056bde0
        ;   XREF to: 005f2dc0 (UNCONDITIONAL_CALL)
    ...
    FMUL double ptr [0x00645d1b]        ; 0056bdf9 | double DOUBLE_00645d1b
    FMUL double ptr [0x00645d23]        ; 0056bdff | double DOUBLE_00645d23
    FMUL double ptr [0x00645d2b]        ; 0056be05 | double DOUBLE_00645d2b
    FDIV float ptr [ESP]                ; 0056be0b
    SUB ESP,0x8                         ; 0056be0e
    MOV ECX,dword ptr [ESP + 0x90]      ; 0056be11
    FSTP double ptr [ESP]               ; 0056be18
    PUSH ECX                            ; 0056be1b
    PUSH 0x645ce2                       ; 0056be1c | = "Process time (%d actors) : %3.2f ms\n" | s_Process_time_d_actors_3__00645ce2 = Process time (%d actors) : %3.2f ms

    MOV EBX,dword ptr [0x0066e8e0]      ; 0056be21 | CConsole g_ConsolePtr | CConsole * g_CConsolePtr
    PUSH EBX                            ; 0056be27 | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 0056be28 | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
        ;   XREF to: 00441890 (UNCONDITIONAL_CALL)
    ...
    JLE 0x0056be70                      ; 0056be3d | LAB_0056be70
        ;   XREF to: 0056be70 (CONDITIONAL_JUMP)
    MOV ESI,EAX                         ; 0056be3f
    PUSH 0x654                          ; 0056be41
        ;   Label: LAB_0056be41
    PUSH 0x645d07                       ; 0056be46 | = "..\\core\\set.cpp" | s_core_set_cpp_00645d07 = ..\core\set.cpp
    MOV EDI,dword ptr [ESI + 0x14d158]  ; 0056be4b
    PUSH EDI                            ; 0056be51
    CALL core_actor.cpp_CDemonActor_doCheckForInvalidPointers_FUN_0040ac80 ; 0056be52 | void core_actor.cpp_CDemonActor_doCheckForInvalidPointers_FUN_0040ac80(CDemonActor * this_ptr, char * context_file, int context_line)
        ;   XREF to: 0040ac80 (UNCONDITIONAL_CALL)
    ...
    JL 0x0056be41                       ; 0056be69 | LAB_0056be41
