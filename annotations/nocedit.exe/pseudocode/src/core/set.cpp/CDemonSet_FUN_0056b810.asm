...
;                               FUNCTION
; *****************************************************************************
; __cdecl int __cdecl core_set_cpp_CDemonSet_FUN_0056b810(CDemonSet *this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV [0x00821ff4],EAX                ; 0056b987 | DAT_00821ff4
    ...
    MOV EAX,[0x00821ff4]                ; 0056b9be | DAT_00821ff4
        ;   Label: LAB_0056b9be
    ...
    MOV dword ptr [EBX + 0x32bd794],EAX ; 0056b9ee | DAT_032bd794
    MOV EAX,[0x00821ff4]                ; 0056b9f4 | DAT_00821ff4
    MOV dword ptr [EBX + 0x32bf6d4],EAX ; 0056b9f9 | DAT_032bf6d4
    ...
    MOV EAX,[0x00821ff4]                ; 0056ba1f | DAT_00821ff4
        ;   Label: LAB_0056ba1f
    PUSH EAX                            ; 0056ba24
    ...
    MOV EDX,dword ptr [0x00821ff4]      ; 0056ba38 | DAT_00821ff4
    PUSH 0x0                            ; 0056ba3e
    ...
    MOV EDX,dword ptr [0x00821ff4]      ; 0056ba4d | DAT_00821ff4
        ;   Label: LAB_0056ba4d
    ...
    MOV EDX,dword ptr [0x00821ff4]      ; 0056ba5f | DAT_00821ff4
        ;   Label: LAB_0056ba5f
    PUSH EDX                            ; 0056ba65
    ...
    MOV dword ptr [0x00821ff4],ECX      ; 0056ba70 | DAT_00821ff4
    ...
    MOV dword ptr [0x00821ff4],ECX      ; 0056ba95 | DAT_00821ff4
    ...
    CALL core_fire.cpp_CFireEffect_FUN_004c8c90 ; 0056bb2b
    ...
    CALL core_fire.cpp_CFireEffect_FUN_004c8c90 ; 0056bbc8
        ;   XREF to: 004c8c90 (UNCONDITIONAL_CALL)  ; int core_fire.cpp_CFireEffect_FUN_004c8c90(CFireEffect * this_ptr)
    ...
    CALL core_fire.cpp_CFireEffect_FUN_004c8c90 ; 0056bc36
        ;   XREF to: 004c8c90 (UNCONDITIONAL_CALL)  ; int core_fire.cpp_CFireEffect_FUN_004c8c90(CFireEffect * this_ptr)
    ...
    CALL core_fire.cpp_CFireEffect_FUN_004c8c90 ; 0056bc7c
        ;   XREF to: 004c8c90 (UNCONDITIONAL_CALL)  ; int core_fire.cpp_CFireEffect_FUN_004c8c90(CFireEffect * this_ptr)
    ...
    MOV EDI,dword ptr [EAX + 0x32bd794] ; 0056bd13 | DAT_032bd794 | DAT_032bd798
        ;   Label: LAB_0056bd13
    MOV ESI,dword ptr [EDX + 0x32bd794] ; 0056bd19 | DAT_032bd794 | DAT_032bd798
    CMP ESI,EDI                         ; 0056bd1f
    JGE 0x0056bd4f                      ; 0056bd21
        ;   XREF to: 0056bd4f (CONDITIONAL_JUMP)  ; LAB_0056bd4f
    MOV EDI,ESI                         ; 0056bd23
    MOV ESI,dword ptr [EAX + 0x32bd794] ; 0056bd25 | DAT_032bd794
    MOV dword ptr [EDX + 0x32bd794],ESI ; 0056bd2b | DAT_032bd794 | DAT_032bd798
    MOV dword ptr [EAX + 0x32bd794],EDI ; 0056bd31 | DAT_032bd794
    MOV EDI,dword ptr [EAX + 0x32bf6d4] ; 0056bd37 | DAT_032bf6d4
    MOV ESI,dword ptr [EDX + 0x32bf6d4] ; 0056bd3d | DAT_032bf6d4
    MOV dword ptr [EDX + 0x32bf6d4],EDI ; 0056bd43 | DAT_032bf6d4
    MOV dword ptr [EAX + 0x32bf6d4],ESI ; 0056bd49 | DAT_032bf6d4
    ...
    FILD dword ptr [EBX + 0x32bd794]    ; 0056bd97 | DAT_032bd794 | DAT_032bd798
        ;   Label: LAB_0056bd97
    ...
    MOV ECX,dword ptr [EBX + 0x32bf6d4] ; 0056bdb8 | DAT_032bf6d4 | DAT_032bf6d8
    PUSH ECX                            ; 0056bdbe
    PUSH ESI                            ; 0056bdbf
