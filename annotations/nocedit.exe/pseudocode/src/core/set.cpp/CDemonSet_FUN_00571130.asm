...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_set.cpp_CDemonSet_FUN_00571130(CDemonSet * this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV ESI,dword ptr [0x03276dac]      ; 00571131 | int g_MasterLightCount
    MOV EDX,dword ptr [ESP + 0xc]       ; 00571137
    MOV ECX,dword ptr [EDX]             ; 0057113b
    CMP ESI,ECX                         ; 0057113d
    JNZ 0x00571161                      ; 0057113f | LAB_00571161
        ;   XREF to: 00571161 (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 00571141
    TEST ECX,ECX                        ; 00571143
    JLE 0x00571161                      ; 00571145 | LAB_00571161
        ;   XREF to: 00571161 (CONDITIONAL_JUMP)
    PUSH EBX                            ; 00571147
    MOV EBX,dword ptr [EAX*0x4 + 0x3276db0] ; 00571148 | CDemonLight *[96] g_MasterLightList
        ;   Label: LAB_00571148
    ...
    JL 0x00571148                       ; 0057115e | LAB_00571148
        ;   XREF to: 00571148 (CONDITIONAL_JUMP)
    POP EBX                             ; 00571160
    MOV dword ptr [0x03276dac],ESI      ; 00571161 | int g_MasterLightCount
        ;   Label: LAB_00571161
    POP ESI                             ; 00571167
    RET                                 ; 00571168
