...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_set_cpp_CDemonSet_FUN_0056d190(CDemonSet *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH 0x80                           ; 0056d1a8
        ;   Label: LAB_0056d1a8
    MOV ECX,dword ptr [EBX + 0x68125c]  ; 0056d1ad | DAT_0068125c | DAT_00681260
    PUSH ECX                            ; 0056d1b3
    MOV EDI,dword ptr [EBX + 0x6810dc]  ; 0056d1b4 | DAT_006810dc | DAT_006810e0
    PUSH EDI                            ; 0056d1ba
    ...
    PUSH 0x80                           ; 0056d1f5
        ;   Label: LAB_0056d1f5
    MOV ECX,dword ptr [EBX + 0x68125c]  ; 0056d1fa | DAT_0068125c | DAT_00681260 | DAT_00681264
    PUSH ECX                            ; 0056d200
    MOV ESI,dword ptr [EBX + 0x6810dc]  ; 0056d201 | DAT_006810dc | DAT_006810e0 | DAT_006810e4
    PUSH ESI                            ; 0056d207
    ...
    MOV ESI,dword ptr [0x03277d80]      ; 0056d230 | DAT_03277d80
        ;   Label: LAB_0056d230
    PUSH ESI                            ; 0056d236
    ...
    PUSH EDI                            ; 0056d25e
    MOV EBP,dword ptr [EBX*0x4 + 0x6810dc] ; 0056d25f | DAT_006810dc
    PUSH EBP                            ; 0056d266
    ...
    PUSH ESI                            ; 0056d296
    MOV EDX,dword ptr [EBX*0x4 + 0x6810dc] ; 0056d297 | DAT_006810dc
    PUSH EDX                            ; 0056d29e
