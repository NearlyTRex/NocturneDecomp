...
;   core_set.cpp_CDemonSet_renderEnvMapBatchTri_FUN_0056ffe0 at 0056fff8
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00570040
        ;   Label: core_set.cpp_CDemonSet_renderEnvMapPrimitives_FUN_00570040
    PUSH ESI                            ; 00570041
    PUSH EDI                            ; 00570042
    PUSH EBP                            ; 00570043
    SUB ESP,0xe4                        ; 00570044
    MOV EBP,dword ptr [ESP + 0xfc]      ; 0057004a
    PUSH 0x6813e4                       ; 00570051 | g_EnvMapTexture
    ...
    CALL engine_drender.cpp_CDemonRenderer_renderAlphaBlendedPoly_FUN_0048b1e0 ; 0057021f
    ...
    CALL engine_drender.cpp_CDemonRenderer_renderDestReadBlendPoly_FUN_0048b970 ; 005702a2
