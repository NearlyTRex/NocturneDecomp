...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_set_cpp_CDemonSet_SetStateVersionCameraCountInStrings_FUN_005711b0(CDemonSet *this_ptr)
;
; Parameters:
...
section .text
    ...
    JLE 0x00571227                      ; 005711fe
        ;   XREF to: 00571227 (CONDITIONAL_JUMP)  ; LAB_00571227
    PUSH ESI                            ; 00571200
    ...
    JL 0x00571203                       ; 00571224
        ;   XREF to: 00571203 (CONDITIONAL_JUMP)  ; LAB_00571203
    POP ESI                             ; 00571226
    POP EBP                             ; 00571227
        ;   Label: LAB_00571227
    POP EDI                             ; 00571228
