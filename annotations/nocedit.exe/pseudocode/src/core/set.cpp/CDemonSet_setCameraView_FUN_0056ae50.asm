...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_set_cpp_CDemonSet_setCameraView_FUN_0056ae50(CDemonSet *this_ptr,int index)
;
; Parameters:
...
;
; XREF[13]:
;   core_game.cpp_CGame_FUN_004dc3e0 at 004dcca5
;   core_game.cpp_CGame_FUN_004dcee0 at 004dd416
...
section .text
    ...
    CALL core_weather.cpp_CWeather_FUN_005ef940 ; 0056b171
        ;   XREF to: 005ef940 (UNCONDITIONAL_CALL)  ; void core_weather.cpp_CWeather_FUN_005ef940(CWeather * this_ptr)
