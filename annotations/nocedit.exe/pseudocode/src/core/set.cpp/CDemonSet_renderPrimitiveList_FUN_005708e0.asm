...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_set.cpp_CDemonSet_renderPrimitiveList_FUN_005708e0(CDemonSet * this_ptr, SMRGLHeaderPrimitive * primitive_array, int primitive_count)
;
; Parameters:
...
section .text
    ...
    MOV EBX,dword ptr [0x0067b654]      ; 005708f0 | CGame * g_CGamePtr
    CMP dword ptr [EBX + 0x1f0],0x0     ; 005708f6 | DAT_02d81c8c
    JNZ 0x00570930                      ; 005708fd | LAB_00570930
        ;   XREF to: 00570930 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [0x006703ec]      ; 005708ff | CDemonRenderer * g_CDemonRendererPtr
    MOV EBX,dword ptr [EBX + 0x18]      ; 00570905 | DAT_02c6d590
    TEST EBX,EBX                        ; 00570908
    JZ 0x00570935                       ; 0057090a | LAB_00570935
        ;   XREF to: 00570935 (CONDITIONAL_JUMP)
    XOR EBX,EBX                         ; 0057090c
    TEST EDI,EDI                        ; 0057090e
    JLE 0x00570930                      ; 00570910 | LAB_00570930
        ;   XREF to: 00570930 (CONDITIONAL_JUMP)
    ...
    PUSH EAX                            ; 0057091b
    INC EBX                             ; 0057091c
    CALL core_mirror.cpp_CMirror_clipAndRenderReflectedPrimitive_FUN_00522560 ; 0057091d | void core_mirror.cpp_CMirror_clipAndRenderReflectedPrimitive_FUN_00522560(CMirror * this_ptr, SMRGLHeaderPrimitive * prim)
        ;   XREF to: 00522560 (UNCONDITIONAL_CALL)
    ADD ESI,0x28                        ; 00570922
    ADD ESP,0x8                         ; 00570925
    CMP EBX,EDI                         ; 00570928
    JL 0x00570914                       ; 0057092a | LAB_00570914
    ...
    JLE 0x00570930                      ; 00570939 | LAB_00570930
        ;   XREF to: 00570930 (CONDITIONAL_JUMP)
    MOV EBX,EAX                         ; 0057093b
    PUSH EBX                            ; 0057093d
        ;   Label: LAB_0057093d
    MOV ECX,dword ptr [0x006703ec]      ; 0057093e | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH ECX                            ; 00570944 | CDemonRenderer g_CDemonRendererInstance
    INC ESI                             ; 00570945
    CALL engine_drender.cpp_CDemonRenderer_renderBasicTextured_FUN_0048a820 ; 00570946 | void engine_drender.cpp_CDemonRenderer_renderBasicTextured_FUN_0048a820(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * polygon_info)
        ;   XREF to: 0048a820 (UNCONDITIONAL_CALL)
    ADD EBX,0x28                        ; 0057094b
    ADD ESP,0x8                         ; 0057094e
    CMP ESI,EDI                         ; 00570951
    JL 0x0057093d                       ; 00570953 | LAB_0057093d
