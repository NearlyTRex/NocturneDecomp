...
section .text
    ...
    MOV EAX,[0x0067d550]                ; 0056acab | CDemonMission g_CDemonMissionInstance | CDemonMission * g_CDemonMissionPtr
    CMP dword ptr [EAX + 0x4],0x0       ; 0056acb0 | DAT_02f33744
    JNZ 0x0056adb6                      ; 0056acb4 | LAB_0056adb6
        ;   XREF to: 0056adb6 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [ESI + 0x15f6e4]  ; 0056acba
        ;   Label: LAB_0056acba
    XOR EBP,EBP                         ; 0056acc0
    TEST EBX,EBX                        ; 0056acc2
    JLE 0x0056adae                      ; 0056acc4 | LAB_0056adae
    ...
    PUSH EAX                            ; 0056ad26
    PUSH ESI                            ; 0056ad27
    CALL core_set.cpp_CDemonSet_FUN_0056d380 ; 0056ad28 | void core_set.cpp_CDemonSet_FUN_0056d380(CDemonSet * this_ptr)
    ...
    PUSH ECX                            ; 0056ad44
    PUSH ESI                            ; 0056ad45
    CALL core_set.cpp_CDemonSet_FUN_00570ca0 ; 0056ad46 | void core_set.cpp_CDemonSet_FUN_00570ca0(CDemonSet * this_ptr)
        ;   XREF to: 00570ca0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0056ad4b
    PUSH 0xffff                         ; 0056ad4e
    MOV EAX,[0x006703ec]                ; 0056ad53 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH EAX                            ; 0056ad58 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_setRenderAlpha_FUN_0048ca60 ; 0056ad59 | void engine_drender.cpp_CDemonRenderer_setRenderAlpha_FUN_0048ca60(CDemonRenderer * this_ptr, int render_alpha)
    ...
    PUSH ESI                            ; 0056ad82
    CALL core_set.cpp_CDemonSet_FUN_00570ca0 ; 0056ad83 | void core_set.cpp_CDemonSet_FUN_00570ca0(CDemonSet * this_ptr)
        ;   XREF to: 00570ca0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0056ad88
    PUSH 0x1                            ; 0056ad8b
    MOV ECX,dword ptr [0x006703ec]      ; 0056ad8d | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH ECX                            ; 0056ad93 | CDemonRenderer g_CDemonRendererInstance
    ADD EDI,0x4                         ; 0056ad94
    INC EBP                             ; 0056ad97
    CALL engine_drender.cpp_CDemonRenderer_enableFaceCapture_FUN_0048caa0 ; 0056ad98 | void engine_drender.cpp_CDemonRenderer_enableFaceCapture_FUN_0048caa0(CDemonRenderer * this_ptr, int enabled)
        ;   XREF to: 0048caa0 (UNCONDITIONAL_CALL)
    MOV EBX,dword ptr [ESI + 0x15f6e4]  ; 0056ad9d
    ADD ESP,0x8                         ; 0056ada3
    CMP EBP,EBX                         ; 0056ada6
    JL 0x0056accc                       ; 0056ada8 | LAB_0056accc
    ...
    JMP 0x0056acba                      ; 0056adbc | LAB_0056acba
    ...
    JMP 0x0056acf2                      ; 0056add5 | LAB_0056acf2
