...
;
; Called Functions:
;   core_set.cpp_CDemonSet_setCameraEnabled_FUN_00570ea0
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 00570ec0
        ;   Label: core_set.cpp_CDemonSet_setCameraEnabledByGroup_FUN_00570ec0
    PUSH ESI                            ; 00570ec1
    PUSH EDI                            ; 00570ec2
    PUSH EBP                            ; 00570ec3
    ...
    PUSH EBX                            ; 00570ef5
    PUSH EDI                            ; 00570ef6
    CALL core_set.cpp_CDemonSet_setCameraEnabled_FUN_00570ea0 ; 00570ef7
