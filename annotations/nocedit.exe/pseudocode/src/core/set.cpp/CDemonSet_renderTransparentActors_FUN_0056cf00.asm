...
;
; XREF[2]:
;   core_msnedit.cpp_CDemonMission_editActorsInSet_FUN_005390f0 at 0053a366
;   core_set.cpp_CDemonSet_renderScene_FUN_0056c1a0 at 0056c4e6
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0056cf00
        ;   Label: core_set.cpp_CDemonSet_renderTransparentActors_FUN_0056cf00
    PUSH ESI                            ; 0056cf01
    PUSH EDI                            ; 0056cf02
    PUSH EBP                            ; 0056cf03
    ...
    PUSH EAX                            ; 0056cfb9
    PUSH EDI                            ; 0056cfba
    CALL core_set.cpp_CDemonSet_setLightingParameters_FUN_0056d380 ; 0056cfbb
    ...
    PUSH EDI                            ; 0056d04f
    INC ESI                             ; 0056d050
    CALL core_set.cpp_CDemonSet_restoreCameraAfterMirror_FUN_00570af0 ; 0056d051
