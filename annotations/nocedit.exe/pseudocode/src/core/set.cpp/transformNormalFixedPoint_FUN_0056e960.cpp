// Name: core_set.cpp_transformNormalFixedPoint_FUN_0056e960
// Address: 0056e960
// Address Range: [[0056e960, 0056eab0]]
// Convention: __stack_esi
// Signature: CVector3i * __stack_esi core_set_cpp_transformNormalFixedPoint_FUN_0056e960(CVector3i *input,CVector3i *output)
...

{
  ...
  lVar6 = (longlong)g_TransformMatrix.m[2].x * (longlong)input->z;
  ...
  output->x = ((uint)((longlong)g_InverseMatrix.m[0].x * (longlong)iVar7) >> 0x10 |
              (int)((ulonglong)((longlong)g_InverseMatrix.m[0].x * (longlong)iVar7) >> 0x20) << 0x10
              ) + ((uint)((longlong)g_InverseMatrix.m[1].x * (longlong)iVar8) >> 0x10 |
