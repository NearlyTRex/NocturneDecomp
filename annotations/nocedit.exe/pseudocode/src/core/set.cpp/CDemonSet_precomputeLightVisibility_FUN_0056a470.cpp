...

{
  ...
  if (0 < this_ptr->camera_count) {
    ...
    do {
      ...
      if (local_14 < local_24) {
        ...
        do {
          ...
          if (this_ptr->lights[local_14].light_type == 0) {
            ...
            core_dcamera_cpp_CDemonCamera_endScene_FUN_0044cb80(&g_CDemonCameraInstance,0);
            pcVar1 = this_ptr->lights[iVar7].field8_0x21e + local_2c + 6;
            pcVar1[0] = '\0';
            pcVar1[1] = '\0';
            pcVar1[2] = '\0';
            pcVar1[3] = '\0';
            pcVar1 = this_ptr->lights[iVar7].field8_0x21e + local_2c + 10;
            pcVar1[0] = '\0';
            pcVar1[1] = '\0';
            pcVar1[2] = '\0';
            pcVar1[3] = '\0';
            pcVar1 = this_ptr->lights[iVar7].field8_0x21e + local_2c + 0xe;
            pcVar1[0] = '\0';
            pcVar1[1] = '\0';
            pcVar1[2] = '\0';
            pcVar1[3] = '\0';
            pcVar1 = this_ptr->lights[iVar7].field8_0x21e + local_2c + 0x12;
            pcVar1[0] = '\0';
            pcVar1[1] = '\0';
            pcVar1[2] = '\0';
            pcVar1[3] = '\0';
      ...
      local_3c = (CDemonSet *)&local_3c->cameras[0].field17_0x1a0;
