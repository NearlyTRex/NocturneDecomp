...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_set.cpp_CDemonSet_FUN_0056cf00(CDemonSet * this_ptr)
;
; Parameters:
...
section .text
    ...
    JL 0x0056cf4d                       ; 0056cf14 | LAB_0056cf4d
    ...
    JNZ 0x0056cf55                      ; 0056cf34 | LAB_0056cf55
    ...
    JGE 0x0056cf23                      ; 0056cf4b | LAB_0056cf23
    ...
    JZ 0x0056cf85                       ; 0056cf6f | LAB_0056cf85
    ...
    JZ 0x0056cfa4                       ; 0056cf8e | LAB_0056cfa4
    ...
    PUSH EAX                            ; 0056cfb9
    PUSH EDI                            ; 0056cfba
    CALL core_set.cpp_CDemonSet_FUN_0056d380 ; 0056cfbb | void core_set.cpp_CDemonSet_FUN_0056d380(CDemonSet * this_ptr)
    ...
    PUSH EDX                            ; 0056cfd7
    PUSH EDI                            ; 0056cfd8
    CALL core_set.cpp_CDemonSet_FUN_00570ca0 ; 0056cfd9 | void core_set.cpp_CDemonSet_FUN_00570ca0(CDemonSet * this_ptr)
    ...
    JZ 0x0056d080                       ; 0056cff0 | LAB_0056d080
        ;   XREF to: 0056d080 (CONDITIONAL_JUMP)
    OR byte ptr [EBX + 0x140],0x8       ; 0056cff6
    PUSH 0x1                            ; 0056cffd
        ;   Label: LAB_0056cffd
    MOV ECX,dword ptr [0x006703ec]      ; 0056cfff | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH ECX                            ; 0056d005 | CDemonRenderer g_CDemonRendererInstance
    XOR ESI,ESI                         ; 0056d006
    CALL engine_drender.cpp_CDemonRenderer_enableFaceCapture_FUN_0048caa0 ; 0056d008 | void engine_drender.cpp_CDemonRenderer_enableFaceCapture_FUN_0048caa0(CDemonRenderer * this_ptr, int enabled)
        ;   XREF to: 0048caa0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [EDI + 0x15acb4]  ; 0056d00d
    ADD ESP,0x8                         ; 0056d013
    TEST EAX,EAX                        ; 0056d016
    JLE 0x0056d063                      ; 0056d018 | LAB_0056d063
        ;   XREF to: 0056d063 (CONDITIONAL_JUMP)
    PUSH 0x0                            ; 0056d01a
        ;   Label: LAB_0056d01a
    PUSH ESI                            ; 0056d01c
    PUSH EDI                            ; 0056d01d
    CALL core_set.cpp_CDemonSet_setupMirrorRendering_FUN_005709e0 ; 0056d01e | void core_set.cpp_CDemonSet_setupMirrorRendering_FUN_005709e0(CDemonSet * this_ptr, int mirror_index, int enable_flag)
    ...
    JZ 0x0056d03e                       ; 0056d035 | LAB_0056d03e
        ;   XREF to: 0056d03e (CONDITIONAL_JUMP)
    OR byte ptr [EBX + 0x140],0x8       ; 0056d037
    PUSH 0x1                            ; 0056d03e
        ;   Label: LAB_0056d03e
    MOV EDX,dword ptr [0x006703ec]      ; 0056d040 | CDemonRenderer g_CDemonRendererInstance | CDemonRenderer * g_CDemonRendererPtr
    PUSH EDX                            ; 0056d046 | CDemonRenderer g_CDemonRendererInstance
    CALL engine_drender.cpp_CDemonRenderer_enableFaceCapture_FUN_0048caa0 ; 0056d047 | void engine_drender.cpp_CDemonRenderer_enableFaceCapture_FUN_0048caa0(CDemonRenderer * this_ptr, int enabled)
        ;   XREF to: 0048caa0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0056d04c
    PUSH EDI                            ; 0056d04f
    INC ESI                             ; 0056d050
    CALL core_set.cpp_FUN_00570af0      ; 0056d051 | undefined core_set.cpp_FUN_00570af0()
        ;   XREF to: 00570af0 (UNCONDITIONAL_CALL)
    MOV ECX,dword ptr [EDI + 0x15acb4]  ; 0056d056
    ADD ESP,0x4                         ; 0056d05c
    CMP ESI,ECX                         ; 0056d05f
    JL 0x0056d01a                       ; 0056d061 | LAB_0056d01a
    ...
    PUSH EDI                            ; 0056d072
    CALL core_set.cpp_CDemonSet_FUN_00570ca0 ; 0056d073 | void core_set.cpp_CDemonSet_FUN_00570ca0(CDemonSet * this_ptr)
        ;   XREF to: 00570ca0 (UNCONDITIONAL_CALL)
    ADD ESP,0x10                        ; 0056d078
    JMP 0x0056cf3d                      ; 0056d07b | LAB_0056cf3d
        ;   XREF to: 0056cf3d (UNCONDITIONAL_JUMP)
    AND byte ptr [EBX + 0x140],0xf7     ; 0056d080
        ;   Label: LAB_0056d080
    JMP 0x0056cffd                      ; 0056d087 | LAB_0056cffd
