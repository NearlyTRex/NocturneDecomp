...
section .text
    ...
    PUSH ESI                            ; 005693c1
    PUSH 0x32780a4                      ; 005693c2 | CKeyFramedModel g_CKeyFramedModelInstance
    CALL core_dmodel.cpp_CKeyFramedModel_free_FUN_00477690 ; 005693c7 | void core_dmodel.cpp_CKeyFramedModel_free_FUN_00477690(CKeyFramedModel * this_ptr)
    ...
    PUSH EBX                            ; 005693de
        ;   Label: LAB_005693de
    CALL core_setutil.cpp_C3DSCamera_free_FUN_00585360 ; 005693df | void core_setutil.cpp_C3DSCamera_free_FUN_00585360(C3DSCamera * this_ptr)
        ;   XREF to: 00585360 (UNCONDITIONAL_CALL)
    ADD EBX,0x1a4                       ; 005693e4
    ADD ESP,0x4                         ; 005693ea
    CMP EBX,ESI                         ; 005693ed
    JNZ 0x005693de                      ; 005693ef | LAB_005693de
        ;   XREF to: 005693de (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x006843f8]      ; 005693f1 | CTerrain g_CTerrainInstance | CTerrain * g_CTerrainPtr
    PUSH EDX                            ; 005693f7 | CTerrain g_CTerrainInstance
    CALL core_terrain.cpp_CTerrain_dtor_FUN_005e1f30 ; 005693f8 | CTerrain * core_terrain.cpp_CTerrain_dtor_FUN_005e1f30(CTerrain * this_ptr)
        ;   XREF to: 005e1f30 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005693fd
    MOV ECX,dword ptr [ESP + 0xc]       ; 00569400
    PUSH ECX                            ; 00569404
    CALL core_setdir.cpp_CDemonSet_freeThumbs_FUN_00575df0 ; 00569405 | void core_setdir.cpp_CDemonSet_freeThumbs_FUN_00575df0(CDemonSet * this_ptr)
