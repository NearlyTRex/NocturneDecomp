...
;
; XREF[2]:
;   core_msnedit.cpp_CDemonMission_editActorsInSet_FUN_005390f0 at 0053a357
;   core_set.cpp_CDemonSet_renderScene_FUN_0056c1a0 at 0056c462
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0056cd60
        ;   Label: core_set.cpp_CDemonSet_renderOpaqueActors_FUN_0056cd60
    PUSH ESI                            ; 0056cd61
    PUSH EDI                            ; 0056cd62
    PUSH EBP                            ; 0056cd63
    ...
    PUSH EAX                            ; 0056ce19
    PUSH EDI                            ; 0056ce1a
    CALL core_set.cpp_CDemonSet_setLightingParameters_FUN_0056d380 ; 0056ce1b
    ...
    PUSH EDI                            ; 0056cec3
    INC ESI                             ; 0056cec4
    CALL core_set.cpp_CDemonSet_restoreCameraAfterMirror_FUN_00570af0 ; 0056cec5
