...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_set.cpp_FUN_005714c0()
;
;
; *****************************************************************************
...
section .text
    ...
    JNZ 0x005714f2                      ; 005714ef | LAB_005714f2
        ;   XREF to: 005714f2 (CONDITIONAL_JUMP)
    RET                                 ; 005714f1
    PUSH EBX                            ; 005714f2
        ;   Label: LAB_005714f2
