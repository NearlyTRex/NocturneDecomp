...
LAB_0056a1fb:
  ...
  if (iVar1 == 0) {
    ...
    for (iVar1 = 0; iVar1 < this_ptr->mirror_glass_actor_count; iVar1 = iVar1 + 1) {
      core_mirror_cpp_CMirror_renderMirrorQuadDepth_FUN_00522800
                (&this_ptr->mirror_glass_actors[iVar1]->mirror);
      if (this_ptr->mirror_glass_actors[iVar1]->shattered != 0) {
        core_glass_cpp_CGlass_renderBrokenGlass_FUN_004e9ca0(this_ptr->mirror_glass_actors[iVar1]);
      }
  ...
  else if ((g_RenderMirrorsFlag != 0) && (0 < this_ptr->mirror_glass_actor_count)) {
    for (iVar1 = 0; iVar1 < this_ptr->mirror_glass_actor_count; iVar1 = iVar1 + 1) {
      core_mirror_cpp_CMirror_renderMirrorQuadDepth_FUN_00522800
                (&this_ptr->mirror_glass_actors[iVar1]->mirror);
      if (this_ptr->mirror_glass_actors[iVar1]->shattered != 0) {
