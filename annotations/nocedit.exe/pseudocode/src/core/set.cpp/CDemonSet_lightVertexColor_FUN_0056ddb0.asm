...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_set.cpp_CDemonSet_lightVertexColor_FUN_0056ddb0(CDemonSet * this_ptr, CVector3i * world_position, CVector3i * surface_normal, int vertex_index, int skip_lighting_calculation)
;
; Parameters:
...
section .text
    ...
    JZ 0x0056de9c                       ; 0056ddc7 | LAB_0056de9c
        ;   XREF to: 0056de9c (CONDITIONAL_JUMP)
    TEST EDI,EDI                        ; 0056ddcd
    JNZ 0x0056ddf4                      ; 0056ddcf | LAB_0056ddf4
        ;   XREF to: 0056ddf4 (CONDITIONAL_JUMP)
    MOV ESI,0x645e2b                    ; 0056ddd1 | = "..\\core\\set.cpp" | s_core_set_cpp_00645e2b = ..\core\set.cpp
    MOV EBP,0xba3                       ; 0056ddd6
    PUSH 0x645e3b                       ; 0056dddb | = "CDemonSet::lightVertexColor - Quick l..." | s_CDemonSet_lightVertexCol_00645e3b = CDemonSet::lightVertexColor - Quick light mode with no normal
    MOV dword ptr [0x02f0ca48],ESI      ; 0056dde0 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBP      ; 0056dde6 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0056ddec | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ...
    ADD ESI,0x688014                    ; 0056de57 | SRenderVertex[16] g_RenderVertexBuffer
    IMUL EDX                            ; 0056de5d
    SHRD EAX,EDX,0x10                   ; 0056de5f
    MOV dword ptr [ESI + 0x20],EAX      ; 0056de63 | g_RenderVertexBuffer[0].light
    MOV EDX,ECX                         ; 0056de66
    MOV EAX,dword ptr [EBX + 0x15ae8c]  ; 0056de68
    IMUL EDX                            ; 0056de6e
    SHRD EAX,EDX,0x10                   ; 0056de70
    MOV dword ptr [ESI + 0x24],EAX      ; 0056de74 | g_RenderVertexBuffer[0].color
    MOV EDX,ECX                         ; 0056de77
    MOV EAX,dword ptr [EBX + 0x15ae90]  ; 0056de79
    IMUL EDX                            ; 0056de7f
    SHRD EAX,EDX,0x10                   ; 0056de81
    MOV dword ptr [ESI + 0x28],EAX      ; 0056de85 | g_RenderVertexBuffer[0].fog
    MOV EAX,[0x02d051f4]                ; 0056de88 | float g_PerspectiveReciprocal
    MOV dword ptr [ESI + 0x2c],EAX      ; 0056de8d | g_RenderVertexBuffer[0].w_recip
    ...
    XOR ECX,ECX                         ; 0056de98
        ;   Label: LAB_0056de98
    JMP 0x0056de2c                      ; 0056de9a | LAB_0056de2c
        ;   XREF to: 0056de2c (UNCONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x48],0x0      ; 0056de9c
        ;   Label: LAB_0056de9c
    JZ 0x0056e03e                       ; 0056dea1 | LAB_0056e03e
        ;   XREF to: 0056e03e (CONDITIONAL_JUMP)
    MOV ECX,0xffff                      ; 0056dea7
    MOV dword ptr [ESP + 0x20],EDX      ; 0056deac
    CMP dword ptr [0x032c1940],0x0      ; 0056deb0 | int g_ColorCorrectionEnabled
        ;   Label: LAB_0056deb0
    JLE 0x0056e0dc                      ; 0056deb7 | LAB_0056e0dc
        ;   XREF to: 0056e0dc (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x032c1cc0]      ; 0056debd | int g_ColorCorrectionLightMultiplier
    ...
    MOV EDX,dword ptr [0x032c1cc4]      ; 0056dedd | int g_ColorCorrectionColorMultiplier
    ...
    MOV EDX,dword ptr [0x032c1cc8]      ; 0056defd | int g_ColorCorrectionFogMultiplier
    ...
    MOV EAX,0x688014                    ; 0056df2a | SRenderVertex[16] g_RenderVertexBuffer
    ...
    JZ 0x0056dfe4                       ; 0056df40 | LAB_0056dfe4
        ;   XREF to: 0056dfe4 (CONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x48]      ; 0056df46
    TEST EAX,EAX                        ; 0056df4a
    JNZ 0x0056dfe4                      ; 0056df4c | LAB_0056dfe4
        ;   XREF to: 0056dfe4 (CONDITIONAL_JUMP)
    PUSH EAX                            ; 0056df52
    MOV EDX,dword ptr [ESP + 0x40]      ; 0056df53
    PUSH EDX                            ; 0056df57
    PUSH EBX                            ; 0056df58
    CALL core_set.cpp_CDemonSet_calculateSpatialLighting_FUN_0056db80 ; 0056df59 | int core_set.cpp_CDemonSet_calculateSpatialLighting_FUN_0056db80(CDemonSet * this_ptr, CVector3i * world_position, CVector3i * surface_normal)
    ...
    JLE 0x0056dfe4                      ; 0056df69 | LAB_0056dfe4
        ;   XREF to: 0056dfe4 (CONDITIONAL_JUMP)
    ...
    JC 0x0056df86                       ; 0056df7f | LAB_0056df86
    ...
    JC 0x0056dfaf                       ; 0056dfa8 | LAB_0056dfaf
    ...
    JC 0x0056dfd6                       ; 0056dfcf | LAB_0056dfd6
    ...
    MOV EAX,dword ptr [EAX*0x4 + 0x327d77c] ; 0056e018 | DAT_032bd778 | g_IntensityToValueLookupTable
    MOV dword ptr [EDX + 0x20],EAX      ; 0056e01f | g_RenderVertexBuffer[0].light
    MOV EAX,dword ptr [EDI*0x4 + 0x327d77c] ; 0056e022 | DAT_032bd778 | g_IntensityToValueLookupTable
    MOV dword ptr [EDX + 0x24],EAX      ; 0056e029 | g_RenderVertexBuffer[0].color
    MOV EAX,dword ptr [EBP*0x4 + 0x327d77c] ; 0056e02c | DAT_032bd778 | g_IntensityToValueLookupTable
    MOV dword ptr [EDX + 0x28],EAX      ; 0056e033 | g_RenderVertexBuffer[0].fog
    ...
    PUSH ESI                            ; 0056e043
    PUSH EBX                            ; 0056e044
    CALL core_set.cpp_CDemonSet_calculateSpatialLighting_FUN_0056db80 ; 0056e045 | int core_set.cpp_CDemonSet_calculateSpatialLighting_FUN_0056db80(CDemonSet * this_ptr, CVector3i * world_position, CVector3i * surface_normal)
        ;   XREF to: 0056db80 (UNCONDITIONAL_CALL)
    ...
    JLE 0x0056deb0                      ; 0056e05b | LAB_0056deb0
        ;   XREF to: 0056deb0 (CONDITIONAL_JUMP)
    TEST EDI,EDI                        ; 0056e061
    JZ 0x0056deb0                       ; 0056e063 | LAB_0056deb0
        ;   XREF to: 0056deb0 (CONDITIONAL_JUMP)
    MOV ESI,EBP                         ; 0056e069
    CMP EBP,0x1000                      ; 0056e06b
    JLE 0x0056e078                      ; 0056e071 | LAB_0056e078
        ;   XREF to: 0056e078 (CONDITIONAL_JUMP)
    MOV ESI,0x1000                      ; 0056e073
    CMP dword ptr [0x02d052c4],0x0      ; 0056e078 | int g_CameraOriginX
        ;   Label: LAB_0056e078
    JL 0x0056e0b2                       ; 0056e07f | LAB_0056e0b2
    ...
    CMP dword ptr [0x02d052cc],0x0      ; 0056e08d | int g_CameraOriginZ
        ;   Label: LAB_0056e08d
    JL 0x0056e0c0                       ; 0056e094 | LAB_0056e0c0
    ...
    JGE 0x0056deb0                      ; 0056e0a5 | LAB_0056deb0
        ;   XREF to: 0056deb0 (CONDITIONAL_JUMP)
    XOR ECX,ECX                         ; 0056e0ab
    JMP 0x0056deb0                      ; 0056e0ad | LAB_0056deb0
    ...
    JMP 0x0056e08d                      ; 0056e0be | LAB_0056e08d
    ...
    JGE 0x0056deb0                      ; 0056e0cf | LAB_0056deb0
        ;   XREF to: 0056deb0 (CONDITIONAL_JUMP)
    XOR ECX,ECX                         ; 0056e0d5
    JMP 0x0056deb0                      ; 0056e0d7 | LAB_0056deb0
        ;   XREF to: 0056deb0 (UNCONDITIONAL_JUMP)
    ...
    JMP 0x0056df15                      ; 0056e10a | LAB_0056df15
