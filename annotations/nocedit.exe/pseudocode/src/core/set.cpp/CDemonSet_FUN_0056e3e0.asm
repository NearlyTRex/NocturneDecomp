...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_set.cpp_CDemonSet_FUN_0056e3e0(CDemonSet * this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV ESI,dword ptr [0x02d7a7b8]      ; 0056e3eb | undefined4 DAT_02d7a7b8
    ...
    MOV EAX,[0x03277d80]                ; 0056e41c | undefined4 DAT_03277d80
    FSTP float ptr [ESP + 0x20]         ; 0056e421
    TEST EAX,EAX                        ; 0056e425
    JLE 0x0056e44d                      ; 0056e427 | LAB_0056e44d
        ;   XREF to: 0056e44d (CONDITIONAL_JUMP)
    LEA EBX,[EAX*0x4 + 0x0]             ; 0056e429
    MOV EDX,dword ptr [ECX + 0x3277d84] ; 0056e430 | undefined4 DAT_03277d84 | DAT_03277d88
        ;   Label: LAB_0056e430
    TEST dword ptr [EDX + 0x11d4],0x7fffffff ; 0056e436
    JNZ 0x0056e50d                      ; 0056e440 | LAB_0056e50d
        ;   XREF to: 0056e50d (CONDITIONAL_JUMP)
    ADD ECX,0x4                         ; 0056e446
        ;   Label: LAB_0056e446
    CMP ECX,EBX                         ; 0056e449
    JL 0x0056e430                       ; 0056e44b | LAB_0056e430
        ;   XREF to: 0056e430 (CONDITIONAL_JUMP)
    CMP dword ptr [0x03277d80],0x0      ; 0056e44d | undefined4 DAT_03277d80
        ;   Label: LAB_0056e44d
    JNZ 0x0056e466                      ; 0056e454 | LAB_0056e466
    ...
    MOV EBX,0x688014                    ; 0056e472 | SRenderVertex[16] g_RenderVertexBuffer
    SHL EAX,0x4                         ; 0056e477
    FLD float ptr [ESP + 0x4]           ; 0056e47a
    ADD EBX,EAX                         ; 0056e47e
    FCOMP double ptr [0x00645e8b]       ; 0056e480 | double DOUBLE_00645e8b
    FNSTSW AX                           ; 0056e486
    SAHF                                ; 0056e488
    JBE 0x0056e493                      ; 0056e489 | LAB_0056e493
        ;   XREF to: 0056e493 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x4],0x437f0000 ; 0056e48b
    FLD float ptr [ESP]                 ; 0056e493
        ;   Label: LAB_0056e493
    FCOMP double ptr [0x00645e8b]       ; 0056e496 | double DOUBLE_00645e8b
    FNSTSW AX                           ; 0056e49c
    SAHF                                ; 0056e49e
    JBE 0x0056e4a8                      ; 0056e49f | LAB_0056e4a8
        ;   XREF to: 0056e4a8 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP],0x437f0000      ; 0056e4a1
    FLD float ptr [ESP + 0x8]           ; 0056e4a8
        ;   Label: LAB_0056e4a8
    FCOMP double ptr [0x00645e8b]       ; 0056e4ac | double DOUBLE_00645e8b
    FNSTSW AX                           ; 0056e4b2
    SAHF                                ; 0056e4b4
    JA 0x0056e5b5                       ; 0056e4b5 | LAB_0056e5b5
    ...
    FXCH ST2                            ; 0056e4c6
    CALL crt_math.c_round_FUN_005fe6b0  ; 0056e4c8 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x28]        ; 0056e4cd
    MOV EAX,dword ptr [ESP + 0x28]      ; 0056e4d1
    CALL crt_math.c_round_FUN_005fe6b0  ; 0056e4d5 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 0056e4e8 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    ...
    MOV dword ptr [0x02d7a7b8],ESI      ; 0056e501 | undefined4 DAT_02d7a7b8
    ...
    FNSTSW AX                           ; 0056e561
    SAHF                                ; 0056e563
    JA 0x0056e446                       ; 0056e564 | LAB_0056e446
