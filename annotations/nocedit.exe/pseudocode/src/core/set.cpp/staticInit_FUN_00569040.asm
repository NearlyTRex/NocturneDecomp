...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_set_cpp_staticInit_FUN_00569040(void)
;
;
; Referenced Globals:
...
section .text
    ...
    CALL crt_stdlib.c_atexit_FUN_005ff060 ; 00569052
    ...
    CALL crt_stdlib.c_atexit_FUN_005ff060 ; 0056906c
        ;   XREF to: 005ff060 (UNCONDITIONAL_CALL)  ; void crt_stdlib.c_atexit_FUN_005ff060(WatcomStaticDestructorNode * exit_node)
    ...
    CALL crt_stdlib.c_atexit_FUN_005ff060 ; 00569086
        ;   XREF to: 005ff060 (UNCONDITIONAL_CALL)  ; void crt_stdlib.c_atexit_FUN_005ff060(WatcomStaticDestructorNode * exit_node)
    ...
    CALL crt_stdlib.c_atexit_FUN_005ff060 ; 005690a0
        ;   XREF to: 005ff060 (UNCONDITIONAL_CALL)  ; void crt_stdlib.c_atexit_FUN_005ff060(WatcomStaticDestructorNode * exit_node)
    ADD ESP,0x4                         ; 005690a5
    PUSH 0x6598c0                       ; 005690a8 | g_CVectorTypeInfo
    PUSH 0xfa0                          ; 005690ad
    PUSH 0x32c1ccc                      ; 005690b2 | g_FaceNormalArray
    CALL crt_memory.c_constructObjectArray_DefaultCtor_FUN_005fe667 ; 005690b7
