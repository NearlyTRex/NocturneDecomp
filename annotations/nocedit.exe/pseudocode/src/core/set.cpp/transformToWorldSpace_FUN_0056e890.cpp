...

{
  ...
  lVar7 = (longlong)g_InverseMatrix.m[0].z * (longlong)input->x;
  lVar8 = (longlong)g_InverseMatrix.m[1].z * (longlong)input->y;
  lVar9 = (longlong)g_InverseMatrix.m[2].z * (longlong)input->z;
