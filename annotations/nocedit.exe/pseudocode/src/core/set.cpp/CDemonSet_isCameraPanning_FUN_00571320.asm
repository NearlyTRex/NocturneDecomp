...
;                               FUNCTION
; *****************************************************************************
; __cdecl int core_set.cpp_CDemonSet_isCameraPanning_FUN_00571320(CDemonSet * this_ptr)
;
; Parameters:
...
section .text
    ...
    JL 0x00571341                       ; 0057132c | LAB_00571341
    ...
    PUSH ESI                            ; 00571341
        ;   Label: LAB_00571341
    MOV ECX,0x646176                    ; 00571342 | = "..\\core\\set.cpp" | s_core_set_cpp_00646176 = ..\core\set.cpp
    MOV ESI,0x138b                      ; 00571347
    PUSH 0x646186                       ; 0057134c | = "CDemonSet::isCameraPanning - no camer..." | s_CDemonSet_isCameraPannin_00646186 = CDemonSet::isCameraPanning - no camera selected
    MOV dword ptr [0x02f0ca48],ECX      ; 00571351 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ESI      ; 00571357 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0057135d | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
