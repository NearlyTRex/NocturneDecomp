// Name: core_set.cpp_CDemonSet_FUN_0056db80
// Address: 0056db80
// Address Range: [[0056db80, 0056dda4]]
// Convention: __cdecl
// Signature: int core_set.cpp_CDemonSet_FUN_0056db80(CDemonSet * this_ptr)
// Cross-references:
...
int __cdecl core_set_cpp_CDemonSet_FUN_0056db80(CDemonSet *this_ptr)

{
  ...
  if (0 < DAT_032c1798) {
    iVar6 = 0;
    do {
      puVar1 = (undefined4 *)((int)&DAT_032c179c + iVar6);
      iVar6 = iVar6 + 4;
      iVar5 = iVar5 + 1;
      iVar2 = core_dcamera_cpp_CDemonCamera_calculateAttenuatedDirectionalLight_FUN_0044edf0
                        (&g_CDemonCameraInstance,(CVector3i *)in_stack_0000000c,
                         (CDemonLight *)*puVar1,(CVector3i *)in_stack_0000000c);
      iVar4 = iVar4 + iVar2;
    } while (iVar5 < DAT_032c1798);
  }
  iVar5 = 0;
  if (0 < DAT_032c1614) {
    iVar6 = 0;
    do {
      puVar1 = (undefined4 *)((int)&DAT_032c1618 + iVar6);
      iVar6 = iVar6 + 4;
      iVar5 = iVar5 + 1;
      iVar2 = core_dcamera_cpp_CDemonCamera_calculateAttenuatedDirectionalLight_FUN_0044edf0
                        (&g_CDemonCameraInstance,(CVector3i *)in_stack_0000000c,
                         (CDemonLight *)*puVar1,(CVector3i *)in_stack_0000000c);
      iVar4 = iVar4 + iVar2;
    } while (iVar5 < DAT_032c1614);
  }
  iVar5 = 0;
  if (0 < DAT_032c17ac) {
    iVar6 = 0;
    do {
      puVar1 = (undefined4 *)((int)&DAT_032c17b0 + iVar6);
      iVar6 = iVar6 + 4;
      iVar5 = iVar5 + 1;
      iVar2 = core_dglobe_cpp_CDemonGlobe_getAttenuationAtVertex_FUN_00471850
                        ((CDemonGlobe *)*puVar1,(CVector3i *)in_stack_0000000c,
                         (CVector3i *)in_stack_0000000c);
      iVar4 = iVar4 + iVar2;
    } while (iVar5 < DAT_032c17ac);
  }
  local_14 = 0;
  iVar5 = in_stack_00000008;
  if (0 < *(int *)(in_stack_00000008 + 0x15acb4)) {
    do {
      core_mirror_cpp_transformMirrorVertex_FUN_005229b0
                ((SMirrorReflection *)(*(int *)(iVar5 + 0x15acb8) + 0x1ec),
                 (CVector3f *)in_stack_0000000c,(CVector3f *)in_stack_ffffffbc);
      in_stack_ffffffbc = (CDemonLight *)local_3c.z;
      local_30[(uint)bVar7 * -2 + -4] = local_30[(uint)bVar7 * -2];
      *(int *)((int)&local_3c + (uint)bVar7 * -8 + (uint)bVar7 * -8) =
           local_30[(uint)bVar7 * -2 + (uint)bVar7 * -2 + 1];
      if (in_stack_0000000c != (CDemonLight *)0x0) {
        in_stack_ffffffbc = in_stack_0000000c;
        core_mirror_cpp_transformMirrorEdgeToIntegerSpace_FUN_00522a50
                  ((CVector3i *)(*(int *)(unaff_EDI + 0x15acb8) + 0x1ec),in_stack_00000010,
                   (CVector3i *)in_stack_0000000c,in_stack_ffffffc0);
        uStack_1c = local_30[3];
        local_30[(uint)bVar7 * -2 + 6] = local_30[(uint)bVar7 * -2 + 4];
        local_30[(uint)bVar7 * -2 + (uint)bVar7 * -2 + 7] =
      ...
      if (0 < g_DynamicLightCount) {
        ...
        do {
          if (in_stack_0000000c == (CDemonLight *)0x0) {
            in_stack_ffffffbc = *(CDemonLight **)((int)g_DynamicLights + iVar2);
          ...
          iVar3 = core_dcamera_cpp_CDemonCamera_calculateAttenuatedDirectionalLight_FUN_0044edf0
      ...
      local_14 = local_14 + 1;
      iVar5 = iVar5 + 4;
    } while (local_14 < *(int *)(in_stack_00000008 + 0x15acb4));
  }
  return iVar4;
}
...
// Assembly code:
// 0056db80: PUSH EBX
//   Label: core_set.cpp_CDemonSet_FUN_0056db80
// 0056db81: PUSH ESI
// 0056db82: PUSH EDI
// 0056db83: PUSH EBP
