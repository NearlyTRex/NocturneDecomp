...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_set.cpp_CDemonSet_FUN_00570fc0(CDemonSet * this_ptr)
;
; Parameters:
...
section .text
    ...
    JLE 0x005710ca                      ; 00571004 | LAB_005710ca
    ...
    JNZ 0x00571024                      ; 00571019 | LAB_00571024
        ;   XREF to: 00571024 (CONDITIONAL_JUMP)
    CMP dword ptr [ESI + 0xf8],0x0      ; 0057101b
    JZ 0x00571037                       ; 00571022 | LAB_00571037
    ...
    PUSH EAX                            ; 0057103c
    PUSH ESI                            ; 0057103d
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 0057103e | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
    ...
    JZ 0x005710cf                       ; 00571062 | LAB_005710cf
    ...
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 00571078 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ...
    JZ 0x005710b8                       ; 0057109c | LAB_005710b8
    ...
    JL 0x0057100c                       ; 005710c4 | LAB_0057100c
    ...
    PUSH ECX                            ; 005710d5
    PUSH ESI                            ; 005710d6
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 005710d7 | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ...
    JZ 0x00571106                       ; 005710fb | LAB_00571106
    ...
    PUSH EAX                            ; 0057110b
    PUSH ESI                            ; 0057110c
    CALL core_actor.cpp_castToClassHash_FUN_0040c790 ; 0057110d | CDemonActor * core_actor.cpp_castToClassHash_FUN_0040c790(CDemonActor * actor_ptr, uint class_name_hash)
        ;   XREF to: 0040c790 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 00571112
    TEST EAX,EAX                        ; 00571115
    JZ 0x005710b8                       ; 00571117 | LAB_005710b8
        ;   XREF to: 005710b8 (CONDITIONAL_JUMP)
    CMP dword ptr [EAX + 0x174],0x4     ; 00571119
    JNZ 0x005710b8                      ; 00571120 | LAB_005710b8
        ;   XREF to: 005710b8 (CONDITIONAL_JUMP)
    CMP dword ptr [EAX + 0x300],0x0     ; 00571122
    JZ 0x005710b8                       ; 00571129 | LAB_005710b8
        ;   XREF to: 005710b8 (CONDITIONAL_JUMP)
    JMP 0x005710a5                      ; 0057112b | LAB_005710a5
