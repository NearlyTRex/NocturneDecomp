...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_set.cpp_CDemonSet_precomputeLightVisibility_FUN_0056a470(CDemonSet * this_ptr)
;
; Parameters:
...
section .text
    ...
    MOV ECX,dword ptr [0x03276dac]      ; 0056a47c | int g_MasterLightCount
    MOV dword ptr [ESP + 0x128],EDX     ; 0056a482
    TEST ECX,ECX                        ; 0056a489
    JZ 0x0056a72f                       ; 0056a48b | LAB_0056a72f
        ;   XREF to: 0056a72f (CONDITIONAL_JUMP)
    XOR EDI,EDI                         ; 0056a491
        ;   Label: LAB_0056a491
    MOV EAX,dword ptr [ESP + 0x178]     ; 0056a493
    MOV dword ptr [0x032776b4],EDI      ; 0056a49a | int g_DynamicLightCount
    MOV dword ptr [0x03277d80],EDI      ; 0056a4a0 | undefined4 DAT_03277d80
    MOV dword ptr [ESP + 0x154],EDI     ; 0056a4a6
    MOV ECX,dword ptr [EAX]             ; 0056a4ad
    MOV dword ptr [0x03276f30],EDI      ; 0056a4af | int g_ActiveLightCount
    TEST ECX,ECX                        ; 0056a4b5
    JLE 0x0056a70e                      ; 0056a4b7 | LAB_0056a70e
    ...
    JZ 0x0056a750                       ; 0056a51f | LAB_0056a750
    ...
    JZ 0x0056a562                       ; 0056a550 | LAB_0056a562
    ...
    JGE 0x0056a69e                      ; 0056a572 | LAB_0056a69e
    ...
    JNZ 0x0056a94c                      ; 0056a5e7 | LAB_0056a94c
        ;   XREF to: 0056a94c (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x03276dac]      ; 0056a5ed | int g_MasterLightCount
    XOR EBX,EBX                         ; 0056a5f3
    TEST EDX,EDX                        ; 0056a5f5
    JLE 0x0056a620                      ; 0056a5f7 | LAB_0056a620
        ;   XREF to: 0056a620 (CONDITIONAL_JUMP)
    ADD ESI,dword ptr [ESP + 0x140]     ; 0056a5f9
    LEA EDI,[ESI + 0x4]                 ; 0056a600
    XOR ESI,ESI                         ; 0056a603
    MOV EAX,dword ptr [ESI + 0x3276db0] ; 0056a605 | CDemonLight *[96] g_MasterLightList
        ;   Label: LAB_0056a605
    PUSH EDI                            ; 0056a60b
    ADD EAX,0x40                        ; 0056a60c
    PUSH EAX                            ; 0056a60f
    CALL crt_string.c_strcmp_FUN_005fef20 ; 0056a610 | int crt_string.c_strcmp_FUN_005fef20(char * str1, char * str2)
        ;   XREF to: 005fef20 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0056a615
    TEST EAX,EAX                        ; 0056a618
    JNZ 0x0056a875                      ; 0056a61a | LAB_0056a875
        ;   XREF to: 0056a875 (CONDITIONAL_JUMP)
    CMP EBX,dword ptr [0x03276dac]      ; 0056a620 | int g_MasterLightCount
        ;   Label: LAB_0056a620
    JNZ 0x0056a64b                      ; 0056a626 | LAB_0056a64b
        ;   XREF to: 0056a64b (CONDITIONAL_JUMP)
    MOV EDX,0x645afe                    ; 0056a628 | = "..\\core\\set.cpp" | s_core_set_cpp_00645afe = ..\core\set.cpp
    MOV ECX,0x2fc                       ; 0056a62d
    PUSH 0x645b0e                       ; 0056a632 | = "CDemonSet::precomuputeLightVisibility..." | s_CDemonSet_precomuputeLig_00645b0e = CDemonSet::precomuputeLightVisibility - Unable to find light in master list
    MOV dword ptr [0x02f0ca48],EDX      ; 0056a637 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],ECX      ; 0056a63d | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 0056a643 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0056a648
    MOV EAX,dword ptr [ESP + 0x14c]     ; 0056a64b
        ;   Label: LAB_0056a64b
    MOV ESI,dword ptr [EAX + 0x144]     ; 0056a652
    MOV EBX,dword ptr [EBX*0x4 + 0x3276db0] ; 0056a658 | CDemonLight *[96] g_MasterLightList
    TEST ESI,ESI                        ; 0056a65f
    JZ 0x0056a88c                       ; 0056a661 | LAB_0056a88c
    ...
    JL 0x0056a5cc                       ; 0056a698 | LAB_0056a5cc
        ;   XREF to: 0056a5cc (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [ESP + 0x154]     ; 0056a69e
        ;   Label: LAB_0056a69e
    PUSH EBX                            ; 0056a6a5
    PUSH 0x645b76                       ; 0056a6a6 | = "Precomputing lights from camera : %d" | s_Precomputing_lights_from_00645b76 = Precomputing lights from camera : %d
    LEA EAX,[ESP + 0x8]                 ; 0056a6ab
    PUSH EAX                            ; 0056a6af
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0056a6b0 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
    ...
    PUSH EAX                            ; 0056a6c0
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 0056a6c1 | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0056a6c6
    LEA EBP,[EBX + 0x1]                 ; 0056a6c9
    CALL wincore_wddvmem.cpp_swapBuffers_FUN_005eda20 ; 0056a6cc | void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20()
    ...
    JL 0x0056a505                       ; 0056a708 | LAB_0056a505
        ;   XREF to: 0056a505 (CONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x128],0x0     ; 0056a70e
        ;   Label: LAB_0056a70e
    JNZ 0x0056a9de                      ; 0056a716 | LAB_0056a9de
        ;   XREF to: 0056a9de (CONDITIONAL_JUMP)
    XOR EBP,EBP                         ; 0056a71c
    MOV dword ptr [0x03277d14],EBP      ; 0056a71e | CDemonRaytrace g_CDemonRaytraceInstance
    ...
    CALL core_set.cpp_CDemonSet_initScene_FUN_0056aa10 ; 0056a73c | void core_set.cpp_CDemonSet_initScene_FUN_0056aa10(CDemonSet * this_ptr)
        ;   XREF to: 0056aa10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0056a741
    MOV dword ptr [ESP + 0x128],ESI     ; 0056a744
    JMP 0x0056a491                      ; 0056a74b | LAB_0056a491
        ;   XREF to: 0056a491 (UNCONDITIONAL_JUMP)
    MOV EAX,dword ptr [ESP + 0x130]     ; 0056a750
        ;   Label: LAB_0056a750
    PUSH 0x32758e4                      ; 0056a757 | CDemonCamera g_CDemonCameraInstance
    ADD EBX,EAX                         ; 0056a75c
    PUSH EBX                            ; 0056a75e
    CALL core_setutil.cpp_C3DSCamera_apply_FUN_00585870 ; 0056a75f | void core_setutil.cpp_C3DSCamera_apply_FUN_00585870(C3DSCamera * this_ptr, CDemonCamera * camera)
        ;   XREF to: 00585870 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0056a764
    PUSH EBP                            ; 0056a767
    PUSH 0x32758e4                      ; 0056a768 | CDemonCamera g_CDemonCameraInstance
    CALL core_dcamera.cpp_CDemonCamera_beginScene_FUN_0044c430 ; 0056a76d | void core_dcamera.cpp_CDemonCamera_beginScene_FUN_0044c430(CDemonCamera * this_ptr, int skip_clear_buffers)
    ...
    PUSH ECX                            ; 0056a787
    MOV dword ptr [0x03277d14],EDX      ; 0056a788 | CDemonRaytrace g_CDemonRaytraceInstance
    CALL core_set.cpp_CDemonSet_renderSceneGeometry_FUN_0056a190 ; 0056a78e | void core_set.cpp_CDemonSet_renderSceneGeometry_FUN_0056a190(CDemonSet * this_ptr, float frustum_param, int render_mode)
        ;   XREF to: 0056a190 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0056a793
    PUSH EBP                            ; 0056a796
    PUSH 0x32758e4                      ; 0056a797 | CDemonCamera g_CDemonCameraInstance
    CALL core_dcamera.cpp_CDemonCamera_endScene_FUN_0044cb80 ; 0056a79c | void core_dcamera.cpp_CDemonCamera_endScene_FUN_0044cb80(CDemonCamera * this_ptr, int skip_zbuffer_copy)
        ;   XREF to: 0044cb80 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0056a7a1
    PUSH 0x32758e4                      ; 0056a7a4 | CDemonCamera g_CDemonCameraInstance
    CALL core_dcamera.cpp_CDemonCamera_precomputeNormals_FUN_0044e360 ; 0056a7a9 | CDemonCamera * core_dcamera.cpp_CDemonCamera_precomputeNormals_FUN_0044e360(CDemonCamera * this_ptr)
        ;   XREF to: 0044e360 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0056a7ae
    LEA EAX,[ESP + 0x100]               ; 0056a7b1
    PUSH EAX                            ; 0056a7b8
    ADD EBX,0x17c                       ; 0056a7b9
    PUSH 0x32758e4                      ; 0056a7bf | CDemonCamera g_CDemonCameraInstance
    MOV EDI,EBX                         ; 0056a7c4
    CALL core_dcamera.cpp_CDemonCamera_computeVisibleFrustumBounds_FUN_00454060 ; 0056a7c6 | CVector3f * core_dcamera.cpp_CDemonCamera_computeVisibleFrustumBounds_FUN_00454060(CDemonCamera * this_ptr, CVector3f * output_vectors, CBoundingBox3D * bounding_box)
        ;   XREF to: 00454060 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0056a7cb
    MOV ESI,EAX                         ; 0056a7ce
    CMP EBX,EAX                         ; 0056a7d0
    JZ 0x0056a7e4                       ; 0056a7d2 | LAB_0056a7e4
    ...
    JZ 0x0056a7fe                       ; 0056a7ec | LAB_0056a7fe
    ...
    PUSH 0x645ac5                       ; 0056a84d | = "Camera box (%7.2f, %7.2f, %7.2f) - (%..." | s_Camera_box_7_2f_7_2f_7_2_00645ac5 = Camera box (%7.2f, %7.2f, %7.2f) - (%7.2f, %7.2f, %7.2f)
    LEA EAX,[ESP + 0x34]                ; 0056a852
    PUSH EAX                            ; 0056a856
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0056a857 | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ...
    PUSH EAX                            ; 0056a867
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 0056a868 | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0056a86d
    JMP 0x0056a525                      ; 0056a870 | LAB_0056a525
        ;   XREF to: 0056a525 (UNCONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x03276dac]      ; 0056a875 | int g_MasterLightCount
        ;   Label: LAB_0056a875
    INC EBX                             ; 0056a87b
    ADD ESI,0x4                         ; 0056a87c
    CMP EBX,ECX                         ; 0056a87f
    JL 0x0056a605                       ; 0056a881 | LAB_0056a605
        ;   XREF to: 0056a605 (CONDITIONAL_JUMP)
    JMP 0x0056a620                      ; 0056a887 | LAB_0056a620
        ;   XREF to: 0056a620 (UNCONDITIONAL_JUMP)
    PUSH ESI                            ; 0056a88c
        ;   Label: LAB_0056a88c
    PUSH EBX                            ; 0056a88d
    PUSH 0x32758e4                      ; 0056a88e | CDemonCamera g_CDemonCameraInstance
    CALL core_dcamera.cpp_CDemonCamera_precomputeLight_FUN_0044de10 ; 0056a893 | void * core_dcamera.cpp_CDemonCamera_precomputeLight_FUN_0044de10(CDemonCamera * this_ptr, CDemonLight * light_source, CRect * rect)
        ;   XREF to: 0044de10 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0056a898
    PUSH EBX                            ; 0056a89b
    PUSH 0x32758e4                      ; 0056a89c | CDemonCamera g_CDemonCameraInstance
    CALL core_dcamera.cpp_CDemonCamera_isCoronaSufficientlyVisible_FUN_00450fc0 ; 0056a8a1 | int core_dcamera.cpp_CDemonCamera_isCoronaSufficientlyVisible_FUN_00450fc0(CDemonCamera * this_ptr, CDemonLight * light_source)
        ;   XREF to: 00450fc0 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0056a8a6
    PUSH EBX                            ; 0056a8a9
    MOV ESI,dword ptr [ESP + 0x160]     ; 0056a8aa
    PUSH 0x32758e4                      ; 0056a8b1 | CDemonCamera g_CDemonCameraInstance
    MOV byte ptr [ESI + 0x19b58],AL     ; 0056a8b6
    LEA ESI,[ESP + 0x120]               ; 0056a8bc
    CALL core_dcamera.cpp_CDemonCamera_computeLightExtentBounds_FUN_00451090 ; 0056a8c3 | void core_dcamera.cpp_CDemonCamera_computeLightExtentBounds_FUN_00451090(CDemonCamera * this_ptr, CDemonLight * light, CRect * out_bounds)
    ...
    JZ 0x0056a667                       ; 0056a8ea | LAB_0056a667
    ...
    PUSH EBX                            ; 0056a913
    PUSH 0x645b5a                       ; 0056a914 | = "Light %d, Box : %d,%d,%d,%d" | s_Light_d_Box_d_d_d_d_00645b5a = Light %d, Box : %d,%d,%d,%d
    LEA EAX,[ESP + 0x18]                ; 0056a919
    PUSH EAX                            ; 0056a91d
    CALL crt_stdio.c_sprintf_FUN_005fdbd0 ; 0056a91e | int crt_stdio.c_sprintf_FUN_005fdbd0(char * buffer, char * format)
        ;   XREF to: 005fdbd0 (UNCONDITIONAL_CALL)
    ...
    CALL engine_2d.c_drawText_FUN_00401fd0 ; 0056a938 | void engine_2d.c_drawText_FUN_00401fd0(char * text, int x_pos, int y_pos)
        ;   XREF to: 00401fd0 (UNCONDITIONAL_CALL)
    ADD ESP,0xc                         ; 0056a93d
    MOV dword ptr [ESP + 0x158],EDI     ; 0056a940
    JMP 0x0056a667                      ; 0056a947 | LAB_0056a667
    ...
    JZ 0x0056a972                       ; 0056a964 | LAB_0056a972
        ;   XREF to: 0056a972 (CONDITIONAL_JUMP)
    MOV byte ptr [EDI + 0x19b58],0x0    ; 0056a966
    JMP 0x0056a667                      ; 0056a96d | LAB_0056a667
        ;   XREF to: 0056a667 (UNCONDITIONAL_JUMP)
    PUSH 0x1                            ; 0056a972
        ;   Label: LAB_0056a972
    PUSH 0x32758e4                      ; 0056a974 | CDemonCamera g_CDemonCameraInstance
    CALL core_dcamera.cpp_CDemonCamera_beginScene_FUN_0044c430 ; 0056a979 | void core_dcamera.cpp_CDemonCamera_beginScene_FUN_0044c430(CDemonCamera * this_ptr, int skip_clear_buffers)
        ;   XREF to: 0044c430 (UNCONDITIONAL_CALL)
    ADD ESP,0x8                         ; 0056a97e
    ADD ESI,dword ptr [ESP + 0x13c]     ; 0056a981
    PUSH ESI                            ; 0056a988
    CALL core_setutil.cpp_C3DSLight_isVisible_FUN_00587df0 ; 0056a989 | int core_setutil.cpp_C3DSLight_isVisible_FUN_00587df0(C3DSLight * this_ptr)
        ;   XREF to: 00587df0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0056a98e
    PUSH 0x0                            ; 0056a991
    PUSH 0x32758e4                      ; 0056a993 | CDemonCamera g_CDemonCameraInstance
    MOV byte ptr [EDI + 0x19b58],AL     ; 0056a998
    CALL core_dcamera.cpp_CDemonCamera_endScene_FUN_0044cb80 ; 0056a99e | void core_dcamera.cpp_CDemonCamera_endScene_FUN_0044cb80(CDemonCamera * this_ptr, int skip_zbuffer_copy)
        ;   XREF to: 0044cb80 (UNCONDITIONAL_CALL)
    ...
    JMP 0x0056a667                      ; 0056a9d9 | LAB_0056a667
        ;   XREF to: 0056a667 (UNCONDITIONAL_JUMP)
    MOV EBX,dword ptr [ESP + 0x178]     ; 0056a9de
        ;   Label: LAB_0056a9de
    PUSH EBX                            ; 0056a9e5
    CALL core_set.cpp_CDemonSet_FUN_0056d2d0 ; 0056a9e6 | void core_set.cpp_CDemonSet_FUN_0056d2d0(CDemonSet * this_ptr)
        ;   XREF to: 0056d2d0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 0056a9eb
    XOR EBP,EBP                         ; 0056a9ee
    MOV dword ptr [0x03277d14],EBP      ; 0056a9f0 | CDemonRaytrace g_CDemonRaytraceInstance
