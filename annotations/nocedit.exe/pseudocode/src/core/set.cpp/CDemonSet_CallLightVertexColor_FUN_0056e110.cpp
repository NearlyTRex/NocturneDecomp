// Name: core_set.cpp_CDemonSet_CallLightVertexColor_FUN_0056e110
// Address: 0056e110
...
int __cdecl core_set_cpp_CDemonSet_CallLightVertexColor_FUN_0056e110(CDemonSet *this_ptr)

{
  ...
  iVar1 = in_stack_00000014 * 0x30 + 0x688044;
  for (iVar2 = in_stack_00000014 + -1; 0 < iVar2; iVar2 = iVar2 + -1) {
    *(float *)(iVar1 + 0x20) = g_RenderVertexBuffer[in_stack_00000014].light;
    *(int *)(iVar1 + 0x24) = g_RenderVertexBuffer[in_stack_00000014].color;
    *(float *)(iVar1 + 0x28) = g_RenderVertexBuffer[in_stack_00000014].fog;
    iVar1 = iVar1 + 0x30;
  }
  return iVar1;
}
...
// Assembly code:
// 0056e110: PUSH EBX
//   Label: core_set.cpp_CDemonSet_CallLightVertexColor_FUN_0056e110
// 0056e111: PUSH ESI
// 0056e112: PUSH EDI
