...
section .text
    ...
    PUSH 0x6628d0                       ; 00571550 | WatcomTypeInfo g_C3DSLightTypeInfo
        ;   Label: core_set.cpp_free3DSLights_FUN_00571550
    PUSH 0xc8                           ; 00571555
    MOV EDX,dword ptr [ESP + 0xc]       ; 0057155a
    PUSH EDX                            ; 0057155e
    CALL crt_memory.c_freeTypeArray_FUN_005feee9 ; 0057155f | int crt_memory.c_freeTypeArray_FUN_005feee9(void * * obj_array, int obj_count, WatcomTypeInfo * type_info)
