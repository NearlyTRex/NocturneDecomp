...
;                               FUNCTION
; *****************************************************************************
; __cdecl void core_set.cpp_CDemonSet_FUN_0056e5d0(CDemonSet * this_ptr)
;
; Parameters:
...
section .text
    ...
    CMP dword ptr [0x00902f70],0x0      ; 0056e5d4 | CDemonCamera * g_SkipClearBuffersSceneCamera
    JZ 0x0056e775                       ; 0056e5db | LAB_0056e775
        ;   XREF to: 0056e775 (CONDITIONAL_JUMP)
    PUSH EDI                            ; 0056e5e1
    PUSH ESI                            ; 0056e5e2
    PUSH EBX                            ; 0056e5e3
    MOV EBX,dword ptr [ESP + 0x34]      ; 0056e5e4
    MOV EAX,[0x006703ec]                ; 0056e5e8 | CDemonRenderer * g_CDemonRendererPtr
    MOV EDI,dword ptr [0x02d02550]      ; 0056e5ed | int g_ViewportRightFixed
    MOV ECX,dword ptr [0x02d02548]      ; 0056e5f3 | int g_ViewportCenterXFixed
    MOV ESI,dword ptr [EAX]             ; 0056e5f9 | CDemonRenderer g_CDemonRendererInstance
    MOV EAX,[0x02d02550]                ; 0056e5fb | int g_ViewportRightFixed
    MOV EBP,dword ptr [0x02d02554]      ; 0056e600 | int g_ViewportBottomFixed
    SUB EAX,ECX                         ; 0056e606
    MOV EDX,dword ptr [0x02d0254c]      ; 0056e608 | int g_ViewportCenterYFixed
    MOV dword ptr [ESP + 0x20],EAX      ; 0056e60e
    MOV EAX,[0x02d0254c]                ; 0056e612 | int g_ViewportCenterYFixed
    ADD EDI,ECX                         ; 0056e617
    SUB EBP,EAX                         ; 0056e619
    MOV EAX,[0x02d02554]                ; 0056e61b | int g_ViewportBottomFixed
    ...
    JGE 0x0056e6b8                      ; 0056e686 | LAB_0056e6b8
        ;   XREF to: 0056e6b8 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [ECX + 0x8]       ; 0056e688
    CMP EBX,EDX                         ; 0056e68b
    JGE 0x0056e6b8                      ; 0056e68d | LAB_0056e6b8
        ;   XREF to: 0056e6b8 (CONDITIONAL_JUMP)
    MOV EBX,EDX                         ; 0056e68f
    MOV EAX,dword ptr [ECX + 0x4]       ; 0056e691
    MOV EDX,dword ptr [0x02d0254c]      ; 0056e694 | int g_ViewportCenterYFixed
    IMUL EDX                            ; 0056e69a
    IDIV EBX                            ; 0056e69c
    MOV EBX,dword ptr [0x02d02554]      ; 0056e69e | int g_ViewportBottomFixed
    MOV EDX,dword ptr [ESP + 0x24]      ; 0056e6a4
    ADD EAX,EBX                         ; 0056e6a8
    CMP EAX,EDX                         ; 0056e6aa
    JLE 0x0056e6b2                      ; 0056e6ac | LAB_0056e6b2
        ;   XREF to: 0056e6b2 (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x24],EAX      ; 0056e6ae
    CMP EAX,EBP                         ; 0056e6b2
        ;   Label: LAB_0056e6b2
    JGE 0x0056e6b8                      ; 0056e6b4 | LAB_0056e6b8
        ;   XREF to: 0056e6b8 (CONDITIONAL_JUMP)
    MOV EBP,EAX                         ; 0056e6b6
    MOV EBX,dword ptr [ECX + 0x8]       ; 0056e6b8
        ;   Label: LAB_0056e6b8
    CMP EBX,dword ptr [ECX]             ; 0056e6bb
    JG 0x0056e6d0                       ; 0056e6bd | LAB_0056e6d0
        ;   XREF to: 0056e6d0 (CONDITIONAL_JUMP)
    MOV EDX,dword ptr [0x02d02550]      ; 0056e6bf | int g_ViewportRightFixed
    MOV EAX,[0x02d02548]                ; 0056e6c5 | int g_ViewportCenterXFixed
    ...
    JL 0x0056e6e8                       ; 0056e6d9 | LAB_0056e6e8
        ;   XREF to: 0056e6e8 (CONDITIONAL_JUMP)
    MOV EAX,[0x02d02548]                ; 0056e6db | int g_ViewportCenterXFixed
    MOV EDI,dword ptr [0x02d02550]      ; 0056e6e0 | int g_ViewportRightFixed
    SUB EDI,EAX                         ; 0056e6e6
    MOV EDX,dword ptr [ECX + 0x8]       ; 0056e6e8
        ;   Label: LAB_0056e6e8
    CMP EDX,dword ptr [ECX + 0x4]       ; 0056e6eb
    JG 0x0056e6fe                       ; 0056e6ee | LAB_0056e6fe
        ;   XREF to: 0056e6fe (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [0x02d02554]      ; 0056e6f0 | int g_ViewportBottomFixed
    MOV EBP,dword ptr [0x02d0254c]      ; 0056e6f6 | int g_ViewportCenterYFixed
    ...
    JL 0x0056e71b                       ; 0056e708 | LAB_0056e71b
        ;   XREF to: 0056e71b (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x02d0254c]      ; 0056e70a | int g_ViewportCenterYFixed
    MOV EAX,[0x02d02554]                ; 0056e710 | int g_ViewportBottomFixed
    ...
    JL 0x0056e634                       ; 0056e72d | LAB_0056e634
        ;   XREF to: 0056e634 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [ESP + 0x20]      ; 0056e733
        ;   Label: LAB_0056e733
    MOV EBX,dword ptr [ESP + 0x24]      ; 0056e737
    MOV EDX,dword ptr [0x00902f70]      ; 0056e73b | CDemonCamera * g_SkipClearBuffersSceneCamera
    ...
    CALL core_dcamera.cpp_CDemonCamera_pushRect_FUN_0044c740 ; 0056e76a | void core_dcamera.cpp_CDemonCamera_pushRect_FUN_0044c740(CDemonCamera * this_ptr, int left, int top, int right, ...)
    ...
    JLE 0x0056e783                      ; 0056e77f | LAB_0056e783
    ...
    JGE 0x0056e792                      ; 0056e78c | LAB_0056e792
    ...
    JLE 0x0056e79b                      ; 0056e797 | LAB_0056e79b
    ...
    JGE 0x0056e71b                      ; 0056e7a4 | LAB_0056e71b
        ;   XREF to: 0056e71b (CONDITIONAL_JUMP)
    MOV dword ptr [ESP + 0x24],EDX      ; 0056e7aa
    JMP 0x0056e71b                      ; 0056e7ae | LAB_0056e71b
