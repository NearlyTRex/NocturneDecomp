...

{
  ...
  if (0 < this_ptr->camera_count) {
    ...
    do {
      iVar10 = iVar10 + 1;
      core_setutil_cpp_C3DSCamera_load_FUN_00585420(pCVar6,p_Var4);
      pCVar6 = pCVar6 + 1;
  ...
  if (iVar10 == 0) {
    ...
    p_Var4 = engine_dosio_c_getFile_FUN_00481a50("data",pcVar3,"rb");
    if (p_Var4 == (_FILE *)0x0) {
      ...
      shape_memdbg_cpp_closeFile_FUN_0050f9b0(p_Var4,"..\\core\\set.cpp",0x1f1);
