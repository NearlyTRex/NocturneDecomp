...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_crate.cpp_FUN_00448a70()
;
;
; XREF[4]:
;   core_actor.cpp_CDemonActor_processMeleeHit_FUN_0040a210 at 0040abaa
;   core_gun.cpp_FUN_004f0350 at 004f0abe
;   core_tommygun.cpp_FUN_005ddb30 at 005de2d7
;   core_turret.cpp_FUN_005e3750 at 005e3c2a
;
; Referenced Globals:
...
section .text
    ...
    JZ 0x00448a83                       ; 00448a7c | LAB_00448a83
    ...
    PUSH EBX                            ; 00448a83
        ;   Label: LAB_00448a83
    PUSH 0x619b2e                       ; 00448a84 | = "%s exploding!\n" | s_s_exploding_00619b2e = %s exploding!

    MOV ECX,dword ptr [0x0066e8e0]      ; 00448a89 | CConsole g_ConsolePtr | CConsole * g_CConsolePtr
    PUSH ECX                            ; 00448a8f | CConsole g_ConsolePtr
    CALL engine_console.cpp_CConsole_printf_FUN_00441890 ; 00448a90 | void engine_console.cpp_CConsole_printf_FUN_00441890(CConsole * this_ptr, char * format)
    ...
    JZ 0x00448ac7                       ; 00448ab1 | LAB_00448ac7
    ...
    MOV ESI,dword ptr [0x0067a3d0]      ; 00448adb | CFireEffect * g_CFireEffectPtr
    PUSH 0x42000000                     ; 00448ae1
    FSUB float ptr [ESP + 0x18]         ; 00448ae6
    PUSH EAX                            ; 00448aea
    FADD float ptr [ESP + 0x34]         ; 00448aeb
    PUSH ESI                            ; 00448aef | CFireEffect g_CFireEffectInstance
    FSTP float ptr [ESP + 0x38]         ; 00448af0
    CALL core_fire.cpp_CFireEffect_FUN_004c8c10 ; 00448af4 | void core_fire.cpp_CFireEffect_FUN_004c8c10(CFireEffect * this_ptr)
        ;   XREF to: 004c8c10 (UNCONDITIONAL_CALL)
    ADD ESP,0x14                        ; 00448af9
    PUSH 0x1                            ; 00448afc
    PUSH EBX                            ; 00448afe
    MOV EDI,dword ptr [0x0067d550]      ; 00448aff | CDemonMission * g_CDemonMissionPtr
    PUSH EDI                            ; 00448b05 | CDemonMission g_CDemonMissionInstance
    CALL core_mission.cpp_CDemonMission_markActorToDelete_FUN_005240a0 ; 00448b06 | void core_mission.cpp_CDemonMission_markActorToDelete_FUN_005240a0(CDemonMission * this_ptr)
