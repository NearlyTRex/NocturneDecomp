...
;                               FUNCTION
; *****************************************************************************
; __cdecl CCrate * __cdecl core_crate_cpp_CCrate_dtor_FUN_00448bb0(CCrate *this_ptr,uint d1,uint d2)
;
; Parameters:
...
section .text
    ...
    PUSH 0x65c350                       ; 00448bd6 | g_CCrateTypeInfo
        ;   Label: LAB_00448bd6
    PUSH EBX                            ; 00448bdb
    CALL crt_memory.c_freeSingleInstance_FUN_005fe632 ; 00448bdc
        ;   XREF to: 005fe632 (UNCONDITIONAL_CALL)  ; void * crt_memory.c_freeSingleInstance_FUN_005fe632(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 00448be1
    PUSH EAX                            ; 00448be4
    CALL crt_memory.c_free_FUN_005fe659 ; 00448be5
