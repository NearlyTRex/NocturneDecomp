...
section .text
    ...
    PUSH 0x2fc                          ; 00448497
    CALL shape_memdbg.cpp_debugAlloc_FUN_0050f1b0 ; 0044849c
    ...
    PUSH EAX                            ; 004484a9
        ;   Label: LAB_004484a9
    CALL core_crate.cpp_FUN_004484d0    ; 004484aa
        ;   XREF to: 004484d0 (UNCONDITIONAL_CALL)  ; CCrate * core_crate.cpp_FUN_004484d0(CCrate * this_ptr)
