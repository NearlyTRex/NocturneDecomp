...
section .text
    ...
    PUSH EBX                            ; 004489d0
        ;   Label: core_crate.cpp_CCrate_getTargetPoints_FUN_004489d0
    ...
    FXCH                                ; 004489fd
    FLD float ptr [0x00619b2a]          ; 004489ff | FLOAT_00619b2a
    FXCH                                ; 00448a05
    FMUL ST1                            ; 00448a07
    FXCH ST2                            ; 00448a09
    ...
    JNZ 0x00448a43                      ; 00448a37
        ;   XREF to: 00448a43 (CONDITIONAL_JUMP)  ; LAB_00448a43
