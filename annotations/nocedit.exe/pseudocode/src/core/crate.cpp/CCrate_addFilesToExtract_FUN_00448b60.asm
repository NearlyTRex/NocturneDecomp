...
;                               FUNCTION
; *****************************************************************************
; __cdecl void __cdecl core_crate_cpp_CCrate_addFilesToExtract_FUN_00448b60(CCrate *this_ptr,_FILE *file_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00448b60
        ;   Label: core_crate.cpp_CCrate_addFilesToExtract_FUN_00448b60
    PUSH ESI                            ; 00448b61
    MOV EBX,dword ptr [ESP + 0xc]       ; 00448b62
    MOV ESI,dword ptr [ESP + 0x10]      ; 00448b66
    PUSH ESI                            ; 00448b6a
    PUSH EBX                            ; 00448b6b
    CALL core_actor.cpp_CDemonActor_addFilesToExtract_FUN_0040cfd0 ; 00448b6c
    ...
    PUSH EAX                            ; 00448b9e
    CALL core_dmodel.cpp_CKeyFramedModel_addFilesToExtract_FUN_0047ed00 ; 00448b9f
