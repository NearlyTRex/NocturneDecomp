...
section .text
    ...
    PUSH EAX                            ; 0044888c
    MOV EDX,dword ptr [0x006703ec]      ; 0044888d | g_CDemonRendererPtr
    ...
    PUSH EAX                            ; 004488a1
    MOV ECX,dword ptr [0x006703ec]      ; 004488a2 | g_CDemonRendererPtr
    ...
    MOV EBX,dword ptr [0x006703ec]      ; 004488d0 | g_CDemonRendererPtr
        ;   Label: LAB_004488d0
