...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x4]       ; 004e5e20
        ;   Label: core_gasmask.cpp_CGasMask_archive_FUN_004e5e20
    PUSH EDX                            ; 004e5e24
    CALL core_actor.cpp_CDemonActor_archive_FUN_0040c1c0 ; 004e5e25
    ...
    PUSH EAX                            ; 004e5e3b
    CALL core_actor.cpp_archiveKeyframedModelInstance_FUN_0040b8f0 ; 004e5e3c
