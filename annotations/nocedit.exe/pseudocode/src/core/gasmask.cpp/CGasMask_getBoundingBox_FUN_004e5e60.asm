...
;                               FUNCTION
; *****************************************************************************
; __cdecl CBoundingBox3D * __cdecl core_gasmask_cpp_CGasMask_getBoundingBox_FUN_004e5e60(CGasMask *this_ptr,CBoundingBox3D *out_box)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004e5e60
        ;   Label: core_gasmask.cpp_CGasMask_getBoundingBox_FUN_004e5e60
