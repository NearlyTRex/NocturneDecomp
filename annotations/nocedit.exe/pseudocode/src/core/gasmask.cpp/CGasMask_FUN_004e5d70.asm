...
;                               FUNCTION
; *****************************************************************************
; unknown undefined core_gasmask.cpp_CGasMask_FUN_004e5d70()
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH 0x62dab5                       ; 004e5d70 | = "CHero" | s_CHero_0062dab5 = CHero
        ;   Label: core_gasmask.cpp_CGasMask_FUN_004e5d70
    MOV EDX,dword ptr [ESP + 0xc]       ; 004e5d75
    PUSH EDX                            ; 004e5d79
    CALL core_actor.cpp_isOfClass_FUN_0040c6d0 ; 004e5d7a | int core_actor.cpp_isOfClass_FUN_0040c6d0(CDemonActor * actor_ptr, char * class_name)
