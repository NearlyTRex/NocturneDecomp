...
section .text
    ...
    PUSH EAX                            ; 004e5dac
    MOV EDX,dword ptr [0x006703ec]      ; 004e5dad | g_CDemonRendererPtr
    ...
    PUSH EAX                            ; 004e5dc1
    MOV ECX,dword ptr [0x006703ec]      ; 004e5dc2 | g_CDemonRendererPtr
    ...
    MOV EBX,dword ptr [0x006703ec]      ; 004e5df0 | g_CDemonRendererPtr
        ;   Label: LAB_004e5df0
