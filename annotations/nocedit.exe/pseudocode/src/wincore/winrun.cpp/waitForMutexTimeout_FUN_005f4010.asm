...
section .text
    ...
    JNZ 0x005f4021                      ; 005f4019 | LAB_005f4021
    ...
    FLD double ptr [ESP + 0x10]         ; 005f4021
        ;   Label: LAB_005f4021
    FMUL double ptr [0x0065817c]        ; 005f4025 | double g_SecondsToMillisecondsMultiplier
    CALL crt_math.c_round_FUN_005fe6b0  ; 005f402b | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP qword ptr [ESP]               ; 005f4030
    MOV EAX,dword ptr [ESP]             ; 005f4033
    PUSH EAX                            ; 005f4036
    PUSH EDX                            ; 005f4037
    CALL dword ptr CS:[0x61166c]        ; 005f4038 | WaitForSingleObject * WaitForSingleObject
