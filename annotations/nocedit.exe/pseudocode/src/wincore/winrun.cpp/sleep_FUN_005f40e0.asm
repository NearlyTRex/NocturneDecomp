...
section .text
    ...
    FNSTSW AX                           ; 005f40e9
    SAHF                                ; 005f40eb
    JC 0x005f40fb                       ; 005f40ec | LAB_005f40fb
        ;   XREF to: 005f40fb (CONDITIONAL_JUMP)
    PUSH 0x0                            ; 005f40ee
    CALL dword ptr CS:[0x611644]        ; 005f40f0 | Sleep * Sleep
    ADD ESP,0x8                         ; 005f40f7
    RET                                 ; 005f40fa
    FLD double ptr [ESP + 0xc]          ; 005f40fb
        ;   Label: LAB_005f40fb
    FMUL double ptr [0x00658184]        ; 005f40ff | double g_SecondsToMillisecondsMultiplier
    SUB ESP,0x8                         ; 005f4105
    FSTP double ptr [ESP]               ; 005f4108
    CALL crt_math.c_ceil_FUN_006001b2   ; 005f410b | double crt_math.c_ceil_FUN_006001b2(double value)
    ...
    CALL crt_math.c_round_FUN_005fe6b0  ; 005f411f | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP qword ptr [ESP]               ; 005f4124
    MOV EAX,dword ptr [ESP]             ; 005f4127
    PUSH EAX                            ; 005f412a
    CALL dword ptr CS:[0x611644]        ; 005f412b | Sleep * Sleep
