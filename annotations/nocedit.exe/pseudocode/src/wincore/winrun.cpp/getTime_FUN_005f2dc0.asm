...
;                               FUNCTION
; *****************************************************************************
; __cdecl int wincore_winrun.cpp_getTime_FUN_005f2dc0(void)
;
;
; XREF[46]:
...
;   core_game.cpp_FUN_004e30f0 at 004e30ff
;   core_game.cpp_FUN_004e3110 at 004e3127
...
section .text
    ...
    CMP dword ptr [0x03f96bc4],0x0      ; 005f2dc3 | BOOL g_UseMultimediaTimer
    JZ 0x005f2ddd                       ; 005f2dca | LAB_005f2ddd
        ;   XREF to: 005f2ddd (CONDITIONAL_JUMP)
    CALL dword ptr CS:[0x61141c]        ; 005f2dcc | timeGetTime * timeGetTime
    ...
    PUSH EDI                            ; 005f2ddd
        ;   Label: LAB_005f2ddd
    PUSH ESI                            ; 005f2dde
    MOV EDI,0x3f96ba0                   ; 005f2ddf | DWORD g_PreviousCounterLow
    MOV ESI,0x3f96ba8                   ; 005f2de4 | LARGE_INTEGER g_PerformanceCounter
    PUSH 0x3f96ba8                      ; 005f2de9 | LARGE_INTEGER g_PerformanceCounter
    MOVSD ES:EDI,ESI                    ; 005f2dee | DWORD g_PreviousCounterLow | LARGE_INTEGER g_PerformanceCounter
    MOVSD ES:EDI,ESI                    ; 005f2def | DWORD g_PreviousCounterHigh | g_PerformanceCounter+4
    CALL dword ptr CS:[0x6115f8]        ; 005f2df0 | QueryPerformanceCounter * QueryPerformanceCounter
    FLD double ptr [0x00657f34]         ; 005f2df7 | double g_HighPartMultiplier
    FILD dword ptr [0x03f96ba4]         ; 005f2dfd | DWORD g_PreviousCounterHigh
    FMUL ST1                            ; 005f2e03
    FILD dword ptr [0x03f96bac]         ; 005f2e05 | g_PerformanceCounter+4
    FMULP ST2                           ; 005f2e0b
    XOR ECX,ECX                         ; 005f2e0d
    MOV EAX,[0x03f96ba0]                ; 005f2e0f | DWORD g_PreviousCounterLow
    MOV dword ptr [ESP + 0x1c],ECX      ; 005f2e14
    MOV dword ptr [ESP + 0x18],EAX      ; 005f2e18
    MOV EAX,[0x03f96ba8]                ; 005f2e1c | LARGE_INTEGER g_PerformanceCounter
    ...
    FSUBP                               ; 005f2e35
    FLD ST0                             ; 005f2e37
    FDIV double ptr [0x03f96bb8]        ; 005f2e39 | double g_TimerCalibration
    FMUL double ptr [0x00657f3c]        ; 005f2e3f | double g_TimeScaleFactor1
    FMUL double ptr [0x00657f44]        ; 005f2e45 | double g_TimeScaleFactor2
    MOV ESI,dword ptr [0x03f96bc0]      ; 005f2e4b | int g_AccumulatedGameTime
    FSTP ST1                            ; 005f2e51
    CALL crt_math.c_round_FUN_005fe6b0  ; 005f2e53 | double crt_math.c_round_FUN_005fe6b0(double value)
        ;   XREF to: 005fe6b0 (UNCONDITIONAL_CALL)
    FISTP dword ptr [ESP + 0x28]        ; 005f2e58
    MOV EAX,dword ptr [ESP + 0x28]      ; 005f2e5c
    ADD ESI,EAX                         ; 005f2e60
    MOV dword ptr [0x03f96bc0],ESI      ; 005f2e62 | int g_AccumulatedGameTime
