...
section .text
    ...
    PUSH 0x0                            ; 005f414f
    PUSH EBX                            ; 005f4151
    CALL crt_memory.c_memset_FUN_005fde40 ; 005f4152 | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
    ...
    CALL dword ptr CS:[0x611570]        ; 005f416a | GetComputerNameA * GetComputerNameA
    MOV EAX,ESP                         ; 005f4171
    PUSH EAX                            ; 005f4173
    MOV ECX,0x100                       ; 005f4174
    PUSH EBX                            ; 005f4179
    MOV dword ptr [ESP + 0x8],ECX       ; 005f417a
    CALL dword ptr CS:[0x611460]        ; 005f417e | GetUserNameA * GetUserNameA
    CMP byte ptr [EBX + 0x100],0x0      ; 005f4185
    JZ 0x005f419a                       ; 005f418c | LAB_005f419a
        ;   XREF to: 005f419a (CONDITIONAL_JUMP)
    CMP byte ptr [EBX],0x0              ; 005f418e
        ;   Label: LAB_005f418e
    JZ 0x005f41d3                       ; 005f4191 | LAB_005f41d3
    ...
    POP EBX                             ; 005f4198
    RET                                 ; 005f4199
    PUSH 0x65818c                       ; 005f419a | = "COMPUTERNAME" | s_COMPUTERNAME_0065818c = COMPUTERNAME
        ;   Label: LAB_005f419a
    CALL crt_env.c_getenv_FUN_006013f0  ; 005f419f | char * crt_env.c_getenv_FUN_006013f0(char * name)
        ;   XREF to: 006013f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005f41a4
    TEST EAX,EAX                        ; 005f41a7
    JZ 0x005f418e                       ; 005f41a9 | LAB_005f418e
    ...
    CMP AL,0x0                          ; 005f41b2
    JZ 0x005f41c6                       ; 005f41b4 | LAB_005f41c6
    ...
    CMP AL,0x0                          ; 005f41c2
    JNZ 0x005f41ae                      ; 005f41c4 | LAB_005f41ae
        ;   XREF to: 005f41ae (CONDITIONAL_JUMP)
    POP EDI                             ; 005f41c6
        ;   Label: LAB_005f41c6
    CMP byte ptr [EBX],0x0              ; 005f41c7
    JZ 0x005f41d3                       ; 005f41ca | LAB_005f41d3
        ;   XREF to: 005f41d3 (CONDITIONAL_JUMP)
    ...
    POP EBX                             ; 005f41d1
    RET                                 ; 005f41d2
    PUSH 0x658199                       ; 005f41d3 | = "USERNAME" | s_USERNAME_00658199 = USERNAME
        ;   Label: LAB_005f41d3
    CALL crt_env.c_getenv_FUN_006013f0  ; 005f41d8 | char * crt_env.c_getenv_FUN_006013f0(char * name)
        ;   XREF to: 006013f0 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005f41dd
    TEST EAX,EAX                        ; 005f41e0
    JZ 0x005f4193                       ; 005f41e2 | LAB_005f4193
    ...
    CMP AL,0x0                          ; 005f41ed
    JZ 0x005f4201                       ; 005f41ef | LAB_005f4201
    ...
    CMP AL,0x0                          ; 005f41fd
    JNZ 0x005f41e9                      ; 005f41ff | LAB_005f41e9
