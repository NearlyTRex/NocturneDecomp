...
section .text
    ...
    CMP dword ptr [0x03f99504],0x0      ; 005f4507 | int g_MoviePlaying
    JNZ 0x005f4518                      ; 005f450e | LAB_005f4518
    ...
    PUSH ECX                            ; 005f4527
    CALL dword ptr CS:[0x6114a4]        ; 005f4528 | GetClientRect * GetClientRect
    PUSH 0x0                            ; 005f452f
    PUSH 0x80                           ; 005f4531
    LEA EAX,[ESP + 0x8]                 ; 005f4536
    PUSH EAX                            ; 005f453a
    PUSH 0x6581dd                       ; 005f453b | = "where mov source" | s_where_mov_source_006581dd = where mov source
    CALL dword ptr CS:[0x611410]        ; 005f4540 | mciSendStringA * mciSendStringA
    LEA EAX,[ESP + 0x90]                ; 005f4547
    PUSH EAX                            ; 005f454e
    CALL dword ptr CS:[0x6114f0]        ; 005f454f | SetRectEmpty * SetRectEmpty
    MOV DL,byte ptr [ESP]               ; 005f4556
    MOV EAX,ESP                         ; 005f4559
    CMP DL,0x20                         ; 005f455b
    JNZ 0x005f4570                      ; 005f455e | LAB_005f4570
        ;   XREF to: 005f4570 (CONDITIONAL_JUMP)
    MOV DH,byte ptr [EAX + 0x1]         ; 005f4560
        ;   Label: LAB_005f4560
    INC EAX                             ; 005f4563
    CMP DH,0x20                         ; 005f4564
    JZ 0x005f4560                       ; 005f4567 | LAB_005f4560
        ;   XREF to: 005f4560 (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 005f4569
    NOP                                 ; 005f456f
    CMP byte ptr [EAX],0x20             ; 005f4570
        ;   Label: LAB_005f4570
    JZ 0x005f4578                       ; 005f4573 | LAB_005f4578
        ;   XREF to: 005f4578 (CONDITIONAL_JUMP)
    INC EAX                             ; 005f4575
    JMP 0x005f4570                      ; 005f4576 | LAB_005f4570
        ;   XREF to: 005f4570 (UNCONDITIONAL_JUMP)
    CMP byte ptr [EAX],0x20             ; 005f4578
        ;   Label: LAB_005f4578
    JNZ 0x005f4580                      ; 005f457b | LAB_005f4580
        ;   XREF to: 005f4580 (CONDITIONAL_JUMP)
    INC EAX                             ; 005f457d
    JMP 0x005f4578                      ; 005f457e | LAB_005f4578
        ;   XREF to: 005f4578 (UNCONDITIONAL_JUMP)
    CMP byte ptr [EAX],0x20             ; 005f4580
        ;   Label: LAB_005f4580
    JZ 0x005f4588                       ; 005f4583 | LAB_005f4588
        ;   XREF to: 005f4588 (CONDITIONAL_JUMP)
    INC EAX                             ; 005f4585
    JMP 0x005f4580                      ; 005f4586 | LAB_005f4580
        ;   XREF to: 005f4580 (UNCONDITIONAL_JUMP)
    CMP byte ptr [EAX],0x20             ; 005f4588
        ;   Label: LAB_005f4588
    JNZ 0x005f45a9                      ; 005f458b | LAB_005f45a9
        ;   XREF to: 005f45a9 (CONDITIONAL_JUMP)
    INC EAX                             ; 005f458d
    JMP 0x005f4588                      ; 005f458e | LAB_005f4588
    ...
    PUSH ECX                            ; 005f4673
    PUSH EBX                            ; 005f4674
    MOV EDI,dword ptr [0x03f994fc]      ; 005f4675 | HWND g_MovieWindowHandle
    PUSH EDI                            ; 005f467b
    CALL dword ptr CS:[0x6114c8]        ; 005f467c | MoveWindow * MoveWindow
    POP EBX                             ; 005f4683
    POP ESI                             ; 005f4684
    POP EDI                             ; 005f4685
    ...
    PUSH ESI                            ; 005f468f
    PUSH EBX                            ; 005f4690
    JMP 0x005f45dc                      ; 005f4691 | LAB_005f45dc
        ;   XREF to: 005f45dc (UNCONDITIONAL_JUMP)
    CMP dword ptr [ESP + 0x98],0x12c    ; 005f4696
        ;   Label: LAB_005f4696
    JG 0x005f45f9                       ; 005f46a1 | LAB_005f45f9
        ;   XREF to: 005f45f9 (CONDITIONAL_JUMP)
    JMP 0x005f4619                      ; 005f46a7 | LAB_005f4619
