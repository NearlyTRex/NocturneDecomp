...
section .text
    ...
    CMP dword ptr [0x03f99504],0x0      ; 005f46b0 | int g_MoviePlaying
        ;   Label: wincore_winvideo.cpp_closeMovie_FUN_005f46b0
    JNZ 0x005f46ba                      ; 005f46b7 | LAB_005f46ba
    ...
    PUSH 0x0                            ; 005f46bd
    PUSH 0x0                            ; 005f46bf
    PUSH 0x6581ee                       ; 005f46c1 | = "close mov" | s_close_mov_006581ee = close mov
    CALL dword ptr CS:[0x611410]        ; 005f46c6 | mciSendStringA * mciSendStringA
    PUSH 0x1                            ; 005f46cd
    XOR ECX,ECX                         ; 005f46cf
    PUSH ECX                            ; 005f46d1
    MOV ESI,dword ptr [ESP + 0x10]      ; 005f46d2
    PUSH ESI                            ; 005f46d6
    MOV dword ptr [0x03f99500],ECX      ; 005f46d7 | DWORD g_MovieHandle
    MOV dword ptr [0x03f99504],ECX      ; 005f46dd | int g_MoviePlaying
    CALL dword ptr CS:[0x6114b4]        ; 005f46e3 | InvalidateRect * InvalidateRect
    PUSH ESI                            ; 005f46ea
    CALL dword ptr CS:[0x6114fc]        ; 005f46eb | UpdateWindow * UpdateWindow
    POP ESI                             ; 005f46f2
    RET                                 ; 005f46f3
