...
section .text
    ...
    MOV EDX,dword ptr [0x00679398]      ; 005ece64 | int g_WindowHeight
    XOR ECX,ECX                         ; 005ece6a
    TEST EDX,EDX                        ; 005ece6c
    JLE 0x005ecedd                      ; 005ece6e | LAB_005ecedd
        ;   XREF to: 005ecedd (CONDITIONAL_JUMP)
    PUSH EDI                            ; 005ece70
    PUSH ESI                            ; 005ece71
    PUSH EBX                            ; 005ece72
    MOV EAX,[0x0067939c]                ; 005ece73 | int g_BitsPerPixel
    ...
    MOV EAX,[0x00679394]                ; 005ece87 | int g_WindowWidth
    SHL EAX,0x2                         ; 005ece8c
    MOV EBP,dword ptr [0x00679394]      ; 005ece8f | int g_WindowWidth
    MOV dword ptr [ESP + 0xc],EAX       ; 005ece95
    XOR EAX,EAX                         ; 005ece99
    IMUL EDX,EBP,0x0                    ; 005ece9b
    MOV EBX,dword ptr [0x00679394]      ; 005ece9e | int g_WindowWidth
        ;   Label: LAB_005ece9e
    IMUL EBX,ECX                        ; 005ecea4
    IMUL EBX,EDI                        ; 005ecea7
    MOV ESI,dword ptr [0x00688010]      ; 005eceaa | void * g_BackBuffer
    ADD EBX,ESI                         ; 005eceb0
    MOV dword ptr [EAX + 0x2cf6a9c],EBX ; 005eceb2 | void *[1024] g_ScreenBufferArray
    MOV EBX,dword ptr [0x0077262c]      ; 005eceb8 | void * g_SoftwareZBuffer
    ADD EAX,0x4                         ; 005ecebe
    ADD EBX,EDX                         ; 005ecec1
    INC ECX                             ; 005ecec3
    MOV dword ptr [EAX + 0x2cf7d58],EBX ; 005ecec4 | uint *[1024] g_ZBufferScanlineArray
    MOV EBX,dword ptr [ESP + 0xc]       ; 005ececa
    MOV ESI,dword ptr [0x00679398]      ; 005ecece | int g_WindowHeight
    ADD EDX,EBX                         ; 005eced4
    CMP ECX,ESI                         ; 005eced6
    JL 0x005ece9e                       ; 005eced8 | LAB_005ece9e
