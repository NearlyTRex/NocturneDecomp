...
section .text
    ...
    MOV EDX,dword ptr [0x03f9593c]      ; 005ed585 | int g_UseSoftwareRendering
    TEST EDX,EDX                        ; 005ed58b
    JNZ 0x005ed5a0                      ; 005ed58d | LAB_005ed5a0
        ;   XREF to: 005ed5a0 (CONDITIONAL_JUMP)
    CMP dword ptr [0x02d03e94],0x0      ; 005ed58f | int g_UseExternalRenderer
    JZ 0x005ed5a6                       ; 005ed596 | LAB_005ed5a6
    ...
    PUSH EAX                            ; 005ed5ad
    CALL crt_memory.c_memset_FUN_005fde40 ; 005ed5ae | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
    ...
    PUSH ECX                            ; 005ed5c3
    MOV EAX,[0x03f95928]                ; 005ed5c4 | IDirectDrawSurface * g_SoftwareRenderSurface
    ...
    JZ 0x005ed600                       ; 005ed5d7 | LAB_005ed600
        ;   XREF to: 005ed600 (CONDITIONAL_JUMP)
    PUSH EDI                            ; 005ed5d9
    PUSH ESI                            ; 005ed5da
    MOV ESI,0x65789f                    ; 005ed5db | = "..\\wincore\\wddvmem.cpp" | s_wincore_wddvmem_cpp_0065789f = ..\wincore\wddvmem.cpp
    MOV EDI,0x255                       ; 005ed5e0
    PUSH 0x6578b6                       ; 005ed5e5 | = "openScreenDevice - Unable to lock scr..." | s_openScreenDevice_Unable__006578b6 = openScreenDevice - Unable to lock screen!
    MOV dword ptr [0x02f0ca48],ESI      ; 005ed5ea | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 005ed5f0 | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005ed5f6 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005ed5fb
    POP ESI                             ; 005ed5fe
    POP EDI                             ; 005ed5ff
    MOV EBP,dword ptr [0x00679398]      ; 005ed600 | int g_WindowHeight
        ;   Label: LAB_005ed600
    MOV EDX,dword ptr [ESP + 0x24]      ; 005ed606
    TEST EBP,EBP                        ; 005ed60a
    JLE 0x005ed5a0                      ; 005ed60c | LAB_005ed5a0
        ;   XREF to: 005ed5a0 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [ESP + 0x10]      ; 005ed60e
    LEA ECX,[EBP*0x4 + 0x0]             ; 005ed612
    XOR EAX,EAX                         ; 005ed619
    MOV dword ptr [EAX + 0x2cf6a9c],EDX ; 005ed61b | void *[1024] g_ScreenBufferArray
        ;   Label: LAB_005ed61b
    ADD EAX,0x4                         ; 005ed621
    ADD EDX,EBX                         ; 005ed624
    CMP EAX,ECX                         ; 005ed626
    JL 0x005ed61b                       ; 005ed628 | LAB_005ed61b
