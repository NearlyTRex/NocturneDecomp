...
;                               FUNCTION
; *****************************************************************************
; __cdecl int wincore_wddvmem.cpp_shutdownDirectDraw_FUN_005eca30(void)
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH EDI                            ; 005eca31
    PUSH EBP                            ; 005eca32
    MOV EDX,dword ptr [0x03f9592c]      ; 005eca33 | IUnknown * g_DirectDrawUnknown
    TEST EDX,EDX                        ; 005eca39
    JNZ 0x005eca81                      ; 005eca3b | LAB_005eca81
        ;   XREF to: 005eca81 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [0x03f95928]      ; 005eca3d | IDirectDrawSurface * g_SoftwareRenderSurface
        ;   Label: LAB_005eca3d
    TEST EBX,EBX                        ; 005eca43
    JZ 0x005eca57                       ; 005eca45 | LAB_005eca57
    ...
    MOV dword ptr [0x03f95928],ESI      ; 005eca50 | IDirectDrawSurface * g_SoftwareRenderSurface
    POP ESI                             ; 005eca56
    MOV EDI,dword ptr [0x03f95924]      ; 005eca57 | IDirectDrawSurface * g_DirectDrawSurface
        ;   Label: LAB_005eca57
    TEST EDI,EDI                        ; 005eca5d
    JZ 0x005eca6f                       ; 005eca5f | LAB_005eca6f
        ;   XREF to: 005eca6f (CONDITIONAL_JUMP)
    PUSH EDI                            ; 005eca61
    MOV EDX,dword ptr [EDI]             ; 005eca62
    XOR EBP,EBP                         ; 005eca64
    CALL dword ptr [EDX + 0x8]          ; 005eca66
    MOV dword ptr [0x03f95924],EBP      ; 005eca69 | IDirectDrawSurface * g_DirectDrawSurface
    MOV EAX,[0x03f95920]                ; 005eca6f | IDirectDraw * g_DirectDrawObject
        ;   Label: LAB_005eca6f
    TEST EAX,EAX                        ; 005eca74
    JNZ 0x005eca93                      ; 005eca76 | LAB_005eca93
    ...
    MOV dword ptr [0x03f9592c],ECX      ; 005eca8b | IUnknown * g_DirectDrawUnknown
    JMP 0x005eca3d                      ; 005eca91 | LAB_005eca3d
        ;   XREF to: 005eca3d (UNCONDITIONAL_JUMP)
    PUSH EAX                            ; 005eca93
        ;   Label: LAB_005eca93
    MOV EDX,dword ptr [EAX]             ; 005eca94
    CALL dword ptr [EDX + 0x4c]         ; 005eca96
    MOV EAX,[0x03f95920]                ; 005eca99 | IDirectDraw * g_DirectDrawObject
    PUSH EAX                            ; 005eca9e
    MOV EDX,dword ptr [EAX]             ; 005eca9f
    CALL dword ptr [EDX + 0x8]          ; 005ecaa1
    XOR EDX,EDX                         ; 005ecaa4
    MOV dword ptr [0x03f95920],EDX      ; 005ecaa6 | IDirectDraw * g_DirectDrawObject
