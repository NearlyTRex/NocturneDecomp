...
section .text
    ...
    PUSH EAX                            ; 005ed73c
    CALL crt_memory.c_memset_FUN_005fde40 ; 005ed73d
    ...
    PUSH ECX                            ; 005ed752
    MOV EAX,[0x03f95928]                ; 005ed753 | g_SoftwareRenderSurface
    ...
    JNZ 0x005ed7f0                      ; 005ed766
        ;   XREF to: 005ed7f0 (CONDITIONAL_JUMP)  ; LAB_005ed7f0
    PUSH 0x0                            ; 005ed76c
        ;   Label: LAB_005ed76c
    MOV EAX,[0x03f95928]                ; 005ed76e | g_SoftwareRenderSurface
    PUSH EAX                            ; 005ed773
    MOV ECX,dword ptr [EAX]             ; 005ed774
    CALL dword ptr [ECX + 0x80]         ; 005ed776
    TEST EAX,EAX                        ; 005ed77c
    JZ 0x005ed7a7                       ; 005ed77e
        ;   XREF to: 005ed7a7 (CONDITIONAL_JUMP)  ; LAB_005ed7a7
    PUSH EDI                            ; 005ed780
    PUSH ESI                            ; 005ed781
    MOV ESI,0x657961                    ; 005ed782 | = "..\\wincore\\wddvmem.cpp"
    MOV EDI,0x2b0                       ; 005ed787
    PUSH 0x657978                       ; 005ed78c | = "setColorTable16 - Unable to unlock ba..."
    MOV dword ptr [0x02f0ca48],ESI      ; 005ed791 | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 005ed797 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005ed79d
    ...
    JNZ 0x005ed7c0                      ; 005ed7b4
        ;   XREF to: 005ed7c0 (CONDITIONAL_JUMP)  ; LAB_005ed7c0
    SHR EAX,0x1                         ; 005ed7b6
        ;   Label: LAB_005ed7b6
    INC ECX                             ; 005ed7b8
    TEST AL,0x1                         ; 005ed7b9
    JZ 0x005ed7b6                       ; 005ed7bb
        ;   XREF to: 005ed7b6 (CONDITIONAL_JUMP)  ; LAB_005ed7b6
    LEA EAX,[EAX]                       ; 005ed7bd
    MOV EAX,dword ptr [ESP + 0x58]      ; 005ed7c0
        ;   Label: LAB_005ed7c0
    MOV dword ptr [0x02d01f24],ECX      ; 005ed7c4 | g_RedBitPosition
    SHR EAX,CL                          ; 005ed7ca
    XOR EDX,EDX                         ; 005ed7cc
    MOV ECX,EAX                         ; 005ed7ce
    MOV EAX,0xff                        ; 005ed7d0
    DIV ECX                             ; 005ed7d5
    MOV [0x02d01f28],EAX                ; 005ed7d7 | g_RedScaleFactor
    XOR ECX,ECX                         ; 005ed7dc
    TEST EAX,EAX                        ; 005ed7de
    JZ 0x005ed818                       ; 005ed7e0
        ;   XREF to: 005ed818 (CONDITIONAL_JUMP)  ; LAB_005ed818
    CMP EAX,0x1                         ; 005ed7e2
        ;   Label: LAB_005ed7e2
    JBE 0x005ed86c                      ; 005ed7e5
        ;   XREF to: 005ed86c (CONDITIONAL_JUMP)  ; LAB_005ed86c
    INC ECX                             ; 005ed7eb
    SHR EAX,0x1                         ; 005ed7ec
    JMP 0x005ed7e2                      ; 005ed7ee
        ;   XREF to: 005ed7e2 (UNCONDITIONAL_JUMP)  ; LAB_005ed7e2
    MOV ECX,0x65791c                    ; 005ed7f0 | = "..\\wincore\\wddvmem.cpp"
        ;   Label: LAB_005ed7f0
    MOV EBX,0x2ae                       ; 005ed7f5
    PUSH 0x657933                       ; 005ed7fa | = "setColorTable16 - Unable to lock back..."
    MOV dword ptr [0x02f0ca48],ECX      ; 005ed7ff | g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EBX      ; 005ed805 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005ed80b
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
    ADD ESP,0x4                         ; 005ed810
    JMP 0x005ed76c                      ; 005ed813
        ;   XREF to: 005ed76c (UNCONDITIONAL_JUMP)  ; LAB_005ed76c
    ...
    JNZ 0x005ed840                      ; 005ed82f
        ;   XREF to: 005ed840 (CONDITIONAL_JUMP)  ; LAB_005ed840
    SHR EAX,0x1                         ; 005ed831
        ;   Label: LAB_005ed831
    INC ECX                             ; 005ed833
    TEST AL,0x1                         ; 005ed834
    JZ 0x005ed831                       ; 005ed836
        ;   XREF to: 005ed831 (CONDITIONAL_JUMP)  ; LAB_005ed831
    LEA EAX,[EAX]                       ; 005ed838
    MOV EDX,EDX                         ; 005ed83e
    MOV EAX,dword ptr [ESP + 0x5c]      ; 005ed840
        ;   Label: LAB_005ed840
    MOV dword ptr [0x02d01f30],ECX      ; 005ed844 | g_GreenBitPosition
    SHR EAX,CL                          ; 005ed84a
    XOR EDX,EDX                         ; 005ed84c
    MOV ECX,EAX                         ; 005ed84e
    MOV EAX,0xff                        ; 005ed850
    DIV ECX                             ; 005ed855
    MOV [0x02d01f34],EAX                ; 005ed857 | g_GreenScaleFactor
    XOR ECX,ECX                         ; 005ed85c
    TEST EAX,EAX                        ; 005ed85e
    JZ 0x005ed870                       ; 005ed860
        ;   XREF to: 005ed870 (CONDITIONAL_JUMP)  ; LAB_005ed870
    CMP EAX,0x1                         ; 005ed862
        ;   Label: LAB_005ed862
    JBE 0x005ed8bc                      ; 005ed865
        ;   XREF to: 005ed8bc (CONDITIONAL_JUMP)  ; LAB_005ed8bc
    INC ECX                             ; 005ed867
    SHR EAX,0x1                         ; 005ed868
    JMP 0x005ed862                      ; 005ed86a
        ;   XREF to: 005ed862 (UNCONDITIONAL_JUMP)  ; LAB_005ed862
    MOV EAX,ECX                         ; 005ed86c
        ;   Label: LAB_005ed86c
    JMP 0x005ed81d                      ; 005ed86e
        ;   XREF to: 005ed81d (UNCONDITIONAL_JUMP)  ; LAB_005ed81d
    ...
    JNZ 0x005ed890                      ; 005ed887
        ;   XREF to: 005ed890 (CONDITIONAL_JUMP)  ; LAB_005ed890
    SHR EAX,0x1                         ; 005ed889
        ;   Label: LAB_005ed889
    INC ECX                             ; 005ed88b
    TEST AL,0x1                         ; 005ed88c
    JZ 0x005ed889                       ; 005ed88e
        ;   XREF to: 005ed889 (CONDITIONAL_JUMP)  ; LAB_005ed889
    MOV EAX,dword ptr [ESP + 0x60]      ; 005ed890
        ;   Label: LAB_005ed890
    MOV dword ptr [0x02d01f3c],ECX      ; 005ed894 | g_BlueBitPosition
    SHR EAX,CL                          ; 005ed89a
    XOR EDX,EDX                         ; 005ed89c
    MOV ECX,EAX                         ; 005ed89e
    MOV EAX,0xff                        ; 005ed8a0
    DIV ECX                             ; 005ed8a5
    MOV [0x02d01f40],EAX                ; 005ed8a7 | g_BlueScaleFactor
    XOR ECX,ECX                         ; 005ed8ac
    TEST EAX,EAX                        ; 005ed8ae
    JZ 0x005ed8c0                       ; 005ed8b0
        ;   XREF to: 005ed8c0 (CONDITIONAL_JUMP)  ; LAB_005ed8c0
    CMP EAX,0x1                         ; 005ed8b2
        ;   Label: LAB_005ed8b2
    JBE 0x005ed8d4                      ; 005ed8b5
        ;   XREF to: 005ed8d4 (CONDITIONAL_JUMP)  ; LAB_005ed8d4
    INC ECX                             ; 005ed8b7
    SHR EAX,0x1                         ; 005ed8b8
    JMP 0x005ed8b2                      ; 005ed8ba
        ;   XREF to: 005ed8b2 (UNCONDITIONAL_JUMP)  ; LAB_005ed8b2
    MOV EAX,ECX                         ; 005ed8bc
        ;   Label: LAB_005ed8bc
    JMP 0x005ed875                      ; 005ed8be
