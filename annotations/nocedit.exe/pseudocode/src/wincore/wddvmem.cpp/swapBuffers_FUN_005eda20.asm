...
;                               FUNCTION
; *****************************************************************************
; __cdecl void wincore_wddvmem.cpp_swapBuffers_FUN_005eda20(void)
;
; Local Variables:
...
section .text
    ...
    CMP dword ptr [0x006849a4],0x0      ; 005eda29 | int g_WindowActive
    JZ 0x005edaf2                       ; 005eda30 | LAB_005edaf2
        ;   XREF to: 005edaf2 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x02d03e94]      ; 005eda36 | int g_UseExternalRenderer
    TEST ECX,ECX                        ; 005eda3c
    JNZ 0x005edb06                      ; 005eda3e | LAB_005edb06
        ;   XREF to: 005edb06 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [0x03f95934]      ; 005eda44 | int g_RenderingInProgress
    TEST EBX,EBX                        ; 005eda4a
    JNZ 0x005edace                      ; 005eda4c | LAB_005edace
        ;   XREF to: 005edace (CONDITIONAL_JUMP)
    MOV ESI,dword ptr [0x03f9593c]      ; 005eda52 | int g_UseSoftwareRendering
    TEST ESI,ESI                        ; 005eda58
    JZ 0x005edb24                       ; 005eda5a | LAB_005edb24
        ;   XREF to: 005edb24 (CONDITIONAL_JUMP)
    MOV EBX,dword ptr [0x00688010]      ; 005eda60 | void * g_BackBuffer
    MOV dword ptr [0x03f9593c],ECX      ; 005eda66 | int g_UseSoftwareRendering
    CALL wincore_wddvmem.cpp_openScreenDevice_FUN_005ed580 ; 005eda6c | void wincore_wddvmem.cpp_openScreenDevice_FUN_005ed580()
        ;   XREF to: 005ed580 (UNCONDITIONAL_CALL)
    MOV ESI,dword ptr [0x00679398]      ; 005eda71 | int g_WindowHeight
    XOR EDI,EDI                         ; 005eda77
    TEST ESI,ESI                        ; 005eda79
    JLE 0x005edabf                      ; 005eda7b | LAB_005edabf
        ;   XREF to: 005edabf (CONDITIONAL_JUMP)
    XOR ESI,ESI                         ; 005eda7d
    MOV ECX,dword ptr [0x00679394]      ; 005eda7f | int g_WindowWidth
        ;   Label: LAB_005eda7f
    MOV EAX,dword ptr [ESI + 0x2cf6a9c] ; 005eda85 | void *[1024] g_ScreenBufferArray
    XOR EDX,EDX                         ; 005eda8b
    TEST ECX,ECX                        ; 005eda8d
    JLE 0x005edab2                      ; 005eda8f | LAB_005edab2
    ...
    MOV ECX,dword ptr [0x00679394]      ; 005edaa5 | int g_WindowWidth
    ADD EAX,0x3                         ; 005edaab
    CMP EDX,ECX                         ; 005edaae
    JL 0x005eda91                       ; 005edab0 | LAB_005eda91
        ;   XREF to: 005eda91 (CONDITIONAL_JUMP)
    MOV EAX,[0x00679398]                ; 005edab2 | int g_WindowHeight
        ;   Label: LAB_005edab2
    INC EDI                             ; 005edab7
    ADD ESI,0x4                         ; 005edab8
    CMP EDI,EAX                         ; 005edabb
    JL 0x005eda7f                       ; 005edabd | LAB_005eda7f
        ;   XREF to: 005eda7f (CONDITIONAL_JUMP)
    CALL wincore_wddvmem.cpp_closeScreenDevice_FUN_005ed630 ; 005edabf | void wincore_wddvmem.cpp_closeScreenDevice_FUN_005ed630()
        ;   Label: LAB_005edabf
        ;   XREF to: 005ed630 (UNCONDITIONAL_CALL)
    MOV dword ptr [0x03f9593c],0x1      ; 005edac4 | int g_UseSoftwareRendering
    MOV EBX,dword ptr [0x03f95924]      ; 005edace | IDirectDrawSurface * g_DirectDrawSurface
        ;   Label: LAB_005edace
    TEST EBX,EBX                        ; 005edad4
    JZ 0x005edaf2                       ; 005edad6 | LAB_005edaf2
        ;   XREF to: 005edaf2 (CONDITIONAL_JUMP)
    PUSH 0x1                            ; 005edad8
    PUSH 0x0                            ; 005edada
    ...
    JZ 0x005edaf2                       ; 005edae4 | LAB_005edaf2
        ;   XREF to: 005edaf2 (CONDITIONAL_JUMP)
    CMP EAX,0x887601c2                  ; 005edae6
    JNZ 0x005edaf2                      ; 005edaeb | LAB_005edaf2
        ;   XREF to: 005edaf2 (CONDITIONAL_JUMP)
    CALL wincore_wddvmem.cpp_videoRestore_FUN_005edc80 ; 005edaed | void wincore_wddvmem.cpp_videoRestore_FUN_005edc80()
        ;   XREF to: 005edc80 (UNCONDITIONAL_CALL)
    XOR ESI,ESI                         ; 005edaf2
        ;   Label: LAB_005edaf2
    MOV dword ptr [0x03f95934],ESI      ; 005edaf4 | int g_RenderingInProgress
    CALL wincore_winrun.cpp_processWindowMessages_FUN_005f35e0 ; 005edafa | void wincore_winrun.cpp_processWindowMessages_FUN_005f35e0()
    ...
    PUSH 0x0                            ; 005edb06
        ;   Label: LAB_005edb06
    CALL wincore_windll.cpp_presentToExternalRenderer_FUN_005b7c30 ; 005edb08 | void wincore_windll.cpp_presentToExternalRenderer_FUN_005b7c30(int skip_buffer_copy)
        ;   XREF to: 005b7c30 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005edb0d
    XOR ESI,ESI                         ; 005edb10
    MOV dword ptr [0x03f95934],ESI      ; 005edb12 | int g_RenderingInProgress
    CALL wincore_winrun.cpp_processWindowMessages_FUN_005f35e0 ; 005edb18 | void wincore_winrun.cpp_processWindowMessages_FUN_005f35e0()
        ;   XREF to: 005f35e0 (UNCONDITIONAL_CALL)
    ...
    POP EBX                             ; 005edb22
    RET                                 ; 005edb23
    MOV EAX,[0x00688010]                ; 005edb24 | void * g_BackBuffer
        ;   Label: LAB_005edb24
    MOV dword ptr [EBP + -0x10],EAX     ; 005edb29
    MOV EAX,[0x0067939c]                ; 005edb2c | int g_BitsPerPixel
    MOV EDX,EAX                         ; 005edb31
    SAR EDX,0x1f                        ; 005edb33
    SHL EDX,0x3                         ; 005edb36
    SBB EAX,EDX                         ; 005edb39
    SAR EAX,0x3                         ; 005edb3b
    MOV EDX,dword ptr [0x00679394]      ; 005edb3e | int g_WindowWidth
    ...
    PUSH EAX                            ; 005edb50
    CALL crt_memory.c_memset_FUN_005fde40 ; 005edb51 | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
    ...
    PUSH EBX                            ; 005edb64
    MOV EAX,[0x03f95924]                ; 005edb65 | IDirectDrawSurface * g_DirectDrawSurface
    ...
    JNZ 0x005edaf2                      ; 005edb7e | LAB_005edaf2
        ;   XREF to: 005edaf2 (CONDITIONAL_JUMP)
    CMP dword ptr [EBP + -0x8],0x0      ; 005edb84
    JZ 0x005edaf2                       ; 005edb88 | LAB_005edaf2
        ;   XREF to: 005edaf2 (CONDITIONAL_JUMP)
    MOV ECX,dword ptr [0x00679398]      ; 005edb8e | int g_WindowHeight
    MOV dword ptr [EBP + -0x4],EDX      ; 005edb94
    TEST ECX,ECX                        ; 005edb97
    JLE 0x005edc00                      ; 005edb99 | LAB_005edc00
    ...
    JG 0x005edbad                       ; 005edbd4 | LAB_005edbad
    ...
    INC ECX                             ; 005edbe7
    MOV EBX,dword ptr [0x00679398]      ; 005edbe8 | int g_WindowHeight
    MOV dword ptr [EBP + -0x4],ECX      ; 005edbee
    CMP ECX,EBX                         ; 005edbf1
    JL 0x005edb9b                       ; 005edbf3 | LAB_005edb9b
    ...
    PUSH 0x0                            ; 005edc00
        ;   Label: LAB_005edc00
    MOV EAX,[0x03f95924]                ; 005edc02 | IDirectDrawSurface * g_DirectDrawSurface
    PUSH EAX                            ; 005edc07
    MOV EDX,dword ptr [EAX]             ; 005edc08
    CALL dword ptr [EDX + 0x80]         ; 005edc0a
    TEST EAX,EAX                        ; 005edc10
    JZ 0x005edaf2                       ; 005edc12 | LAB_005edaf2
        ;   XREF to: 005edaf2 (CONDITIONAL_JUMP)
    MOV ESI,0x657a2b                    ; 005edc18 | = "..\\wincore\\wddvmem.cpp" | s_wincore_wddvmem_cpp_00657a2b = ..\wincore\wddvmem.cpp
    MOV EDI,0x36e                       ; 005edc1d
    PUSH 0x657a42                       ; 005edc22 | = "Unable to unlock front buffer" | s_Unable_to_unlock_front_b_00657a42 = Unable to unlock front buffer
    MOV dword ptr [0x02f0ca48],ESI      ; 005edc27 | char * g_CurrentFilename
    MOV dword ptr [0x02f0ca4c],EDI      ; 005edc2d | int g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_00506f10 ; 005edc33 | void core_main.c_displayErrorAndQuit_FUN_00506f10(char * format)
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005edc38
    XOR ESI,ESI                         ; 005edc3b
    MOV dword ptr [0x03f95934],ESI      ; 005edc3d | int g_RenderingInProgress
    CALL wincore_winrun.cpp_processWindowMessages_FUN_005f35e0 ; 005edc43 | void wincore_winrun.cpp_processWindowMessages_FUN_005f35e0()
        ;   XREF to: 005f35e0 (UNCONDITIONAL_CALL)
