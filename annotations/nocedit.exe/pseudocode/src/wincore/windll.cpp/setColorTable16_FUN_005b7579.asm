...
section .text
    ...
    LEA EAX,[EAX]                       ; 005b7579
        ;   Label: wincore_windll.cpp_setColorTable16_FUN_005b7579
    NOP                                 ; 005b757f
    CMP dword ptr [0x02d03e94],0x0      ; 005b7580 | int g_UseExternalRenderer
    JNZ 0x005b758c                      ; 005b7587 | LAB_005b758c
        ;   XREF to: 005b758c (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 005b7589
    RET                                 ; 005b758b
    PUSH EBX                            ; 005b758c
        ;   Label: LAB_005b758c
    PUSH 0x2d01020                      ; 005b758d | ushort[256] g_ColorTable16
    PUSH 0x2d01f48                      ; 005b7592 | char[768] g_SourcePaletteData
    CALL dword ptr [0x03f6b900]         ; 005b7597 | APIDLL_setColorTable16 * g_APIDLL_setColorTable16
    ADD ESP,0x8                         ; 005b759d
    MOV EBX,EAX                         ; 005b75a0
    TEST EAX,EAX                        ; 005b75a2
    JZ 0x005b75ab                       ; 005b75a4 | LAB_005b75ab
        ;   XREF to: 005b75ab (CONDITIONAL_JUMP)
    CALL wincore_wddvmem.cpp_convertPaletteToDirectColor_FUN_004f41c0 ; 005b75a6 | void wincore_wddvmem.cpp_convertPaletteToDirectColor_FUN_004f41c0()
