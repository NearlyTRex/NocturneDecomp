...
LAB_005b5640:
      ...
      uVar12 = (ushort)CONCAT41 /* combine 2-byte values */(uVar4,(char)(uVar2 >> 8)) & 0xff;
      ...
      uVar6 = CONCAT21 /* combine 2-byte values */(uVar10,(char)(uVar21 >> 0x10));
      uVar9 = (ushort)uVar21;
      uVar5 = CONCAT43 /* combine 2-byte values */((int)(((uint7)uVar6 << 0x20) >> 0x18),CONCAT12 /* combine 2-byte values */((char)(uVar21 >> 8),uVar9));
      sVar15 = (short)(uVar14 >> 8);
      sVar18 = (short)(uVar14 >> 0x18);
      if (g_BlendMode == 1) {
        uVar22 = psllw((ulonglong)CONCAT52 /* combine 2-byte values */((int5)((uint7)uVar5 >> 0x10),uVar9) & 0xffffffffffff00ff,
                       8);
        uVar22 = paddusw(CONCAT26 /* combine 2-byte values */(sVar18 * SVar1.pad,
                                  CONCAT24 /* combine 2-byte values */(sVar15 * SVar1.blue,
                                           CONCAT22 /* combine 2-byte values */(uVar12 * SVar1.green,
        ...
        uVar11 = (ulonglong)
                 CONCAT13 /* combine 2-byte values */((uVar13 != 0) * (uVar13 < 0x100) * (char)((ulonglong)uVar22 >> 0x38) -
                          (0xff < uVar13),
                          CONCAT12 /* combine 2-byte values */((uVar9 != 0) * (uVar9 < 0x100) *
                                   (char)((ulonglong)uVar22 >> 0x28) - (0xff < uVar9),
                                   CONCAT11 /* combine 2-byte values */((uVar12 != 0) * (uVar12 < 0x100) *
        ...
        uVar20 = uVar19 >> 8;
        uVar11 = (ulonglong)
                 CONCAT13 /* combine 2-byte values */((uVar20 != 0) * (uVar20 < 0x100) * (char)(uVar19 >> 8) - (0xff < uVar20),
                          CONCAT12 /* combine 2-byte values */((uVar17 != 0) * (uVar17 < 0x100) * (char)(uVar16 >> 8) -
                                   (0xff < uVar17),
                                   CONCAT11 /* combine 2-byte values */((uVar13 != 0) * (uVar13 < 0x100) * (char)(uVar12 >> 8) -
                                            (0xff < uVar13),
