...
;                               FUNCTION
; *****************************************************************************
; __cdecl void wincore_windll.cpp_presentToExternalRenderer_FUN_005b7c30(int skip_buffer_copy)
;
; Parameters:
...
section .text
    ...
    CMP dword ptr [0x02d03e94],0x0      ; 005b7c34 | int g_UseExternalRenderer
    JZ 0x005b7cf5                       ; 005b7c3b | LAB_005b7cf5
        ;   XREF to: 005b7cf5 (CONDITIONAL_JUMP)
    PUSH EDI                            ; 005b7c41
    CMP dword ptr [ESP + 0x10],0x0      ; 005b7c42
    JNZ 0x005b7ce1                      ; 005b7c47 | LAB_005b7ce1
        ;   XREF to: 005b7ce1 (CONDITIONAL_JUMP)
    CMP dword ptr [0x03f6b99c],0x0      ; 005b7c4d | int g_ExternalFrameLocked
    JNZ 0x005b7ce1                      ; 005b7c54 | LAB_005b7ce1
        ;   XREF to: 005b7ce1 (CONDITIONAL_JUMP)
    PUSH ESI                            ; 005b7c5a
    PUSH EBX                            ; 005b7c5b
    MOV EDX,dword ptr [0x00679394]      ; 005b7c5c | int g_WindowWidth
    MOV ESI,dword ptr [0x0067939c]      ; 005b7c62 | int g_BitsPerPixel
    ...
    MOV EBX,dword ptr [0x02cf6a9c]      ; 005b7c78 | void *[1024] g_ScreenBufferArray
    XOR EDI,EDI                         ; 005b7c7e
    MOV EBP,EAX                         ; 005b7c80
    CALL wincore_wddvmem.cpp_openScreenDevice_FUN_005ed580 ; 005b7c82 | void wincore_wddvmem.cpp_openScreenDevice_FUN_005ed580()
        ;   XREF to: 005ed580 (UNCONDITIONAL_CALL)
    CALL wincore_windll.cpp_lockFrame_FUN_005b7210 ; 005b7c87 | int wincore_windll.cpp_lockFrame_FUN_005b7210()
        ;   XREF to: 005b7210 (UNCONDITIONAL_CALL)
    MOV EAX,[0x00679398]                ; 005b7c8c | int g_WindowHeight
    MOV dword ptr [ESP + 0xc],EDI       ; 005b7c91
    TEST EAX,EAX                        ; 005b7c95
    JLE 0x005b7cd0                      ; 005b7c97 | LAB_005b7cd0
        ;   XREF to: 005b7cd0 (CONDITIONAL_JUMP)
    XOR EDX,EDX                         ; 005b7c99
    MOV ECX,EBP                         ; 005b7c9b
        ;   Label: LAB_005b7c9b
    MOV ESI,EBX                         ; 005b7c9d
    MOV EDI,dword ptr [EDX + 0x2cf6a9c] ; 005b7c9f | void *[1024] g_ScreenBufferArray
    PUSH EDI                            ; 005b7ca5
    ...
    MOV ESI,dword ptr [0x00679398]      ; 005b7cbc | int g_WindowHeight
    INC ECX                             ; 005b7cc2
    ADD EBX,EBP                         ; 005b7cc3
    MOV dword ptr [ESP + 0xc],ECX       ; 005b7cc5
    CMP ECX,ESI                         ; 005b7cc9
    JL 0x005b7c9b                       ; 005b7ccb | LAB_005b7c9b
        ;   XREF to: 005b7c9b (CONDITIONAL_JUMP)
    LEA EAX,[EAX]                       ; 005b7ccd
    PUSH 0x0                            ; 005b7cd0
        ;   Label: LAB_005b7cd0
    CALL wincore_windll.cpp_unlockFrame_FUN_005b7250 ; 005b7cd2 | void wincore_windll.cpp_unlockFrame_FUN_005b7250(int clear_lock_flag)
        ;   XREF to: 005b7250 (UNCONDITIONAL_CALL)
    ADD ESP,0x4                         ; 005b7cd7
    CALL wincore_wddvmem.cpp_closeScreenDevice_FUN_005ed630 ; 005b7cda | void wincore_wddvmem.cpp_closeScreenDevice_FUN_005ed630()
        ;   XREF to: 005ed630 (UNCONDITIONAL_CALL)
    POP EBX                             ; 005b7cdf
    POP ESI                             ; 005b7ce0
    XOR EDI,EDI                         ; 005b7ce1
        ;   Label: LAB_005b7ce1
    MOV dword ptr [0x03f6b99c],EDI      ; 005b7ce3 | int g_ExternalFrameLocked
    CALL dword ptr [0x03f6b894]         ; 005b7ce9 | APIDLL_toggle * g_APIDLL_toggle
    POP EDI                             ; 005b7cef
