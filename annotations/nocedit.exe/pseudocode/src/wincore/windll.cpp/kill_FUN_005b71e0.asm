...
section .text
    ...
    CMP dword ptr [0x03f6b978],0x0      ; 005b71e0 | int g_ExternalRendererActive
        ;   Label: wincore_windll.cpp_kill_FUN_005b71e0
    JNZ 0x005b71ef                      ; 005b71e7 | LAB_005b71ef
        ;   XREF to: 005b71ef (CONDITIONAL_JUMP)
    MOV EAX,0x1                         ; 005b71e9
    RET                                 ; 005b71ee
    CALL dword ptr [0x03f6b890]         ; 005b71ef | APIDLL_kill * g_APIDLL_kill
        ;   Label: LAB_005b71ef
    CALL wincore_windll.cpp_shutdownExternalRenderer_FUN_005b5d20 ; 005b71f5 | void wincore_windll.cpp_shutdownExternalRenderer_FUN_005b5d20()
