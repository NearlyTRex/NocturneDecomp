...

{
  ...
  do {
    ...
    if (g_BlendMode == 1) {
LAB_005b559d:
      uVar3 = (uint)(CONCAT34 /* combine 2-byte values */((int3)(CONCAT25 /* combine 2-byte values */((short)(((uint7)(byte)(uVar8 >> 0x18) << 0x30) >> 0x28
                                                     ),CONCAT14 /* combine 2-byte values */((char)(uVar8 >> 0x10),uVar8)) >>
                                    0x20),uVar8) >> 0x18);
      uVar11 = (uint5)uVar3 & 0xffffffff00;
      uVar7 = (ushort)CONCAT41 /* combine 2-byte values */(uVar3,(char)(uVar8 >> 8)) & 0xff;
      SVar1 = g_AlphaTable[uVar4 >> 8];
      uVar18 = (ulonglong)SVar1 ^ (ulonglong)g_AlphaTable[0xff];
      uVar4 = *destPixels;
      uVar3 = (uint)(CONCAT34 /* combine 2-byte values */((int3)(CONCAT25 /* combine 2-byte values */((short)(((uint7)(byte)(uVar4 >> 0x18) << 0x30) >> 0x28
                                                     ),CONCAT14 /* combine 2-byte values */((char)(uVar4 >> 0x10),uVar4)) >>
                                    0x20),uVar4) >> 0x18);
      uVar21 = (uint5)uVar3 & 0xffffffff00;
      uVar6 = (ushort)uVar4;
      uVar19 = (ulonglong)CONCAT43 /* combine 2-byte values */(uVar3,CONCAT12 /* combine 2-byte values */((char)(uVar4 >> 8),uVar6)) & 0xffffffff00ffffff;
      sVar12 = (short)(uVar11 >> 8);
      sVar15 = (short)(uVar11 >> 0x18);
      if (g_BlendMode == 1) {
        uVar20 = psllw(CONCAT62 /* combine 2-byte values */((int6)(uVar19 >> 0x10),uVar6) & 0xffffffffffff00ff,8);
        uVar20 = paddusw(CONCAT26 /* combine 2-byte values */(sVar15 * SVar1.pad,
                                  CONCAT24 /* combine 2-byte values */(sVar12 * SVar1.blue,
                                           CONCAT22 /* combine 2-byte values */(uVar7 * SVar1.green,
        ...
        uVar8 = CONCAT13 /* combine 2-byte values */((uVar10 != 0) * (uVar10 < 0x100) * (char)((ulonglong)uVar20 >> 0x38) -
                         (0xff < uVar10),
                         CONCAT12 /* combine 2-byte values */((uVar9 != 0) * (uVar9 < 0x100) * (char)((ulonglong)uVar20 >> 0x28)
                                  - (0xff < uVar9),
                                  CONCAT11 /* combine 2-byte values */((uVar6 != 0) * (uVar6 < 0x100) *
        ...
        uVar14 = uVar13 >> 8;
        uVar17 = uVar16 >> 8;
        uVar8 = CONCAT13 /* combine 2-byte values */((uVar17 != 0) * (uVar17 < 0x100) * (char)(uVar16 >> 8) - (0xff < uVar17),
                         CONCAT12 /* combine 2-byte values */((uVar14 != 0) * (uVar14 < 0x100) * (char)(uVar13 >> 8) -
                                  (0xff < uVar14),
                                  CONCAT11 /* combine 2-byte values */((uVar10 != 0) * (uVar10 < 0x100) * (char)(uVar9 >> 8) -
                                           (0xff < uVar10),
