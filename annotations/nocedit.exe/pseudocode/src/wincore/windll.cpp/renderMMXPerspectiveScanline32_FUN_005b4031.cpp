  ...
  if (iVar10 != 0 && uVar8 <= uVar11 >> 0x10) {
    ...
    if ((g_CurrentTextureOpacityData == (void *)0x0) && ((g_RenderStateFlags & 2U) == 0)) {
      ...
      while( true ) {
        ...
        uVar38 = CONCAT26 /* combine 2-byte values */(-(ushort)((short)((ulonglong)0.0 >> 0x30) < sVar41),
                          CONCAT24 /* combine 2-byte values */(-(ushort)((short)((ulonglong)0.0 >> 0x20) <
                                            sVar40),
                                   CONCAT22 /* combine 2-byte values */(-(ushort)((short)((ulonglong)0.0 >>
                                                             0x10) < sVar39),
                                            -(ushort)(SUB82 /* extract 2-byte value */(0.0,0) < sVar36)))) &
      ...
      if (g_CurrentTextureOpacityData != (void *)0x0) {
        while( true ) {
          ...
          iVar17 = iVar17 + g_DeltaDepthW;
          iVar10 = iVar10 + g_VertexAlphaDelta;
          uVar38 = CONCAT26 /* combine 2-byte values */(-(ushort)((short)((ulonglong)0.0 >> 0x30) <
                                     (short)(uVar20 + sVar46)),
                            CONCAT24 /* combine 2-byte values */(-(ushort)((short)((ulonglong)0.0 >> 0x20) <
                                              (short)(uVar48 + sVar45)),
                                     CONCAT22 /* combine 2-byte values */(-(ushort)((short)((ulonglong)0.0 >>
