...
;                               FUNCTION
; *****************************************************************************
; __cdecl int wincore_windll.cpp_lockFrame_FUN_005b7210(void)
;
;
; XREF[12]:
;   core_dcamera.cpp_CDemonCamera_lockAndRenderToBuffer_FUN_004511c0 at 004511ce
;   core_game.cpp_CGame_openSomething_FUN_004e2910 at 004e2ade
;   core_game.cpp_CGame_processFrame_FUN_004da100 at 004da42c
;   core_setedit.cpp_CDemonSet_ViewerVisitSet_FUN_0057a940 at 0057aae0
...
section .text
    ...
    CMP dword ptr [0x02d03e94],0x0      ; 005b7210 | int g_UseExternalRenderer
        ;   Label: wincore_windll.cpp_lockFrame_FUN_005b7210
    JNZ 0x005b721c                      ; 005b7217 | LAB_005b721c
        ;   XREF to: 005b721c (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 005b7219
        ;   Label: LAB_005b7219
    RET                                 ; 005b721b
        ;   Label: LAB_005b721b
    CALL dword ptr [0x03f6b8ac]         ; 005b721c | APIDLL_lockFrame * g_APIDLL_lockFrame
        ;   Label: LAB_005b721c
    TEST EAX,EAX                        ; 005b7222
    JZ 0x005b721b                       ; 005b7224 | LAB_005b721b
        ;   XREF to: 005b721b (CONDITIONAL_JUMP)
    MOV EAX,[0x0067939c]                ; 005b7226 | int g_BitsPerPixel
    MOV ECX,0x1                         ; 005b722b
    MOV [0x03f6b998],EAX                ; 005b7230 | int g_SavedBitsPerPixel
    MOV EAX,[0x03f6b990]                ; 005b7235 | int g_ExternalBitsPerPixel
    MOV dword ptr [0x03f6b99c],ECX      ; 005b723a | int g_ExternalFrameLocked
    MOV [0x0067939c],EAX                ; 005b7240 | int g_BitsPerPixel
