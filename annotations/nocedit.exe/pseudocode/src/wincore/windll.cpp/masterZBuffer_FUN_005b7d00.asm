...
section .text
    ...
    CMP dword ptr [0x02d03e94],0x0      ; 005b7d00 | int g_UseExternalRenderer
        ;   Label: wincore_windll.cpp_masterZBuffer_FUN_005b7d00
    JNZ 0x005b7d0c                      ; 005b7d07 | LAB_005b7d0c
    ...
    MOV ECX,dword ptr [ESP + 0x4]       ; 005b7d0c
        ;   Label: LAB_005b7d0c
    PUSH ECX                            ; 005b7d10
    CALL dword ptr [0x03f6b90c]         ; 005b7d11 | APIDLL_masterZBuffer * g_APIDLL_masterZBuffer
