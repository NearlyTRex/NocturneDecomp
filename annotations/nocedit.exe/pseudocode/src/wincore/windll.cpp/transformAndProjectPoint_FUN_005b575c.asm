...
section .text
    ...
    TEST dword ptr [0x02d05248],0xffffffff ; 005b575c | BOOL g_MMXSupported
        ;   Label: wincore_windll.cpp_transformAndProjectPoint_FUN_005b575c
    JZ 0x005b58aa                       ; 005b5766 | LAB_005b58aa
    ...
    SUB EAX,dword ptr [0x02d052b8]      ; 005b5778 | int g_RelativeX
    SUB ECX,dword ptr [0x02d052bc]      ; 005b577e | int g_RelativeY
    SUB EDX,dword ptr [0x02d052c0]      ; 005b5784 | int g_RelativeZ
    MOVD MM0,EAX                        ; 005b578a
    MOVD MM1,ECX                        ; 005b578d
    MOVD MM2,EDX                        ; 005b5790
    IMUL dword ptr [0x02d052e8]         ; 005b5793 | CMatrix3x3i g_TransformMatrix
    ...
    JNZ 0x005b58a4                      ; 005b586b | LAB_005b58a4
    ...
    IMUL dword ptr [0x02d02548]         ; 005b587c | int g_ViewportCenterXFixed
    IDIV ECX                            ; 005b5882
    ADD EAX,dword ptr [0x02d02550]      ; 005b5884 | int g_ViewportRightFixed
    MOV dword ptr [EBX + 0x10],EAX      ; 005b588a
    MOVD EAX,MM5                        ; 005b588d
    IMUL dword ptr [0x02d0254c]         ; 005b5890 | int g_ViewportCenterYFixed
    IDIV ECX                            ; 005b5896
    ADD EAX,dword ptr [0x02d02554]      ; 005b5898 | int g_ViewportBottomFixed
    ...
    SUB EAX,dword ptr [0x02d052b8]      ; 005b58bc | int g_RelativeX
    SUB EBX,dword ptr [0x02d052bc]      ; 005b58c2 | int g_RelativeY
    SUB ECX,dword ptr [0x02d052c0]      ; 005b58c8 | int g_RelativeZ
    MOV [0x00682668],EAX                ; 005b58ce | int g_TempX
    MOV dword ptr [0x0068266c],EBX      ; 005b58d3 | int g_TempY
    MOV dword ptr [0x00682670],ECX      ; 005b58d9 | int g_TempZ
    IMUL dword ptr [0x02d052e8]         ; 005b58df | CMatrix3x3i g_TransformMatrix
    MOV EBX,EAX                         ; 005b58e5
    MOV ECX,EDX                         ; 005b58e7
    MOV EAX,[0x0068266c]                ; 005b58e9 | int g_TempY
    IMUL dword ptr [0x02d052f4]         ; 005b58ee | g_TransformMatrix[1][0]
    ADD EBX,EAX                         ; 005b58f4
    ADC ECX,EDX                         ; 005b58f6
    MOV EAX,[0x00682670]                ; 005b58f8 | int g_TempZ
    ...
    MOV EAX,[0x00682678]                ; 005b59e2 | int g_TempTransformedX
    IMUL dword ptr [0x02d02548]         ; 005b59e7 | int g_ViewportCenterXFixed
    IDIV ECX                            ; 005b59ed
    ADD EAX,dword ptr [0x02d02550]      ; 005b59ef | int g_ViewportRightFixed
    MOV dword ptr [EDI + 0x10],EAX      ; 005b59f5
    MOV EAX,[0x0068267c]                ; 005b59f8 | int g_TempTransformedY
    IMUL dword ptr [0x02d0254c]         ; 005b59fd | int g_ViewportCenterYFixed
    IDIV ECX                            ; 005b5a03
    ADD EAX,dword ptr [0x02d02554]      ; 005b5a05 | int g_ViewportBottomFixed
    MOV dword ptr [EDI + 0x14],EAX      ; 005b5a0b
    POP EDI                             ; 005b5a0e
    POP ESI                             ; 005b5a0f
    RET                                 ; 005b5a10
    MOV EDX,dword ptr [0x00682678]      ; 005b5a11 | int g_TempTransformedX
        ;   Label: LAB_005b5a11
