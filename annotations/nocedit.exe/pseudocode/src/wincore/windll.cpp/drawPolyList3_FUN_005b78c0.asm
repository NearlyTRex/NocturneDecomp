...
;                               FUNCTION
; *****************************************************************************
; __cdecl int wincore_windll.cpp_drawPolyList3_FUN_005b78c0(void * vertex_buffer, void * polygons, int polygon_count, int render_flags)
;
; Parameters:
...
section .text
    ...
    CMP dword ptr [0x02d03e94],0x0      ; 005b78d3 | int g_UseExternalRenderer
    JZ 0x005b795d                       ; 005b78da | LAB_005b795d
        ;   XREF to: 005b795d (CONDITIONAL_JUMP)
    MOV EAX,[0x030e56b8]                ; 005b78e0 | int g_RenderedTriangleCount
    MOV ECX,dword ptr [0x03f6b8d8]      ; 005b78e5 | APIDLL_drawPolyList3 * g_APIDLL_drawPolyList3
    ADD EAX,EBP                         ; 005b78eb
    TEST ECX,ECX                        ; 005b78ed
    JNZ 0x005b7967                      ; 005b78ef | LAB_005b7967
        ;   XREF to: 005b7967 (CONDITIONAL_JUMP)
    MOV [0x030e56b8],EAX                ; 005b78f5 | int g_RenderedTriangleCount
    XOR ESI,ESI                         ; 005b78fa
    TEST EBP,EBP                        ; 005b78fc
    JLE 0x005b7950                      ; 005b78fe | LAB_005b7950
    ...
    CALL dword ptr [0x03f6b8cc]         ; 005b793e | APIDLL_drawPolygon2 * g_APIDLL_drawPolygon2
    ADD ESP,0xc                         ; 005b7944
    CMP ESI,EBP                         ; 005b7947
    JL 0x005b7900                       ; 005b7949 | LAB_005b7900
    ...
    PUSH EBX                            ; 005b796d
    PUSH EDI                            ; 005b796e
    MOV [0x030e56b8],EAX                ; 005b796f | int g_RenderedTriangleCount
    CALL dword ptr [0x03f6b8d8]         ; 005b7974 | APIDLL_drawPolyList3 * g_APIDLL_drawPolyList3
