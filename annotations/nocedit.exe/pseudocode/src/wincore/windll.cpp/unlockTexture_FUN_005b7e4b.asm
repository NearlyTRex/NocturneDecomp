...
section .text
    ...
    CMP dword ptr [0x03f6b92c],0x0      ; 005b7e50 | APIDLL_unlockTexture * g_APIDLL_unlockTexture
    JNZ 0x005b7e5c                      ; 005b7e57 | LAB_005b7e5c
        ;   XREF to: 005b7e5c (CONDITIONAL_JUMP)
    XOR EAX,EAX                         ; 005b7e59
    RET                                 ; 005b7e5b
    CALL dword ptr [0x03f6b92c]         ; 005b7e5c | APIDLL_unlockTexture * g_APIDLL_unlockTexture
        ;   Label: LAB_005b7e5c
    RET                                 ; 005b7e62
