...
;                               FUNCTION
; *****************************************************************************
; void __edi_esi_ebx wincore_windll_cpp_renderPerspectiveCorrectScanline32_FUN_005b50ec(SSoftwareEdge *left_vertex,SSoftwareEdge *right_vertex,int scanline_y)
;
;
; XREF[57]:
;   engine_3d.c_flushPremiumRenderBuffer_FUN_004070c0 at 00407136
;   engine_3d.c_renderPolygonAdaptiveDepthOp25_FUN_00404ae0 at 00404b24
;   engine_3d.c_renderPolygonAdaptiveFogTexturedOp52_FUN_00406430 at 00406543
;   engine_3d.c_renderPolygonAdaptivePlaneMaskedUVOp34_FUN_00404840 at 00404924
;   engine_3d.c_renderPolygonAlphaBlendedDepthWritePerspOp59_FUN_00406f20 at 00406f65
;   engine_3d.c_renderPolygonAlphaBlendedDepthWritePlaneMaskedOp58_FUN_00406de0 at 00406e25
;   engine_3d.c_renderPolygonAlphaBlendedPlaneMaskedOp36_FUN_00405690 at 00405743
;   engine_3d.c_renderPolygonAlphaBlendedPlaneMaskedPerspOp37_FUN_004057b0 at 00405863
;   engine_3d.c_renderPolygonAlphaTexturedNearPlane_FUN_00404e40 at 00404e6c
;   engine_3d.c_renderPolygonAlphaTexturedNormalized2_FUN_00405020 at 0040504c
;   ... and 47 more
;
; Referenced Globals:
...
section .text
    ...
    CMP dword ptr [0x02d052a4],0x5      ; 005b5144 | g_VertexPreprocessMode
    ...
    MOV dword ptr [0x00682610],EDX      ; 005b517e | g_HardwareDeltaTextureU
    ...
    MOV dword ptr [0x00682614],EDX      ; 005b51b5 | g_HardwareDeltaTextureV
    ...
    MOV dword ptr [0x00682610],EDX      ; 005b51d1 | g_HardwareDeltaTextureU
    ...
    MOV dword ptr [0x00682614],EDX      ; 005b51eb | g_HardwareDeltaTextureV
    ...
    MOV dword ptr [0x00682618],EDX      ; 005b5205 | g_HardwareDeltaDepthZ
    ...
    JNC 0x005b52d6                      ; 005b52bd
        ;   XREF to: 005b52d6 (CONDITIONAL_JUMP)  ; LAB_005b52d6
    ADD EBP,dword ptr [0x00682610]      ; 005b52bf | g_HardwareDeltaTextureU
    ADD EDX,dword ptr [0x00682614]      ; 005b52c5 | g_HardwareDeltaTextureV
    ADD ESI,dword ptr [0x00682618]      ; 005b52cb | g_HardwareDeltaDepthZ
    ...
    MOV dword ptr [0x00682618],EDX      ; 005b52f5 | g_HardwareDeltaDepthZ
    MOV EAX,[0x006821ec]                ; 005b52fb | g_StartDepthW
    MOV EBX,dword ptr [0x00682618]      ; 005b5300 | g_HardwareDeltaDepthZ
