...
;                               FUNCTION
; *****************************************************************************
; __cdecl int wincore_windll.cpp_transformPoint_FUN_005b5a25(SProjectedVertex * output, CVector3i * input)
;
; Parameters:
...
section .text
    ...
    TEST dword ptr [0x02d05248],0xffffffff ; 005b5a25 | BOOL g_MMXSupported
        ;   Label: wincore_windll.cpp_transformPoint_FUN_005b5a25
    JZ 0x005b5b73                       ; 005b5a2f | LAB_005b5b73
    ...
    SUB EAX,dword ptr [0x02d052c4]      ; 005b5a41 | int g_CameraOriginX
    SUB ECX,dword ptr [0x02d052c8]      ; 005b5a47 | int g_CameraOriginY
    SUB EDX,dword ptr [0x02d052cc]      ; 005b5a4d | int g_CameraOriginZ
    MOVD MM0,EAX                        ; 005b5a53
    MOVD MM1,ECX                        ; 005b5a56
    MOVD MM2,EDX                        ; 005b5a59
    IMUL dword ptr [0x02d052e8]         ; 005b5a5c | CMatrix3x3i g_TransformMatrix
    ...
    JNZ 0x005b5b6d                      ; 005b5b34 | LAB_005b5b6d
    ...
    IMUL dword ptr [0x02d02548]         ; 005b5b45 | int g_ViewportCenterXFixed
    IDIV ECX                            ; 005b5b4b
    ADD EAX,dword ptr [0x02d02550]      ; 005b5b4d | int g_ViewportRightFixed
    MOV dword ptr [EBX + 0x10],EAX      ; 005b5b53
    MOVD EAX,MM5                        ; 005b5b56
    IMUL dword ptr [0x02d0254c]         ; 005b5b59 | int g_ViewportCenterYFixed
    IDIV ECX                            ; 005b5b5f
    ADD EAX,dword ptr [0x02d02554]      ; 005b5b61 | int g_ViewportBottomFixed
    ...
    SUB EAX,dword ptr [0x02d052c4]      ; 005b5b85 | int g_CameraOriginX
    SUB EBX,dword ptr [0x02d052c8]      ; 005b5b8b | int g_CameraOriginY
    SUB ECX,dword ptr [0x02d052cc]      ; 005b5b91 | int g_CameraOriginZ
    MOV [0x00682668],EAX                ; 005b5b97 | int g_TempX
    MOV dword ptr [0x0068266c],EBX      ; 005b5b9c | int g_TempY
    MOV dword ptr [0x00682670],ECX      ; 005b5ba2 | int g_TempZ
    IMUL dword ptr [0x02d052e8]         ; 005b5ba8 | CMatrix3x3i g_TransformMatrix
    MOV EBX,EAX                         ; 005b5bae
    MOV ECX,EDX                         ; 005b5bb0
    MOV EAX,[0x0068266c]                ; 005b5bb2 | int g_TempY
    IMUL dword ptr [0x02d052f4]         ; 005b5bb7 | g_TransformMatrix[1][0]
    ADD EBX,EAX                         ; 005b5bbd
    ADC ECX,EDX                         ; 005b5bbf
    MOV EAX,[0x00682670]                ; 005b5bc1 | int g_TempZ
    ...
    MOV EAX,[0x00682678]                ; 005b5cab | int g_TempTransformedX
    IMUL dword ptr [0x02d02548]         ; 005b5cb0 | int g_ViewportCenterXFixed
    IDIV ECX                            ; 005b5cb6
    ADD EAX,dword ptr [0x02d02550]      ; 005b5cb8 | int g_ViewportRightFixed
    MOV dword ptr [EDI + 0x10],EAX      ; 005b5cbe
    MOV EAX,[0x0068267c]                ; 005b5cc1 | int g_TempTransformedY
    IMUL dword ptr [0x02d0254c]         ; 005b5cc6 | int g_ViewportCenterYFixed
    IDIV ECX                            ; 005b5ccc
    ADD EAX,dword ptr [0x02d02554]      ; 005b5cce | int g_ViewportBottomFixed
    MOV dword ptr [EDI + 0x14],EAX      ; 005b5cd4
    POP EDI                             ; 005b5cd7
    POP ESI                             ; 005b5cd8
    RET                                 ; 005b5cd9
    MOV EDX,dword ptr [0x00682678]      ; 005b5cda | int g_TempTransformedX
        ;   Label: LAB_005b5cda
