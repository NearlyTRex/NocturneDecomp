...
;                               FUNCTION
; *****************************************************************************
; __cdecl int wincore_windll.cpp_lockTexture_FUN_005b7e23(int texture_id)
;
; Parameters:
...
section .text
    ...
    NOP                                 ; 005b7e2f
    CMP dword ptr [0x03f6b928],0x0      ; 005b7e30 | APIDLL_lockTexture * g_APIDLL_lockTexture
    JNZ 0x005b7e3c                      ; 005b7e37 | LAB_005b7e3c
    ...
    MOV ECX,dword ptr [ESP + 0x4]       ; 005b7e3c
        ;   Label: LAB_005b7e3c
    PUSH ECX                            ; 005b7e40
    CALL dword ptr [0x03f6b928]         ; 005b7e41 | APIDLL_lockTexture * g_APIDLL_lockTexture
