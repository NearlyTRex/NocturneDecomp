...
;                               FUNCTION
; *****************************************************************************
; __cdecl int wincore_windll.cpp_switchRenderer_FUN_005b8140(char * new_dll_name, int renderer_handle)
;
; Parameters:
...
section .text
    ...
    PUSH EDI                            ; 005b8141
    CALL wincore_windll.cpp_kill_FUN_005b71e0 ; 005b8142 | int wincore_windll.cpp_kill_FUN_005b71e0()
        ;   XREF to: 005b71e0 (UNCONDITIONAL_CALL)
    MOV EAX,dword ptr [ESP + 0x10]      ; 005b8147
    MOV ESI,dword ptr [ESP + 0xc]       ; 005b814b
    MOV EDI,0x684010                    ; 005b814f | = "trid3d.dll" | g_RendererDllName = trid3d.dll
    MOV [0x03f6b87c],EAX                ; 005b8154 | int g_RendererHandle
    PUSH EDI                            ; 005b8159 | = "trid3d.dll" | g_RendererDllName = trid3d.dll
    MOV AL,byte ptr [ESI]               ; 005b815a
        ;   Label: LAB_005b815a
    MOV byte ptr [EDI],AL               ; 005b815c | = "trid3d.dll" | g_RendererDllName = trid3d.dll
    CMP AL,0x0                          ; 005b815e
    JZ 0x005b8172                       ; 005b8160 | LAB_005b8172
        ;   XREF to: 005b8172 (CONDITIONAL_JUMP)
    MOV AL,byte ptr [ESI + 0x1]         ; 005b8162
    ADD ESI,0x2                         ; 005b8165
    MOV byte ptr [EDI + 0x1],AL         ; 005b8168 | DAT_00684011
    ADD EDI,0x2                         ; 005b816b
    CMP AL,0x0                          ; 005b816e
    JNZ 0x005b815a                      ; 005b8170 | LAB_005b815a
        ;   XREF to: 005b815a (CONDITIONAL_JUMP)
    POP EDI                             ; 005b8172
        ;   Label: LAB_005b8172
    MOV EDX,dword ptr [0x03f6b98c]      ; 005b8173 | HWND g_StoredWindowHandle
    PUSH EDX                            ; 005b8179
    CALL wincore_windll.cpp_loadExternalRenderer_FUN_005b6750 ; 005b817a | int wincore_windll.cpp_loadExternalRenderer_FUN_005b6750(HWND window_handle)
