...
section .text
    ...
    CMP dword ptr [0x03f6b978],0x0      ; 005b7db1 | int g_ExternalRendererActive
    JNZ 0x005b7dbe                      ; 005b7db8 | LAB_005b7dbe
    ...
    PUSH EBP                            ; 005b7dd9
    CALL dword ptr [0x03f6b91c]         ; 005b7dda | APIDLL_buildCardList * g_APIDLL_buildCardList
