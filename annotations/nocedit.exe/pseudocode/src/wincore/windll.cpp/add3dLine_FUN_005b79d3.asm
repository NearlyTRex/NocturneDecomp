...
section .text
    ...
    NOP                                 ; 005b79df
    CMP dword ptr [0x02d03e94],0x0      ; 005b79e0 | int g_UseExternalRenderer
    JNZ 0x005b79ec                      ; 005b79e7 | LAB_005b79ec
    ...
    PUSH ESI                            ; 005b79fc
    CALL dword ptr [0x03f6b8e4]         ; 005b79fd | APIDLL_add3dLine * g_APIDLL_add3dLine
