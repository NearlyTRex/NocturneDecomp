...
section .text
    ...
    MOVZX EAX,byte ptr [ESI]            ; 005b5610
        ;   Label: LAB_005b5610
    MOVD MM0,dword ptr [EAX*0x4 + 0x2d01924] ; 005b5613 | uint[256] g_Hardware32BitPalette
    MOVZX EAX,byte ptr [EBX]            ; 005b561b
    IMUL EAX,EBP                        ; 005b561e
    CMP dword ptr [0x02d05298],0x1      ; 005b5621 | int g_BlendMode
    JZ 0x005b5640                       ; 005b5628 | LAB_005b5640
        ;   XREF to: 005b5640 (CONDITIONAL_JUMP)
    CMP EAX,0xfde8                      ; 005b562a
    JGE 0x005b56c3                      ; 005b562f | LAB_005b56c3
        ;   XREF to: 005b56c3 (CONDITIONAL_JUMP)
    CMP EAX,0xff                        ; 005b5635
    JLE 0x005b56ff                      ; 005b563a | LAB_005b56ff
        ;   XREF to: 005b56ff (CONDITIONAL_JUMP)
    SHR EAX,0x8                         ; 005b5640
        ;   Label: LAB_005b5640
    PUNPCKLBW MM0,MM7                   ; 005b5643
    MOVQ MM1,qword ptr [EAX*0x8 + 0x683000] ; 005b5646 | SAlphaEntry[256] g_AlphaTable
    ...
    PAND MM3,qword ptr [0x00682758]     ; 005b565e | uint g_BlueMask16
    PSLLQ MM3,qword ptr [0x006827e8]    ; 005b5665 | ulonglong g_BlueBitShift
    MOVD MM4,EAX                        ; 005b566c
    PAND MM4,qword ptr [0x00682750]     ; 005b566f | uint g_GreenMask16
    PSLLQ MM4,qword ptr [0x006827c8]    ; 005b5676 | ulonglong g_GreenBlueBits
    POR MM3,MM4                         ; 005b567d
    MOVD MM5,EAX                        ; 005b5680
    PAND MM5,qword ptr [0x00682748]     ; 005b5683 | uint g_RedMask16
    PSLLQ MM5,qword ptr [0x006827a8]    ; 005b568a | ulonglong g_TotalColorBits
    POR MM3,MM5                         ; 005b5691
    PUNPCKLBW MM3,MM7                   ; 005b5694
    CMP dword ptr [0x02d05298],0x1      ; 005b5697 | int g_BlendMode
    JZ 0x005b56b2                       ; 005b569e | LAB_005b56b2
    ...
    JMP 0x005b56c3                      ; 005b56b0 | LAB_005b56c3
    ...
    PAND MM0,qword ptr [0x006827a0]     ; 005b56c9 | ulonglong g_BlueMask32
    PAND MM2,qword ptr [0x00682780]     ; 005b56d0 | ulonglong g_GreenMask32
    PAND MM4,qword ptr [0x00682760]     ; 005b56d7 | ulonglong g_RedMask32
    PSRLQ MM0,qword ptr [0x006827e8]    ; 005b56de | ulonglong g_BlueBitShift
    PSRLQ MM2,qword ptr [0x006827c8]    ; 005b56e5 | ulonglong g_GreenBlueBits
    PSRLQ MM4,qword ptr [0x006827a8]    ; 005b56ec | ulonglong g_TotalColorBits
    ...
    DEC ECX                             ; 005b5704
    JG 0x005b5610                       ; 005b5705 | LAB_005b5610
