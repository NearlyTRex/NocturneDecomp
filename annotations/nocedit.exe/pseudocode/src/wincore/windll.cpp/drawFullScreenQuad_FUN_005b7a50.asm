...
;                               FUNCTION
; *****************************************************************************
; __cdecl int wincore_windll.cpp_drawFullScreenQuad_FUN_005b7a50(int color)
;
; Parameters:
...
section .text
    ...
    PUSH EAX                            ; 005b7a61
    CALL crt_memory.c_memset_FUN_005fde40 ; 005b7a62 | void * crt_memory.c_memset_FUN_005fde40(void * dest, int value, ulong count)
        ;   XREF to: 005fde40 (UNCONDITIONAL_CALL)
    MOV EAX,[0x02d02558]                ; 005b7a67 | int g_ClipLeft
    ADD ESP,0xc                         ; 005b7a6c
    SHL EAX,0x10                        ; 005b7a6f
    MOV dword ptr [ESP + 0x10],EAX      ; 005b7a72
    MOV EAX,[0x02d0255c]                ; 005b7a76 | int g_ClipTop
    SHL EAX,0x10                        ; 005b7a7b
    MOV dword ptr [ESP + 0x14],EAX      ; 005b7a7e
    MOV EAX,[0x02d02560]                ; 005b7a82 | int g_ClipRight
    ...
    MOV EAX,[0x02d02564]                ; 005b7a9e | int g_ClipBottom
    ...
    MOV EAX,[0x0068411c]                ; 005b7ac0 | int g_SystemMemorySize
    PUSH 0x10                           ; 005b7ac5
    ...
    PUSH 0x4                            ; 005b7ae1
    MOV [0x02d02570],EAX                ; 005b7ae3 | int g_ActiveRenderColor
    LEA EAX,[ESP + 0x8]                 ; 005b7ae8
    PUSH EAX                            ; 005b7aec
    CALL wincore_windll.cpp_drawPolygon_FUN_005b75e0 ; 005b7aed | int wincore_windll.cpp_drawPolygon_FUN_005b75e0(SRenderVertex * vertices, int vertex_count, int render_flags)
