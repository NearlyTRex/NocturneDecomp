...
// Convention: __cdecl
// Signature: void __cdecl wincore_windll_cpp_renderPerspectiveCorrectScanline16_FUN_005b5322(SSoftwareEdge *left_vertex,SSoftwareEdge *right_vertex,int scanline_y)
