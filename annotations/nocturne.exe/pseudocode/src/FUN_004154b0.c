...
// Convention: unknown
// Signature: void FUN_004154b0(int param_1,float param_2)
...

{
  ...
  *(uint *)(param_1 + 0x23a4) = *(uint *)(param_1 + 0x23a8);
  ...
  iVar3 = param_1 + 0x150;
  while (0.0 < local_40) {
    uVar5 = FUN_004e11c0(iVar3,&local_40);
