...
// Convention: unknown
// Signature: void FUN_0042f600(int param_1,int param_2,int param_3,int param_4,undefined4 param_5)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_0042f600(int param_1,int param_2,int param_3,int param_4,uint param_5)

{
  ...
  if ((_DAT_005ad280 != 0) ||
    ...
    FUN_00430140(param_1,param_2,param_5,0x3b800000);
    ...
    if (uStack_14 != 0) {
      if (uStack_18 == 0) {
        do {
          param_2 = param_2 + 1;
          FUN_00430140(param_1,param_2,param_5);
      ...
      if (uStack_18 != uStack_14) {
        ...
        FUN_00430140(param_3,param_4,param_5);
        return;
      }
      do {
        param_2 = param_2 + 1;
