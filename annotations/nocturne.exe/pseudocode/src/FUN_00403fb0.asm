...
;                               FUNCTION
; *****************************************************************************
; uint FUN_00403fb0(undefined1 *param_1,int param_2,undefined4 param_3,undefined4 param_4,undefined4 param_5)
;
; Local Variables:
...
section .text
    ...
    MOV byte ptr [ESI],0x0              ; 00404068
        ;   Label: LAB_00404068
    CALL FUN_00553910                   ; 0040406b
        ;   XREF to: 00553910 (UNCONDITIONAL_CALL)  ; undefined FUN_00553910()
        ;   Label: LAB_0040406b
    CALL FUN_00403f50                   ; 00404070
        ;   XREF to: 00403f50 (UNCONDITIONAL_CALL)  ; undefined FUN_00403f50()
