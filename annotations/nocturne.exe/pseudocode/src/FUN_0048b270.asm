...
;
; XREF[3]:
;   FUN_004785a0 at 00478757
;   FUN_00484b60 at 00484b8e
;   FUN_004c4970 at 004c4d88
;
; Referenced Globals:
...
section .text
    ...
    CALL FUN_00526ea0                   ; 0048b2f4
        ;   XREF to: 00526ea0 (UNCONDITIONAL_CALL)  ; undefined FUN_00526ea0()
    ADD ESP,0x8                         ; 0048b2f9
    LEA EAX,[EBX + 0xc]                 ; 0048b2fc
    PUSH EAX                            ; 0048b2ff
    MOV ECX,dword ptr [EBX + 0x58]      ; 0048b300
    PUSH ECX                            ; 0048b303
    CALL FUN_00526ff0                   ; 0048b304
        ;   XREF to: 00526ff0 (UNCONDITIONAL_CALL)  ; undefined FUN_00526ff0()
