...
section .text
    ...
    FMUL float ptr [0x0059bde4]         ; 0044810b | DAT_0059bde4
    FSTP float ptr [EBX]                ; 00448111
    FILD dword ptr [EAX + 0x4]          ; 00448113
    FMUL float ptr [0x0059bde4]         ; 00448116 | DAT_0059bde4
    FSTP float ptr [EBX + 0x4]          ; 0044811c
    FILD dword ptr [EAX + 0x8]          ; 0044811f
    FMUL float ptr [0x0059bde4]         ; 00448122 | DAT_0059bde4
