...
// Convention: unknown
// Signature: void FUN_00414930(int param_1,int param_2)
...

{
  ...
  FUN_00527230(*(uint *)(param_1 + 0xbddc));
  FUN_00527230(*(uint *)(param_1 + 0xbdd4));
  ...
  if (fVar1 <= 0.0) {
    *(uint *)(param_1 + 0x2434) = 0;
    ...
    if ((*(int *)(iVar3 + 0x24) != 7) && (*(int *)(iVar3 + 0x24) != 8)) {
      ...
      FUN_00527230(*(uint *)(param_1 + 0xbdd8));
    ...
    iVar4 = FUN_00526c50(*(uint *)(param_1 + 0xbdd8));
    if (iVar4 == 0) {
