...
section .text
    ...
    CALL FUN_00549280                   ; 004e9940
        ;   XREF to: 00549280 (UNCONDITIONAL_CALL)  ; undefined FUN_00549280()
    PUSH 0x58baa4                       ; 004e9945 | = "USERNAME"
    CALL FUN_00566e10                   ; 004e994a
