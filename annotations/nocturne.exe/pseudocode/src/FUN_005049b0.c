...
// Convention: unknown
// Signature: float FUN_005049b0(int param_1,undefined4 param_2,undefined4 param_3,char *param_4)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

float FUN_005049b0(int param_1,uint param_2,uint param_3,char *param_4)

{
  ...
  if (*(float *)(param_1 + 0x44c) < 0.0) {
    iVar2 = FUN_00566b5c(param_3,&DAT_0058fa9a,&local_28);
    if (iVar2 != 1) {
      local_28 = (float)FUN_0052ebc0(0x02DC9450,param_3);
      local_14 = local_28;
      if (local_28 < 0.0) {
        FUN_00473cb0(0x1e56c30,param_3);
        uVar4 = 0xffffffff;
        pcVar5 = param_4;
        do {
          if (uVar4 == 0) break;
  ...
  iVar2 = FUN_004fe180(param_2,DAT_00765a98,&DAT_00765a60);
  *(int *)(param_1 + 4) = iVar2;
  if (iVar2 == 0) {
    if (_DAT_01e56c2c != 0) {
      return 0.0;
  ...
  *(int *)(param_1 + 8) = iVar2;
  ...
  if (_DAT_01e56418 == 0) {
    ...
    if (local_18 != 0) {
      FUN_00526340();
      FUN_005261b0(2);
      uVar3 = FUN_0052ea40(0x02DC9450,param_1,param_3);
