...
// Convention: unknown
// Signature: void FUN_00550cb0(int *param_1,int param_2)
...

{
  ...
  if ((param_1[1] & 0x7fffffffU) != 0) {
    ...
    FUN_00461eb0(DAT_005ae704,&DAT_005c11f4 + _DAT_02dd1230 * 0x18);
    _DAT_01c038f4 = 0;
    _DAT_02dd9260 =
    ...
    if (0 < _DAT_02dd1234) {
      ...
      do {
        ...
        local_14 = iVar2;
        FUN_00460a00(DAT_005ae704,&local_6c);
        local_30 = local_6c;
        local_2c = local_68;
        local_28 = local_64;
        local_6c = 0.0;
        ...
        FUN_0050be20(0x01E57284,&local_6c,&local_30,0);
        ...
        FUN_0050be20(0x01E57284,&local_6c,&local_30,1);
        ...
        FUN_0053075c(*DAT_005ae704 + 0x60,&local_48);
        FUN_0050be20(0x01E57284,&local_6c,&local_30,2);
        local_6c = 0.0;
        if (*param_1 != 0) {
          fVar3 = (float10)fsin((float10)(iVar2 + 1) * (float10)_DAT_0059759f *
        ...
        FUN_0050be20(0x01E57284,&local_6c,&local_30,3);
        if (*param_1 == 0) {
          if (_DAT_01c02594 == 0) {
            if (param_2 == 0) {
              FUN_0045f9d0(DAT_005ae704,&DAT_005c1374);
            }
            else {
              FUN_0045f790(DAT_005ae704,&DAT_005c1374);
            }
          }
          else {
            FUN_00460f10(DAT_005ae704,1);
            FUN_0045eee0(DAT_005ae704,&DAT_005c1374);
          }
        }
        else {
          FUN_00461010(DAT_005ae704,0xa000);
          FUN_00460370(DAT_005ae704,&DAT_005c1374);
        }
        local_18 = local_18 + 4;
        local_1c = local_1c + 1;
