...
// Convention: unknown
// Signature: void FUN_004e48a0(undefined4 param_1,int param_2,int param_3,int param_4,int param_5)

#include "nocturne.h"

void FUN_004e48a0(uint param_1,int param_2,int param_3,int param_4,int param_5)

{
  ...
  if ((*(int *)(iVar2 + 0x10) != 0) && (*(int *)(iVar2 + 0x14) == 2)) {
      ...
      do {
        ...
        if (local_1c < *(int *)(&DAT_005bc070 + local_34)) {
          ...
          do {
            ...
            do {
              puVar4 = puVar7 + 0xd;
              uVar1 = FUN_004e2cf0(param_1,*(uint *)
    ...
    do {
      puVar4 = puVar7 + 1;
      uVar1 = FUN_004e2cf0(param_1,*(uint *)(&DAT_005bc078 + *(int *)(iVar2 + 0xc) * 4));
      *puVar7 = uVar1;
      puVar7 = puVar4;
    ...
    do {
      ...
      do {
        iVar5 = iVar6 + 0x34;
        uVar1 = FUN_004e2cf0(param_1,*(uint *)(&DAT_005bc0b8 + *(int *)(iVar2 + 0xc) * 4));
        *(uint *)(iVar6 + 0x5c) = uVar1;
        iVar6 = iVar5;
