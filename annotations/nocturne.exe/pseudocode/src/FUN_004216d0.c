...
// Convention: unknown
// Signature: void FUN_004216d0(int param_1)
...

{
  ...
  do {
    ...
    do {
      ...
      iStack_34 = (int)ROUND(((float)iVar3 * _DAT_0059aea8 + *(float *)(param_1 + 0x19858)) *
                             _DAT_0059ae90);
      iStack_18 = iVar3;
      FUN_0053075c(*DAT_005ae704 + iStack_1c,&iStack_3c);
      iVar5 = iVar5 + 4;
  ...
  FUN_00460f10(DAT_005ae704,0xffffffff);
  iStack_24 = 0xc;
  do {
    iStack_20 = iStack_24;
    iVar4 = 1;
    ...
    do {
      ...
      FUN_004610a0(DAT_005ae704,iStack_30,iVar5);
      iVar5 = iVar5 + 1;
      iVar4 = iVar4 + 1;
      FUN_004610a0(DAT_005ae704,iStack_30,iVar3);
      iVar3 = iVar3 + 1;
    } while (iVar4 < 0xc);
