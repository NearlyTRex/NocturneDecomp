...
// Convention: unknown
// Signature: void FUN_004f2e60(int param_1,int param_2,int param_3,int param_4)
...

{
  ...
  if ((((param_3 == 0) ||
    ...
    pfVar2 = (float *)FUN_0044daa0(param_1 + 0x3c,auStack_40,&fStack_70);
    if (&fStack_7c != pfVar2) {
      fStack_7c = *pfVar2;
      fStack_78 = pfVar2[1];
      fStack_74 = pfVar2[2];
    ...
    if (((((*pfVar2 <= fStack_7c) && (pfVar2[1] <= fStack_78)) && (pfVar2[2] <= fStack_74)) &&
      ...
      if (0 < iStack_20) {
        ...
        while( true ) {
          ...
          pfVar2 = (float *)FUN_0044da40(iStack_28,auStack_64,&fStack_a0);
          if (&fStack_a0 != pfVar2) {
            fStack_a0 = *pfVar2;
            fStack_9c = pfVar2[1];
            fStack_98 = pfVar2[2];
        ...
        FUN_004b0200(0x01C78C7C,&fStack_a0,0,200,0);
        return;
      }
    }
  }
