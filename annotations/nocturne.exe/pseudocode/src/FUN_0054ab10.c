...
// Convention: unknown
// Signature: undefined4 FUN_0054ab10(int param_1)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_0054ab10(int param_1)

{
  ...
  FUN_0040a240(param_1,&fStack_a4,uVar1);
  uStack_60 = *(uint *)(param_1 + 0x2e0);
  uStack_68 = 0;
  uStack_64 = 0;
  FUN_0040a200(param_1,&fStack_38,&uStack_68);
  ...
  iStack_24 = 0;
  do {
    fStack_18 = (float)FUN_0050fb00(0x01E57284,&fStack_74,&fStack_98);
    ...
    iVar4 = FUN_0040d890(*(uint *)(0x01E57284 + 0x14cd5c),_DAT_01c7068c);
    if (iVar2 == 0) {
      if (iStack_20 == 0) {
        if (iVar3 != 0) {
          FUN_00548580(iVar3);
      ...
      fStack_18 = fStack_dc;
      puVar5 = (uint *)FUN_0040a290(iVar2,auStack_80,0x01E57284 + 0x14cd50);
      if (&uStack_c4 != puVar5) {
        uStack_c4 = *puVar5;
        uStack_c0 = puVar5[1];
        uStack_bc = puVar5[2];
...
LAB_0054aea2:
  ...
  FUN_0048af20(0x01C08D04,&fStack_44,param_1 + 0x3c);
