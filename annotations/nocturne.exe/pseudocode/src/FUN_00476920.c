...
// Convention: unknown
// Signature: void FUN_00476920(int *param_1)
...

{
  ...
  if (param_1 != _DAT_01bcde24) {
    ...
    _DAT_01bcde2c = FUN_00558a30();
    _DAT_01bcde30 = 0x48000;
    FUN_00476920(param_1);
    return;
  }
  if ((DAT_01bd1d94 & 1) == 0) {
  ...
  if (_DAT_01bcde28 != 0) {
    ...
    FUN_00558d60(_DAT_01bcde34,_DAT_01bcde38);
    goto LAB_004769e3;
  }
  if (param_1[4] == 0) {
