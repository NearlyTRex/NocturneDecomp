...
section .text
    ...
    PUSH EAX                            ; 004caf7a
    CALL FUN_00526e10                   ; 004caf7b
        ;   XREF to: 00526e10 (UNCONDITIONAL_CALL)  ; undefined FUN_00526e10()
    ADD ESP,0x1c                        ; 004caf80
    MOV EDX,dword ptr [ESI]             ; 004caf83
    PUSH dword ptr [ESP]                ; 004caf85
    PUSH EDX                            ; 004caf88
    CALL FUN_005270d0                   ; 004caf89
