...
// Convention: unknown
// Signature: void FUN_00427ab0(int param_1,undefined4 param_2,undefined4 param_3)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_00427ab0(int param_1,uint param_2,uint param_3)

{
  ...
  FUN_0040a240(param_1,auStack_1c,&fStack_28);
  FUN_0048c0d0(0x01C08D04,auStack_1c,0x40000000,0x44bb8000,0x40800000);
  FUN_00427b60(param_1,param_2,param_3,0);
  return;
}
