...
// Convention: unknown
// Signature: void FUN_004874d0(int *param_1)
...

{
  ...
  if (0.0 < (float)param_1[0xf7]) {
    ...
    if (0.0 < fVar2 - local_c) {
      ...
      iVar3 = FUN_00454530(param_1 + 1);
      local_28 = local_28 + *(float *)(iVar3 + 0x34c);
      pfVar4 = (float *)FUN_0044da40(param_1 + 0x66,local_18,&local_30);
      ...
      FUN_0048ae90(0x01C08D04,&local_30,0,0x20000,0x10000,0,0xffff);
      return;
    }
    if (*param_1 == 0) {
      FUN_0048c0d0(0x01C08D04,pfVar1,0x41800000,0x42c80000,0x40800000);
      FUN_00527230(param_1[0xf8]);
      return;
    }
  }
  return;
