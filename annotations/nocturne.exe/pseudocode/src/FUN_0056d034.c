...
// Convention: unknown
// Signature: uint FUN_0056d034(int param_1)
...

{
  ...
  uVar1 = FUN_0056cfd8(&DAT_005c1dc0,&DAT_005c1de4,*(uint *)(param_1 + 0x14));
  if (uVar1 == 0) {
  ...
  iVar2 = FUN_0056cea0(*(int *)(param_1 + 0x14) + 0x76c);
  iVar6 = iVar4 * 2;
  if (iVar2 == 0) {
  ...
  if (puVar7[8] == 0) {
    if ((int)puVar7[4] < iVar4) {
      ...
      iVar2 = *(int *)(param_1 + 0xc) - ((*(int *)(param_1 + 0x18) + 7) - puVar7[6]) % 7;
      iVar5 = (*(int *)(param_1 + 0xc) + -1) - ((*(int *)(param_1 + 0x18) + 6) - puVar7[6]) % 7;
      if (puVar7[3] == 5) {
        iVar3 = iVar6 + -7;
        if ((iVar3 < iVar2) && (uVar8 = 1, iVar5 <= iVar3)) {
LAB_0056d1d5:
          iVar2 = FUN_0056d308(param_1,puVar7);
          uVar8 = (uint)(iVar2 == 0);
        }
      }
      else {
    ...
    if ((local_14 <= *(int *)(param_1 + 0x1c)) && (uVar8 = 1, *(int *)(param_1 + 0x1c) == local_14))
    goto LAB_0056d1d5;
  }
  if (uVar8 == 0) {
    if (uVar1 != 0) {
  ...
  if (puVar9[8] == 0) {
    if ((int)puVar9[4] < iVar4) {
      ...
      iVar2 = *(int *)(param_1 + 0xc) - ((*(int *)(param_1 + 0x18) + 7) - puVar9[6]) % 7;
      uVar8 = 0;
      iVar4 = (*(int *)(param_1 + 0xc) + -1) - ((*(int *)(param_1 + 0x18) + 6) - puVar9[6]) % 7;
      if (puVar9[3] == 5) {
        iVar6 = iVar6 + -7;
        if (iVar6 < iVar2) {
          if (iVar4 <= iVar6) {
LAB_0056d2e3:
            uVar8 = FUN_0056d308(param_1,puVar9);
          }
        }
        else {
          uVar8 = 1;
    ...
    iVar4 = puVar9[7];
    if (puVar9[8] == 1) {
      iVar6 = FUN_0056cea0(*(int *)(param_1 + 0x14) + 0x76c);
      if ((iVar6 != 0) && (0x003B001F >> 0x10 < iVar4)) {
        iVar4 = iVar4 + 1;
      }
      iVar4 = iVar4 + -1;
    }
    if ((iVar4 <= *(int *)(param_1 + 0x1c)) && (uVar8 = 0, iVar4 == *(int *)(param_1 + 0x1c)))
    goto LAB_0056d2e3;
  }
  if (uVar1 != 0) {
    uVar8 = uVar1 - uVar8;
