...
// Convention: unknown
// Signature: void FUN_0051cfd0(int param_1,undefined4 param_2,float param_3,undefined4 param_4,code *param_5)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_0051cfd0(int param_1,uint param_2,float param_3,uint param_4,code *param_5)

{
  ...
  if ((float)_DAT_00591bbb < param_3) {
    iVar2 = 0;
    local_1c = FUN_0051e0a0(param_1);
    if (0 < *(int *)(local_1c + 0x28558)) {
      local_18 = param_1;
      iVar3 = param_1 + 0x6b0;
      do {
        iVar1 = FUN_00517b10(local_1c,iVar2,param_4);
        if (-1 < iVar1) {
          uStack_14 = (*param_5)(iVar2,param_4,param_3,iVar1,param_1);
          FUN_0055d2d0(iVar3,param_2,uStack_14);
