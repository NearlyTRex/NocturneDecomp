...
// Convention: unknown
// Signature: void FUN_00461ad0(int param_1,int param_2,undefined4 param_3)

#include "nocturne.h"

void FUN_00461ad0(int param_1,int param_2,uint param_3)

{
  ...
  FUN_00461bd0(param_1,&local_24,param_3);
  if (*(int *)(param_2 + 4) < 4) {
    return;
  }
