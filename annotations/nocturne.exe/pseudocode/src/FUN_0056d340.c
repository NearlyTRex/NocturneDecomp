...
// Convention: unknown
// Signature: undefined4 * FUN_0056d340(int param_1,uint param_2,int param_3,undefined4 *param_4)

#include "nocturne.h"

uint * FUN_0056d340(int param_1,uint param_2,int param_3,uint *param_4)

{
  ...
  *param_4 = (int)(uVar1 % 0x3c);
  ...
  iVar3 = FUN_0056cea0(uVar2 + 0x76c);
