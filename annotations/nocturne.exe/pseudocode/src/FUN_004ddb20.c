...
// Convention: unknown
// Signature: void FUN_004ddb20(int param_1,float param_2)
...

{
  ...
  *(uint *)(param_1 + 0x23a4) = *(uint *)(param_1 + 0x23a8);
  ...
  while (iVar3 = 0x01C775EC, 0.0 < local_1b14) {
    uVar4 = FUN_004e11c0(param_1 + 0x150,&local_1b14);
  ...
  if (*(int *)(param_1 + 0x2590) == 0) {
    ...
    *(float *)(param_1 + 0x2414) = *(float *)(param_1 + 0x2418);
    ...
    if (*(int *)(param_1 + 0x2594) == 0) {
      uVar4 = FUN_0040a290(param_1,local_5c,*(int *)(param_1 + 0x2590) + 0x20);
      iVar3 = FUN_0054e4a0(local_50,uVar4);
    ...
    uVar4 = FUN_0051d380(param_1 + 0x150,local_44,0);
...
LAB_004ddd8e:
  ...
  if (*(int *)(param_1 + 0x21cf4) == 0) {
    if (*(int *)(param_1 + 0x21cf0) == 0) {
      iVar3 = FUN_0047dc30(0x01C03A10,param_1 + 0x21d60);
      if (iVar3 != 0) {
        FUN_004de700(param_1);
        return;
      }
      ...
      iVar3 = FUN_0047dc30(0x01C03A10,param_1 + 0x21cfc);
      if (iVar3 != 0) {
        FUN_004de700(param_1);
        return;
      }
    ...
    uVar4 = FUN_004e1660(param_1 + 0x150);
    FUN_004e1960(param_1 + 0x1fa3c,uVar4,*(uint *)(param_1 + 0x158));
    FUN_0051b880(param_1 + 0x1fa3c);
    ...
    *(float *)(param_1 + 0x21cf8) = param_2;
    if (_DAT_005a0ab8 < param_2) {
      ...
      *(uint *)(param_1 + 0x21cf8) = 0;
      FUN_0051ed90(iVar3,auStack_1b10);
      local_14 = (float)FUN_004e1660(iVar3);
      iVar1 = param_1 + 0x150;
      uStack_24 = *(uint *)(param_1 + 0x1fa44);
      FUN_0051e0c0(iVar1,pcVar5);
      FUN_0051dcd0(iVar1);
      FUN_004e1960(iVar1,local_14,uStack_24);
      FUN_0051e0c0(iVar3,pcStack_20);
      FUN_0051dcd0(iVar3);
      param_1 = param_1 + 0x21dc4;
      FUN_004e0170(param_1,0,iVar1);
      FUN_004e0170(param_1,1,iVar3);
      FUN_004e03c0(param_1);
      return;
    }
  }
  return;
