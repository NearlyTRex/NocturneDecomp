...
section .text
    ...
    PUSH EDI                            ; 004b3e3a
    PUSH EBX                            ; 004b3e3b
    CALL FUN_004b3f40                   ; 004b3e3c
        ;   XREF to: 004b3f40 (UNCONDITIONAL_CALL)  ; undefined FUN_004b3f40()
