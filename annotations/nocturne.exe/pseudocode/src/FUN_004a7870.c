...
// Convention: unknown
// Signature: void FUN_004a7870(int param_1,float param_2)
  ...
  *(float *)(param_1 + 0x2430) = param_2 * fVar2 * *(float *)(param_1 + 0xbc8c);
  ...
  if (iVar6 == 0) {
    ...
    case 0:
      ...
      iVar5 = FUN_004a7710(param_1);
      if (iVar5 == 0) {
        local_14 = (float)FUN_0040dda0(0,0x3f800000);
        *(float *)(param_1 + 0xbd7c) = local_14;
        FUN_004e16b0(iVar3,5,1);
        iVar3 = FUN_00526c50(*(uint *)(param_1 + 0xbd68));
        if (iVar3 == 0) {
        ...
        if (*(int *)(param_1 + 0xbd78) == 0) {
          ...
          if (local_1c < 0x40400000) {
            FUN_0054e4a0(local_68,&local_a4);
            local_14 = (float)FUN_0040df00(local_64 - *(float *)(param_1 + 0x34));
            if (ABS(local_14) < (float)_DAT_00584a00) {
        ...
        *(float *)(param_1 + 0xbd7c) = local_14;
        ...
        if (iVar5 == 0) {
            ...
            *(uint *)(param_1 + 0x23a4) = *(uint *)(param_1 + 0x23a8);
            ...
            if (-1 < iVar6) {
              ...
              if ((local_24 <= local_20) && (*(float *)(param_1 + 0xbca0) <= 0.0)) {
                ...
                FUN_0054e4a0(local_c8,&local_50);
                local_14 = (float)FUN_0040df00(local_c4 - *(float *)(param_1 + 0x34));
                if (ABS(local_14) < (float)_DAT_00584a00) {
          ...
          *(uint *)(param_1 + 0x23a4) = *(uint *)(param_1 + 0x23a8);
          ...
          FUN_004247f0(param_1,*(int *)(param_1 + 0xbd60) + 0x20,uVar4);
        }
      }
      break;
    case 3:
      FUN_00423ed0(local_104);
      local_100 = (float)FUN_0040dda0(0x40400000,0x40a00000);
      local_d0 = param_1;
      local_cc = param_1;
      local_14 = local_100;
      uVar4 = FUN_0055a8b0(local_8c,&DAT_02dd1184,_DAT_01c78b20 * 0x30 + param_1 + 0xfd0,0x3ecccccd,
                           local_104);
      uVar4 = FUN_0040a240(param_1,local_bc,uVar4);
      FUN_004798e0(param_1,uVar4);
      break;
    case 5:
      (**(code **)(*(int *)(param_1 + 0x14c) + 0x13c))(param_1,param_2);
      iVar5 = FUN_004a7710(param_1);
...
switchD_004a818f_caseD_4:
  ...
  if (iVar3 != 0) {
    *(float *)(param_1 + 0x2424) = *(float *)(param_1 + 0x2424) - param_2 * (float)_DAT_00584a08;
