...
// Convention: unknown
// Signature: void FUN_00448bf0(float param_1)
  ...
  if (0 < (int)_DAT_014b879c) {
    ...
    do {
      ...
      case 0:
        ...
        break;
      case 1:
        FUN_004484c0(&DAT_014b87a0 + uVar2 * 0xc,puVar4,&DAT_014b8864 + _DAT_014b8860 * 0xc,0,0,0,0,
      ...
      case 2:
        ...
        FUN_004484c0(puVar4,&DAT_014b87a0 + uVar2 * 0xc,&DAT_014b8864 + _DAT_014b8860 * 0xc,0,0,0,0,
                     0,0xbff00000,(double)param_1);
        break;
      default:
