...
section .text
    ...
    PUSH EBX                            ; 00473a17
    CALL wincore_windll.cpp_transformAndProjectPoint_FUN_0053075c ; 00473a18
    ...
    PUSH ECX                            ; 00473a45
    CALL FUN_004737a0                   ; 00473a46
        ;   XREF to: 004737a0 (UNCONDITIONAL_CALL)  ; undefined FUN_004737a0()
