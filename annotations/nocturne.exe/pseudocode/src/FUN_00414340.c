...
// Convention: unknown
// Signature: int FUN_00414340(int param_1)
...

{
  ...
  if (((*(int *)(param_1 + 0xbdc0) != 2) &&
      (((iVar2 = FUN_00461090(DAT_005ae704), iVar2 == 0 || (*(int *)(param_1 + 0xbdc0) == 0)) &&
       (iVar1 == 0)))) && (*(int *)(param_1 + 0x2404) == 0)) {
    FUN_00409f20(param_1);
    uVar3 = (**(code **)(*(int *)(param_1 + 0x14c) + 0x14))(param_1,local_2c,0);
    iVar1 = FUN_0041ceb0(uVar3);
    if (iVar1 != 0) {
      *(uint *)(param_1 + 0x2618) = 1;
      if (*(int *)(param_1 + 0xbdc0) == 0) {
        ...
        if (*(int *)(param_1 + 0xbdc0) == 1) {
          ...
          fStack_30 = ((float)_DAT_00578c9f - *(float *)(param_1 + 0xbdc4)) / 0x3F800000;
          if (fStack_30 < 0.0) {
            fStack_30 = 0.0;
          }
        }
        if (0.0 < (double)fStack_30) {
          ...
          FUN_00461020(DAT_005ae704,fStack_30);
          FUN_004619f0(DAT_005ae704,1);
          if ((double)fStack_30 <= _DAT_00578c9f) {
            uVar3 = 0x267;
          }
          else {
            uVar3 = 0x2e7;
          }
          FUN_0051d9d0(param_1 + 0x150,0xffffffff,uVar3,1,0);
