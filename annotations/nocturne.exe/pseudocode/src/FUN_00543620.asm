...
section .text
    ...
    POP EBX                             ; 005436bf
    RET                                 ; 005436c0
    PUSH 0x5a2e80                       ; 005436c1 | DAT_005a2e80
        ;   Label: LAB_005436c1
    PUSH EBX                            ; 005436c6
    CALL FUN_0056445f                   ; 005436c7
        ;   XREF to: 0056445f (UNCONDITIONAL_CALL)  ; undefined FUN_0056445f()
    ADD ESP,0x8                         ; 005436cc
    PUSH EAX                            ; 005436cf
    CALL FUN_00564486                   ; 005436d0
