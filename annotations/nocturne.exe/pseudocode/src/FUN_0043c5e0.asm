...
section .text
    ...
    PUSH EDI                            ; 0043c5eb
    PUSH EBX                            ; 0043c5ec
    CALL FUN_0043c360                   ; 0043c5ed
        ;   XREF to: 0043c360 (UNCONDITIONAL_CALL)  ; undefined FUN_0043c360()
