...
// Convention: unknown
// Signature: void FUN_00480d60(int param_1)
...

{
  ...
  if (0 < *(int *)(param_1 + 0x3ac8)) {
    ...
    do {
      uVar6 = FUN_00526d10(*puVar2,1);
      *(ulonglong *)(puVar2 + 0x46) = uVar6;
      local_20 = uVar6;
      if (0.0 <= *(double *)(puVar2 + 0x46)) {
        FUN_00525b70(local_148);
        iVar3 = FUN_00526cd0(*puVar2,local_148);
...
LAB_00480de0:
        ...
        *(int *)(param_1 + 0x3ac8) = iVar3;
        FUN_00566170(puVar2,local_18,(iVar3 - local_14) * 0x120);
      }
