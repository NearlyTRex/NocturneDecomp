...
section .text
    ...
    PUSH -0x1                           ; 0043d0e6
        ;   Label: LAB_0043d0e6
    PUSH EBX                            ; 0043d0e8
    CALL FUN_0043d810                   ; 0043d0e9
        ;   XREF to: 0043d810 (UNCONDITIONAL_CALL)  ; undefined FUN_0043d810()
