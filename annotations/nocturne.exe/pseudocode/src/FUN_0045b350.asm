...
section .text
    ...
    PUSH 0x59c580                       ; 0045b3e1 | DAT_0059c580
        ;   Label: LAB_0045b3e1
    PUSH EBX                            ; 0045b3e6
    CALL FUN_0056445f                   ; 0045b3e7
        ;   XREF to: 0056445f (UNCONDITIONAL_CALL)  ; undefined FUN_0056445f()
    ADD ESP,0x8                         ; 0045b3ec
    PUSH EAX                            ; 0045b3ef
    CALL FUN_00564486                   ; 0045b3f0
