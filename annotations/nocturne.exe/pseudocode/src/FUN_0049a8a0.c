...
// Convention: unknown
// Signature: void FUN_0049a8a0(int param_1)
...

{
  ...
  *(int *)(param_1 + 0x25c) = iVar1;
  ...
  iVar1 = _DAT_01c78acc;
  fVar3 = (float10)*(int *)(param_1 + 0x260) * (float10)*(float *)(param_1 + 0x1ec);
  FUN_00563a30();
  *(int *)(param_1 + 0x260) = (int)ROUND(fVar3);
  if (iVar1 != 0) {
    fVar3 = ((float10)_DAT_005823be / (float10)_DAT_005b9360) * (float10)*(float *)(param_1 + 0x1ec)
    ;
    FUN_00563a30();
    *(int *)(param_1 + 0x260) = (int)ROUND(fVar3);
  }
