...
// Convention: unknown
// Signature: undefined4 FUN_0048c160(undefined4 param_1,float *param_2,float param_3,float *param_4,float *param_5)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_0048c160(uint param_1,float *param_2,float param_3,float *param_4,float *param_5)
