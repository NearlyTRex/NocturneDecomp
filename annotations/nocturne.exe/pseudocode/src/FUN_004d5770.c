...
// Convention: unknown
// Signature: void FUN_004d5770(int param_1)
...

{
  ...
  *(uint *)(param_1 + 0x4691c) = 2;
  FUN_004359e0(param_1 + 0xbdec,param_1 + 0x20,param_1 + 0x30,param_1 + 0x150);
  iVar1 = FUN_0040d890(*(uint *)(_DAT_01cae0e8 * 4 + 0x1cae0d8),_DAT_01c71420);
  if (iVar1 != 0) {
  ...
  uVar2 = FUN_004e1660(iVar1 + 0x150,*(uint *)(iVar1 + 0x158));
  FUN_004e1960(param_1 + 0x150,uVar2);
  FUN_004e16b0(param_1 + 0x150,1,1);
  FUN_0043ac60(PTR_DAT_005ad350,"@@%s attacking hero\n" + 2,param_1);
  return;
}
