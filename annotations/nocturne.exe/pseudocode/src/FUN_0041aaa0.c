...
// Convention: unknown
// Signature: void FUN_0041aaa0(float *param_1,float *param_2,float *param_3,float param_4)
...

{
  ...
  FUN_0044d7a0(param_1 + 6,param_1 + 3);
  ...
  if (0 < (int)param_1[0x2c]) {
    ...
    pfVar4 = param_1 + 0x30;
    do {
      pfVar3 = (float *)FUN_0044da40(param_1 + 6,local_2c,local_14 + iVar5 * 0xd);
