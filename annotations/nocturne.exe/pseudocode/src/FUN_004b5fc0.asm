...
;
; Referenced Globals:
;   undefined1* PTR_FUN_0059ec84 = 00409fc0
...
section .text
    ...
    PUSH 0x1                            ; 004b5fcc
    PUSH EBX                            ; 004b5fce
    MOV dword ptr [EBX + 0x14c],0x59ec84 ; 004b5fcf | PTR_FUN_0059ec84
    CALL FUN_00409ea0                   ; 004b5fd9
    ...
    PUSH 0x59ed60                       ; 004b5ff0 | DAT_0059ed60
        ;   Label: LAB_004b5ff0
    PUSH EBX                            ; 004b5ff5
    CALL FUN_0056445f                   ; 004b5ff6
        ;   XREF to: 0056445f (UNCONDITIONAL_CALL)  ; undefined FUN_0056445f()
    ADD ESP,0x8                         ; 004b5ffb
    PUSH EAX                            ; 004b5ffe
    CALL FUN_00564486                   ; 004b5fff
