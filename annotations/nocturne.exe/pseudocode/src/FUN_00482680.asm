...
;
; XREF[1]:
;   FUN_0048a650 at 0048a777
;
; Referenced Globals:
;   undefined4 DAT_0058106c
...
section .text
    ...
    FLD double ptr [0x0058106c]         ; 0048271c | DAT_0058106c
    ...
    FMULP ST3                           ; 00482732
    FXCH                                ; 00482734
    CALL FUN_00563a30                   ; 00482736
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH                                ; 0048273b
    CALL FUN_00563a30                   ; 0048273d
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH ST2                            ; 00482742
    CALL FUN_00563a30                   ; 00482744
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH                                ; 00482749
