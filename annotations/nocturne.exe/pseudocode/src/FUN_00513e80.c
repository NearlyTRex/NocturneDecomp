...
// Convention: unknown
// Signature: undefined4 FUN_00513e80(float *param_1,float *param_2)

#include "nocturne.h"

uint FUN_00513e80(float *param_1,float *param_2)

{
  ...
  FUN_005644a7(local_128,8,&DAT_005993b0);
  local_28 = param_2 + 6;
  uVar3 = 0;
  local_24 = param_1 + 6;
  do {
    ...
    while( true ) {
      ...
      local_60 = local_18;
      pfVar1 = (float *)FUN_0044da40(local_24,local_5c,&local_68);
      ...
      pfVar1 = (float *)FUN_0044daa0(local_28,local_98,&local_80);
      if (&local_68 != pfVar1) {
        local_68 = *pfVar1;
        local_64 = pfVar1[1];
        local_60 = pfVar1[2];
      ...
      if (7 < (int)uVar3) {
        ...
        while( true ) {
          ...
          local_14 = (float)FUN_0041d550(&local_c8,pfVar4,&local_50,0);
          local_2c = local_14;
          ...
          local_14 = (float)FUN_0041d550(&local_c8,pfVar4,&local_a4,0);
          ...
          local_14 = (float)FUN_0041d550(&local_c8,pfVar4,&local_b0,0);
