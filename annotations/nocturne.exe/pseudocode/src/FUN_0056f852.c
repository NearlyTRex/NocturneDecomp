...
// Convention: unknown
// Signature: double FUN_0056f852(undefined4 param_1,undefined4 param_2)

#include "nocturne.h"

double FUN_0056f852(uint param_1,uint param_2)

{
  ...
  iVar4 = FUN_0056f690(param_1,&uStack_34,param_2);
  if (iVar4 == 0) {
    uVar5 = 0;
    uVar1 = 0;
LAB_0056f878:
