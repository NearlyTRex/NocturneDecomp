...
// Convention: unknown
// Signature: int FUN_0055eac0(undefined4 param_1)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

int FUN_0055eac0(uint param_1)

{
  ...
  pcVar6 = &DAT_005983f2;
  *(byte ***)(iVar3 + 0x14c) = &PTR_FUN_005a4554;
  FUN_0051e0c0(iVar3 + 0x150,"zombie1.dfm");
  ...
  *(uint *)(iVar3 + 0x2de0) = uVar2;
  ...
  uVar4 = FUN_0040dda0(0x3e99999a,0x3f800000);
  *(uint *)(iVar3 + 0xbd3c) = 0;
  ...
  *(uint *)(iVar3 + 0xbda8) = 0;
  *(uint *)(iVar3 + 0xbdfc) = 0;
  iVar5 = FUN_00564520(iVar5,"mine.geo");
  *(uint *)(iVar3 + 0xbdac) = 0;
  *(uint *)(iVar3 + 0xbe0c) = 0;
  *(uint *)(iVar3 + 0xbe10) = 0;
  *(uint *)(iVar3 + 0xbd20) = 0;
