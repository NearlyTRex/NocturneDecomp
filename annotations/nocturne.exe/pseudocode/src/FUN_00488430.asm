...
section .text
    ...
    JZ 0x0048853e                       ; 00488533
        ;   XREF to: 0048853e (CONDITIONAL_JUMP)  ; LAB_0048853e
    PUSH EBX                            ; 00488535
    CALL FUN_004880d0                   ; 00488536
        ;   XREF to: 004880d0 (UNCONDITIONAL_CALL)  ; undefined FUN_004880d0()
