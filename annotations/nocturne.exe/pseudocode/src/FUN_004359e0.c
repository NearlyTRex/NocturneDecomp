...
// Convention: unknown
// Signature: void FUN_004359e0(int param_1,undefined4 *param_2,undefined4 *param_3,int param_4)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_004359e0(int param_1,uint *param_2,uint *param_3,int param_4)

{
  ...
  if (param_4 != 0) {
    piVar12 = (int *)FUN_0051e020(param_4);
    local_84 = piVar12;
    FUN_00518130(piVar12);
    iVar6 = 0;
    if (0 < *(int *)(param_1 + 0x104)) {
    ...
    FUN_0051b800(param_4);
    FUN_0051d3c0(param_4);
    local_2c = 0;
    if (0 < *(int *)(param_1 + 0x39ce8)) {
        ...
        if (0 < local_84[0xb]) {
          ...
          do {
            ...
            for (iVar6 = 0; pfVar9 = pfVar9 + 1, iVar6 < (int)(uint)*(byte *)local_7c;
                iVar6 = iVar6 + 1) {
              pfVar8 = (float *)FUN_0055a8b0(local_c0,pfVar17,
    ...
    if (0 < *(int *)(param_1 + 0x37b4c)) {
      do {
        FUN_004363e0(param_1,iVar6,param_4);
        iVar6 = iVar6 + 1;
        ...
        while (local_30 < *local_84) {
          ...
          for (local_24 = 0; local_24 < *(int *)((int)local_84 + local_50 + 0x2c);
            ...
            for (iVar6 = 0; pfVar9 = pfVar9 + 1, iVar6 < (int)(uint)*(byte *)local_5c;
                iVar6 = iVar6 + 1) {
              pfVar8 = (float *)FUN_0055a8b0(local_d8,pfVar17,
