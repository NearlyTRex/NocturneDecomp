...
section .text
    ...
    PUSH EAX                            ; 00529cf6
    CALL FUN_005294f0                   ; 00529cf7
        ;   XREF to: 005294f0 (UNCONDITIONAL_CALL)  ; undefined FUN_005294f0()
    ...
    PUSH EAX                            ; 00529db1
    CALL FUN_00563c90                   ; 00529db2
        ;   XREF to: 00563c90 (UNCONDITIONAL_CALL)  ; undefined FUN_00563c90()
    ADD ESP,0x10                        ; 00529db7
    LEA EAX,[ESP + 0x190]               ; 00529dba
    PUSH EAX                            ; 00529dc1
    CALL FUN_00529980                   ; 00529dc2
        ;   XREF to: 00529980 (UNCONDITIONAL_CALL)  ; undefined FUN_00529980()
