...
// Convention: unknown
// Signature: void FUN_00473190(undefined4 param_1,undefined4 *param_2,undefined4 *param_3,undefined4 param_4)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_00473190(uint param_1,uint *param_2,uint *param_3,uint param_4)
      ...
      *(uint *)((int)afStack_110 + iVar2 + 8) = uStack_18;
      if (7 < (int)uVar1) {
        ...
        do {
          ...
          fStack_38 = *pfVar3 * _DAT_0057eaae;
          fStack_34 = pfVar3[1] * _DAT_0057eaae;
          fStack_30 = pfVar3[2] * _DAT_0057eaae;
          fStack_44 = *pfVar3 * _DAT_0057eaae + afStack_110[uVar1 * 3] * _DAT_0057eaaa;
          fStack_40 = pfVar3[1] * _DAT_0057eaae + afStack_110[uVar1 * 3 + 1] * _DAT_0057eaaa;
          fStack_3c = fStack_30 + afStack_110[uVar1 * 3 + 2] * _DAT_0057eaaa;
          ...
          fStack_74 = *pfVar3 * _DAT_0057eaae;
          fStack_70 = pfVar3[1] * _DAT_0057eaae;
          fStack_6c = pfVar3[2] * _DAT_0057eaae;
          fStack_2c = *pfVar3 * _DAT_0057eaae + afStack_110[uVar1 * 3] * _DAT_0057eaaa;
          fStack_28 = pfVar3[1] * _DAT_0057eaae + afStack_110[uVar1 * 3 + 1] * _DAT_0057eaaa;
          fStack_24 = fStack_6c + afStack_110[uVar1 * 3 + 2] * _DAT_0057eaaa;
          ...
          fStack_a4 = *pfVar3 * _DAT_0057eaae;
          fStack_a0 = pfVar3[1] * _DAT_0057eaae;
          fStack_9c = _DAT_0057eaae * pfVar3[2];
          fStack_5c = *pfVar3 * _DAT_0057eaae + afStack_110[uVar1 * 3] * _DAT_0057eaaa;
          fStack_58 = pfVar3[1] * _DAT_0057eaae + afStack_110[uVar1 * 3 + 1] * _DAT_0057eaaa;
          fStack_54 = fStack_9c + _DAT_0057eaaa * afStack_110[uVar1 * 3 + 2];
