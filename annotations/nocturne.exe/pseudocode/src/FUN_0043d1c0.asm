...
section .text
    ...
    PUSH ECX                            ; 0043d7fc
    CALL FUN_0048b070                   ; 0043d7fd
        ;   XREF to: 0048b070 (UNCONDITIONAL_CALL)  ; undefined FUN_0048b070()
