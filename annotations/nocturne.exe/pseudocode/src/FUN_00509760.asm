...
section .text
    ...
    MOV EAX,[0x005b9354]                ; 0050976b | DAT_005b9354 | DAT_01c775ec
    CMP dword ptr [EAX + 0x24],0x0      ; 00509770 | DAT_01c77610
    JZ 0x0050983b                       ; 00509774
        ;   XREF to: 0050983b (CONDITIONAL_JUMP)  ; LAB_0050983b
    CMP dword ptr [EAX + 0x20c],0x0     ; 0050977a | DAT_01c777f8
    ...
    MOV dword ptr [0x01fba938],EBX      ; 00509793 | DAT_01fba938
    ...
    MOV EAX,[0x005b9354]                ; 00509829 | DAT_005b9354 | DAT_01c775ec
        ;   Label: LAB_00509829
    CMP dword ptr [EAX + 0x20c],0x0     ; 0050982e | DAT_01c777f8
    ...
    MOV EBX,dword ptr [0x005b96c4]      ; 0050993c | DAT_005b96c4
        ;   Label: LAB_0050993c
    PUSH EBX                            ; 00509942
    CALL FUN_004afe00                   ; 00509943
        ;   XREF to: 004afe00 (UNCONDITIONAL_CALL)  ; undefined FUN_004afe00()
    ADD ESP,0x4                         ; 00509948
    MOV EDI,dword ptr [0x005b80f0]      ; 0050994b | DAT_005b80f0
    PUSH EDI                            ; 00509951
    CALL FUN_0048a650                   ; 00509952
    ...
    PUSH 0x1                            ; 0050997c
        ;   Label: LAB_0050997c
    PUSH EAX                            ; 0050997e
    CALL FUN_0044e470                   ; 0050997f
        ;   XREF to: 0044e470 (UNCONDITIONAL_CALL)  ; undefined FUN_0044e470()
    ADD ESP,0x8                         ; 00509984
    PUSH 0x22                           ; 00509987
    PUSH ESI                            ; 00509989
    CALL FUN_0050d2d0                   ; 0050998a
        ;   XREF to: 0050d2d0 (UNCONDITIONAL_CALL)  ; undefined FUN_0050d2d0()
    ...
    MOV ECX,dword ptr [0x005b96c4]      ; 005099e5 | DAT_005b96c4
        ;   Label: LAB_005099e5
    PUSH ECX                            ; 005099eb
    CALL FUN_004afe00                   ; 005099ec
        ;   XREF to: 004afe00 (UNCONDITIONAL_CALL)  ; undefined FUN_004afe00()
    ADD ESP,0x4                         ; 005099f1
    MOV EBX,dword ptr [0x005b80f0]      ; 005099f4 | DAT_005b80f0
    PUSH EBX                            ; 005099fa
    CALL FUN_0048a650                   ; 005099fb
        ;   XREF to: 0048a650 (UNCONDITIONAL_CALL)  ; undefined FUN_0048a650()
