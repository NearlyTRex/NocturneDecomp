...
section .text
    ...
    CALL thunk_FUN_004cdbc0             ; 00550271
    ...
    CALL thunk_FUN_004cdbc0             ; 0055033e
        ;   XREF to: 00460bf0 (UNCONDITIONAL_CALL)  ; undefined thunk_FUN_004cdbc0()
