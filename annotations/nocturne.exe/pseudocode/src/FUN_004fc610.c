...
// Convention: unknown
// Signature: void FUN_004fc610(int param_1,float param_2)
...

{
  ...
  if ((((*(int *)(param_1 + 0x1fa38) == 2) || (*(int *)(param_1 + 0x1fa38) == 3)) &&
    ...
    local_30 = 0x461c3f9a;
    iVar2 = FUN_004b5d00(param_1,&local_30);
  ...
  if (*(int *)(*(int *)(param_1 + 0x1fa50) + 0x2d8) == 8) {
    if (local_7c < (float)_DAT_0058deee) {
      iVar5 = FUN_004e1660(param_1 + 0x150);
...
LAB_004fc7c4:
    ...
    if ((*(int *)(param_1 + 0x1fa3c) != 0) && (iVar5 != 0)) {
      ...
      FUN_00424e90(param_1,iVar4 + 0x20);
    }
  ...
  if (iVar5 == 0) {
    iVar5 = FUN_004f1e00(iVar4 + 0x20);
  }
  iVar5 = FUN_004f1600(iVar5,param_1 + 0x20,auStack_54,*(uint *)(param_1 + 0x6c));
  if (iVar5 != 0) {
    fStack_18 = (float)FUN_0040df00(fStack_50 - *(float *)(param_1 + 0x34));
...
LAB_004fc893:
  ...
  pfVar3 = (float *)FUN_0054e4a0(auStack_6c,&local_3c);
  if (&local_3c != pfVar3) {
    local_3c = *pfVar3;
    local_38 = pfVar3[1];
    local_34 = pfVar3[2];
  }
  fStack_44 = (float)FUN_0040df00(local_38 - *(float *)(param_1 + 0x34));
