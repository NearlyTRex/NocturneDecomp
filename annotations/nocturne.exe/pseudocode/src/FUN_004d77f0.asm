...
section .text
    ...
    FMUL float ptr [0x005a0880]         ; 004d780a | DAT_005a0880
    FISTP dword ptr [EBX]               ; 004d7810
    FLD float ptr [EAX + 0x4]           ; 004d7812
    FMUL float ptr [0x005a0880]         ; 004d7815 | DAT_005a0880
    FISTP dword ptr [EBX + 0x4]         ; 004d781b
    FLD float ptr [EAX + 0x8]           ; 004d781e
    FMUL float ptr [0x005a0880]         ; 004d7821 | DAT_005a0880
    FISTP dword ptr [EBX + 0x8]         ; 004d7827
    LEA EAX,[ESP + 0x40]                ; 004d782a
    PUSH EAX                            ; 004d782e
    PUSH EDX                            ; 004d782f
    CALL wincore_windll.cpp_transformPoint_FUN_00530a25 ; 004d7830
    ...
    FMUL float ptr [0x005a0880]         ; 004d7848 | DAT_005a0880
    FISTP dword ptr [EBX]               ; 004d784e
    FLD float ptr [EAX + 0x4]           ; 004d7850
    FMUL float ptr [0x005a0880]         ; 004d7853 | DAT_005a0880
    FISTP dword ptr [EBX + 0x4]         ; 004d7859
    FLD float ptr [EAX + 0x8]           ; 004d785c
    FMUL float ptr [0x005a0880]         ; 004d785f | DAT_005a0880
    FISTP dword ptr [EBX + 0x8]         ; 004d7865
    LEA EAX,[ESP + 0x34]                ; 004d7868
    PUSH EAX                            ; 004d786c
    ADD EDX,0x30                        ; 004d786d
    PUSH EDX                            ; 004d7870
    CALL wincore_windll.cpp_transformPoint_FUN_00530a25 ; 004d7871
        ;   XREF to: 00530a25 (UNCONDITIONAL_CALL)  ; undefined wincore_windll.cpp_transformPoint_FUN_00530a25()
    ...
    FMUL float ptr [0x005a0880]         ; 004d788a | DAT_005a0880
    FISTP dword ptr [EBX]               ; 004d7890
    FLD float ptr [EAX + 0x4]           ; 004d7892
    FMUL float ptr [0x005a0880]         ; 004d7895 | DAT_005a0880
    FISTP dword ptr [EBX + 0x4]         ; 004d789b
    FLD float ptr [EAX + 0x8]           ; 004d789e
    FMUL float ptr [0x005a0880]         ; 004d78a1 | DAT_005a0880
    FISTP dword ptr [EBX + 0x8]         ; 004d78a7
    LEA EAX,[ESP + 0x28]                ; 004d78aa
    PUSH EAX                            ; 004d78ae
    ADD EDX,0x60                        ; 004d78af
    PUSH EDX                            ; 004d78b2
    CALL wincore_windll.cpp_transformPoint_FUN_00530a25 ; 004d78b3
        ;   XREF to: 00530a25 (UNCONDITIONAL_CALL)  ; undefined wincore_windll.cpp_transformPoint_FUN_00530a25()
    ...
    FMUL float ptr [0x005a0880]         ; 004d78d1 | DAT_005a0880
    FISTP dword ptr [EBX]               ; 004d78d7
    FLD float ptr [EAX + 0x4]           ; 004d78d9
    FMUL float ptr [0x005a0880]         ; 004d78dc | DAT_005a0880
    FISTP dword ptr [EBX + 0x4]         ; 004d78e2
    FLD float ptr [EAX + 0x8]           ; 004d78e5
    FMUL float ptr [0x005a0880]         ; 004d78e8 | DAT_005a0880
    FISTP dword ptr [EBX + 0x8]         ; 004d78ee
    LEA EAX,[ESP + 0x4c]                ; 004d78f1
    PUSH EAX                            ; 004d78f5
    PUSH EDX                            ; 004d78f6
    CALL wincore_windll.cpp_transformPoint_FUN_00530a25 ; 004d78f7
        ;   XREF to: 00530a25 (UNCONDITIONAL_CALL)  ; undefined wincore_windll.cpp_transformPoint_FUN_00530a25()
