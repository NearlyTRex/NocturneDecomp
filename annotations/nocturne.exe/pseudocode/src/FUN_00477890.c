...

{
  ...
  FUN_0040a240(param_1,&fStack_d4,uVar2);
  iVar3 = FUN_00554600(param_1);
  if (iVar3 == 0) {
    FUN_0052ea60(0x02DC9450,param_1,"shotgun-noammo.wav",&fStack_d4);
    return 0;
  }
  ...
  if (0 < (int)fStack_38) {
    do {
      fStack_4c = (float)FUN_0040dda0(0,0x40c90fdb);
      fStack_18 = fStack_4c;
      ...
      pfVar4 = (float *)FUN_0040a200(param_1,auStack_8c,&fStack_e0);
      if (&fStack_e0 != pfVar4) {
        fStack_e0 = *pfVar4;
        fStack_dc = pfVar4[1];
        fStack_d8 = pfVar4[2];
      ...
      iStack_24 = 0;
      do {
        fVar5 = (float)FUN_0050fb00(0x01E57284,&fStack_98,&fStack_bc);
        dVar1 = (double)fVar5;
        fStack_18 = fVar5;
        ...
        iStack_30 = FUN_0040d890(*(uint *)(0x01E57284 + 0x14cd5c),_DAT_01c7068c);
        ...
        if (iVar3 == 0) {
          ...
          puVar8 = (uint *)FUN_0040a290(iVar3,auStack_68,0x01E57284 + 0x14cd50);
  ...
  FUN_0048af20(0x01C08D04,&fStack_80,param_1 + 0x3c);
  FUN_0052ea60(0x02DC9450,param_1,"elephantgun.wav",&fStack_d4);
