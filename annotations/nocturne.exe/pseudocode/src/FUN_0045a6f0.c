...
// Convention: unknown
// Signature: void FUN_0045a6f0(int param_1,int param_2)
  ...
  *(float *)(param_1 + 0x2434) = fVar1;
  if (fVar1 <= 0.0) {
    *(uint *)(param_1 + 0x2434) = 0;
    ...
    if (iVar5 != 0) {
      FUN_0045ab40(param_1,"bride-die?.wav",0x40000000);
      FUN_00479f70(param_1,param_2);
      return;
    }
    goto LAB_0045a7ee;
  }
  iVar5 = FUN_004e1660(iVar5);
...
LAB_0045a8a5:
  ...
  iVar5 = FUN_0040dea0(0x3ecccccd);
  if (iVar5 != 0) {
    FUN_0045ab40(param_1,"bride-hurt?.wav",0x40000000);
    FUN_00479f70(param_1,param_2);
    return;
  }
LAB_0045a7ee:
