...
// Convention: unknown
// Signature: undefined4 FUN_0052a970(void)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_0052a970(void)

{
  ...
  if (_DAT_02dc9220 == 0) {
    if (_DAT_02dc921c != (int *)0x0) {
      ...
      if (iVar2 != 0) {
        uVar1 = FUN_00529a90(iVar2);
        FUN_00563c90(&piStack_1a8,"DirectSux: Unable to %s.  (%s)",
                     "Get position of secondary buffer",uVar1);
        FUN_00529980(&piStack_1a8);
        return 0;
      }
