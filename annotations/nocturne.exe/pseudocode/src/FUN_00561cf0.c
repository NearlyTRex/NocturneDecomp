...
// Convention: unknown
// Signature: void FUN_00561cf0(int param_1,int *param_2)
  ...
  if (((((iVar2 == *(int *)(param_1 + 0xbde0)) || (iVar2 == *(int *)(param_1 + 0xbde4))) ||
    ...
    if (iVar2 != 0) {
      ...
      if (*param_2 == *(int *)(param_1 + 0xbde0)) {
        FUN_00427eb0(param_1,uVar3,*(uint *)(param_1 + 0xbde4),0);
      }
      if (*(int *)(param_1 + 0xbde8) == *param_2) {
        FUN_00427eb0(param_1,uVar3,*(uint *)(param_1 + 0xbdec),0);
      }
      if (*(int *)(param_1 + 0xbdf4) == *param_2) {
        piVar1 = param_2 + 3;
        FUN_00427e40(param_1,*(uint *)(param_1 + 0xbde8),piVar1,0);
        FUN_00427e40(param_1,*(uint *)(param_1 + 0xbdec),piVar1,0);
        FUN_00427e40(param_1,*(uint *)(param_1 + 0xbde0),piVar1,0);
        FUN_00427e40(param_1,*(uint *)(param_1 + 0xbde4),piVar1,0);
        FUN_00427e40(param_1,*(uint *)(param_1 + 0xbdf8),piVar1,0);
      }
