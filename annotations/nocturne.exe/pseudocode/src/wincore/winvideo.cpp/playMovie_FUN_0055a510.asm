...
section .text
    ...
    PUSH EBP                            ; 0055a510
        ;   Label: wincore_winvideo.cpp_playMovie_FUN_0055a510
    ...
    MOV EBX,dword ptr [0x02de2098]      ; 0055a580 | g_HWND_02de2098
    ...
    MOV ECX,dword ptr [0x02de3120]      ; 0055a7a7 | DAT_02de3120
        ;   Label: LAB_0055a7a7
    MOV EAX,[0x02de2098]                ; 0055a7ad | g_HWND_02de2098
    ...
    MOV EAX,[0x02de2098]                ; 0055a883 | g_HWND_02de2098
    PUSH EAX                            ; 0055a888
