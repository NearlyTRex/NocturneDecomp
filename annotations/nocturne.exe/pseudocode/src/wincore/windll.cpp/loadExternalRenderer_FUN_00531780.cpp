// Name: wincore_windll.cpp_loadExternalRenderer_FUN_00531780
// Address: 00531780
// Address Range: [[00531780, 005322a5]]
// Convention: __cdecl
// Signature: undefined4 __cdecl wincore_windll_cpp_loadExternalRenderer_FUN_00531780(int param_1)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint __cdecl wincore_windll_cpp_loadExternalRenderer_FUN_00531780(int param_1)

{
  ...
  if (pcVar1 != (code *)0x0) {
    ...
    wincore_windll_cpp_CExternalRenderer_ctor_FUN_00532da0(auStack_3c2c);
    iVar2 = wincore_windll_cpp_CExternalRenderer_validate_FUN_00532df0(local_1e64,auStack_3c2c);
    if (iVar2 != 0) {
      _DAT_02dc9d74 =
      ...
      if (iVar3 != 0) {
        wincore_windll_cpp_selectCard_FUN_00532d00(_DAT_02dc9d64);
        return 1;
      }
      _DAT_02dc9d60 = iVar3;
      return 0;
