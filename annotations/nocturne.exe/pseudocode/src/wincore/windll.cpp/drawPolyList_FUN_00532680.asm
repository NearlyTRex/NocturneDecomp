...
section .text
    ...
    PUSH EBX                            ; 00532680
        ;   Label: wincore_windll.cpp_drawPolyList_FUN_00532680
    PUSH ESI                            ; 00532681
    PUSH EDI                            ; 00532682
    PUSH EBP                            ; 00532683
    ...
    INC EDI                             ; 00532757
    CALL dword ptr [0x02dc9dac]         ; 00532758 | DAT_02dc9dac
    ...
    PUSH EDX                            ; 0053279a
    PUSH EBX                            ; 0053279b
    MOV [0x01e52ef8],EAX                ; 0053279c | DAT_01e52ef8
    CALL dword ptr [0x02dc9db0]         ; 005327a1 | DAT_02dc9db0
