// Name: wincore_windll.cpp_setResolutionAndColorTable_FUN_005324a0
// Address: 005324a0
// Address Range: [[005324a0, 005325b3]]
// Convention: __cdecl
// Signature: undefined4 __cdecl wincore_windll_cpp_setResolutionAndColorTable_FUN_005324a0(undefined4 param_1,undefined4 param_2,int param_3)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint __cdecl wincore_windll_cpp_setResolutionAndColorTable_FUN_005324a0(uint param_1,uint param_2,int param_3)

{
  ...
  if ((_DAT_02dc9e04 == 0) &&
     (iVar2 = wincore_windll_cpp_loadExternalRenderer_FUN_00531780(_DAT_02dc9e18), iVar2 == 0)) {
    return 0;
  }
