...
;                               FUNCTION
; *****************************************************************************
; undefined4 wincore_windll_cpp_clearScreenRegion_FUN_0052ef37(undefined4 param_1)
;
;
; Referenced Globals:
...
;
; Called Functions:
;   wincore_windll.cpp_drawFullScreenQuad_FUN_005329c0
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBP                            ; 0052ef37
        ;   Label: wincore_windll.cpp_clearScreenRegion_FUN_0052ef37
    ...
    CALL wincore_windll.cpp_drawFullScreenQuad_FUN_005329c0 ; 0052ef48
        ;   XREF to: 005329c0 (UNCONDITIONAL_CALL)  ; undefined wincore_windll.cpp_drawFullScreenQuad_FUN_005329c0()
    POP EAX                             ; 0052ef4d
    POP EDI                             ; 0052ef4e
    POP ESI                             ; 0052ef4f
    LEAVE                               ; 0052ef50
