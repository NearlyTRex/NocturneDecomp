...
;
; XREF[2]:
;   FUN_00530e60 at 00530ed0
;   wincore_windll.cpp_loadExternalRenderer_FUN_00531780 at 00531823
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 00532df0
        ;   Label: wincore_windll.cpp_CExternalRenderer_validate_FUN_00532df0
    PUSH ESI                            ; 00532df1
    PUSH EDI                            ; 00532df2
