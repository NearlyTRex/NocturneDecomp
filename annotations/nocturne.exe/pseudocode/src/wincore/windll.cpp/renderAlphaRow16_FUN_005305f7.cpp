// Name: wincore_windll.cpp_renderAlphaRow16_FUN_005305f7
// Address: 005305f7
// Address Range: [[005305f7, 0053070f]]
// Convention: __cdecl
// Signature: undefined8 __cdecl wincore_windll_cpp_renderAlphaRow16_FUN_005305f7(ushort *param_1,byte *param_2,byte *param_3,uint param_4,int param_5)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

ulonglong __cdecl wincore_windll_cpp_renderAlphaRow16_FUN_005305f7(ushort *param_1,byte *param_2,byte *param_3,uint param_4,int param_5)

{
  ...
  do {
    uVar1 = *(uint *)(&DAT_01c00024 + (uint)*param_2 * 4);
    uVar10 = (ulonglong)uVar1;
    uVar6 = (uint)*param_3 * (param_4 >> 8);
    if (_DAT_01c03998 == 1) {
LAB_00530640:
...
LAB_005306c3:
      *param_1 = (ushort)((uVar10 & _DAT_005bf610) >> _DAT_005bf658) |
