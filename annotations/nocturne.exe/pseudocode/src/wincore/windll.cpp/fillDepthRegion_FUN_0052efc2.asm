...
;                               FUNCTION
; *****************************************************************************
; uint wincore_windll_cpp_fillDepthRegion_FUN_0052efc2(int param_1,int param_2,uint param_3,uint param_4)
;
;
; Referenced Globals:
...
;
; Called Functions:
;   wincore_windll.cpp_clearZBox_FUN_00532b70
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBP                            ; 0052efc2
        ;   Label: wincore_windll.cpp_fillDepthRegion_FUN_0052efc2
    ...
    CALL wincore_windll.cpp_clearZBox_FUN_00532b70 ; 0052efdc
        ;   XREF to: 00532b70 (UNCONDITIONAL_CALL)  ; undefined wincore_windll.cpp_clearZBox_FUN_00532b70()
    POP EAX                             ; 0052efe1
    POP EAX                             ; 0052efe2
    POP EAX                             ; 0052efe3
    POP EAX                             ; 0052efe4
