...
section .text
    ...
    PUSH EBX                            ; 00531780
        ;   Label: wincore_windll.cpp_loadExternalRenderer_FUN_00531780
    PUSH ESI                            ; 00531781
    PUSH EDI                            ; 00531782
    PUSH EBP                            ; 00531783
    ...
    PUSH EAX                            ; 0053180f
    CALL wincore_windll.cpp_CExternalRenderer_ctor_FUN_00532da0 ; 00531810
    ...
    PUSH EAX                            ; 00531822
    CALL wincore_windll.cpp_CExternalRenderer_validate_FUN_00532df0 ; 00531823
    ...
    MOV EDX,dword ptr [0x02dc9d64]      ; 00532287 | DAT_02dc9d64
        ;   Label: LAB_00532287
    PUSH EDX                            ; 0053228d
    CALL wincore_windll.cpp_selectCard_FUN_00532d00 ; 0053228e
