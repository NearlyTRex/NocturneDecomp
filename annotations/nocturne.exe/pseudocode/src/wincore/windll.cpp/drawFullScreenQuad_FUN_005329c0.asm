...
;
; XREF[1]:
;   wincore_windll.cpp_clearScreenRegion_FUN_0052ef37 at 0052ef48
;
; Referenced Globals:
...
section .text
    ...
    SUB ESP,0xc0                        ; 005329c0
        ;   Label: wincore_windll.cpp_drawFullScreenQuad_FUN_005329c0
    PUSH 0xc0                           ; 005329c6
    PUSH 0x0                            ; 005329cb
    ...
    PUSH EAX                            ; 00532a5c
    CALL wincore_windll.cpp_drawPolygon_FUN_00532620 ; 00532a5d
