...
section .text
    ...
    PUSH EBX                            ; 005324a0
        ;   Label: wincore_windll.cpp_setResolutionAndColorTable_FUN_005324a0
    PUSH ESI                            ; 005324a1
    PUSH EDI                            ; 005324a2
    PUSH EBP                            ; 005324a3
    ...
    CALL wincore_windll.cpp_lockFrame_FUN_005322e0 ; 00532542
