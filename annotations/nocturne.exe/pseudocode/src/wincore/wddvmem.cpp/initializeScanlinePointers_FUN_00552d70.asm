...
section .text
    ...
    MOV EDX,dword ptr [0x005b7620]      ; 00552d74 | g_WindowHeight
    ...
    PUSH ESI                            ; 00552d81
    PUSH EBX                            ; 00552d82
    MOV EAX,[0x005b7624]                ; 00552d83 | g_BitsPerPixel
    ...
    MOV EAX,[0x005b761c]                ; 00552d97 | g_WindowWidth
    SHL EAX,0x2                         ; 00552d9c
    MOV EBP,dword ptr [0x005b761c]      ; 00552d9f | g_WindowWidth
    MOV dword ptr [ESP + 0xc],EAX       ; 00552da5
    XOR EAX,EAX                         ; 00552da9
    IMUL EDX,EBP,0x0                    ; 00552dab
    MOV EBX,dword ptr [0x005b761c]      ; 00552dae | g_WindowWidth
        ;   Label: LAB_00552dae
    IMUL EBX,ECX                        ; 00552db4
    IMUL EBX,EDI                        ; 00552db7
    MOV ESI,dword ptr [0x005c5010]      ; 00552dba | g_BackBuffer
    ADD EBX,ESI                         ; 00552dc0
    MOV dword ptr [EAX + 0x1bd2fa0],EBX ; 00552dc2 | g_ScreenBufferArray | g_ScreenBufferArray[1]
    MOV EBX,dword ptr [0x006af62c]      ; 00552dc8 | g_SoftwareZBuffer
    ADD EAX,0x4                         ; 00552dce
    ADD EBX,EDX                         ; 00552dd1
    INC ECX                             ; 00552dd3
    MOV dword ptr [EAX + 0x1bd425c],EBX ; 00552dd4 | g_ZBufferScanlineArray
    MOV EBX,dword ptr [ESP + 0xc]       ; 00552dda
    MOV ESI,dword ptr [0x005b7620]      ; 00552dde | g_WindowHeight
