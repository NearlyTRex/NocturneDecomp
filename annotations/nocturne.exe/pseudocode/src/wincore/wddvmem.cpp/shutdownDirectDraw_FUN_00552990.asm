...
section .text
    ...
    PUSH EBX                            ; 00552990
        ;   Label: wincore_wddvmem.cpp_shutdownDirectDraw_FUN_00552990
    PUSH EDI                            ; 00552991
    PUSH EBP                            ; 00552992
    MOV EDX,dword ptr [0x02ddf55c]      ; 00552993 | g_DirectDrawUnknown
    TEST EDX,EDX                        ; 00552999
    JNZ 0x005529e1                      ; 0055299b
        ;   XREF to: 005529e1 (CONDITIONAL_JUMP)  ; LAB_005529e1
    MOV EBX,dword ptr [0x02ddf558]      ; 0055299d | g_SoftwareRenderSurface
        ;   Label: LAB_0055299d
    ...
    MOV dword ptr [0x02ddf558],ESI      ; 005529b0 | g_SoftwareRenderSurface
    POP ESI                             ; 005529b6
    MOV EDI,dword ptr [0x02ddf554]      ; 005529b7 | g_DirectDrawSurface
        ;   Label: LAB_005529b7
    ...
    MOV dword ptr [0x02ddf554],EBP      ; 005529c9 | g_DirectDrawSurface
    MOV EAX,[0x02ddf550]                ; 005529cf | g_DirectDrawObject
        ;   Label: LAB_005529cf
    ...
    MOV dword ptr [0x02ddf55c],ECX      ; 005529eb | g_DirectDrawUnknown
    ...
    MOV EAX,[0x02ddf550]                ; 005529f9 | g_DirectDrawObject
    PUSH EAX                            ; 005529fe
    MOV EDX,dword ptr [EAX]             ; 005529ff
    CALL dword ptr [EDX + 0x8]          ; 00552a01
    XOR EDX,EDX                         ; 00552a04
    MOV dword ptr [0x02ddf550],EDX      ; 00552a06 | g_DirectDrawObject
