...
// Convention: unknown
// Signature: undefined4 FUN_00552e00(int param_1,int param_2,int param_3)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_00552e00(int param_1,int param_2,int param_3)

{
  ...
  if (iVar4 == 0) {
    ...
    FUN_00401e30(0,0,iStack_28 + -1,iStack_24 + -1);
    iVar3 = 0;
    FUN_005537e0();
    do {
      FUN_0052ee70();
