...
;
; XREF[1]:
;   engine_2d.c_FUN_004012a0 at 004012a8
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00552cb0
        ;   Label: wincore_wddvmem.cpp_FUN_00552cb0
    PUSH ESI                            ; 00552cb1
    PUSH EBP                            ; 00552cb2
    ...
    PUSH ESI                            ; 00552ccb
    CALL crt_unknown.c_FUN_005638d0     ; 00552ccc
    ...
    PUSH EDX                            ; 00552d38
        ;   Label: LAB_00552d38
    CALL crt_unknown.c_FUN_005638d0     ; 00552d39
        ;   XREF to: 005638d0 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_005638d0()
