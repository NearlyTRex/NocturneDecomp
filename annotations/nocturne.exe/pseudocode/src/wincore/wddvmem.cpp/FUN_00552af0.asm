...
section .text
    ...
    PUSH EBP                            ; 00552af1
    MOV EDX,dword ptr [0x005c5010]      ; 00552af2 | DAT_005c5010
    TEST EDX,EDX                        ; 00552af8
    JNZ 0x00552b09                      ; 00552afa
        ;   XREF to: 00552b09 (CONDITIONAL_JUMP)  ; LAB_00552b09
    MOV ESI,dword ptr [0x02ddf560]      ; 00552afc | DAT_02ddf560
    ...
    PUSH EBX                            ; 00552b09
        ;   Label: LAB_00552b09
    PUSH EDX                            ; 00552b0a
    CALL crt_unknown.c_FUN_005638d0     ; 00552b0b
        ;   XREF to: 005638d0 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_005638d0()
    XOR EBX,EBX                         ; 00552b10
    ADD ESP,0x4                         ; 00552b12
    MOV dword ptr [0x005c5010],EBX      ; 00552b15 | DAT_005c5010
    POP EBX                             ; 00552b1b
    MOV ESI,dword ptr [0x02ddf560]      ; 00552b1c | DAT_02ddf560
    ...
    PUSH ESI                            ; 00552b29
        ;   Label: LAB_00552b29
    CALL crt_unknown.c_FUN_005638d0     ; 00552b2a
        ;   XREF to: 005638d0 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_005638d0()
    XOR EBP,EBP                         ; 00552b2f
    ADD ESP,0x4                         ; 00552b31
    MOV dword ptr [0x006af62c],EBP      ; 00552b34 | DAT_006af62c
    POP EBP                             ; 00552b3a
    POP ESI                             ; 00552b3b
    RET                                 ; 00552b3c
