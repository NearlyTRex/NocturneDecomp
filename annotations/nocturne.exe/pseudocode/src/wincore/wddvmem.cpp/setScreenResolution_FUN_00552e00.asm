...
section .text
    ...
    MOV EDX,dword ptr [0x02ddf55c]      ; 00552e0e | g_DirectDrawUnknown
    TEST EDX,EDX                        ; 00552e14
    JNZ 0x00552f97                      ; 00552e16
        ;   XREF to: 00552f97 (CONDITIONAL_JUMP)  ; LAB_00552f97
    MOV ESI,dword ptr [0x02ddf558]      ; 00552e1c | g_SoftwareRenderSurface
        ;   Label: LAB_00552e1c
    ...
    MOV dword ptr [0x02ddf558],EDI      ; 00552e2e | g_SoftwareRenderSurface
    MOV EBP,dword ptr [0x02ddf554]      ; 00552e34 | g_DirectDrawSurface
        ;   Label: LAB_00552e34
    ...
    MOV [0x02ddf554],EAX                ; 00552e47 | g_DirectDrawSurface
    ...
    MOV EAX,dword ptr [ESP + 0x88]      ; 00552e5f
        ;   Label: LAB_00552e5f
    MOV ECX,dword ptr [0x005c5010]      ; 00552e66 | g_BackBuffer
    MOV dword ptr [0x005b7624],EBX      ; 00552e6c | g_BitsPerPixel
    ...
    MOV dword ptr [0x005c5010],EDI      ; 00552e9a | g_BackBuffer
    MOV EBP,dword ptr [0x02ddf560]      ; 00552ea0 | g_SoftwareFrameBuffer
        ;   Label: LAB_00552ea0
    ...
    MOV [0x005c5010],EAX                ; 00552ee7 | g_BackBuffer
    ...
    MOV [0x02ddf560],EAX                ; 00552f2e | g_SoftwareFrameBuffer
    ...
    MOV EAX,[0x02ddf560]                ; 00552f59 | g_SoftwareFrameBuffer
        ;   Label: LAB_00552f59
    PUSH EBX                            ; 00552f5e
    ...
    PUSH ESI                            ; 00552f73
    MOV [0x006af62c],EAX                ; 00552f74 | g_SoftwareZBuffer
    MOV EAX,[0x02ddf550]                ; 00552f79 | g_DirectDrawObject
    PUSH EAX                            ; 00552f7e
    ...
    MOV dword ptr [0x02ddf55c],ECX      ; 00552fa1 | g_DirectDrawUnknown
    ...
    PUSH EDI                            ; 00552fb5
    MOV EAX,[0x02ddf550]                ; 00552fb6 | g_DirectDrawObject
    PUSH ESI                            ; 00552fbb
    ...
    PUSH 0x2ddf554                      ; 0055302b | g_DirectDrawSurface
    MOV EAX,[0x02ddf550]                ; 00553030 | g_DirectDrawObject
    ...
    PUSH 0x2ddf554                      ; 0055304f | g_DirectDrawSurface
    MOV EAX,[0x02ddf550]                ; 00553054 | g_DirectDrawObject
    ...
    PUSH 0x2ddf558                      ; 0055307d | g_SoftwareRenderSurface
    LEA ECX,[ESP + 0x70]                ; 00553082
    MOV EAX,0x4                         ; 00553086
    PUSH ECX                            ; 0055308b
    MOV dword ptr [ESP + 0x74],EAX      ; 0055308c
    MOV EAX,[0x02ddf554]                ; 00553090 | g_DirectDrawSurface
    PUSH EAX                            ; 00553095
    ...
    MOV EAX,[0x005b7624]                ; 005530af | g_BitsPerPixel
    ...
    MOV EBX,dword ptr [0x005c5010]      ; 005530d6 | g_BackBuffer
    ...
    MOV dword ptr [EAX + 0x1bd2fa0],ESI ; 005530f2 | g_ScreenBufferArray | g_ScreenBufferArray[1]
    MOV ESI,dword ptr [0x006af62c]      ; 005530f8 | g_SoftwareZBuffer
    ADD EAX,0x4                         ; 005530fe
    ADD ESI,EDX                         ; 00553101
    MOV dword ptr [EAX + 0x1bd425c],ESI ; 00553103 | g_ZBufferScanlineArray
