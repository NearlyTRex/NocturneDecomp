...
;
; XREF[1]:
;   core_main.c_displayErrorAndQuit_FUN_004c8440 at 004c84c8
;
; Referenced Globals:
...
;   char[256] g_CHAR_ARRAY_02de0860
...
section .text
    ...
    PUSH EBX                            ; 00559500
        ;   Label: wincore_winrun.cpp_displayMessageBoxAndQuit_FUN_00559500
    PUSH ESI                            ; 00559501
    PUSH EDI                            ; 00559502
    MOV EDX,dword ptr [0x01cc4804]      ; 00559503 | g_CurrentLineNumber
    PUSH EDX                            ; 00559509
    MOV ECX,dword ptr [0x01cc4800]      ; 0055950a | g_CurrentFilename
    PUSH ECX                            ; 00559510
    ...
    PUSH 0x2de0860                      ; 00559531 | g_CHAR_ARRAY_02de0860
    MOV EDI,dword ptr [0x02de2098]      ; 00559536 | g_HWND_02de2098
    PUSH EDI                            ; 0055953c
