// Name: wincore_winrun.cpp_winMain_FUN_00559260
// Address: 00559260
// Address Range: [[00559260, 005594fb]]
// Convention: __stdcall
// Signature: int __stdcall wincore_winrun_cpp_winMain_FUN_00559260(HINSTANCE hInstance,HINSTANCE hPrevInstance,LPSTR lpCmdLine,int nCmdShow)
...
LAB_005593b7:
  ...
  local_58.lpfnWndProc = wincore_winrun_cpp_mainWindowProc_FUN_00558d90;
  ...
  g_HWND_02de2098 =
       CreateWindowExA(0x40000,PTR_s_Nocturne_005c1658,PTR_s_Nocturne_005c165c,0x80000000,0,0,0,0,0,
                       (HMENU)0x0,hInstance,(LPVOID)0x0);
  if (g_HWND_02de2098 == 0) {
    return 0;
  }
  ShowWindow(g_HWND_02de2098,nCmdShow);
  UpdateWindow(g_HWND_02de2098);
