...
;
; XREF[1]:
;   wincore_winrun.cpp_winMain_FUN_00559260 at 005593d1
;
; Referenced Globals:
...
;   wincore_wddvmem.cpp_stubFunction_FUN_00553ca0
...
section .text
    ...
    PUSH EBX                            ; 00558d90
        ;   Label: wincore_winrun.cpp_mainWindowProc_FUN_00558d90
    PUSH ESI                            ; 00558d91
    PUSH EDI                            ; 00558d92
    PUSH EBP                            ; 00558d93
    ...
    MOV EDX,dword ptr [0x02de2098]      ; 00558da0 | g_HWND_02de2098
    ...
    CALL wincore_wddvmem.cpp_videoRestore_FUN_00553ba0 ; 00558e69
    ...
    JZ 0x00558ddf                       ; 00558ec4
        ;   XREF to: 00558ddf (CONDITIONAL_JUMP)  ; LAB_00558ddf
    CALL wincore_wddvmem.cpp_stubFunction_FUN_00553ca0 ; 00558eca
        ;   XREF to: 00553ca0 (UNCONDITIONAL_CALL)  ; void wincore_wddvmem.cpp_stubFunction_FUN_00553ca0()
        ;   Label: LAB_00558eca
    JMP 0x00558ddf                      ; 00558ecf
        ;   XREF to: 00558ddf (UNCONDITIONAL_JUMP)  ; LAB_00558ddf
    CALL wincore_wddvmem.cpp_stubFunction_FUN_00553ca0 ; 00558ed4
        ;   XREF to: 00553ca0 (UNCONDITIONAL_CALL)  ; void wincore_wddvmem.cpp_stubFunction_FUN_00553ca0()
        ;   Label: LAB_00558ed4
