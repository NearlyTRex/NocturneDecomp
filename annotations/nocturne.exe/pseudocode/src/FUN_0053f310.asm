...
section .text
    ...
    MOV ESI,dword ptr [0x02ddf9a8]      ; 0053f3d7 | DAT_02ddf9a8
        ;   Label: LAB_0053f3d7
    PUSH ESI                            ; 0053f3dd
    PUSH ECX                            ; 0053f3de
    CALL FUN_0040d890                   ; 0053f3df
    ...
    PUSH EAX                            ; 0053f432
    PUSH EBX                            ; 0053f433
    CALL FUN_0042a500                   ; 0053f434
        ;   XREF to: 0042a500 (UNCONDITIONAL_CALL)  ; undefined FUN_0042a500()
    ...
    JMP dword ptr [EAX*0x4 + 0x53f2ec]  ; 0053f480 | caseD_6 | caseD_7 | caseD_8
        ;   Label: switchD
    MOV EDX,dword ptr [0x01bca0c0]      ; 0053f487 | DAT_01bca0c0
        ;   Label: caseD_6
    PUSH EDX                            ; 0053f48d
    MOV ECX,dword ptr [EBX + 0x1fa94]   ; 0053f48e
    PUSH ECX                            ; 0053f494
    CALL FUN_0040d890                   ; 0053f495
        ;   XREF to: 0040d890 (UNCONDITIONAL_CALL)  ; undefined FUN_0040d890()
    ...
    JZ 0x0053f4b6                       ; 0053f4a3
        ;   XREF to: 0053f4b6 (CONDITIONAL_JUMP)  ; caseD_b
    PUSH EAX                            ; 0053f4a5
    CALL FUN_0046ed80                   ; 0053f4a6
        ;   XREF to: 0046ed80 (UNCONDITIONAL_CALL)  ; undefined FUN_0046ed80()
    ...
    PUSH EDX                            ; 0053f55e
    PUSH EBX                            ; 0053f55f
    CALL FUN_004b5c70                   ; 0053f560
        ;   XREF to: 004b5c70 (UNCONDITIONAL_CALL)  ; undefined FUN_004b5c70()
    ...
    PUSH EDX                            ; 0053f60c
    CALL FUN_004c1830                   ; 0053f60d
        ;   XREF to: 004c1830 (UNCONDITIONAL_CALL)  ; undefined FUN_004c1830()
    ...
    PUSH ESI                            ; 0053f642
        ;   Label: LAB_0053f642
    PUSH EBX                            ; 0053f643
    CALL FUN_0042aa50                   ; 0053f644
        ;   XREF to: 0042aa50 (UNCONDITIONAL_CALL)  ; undefined FUN_0042aa50()
    ...
    JMP 0x0053f424                      ; 0053f800
        ;   XREF to: 0053f424 (UNCONDITIONAL_JUMP)  ; LAB_0053f424
    MOV EDI,dword ptr [0x01cc56dc]      ; 0053f805 | DAT_01cc56dc
        ;   Label: LAB_0053f805
    PUSH EDI                            ; 0053f80b
    PUSH EAX                            ; 0053f80c
    CALL FUN_0040d890                   ; 0053f80d
        ;   XREF to: 0040d890 (UNCONDITIONAL_CALL)  ; undefined FUN_0040d890()
    ...
    JMP 0x0053f424                      ; 0053f851
        ;   XREF to: 0053f424 (UNCONDITIONAL_JUMP)  ; LAB_0053f424
    MOV EDX,dword ptr [0x01cc56dc]      ; 0053f856 | DAT_01cc56dc
        ;   Label: LAB_0053f856
    PUSH EDX                            ; 0053f85c
    PUSH EAX                            ; 0053f85d
    CALL FUN_0040d890                   ; 0053f85e
        ;   XREF to: 0040d890 (UNCONDITIONAL_CALL)  ; undefined FUN_0040d890()
    ...
    PUSH ECX                            ; 0053f8ce
    CALL FUN_0046ed30                   ; 0053f8cf
        ;   XREF to: 0046ed30 (UNCONDITIONAL_CALL)  ; undefined FUN_0046ed30()
    ...
    MOV EAX,[0x01cc56dc]                ; 0053fad4 | DAT_01cc56dc
        ;   Label: LAB_0053fad4
    PUSH EAX                            ; 0053fad9
    PUSH EDX                            ; 0053fada
    CALL FUN_0040d890                   ; 0053fadb
        ;   XREF to: 0040d890 (UNCONDITIONAL_CALL)  ; undefined FUN_0040d890()
    ...
    MOV EAX,[0x01cc56dc]                ; 0053fb35 | DAT_01cc56dc
        ;   Label: LAB_0053fb35
    PUSH EAX                            ; 0053fb3a
    PUSH EDX                            ; 0053fb3b
    CALL FUN_0040d890                   ; 0053fb3c
        ;   XREF to: 0040d890 (UNCONDITIONAL_CALL)  ; undefined FUN_0040d890()
