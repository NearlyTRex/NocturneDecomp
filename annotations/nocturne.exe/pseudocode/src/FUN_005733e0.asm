...
section .text
    ...
    PUSH ECX                            ; 005734d0
    CALL dword ptr [0x005c1ac4]         ; 005734d1 | PTR_FUN_005c1ac4
    ...
    PUSH ECX                            ; 0057354e
    CALL dword ptr [0x005c1ac4]         ; 0057354f | PTR_FUN_005c1ac4
    ...
    MOV EAX,dword ptr [ESP + 0x24]      ; 005735d1
        ;   Label: LAB_005735d1
    PUSH EAX                            ; 005735d5
    CALL dword ptr [0x005c1ac4]         ; 005735d6 | PTR_FUN_005c1ac4
        ;   Label: LAB_005735d6
