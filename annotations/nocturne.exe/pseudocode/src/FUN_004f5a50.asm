...
;                               FUNCTION
; *****************************************************************************
; void FUN_004f5a50(int *param_1,undefined4 param_2,int param_3)
;
;
; XREF[1]:
;   FUN_004f5c80 at 004f5cd8
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBP                            ; 004f5afb
    PUSH EDI                            ; 004f5afc
    CALL FUN_004f5a20                   ; 004f5afd
        ;   XREF to: 004f5a20 (UNCONDITIONAL_CALL)  ; undefined FUN_004f5a20()
    ...
    PUSH EBP                            ; 004f5b0b
    PUSH EDI                            ; 004f5b0c
    CALL FUN_004f5740                   ; 004f5b0d
        ;   XREF to: 004f5740 (UNCONDITIONAL_CALL)  ; undefined FUN_004f5740()
