...
section .text
    ...
    PUSH ESI                            ; 0053fcfd
    CALL FUN_0046fcd0                   ; 0053fcfe
        ;   XREF to: 0046fcd0 (UNCONDITIONAL_CALL)  ; undefined FUN_0046fcd0()
    ADD ESP,0xc                         ; 0053fd03
    PUSH EBX                            ; 0053fd06
        ;   Label: LAB_0053fd06
    CALL FUN_0053c800                   ; 0053fd07
        ;   XREF to: 0053c800 (UNCONDITIONAL_CALL)  ; undefined FUN_0053c800()
