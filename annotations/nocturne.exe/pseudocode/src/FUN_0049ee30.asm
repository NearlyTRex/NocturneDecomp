...
;
; XREF[3]:
;   FUN_0049e7d0 at 0049e806
;   FUN_0049ec80 at 0049ec98
;   FUN_0049f710 at 0049f724
;
; Referenced Globals:
;   undefined4 DAT_005829ea
;   undefined4 DAT_005829ee
;   undefined4 DAT_005829f2
;   undefined4 DAT_005829f6
;   undefined4 DAT_005829fa
;   undefined4 DAT_00582a02
;   undefined4 DAT_00582a0a
;   undefined4 DAT_00582a0e
;   undefined4 DAT_00582a12
...
section .text
    ...
    FCOMP float ptr [0x005829ee]        ; 0049ee6b | DAT_005829ee
    FNSTSW AX                           ; 0049ee71
    SAHF                                ; 0049ee73
    ...
    FDIV float ptr [0x005829ea]         ; 0049ee81 | DAT_005829ea
    FSUBR float ptr [EDX]               ; 0049ee87
    FST float ptr [EDX]                 ; 0049ee89
    FCOMP float ptr [0x005829ee]        ; 0049ee8b | DAT_005829ee
    FNSTSW AX                           ; 0049ee91
    SAHF                                ; 0049ee93
    ...
    FCOMP float ptr [0x005829ee]        ; 0049eec4 | DAT_005829ee
    FNSTSW AX                           ; 0049eeca
    SAHF                                ; 0049eecc
    ...
    FDIV float ptr [0x005829ea]         ; 0049eeda | DAT_005829ea
    FSUBR float ptr [EDX]               ; 0049eee0
    FST float ptr [EDX]                 ; 0049eee2
    FCOMP float ptr [0x005829ee]        ; 0049eee4 | DAT_005829ee
    FNSTSW AX                           ; 0049eeea
    SAHF                                ; 0049eeec
    ...
    FMUL float ptr [0x005829f2]         ; 0049ef00 | DAT_005829f2
    FDIV float ptr [0x005829f6]         ; 0049ef06 | DAT_005829f6
    FLDZ                                ; 0049ef0c
    ...
    FILD dword ptr [EBX + 0xa0]         ; 0049ef49
        ;   Label: LAB_0049ef49
    FMUL double ptr [0x00582a12]        ; 0049ef4f | DAT_00582a12
    FMUL double ptr [0x00582a02]        ; 0049ef55 | DAT_00582a02
    ...
    FCOMP float ptr [0x00582a0a]        ; 0049ef77 | DAT_00582a0a
    FNSTSW AX                           ; 0049ef7d
    SAHF                                ; 0049ef7f
    ...
    FMUL float ptr [0x005829f2]         ; 0049ef8d | DAT_005829f2
    FDIV float ptr [ESP + 0x8]          ; 0049ef93
    FSUBR float ptr [EDX]               ; 0049ef97
    FST float ptr [EDX]                 ; 0049ef99
    FCOMP float ptr [0x00582a0a]        ; 0049ef9b | DAT_00582a0a
    FNSTSW AX                           ; 0049efa1
    SAHF                                ; 0049efa3
    ...
    MOV ECX,dword ptr [EBX + 0x7c]      ; 0049f0dd
        ;   Label: LAB_0049f0dd
    MOV EAX,[0x005bac64]                ; 0049f0e0 | DAT_005bac64
    PUSH ECX                            ; 0049f0e5
    ...
    PUSH EAX                            ; 0049f143
    CALL FUN_004c0850                   ; 0049f144
        ;   XREF to: 004c0850 (UNCONDITIONAL_CALL)  ; undefined FUN_004c0850()
    ADD ESP,0x10                        ; 0049f149
    MOV EDI,dword ptr [EBX + 0x84]      ; 0049f14c
        ;   Label: LAB_0049f14c
    MOV EAX,[0x005bac64]                ; 0049f152 | DAT_005bac64
    PUSH EDI                            ; 0049f157
    ...
    PUSH EAX                            ; 0049f178
    CALL FUN_004c0950                   ; 0049f179
        ;   XREF to: 004c0950 (UNCONDITIONAL_CALL)  ; undefined FUN_004c0950()
    ADD ESP,0x8                         ; 0049f17e
    MOV EBP,dword ptr [EBX + 0x88]      ; 0049f181
        ;   Label: LAB_0049f181
    MOV EAX,[0x005bac64]                ; 0049f187 | DAT_005bac64
    PUSH EBP                            ; 0049f18c
    ...
    PUSH EAX                            ; 0049f1ad
    CALL FUN_004c0950                   ; 0049f1ae
        ;   XREF to: 004c0950 (UNCONDITIONAL_CALL)  ; undefined FUN_004c0950()
    ADD ESP,0x8                         ; 0049f1b3
    MOV ECX,dword ptr [EBX + 0x90]      ; 0049f1b6
        ;   Label: LAB_0049f1b6
    MOV EAX,[0x005bac64]                ; 0049f1bc | DAT_005bac64
    PUSH ECX                            ; 0049f1c1
    ...
    PUSH EAX                            ; 0049f1e2
    CALL FUN_004c0a50                   ; 0049f1e3
        ;   XREF to: 004c0a50 (UNCONDITIONAL_CALL)  ; undefined FUN_004c0a50()
    ADD ESP,0x8                         ; 0049f1e8
    MOV ESI,dword ptr [EBX + 0x8c]      ; 0049f1eb
        ;   Label: LAB_0049f1eb
    MOV EAX,[0x005bac64]                ; 0049f1f1 | DAT_005bac64
    PUSH ESI                            ; 0049f1f6
    ...
    PUSH EAX                            ; 0049f215
    CALL FUN_004c32e0                   ; 0049f216
        ;   XREF to: 004c32e0 (UNCONDITIONAL_CALL)  ; undefined FUN_004c32e0()
    ADD ESP,0x4                         ; 0049f21b
    MOV EDI,dword ptr [EBX + 0x68]      ; 0049f21e
        ;   Label: LAB_0049f21e
    MOV EAX,[0x005bac64]                ; 0049f221 | DAT_005bac64
    PUSH EDI                            ; 0049f226
    ...
    PUSH EAX                            ; 0049f24b
    CALL FUN_004c0850                   ; 0049f24c
        ;   XREF to: 004c0850 (UNCONDITIONAL_CALL)  ; undefined FUN_004c0850()
    ADD ESP,0x10                        ; 0049f251
    MOV EBP,dword ptr [EBX + 0x6c]      ; 0049f254
        ;   Label: LAB_0049f254
    MOV EAX,[0x005bac64]                ; 0049f257 | DAT_005bac64
    PUSH EBP                            ; 0049f25c
    ...
    PUSH EAX                            ; 0049f281
    CALL FUN_004c0850                   ; 0049f282
        ;   XREF to: 004c0850 (UNCONDITIONAL_CALL)  ; undefined FUN_004c0850()
    ADD ESP,0x10                        ; 0049f287
    MOV ECX,dword ptr [EBX + 0x70]      ; 0049f28a
        ;   Label: LAB_0049f28a
    MOV EDX,dword ptr [0x005bac64]      ; 0049f28d | DAT_005bac64
    PUSH ECX                            ; 0049f293
    ...
    PUSH EAX                            ; 0049f2b8
    CALL FUN_004c0850                   ; 0049f2b9
        ;   XREF to: 004c0850 (UNCONDITIONAL_CALL)  ; undefined FUN_004c0850()
    ADD ESP,0x10                        ; 0049f2be
    MOV ESI,dword ptr [EBX + 0x74]      ; 0049f2c1
        ;   Label: LAB_0049f2c1
    MOV EAX,[0x005bac64]                ; 0049f2c4 | DAT_005bac64
    PUSH ESI                            ; 0049f2c9
    ...
    PUSH EAX                            ; 0049f2ee
    CALL FUN_004c0850                   ; 0049f2ef
        ;   XREF to: 004c0850 (UNCONDITIONAL_CALL)  ; undefined FUN_004c0850()
    ADD ESP,0x10                        ; 0049f2f4
    MOV EDI,dword ptr [EBX + 0x78]      ; 0049f2f7
        ;   Label: LAB_0049f2f7
    MOV EAX,[0x005bac64]                ; 0049f2fa | DAT_005bac64
    PUSH EDI                            ; 0049f2ff
    ...
    PUSH EAX                            ; 0049f324
    CALL FUN_004c0850                   ; 0049f325
        ;   XREF to: 004c0850 (UNCONDITIONAL_CALL)  ; undefined FUN_004c0850()
    ADD ESP,0x10                        ; 0049f32a
    MOV EBP,dword ptr [EBX + 0x54]      ; 0049f32d
        ;   Label: LAB_0049f32d
    MOV EAX,[0x005bac64]                ; 0049f330 | DAT_005bac64
    PUSH EBP                            ; 0049f335
    ...
    PUSH 0x200                          ; 0049f3e1
        ;   Label: LAB_0049f3e1
    MOV EAX,[0x005bac64]                ; 0049f3e6 | DAT_005bac64
    ...
    MOV EAX,[0x005bac64]                ; 0049f3f4 | DAT_005bac64
    PUSH 0x201                          ; 0049f3f9
    ...
    FDIV float ptr [0x005829ea]         ; 0049f430 | DAT_005829ea
    ...
    FDIV float ptr [0x005829ea]         ; 0049f475 | DAT_005829ea
    ...
    FILD dword ptr [EBX + 0x9c]         ; 0049f4bd
        ;   Label: LAB_0049f4bd
    FMUL double ptr [0x005829fa]        ; 0049f4c3 | DAT_005829fa
    FMUL double ptr [0x00582a02]        ; 0049f4c9 | DAT_00582a02
    ...
    FCOMP float ptr [0x00582a0a]        ; 0049f4eb | DAT_00582a0a
    FNSTSW AX                           ; 0049f4f1
    SAHF                                ; 0049f4f3
    ...
    FMUL float ptr [0x005829f2]         ; 0049f505 | DAT_005829f2
    FDIV float ptr [ESP + 0x10]         ; 0049f50b
    FSUBR float ptr [EDX]               ; 0049f50f
    FST float ptr [EDX]                 ; 0049f511
    FCOMP float ptr [0x00582a0a]        ; 0049f513 | DAT_00582a0a
    FNSTSW AX                           ; 0049f519
    SAHF                                ; 0049f51b
    ...
    FMUL float ptr [0x005829f2]         ; 0049f544 | DAT_005829f2
    FDIV float ptr [0x005829f6]         ; 0049f54a | DAT_005829f6
    FLDZ                                ; 0049f550
    ...
    FMUL float ptr [0x005829f2]         ; 0049f591 | DAT_005829f2
    ...
    FMUL float ptr [0x005829f2]         ; 0049f5ed | DAT_005829f2
    FDIV float ptr [0x00582a0e]         ; 0049f5f3 | DAT_00582a0e
    FLDZ                                ; 0049f5f9
    ...
    FMUL float ptr [0x005829f2]         ; 0049f651 | DAT_005829f2
