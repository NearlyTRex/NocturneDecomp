...
// Convention: unknown
// Signature: void FUN_0043aec0(int param_1)
...

{
    ...
    do {
      ...
      if (0 < *(int *)(param_1 + 0xfac)) {
        ...
        do {
          ...
          if (local_14[0] != '\0') {
            FUN_004026b0(local_14,*(int *)(param_1 + 0xfb4) + iVar4,
  ...
  iVar5 = iVar4 + -1;
  _DAT_01c00c70 = 0xf8;
  FUN_004015a0(iVar3,iVar5,iVar2,iVar5);
  iVar4 = iVar4 + iVar1 * 0xb + 1;
  FUN_004015a0(iVar3,iVar4,iVar2,iVar4);
  FUN_004015a0(iVar3 + -1,iVar5,iVar3 + -1,iVar4);
  FUN_004015a0(iVar2 + 1,iVar5,iVar2 + 1,iVar4);
  return;
}
