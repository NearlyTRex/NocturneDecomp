...

{
  ...
  local_a8 = ((float)_DAT_0057c7b6 / *(float *)(param_1 + 0x138)) * *(float *)(param_1 + 0x100);
  iVar5 = 0;
  local_38 = *(float *)(param_1 + 0x100);
  iVar4 = 0;
  do {
    fVar6 = (float10)iVar5 * (float10)_DAT_0057c7be * (float10)_DAT_0057c7c6;
  ...
  *(uint *)(*DAT_005ae704 + 800) = 0xffff;
  ...
  uVar8 = 0x44f39a;
  fVar6 = (float10)round
                             ((float10)*(float *)(param_1 + 0x100) * (float10)_DAT_0057c7d6);
