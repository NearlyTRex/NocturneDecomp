...
// Convention: unknown
// Signature: void FUN_00451350(int param_1)
...

{
  ...
  if (((*(int *)(param_1 + 0x1cbc) != 0) &&
    ...
    if (0.0 < local_54) {
      ...
      FUN_0044da40(param_1 + 0x110,local_108,&local_120);
      FUN_00460d30(DAT_005ae704,&local_138);
      local_138 = local_138 - *(float *)(param_1 + 0x104);
      local_134 = local_134 - *(float *)(param_1 + 0x108);
      local_130 = local_130 - *(float *)(param_1 + 0x10c);
      pfVar4 = (float *)FUN_0044daa0(param_1 + 0x110,local_cc,&local_138);
      if (&local_138 != pfVar4) {
        local_138 = *pfVar4;
        local_134 = pfVar4[1];
        local_130 = pfVar4[2];
      ...
      if ((fVar1 <= fVar2) || (local_58 <= (float)_DAT_0057c8de)) {
        ...
        FUN_0044dbd0(param_1 + 0x110,local_b4);
        local_50 = 1;
        FUN_00460aa0(DAT_005ae704,local_b4,0);
        do {
          ...
          do {
            ...
            fVar7 = (float10)local_14 - (float10)local_14 * (float10)local_30;
            FUN_00563a30();
            local_78 = (int)ROUND(fVar7);
            local_34 = (float)(fVar8 * fVar10);
            fVar7 = (float10)local_18 * (float10)local_34 + (float10)local_18;
            fVar9 = fVar9 * fVar10;
            iVar5 = FUN_00563a30();
            ...
            do {
              ...
              FUN_0053075c(*DAT_005ae704,&local_12c);
              local_f4 = local_2c;
              ...
              FUN_0053075c(*DAT_005ae704 + 0x30,&local_a8);
              local_f4 = local_2c;
              ...
              FUN_0053075c(*DAT_005ae704 + 0x60,&local_d8);
              local_f4 = local_28;
              ...
              FUN_0053075c(*DAT_005ae704 + 0x90,&local_c0);
              piVar3 = DAT_005ae704;
              ...
              *(int *)(*piVar3 + 0xb0) = local_64;
              ...
              local_148 = 3;
              local_24 = iVar5;
              FUN_00460e80(piVar3,local_160,&LAB_004442a0);
            } while (iVar5 < 4);
            local_48 = local_48 + 1;
          } while (local_48 < 0x10);
          local_50 = local_50 + 1;
