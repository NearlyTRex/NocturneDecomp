...
section .text
    ...
    PUSH ECX                            ; 004fd1b4
        ;   Label: LAB_004fd1b4
    PUSH EBX                            ; 004fd1b5
    CALL FUN_004fd1d0                   ; 004fd1b6
        ;   XREF to: 004fd1d0 (UNCONDITIONAL_CALL)  ; undefined FUN_004fd1d0()
