...
// Convention: unknown
// Signature: void FUN_00417d70(int param_1)
...

{
  ...
  if ((2 < *(int *)(param_1 + 0x16c)) && (0 < *(int *)(param_1 + 0x178))) {
    ...
    FUN_0040a240(param_1,auStack_1c,&fStack_34);
    fStack_10 = fStack_40 - fStack_4c;
    fStack_c = fStack_3c - fStack_48;
    fStack_8 = fStack_38 - fStack_44;
    FUN_0041a6e0(param_1 + 0xcb4,auStack_1c,param_1 + 0x30,&fStack_10,0x40a00000);
    return;
  }
  *(uint *)(param_1 + 0x70) = 2;
