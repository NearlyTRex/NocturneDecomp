...
// Convention: unknown
// Signature: void FUN_004ef040(undefined4 *param_1,undefined4 *param_2,undefined4 *param_3)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_004ef040(uint *param_1,uint *param_2,uint *param_3)

{
  ...
  fVar1 = (float)FUN_0040dda0(0x3f490fdb,0x3fc90fdb);
  fVar2 = (float)FUN_0040dda0(0,0x40c90fdb);
