...
// Convention: unknown
// Signature: void FUN_00427730(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,undefined4 param_5,int param_6)

#include "nocturne.h"

void FUN_00427730(int param_1,uint param_2,uint param_3,uint param_4,uint param_5,int param_6)
