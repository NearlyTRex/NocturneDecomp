...
// Convention: unknown
// Signature: undefined4 FUN_0052bef0(int param_1)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_0052bef0(int param_1)
      ...
      if (iVar1 == 0) {
        ...
        if (iVar1 == 0) {
          ...
          if (iVar1 != 0) {
            ...
            if (iVar1 != 0) {
              uVar2 = FUN_00529a90(iVar1);
              FUN_00563c90(auStack_464,"DirectSux: Unable to %s.  (%s)",
                           "Create the primary buffer",uVar2);
              puVar3 = auStack_464;
              goto LAB_0052bf91;
            }
        ...
        uVar2 = FUN_00529a90(iVar1);
        FUN_00563c90(auStack_2d4,"DirectSux: Unable to %s.  (%s)",
                     "Set cooperative level",uVar2);
        puVar3 = auStack_2d4;
      }
      else {
        uVar2 = FUN_00529a90(iVar1);
        FUN_00563c90(auStack_5f4,"DirectSux: Unable to %s.  (%s)",
                     "create DirectSound object",uVar2);
        puVar3 = auStack_5f4;
      }
LAB_0052bf91:
      FUN_00529980(puVar3);
      FUN_00529e90(0x2dc93a0);
      return 0;
    }
  }
  return 0;
