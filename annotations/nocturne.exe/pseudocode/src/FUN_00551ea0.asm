...
section .text
    ...
    PUSH EAX                            ; 00551fba
    CALL FUN_0040c880                   ; 00551fbb
        ;   XREF to: 0040c880 (UNCONDITIONAL_CALL)  ; undefined FUN_0040c880()
    ADD ESP,0x8                         ; 00551fc0
    CMP dword ptr [0x005c154c],0x5      ; 00551fc3 | DAT_005c154c
        ;   Label: LAB_00551fc3
    ...
    PUSH EAX                            ; 00551fd7
    CALL FUN_0040c900                   ; 00551fd8
        ;   XREF to: 0040c900 (UNCONDITIONAL_CALL)  ; undefined FUN_0040c900()
    ADD ESP,0x8                         ; 00551fdd
    CMP dword ptr [0x005c154c],0x6      ; 00551fe0 | DAT_005c154c
        ;   Label: LAB_00551fe0
