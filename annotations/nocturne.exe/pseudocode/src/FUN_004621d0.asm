...
section .text
    ...
    CMP dword ptr [0x005b064c],0x2      ; 004621d5 | DAT_005b064c
    ...
    PUSH EAX                            ; 0046223d
    CALL FUN_0040c450                   ; 0046223e
        ;   XREF to: 0040c450 (UNCONDITIONAL_CALL)  ; undefined FUN_0040c450()
    MOV ECX,dword ptr [0x005b064c]      ; 00462243 | DAT_005b064c
    ...
    PUSH EAX                            ; 00462270
    CALL FUN_0040c880                   ; 00462271
        ;   XREF to: 0040c880 (UNCONDITIONAL_CALL)  ; undefined FUN_0040c880()
    ADD ESP,0x8                         ; 00462276
    PUSH 0x57de45                       ; 00462279 | = "dripRadius"
    LEA EAX,[EBX + 0x2e0]               ; 0046227e
    PUSH EAX                            ; 00462284
    CALL FUN_0040c880                   ; 00462285
        ;   XREF to: 0040c880 (UNCONDITIONAL_CALL)  ; undefined FUN_0040c880()
    ADD ESP,0x8                         ; 0046228a
    CMP dword ptr [0x005b064c],0x4      ; 0046228d | DAT_005b064c
        ;   Label: LAB_0046228d
    ...
    PUSH EAX                            ; 004622a1
    CALL FUN_0040c880                   ; 004622a2
        ;   XREF to: 0040c880 (UNCONDITIONAL_CALL)  ; undefined FUN_0040c880()
    ADD ESP,0x8                         ; 004622a7
    CMP dword ptr [0x005b064c],0x5      ; 004622aa | DAT_005b064c
        ;   Label: LAB_004622aa
