...
section .text
    ...
    PUSH 0x0                            ; 00440974
    PUSH 0x0                            ; 00440976
    CALL FUN_00532c90                   ; 00440978
        ;   XREF to: 00532c90 (UNCONDITIONAL_CALL)  ; undefined FUN_00532c90()
    ...
    PUSH EAX                            ; 004409a7
    PUSH EDI                            ; 004409a8
    CALL FUN_00440610                   ; 004409a9
        ;   XREF to: 00440610 (UNCONDITIONAL_CALL)  ; undefined FUN_00440610()
