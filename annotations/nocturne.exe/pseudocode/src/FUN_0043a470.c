...
// Convention: unknown
// Signature: void FUN_0043a470(int param_1,float param_2)
...

{
  ...
  if (*(int *)(param_1 + 0x1fa38) != 0) {
    ...
    if ((((*(int *)(param_1 + 0x1fa38) == 3) || (local_2c < _DAT_0057b174)) &&
       ...
       ((iVar4 = FUN_004b5d00(param_1,&local_88), iVar4 != 0 && (local_88 < (float)_DAT_0057b17c))))
    {
      bVar2 = true;
      iVar6 = iVar4;
    }
    ...
    if ((float)_DAT_0057b184 <= fVar1) {
      ...
      if (bVar2) {
        iVar4 = FUN_0054e4a0(local_3c,&local_54);
    ...
    pfVar5 = (float *)FUN_0054e4a0(local_6c,&local_54);
    if (&local_54 != pfVar5) {
      local_54 = *pfVar5;
      local_50 = pfVar5[1];
      local_4c = pfVar5[2];
    }
    local_44 = (float)FUN_0040df00(local_50 - *(float *)(param_1 + 0x34));
