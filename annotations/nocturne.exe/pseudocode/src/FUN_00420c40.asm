...
section .text
    ...
    PUSH EDI                            ; 00420cb1
        ;   Label: LAB_00420cb1
    PUSH ESI                            ; 00420cb2
    CALL FUN_00420a10                   ; 00420cb3
        ;   XREF to: 00420a10 (UNCONDITIONAL_CALL)  ; undefined FUN_00420a10()
