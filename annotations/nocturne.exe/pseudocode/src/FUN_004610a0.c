...
// Convention: unknown
// Signature: void FUN_004610a0(int *param_1,int param_2,int param_3)
  ...
  if (((uStack_30 & uStack_90 & 0x80000000) == 0) || ((char)(uStack_30 & uStack_90) == '\0')) {
    ...
    do {
      if (aiStack_a0[2] < aiStack_a0[0]) {
        FUN_00431530(aiStack_40,aiStack_a0,aiStack_70);
        piVar4 = aiStack_70;
        piVar5 = aiStack_a0;
      ...
      if (-aiStack_a0[0] != aiStack_a0[2] && aiStack_a0[0] <= -aiStack_a0[2]) {
        FUN_00431630(aiStack_40,aiStack_a0,aiStack_70);
        piVar4 = aiStack_70;
        piVar5 = aiStack_a0;
        for (iVar2 = 0xc; iVar2 != 0; iVar2 = iVar2 + -1) {
          *piVar5 = *piVar4;
      ...
      if (aiStack_a0[2] < aiStack_a0[1]) {
        FUN_00431730(aiStack_40,aiStack_a0,aiStack_70);
        piVar4 = aiStack_70;
        piVar5 = aiStack_a0;
        for (iVar2 = 0xc; iVar2 != 0; iVar2 = iVar2 + -1) {
          *piVar5 = *piVar4;
      ...
      if (-aiStack_a0[1] != aiStack_a0[2] && aiStack_a0[1] <= -aiStack_a0[2]) {
        FUN_00431830(aiStack_40,aiStack_a0,aiStack_70);
        piVar4 = aiStack_70;
        piVar5 = aiStack_a0;
        for (iVar2 = 0xc; iVar2 != 0; iVar2 = iVar2 + -1) {
          *piVar5 = *piVar4;
      ...
      if (aiStack_40[2] < aiStack_40[0]) {
        FUN_00431530(aiStack_a0,aiStack_40,aiStack_70);
        piVar4 = aiStack_70;
        piVar5 = aiStack_40;
        for (iVar2 = 0xc; iVar2 != 0; iVar2 = iVar2 + -1) {
          *piVar5 = *piVar4;
      ...
      if (-aiStack_40[0] != aiStack_40[2] && aiStack_40[0] <= -aiStack_40[2]) {
        FUN_00431630(aiStack_a0,aiStack_40,aiStack_70);
        piVar4 = aiStack_70;
        piVar5 = aiStack_40;
        for (iVar2 = 0xc; iVar2 != 0; iVar2 = iVar2 + -1) {
          *piVar5 = *piVar4;
      ...
      if (aiStack_40[2] < aiStack_40[1]) {
        FUN_00431730(aiStack_a0,aiStack_40,aiStack_70);
        piVar4 = aiStack_70;
        piVar5 = aiStack_40;
        for (iVar2 = 0xc; iVar2 != 0; iVar2 = iVar2 + -1) {
          *piVar5 = *piVar4;
      ...
      if (-aiStack_40[1] != aiStack_40[2] && aiStack_40[1] <= -aiStack_40[2]) {
        FUN_00431830(aiStack_a0,aiStack_40,aiStack_70);
        piVar4 = aiStack_70;
        piVar5 = aiStack_40;
        for (iVar2 = 0xc; iVar2 != 0; iVar2 = iVar2 + -1) {
          *piVar5 = *piVar4;
    ...
    if ((((((aiStack_40[0] <= aiStack_40[2]) &&
      ...
      FUN_004cd300(0x4e1e);
      FUN_004cd300(19999);
      FUN_004f99d0(*param_1 + 0xea5a0,2);
      iVar1 = *param_1;
      FUN_00401710(*(int *)(iVar1 + 0xea5b0) >> 0x10,*(int *)(iVar1 + 0xea5b4) >> 0x10,
