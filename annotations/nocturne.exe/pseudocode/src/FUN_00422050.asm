...
;
; Referenced Globals:
;   undefined4 DAT_00579d1d
;   undefined4 DAT_00579d25
...
section .text
    ...
    FCOMP double ptr [0x00579d1d]       ; 004220b5 | DAT_00579d1d
    FNSTSW AX                           ; 004220bb
    SAHF                                ; 004220bd
    ...
    FABS                                ; 004220c8
    FCOMP double ptr [0x00579d1d]       ; 004220ca | DAT_00579d1d
    FNSTSW AX                           ; 004220d0
    SAHF                                ; 004220d2
    ...
    FABS                                ; 004220dd
    FCOMP double ptr [0x00579d1d]       ; 004220df | DAT_00579d1d
    FNSTSW AX                           ; 004220e5
    SAHF                                ; 004220e7
    ...
    FXCH                                ; 004222b3
    FLD float ptr [0x00579d25]          ; 004222b5 | DAT_00579d25
    FXCH                                ; 004222bb
    FMUL ST1                            ; 004222bd
    FXCH ST2                            ; 004222bf
