...
// Convention: unknown
// Signature: void FUN_0043ebf0(int param_1,float param_2)
...

{
  ...
  if (((*(int *)(param_1 + 0x65b28) != 0) || (*(int *)(param_1 + 0x188) != 0)) &&
    ...
    iVar3 = FUN_0047dc30(0x01C03A10,param_1 + 0x18c);
    if (iVar3 != 0) {
      *(uint *)(param_1 + 0x188) = 1;
    }
    iVar3 = FUN_005649c0(param_1 + 0x18c,&DAT_0057b50e);
