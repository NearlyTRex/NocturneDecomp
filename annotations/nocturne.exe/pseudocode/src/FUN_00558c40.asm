...
section .text
    ...
    PUSH EDI                            ; 00558c42
    PUSH EBP                            ; 00558c43
    MOV EAX,[0x005c1654]                ; 00558c44 | DAT_005c1654
    ...
    MOV dword ptr [0x005c1654],EDX      ; 00558cd7 | DAT_005c1654
    ...
    MOV dword ptr [0x005c1654],EBP      ; 00558ceb | DAT_005c1654
