...
section .text
    ...
    FCOMP double ptr [0x0057d756]       ; 0045a3d7 | DAT_0057d756
    FNSTSW AX                           ; 0045a3dd
    SAHF                                ; 0045a3df
    ...
    FLD float ptr [EBX + 0xbdb4]        ; 0045a409
        ;   Label: LAB_0045a409
    FSUBR double ptr [0x0057d756]       ; 0045a40f | DAT_0057d756
