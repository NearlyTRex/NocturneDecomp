...
section .text
    ...
    PUSH EAX                            ; 0049766b
    PUSH EBX                            ; 0049766c
    CALL FUN_0040a240                   ; 0049766d
        ;   XREF to: 0040a240 (UNCONDITIONAL_CALL)  ; undefined FUN_0040a240()
    ADD ESP,0xc                         ; 00497672
    LEA EAX,[ESP + 0x8]                 ; 00497675
    PUSH EAX                            ; 00497679
    CALL FUN_00423ed0                   ; 0049767a
    ...
    PUSH EBX                            ; 004977cd
        ;   Label: caseD_13
    CALL FUN_00498790                   ; 004977ce
        ;   XREF to: 00498790 (UNCONDITIONAL_CALL)  ; undefined FUN_00498790()
