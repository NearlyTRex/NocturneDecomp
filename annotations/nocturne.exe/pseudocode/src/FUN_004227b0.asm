...
section .text
    ...
    PUSH ECX                            ; 0042282a
    CALL FUN_00421f00                   ; 0042282b
        ;   XREF to: 00421f00 (UNCONDITIONAL_CALL)  ; undefined FUN_00421f00()
