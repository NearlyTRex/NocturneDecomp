...
;                               FUNCTION
; *****************************************************************************
; void FUN_005200c0(int param_1,float param_2)
;
; Local Variables:
...
section .text
    ...
    MOV EDX,dword ptr [0x005ad350]      ; 00520432 | PTR_DAT_005ad350
    PUSH EDX                            ; 00520438 | DAT_0077ad0c
    CALL FUN_0043ac60                   ; 00520439
    ...
    PUSH EAX                            ; 005205ee
    PUSH EBX                            ; 005205ef
    CALL FUN_0040a240                   ; 005205f0
        ;   XREF to: 0040a240 (UNCONDITIONAL_CALL)  ; undefined FUN_0040a240()
    ADD ESP,0xc                         ; 005205f5
    PUSH EAX                            ; 005205f8
    PUSH EBX                            ; 005205f9
    CALL FUN_004798e0                   ; 005205fa
        ;   XREF to: 004798e0 (UNCONDITIONAL_CALL)  ; undefined FUN_004798e0()
    ...
    PUSH EAX                            ; 0052067b
    PUSH EBX                            ; 0052067c
    CALL FUN_0040a240                   ; 0052067d
        ;   XREF to: 0040a240 (UNCONDITIONAL_CALL)  ; undefined FUN_0040a240()
    ADD ESP,0xc                         ; 00520682
    PUSH EDI                            ; 00520685
    LEA EAX,[EBP + 0x3e]                ; 00520686
    PUSH EAX                            ; 00520689
    MOV EAX,[0x005b96c4]                ; 0052068a | DAT_005b96c4
    PUSH EAX                            ; 0052068f
    CALL FUN_004b0480                   ; 00520690
    ...
    PUSH EDI                            ; 00520951
    MOV EAX,[0x005be368]                ; 00520952 | DAT_005be368
    PUSH EAX                            ; 00520957 | DAT_01e57284
    CALL FUN_00511780                   ; 00520958
