...
// Convention: unknown
// Signature: void FUN_00454100(int param_1,undefined4 *param_2)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_00454100(int param_1,uint *param_2)

{
  ...
  iVar3 = param_1 + 0x370;
  FUN_0044d7a0(iVar3,param_1 + 0x364);
  local_30 = 0;
    ...
    do {
      ...
      if (0 < *(int *)(param_1 + 0x110)) {
        ...
        do {
          ...
          pfVar2 = (float *)FUN_0044da40(local_28,local_3c,&local_48);
          if (&local_48 != pfVar2) {
            local_48 = *pfVar2;
            local_44 = pfVar2[1];
            local_40 = pfVar2[2];
          }
          pfVar2 = (float *)FUN_0044da40(local_2c,local_78,&local_54);
          if (&local_54 != pfVar2) {
            local_54 = *pfVar2;
            local_50 = pfVar2[1];
            local_4c = pfVar2[2];
          ...
          if (2 < *(int *)(local_14 + 4)) {
            ...
            do {
              ...
              pfVar2 = (float *)FUN_0044da40(local_1c,local_6c,&local_60);
              if (&local_60 != pfVar2) {
                local_60 = *pfVar2;
                local_5c = pfVar2[1];
                local_58 = pfVar2[2];
              }
              FUN_0046c5b0(iVar4,&local_48,&local_54,&local_60);
              iVar4 = iVar4 + 0x38;
