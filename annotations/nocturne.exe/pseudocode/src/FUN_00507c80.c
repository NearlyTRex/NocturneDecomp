...
// Convention: unknown
// Signature: void FUN_00507c80(int param_1,undefined4 param_2,int param_3)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_00507c80(int param_1,uint param_2,int param_3)

{
  ...
  FUN_00460c70(DAT_005ae704,&DAT_005be36c);
  FUN_00460c40(DAT_005ae704,0x3e800000);
...
LAB_00507e84:
    ...
    if ((0 < iVar3) && (iVar1 = *(int *)(iVar1 + 0x198), iVar1 != 0)) {
      FUN_0046ace0(&DAT_01fba938,iVar3,iVar1);
      goto LAB_00507e84;
    }
    param_3 = 2;
LAB_00507d02:
  ...
  if (param_3 == 2) {
    ...
    FUN_0046ae40(&DAT_01fba938,iVar3 + 400,iVar3 + 0x194);
  }
LAB_00507d51:
  iVar3 = FUN_00461090(DAT_005ae704);
  if (iVar3 == 0) {
    if (_DAT_01c02594 == 0) {
      FUN_0050e210(param_1);
    }
    if (_DAT_01c02594 == 0) {
      if (*(int *)(param_1 + 0x15a8ac) != 0) {
        ...
        FUN_00460a00(DAT_005ae704,&local_1c);
        FUN_00453040(0x1fbacc8,0,0,0xffffffff);
      }
      if ((*(int *)(param_1 + 0x15a8a8) == 0) && (*(int *)(param_1 + 0x161240) != 0)) {
        FUN_00463580(0x01B7B4E8,param_1 + 0x161244,*(uint *)(param_1 + 0x161264));
      }
      if ((*(int *)(param_1 + 0x15a8a4) == 0) && (FUN_00550800(0x02DD1210), *0x02DD1210 == 0)) {
        FUN_00550cb0(0x02DD1210,1);
      }
      if (*(int *)(param_1 + 0x15a8c0) != 0) {
        FUN_00549310(0x02DD10C8,1);
      }
    }
    iVar1 = 0;
    iVar3 = param_1;
    if (0 < *(int *)(param_1 + 0x15a8cc)) {
      do {
        FUN_004d7980(*(int *)(iVar3 + 0x15a8d0) + 0x1e4);
