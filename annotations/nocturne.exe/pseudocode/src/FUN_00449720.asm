...
section .text
    ...
    PUSH EBP                            ; 00449b91
    PUSH EBX                            ; 00449b92
    CALL FUN_00449680                   ; 00449b93
        ;   XREF to: 00449680 (UNCONDITIONAL_CALL)  ; undefined FUN_00449680()
