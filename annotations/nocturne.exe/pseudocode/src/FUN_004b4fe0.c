...
// Convention: unknown
// Signature: undefined4 FUN_004b4fe0(int param_1)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_004b4fe0(int param_1)

{
  ...
  local_4c = 0;
  local_48 = 0x3fc00000;
  FUN_0040a240(param_1,local_38,&local_50);
  local_14 = 0;
  do {
    ...
    if ((*(char *)(iVar1 + 0x252c) != '\0') && (iVar1 != param_1)) {
      ...
      if (ABS(*(float *)(iVar1 + 0x24) - *(float *)(param_1 + 0x24)) <= (float)_DAT_0058582b) {
        ...
        if (SQRT(local_20[2] * local_20[2] + local_20[0] * local_20[0]) <= (float)_DAT_00585833) {
          uVar2 = FUN_0040a220(param_1,local_2c,local_20);
          iVar3 = FUN_0054e4a0(local_44,uVar2);
          if (ABS(*(float *)(iVar3 + 4)) <= (float)_DAT_0058583b) {
            FUN_0047ab70(0x01C03A10,iVar1 + 0x252c);
            return 1;
          }
        }
      }
