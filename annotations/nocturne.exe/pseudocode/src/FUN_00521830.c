...
// Convention: unknown
// Signature: undefined4 FUN_00521830(int param_1,int *param_2,int param_3)

#include "nocturne.h"

uint FUN_00521830(int param_1,int *param_2,int param_3)

{
  ...
  iVar2 = FUN_0056582c(param_1,*param_2,0);
  if (iVar2 == 0) {
    iVar2 = FUN_005636d0(&local_18,8,1,param_1);
    if (iVar2 == 1) {
      if ((((local_18 == 'R') && (local_17 == 'I')) && (local_16 == 'F')) && (local_15 == 'F')) {
        iVar4 = local_14 + 8;
        iVar2 = FUN_005636d0(&local_88,4,1,param_1);
        if (iVar2 == 1) {
          if (((local_88 == 'W') && (local_87 == 'A')) && ((local_86 == 'V' && (local_85 == 'E'))))
          {
            iVar2 = 0xc;
            do {
              iVar3 = FUN_0056582c(param_1,*param_2 + iVar2,0);
              if (iVar3 != 0) goto LAB_00521857;
              iVar3 = FUN_005636d0(&local_18,8,1,param_1);
              ...
              if (((local_18 == 'f') && (local_17 == 'm')) && (local_16 == 't')) {
                ...
                iVar3 = FUN_005636d0(&local_24,10,1,param_1);
                if (iVar3 != 1) goto LAB_00521857;
                if ((short)local_24 != 1) {
                  FUN_00563c90(&local_88,"Invalid \"fmt\" chunk tag: %04X  (Must be 0001h = Pulse Code Modulation)",
                               local_24 & 0xffff);
                  FUN_00529980("WAV file is invalid: %s\n",&local_88);
                  goto LAB_00521857;
                }
                if ((local_24._2_2_ == 0) || (2 < local_24._2_2_)) {
                  FUN_00563c90(&local_88,"Invalid number of channels: %u  (must be 1 or 2)",local_24._2_2_)
                  ;
                  FUN_00529980("WAV file is invalid: %s\n",&local_88);
                  goto LAB_00521857;
                }
                ...
                FUN_00563c90(&local_88,"Invalid bytes/sec value: %u (%04Xh)",local_1c & 0xffff
                             ,local_1c & 0xffff);
                FUN_00529980("WAV file is invalid: %s\n",&local_88);
                goto LAB_00521857;
              }
