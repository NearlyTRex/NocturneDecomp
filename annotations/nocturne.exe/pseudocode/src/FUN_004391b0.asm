...
section .text
    ...
    PUSH EAX                            ; 004391db
    CALL FUN_00565072                   ; 004391dc
        ;   XREF to: 00565072 (UNCONDITIONAL_CALL)  ; undefined FUN_00565072()
