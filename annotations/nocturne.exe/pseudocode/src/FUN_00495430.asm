...
section .text
    ...
    POP EBX                             ; 0049546b
    RET                                 ; 0049546c
    PUSH 0x59dc60                       ; 0049546d | DAT_0059dc60
        ;   Label: LAB_0049546d
    PUSH EBX                            ; 00495472
    CALL FUN_0056445f                   ; 00495473
        ;   XREF to: 0056445f (UNCONDITIONAL_CALL)  ; undefined FUN_0056445f()
    ADD ESP,0x8                         ; 00495478
    PUSH EAX                            ; 0049547b
    CALL FUN_00564486                   ; 0049547c
