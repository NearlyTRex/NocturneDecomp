...
;
; Referenced Globals:
;   undefined1* PTR_FUN_005a1074 = 004ef6d0
...
section .text
    ...
    MOV dword ptr [EBX + 0x14c],0x5a1074 ; 004ef5d6 | PTR_FUN_005a1074
    ...
    PUSH 0x5a11b0                       ; 004ef69b | DAT_005a11b0
        ;   Label: LAB_004ef69b
    PUSH EBX                            ; 004ef6a0
    CALL FUN_0056445f                   ; 004ef6a1
        ;   XREF to: 0056445f (UNCONDITIONAL_CALL)  ; undefined FUN_0056445f()
    ADD ESP,0x8                         ; 004ef6a6
    PUSH EAX                            ; 004ef6a9
    CALL FUN_00564486                   ; 004ef6aa
