...
;
; XREF[2]:
;   FUN_00509a80 at 00509d4a
;   FUN_0050aba0 at 0050accd
;
; Referenced Globals:
...
section .text
    ...
    CALL FUN_00461050                   ; 0050a79b
        ;   XREF to: 00461050 (UNCONDITIONAL_CALL)  ; undefined FUN_00461050()
    ADD ESP,0x8                         ; 0050a7a0
    PUSH EDI                            ; 0050a7a3
    INC ESI                             ; 0050a7a4
    CALL FUN_0050e190                   ; 0050a7a5
