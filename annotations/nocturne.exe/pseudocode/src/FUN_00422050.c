...

{
  ...
  if ((*(int *)(param_1 + 0x19700) != 0) && (iVar2 = *(int *)(param_1 + 0xbca4), iVar2 != 0)) {
    ...
    if (iVar2 == 0) {
      iVar2 = FUN_004f1e00(*(int *)(param_1 + 0xbca4) + 0x20);
    }
    pfVar1 = (float *)(param_1 + 0x20);
    iVar2 = FUN_004f1600(iVar2,pfVar1,auStack_50,*(uint *)(param_1 + 0x6c));
    if (iVar2 != 0) {
      FUN_0044d7a0(auStack_a8,auStack_50);
      fStack_78 = _DAT_0059aeb4 * param_2;
      uStack_80 = 0;
      uStack_7c = 0;
      pfStack_14 = (float *)fStack_78;
      FUN_0044da40(auStack_a8,auStack_2c,&uStack_80);
      fStack_68 = *pfVar1;
      uStack_64 = *(uint *)(param_1 + 0x24);
      pfStack_14 = (float *)(param_1 + 0x28);
      fStack_60 = *pfStack_14;
      FUN_00425050(param_1,auStack_2c);
      fStack_38 = *pfVar1;
      ...
      *(float *)(param_1 + 0x28) = fStack_60;
      ...
      if ((((*(float *)(param_1 + 0x19834) <= fStack_44) &&
        ...
        FUN_00423a50(param_1,&fStack_38);
      }
    }
  }
  FUN_00421b80(param_1);
LAB_00422116:
  ...
  if (0 < *(int *)(param_1 + 0xbd28)) {
    ...
    do {
      iVar2 = iVar2 + 1;
      FUN_004227b0(param_1,iVar3,param_2,0);
      iVar3 = iVar3 + 0x40;
