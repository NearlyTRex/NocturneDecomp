...
// Convention: unknown
// Signature: undefined4 FUN_0056720c(int param_1,undefined4 param_2,HMODULE param_3)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_0056720c(int param_1,uint param_2,HMODULE param_3)

{
  ...
  _DAT_02de4e30 = param_1;
  _DAT_02de4e3c = FUN_0056e56c(param_2);
  if (_DAT_02de4e3c == 0) {
    uVar8 = 0;
    if (param_1 == 0) {
    ...
    if (param_1 != 0) {
      GetModuleFileNameA(param_3,&DAT_02de514c,0x104);
      _DAT_005c1cd4 = &DAT_02de514c;
      FUN_0056e890(param_3,0x2de5250,0x208);
