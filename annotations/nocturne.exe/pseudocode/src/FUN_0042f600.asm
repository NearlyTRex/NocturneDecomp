...
section .text
    ...
    PUSH EBX                            ; 0042f67e
    PUSH ESI                            ; 0042f67f
    CALL FUN_00430140                   ; 0042f680
        ;   XREF to: 00430140 (UNCONDITIONAL_CALL)  ; undefined FUN_00430140()
