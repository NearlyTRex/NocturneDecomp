...
// Convention: unknown
// Signature: undefined4 FUN_0052a0d0(void)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_0052a0d0(void)

{
  ...
  if (_DAT_02dc921c != (int *)0x0) {
    ...
    if (iVar4 != 0) {
      uVar3 = FUN_00529a90(iVar4);
      FUN_00563c90(auStack_1a4,"DirectSux: Unable to %s.  (%s)",
  ...
  if (_DAT_02dc9218 != (int *)0x0) {
    ...
    if (iVar4 != 0) {
      uVar3 = FUN_00529a90(iVar4);
      FUN_00563c90(auStack_334,"DirectSux: Unable to %s.  (%s)",
...
LAB_0052a120:
      ...
      FUN_00563c90(auStack_4c4,"DirectSux: Unable to %s.  (%s)",
