...
section .text
    ...
    JZ 0x0040b543                       ; 0040b524
        ;   XREF to: 0040b543 (CONDITIONAL_JUMP)  ; LAB_0040b543
    PUSH 0x5777b9                       ; 0040b526 | s_CHero_005777b8+1
    MOV ECX,dword ptr [ESP + 0x27c]     ; 0040b52b
    PUSH ECX                            ; 0040b532
    CALL FUN_0040d7e0                   ; 0040b533
    ...
    FMUL double ptr [0x00577809]        ; 0040b5ad | DAT_00577809
    MOV EAX,dword ptr [EDI + 0x2608]    ; 0040b5b3
    FLD1                                ; 0040b5b9
    FADDP                               ; 0040b5bb
    PUSH EAX                            ; 0040b5bd
    CALL FUN_00563a30                   ; 0040b5be
    ...
    PUSH EAX                            ; 0040b674
    CALL FUN_0041e200                   ; 0040b675
        ;   XREF to: 0041e200 (UNCONDITIONAL_CALL)  ; undefined FUN_0041e200()
    ...
    FADDP                               ; 0040ba18
    FSQRT                               ; 0040ba1a
    FDIVR double ptr [0x00577811]       ; 0040ba1c | DAT_00577811
