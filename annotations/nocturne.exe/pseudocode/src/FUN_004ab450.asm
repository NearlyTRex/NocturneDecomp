...
section .text
    ...
    PUSH EDI                            ; 004ab48c
        ;   Label: LAB_004ab48c
    PUSH EBX                            ; 004ab48d
    CALL FUN_004ab190                   ; 004ab48e
        ;   XREF to: 004ab190 (UNCONDITIONAL_CALL)  ; undefined FUN_004ab190()
