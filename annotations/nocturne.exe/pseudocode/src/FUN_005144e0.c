...
// Convention: unknown
// Signature: void FUN_005144e0(int param_1,undefined4 param_2)

#include "nocturne.h"

void FUN_005144e0(int param_1,uint param_2)

{
  ...
  FUN_00564b20(local_110,0xff,param_2);
  FUN_00566b5c(local_110,&DAT_00590c71,param_1);
  if (10 < *(int *)(0x01E57284 + 0x15a8c4)) {
    FUN_00564b20(local_110,0xff,param_2);
  }
  ...
  FUN_00563350(param_2,&DAT_00590c89,param_1 + 0x140);
  FUN_00564b20(local_110,0xff,param_2);
  ...
  if (*(int *)(0x01E57284 + 0x15a8c4) < 0x12) {
    ...
    *(uint *)(param_1 + 0x170) = *(uint *)(iVar1 + 0x15a868);
    ...
    FUN_00563350(param_2,&DAT_00590cab,param_1 + 0x14c);
    if (*(int *)(param_1 + 0x14c) == 0) {
      FUN_00447d10((uint *)(param_1 + 0x150),param_2,*(uint *)(0x01E57284 + 0x15a8c4))
      ;
    }
  }
  ...
  FUN_00564b20(local_110,0xff,param_2);
  FUN_00563350(param_2,&DAT_00590cc3,param_1 + 0x174);
  return;
}
