...
;                               FUNCTION
; *****************************************************************************
; void FUN_004bbaf0(int param_1,float param_2)
;
; Local Variables:
...
;   string s_ghoul-eat-?.wav_005863cc
;   string s_%s_confused_while_walking_to_scr_005863dc
...
section .text
    ...
    MOV EAX,[0x0059f56c]                ; 004bbc34 | DAT_0059f56c
    ...
    PUSH EAX                            ; 004bbd0b
    PUSH EBX                            ; 004bbd0c
    CALL FUN_0040a240                   ; 004bbd0d
        ;   XREF to: 0040a240 (UNCONDITIONAL_CALL)  ; undefined FUN_0040a240()
    ADD ESP,0xc                         ; 004bbd12
    LEA EAX,[EBP + 0xffffff26]          ; 004bbd15
    PUSH EAX                            ; 004bbd1b
    CALL FUN_00423ed0                   ; 004bbd1c
    ...
    PUSH EAX                            ; 004bbd90
    MOV ESI,dword ptr [0x005b96c4]      ; 004bbd91 | DAT_005b96c4
    PUSH ESI                            ; 004bbd97
    CALL FUN_004b0200                   ; 004bbd98
    ...
    PUSH EAX                            ; 004bc059
    PUSH EBX                            ; 004bc05a
    CALL FUN_0040a240                   ; 004bc05b
        ;   XREF to: 0040a240 (UNCONDITIONAL_CALL)  ; undefined FUN_0040a240()
    ADD ESP,0xc                         ; 004bc060
    PUSH 0x0                            ; 004bc063
    LEA EAX,[EBP + -0x3e]               ; 004bc065
    PUSH EAX                            ; 004bc068
    MOV ECX,dword ptr [0x005b96c4]      ; 004bc069 | DAT_005b96c4
    PUSH ECX                            ; 004bc06f
    CALL FUN_004b0480                   ; 004bc070
    ...
    PUSH EAX                            ; 004bc16b
    PUSH EBX                            ; 004bc16c
    CALL FUN_0040a240                   ; 004bc16d
        ;   XREF to: 0040a240 (UNCONDITIONAL_CALL)  ; undefined FUN_0040a240()
    ADD ESP,0xc                         ; 004bc172
    PUSH EAX                            ; 004bc175
    PUSH EBX                            ; 004bc176
    CALL FUN_004798e0                   ; 004bc177
    ...
    JGE 0x004bbeaf                      ; 004bc196
        ;   XREF to: 004bbeaf (CONDITIONAL_JUMP)  ; caseD_8
    MOV ECX,dword ptr [0x01cae374]      ; 004bc19c | DAT_01cae374
    PUSH ECX                            ; 004bc1a2
    MOV EDX,dword ptr [EDI + EAX*0x1 + 0x150bf8] ; 004bc1a3
    PUSH EDX                            ; 004bc1aa
    CALL FUN_0040d890                   ; 004bc1ab
    ...
    FCOMP float ptr [0x0059f56c]        ; 004bc2a1 | DAT_0059f56c
    FNSTSW AX                           ; 004bc2a7
    SAHF                                ; 004bc2a9
    ...
    FCOMP float ptr [0x0059f578]        ; 004bc2c7 | DAT_0059f578
    FNSTSW AX                           ; 004bc2cd
    SAHF                                ; 004bc2cf
    ...
    PUSH EAX                            ; 004bc3e7
    PUSH ESI                            ; 004bc3e8
    CALL FUN_004e16b0                   ; 004bc3e9
        ;   XREF to: 004e16b0 (UNCONDITIONAL_CALL)  ; undefined FUN_004e16b0()
    ADD ESP,0xc                         ; 004bc3ee
    JMP 0x004bbeaf                      ; 004bc3f1
        ;   XREF to: 004bbeaf (UNCONDITIONAL_JUMP)  ; caseD_8
    MOV EAX,[0x0059f56c]                ; 004bc3f6 | DAT_0059f56c
        ;   Label: LAB_004bc3f6
    ...
    FCOMP float ptr [0x0059f578]        ; 004bc4a5 | DAT_0059f578
    FNSTSW AX                           ; 004bc4ab
    SAHF                                ; 004bc4ad
    ...
    PUSH 0x2                            ; 004bc4b9
    PUSH ESI                            ; 004bc4bb
    CALL FUN_004e16b0                   ; 004bc4bc
        ;   XREF to: 004e16b0 (UNCONDITIONAL_CALL)  ; undefined FUN_004e16b0()
    ADD ESP,0xc                         ; 004bc4c1
    FLD float ptr [EBP + 0x6e]          ; 004bc4c4
        ;   Label: LAB_004bc4c4
    FCOMP float ptr [0x0059f57c]        ; 004bc4c7 | DAT_0059f57c
    FNSTSW AX                           ; 004bc4cd
    SAHF                                ; 004bc4cf
