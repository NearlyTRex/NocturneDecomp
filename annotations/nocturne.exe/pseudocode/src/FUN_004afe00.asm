...
;
; XREF[3]:
;   FUN_00509760 at 00509943
;   FUN_00509a80 at 00509d6c
;   FUN_0050a260 at 0050a457
;
; Referenced Globals:
...
section .text
    ...
    CALL FUN_004ae0a0                   ; 004afe4a
        ;   XREF to: 004ae0a0 (UNCONDITIONAL_CALL)  ; undefined FUN_004ae0a0()
