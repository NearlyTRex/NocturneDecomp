...
// Convention: unknown
// Signature: undefined4 FUN_0050fb00(int param_1,float *param_2,float *param_3)

#include "nocturne.h"

uint FUN_0050fb00(int param_1,float *param_2,float *param_3)

{
  ...
  local_14 = FUN_00467a00(&DAT_01fba938,param_2,param_3,puVar1,param_1 + 0x15f2f0);
  ...
  *(uint *)(param_1 + 0x14cd4c) = *(uint *)(param_1 + 0x15f2f0);
  ...
  uVar9 = FUN_0050ffe0(param_1,0xbf800000,param_2,param_3,*(uint *)(param_1 + 0x15f2e0));
