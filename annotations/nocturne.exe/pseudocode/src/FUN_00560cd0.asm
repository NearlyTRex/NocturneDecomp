...
section .text
    ...
    PUSH 0x59877e                       ; 00560d24 | DAT_0059877e
    ADD EAX,0x23b0                      ; 00560d29
    PUSH EAX                            ; 00560d2e
    CALL FUN_00564bc0                   ; 00560d2f
