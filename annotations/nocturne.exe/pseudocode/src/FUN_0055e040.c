...
// Convention: unknown
// Signature: int * FUN_0055e040(uint param_1,int *param_2)
    ...
    if (0 < (int)_DAT_02de3130) {
      ...
      do {
        ...
        case (int *)0x0:
          ...
          break;
        case (int *)0x1:
          local_28 = (int *)FUN_0055d6b0(piVar9,plVar6,&DAT_02de3140 + _DAT_02de3134 * 0x30);
          _DAT_02de3134 = _DAT_02de3134 + 1;
          break;
        case (int *)0x2:
          plVar12 = (longlong *)(&DAT_02de3140 + _DAT_02de3134 * 0x30);
          ...
          _DAT_02de3134 = _DAT_02de3134 + 1;
          local_28 = (int *)FUN_0055d6b0(plVar6,piVar9,&DAT_02de3140 + _DAT_02de3134 * 0x30);
          _DAT_02de3134 = _DAT_02de3134 + 1;
        }
        local_20 = local_20 + 1;
        plVar6 = plVar6 + 6;
      ...
      if (0 < (int)_DAT_02de3134) {
        ...
        do {
          ...
          case (int *)0x0:
            ...
            break;
          case (int *)0x1:
            local_28 = (int *)FUN_0055d770(piVar9,plVar6,_DAT_02de3138 * 0x30 + 0x2de3d40);
            _DAT_02de3138 = _DAT_02de3138 + 1;
            break;
          case (int *)0x2:
            plVar12 = (longlong *)(_DAT_02de3138 * 0x30 + 0x2de3d40);
            ...
            _DAT_02de3138 = _DAT_02de3138 + 1;
            local_28 = (int *)FUN_0055d770(plVar6,piVar9,_DAT_02de3138 * 0x30 + 0x2de3d40);
            _DAT_02de3138 = _DAT_02de3138 + 1;
          }
          local_18 = local_18 + 1;
          plVar6 = plVar6 + 6;
        ...
        if (0 < (int)_DAT_02de3138) {
          ...
          do {
            ...
            case (int *)0x0:
              ...
              break;
            case (int *)0x1:
              local_28 = (int *)FUN_0055d830(iVar8 + 0x2de3d40,plVar6,
            ...
            case (int *)0x2:
              ...
              _DAT_02de313c = _DAT_02de313c + 1;
              local_28 = (int *)FUN_0055d830(plVar6,iVar8 + 0x2de3d40,
                                             &DAT_02de4340 + _DAT_02de313c * 0x30);
              _DAT_02de313c = _DAT_02de313c + 1;
            }
            local_14 = local_14 + 1;
          ...
          if (0 < (int)_DAT_02de313c) {
            ...
            do {
              ...
              case (int *)0x0:
                ...
                break;
              case (int *)0x1:
                local_28 = (int *)FUN_0055d8f0(&DAT_02de4340 + iVar8,plVar6,
              ...
              case (int *)0x2:
                ...
                DAT_00766c70 = DAT_00766c70 + 1;
                local_28 = (int *)FUN_0055d8f0(plVar6,&DAT_02de4340 + iVar8,
                                               &DAT_00766c74 + DAT_00766c70 * 0xc);
                DAT_00766c70 = DAT_00766c70 + 1;
              }
              local_1c = local_1c + 1;
