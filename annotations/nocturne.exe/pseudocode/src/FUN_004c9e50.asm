...
section .text
    ...
    PUSH EDI                            ; 004c9f1b
    CALL FUN_0046c620                   ; 004c9f1c
        ;   XREF to: 0046c620 (UNCONDITIONAL_CALL)  ; undefined FUN_0046c620()
