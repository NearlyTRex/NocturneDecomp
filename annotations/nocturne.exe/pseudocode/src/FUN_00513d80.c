...
// Convention: unknown
// Signature: undefined4 FUN_00513d80(int param_1,int param_2,float *param_3)

#include "nocturne.h"

uint FUN_00513d80(int param_1,int param_2,float *param_3)

{
  ...
  FUN_0044daa0(pfVar1 + 6,&local_20,&local_14);
