...
// Convention: unknown
// Signature: void FUN_0053d910(int param_1,int param_2,float param_3)
...

{
  ...
  *local_24 = fVar8;
  ...
  if ((local_48 == 3) || (iVar6 = *(int *)(param_1 + 0x1f59c), iVar6 != 0)) {
    ...
    if (local_48 == 0) {
      pfVar5 = (float *)FUN_0051d2a0(param_1 + 0x150,auStack_a0,uVar11);
      ...
      pfVar5 = (float *)FUN_0051d2a0(param_1 + 0x150,auStack_c4,uVar9);
      if (&fStack_100 != pfVar5) {
        fStack_100 = *pfVar5;
        fStack_fc = pfVar5[1];
        fStack_f8 = pfVar5[2];
    ...
    FUN_0040a240(param_1,auStack_94,&fStack_100);
    fStack_70 = *local_24;
    uStack_68 = 0;
    fStack_6c = local_24[1];
    FUN_0044d7a0(auStack_128,&fStack_70);
    uStack_ac = 0;
    uStack_a8 = 0;
    uStack_a4 = 0x3f800000;
    FUN_0044da40(auStack_128,&fStack_d0,&uStack_ac);
    fStack_20 = 1e+30;
    iStack_3c = 0;
    for (iStack_40 = 0; iStack_40 < *(int *)(0x01E57284 + 0x152b38); iStack_40 = iStack_40 + 1) {
      iVar6 = FUN_0040d890(*(uint *)(0x01E57284 + iStack_3c + 0x152b3c),DAT_00765a98);
      if ((iVar6 == 0) ||
        ...
        FUN_005644a7(auStack_1a0,10,&DAT_005993b0);
        iStack_28 = (**(code **)(*(int *)(iStack_1c + 0x14c) + 0x4c))(iStack_1c,auStack_1a0);
        if ((0 < iStack_28) && (iVar6 = 0, 0 < iStack_28)) {
          puVar10 = auStack_1a0;
          do {
            FUN_0040a240(iStack_1c,auStack_88,puVar10);
            FUN_0040a290(param_1,&fStack_dc,auStack_88);
            ...
            if ((0.0 < (double)fStack_b0) && ((double)fStack_b0 <= _DAT_00595ce7)) {
              FUN_0054e4a0(&fStack_f4,&fStack_b8);
              ...
              if (((ABS(fStack_f4) <= fStack_1a8) && (local_30 <= fStack_f0)) &&
                ...
                if (fVar8 < fStack_20) {
                  ...
                  FUN_00511780(0x01E57284,iStack_1c);
                  iVar7 = FUN_0050fa30(0x01E57284,auStack_94,auStack_88);
                  FUN_00511750(0x01E57284);
                  if (iVar7 == 0) {
                    fStack_38 = fStack_f0;
                    fStack_34 = fStack_f4;
  ...
  fStack_4c = (float)FUN_0040df00(fStack_38 - local_24[3]);
  fStack_18 = fStack_4c;
  fStack_18 = (float)FUN_0040df00(fStack_34 - local_24[2]);
  fStack_54 = -fStack_44;
  ...
  fStack_18 = (float)FUN_0040df00(local_24[3] + fStack_4c);
  local_24[3] = fStack_18;
  fVar8 = (float)FUN_0040df00(local_24[2] + fStack_50);
  local_24[2] = fVar8;
  local_24[5] = 1.0;
