...
section .text
    ...
    PUSH EDX                            ; 0046f33c
    CALL FUN_00472c90                   ; 0046f33d
        ;   XREF to: 00472c90 (UNCONDITIONAL_CALL)  ; undefined FUN_00472c90()
