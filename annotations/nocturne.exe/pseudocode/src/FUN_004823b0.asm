...
;                               FUNCTION
; *****************************************************************************
; void FUN_004823b0(void)
;
;
; Referenced Globals:
;   undefined4 SUB_0048a130
;
; Called Functions:
...
section .text
    ...
    PUSH 0x1c08d04                      ; 004823b0
        ;   Label: FUN_004823b0
    CALL 0x0048a130                     ; 004823b5
        ;   XREF to: 0048a130 (UNCONDITIONAL_CALL)  ; SUB_0048a130
