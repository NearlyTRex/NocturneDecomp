...

{
  ...
  iVar2 = FUN_004613b0(DAT_005ae704);
  if (iVar2 == 0) {
      ...
      *(uint *)(param_1 + 0x2618) = 1;
      if (iVar2 == 0) {
        if (*(int *)(param_1 + 0xe19c) == 0) {
          ...
          FUN_004e0340(iVar2,0,param_1 + 0x150,0);
          FUN_004e0340(iVar2,1,iVar1,0);
          FUN_004e0380(iVar2,1,*(uint *)(param_1 + 0xe16c),0,1);
          FUN_004e0380(iVar2,1,*(uint *)(param_1 + 0xe16c),0,2);
          FUN_004e0820(iVar2,*(float *)(param_1 + 0xe1a0) / _DAT_005a28d8);
        }
      }
      else {
        FUN_0051d9d0(iVar1,0xffffffff,0xffffffff,1,0);
        FUN_004385a0(param_1 + 0xdfd8,iVar1);
      }
