// Name: FUN_004ab190
// Address: 004ab190
// Address Range: [[004ab190, 004ab441]]
// Convention: unknown
// Signature: void FUN_004ab190(int param_1,int *param_2)
...

{
  ...
  if ((0.0 < (float)param_2[0xb]) && (*param_2 == -1)) {
    ...
    case 3:
      ...
      break;
    case 4:
      iVar2 = *(int *)(param_1 + 0xbd70);
      break;
    case 5:
      iVar2 = *(int *)(param_1 + 0xbd6c);
      break;
    default:
      goto switchD_004ab1c6_default;
    }
    *param_2 = iVar2;
  }
switchD_004ab1c6_default:
  iVar2 = *param_2;
  if (((((iVar2 == *(int *)(param_1 + 0xbd48)) || (iVar2 == *(int *)(param_1 + 0xbd4c))) ||
       (iVar2 == *(int *)(param_1 + 0xbd50))) ||
      ((iVar2 == *(int *)(param_1 + 0xbd54) || (iVar2 == *(int *)(param_1 + 0xbd6c))))) ||
     (iVar2 == *(int *)(param_1 + 0xbd70))) {
    local_14 = param_2[0xb];
    if (*(int *)(param_1 + 0xbd70) == *param_2) {
      local_14 = 0x3d4ccccd;
    }
    if (*(int *)(param_1 + 0xbd6c) == *param_2) {
      local_14 = 0x3ca3d70a;
    }
    ...
    if (iVar2 != 0) {
      uVar3 = FUN_00415b30(param_1 + 0x20,param_1 + 0x30,param_2 + 3,param_1,0,0,0);
      FUN_00427eb0(param_1,uVar3,*param_2,0);
      if (*param_2 == *(int *)(param_1 + 0xbd48)) {
        FUN_00427eb0(param_1,uVar3,*(uint *)(param_1 + 0xbd4c),0);
      }
      if (*(int *)(param_1 + 0xbd50) == *param_2) {
        FUN_00427eb0(param_1,uVar3,*(uint *)(param_1 + 0xbd54),0);
      }
      if (*(int *)(param_1 + 0xbd6c) == *param_2) {
        piVar1 = param_2 + 3;
        FUN_00427e40(param_1,*(uint *)(param_1 + 0xbd50),piVar1,0);
        FUN_00427e40(param_1,*(uint *)(param_1 + 0xbd54),piVar1,0);
        FUN_00427e40(param_1,*(uint *)(param_1 + 0xbd48),piVar1,0);
        FUN_00427e40(param_1,*(uint *)(param_1 + 0xbd4c),piVar1,0);
        FUN_00427e40(param_1,*(uint *)(param_1 + 0xbd70),piVar1,0);
      }
