...
section .text
    ...
    CALL thunk_FUN_004cdbc0             ; 004831b5
    ...
    CALL thunk_FUN_004cdbc0             ; 0048327c
        ;   XREF to: 00460bf0 (UNCONDITIONAL_CALL)  ; undefined thunk_FUN_004cdbc0()
