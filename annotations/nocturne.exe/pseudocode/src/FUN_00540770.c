...
// Convention: unknown
// Signature: int FUN_00540770(int param_1,undefined4 param_2,undefined4 param_3)

#include "nocturne.h"

int FUN_00540770(int param_1,uint param_2,uint param_3)

{
  ...
  if (((*(int *)(param_1 + 0x1fa08) == 0) && (*(int *)(param_1 + 0x1fa04) == 0)) &&
    ...
    iVar1 = FUN_004b4c70(param_1,param_2,param_3);
    if (iVar1 != 0) {
