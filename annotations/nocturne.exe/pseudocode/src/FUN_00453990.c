...
// Convention: unknown
// Signature: float FUN_00453990(int param_1,int param_2,undefined4 param_3,undefined4 param_4,float *param_5)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

float FUN_00453990(int param_1,int param_2,uint param_3,uint param_4,float *param_5)

{
  ...
  local_18 = (float)FUN_0041d550(param_2 * 0x18 + *(int *)(param_1 + 0x350),param_3,param_4,0);
  if ((local_18 < 0.0) || (1.0 < local_18)) {
    ...
    if (*(int *)(param_1 + 0x358) == 0) {
      local_38 = FUN_00453080(param_1,param_2);
      local_2c = 0;
        ...
        do {
          ...
          if (2 < *(int *)(local_24 + 4)) {
            ...
            do {
              ...
              FUN_0046c5b0(local_d0,&local_68,&local_5c,&local_44);
              if (&local_5c != &local_44) {
                local_5c = local_44;
                local_58 = local_40;
                local_54 = local_3c;
              }
              local_18 = (float)FUN_0046c620(local_d0,param_3,param_4);
      ...
      iVar3 = param_1 + 0x370;
      FUN_0044daa0(iVar3,local_80,param_3);
      FUN_0044daa0(iVar3,local_50,param_4);
      iVar4 = *(int *)(param_1 + 0x358) + param_2 * *(int *)(param_1 + 0x354) * 0x38;
      iVar5 = 0;
      local_30 = iVar3;
      if (0 < *(int *)(param_1 + 0x354)) {
        do {
          local_18 = (float)FUN_0046c620(iVar4,local_80,local_50);
          if ((((local_18 <= local_20) && (0.0 <= local_18)) && (local_18 <= 1.0)) &&
            ...
            pfVar2 = (float *)FUN_0044da40(local_30,local_74,&local_8c);
            if (param_5 != pfVar2) {
              *param_5 = *pfVar2;
              param_5[1] = pfVar2[1];
              param_5[2] = pfVar2[2];
