...
section .text
    ...
    MOV dword ptr [0x01cc4800],ECX      ; 004ee456 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EBX      ; 004ee45c | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004ee462
    ...
    MOV [0x01cc4800],EAX                ; 004ee495 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EDX      ; 004ee49a | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004ee4a0
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
    ...
    MOV dword ptr [0x01cc4800],ECX      ; 004ee4b9 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EBX      ; 004ee4bf | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004ee4c5
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
