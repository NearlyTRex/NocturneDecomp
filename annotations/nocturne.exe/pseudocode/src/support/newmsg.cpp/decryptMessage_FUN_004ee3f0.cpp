...

{
  ...
  if (encrypted_msg[2] != '>') {
    ...
    if ((byte)(encrypted_msg[2] ^ bVar2) != 0x3e) {
      ...
      g_CurrentLineNumber = 202;
      core_main_c_displayErrorAndQuit_FUN_004c8440("decryptMessage - invalid initial mask value!");
    }
    iVar4 = 2;
    ...
    while (bVar1 = *pbVar3, *pbVar3 = bVar1 ^ bVar2, (bVar1 ^ bVar2) != 0) {
      ...
      if (1000 < iVar4) {
        ...
        core_main_c_displayErrorAndQuit_FUN_004c8440("decryptMessage - error decrypting text!");
      }
    }
    if (iVar4 < 0x17) {
      g_CurrentFilename = "..\\support\\newmsg.cpp";
      g_CurrentLineNumber = 232;
      core_main_c_displayErrorAndQuit_FUN_004c8440("decryptMessage - premature null terminator!");
