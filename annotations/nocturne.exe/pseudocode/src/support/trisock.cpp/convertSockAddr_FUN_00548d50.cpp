...
// Convention: unknown
// Signature: undefined4 * support_trisock_cpp_convertSockAddr_FUN_00548d50(undefined4 *param_1,short *param_2)
...

{
  ...
  *(ushort *)(param_1 + 1) = uVar1;
  puVar2 = (uint *)support_trisock_cpp_copyIPAddress_FUN_00548ae0(apcStack_10,param_2 + 2);
  *param_1 = *puVar2;
  return param_1;
}
