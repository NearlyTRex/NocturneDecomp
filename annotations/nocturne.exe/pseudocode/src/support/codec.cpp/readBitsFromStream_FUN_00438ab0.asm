...
;
; XREF[1]:
;   support_codec.cpp_CLZWDictionary_readCodeFromStream_FUN_00439590 at 004395c9
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 00438ab0
        ;   Label: support_codec.cpp_readBitsFromStream_FUN_00438ab0
    PUSH ESI                            ; 00438ab1
    PUSH EDI                            ; 00438ab2
    PUSH EBP                            ; 00438ab3
    ...
    PUSH EAX                            ; 00438b67
    PUSH EDI                            ; 00438b68
    CALL crt_iostream.cpp_istream_get_FUN_00564c53 ; 00438b69
    ...
    PUSH EAX                            ; 00438c05
    PUSH EDI                            ; 00438c06
    CALL crt_iostream.cpp_istream_get_FUN_00564c53 ; 00438c07
        ;   XREF to: 00564c53 (UNCONDITIONAL_CALL)  ; undefined crt_iostream.cpp_istream_get_FUN_00564c53()
