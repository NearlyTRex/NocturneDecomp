...
section .text
    ...
    MOV dword ptr [EAX + 0x1c00020],ECX ; 005454c1 | DAT_01c00024 | DAT_01c00028
    CMP EAX,0x400                       ; 005454c7
    JNZ 0x00545487                      ; 005454cc
        ;   XREF to: 00545487 (CONDITIONAL_JUMP)  ; LAB_00545487
    MOV EAX,[0x005b762c]                ; 005454ce | DAT_005b762c
        ;   Label: LAB_005454ce
    ...
    MOV dword ptr [EBP + 0x1c00020],ECX ; 005455b3 | DAT_01c00024
    ...
    MOV dword ptr [0x005bf550],ESI      ; 005455e8 | DAT_005bf550
    MOV dword ptr [0x005bf570],EBX      ; 005455ee | DAT_005bf570
    MOV dword ptr [0x005bf590],EBP      ; 005455f4 | DAT_005bf590
    MOV [0x005bf5b0],EAX                ; 005455fa | DAT_005bf5b0
    MOV dword ptr [0x01c02590],EBX      ; 005455ff | DAT_01c02590
    ...
    MOV dword ptr [0x005bf550],ECX      ; 00545626 | DAT_005bf550
    MOV dword ptr [0x005bf570],EBX      ; 0054562c | DAT_005bf570
    MOV dword ptr [0x005bf590],ESI      ; 00545632 | DAT_005bf590
    MOV dword ptr [0x005bf5b0],EDI      ; 00545638 | DAT_005bf5b0
    MOV dword ptr [0x01c02590],EDX      ; 0054563e | DAT_01c02590
    ...
    MOV [0x005bf550],EAX                ; 00545665 | DAT_005bf550
    MOV dword ptr [0x005bf570],EDX      ; 0054566a | DAT_005bf570
    MOV dword ptr [0x005bf590],ECX      ; 00545670 | DAT_005bf590
    MOV dword ptr [0x005bf5b0],EBX      ; 00545676 | DAT_005bf5b0
    MOV dword ptr [0x01c02590],EBP      ; 0054567c | DAT_01c02590
    ...
    MOV dword ptr [0x005bf550],EDI      ; 005456a3 | DAT_005bf550
    MOV dword ptr [0x005bf570],EBP      ; 005456a9 | DAT_005bf570
    MOV [0x005bf590],EAX                ; 005456af | DAT_005bf590
    MOV dword ptr [0x005bf5b0],EDX      ; 005456b4 | DAT_005bf5b0
    MOV dword ptr [0x01c02590],ESI      ; 005456ba | DAT_01c02590
