...
// Convention: unknown
// Signature: undefined4 FUN_0053bf90(int param_1)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_0053bf90(int param_1)

{
  ...
  *(uint *)(param_1 + 0x1fa14) = 0;
  local_14 = (float)FUN_0042a9d0(param_1,0);
  if ((((float)_DAT_00595b0f <= local_14) && (*(int *)(param_1 + 0x24ac) == 0)) &&
    ...
    while( true ) {
      ...
      iVar2 = FUN_0040d890(*(uint *)(0x01E57284 + local_18 + 0x14cd70),_DAT_01cc3120);
      if ((iVar2 != 0) &&
         (ABS(*(float *)(param_1 + 0x24) - *(float *)(iVar2 + 0x24)) <= (float)_DAT_00595b1f)) {
        FUN_0040a290(iVar2,&local_a4,local_20);
        if ((ABS(local_9c) <= (float)_DAT_00595b27) && (0.0 <= local_9c)) {
          ...
          local_9c = fStack_c0;
          pfVar3 = (float *)FUN_0040a240(iVar2,auStack_8c,&local_a4);
          if (&local_a4 != pfVar3) {
            local_a4 = *pfVar3;
            fStack_a0 = pfVar3[1];
            local_9c = pfVar3[2];
          ...
          if (fVar5 <= ABS((float10)fStack_a8 * (float10)fStack_3c +
            ...
            iVar4 = FUN_0040a290(param_1,auStack_98,iVar2 + 0x20);
            if (0.0 < *(float *)(iVar4 + 8)) {
              *(int *)(param_1 + 0x1fa14) = iVar2;
              FUN_004e16b0(param_1 + 0x150,0x2a,1);
              *(uint *)(param_1 + 0xbca0) = 0;
              uStack_54 = 0x40000000;
              uStack_5c = 0;
              uStack_58 = 0;
              pfVar3 = (float *)FUN_0040a240(iVar2,auStack_50,&uStack_5c);
