...
// Convention: unknown
// Signature: void FUN_00557cc0(int param_1)
...

{
  ...
  if ((*(int *)(param_1 + 0xbd50) != 0) && (*(int *)(param_1 + 0xbca4) != 0)) {
    ...
    local_4c = 0xbe99999a;
    local_48 = 0;
    FUN_0055a8b0(&local_5c,&local_50,*(int *)(param_1 + 0xbd38) * 0x30 + param_1 + 0xfd0);
    FUN_0040a290(param_1,&local_68,*(int *)(param_1 + 0xbd50) + 0x20);
    ...
    FUN_0043ac60(PTR_DAT_005ad350,"Chain stretched to %f\n",(double)local_1c);
