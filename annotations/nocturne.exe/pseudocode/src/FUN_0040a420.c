...
// Convention: unknown
// Signature: undefined4 FUN_0040a420(int param_1,float *param_2,float *param_3,float *param_4)

#include "nocturne.h"

uint FUN_0040a420(int param_1,float *param_2,float *param_3,float *param_4)
