...
;   undefined4 DAT_00579d0d
;   undefined4 DAT_00579d15
...
section .text
    ...
    FXCH                                ; 00421bb0
    FLD float ptr [0x00579d09]          ; 00421bb2 | DAT_00579d09
    FXCH                                ; 00421bb8
    FMUL ST1                            ; 00421bba
    FXCH ST2                            ; 00421bbc
    ...
    FMUL float ptr [0x00579d0d]         ; 00421c96 | DAT_00579d0d
    FILD dword ptr [ESP + 0x70]         ; 00421c9c
    FMUL float ptr [0x0059aea8]         ; 00421ca0 | DAT_0059aea8
    FXCH                                ; 00421ca6
    FMUL double ptr [0x00579d15]        ; 00421ca8 | DAT_00579d15
