...
// Convention: unknown
// Signature: void FUN_005181a0(int param_1,int param_2,int param_3,int *param_4)
...

{
  ...
  for (local_20 = 0; local_20 < *(int *)(param_1 + local_24 + 0x2c); local_20 = local_20 + 1) {
    ...
    local_14 = pfVar3;
    if (*(char *)pfVar3 == '\x01') {
      pfVar2 = (float *)FUN_0055a8b0(local_3c,pfVar2,
      ...
      {
        pfVar1 = (float *)FUN_0055a8b0(local_54,pfVar2,
                                       (uint)*(byte *)((int)pfVar3 + 1) * 0x30 + param_3);
