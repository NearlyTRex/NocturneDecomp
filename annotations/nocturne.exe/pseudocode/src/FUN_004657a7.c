...
// Convention: unknown
// Signature: void FUN_004657a7(undefined4 *param_1,undefined4 *param_2,byte *param_3,byte *param_4,int param_5)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_004657a7(uint *param_1,uint *param_2,byte *param_3,byte *param_4,int param_5)
