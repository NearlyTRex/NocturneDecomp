...
;
; XREF[1]:
;   FUN_0048a650 at 0048a87e
;
; Referenced Globals:
;   undefined4 DAT_00581214
;   undefined4 DAT_0058121c
;   undefined4 DAT_00581224
;   undefined4 DAT_0058122c
;   undefined4 DAT_00581234
;   undefined4 DAT_0058123c
...
section .text
    ...
    FLD1                                ; 00487006
    FSUBRP                              ; 00487008
    FMUL double ptr [0x00581214]        ; 0048700a | DAT_00581214
    CALL FUN_00563a30                   ; 00487010
    ...
    CALL FUN_00460aa0                   ; 00487070
        ;   XREF to: 00460aa0 (UNCONDITIONAL_CALL)  ; undefined FUN_00460aa0()
    FLD float ptr [ESI + 0x10]          ; 00487075
    FMUL double ptr [0x0058122c]        ; 00487078 | DAT_0058122c
    FLD float ptr [ESI + 0x10]          ; 0048707e
    FCHS                                ; 00487081
    FMUL float ptr [0x0058121c]         ; 00487083 | DAT_0058121c
    FXCH                                ; 00487089
    FLD double ptr [0x00581224]         ; 0048708b | DAT_00581224
    FXCH                                ; 00487091
    FMUL ST1                            ; 00487093
    FXCH ST2                            ; 00487095
    FMULP                               ; 00487097
    ...
    FXCH                                ; 0048709f
    CALL FUN_00563a30                   ; 004870a1
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH                                ; 004870a6
    CALL FUN_00563a30                   ; 004870a8
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH                                ; 004870ad
    ...
    FMUL float ptr [0x00581234]         ; 00487105 | DAT_00581234
    FMUL double ptr [0x00581224]        ; 0048710b | DAT_00581224
    ...
    FMUL float ptr [0x0059d1f8]         ; 00487184 | DAT_0059d1f8
    FISTP dword ptr [EBX]               ; 0048718a
    FLD float ptr [EAX + 0x4]           ; 0048718c
    FMUL float ptr [0x0059d1f8]         ; 0048718f | DAT_0059d1f8
    FISTP dword ptr [EBX + 0x4]         ; 00487195
    FLD float ptr [EAX + 0x8]           ; 00487198
    FMUL float ptr [0x0059d1f8]         ; 0048719b | DAT_0059d1f8
    ...
    PUSH EAX                            ; 004871ae
    CALL FUN_0053075c                   ; 004871af
        ;   XREF to: 0053075c (UNCONDITIONAL_CALL)  ; undefined FUN_0053075c()
    FLD float ptr [ESI + 0x10]          ; 004871b4
    FCHS                                ; 004871b7
    FMUL double ptr [0x0058123c]        ; 004871b9 | DAT_0058123c
    FMUL double ptr [0x00581224]        ; 004871bf | DAT_00581224
    ...
    FMUL float ptr [0x0059d1f8]         ; 004871dc | DAT_0059d1f8
    FISTP dword ptr [EBX]               ; 004871e2
    FLD float ptr [EAX + 0x4]           ; 004871e4
    FMUL float ptr [0x0059d1f8]         ; 004871e7 | DAT_0059d1f8
    FISTP dword ptr [EBX + 0x4]         ; 004871ed
    FLD float ptr [EAX + 0x8]           ; 004871f0
    FMUL float ptr [0x0059d1f8]         ; 004871f3 | DAT_0059d1f8
    ...
    FMUL float ptr [0x0059d1f8]         ; 00487227 | DAT_0059d1f8
    FISTP dword ptr [EBX]               ; 0048722d
    FLD float ptr [EAX + 0x4]           ; 0048722f
    FMUL float ptr [0x0059d1f8]         ; 00487232 | DAT_0059d1f8
    FISTP dword ptr [EBX + 0x4]         ; 00487238
    FLD float ptr [EAX + 0x8]           ; 0048723b
    FMUL float ptr [0x0059d1f8]         ; 0048723e | DAT_0059d1f8
