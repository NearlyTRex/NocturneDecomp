...
// Convention: unknown
// Signature: uint * FUN_00405b40(uint *param_1)
...

{
  ...
  while (uVar5 != 0) {
    ...
    if (uVar5 < 0xd) {
      ...
      if ((0xd < uVar5) && (puVar8 = puVar4, uVar5 == 0x18)) {
        FUN_00405ab0(puVar6,puVar4,unaff_EDI);
      }
    }
  ...
  if (0x00000001 != 0) {
    if (DAT_006b0278 == 0) {
      iVar10 = 0;
      _qsort(&DAT_006b415c,DAT_006b0268,4,FUN_00405a60);
      iVar9 = 0;
      iVar7 = 0;
      ...
      if (0 < (int)DAT_006b0268) {
        do {
          ...
          iVar7 = iVar7 + 4;
          iVar10 = iVar10 + 1;
          param_1 = (uint *)FUN_00405340(*puVar3);
