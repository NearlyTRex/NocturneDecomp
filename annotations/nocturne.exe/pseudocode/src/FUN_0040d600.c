...
// Convention: unknown
// Signature: uint FUN_0040d600(undefined4 param_1,int *param_2)

#include "nocturne.h"

uint FUN_0040d600(uint param_1,int *param_2)

{
  ...
  if (cVar1 == '(') {
    *param_2 = (int)(pcVar2 + 1);
    uVar3 = FUN_0040d720(param_1,param_2);
    if (-1 < (int)uVar3) {
      while (((&DAT_005c168c)[(byte)(*(char *)*param_2 + 1)] & 2) != 0) {
        *param_2 = (int)((char *)*param_2 + 1);
      }
  ...
  if (cVar1 == '!') {
    *param_2 = (int)(pcVar2 + 1);
    uVar3 = FUN_0040d600(param_1,param_2);
    if (-1 < (int)uVar3) {
      uVar3 = (uint)(uVar3 == 0);
    }
    return uVar3;
