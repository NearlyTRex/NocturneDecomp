...
// Convention: unknown
// Signature: int FUN_004f9170(int *param_1,undefined4 param_2,undefined4 param_3,int *param_4)

#include "nocturne.h"

int FUN_004f9170(int *param_1,uint param_2,uint param_3,int *param_4)
