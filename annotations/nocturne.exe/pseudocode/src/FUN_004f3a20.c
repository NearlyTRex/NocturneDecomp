...
// Convention: unknown
// Signature: void FUN_004f3a20(int param_1,undefined4 param_2)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_004f3a20(int param_1,uint param_2)

{
  ...
  if (*(int *)(param_1 + 0x394) == 0) {
    iVar2 = FUN_0047dc30(0x01C03A10,param_1 + 0x2cc);
    if (iVar2 == 0) {
      return;
    }
    *(uint *)(param_1 + 0x394) = 1;
  }
  iVar2 = FUN_0047dc30(0x01C03A10,param_1 + 0x330);
  if ((iVar2 != 0) && (*(int *)(param_1 + 0x428) != 0x3f800000)) {
    *(uint *)(param_1 + 0x42c) = 0;
    *(uint *)(param_1 + 0x428) = 0x3f800000;
  }
  FUN_004f3430(param_1,param_2);
  fVar7 = (float10)1;
  ...
  do {
    while( true ) {
      ...
      if ((*(int *)(param_1 + 0x420) == 0) ||
         (iVar3 = FUN_0040d890(uVar1,_DAT_01cae124), iVar3 == 0)) break;
      FUN_004f2e60(param_1,uVar1,iVar3,0);
LAB_004f3aee:
      iVar2 = iVar2 + 1;
      iVar4 = iVar4 + 4;
    }
    if ((*(int *)(param_1 + 0x424) == 0) || (iVar3 = FUN_0040d890(uVar1,_DAT_01bcdef4), iVar3 == 0))
    goto LAB_004f3aee;
    FUN_004f2e60(param_1,uVar1,0,iVar3);
    iVar2 = iVar2 + 1;
    iVar4 = iVar4 + 4;
  } while( true );
}
