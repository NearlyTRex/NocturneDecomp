...
section .text
    ...
    PUSH EAX                            ; 00493ac7
    PUSH ESI                            ; 00493ac8
    CALL FUN_00490b20                   ; 00493ac9
        ;   XREF to: 00490b20 (UNCONDITIONAL_CALL)  ; undefined FUN_00490b20()
    ...
    PUSH 0xff                           ; 00493bf4
    PUSH ESI                            ; 00493bf9
    CALL FUN_00493110                   ; 00493bfa
        ;   XREF to: 00493110 (UNCONDITIONAL_CALL)  ; undefined FUN_00493110()
