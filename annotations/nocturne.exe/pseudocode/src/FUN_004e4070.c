...
// Convention: unknown
// Signature: int FUN_004e4070(int param_1,int param_2,int param_3,int param_4)
      ...
      do {
        ...
        *pfVar11 = (float)(fVar13 * (float10)_DAT_0058b6b8);
        ...
        if (*pfVar11 < 0.0) {
          ...
          FUN_00566fb6((double)(*pfVar11 + (float)_DAT_0058b6d0),local_5c);
          dVar3 = local_5c[0];
        }
        else {
          local_64 = (double)*pfVar11;
          FUN_00566fb6((double)(*pfVar11 + (float)_DAT_0058b6d8),&local_64);
          dVar3 = local_64;
        }
        *pfVar11 = (float)dVar3;
        pfVar11 = pfVar11 + 1;
