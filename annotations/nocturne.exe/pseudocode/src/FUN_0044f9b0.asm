...
;
; XREF[1]:
;   FUN_00509a80 at 0050a1f0
;
; Referenced Globals:
;   undefined4 DAT_0057c7ee
;   undefined4 DAT_0057c7f6
;   undefined4 DAT_0057c7fe
;   undefined4 DAT_0057c806
;   undefined4 DAT_0057c80e
;   undefined4 DAT_0057c816
;   undefined4 DAT_0057c81e
...
section .text
    ...
    LEA EAX,[ESP + 0xd4]                ; 0044f9d2
        ;   Label: LAB_0044f9d2
    PUSH EAX                            ; 0044f9d9
    MOV ECX,dword ptr [0x005ae704]      ; 0044f9da | DAT_005ae704
    PUSH ECX                            ; 0044f9e0 | DAT_01b4d738
    CALL FUN_00460d30                   ; 0044f9e1
    ...
    FMUL double ptr [0x0057c7ee]        ; 0044fa97 | DAT_0057c7ee
    ...
    FMUL ST0                            ; 0044fab6
    FXCH ST2                            ; 0044fab8
    FMUL double ptr [0x0057c7f6]        ; 0044faba | DAT_0057c7f6
    FXCH                                ; 0044fac0
    ...
    MOV EBX,dword ptr [0x005ae704]      ; 0044fb16 | DAT_005ae704
    ...
    FMUL float ptr [0x0057c7fe]         ; 0044fc99 | DAT_0057c7fe
    FLDZ                                ; 0044fc9f
    FCOMPP                              ; 0044fca1
    FNSTSW AX                           ; 0044fca3
    SAHF                                ; 0044fca5
    ...
    PUSH 0x1                            ; 0044fcaf
    MOV ECX,dword ptr [0x005ae704]      ; 0044fcb1 | DAT_005ae704
    FMUL double ptr [0x0057c806]        ; 0044fcb7 | DAT_0057c806
    PUSH ECX                            ; 0044fcbd | DAT_01b4d738
    CALL FUN_00563a30                   ; 0044fcbe
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FISTP dword ptr [ESP + 0x134]       ; 0044fcc3
    CALL FUN_00461000                   ; 0044fcca
    ...
    FXCH ST3                            ; 0044fd66
    FMUL double ptr [0x0057c7f6]        ; 0044fd68 | DAT_0057c7f6
    ...
    MOV EDX,dword ptr [0x005ae704]      ; 0044fe61 | DAT_005ae704
    ...
    MOV EDX,dword ptr [0x005ae704]      ; 0044feb8 | DAT_005ae704
    ...
    MOV EDX,dword ptr [0x005ae704]      ; 0044ff15 | DAT_005ae704
    ...
    MOV EDX,dword ptr [0x005ae704]      ; 0044ff72 | DAT_005ae704
    ...
    PUSH EAX                            ; 0044ffa9
    CALL FUN_0053075c                   ; 0044ffaa
        ;   XREF to: 0053075c (UNCONDITIONAL_CALL)  ; undefined FUN_0053075c()
    ADD ESP,0x8                         ; 0044ffaf
    PUSH ESI                            ; 0044ffb2 | DAT_005ae488
    MOV EAX,[0x005ae704]                ; 0044ffb3 | DAT_005ae704
    PUSH EAX                            ; 0044ffb8 | DAT_01b4d738
    CALL FUN_00461eb0                   ; 0044ffb9
    ...
    MOV EDX,dword ptr [0x005ae704]      ; 0044ffe0 | DAT_005ae704
    ...
    CALL FUN_004604c0                   ; 00450118
        ;   XREF to: 004604c0 (UNCONDITIONAL_CALL)  ; undefined FUN_004604c0()
    ADD ESP,0x8                         ; 0045011d
    MOV EBX,dword ptr [0x005ae704]      ; 00450120 | DAT_005ae704
    PUSH EBX                            ; 00450126 | DAT_01b4d738
    CALL thunk_FUN_004cdbc0             ; 00450127
    ...
    PUSH 0x0                            ; 0045014a
    MOV EDX,dword ptr [0x005ae704]      ; 0045014c | DAT_005ae704
    PUSH EDX                            ; 00450152 | DAT_01b4d738
    CALL FUN_00461000                   ; 00450153
        ;   XREF to: 00461000 (UNCONDITIONAL_CALL)  ; undefined FUN_00461000()
