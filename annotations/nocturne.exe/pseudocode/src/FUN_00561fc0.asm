...
section .text
    ...
    PUSH EDI                            ; 00561fcb
    PUSH EBX                            ; 00561fcc
    CALL FUN_00561cf0                   ; 00561fcd
        ;   XREF to: 00561cf0 (UNCONDITIONAL_CALL)  ; undefined FUN_00561cf0()
    ...
    PUSH ESI                            ; 00562050
    PUSH EBX                            ; 00562051
    CALL FUN_005618c0                   ; 00562052
        ;   XREF to: 005618c0 (UNCONDITIONAL_CALL)  ; undefined FUN_005618c0()
