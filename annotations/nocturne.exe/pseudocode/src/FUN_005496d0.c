...

{
  ...
  if (iVar2 != 0) {
    uStack_10 = FUN_00549ef0(param_1,0,0xffffffff);
    FUN_004544d0(param_1 + 0x150,uStack_10);
  }
  FUN_00409f60(param_1);
  if (iVar2 != 0) {
    iVar3 = FUN_00454530(param_1 + 0x57c);
    if (0 < *(int *)(iVar3 + 0x110)) {
      FUN_00460a00(DAT_005ae704,param_1 + 0x20);
      FUN_00460aa0(DAT_005ae704,param_1 + 0x570,0);
      uStack_10 = FUN_00549ef0(param_1,1,0xffffffff);
      FUN_004544d0(param_1 + 0x57c,uStack_10);
