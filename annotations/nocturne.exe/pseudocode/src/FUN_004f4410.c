...
// Convention: unknown
// Signature: void FUN_004f4410(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6,int param_7)
...

{
  ...
  if ((((*(int *)(param_1 + 0x20) != 0) && (*(int *)(param_1 + 0x14) != 0)) && (param_2 <= param_6))
    ...
    if ((param_4 <= iVar3) && (param_5 <= iVar1)) {
      ...
      FUN_004f4310(param_1,param_2,param_3,local_18,local_14,iVar2,iVar3);
    }
  }
  return;
}
