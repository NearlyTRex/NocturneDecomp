...
section .text
    ...
    POP EBX                             ; 00534dfb
    RET                                 ; 00534dfc
    PUSH 0x5a26b0                       ; 00534dfd | DAT_005a26b0
        ;   Label: LAB_00534dfd
    PUSH EBX                            ; 00534e02
    CALL FUN_0056445f                   ; 00534e03
        ;   XREF to: 0056445f (UNCONDITIONAL_CALL)  ; undefined FUN_0056445f()
    ADD ESP,0x8                         ; 00534e08
    PUSH EAX                            ; 00534e0b
    CALL FUN_00564486                   ; 00534e0c
