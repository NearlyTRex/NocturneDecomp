...
section .text
    ...
    CALL FUN_004301e0                   ; 0045ca9a
        ;   XREF to: 004301e0 (UNCONDITIONAL_CALL)  ; undefined FUN_004301e0()
    PUSH 0x1                            ; 0045ca9f
    MOV ESI,EAX                         ; 0045caa1
    CALL FUN_00430200                   ; 0045caa3
        ;   XREF to: 00430200 (UNCONDITIONAL_CALL)  ; undefined FUN_00430200()
