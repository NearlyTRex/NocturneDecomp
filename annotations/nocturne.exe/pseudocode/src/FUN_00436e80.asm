...
section .text
    ...
    PUSH EBX                            ; 0043705b
    PUSH EDI                            ; 0043705c
    CALL FUN_00436580                   ; 0043705d
        ;   XREF to: 00436580 (UNCONDITIONAL_CALL)  ; undefined FUN_00436580()
    INC EBX                             ; 00437062
    ...
    CALL FUN_004366f0                   ; 00437a3e
        ;   XREF to: 004366f0 (UNCONDITIONAL_CALL)  ; undefined FUN_004366f0()
