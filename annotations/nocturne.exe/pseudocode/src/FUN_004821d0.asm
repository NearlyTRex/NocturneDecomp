...
section .text
    ...
    CALL thunk_FUN_004cdbc0             ; 0048228a
    ...
    CALL thunk_FUN_004cdbc0             ; 00482299
        ;   XREF to: 00460bf0 (UNCONDITIONAL_CALL)  ; undefined thunk_FUN_004cdbc0()
    ADD ESP,0x4                         ; 0048229e
    POP EDI                             ; 004822a1
    PUSH EBX                            ; 004822a2
    CALL FUN_00409f60                   ; 004822a3
        ;   XREF to: 00409f60 (UNCONDITIONAL_CALL)  ; undefined FUN_00409f60()
