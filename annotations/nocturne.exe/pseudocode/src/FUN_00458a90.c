...
// Convention: unknown
// Signature: void FUN_00458a90(int param_1,float param_2)
...

{
    ...
    *(float *)(param_1 + 0xbe50) = fVar2;
    if (0.0 <= fVar2) {
      ...
      if (0 < *(int *)(param_1 + 0xbdd0)) {
        ...
        iVar3 = param_1;
        do {
          iVar5 = *(int *)(iVar3 + 0xbdd4);
          *(uint *)(iVar5 + 0xfc) = 1;
          *(uint *)(iVar5 + 0xc9c) = 1;
          fVar9 = ((float10)*(float *)(param_1 + 0xbe50) * fVar8) / fVar7;
          iVar4 = iVar4 + 1;
          iVar5 = FUN_00563a30();
          *(int *)(iVar5 + 0xca8) = (int)ROUND(fVar9);
          iVar3 = iVar3 + 4;
  ...
  *(uint *)(param_1 + 0x23a4) = *(uint *)(param_1 + 0x23a8);
  ...
  while (0.0 < local_38) {
    iVar4 = FUN_004e11c0(param_1 + 0x150,&local_38);
    if (iVar4 == 0x29a) {
      *(uint *)(param_1 + 0x2dec) = 0;
      local_178 = 0;
      local_174 = 0x41a00000;
      local_170 = 0x41a00000;
      FUN_0040a200(param_1,local_ac,&local_178);
      FUN_00459f70(param_1,local_ac,0xbf800000,1);
      fVar2 = _DAT_0059c40c;
...
LAB_00458f79:
      ...
      FUN_004e16b0(param_1 + 0x150,uVar10,1);
    }
    else {
  ...
  case 0:
    ...
    if (*(int *)(param_1 + 0xbca4) == 0) {
      ...
      if (iVar4 != 0) {
        FUN_004e16b0(param_1 + 0x150,0xe,1);
      }
      break;
    }
    iVar4 = FUN_0040dea0(0x3e800000);
    if ((iVar4 != 0) &&
       (iVar4 = FUN_0040d7e0(*(uint *)(param_1 + 0xbca4),"CHero"), iVar4 != 0)) {
      iVar3 = 0;
      iVar4 = 0;
      while ((iVar3 < *(int *)(0x01E57284 + 0x150bf4) &&
             ((iVar5 = FUN_0040d890(*(uint *)(iVar4 + 0x150bf8 + 0x01E57284),_DAT_01b4d25c),
              iVar5 == 0 || (*(int *)(iVar5 + 0xbdb0) == 0))))) {
        iVar3 = iVar3 + 1;
        iVar4 = iVar4 + 4;
      }
      if (iVar3 == *(int *)(0x01E57284 + 0x150bf4)) {
        FUN_00563c90(local_430,"bride-%d?.wav",*(uint *)(param_1 + 0xbdac));
        FUN_0045ab40(param_1,local_430,0x3f800000);
        FUN_004e16b0(param_1 + 0x150,0x17,1);
    ...
    if (*(float *)(param_1 + 0xbdbc) < 0.0) {
      local_14 = (float)FUN_0040dda0(0x40000000,0x41a00000);
      *(float *)(param_1 + 0xbdbc) = local_14;
      FUN_004e16b0(param_1 + 0x150,0xd,1);
      break;
    }
    goto LAB_00459978;
  case 2:
    FUN_00423ed0(local_28c);
    local_288 = (float)FUN_0040dda0(0x40e00000,0x41700000);
    local_258 = param_1;
    local_254 = param_1;
    local_14 = local_288;
    uVar10 = FUN_0055a8b0(local_b8,&DAT_02dd1184,_DAT_01b4d260 * 0x30 + param_1 + 0xfd0,0x3ecccccd,
                          local_28c);
    uVar10 = FUN_0040a240(param_1,local_100,uVar10);
    FUN_004798e0(param_1,uVar10);
    *(uint *)(param_1 + 0xbdcc) = 1;
    break;
  case 3:
    FUN_00423ed0(local_304);
    local_300 = (float)FUN_0040dda0(0x40e00000,0x41700000);
    local_2d0 = param_1;
    local_2cc = param_1;
    local_14 = local_300;
    uVar10 = FUN_0055a8b0(local_184,&DAT_02dd1184,_DAT_01b4d260 * 0x30 + param_1 + 0xfd0,0x3ecccccd,
                          local_304);
    uVar10 = FUN_0040a240(param_1,local_4c,uVar10);
    FUN_004798e0(param_1,uVar10);
    break;
  case 7:
    if (*(int *)(param_1 + 0xbe4c) == 0) {
      uVar10 = FUN_0051d380(param_1 + 0x150,local_d0,_DAT_01b4d27c);
      FUN_0040a240(param_1,local_f4,uVar10);
      FUN_0048c3c0(0x01C08D04,local_f4,param_1 + 0x30,1,0);
      local_9c = *(uint *)(param_1 + 0x34);
      local_98 = *(uint *)(param_1 + 0x38);
      local_a0 = *(float *)(param_1 + 0x30) + _DAT_0057d72e;
      FUN_0048c3c0(0x01C08D04,local_f4,&local_a0,1,0);
    }
    break;
  case 8:
    (**(code **)(*(int *)(param_1 + 0x14c) + 0x13c))(param_1,param_2);
    if (*(int *)(param_1 + 0xbca4) == 0) {
      ...
      if (*(int *)(param_1 + 0xbdcc) == 0) {
        ...
        FUN_004e16b0(param_1 + 0x150,0x19,1);
  ...
  case 9:
    if (*(float *)(param_1 + 0xbdb8) <= 0.0) {
      FUN_00563c90(local_3cc,"bride-%d?.wav",*(uint *)(param_1 + 0xbdac));
      FUN_0045ab40(param_1,local_3cc,0x3f800000);
      iVar4 = FUN_0040dea0(0x3e4ccccd);
      if (iVar4 != 0) {
        FUN_0045ab40(param_1,local_3cc,0x3f800000);
      }
    }
    ...
    if (*(int *)(param_1 + 0xbca4) != 0) {
      if (0.0 <= *(float *)(param_1 + 0xbdbc)) {
        ...
        iVar3 = FUN_004247f0(param_1,*(int *)(param_1 + 0xbca4) + 0x20,uVar10);
        if (iVar3 < 0) {
          ...
          if ((float)_DAT_0057d71e <
            ...
            FUN_0054e4a0(local_70,&local_7c);
            local_14 = (float)FUN_0040df00(local_6c - *(float *)(param_1 + 0x34));
            if (ABS(local_14) < (float)_DAT_0057d726) {
              local_14 = (float)FUN_0040dda0(0xbf490fdb,0x3f490fdb);
...
LAB_00459978:
  ...
  case 0xc:
    ...
    if ((iVar4 == 0) && (iVar4 = FUN_0047dc30(0x01C03A10,param_1 + 0xbd48), iVar4 != 0)) {
      FUN_004e16b0(param_1 + 0x150,0xd,1);
    }
    break;
  case 0xe:
    if (*(float *)(param_1 + 0xbdb8) <= 0.0) {
      FUN_00563c90(local_368,"bride-%d?.wav",*(uint *)(param_1 + 0xbdac));
    ...
    iVar4 = param_1 + 0x150;
    if (*(int *)(param_1 + 0xbca4) == 0) {
      iVar3 = FUN_0047a030(param_1,param_2);
      if (iVar3 == 0) {
        FUN_004e16b0(iVar4,0,1);
      }
    }
      ...
      *(uint *)(param_1 + 0x23a4) = *(uint *)(param_1 + 0x23a8);
      ...
      if (iVar3 < 0) {
        ...
        if (iVar3 == 0) {
          FUN_004e16b0(iVar4,0x13,1);
        }
        if (iVar3 == 1) {
          FUN_004e16b0(param_1 + 0x150,0x14,1);
        }
        if (iVar3 == 2) {
    ...
    break;
  case 0xf:
    iVar4 = FUN_0047dc30(0x01C03A10,param_1 + 0xbd48);
    if (iVar4 != 0) {
      FUN_004e16b0(param_1 + 0x150,0xb,1);
    }
    break;
  case 0x10:
  ...
  case 0x11:
    ...
    uVar10 = FUN_0051d2a0(param_1 + 0x150,local_1b4,0);
    FUN_0040a240(param_1,local_1cc,uVar10);
  ...
  case 0x12:
    ...
    break;
  case 0x13:
    FUN_00423ed0(local_2c8);
    local_2c4 = (float)FUN_0040dda0(0x40e00000,0x41700000);
    local_294 = param_1;
    local_290 = param_1;
    local_14 = local_2c4;
    uVar10 = FUN_0055a8b0(local_13c,&DAT_02dd1184,_DAT_01b4d260 * 0x30 + param_1 + 0xfd0,0x3ecccccd,
                          local_2c8);
    uVar10 = FUN_0040a240(param_1,local_94,uVar10);
    FUN_004798e0(param_1,uVar10);
    *(uint *)(param_1 + 0xbdcc) = 1;
    break;
  case 0x14:
    FUN_00423ed0(local_214);
    local_210 = (float)FUN_0040dda0(0x40e00000,0x41700000);
    local_1e0 = param_1;
    local_1dc = param_1;
    local_14 = local_210;
    uVar10 = FUN_0055a8b0(local_88,&DAT_02dd1184,param_1 + 0xfd0 + _DAT_01b4d260 * 0x30,0x3ecccccd,
                          local_214);
    uVar10 = FUN_0040a240(param_1,local_16c,uVar10);
    FUN_004798e0(param_1,uVar10);
    *(uint *)(param_1 + 0xbdcc) = 1;
    break;
  case 0x15:
    FUN_00423ed0(local_250);
    local_24c = (float)FUN_0040dda0(0x40e00000,0x41700000);
    local_21c = param_1;
    local_218 = param_1;
    local_14 = local_24c;
    uVar10 = FUN_0055a8b0(local_1c0,&DAT_02dd1184,param_1 + 0xfd0 + _DAT_01b4d268 * 0x30,0x3ecccccd,
                          local_250);
    uVar10 = FUN_0040a240(param_1,local_154,uVar10);
    FUN_004798e0(param_1,uVar10);
    break;
  case 0x17:
    if (*(float *)(param_1 + 0xbdb8) <= 0.0) {
      FUN_00563c90(local_494,"bride-%d?.wav",*(uint *)(param_1 + 0xbdac));
    ...
    case 1:
      ...
      *(float *)(param_1 + 0xbdb4) = fVar2;
      ...
      local_140 = 0;
      iVar4 = FUN_0051e0a0(local_2c);
      if (0 < *(int *)(iVar4 + 0x28558)) {
        local_24 = local_2c;
        do {
          uVar10 = FUN_0051d380(local_24,local_64,iVar3);
          FUN_0040a240(param_1,local_118,uVar10);
          iVar3 = iVar3 + 1;
          FUN_0048afe0(0x01C08D04,local_118,0x3f000000,&local_148,0xffff);
      ...
      if (local_30 != 0) {
        ...
        *(uint *)(param_1 + 0x28) = *(uint *)(param_1 + 0xbdc8);
        ...
        if (iVar4 != 0) {
          ...
          puVar6 = (uint *)FUN_0054e4a0(local_190,&local_dc);
    ...
    case 3:
      ...
      iVar3 = 0;
      local_c0 = 0x40400000;
      local_20 = FUN_0051e0a0(iVar4);
      if (0 < *(int *)(local_20 + 0x28558)) {
        do {
          uVar10 = FUN_0051d380(iVar4,local_10c,iVar3);
          FUN_0040a240(param_1,local_130,uVar10);
          FUN_0048afe0(0x01C08D04,local_130,0x3f000000,&local_c4,0xffff);
          iVar3 = iVar3 + 1;
