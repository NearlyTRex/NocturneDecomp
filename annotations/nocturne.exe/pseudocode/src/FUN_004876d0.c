...
// Convention: unknown
// Signature: void FUN_004876d0(undefined4 *param_1,undefined4 *param_2,float param_3)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_004876d0(uint *param_1,uint *param_2,float param_3)

{
  ...
  FUN_00487af0(param_1);
  *param_1 = 1;
  uVar1 = 0x01E57284;
  param_1[1] = 0;
  param_1[2] = 0x3dcccccd;
  local_14 = (float)FUN_0050ec80(uVar1,param_1 + 3,0);
  param_1[4] = local_14;
  puVar3 = param_1;
  do {
    local_18 = -param_3;
    local_14 = (float)FUN_0040dda0(local_18,param_3);
  ...
  local_14 = local_30;
  local_14 = (float)FUN_0050ec80(0x01E57284,param_1 + 0x10,0,local_18,0,local_18,param_3,0,param_3
                                 ,param_3,0,-param_3);
  uVar1 = 0x01E57284;
  param_1[0x11] = local_14 + (float)_DAT_005812a4;
  local_14 = (float)FUN_0050ec80(uVar1,param_1 + 0x13,0);
  uVar1 = 0x01E57284;
  param_1[0x14] = local_14 + (float)_DAT_005812a4;
  local_14 = (float)FUN_0050ec80(uVar1,param_1 + 0x16,0);
  uVar1 = 0x01E57284;
  param_1[0x17] = local_14 + (float)_DAT_005812a4;
  fVar2 = (float)FUN_0050ec80(uVar1,param_1 + 0x19,0);
