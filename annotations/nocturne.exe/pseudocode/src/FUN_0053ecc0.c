...
// Convention: unknown
// Signature: void FUN_0053ecc0(int param_1,float param_2,int param_3)
...
LAB_0053ecf1:
    do {
      ...
      FUN_0040a290(param_1,&local_68,iVar3 + 0x20);
...
LAB_0053ee02:
  ...
  local_1c = 1.5;
  local_9c = 0x40600000;
  pfVar4 = (float *)FUN_0040a200(param_1,local_b0,&local_a4);
  if (&local_8c != pfVar4) {
    local_8c = *pfVar4;
    local_88 = pfVar4[1];
    local_84 = pfVar4[2];
  }
  uVar5 = FUN_0051d2a0(param_1 + 0x150,local_bc,_DAT_02dc9f54);
  pfVar4 = (float *)FUN_0040a240(param_1,local_80,uVar5);
  if (&local_5c != pfVar4) {
    local_5c = *pfVar4;
    local_58 = pfVar4[1];
    local_54 = pfVar4[2];
  ...
  local_18 = (float)FUN_0050fb00(0x01E57284,&local_5c,&local_98);
  if (((0.0 <= local_18) && (local_18 < 1.0)) &&
     (fVar1 = 1.0 - (local_18 * local_20 - local_1c) / (local_20 - local_1c), local_f8 < fVar1)) {
    local_f8 = fVar1;
  }
  uVar5 = FUN_0051d2a0(param_1 + 0x150,local_50,_DAT_02dc9f58);
  pfVar4 = (float *)FUN_0040a240(param_1,local_44,uVar5);
  if (&local_5c != pfVar4) {
    local_5c = *pfVar4;
    local_58 = pfVar4[1];
    local_54 = pfVar4[2];
