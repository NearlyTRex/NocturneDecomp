...
section .text
    ...
    PUSH EBX                            ; 0043ff60
    CALL FUN_00447a70                   ; 0043ff61
        ;   XREF to: 00447a70 (UNCONDITIONAL_CALL)  ; undefined FUN_00447a70()
