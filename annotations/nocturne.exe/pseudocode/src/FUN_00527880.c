...
// Convention: unknown
// Signature: undefined4 FUN_00527880(double param_1,double param_2,double param_3,double param_4)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_00527880(double param_1,double param_2,double param_3,double param_4)
