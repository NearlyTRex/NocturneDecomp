...
section .text
    ...
    PUSH EBX                            ; 00408635
        ;   Label: LAB_00408635
    CALL FUN_00406f30                   ; 00408636
        ;   XREF to: 00406f30 (UNCONDITIONAL_CALL)  ; undefined FUN_00406f30()
    ADD ESP,0x4                         ; 0040863b
    PUSH EBX                            ; 0040863e
    CALL FUN_00406d80                   ; 0040863f
        ;   XREF to: 00406d80 (UNCONDITIONAL_CALL)  ; undefined FUN_00406d80()
