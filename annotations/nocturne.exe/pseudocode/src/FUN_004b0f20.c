...
// Convention: unknown
// Signature: undefined4 * FUN_004b0f20(int param_1,undefined4 *param_2)

#include "nocturne.h"

uint * FUN_004b0f20(int param_1,uint *param_2)

{
  ...
  if (*(int *)(0x01CC9450 + 4) == 0) {
    fVar4 = (float10)*(float *)(param_1 + 0x2cc);
    uVar2 = FUN_00563a30();
    iVar1 = FUN_00454530(uVar2);
    puVar3 = (uint *)((int)ROUND(fVar4) * 0x18 + *(int *)(iVar1 + 0x350));
    if (param_2 != puVar3) {
      *param_2 = *puVar3;
      param_2[1] = puVar3[1];
      param_2[2] = puVar3[2];
