...
// Convention: unknown
// Signature: void FUN_00411530(int param_1)
...

{
  ...
  if (*(int *)(param_1 + 0x570) == 0) {
    ...
    for (iVar4 = 0; iVar4 < *(int *)(0x01E57284 + 0x14cd6c); iVar4 = iVar4 + 1) {
      iVar2 = FUN_0040d890(*(uint *)(iVar5 + 0x14cd70 + 0x01E57284),DAT_00764368);
      *(int *)(param_1 + 0x570) = iVar2;
      if (iVar2 != 0) break;
      iVar5 = iVar5 + 4;
    }
    if (*(int *)(param_1 + 0x570) == 0) {
      uVar3 = FUN_0040d540("CBaron");
      uVar1 = 0x01CC9450;
      *(uint *)(param_1 + 0x570) = uVar3;
      FUN_004d9720(uVar1,uVar3);
      (*(code *)**(uint **)(*(int *)(param_1 + 0x570) + 0x14c))(*(int *)(param_1 + 0x570));
      FUN_004d8c60(0x01CC9450,*(uint *)(param_1 + 0x570));
