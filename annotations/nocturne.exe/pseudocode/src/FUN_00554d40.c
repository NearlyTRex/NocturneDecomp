...
// Convention: unknown
// Signature: void FUN_00554d40(int param_1,undefined4 param_2,int param_3)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_00554d40(int param_1,uint param_2,int param_3)

{
  ...
  local_14 = FUN_0040dda0(0x41200000,0x41a00000);
  *(int *)(param_1 + 0x20) = local_14;
  local_14 = FUN_0040dda0(0x40000000,*(uint *)(param_1 + 0x34));
  *(uint *)(param_1 + 0x28) = param_2;
  *(uint *)(param_1 + 0x24) = 1;
  *(int *)(param_1 + 0x2c) = local_14;
  FUN_0046b9c0(&DAT_01fba938,&local_30);
  ...
  FUN_0044d7a0(local_94,param_1 + 0x14);
  local_64 = local_18;
  local_6c = 0.0;
  local_68 = 0.0;
  pfVar4 = (float *)FUN_0044da40(local_94,local_3c,&local_6c);
  ...
  if (param_3 != 0) {
    FUN_0048c420(0x01C08D04,&local_6c,local_18,0,0);
  }
  uVar3 = 0x01C03A10;
  ...
  *(float *)(param_1 + 0x30) = fVar2 * fVar1;
  iVar5 = FUN_0047dc30(uVar3,"BnoLightningFlash" + 1);
  if (iVar5 == 0) {
    local_98 = fVar2 * fVar1 + _DAT_00597c99;
    if (1.0 < local_98) {
      local_98 = 1.0;
    }
    FUN_00446740(0x1fb8508,local_98);
    if (param_3 == 0) {
      return;
    }
  }
  ...
  FUN_0052ea60(0x02DC9450,param_1,"light?.wav",&local_6c);
  return;
}
