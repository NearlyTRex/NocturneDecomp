...
section .text
    ...
    PUSH ESI                            ; 0045bf1d
    PUSH EBX                            ; 0045bf1e
    CALL FUN_0045bab0                   ; 0045bf1f
        ;   XREF to: 0045bab0 (UNCONDITIONAL_CALL)  ; undefined FUN_0045bab0()
    ...
    PUSH ESI                            ; 0045bf43
    PUSH EBX                            ; 0045bf44
    CALL FUN_0045bab0                   ; 0045bf45
        ;   XREF to: 0045bab0 (UNCONDITIONAL_CALL)  ; undefined FUN_0045bab0()
    ADD ESP,0xc                         ; 0045bf4a
    PUSH EDI                            ; 0045bf4d
    PUSH EBP                            ; 0045bf4e
    PUSH EBX                            ; 0045bf4f
    CALL FUN_0045bab0                   ; 0045bf50
        ;   XREF to: 0045bab0 (UNCONDITIONAL_CALL)  ; undefined FUN_0045bab0()
    ...
    PUSH EDI                            ; 0045bf95
    PUSH EBX                            ; 0045bf96
    CALL FUN_0045bab0                   ; 0045bf97
        ;   XREF to: 0045bab0 (UNCONDITIONAL_CALL)  ; undefined FUN_0045bab0()
    ADD ESP,0xc                         ; 0045bf9c
    PUSH EBP                            ; 0045bf9f
    PUSH ESI                            ; 0045bfa0
    PUSH EBX                            ; 0045bfa1
    CALL FUN_0045bab0                   ; 0045bfa2
        ;   XREF to: 0045bab0 (UNCONDITIONAL_CALL)  ; undefined FUN_0045bab0()
