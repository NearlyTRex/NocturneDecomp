...
// Convention: unknown
// Signature: void FUN_004990c0(int param_1,float param_2,int param_3)
...

{
  ...
  if ((param_3 == 0) && (iVar4 = FUN_004e1660(param_1 + 0x150), *(int *)(iVar4 + 0x24) == 2)) {
    param_3 = 1;
  }
  if ((*(int *)(param_1 + 0x1f59c) == 0) || (*(int *)(param_1 + 0xbc90) == 2)) {
    ...
    if (*(int *)(param_1 + 0x1fa54) == 2) {
      ...
      FUN_005644a7(&local_134,10,&DAT_005993b0);
...
LAB_004993c1:
      ...
      uVar5 = FUN_0040a240(*(uint *)(param_1 + 0x1fa60),auStack_68,&fStack_50);
      FUN_0040a290(param_1,&fStack_74,uVar5);
      pfVar6 = (float *)FUN_0051d2a0(param_1 + 0x150,auStack_80,_DAT_01c713b0);
      fStack_98 = fStack_74 - *pfVar6;
      fStack_94 = fStack_70 - pfVar6[1];
      fStack_90 = fStack_6c - pfVar6[2];
      FUN_0054e4a0(&uStack_5c,&fStack_98);
...
LAB_0049915d:
  ...
  if (0.0 < *(float *)(param_1 + 0x1fa78)) {
    local_1c = (float)FUN_0040df00(*(float *)(param_1 + 0x1fa68) - *(float *)(param_1 + 0x1fa70));
    local_18 = local_1c;
    local_30 = (float)FUN_0040df00(*(float *)(param_1 + 0x1fa64) - *(float *)(param_1 + 0x1fa6c));
