...
section .text
    ...
    PUSH EDI                            ; 005525eb
    CALL FUN_00548170                   ; 005525ec
        ;   XREF to: 00548170 (UNCONDITIONAL_CALL)  ; undefined FUN_00548170()
