...
// Convention: unknown
// Signature: void FUN_00516d80(int param_1,undefined4 param_2)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_00516d80(int param_1,uint param_2)

{
  ...
  if ((*(int *)(param_1 + 0x2cc) == 1) && (*(int *)(param_1 + 0x5a4) == 0)) {
    iVar1 = FUN_0047dc30(0x01C03A10,param_1 + 0x2d4);
    if (iVar1 != 0) {
      *(uint *)(param_1 + 0x5a4) = 1;
      ...
      puVar2 = (uint *)FUN_0044da40(param_1 + 0x368,local_18,param_1 + 0x39c);
  ...
  if (*(int *)(param_1 + 0x5a4) != 0) {
    FUN_0041acb0((uint *)(param_1 + 0x350),param_2);
