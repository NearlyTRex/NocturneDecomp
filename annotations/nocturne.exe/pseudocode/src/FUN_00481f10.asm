...
;
; Referenced Globals:
;   string s_filmreel.kfm_00580fc5
;   string s_CFilmReel_00580fd2
...
;   undefined1* PTR_FUN_0059d064 = 00481fd0
;
; Called Functions:
;   FUN_0044b7a0
;   FUN_00454490
...
section .text
    ...
    PUSH EBX                            ; 00481f17
    CALL FUN_0044b7a0                   ; 00481f18
        ;   XREF to: 0044b7a0 (UNCONDITIONAL_CALL)  ; undefined FUN_0044b7a0()
    ADD ESP,0x4                         ; 00481f1d
    ADD EAX,0x1ec                       ; 00481f20
    PUSH EAX                            ; 00481f25
    CALL FUN_00454490                   ; 00481f26
    ...
    MOV dword ptr [EBX + 0x14c],0x59d064 ; 00481f45 | PTR_FUN_0059d064
    CALL FUN_00454580                   ; 00481f4f
