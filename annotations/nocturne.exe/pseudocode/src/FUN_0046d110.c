...
// Convention: unknown
// Signature: uint FUN_0046d110(float *param_1,float *param_2,float param_3,float *param_4)
  ...
  if (param_1[10] <= (float)_DAT_0057e47e) {
    ...
    if (local_6c <= param_2[1]) {
      ...
      if (*param_4 <= local_48) {
        ...
        uVar6 = FUN_0046cfa0(&local_4c,&local_58,param_3,param_4);
        uVar7 = FUN_0046cfa0(&local_58,&local_70,param_3,param_4);
        uVar8 = FUN_0046cfa0(&local_70,&local_4c,param_3,param_4);
        ...
        if (_DAT_0057e486 <= (double)fVar9) {
          ...
          local_60 = param_2[1];
          fVar9 = (float)FUN_0046c620(param_1,&local_64,&DAT_01bc995c);
          ...
          fVar9 = (float)FUN_0046c620(param_1,param_2,&DAT_01bc995c);
          if (0.0 <= fVar9) {
            uVar8 = 1;
            *param_4 = local_48;
          }
