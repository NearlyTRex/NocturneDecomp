...
;                               FUNCTION
; *****************************************************************************
; uint FUN_0042f330(int param_1,int param_2,int param_3,uint param_4,undefined1 param_5,undefined1 param_6,int param_7)
;
; Local Variables:
...
;
; XREF[2]:
;   FUN_0042f190 at 0042f235
;   FUN_0042f260 at 0042f307
;
; Referenced Globals:
...
section .text
    ...
    PUSH ESI                            ; 0042f4b1
    PUSH EDI                            ; 0042f4b2
    CALL FUN_0042f8c0                   ; 0042f4b3
        ;   XREF to: 0042f8c0 (UNCONDITIONAL_CALL)  ; undefined FUN_0042f8c0()
