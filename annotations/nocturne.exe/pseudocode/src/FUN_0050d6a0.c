...
// Convention: unknown
// Signature: void FUN_0050d6a0(undefined4 param_1,undefined4 *param_2,int param_3,int param_4,int param_5)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_0050d6a0(uint param_1,uint *param_2,int param_3,int param_4,int param_5)

{
  ...
  if (*(int *)(0x01C775EC + 500) == 2) {
    ...
    FUN_00461010(DAT_005ae704,(uint)lVar3 >> 0x10 | (int)((ulonglong)lVar3 >> 0x20) << 0x10);
  ...
  if (0 < param_3) {
    do {
      ...
      if (param_4 < 0xfde9) {
        FUN_0045ff20(DAT_005ae704,&uStack_f4);
      }
      else {
        FUN_0045f790(DAT_005ae704,&uStack_f4);
      }
      local_14 = local_14 + 1;
