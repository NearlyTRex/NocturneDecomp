...
section .text
    ...
    CALL FUN_0055ca90                   ; 004d4da0
        ;   XREF to: 0055ca90 (UNCONDITIONAL_CALL)  ; undefined FUN_0055ca90()
    ...
    CALL FUN_0055c9d0                   ; 004d4e53
        ;   XREF to: 0055c9d0 (UNCONDITIONAL_CALL)  ; undefined FUN_0055c9d0()
