...
;   undefined4 DAT_014b86e8
;   undefined4 DAT_014b86f4
;   undefined4 DAT_014b879c
;   undefined4 DAT_014b87a0
;   undefined4 DAT_014b87a4
;   undefined4 DAT_014b87a8
;
; Called Functions:
...
section .text
    ...
    FLD float ptr [ESI]                 ; 00448ad3 | DAT_014b86dc | DAT_014b86e8
    ADD EAX,ECX                         ; 00448ad5
    MOV EDX,ESI                         ; 00448ad7
    MOV dword ptr [ESP + 0x4],EAX       ; 00448ad9 | DAT_014b86f4
    ...
    MOV EAX,dword ptr [ESP + 0x4]       ; 00448aec
        ;   Label: LAB_00448aec
    FLD float ptr [EAX]                 ; 00448af0 | DAT_014b86dc | DAT_014b86f4
    ...
    MOV EAX,dword ptr [EDX]             ; 00448b16 | DAT_014b86dc
    MOV dword ptr [ECX],EAX             ; 00448b18 | DAT_014b87a0
    MOV EAX,dword ptr [EDX + 0x4]       ; 00448b1a | DAT_014b86e0
    MOV dword ptr [ECX + 0x4],EAX       ; 00448b1d | DAT_014b87a4
    MOV EAX,dword ptr [EDX + 0x8]       ; 00448b20 | DAT_014b86e4
    MOV dword ptr [ECX + 0x8],EAX       ; 00448b23 | DAT_014b87a8
    INC EBX                             ; 00448b26
        ;   Label: LAB_00448b26
    ...
    PUSH ECX                            ; 00448b63
    PUSH EDX                            ; 00448b64 | DAT_014b86dc
    ...
    MOV EAX,dword ptr [EDX]             ; 00448b8d | DAT_014b86dc
    MOV dword ptr [ECX],EAX             ; 00448b8f | DAT_014b87a0
    MOV EAX,dword ptr [EDX + 0x4]       ; 00448b91 | DAT_014b86e0
    MOV dword ptr [ECX + 0x4],EAX       ; 00448b94 | DAT_014b87a4
    MOV EAX,dword ptr [EDX + 0x8]       ; 00448b97 | DAT_014b86e4
    MOV dword ptr [ECX + 0x8],EAX       ; 00448b9a | DAT_014b87a8
    INC EBX                             ; 00448b9d
        ;   Label: LAB_00448b9d
    ...
    PUSH ECX                            ; 00448bc4
    PUSH EDX                            ; 00448bc5 | DAT_014b86dc
