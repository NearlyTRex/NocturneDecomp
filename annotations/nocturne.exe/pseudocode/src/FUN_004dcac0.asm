...
;                               FUNCTION
; *****************************************************************************
; int FUN_004dcac0(int param_1,byte param_2)
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH 0x5a0a80                       ; 004dcb51 | DAT_005a0a80
        ;   Label: LAB_004dcb51
    PUSH EBX                            ; 004dcb56
    CALL FUN_0056445f                   ; 004dcb57
        ;   XREF to: 0056445f (UNCONDITIONAL_CALL)  ; undefined FUN_0056445f()
    ADD ESP,0x8                         ; 004dcb5c
    PUSH EAX                            ; 004dcb5f
    CALL FUN_00564486                   ; 004dcb60
