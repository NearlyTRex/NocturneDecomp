...

{
  ...
  *(uint *)(param_1 + 0x23a4) = *(uint *)(param_1 + 0x23a8);
  ...
  while (0.0 < local_1a0) {
    uVar8 = FUN_004e11c0(local_28,&local_1a0);
    if (uVar8 < 0xb) {
      if (uVar8 == 6) {
        if (*(int *)(param_1 + 0x2590) != 0) {
          FUN_0043ac60(PTR_DAT_005ad350,"%s escaping from %s\n",param_1,
                       *(int *)(param_1 + 0x2590));
          FUN_00423ed0(local_194);
          local_190 = FUN_0040dda0(0x41200000,0x41700000);
          local_160 = param_1;
          local_15c = param_1;
      ...
      iVar7 = 0;
      iVar14 = 0;
      FUN_0040a240(param_1,&local_ec,&local_140);
      while (iVar7 < *(int *)(0x01E57284 + 0x14cd6c)) {
        iVar9 = FUN_0040d890(*(uint *)(iVar14 + 0x14cd70 + 0x01E57284),_DAT_01af4ed4);
        if (iVar9 == 0) {
LAB_004b6f82:
          iVar7 = iVar7 + 1;
          iVar14 = iVar14 + 4;
      ...
      if (local_24 != 0) {
        FUN_00456220(local_24,0x3dcccccd);
      }
    }
    else if (uVar8 == 0xc) {
      ...
      if (iVar7 != 0) {
        ...
        FUN_004bf360(*(int *)(_DAT_01cae0e8 * 4 + 0x1cae0d8) + 0x1f5a0,iVar7,1);
      }
    }
    else {
      FUN_0042add0(param_1,uVar8);
  ...
  *(float *)(param_1 + 0x2430) = param_2 * fVar1;
  local_18 = (float)FUN_004e18d0(local_28,10);
  bVar13 = 0.0 < local_18;
  if (bVar13) {
    local_2c = 1;
  }
  if (*(float *)(param_1 + 0x2434) <= 0.0) {
    local_18 = (float)FUN_004e18d0(param_1 + 0x150,5);
    if ((local_18 <= 0.0) && (local_18 = (float)FUN_004e18d0(param_1 + 0x150,8), local_18 <= 0.0)) {
...
LAB_004b7170:
  ...
  if (*(int *)(param_1 + 0x2590) == 0) {
    iVar7 = param_1 + 0x150;
    local_18 = (float)FUN_004e18d0(iVar7,3);
    if (((0.0 < local_18) || (local_18 = (float)FUN_004e18d0(iVar7,5), 0.0 < local_18)) ||
       (local_18 = (float)FUN_004e18d0(iVar7,8), 0.0 < local_18)) goto LAB_004b7170;
    iVar14 = FUN_00428c00(param_1,param_2);
    puVar6 = PTR_DAT_005ad350;
    if (iVar14 == 0) {
      switch(*(uint *)(param_1 + 0x1f924)) {
      case 0:
        iVar7 = FUN_004b81a0(param_1,param_2);
        if (iVar7 == 0) {
          ...
          if (((0.0 < *(float *)(param_1 + 0x1f570)) &&
             ...
             (iVar7 = FUN_0047dc30(0x01C03A10,param_1 + 0x1f574), puVar6 = PTR_DAT_005ad350,
             iVar7 == 0)) goto LAB_004b7672;
          *(uint *)(param_1 + 0x1f924) = 1;
          FUN_0043ac60(puVar6,"%s rescued, entering follow mode\n",param_1);
          FUN_0047ab70(0x01C03A10,param_1 + 0x1f5f8);
        }
        break;
      case 1:
        ...
        if ((iVar7 != 0) &&
          ...
          uVar10 = FUN_00552680(param_1 + 0x20,iVar7);
        ...
        if (*(int *)(param_1 + 0x1f930) == 0) {
          ...
          if (iVar7 == 0) {
            ...
            if (iVar7 == 0) {
              FUN_00428780(param_1,*(uint *)(_DAT_01cae0e8 * 4 + 0x1cae0d8),0x40a00000,
            ...
            if (uVar8 < 2) {
              ...
              FUN_004e16b0(iVar7,1,1);
            }
            else if (uVar8 < 3) {
              FUN_004e16b0(iVar7,2,1);
            }
            else {
              if (uVar8 != 3) goto LAB_004b7672;
              FUN_004e16b0(iVar7,0,1);
              puVar6 = PTR_DAT_005ad350;
              *(uint *)(param_1 + 0x1f924) = 2;
              FUN_0043ac60(puVar6,"%s left behind!\n",param_1);
              FUN_0047ab70(0x01C03A10,param_1 + 0x1f65c);
          ...
          *(uint *)(param_1 + 0x1f924) = 3;
          FUN_0043ac60(puVar6,"%s was led close enough, going home!\n",param_1);
          FUN_0047ab70(0x01C03A10,param_1 + 0x1f788);
          *(uint *)(param_1 + 0x2dbc) = 0;
        }
        break;
      case 2:
        iVar14 = FUN_004b81a0(param_1,param_2);
        if (iVar14 == 0) {
          FUN_00428780(param_1,*(uint *)(_DAT_01cae0e8 * 4 + 0x1cae0d8),0x40800000,0x41200000,
                       param_1 + 0x1f91c);
          uVar8 = *(uint *)(param_1 + 0x1f91c);
          local_50 = 0;
          if (uVar8 == 0) {
...
LAB_004b794d:
          ...
          FUN_0043ac60(PTR_DAT_005ad350,"%s was left behind, but now can follow again!\n",param_1);
          FUN_0047ab70(0x01C03A10,param_1 + 0x1f6c0);
        }
        break;
      case 3:
        if (*(int *)(param_1 + 0x1f930) == 0) {
          *(uint *)(param_1 + 0x1f924) = 2;
          FUN_0043ac60(puVar6,"%s doesn't know next waypoint going home.  Help me!\n",param_1);
        }
        else {
          FUN_00428780(param_1,*(uint *)(param_1 + 0x1f930),0x3f800000,0xbf800000,
                       param_1 + 0x1f91c);
          switch(*(uint *)(param_1 + 0x1f91c)) {
          case 0:
            FUN_0043ac60(PTR_DAT_005ad350,"%s reached waypoint %s!\n",param_1,
                         *(uint *)(param_1 + 0x1f930));
            puVar6 = PTR_DAT_005ad350;
            if (*(int *)(param_1 + 0x1f930) == *(int *)(param_1 + 0x1f928)) {
              *(uint *)(param_1 + 0x1f924) = 4;
              FUN_0043ac60(puVar6,"%s rescued and taken home!\n",param_1);
              *(uint *)(param_1 + 0x1f930) = 0;
            }
            else {
              uVar10 = FUN_00552680(param_1 + 0x20,*(int *)(param_1 + 0x1f928));
              *(uint *)(param_1 + 0x1f930) = uVar10;
            }
            break;
          case 1:
          ...
          case 3:
            ...
            puVar6 = PTR_DAT_005ad350;
            *(uint *)(param_1 + 0x1f924) = 2;
            FUN_0043ac60(puVar6,"%s got confused going home.  Help me!\n",param_1);
            FUN_004e16b0(iVar7,0,1);
            FUN_0047ab70(0x01C03A10,param_1 + 0x1f7ec);
            FUN_004802e0(0x01C03A10,param_1 + 0x1f5d8,1);
            *(uint *)(param_1 + 0x1f924) = 4;
            *(uint *)(param_1 + 0x1f930) = 0;
          }
        }
      ...
      case 4:
        ...
        if (*(int *)(param_1 + 0x1f92c) != 0) {
          ...
          puVar12 = (uint *)FUN_0040a290(param_1,local_8c,*(int *)(param_1 + 0x1f92c) + 0x20);
          ...
          local_34 = local_198;
          iVar7 = FUN_0054e4a0(local_14c,param_1 + 0x2414);
          fVar1 = local_198 * (float)_DAT_00585c3a;
          *(uint *)(param_1 + 0x2410) = *(uint *)(iVar7 + 4);
          if (fVar1 < 1.0) {
            local_18 = (float)FUN_0040df00(*(float *)(*(int *)(param_1 + 0x1f92c) + 0x34) -
                                           *(float *)(param_1 + 0x34));
            local_18 = (float)FUN_0040df00(local_18 - *(float *)(param_1 + 0x2410));
            *(float *)(param_1 + 0x2410) = (1.0 - fVar1) * local_18 + *(float *)(param_1 + 0x2410);
          }
          local_18 = (float)FUN_0040df00(*(uint *)(param_1 + 0x2410));
...
LAB_004b7672:
    ...
    uVar10 = FUN_0040a290(param_1,local_d4,*(int *)(param_1 + 0x2590) + 0x20);
    iVar7 = FUN_0054e4a0(local_c8,uVar10);
    local_18 = (float)FUN_0040df00(*(uint *)(iVar7 + 4));
    local_19c = local_18;
    ...
    *(float *)(param_1 + 0x34) = *(float *)(param_1 + 0x34) + local_19c;
    ...
    uVar10 = FUN_0051d380(param_1 + 0x150,local_98,0);
...
switchD_004b7b39_default:
  if (((0.0 < *(float *)(param_1 + 0x2434)) && (*(int *)(param_1 + 0x1f920) == 1)) &&
     (iVar7 = FUN_0040dea0(param_2 * _DAT_00585c76), iVar7 != 0)) {
    uVar10 = FUN_0051e0a0(param_1 + 0x150,"Bip01 L Forearm",0);
    iVar7 = FUN_005179d0(uVar10);
    if (-1 < iVar7) {
      uVar10 = FUN_0051d2a0(param_1 + 0x150,local_bc,iVar7);
      FUN_0040a240(param_1,local_158,uVar10);
      local_11c = 0x40400000;
      local_118 = 0;
      local_114 = 0;
      FUN_0040a200(param_1,local_134,&local_11c);
      FUN_004b00f0(0x01C78C7C,local_158,local_134,0);
    }
  }
  ...
  if (local_2c == 0) {
    ...
    *(float *)(param_1 + 0x2dcc) = *(float *)(param_1 + 0x2dcc) + param_2;
    ...
    pfVar11 = (float *)FUN_0040a200(param_1,local_80,param_1 + 0x2414);
...
LAB_004b72a1:
  ...
  if (*(int *)(param_1 + 0x1f920) == 1) {
    ...
    local_4c = 0;
    if (((iVar7 != 0) && (local_18 = (float)FUN_004e18d0(param_1 + 0x150,0x10), local_18 <= 0.0)) ||
       (local_4c != 0)) {
    ...
    *(float *)(param_1 + 0x1f94c) = fVar1;
    if (0.0 < *(float *)(param_1 + 0x1f94c)) {
      ...
      iVar7 = param_1 + 0x150;
      local_58 = (float)FUN_004e1f50(iVar7,_DAT_01cae1a0,
                                     *(float *)(param_1 + 0x1f948) * (float)_DAT_00585c92 +
                                     (float)_DAT_00585c9a);
      local_18 = local_58;
      FUN_0051c3d0(iVar7,_DAT_01cae1a0,local_58,*(uint *)(param_1 + 0x1f94c),
  ...
  FUN_00429730(param_1,param_2,bVar13);
  FUN_0042a150(param_1,param_2);
  if ((1.0 <= *(float *)(param_1 + 0x1f948)) &&
     (iVar7 = FUN_0040d890(*(uint *)(param_1 + 0x24f0),_DAT_02ddf9a8), iVar7 != 0)) {
    uVar10 = *(uint *)(iVar7 + 0x564);
    *(uint *)(iVar7 + 0x564) = 6;
    (**(code **)(*(int *)(iVar7 + 0x14c) + 0xdc))(iVar7);
    *(uint *)(iVar7 + 0x564) = uVar10;
    FUN_004e16b0(param_1 + 0x150,0xc,1);
    *(uint *)(param_1 + 0x1f94c) = 0;
    *(uint *)(param_1 + 0x1f948) = 0;
  }
  if (((*(int *)(param_1 + 0x1f920) == 1) &&
      (iVar7 = FUN_0040d890(*(uint *)(param_1 + 0x24f0),_DAT_02ddf9a8), iVar7 != 0)) &&
     (iVar7 = FUN_0047dc30(0x01C03A10,"deputeFireShotgun"), iVar7 != 0)) {
