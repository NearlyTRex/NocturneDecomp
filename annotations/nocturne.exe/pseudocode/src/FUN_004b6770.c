...
// Convention: unknown
// Signature: void FUN_004b6770(int param_1,float param_2)
...

{
  ...
  if (*(int *)(iVar1 + 0x24) != 1) {
    ...
    if (iVar1 != 0) {
      ...
      uVar3 = FUN_004d90a0(0x01CC9450,"GlassHiram",_DAT_01c78c78);
      iVar1 = FUN_0040d890(uVar3);
      if (iVar1 != 0) {
  ...
  *(uint *)(param_1 + 0x23a4) = *(uint *)(param_1 + 0x23a8);
  while (0.0 < local_18[0]) {
    iVar2 = FUN_004e11c0(iVar1,local_18);
    if (iVar2 == 0x29a) {
      FUN_004d9110(0x01CC9450,param_1,1);
    }
    else {
      FUN_0042add0(param_1,iVar2);
    }
  }
  FUN_0051b8a0(iVar1);
