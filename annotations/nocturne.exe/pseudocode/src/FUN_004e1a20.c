...
// Convention: unknown
// Signature: undefined4 FUN_004e1a20(int *param_1,int *param_2,float *param_3,float param_4,undefined4 param_5)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_004e1a20(int *param_1,int *param_2,float *param_3,float param_4,uint param_5)
