...
// Convention: unknown
// Signature: int FUN_00509140(int param_1)
...

{
  ...
  if (0.0 < fVar3) {
    ...
    if (0 < *(int *)(param_1 + 0x14cd6c)) {
      do {
        iVar9 = FUN_0040d890(*(uint *)(iVar6 + 0x14cd70),DAT_00765a98);
        local_38 = iVar9;
        if (((iVar9 != 0) && (iVar8 = (**(code **)(*(int *)(iVar9 + 0x14c) + 0x104))(), iVar8 == 0))
           && (iStack_48 = iVar8, iVar9 = FUN_0048c160(0x01C08D04,iVar9 + 0x20,0,&uStack_68),
              iVar9 != 0)) {
          FUN_00423ed0();
          uStack_74 = 4;
        ...
        iVar9 = FUN_0040d890(*(uint *)(iVar6 + 0x14cd70),_DAT_01c78c78);
        if (iVar9 != 0) {
          iStack_34 = iVar9 + 0x20;
          iVar8 = FUN_0048c160(0x01C08D04,iStack_34,0,0);
          if ((iVar8 != 0) && (iVar8 = FUN_004aded0(), iVar8 != 0)) {
            FUN_004ada20(iVar9);
          }
        }
        iVar9 = FUN_0040d890(*(uint *)(iVar6 + 0x14cd70),_DAT_02dd10bc);
        if (((iVar9 != 0) && (*(int *)(iVar9 + 0x16c) == 7)) && (*(char *)(iVar9 + 0x2fc) == '\0'))
        {
          uStack_4c = 0;
          iVar8 = FUN_0048c160(0x01C08D04,iVar9 + 0x20,0,0);
          if (iVar8 != 0) {
            FUN_005485e0(iVar9);
          }
        }
        iVar9 = FUN_0040d890(*(uint *)(iVar6 + 0x14cd70),_DAT_01c7068c);
        if ((iVar9 != 0) && (iVar9 = FUN_0048c160(0x01C08D04,iVar9 + 0x20,0), iVar9 != 0)) {
          FUN_0048e550();
        }
        iVar7 = iVar7 + 1;
        iVar6 = iVar6 + 4;
    ...
    if (*(int *)(0x01C775EC + 0x20c) != 0) {
      if (*(int *)(0x01C775EC + 0x20c) == 2) {
        ...
        if (0 < iVar6) {
          ...
          do {
            ...
            iVar9 = iVar9 + 4;
            iVar8 = iVar7 + 1;
            FUN_0043ac60(PTR_DAT_005ad350,"%d. %s : %3.2f ms\n",iVar7,*puVar2,
      ...
      iStack_18 = FUN_00558a30();
      iStack_18 = iStack_18 - local_44;
      FUN_0043ac60(PTR_DAT_005ad350,"Process time (%d actors) : %3.2f ms\n",local_20,
                   ((double)iStack_18 * _DAT_005904e2 * _DAT_005904ea * _DAT_005904f2) /
                   (double)fVar3);
    }
    iVar6 = 0;
    if (0 < *(int *)(param_1 + 0x14cd6c)) {
