...
// Convention: unknown
// Signature: void FUN_004bbaf0(int param_1,float param_2)
...
LAB_004bbb59:
  if (0.0 < local_34[0]) {
    uVar5 = FUN_004e11c0(iVar4,local_34);
    if (uVar5 < 0x29a) {
    ...
    if (uVar5 < 0x29b) {
      ...
      if ((((iVar7 != 0) &&
        ...
        local_50 = 0;
        local_4c = 0;
        FUN_0040a240(param_1,&local_68,&local_50);
        fVar1 = local_68 - *(float *)(*(int *)(param_1 + 0xbca4) + 0x20);
        fVar3 = local_60 - *(float *)(*(int *)(param_1 + 0xbca4) + 0x28);
        bVar2 = (float)_DAT_0058646d < SQRT(fVar3 * fVar3 + fVar1 * fVar1);
        if (((ABS(local_64 - *(float *)(*(int *)(param_1 + 0xbca4) + 0x24)) <= (float)_DAT_00586475)
            && ((bVar2 || (iVar7 = (**(code **)(*(int *)(*(int *)(param_1 + 0xbca4) + 0x14c) + 0xe4)
                                   )(*(int *)(param_1 + 0xbca4),param_1,0), iVar7 != 0)))) &&
           (!bVar2)) {
          FUN_004e16b0(iVar4,9,1);
          goto LAB_004bbb59;
        }
      }
    ...
    if (uVar5 == 0x29b) {
      if (*(int *)(param_1 + 0xbca4) == 0) {
        ...
        uVar6 = FUN_0051d2a0(iVar4,local_104,_DAT_01cae30c);
        FUN_0040a240(param_1,local_8c,uVar6);
        FUN_00423ed0(local_164);
        local_160 = (float)FUN_0040dda0(0x40a00000,0x41200000);
        local_130 = param_1;
        local_12c = param_1;
        local_14 = local_160;
        (**(code **)(*(int *)(*(int *)(param_1 + 0xbca4) + 0x14c) + 0x100))
                  (*(int *)(param_1 + 0xbca4),local_164);
        fVar9 = (float10)local_160 * (float10)_DAT_00586455 * (float10)_DAT_0058645d;
        FUN_00563a30(0);
        local_3c = (int)ROUND(fVar9);
        FUN_004b0200(0x01C78C7C,local_8c,0,local_3c);
  ...
  if (iVar8 == 0) {
    ...
    case 0:
      ...
      if (iVar7 == 0) {
        ...
        iVar7 = *(int *)(param_1 + 0xbca4);
        if (iVar7 == 0) {
          iVar7 = FUN_0047a030(param_1,param_2);
          if (iVar7 != 0) {
            FUN_004e16b0(iVar4,1,1);
          }
        }
          ...
          if (local_20 < 0x40000000) {
            FUN_0054e4a0(local_e0,&local_80);
            local_14 = (float)FUN_0040df00(local_dc - *(float *)(param_1 + 0x34));
            if (ABS(local_14) < (float)_DAT_0058644d) {
          ...
          FUN_004e16b0(iVar4,3,1);
        }
      }
      else {
        iVar4 = FUN_0040dea0(0x3dcccccd);
        if (iVar4 != 0) {
    ...
    case 2:
      ...
      if (*(int *)(param_1 + 0xbca4) == 0) {
        ...
        if (iVar7 == 0) {
          ...
          *(uint *)(param_1 + 0x23a4) = *(uint *)(param_1 + 0x23a8);
          ...
          iVar7 = FUN_004247f0(param_1,*(int *)(param_1 + 0xbca4) + 0x20,uVar6);
          if (-1 < iVar7) {
            ...
            if (((local_1c < _DAT_0059f57c) &&
              ...
              FUN_0054e4a0(local_ec,&local_74);
              local_14 = (float)FUN_0040df00(local_e8 - *(float *)(param_1 + 0x34));
              if ((ABS(local_14) < (float)_DAT_0058644d) &&
                 (iVar4 = FUN_0040dea0(0x3dcccccd), iVar4 != 0)) {
            ...
            if ((local_1c <= local_28) && (*(float *)(param_1 + 0xbca0) <= 0.0)) {
              ...
              FUN_0054e4a0(local_11c,&local_d4);
              local_14 = (float)FUN_0040df00(local_118 - *(float *)(param_1 + 0x34));
              if (ABS(local_14) < (float)_DAT_0058644d) {
            ...
            *(float *)(param_1 + 0xbd2c) = fVar1;
            if (fVar1 < 0.0) {
              *(uint *)(param_1 + 0xbd2c) = 0;
              iVar4 = FUN_00526c50(*(uint *)(param_1 + 0xbd24));
              if ((iVar4 == 0) &&
                 (iVar4 = FUN_00526c50(*(uint *)(param_1 + 0xbd28)), iVar4 == 0)) {
                uVar6 = (**(code **)(*(int *)(param_1 + 0x14c) + 0x24))
                                  (param_1,"imp-laugh?.wav");
                *(uint *)(param_1 + 0xbd24) = uVar6;
                local_14 = (float)FUN_0040dda0(0x41200000,0x41a00000);
      ...
      break;
    case 3:
      fVar1 = *(float *)(param_1 + 0xbd2c) - param_2 * _DAT_00586445;
      *(float *)(param_1 + 0xbd2c) = fVar1;
      if (fVar1 < 0.0) {
        *(uint *)(param_1 + 0xbd2c) = 0;
        iVar4 = FUN_00526c50(*(uint *)(param_1 + 0xbd24));
        if ((iVar4 == 0) && (iVar4 = FUN_00526c50(*(uint *)(param_1 + 0xbd28)), iVar4 == 0)) {
      ...
      break;
    case 4:
      FUN_00423ed0(local_1a0);
      local_19c = (float)FUN_0040dda0(0x40400000,0x40a00000);
      local_16c = param_1;
      local_168 = param_1;
      local_14 = local_19c;
      uVar6 = FUN_0055a8b0(local_b0,&DAT_02dd1184,param_1 + 0xfd0 + _DAT_01cae314 * 0x30,0x3ecccccd,
                           local_1a0);
      uVar6 = FUN_0040a240(param_1,local_5c,uVar6);
      iVar4 = FUN_004798e0(param_1,uVar6);
      if (iVar4 != 0) {
        iVar7 = 0;
        iVar4 = 0;
        while (iVar4 < *(int *)(0x01E57284 + 0x150bf4)) {
          iVar8 = FUN_0040d890(*(uint *)(iVar7 + 0x150bf8 + 0x01E57284),_DAT_01cae374);
    ...
    case 7:
      if ((*(int *)(param_1 + 0xbc90) == 0) && (*(int *)(param_1 + 0xdc) == 0)) {
        uVar6 = FUN_0051d2a0(iVar4,local_f8,0);
        FUN_0040a240(param_1,local_c8,uVar6);
...
switchD_004bc7ad_caseD_5:
  ...
  iVar4 = FUN_00425960(param_1);
  if ((iVar4 != 0) && (local_24 != 9)) {
    *(float *)(param_1 + 0x2424) = *(float *)(param_1 + 0x2424) - param_2 * (float)_DAT_00586465;
    ...
    *(float *)(param_1 + 0x23a4) = *(float *)(param_1 + 0x23a8);
    FUN_00425050(param_1,&local_110);
  }
