...
;
; XREF[1]:
;   FUN_00533210 at 00533517
;
; Referenced Globals:
;   undefined4 DAT_005950ee
;   undefined4 DAT_005950f2
;   undefined4 DAT_005950f6
;   undefined4 DAT_005950fa
...
section .text
    ...
    PUSH EAX                            ; 005337b6
    FXCH ST3                            ; 005337b7
    FLD float ptr [0x005950ee]          ; 005337b9 | DAT_005950ee
    FXCH                                ; 005337bf
    FADD ST0,ST1                        ; 005337c1
    FXCH ST3                            ; 005337c3
    FADDP                               ; 005337c5
    FXCH                                ; 005337c7
    FLD float ptr [0x005950f2]          ; 005337c9 | DAT_005950f2
    FXCH                                ; 005337cf
    ...
    CALL FUN_0041dbc0                   ; 005337f7
        ;   XREF to: 0041dbc0 (UNCONDITIONAL_CALL)  ; undefined FUN_0041dbc0()
    ADD ESP,0x4                         ; 005337fc
    PUSH 0x5993b0                       ; 005337ff | DAT_005993b0
    PUSH 0x8                            ; 00533804
    LEA EAX,[ESP + 0x14]                ; 00533806
    PUSH EAX                            ; 0053380a
    XOR EDI,EDI                         ; 0053380b
    LEA EBX,[ESP + 0x18]                ; 0053380d
    CALL FUN_005644a7                   ; 00533811
    ...
    FXCH                                ; 005338f7
    FMUL float ptr [0x005950f6]         ; 005338f9 | DAT_005950f6
    FXCH                                ; 005338ff
    FSTP float ptr [ESP + 0x1c0]        ; 00533901
    FADD float ptr [0x005950fa]         ; 00533908 | DAT_005950fa
    ...
    PUSH EAX                            ; 00533b27
    PUSH EBX                            ; 00533b28
    CALL FUN_0040a740                   ; 00533b29
        ;   XREF to: 0040a740 (UNCONDITIONAL_CALL)  ; undefined FUN_0040a740()
    ...
    CALL FUN_0040a290                   ; 00533bf6
        ;   XREF to: 0040a290 (UNCONDITIONAL_CALL)  ; undefined FUN_0040a290()
    ADD ESP,0xc                         ; 00533bfb
    LEA EAX,[ESP + 0x6c]                ; 00533bfe
    PUSH EAX                            ; 00533c02
    CALL FUN_00423ed0                   ; 00533c03
