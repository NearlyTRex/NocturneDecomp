...
// Convention: unknown
// Signature: void FUN_0051d3c0(int param_1)
...

{
  ...
  if (0 < *(int *)(local_2c + 0x28558)) {
    ...
    do {
      local_28 = iVar2 * 0x30;
      FUN_0055cd70(local_24,local_1c);
      ...
      if (*(int *)(local_20 + 0x2857c) < 0) {
        ...
        *(float *)(iVar3 + 0xeac) =
        ...
        FUN_0055a8b0(&local_3c,local_30 + local_18,*(int *)(local_20 + 0x2857c) * 0x30 + local_14);
