...
section .text
    ...
    PUSH ESI                            ; 004c6896
    CALL FUN_0040c6d0                   ; 004c6897
        ;   XREF to: 0040c6d0 (UNCONDITIONAL_CALL)  ; undefined FUN_0040c6d0()
    ADD ESP,0x8                         ; 004c689c
    MOV ESI,ESP                         ; 004c689f
    PUSH ESI                            ; 004c68a1
    PUSH EDI                            ; 004c68a2
    CALL FUN_00454580                   ; 004c68a3
