...
section .text
    ...
    PUSH EAX                            ; 00470588
    CALL FUN_004746b0                   ; 00470589
        ;   XREF to: 004746b0 (UNCONDITIONAL_CALL)  ; undefined FUN_004746b0()
    ...
    PUSH EAX                            ; 004705a6
    CALL FUN_00473fd0                   ; 004705a7
        ;   XREF to: 00473fd0 (UNCONDITIONAL_CALL)  ; undefined FUN_00473fd0()
    ...
    PUSH EAX                            ; 004705e0
    CALL FUN_00474090                   ; 004705e1
        ;   XREF to: 00474090 (UNCONDITIONAL_CALL)  ; undefined FUN_00474090()
