...
// Convention: unknown
// Signature: void FUN_00412de0(int param_1,int *param_2)
...
switchD_00412e16_default:
  ...
  if (iVar2 != 0) {
    ...
    if (*param_2 == *(int *)(param_1 + 0xbd44)) {
      FUN_00427eb0(param_1,uVar3,*(uint *)(param_1 + 0xbd48),0);
    }
    if (*(int *)(param_1 + 0xbd4c) == *param_2) {
      FUN_00427eb0(param_1,uVar3,*(uint *)(param_1 + 0xbd50),0);
    }
    if (*(int *)(param_1 + 0xbd28) == *param_2) {
      piVar1 = param_2 + 3;
      ...
      FUN_00427e40(param_1,*(uint *)(param_1 + 0xbd24),piVar1,0);
    }
