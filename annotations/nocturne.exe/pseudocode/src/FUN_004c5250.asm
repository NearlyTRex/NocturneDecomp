...
;
; Referenced Globals:
;   undefined4 s_speed_00587833+1
;   string s_modelName_0058783a
;   string s_guardDistance_00587844
;   string s_motion_state_00587852
;   undefined4 DAT_005bac7c
;
; Called Functions:
;   FUN_0040c880
;   FUN_0040ca80
...
section .text
    ...
    PUSH EAX                            ; 004c527d
    CALL FUN_0040ca80                   ; 004c527e
        ;   XREF to: 0040ca80 (UNCONDITIONAL_CALL)  ; undefined FUN_0040ca80()
    MOV EDX,dword ptr [0x005bac7c]      ; 004c5283 | DAT_005bac7c
