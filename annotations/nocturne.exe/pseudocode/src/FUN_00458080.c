...
// Convention: unknown
// Signature: void FUN_00458080(int *param_1,int param_2)
...

{
  ...
  if (DAT_006b0280 != 0) {
    ...
    iVar8 = FUN_004f9a10(&DAT_005c5014 + *param_1 * 0xc,&DAT_005c5014 + param_1[1] * 0xc);
    if (iVar8 == 0) {
      return;
    }
  }
      ...
      if (_DAT_01c039a4 < 2) {
        ...
        if (0 < param_2) {
          do {
            ...
            iVar8 = iVar8 + 1;
            FUN_004f9870(&DAT_005c5014 + *piVar7 * 0xc);
            piVar7 = piVar7 + 1;
          } while (iVar8 < param_2);
        }
      }
        ...
        do {
          apuStack_78[0] = (uint *)0x1;
          iVar8 = iVar8 + 1;
          FUN_004f99d0(&DAT_005c5014 + *piVar7 * 0xc);
          piVar7 = piVar7 + 1;
        } while (iVar8 < param_2);
      }
    }
...
LAB_00458358:
    ...
    FUN_00532650(apuStack_78 + 1,param_2);
  }
  return;
}
