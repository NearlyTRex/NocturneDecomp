...
// Convention: unknown
// Signature: void FUN_00493760(int param_1,uint param_2,uint param_3)
...

{
  ...
  iVar6 = iVar6 + iVar5;
  FUN_00490b20(param_1,param_2 >> 1,iVar6 - iVar5,1,6,"maxCharHght: %d",
               *(uint *)(param_1 + 0x316c));
  if ((uint)(*(int *)(param_1 + 0x316c) + iVar6) < param_3) {
    iVar4 = param_2 - 1;
    _DAT_01c00c70 = 4;
  ...
  uVar3 = FUN_00493110(param_1,0xff);
  ...
  FUN_00490b20(param_1,param_2 >> 1,iVar6,1,6,&DAT_00581ae0,uVar3);
  return;
}
