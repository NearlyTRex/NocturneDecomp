...
section .text
    ...
    PUSH EAX                            ; 004fe45e
    PUSH ESI                            ; 004fe45f
    CALL FUN_005058b0                   ; 004fe460
        ;   XREF to: 005058b0 (UNCONDITIONAL_CALL)  ; undefined FUN_005058b0()
