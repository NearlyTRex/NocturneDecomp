...
// Convention: unknown
// Signature: undefined1 FUN_00515350(int param_1,char *param_2)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

byte FUN_00515350(int param_1,char *param_2)

{
  ...
  FUN_0044d7a0(param_2 + 0x110,param_1 + 0x110);
  *(uint *)(param_2 + 0x138) = *(uint *)(param_1 + 0x11c);
  fVar5 = (float10)*(float *)(param_1 + 0x120) * (float10)_DAT_00590e61;
  FUN_00563a30();
  *(int *)(param_2 + 0x2fa4) = (int)ROUND(fVar5);
  pcVar3 = (char *)(param_1 + 4);
  FUN_00452080(param_2,*(uint *)(param_1 + 0x124));
