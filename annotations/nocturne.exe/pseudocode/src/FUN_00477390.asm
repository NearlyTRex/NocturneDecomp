...
section .text
    ...
    PUSH EAX                            ; 00477409
    PUSH EBX                            ; 0047740a
    CALL FUN_00477370                   ; 0047740b
        ;   XREF to: 00477370 (UNCONDITIONAL_CALL)  ; undefined FUN_00477370()
