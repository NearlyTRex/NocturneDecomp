...
// Convention: unknown
// Signature: int FUN_0050b5c0(int param_1,undefined4 param_2,int param_3)
...
int FUN_0050b5c0(int param_1,uint param_2,int param_3)

{
  ...
  if (_DAT_01fff548 != 0) {
    ...
    FUN_0050aee0(param_1,puVar6,puVar7,puVar8,puVar9,puVar11);
    _DAT_01fff548 = 0;
  }
  iVar3 = 0;
  iVar2 = 0;
  if (0 < _DAT_01fff07c) {
    ...
    do {
      ...
      iVar4 = iVar4 + 4;
      iVar3 = iVar3 + 1;
      iVar1 = FUN_00442c50(0x1fb8508,param_2,*puVar12,param_3);
      iVar2 = iVar2 + iVar1;
  ...
  if (0 < _DAT_01fff090) {
    ...
    do {
      ...
      iVar4 = iVar4 + 4;
      iVar3 = iVar3 + 1;
      iVar1 = FUN_0044d2d0(*puVar12,param_2,param_3);
      iVar2 = iVar2 + iVar1;
  ...
  if (0 < *(int *)(param_1 + 0x15a8cc)) {
    local_14 = param_1;
    do {
      FUN_004d7b30(*(int *)(local_14 + 0x15a8d0) + 0x1e4,param_2);
      local_48 = local_3c;
      ...
      *(uint *)(&stack0xffffffc0 + (uint)bVar5 * -8 + (uint)bVar5 * -8) =
      ...
      if (param_3 != 0) {
        FUN_004d7bd0(*(int *)(local_14 + 0x15a8d0) + 0x1e4,param_2,param_3);
        local_24 = local_30;
      ...
      if (0 < _DAT_01fba2d8) {
        ...
        do {
          ...
          iVar1 = FUN_00442c50(0x1fb8508,&stack0xffffffb8,uVar10,puVar12);
          iVar2 = iVar2 + iVar1;
          iVar3 = iVar3 + 1;
          iVar4 = iVar4 + 4;
