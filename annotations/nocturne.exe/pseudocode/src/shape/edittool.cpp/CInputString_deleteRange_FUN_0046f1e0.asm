...
;   shape_edittool.cpp_CInputString_deleteSelection_FUN_0046f250 at 0046f26c
;   shape_edittool.cpp_CInputString_handleKeyboardInput_FUN_0046f390 at 0046f5b3
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 0046f1e0
        ;   Label: shape_edittool.cpp_CInputString_deleteRange_FUN_0046f1e0
    PUSH ESI                            ; 0046f1e1
    PUSH EDI                            ; 0046f1e2
