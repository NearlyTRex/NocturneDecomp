...
// Convention: unknown
// Signature: void FUN_00473cf0(int *param_1,int param_2,char *param_3)
...

{
  ...
  *param_1 = iVar5;
  if (param_1[1] < iVar5) {
    FUN_00473de0(param_1,iVar2 + 0x15);
  }
  iVar2 = param_2 * 4;
  FUN_00566170(param_1[2] + iVar2 + 4,param_1[2] + iVar2,(*param_1 - param_2) * 4 + -4);
  uVar4 = 0xffffffff;
  pcVar6 = param_3;
  do {
    if (uVar4 == 0) break;
