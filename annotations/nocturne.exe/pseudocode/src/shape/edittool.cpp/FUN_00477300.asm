...
;                               FUNCTION
; *****************************************************************************
; int shape_edittool_cpp_FUN_00477300(undefined4 param_1)
;
;
; XREF[3]:
;   shape_edittool.cpp_FUN_004771f0 at 00477278
;   shape_edittool.cpp_FUN_00477370 at 00477375
;   shape_edittool.cpp_FUN_00477390 at 004773bf
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00477300
        ;   Label: shape_edittool.cpp_FUN_00477300
    MOV EDX,dword ptr [ESP + 0x8]       ; 00477301
    PUSH EDX                            ; 00477305
    CALL shape_edittool.cpp_FUN_00477340 ; 00477306
