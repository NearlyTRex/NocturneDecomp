...
section .text
    ...
    MOV dword ptr [0x01cc4800],ESI      ; 0046f6e7 | DAT_01cc4800
    MOV [0x01cc4804],EAX                ; 0046f6ed | DAT_01cc4804
    CALL FUN_004c8440                   ; 0046f6f2
    ...
    PUSH EAX                            ; 0046f751
        ;   Label: LAB_0046f751
    PUSH EBX                            ; 0046f752
    CALL FUN_0046f5c0                   ; 0046f753
        ;   XREF to: 0046f5c0 (UNCONDITIONAL_CALL)  ; undefined FUN_0046f5c0()
    ADD ESP,0x8                         ; 0046f758
    LEA ESI,[EDI + EAX*0x1]             ; 0046f75b
    MOV EAX,dword ptr [EBX + 0x134]     ; 0046f75e
    PUSH EAX                            ; 0046f764
    PUSH EBX                            ; 0046f765
    CALL FUN_0046f5c0                   ; 0046f766
        ;   XREF to: 0046f5c0 (UNCONDITIONAL_CALL)  ; undefined FUN_0046f5c0()
