...
// Convention: unknown
// Signature: void FUN_00475470(int *param_1,undefined4 param_2,undefined4 param_3)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_00475470(int *param_1,uint param_2,uint param_3)

{
  ...
  param_1[0x45] = 8;
  param_1[0x29] = 1;
  FUN_00563cc0(param_1 + 0x1f,0,0x28);
  local_14 = 0;
  if (0 < *param_1) {
    do {
      pcVar3 = (char *)FUN_00474080(param_1,local_14);
      iVar10 = 0;
      piVar5 = param_1;
      while( true ) {
        cVar1 = *pcVar3;
        ...
        *pcVar8 = '\0';
        iVar4 = FUN_00492da0(_DAT_01bcd070,local_144);
  ...
  FUN_00471a80(0x01BCD074,iVar10,iVar4,param_2,param_3);
  ...
  FUN_004764d0(param_1 + 0x4e,iVar6,iVar9,_DAT_01c00c60,_DAT_01c00c64);
LAB_0047587b:
