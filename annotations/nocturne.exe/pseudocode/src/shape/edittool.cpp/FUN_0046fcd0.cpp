...

{
  ...
  FUN_00563a08(0x1bca4d0,param_2,&local_18);
  local_18 = (byte *)0x0;
  local_14 = "Error";
  iVar1 = FUN_00492da0(_DAT_01bcd070,"Error");
  iVar2 = FUN_00492da0(_DAT_01bcd070,0x1bca4d0);
  if (iVar1 < iVar2) {
    iVar1 = iVar2;
  }
  iVar3 = FUN_00492e60(_DAT_01bcd070,0x1bca4d0);
  FUN_00471a80(param_1,_DAT_01bcd9b8 * 4 + iVar1,_DAT_01bcd9bc * 2 + iVar3,local_14,0);
  FUN_004722b0(param_1);
  FUN_00408370(0xffff);
  FUN_00490980(_DAT_01bcd070,0x1bca4d0,((_DAT_01c00c58 + _DAT_01c00c60) - iVar2) / 2,
