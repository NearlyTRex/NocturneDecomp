...
// Convention: unknown
// Signature: void FUN_004764d0(int param_1,undefined4 param_2,undefined4 param_3,int param_4,int param_5)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_004764d0(int param_1,uint param_2,uint param_3,int param_4,int param_5)
