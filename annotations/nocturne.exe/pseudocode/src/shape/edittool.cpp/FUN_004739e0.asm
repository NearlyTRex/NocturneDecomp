...
;   shape_edittool.cpp_FUN_004737a0
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 004739e0
        ;   Label: shape_edittool.cpp_FUN_004739e0
    ...
    PUSH ECX                            ; 00473a45
    CALL shape_edittool.cpp_FUN_004737a0 ; 00473a46
        ;   XREF to: 004737a0 (UNCONDITIONAL_CALL)  ; undefined shape_edittool.cpp_FUN_004737a0()
