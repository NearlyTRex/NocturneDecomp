...
;                               FUNCTION
; *****************************************************************************
; void shape_edittool_cpp_FUN_00473190(undefined4 param_1,undefined4 *param_2,undefined4 *param_3,undefined4 param_4)
;
;
; XREF[1]:
;   shape_edittool.cpp_FUN_00473650 at 004736ae
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00473190
        ;   Label: shape_edittool.cpp_FUN_00473190
    PUSH ESI                            ; 00473191
    PUSH EDI                            ; 00473192
    PUSH EBP                            ; 00473193
