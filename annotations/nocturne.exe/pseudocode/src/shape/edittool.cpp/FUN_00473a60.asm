...
section .text
    ...
    PUSH EDI                            ; 00473b21
        ;   Label: LAB_00473b21
    PUSH ESI                            ; 00473b22
    MOV ESI,0x57eb12                    ; 00473b23
    MOV EDI,0x93b                       ; 00473b28
    PUSH 0x57eb28                       ; 00473b2d
    MOV dword ptr [0x01cc4800],ESI      ; 00473b32 | DAT_01cc4800
    MOV dword ptr [0x01cc4804],EDI      ; 00473b38 | DAT_01cc4804
    CALL FUN_004c8440                   ; 00473b3e
