...
;
; Referenced Globals:
;   string s_..\\shape\\edittool.cpp_0057f012
;   string s_CPickList::swap_-_can't_do_this_a_0057f028
...
section .text
    ...
    PUSH EBP                            ; 0047621e
    CALL FUN_00474300                   ; 0047621f
        ;   XREF to: 00474300 (UNCONDITIONAL_CALL)  ; undefined FUN_00474300()
