...
section .text
    ...
    MOV dword ptr [0x01cc4800],EBX      ; 00474258 | DAT_01cc4800
    MOV dword ptr [0x01cc4804],EDI      ; 0047425e | DAT_01cc4804
    CALL FUN_004c8440                   ; 00474264
    ...
    MOV dword ptr [0x01cc4800],EBX      ; 004742de | DAT_01cc4800
    MOV dword ptr [0x01cc4804],EDI      ; 004742e4 | DAT_01cc4804
    CALL FUN_004c8440                   ; 004742ea
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; undefined FUN_004c8440()
