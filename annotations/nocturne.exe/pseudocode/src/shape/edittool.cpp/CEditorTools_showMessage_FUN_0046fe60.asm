...
;   core_main.c_showDeveloperToolsMenu_FUN_004c8510 at 004c85bd
...
;   TerminatedCString s_Message_0057e5dd
...
section .text
    ...
    PUSH EBX                            ; 0046fe60
        ;   Label: shape_edittool.cpp_CEditorTools_showMessage_FUN_0046fe60
    PUSH ESI                            ; 0046fe61
    PUSH EDI                            ; 0046fe62
    PUSH EBP                            ; 0046fe63
    ...
    PUSH EDI                            ; 0046ff4e
    CALL shape_edittool.cpp_CEditorTools_paintCurrentWindow_FUN_004722b0 ; 0046ff4f
    ...
    MOV EBP,dword ptr [0x005bac64]      ; 0046ffbf | g_CKeys_PTR_005bac64
    PUSH EBP                            ; 0046ffc5 | g_CKeys_01cc30e4
    ...
    PUSH EDI                            ; 0046ffce
    CALL shape_edittool.cpp_CEditorTools_restoreWindowAndCleanup_FUN_004720c0 ; 0046ffcf
