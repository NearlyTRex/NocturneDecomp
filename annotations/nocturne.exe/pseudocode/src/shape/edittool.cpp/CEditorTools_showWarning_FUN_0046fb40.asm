...
;                               FUNCTION
; *****************************************************************************
; void __cdecl shape_edittool_cpp_CEditorTools_showWarning_FUN_0046fb40(CEditorTools *this_ptr,char *format,...)
;
; Parameters:
...
;   core_stranger.cpp_CStranger_tryPlaceObject_FUN_0053c800 at 0053cafe
...
section .text
    ...
    PUSH EBX                            ; 0046fb40
        ;   Label: shape_edittool.cpp_CEditorTools_showWarning_FUN_0046fb40
    PUSH ESI                            ; 0046fb41
    PUSH EDI                            ; 0046fb42
    PUSH EBP                            ; 0046fb43
    ...
    MOV ECX,dword ptr [0x01c00c64]      ; 0046fc4c | g_ClipBottom
    PUSH EDX                            ; 0046fc52
    MOV EDX,dword ptr [0x01c00c5c]      ; 0046fc53 | g_ClipTop
    ...
    MOV EBX,dword ptr [0x01c00c60]      ; 0046fc66 | g_ClipRight
    MOV EDX,dword ptr [0x01c00c58]      ; 0046fc6c | g_ClipLeft
