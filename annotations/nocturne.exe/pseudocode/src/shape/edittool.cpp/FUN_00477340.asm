...
;                               FUNCTION
; *****************************************************************************
; int shape_edittool_cpp_FUN_00477340(int param_1)
;
;
; XREF[2]:
;   shape_edittool.cpp_FUN_00477300 at 00477306
;   shape_edittool.cpp_FUN_00477390 at 004773a7
;
; *****************************************************************************
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x4]       ; 00477340
        ;   Label: shape_edittool.cpp_FUN_00477340
