...
// Convention: unknown
// Signature: void FUN_00473a60(undefined4 param_1,uint param_2,uint param_3,uint param_4)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_00473a60(uint param_1,uint param_2,uint param_3,uint param_4)

{
  ...
  if (param_2 != 0) {
    ...
    if (param_2 != 2) {
      _DAT_01cc4800 = "P?..\\shape\\edittool.cpp" + 2;
      _DAT_01cc4804 = 0x93b;
