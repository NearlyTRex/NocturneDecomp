...
// Convention: __cdecl
// Signature: void __cdecl shape_edittool_cpp_CEdScrollBar_setPosition_FUN_004764d0(CEdScrollBar *this_ptr,int left_pos,int top_pos,int right_pos,int bottom_pos)
