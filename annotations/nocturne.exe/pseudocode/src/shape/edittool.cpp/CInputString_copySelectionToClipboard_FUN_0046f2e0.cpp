...
// Convention: __cdecl
// Signature: void __cdecl shape_edittool_cpp_CInputString_copySelectionToClipboard_FUN_0046f2e0(int param_1)
...

{
  ...
  if (iVar6 != iVar3) {
    ...
    uVar2 = *puVar1;
    *puVar1 = 0;
    shape_edittool_cpp_CEditorTools_setClipboardText_FUN_00472d10(uVar4,param_1 + iVar6);
    *puVar1 = uVar2;
  }
  return;
}
