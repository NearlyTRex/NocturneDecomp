...
;                               FUNCTION
; *****************************************************************************
; void shape_edittool_cpp_FUN_00477390(int param_1)
;
; Local Variables:
...
;   shape_edittool.cpp_FUN_00477340
...
section .text
    ...
    PUSH EBX                            ; 00477390
        ;   Label: shape_edittool.cpp_FUN_00477390
    PUSH ESI                            ; 00477391
    PUSH EDI                            ; 00477392
    PUSH EBP                            ; 00477393
    ...
    CALL shape_edittool.cpp_FUN_00477340 ; 004773a7
        ;   XREF to: 00477340 (UNCONDITIONAL_CALL)  ; undefined shape_edittool.cpp_FUN_00477340()
    ...
    CALL shape_edittool.cpp_FUN_00477300 ; 004773bf
    ...
    CALL shape_edittool.cpp_FUN_00477340 ; 004773cb
        ;   XREF to: 00477340 (UNCONDITIONAL_CALL)  ; undefined shape_edittool.cpp_FUN_00477340()
    ...
    PUSH EAX                            ; 00477409
    PUSH EBX                            ; 0047740a
    CALL shape_edittool.cpp_FUN_00477370 ; 0047740b
    ...
    CALL engine_2d.c_clipLineGlobal_FUN_00403940 ; 0047748b
        ;   XREF to: 00403940 (UNCONDITIONAL_CALL)  ; undefined engine_2d.c_clipLineGlobal_FUN_00403940()
