// Name: shape_edittool.cpp_FUN_00477390
// Address: 00477390
// Address Range: [[00477390, 004774a6]]
// Convention: unknown
// Signature: void shape_edittool_cpp_FUN_00477390(int param_1)
...

{
  ...
  iVar1 = shape_edittool_cpp_FUN_00477340(param_1);
  iVar1 = ((iVar6 + iVar2) - iVar1) / 2;
  iVar2 = shape_edittool_cpp_FUN_00477300(param_1);
  iVar2 = iVar2 + iVar5;
  iVar3 = shape_edittool_cpp_FUN_00477340(param_1);
  iVar3 = iVar1 + iVar3;
  iVar6 = param_1 + 0x24;
  iVar4 = engine_font_cpp_CBitFont_getTextHeight_FUN_00492e60(_DAT_01bcd070,iVar6,iVar6,iVar3);
  iVar4 = shape_edittool_cpp_FUN_00477370
                    (param_1,((*(int *)(param_1 + 0x14) + *(int *)(param_1 + 0x1c)) - iVar4) / 2,
