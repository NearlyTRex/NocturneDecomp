...
;                               FUNCTION
; *****************************************************************************
; void shape_edittool_cpp_FUN_00473650(void)
;
; Local Variables:
...
;
; Called Functions:
;   shape_edittool.cpp_FUN_00473190
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBP                            ; 00473650
        ;   Label: shape_edittool.cpp_FUN_00473650
    ...
    CALL shape_edittool.cpp_FUN_00473190 ; 004736ae
        ;   XREF to: 00473190 (UNCONDITIONAL_CALL)  ; undefined shape_edittool.cpp_FUN_00473190()
