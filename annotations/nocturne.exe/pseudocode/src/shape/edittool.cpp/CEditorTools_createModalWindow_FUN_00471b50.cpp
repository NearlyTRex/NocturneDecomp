...
// Convention: __cdecl
// Signature: void __cdecl shape_edittool_cpp_CEditorTools_createModalWindow_FUN_00471b50(undefined4 param_1,int param_2,int param_3,int param_4,int param_5,int param_6,byte param_7)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __cdecl shape_edittool_cpp_CEditorTools_createModalWindow_FUN_00471b50(uint param_1,int param_2,int param_3,int param_4,int param_5,int param_6,byte param_7)

{
  ...
  *(byte *)(iVar1 + 0x1bcd0b8) = 0;
  if (param_6 != 0) {
    iVar1 = engine_font_cpp_CBitFont_wrapText_FUN_00492f30
                      (_DAT_01bcd070,param_6,0x1bcc0d0,0x14,200,(param_4 - param_2) + local_20 * -2)
    ;
    iVar8 = 0;
    piVar5 = local_1c + 0xe;
    if (0 < iVar1) {
    ...
    if (0 < iVar1) {
      *(byte *)((int)piVar5 + -1) = 0;
      local_28 = engine_font_cpp_CBitFont_getTextHeight_FUN_00492e60(iVar8,local_1c + 0xe);
  ...
  *local_1c = param_2;
  ...
  engine_2d_c_setupViewportAndClipping_FUN_00401e30
            (param_2 + local_20,param_3 + local_24 + local_28,(param_4 - local_20) + -1,
             (param_5 - local_24) + -1);
  return;
}
