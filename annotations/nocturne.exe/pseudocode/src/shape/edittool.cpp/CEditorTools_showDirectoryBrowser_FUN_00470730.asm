...
;   crt_watcom.c_getcwd_FUN_00566440
...
section .text
    ...
    PUSH EBX                            ; 00470730
        ;   Label: shape_edittool.cpp_CEditorTools_showDirectoryBrowser_FUN_00470730
    PUSH EBP                            ; 00470731
    ...
    PUSH EAX                            ; 0047074b
    CALL crt_watcom.c_getcwd_FUN_00566440 ; 0047074c
        ;   XREF to: 00566440 (UNCONDITIONAL_CALL)  ; char * crt_watcom.c_getcwd_FUN_00566440(char * buffer, SIZE_T size)
    ...
    CALL crt_watcom.c_getcwd_FUN_00566440 ; 004707aa
        ;   XREF to: 00566440 (UNCONDITIONAL_CALL)  ; char * crt_watcom.c_getcwd_FUN_00566440(char * buffer, SIZE_T size)
    ...
    PUSH EAX                            ; 004707db
    CALL shape_edittool.cpp_CPickList_ctor_FUN_00474c90 ; 004707dc
    ...
    PUSH 0x57e691                       ; 00470a4a | = "Error getting current directory."
        ;   Label: LAB_00470a4a
    PUSH EBX                            ; 00470a4f
    CALL shape_edittool.cpp_CEditorTools_showError_FUN_0046fcd0 ; 00470a50
    ...
    PUSH EBX                            ; 00470d19
    CALL shape_edittool.cpp_CEditorTools_showError_FUN_0046fcd0 ; 00470d1a
        ;   XREF to: 0046fcd0 (UNCONDITIONAL_CALL)  ; void shape_edittool.cpp_CEditorTools_showError_FUN_0046fcd0(CEditorTools * this_ptr, char * format)
