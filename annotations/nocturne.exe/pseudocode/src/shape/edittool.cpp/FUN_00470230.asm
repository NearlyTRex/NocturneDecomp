...
;
; XREF[2]:
;   core_game.cpp_CGame_processHotkeys_FUN_0049f930 at 004a0025
...
section .text
    ...
    PUSH ESI                            ; 00470230
        ;   Label: shape_edittool.cpp_FUN_00470230
    PUSH EDI                            ; 00470231
    ...
    CALL shape_edittool.cpp_CPickList_ctor_FUN_00474c90 ; 0047026f
    ...
    PUSH EAX                            ; 004702e5
    CALL shape_edittool.cpp_CPickList_displayChoicesAndWaitForInput_FUN_00474d70 ; 004702e6
