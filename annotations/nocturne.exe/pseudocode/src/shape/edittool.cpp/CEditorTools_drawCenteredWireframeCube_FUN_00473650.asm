...
;
; Called Functions:
;   shape_edittool.cpp_CEditorTools_draw3DWireframeCube_FUN_00473190
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBP                            ; 00473650
        ;   Label: shape_edittool.cpp_CEditorTools_drawCenteredWireframeCube_FUN_00473650
    ...
    CALL shape_edittool.cpp_CEditorTools_draw3DWireframeCube_FUN_00473190 ; 004736ae
        ;   XREF to: 00473190 (UNCONDITIONAL_CALL)  ; void shape_edittool.cpp_CEditorTools_draw3DWireframeCube_FUN_00473190(CEditorTools * this_ptr, CVector3f * corner1, CVector3f * corner2, int color_value)
