...

{
  ...
  FUN_004ce7c0(*piVar8,*(uint *)(iVar7 + 0x1bcd084),
               (*(int *)(iVar7 + 0x1bcd088) - *piVar8) + 1,
               (*(int *)(iVar7 + 0x1bcd08c) - *(int *)(iVar7 + 0x1bcd084)) + 1);
  FUN_00403ef0(*piVar8 + 1,*(int *)(iVar7 + 0x1bcd084) + 1,*(int *)(iVar7 + 0x1bcd088) + -2,
  ...
  iVar5 = FUN_00492da0(_DAT_01bcd070,iVar6,_DAT_01bcd9bc / 2 + *(int *)(iVar7 + 0x1bcd084) + 1,
                       _DAT_01bcddd0,0xffffffff);
  FUN_00490980(_DAT_01bcd070,iVar6,((iVar1 + iVar2) - iVar5) / 2);
  _DAT_01c00c70 = _DAT_01bcddcc;
  iVar6 = FUN_00492e60(_DAT_01bcd070,iVar6);
  FUN_00403bd0(*piVar8 + 1,iVar6 + *(int *)(iVar7 + 0x1bcd084) + _DAT_01bcd9bc,
