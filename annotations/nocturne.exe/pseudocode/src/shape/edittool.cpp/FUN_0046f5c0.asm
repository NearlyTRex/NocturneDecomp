...
section .text
    ...
    MOV dword ptr [0x01cc4800],EDI      ; 0046f602 | DAT_01cc4800
    MOV dword ptr [0x01cc4804],EBP      ; 0046f608 | DAT_01cc4804
    CALL FUN_004c8440                   ; 0046f60e
