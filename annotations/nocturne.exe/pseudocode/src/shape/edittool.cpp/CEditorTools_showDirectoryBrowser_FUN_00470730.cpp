// Name: shape_edittool.cpp_CEditorTools_showDirectoryBrowser_FUN_00470730
// Address: 00470730
// Address Range: [[00470730, 00470eac]]
// Convention: __cdecl
// Signature: int __cdecl shape_edittool_cpp_CEditorTools_showDirectoryBrowser_FUN_00470730(CEditorTools *this_ptr,char *title_text,char *search_pattern,char *initial_path,uint flags)
...

{
  ...
  if ((flags & 1) != 0) {
    splitpath(initial_path,local_c,local_bc4,local_ec4,local_3c4);
...
LAB_0047078a:
  do {
    ...
    engine_dosio_cpp_CFileFinder_openSearch_FUN_00456c40(&local_18f0,search_pattern);
...
LAB_00470970:
    ...
    if (iVar6 < iVar4) {
      ...
      makepath(initial_path,local_10,local_8c4,local_cc4,local_2c4);
      local_14 = 1;
LAB_00470cb8:
      engine_dosio_cpp_CFileFinder_dtor_FUN_00456c20(&local_18f0,0);
      shape_edittool_cpp_CPickList_dtor_FUN_00474cf0(&local_1a60,0);
