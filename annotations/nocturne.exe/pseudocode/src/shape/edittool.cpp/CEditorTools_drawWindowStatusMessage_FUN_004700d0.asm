...
section .text
    ...
    PUSH EBX                            ; 004700d0
        ;   Label: shape_edittool.cpp_CEditorTools_drawWindowStatusMessage_FUN_004700d0
    PUSH ESI                            ; 004700d1
    PUSH EDI                            ; 004700d2
    PUSH EBP                            ; 004700d3
    ...
    CALL shape_edittool.cpp_CEditorTools_paintCurrentWindow_FUN_004722b0 ; 0047012c
