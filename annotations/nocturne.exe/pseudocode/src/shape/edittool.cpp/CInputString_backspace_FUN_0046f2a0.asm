...
;
; XREF[2]:
;   shape_edittool.cpp_CEditorTools_showFilenameInputDialog_FUN_00470eb0 at 00471346
;   shape_edittool.cpp_showTextInputDialog_FUN_0046f7e0 at 0046f934
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 0046f2a0
        ;   Label: shape_edittool.cpp_CInputString_backspace_FUN_0046f2a0
    ...
    PUSH EBX                            ; 0046f2af
    CALL shape_edittool.cpp_CInputString_setSelectionToCursor_FUN_0046f130 ; 0046f2b0
    ...
    CALL shape_edittool.cpp_CInputString_deleteRange_FUN_0046f1e0 ; 0046f2c6
    ...
    PUSH EBX                            ; 0046f2ce
    CALL shape_edittool.cpp_CInputString_setSelectionToCursor_FUN_0046f130 ; 0046f2cf
        ;   XREF to: 0046f130 (UNCONDITIONAL_CALL)  ; void shape_edittool.cpp_CInputString_setSelectionToCursor_FUN_0046f130(CInputString * this_ptr)
