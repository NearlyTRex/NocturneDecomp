...
;                               FUNCTION
; *****************************************************************************
; void __cdecl shape_edittool_cpp_CEditorTools_showError_FUN_0046fcd0(CEditorTools *this_ptr,char *format,...)
;
; Parameters:
...
;
; XREF[21]:
;   core_game.cpp_CGame_FUN_004a3b90 at 004a4015
;   core_game.cpp_CGame_FUN_004a4170 at 004a46be
;   core_game.cpp_CGame_FUN_004a57c0 at 004a5bd1
...
;   core_mission.cpp_CDemonMission_startMission_FUN_004d9780 at 004d9853
;   core_netgame.cpp_CNetGame_initializeNetworkToJoin_FUN_004e9a90 at 004e9cb9
;   core_netgame.cpp_CNetGame_initializeNetwork_FUN_004e9d50 at 004e9e2d
;   ... and 11 more
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0046fcd0
        ;   Label: shape_edittool.cpp_CEditorTools_showError_FUN_0046fcd0
    PUSH ESI                            ; 0046fcd1
    PUSH EDI                            ; 0046fcd2
    PUSH EBP                            ; 0046fcd3
    ...
    MOV dword ptr [0x01cc4800],ECX      ; 0046fcf3 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EBX      ; 0046fcf9 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 0046fcff
    ...
    PUSH EDI                            ; 0046fdbe
    CALL shape_edittool.cpp_CEditorTools_paintCurrentWindow_FUN_004722b0 ; 0046fdbf
    ...
    MOV ECX,dword ptr [0x01c00c64]      ; 0046fddc | g_ClipBottom
    PUSH EDX                            ; 0046fde2
    MOV EDX,dword ptr [0x01c00c5c]      ; 0046fde3 | g_ClipTop
    ...
    MOV EBX,dword ptr [0x01c00c60]      ; 0046fdf6 | g_ClipRight
    MOV EDX,dword ptr [0x01c00c58]      ; 0046fdfc | g_ClipLeft
    ...
    PUSH EDI                            ; 0046fe3e
    CALL shape_edittool.cpp_CEditorTools_restoreWindowAndCleanup_FUN_004720c0 ; 0046fe3f
