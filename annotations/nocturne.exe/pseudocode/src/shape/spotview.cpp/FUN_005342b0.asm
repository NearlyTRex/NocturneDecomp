...
;                               FUNCTION
; *****************************************************************************
; void shape_spotview_cpp_FUN_005342b0(void)
;
; Local Variables:
...
;   shape_spotview.cpp_FUN_00534590
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 005342b0
        ;   Label: shape_spotview.cpp_FUN_005342b0
    PUSH EBP                            ; 005342b1
    ...
    PUSH EBX                            ; 00534541
    CALL shape_spotview.cpp_FUN_00534590 ; 00534542
        ;   XREF to: 00534590 (UNCONDITIONAL_CALL)  ; undefined shape_spotview.cpp_FUN_00534590()
    ...
    PUSH EBX                            ; 0053457f
    CALL shape_spotview.cpp_FUN_00534590 ; 00534580
        ;   XREF to: 00534590 (UNCONDITIONAL_CALL)  ; undefined shape_spotview.cpp_FUN_00534590()
