...
;                               FUNCTION
; *****************************************************************************
; void FUN_004b6770(int param_1,float param_2)
;
; Local Variables:
