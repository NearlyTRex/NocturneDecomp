...

{
  ...
  *(float *)(param_1 + 0x2f8) = *(float *)(param_1 + 0x2f8) + _DAT_005968b5;
  ...
  FUN_0040a240(param_1,&fStack_9c,uVar1);
  ...
  uStack_a8 = 0;
  uStack_a4 = 0;
  FUN_0040a200(param_1,&fStack_78,&uStack_a8);
  ...
  iStack_20 = 0;
  do {
    fStack_18 = (float)FUN_0050fb00(0x01E57284,&fStack_3c,&fStack_c0);
    ...
    iStack_1c = FUN_0040d890(*(uint *)(0x01E57284 + 0x14cd5c),_DAT_01c78c78);
    iVar4 = FUN_0040d890(*(uint *)(0x01E57284 + 0x14cd5c),_DAT_02dd10bc);
    iStack_28 = iVar4;
    iStack_24 = FUN_0040d890(*(uint *)(0x01E57284 + 0x14cd5c),DAT_0077bd78);
    iVar5 = FUN_0040d890(*(uint *)(0x01E57284 + 0x14cd5c),_DAT_01c7068c);
    if (iVar2 == 0) {
      if (iStack_1c == 0) {
        if (iVar4 == 0) {
          if (iStack_24 == 0) {
          ...
          if (iVar2 != 0) {
            ...
            FUN_005485e0(iVar4,fStack_18);
          }
          FUN_00511780(0x01E57284,iStack_28);
        }
      }
      else {
      ...
      if ((iVar4 != 0) &&
         (iVar5 = FUN_0040d890(*(uint *)(param_1 + 0x2fc),_DAT_01cae124), iVar4 = 0x01E57284
         , iVar5 != 0)) {
        if (iStack_20 == 0) {
      ...
      puVar3 = (uint *)FUN_0040a290(iVar2,auStack_e4,0x01E57284 + 0x14cd50);
...
LAB_00545ebe:
      ...
      if (*(int *)(param_1 + 0x56c) != 0) {
        ...
        FUN_0048af20(0x01C08D04,&fStack_6c,param_1 + 0x3c);
        uStack_84 = 0x40a00000;
        uStack_80 = 0x40c00000;
        uStack_7c = 0xc0c00000;
        uStack_90 = FUN_0040dda0(0xbec90fdb,0x3ec90fdb);
        fStack_18 = (float)uStack_90;
        uStack_8c = FUN_0040dda0(0xbec90fdb,0x3ec90fdb);
        uStack_88 = 0;
        fStack_18 = (float)uStack_8c;
        FUN_0044d7a0(auStack_10c,&uStack_90);
        uVar1 = FUN_0044da40(auStack_10c,auStack_b4,&uStack_84);
        puVar3 = (uint *)FUN_0040a200(param_1,auStack_54,uVar1);
        if (&uStack_84 != puVar3) {
          uStack_84 = *puVar3;
          uStack_80 = puVar3[1];
          uStack_7c = puVar3[2];
        }
        uVar1 = FUN_004543b0("bullet.kfm");
        FUN_0048c6b0(0x01C08D04,param_1 + 0x20,param_1 + 0x30,&uStack_84,uVar1);
      }
      return 1;
    }
  } while( true );
