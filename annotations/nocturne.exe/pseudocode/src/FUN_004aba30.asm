...
section .text
    ...
    PUSH 0x59e370                       ; 004abac1 | DAT_0059e370
        ;   Label: LAB_004abac1
    PUSH EBX                            ; 004abac6
    CALL FUN_0056445f                   ; 004abac7
        ;   XREF to: 0056445f (UNCONDITIONAL_CALL)  ; undefined FUN_0056445f()
    ADD ESP,0x8                         ; 004abacc
    PUSH EAX                            ; 004abacf
    CALL FUN_00564486                   ; 004abad0
