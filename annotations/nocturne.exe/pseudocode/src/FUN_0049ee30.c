...
// Convention: unknown
// Signature: void FUN_0049ee30(int param_1,uint *param_2)
...
LAB_0049ef39:
  ...
  if (iVar3 != 0) {
    FUN_004c0850(*(int *)(_DAT_01cae0e8 * 4 + 0x1cae0d8) + 0x1f5a0,0,5,1);
  }
  iVar3 = (**(code **)(*0x01CC30E4 + 4))(0x01CC30E4,*(uint *)(param_1 + 0x80));
  if (iVar3 != 0) {
    FUN_004c0850(*(int *)(_DAT_01cae0e8 * 4 + 0x1cae0d8) + 0x1f5a0,0,5,0xffffffff);
  }
  iVar3 = (**(code **)(*0x01CC30E4 + 4))(0x01CC30E4,*(uint *)(param_1 + 0x84));
  if (iVar3 != 0) {
    FUN_004c0950(*(int *)(_DAT_01cae0e8 * 4 + 0x1cae0d8) + 0x1f5a0,1);
  }
  iVar3 = (**(code **)(*0x01CC30E4 + 4))(0x01CC30E4,*(uint *)(param_1 + 0x88));
  if (iVar3 != 0) {
    FUN_004c0950(*(int *)(_DAT_01cae0e8 * 4 + 0x1cae0d8) + 0x1f5a0,0xffffffff);
  }
  iVar3 = (**(code **)(*0x01CC30E4 + 4))(0x01CC30E4,*(uint *)(param_1 + 0x90));
  if (iVar3 != 0) {
    FUN_004c0a50(*(int *)(_DAT_01cae0e8 * 4 + 0x1cae0d8) + 0x1f5a0,1);
  }
  iVar3 = (**(code **)(*0x01CC30E4 + 4))(0x01CC30E4,*(uint *)(param_1 + 0x8c));
  if (iVar3 != 0) {
    FUN_004c32e0(*(int *)(_DAT_01cae0e8 * 4 + 0x1cae0d8) + 0x1f5a0);
  }
  iVar3 = (**(code **)(*0x01CC30E4 + 4))(0x01CC30E4,*(uint *)(param_1 + 0x68));
  if (iVar3 != 0) {
    FUN_004c0850(*(int *)(_DAT_01cae0e8 * 4 + 0x1cae0d8) + 0x1f5a0,0,0,1);
  }
  iVar3 = (**(code **)(*0x01CC30E4 + 4))(0x01CC30E4,*(uint *)(param_1 + 0x6c));
  if (iVar3 != 0) {
    FUN_004c0850(*(int *)(_DAT_01cae0e8 * 4 + 0x1cae0d8) + 0x1f5a0,0,1,1);
  }
  iVar3 = (**(code **)(*0x01CC30E4 + 4))(0x01CC30E4,*(uint *)(param_1 + 0x70));
  if (iVar3 != 0) {
    FUN_004c0850(*(int *)(_DAT_01cae0e8 * 4 + 0x1cae0d8) + 0x1f5a0,0,2,1);
  }
  iVar3 = (**(code **)(*0x01CC30E4 + 4))(0x01CC30E4,*(uint *)(param_1 + 0x74));
  if (iVar3 != 0) {
    FUN_004c0850(*(int *)(_DAT_01cae0e8 * 4 + 0x1cae0d8) + 0x1f5a0,0,4,1);
  }
  iVar3 = (**(code **)(*0x01CC30E4 + 4))(0x01CC30E4,*(uint *)(param_1 + 0x78));
  if (iVar3 != 0) {
    FUN_004c0850(*(int *)(_DAT_01cae0e8 * 4 + 0x1cae0d8) + 0x1f5a0,0,3,1);
  }
  ...
  if (iVar3 != 0) {
    ...
    *(uint *)(0x01E56DA0 + 0x10) = 0;
    if (iVar3 == *(int *)(0x01E57284 + 0x15aabc)) {
      FUN_005088f0(0x01E57284,*(int *)(0x01E57284 + 0x15aabc));
      return;
    }
  }
  return;
