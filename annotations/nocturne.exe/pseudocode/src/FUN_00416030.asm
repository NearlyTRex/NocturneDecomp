...
;
; XREF[3]:
;   FUN_004161a0 at 0041622c
;   FUN_00416300 at 004163a6
;   FUN_00416430 at 00416499
;
; Referenced Globals:
...
section .text
    ...
    MOV ECX,dword ptr [0x005ae704]      ; 004160aa | DAT_005ae704
        ;   Label: LAB_004160aa
    PUSH ECX                            ; 004160b0 | DAT_01b4d738
    CALL FUN_00461090                   ; 004160b1
        ;   XREF to: 00461090 (UNCONDITIONAL_CALL)  ; undefined FUN_00461090()
    ...
    CALL FUN_004613d0                   ; 004160ed
        ;   XREF to: 004613d0 (UNCONDITIONAL_CALL)  ; undefined FUN_004613d0()
    ADD ESP,0x10                        ; 004160f2
    PUSH 0x1                            ; 004160f5
        ;   Label: LAB_004160f5
    MOV EBX,dword ptr [0x005ae704]      ; 004160f7 | DAT_005ae704
    PUSH EBX                            ; 004160fd | DAT_01b4d738
    CALL FUN_00461050                   ; 004160fe
