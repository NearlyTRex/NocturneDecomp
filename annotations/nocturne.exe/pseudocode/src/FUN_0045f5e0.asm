...
;
; XREF[2]:
;   FUN_00461720 at 00461787
;   FUN_00461db0 at 00461e74
;
; Referenced Globals:
...
section .text
    ...
    MOV EDX,0x463a79                    ; 0045f62b | LAB_00463a79
    ...
    MOV dword ptr [0x01c00c7c],0x52f031 ; 0045f6ba | DAT_01c00c7c | LAB_0052f031
    ...
    PUSH 0x3                            ; 0045f6dc
    PUSH ECX                            ; 0045f6de
    CALL FUN_0045ed80                   ; 0045f6df
        ;   XREF to: 0045ed80 (UNCONDITIONAL_CALL)  ; undefined FUN_0045ed80()
    ADD ESP,0xc                         ; 0045f6e4
    POP EBX                             ; 0045f6e7
    POP EBP                             ; 0045f6e8
    RET                                 ; 0045f6e9
    MOV dword ptr [0x01c00c7c],0x52f823 ; 0045f6ea | DAT_01c00c7c | LAB_0052f823
        ;   Label: LAB_0045f6ea
