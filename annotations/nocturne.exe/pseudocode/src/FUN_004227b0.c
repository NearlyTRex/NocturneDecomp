...
// Convention: unknown
// Signature: undefined4 FUN_004227b0(undefined4 param_1,int *param_2,float param_3,float *param_4)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_004227b0(uint param_1,int *param_2,float param_3,float *param_4)

{
  ...
  if (local_90 < _DAT_0059aea8) {
    local_14 = (float)FUN_00421f00(param_1,param_2[2],param_2[4]);
    ...
    if (param_4 == (float *)0x0) {
      ...
      local_14 = (float)FUN_0040dda0(local_18,local_40);
      param_2[8] = (int)local_14;
      local_14 = (float)FUN_0040dda0(local_18,local_40);
      param_2[10] = (int)local_14;
      local_14 = (float)FUN_00421f00(param_1,param_2[8],param_2[10]);
  ...
  FUN_0054e4a0(&local_80,&local_68);
  if (local_90 <= 0.0) {
    return 1;
  }
  ...
  local_30 = (float)FUN_00421f00(param_1,local_8c,local_84);
  ...
  local_14 = local_30;
  local_24 = (float)FUN_0040df00(local_58);
  local_14 = local_24;
  local_14 = (float)FUN_0040df00(local_5c);
  ...
  local_14 = (float)FUN_0040df00((float)param_2[6] + local_24);
  param_2[7] = 0;
  param_2[6] = (int)local_14;
  iVar2 = FUN_0040df00((float)param_2[5] + local_28);
  param_2[5] = iVar2;
  return 0;
}
