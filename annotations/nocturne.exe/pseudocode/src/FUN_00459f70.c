...
// Convention: unknown
// Signature: void FUN_00459f70(int param_1,float *param_2,float param_3,undefined4 param_4)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_00459f70(int param_1,float *param_2,float param_3,uint param_4)
    ...
    if (1 < local_24) {
      ...
      if (0 < local_24) {
        do {
          ...
          FUN_0045a1a0(param_1,iVar1,pfVar2,param_4);
          iVar1 = iVar1 + 1;
