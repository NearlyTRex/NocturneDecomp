...
// Convention: unknown
// Signature: void FUN_00478790(int param_1,float param_2)
...

{
  ...
  iVar2 = FUN_005649c0(param_1 + 0x164,"@none" + 1);
  if ((iVar2 != 0) &&
     (iVar2 = FUN_0047dc30(0x01C03A10,param_1 + 0x164), uVar4 = 0x01E57284, iVar2 != 0)) {
    iVar5 = 1;
    *(uint *)(param_1 + 0x160) = 1;
    *(uint *)(param_1 + 0x440) = *(uint *)(param_1 + 0x22c);
    FUN_00508890(uVar4,param_1);
  }
  iVar2 = FUN_0047dc30(0x01C03A10,param_1 + 0x1c8);
  if (iVar2 != 0) {
  ...
  if (*(int *)(param_1 + 0x150) == 10) {
    ...
    if (((iVar2 == 0) || (iVar5 = 1, *(int *)(0x01C775EC + 0x1c) != 0)) ||
       (iVar2 = FUN_00564bc0(), iVar2 != 0)) {
      if (iVar5 != 0) goto LAB_0047883d;
    }
    else {
      iVar5 = 0;
    }
    FUN_00527230(*(uint *)(param_1 + 0x430));
  }
LAB_0047883d:
  ...
  *(float *)(param_1 + 0x438) = fVar1;
  ...
  case 0:
    FUN_0048ae90();
    FUN_0044cd90(param_1 + 0x444,param_1 + 0x20);
    iVar5 = FUN_0040de00(0,0x7fff);
  ...
  case 1:
    ...
    do {
      ...
      local_14 = (float)FUN_0040dda0(0xbf000000,0x3f000000);
  ...
  case 4:
    ...
    uVar4 = FUN_00454530(param_1 + 0x240);
    FUN_0048b320(0x01C08D04,param_1 + 0x20,&local_94,uVar4);
    break;
  case 5:
    FUN_00479390(param_1,local_b8);
    FUN_0048c3c0();
  ...
  case 7:
    ...
    FUN_0044cd90(param_1 + 0x444,&local_4c);
    iVar5 = FUN_0040de00(0,0x7fff);
    *(int *)(param_1 + 0x480) = iVar5;
    iVar5 = (iVar5 + (iVar5 >> 0x1f) * -0x100) - (uint)((iVar5 >> 0x1f) << 7 < 0);
    iVar2 = iVar5 >> 0x1f;
...
LAB_00478902:
    FUN_0044cde0(param_1 + 0x444,uVar4);
    uVar4 = 0x01E57284;
    *(uint *)(param_1 + 0x464) = 0;
    FUN_0050a9f0(uVar4,param_1 + 0x444);
    break;
  case 8:
    FUN_0048ae90();
    break;
  case 9:
    ...
    if (iVar5 != 0) {
      ...
      FUN_0048c4a0(0x01C08D04,param_1 + 0x20,&fStack_58,0,0,0x40800000);
    }
  }
  if (((*(char *)(param_1 + 0x3cc) != '\0') &&
      (iVar5 = FUN_00526c50(*(uint *)(param_1 + 0x430)), iVar5 == 0)) &&
     ((*(int *)(param_1 + 0x434) != 1 || (*(int *)(param_1 + 0x488) == 0)))) {
