...

{
  ...
  __arrinit(0x2dbd374,0x40,&g_SSfxSlotTypeInfo_005a2180);
  __arrinit(0x2dc1b78,8,&g_SSfxOptionsTypeInfo_005a21a0);
  __arrinit(0x2dc1edc,0x40,&g_SSfxSampleTypeInfo_005a21c0);
  FUN_00564bb0(0x5bea20);
  return;
}
