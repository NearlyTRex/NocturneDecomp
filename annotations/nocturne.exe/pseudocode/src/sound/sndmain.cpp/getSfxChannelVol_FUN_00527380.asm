...
;   core_sound.cpp_CSound_process_FUN_0052dff0 at 0052e25b
...
;   sound_sndmain.cpp_readIni_FUN_005289f0 at 00528c12
...
section .text
    ...
    MOV dword ptr [0x01cc4800],EDX      ; 005273a9 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],ECX      ; 005273af | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 005273b5
