...
section .text
    ...
    PUSH EBX                            ; 005253b6
    CALL FUN_00523750                   ; 005253b7
        ;   XREF to: 00523750 (UNCONDITIONAL_CALL)  ; undefined FUN_00523750()
    ...
    PUSH EBX                            ; 00525490
    CALL FUN_00523610                   ; 00525491
        ;   XREF to: 00523610 (UNCONDITIONAL_CALL)  ; undefined FUN_00523610()
