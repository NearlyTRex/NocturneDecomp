...
;   sound_sndmain.cpp_FUN_00528670 at 00528688
;
; Referenced Globals:
...
section .text
    ...
    CALL wincore_winrun.cpp_waitForMutexTimeout_FUN_00559bf0 ; 00528913
        ;   XREF to: 00559bf0 (UNCONDITIONAL_CALL)  ; undefined wincore_winrun.cpp_waitForMutexTimeout_FUN_00559bf0()
    ...
    CALL sound_sndmain.cpp_pollAllStreams_FUN_005298f0 ; 0052893f
        ;   XREF to: 005298f0 (UNCONDITIONAL_CALL)  ; undefined sound_sndmain.cpp_pollAllStreams_FUN_005298f0()
