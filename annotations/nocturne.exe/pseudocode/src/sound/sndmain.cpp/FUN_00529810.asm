...
section .text
    ...
    PUSH EBX                            ; 00529862
    CALL FUN_005256f0                   ; 00529863
        ;   XREF to: 005256f0 (UNCONDITIONAL_CALL)  ; undefined FUN_005256f0()
