...
// Convention: __cdecl
// Signature: float __cdecl sound_sndmain_cpp_CSfxSlot_computeChannelVolumes_FUN_00524630(undefined4 *param_1)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

float __cdecl sound_sndmain_cpp_CSfxSlot_computeChannelVolumes_FUN_00524630(uint *param_1)
