...

{
  ...
  if (-1 < param_1->loop_endpoints[3]) {
    iVar15 = param_1->loop_endpoints[3] * 0x120;
    if ((*(int *)(&DAT_02dbd3e4 + iVar15) == 0) ||
       (param_1 != *(CSfxSample **)(&DAT_02dbd3e8 + iVar15))) {
      PTR_01cc4800 = "..\\sound\\sndmain.cpp";
      INT_01cc4804 = 0x7cb;
    ...
    if (*(int *)(iVar15 + 0x2dbd3e0) != 0) {
      ...
      if (((param_1->loop_marker_count == 0) && (-1 < (param_1->sample_info).sample_count)) &&
         ((double)(param_1->sample_info).sample_count <= *(double *)(iVar15 + 0x2dbd3d4)))
      goto LAB_005240fa;
    }
    iVar15 = 0x523f55;
    ...
    uVar14 = 0x523f78;
    dVar12 = round
                       ((double)param_1->loop_destinations[1] - *(double *)(local_28 + 0x118));
    local_34 = (SIZE_T)ROUND(dVar12);
    if ((int)local_34 < 0) {
      local_34 = local_34 + param_1->loop_endpoints[4];
    }
    if ((int)local_34 < iVar15) {
      ...
      iVar5 = param_1->loop_endpoints[4] + -1;
      dVar12 = round
      ...
      while( true ) {
        ...
        if ((param_1->loop_destinations[1] < 0) ||
           (param_1->loop_endpoints[4] <= param_1->loop_destinations[1])) {
          PTR_01cc4800 = "..\\sound\\sndmain.cpp";
          INT_01cc4804 = 0x81a;
          core_main_c_FUN_004c8440
                    ("nextLoadSampleDest = %d, allocLength = %d",param_1->loop_destinations[1],
                     param_1->loop_endpoints[4],iVar4,uVar14);
        }
        samples_requested = param_1->loop_endpoints[4] - param_1->loop_destinations[1];
        ...
        bVar3 = false;
        if (-1 < iVar15) {
          if (param_1->loop_destinations[0] < iVar15) {
            SVar7 = iVar15 - param_1->loop_destinations[0];
            if ((int)SVar7 < (int)samples_requested) {
              samples_requested = SVar7;
            }
          }
          else {
            this_ptr = (CSfxSample *)local_30->playback_state;
            if ((this_ptr->loop_marker_count == 0) ||
               (this_ptr->loop_endpoints[4] == (this_ptr->sample_info).sample_count)) {
              if (param_1->loop_endpoints[2] == 0) {
                return 1;
              }
              bVar3 = true;
              ...
              sound_sndmain_cpp_CSfxSample_seek_FUN_00523d10
                        (this_ptr,0,param_1->loop_destinations[1]);
            }
          }
        }
        ...
        bVar1 = true;
        bVar2 = false;
        if (param_1->loop_endpoints[2] == 0) break;
LAB_005241ef:
        if (bVar3) {
          count = *(int *)(local_30->playback_state + 0x108) * samples_requested;
          uVar9 = *(uint *)(local_30->playback_state + 0x104);
...
LAB_00524219:
        ...
        else if ((CMP3Decoder *)param_1->loop_destinations[2] == (CMP3Decoder *)0x0) {
          if (param_1->loop_destinations[4] == 0) {
            PTR_01cc4800 = "..\\sound\\sndmain.cpp";
            INT_01cc4804 = 0x86c;
            core_main_c_FUN_004c8440("Can't stream unless we have mp3 decoder or open wav file!");
          }
          file = (_FILE *)param_1->loop_destinations[4];
          ...
          if ((*(byte *)(param_1->loop_destinations[4] + 0xc) & 0x20) != 0) {
          ...
          local_20 = sound_mp3_cpp_CMP3Decoder_read_FUN_004e82d0
                               ((CMP3Decoder *)param_1->loop_destinations[2],output_buffer,
                                samples_requested);
        }
        if ((bVar1) && (0 < (int)local_20)) {
          puVar8 = (uint *)
                   sound_sndmain_cpp_CSfxSample_lock_FUN_00523ba0
                             (param_1,param_1->loop_destinations[1],local_20);
          if (puVar8 == (uint *)0x0) {
...
LAB_00524292:
        ...
        if (samples_requested != local_20) {
          (param_1->sample_info).sample_count = param_1->loop_destinations[0] + local_20;
        }
        iVar15 = param_1->loop_endpoints[4];
        SVar6 = SVar6 - local_20;
        iVar5 = param_1->loop_destinations[1] + local_20;
        param_1->loop_destinations[0] = param_1->loop_destinations[0] + local_20;
        param_1->loop_destinations[1] = iVar5;
        if (iVar15 <= iVar5) {
          param_1->loop_destinations[1] = 0;
        }
      }
      output_buffer =
           (short *)sound_sndmain_cpp_CSfxSample_lock_FUN_00523ba0
                              (param_1,param_1->loop_destinations[1],samples_requested);
