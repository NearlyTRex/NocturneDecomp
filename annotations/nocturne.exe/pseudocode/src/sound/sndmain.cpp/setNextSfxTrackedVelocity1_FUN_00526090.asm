...
;
; XREF[4]:
;   core_dracbrid.cpp_CDraculaBride_startFreakySound_FUN_0045ab40 at 0045afbf
;   core_sound.cpp_CSound_process_FUN_0052dff0 at 0052e744
;   core_sound.cpp_processTrainSounds_FUN_0052d790 at 0052dbaa
