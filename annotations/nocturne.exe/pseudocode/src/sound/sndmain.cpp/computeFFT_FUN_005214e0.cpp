...
// Convention: unknown
// Signature: void sound_sndmain_cpp_computeFFT_FUN_005214e0(undefined4 *param_1,int param_2,int param_3,int param_4)
...
void sound_sndmain_cpp_computeFFT_FUN_005214e0(uint *param_1,int param_2,int param_3,int param_4)
