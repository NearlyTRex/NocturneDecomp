...
;
; XREF[1]:
;   core_sound.cpp_FUN_0052dd00 at 0052dd0d
;
; Referenced Globals:
...
section .text
    ...
    CMP dword ptr [ESP + 0x4],0x20      ; 005273d0
        ;   Label: sound_sndmain.cpp_FUN_005273d0
    ...
    MOV dword ptr [0x01cc4800],ECX      ; 005273f1 | PTR_01cc4800
    MOV dword ptr [0x01cc4804],EBX      ; 005273f7 | INT_01cc4804
