...
// Convention: __cdecl
// Signature: void __cdecl sound_sndmain_cpp_allocMixBuffers_FUN_00522f10(int requested_size,int num_buffers)
...

{
  ...
  _DAT_02dc8330 = 1;
  _DAT_02dc8334 = num_buffers;
  if (1 < requested_size) {
    do {
      _DAT_02dc8330 = _DAT_02dc8330 * 2;
    } while (_DAT_02dc8330 < requested_size);
  }
  iVar4 = _DAT_02dc8330 * 4;
  _DAT_02dc8328 = 0;
  _DAT_02dc832c = 0;
  _DAT_02dc835c =
       realloc(_DAT_02dc835c,num_buffers * iVar4 * DAT_005bea68);
  ...
  if (((_DAT_02dc835c == (void *)0x0) || (_DAT_02dc8380 == (void *)0x0)) ||
    ...
    g_CurrentLineNumber = 1196;
    core_main_c_displayErrorAndQuit_FUN_004c8440("allocMixBuffers - out of memory");
  }
  iVar4 = 0;
  if (0 < DAT_005bea68) {
    iVar3 = 0;
    ...
    do {
      *(void **)(iVar2 + 0x2dc8360) =
           (void *)((int)_DAT_02dc835c + _DAT_02dc8330 * iVar4 * _DAT_02dc8334 * 4);
      *(int *)(iVar2 + 0x2dc833c) = (int)_DAT_02dc8338 + iVar3;
      pvVar1 = _DAT_02dc8380;
      *(int *)(iVar2 + 0x2dc8384) = (int)_DAT_02dc8380 + iVar6;
      *(int *)(iVar2 + 0x2dc83a4) = (int)pvVar1 + iVar5;
