...
;
; XREF[2]:
;   sound_sndmain.cpp_CSfxSample_seek_FUN_00523d10 at 00523d41
;   sound_sndmain.cpp_CSfxSlot_seek_FUN_00525a80 at 00525af4
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 00525de0
        ;   Label: sound_sndmain.cpp_CSfxSample_normalizePlaybackPos_FUN_00525de0
    PUSH ESI                            ; 00525de1
    PUSH EDI                            ; 00525de2
    PUSH EBP                            ; 00525de3
