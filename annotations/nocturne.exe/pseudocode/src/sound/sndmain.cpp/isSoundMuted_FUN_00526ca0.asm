...
;
; XREF[8]:
;   core_game.cpp_CGame_processHotkeys_FUN_0049f930 at 0049fa81
;   core_menu.cpp_configureSoundOptions_FUN_004d12e0 at 004d1393
;   core_menu.cpp_showMainGameMenu_FUN_004d23d0 at 004d26ad
...
section .text
    ...
    MOV EAX,[0x02dc8324]                ; 00526ca0 | g_SoundMuted
        ;   Label: sound_sndmain.cpp_isSoundMuted_FUN_00526ca0
    RET                                 ; 00526ca5
