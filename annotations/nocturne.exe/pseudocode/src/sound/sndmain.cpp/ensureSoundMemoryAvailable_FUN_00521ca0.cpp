...
// Convention: __cdecl
// Signature: undefined4 __cdecl sound_sndmain_cpp_ensureSoundMemoryAvailable_FUN_00521ca0(int param_1)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint __cdecl sound_sndmain_cpp_ensureSoundMemoryAvailable_FUN_00521ca0(int param_1)

{
  ...
  do {
    if (*(int *)(iVar2 + 0x2dc1ffc) != 0) {
      iVar3 = sound_sndmain_cpp_CSfxSample_getBytesPerFrame_FUN_00525c40(iVar2 + 0x2dc1edc);
  ...
  do {
    ...
    do {
      ...
      if ((((*(int *)(iVar1 + 0x2dc1ffc) != 0) && (0 < *(int *)(iVar1 + 0x2dc2014))) &&
        ...
        sound_sndmain_cpp_CSfxSample_freeMemory_FUN_00523a60(iVar1 + 0x2dc1edc);
        if (0x3f < iVar3) {
          return 0;
        }
        goto LAB_00521cc3;
