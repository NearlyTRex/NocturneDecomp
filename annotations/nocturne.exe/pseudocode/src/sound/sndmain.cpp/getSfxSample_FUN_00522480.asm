...
;
; XREF[2]:
;   sound_sndmain.cpp_isSampleLoaded_FUN_005279b0 at 005279bd
...
section .text
    ...
    PUSH EBX                            ; 00522480
        ;   Label: sound_sndmain.cpp_getSfxSample_FUN_00522480
    PUSH ESI                            ; 00522481
    PUSH EDI                            ; 00522482
    PUSH EBP                            ; 00522483
    ...
    PUSH 0x5bea30                       ; 00522524 | g_WatcomStaticDestructorNode_005bea30
    CALL crt_unknown.c__atexit_FUN_00564bb0 ; 00522529
