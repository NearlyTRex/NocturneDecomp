...
;
; XREF[1]:
;   core_fire.cpp_CFireEffect_createFireball_FUN_0048b270 at 0048b304
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00526ff0
        ;   Label: sound_sndmain.cpp_setSfxTrackedFloatVelocity_FUN_00526ff0
    PUSH 0x1                            ; 00526ff1
    MOV EDX,dword ptr [ESP + 0xc]       ; 00526ff3
    PUSH EDX                            ; 00526ff7
    CALL sound_sndmain.cpp_getSfxSlotFromHandle_FUN_005234b0 ; 00526ff8
    ...
    CALL sound_sndmain.cpp_CSfxSlot_compute_FUN_00524830 ; 00527020
    ...
    CALL sound_sndmain.cpp_unlockSound_FUN_00528890 ; 00527047
