...
;
; XREF[2]:
;   FUN_005265a0 at 005267ff
;   FUN_005298f0 at 0052993e
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBP                            ; 005243a4
    PUSH EBX                            ; 005243a5
    CALL FUN_00525c40                   ; 005243a6
        ;   XREF to: 00525c40 (UNCONDITIONAL_CALL)  ; undefined FUN_00525c40()
    ADD ESP,0x4                         ; 005243ab
    PUSH EAX                            ; 005243ae
    PUSH ESI                            ; 005243af
    CALL FUN_005636d0                   ; 005243b0
