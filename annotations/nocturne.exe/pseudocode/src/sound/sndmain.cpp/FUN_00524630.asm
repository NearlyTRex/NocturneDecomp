...
;
; XREF[1]:
;   FUN_00524830 at 005249c3
;
; Referenced Globals:
;   string s_..\\sound\\sndmain.cpp_00592d82
;   string s_SfxSlot::kill_-_must_be_locked!_00592d97
;   undefined4 DAT_00592dbe
...
section .text
    ...
    MOV dword ptr [0x01cc4800],ECX      ; 005246dc | DAT_01cc4800
    MOV dword ptr [0x01cc4804],EDI      ; 005246e2 | DAT_01cc4804
    CALL FUN_004c8440                   ; 005246e8
    ...
    FLD float ptr [ESP + 0x4]           ; 0052474b
        ;   Label: LAB_0052474b
    FMUL double ptr [0x00592dbe]        ; 0052474f | DAT_00592dbe
