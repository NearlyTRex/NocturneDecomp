...
;   TerminatedCString s_Channels_00593a2e
;   TerminatedCString s_Hz_00593a37
;   TerminatedCString s_HwMixingEnabled_00593a3a
;   TerminatedCString s_MaxSwLatency_00593a4a
;   TerminatedCString s_Mute_00593a57
;   TerminatedCString s_SfxChannel_dEnabled_00593a5c
;   TerminatedCString s_SfxChannel_dVol_00593a70
...
section .text
    ...
    PUSH EBX                            ; 005289f0
        ;   Label: sound_sndmain.cpp_readIni_FUN_005289f0
    PUSH ESI                            ; 005289f1
    PUSH EDI                            ; 005289f2
    PUSH EBP                            ; 005289f3
    ...
    CALL engine_ini.cpp_CIniFile_getFloat_FUN_004bdac0 ; 00528b32
        ;   XREF to: 004bdac0 (UNCONDITIONAL_CALL)  ; void engine_ini.cpp_CIniFile_getFloat_FUN_004bdac0(CIniFile * this_ptr, char * key, float * output)
    ADD ESP,0xc                         ; 00528b37
    PUSH dword ptr [ESP + 0x28c]        ; 00528b3a
    CALL sound_sndmain.cpp_setMaxSwSoundLatency_FUN_00528980 ; 00528b41
        ;   XREF to: 00528980 (UNCONDITIONAL_CALL)  ; void sound_sndmain.cpp_setMaxSwSoundLatency_FUN_00528980(float latency)
    ...
    CALL sound_sndmain.cpp_isSoundMuted_FUN_00526ca0 ; 00528b69
    ...
    CALL sound_sndmain.cpp_setSoundMuted_FUN_00526cb0 ; 00528b95
