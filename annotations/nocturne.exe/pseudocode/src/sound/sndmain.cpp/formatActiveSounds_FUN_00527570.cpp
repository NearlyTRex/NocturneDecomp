// Name: sound_sndmain.cpp_formatActiveSounds_FUN_00527570
// Address: 00527570
// Address Range: [[00527570, 005275dc]]
// Convention: __cdecl
// Signature: void __cdecl sound_sndmain_cpp_formatActiveSounds_FUN_00527570(char *output_buffer)
...

{
  ...
  do {
    if ((this_ptr->sample != (CSfxSample *)0x0) && (this_ptr->playback_state != 0)) {
      ...
      iVar1 = _sprintf(output_buffer,"sfx slot %d: %s, pos %7.1f/%7.1f\n",iVar2,this_ptr->sample,
