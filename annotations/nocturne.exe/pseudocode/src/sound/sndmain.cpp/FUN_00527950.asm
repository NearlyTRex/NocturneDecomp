...
;   sound_sndmain.cpp_FUN_005278e0
...
section .text
    ...
    PUSH EBX                            ; 00527950
        ;   Label: sound_sndmain.cpp_FUN_00527950
    PUSH ESI                            ; 00527951
    PUSH EDI                            ; 00527952
    ...
    PUSH EDI                            ; 005279a3
        ;   Label: LAB_005279a3
    CALL sound_sndmain.cpp_FUN_005278e0 ; 005279a4
        ;   XREF to: 005278e0 (UNCONDITIONAL_CALL)  ; undefined sound_sndmain.cpp_FUN_005278e0()
