...
// Convention: unknown
// Signature: void sound_sndmain_cpp_FUN_00527950(undefined4 param_1,int param_2)

#include "nocturne.h"

void sound_sndmain_cpp_FUN_00527950(uint param_1,int param_2)

{
  ...
  if (param_2 != 0) {
    sound_sndmain_cpp_FUN_005278e0(param_1);
  }
  iVar2 = 0;
  do {
