...
// Convention: unknown
// Signature: void FUN_00525870(int param_1,undefined4 param_2,undefined4 param_3)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_00525870(int param_1,uint param_2,uint param_3)

{
  ...
  if ((local_28 < 0.0) ||
     ((double)*(int *)(*(int *)(param_1 + 0x74) + 0x138) + _DAT_0059322e < local_28)) {
    _DAT_01cc4800 = "..\\sound\\sndmain.cpp";
    _DAT_01cc4804 = 0xbc3;
  ...
  if ((-1 < *(int *)(iVar1 + 0x110)) &&
    ...
    if (*(int *)(iVar1 + 0x124) == 0) {
      *(double *)(param_1 + 0x60) = dVar2;
      ...
      dVar3 = (double)FUN_005648c0(*(double *)(param_1 + 0x60) / dVar2);
