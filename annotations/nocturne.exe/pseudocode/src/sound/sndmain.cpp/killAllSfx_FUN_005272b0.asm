...
;
; XREF[2]:
;   sound_sndmain.cpp_freeAllSamples_FUN_00527c30 at 00527c3c
...
section .text
    ...
    PUSH EBX                            ; 005272b0
        ;   Label: sound_sndmain.cpp_killAllSfx_FUN_005272b0
    PUSH ESI                            ; 005272b1
    ...
    CALL sound_sndmain.cpp_unlockSound_FUN_00528890 ; 005272d5
