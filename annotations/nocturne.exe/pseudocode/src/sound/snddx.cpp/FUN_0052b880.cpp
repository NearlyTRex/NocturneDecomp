...
// Convention: unknown
// Signature: double FUN_0052b880(undefined4 param_1,int param_2)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

double FUN_0052b880(uint param_1,int param_2)

{
  ...
  if (iVar2 != 0) {
    uVar4 = FUN_00529a90(iVar2);
    FUN_00563c90(apcStack_1bc,"DirectSux: Unable to %s.  (%s)",
                 "Get playback cursor of hardware sfx secondary buffer",uVar4);
    FUN_00529980(apcStack_1bc);
    return -1.0;
  }
  uVar3 = FUN_00525c40(*(uint *)(param_2 + 0x74));
