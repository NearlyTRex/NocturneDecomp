...
// Convention: unknown
// Signature: void * sound_snddx_cpp_CDirectSoundDevice_lockSample_FUN_0052adc0(undefined4 param_1,int param_2,int param_3,int param_4,CSfxSample *param_5)

#include "nocturne.h"

void * sound_snddx_cpp_CDirectSoundDevice_lockSample_FUN_0052adc0(uint param_1,int param_2,int param_3,int param_4,CSfxSample *param_5)

{
  ...
  if (((0 < param_2) && (param_2 < 0x19)) && (*(int *)(&DAT_02dc9244 + param_2 * 4) != 0)) {
    ...
    puStack_1a0 = &param_5->locked_bytes2;
    ppvStack_1a4 = &param_5->locked_ptr2;
    puStack_1a8 = &param_5->locked_bytes1;
    ppvStack_1ac = &param_5->locked_ptr1;
