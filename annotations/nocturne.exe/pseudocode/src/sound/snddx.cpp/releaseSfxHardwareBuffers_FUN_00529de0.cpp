...
// Convention: unknown
// Signature: undefined4 sound_snddx_cpp_releaseSfxHardwareBuffers_FUN_00529de0(int param_1)

#include "nocturne.h"

uint sound_snddx_cpp_releaseSfxHardwareBuffers_FUN_00529de0(int param_1)

{
  ...
  piVar3 = (int *)(param_1 * 4 + 0x2dc9324);
  piVar1 = (int *)*piVar3;
  if (piVar1 != (int *)0x0) {
    (**(code **)(*piVar1 + 8))(piVar1);
    *piVar3 = 0;
  }
  piVar3 = (int *)(param_1 * 4 + 0x2dc92a8);
  piVar1 = (int *)*piVar3;
  if (piVar1 != (int *)0x0) {
    (**(code **)(*piVar1 + 8))(piVar1);
    *piVar3 = 0;
