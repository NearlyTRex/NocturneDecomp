...
section .text
    ...
    CALL sound_sndmain.cpp_logSoundError_FUN_00529980 ; 0052a1c3
    ...
    CALL sound_sndmain.cpp_logSoundError_FUN_00529980 ; 0052a213
        ;   XREF to: 00529980 (UNCONDITIONAL_CALL)  ; void sound_sndmain.cpp_logSoundError_FUN_00529980(char * format)
    ...
    PUSH EAX                            ; 0052a24a
    CALL sound_sndmain.cpp_logSoundError_FUN_00529980 ; 0052a24b
        ;   XREF to: 00529980 (UNCONDITIONAL_CALL)  ; void sound_sndmain.cpp_logSoundError_FUN_00529980(char * format)
