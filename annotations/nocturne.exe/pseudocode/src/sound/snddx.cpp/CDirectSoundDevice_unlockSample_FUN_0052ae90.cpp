...
// Convention: unknown
// Signature: void sound_snddx_cpp_CDirectSoundDevice_unlockSample_FUN_0052ae90(undefined4 param_1,int param_2,undefined4 param_3,undefined4 param_4,int param_5)
...

{
  ...
  if (iVar1 != 0) {
    ...
    _sprintf(&piStack_1b4,"DirectSux: Unable to %s.  (%s)",
