// Name: sound_snddx.cpp_FUN_0052a280
// Address: 0052a280
// Address Range: [[0052a280, 0052a440]]
// Convention: unknown
// Signature: void sound_snddx_cpp_FUN_0052a280(void)
...

{
  ...
  if (_DAT_02dc9224 != (int *)0x0) {
    piStack_1d4 = _DAT_02dc9224;
    puStack_1d8 = (uint *)0x52a29c;
    (**(code **)(*_DAT_02dc9224 + 8))();
    _DAT_02dc9224 = (int *)0x0;
  }
  piStack_1d4 = (int *)0x12;
  ppiStack_1dc = (int **)&local_2c;
  puStack_1d8 = (uint *)0x0;
  local_18 = 0;
  local_14 = 0;
  piStack_1e0 = (int *)0x52a2d3;
  memset();
  ppiStack_1dc = &piStack_40;
  piStack_1d4 = (int *)0x14;
  local_2c = 1;
  uStack_2a = 1;
  puStack_1d8 = (uint *)0x0;
  ...
  puStack_1d8 = &local_18;
  ppiStack_1dc = &piStack_40;
  uStack_38 = 0x400;
  piStack_1e0 = _DAT_02dc9214;
  iVar1 = (**(code **)(*_DAT_02dc9214 + 0xc))();
  if (iVar1 == 0) {
