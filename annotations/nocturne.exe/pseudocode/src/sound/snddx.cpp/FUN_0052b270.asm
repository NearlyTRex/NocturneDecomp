...
;                               FUNCTION
; *****************************************************************************
; bool FUN_0052b270(undefined4 param_1,int param_2,byte param_3)
;
; Local Variables:
