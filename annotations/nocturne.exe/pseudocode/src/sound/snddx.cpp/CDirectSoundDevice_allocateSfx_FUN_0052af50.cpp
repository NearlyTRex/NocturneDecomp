...

{
  ...
  if (((sample_buffer_id < 1) || (0x18 < sample_buffer_id)) ||
    ...
    core_main_c_FUN_004c8440("DirectSoundDevice::allocateSfx - Invalid sample handle: %d",sample_buffer_id);
  }
  ...
  piVar2 = *(int **)(iVar6 * 4 + 0x2dc92a8);
  if (piVar2 != (int *)0x0) {
    uVar5 = (**(code **)(*piVar2 + 0x48))(piVar2);
    if (uVar5 != 0) {
      sound_snddx_cpp_getDirectSoundErrorString_FUN_00529a90(uVar5);
      _sprintf(acStack_650,"DirectSux: Unable to %s.  (%s)");
      sound_sndmain_cpp_FUN_00529980(acStack_650);
      goto LAB_0052b04d;
    }
  }
  ...
  if (uVar5 == 0) {
    ...
    if (puVar3 != (uint *)0x0) {
      ...
      if (uVar5 == 0) {
        ...
        sound_snddx_cpp_getDirectSoundErrorString_FUN_00529a90(uVar5);
        _sprintf(acStack_4cc,"DirectSux: Unable to %s.  (%s)");
        sound_sndmain_cpp_FUN_00529980(acStack_4cc);
      }
    }
  }
  else {
    sound_snddx_cpp_getDirectSoundErrorString_FUN_00529a90(uVar5);
    _sprintf(acStack_33c,"DirectSux: Unable to %s.  (%s)");
    sound_sndmain_cpp_FUN_00529980(acStack_33c);
  }
  piVar2 = *(int **)(iVar6 * 4 + 0x2dc92a8);
  if ((piVar2 != (int *)0x0) && (uVar5 = (**(code **)(*piVar2 + 0x48))(piVar2), uVar5 != 0)) {
    sound_snddx_cpp_getDirectSoundErrorString_FUN_00529a90(uVar5);
    _sprintf(acStack_1ac,"DirectSux: Unable to %s.  (%s)");
    sound_sndmain_cpp_FUN_00529980(acStack_1ac);
    return 0;
  }
  piVar7 = (int *)(iVar6 * 4 + 0x2dc9324);
  piVar2 = (int *)*piVar7;
