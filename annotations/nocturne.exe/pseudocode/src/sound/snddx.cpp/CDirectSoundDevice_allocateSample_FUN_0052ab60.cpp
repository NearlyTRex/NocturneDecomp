...
// Convention: unknown
// Signature: int sound_snddx_cpp_CDirectSoundDevice_allocateSample_FUN_0052ab60(undefined4 param_1,int param_2,int param_3,int param_4,int param_5)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

int sound_snddx_cpp_CDirectSoundDevice_allocateSample_FUN_0052ab60(uint param_1,int param_2,int param_3,int param_4,int param_5)
