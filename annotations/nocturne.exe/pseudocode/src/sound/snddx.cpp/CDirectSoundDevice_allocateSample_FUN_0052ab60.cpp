  ...
  if (_DAT_02dc9214 != (int *)0x0) {
    ...
    if (iVar5 < 0x19) {
      ...
      if (error_code == 0) {
        ...
        sound_sndmain_cpp_logSoundError_FUN_00529980((char *)&piStack_1d8);
      }
      sound_sndmain_cpp_logSoundError_FUN_00529980("DirectSoundDevice::allocateSample - access failed\n");
