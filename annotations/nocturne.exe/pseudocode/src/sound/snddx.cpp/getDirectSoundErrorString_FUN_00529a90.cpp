...
// Convention: __cdecl
// Signature: undefined8 __cdecl sound_snddx_cpp_getDirectSoundErrorString_FUN_00529a90(uint param_1)

#include "nocturne.h"

ulonglong __cdecl sound_snddx_cpp_getDirectSoundErrorString_FUN_00529a90(uint param_1)
