...
section .text
    ...
    PUSH EBX                            ; 0052bae0
        ;   Label: sound_snddx.cpp_CDirectSoundDevice_killSfx_FUN_0052bae0
    PUSH ESI                            ; 0052bae1
    PUSH EDI                            ; 0052bae2
    PUSH EBP                            ; 0052bae3
    ...
    PUSH 0x5947d0                       ; 0052bafd | = "DirectSoundDevice::killSfx - handle w..."
        ;   Label: LAB_0052bafd
    CALL sound_sndmain.cpp_logSoundError_FUN_00529980 ; 0052bb02
    ...
    PUSH EAX                            ; 0052bb93
    CALL sound_snddx.cpp_getDirectSoundErrorString_FUN_00529a90 ; 0052bb94
    ...
    PUSH EAX                            ; 0052bbab
    CALL crt_stdio.c_sprintf_FUN_00563c90 ; 0052bbac
        ;   XREF to: 00563c90 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_sprintf_FUN_00563c90(char * buffer, char * format)
    ADD ESP,0x10                        ; 0052bbb1
    MOV EAX,ESP                         ; 0052bbb4
    PUSH EAX                            ; 0052bbb6
    CALL sound_sndmain.cpp_logSoundError_FUN_00529980 ; 0052bbb7
        ;   XREF to: 00529980 (UNCONDITIONAL_CALL)  ; void sound_sndmain.cpp_logSoundError_FUN_00529980(char * format)
