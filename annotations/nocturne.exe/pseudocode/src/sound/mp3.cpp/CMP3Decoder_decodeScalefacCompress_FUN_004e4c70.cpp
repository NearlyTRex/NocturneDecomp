...
// Convention: unknown
// Signature: void sound_mp3_cpp_CMP3Decoder_decodeScalefacCompress_FUN_004e4c70(int param_1,undefined4 param_2,int param_3,int param_4,int param_5,int *param_6)

#include "nocturne.h"

void sound_mp3_cpp_CMP3Decoder_decodeScalefacCompress_FUN_004e4c70(int param_1,uint param_2,int param_3,int param_4,int param_5,int *param_6)
