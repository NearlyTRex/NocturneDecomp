...
section .text
    ...
    PUSH EBP                            ; 004e2f95
    CALL FUN_004e2dd0                   ; 004e2f96
        ;   XREF to: 004e2dd0 (UNCONDITIONAL_CALL)  ; undefined FUN_004e2dd0()
