...
; SMpegLayer3SideInfo * Stack[0xc]:4   side_info_array
...
section .text
    ...
    MOV dword ptr [0x01cc4800],EBP      ; 004e44f7 | g_CurrentFilename
    MOV [0x01cc4804],EAX                ; 004e44fd | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004e4502
    ...
    MOV dword ptr [0x01cc4800],EBP      ; 004e484a | g_CurrentFilename
    MOV [0x01cc4804],EAX                ; 004e4850 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004e4855
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
