...
// Convention: __cdecl
// Signature: void __cdecl sound_mp3_cpp_CFileBitStream_readQuantizedSamplesGrouped_FUN_004e37d0(undefined4 param_1,int param_2,int param_3,int param_4)

#include "nocturne.h"

void __cdecl sound_mp3_cpp_CFileBitStream_readQuantizedSamplesGrouped_FUN_004e37d0(uint param_1,int param_2,int param_3,int param_4)
      ...
      while( true ) {
        ...
        if (*local_1c == 0) {
          ...
          if (puVar5[2] == 3) {
            ...
            do {
              puVar9 = puVar8 + 0x20;
              uVar6 = sound_mp3_cpp_CFileBitStream_readBits_FUN_004e2ac0
                                (param_1,*(uint *)
            ...
            uVar2 = *puVar5;
            uVar7 = sound_mp3_cpp_CFileBitStream_readBits_FUN_004e2ac0(param_1,puVar5[1]);
