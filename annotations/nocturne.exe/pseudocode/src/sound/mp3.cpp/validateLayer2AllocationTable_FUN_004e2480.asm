...
section .text
    ...
    PUSH EBX                            ; 004e2480
        ;   Label: sound_mp3.cpp_validateLayer2AllocationTable_FUN_004e2480
    PUSH ESI                            ; 004e2481
    PUSH EDI                            ; 004e2482
    PUSH EBP                            ; 004e2483
    ...
    MOV [0x01cc4800],EAX                ; 004e25a1 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EDX      ; 004e25a6 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004e25ac
