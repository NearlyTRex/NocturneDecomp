// Name: sound_mp3.cpp_CFileBitStream_readBit_FUN_004e29d0
// Address: 004e29d0
// Address Range: [[004e29d0, 004e2abb]]
// Convention: __cdecl
// Signature: uint __cdecl sound_mp3_cpp_CFileBitStream_readBit_FUN_004e29d0(undefined4 *param_1)

#include "nocturne.h"

uint __cdecl sound_mp3_cpp_CFileBitStream_readBit_FUN_004e29d0(uint *param_1)
      ...
      if (param_1[6] == 0) {
        ...
        while ((-1 < iVar4 && (param_1[6] == 0))) {
          ...
          if (0 < (int)param_1[10]) {
            ...
            iVar4 = iVar4 + -1;
            iVar3 = _fread(iVar3,1,1,*param_1);
          }
          if (iVar3 == 1) {
