...
;
; XREF[1]:
;   sound_mp3.cpp_CMP3Decoder_decodeFrame_FUN_004e85b0 at 004e9470
;
; Called Functions:
;   sound_mp3.cpp_CMP3Decoder_decodeScalefacCompress_FUN_004e4c70
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 004e5000
        ;   Label: sound_mp3.cpp_CMP3Decoder_readLayer3ScalefactorsLSF_FUN_004e5000
    PUSH ESI                            ; 004e5001
    PUSH EDI                            ; 004e5002
    PUSH EBP                            ; 004e5003
    ...
    CALL sound_mp3.cpp_CMP3Decoder_decodeScalefacCompress_FUN_004e4c70 ; 004e504e
        ;   XREF to: 004e4c70 (UNCONDITIONAL_CALL)  ; void sound_mp3.cpp_CMP3Decoder_decodeScalefacCompress_FUN_004e4c70(CMP3Decoder * this_ptr, int * scalefactor_dest, SMpegLayer3SideInfo * side_info, int channel, ...)
