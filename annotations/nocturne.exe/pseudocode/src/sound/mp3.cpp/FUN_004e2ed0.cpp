...
// Convention: unknown
// Signature: undefined4 FUN_004e2ed0(undefined4 param_1,char *param_2,uint *param_3,uint *param_4,uint *param_5,uint *param_6)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_004e2ed0(uint param_1,char *param_2,uint *param_3,uint *param_4,uint *param_5,uint *param_6)
...
LAB_004e2f39:
  if ((*param_2 == '3') && ((param_2[1] == '2' || (param_2[1] == '3')))) {
    ...
    *param_4 = *param_4 & 1;
    if ((*param_5 != 0) && (iVar1 = FUN_004e2dd0(param_1), iVar1 == 1)) {
      *param_5 = -*param_5;
    }
    if ((*param_6 != 0) && (iVar1 = FUN_004e2dd0(param_1), iVar1 == 1)) {
      *param_6 = -*param_6;
    }
    if ((*param_3 != 0) && (iVar1 = FUN_004e2dd0(param_1), iVar1 == 1)) {
      *param_3 = -*param_3;
    }
  }
  else {
    if ((*(int *)(param_2 + 0xc) != 0) && (*(int *)(param_2 + 4) - 1U == *param_3)) {
      iVar1 = FUN_004e2cf0(param_1,*(int *)(param_2 + 0xc));
    ...
    if ((*(int *)(param_2 + 0xc) != 0) && (*(int *)(param_2 + 8) - 1U == *param_4)) {
      iVar1 = FUN_004e2cf0(param_1,*(uint *)(param_2 + 0xc));
      *param_4 = *param_4 + iVar1;
    }
  }
  if ((*param_4 != 0) && (iVar1 = FUN_004e2dd0(param_1), iVar1 == 1)) {
    *param_4 = -*param_4;
  }
  return local_14;
}
