...
section .text
    ...
    PUSH EBX                            ; 004e2de0
        ;   Label: sound_mp3.cpp_CMP3Decoder_putByte_FUN_004e2de0
    ...
    MOV dword ptr [0x01cc4800],ECX      ; 004e2e1f | PTR_01cc4800
    MOV dword ptr [0x01cc4804],ESI      ; 004e2e25 | INT_01cc4804
