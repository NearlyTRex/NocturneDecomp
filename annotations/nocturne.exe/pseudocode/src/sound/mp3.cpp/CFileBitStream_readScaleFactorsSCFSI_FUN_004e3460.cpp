...
// Convention: __cdecl
// Signature: void __cdecl sound_mp3_cpp_CFileBitStream_readScaleFactorsSCFSI_FUN_004e3460(CFileBitStream *this_ptr,SMpegSubbandSCFSI *scfsi_array,SMpegSubbandAllocation *allocation_array,SMpegSubbandScalefactors *scalefactor_array,SMpegFrame *frame)
...

{
  ...
  if (0 < iVar3) {
    ...
    do {
      iVar4 = 0;
      if (0 < iVar1) {
        piVar8 = (int *)((int)allocation_array->bit_allocations + local_28);
        do {
          if (*piVar8 != 0) {
  ...
  if (0 < iVar3) {
    ...
    do {
      iVar4 = 0;
      if (0 < iVar1) {
        local_14 = (int *)((int)allocation_array->bit_allocations + local_24);
        ...
        do {
          ...
          case 0:
            uVar2 = sound_mp3_cpp_CFileBitStream_readBits_FUN_004e2ac0(this_ptr,6);
            *puVar6 = uVar2;
            uVar2 = sound_mp3_cpp_CFileBitStream_readBits_FUN_004e2ac0(this_ptr,6);
            puVar6[0x20] = uVar2;
            goto LAB_004e3598;
