// Name: sound_mp3.cpp_CMP3Decoder_parseHeader_FUN_004e7ed0
// Address: 004e7ed0
// Address Range: [[004e7ed0, 004e825f]]
// Convention: __cdecl
// Signature: int __cdecl sound_mp3_cpp_CMP3Decoder_parseHeader_FUN_004e7ed0(CMP3Decoder *this_ptr,_FILE *file_handle,int file_size)
...

{
  ...
  if (local_48->layer == 2) {
    ...
    if (iVar6 != *(int *)(local_24 + 0xc)) {
      ...
      core_main_c_displayErrorAndQuit_FUN_004c8440("MPEG Layer 2 - pick_table - can't load tables!  File: %s",&DAT_01cd8b28)
      ;
    }
    local_30 = local_1c;
  }
  ...
  if (pSVar1->channel_mode == 1) {
    ...
    if ((((iVar6 < 1) || (3 < iVar6)) || (iVar5 < 0)) || (3 < iVar5)) {
      ...
      core_main_c_displayErrorAndQuit_FUN_004c8440
                ("js_bound bad layer/modext (%d/%d)  File: %s",iVar6,iVar5,&DAT_01cd8b28);
    }
