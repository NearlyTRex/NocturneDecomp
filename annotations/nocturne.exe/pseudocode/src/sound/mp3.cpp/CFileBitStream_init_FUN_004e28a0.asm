...
section .text
    ...
    PUSH EBX                            ; 004e28a0
        ;   Label: sound_mp3.cpp_CFileBitStream_init_FUN_004e28a0
    PUSH ESI                            ; 004e28a1
    PUSH EDI                            ; 004e28a2
    PUSH EBP                            ; 004e28a3
    ...
    PUSH EDI                            ; 004e28bb
    CALL crt_memory.c_free_FUN_005638d0 ; 004e28bc
    ...
    MOV dword ptr [0x01cc4800],ESI      ; 004e2962 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EDI      ; 004e2968 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004e296e
