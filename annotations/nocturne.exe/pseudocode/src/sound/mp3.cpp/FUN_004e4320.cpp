...
// Convention: unknown
// Signature: void FUN_004e4320(undefined4 param_1,undefined4 param_2,undefined4 *param_3,undefined4 *param_4)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_004e4320(uint param_1,uint param_2,uint *param_3,uint *param_4)

{
  ...
  if (*(int *)*param_4 == 0) {
    ...
    *param_3 = uVar3;
    ...
    uVar3 = FUN_004e2ac0(param_2,uVar3);
    param_3[1] = uVar3;
    local_30 = 0;
    if (0 < iVar1) {
      local_28 = param_3;
      ...
      local_38 = param_3;
      do {
        uVar3 = FUN_004e2ac0(param_2,0xc);
        local_28[6] = uVar3;
        uVar3 = FUN_004e2ac0(param_2,9);
        local_28[7] = uVar3;
        uVar3 = FUN_004e2ac0(param_2,8);
        local_28[8] = uVar3;
        uVar3 = FUN_004e2ac0(param_2,9);
        local_28[9] = uVar3;
        iVar4 = FUN_004e29d0(param_2);
        puVar5 = param_3 + local_30 * 0x28;
        local_28[10] = iVar4;
        if (iVar4 == 0) {
          iVar4 = 0;
          do {
            uVar3 = FUN_004e2ac0(param_2,5);
            iVar7 = iVar4 + 4;
            *(uint *)((int)puVar5 + iVar4 + 0x34) = uVar3;
            iVar4 = iVar7;
          } while (iVar7 != 0xc);
          uVar3 = FUN_004e2ac0(param_2,4);
          puVar5[0x13] = uVar3;
          uVar3 = FUN_004e2ac0(param_2,3);
          puVar5[0xb] = 0;
          puVar5[0x14] = uVar3;
        }
        else {
          uVar3 = FUN_004e2ac0(param_2,2);
          local_28[0xb] = uVar3;
          uVar3 = FUN_004e29d0(param_2);
          local_28[0xc] = uVar3;
          puVar8 = puVar5;
          do {
            puVar9 = puVar8 + 1;
