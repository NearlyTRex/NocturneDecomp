...
;   undefined4 DAT_01cc9124
;   undefined4 DAT_01cc9128
;   undefined4 DAT_01cc912c
;   undefined4 DAT_01cc9130
;   undefined4 DAT_01cc9134
;   undefined4 DAT_01cc9138
;   undefined4 DAT_01cc92a4
;   undefined4 DAT_01cc92a8
;   undefined4 DAT_01cc92ac
;   undefined4 DAT_01cc92b0
;   ... and 3 more
;
; Called Functions:
...
section .text
    ...
    FMUL float ptr [0x005a0888]         ; 004d74d7 | DAT_005a0888
    FSTP float ptr [EBX]                ; 004d74dd | DAT_01cc9124 | DAT_01cc9130
    FILD dword ptr [EAX + 0x4]          ; 004d74df
    FMUL float ptr [0x005a0888]         ; 004d74e2 | DAT_005a0888
    FSTP float ptr [EBX + 0x4]          ; 004d74e8 | DAT_01cc9128 | DAT_01cc9134
    FILD dword ptr [EAX + 0x8]          ; 004d74eb
    FMUL float ptr [0x005a0888]         ; 004d74ee | DAT_005a0888
    FSTP float ptr [EBX + 0x8]          ; 004d74f4 | DAT_01cc912c | DAT_01cc9138
    ...
    PUSH 0x1cc92a4                      ; 004d7510 | DAT_01cc92a4
        ;   Label: LAB_004d7510
    PUSH 0x1cc92a8                      ; 004d7515 | DAT_01cc92a8
    ...
    PUSH 0x1cc9120                      ; 004d754d | DAT_01cc9120
        ;   Label: LAB_004d754d
    PUSH 0x1cc9124                      ; 004d7552 | DAT_01cc9124
    PUSH ESI                            ; 004d7557
    ...
    PUSH 0x1cc9124                      ; 004d75ab | DAT_01cc9124
    PUSH ECX                            ; 004d75b0
    ...
    FLD float ptr [EAX]                 ; 004d7662 | DAT_01cc92a8 | DAT_01cc92b4
    FMUL float ptr [0x005a0880]         ; 004d7664 | DAT_005a0880
    FISTP dword ptr [EBX]               ; 004d766a
    FLD float ptr [EAX + 0x4]           ; 004d766c | DAT_01cc92ac | DAT_01cc92b8
    FMUL float ptr [0x005a0880]         ; 004d766f | DAT_005a0880
    FISTP dword ptr [EBX + 0x4]         ; 004d7675
    FLD float ptr [EAX + 0x8]           ; 004d7678 | DAT_01cc92b0 | DAT_01cc92bc
    FMUL float ptr [0x005a0880]         ; 004d767b | DAT_005a0880
