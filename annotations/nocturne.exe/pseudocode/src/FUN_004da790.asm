...
;   undefined4 DAT_0058a339
;   undefined4 DAT_0058a341
;   undefined4 DAT_0058a349
;   undefined4 DAT_0058a351
;   undefined4 DAT_0058a359
;   undefined4 DAT_005a0918
;   undefined4 DAT_005a091c
;   undefined4 DAT_005a0928
...
section .text
    ...
    PUSH EBX                            ; 004da7c9
        ;   Label: LAB_004da7c9
    CALL FUN_004da5a0                   ; 004da7ca
        ;   XREF to: 004da5a0 (UNCONDITIONAL_CALL)  ; undefined FUN_004da5a0()
    ADD ESP,0x4                         ; 004da7cf
    PUSH dword ptr [EBP + 0x92]         ; 004da7d2
    PUSH EBX                            ; 004da7d8
    CALL FUN_00429220                   ; 004da7d9
    ...
    PUSH EBX                            ; 004dacad
    CALL FUN_004db6f0                   ; 004dacae
        ;   XREF to: 004db6f0 (UNCONDITIONAL_CALL)  ; undefined FUN_004db6f0()
    ...
    PUSH EAX                            ; 004dae15
    PUSH EBX                            ; 004dae16
    CALL FUN_0040a240                   ; 004dae17
        ;   XREF to: 0040a240 (UNCONDITIONAL_CALL)  ; undefined FUN_0040a240()
    ADD ESP,0xc                         ; 004dae1c
    PUSH EAX                            ; 004dae1f
    PUSH EBX                            ; 004dae20
    CALL FUN_004798e0                   ; 004dae21
        ;   XREF to: 004798e0 (UNCONDITIONAL_CALL)  ; undefined FUN_004798e0()
    ...
    JC 0x004daae7                       ; 004dae3b
        ;   XREF to: 004daae7 (CONDITIONAL_JUMP)  ; caseD_7
    PUSH EBX                            ; 004dae41
    CALL FUN_004dc110                   ; 004dae42
        ;   XREF to: 004dc110 (UNCONDITIONAL_CALL)  ; undefined FUN_004dc110()
    ...
    FLD float ptr [EBX + 0xbdf4]        ; 004dae6f
        ;   Label: LAB_004dae6f
    FCOMP double ptr [0x0058a341]       ; 004dae75 | DAT_0058a341
    FNSTSW AX                           ; 004dae7b
    SAHF                                ; 004dae7d
    ...
    PUSH EAX                            ; 004daeb9
    CALL FUN_004e16b0                   ; 004daeba
        ;   XREF to: 004e16b0 (UNCONDITIONAL_CALL)  ; undefined FUN_004e16b0()
    ADD ESP,0xc                         ; 004daebf
    PUSH 0x3e99999a                     ; 004daec2
    CALL FUN_0040dea0                   ; 004daec7
    ...
    PUSH 0x3                            ; 004daed7
    PUSH EBX                            ; 004daed9
    CALL FUN_004dc940                   ; 004daeda
        ;   XREF to: 004dc940 (UNCONDITIONAL_CALL)  ; undefined FUN_004dc940()
    ...
    FCOMP double ptr [0x0058a341]       ; 004db079 | DAT_0058a341
    FNSTSW AX                           ; 004db07f
    SAHF                                ; 004db081
    ...
    FADDP                               ; 004db0fd
    FSQRT                               ; 004db0ff
    FCOMP double ptr [0x0058a351]       ; 004db101 | DAT_0058a351
    FNSTSW AX                           ; 004db107
    SAHF                                ; 004db109
    ...
    FCOMP double ptr [0x0058a341]       ; 004db11f | DAT_0058a341
    FNSTSW AX                           ; 004db125
    SAHF                                ; 004db127
    JBE 0x004daae7                      ; 004db128
        ;   XREF to: 004daae7 (CONDITIONAL_JUMP)  ; caseD_7
    PUSH 0x3e800000                     ; 004db12e
    CALL FUN_0040dea0                   ; 004db133
        ;   XREF to: 0040dea0 (UNCONDITIONAL_CALL)  ; undefined FUN_0040dea0()
    ...
    PUSH EBX                            ; 004db143
    CALL FUN_004da670                   ; 004db144
        ;   XREF to: 004da670 (UNCONDITIONAL_CALL)  ; undefined FUN_004da670()
    ...
    FADDP                               ; 004db1dd
    FSQRT                               ; 004db1df
    FLD float ptr [0x005a0918]          ; 004db1e1 | DAT_005a0918
    FLD1                                ; 004db1e7
    FADDP                               ; 004db1e9
    FXCH                                ; 004db1eb
    ...
    FCOMP double ptr [0x0058a349]       ; 004db22f | DAT_0058a349
    FNSTSW AX                           ; 004db235
    SAHF                                ; 004db237
    ...
    FCOMP float ptr [0x005a0928]        ; 004db27d | DAT_005a0928
    FNSTSW AX                           ; 004db283
    SAHF                                ; 004db285
    ...
    MOV EAX,[0x005a0918]                ; 004db339 | DAT_005a0918
    ...
    PUSH dword ptr [EBP + 0x92]         ; 004db3e3
        ;   Label: LAB_004db3e3
    PUSH EBX                            ; 004db3e9
    CALL FUN_004dbce0                   ; 004db3ea
        ;   XREF to: 004dbce0 (UNCONDITIONAL_CALL)  ; undefined FUN_004dbce0()
    ADD ESP,0x8                         ; 004db3ef
    TEST EAX,EAX                        ; 004db3f2
    JNZ 0x004daae7                      ; 004db3f4
        ;   XREF to: 004daae7 (CONDITIONAL_JUMP)  ; caseD_7
    FLD float ptr [0x005a0918]          ; 004db3fa | DAT_005a0918
    FLD1                                ; 004db400
    FADDP                               ; 004db402
    ...
    MOV EAX,[0x005a091c]                ; 004db411 | DAT_005a091c
    ...
    MOV EAX,[0x005a0918]                ; 004db43d | DAT_005a0918
    ...
    FLD float ptr [EBX + 0xbdf4]        ; 004db5c2
        ;   Label: LAB_004db5c2
    FCOMP double ptr [0x0058a341]       ; 004db5c8 | DAT_0058a341
    FNSTSW AX                           ; 004db5ce
    SAHF                                ; 004db5d0
