...
// Convention: unknown
// Signature: void FUN_00455640(int param_1,float param_2)
...

{
  ...
  case 0:
    iVar4 = FUN_0047dc30(0x01C03A10,param_1 + 0x2e0);
    if (iVar4 != 0) {
  ...
  case 1:
    *(float *)(param_1 + 0x9a4) =
    ...
    break;
  case 2:
    iVar4 = FUN_0047dc30(0x01C03A10,param_1 + 0x344);
  ...
  FUN_0047ab70(0x01C03A10,iVar4);
LAB_00455728:
  FUN_004552a0(param_1);
  if ((*(float *)(param_1 + 0x9a4) != local_50) && (*(int *)(param_1 + 0x2d0) != 3)) {
    ...
    while( true ) {
      ...
      if (((iVar2 == 2) &&
        ...
        pfVar3 = (float *)FUN_0044daa0(iStack_4c,auStack_90,&fStack_84);
        if (&fStack_6c != pfVar3) {
          fStack_6c = *pfVar3;
          fStack_68 = pfVar3[1];
          fStack_64 = pfVar3[2];
