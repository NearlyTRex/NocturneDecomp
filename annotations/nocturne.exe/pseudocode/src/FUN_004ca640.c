...
// Convention: unknown
// Signature: void FUN_004ca640(int param_1,int param_2)
...

{
  ...
  *(float *)(iVar3 + 0x1c) = fVar1;
  FUN_0044d7a0(iVar3 + 0x24,iVar3 + 0x18);
  local_2c = *(uint *)(param_1 + 0x1504);
  local_34 = 0;
  local_30 = 0;
  puVar2 = (uint *)FUN_0044da40(iVar3 + 0x24,local_28,&local_34);
  if ((uint *)(iVar3 + 0xc) != puVar2) {
    *(uint *)(iVar3 + 0xc) = *puVar2;
    *(uint *)(iVar3 + 0x10) = puVar2[1];
    *(uint *)(iVar3 + 0x14) = puVar2[2];
  }
  puVar2 = (uint *)FUN_0040a240(param_1,local_1c,iVar3 + 0xc);
