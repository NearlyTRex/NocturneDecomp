...
section .text
    ...
    PUSH EAX                            ; 0048a006
    MOV ESI,dword ptr [0x005be368]      ; 0048a007 | DAT_005be368
    PUSH ESI                            ; 0048a00d | DAT_01e57284
    CALL FUN_0050bb50                   ; 0048a00e
