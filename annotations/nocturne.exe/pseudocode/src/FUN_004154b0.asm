...
;   undefined4 DAT_00578e1e
;   undefined4 DAT_00578e26
...
section .text
    ...
    FLD ST0                             ; 004155bd
    FMUL double ptr [0x00578e26]        ; 004155bf | DAT_00578e26
