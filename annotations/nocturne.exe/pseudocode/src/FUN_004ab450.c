...

{
  ...
  FUN_00527230(*(uint *)(param_1 + 0xbd74));
  if ((*(int *)(param_1 + 0xbd84) != 0) &&
     (iVar1 = FUN_004e1660(param_1 + 0x150), *(int *)(iVar1 + 0x24) == 0)) {
    ...
    *(uint *)(param_1 + 0xbd90) = 0x3f800000;
    ...
    FUN_0043ac60(PTR_DAT_005ad350,"@go berzerk\n" + 1);
  }
  if (*(int *)(param_2 + 0x30) == 0x6c) {
    *(uint *)(param_1 + 0xbd80) = 0x40800000;
  }
  FUN_004ab190(param_1,param_2);
  ...
  if (*(float *)(param_1 + 0x2434) <= 0.0) {
    *(uint *)(param_1 + 0x2434) = 0;
    ...
    if ((*(int *)(iVar1 + 0x24) != 10) && (*(int *)(iVar1 + 0x24) != 9)) {
      ...
      iVar1 = FUN_00526c50(*(uint *)(param_1 + 0xbd7c));
      if (iVar1 == 0) {
        uVar3 = (**(code **)(*(int *)(param_1 + 0x14c) + 0x24))
                          (param_1,"ghoul-die-!-?.wav @1.6");
        *(uint *)(param_1 + 0xbd7c) = uVar3;
      }
      local_14 = (float)FUN_0040dda0(0x40800000,0x41200000);
      fVar4 = (float10)local_14 * (float10)_DAT_00584e8d;
      *(uint *)(param_1 + 0xbd30) = 0xa0000;
      iVar1 = FUN_00563a30(0x32,0x41c80000);
      *(int *)(param_1 + 0xbd2c) = (int)ROUND(fVar4);
      (**(code **)(iVar1 + 0xa0))(param_1);
    }
  }
  else {
    iVar1 = FUN_004e1660(param_1 + 0x150);
    ...
    if (((iVar1 == 0) || (iVar1 == 0xb || (iVar1 == 0xc || iVar1 == 2))) ||
       (iVar1 = FUN_0040dea0(0x3e800000), iVar1 != 0)) {
      iVar1 = FUN_0040dea0(0x3f000000,1);
      FUN_004e16b0(param_1 + 0x150,(iVar1 == 0) + '\x03');
    }
    else {
      uVar3 = FUN_0040de00(1,2);
      FUN_00563c90(local_78,"guul flinch%d",uVar3);
      uVar3 = FUN_004e1890(param_1 + 0x150,local_78,1);
      uVar3 = FUN_004e1010(uVar3);
      *(uint *)(param_1 + 0xbd38) = 0x3f800000;
      *(uint *)(param_1 + 0xbd3c) = uVar3;
    }
    iVar1 = FUN_00526c50(*(uint *)(param_1 + 0xbd78));
    if (iVar1 == 0) {
