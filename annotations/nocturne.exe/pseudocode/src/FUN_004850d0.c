...
// Convention: unknown
// Signature: void FUN_004850d0(int param_1,float *param_2,undefined4 *param_3,undefined4 *param_4,undefined4 *param_5,undefined4 param_6)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_004850d0(int param_1,float *param_2,uint *param_3,uint *param_4,uint *param_5,uint param_6)

{
  ...
  *(uint *)(param_1 + 0x74) = param_4[2];
  local_10 = (float)FUN_0040dda0(0,0x40490fdb);
  *(uint *)(param_1 + 0x5c) = 0;
  *(float *)(param_1 + 0x54) = local_10;
  local_10 = (float)FUN_0040dda0(0,0x40c90fdb);
  ...
  *(uint *)(param_1 + 0x38) = param_6;
  ...
  local_28 = SQRT(local_84 * local_84 + local_8c * local_8c + local_88 * local_88) *
             (float)_DAT_00581154;
  local_1c = (float)FUN_0040dda0(0x3f490fdb,0x3fc90fdb);
  local_10 = local_1c;
  local_10 = (float)FUN_0040dda0(0,0x40c90fdb);
  ...
  FUN_004ef040(param_1,&local_50,&local_68);
  return;
}
