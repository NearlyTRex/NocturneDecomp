...
// Convention: unknown
// Signature: void FUN_0045cb90(undefined4 param_1,int param_2,int param_3,uint param_4,uint param_5)

#include "nocturne.h"

void FUN_0045cb90(uint param_1,int param_2,int param_3,uint param_4,uint param_5)
