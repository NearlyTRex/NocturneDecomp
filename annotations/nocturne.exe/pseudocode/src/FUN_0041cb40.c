...
// Convention: unknown
// Signature: void FUN_0041cb40(int param_1,undefined4 *param_2,undefined4 *param_3)

#include "nocturne.h"

void FUN_0041cb40(int param_1,uint *param_2,uint *param_3)

{
  ...
  if (param_2 != (uint *)0x0) {
    ...
    puVar1 = (uint *)FUN_0044daa0(param_1 + 0x18,local_14,param_1 + 0x40);
