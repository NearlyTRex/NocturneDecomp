...
section .text
    ...
    CALL FUN_00525f50                   ; 00484c69
        ;   XREF to: 00525f50 (UNCONDITIONAL_CALL)  ; undefined FUN_00525f50()
    ADD ESP,0x18                        ; 00484c6e
    PUSH 0x3f4ccccd                     ; 00484c71
    CALL FUN_005260f0                   ; 00484c76
