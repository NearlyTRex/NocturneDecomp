...
// Convention: unknown
// Signature: void FUN_00440710(int param_1)
...
LAB_0044089a:
      ...
      if (0 < _DAT_0140e7a4) {
        ...
        do {
          ...
          iVar5 = iVar5 + 4;
          iVar7 = iVar7 + 1;
          FUN_00465341(*(int *)(&DAT_01bd4260 + local_20) + *piVar6 * 4,
                       *(int *)(param_1 + 0x15c) +
                       (((local_18 - *(int *)(param_1 + 0x148)) * *(int *)(param_1 + 0x13c) +
                        *piVar1) - *(int *)(param_1 + 0x144)) * 4,(*piVar3 - *piVar2) * 4 + 4);
