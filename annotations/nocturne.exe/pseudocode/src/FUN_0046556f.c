...
// Convention: unknown
// Signature: void FUN_0046556f(undefined8 *param_1,undefined8 *param_2,byte *param_3,byte *param_4,int param_5)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_0046556f(ulonglong *param_1,ulonglong *param_2,byte *param_3,byte *param_4,int param_5)
