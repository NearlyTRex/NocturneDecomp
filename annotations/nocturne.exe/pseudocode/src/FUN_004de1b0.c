...
// Convention: unknown
// Signature: void FUN_004de1b0(int param_1,float param_2)
  ...
  if ((*(int *)(param_1 + 0x1fa38) != 0) && (*(int *)(param_1 + 0x1fa38) == 1)) {
    ...
    *(uint *)(param_1 + 0x2410) = 0;
    if (SQRT(local_6c * local_6c + local_74 * local_74 + local_70 * local_70) <=
      ...
      iVar6 = FUN_004f1600(uVar3,param_1 + 0x20,auStack_68,*(uint *)(param_1 + 0x6c));
      if (iVar6 != 0) {
        fStack_18 = (float)FUN_0040df00(fStack_64 - *(float *)(param_1 + 0x34));
    ...
    pfVar4 = (float *)FUN_0054e4a0(auStack_50,&local_74);
    if (&local_74 != pfVar4) {
      local_74 = *pfVar4;
      local_70 = pfVar4[1];
      local_6c = pfVar4[2];
    }
    fStack_58 = (float)FUN_0040df00(local_70 - *(float *)(param_1 + 0x34));
