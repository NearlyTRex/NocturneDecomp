...
;
; Referenced Globals:
;   undefined4 s_gabriela.dfm_00581e49+1
;   string s_gabgun.kfm_00581e57
;   undefined4 DAT_0059dcdc
;   undefined1* PTR_FUN_0059dcf4 = 004957c0
;
; Called Functions:
;   FUN_00435100
;   FUN_00454580
...
section .text
    ...
    PUSH 0x581e4a                       ; 0049575c | s_gabriela.dfm_00581e49+1
