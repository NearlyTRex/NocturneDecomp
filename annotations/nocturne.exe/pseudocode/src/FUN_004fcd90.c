...
// Convention: unknown
// Signature: void FUN_004fcd90(int param_1,float param_2)
...

{
  ...
  if ((*(int *)(iVar2 + 0x24) != 0xc) &&
     (iVar2 = FUN_004e1660(param_1 + 0x150), *(int *)(iVar2 + 0x24) != 0xd)) {
...
LAB_004fcf93:
      ...
      uVar3 = FUN_0042a500(param_1,&param_2,iVar5);
      FUN_004e1890(param_1 + 0x150);
      if (-1 < (int)uVar3) {
