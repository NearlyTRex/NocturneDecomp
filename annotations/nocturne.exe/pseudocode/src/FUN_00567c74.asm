...
section .text
    ...
    PUSH EDX                            ; 00567ca7
    CALL FUN_00567c2c                   ; 00567ca8
        ;   XREF to: 00567c2c (UNCONDITIONAL_CALL)  ; undefined FUN_00567c2c()
