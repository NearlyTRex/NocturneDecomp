...
section .text
    ...
    MOV EBX,dword ptr [0x005ae704]      ; 004ae0b4 | DAT_005ae704
    ...
    FMULP ST3                           ; 004ae152
    FXCH                                ; 004ae154
    CALL FUN_00563a30                   ; 004ae156
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH                                ; 004ae15b
    CALL FUN_00563a30                   ; 004ae15d
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH ST2                            ; 004ae162
    CALL FUN_00563a30                   ; 004ae164
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH                                ; 004ae169
