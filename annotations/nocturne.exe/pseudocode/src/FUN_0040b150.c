...
// Convention: unknown
// Signature: undefined4 FUN_0040b150(int param_1,undefined4 *param_2,undefined4 *param_3)

#include "nocturne.h"

uint FUN_0040b150(int param_1,uint *param_2,uint *param_3)
