...
// Convention: unknown
// Signature: byte * FUN_0056d658(byte *param_1,byte *param_2,int *param_3)
...
LAB_0056d6d8:
  if ((0x2f < *param_1) && (*param_1 < 0x3a)) {
    ...
    local_18 = 0;
    local_14 = 0;
    param_1 = (byte *)FUN_0056d628(param_1,&local_14);
    if (*param_1 == 0x3a) {
      param_1 = (byte *)FUN_0056d628(param_1 + 1,&local_18);
      if (*param_1 == 0x3a) {
        param_1 = (byte *)FUN_0056d628(param_1 + 1,&local_1c);
      }
    }
