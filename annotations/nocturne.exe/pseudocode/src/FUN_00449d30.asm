...
section .text
    ...
    PUSH EAX                            ; 00449ef6
    CALL FUN_00449bc0                   ; 00449ef7
        ;   XREF to: 00449bc0 (UNCONDITIONAL_CALL)  ; undefined FUN_00449bc0()
    ...
    PUSH ESI                            ; 00449f72
    PUSH EBX                            ; 00449f73
    CALL FUN_00449150                   ; 00449f74
        ;   XREF to: 00449150 (UNCONDITIONAL_CALL)  ; undefined FUN_00449150()
