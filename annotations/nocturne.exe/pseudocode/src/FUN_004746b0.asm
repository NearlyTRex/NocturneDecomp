...
section .text
    ...
    PUSH ECX                            ; 0047470f
    PUSH EDX                            ; 00474710
    CALL FUN_004f8d50                   ; 00474711
        ;   XREF to: 004f8d50 (UNCONDITIONAL_CALL)  ; undefined FUN_004f8d50()
    ...
    PUSH ECX                            ; 004747bb
    PUSH EBX                            ; 004747bc
    CALL FUN_00474460                   ; 004747bd
        ;   XREF to: 00474460 (UNCONDITIONAL_CALL)  ; undefined FUN_00474460()
    ADD ESP,0x14                        ; 004747c2
    MOV ECX,ESP                         ; 004747c5
    PUSH ECX                            ; 004747c7
    MOV EBP,dword ptr [0x005be1cc]      ; 004747c8 | DAT_005be1cc
    PUSH EBP                            ; 004747ce
    CALL FUN_004f8da0                   ; 004747cf
        ;   XREF to: 004f8da0 (UNCONDITIONAL_CALL)  ; undefined FUN_004f8da0()
    ...
    PUSH ECX                            ; 0047482c
    PUSH EBX                            ; 0047482d
    CALL FUN_00474460                   ; 0047482e
        ;   XREF to: 00474460 (UNCONDITIONAL_CALL)  ; undefined FUN_00474460()
    ADD ESP,0x14                        ; 00474833
    LEA ECX,[ESP + 0x31c]               ; 00474836
    PUSH ECX                            ; 0047483d
    CALL FUN_00456cc0                   ; 0047483e
