...
section .text
    ...
    PUSH EAX                            ; 00561ace
    CALL FUN_0040ca80                   ; 00561acf
        ;   XREF to: 0040ca80 (UNCONDITIONAL_CALL)  ; undefined FUN_0040ca80()
    MOV EDX,dword ptr [0x005c166c]      ; 00561ad4 | DAT_005c166c
    ...
    PUSH EAX                            ; 00561b23
    CALL FUN_0040cbf0                   ; 00561b24
        ;   XREF to: 0040cbf0 (UNCONDITIONAL_CALL)  ; undefined FUN_0040cbf0()
    MOV EDI,dword ptr [0x005c166c]      ; 00561b29 | DAT_005c166c
    ...
    PUSH EAX                            ; 00561b7c
    CALL FUN_0040c980                   ; 00561b7d
        ;   XREF to: 0040c980 (UNCONDITIONAL_CALL)  ; undefined FUN_0040c980()
    ADD ESP,0x8                         ; 00561b82
    MOV EDX,dword ptr [0x005c166c]      ; 00561b85 | DAT_005c166c
        ;   Label: LAB_00561b85
