...
section .text
    ...
    PUSH 0x59b200                       ; 0042b661 | DAT_0059b200
        ;   Label: LAB_0042b661
    PUSH EBX                            ; 0042b666
    CALL FUN_0056445f                   ; 0042b667
        ;   XREF to: 0056445f (UNCONDITIONAL_CALL)  ; undefined FUN_0056445f()
    ADD ESP,0x8                         ; 0042b66c
    PUSH EAX                            ; 0042b66f
    CALL FUN_00564486                   ; 0042b670
