...
// Convention: unknown
// Signature: void FUN_004b1ff0(int param_1)
...

{
  ...
  for (; iVar2 = iVar1, iVar4 < 0; iVar4 = iVar4 + 1) {
    for (; iVar3 = local_1c, iVar2 < 0; iVar2 = iVar2 + 1) {
      FUN_004b1e10(param_1,*(int *)(param_1 + 0x2c) + iVar2,*(int *)(param_1 + 0x30) + iVar4);
    }
    while (iVar3 = iVar3 + -1, -1 < iVar3) {
      FUN_004b1e10(param_1,*(int *)(param_1 + 0x2c) + iVar3,*(int *)(param_1 + 0x30) + iVar4);
    }
  }
  while (local_20 = local_20 + -1, iVar4 = iVar1, -1 < local_20) {
    for (; iVar2 = local_1c, iVar4 < 0; iVar4 = iVar4 + 1) {
      FUN_004b1e10(param_1,*(int *)(param_1 + 0x2c) + iVar4,*(int *)(param_1 + 0x30) + local_20);
    }
    while (iVar2 = iVar2 + -1, -1 < iVar2) {
      FUN_004b1e10(param_1,*(int *)(param_1 + 0x2c) + iVar2,*(int *)(param_1 + 0x30) + local_20);
    }
  }
  return;
}
