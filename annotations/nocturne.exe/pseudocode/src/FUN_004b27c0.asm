...
section .text
    ...
    PUSH EDX                            ; 004b2b34
    CALL FUN_0048c6b0                   ; 004b2b35
        ;   XREF to: 0048c6b0 (UNCONDITIONAL_CALL)  ; undefined FUN_0048c6b0()
