...
section .text
    ...
    PUSH EBX                            ; 004adf04
    CALL FUN_004adf70                   ; 004adf05
        ;   XREF to: 004adf70 (UNCONDITIONAL_CALL)  ; undefined FUN_004adf70()
    ADD ESP,0x8                         ; 004adf0a
    PUSH 0x0                            ; 004adf0d
    SUB EAX,0x1a0                       ; 004adf0f
    PUSH EAX                            ; 004adf14
    CALL FUN_004d6570                   ; 004adf15
        ;   XREF to: 004d6570 (UNCONDITIONAL_CALL)  ; undefined FUN_004d6570()
    ADD ESP,0x8                         ; 004adf1a
    PUSH 0x1                            ; 004adf1d
    LEA EBX,[EAX + 0xfffffe1c]          ; 004adf1f
    PUSH EBX                            ; 004adf25
    CALL FUN_00409ea0                   ; 004adf26
    ...
    POP EBX                             ; 004adf3b
    RET                                 ; 004adf3c
    PUSH 0x59e490                       ; 004adf3d | DAT_0059e490
        ;   Label: LAB_004adf3d
    PUSH EBX                            ; 004adf42
    CALL FUN_0056445f                   ; 004adf43
        ;   XREF to: 0056445f (UNCONDITIONAL_CALL)  ; undefined FUN_0056445f()
    ADD ESP,0x8                         ; 004adf48
    PUSH EAX                            ; 004adf4b
    CALL FUN_00564486                   ; 004adf4c
