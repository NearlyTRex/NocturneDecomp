...
section .text
    ...
    CALL core_glass.cpp_CVector3f_arrdtor_FUN_004adf70 ; 004adf05
        ;   XREF to: 004adf70 (UNCONDITIONAL_CALL)  ; undefined core_glass.cpp_CVector3f_arrdtor_FUN_004adf70()
    ADD ESP,0x8                         ; 004adf0a
    PUSH 0x0                            ; 004adf0d
    SUB EAX,0x1a0                       ; 004adf0f
    PUSH EAX                            ; 004adf14
    CALL core_mirror.cpp_CMirror_dtor_FUN_004d6570 ; 004adf15
        ;   XREF to: 004d6570 (UNCONDITIONAL_CALL)  ; undefined core_mirror.cpp_CMirror_dtor_FUN_004d6570()
