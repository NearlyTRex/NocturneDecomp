...
// Convention: unknown
// Signature: void FUN_0056511e(undefined4 *param_1,byte param_2,undefined4 param_3,uint param_4,undefined4 param_5)

#include "nocturne.h"

void FUN_0056511e(uint *param_1,byte param_2,uint param_3,uint param_4,uint param_5)
