...
// Convention: unknown
// Signature: void FUN_00508750(int param_1,undefined4 param_2)

#include "nocturne.h"

void FUN_00508750(int param_1,uint param_2)

{
  ...
  if (0 < *(int *)(param_1 + 0x15f2fc)) {
    do {
      ...
      FUN_0050adc0(param_1,iVar1 + 0x20,iVar1 + 0x30,&uStack_28,&uStack_1c,iVar1 + 0x3c);
