...
section .text
    ...
    POP EBX                             ; 0041fa5b
    RET                                 ; 0041fa5c
    PUSH 0x59acb0                       ; 0041fa5d | DAT_0059acb0
        ;   Label: LAB_0041fa5d
    PUSH EBX                            ; 0041fa62
    CALL FUN_0056445f                   ; 0041fa63
        ;   XREF to: 0056445f (UNCONDITIONAL_CALL)  ; undefined FUN_0056445f()
    ADD ESP,0x8                         ; 0041fa68
    PUSH EAX                            ; 0041fa6b
    CALL FUN_00564486                   ; 0041fa6c
