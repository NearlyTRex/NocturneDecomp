...
section .text
    ...
    PUSH 0x6                            ; 004e3663
        ;   Label: caseD_3
    PUSH ESI                            ; 004e3665
    CALL FUN_004e2ac0                   ; 004e3666
        ;   XREF to: 004e2ac0 (UNCONDITIONAL_CALL)  ; undefined FUN_004e2ac0()
    ADD ESP,0x8                         ; 004e366b
    PUSH 0x6                            ; 004e366e
    PUSH ESI                            ; 004e3670
    MOV dword ptr [EBX],EAX             ; 004e3671
    CALL FUN_004e2ac0                   ; 004e3673
        ;   XREF to: 004e2ac0 (UNCONDITIONAL_CALL)  ; undefined FUN_004e2ac0()
