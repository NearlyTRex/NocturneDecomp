...
section .text
    ...
    POP EBX                             ; 00410aa7
    RET                                 ; 00410aa8
    MOV EDI,dword ptr [0x00765a98]      ; 00410aa9 | DAT_00765a98
        ;   Label: LAB_00410aa9
    PUSH EDI                            ; 00410aaf
    PUSH ESI                            ; 00410ab0
    CALL FUN_0040d890                   ; 00410ab1
