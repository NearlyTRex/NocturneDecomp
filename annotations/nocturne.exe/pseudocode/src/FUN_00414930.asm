...
section .text
    ...
    PUSH EDI                            ; 004149b4
        ;   Label: LAB_004149b4
    PUSH ESI                            ; 004149b5
    CALL FUN_004145f0                   ; 004149b6
        ;   XREF to: 004145f0 (UNCONDITIONAL_CALL)  ; undefined FUN_004145f0()
