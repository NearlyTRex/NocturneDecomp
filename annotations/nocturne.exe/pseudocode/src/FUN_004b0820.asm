...
;
; XREF[2]:
;   FUN_004a4170 at 004a4915
;   FUN_004d7fe0 at 004d861e
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004b0869
    INC ESI                             ; 004b086a
    CALL FUN_004af7c0                   ; 004b086b
        ;   XREF to: 004af7c0 (UNCONDITIONAL_CALL)  ; undefined FUN_004af7c0()
    ...
    PUSH EBX                            ; 004b08a5
    INC ESI                             ; 004b08a6
    CALL FUN_004af160                   ; 004b08a7
        ;   XREF to: 004af160 (UNCONDITIONAL_CALL)  ; undefined FUN_004af160()
