...
// Convention: unknown
// Signature: void FUN_00454750(int param_1,float param_2)
...

{
  ...
  *(uint *)(param_1 + 0x23a4) = *(uint *)(param_1 + 0x23a8);
  ...
  while (0.0 < local_20) {
    uVar6 = FUN_004e11c0(param_1 + 0x150,&local_20);
  ...
  *(float *)(param_1 + 0x2430) = param_2 * fVar3 * *(float *)(param_1 + 0xbc8c);
  ...
  if (iVar5 == 0) {
    ...
    case 3:
    case 4:
      FUN_00423ed0(local_e0);
      local_dc = (float)FUN_0040dda0(0x40e00000,0x41700000);
      local_ac = param_1;
      local_a8 = param_1;
      local_14 = local_dc;
      uVar6 = FUN_0055a8b0(local_98,&DAT_02dd1184,
                           *(int *)(param_1 + 0xbd28) * 0x30 + param_1 + 0xfd0,0x3f333333,local_e0);
      uVar6 = FUN_0040a240(param_1,local_8c,uVar6);
    ...
    case 7:
      if ((*(int *)(param_1 + 0xbc90) == 0) && (*(int *)(param_1 + 0xdc) == 0)) {
        uVar6 = FUN_0051d2a0(param_1 + 0x150,local_50,0);
        FUN_0040a240(param_1,local_44,uVar6);
