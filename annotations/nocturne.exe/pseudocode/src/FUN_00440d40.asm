...
section .text
    ...
    FXCH ST3                            ; 00440f5e
    CALL FUN_00563a30                   ; 00440f60
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FISTP dword ptr [EAX + 0x1a0]       ; 00440f65
    FLD float ptr [ESP + 0x10]          ; 00440f6b
    FMUL float ptr [ESP]                ; 00440f6f
    FXCH ST5                            ; 00440f72
    CALL FUN_00563a30                   ; 00440f74
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH ST6                            ; 00440f79
    CALL FUN_00563a30                   ; 00440f7b
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH ST2                            ; 00440f80
    CALL FUN_00563a30                   ; 00440f82
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH                                ; 00440f87
    CALL FUN_00563a30                   ; 00440f89
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH ST4                            ; 00440f8e
    CALL FUN_00563a30                   ; 00440f90
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH ST3                            ; 00440f95
    CALL FUN_00563a30                   ; 00440f97
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH ST5                            ; 00440f9c
    CALL FUN_00563a30                   ; 00440f9e
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH ST6                            ; 00440fa3
