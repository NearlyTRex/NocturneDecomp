...
// Convention: unknown
// Signature: void FUN_004d7bd0(undefined4 param_1,int *param_2,int *param_3)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_004d7bd0(uint param_1,int *param_2,int *param_3)

{
  ...
  pfVar1 = (float *)FUN_004d7480(param_1,local_48,&local_24);
  if (&local_24 != pfVar1) {
    local_24 = *pfVar1;
    local_20 = pfVar1[1];
    local_1c = pfVar1[2];
  }
  pfVar1 = (float *)FUN_004d7480(param_1,local_18,&local_54);
  if (&local_54 != pfVar1) {
    local_54 = *pfVar1;
    local_50 = pfVar1[1];
    local_4c = pfVar1[2];
