...
section .text
    ...
    PUSH EBX                            ; 004b4cd1
    CALL FUN_004e1890                   ; 004b4cd2
        ;   XREF to: 004e1890 (UNCONDITIONAL_CALL)  ; undefined FUN_004e1890()
    ADD ESP,0x4                         ; 004b4cd7
    PUSH EAX                            ; 004b4cda
    CALL FUN_004e10a0                   ; 004b4cdb
        ;   XREF to: 004e10a0 (UNCONDITIONAL_CALL)  ; undefined FUN_004e10a0()
