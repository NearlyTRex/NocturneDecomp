...
// Convention: unknown
// Signature: int FUN_004fbc00(undefined4 param_1)

#include "nocturne.h"

int FUN_004fbc00(uint param_1)

{
  int iVar1;
  
  iVar1 = FUN_004b46d0(param_1);
  *(byte ***)(iVar1 + 0x14c) = &PTR_FUN_005a1554;
  *(uint *)(iVar1 + 0x1fa3c) = 0;
  FUN_0051e0c0(iVar1 + 0x150,"scat.dfm");
  ...
  *(uint *)(iVar1 + 0x1fa54) = *(uint *)(iVar1 + 0x1fa58);
  FUN_0042a760(iVar1,0,1,"draw_stand2coatPocket",0);
  FUN_0042a760(iVar1,1,2,"draw_coatPocket2aimPistols",0);
  return iVar1;
}
