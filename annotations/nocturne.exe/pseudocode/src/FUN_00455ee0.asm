...
section .text
    ...
    PUSH EDI                            ; 00456083
    CALL FUN_0040c900                   ; 00456084
        ;   XREF to: 0040c900 (UNCONDITIONAL_CALL)  ; undefined FUN_0040c900()
    ADD ESP,0x8                         ; 00456089
    MOV EDI,dword ptr [0x005ae690]      ; 0045608c | DAT_005ae690
        ;   Label: LAB_0045608c
    ...
    PUSH EDI                            ; 004560a6
    CALL FUN_0040d110                   ; 004560a7
        ;   XREF to: 0040d110 (UNCONDITIONAL_CALL)  ; undefined FUN_0040d110()
    ADD ESP,0x8                         ; 004560ac
    CMP dword ptr [0x005ae690],0x6      ; 004560af | DAT_005ae690
        ;   Label: LAB_004560af
    ...
    PUSH EDI                            ; 004560c3
    CALL FUN_0040c900                   ; 004560c4
        ;   XREF to: 0040c900 (UNCONDITIONAL_CALL)  ; undefined FUN_0040c900()
    ADD ESP,0x8                         ; 004560c9
    CMP dword ptr [0x005ae690],0x8      ; 004560cc | DAT_005ae690
        ;   Label: LAB_004560cc
    ...
    PUSH EDI                            ; 004560e0
    CALL FUN_0040c900                   ; 004560e1
        ;   XREF to: 0040c900 (UNCONDITIONAL_CALL)  ; undefined FUN_0040c900()
    ADD ESP,0x8                         ; 004560e6
    CMP dword ptr [0x005ae690],0x9      ; 004560e9 | DAT_005ae690
        ;   Label: LAB_004560e9
    ...
    PUSH EDI                            ; 004560fd
    CALL FUN_0040c900                   ; 004560fe
        ;   XREF to: 0040c900 (UNCONDITIONAL_CALL)  ; undefined FUN_0040c900()
    ADD ESP,0x8                         ; 00456103
    CMP dword ptr [0x005ae690],0xa      ; 00456106 | DAT_005ae690
        ;   Label: LAB_00456106
    ...
    PUSH EDI                            ; 0045611a
    CALL FUN_0040c900                   ; 0045611b
        ;   XREF to: 0040c900 (UNCONDITIONAL_CALL)  ; undefined FUN_0040c900()
    ADD ESP,0x8                         ; 00456120
    CMP dword ptr [0x005ae690],0xb      ; 00456123 | DAT_005ae690
        ;   Label: LAB_00456123
