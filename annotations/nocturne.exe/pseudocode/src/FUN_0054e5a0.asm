...
;   undefined1* PTR_FUN_005a3c44 = 0054e7f0
...
section .text
    ...
    PUSH EAX                            ; 0054e5df
    CALL FUN_005644a7                   ; 0054e5e0
        ;   XREF to: 005644a7 (UNCONDITIONAL_CALL)  ; undefined FUN_005644a7()
    ADD ESP,0xc                         ; 0054e5e5
    ADD EAX,0x6e4                       ; 0054e5e8
    PUSH EAX                            ; 0054e5ed
    CALL FUN_0043b5d0                   ; 0054e5ee
    ...
    PUSH EAX                            ; 0054e607
    MOV dword ptr [EBX + 0x14c],0x5a3c44 ; 0054e608 | PTR_FUN_005a3c44
    CALL FUN_00454580                   ; 0054e612
