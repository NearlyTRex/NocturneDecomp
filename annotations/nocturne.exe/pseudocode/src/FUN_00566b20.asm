...
section .text
    ...
    MOV EDX,0x566af0                    ; 00566b2d | LAB_00566af0
    PUSH ECX                            ; 00566b32
    MOV ESI,dword ptr [ESP + 0x28]      ; 00566b33
    MOV dword ptr [ESP + 0xc],EAX       ; 00566b37
    PUSH ESI                            ; 00566b3b
    LEA EAX,[ESP + 0x8]                 ; 00566b3c
    MOV EBX,0x566b18                    ; 00566b40 | LAB_00566b18
    PUSH EAX                            ; 00566b45
    MOV dword ptr [ESP + 0xc],EDX       ; 00566b46 | LAB_00566af0
    MOV dword ptr [ESP + 0x10],EBX      ; 00566b4a | LAB_00566b18
