...
;
; XREF[2]:
;   crt_startup.cpp_InitializeWinAppRuntime_FUN_00567458 at 00567498
...
section .text
    ...
    PUSH EBX                            ; 0056ef60
        ;   Label: crt_init.c_ProcessInitTermHandlers_FUN_0056ef60
    PUSH ESI                            ; 0056ef61
    PUSH ES                             ; 0056ef62
    ...
    CALL crt_util.c_invokeRuntimeHandler_FUN_0056ef50 ; 0056efa2
