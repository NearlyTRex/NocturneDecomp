...
// Convention: __cdecl
// Signature: undefined4 __cdecl crt_io_c_getFileStat_FUN_00565dc0(LPCSTR param_1,int *param_2)

#include "nocturne.h"

uint __cdecl getFileStat(LPCSTR param_1,int *param_2)

{
  ...
  if ((*param_1 == '\0') || (iVar3 = FUN_00570870(param_1,&DAT_00598be4), iVar3 != 0)) {
    ...
    iVar3 = _fullpath(&cStack_228,param_1,0x104);
    if ((iVar3 != 0) &&
    ...
    *(byte *)(param_2 + 0xe) = 0;
    _strncpy((int)param_2 + 0x39,_Stack_368.cFileName,0xd);
    uVar4 = 0;
  }
  return uVar4;
}
