...
;
; XREF[2]:
;   engine_dosio.cpp_copyFileTimestamp_FUN_00456950 at 00456967
;   engine_dosio.cpp_findFileNormally_FUN_00456800 at 00456847
;
; *****************************************************************************

section .text

    JMP 0x0056c864                      ; 00565dc0
        ;   XREF to: 0056c864 (UNCONDITIONAL_JUMP)
        ;   Label: crt_io.c_getFileStat_FUN_00565dc0
