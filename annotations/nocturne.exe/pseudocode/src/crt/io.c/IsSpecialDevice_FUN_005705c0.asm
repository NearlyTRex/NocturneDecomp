...
section .text
    ...
    PUSH EBX                            ; 005705c0
        ;   Label: crt_io.c_IsSpecialDevice_FUN_005705c0
    MOV EBX,dword ptr [ESP + 0x8]       ; 005705c1
    PUSH EBX                            ; 005705c5
    CALL dword ptr [0x005c1ac0]         ; 005705c6 | PTR_crt_sync.c_CriticalSectionStub_FUN_005671e4_005c1ac0
    ...
    JZ 0x005705f8                       ; 005705e5
        ;   XREF to: 005705f8 (CONDITIONAL_JUMP)  ; LAB_005705f8
    PUSH EBX                            ; 005705e7
    CALL dword ptr [0x005c1ac4]         ; 005705e8 | PTR_crt_sync.c_CriticalSectionStub_FUN_005671e4_005c1ac4
    ...
    PUSH EBX                            ; 0057060d
    CALL dword ptr [0x005c1ac4]         ; 0057060e | PTR_crt_sync.c_CriticalSectionStub_FUN_005671e4_005c1ac4
    ...
    PUSH EBX                            ; 0057061e
        ;   Label: LAB_0057061e
    CALL dword ptr [0x005c1ac4]         ; 0057061f | PTR_crt_sync.c_CriticalSectionStub_FUN_005671e4_005c1ac4
