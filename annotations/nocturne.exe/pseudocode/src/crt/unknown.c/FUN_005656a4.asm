...
;                               FUNCTION
; *****************************************************************************
; int crt_unknown_c_FUN_005656a4(int param_1)
;
;
; XREF[1]:
...
section .text
    ...
    CALL dword ptr [0x005c1ad0]         ; 005656a9 | PTR_FUN_005c1ad0
    ...
    CALL dword ptr [0x005c1ad4]         ; 00565701 | PTR_FUN_005c1ad4
