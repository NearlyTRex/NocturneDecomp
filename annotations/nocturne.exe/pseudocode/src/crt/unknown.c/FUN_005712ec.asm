...
;
; XREF[1]:
;   crt_unknown.c_FUN_0056e664 at 0056e68a
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 005712ec
        ;   Label: crt_unknown.c_FUN_005712ec
    PUSH ESI                            ; 005712ed
    PUSH EDI                            ; 005712ee
    ...
    PUSH EDI                            ; 00571316
    CALL crt_memory.c_free_FUN_005638d0 ; 00571317
    ...
    CALL crt_memory.c_free_FUN_005638d0 ; 00571324
        ;   XREF to: 005638d0 (UNCONDITIONAL_CALL)  ; void crt_memory.c_free_FUN_005638d0(void * ptr)
