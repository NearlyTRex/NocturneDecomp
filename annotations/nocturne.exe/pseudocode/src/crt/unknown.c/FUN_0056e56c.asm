...
;   crt_unknown.c_FUN_0056e608 at 0056e61d
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0056e56c
        ;   Label: crt_unknown.c_FUN_0056e56c
    ...
    PUSH EDX                            ; 0056e57b
    PUSH 0x1                            ; 0056e57c
    CALL crt_memory.c_calloc_FUN_00565c50 ; 0056e57e
    ...
    PUSH EBX                            ; 0056e59c
        ;   Label: LAB_0056e59c
    CALL crt_unknown.c_FUN_005713a0     ; 0056e59d
        ;   XREF to: 005713a0 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_005713a0()
