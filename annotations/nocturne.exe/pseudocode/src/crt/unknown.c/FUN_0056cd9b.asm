...
section .text
    ...
    PUSH EBX                            ; 0056cd9b
        ;   Label: crt_unknown.c_FUN_0056cd9b
    PUSH ESI                            ; 0056cd9c
    PUSH EBP                            ; 0056cd9d
    ...
    PUSH ESI                            ; 0056cdfa
    CALL crt_unknown.c_FUN_00570ad0     ; 0056cdfb
        ;   XREF to: 00570ad0 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_00570ad0()
