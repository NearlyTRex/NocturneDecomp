...
;
; XREF[1]:
;   crt_unknown.c_FUN_0056e6e4 at 0056e7e5
;
; Referenced Globals:
...
;
; Called Functions:
;   crt_unknown.c_FUN_00571170
;   crt_unknown.c_FUN_005711a8
;   GetLastError
;   SetLastError
;   TlsGetValue
;
...
section .text
    ...
    PUSH EBX                            ; 0056e52c
        ;   Label: crt_unknown.c_FUN_0056e52c
    PUSH ESI                            ; 0056e52d
    ...
    CALL crt_unknown.c_FUN_00571170     ; 0056e54b
        ;   XREF to: 00571170 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_00571170()
    ...
    CALL crt_unknown.c_FUN_005711a8     ; 0056e558
        ;   XREF to: 005711a8 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_005711a8()
