...
;
; XREF[1]:
;   crt_unknown.c_FUN_00573ed0 at 00573f6a
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00573e30
        ;   Label: crt_unknown.c_FUN_00573e30
    PUSH ESI                            ; 00573e31
    PUSH EDI                            ; 00573e32
    PUSH ES                             ; 00573e33
    PUSH FS                             ; 00573e34
    ...
    CALL crt_unknown.c_FUN_0056e608     ; 00573e7e
    ...
    CALL crt_unknown.c_FUN_00572e88     ; 00573ebc
        ;   XREF to: 00572e88 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_00572e88()
