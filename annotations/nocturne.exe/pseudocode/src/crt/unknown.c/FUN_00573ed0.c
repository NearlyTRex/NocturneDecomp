// Name: crt_unknown.c_FUN_00573ed0
// Address: 00573ed0
// Address Range: [[00573ed0, 00573fc4]]
// Convention: unknown
// Signature: HANDLE crt_unknown_c_FUN_00573ed0(undefined4 param_1,int param_2,undefined4 param_3)
...

{
  ...
  (&uStack_48)[(uint)bVar2 * -2] = (&DAT_005992a8)[(uint)bVar2 * -2];
  acStack_44[(uint)bVar2 * -8 + (uint)bVar2 * -8] =
       (&DAT_005992ac)[(uint)bVar2 * -8 + (uint)bVar2 * -8];
  value = GetCurrentThreadId();
  IntegerToString(value,buffer,iVar1);
