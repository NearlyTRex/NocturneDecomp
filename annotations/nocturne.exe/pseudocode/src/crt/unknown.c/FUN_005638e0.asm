...
;                               FUNCTION
; *****************************************************************************
; void crt_unknown_c_FUN_005638e0(int *param_1)
;
;
; XREF[4]:
;   FUN_00568d58 at 00568df6
;   FUN_0056afe8 at 0056b190
;   crt_unknown.c_FUN_005638d0 at 005638d5
;   crt_unknown.c_FUN_00564a88 at 00564aab
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 005638e0
        ;   Label: crt_unknown.c_FUN_005638e0
    PUSH ESI                            ; 005638e1
    PUSH EDI                            ; 005638e2
    ...
    CALL dword ptr [0x005c1ad8]         ; 005638ef | PTR_FUN_005c1ad8
    ...
    CALL FUN_00568bb0                   ; 005639ad
        ;   XREF to: 00568bb0 (UNCONDITIONAL_CALL)  ; undefined FUN_00568bb0()
    ...
    CALL dword ptr [0x005c1ae0]         ; 005639dc | PTR_FUN_005c1ae0
        ;   Label: LAB_005639dc
    POP EDI                             ; 005639e2
        ;   Label: LAB_005639e2
    POP ESI                             ; 005639e3
