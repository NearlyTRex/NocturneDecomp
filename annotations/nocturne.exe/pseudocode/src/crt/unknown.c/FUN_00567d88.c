// Name: crt_unknown.c_FUN_00567d88
// Address: 00567d88
// Address Range: [[00567d88, 0056808a]]
// Convention: unknown
// Signature: int crt_unknown_c_FUN_00567d88(int param_1,int *param_2)
...
LAB_00567fbd:
  if ((0 < iVar11) && (iVar11 = iVar11 + local_24, (*(byte *)(param_1 + 0x10) & 1) != 0)) {
    *pcVar10 = '\0';
    ...
    if ((*(byte *)(param_1 + 0x10) & 0x10) == 0) {
      (*(code *)PTR_crt_unknown_c_FUN_0056f0f0_005c1f8c)(&local_80,&local_30);
      fVar7 = __BITCAST_FLOAT(CONCAT22(local_1c._2_2_,(ushort)local_1c));
    }
    else if (local_80 == '-') {
