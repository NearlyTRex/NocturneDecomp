...
section .text
    ...
    PUSH EBX                            ; 0057415e
    CALL crt_memory.c_free_FUN_005638d0 ; 0057415f
    ...
    CALL crt_memory.c_free_FUN_005638d0 ; 005741a3
        ;   XREF to: 005638d0 (UNCONDITIONAL_CALL)  ; void crt_memory.c_free_FUN_005638d0(void * ptr)
    ADD ESP,0x4                         ; 005741a8
    PUSH EBP                            ; 005741ab
    CALL crt_memory.c_free_FUN_005638d0 ; 005741ac
        ;   XREF to: 005638d0 (UNCONDITIONAL_CALL)  ; void crt_memory.c_free_FUN_005638d0(void * ptr)
    ...
    PUSH EBX                            ; 0057423a
    CALL crt_memory.c_free_FUN_005638d0 ; 0057423b
        ;   XREF to: 005638d0 (UNCONDITIONAL_CALL)  ; void crt_memory.c_free_FUN_005638d0(void * ptr)
