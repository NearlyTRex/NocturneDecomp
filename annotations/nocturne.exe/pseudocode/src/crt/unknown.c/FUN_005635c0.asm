...
;                               FUNCTION
; *****************************************************************************
; int crt_unknown_c_FUN_005635c0(uint param_1)
;
; Local Variables:
...
;   crt_unknown.c_FUN_00564a88 at 00564a99
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 005635c0
        ;   Label: crt_unknown.c_FUN_005635c0
    PUSH ESI                            ; 005635c1
    PUSH EDI                            ; 005635c2
    PUSH ES                             ; 005635c3
    PUSH FS                             ; 005635c4
    ...
    CALL dword ptr [0x005c1ad8]         ; 005635f6 | PTR_FUN_005c1ad8
        ;   Label: LAB_005635f6
    ...
    CALL FUN_00568b00                   ; 0056365b
        ;   XREF to: 00568b00 (UNCONDITIONAL_CALL)  ; undefined FUN_00568b00()
    ...
    PUSH EBP                            ; 00563681
    CALL FUN_00568e08                   ; 00563682
        ;   XREF to: 00568e08 (UNCONDITIONAL_CALL)  ; undefined FUN_00568e08()
    ...
    CALL dword ptr [0x005c1ae0]         ; 005636b8 | PTR_FUN_005c1ae0
