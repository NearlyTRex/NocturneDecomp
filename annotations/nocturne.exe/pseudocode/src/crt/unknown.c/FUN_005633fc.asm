...
;                               FUNCTION
; *****************************************************************************
; void crt_unknown_c_FUN_005633fc(char *param_1,uint param_2)
;
;
; XREF[2]:
;   FUN_00568690 at 005686ae
;   crt_unknown.c_FUN_005634b0 at 0056355e
;
; Called Functions:
;   crt_unknown.c_FUN_005633ec
;   FUN_00568680
;   FUN_005687bc
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 005633fc
        ;   Label: crt_unknown.c_FUN_005633fc
    PUSH ESI                            ; 005633fd
    PUSH EDI                            ; 005633fe
    PUSH EBP                            ; 005633ff
    MOV EBX,dword ptr [ESP + 0x14]      ; 00563400
    CALL FUN_00568680                   ; 00563404
        ;   XREF to: 00568680 (UNCONDITIONAL_CALL)  ; undefined FUN_00568680()
    MOV EBP,EAX                         ; 00563409
    SHR EBP,0x10                        ; 0056340b
    MOV EDI,EBX                         ; 0056340e
    OR EBP,EAX                          ; 00563410
    CALL FUN_005687bc                   ; 00563412
        ;   XREF to: 005687bc (UNCONDITIONAL_CALL)  ; undefined FUN_005687bc()
    ...
    CALL crt_unknown.c_FUN_005633ec     ; 00563458
        ;   XREF to: 005633ec (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_005633ec()
    ...
    CALL crt_unknown.c_FUN_005633ec     ; 00563476
        ;   XREF to: 005633ec (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_005633ec()
    ...
    PUSH EAX                            ; 00563488
    CALL crt_unknown.c_FUN_005633ec     ; 00563489
        ;   XREF to: 005633ec (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_005633ec()
