...
;   crt_unknown.c_FUN_005740b0 at 005741d4
;   crt_unknown.c_FUN_00574680 at 005746ca
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00574264
        ;   Label: crt_unknown.c_FUN_00574264
    PUSH ESI                            ; 00574265
    PUSH EDI                            ; 00574266
    PUSH EBP                            ; 00574267
    ...
    PUSH ECX                            ; 0057430f
    CALL crt_unknown.c_FUN_00574404     ; 00574310
        ;   XREF to: 00574404 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_00574404()
    ...
    PUSH EAX                            ; 00574373
    PUSH EDI                            ; 00574374
    CALL crt_unknown.c_FUN_00571410     ; 00574375
