...
;
; Called Functions:
;   crt_heap.c_GetBlockSize_FUN_0056afc0
...
section .text
    ...
    PUSH EBX                            ; 00564a88
        ;   Label: crt_unknown.c_realloc__FUN_00564a88
    PUSH ESI                            ; 00564a89
    PUSH EDI                            ; 00564a8a
    PUSH EBP                            ; 00564a8b
    ...
    PUSH EDI                            ; 00564a98
    CALL crt_unknown.c_InternalHeapAlloc_FUN_005635c0 ; 00564a99
    ...
    PUSH EBX                            ; 00564aaa
    CALL crt_unknown.c_ValidateHeapIntegrity_FUN_005638e0 ; 00564aab
    ...
    PUSH EBX                            ; 00564aba
        ;   Label: LAB_00564aba
    CALL crt_heap.c_GetBlockSize_FUN_0056afc0 ; 00564abb
        ;   XREF to: 0056afc0 (UNCONDITIONAL_CALL)  ; ulong crt_heap.c_GetBlockSize_FUN_0056afc0(void * ptr)
    ADD ESP,0x4                         ; 00564ac0
    PUSH EDI                            ; 00564ac3
    PUSH EBX                            ; 00564ac4
    MOV ESI,EAX                         ; 00564ac5
    CALL crt_heap.c_TryResizeInPlace_FUN_0056b1a4 ; 00564ac7
    ...
    PUSH EDI                            ; 00564ad5
    CALL crt_unknown.c_InternalHeapAlloc_FUN_005635c0 ; 00564ad6
        ;   XREF to: 005635c0 (UNCONDITIONAL_CALL)  ; void * crt_unknown.c_InternalHeapAlloc_FUN_005635c0(ulong size)
    ...
    POP ES                              ; 00564aff
    PUSH EBX                            ; 00564b00
    CALL crt_unknown.c_ValidateHeapIntegrity_FUN_005638e0 ; 00564b01
        ;   XREF to: 005638e0 (UNCONDITIONAL_CALL)  ; void crt_unknown.c_ValidateHeapIntegrity_FUN_005638e0(void * ptr)
    ...
    PUSH ESI                            ; 00564b0b
        ;   Label: LAB_00564b0b
    PUSH EBX                            ; 00564b0c
    CALL crt_heap.c_TryResizeInPlace_FUN_0056b1a4 ; 00564b0d
        ;   XREF to: 0056b1a4 (UNCONDITIONAL_CALL)  ; void * crt_heap.c_TryResizeInPlace_FUN_0056b1a4(void * ptr, ulong new_size)
