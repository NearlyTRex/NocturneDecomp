// Name: crt_unknown.c_FUN_005698b0
// Address: 005698b0
// Address Range: [[005698b0, 00569925]]
// Convention: unknown
// Signature: void crt_unknown_c_FUN_005698b0(ushort *param_1,undefined4 param_2,int param_3,code *param_4)
...

{
  ...
  do {
    ...
    uVar1 = *param_1;
    param_1 = param_1 + 1;
    iVar2 = WideCharToSingleByte((wchar_t)local_18,(char *)(uint)uVar1);
    if (iVar2 != -1) {
