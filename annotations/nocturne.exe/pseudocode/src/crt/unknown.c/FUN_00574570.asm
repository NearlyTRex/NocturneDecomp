...
;
; XREF[1]:
;   crt_unknown.c_FUN_005740b0 at 00574194
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00574570
        ;   Label: crt_unknown.c_FUN_00574570
    PUSH ESI                            ; 00574571
    PUSH EDI                            ; 00574572
    PUSH EBP                            ; 00574573
    ...
    MOV EDX,dword ptr [ESP + 0x14]      ; 00574595
        ;   Label: LAB_00574595
    PUSH EDX                            ; 00574599
    CALL crt_unknown.c_FUN_005713e0     ; 0057459a
    ...
    PUSH EBX                            ; 005745c4
    CALL crt_unknown.c_FUN_005713e0     ; 005745c5
        ;   XREF to: 005713e0 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_005713e0()
    ...
    JNZ 0x005745f1                      ; 005745df
        ;   XREF to: 005745f1 (CONDITIONAL_JUMP)  ; LAB_005745f1
    PUSH EDI                            ; 005745e1
    CALL crt_memory.c_free_FUN_005638d0 ; 005745e2
    ...
    PUSH EBP                            ; 00574605
    CALL crt_memory.c_free_FUN_005638d0 ; 00574606
        ;   XREF to: 005638d0 (UNCONDITIONAL_CALL)  ; void crt_memory.c_free_FUN_005638d0(void * ptr)
    ...
    PUSH EBX                            ; 00574612
    CALL crt_memory.c_free_FUN_005638d0 ; 00574613
        ;   XREF to: 005638d0 (UNCONDITIONAL_CALL)  ; void crt_memory.c_free_FUN_005638d0(void * ptr)
    ...
    JNZ 0x0057464a                      ; 00574638
        ;   XREF to: 0057464a (CONDITIONAL_JUMP)  ; LAB_0057464a
    PUSH EBX                            ; 0057463a
    CALL crt_memory.c_free_FUN_005638d0 ; 0057463b
        ;   XREF to: 005638d0 (UNCONDITIONAL_CALL)  ; void crt_memory.c_free_FUN_005638d0(void * ptr)
    ...
    CALL crt_memory.c_free_FUN_005638d0 ; 00574656
        ;   XREF to: 005638d0 (UNCONDITIONAL_CALL)  ; void crt_memory.c_free_FUN_005638d0(void * ptr)
    ...
    PUSH EBX                            ; 00574662
    CALL crt_memory.c_free_FUN_005638d0 ; 00574663
        ;   XREF to: 005638d0 (UNCONDITIONAL_CALL)  ; void crt_memory.c_free_FUN_005638d0(void * ptr)
