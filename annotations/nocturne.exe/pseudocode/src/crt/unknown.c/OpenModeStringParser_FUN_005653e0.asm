...
;   crt_unknown.c_fopenWithFlags_FUN_00565630 at 0056563e
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 005653e0
        ;   Label: crt_unknown.c_OpenModeStringParser_FUN_005653e0
    PUSH ESI                            ; 005653e1
    PUSH EDI                            ; 005653e2
    PUSH EBP                            ; 005653e3
    ...
    PUSH 0x9                            ; 00565432
        ;   Label: LAB_00565432
    CALL crt_errno.c_setErrno_FUN_00568e80 ; 00565434
