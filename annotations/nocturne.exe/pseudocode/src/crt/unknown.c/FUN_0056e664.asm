...
;
; XREF[2]:
;   crt_unknown.c_FUN_0056e6b8 at 0056e6ba
;   crt_unknown.c_FUN_00573fc8 at 00573fde
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0056e664
        ;   Label: crt_unknown.c_FUN_0056e664
    PUSH ESI                            ; 0056e665
    ...
    CALL crt_unknown.c_FUN_005712ec     ; 0056e68a
        ;   XREF to: 005712ec (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_005712ec()
