...
;                               FUNCTION
; *****************************************************************************
; uint crt_unknown_c_FUN_005634b0(int param_1,int param_2)
;
;
; XREF[2]:
;   crt_unknown.c_FUN_005633c4 at 005633cf
...
section .text
    ...
    PUSH EBX                            ; 005634b0
        ;   Label: crt_unknown.c_FUN_005634b0
    PUSH ESI                            ; 005634b1
    PUSH EDI                            ; 005634b2
    PUSH EBP                            ; 005634b3
    ...
    PUSH EAX                            ; 0056351d
    CALL FUN_00568a50                   ; 0056351e
        ;   XREF to: 00568a50 (UNCONDITIONAL_CALL)  ; undefined FUN_00568a50()
    ...
    PUSH EAX                            ; 0056355d
    CALL crt_unknown.c_FUN_005633fc     ; 0056355e
    ...
    MOV ECX,dword ptr [EBX + 0x10]      ; 00563571
        ;   Label: LAB_00563571
    PUSH ECX                            ; 00563574
    CALL dword ptr [0x005c1ac4]         ; 00563575 | PTR_FUN_005c1ac4
    ...
    PUSH EBP                            ; 0056358b
    CALL dword ptr [0x005c1acc]         ; 0056358c | PTR_FUN_005c1acc
