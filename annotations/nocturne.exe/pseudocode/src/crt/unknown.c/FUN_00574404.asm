...
;
; XREF[1]:
;   crt_unknown.c_FUN_00574264 at 00574310
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00574404
        ;   Label: crt_unknown.c_FUN_00574404
    PUSH ESI                            ; 00574405
    PUSH EDI                            ; 00574406
    PUSH EBP                            ; 00574407
    ...
    PUSH EAX                            ; 00574426
    CALL crt_unknown.c_FUN_005746f0     ; 00574427
        ;   XREF to: 005746f0 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_005746f0()
    MOV EDI,EAX                         ; 0057442c
    XOR EAX,EAX                         ; 0057442e
    ADD ESP,0x4                         ; 00574430
    MOV AX,word ptr [ESI]               ; 00574433
    PUSH EAX                            ; 00574436
    CALL crt_unknown.c_FUN_005746f0     ; 00574437
        ;   XREF to: 005746f0 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_005746f0()
    ...
    PUSH EDX                            ; 00574495
    CALL crt_memory.c_free_FUN_005638d0 ; 00574496
