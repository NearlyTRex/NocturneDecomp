...
;
; XREF[1]:
;   crt_unknown.c_FUN_0056a388 at 0056a690
;
; Called Functions:
;   crt_unknown.c_FUN_0056a6ad
;
; *****************************************************************************
...
section .text
    ...
    MOV ECX,0x2710                      ; 0056a697
        ;   Label: crt_unknown.c_FUN_0056a697
    ...
    PUSH EDX                            ; 0056a6a6
        ;   Label: LAB_0056a6a6
    CALL crt_unknown.c_FUN_0056a6ad     ; 0056a6a7
        ;   XREF to: 0056a6ad (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_0056a6ad()
    POP EAX                             ; 0056a6ac
