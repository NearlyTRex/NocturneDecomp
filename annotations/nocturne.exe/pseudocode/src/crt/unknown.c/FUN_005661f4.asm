...
;                               FUNCTION
; *****************************************************************************
; void crt_unknown_c_FUN_005661f4(undefined4 *param_1,undefined4 param_2,undefined4 param_3)
;
;
; XREF[1]:
...
section .text
    ...
    MOV EAX,dword ptr [ESP + 0x4]       ; 005661f4
        ;   Label: crt_unknown.c_FUN_005661f4
    ...
    PUSH EAX                            ; 00566210
    CALL crt_unknown.c_FUN_005661c2     ; 00566211
        ;   XREF to: 005661c2 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_005661c2()
