...
;
; XREF[1]:
;   crt_unknown.c_FUN_00570f60 at 00571039
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00572b70
        ;   Label: crt_unknown.c_FUN_00572b70
    PUSH ESI                            ; 00572b71
    PUSH EDI                            ; 00572b72
    PUSH EBP                            ; 00572b73
    ...
    CALL crt_unknown.c_FUN_0056e09c     ; 00572c7d
        ;   XREF to: 0056e09c (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_0056e09c()
    ADD ESP,0x8                         ; 00572c82
    PUSH EBX                            ; 00572c85
    PUSH EBP                            ; 00572c86
    LEA ESI,[EDI + 0x1]                 ; 00572c87
    CALL crt_unknown.c_FUN_0056f278     ; 00572c8a
