...
;
; XREF[2]:
;   crt_unknown.c_FUN_0056e608 at 0056e633
;   crt_unknown.c_FUN_0056e6e4 at 0056e7cf
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00571280
        ;   Label: crt_unknown.c_FUN_00571280
    PUSH ESI                            ; 00571281
    PUSH EDI                            ; 00571282
    ...
    PUSH ESI                            ; 00571294
    CALL crt_memory.c_calloc_FUN_00565c50 ; 00571295
    ...
    PUSH EDI                            ; 005712a3
    CALL crt_unknown.c_FUN_00572e90     ; 005712a4
        ;   XREF to: 00572e90 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_00572e90()
    ADD ESP,0x4                         ; 005712a9
    TEST EAX,EAX                        ; 005712ac
    JZ 0x005712bd                       ; 005712ae
        ;   XREF to: 005712bd (CONDITIONAL_JUMP)  ; LAB_005712bd
    PUSH EBX                            ; 005712b0
    CALL crt_memory.c_free_FUN_005638d0 ; 005712b1
