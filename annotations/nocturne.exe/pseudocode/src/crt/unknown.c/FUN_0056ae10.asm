...
section .text
    ...
    PUSH EBX                            ; 0056ae10
        ;   Label: crt_unknown.c_FUN_0056ae10
    PUSH ESI                            ; 0056ae11
    PUSH EDI                            ; 0056ae12
    PUSH EBP                            ; 0056ae13
    ...
    PUSH ESI                            ; 0056ae9e
    PUSH EBX                            ; 0056ae9f
    CALL crt_unknown.c_FUN_00569040     ; 0056aea0
        ;   XREF to: 00569040 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_00569040()
    ...
    CALL crt_unknown.c_FUN_00568890     ; 0056aebf
