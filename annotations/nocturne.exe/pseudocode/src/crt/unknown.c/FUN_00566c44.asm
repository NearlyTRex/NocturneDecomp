...
;                               FUNCTION
; *****************************************************************************
; undefined4 crt_unknown_c_FUN_00566c44(undefined4 param_1)
;
;
; XREF[1]:
...
section .text
    ...
    PUSH EBX                            ; 00566c44
        ;   Label: crt_unknown.c_FUN_00566c44
    ...
    PUSH EBX                            ; 00566c56
    CALL crt_unknown.c_FUN_00566ba0     ; 00566c57
        ;   XREF to: 00566ba0 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_00566ba0()
