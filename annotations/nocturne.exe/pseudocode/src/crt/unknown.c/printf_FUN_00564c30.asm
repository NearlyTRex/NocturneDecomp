...
;                               FUNCTION
; *****************************************************************************
; int __cdecl crt_unknown_c_printf_FUN_00564c30(char *format)
;
; Parameters:
...
;
; XREF[1]:
;   cockpit_ckptutil.c_loadEdgeListFile_FUN_0042eb90 at 0042ed8f
;
; Referenced Globals:
...
section .text
    ...
    SUB ESP,0x4                         ; 00564c30
        ;   Label: crt_unknown.c_printf_FUN_00564c30
