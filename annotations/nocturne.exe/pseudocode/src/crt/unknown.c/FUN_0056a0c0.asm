...
section .text
    ...
    OR ECX,ECX                          ; 0056a0c0
        ;   Label: crt_unknown.c_FUN_0056a0c0
    ...
    CALL crt_unknown.c_FUN_0056a0f7     ; 0056a0d7
        ;   XREF to: 0056a0f7 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_0056a0f7()
    POP ECX                             ; 0056a0dc
