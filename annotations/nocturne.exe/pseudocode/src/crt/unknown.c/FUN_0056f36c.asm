...
;
; XREF[1]:
;   crt_unknown.c_FUN_0056f2d0 at 0056f2f3
;
; Referenced Globals:
;   undefined4 DAT_005c1680
;
; Called Functions:
;   crt_unknown.c_FUN_0056f30c
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 0056f36c
        ;   Label: crt_unknown.c_FUN_0056f36c
    PUSH ESI                            ; 0056f36d
    MOV EAX,dword ptr [ESP + 0xc]       ; 0056f36e
    PUSH EAX                            ; 0056f372
    MOV ESI,dword ptr [EAX + 0x4]       ; 0056f373
    MOV EBX,dword ptr [EAX + 0x8]       ; 0056f376
    CALL crt_unknown.c_FUN_0056f30c     ; 0056f379
        ;   XREF to: 0056f30c (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_0056f30c()
