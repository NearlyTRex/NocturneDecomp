...
;   undefined1* PTR_crt_unknown.c_FUN_00570eb0_005c4094 = 00570eb0
...
section .text
    ...
    PUSH EAX                            ; 00570d50
        ;   Label: crt_unknown.c_FUN_00570d50
    PUSH ECX                            ; 00570d51
    PUSH EDX                            ; 00570d52
    ...
    FADDP                               ; 00570ea7
    JMP dword ptr [EDX*0x4 + 0x5c4094]  ; 00570ea9 | PTR_crt_unknown.c_FUN_00570eb0_005c4094
