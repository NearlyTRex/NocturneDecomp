// Name: crt_unknown.c_FUN_00571718
// Address: 00571718
// Address Range: [[00571718, 005717a4]]
// Convention: unknown
// Signature: SIGNAL_HANDLER_TYPE crt_unknown_c_FUN_00571718(int param_1,int param_2)
...

{
  ...
  if ((0 < param_1) && (param_1 < 0xd)) {
    PTR_crt_unknown_c_reportAbnormalTermination_FUN_00566f98_005c1890 = &UNK_005716cc;
