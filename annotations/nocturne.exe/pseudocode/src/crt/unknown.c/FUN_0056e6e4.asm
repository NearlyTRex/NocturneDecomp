...
;
; XREF[1]:
;   crt_unknown.c_FUN_00573ed0 at 00573ef2
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0056e6e4
        ;   Label: crt_unknown.c_FUN_0056e6e4
    PUSH ESI                            ; 0056e6e5
    PUSH EDI                            ; 0056e6e6
    PUSH EBP                            ; 0056e6e7
    ...
    MOV dword ptr [0x005c1f60],EBX      ; 0056e75d | PTR_crt_unknown.c_FUN_0056e250_005c1f60
    MOV dword ptr [0x005c1f64],ECX      ; 0056e763 | PTR_crt_unknown.c_FUN_0056e250_005c1f64
    MOV dword ptr [0x005c1f68],ESI      ; 0056e769 | PTR_crt_unknown.c_FUN_0056e250_005c1f68
    ...
    CALL crt_unknown.c_FUN_0056e254     ; 0056e79a
    ...
    CALL crt_unknown.c_FUN_00571280     ; 0056e7cf
