...
section .text
    ...
    PUSH EBX                            ; 005632c8
        ;   Label: crt_unknown.c_FUN_005632c8
    PUSH ESI                            ; 005632c9
    PUSH EDI                            ; 005632ca
    PUSH EBP                            ; 005632cb
    ...
    PUSH EDX                            ; 005632d6
    CALL dword ptr [0x005c1ac0]         ; 005632d7 | PTR_FUN_005c1ac0
    ...
    PUSH EDI                            ; 005632f2
    CALL dword ptr [0x005c1ac4]         ; 005632f3 | PTR_FUN_005c1ac4
    ...
    CALL dword ptr [0x005c1ac4]         ; 0056333a | PTR_FUN_005c1ac4
