...
;                               FUNCTION
; *****************************************************************************
; undefined4 * crt_unknown_c_FUN_00564a88(undefined4 *param_1,int param_2)
;
;
; XREF[1]:
...
section .text
    ...
    PUSH EBX                            ; 00564a88
        ;   Label: crt_unknown.c_FUN_00564a88
    PUSH ESI                            ; 00564a89
    PUSH EDI                            ; 00564a8a
    PUSH EBP                            ; 00564a8b
    ...
    PUSH EDI                            ; 00564a98
    CALL crt_unknown.c_FUN_005635c0     ; 00564a99
    ...
    PUSH EBX                            ; 00564aaa
    CALL crt_unknown.c_FUN_005638e0     ; 00564aab
    ...
    PUSH EDI                            ; 00564ad5
    CALL crt_unknown.c_FUN_005635c0     ; 00564ad6
        ;   XREF to: 005635c0 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_005635c0()
    ...
    POP ES                              ; 00564aff
    PUSH EBX                            ; 00564b00
    CALL crt_unknown.c_FUN_005638e0     ; 00564b01
        ;   XREF to: 005638e0 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_005638e0()
