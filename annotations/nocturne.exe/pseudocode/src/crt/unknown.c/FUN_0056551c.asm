...
;                               FUNCTION
; *****************************************************************************
; int crt_unknown_c_FUN_0056551c(undefined4 param_1,undefined1 param_2,uint param_3,undefined4 param_4,undefined4 param_5,int param_6)
;
;
; XREF[2]:
;   crt_stdio.c_freopen_FUN_00565724 at 00565798
;   crt_unknown.c_FUN_00565630 at 00565676
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 0056551c
        ;   Label: crt_unknown.c_FUN_0056551c
    PUSH ESI                            ; 0056551d
    PUSH EDI                            ; 0056551e
    PUSH EBP                            ; 0056551f
