...
;
; XREF[1]:
;   crt_unknown.c_FUN_005710a0 at 005710f3
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 00572d90
        ;   Label: crt_unknown.c_FUN_00572d90
    PUSH ESI                            ; 00572d91
    ...
    PUSH EAX                            ; 00572db1
    CALL crt_unknown.c_FUN_00573db0     ; 00572db2
        ;   XREF to: 00573db0 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_00573db0()
    ...
    PUSH EAX                            ; 00572dd8
    PUSH EBX                            ; 00572dd9
    CALL crt_unknown.c_FUN_00572d50     ; 00572dda
