...
section .text
    ...
    PUSH EAX                            ; 0056c520
        ;   Label: crt_unknown.c_FUN_0056c520
    ...
    CALL crt_unknown.c_FUN_0056c416     ; 0056c53e
        ;   XREF to: 0056c416 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_0056c416()
    POP EAX                             ; 0056c543
    RET 0x8                             ; 0056c544
    FXCH                                ; 0056c547
        ;   Label: LAB_0056c547
    ...
    CALL crt_unknown.c_FUN_0056c416     ; 0056c553
        ;   XREF to: 0056c416 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_0056c416()
