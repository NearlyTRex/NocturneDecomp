...
section .text
    ...
    PUSH EBX                            ; 0056e890
        ;   Label: crt_unknown.c_FUN_0056e890
    PUSH ESI                            ; 0056e891
    PUSH EDI                            ; 0056e892
    PUSH EBP                            ; 0056e893
    ...
    PUSH EBX                            ; 0056e8e9
    CALL crt_memory.c_free_FUN_005638d0 ; 0056e8ea
    ...
    CALL crt_memory.c_free_FUN_005638d0 ; 0056e90c
        ;   XREF to: 005638d0 (UNCONDITIONAL_CALL)  ; void crt_memory.c_free_FUN_005638d0(void * ptr)
    ...
    CALL crt_unknown.c_FUN_005713e0     ; 0056e927
