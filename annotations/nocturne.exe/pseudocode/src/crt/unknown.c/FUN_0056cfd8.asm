...
section .text
    ...
    PUSH EBX                            ; 0056cfd8
        ;   Label: crt_unknown.c_FUN_0056cfd8
    PUSH ESI                            ; 0056cfd9
    PUSH EBP                            ; 0056cfda
    ...
    PUSH EBP                            ; 0056d008
    PUSH EAX                            ; 0056d009
    CALL crt_unknown.c_FUN_0056ced8     ; 0056d00a
        ;   XREF to: 0056ced8 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_0056ced8()
    ADD ESP,0x8                         ; 0056d00f
    PUSH EBP                            ; 0056d012
    PUSH ESI                            ; 0056d013
    MOV EBX,EAX                         ; 0056d014
    CALL crt_unknown.c_FUN_0056ced8     ; 0056d016
        ;   XREF to: 0056ced8 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_0056ced8()
