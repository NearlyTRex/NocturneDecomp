...
;   crt_unknown.c_FUN_0056e7fc at 0056e840
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0056f2d0
        ;   Label: crt_unknown.c_FUN_0056f2d0
    PUSH ESI                            ; 0056f2d1
    ...
    PUSH EAX                            ; 0056f2f2
    CALL crt_unknown.c_FUN_0056f36c     ; 0056f2f3
        ;   XREF to: 0056f36c (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_0056f36c()
