...
section .text
    ...
    NOP                                 ; 0056d4ab
        ;   Label: crt_unknown.c_FUN_0056d4ab
    ...
    PUSH EDX                            ; 0056d4ba
    CALL crt_unknown.c_FUN_0056d488     ; 0056d4bb
        ;   XREF to: 0056d488 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_0056d488()
