...
;   crt_unknown.c_FUN_0056e5ac
;   crt_unknown.c_FUN_0056e6e4
;   GetCurrentThread
;   GetCurrentThreadId
;   WaitForSingleObject
;
...
section .text
    ...
    PUSH EBX                            ; 00573ed0
        ;   Label: crt_unknown.c_FUN_00573ed0
    PUSH ESI                            ; 00573ed1
    PUSH EDI                            ; 00573ed2
    PUSH ES                             ; 00573ed3
    PUSH EBP                            ; 00573ed4
    ...
    CALL crt_unknown.c_FUN_0056e5ac     ; 00573ee5
        ;   XREF to: 0056e5ac (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_0056e5ac()
    TEST EAX,EAX                        ; 00573eea
    JZ 0x00573fbc                       ; 00573eec
        ;   XREF to: 00573fbc (CONDITIONAL_JUMP)  ; LAB_00573fbc
    CALL crt_unknown.c_FUN_0056e6e4     ; 00573ef2
        ;   XREF to: 0056e6e4 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_0056e6e4()
