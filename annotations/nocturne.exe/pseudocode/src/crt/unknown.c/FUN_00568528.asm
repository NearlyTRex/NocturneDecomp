...
;
; XREF[3]:
;   crt_unknown.c_FUN_00567a5c at 00567b6b
;   crt_unknown.c_FUN_00567d88 at 00567df5
;   crt_unknown.c_FUN_0056808c at 00568126
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 00568528
        ;   Label: crt_unknown.c_FUN_00568528
    ...
    PUSH EBX                            ; 0056853a
    CALL crt_unknown.c_FUN_00567540     ; 0056853b
