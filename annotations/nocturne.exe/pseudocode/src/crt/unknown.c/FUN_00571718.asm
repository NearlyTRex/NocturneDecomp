...
section .text
    ...
    PUSH EBX                            ; 00571718
        ;   Label: crt_unknown.c_FUN_00571718
    PUSH ESI                            ; 00571719
    PUSH EDI                            ; 0057171a
    ...
    JZ 0x00571775                       ; 00571752
        ;   XREF to: 00571775 (CONDITIONAL_JUMP)  ; LAB_00571775
    PUSH EBX                            ; 00571754
    CALL crt_unknown.c_FUN_00571588     ; 00571755
    ...
    PUSH 0x9f                           ; 00571766
    PUSH 0x0                            ; 0057176b
    CALL crt_unknown.c_FUN_00572ef0     ; 0057176d
        ;   XREF to: 00572ef0 (UNCONDITIONAL_CALL)  ; undefined crt_unknown.c_FUN_00572ef0()
    ...
    CALL crt_unknown.c_FUN_00571630     ; 0057178a
