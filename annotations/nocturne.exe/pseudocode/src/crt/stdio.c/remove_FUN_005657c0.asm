...
;
; Called Functions:
;   crt_unknown.c_remove_FUN_0056bbf0
;
; *****************************************************************************
...
section .text
    ...
    PUSH EDX                            ; 005657c4
    CALL crt_unknown.c_remove_FUN_0056bbf0 ; 005657c5
        ;   XREF to: 0056bbf0 (UNCONDITIONAL_CALL)  ; int crt_unknown.c_remove_FUN_0056bbf0(char * filename)
