...
;   crt_unknown.c_GetConsoleInputHandle_FUN_005714e0
;   GetConsoleMode
;   SetConsoleMode
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 0056fb98
        ;   Label: crt_stdio.c_DrainConsoleInputAndSetup_FUN_0056fb98
    PUSH ESI                            ; 0056fb99
    ...
    CALL crt_unknown.c_GetConsoleInputHandle_FUN_005714e0 ; 0056fbdb
        ;   XREF to: 005714e0 (UNCONDITIONAL_CALL)  ; HANDLE crt_unknown.c_GetConsoleInputHandle_FUN_005714e0()
    ...
    PUSH EBX                            ; 0056fbf7
    CALL crt_stdio.c_DrainConsoleInputWithBuffering_FUN_0056fa80 ; 0056fbf8
        ;   XREF to: 0056fa80 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_DrainConsoleInputWithBuffering_FUN_0056fa80(HANDLE hConsoleInput)
    ...
    PUSH 0x0                            ; 0056fc0e
    CALL dword ptr [0x005c1ac4]         ; 0056fc10 | PTR_crt_sync.c_CriticalSectionStub_FUN_005671e4_005c1ac4
