...
;
; XREF[1]:
;   crt_unknown.c_fopenWithFlags_FUN_00565630 at 0056564e
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00568560
        ;   Label: crt_stdio.c___allocfp_FUN_00568560
    PUSH ESI                            ; 00568561
    PUSH EDI                            ; 00568562
    CALL dword ptr [0x005c1ad0]         ; 00568563 | PTR_crt_sync.c_CriticalSectionStub_FUN_005671e4_005c1ad0
    ...
    CALL dword ptr [0x005c1ad4]         ; 005685fc | PTR_crt_sync.c_CriticalSectionStub_FUN_005671e4_005c1ad4
    ...
    PUSH 0x5                            ; 00568608
        ;   Label: LAB_00568608
    CALL crt_errno.c_setErrno_FUN_00568e80 ; 0056860a
        ;   XREF to: 00568e80 (UNCONDITIONAL_CALL)  ; void crt_errno.c_setErrno_FUN_00568e80(int error_code)
    ADD ESP,0x4                         ; 0056860f
    CALL dword ptr [0x005c1ad4]         ; 00568612 | PTR_crt_sync.c_CriticalSectionStub_FUN_005671e4_005c1ad4
