...
;
; XREF[2]:
;   crt_math.c_print_error_message_FUN_005729e8 at 005729ee
;   crt_stdio.c_prepare_stream_for_write_FUN_0056b35c at 0056b39c
;
; Referenced Globals:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x4]       ; 0056fdf0
        ;   Label: crt_stdio.c_get_standard_file_handle_FUN_0056fdf0
