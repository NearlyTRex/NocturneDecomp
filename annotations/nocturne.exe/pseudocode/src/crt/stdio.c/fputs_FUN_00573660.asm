...
;
; XREF[1]:
;   crt_math.c_print_error_message_FUN_005729e8 at 00572a04
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00573660
        ;   Label: crt_stdio.c_fputs_FUN_00573660
    PUSH ESI                            ; 00573661
    PUSH EDI                            ; 00573662
    PUSH EBP                            ; 00573663
    ...
    PUSH EDX                            ; 00573672
    CALL dword ptr [0x005c1ac0]         ; 00573673 | PTR_crt_sync.c_CriticalSectionStub_FUN_005671e4_005c1ac0
    ...
    MOV EBP,dword ptr [ESI + 0x10]      ; 005736fc
        ;   Label: LAB_005736fc
    PUSH EBP                            ; 005736ff
    CALL dword ptr [0x005c1ac4]         ; 00573700 | PTR_crt_sync.c_CriticalSectionStub_FUN_005671e4_005c1ac4
