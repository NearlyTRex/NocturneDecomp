...
;
; XREF[1]:
;   crt_iostream.cpp_istream_get_FUN_00564c53 at 00564cd6
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 0056b2b4
        ;   Label: crt_stdio.c_fgetcInternal_FUN_0056b2b4
    PUSH ESI                            ; 0056b2b5
    ...
    PUSH EAX                            ; 0056b312
    CALL crt_stdio.c_reportStreamError_FUN_0056b327 ; 0056b313
