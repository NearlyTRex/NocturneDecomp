...
;   crt_strstream.cpp_strstreambase_destructor_thunk_FUN_0056b491 at 0056b4a0
;
; Referenced Globals:
...
;   crt_strstream.cpp_strstreambuf_dtor_FUN_005701cf
...
section .text
    ...
    PUSH EBX                            ; 0056b5ad
        ;   Label: crt_strstream.cpp_strstreambase_dtor_FUN_0056b5ad
    ...
    MOV dword ptr [EBX + 0x44],0x5a48bc ; 0056b5c8 | PTR_crt_strstream.cpp_strstreambase_dtor_FUN_0056b5ad_005a48bc
    ADD EBX,0x4                         ; 0056b5cf
    MOV EAX,dword ptr [EAX + 0x4]       ; 0056b5d2
    PUSH EBX                            ; 0056b5d5
    MOV dword ptr [EBX + EAX*0x1 + 0x24],0x5a48c4 ; 0056b5d6 | PTR_crt_strstream.cpp_strstreambase_destructor_thunk_FUN_0056b491_005a48c4
    ...
    POP EBX                             ; 0056b5fb
    RET                                 ; 0056b5fc
    PUSH 0x5a4980                       ; 0056b5fd | g_strstreambaseTypeInfo_005a4980
        ;   Label: LAB_0056b5fd
    PUSH EBX                            ; 0056b602
    ...
    PUSH EBX                            ; 0056b61d
    CALL crt_iostream.cpp_ios_dtor_FUN_0056b633 ; 0056b61e
    ...
    PUSH EBX                            ; 0056b62b
        ;   Label: LAB_0056b62b
    CALL crt_memory.c_operator_delete_FUN_00564494 ; 0056b62c
