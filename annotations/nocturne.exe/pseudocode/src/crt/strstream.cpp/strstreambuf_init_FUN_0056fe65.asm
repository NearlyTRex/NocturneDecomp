...
;   crt_strstream.cpp_strstreambuf_ctor_FUN_00570248 at 00570266
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 0056fe65
        ;   Label: crt_strstream.cpp_strstreambuf_init_FUN_0056fe65
    PUSH ESI                            ; 0056fe66
    PUSH EDI                            ; 0056fe67
    PUSH EBP                            ; 0056fe68
    ...
    PUSH ESI                            ; 0056feae
    PUSH EBX                            ; 0056feaf
    CALL crt_iostream.cpp_setBuffer_FUN_00571df8 ; 0056feb0
