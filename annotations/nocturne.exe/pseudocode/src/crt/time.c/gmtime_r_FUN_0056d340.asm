...
section .text
    ...
    PUSH EBX                            ; 0056d340
        ;   Label: crt_time.c_gmtime_r_FUN_0056d340
    PUSH ESI                            ; 0056d341
    PUSH EDI                            ; 0056d342
    PUSH EBP                            ; 0056d343
    ...
    LEA EAX,[ESI + 0x76c]               ; 0056d3f1
        ;   Label: LAB_0056d3f1
    PUSH EAX                            ; 0056d3f7
    CALL crt_time.c_is_leap_year_FUN_0056cea0 ; 0056d3f8
    ...
    CALL crt_time.c_is_leap_year_FUN_0056cea0 ; 0056d426
        ;   XREF to: 0056cea0 (UNCONDITIONAL_CALL)  ; int crt_time.c_is_leap_year_FUN_0056cea0(int year)
