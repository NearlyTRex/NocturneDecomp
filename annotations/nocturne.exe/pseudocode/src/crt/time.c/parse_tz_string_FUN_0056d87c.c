...

{
  ...
  _DAT_005c1f18 = 0;
  pcVar1 = parse_timezone_spec(tz_string,&DAT_005c1e08,&DAT_005c1f14);
  if (*pcVar1 == '\0') {
    DAT_005c1e89 = 0;
  }
  else {
    ...
    _DAT_005c1f18 = 1;
    pcVar1 = parse_timezone_spec(pcVar1,&DAT_005c1e89,&local_14);
    DAT_005c1f1c = DAT_005c1f14 - local_14;
    if (*pcVar1 == ',') {
      pcVar1 = parse_dst_rule(pcVar1 + 1,(dst_rule *)&DAT_005c1dc0);
    }
    if (*pcVar1 == ',') {
      parse_dst_rule(pcVar1 + 1,(dst_rule *)&DAT_005c1de4);
