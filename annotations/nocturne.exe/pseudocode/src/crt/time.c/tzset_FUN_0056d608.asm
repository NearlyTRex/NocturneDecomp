...
;   crt_unknown.c_localtime_r_FUN_00566590 at 00566596
;
; Referenced Globals:
...
;   crt_time.c_parse_tz_string_FUN_0056d87c
...
section .text
    ...
    CALL crt_string.c_wcstombs_FUN_00570bd0 ; 0056d5b0
    ...
    CALL crt_string.c_wcstombs_FUN_00570bd0 ; 0056d5de
        ;   XREF to: 00570bd0 (UNCONDITIONAL_CALL)  ; int crt_string.c_wcstombs_FUN_00570bd0(char * dest, wchar_t * src, SIZE_T dest_size)
    ...
    PUSH 0x598be8                       ; 0056d608 | = "TZ"
        ;   Label: crt_time.c_tzset_FUN_0056d608
    ...
    PUSH EAX                            ; 0056d61d
    CALL crt_time.c_parse_tz_string_FUN_0056d87c ; 0056d61e
        ;   XREF to: 0056d87c (UNCONDITIONAL_CALL)  ; void crt_time.c_parse_tz_string_FUN_0056d87c(char * tz_string)
