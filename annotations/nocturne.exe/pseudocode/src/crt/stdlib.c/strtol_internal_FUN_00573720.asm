...
;
; XREF[1]:
;   crt_stdlib.c_strtol_FUN_005738ac at 005738be
;
; Called Functions:
;   crt_errno.c_setErrno_FUN_00568e80
;   crt_stdlib.c_charToDigit_FUN_005738c8
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 00573720
        ;   Label: crt_stdlib.c_strtol_internal_FUN_00573720
    PUSH ESI                            ; 00573721
    PUSH EDI                            ; 00573722
    PUSH EBP                            ; 00573723
    ...
    PUSH 0xd                            ; 00573799
        ;   Label: LAB_00573799
    CALL crt_errno.c_setErrno_FUN_00568e80 ; 0057379b
    ...
    PUSH EAX                            ; 005737da
    CALL crt_stdlib.c_charToDigit_FUN_005738c8 ; 005737db
        ;   XREF to: 005738c8 (UNCONDITIONAL_CALL)  ; int crt_stdlib.c_charToDigit_FUN_005738c8(char ch)
    ...
    PUSH 0xe                            ; 0057383c
        ;   Label: LAB_0057383c
    CALL crt_errno.c_setErrno_FUN_00568e80 ; 0057383e
        ;   XREF to: 00568e80 (UNCONDITIONAL_CALL)  ; void crt_errno.c_setErrno_FUN_00568e80(int error_code)
