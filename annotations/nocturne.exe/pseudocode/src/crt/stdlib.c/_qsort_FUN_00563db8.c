...
// Convention: __cdecl
// Signature: void __cdecl crt_stdlib_c__qsort_FUN_00563db8(undefined4 *param_1,uint param_2,uint param_3,code *param_4)

#include "nocturne.h"

/* WARNING: Removing unreachable block (ram,0x005640b2) */

void __cdecl _qsort(uint *param_1,uint param_2,uint param_3,code *param_4)
