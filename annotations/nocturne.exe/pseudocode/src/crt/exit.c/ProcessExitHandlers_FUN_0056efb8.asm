...
;
; XREF[2]:
;   crt_exit.c_ExitProcess_FUN_005674b0 at 005674e0
;   crt_startup.c_ExitApplication_FUN_0056fcd4 at 0056fced
;
; Referenced Globals:
...
;
; Called Functions:
;   crt_util.c_invokeRuntimeHandler_FUN_0056ef50
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 0056efb8
        ;   Label: crt_exit.c_ProcessExitHandlers_FUN_0056efb8
    PUSH ESI                            ; 0056efb9
    PUSH ES                             ; 0056efba
    ...
    CALL crt_util.c_invokeRuntimeHandler_FUN_0056ef50 ; 0056f007
        ;   XREF to: 0056ef50 (UNCONDITIONAL_CALL)  ; void crt_util.c_invokeRuntimeHandler_FUN_0056ef50(RUNTIME_HANDLER_FUNC * * ppHandler)
