...
;
; XREF[1]:
;   crt_exception.c_installExceptionHandler_FUN_0056eed8 at 0056ef16
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0056ead4
        ;   Label: crt_exception.c_TopLevelExceptionFilter_FUN_0056ead4
    PUSH ESI                            ; 0056ead5
    PUSH EDI                            ; 0056ead6
    PUSH EBP                            ; 0056ead7
    ...
    CALL crt_windows.c_has_active_window_FUN_0056ea40 ; 0056eaea
        ;   XREF to: 0056ea40 (UNCONDITIONAL_CALL)  ; BOOL crt_windows.c_has_active_window_FUN_0056ea40()
    ...
    PUSH EAX                            ; 0056ec15
    CALL crt_exception.c_FormatHexString_FUN_0056ea78 ; 0056ec16
        ;   XREF to: 0056ea78 (UNCONDITIONAL_CALL)  ; void crt_exception.c_FormatHexString_FUN_0056ea78(char * dest, char * format, DWORD value)
    ...
    PUSH EAX                            ; 0056ec2b
    CALL crt_exception.c_FormatHexString_FUN_0056ea78 ; 0056ec2c
        ;   XREF to: 0056ea78 (UNCONDITIONAL_CALL)  ; void crt_exception.c_FormatHexString_FUN_0056ea78(char * dest, char * format, DWORD value)
    ...
    PUSH EAX                            ; 0056ec86
    CALL crt_exception.c_FormatHexString_FUN_0056ea78 ; 0056ec87
        ;   XREF to: 0056ea78 (UNCONDITIONAL_CALL)  ; void crt_exception.c_FormatHexString_FUN_0056ea78(char * dest, char * format, DWORD value)
    ...
    LEA EAX,[ESP + 0x8]                 ; 0056ec98
        ;   Label: LAB_0056ec98
    PUSH EAX                            ; 0056ec9c
    CALL crt_exception.c_FormatHexString_FUN_0056ea78 ; 0056ec9d
        ;   XREF to: 0056ea78 (UNCONDITIONAL_CALL)  ; void crt_exception.c_FormatHexString_FUN_0056ea78(char * dest, char * format, DWORD value)
