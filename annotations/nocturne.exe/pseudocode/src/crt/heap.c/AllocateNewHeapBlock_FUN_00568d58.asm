...
;
; XREF[1]:
;   crt_heap.c_SystemAllocWrapper_FUN_00568e08 at 00568e12
;
; Referenced Globals:
...
;
; Called Functions:
;   crt_heap.c_CalculateHeapBlockSize_FUN_00568e1c
;   crt_heap.c_InsertHeapBlockInOrder_FUN_00568ce0
...
section .text
    ...
    PUSH EBX                            ; 00568d58
        ;   Label: crt_heap.c_AllocateNewHeapBlock_FUN_00568d58
    PUSH ESI                            ; 00568d59
    PUSH EDI                            ; 00568d5a
    ...
    LEA EAX,[ESP + 0x10]                ; 00568d79
        ;   Label: LAB_00568d79
    PUSH EAX                            ; 00568d7d
    CALL crt_heap.c_CalculateHeapBlockSize_FUN_00568e1c ; 00568d7e
        ;   XREF to: 00568e1c (UNCONDITIONAL_CALL)  ; int crt_heap.c_CalculateHeapBlockSize_FUN_00568e1c(uint * pSize)
    ...
    CALL crt_unknown.c_ValidateHeapIntegrity_FUN_005638e0 ; 00568df6
