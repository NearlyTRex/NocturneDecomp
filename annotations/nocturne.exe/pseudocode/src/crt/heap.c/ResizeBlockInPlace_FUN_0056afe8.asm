...
;
; XREF[1]:
;   crt_heap.c_TryResizeInPlace_FUN_0056b1a4 at 0056b1c8
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0056afe8
        ;   Label: crt_heap.c_ResizeBlockInPlace_FUN_0056afe8
    PUSH ESI                            ; 0056afe9
    PUSH EDI                            ; 0056afea
    PUSH EBP                            ; 0056afeb
    ...
    PUSH EAX                            ; 0056b18f
    CALL crt_unknown.c_ValidateHeapIntegrity_FUN_005638e0 ; 0056b190
