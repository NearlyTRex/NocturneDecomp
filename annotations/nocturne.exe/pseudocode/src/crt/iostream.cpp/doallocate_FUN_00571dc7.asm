...
;   crt_unknown.c_streambuf_allocBuffer_FUN_00571ee0
;
; *****************************************************************************
...
section .text
    ...
    CALL crt_unknown.c_streambuf_allocBuffer_FUN_00571ee0 ; 00571dcc
        ;   XREF to: 00571ee0 (UNCONDITIONAL_CALL)  ; void * crt_unknown.c_streambuf_allocBuffer_FUN_00571ee0(uint size)
