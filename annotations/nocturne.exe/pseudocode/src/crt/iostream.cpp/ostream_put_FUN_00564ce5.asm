...
;
; XREF[4]:
;   support_codec.cpp_CCodec_process_FUN_00438f90 at 00438fec
;   support_codec.cpp_CLZWDictionary_writeCodeSequence_FUN_00439760 at 00439797
;   support_codec.cpp_flushBitBuffer_FUN_00438d60 at 00438d79
;   support_codec.cpp_writeBitsToStream_FUN_00438c40 at 00438c61
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 00564ce5
        ;   Label: crt_iostream.cpp_ostream_put_FUN_00564ce5
    PUSH ESI                            ; 00564ce6
    ...
    PUSH EAX                            ; 00564d4c
    CALL crt_stdio.c_reportStreamError_FUN_0056b327 ; 00564d4d
    ...
    PUSH EAX                            ; 00564d6b
        ;   Label: LAB_00564d6b
    CALL crt_stdio.c_prepare_stream_for_write_FUN_0056b35c ; 00564d6c
    ...
    PUSH EBX                            ; 00564d87
        ;   Label: LAB_00564d87
    CALL crt_stdio.c_stream_flush_FUN_0056b3c2 ; 00564d88
