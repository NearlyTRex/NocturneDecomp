...
;   crt_iostream.cpp_ostream_destructor_thunk_FUN_0056b4eb at 0056b4fa
...
;   void* PTR_crt_iostream.cpp_ostream_destructor_thunk_FUN_0056b4eb_005a491c = 0056b4eb
...
section .text
    ...
    MOV dword ptr [EBX + EAX*0x1 + 0x28],0x5a491c ; 0056b55f | PTR_crt_iostream.cpp_ostream_destructor_thunk_FUN_0056b4eb_005a491c
    ...
    PUSH EBX                            ; 0056b5a5
        ;   Label: LAB_0056b5a5
    CALL crt_memory.c_operator_delete_FUN_00564494 ; 0056b5a6
