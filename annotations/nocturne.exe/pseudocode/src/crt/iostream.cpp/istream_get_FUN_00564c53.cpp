...
// Convention: __cdecl
// Signature: int * __cdecl crt_iostream_cpp_istream_get_FUN_00564c53(int *param_1,undefined1 *param_2)

#include "nocturne.h"

int * __cdecl crt_iostream_cpp_istream_get_FUN_00564c53(int *param_1,byte *param_2)
