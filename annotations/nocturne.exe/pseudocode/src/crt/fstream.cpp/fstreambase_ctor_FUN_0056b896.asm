...
section .text
    ...
    MOV dword ptr [EBX + EAX*0x1 + 0x28],0x5a4a2c ; 0056b8c8 | PTR_crt_fstream.cpp_fstream_destructor_thunk_from_ios_FUN_0056b7f8_005a4a2c
    ...
    POP EBX                             ; 0056b8e6
    RET                                 ; 0056b8e7
    MOV dword ptr [EBX],0x5a4a18        ; 0056b8e8 | g_WatcomVirtualBaseDescriptor_005a4a18
        ;   Label: LAB_0056b8e8
