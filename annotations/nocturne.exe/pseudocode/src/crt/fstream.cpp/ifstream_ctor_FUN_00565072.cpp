...

{
  ...
  if ((ctor_flags & 1U) == 0) {
    ...
    *(byte **)((int)this_ptr + 0x44) = &DAT_005a47ac;
    piVar4 = crt_iostream_cpp_ios_ctor_FUN_0056b503((ios *)((int)this_ptr + 0x54));
  ...
  p_Var2 = crt_iostream_cpp_istream_ctor_FUN_0056b67d((_istream *)(extraout_EAX + 0x44),1);
  ppvVar3 = &p_Var2[-2]._ios.__i_lock;
  *(int *)((int)ppvVar3 + *(int *)((int)*ppvVar3 + 4) + -4) = *(int *)((int)*ppvVar3 + 4);
  p_Var2[-1]._ios.cleanup_vtable = &PTR_crt_fstream_cpp_ifstream_dtor_FUN_00565264_005a47b8;
  pvVar1 = *ppvVar3;
  (p_Var2->_istream_core).destructor_vtable =
       (WatcomThunkedDestructor *)&PTR_crt_unknown_c_FUN_005650f0_005a47c0;
  *(byte ***)(*(int *)((int)pvVar1 + 4) + 0x28 + (int)ppvVar3) =
