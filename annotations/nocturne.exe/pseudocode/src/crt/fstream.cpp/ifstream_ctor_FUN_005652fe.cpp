...
// Convention: __cdecl
// Signature: void __cdecl crt_fstream_cpp_ifstream_ctor_FUN_005652fe(undefined4 *param_1,byte param_2)

#include "nocturne.h"

void __cdecl crt_fstream_cpp_ifstream_ctor_FUN_005652fe(uint *param_1,byte param_2)
