...
section .text
    ...
    PUSH EBX                            ; 00571fd1
        ;   Label: crt_fstream.cpp_filebuf_overflow_FUN_00571fd1
    PUSH ESI                            ; 00571fd2
    PUSH EDI                            ; 00571fd3
    PUSH EBP                            ; 00571fd4
    ...
    PUSH EAX                            ; 0057205a
    CALL crt_io.c_write_FUN_0057301c    ; 0057205b
    ...
    PUSH EAX                            ; 005720bb
    CALL crt_io.c_write_FUN_0057301c    ; 005720bc
        ;   XREF to: 0057301c (UNCONDITIONAL_CALL)  ; int crt_io.c_write_FUN_0057301c(int fd, void * buffer, SIZE_T count)
    ...
    MOV EAX,dword ptr [EBX + 0x2c]      ; 0057211a
        ;   Label: LAB_0057211a
    PUSH EAX                            ; 0057211d
    CALL crt_io.c_tell_FUN_0056bc10     ; 0057211e
    ...
    PUSH EAX                            ; 00572133
    CALL crt_stdio.c_lseek_FUN_005689c0 ; 00572134
    ...
    PUSH EAX                            ; 005721ba
    CALL crt_stdio.c_lseek_FUN_005689c0 ; 005721bb
        ;   XREF to: 005689c0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_lseek_FUN_005689c0(int file_handle_index, long distance_to_move, int move_method)
