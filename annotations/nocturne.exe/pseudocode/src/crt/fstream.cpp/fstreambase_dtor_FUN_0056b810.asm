...
;
; XREF[3]:
;   crt_fstream.cpp_fstream_destructor_thunk_from_ios_FUN_0056b7f8 at 0056b807
...
section .text
    ...
    PUSH EBX                            ; 0056b838
    MOV dword ptr [EBX + EAX*0x1 + 0x24],0x5a4a2c ; 0056b839 | PTR_crt_fstream.cpp_fstream_destructor_thunk_from_ios_FUN_0056b7f8_005a4a2c
    ...
    PUSH EBX                            ; 0056b88e
        ;   Label: LAB_0056b88e
    CALL crt_memory.c_operator_delete_FUN_00564494 ; 0056b88f
