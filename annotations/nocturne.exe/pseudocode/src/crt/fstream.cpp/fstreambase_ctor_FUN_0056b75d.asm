...
section .text
    ...
    PUSH EBX                            ; 0056b75d
        ;   Label: crt_fstream.cpp_fstreambase_ctor_FUN_0056b75d
    PUSH ESI                            ; 0056b75e
    PUSH EDI                            ; 0056b75f
    ...
    ADD EBX,0x4                         ; 0056b780
        ;   Label: LAB_0056b780
    PUSH EBX                            ; 0056b783
    CALL crt_fstream.cpp_filebuf_ctor_FUN_0057042d ; 0056b784
    ...
    PUSH EAX                            ; 0056b7b9
    CALL crt_iostream.cpp_streambuf_initBuffer_FUN_0056ff2a ; 0056b7ba
    ...
    PUSH EAX                            ; 0056b7ed
    CALL crt_stdio.c_reportStreamError_FUN_0056b327 ; 0056b7ee
