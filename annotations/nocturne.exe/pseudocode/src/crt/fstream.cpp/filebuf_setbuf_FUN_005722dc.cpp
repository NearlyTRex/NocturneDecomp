...
// Signature: streambuf * __watcallStack crt_fstream_cpp_filebuf_setbuf_FUN_005722dc(filebuf *this_ptr,char *buffer_ptr,int buffer_size)
...

{
  ...
  if ((buffer_ptr == (char *)0x0) || (buffer_size < 1)) {
    ...
    if (buffer_size < 5) {
      crt_iostream_cpp_setBuffer_FUN_00571df8(&this_ptr->_streambuf,(void *)0x0,(void *)0x0,0);
      return (streambuf *)0x0;
    }
    buffer_end = buffer_ptr + buffer_size;
  }
  crt_iostream_cpp_setBuffer_FUN_00571df8(&this_ptr->_streambuf,buffer_ptr,buffer_end,0);
