...
// Convention: __cdecl
// Signature: void __cdecl crt_fstream_cpp_ofstream_ctor_FUN_0056536a(undefined4 *param_1,byte param_2)

#include "nocturne.h"

void __cdecl crt_fstream_cpp_ofstream_ctor_FUN_0056536a(uint *param_1,byte param_2)
