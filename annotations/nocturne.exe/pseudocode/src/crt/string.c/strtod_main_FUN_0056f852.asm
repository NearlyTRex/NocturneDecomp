...
;
; XREF[1]:
;   crt_unknown.c__strtod_FUN_0056a189 at 0056a195
;
; Referenced Globals:
...
;   crt_string.c_parseFloatString_FUN_0056f690
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBP                            ; 0056f852
        ;   Label: crt_string.c_strtod_main_FUN_0056f852
    ...
    CALL crt_math.c_set_range_error_errno_FUN_00568e9c ; 0056f892
    ...
    CALL crt_math.c_set_range_error_errno_FUN_00568e9c ; 0056f8ca
        ;   XREF to: 00568e9c (UNCONDITIONAL_CALL)  ; void crt_math.c_set_range_error_errno_FUN_00568e9c()
    ...
    JNZ 0x0056f92d                      ; 0056f926
        ;   XREF to: 0056f92d (CONDITIONAL_JUMP)  ; LAB_0056f92d
    CALL crt_math.c_set_range_error_errno_FUN_00568e9c ; 0056f928
        ;   XREF to: 00568e9c (UNCONDITIONAL_CALL)  ; void crt_math.c_set_range_error_errno_FUN_00568e9c()
        ;   Label: LAB_0056f928
