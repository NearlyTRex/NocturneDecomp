...
section .text
    ...
    PUSH EBX                            ; 0056dcd0
        ;   Label: crt_string.c__mbstrnicmp_FUN_0056dcd0
    PUSH ESI                            ; 0056dcd1
    PUSH EDI                            ; 0056dcd2
    PUSH EBP                            ; 0056dcd3
    ...
    PUSH ESI                            ; 0056dce6
        ;   Label: LAB_0056dce6
    CALL crt_string.c_mbstring_termination_check_FUN_00570ca0 ; 0056dce7
    ...
    JNZ 0x0056dd2b                      ; 0056dcf1
        ;   XREF to: 0056dd2b (CONDITIONAL_JUMP)  ; LAB_0056dd2b
    PUSH EBX                            ; 0056dcf3
    CALL crt_string.c_mbstring_termination_check_FUN_00570ca0 ; 0056dcf4
        ;   XREF to: 00570ca0 (UNCONDITIONAL_CALL)  ; int crt_string.c_mbstring_termination_check_FUN_00570ca0(char * str)
    ...
    PUSH ESI                            ; 0056dd2f
    CALL crt_string.c_mbstring_termination_check_FUN_00570ca0 ; 0056dd30
        ;   XREF to: 00570ca0 (UNCONDITIONAL_CALL)  ; int crt_string.c_mbstring_termination_check_FUN_00570ca0(char * str)
    ...
    PUSH EBX                            ; 0056dd3c
    CALL crt_string.c_mbstring_termination_check_FUN_00570ca0 ; 0056dd3d
        ;   XREF to: 00570ca0 (UNCONDITIONAL_CALL)  ; int crt_string.c_mbstring_termination_check_FUN_00570ca0(char * str)
