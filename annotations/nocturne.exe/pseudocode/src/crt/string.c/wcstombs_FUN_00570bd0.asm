...
section .text
    ...
    PUSH EBX                            ; 00570bd0
        ;   Label: crt_string.c_wcstombs_FUN_00570bd0
    PUSH ESI                            ; 00570bd1
    PUSH EDI                            ; 00570bd2
    PUSH EBP                            ; 00570bd3
    ...
    PUSH EAX                            ; 00570c06
    CALL crt_stdio.c_WideCharToSingleByte_FUN_0056f3a0 ; 00570c07
    ...
    PUSH EAX                            ; 00570c72
    CALL crt_stdio.c_WideCharToSingleByte_FUN_0056f3a0 ; 00570c73
        ;   XREF to: 0056f3a0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_WideCharToSingleByte_FUN_0056f3a0(wchar_t wide_char, char * output_buffer)
