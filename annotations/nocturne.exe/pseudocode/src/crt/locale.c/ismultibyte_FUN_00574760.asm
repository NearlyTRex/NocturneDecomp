...
;
; XREF[1]:
;   crt_locale.c_islower_multibyte_FUN_00574710 at 00574716
;
; Referenced Globals:
;   undefined4 DAT_02de5c30
;
; Called Functions:
;   crt_locale.c_istrailbyte_FUN_005747b0
;
; *****************************************************************************
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x4]       ; 00574760
        ;   Label: crt_locale.c_ismultibyte_FUN_00574760
    ...
    PUSH EAX                            ; 0057478d
    CALL crt_locale.c_istrailbyte_FUN_005747b0 ; 0057478e
        ;   XREF to: 005747b0 (UNCONDITIONAL_CALL)  ; int crt_locale.c_istrailbyte_FUN_005747b0(uchar byte_value)
