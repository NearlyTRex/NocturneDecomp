...
// Convention: unknown
// Signature: void FUN_00413800(int param_1,float param_2)
...

{
  ...
  *(uint *)(param_1 + 0x23a4) = *(uint *)(param_1 + 0x23a8);
  ...
  while (0.0 < local_3c) {
    uVar7 = FUN_004e11c0(param_1 + 0x150,&local_3c);
    FUN_0042add0(param_1,uVar7);
  }
  fVar2 = (float)_DAT_00578c7f;
  iVar3 = param_1 + 0x150;
  ...
  if (iVar5 == 0) {
    ...
    case 0:
      ...
      if (*(int *)(param_1 + 0xbca4) == 0) {
        ...
        iVar3 = FUN_0040dea0(0x3e800000);
        if ((iVar3 != 0) &&
           (iVar3 = FUN_0040d7e0(*(uint *)(param_1 + 0xbca4),"CHero"), iVar3 != 0)) {
          iVar4 = 0;
          iVar3 = 0;
          while ((iVar3 < *(int *)(0x01E57284 + 0x150bf4) &&
                 ((iVar5 = FUN_0040d890(*(uint *)(iVar4 + 0x150bf8 + 0x01E57284),
                                        DAT_00764670), iVar5 == 0 || (*(int *)(iVar5 + 0xbdc0) == 0)
                  )))) {
            iVar3 = iVar3 + 1;
            iVar4 = iVar4 + 4;
          }
        ...
        if (SQRT(local_c0 * local_c0 + local_c8 * local_c8 + local_c4 * local_c4) < 0x40600000) {
          FUN_0054e4a0(local_80,&local_c8);
          local_14 = (float)FUN_0040df00(local_7c - *(float *)(param_1 + 0x34));
          if (ABS(local_14) < (float)_DAT_00578c87) {
            FUN_004e16b0(param_1 + 0x150,3,1);
          }
        }
        FUN_00413780(param_1);
      }
      break;
    case 1:
    case 2:
      ...
      if (*(int *)(param_1 + 0xbca4) == 0) {
        ...
        *(uint *)(param_1 + 0x23a4) = *(uint *)(param_1 + 0x23a8);
        ...
        iVar4 = FUN_004247f0(param_1,*(int *)(param_1 + 0xbca4) + 0x20,uVar7);
        if (-1 < iVar4) {
          ...
          if ((local_38 <= local_2c) && (*(float *)(param_1 + 0xbca0) <= 0.0)) {
            ...
            FUN_0054e4a0(local_98,&local_5c);
            local_14 = (float)FUN_0040df00(local_94 - *(float *)(param_1 + 0x34));
            if (ABS(local_14) < (float)_DAT_00578c87) {
              FUN_004e16b0(iVar3,3,1);
              *(uint *)(param_1 + 0xbca0) = 0x3f800000;
              iVar3 = FUN_00526c50(*(uint *)(param_1 + 0xbdd8));
              if ((iVar3 == 0) &&
                 (iVar3 = FUN_00526c50(*(uint *)(param_1 + 0xbddc)), iVar3 == 0)) {
      ...
      break;
    case 3:
      FUN_00423ed0(local_188);
      local_184 = (float)FUN_0040dda0(0x40e00000,0x41700000);
      local_154 = param_1;
      local_150 = param_1;
      local_14 = local_184;
      uVar7 = FUN_0055a8b0(local_104,&DAT_02dd1184,DAT_00764610 * 0x30 + param_1 + 0xfd0,0x3ecccccd,
                           local_188);
      uVar7 = FUN_0040a240(param_1,local_f8,uVar7);
      FUN_004798e0(param_1,uVar7);
      break;
    case 8:
      if ((*(int *)(param_1 + 0xbc90) == 0) && (*(int *)(param_1 + 0xdc) == 0)) {
        uVar7 = FUN_0051d2a0(iVar3,local_ec,0);
        FUN_0040a240(param_1,local_74,uVar7);
    ...
    case 9:
      (**(code **)(*(int *)(param_1 + 0x14c) + 0x13c))(param_1,param_2);
      if ((*(int *)(param_1 + 0xbca4) != 0) ||
         (iVar3 = FUN_0047dc30(0x01C03A10,param_1 + 0xbd24), iVar3 != 0)) {
        FUN_004e16b0(param_1 + 0x150,0xb,1);
        iVar3 = FUN_00526c50(*(uint *)(param_1 + 0xbdd8));
        if ((iVar3 == 0) &&
           ((iVar3 = FUN_00526c50(*(uint *)(param_1 + 0xbddc)), iVar3 == 0 &&
            (iVar3 = FUN_00526c50(*(uint *)(param_1 + 0xbdd4)), iVar3 == 0)))) {
          uVar7 = (**(code **)(*(int *)(param_1 + 0x14c) + 0x24))
    ...
    case 0xd:
      ...
      case 1:
        ...
        *(float *)(param_1 + 0xbdc4) = fVar2;
        ...
        local_b8 = 0x40400000;
        local_b4 = 0;
        local_20 = FUN_0051e0a0(param_1 + 0x150);
        if (0 < *(int *)(local_20 + 0x28558)) {
          do {
            uVar7 = FUN_0051d380(param_1 + 0x150,local_11c,iVar3);
            FUN_0040a240(param_1,local_14c,uVar7);
            FUN_0048afe0(0x01C08D04,local_14c,0x3f000000,&local_bc,0xffff);
            iVar3 = iVar3 + 1;
        ...
        for (local_18 = 0; fVar2 = 0x3F800000, local_18 < *(int *)(0x01E57284 + 0x14ecb0);
          ...
          if (((iVar3 != 0) && (iVar3 != param_1)) &&
            ...
            if (SQRT(local_48 * local_48 + local_50 * local_50 + local_4c * local_4c) <
                (float)_DAT_00578c97) goto switchD_00413d82_default;
          }
          local_1c = local_1c + 4;
        }
        if (local_30 != 0) {
          ...
          *(uint *)(param_1 + 0x28) = *(uint *)(param_1 + 0xbdd0);
          ...
          if (iVar3 != 0) {
            ...
            puVar6 = (uint *)FUN_0054e4a0(local_b0,&local_a4);
      ...
      case 3:
        ...
        local_64 = 0x40400000;
        local_60 = 0;
        local_24 = FUN_0051e0a0(iVar3);
        if (0 < *(int *)(local_24 + 0x28558)) {
          do {
            uVar7 = FUN_0051d380(iVar3,local_128,iVar4);
            FUN_0040a240(param_1,local_134,uVar7);
            FUN_0048afe0(0x01C08D04,local_134,0x3f000000,&local_68,0xffff);
            iVar4 = iVar4 + 1;
...
LAB_00413a93:
    ...
    FUN_004e16b0(param_1 + 0x150,uVar7,1);
  }
  else {
...
switchD_00413d82_default:
  ...
  if ((iVar3 != 0) && (local_28 != 9)) {
    *(float *)(param_1 + 0x2424) = *(float *)(param_1 + 0x2424) - param_2 * (float)_DAT_00578c8f;
