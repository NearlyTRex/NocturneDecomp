...
// Convention: unknown
// Signature: undefined4 FUN_00434210(uint param_1,int *param_2)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_00434210(uint param_1,int *param_2)

{
  ...
  if (_DAT_01c02594 != 0) {
    ...
    wincore_windll_cpp_drawPolygon2_FUN_00532650(&DAT_00767274,param_1,_DAT_01c039a0);
    return 1;
  }
