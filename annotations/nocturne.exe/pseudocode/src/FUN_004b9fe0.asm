...
;   string s_%s_confused_while_walking_to_scr_00586116
;   string s_icepick-miss?.wav_00586140
;   undefined4 DAT_00586152
;   undefined4 DAT_0058615a
;   undefined4 DAT_00586162
;   undefined4 DAT_0058616a
;   undefined4 DAT_00586172
;   undefined4 DAT_0058617a
;   undefined4 DAT_00586182
...
section .text
    ...
    FLD ST0                             ; 004ba02d
    FMUL double ptr [0x00586152]        ; 004ba02f | DAT_00586152
    ...
    PUSH dword ptr [EBP + 0x18]         ; 004ba302
        ;   Label: LAB_004ba302
    PUSH EBX                            ; 004ba305
    CALL FUN_004baba0                   ; 004ba306
        ;   XREF to: 004baba0 (UNCONDITIONAL_CALL)  ; undefined FUN_004baba0()
    ...
    MOV EDX,dword ptr [0x02ddf9a8]      ; 004ba417 | DAT_02ddf9a8
    PUSH EDX                            ; 004ba41d
    MOV ECX,dword ptr [EBX + 0x24f0]    ; 004ba41e
    PUSH ECX                            ; 004ba424
    CALL FUN_0040d890                   ; 004ba425
        ;   XREF to: 0040d890 (UNCONDITIONAL_CALL)  ; undefined FUN_0040d890()
    ...
    JZ 0x004ba0e6                       ; 004ba4a2
        ;   XREF to: 004ba0e6 (CONDITIONAL_JUMP)  ; LAB_004ba0e6
    PUSH EBX                            ; 004ba4a8
    CALL FUN_004ba8a0                   ; 004ba4a9
        ;   XREF to: 004ba8a0 (UNCONDITIONAL_CALL)  ; undefined FUN_004ba8a0()
    ADD ESP,0x4                         ; 004ba4ae
    TEST EAX,EAX                        ; 004ba4b1
    JNZ 0x004ba0e6                      ; 004ba4b3
        ;   XREF to: 004ba0e6 (CONDITIONAL_JUMP)  ; LAB_004ba0e6
    PUSH EBX                            ; 004ba4b9
    CALL FUN_004baa00                   ; 004ba4ba
        ;   XREF to: 004baa00 (UNCONDITIONAL_CALL)  ; undefined FUN_004baa00()
    ...
    FMUL double ptr [0x0058615a]        ; 004ba681 | DAT_0058615a
