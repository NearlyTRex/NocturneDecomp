...
;
; XREF[6]:
;   FUN_004e9a90 at 004e9c50
;   FUN_004e9e90 at 004ea0fa
;   FUN_004ea370 at 004ea502
;   FUN_004eb520 at 004eb9ce
;   FUN_004ed2d0 at 004ed3a1
;   FUN_004ed720 at 004ed772
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004ea7ac
    CALL FUN_00549010                   ; 004ea7ad
        ;   XREF to: 00549010 (UNCONDITIONAL_CALL)  ; undefined FUN_00549010()
    ...
    PUSH EAX                            ; 004ea7c8
    PUSH ESI                            ; 004ea7c9
    CALL FUN_004ea830                   ; 004ea7ca
        ;   XREF to: 004ea830 (UNCONDITIONAL_CALL)  ; undefined FUN_004ea830()
    ADD ESP,0xc                         ; 004ea7cf
    JMP 0x004ea781                      ; 004ea7d2
        ;   XREF to: 004ea781 (UNCONDITIONAL_JUMP)  ; LAB_004ea781
    PUSH ESI                            ; 004ea7d4
        ;   Label: LAB_004ea7d4
    CALL FUN_004ec180                   ; 004ea7d5
        ;   XREF to: 004ec180 (UNCONDITIONAL_CALL)  ; undefined FUN_004ec180()
