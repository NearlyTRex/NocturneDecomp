...
section .text
    ...
    PUSH EAX                            ; 0050616b
    PUSH EBX                            ; 0050616c
    CALL FUN_0040a240                   ; 0050616d
        ;   XREF to: 0040a240 (UNCONDITIONAL_CALL)  ; undefined FUN_0040a240()
    ADD ESP,0xc                         ; 00506172
    PUSH EAX                            ; 00506175
    PUSH EBX                            ; 00506176
    CALL FUN_004798e0                   ; 00506177
    ...
    PUSH EAX                            ; 005061df
    PUSH EBX                            ; 005061e0
    CALL FUN_0040a240                   ; 005061e1
        ;   XREF to: 0040a240 (UNCONDITIONAL_CALL)  ; undefined FUN_0040a240()
    ADD ESP,0xc                         ; 005061e6
    PUSH EAX                            ; 005061e9
    PUSH EBX                            ; 005061ea
    CALL FUN_004798e0                   ; 005061eb
        ;   XREF to: 004798e0 (UNCONDITIONAL_CALL)  ; undefined FUN_004798e0()
