...
section .text
    ...
    PUSH ESI                            ; 0051db3f
    PUSH EBX                            ; 0051db40
    CALL FUN_0051e020                   ; 0051db41
        ;   XREF to: 0051e020 (UNCONDITIONAL_CALL)  ; undefined FUN_0051e020()
    ADD ESP,0x4                         ; 0051db46
    PUSH EAX                            ; 0051db49
    CALL FUN_00518470                   ; 0051db4a
        ;   XREF to: 00518470 (UNCONDITIONAL_CALL)  ; undefined FUN_00518470()
