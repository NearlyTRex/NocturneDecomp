...
// Convention: unknown
// Signature: undefined8 FUN_0042d370(undefined4 param_1,byte *param_2,uint param_3,int param_4)

#include "nocturne.h"

ulonglong FUN_0042d370(uint param_1,byte *param_2,uint param_3,int param_4)
