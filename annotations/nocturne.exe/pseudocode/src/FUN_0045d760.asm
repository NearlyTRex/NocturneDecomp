...
;
; XREF[2]:
;   FUN_0045da30 at 0045da4c
;   FUN_0045e000 at 0045e024
;
; Referenced Globals:
...
section .text
    ...
    CALL FUN_00491150                   ; 0045d804
        ;   XREF to: 00491150 (UNCONDITIONAL_CALL)  ; undefined FUN_00491150()
    ...
    PUSH EDI                            ; 0045d878
    CALL FUN_00490be0                   ; 0045d879
        ;   XREF to: 00490be0 (UNCONDITIONAL_CALL)  ; undefined FUN_00490be0()
    ...
    MOV EAX,dword ptr [ESP + 0x18]      ; 0045d981
        ;   Label: default
    PUSH EAX                            ; 0045d985
    CALL FUN_00402e70                   ; 0045d986
        ;   XREF to: 00402e70 (UNCONDITIONAL_CALL)  ; undefined FUN_00402e70()
    ADD ESP,0x4                         ; 0045d98b
    MOV EDX,dword ptr [ESP + 0xc]       ; 0045d98e
    PUSH EDX                            ; 0045d992
    CALL FUN_00402e30                   ; 0045d993
    ...
    PUSH ESI                            ; 0045d9df
    PUSH EDI                            ; 0045d9e0
    CALL FUN_00402cf0                   ; 0045d9e1
        ;   XREF to: 00402cf0 (UNCONDITIONAL_CALL)  ; undefined FUN_00402cf0()
    ADD ESP,0x10                        ; 0045d9e6
    JMP 0x0045d981                      ; 0045d9e9
        ;   XREF to: 0045d981 (UNCONDITIONAL_JUMP)  ; default
    CALL FUN_00402e20                   ; 0045d9eb
        ;   XREF to: 00402e20 (UNCONDITIONAL_CALL)  ; undefined FUN_00402e20()
        ;   Label: LAB_0045d9eb
    MOV dword ptr [ESP + 0xc],EAX       ; 0045d9f0
    CALL FUN_00402e60                   ; 0045d9f4
        ;   XREF to: 00402e60 (UNCONDITIONAL_CALL)  ; undefined FUN_00402e60()
    MOV dword ptr [ESP + 0x18],EAX      ; 0045d9f9
    CALL FUN_00402e50                   ; 0045d9fd
        ;   XREF to: 00402e50 (UNCONDITIONAL_CALL)  ; undefined FUN_00402e50()
    MOV EDX,dword ptr [0x01b4d714]      ; 0045da02 | DAT_01b4d714
    PUSH EDX                            ; 0045da08
    CALL FUN_00402e70                   ; 0045da09
        ;   XREF to: 00402e70 (UNCONDITIONAL_CALL)  ; undefined FUN_00402e70()
