...
section .text
    ...
    PUSH ECX                            ; 0050b1dd
    CALL FUN_0044d1f0                   ; 0050b1de
        ;   XREF to: 0044d1f0 (UNCONDITIONAL_CALL)  ; undefined FUN_0044d1f0()
