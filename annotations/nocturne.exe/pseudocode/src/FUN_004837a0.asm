...
;
; XREF[1]:
;   FUN_0048a650 at 0048a7fa
;
; Referenced Globals:
;   undefined4 DAT_005810d4
...
section .text
    ...
    FLD double ptr [0x005810d4]         ; 00483876 | DAT_005810d4
    ...
    FMULP ST3                           ; 0048388c
    FXCH                                ; 0048388e
    CALL FUN_00563a30                   ; 00483890
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH                                ; 00483895
    CALL FUN_00563a30                   ; 00483897
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH ST2                            ; 0048389c
    CALL FUN_00563a30                   ; 0048389e
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH                                ; 004838a3
