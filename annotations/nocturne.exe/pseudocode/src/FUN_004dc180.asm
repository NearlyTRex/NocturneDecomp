...
section .text
    ...
    PUSH EAX                            ; 004dc1ad
    CALL FUN_0040ca80                   ; 004dc1ae
        ;   XREF to: 0040ca80 (UNCONDITIONAL_CALL)  ; undefined FUN_0040ca80()
    MOV EDX,dword ptr [0x005bb124]      ; 004dc1b3 | DAT_005bb124
    ...
    PUSH EAX                            ; 004dc23d
    CALL FUN_0040c980                   ; 004dc23e
        ;   XREF to: 0040c980 (UNCONDITIONAL_CALL)  ; undefined FUN_0040c980()
    ADD ESP,0x8                         ; 004dc243
    PUSH 0x58a42f                       ; 004dc246 | = "sideOfCar"
    LEA EAX,[EBX + 0xbd4c]              ; 004dc24b
    PUSH EAX                            ; 004dc251
    CALL FUN_0040c900                   ; 004dc252
        ;   XREF to: 0040c900 (UNCONDITIONAL_CALL)  ; undefined FUN_0040c900()
    ADD ESP,0x8                         ; 004dc257
    CMP dword ptr [0x005bb124],0x7      ; 004dc25a | DAT_005bb124
        ;   Label: LAB_004dc25a
