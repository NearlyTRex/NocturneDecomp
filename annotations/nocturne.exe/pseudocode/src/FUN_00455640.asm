...
section .text
    ...
    PUSH EBP                            ; 0045571f
    CALL FUN_0047ab70                   ; 00455720
        ;   XREF to: 0047ab70 (UNCONDITIONAL_CALL)  ; undefined FUN_0047ab70()
        ;   Label: LAB_00455720
    ADD ESP,0x8                         ; 00455725
    PUSH ESI                            ; 00455728
        ;   Label: LAB_00455728
    CALL FUN_004552a0                   ; 00455729
        ;   XREF to: 004552a0 (UNCONDITIONAL_CALL)  ; undefined FUN_004552a0()
