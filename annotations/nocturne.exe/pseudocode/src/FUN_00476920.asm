...
section .text
    ...
    PUSH EBX                            ; 00476928
    CALL FUN_00476ce0                   ; 00476929
        ;   XREF to: 00476ce0 (UNCONDITIONAL_CALL)  ; undefined FUN_00476ce0()
    ADD ESP,0x4                         ; 0047692e
    PUSH EBX                            ; 00476931
    CALL FUN_00476800                   ; 00476932
    ...
    PUSH EBX                            ; 004769e3
        ;   Label: LAB_004769e3
    CALL FUN_00476ce0                   ; 004769e4
        ;   XREF to: 00476ce0 (UNCONDITIONAL_CALL)  ; undefined FUN_00476ce0()
    ADD ESP,0x4                         ; 004769e9
    PUSH EBX                            ; 004769ec
    CALL FUN_00476800                   ; 004769ed
        ;   XREF to: 00476800 (UNCONDITIONAL_CALL)  ; undefined FUN_00476800()
