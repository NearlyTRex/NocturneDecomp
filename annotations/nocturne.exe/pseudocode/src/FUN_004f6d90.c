...

{
  ...
  if (*(int *)(param_1 + 0x4c0) != 0) {
    ...
    iVar1 = FUN_0047dc30(0x01C03A10,param_1 + 0x3b0);
    if (iVar1 != 0) {
      return;
    }
    iVar1 = FUN_0047dc30(0x01C03A10,param_1 + 0x34c);
    if (iVar1 != 0) {
      return;
    }
  }
  ...
  if (iVar1 != 0) {
    if ((*(int *)(param_1 + 0x50c) == 0) || (iVar1 = FUN_00461090(DAT_005ae704), iVar1 != 0)) {
    ...
    *(uint *)(0x01E57284 + 0x15a890) = 1;
    ...
    _DAT_014b7190 = FUN_004475a0(_DAT_007f7370,&iStack_14,0);
    FUN_004544d0(param_1 + 0x150,0,0xffffffff);
