...
// Convention: unknown
// Signature: float FUN_0050ffe0(int param_1,float param_2,float *param_3,float *param_4,float param_5)
...

{
  ...
  *(uint *)(param_1 + 0x14cd5c) = 0;
  if (-1 < *(int *)(param_1 + 0x15f2ac)) {
    ...
    FUN_0041cc00(&local_88,&local_4c);
    FUN_00511990(&local_cc);
    ...
    if (0 < *(int *)(param_1 + 0x1569c0)) {
      ...
      do {
        ...
        iVar3 = FUN_005103f0(param_1,iVar1);
        if (iVar3 == 0) {
          local_ac = iVar3;
          local_a8 = iVar3;
          iVar3 = (**(code **)(*(int *)(iVar1 + 0x14c) + 0x34))(iVar1,&local_cc);
          if (iVar3 != 0) {
            fStack_14 = (float)FUN_0040a740(iVar1,param_3,&local_64,&uStack_a4,&local_cc,iVar3,
                                            &local_88);
            if (((fStack_14 <= 1.0) && (fVar2 = fStack_14 * local_24, fVar2 < param_5)) &&
              ...
              *(uint *)(param_1 + 0x14cd64) = uStack_8c;
              ...
              local_24 = fVar2;
              FUN_0041cc00(&local_88,&fStack_34);
              param_5 = fVar2;
            }
          }
        }
