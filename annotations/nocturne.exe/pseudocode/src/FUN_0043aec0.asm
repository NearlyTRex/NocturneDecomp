...
section .text
    ...
    PUSH EAX                            ; 0043af31
    CALL FUN_004026b0                   ; 0043af32
        ;   XREF to: 004026b0 (UNCONDITIONAL_CALL)  ; undefined FUN_004026b0()
