...
// Convention: unknown
// Signature: void FUN_00540660(int param_1,undefined4 param_2)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_00540660(int param_1,uint param_2)

{
  ...
  if (iVar2 != 0) {
    ...
    iVar2 = FUN_0040d890(*(uint *)(param_1 + 0x1fa94),_DAT_01bca0c0);
    if (iVar2 != 0) {
