...
;   string s_%s_confused_while_walking_to_scr_0057899e
;   string s_batman-attack?.wav_005789c8
;   string s_batman-alert.wav_005789db
;   string s_batman-attack?.wav_005789ec
;   string s_batman-attack?.wav_005789ff
;   undefined4 DAT_00578a17
;   undefined4 DAT_00578a1f
;   undefined4 DAT_00578a27
;   undefined4 DAT_00578a2f
;   undefined4 DAT_00599fac
;   undefined4 DAT_00599fb8
...
section .text
    ...
    FMUL double ptr [0x00578a17]        ; 004124f5 | DAT_00578a17
    FMULP                               ; 004124fb
    ...
    FLD ST0                             ; 004125b3
    FMUL double ptr [0x00578a2f]        ; 004125b5 | DAT_00578a2f
    ...
    MOV ECX,dword ptr [0x005ad350]      ; 004126ca | PTR_DAT_005ad350
    PUSH ECX                            ; 004126d0 | DAT_0077ad0c
    CALL FUN_0043ac60                   ; 004126d1
    ...
    PUSH EAX                            ; 004127b8
    PUSH EBX                            ; 004127b9
    CALL FUN_0040a240                   ; 004127ba
        ;   XREF to: 0040a240 (UNCONDITIONAL_CALL)  ; undefined FUN_0040a240()
    ADD ESP,0xc                         ; 004127bf
    PUSH EAX                            ; 004127c2
    PUSH EBX                            ; 004127c3
    CALL FUN_004798e0                   ; 004127c4
    ...
    FCOMP float ptr [0x00599fac]        ; 00412833 | DAT_00599fac
    FNSTSW AX                           ; 00412839
    SAHF                                ; 0041283b
    ...
    FCOMP float ptr [0x00599fb8]        ; 0041285d | DAT_00599fb8
    FNSTSW AX                           ; 00412863
    SAHF                                ; 00412865
    ...
    FCOMP double ptr [0x00578a1f]       ; 004128da | DAT_00578a1f
    FNSTSW AX                           ; 004128e0
    SAHF                                ; 004128e2
    ...
    FABS                                ; 004128f5
    FCOMP double ptr [0x00578a27]       ; 004128f7 | DAT_00578a27
    FNSTSW AX                           ; 004128fd
    SAHF                                ; 004128ff
    ...
    PUSH EAX                            ; 00412aac
    PUSH ESI                            ; 00412aad
    CALL FUN_004e16b0                   ; 00412aae
        ;   XREF to: 004e16b0 (UNCONDITIONAL_CALL)  ; undefined FUN_004e16b0()
    ADD ESP,0xc                         ; 00412ab3
    JMP 0x0041257b                      ; 00412ab6
        ;   XREF to: 0041257b (UNCONDITIONAL_JUMP)  ; caseD_7
    MOV EAX,[0x00599fac]                ; 00412abb | DAT_00599fac
        ;   Label: LAB_00412abb
    ...
    FCOMP float ptr [0x00599fb8]        ; 00412b70 | DAT_00599fb8
    FNSTSW AX                           ; 00412b76
    SAHF                                ; 00412b78
    ...
    FABS                                ; 00412bf5
    FCOMP double ptr [0x00578a27]       ; 00412bf7 | DAT_00578a27
    FNSTSW AX                           ; 00412bfd
    SAHF                                ; 00412bff
