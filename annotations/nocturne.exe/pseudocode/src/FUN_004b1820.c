...
// Convention: unknown
// Signature: void FUN_004b1820(int *param_1,uint param_2,uint param_3)
...

{
  ...
  iVar1 = FUN_004b1800(param_1,(param_3 - param_1[0xc]) + param_1[5],
  ...
  FUN_00530a25(&DAT_005c5014 + iVar1 * 0xc,&local_1c);
