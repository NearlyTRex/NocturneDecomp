...
;
; Referenced Globals:
;   string s_Bip01_head_00595380
;   string s_Bip01_L_Clavicle_0059538b
;   string s_Bip01_R_Clavicle_0059539c
;   string s_Bip01_L_UpperArm_005953ad
;   string s_Bip01_R_UpperArm_005953be
;   string s_Bip01_L_ForeArm_005953cf
;   string s_Bip01_R_ForeArm_005953df
;   string s_Bip01_L_Foot_005953ef
;   string s_Bip01_R_Foot_005953fc
;   string s_Bip01_L_Thigh_00595409
;   string s_Bip01_R_Thigh_00595417
;   string s_Bip01_L_Calf_00595425
;   string s_Bip01_R_Calf_00595432
;   string s_Bip01_L_Hand_0059543f
;   string s_Bip01_R_Hand_0059544c
;   ... and 33 more
;
; Called Functions:
;   FUN_00454510
...
section .text
    ...
    CALL FUN_004e1890                   ; 00535654
        ;   XREF to: 004e1890 (UNCONDITIONAL_CALL)  ; undefined FUN_004e1890()
    ADD ESP,0x4                         ; 00535659
    PUSH EAX                            ; 0053565c
    CALL FUN_004e1010                   ; 0053565d
        ;   XREF to: 004e1010 (UNCONDITIONAL_CALL)  ; undefined FUN_004e1010()
    ...
    CALL FUN_004e1890                   ; 00535672
        ;   XREF to: 004e1890 (UNCONDITIONAL_CALL)  ; undefined FUN_004e1890()
    ADD ESP,0x4                         ; 00535677
    PUSH EAX                            ; 0053567a
    CALL FUN_004e1010                   ; 0053567b
        ;   XREF to: 004e1010 (UNCONDITIONAL_CALL)  ; undefined FUN_004e1010()
    ADD ESP,0xc                         ; 00535680
    PUSH 0x41b00000                     ; 00535683
    PUSH EAX                            ; 00535688
    PUSH EDI                            ; 00535689
    CALL FUN_0051b8f0                   ; 0053568a
        ;   XREF to: 0051b8f0 (UNCONDITIONAL_CALL)  ; undefined FUN_0051b8f0()
