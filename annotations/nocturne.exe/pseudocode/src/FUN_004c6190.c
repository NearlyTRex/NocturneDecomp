...
// Convention: unknown
// Signature: void FUN_004c6190(int param_1,float param_2)
    ...
    if (*(float *)(param_1 + 0x414) < fVar1) {
      ...
      *(uint *)(param_1 + 0x2d4) = *(uint *)(param_1 + 0x414);
      if ((*(int *)(param_1 + 0x404) != 0) && ((float)_DAT_00587935 < *(float *)(param_1 + 0x2d4)))
      {
        iVar3 = param_1 + 0x2d8;
LAB_004c621d:
        FUN_0047ab70(0x01C03A10,iVar3);
      }
    }
  }
  if (*(int *)(param_1 + 0x408) != 0) {
    FUN_004c6390(*(int *)(param_1 + 0x408),*(uint *)(param_1 + 0x2d4));
  }
  iVar3 = 0;
  iVar4 = 0;
  while (iVar4 < *(int *)(0x01E57284 + 0x14cd6c)) {
    iVar2 = FUN_0040d890(*(uint *)(iVar3 + 0x14cd70 + 0x01E57284),_DAT_01cc3660);
    if ((iVar2 == 0) || (param_1 != *(int *)(iVar2 + 0x408))) {
      iVar4 = iVar4 + 1;
      iVar3 = iVar3 + 4;
    }
    else {
      FUN_004c6390(iVar2,*(uint *)(*(int *)(iVar2 + 0x408) + 0x2d4));
      iVar4 = iVar4 + 1;
      iVar3 = iVar3 + 4;
    }
  }
