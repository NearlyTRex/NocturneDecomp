...
// Convention: unknown
// Signature: void FUN_004dc690(int param_1,int param_2)
...

{
  ...
  FUN_00527230(*(uint *)(param_1 + 0xbdc4));
  FUN_00527230(*(uint *)(param_1 + 0xbdbc));
  FUN_004dc2d0(param_1,param_2);
  ...
  *(float *)(param_1 + 0x2434) = fVar1;
  ...
  iVar2 = FUN_0040d890(*(uint *)(param_2 + 0x34),_DAT_02dd1008);
  if (iVar2 == 0) {
LAB_004dc731:
    FUN_004e16b0(iVar3,3,1);
  }
  else {
    iVar2 = FUN_0040dea0(0x3f000000);
    if (iVar2 != 0) goto LAB_004dc731;
  }
  iVar3 = FUN_00526c50(*(uint *)(param_1 + 0xbdb8));
  if (iVar3 == 0) {
