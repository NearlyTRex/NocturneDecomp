...
;
; XREF[3]:
;   FUN_004d92a0 at 004d9396
;   FUN_004d9440 at 004d949b
;   FUN_004d9780 at 004d9802
;
; Referenced Globals:
...
section .text
    ...
    CALL FUN_00506f10                   ; 004d9048
        ;   XREF to: 00506f10 (UNCONDITIONAL_CALL)  ; undefined FUN_00506f10()
    ADD ESP,0x8                         ; 004d904d
    PUSH EBX                            ; 004d9050
    CALL FUN_004d8ee0                   ; 004d9051
