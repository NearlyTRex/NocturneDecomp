  ...
  if (iVar3 != 0) {
    ...
    if (uVar1 < 5) {
      if (uVar1 == 0) {
        ...
        if (iVar4 == 0) {
          ...
          if (*(int *)(param_1 + 0xbca4) != 0) {
            ...
            iVar3 = FUN_00526c50(*(uint *)(param_1 + 0xbd4c));
            if ((iVar3 == 0) &&
               (iVar3 = FUN_00526c50(*(uint *)(param_1 + 0xbd50)), iVar3 == 0)) {
        ...
        if (*(float *)(param_1 + 0xbd48) <= 0.0) {
          ...
          *(float *)(param_1 + 0xbd48) = local_14;
          ...
          iVar3 = FUN_00526c50(*(uint *)(param_1 + 0xbd4c));
          if ((iVar3 == 0) && (iVar3 = FUN_00526c50(*(uint *)(param_1 + 0xbd50)), iVar3 == 0))
          {
        ...
        *(float *)(param_1 + 0x2430) = *(float *)(param_1 + 0xbc8c) * fVar2 * param_2;
        ...
        if (*(int *)(param_1 + 0xbca4) == 0) {
          ...
          iVar4 = FUN_004247f0(param_1,*(int *)(param_1 + 0xbca4) + 0x20,uVar5);
          if (iVar4 < 0) {
            FUN_004e16b0(iVar3,0,1);
          }
      ...
      if (iVar4 == 0) {
        ...
        if (iVar4 == 0) {
          ...
          *(float *)(param_1 + 0xbca0) = local_14;
          local_20 = (float)FUN_004e1e60(iVar3);
          ...
          if (local_20 <= (float)_DAT_00579b55) {
            ...
            if ((local_4c < 1.0) || (_DAT_00579b3d < local_4c)) {
              ...
              if (((float)_DAT_00579b55 <= local_20) &&
                ...
                FUN_00423ed0(local_140);
                local_13c = (float)FUN_0040dda0(0x40e00000,0x41700000);
                local_10c = param_1;
                local_108 = param_1;
                local_14 = local_13c;
                uVar5 = FUN_0055a8b0(local_a4,&DAT_00764ae4,DAT_00764b30 * 0x30 + param_1 + 0xfd0,
                                     0x3ecccccd,local_140);
                uVar5 = FUN_0040a240(param_1,local_68,uVar5);
                FUN_004798e0(param_1,uVar5);
              }
            }
            else if (*(int *)(param_1 + 0x2290 + *(int *)(param_1 + 0xbd30) * 4) != 0) {
              FUN_00423ed0(local_1f4);
              local_1f0 = (float)FUN_0040dda0(0x40e00000,0x41700000);
              local_1c0 = param_1;
              local_1bc = param_1;
              local_14 = local_1f0;
              uVar5 = FUN_0055a8b0(local_e0,&DAT_00764ae4,param_1 + 0xfd0 + DAT_00764b34 * 0x30,
                                   0x3ecccccd,local_1f4);
              uVar5 = FUN_0040a240(param_1,local_f8,uVar5);
              FUN_004798e0(param_1,uVar5);
            }
          }
        }
      ...
      if (iVar4 == 0) {
        ...
        if (iVar4 == 0) {
          local_14 = (float)FUN_0040dda0(0x3e4ccccd,0x3f000000);
          *(float *)(param_1 + 0xbca0) = local_14;
          local_1c = (float)FUN_004e1e60(iVar3);
          ...
          if (local_1c <= (float)_DAT_00579b35) {
            ...
            if (((1.0 <= local_54) && (local_54 <= _DAT_00579b3d)) ||
              ...
              if (*(int *)(param_1 + 0x2290 + *(int *)(param_1 + 0xbd30) * 4) != 0) {
                FUN_00423ed0(local_17c);
                local_178 = (float)FUN_0040dda0(0x40e00000,0x41700000);
                local_148 = param_1;
                local_144 = param_1;
                local_14 = local_178;
                uVar5 = FUN_0055a8b0(local_80,&DAT_00764ae4,param_1 + 0xfd0 + DAT_00764b34 * 0x30,
                                     0x3ecccccd,local_17c);
                uVar5 = FUN_0040a240(param_1,local_b0,uVar5);
                FUN_004798e0(param_1,uVar5);
              }
            }
            else {
              ...
              if (((((float)_DAT_00579b55 <= local_1c) && (local_5c <= _DAT_00579b5d)) ||
                 ...
                 (*(int *)(param_1 + 0x2290 + *(int *)(param_1 + 0xbd28) * 4) != 0)) {
                FUN_00423ed0(local_1b8);
                local_1b4 = (float)FUN_0040dda0(0x40e00000,0x41700000);
                local_184 = param_1;
                local_180 = param_1;
                local_14 = local_1b4;
                uVar5 = FUN_0055a8b0(local_98,&DAT_00764ae4,param_1 + 0xfd0 + DAT_00764b30 * 0x30,
                                     0x3ecccccd,local_1b8);
                uVar5 = FUN_0040a240(param_1,local_74,uVar5);
                FUN_004798e0(param_1,uVar5);
              }
            }
          }
      ...
      uVar5 = FUN_0051d2a0(iVar3,local_c8,0);
      FUN_0040a240(param_1,local_d4,uVar5);
      FUN_004b0480(0x01C78C7C,local_d4,0);
    ...
    if ((*(int *)(param_1 + 0xbca4) != 0) && (0.0 <= local_18)) {
      ...
      *(float *)(param_1 + 0x242c) = param_2 * fVar2 * *(float *)(param_1 + 0xbc8c);
      ...
      iVar3 = FUN_004247f0(param_1,*(int *)(param_1 + 0xbca4) + 0x20,uVar5);
      if (iVar3 != 1) {
        FUN_004e16b0(param_1 + 0x150,1,1);
    ...
    *(uint *)(param_1 + 0x23a4) = *(uint *)(param_1 + 0x23a8);
    ...
    while (0.0 < local_24) {
      iVar3 = FUN_004e11c0(param_1 + 0x150,&local_24);
      if (iVar3 != 0x11) {
    ...
    *(float *)(param_1 + 0x34) = *(float *)(param_1 + 0x2410) + *(float *)(param_1 + 0x34);
    ...
    if (iVar3 != 0) {
      *(float *)(param_1 + 0x2424) = *(float *)(param_1 + 0x2424) - param_2 * (float)_DAT_00579b7d;
      ...
      FUN_00425050(param_1,&local_ec);
    }
    FUN_0051b8a0(param_1 + 0x150);
    FUN_0042a150(param_1,param_2);
    if (*(int *)(param_1 + 0xbc90) == 0) {
      FUN_004278e0(param_1,*(uint *)(param_1 + 0xbd24),DAT_00764b40,0x3e4ccccd);
      if (*(int *)(param_1 + 0x2290 + *(int *)(param_1 + 0xbd24) * 4) != 0) {
        FUN_004278e0(param_1,*(uint *)(param_1 + 0xbd28),DAT_00764b38,0x3e4ccccd);
      }
      FUN_004278e0(param_1,*(uint *)(param_1 + 0xbd2c),DAT_00764b44,0x3e4ccccd);
      if (*(int *)(param_1 + 0x2290 + *(int *)(param_1 + 0xbd2c) * 4) != 0) {
        FUN_004278e0(param_1,*(uint *)(param_1 + 0xbd30),DAT_00764b3c,0x3e4ccccd);
      }
      FUN_00427990(param_1,*(uint *)(param_1 + 0xbd44),DAT_00764b2c,0x3f333333);
