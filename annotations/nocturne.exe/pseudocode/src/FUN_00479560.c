...
// Convention: unknown
// Signature: int FUN_00479560(undefined4 param_1)

#include "nocturne.h"

int FUN_00479560(uint param_1)

{
  ...
  iVar2 = FUN_00423f40(param_1);
  *(byte ***)(iVar2 + 0x14c) = &PTR_FUN_0059cdb4;
  uVar3 = FUN_0040dda0(0x3f666666,0x3f8ccccd);
  *(uint *)(iVar2 + 0xbc90) = 0;
  *(uint *)(iVar2 + 0xbd14) = 0;
  *(uint *)(iVar2 + 0xbca4) = 0;
  *(uint *)(iVar2 + 0xbca8) = 0;
  ...
  *(uint *)(iVar2 + 0xbc8c) = uVar3;
  iVar4 = FUN_0040de00(0xffffe001,0x1fff);
