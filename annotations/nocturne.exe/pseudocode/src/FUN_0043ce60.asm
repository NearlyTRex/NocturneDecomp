...
section .text
    ...
    POP EBX                             ; 0043ce84
    RET                                 ; 0043ce85
    PUSH 0x59bb10                       ; 0043ce86 | DAT_0059bb10
        ;   Label: LAB_0043ce86
    PUSH EBX                            ; 0043ce8b
    CALL FUN_0056445f                   ; 0043ce8c
        ;   XREF to: 0056445f (UNCONDITIONAL_CALL)  ; undefined FUN_0056445f()
    ADD ESP,0x8                         ; 0043ce91
    PUSH EAX                            ; 0043ce94
    CALL FUN_00564486                   ; 0043ce95
