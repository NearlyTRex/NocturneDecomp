...
section .text
    ...
    POP EBX                             ; 0052a992
    RET                                 ; 0052a993
    CALL FUN_00529810                   ; 0052a994
        ;   XREF to: 00529810 (UNCONDITIONAL_CALL)  ; undefined FUN_00529810()
        ;   Label: LAB_0052a994
