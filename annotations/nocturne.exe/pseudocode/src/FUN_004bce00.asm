...
;                               FUNCTION
; *****************************************************************************
; int FUN_004bce00(int param_1,undefined4 *param_2)
;
; Local Variables:
