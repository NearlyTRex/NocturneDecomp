...
// Convention: unknown
// Signature: undefined4 FUN_0040b300(int param_1,int param_2)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_0040b300(int param_1,int param_2)

{
  ...
  FUN_0040a240(param_1,&fStack_c8,&local_d4);
  if (local_44 == 1) {
    uStack_d8 = 0xc0400000;
    uStack_e0 = 0;
    uStack_dc = 0;
    pfVar2 = (float *)FUN_0040a200(param_1,auStack_a4,&uStack_e0);
  ...
  FUN_0040a200(param_1,auStack_68,&uStack_b0);
      ...
      if ((param_1 != iStack_24) && (iStack_24 != iStack_28)) {
        ...
        if (iVar1 == 0) {
          ...
          if (iVar1 == 0) {
            iVar1 = FUN_0040d890();
            if (iVar1 != 0) {
              FUN_0040a290(iVar1,auStack_80,&fStack_c8,0x40000000);
              uVar4 = (**(code **)(*(int *)(iVar1 + 0x14c) + 0x14))(iVar1,auStack_f8);
              iVar3 = FUN_0041e200(uVar4);
              if (iVar3 != 0) {
                FUN_00423ed0(auStack_254);
            ...
            iVar3 = FUN_005485a0();
            if (iVar3 != 0) {
              FUN_0040a290(iVar1,auStack_74,&fStack_c8,0x40000000);
              uVar4 = (**(code **)(*(int *)(iVar1 + 0x14c) + 0x14))(iVar1,auStack_128);
              iVar3 = FUN_0041e200(uVar4);
              if (iVar3 != 0) {
                FUN_00423ed0(auStack_290);
                (**(code **)(*(int *)(param_1 + 0x14c) + 0x74))(param_1,param_2,auStack_290,iVar1);
                FUN_0043ac60(PTR_DAT_005ad350,"%s causing %5.2f damage to %s\n",param_1,
                ...
                (iVar3 = FUN_0040d7e0(), iVar3 == 0)) {
          FUN_00423ed0(auStack_1a0);
          ...
          if (0.0 < fStack_19c) {
            fVar7 = (float10)1 + (float10)fStack_19c * (float10)_DAT_00577809;
            FUN_00563a30(*(uint *)(iVar1 + 0x2608));
            fStack_18 = (float)(int)ROUND(fVar7);
            FUN_004b0200(0x01C78C7C,&fStack_c8,auStack_68);
            (**(code **)(*(int *)(param_1 + 0x14c) + 0x78))(param_1,param_2,auStack_1a0,iVar1);
          }
        }
      }
  ...
  if (local_44 == 1) {
    ...
    iStack_34 = 0;
    while ((fStack_18 = (float)FUN_0050fb00(0x01E57284,&fStack_bc,&fStack_c8), 0.0 <= fStack_18 &&
           (fStack_18 <= 1.0))) {
      iVar1 = FUN_0040d890();
      ...
      iStack_1c = FUN_0040d890();
      iStack_40 = FUN_0040d890();
      iStack_20 = iStack_40;
      iStack_3c = FUN_0040d890();
      iVar5 = FUN_0040d890();
      iVar3 = iStack_20;
      if (iVar1 == 0) {
        if (iStack_1c == 0) {
        ...
        puVar6 = (uint *)FUN_0040a290(iVar1,auStack_50,0x01E57284 + 0x14cd50);
