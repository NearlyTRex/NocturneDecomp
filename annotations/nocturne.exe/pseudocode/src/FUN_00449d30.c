...
// Convention: unknown
// Signature: uint FUN_00449d30(int *param_1,float *param_2,float param_3,float *param_4)
  ...
  if ((float)param_1[4] <= (float)_DAT_0057bbab) {
    ...
    if (local_3c <= param_2[1]) {
      ...
      if (*param_4 <= local_54) {
        ...
        uVar6 = FUN_00449bc0(&local_58,&local_4c,param_3,param_4);
        uVar7 = FUN_00449bc0(&local_4c,&local_40,param_3,param_4);
        uVar8 = FUN_00449bc0(&local_40,&local_58,param_3,param_4);
        ...
        if (_DAT_0057bbb3 <= (double)fVar9) {
          ...
          local_30 = param_2[1];
          fVar9 = (float)FUN_00449150(param_1,&local_34,&DAT_014b846c);
          ...
          fVar9 = (float)FUN_00449150(param_1,param_2,&DAT_014b846c);
          if (0.0 <= fVar9) {
            uVar8 = 1;
            *param_4 = local_54;
          }
