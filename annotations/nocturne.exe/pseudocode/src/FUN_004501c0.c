...
// Convention: unknown
// Signature: void FUN_004501c0(int param_1,undefined4 *param_2,int param_3,uint param_4,uint param_5)

#include "nocturne.h"

void FUN_004501c0(int param_1,uint *param_2,int param_3,uint param_4,uint param_5)
