...
;
; Referenced Globals:
;   undefined4 DAT_0057a58a
;   undefined4 DAT_0057a58e
;   undefined4 DAT_0057a596
;   undefined4 DAT_0057a59e
...
section .text
    ...
    FCOMP float ptr [0x0057a58a]        ; 0042bcb8 | DAT_0057a58a
    FNSTSW AX                           ; 0042bcbe
    SAHF                                ; 0042bcc0
    ...
    PUSH EAX                            ; 0042bda5
    PUSH ESI                            ; 0042bda6
    CALL FUN_0042b890                   ; 0042bda7
        ;   XREF to: 0042b890 (UNCONDITIONAL_CALL)  ; undefined FUN_0042b890()
    ...
    PUSH EBX                            ; 0042bfa9
    PUSH ESI                            ; 0042bfaa
    CALL FUN_0042baa0                   ; 0042bfab
        ;   XREF to: 0042baa0 (UNCONDITIONAL_CALL)  ; undefined FUN_0042baa0()
    ADD ESP,0xc                         ; 0042bfb0
    PUSH EDI                            ; 0042bfb3
    PUSH EBX                            ; 0042bfb4
    PUSH ESI                            ; 0042bfb5
    ADD EDI,0x24                        ; 0042bfb6
    CALL FUN_0042baa0                   ; 0042bfb9
        ;   XREF to: 0042baa0 (UNCONDITIONAL_CALL)  ; undefined FUN_0042baa0()
    ...
    FMUL double ptr [0x0057a58e]        ; 0042c02f | DAT_0057a58e
    FLD1                                ; 0042c035
    FLDZ                                ; 0042c037
    FXCH ST2                            ; 0042c039
    ...
    FMUL double ptr [0x0057a596]        ; 0042c290 | DAT_0057a596
    ...
    FLD float ptr [ESI + 0x154]         ; 0042c2fa
        ;   Label: LAB_0042c2fa
    FMUL double ptr [0x0057a596]        ; 0042c300 | DAT_0057a596
    ...
    FMUL double ptr [0x0057a59e]        ; 0042c378 | DAT_0057a59e
    FCOMPP                              ; 0042c37e
    FNSTSW AX                           ; 0042c380
    SAHF                                ; 0042c382
