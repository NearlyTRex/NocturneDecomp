...
;
; XREF[1]:
;   FUN_0056fcd4 at 0056fcf7
;
; Referenced Globals:
;   undefined4 DAT_005c1d94
;   void* PTR_FUN_005c2054 = 0056fcd0
;   void* PTR_FUN_005c2058 = 0056fcd0
;
; Called Functions:
;   FUN_005674b0
;   FUN_0056fcd0
...
section .text
    ...
    PUSH EBX                            ; 0056fd00
        ;   Label: FUN_0056fd00
    CALL dword ptr [0x005c2054]         ; 0056fd01 | PTR_FUN_005c2054
    CALL dword ptr [0x005c2058]         ; 0056fd07 | PTR_FUN_005c2058
