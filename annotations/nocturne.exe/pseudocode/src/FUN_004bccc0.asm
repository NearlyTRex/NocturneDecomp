...
;                               FUNCTION
; *****************************************************************************
; void FUN_004bccc0(int param_1,int param_2)
;
; Local Variables:
...
section .text
    ...
    PUSH EAX                            ; 004bcd21
    MOV EBP,dword ptr [0x005b80f0]      ; 004bcd22 | DAT_005b80f0
    PUSH EBP                            ; 004bcd28
    INC EBX                             ; 004bcd29
    CALL FUN_0048ae90                   ; 004bcd2a
    ...
    PUSH EDI                            ; 004bcd40
        ;   Label: LAB_004bcd40
    PUSH ESI                            ; 004bcd41
    CALL FUN_004bca20                   ; 004bcd42
        ;   XREF to: 004bca20 (UNCONDITIONAL_CALL)  ; undefined FUN_004bca20()
