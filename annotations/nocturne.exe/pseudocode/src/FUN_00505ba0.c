...
// Convention: unknown
// Signature: void FUN_00505ba0(int param_1,float param_2)
...
LAB_00505bf9:
  if (0.0 < local_2c[0]) {
    uVar7 = FUN_004e11c0(iVar4,local_2c);
    switch(uVar7) {
    case 100:
      ...
      if ((((iVar5 != 0) &&
        ...
        local_108 = 0x40800000;
        local_110 = 0;
        local_10c = 0;
        FUN_0040a240(param_1,&local_c8,&local_110);
        ...
        fVar3 = (float)_DAT_00590085;
        iVar5 = *(int *)(param_1 + 0xbca4);
        if (ABS(local_c4 - *(float *)(iVar5 + 0x24)) <= (float)_DAT_0059008d) {
          if ((fVar3 < fVar2) ||
    ...
    case 0x66:
      if (*(int *)(param_1 + 0xbca4) != 0) {
        ...
        local_160 = (float)FUN_0040dda0(0x3f800000,0x40a00000);
        local_14 = local_160;
  ...
  if (iVar6 == 0) {
    ...
    case 0:
      ...
      if (iVar4 == 0) {
        ...
        if (SQRT(local_54 * local_54 + local_5c * local_5c + local_58 * local_58) <= _DAT_005a1744)
        {
          FUN_004e16b0(param_1 + 0x150,2,1);
        }
        else {
        ...
        *(uint *)(param_1 + 0x23a4) = *(uint *)(param_1 + 0x23a8);
        ...
        if (-1 < iVar4) {
          ...
          if ((local_24 <= local_20) && (*(float *)(param_1 + 0xbca0) <= 0.0)) {
            ...
            FUN_0054e4a0(local_74,&local_bc);
            local_14 = (float)FUN_0040df00(local_70 - *(float *)(param_1 + 0x34));
            if (ABS(local_14) < (float)_DAT_00590075) {
...
LAB_005062ff:
    ...
    case 3:
      ...
      *(uint *)(param_1 + 0x23a4) = *(uint *)(param_1 + 0x23a8);
      ...
      FUN_004247f0(param_1,*(int *)(param_1 + 0xbca4) + 0x20,uVar7);
      iVar5 = *(int *)(param_1 + 0xbca4);
      ...
      if (_DAT_005a1744 <=
        ...
        iVar5 = FUN_0040dea0(0x3dcccccd);
        if (iVar5 == 0) break;
        iVar5 = FUN_0040dea0(0x3f000000);
        if (iVar5 != 0) {
      ...
      FUN_004e16b0(iVar4,0xf,1);
      break;
    case 4:
      FUN_00423ed0(local_1a0);
      local_19c = (float)FUN_0040dda0(0x40e00000,0x41700000);
      local_16c = param_1;
      local_168 = param_1;
      local_14 = local_19c;
      uVar7 = FUN_0055a8b0(local_b0,&DAT_02dd1184,_DAT_01e57220 * 0x30 + param_1 + 0xfd0,0x3f800000,
                           local_1a0);
      uVar7 = FUN_0040a240(param_1,local_a4,uVar7);
      FUN_004798e0(param_1,uVar7);
      local_19c = (float)FUN_0040dda0(0x41700000,0x41f00000);
      local_16c = param_1;
      local_168 = param_1;
      local_14 = local_19c;
      uVar7 = FUN_0055a8b0(local_50,&DAT_02dd1184,_DAT_01e57218 * 0x30 + param_1 + 0xfd0,0x3f800000,
                           local_1a0);
    ...
    case 9:
      if ((*(int *)(param_1 + 0xbc90) == 0) && (*(int *)(param_1 + 0xdc) == 0)) {
        uVar7 = FUN_0051d2a0(param_1 + 0x150,local_44,0);
        FUN_0040a240(param_1,local_128,uVar7);
        FUN_004b0480(0x01C78C7C,local_128,0);
    ...
    case 0xf:
      ...
      if (iVar4 == 0) {
        ...
        FUN_0054e4a0(local_d4,&local_f8);
...
switchD_00505ff7_caseD_5:
  ...
  if (iVar4 != 0) {
    *(float *)(param_1 + 0x2424) = *(float *)(param_1 + 0x2424) - param_2 * (float)_DAT_0059007d;
