...
// Convention: unknown
// Signature: void FUN_004bca20(int param_1,int *param_2)
  ...
  if (((((iVar2 == *(int *)(param_1 + 0xbd30)) || (iVar2 == *(int *)(param_1 + 0xbd34))) ||
    ...
    if (iVar2 != 0) {
      ...
      if (*param_2 == *(int *)(param_1 + 0xbd30)) {
        FUN_00427eb0(param_1,uVar3,*(uint *)(param_1 + 0xbd34),0);
      }
      if (*(int *)(param_1 + 0xbd38) == *param_2) {
        FUN_00427eb0(param_1,uVar3,*(uint *)(param_1 + 0xbd3c),0);
      }
      if (*(int *)(param_1 + 0xbd54) == *param_2) {
        piVar1 = param_2 + 3;
        FUN_00427e40(param_1,*(uint *)(param_1 + 0xbd38),piVar1,1);
        FUN_00427e40(param_1,*(uint *)(param_1 + 0xbd3c),piVar1,1);
        FUN_00427e40(param_1,*(uint *)(param_1 + 0xbd30),piVar1,1);
        FUN_00427e40(param_1,*(uint *)(param_1 + 0xbd34),piVar1,1);
        FUN_00427e40(param_1,*(uint *)(param_1 + 0xbd58),piVar1,1);
      }
