...
// Convention: unknown
// Signature: void FUN_004cf0c0(int param_1,float param_2)
...

{
  ...
  if ((0 < *(int *)(param_1 + 0x588)) &&
    ...
    *(float *)(param_1 + 0x58c) = fVar1;
    ...
    FUN_0040a240(param_1,auStack_18,uVar2);
    FUN_004b00f0(0x01C78C7C,auStack_18,&DAT_02dd1184,*(uint *)(param_1 + 0x584));
    return;
  }
  return;
}
