...
// Convention: unknown
// Signature: void FUN_0040e710(int *param_1,int param_2,int param_3,undefined4 param_4)

#include "nocturne.h"

void FUN_0040e710(int *param_1,int param_2,int param_3,uint param_4)
      ...
      if (0 < param_1[4]) {
        ...
        do {
          if ((-1 < local_18) && (local_18 < DAT_005b7620)) {
            ...
            FUN_0053055c(iVar2,iVar3 + local_14,iVar3 + iVar4,param_4,iVar1);
          }
          local_18 = local_18 + 1;
      ...
      if (0 < param_1[4]) {
        ...
        do {
          if ((-1 < local_1c) && (local_1c < DAT_005b7620)) {
            ...
            FUN_005305f7(iVar2,iVar3 + local_14,iVar3 + iVar4,param_4,iVar1);
          }
          local_1c = local_1c + 1;
          local_14 = local_14 + param_1[3];
          iVar4 = iVar4 + param_1[3];
