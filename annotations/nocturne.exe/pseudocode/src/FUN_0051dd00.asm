...
;
; XREF[3]:
;   FUN_00519be0 at 00519c68
;   FUN_0051ad20 at 0051addb
;   FUN_0051dcd0 at 0051dce8
;
; Called Functions:
;   FUN_004e1860
;   FUN_00518180
...
section .text
    ...
    CALL FUN_004e1860                   ; 0051dd28
        ;   XREF to: 004e1860 (UNCONDITIONAL_CALL)  ; undefined FUN_004e1860()
    ...
    PUSH ECX                            ; 0051ddad
    CALL FUN_00518180                   ; 0051ddae
        ;   XREF to: 00518180 (UNCONDITIONAL_CALL)  ; undefined FUN_00518180()
    ...
    MOV EDX,dword ptr [ESP + 0x28]      ; 0051ddfe
        ;   Label: LAB_0051ddfe
    PUSH EDX                            ; 0051de02
    CALL FUN_0051b750                   ; 0051de03
        ;   XREF to: 0051b750 (UNCONDITIONAL_CALL)  ; undefined FUN_0051b750()
    ADD ESP,0x4                         ; 0051de08
    MOV ECX,dword ptr [ESP + 0x28]      ; 0051de0b
    PUSH ECX                            ; 0051de0f
    CALL FUN_0051de60                   ; 0051de10
        ;   XREF to: 0051de60 (UNCONDITIONAL_CALL)  ; undefined FUN_0051de60()
    ADD ESP,0x4                         ; 0051de15
    MOV EBX,dword ptr [ESP + 0x28]      ; 0051de18
    PUSH EBX                            ; 0051de1c
    CALL FUN_0051b880                   ; 0051de1d
