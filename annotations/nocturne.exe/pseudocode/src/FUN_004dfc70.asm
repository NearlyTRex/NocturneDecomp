...
section .text
    ...
    PUSH ECX                            ; 004dfc8e
    CALL FUN_004dfcb0                   ; 004dfc8f
        ;   XREF to: 004dfcb0 (UNCONDITIONAL_CALL)  ; undefined FUN_004dfcb0()
    ADD ESP,0xc                         ; 004dfc94
    MOV EBX,dword ptr [ESP + 0x8]       ; 004dfc97
    PUSH dword ptr [ESP + 0xc]          ; 004dfc9b
    PUSH EBX                            ; 004dfc9f
    CALL FUN_004dfea0                   ; 004dfca0
        ;   XREF to: 004dfea0 (UNCONDITIONAL_CALL)  ; undefined FUN_004dfea0()
