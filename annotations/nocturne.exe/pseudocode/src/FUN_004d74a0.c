...
// Convention: unknown
// Signature: undefined4 FUN_004d74a0(int param_1,int param_2)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_004d74a0(int param_1,int param_2)

{
  ...
  if (0 < _DAT_01cc9120) {
    ...
    do {
      ...
      iVar3 = iVar3 + 1;
      *pfVar2 = (float)*piVar1 * _DAT_005a0888;
      pfVar2[1] = (float)piVar1[1] * _DAT_005a0888;
      pfVar2[2] = (float)piVar1[2] * _DAT_005a0888;
      pfVar2 = pfVar2 + 3;
    ...
    *(uint *)(param_1 + 0xfc) = *(uint *)(param_2 + 0x14);
    ...
    if (0 < _DAT_01cc92a4) {
      ...
      do {
        ...
        *piVar1 = (int)ROUND(*local_14 * _DAT_005a0880);
        piVar1[1] = (int)ROUND(local_14[1] * _DAT_005a0880);
