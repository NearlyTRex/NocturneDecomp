...
// Convention: unknown
// Signature: int FUN_00415370(undefined4 param_1)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

int FUN_00415370(uint param_1)

{
  ...
  iVar4 = FUN_00454490(iVar4 + 0xbd24);
  iVar4 = FUN_004e0050(iVar4 + 0x184);
  *(byte ***)(iVar4 + -0xbd5c) = &PTR_FUN_0059a5b4;
  FUN_0051e0c0(iVar4 + -0xbd58,"biggs.dfm");
  pcVar5 = "bigAlien";
  pcVar6 = (char *)(iVar4 + 0xc2c);
  FUN_00454580(iVar4 + -0x184,"question.kfm");
  uVar2 = _DAT_0059a598;
