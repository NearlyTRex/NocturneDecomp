...

{
  ...
  if (param_2 != 0) {
    FUN_00511990(local_88);
    local_88[0] = 0;
    iVar1 = (**(code **)(*(int *)(param_2 + 0x14c) + 0x34))(param_2,local_88);
    if (iVar1 == 2) {
      uStack_18 = FUN_0040df00(*(uint *)(param_1 + 0x30));
      *(uint *)(param_1 + 0x30) = uStack_18;
      uStack_18 = FUN_0040df00(*(uint *)(param_1 + 0x38));
      *(uint *)(param_1 + 0x38) = uStack_18;
      if ((ABS(*(float *)(param_1 + 0x30)) <= (float)_DAT_0058d965) &&
        ...
        FUN_0040a290(param_1,&fStack_24,param_2 + 0x20);
        if (((fStack_60 <= fStack_24 + fStack_6c) &&
          ...
          if (*(int *)(iVar1 + 0x358) != 0) {
            ...
            uVar2 = FUN_00454530(param_1 + 0x150,0,&fStack_48,&uStack_30,auStack_3c);
            fVar3 = (float)FUN_00453990(uVar2);
            if (fVar3 < 0.0) {
              return 0;
            }
            if (1.0 < fVar3) {
