...
;
; Referenced Globals:
;   undefined4 s_batman-die.wav_00578a66+1
;   string s_batman-hurt?.wav_00578a76
;   undefined4 DAT_00578a87
...
section .text
    ...
    PUSH EAX                            ; 004130ba
    PUSH ESI                            ; 004130bb
    CALL FUN_00427730                   ; 004130bc
        ;   XREF to: 00427730 (UNCONDITIONAL_CALL)  ; undefined FUN_00427730()
    ADD ESP,0x18                        ; 004130c1
    PUSH EDI                            ; 004130c4
        ;   Label: LAB_004130c4
    PUSH ESI                            ; 004130c5
    CALL FUN_00412de0                   ; 004130c6
        ;   XREF to: 00412de0 (UNCONDITIONAL_CALL)  ; undefined FUN_00412de0()
    ...
    FLD ST0                             ; 0041316d
    FMUL double ptr [0x00578a87]        ; 0041316f | DAT_00578a87
    PUSH EAX                            ; 00413175
    ...
    PUSH 0x7                            ; 004131df
    PUSH EBX                            ; 004131e1
    CALL FUN_004e16b0                   ; 004131e2
        ;   XREF to: 004e16b0 (UNCONDITIONAL_CALL)  ; undefined FUN_004e16b0()
    ADD ESP,0xc                         ; 004131e7
    MOV EBX,dword ptr [ESI + 0xbd60]    ; 004131ea
    PUSH EBX                            ; 004131f0
    CALL FUN_00527230                   ; 004131f1
        ;   XREF to: 00527230 (UNCONDITIONAL_CALL)  ; undefined FUN_00527230()
    ADD ESP,0x4                         ; 004131f6
    PUSH 0x578a67                       ; 004131f9 | s_batman-die.wav_00578a66+1
