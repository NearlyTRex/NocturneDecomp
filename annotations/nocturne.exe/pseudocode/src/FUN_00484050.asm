...
section .text
    ...
    PUSH EBP                            ; 00484070
        ;   Label: LAB_00484070
    CALL FUN_004ef120                   ; 00484071
        ;   XREF to: 004ef120 (UNCONDITIONAL_CALL)  ; undefined FUN_004ef120()
