...
;
; XREF[2]:
;   FUN_004a6010 at 004a61a9
;   FUN_005088f0 at 00508f81
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0050d0dd
    PUSH ESI                            ; 0050d0de
    CALL FUN_00515420                   ; 0050d0df
        ;   XREF to: 00515420 (UNCONDITIONAL_CALL)  ; undefined FUN_00515420()
