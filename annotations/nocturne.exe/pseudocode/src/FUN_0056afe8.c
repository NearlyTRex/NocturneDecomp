...
// Convention: unknown
// Signature: undefined4 FUN_0056afe8(short param_1,int *param_2,uint param_3,uint *param_4)

#include "nocturne.h"

uint FUN_0056afe8(short param_1,int *param_2,uint param_3,uint *param_4)
    ...
    *param_4 = uVar4 - uVar7;
    ...
    if (0xf < uVar7 - uVar4) {
      ...
      *(uint *)(uVar4 + (int)puVar1) = uVar7 - uVar4 | 1;
      ...
      FUN_005638e0((uint *)(uVar4 + (int)puVar1) + 1);
    }
LAB_0056b198:
    uVar5 = 0;
  }
