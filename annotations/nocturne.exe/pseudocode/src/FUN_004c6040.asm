...
;   undefined1* PTR_FUN_0059fc44 = 004c6110
;
; Called Functions:
;   FUN_00409d30
;   FUN_00454490
...
section .text
    ...
    PUSH EAX                            ; 004c607c
    MOV dword ptr [EBX + 0x14c],0x59fc44 ; 004c607d | PTR_FUN_0059fc44
    CALL FUN_00454580                   ; 004c6087
