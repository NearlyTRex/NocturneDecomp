...
// Convention: unknown
// Signature: void FUN_0043bdb0(int param_1,float param_2)
...

{
  ...
  *(uint *)(param_1 + 0x23a4) = *(uint *)(param_1 + 0x23a8);
  ...
  iVar4 = param_1 + 0x150;
  while (0.0 < local_1c) {
    uVar6 = FUN_004e11c0(iVar4,&local_1c);
  ...
  *(float *)(param_1 + 0x2430) = param_2 * fVar3 * *(float *)(param_1 + 0xbc8c) * fVar2;
  ...
  if (iVar5 == 0) {
    ...
    case 0:
      ...
      if (iVar5 == 0) {
        ...
        if (*(int *)(param_1 + 0xbca4) != 0) {
          iVar4 = FUN_0052eba0(0x02DC9450,*(uint *)(param_1 + 0xbd2c));
          if (iVar4 == 0) {
    ...
    case 1:
      ...
      break;
    case 2:
      FUN_00423ed0(local_c0);
      local_bc = FUN_0040dda0(0x40e00000,0x41700000);
      local_8c = param_1;
      local_88 = param_1;
      local_14 = local_bc;
      uVar6 = FUN_0055a8b0(local_3c,&DAT_02dd1184,
                           param_1 + 0xfd0 + *(int *)(param_1 + 0xbd28) * 0x30,0x3f333333,local_c0);
      uVar6 = FUN_0040a240(param_1,local_30,uVar6);
      FUN_004798e0(param_1,uVar6);
      break;
    case 5:
      if ((*(int *)(param_1 + 0xbc90) == 0) && (*(int *)(param_1 + 0xdc) == 0)) {
        uVar6 = FUN_0051d2a0(iVar4,local_78,0);
        FUN_0040a240(param_1,local_84,uVar6);
