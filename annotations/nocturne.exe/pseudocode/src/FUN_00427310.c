...
// Convention: unknown
// Signature: void FUN_00427310(int param_1)
...

{
  ...
  if ((iVar4 < 5) && (-1 < *(int *)(0x01E57284 + 0x14cd60))) {
    ...
    *local_18 = *(uint *)(iVar2 + 0x14cd60);
    ...
    local_1c = (float)FUN_0040dda0(0x3e99999a,0x3f19999a,fVar1);
    ...
    local_14 = local_1c;
    uVar3 = FUN_0054e4a0(local_40,&local_4c);
    FUN_0055afb0(local_ac,&local_28,uVar3);
    local_14 = (float)FUN_0040dda0(0xbd0efa35,0x3d0efa35,local_ac);
    FUN_0055c7b0(local_14);
    puVar5 = local_25c;
    puVar6 = local_2bc;
    ...
    local_14 = (float)FUN_0040dda0(0xbd0efa35,0x3d0efa35,local_2bc);
    FUN_0055c730(local_14);
    puVar5 = local_16c;
    puVar6 = local_19c;
    for (iVar4 = 0xc; iVar4 != 0; iVar4 = iVar4 + -1) {
      *puVar6 = *puVar5;
    ...
    FUN_0055ae80(local_10c,param_1 + 0x20,param_1 + 0x30);
    FUN_0055bd00(local_18[1] * 0x30 + param_1 + 0xfd0);
    puVar5 = local_2ec;
    puVar6 = local_22c;
    for (iVar4 = 0xc; iVar4 != 0; iVar4 = iVar4 + -1) {
      *puVar6 = *puVar5;
    ...
    FUN_0055aa00(local_ac,local_10c,local_22c);
    puVar5 = local_1fc;
    puVar6 = local_dc;
    for (iVar4 = 0xc; iVar4 != 0; iVar4 = iVar4 + -1) {
      *puVar6 = *puVar5;
