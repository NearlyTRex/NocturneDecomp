...
// Convention: unknown
// Signature: void FUN_0047dd80(int param_1)
...

{
  ...
  if (0 < *(int *)(param_1 + 0x1908)) {
    ...
    iVar2 = iVar1;
    do {
      FUN_00563c90(local_218,"Game Flag: %s",iVar3);
      iVar4 = iVar4 + 1;
      iVar3 = iVar3 + 0x20;
      iVar1 = iVar2 + 0xb;
      FUN_00402600(local_218,0,iVar2);
      iVar2 = iVar1;
  ...
  if (0 < *(int *)(param_1 + 0x258c)) {
    ...
    iVar2 = iVar1;
    do {
      FUN_00563c90(local_3a8,"Persistent: %s",iVar3);
      iVar4 = iVar4 + 1;
      iVar3 = iVar3 + 0x20;
      iVar1 = iVar2 + 0xb;
      FUN_00402600(local_3a8,0,iVar2);
      iVar2 = iVar1;
  ...
  if (0 < *(int *)(param_1 + 0x3210)) {
    ...
    local_24 = param_1;
    do {
      FUN_00563c90(local_2e0,"Timer: %5.2f %s",(double)*(float *)(local_24 + 0x3354),iVar3)
      ;
      iVar4 = iVar4 + 1;
      FUN_00402600(local_2e0,0,iVar1);
      iVar3 = iVar3 + 0x20;
      iVar1 = iVar1 + 0xb;
      local_24 = local_24 + 4;
  ...
  if (0 < *(int *)(param_1 + 0x337c)) {
    ...
    iVar3 = param_1;
    do {
      FUN_00563c90(local_88,"%s=%d",local_1c,*(uint *)(iVar3 + 0x34c0));
      iVar3 = iVar3 + 4;
      FUN_00402600(local_88,0,iVar1);
      iVar4 = iVar4 + 1;
      iVar1 = iVar1 + 0xb;
  ...
  if (0 < *(int *)(param_1 + 0x34e8)) {
    ...
    do {
      FUN_00563c90(local_ec,"%s=%s",local_18,iVar3);
      iVar4 = iVar4 + 1;
      FUN_00402600(local_ec,0,iVar1);
      iVar3 = iVar3 + 0x1e;
      iVar1 = iVar1 + 0xb;
  ...
  if (0 < *(int *)(param_1 + 0x3ac8)) {
    ...
    iVar3 = param_1;
    do {
      FUN_00563c90(local_150,"%s=%s %.1f",local_20,iVar4,*(uint *)(iVar3 + 0x3be4),
                   *(uint *)(iVar3 + 0x3be8));
      iVar3 = iVar3 + 0x120;
      iVar4 = iVar4 + 0x120;
      FUN_00402600(local_150,0,iVar1);
