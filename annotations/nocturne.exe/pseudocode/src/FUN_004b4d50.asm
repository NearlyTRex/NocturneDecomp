...
section .text
    ...
    PUSH EBX                            ; 004b4db6
    CALL FUN_004e1740                   ; 004b4db7
        ;   XREF to: 004e1740 (UNCONDITIONAL_CALL)  ; undefined FUN_004e1740()
    ADD ESP,0xc                         ; 004b4dbc
    PUSH ESI                            ; 004b4dbf
        ;   Label: LAB_004b4dbf
    CALL FUN_004280b0                   ; 004b4dc0
        ;   XREF to: 004280b0 (UNCONDITIONAL_CALL)  ; undefined FUN_004280b0()
