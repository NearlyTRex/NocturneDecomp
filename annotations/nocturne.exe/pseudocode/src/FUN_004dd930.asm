...
;                               FUNCTION
; *****************************************************************************
; int FUN_004dd930(undefined4 param_1)
;
;
; Referenced Globals:
...
;   undefined1* PTR_FUN_005a0ac4 = 004dda70
;
; Called Functions:
;   FUN_004b46d0
;   FUN_004e0050
...
section .text
    ...
    PUSH EAX                            ; 004dd96d
    MOV dword ptr [EBX + 0x14c],0x5a0ac4 ; 004dd96e | PTR_FUN_005a0ac4
    CALL FUN_0051e0c0                   ; 004dd978
