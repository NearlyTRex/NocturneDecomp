...
section .text
    ...
    PUSH EBX                            ; 004224d9
    INC EDI                             ; 004224da
    CALL FUN_00422c70                   ; 004224db
        ;   XREF to: 00422c70 (UNCONDITIONAL_CALL)  ; undefined FUN_00422c70()
