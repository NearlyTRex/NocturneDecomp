...
// Convention: unknown
// Signature: undefined4 FUN_004b54c0(int param_1)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_004b54c0(int param_1)

{
  ...
  iVar1 = FUN_004294f0(param_1);
  if (iVar1 == 0) {
    if (*(int *)(param_1 + 0x1fa0c) == 0) {
      iVar1 = 0;
      for (iVar5 = 0; iVar5 < *(int *)(0x01E57284 + 0x14cd6c); iVar5 = iVar5 + 1) {
        iVar3 = FUN_0040d890(*(uint *)(iVar1 + 0x14cd70 + 0x01E57284),DAT_00764838);
        if (((iVar3 != 0) && (*(int *)(iVar3 + 0x314) != 0)) && (*(int *)(iVar3 + 0x318) == 0)) {
          ...
          FUN_0040a240(iVar3,auStack_5c,&fStack_50);
          FUN_0040a290(param_1,auStack_38,auStack_5c);
          ...
          if (((fStack_30 - SQRT(fStack_3c * fStack_3c + fStack_44 * fStack_44) <=
            ...
            iVar4 = FUN_0054e4a0(auStack_2c,auStack_38);
            fStack_14 = (float)FUN_0040df00(*(uint *)(iVar4 + 4));
