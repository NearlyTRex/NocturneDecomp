...
// Convention: unknown
// Signature: int FUN_0042db50(int param_1,int param_2,int param_3,int param_4,int param_5)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

int FUN_0042db50(int param_1,int param_2,int param_3,int param_4,int param_5)
