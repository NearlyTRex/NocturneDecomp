...
// Convention: unknown
// Signature: int FUN_004d60d0(int param_1,byte param_2)
...

{
  ...
  if ((param_2 & 4) != 0) {
    uVar2 = __vec_delete(param_1,&DAT_005a0860);
    shape_memdbg_cpp_free_FUN_00564486(uVar2);
    return param_1;
  }
  iVar1 = core_stairs_cpp_CDemonTriangle_arrdtor_FUN_0043b5f0(param_1 + 0x308,0);
