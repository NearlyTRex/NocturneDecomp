...
section .text
    ...
    CALL FUN_004ee370                   ; 004d0e15
        ;   XREF to: 004ee370 (UNCONDITIONAL_CALL)  ; undefined FUN_004ee370()
        ;   Label: LAB_004d0e15
    ADD ESP,0x4                         ; 004d0e1a
    PUSH EAX                            ; 004d0e1d
    PUSH ESI                            ; 004d0e1e
    CALL FUN_00563c90                   ; 004d0e1f
        ;   XREF to: 00563c90 (UNCONDITIONAL_CALL)  ; undefined FUN_00563c90()
    ...
    CALL FUN_004cfbc0                   ; 004d120b
        ;   XREF to: 004cfbc0 (UNCONDITIONAL_CALL)  ; undefined FUN_004cfbc0()
    ADD ESP,0x8                         ; 004d1210
    JMP 0x004d1056                      ; 004d1213
        ;   XREF to: 004d1056 (UNCONDITIONAL_JUMP)  ; default
    PUSH 0x588b27                       ; 004d1218 | = "Adjust Y-Axis sensitivity"
        ;   Label: caseD_6
    CALL FUN_004ee370                   ; 004d121d
        ;   XREF to: 004ee370 (UNCONDITIONAL_CALL)  ; undefined FUN_004ee370()
