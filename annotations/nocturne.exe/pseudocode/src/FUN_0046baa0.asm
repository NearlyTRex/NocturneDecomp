...
;
; XREF[1]:
;   FUN_00511a10 at 00511a6a
;
; Referenced Globals:
;   undefined4 DAT_0057e3be
...
section .text
    ...
    FXCH ST2                            ; 0046baff
    FLD double ptr [0x0057e3be]         ; 0046bb01 | DAT_0057e3be
    FXCH                                ; 0046bb07
    FMUL ST1                            ; 0046bb09
    FLD1                                ; 0046bb0b
    FADDP                               ; 0046bb0d
    ...
    FMUL ST1                            ; 0046bbfa
    FXCH ST3                            ; 0046bbfc
    FLD double ptr [0x0057e3c6]         ; 0046bbfe | DAT_0057e3c6
    FXCH                                ; 0046bc04
    FMUL ST1                            ; 0046bc06
    ...
    PUSH EAX                            ; 0046bca5
    CALL FUN_0046bfe0                   ; 0046bca6
        ;   XREF to: 0046bfe0 (UNCONDITIONAL_CALL)  ; undefined FUN_0046bfe0()
