...
// Convention: unknown
// Signature: void FUN_004fd450(int param_1,float param_2,int param_3)
...

{
  ...
  *(uint *)(param_1 + 0x1fa64) = 0;
  if ((param_3 == 0) && (iVar3 = FUN_004e1660(param_1 + 0x150), *(int *)(iVar3 + 0x24) == 2)) {
    param_3 = 1;
  }
  ...
  FUN_005644a7(&local_138,10,&DAT_005993b0);
...
LAB_004fd81b:
  ...
  uVar4 = FUN_0040a240(*(uint *)(param_1 + 0x1fa60),auStack_6c,&fStack_60);
  FUN_0040a290(param_1,&fStack_9c,uVar4);
  pfVar5 = (float *)FUN_0051d2a0(param_1 + 0x150,auStack_a8,_DAT_01e533a0);
  fStack_84 = fStack_9c - *pfVar5;
  fStack_80 = fStack_98 - pfVar5[1];
  fStack_7c = fStack_94 - pfVar5[2];
  FUN_0054e4a0(&fStack_54,&fStack_84);
  local_13c = fStack_54;
  local_2c = fStack_50;
LAB_004fd4ed:
  local_38 = (float)FUN_0040df00(local_2c - *(float *)(param_1 + 0x1fa58));
  local_18 = local_38;
  local_18 = (float)FUN_0040df00(local_13c - *(float *)(param_1 + 0x1fa54));
  ...
  *(float *)(param_1 + 0x1fa58) = *(float *)(param_1 + 0x1fa58) + local_38;
  if ((*(int *)(param_1 + 0x1fa60) != 0) && (param_3 == 0)) {
    local_18 = (float)FUN_0040df00(*(float *)(param_1 + 0x1fa58) - local_2c);
    if (((float)_DAT_0058df6e <= ABS(local_18)) &&
       (fVar6 = (float)FUN_0040df00(*(float *)(param_1 + 0x1fa58) - local_2c),
