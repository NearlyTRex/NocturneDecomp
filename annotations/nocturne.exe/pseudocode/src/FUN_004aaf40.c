...
// Convention: unknown
// Signature: undefined4 FUN_004aaf40(int param_1,undefined4 *param_2)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_004aaf40(int param_1,uint *param_2)

{
  ...
  iVar4 = param_1 + 0x150;
  local_10 = (float)FUN_004e18d0(iVar4,0xb);
  if (local_10 <= 0.0) {
    return 0;
  }
  pfVar1 = (float *)FUN_0051d380(iVar4,local_40,_DAT_01c78c18);
  pfVar2 = (float *)FUN_0051d380(iVar4,local_88,_DAT_01c78c20);
  ...
  pfVar1 = (float *)FUN_0051d380(iVar4,local_94,_DAT_01c78c1c);
  pfVar2 = (float *)FUN_0051d380(iVar4,local_4c,_DAT_01c78c24);
  ...
  puVar3 = (uint *)FUN_0040a240(param_1,local_1c,&local_70);
  if (param_2 != puVar3) {
    *param_2 = *puVar3;
    param_2[1] = puVar3[1];
    param_2[2] = puVar3[2];
