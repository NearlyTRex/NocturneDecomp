...
section .text
    ...
    PUSH EBX                            ; 00416912
        ;   Label: LAB_00416912
    CALL FUN_00417eb0                   ; 00416913
        ;   XREF to: 00417eb0 (UNCONDITIONAL_CALL)  ; undefined FUN_00417eb0()
    ...
    PUSH dword ptr [ESP + 0x60]         ; 0041694f
        ;   Label: LAB_0041694f
    PUSH EBX                            ; 00416953
    CALL FUN_00416b00                   ; 00416954
        ;   XREF to: 00416b00 (UNCONDITIONAL_CALL)  ; undefined FUN_00416b00()
