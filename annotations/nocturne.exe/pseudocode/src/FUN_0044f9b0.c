...

{
  ...
  if (*(int *)(param_1 + 0x1cbc) != 0) {
    ...
    if (local_6c <= *(float *)(param_1 + 0x100)) {
      ...
      local_24 = (float *)(((local_6c * (float)_DAT_0057c7ee) / *(float *)(param_1 + 0x138)) *
                          (float)_DAT_0057c7f6);
      ...
      if (local_28 <= local_2c) {
        ...
        if (0.0 < local_140) {
          ...
          if (0.0 < (local_78 * pfVar2[2] + local_80 * *pfVar2 + local_7c * pfVar2[1]) * local_14 *
            ...
            piVar7 = DAT_005ae704;
            fVar5 = (float10)round
                                       ((float10)local_148 * (float10)_DAT_0057c806);
            ...
            do {
              local_18 = local_1c;
              fVar1 = (float)local_1c * _DAT_0057c80e * *(float *)(param_1 + 0x100);
              local_114 = *(float *)(param_1 + 0x118);
              local_148 = fVar1 * (float)_DAT_0057c81e;
              ...
              local_140 = *(float *)(puVar3 + 0x1c) * (float)_DAT_0057c816 *
