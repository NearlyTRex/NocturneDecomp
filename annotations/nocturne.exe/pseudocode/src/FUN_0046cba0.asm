...
;
; XREF[3]:
;   FUN_00453e10 at 00453eac
;   FUN_00510710 at 005107e9
;   FUN_00534a30 at 00534a58
;
; Called Functions:
;   FUN_0046c820
;   FUN_0046cb00
...
section .text
    ...
    PUSH EBP                            ; 0046cf7c
    PUSH ESI                            ; 0046cf7d
    CALL FUN_0046cb00                   ; 0046cf7e
        ;   XREF to: 0046cb00 (UNCONDITIONAL_CALL)  ; undefined FUN_0046cb00()
    ADD ESP,0xc                         ; 0046cf83
    MOV EBX,dword ptr [ESP + 0x3c]      ; 0046cf86
    PUSH EBX                            ; 0046cf8a
    PUSH EBP                            ; 0046cf8b
    PUSH ESI                            ; 0046cf8c
    CALL FUN_0046cb00                   ; 0046cf8d
        ;   XREF to: 0046cb00 (UNCONDITIONAL_CALL)  ; undefined FUN_0046cb00()
