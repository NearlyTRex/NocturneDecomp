...
// Convention: unknown
// Signature: int FUN_0050aee0(undefined4 param_1,float *param_2,undefined4 param_3,float *param_4,float *param_5,undefined4 param_6)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

int FUN_0050aee0(uint param_1,float *param_2,uint param_3,float *param_4,float *param_5,uint param_6)
  ...
  if (param_2 == (float *)0x0) {
    ...
    if (0 < _DAT_01fba2d8) {
      ...
      do {
        if ((*(int *)(*(int *)(iVar8 + 0x1fba2dc) + 0x1cb4) != 0) &&
           (iVar5 = FUN_00445fe0(*(int *)(iVar8 + 0x1fba2dc),param_2,param_3,param_4,param_5),
           iVar5 != 0)) {
    ...
    if (0 < _DAT_01fb9b54) {
      ...
      do {
        if ((*(int *)(*(int *)(&DAT_01fb9b58 + iVar8) + 0x1cb4) != 0) &&
           (iVar5 = FUN_00445fe0(*(int *)(&DAT_01fb9b58 + iVar8),param_2,param_3,param_4,param_5),
           iVar5 != 0)) {
    ...
    if (0 < _DAT_01fba9a4) {
      ...
      do {
        ...
        pfVar6 = (float *)FUN_0044daa0(param_6,local_a0,&local_64);
        if (&local_64 != pfVar6) {
          local_64 = *pfVar6;
          local_60 = pfVar6[1];
          local_5c = pfVar6[2];
    ...
    if (0 < _DAT_01fba2ec) {
      iVar8 = 0;
      do {
        iVar5 = FUN_0044d1f0(*(uint *)(iVar8 + 0x1fba2f0),param_2,param_6,param_4,param_5);
        if (iVar5 != 0) {
    ...
    if (0 < _DAT_01fba7a4) {
      iVar8 = 0;
      do {
        iVar5 = FUN_0044d1f0(*(uint *)(&DAT_01fba7a8 + iVar8),param_2,param_6,param_4,param_5)
        ;
        local_74 = 0;
        if (iVar5 != 0) {
          _DAT_01fff090 = _DAT_01fff090 + 1;
    ...
    if (0 < _DAT_01fff224) {
      ...
      pfVar6 = (float *)FUN_0044da40(param_6,local_58,&local_ac);
      iVar8 = 0;
      local_80 = 0.0;
      local_84 = 0.0;
      local_88 = 0.0;
