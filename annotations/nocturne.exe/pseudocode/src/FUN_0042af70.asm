...
;
; XREF[4]:
;   FUN_004b6d80 at 004b781f
;   FUN_004baba0 at 004bb08c
;   FUN_004de1b0 at 004de4e5
;   FUN_005423c0 at 005428ac
;
; Referenced Globals:
;   string s_%s_was_in_the_way,_but_couldn't_f_0057a4ce
;   undefined4 DAT_0057a50a
;   undefined4 DAT_0057a512
;   undefined4 DAT_0057a51a
;   undefined4 DAT_0057a522
;   undefined4 DAT_0057a52a
;   undefined4 DAT_0057a532
;   undefined4 DAT_0057a53a
;   undefined4 DAT_0057a542
;   undefined4 DAT_0057a54a
;   undefined4 DAT_0057a552
...
section .text
    ...
    FCOMP double ptr [0x0057a512]       ; 0042afaf | DAT_0057a512
    FNSTSW AX                           ; 0042afb5
    SAHF                                ; 0042afb7
    ...
    LEA ESI,[EDI + 0x20]                ; 0042aff3
        ;   Label: LAB_0042aff3
    PUSH ESI                            ; 0042aff6
    CALL FUN_004b4500                   ; 0042aff7
        ;   XREF to: 004b4500 (UNCONDITIONAL_CALL)  ; undefined FUN_004b4500()
    ...
    FCOMP double ptr [0x0057a50a]       ; 0042b09a | DAT_0057a50a
    FNSTSW AX                           ; 0042b0a0
    SAHF                                ; 0042b0a2
    ...
    FLD float ptr [ESP + 0x8]           ; 0042b146
        ;   Label: LAB_0042b146
    FCOMP double ptr [0x0057a54a]       ; 0042b14a | DAT_0057a54a
    FNSTSW AX                           ; 0042b150
    SAHF                                ; 0042b152
    ...
    FLD float ptr [ESP + 0x78]          ; 0042b22e
        ;   Label: LAB_0042b22e
    FABS                                ; 0042b232
    FCOMP double ptr [0x0057a51a]       ; 0042b234 | DAT_0057a51a
    FNSTSW AX                           ; 0042b23a
    SAHF                                ; 0042b23c
    JA 0x0042afba                       ; 0042b23d
        ;   XREF to: 0042afba (CONDITIONAL_JUMP)  ; LAB_0042afba
    FLD float ptr [ESP + 0x4]           ; 0042b243
    FCOMP double ptr [0x0057a522]       ; 0042b247 | DAT_0057a522
    FNSTSW AX                           ; 0042b24d
    SAHF                                ; 0042b24f
    ...
    FADDP                               ; 0042b26a
    FSQRT                               ; 0042b26c
    FCOMP double ptr [0x0057a52a]       ; 0042b26e | DAT_0057a52a
    FNSTSW AX                           ; 0042b274
    SAHF                                ; 0042b276
    ...
    FCOMP double ptr [0x0057a532]       ; 0042b28c | DAT_0057a532
    FNSTSW AX                           ; 0042b292
    SAHF                                ; 0042b294
    ...
    FMUL double ptr [0x0057a53a]        ; 0042b2d2 | DAT_0057a53a
    FMUL double ptr [0x0057a542]        ; 0042b2d8 | DAT_0057a542
    ...
    FLD float ptr [ESP]                 ; 0042b345
        ;   Label: LAB_0042b345
    FCOMP double ptr [0x0057a54a]       ; 0042b348 | DAT_0057a54a
    FNSTSW AX                           ; 0042b34e
    SAHF                                ; 0042b350
    ...
    FLD float ptr [ESP + 0x8]           ; 0042b39a
        ;   Label: LAB_0042b39a
    FADD float ptr [0x0057a552]         ; 0042b39e | DAT_0057a552
    ...
    FLD float ptr [ESP]                 ; 0042b3ba
        ;   Label: LAB_0042b3ba
    FADD float ptr [0x0057a552]         ; 0042b3bd | DAT_0057a552
