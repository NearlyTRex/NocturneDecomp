...
section .text
    ...
    PUSH EDI                            ; 0045a45b
    CALL FUN_004796c0                   ; 0045a45c
        ;   XREF to: 004796c0 (UNCONDITIONAL_CALL)  ; undefined FUN_004796c0()
    MOV EDX,dword ptr [0x005ae6c8]      ; 0045a461 | DAT_005ae6c8
    ...
    PUSH EAX                            ; 0045a47e
    CALL FUN_0040ca80                   ; 0045a47f
        ;   XREF to: 0040ca80 (UNCONDITIONAL_CALL)  ; undefined FUN_0040ca80()
    MOV ECX,dword ptr [0x005ae6c8]      ; 0045a484 | DAT_005ae6c8
    ...
    PUSH EAX                            ; 0045a4bf
    CALL FUN_0040c6d0                   ; 0045a4c0
        ;   XREF to: 0040c6d0 (UNCONDITIONAL_CALL)  ; undefined FUN_0040c6d0()
    MOV EBP,dword ptr [0x005ae6c8]      ; 0045a4c5 | DAT_005ae6c8
    ...
    CMP dword ptr [0x005ae6c8],0x7      ; 0045a580 | DAT_005ae6c8
        ;   Label: LAB_0045a580
    ...
    PUSH EAX                            ; 0045a594
    CALL FUN_0040c900                   ; 0045a595
        ;   XREF to: 0040c900 (UNCONDITIONAL_CALL)  ; undefined FUN_0040c900()
    ADD ESP,0x8                         ; 0045a59a
    CMP dword ptr [0x005ae6c8],0x8      ; 0045a59d | DAT_005ae6c8
        ;   Label: LAB_0045a59d
    ...
    CMP dword ptr [0x005ae6c8],0x9      ; 0045a620 | DAT_005ae6c8
        ;   Label: LAB_0045a620
