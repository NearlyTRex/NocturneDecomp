...
// Convention: unknown
// Signature: int FUN_004101d0(undefined4 param_1)

#include "nocturne.h"

int FUN_004101d0(uint param_1)

{
  ...
  *(byte ***)(iVar2 + 0x14c) = &PTR_FUN_00599ac4;
  FUN_0051e0c0(iVar2 + 0x150,"baron.dfm");
  ...
  *(uint *)(iVar2 + 0x1fb34) = 0;
  ...
  FUN_00454580(&DAT_0076436c,"baronshell.kfm");
