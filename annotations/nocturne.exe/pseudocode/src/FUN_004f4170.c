...
// Convention: unknown
// Signature: void FUN_004f4170(int param_1,int param_2,int param_3,uint param_4,int param_5,int param_6,int param_7)

#include "nocturne.h"

void FUN_004f4170(int param_1,int param_2,int param_3,uint param_4,int param_5,int param_6,int param_7)
