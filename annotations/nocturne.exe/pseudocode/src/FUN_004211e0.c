...
// Convention: unknown
// Signature: void FUN_004211e0(int param_1)
  ...
  *(uint *)(param_1 + 0x1212c) = 4;
      ...
      if (*pcVar9 == '\0') {
        ...
        *(int *)(param_1 + 0x1212c) = iVar5;
        if (iVar6 < iVar5) {
          ...
          iVar5 = iVar6;
          do {
            FUN_00454580(local_20,local_1c);
            iVar5 = iVar5 + 1;
        ...
        FUN_00454510(iVar6 * 0x17c + iVar3);
        pcVar9 = pcVar9 + 0x17c;
        iVar6 = iVar6 + 1;
      }
  ...
  if (0 < *(int *)(param_1 + 0xbd28)) {
    ...
    do {
      ...
      *puVar8 = 0;
      uVar4 = FUN_0040de00(0,*(int *)(param_1 + 0x1212c) + -1,fVar11,fVar12);
      fVar1 = fVar11 * (float)_DAT_00579c4d;
      fVar2 = fVar12 * (float)_DAT_00579c4d;
      puVar8[1] = uVar4;
      uVar4 = FUN_0040dda0(fVar2,fVar1);
      puVar8[3] = 0;
      puVar8[2] = uVar4;
      uVar4 = FUN_0040dda0(fVar2,fVar1);
      puVar8[4] = uVar4;
      ...
      puVar7[1] = puVar7[2];
      *puVar7 = puVar7[1];
      uVar4 = FUN_0040dda0(0xc0490fdb,0x40490fdb);
      puVar8[6] = uVar4;
      if (puVar10 != local_2c) {
        *puVar10 = puVar7[-3];
        puVar10[1] = puVar7[-2];
