...
// Convention: unknown
// Signature: void FUN_0050adc0(undefined4 param_1,undefined4 *param_2,undefined4 *param_3,undefined4 *param_4,undefined4 *param_5,undefined4 *param_6)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_0050adc0(uint param_1,uint *param_2,uint *param_3,uint *param_4,uint *param_5,uint *param_6)
