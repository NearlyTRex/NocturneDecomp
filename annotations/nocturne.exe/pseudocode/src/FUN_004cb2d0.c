...
// Convention: unknown
// Signature: void FUN_004cb2d0(int param_1,int param_2,float param_3)
...

{
  ...
  if (*piVar1 == 0) {
    local_14 = 1;
    iVar4 = FUN_004cb8f0(param_1,param_2);
...
LAB_004cb32e:
  *(float *)(param_1 + 0x1488 + param_2 * 4) = param_3;
  ...
  if (0.0 < local_24) {
    ...
    local_1c = piVar1 + 9;
    pfVar2 = (float *)FUN_0044da40(local_1c,local_6c,param_1 + 0x5dc);
    local_48 = (float)piVar1[3] + *pfVar2;
    local_44 = (float)piVar1[4] + pfVar2[1];
    local_40 = (float)piVar1[5] + pfVar2[2];
    FUN_0040a240(param_1,local_3c,&local_48);
    local_60 = 0;
    ...
    FUN_0044da40(local_1c,local_30,&local_60);
    FUN_0040a200(param_1,local_54,local_30);
    FUN_00511750(0x01E57284);
    FUN_0048b6b0(&local_114);
