...
;   FUN_004a0550 at 004a1fff
;   FUN_004bf360 at 004bff5e
;   FUN_004c1b90 at 004c1be5
;
; Referenced Globals:
...
section .text
    ...
    PUSH EAX                            ; 0040edf3
    CALL FUN_00454580                   ; 0040edf4
        ;   XREF to: 00454580 (UNCONDITIONAL_CALL)  ; undefined FUN_00454580()
    ADD ESP,0x8                         ; 0040edf9
    PUSH 0x5782b0                       ; 0040edfc | = "CCrossbow"
        ;   Label: LAB_0040edfc
    PUSH EBP                            ; 0040ee01
    CALL FUN_005649c0                   ; 0040ee02
        ;   XREF to: 005649c0 (UNCONDITIONAL_CALL)  ; undefined FUN_005649c0()
    ...
    PUSH EAX                            ; 0040ee28
        ;   Label: LAB_0040ee28
    CALL FUN_00454580                   ; 0040ee29
        ;   XREF to: 00454580 (UNCONDITIONAL_CALL)  ; undefined FUN_00454580()
    ADD ESP,0x8                         ; 0040ee2e
    PUSH 0x5782d2                       ; 0040ee31 | = "CDynamite"
        ;   Label: LAB_0040ee31
    PUSH EBP                            ; 0040ee36
    CALL FUN_005649c0                   ; 0040ee37
        ;   XREF to: 005649c0 (UNCONDITIONAL_CALL)  ; undefined FUN_005649c0()
    ...
    PUSH EAX                            ; 0040ee4e
    CALL FUN_00454580                   ; 0040ee4f
        ;   XREF to: 00454580 (UNCONDITIONAL_CALL)  ; undefined FUN_00454580()
    ADD ESP,0x8                         ; 0040ee54
    PUSH 0x5782ef                       ; 0040ee57 | = "CTommyGun"
        ;   Label: LAB_0040ee57
    PUSH EBP                            ; 0040ee5c
    CALL FUN_005649c0                   ; 0040ee5d
        ;   XREF to: 005649c0 (UNCONDITIONAL_CALL)  ; undefined FUN_005649c0()
    ...
    PUSH EAX                            ; 0040ef3c
    CALL FUN_00454580                   ; 0040ef3d
        ;   XREF to: 00454580 (UNCONDITIONAL_CALL)  ; undefined FUN_00454580()
    ADD ESP,0x8                         ; 0040ef42
    ADD EBX,0x150                       ; 0040ef45
    PUSH EBX                            ; 0040ef4b
    CALL FUN_00454510                   ; 0040ef4c
        ;   XREF to: 00454510 (UNCONDITIONAL_CALL)  ; undefined FUN_00454510()
