...
// Convention: unknown
// Signature: void FUN_0045bd50(int param_1,int param_2,int param_3,int param_4)
...

{
  ...
  if (0 < param_4) {
    ...
    if (((*(int *)(param_1 + 0x10) <= param_2 + param_4) ||
      ...
      iVar3 = 0;
      iVar4 = 1 - param_4;
      FUN_0045bf00(param_1,param_2,param_3,0,param_4);
      if (0 < param_4) {
        iVar2 = 1;
        do {
          iVar3 = iVar3 + 1;
          ...
          iVar4 = iVar4 + iVar1;
          FUN_0045bf00(param_1,param_2,param_3,iVar3,param_4);
        } while (iVar3 < param_4);
      }
    }
  }
