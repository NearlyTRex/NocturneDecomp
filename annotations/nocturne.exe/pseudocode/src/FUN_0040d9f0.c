...
// Convention: unknown
// Signature: undefined4 FUN_0040d9f0(int param_1,undefined4 param_2,undefined4 param_3)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_0040d9f0(int param_1,uint param_2,uint param_3)

{
  ...
  FUN_0040a240(param_1,&local_34,param_2);
  ...
  local_1c = (float)FUN_0050ec80(0x01E57284,&local_34,0);
  uVar1 = *(uint *)(0x01E57284 + 0x14cd4c);
  local_8 = local_1c;
  local_18 = (float)FUN_0050ec80(0x01E57284,param_1 + 0x20,0);
  local_8 = local_18;
