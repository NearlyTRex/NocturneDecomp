...
;
; Referenced Globals:
;   undefined4 DAT_0058a2d9
;   undefined4 DAT_0058a2e1
;
; Called Functions:
;   FUN_0040a240
;
...
section .text
    ...
    FADD double ptr [0x0058a2e1]        ; 004da5ef | DAT_0058a2e1
    ...
    FADD double ptr [0x0058a2d9]        ; 004da662 | DAT_0058a2d9
