...
;
; XREF[2]:
;   FUN_00506f10 at 00507711
;   FUN_005084c0 at 00508697
;
; Called Functions:
;   FUN_00513e80
;   FUN_00514300
...
section .text
    ...
    PUSH EBX                            ; 00514251
    PUSH EDI                            ; 00514252
    CALL FUN_00514300                   ; 00514253
        ;   XREF to: 00514300 (UNCONDITIONAL_CALL)  ; undefined FUN_00514300()
    INC EBX                             ; 00514258
    ...
    PUSH EBP                            ; 005142a2
        ;   Label: LAB_005142a2
    PUSH ESI                            ; 005142a3
    CALL FUN_00513e80                   ; 005142a4
        ;   XREF to: 00513e80 (UNCONDITIONAL_CALL)  ; undefined FUN_00513e80()
