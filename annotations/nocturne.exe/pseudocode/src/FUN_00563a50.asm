...
section .text
    ...
    PUSH EDX                            ; 00563a62
    CALL dword ptr [0x005c1ac0]         ; 00563a63 | PTR_FUN_005c1ac0
    ...
    CALL dword ptr [0x005c1ac4]         ; 00563a8b | PTR_FUN_005c1ac4
    ...
    PUSH EAX                            ; 00563aa7
    CALL dword ptr [0x005c1ac4]         ; 00563aa8 | PTR_FUN_005c1ac4
    ...
    CALL dword ptr [0x005c1abc]         ; 00563b2f | PTR_FUN_005c1abc
    ...
    CALL dword ptr [0x005c1ac4]         ; 00563c6e | PTR_FUN_005c1ac4
