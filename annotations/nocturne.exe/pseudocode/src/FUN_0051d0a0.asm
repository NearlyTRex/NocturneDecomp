...
section .text
    ...
    LEA EAX,[ESP + 0x30]                ; 0051d1ae
        ;   Label: LAB_0051d1ae
    PUSH EAX                            ; 0051d1b2
    CALL FUN_0055ac80                   ; 0051d1b3
        ;   XREF to: 0055ac80 (UNCONDITIONAL_CALL)  ; undefined FUN_0055ac80()
