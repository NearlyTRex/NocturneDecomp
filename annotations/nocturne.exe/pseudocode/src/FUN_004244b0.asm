...
section .text
    ...
    PUSH EAX                            ; 004244cf
    CALL FUN_0040c880                   ; 004244d0
        ;   XREF to: 0040c880 (UNCONDITIONAL_CALL)  ; undefined FUN_0040c880()
    MOV EDX,dword ptr [0x005ad1e8]      ; 004244d5 | DAT_005ad1e8
    ...
    CMP dword ptr [0x005ad1e8],0x3      ; 00424560 | DAT_005ad1e8
        ;   Label: LAB_00424560
    ...
    PUSH EAX                            ; 004245d6
    CALL FUN_0040c880                   ; 004245d7
        ;   XREF to: 0040c880 (UNCONDITIONAL_CALL)  ; undefined FUN_0040c880()
    ADD ESP,0x8                         ; 004245dc
    CMP dword ptr [0x005ad1e8],0x6      ; 004245df | DAT_005ad1e8
        ;   Label: LAB_004245df
