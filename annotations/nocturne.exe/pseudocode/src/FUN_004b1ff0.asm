...
section .text
    ...
    PUSH EBX                            ; 004b2079
    DEC ESI                             ; 004b207a
    CALL FUN_004b1e10                   ; 004b207b
        ;   XREF to: 004b1e10 (UNCONDITIONAL_CALL)  ; undefined FUN_004b1e10()
