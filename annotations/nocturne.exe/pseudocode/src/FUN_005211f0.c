...
// Convention: unknown
// Signature: void FUN_005211f0(undefined4 *param_1,int param_2,int param_3,int param_4,int param_5)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_005211f0(uint *param_1,int param_2,int param_3,int param_4,int param_5)
