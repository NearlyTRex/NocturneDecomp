...
;                               FUNCTION
; *****************************************************************************
; void FUN_0044b660(undefined4 param_1)
;
; Local Variables:
...
section .text
    ...
    CALL wincore_windll.cpp_clearScreen_FUN_0052ee70 ; 0044b699
    ...
    CALL engine_2d.c_clearInputAndWait_FUN_00403f50 ; 0044b6e1
        ;   XREF to: 00403f50 (UNCONDITIONAL_CALL)  ; undefined engine_2d.c_clearInputAndWait_FUN_00403f50()
    CALL wincore_windll.cpp_clearScreen_FUN_0052ee70 ; 0044b6e6
        ;   XREF to: 0052ee70 (UNCONDITIONAL_CALL)  ; undefined wincore_windll.cpp_clearScreen_FUN_0052ee70()
