...
// Convention: unknown
// Signature: undefined4 FUN_004b81a0(int param_1,float param_2)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_004b81a0(int param_1,float param_2)

{
  ...
  *(float *)(param_1 + 0x1f954) = param_2;
  if ((0.0 < param_2) && (*(float *)(param_1 + 0x2dcc) <= (float)_DAT_00585caa)) {
    ...
    iVar1 = FUN_0054e4a0(local_14,&local_20);
    local_8 = FUN_0040df00(*(float *)(iVar1 + 4) - *(float *)(param_1 + 0x34));
