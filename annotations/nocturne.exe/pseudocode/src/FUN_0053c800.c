...

{
  ...
  if ((((*(int *)(param_1 + 0x1fa08) == 0) && (*(int *)(param_1 + 0x24f0) != 0)) &&
      ((*(int *)(param_1 + 0x2a84) == 0xe ||
       (fVar5 = (float)FUN_0042a9d0(param_1,0), (float)_DAT_00595bd7 <= fVar5)))) &&
     (fVar5 = (float)FUN_004e18d0(param_1 + 0x150,0), 1.0 <= fVar5)) {
    ...
    if ((iVar6 == 0) ||
      ...
      for (local_28 = 0; local_28 < *(int *)(0x01E57284 + 0x14cd6c); local_28 = local_28 + 1) {
        iVar6 = FUN_0040d890();
        if ((iVar6 != 0) && (iVar9 = FUN_0044bab0(), iVar9 != 0)) {
          pfVar10 = (float *)FUN_0040a290();
          pfVar11 = (float *)FUN_0040a290();
          fVar5 = *pfVar11;
          fVar1 = *pfVar10;
          fVar8 = pfVar11[1];
          fVar12 = pfVar10[1];
          fVar2 = pfVar11[2];
          fVar3 = pfVar10[2];
          FUN_0043ac60(PTR_DAT_005ad350,"Delta to dest : %3.2f,%3.2f,%3.2f\n",
      ...
      {
        iVar9 = FUN_0040d890(*(uint *)(0x01E57284 + iVar6 + 0x14cd70),_DAT_014b8a54);
        if ((iVar9 != 0) && (iVar13 = FUN_0044bab0(), iVar13 != 0)) {
          pfVar10 = (float *)FUN_0040a290();
          pfVar11 = (float *)FUN_0040a290();
    ...
    if (fVar12 < 1.0) {
      ...
      if (ABS(fVar12 - *(float *)(param_1 + 0x24)) <= 1.0) {
        ...
        while( true ) {
          ...
          iVar13 = FUN_0040d890(*(uint *)(iVar9 + 0x14cd70 + 0x01E57284),DAT_0077bd78);
          if ((iVar13 != 0) &&
