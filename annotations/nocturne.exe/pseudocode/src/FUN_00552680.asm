...
;
; XREF[3]:
;   FUN_00428c00 at 00428e75
;   FUN_0042a1e0 at 0042a35b
;   FUN_004b6d80 at 004b77f4
;
; Referenced Globals:
...
section .text
    ...
    PUSH EDX                            ; 0055269f
    CALL FUN_005523b0                   ; 005526a0
        ;   XREF to: 005523b0 (UNCONDITIONAL_CALL)  ; undefined FUN_005523b0()
