...
// Convention: unknown
// Signature: void FUN_00442d9c(void)
...

{
  ...
  *(int *)(unaff_EBP + 0x16c) = (int)ROUND(*(float *)(unaff_EBP + 0x104) * _DAT_0059bddc);
  *(int *)(unaff_EBP + 0x170) = (int)ROUND(*(float *)(unaff_EBP + 0x108) * _DAT_0059bddc);
  *(int *)(unaff_EBP + 0x174) = (int)ROUND(*(float *)(unaff_EBP + 0x10c) * _DAT_0059bddc);
