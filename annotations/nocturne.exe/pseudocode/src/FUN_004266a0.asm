...
;
; XREF[3]:
;   FUN_00424260 at 0042434d
;   FUN_004269b0 at 00426e33
...
section .text
    ...
    CALL FUN_0051e020                   ; 00426826
        ;   XREF to: 0051e020 (UNCONDITIONAL_CALL)  ; undefined FUN_0051e020()
    ADD ESP,0x4                         ; 0042682b
    PUSH EBP                            ; 0042682e
    PUSH EAX                            ; 0042682f
    CALL FUN_00519bc0                   ; 00426830
        ;   XREF to: 00519bc0 (UNCONDITIONAL_CALL)  ; undefined FUN_00519bc0()
