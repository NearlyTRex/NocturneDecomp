...
// Convention: unknown
// Signature: void FUN_004e5d80(undefined4 *param_1,undefined4 *param_2,int param_3,int *param_4)

#include "nocturne.h"

void FUN_004e5d80(uint *param_1,uint *param_2,int param_3,int *param_4)
