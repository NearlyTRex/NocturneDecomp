...
// Convention: unknown
// Signature: float FUN_005520d0(int param_1,undefined4 param_2,undefined4 param_3,float *param_4)

#include "nocturne.h"

float FUN_005520d0(int param_1,uint param_2,uint param_3,float *param_4)

{
  ...
  fStack_18 = (float)FUN_0041d550(uVar1);
  if ((fStack_18 < 0.0) || (1.0 < fStack_18)) {
    ...
    if (0 < iStack_1c) {
      ...
      do {
        FUN_0046c5b0(auStack_88,*(int *)(iVar2 + 0x18) * 0x20 + param_1,
                     *(int *)(iVar2 + 0x24) * 0x20 + param_1,*(int *)(iVar2 + 0x30) * 0x20 + param_1
                    );
        fStack_18 = (float)FUN_0046c620(auStack_88,param_2,param_3);
