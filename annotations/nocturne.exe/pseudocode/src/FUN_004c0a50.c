...
// Convention: unknown
// Signature: void FUN_004c0a50(int param_1,int param_2)
...

{
  ...
  if (*(int *)(param_1 + 0x330) != 0) {
    ...
    do {
      ...
      iVar1 = FUN_0040d890(*(uint *)(param_1 + 0xc + iVar4 * 4),_DAT_02ddf9a8);
      if (iVar1 != 0) {
        uVar2 = FUN_00409fa0(*(uint *)(param_1 + 0x330));
        uVar2 = FUN_00409fa0(iVar1,uVar2);
        iVar3 = FUN_005649c0(uVar2);
        if (iVar3 == 0) {
