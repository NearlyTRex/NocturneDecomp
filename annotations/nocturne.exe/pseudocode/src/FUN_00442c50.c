...
// Convention: unknown
// Signature: undefined4 FUN_00442c50(undefined4 param_1,int *param_2,int param_3,int *param_4)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_00442c50(uint param_1,int *param_2,int param_3,int *param_4)

{
  ...
  uVar8 = FUN_004425f0(param_1,param_2,param_3,iVar7);
  return uVar8;
}
