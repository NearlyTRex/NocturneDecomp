...
;
; XREF[2]:
;   FUN_004d0d20 at 004d127c
;   FUN_004d2d00 at 004d3be6
;
; Referenced Globals:
...
section .text
    ...
    PUSH 0x1cc5780                      ; 004cf8ea
        ;   Label: LAB_004cf8ea
    CALL FUN_004df040                   ; 004cf8ef
        ;   XREF to: 004df040 (UNCONDITIONAL_CALL)  ; undefined FUN_004df040()
    ADD ESP,0x4                         ; 004cf8f4
    PUSH 0x5884f5                       ; 004cf8f7 | = "Center gamepad, press ENTER"
    CALL FUN_004ee370                   ; 004cf8fc
