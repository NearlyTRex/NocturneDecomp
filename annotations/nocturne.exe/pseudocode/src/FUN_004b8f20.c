...
// Convention: unknown
// Signature: void FUN_004b8f20(int param_1,float param_2)
...

{
  ...
  *(uint *)(param_1 + 0x23a4) = *(uint *)(param_1 + 0x23a8);
  ...
  iVar3 = param_1 + 0x150;
  while (0.0 < local_2c) {
    uVar6 = FUN_004e11c0(iVar3,&local_2c);
  ...
  case 6:
    ...
    if (iVar3 != 0) {
      ...
      if (local_28 < 0x40000000) {
        FUN_0054e4a0(local_40,&local_c4);
        local_14 = (float)FUN_0040df00(local_3c - *(float *)(param_1 + 0x34));
        if (ABS(local_14) < (float)_DAT_00585f6d) {
          ...
          FUN_004e16b0(param_1 + 0x150,uVar6,1);
          iVar3 = FUN_00526c50(*(uint *)(param_1 + 0xbd24));
          if (iVar3 == 0) {
      ...
      *(uint *)(param_1 + 0x23a4) = *(uint *)(param_1 + 0x23a8);
      ...
      if (-1 < iVar5) {
        ...
        if ((local_20 <= local_1c) && (*(float *)(param_1 + 0xbca0) <= 0.0)) {
          ...
          FUN_0054e4a0(local_88,&local_70);
          local_14 = (float)FUN_0040df00(local_84 - *(float *)(param_1 + 0x34));
          if (ABS(local_14) < (float)_DAT_00585f6d) {
            if (iVar4 == 7) {
              uVar6 = 8;
            }
...
LAB_004b93d5:
  ...
  case 2:
  case 8:
    FUN_00423ed0(local_10c);
    local_108 = (float)FUN_0040dda0(0x40e00000,0x41700000);
    local_d8 = param_1;
    local_d4 = param_1;
    local_14 = local_108;
    uVar6 = FUN_0055a8b0(local_4c,&DAT_02dd1184,_DAT_01cae1e8 * 0x30 + param_1 + 0xfd0,0x3ecccccd,
                         local_10c);
    uVar6 = FUN_0040a240(param_1,local_d0,uVar6);
    FUN_004798e0(param_1,uVar6);
    break;
  case 5:
  case 0xb:
    if ((*(int *)(param_1 + 0xbc90) == 0) && (*(int *)(param_1 + 0xdc) == 0)) {
      uVar6 = FUN_0051d2a0(param_1 + 0x150,local_ac,0);
      FUN_0040a240(param_1,local_b8,uVar6);
