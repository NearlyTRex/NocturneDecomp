...
section .text
    ...
    MOV dword ptr [0x01c00c7c],0x52f031 ; 0045f929 | DAT_01c00c7c | LAB_0052f031
    ...
    XOR EDI,EDI                         ; 0045f99b
        ;   Label: LAB_0045f99b
    MOV ESI,0x463a79                    ; 0045f99d | LAB_00463a79
    ...
    MOV dword ptr [0x01c00c7c],0x52f823 ; 0045f9b6 | DAT_01c00c7c | LAB_0052f823
        ;   Label: LAB_0045f9b6
