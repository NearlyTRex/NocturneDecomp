...
// Convention: unknown
// Signature: int FUN_004e82d0(char *param_1,undefined4 *param_2,int param_3)

#include "nocturne.h"

int FUN_004e82d0(char *param_1,uint *param_2,int param_3)

{
  ...
  while( true ) {
    ...
    for (; 0x47f < param_3; param_3 = param_3 - iVar3) {
      iVar3 = FUN_004e85b0(param_1,param_2);
      if (iVar3 < 1) {
        return local_14;
      }
      local_14 = local_14 + iVar3;
    ...
    if (param_3 < 1) break;
    iVar3 = FUN_004e85b0(param_1,param_1 + 0x110);
