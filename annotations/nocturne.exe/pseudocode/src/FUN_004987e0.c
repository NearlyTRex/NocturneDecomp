...
// Convention: unknown
// Signature: undefined4 FUN_004987e0(int param_1)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_004987e0(int param_1)

{
  ...
  *(uint *)(param_1 + 0x1fa14) = 0;
  do {
    ...
    iVar1 = FUN_0040d890(*(uint *)(0x01E57284 + local_1c + 0x14cd70),_DAT_01cc3120);
    local_24 = iVar1;
    if (iVar1 != 0) {
      ...
      {
        FUN_0040a290(param_1,&local_90,(float *)(iVar1 + 0x20));
        if ((ABS(local_90) <= (float)_DAT_00582192) &&
           (((float)_DAT_0058219a <= local_88 && ((double)local_88 <= _DAT_0058218a)))) {
          iVar2 = FUN_0054e4a0(local_54,&local_90);
          local_18 = (float)FUN_0040df00(*(uint *)(iVar2 + 4));
          if (ABS(local_18) <= (float)_DAT_005821a2) {
            local_20 = 0;
            pfVar3 = (float *)FUN_0040a290(iVar1,local_78,(float *)(param_1 + 0x20));
            if (&local_90 != pfVar3) {
              local_90 = *pfVar3;
              local_8c = pfVar3[1];
              local_88 = pfVar3[2];
            ...
            if (((ABS(local_90) <= (float)_DAT_00582192) && ((float)_DAT_0058219a <= local_88)) &&
              ...
              iVar1 = FUN_0054e4a0(local_30,&local_90);
              local_18 = (float)FUN_0040df00(*(uint *)(iVar1 + 4));
              if (ABS(local_18) <= (float)_DAT_005821a2) {
                ...
                *(uint *)(param_1 + 0xbca0) = 0;
                ...
                puVar4 = (uint *)FUN_0040a240(local_24,local_6c,&local_84);
                ...
                *(uint *)(param_1 + 0x28) = puVar4[2];
                ...
                iVar5 = FUN_0054e4a0(local_3c,&local_48);
