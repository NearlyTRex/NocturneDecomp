...
section .text
    ...
    PUSH EDX                            ; 0051e946
    PUSH ESI                            ; 0051e947
    CALL FUN_00519ec0                   ; 0051e948
        ;   XREF to: 00519ec0 (UNCONDITIONAL_CALL)  ; undefined FUN_00519ec0()
