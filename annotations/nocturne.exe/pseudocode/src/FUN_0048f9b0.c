...
// Convention: unknown
// Signature: float * FUN_0048f9b0(int param_1,float *param_2,float *param_3)
...

{
  ...
  local_18 = (float)FUN_0040dda0(*(float *)(param_1 + 0x150) * (float)_DAT_00581747,
                                 *(float *)(param_1 + 0x150) * (float)_DAT_0058173f);
  *param_2 = local_18;
  fVar6 = (float)FUN_0040dda0(*(float *)(param_1 + 0x158) * (float)_DAT_00581747,
