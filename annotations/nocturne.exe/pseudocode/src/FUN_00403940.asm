...
;                               FUNCTION
; *****************************************************************************
; void FUN_00403940(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH EDX                            ; 00403973
    CALL FUN_00403990                   ; 00403974
        ;   XREF to: 00403990 (UNCONDITIONAL_CALL)  ; undefined FUN_00403990()
