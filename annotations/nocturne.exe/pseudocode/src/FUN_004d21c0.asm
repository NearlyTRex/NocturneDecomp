...
section .text
    ...
    JMP dword ptr [EBX*0x4 + 0x4d21ac]  ; 004d22e6 | caseD_0 | caseD_1 | caseD_2
        ;   Label: switchD
    CALL FUN_004d0080                   ; 004d22ed
        ;   XREF to: 004d0080 (UNCONDITIONAL_CALL)  ; undefined FUN_004d0080()
        ;   Label: caseD_0
    PUSH 0x1                            ; 004d22f2
        ;   Label: default
    ...
    CALL FUN_004d12e0                   ; 004d2342
        ;   XREF to: 004d12e0 (UNCONDITIONAL_CALL)  ; undefined FUN_004d12e0()
        ;   Label: caseD_1
    ...
    CALL FUN_004d0d20                   ; 004d2354
        ;   XREF to: 004d0d20 (UNCONDITIONAL_CALL)  ; undefined FUN_004d0d20()
    MOV EAX,[0x005b9354]                ; 004d2359 | DAT_005b9354
    CMP EBX,dword ptr [EAX + 0xbc]      ; 004d235e | DAT_01c776a8
    JZ 0x004d22f2                       ; 004d2364
        ;   XREF to: 004d22f2 (CONDITIONAL_JUMP)  ; default
    CALL FUN_004d2d00                   ; 004d2366
        ;   XREF to: 004d2d00 (UNCONDITIONAL_CALL)  ; undefined FUN_004d2d00()
    JMP 0x004d22f2                      ; 004d236b
        ;   XREF to: 004d22f2 (UNCONDITIONAL_JUMP)  ; default
    MOV EBP,dword ptr [0x005b9354]      ; 004d236d | DAT_005b9354
        ;   Label: caseD_3
    PUSH EBP                            ; 004d2373 | DAT_01c775ec
    CALL FUN_004a6e90                   ; 004d2374
        ;   XREF to: 004a6e90 (UNCONDITIONAL_CALL)  ; undefined FUN_004a6e90()
    ADD ESP,0x4                         ; 004d2379
    MOV EAX,[0x005bed68]                ; 004d237c | DAT_005bed68
    PUSH EAX                            ; 004d2381
    CALL FUN_0052e850                   ; 004d2382
        ;   XREF to: 0052e850 (UNCONDITIONAL_CALL)  ; undefined FUN_0052e850()
