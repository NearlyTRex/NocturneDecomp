...

{
  ...
  bVar8 = 0;
  iVar4 = FUN_0047dc30(0x01C03A10,param_1 + 0xbd38);
  if (iVar4 != 0) {
    ...
    *(uint *)(param_1 + 0xc348) = 0;
    ...
    FUN_004e1990(param_1 + 0x150,5,0);
  }
  ...
  if (*(int *)(param_1 + 0xc344) == 2) {
    ...
    *(float *)(param_1 + 0xc348) = fVar2;
    if (fVar2 < 1.0) {
      ...
      do {
        ...
        FUN_0055d2d0(local_28,local_20,*(uint *)(param_1 + 0xc348));
        puVar11 = &local_12c;
        pfVar5 = &local_88;
        ...
        FUN_0055d5b0(pfVar5,puVar11);
        local_88 = *(float *)(param_1 + 0xc348) * (float)_DAT_00579366 + local_88;
    ...
    *(uint *)(param_1 + 0xc344) = 0;
    fVar2 = *(float *)(param_1 + 0xbd9c) * (float)_DAT_00579336;
    *(uint *)(param_1 + 0x2434) = 0x42c80000;
    *(float *)(param_1 + 0xbd9c) = fVar2;
    if (fVar2 <= (float)_DAT_0057933e) {
  ...
  *(uint *)(param_1 + 0x23a4) = *(uint *)(param_1 + 0x23a8);
  ...
  iVar4 = param_1 + 0x150;
  while (0.0 < local_38) {
    iVar7 = FUN_004e11c0(iVar4,&local_38);
    if (iVar7 == 100) {
      iVar7 = *(int *)(param_1 + 0xbd30);
      if (iVar7 != 0) {
        *(uint *)(param_1 + 0xbd30) = 0;
        FUN_00428f40(param_1,1,iVar7,0x3e4ccccd);
      }
    }
    else {
      FUN_0042add0(param_1,iVar7);
    }
  }
  fVar3 = (float)_DAT_00579346;
  fVar2 = (float)_DAT_0057934e;
  ...
  if (iVar6 == 0) {
    ...
    case 1:
      ...
      if (*(int *)(param_1 + 0xbca4) == 0) {
        ...
        if (iVar4 == 0) {
          ...
          iVar4 = FUN_004247f0(param_1,*(int *)(param_1 + 0xbca4) + 0x20,uVar9);
          if (iVar4 < 0) {
            ...
            if ((SQRT(fVar3 * fVar3 + fVar2 * fVar2) <= local_30 + (float)_DAT_00579336) &&
              ...
              FUN_004e16b0(param_1 + 0x150,uVar9,1);
      ...
      break;
    case 2:
      FUN_00423ed0(local_180);
      local_17c = FUN_0040dda0(0x40e00000,0x41700000);
      puVar12 = local_180;
      local_14c = param_1;
      local_148 = param_1;
      uVar10 = 0x3ecccccd;
      ...
      FUN_0055a8b0();
      uVar9 = FUN_0040a240();
      FUN_004798e0(param_1,uVar9,uVar10,puVar12);
      break;
    case 5:
    ...
    case 6:
      ...
      if (iVar4 != 0) {
        ...
        local_c4 = local_10c * _DAT_00579356;
        local_108 = local_140 + local_134;
        local_104 = local_13c + local_130;
        local_c0 = local_108 * _DAT_00579356;
        local_bc = local_104 * _DAT_00579356;
        ...
        local_f8 = local_13c;
        local_ec = local_130;
        pfVar5 = (float *)FUN_0040a240(*(uint *)(param_1 + 0x24f0),local_a0,&local_100);
        if (&local_100 != pfVar5) {
          local_100 = *pfVar5;
          local_fc = pfVar5[1];
          local_f8 = pfVar5[2];
        }
        pfVar5 = (float *)FUN_0040a240(*(uint *)(param_1 + 0x24f0),local_58,&local_f4);
        if (&local_f4 != pfVar5) {
          local_f4 = *pfVar5;
          local_f0 = pfVar5[1];
          local_ec = pfVar5[2];
        }
        FUN_00423ed0(local_1bc);
        local_1b8 = FUN_0040dda0(0x41700000,0x41c80000);
        local_188 = *(uint *)(param_1 + 0x24f0);
        local_184 = param_1;
        local_14 = (float)local_1b8;
        FUN_00479990(param_1,&local_100,&local_f4,local_1bc);
      }
    }
  }
  else {
...
LAB_0041907c:
  ...
  if (iVar4 != 0) {
    ...
    *(float *)(param_1 + 0x2424) = *(float *)(param_1 + 0x2424) - param_2 * (float)_DAT_0057935e;
    ...
    *(float *)(param_1 + 0x23a4) = *(float *)(param_1 + 0x23a8);
    FUN_00425050(param_1,&local_dc);
  }
  FUN_004259a0(param_1);
  FUN_0051b8a0(param_1 + 0x150);
  FUN_0042a150(param_1,param_2);
  if ((local_34 == 1) &&
     (iVar4 = FUN_00527880((double)*(float *)(param_1 + 0x20),(double)*(float *)(param_1 + 0x24),
                           (double)*(float *)(param_1 + 0x28),0,0x40590000), iVar4 != 0)) {
    iVar4 = FUN_00526c50(*(uint *)(param_1 + 0xbd34));
    if (iVar4 != 0) {
      return;
    }
    FUN_00526340();
