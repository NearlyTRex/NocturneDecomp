...
section .text
    ...
    PUSH EDI                            ; 00444ff4
    PUSH EBX                            ; 00444ff5
    CALL FUN_00446fe0                   ; 00444ff6
        ;   XREF to: 00446fe0 (UNCONDITIONAL_CALL)  ; undefined FUN_00446fe0()
