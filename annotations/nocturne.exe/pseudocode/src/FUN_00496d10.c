...
// Convention: unknown
// Signature: void FUN_00496d10(int param_1)
...

{
  ...
  if (*(int *)(param_1 + 0x1fa38) != 0) {
    ...
    if ((float)_DAT_00582082 <= local_120) {
      iVar4 = FUN_004f1600(*(int *)(_DAT_01cae0e8 * 4 + 0x1cae0d8) + 0xbcc0,param_1 + 0x20,local_c0,
                           *(uint *)(param_1 + 0x6c));
      if (iVar4 != 0) {
        fVar3 = (float)FUN_0040df00(local_bc - *(float *)(param_1 + 0x34));
      ...
      if ((*(int *)(param_1 + 0x1fa38) == 2) || (*(int *)(param_1 + 0x1fa38) == 3)) {
        iVar4 = FUN_004b5d00(param_1,&local_11c);
      }
      if ((iVar4 == 0) || ((float)_DAT_0058209a <= local_11c)) {
        ...
        iVar1 = FUN_0054e4a0(local_e4,&local_6c);
        local_18 = (float)FUN_0040df00(*(float *)(iVar1 + 4) - *(float *)(param_1 + 0x34));
        ...
        *(float *)(param_1 + 0xbcb8) = fVar3;
        ...
        if (((float)_DAT_005820a2 < *(float *)(param_1 + 0xbcb8)) &&
          ...
          *(uint *)(0x01E57284 + 0x14cd5c) = 0;
          FUN_0050fb00(iVar1,&fStack_78,&fStack_48);
