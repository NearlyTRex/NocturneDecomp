...
// Convention: unknown
// Signature: void FUN_00447670(undefined4 param_1,float *param_2,undefined4 param_3)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_00447670(uint param_1,float *param_2,uint param_3)

{
  ...
  _DAT_01c038f4 = (float *)FUN_004475a0(param_1,&local_10,param_3);
