...

{
  ...
  if (*(int *)(param_1 + 0x2e4) == 0) {
    ...
    FUN_00467930(&DAT_01fba938,local_54,(uint *)(param_1 + 0x2f0),&local_48);
    ...
    if (*(float *)(param_1 + 0x24) <
      ...
      *(uint *)(param_1 + 0x24) = *(uint *)(param_1 + 0x2e8);
      if (*(int *)(param_1 + 0x32c) == 0) {
        iVar4 = 0;
        do {
          fStack_60 = (float)FUN_0040dda0(0xbf000000,0x3f000000);
          fStack_14 = fStack_60;
          fStack_5c = (float)FUN_0040dda0(0xbf000000,0x3f000000);
          fStack_14 = fStack_5c;
          fStack_14 = (float)FUN_0040dda0(0xbf000000,0x3f000000);
          fStack_60 = fStack_60 + *(float *)(param_1 + 0x20);
          fStack_5c = fStack_5c + *(float *)(param_1 + 0x24);
          fStack_58 = fStack_14 + *(float *)(param_1 + 0x28);
          FUN_0048afe0(0x01C08D04,&fStack_60,0x3f000000,0,0xffff);
          fStack_1c = (float)FUN_0040dda0(0x3f490fdb,0x3fc90fdb);
          fStack_14 = fStack_1c;
          fStack_14 = (float)FUN_0040dda0(0,0x40c90fdb);
          ...
          uVar3 = FUN_00454530(0x1b7b330);
          iVar4 = iVar4 + 1;
          FUN_0048b320(0x01C08D04,(float *)(param_1 + 0x20),&fStack_3c,uVar3);
        } while (iVar4 < 10);
      }
      *(uint *)(param_1 + 0x24) = *(uint *)(param_1 + 0x2f4);
      fStack_14 = (float)FUN_0040dda0(0,0x3f800000);
      *(float *)(param_1 + 0x20) =
      ...
      *(uint *)(param_1 + 0x2fc) = *(uint *)(param_1 + 0x300);
      fStack_14 = (float)FUN_0040dda0(*(uint *)(param_1 + 0x2d8),
                                      *(uint *)(param_1 + 0x2dc));
