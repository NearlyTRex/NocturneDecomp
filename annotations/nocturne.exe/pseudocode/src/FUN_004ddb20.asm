...
;                               FUNCTION
; *****************************************************************************
; void FUN_004ddb20(int param_1,float param_2)
;
; Local Variables:
...
section .text
    ...
    JZ 0x004ddb3b                       ; 004dddf5
        ;   XREF to: 004ddb3b (CONDITIONAL_JUMP)  ; LAB_004ddb3b
    PUSH EBX                            ; 004dddfb
    CALL FUN_004de700                   ; 004dddfc
        ;   XREF to: 004de700 (UNCONDITIONAL_CALL)  ; undefined FUN_004de700()
    ...
    PUSH EBX                            ; 004dde5a
    CALL FUN_004de1b0                   ; 004dde5b
        ;   XREF to: 004de1b0 (UNCONDITIONAL_CALL)  ; undefined FUN_004de1b0()
    ADD ESP,0x8                         ; 004dde60
    LEA EAX,[EBX + 0x150]               ; 004dde63
        ;   Label: LAB_004dde63
    PUSH EAX                            ; 004dde69
    CALL FUN_004e1660                   ; 004dde6a
