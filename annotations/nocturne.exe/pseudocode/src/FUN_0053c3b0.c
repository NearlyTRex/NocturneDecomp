...
// Convention: unknown
// Signature: undefined4 FUN_0053c3b0(int param_1)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_0053c3b0(int param_1)

{
  ...
  *(uint *)(param_1 + 0x1fa90) = 0;
  local_18 = (float)FUN_0042a9d0(param_1,0);
  if ((((float)_DAT_00595b57 <= local_18) && (*(int *)(param_1 + 0x24ac) == 0)) &&
     (*(int *)(param_1 + 0x24f0) == 0)) {
    local_28 = param_1 + 0x20;
    local_20 = 0;
    for (local_1c = 0; local_1c < *(int *)(0x01E57284 + 0x14cd6c); local_1c = local_1c + 1) {
      iVar2 = FUN_0040d890(*(uint *)(0x01E57284 + local_20 + 0x14cd70),_DAT_01cc3120);
      if ((iVar2 != 0) &&
         (ABS(*(float *)(param_1 + 0x24) - (*(float *)(iVar2 + 0x24) + *(float *)(iVar2 + 0x2d0)))
          <= (float)_DAT_00595b67)) {
        FUN_0040a290(iVar2,&local_d0,local_28);
        if ((ABS(local_c8) <= (float)_DAT_00595b6f) && (local_c8 <= 0.0)) {
          ...
          if (local_d0 < local_e8) {
            if (local_d0 < local_e8 + (float)_DAT_00595b77) goto LAB_0053c438;
            local_d0 = local_e8;
          }
          fStack_7c = local_e8 + fStack_dc;
          fStack_94 = fStack_7c * _DAT_00595b5f;
          fStack_74 = fStack_e0 + fStack_d4;
          fStack_78 = fStack_e4 + fStack_d8;
          local_c8 = fStack_74 * _DAT_00595b5f;
          fStack_90 = fStack_78 * _DAT_00595b5f;
          fStack_8c = local_c8;
          pfVar3 = (float *)FUN_0040a240(iVar2,auStack_88,&local_d0);
          if (&local_d0 != pfVar3) {
            local_d0 = *pfVar3;
            fStack_cc = pfVar3[1];
            local_c8 = pfVar3[2];
          ...
          fVar5 = (float10)fcos((float10)_DAT_00595b7f);
          ...
          if (fVar5 <= (float10)fVar1) {
            iVar4 = FUN_0040a290(param_1,auStack_70,iVar2 + 0x20);
            if (0.0 < *(float *)(iVar4 + 8)) {
              FUN_0043ac60(PTR_DAT_005ad350,"?Ladder dot : %f\n" + 1,(double)fVar1);
              *(int *)(param_1 + 0x1fa90) = iVar2;
              FUN_004e16b0(param_1 + 0x150,0x2b,1);
              *(uint *)(param_1 + 0xbca0) = 0;
              uStack_9c = *(uint *)(iVar2 + 0x2d0);
              uStack_a0 = 0;
              uStack_98 = 0xbfc00000;
              uStack_2c = uStack_9c;
              pfVar3 = (float *)FUN_0040a240(iVar2,auStack_58,&uStack_a0);
              ...
              iVar2 = FUN_0054e4a0(auStack_c4,&fStack_4c);
