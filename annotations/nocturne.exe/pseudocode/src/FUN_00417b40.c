...
// Convention: unknown
// Signature: void FUN_00417b40(int param_1,undefined4 *param_2)

#include "nocturne.h"

void FUN_00417b40(int param_1,uint *param_2)

{
  ...
  if (*(int *)(param_1 + 0x744) < 2) {
    ...
    *(int *)(param_1 + 0x744) = *(int *)(param_1 + 0x744) + 1;
    ...
    puVar2 = (uint *)FUN_0040a240(param_1,local_18,puVar6);
    puVar6[0xb] = *puVar2;
    puVar6[0xc] = puVar2[1];
    puVar6[0xd] = puVar2[2];
    FUN_0048d050(puVar6 + 3);
    puVar6[0x6c] = 0;
    ...
    *(uint *)(param_1 + 0x184) = 1;
    ...
    uVar4 = FUN_0040dda0(0x41400000,0x41a00000);
