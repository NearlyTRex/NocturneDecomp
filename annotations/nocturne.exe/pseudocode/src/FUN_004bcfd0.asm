...
section .text
    ...
    PUSH 0x59f6d0                       ; 004bd061 | DAT_0059f6d0
        ;   Label: LAB_004bd061
    PUSH EBX                            ; 004bd066
    CALL FUN_0056445f                   ; 004bd067
        ;   XREF to: 0056445f (UNCONDITIONAL_CALL)  ; undefined FUN_0056445f()
    ADD ESP,0x8                         ; 004bd06c
    PUSH EAX                            ; 004bd06f
    CALL FUN_00564486                   ; 004bd070
