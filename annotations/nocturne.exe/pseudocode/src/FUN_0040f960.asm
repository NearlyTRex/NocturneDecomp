...
;   undefined4 DAT_005997a8
;   undefined4 DAT_005997ac
;   undefined1* PTR_FUN_005997b4 = 0040fa00
;
; Called Functions:
...
section .text
    ...
    MOV dword ptr [EAX + 0x14c],0x5997b4 ; 0040f983 | PTR_FUN_005997b4
    CALL core_skeleton.cpp_CDeformableModelInstance_init_FUN_0051e0c0 ; 0040f98d
        ;   XREF to: 0051e0c0 (UNCONDITIONAL_CALL)  ; undefined core_skeleton.cpp_CDeformableModelInstance_init_FUN_0051e0c0()
    FLD float ptr [0x005997a8]          ; 0040f992 | DAT_005997a8
    FLD float ptr [0x005997ac]          ; 0040f998 | DAT_005997ac
