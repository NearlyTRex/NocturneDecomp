...
;
; XREF[3]:
;   FUN_0040a740 at 0040a783
;   FUN_0050ec80 at 0050ef95
;   FUN_00510a40 at 00510d46
;
; Called Functions:
;   FUN_0040a200
;   FUN_0041cc00
...
section .text
    ...
    PUSH EAX                            ; 0040a5d7
    PUSH EDI                            ; 0040a5d8
    CALL FUN_0040a200                   ; 0040a5d9
        ;   XREF to: 0040a200 (UNCONDITIONAL_CALL)  ; undefined FUN_0040a200()
    ADD ESP,0xc                         ; 0040a5de
    PUSH EAX                            ; 0040a5e1
    PUSH ESI                            ; 0040a5e2
    INC EBX                             ; 0040a5e3
    CALL FUN_0041cc00                   ; 0040a5e4
