...
;
; XREF[1]:
;   FUN_00411010 at 00411046
;
; Referenced Globals:
;   undefined4 s_baron-attack.wav_0057866e+2
;   undefined4 DAT_00578688
;   undefined4 DAT_00578690
...
section .text
    ...
    FCOMP double ptr [0x00578688]       ; 00410d6e | DAT_00578688
    FNSTSW AX                           ; 00410d74
    SAHF                                ; 00410d76
    ...
    FLD double ptr [ESP]                ; 00410e22
        ;   Label: LAB_00410e22
    FCOMP double ptr [0x00578690]       ; 00410e25 | DAT_00578690
    FNSTSW AX                           ; 00410e2b
    SAHF                                ; 00410e2d
    ...
    PUSH EAX                            ; 00410fec
    CALL FUN_0048c4a0                   ; 00410fed
        ;   XREF to: 0048c4a0 (UNCONDITIONAL_CALL)  ; undefined FUN_0048c4a0()
    ADD ESP,0x18                        ; 00410ff2
    PUSH 0x578670                       ; 00410ff5 | s_baron-attack.wav_0057866e+2
