...
section .text
    ...
    PUSH EAX                            ; 00474993
    CALL FUN_0056626c                   ; 00474994
        ;   XREF to: 0056626c (UNCONDITIONAL_CALL)  ; undefined FUN_0056626c()
    ADD ESP,0x14                        ; 00474999
    LEA EAX,[ESP + 0x430]               ; 0047499c
    PUSH EAX                            ; 004749a3
    PUSH EBP                            ; 004749a4
    CALL FUN_00474140                   ; 004749a5
        ;   XREF to: 00474140 (UNCONDITIONAL_CALL)  ; undefined FUN_00474140()
