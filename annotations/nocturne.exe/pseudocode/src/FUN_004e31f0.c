...
// Convention: unknown
// Signature: void FUN_004e31f0(undefined4 param_1,int param_2,int param_3)

#include "nocturne.h"

void FUN_004e31f0(uint param_1,int param_2,int param_3)

{
  ...
  if (0 < iVar5) {
    ...
    do {
      ...
      if (0 < iVar1) {
        ...
        do {
          uVar2 = FUN_004e2ac0(param_1,*(uint *)(local_18 + 4));
          iVar6 = iVar6 + 1;
          *puVar3 = uVar2 & 0xff;
          puVar3 = puVar3 + 0x20;
        } while (iVar6 < iVar1);
  ...
  if (iVar5 < iVar8) {
    ...
    do {
      uVar2 = FUN_004e2ac0(param_1,*(uint *)(iVar7 + 4));
      iVar7 = iVar7 + 0x100;
