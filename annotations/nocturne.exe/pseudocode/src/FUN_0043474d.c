...
code_r0x0043474d:
  *(byte *)(in_ECX + 0x30) = *(byte *)(in_ECX + 0x30) ^ (byte)((uint)unaff_EBX >> 8);
  piVar7 = in_EDX;
  piVar9 = (int *)((int)&DAT_00767b4c + unaff_EDI);
  ...
  do {
    ...
    unaff_EBP = &DAT_0076814c + uVar5 * 0xc;
    bVar3 = unaff_EBX[0xe] <= *in_EDX;
    if ((int)(&DAT_00768154)[uVar5 * 0xc] <= *unaff_EBP) {
      bVar3 = bVar3 | 2;
    }
    unaff_EBX = in_EDX;
    ...
    case 0:
      piVar7 = in_EDX;
      piVar9 = &DAT_00767b4c + DAT_00767b40 * 0xc;
      for (iVar4 = 0xc; iVar4 != 0; iVar4 = iVar4 + -1) {
        *piVar9 = *piVar7;
        piVar7 = piVar7 + (uint)bVar14 * -2 + 1;
        piVar9 = piVar9 + (uint)bVar14 * -2 + 1;
