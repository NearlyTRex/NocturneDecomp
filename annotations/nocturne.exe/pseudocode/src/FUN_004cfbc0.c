...
// Convention: unknown
// Signature: void FUN_004cfbc0(int *param_1,undefined4 param_2)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_004cfbc0(int *param_1,uint param_2)

{
  ...
  FUN_00471a80(0x01BCD074,(int)((DAT_005b761c * 3 + iVar3 * -4) - (uint)(iVar3 << 1 < 0)) >> 2,
               0x2c,param_2,0);
  iVar3 = *param_1;
  if (iVar3 < 0x4000) {
    *param_1 = 0x4000;
...
LAB_004cfc23:
  iVar3 = *param_1;
  FUN_00403f50();
  FUN_00558d60((int)(((longlong)(DAT_005b761c + -1) * (longlong)(iVar3 + -0x4000)) / 0x3c000),
               _DAT_01bd1d90);
  local_18 = 0;
  do {
    FUN_004722b0();
    ...
    FUN_00403ef0(iVar5,iVar1,iVar4,iVar2,0,0xff,iVar1,iVar2);
    FUN_00403e60(iVar5,iVar1,
                 (int)(((longlong)(iVar4 - iVar5) * (longlong)(iVar3 + -0x4000)) / 0x3c000) + iVar5,
                 iVar2,4);
    iVar2 = _DAT_01c00c64 + _DAT_01c00c5c;
    iVar1 = FUN_004930e0(_DAT_01bcd070,0x41,0xff,0,"%4.2f",(double)iVar3 * _DAT_00588543);
    FUN_00490e30(_DAT_01bcd070,_DAT_01c00c58,_DAT_01c00c60,(iVar2 - iVar1) / 2);
    FUN_00553910();
