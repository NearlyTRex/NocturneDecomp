...
// Convention: unknown
// Signature: void FUN_005580b0(int *param_1,undefined4 param_2,LPCSTR param_3,int param_4,int param_5,int param_6 ,int param_7)

#include "nocturne.h"

void FUN_005580b0(int *param_1,uint param_2,LPCSTR param_3,int param_4,int param_5,int param_6 ,int param_7)

{
  ...
  if (((param_6 == param_1[0x4b]) && (param_7 == param_1[0x4c])) &&
     (iVar4 = FUN_005649c0(param_1 + 6,param_3), iVar4 == 0)) goto LAB_00558202;
  param_1[0x4b] = param_6;
  local_28 = 0;
  param_1[0x4c] = param_7;
  if (param_6 < 0) {
    local_34 = FUN_00491140();
