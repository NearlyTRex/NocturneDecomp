...
;   string s_%s_confused_while_walking_to_scr_0057dea3
;   string s_%s_gave_up_chase_-_I'm_confused_0057decd
;   string s_drone-attack?.wav_0057deee
;   string s_slime.wav_0057df00
;   undefined4 DAT_0057df0c
;   undefined4 DAT_0057df14
;   undefined4 DAT_0057df1c
;   undefined4 DAT_0057df24
...
section .text
    ...
    FMUL double ptr [0x0057df14]        ; 00462ad5 | DAT_0057df14
    FMULP                               ; 00462adb
    FMUL double ptr [0x0057df1c]        ; 00462add | DAT_0057df1c
    FLD double ptr [0x0057df0c]         ; 00462ae3 | DAT_0057df0c
    ...
    CALL FUN_00527880                   ; 00462bb9
        ;   XREF to: 00527880 (UNCONDITIONAL_CALL)  ; undefined FUN_00527880()
    ...
    PUSH EAX                            ; 00462c15
    MOV EDX,dword ptr [0x005be368]      ; 00462c16 | DAT_005be368
    PUSH EDX                            ; 00462c1c | DAT_01e57284
    CALL FUN_00511780                   ; 00462c1d
        ;   XREF to: 00511780 (UNCONDITIONAL_CALL)  ; undefined FUN_00511780()
    ADD ESP,0x8                         ; 00462c22
    FLD float ptr [EBP + 0x92]          ; 00462c25
        ;   Label: LAB_00462c25
    FLD ST0                             ; 00462c2b
    FMUL double ptr [0x0057df24]        ; 00462c2d | DAT_0057df24
    ...
    PUSH 0x0                            ; 00462d3e
    PUSH ESI                            ; 00462d40
    CALL FUN_004e16b0                   ; 00462d41
        ;   XREF to: 004e16b0 (UNCONDITIONAL_CALL)  ; undefined FUN_004e16b0()
    ADD ESP,0xc                         ; 00462d46
    PUSH EBX                            ; 00462d49
    PUSH 0x57dea3                       ; 00462d4a | = "%s confused while walking to scriptDe..."
    MOV EAX,[0x005ad350]                ; 00462d4f | PTR_DAT_005ad350
    PUSH EAX                            ; 00462d54 | DAT_0077ad0c
    CALL FUN_0043ac60                   ; 00462d55
    ...
    PUSH EAX                            ; 00462e60
    PUSH EBX                            ; 00462e61
    CALL FUN_0040a240                   ; 00462e62
        ;   XREF to: 0040a240 (UNCONDITIONAL_CALL)  ; undefined FUN_0040a240()
    ADD ESP,0xc                         ; 00462e67
    PUSH EAX                            ; 00462e6a
    PUSH EBX                            ; 00462e6b
    CALL FUN_004798e0                   ; 00462e6c
        ;   XREF to: 004798e0 (UNCONDITIONAL_CALL)  ; undefined FUN_004798e0()
    ...
    PUSH EAX                            ; 00462ea6
    PUSH EBX                            ; 00462ea7
    CALL FUN_0040a240                   ; 00462ea8
        ;   XREF to: 0040a240 (UNCONDITIONAL_CALL)  ; undefined FUN_0040a240()
    ADD ESP,0xc                         ; 00462ead
    PUSH 0x1                            ; 00462eb0
    LEA EAX,[EBP + -0xa]                ; 00462eb2
    PUSH EAX                            ; 00462eb5
    MOV EDX,dword ptr [0x005b96c4]      ; 00462eb6 | DAT_005b96c4
    PUSH EDX                            ; 00462ebc
    CALL FUN_004b0480                   ; 00462ebd
    ...
    MOV ECX,dword ptr [0x005ad350]      ; 0046304b | PTR_DAT_005ad350
    PUSH ECX                            ; 00463051 | DAT_0077ad0c
    CALL FUN_0043ac60                   ; 00463052
        ;   XREF to: 0043ac60 (UNCONDITIONAL_CALL)  ; undefined FUN_0043ac60()
    ADD ESP,0xc                         ; 00463057
    PUSH 0x1                            ; 0046305a
    PUSH EDI                            ; 0046305c
    PUSH ESI                            ; 0046305d
    CALL FUN_004e16b0                   ; 0046305e
        ;   XREF to: 004e16b0 (UNCONDITIONAL_CALL)  ; undefined FUN_004e16b0()
