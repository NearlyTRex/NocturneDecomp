...
;
; XREF[4]:
;   FUN_00416030 at 00416175
;   FUN_004614b0 at 004614d7
;   FUN_00463580 at 0046388e
;   FUN_004dfea0 at 004dff69
;
; Referenced Globals:
...
section .text
    ...
    MOV EBP,0x463a79                    ; 0045f4cc | LAB_00463a79
    ...
    PUSH EBP                            ; 0045f515
    PUSH EBX                            ; 0045f516
    CALL FUN_00461ad0                   ; 0045f517
        ;   XREF to: 00461ad0 (UNCONDITIONAL_CALL)  ; undefined FUN_00461ad0()
    ...
    MOV dword ptr [0x01c00c7c],0x52f031 ; 0045f5a3 | DAT_01c00c7c | LAB_0052f031
    ...
    MOV dword ptr [0x01c00c7c],0x52f823 ; 0045f5c6 | DAT_01c00c7c | LAB_0052f823
        ;   Label: LAB_0045f5c6
