...
section .text
    ...
    PUSH ESI                            ; 004c0958
    CALL FUN_004c1d70                   ; 004c0959
        ;   XREF to: 004c1d70 (UNCONDITIONAL_CALL)  ; undefined FUN_004c1d70()
