...
section .text
    ...
    PUSH EBX                            ; 00570a94
        ;   Label: LAB_00570a94
    CALL dword ptr [0x005c1ac0]         ; 00570a95 | PTR_FUN_005c1ac0
    ADD ESP,0x4                         ; 00570a9b
    PUSH EBX                            ; 00570a9e
    CALL FUN_00568a50                   ; 00570a9f
        ;   XREF to: 00568a50 (UNCONDITIONAL_CALL)  ; undefined FUN_00568a50()
    ADD ESP,0x4                         ; 00570aa4
    PUSH EBX                            ; 00570aa7
    MOV ESI,EAX                         ; 00570aa8
    CALL dword ptr [0x005c1ac4]         ; 00570aaa | PTR_FUN_005c1ac4
    ADD ESP,0x4                         ; 00570ab0
    PUSH EBX                            ; 00570ab3
    CALL dword ptr [0x005c1acc]         ; 00570ab4 | PTR_FUN_005c1acc
