...
// Convention: unknown
// Signature: int FUN_004783c0(undefined4 param_1)

#include "nocturne.h"

int FUN_004783c0(uint param_1)

{
  ...
  iVar2 = FUN_00454490(iVar2 + 0x240);
  *(byte ***)(iVar2 + -0xf4) = &PTR_FUN_0059cc74;
  ...
  *(uint *)(iVar2 + -0x14) = 0;
  *(uint *)(iVar2 + 0x200) = 0;
  FUN_00454580(iVar2,"stalrock.kfm");
