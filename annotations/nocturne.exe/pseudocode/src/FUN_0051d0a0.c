...
// Convention: unknown
// Signature: void FUN_0051d0a0(int param_1,int param_2)
...

{
  ...
  if (param_2 < 0) {
    ...
    if (iVar1 < 0) {
      ...
      FUN_0055a8b0(&local_1c,param_1 + 0x58 + local_10,local_4c);
      local_70 = local_1c;
      local_60 = local_18;
      local_50 = local_14;
    }
    FUN_0055cd70(&local_7c,param_2 * 0x10 + param_1 + 0x6b0);
