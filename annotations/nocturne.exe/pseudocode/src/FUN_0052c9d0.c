...
// Convention: unknown
// Signature: void FUN_0052c9d0(void)
...

{
  ...
  FUN_00527610((double)local_cc,(double)local_c8,(double)local_c4);
  local_d8 = 0x3f800000;
  local_d4 = 0;
  local_d0 = 0;
  FUN_0044da40();
  ...
  local_ac = 0x3f800000;
  FUN_0044da40();
  FUN_00527690((double)afStack_38[2],(double)afStack_38[3],(double)local_28,(double)local_c0,
        ...
        do {
          ...
          *(float *)((int)&stack0xffffff20 + (uint)bVar6 * 0xfffffffe * 4) =
          ...
          if ((int)local_dc < 0x7fffffff) {
            ...
            FUN_004411b0(0x1fb8508,&stack0xffffff1c);
            local_90 = local_54;
