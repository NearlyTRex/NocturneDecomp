...
section .text
    ...
    PUSH EBP                            ; 00515411
        ;   Label: LAB_00515411
    CALL FUN_00450170                   ; 00515412
        ;   XREF to: 00450170 (UNCONDITIONAL_CALL)  ; undefined FUN_00450170()
