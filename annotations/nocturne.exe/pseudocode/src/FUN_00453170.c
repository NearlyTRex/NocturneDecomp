...
// Convention: unknown
// Signature: void FUN_00453170(int param_1,int *param_2,undefined4 param_3)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_00453170(int param_1,int *param_2,uint param_3)
      ...
      do {
        ...
        if ((param_2 == (int *)0x0) || (*local_20 != 0)) {
          if ((*(int *)(param_1 + 0x120) < 2) || (iVar4 != 0)) {
            if (iVar4 == 0) {
              FUN_00461eb0(DAT_005ae704,param_1 + 0x124);
            }
            ...
            while (iVar8 < iVar5) {
              ...
              if (iVar9 != iVar6) {
                FUN_00461eb0(DAT_005ae704,iVar6 * 0x48 + param_1 + 0x124);
