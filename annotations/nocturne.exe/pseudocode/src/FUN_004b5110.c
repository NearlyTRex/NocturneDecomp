...
// Convention: unknown
// Signature: int FUN_004b5110(int param_1)
...

{
  ...
  *(uint *)(param_1 + 0x1fa04) = 0;
  do {
    ...
    iVar2 = FUN_0040d890(*(uint *)(0x01E57284 + local_14 + 0x14cd70),_DAT_01af4ed4);
    if ((iVar2 != 0) && (*(int *)(iVar2 + 0x2d8) == 0)) {
      ...
      iVar3 = FUN_0040a290(param_1,local_24,iVar2 + 0x20);
      if ((0.0 < *(float *)(iVar3 + 8)) &&
         ((ABS(fVar6) <= (float)_DAT_00585843 &&
          (SQRT(fVar1 * fVar1 + fVar5 * fVar5) < (float)_DAT_0058584b)))) {
        iVar3 = FUN_00481890(iVar2 + 0x470,fVar5,0);
        if (iVar3 != 0) {
          return 1;
        }
        local_18 = FUN_004564b0(iVar2,param_1);
        if (local_18 != 0) {
          if (local_18 == 1) {
            FUN_00455270(iVar2);
            return local_18;
