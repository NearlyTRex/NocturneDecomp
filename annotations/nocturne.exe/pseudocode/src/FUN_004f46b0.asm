...
section .text
    ...
    PUSH EAX                            ; 004f46d6
    PUSH EBX                            ; 004f46d7
    CALL FUN_004f4700                   ; 004f46d8
        ;   XREF to: 004f4700 (UNCONDITIONAL_CALL)  ; undefined FUN_004f4700()
