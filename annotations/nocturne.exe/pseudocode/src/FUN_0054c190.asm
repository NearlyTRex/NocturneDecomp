...
section .text
    ...
    POP EBX                             ; 0054c21f
    RET                                 ; 0054c220
    PUSH 0x5a3a40                       ; 0054c221 | DAT_005a3a40
        ;   Label: LAB_0054c221
    PUSH EBX                            ; 0054c226
    CALL FUN_0056445f                   ; 0054c227
        ;   XREF to: 0056445f (UNCONDITIONAL_CALL)  ; undefined FUN_0056445f()
    ADD ESP,0x8                         ; 0054c22c
    PUSH EAX                            ; 0054c22f
    CALL FUN_00564486                   ; 0054c230
