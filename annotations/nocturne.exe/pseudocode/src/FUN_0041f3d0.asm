...
section .text
    ...
    PUSH EBX                            ; 0041f3e6
    CALL FUN_0041e5e0                   ; 0041f3e7
        ;   XREF to: 0041e5e0 (UNCONDITIONAL_CALL)  ; undefined FUN_0041e5e0()
