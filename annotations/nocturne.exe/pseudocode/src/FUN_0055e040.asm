...
;
; XREF[2]:
;   FUN_0045ed80 at 0045ee23
;   FUN_00460e80 at 00460ede
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBP                            ; 0055e4da
    CALL FUN_0055d6b0                   ; 0055e4db
        ;   XREF to: 0055d6b0 (UNCONDITIONAL_CALL)  ; undefined FUN_0055d6b0()
    ...
    PUSH EBP                            ; 0055e574
    CALL FUN_0055d770                   ; 0055e575
        ;   XREF to: 0055d770 (UNCONDITIONAL_CALL)  ; undefined FUN_0055d770()
    ...
    PUSH EBP                            ; 0055e60e
    CALL FUN_0055d830                   ; 0055e60f
        ;   XREF to: 0055d830 (UNCONDITIONAL_CALL)  ; undefined FUN_0055d830()
