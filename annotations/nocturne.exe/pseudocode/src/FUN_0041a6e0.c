...
// Convention: unknown
// Signature: void FUN_0041a6e0(int param_1,undefined4 param_2,undefined4 param_3,undefined4 *param_4,undefined4 param_5)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_0041a6e0(int param_1,uint param_2,uint param_3,uint *param_4,uint param_5)

{
  ...
  *(float *)(param_1 + 0x228) = -*(float *)(param_1 + 0xac) * fVar1;
  FUN_0041aaa0(param_1,param_2,param_3,param_5);
  return;
}
