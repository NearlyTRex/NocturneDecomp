...
// Convention: unknown
// Signature: void FUN_004f4310(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6,int param_7)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_004f4310(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6,int param_7)

{
  if ((*(int *)(param_1 + 0x20) != 0) && (*(int *)(param_1 + 0x14) != 0)) {
    ...
    if ((((param_4 <= param_6) && (param_5 <= param_7)) && (0 < param_6)) &&
      ...
      FUN_004f4170(param_1,param_2,param_3,param_4,param_5,param_6,param_7);
    }
  }
  return;
}
