...
section .text
    ...
    CALL FUN_004b21b0                   ; 00549356
        ;   XREF to: 004b21b0 (UNCONDITIONAL_CALL)  ; undefined FUN_004b21b0()
    ...
    CALL FUN_004606e0                   ; 005493d9
        ;   XREF to: 004606e0 (UNCONDITIONAL_CALL)  ; undefined FUN_004606e0()
    ADD ESP,0x8                         ; 005493de
    MOV EAX,[0x005ba8ec]                ; 005493e1 | DAT_005ba8ec
    PUSH EAX                            ; 005493e6
    CALL FUN_004b2110                   ; 005493e7
        ;   XREF to: 004b2110 (UNCONDITIONAL_CALL)  ; undefined FUN_004b2110()
    ADD ESP,0x4                         ; 005493ec
    MOV EAX,ESP                         ; 005493ef
    PUSH EAX                            ; 005493f1
    MOV EDX,dword ptr [0x005ae704]      ; 005493f2 | DAT_005ae704
    PUSH EDX                            ; 005493f8 | DAT_01b4d738
    CALL FUN_00460700                   ; 005493f9
