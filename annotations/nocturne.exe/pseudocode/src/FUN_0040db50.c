...
// Convention: unknown
// Signature: undefined4 FUN_0040db50(int param_1,float *param_2,int param_3,float param_4)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_0040db50(int param_1,float *param_2,int param_3,float param_4)
