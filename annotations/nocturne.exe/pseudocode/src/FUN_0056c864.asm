...
section .text
    ...
    PUSH ESI                            ; 0056c9f6
    CALL FUN_0056c750                   ; 0056c9f7
        ;   XREF to: 0056c750 (UNCONDITIONAL_CALL)  ; undefined FUN_0056c750()
    ...
    PUSH EAX                            ; 0056ca35
    CALL FUN_005709b0                   ; 0056ca36
        ;   XREF to: 005709b0 (UNCONDITIONAL_CALL)  ; undefined FUN_005709b0()
