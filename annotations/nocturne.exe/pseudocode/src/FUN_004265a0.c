...
// Convention: unknown
// Signature: void FUN_004265a0(int param_1)
  ...
  if (0 < *(int *)(param_1 + 0x2dec)) {
    ...
    do {
      if (*(int *)(*piVar2 * 4 + param_1 + 0x2290) != 0) {
        FUN_0055aa00(piVar2 + 2,piVar2[1] * 0x30 + local_14);
        puVar4 = local_8c;
        puVar5 = local_5c;
        ...
        FUN_0055b180(local_5c,local_2c);
        local_20 = local_50;
        local_1c = local_40;
        local_18 = local_30;
        FUN_00460aa0(DAT_005ae704,local_2c,&local_20);
        FUN_004544d0(&DAT_007658e4,0,0xffffffff);
