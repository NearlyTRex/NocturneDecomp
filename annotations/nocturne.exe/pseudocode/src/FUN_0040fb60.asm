...
;                               FUNCTION
; *****************************************************************************
; void FUN_0040fb60(int param_1)
;
;
; Referenced Globals:
;   TerminatedCString s_speed_00578482
;   string s_modelName_00578488
;   string s_motion_state_00578492
;   string s_fallApartEvent_0057849f
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 0040fb9c
    CALL core_actor.cpp_FUN_0040cb00    ; 0040fb9d
