...
;
; Referenced Globals:
;   undefined4 DAT_0057f17c
;   undefined4 DAT_0057f184
...
section .text
    ...
    FLD float ptr [EBX + 0x570]         ; 0047825d
        ;   Label: LAB_0047825d
    FMUL double ptr [0x0057f17c]        ; 00478263 | DAT_0057f17c
    FMUL double ptr [0x0057f184]        ; 00478269 | DAT_0057f184
