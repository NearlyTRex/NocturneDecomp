...
section .text
    ...
    PUSH ESI                            ; 004398f4
    PUSH EDI                            ; 004398f5
    CALL FUN_004394b0                   ; 004398f6
        ;   XREF to: 004394b0 (UNCONDITIONAL_CALL)  ; undefined FUN_004394b0()
