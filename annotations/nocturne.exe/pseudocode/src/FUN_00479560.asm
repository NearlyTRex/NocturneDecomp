...
;   void* PTR_FUN_0059cdb4 = 004796b0
;
; Called Functions:
;   FUN_0040dda0
;   FUN_0040de00
...
section .text
    ...
    MOV dword ptr [EAX + 0x14c],0x59cdb4 ; 0047957f | PTR_FUN_0059cdb4
    CALL FUN_0040dda0                   ; 00479589
