...
// Convention: unknown
// Signature: int FUN_00504c70(int param_1,int param_2,int param_3)
    ...
    do {
      ...
      if (*pcVar1 == '{') {
        ...
        iVar4 = iVar4 + -1;
              ...
              (iVar3 = FUN_00564bc0(pcVar1,&DAT_0058faef,2), iVar3 != 0)) {
        if (((iVar4 < 1) && (param_3 == 0)) ||
           (iVar3 = FUN_00564bc0(pcVar1,&DAT_0058faf2,4), iVar3 != 0)) {
          if (iVar4 == 0) {
            if (!bVar2) {
              return param_2;
            }
          ...
          param_2 = FUN_00504c70(param_1,param_2 + 1,1);
        }
      }
      else {
        param_2 = FUN_00504c70(param_1,param_2 + 1,1);
