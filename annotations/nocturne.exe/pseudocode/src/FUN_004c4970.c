...

{
  ...
  if (iVar4 != 0) {
    ...
    *(uint *)(param_1 + 0x23a4) = *(uint *)(param_1 + 0x23a8);
    ...
    while (0.0 < local_18) {
      iVar4 = FUN_004e11c0(param_1 + 0x150,&local_18);
      if ((iVar4 == 100) && (iVar4 = *(int *)(param_1 + 0xbca4), iVar4 != 0)) {
        ...
        local_14 = (float)FUN_0040dda0(0xc0000000);
        local_ec = local_14 + local_ec;
        local_14 = (float)FUN_0040dda0();
        Var7 = fsin((float10)_DAT_00587824);
        fVar12 = (float10)fptan((float10)_DAT_0058782c);
        fVar10 = (float10)local_14 + (float10)local_e4;
        local_e4 = (float)fVar10;
        fVar11 = (float10)local_ec;
        FUN_00566c81();
        fVar2 = SQRT(local_ec * local_ec + local_e4 * local_e4);
        fVar8 = (float10)fcos(Var7);
        fVar9 = (float10)fsin(fVar11);
        fVar11 = (float10)fcos(fVar11);
        local_60 = (double)fVar2;
        local_24 = fVar2 * (float)_DAT_00587814 * fVar2;
        fVar10 = fVar8 * (float10)_DAT_0058781c * fVar8 *
                 (fVar10 * (float10)fVar2 - (float10)local_e8);
        local_ac = (float)-fVar12;
        local_20 = (float)fVar10;
        local_b0 = (float)(fVar9 * fVar8);
        local_a8 = (float)(fVar11 * fVar8);
        if ((float10)0 < fVar10) {
          ...
          FUN_0040a240();
          FUN_0048b270(0x01C08D04,local_74,&local_b0,2);
    ...
    *(float *)(param_1 + 0x2430) = param_2 * fVar3 * *(float *)(param_1 + 0xbc8c) * fVar2;
    ...
    if (iVar4 == 0) {
      if (local_28 == 0) {
        ...
        if (iVar4 == 0) {
          ...
          FUN_0054e4a0(local_80,&local_128);
          ...
          *(uint *)(param_1 + 0x23a4) = *(uint *)(param_1 + 0x23a8);
          ...
          if (*(float *)(param_1 + 0xbca0) <= 0.0) {
            ...
            if (local_40 < *(float *)(param_1 + 0xbc9c)) {
              pfVar5 = (float *)FUN_0054e4a0(local_a4,&local_f8);
              if (&local_f8 != pfVar5) {
                local_f8 = *pfVar5;
                local_f4 = pfVar5[1];
                local_f0 = pfVar5[2];
              }
              local_3c = FUN_0040df00();
    ...
    if (local_30 == 1) {
      ...
      if (iVar4 == 0) {
        fVar12 = (float10)1;
        fVar10 = (float10)1.4426950408889634 *
                 (float10)0.6931471805599453 * (float10)*(float *)(param_1 + 0x2614) *
                 (float10)_DAT_0058780c;
        fVar11 = (float10)f2xm1(fVar10 - (fVar10 / fVar12) * fVar12);
        fVar12 = (float10)fscale(fVar11 + fVar12,fVar10);
        local_68 = (double)fVar12;
        local_14 = (float)FUN_0040dda0(0x3f7d70a4,0x3f8147ae);
        FUN_00563c90(local_1f0,"slime.wav @%f *%f",(double)*(float *)(param_1 + 0x2614),
