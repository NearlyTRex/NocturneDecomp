...
section .text
    ...
    CALL FUN_00461050                   ; 0050a927
        ;   XREF to: 00461050 (UNCONDITIONAL_CALL)  ; undefined FUN_00461050()
    ADD ESP,0x8                         ; 0050a92c
    PUSH EDI                            ; 0050a92f
    INC ESI                             ; 0050a930
    CALL FUN_0050e190                   ; 0050a931
