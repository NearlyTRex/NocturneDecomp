...
// Convention: unknown
// Signature: void FUN_0051f1d0(float *param_1,int param_2)
...

{
  ...
  if (0 < *(int *)(local_2c + 0x28558)) {
    ...
    do {
      ...
      FUN_0055cd70(local_1c,local_18);
      if (pfVar1[0x193] != 1.0) {
      ...
      if (*(int *)(local_20 + 0x2857c) < 0) {
        ...
        FUN_0055a8b0(&local_3c,local_30 + iVar2,local_28 + *(int *)(local_20 + 0x2857c) * 0xc);
