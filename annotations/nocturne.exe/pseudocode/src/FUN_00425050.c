...
// Convention: unknown
// Signature: void FUN_00425050(int param_1,uint *param_2)
...

{
  ...
  bVar12 = 0;
  FUN_0040a200(param_1,&local_94,param_2);
  ...
  if (*(char *)(param_1 + 0x23b0) != '\0') {
    pcVar6 = (char *)FUN_004e1660(param_1 + 0x150);
    uVar7 = 0xffffffff;
    pcVar10 = pcVar6;
    do {
      if (uVar7 == 0) break;
    ...
    if (-1 < iVar8) {
      do {
        iVar8 = FUN_00564bc0(pcVar6,local_7c,0xb);
        if (iVar8 == 0) {
          *(uint *)(param_1 + 0x2428) = 0;
          *(uint *)(param_1 + 0x2424) = *(uint *)(param_1 + 0x2428);
          *(uint *)(param_1 + 0x2420) = *(uint *)(param_1 + 0x2424);
    ...
    if (0.0 <= local_14) {
      ...
      *(float *)(param_1 + 0x240c) = local_14;
      ...
      if ((param_1 == iVar8) && (local_c8 < 1.0)) {
        FUN_0040a220(iVar8,auStack_c4,0x01E57284 + 0x14cd40);
