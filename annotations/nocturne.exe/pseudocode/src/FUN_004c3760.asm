...
;
; XREF[2]:
;   FUN_004c3c90 at 004c406b
;   FUN_004c4080 at 004c4159
;
; Referenced Globals:
...
section .text
    ...
    FXCH ST2                            ; 004c38db
    CALL FUN_00563a30                   ; 004c38dd
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH                                ; 004c38e2
    CALL FUN_00563a30                   ; 004c38e4
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH ST2                            ; 004c38e9
    CALL FUN_00563a30                   ; 004c38eb
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH                                ; 004c38f0
