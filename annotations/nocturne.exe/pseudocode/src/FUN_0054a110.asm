...
section .text
    ...
    PUSH EAX                            ; 0054a4a7
    PUSH ESI                            ; 0054a4a8
    CALL FUN_0040a290                   ; 0054a4a9
        ;   XREF to: 0040a290 (UNCONDITIONAL_CALL)  ; undefined FUN_0040a290()
    ADD ESP,0xc                         ; 0054a4ae
    PUSH EAX                            ; 0054a4b1
    LEA EAX,[ESP + 0x118]               ; 0054a4b2
    PUSH EAX                            ; 0054a4b9
    CALL FUN_0054e4a0                   ; 0054a4ba
    ...
    PUSH EAX                            ; 0054a5db
    PUSH ESI                            ; 0054a5dc
    CALL FUN_0054a640                   ; 0054a5dd
        ;   XREF to: 0054a640 (UNCONDITIONAL_CALL)  ; undefined FUN_0054a640()
