...

{
  ...
  if (*(int *)(param_1 + 0xbe168) == 0) {
    if ((*(int *)(param_2 + 0x28) == 1) &&
       (iVar2 = FUN_0040d890(*(uint *)(param_2 + 0x34),_DAT_01cc56dc), iVar2 != 0)) {
      FUN_004e16b0(param_1 + 0x150,10,1);
      iVar3 = (**(code **)(*(int *)(iVar2 + 0x14c) + 0x8c))(iVar2);
      if (iVar3 != 0) {
        (**(code **)(*(int *)(iVar3 + 0x14c) + 0x88))(iVar3,iVar2,0);
        iVar3 = FUN_0040d890(iVar3,_DAT_01cae124);
        if (iVar3 != 0) {
          iVar4 = FUN_004c0710(iVar3 + 0x1f5a0,iVar2);
          if (iVar4 == iVar2) {
            FUN_004c07b0(iVar3 + 0x1f5a0,iVar2,0);
            FUN_004d8c60(0x01CC9450,iVar2);
          }
        }
      }
      FUN_00428f40(param_1,0,iVar2,0x3e4ccccd);
      FUN_0047ab70(0x01C03A10,"VampireBossBitesIt");
      FUN_00527230(*(uint *)(param_1 + 0xbeda8));
      FUN_0052ea40(0x02DC9450,param_1,"voicudeath.wav @ 2.5");
    ...
    *(float *)(param_1 + 0x2434) = fVar1;
    ...
    FUN_004e16b0(param_1 + 0xbd24,uVar5,1);
    iVar2 = FUN_00526c50(*(uint *)(param_1 + 0xbeda8));
    if (iVar2 == 0) {
