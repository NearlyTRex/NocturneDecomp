...
;                               FUNCTION
; *****************************************************************************
; undefined4 FUN_0056ed08(PEXCEPTION_RECORD param_1,undefined4 param_2,PCONTEXT param_3)
;
; Local Variables:
...
section .text
    ...
    PUSH EBX                            ; 0056ee1f
    CALL FUN_005716d8                   ; 0056ee20
        ;   XREF to: 005716d8 (UNCONDITIONAL_CALL)  ; undefined FUN_005716d8()
