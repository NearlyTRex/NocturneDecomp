...
// Convention: unknown
// Signature: undefined4 * FUN_00506bc0(int param_1)

#include "nocturne.h"

uint * FUN_00506bc0(int param_1)

{
  ...
  iVar3 = FUN_005644a7(param_1 + 4,0xfa,&DAT_005a1970);
  iVar3 = FUN_005644a7(iVar3 + 0x19644,200,&DAT_005a1990);
  iVar3 = FUN_005644a7(iVar3 + 0x141490,0x14,&DAT_005a19b0);
  iVar3 = FUN_005644a7(iVar3 + 0x554,0xfa,&DAT_005a19d0);
