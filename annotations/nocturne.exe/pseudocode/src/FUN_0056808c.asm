...
section .text
    ...
    CALL FUN_00568528                   ; 00568126
        ;   XREF to: 00568528 (UNCONDITIONAL_CALL)  ; undefined FUN_00568528()
    ...
    MOV ECX,dword ptr [ESP + 0x18]      ; 00568226
        ;   Label: LAB_00568226
    PUSH ECX                            ; 0056822a
    CALL FUN_005684f8                   ; 0056822b
        ;   XREF to: 005684f8 (UNCONDITIONAL_CALL)  ; undefined FUN_005684f8()
