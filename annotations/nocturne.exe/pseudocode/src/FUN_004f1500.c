...
// Convention: unknown
// Signature: undefined4 FUN_004f1500(void)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_004f1500(void)

{
  ...
  do {
    ...
    iVar6 = iStack_18;
    do {
      FUN_00563c90(auStack_11c,0x58ce1b,(&PTR_DAT_005be130)[*(byte *)(iVar6 + 0x1e40098)]);
      ...
      iVar3 = iVar3 + 1;
      iVar5 = iVar5 + 0xe;
      uVar2 = FUN_00402600(auStack_11c,iVar1,iStack_1c);
    } while (iVar3 < 100);
    iVar4 = iVar4 + 1;
