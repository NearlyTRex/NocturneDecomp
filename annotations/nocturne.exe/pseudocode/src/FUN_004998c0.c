  ...
  *(float *)(param_1 + 0x1fa5c) = *(float *)(param_1 + 0x1fa5c) - fVar2;
  ...
  if (param_3 != 0) {
    ...
    if (*(int *)(param_1 + 0x24ac) != 0) {
      FUN_00511780(0x01E57284,*(int *)(param_1 + 0x24ac));
    }
    if (*(int *)(param_1 + 0x24f0) != 0) {
      FUN_00511780(0x01E57284,*(int *)(param_1 + 0x24f0));
    }
  ...
  FUN_0051c3d0(param_1 + 0x150,0,0,*(uint *)(param_1 + 0x1fa58),_DAT_01c7139c,&LAB_0051b650);
  FUN_0051c3d0(param_1 + 0x150,0,0,*(uint *)(param_1 + 0x1fa5c),_DAT_01c713a0,&LAB_0051b650);
  return;
}
