...
;
; XREF[2]:
;   FUN_00507c80 at 00507eb6
;   FUN_005088f0 at 00508c7d
;
; Referenced Globals:
;   IMAGE_DOS_HEADER IMAGE_DOS_HEADER_00400000
;   undefined4 DAT_0057dfae
;   undefined4 DAT_0057dfb6
;   undefined4 DAT_0057dfbe
;   undefined4 DAT_0057dfc6
...
section .text
    ...
    CALL FUN_0046b9c0                   ; 004635c9
        ;   XREF to: 0046b9c0 (UNCONDITIONAL_CALL)  ; undefined FUN_0046b9c0()
    ADD ESP,0x8                         ; 004635ce
    LEA EAX,[ESP + 0x60]                ; 004635d1
    PUSH EAX                            ; 004635d5
    PUSH 0x1fba938                      ; 004635d6 | DAT_01fba938
    CALL FUN_0046b9f0                   ; 004635db
        ;   XREF to: 0046b9f0 (UNCONDITIONAL_CALL)  ; undefined FUN_0046b9f0()
    ADD ESP,0x8                         ; 004635e0
    FLD float ptr [ESP + 0x54]          ; 004635e3
    FADD float ptr [ESP + 0x60]         ; 004635e7
    FLD double ptr [0x0057dfae]         ; 004635eb | DAT_0057dfae
    FXCH                                ; 004635f1
    FMUL ST1                            ; 004635f3
    ...
    FXCH                                ; 0046360b
    FMULP ST3                           ; 0046360d
    FMUL double ptr [0x0057dfb6]        ; 0046360f | DAT_0057dfb6
    FLDZ                                ; 00463615
    ...
    FMUL double ptr [0x0057dfb6]        ; 00463659 | DAT_0057dfb6
    ...
    FMUL double ptr [0x0057dfae]        ; 00463685 | DAT_0057dfae
    FMUL double ptr [0x0057dfb6]        ; 0046368b | DAT_0057dfb6
    ...
    CALL FUN_00461eb0                   ; 004636e9
        ;   XREF to: 00461eb0 (UNCONDITIONAL_CALL)  ; undefined FUN_00461eb0()
    FLD double ptr [0x0057dfbe]         ; 004636ee | DAT_0057dfbe
    FSIN                                ; 004636f4
    ADD ESP,0x8                         ; 004636f6
    FLD float ptr [0x005b0678]          ; 004636f9 | DAT_005b0678
    FXCH                                ; 004636ff
    FMUL ST1                            ; 00463701
    FLD double ptr [0x0057dfc6]         ; 00463703 | DAT_0057dfc6
    FXCH                                ; 00463709
    FMUL ST1                            ; 0046370b
    FXCH ST2                            ; 0046370d
    FMULP                               ; 0046370f
    FXCH                                ; 00463711
    CALL FUN_00563a30                   ; 00463713
    ...
    INC ESI                             ; 004638aa
    INC EBX                             ; 004638ab
    CALL FUN_00463440                   ; 004638ac
        ;   XREF to: 00463440 (UNCONDITIONAL_CALL)  ; undefined FUN_00463440()
