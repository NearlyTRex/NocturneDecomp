...
;
; XREF[2]:
;   FUN_004d12e0 at 004d2141
;   FUN_0052dd20 at 0052dd57
;
; Referenced Globals:
...
section .text
    ...
    PUSH ESI                            ; 00528546
    CALL FUN_0052c760                   ; 00528547
        ;   XREF to: 0052c760 (UNCONDITIONAL_CALL)  ; undefined FUN_0052c760()
    ...
    PUSH EBP                            ; 0052857b
    CALL FUN_0052bef0                   ; 0052857c
        ;   XREF to: 0052bef0 (UNCONDITIONAL_CALL)  ; undefined FUN_0052bef0()
