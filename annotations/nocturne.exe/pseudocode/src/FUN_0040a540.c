...
// Convention: unknown
// Signature: float * FUN_0040a540(int param_1,float *param_2,int param_3,uint param_4)
...
LAB_0040a68d:
  ...
  uVar1 = FUN_0041cc70(auStack_54,auStack_3c,0);
  pfVar2 = (float *)FUN_0040a200(param_1,auStack_18,uVar1);
  if (param_2 != pfVar2) {
    *param_2 = *pfVar2;
    param_2[1] = pfVar2[1];
    param_2[2] = pfVar2[2];
  ...
  iVar3 = 1;
  do {
    uVar1 = FUN_0041cc70(auStack_54,auStack_30,iVar3);
    uVar1 = FUN_0040a200(param_1,auStack_24,uVar1);
    iVar3 = iVar3 + 1;
