...
section .text
    ...
    PUSH EDI                            ; 00551640
        ;   Label: LAB_00551640
    CALL FUN_00551920                   ; 00551641
        ;   XREF to: 00551920 (UNCONDITIONAL_CALL)  ; undefined FUN_00551920()
