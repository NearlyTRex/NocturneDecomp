...
// Convention: unknown
// Signature: void FUN_0046cb00(undefined4 *param_1,undefined4 *param_2,undefined4 *param_3)

#include "nocturne.h"

void FUN_0046cb00(uint *param_1,uint *param_2,uint *param_3)
