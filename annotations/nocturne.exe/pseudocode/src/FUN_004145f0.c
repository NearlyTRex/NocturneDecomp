...
// Convention: unknown
// Signature: void FUN_004145f0(int param_1,int *param_2)
...
switchD_00414626_default:
  ...
  if (((((iVar4 == *(int *)(param_1 + 0xbd90)) || (iVar4 == *(int *)(param_1 + 0xbd94))) ||
    ...
    iVar4 = FUN_0040dea0(local_14);
    if (iVar4 != 0) {
      uVar5 = FUN_00415b30(param_1 + 0x20,param_1 + 0x30,param_2 + 3,param_1,0,0,
                           *(uint *)(param_1 + 0x2608));
      FUN_00427eb0(param_1,uVar5,*param_2,0);
      if (*param_2 == *(int *)(param_1 + 0xbd90)) {
        FUN_00427eb0(param_1,uVar5,*(uint *)(param_1 + 0xbd94),0);
      }
      if (*(int *)(param_1 + 0xbd98) == *param_2) {
        FUN_00427eb0(param_1,uVar5,*(uint *)(param_1 + 0xbd9c),0);
      }
      if (*(int *)(param_1 + 0xbd8c) == *param_2) {
        piVar1 = param_2 + 3;
        FUN_00427e40(param_1,*(uint *)(param_1 + 0xbd98),piVar1,0);
        FUN_00427e40(param_1,*(uint *)(param_1 + 0xbd9c),piVar1,0);
        FUN_00427e40(param_1,*(uint *)(param_1 + 0xbd90),piVar1,0);
        FUN_00427e40(param_1,*(uint *)(param_1 + 0xbd94),piVar1,0);
        FUN_00427e40(param_1,*(uint *)(param_1 + 0xbd88),piVar1,0);
      }
...
LAB_004147e1:
  ...
  if ((*(int *)(param_1 + 0xbd8c) == *param_2) && (param_2[0xc] == 0x68)) {
    ...
    FUN_0043ac60(puVar3,"Shot thru the heart\n");
    iVar4 = FUN_0040dea0(0x3f000000);
    if (iVar4 != 0) {
      local_28 = 0;
      local_24 = 0x41a00000;
      local_20 = 0x41a00000;
      FUN_0040a200(param_1,local_34,&local_28);
      FUN_00427b60(param_1,local_34,0xbf800000,1);
      return;
    }
  }
  return;
