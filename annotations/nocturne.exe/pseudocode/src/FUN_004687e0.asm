...
section .text
    ...
    FXCH ST3                            ; 004688d4
    CALL FUN_00563a30                   ; 004688d6
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH                                ; 004688db
    CALL FUN_00563a30                   ; 004688dd
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH ST3                            ; 004688e2
    CALL FUN_00563a30                   ; 004688e4
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH ST2                            ; 004688e9
    CALL FUN_00563a30                   ; 004688eb
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH                                ; 004688f0
    ...
    PUSH EDX                            ; 0046894f
    PUSH EAX                            ; 00468950
    CALL FUN_0044b500                   ; 00468951
        ;   XREF to: 0044b500 (UNCONDITIONAL_CALL)  ; undefined FUN_0044b500()
