...
section .text
    ...
    PUSH 0x5a3be0                       ; 0054e451 | DAT_005a3be0
        ;   Label: LAB_0054e451
    PUSH EBX                            ; 0054e456
    CALL FUN_0056445f                   ; 0054e457
        ;   XREF to: 0056445f (UNCONDITIONAL_CALL)  ; undefined FUN_0056445f()
    ADD ESP,0x8                         ; 0054e45c
    PUSH EAX                            ; 0054e45f
    CALL FUN_00564486                   ; 0054e460
