...

{
  ...
  iVar1 = (*g_CKeys_PTR_005bac64->vtable->getKeyState)(g_CKeys_PTR_005bac64,DIK_LCONTROL);
  if ((iVar1 != 0) && (this_ptr->debug_fudge_target != (CVector3f *)0x0)) {
    ...
    iVar1 = (*g_CKeys_PTR_005bac64->vtable->getAndClearKeyState)(g_CKeys_PTR_005bac64,DIK_A);
    if (iVar1 != 0) {
      this_ptr->debug_fudge_target->y = this_ptr->debug_fudge_target->y - fStack_18;
    }
    iVar1 = (*g_CKeys_PTR_005bac64->vtable->getAndClearKeyState)(g_CKeys_PTR_005bac64,DIK_Q);
    if (iVar1 != 0) {
      this_ptr->debug_fudge_target->y = this_ptr->debug_fudge_target->y + fStack_18;
      return;
    }
