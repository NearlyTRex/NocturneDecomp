...
// Convention: __cdecl
// Signature: void __cdecl core_game_cpp_CGame_updateStatusDisplays_FUN_0049b0b0(int param_1)
    ...
    do {
      while( true ) {
        ...
        *(int *)(param_1 + 0x388) = iVar3;
        ...
        memmove
                  (param_1 + 0x88c + iVar1,param_1 + 0x88c + iVar1 + 4,
                   (*(int *)(param_1 + 0x388) - iVar4) * 4);
        memmove
                  (param_1 + 0x8a0 + iVar1,param_1 + 0x8a0 + iVar1 + 4,
                   (*(int *)(param_1 + 0x388) - iVar4) * 4);
