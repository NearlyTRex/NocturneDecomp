...
// Convention: unknown
// Signature: void FUN_0049e7d0(int param_1)
...

{
  ...
  if ((*(int *)(param_1 + 0x1fc) == 0) && (*(int *)(param_1 + 0x238) == 0)) {
    uVar2 = FUN_004eda40(0x01CEA280);
    uVar1 = *(uint *)(param_1 + 0xbc);
    if (uVar1 == 0) {
      FUN_0049ee30(param_1,uVar2);
    }
    else if (uVar1 < 2) {
      FUN_0049f710(param_1,uVar2);
    }
    else if (uVar1 == 2) {
      FUN_0049ec80(param_1,uVar2);
    }
    else {
      _DAT_01cc4800 = "@..\\core\\game.cpp" + 1;
      _DAT_01cc4804 = 0x71d;
      FUN_004c8440("CGame::playerControls - unknown control type");
    }
