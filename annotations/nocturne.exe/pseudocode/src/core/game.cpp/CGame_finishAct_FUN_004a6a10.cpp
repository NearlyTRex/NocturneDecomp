...

{
  ...
  if (this_ptr->act_completion_state == 2) {
    pCVar8 = g_CBitFont_PTR_014b9900;
    if (g_CDemonCamera_01fb8508.screen_width < 0x1e0) {
      pCVar8 = g_CBitFont_PTR_014b9904;
    }
    iVar3 = engine_font_cpp_CBitFont_getCharHeight_FUN_004930e0(pCVar8,0x58);
    ...
    for (local_550 = 5.0; 0.0 < local_550; local_550 = local_550 - this_ptr->delta_time_float) {
      ...
      engine_font_cpp_CBitFont_drawTextCenterInBounds_FUN_00490de0
                (pCVar8,0,DAT_005b761c + -1,(DAT_005b7620 - iVar3) / 2,0xf8,0,pcVar4);
  ...
  local_20 = local_24;
  dVar12 = round((double)(fVar1 * (float)100));
  ...
  iVar10 = 0;
  iStack_34 = iVar3;
  local_30 = engine_font_cpp_CBitFont_getCharHeight_FUN_004930e0(pCVar8,0x58);
  y = 0xf0;
  if (0 < iVar3) {
    ...
    do {
      iVar10 = iVar10 + 1;
      engine_font_cpp_CBitFont_drawTextCenterInBounds_FUN_00490de0
                (local_2c,0x1c0,0x27f,y,0xf8,0,pcVar4);
      pcVar4 = pcVar4 + 0x100;
      y = y + local_30;
