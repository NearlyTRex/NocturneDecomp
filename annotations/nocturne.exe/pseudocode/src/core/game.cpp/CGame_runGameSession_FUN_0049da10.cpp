...

{
  ...
  *(uint *)(param_1 + 0x210) = 0;
  ...
  iVar4 = core_netgame_cpp_CNetGame_syncPlayers_FUN_004ea370(0x01CEA280,3);
  if ((iVar4 != 0) &&
     (iVar4 = core_netgame_cpp_CNetGame_syncPlayers_FUN_004ea370(0x01CEA280,4), iVar4 != 0)) {
    0x01CEA280[1] = 3;
    ...
    core_level_cpp_CLevelLoader_cleanup_FUN_004c5fa0(0x01CC3160);
    ...
    *(uint *)(param_1 + 600) = 0;
    while( true ) {
      ...
      engine_keys_cpp_CKeys_toggleInputMask_FUN_004c4210(0x01CC30E4,uVar3);
          ...
          *(uint *)(param_1 + 0x200) = 0;
          ...
          if (*0x01CEA280 == 2) {
            uVar3 = support_newmsg_cpp_getLocalizedString_FUN_004ee370
                              ("Leave network game");
            shape_edittool_cpp_CStrList_add_FUN_00473cb0(&DAT_01c78424,uVar3);
            uVar3 = support_newmsg_cpp_getLocalizedString_FUN_004ee370("Return to game");
            shape_edittool_cpp_CStrList_add_FUN_00473cb0(&DAT_01c78424,uVar3);
            uVar3 = support_newmsg_cpp_getLocalizedString_FUN_004ee370
                              ("You are connect to a network game.\nDo you want to leave the game?",0,1);
            shape_edittool_cpp_CPickList_initializeDialog_FUN_00474e70(&DAT_01c78424,uVar3);
            _DAT_01c78420 = 1;
          }
            ...
            uVar3 = support_newmsg_cpp_getLocalizedString_FUN_004ee370("Return");
            shape_edittool_cpp_CStrList_add_FUN_00473cb0(local_290,uVar3);
            uVar3 = support_newmsg_cpp_getLocalizedString_FUN_004ee370("Options");
            shape_edittool_cpp_CStrList_add_FUN_00473cb0(local_290,uVar3);
            ...
            if (iVar4 == 1) {
              ...
              engine_keys_cpp_CKeys_toggleInputMask_FUN_004c4210
                        (0x01CC30E4,*(int *)(param_1 + 0x1fc) == 0);
      ...
      if (iVar4 == 2) {
        ...
        if (local_14 < 0.0) {
          iVar4 = core_game_cpp_CGame_fadeIn_FUN_004a3a50(param_1);
          if (iVar4 != 0) goto LAB_0049dec1;
        }
        else {
...
LAB_0049dec1:
  ...
  uVar3 = core_mission_cpp_CDemonMission_countDamageableEnemies_FUN_004d9df0(0x01CC9450);
  piVar2 = 0x01CC30E4;
  *(uint *)(param_1 + 0x24c) = uVar3;
  engine_keys_cpp_CKeys_toggleInputMask_FUN_004c4210(piVar2,0);
  core_sound_cpp_CSound_shutdown_FUN_0052df90(0x02DC9450);
  FUN_004940d0(0x01C70F74);
  core_game_cpp_CGame_setScreenResolutionAndDisplayFangs_FUN_0049d960(param_1);
