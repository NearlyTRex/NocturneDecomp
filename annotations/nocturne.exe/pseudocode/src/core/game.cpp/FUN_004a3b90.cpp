...

{
  ...
  if (*(int *)(param_1 + 0x228) != 0) {
    ...
    shape_edittool_cpp_FUN_0046fcd0(0x01BCD074,uVar4);
    return;
  }
  ...
  if (param_2 == (char *)0x0) {
    ...
    iVar2 = shape_edittool_cpp_FUN_00470eb0(0x01BCD074,uVar4,uVar8,pcVar9,uVar3);
    if (iVar2 == 0) {
      return;
    }
    splitpath();
  ...
  _fprintf();
  core_mission_cpp_FUN_004d8720(0x01CC9450,iVar2);
  ...
  core_script_cpp_FUN_005055f0(0x01E56DA0,iVar2);
  ...
  if (local_14 != 0) {
    ...
    if (local_e8 != 0) {
      shape_edittool_cpp_FUN_0046fcd0(0x01BCD074,uVar3);
