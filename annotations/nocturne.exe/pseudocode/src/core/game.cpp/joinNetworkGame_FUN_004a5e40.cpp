...

{
  ...
  iVar1 = shape_edittool_cpp_CEditorTools_showTextInputDialog_FUN_00471600
                    (0x01BCD074,"Enter Server IP",&stack0xffffff8c,100,1);
  if (iVar1 == 0) {
    return;
  }
  server_ip = support_trisock_cpp_parseIPAddress_FUN_00548af0(&uStack_10,&stack0xffffff8c);
  iVar1 = core_netgame_cpp_CNetGame_initializeNetworkToJoin_FUN_004e9a90(0x01CEA280,server_ip);
  if (iVar1 != 0) {
    DAT_01c78598 = 0;
    while( true ) {
      iVar1 = core_netgame_cpp_CNetGame_runLobby_FUN_004eb520(0x01CEA280);
      if (iVar1 == 0) break;
