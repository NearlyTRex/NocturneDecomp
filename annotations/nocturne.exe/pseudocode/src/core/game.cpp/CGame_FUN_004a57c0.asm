...
section .text
    ...
    PUSH EBX                            ; 004a57c0
        ;   Label: core_game.cpp_CGame_FUN_004a57c0
    PUSH ESI                            ; 004a57c1
    PUSH EDI                            ; 004a57c2
    PUSH EBP                            ; 004a57c3
    ...
    MOV [0x01cc4800],EAX                ; 004a5a06 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EDX      ; 004a5a0b | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004a5a11
    ...
    MOV EAX,[0x005b7620]                ; 004a5a4a | g_WindowHeight
    ...
    MOV ECX,dword ptr [0x005b7620]      ; 004a5a7a | g_WindowHeight
    ...
    MOV EBX,dword ptr [0x005b761c]      ; 004a5a97 | g_WindowWidth
    ...
    MOV EBP,dword ptr [0x005b761c]      ; 004a5ac9 | g_WindowWidth
    ...
    MOV EBP,dword ptr [0x005b761c]      ; 004a5b1a | g_WindowWidth
        ;   Label: LAB_004a5b1a
    ...
    MOV EBX,dword ptr [0x005b7620]      ; 004a5b39 | g_WindowHeight
    ...
    CALL crt_memory.c_free_FUN_005638d0 ; 004a5d62
