...

{
  ...
  if ((this_ptr->cutscene_skippable != 0) || (0x01CEA280->has_pending_sim_frame != 0)) {
    ...
    core_netgame_cpp_CNetGame_processClientFrame_FUN_004ed720(pCVar3);
  ...
  if (this_ptr->is_paused == 0) {
    ...
    if (&local_b0 != (CSlew *)(iVar4 + 0x20)) {
      local_b0.position.x = (((CSlew *)(iVar4 + 0x20))->position).x;
      local_b0.position.y = *(float *)(iVar4 + 0x24);
      local_b0.position.z = *(float *)(iVar4 + 0x28);
    }
    iVar4 = *(int *)(_DAT_01cae0e8 * 4 + 0x1cae0d8);
    if (&local_b0.orientation != (UOrientationVector *)(iVar4 + 0x30)) {
      local_b0.orientation.vec.x = (((UOrientationVector *)(iVar4 + 0x30))->vec).x;
      local_b0.orientation.vec.y = *(float *)(iVar4 + 0x34);
      local_b0.orientation.vec.z = *(float *)(iVar4 + 0x38);
    }
    core_slew_cpp_CSlew_processInput_FUN_0051f980(&local_b0);
    iVar4 = *(int *)(_DAT_01cae0e8 * 4 + 0x1cae0d8);
    (**(code **)(*(int *)(iVar4 + 0x14c) + 0x60))(iVar4,&local_b0,&local_b0.orientation);
    if ((DAT_01bd1d94 & 1) != 0) {
      core_dcamera_cpp_CDemonCamera_screenToWorldCoord_FUN_004410c0
                (0x1fb8508,_DAT_01bd1d8c,_DAT_01bd1d90);
      puVar17 = auStack_90 + 5;
      local_7c = auStack_90[2];
      auStack_90[(uint)bVar12 * -2 + 6] = auStack_90[(uint)bVar12 * -2 + 3];
      auStack_90[(uint)bVar12 * -2 + (uint)bVar12 * -2 + 7] =
           auStack_90[(uint)bVar12 * -2 + (uint)bVar12 * -2 + 4];
      core_dcamera_cpp_CDemonCamera_screenToWorldTransform_FUN_004411b0(0x1fb8508,puVar17);
      local_7c = local_94;
      auStack_90[(uint)bVar12 * -2 + 6] = auStack_90[(uint)bVar12 * -2];
      auStack_90[(uint)bVar12 * -2 + (uint)bVar12 * -2 + 7] =
           auStack_90[(uint)bVar12 * -2 + (uint)bVar12 * -2 + 1];
  ...
  if (this_ptr->developer_mode_enabled == 0) {
    pcVar7 = support_newmsg_cpp_decryptMessage_FUN_004ee3f0((char *)BYTE_ARRAY_005825f0);
    pcVar7 = getenv(pcVar7);
    if (pcVar7 != (char *)0x0) goto LAB_0049cf70;
  }
  else {
LAB_0049cf70:
    ...
    if (iVar4 != 0) {
      ...
      engine_pcx_c_FUN_004f2990(0x1c780c0);
    }
  }
  core_inv_cpp_FUN_004c2470(*(int *)(_DAT_01cae0e8 * 4 + 0x1cae0d8) + 0x1f5a0);
            ...
            do {
              ...
              if (0 < 0x00000040) {
                ...
                do {
                  ...
                  iVar4 = (local_38 * DAT_005b7620) / 0x00000040;
                  iVar6 = (local_3c * DAT_005b7620) / 0x00000040;
                  iVar9 = 0;
                  local_18 = 0;
                  local_1c = 0;
                  iVar10 = 0;
                  if (iVar4 < iVar6) {
                    ...
                    do {
                      if (local_28 < local_20) {
                        puVar8 = (uint *)(local_28 * 4 + *(int *)(&DAT_01bd2fa0 + local_24));
                        iVar4 = local_28;
                        do {
                          uVar5 = *puVar8;
                          puVar8 = puVar8 + 1;
                          iVar10 = iVar10 + (uVar5 >> 0x10 & 0xff);
                          iVar4 = iVar4 + 1;
                          iVar9 = iVar9 + (uVar5 & 0xff);
                          local_1c = local_1c + (uVar5 >> 8 & 0xff);
                          local_18 = local_18 + 1;
                  ...
                  _fputc(iVar10 / local_18,local_34);
  ...
  if (this_ptr->camera_debug_enabled == 0) {
    ...
    dVar16 = (double)local_48 * 0.0009765625;
    dVar14 = (double)local_50 * 0.0009765625;
    dVar15 = (double)(local_58 + local_50) * 0.0009765625;
    local_14 = local_58;
    dVar13 = (double)local_58 * 0.0009765625;
    iVar4 = sound_sndmain_cpp_countActiveSfx_FUN_005275e0();
    _sprintf(local_2dc,"SFX: %d Samples: Active: %d/%.1fk Avail: %d/%.1fk Total alloc: %.1fk Free: %.1fk",iVar4,local_5c,dVar13,local_54,dVar14,
               dVar15,dVar16);
  ...
  if (_DAT_01c78ad8 != 0) {
    uVar5 = sound_sndmain_cpp_getFirstActiveSfx_FUN_005274e0();
    iVar4 = 0x37;
    for (; uVar5 != 0; uVar5 = sound_sndmain_cpp_FUN_00527520(uVar5)) {
      sound_sndmain_cpp_CSfxSample_init_FUN_00525b70(&local_604);
      iVar6 = sound_sndmain_cpp_getSfxSampleInfo_FUN_00526cd0(uVar5,&local_604);
      if (iVar6 != 0) {
  ...
  if (iVar4 == 2) {
    pcVar7 = support_newmsg_cpp_getLocalizedString_FUN_004ee370("You're dead.  Game over.");
    piVar11 = local_604.loop_endpoints;
    do {
      cVar1 = *pcVar7;
      *(char *)piVar11 = cVar1;
      if (cVar1 == '\0') break;
  ...
  if (0 < _DAT_01c78424) {
    shape_edittool_cpp_FUN_004759d0(&DAT_01c78424);
  }
  if (this_ptr->is_paused != 0) {
