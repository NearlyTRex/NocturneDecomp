...
section .text
    ...
    CALL thunk_FUN_00553190             ; 0049d8fc
        ;   XREF to: 00403760 (UNCONDITIONAL_CALL)  ; undefined thunk_FUN_00553190()
        ;   Label: LAB_0049d8fc
    MOV EDI,dword ptr [0x005b7620]      ; 0049d901 | DAT_005b7620
    PUSH EDI                            ; 0049d907
    PUSH 0x1fb8508                      ; 0049d908
    CALL FUN_00440010                   ; 0049d90d
