// Name: core_game.cpp_CGame_FUN_004a4b50
// Address: 004a4b50
// Address Range: [[004a4b50, 004a573a]]
// Convention: __cdecl
// Signature: void __cdecl core_game_cpp_CGame_FUN_004a4b50(CGame *this_ptr,int select_mode)
...

{
  ...
  engine_ini_cpp_CIniFile_ctor_FUN_004bd860
            ((CIniFile *)&stack0xfffffb4c,"system\\nocturne.ini","Game");
  local_2c = 0;
  local_28 = 0;
  local_24 = 0;
  local_20 = 0;
  engine_ini_cpp_CIniFile_getInteger_FUN_004bda20
            ((CIniFile *)&stack0xfffffb4c,"Act1Code",&local_2c);
  engine_ini_cpp_CIniFile_getInteger_FUN_004bda20
            ((CIniFile *)&stack0xfffffb4c,"Act2Code",&local_28);
  engine_ini_cpp_CIniFile_getInteger_FUN_004bda20
            ((CIniFile *)&stack0xfffffb4c,"Act3Code",&local_24);
  engine_ini_cpp_CIniFile_getInteger_FUN_004bda20
            ((CIniFile *)&stack0xfffffb4c,"Act4Code",&local_20);
  ...
  if (bVar8 || p_Var2 != (_FILE *)0x0) {
    iVar6 = shape_edittool_cpp_CEditorTools_showFileSelectionDialog_FUN_00470550
                      (g_CEditorTools_PTR_005b6d50,"Select mission to play",
                       "world","*.msn",local_144,0);
    if (iVar6 == 0) {
      return;
    }
    _DAT_01c78ac0 = 0;
    ...
    while (iVar6 < 0) {
      shape_edittool_cpp_CPickList_ctor_FUN_00474c90(&local_2b4);
      pcVar7 = support_newmsg_cpp_getLocalizedString_FUN_004ee370
                         ("Volume 1 - 'Dark Reign of the Vampire King'");
      shape_edittool_cpp_CStrList_add_FUN_00473cb0(&local_2b4.base,pcVar7);
      pcVar7 = support_newmsg_cpp_getLocalizedString_FUN_004ee370
      ...
      if (local_14 == 0) {
        iVar5 = 0;
        iVar3 = 0;
        if (0 < local_2b4.base.item_count) {
          do {
            p_Var2 = engine_dosio_cpp_getFile_FUN_00456a60
                               ("world",*(char **)(&DAT_005b9450 + iVar3),"rt");
            if (p_Var2 == (_FILE *)0x0) {
              shape_edittool_cpp_CPickList_enableItem_FUN_00475f80(&local_2b4,iVar5,0);
            }
            else {
              _fclose(p_Var2);
            }
            iVar5 = iVar5 + 1;
            iVar3 = iVar3 + 0x34;
          } while (iVar5 < local_2b4.base.item_count);
        }
      }
      iVar3 = -1;
      ...
      iVar3 = shape_edittool_cpp_CPickList_displayChoicesAndWaitForInput_FUN_00474d70
                        (&local_2b4,pcVar7,iVar3,in_stack_fffffb4c);
      if (iVar3 < 0) {
...
LAB_004a50dc:
        ...
        if (iVar3 == 0) {
          ...
          iVar6 = 0;
          shape_edittool_cpp_CStrList_add_FUN_00473cb0(&local_2b4.base,pcVar7);
          while (iVar6 < local_2b4.base.item_count) {
            p_Var2 = engine_dosio_cpp_getFile_FUN_00456a60
                               ("world",*(char **)(&DAT_005b9450 + iVar5),"rt");
            if (p_Var2 == (_FILE *)0x0) {
              shape_edittool_cpp_CPickList_enableItem_FUN_00475f80(&local_2b4,iVar6,0);
              iVar6 = iVar6 + 1;
              iVar5 = iVar5 + 4;
            }
            else {
          ...
          iVar6 = shape_edittool_cpp_CPickList_displayChoicesAndWaitForInput_FUN_00474d70
                            (&local_2b4,pcVar7,iVar6,in_stack_fffffb4c);
        }
        if (iVar3 == 1) {
          pcVar7 = support_newmsg_cpp_getLocalizedString_FUN_004ee370
          ...
          iVar5 = 0x34;
          for (iVar6 = 0; iVar6 < local_2b4.base.item_count; iVar6 = iVar6 + 1) {
            p_Var2 = engine_dosio_cpp_getFile_FUN_00456a60
                               ("world",*(char **)(&DAT_005b9450 + iVar5),"rt");
            if (p_Var2 == (_FILE *)0x0) {
              shape_edittool_cpp_CPickList_enableItem_FUN_00475f80(&local_2b4,iVar6,0);
  ...
  core_level_cpp_CLevelLoader_show_FUN_004c5640(g_CLevelLoader_PTR_005baca0,10,0,iVar3);
  core_mission_cpp_CDemonMission_load_FUN_004d7ee0(g_CDemonMission_PTR_005baf90,local_144,iVar5);
  iVar3 = core_mission_cpp_CDemonMission_createHeros_FUN_004d9a80
  ...
  if (iVar3 != 0) {
    ...
    if (this_ptr->need_chapter_reload != 0) {
      ...
      core_game_cpp_CGame_FUN_004a4170(this_ptr,this_ptr->chapter_reload_filename,1);
    }
  }
  _DAT_01bcd070 = (CBitFont *)local_1c;
  return;
}
