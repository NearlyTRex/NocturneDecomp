...

{
  ...
  if ((this_ptr->x_stick_max - this_ptr->x_center) / 2 + this_ptr->x_center < _DAT_01c038f8) {
    engine_keys_cpp_CKeys_setKeyAsPressed_FUN_004c41f0((CKeys *)INT_005bac64,DIJ_RIGHT);
  }
  if (_DAT_01c038fc < this_ptr->y_center - (this_ptr->y_center - this_ptr->y_stick_min) / 2) {
    engine_keys_cpp_CKeys_setKeyAsPressed_FUN_004c41f0((CKeys *)INT_005bac64,DIJ_UP);
  }
  if ((this_ptr->y_stick_max - this_ptr->y_center) / 2 + this_ptr->y_center < _DAT_01c038fc) {
    engine_keys_cpp_CKeys_setKeyAsPressed_FUN_004c41f0((CKeys *)INT_005bac64,DIJ_DOWN);
    return;
  }
  return;
}
