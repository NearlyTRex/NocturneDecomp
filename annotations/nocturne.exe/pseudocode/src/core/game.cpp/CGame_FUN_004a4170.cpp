// Name: core_game.cpp_CGame_FUN_004a4170
// Address: 004a4170
// Address Range: [[004a4170, 004a4ad3]]
// Convention: __cdecl
// Signature: void __cdecl core_game_cpp_CGame_FUN_004a4170(CGame *this_ptr,char *save_filename,int load_mode)
  ...
  do {
    if (save_filename == (char *)0x0) {
      ...
      iVar2 = shape_edittool_cpp_CEditorTools_showFileSelectionDialog_FUN_00470550
                        (g_CEditorTools_PTR_005b6d50,pcVar7,search_directory,file_pattern,pcVar9,
                         uVar14);
      if (iVar2 == 0) {
LAB_004a4674:
