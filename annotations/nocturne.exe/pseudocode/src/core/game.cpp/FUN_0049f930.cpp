...
// Convention: unknown
// Signature: void core_game_cpp_FUN_0049f930(int param_1)
...
LAB_0049f9d8:
  ...
  if ((iVar4 != 0) && (*(int *)(param_1 + 0x228) == 0)) {
    core_game_cpp_FUN_004a3b90(param_1,"quicksavedgame.noc");
  ...
  if ((*(int *)(param_1 + 0x1dc) == 0) &&
    ...
    if (iVar4 == 0) {
      ...
      _fclose();
      uVar5 = support_newmsg_cpp_getLocalizedString_FUN_004ee370();
      iVar4 = shape_edittool_cpp_FUN_00470230(0x01BCD074,uVar5);
      if (iVar4 != 0) {
