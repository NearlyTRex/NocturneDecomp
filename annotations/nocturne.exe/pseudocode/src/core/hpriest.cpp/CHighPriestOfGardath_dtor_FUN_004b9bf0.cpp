// Name: core_hpriest.cpp_CHighPriestOfGardath_dtor_FUN_004b9bf0
// Address: 004b9bf0
// Address Range: [[004b9bf0, 004b9cb8]]
// Convention: __cdecl
// Signature: CHighPriestOfGardath * __cdecl core_hpriest_cpp_CHighPriestOfGardath_dtor_FUN_004b9bf0(CHighPriestOfGardath *this_ptr,uint flags)
...

{
  ...
  CHighPriestOfGardath *pCVar7;
  void *ptr;
  
  if ((flags & 4) != 0) {
    ptr = __vec_delete(this_ptr,&g_CHighPriestOfGardathTypeInfo_0059f3a0);
