...
;
; XREF[1]:
;   core_hpriest.cpp_factoryFuncHighPriestOfGardath_FUN_004b9ac0 at 004b9ad3
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004b9af0
        ;   Label: core_hpriest.cpp_CHighPriestOfGardath_ctor_FUN_004b9af0
    PUSH ESI                            ; 004b9af1
    PUSH EDI                            ; 004b9af2
    MOV EDX,dword ptr [ESP + 0x10]      ; 004b9af3
    PUSH EDX                            ; 004b9af7
    CALL core_npc.cpp_CNPC_ctor_FUN_004ee950 ; 004b9af8
