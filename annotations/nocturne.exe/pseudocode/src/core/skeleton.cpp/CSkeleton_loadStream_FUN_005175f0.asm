...
section .text
    ...
    PUSH EDX                            ; 005175fb
    CALL core_skeleton.cpp_CSkeleton_FUN_005174e0 ; 005175fc
    ...
    MOV dword ptr [0x01cc4800],EDI      ; 0051764c | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EBP      ; 00517652 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 00517658
    ...
    MOV dword ptr [0x01cc4800],EDX      ; 00517678 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],ECX      ; 0051767e | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 00517684
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
    ...
    CALL core_skeleton.cpp_CSkeleton_allocMemory_FUN_005173c0 ; 005176de
        ;   XREF to: 005173c0 (UNCONDITIONAL_CALL)  ; void core_skeleton.cpp_CSkeleton_allocMemory_FUN_005173c0(CSkeleton * this_ptr, int bone_count, int frame_count)
    ...
    MOV dword ptr [0x01cc4800],EBP      ; 005178e9 | g_CurrentFilename
    MOV [0x01cc4804],EAX                ; 005178ef | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 005178f4
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
    ...
    CALL core_motion.cpp_CMotionList_load_FUN_004e0920 ; 00517906
        ;   XREF to: 004e0920 (UNCONDITIONAL_CALL)  ; void core_motion.cpp_CMotionList_load_FUN_004e0920(CMotionList * this_ptr, _FILE * file_handle)
    ...
    MOV dword ptr [0x01cc4800],EDI      ; 00517980 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EBP      ; 00517986 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 0051798c
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
    ...
    MOV dword ptr [0x01cc4800],EBX      ; 005179a8 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],ESI      ; 005179ae | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 005179b4
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
