...
;
; XREF[2]:
;   core_main.c_finalizeGameSystems_FUN_004c90e0 at 004c935c
;   core_mission.cpp_CDemonMission_freeAllAssets_FUN_004d9900 at 004d990f
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0051f742
        ;   Label: LAB_0051f742
    CALL core_skeleton.cpp_CSkeleton_FUN_005174e0 ; 0051f743
