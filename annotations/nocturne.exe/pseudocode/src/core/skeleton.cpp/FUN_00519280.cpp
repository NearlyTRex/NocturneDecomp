...
// Convention: unknown
// Signature: void FUN_00519280(int *param_1,int param_2)
...

{
  ...
  do {
    iVar1 = FUN_00564570(param_2);
    if (iVar1 < 0) break;
  } while (iVar1 != 10);
  iVar1 = FUN_00563350(param_2,&DAT_005916d9,&local_64);
...
LAB_005192e4:
    ...
    if (local_64 < 3) {
      ...
      iVar1 = FUN_00563350(param_2,"%d,%d,%d,%d,%d,%d\n",&local_50,&local_4c,&local_48,
                           &local_44,&local_60,&local_40);
      if (iVar1 != 6) goto LAB_005192c1;
      FUN_00517da0(param_1,1,1,local_44,local_40);
      FUN_00517ec0(param_1,0,local_50,local_4c,local_48);
    }
    else {
      if (local_64 < 5) {
        do {
    ...
    if (local_64 < 3) {
      ...
      for (iVar1 = 0; iVar1 < param_1[0x300]; iVar1 = iVar1 + 1) {
        ...
        for (iVar2 = 0; iVar2 < param_1[iVar1 * 0x18 + 0x313]; iVar2 = iVar2 + 1) {
          FUN_00563350(param_2,&DAT_005917d8,param_1 + iVar1 * 0x18 + iVar2 + 0x314);
        }
    ...
    for (local_14 = 0; local_14 < *param_1; local_14 = local_14 + 1) {
      for (iVar1 = 0; iVar2 = local_14, iVar1 < param_1[local_14 + 0x15] + param_1[local_14 + 0x1a];
        ...
        iVar5 = FUN_00563350(param_2,"%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n",&local_28,local_74,
                             &local_80,&local_8c,local_70,local_7c,local_88,local_6c,local_78,
                             local_84);
    ...
    for (iVar1 = 0; iVar1 < *param_1; iVar1 = iVar1 + 1) {
      for (iVar2 = 0; iVar2 < param_1[iVar1 + 0x1a]; iVar2 = iVar2 + 1) {
        iVar5 = FUN_00563350(param_2,&DAT_0059182c,param_1[iVar1 + 0x29] + iVar2 * 4);
        if (iVar5 != 1) goto LAB_005192c1;
      }
    }
    do {
    ...
    for (iVar1 = 0; iVar1 < local_60; iVar1 = iVar1 + 1) {
      ...
      iVar2 = FUN_00563350(param_2,"%f,%f,%f\n",piVar3,piVar3 + 1,piVar3 + 2);
  ...
  if (6 < local_64) {
    ...
    for (iVar1 = 0; iVar1 < local_60; iVar1 = iVar1 + 1) {
      FUN_00563350(param_2,&DAT_00591855,param_1 + iVar1 + 0x9bf);
    }
  }
  if (local_64 < 7) {
    FUN_0051ad20(param_1);
  }
