...
// Convention: __cdecl
// Signature: void __cdecl core_skeleton_cpp_CDeformableModelInstance_resetToRestPose_FUN_0051b800(int param_1)
...

{
  ...
  if (0 < *(int *)(iVar1 + 0x28558)) {
    ...
    iVar2 = param_1;
    do {
      core_xform_cpp_setIdentityQuaternion_FUN_0055d110(iVar4);
      iVar3 = iVar3 + 1;
