...
section .text
    ...
    PUSH EBX                            ; 0051923b
    CALL FUN_00519280                   ; 0051923c
        ;   XREF to: 00519280 (UNCONDITIONAL_CALL)  ; undefined FUN_00519280()
    ADD ESP,0x8                         ; 00519241
    PUSH EDI                            ; 00519244
    CALL FUN_00563380                   ; 00519245
