...
// Convention: unknown
// Signature: int FUN_00519be0(int param_1,uint param_2)
...

{
  ...
  if (1 < *(int *)(param_1 + 0xc00)) {
    ...
    iVar1 = local_24;
    FUN_0051dd00(local_24,param_1);
    FUN_0051b800(iVar1);
    FUN_0051d3c0(iVar1);
    FUN_0051da50(iVar1,0);
    FUN_0051d2a0(iVar1,&local_6c,param_2);
    local_38 = 0;
