  ...
  if ((float)0.001 < blend_weight) {
    ...
    if (this_ptr->bone_update_mode == 0) {
      if (0 < this_ptr_00->bone_count) {
        ...
        do {
          ...
          if (-1 < hierarchy_distance) {
            ...
            pCVar15 = local_2c;
            pCVar16 = &CStack_144;
            CStack_144.w = CStack_164.w;
            puVar18 = (uint *)((int)&CStack_144 + (uint)bVar20 * -8 + (uint)bVar20 * -8 + 8);
            puVar17 = (uint *)((int)&CStack_164 + (uint)bVar20 * -8 + (uint)bVar20 * -8 + 8);
            *(uint *)((int)&CStack_144 + (uint)bVar20 * -8 + 4) =
                 *(uint *)((int)&CStack_164 + (uint)bVar20 * -8 + 4);
            *puVar18 = *puVar17;
            puVar18[(uint)bVar20 * -2 + 1] = puVar17[(uint)bVar20 * -2 + 1];
            core_xform_cpp_slerpQuaternion_FUN_0055d2d0(pCVar15,pCVar16,fVar13,&CStack_154);
            puVar18 = (uint *)((int)local_34 + (uint)bVar20 * -8 + 0x6b4);
            (local_34->bone_transform).pose_data.bone_rotations[0].w = CStack_154.w;
            puVar19 = puVar18 + (uint)bVar20 * -2 + 1;
            puVar17 = (uint *)((int)&CStack_154 + (uint)bVar20 * -8 + (uint)bVar20 * -8 + 8);
            *puVar18 = *(uint *)((int)&CStack_154 + (uint)bVar20 * -8 + 4);
            *puVar19 = *puVar17;
        ...
        do {
          ...
          *(int *)((int)aiStack_2f4 + local_28) = iVar14;
          if (-1 < iVar14) {
            ...
            puVar18 = (uint *)((int)local_934 + (uint)bVar20 * -8 + local_44 + 4);
            *(float *)((int)&local_934[0].w + local_44) = local_124.w;
            puVar19 = puVar18 + (uint)bVar20 * -2 + 1;
            puVar17 = (uint *)((int)&local_124 + (uint)bVar20 * -8 + (uint)bVar20 * -8 + 8);
            *puVar18 = *(uint *)((int)&local_124 + (uint)bVar20 * -8 + 4);
            *puVar19 = *puVar17;
            puVar19[(uint)bVar20 * -2 + 1] = puVar17[(uint)bVar20 * -2 + 1];
          }
          local_20 = local_20 + 1;
      ...
      if (-1 < iVar14) {
        ...
        puVar18 = (uint *)((int)local_934 + (uint)bVar20 * -8 + iVar14 * 0x10 + 4);
        local_934[iVar14].w = local_f4.w;
        puVar19 = puVar18 + (uint)bVar20 * -2 + 1;
        puVar17 = (uint *)((int)&local_f4 + (uint)bVar20 * -8 + (uint)bVar20 * -8 + 8);
        *puVar18 = *(uint *)((int)&local_f4 + (uint)bVar20 * -8 + 4);
        *puVar19 = *puVar17;
        puVar19[(uint)bVar20 * -2 + 1] = puVar17[(uint)bVar20 * -2 + 1];
      }
      local_24 = 0;
        ...
        do {
          if (-1 < *(int *)((int)aiStack_2f4 + local_3c)) {
            ...
            if (iVar14 < 0) {
              ...
              pCVar16 = local_b4;
              pCVar15 = (CQuaternion4f *)((int)&local_934[0].w + local_48);
              local_b4[0].w = local_e4.w;
              puVar18 = (uint *)((int)local_b4 + (uint)bVar20 * -8 + (uint)bVar20 * -8 + 8);
              puVar17 = (uint *)((int)&local_e4 + (uint)bVar20 * -8 + (uint)bVar20 * -8 + 8);
              *(uint *)((int)local_b4 + (uint)bVar20 * -8 + 4) =
                   *(uint *)((int)&local_e4 + (uint)bVar20 * -8 + 4);
              *puVar18 = *puVar17;
              puVar18[(uint)bVar20 * -2 + 1] = puVar17[(uint)bVar20 * -2 + 1];
              core_xform_cpp_multiplyQuaternion_FUN_0055d130(pCVar15,pCVar16,&local_c4);
              pCVar16 = (CQuaternion4f *)((int)&local_4c->w + (int)local_18);
              local_114.w = local_c4.w;
              puVar18 = (uint *)((int)&local_114 + (uint)bVar20 * -8 + (uint)bVar20 * -8 + 8);
              puVar17 = (uint *)((int)local_b4 + (uint)bVar20 * -8 + (uint)bVar20 * -8 + -8);
              *(uint *)((int)&local_114 + (uint)bVar20 * -8 + 4) =
                   *(uint *)((int)local_b4 + (uint)bVar20 * -8 + -0xc);
              *puVar18 = *puVar17;
              puVar18[(uint)bVar20 * -2 + 1] = puVar17[(uint)bVar20 * -2 + 1];
              core_xform_cpp_multiplyQuaternion_FUN_0055d130(&local_114,pCVar16,&local_104);
              pCVar16 = &local_104;
            }
            puVar17 = (uint *)((int)pCVar16 + ((uint)bVar20 * -2 + 1) * 4);
            local_d4.w = pCVar16->w;
            puVar19 = (uint *)((int)&local_d4 + (uint)bVar20 * -8 + (uint)bVar20 * -8 + 8);
            puVar18 = puVar17 + (uint)bVar20 * -2 + 1;
            *(uint *)((int)&local_d4 + (uint)bVar20 * -8 + 4) = *puVar17;
            *puVar19 = *puVar18;
            puVar19[(uint)bVar20 * -2 + 1] = puVar18[(uint)bVar20 * -2 + 1];
            core_xform_cpp_slerpQuaternion_FUN_0055d2d0(local_40,&local_d4,blend_weight,&local_134);
            puVar18 = (uint *)((int)local_38 + (uint)bVar20 * -8 + 0x6b4);
            (local_38->bone_transform).pose_data.bone_rotations[0].w = local_134.w;
            puVar19 = puVar18 + (uint)bVar20 * -2 + 1;
            puVar17 = (uint *)((int)&local_134 + (uint)bVar20 * -8 + (uint)bVar20 * -8 + 8);
            *puVar18 = *(uint *)((int)&local_134 + (uint)bVar20 * -8 + 4);
            *puVar19 = *puVar17;
            puVar19[(uint)bVar20 * -2 + 1] = puVar17[(uint)bVar20 * -2 + 1];
          }
          local_24 = local_24 + 1;
