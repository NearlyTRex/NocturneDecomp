...
;
; XREF[2]:
;   FUN_004113b0 at 004113c2
;   FUN_0051dcd0 at 0051dcda
;
; Referenced Globals:
...
section .text
    ...
    MOV dword ptr [0x01cc4804],EDI      ; 0051f5e4 | DAT_01cc4804
    CALL FUN_004c8440                   ; 0051f5ea
    ...
    CALL FUN_005191f0                   ; 0051f629
        ;   XREF to: 005191f0 (UNCONDITIONAL_CALL)  ; undefined FUN_005191f0()
    ADD ESP,0x8                         ; 0051f62e
    PUSH EBX                            ; 0051f631
    CALL FUN_005180a0                   ; 0051f632
