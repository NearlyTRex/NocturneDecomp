...
// Convention: unknown
// Signature: void FUN_0051f080(int param_1,int param_2,int param_3)
  ...
  if (0 < iVar1) {
    ...
    do {
      ...
      if ((*piVar4 == 0) && (piVar4[2] == 0)) {
        ...
        fVar9 = (float10)*piVar4;
        FUN_00566c81();
        fVar9 = fVar9 * (float10)_DAT_00591dcb;
        uVar10 = FUN_00563a30();
        piVar4 = (int *)((ulonglong)uVar10 >> 0x20);
        iVar2 = (int)uVar10 + (int)ROUND(fVar9);
        iVar7 = *DAT_005ae704;
        iVar3 = extraout_ECX;
      }
