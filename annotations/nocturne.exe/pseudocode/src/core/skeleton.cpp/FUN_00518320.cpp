// Name: core_skeleton.cpp_FUN_00518320
// Address: 00518320
// Address Range: [[00518320, 00518436]]
// Convention: unknown
// Signature: float * core_skeleton_cpp_FUN_00518320(int param_1,float *param_2,int param_3,int param_4,int param_5)

#include "nocturne.h"

float * core_skeleton_cpp_FUN_00518320(int param_1,float *param_2,int param_3,int param_4,int param_5)
