...
// Convention: __cdecl
// Signature: void __cdecl core_skeleton_cpp_CDeformableModelInstance_updateMotion_FUN_0051b920(int param_1,int param_2,undefined4 param_3,int param_4)

#include "nocturne.h"

/* WARNING: Type propagation algorithm not settling */

void __cdecl core_skeleton_cpp_CDeformableModelInstance_updateMotion_FUN_0051b920(int param_1,int param_2,uint param_3,int param_4)

{
  ...
  bVar12 = 0;
  iVar6 = core_skeleton_cpp_CDeformableModelInstance_getSkeletonPtr_FUN_0051e0a0(param_1);
  core_motion_cpp_CMotionController_getFramesForInterpolation_FUN_004e2070
            (param_1,param_2,param_3,&local_84,&local_88,&stack0xffffe790);
  if (param_4 < 0) {
    local_34 = 0;
    if (0 < *(int *)(iVar6 + 0x28558)) {
      ...
      do {
        core_skeleton_cpp_CSkeleton_getBoneAngleInterpolated_FUN_00517a80
                  (iVar6,local_34,local_84,local_88,local_1870,auStack_288 + 0xf);
        iVar8 = local_3c;
        local_3c = local_3c + 4;
        puVar11 = (uint *)(local_5c + 0x6b4 + (uint)bVar12 * -8);
        *(uint *)(local_5c + 0x6b0) = local_24c[0];
  ...
  if (*(int *)(param_1 + 0x2250) == 1) {
    ...
    if (0 < *(int *)(iVar6 + 0x28558)) {
      ...
      do {
        iVar8 = core_skeleton_cpp_CSkeleton_getHierarchyDistance_FUN_00517b10
                          (iVar6,local_1c,param_4);
        *(int *)((int)aiStack_5ac + local_38) = iVar8;
        if (-1 < iVar8) {
          core_skeleton_cpp_CSkeleton_getBoneAngleInterpolated_FUN_00517a80
                    (iVar6,local_1c,local_84,local_88,local_1870,auStack_108 + 0xf);
          puVar11 = (uint *)((int)local_bec + (uint)bVar12 * -8 + local_54 + 4);
          *(uint *)((int)local_bec + local_54) = local_cc[0];
          puVar9 = puVar11 + (uint)bVar12 * -2 + 1;
    ...
    if (-1 < iVar8) {
      core_skeleton_cpp_CSkeleton_getBoneAngleInterpolated_FUN_00517a80
                (iVar6,iVar8,local_84,local_88,local_1870,auStack_228 + 0x1b);
      puVar11 = local_bec + iVar8 * 4 + (uint)bVar12 * -2 + 1;
      local_bec[iVar8 * 4] = local_1bc[0];
      ...
      do {
        if (-1 < *(int *)((int)aiStack_5ac + local_58)) {
          ...
          if (iVar8 < 0) {
            ...
            ;
            core_xform_cpp_multiplyQuaternion_FUN_0055d130(iVar8,puVar11);
            ...
            ;
            core_xform_cpp_multiplyQuaternion_FUN_0055d130(auStack_108 + 0x13,iVar8);
    ...
    if (0 < *(int *)(iVar6 + 0x28558)) {
      ...
      do {
        iVar8 = core_skeleton_cpp_CSkeleton_getHierarchyDistance_FUN_00517b10
                          (iVar6,local_18,param_4);
        *(int *)((int)aiStack_41c + local_40) = iVar8;
        if (-1 < iVar8) {
          puVar11 = (uint *)
                    core_skeleton_cpp_CSkeleton_getBoneAngleAtFrame_FUN_00517a60
                              (iVar6,local_18,local_70);
          ...
          *puVar11 = puVar9[(uint)bVar12 * -2 + 1];
          puVar11[(uint)bVar12 * -2 + 1] = (puVar9 + (uint)bVar12 * -2 + 1)[(uint)bVar12 * -2 + 1];
          core_skeleton_cpp_CSkeleton_getBoneAngleInterpolated_FUN_00517a80
                    (iVar6,local_18,local_84,local_88,local_1870,auStack_228 + 0x2f);
          puVar11 = (uint *)((int)local_186c + (uint)bVar12 * -8 + local_44 + 4);
          *(uint *)((int)local_186c + local_44) = local_16c[0];
          puVar9 = puVar11 + (uint)bVar12 * -2 + 1;
    ...
    if (-1 < iVar8) {
      puVar11 = (uint *)
                core_skeleton_cpp_CSkeleton_getBoneAngleAtFrame_FUN_00517a60(iVar6,iVar8,local_70);
      ...
      *puVar10 = *puVar9;
      ...
      local_80 = iVar8 * 0x10;
      core_skeleton_cpp_CSkeleton_getBoneAngleInterpolated_FUN_00517a80
                (iVar6,local_78,local_84,local_88,local_1870,&local_22c);
      ...
      do {
        ...
        if (-1 < *(int *)((int)aiStack_41c + local_64)) {
          ...
          if (-1 < iVar8) {
            ...
            core_xform_cpp_multiplyQuaternion_FUN_0055d130(auStack_228 + 0x17,puVar11);
            ...
            core_xform_cpp_multiplyQuaternion_FUN_0055d130(auStack_108 + 0xb,puVar11);
            ...
            core_xform_cpp_multiplyQuaternion_FUN_0055d130(auStack_108 + 7,puVar11);
          ...
          if (iVar8 < 0) {
            ...
            core_xform_cpp_multiplyQuaternion_FUN_0055d130
                      (auStack_228 + 0x2b,iVar8 * 0x10 + local_6c);
    ...
    if (0 < *(int *)(iVar6 + 0x28558)) {
      ...
      do {
        iVar8 = local_24;
        iVar7 = core_skeleton_cpp_CSkeleton_getHierarchyDistance_FUN_00517b10
                          (iVar6,local_24,param_4);
        if (-1 < iVar7) {
          core_skeleton_cpp_CSkeleton_getBoneAngleInterpolated_FUN_00517a80
                    (iVar6,iVar8,local_84,local_88,local_1870,auStack_228 + 3);
