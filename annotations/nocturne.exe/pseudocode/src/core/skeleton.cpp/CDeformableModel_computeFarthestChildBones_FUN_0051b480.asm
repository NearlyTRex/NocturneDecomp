...
;
; XREF[1]:
;   core_skeleton.cpp_CDeformableModel_bindSkeleton_FUN_00519ae0 at 00519af9
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 0051b480
        ;   Label: core_skeleton.cpp_CDeformableModel_computeFarthestChildBones_FUN_0051b480
    PUSH ESI                            ; 0051b481
    PUSH EDI                            ; 0051b482
    PUSH EBP                            ; 0051b483
