...
;                               FUNCTION
; *****************************************************************************
; int core_skeleton_cpp_FUN_00518f60(undefined1 *param_1,int param_2,int param_3,byte param_4)
;
; Local Variables:
...
;
; XREF[1]:
;   core_skeleton.cpp_FUN_0051f030 at 0051f050
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00518f60
        ;   Label: core_skeleton.cpp_FUN_00518f60
    PUSH ESI                            ; 00518f61
    PUSH EDI                            ; 00518f62
    PUSH EBP                            ; 00518f63
    ...
    PUSH EAX                            ; 005190e0
    CALL shape_edittool.cpp_FUN_00472de0 ; 005190e1
