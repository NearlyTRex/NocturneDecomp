...
section .text
    ...
    PUSH 0x22b4                         ; 00519c19
        ;   Label: LAB_00519c19
    CALL crt_memory.c_operator_new_FUN_0056497c ; 00519c1e
    ...
    MOV [0x01cc4800],EAX                ; 00519c4a | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EDX      ; 00519c4f | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 00519c55
