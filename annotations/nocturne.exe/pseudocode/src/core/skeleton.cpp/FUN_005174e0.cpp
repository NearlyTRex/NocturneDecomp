...

{
  ...
  *(uint *)(param_1 + 0x2936c) = 0;
  shape_memdbg_cpp_free_FUN_00564486(*(void **)(param_1 + 0x29370));
  if (*(int *)(param_1 + 0x29374) != 0) {
    shape_memdbg_cpp_free_FUN_00564486((void *)(*(int *)(param_1 + 0x29374) + -4));
  }
  if (*(int *)(param_1 + 0x29378) != 0) {
    shape_memdbg_cpp_free_FUN_00564486((void *)(*(int *)(param_1 + 0x29378) + -4));
  }
