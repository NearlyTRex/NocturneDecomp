...
// Convention: unknown
// Signature: void FUN_00519ec0(int param_1,int param_2,int param_3,int param_4,undefined4 *param_5,int param_6)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_00519ec0(int param_1,int param_2,int param_3,int param_4,uint *param_5,int param_6)

{
  ...
  if (param_3 != 0) {
    ...
    FUN_00563cc0(0x2671950,0,*(int *)(iVar7 + 0x2c) << 2);
    if (local_2c < iVar8) {
      iVar4 = local_2c * 0x12;
      do {
    ...
    if (local_2c < iVar8) {
      ...
      do {
        ...
        *(uint *)(iVar5 + 4) = 3;
        ...
        iVar7 = iVar7 + 0x3c;
        uVar6 = FUN_00417c90(param_3,*(int *)(local_2c + *(int *)(iVar4 + 0x90)) * 0x48 +
    ...
    if (local_30 < iVar3) {
      ...
      do {
        ...
        *(uint *)(iVar4 + 4) = 3;
        ...
        iVar8 = iVar8 + 4;
        local_30 = local_30 + 4;
        uVar6 = FUN_00417c90(param_3,*piVar2 * 0x48 + param_1 + param_6 * 0x240 + 200);
