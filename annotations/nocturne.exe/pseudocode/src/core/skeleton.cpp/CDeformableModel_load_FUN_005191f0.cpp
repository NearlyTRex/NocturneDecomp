...
// Convention: __cdecl
// Signature: void __cdecl core_skeleton_cpp_CDeformableModel_load_FUN_005191f0(int param_1,char *param_2)
...

{
  ...
  iVar2 = engine_dosio_cpp_getFile_FUN_00456a60("models",param_2,&DAT_00591693);
  if (iVar2 == 0) {
