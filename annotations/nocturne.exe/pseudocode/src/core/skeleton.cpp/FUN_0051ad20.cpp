...
// Convention: unknown
// Signature: int FUN_0051ad20(int param_1)
...

{
  ...
  if (*(int *)(param_1 + 0xc00) < 2) {
    *(uint *)(param_1 + 0xc60) = 0;
    ...
    FUN_005180a0(param_1);
    iVar3 = FUN_00518130(param_1);
    local_24 = *(int *)(iVar3 + 0x28558);
    iVar3 = FUN_0056497c(0x22b4);
    local_20 = 0;
    if (iVar3 != 0) {
      local_20 = FUN_0051b660(iVar3);
    }
    if (local_20 == 0) {
    ...
    iVar3 = local_20;
    FUN_0051dd00(local_20,param_1);
    FUN_0051b800(iVar3);
    FUN_0051d3c0(iVar3);
    iVar3 = FUN_0051da50(iVar3,0);
    local_34 = 0;
    ...
    if (0 < local_24) {
      do {
        uVar8 = FUN_00519be0(param_1,iVar11);
        iVar11 = iVar11 + 1;
