...
// Convention: __cdecl
// Signature: CBoundingBox3D * __cdecl core_skeleton_cpp_CDeformableModelInstance_computeBoundingBoxFromBones_FUN_0051ef40(CDeformableModelInstance *this_ptr,CBoundingBox3D *output_bbox)
...

{
  ...
  pCVar2 = core_skeleton_cpp_CDeformableModel_getSkeletonPtr_FUN_00518130(this_ptr_01);
    ...
    do {
      ...
      if (local_18->bone_flags[0] == 2) {
        ...
        do {
          ...
          core_box_cpp_CBoundingBox3D_expand_FUN_0041cc00(output_bbox,pCVar3);
