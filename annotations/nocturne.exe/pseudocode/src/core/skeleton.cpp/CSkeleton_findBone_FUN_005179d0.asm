...
section .text
    ...
    MOV dword ptr [0x01cc4800],ESI      ; 00517a39 | g_CurrentFilename
    MOV [0x01cc4804],EAX                ; 00517a3f | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 00517a44
