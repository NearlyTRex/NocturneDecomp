...
// Convention: __cdecl
// Signature: void __cdecl core_skeleton_cpp_CDeformableModelInstance_initializeFromModel_FUN_0051dd00(int param_1,undefined4 param_2)

#include "nocturne.h"

void __cdecl core_skeleton_cpp_CDeformableModelInstance_initializeFromModel_FUN_0051dd00(int param_1,uint param_2)

{
  ...
  *(uint *)(param_1 + 0x22b0) = param_2;
  ...
  core_motion_cpp_CMotionController_setMotionList_FUN_004e1860(param_1,iVar1);
  ...
  if (0 < local_14) {
    ...
    do {
      pfVar2 = (float *)core_skeleton_cpp_CDeformableModel_getVertexPoolPtr_FUN_00518180
                                  (*(uint *)(param_1 + 0x22b0),iVar4);
      if (pfVar3 != pfVar2) {
        *pfVar3 = *pfVar2;
        pfVar3[1] = pfVar2[1];
        pfVar3[2] = pfVar2[2];
  ...
  core_skeleton_cpp_CDeformableModelInstance_allocPointList_FUN_0051b750(param_1);
  core_skeleton_cpp_CDeformableModelInstance_computeBoundingBoxFromVertices_FUN_0051de60(param_1);
  core_skeleton_cpp_CDeformableModelInstance_updateAnimationAndTransforms_FUN_0051b880(param_1);
  return;
}
