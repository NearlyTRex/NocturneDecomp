...
// Convention: unknown
// Signature: float FUN_0051a470(int param_1,int param_2,undefined4 param_3,undefined4 param_4,int *param_5,byte *param_6)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

float FUN_0051a470(int param_1,int param_2,uint param_3,uint param_4,int *param_5,byte *param_6)
  ...
  if (0 < *(int *)(param_1 + 0xc00)) {
    ...
    do {
      ...
      if (((*local_24 & 1) != 0) &&
        ...
        do {
          FUN_0046c5b0(local_6c);
          local_14 = (float)FUN_0046c620();
