...
;
; XREF[1]:
;   FUN_005191f0 at 0051923c
;
; Referenced Globals:
;   undefined4 DAT_005916d9
...
section .text
    ...
    LEA EAX,[ESP + 0x28]                ; 005192a9
        ;   Label: LAB_005192a9
    PUSH EAX                            ; 005192ad
    PUSH 0x5916d9                       ; 005192ae | DAT_005916d9
    PUSH ESI                            ; 005192b3
    CALL FUN_00563350                   ; 005192b4
    ...
    CALL FUN_00517da0                   ; 0051938b
        ;   XREF to: 00517da0 (UNCONDITIONAL_CALL)  ; undefined FUN_00517da0()
    ADD ESP,0x14                        ; 00519390
    PUSH EDI                            ; 00519393
        ;   Label: LAB_00519393
    CALL FUN_00564570                   ; 00519394
        ;   XREF to: 00564570 (UNCONDITIONAL_CALL)  ; undefined FUN_00564570()
    ...
    PUSH EDI                            ; 005193f5
    PUSH EBX                            ; 005193f6
    CALL FUN_00517ec0                   ; 005193f7
        ;   XREF to: 00517ec0 (UNCONDITIONAL_CALL)  ; undefined FUN_00517ec0()
    INC EDI                             ; 005193fc
    ...
    PUSH EAX                            ; 00519584
    PUSH 0x5917d8                       ; 00519585 | DAT_005917d8
    PUSH ESI                            ; 0051958a
    INC EBP                             ; 0051958b
    CALL FUN_00563350                   ; 0051958c
        ;   XREF to: 00563350 (UNCONDITIONAL_CALL)  ; undefined FUN_00563350()
    ...
    PUSH EAX                            ; 00519660
    PUSH 0x5917f5                       ; 00519661 | DAT_005917f5
    PUSH ESI                            ; 00519666
    CALL FUN_00563350                   ; 00519667
        ;   XREF to: 00563350 (UNCONDITIONAL_CALL)  ; undefined FUN_00563350()
    ...
    PUSH EAX                            ; 005196dc
    PUSH 0x5917f9                       ; 005196dd | DAT_005917f9
    PUSH ESI                            ; 005196e2
    CALL FUN_00563350                   ; 005196e3
        ;   XREF to: 00563350 (UNCONDITIONAL_CALL)  ; undefined FUN_00563350()
    ...
    PUSH EAX                            ; 0051989c
    PUSH 0x59182c                       ; 0051989d | DAT_0059182c
    PUSH ESI                            ; 005198a2
    CALL FUN_00563350                   ; 005198a3
        ;   XREF to: 00563350 (UNCONDITIONAL_CALL)  ; undefined FUN_00563350()
    ...
    PUSH EAX                            ; 00519a3d
    PUSH 0x591855                       ; 00519a3e | DAT_00591855
    PUSH ESI                            ; 00519a43
    INC EDI                             ; 00519a44
    CALL FUN_00563350                   ; 00519a45
        ;   XREF to: 00563350 (UNCONDITIONAL_CALL)  ; undefined FUN_00563350()
    ...
    PUSH EBX                            ; 00519a9a
    CALL FUN_0051ad20                   ; 00519a9b
        ;   XREF to: 0051ad20 (UNCONDITIONAL_CALL)  ; undefined FUN_0051ad20()
