...
section .text
    ...
    PUSH ESI                            ; 0051e590
        ;   Label: core_skeleton.cpp_CDeformableModelInstance_getRootMotionDelta_FUN_0051e590
    PUSH EDI                            ; 0051e591
    ...
    CALL crt_math.c_floor_FUN_005648c0  ; 0051e5e3
    ...
    CALL crt_math.c_ceil_FUN_00567121   ; 0051e60c
