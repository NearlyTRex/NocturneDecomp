...

{
  ...
  uVar1 = __vec_delete(param_1[param_2 + 0x10],&g_SVertTypeInfo_005a1ee0);
  ...
  uVar1 = shape_memdbg_cpp_malloc_FUN_00564c18
                    (param_1[param_2 + 0xb] * 0x34 + 4,param_1[param_2 + 0xb],
                     &g_SVertTypeInfo_005a1ee0);
  ...
  core_main_c_FUN_004c8440
            ("Out of hunk in CDeformableModel::allocMemory.  vertexCount=%d, triCount=%d, capTriCount=%d",param_1 + 0xb,param_1 + 0x15,param_1 + 0x1a);
  return;
}
