...
// Convention: __cdecl
// Signature: void __cdecl core_skeleton_cpp_CDeformableModel_skinVertices_FUN_005181a0(CDeformableModel *this_ptr,int lod_index,CMatrix3x4f *bone_matrices,int *output_buffer,SPartInstanceData *part_data)
...

{
  ...
  for (local_20 = 0; local_20 < *(int *)((int)this_ptr->vertex_count + local_24);
    ...
    *local_18 = (int)ROUND(local_30.x * _DAT_005a1ea8);
    local_18[1] = (int)ROUND(local_30.y * _DAT_005a1ea8);
    local_18[2] = (int)ROUND(local_30.z * _DAT_005a1ea8);
    local_18 = local_18 + 3;
