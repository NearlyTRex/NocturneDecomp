...
// Convention: __cdecl
// Signature: void __cdecl core_skeleton_cpp_CDeformableModel_captureTextures_FUN_005180a0(int param_1)
  ...
  if (0 < *(int *)(param_1 + 0xb8)) {
    ...
    do {
      ...
      if (0 < *(int *)(param_1 + 0xbc)) {
        do {
          iVar2 = iVar2 + 1;
          engine_drender_cpp_CDemonRenderer_captureTexture_FUN_00461eb0(DAT_005ae704,iVar4);
          iVar4 = iVar4 + 0x48;
