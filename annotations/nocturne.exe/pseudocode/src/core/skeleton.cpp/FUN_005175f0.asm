...
section .text
    ...
    PUSH EDI                            ; 005176dd
    CALL FUN_005173c0                   ; 005176de
        ;   XREF to: 005173c0 (UNCONDITIONAL_CALL)  ; undefined FUN_005173c0()
    ADD ESP,0xc                         ; 005176e3
    MOV EBX,dword ptr [ESP + 0x2c]      ; 005176e6
    PUSH EBX                            ; 005176ea
        ;   Label: LAB_005176ea
    CALL FUN_00564570                   ; 005176eb
        ;   XREF to: 00564570 (UNCONDITIONAL_CALL)  ; undefined FUN_00564570()
    ...
    PUSH ECX                            ; 00517905
    CALL FUN_004e0920                   ; 00517906
        ;   XREF to: 004e0920 (UNCONDITIONAL_CALL)  ; undefined FUN_004e0920()
