...
;   core_skeleton.cpp_CBoundingBox3D_arrdtor_FUN_0051f900
...
section .text
    ...
    PUSH EBX                            ; 00517c96
    CALL core_skeleton.cpp_CBoundingBox3D_arrdtor_FUN_0051f900 ; 00517c97
        ;   XREF to: 0051f900 (UNCONDITIONAL_CALL)  ; CBoundingBox3D * core_skeleton.cpp_CBoundingBox3D_arrdtor_FUN_0051f900(CBoundingBox3D * this_ptr, uint flags)
