...
;   core_skeleton.cpp_CBoundingBox3D_arrdtor100_FUN_0051f900
...
section .text
    ...
    PUSH EBX                            ; 00517c96
    CALL core_skeleton.cpp_CBoundingBox3D_arrdtor100_FUN_0051f900 ; 00517c97
        ;   XREF to: 0051f900 (UNCONDITIONAL_CALL)  ; CBoundingBox3D * core_skeleton.cpp_CBoundingBox3D_arrdtor100_FUN_0051f900(CBoundingBox3D * this_ptr, uint flags)
    ADD ESP,0x8                         ; 00517c9c
    PUSH 0x0                            ; 00517c9f
    SUB EAX,0x4bc                       ; 00517ca1
    PUSH EAX                            ; 00517ca6
    CALL core_curtain.cpp_CVector3f_arrdtor100_FUN_0043f9a0 ; 00517ca7
