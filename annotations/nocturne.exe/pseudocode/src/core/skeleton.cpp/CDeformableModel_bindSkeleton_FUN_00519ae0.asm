...
section .text
    ...
    CALL core_skeleton.cpp_CDeformableModel_computeBoneBoundsAndFlags_FUN_0051b280 ; 00519af0
        ;   XREF to: 0051b280 (UNCONDITIONAL_CALL)  ; undefined core_skeleton.cpp_CDeformableModel_computeBoneBoundsAndFlags_FUN_0051b280()
    ADD ESP,0x4                         ; 00519af5
    PUSH EBX                            ; 00519af8
    CALL core_skeleton.cpp_CDeformableModel_computeFarthestChildBones_FUN_0051b480 ; 00519af9
        ;   XREF to: 0051b480 (UNCONDITIONAL_CALL)  ; undefined core_skeleton.cpp_CDeformableModel_computeFarthestChildBones_FUN_0051b480()
