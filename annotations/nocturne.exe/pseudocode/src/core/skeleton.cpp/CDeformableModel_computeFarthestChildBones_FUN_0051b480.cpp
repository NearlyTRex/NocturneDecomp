...
// Convention: __cdecl
// Signature: void __cdecl core_skeleton_cpp_CDeformableModel_computeFarthestChildBones_FUN_0051b480(int param_1)
...

{
  ...
  iVar2 = core_skeleton_cpp_CDeformableModel_getSkeletonPtr_FUN_00518130(param_1);
  iVar6 = 0;
