...
// Convention: unknown
// Signature: void FUN_0051c3d0(int param_1,undefined4 param_2,undefined4 param_3,float param_4,int param_5,code *param_6)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_0051c3d0(int param_1,uint param_2,uint param_3,float param_4,int param_5,code *param_6)

{
  ...
  if ((float)_DAT_00591b8b < param_4) {
    FUN_004e2070(param_1,param_2,param_3,local_58,&local_5c,&local_938);
    ...
    if (*(int *)(param_1 + 0x2250) == 0) {
      if (0 < *(int *)(iVar8 + 0x28558)) {
        ...
        do {
          iVar10 = local_1c;
          iVar9 = FUN_00517b10(iVar8,local_1c,param_5);
          if (-1 < iVar9) {
            local_18 = (*param_6)(iVar10,param_5,param_4,iVar9,param_1);
            FUN_00517a80(iVar8,iVar10,local_58[0],local_5c,local_938,local_18);
            iVar10 = local_2c;
      ...
      if (0 < *(int *)(iVar8 + 0x28558)) {
        ...
        local_28 = 0;
        do {
          iVar10 = FUN_00517b10(iVar8,local_20,param_5);
          *(int *)((int)aiStack_2f4 + local_28) = iVar10;
          if (-1 < iVar10) {
            FUN_00517a80(iVar8,local_20,local_58[0],local_5c,local_938);
            puVar11 = (uint *)((int)local_934 + (uint)bVar13 * -8 + local_44 + 4);
            *(uint *)((int)local_934 + local_44) = local_124;
            puVar12 = puVar11 + (uint)bVar13 * -2 + 1;
      ...
      if (-1 < iVar10) {
        FUN_00517a80(iVar8,iVar10,local_58[0],local_5c,local_938);
        ...
        do {
          if (-1 < *(int *)((int)aiStack_2f4 + local_3c)) {
            ...
            if (iVar10 < 0) {
              ...
              ;
              FUN_0055d130(auStack_160 + 0x13,iVar10);
            ...
            FUN_0055d2d0(local_40,auStack_f0 + 7,param_4);
