...
section .text
    ...
    PUSH EBX                            ; 0051d650
        ;   Label: core_skeleton.cpp_CDeformableModelInstance_aimBoneAtTarget_FUN_0051d650
    PUSH ESI                            ; 0051d651
    ...
    CALL core_xform.cpp_quaternionFromAngleX_FUN_0055d4a0 ; 0051d6f0
    ...
    CALL core_xform.cpp_quaternionFromAngleY_FUN_0055d4e0 ; 0051d714
