...
// Convention: unknown
// Signature: void FUN_0051a780(int param_1,float *param_2,undefined4 param_3,int param_4,int *param_5,byte *param_6,int *param_7)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_0051a780(int param_1,float *param_2,uint param_3,int param_4,int *param_5,byte *param_6,int *param_7)

{
  ...
  local_1c = 0xffff;
  FUN_0044d7a0(local_e0,param_3);
  if ((DAT_0268ced4 & 1) == 0) {
    DAT_0268ced4 = DAT_0268ced4 | 1;
    FUN_005644a7(&DAT_02684234,3000,&DAT_005993b0);
  }
  ...
  if (0 < *(int *)(local_5c + 0x2c)) {
    do {
      *pfVar7 = (float)*param_5 * _DAT_005a1eb0;
      ...
      pfVar2 = (float *)FUN_0044da40(local_e0,local_70,pfVar7);
  ...
  FUN_005644a7(local_b8,3,&DAT_005993b0);
  local_24 = 0;
  local_44 = 0;
    ...
    do {
      ...
      if (((*local_4c & 1) != 0) && (local_24 < local_40)) {
        ...
        do {
          ...
          FUN_0048b1c0(0x01C08D04,local_b8,local_94,local_94 + 3,
