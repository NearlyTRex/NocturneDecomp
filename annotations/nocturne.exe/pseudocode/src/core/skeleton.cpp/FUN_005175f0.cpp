...
// Convention: unknown
// Signature: void FUN_005175f0(int param_1,int param_2)
...

{
  ...
  FUN_00563350(param_2,&DAT_00591228,&local_24);
  if (local_24 < 1) {
  ...
  FUN_005173c0(param_1,local_20,local_1c);
  do {
    iVar1 = FUN_00564570(param_2);
    if (iVar1 < 0) break;
  } while (iVar1 != 10);
