...
// Convention: __cdecl
// Signature: void __cdecl core_skeleton_cpp_CDeformableModelInstance_blendWithQuaternions_FUN_0051cae0(int param_1,undefined4 *param_2,float *param_3,float param_4,int param_5,code *param_6)
  ...
  if ((float)0.001 < param_4) {
    ...
    if (*(int *)(param_1 + 0x2250) == 0) {
      ...
      if (0 < *(int *)(iVar4 + 0x28558)) {
        ...
        local_2c = local_34;
        do {
          iVar5 = core_skeleton_cpp_CSkeleton_getHierarchyDistance_FUN_00517b10(iVar4,iVar6,param_5)
          ;
          if (-1 < iVar5) {
      ...
      if (0 < *(int *)(iVar4 + 0x28558)) {
        ...
        local_20 = iVar4;
        do {
          iVar6 = core_skeleton_cpp_CSkeleton_getHierarchyDistance_FUN_00517b10
                            (iVar4,local_18,param_5);
          if (-1 < iVar6) {
            ...
            if (-1 < iVar6) {
              ...
              *(uint *)
               ...
               ((uint)bVar10 * -2 + 1) * 4) =
                   *(uint *)
                    ...
                    ((uint)bVar10 * -2 + 1) * 4);
              core_xform_cpp_multiplyQuaternion_FUN_0055d130(puVar8,puVar9);
              ...
              *(uint *)
               ...
               ((uint)bVar10 * -2 + 1) * 4) =
                   (auStack_84 + (uint)bVar10 * 0xfffffffe + (uint)bVar10 * 0xfffffffe + 5)
                   [(uint)bVar10 * -2 + 1];
              core_xform_cpp_multiplyQuaternion_FUN_0055d130(&stack0xffffff48,local_34 + local_14);
            ...
            *(uint *)
            ...
            core_xform_cpp_slerpQuaternion_FUN_0055d2d0(local_30,&stack0xffffff28,param_4);
