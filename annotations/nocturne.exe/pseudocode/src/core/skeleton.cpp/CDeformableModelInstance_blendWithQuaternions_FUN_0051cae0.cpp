      ...
      if (0 < this_ptr_00->bone_count) {
        ...
        do {
          ...
          if (-1 < hierarchy_distance) {
            ...
            core_xform_cpp_slerpQuaternion_FUN_0055d2d0(local_2c,local_1c,local_14,&CStack_e8);
          ...
          if (-1 < iVar8) {
            ...
            if (-1 < iVar8) {
              ...
              *puVar11 = *puVar9;
              ...
              core_xform_cpp_multiplyQuaternion_FUN_0055d130(quat1_in,pCVar10,local_78);
            ...
            *puVar12 = *puVar11;
            ...
            core_xform_cpp_slerpQuaternion_FUN_0055d2d0(local_30,&local_d8,blend_weight,&local_88);
