...
section .text
    ...
    PUSH EBX                            ; 00422050
        ;   Label: core_bugs.cpp_CBugs_updateBugsBehavior_FUN_00422050
    PUSH ESI                            ; 00422051
    PUSH EDI                            ; 00422052
    PUSH EBP                            ; 00422053
    ...
    PUSH EBX                            ; 004220ee
        ;   Label: LAB_004220ee
    CALL core_bugs.cpp_CBugs_updateGroundHeightGrid_FUN_00421b80 ; 004220ef
    ...
    PUSH EBX                            ; 00422348
        ;   Label: LAB_00422348
    CALL core_bugs.cpp_CBugs_updateGroundHeightGrid_FUN_00421b80 ; 00422349
        ;   XREF to: 00421b80 (UNCONDITIONAL_CALL)  ; void core_bugs.cpp_CBugs_updateGroundHeightGrid_FUN_00421b80(CBugs * this_ptr)
