...

{
  ...
  iVar1 = core_charactr_cpp_CCharacter_process_FUN_004259f0((CCharacter *)this_ptr,delta_time);
  if (iVar1 != 0) {
    ...
    case BUGS_STATE_IDLE:
      core_bugs_cpp_CBugs_updateBugsBehavior_FUN_00422050(this_ptr,delta_time);
      break;
