...
section .text
    ...
    PUSH EBX                            ; 00422050
        ;   Label: core_bugs.cpp_FUN_00422050
    PUSH ESI                            ; 00422051
    PUSH EDI                            ; 00422052
    PUSH EBP                            ; 00422053
    ...
    PUSH ESI                            ; 004220fd
    PUSH EBX                            ; 004220fe
    CALL core_bugs.cpp_FUN_00423790     ; 004220ff
        ;   XREF to: 00423790 (UNCONDITIONAL_CALL)  ; undefined core_bugs.cpp_FUN_00423790()
