// Name: core_bugs.cpp_CBugs_updateBugsBehavior_FUN_00422050
// Address: 00422050
// Address Range: [[00422050, 00422368]]
// Convention: __cdecl
// Signature: void __cdecl core_bugs_cpp_CBugs_updateBugsBehavior_FUN_00422050(CBugs *this_ptr,float delta_time)

#include "nocturne.h"

/* WARNING: Type propagation algorithm not settling */

void __cdecl core_bugs_cpp_CBugs_updateBugsBehavior_FUN_00422050(CBugs *this_ptr,float delta_time)

{
  ...
  if ((this_ptr->allow_swarm != 0) &&
    ...
    if ((ABS(fStack_70) < (float)2) &&
      ...
      core_bugs_cpp_CBugs_setSwarmTarget_FUN_00423790(this_ptr,&((this_ptr->base).victim)->base);
  ...
  if ((this_ptr->allow_chase != 0) &&
    ...
    if (this_ptr_00 == (CPathMap *)0x0) {
      this_ptr_00 = core_path_cpp_getPathMap_FUN_004f1e00
    ...
    if (iVar3 != 0) {
      core_dirmat_cpp_CMatrix3x3f_buildRotationMatrix_FUN_0044d7a0(&CStack_a8,&CStack_50);
      CStack_80.z = 2.0f * delta_time;
      CStack_80.x = 0.0;
      CStack_80.y = 0.0;
      pfStack_14 = (float *)CStack_80.z;
      core_dirmat_cpp_CMatrix3x3f_transformVector_FUN_0044da40(&CStack_a8,&CStack_2c,&CStack_80);
      ...
      core_charactr_cpp_CCharacter_moveAndCollide_FUN_00425050((CCharacter *)this_ptr,&CStack_2c);
      ...
      fStack_5c = fStack_20 * 5.2220990168285998e-315._0_4_;
      fStack_18 = (this_ptr->bounds).min.z + (this_ptr->bounds).max.z;
      fStack_58 = fStack_1c * 5.2220990168285998e-315._0_4_;
      fStack_54 = fStack_18 * 5.2220990168285998e-315._0_4_;
      fStack_40 = fStack_58;
      if (((((this_ptr->bounds).min.x <= fStack_44) && ((this_ptr->bounds).min.y <= fStack_58)) &&
        ...
        core_bugs_cpp_CBugs_applySwarmTranslation_FUN_00423a50(this_ptr,&CStack_38);
      }
    }
  }
  core_bugs_cpp_CBugs_updateGroundHeightGrid_FUN_00421b80(this_ptr);
LAB_00422116:
  ...
  if (0 < this_ptr->count) {
    ...
    do {
      iVar3 = iVar3 + 1;
      core_bugs_cpp_CBugs_updateBugPathfinding_FUN_004227b0
