...
// Convention: unknown
// Signature: int core_bugs_cpp_FUN_00423d90(int param_1,byte param_2)

#include "nocturne.h"

int core_bugs_cpp_FUN_00423d90(int param_1,byte param_2)

{
  ...
  if ((param_2 & 4) != 0) {
    uVar2 = __vec_delete(param_1,&g_CBugsTypeInfo_0059b050);
    shape_memdbg_cpp_free_FUN_00564486(uVar2);
    return param_1;
  }
  iVar1 = core_bugs_cpp_FUN_00423e80(param_1 + 0xbd2c,0);
  iVar1 = core_armour_cpp_CFlame_arrdtor_FUN_0040fe50(iVar1 + -0x8968,0);
