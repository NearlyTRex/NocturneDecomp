...
// Convention: unknown
// Signature: void FUN_004c1190(int param_1,undefined4 param_2)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_004c1190(int param_1,uint param_2)

{
  ...
  FUN_00564b20(local_1dc,0xff,param_2);
  FUN_00564b20(local_1dc,0xff,param_2);
  FUN_00563350(param_2,&DAT_005872b9,param_1 + 0x32c);
  FUN_00564b20(local_1dc,0xff,param_2);
  FUN_00563350(param_2,&DAT_005872bd,param_1 + 8);
  FUN_00564b20(local_1dc,0xff,param_2);
  FUN_00563350(param_2,&DAT_005872c1,&local_14);
  if (0 < *(int *)(param_1 + 0x32c)) {
    FUN_00564b20(local_1dc,0xff,param_2);
    FUN_00563350(param_2,&DAT_005872c5,param_1);
  }
  FUN_00564b20(local_1dc,0xff,param_2);
  iVar6 = 0;
  iVar5 = param_1;
  if (0 < *(int *)(param_1 + 8)) {
    do {
      ...
      if (*(int *)(0x01CC9450 + 0xc) == 0) {
        pcVar8 = local_78;
        pcVar3 = (char *)FUN_0040d540(local_dc);
        pcVar10 = pcVar3;
        do {
          cVar1 = *pcVar8;
          *pcVar10 = cVar1;
        ...
        *(char **)(iVar5 + 0xc) = pcVar3;
        ...
        uVar2 = FUN_004d8640(0x01CC9450,local_78);
  ...
  if (0 < *(int *)(param_1 + 8)) {
    do {
      FUN_0040c160(*(uint *)(iVar5 + 0xc),param_2);
      iVar6 = iVar6 + 1;
      iVar5 = iVar5 + 4;
    } while (iVar6 < *(int *)(param_1 + 8));
  }
  ...
  *(uint *)(param_1 + 0x450) = uVar2;
  if (-1 < local_14) {
    uVar2 = FUN_0040d890(*(uint *)(local_14 * 4 + param_1 + 0xc),_DAT_02ddf9a8);
