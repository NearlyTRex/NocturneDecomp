...
// Convention: __cdecl
// Signature: void __cdecl core_inv_cpp_drawItemIconBackground_FUN_004c1f90(int param_1,int param_2,int param_3,int param_4,undefined4 param_5)

#include "nocturne.h"

void __cdecl core_inv_cpp_drawItemIconBackground_FUN_004c1f90(int param_1,int param_2,int param_3,int param_4,uint param_5)

{
  ...
  engine_drender_cpp_CDemonRenderer_captureTexture_FUN_00461eb0(DAT_005ae704,&DAT_005bac34);
  ...
  *(uint *)(*piVar1 + 0xac) = 0x600000;
  ...
  local_24 = 3;
  local_28 = 2;
  engine_drender_cpp_CDemonRenderer_renderTexturedDirect_FUN_0045f3c0(piVar1,local_48,0xa3);
  local_20 = param_1;
  local_18 = param_2;
  local_1c = param_3;
  local_14 = param_4;
