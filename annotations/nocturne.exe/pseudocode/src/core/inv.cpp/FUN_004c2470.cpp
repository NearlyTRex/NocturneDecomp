...
// Convention: unknown
// Signature: void core_inv_cpp_FUN_004c2470(float *param_1)
...

{
  ...
  iVar3 = core_actor_cpp_castToClassHash_FUN_0040d890
                    (param_1[0xcc],g_CLightGunActorType_01cc3688.name_hash);
  if (iVar3 == 0) {
...
LAB_004c27a0:
  if ((param_1[0xcd] != 0.0) && (0.0 < param_1[0xcf])) {
    ...
    iVar4 = core_actor_cpp_castToClassHash_FUN_0040d890
                      (param_1[0xcd],g_CHealthItemActorType_01cae098.name_hash);
    if (iVar4 != 0) {
    ...
    iVar4 = core_actor_cpp_castToClassHash_FUN_0040d890
                      (param_1[0xcd],g_CFilmReelActorType_01c08c8c.name_hash);
    if (iVar4 != 0) {
      uVar5 = core_inv_cpp_getItemDisplayName_FUN_004beca0();
