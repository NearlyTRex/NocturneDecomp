...
section .text
    ...
    CALL FUN_004d8640                   ; 004c1300
        ;   XREF to: 004d8640 (UNCONDITIONAL_CALL)  ; undefined FUN_004d8640()
    ...
    PUSH ESI                            ; 004c13e4
    CALL FUN_004c1b90                   ; 004c13e5
        ;   XREF to: 004c1b90 (UNCONDITIONAL_CALL)  ; undefined FUN_004c1b90()
    ...
    LEA EAX,[EBX*0x4 + 0x0]             ; 004c146a
        ;   Label: LAB_004c146a
    MOV ESI,dword ptr [0x02ddf9a8]      ; 004c1471 | DAT_02ddf9a8
    ADD EAX,EDX                         ; 004c1477
    PUSH ESI                            ; 004c1479
    MOV EBP,dword ptr [EAX + 0xc]       ; 004c147a
    PUSH EBP                            ; 004c147d
    MOV EDI,EDX                         ; 004c147e
    CALL FUN_0040d890                   ; 004c1480
    ...
    MOV dword ptr [0x01cc4800],ECX      ; 004c14ad | DAT_01cc4800
    MOV dword ptr [0x01cc4804],EBX      ; 004c14b3 | DAT_01cc4804
    CALL FUN_004c8440                   ; 004c14b9
