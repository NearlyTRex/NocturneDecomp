...
;
; XREF[1]:
;   core_game.cpp_CGame_processFrame_FUN_0049cc10 at 0049cfc3
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004c2470
        ;   Label: core_inv.cpp_CInventory_renderAllItems_FUN_004c2470
    PUSH ESI                            ; 004c2471
    PUSH EDI                            ; 004c2472
    PUSH EBP                            ; 004c2473
    ...
    JNZ 0x004c2dcc                      ; 004c24a4
        ;   XREF to: 004c2dcc (CONDITIONAL_JUMP)  ; LAB_004c2dcc
    MOV EBX,dword ptr [0x005b7620]      ; 004c24aa | g_WindowHeight
    ...
    MOV EDI,dword ptr [0x005b7620]      ; 004c252c | g_WindowHeight
    ...
    MOV EDX,dword ptr [0x005b7620]      ; 004c2623 | g_WindowHeight
    ...
    PUSH EDX                            ; 004c263b
    MOV EDX,dword ptr [0x005b761c]      ; 004c263c | g_WindowWidth
    ...
    MOV EBX,dword ptr [0x005b7620]      ; 004c271b | g_WindowHeight
    ...
    MOV EAX,[0x005b761c]                ; 004c2738 | g_WindowWidth
    ...
    MOV EDI,dword ptr [0x005b7620]      ; 004c27d3 | g_WindowHeight
    ...
    MOV EDX,dword ptr [0x005b7620]      ; 004c2879 | g_WindowHeight
    ...
    PUSH EDX                            ; 004c2891
    MOV EDX,dword ptr [0x005b761c]      ; 004c2892 | g_WindowWidth
    ...
    MOV EDX,dword ptr [0x005b7620]      ; 004c2921 | g_WindowHeight
    ...
    PUSH EDX                            ; 004c2939
    MOV EDX,dword ptr [0x005b761c]      ; 004c293a | g_WindowWidth
    ...
    MOV EDI,dword ptr [0x005b7620]      ; 004c2a03 | g_WindowHeight
    MOV dword ptr [ESP + 0x64c],EAX     ; 004c2a09
    SUB EDI,ESI                         ; 004c2a10
    ADD EDI,dword ptr [ESP + 0x63c]     ; 004c2a12
    MOV EAX,[0x005b761c]                ; 004c2a19 | g_WindowWidth
    ...
    MOV EAX,[0x005b7620]                ; 004c2a92 | g_WindowHeight
        ;   Label: LAB_004c2a92
    SUB EAX,0x21                        ; 004c2a97
    MOV dword ptr [ESP + 0x610],EAX     ; 004c2a9a
    MOV EAX,[0x005b7620]                ; 004c2aa1 | g_WindowHeight
    ...
    PUSH EDI                            ; 004c2af3
    PUSH 0x6                            ; 004c2af4
    MOV EBX,dword ptr [0x005b7620]      ; 004c2af6 | g_WindowHeight
    ...
    MOV EBX,0x3f                        ; 004c2bcd
        ;   Label: LAB_004c2bcd
    MOV ESI,dword ptr [0x005b7620]      ; 004c2bd2 | g_WindowHeight
    ...
    MOV EAX,[0x005b761c]                ; 004c2bef | g_WindowWidth
        ;   Label: LAB_004c2bef
    ...
    CALL engine_alphabit.cpp_CAlphaBitmap_render_FUN_0040e8c0 ; 004c2c53
        ;   XREF to: 0040e8c0 (UNCONDITIONAL_CALL)  ; void engine_alphabit.cpp_CAlphaBitmap_render_FUN_0040e8c0(CAlphaBitmap * this_ptr, int dest_x, int dest_y, int left_x, ...)
    ...
    MOV ESI,dword ptr [0x005b7620]      ; 004c2cd3 | g_WindowHeight
    ...
    MOV EAX,[0x005b761c]                ; 004c2cff | g_WindowWidth
        ;   Label: LAB_004c2cff
    ...
    MOV EDI,dword ptr [0x005b7620]      ; 004c2d4d | g_WindowHeight
    ...
    MOV ESI,dword ptr [0x005b761c]      ; 004c2e63 | g_WindowWidth
    MOV EDX,dword ptr [EAX + 0x330]     ; 004c2e69
    MOV EDI,dword ptr [0x005b7620]      ; 004c2e6f | g_WindowHeight
    PUSH EDX                            ; 004c2e75
    ...
    MOV EDX,dword ptr [0x005b7620]      ; 004c2fc8 | g_WindowHeight
    ...
    PUSH EDX                            ; 004c2fe0
    MOV EDX,dword ptr [0x005b761c]      ; 004c2fe1 | g_WindowWidth
