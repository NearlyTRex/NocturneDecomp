...
section .text
    ...
    MOV EDX,dword ptr [0x007641f4]      ; 004c15aa | DAT_007641f4
    PUSH EDX                            ; 004c15b0
    PUSH EBX                            ; 004c15b1
    CALL FUN_0040d890                   ; 004c15b2
    ...
    PUSH EAX                            ; 004c1769
    CALL FUN_004b43f0                   ; 004c176a
        ;   XREF to: 004b43f0 (UNCONDITIONAL_CALL)  ; undefined FUN_004b43f0()
    ...
    PUSH 0x5873f2                       ; 004c17e3 | = "CBoxActor"
        ;   Label: LAB_004c17e3
    PUSH EBX                            ; 004c17e8
    CALL FUN_0040d7e0                   ; 004c17e9
        ;   XREF to: 0040d7e0 (UNCONDITIONAL_CALL)  ; undefined FUN_0040d7e0()
    ADD ESP,0x8                         ; 004c17ee
    TEST EAX,EAX                        ; 004c17f1
    JZ 0x004c15f3                       ; 004c17f3
        ;   XREF to: 004c15f3 (CONDITIONAL_JUMP)  ; LAB_004c15f3
    MOV EDX,dword ptr [0x00764838]      ; 004c17f9 | DAT_00764838
    PUSH EDX                            ; 004c17ff
    PUSH EBX                            ; 004c1800
    CALL FUN_0040d890                   ; 004c1801
        ;   XREF to: 0040d890 (UNCONDITIONAL_CALL)  ; undefined FUN_0040d890()
