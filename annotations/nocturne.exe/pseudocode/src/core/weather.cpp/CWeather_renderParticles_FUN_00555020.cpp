...
// Convention: __cdecl
// Signature: void __cdecl core_weather_cpp_CWeather_renderParticles_FUN_00555020(int *param_1)
...

{
  ...
  if (*param_1 == 1) {
    engine_drender_cpp_CDemonRenderer_captureTexture_FUN_00461eb0(DAT_005ae704,&DAT_005c15bc);
    piVar1 = DAT_005ae704;
    ...
    *(uint *)(*piVar1 + 0xac) = 0xf80000;
    ...
    engine_drender_cpp_CDemonRenderer_captureTexture_FUN_00461eb0(DAT_005ae704,&DAT_005c15ec);
  }
  ...
  do {
    ...
    if (iVar2 != 0) {
      engine_drender_cpp_CDemonRenderer_processCameraRelativeVertex_FUN_00460a00
                (DAT_005ae704,pfVar3);
      engine_drender_cpp_CDemonRenderer_applyScaledTransform_FUN_00460aa0(DAT_005ae704,local_b0,0);
      ...
      core_set_cpp_CDemonSet_computeLighting_FUN_0050bb50(0x01E57284,&local_80,0,0,4);
      piVar1 = DAT_005ae704;
      if (*param_1 == 2) {
  ...
  if (*param_1 == 1) {
    engine_drender_cpp_CDemonRenderer_captureTexture_FUN_00461eb0(DAT_005ae704,&DAT_005c15d4);
    piVar1 = DAT_005ae704;
    *(uint *)(*DAT_005ae704 + 0x18) = 0x80000;
    *(uint *)(*piVar1 + 0x1c) = 0x80000;
    *(uint *)(*piVar1 + 0x48) = 0x780000;
