// Name: core_glass.cpp_CGlass_renderOpaque_FUN_004ac440
// Address: 004ac440
// Address Range: [[004ac440, 004ac5f4]]
// Convention: unknown
// Signature: int core_glass_cpp_CGlass_renderOpaque_FUN_004ac440(CDemonActor *param_1)
...

{
  ...
  if ((((*(int *)(param_1[2].create_event + 0x50) == 0) && (param_1->is_transparent == 0)) &&
      (64999 < (int)param_1[1].location.position.y)) &&
