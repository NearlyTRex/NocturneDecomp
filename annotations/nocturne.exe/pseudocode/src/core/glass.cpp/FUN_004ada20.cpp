// Name: core_glass.cpp_FUN_004ada20
// Address: 004ada20
// Address Range: [[004ada20, 004add77]]
// Convention: unknown
// Signature: void core_glass_cpp_FUN_004ada20(int param_1)
...

{
  ...
  if (*(int *)(param_1 + 0x178) == 0) {
    *(uint *)(param_1 + 0x178) = 1;
    ...
    core_glass_cpp_FUN_004accf0(param_1,&local_cc,&local_9c,&local_8c,0);
