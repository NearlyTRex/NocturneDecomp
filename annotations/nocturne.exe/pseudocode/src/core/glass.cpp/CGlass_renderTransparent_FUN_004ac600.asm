...
section .text
    ...
    PUSH EBX                            ; 004ac600
        ;   Label: core_glass.cpp_CGlass_renderTransparent_FUN_004ac600
    PUSH ESI                            ; 004ac601
    PUSH EBP                            ; 004ac602
    ...
    CALL engine_drender.cpp_CDemonRenderer_isShadowPass_FUN_00461090 ; 004ac636
    ...
    PUSH ESI                            ; 004ac6e7
    MOV EAX,[0x005be368]                ; 004ac6e8 | g_CDemonSet_PTR_005be368
    PUSH EAX                            ; 004ac6ed | g_CDemonSet_01e57284
    ...
    PUSH ESI                            ; 004ac738
    MOV EAX,[0x005be368]                ; 004ac739 | g_CDemonSet_PTR_005be368
    PUSH EAX                            ; 004ac73e | g_CDemonSet_01e57284
