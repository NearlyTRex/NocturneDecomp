...
// Convention: unknown
// Signature: undefined4 core_crossbow_cpp_FUN_0043d1c0(int param_1)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint core_crossbow_cpp_FUN_0043d1c0(int param_1)
  ...
  do {
    ...
    if (iVar2 == 0) {
      if (iStack_18 == 0) {
        ...
        iVar2 = core_trigger_cpp_FUN_005485a0(iVar3,param_1);
        if (iVar2 != 0) {
        ...
        iVar2 = core_glass_cpp_FUN_004aded0(iStack_18);
        if (iVar2 == 0) break;
        core_glass_cpp_FUN_004ada20(iStack_18,0x01E57284 + 0x14cd50);
      }
    }
    else {
