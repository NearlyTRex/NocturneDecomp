...
;   core_flame.cpp_CFlame_hide_FUN_0048df10
...
section .text
    ...
    LEA EAX,[EBX + 0x574]               ; 0043d079
        ;   Label: LAB_0043d079
    PUSH EAX                            ; 0043d07f
    CALL core_flame.cpp_CFlame_hide_FUN_0048df10 ; 0043d080
        ;   XREF to: 0048df10 (UNCONDITIONAL_CALL)  ; void core_flame.cpp_CFlame_hide_FUN_0048df10(CFlame * this_ptr)
