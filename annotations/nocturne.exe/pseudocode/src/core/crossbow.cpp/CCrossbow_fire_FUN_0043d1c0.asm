...
section .text
    ...
    MOV EBX,dword ptr [0x01cae0e8]      ; 0043d452 | g_LocalHeroIndex
    ...
    MOV ECX,dword ptr [0x005b9284]      ; 0043d466 | g_CForceFeedback_PTR_005b9284
    PUSH ECX                            ; 0043d46c
    CALL engine_force.cpp_CForceFeedback_processEvent_FUN_004940d0 ; 0043d46d
