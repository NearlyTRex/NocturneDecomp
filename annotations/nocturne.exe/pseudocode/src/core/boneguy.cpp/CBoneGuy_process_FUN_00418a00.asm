...
section .text
    ...
    PUSH EBX                            ; 00418a00
        ;   Label: core_boneguy.cpp_CBoneGuy_process_FUN_00418a00
    PUSH ESI                            ; 00418a01
    PUSH EDI                            ; 00418a02
    PUSH EBP                            ; 00418a03
    ...
    CALL core_boneguy.cpp_CBoneGuy_beginRecombine_FUN_0041a310 ; 00418ac4
        ;   XREF to: 0041a310 (UNCONDITIONAL_CALL)  ; void core_boneguy.cpp_CBoneGuy_beginRecombine_FUN_0041a310(CBoneGuy * this_ptr)
    ...
    FDIV float ptr [0x0059a8a8]         ; 00418adf | FLOAT_0059a8a8
    ...
    FMUL double ptr [0x00579366]        ; 00418be4 | DOUBLE_00579366
    ...
    FLD ST0                             ; 00418d20
    FMUL double ptr [0x00579336]        ; 00418d22 | DOUBLE_00579336
    MOV dword ptr [EBX + 0x2434],0x42c80000 ; 00418d28
    FSTP ST1                            ; 00418d32
    FST float ptr [EBX + 0xbd9c]        ; 00418d34
    FCOMP double ptr [0x0057933e]       ; 00418d3a | DOUBLE_0057933e
    FNSTSW AX                           ; 00418d40
    SAHF                                ; 00418d42
    ...
    FMUL double ptr [0x00579346]        ; 00418ddb | DOUBLE_00579346
    FMULP                               ; 00418de1
    FMUL double ptr [0x0057934e]        ; 00418de3 | DOUBLE_0057934e
    ...
    FLD float ptr [EBP + 0x92]          ; 00418eca
        ;   Label: LAB_00418eca
    FLD ST0                             ; 00418ed0
    FMUL double ptr [0x0057935e]        ; 00418ed2 | DOUBLE_0057935e
    ...
    FLD float ptr [0x00579356]          ; 00419146 | DOUBLE_00579356
    FXCH                                ; 0041914c
    FMUL ST1                            ; 0041914e
    ...
    CALL core_enemy.cpp_CEnemy_testAttackLine_FUN_00479990 ; 00419273
        ;   XREF to: 00479990 (UNCONDITIONAL_CALL)  ; int core_enemy.cpp_CEnemy_testAttackLine_FUN_00479990(CEnemy * this_ptr, CVector3f * start, CVector3f * end, SDamageInfo * damage_info)
    ...
    FADD double ptr [0x00579336]        ; 00419406 | DOUBLE_00579336
    FCOMPP                              ; 0041940c
    FNSTSW AX                           ; 0041940e
    SAHF                                ; 00419410
