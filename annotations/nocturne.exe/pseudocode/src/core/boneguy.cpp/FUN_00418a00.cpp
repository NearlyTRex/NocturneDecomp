...
// Convention: unknown
// Signature: void core_boneguy_cpp_FUN_00418a00(int param_1,float param_2)
...

{
  ...
  if (*(int *)(param_1 + 0xc344) == 2) {
    fVar2 = param_2 / 2.0f + *(float *)(param_1 + 0xc348);
    *(float *)(param_1 + 0xc348) = fVar2;
    if (fVar2 < 1.0) {
      local_1c = 0;
    ...
    if (0 < *(int *)(param_1 + 0xbda0)) {
      do {
        core_mission_cpp_FUN_004d9110(0x01CC9450,*(uint *)(iVar4 + 0xbde8),1);
        *(uint *)(iVar4 + 0xbde8) = 0;
        iVar7 = iVar7 + 1;
        iVar4 = iVar4 + 0x48;
  ...
  if (iVar6 == 0) {
    ...
    case 1:
      ...
      if (*(int *)(param_1 + 0xbca4) == 0) {
        ...
        iVar4 = core_boneguy_cpp_FUN_004196b0(param_1,param_2);
        if (iVar4 == 0) {
          local_30 = 2.0f;
