...
;
; Referenced Globals:
;   double DOUBLE_0057936e = 5.22209901682860E-315
;   double DOUBLE_00579376 = 0.400000000000000
...
section .text
    ...
    PUSH EBX                            ; 004194b0
        ;   Label: core_boneguy.cpp_CBoneGuy_getCarryObjToBodyXForm_FUN_004194b0
    PUSH EDI                            ; 004194b1
    PUSH EBP                            ; 004194b2
    ...
    PUSH EAX                            ; 00419527
    CALL core_actor.cpp_CVector3f_ctor_FUN_0040e160 ; 00419528
    ...
    CALL core_actor.cpp_CVector3f_ctor_FUN_0040e160 ; 00419559
        ;   XREF to: 0040e160 (UNCONDITIONAL_CALL)  ; CVector3f * core_actor.cpp_CVector3f_ctor_FUN_0040e160(CVector3f * this_ptr)
    FLD float ptr [0x0057936e]          ; 0041955e | DOUBLE_0057936e
    ...
    FADD double ptr [0x00579376]        ; 0041957a | DOUBLE_00579376
    FXCH                                ; 00419580
