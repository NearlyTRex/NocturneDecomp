...
section .text
    ...
    PUSH EBX                            ; 00494e80
        ;   Label: core_frankgen.cpp_CFrankenstienMachine_renderOpaque_FUN_00494e80
    PUSH ESI                            ; 00494e81
    PUSH EDI                            ; 00494e82
    PUSH EBP                            ; 00494e83
    ...
    CALL core_frankgen.cpp_CFrankenstienMachine_updateAnchorPosition_FUN_004950a0 ; 00494eac
