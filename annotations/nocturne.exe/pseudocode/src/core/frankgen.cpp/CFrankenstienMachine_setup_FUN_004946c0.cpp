...
// Convention: __cdecl
// Signature: void __cdecl core_frankgen_cpp_CFrankenstienMachine_setup_FUN_004946c0(CFrankenstienMachine *this_ptr)
...

{
  ...
  case 0:
    ...
    core_dmodel_cpp_CKeyFramedModelInstance_preCache_FUN_00454510(&this_ptr->body_model);
    break;
  case 1:
    core_dmodel_cpp_CKeyFramedModelInstance_setModelName_FUN_00454580
