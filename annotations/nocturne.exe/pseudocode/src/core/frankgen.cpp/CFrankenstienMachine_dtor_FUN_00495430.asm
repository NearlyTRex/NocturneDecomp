...
section .text
    ...
    PUSH EBX                            ; 00495430
        ;   Label: core_frankgen.cpp_CFrankenstienMachine_dtor_FUN_00495430
    ...
    PUSH EBX                            ; 00495444
    CALL core_course.cpp_CCourse_dtor_FUN_0043b5f0 ; 00495445
    ...
    PUSH EAX                            ; 00495488
        ;   Label: LAB_00495488
    CALL crt_memory.c_operator_delete_FUN_00564494 ; 00495489
