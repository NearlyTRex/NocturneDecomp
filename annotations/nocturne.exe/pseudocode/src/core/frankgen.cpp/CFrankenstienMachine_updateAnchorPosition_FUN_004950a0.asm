...
;   core_frankgen.cpp_CFrankenstienMachine_renderOpaque_FUN_00494e80 at 00494eac
...
section .text
    ...
    PUSH EBX                            ; 004950a0
        ;   Label: core_frankgen.cpp_CFrankenstienMachine_updateAnchorPosition_FUN_004950a0
    PUSH ESI                            ; 004950a1
    PUSH EDI                            ; 004950a2
    PUSH EBP                            ; 004950a3
