...
// Convention: __cdecl
// Signature: void __cdecl core_pendulum_cpp_CPendulum_process_FUN_004f3a20(CPendulum *this_ptr,float delta_time)
...

{
  ...
  core_pendulum_cpp_CPendulum_updateSwing_FUN_004f3430(this_ptr,delta_time);
  fVar6 = (float10)1;
