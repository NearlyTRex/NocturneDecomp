...
// Convention: __cdecl
// Signature: CPendulum * __cdecl core_pendulum_cpp_CPendulum_ctor_FUN_004f2c30(CPendulum *this_ptr)
...

{
  ...
  this_ptr_00[-1].model_ptr =
       (CKeyFramedModel *)&PTR_core_pendulum_cpp_CPendulum_setup_FUN_004f2d40_005a1244;
  core_dmodel_cpp_CKeyFramedModelInstance_setModelName_FUN_00454580(this_ptr_00,"pend.kfm")
  ;
  pcVar3 = "true";
  ...
  return (CPendulum *)(this_ptr_00[-1].part_visibility_flags + 0xb);
}
