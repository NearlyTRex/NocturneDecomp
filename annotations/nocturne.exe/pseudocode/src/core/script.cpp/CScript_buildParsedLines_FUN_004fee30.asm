...
;
; XREF[1]:
;   core_script.cpp_CScript_FUN_004febd0 at 004fed01
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004fee30
        ;   Label: core_script.cpp_CScript_buildParsedLines_FUN_004fee30
    PUSH ESI                            ; 004fee31
    PUSH EDI                            ; 004fee32
    PUSH EBP                            ; 004fee33
    ...
    MOV dword ptr [0x01cc4800],0x58e2f7 ; 004feea9 | g_CurrentFilename | = "..\\core\\script.cpp"
    LEA EAX,[EBP + 0x1]                 ; 004feeb3
    PUSH EAX                            ; 004feeb6
    MOV EDX,0x398                       ; 004feeb7
    PUSH 0x58e30a                       ; 004feebc | = "Out of memory loading script at line %d"
    MOV dword ptr [0x01cc4804],EDX      ; 004feec1 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004feec7
    ...
    MOV dword ptr [0x01cc4800],EDI      ; 004fef15 | g_CurrentFilename
    MOV [0x01cc4804],EAX                ; 004fef1b | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004fef20
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
