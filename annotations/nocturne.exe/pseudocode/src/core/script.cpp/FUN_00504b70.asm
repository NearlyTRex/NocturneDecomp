...
section .text
    ...
    MOV dword ptr [0x01cc4800],EDX      ; 00504bc7 | DAT_01cc4800
    MOV dword ptr [0x01cc4804],ECX      ; 00504bcd | DAT_01cc4804
    CALL FUN_004c8440                   ; 00504bd3
