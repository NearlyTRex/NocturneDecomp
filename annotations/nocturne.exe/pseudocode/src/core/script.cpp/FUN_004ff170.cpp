...
// Convention: unknown
// Signature: void FUN_004ff170(int param_1)
...

{
  ...
  if ((0 < *(int *)(param_1 + 0x28)) && (*(int *)(param_1 + 0x2c) != 0)) {
    iVar2 = FUN_00504c10(param_1,"initSection");
    if (-1 < iVar2) {
      iVar3 = FUN_00504c10(param_1,"initSectionEnd");
      if (iVar3 < 0) {
      ...
      *(int *)(param_1 + 0x40) = iVar2;
      ...
      while( true ) {
        ...
        local_14 = 0x3e800000;
        iVar4 = FUN_004ff2c0(param_1,&local_14);
        if (iVar4 < 0) {
          _DAT_01cc4800 = "..\\core\\script.cpp";
          _DAT_01cc4804 = 0x438;
