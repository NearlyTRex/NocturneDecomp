...

{
  ...
  cockpit_drawsurf_cpp_CDrawSurface_initFromParent_FUN_0045b480
            (local_40,param_2,param_3,(param_4 - param_2) + 1,iVar3,0);
  cockpit_drawsurf_cpp_CDrawSurface_setColor_FUN_0045b5f0(0);
  cockpit_drawsurf_cpp_FUN_0045d2b0(local_40);
  ...
  if (*(int *)(param_1 + 0x28) < 1) {
    ...
    if (2 < local_18) {
      do {
        iVar3 = shape_edittool_cpp_CStrList_getItemCount_FUN_00477660(local_14);
        ...
        cockpit_drawsurf_cpp_CDrawSurface_drawTextRightAligned_FUN_0045da30(local_40,uVar4);
