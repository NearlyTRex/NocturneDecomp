...

{
  ...
  _fscanf(param_2,&DAT_0058fcc6,&local_18);
  if (6 < local_18) {
  ...
  _fgets(local_118,0xff,param_2);
  _fscanf(param_2,&DAT_0058fd12,0x01C775EC + 0x228);
  if (1 < local_18) {
    _fgets(local_118,0xff,param_2);
    _fscanf(param_2,&DAT_0058fd16,0x01C775EC + 0x22c);
  }
  if (2 < local_18) {
    _fgets(local_118,0xff,param_2);
    _fscanf(param_2,&DAT_0058fd1a,0x01C775EC + 0x230);
  }
  _fgets(local_118,0xff,param_2);
  _fscanf(param_2,&DAT_0058fd1e,&DAT_01e56c20);
  _fgets(local_118,0xff,param_2);
  _fscanf(param_2,&DAT_0058fd22,param_1 + 0x40);
  _fgets(local_118,0xff,param_2);
  *(byte *)(param_1 + 0x4c) = 0;
  _fscanf(param_2,"\"%[^\"]",param_1 + 0x4c);
  _fscanf(param_2,&DAT_0058fd2d,param_1 + 0x4c);
  _fgets(local_118,0xff,param_2);
  _fscanf(param_2,&DAT_0058fd30,param_1 + 0x44);
  _fgets(local_118,0xff,param_2);
  _fscanf(param_2,&DAT_0058fd34,param_1 + 0x48);
  _fgets(local_118,0xff,param_2);
  ...
  if (4 < local_18) {
    _fgets(local_118,0xff,param_2);
    iVar1 = _fscanf(param_2,&DAT_0058fd38,param_1 + 0x14);
  }
  if (3 < local_18) {
    _fgets(local_118,0xff,param_2);
    iVar3 = 0;
    iVar1 = _fscanf(param_2,&DAT_0058fd3c,param_1 + 0x454);
    if (0 < *(int *)(param_1 + 0x454)) {
      iVar2 = param_1 + 0x458;
      do {
        iVar3 = iVar3 + 1;
        _fscanf(param_2,&DAT_0058fd40,iVar2);
  ...
  if (5 < local_18) {
    _fgets(local_118,0xff,param_2);
    _fscanf(param_2,&DAT_0058fd44,&local_14);
