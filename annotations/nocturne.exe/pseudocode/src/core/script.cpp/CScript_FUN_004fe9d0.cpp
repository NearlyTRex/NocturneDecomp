// Name: core_script.cpp_CScript_FUN_004fe9d0
// Address: 004fe9d0
// Address Range: [[004fe9d0, 004febc6]]
// Convention: __cdecl
// Signature: void __cdecl core_script_cpp_CScript_FUN_004fe9d0(CScript *this_ptr,int left,int top,int right,int bottom)
