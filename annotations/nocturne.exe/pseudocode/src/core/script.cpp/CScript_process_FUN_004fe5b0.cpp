...
// Convention: __cdecl
// Signature: void __cdecl core_script_cpp_CScript_process_FUN_004fe5b0(int *param_1)
...

{
  ...
  if ((0 < param_1[10]) && (param_1[0xb] != 0)) {
    ...
    iVar3 = 0;
    local_18 = (float)core_charactr_cpp_getGameDeltaTime_FUN_0042b5c0(0x01C775EC);
    _DAT_01e56c24 = 0;
    local_14 = local_18;
    do {
...
LAB_004fe623:
    ...
    if (iVar3 != 0) {
      ...
      if (0 < iVar3) {
        sound_sndmain_cpp_killSfx_FUN_00527230(param_1[9]);
        return;
      }
    }
  }
