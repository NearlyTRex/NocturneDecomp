...

{
  ...
  if (*actor_specifier == '@') {
    ...
    _DAT_01e56c2c = 1;
    actor_ptr = (CHero *)core_event_cpp_CEventList_getActorByVarName_FUN_00480b30
  ...
  iVar2 = core_actor_cpp_isOfClassHash_FUN_0040d860((CDemonActor *)actor_ptr,expected_class_hash);
  if (iVar2 == 0) {
