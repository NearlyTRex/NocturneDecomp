...
;   core_script.cpp_CScript_FUN_004febd0 at 004fee0b
;   core_script.cpp_CScript_validateSyntax_FUN_004fef60 at 004fef76
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004feff0
        ;   Label: core_script.cpp_CScript_initRuntime_FUN_004feff0
    PUSH ESI                            ; 004feff1
    PUSH EDI                            ; 004feff2
