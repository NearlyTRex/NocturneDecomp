...

{
  ...
  if ((*(char *)(param_1 + 0x4c) != '\0') && (*(int *)(0x01C775EC + 0x10) != 0)) {
    this_ptr = _DAT_014b98f8;
    if (DAT_005b7620 < 0x1e0) {
      this_ptr = _DAT_014b98fc;
    }
    if ((DAT_005b7620 < 0x180) && (this_ptr = _DAT_014b990c, _DAT_01d16810 != 0)) {
      this_ptr = _DAT_014b9904;
    }
    iVar5 = engine_font_cpp_CBitFont_wrapText_FUN_00492f30
                      (this_ptr,(char *)(param_1 + 0x4c),(char *)0x1e53418,10,0x400,
                       (DAT_005b761c * 9) / 10);
    iVar6 = engine_font_cpp_CBitFont_getCharHeight_FUN_004930e0(this_ptr,0x58);
    ...
    if (0 < iVar5) {
      text = (char *)0x1e53418;
      do {
        iVar7 = engine_font_cpp_CBitFont_getTextWidth_FUN_00492da0(this_ptr,text);
        iVar8 = iVar8 + 1;
