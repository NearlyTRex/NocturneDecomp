...
;
; Called Functions:
;   core_script.cpp_CScript_ctor_FUN_004fe490
...
section .text
    ...
    CALL shape_edittool.cpp_CPickList_ctor_FUN_00474c90 ; 004fde85
    ...
    CALL core_script.cpp_CScript_ctor_FUN_004fe490 ; 004fde9f
        ;   XREF to: 004fe490 (UNCONDITIONAL_CALL)  ; CScript * core_script.cpp_CScript_ctor_FUN_004fe490(CScript * this_ptr)
