...
section .text
    ...
    PUSH EBX                            ; 00504d90
        ;   Label: core_script.cpp_CScript_skipCinematic_FUN_00504d90
    PUSH EBP                            ; 00504d91
    ...
    PUSH ESI                            ; 00504dab
    PUSH EBX                            ; 00504dac
    CALL core_script.cpp_CScript_resetDialogState_FUN_00504d60 ; 00504dad
    ...
    MOV [0x01cc4804],EAX                ; 00504e0f | g_CurrentLineNumber
    MOV EAX,dword ptr [EBX + 0x2c]      ; 00504e14
    MOV dword ptr [0x01cc4800],EBP      ; 00504e17 | g_CurrentFilename
    MOV EDX,dword ptr [EAX + EDI*0x8]   ; 00504e1d
    PUSH EDX                            ; 00504e20
    PUSH 0x58fb59                       ; 00504e21 | = "Infinite loop detected trying to skip..."
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 00504e26
