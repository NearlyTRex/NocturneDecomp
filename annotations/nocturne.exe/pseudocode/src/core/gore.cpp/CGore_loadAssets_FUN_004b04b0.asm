...
section .text
    ...
    PUSH EBX                            ; 004b04b0
        ;   Label: core_gore.cpp_CGore_loadAssets_FUN_004b04b0
    PUSH ESI                            ; 004b04b1
    PUSH EDI                            ; 004b04b2
    PUSH EBP                            ; 004b04b3
    PUSH 0x5b96d4                       ; 004b04b4 | DAT_005b96d4
    MOV EDX,dword ptr [0x005ae704]      ; 004b04b9 | g_CDemonRenderer_PTR_005ae704
    ...
    PUSH EBX                            ; 004b04d0 | DAT_005b96ec | DAT_005b9704
        ;   Label: LAB_004b04d0
    MOV ECX,dword ptr [0x005ae704]      ; 004b04d1 | g_CDemonRenderer_PTR_005ae704
    ...
    PUSH EBX                            ; 004b0502 | DAT_005b974c | DAT_005b9764 | DAT_005b98cc
        ;   Label: LAB_004b0502
    MOV EAX,[0x005ae704]                ; 004b0503 | g_CDemonRenderer_PTR_005ae704
    ...
    PUSH EBX                            ; 004b053f | DAT_005b9d4c | DAT_005b9d64 | DAT_005ba004
        ;   Label: LAB_004b053f
    MOV EDX,dword ptr [0x005ae704]      ; 004b0540 | g_CDemonRenderer_PTR_005ae704
    ...
    MOV ECX,dword ptr [0x005ae704]      ; 004b0567 | g_CDemonRenderer_PTR_005ae704
