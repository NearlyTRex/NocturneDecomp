...
section .text
    ...
    PUSH EBX                            ; 004ae190
        ;   Label: core_gore.cpp_CBloodParticle_render_FUN_004ae190
    PUSH ESI                            ; 004ae191
    PUSH EDI                            ; 004ae192
    PUSH EBP                            ; 004ae193
    ...
    PUSH EDI                            ; 004ae1f5
        ;   Label: LAB_004ae1f5
    MOV EDX,dword ptr [0x005ae704]      ; 004ae1f6 | g_CDemonRenderer_PTR_005ae704
    PUSH EDX                            ; 004ae1fc | DAT_01b4d738
    CALL engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_00460a00 ; 004ae1fd
        ;   XREF to: 00460a00 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_00460a00(CDemonRenderer * this_ptr, CVector3f * world_position)
    ADD ESP,0x8                         ; 004ae202
    PUSH 0x0                            ; 004ae205
    PUSH 0x1c78ca8                      ; 004ae207 | DAT_01c78ca8
    MOV ECX,dword ptr [0x005ae704]      ; 004ae20c | g_CDemonRenderer_PTR_005ae704
    ...
    MOV EDX,dword ptr [0x005ae704]      ; 004ae238 | g_CDemonRenderer_PTR_005ae704
    FLD float ptr [EAX]                 ; 004ae23e
    FMUL float ptr [0x0059e4d4]         ; 004ae240 | FLOAT_0059e4d4
    FISTP dword ptr [EBX]               ; 004ae246
    FLD float ptr [EAX + 0x4]           ; 004ae248
    FMUL float ptr [0x0059e4d4]         ; 004ae24b | FLOAT_0059e4d4
    FISTP dword ptr [EBX + 0x4]         ; 004ae251
    FLD float ptr [EAX + 0x8]           ; 004ae254
    FMUL float ptr [0x0059e4d4]         ; 004ae257 | FLOAT_0059e4d4
    FISTP dword ptr [EBX + 0x8]         ; 004ae25d
    LEA EAX,[ESP + 0x10]                ; 004ae260
    PUSH EAX                            ; 004ae264
    MOV EAX,dword ptr [EDX]             ; 004ae265 | DAT_01b4d738
    PUSH EAX                            ; 004ae267
    CALL engine_special.cpp_transformAndProjectPoint_FUN_0053075c ; 004ae268
    ...
    MOV EDX,dword ptr [0x005ae704]      ; 004ae290 | g_CDemonRenderer_PTR_005ae704
    FLD float ptr [EAX]                 ; 004ae296
    FMUL float ptr [0x0059e4d4]         ; 004ae298 | FLOAT_0059e4d4
    FISTP dword ptr [EBX]               ; 004ae29e
    FLD float ptr [EAX + 0x4]           ; 004ae2a0
    FMUL float ptr [0x0059e4d4]         ; 004ae2a3 | FLOAT_0059e4d4
    FISTP dword ptr [EBX + 0x4]         ; 004ae2a9
    FLD float ptr [EAX + 0x8]           ; 004ae2ac
    FMUL float ptr [0x0059e4d4]         ; 004ae2af | FLOAT_0059e4d4
    ...
    CALL engine_special.cpp_transformAndProjectPoint_FUN_0053075c ; 004ae2cb
        ;   XREF to: 0053075c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_0053075c(SProjectedVertex * output, CVector3i * input)
    ...
    MOV EDX,dword ptr [0x005ae704]      ; 004ae2e9 | g_CDemonRenderer_PTR_005ae704
    FLD float ptr [EAX]                 ; 004ae2ef
    FMUL float ptr [0x0059e4d4]         ; 004ae2f1 | FLOAT_0059e4d4
    FISTP dword ptr [EBX]               ; 004ae2f7
    FLD float ptr [EAX + 0x4]           ; 004ae2f9
    FMUL float ptr [0x0059e4d4]         ; 004ae2fc | FLOAT_0059e4d4
    FISTP dword ptr [EBX + 0x4]         ; 004ae302
    FLD float ptr [EAX + 0x8]           ; 004ae305
    FMUL float ptr [0x0059e4d4]         ; 004ae308 | FLOAT_0059e4d4
    ...
    PUSH EAX                            ; 004ae31b
    CALL engine_special.cpp_transformAndProjectPoint_FUN_0053075c ; 004ae31c
        ;   XREF to: 0053075c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_0053075c(SProjectedVertex * output, CVector3i * input)
    MOV ECX,0xbdcccccd                  ; 004ae321
    LEA EBX,[ESP + 0x78]                ; 004ae326
    LEA EAX,[ESP + 0x54]                ; 004ae32a
    ADD ESP,0x8                         ; 004ae32e
    MOV EDX,dword ptr [0x005ae704]      ; 004ae331 | g_CDemonRenderer_PTR_005ae704
    ...
    FMUL float ptr [0x0059e4d4]         ; 004ae347 | FLOAT_0059e4d4
    FISTP dword ptr [EBX]               ; 004ae34d
    FLD float ptr [EAX + 0x4]           ; 004ae34f
    FMUL float ptr [0x0059e4d4]         ; 004ae352 | FLOAT_0059e4d4
    FISTP dword ptr [EBX + 0x4]         ; 004ae358
    FLD float ptr [EAX + 0x8]           ; 004ae35b
    FMUL float ptr [0x0059e4d4]         ; 004ae35e | FLOAT_0059e4d4
    ...
    PUSH EAX                            ; 004ae373
    CALL engine_special.cpp_transformAndProjectPoint_FUN_0053075c ; 004ae374
        ;   XREF to: 0053075c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_0053075c(SProjectedVertex * output, CVector3i * input)
    ADD ESP,0x8                         ; 004ae379
    PUSH 0x5b96d4                       ; 004ae37c | DAT_005b96d4
    MOV EAX,[0x005ae704]                ; 004ae381 | g_CDemonRenderer_PTR_005ae704
    PUSH EAX                            ; 004ae386 | DAT_01b4d738
    LEA EBX,[ESP + 0x84]                ; 004ae387
    CALL engine_drender.cpp_CDemonRenderer_captureTexture_FUN_00461eb0 ; 004ae38e
    ...
    FMUL float ptr [0x0059e4d4]         ; 004ae3f4 | FLOAT_0059e4d4
    FISTP dword ptr [EBX]               ; 004ae3fa
    FLD float ptr [EAX + 0x4]           ; 004ae3fc
    FMUL float ptr [0x0059e4d4]         ; 004ae3ff | FLOAT_0059e4d4
    FISTP dword ptr [EBX + 0x4]         ; 004ae405
    FLD float ptr [EAX + 0x8]           ; 004ae408
    FMUL float ptr [0x0059e4d4]         ; 004ae40b | FLOAT_0059e4d4
    ...
    PUSH EAX                            ; 004ae423
    MOV EDX,dword ptr [0x005be368]      ; 004ae424 | g_CDemonSet_PTR_005be368
    PUSH EDX                            ; 004ae42a | g_CDemonSet_01e57284
    LEA EBX,[ESP + 0xe8]                ; 004ae42b
    CALL core_set.cpp_CDemonSet_computeLighting_FUN_0050bb50 ; 004ae432
    ...
    PUSH EAX                            ; 004ae4dd
    MOV EAX,[0x005ae704]                ; 004ae4de | g_CDemonRenderer_PTR_005ae704
    PUSH EAX                            ; 004ae4e3 | DAT_01b4d738
    CALL engine_drender.cpp_CDemonRenderer_setRenderAlpha_FUN_00461010 ; 004ae4e4
    ...
    MOV EDX,dword ptr [0x005ae704]      ; 004ae4f1 | g_CDemonRenderer_PTR_005ae704
    PUSH EDX                            ; 004ae4f7 | DAT_01b4d738
    CALL engine_drender.cpp_CDemonRenderer_renderBlendedDirect_FUN_004602a0 ; 004ae4f8
    ...
    MOV ECX,dword ptr [0x005ae704]      ; 004ae500 | g_CDemonRenderer_PTR_005ae704
    PUSH ECX                            ; 004ae506 | DAT_01b4d738
    CALL engine_drender.cpp_CDemonRenderer_matrixPop_FUN_00460bf0 ; 004ae507
    ...
    PUSH EAX                            ; 004ae5c0
    MOV EAX,[0x005ae704]                ; 004ae5c1 | g_CDemonRenderer_PTR_005ae704
    FXCH ST5                            ; 004ae5c6
    FSTP ST6                            ; 004ae5c8
    FXCH ST5                            ; 004ae5ca
    ...
    CALL engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_00460a00 ; 004ae607
        ;   XREF to: 00460a00 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_00460a00(CDemonRenderer * this_ptr, CVector3f * world_position)
    ADD ESP,0x8                         ; 004ae60c
    PUSH 0x0                            ; 004ae60f
    PUSH 0x1c78ca8                      ; 004ae611 | DAT_01c78ca8
    MOV EDX,dword ptr [0x005ae704]      ; 004ae616 | g_CDemonRenderer_PTR_005ae704
    ...
    MOV EDX,dword ptr [0x005ae704]      ; 004ae636 | g_CDemonRenderer_PTR_005ae704
    ...
    MOV EDX,dword ptr [0x005ae704]      ; 004ae6bf | g_CDemonRenderer_PTR_005ae704
    FLD float ptr [EAX]                 ; 004ae6c5
    FMUL float ptr [0x0059e4d4]         ; 004ae6c7 | FLOAT_0059e4d4
    FISTP dword ptr [EBX]               ; 004ae6cd
    FLD float ptr [EAX + 0x4]           ; 004ae6cf
    FMUL float ptr [0x0059e4d4]         ; 004ae6d2 | FLOAT_0059e4d4
    FISTP dword ptr [EBX + 0x4]         ; 004ae6d8
    FLD float ptr [EAX + 0x8]           ; 004ae6db
    FMUL float ptr [0x0059e4d4]         ; 004ae6de | FLOAT_0059e4d4
    ...
    PUSH EAX                            ; 004ae6f1
    CALL engine_special.cpp_transformAndProjectPoint_FUN_0053075c ; 004ae6f2
        ;   XREF to: 0053075c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_0053075c(SProjectedVertex * output, CVector3i * input)
    ...
    MOV EDX,dword ptr [0x005ae704]      ; 004ae71a | g_CDemonRenderer_PTR_005ae704
    FLD float ptr [EAX]                 ; 004ae720
    FMUL float ptr [0x0059e4d4]         ; 004ae722 | FLOAT_0059e4d4
    FISTP dword ptr [EBX]               ; 004ae728
    FLD float ptr [EAX + 0x4]           ; 004ae72a
    FMUL float ptr [0x0059e4d4]         ; 004ae72d | FLOAT_0059e4d4
    FISTP dword ptr [EBX + 0x4]         ; 004ae733
    FLD float ptr [EAX + 0x8]           ; 004ae736
    FMUL float ptr [0x0059e4d4]         ; 004ae739 | FLOAT_0059e4d4
    ...
    PUSH EAX                            ; 004ae74f
    CALL engine_special.cpp_transformAndProjectPoint_FUN_0053075c ; 004ae750
        ;   XREF to: 0053075c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_0053075c(SProjectedVertex * output, CVector3i * input)
    ...
    MOV EDX,dword ptr [0x005ae704]      ; 004ae77c | g_CDemonRenderer_PTR_005ae704
    FLD float ptr [EAX]                 ; 004ae782
    FMUL float ptr [0x0059e4d4]         ; 004ae784 | FLOAT_0059e4d4
    FISTP dword ptr [EBX]               ; 004ae78a
    FLD float ptr [EAX + 0x4]           ; 004ae78c
    FMUL float ptr [0x0059e4d4]         ; 004ae78f | FLOAT_0059e4d4
    FISTP dword ptr [EBX + 0x4]         ; 004ae795
    FLD float ptr [EAX + 0x8]           ; 004ae798
    FMUL float ptr [0x0059e4d4]         ; 004ae79b | FLOAT_0059e4d4
    ...
    PUSH EAX                            ; 004ae7b0
    CALL engine_special.cpp_transformAndProjectPoint_FUN_0053075c ; 004ae7b1
        ;   XREF to: 0053075c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_0053075c(SProjectedVertex * output, CVector3i * input)
    ADD ESP,0x8                         ; 004ae7b6
    LEA EBX,[ESP + 0x7c]                ; 004ae7b9
    LEA EAX,[ESP + 0x1c]                ; 004ae7bd
    FLD float ptr [EAX]                 ; 004ae7c1
    FMUL float ptr [0x0059e4d4]         ; 004ae7c3 | FLOAT_0059e4d4
    FISTP dword ptr [EBX]               ; 004ae7c9
    FLD float ptr [EAX + 0x4]           ; 004ae7cb
    FMUL float ptr [0x0059e4d4]         ; 004ae7ce | FLOAT_0059e4d4
    FISTP dword ptr [EBX + 0x4]         ; 004ae7d4
    FLD float ptr [EAX + 0x8]           ; 004ae7d7
    FMUL float ptr [0x0059e4d4]         ; 004ae7da | FLOAT_0059e4d4
    ...
    PUSH EAX                            ; 004ae7f3
    MOV ECX,dword ptr [0x005be368]      ; 004ae7f4 | g_CDemonSet_PTR_005be368
    PUSH ECX                            ; 004ae7fa | g_CDemonSet_01e57284
    CALL core_set.cpp_CDemonSet_computeLighting_FUN_0050bb50 ; 004ae7fb
        ;   XREF to: 0050bb50 (UNCONDITIONAL_CALL)  ; void core_set.cpp_CDemonSet_computeLighting_FUN_0050bb50(CDemonSet * this_ptr, CVector3i * world_position, CVector3i * surface_normal, int start_vertex_index, ...)
    ...
    PUSH EAX                            ; 004ae87a
    MOV ECX,dword ptr [0x005ae704]      ; 004ae87b | g_CDemonRenderer_PTR_005ae704
    PUSH ECX                            ; 004ae881 | DAT_01b4d738
    CALL engine_drender.cpp_CDemonRenderer_setRenderAlpha_FUN_00461010 ; 004ae882
        ;   XREF to: 00461010 (UNCONDITIONAL_CALL)  ; int engine_drender.cpp_CDemonRenderer_setRenderAlpha_FUN_00461010(CDemonRenderer * this_ptr, int render_alpha)
    ADD ESP,0x8                         ; 004ae887
    PUSH 0x1c78c80                      ; 004ae88a
    MOV EBX,dword ptr [0x005ae704]      ; 004ae88f | g_CDemonRenderer_PTR_005ae704
    PUSH EBX                            ; 004ae895 | DAT_01b4d738
    CALL engine_drender.cpp_CDemonRenderer_renderBlendedDirect_FUN_004602a0 ; 004ae896
        ;   XREF to: 004602a0 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_renderBlendedDirect_FUN_004602a0(CDemonRenderer * this_ptr, SMRGLHeaderPrimitive * prim)
    ADD ESP,0x8                         ; 004ae89b
    MOV EAX,[0x005ae704]                ; 004ae89e | g_CDemonRenderer_PTR_005ae704
    PUSH EAX                            ; 004ae8a3 | DAT_01b4d738
    INC ESI                             ; 004ae8a4
    CALL engine_drender.cpp_CDemonRenderer_matrixPop_FUN_00460bf0 ; 004ae8a5
        ;   XREF to: 00460bf0 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_matrixPop_FUN_00460bf0()
