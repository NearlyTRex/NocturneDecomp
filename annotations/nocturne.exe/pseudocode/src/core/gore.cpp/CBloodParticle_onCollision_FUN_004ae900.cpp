...
// Convention: unknown
// Signature: undefined4 core_gore_cpp_CBloodParticle_onCollision_FUN_004ae900(int param_1,int param_2)

#include "nocturne.h"

uint core_gore_cpp_CBloodParticle_onCollision_FUN_004ae900(int param_1,int param_2)
