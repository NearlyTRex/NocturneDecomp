...
;
; XREF[1]:
;   core_gore.cpp_CGore_renderDecals_FUN_004afe80 at 004aff4e
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004afa20
        ;   Label: core_gore.cpp_CFootstep_render_FUN_004afa20
    PUSH ESI                            ; 004afa21
    PUSH EDI                            ; 004afa22
    PUSH EBP                            ; 004afa23
    ...
    CALL engine_drender.cpp_CDemonRenderer_captureTexture_FUN_00461eb0 ; 004afad7
