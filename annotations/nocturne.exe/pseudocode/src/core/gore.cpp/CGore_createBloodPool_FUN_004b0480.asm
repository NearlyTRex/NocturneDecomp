...
section .text
    ...
    CMP dword ptr [ESP + 0xc],0x2       ; 004b0480
        ;   Label: core_gore.cpp_CGore_createBloodPool_FUN_004b0480
    ...
    CALL core_gore.cpp_CGore_allocateBloodPool_FUN_004b0430 ; 004b048f
        ;   XREF to: 004b0430 (UNCONDITIONAL_CALL)  ; CBloodPool * core_gore.cpp_CGore_allocateBloodPool_FUN_004b0430(CGore * this_ptr)
    ...
    CALL core_gore.cpp_CBloodPool_init_FUN_004af730 ; 004b04a2
        ;   XREF to: 004af730 (UNCONDITIONAL_CALL)  ; void core_gore.cpp_CBloodPool_init_FUN_004af730(CBloodPool * this_ptr, CVector3f * position, int blood_type)
