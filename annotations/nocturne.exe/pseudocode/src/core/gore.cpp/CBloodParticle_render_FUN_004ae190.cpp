...

{
  ...
  iVar5 = *DAT_005ae704;
  local_70 = (int)ROUND(*param_1 * 256.0f);
  local_6c = (int)ROUND(param_1[1] * 256.0f);
  local_68 = (int)ROUND(param_1[2] * 256.0f);
  engine_special_cpp_transformPoint_FUN_00530a25(iVar5,&local_70);
  ...
  local_a8 = -0.1;
  local_a4 = 0;
  local_e8 = (int)ROUND(256.0f * -0.1);
  local_e4 = (int)ROUND(256.0f * -0.1);
  local_e0 = (int)ROUND(256.0f * 0.0);
  engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704,&local_e8);
  local_ac = 0.1;
  local_a8 = -0.1;
  local_a4 = 0;
  local_64 = (int)ROUND(256.0f * 0.1);
  local_60 = (int)ROUND(256.0f * -0.1);
  local_5c = (int)ROUND(256.0f * 0.0);
  engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x30,&local_64);
  local_ac = 0.1;
  local_a8 = 0.1;
  local_a4 = 0;
  local_b8 = (int)ROUND(256.0f * 0.1);
  local_b4 = (int)ROUND(256.0f * 0.1);
  local_b0 = (int)ROUND(256.0f * 0.0);
  engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x60,&local_b8);
  local_a8 = 0.1;
  local_ac = -0.1;
  local_a4 = 0;
  local_88 = (int)ROUND(256.0f * -0.1);
  local_84 = (int)ROUND(256.0f * 0.1);
  local_80 = (int)ROUND(256.0f * 0.0);
  engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x90,&local_88);
  ...
  local_7c = (int)ROUND(*param_1 * 256.0f);
  local_78 = (int)ROUND(param_1[1] * 256.0f);
  local_74 = (int)ROUND(param_1[2] * 256.0f);
...
LAB_004ae466:
  ...
  do {
    ...
    local_cc = (int)ROUND(local_ac * 256.0f);
    local_c8 = (int)ROUND(256.0f * 0.0);
    local_a8 = local_ac;
    local_18 = local_ac;
    engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704,&local_d0,dVar6);
    local_ac = (float)((float10)dVar6 * (float10)0.10000000000000001);
    local_a4 = 0;
    local_a8 = local_18;
    local_94 = (int)ROUND(local_ac * 256.0f);
    local_90 = (int)ROUND(local_18 * 256.0f);
    local_8c = (int)ROUND(256.0f * 0.0);
    local_1c = local_ac;
    engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x30,&local_94);
    local_ac = local_1c;
    local_a8 = local_1c;
    local_a4 = 0;
    local_58 = (int)ROUND(local_1c * 256.0f);
    local_54 = (int)ROUND(local_1c * 256.0f);
    local_50 = (int)ROUND(256.0f * 0.0);
    engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x60,&local_58);
    local_ac = local_18;
    local_a4 = 0;
    local_a8 = local_1c;
    local_c4 = (int)ROUND(local_18 * 256.0f);
    local_c0 = (int)ROUND(local_1c * 256.0f);
    local_bc = (int)ROUND(256.0f * 0.0);
    engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x90,&local_c4);
    local_7c = (int)ROUND(local_dc * 256.0f);
    local_78 = (int)ROUND(local_d8 * 256.0f);
    local_74 = (int)ROUND(local_d4 * 256.0f);
    core_set_cpp_CDemonSet_computeLighting_FUN_0050bb50(0x01E57284,&local_7c,&DAT_01c78cb4,0,4);
    iVar3 = 0;
    do {
