...
section .text
    ...
    PUSH EBX                            ; 004afe80
        ;   Label: core_gore.cpp_CGore_renderDecals_FUN_004afe80
    PUSH ESI                            ; 004afe81
    PUSH EDI                            ; 004afe82
    PUSH EBP                            ; 004afe83
    ...
    CALL core_gore.cpp_CBloodSplat_setupRenderState_FUN_004aeae0 ; 004afeaa
        ;   XREF to: 004aeae0 (UNCONDITIONAL_CALL)  ; void core_gore.cpp_CBloodSplat_setupRenderState_FUN_004aeae0(CBloodSplat * this_ptr)
