...
;
; XREF[3]:
;   core_set.cpp_CDemonSet_renderGogglesView_FUN_0050a260 at 0050a457
;   core_set.cpp_CDemonSet_renderScene_FUN_00509a80 at 00509d6c
...
section .text
    ...
    CALL engine_drender.cpp_CDemonRenderer_isShadowPass_FUN_00461090 ; 004afe20
