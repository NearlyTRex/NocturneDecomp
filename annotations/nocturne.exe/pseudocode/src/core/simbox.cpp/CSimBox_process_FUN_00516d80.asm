...
section .text
    ...
    PUSH EBX                            ; 00516d80
        ;   Label: core_simbox.cpp_CSimBox_process_FUN_00516d80
    PUSH ESI                            ; 00516d81
    ...
    PUSH EAX                            ; 00516e1d
    CALL core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_0044da40 ; 00516e1e
    ...
    PUSH 0x13                           ; 00516e4d
    MOV EAX,[0x005bac64]                ; 00516e4f | g_CKeys_PTR_005bac64
    PUSH EAX                            ; 00516e54 | g_CKeys_01cc30e4
    MOV ESI,dword ptr [EAX]             ; 00516e55 | g_CKeys_01cc30e4
