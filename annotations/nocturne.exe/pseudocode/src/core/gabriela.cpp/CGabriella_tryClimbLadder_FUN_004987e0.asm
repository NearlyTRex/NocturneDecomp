...
section .text
    ...
    MOV EAX,[0x005be368]                ; 00498808 | g_CDemonSet_PTR_005be368
        ;   Label: LAB_00498808
    CMP EDI,dword ptr [EAX + 0x14cd6c]  ; 0049880d | g_CDemonSet_01e57284.actor_count
    ...
    PUSH EDX                            ; 00498841
    MOV EAX,dword ptr [EAX + 0x14cd70]  ; 00498842 | g_CDemonSet_01e57284.actors[0]
    PUSH EAX                            ; 00498848
