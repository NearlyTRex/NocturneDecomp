// Name: core_gabriela.cpp_CGabriella_process_FUN_00495a20
// Address: 00495a20
// Address Range: [[00495a20, 00496d0f]]
// Convention: __cdecl
// Signature: void __cdecl core_gabriela_cpp_CGabriella_process_FUN_00495a20(CGabriella *this_ptr,float delta_time)
...

{
  ...
  iVar10 = core_charactr_cpp_FUN_004259f0((CCharacter *)this_ptr,delta_time);
  if (iVar10 == 0) {
    return;
  }
  if ((this_ptr->base).control_type == HERO_CONTROL_AI) {
    core_gabriela_cpp_CGabriella_processAI_FUN_00496d10(this_ptr,delta_time);
  }
  ...
  pCVar11 = core_gabriela_cpp_CGabriella_getTorsoCenterPosition_FUN_00497870(this_ptr,&local_10c);
  ...
  (this_ptr->base).base.model.accumulated_root_motion.x =
       (this_ptr->base).base.model.accumulated_root_motion.y;
  core_gabriela_cpp_CGabriella_processMotionEvents_FUN_00497410(this_ptr,delta_time);
  ...
  if (iVar10 != 0) {
    ...
    (this_ptr->base).base.walk_step_speed =
         (float)local_14 * _DAT_01c71358 + (this_ptr->base).base.walk_step_speed;
    local_14 = (CCharacter_full_vtable *)
               core_motion_cpp_CMotionController_getStateBlendWeight_FUN_004e18d0
                         (&pCVar2->motion_controller,2);
    (this_ptr->base).base.walk_step_speed =
         (float)local_14 * _DAT_01c7135c + (this_ptr->base).base.walk_step_speed;
    local_14 = (CCharacter_full_vtable *)
               core_motion_cpp_CMotionController_getStateBlendWeight_FUN_004e18d0
                         (&pCVar2->motion_controller,3);
    (this_ptr->base).base.walk_step_speed =
         (this_ptr->base).base.walk_step_speed - (float)local_14 * _DAT_01c71360;
    local_14 = (CCharacter_full_vtable *)
               core_motion_cpp_CMotionController_getStateBlendWeight_FUN_004e18d0
...
LAB_00496679:
              if ((this_ptr->base).base.is_on_ground != 0) {
                ...
                if (((this_ptr->base).player_input.action_state.use_item != 0) &&
                   (iVar10 = core_gabriela_cpp_CGabriella_findAndPickupNearbyObject_FUN_004983f0
                                       (this_ptr), iVar10 == 0)) {
                  core_gabriela_cpp_CGabriella_tryThrowObject_FUN_00498bd0(this_ptr);
                }
              }
            }
          }
    ...
    if ((this_ptr->base).base.base.location.position.y <= pCVar11->y) goto LAB_00495d9d;
...
LAB_00496834:
      ...
      core_charactr_cpp_CCharacter_moveAndCollide_FUN_00425050((CCharacter *)this_ptr,&local_178);
    }
  }
  else {
  ...
  if (pCVar13 != (CDemonActor *)0x0) {
    ...
    if (pCVar13[0x1a].is_transparent != 0) {
      ...
      local_48 = core_gabriela_cpp_CGabriella_getFlashlightMinAngle_FUN_00497810(this_ptr);
...
LAB_00495fcb:
  ...
  core_gabriela_cpp_CGabriella_updateAimTracking_FUN_004990c0(this_ptr,delta_time,is_holstering);
  ...
  if (((fVar3 <= 0.0) && (this_ptr->fire_cooldown_timer = 0.0, is_holstering == 0)) &&
    ...
    if (this_ptr->weapon_state_flags == 0) {
      if ((this_ptr->draw_blend <= 0.0) &&
        ...
        iVar10 = core_hero_cpp_FUN_004b5110(&this_ptr->base);
        switch(iVar10) {
        case 0:
        case 1:
          break;
        ...
        if ((iVar10 == 0) &&
           ...
           iVar10 == 0)) {
          iVar10 = core_hero_cpp_CHero_tryPushNearbyBox_FUN_004b54c0(&this_ptr->base);
          if (iVar10 == 0) {
            iVar10 = core_hero_cpp_CHero_tryPullLever_FUN_004b52f0(&this_ptr->base);
            if (iVar10 == 0) {
              core_gabriela_cpp_CGabriella_tryClimbLadder_FUN_004987e0(this_ptr);
            }
            else {
  ...
  core_gabriela_cpp_FUN_004998c0(this_ptr,delta_time,(uint)(is_holstering == 0));
  ...
  if ((float)local_14 <= 0.0) {
    ...
    {
      core_gabriela_cpp_CGabriella_getTorsoCenterPosition_FUN_00497870(this_ptr,&local_7c);
      core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240
  ...
  core_gabriela_cpp_CGabriella_updateWeaponPosition_FUN_004980d0(this_ptr,delta_time);
...
LAB_004961ba:
    ...
    iVar10 = core_gabriela_cpp_CGabriella_canFireWeapon_FUN_00498af0(this_ptr);
    if (iVar10 == 0) goto LAB_00496cd2;
    this_ptr->fire_state = 1;
  }
  else {
LAB_00496cc5:
    if (this_ptr->fire_state == 2) goto LAB_004961ba;
LAB_00496cd2:
    if (this_ptr->fire_state != 1) goto LAB_0049620e;
  }
  this_ptr->fire_state = 0;
  core_gabriela_cpp_CGabriella_tryFireWeapon_FUN_00498b60(this_ptr);
