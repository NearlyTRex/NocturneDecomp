...
// Convention: unknown
// Signature: float core_gabriela_cpp_FUN_00498de0(int param_1,int param_2,int param_3)
...

{
  ...
  iVar3 = core_actor_cpp_castToClassHash_FUN_0040d890(param_2,g_CEnemyActorType_01bcdebc.name_hash);
