...
// Convention: __cdecl
// Signature: float __cdecl core_gabriela_cpp_FUN_00498de0(CGabriella *this_ptr,CDemonActor *target_actor,int use_wider_fov)
...

{
  ...
  if ((iVar3 != 0) &&
    ...
    if ((fStack_1c <= 1.0) &&
       (target_actor == *(CDemonActor **)(0x01E57284->lights[199].filter_names[0x13] + 0x18))) {
      return fStack_20;
    }
  }
  return -1.0;
