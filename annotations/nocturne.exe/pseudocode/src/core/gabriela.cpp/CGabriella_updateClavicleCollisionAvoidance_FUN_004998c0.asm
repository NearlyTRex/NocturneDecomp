...
;
; XREF[1]:
;   core_gabriela.cpp_CGabriella_process_FUN_00495a20 at 00496069
;
; Referenced Globals:
...
;
; Called Functions:
;   core_gabriela.cpp_CGabriella_binarySearchClavicleBlend_FUN_00499b00
...
section .text
    ...
    PUSH EBX                            ; 004998c0
        ;   Label: core_gabriela.cpp_CGabriella_updateClavicleCollisionAvoidance_FUN_004998c0
    PUSH ESI                            ; 004998c1
    PUSH EDI                            ; 004998c2
    PUSH EBP                            ; 004998c3
    ...
    FXCH ST2                            ; 004998db
    FDIV float ptr [0x0059dcbc]         ; 004998dd | FLOAT_0059dcbc
    FXCH                                ; 004998e3
    ...
    PUSH EBX                            ; 004999f6
    CALL core_gabriela.cpp_CGabriella_binarySearchClavicleBlend_FUN_00499b00 ; 004999f7
        ;   XREF to: 00499b00 (UNCONDITIONAL_CALL)  ; void core_gabriela.cpp_CGabriella_binarySearchClavicleBlend_FUN_00499b00(CGabriella * this_ptr, float delta_time, float * clavicle_blend, int probe_bone_index, ...)
    ...
    PUSH EBX                            ; 00499a65
    CALL core_gabriela.cpp_CGabriella_binarySearchClavicleBlend_FUN_00499b00 ; 00499a66
        ;   XREF to: 00499b00 (UNCONDITIONAL_CALL)  ; void core_gabriela.cpp_CGabriella_binarySearchClavicleBlend_FUN_00499b00(CGabriella * this_ptr, float delta_time, float * clavicle_blend, int probe_bone_index, ...)
