...
;
; Referenced Globals:
;   double DOUBLE_00582202 = 30
;   double DOUBLE_0058220a = -0.781490709825871
;   double DOUBLE_00582212 = 1.56298141965174
;   double DOUBLE_0058221a = 35
;   double DOUBLE_00582222 = -0.785398163375000
;   double DOUBLE_0058222a = 1.57079632675000
;   float FLOAT_00582232 = 0.5
...
section .text
    ...
    PUSH EBX                            ; 00498de0
        ;   Label: core_gabriela.cpp_CGabriella_scoreTargetVisibility_FUN_00498de0
    PUSH ESI                            ; 00498de1
    PUSH EDI                            ; 00498de2
    PUSH EBP                            ; 00498de3
    ...
    MOV EDX,dword ptr [0x01bcdef4]      ; 00498df5 | g_CEnemyActorType_01bcdebc.name_hash
    PUSH EDX                            ; 00498dfb
    PUSH ESI                            ; 00498dfc
    CALL core_actor.cpp_castToClassHash_FUN_0040d890 ; 00498dfd
        ;   XREF to: 0040d890 (UNCONDITIONAL_CALL)  ; CDemonActor * core_actor.cpp_castToClassHash_FUN_0040d890(CDemonActor * actor_ptr, uint class_name_hash)
    ADD ESP,0x8                         ; 00498e02
    PUSH 0x5993b0                       ; 00498e05 | g_CVectorTypeInfo_005993b0
    PUSH 0xa                            ; 00498e0a
    ...
    FCOMP double ptr [0x0058221a]       ; 00498ee1 | DOUBLE_0058221a
    FNSTSW AX                           ; 00498ee7
    SAHF                                ; 00498ee9
    ...
    FCOMP double ptr [0x00582222]       ; 00498ef8 | DOUBLE_00582222
    FNSTSW AX                           ; 00498efe
    SAHF                                ; 00498f00
    JC 0x00498e49                       ; 00498f01
        ;   XREF to: 00498e49 (CONDITIONAL_JUMP)  ; LAB_00498e49
    FLD double ptr [ESP + 0x8]          ; 00498f07
    FCOMP double ptr [0x0058222a]       ; 00498f0b | DOUBLE_0058222a
    FNSTSW AX                           ; 00498f11
    SAHF                                ; 00498f13
    ...
    FLD float ptr [ESP + 0x14]          ; 00498f1b
        ;   Label: LAB_00498f1b
    FCOMP double ptr [0x00582202]       ; 00498f1f | DOUBLE_00582202
    FNSTSW AX                           ; 00498f25
    SAHF                                ; 00498f27
    ...
    FCOMP double ptr [0x0058220a]       ; 00498f35 | DOUBLE_0058220a
    FNSTSW AX                           ; 00498f3b
    SAHF                                ; 00498f3d
    JC 0x00498e49                       ; 00498f3e
        ;   XREF to: 00498e49 (CONDITIONAL_JUMP)  ; LAB_00498e49
    FLD double ptr [ESP]                ; 00498f44
    FCOMP double ptr [0x00582212]       ; 00498f47 | DOUBLE_00582212
    FNSTSW AX                           ; 00498f4d
    SAHF                                ; 00498f4f
    ...
    FXCH                                ; 00498f7f
    FLD float ptr [0x00582232]          ; 00498f81 | FLOAT_00582232
    FXCH                                ; 00498f87
    FMUL ST1                            ; 00498f89
    FXCH ST2                            ; 00498f8b
    ...
    PUSH 0x1                            ; 0049900d
    MOV EAX,[0x005be368]                ; 0049900f | g_CDemonSet_PTR_005be368
    PUSH EAX                            ; 00499014 | g_CDemonSet_01e57284
    ...
    PUSH EDI                            ; 0049901d
    MOV EDX,dword ptr [0x005be368]      ; 0049901e | g_CDemonSet_PTR_005be368
    PUSH EDX                            ; 00499024 | g_CDemonSet_01e57284
    ...
    PUSH EAX                            ; 0049903c
    MOV ECX,dword ptr [0x005be368]      ; 0049903d | g_CDemonSet_PTR_005be368
    PUSH ECX                            ; 00499043 | g_CDemonSet_01e57284
    ...
    MOV EBX,dword ptr [0x005be368]      ; 0049905a | g_CDemonSet_PTR_005be368
    PUSH EBX                            ; 00499060 | g_CDemonSet_01e57284
    ...
    JC 0x00498e49                       ; 0049907e
        ;   XREF to: 00498e49 (CONDITIONAL_JUMP)  ; LAB_00498e49
    MOV EAX,[0x005be368]                ; 00499084 | g_CDemonSet_PTR_005be368
    CMP ESI,dword ptr [EAX + 0x14cd5c]  ; 00499089 | g_CDemonSet_01e57284.collision_actor
