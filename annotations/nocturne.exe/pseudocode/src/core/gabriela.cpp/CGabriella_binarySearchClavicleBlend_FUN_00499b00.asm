...
;
; XREF[1]:
;   core_gabriela.cpp_CGabriella_updateClavicleCollisionAvoidance_FUN_004998c0 at 004999f7
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00499b00
        ;   Label: core_gabriela.cpp_CGabriella_binarySearchClavicleBlend_FUN_00499b00
    PUSH ESI                            ; 00499b01
    PUSH EDI                            ; 00499b02
    PUSH EBP                            ; 00499b03
