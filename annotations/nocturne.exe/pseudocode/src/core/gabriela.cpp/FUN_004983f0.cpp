...
// Convention: unknown
// Signature: undefined4 FUN_004983f0(int param_1)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_004983f0(int param_1)

{
  ...
  *(uint *)(param_1 + 0x1fa08) = 0;
  FUN_005644a7(local_bc,4,&DAT_005993b0);
  local_5c = 0xbda3d70a;
  local_58 = 0x3ee147ae;
  local_54 = 0x3ff5c28f;
  pfVar3 = (float *)FUN_0040a240(param_1,local_74,&local_5c);
  ...
  local_50 = 0xbf266666;
  local_48 = 0x4007ae14;
  puVar4 = (uint *)FUN_0040a240(param_1,local_38,&local_50);
  if (&local_a4 != puVar4) {
    local_a4 = *puVar4;
    local_a0 = puVar4[1];
    local_9c = puVar4[2];
  ...
  local_88 = 0;
  local_84 = 0x40000000;
  puVar4 = (uint *)FUN_0040a240(param_1,local_80,&local_8c);
  if (&local_98 != puVar4) {
    local_98 = *puVar4;
    local_94 = puVar4[1];
    local_90 = puVar4[2];
    ...
    if (iVar5 == 0) {
      ...
      if (uStack_20 < 2) {
        if ((uStack_20 == 1) && (*(int *)(param_1 + 0x24ac) == 0)) {
          FUN_0040a290(iVar1,&fStack_68,local_2c);
