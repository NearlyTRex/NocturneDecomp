...
// Convention: unknown
// Signature: void core_gabriela_cpp_FUN_004998c0(int param_1,float param_2,int param_3)
  ...
  *(float *)(param_1 + 0x1fa5c) = *(float *)(param_1 + 0x1fa5c) - fVar2;
  ...
  if (param_3 != 0) {
    ...
    core_gabriela_cpp_FUN_00499b00
              (param_1,param_2,param_1 + 0x1fa58,_DAT_01c713d8,_DAT_01c7139c,local_2c);
    ...
    core_gabriela_cpp_FUN_00499b00
              (param_1,param_2,param_1 + 0x1fa5c,_DAT_01c713dc,_DAT_01c713a0,local_2c);
    core_setcolid_cpp_CDemonSet_init_FUN_00511750(0x01E57284);
    return;
  }
  core_skeleton_cpp_CDeformableModelInstance_blendMotion_FUN_0051c3d0
            (param_1 + 0x150,0,0,*(uint *)(param_1 + 0x1fa58),_DAT_01c7139c,
             core_skeleton_cpp_FUN_0051b650);
  core_skeleton_cpp_CDeformableModelInstance_blendMotion_FUN_0051c3d0
            (param_1 + 0x150,0,0,*(uint *)(param_1 + 0x1fa5c),_DAT_01c713a0,
             core_skeleton_cpp_FUN_0051b650);
  return;
}
