...
;
; Called Functions:
;   core_gabriela.cpp_CGabriella_FUN_00499b00
...
section .text
    ...
    PUSH EBX                            ; 004998c0
        ;   Label: core_gabriela.cpp_CGabriella_FUN_004998c0
    PUSH ESI                            ; 004998c1
    PUSH EDI                            ; 004998c2
    PUSH EBP                            ; 004998c3
    ...
    PUSH EBX                            ; 004999f6
    CALL core_gabriela.cpp_CGabriella_FUN_00499b00 ; 004999f7
        ;   XREF to: 00499b00 (UNCONDITIONAL_CALL)  ; void core_gabriela.cpp_CGabriella_FUN_00499b00(CGabriella * this_ptr, float param_2, float * param_3, int param_4, ...)
    ...
    PUSH EBX                            ; 00499a65
    CALL core_gabriela.cpp_CGabriella_FUN_00499b00 ; 00499a66
        ;   XREF to: 00499b00 (UNCONDITIONAL_CALL)  ; void core_gabriela.cpp_CGabriella_FUN_00499b00(CGabriella * this_ptr, float param_2, float * param_3, int param_4, ...)
