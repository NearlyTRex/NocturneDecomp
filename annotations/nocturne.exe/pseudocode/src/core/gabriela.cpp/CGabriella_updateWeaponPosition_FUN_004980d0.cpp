...

{
  ...
  if (this_ptr->draw_blend < 0.64f) {
    ...
    core_xform_cpp_multiplyMatrix3x4_FUN_0055aa00(&local_1fc,pCVar10,&local_dc);
    pCVar10 = &local_dc;
  }
  else {
    pCVar1 = (CCharacter *)(this_ptr->base).inventory.selected_weapon;
    ...
    core_xform_cpp_buildRotationY_FUN_0055c7b0(1.5707964,(CMatrix3x4f *)&stack0xfffffc54);
    ...
    core_xform_cpp_multiplyMatrix3x4_FUN_0055aa00(&local_2bc,pCVar9,&local_37c);
    pCVar9 = &local_37c;
    pCVar7 = &local_25c;
    for (iVar5 = 0xc; iVar5 != 0; iVar5 = iVar5 + -1) {
      pCVar7->m[0].w = pCVar9->m[0].w;
    ...
    core_xform_cpp_multiplyMatrix3x4_FUN_0055aa00(&local_25c,pCVar10,&local_ac);
    pCVar10 = &local_ac;
    pCVar9 = &local_19c;
    for (iVar5 = 0xc; iVar5 != 0; iVar5 = iVar5 + -1) {
    ...
    core_xform_cpp_multiplyMatrix3x4_FUN_0055aa00(&local_19c,(CMatrix3x4f *)matrix_b,&local_7c);
    pCVar3 = local_14;
    pCVar10 = &local_7c;
    pCVar9 = &local_2ec;
    for (iVar5 = 0xc; iVar5 != 0; iVar5 = iVar5 + -1) {
    ...
    core_xform_cpp_multiplyMatrix3x4_FUN_0055aa00(&local_2ec,&local_34c,&local_10c);
    pCVar10 = &local_10c;
  }
  pCVar9 = &local_31c;
  for (iVar5 = 0xc; iVar5 != 0; iVar5 = iVar5 + -1) {
