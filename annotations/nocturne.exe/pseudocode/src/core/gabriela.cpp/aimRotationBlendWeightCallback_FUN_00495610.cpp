...
// Convention: __cdecl
// Signature: float __cdecl core_gabriela_cpp_aimRotationBlendWeightCallback_FUN_00495610(int current_bone_index,int target_bone_index,float blend_weight,int hierarchy_distance,CDeformableModelInstance *model_ptr)
