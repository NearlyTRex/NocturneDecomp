// Name: core_gabriela.cpp_FUN_00497900
// Address: 00497900
// Address Range: [[00497900, 004980c7]]
// Convention: unknown
// Signature: void core_gabriela_cpp_FUN_00497900(int param_1)
...

{
  ...
  core_xform_cpp_FUN_0055d610(&local_78);
  local_1a4 = local_124;
    ...
    if (iVar1 == 0) {
      if ((float)0.001 < local_28) {
        ...
        core_skeleton_cpp_CDeformableModelInstance_blendMotion_FUN_0051c3d0
                  (param_1 + 0x150,_DAT_01c713cc,local_50,local_28,_DAT_01c713a8,
        ...
        if (0.82f <= *(float *)(param_1 + 0x1fa44)) {
          ...
          if ((float)0.001 < local_2c) {
            ...
            core_xform_cpp_FUN_0055d610(&local_6c,&stack0xfffffe5c);
            local_174 = local_184;
            ...
            *(uint *)
            ...
            fVar5 = local_2c;
            pcVar7 = core_gabriela_cpp_FUN_00495610;
            local_104 = local_f4;
      ...
      *puVar2 = *(uint *)(&stack0xfffffe40 + (uint)bVar3 * -8);
      ...
      if ((float)0.001 < local_28) {
        ...
        core_skeleton_cpp_CDeformableModelInstance_blendMotion_FUN_0051c3d0
                  (param_1 + 0x150,_DAT_01c713cc,local_44,local_28,_DAT_01c713a8,
                   core_skeleton_cpp_FUN_0051b650);
        if ((0.82f <= *(float *)(param_1 + 0x1fa44)) &&
            ...
            *(uint *)
             ...
             ((uint)bVar3 * -2 + 1) * 4) =
                 *(uint *)
                  ...
                  ((uint)bVar3 * -2 + 1) * 4);
            core_xform_cpp_FUN_0055d4e0(0xbfc90fdb,puVar4);
            local_b4 = local_1f4;
          ...
          fVar5 = local_40;
          pcVar7 = core_gabriela_cpp_FUN_00495580;
      ...
      if (0.0 < *(float *)(param_1 + 0x1fa74)) {
        fVar5 = (float)0.90000000000000002;
        *(uint *)(param_1 + 0x23a0) = 2;
  ...
  *(uint *)
  ...
  local_4c = (float)core_gabriela_cpp_FUN_00497810(param_1);
  local_14 = local_4c;
  local_14 = (float)core_gabriela_cpp_FUN_00497860(param_1);
  _DAT_01c71394 =
  ...
  core_xform_cpp_FUN_0055d4a0
            (*(uint *)(param_1 + 0x1fa50),*(uint *)(param_1 + 0x1fa4c),_DAT_01c7139c,
             core_gabriela_cpp_FUN_004955c0);
  ...
  *(uint *)
  ...
  ;
  core_xform_cpp_FUN_0055d4e0(0x3fc90fdb,puVar4);
  local_164 = local_134;
