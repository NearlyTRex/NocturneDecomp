...

{
  ...
  if (local_2c != 0) {
    puVar2 = shape_memdbg_cpp_malloc_FUN_00564c18(this_ptr->poly_count);
    this_ptr->env_map_opac_list = puVar2;
    if (puVar2 == (uchar *)0x0) {
      g_CurrentFilename = "..\\core\\dmodel.cpp";
      g_CurrentLineNumber = 376;
      core_main_c_displayErrorAndQuit_FUN_004c8440("Out of memory for envMapOpacList");
    }
    iVar3 = 1;
    do {
      iVar1 = _fgetc(file);
  ...
  if ((file->_flag & 0x20) != 0) {
    ...
    core_main_c_displayErrorAndQuit_FUN_004c8440("Error reading KFM model");
  }
  if (local_48 != 0) {
