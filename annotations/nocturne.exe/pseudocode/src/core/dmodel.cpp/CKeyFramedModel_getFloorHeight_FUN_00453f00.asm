...
section .text
    ...
    MOV dword ptr [0x01cc4800],EBX      ; 00453f3e | g_CurrentFilename
    MOV [0x01cc4804],EAX                ; 00453f44 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 00453f49
