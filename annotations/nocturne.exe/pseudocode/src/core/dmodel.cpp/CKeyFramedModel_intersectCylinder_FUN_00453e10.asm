...
section .text
    ...
    MOV [0x01cc4800],EAX                ; 00453e6f | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EDX      ; 00453e74 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 00453e7a
