...
// Convention: __cdecl
// Signature: void __cdecl core_dmodel_cpp_CKeyFramedModel_calculateFrameBounds_FUN_004537d0(CKeyFramedModel *model_ptr)
    ...
    do {
      ...
      if (1 < model_ptr->vertex_count) {
        do {
          ...
          pCVar1 = pCVar1 + 1;
          iVar2 = iVar2 + 1;
          core_box_cpp_CBoundingBox3D_expand_FUN_0041cc00(this_ptr_00,&local_28.min);
      ...
      core_box_cpp_CBoundingBox3D_expand_FUN_0041cc00((CBoundingBox3D *)this_ptr,&this_ptr_00->max);
