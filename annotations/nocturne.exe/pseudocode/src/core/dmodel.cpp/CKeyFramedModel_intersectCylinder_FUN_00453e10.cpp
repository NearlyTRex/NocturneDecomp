...

{
  ...
  if (this_ptr->collision_triangle_list == (CDemonTriangle *)0x0) {
    ...
    core_main_c_displayErrorAndQuit_FUN_004c8440("Tried to call CKeyFramedModel::intersectCylinderXZ for model %s but this model does not have a collision triangle list!",this_ptr);
  }
