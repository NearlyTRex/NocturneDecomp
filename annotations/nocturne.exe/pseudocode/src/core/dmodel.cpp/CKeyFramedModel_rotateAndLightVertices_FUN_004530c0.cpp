...

{
  ...
  core_set_cpp_CDemonSet_rotateVerticies_FUN_0050c200
            (g_CDemonSet_PTR_005be368,this_ptr->vertex_count,input_vertices);
  if (this_ptr->vertex_normal_list != (CVector3i *)0x0) {
    core_set_cpp_CDemonSet_lightVerticies_FUN_0050c2d0
              (g_CDemonSet_PTR_005be368,this_ptr->vertex_count,this_ptr->poly_count,
               this_ptr->poly_vert_list,input_vertices,4,this_ptr->vertex_normal_list);
    return;
  }
  core_set_cpp_CDemonSet_lightVerticies_FUN_0050c2d0
            (g_CDemonSet_PTR_005be368,this_ptr->vertex_count,this_ptr->poly_count,
             this_ptr->poly_vert_list,input_vertices,4,(CVector3i *)0x0);
  return;
}
