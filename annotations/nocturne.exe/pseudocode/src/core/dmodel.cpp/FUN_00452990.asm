...
section .text
    ...
    CALL FUN_004533e0                   ; 00452a74
        ;   XREF to: 004533e0 (UNCONDITIONAL_CALL)  ; undefined FUN_004533e0()
    MOV EBX,0x1                         ; 00452a79
    ADD ESP,0x18                        ; 00452a7e
    PUSH ESI                            ; 00452a81
        ;   Label: LAB_00452a81
    CALL FUN_00564570                   ; 00452a82
        ;   XREF to: 00564570 (UNCONDITIONAL_CALL)  ; undefined FUN_00564570()
    ...
    MOV EBP,dword ptr [ESP + 0x4c]      ; 00452eed
        ;   Label: LAB_00452eed
    PUSH EBP                            ; 00452ef1
    CALL FUN_00453ff0                   ; 00452ef2
        ;   XREF to: 00453ff0 (UNCONDITIONAL_CALL)  ; undefined FUN_00453ff0()
