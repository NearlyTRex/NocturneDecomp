...
section .text
    ...
    MOV [0x01cc4800],EAX                ; 004527e1 | DAT_01cc4800
    MOV dword ptr [0x01cc4804],EDX      ; 004527e6 | DAT_01cc4804
    CALL FUN_004c8440                   ; 004527ec
    ...
    MOV dword ptr [0x01cc4800],EDX      ; 00452828 | DAT_01cc4800
    MOV dword ptr [0x01cc4804],ECX      ; 0045282e | DAT_01cc4804
    CALL FUN_004c8440                   ; 00452834
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; undefined FUN_004c8440()
