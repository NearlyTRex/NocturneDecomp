...
// Convention: unknown
// Signature: int FUN_00452990(int param_1,int param_2)
...

{
  ...
  FUN_00563350(param_2,&DAT_0057ca34,&local_44);
  if (local_44 < 5) {
  ...
  FUN_004533e0(param_1,local_40,local_3c,local_38,local_34,local_30);
  iVar3 = 1;
  do {
    iVar1 = FUN_00564570(param_2);
    if (iVar1 < 0) break;
  } while ((iVar1 != 10) || (iVar3 = iVar3 + -1, 0 < iVar3));
  FUN_00563350(param_2,&DAT_0057cad0,&local_48);
  if (local_44 < 6) {
    *(uint *)(param_1 + 0x35c) = 0;
    ...
    FUN_00563350(param_2,&DAT_0057cad4,param_1 + 0x35c);
  }
  if (local_44 < 8) {
    *(uint *)(param_1 + 0x360) = 0;
    ...
    FUN_00563350(param_2,&DAT_0057cad8,param_1 + 0x360);
  }
  local_2c = 0;
  if (6 < local_44) {
    iVar3 = 1;
    ...
    FUN_00563350(param_2,&DAT_0057cadc,&local_2c);
  }
  iVar3 = 1;
  do {
    iVar1 = FUN_00564570(param_2);
  ...
  if (0 < *(int *)(param_1 + 0x110)) {
    ...
    do {
      ...
      FUN_00563350(param_2,"%d,%d",*(int *)(param_1 + 0x118) + local_24,local_14 + 4);
      iVar3 = 0;
      if (0 < *(int *)(local_14 + 4)) {
        ...
        iVar2 = local_14 + 0x20;
        do {
          FUN_00563350(param_2,", %d,%d,%d",iVar3 * 0xc + local_18,iVar1,iVar2);
          iVar2 = iVar2 + 0xc;
          iVar3 = iVar3 + 1;
          iVar1 = iVar1 + 0xc;
        } while (iVar3 < *(int *)(local_14 + 4));
      }
      FUN_00563350(param_2,&DAT_0057cafb);
      local_24 = local_24 + 4;
  ...
  if (local_2c != 0) {
    iVar3 = FUN_00564c18(*(uint *)(param_1 + 0x110));
    *(int *)(param_1 + 0x11c) = iVar3;
    ...
    if (0 < *(int *)(param_1 + 0x110)) {
      do {
        FUN_00563350(param_2,&DAT_0057cb31,local_28);
