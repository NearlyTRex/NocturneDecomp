...
;
; XREF[2]:
;   FUN_004527a0 at 0045297a
;   FUN_00452990 at 00452ef2
;
; Referenced Globals:
...
section .text
    ...
    MOV dword ptr [0x01cc4800],ESI      ; 004540bb | DAT_01cc4800
    MOV dword ptr [0x01cc4804],EDI      ; 004540c1 | DAT_01cc4804
    CALL FUN_004c8440                   ; 004540c7
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; undefined FUN_004c8440()
    ADD ESP,0x4                         ; 004540cc
    PUSH 0x2dd1184                      ; 004540cf | DAT_02dd1184
        ;   Label: LAB_004540cf
    PUSH EBX                            ; 004540d4
    CALL FUN_00454100                   ; 004540d5
        ;   XREF to: 00454100 (UNCONDITIONAL_CALL)  ; undefined FUN_00454100()
