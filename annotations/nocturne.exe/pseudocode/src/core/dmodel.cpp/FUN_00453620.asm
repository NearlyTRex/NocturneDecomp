...
section .text
    ...
    MOV dword ptr [0x01cc4800],EBX      ; 0045376e | DAT_01cc4800
    MOV dword ptr [0x01cc4804],ESI      ; 00453774 | DAT_01cc4804
    CALL FUN_004c8440                   ; 0045377a
    ...
    FMULP ST3                           ; 004537a2
    FXCH                                ; 004537a4
    CALL FUN_00563a30                   ; 004537a6
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH                                ; 004537ab
    CALL FUN_00563a30                   ; 004537ad
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH ST2                            ; 004537b2
    CALL FUN_00563a30                   ; 004537b4
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH                                ; 004537b9
