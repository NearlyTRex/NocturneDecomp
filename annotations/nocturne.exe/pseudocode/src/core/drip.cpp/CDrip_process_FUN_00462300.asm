...
section .text
    ...
    PUSH EBX                            ; 00462300
        ;   Label: core_drip.cpp_CDrip_process_FUN_00462300
    PUSH ESI                            ; 00462301
    PUSH EDI                            ; 00462302
    PUSH EBP                            ; 00462303
    ...
    FLD float ptr [ESP + 0xbc]          ; 004623be
        ;   Label: LAB_004623be
    FLD ST0                             ; 004623c5
    FMUL double ptr [0x0057de70]        ; 004623c7 | DOUBLE_0057de70
    ...
    FMUL double ptr [0x0057de78]        ; 004623fb | DOUBLE_0057de78
    ...
    CALL core_set.cpp_CDemonSet_initCameraShake_FUN_0050e660 ; 00462498
    ...
    CALL core_actor.cpp_getRandomFloatFromRange_FUN_0040dda0 ; 004624da
    ...
    CALL core_actor.cpp_getRandomFloatFromRange_FUN_0040dda0 ; 004624fe
        ;   XREF to: 0040dda0 (UNCONDITIONAL_CALL)  ; float core_actor.cpp_getRandomFloatFromRange_FUN_0040dda0(float min_value, float max_value)
    ...
    CALL core_actor.cpp_getRandomFloatFromRange_FUN_0040dda0 ; 0046258c
        ;   XREF to: 0040dda0 (UNCONDITIONAL_CALL)  ; float core_actor.cpp_getRandomFloatFromRange_FUN_0040dda0(float min_value, float max_value)
    ...
    CALL core_actor.cpp_getRandomFloatFromRange_FUN_0040dda0 ; 004625b0
        ;   XREF to: 0040dda0 (UNCONDITIONAL_CALL)  ; float core_actor.cpp_getRandomFloatFromRange_FUN_0040dda0(float min_value, float max_value)
    ...
    FSIN                                ; 004625db
    FXCH ST2                            ; 004625dd
    FMUL float ptr [0x0057de80]         ; 004625df | FLOAT_0057de80
    FXCH                                ; 004625e5
    FMUL float ptr [0x0057de80]         ; 004625e7 | FLOAT_0057de80
    FXCH ST2                            ; 004625ed
    FMUL float ptr [0x0057de80]         ; 004625ef | FLOAT_0057de80
    FXCH ST3                            ; 004625f5
    ...
    CALL core_actor.cpp_getRandomFloatFromRange_FUN_0040dda0 ; 00462660
        ;   XREF to: 0040dda0 (UNCONDITIONAL_CALL)  ; float core_actor.cpp_getRandomFloatFromRange_FUN_0040dda0(float min_value, float max_value)
    ...
    CALL core_actor.cpp_getRandomFloatFromRange_FUN_0040dda0 ; 0046268c
        ;   XREF to: 0040dda0 (UNCONDITIONAL_CALL)  ; float core_actor.cpp_getRandomFloatFromRange_FUN_0040dda0(float min_value, float max_value)
    ...
    CALL core_actor.cpp_getRandomFloatFromRange_FUN_0040dda0 ; 004626d5
        ;   XREF to: 0040dda0 (UNCONDITIONAL_CALL)  ; float core_actor.cpp_getRandomFloatFromRange_FUN_0040dda0(float min_value, float max_value)
