// Name: core_imp.cpp_CImp_dtor_FUN_004bcfd0
// Address: 004bcfd0
// Address Range: [[004bcfd0, 004bd088]]
// Convention: __cdecl
// Signature: CImp * __cdecl core_imp_cpp_CImp_dtor_FUN_004bcfd0(CImp *this_ptr,uint flags)
...

{
  ...
  if ((flags & 4) != 0) {
    ptr = __vec_delete(this_ptr,&g_CImpTypeInfo_0059f6d0);
  ...
  pCVar6 = (CImp *)core_actor_cpp_CDemonActor_dtor_FUN_00409ea0
