// Name: core_imp.cpp_FUN_004bcfd0
// Address: 004bcfd0
// Address Range: [[004bcfd0, 004bd088]]
// Convention: unknown
// Signature: int core_imp_cpp_FUN_004bcfd0(int param_1,byte param_2)

#include "nocturne.h"

int core_imp_cpp_FUN_004bcfd0(int param_1,byte param_2)

{
  ...
  if ((param_2 & 4) != 0) {
    uVar2 = __vec_delete(param_1,&g_CImpTypeInfo_0059f6d0);
