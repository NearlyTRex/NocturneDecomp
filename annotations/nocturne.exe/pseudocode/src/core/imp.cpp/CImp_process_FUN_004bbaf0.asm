...
section .text
    ...
    PUSH EBX                            ; 004bbb0b
    CALL core_charactr.cpp_CCharacter_FUN_004259f0 ; 004bbb0c
    ...
    CALL core_charactr.cpp_CCharacter_FUN_00428c00 ; 004bbe5c
    ...
    PUSH EBX                            ; 004bbfdc
    CALL core_charactr.cpp_CCharacter_FUN_0042a150 ; 004bbfdd
