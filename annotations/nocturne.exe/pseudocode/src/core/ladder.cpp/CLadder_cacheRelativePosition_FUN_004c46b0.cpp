// Name: core_ladder.cpp_CLadder_cacheRelativePosition_FUN_004c46b0
// Address: 004c46b0
// Address Range: [[004c46b0, 004c47b9]]
// Convention: __cdecl
// Signature: void __cdecl core_ladder_cpp_CLadder_cacheRelativePosition_FUN_004c46b0(CLadder *this_ptr)
...

{
  ...
  if (this_ptr->master_actor != (CDemonActor *)0x0) {
    ...
    core_xform_cpp_multiplyMatrix3x4_FUN_0055aa00(&local_e4,&local_b4,&local_54);
    pCVar3 = &local_54;
    pCVar4 = &local_84;
