...
;
; Called Functions:
;   core_ladder.cpp_CLadder_FUN_004c45a0
;
; *****************************************************************************
...
section .text
    ...
    PUSH EDX                            ; 004c4364
    CALL core_ladder.cpp_CLadder_FUN_004c45a0 ; 004c4365
        ;   XREF to: 004c45a0 (UNCONDITIONAL_CALL)  ; void core_ladder.cpp_CLadder_FUN_004c45a0(CLadder * this_ptr)
