...
// Convention: unknown
// Signature: void core_conveyor_cpp_CConveyor_process_FUN_0043b1a0(int param_1,float param_2)
...

{
  ...
  iVar2 = core_event_cpp_CEventList_evaluateCondition_FUN_0047dc30(0x01C03A10,param_1 + 0x738);
  if (iVar2 != 0) {
    *(uint *)(param_1 + 0x800) = 1;
  }
  iVar2 = core_event_cpp_CEventList_evaluateCondition_FUN_0047dc30(0x01C03A10,param_1 + 0x79c);
  if (iVar2 == 0) {
...
LAB_0043b24d:
            ...
            *(uint *)(iVar1 + 0xec) = 0;
            ...
            iVar3 = core_actor_cpp_isOfClass_FUN_0040d7e0(iVar1,local_14);
