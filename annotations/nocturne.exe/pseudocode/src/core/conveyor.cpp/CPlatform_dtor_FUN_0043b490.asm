...
section .text
    ...
    PUSH EBX                            ; 0043b490
        ;   Label: core_conveyor.cpp_CPlatform_dtor_FUN_0043b490
    ...
    PUSH EBX                            ; 0043b4a4
    CALL core_course.cpp_CCourse_dtor_FUN_0043b5f0 ; 0043b4a5
    ...
    PUSH EAX                            ; 0043b4e8
        ;   Label: LAB_0043b4e8
    CALL crt_memory.c_operator_delete_FUN_00564494 ; 0043b4e9
