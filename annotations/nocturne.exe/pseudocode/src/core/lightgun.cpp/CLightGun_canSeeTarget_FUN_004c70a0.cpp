...
// Convention: unknown
// Signature: undefined4 core_lightgun_cpp_CLightGun_canSeeTarget_FUN_004c70a0(undefined4 param_1,int param_2)
...

{
  ...
  do {
    core_setcolid_cpp_CDemonSet_raycast_FUN_0050fb00(0x01E57284,param_1,auStack_28);
    ...
    iVar2 = core_actor_cpp_isOfClass_FUN_0040d7e0(iVar2,"CTrigger || CGlass");
    if (iVar2 == 0) break;
    iVar3 = iVar3 + 1;
