...
;                               FUNCTION
; *****************************************************************************
; undefined4 core_lightgun_cpp_FUN_004c8040(undefined4 param_1,byte param_2)
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004c8040
        ;   Label: core_lightgun.cpp_FUN_004c8040
    ...
    POP EBX                             ; 004c8064
    RET                                 ; 004c8065
    PUSH 0x59fe90                       ; 004c8066 | g_CLightGunTypeInfo_0059fe90
        ;   Label: LAB_004c8066
    PUSH EBX                            ; 004c806b
    ...
    PUSH EAX                            ; 004c8081
        ;   Label: LAB_004c8081
    CALL crt_unknown.c_FUN_00564494     ; 004c8082
