...
// Convention: unknown
// Signature: undefined4 core_lightgun_cpp_FUN_004c71a0(int param_1)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint core_lightgun_cpp_FUN_004c71a0(int param_1)
  ...
  do {
    ...
    *(float *)(param_1 + 0x584) = *(float *)(param_1 + 0x2e0) * (float)pfStack_14;
    ...
    iVar2 = core_actor_cpp_castToClassHash_FUN_0040d890
                      (*(uint *)(0x01E57284 + 0x14cd5c),g_CGlassActorType_01c78c40.name_hash
                      );
    ...
    if (iVar2 == 0) {
      if (iVar4 != 0) {
        ...
        iVar5 = core_trigger_cpp_FUN_005485a0(iVar4,param_1);
        if (iVar5 != 0) {
