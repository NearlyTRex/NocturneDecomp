...
// Convention: __cdecl
// Signature: CWaterActor * __cdecl core_wateract_cpp_CWaterActor_ctor_FUN_00551220(CWaterActor *this_ptr)
...

{
  ...
  *(uint *)((int)pvVar3 + -0x198) = 1;
  *(uint *)((int)pvVar3 + -0x19c) = 0;
  ...
  *(uint *)((int)pvVar3 + -0x10) = *(uint *)((int)pvVar3 + -8);
  return (CWaterActor *)((int)pvVar3 + -0x294);
}
