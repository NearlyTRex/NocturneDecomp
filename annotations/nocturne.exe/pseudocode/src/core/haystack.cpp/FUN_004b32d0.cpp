...
// Convention: unknown
// Signature: void core_haystack_cpp_FUN_004b32d0(int param_1,float param_2)
...
void core_haystack_cpp_FUN_004b32d0(int param_1,float param_2)
      ...
      if (*(int *)(param_1 + 0x2408) != 0) {
        ...
        if (*(int *)(param_1 + 0xbca0) != 0) {
          ...
          if ((*(int *)(param_1 + 0x1fa3c) == 0) && (*(int *)(param_1 + 0xbc90) != 2)) {
            ...
            iVar6 = core_hero_cpp_FUN_004b52f0(param_1);
            if (iVar6 != 0) {
...
LAB_004b34e4:
  ...
  if ((iVar3 == 0) &&
    ...
    core_xform_cpp_FUN_0055d610
              (param_1 + 0x1fa44,*(uint *)(param_1 + 0x1fa50),_DAT_01cae018,
