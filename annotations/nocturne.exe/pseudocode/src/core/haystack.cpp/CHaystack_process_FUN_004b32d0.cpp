...
// Convention: unknown
// Signature: void core_haystack_cpp_CHaystack_process_FUN_004b32d0(CHaystack *param_1,float param_2)
...

{
  ...
  fVar14 = (param_1->base).invincibility_timer - param_2;
  (param_1->base).invincibility_timer = fVar14;
  if (fVar14 < 0.0) {
      ...
      if ((param_1->base).base.is_on_ground != 0) {
        ...
        if ((param_1->base).player_input.action_state.fire != 0) {
          ...
          if ((param_1->guns_drawn == 0) && ((param_1->base).control_type != HERO_CONTROL_AI)) {
            iVar10 = core_hero_cpp_CHero_tryInteract_FUN_004b4e90(&param_1->base);
            bVar3 = false;
...
switchD_004b375e_caseD_4:
  ...
  if (pCVar2 == (CDemonActor *)0x0) {
    ...
    iVar5 = (*(local_18->_uc).attractActorToward)(this_ptr,(CDemonActor *)param_1,pCVar6);
    if (iVar5 == 0) {
...
LAB_004b34e4:
  ...
  if ((EVar7 == DEATH_STATE_ALIVE) &&
    ...
    fVar14 = param_1->head_look_blend_weight;
    iVar5 = _DAT_01cae018;
    ...
    *(uint *)((int)&CStack_7c + (uint)bVar12 * -8 + 4) =
         *(uint *)(&stack0xffffff78 + (uint)bVar12 * -8);
    *puVar11 = *(uint *)(&stack0xffffff7c + (uint)bVar12 * -8 + (uint)bVar12 * -8);
    puVar11[(uint)bVar12 * -2 + 1] =
         *(uint *)
          ((int)(&stack0xffffff7c + (uint)bVar12 * -8 + (uint)bVar12 * -8) +
          ((uint)bVar12 * -2 + 1) * 4);
