...
section .text
    ...
    PUSH EBX                            ; 004b32d0
        ;   Label: core_haystack.cpp_CHaystack_process_FUN_004b32d0
    PUSH ESI                            ; 004b32d1
    PUSH EDI                            ; 004b32d2
    PUSH EBP                            ; 004b32d3
    ...
    MOV EAX,[0x005b9354]                ; 004b3309 | g_CGame_PTR_005b9354
    FSTP float ptr [EBX + 0x2430]       ; 004b330e
    CMP dword ptr [EAX + 0x228],0x0     ; 004b3314 | g_CGame_01c775ec.letterbox_mode
    ...
    PUSH EBX                            ; 004b3378
    CALL core_charactr.cpp_CCharacter_processWalking_FUN_00428c00 ; 004b3379
    ...
    CALL core_xform.cpp_eulerToQuaternion_FUN_0055d610 ; 004b3546
    ...
    PUSH dword ptr [EBP + 0x18]         ; 004b356c
        ;   Label: LAB_004b356c
    PUSH EBX                            ; 004b356f
    CALL core_charactr.cpp_CCharacter_applyGestureLookAt_FUN_0042a150 ; 004b3570
    ...
    MOV EDI,dword ptr [0x005ad350]      ; 004b35a3 | g_CConsole_PTR_005ad350
    PUSH EDI                            ; 004b35a9 | g_CConsole_0077ad0c
    ...
    JNZ 0x004b3666                      ; 004b36e0
        ;   XREF to: 004b3666 (CONDITIONAL_JUMP)  ; LAB_004b3666
    PUSH EBX                            ; 004b36e2
    CALL core_hero.cpp_CHero_tryOpenNearbyDoor_FUN_004b5110 ; 004b36e3
    ...
    JNZ 0x004b3666                      ; 004b370e
        ;   XREF to: 004b3666 (CONDITIONAL_JUMP)  ; LAB_004b3666
    PUSH EBX                            ; 004b3714
    CALL core_hero.cpp_CHero_tryPullLever_FUN_004b52f0 ; 004b3715
    ...
    PUSH EBX                            ; 004b3726
        ;   Label: LAB_004b3726
    CALL core_hero.cpp_CHero_tryOpenDoor_FUN_004b5270 ; 004b3727
