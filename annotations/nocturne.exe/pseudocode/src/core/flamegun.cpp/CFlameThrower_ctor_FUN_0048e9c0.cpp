...
// Convention: __cdecl
// Signature: CFlameThrower * __cdecl core_flamegun_cpp_CFlameThrower_ctor_FUN_0048e9c0(CFlameThrower *this_ptr)
...

{
  ...
  pCVar2 = (CFlameThrower *)core_weapon_cpp_CWeapon_ctor_FUN_00553d90(&this_ptr->base);
