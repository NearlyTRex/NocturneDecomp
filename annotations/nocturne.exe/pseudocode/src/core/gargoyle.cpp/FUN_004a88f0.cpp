// Name: core_gargoyle.cpp_FUN_004a88f0
// Address: 004a88f0
// Address Range: [[004a88f0, 004a89a8]]
// Convention: unknown
// Signature: CDemonActor * core_gargoyle_cpp_FUN_004a88f0(CDemonActor *param_1,byte param_2)
...

{
  ...
  if ((param_2 & 4) != 0) {
    ptr = __vec_delete(param_1,&g_CGargoyleTypeInfo_0059e0a0);
