// Name: core_gargoyle.cpp_CGargoyle_processDismemberment_FUN_004a8330
// Address: 004a8330
// Address Range: [[004a8330, 004a85c8]]
// Convention: __cdecl
// Signature: void __cdecl core_gargoyle_cpp_CGargoyle_processDismemberment_FUN_004a8330(int param_1,int *param_2)
    ...
    if (iVar2 != 0) {
      ...
      if (*param_2 == *(int *)(param_1 + 0xbd24)) {
        core_charactr_cpp_CCharacter_dismemberPartInternal_FUN_00427eb0
                  (param_1,uVar3,*(uint *)(param_1 + 0xbd28),1);
      }
      if (*(int *)(param_1 + 0xbd2c) == *param_2) {
        core_charactr_cpp_CCharacter_dismemberPartInternal_FUN_00427eb0
                  (param_1,uVar3,*(uint *)(param_1 + 0xbd30),1);
      }
      if (*(int *)(param_1 + 0xbd48) == *param_2) {
        piVar1 = param_2 + 3;
        core_charactr_cpp_CCharacter_detachBodyPart_FUN_00427e40
                  (param_1,*(uint *)(param_1 + 0xbd2c),piVar1,1);
        core_charactr_cpp_CCharacter_detachBodyPart_FUN_00427e40
                  (param_1,*(uint *)(param_1 + 0xbd30),piVar1,1);
        core_charactr_cpp_CCharacter_detachBodyPart_FUN_00427e40
                  (param_1,*(uint *)(param_1 + 0xbd24),piVar1,1);
        core_charactr_cpp_CCharacter_detachBodyPart_FUN_00427e40
                  (param_1,*(uint *)(param_1 + 0xbd28),piVar1,1);
        core_charactr_cpp_CCharacter_detachBodyPart_FUN_00427e40
                  (param_1,*(uint *)(param_1 + 0xbd4c),piVar1,1);
      }
