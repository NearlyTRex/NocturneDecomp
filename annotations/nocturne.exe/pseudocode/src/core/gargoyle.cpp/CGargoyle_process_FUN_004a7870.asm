...
section .text
    ...
    PUSH EBX                            ; 004a788b
    CALL core_charactr.cpp_CCharacter_FUN_004259f0 ; 004a788c
    ...
    CALL core_charactr.cpp_CCharacter_FUN_00428c00 ; 004a794a
    ...
    CALL core_charactr.cpp_CCharacter_FUN_0042a150 ; 004a7aa9
