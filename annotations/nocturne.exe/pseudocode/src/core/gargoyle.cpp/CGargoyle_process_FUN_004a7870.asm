...
;   float FLOAT_0059df3c = 3
;   float FLOAT_0059df48 = 10
...
section .text
    ...
    PUSH EBX                            ; 004a788b
    CALL core_charactr.cpp_CCharacter_process_FUN_004259f0 ; 004a788c
    ...
    CALL core_charactr.cpp_CCharacter_processWalking_FUN_00428c00 ; 004a794a
    ...
    CALL core_charactr.cpp_CCharacter_applyGestureLookAt_FUN_0042a150 ; 004a7aa9
    ...
    CALL core_gargoyle.cpp_CGargoyle_shouldMove_FUN_004a7710 ; 004a7c66
        ;   XREF to: 004a7710 (UNCONDITIONAL_CALL)  ; int core_gargoyle.cpp_CGargoyle_shouldMove_FUN_004a7710(CGargoyle * this_ptr)
    ...
    FCOMP float ptr [0x0059df3c]        ; 004a7d60 | FLOAT_0059df3c
    FNSTSW AX                           ; 004a7d66
    SAHF                                ; 004a7d68
    ...
    FCOMP float ptr [0x0059df48]        ; 004a7d8a | FLOAT_0059df48
    FNSTSW AX                           ; 004a7d90
    SAHF                                ; 004a7d92
    ...
    MOV EDX,dword ptr [0x0059df3c]      ; 004a7ff9 | FLOAT_0059df3c
    ...
    FCOMP float ptr [0x0059df48]        ; 004a8091 | FLOAT_0059df48
    FNSTSW AX                           ; 004a8097
    SAHF                                ; 004a8099
