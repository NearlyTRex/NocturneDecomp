...
// Convention: unknown
// Signature: int core_gargoyle_cpp_CGargoyle_getTargetPoints_FUN_004a8730(int param_1,undefined4 *param_2)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

int core_gargoyle_cpp_CGargoyle_getTargetPoints_FUN_004a8730(int param_1,uint *param_2)

{
  ...
  puVar1 = (uint *)
           core_skeleton_cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0051d380
                     (param_1 + 0x150,local_4c,_DAT_01c78b18);
  if (param_2 != puVar1) {
    *param_2 = *puVar1;
    param_2[1] = puVar1[1];
    param_2[2] = puVar1[2];
  ...
  if (*(int *)(param_1 + 0x2290 + *(int *)(param_1 + 0xbd24) * 4) != 0) {
    puVar1 = (uint *)
             core_skeleton_cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0051d380
                       (param_1 + 0x150,local_40,_DAT_01c78b2c);
    if (param_2 + 3 != puVar1) {
      param_2[3] = *puVar1;
      param_2[4] = puVar1[1];
      param_2[5] = puVar1[2];
  ...
  if (*(int *)(param_1 + 0x2290 + *(int *)(param_1 + 0xbd2c) * 4) != 0) {
    puVar1 = (uint *)
             core_skeleton_cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0051d380
                       (param_1 + 0x150,local_34,_DAT_01c78b30);
  ...
  if (*(int *)(param_1 + 0x2290 + *(int *)(param_1 + 0xbd44) * 4) != 0) {
    puVar1 = (uint *)
             core_skeleton_cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0051d380
                       (param_1 + 0x150,local_1c,_DAT_01c78b3c);
    puVar2 = param_2 + iVar3 * 3;
    if (puVar2 != puVar1) {
      *puVar2 = *puVar1;
      puVar2[1] = puVar1[1];
  ...
  puVar1 = (uint *)
           core_skeleton_cpp_CDeformableModelInstance_getBoneCachedWorldPosition_FUN_0051d380
                     (param_1 + 0x150,local_28,_DAT_01c78b44);
