...
;                               FUNCTION
; *****************************************************************************
; undefined4 core_grave_cpp_FUN_004b1010(undefined4 param_1,byte param_2)
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004b1010
        ;   Label: core_grave.cpp_FUN_004b1010
    ...
    POP EBX                             ; 004b1034
    RET                                 ; 004b1035
    PUSH 0x59e6b0                       ; 004b1036 | g_CGraveTypeInfo_0059e6b0
        ;   Label: LAB_004b1036
    PUSH EBX                            ; 004b103b
    ...
    PUSH EAX                            ; 004b1051
        ;   Label: LAB_004b1051
    CALL crt_unknown.c_FUN_00564494     ; 004b1052
