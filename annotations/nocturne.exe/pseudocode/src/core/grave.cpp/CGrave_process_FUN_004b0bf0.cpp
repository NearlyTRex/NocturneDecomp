...
// Convention: unknown
// Signature: void core_grave_cpp_CGrave_process_FUN_004b0bf0(int param_1,float param_2)
...

{
  ...
  if (*(int *)(param_1 + 0x2d4) == 0) {
    if (*(int *)(param_1 + 0x2d8) == 0) {
      iVar3 = core_event_cpp_CEventList_evaluateCondition_FUN_0047dc30(0x01C03A10,param_1 + 0x2e0)
      ;
      if (iVar3 != 0) {
