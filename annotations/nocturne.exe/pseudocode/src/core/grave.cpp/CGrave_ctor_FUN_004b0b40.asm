...
;
; XREF[1]:
;   core_grave.cpp_factoryFuncGrave_FUN_004b0b10 at 004b0b23
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004b0b40
        ;   Label: core_grave.cpp_CGrave_ctor_FUN_004b0b40
    MOV EBX,dword ptr [ESP + 0x8]       ; 004b0b41
    PUSH EBX                            ; 004b0b45
    CALL core_actor.cpp_CDemonActor_ctor_FUN_00409d30 ; 004b0b46
