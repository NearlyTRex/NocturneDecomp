...
// Convention: unknown
// Signature: void core_larva_cpp_FUN_004c4970(int param_1,float param_2)

#include "nocturne.h"

/* WARNING: Removing unreachable block (ram,0x004c518e) */

void core_larva_cpp_FUN_004c4970(int param_1,float param_2)
