...
section .text
    ...
    PUSH EBX                            ; 004c498b
    CALL core_charactr.cpp_CCharacter_FUN_004259f0 ; 004c498c
    ...
    CALL core_charactr.cpp_CCharacter_FUN_00428c00 ; 004c4a21
    ...
    PUSH EBX                            ; 004c4bce
    CALL core_charactr.cpp_CCharacter_FUN_0042a150 ; 004c4bcf
