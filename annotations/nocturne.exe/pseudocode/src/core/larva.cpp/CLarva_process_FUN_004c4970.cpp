...
// Convention: __cdecl
// Signature: void __cdecl core_larva_cpp_CLarva_process_FUN_004c4970(CLarva *this_ptr,float delta_time)
...
LAB_004c4a74:
  ...
  if (iVar6 != 0) {
    ...
    pCVar2->x = fVar3;
    core_charactr_cpp_CCharacter_moveAndCollide_FUN_00425050((CCharacter *)this_ptr,&local_bc);
  }
