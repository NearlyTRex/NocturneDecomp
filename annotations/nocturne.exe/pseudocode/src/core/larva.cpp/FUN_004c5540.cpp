...
// Convention: unknown
// Signature: int core_larva_cpp_FUN_004c5540(int param_1,byte param_2)

#include "nocturne.h"

int core_larva_cpp_FUN_004c5540(int param_1,byte param_2)

{
  ...
  if ((param_2 & 4) != 0) {
    uVar2 = __vec_delete(param_1,&g_CLarvaTypeInfo_0059fbd0);
