...
// Convention: unknown
// Signature: void FUN_004d9180(int *param_1)
    ...
    if (*param_1 == *(int *)(iVar1 + 0x2c)) {
      if (*(int *)(iVar1 + 0x70) == 0) {
        if (*(char *)(iVar1 + 0x78) != '\0') {
          iVar2 = FUN_00564520(iVar1 + 0x78,&DAT_00589d44);
          if ((iVar2 != 0) && (iVar2 = FUN_0047dc30(0x01C03A10,iVar1 + 0x78), iVar2 == 0))
          goto LAB_004d927a;
        }
        iVar2 = FUN_0040dea0(*(uint *)(iVar1 + 0x74));
        if (iVar2 == 0) {
          *(uint *)(iVar1 + 0x70) = 2;
        }
        else {
...
LAB_004d91fc:
          if (1999 < *(int *)(0x01E57284 + 0x14cd6c)) {
            ...
            _DAT_01cc4804 = 0x44e;
            FUN_004c8440("CDemonMission::buildActiveSetActorList - Too many actors in current set!");
          }
          iVar2 = 0x01E57284;
