...
;
; XREF[3]:
;   core_game.cpp_CGame_FUN_004a4170 at 004a4a34
;   core_game.cpp_CGame_FUN_004a4b50 at 004a4ece
...
section .text
    ...
    MOV [0x01cc4800],EAX                ; 004d9477 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EDX      ; 004d947c | g_CurrentLineNumber
    ...
    CALL core_mission.cpp_CDemonMission_FUN_004d8cd0 ; 004d94d4
    ...
    PUSH EBX                            ; 004d94ec
    CALL core_mission.cpp_CDemonMission_FUN_004d7ea0 ; 004d94ed
    ...
    MOV dword ptr [0x01cc4800],ECX      ; 004d9534 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],ESI      ; 004d953a | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004d9540
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
