...
;
; XREF[2]:
;   FUN_004d92a0 at 004d92eb
;   FUN_004d9440 at 004d94ac
;
; Referenced Globals:
...
section .text
    ...
    CALL FUN_0050e6b0                   ; 004d91c6
        ;   XREF to: 0050e6b0 (UNCONDITIONAL_CALL)  ; undefined FUN_0050e6b0()
    ...
    MOV dword ptr [0x01cc4800],ECX      ; 004d921c | DAT_01cc4800
    MOV dword ptr [0x01cc4804],ESI      ; 004d9222 | DAT_01cc4804
    CALL FUN_004c8440                   ; 004d9228
