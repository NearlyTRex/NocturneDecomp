...
// Convention: unknown
// Signature: void FUN_004d7fe0(undefined4 *param_1,undefined4 param_2,int param_3)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_004d7fe0(uint *param_1,uint param_2,int param_3)

{
  ...
  FUN_00563350(param_2,&DAT_005897ad,param_1 + 4);
  do {
    iVar3 = FUN_00564570(param_2);
    if (iVar3 < 0) break;
  } while (iVar3 != 10);
  iVar3 = 0;
  FUN_00563350(param_2,&DAT_005897b1,param_1 + 0x44);
  if (0 < (int)param_1[0x44]) {
    puVar7 = param_1 + 0x45;
    do {
      iVar3 = iVar3 + 1;
      FUN_00563350(param_2,&DAT_005897b5,puVar7);
      puVar7 = puVar7 + 0x40;
  ...
  if (2 < (int)param_1[2]) {
    ...
    FUN_00563350(param_2,&DAT_005897b9,&local_20);
    iVar3 = 0;
    if (0 < local_20) {
      do {
        pcVar8 = "corrupt!";
        ...
        FUN_00563350(param_2,"%s %d\n",local_158,&local_1c);
        iVar6 = FUN_0040d4d0(local_158);
        if (iVar6 != 0) {
  ...
  FUN_00563350(param_2,&DAT_00589841,&local_28);
  local_24 = 0;
  if ((int)param_1[2] < 6) {
    param_1[3] = 0;
  }
    ...
    FUN_00563350(param_2,&DAT_00589845,&local_24);
    param_1[3] = 1;
  }
  do {
    iVar3 = FUN_00564570(param_2);
  ...
  while (local_14 < local_28 + local_24) {
    ...
    FUN_00563350(param_2,"%s \"%[^\"]\"\n",local_90,local_f4);
    pcVar8 = local_f4;
    pcVar5 = (char *)FUN_0040d540(local_90);
    local_18 = pcVar5;
    pcVar10 = pcVar5;
    do {
      cVar1 = *pcVar8;
  ...
  if (param_1[3] != 0) {
    ...
    if (0 < local_28) {
      do {
        ...
        iVar4 = FUN_0040d890(iVar3,_DAT_01cae124);
        if (iVar4 != 0) {
          FUN_004c14d0(iVar4 + 0x1f5a0);
        }
        iVar6 = iVar6 + 1;
        iVar3 = *(int *)(iVar3 + 0x144);
      } while (iVar6 < local_28);
  ...
  *param_1 = 0xffffffff;
  FUN_004afdb0(uVar2);
  if (6 < (int)param_1[2]) {
    FUN_004b0820(0x01C78C7C,param_2);
    return;
  }
  return;
}
