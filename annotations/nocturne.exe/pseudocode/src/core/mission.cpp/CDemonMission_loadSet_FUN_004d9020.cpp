...
// Convention: __cdecl
// Signature: void __cdecl core_mission_cpp_CDemonMission_loadSet_FUN_004d9020(int *param_1,int param_2)
...

{
  ...
  if (param_2 != *param_1) {
    *param_1 = param_2;
    core_set_cpp_CDemonSet_load_FUN_00506f10(0x01E57284,param_1 + param_2 * 0x40 + 0x45);
