...

{
  ...
  while (local_14 < local_28 + local_24) {
    ...
    _fscanf(param_2,"%s \"%[^\"]\"\n",local_90,local_f4);
    pcVar7 = local_f4;
    pcVar4 = (char *)core_actor_cpp_createActorByName_FUN_0040d540(local_90);
    local_18 = pcVar4;
    pcVar9 = pcVar4;
    do {
      cVar1 = *pcVar7;
    ...
    core_mission_cpp_CDemonMission_addActorToList_FUN_004d8c60(param_1,pcVar4);
  ...
  iVar2 = INT_005b96c4;
  *param_1 = 0xffffffff;
  core_gore_cpp_CGore_reset_FUN_004afdb0(iVar2);
  if (6 < (int)param_1[2]) {
    core_gore_cpp_CGore_load_FUN_004b0820(INT_005b96c4,param_2);
    return;
  }
  return;
}
