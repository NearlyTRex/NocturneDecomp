...
;                               FUNCTION
; *****************************************************************************
; void __cdecl core_mission_cpp_CDemonMission_FUN_004d8720(CDemonMission *this_ptr,_FILE *file_handle)
;
; Parameters:
...
;
; XREF[2]:
;   core_game.cpp_CGame_FUN_004a3b90 at 004a3ca4
;   core_mission.cpp_CDemonMission_save_FUN_004d7f80 at 004d7fa5
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004d8720
        ;   Label: core_mission.cpp_CDemonMission_FUN_004d8720
    PUSH ESI                            ; 004d8721
    PUSH EDI                            ; 004d8722
    PUSH EBP                            ; 004d8723
    ...
    CALL core_mission.cpp_CDemonMission_countActors_FUN_004d8d80 ; 004d8883
        ;   XREF to: 004d8d80 (UNCONDITIONAL_CALL)  ; int core_mission.cpp_CDemonMission_countActors_FUN_004d8d80(CDemonMission * this_ptr)
    ...
    MOV dword ptr [0x01cc4800],EBP      ; 004d8951 | g_CurrentFilename
    MOV [0x01cc4804],EAX                ; 004d8957 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004d895c
    ...
    MOV dword ptr [0x01cc4800],ECX      ; 004d8a75 | g_CurrentFilename
    MOV [0x01cc4804],EAX                ; 004d8a7b | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004d8a80
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
