...
section .text
    ...
    PUSH EBX                            ; 004d9c20
        ;   Label: core_mission.cpp_CDemonMission_ensureHeroPlaceholder_FUN_004d9c20
    PUSH EDI                            ; 004d9c21
    PUSH EBP                            ; 004d9c22
    ...
    PUSH EAX                            ; 004d9c9c
    CALL shape_edittool.cpp_CPickList_displayChoicesAndWaitForInput_FUN_00474d70 ; 004d9c9d
