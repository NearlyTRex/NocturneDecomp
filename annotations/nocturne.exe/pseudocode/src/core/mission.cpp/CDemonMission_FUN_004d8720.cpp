// Name: core_mission.cpp_CDemonMission_FUN_004d8720
// Address: 004d8720
// Address Range: [[004d8720, 004d8a9f]]
// Convention: __cdecl
// Signature: void __cdecl core_mission_cpp_CDemonMission_FUN_004d8720(CDemonMission *this_ptr,_FILE *file_handle)
...

{
  ...
  if (this_ptr->actors_prepared == 0) {
    shape_edittool_cpp_CEditorTools_displayCenteredStatusMessage_FUN_0046fff0
              (g_CEditorTools_PTR_005b6d50,"Preparing actors...");
  ...
  if (0 < DAT_00763e94) {
    iVar8 = 0;
    do {
      piVar1 = (int *)((int)&DAT_00763e98 + iVar8);
      iVar8 = iVar8 + 4;
      iVar5 = iVar5 + 1;
  ...
  for (pCVar2 = this_ptr->first_actor; pCVar2 != (CDemonActor *)0x0; pCVar2 = pCVar2->next_actor) {
    ...
    if (pCVar3 != (CDemonActor *)0x0) {
      ...
      for (iVar5 = 0; iVar5 < (int)pCVar3[0x17e].orient_matrix.m[1].x; iVar5 = iVar5 + 1) {
        ...
        this_ptr->actor_lookup_table[this_ptr->actor_lookup_count] = (CDemonActor *)pfVar6[3];
        pfVar6 = pfVar6 + 1;
        this_ptr->actor_lookup_count = this_ptr->actor_lookup_count + 1;
      }
  ...
  core_gore_cpp_CGore_save_FUN_004b08d0(g_CGore_PTR_005b96c4,file_handle);
  this_ptr->actor_lookup_count = 0;
  return;
}
