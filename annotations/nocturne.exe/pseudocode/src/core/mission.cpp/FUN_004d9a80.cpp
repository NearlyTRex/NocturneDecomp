...
// Convention: unknown
// Signature: undefined4 FUN_004d9a80(int param_1,undefined4 param_2)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_004d9a80(int param_1,uint param_2)

{
  ...
  if (*0x01CEA280 == 0) {
    ...
    iVar4 = FUN_004d9920(param_1,0,*(uint *)(0x01C775EC + 0xc0),param_2);
    if (iVar4 == 0) {
      return 0;
    }
    *(uint *)(*(int *)(_DAT_01cae0e8 * 4 + 0x1cae0d8) + 0x1f59c) =
    ...
    if (0 < _DAT_01cae0d4) {
      ...
      iVar2 = 0;
      do {
        iVar1 = FUN_004d9920(param_1,iVar4,*(uint *)(iVar3 + 0x34 + (int)0x01CEA280),0);
        if (iVar1 == 0) {
          return 0;
        }
  ...
  *(uint *)(*(int *)(_DAT_01cae0e8 * 4 + 0x1cae0d8) + 0xbc90) = 0;
  ...
  while (iVar4 != 0) {
    iVar2 = FUN_0040d7e0(iVar4,"CHeroPlaceholder");
    if (iVar2 == 0) {
      iVar4 = *(int *)(iVar4 + 0x144);
    }
    else {
      FUN_004d8f90(param_1,iVar4,1);
      iVar4 = *(int *)(param_1 + 0x514);
    }
  }
