...
;
; XREF[4]:
;   core_mission.cpp_CDemonMission_createFromSingleSet_FUN_004d93d0 at 004d9415
...
;   core_mission.cpp_CDemonMission_writeFile_FUN_004d8720 at 004d8749
;
; Referenced Globals:
...
section .text
    ...
    PUSH EAX                            ; 004d8dc7
    MOV EDX,dword ptr [0x005baca0]      ; 004d8dc8 | g_CLevelLoader_PTR_005baca0
    PUSH EDX                            ; 004d8dce
    ...
    PUSH EAX                            ; 004d8e5f
    MOV EAX,[0x005baca0]                ; 004d8e60 | g_CLevelLoader_PTR_005baca0
    PUSH EAX                            ; 004d8e65
    ...
    PUSH EAX                            ; 004d8e82
    MOV ECX,dword ptr [0x005baca0]      ; 004d8e83 | g_CLevelLoader_PTR_005baca0
    PUSH ECX                            ; 004d8e89
    ...
    PUSH EAX                            ; 004d8ec1
    MOV ECX,dword ptr [0x005baca0]      ; 004d8ec2 | g_CLevelLoader_PTR_005baca0
    PUSH ECX                            ; 004d8ec8
