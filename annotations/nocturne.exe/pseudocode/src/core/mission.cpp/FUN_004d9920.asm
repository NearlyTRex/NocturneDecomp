...
section .text
    ...
    PUSH EDX                            ; 004d9a51
    PUSH EBX                            ; 004d9a52
    CALL FUN_004b6080                   ; 004d9a53
        ;   XREF to: 004b6080 (UNCONDITIONAL_CALL)  ; undefined FUN_004b6080()
