...
section .text
    ...
    PUSH EBX                            ; 004c3710
        ;   Label: core_keyactor.cpp_CKeyActor_dtor_FUN_004c3710
    ...
    POP EBX                             ; 004c3734
    RET                                 ; 004c3735
    PUSH 0x59f900                       ; 004c3736 | g_CKeyActorTypeInfo_0059f900
        ;   Label: LAB_004c3736
    PUSH EBX                            ; 004c373b
    ...
    PUSH EAX                            ; 004c3751
        ;   Label: LAB_004c3751
    CALL crt_memory.c_operator_delete_FUN_00564494 ; 004c3752
