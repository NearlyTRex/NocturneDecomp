...

{
  ...
  if (0.0 < this_ptr->lifetime_remaining) {
    ...
    local_20 = g_CGame_PTR_005b9354->delta_time_float;
    ...
    core_dtrace_cpp_CDemonRaytrace_worldPositionToVoxelCoords_FUN_0046b700
              (&g_CDemonRaytrace_01fba938,&this_ptr->position,(CVector3i *)(local_68 + 0x30));
    voxel_coords = &local_74;
    this_ptr_00 = &g_CDemonRaytrace_01fba938;
    local_74.x = local_68._48_4_;
    *(float *)(local_68 + (uint)bVar5 * -8 + -8) = afStack_34[(uint)bVar5 * -2];
    *(float *)(local_68 + (uint)bVar5 * -8 + (uint)bVar5 * -8 + -4) =
    ...
    if ((iVar4 != 0) || (this_ptr->was_in_solid != 0)) {
      ...
      local_14 = core_dtrace_cpp_CDemonRaytrace_rayVoxelIntersection_FUN_00467a00
                           (&g_CDemonRaytrace_01fba938,pCVar1,&this_ptr->position,&local_2c,
                            (int *)0x0);
      if ((0.0 <= local_14) && (local_14 < 1.0)) {
        ...
        local_68._0_4_ = pCVar1->x + (float)local_68._24_4_ * local_14 * 0.8f;
        local_68._4_4_ =
             (this_ptr->previous_position).y + (float)local_68._28_4_ * local_14 * 0.8f;
        local_68._8_4_ =
             (this_ptr->previous_position).z + (float)local_68._32_4_ * local_14 * 0.8f;
        ...
        if (iVar4 == 0) {
          ...
          if (pCVar1 != (CVector3f *)(local_68 + 0xc)) {
          ...
          if (pCVar1 != (CVector3f *)(local_68 + 0x24)) {
