...
// Convention: unknown
// Signature: undefined4 FUN_005487b0(int param_1,int param_2)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_005487b0(int param_1,int param_2)

{
  ...
  if (param_2 != 0) {
    ...
    FUN_0040a240(param_2,&fStack_40,&fStack_4c);
    if (*(int *)(param_1 + 0x210) != 0) {
      iVar5 = FUN_0040d890(param_2,DAT_00765a98);
    ...
    if (fVar2 * fVar2 + fVar3 * fVar3 + fVar1 * fVar1 <=
      ...
      pfVar4 = (float *)FUN_0040a290(param_1,auStack_28,&fStack_40);
      if (&fStack_40 != pfVar4) {
        fStack_40 = *pfVar4;
        fStack_3c = pfVar4[1];
        fStack_38 = pfVar4[2];
