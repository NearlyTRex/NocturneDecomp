...
section .text
    ...
    POP EBX                             ; 00548938
    RET                                 ; 00548939
    MOV ECX,dword ptr [0x00765a98]      ; 0054893a | g_CCharacterActorType_00765a60.name_hash
        ;   Label: LAB_0054893a
    PUSH ECX                            ; 00548940
    PUSH ESI                            ; 00548941
    ...
    MOV dword ptr [0x01cc4800],EBP      ; 00548a00 | g_CurrentFilename
    MOV [0x01cc4804],EAX                ; 00548a06 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 00548a0b
    ...
    MOV dword ptr [0x01cc4804],EBX      ; 00548a22 | g_CurrentLineNumber
    MOV dword ptr [0x01cc4800],ECX      ; 00548a28 | g_CurrentFilename
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 00548a2e
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
