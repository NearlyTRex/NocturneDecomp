// Name: core_trigger.cpp_FUN_00547b30
// Address: 00547b30
// Address Range: [[00547b30, 005480f6]]
// Convention: unknown
// Signature: void core_trigger_cpp_FUN_00547b30(int param_1,float param_2)
  ...
  case 6:
    ...
    if (iVar6 != 0) {
      ...
      local_34 = core_fire_cpp_CFireEffect_getExplosionEffect_FUN_0048c160
                           (0x01C08D04,param_1 + 0x20,
                            ((int)local_1c >> 1) + (int)CVector3f_01c70708.y,0,0);
    }
    break;
  case 7:
