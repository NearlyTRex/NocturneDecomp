...
;                               FUNCTION
; *****************************************************************************
; void __cdecl core_elephant_cpp_CElephantGun_renderAimBeam_FUN_00478120(CElephantGun *this_ptr)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 00478120
        ;   Label: core_elephant.cpp_CElephantGun_renderAimBeam_FUN_00478120
    PUSH EDI                            ; 00478121
    PUSH EBP                            ; 00478122
    ...
    MOV EDX,dword ptr [0x005ae704]      ; 0047812e | g_CDemonRenderer_PTR_005ae704
    PUSH EDX                            ; 00478134 | DAT_01b4d738
    CALL engine_drender.cpp_CDemonRenderer_isShadowPass_FUN_00461090 ; 00478135
    ...
    PUSH EAX                            ; 0047828c
    MOV ECX,dword ptr [0x005b80f0]      ; 0047828d | g_CFireEffect_PTR_005b80f0
    PUSH ECX                            ; 00478293
