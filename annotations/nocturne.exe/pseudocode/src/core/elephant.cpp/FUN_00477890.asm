...
;                               FUNCTION
; *****************************************************************************
; undefined4 core_elephant_cpp_FUN_00477890(int param_1)
;
; Local Variables:
...
section .text
    ...
    PUSH EBX                            ; 00477d3c
    PUSH EDI                            ; 00477d3d
    CALL core_trigger.cpp_FUN_005485a0  ; 00477d3e
    ...
    PUSH EDI                            ; 00477f48
    CALL core_glass.cpp_FUN_004ada20    ; 00477f49
    ...
    PUSH ESI                            ; 00477fc0
    CALL core_fire.cpp_FUN_0048ab60     ; 00477fc1
