...
// Convention: unknown
// Signature: void core_elephant_cpp_CElephantGun_onFired_FUN_00477fd0(CDemonActor *param_1)
...

{
  ...
  pCVar1 = core_actor_cpp_CDemonActor_transformVector_FUN_0040a200(param_1,&local_44,pCVar1);
  if (&local_38 != pCVar1) {
    local_38.x = pCVar1->x;
    local_38.y = pCVar1->y;
    local_38.z = pCVar1->z;
