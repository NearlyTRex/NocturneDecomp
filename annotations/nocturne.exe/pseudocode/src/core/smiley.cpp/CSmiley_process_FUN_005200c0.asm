...
section .text
    ...
    PUSH dword ptr [EBP + 0x92]         ; 0052015d
        ;   Label: LAB_0052015d
    PUSH EBX                            ; 00520163
    CALL core_charactr.cpp_CCharacter_FUN_004259f0 ; 00520164
    ...
    CALL core_charactr.cpp_CCharacter_FUN_00428c00 ; 00520328
    ...
    PUSH EBX                            ; 00520407
    CALL core_charactr.cpp_CCharacter_FUN_0042a150 ; 00520408
