// Name: core_smiley.cpp_FUN_005210d0
// Address: 005210d0
// Address Range: [[005210d0, 00521188]]
// Convention: unknown
// Signature: int core_smiley_cpp_FUN_005210d0(int param_1,byte param_2)
...

{
  ...
  if ((param_2 & 4) != 0) {
    uVar2 = __vec_delete(param_1,&g_CSmileyTypeInfo_005a2100);
