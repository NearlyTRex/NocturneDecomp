...
;
; XREF[1]:
;   core_set.cpp_CDemonSet_gatherVisibleLights_FUN_0050aee0 at 0050b1de
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 0044d1f0
        ;   Label: core_dglobe.cpp_CDemonGlobe_intersectAABB_FUN_0044d1f0
    PUSH ESI                            ; 0044d1f1
    PUSH EDI                            ; 0044d1f2
    ...
    CALL core_dirmat.cpp_CMatrix3x3f_transformVectorTranspose_FUN_0044daa0 ; 0044d231
