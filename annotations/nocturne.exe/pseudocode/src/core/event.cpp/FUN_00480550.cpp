...
// Convention: unknown
// Signature: void FUN_00480550(int param_1,char *param_2,float param_3)
...

{
  ...
  iVar3 = FUN_004808b0(param_1,param_2);
  if (iVar3 < 0) {
    if (0.0 < param_3) {
    ...
    if (param_3 <= 0.0) {
      ...
      *(int *)(param_1 + 0x3210) = iVar4;
      FUN_00566170(param_1 + 0x3214 + iVar3 * 0x20,iVar3 * 0x20 + 0x20 + param_1 + 0x3214,
                   (iVar4 - iVar3) * 0x20);
      FUN_00566170(param_1 + 0x3354 + iVar1,iVar1 + 4 + param_1 + 0x3354,
