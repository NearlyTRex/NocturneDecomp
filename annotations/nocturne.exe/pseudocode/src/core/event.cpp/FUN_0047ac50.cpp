...
// Convention: unknown
// Signature: undefined4 FUN_0047ac50(int *param_1,char *param_2)
...
uint FUN_0047ac50(int *param_1,char *param_2)

{
  ...
  bVar14 = 0;
  DAT_01c08b60 = 0;
  if (((param_2 != (char *)0x0) && (*param_2 != '\0')) && (iVar3 = FUN_00564520(), iVar3 != 0)) {
    if (*param_2 == '.') {
      param_2 = param_2 + 1;
    }
...
LAB_0047acd1:
    ...
    iVar3 = FUN_00564bc0(param_2,"advanceLightFilter",0x12);
    if ((iVar3 == 0) && (((&DAT_005c168c)[(byte)(param_2[0x12] + 1)] & 0xe0) == 0)) {
      local_ec = param_2 + 0x12;
      while (((&DAT_005c168c)[(byte)(*local_ec + 1)] & 2) != 0) {
        local_ec = local_ec + 1;
      }
      pcVar9 = (char *)FUN_0047a650(&local_ec,local_fc4,200);
      if (pcVar9 != (char *)0x0) goto LAB_0047aec8;
      FUN_0050e5d0(0x01E57284,local_fc4,&local_e8,&local_44);
      if (local_e8 == 0) {
      ...
      if (local_f0 != 0) {
        ...
        FUN_005155e0(local_e8,local_44);
      }
    }
    else {
      iVar3 = FUN_00564bc0(param_2,"createExplosion",0xf);
      if ((iVar3 == 0) && (((&DAT_005c168c)[(byte)(param_2[0xf] + 1)] & 0xe0) == 0)) {
        ...
        local_e4 = -1;
        FUN_00566b5c(local_ec,"( %f , %n",&local_e0,&local_e4);
        if (local_e4 < 0) {
          uVar5 = FUN_0047a210();
          return uVar5;
        }
        ...
        local_e4 = -1;
        FUN_00566b5c(local_ec,"%f , %f , %f %n",&local_128,&local_124,&local_120,&local_e4)
        ;
        if ((local_e4 < 0) &&
           (FUN_00566b5c(local_ec," %[^,)] %n",local_4d5 + 1,&local_e4), -1 < local_e4)) {
          uVar6 = 0xffffffff;
          pcVar9 = local_4d5 + 1;
          do {
            if (uVar6 == 0) break;
          ...
          while (((&DAT_005c168c)[(byte)(local_4d5[1] + 1)] & 2) != 0) {
            FUN_00566170(local_4d5 + 1);
          }
          uVar6 = FUN_0047a390(local_4d5 + 1,DAT_00763e80,&DAT_00763e48);
          if (uVar6 == 0) {
            return 0;
          }
          if (uVar6 == 0x0FFFFFFF) {
        ...
        if (*local_ec == ',') {
          local_e4 = -1;
          FUN_00566b5c(local_ec,", %f %n",&local_dc,&local_e4);
          if (local_e4 < 0) {
            uVar5 = FUN_0047a210();
            return uVar5;
          }
        ...
        iVar3 = FUN_00564bc0(param_2,"deleteActor",0xb);
        if ((iVar3 == 0) && (((&DAT_005c168c)[(byte)(param_2[0xb] + 1)] & 0xe0) == 0)) {
          local_ec = param_2 + 0xb;
          while (((&DAT_005c168c)[(byte)(*local_ec + 1)] & 2) != 0) {
            local_ec = local_ec + 1;
          }
          pcVar9 = (char *)FUN_0047a650(&local_ec,local_1154,200);
          if (pcVar9 != (char *)0x0) goto LAB_0047aec8;
          uVar6 = FUN_0047a390(local_1154,DAT_00763e80,&DAT_00763e48);
          uVar5 = DAT_00764838;
          if (uVar6 == 0) {
            if (_DAT_01c08b5c != 0) {
              return 0;
          ...
          if ((uVar6 != 0x0FFFFFFF) && (local_f0 != 0)) {
            *(uint *)(uVar6 + 0x70) = 2;
            iVar3 = FUN_0040d890(uVar6,uVar5);
            if (iVar3 != 0) {
              *(byte *)(iVar3 + 0x2cc) = 0;
              FUN_00527230();
            }
            iVar3 = FUN_0040d890(uVar6,DAT_00765c68);
            if (iVar3 != 0) {
              *(byte *)(iVar3 + 0x1ac) = 0;
              *(byte *)(iVar3 + 0x214) = 0;
              FUN_00527230();
          ...
          iVar3 = FUN_00564bc0(param_2,"displayBitmap",0xd);
          if ((iVar3 == 0) && (((&DAT_005c168c)[(byte)(param_2[0xd] + 1)] & 0xe0) == 0)) {
            ...
            local_d0 = -1;
            FUN_00566b5c(local_ec,"( %[^ ,], %d, %d )%n",local_163c,&local_d8,&local_d4,
                         &local_d0);
            if (local_d0 < 0) {
              uVar5 = FUN_0047a210();
              return uVar5;
            ...
            iVar3 = FUN_004568c0(&DAT_0057f7a5,local_163c);
            if (iVar3 < 0) {
              uVar5 = FUN_0047a210();
              return uVar5;
            }
            ...
            if (local_f0 != 0) {
              FUN_004a5740(0x01C775EC,local_163c,local_d8,local_d4);
            }
          }
          else {
            iVar3 = FUN_00564bc0(param_2,"fadeAmbientSound",0x10);
            if ((iVar3 == 0) && (((&DAT_005c168c)[(byte)(param_2[0x10] + 1)] & 0xe0) == 0)) {
              ...
              local_c4 = -1;
              FUN_00566b5c(local_ec,"(%f, %f )%n",&local_cc,&local_c8,&local_c4);
              if (local_c4 < 0) {
                FUN_00563c90(&DAT_01c08b60,"Error parsing fadeAmbientSound parms");
                return 0;
              }
              local_ec = local_ec + local_c4;
              if (local_f0 != 0) {
                FUN_0052ede0(0x02DC9450,local_cc,local_c8);
              }
            }
            else {
              iVar3 = FUN_00564bc0(param_2,"fadeSfx",7);
              if ((iVar3 == 0) && (((&DAT_005c168c)[(byte)(param_2[7] + 1)] & 0xe0) == 0)) {
                ...
                local_b8 = -1;
                FUN_00566b5c(local_ec,"(%[^,], %f, %f )%n",local_108d + 1,&local_c0,
                             &local_bc,&local_b8);
                if (local_b8 < 0) {
                  FUN_00563c90(&DAT_01c08b60,"Error parsing fadeSfx parms");
                  return 0;
                }
                ...
                while (((&DAT_005c168c)[(byte)(local_108d[1] + 1)] & 2) != 0) {
                  FUN_00566170(local_108d + 1);
                }
                if (local_f0 != 0) {
                  uVar5 = FUN_00480bf0(param_1,local_108d + 1);
                  if (local_bc <= 0.0) {
                    FUN_005270d0(uVar5,local_c0);
                  }
                  else {
                    FUN_00527260(uVar5,local_c0,local_bc,0);
                  }
                }
              }
              else {
                iVar3 = FUN_00564bc0(param_2,"flagOn",6);
                if ((iVar3 == 0) && (((&DAT_005c168c)[(byte)(param_2[6] + 1)] & 0xe0) == 0)) {
                  local_ec = param_2 + 6;
                  while (((&DAT_005c168c)[(byte)(*local_ec + 1)] & 2) != 0) {
                    local_ec = local_ec + 1;
                  }
                  pcVar9 = (char *)FUN_0047a650(&local_ec,local_194,0x20);
                  if (pcVar9 != (char *)0x0) {
LAB_0047aec8:
                    pcVar8 = &DAT_01c08b60;
                    do {
                  ...
                  if (local_f0 != 0) {
                    FUN_004802e0(param_1,local_194,1);
                  }
                }
                else {
                  iVar3 = FUN_00564bc0(param_2,"flagOff",7);
                  if ((iVar3 == 0) && (((&DAT_005c168c)[(byte)(param_2[7] + 1)] & 0xe0) == 0)) {
                    local_ec = param_2 + 7;
                    while (((&DAT_005c168c)[(byte)(*local_ec + 1)] & 2) != 0) {
                      local_ec = local_ec + 1;
                    }
                    pcVar9 = (char *)FUN_0047a650(&local_ec,local_174,0x20);
                    if (pcVar9 != (char *)0x0) goto LAB_0047aec8;
                    if (local_f0 != 0) {
                      FUN_004802e0(param_1,local_174,0);
                    }
                  }
                  else {
                    iVar3 = FUN_00564bc0(param_2,"gameFlagOn",10);
                    if ((iVar3 == 0) && (((&DAT_005c168c)[(byte)(param_2[10] + 1)] & 0xe0) == 0)) {
                      local_ec = param_2 + 10;
                      while (((&DAT_005c168c)[(byte)(*local_ec + 1)] & 2) != 0) {
                        local_ec = local_ec + 1;
                      }
                      pcVar9 = (char *)FUN_0047a650(&local_ec,local_1b4,0x20);
                      if (pcVar9 != (char *)0x0) goto LAB_0047aec8;
                      if (local_f0 != 0) {
                        FUN_00480420(param_1,local_1b4,1);
                      }
                    }
                    else {
                      iVar3 = FUN_00564bc0(param_2,"gameFlagOff",0xb);
                      if ((iVar3 == 0) && (((&DAT_005c168c)[(byte)(param_2[0xb] + 1)] & 0xe0) == 0))
                      {
                        local_ec = param_2 + 0xb;
                        while (((&DAT_005c168c)[(byte)(*local_ec + 1)] & 2) != 0) {
                        ...
                        pcVar9 = (char *)FUN_0047a650(&local_ec,local_154,0x20);
                        if (pcVar9 != (char *)0x0) goto LAB_0047aec8;
                        if (local_f0 != 0) {
                          FUN_00480420(param_1,local_154,0);
                        }
                      }
                      else {
                        iVar3 = FUN_00564bc0(param_2,"hurtCharacter",0xd);
                        if ((iVar3 == 0) &&
                          ...
                          local_b4 = -1;
                          FUN_00566b5c(local_ec," ( %[^,], %[^,],%f)%n",local_665 + 1,
                          ...
                          while (((&DAT_005c168c)[(byte)(local_2e1[1] + 1)] & 2) != 0) {
                            FUN_00566170(local_2e1 + 1);
                          }
                          local_ec = local_ec + local_b4;
                          while (((&DAT_005c168c)[(byte)(*local_ec + 1)] & 2) != 0) {
                            local_ec = local_ec + 1;
                          }
                          uVar6 = FUN_0047a390(local_665 + 1,DAT_00765a98,&DAT_00765a60);
                          if (uVar6 == 0) {
                            return 0;
                          }
                          if (uVar6 == 0x0FFFFFFF) {
                          ...
                          iVar3 = FUN_0047a8f0(local_2e1 + 1,&local_ac);
                          if (iVar3 == 0) {
                          ...
                          iVar3 = FUN_00564bc0(param_2,"incCounter",10);
                          if ((iVar3 == 0) &&
                            ...
                            local_a8 = -1;
                            FUN_00566b5c(local_ec,"( %[^ )] )%n",local_121d + 1,&local_a8);
                            if (local_a8 < 5) {
                              FUN_00563c90(&DAT_01c08b60,"Error parsing incCounter arguments"
                                          );
                              return 0;
                            }
                            ...
                            while (((&DAT_005c168c)[(byte)(local_121d[1] + 1)] & 2) != 0) {
                              FUN_00566170(local_121d + 1);
                            }
                            if (local_f0 != 0) {
                              iVar3 = FUN_004807e0(param_1,local_121d + 1);
                              FUN_004806d0(param_1,local_121d + 1,iVar3 + 1);
                            }
                          }
                          else {
                            iVar3 = FUN_00564bc0(param_2,"killCharacter",0xd);
                            if ((iVar3 == 0) &&
                               (((&DAT_005c168c)[(byte)(param_2[0xd] + 1)] & 0xe0) == 0)) {
                              local_ec = param_2 + 0xd;
                              while (((&DAT_005c168c)[(byte)(*local_ec + 1)] & 2) != 0) {
                              ...
                              local_a4 = -1;
                              local_9c = 0.0;
                              FUN_00566b5c(local_ec," ( %[^,], %[^,], %f , %f , %f , %f)%n",
                                           local_153d + 1,local_219 + 1,local_110,local_10c,
                                           local_108,&local_9c,&local_a4);
                              local_9c = local_9c * (float)_DAT_00580217;
                              if (local_a4 < 0) {
                                local_9c = -1.0;
                                FUN_00566b5c(local_ec," ( %[^,], %[^,], %f , %f , %f )%n",
                                             local_153d + 1,local_219 + 1,local_110,local_10c,
                                             local_108,&local_a4);
                              }
                              if (local_a4 < 0) {
                                local_a0 = (byte *)0x0;
                                FUN_00566b5c(local_ec," ( %[^,], %[^)])%n",local_153d + 1,
                              ...
                              while (((&DAT_005c168c)[(byte)(local_219[1] + 1)] & 2) != 0) {
                                FUN_00566170(local_219 + 1);
                              }
                              local_ec = local_ec + local_a4;
                              while (((&DAT_005c168c)[(byte)(*local_ec + 1)] & 2) != 0) {
                                local_ec = local_ec + 1;
                              }
                              uVar6 = FUN_0047a390(local_153d + 1,DAT_00765a98,&DAT_00765a60);
                              if (uVar6 == 0) {
                                return 0;
                              }
                              if (uVar6 == 0x0FFFFFFF) {
                              ...
                              iVar3 = FUN_0047a760(local_219 + 1,&local_98);
                              if (iVar3 == 0) {
                              ...
                              iVar3 = FUN_00564bc0(param_2,"killHero",8);
                              if ((iVar3 == 0) &&
                                ...
                                local_94 = -1;
                                FUN_00566b5c(local_ec," ( %[^)])%n",local_27c,&local_94);
                                if (local_94 < 2) {
                                  uVar5 = FUN_0047a210();
                                  return uVar5;
                                }
                                ...
                                iVar3 = FUN_0047a760(local_27c,&local_90);
                                if (iVar3 == 0) {
                                ...
                                iVar3 = FUN_00564bc0(param_2,"killSfx",7);
                                if ((iVar3 == 0) &&
                                  ...
                                  local_8c = -1;
                                  FUN_00566b5c(local_ec,"(%[^,)]%n",local_efd + 1,&local_8c
                                              );
                                  if (local_8c < 3) {
                                    FUN_00563c90(&DAT_01c08b60,
                                  ...
                                  while (((&DAT_005c168c)[(byte)(local_efd[1] + 1)] & 2) != 0) {
                                    FUN_00566170(local_efd + 1);
                                  }
                                  local_88 = 0.0;
                                  if (*local_ec == ',') {
                                    local_8c = -1;
                                    FUN_00566b5c(local_ec,",%f%n",&local_88,&local_8c);
                                    if (local_8c < 3) {
                                      FUN_00563c90(&DAT_01c08b60,
                                                   "Error parsing killSfx parms");
                                      return 0;
                                  ...
                                  if (local_f0 != 0) {
                                    uVar5 = FUN_00480bf0(param_1,local_efd + 1);
                                    if (local_88 <= 0.0) {
                                      FUN_00527230();
                                      FUN_00480d60();
                                    }
                                    else {
                                      FUN_00527260(uVar5,0,local_88,1);
                                      FUN_00480d60();
                                    }
                                  }
                                }
                                else {
                                  iVar3 = FUN_00564bc0(param_2,"lightning",9);
                                  if ((iVar3 == 0) &&
                                    ...
                                    local_84 = -1;
                                    FUN_00566b5c(local_ec,"( )%n",&local_84);
                                    if (local_84 < 2) {
                                      FUN_00563c90(&DAT_01c08b60,
                                    ...
                                    if (local_f0 != 0) {
                                      FUN_00554d40(0x02DDF9F0,0x3dcccccd,1);
                                    }
                                  }
                                  else {
                                    iVar3 = FUN_00564bc0(param_2,"playSfx",7);
                                    if ((iVar3 == 0) &&
                                       (((&DAT_005c168c)[(byte)(param_2[7] + 1)] & 0xe0) == 0)) {
                                      local_ec = param_2 + 7;
                                      while (((&DAT_005c168c)[(byte)(*local_ec + 1)] & 2) != 0) {
                                      ...
                                      local_7c = -1;
                                      FUN_00566b5c(local_ec,"(%[^,)]%n",local_13ad + 1,
                                                   &local_7c);
                                      if (local_7c < 3) {
                                        FUN_00563c90(&DAT_01c08b60,
                                      ...
                                      if (*pcVar9 == ',') {
                                        local_7c = -1;
                                        FUN_00566b5c(local_ec,",%[^)]%n",(int)local_b15 + 1
                                                     ,&local_7c);
                                        if (local_7c < 3) {
                                          FUN_00563c90(&DAT_01c08b60,
                                                       "Error parsing playSfx parms");
                                      ...
                                      if (local_f0 != 0) {
                                        iVar3 = FUN_00564bc0(local_13ad + 1,&DAT_0057fbe2,3);
                                        if (iVar3 == 0) {
                                          iVar3 = FUN_00527490();
                                          if (iVar3 != 0) {
                                            FUN_00526340();
                                            FUN_005261b0();
                                            uVar5 = FUN_0052ea40(0x02DC9450,param_1,local_13ad + 1
                                                                );
                                            FUN_005263c0();
                                            if (local_b15[1] != '\0') {
                                              FUN_00480c30(param_1,(int)local_b15 + 1,uVar5);
                                            }
                                          }
                                        }
                                        else {
                                      ...
                                      iVar3 = FUN_00564bc0(param_2,"setCameraAmbient",0x10)
                                      ;
                                      if ((iVar3 == 0) &&
                                         (((&DAT_005c168c)[(byte)(param_2[0x10] + 1)] & 0xe0) == 0))
                                      {
                                        ...
                                        local_74 = -1;
                                        FUN_00566b5c(local_ec,"(%[^,], %f)%n",
                                                     local_12e5 + 1,&local_78,&local_74);
                                        if (local_74 < 3) {
                                          FUN_00563c90(&DAT_01c08b60,
                                        ...
                                        while (((&DAT_005c168c)[(byte)(local_12e5[1] + 1)] & 2) != 0
                                          ...
                                          FUN_00566170(local_12e5 + 1);
                                        }
                                        iVar3 = FUN_005090a0(0x01E57284,local_12e5 + 1);
                                        if (iVar3 < 0) {
                                          FUN_00563c90(&DAT_01c08b60,
                                        ...
                                        if (local_f0 != 0) {
                                          FUN_0050e4c0(0x01E57284,iVar3,
                                                       local_78 * (float)_DAT_0058021f);
                                        }
                                      }
                                      else {
                                        iVar3 = FUN_00564bc0(param_2,"setCounter",10);
                                        if ((iVar3 == 0) &&
                                           (((&DAT_005c168c)[(byte)(param_2[10] + 1)] & 0xe0) == 0))
                                        {
                                          local_ec = param_2 + 10;
                                          ...
                                          local_6c = -1;
                                          FUN_00566b5c(local_ec,"( %[^,)]%n",local_ca5 + 1,
                                                       &local_6c);
                                          if (local_6c < 5) {
                                            FUN_00563c90(&DAT_01c08b60,
                                          ...
                                          while (((&DAT_005c168c)[(byte)(local_ca5[1] + 1)] & 2) !=
                                                 0) {
                                            FUN_00566170(local_ca5 + 1);
                                          }
                                          local_68 = 0;
                                          if (*local_ec == ',') {
                                            local_6c = -1;
                                            FUN_00566b5c(local_ec,",%d%n",&local_68,
                                                         &local_6c);
                                            if (local_6c < 1) {
                                              FUN_00563c90(&DAT_01c08b60,
                                          ...
                                          local_ec = local_ec + 1;
                                          if (local_f0 != 0) {
                                            FUN_004806d0(param_1,local_ca5 + 1,local_68);
                                          }
                                        }
                                        else {
                                          iVar3 = FUN_00564bc0(param_2,"setGroupAmbient",
                                                               0xf);
                                          if ((iVar3 == 0) &&
                                            ...
                                            local_5c = -1;
                                            FUN_00566b5c(local_ec,"(%d, %f)%n",&local_64,
                                                         &local_60,&local_5c);
                                            if (local_5c < 3) {
                                              FUN_00563c90(&DAT_01c08b60,
                                            ...
                                            if (local_f0 != 0) {
                                              FUN_0050e510(0x01E57284,local_64,
                                                           local_60 * (float)_DAT_0058021f);
                                            }
                                          }
                                          else {
                                            iVar3 = FUN_00564bc0(param_2,
                                            ...
                                            if ((iVar3 == 0) &&
                                              ...
                                              FUN_0050e5d0(0x01E57284,local_7f4,&local_50,
                                                           &local_4c);
                                              if (local_50 == 0) {
                                                uVar5 = FUN_0047a210(
                                              ...
                                              if (local_f0 != 0) {
                                                ...
                                                FUN_00515670(local_50,local_54,local_4c);
                                              }
                                            }
                                            else {
                                              iVar3 = FUN_00564bc0(param_2,"setLeverState",
                                                                   0xd);
                                              if ((iVar3 == 0) &&
                                                ...
                                                while (((&DAT_005c168c)[(byte)(local_1475[1] + 1)] &
                                                       2) != 0) {
                                                  FUN_00566170(local_1475 + 1);
                                                }
                                                uVar6 = FUN_0047a390(local_d6d + 1,_DAT_01cc3660,
                                                                     0x1cc3628);
                                                if (uVar6 == 0) {
                                                  return 0;
                                                }
                                                if ((uVar6 == 0x0FFFFFFF) || (local_f0 == 0)) {
                                                  iVar3 = FUN_0047dc90(param_1,local_1475 + 1);
                                                  if (iVar3 != 0) {
                                                    return 0;
                                                  }
                                                }
                                                else {
                                                  iVar3 = FUN_0047dc30(0x01C03A10,local_1475 + 1);
                                                  if (iVar3 == 0) {
                                                    uStack_f8 = 0;
                                                  }
                                                  else {
                                                  ...
                                                  local_fc = 0;
                                                  FUN_004c6390(uVar6,(float)(double)((ulonglong)
                                                                                     uStack_f8 <<
                                                                                    0x20));
                                                }
                                              }
                                                ...
                                                if ((iVar3 == 0) &&
                                                  ...
                                                  while (((&DAT_005c168c)[(byte)(local_8bd[1] + 1)]
                                                         & 2) != 0) {
                                                    FUN_00566170(local_8bd + 1);
                                                  }
                                                  uVar6 = FUN_0047a390(local_985 + 1,DAT_00765a98,
                                                                       &DAT_00765a60);
                                                  if (uVar6 == 0) {
                                                    return 0;
                                                  }
                                                  if (uVar6 != 0x0FFFFFFF) {
                                                    uVar5 = FUN_004e1890(uVar6 + 0x150,local_8bd + 1
                                                                         ,0);
                                                    iVar3 = FUN_004e10a0(uVar5);
                                                    if (iVar3 < 0) {
                                                      FUN_00563c90(&DAT_01c08b60,
                                                  ...
                                                  if (local_f0 != 0) {
                                                    FUN_004e16b0(uVar6 + 0x150,iVar3,1);
                                                  }
                                                  }
                                                }
                                                else {
                                                  iVar3 = FUN_00564bc0(param_2,"setTimer",8
                                                                      );
                                                  if ((iVar3 == 0) &&
                                                  ...
                                                  if (local_f0 != 0) {
                                                    FUN_00480550(param_1,local_a4d + 1,local_3c);
                                                  }
                                                  }
                                                  else {
                                                    iVar3 = FUN_00564bc0(param_2,
                                                  ...
                                                  while (((&DAT_005c168c)[(byte)(local_e35[1] + 1)]
                                                         & 2) != 0) {
                                                    FUN_00566170(local_e35 + 1);
                                                  }
                                                  iVar3 = FUN_00564520(local_e35 + 1,&DAT_0057ffbc);
                                                  uVar5 = 0;
                                                  if (iVar3 != 0) {
                                                    iVar3 = FUN_00564520(local_e35 + 1,&DAT_0057ffc1
                                                                        );
                                                    if (iVar3 == 0) {
                                                      uVar5 = 1;
                                                    }
                                                    else {
                                                      iVar3 = FUN_00564520(local_e35 + 1,
                                                                           &DAT_0057ffc6);
                                                      if (iVar3 != 0) {
                                                        FUN_00563c90(&DAT_01c08b60,
                                                  ...
                                                  while (((&DAT_005c168c)[(byte)(local_40d[1] + 1)]
                                                         & 2) != 0) {
                                                    FUN_00566170(local_40d + 1);
                                                  }
                                                  uVar6 = FUN_0047a390(local_72d + 1,DAT_00765a98,
                                                                       &DAT_00765a60);
                                                  if (uVar6 == 0) {
                                                    return 0;
                                                  }
                                                  if (uVar6 != 0x0FFFFFFF) {
                                                    iVar3 = uVar6 + 0x150;
                                                    uVar5 = FUN_004e1890(iVar3,local_40d + 1,0);
                                                    iVar4 = FUN_004e1010(uVar5);
                                                    if (iVar4 < 0) {
                                                      FUN_00563c90(&DAT_01c08b60,
                                                  ...
                                                  if (local_f0 != 0) {
                                                    FUN_004e1990(iVar3,iVar4,0);
                                                    iVar4 = FUN_004e1660(iVar3,1);
                                                    FUN_004e16b0(iVar3,*(uint *)(iVar4 + 0x24)
                                                                );
                                                  }
                                                  }
                                                  }
                                                  ...
                                                  if ((iVar3 == 0) &&
                                                    ...
                                                    iVar3 = FUN_005090a0(0x01E57284,local_344);
                                                    if (iVar3 < 0) {
                                                      uVar5 = FUN_0047a210(
                                                  ...
                                                  if (*local_ec == ',') {
                                                    local_1c = -1;
                                                    FUN_00566b5c(local_ec,",%f%n",&local_70
                                                                 ,&local_1c);
                                                    if (local_1c < 2) {
                                                      uVar5 = FUN_0047a210();
                                                      return uVar5;
                                                  ...
                                                  local_ec = local_ec + 1;
                                                  if (local_f0 != 0) {
                                                    FUN_005135d0(0x01E57284,iVar3,local_70);
                                                  }
                                                  }
                                                  else {
                                                    iVar3 = FUN_00564bc0(param_2,"warpTo",6
                                                                        );
                                                    if ((iVar3 != 0) ||
                                                  ...
                                                  uVar6 = FUN_0047a390(local_bdd + 1,DAT_00763e80,
                                                                       &DAT_00763e48);
                                                  if (uVar6 == 0) {
                                                    return 0;
                                                  }
                                                  ...
                                                  if (local_18 < 0) {
                                                    ...
                                                    FUN_00566b5c(local_59d + 1,"%f,%f,%f%n"
                                                                 ,&local_11c,&local_118,&local_114,
                                                                 &local_18);
                                                  }
                                                  if (local_18 < 0) {
                                                    uVar7 = FUN_0047a390(local_59d + 1,DAT_00763e80,
                                                                         &DAT_00763e48);
                                                    if (uVar7 == 0) {
                                                      return 0;
                                                    }
                                                  ...
                                                  if (local_f0 != 0) {
                                                    iVar3 = FUN_0040d890(uVar6,DAT_00765a98);
                                                    if (iVar3 != 0) {
