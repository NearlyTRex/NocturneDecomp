...
// Convention: unknown
// Signature: void FUN_00480420(int param_1,char *param_2,int param_3)
...

{
  ...
  if ((param_2 != (char *)0x0) && (*param_2 != '\0')) {
    iVar2 = FUN_00480860(param_1,param_2);
    if (param_3 == 0) {
      if (-1 < iVar2) {
        iVar4 = *(int *)(param_1 + 0x1908) + -1;
        *(int *)(param_1 + 0x1908) = iVar4;
        FUN_00566170(iVar2 * 0x20 + param_1 + 0x190c,iVar2 * 0x20 + 0x20 + param_1 + 0x190c,
                     (iVar4 - iVar2) * 0x20);
        return;
      }
    }
      ...
      FUN_00566ad0(param_1 + 0x190c + *(int *)(param_1 + 0x1908) * 0x20);
