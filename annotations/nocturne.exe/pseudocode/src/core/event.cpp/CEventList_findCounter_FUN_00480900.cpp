...
// Convention: unknown
// Signature: int core_event_cpp_CEventList_findCounter_FUN_00480900(int param_1,undefined4 param_2)

#include "nocturne.h"

int core_event_cpp_CEventList_findCounter_FUN_00480900(int param_1,uint param_2)
