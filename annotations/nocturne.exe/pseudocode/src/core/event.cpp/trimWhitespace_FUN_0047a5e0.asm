...
section .text
    ...
    PUSH EBX                            ; 0047a5e0
        ;   Label: core_event.cpp_trimWhitespace_FUN_0047a5e0
    PUSH ESI                            ; 0047a5e1
    PUSH EDI                            ; 0047a5e2
    ...
    TEST byte ptr [EDX + 0x5c168c],0x2  ; 0047a607 | g_CharacterClassificationTable
    ...
    TEST byte ptr [EAX + 0x5c168c],0x2  ; 0047a622 | g_CharacterClassificationTable
