...
// Convention: unknown
// Signature: void FUN_00480c30(int param_1,char *param_2,undefined4 param_3)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_00480c30(int param_1,char *param_2,uint param_3)

{
  ...
  iVar2 = FUN_00480d10(param_1,param_2);
  if (iVar2 < 0) {
