...
// Convention: unknown
// Signature: void FUN_004806d0(int param_1,char *param_2,int param_3)
...

{
  ...
  iVar3 = FUN_00480900(param_1,param_2);
  if (iVar3 < 0) {
    if (param_3 != 0) {
    ...
    if (param_3 == 0) {
      ...
      *(int *)(param_1 + 0x337c) = iVar4;
      FUN_00566170(iVar3 * 0x20 + param_1 + 0x3380,iVar3 * 0x20 + 0x20 + param_1 + 0x3380,
                   (iVar4 - iVar3) * 0x20);
      FUN_00566170(param_1 + 0x34c0 + iVar1,iVar1 + 4 + param_1 + 0x34c0,
