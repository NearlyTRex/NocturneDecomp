...
section .text
    ...
    PUSH EBX                            ; 004802e0
        ;   Label: core_event.cpp_CEventList_addOrRemovePersistentEvent_FUN_004802e0
    PUSH ESI                            ; 004802e1
    PUSH EBP                            ; 004802e2
    ...
    PUSH ESI                            ; 004802f8
        ;   Label: LAB_004802f8
    PUSH EBX                            ; 004802f9
    CALL core_event.cpp_CEventList_findPersistentEvent_FUN_00480810 ; 004802fa
    ...
    MOV dword ptr [0x01cc4800],EDX      ; 00480340 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],ECX      ; 00480346 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 0048034c
    ...
    PUSH EDX                            ; 0048038a
    CALL crt_string.c_strupr_FUN_00566ad0 ; 0048038b
    ...
    MOV dword ptr [0x01cc4800],EBP      ; 004803b4 | g_CurrentFilename
    MOV [0x01cc4804],EAX                ; 004803ba | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004803bf
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
    ...
    CALL crt_string.c_memmove_FUN_00566170 ; 004803f8
