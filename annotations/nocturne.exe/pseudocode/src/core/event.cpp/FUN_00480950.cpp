...
// Convention: unknown
// Signature: void FUN_00480950(int param_1,char *param_2,char *param_3)
  ...
  if (iVar4 < 0) {
    ...
    if (param_3 == (char *)0x0) {
      ...
      *(int *)(param_1 + 0x34e8) = iVar7;
      iVar2 = (iVar4 + 1) * 0x1e;
      FUN_00566170(pcVar6,param_1 + 0x34ec + iVar2,(iVar7 - iVar4) * 0x1e);
      FUN_00566170(pcVar5,iVar2 + param_1 + 0x37da,(*(int *)(param_1 + 0x34e8) - iVar4) * 0x1e);
      return;
    }
    do {
      cVar1 = *param_2;
