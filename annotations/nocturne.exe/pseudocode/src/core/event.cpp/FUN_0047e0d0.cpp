...
// Convention: unknown
// Signature: uint FUN_0047e0d0(undefined4 param_1,int param_2,int *param_3)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_0047e0d0(uint param_1,int param_2,int *param_3)

{
  ...
  if (cVar1 == '(') {
    *param_3 = *param_3 + 1;
    uVar6 = FUN_00480220(param_1,param_2,param_3);
    if ((int)uVar6 < 0) {
      return uVar6;
    }
    if (*(char *)(param_2 + *param_3) == ')') {
  ...
  if (cVar1 == '!') {
    *param_3 = *param_3 + 1;
    uVar6 = FUN_0047e0d0(param_1,param_2,param_3);
    if (-1 < (int)uVar6) {
      return (uint)(uVar6 == 0);
    }
    return uVar6;
  }
  iVar7 = FUN_00480f40(cVar1);
  if (iVar7 == 0) {
  ...
  do {
    ...
    *param_3 = iVar7 + 1;
    puVar12 = puVar12 + 1;
    iVar7 = FUN_00480f40(*(byte *)(param_2 + iVar7 + 1));
  } while (iVar7 != 0);
  *puVar12 = 0;
  if (*(char *)(param_2 + *param_3) != '(') {
    while (((&DAT_005c168c)[(byte)(*(char *)(*param_3 + param_2) + 1)] & 2) != 0) {
    ...
    uVar6 = FUN_0047dba0(param_1,local_150);
    return uVar6;
  }
  local_dc = 0xffffffff;
  iVar7 = FUN_00564520(local_150,&DAT_005802c4);
  if (iVar7 != 0) {
    iVar7 = FUN_00564520(local_150,"exists");
    if (iVar7 == 0) {
      local_6c = -1;
      FUN_00566b5c(param_2 + *param_3," ( %[^ )] )%n",acStack_2e1 + 1,&local_6c);
      if (local_6c < 3) {
      ...
      while (((&DAT_005c168c)[(byte)(acStack_2e1[1] + 1)] & 2) != 0) {
        FUN_00566170(pcVar11,local_bc,iVar7);
        iVar7 = iVar7 + -1;
      }
      uVar6 = FUN_0047a390(acStack_2e1 + 1,DAT_00763e80,&DAT_00763e48);
      ...
      *param_3 = *param_3 + local_6c;
      ...
      iVar7 = FUN_00564520(local_150,"hasItem");
      if (iVar7 == 0) {
        if (*0x01CEA280 != 0) {
        ...
        local_b8 = -1;
        FUN_00566b5c(param_2 + *param_3," (%[^)])%n",acStack_7f5 + 1,&local_b8);
        if (local_b8 < 3) {
        ...
        while (((&DAT_005c168c)[(byte)(acStack_7f5[1] + 1)] & 2) != 0) {
          FUN_00566170(pcVar11,local_b0,iVar7);
          iVar7 = iVar7 + -1;
        }
        iVar7 = *(int *)(_DAT_01cae0e8 * 4 + 0x1cae0d8);
        local_dc = 0;
        if ((iVar7 != 0) && (iVar7 = FUN_004c0710(iVar7 + 0x1f5a0,acStack_7f5 + 1), iVar7 != 0)) {
          local_dc = 1;
        }
        *param_3 = *param_3 + local_b8;
      }
      else {
        iVar7 = FUN_00564520(local_150,"hasItemType");
        if (iVar7 == 0) {
          local_ac = -1;
          FUN_00566b5c(param_2 + *param_3," (%[^,], %[^)] )%n",acStack_72d + 1,local_6c9 + 1
                       ,&local_ac);
          if (local_ac < 5) {
            ...
            while (((&DAT_005c168c)[(byte)(acStack_72d[1] + 1)] & 2) != 0) {
              FUN_00566170(pcVar11,local_50,iVar7);
              iVar7 = iVar7 + -1;
            }
            uVar6 = 0xffffffff;
            pcVar11 = local_6c9 + 1;
            ...
            while (((&DAT_005c168c)[(byte)(local_6c9[1] + 1)] & 2) != 0) {
              FUN_00566170(local_6c9 + 1,local_a8,iVar7);
              iVar7 = iVar7 + -1;
            }
            uVar6 = FUN_0047a390(acStack_72d + 1,_DAT_01cae124,0x1cae0ec);
            if (uVar6 != 0) {
              if (uVar6 == 0x0FFFFFFF) {
                local_dc = 0;
                *param_3 = *param_3 + local_ac;
                ...
                local_dc = FUN_004c0760(uVar6 + 0x1f5a0,local_6c9 + 1);
                *param_3 = *param_3 + local_ac;
              }
              goto LAB_0047e580;
            }
        ...
        iVar7 = FUN_00564520(local_150,"hasKeyMask");
        if (iVar7 == 0) {
          if (*0x01CEA280 != 0) {
          ...
          local_a4 = -1;
          FUN_00566b5c(param_2 + *param_3," ( %d )%n",&local_a0,&local_a4);
          if (local_a4 < 3) {
          ...
          iVar7 = *(int *)(_DAT_01cae0e8 * 4 + 0x1cae0d8);
          local_dc = 0;
          if ((iVar7 != 0) && (iVar7 = FUN_004c31b0(iVar7 + 0x1f5a0,local_a0,0), iVar7 != 0)) {
            local_dc = 1;
          }
          *param_3 = *param_3 + local_a4;
        }
        else {
          iVar7 = FUN_00564520(local_150,"isBroken");
          if (iVar7 == 0) {
            local_9c = -1;
            FUN_00566b5c(param_2 + *param_3," (%[^)])%n",acStack_59d + 1,&local_9c);
            if (local_9c < 3) {
              ...
              while (((&DAT_005c168c)[(byte)(acStack_59d[1] + 1)] & 2) != 0) {
                FUN_00566170(pcVar11,local_98,iVar7);
                iVar7 = iVar7 + -1;
              }
              uVar6 = FUN_0047a390(acStack_59d + 1,_DAT_01c78c78,0x1c78c40);
              if (uVar6 != 0) {
                if (uVar6 == 0x0FFFFFFF) {
                  local_dc = 0;
          ...
          iVar7 = FUN_00564520(local_150,"isCurrentCamera");
          if (iVar7 == 0) {
            local_94 = -1;
            FUN_00566b5c(param_2 + *param_3," ( %[^ )] )%n",local_858,&local_94);
            if (local_94 < 3) {
            ...
            if ((-1 < *(int *)(0x01E57284 + 0x15aabc)) &&
               (iVar7 = FUN_00564520(*(int *)(0x01E57284 + 0x15aabc) * 0x1a0 + 0x01E57284 + 4,
                                     local_858), iVar7 == 0)) {
              local_dc = 1;
            }
            *param_3 = *param_3 + local_94;
            ...
            iVar7 = FUN_00564520(local_150,"isDead");
            if (iVar7 == 0) {
              local_90 = -1;
              FUN_00566b5c(param_2 + *param_3," ( %[^ )] )%n",local_600,&local_90);
              if (local_90 < 3) {
                ...
                uVar6 = FUN_0047a390(local_600,DAT_00765a98,&DAT_00765a60);
                if (uVar6 != 0) {
                  if (uVar6 == 0x0FFFFFFF) {
                    local_dc = 0;
            ...
            iVar7 = FUN_00564520(local_150,"isFadeFinished");
            if (iVar7 == 0) {
              local_8c = -1;
              FUN_00566b5c(param_2 + *param_3," ( )%n",&local_8c);
              iVar7 = 0x01C775EC;
              if (local_8c < 2) {
              ...
              *param_3 = *param_3 + local_8c;
              local_dc = FUN_004a3a50(iVar7);
            }
            else {
              iVar7 = FUN_00564520(local_150,"isInRange");
              if (iVar7 == 0) {
                local_88 = -1;
                FUN_00566b5c(param_2 + *param_3," ( %n",&local_88);
                if (local_88 < 1) {
                ...
                *param_3 = *param_3 + local_88;
                iVar7 = FUN_0047a4c0(param_2,param_3,&local_104);
                if (iVar7 < 0) {
                  return 0xffffffff;
                }
                local_88 = -1;
                ...
                if (local_88 < 1) {
                  ...
                  *param_3 = *param_3 + local_88;
                  iVar8 = FUN_0047a4c0(param_2,param_3,&local_ec);
                  if (-1 < iVar8) {
                    local_88 = -1;
                    FUN_00566b5c(param_2 + *param_3," , %f )%n",local_84,&local_88);
                    if (local_88 < 3) {
                      pcVar11 = "Error parsing isInRange parameters.";
                      pcVar13 = &DAT_01c08b60;
                      do {
              ...
              iVar7 = FUN_00564520(local_150,"isOfType");
              if (iVar7 == 0) {
                local_70 = -1;
                FUN_00566b5c(param_2 + *param_3," ( %[^ ,] , %[^ )] )%n",acStack_40d + 1,
                ...
                if (local_70 < 3) {
                  ...
                  while (((&DAT_005c168c)[(byte)(acStack_40d[1] + 1)] & 2) != 0) {
                    FUN_00566170(pcVar11,local_68,iVar7);
                    iVar7 = iVar7 + -1;
                  }
                  uVar6 = 0xffffffff;
                  pcVar11 = local_985 + 1;
                  ...
                  while (((&DAT_005c168c)[(byte)(local_985[1] + 1)] & 2) != 0) {
                    FUN_00566170(local_985 + 1,local_64,iVar7);
                    iVar7 = iVar7 + -1;
                  }
                  uVar6 = FUN_0047a390(acStack_40d + 1,DAT_00763e80,&DAT_00763e48);
                  if (uVar6 != 0) {
                    if (uVar6 == 0x0FFFFFFF) {
                      local_dc = 0;
                      *param_3 = *param_3 + local_70;
                      ...
                      local_dc = FUN_0040d7e0(uVar6,local_985 + 1);
                      *param_3 = *param_3 + local_70;
                    }
                    goto LAB_0047e580;
                  }
              ...
              iVar7 = FUN_00564520(local_150,"isFacing");
              if (iVar7 == 0) {
                local_60 = -1;
                FUN_00566b5c(param_2 + *param_3," (%[^,], %[^,)]%n",acStack_4d5 + 1,
                ...
                while (((&DAT_005c168c)[(byte)(acStack_4d5[1] + 1)] & 2) != 0) {
                  FUN_00566170(pcVar11,local_5c,iVar7);
                  iVar7 = iVar7 + -1;
                }
                uVar6 = 0xffffffff;
                pcVar11 = local_3a9 + 1;
                ...
                while (((&DAT_005c168c)[(byte)(local_3a9[1] + 1)] & 2) != 0) {
                  FUN_00566170(local_3a9 + 1,local_58,iVar7);
                  iVar7 = iVar7 + -1;
                }
                uVar6 = FUN_0047a390(acStack_4d5 + 1,DAT_00763e80,&DAT_00763e48);
                if ((uVar6 == 0) ||
                   (uVar10 = FUN_0047a390(local_3a9 + 1,DAT_00763e80,&DAT_00763e48), uVar10 == 0)) {
                  return 0xffffffff;
                }
                *param_3 = *param_3 + local_60;
                ...
                if (*(char *)(param_2 + *param_3) == ',') {
                  local_60 = -1;
                  FUN_00566b5c(param_2 + *param_3,",%f %n",&local_a88,&local_60);
                  if (local_60 < 2) {
                    pcVar11 = "Error parsing isFacing parameters.";
                    pcVar13 = &DAT_01c08b60;
                    do {
                ...
                *param_3 = *param_3 + 1;
                if ((uVar6 == uVar5) || (uVar10 == uVar5)) {
                  ...
                  FUN_0040a290(uVar6,local_110,uVar10 + 0x20);
                  local_10c = 0;
                  iVar7 = FUN_0054e4a0(local_f8,local_110);
                ...
                iVar7 = FUN_00564520(local_150,"isLightOn");
                if (iVar7 == 0) {
                  local_54 = -1;
                  FUN_00566b5c(param_2 + *param_3," ( %[^ )] )%n",local_920,&local_54);
                  if (local_54 < 3) {
                  ...
                  FUN_0050e5d0(0x01E57284,local_920,&local_4c,&local_48);
                  if (local_4c == 0) {
                    FUN_00563c90(local_a84,"Spotlight %s doesn't exist.",local_920);
                    pcVar11 = local_a84;
                    pcVar13 = &DAT_01c08b60;
                    do {
                      cVar1 = *pcVar11;
                  ...
                  *param_3 = *param_3 + local_54;
                  ...
                  iVar7 = FUN_00564520(local_150,"isNudityEnabled");
                  if (iVar7 == 0) {
                    local_44 = -1;
                    FUN_00566b5c(param_2 + *param_3," ( )%n",&local_44);
                    if (local_44 < 2) {
                    ...
                    *param_3 = *param_3 + local_44;
                    ...
                    iVar7 = FUN_00564520(local_150,"isSfxActive");
                    if (iVar7 == 0) {
                      local_40 = -1;
                      FUN_00566b5c(param_2 + *param_3," ( %[^ )] )%n",acStack_791 + 1,
                                   &local_40);
                      if (local_40 < 3) {
                      ...
                      while (((&DAT_005c168c)[(byte)(acStack_791[1] + 1)] & 2) != 0) {
                        FUN_00566170(pcVar11,local_3c,iVar7);
                        iVar7 = iVar7 + -1;
                      }
                      local_dc = 0;
                      iVar7 = FUN_00480bf0(param_1,acStack_791 + 1);
                      if (iVar7 != 0) {
                        local_dc = 1;
                      }
                      *param_3 = *param_3 + local_40;
                      ...
                      iVar7 = FUN_00564520(local_150,"isTalking");
                      if (iVar7 == 0) {
                        local_38 = -1;
                        FUN_00566b5c(param_2 + *param_3," ( %[^ )] )%n",local_27c,&local_38)
                        ;
                        if (local_38 < 3) {
                        ...
                        local_dc = FUN_0047a390(local_27c,DAT_00765a98,&DAT_00765a60);
                        if (local_dc == 0) {
                          return 0xffffffff;
                        }
                        ...
                        *param_3 = *param_3 + local_38;
                        ...
                        iVar7 = FUN_00564520(local_150,"isVictim");
                        if (iVar7 == 0) {
                          local_e0 = -1;
                          FUN_00566b5c(param_2 + *param_3," ( %[^ )] )%n",local_1b4,
                                       &local_e0);
                          if (local_e0 < 3) {
                            ...
                            local_b4 = FUN_0047a390(local_1b4,DAT_00765a98,&DAT_00765a60);
                            if (local_b4 != 0) {
                              local_dc = 0;
                        ...
                        iVar7 = FUN_00564520(local_150,"isWeaponDrawn");
                        if (iVar7 == 0) {
                          local_d8 = -1;
                          FUN_00566b5c(param_2 + *param_3," ( %[^ )] )%n",local_470,
                                       &local_d8);
                          if (local_d8 < 3) {
                          ...
                          uVar6 = FUN_0047a390(local_470,_DAT_01cae124,0x1cae0ec);
                          if (uVar6 == 0) {
                            return 0xffffffff;
                          }
                          if (uVar6 == 0x0FFFFFFF) {
                          ...
                          *param_3 = *param_3 + local_d8;
                          ...
                          iVar7 = FUN_00564520(local_150,"isWearingGasMask");
                          if (iVar7 == 0) {
                            local_20 = -1;
                            FUN_00566b5c(param_2 + *param_3," ( %[^ )] )%n",local_538,
                                         &local_20);
                            if (local_20 < 3) {
                            ...
                            uVar6 = FUN_0047a390(local_538,_DAT_01cae124,0x1cae0ec);
                            if (uVar6 == 0) {
                              return 0xffffffff;
                            }
                            if (uVar6 == 0x0FFFFFFF) {
                            ...
                            iVar7 = FUN_00564520(local_150,"randBool");
                            if (iVar7 != 0) {
                              iVar7 = FUN_00564520(local_150,"reachedDest");
                              if (iVar7 != 0) {
                              ...
                              local_18 = -1;
                              FUN_00566b5c(param_2 + *param_3," ( %[^ )] )%n",local_664,
                                           &local_18);
                              if (local_18 < 3) {
                                ...
                                uVar6 = FUN_0047a390(local_664,DAT_00765a98,&DAT_00765a60);
                                if (uVar6 != 0) {
                                  if (uVar6 == 0x0FFFFFFF) {
                                    local_dc = 0;
                            ...
                            local_1c = -1;
                            FUN_00566b5c(param_2 + *param_3," ( %f )%n",&local_d4,&local_1c)
                            ;
                            if (local_1c < 3) {
                            ...
                            local_dc = FUN_0040dea0(local_d4);
  ...
  local_c0 = -1;
  FUN_00566b5c(param_2 + *param_3," ( %s %s %[^ )] )%n",acStack_8bd + 1,local_219 + 1,
  ...
  while (((&DAT_005c168c)[(byte)(acStack_8bd[1] + 1)] & 2) != 0) {
    FUN_00566170(pcVar11,local_d0,iVar7);
    iVar7 = iVar7 + -1;
  }
  uVar6 = 0xffffffff;
  pcVar11 = local_345 + 1;
  ...
  while (((&DAT_005c168c)[(byte)(local_345[1] + 1)] & 2) != 0) {
    FUN_00566170(local_345 + 1,local_cc,iVar7);
    iVar7 = iVar7 + -1;
  }
  uVar6 = 0xffffffff;
  pcVar11 = local_219 + 1;
  ...
  while (((&DAT_005c168c)[(byte)(local_219[1] + 1)] & 2) != 0) {
    FUN_00566170(local_219 + 1,local_c8,iVar7);
    iVar7 = iVar7 + -1;
  }
  iVar8 = FUN_005649c0(local_219 + 1,&DAT_0057f3b3);
  iVar7 = 0;
  if (iVar8 != 0) {
    iVar7 = FUN_005649c0(local_219 + 1,&DAT_0057f3b5);
    if (iVar7 == 0) {
      iVar7 = 1;
    }
    else {
      iVar7 = FUN_005649c0(local_219 + 1,&DAT_0057f3b8);
      if (iVar7 == 0) {
        iVar7 = 2;
      }
      else {
        iVar7 = FUN_005649c0(local_219 + 1,&DAT_0057f3bb);
        if (iVar7 == 0) {
          iVar7 = 3;
        }
        else {
          iVar7 = FUN_005649c0(local_219 + 1,&DAT_0057f3be);
          if (iVar7 == 0) {
            iVar7 = 5;
          }
          else {
            iVar7 = FUN_005649c0(local_219 + 1,&DAT_0057f3c0);
            if (iVar7 == 0) {
              iVar7 = 4;
            }
            else {
  ...
  *param_3 = *param_3 + local_c0;
  iVar9 = FUN_00566b5c(acStack_8bd + 1,&DAT_0057f3c3,&local_c4);
  iVar8 = local_c4;
  if (iVar9 != 1) {
    iVar8 = FUN_004807e0(0x01C03A10,acStack_8bd + 1);
  }
  iVar9 = FUN_00566b5c(local_345 + 1,&DAT_0057f3c3,&local_74);
  if (iVar9 == 1) {
    switch(iVar7) {
    case 0:
...
LAB_0047e580:
  ...
  local_74 = FUN_004807e0(0x01C03A10,local_345 + 1);
  switch(iVar7) {
  case 0:
