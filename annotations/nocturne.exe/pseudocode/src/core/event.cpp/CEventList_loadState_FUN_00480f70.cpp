...
// Convention: __cdecl
// Signature: int __cdecl core_event_cpp_CEventList_loadState_FUN_00480f70(CEventList *this_ptr,_FILE *file_handle)
...

{
  ...
  core_event_cpp_CEventList_reset_FUN_0047aa00(this_ptr);
