...
;   core_event.cpp_CEventList_evaluateExpression_FUN_0047dd10 at 0047dd2f
;
; Called Functions:
;   core_event.cpp_CEventList_evaluateAtom_FUN_0047e0d0
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 00480220
        ;   Label: core_event.cpp_CEventList_evaluateLogicalExpr_FUN_00480220
    PUSH ESI                            ; 00480221
    PUSH EDI                            ; 00480222
    PUSH EBP                            ; 00480223
