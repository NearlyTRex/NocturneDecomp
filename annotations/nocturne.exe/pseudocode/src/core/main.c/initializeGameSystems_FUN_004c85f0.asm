...
section .text
    ...
    PUSH EBX                            ; 004c85f0
        ;   Label: core_main.c_initializeGameSystems_FUN_004c85f0
    PUSH ESI                            ; 004c85f1
    PUSH EDI                            ; 004c85f2
    PUSH EBP                            ; 004c85f3
    ...
    MOV ECX,dword ptr [0x005b9284]      ; 004c8d34 | g_CForceFeedback_PTR_005b9284
    PUSH ECX                            ; 004c8d3a
    CALL engine_force.cpp_CForceFeedback_processEvent_FUN_004940d0 ; 004c8d3b
