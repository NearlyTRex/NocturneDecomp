...
;
; XREF[1]:
;   core_menu.cpp_showMainGameMenu_FUN_004d23d0 at 004d270d
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004c8510
        ;   Label: core_main.c_showDeveloperToolsMenu_FUN_004c8510
    PUSH ESI                            ; 004c8511
    PUSH EDI                            ; 004c8512
    SUB ESP,0x100                       ; 004c8513
    XOR ESI,ESI                         ; 004c8519
    CALL engine_special.cpp_clearScreen_FUN_0052ee70 ; 004c851b
