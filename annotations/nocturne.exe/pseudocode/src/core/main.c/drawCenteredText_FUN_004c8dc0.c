...
// Convention: unknown
// Signature: void core_main_c_drawCenteredText_FUN_004c8dc0(char *param_1,undefined4 param_2,int param_3,int param_4)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void core_main_c_drawCenteredText_FUN_004c8dc0(char *param_1,uint param_2,int param_3,int param_4)
