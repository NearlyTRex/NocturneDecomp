...
LAB_004c84a6:
      ...
      do {
        pcVar2 = g_CHAR_PTR_01cc4800;
        if (*g_CHAR_PTR_01cc4800 == '\\') goto LAB_004c84fe;
        if (*g_CHAR_PTR_01cc4800 == '\0') break;
        pcVar2 = g_CHAR_PTR_01cc4800 + 1;
        if (*pcVar2 == '\\') goto LAB_004c84fe;
        g_CHAR_PTR_01cc4800 = g_CHAR_PTR_01cc4800 + 2;
      } while (*pcVar2 != '\0');
      pcVar2 = (char *)0x0;
LAB_004c84fe:
      pcVar2 = pcVar2 + 1;
      g_CHAR_PTR_01cc4800 = pcVar2;
    }
  } while( true );
}
