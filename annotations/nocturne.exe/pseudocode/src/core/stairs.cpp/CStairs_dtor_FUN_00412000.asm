...
section .text
    ...
    PUSH EBX                            ; 00412000
        ;   Label: core_stairs.cpp_CStairs_dtor_FUN_00412000
    ...
    PUSH EBX                            ; 00412014
    CALL core_stairs.cpp_CDemonTriangle_arrdtor_FUN_0043b5f0 ; 00412015
    ...
    POP EBX                             ; 0041203b
    RET                                 ; 0041203c
    PUSH 0x599f70                       ; 0041203d | DAT_00599f70
        ;   Label: LAB_0041203d
    PUSH EBX                            ; 00412042
