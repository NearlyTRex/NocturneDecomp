...
;                               FUNCTION
; *****************************************************************************
; void core_stairs_cpp_FUN_005348c0(int param_1)
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 005348c0
        ;   Label: core_stairs.cpp_FUN_005348c0
    ...
    PUSH EAX                            ; 00534901
    CALL core_actor.cpp_archiveFloat_FUN_0040c880 ; 00534902
        ;   XREF to: 0040c880 (UNCONDITIONAL_CALL)  ; undefined core_actor.cpp_archiveFloat_FUN_0040c880()
    ADD ESP,0x8                         ; 00534907
    PUSH 0x595191                       ; 0053490a | = "count"
    LEA EAX,[EBX + 0x164]               ; 0053490f
    PUSH EAX                            ; 00534915
    CALL core_actor.cpp_archiveInteger_FUN_0040c900 ; 00534916
    ...
    PUSH EBX                            ; 00534929
    CALL core_actor.cpp_archiveInteger_FUN_0040c900 ; 0053492a
        ;   XREF to: 0040c900 (UNCONDITIONAL_CALL)  ; undefined core_actor.cpp_archiveInteger_FUN_0040c900()
