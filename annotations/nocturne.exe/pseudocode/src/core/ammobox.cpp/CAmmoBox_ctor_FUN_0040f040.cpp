// Name: core_ammobox.cpp_CAmmoBox_ctor_FUN_0040f040
// Address: 0040f040
// Address Range: [[0040f040, 0040f0ef]]
// Convention: __cdecl
// Signature: CAmmoBox * __cdecl core_ammobox_cpp_CAmmoBox_ctor_FUN_0040f040(CAmmoBox *this_ptr)
...

{
  ...
  *(byte *)(this_ptr_00[1].part_visibility_flags + 0x15) = 0;
  ...
  return (CAmmoBox *)(this_ptr_00[-1].part_visibility_flags + 0xb);
}
