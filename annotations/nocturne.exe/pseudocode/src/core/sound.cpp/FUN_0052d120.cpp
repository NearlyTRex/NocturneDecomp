...
// Convention: unknown
// Signature: undefined4 FUN_0052d120(undefined4 param_1,char *param_2,float param_3,float param_4,float param_5,float *param_6)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_0052d120(uint param_1,char *param_2,float param_3,float param_4,float param_5,float *param_6)
  ...
  if ((param_2 != (char *)0x0) && (*param_2 != '\0')) {
    ...
    while ((((cVar4 != '\0' && (((&DAT_005c168c)[(byte)(*local_14 + 1)] & 2) == 0)) &&
      ...
      if (cVar4 == '[') {
        ...
        iVar1 = FUN_00563c90(pcVar6);
        pcVar5 = pcVar6 + iVar1;
        if (9 < local_2c) {
          iVar1 = FUN_00563c90(pcVar5);
          pcVar5 = pcVar5 + iVar1;
        }
...
LAB_0052d202:
    if (pcVar5 == (char *)0x0) {
      ...
      local_28 = FUN_0050d1c0(0x01E57284,&local_44);
      local_1c = local_28;
      local_18 = local_28 + 5;
      do {
        iVar1 = local_1c;
    ...
    FUN_00526340();
    if (param_6 == (float *)0x0) {
      FUN_00525f50((double)param_3,(double)param_4,(double)param_5);
    }
    else {
      FUN_00525fc0();
    }
