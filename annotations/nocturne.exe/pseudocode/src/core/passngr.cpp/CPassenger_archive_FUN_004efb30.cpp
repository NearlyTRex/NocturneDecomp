...

{
  ...
  core_actor_cpp_archiveString_FUN_0040c6d0((char *)(param_1 + 0x1f570),"transformEvent");
  core_actor_cpp_archiveString_FUN_0040c6d0((char *)(param_1 + 0x1f5d4),"wolfModelName");
  core_actor_cpp_archiveFloat_FUN_0040c880((float *)(param_1 + 0x202a8),"morphTime");
  ...
  if (2 < INT_005be078) {
    core_actor_cpp_archiveFloat_FUN_0040c880((float *)(param_1 + 0x202ac),"wolfSize");
  }
  if (3 < INT_005be078) {
    core_actor_cpp_archiveString_FUN_0040c6d0((char *)(param_1 + 0x1f5f4),"nameOfWolf");
  }
  if (INT_005be078 < 6) {
    return;
  }
  core_actor_cpp_archiveString_FUN_0040c6d0((char *)(param_1 + 0x1f614),"transformWav");
  return;
}
