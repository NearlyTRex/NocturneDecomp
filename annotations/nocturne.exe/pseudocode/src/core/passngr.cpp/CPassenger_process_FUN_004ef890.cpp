...
// Convention: unknown
// Signature: void core_passngr_cpp_CPassenger_process_FUN_004ef890(int param_1,float param_2)
...

{
  ...
  if ((iVar3 == 1) || (iVar3 == 2)) {
    ...
    iVar4 = core_event_cpp_CEventList_evaluateCondition_FUN_0047dc30(0x01C03A10,param_1 + 0x1f570)
    ;
    if (iVar4 != 0) {
  ...
  *(uint *)(param_1 + 0x23a4) = *(uint *)(param_1 + 0x23a8);
  while (0.0 < local_20) {
    uVar5 = core_motion_cpp_CMotionController_advance_FUN_004e11c0(param_1 + 0x150,&local_20);
  ...
  if (iVar3 != 0) {
    pfVar6 = (float *)core_actor_cpp_CDemonActor_transformVector_FUN_0040a200
                                (param_1,local_1c,param_1 + 0x23a4);
