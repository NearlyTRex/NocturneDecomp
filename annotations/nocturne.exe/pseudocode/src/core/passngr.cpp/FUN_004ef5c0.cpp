...
// Convention: unknown
// Signature: int core_passngr_cpp_FUN_004ef5c0(int param_1,byte param_2)
...

{
  ...
  if ((param_2 & 4) != 0) {
    uVar2 = __vec_delete(param_1,&g_CPassengerTypeInfo_005a11b0);
    shape_memdbg_cpp_free_FUN_00564486(uVar2);
    return param_1;
  }
  iVar1 = *(int *)(param_1 + 0x1f678);
  *(byte ***)(param_1 + 0x14c) = &PTR_core_passngr_cpp_CPassenger_setup_FUN_004ef6d0_005a1074;
  if (iVar1 != 0) {
    (**(code **)(*(int *)(iVar1 + 0x14c) + 200))(iVar1,2);
  }
  iVar1 = core_morph_cpp_CMorph_dtor_FUN_004e0070(param_1 + 0x1f67c,0);
  iVar1 = core_path_cpp_CPathMap_dtor_FUN_004efdd0(iVar1 + -0x139f0,0);
