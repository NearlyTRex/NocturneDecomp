...
// Convention: __cdecl
// Signature: CMobster * __cdecl core_mobster_cpp_CMobster_dtor_FUN_004dcac0(CMobster *this_ptr,uint flags)
...

{
  ...
  if ((flags & 4) != 0) {
    ptr_00 = __vec_delete(this_ptr,&g_CMobsterTypeInfo_005a0a80);
