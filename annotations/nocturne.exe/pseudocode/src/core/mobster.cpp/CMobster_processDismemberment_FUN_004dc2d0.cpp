// Name: core_mobster.cpp_CMobster_processDismemberment_FUN_004dc2d0
// Address: 004dc2d0
// Address Range: [[004dc2d0, 004dc68b]]
// Convention: __cdecl
// Signature: void __cdecl core_mobster_cpp_CMobster_processDismemberment_FUN_004dc2d0(int param_1,int *param_2)
...
LAB_004dc363:
  ...
  iVar2 = core_actor_cpp_randomChance_FUN_0040dea0(local_1c);
  if (iVar2 != 0) {
    uVar4 = core_bodypart_cpp_createBodyPart_FUN_00415b30
                      (param_1 + 0x20,param_1 + 0x30,param_2 + 3,param_1,0,0,0);
    core_charactr_cpp_CCharacter_dismemberPartInternal_FUN_00427eb0(param_1,uVar4,*param_2,0);
    if (*param_2 == *(int *)(param_1 + 0xbdc8)) {
      core_charactr_cpp_CCharacter_dismemberPartInternal_FUN_00427eb0
                (param_1,uVar4,*(uint *)(param_1 + 0xbdcc),0);
    }
    if (*(int *)(param_1 + 0xbdd0) == *param_2) {
      core_charactr_cpp_CCharacter_dismemberPartInternal_FUN_00427eb0
                (param_1,uVar4,*(uint *)(param_1 + 0xbdd4),0);
    }
    if (*(int *)(param_1 + 0xbdec) == *param_2) {
      piVar1 = param_2 + 3;
      core_charactr_cpp_CCharacter_detachBodyPart_FUN_00427e40
                (param_1,*(uint *)(param_1 + 0xbdd0),piVar1,0);
      core_charactr_cpp_CCharacter_detachBodyPart_FUN_00427e40
                (param_1,*(uint *)(param_1 + 0xbdd4),piVar1,0);
      core_charactr_cpp_CCharacter_detachBodyPart_FUN_00427e40
                (param_1,*(uint *)(param_1 + 0xbdc8),piVar1,0);
      core_charactr_cpp_CCharacter_detachBodyPart_FUN_00427e40
                (param_1,*(uint *)(param_1 + 0xbdcc),piVar1,0);
      core_charactr_cpp_CCharacter_detachBodyPart_FUN_00427e40
                (param_1,*(uint *)(param_1 + 0xbdf0),piVar1,0);
    ...
    core_bodypart_cpp_CBodyPart_finalizeGeometry_FUN_00416d40(uVar4);
