...
// Convention: unknown
// Signature: void core_mobster_cpp_FUN_004da790(int param_1,float param_2)
  ...
  if (iVar5 == 0) {
      ...
      if (*(int *)(param_1 + 0xbd50) == 0) {
        ...
        if (*(int *)(param_1 + 0xbd48) == 0) {
          ...
          if (local_20 < 3.0f + 1.0) {
            ...
            if ((ABS(local_14) < (float)0.52359877558333301) && (*(float *)(param_1 + 0xbca0) <= 0.0)) {
        ...
        if (*(float *)(param_1 + 0xbdf4) <= (float)0.5) break;
          ...
          if (-1 < iVar4) {
            ...
            if ((local_30 <= local_24) && (*(float *)(param_1 + 0xbca0) <= 0.0)) {
              if (*(int *)(param_1 + 0x24f0) == 0) {
                ...
                if (((float)0.5 < *(float *)(param_1 + 0xbdf4)) &&
    ...
    case 6:
      ...
      if (*(int *)(param_1 + 0xbca4) != 0) {
        ...
        iVar4 = core_actor_cpp_castToClassHash_FUN_0040d890
                          (*(uint *)(param_1 + 0x24ac),g_CWeaponActorType_02ddf970.name_hash);
        local_2c = iVar4;
        if (iVar4 != 0) {
          core_setcolid_cpp_CDemonSet_init_FUN_00511750(0x01E57284);
      ...
      if ((*(float *)(param_1 + 0xbdf4) < (float)0.5) ||
         (*(float *)(param_1 + 0xbdf8) <= 0.0)) {
        if (*(int *)(param_1 + 0xbd50) == 0) {
          uVar7 = 0x40800000;
          uVar6 = 0x40000000;
    ...
    case 5:
      if ((*(int *)(param_1 + 0xbc90) == 0) && (*(int *)(param_1 + 0xdc) == 0)) {
        ...
        core_gore_cpp_FUN_004b0480(INT_005b96c4,local_c4,0);
