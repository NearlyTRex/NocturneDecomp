        ...
        if (this_ptr->disable_directional_lighting == 0) {
          if (vertex_normals == (CVector3i *)0x0) {
            if (tri_count == 0) {
              ...
              if (0 < vertex_count) {
                do {
                  local_11c = *(uint *)((int)&DAT_005c5014 + iVar5);
                  local_118 = *(uint *)((int)&DAT_005c5018 + iVar5);
                  local_114 = *(uint *)((int)&DAT_005c501c + iVar5);
                  core_dcamera_cpp_CDemonCamera_screenToWorldWithAlpha_FUN_00441440
                            (&g_CDemonCamera_01fb8508,&local_11c);
              ...
              if (0 < vertex_count) {
                ...
                local_68 = iVar8;
                do {
                  auStack_13c[2] = *(uint *)((int)&DAT_005c5014 + iVar5);
                  auStack_13c[3] = *(uint *)((int)&DAT_005c5018 + iVar5);
                  local_12c = *(uint *)((int)&DAT_005c501c + iVar5);
                  core_dcamera_cpp_CDemonCamera_screenToWorldWithAlpha_FUN_00441440
                            (&g_CDemonCamera_01fb8508,auStack_13c + 2);
              ...
              if (vertices_per_face < 1) {
                ...
                if (0 < tri_count) {
                  ...
                  do {
                    ...
                    iVar15 = local_94 * 0xc;
                    iVar8 = *(int *)(iVar15 + 0x200b130) - *(int *)(iVar10 + 0x200b130);
                ...
                if (0 < tri_count) {
                  do {
                    ...
                    iVar15 = *(int *)(iVar10 + 0x200b130) - *(int *)(iVar6 + 0x200b130);
                    ...
                    fVar4 = (float)iVar15 * fVar2 - (float)local_20 * local_bc;
                ...
                if (0 < tri_count) {
                  do {
                    ...
                    *(float *)(&DAT_02045ab0 + iVar8) = *pfVar16 + *(float *)(&DAT_02045ab0 + iVar8)
                    ;
                    *(float *)(&DAT_02045ab4 + iVar8) =
                    ...
                    *(float *)(&DAT_02045ab8 + iVar8) =
                    ...
                    if (*(int *)((int)face_data + 4) == 4) {
                      ...
                      *(float *)(&DAT_02045ab0 + iVar8) =
                           *pfVar16 + *(float *)(&DAT_02045ab0 + iVar8);
                      *(float *)(&DAT_02045ab4 + iVar8) =
                           *(float *)((int)face_data + 0xc) + *(float *)(&DAT_02045ab4 + iVar8);
                      *(float *)(&DAT_02045ab8 + iVar8) =
                           *(float *)((int)face_data + 0x10) + *(float *)(&DAT_02045ab8 + iVar8);
            ...
            if (this_ptr->rendering_mode == 0) {
              if (0 < vertex_count) {
                ...
                do {
                  ...
                  core_dcamera_cpp_CDemonCamera_screenToWorldWithAlpha_FUN_00441440
                            (&g_CDemonCamera_01fb8508,&local_110);
                  iVar5 = iVar5 + 0x30;
              ...
              if (0 < vertex_count) {
                ...
                do {
                  ...
                  *(uint *)(&DAT_02045ab4 + (uint)bVar17 * -8 + iVar5 * 0xc) =
                       *(uint *)((int)&local_170 + (uint)bVar17 * -8 + 4);
                  *(uint *)
                   ((int)(&DAT_02045ab4 + (uint)bVar17 * -8 + iVar5 * 0xc) +
                   ((uint)bVar17 * -2 + 1) * 4) =
              ...
              if (0 < vertex_count) {
                do {
                  ...
                  *(uint *)(&DAT_02045ab4 + (uint)bVar17 * -8 + iVar5 * 0xc) = *puVar12;
                  *(uint *)
                   ((int)(&DAT_02045ab4 + (uint)bVar17 * -8 + iVar5 * 0xc) +
          ...
          do {
            ...
            core_dcamera_cpp_CDemonCamera_screenToWorldWithAlpha_FUN_00441440
                      (&g_CDemonCamera_01fb8508,&local_164);
