...
// Convention: unknown
// Signature: int FUN_0050c2d0(int param_1,int param_2,int param_3,ushort *param_4,int param_5,int param_6,undefined4 *param_7)
...
int FUN_0050c2d0(int param_1,int param_2,int param_3,ushort *param_4,int param_5,int param_6,uint *param_7)

{
  ...
  iVar5 = FUN_00461090(DAT_005ae704);
  if (iVar5 == 0) {
        ...
        if (*(int *)(param_1 + 0x15a8a0) == 0) {
          if (param_7 == (uint *)0x0) {
            if (param_3 == 0) {
              ...
              if (0 < param_2) {
                do {
                  ...
                  *(uint *)(&stack0xffffff28 + (uint)bVar15 * -8 + (uint)bVar15 * -8) =
                  ...
                  FUN_0050b7f0(param_1,&stack0xffffff20,0,local_34,0);
              ...
              if (param_6 < 1) {
                ...
                FUN_00563cc0(&DAT_02045ab0,0,param_2 * 0xc);
                iVar8 = 0;
                if (0 < param_3) {
                  pfVar14 = (float *)&DAT_01fff5b0;
                  do {
              ...
              if (*(int *)(param_1 + 0x15aa9c) == 0) {
                if (0 < param_2) {
                  ...
                  do {
                    ...
                    *pfVar14 = *pfVar14 * fVar1;
                    ...
                    pfVar14 = pfVar14 + 3;
                    iVar9 = iVar5 + 1;
                    FUN_0050b7f0(param_1,local_54,&stack0xfffffed8,iVar5,0);
                    iVar6 = _DAT_01c038f4;
                    local_54 = iVar8 + 0xc;
                ...
                if (0 < param_2) {
                  ...
                  do {
                    ...
                    FUN_0050b7f0(param_1,iVar5,piVar16,local_30,0);
                    iVar5 = _DAT_01c038f4;
                    pfVar14 = pfVar14 + 3;
                    local_30 = local_30 + 1;
            ...
            if (0 < param_2) {
              ...
              do {
                iVar6 = iVar5 + 1;
                FUN_0050b7f0(param_1,local_64,puVar11,iVar5,0);
                *(int *)((int)&DAT_005c5040 + iVar8) = _DAT_01c038f4;
                puVar11 = puVar11 + 0xc;
          ...
          do {
            ...
            *(uint *)(&stack0xffffff1c + (uint)bVar15 * -8 + (uint)bVar15 * -8) =
            ...
            FUN_0050b7f0(param_1,&stack0xffffff14,0,local_38,0);
          ...
          if (0 < param_2) {
            ...
            do {
              *(uint *)((int)&DAT_005c5040 + iVar8) = 0;
              iVar6 = FUN_0050b7f0(param_1,param_5,0,iVar5,1);
              iVar5 = iVar5 + 1;
              param_5 = param_5 + 0xc;
              iVar8 = iVar8 + 0x30;
            } while (iVar5 < param_2);
