...
section .text
    ...
    CALL core_dlight.cpp_captureLightTextures_FUN_004504e0 ; 0050d280
        ;   XREF to: 004504e0 (UNCONDITIONAL_CALL)  ; undefined core_dlight.cpp_captureLightTextures_FUN_004504e0()
    ...
    CALL core_water.cpp_CWater_captureTextures_FUN_005507d0 ; 0050d28c
        ;   XREF to: 005507d0 (UNCONDITIONAL_CALL)  ; undefined core_water.cpp_CWater_captureTextures_FUN_005507d0()
