...
// Convention: unknown
// Signature: int FUN_005088f0(int *param_1,int param_2)
...

{
  ...
  iVar5 = 0;
  FUN_004474e0(0x1fb8508,param_1 + 0x56a1b);
  _DAT_01fba938 = 0;
  piVar4 = param_1;
  if (0 < param_1[0x5335b]) {
    do {
      iVar5 = iVar5 + 1;
      FUN_00508890(param_1,piVar4[0x5335c]);
      piVar4 = piVar4 + 1;
    } while (iVar5 < param_1[0x5335b]);
  }
  FUN_00440290(0x1fb8508,0);
  FUN_00440b20(0x1fb8508);
  FUN_0050d2d0(param_1,0x10);
  FUN_00507c80(param_1,0x461c3f9a,1);
  ...
  FUN_00563c90(local_f0,"%s.raw",param_1 + param_2 * 0x68 + 1);
  FUN_00443250(0x1fb8508,local_f0);
  FUN_00508750(param_1,1);
  ...
  if (param_1[0x56a27] == 0) {
    ...
    if (0 < _DAT_01fb9b54) {
      ...
      do {
        ...
        FUN_0044e3c0(uVar1);
        FUN_0044e470(uVar1,1);
        FUN_0044e830(uVar1);
        FUN_00508750(param_1,1);
        FUN_0044e920(uVar1);
        FUN_0044e720(uVar1,0);
        FUN_0044e970(uVar1);
        FUN_00441c50(0x1fb8508,uVar1,iVar3);
        iVar5 = iVar5 + 1;
        iVar3 = iVar3 + 0x10;
        local_18 = local_18 + 4;
      } while (iVar5 < _DAT_01fb9b54);
  ...
  if (param_1[0x58490] != 0) {
    FUN_00463580(0x01B7B4E8,param_1 + 0x58491,param_1[0x58499]);
  }
  FUN_00508750(param_1,1);
  ...
  puVar2 = (uint *)FUN_0044dbd0(local_78,local_50);
  if (&local_38 != puVar2) {
    local_38 = *puVar2;
    local_34 = puVar2[1];
    local_30 = puVar2[2];
  ...
  iVar3 = 0;
  FUN_005557d0(0x02DDF9F0,&local_44,&local_38);
  iVar5 = param_1[0x5335b];
  piVar4 = param_1;
  if (0 < iVar5) {
    do {
      iVar3 = iVar3 + 1;
      iVar5 = FUN_00508890(param_1,piVar4[0x5335c]);
      piVar4 = piVar4 + 1;
