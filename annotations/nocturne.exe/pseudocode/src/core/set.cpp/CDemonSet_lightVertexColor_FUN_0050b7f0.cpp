...
// Convention: unknown
// Signature: void core_set_cpp_CDemonSet_lightVertexColor_FUN_0050b7f0(int param_1,undefined4 param_2,int *param_3,int param_4,int param_5)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void core_set_cpp_CDemonSet_lightVertexColor_FUN_0050b7f0(int param_1,uint param_2,int *param_3,int param_4,int param_5)

{
  ...
  if (param_5 == 0) {
    iVar8 = core_set_cpp_CDemonSet_calculateSpatialLighting_FUN_0050b5c0(param_1,param_2,param_3);
  ...
  if ((*(int *)(param_1 + 0x15f2f8) != 0) && (param_5 == 0)) {
    iVar8 = core_set_cpp_CDemonSet_calculateSpatialLighting_FUN_0050b5c0(param_1,param_2,0);
