...
section .text
    ...
    PUSH EBX                            ; 0050df40
        ;   Label: core_set.cpp_CDemonSet_renderPrimitiveList_FUN_0050df40
    PUSH ESI                            ; 0050df41
    PUSH EDI                            ; 0050df42
    PUSH EBP                            ; 0050df43
    ...
    CMP dword ptr [EBX + 0x1f0],0x0     ; 0050df56 | g_CGame_01c775ec.suppress_set_geometry
    ...
    CMP dword ptr [0x01c02594],0x0      ; 0050df90 | g_UseExternalRenderer
        ;   Label: LAB_0050df90
    ...
    CMP dword ptr [0x01c02594],0x0      ; 0050dfbe | g_UseExternalRenderer
