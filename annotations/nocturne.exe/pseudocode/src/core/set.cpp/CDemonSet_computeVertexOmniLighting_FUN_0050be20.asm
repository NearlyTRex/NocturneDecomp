...
;   core_wateract.cpp_CWaterActor_renderTransparent_FUN_00551c00 at 00551d41
;
; Referenced Globals:
...
section .text
    ...
    MOV ESI,dword ptr [0x01c7070c]      ; 0050be2b | g_FastSqrtMagic
    ...
    MOV dword ptr [0x01c7070c],ESI      ; 0050bf41 | g_FastSqrtMagic
