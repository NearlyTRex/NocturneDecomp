...
section .text
    ...
    CALL FUN_0043ff50                   ; 00508515
        ;   XREF to: 0043ff50 (UNCONDITIONAL_CALL)  ; undefined FUN_0043ff50()
    ADD ESP,0x4                         ; 0050851a
    LEA ESI,[EBX + 0x15a848]            ; 0050851d
    PUSH ESI                            ; 00508523
    PUSH 0x1fb8508                      ; 00508524
    MOV EDI,ESI                         ; 00508529
    CALL FUN_004474e0                   ; 0050852b
    ...
    MOV dword ptr [0x01cc4800],EBP      ; 005085a4 | DAT_01cc4800
    MOV [0x01cc4804],EAX                ; 005085aa | DAT_01cc4804
    CALL FUN_004c8440                   ; 005085af
    ...
    ADD EBP,dword ptr [ESP]             ; 005086ee
        ;   Label: LAB_005086ee
    PUSH EBP                            ; 005086f1
    CALL FUN_005151f0                   ; 005086f2
        ;   XREF to: 005151f0 (UNCONDITIONAL_CALL)  ; undefined FUN_005151f0()
    ...
    CALL FUN_00515350                   ; 00508709
        ;   XREF to: 00515350 (UNCONDITIONAL_CALL)  ; undefined FUN_00515350()
    ...
    MOV dword ptr [0x01cc4800],EBP      ; 00508736 | DAT_01cc4800
    MOV [0x01cc4804],EAX                ; 0050873c | DAT_01cc4804
    CALL FUN_004c8440                   ; 00508741
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; undefined FUN_004c8440()
