...
section .text
    ...
    PUSH EBX                            ; 0050dfe0
        ;   Label: core_set.cpp_FUN_0050dfe0
    PUSH ESI                            ; 0050dfe1
    PUSH EDI                            ; 0050dfe2
    PUSH EBP                            ; 0050dfe3
    ...
    PUSH EAX                            ; 0050e01b
    INC EBX                             ; 0050e01c
    CALL core_mirror.cpp_FUN_004d7760   ; 0050e01d
        ;   XREF to: 004d7760 (UNCONDITIONAL_CALL)  ; undefined core_mirror.cpp_FUN_004d7760()
