...
// Convention: unknown
// Signature: void core_set_cpp_FUN_0050a260(CDemonSet *param_1)
...

{
  ...
  this_ptr = *(CDemonActor **)(_DAT_01cae0e8 * 4 + 0x1cae0d8);
  local_14 = (CDemonLight *)&DAT_01c74640;
  this_ptr_01 = core_skeleton_cpp_CDeformableModelInstance_getSkeletonPtr_FUN_0051e0a0
                          ((CDeformableModelInstance *)(this_ptr + 1));
  iVar4 = core_skeleton_cpp_CSkeleton_findBone_FUN_005179d0(this_ptr_01,"Bip01 Head",0);
  local_44.y = 0.338;
  local_44.x = 0.0;
  local_44.z = 0.75;
  input_local_point =
       core_xform_cpp_transformVector3x4_FUN_0055a8b0
                 (&local_50,&local_44,
                  (CMatrix3x4f *)(this_ptr[0xc].actor_name + iVar4 * 0x30 + 0x10));
  core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240(this_ptr,&local_2c,input_local_point);
  core_xform_cpp_matrixToEulerAngles_FUN_0055b180
            ((CMatrix3x4f *)(this_ptr[0xc].actor_name + iVar4 * 0x30 + 0x10),&local_38);
  local_20.z = 0.0;
  local_20.x = local_38.x + (float)0.261799387791667;
  _DAT_01c762fc = 0;
  local_20.y = local_38.y + (this_ptr->orient).vec.y;
  ...
  if (*(int *)(0x01C775EC + 0x218) == 0) {
    ...
    core_dlight_cpp_CDemonLight_clearCircularShadowMapEdges_FUN_0044efb0(this_ptr_00);
    DAT_005be378 = 0;
    core_set_cpp_CDemonSet_renderSceneGeometry_FUN_00507c80
              (param_1,*(float *)((this_ptr_00->base).camera_name + 0xc0),0);
    DAT_005be378 = 1;
    ...
    pCVar6 = param_1;
    if (0 < (int)param_1->vdir_boxes[0xec].rotation_matrix.m[2].z) {
      do {
      ...
      } while (iVar4 < (int)param_1->vdir_boxes[0xec].rotation_matrix.m[2].z);
    }
    ...
    local_5c = (int)ROUND(local_2c.x * _DAT_005a18f0);
    local_58 = (int)ROUND(local_2c.y * _DAT_005a18f0);
    local_54 = (int)ROUND(local_2c.z * _DAT_005a18f0);
    core_set_cpp_CDemonSet_setLightingParameters_FUN_0050adc0
              (param_1,(CVector3f *)0x0,(UOrientationVector *)0x0,(CVector3f *)0x0,(CVector3f *)0x0,
               (CMatrix3x3f *)0x0);
    iVar4 = core_set_cpp_CDemonSet_calculateSpatialLighting_FUN_0050b5c0(param_1,&local_5c,0);
