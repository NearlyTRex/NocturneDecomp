...

{
  ...
  pSVar1 = core_set_cpp_SVDBox_arrdtor250_FUN_0050eb60(this_ptr->vdir_boxes,0);
  pSVar2 = core_set_cpp_SRoom_arrdtor20_FUN_0050eb40((SRoom *)&pSVar1[-0x15].parent_index,0);
  pCVar3 = core_set_cpp_C3DSLight_arrdtor200_FUN_0050eb20((C3DSLight *)&pSVar2[-0x4b99].extents.z,0)
  ;
  pCVar4 = core_set_cpp_C3DSCamera_arrdtor250_FUN_0050eb00
                     ((C3DSCamera *)(pCVar3[-0x11].camera_light_bounds + 0x9b),0);
