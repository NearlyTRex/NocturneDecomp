// Name: core_set.cpp_FUN_0050bcf0
// Address: 0050bcf0
// Address Range: [[0050bcf0, 0050be1e]]
// Convention: unknown
// Signature: void core_set_cpp_FUN_0050bcf0(int param_1,ushort *param_2,float *param_3)
...

{
  ...
  fVar3 = (float)((int)CVector3f_01c70708.z -
                 ((int)(fVar4 * fVar4 + fVar5 * fVar5 + fVar2 * fVar2) >> 1)) * (float)_DAT_00590642
  ;
  *param_3 = fVar2 * fVar3;
