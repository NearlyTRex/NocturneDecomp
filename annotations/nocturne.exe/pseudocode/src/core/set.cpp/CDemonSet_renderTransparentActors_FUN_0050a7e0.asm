...
;
; XREF[1]:
;   core_set.cpp_CDemonSet_renderScene_FUN_00509a80 at 00509dc6
;
; Referenced Globals:
...
section .text
    ...
    PUSH 0x1                            ; 0050a8dd
        ;   Label: LAB_0050a8dd
    MOV ECX,dword ptr [0x005ae704]      ; 0050a8df | g_CDemonRenderer_PTR_005ae704
    ...
    PUSH ESI                            ; 0050a8fc
    PUSH EDI                            ; 0050a8fd
    CALL core_set.cpp_CDemonSet_setupMirrorRendering_FUN_0050e080 ; 0050a8fe
    ...
    PUSH 0x1                            ; 0050a91e
        ;   Label: LAB_0050a91e
    MOV EDX,dword ptr [0x005ae704]      ; 0050a920 | g_CDemonRenderer_PTR_005ae704
