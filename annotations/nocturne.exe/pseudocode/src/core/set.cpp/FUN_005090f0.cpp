...

{
  ...
  core_dcamera_cpp_FUN_004401b0(&g_CDemonCamera_01fb8508,param_2,param_3);
  core_set_cpp_CDemonSet_setCameraView_FUN_005088f0(param_1,param_1->selected_camera_index);
  return;
}
