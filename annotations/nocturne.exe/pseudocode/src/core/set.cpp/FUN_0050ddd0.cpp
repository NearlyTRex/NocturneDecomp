...
// Convention: unknown
// Signature: void core_set_cpp_FUN_0050ddd0(int param_1,int param_2,int param_3,undefined4 param_4)

#include "nocturne.h"

void core_set_cpp_FUN_0050ddd0(int param_1,int param_2,int param_3,uint param_4)
    ...
    if ((*(int *)(param_1 + 0x15a890) != 0) && (iVar2 = 0, iVar1 = param_2, 0 < param_3)) {
      do {
        ...
        engine_drender_cpp_CDemonRenderer_renderCustomScanline_FUN_00460e80
                  (DAT_005ae704,local_38,core_dcamera_cpp_FUN_00444440);
      } while (iVar2 < param_3);
    }
