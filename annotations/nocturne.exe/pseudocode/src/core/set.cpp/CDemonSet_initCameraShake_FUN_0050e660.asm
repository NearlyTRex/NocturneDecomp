...
; float            Stack[0x8]:4   peak
; float            Stack[0xc]:4   attack
; float            Stack[0x10]:4   sustain
; float            Stack[0x14]:4   decay
; Local Variables:
...
section .text
    ...
    PUSH dword ptr [ESP + 0x14]         ; 0050e660
        ;   Label: core_set.cpp_CDemonSet_initCameraShake_FUN_0050e660
    ...
    MOV EDX,dword ptr [0x005b9284]      ; 0050e68f | g_CForceFeedback_PTR_005b9284
    PUSH 0x3f800000                     ; 0050e695
    PUSH EDX                            ; 0050e69a
    CALL engine_force.cpp_CForceFeedback_processEvent_FUN_004940d0 ; 0050e69b
