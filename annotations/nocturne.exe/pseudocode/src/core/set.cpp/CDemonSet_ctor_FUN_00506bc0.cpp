...
// Convention: __cdecl
// Signature: CDemonSet * __cdecl core_set_cpp_CDemonSet_ctor_FUN_00506bc0(CDemonSet *this_ptr)
...

{
  ...
  pvVar2 = __arrinit
                     (this_ptr->cameras,0xfa,&g_C3DSCameraTypeInfo_005a1970);
  pvVar2 = __arrinit
                     ((void *)((int)pvVar2 + 0x19644),200,&g_C3DSLightTypeInfo_005a1990);
  pvVar2 = __arrinit
                     ((void *)((int)pvVar2 + 0x141490),0x14,&g_SRoomTypeInfo_005a19b0);
  pvVar2 = __arrinit
                     ((void *)((int)pvVar2 + 0x554),0xfa,&g_SVDBoxTypeInfo_005a19d0);
  this_ptr_00 = (CDemonSet *)((int)pvVar2 + -0x15b02c);
