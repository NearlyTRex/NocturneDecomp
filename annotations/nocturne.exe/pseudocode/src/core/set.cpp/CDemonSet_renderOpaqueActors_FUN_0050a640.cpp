...
// Convention: __cdecl
// Signature: void __cdecl core_set_cpp_CDemonSet_renderOpaqueActors_FUN_0050a640(CDemonSet *this_ptr)
...

{
  ...
  if (-1 < iVar6) {
    ...
    do {
      ...
      if (*(int *)(iVar2 + 0xf8) == 0) {
        *(byte *)(iVar2 + 0x140) = *(byte *)(iVar2 + 0x140) & 0xfb;
      }
      else {
        ...
        iVar4 = (**(code **)(*(int *)(iVar2 + 0x14c) + 8))(iVar2);
        if (iVar4 == 0) {
          *(byte *)(iVar2 + 0x140) = *(byte *)(iVar2 + 0x140) & 0xfb;
        }
        else {
          *(byte *)(iVar2 + 0x140) = *(byte *)(iVar2 + 0x140) | 4;
        }
        ...
        if (0 < (int)this_ptr->renderable_actors[0x6f7]) {
          do {
            ...
            iVar5 = (**(code **)(*(int *)(iVar2 + 0x14c) + 8))(iVar2);
            if (iVar5 != 0) {
              *(byte *)(iVar2 + 0x140) = *(byte *)(iVar2 + 0x140) | 4;
            }
            engine_drender_cpp_CDemonRenderer_enableFaceCapture_FUN_00461050(DAT_005ae704,1);
