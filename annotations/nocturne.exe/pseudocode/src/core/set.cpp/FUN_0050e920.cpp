...
// Convention: unknown
// Signature: void FUN_0050e920(int *param_1,undefined4 param_2)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_0050e920(int *param_1,uint param_2)

{
  ...
  FUN_00563350(param_2,&DAT_005908ca,&local_1c);
  if (local_1c != 1) {
  ...
  FUN_00563350(param_2,"%*[^\n]\n");
  FUN_00563350(param_2,&DAT_0059090f,&local_18);
  if (*param_1 != local_18) {
  ...
  if (0 < local_18) {
    do {
      FUN_00563350(param_2,&DAT_00590979,&local_14);
      if (iVar1 < *param_1) {
