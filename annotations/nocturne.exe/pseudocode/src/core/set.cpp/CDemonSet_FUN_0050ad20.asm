...
;   core_set.cpp_CDemonSet_precomputeLightVisibility_FUN_00507f80 at 00508496
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0050ad20
        ;   Label: core_set.cpp_CDemonSet_FUN_0050ad20
    PUSH ESI                            ; 0050ad21
    PUSH EDI                            ; 0050ad22
    PUSH EBP                            ; 0050ad23
    ...
    PUSH EAX                            ; 0050adb2
    CALL crt_memory.c_operator_delete_FUN_00564494 ; 0050adb3
