...
;   core_curtain.cpp_CCurtain_renderMesh_FUN_0043f330 at 0043f53a
...
section .text
    ...
    PUSH EBX                            ; 0050ddd0
        ;   Label: core_set.cpp_CDemonSet_renderPrimitiveBatch_FUN_0050ddd0
    PUSH ESI                            ; 0050ddd1
    PUSH EDI                            ; 0050ddd2
    PUSH EBP                            ; 0050ddd3
    ...
    CMP dword ptr [EAX + 0x1f0],0x0     ; 0050dde8 | g_CGame_01c775ec.suppress_set_geometry
    ...
    CALL engine_drender.cpp_CDemonRenderer_isShadowPass_FUN_00461090 ; 0050dea5
