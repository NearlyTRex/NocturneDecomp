...
;
; XREF[5]:
;   FUN_005088f0 at 00508b1f
;   FUN_00509760 at 00509899
...
section .text
    ...
    MOV EAX,[0x01cae0e8]                ; 0050d383 | DAT_01cae0e8
        ;   Label: LAB_0050d383
