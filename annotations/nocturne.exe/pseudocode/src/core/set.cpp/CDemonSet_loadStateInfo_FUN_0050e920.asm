...
;
; XREF[1]:
;   core_game.cpp_CGame_FUN_004a4170 at 004a4a0e
;
; Referenced Globals:
...
section .text
    ...
    MOV dword ptr [0x01cc4800],ECX      ; 0050e9e5 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EBX      ; 0050e9eb | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 0050e9f1
