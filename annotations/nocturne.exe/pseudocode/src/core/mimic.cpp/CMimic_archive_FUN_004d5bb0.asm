...
section .text
    ...
    PUSH 0x5894d6                       ; 004d5c3a | = "motion state"
        ;   Label: LAB_004d5c3a
    PUSH ESI                            ; 004d5c3f
    CALL core_actor.cpp_archiveMotionState_FUN_0040cb00 ; 004d5c40
    ...
    CMP dword ptr [0x005baf48],0x3      ; 004d5c5c | INT_005baf48
