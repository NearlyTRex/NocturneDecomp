// Name: core_mimic.cpp_CMimic_FUN_004d4f30
// Address: 004d4f30
// Address Range: [[004d4f30, 004d5768]]
// Convention: __cdecl
// Signature: void __cdecl core_mimic_cpp_CMimic_FUN_004d4f30(CMimic *this_ptr,float delta_time)
...
void __cdecl core_mimic_cpp_CMimic_FUN_004d4f30(CMimic *this_ptr,float delta_time)
...
LAB_004d4fed:
    ...
    if (-local_118.z <= SQRT(local_d4 * local_d4 + local_dc * local_dc)) {
      ...
      (this_ptr->base).base.walk_step_speed = fVar14 * delta_time * fVar2;
      iVar6 = *(int *)(_DAT_01cae0e8 * 4 + 0x1cae0d8);
      local_e8.x = 0.0;
      local_e8.y = 0.0;
      iVar6 = core_charactr_cpp_CCharacter_walkToPoint_FUN_004247f0
                        ((CCharacter *)this_ptr,(CVector3f *)(iVar6 + 0x20),
...
LAB_004d5024:
  if (0.0 <= local_1c) {
    ...
    (this_ptr->base).base.walk_step_speed = fVar14 * delta_time;
    (this_ptr->base).base.turn_speed = delta_time * fVar1 * fVar14;
    local_64.z = local_1c;
    iVar6 = *(int *)(_DAT_01cae0e8 * 4 + 0x1cae0d8);
    local_64.x = 0.0;
    local_64.y = 0.0;
