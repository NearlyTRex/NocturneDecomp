...
section .text
    ...
    PUSH EBX                            ; 005423c0
        ;   Label: core_svetlana.cpp_CSvetlana_FUN_005423c0
    PUSH ESI                            ; 005423c1
    PUSH EDI                            ; 005423c2
    PUSH EBP                            ; 005423c3
    ...
    PUSH EBX                            ; 005428ab
    CALL core_charactr.cpp_CCharacter_FUN_0042af70 ; 005428ac
    ...
    PUSH dword ptr [EBP + 0x18]         ; 00542a4e
        ;   Label: LAB_00542a4e
    PUSH EBX                            ; 00542a51
    CALL core_charactr.cpp_CCharacter_FUN_0042af70 ; 00542a52
        ;   XREF to: 0042af70 (UNCONDITIONAL_CALL)  ; int core_charactr.cpp_CCharacter_FUN_0042af70(CCharacter * this_ptr, float delta_time)
