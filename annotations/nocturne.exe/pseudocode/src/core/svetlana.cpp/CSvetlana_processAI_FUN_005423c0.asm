...
section .text
    ...
    PUSH EBX                            ; 005423c0
        ;   Label: core_svetlana.cpp_CSvetlana_processAI_FUN_005423c0
    PUSH ESI                            ; 005423c1
    PUSH EDI                            ; 005423c2
    PUSH EBP                            ; 005423c3
    ...
    MOV EDI,dword ptr [0x01cae0e8]      ; 005423e0 | g_LocalHeroIndex
    PUSH ESI                            ; 005423e6
    ...
    MOV EAX,[0x01cae0e8]                ; 00542419 | g_LocalHeroIndex
    ...
    MOV dword ptr [ESP + 0x90],0x41a00000 ; 00542474
        ;   Label: LAB_00542474
    MOV EAX,[0x01cae0e8]                ; 0054247f | g_LocalHeroIndex
    ...
    MOV EAX,[0x01cae0e8]                ; 00542884 | g_LocalHeroIndex
        ;   Label: LAB_00542884
    ...
    PUSH EBX                            ; 005428ab
    CALL core_charactr.cpp_CCharacter_moveOutOfHeroWay_FUN_0042af70 ; 005428ac
        ;   XREF to: 0042af70 (UNCONDITIONAL_CALL)  ; int core_charactr.cpp_CCharacter_moveOutOfHeroWay_FUN_0042af70(CCharacter * this_ptr, float delta_time)
    ...
    MOV EAX,[0x01cae0e8]                ; 00542902 | g_LocalHeroIndex
    ...
    MOV EAX,[0x01cae0e8]                ; 00542925 | g_LocalHeroIndex
    ...
    PUSH dword ptr [EBP + 0x18]         ; 00542a4e
        ;   Label: LAB_00542a4e
    PUSH EBX                            ; 00542a51
    CALL core_charactr.cpp_CCharacter_moveOutOfHeroWay_FUN_0042af70 ; 00542a52
        ;   XREF to: 0042af70 (UNCONDITIONAL_CALL)  ; int core_charactr.cpp_CCharacter_moveOutOfHeroWay_FUN_0042af70(CCharacter * this_ptr, float delta_time)
