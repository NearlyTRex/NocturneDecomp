...

{
  ...
  if (*(int *)(0x01C775EC + 0x18) == 0) {
    pcVar2 = "svetlanax.dfm";
  }
  else {
    pcVar2 = "svetlana.dfm";
  }
  core_skeleton_cpp_CDeformableModelInstance_init_FUN_0051e0c0(param_1 + 0x150,pcVar2);
  ...
  *(uint *)(param_1 + 0x1fa3c) = 0;
  core_cloth_cpp_CCloth_load_FUN_00435240((CCloth *)(param_1 + 0x1fa44),"svetcape.cth");
  core_cloth_cpp_CCloth_setup_FUN_004359e0
            ((CCloth *)(param_1 + 0x1fa44),(CVector3f *)(param_1 + 0x20),
             (CVector3f *)(param_1 + 0x30),this_ptr);
  core_cloth_cpp_CCloth_load_FUN_00435240((CCloth *)(param_1 + 0x5a574),"svethair.cth");
  core_cloth_cpp_CCloth_setup_FUN_004359e0
            ((CCloth *)(param_1 + 0x5a574),(CVector3f *)(param_1 + 0x20),
             (CVector3f *)(param_1 + 0x30),this_ptr);
  ...
  *(int *)(param_1 + 0x950b8) = iVar1;
  iVar1 = core_skeleton_cpp_CDeformableModel_findPartByName_FUN_00519b30
                    (this_ptr_01,"rblade02",1);
  *(uint *)(param_1 + 0x950a4) = 0;
  *(int *)(param_1 + 0x950bc) = iVar1;
  return;
}
