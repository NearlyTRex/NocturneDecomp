...
section .text
    ...
    PUSH EBX                            ; 00541d00
        ;   Label: core_svetlana.cpp_CSvetlana_process_FUN_00541d00
    PUSH ESI                            ; 00541d01
    PUSH EDI                            ; 00541d02
    PUSH EBP                            ; 00541d03
    ...
    CALL core_charactr.cpp_CCharacter_processWalking_FUN_00428c00 ; 00541dde
    ...
    PUSH dword ptr [EBP + 0x18]         ; 00542000
        ;   Label: LAB_00542000
    PUSH EBX                            ; 00542003
    CALL core_charactr.cpp_CCharacter_applyGestureLookAt_FUN_0042a150 ; 00542004
    ...
    PUSH EBX                            ; 005420b3
    CALL core_svetlana.cpp_CSvetlana_processAI_FUN_005423c0 ; 005420b4
        ;   XREF to: 005423c0 (UNCONDITIONAL_CALL)  ; void core_svetlana.cpp_CSvetlana_processAI_FUN_005423c0(CSvetlana * this_ptr, float delta_time)
    ...
    JNZ 0x00542171                      ; 005421eb
        ;   XREF to: 00542171 (CONDITIONAL_JUMP)  ; LAB_00542171
    PUSH EBX                            ; 005421ed
    CALL core_hero.cpp_CHero_tryOpenNearbyDoor_FUN_004b5110 ; 005421ee
