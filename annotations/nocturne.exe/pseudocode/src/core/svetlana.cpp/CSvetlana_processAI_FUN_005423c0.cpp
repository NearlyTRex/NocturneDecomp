// Name: core_svetlana.cpp_CSvetlana_processAI_FUN_005423c0
// Address: 005423c0
// Address Range: [[005423c0, 00542ac8]]
// Convention: __cdecl
// Signature: void __cdecl core_svetlana_cpp_CSvetlana_processAI_FUN_005423c0(CSvetlana *this_ptr,float delta_time)
    ...
    if ((float)6 <= fVar1) {
      ...
      if (bVar3) {
        ...
        iVar5 = (*(((g_HeroActors[g_LocalHeroIndex]->base).base.vtable._uh)->_uh).isWeaponDrawn)
                          (g_HeroActors[g_LocalHeroIndex]);
        if ((iVar5 == 0) &&
           (uVar9 = core_charactr_cpp_CCharacter_moveOutOfHeroWay_FUN_0042af70
