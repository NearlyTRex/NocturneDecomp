// Name: core_batcreat.cpp_FUN_004132c0
// Address: 004132c0
// Address Range: [[004132c0, 00413378]]
// Convention: unknown
// Signature: int core_batcreat_cpp_FUN_004132c0(int param_1,byte param_2)
...

{
  ...
  if ((param_2 & 4) != 0) {
    uVar2 = __vec_delete(param_1,&g_CBatCreatureTypeInfo_0059a110);
