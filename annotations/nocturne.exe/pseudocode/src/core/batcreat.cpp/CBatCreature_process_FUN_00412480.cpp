...
// Convention: unknown
// Signature: void core_batcreat_cpp_CBatCreature_process_FUN_00412480(int param_1,float param_2)
...

{
  ...
  *(uint *)(param_1 + 0x23a4) = *(uint *)(param_1 + 0x23a8);
  ...
  while (0.0 < local_2c) {
    uVar6 = core_motion_cpp_CMotionController_advance_FUN_004e11c0(param_1 + 0x150,&local_2c);
    ...
    case 0:
      ...
      if (local_28 < 3.5f) {
        ...
        if (ABS(local_14) < (float)0.52359877558333301) {
          ...
          iVar3 = sound_sndmain_cpp_isSfxPlaying_FUN_00526c50(*(uint *)(param_1 + 0xbd60));
          if ((iVar3 == 0) &&
             (iVar3 = sound_sndmain_cpp_isSfxPlaying_FUN_00526c50(*(uint *)(param_1 + 0xbd64))
             , iVar3 == 0)) {
...
LAB_0041290b:
      ...
      if ((((*(int *)(param_1 + 0xbd68) == 0) &&
          ...
          (iVar3 = sound_sndmain_cpp_isSfxPlaying_FUN_00526c50(*(uint *)(param_1 + 0xbd64)),
          iVar3 == 0)) &&
         (iVar3 = sound_sndmain_cpp_isSfxPlaying_FUN_00526c50(*(uint *)(param_1 + 0xbd5c)),
         iVar3 == 0)) {
      ...
      if (*(int *)(param_1 + 0xbca4) == 0) {
        ...
        *(uint *)(param_1 + 0x23a4) = *(uint *)(param_1 + 0x23a8);
        ...
        if (-1 < iVar5) {
          ...
          local_18 = local_20;
          if ((10.0f < local_20) && (*(uint *)(param_1 + 0xbca0) = 0, iVar4 == 1)) {
            iVar4 = *(int *)(param_1 + 0xbca4);
            ...
            local_14 = (float)core_actor_cpp_normalizeAngleToPi_FUN_0040df00
                                        (local_d8 - *(float *)(param_1 + 0x34));
            if ((ABS(local_14) < (float)0.52359877558333301) &&
               (ABS(*(float *)(*(int *)(param_1 + 0xbca4) + 0x24) - *(float *)(param_1 + 0x24)) <
                (float)2)) {
              core_motion_cpp_CMotionController_setDesiredState_FUN_004e16b0(iVar3,2,1);
              *(uint *)(param_1 + 0xbca0) = 0;
              iVar3 = sound_sndmain_cpp_isSfxPlaying_FUN_00526c50(*(uint *)(param_1 + 0xbd60))
              ;
              if ((iVar3 == 0) &&
                 (iVar3 = sound_sndmain_cpp_isSfxPlaying_FUN_00526c50
                                    (*(uint *)(param_1 + 0xbd64)), iVar3 == 0)) {
                uVar6 = (**(code **)(*(int *)(param_1 + 0x14c) + 0x24))
                                  (param_1,"batman-attack?.wav");
                *(uint *)(param_1 + 0xbd64) = uVar6;
              }
    ...
    case 3:
      ...
      local_138 = (float)core_actor_cpp_getRandomFloatFromRange_FUN_0040dda0(0x40e00000,0x41700000);
      local_108 = param_1;
      local_104 = param_1;
      local_14 = local_138;
      uVar6 = core_xform_cpp_transformVector3x4_FUN_0055a8b0
                        (local_ac,&DAT_02dd1184,DAT_007645a4 * 0x30 + param_1 + 0xfd0,0x3ecccccd,
                         local_13c);
      uVar6 = core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240(param_1,local_40,uVar6);
    ...
    case 8:
      if ((*(int *)(param_1 + 0xbc90) == 0) && (*(int *)(param_1 + 0xdc) == 0)) {
        uVar6 = core_skeleton_cpp_CDeformableModelInstance_getBoneWorldPosition_FUN_0051d2a0
                          (iVar3,local_4c,0);
        core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240(param_1,local_100,uVar6);
        core_gore_cpp_FUN_004b0480(INT_005b96c4,local_100,0);
...
switchD_00412d72_caseD_2:
  ...
  if (iVar3 != 0) {
    ...
    *(float *)(param_1 + 0x23a4) = *(float *)(param_1 + 0x23a8);
    core_charactr_cpp_CCharacter_moveAndCollide_FUN_00425050(param_1,&local_70);
  }
