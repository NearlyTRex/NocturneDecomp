...
;                               FUNCTION
; *****************************************************************************
; CBatCreature * __cdecl core_batcreat_cpp_CBatCreature_dtor_FUN_004132c0(CBatCreature *this_ptr,uint flags)
;
; Parameters:
...
section .text
    ...
    PUSH EBX                            ; 004132c0
        ;   Label: core_batcreat.cpp_CBatCreature_dtor_FUN_004132c0
    ...
    PUSH EBX                            ; 004132d8
    CALL core_armour.cpp_CFlame_arrdtor50_FUN_0040fe50 ; 004132d9
    ...
    PUSH EAX                            ; 004132e8
    CALL core_armour.cpp_SFire_arrdtor50_FUN_0040fe30 ; 004132e9
    ...
    PUSH EAX                            ; 004132f8
    CALL core_armour.cpp_CVector3f_arrdtor15_FUN_0040fe10 ; 004132f9
    ...
    PUSH EAX                            ; 00413308
    CALL core_armour.cpp_CVector3f_arrdtor15_FUN_0040fe10 ; 00413309
        ;   XREF to: 0040fe10 (UNCONDITIONAL_CALL)  ; CVector3f * core_armour.cpp_CVector3f_arrdtor15_FUN_0040fe10(CVector3f * this_ptr, uint flags)
    ...
    PUSH EAX                            ; 0041336c
        ;   Label: LAB_0041336c
    CALL crt_memory.c_operator_delete_FUN_00564494 ; 0041336d
