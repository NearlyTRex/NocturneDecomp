...
section .text
    ...
    PUSH EBX                            ; 0041249b
    CALL core_charactr.cpp_CCharacter_FUN_004259f0 ; 0041249c
    ...
    CALL core_charactr.cpp_CCharacter_FUN_00428c00 ; 00412528
    ...
    PUSH EBX                            ; 00412683
    CALL core_charactr.cpp_CCharacter_FUN_0042a150 ; 00412684
