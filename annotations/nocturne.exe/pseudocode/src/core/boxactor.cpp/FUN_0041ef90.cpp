// Name: core_boxactor.cpp_FUN_0041ef90
// Address: 0041ef90
// Address Range: [[0041ef90, 0041f0a5]]
// Convention: unknown
// Signature: void core_boxactor_cpp_FUN_0041ef90(int param_1,undefined4 param_2,float *param_3)

#include "nocturne.h"

void core_boxactor_cpp_FUN_0041ef90(int param_1,uint param_2,float *param_3)
  ...
  if (local_1c * local_40 + local_24 * local_48 + local_20 * local_44 < 0.0) {
    ...
    if ((0.0 <= fStack_14) && (fStack_14 < 1.0)) {
      ...
      *(float *)(param_1 + 0x28) = *(float *)(param_1 + 0x28) + fStack_28;
      ...
      core_boxactor_cpp_FUN_0041f190(param_1);
      return;
    }
  }
  return;
