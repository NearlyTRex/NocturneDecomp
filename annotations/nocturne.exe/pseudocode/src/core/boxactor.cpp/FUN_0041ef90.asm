...
;
; XREF[2]:
;   core_gabriela.cpp_FUN_00495a20 at 00496164
...
section .text
    ...
    PUSH EBX                            ; 0041ef90
        ;   Label: core_boxactor.cpp_FUN_0041ef90
    PUSH ESI                            ; 0041ef91
    PUSH EBP                            ; 0041ef92
    ...
    CALL core_boxactor.cpp_FUN_0041f190 ; 0041f098
        ;   XREF to: 0041f190 (UNCONDITIONAL_CALL)  ; undefined core_boxactor.cpp_FUN_0041f190()
