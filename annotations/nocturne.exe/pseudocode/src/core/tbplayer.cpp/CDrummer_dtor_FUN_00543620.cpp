// Name: core_tbplayer.cpp_CDrummer_dtor_FUN_00543620
// Address: 00543620
// Address Range: [[00543620, 005436e8]]
// Convention: __cdecl
// Signature: CDrummer * __cdecl core_tbplayer_cpp_CDrummer_dtor_FUN_00543620(CDrummer *this_ptr,uint flags)
...

{
  ...
  if ((flags & 4) != 0) {
    ptr_00 = __vec_delete(this_ptr,&g_CDrummerTypeInfo_005a2e80);
