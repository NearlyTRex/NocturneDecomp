// Name: core_tbplayer.cpp_FUN_005436f0
// Address: 005436f0
// Address Range: [[005436f0, 005437b8]]
// Convention: unknown
// Signature: CDemonActor * core_tbplayer_cpp_FUN_005436f0(CDemonActor *param_1,byte param_2)
...

{
  ...
  if ((param_2 & 4) != 0) {
    ptr = __vec_delete(param_1,&g_CBassPlayerTypeInfo_005a2ea0);
