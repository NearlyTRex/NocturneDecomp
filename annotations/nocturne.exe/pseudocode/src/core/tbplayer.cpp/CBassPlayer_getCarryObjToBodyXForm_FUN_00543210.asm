...
section .text
    ...
    PUSH EBX                            ; 00543210
        ;   Label: core_tbplayer.cpp_CBassPlayer_getCarryObjToBodyXForm_FUN_00543210
    PUSH EDI                            ; 00543211
    PUSH EBP                            ; 00543212
    ...
    PUSH EAX                            ; 005432da
    CALL core_xform.cpp_buildMatrixFromEulerAndPositionDirect_FUN_0055afb0 ; 005432db
