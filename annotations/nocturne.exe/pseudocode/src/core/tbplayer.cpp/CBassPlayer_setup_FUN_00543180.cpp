...
// Convention: unknown
// Signature: void core_tbplayer_cpp_CBassPlayer_setup_FUN_00543180(int param_1)
...

{
  ...
  *(uint *)(param_1 + 0x1f570) = uVar2;
  uVar1 = core_skeleton_cpp_CSkeleton_findBone_FUN_005179d0(uVar1,"Bip01 R Hand",1);
