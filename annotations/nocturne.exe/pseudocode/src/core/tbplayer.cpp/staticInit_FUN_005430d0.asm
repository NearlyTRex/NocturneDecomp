...
;
; Referenced Globals:
;   TerminatedCString s_CBassPlayer_0059647c
;   TerminatedCString s_CDrummer_00596488
;
; Called Functions:
...
section .text
    ...
    PUSH 0x1d46820                      ; 005430d0
        ;   Label: core_tbplayer.cpp_staticInit_FUN_005430d0
    PUSH 0x1                            ; 005430d5
    PUSH 0x5c1050                       ; 005430d7
    PUSH 0x543120                       ; 005430dc
    PUSH 0x59647c                       ; 005430e1 | = "CBassPlayer"
    ...
    PUSH 0x596488                       ; 00543104 | = "CDrummer"
