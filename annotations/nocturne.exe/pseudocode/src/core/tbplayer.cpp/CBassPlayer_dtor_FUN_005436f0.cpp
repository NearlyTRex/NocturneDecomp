// Name: core_tbplayer.cpp_CBassPlayer_dtor_FUN_005436f0
// Address: 005436f0
// Address Range: [[005436f0, 005437b8]]
// Convention: __cdecl
// Signature: CBassPlayer * __cdecl core_tbplayer_cpp_CBassPlayer_dtor_FUN_005436f0(CBassPlayer *this_ptr,uint flags)
...

{
  ...
  if ((flags & 4) != 0) {
    ptr_00 = __vec_delete(this_ptr,&g_CBassPlayerTypeInfo_005a2ea0);
