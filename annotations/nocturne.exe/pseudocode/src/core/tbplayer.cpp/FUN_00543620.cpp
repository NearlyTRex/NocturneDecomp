// Name: core_tbplayer.cpp_FUN_00543620
// Address: 00543620
// Address Range: [[00543620, 005436e8]]
// Convention: unknown
// Signature: int core_tbplayer_cpp_FUN_00543620(int param_1,byte param_2)

#include "nocturne.h"

int core_tbplayer_cpp_FUN_00543620(int param_1,byte param_2)

{
  ...
  if ((param_2 & 4) != 0) {
    uVar2 = __vec_delete(param_1,&g_CDrummerTypeInfo_005a2e80);
