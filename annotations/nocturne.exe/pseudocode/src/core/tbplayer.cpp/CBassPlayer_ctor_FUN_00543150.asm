...
;
; XREF[1]:
;   core_tbplayer.cpp_factoryFuncBassPlayer_FUN_00543120 at 00543133
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00543150
        ;   Label: core_tbplayer.cpp_CBassPlayer_ctor_FUN_00543150
    MOV EDX,dword ptr [ESP + 0x8]       ; 00543151
    PUSH EDX                            ; 00543155
    CALL core_npc.cpp_CNPC_ctor_FUN_004ee950 ; 00543156
