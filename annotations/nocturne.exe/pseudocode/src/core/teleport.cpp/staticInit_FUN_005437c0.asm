...
;
; Referenced Globals:
;   TerminatedCString s_CTeleportDest_005964e0
;   TerminatedCString s_CTeleport_005964ee
;
; Called Functions:
...
section .text
    ...
    PUSH 0x763e48                       ; 005437c0
        ;   Label: core_teleport.cpp_staticInit_FUN_005437c0
    PUSH 0x1                            ; 005437c5
    PUSH 0x5c107c                       ; 005437c7
    PUSH 0x543810                       ; 005437cc
    PUSH 0x5964e0                       ; 005437d1 | = "CTeleportDest"
    ...
    PUSH 0x5964ee                       ; 005437f4 | = "CTeleport"
