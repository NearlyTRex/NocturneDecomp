...
// Convention: __cdecl
// Signature: void __cdecl core_charactr_cpp_FUN_00427730(CCharacter *this_ptr,CVector3f *position,int fire_type,int flame_type,float flame_scale,int include_hero)
