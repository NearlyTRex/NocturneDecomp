...

{
  ...
  engine_drender_cpp_CDemonRenderer_setRenderAlpha_FUN_00461010(DAT_005ae704,0xc000);
  ...
  DAT_005ae704->skip_uv_extraction = 1;
  ...
  core_skeleton_cpp_CDeformableModelInstance_getBoneTransform_FUN_0051ed90
            (this_ptr,(SPose *)&stack0xffffe550);
  core_skeleton_cpp_CDeformableModelInstance_scalePoseDataForHierarchy_FUN_0051d970(this_ptr,1.1,-1)
  ;
  core_skeleton_cpp_CDeformableModelInstance_computeBoneTransforms_FUN_0051d3c0(this_ptr);
  bounding_box = (CBoundingBox3D *)(param_1 + 0x2388);
  this_ptr_00 = core_skeleton_cpp_CDeformableModelInstance_getModelPtr_FUN_0051e020(this_ptr);
  iVar2 = core_skeleton_cpp_CDeformableModel_selectLOD_FUN_0051a700(this_ptr_00,bounding_box);
  core_skeleton_cpp_CDeformableModelInstance_skinAndRotateVertices_FUN_0051dad0(this_ptr,iVar2);
  core_skeleton_cpp_CDeformableModelInstance_computeCylindricalUVs_FUN_0051f080
            (this_ptr,DAT_007658dc,0);
  iVar2 = 0;
  do {
    pCVar1 = DAT_005ae704;
    *(uint *)((int)&DAT_005ae704->vertex_buffer_ptr->r + iVar2) = 0xb332;
  ...
  core_skeleton_cpp_CDeformableModelInstance_renderPolygons_FUN_0051dbc0
            ((CDeformableModelInstance *)(param_1 + 0x150),0x267,1);
  DAT_005ae704->skip_uv_extraction = 0;
  core_skeleton_cpp_CDeformableModelInstance_setBoneTransform_FUN_0051ee60
            ((CDeformableModelInstance *)(param_1 + 0x150),(SPose *)&stack0xffffe550);
