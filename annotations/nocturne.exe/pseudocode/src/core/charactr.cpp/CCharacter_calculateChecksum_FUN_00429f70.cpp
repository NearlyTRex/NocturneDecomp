...
// Convention: unknown
// Signature: void core_charactr_cpp_CCharacter_calculateChecksum_FUN_00429f70(CDemonActor *param_1,uint *param_2)
...

{
  ...
  core_actor_cpp_CDemonActor_calculateChecksum_FUN_0040b0d0(param_1,param_2);
