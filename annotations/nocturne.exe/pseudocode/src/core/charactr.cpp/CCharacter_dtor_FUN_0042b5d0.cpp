// Name: core_charactr.cpp_CCharacter_dtor_FUN_0042b5d0
// Address: 0042b5d0
// Address Range: [[0042b5d0, 0042b688]]
// Convention: __cdecl
// Signature: CCharacter * __cdecl core_charactr_cpp_CCharacter_dtor_FUN_0042b5d0(CCharacter *this_ptr,uint flags)
...

{
  ...
  if ((flags & 4) != 0) {
    ptr_00 = __vec_delete(this_ptr,&g_CCharacterTypeInfo_0059b200);
    shape_memdbg_cpp_free_FUN_00564486(ptr_00);
    return this_ptr;
  }
  pCVar1 = core_armour_cpp_CFlame_arrdtor50_FUN_0040fe50(this_ptr->flames,0);
