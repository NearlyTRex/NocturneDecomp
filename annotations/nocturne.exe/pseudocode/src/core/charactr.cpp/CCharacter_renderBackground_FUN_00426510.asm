...
;
; XREF[2]:
;   core_enemy.cpp_CEnemy_renderBackground_FUN_0047a000 at 0047a021
;   core_npc.cpp_CNPC_renderBackground_FUN_004eece0 at 004eed01
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 00426510
        ;   Label: core_charactr.cpp_CCharacter_renderBackground_FUN_00426510
