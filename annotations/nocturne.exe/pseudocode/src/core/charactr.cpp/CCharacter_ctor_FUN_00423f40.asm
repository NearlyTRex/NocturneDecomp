...
;   core_hero.cpp_CHero_ctor_FUN_004b46d0 at 004b46d6
...
section .text
    ...
    PUSH EDX                            ; 00423f47
    CALL core_actor.cpp_CDemonActor_ctor_FUN_00409d30 ; 00423f48
    ...
    MOV dword ptr [EDX + 0x14c],0x59b0a4 ; 00423fc3 | g_CCharacterVTable
