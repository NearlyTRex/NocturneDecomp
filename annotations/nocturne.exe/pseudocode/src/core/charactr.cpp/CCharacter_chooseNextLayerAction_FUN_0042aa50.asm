...
section .text
    ...
    PUSH EBX                            ; 0042aa50
        ;   Label: core_charactr.cpp_CCharacter_chooseNextLayerAction_FUN_0042aa50
    PUSH ESI                            ; 0042aa51
    PUSH EDI                            ; 0042aa52
    PUSH EBP                            ; 0042aa53
    ...
    MOV dword ptr [0x01cc4800],EDI      ; 0042aa83 | PTR_01cc4800
    MOV [0x01cc4804],EAX                ; 0042aa89 | INT_01cc4804
