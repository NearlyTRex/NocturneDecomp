...
;
; XREF[1]:
;   core_scat.cpp_CScat_updateAI_FUN_004fc610 at 004fca1b
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 00424e90
        ;   Label: core_charactr.cpp_CCharacter_turnTowardPoint_FUN_00424e90
    ...
    PUSH EAX                            ; 00424eb0
    CALL core_vecdir.cpp_convertDirectionVectorToEulerAngles_FUN_0054e4a0 ; 00424eb1
    ...
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040df00 ; 00424ece
