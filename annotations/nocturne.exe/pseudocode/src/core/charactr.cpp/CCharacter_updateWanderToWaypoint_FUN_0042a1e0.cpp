...
// Convention: __cdecl
// Signature: undefined4 __cdecl core_charactr_cpp_CCharacter_updateWanderToWaypoint_FUN_0042a1e0(int param_1,float param_2,char *param_3)
  ...
  *(float *)(param_1 + 0x25ec) = param_2;
  ...
  if ((iVar7 == 0) ||
    ...
    uVar8 = core_waypoint_cpp_CWayPoint_findNearestReachable_FUN_00552680
                      (param_1 + 0x20,*(int *)(param_1 + 0x25e4));
...
LAB_0042a27e:
    *(uint *)(param_1 + 0x25e8) = 0;
    ...
    for (local_20 = 0; local_20 < *(int *)(0x01E57284 + 0x154a7c); local_20 = local_20 + 1) {
      ...
      iVar4 = shape_edittool_cpp_wildcardStringMatch_FUN_004775b0(param_3,iVar5,0);
      iVar6 = iVar7;
      if ((iVar4 != 0) &&
    ...
    if (0 < local_28) {
      ...
      do {
        while( true ) {
          iVar5 = core_actor_cpp_getRandomInt_FUN_0040de00(0,local_2c);
          if (local_1f80[iVar5] != 0) break;
          iVar7 = iVar7 + 1;
          if (9 < iVar7) goto LAB_0042a369;
        }
        iVar6 = core_waypoint_cpp_CWayPoint_findNearestReachable_FUN_00552680
                          (param_1 + 0x20,local_1f80[iVar5]);
...
LAB_0042a369:
  ...
  local_14 = core_actor_cpp_getRandomFloatFromRange_FUN_0040dda0(uVar8,uVar9);
...
LAB_0042a39c:
  ...
  iVar7 = core_charactr_cpp_CCharacter_walkToPoint_FUN_004247f0
                    (param_1,*(int *)(param_1 + 0x25e8) + 0x20,uVar8);
  if (iVar7 == 0) {
    return 1;
  }
  if (iVar7 < 0) {
