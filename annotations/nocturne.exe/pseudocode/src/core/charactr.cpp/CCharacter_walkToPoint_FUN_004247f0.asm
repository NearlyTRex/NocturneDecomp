...
;   core_boneguy.cpp_CBoneGuy_updatePickupBehavior_FUN_004196b0 at 00419918
;   core_bride.cpp_CBride_process_FUN_0041fe40 at 0042017b
;   core_charactr.cpp_CCharacter_followActor_FUN_00428780 at 00428a53
;   core_charactr.cpp_CCharacter_moveOutOfHeroWay_FUN_0042af70 at 0042afe0
;   core_charactr.cpp_CCharacter_processWalking_FUN_00428c00 at 00428d22
;   core_charactr.cpp_CCharacter_updateWanderToWaypoint_FUN_0042a1e0 at 0042a4bc
;   core_cow.cpp_CZombieCow_process_FUN_0043bdb0 at 0043c25c
;   ... and 17 more
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004247f0
        ;   Label: core_charactr.cpp_CCharacter_walkToPoint_FUN_004247f0
    PUSH ESI                            ; 004247f1
    PUSH EDI                            ; 004247f2
    PUSH EBP                            ; 004247f3
    ...
    CALL core_vecdir.cpp_convertDirectionVectorToEulerAngles_FUN_0054e4a0 ; 00424836
    ...
    CALL core_vecdir.cpp_convertDirectionVectorToEulerAngles_FUN_0054e4a0 ; 00424872
        ;   XREF to: 0054e4a0 (UNCONDITIONAL_CALL)  ; CVector3f * core_vecdir.cpp_convertDirectionVectorToEulerAngles_FUN_0054e4a0(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
    ...
    FLD float ptr [EBP + 0x24]          ; 004248c2
        ;   Label: LAB_004248c2
    FADD double ptr [0x00579f0a]        ; 004248c5 | DOUBLE_00579f0a
    ...
    FADD double ptr [0x00579f0a]        ; 004248d9 | DOUBLE_00579f0a
    ...
    FABS                                ; 004248ee
    FCOMP double ptr [0x00579f12]       ; 004248f0 | DOUBLE_00579f12
    FNSTSW AX                           ; 004248f6
    SAHF                                ; 004248f8
    ...
    FABS                                ; 00424922
    FMUL double ptr [0x00579f1a]        ; 00424924 | DOUBLE_00579f1a
    FMUL double ptr [0x00579f22]        ; 0042492a | DOUBLE_00579f22
    FLD float ptr [ESP + 0x18]          ; 00424930
    FST double ptr [ESP]                ; 00424934
    FMUL double ptr [0x00579f2a]        ; 00424937 | DOUBLE_00579f2a
    FADD double ptr [0x00579f32]        ; 0042493d | DOUBLE_00579f32
    FADDP                               ; 00424943
    ...
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040df00 ; 004249b3
    ...
    FMUL double ptr [0x00579f3a]        ; 004249eb | DOUBLE_00579f3a
    ...
    CALL core_vecdir.cpp_convertDirectionVectorToEulerAngles_FUN_0054e4a0 ; 00424af6
        ;   XREF to: 0054e4a0 (UNCONDITIONAL_CALL)  ; CVector3f * core_vecdir.cpp_convertDirectionVectorToEulerAngles_FUN_0054e4a0(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
    ...
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040df00 ; 00424b0b
        ;   XREF to: 0040df00 (UNCONDITIONAL_CALL)  ; float core_actor.cpp_normalizeAngleToPi_FUN_0040df00(float angle_radians)
    ...
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040df00 ; 00424c09
        ;   XREF to: 0040df00 (UNCONDITIONAL_CALL)  ; float core_actor.cpp_normalizeAngleToPi_FUN_0040df00(float angle_radians)
    ...
    PUSH EAX                            ; 00424d4b
    PUSH EBX                            ; 00424d4c
    CALL core_actor.cpp_CDemonActor_transformVector_FUN_0040a200 ; 00424d4d
    ...
    CALL core_vecdir.cpp_convertDirectionVectorToEulerAngles_FUN_0054e4a0 ; 00424db6
        ;   XREF to: 0054e4a0 (UNCONDITIONAL_CALL)  ; CVector3f * core_vecdir.cpp_convertDirectionVectorToEulerAngles_FUN_0054e4a0(CVector3f * out_euler_angles, CVector3f * in_direction_vector)
    ...
    CALL core_actor.cpp_normalizeAngleToPi_FUN_0040df00 ; 00424dca
        ;   XREF to: 0040df00 (UNCONDITIONAL_CALL)  ; float core_actor.cpp_normalizeAngleToPi_FUN_0040df00(float angle_radians)
