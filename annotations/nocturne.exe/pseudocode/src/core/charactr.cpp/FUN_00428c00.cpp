...
// Convention: unknown
// Signature: undefined4 core_charactr_cpp_FUN_00428c00(int param_1,float param_2)
...

{
  ...
  if (*(int *)(param_1 + 0x25ac) == 0) {
    ...
    core_charactr_cpp_CCharacter_followActor_FUN_00428780
              (param_1,iVar2,*(uint *)(param_1 + 0x259c),*(uint *)(param_1 + 0x25a0),
               param_1 + 0x25a8);
    return 1;
  }
  core_door_cpp_CDoor_getOpenStandPos_FUN_00456260
            (*(int *)(param_1 + 0x25ac),local_3c,param_1 + 0x25b0,param_1 + 0x20);
  uVar1 = (**(code **)(*(int *)(*(int *)(param_1 + 0x25ac) + 0x14c) + 0xbc))
                    (*(int *)(param_1 + 0x25ac),&DAT_02dd1184,0,0);
  iVar2 = core_charactr_cpp_CCharacter_walkToPoint_FUN_004247f0(param_1,local_3c,uVar1);
  if (iVar2 < 0) {
  ...
  uVar1 = core_actor_cpp_CDemonActor_worldToLocalPoint_FUN_0040a290
                    (param_1,auStack_30,*(int *)(param_1 + 0x25ac) + 0x9b4);
  iVar2 = core_vecdir_cpp_convertDirectionVectorToEulerAngles_FUN_0054e4a0(auStack_48,uVar1);
  fVar4 = *(float *)(iVar2 + 4);
  *(float *)(param_1 + 0x2410) = fVar4;
  if ((float)0.62831853069999999 <= fVar4) {
    *(uint *)(param_1 + 0x25a8) = 1;
  }
  else {
    *(uint *)(param_1 + 0x25a8) = 0;
  ...
  fVar3 = (float)core_actor_cpp_normalizeAngleToPi_FUN_0040df00(uStack_18);
  fVar4 = -fStack_1c;
