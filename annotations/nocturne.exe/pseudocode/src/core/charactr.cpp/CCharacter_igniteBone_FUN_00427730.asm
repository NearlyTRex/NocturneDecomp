...
;
; XREF[8]:
;   core_batcreat.cpp_CBatCreature_processDamage_FUN_00413040 at 004130bc
...
;   core_emitter.cpp_CEmitter_process_FUN_00478790 at 00478c46
...
section .text
    ...
    PUSH EBX                            ; 00427730
        ;   Label: core_charactr.cpp_CCharacter_igniteBone_FUN_00427730
    PUSH ESI                            ; 00427731
    PUSH EDI                            ; 00427732
    PUSH EBP                            ; 00427733
