...
section .text
    ...
    PUSH EDX                            ; 004243dc
    PUSH EBX                            ; 004243dd
    CALL FUN_00438550                   ; 004243de
        ;   XREF to: 00438550 (UNCONDITIONAL_CALL)  ; undefined FUN_00438550()
    ADD ESP,0x18                        ; 004243e3
    PUSH EBP                            ; 004243e6
    CALL FUN_0042a800                   ; 004243e7
        ;   XREF to: 0042a800 (UNCONDITIONAL_CALL)  ; undefined FUN_0042a800()
