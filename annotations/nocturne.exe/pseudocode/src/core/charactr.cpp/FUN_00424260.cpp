...
// Convention: unknown
// Signature: void FUN_00424260(int param_1)
...

{
  ...
  *(uint *)(param_1 + 0x240c) = uVar2;
  FUN_00454580(&DAT_007658e4,"stake_b.kfm");
  FUN_00454510(&DAT_007658e4);
  iVar5 = param_1;
  do {
  ...
  if (*(char *)(param_1 + 0x23b0) != '\0') {
    *(uint *)(param_1 + 0x1a4) = *(uint *)(param_1 + 0x2614);
    ...
    uVar2 = FUN_0051e0a0(param_1 + 0x150,"bip01 head",0);
    uVar2 = FUN_005179d0(uVar2);
    *(uint *)(param_1 + 0x25dc) = uVar2;
  }
  FUN_004296c0(param_1);
  if (*(int *)(param_1 + 0x260c) != 0) {
    iVar3 = FUN_0051e0a0(param_1 + 0x150);
    *(uint *)(param_1 + 0x2f0c) = 4;
    iVar5 = 0;
    if (0 < *(int *)(iVar3 + 0x28558)) {
      do {
        iVar4 = iVar5 + 1;
        FUN_004266a0(param_1,iVar3,iVar5);
        iVar5 = iVar4;
  ...
  FUN_00438270(iVar3);
  iVar5 = param_1 + 0x20;
  FUN_00438510(iVar3,iVar5,param_1 + 0x30,param_1 + 0x150,iVar5);
  FUN_00438550(iVar3,iVar5,param_1 + 0x30,0x3d4ccccd,*(uint *)(param_1 + 0x240c),
               param_1 + 0x150);
  FUN_0042a800(param_1);
  if (*(char *)(param_1 + 0x2440) != '\0') {
    *(uint *)(param_1 + 0xb63c) = 0;
    return;
  }
  iVar5 = FUN_00409fa0(param_1);
  pcVar6 = (char *)(iVar5 + 1);
