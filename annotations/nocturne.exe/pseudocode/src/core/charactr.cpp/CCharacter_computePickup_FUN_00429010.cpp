...
// Convention: __cdecl
// Signature: void __cdecl core_charactr_cpp_CCharacter_computePickup_FUN_00429010(int param_1,int param_2,float param_3)
...

{
  ...
  core_xform_cpp_buildMatrixFromEulerAndPositionDirect_FUN_0055afb0
            (local_d0,param_1 + 0x20,param_1 + 0x30);
  ...
  core_xform_cpp_multiplyMatrix3x4_FUN_0055aa00(*piVar2 * 0x30 + param_1 + 0xfd0,local_a0);
  puVar3 = local_40;
  puVar5 = local_70;
  for (iVar1 = 0xc; iVar1 != 0; iVar1 = iVar1 + -1) {
    *puVar5 = *puVar3;
