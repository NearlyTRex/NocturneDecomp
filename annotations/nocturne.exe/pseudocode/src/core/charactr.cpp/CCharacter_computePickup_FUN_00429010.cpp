...

{
  ...
  if (pSVar2->bone_index < 0) {
    ...
    g_CurrentLineNumber = 3092;
    core_main_c_displayErrorAndQuit_FUN_004c8440("CCharacter::computePickup - invalid bone!");
  }
  ...
  core_xform_cpp_multiplyMatrix3x4_FUN_0055aa00(&local_d0,&local_100,&local_130);
  pCVar3 = &local_130;
  pCVar4 = &local_a0;
  ...
  core_xform_cpp_inverse_FUN_0055bd00(&local_70,&local_160);
  pCVar3 = &local_160;
