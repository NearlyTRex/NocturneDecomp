...
// Convention: unknown
// Signature: undefined4 core_charactr_cpp_CCharacter_attractActorToward_FUN_00428160(int param_1,int param_2,undefined4 param_3)
...

{
  ...
  if ((param_2 != 0) &&
    ...
    pfVar2 = (float *)core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240
                                (param_2,local_44,param_3);
