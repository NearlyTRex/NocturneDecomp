...
// Convention: __cdecl
// Signature: undefined4 __cdecl core_charactr_cpp_CCharacter_walkToPoint_FUN_004247f0(int param_1,float *param_2,int param_3,float *param_4,float param_5,float param_6)
...

{
  ...
  iVar3 = core_vecdir_cpp_convertDirectionVectorToEulerAngles_FUN_0054e4a0(local_b0,param_4);
  fVar5 = *(float *)(iVar3 + 4);
  core_actor_cpp_CDemonActor_worldToLocalPoint_FUN_0040a290(param_1,&local_bc,param_2);
  fVar2 = SQRT(local_bc * local_bc + local_b4 * local_b4);
  iVar3 = core_vecdir_cpp_convertDirectionVectorToEulerAngles_FUN_0054e4a0(local_d4,&local_bc);
  ...
  *(uint *)(param_1 + 0x23a4) = *(uint *)(param_1 + 0x23a8);
       ...
       ABS(fVar5) * (float)_DAT_00579f1a * (float)_DAT_00579f22 <= fVar2) || (1.0 < ABS(local_b8)))
  {
    ...
    iVar3 = core_path_cpp_CPathMap_findPathWithRetry_FUN_004f1600
                      (param_3,param_1 + 0x20,local_74,*(uint *)(param_1 + 0x6c));
    if (iVar3 == 0) {
      if (local_4c != 0) {
        return 1;
      }
    ...
    *(float *)(param_1 + 0x241c) = *(float *)(param_1 + 0x241c) + local_44;
    ...
    fVar5 = (float)core_actor_cpp_normalizeAngleToPi_FUN_0040df00(local_18);
    fVar4 = -local_1c;
    ...
    *(float *)(param_1 + 0x2410) = *(float *)(param_1 + 0x2410) + fVar4;
    ...
    if (fVar4 * (float)_DAT_00579f3a + fVar1 <= fVar2) {
      ...
      *(float *)(param_1 + 0x241c) = *(float *)(param_1 + 0x241c) + local_30;
      core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240(param_1,&local_8c,param_1 + 0x2414);
      pfVar6 = (float *)core_actor_cpp_CDemonActor_transformVector_FUN_0040a200
                                  (param_1,local_f8,param_4);
      ...
      iVar3 = core_vecdir_cpp_convertDirectionVectorToEulerAngles_FUN_0054e4a0(local_ec,&local_98);
      ...
      *(float *)(param_1 + 0x241c) = *(float *)(param_1 + 0x241c) + local_d8;
      ...
      iVar3 = core_vecdir_cpp_convertDirectionVectorToEulerAngles_FUN_0054e4a0(local_c8,&local_80);
      fVar5 = (float)core_actor_cpp_normalizeAngleToPi_FUN_0040df00(*(float *)(iVar3 + 4) - fVar5);
      fVar4 = -local_1c;
      if ((fVar4 <= fVar5) && (fVar4 = fVar5, local_1c < fVar5)) {
        fVar4 = local_1c;
      }
