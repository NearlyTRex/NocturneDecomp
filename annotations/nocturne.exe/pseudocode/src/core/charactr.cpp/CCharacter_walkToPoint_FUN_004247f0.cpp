...

{
  ...
  pCVar4 = core_vecdir_cpp_convertDirectionVectorToEulerAngles_FUN_0054e4a0(&local_b0,direction);
  fVar7 = pCVar4->y;
  ...
  pCVar4 = core_vecdir_cpp_convertDirectionVectorToEulerAngles_FUN_0054e4a0(&local_d4,&local_bc);
  local_20 = pCVar4->y;
  local_4c = 0;
  local_fc = 0.0;
  if (0.0 < SQRT(direction->z * direction->z +
                 direction->x * direction->x + direction->y * direction->y)) {
    local_18 = core_actor_cpp_normalizeAngleToPi_FUN_0040df00(local_20 - fVar7);
  ...
  if ((fVar2 * (float)1.5 + (float)0.5 +
    ...
    *pfVar1 = *pfVar1 + local_44;
    ...
    fVar7 = core_actor_cpp_normalizeAngleToPi_FUN_0040df00(local_18);
    fVar6 = -local_1c;
    ...
    if (fVar6 * (float)4 + fVar2 <= fVar3) {
      ...
      *pfVar1 = *pfVar1 + local_30;
      ...
      pCVar4 = core_actor_cpp_CDemonActor_transformVector_FUN_0040a200
      ...
      pCVar4 = core_vecdir_cpp_convertDirectionVectorToEulerAngles_FUN_0054e4a0(&local_ec,&local_98)
      ;
      ...
      pCVar4 = core_vecdir_cpp_convertDirectionVectorToEulerAngles_FUN_0054e4a0(&local_c8,&local_80)
      ;
      fVar7 = core_actor_cpp_normalizeAngleToPi_FUN_0040df00(pCVar4->y - fVar7);
      fVar6 = -local_1c;
      if ((fVar6 <= fVar7) && (fVar6 = fVar7, local_1c < fVar7)) {
        fVar6 = local_1c;
      }
