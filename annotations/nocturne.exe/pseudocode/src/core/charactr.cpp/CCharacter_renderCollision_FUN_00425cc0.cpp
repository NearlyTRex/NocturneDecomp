...
// Convention: __cdecl
// Signature: void __cdecl core_charactr_cpp_CCharacter_renderCollision_FUN_00425cc0(CCharacter *this_ptr)
...

{
  ...
  local_e8.surface_normal.B.i = local_e8.surface_normal.A.i;
  ...
  do {
    ...
    do {
      ...
      *(uint *)((int)&pCVar5->vertex_buffer_ptr->b + iVar9) = 0;
      ...
      local_78.x = (int)ROUND(local_84.x * _DAT_0059b070);
      local_78.y = (int)ROUND(local_84.y * _DAT_0059b070);
      local_78.z = (int)ROUND(local_84.z * _DAT_0059b070);
      pCVar11 = pCVar11 + 1;
  ...
  do {
    ...
    do {
      ...
      *(uint *)((int)&pCVar5->vertex_buffer_ptr->b + iVar9) = 0xffff;
      ...
      local_6c.x = (int)ROUND(local_84.x * _DAT_0059b070);
      local_6c.y = (int)ROUND(local_84.y * _DAT_0059b070);
      local_6c.z = (int)ROUND(local_84.z * _DAT_0059b070);
      pCVar11 = pCVar11 + 1;
      engine_special_cpp_transformAndProjectPoint_FUN_0053075c
                ((SProjectedVertex *)
                 ((int)&(g_CDemonRenderer_PTR_005ae704->vertex_buffer_ptr->projected_vertex).
  ...
  do {
    ...
    local_60[0].x = (int)ROUND(local_84.x * _DAT_0059b070);
    local_60[0].y = (int)ROUND(local_44 * _DAT_0059b070);
    local_60[0].z = (int)ROUND(local_84.z * _DAT_0059b070);
    local_18 = iVar4;
    engine_special_cpp_transformAndProjectPoint_FUN_0053075c
              ((SProjectedVertex *)
               ((int)&(g_CDemonRenderer_PTR_005ae704->vertex_buffer_ptr->projected_vertex).
    ...
    *(uint *)((int)&pCVar5->vertex_buffer_ptr->b + iVar6) = 0;
    local_84.y = local_38;
    local_34 = iVar4 + 1;
    local_b4.x = (int)ROUND(local_84.x * _DAT_0059b070);
    local_b4.y = (int)ROUND(local_38 * _DAT_0059b070);
    local_b4.z = (int)ROUND(local_84.z * _DAT_0059b070);
    engine_special_cpp_transformAndProjectPoint_FUN_0053075c
              ((SProjectedVertex *)
  ...
  local_c0.x = (int)ROUND(_DAT_02dd1184 * _DAT_0059b070);
  ...
  do {
    ...
    local_a8.x = (int)ROUND(local_84.x * _DAT_0059b070);
    local_a8.y = (int)ROUND(_DAT_0059b070 * 0.0);
