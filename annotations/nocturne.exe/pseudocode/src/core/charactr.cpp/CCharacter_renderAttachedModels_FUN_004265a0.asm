...
section .text
    ...
    PUSH EBX                            ; 004265a0
        ;   Label: core_charactr.cpp_CCharacter_renderAttachedModels_FUN_004265a0
    PUSH ESI                            ; 004265a1
    PUSH EDI                            ; 004265a2
    PUSH EBP                            ; 004265a3
    ...
    CALL core_xform.cpp_multiplyMatrix3x4_FUN_0055aa00 ; 00426619
    ...
    CALL core_xform.cpp_matrixToEulerAngles_FUN_0055b180 ; 00426636
