...
// Convention: __cdecl
// Signature: void __cdecl core_charactr_cpp_FUN_00426510(CCharacter *this_ptr,int layer_flag)

#include "nocturne.h"

void __cdecl core_charactr_cpp_FUN_00426510(CCharacter *this_ptr,int layer_flag)
