...
;   core_stranger.cpp_CStranger_updateWeaponLayerActions_FUN_0053f310 at 0053f5b6
...
section .text
    ...
    MOV dword ptr [0x01cc4800],EDX      ; 00428f68 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],ECX      ; 00428f6e | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 00428f74
    ...
    MOV [0x01cc4800],EAX                ; 00428fcf | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EDX      ; 00428fd4 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 00428fda
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
