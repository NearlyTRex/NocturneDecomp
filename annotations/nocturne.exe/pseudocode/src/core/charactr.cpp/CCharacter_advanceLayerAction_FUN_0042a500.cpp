...
// Convention: __cdecl
// Signature: int __cdecl core_charactr_cpp_CCharacter_advanceLayerAction_FUN_0042a500(CCharacter *this_ptr,float *remaining_time,int target_bone_index)
...

{
  ...
  if ((this_ptr->layer_action_index < 0) ||
    ...
    g_CurrentLineNumber = 3840;
    core_main_c_displayErrorAndQuit_FUN_004c8440("CCharacter::advanceLayerAction - invalid layerActionIndex");
  }
