...
// Convention: __cdecl
// Signature: void __cdecl core_charactr_cpp_CCharacter_processFire_FUN_004269b0(int param_1,float param_2)
...

{
  ...
  iVar4 = param_1 + 0x150;
  local_18 = core_skeleton_cpp_CDeformableModelInstance_getSkeletonPtr_FUN_0051e0a0(iVar4);
  if (*(int *)(param_1 + 0xb640) == 0) {
    if (0 < *(int *)(param_1 + 0x2f08)) {
      iVar3 = core_skeleton_cpp_CDeformableModelInstance_getSkeletonPtr_FUN_0051e0a0(iVar4);
      local_38 = iVar3;
      iVar4 = core_skeleton_cpp_CDeformableModelInstance_getModelPtr_FUN_0051e020(iVar4);
      iVar8 = 0;
      ...
      if (0 < *(int *)(local_38 + 0x28558)) {
        ...
        do {
          ...
          iVar4 = core_skeleton_cpp_CDeformableModelInstance_getModelPtr_FUN_0051e020(local_44);
      ...
      if (*(int *)(param_1 + 0x2290 + *piVar9 * 4) != 0) {
        *(uint *)(param_1 + 0xfc) = 1;
        uVar5 = core_xform_cpp_transformVector3x4_FUN_0055a8b0
                          (local_5c,piVar9 + 2,piVar9[1] * 0x30 + local_40);
        puVar6 = (uint *)
                 core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240(param_1,local_68,uVar5);
        *puVar10 = *puVar6;
        puVar10[1] = puVar6[1];
        puVar10[2] = puVar6[2];
      ...
      if ((*(int *)(param_1 + 0x2290 + *local_20 * 4) != 0) &&
          ...
          do {
            if (*(uint *)(iVar4 + 0x2857c) == local_1c[1]) {
              ...
              if (uVar7 == *(uint *)(param_1 + 0x2f08)) {
                core_charactr_cpp_CCharacter_spawnFireOnBone_FUN_004266a0(param_1,local_18,iVar3);
              }
            }
            iVar3 = iVar3 + 1;
            iVar4 = iVar4 + 0x24;
        ...
        if (iVar4 == *(int *)(param_1 + 0x2f08)) {
          core_charactr_cpp_CCharacter_spawnFireOnBone_FUN_004266a0
                    (param_1,local_18,*(uint *)(local_1c[1] * 0x24 + local_18 + 0x2857c));
        }
      }
      local_20 = local_20 + 6;
      local_30 = local_30 + 1;
