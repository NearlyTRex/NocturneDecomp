...
// Convention: __cdecl
// Signature: void __cdecl core_charactr_cpp_CCharacter_dropCarriedObject_FUN_00429170(int param_1,int param_2,int param_3)
...

{
  ...
  if (*(int *)(iVar2 + 8) != 0) {
    ...
    if (param_3 != 0) {
      puVar1 = (uint *)
               core_actor_cpp_CDemonActor_transformVector_FUN_0040a200(param_1,local_1c,param_3);
      if (&local_10 != puVar1) {
        local_10 = *puVar1;
        local_c = puVar1[1];
        local_8 = puVar1[2];
