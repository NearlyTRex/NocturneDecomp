...
// Convention: __cdecl
// Signature: undefined4 __cdecl core_charactr_cpp_CCharacter_isOnGround_FUN_00425960(int param_1)

#include "nocturne.h"

uint __cdecl core_charactr_cpp_CCharacter_isOnGround_FUN_00425960(int param_1)
