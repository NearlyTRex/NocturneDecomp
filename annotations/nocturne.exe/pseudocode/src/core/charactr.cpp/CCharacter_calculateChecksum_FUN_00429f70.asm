...
;
; Called Functions:
;   core_actor.cpp_CDemonActor_calculateChecksum_FUN_0040b0d0
...
section .text
    ...
    PUSH EBX                            ; 00429f70
        ;   Label: core_charactr.cpp_CCharacter_calculateChecksum_FUN_00429f70
    PUSH ESI                            ; 00429f71
    PUSH EDI                            ; 00429f72
    ...
    PUSH EBX                            ; 00429f7b
    PUSH EDI                            ; 00429f7c
    CALL core_actor.cpp_CDemonActor_calculateChecksum_FUN_0040b0d0 ; 00429f7d
        ;   XREF to: 0040b0d0 (UNCONDITIONAL_CALL)  ; void core_actor.cpp_CDemonActor_calculateChecksum_FUN_0040b0d0(CDemonActor * this_ptr, uint * out_crc)
