...

{
      ...
      for (iVar8 = 0; iVar8 < g_CDemonSet_PTR_005be368->character_count; iVar8 = iVar8 + 1) {
        ...
        if ((pCVar4 != this_ptr) &&
          ...
          if ((((0.0 <= CStack_50.z) &&
            ...
            if (((pCVar3 != (CDemonActor *)0x0) && (EStack_1c == DEATH_STATE_ALIVE)) &&
               (fStack_100 = 30.0,
  ...
  if (pCStack_20 != (CCharacter *)0x0) {
    ...
    if (pCVar4 == (CCharacter *)0x0) {
      ...
      g_CurrentLineNumber = 3508;
      core_main_c_displayErrorAndQuit_FUN_004c8440("CCharacter::findSomethingToLookAt - Should be a character");
    }
    ...
    pCVar5 = core_vecdir_cpp_convertDirectionVectorToEulerAngles_FUN_0054e4a0(&CStack_bc,&CStack_e0)
    ;
    if (&CStack_d4 != pCVar5) {
  ...
  if (this_ptr->look_at_candidate != (CCharacter *)0x0) {
    fVar6 = delta_time / 5.2220990168285998e-315._0_4_ + this_ptr->look_at_weight;
    this_ptr->look_at_weight = fVar6;
    if (1.0 < fVar6) {
      this_ptr->look_at_weight = 1.0;
    }
    fStack_14 = core_actor_cpp_normalizeAngleToPi_FUN_0040df00(CStack_d4.y - this_ptr->look_at_yaw);
    this_ptr->look_at_yaw = fStack_14 * (float)0.40000000000000002 + this_ptr->look_at_yaw;
    fVar6 = core_actor_cpp_normalizeAngleToPi_FUN_0040df00(CStack_d4.x - this_ptr->look_at_pitch);
    this_ptr->look_at_pitch = fVar6 * (float)0.40000000000000002 + this_ptr->look_at_pitch;
    return;
  }
LAB_00429793:
  fVar6 = this_ptr->look_at_weight - delta_time / 5.2220990168285998e-315._0_4_;
  this_ptr->look_at_weight = fVar6;
  if (fVar6 < 0.0) {
