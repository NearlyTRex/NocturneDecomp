...
// Convention: unknown
// Signature: void FUN_00428f40(int param_1,int param_2,int param_3,undefined4 param_4)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_00428f40(int param_1,int param_2,int param_3,uint param_4)

{
  ...
  if (param_3 != 0) {
    ...
    if ((piVar1[1] < 0) || (*(int *)(param_1 + 0x2290 + piVar1[1] * 4) != 0)) {
      ...
      piVar1[2] = param_3;
      FUN_00429010(param_1,param_2,param_4);
      return;
    }
  }
  return;
