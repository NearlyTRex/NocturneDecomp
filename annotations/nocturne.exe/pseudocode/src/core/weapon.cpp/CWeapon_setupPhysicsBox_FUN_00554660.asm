...
;
; XREF[2]:
;   core_weapon.cpp_CWeapon_onDropped_FUN_00554310 at 00554328
...
section .text
    ...
    PUSH EBX                            ; 00554660
        ;   Label: core_weapon.cpp_CWeapon_setupPhysicsBox_FUN_00554660
    ...
    CALL core_actor.cpp_CDemonActor_localToWorldPoint_FUN_0040a240 ; 005546e7
    ...
    PUSH EBX                            ; 00554736
    CALL core_box.cpp_CBox_setupCorners_FUN_0041a6e0 ; 00554737
