...
// Convention: unknown
// Signature: int core_bodypart_cpp_CBodyPart_getAllowedMeleeAttackTypes_FUN_00417ef0(CDemonActor *param_1)
...

{
  ...
  iVar1 = core_actor_cpp_CDemonActor_getAllowedMeleeAttackTypes_FUN_0040b200(param_1);
  return iVar1;
}
