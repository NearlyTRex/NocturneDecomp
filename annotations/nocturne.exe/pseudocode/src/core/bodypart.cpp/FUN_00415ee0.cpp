...
// Convention: unknown
// Signature: void FUN_00415ee0(int param_1,undefined4 param_2,undefined4 param_3)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_00415ee0(int param_1,uint param_2,uint param_3)

{
  ...
  *(uint *)(param_1 + 0x178) = param_3;
  uVar1 = FUN_00564a70(*(uint *)(param_1 + 0x170),*(int *)(param_1 + 0x16c) * 0xc);
  *(uint *)(param_1 + 0x170) = uVar1;
  uVar1 = FUN_00564a70(*(uint *)(param_1 + 0x174),*(int *)(param_1 + 0x16c) * 0xc);
  *(uint *)(param_1 + 0x174) = uVar1;
  uVar1 = FUN_00564a70(*(uint *)(param_1 + 0x17c),*(int *)(param_1 + 0x178) * 0x3c);
  *(uint *)(param_1 + 0x17c) = uVar1;
  uVar1 = FUN_00564a70(*(uint *)(param_1 + 0x180),*(int *)(param_1 + 0x178) << 2);
