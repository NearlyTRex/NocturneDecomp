...
section .text
    ...
    CALL core_bodypart.cpp_SBodyPartFire_arrdtor_FUN_00418130 ; 00415e7c
        ;   XREF to: 00418130 (UNCONDITIONAL_CALL)  ; undefined core_bodypart.cpp_SBodyPartFire_arrdtor_FUN_00418130()
    ADD ESP,0x8                         ; 00415e81
    PUSH 0x0                            ; 00415e84
    SUB EAX,0x4c0                       ; 00415e86
    PUSH EAX                            ; 00415e8b
    CALL core_bodypart.cpp_SBodyPartModel_arrdtor_FUN_00418110 ; 00415e8c
        ;   XREF to: 00418110 (UNCONDITIONAL_CALL)  ; undefined core_bodypart.cpp_SBodyPartModel_arrdtor_FUN_00418110()
