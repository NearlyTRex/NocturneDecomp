...
// Convention: __cdecl
// Signature: int __cdecl core_bodypart_cpp_createBodyPart_FUN_00415b30(undefined4 *param_1,undefined4 *param_2,undefined4 *param_3,int param_4,undefined4 param_5,undefined4 param_6,undefined4 param_7)
...

{
  ...
  *(uint *)(iVar2 + 0x28) = param_1[2];
  ...
  if (param_3 == (uint *)0x0) {
    fVar3 = (float)core_actor_cpp_getRandomFloatFromRange_FUN_0040dda0(0x3f490fdb,0x3fc90fdb);
    fVar4 = (float)core_actor_cpp_getRandomFloatFromRange_FUN_0040dda0(0,0x40c90fdb);
