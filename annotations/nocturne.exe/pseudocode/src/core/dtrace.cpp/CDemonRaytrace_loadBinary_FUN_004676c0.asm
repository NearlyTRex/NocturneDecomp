...
;
; XREF[1]:
;   core_dtrace.cpp_CDemonRaytrace_loadAndSyncWithGeoFile_FUN_00467890 at 004678b6
;
; Referenced Globals:
...
;   core_dtrace.cpp_CDemonRaytrace_freeNewCubeList_FUN_004673a0
...
section .text
    ...
    PUSH EBX                            ; 004676c0
        ;   Label: core_dtrace.cpp_CDemonRaytrace_loadBinary_FUN_004676c0
    PUSH ESI                            ; 004676c1
    PUSH EDI                            ; 004676c2
    PUSH EBP                            ; 004676c3
    ...
    PUSH EBX                            ; 004676cf
    CALL core_dtrace.cpp_CDemonRaytrace_freeNewCubeList_FUN_004673a0 ; 004676d0
        ;   XREF to: 004673a0 (UNCONDITIONAL_CALL)  ; void core_dtrace.cpp_CDemonRaytrace_freeNewCubeList_FUN_004673a0(CDemonRaytrace * this_ptr)
