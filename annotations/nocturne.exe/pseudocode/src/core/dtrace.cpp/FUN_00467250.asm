...
section .text
    ...
    MOV dword ptr [0x01cc4800],EDI      ; 00467286 | DAT_01cc4800
    MOV dword ptr [0x01cc4804],EBP      ; 0046728c | DAT_01cc4804
    CALL FUN_004c8440                   ; 00467292
