...
// Convention: __cdecl
// Signature: float __cdecl core_dtrace_cpp_CDemonRaytrace_getVoxelHeightAtPosition_FUN_0046aff0(CDemonRaytrace *this_ptr,CVector3f *world_position)
...

{
  ...
  if (((((iStack_30 < 0) || (iStack_30 < 0)) || (iVar1 < 0)) || ((7 < iStack_30 || (7 < iStack_30)))
      ) || (7 < iVar1)) {
    fStack_44 = -999.0;
  }
  else {
    while (pCVar15 = core_dtrace_cpp_CDemonRaytrace_getCubeAt_FUN_004678d0
