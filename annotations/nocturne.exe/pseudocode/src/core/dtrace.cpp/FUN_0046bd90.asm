...
section .text
    ...
    PUSH EBX                            ; 0046bd90
        ;   Label: core_dtrace.cpp_FUN_0046bd90
    PUSH ESI                            ; 0046bd91
    PUSH EDI                            ; 0046bd92
    PUSH EBP                            ; 0046bd93
    ...
    PUSH EAX                            ; 0046bf95
    CALL core_dtrace.cpp_FUN_0046c100   ; 0046bf96
        ;   XREF to: 0046c100 (UNCONDITIONAL_CALL)  ; undefined core_dtrace.cpp_FUN_0046c100()
