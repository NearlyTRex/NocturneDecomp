// Name: core_dtrace.cpp_FUN_0046bd90
// Address: 0046bd90
// Address Range: [[0046bd90, 0046bfdf]]
// Convention: unknown
// Signature: void core_dtrace_cpp_FUN_0046bd90(int param_1,float *param_2,undefined4 param_3,float *param_4,float *param_5)

#include "nocturne.h"

void core_dtrace_cpp_FUN_0046bd90(int param_1,float *param_2,uint param_3,float *param_4,float *param_5)
        ...
        do {
          ...
          if (0 < local_28) {
            do {
              ...
              core_dtrace_cpp_FUN_0046c100(param_1,&local_58);
              iVar4 = iVar4 + 1;
