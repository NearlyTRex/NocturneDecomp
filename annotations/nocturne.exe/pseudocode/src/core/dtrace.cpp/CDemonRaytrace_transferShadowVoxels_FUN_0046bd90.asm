...
;
; XREF[1]:
;   core_setcolid.cpp_FUN_00511aa0 at 00511afa
;
; Referenced Globals:
...
;   core_dtrace.cpp_CDemonRaytrace_restoreShadowBitFromBuffer_FUN_0046c100
...
section .text
    ...
    PUSH EBX                            ; 0046bd90
        ;   Label: core_dtrace.cpp_CDemonRaytrace_transferShadowVoxels_FUN_0046bd90
    PUSH ESI                            ; 0046bd91
    PUSH EDI                            ; 0046bd92
    PUSH EBP                            ; 0046bd93
    ...
    PUSH EAX                            ; 0046bdb0
    CALL core_dirmat.cpp_CMatrix3x3f_buildRotationMatrix_FUN_0044d7a0 ; 0046bdb1
    ...
    FLD1                                ; 0046bdfb
    FADDP                               ; 0046bdfd
    CALL crt_math.c_round_FUN_00563a30  ; 0046bdff
    ...
    FLD1                                ; 0046be22
    FADDP                               ; 0046be24
    CALL crt_math.c_round_FUN_00563a30  ; 0046be26
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_00563a30(double value)
    ...
    FLD1                                ; 0046be49
    FADDP                               ; 0046be4b
    CALL crt_math.c_round_FUN_00563a30  ; 0046be4d
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_00563a30(double value)
    ...
    CALL core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_0044da40 ; 0046bf45
    ...
    PUSH EAX                            ; 0046bf95
    CALL core_dtrace.cpp_CDemonRaytrace_restoreShadowBitFromBuffer_FUN_0046c100 ; 0046bf96
        ;   XREF to: 0046c100 (UNCONDITIONAL_CALL)  ; void core_dtrace.cpp_CDemonRaytrace_restoreShadowBitFromBuffer_FUN_0046c100(CDemonRaytrace * this_ptr, CVector3f * world_position)
