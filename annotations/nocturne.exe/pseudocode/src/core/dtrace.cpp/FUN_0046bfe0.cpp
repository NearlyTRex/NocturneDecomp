...
// Convention: unknown
// Signature: void FUN_0046bfe0(int param_1,undefined4 param_2)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_0046bfe0(int param_1,uint param_2)
  ...
  *(uint *)((int)&stack0xffffffc8 + (uint)bVar3 * -8 + (uint)bVar3 * -8) =
  ...
  if ((((-1 < local_40) && (-1 < local_3c)) && (-1 < local_38)) &&
    ...
    *(uint *)((int)&stack0xffffffd4 + (uint)bVar3 * -8 + (uint)bVar3 * -8) =
    ...
    local_30 = local_30 % 8;
    local_2c = local_2c % 8;
    piVar1 = (int *)FUN_004678d0(param_1,local_40,local_3c,local_38);
    if (piVar1 == (int *)0x0) {
