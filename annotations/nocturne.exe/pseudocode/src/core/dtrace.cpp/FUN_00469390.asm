...
section .text
    ...
    PUSH EAX                            ; 0046996a
    CALL FUN_0044aff0                   ; 0046996b
        ;   XREF to: 0044aff0 (UNCONDITIONAL_CALL)  ; undefined FUN_0044aff0()
    ...
    MOV dword ptr [0x01cc4804],EDI      ; 00469a01 | DAT_01cc4804
    CALL FUN_004c8440                   ; 00469a07
    ...
    PUSH EAX                            ; 00469ae2
    CALL FUN_00563a30                   ; 00469ae3
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    PUSH ECX                            ; 00469ae8
    FISTP dword ptr [ESP + 0x1c]        ; 00469ae9
    CALL FUN_0045f190                   ; 00469aed
        ;   XREF to: 0045f190 (UNCONDITIONAL_CALL)  ; undefined FUN_0045f190()
    ...
    PUSH EAX                            ; 00469b4f
    CALL FUN_00563a30                   ; 00469b50
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    PUSH ECX                            ; 00469b55
    FISTP dword ptr [ESP + 0x1c]        ; 00469b56
    CALL FUN_0045f190                   ; 00469b5a
        ;   XREF to: 0045f190 (UNCONDITIONAL_CALL)  ; undefined FUN_0045f190()
    ...
    PUSH EAX                            ; 00469c3a
    CALL FUN_00563a30                   ; 00469c3b
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    PUSH ECX                            ; 00469c40
    FISTP dword ptr [ESP + 0x1c]        ; 00469c41
    CALL FUN_0045f190                   ; 00469c45
        ;   XREF to: 0045f190 (UNCONDITIONAL_CALL)  ; undefined FUN_0045f190()
