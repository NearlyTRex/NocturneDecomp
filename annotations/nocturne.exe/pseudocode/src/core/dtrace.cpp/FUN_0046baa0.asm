...
section .text
    ...
    PUSH EBX                            ; 0046baa0
        ;   Label: core_dtrace.cpp_FUN_0046baa0
    PUSH ESI                            ; 0046baa1
    PUSH EDI                            ; 0046baa2
    PUSH EBP                            ; 0046baa3
    ...
    PUSH EAX                            ; 0046bca5
    CALL core_dtrace.cpp_FUN_0046bfe0   ; 0046bca6
        ;   XREF to: 0046bfe0 (UNCONDITIONAL_CALL)  ; undefined core_dtrace.cpp_FUN_0046bfe0()
