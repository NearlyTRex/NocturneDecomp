...
// Convention: __cdecl
// Signature: float __cdecl core_dtrace_cpp_CDemonRaytrace_rayVoxelIntersection_FUN_00467a00(CDemonRaytrace *this_ptr,CVector3f *ray_start,CVector3f *ray_end,CVector3f *out_intersection_point,int *out_intersection_type)
    ...
    if ((((local_50 < iVar5) || (local_70 < iVar5)) &&
      ...
      while( true ) {
        ...
        if (this_ptr_00 != (CDemonCube *)0x0) {
          local_48 = core_dcube_cpp_CDemonCube_rayIntersectTriangles_FUN_0044b290
