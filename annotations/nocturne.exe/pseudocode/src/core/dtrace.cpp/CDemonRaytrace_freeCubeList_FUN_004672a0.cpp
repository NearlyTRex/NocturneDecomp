...
// Convention: __cdecl
// Signature: void __cdecl core_dtrace_cpp_CDemonRaytrace_freeCubeList_FUN_004672a0(int param_1)
  ...
  if (*(int *)(param_1 + 0x4c) != 0) {
    ...
    for (iVar3 = 0;
      ...
      *puVar2 = 0;
      ...
      puVar2[0x15] = 0;
      if (puVar2[3] != 0) {
        uVar1 = core_dpart_cpp_CDemonPart_dtor_FUN_00456f40(puVar2[3],0);
        FUN_00564494(uVar1);
      }
      iVar4 = iVar4 + 0x58;
      puVar2[3] = 0;
