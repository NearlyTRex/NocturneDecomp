...
;
; XREF[1]:
;   core_dtrace.cpp_FUN_00467890 at 004678b6
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004676c0
        ;   Label: core_dtrace.cpp_FUN_004676c0
    PUSH ESI                            ; 004676c1
    PUSH EDI                            ; 004676c2
    PUSH EBP                            ; 004676c3
    ...
    PUSH EBX                            ; 004676cf
    CALL core_dtrace.cpp_FUN_004673a0   ; 004676d0
    ...
    CALL crt_stdio.c_fread_FUN_005636d0 ; 004676ea
    ...
    MOV dword ptr [0x01cc4800],ECX      ; 00467718 | PTR_01cc4800
    MOV dword ptr [0x01cc4804],ESI      ; 0046771e | INT_01cc4804
    ...
    PUSH EAX                            ; 00467734
    CALL crt_stdio.c_fread_FUN_005636d0 ; 00467735
        ;   XREF to: 005636d0 (UNCONDITIONAL_CALL)  ; SIZE_T crt_stdio.c_fread_FUN_005636d0(void * buffer, SIZE_T size, SIZE_T count, _FILE * file)
    ...
    PUSH EAX                            ; 00467745
    CALL crt_stdio.c_fread_FUN_005636d0 ; 00467746
        ;   XREF to: 005636d0 (UNCONDITIONAL_CALL)  ; SIZE_T crt_stdio.c_fread_FUN_005636d0(void * buffer, SIZE_T size, SIZE_T count, _FILE * file)
    ...
    PUSH EAX                            ; 00467756
    CALL crt_stdio.c_fread_FUN_005636d0 ; 00467757
        ;   XREF to: 005636d0 (UNCONDITIONAL_CALL)  ; SIZE_T crt_stdio.c_fread_FUN_005636d0(void * buffer, SIZE_T size, SIZE_T count, _FILE * file)
    ...
    PUSH EAX                            ; 00467767
    CALL crt_stdio.c_fread_FUN_005636d0 ; 00467768
        ;   XREF to: 005636d0 (UNCONDITIONAL_CALL)  ; SIZE_T crt_stdio.c_fread_FUN_005636d0(void * buffer, SIZE_T size, SIZE_T count, _FILE * file)
    ...
    PUSH EAX                            ; 00467778
    CALL crt_stdio.c_fread_FUN_005636d0 ; 00467779
        ;   XREF to: 005636d0 (UNCONDITIONAL_CALL)  ; SIZE_T crt_stdio.c_fread_FUN_005636d0(void * buffer, SIZE_T size, SIZE_T count, _FILE * file)
    ...
    PUSH EBX                            ; 004677d6
    CALL core_dtrace.cpp_CDemonRaytrace_allocNewCubeList_FUN_00467330 ; 004677d7
        ;   XREF to: 00467330 (UNCONDITIONAL_CALL)  ; void core_dtrace.cpp_CDemonRaytrace_allocNewCubeList_FUN_00467330(CDemonRaytrace * this_ptr)
    ...
    MOV dword ptr [0x01cc4800],ESI      ; 00467818 | PTR_01cc4800
    MOV dword ptr [0x01cc4804],EDI      ; 0046781e | INT_01cc4804
    ...
    MOV [0x01cc4800],EAX                ; 00467840 | PTR_01cc4800
    MOV dword ptr [0x01cc4804],EDX      ; 00467845 | INT_01cc4804
    ...
    MOV dword ptr [0x01cc4800],ECX      ; 00467870 | PTR_01cc4800
    MOV dword ptr [0x01cc4804],EBX      ; 00467876 | INT_01cc4804
