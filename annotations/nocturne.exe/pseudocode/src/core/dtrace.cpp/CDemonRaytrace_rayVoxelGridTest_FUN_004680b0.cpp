...

{
  ...
  local_8c = SUB84(__BITCAST_UINT64(dVar7),0);
  ...
  fStack_c0 = 6.474964e-39;
  dVar7 = floor((double)((fVar1 - fVar2) / fVar3));
  local_90 = SUB84(__BITCAST_UINT64(dVar7),0);
  ...
  if (((local_44 != fStack_74) || (local_48 != iStack_80)) ||
    ...
    fStack_c0 = 6.475232e-39;
    dVar7 = round((double)(ABS(fVar2) * fVar4));
    fStack_c4 = 6.475242e-39;
  ...
  while (((local_4c = iVar5, local_50 = fVar4, local_58 = fVar10,
          ...
          (local_44 = core_dcube_cpp_CDemonCube_rayIntersectTriangles_FUN_0044b290
