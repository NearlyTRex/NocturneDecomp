...
;
; Called Functions:
;   core_dtrace.cpp_CDemonRaytrace_loadBinary_FUN_004676c0
...
section .text
    ...
    PUSH EBX                            ; 00467890
        ;   Label: core_dtrace.cpp_CDemonRaytrace_loadAndSyncWithGeoFile_FUN_00467890
    ...
    PUSH ECX                            ; 004678b5
    CALL core_dtrace.cpp_CDemonRaytrace_loadBinary_FUN_004676c0 ; 004678b6
        ;   XREF to: 004676c0 (UNCONDITIONAL_CALL)  ; void core_dtrace.cpp_CDemonRaytrace_loadBinary_FUN_004676c0(CDemonRaytrace * this_ptr, _FILE * file_handle)
