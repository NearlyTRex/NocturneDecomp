...
;   core_water.cpp_CWater_calculateVisibleTiles_FUN_00550800 at 0055087d
;   core_weather.cpp_CWeather_createLightningStrike_FUN_00554d40 at 00554dbe
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 0046b9f0
        ;   Label: core_dtrace.cpp_CDemonRaytrace_getBBoxMax_FUN_0046b9f0
