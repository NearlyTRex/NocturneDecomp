...
// Signature: void __stack2_esi core_dtrace_cpp_CDemonRaytrace_worldPositionToGridCoords_FUN_0046b650(CDemonRaytrace *this_ptr,CVector3f *world_position,CVector3i *output_grid_coords)
...

{
  ...
  round(dVar6);
  puVar4 = (uint *)((int)output_grid_coords + (uint)bVar5 * -8 + 4);
  output_grid_coords->x = iVar7;
