...
;
; Called Functions:
;   core_curtain.cpp_CCurtain_renderMesh_FUN_0043f330
;
; *****************************************************************************
...
section .text
    ...
    PUSH EAX                            ; 0043f623
        ;   Label: LAB_0043f623
    CALL core_curtain.cpp_CCurtain_renderMesh_FUN_0043f330 ; 0043f624
        ;   XREF to: 0043f330 (UNCONDITIONAL_CALL)  ; int core_curtain.cpp_CCurtain_renderMesh_FUN_0043f330(CCurtain * this_ptr)
