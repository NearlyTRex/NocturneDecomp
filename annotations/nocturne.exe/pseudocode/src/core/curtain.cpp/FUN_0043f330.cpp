...
// Convention: unknown
// Signature: int core_curtain_cpp_FUN_0043f330(int param_1)
...

{
  ...
  iStack_c = core_box_cpp_CBoundingBox3D_isVisible_FUN_0041ceb0(uVar2);
  uVar2 = DAT_005ae704;
  if (iStack_c == 0) goto LAB_0043f5f0;
  *(uint *)(param_1 + 0x65b28) = 1;
  iVar3 = engine_drender_cpp_CDemonRenderer_getFaceCount_FUN_00461090(uVar2);
  ...
  core_set_cpp_CDemonSet_rotateVerticies_FUN_0050c200
            (0x01E57284,*(uint *)(param_1 + 0x1fc),(int *)(param_1 + 0x1c72c));
...
LAB_0043f474:
    ...
    core_set_cpp_CDemonSet_lightVerticies_FUN_0050c2d0
              (0x01E57284,*(uint *)(param_1 + 0x1fc),
               *(int *)(param_1 + 0x1c724) * *(int *)(param_1 + 0x1c728) * 2,iVar3,param_1 + 0x1c72c
               ,4,0);
    if (*(int *)(param_1 + 0x174) < 0xfde9) {
      for (iVar6 = 0; iVar6 < *(int *)(param_1 + 0x1c724) * *(int *)(param_1 + 0x1c728) * 2;
          iVar6 = iVar6 + 1) {
        engine_drender_cpp_CDemonRenderer_renderBlendedPoly_FUN_00460370(DAT_005ae704,iVar3);
        iVar3 = iVar3 + 0x48;
      }
    }
    else {
