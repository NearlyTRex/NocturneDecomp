...
// Convention: __cdecl
// Signature: int __cdecl core_curtain_cpp_FUN_0043f330(CCurtain *this_ptr)
...
LAB_0043f474:
    ...
    if (this_ptr->opacity < 0xfde9) {
      for (iVar3 = 0; iVar3 < (this_ptr->mesh).grid_cols * (this_ptr->mesh).grid_rows * 2;
          iVar3 = iVar3 + 1) {
        engine_drender_cpp_CDemonRenderer_renderBlendedPoly_FUN_00460370(DAT_005ae704,pSVar6);
