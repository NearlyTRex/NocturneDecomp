// Name: core_drone.cpp_CDrone_dtor_FUN_00463310
// Address: 00463310
// Address Range: [[00463310, 004633c8]]
// Convention: __cdecl
// Signature: CDrone * __cdecl core_drone_cpp_CDrone_dtor_FUN_00463310(CDrone *this_ptr,uint flags)
...

{
  ...
  if ((flags & 4) != 0) {
    ptr_00 = __vec_delete(this_ptr,&g_CDroneTypeInfo_0059c860);
