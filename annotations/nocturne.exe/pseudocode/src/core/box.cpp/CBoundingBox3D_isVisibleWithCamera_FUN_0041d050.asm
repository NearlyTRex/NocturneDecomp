...
section .text
    ...
    PUSH EBX                            ; 0041d050
        ;   Label: core_box.cpp_CBoundingBox3D_isVisibleWithCamera_FUN_0041d050
    PUSH ESI                            ; 0041d051
    PUSH EDI                            ; 0041d052
    PUSH EBP                            ; 0041d053
    ...
    MOV EAX,[0x005ae704]                ; 0041d0b8 | g_CDemonRenderer_PTR_005ae704
    ...
    PUSH ECX                            ; 0041d0e6
    MOV EBX,dword ptr [0x005ae704]      ; 0041d0e7 | g_CDemonRenderer_PTR_005ae704
    ...
    PUSH EBP                            ; 0041d0f6
    MOV EDI,dword ptr [0x005ae704]      ; 0041d0f7 | g_CDemonRenderer_PTR_005ae704
    ...
    CALL core_set.cpp_CDemonSet_renderSinglePrimitive_FUN_0050e490 ; 0041d1c8
        ;   XREF to: 0050e490 (UNCONDITIONAL_CALL)  ; int core_set.cpp_CDemonSet_renderSinglePrimitive_FUN_0050e490(CDemonSet * this_ptr, SMRGLHeaderPrimitive * prim)
    ...
    PUSH 0x1                            ; 0041d3f6
        ;   Label: LAB_0041d3f6
    MOV EBP,dword ptr [0x005ae704]      ; 0041d3f8 | g_CDemonRenderer_PTR_005ae704
    ...
    PUSH 0x1                            ; 0041d407
    MOV EAX,[0x005ae704]                ; 0041d409 | g_CDemonRenderer_PTR_005ae704
