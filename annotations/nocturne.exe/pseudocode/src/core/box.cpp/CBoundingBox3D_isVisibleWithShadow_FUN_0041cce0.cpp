...

{
  ...
  if (_DAT_014b9920 != (CDemonLight *)0x0) {
    ...
    local_20.x_max = g_Projection.center_x_fixed - g_Projection.half_width_fixed;
    local_20.y_max = g_Projection.center_y_fixed + g_Projection.neg_half_height_fixed;
    ...
    do {
      if ((int)((pSVar3->projected_vertex).screen_x & -0x80000000) == 0) {
        ...
        if ((pSVar3->projected_vertex).transformed_z <= (pSVar3->projected_vertex).transformed_x) {
          local_20.x_max = g_Projection.half_width_fixed + g_Projection.center_x_fixed;
        }
