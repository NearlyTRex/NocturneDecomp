...
// Convention: __cdecl
// Signature: void __cdecl core_box_cpp_CBox_processPhysics_FUN_0041ad10(float *param_1,float param_2)
  ...
  if (param_1[0x95] != 0.0) {
    ...
    *pfVar6 = *pfVar5 + *pfVar6;
    ...
    pfVar6 = (float *)core_dirmat_cpp_CMatrix3x3f_transformVector_FUN_0044da40
                                (param_1 + 6,local_2c0,param_1 + 0x16);
    ...
    *param_1 = *param_1 + local_248;
    ...
    core_dirmat_cpp_CMatrix3x3f_buildRotationMatrix_FUN_0044d7a0(&local_420,&local_17c);
    ...
    pfVar6 = (float *)core_dirmat_cpp_CMatrix3x3f_getEulerAngles_FUN_0044dbd0(param_1 + 6,local_170)
    ;
    if (param_1 + 3 != pfVar6) {
      param_1[3] = *pfVar6;
      param_1[4] = pfVar6[1];
    ...
    if (0 < (int)param_1[0x2c]) {
      ...
      do {
        pfVar7 = (float *)core_dirmat_cpp_CMatrix3x3f_transformVector_FUN_0044da40
                                    (local_44,local_20c,local_40 + iVar8 * 0xd);
    ...
    if (local_1c == 1) {
      ...
      *param_1 = *param_1 - local_1a0;
      ...
      core_dirmat_cpp_CMatrix3x3f_transformVectorTranspose_FUN_0044daa0
                (param_1 + 6,&local_194,local_50 + local_3d0[0] * 0xd + 10);
      pfVar6 = param_1 + 0x13;
      local_374 = *pfVar6;
    ...
    if (local_1c == 2) {
      ...
      param_1[2] = fVar1;
      pfVar6 = (float *)core_dirmat_cpp_CMatrix3x3f_transformVectorTranspose_FUN_0044daa0
                                  (param_1 + 6,puVar11,param_1 + local_3d0[1] * 0xd + 0x37);
      if (&local_338 != pfVar6) {
        local_338 = *pfVar6;
        local_334 = pfVar6[1];
        local_330 = pfVar6[2];
