...

{
  ...
  if (this_ptr->is_valid != 0) {
    ...
    local_18 = (float)core_dtrace_cpp_CDemonRaytrace_rayVoxelIntersection_FUN_00467a00
                                (&DAT_01fba938,&local_344.scrape_points[7].transformed_position.z,
                                 &local_344,local_344.scrape_points + 3,0);
    ...
    pCVar15 = &this_ptr->scrape_points[0].previous_position;
    do {
      if (pCVar15 != pCVar10) {
        pCVar15->x = pCVar10->x;
        pCVar15->y = pCVar10->y;
      ...
      pCVar15 = (CVector3f *)((int)(pCVar15 + 4) + 4);
    ...
    pfVar8 = (float *)core_dirmat_cpp_CMatrix3x3f_transformVectorTranspose_FUN_0044daa0
                                (&this_ptr->rotation_matrix,&local_344.linear_velocity.z,
                                 local_344.rotation_matrix.m + 1);
    pCVar10 = &this_ptr->linear_momentum;
    pCVar10->x = *pfVar8 + pCVar10->x;
    (this_ptr->linear_momentum).y = pfVar8[1] + (this_ptr->linear_momentum).y;
    pfVar9 = &this_ptr->mass;
    (this_ptr->linear_momentum).z = pfVar8[2] + (this_ptr->linear_momentum).z;
    local_344.linear_velocity_temp.z = pCVar10->x / *pfVar9;
    local_344.linear_momentum.x = (this_ptr->linear_momentum).y / *pfVar9;
    local_344.linear_momentum.y = (this_ptr->linear_momentum).z / *pfVar9;
    ...
    pfVar9 = (float *)core_dirmat_cpp_CMatrix3x3f_transformVector_FUN_0044da40
                                (&this_ptr->rotation_matrix,&local_344.angular_velocity_temp.z,
                                 &this_ptr->linear_velocity_temp);
    local_344.extents.y = *pfVar9 * delta_time;
    local_344.extents.z = pfVar9[1] * delta_time;
    local_344.scrape_point_count = (int)(delta_time * pfVar9[2]);
    ...
    pfVar9 = (float *)core_dirmat_cpp_CMatrix3x3f_transformVectorTranspose_FUN_0044daa0
                                (&this_ptr->rotation_matrix,
                                 &local_344.scrape_points[0].transformed_position,pCVar10);
    if (&this_ptr->linear_velocity_local != (CVector3f *)pfVar9) {
      (this_ptr->linear_velocity_local).x = *pfVar9;
      (this_ptr->linear_velocity_local).y = pfVar9[1];
      (this_ptr->linear_velocity_local).z = pfVar9[2];
    }
    ...
    fVar1 = SQRT(fVar2 * (this_ptr->angular_velocity).z +
                 pCVar10->x * pCVar10->x + fVar1 * (this_ptr->angular_velocity).y);
    ...
    for (iVar11 = 10; iVar11 != 0; iVar11 = iVar11 + -1) {
      pCVar16->m[0].x = *pfVar9;
      pfVar9 = pfVar9 + (uint)bVar18 * -2 + 1;
      pCVar16 = (CMatrix3x3f *)((int)pCVar16 + (uint)bVar18 * -8 + 4);
    }
    pCVar10 = core_dirmat_cpp_CMatrix3x3f_getEulerAngles_FUN_0044dbd0
                        (&this_ptr->rotation_matrix,
    ...
    if (0 < this_ptr->scrape_point_count) {
      ...
      do {
        pfVar9 = (float *)core_dirmat_cpp_CMatrix3x3f_transformVector_FUN_0044da40
                                    (local_44,&local_344.scrape_points[2].previous_position.y,
                                     local_40 + iVar11);
        local_e0 = (this_ptr->position).x + *pfVar9;
        local_dc = (this_ptr->position).y + pfVar9[1];
        local_d8 = (this_ptr->position).z + pfVar9[2];
      ...
      do {
        ...
        if (this_ptr[1].position.x <= pCVar14->scrape_points[0].transformed_position.y) {
          ...
          if ((float)0.01 <
            ...
            local_18 = (float)core_dtrace_cpp_CDemonRaytrace_rayVoxelIntersection_FUN_00467a00
                                        (&DAT_01fba938,local_6c,pCVar10,&local_28->raytrace_normal,0
                                        );
            pCVar14->scrape_points[0].raytrace_intersection = local_18;
            fVar1 = pCVar14->scrape_points[0].raytrace_intersection;
          ...
          fVar1 = pCVar14->scrape_points[0].transformed_position.y;
          ...
          pCVar14->scrape_points[0].raytrace_intersection = (fVar3 - fVar4) / (fVar1 - fVar2);
          local_3d0[local_1c] = local_20;
          local_1c = local_1c + 1;
        }
        pCVar10 = (CVector3f *)((int)(pCVar10 + 4) + 4);
        local_20 = (float)((int)local_20 + 1);
        local_6c = (CVector3f *)((int)(local_6c + 4) + 4);
        local_28 = local_28 + 1;
    ...
    if (local_1c == 1) {
      ...
      core_dirmat_cpp_CMatrix3x3f_transformVectorTranspose_FUN_0044daa0
                (&this_ptr->rotation_matrix,&local_344.scrape_points[4].raytrace_normal.y,
      ...
      local_344.scrape_points[6].transformed_position.x = local_bc * *pfVar9;
      local_344.scrape_points[6].transformed_position.y = local_b8 * *pfVar9;
      local_344.scrape_points[6].transformed_position.z = local_b4 * *pfVar9;
      ...
      pSVar12 = this_ptr->scrape_points + (int)fVar1;
      ...
      local_344.scrape_points[7].transformed_position.x =
           (pSVar12->local_position).z * (float)local_344.dead -
      ...
      local_344.scrape_points[7].transformed_position.y =
           ...
           (pSVar12->local_position).y * (float)local_344.dead;
      ...
      local_8c = 0.0;
      local_84 = 0.0;
      local_88 = this_ptr->mass * (float)32;
      pfVar9 = (float *)core_dirmat_cpp_CMatrix3x3f_transformVectorTranspose_FUN_0044daa0
                                  (&this_ptr->rotation_matrix,
                                   &local_344.scrape_points[5].local_position.y,&local_8c);
      if (&local_8c != pfVar9) {
        local_8c = *pfVar9;
        local_88 = pfVar9[1];
        local_84 = pfVar9[2];
    ...
    if (local_1c == 2) {
      ...
      if (SQRT(local_344.scrape_points[4].previous_position.y *
        ...
        pfVar9 = &local_344.scrape_points[7].raytrace_normal.y;
        ...
        pfVar9 = &local_344.scrape_points[3].raytrace_normal.z;
        (this_ptr->position).y =
      ...
      pfVar9 = (float *)core_dirmat_cpp_CMatrix3x3f_transformVectorTranspose_FUN_0044daa0
                                  (&this_ptr->rotation_matrix,pfVar9,
                                   &this_ptr->scrape_points[(int)local_3d0[1]].raytrace_normal);
      if (&local_344.orientation != (CVector3f *)pfVar9) {
        local_344.orientation.x = *pfVar9;
        local_344.orientation.y = pfVar9[1];
        local_344.orientation.z = pfVar9[2];
      }
      pCVar10 = &this_ptr->linear_velocity_local;
      local_368 = pCVar10->x;
      ...
      local_c8 = local_344.scrape_points[0].raytrace_normal.z * *pfVar9;
      local_c4 = local_344.scrape_points[1].local_position.x * *pfVar9;
      local_c0 = local_344.scrape_points[1].local_position.y * *pfVar9;
      ...
      pfVar9 = (float *)core_dirmat_cpp_CMatrix3x3f_transformVectorTranspose_FUN_0044daa0
                                  (&this_ptr->rotation_matrix,&local_344.angular_velocity.z,
                                   &local_344.linear_velocity_local.z);
      local_344.scrape_points[1].transformed_position.y = 0.5f;
      if (&local_344.linear_velocity_local.z != pfVar9) {
        local_344.linear_velocity_local.z = *pfVar9;
        local_344.linear_velocity_temp.x = pfVar9[1];
        local_344.linear_velocity_temp.y = pfVar9[2];
      }
    ...
    if (2 < local_1c) {
      ...
      if (&local_344.moment_of_inertia.y != &local_344.scrape_points[2].transformed_position.y) {
        local_344.moment_of_inertia.y =
             local_344.scrape_points[0].previous_position.x * fVar1 - pCVar10->x;
      ...
      (this_ptr->linear_momentum).x =
           ...
           (this_ptr->linear_velocity_local).x) * *pfVar9 * fVar5;
      (this_ptr->linear_momentum).y =
