...
// Convention: __cdecl
// Signature: void __cdecl core_box_cpp_CBoundingBox3D_render_FUN_0041dcc0(float *param_1)
...

{
  ...
  piVar2 = local_b0;
  do {
    core_box_cpp_CBoundingBox3D_getCorner_FUN_0041cc70(param_1,&local_1c,iVar1);
    iVar1 = iVar1 + 1;
