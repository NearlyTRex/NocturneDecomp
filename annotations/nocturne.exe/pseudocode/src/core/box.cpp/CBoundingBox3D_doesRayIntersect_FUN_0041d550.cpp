...
// Convention: __cdecl
// Signature: float __cdecl core_box_cpp_CBoundingBox3D_doesRayIntersect_FUN_0041d550(CBoundingBox3D *this_ptr,CVector3f *ray_origin,CVector3f *ray_direction,CVector3f *out_normal)
