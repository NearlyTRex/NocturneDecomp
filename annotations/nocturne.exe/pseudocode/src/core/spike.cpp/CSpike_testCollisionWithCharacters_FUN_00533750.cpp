// Name: core_spike.cpp_CSpike_testCollisionWithCharacters_FUN_00533750
// Address: 00533750
// Address Range: [[00533750, 00533c8b]]
// Convention: __cdecl
// Signature: void __cdecl core_spike_cpp_CSpike_testCollisionWithCharacters_FUN_00533750(CSpike *this_ptr)

#include "nocturne.h"

void __cdecl core_spike_cpp_CSpike_testCollisionWithCharacters_FUN_00533750(CSpike *this_ptr)

{
  ...
  core_box_cpp_CBoundingBox3D_reset_FUN_0041dbc0(&CStack_d4);
  corner_index = 0;
  point = aCStack_1cc;
  __arrinit(aCStack_1cc,8,&g_CVectorTypeInfo_005993b0);
  do {
    pCVar4 = core_box_cpp_CBoundingBox3D_getCorner_FUN_0041cc70(&local_ec,&CStack_50,corner_index);
    ...
    core_box_cpp_CBoundingBox3D_expand_FUN_0041cc00(&CStack_d4,point);
    point = point + 1;
  ...
  for (iStack_1c = 0; iStack_1c < g_CDemonSet_PTR_005be368->character_count;
    ...
    if (fVar2 * fVar2 + fVar3 * fVar3 + fVar1 * fVar1 <= fStack_2c) {
      ...
      if (EStack_28 != COLLISION_TYPE_NONE) {
        ...
        fStack_18 = core_actor_cpp_CDemonActor_rayIntersect_FUN_0040a740
                              (&this_ptr_00->base,&CStack_80,&CStack_98,&SStack_108,&SStack_130,
                               EStack_28,&CStack_d4);
        if ((0.0 <= fStack_18) && (fStack_18 <= 1.0)) {
          ...
          core_charactr_cpp_SDamageInfo_ctor_FUN_00423ed0(&SStack_16c);
