...
// Convention: unknown
// Signature: undefined4 * core_spike_cpp_CSpike_getBoundingBox_FUN_005335a0(int param_1,undefined4 *param_2)

#include "nocturne.h"

uint * core_spike_cpp_CSpike_getBoundingBox_FUN_005335a0(int param_1,uint *param_2)
