...
// Convention: unknown
// Signature: void FUN_00441c50(int param_1,int param_2,int *param_3)
...

{
  ...
  local_3c = 0x80;
  local_40 = 0;
  iVar1 = FUN_005649c0(param_2 + 0x1c74,"@movscrn.raw" + 1);
  if (iVar1 == 0) {
    local_40 = 1;
    local_3c = 0x100;
  }
            ...
            *local_24 = 0;
            ...
            if ((local_40 != 0) ||
              ...
              *local_20 = local_5c - local_3c;
              iVar1 = FUN_0044ec60(param_2,&stack0xffffff9c,local_18,local_2c);
              *local_1c = iVar1;
              if (iVar1 != 0) {
