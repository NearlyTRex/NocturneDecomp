...
;                               FUNCTION
; *****************************************************************************
; void __cdecl core_dcamera_cpp_CDemonCamera_saveBackdrop_FUN_00446810(CDemonCamera *this_ptr)
;
; Parameters:
...
;
; XREF[1]:
;   core_dcamera.cpp_CDemonCamera_precomputeNormals_FUN_004421b0 at 00442402
;
; Referenced Globals:
...
;   support_codec.cpp_CCodec_processFromBuffer_FUN_004390b0
;   support_codec.cpp_CLZWCompress_ctor_FUN_00439830
;   ... and 3 more
;
; *****************************************************************************
...
section .text
    ...
    PUSH ESI                            ; 00446810
        ;   Label: core_dcamera.cpp_CDemonCamera_saveBackdrop_FUN_00446810
    PUSH EDI                            ; 00446811
    PUSH EBP                            ; 00446812
    ...
    MOV EAX,[0x0140e790]                ; 00446841 | g_SFogGrid_0140d784.scroll_vector.x
    MOV EDI,dword ptr [0x0140e794]      ; 00446846 | g_SFogGrid_0140d784.scroll_vector.y
    MOV EBP,dword ptr [0x0140e798]      ; 0044684c | g_SFogGrid_0140d784.scroll_vector.z
    ...
    CALL engine_dosio.cpp_getFile_FUN_00456a60 ; 00446894
    ...
    PUSH EAX                            ; 004468b3
    CALL crt_stdio.c_sprintf_FUN_00563c90 ; 004468b4
        ;   XREF to: 00563c90 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_sprintf_FUN_00563c90(char * buffer, char * format)
    ...
    PUSH EAX                            ; 004468d9
    CALL crt_fstream.cpp_ofstream_ctor_FUN_0056511e ; 004468da
    ...
    MOV dword ptr [0x01cc4800],ESI      ; 00446903 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EDI      ; 00446909 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 0044690f
    ...
    PUSH EAX                            ; 00446928
    CALL crt_fstream.cpp_ostream_write_FUN_00565a13 ; 00446929
    ...
    MOV EBP,dword ptr [0x0140e7a0]      ; 0044692e | g_SFogGrid_0140d784.density_multiplier
    ...
    PUSH EAX                            ; 0044695d
    CALL crt_fstream.cpp_ostream_write_FUN_00565a13 ; 0044695e
        ;   XREF to: 00565a13 (UNCONDITIONAL_CALL)  ; _ostream * crt_fstream.cpp_ostream_write_FUN_00565a13(_ostream * stream, void * buffer, SIZE_T count)
    ...
    FMUL ST1                            ; 0044698d
    PUSH 0x6                            ; 0044698f
    CALL crt_math.c_round_FUN_00563a30  ; 00446991
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_00563a30(double value)
    FISTP dword ptr [ESP + 0x224]       ; 00446996
    FMUL float ptr [EAX + 0x10c]        ; 0044699d
    PUSH 0x10000                        ; 004469a3
    LEA EAX,[ESP + 0x1ec]               ; 004469a8
    CALL crt_math.c_round_FUN_00563a30  ; 004469af
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; double crt_math.c_round_FUN_00563a30(double value)
    PUSH EAX                            ; 004469b4
    FISTP dword ptr [ESP + 0x230]       ; 004469b5
    CALL support_codec.cpp_CLZWCompress_ctor_FUN_00439830 ; 004469bc
    ...
    PUSH EAX                            ; 004469cb
    CALL support_codec.cpp_CLZWCompress_init_FUN_00439880 ; 004469cc
    ...
    CALL core_dcamera.cpp_updateFogScrollOffset_FUN_0043fe60 ; 00446a0c
        ;   XREF to: 0043fe60 (UNCONDITIONAL_CALL)  ; void core_dcamera.cpp_updateFogScrollOffset_FUN_0043fe60(SFogGrid * fog_ptr, int time_major, int time_minor)
    ...
    CALL core_dcamera.cpp_CDemonCamera_copyFogPlaneToBuffer_FUN_00446ea0 ; 00446b5f
        ;   XREF to: 00446ea0 (UNCONDITIONAL_CALL)  ; void core_dcamera.cpp_CDemonCamera_copyFogPlaneToBuffer_FUN_00446ea0(CDemonCamera * this_ptr, int plane_index)
    ...
    PUSH EAX                            ; 00446cfb
    CALL support_codec.cpp_CCodec_processFromBuffer_FUN_004390b0 ; 00446cfc
        ;   XREF to: 004390b0 (UNCONDITIONAL_CALL)  ; int support_codec.cpp_CCodec_processFromBuffer_FUN_004390b0(CCodec * this_ptr, char * input, int * input_length, _ostream * ostream)
    ...
    MOV dword ptr [0x01cc4800],ESI      ; 00446d2d | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EDI      ; 00446d33 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 00446d39
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
    ...
    PUSH EAX                            ; 00446da3
    CALL support_codec.cpp_CLZWCompress_finalize_FUN_004399a0 ; 00446da4
    ...
    PUSH EAX                            ; 00446db5
    CALL support_codec.cpp_CLZWDictionary_dtor_FUN_00439370 ; 00446db6
    ...
    PUSH EAX                            ; 00446dc7
    CALL support_codec.cpp_CCodec_dtor_FUN_00438f30 ; 00446dc8
    ...
    PUSH EAX                            ; 00446dd9
    CALL crt_fstream.cpp_ofstream_dtor_FUN_005651ca ; 00446dda
    ...
    PUSH EAX                            ; 00446ded
        ;   Label: LAB_00446ded
    CALL crt_stdio.c_fclose_FUN_00563380 ; 00446dee
    ...
    PUSH EAX                            ; 00446e08
    CALL crt_fstream.cpp_ofstream_dtor_FUN_005651ca ; 00446e09
        ;   XREF to: 005651ca (UNCONDITIONAL_CALL)  ; ofstream * crt_fstream.cpp_ofstream_dtor_FUN_005651ca(void * this_ptr, uint flags)
    ...
    MOV dword ptr [0x01cc4800],EDX      ; 00446e4d | g_CurrentFilename
    MOV dword ptr [0x01cc4804],ECX      ; 00446e53 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 00446e59
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
    ADD ESP,0x8                         ; 00446e5e
    JMP 0x00446d0c                      ; 00446e61
        ;   XREF to: 00446d0c (UNCONDITIONAL_JUMP)  ; LAB_00446d0c
    MOV dword ptr [0x01cc4800],0x57baa1 ; 00446e66 | g_CurrentFilename | = "..\\core\\dcamera.cpp"
        ;   Label: LAB_00446e66
    LEA EAX,[ESP + 0x180]               ; 00446e70
    PUSH EAX                            ; 00446e77
    MOV EDX,0x1340                      ; 00446e78
    PUSH 0x57bab5                       ; 00446e7d | = "Error writing compressed file %s"
    MOV dword ptr [0x01cc4804],EDX      ; 00446e82 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 00446e88
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
