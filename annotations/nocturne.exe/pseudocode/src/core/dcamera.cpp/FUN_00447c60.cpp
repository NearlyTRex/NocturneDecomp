// Name: core_dcamera.cpp_FUN_00447c60
// Address: 00447c60
// Address Range: [[00447c60, 00447d0c]]
// Convention: unknown
// Signature: void core_dcamera_cpp_FUN_00447c60(int param_1,int param_2,int param_3,int param_4)
...

{
  ...
  core_dstrender_cpp_blendLightmapSharedU32toU16pNoBiasPx1MMX_FUN_00466886
            ((ushort *)
             ...
             (uint *)(*(int *)(param_1 + 0x13c) * param_3 * 4 + *(int *)(param_1 + 0x158) +
                     param_2 * 4),(byte *)(iVar2 + 0xaafdb8 + iVar1 + param_4),
             &DAT_012ceb78 + param_4 + iVar1 + iVar2);
  return;
}
