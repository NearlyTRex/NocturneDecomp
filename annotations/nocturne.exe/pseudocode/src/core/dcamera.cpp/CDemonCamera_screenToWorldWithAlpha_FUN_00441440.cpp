...
// Signature: CVector3i * __stack2_esi core_dcamera_cpp_CDemonCamera_screenToWorldWithAlpha_FUN_00441440(CDemonCamera *this_ptr,CVector3i *input_ptr,CVector3i *output_ptr)
...

{
  ...
  if (iVar4 == 0) {
    ...
    lVar3 = (longlong)this_ptr->alpha_transform_matrices[0xf][iVar4] * (longlong)local_20;
    ...
    lVar3 = (longlong)this_ptr->alpha_transform_matrices[0x10][iVar4] * (longlong)local_20;
    ...
    lVar3 = (longlong)this_ptr->alpha_transform_matrices[0x11][iVar4] * (longlong)local_20;
