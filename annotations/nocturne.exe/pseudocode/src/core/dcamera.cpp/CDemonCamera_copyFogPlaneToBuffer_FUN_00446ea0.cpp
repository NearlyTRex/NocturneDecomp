...

{
  ...
  for (iVar5 = 1; iVar4 = iVar4 + 0x140, iVar5 < this_ptr->display_height + -1; iVar5 = iVar5 + 1) {
    ...
    while( true ) {
      ...
      iVar3 = iVar3 + 1;
      *(byte *)((int)&g_VOID_PTR_012e1778 + iVar1 + 1) = (&DAT_012ceb79)[iVar2];
      iVar2 = iVar2 + 1;
      iVar1 = iVar1 + 1;
    }
  }
  ...
  if (0 < this_ptr->display_height) {
    ...
    do {
      *(byte *)((int)&g_VOID_PTR_012e1778 + iVar5) = (&DAT_012ceb78)[iVar4 * 0x140];
  ...
  while (iVar5 < this_ptr->display_width + -1) {
    *(byte *)((int)&g_VOID_PTR_012e1778 + iVar4 + 1) = (&DAT_012ceb78)[iVar5];
