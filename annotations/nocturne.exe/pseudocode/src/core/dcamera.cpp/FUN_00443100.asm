...
section .text
    ...
    PUSH EBX                            ; 00443100
        ;   Label: core_dcamera.cpp_FUN_00443100
    PUSH ESI                            ; 00443101
    PUSH EDI                            ; 00443102
    PUSH EBP                            ; 00443103
    MOV EBP,dword ptr [0x005b7624]      ; 00443104 | DAT_005b7624
    ...
    MOV CL,byte ptr [0x01c00624]        ; 00443129 | DAT_01c00624
    SHL EDI,CL                          ; 0044312f
    MOV CL,byte ptr [0x01c00630]        ; 00443131 | DAT_01c00630
    SHL ESI,CL                          ; 00443137
    MOV CL,byte ptr [0x01c0063c]        ; 00443139 | DAT_01c0063c
    SHL EBX,CL                          ; 0044313f
    OR EDI,ESI                          ; 00443141
    ...
    MOV dword ptr [0x005b7624],EBP      ; 0044315b | DAT_005b7624
    POP EBP                             ; 00443161
    POP EDI                             ; 00443162
    POP ESI                             ; 00443163
    POP EBX                             ; 00443164
