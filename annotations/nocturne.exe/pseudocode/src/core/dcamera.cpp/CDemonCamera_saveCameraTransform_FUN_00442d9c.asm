...
section .text
    ...
    PUSH EDI                            ; 00442d9c
        ;   Label: core_dcamera.cpp_CDemonCamera_saveCameraTransform_FUN_00442d9c
    PUSH ESI                            ; 00442d9d
    PUSH EBX                            ; 00442d9e
    ...
    FMUL float ptr [0x0059bddc]         ; 00442e95 | FLOAT_0059bddc
    FISTP dword ptr [EBX]               ; 00442e9b
    FLD float ptr [EAX + 0x4]           ; 00442e9d
    FMUL float ptr [0x0059bddc]         ; 00442ea0 | FLOAT_0059bddc
    FISTP dword ptr [EBX + 0x4]         ; 00442ea6
    FLD float ptr [EAX + 0x8]           ; 00442ea9
    FMUL float ptr [0x0059bddc]         ; 00442eac | FLOAT_0059bddc
