...
// Convention: unknown
// Signature: void core_dcamera_cpp_CDemonCamera_worldToScreenWithFrustumCull_FUN_00441610(int param_1,int *param_2)
...

{
  ...
  bVar6 = 0;
  iVar5 = engine_drender_cpp_CDemonRenderer_getAlphaMask_FUN_004613b0(DAT_005ae704);
  if (iVar5 == 0) {
