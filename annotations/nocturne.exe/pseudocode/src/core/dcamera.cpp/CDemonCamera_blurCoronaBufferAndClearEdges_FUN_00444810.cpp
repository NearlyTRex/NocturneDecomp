...
// Convention: __cdecl
// Signature: undefined8 __cdecl core_dcamera_cpp_CDemonCamera_blurCoronaBufferAndClearEdges_FUN_00444810(int param_1)

#include "nocturne.h"

ulonglong __cdecl core_dcamera_cpp_CDemonCamera_blurCoronaBufferAndClearEdges_FUN_00444810(int param_1)

{
  ...
  while( true ) {
    ...
    core_dstrender_cpp_verticalBlur3TapMMXStride320_FUN_00465382
              (iVar1,iVar2,*(uint *)(param_1 + 0x150));
    iVar3 = iVar3 + 1;
  }
  iVar1 = 0;
