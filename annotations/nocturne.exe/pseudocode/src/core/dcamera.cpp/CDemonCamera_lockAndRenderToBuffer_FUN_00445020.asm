...
;   wincore_windll.cpp_lockHoldBuffer_FUN_00532d60
;   wincore_windll.cpp_unlockHoldBuffer_FUN_00532d80
;
; *****************************************************************************
...
section .text
    ...
    CALL wincore_windll.cpp_lockFrame_FUN_005322e0 ; 0044502e
    ...
    MOV ESI,dword ptr [ESP + 0xc]       ; 00445033
        ;   Label: LAB_00445033
    PUSH ESI                            ; 00445037
    CALL FUN_004470f0                   ; 00445038
        ;   XREF to: 004470f0 (UNCONDITIONAL_CALL)  ; undefined FUN_004470f0()
    ...
    CALL wincore_windll.cpp_unlockHoldBuffer_FUN_00532d80 ; 0044504e
        ;   XREF to: 00532d80 (UNCONDITIONAL_CALL)  ; undefined wincore_windll.cpp_unlockHoldBuffer_FUN_00532d80()
    CMP dword ptr [0x02dc9d60],0x0      ; 00445053 | DAT_02dc9d60
    ...
    RET                                 ; 00445060
    CALL wincore_windll.cpp_lockHoldBuffer_FUN_00532d60 ; 00445061
        ;   XREF to: 00532d60 (UNCONDITIONAL_CALL)  ; undefined wincore_windll.cpp_lockHoldBuffer_FUN_00532d60()
        ;   Label: LAB_00445061
    ...
    MOV dword ptr [0x01cc4804],EBX      ; 00445080 | DAT_01cc4804
    CALL FUN_004c8440                   ; 00445086
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; undefined FUN_004c8440()
    ADD ESP,0x4                         ; 0044508b
    POP EBX                             ; 0044508e
    JMP 0x00445033                      ; 0044508f
        ;   XREF to: 00445033 (UNCONDITIONAL_JUMP)  ; LAB_00445033
    CALL FUN_00532320                   ; 00445091
        ;   XREF to: 00532320 (UNCONDITIONAL_CALL)  ; undefined FUN_00532320()
        ;   Label: LAB_00445091
    CMP dword ptr [0x02dc9d60],0x0      ; 00445096 | DAT_02dc9d60
    JNZ 0x004450a2                      ; 0044509d
        ;   XREF to: 004450a2 (CONDITIONAL_JUMP)  ; LAB_004450a2
    POP EDI                             ; 0044509f
    POP ESI                             ; 004450a0
    RET                                 ; 004450a1
    CALL wincore_windll.cpp_beginScene_FUN_00532340 ; 004450a2
