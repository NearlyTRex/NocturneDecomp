...
;
; XREF[1]:
;   core_set.cpp_CDemonSet_renderScene_FUN_00509a80 at 00509c34
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00445750
        ;   Label: core_dcamera.cpp_CDemonCamera_renderGlobeCoronas_FUN_00445750
    PUSH ESI                            ; 00445751
    PUSH EDI                            ; 00445752
    PUSH EBP                            ; 00445753
    ...
    CALL core_dglobe.cpp_CDemonGlobe_renderCorona_FUN_0044ce80 ; 0044593e
        ;   XREF to: 0044ce80 (UNCONDITIONAL_CALL)  ; void core_dglobe.cpp_CDemonGlobe_renderCorona_FUN_0044ce80(CDemonGlobe * this_ptr)
    ...
    CALL core_dcamera.cpp_blendCoronaTextureSpan_FUN_00445650 ; 004459f8
        ;   XREF to: 00445650 (UNCONDITIONAL_CALL)  ; void core_dcamera.cpp_blendCoronaTextureSpan_FUN_00445650(int scanline_y, int x_start, int x_end, SCoronaLightEntry * source_entry)
