...
// Convention: unknown
// Signature: void FUN_00443250(int param_1,char *param_2)
...
LAB_00443299:
  ...
  iVar5 = FUN_00456a60("backdrop",local_144,&DAT_0057b85b);
  if ((iVar5 != 0) || (iVar5 = FUN_00456a60(&DAT_0057b86a,local_144,&DAT_0057b867), iVar5 != 0)) {
    FUN_005636d0(&DAT_00b0daf8,0x100,3,iVar5);
    FUN_00563380(iVar5);
    pcVar22 = local_f4;
    pcVar24 = param_2;
    do {
...
LAB_00443363:
    ...
    local_14 = FUN_00456a60("backdrop",local_f4,&DAT_0057b8a8);
    if (local_14 != 0) {
      FUN_005636d0(0x140d784,0x1000,1,local_14);
      iVar5 = local_14;
      if (_DAT_0140e7a0 == 0) {
        FUN_00563cc0(0x12e1778,0,0x12c000);
      }
      else {
        _DAT_0140d780 = 0x10;
        ...
        FUN_005636d0(local_a0,3,1,local_14);
        local_9d = 0;
        iVar6 = FUN_005649c0(local_a0,&DAT_0057b8b4);
        if ((iVar6 == 0) || (iVar6 = FUN_005649c0(local_a0,&DAT_0057b8b8), iVar6 == 0)) {
          iVar5 = FUN_004568c0("backdrop",local_f4);
          ...
          FUN_005636d0(&DAT_0077d250,local_9c,1,local_14);
          FUN_00439a30(0x12cdb28);
          local_98 = _DAT_0140d780 * 0x12c00;
          iVar5 = FUN_00439b30(0x12cdb28,&DAT_0077d250,&local_9c,0x12e1778,&local_98,1);
          if (iVar5 == 0) {
            _DAT_01cc4800 = "..\\core\\dcamera.cpp";
            _DAT_01cc4804 = 0x9c4;
          ...
          FUN_0056582c(iVar5,0xfffffffd,1);
          FUN_005636d0(0x12e1778,0x12c00,_DAT_0140d780,iVar5);
        }
      }
      FUN_00563380(local_14);
    }
    iVar5 = FUN_00456a60("backdrop",param_2,&DAT_0057b955);
    if ((iVar5 != 0) || (iVar5 = FUN_00456a60(&DAT_0057b964,param_2,&DAT_0057b961), iVar5 != 0)) {
      iVar15 = 0;
      iVar6 = 0;
      do {
      ...
      FUN_005636d0(&DAT_01410290,0x280,0x1e0,iVar5);
      FUN_00563380(iVar5);
      ...
      FUN_00461eb0(DAT_005ae704,&DAT_005ad49c);
      ...
      FUN_00461f60(DAT_005ae704,&DAT_005ad49c,&DAT_00b0daf8);
      FUN_00481980(0x12d40);
