...
section .text
    ...
    PUSH EBX                            ; 00441c50
        ;   Label: core_dcamera.cpp_CDemonCamera_precomputeLight_FUN_00441c50
    PUSH ESI                            ; 00441c51
    PUSH EDI                            ; 00441c52
    PUSH EBP                            ; 00441c53
    ...
    MOV dword ptr [0x01cc4800],ESI      ; 00441d63 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EDI      ; 00441d69 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 00441d6f
    ...
    CALL core_dcamera.cpp_CDemonCamera_worldToScreenWithFrustumCull_FUN_00441610 ; 00442098
