...
;   core_dcamera.cpp_CDemonCamera_saveBackdrop_FUN_00446810
...
section .text
    ...
    PUSH EBX                            ; 004421b0
        ;   Label: core_dcamera.cpp_CDemonCamera_precomputeNormals_FUN_004421b0
    PUSH ESI                            ; 004421b1
    PUSH EDI                            ; 004421b2
    PUSH EBP                            ; 004421b3
    ...
    CALL core_dcamera.cpp_CDemonCamera_saveBackdrop_FUN_00446810 ; 00442402
        ;   XREF to: 00446810 (UNCONDITIONAL_CALL)  ; void core_dcamera.cpp_CDemonCamera_saveBackdrop_FUN_00446810(CDemonCamera * this_ptr)
