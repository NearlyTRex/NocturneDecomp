...
// Convention: unknown
// Signature: uint FUN_0054eae0(int param_1,float param_2)
...

{
  ...
  FUN_0043b800((int *)(param_1 + 0x1018),local_28,&local_70,local_7c);
  ...
  *(float *)(param_1 + 0x1024) = fVar3;
  ...
  local_14 = *(int *)(param_1 + 0x1018);
  local_28 = (*(float *)(param_1 + 0x1024) / *(float *)(param_1 + 0x1028)) * (float)local_14;
  FUN_0043b800((int *)(param_1 + 0x1018),local_28,(float *)(param_1 + 0x20),param_1 + 0x30);
  ...
  puVar5 = (uint *)FUN_0040a220(param_1,local_4c,param_1 + 0x8bc);
  ...
  *(float *)(param_1 + 0x34) = fVar3;
  ...
  for (iVar10 = 0; iVar10 < *(int *)(0x01E57284 + 0x14ecb0); iVar10 = iVar10 + 1) {
    ...
    iVar6 = FUN_0040d890(iVar9,_DAT_01ccdc10);
    if ((iVar6 == 0) || (param_1 != *(int *)(iVar6 + 0xbd48))) {
      FUN_00511990(auStack_c8);
      ...
      if ((iVar6 == 2) &&
         ((((*(float *)(iVar9 + 0x24) <= *(float *)(param_1 + 0x24) + fStack_90 &&
           ...
           (FUN_0040a290(param_1,afStack_64,iVar9 + 0x20), local_a0 <= afStack_64[0] + fStack_ac))
          && ((afStack_64[0] - fStack_ac <= fStack_94 && (fStack_98 <= fStack_5c + fStack_ac)))))) {
        if (fStack_5c - fStack_ac <= fStack_8c) {
          FUN_00423ed0(auStack_104);
          uStack_d4 = 4;
          ...
          (**(code **)(*(int *)(iVar9 + 0x14c) + 0x100))(iVar9,auStack_104);
                ...
                (iVar9 = FUN_00526c50(*(uint *)(param_1 + 0x104c)), iVar9 == 0)) {
          uVar7 = FUN_0054f7a0(param_1,"?model-t-horn?.wav" + 1);
  ...
  for (iVar9 = 0; iVar9 < *(int *)(0x01E57284 + 0x150bf4); iVar9 = iVar9 + 1) {
    iVar6 = FUN_0040d890(*(uint *)(iVar10 + 0x150bf8 + 0x01E57284),_DAT_01ccdc10);
...
joined_r0x0054f2b0:
  ...
  iVar10 = 0;
  if (iVar9 != 0) {
    iVar10 = FUN_004da150(iVar9);
  }
  iVar6 = FUN_0056497c(0x57c);
  iVar9 = 0;
  if (iVar6 != 0) {
    iVar9 = FUN_00545b90(iVar6);
  }
  if ((iVar10 == 0) || (iVar9 == 0)) {
  ...
  FUN_0051e0c0(iVar10 + 0x150,pcVar11);
  ...
  *(uint *)(iVar9 + 0x2c) = *(uint *)(param_1 + 0x2c);
  ...
  FUN_00428f40(iVar10,1,iVar9,0);
  FUN_004d8c60(0x01CC9450,iVar10);
  FUN_004d8c60(0x01CC9450,iVar9);
LAB_0054ef54:
  iVar10 = FUN_00526c50(*(uint *)(param_1 + 0x1050));
  if (iVar10 == 0) {
    uVar7 = FUN_0054f7a0(param_1,"ext-modelt-fast_??.wav");
    *(uint *)(param_1 + 0x1050) = uVar7;
  }
  FUN_00527130(*(uint *)(param_1 + 0x1050),0x3f800000);
  ...
  if ((fVar3 >= fVar4 && (fVar3 == fVar4) == 0) &&
     (uVar8 = FUN_00526c50(*(uint *)(param_1 + 0x1054)), uVar8 == 0)) {
    uVar8 = FUN_0054f7a0(param_1,"skid_??.wav");
