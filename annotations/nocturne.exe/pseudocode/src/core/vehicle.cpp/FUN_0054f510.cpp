// Name: core_vehicle.cpp_FUN_0054f510
// Address: 0054f510
// Address Range: [[0054f510, 0054f77a]]
// Convention: unknown
// Signature: int core_vehicle_cpp_FUN_0054f510(int param_1)

#include "nocturne.h"

int core_vehicle_cpp_FUN_0054f510(int param_1)

{
  ...
  iStack_18 = core_box_cpp_CBoundingBox3D_isVisible_FUN_0041ceb0(uVar1);
  *(int *)(param_1 + 0x1064) = iStack_18;
  if (iStack_18 != 0) {
    ...
    if ((iVar2 == 0) || (*(int *)(0x01C775EC + 0x240) != 0)) {
      ...
      if (0 < *(int *)(param_1 + 0x930)) {
        ...
        do {
          engine_drender_cpp_CDemonRenderer_applyScaledTransform_FUN_00460aa0
                    (DAT_005ae704,iVar6,iVar4);
          engine_drender_cpp_CDemonRenderer_applyScaledTransform_FUN_00460aa0
                    (DAT_005ae704,iStack_14,0);
          core_dmodel_cpp_CKeyFramedModelInstance_prepareForRendering_FUN_004544d0
                    (iVar5,0,0xffffffff);
      ...
      core_box_cpp_CBoundingBox3D_render_FUN_0041dcc0(uVar1);
    }
  }
  core_actor_cpp_CDemonActor_restoreRenderState_FUN_00409f60(param_1);
  if ((*(int *)(param_1 + 0x1064) != 0) &&
    ...
    core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240(param_1,&uStack_48,&uStack_30);
    core_dlight_cpp_renderConeLightGeometry_FUN_00451b70
              (&uStack_48,param_1 + 0x30,0x42600000,0x41200000);
    puVar3 = (uint *)
             core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240
                       (param_1,auStack_3c,&uStack_24);
    if (&uStack_48 != puVar3) {
      uStack_48 = *puVar3;
      uStack_44 = puVar3[1];
      uStack_40 = puVar3[2];
