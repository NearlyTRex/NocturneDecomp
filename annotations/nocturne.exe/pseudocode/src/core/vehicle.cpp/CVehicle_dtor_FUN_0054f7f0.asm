...
;   core_vehicle.cpp_CTire_arrdtor4_FUN_0054f8a0
...
section .text
    ...
    PUSH EBX                            ; 0054f7f0
        ;   Label: core_vehicle.cpp_CVehicle_dtor_FUN_0054f7f0
    ...
    PUSH EBX                            ; 0054f804
    CALL core_course.cpp_CCourse_dtor_FUN_0043b5f0 ; 0054f805
    ...
    PUSH EAX                            ; 0054f814
    CALL core_vehicle.cpp_CTire_arrdtor4_FUN_0054f8a0 ; 0054f815
        ;   XREF to: 0054f8a0 (UNCONDITIONAL_CALL)  ; CTire * core_vehicle.cpp_CTire_arrdtor4_FUN_0054f8a0(CTire * this_ptr, uint flags)
    ...
    PUSH EAX                            ; 0054f858
        ;   Label: LAB_0054f858
    CALL crt_memory.c_operator_delete_FUN_00564494 ; 0054f859
