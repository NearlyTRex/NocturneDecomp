...
// Convention: unknown
// Signature: undefined4 * core_vehicle_cpp_CVehicle_getBoundingBox_FUN_0054f320(int param_1,undefined4 *param_2)

#include "nocturne.h"

uint * core_vehicle_cpp_CVehicle_getBoundingBox_FUN_0054f320(int param_1,uint *param_2)
