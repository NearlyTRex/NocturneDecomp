...

{
  ...
  if (0 < *(int *)param_1[7].actor_name) {
    ...
    } while (iVar15 < *(int *)param_1[7].actor_name);
  }
  pCVar11 = core_dmodel_cpp_CKeyFramedModelInstance_getModelPtr_FUN_00454530
                      ((CKeyFramedModelInstance *)(param_1 + 1));
  pfVar14 = (float *)pCVar11->texture_list[7].textures[2].base.count;
  local_1c = (CDemonActor *)(pfVar14[3] - *pfVar14);
  local_18 = (CDemonActor *)(pfVar14[4] - pfVar14[1]);
  local_14 = (UActorVTable)(pfVar14[5] - pfVar14[2]);
  if (&param_1[6].next_actor != &local_1c) {
    param_1[6].next_actor = local_1c;
    param_1[6].prev_actor = local_18;
    param_1[6].vtable = local_14;
  }
  fVar9 = param_1[6].previous_transform_state.position.z * (float)0.03125;
  ...
  param_1[6].previous_transform_state.orientation.vec.x = fVar9;
  ...
  param_1[6].previous_transform_state.orientation.vec.y =
       fVar9 * fVar10 * ((float)UVar4 * (float)UVar4 + (float)pCVar1 * (float)pCVar1);
  param_1[6].previous_transform_state.orientation.vec.z =
       fVar7 * fVar10 * ((float)UVar5 * (float)UVar5 + (float)pCVar2 * (float)pCVar2);
  param_1[6].previous_transform_state.dirty_flags =
       (int)(((float)pCVar6 * (float)pCVar6 + (float)pCVar3 * (float)pCVar3) * fVar8 * fVar10);
  param_1[6].scale.x = 0;
  ...
  *(int *)param_1[6].footstep_sound_code = param_1[6].dead1;
  ...
  iVar15 = 0;
  if (0 < *(int *)param_1[7].actor_name) {
    pfVar14 = &param_1[8].orient_matrix.m[1].z;
    pfVar12 = &param_1[8].orient_matrix.m[0].z;
    do {
      pfVar13 = (float *)((int)param_1 + iVar15 * 0x1b4 + 0x934);
      if (pfVar14 != pfVar13) {
        *pfVar14 = *pfVar13;
        pfVar14[1] = pfVar13[1];
        pfVar14[2] = pfVar13[2];
