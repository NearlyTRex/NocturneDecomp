...
// Convention: unknown
// Signature: void core_vehicle_cpp_CVehicle_setup_FUN_0054e7f0(int param_1)
...

{
  ...
  if (0 < *(int *)(param_1 + 0x930)) {
    iVar7 = param_1 + 0x948;
    do {
      core_dmodel_cpp_CKeyFramedModelInstance_preCache_FUN_00454510(iVar7);
      iVar8 = iVar8 + 1;
      iVar7 = iVar7 + 0x1b4;
    } while (iVar8 < *(int *)(param_1 + 0x930));
  }
  iVar8 = core_dmodel_cpp_CKeyFramedModelInstance_getModelPtr_FUN_00454530(param_1 + 0x150);
  ...
  *(uint *)(param_1 + 0x1010) = 0;
  core_course_cpp_CCourse_load_FUN_0043b690(param_1 + 0x1018,param_1 + 0x102c);
