...

{
  ...
  pCVar8 = &this_ptr->world_velocity;
  if (delta_time <= 0.0) {
  ...
  if (&this_ptr->local_velocity != pCVar8) {
    (this_ptr->local_velocity).x = pCVar8->x;
    (this_ptr->local_velocity).y = pCVar8->y;
    (this_ptr->local_velocity).z = pCVar8->z;
  }
  iVar15 = 0;
  pCVar9 = this_ptr;
  if (0 < this_ptr->tire_count) {
    ...
    } while (iVar15 < this_ptr->tire_count);
  }
  ...
  for (iVar15 = 0; iVar15 < g_CDemonSet_PTR_005be368->character_count; iVar15 = iVar15 + 1) {
    ...
    if ((pCVar10 == (CDemonActor *)0x0) ||
       (this_ptr != (CVehicle *)pCVar10[0x90].orient_matrix.m[1].x)) {
      ...
      if ((EVar11 == COLLISION_TYPE_CYLINDER) &&
        ...
        if (CStack_64.z - SStack_c8.cylinder_radius <= local_a0.max.z) {
          ...
          (*(((pCVar7->base).vtable._uc)->_uc).processDamage)(pCVar7,&SStack_104);
                ...
                && (iVar12 = sound_sndmain_cpp_isSfxPlaying_FUN_00526c50(this_ptr->sfx_handles[0]),
                   iVar12 == 0)) {
  ...
  fStack_40 = (this_ptr->base).location.position.x - *(float *)(iVar15 + 0x20);
  fStack_3c = (this_ptr->base).location.position.y - *(float *)(iVar15 + 0x24);
  fStack_38 = (this_ptr->base).location.position.z - *(float *)(iVar15 + 0x28);
  ...
  for (iVar12 = 0; iVar12 < g_CDemonSet_PTR_005be368->enemy_count; iVar12 = iVar12 + 1) {
    ...
    if ((pCVar10 != (CDemonActor *)0x0) &&
       (pCVar9 = (CVehicle *)pCVar10[0x90].orient_matrix.m[1].x, this_ptr == pCVar9)) {
...
joined_r0x0054f2b0:
  ...
  core_mission_cpp_CDemonMission_addActorToList_FUN_004d8c60
            (g_CDemonMission_PTR_005baf90,(CDemonActor *)actor);
LAB_0054ef54:
  iVar15 = sound_sndmain_cpp_isSfxPlaying_FUN_00526c50(this_ptr->sfx_handles[1]);
  if (iVar15 == 0) {
    uVar13 = core_vehicle_cpp_CVehicle_playTrackedSound_FUN_0054f7a0
  ...
  if (((float)0.20000000000000001 < ABS((this_ptr->local_velocity).x)) &&
     (iVar15 = sound_sndmain_cpp_isSfxPlaying_FUN_00526c50(this_ptr->sfx_handles[2]), iVar15 == 0))
  {
    uVar13 = core_vehicle_cpp_CVehicle_playTrackedSound_FUN_0054f7a0(this_ptr,"skid_??.wav");
