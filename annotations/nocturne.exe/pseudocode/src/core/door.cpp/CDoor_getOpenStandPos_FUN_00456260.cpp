...
// Convention: __cdecl
// Signature: float * __cdecl core_door_cpp_CDoor_getOpenStandPos_FUN_00456260(int param_1,float *param_2,float *param_3,undefined4 param_4)
...

{
  ...
  case 1:
  case 2:
    iVar5 = core_actor_cpp_CDemonActor_worldToLocalPoint_FUN_0040a290(param_1,local_2c,param_4);
    if (*(float *)(iVar5 + 8) <= 0.0) {
      pfVar6 = (float *)core_actor_cpp_CDemonActor_transformVector_FUN_0040a200
                                  (param_1,local_20,&local_5c);
