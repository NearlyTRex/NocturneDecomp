...
;
; XREF[2]:
;   core_door.cpp_CDoor_process_FUN_00455640 at 00455729
;   core_door.cpp_CDoor_updateCollisionData_FUN_00456460 at 0045647c
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004552a0
        ;   Label: core_door.cpp_CDoor_reposition_FUN_004552a0
    PUSH ESI                            ; 004552a1
    PUSH EDI                            ; 004552a2
    PUSH EBP                            ; 004552a3
