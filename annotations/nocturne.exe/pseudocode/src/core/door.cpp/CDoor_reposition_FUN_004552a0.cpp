...
// Convention: __cdecl
// Signature: void __cdecl core_door_cpp_CDoor_reposition_FUN_004552a0(int param_1)
...

{
    ...
    *(uint *)(param_1 + 0x9bc) = 0;
    puVar2 = (uint *)
             core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240
                       (param_1,auStack_50,param_1 + 0x9b4);
    break;
  case 1:
  ...
  case 2:
    ...
    pfVar3 = (float *)core_dirmat_cpp_CMatrix3x3f_transformVector_FUN_0044da40
                                (param_1 + 0x3c,auStack_2c,afStack_a4);
...
LAB_00455399:
  if (0.0 < *(float *)(param_1 + 0x9c4)) {
    uStack_20 = core_actor_cpp_getRandomFloatFromRange_FUN_0040dda0
                          (-*(float *)(param_1 + 0x9c4),*(uint *)(param_1 + 0x9c4));
    uStack_1c = 0;
    uStack_14 = uStack_20;
