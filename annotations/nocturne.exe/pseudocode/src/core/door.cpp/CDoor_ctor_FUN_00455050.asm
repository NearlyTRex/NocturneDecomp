...
;   core_event.cpp_CRuleList_clear_FUN_00481620
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 00455057
    CALL core_actor.cpp_CDemonActor_ctor_FUN_00409d30 ; 00455058
    ...
    PUSH EBX                            ; 00455074
    CALL core_event.cpp_CRuleList_clear_FUN_00481620 ; 00455075
        ;   XREF to: 00481620 (UNCONDITIONAL_CALL)  ; void core_event.cpp_CRuleList_clear_FUN_00481620(CRuleList * this_ptr)
