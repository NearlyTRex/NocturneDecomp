...
section .text
    ...
    MOV dword ptr [0x01cc4800],EDX      ; 00456432 | DAT_01cc4800
    MOV dword ptr [0x01cc4804],ECX      ; 00456438 | DAT_01cc4804
    CALL FUN_004c8440                   ; 0045643e
