...
// Convention: unknown
// Signature: int core_succubus_cpp_CSuccubus_dtor_FUN_00541860(int param_1,byte param_2)
...

{
  ...
  if ((param_2 & 4) != 0) {
    uVar2 = __vec_delete(param_1,&g_CSuccubusTypeInfo_005a2a30);
    shape_memdbg_cpp_free_FUN_00564486(uVar2);
    return param_1;
  }
  iVar1 = core_morph_cpp_CMorph_dtor_FUN_004e0070(param_1 + 0xe1a4,0);
  iVar1 = core_cloth_cpp_CClothList_dtor_FUN_00438250(iVar1 + -0x1cc,0);
