...
// Convention: unknown
// Signature: CDemonActor * core_health_cpp_CHealthItem_dtor_FUN_004b4460(CDemonActor *param_1,byte param_2)
...

{
  ...
  if ((param_2 & 4) != 0) {
    ptr = __vec_delete(param_1,&g_CHealthItemTypeInfo_0059eaf0);
