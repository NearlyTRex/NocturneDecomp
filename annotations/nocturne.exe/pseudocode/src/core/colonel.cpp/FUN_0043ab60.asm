...
;                               FUNCTION
; *****************************************************************************
; undefined4 core_colonel_cpp_FUN_0043ab60(undefined4 param_1,byte param_2)
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0043ab60
        ;   Label: core_colonel.cpp_FUN_0043ab60
    ...
    PUSH 0x1                            ; 0043ab6c
    PUSH EBX                            ; 0043ab6e
    CALL core_hero.cpp_FUN_004b4800     ; 0043ab6f
    ...
    PUSH EAX                            ; 0043aba1
        ;   Label: LAB_0043aba1
    CALL crt_unknown.c_FUN_00564494     ; 0043aba2
