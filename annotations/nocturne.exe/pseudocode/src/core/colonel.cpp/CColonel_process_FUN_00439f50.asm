...
;   core_hero.cpp_CHero_tryOpenNearbyDoor_FUN_004b5110
...
section .text
    ...
    PUSH EBX                            ; 00439f50
        ;   Label: core_colonel.cpp_CColonel_process_FUN_00439f50
    PUSH ESI                            ; 00439f51
    PUSH EDI                            ; 00439f52
    PUSH EBP                            ; 00439f53
    ...
    CALL core_colonel.cpp_CColonel_processMotionEvents_FUN_0043a980 ; 00439fb4
        ;   XREF to: 0043a980 (UNCONDITIONAL_CALL)  ; void core_colonel.cpp_CColonel_processMotionEvents_FUN_0043a980(CColonel * this_ptr, float delta_time)
    ...
    CALL core_colonel.cpp_CColonel_processAI_FUN_0043a470 ; 00439fcb
        ;   XREF to: 0043a470 (UNCONDITIONAL_CALL)  ; void core_colonel.cpp_CColonel_processAI_FUN_0043a470(CColonel * this_ptr, float delta_time)
    ...
    CALL core_charactr.cpp_CCharacter_processWalking_FUN_00428c00 ; 00439ff2
    ...
    CALL core_xform.cpp_eulerToQuaternion_FUN_0055d610 ; 0043a1b4
    ...
    PUSH dword ptr [EBP + 0x18]         ; 0043a1dd
        ;   Label: LAB_0043a1dd
    PUSH EBX                            ; 0043a1e0
    CALL core_charactr.cpp_CCharacter_applyGestureLookAt_FUN_0042a150 ; 0043a1e1
    ...
    MOV ESI,dword ptr [0x005ad350]      ; 0043a203 | g_CConsole_PTR_005ad350
    PUSH ESI                            ; 0043a209 | g_CConsole_0077ad0c
    ...
    JNZ 0x0043a2b0                      ; 0043a313
        ;   XREF to: 0043a2b0 (CONDITIONAL_JUMP)  ; LAB_0043a2b0
    PUSH EBX                            ; 0043a315
    CALL core_hero.cpp_CHero_tryOpenNearbyDoor_FUN_004b5110 ; 0043a316
    ...
    JNZ 0x0043a2b0                      ; 0043a341
        ;   XREF to: 0043a2b0 (CONDITIONAL_JUMP)  ; LAB_0043a2b0
    PUSH EBX                            ; 0043a347
    CALL core_hero.cpp_CHero_tryPullLever_FUN_004b52f0 ; 0043a348
    ...
    PUSH EBX                            ; 0043a359
        ;   Label: LAB_0043a359
    CALL core_hero.cpp_CHero_tryOpenDoor_FUN_004b5270 ; 0043a35a
