...
;   undefined1* PTR_core_colonel.cpp_FUN_00439da0_0059b574 = 00439da0
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 00439d30
        ;   Label: core_colonel.cpp_FUN_00439d30
    ...
    MOV dword ptr [EAX + -0x4],0x59b574 ; 00439d45 | PTR_core_colonel.cpp_FUN_00439da0_0059b574
