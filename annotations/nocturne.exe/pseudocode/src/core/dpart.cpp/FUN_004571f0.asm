...
;                               FUNCTION
; *****************************************************************************
; void core_dpart_cpp_FUN_004571f0(int param_1,undefined4 param_2,float *param_3)
;
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004571f0
        ;   Label: core_dpart.cpp_FUN_004571f0
    PUSH ESI                            ; 004571f1
    PUSH EDI                            ; 004571f2
    PUSH EBP                            ; 004571f3
    ...
    PUSH EBX                            ; 0045722f
    CALL core_dpart.cpp_FUN_00456f60    ; 00457230
        ;   XREF to: 00456f60 (UNCONDITIONAL_CALL)  ; undefined core_dpart.cpp_FUN_00456f60()
