...
;
; Called Functions:
;   core_dpart.cpp_CDemonPart_alloc_FUN_00456f60
...
section .text
    ...
    PUSH EBX                            ; 004571f0
        ;   Label: core_dpart.cpp_CDemonPart_loadFromFile_FUN_004571f0
    PUSH ESI                            ; 004571f1
    PUSH EDI                            ; 004571f2
    PUSH EBP                            ; 004571f3
    ...
    PUSH EBX                            ; 0045722f
    CALL core_dpart.cpp_CDemonPart_alloc_FUN_00456f60 ; 00457230
        ;   XREF to: 00456f60 (UNCONDITIONAL_CALL)  ; void core_dpart.cpp_CDemonPart_alloc_FUN_00456f60(CDemonPart * this_ptr)
    ...
    PUSH 0x57d481                       ; 004572f7 | = "newformat"
    PUSH EBX                            ; 004572fc
    ...
    CALL core_dpart.cpp_CDemonPart_calculateFaceNormals_FUN_00457120 ; 00457441
        ;   XREF to: 00457120 (UNCONDITIONAL_CALL)  ; void core_dpart.cpp_CDemonPart_calculateFaceNormals_FUN_00457120(CDemonPart * this_ptr)
