// Name: core_baron.cpp_FUN_004110f0
// Address: 004110f0
// Address Range: [[004110f0, 004112e1]]
// Convention: unknown
// Signature: int core_baron_cpp_FUN_004110f0(int param_1)
...
LAB_00411153:
    fVar4 = ((float10)local_44[0] * (float10)65000) / (float10)*(int *)(iVar2 + 100);
  }
  else {
    if (uVar1 < 7) goto LAB_00411153;
    if (uVar1 != 7) goto LAB_004112d5;
    fVar4 = (float10)*(int *)(iVar2 + 100);
    fVar4 = ((fVar4 - (float10)local_1c) * (float10)65000) / fVar4;
  }
  iVar5 = 0x411165;
