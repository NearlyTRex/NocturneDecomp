...
;   core_baron.cpp_CBaronWeapon_isReadyToFire_FUN_00411440 at 00411446
;   core_baron.cpp_CBaronWeapon_process_FUN_004113d0 at 004113d5
...
section .text
    ...
    PUSH EBX                            ; 00411530
        ;   Label: core_baron.cpp_CBaronWeapon_findOrCreateBaron_FUN_00411530
    PUSH ESI                            ; 00411531
    PUSH EDI                            ; 00411532
    PUSH EBP                            ; 00411533
