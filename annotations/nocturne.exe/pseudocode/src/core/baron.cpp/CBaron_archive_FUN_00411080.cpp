...

{
  ...
  core_actor_cpp_archiveString_FUN_0040c6d0((char *)(param_1 + 0x1fa3c),"summonEvent");
  core_actor_cpp_archiveString_FUN_0040c6d0((char *)(param_1 + 0x1faa0),"goAwayEvent");
  core_actor_cpp_archiveInteger_FUN_0040c900((int *)(param_1 + 0x1fb34),"summoned");
  return;
}
