...
// Convention: unknown
// Signature: CDemonActor * core_waypoint_cpp_CWayPoint_dtor_FUN_00552830(CDemonActor *param_1,byte param_2)
...

{
  ...
  if ((param_2 & 4) != 0) {
    ptr = __vec_delete(param_1,&g_CWayPointTypeInfo_005a4110);
