...

{
  ...
  if (iVar2 == 0) {
    core_sound_cpp_CSound_playActorSound_FUN_0052ea60
              (0x02DC9450,(CDemonActor *)this_ptr,"45-dry-!.wav",&CStack_98);
    return 0;
  }
  ...
  core_fire_cpp_CFireEffect_createMuzzleFlash_FUN_0048af20
            (0x01C08D04,&CStack_e0,&(this_ptr->base).base.orient_matrix);
  core_sound_cpp_CSound_playActorSound_FUN_0052ea60
            (0x02DC9450,(CDemonActor *)this_ptr,"45.wav",&CStack_98);
  ...
  core_fire_cpp_CFireEffect_createShell_FUN_0048c6b0
            (0x01C08D04,&(this_ptr->base).base.location.position,&(this_ptr->base).base.orient.vec
             ,aCStack_50,model_ptr);
