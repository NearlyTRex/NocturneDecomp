...
;                               FUNCTION
; *****************************************************************************
; undefined4 core_gun_cpp_FUN_004b27c0(int param_1)
;
; Local Variables:
...
section .text
    ...
    PUSH ECX                            ; 004b2ef1
    CALL core_glass.cpp_FUN_004ada20    ; 004b2ef2
    ...
    PUSH EBX                            ; 004b2f05
    PUSH EDI                            ; 004b2f06
    CALL core_trigger.cpp_FUN_005485a0  ; 004b2f07
    ...
    PUSH ECX                            ; 004b2fa4
    CALL core_fire.cpp_FUN_0048ab60     ; 004b2fa5
