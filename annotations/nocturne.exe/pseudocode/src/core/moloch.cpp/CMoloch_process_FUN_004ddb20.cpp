...

{
  ...
  (param_1->base).base.model.accumulated_root_motion.x =
       (param_1->base).base.model.accumulated_root_motion.y;
  local_1b14 = param_2;
  while (iVar4 = 0x01C775EC, 0.0 < local_1b14) {
  ...
  if (iVar4 == 0) {
    ...
    if ((((uVar9 == 0) || (uVar9 < 2)) || (uVar9 == 2)) && ((param_1->base).base.is_on_ground != 0))
    {
      uVar9 = (uint)((param_1->base).player_input.action_state.walk != 0);
      ...
      pSVar7 = core_motion_cpp_CMotionController_getCurrentMotion_FUN_004e1660
                         (&(param_1->base).base.model.motion_controller);
      if (uVar9 != pSVar7->state_index) goto LAB_004ddc32;
    }
  }
  else {
    uVar9 = (param_1->base).base.is_walking;
    if (uVar9 < 2) {
...
LAB_004ddc32:
    core_motion_cpp_CMotionController_setDesiredState_FUN_004e16b0
              (&(param_1->base).base.model.motion_controller,uVar9,1);
  }
LAB_004ddc3a:
  ...
  if (pCVar6 == (CDemonActor *)0x0) {
    ...
    if ((param_1->base).base.grabbed_type == 0) {
      ...
      iVar4 = core_vecdir_cpp_convertDirectionVectorToEulerAngles_FUN_0054e4a0(local_50,pCVar5);
      local_14 = (SMotion *)
    ...
    pCVar6 = (*((CCharacter_vtable *)((int)local_14 + 0xec))->getGrabber)(this_ptr_00);
    if (pCVar6 == (CDemonActor *)0x0) {
...
LAB_004ddd8e:
  ...
  (*(((param_1->base).base.base.vtable._uc)->_uc).releaseFromGrab)((CCharacter *)param_1);
  ...
  if (param_1->morphing == 0) {
    ...
    if (_DAT_005a0ab8 < param_2) {
      ...
      core_skeleton_cpp_CDeformableModelInstance_init_FUN_0051e0c0(this_ptr,pcVar8);
