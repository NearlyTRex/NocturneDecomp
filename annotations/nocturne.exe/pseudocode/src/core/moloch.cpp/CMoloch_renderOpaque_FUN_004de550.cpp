// Name: core_moloch.cpp_CMoloch_renderOpaque_FUN_004de550
// Address: 004de550
// Address Range: [[004de550, 004de675]]
// Convention: __cdecl
// Signature: int __cdecl core_moloch_cpp_CMoloch_renderOpaque_FUN_004de550(CMoloch *this_ptr)
  ...
  if ((this_ptr->base).base.render_active == 0) {
    ...
    if (iVar1 != 0) {
      ...
      if (iVar2 == 0) {
        ...
        core_morph_cpp_CMorph_render_FUN_004e0820(this_ptr_00,this_ptr->morph_timer / _DAT_005a0ab8)
        ;
      }
      if (_DAT_01cd4318 != 0) {
