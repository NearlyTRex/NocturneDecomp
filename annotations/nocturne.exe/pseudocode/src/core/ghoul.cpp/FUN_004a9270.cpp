...
// Convention: unknown
// Signature: void core_ghoul_cpp_FUN_004a9270(int param_1,float param_2)
...
LAB_004aa1e6:
            ...
            if ((local_50 <= (float)2) && (local_20 = 3.4f, 1.0 <= local_9c)
              ...
              uVar9 = core_xform_cpp_transformVector3x4_FUN_0055a8b0
                                (local_114,&CVector3f_01c78bcc,
                                 _DAT_01c78c1c * 0x30 + param_1 + 0xfd0,0x3e4ccccd,local_2d8);
              uVar9 = core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240
    ...
    case 10:
      if (((*(int *)(param_1 + 0xbc90) == 0) && (*(int *)(param_1 + 0xbd40) < 1)) &&
        ...
        core_gore_cpp_FUN_004b0480(INT_005b96c4,local_108,0);
      ...
      if (*(int *)(param_1 + 0x2290 + *(int *)(param_1 + 0xbd4c) * 4) != 0) {
        ...
        if (local_4c <= (float)2) {
          ...
          if (1.0 <= local_a4) {
            ...
            local_2dc = param_1;
            uVar9 = core_xform_cpp_transformVector3x4_FUN_0055a8b0
                              (local_210,&CVector3f_01c78bc0,_DAT_01c78c18 * 0x30 + param_1 + 0xfd0,
