// Name: core_ghoul.cpp_CGhoul_processDismemberment_FUN_004ab190
// Address: 004ab190
// Address Range: [[004ab190, 004ab441]]
// Convention: __cdecl
// Signature: void __cdecl core_ghoul_cpp_CGhoul_processDismemberment_FUN_004ab190(int param_1,int *param_2)
    ...
    if (iVar2 != 0) {
      ...
      if (*param_2 == *(int *)(param_1 + 0xbd48)) {
        core_charactr_cpp_CCharacter_dismemberPartInternal_FUN_00427eb0
                  (param_1,uVar3,*(uint *)(param_1 + 0xbd4c),0);
      }
      if (*(int *)(param_1 + 0xbd50) == *param_2) {
        core_charactr_cpp_CCharacter_dismemberPartInternal_FUN_00427eb0
                  (param_1,uVar3,*(uint *)(param_1 + 0xbd54),0);
      }
      if (*(int *)(param_1 + 0xbd6c) == *param_2) {
        piVar1 = param_2 + 3;
        ...
        core_charactr_cpp_CCharacter_detachBodyPart_FUN_00427e40
                  (param_1,*(uint *)(param_1 + 0xbd70),piVar1,0);
      }
