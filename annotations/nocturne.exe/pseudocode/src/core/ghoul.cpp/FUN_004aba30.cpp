// Name: core_ghoul.cpp_FUN_004aba30
// Address: 004aba30
// Address Range: [[004aba30, 004abae8]]
// Convention: unknown
// Signature: int core_ghoul_cpp_FUN_004aba30(int param_1,byte param_2)
...

{
  ...
  if ((param_2 & 4) != 0) {
    uVar2 = __vec_delete(param_1,&g_CGhoulTypeInfo_0059e370);
