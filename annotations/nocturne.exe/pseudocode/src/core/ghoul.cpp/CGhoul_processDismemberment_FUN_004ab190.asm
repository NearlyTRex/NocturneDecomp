...
;   TerminatedCString s_limb_wav_00584e21
...
section .text
    ...
    MOV EAX,[0x005b9354]                ; 004ab210 | g_CGame_PTR_005b9354
        ;   Label: LAB_004ab210
    CMP dword ptr [EAX + 0x1e0],0x0     ; 004ab215 | g_CGame_01c775ec.gratuitous_dismemberment
    JZ 0x004ab226                       ; 004ab21c
        ;   XREF to: 004ab226 (CONDITIONAL_JUMP)  ; LAB_004ab226
    MOV dword ptr [ESP + 0x8],0x3f800000 ; 004ab21e
    MOV EAX,[0x005b9354]                ; 004ab226 | g_CGame_PTR_005b9354
        ;   Label: LAB_004ab226
    MOV EDX,dword ptr [EAX + 0x14]      ; 004ab22b | g_CGame_01c775ec.blood_flag
