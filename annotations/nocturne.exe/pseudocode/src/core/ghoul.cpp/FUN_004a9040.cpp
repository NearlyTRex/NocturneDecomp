...
// Convention: unknown
// Signature: void FUN_004a9040(int param_1,float param_2)
...

{
  ...
  if ((*(int *)(param_1 + 0xbd8c) == 0) &&
     ...
     param_2 <= 0.0)) {
    local_14 = (float)FUN_0040dda0(0x3f800000,0x40000000);
    ...
    *(float *)(param_1 + 0xbd88) = local_14 + *(float *)(param_1 + 0xbd88);
    for (; local_18 < *(int *)(0x01E57284 + 0x14cd6c); local_18 = local_18 + 1) {
      iVar1 = FUN_0040d890(*(uint *)(0x01E57284 + local_1c + 0x14cd70),_DAT_02ddf54c);
      if ((iVar1 != 0) &&
         (iVar2 = FUN_004775b0(PTR_s_darkPoint__00584eac_1_005b9654,iVar1,0), iVar2 != 0)) {
        iVar2 = 0;
        local_20 = 1;
        for (iVar4 = 0; iVar4 < *(int *)(0x01E57284 + 0x150bf4); iVar4 = iVar4 + 1) {
          iVar3 = FUN_0040d890(*(uint *)(iVar2 + 0x150bf8 + 0x01E57284),_DAT_01c78c10);
        ...
        if (local_20 != 0) {
          ...
          uStack_2c = 0;
          uStack_28 = 0;
          iVar2 = FUN_004f1600(iVar2,local_24,&uStack_30,*(uint *)(param_1 + 0x6c));
          if (0 < iVar2) {
