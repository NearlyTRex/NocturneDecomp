...
// Convention: unknown
// Signature: void core_ghoul_cpp_CGhoul_process_FUN_004a9270(CGhoul *param_1,float param_2)
...
switchD_004a9c0a_caseD_e:
  ...
  if (0.0 < local_64) {
    ...
    case 5:
      ...
      if ((pCVar2 != (CCharacter *)0x0) &&
        ...
        if ((pCVar13 == (CDemonActor *)0x0) &&
           ...
           iVar6 = (*(((pCVar2->base).vtable._uc)->_uc).canBeGrabbed)
                             (pCVar2,(CDemonActor *)param_1,0), iVar6 != 0)) {
          local_174.z = 2.5f;
          local_174.x = 0.0;
          local_174.y = 0.0;
      ...
      break;
    default:
      core_charactr_cpp_CCharacter_processMotion_FUN_0042add0((CCharacter *)param_1,iVar6);
      break;
    case 10:
      pCVar2 = (param_1->base).victim;
      if (pCVar2 == (CCharacter *)0x0) {
    ...
    case 0xc:
      ...
      core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240
                ((CDemonActor *)param_1,&local_1d4,pCVar12);
    ...
    case 0xd:
      ...
      core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240
                ((CDemonActor *)param_1,&local_228,pCVar12);
      local_14 = core_actor_cpp_getRandomFloatFromRange_FUN_0040dda0(8.0,12.0);
      iVar6 = 0x4a9ae1;
      dVar23 = round((double)(local_14 * (float)0.25));
    ...
    case 0x10:
      ...
      core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240
                ((CDemonActor *)param_1,&local_15c,pCVar12);
      local_14 = core_actor_cpp_getRandomFloatFromRange_FUN_0040dda0(8.0,12.0);
      iVar6 = 0x4a9b6c;
      dVar23 = round((double)(local_14 * (float)0.25));
  ...
  (param_1->base).base.turn_speed = param_2 * fVar25 * fVar26;
  ...
  if (iVar6 == 0x11) {
    ...
    (param_1->base).base.walk_step_speed = (float)((float10)local_8c * fVar21 * (float10)fVar26);
  }
  iVar8 = core_charactr_cpp_FUN_00428c00((CCharacter *)param_1,param_2);
  if (iVar8 == 0) {
    local_20 = -1.0;
    pCVar9 = (CGhoul *)&(param_1->base).base.model;
    pSVar7 = core_motion_cpp_CMotionController_getCurrentMotion_FUN_004e1660
      ...
      if (param_1->stun_timer <= 0.0) {
        ...
        if (pCVar13 == (CDemonActor *)0x0) {
          ...
          if ((param_1->base).victim != (CCharacter *)0x0) {
            ...
            iVar8 = sound_sndmain_cpp_isSfxPlaying_FUN_00526c50(param_1->sfx_handles[0]);
            if (iVar8 != 0) {
              in_stack_fffffc88 = (char *)0x4aa254;
              iVar8 = sound_sndmain_cpp_isSfxPlaying_FUN_00526c50(param_1->sfx_handles[1]);
              if (iVar8 != 0) break;
            }
          ...
          if (SQRT(local_178 * local_178 + local_180 * local_180 + local_17c * local_17c) <
              (float)4) {
            fVar26 = (param_1->base).base.hit_points + param_2;
            param_1->heal_timer = param_1->heal_timer - param_2;
            (param_1->base).base.hit_points = fVar26;
            if ((float)100 < fVar26) {
    ...
    case 1:
    case 0x11:
      if ((param_1->is_berserk != 0) && (iVar6 == 1)) {
        core_motion_cpp_CMotionController_setDesiredState_FUN_004e16b0
          ...
          if (pCVar2 == (CCharacter *)0x0) {
            ...
            if (pCVar13 == (CDemonActor *)0x0) {
              ...
              iVar8 = core_charactr_cpp_CCharacter_walkToPoint_FUN_004247f0
                                ((CCharacter *)param_1,
                                 &(((param_1->base).victim)->base).location.position,pCVar11,
              ...
              iVar8 = core_charactr_cpp_CCharacter_walkToPoint_FUN_004247f0
                                ((CCharacter *)param_1,&(param_1->dark_waypoint->location).position,
                                 pCVar11,(CVector3f *)in_stack_fffffc88,fVar26,
          ...
          if (param_1->pending_eat_state < 0) {
            ...
            if (cVar20 != '\0') {
              if (cVar20 == '\x01') {
                ...
                param_1->pending_eat_state = (iVar8 == 0) + 0xd;
            ...
            if (param_1->pending_eat_state != 0) {
              ...
              pCVar14 = core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240
                                  (*(CDemonActor **)(_DAT_01cae0e8 * 4 + 0x1cae0d8),&local_150,
                                   pCVar14);
              iVar8 = core_charactr_cpp_CCharacter_walkToPoint_FUN_004247f0
                                ((CCharacter *)param_1,pCVar14,pCVar11,pCVar12,fVar26,fVar25);
              if (((0 < iVar8) &&
...
LAB_004aa1e6:
        ...
        if (pCVar13 == (CDemonActor *)0x0) {
          ...
          iVar8 = param_1->part_indices[3];
          (param_1->base).attack_cooldown = local_14;
          if ((param_1->base).base.model.part_data.visibility_flags[iVar8] != 0) {
            ...
            if ((local_50 <= (float)2) && (local_20 = 3.4f, 1.0 <= local_9c)
              ...
              pCVar12 = core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240
                                  ((CDemonActor *)param_1,&local_1bc,pCVar12);
              iVar8 = core_enemy_cpp_CEnemy_testAttackRadius_FUN_004798e0
                                (&param_1->base,pCVar12,fVar26,(SDamageInfo *)in_stack_fffffc88);
              if (iVar8 != 0) {
    ...
    case 10:
      if ((((param_1->base).pool_me == 0) && (param_1->lives_left < 1)) &&
        ...
        core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240
                  ((CDemonActor *)param_1,&local_108,pCVar12);
      ...
      if (((0 < param_1->spasm_count) || (0 < param_1->lives_left)) &&
         (iVar8 = param_1->spasm_timer - _DAT_01bd1d80, param_1->spasm_timer = iVar8, iVar8 < 1)) {
        ...
        if ((0 < param_1->spasm_count) || (0 < param_1->lives_left)) {
          ...
          core_motion_cpp_CMotionController_setDesiredState_FUN_004e16b0
                    (&(param_1->base).base.model.motion_controller,iVar8,iVar24);
        }
      }
      if (0 < param_1->lives_left) {
        if (param_1->arise_timer < 1) {
          iVar8 = param_1->arise_timer + _DAT_01bd1d80;
          param_1->arise_timer = iVar8;
          if (iVar8 < 0) {
            (*(((param_1->base).base.base.vtable._ue)->_ue).updateVictim)(&param_1->base,param_2);
            pCVar2 = (param_1->base).victim;
            if (pCVar2 != (CCharacter *)0x0) {
...
LAB_004aaa0a:
          ...
          if (1.0 <= local_a4) {
            ...
            pCVar12 = core_xform_cpp_transformVector3x4_FUN_0055a8b0
                                (local_210,&CVector3f_01c78bc0,
                                 ...
                                 [_DAT_01c78c18].m);
            pCVar12 = core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240
                                ((CDemonActor *)param_1,&local_21c,pCVar12);
            iVar8 = core_enemy_cpp_CEnemy_testAttackRadius_FUN_004798e0
                              (&param_1->base,pCVar12,fVar26,(SDamageInfo *)in_stack_fffffc88);
            if (iVar8 != 0) {
              in_stack_fffffc88 = "gh-hits?.wav";
    ...
    case 0xd:
    case 0xe:
      iVar8 = param_1->burp_timer - _DAT_01bd1d80;
      param_1->burp_timer = iVar8;
      if (iVar8 < 1) {
        (*((param_1->base).base.base.vtable._ub)->playSound)
    ...
    if (((0.0 <= local_20) && (param_1->flinch_blend_weight <= 0.0)) &&
      ...
      pCVar12 = core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240
                          (&((param_1->base).victim)->base,&local_144,pCVar12);
      iVar8 = core_charactr_cpp_CCharacter_walkToPoint_FUN_004247f0
                        ((CCharacter *)param_1,pCVar12,pCVar11,pCVar14,fVar26,
...
LAB_004a93c4:
  ...
  if (0.0 < local_b4) {
    ...
    fVar26 = 1.0 - param_1->flinch_blend_weight;
    ...
    fVar26 = param_1->flinch_blend_weight - param_2 / 0.7f;
    param_1->flinch_blend_weight = fVar26;
    if (fVar26 < 0.0) {
  ...
  if (((float)0.01 < ABS((param_1->base).base.turn_angle_accumulator)) ||
     (fVar26 = (param_1->base).base.position_delta.y, fVar25 = (param_1->base).base.position_delta.x
    ...
    core_sound_cpp_CSound_killSound_FUN_0052ebb0(g_CSound_PTR_005bed68,param_1->sfx_handle);
  }
  if ((param_1->base).pool_me == 0) {
    if ((param_1->base).base.model.part_data.visibility_flags[param_1->part_indices[9]] == 0) {
      fVar26 = 0.5;
      iVar8 = param_1->part_indices[9];
      ...
      fVar26 = 0.7;
      iVar8 = param_1->part_indices[10];
      iVar24 = _DAT_01c78c14;
    }
    core_charactr_cpp_CCharacter_spawnBloodAtBone_FUN_00427990
              ((CCharacter *)param_1,iVar8,iVar24,fVar26);
    core_charactr_cpp_CCharacter_processDamageDecals_FUN_004277f0((CCharacter *)param_1);
  }
  if ((param_1->dark_waypoint != (CDemonActor *)0x0) && (iVar6 == 0x11)) {
    fVar26 = (param_1->base).base.base.location.position.x - (param_1->prev_position).x;
    fVar25 = (param_1->base).base.base.location.position.z - (param_1->prev_position).z;
    if (param_2 * (float)0.5 <= SQRT(fVar25 * fVar25 + fVar26 * fVar26)) {
