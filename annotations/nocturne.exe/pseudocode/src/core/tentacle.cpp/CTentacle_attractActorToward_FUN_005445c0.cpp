...
// Convention: unknown
// Signature: undefined4 core_tentacle_cpp_CTentacle_attractActorToward_FUN_005445c0(int param_1,int param_2)

#include "nocturne.h"

uint core_tentacle_cpp_CTentacle_attractActorToward_FUN_005445c0(int param_1,int param_2)
