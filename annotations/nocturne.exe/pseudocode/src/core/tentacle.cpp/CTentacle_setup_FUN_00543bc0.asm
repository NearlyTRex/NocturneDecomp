...
section .text
    ...
    PUSH EBX                            ; 00543bc0
        ;   Label: core_tentacle.cpp_CTentacle_setup_FUN_00543bc0
    MOV EBX,dword ptr [ESP + 0x8]       ; 00543bc1
    ADD EBX,0x150                       ; 00543bc5
    PUSH EBX                            ; 00543bcb
    CALL core_skeleton.cpp_CDeformableModelInstance_preCache_FUN_0051dcd0 ; 00543bcc
    ...
    PUSH EDX                            ; 00543bd8
    CALL core_enemy.cpp_CEnemy_setup_FUN_004796b0 ; 00543bd9
        ;   XREF to: 004796b0 (UNCONDITIONAL_CALL)  ; void core_enemy.cpp_CEnemy_setup_FUN_004796b0(CEnemy * this_ptr)
    ADD ESP,0x4                         ; 00543bde
    PUSH EBX                            ; 00543be1
    CALL core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_0051e0a0 ; 00543be2
    ...
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_005179d0 ; 00543bf4
    ...
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_005179d0 ; 00543c09
        ;   XREF to: 005179d0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_005179d0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ...
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_005179d0 ; 00543c1e
        ;   XREF to: 005179d0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_005179d0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
    ...
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_005179d0 ; 00543c33
        ;   XREF to: 005179d0 (UNCONDITIONAL_CALL)  ; int core_skeleton.cpp_CSkeleton_findBone_FUN_005179d0(CSkeleton * this_ptr, char * bone_name, int assert_if_not_found)
