...
// Convention: unknown
// Signature: void FUN_004df9e0(int *param_1,int param_2,ushort *param_3,int param_4,int *param_5,int param_6,int param_7)
...

{
  ...
  if (0 < param_7) {
    ...
    do {
      uVar2 = FUN_004dfba0(param_1,*local_20 * 0x48 + param_4 + 8);
      iVar5 = 0;
