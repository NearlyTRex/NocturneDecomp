...
;   core_morph.cpp_CMorphModel_setFaceListFromTriangles_FUN_004df9e0
...
section .text
    ...
    PUSH EBX                            ; 004df460
        ;   Label: core_morph.cpp_CMorphModel_addPartFromVertexBuffer_FUN_004df460
    PUSH ESI                            ; 004df461
    PUSH EDI                            ; 004df462
    PUSH EBP                            ; 004df463
    ...
    MOV dword ptr [0x01cc4800],EBP      ; 004df513 | g_CurrentFilename
    MOV [0x01cc4804],EAX                ; 004df519 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004df51e
    ...
    MOV dword ptr [0x01cc4800],ECX      ; 004df55f | g_CurrentFilename
    MOV dword ptr [0x01cc4804],ESI      ; 004df565 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004df56b
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
