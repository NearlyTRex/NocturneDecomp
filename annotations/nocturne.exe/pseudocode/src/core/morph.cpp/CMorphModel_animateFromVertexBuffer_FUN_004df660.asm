...
section .text
    ...
    MOV dword ptr [0x01cc4800],ESI      ; 004df68b | g_CurrentFilename
    MOV [0x01cc4804],EAX                ; 004df691 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004df696
    ...
    MOV [0x01cc4800],EAX                ; 004df6ca | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EDX      ; 004df6cf | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004df6d5
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
