...

{
  ...
  if ((part_index < 0) || (this_ptr->part_count <= part_index)) {
    ...
    core_main_c_displayErrorAndQuit_FUN_004c8440("CMorphModel::animate - invalid part index");
  }
  ...
  if (iVar2 + this_ptr->parts[part_index].vertex_count < iVar3 + vertex_count) {
    ...
    core_main_c_displayErrorAndQuit_FUN_004c8440("CMorphModel::animate - invalid vertex range");
  }
  iVar2 = 0;
  if (0 < vertex_count) {
    iVar3 = iVar3 * 0x10;
