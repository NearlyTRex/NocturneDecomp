...
section .text
    ...
    CALL core_morph.cpp_CMorphModel_rotatePoints_FUN_004dfcb0 ; 004dfc8f
        ;   XREF to: 004dfcb0 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_CMorphModel_rotatePoints_FUN_004dfcb0(CMorphModel * this_ptr, float blend_factor, SMorphPoint * ref_points)
    ...
    CALL core_morph.cpp_CMorphModel_renderFaces_FUN_004dfea0 ; 004dfca0
        ;   XREF to: 004dfea0 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_CMorphModel_renderFaces_FUN_004dfea0(CMorphModel * this_ptr, float morph_t)
