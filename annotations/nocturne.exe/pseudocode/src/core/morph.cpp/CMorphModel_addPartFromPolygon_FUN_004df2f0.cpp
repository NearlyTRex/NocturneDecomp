...
// Convention: __cdecl
// Signature: void __cdecl core_morph_cpp_CMorphModel_addPartFromPolygon_FUN_004df2f0(CMorphModel *this_ptr,int vertex_count,CVector3i *vertex_data,int poly_count,SMRGLHeaderPrimitive *poly_data,int poly_stride,SMRGLTextureModel *texture_list,int *texture_index_list)

#include "nocturne.h"

void __cdecl core_morph_cpp_CMorphModel_addPartFromPolygon_FUN_004df2f0(CMorphModel *this_ptr,int vertex_count,CVector3i *vertex_data,int poly_count,SMRGLHeaderPrimitive *poly_data,int poly_stride,SMRGLTextureModel *texture_list,int *texture_index_list)

{
  ...
  if (4 < this_ptr->part_count) {
    ...
    core_main_c_displayErrorAndQuit_FUN_004c8440("CMorphModel::addPart - too many parts!");
  }
  iVar5 = 0;
  pSVar6 = poly_data;
  ...
  if ((this_ptr->points == (SMorphPoint *)0x0) || (this_ptr->faces == (SMRGLPrimitiveTriangle *)0x0)
    ...
    g_CurrentFilename = "..\\core\\morph.cpp";
    g_CurrentLineNumber = 144;
    core_main_c_displayErrorAndQuit_FUN_004c8440("CMorphModel::setup - out of memory!");
  }
