...
// Convention: __cdecl
// Signature: void __cdecl core_morph_cpp_CMorphModel_addPartFromVertexBuffer_FUN_004df460(int *param_1,int param_2,int param_3,int param_4,int param_5,undefined4 param_6,undefined4 param_7)
...

{
  ...
  iVar1 = realloc(param_1[0x16],param_1[0x15] << 4);
  param_1[0x16] = iVar1;
  iVar1 = realloc(param_1[0x18],param_1[0x17] * 0x3c);
  param_1[0x18] = iVar1;
  *param_1 = *param_1 + 1;
  ...
  if (param_5 != 0) {
    core_morph_cpp_CMorphModel_setFaceListFromTriangles_FUN_004df9e0
              (param_1,*param_1 + -1,param_5,param_6,param_7,0,param_4);
    return;
  }
  return;
}
