...
// Convention: unknown
// Signature: void FUN_004df2f0(int *param_1,int param_2,int param_3,int param_4,int param_5,int param_6,undefined4 param_7,undefined4 param_8)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_004df2f0(int *param_1,int param_2,int param_3,int param_4,int param_5,int param_6,uint param_7,uint param_8)

{
  ...
  iVar3 = FUN_00564a70(param_1[0x16],param_1[0x15] << 4);
  param_1[0x16] = iVar3;
  iVar3 = FUN_00564a70(param_1[0x18],param_1[0x17] * 0x3c);
  param_1[0x18] = iVar3;
  *param_1 = *param_1 + 1;
  ...
  FUN_004df800(param_1,*param_1 + -1,param_5,param_6,param_7,param_8,0,param_4);
  return;
}
