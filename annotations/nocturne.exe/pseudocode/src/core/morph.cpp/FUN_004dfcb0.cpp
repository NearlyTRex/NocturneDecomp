...
// Convention: unknown
// Signature: void FUN_004dfcb0(int param_1,float param_2,int param_3)
...

{
  ...
  if (0 < *(int *)(param_1 + 0x54)) {
    ...
    do {
      ...
      *piVar10 = (int)ROUND((*(float *)(iVar5 + 4 + iVar9) * param_2 + *(float *)(iVar8 + 4) * fVar7
      ...
      FUN_0053075c(*DAT_005ae704 + iVar11,piVar10);
  ...
  FUN_0050c010(0x01E57284,*(uint *)(param_1 + 0x54));
  FUN_0050c2d0(0x01E57284,*(uint *)(param_1 + 0x54),*(uint *)(param_1 + 0x5c),
               *(uint *)(param_1 + 0x60),&DAT_01cce554,3,0);
  FUN_00461050(DAT_005ae704,local_20);
  return;
}
