...
;   core_level.cpp_CLevelLoader_FUN_004c5630
...
section .text
    ...
    CALL core_level.cpp_CLevelLoader_FUN_004c5630 ; 004c5605
        ;   XREF to: 004c5630 (UNCONDITIONAL_CALL)  ; void core_level.cpp_CLevelLoader_FUN_004c5630(CLevelLoader * this_ptr)
