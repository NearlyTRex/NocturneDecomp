...

{
  ...
  if (param_1[3] != 0) {
    ...
    *(uint *)(iVar3 + 0x15aa94) =
    ...
    wincore_windll_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x60,&local_3c);
    local_30 = -local_30;
    ...
    wincore_windll_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x90,&local_48);
    piVar1 = DAT_005ae704;
