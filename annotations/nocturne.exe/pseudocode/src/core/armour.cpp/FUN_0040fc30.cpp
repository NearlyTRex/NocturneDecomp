// Name: core_armour.cpp_FUN_0040fc30
// Address: 0040fc30
// Address Range: [[0040fc30, 0040fce8]]
// Convention: unknown
// Signature: int core_armour_cpp_FUN_0040fc30(int param_1,byte param_2)
...

{
  ...
  if ((param_2 & 4) != 0) {
    uVar2 = __vec_delete(param_1,&g_CArmourTypeInfo_00599900);
