// Name: core_armour.cpp_CArmour_dtor_FUN_0040fc30
// Address: 0040fc30
// Address Range: [[0040fc30, 0040fce8]]
// Convention: __cdecl
// Signature: CArmour * __cdecl core_armour_cpp_CArmour_dtor_FUN_0040fc30(CArmour *this_ptr,uint flags)
...

{
  ...
  if ((flags & 4) != 0) {
    ptr_00 = __vec_delete(this_ptr,&g_CArmourTypeInfo_00599900);
