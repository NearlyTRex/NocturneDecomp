...
section .text
    ...
    PUSH EBX                            ; 0040fa20
        ;   Label: core_armour.cpp_CArmour_process_FUN_0040fa20
    PUSH ESI                            ; 0040fa21
    PUSH EDI                            ; 0040fa22
    PUSH EBP                            ; 0040fa23
    ...
    PUSH ESI                            ; 0040fa32
    CALL core_charactr.cpp_CCharacter_FUN_004259f0 ; 0040fa33
    ...
    PUSH ESI                            ; 0040faac
    CALL core_charactr.cpp_CCharacter_FUN_00428c00 ; 0040faad
    ...
    PUSH ESI                            ; 0040fae3
    CALL core_charactr.cpp_CCharacter_FUN_0042a150 ; 0040fae4
