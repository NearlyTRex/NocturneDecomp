...
// Convention: __cdecl
// Signature: void __cdecl core_cow_cpp_CZombieCow_process_FUN_0043bdb0(CZombieCow *this_ptr,float delta_time)
...

{
  ...
  if (iVar6 == 0) {
    ...
    case 2:
      ...
      core_enemy_cpp_CEnemy_testAttackRadius_FUN_004798e0(&this_ptr->base,pCVar8,fVar10,damage_info)
      ;
      break;
    case 5:
...
LAB_0043c040:
    ...
    if (uVar9 < 3) goto LAB_0043be80;
    if (uVar9 != 3) goto LAB_0043c040;
    core_motion_cpp_CMotionController_setDesiredState_FUN_004e16b0
              (&this_ptr_00->motion_controller,0,1);
    engine_console_cpp_CConsole_printf_FUN_0043ac60
...
switchD_0043c2cd_caseD_3:
  ...
  if (iVar4 != 0) {
    ...
    pCVar1->x = fVar10;
    core_charactr_cpp_CCharacter_moveAndCollide_FUN_00425050((CCharacter *)this_ptr,&local_6c);
  }
