...
;   TerminatedCString s_s_confused_while_walking_0057b34f
;   TerminatedCString s_cow_wav_0057b379
;   TerminatedCString s_s_gave_up_chase_I_m_conf_0057b382
;   double DOUBLE_0057b3aa = 3.14159265350000
...
section .text
    ...
    PUSH EBX                            ; 0043bdcb
    CALL core_charactr.cpp_CCharacter_process_FUN_004259f0 ; 0043bdcc
    ...
    FMUL double ptr [0x0057b3aa]        ; 0043be25 | DOUBLE_0057b3aa
    FMULP                               ; 0043be2b
    FMUL double ptr [0x0057b3b2]        ; 0043be2d | DOUBLE_0057b3b2
    ...
    CALL core_charactr.cpp_CCharacter_processWalking_FUN_00428c00 ; 0043be58
    ...
    FLD float ptr [EBP + 0x92]          ; 0043bf11
        ;   Label: LAB_0043bf11
    FLD ST0                             ; 0043bf17
    FMUL double ptr [0x0057b3ba]        ; 0043bf19 | DOUBLE_0057b3ba
    ...
    PUSH EBX                            ; 0043bfe4
    CALL core_charactr.cpp_CCharacter_applyGestureLookAt_FUN_0042a150 ; 0043bfe5
    ...
    JMP 0x0043beab                      ; 0043c1f9
        ;   XREF to: 0043beab (UNCONDITIONAL_JUMP)  ; caseD_4
    MOV EAX,[0x0059b888]                ; 0043c1fe | FLOAT_0059b888
        ;   Label: LAB_0043c1fe
