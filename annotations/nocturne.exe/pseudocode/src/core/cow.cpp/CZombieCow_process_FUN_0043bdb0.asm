...
section .text
    ...
    PUSH EBX                            ; 0043bdcb
    CALL core_charactr.cpp_CCharacter_FUN_004259f0 ; 0043bdcc
    ...
    CALL core_charactr.cpp_CCharacter_FUN_00428c00 ; 0043be58
    ...
    PUSH EBX                            ; 0043bfe4
    CALL core_charactr.cpp_CCharacter_FUN_0042a150 ; 0043bfe5
