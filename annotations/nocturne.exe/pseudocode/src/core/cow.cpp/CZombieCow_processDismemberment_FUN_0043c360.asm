...
;
; XREF[1]:
;   core_cow.cpp_CZombieCow_processDamage_FUN_0043c5e0 at 0043c5ed
;
; Referenced Globals:
;   undefined1* switchdataD_0043c350 = 0043c39d
;   TerminatedCString s_limb_wav_0057b3ed
...
section .text
    ...
    PUSH EBX                            ; 0043c360
        ;   Label: core_cow.cpp_CZombieCow_processDismemberment_FUN_0043c360
    PUSH ESI                            ; 0043c361
    PUSH EDI                            ; 0043c362
    PUSH EBP                            ; 0043c363
