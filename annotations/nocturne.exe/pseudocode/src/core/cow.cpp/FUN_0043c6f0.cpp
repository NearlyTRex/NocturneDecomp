// Name: core_cow.cpp_FUN_0043c6f0
// Address: 0043c6f0
// Address Range: [[0043c6f0, 0043c7a8]]
// Convention: unknown
// Signature: int core_cow_cpp_FUN_0043c6f0(int param_1,byte param_2)

#include "nocturne.h"

int core_cow_cpp_FUN_0043c6f0(int param_1,byte param_2)

{
  ...
  if ((param_2 & 4) != 0) {
    uVar2 = __vec_delete(param_1,&g_CZombieCowTypeInfo_0059b9f0);
