...
// Convention: unknown
// Signature: void core_actor_cpp_FUN_0040b0d0(int param_1,undefined4 param_2)

#include "nocturne.h"

void core_actor_cpp_FUN_0040b0d0(int param_1,uint param_2)

{
  core_actor_cpp_FUN_0040e120(param_2,param_1);
