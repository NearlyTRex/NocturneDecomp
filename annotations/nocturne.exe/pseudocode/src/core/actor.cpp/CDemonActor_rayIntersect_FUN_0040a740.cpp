...

{
  ...
  if (ray_bbox == (CBoundingBox3D *)0x0) {
    ...
    iVar2 = core_box_cpp_CBoundingBox3D_doesBoxIntersect_FUN_0041dc20(&local_6c,&local_9c);
  }
  else {
    iVar2 = core_box_cpp_CBoundingBox3D_doesBoxIntersect_FUN_0041dc20(ray_bbox,&local_9c);
  }
  if (iVar2 == 0) {
    return 2.0;
  }
  ...
  if ((uint)bbox_type < 2) {
    if (bbox_type == 1) {
      ...
      local_a0 = core_box_cpp_CBoundingBox3D_doesRayIntersect_FUN_0041d550
                           (this_ptr_00,pCVar4,(CVector3f *)in_stack_ffffff48,
...
LAB_0040a899:
    ...
    if (frame_index == (CDeformableModelInstance *)0x0) {
      if (collision_info->keyframed_model != (CKeyFramedModelInstance *)0x0) {
        ...
        local_a0 = core_dmodel_cpp_CKeyFramedModel_intersectRay_FUN_00453990
                             (this_ptr_01,(int)frame_index,ray_origin_00,pCVar4,output_normal);
        if (local_a0 < 0.0) {
          return 2.0;
        }
        local_14 = local_a0;
      ...
      iVar2 = core_skeleton_cpp_CDeformableModel_findMaxWeightBone_FUN_0051b540
                        (this_ptr_02,iVar2,triangle_index);
      out_hit->bone_index = iVar2;
      if ((int *)&stack0x00000000 !=
          &g_CDeformableModel_ARRAY_0268cef4[0].lod_info[2].shadow_only_flag) {
  ...
  if (out_hit != pSVar3) {
    (out_hit->normal).x = (pSVar3->normal).x;
    (out_hit->normal).y = (pSVar3->normal).y;
    (out_hit->normal).z = (pSVar3->normal).z;
  }
  return local_a0;
}
