...
section .text
    ...
    PUSH EBX                            ; 0040cb00
        ;   Label: core_actor.cpp_archiveMotionState_FUN_0040cb00
    PUSH ESI                            ; 0040cb01
    PUSH EBP                            ; 0040cb02
    ...
    CALL core_motion.cpp_CMotionController_load_FUN_004e2180 ; 0040cb39
        ;   XREF to: 004e2180 (UNCONDITIONAL_CALL)  ; void core_motion.cpp_CMotionController_load_FUN_004e2180(CMotionController * this_ptr, _FILE * file_handle)
    ...
    CALL core_motion.cpp_CMotionController_save_FUN_004e2220 ; 0040cbbc
        ;   XREF to: 004e2220 (UNCONDITIONAL_CALL)  ; void core_motion.cpp_CMotionController_save_FUN_004e2220(CMotionController * this_ptr, _FILE * file_handle, char * indent_prefix)
