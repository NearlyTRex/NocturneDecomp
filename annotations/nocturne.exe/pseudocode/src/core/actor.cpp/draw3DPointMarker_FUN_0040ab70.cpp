...
// Convention: unknown
// Signature: void core_actor_cpp_draw3DPointMarker_FUN_0040ab70(float *param_1,undefined4 param_2)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void core_actor_cpp_draw3DPointMarker_FUN_0040ab70(float *param_1,uint param_2)

{
  ...
  local_14.x = (int)ROUND(*param_1 * _DAT_005992b0);
  local_14.y = (int)ROUND(param_1[1] * _DAT_005992b0);
  local_14.z = (int)ROUND(param_1[2] * _DAT_005992b0);
