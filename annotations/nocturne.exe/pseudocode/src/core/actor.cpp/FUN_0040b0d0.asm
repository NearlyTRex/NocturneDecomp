...
;                               FUNCTION
; *****************************************************************************
; void core_actor_cpp_FUN_0040b0d0(int param_1,undefined4 param_2)
;
;
; XREF[1]:
...
section .text
    ...
    PUSH EBX                            ; 0040b0da
    PUSH ESI                            ; 0040b0db
    CALL core_actor.cpp_FUN_0040e120    ; 0040b0dc
    ...
    CALL core_actor.cpp_crc32ProcessVector_FUN_0040e100 ; 0040b0e9
        ;   XREF to: 0040e100 (UNCONDITIONAL_CALL)  ; undefined core_actor.cpp_crc32ProcessVector_FUN_0040e100()
