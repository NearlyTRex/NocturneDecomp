...

{
  ...
  fVar1 = core_actor_cpp_normalizeAngleToPi_FUN_0040df00((this_ptr->orient).vec.x);
  (this_ptr->orient).vec.x = fVar1;
  fVar1 = core_actor_cpp_normalizeAngleToPi_FUN_0040df00((this_ptr->orient).vec.z);
  (this_ptr->orient).vec.z = fVar1;
  fVar1 = core_actor_cpp_normalizeAngleToPi_FUN_0040df00((this_ptr->orient).vec.y);
