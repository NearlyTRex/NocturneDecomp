...

{
  ...
  if (this_ptr->actor_name[0] == '\0') {
    ...
    core_main_c_displayErrorAndQuit_FUN_004c8440("CDemonActor::save - tried to save actor of class %s with no name");
  }
  ...
  if ((file_handle->_flag & 0x20) != 0) {
    ...
    core_main_c_displayErrorAndQuit_FUN_004c8440("IO Error after writing actor of type %s");
  }
