...
;
; XREF[1]:
;   core_bodypart.cpp_CBodyPart_getAllowedMeleeAttackTypes_FUN_00417ef0 at 00417f01
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0040b200
        ;   Label: core_actor.cpp_CDemonActor_getAllowedMeleeAttackTypes_FUN_0040b200
    PUSH EBP                            ; 0040b201
