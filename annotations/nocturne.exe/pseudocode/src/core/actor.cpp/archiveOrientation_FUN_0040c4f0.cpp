...
// Convention: unknown
// Signature: void core_actor_cpp_archiveOrientation_FUN_0040c4f0(float *param_1,undefined4 param_2)

#include "nocturne.h"

void core_actor_cpp_archiveOrientation_FUN_0040c4f0(float *param_1,uint param_2)
