...
;   TerminatedCString s_Not_enough_memory_to_cre_00577ff0
...
section .text
    ...
    MOV dword ptr [0x01cc4800],EBP      ; 0040d56c | g_CurrentFilename
    MOV [0x01cc4804],EAX                ; 0040d572 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 0040d577
    ...
    MOV dword ptr [0x01cc4800],EDX      ; 0040d59e | g_CurrentFilename
    MOV dword ptr [0x01cc4804],ECX      ; 0040d5a4 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 0040d5aa
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
    ...
    MOV dword ptr [0x01cc4800],EDX      ; 0040d5c4 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],ECX      ; 0040d5ca | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 0040d5d0
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
