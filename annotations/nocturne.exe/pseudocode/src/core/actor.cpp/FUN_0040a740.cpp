...
// Convention: unknown
// Signature: float FUN_0040a740(int param_1,float *param_2,float *param_3,undefined4 *param_4,int param_5,uint param_6,int param_7)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

float FUN_0040a740(int param_1,float *param_2,float *param_3,uint *param_4,int param_5,uint param_6,int param_7)

{
  ...
  if (param_6 < 2) {
    if (param_6 == 1) {
      ...
      local_a0 = (float)FUN_0041d550(uVar2);
      local_14 = local_a0;
      goto LAB_0040a899;
    }
  }
    ...
    if (param_6 < 3) {
      local_a0 = (float)FUN_00409860(param_5);
      local_14 = local_a0;
      goto LAB_0040a899;
    }
    if (param_6 == 3) {
  ...
  if (*(int *)(iVar1 + 0x15f2f4) == 0) {
    if (*(int *)(param_5 + 0x20) == 0) {
      if (*(int *)(param_5 + 0x24) != 0) {
        uVar2 = FUN_00454530(*(uint *)(param_5 + 0x24),0);
        local_a0 = (float)FUN_00453990(uVar2);
        if (local_a0 < 0.0) {
          return 2.0;
        }
        local_14 = local_a0;
