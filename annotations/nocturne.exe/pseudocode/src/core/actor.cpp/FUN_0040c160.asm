...
;
; XREF[2]:
;   FUN_004c1190 at 004c1359
;   FUN_004d7fe0 at 004d8377
;
; Referenced Globals:
...
section .text
    ...
    PUSH EDX                            ; 0040c23e
    CALL FUN_00563350                   ; 0040c23f
        ;   XREF to: 00563350 (UNCONDITIONAL_CALL)  ; undefined FUN_00563350()
    ADD ESP,0x10                        ; 0040c244
    MOV EAX,ESP                         ; 0040c247
    PUSH EAX                            ; 0040c249
    PUSH EBP                            ; 0040c24a
    CALL FUN_00564520                   ; 0040c24b
        ;   XREF to: 00564520 (UNCONDITIONAL_CALL)  ; undefined FUN_00564520()
