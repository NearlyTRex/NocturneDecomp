...
;   core_boneguy.cpp_getWorldBoundingBoxCenter_FUN_004181f0 at 00418216
;   core_lightgun.cpp_CLightGun_fire_FUN_004c71a0 at 004c74d4
;   core_mobster.cpp_getObjectGrabPointWorld_FUN_004da070 at 004da096
...
section .text
    ...
    MOV EAX,dword ptr [ESP + 0x4]       ; 0040e160
        ;   Label: core_actor.cpp_CVector3f_ctor_FUN_0040e160
    RET                                 ; 0040e164
