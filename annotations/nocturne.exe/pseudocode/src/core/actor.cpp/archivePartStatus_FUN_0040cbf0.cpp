...

{
  ...
  if (DAT_00763e88 != 1) {
    ...
    _fprintf(DAT_00763e84,&DAT_00577d70,&DAT_005acc90);
    iVar2 = param_1;
    do {
      puVar1 = (uint *)(iVar2 + 0x2140);
      iVar2 = iVar2 + 4;
      _fprintf(DAT_00763e84,&DAT_00577d73,*puVar1);
    } while (iVar2 != param_1 + 0x78);
    _fprintf(DAT_00763e84,&DAT_00577d77);
    iVar2 = 0;
    _fprintf(DAT_00763e84,&DAT_00577d79,&DAT_005acc90);
    do {
      puVar1 = (uint *)(param_1 + 0x21b8);
      param_1 = param_1 + 4;
      iVar2 = iVar2 + 1;
      _fprintf(DAT_00763e84,&DAT_00577d7c,*puVar1);
    } while (iVar2 < 0x1e);
    _fprintf(DAT_00763e84,&DAT_00577d80);
    core_actor_cpp_adjustIndentationLevel_FUN_0040bff0(0xffffffff);
    _fprintf(DAT_00763e84,&DAT_00577d82,&DAT_005acc90);
    return;
  }
  do {
  ...
  _fscanf(DAT_00763e84,&DAT_00577d3e);
  do {
