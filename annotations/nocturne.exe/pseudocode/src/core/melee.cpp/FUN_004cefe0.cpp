...
// Convention: unknown
// Signature: void core_melee_cpp_FUN_004cefe0(CMelee *param_1,int param_2,SDamageInfo *param_3,CDemonActor *param_4)
...

{
  ...
  core_actor_cpp_FUN_0040bce0((CDemonActor *)param_1,param_2,param_3,param_4);
