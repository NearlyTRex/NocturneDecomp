...
// Convention: unknown
// Signature: void core_melee_cpp_FUN_004cefe0(int param_1,int param_2,undefined4 param_3,int param_4)

#include "nocturne.h"

void core_melee_cpp_FUN_004cefe0(int param_1,int param_2,uint param_3,int param_4)
