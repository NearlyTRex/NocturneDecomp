...

{
  ...
  if (0 < (int)_DAT_01bc9af4) {
    point1_ptr = CVector3f_ARRAY_01bc9af8;
    do {
      uVar2 = iVar3 + 1;
      if (uVar2 == _DAT_01bc9af4) {
        uVar2 = uVar2 ^ _DAT_01bc9af4;
      }
      point2_ptr = CVector3f_ARRAY_01bc9af8 + uVar2;
      ...
      switch(bVar1) {
      case 0:
        if (CVector3f_ARRAY_01bc9bbc + _DAT_01bc9bb8 != point1_ptr) {
          CVector3f_ARRAY_01bc9bbc[_DAT_01bc9bb8].x = point1_ptr->x;
          CVector3f_ARRAY_01bc9bbc[_DAT_01bc9bb8].y = point1_ptr->y;
          CVector3f_ARRAY_01bc9bbc[_DAT_01bc9bb8].z = point1_ptr->z;
        }
        break;
      case 1:
        core_dtri_cpp_clipLineToPlane_FUN_0046d4e0
                  (point2_ptr,point1_ptr,CVector3f_ARRAY_01bc9bbc + _DAT_01bc9bb8,1.0,0.0,0.0,
                   (double)-param_1);
        break;
      case 2:
        if (CVector3f_ARRAY_01bc9bbc + _DAT_01bc9bb8 != point1_ptr) {
        ...
        core_dtri_cpp_clipLineToPlane_FUN_0046d4e0
                  (point1_ptr,point2_ptr,CVector3f_ARRAY_01bc9bbc + _DAT_01bc9bb8,1.0,0.0,0.0,
                   (double)-param_1);
        break;
      default:
