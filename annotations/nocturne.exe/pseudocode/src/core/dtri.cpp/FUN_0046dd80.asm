...
;   undefined4 DAT_01bc9d44
;   undefined4 DAT_01bc9d48
;   undefined4 DAT_01bc9d4c
;   undefined4 DAT_01bc9d58
;   undefined4 DAT_01bc9d64
...
section .text
    ...
    FLD float ptr [ESI + 0x8]           ; 0046ddc3 | DAT_01bc9d4c | DAT_01bc9d58
    ...
    MOV EAX,dword ptr [ESP + 0x4]       ; 0046dddd
        ;   Label: LAB_0046dddd
    FLD float ptr [EAX + 0x8]           ; 0046dde1 | DAT_01bc9d4c | DAT_01bc9d64
    ...
    MOV EAX,dword ptr [EDX]             ; 0046de08 | DAT_01bc9d44
    MOV dword ptr [ECX],EAX             ; 0046de0a
    MOV EAX,dword ptr [EDX + 0x4]       ; 0046de0c | DAT_01bc9d48
    MOV dword ptr [ECX + 0x4],EAX       ; 0046de0f
    MOV EAX,dword ptr [EDX + 0x8]       ; 0046de12 | DAT_01bc9d4c
    ...
    PUSH ECX                            ; 0046de55
    PUSH EDX                            ; 0046de56 | DAT_01bc9d44
    ...
    MOV EAX,dword ptr [EDX]             ; 0046de7f | DAT_01bc9d44
    MOV dword ptr [ECX],EAX             ; 0046de81
    MOV EAX,dword ptr [EDX + 0x4]       ; 0046de83 | DAT_01bc9d48
    MOV dword ptr [ECX + 0x4],EAX       ; 0046de86
    MOV EAX,dword ptr [EDX + 0x8]       ; 0046de89 | DAT_01bc9d4c
    ...
    PUSH ECX                            ; 0046deb6
    PUSH EDX                            ; 0046deb7 | DAT_01bc9d44
