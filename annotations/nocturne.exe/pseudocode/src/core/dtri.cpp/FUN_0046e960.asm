...
section .text
    ...
    PUSH EBP                            ; 0046e960
        ;   Label: core_dtri.cpp_FUN_0046e960
    SUB ESP,0x4                         ; 0046e961
    MOV EDX,dword ptr [ESP + 0xc]       ; 0046e964
    PUSH EDX                            ; 0046e968
    CALL core_dtri.cpp_FUN_0046e950     ; 0046e969
        ;   XREF to: 0046e950 (UNCONDITIONAL_CALL)  ; undefined core_dtri.cpp_FUN_0046e950()
