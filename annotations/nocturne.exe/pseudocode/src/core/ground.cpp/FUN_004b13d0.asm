...
section .text
    ...
    PUSH EAX                            ; 004b1408
    CALL FUN_00544930                   ; 004b1409
        ;   XREF to: 00544930 (UNCONDITIONAL_CALL)  ; undefined FUN_00544930()
    ...
    MOV dword ptr [0x01cc4800],ESI      ; 004b142b | DAT_01cc4800
    MOV dword ptr [0x01cc4804],EDI      ; 004b1431 | DAT_01cc4804
    CALL FUN_004c8440                   ; 004b1437
    ...
    MOV [0x01cc4800],EAX                ; 004b1452 | DAT_01cc4800
    MOV dword ptr [0x01cc4804],EDX      ; 004b1457 | DAT_01cc4804
    CALL FUN_004c8440                   ; 004b145d
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; undefined FUN_004c8440()
