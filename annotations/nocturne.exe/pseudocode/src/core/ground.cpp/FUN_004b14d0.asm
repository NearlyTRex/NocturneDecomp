...
section .text
    ...
    PUSH EBP                            ; 004b179b
    CALL FUN_00544950                   ; 004b179c
        ;   XREF to: 00544950 (UNCONDITIONAL_CALL)  ; undefined FUN_00544950()
