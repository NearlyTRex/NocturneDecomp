...

{
  ...
  if (pSVar1 == (SGroundCell *)0x0) {
    ...
    core_main_c_displayErrorAndQuit_FUN_004c8440("CGround::init - Out of memory");
  }
  this_ptr_00 = operator_new(0x6d64);
  ...
  core_main_c_displayErrorAndQuit_FUN_004c8440("CGround::init - Out of memory2");
  return;
}
