...
// Convention: unknown
// Signature: undefined4 FUN_004b14d0(int *param_1,char *param_2)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_004b14d0(int *param_1,char *param_2)
...
LAB_004b153d:
  ...
  piVar5 = (int *)FUN_00456a60(local_24,local_cc,puVar3);
  if (piVar5 == (int *)0x0) {
    _DAT_01cc4800 = "..\\core\\ground.cpp";
    _DAT_01cc4804 = 0x44;
...
LAB_004b1687:
  ...
  local_1c = FUN_00456a60(local_28,local_7c,local_2c);
  if (local_1c == 0) {
    _DAT_01cc4800 = "..\\core\\ground.cpp";
    _DAT_01cc4804 = 0x44;
    FUN_004c8440("eopen - Cannot open file");
    ...
    do {
      ...
      if (0 < *param_1) {
        do {
          ...
          iVar11 = iVar11 + 1;
          FUN_005636d0(iVar6 * 4 + param_1[9] + 2,1,2,local_1c);
        } while (iVar11 < *param_1);
      }
      local_14 = local_14 + 1;
  ...
  uVar7 = FUN_00544950(param_1[10],param_2);
  return uVar7;
}
