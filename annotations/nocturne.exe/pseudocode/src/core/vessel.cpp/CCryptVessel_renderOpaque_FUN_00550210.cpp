...
// Convention: unknown
// Signature: undefined4 core_vessel_cpp_CCryptVessel_renderOpaque_FUN_00550210(int param_1)

#include "nocturne.h"

uint core_vessel_cpp_CCryptVessel_renderOpaque_FUN_00550210(int param_1)
