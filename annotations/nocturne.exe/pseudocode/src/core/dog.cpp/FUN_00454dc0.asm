...
;                               FUNCTION
; *****************************************************************************
; void core_dog_cpp_FUN_00454dc0(int param_1)
;
;
; Referenced Globals:
;   TerminatedCString s_speed_0057cfce
;   TerminatedCString s_modelName_0057cfd4
;   TerminatedCString s_guardDistance_0057cfde
;   TerminatedCString s_motion_state_0057cfec
...
section .text
    ...
    PUSH EBX                            ; 00454dc0
        ;   Label: core_dog.cpp_FUN_00454dc0
    MOV EBX,dword ptr [ESP + 0x8]       ; 00454dc1
    PUSH EBX                            ; 00454dc5
    CALL core_enemy.cpp_CEnemy_archive_FUN_004796c0 ; 00454dc6
        ;   XREF to: 004796c0 (UNCONDITIONAL_CALL)  ; undefined core_enemy.cpp_CEnemy_archive_FUN_004796c0()
    ADD ESP,0x4                         ; 00454dcb
    PUSH 0x57cfce                       ; 00454dce | = "speed"
    LEA EAX,[EBX + 0xbc8c]              ; 00454dd3
    PUSH EAX                            ; 00454dd9
    CALL core_actor.cpp_archiveFloat_FUN_0040c880 ; 00454dda
    ...
    PUSH EAX                            ; 00454ded
    CALL core_actor.cpp_archiveDeformableModelInstance_FUN_0040ca80 ; 00454dee
        ;   XREF to: 0040ca80 (UNCONDITIONAL_CALL)  ; undefined core_actor.cpp_archiveDeformableModelInstance_FUN_0040ca80()
    MOV EDX,dword ptr [0x005ae678]      ; 00454df3 | g_INT_005ae678
    ...
    PUSH EBX                            ; 00454e0c
    CALL core_actor.cpp_FUN_0040cb00    ; 00454e0d
    ...
    PUSH EAX                            ; 00454e22
    CALL core_actor.cpp_archiveFloat_FUN_0040c880 ; 00454e23
        ;   XREF to: 0040c880 (UNCONDITIONAL_CALL)  ; undefined core_actor.cpp_archiveFloat_FUN_0040c880()
