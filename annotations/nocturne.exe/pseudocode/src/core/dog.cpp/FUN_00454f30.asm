...
section .text
    ...
    PUSH EBX                            ; 00454f30
        ;   Label: core_dog.cpp_FUN_00454f30
    ...
    PUSH EBX                            ; 00454f48
    CALL core_armour.cpp_CFlame_arrdtor_FUN_0040fe50 ; 00454f49
    ...
    PUSH EAX                            ; 00454f58
    CALL core_armour.cpp_SFire_arrdtor_FUN_0040fe30 ; 00454f59
    ...
    PUSH EAX                            ; 00454f68
    CALL core_armour.cpp_CVector3f_arrdtor_FUN_0040fe10 ; 00454f69
    ...
    PUSH EAX                            ; 00454f78
    CALL core_armour.cpp_CVector3f_arrdtor_FUN_0040fe10 ; 00454f79
        ;   XREF to: 0040fe10 (UNCONDITIONAL_CALL)  ; CVector3f * core_armour.cpp_CVector3f_arrdtor_FUN_0040fe10(CVector3f * objs, uint flags)
    ...
    PUSH EAX                            ; 00454fdc
        ;   Label: LAB_00454fdc
    CALL crt_unknown.c_FUN_00564494     ; 00454fdd
