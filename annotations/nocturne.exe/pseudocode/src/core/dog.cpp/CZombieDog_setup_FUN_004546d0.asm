...
section .text
    ...
    PUSH EBX                            ; 004546d0
        ;   Label: core_dog.cpp_CZombieDog_setup_FUN_004546d0
    PUSH ESI                            ; 004546d1
    MOV ESI,dword ptr [ESP + 0xc]       ; 004546d2
    LEA EBX,[ESI + 0x150]               ; 004546d6
    PUSH EBX                            ; 004546dc
    CALL core_skeleton.cpp_CDeformableModelInstance_preCache_FUN_0051dcd0 ; 004546dd
    ...
    PUSH EBX                            ; 004546e5
    CALL core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_0051e0a0 ; 004546e6
    ...
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_005179d0 ; 004546f8
    ...
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_005179d0 ; 0045470e
        ;   XREF to: 005179d0 (UNCONDITIONAL_CALL)  ; undefined core_skeleton.cpp_CSkeleton_findBone_FUN_005179d0()
    ADD ESP,0xc                         ; 00454713
    PUSH ESI                            ; 00454716
    MOV dword ptr [ESI + 0xbd28],EAX    ; 00454717
    CALL core_enemy.cpp_CEnemy_setup_FUN_004796b0 ; 0045471d
