...
section .text
    ...
    PUSH EBX                            ; 0045476b
    CALL core_charactr.cpp_CCharacter_FUN_004259f0 ; 0045476c
    ...
    FMUL double ptr [0x0057cfae]        ; 004547cb | DOUBLE_0057cfae
    FMULP                               ; 004547d1
    ...
    FLD ST0                             ; 004547f8
    FMUL double ptr [0x0057cfb6]        ; 004547fa | DOUBLE_0057cfb6
    FSTP ST1                            ; 00454800
    FSTP float ptr [EBX + 0x2430]       ; 00454802
    PUSH dword ptr [EBP + 0x92]         ; 00454808
        ;   Label: LAB_00454808
    PUSH EBX                            ; 0045480e
    CALL core_charactr.cpp_CCharacter_FUN_00428c00 ; 0045480f
    ...
    FLD float ptr [EBP + 0x92]          ; 004548c8
        ;   Label: LAB_004548c8
    FLD ST0                             ; 004548ce
    FMUL double ptr [0x0057cfc6]        ; 004548d0 | DOUBLE_0057cfc6
    ...
    PUSH EBX                            ; 0045499b
    CALL core_charactr.cpp_CCharacter_FUN_0042a150 ; 0045499c
    ...
    FCOMP double ptr [0x0057cfbe]       ; 00454d20 | DOUBLE_0057cfbe
    FNSTSW AX                           ; 00454d26
    SAHF                                ; 00454d28
