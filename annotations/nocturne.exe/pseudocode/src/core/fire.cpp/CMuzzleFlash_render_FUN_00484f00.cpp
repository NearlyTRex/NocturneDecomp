...

{
  ...
  local_28.z = core_actor_cpp_getRandomFloatFromRange_FUN_0040dda0(0.0,6.2831855);
  local_28.x = 0.0;
  local_28.y = 0.0;
  local_10 = local_28.z;
  local_c = local_28.z;
  engine_drender_cpp_CDemonRenderer_applyScaledTransform_FUN_00460aa0
            (g_CDemonRenderer_PTR_005ae704,&local_28,(CVector3f *)0x0);
  g_CDemonSet_PTR_005be368->lighting_quality_mode = 1;
  engine_drender_cpp_CDemonRenderer_setBlendMode_FUN_00461000(g_CDemonRenderer_PTR_005ae704,1);
  uVar1 = rand();
  engine_drender_cpp_CDemonRenderer_setRenderAlpha_FUN_00461010
            (g_CDemonRenderer_PTR_005ae704,(uVar1 & 0x3fff) + 0x1800);
