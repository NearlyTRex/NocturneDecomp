...
// Convention: __cdecl
// Signature: void __cdecl core_fire_cpp_CGlassParticle_init_FUN_004850d0(CGlassParticle *this_ptr,STriangleVertices *triangle_vertices,CVector3i *uv_u_per_vertex,CVector3i *uv_v_per_vertex,SMRGLTextureBasic *texture,int lifetime)
...

{
  ...
  core_particle_cpp_CParticle_setup_FUN_004ef040(&this_ptr->base,&local_50,&local_68);
  return;
}
