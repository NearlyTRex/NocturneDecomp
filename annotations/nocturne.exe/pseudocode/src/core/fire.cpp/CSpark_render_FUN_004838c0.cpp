...
// Convention: unknown
// Signature: void core_fire_cpp_CSpark_render_FUN_004838c0(float *param_1)
...

{
  ...
  local_20 = 0.4;
  engine_special_cpp_transformPoint_FUN_00530a25(iVar2,&local_70);
  ...
  local_48 = -0.4;
  local_44 = 0;
  local_64 = (int)ROUND(256.0f * -0.4);
  local_60 = (int)ROUND(256.0f * -0.4);
  local_5c = (int)ROUND(256.0f * 0.0);
  engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704,&local_64);
  local_4c = 0.4;
  local_44 = 0;
  local_48 = -0.4;
  local_b8 = (int)ROUND(256.0f * 0.4);
  local_b4 = (int)ROUND(256.0f * -0.4);
  local_b0 = (int)ROUND(256.0f * 0.0);
  engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x30,&local_b8);
  local_4c = 0.4;
  local_48 = 0.4;
  local_44 = 0;
  local_94 = (int)ROUND(256.0f * 0.4);
  local_90 = (int)ROUND(256.0f * 0.4);
  local_8c = (int)ROUND(256.0f * 0.0);
  engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x60,&local_94);
  local_4c = -0.4;
  local_48 = 0.4;
  local_44 = 0;
  local_7c = (int)ROUND(256.0f * -0.4);
  local_78 = (int)ROUND(256.0f * 0.4);
  local_74 = (int)ROUND(256.0f * 0.0);
  engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x90,&local_7c);
  fVar4 = param_1[0x11];
  if (fVar4 == 0.0) {
    puVar3 = &DAT_005b84cc;
  }
...
LAB_0048394f:
  ...
  do {
    ...
    local_48 = local_1c;
    local_44 = 0;
    local_c4 = (int)ROUND(local_4c * 256.0f);
    local_c0 = (int)ROUND(local_1c * 256.0f);
    local_bc = (int)ROUND(256.0f * 0.0);
    local_18 = local_4c;
    engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x30,&local_c4);
    local_44 = 0;
    local_4c = local_18;
    local_48 = local_18;
    local_88 = (int)ROUND(local_18 * 256.0f);
    local_84 = (int)ROUND(local_18 * 256.0f);
    local_80 = (int)ROUND(256.0f * 0.0);
    engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x60,&local_88);
    local_4c = local_1c;
    local_48 = local_18;
    local_44 = 0;
    local_d0 = (int)ROUND(local_1c * 256.0f);
    local_cc = (int)ROUND(local_18 * 256.0f);
    local_c8 = (int)ROUND(256.0f * 0.0);
    engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x90,&local_d0);
    core_dcamera_cpp_CDemonCamera_setupPerspectiveAndFog_FUN_00447670(_DAT_007f7370,param_1,0);
    lVar1 = (longlong)(int)param_1[0xe] * (longlong)(0xffff - _DAT_01c038f4);
    DAT_005c5040 = (uint)lVar1 >> 0x10 | (int)((ulonglong)lVar1 >> 0x20) << 0x10;
    DAT_005c5034 = 0xffff;
