...
section .text
    ...
    MOV EAX,[0x005b9354]                ; 004874e8 | g_CGame_PTR_005b9354
    MOV EAX,dword ptr [EAX + 0x264]     ; 004874ed | g_CGame_01c775ec.delta_time_float
    ...
    PUSH ECX                            ; 0048753c
    CALL core_fire.cpp_CFireEffect_createExplosion_FUN_0048c0d0 ; 0048753d
    ...
    PUSH EAX                            ; 004875f9
    MOV EDX,dword ptr [0x005b80f0]      ; 004875fa | g_CFireEffect_PTR_005b80f0
    PUSH EDX                            ; 00487600
