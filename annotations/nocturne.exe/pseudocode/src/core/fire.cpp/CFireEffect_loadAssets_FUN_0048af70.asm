...
section .text
    ...
    CALL core_fire.cpp_loadStakeAssets_FUN_00483290 ; 0048afad
        ;   XREF to: 00483290 (UNCONDITIONAL_CALL)  ; void core_fire.cpp_loadStakeAssets_FUN_00483290()
    CALL core_fire.cpp_loadFireBallAssets_FUN_00483ff0 ; 0048afb2
        ;   XREF to: 00483ff0 (UNCONDITIONAL_CALL)  ; void core_fire.cpp_loadFireBallAssets_FUN_00483ff0()
    CALL core_fire.cpp_loadRockAssets_FUN_00484cb0 ; 0048afb7
        ;   XREF to: 00484cb0 (UNCONDITIONAL_CALL)  ; void core_fire.cpp_loadRockAssets_FUN_00484cb0()
    CALL core_fire.cpp_loadDynamiteAssets_FUN_004876a0 ; 0048afbc
        ;   XREF to: 004876a0 (UNCONDITIONAL_CALL)  ; void core_fire.cpp_loadDynamiteAssets_FUN_004876a0()
    CALL core_fire.cpp_loadGunFlameAssets_FUN_00488220 ; 0048afc1
        ;   XREF to: 00488220 (UNCONDITIONAL_CALL)  ; void core_fire.cpp_loadGunFlameAssets_FUN_00488220()
    CALL core_fire.cpp_loadGunFlashAssets_FUN_004850b0 ; 0048afc6
        ;   XREF to: 004850b0 (UNCONDITIONAL_CALL)  ; void core_fire.cpp_loadGunFlashAssets_FUN_004850b0()
    CALL core_fire.cpp_loadLightningBoltAssets_FUN_00488ad0 ; 0048afcb
        ;   XREF to: 00488ad0 (UNCONDITIONAL_CALL)  ; void core_fire.cpp_loadLightningBoltAssets_FUN_00488ad0()
    CALL core_fire.cpp_loadDebrisAssets_FUN_00486da0 ; 0048afd0
        ;   XREF to: 00486da0 (UNCONDITIONAL_CALL)  ; void core_fire.cpp_loadDebrisAssets_FUN_00486da0()
    POP EBX                             ; 0048afd5
    RET                                 ; 0048afd6
