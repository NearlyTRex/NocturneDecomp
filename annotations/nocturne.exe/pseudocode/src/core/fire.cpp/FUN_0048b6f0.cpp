...
// Convention: __cdecl
// Signature: void __cdecl core_fire_cpp_FUN_0048b6f0(CFireEffect *this_ptr,CVector3f *origin,CVector3f *direction,SLaserInfo *laser_info,int recursion_depth)
...

{
  ...
  if (recursion_depth < 3) {
    ...
    core_fire_cpp_FUN_0048b6f0(this_ptr,&local_134,&local_104,&local_1e8,recursion_depth + 1);
