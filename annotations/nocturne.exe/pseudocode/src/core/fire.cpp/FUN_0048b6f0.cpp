...
// Convention: unknown
// Signature: void core_fire_cpp_FUN_0048b6f0(undefined4 param_1,float *param_2,float *param_3,float *param_4,int param_5)

#include "nocturne.h"

void core_fire_cpp_FUN_0048b6f0(uint param_1,float *param_2,float *param_3,float *param_4,int param_5)
  ...
  if (param_5 < 3) {
    ...
    while( true ) {
      ...
      if (iVar1 != 0) {
        ...
        if ((((param_5 == 0) && (param_4[6] != 0.0)) &&
            (iVar4 = core_actor_cpp_castToClassHash_FUN_0040d890
                               (iVar1,g_CCharacterActorType_00765a60.name_hash), iVar4 != 0)) &&
      ...
      if (0.0 < param_4[0x14]) {
        ...
        core_fire_cpp_FUN_0048b6f0(param_1,&local_134,&local_bc,&local_23c,local_54);
