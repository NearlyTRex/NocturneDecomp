...
; CVector3f *      Stack[0x8]:4   impact_pos
...
;
; XREF[5]:
;   core_elephant.cpp_CElephantGun_fire_FUN_00477890 at 00477fc1
;   core_gun.cpp_CGun_fire_FUN_004b27c0 at 004b2fa5
;   core_shotgun.cpp_CShotgun_fire_FUN_00515ea0 at 00516608
;   core_tommygun.cpp_CTommyGun_fire_FUN_00545c30 at 0054645f
...
section .text
    ...
    PUSH EBX                            ; 0048ab60
        ;   Label: core_fire.cpp_CFireEffect_createBulletImpact_FUN_0048ab60
    PUSH ESI                            ; 0048ab61
    PUSH EDI                            ; 0048ab62
    PUSH EBP                            ; 0048ab63
    ...
    CALL core_dcamera.cpp_CDemonCamera_isSphereVisible_FUN_00446590 ; 0048ac50
        ;   XREF to: 00446590 (UNCONDITIONAL_CALL)  ; int core_dcamera.cpp_CDemonCamera_isSphereVisible_FUN_00446590(CDemonCamera * this_ptr, CVector3f * position, float radius)
    ...
    CALL core_fire.cpp_allocateBulletHole_FUN_0048a0e0 ; 0048ad12
        ;   XREF to: 0048a0e0 (UNCONDITIONAL_CALL)  ; CBulletHole * core_fire.cpp_allocateBulletHole_FUN_0048a0e0()
    ...
    CALL core_fire.cpp_CBulletHole_init_FUN_00482c80 ; 0048ad21
        ;   XREF to: 00482c80 (UNCONDITIONAL_CALL)  ; void core_fire.cpp_CBulletHole_init_FUN_00482c80(CBulletHole * this_ptr, CVector3f * hit_position, CVector3f * surface_normal, CDemonActor * hit_actor)
