// Name: core_fire.cpp_CFireEffect_FUN_0048b6f0
// Address: 0048b6f0
// Address Range: [[0048b6f0, 0048c0c9]]
// Convention: __cdecl
// Signature: void __cdecl core_fire_cpp_CFireEffect_FUN_0048b6f0(CFireEffect *this_ptr,CVector3f *origin,CVector3f *direction,SLaserInfo *laser_info,int recursion_depth)
  ...
  if (recursion_depth < 3) {
    ...
    while( true ) {
      ...
      if (0.0 < laser_info->transparency) {
        ...
        core_fire_cpp_CFireEffect_FUN_0048b6f0(this_ptr,&local_134,&local_bc,&local_23c,local_54);
