...
section .text
    ...
    PUSH EBX                            ; 00482c80
        ;   Label: core_fire.cpp_CBulletHole_init_FUN_00482c80
    PUSH ESI                            ; 00482c81
    PUSH EDI                            ; 00482c82
    PUSH EBP                            ; 00482c83
    ...
    PUSH EAX                            ; 00482da6
    CALL core_xform.cpp_buildMatrixFromEulerAndPositionDirect_FUN_0055afb0 ; 00482da7
    ...
    CALL core_xform.cpp_multiplyMatrix3x4_FUN_0055aa00 ; 00482ddc
    ...
    CALL core_actor.cpp_CDemonActor_inverseTransformVector_FUN_0040a220 ; 00482e5a
