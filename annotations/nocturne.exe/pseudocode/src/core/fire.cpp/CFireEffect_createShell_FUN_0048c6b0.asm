...
;   core_tommygun.cpp_CTommyGun_fire_FUN_00545c30 at 00546042
;
; Referenced Globals:
;   undefined4 DAT_01c684dc
;
; Called Functions:
;   core_fire.cpp_CShell_setup_FUN_00489640
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 0048c6b0
        ;   Label: core_fire.cpp_CFireEffect_createShell_FUN_0048c6b0
    PUSH ESI                            ; 0048c6b1
    PUSH EDI                            ; 0048c6b2
