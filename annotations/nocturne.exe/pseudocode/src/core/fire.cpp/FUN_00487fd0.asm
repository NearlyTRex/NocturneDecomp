...
section .text
    ...
    MOV EBX,dword ptr [0x005be368]      ; 00487fe0 | DAT_005be368
        ;   Label: LAB_00487fe0
    CMP EDI,dword ptr [EBX + 0x14ecb0]  ; 00487fe6 | DAT_01fa5f34
    ...
    MOV EAX,[0x005be368]                ; 00487ff8 | DAT_005be368 | DAT_01e57284
        ;   Label: LAB_00487ff8
    CMP EBX,dword ptr [EAX + 0x14cd6c]  ; 00487ffd | DAT_01fa3ff0
    ...
    MOV [0x01cc4800],EAX                ; 00488074 | DAT_01cc4800
    MOV dword ptr [0x01cc4804],EDX      ; 00488079 | DAT_01cc4804
    CALL FUN_004c8440                   ; 0048807f
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; undefined FUN_004c8440()
    ADD ESP,0x4                         ; 00488084
    JMP 0x00488047                      ; 00488087
        ;   XREF to: 00488047 (UNCONDITIONAL_JUMP)  ; LAB_00488047
    MOV EBP,dword ptr [0x01c7068c]      ; 00488089 | DAT_01c7068c
        ;   Label: LAB_00488089
    PUSH EBP                            ; 0048808f
    MOV EDX,dword ptr [ESI + EAX*0x1 + 0x14cd70] ; 00488090 | DAT_01fa3ff4
    PUSH EDX                            ; 00488097
    CALL FUN_0040d890                   ; 00488098
