...

{
  ...
  if ((iVar3 != 0) &&
    ...
    local_64 = (int)ROUND(local_74 * _DAT_0059d1f8);
    local_60 = (int)ROUND(_DAT_0059d1f8 * 0.0);
    local_70 = local_74;
    local_28 = local_74;
    wincore_windll_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704,&local_68);
    local_6c = 0;
    local_74 = local_20;
    local_70 = local_28;
    local_c8 = (int)ROUND(local_20 * _DAT_0059d1f8);
    local_c4 = (int)ROUND(local_28 * _DAT_0059d1f8);
    local_c0 = (int)ROUND(_DAT_0059d1f8 * 0.0);
    wincore_windll_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x30,&local_c8);
    local_74 = local_20;
    local_70 = local_20;
    local_6c = 0;
    local_b0 = (int)ROUND(local_20 * _DAT_0059d1f8);
    local_ac = (int)ROUND(local_20 * _DAT_0059d1f8);
    local_a8 = (int)ROUND(_DAT_0059d1f8 * 0.0);
    wincore_windll_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x60,&local_b0);
    local_74 = local_28;
    local_70 = local_20;
    local_6c = 0;
    local_80 = (int)ROUND(local_28 * _DAT_0059d1f8);
    local_7c = (int)ROUND(local_20 * _DAT_0059d1f8);
    local_78 = (int)ROUND(_DAT_0059d1f8 * 0.0);
    wincore_windll_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x90,&local_80);
    ...
    if ((param_1[0x11] != 1.4013e-45) && (param_1[0x11] != 2.8026e-45)) {
      ...
      do {
        ...
        local_6c = 0;
        local_98 = (int)ROUND(local_74 * _DAT_0059d1f8);
        local_94 = (int)ROUND(local_74 * _DAT_0059d1f8);
        local_90 = (int)ROUND(_DAT_0059d1f8 * 0.0);
        local_70 = local_74;
        local_1c = local_74;
        wincore_windll_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704,&local_98);
        local_74 = local_20 * fVar6;
        local_6c = 0;
        local_70 = local_1c;
        local_bc = (int)ROUND(local_74 * _DAT_0059d1f8);
        local_b8 = (int)ROUND(local_1c * _DAT_0059d1f8);
        local_b4 = (int)ROUND(_DAT_0059d1f8 * 0.0);
        local_18 = local_74;
        wincore_windll_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x30,&local_bc);
        local_6c = 0;
        local_74 = local_18;
        local_70 = local_18;
        local_44 = (int)ROUND(local_18 * _DAT_0059d1f8);
        local_40 = (int)ROUND(local_18 * _DAT_0059d1f8);
        local_3c = (int)ROUND(_DAT_0059d1f8 * 0.0);
        wincore_windll_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x60,&local_44);
        local_74 = local_1c;
        local_70 = local_18;
        local_6c = 0;
        local_8c = (int)ROUND(local_1c * _DAT_0059d1f8);
        local_88 = (int)ROUND(local_18 * _DAT_0059d1f8);
        local_84 = (int)ROUND(_DAT_0059d1f8 * 0.0);
        wincore_windll_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x90,&local_8c);
