...
// Convention: __cdecl
// Signature: void __cdecl core_fire_cpp_CCrater_activate_FUN_004876d0(CCrater *this_ptr,CVector3f *center_position,float radius)
...

{
  ...
  do {
    local_18 = -radius;
    local_14 = core_actor_cpp_getRandomFloatFromRange_FUN_0040dda0(local_18,radius);
