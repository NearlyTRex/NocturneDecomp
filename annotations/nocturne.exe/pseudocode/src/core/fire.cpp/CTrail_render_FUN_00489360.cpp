...

{
  ...
  local_2c = (int)ROUND(local_44 * 256.0f);
  local_28 = (int)ROUND(local_44 * 256.0f);
  local_24 = (int)ROUND(256.0f * 0.0);
  local_40 = local_44;
  engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704,&local_2c);
  local_44 = -local_44;
  local_14 = (int)ROUND(local_44 * 256.0f);
  local_10 = (int)ROUND(local_40 * 256.0f);
  local_c = (int)ROUND(local_3c * 256.0f);
  engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x30,&local_14);
  local_40 = -local_40;
  local_38 = (int)ROUND(local_44 * 256.0f);
  ...
  local_44 = -local_44;
  local_50 = (int)ROUND(local_44 * 256.0f);
