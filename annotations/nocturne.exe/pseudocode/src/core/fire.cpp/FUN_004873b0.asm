...
section .text
    ...
    MOV dword ptr [0x01cc4800],EDX      ; 004873ee | DAT_01cc4800
    MOV dword ptr [0x01cc4804],ECX      ; 004873f4 | DAT_01cc4804
    CALL FUN_004c8440                   ; 004873fa
