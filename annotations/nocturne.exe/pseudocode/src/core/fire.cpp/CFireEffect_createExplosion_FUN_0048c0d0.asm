...
section .text
    ...
    PUSH EBX                            ; 0048c0d0
        ;   Label: core_fire.cpp_CFireEffect_createExplosion_FUN_0048c0d0
    PUSH EDI                            ; 0048c0d1
    PUSH EBP                            ; 0048c0d2
    ...
    MOV EDX,dword ptr [0x005b9284]      ; 0048c141 | g_CForceFeedback_PTR_005b9284
    PUSH EDX                            ; 0048c147
    CALL engine_force.cpp_CForceFeedback_processEvent_FUN_004940d0 ; 0048c148
