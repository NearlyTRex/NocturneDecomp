...

{
  ...
  local_64 = (int)ROUND(*(float *)(param_1 + 4) * 256.0f);
  local_60 = (int)ROUND(*(float *)(param_1 + 8) * 256.0f);
  local_5c = (float)(int)ROUND(*(float *)(param_1 + 0xc) * 256.0f);
  piStack_74 = &local_64;
  engine_special_cpp_transformPoint_FUN_00530a25(piVar2);
  piStack_74 = piVar2;
  ...
  if (iVar4 != 0) {
    ...
    local_54 = 0;
    local_5c = -local_18;
    local_2c = (int)ROUND(local_5c * 256.0f);
    local_28 = (int)ROUND(local_5c * 256.0f);
    local_24 = (int)ROUND(256.0f * 0.0);
    local_58 = local_5c;
    local_20 = local_5c;
    engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704,&local_2c);
    local_5c = local_18;
    local_58 = local_20;
    local_54 = 0;
    piStack_74 = (int *)(int)ROUND(local_18 * 256.0f);
    local_70 = (int)ROUND(local_20 * 256.0f);
    local_6c = (int)ROUND(256.0f * 0.0);
    engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x30,&piStack_74);
    local_54 = 0;
    local_5c = local_18;
    local_58 = local_18;
    local_38 = (int)ROUND(local_18 * 256.0f);
    local_34 = (int)ROUND(local_18 * 256.0f);
    local_30 = (int)ROUND(256.0f * 0.0);
    engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x60,&local_38);
    local_5c = local_20;
    local_58 = local_18;
    local_54 = 0;
    local_50 = (int)ROUND(local_20 * 256.0f);
    local_4c = (int)ROUND(local_18 * 256.0f);
    local_48 = (int)ROUND(256.0f * 0.0);
    engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x90,&local_50);
    ...
    local_44 = (int)ROUND(*pfVar1 * 256.0f);
    local_40 = (int)ROUND(*(float *)(param_1 + 8) * 256.0f);
    local_3c = (int)ROUND(*(float *)(param_1 + 0xc) * 256.0f);
