...
// Convention: unknown
// Signature: void core_fire_cpp_CFireball_process_FUN_00484050(int param_1)
...

{
  ...
  *(int *)(param_1 + 0x50) = *(int *)(param_1 + 0x50) + iVar3;
  if (*(int *)(param_1 + 0x44) == 0) {
    iVar3 = param_1 + 0x5c;
    core_dglobe_cpp_CDemonGlobe_setPosition_FUN_0044cd90(iVar3,param_1);
    ...
    *(char *)(param_1 + 0x78) =
    ...
    core_dglobe_cpp_CDemonGlobe_precomputeAttenuation_FUN_0044cde0(iVar3,0x41000000);
    iVar4 = 0x01E57284;
    *(uint *)(param_1 + 0x7c) = 0;
    core_set_cpp_CDemonSet_addCoronaGlobe_FUN_0050a9f0(iVar4,iVar3);
    iVar3 = *(int *)(param_1 + 0x48) + _DAT_01bd1d80;
    *(int *)(param_1 + 0x48) = iVar3;
    uVar2 = 0x01C08D04;
    if (0x1000 < iVar3) {
      *(int *)(param_1 + 0x48) = iVar3 + -0x1000;
      core_fire_cpp_CFireEffect_createSmokeParticle_FUN_0048afe0(uVar2,param_1,0x40000000,0,0xffff);
      core_fire_cpp_CFireEffect_createSpark_FUN_0048ae90
                (0x01C08D04,param_1,0,0x20000,0x10000,0,0xffff);
      core_fire_cpp_CFireEffect_createSpark_FUN_0048ae90
                (0x01C08D04,param_1,0,0x20000,0x10000,0,0xffff);
      core_fire_cpp_CFireEffect_createSpark_FUN_0048ae90
                (0x01C08D04,param_1,0,0x20000,0x10000,0,0xffff);
  ...
  while( true ) {
    ...
    core_charactr_cpp_SDamageInfo_ctor_FUN_00423ed0(auStack_54);
    local_50 = local_18;
    iVar4 = iVar4 + 4;
    iVar3 = iVar3 + 1;
