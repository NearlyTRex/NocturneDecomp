...

{
  ...
  if ((0.0 < local_2e8) && (*(int *)(0x01C775EC + 0xc) != 0)) {
    ...
    do {
      ...
      local_e0 = local_28;
      local_dc = 0.0;
      local_180 = (int)ROUND(local_28 * 256.0f);
      local_17c = (int)ROUND(local_28 * 256.0f);
      local_178 = (int)ROUND(256.0f * 0.0);
      engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704,&local_180);
      local_e4 = -local_e4;
      local_c0 = (int)ROUND(local_e4 * 256.0f);
      local_bc = (int)ROUND(local_e0 * 256.0f);
      local_b8 = (int)ROUND(local_dc * 256.0f);
      engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x30,&local_c0);
      local_e0 = -local_e0;
      local_1bc = (int)ROUND(local_e4 * 256.0f);
      local_1b8 = (int)ROUND(local_e0 * 256.0f);
      local_1b4 = (int)ROUND(local_dc * 256.0f);
      engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x60,&local_1bc);
      local_e4 = -local_e4;
      local_174 = (int)ROUND(local_e4 * 256.0f);
      local_170 = (int)ROUND(local_e0 * 256.0f);
      local_16c = (int)ROUND(local_dc * 256.0f);
      engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x90,&local_174);
  ...
  if (0.0 < local_2e0) {
    ...
    if (-1 < (int)local_24) {
      ...
      do {
        ...
        local_a8 = (int)ROUND(local_cc * 256.0f);
        local_a4 = (int)ROUND(local_c8 * 256.0f);
        local_a0 = (int)ROUND(256.0f * 0.0);
        engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*piVar4,&local_a8);
        local_cc = local_68 * local_38;
        local_c8 = local_6c * local_38;
        local_c4 = fVar2 + (float)-0.10000000000000001;
        local_108 = (int)ROUND(local_cc * 256.0f);
        local_104 = (int)ROUND(local_c8 * 256.0f);
        local_100 = (int)ROUND(local_c4 * 256.0f);
        engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x30,&local_108);
        iVar8 = local_20;
        if (local_20 != 0) {
          uVar13 = 0x4866db;
  ...
  if (0.0 < local_2f4) {
    ...
    local_ac = 0.0;
    local_b0 = 0.2;
    local_198 = (int)ROUND(256.0f * 0.2);
    local_194 = (int)ROUND(256.0f * 0.2);
    local_190 = (int)ROUND(256.0f * 0.0);
    engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704,&local_198);
    local_b4 = -local_b4;
    local_d8 = (int)ROUND(local_b4 * 256.0f);
    local_d4 = (int)ROUND(local_b0 * 256.0f);
    local_d0 = (int)ROUND(local_ac * 256.0f);
    engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x30,&local_d8);
    local_b0 = -local_b0;
    local_1ec = (int)ROUND(local_b4 * 256.0f);
    local_1e8 = (int)ROUND(local_b0 * 256.0f);
    local_1e4 = (int)ROUND(local_ac * 256.0f);
    engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x60,&local_1ec);
    local_b4 = -local_b4;
    local_1c8 = (int)ROUND(local_b4 * 256.0f);
    local_1c4 = (int)ROUND(local_b0 * 256.0f);
    local_1c0 = (int)ROUND(local_ac * 256.0f);
    engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x90,&local_1c8);
    piVar4 = DAT_005ae704;
    local_28c = 4;
    local_27c = 0;
    local_280 = 0;
