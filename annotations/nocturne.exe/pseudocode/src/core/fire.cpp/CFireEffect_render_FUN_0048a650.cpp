...
// Convention: __cdecl
// Signature: void __cdecl core_fire_cpp_CFireEffect_render_FUN_0048a650(void)
...

{
  ...
  if (0 < _DAT_01c23d48) {
    ...
    do {
      if (*(int *)(iVar1 + 0x1c23d50) == 0) {
        core_fire_cpp_CStake_render_FUN_004835d0(iVar1 + 0x1c23d50);
      }
      iVar4 = iVar4 + 1;
      iVar1 = iVar1 + 0x260;
  ...
  core_fire_cpp_CFireball_setupRenderState_FUN_004842a0(0x1c58dfc);
  do {
    if (0.0 < *(float *)(puVar2 + 0x18)) {
      (**(code **)(*(int *)(puVar2 + 0x34) + 8))(puVar2);
    }
  ...
  if (iVar4 == 0) {
    ...
    if (0 < _DAT_01c20140) {
      ...
      do {
        if (*(int *)(iVar1 + 0x1c20158) != 0) {
          core_fire_cpp_CBulletHole_render_FUN_00482f50(&DAT_01c20148 + iVar1);
        }
        iVar4 = iVar4 + 1;
        iVar1 = iVar1 + 0x3c;
    ...
    core_fire_cpp_CSmokeParticle_setupRenderState_FUN_00482680(&DAT_01c0a140);
    do {
      if (*piVar3 != 0) {
        core_fire_cpp_CSmokeParticle_render_FUN_00482950(piVar3);
      }
      piVar3 = piVar3 + 0xb;
    ...
    do {
      if (*piVar3 != 0) {
        core_fire_cpp_CMuzzleFlash_render_FUN_00484f00(piVar3);
      }
      piVar3 = piVar3 + 0x17;
    ...
    if (0 < _DAT_01c5c700) {
      iVar1 = 0x1c5c704;
      do {
        core_fire_cpp_CLaserBeam_render_FUN_00485a90(iVar1);
        iVar4 = iVar4 + 1;
        iVar1 = iVar1 + 0x40;
      } while (iVar4 < _DAT_01c5c700);
    }
    puVar2 = (byte *)0x1c49d54;
    core_fire_cpp_CSpark_setupRenderState_FUN_004837a0(0x1c49d54);
    do {
      if (0.0 < *(float *)(puVar2 + 0x18)) {
        (**(code **)(*(int *)(puVar2 + 0x34) + 8))(puVar2);
      }
    ...
    do {
      if (*(int *)(puVar2 + 0x20) != 0) {
        core_fire_cpp_CBulletTrail_render_FUN_004856c0(puVar2);
      }
      puVar2 = puVar2 + 0x24;
    } while (puVar2 != &DAT_01c58df8);
    puVar2 = (byte *)0x1c5d708;
    do {
      core_fire_cpp_CExplosion_render_FUN_00486fe0(puVar2);
      puVar2 = puVar2 + 0x1c;
    } while (puVar2 != &DAT_01c5d820);
    puVar2 = (byte *)0x1c5d824;
    do {
      core_fire_cpp_CToss_render_FUN_00487630(puVar2);
      puVar2 = puVar2 + 0x3e4;
    } while (puVar2 != &DAT_01c625f4);
    puVar2 = &DAT_01c62ebc;
    do {
      core_fire_cpp_CGunFlame_render_FUN_00488580(puVar2);
      puVar2 = puVar2 + 0x24;
    } while (puVar2 != &DAT_01c6750c);
    puVar2 = (byte *)0x1c67510;
    do {
      core_fire_cpp_CLightningBolt_render_FUN_00488bf0(puVar2);
      puVar2 = puVar2 + 0x2c;
    } while (puVar2 != &DAT_01c676c8);
    puVar2 = (byte *)0x1c676cc;
    do {
      core_fire_cpp_CTrail_render_FUN_00489360(puVar2);
      puVar2 = puVar2 + 0x24;
    ...
    do {
      ...
      iVar4 = iVar4 + 0x38;
    } while ((CDemonActorType *)iVar4 != &g_CFlameActorType_01c70618);
  }
  return;
}
