...

{
  ...
  iVar2 = 0;
  do {
    piVar1 = (int *)((int)&(g_CDemonRenderer_PTR_005ae704->vertex_buffer_ptr->projected_vertex).
                           transformed_x + iVar2);
    *piVar1 = *piVar1 << 4;
    piVar1 = (int *)((int)&(g_CDemonRenderer_PTR_005ae704->vertex_buffer_ptr->projected_vertex).
                           transformed_y + iVar2);
    ...
    *piVar1 = *piVar1 << 4;
    iVar3 = iVar2 + 0x30;
    *(uint *)((int)&(g_CDemonRenderer_PTR_005ae704->vertex_buffer_ptr->projected_vertex).inv_z +
             iVar2) =
         *(uint *)((int)&(g_CDemonRenderer_PTR_005ae704->vertex_buffer_ptr->projected_vertex).inv_z
                  + iVar2) >> 4;
    iVar2 = iVar3;
  ...
  engine_drender_cpp_CDemonRenderer_renderZPrepassPoly_FUN_0045ef90
            (g_CDemonRenderer_PTR_005ae704,&SStack_88);
  return;
}
