...
;
; Called Functions:
;   core_mirror.cpp_SClipPlane_arrdtor5_FUN_004d7d90
;
; *****************************************************************************
...
section .text
    ...
    PUSH EAX                            ; 004d657b
    CALL core_mirror.cpp_SClipPlane_arrdtor5_FUN_004d7d90 ; 004d657c
        ;   XREF to: 004d7d90 (UNCONDITIONAL_CALL)  ; SClipPlane * core_mirror.cpp_SClipPlane_arrdtor5_FUN_004d7d90(SClipPlane * this_ptr, uint flags)
