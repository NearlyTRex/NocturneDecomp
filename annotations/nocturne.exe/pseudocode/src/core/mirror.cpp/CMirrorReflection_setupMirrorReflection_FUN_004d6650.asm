...
;
; XREF[1]:
;   core_set.cpp_CDemonSet_setupMirrorRendering_FUN_0050e080 at 0050e139
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004d6650
        ;   Label: core_mirror.cpp_CMirrorReflection_setupMirrorReflection_FUN_004d6650
    PUSH ESI                            ; 004d6651
    PUSH EDI                            ; 004d6652
    PUSH EBP                            ; 004d6653
    ...
    CALL core_mirror.cpp_computePlaneFromTriangle_FUN_004d6170 ; 004d6673
        ;   XREF to: 004d6170 (UNCONDITIONAL_CALL)  ; void core_mirror.cpp_computePlaneFromTriangle_FUN_004d6170(SClipPlane * out_plane, CVector3f * vertex_a, CVector3f * vertex_b, CVector3f * vertex_c)
    ...
    CALL core_mirror.cpp_CMirrorReflection_setupMirrorCamera_FUN_004d6610 ; 004d7076
        ;   XREF to: 004d6610 (UNCONDITIONAL_CALL)  ; void core_mirror.cpp_CMirrorReflection_setupMirrorCamera_FUN_004d6610(CMirrorReflection * this_ptr)
