...
// Convention: __cdecl
// Signature: void __cdecl core_mirror_cpp_computePlaneFromTriangle_FUN_004d6170(SClipPlane *out_plane,CVector3f *vertex_a,CVector3f *vertex_b,CVector3f *vertex_c)
...

{
  ...
  if (fVar1 <= 0.0) {
    ...
    fVar1 = 1.0 / fVar1;
    (out_plane->A).f = (out_plane->A).f * fVar1;
    (out_plane->B).f = (out_plane->B).f * fVar1;
    (out_plane->C).f = (out_plane->C).f * fVar1;
  }
  (out_plane->D).f =
