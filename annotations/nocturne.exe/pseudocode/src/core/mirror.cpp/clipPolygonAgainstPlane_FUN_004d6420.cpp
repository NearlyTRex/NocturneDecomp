...
// Convention: unknown
// Signature: void core_mirror_cpp_clipPolygonAgainstPlane_FUN_004d6420(float *param_1,float *param_2,uint param_3,int param_4,int *param_5)
    ...
    do {
      ...
      case 1:
        core_mirror_cpp_computePlaneIntersection_FUN_004d62f0
                  (param_1,pfVar4,pfVar6,*param_5 * 0xc + param_4);
        *param_5 = *param_5 + 1;
        break;
      case 2:
        ...
        *param_5 = iVar1 + 1;
        core_mirror_cpp_computePlaneIntersection_FUN_004d62f0
                  (param_1,pfVar6,pfVar4,(iVar1 + 1) * 0xc + param_4);
        *param_5 = *param_5 + 1;
      }
      local_14 = local_14 + 1;
      pfVar6 = pfVar6 + 3;
