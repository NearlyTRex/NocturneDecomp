...
;
; XREF[6]:
;   FUN_00411ae0 at 00411b05
;   FUN_004946c0 at 004948d0
;   FUN_004cc2e0 at 004cc2fc
;   FUN_004de860 at 004dea12
;   FUN_004f5f60 at 004f5fbd
;   FUN_0054e7f0 at 0054eaa7
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBP                            ; 0043b70c
    CALL FUN_00563350                   ; 0043b70d
        ;   XREF to: 00563350 (UNCONDITIONAL_CALL)  ; undefined FUN_00563350()
    ADD ESP,0x10                        ; 0043b712
    MOV EBX,dword ptr [ESP + 0x4]       ; 0043b715
    PUSH EBX                            ; 0043b719
    PUSH EDI                            ; 0043b71a
    CALL FUN_0043b610                   ; 0043b71b
        ;   XREF to: 0043b610 (UNCONDITIONAL_CALL)  ; undefined FUN_0043b610()
    MOV EBX,EBP                         ; 0043b720
    ADD ESP,0x8                         ; 0043b722
    PUSH EBX                            ; 0043b725
        ;   Label: LAB_0043b725
    CALL FUN_00564570                   ; 0043b726
        ;   XREF to: 00564570 (UNCONDITIONAL_CALL)  ; undefined FUN_00564570()
