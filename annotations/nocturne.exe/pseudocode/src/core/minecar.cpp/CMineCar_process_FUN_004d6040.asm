...
;   core_platfrm.cpp_CPlatform_process_FUN_004f6170
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 004d6040
        ;   Label: core_minecar.cpp_CMineCar_process_FUN_004d6040
    MOV EBX,dword ptr [ESP + 0x8]       ; 004d6041
    PUSH dword ptr [ESP + 0xc]          ; 004d6045
    PUSH EBX                            ; 004d6049
    CALL core_platfrm.cpp_CPlatform_process_FUN_004f6170 ; 004d604a
        ;   XREF to: 004f6170 (UNCONDITIONAL_CALL)  ; void core_platfrm.cpp_CPlatform_process_FUN_004f6170(CPlatform * this_ptr, float delta_time)
