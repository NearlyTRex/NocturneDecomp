// Name: core_bat.cpp_CBat_ctor_FUN_00411a10
// Address: 00411a10
// Address Range: [[00411a10, 00411adf]]
// Convention: __cdecl
// Signature: CBat * __cdecl core_bat_cpp_CBat_ctor_FUN_00411a10(CBat *this_ptr)
...

{
  ...
  *(CDemonActor_vtable **)(this_ptr_00[-1].model_name + 0xd0) = &g_CBatVTable;
  ...
  pcVar5 = this_ptr_00[-1].model_name + 0xd4;
  ...
  *(byte *)(this_ptr_00[1].part_visibility_flags + 4) = 0;
  ...
  return (CBat *)&this_ptr_00[-2].model_ptr;
}
