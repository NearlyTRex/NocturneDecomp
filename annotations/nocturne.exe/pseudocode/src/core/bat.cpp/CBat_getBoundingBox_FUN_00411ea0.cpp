...
// Convention: unknown
// Signature: undefined4 * core_bat_cpp_CBat_getBoundingBox_FUN_00411ea0(int param_1,undefined4 *param_2)

#include "nocturne.h"

uint * core_bat_cpp_CBat_getBoundingBox_FUN_00411ea0(int param_1,uint *param_2)
