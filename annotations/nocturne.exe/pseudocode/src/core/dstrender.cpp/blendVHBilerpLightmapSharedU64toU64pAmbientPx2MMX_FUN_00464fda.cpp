// Name: core_dstrender.cpp_blendVHBilerpLightmapSharedU64toU64pAmbientPx2MMX_FUN_00464fda
// Address: 00464fda
// Address Range: [[00464fda, 00465210] [00465220, 004652cf]]
// Convention: __cdecl
// Signature: void __cdecl core_dstrender_cpp_blendVHBilerpLightmapSharedU64toU64pAmbientPx2MMX_FUN_00464fda(ulonglong *output_buffer,ulonglong *texture_buffer,byte *texture_indices,byte *lightmap_indices,int pixel_count)
...

{
  ...
  do {
    ...
    uVar2 = *(uint *)
             (&DAT_00b0e1fc + ((uint)*texture_indices + (uint)texture_indices[0x140] >> 1) * 4);
    uVar8 = (ushort)(((uint7)(byte)(uVar1 >> 0x18) << 0x30) >> 0x28);
    uVar3 = *(uint *)
             (&DAT_00b0e1fc + ((uint)texture_indices[1] + (uint)texture_indices[0x141] >> 1) * 4);
    uVar5 = (uint)(CONCAT34((int3)(CONCAT25((short)(((uint7)(byte)((uint)uVar3 >> 0x18) << 0x30) >>
    ...
    uVar12 = (ushort)(CONCAT43(uVar6,CONCAT12((char)((uint)uVar2 >> 8),(ushort)uVar2)) >> 0x10) &
             0xff;
    ...
    uVar18 = *(ulonglong *)
              ...
              ((uint)texture_indices[1] + (uint)texture_indices[0x141] >> 2)) * 2) ^ _DAT_005b64f8;
    ...
    uVar14 = pmulhw(CONCAT26((uVar10 >> 8) * ((ushort)((short)(uVar25 >> 0x18) + sVar21) >> 1),
                             CONCAT24((short)CONCAT21(uVar10,(char)(uVar1 >> 0x30)) *
                                      ...
                                      CONCAT22((ushort)(byte)(uVar1 >> 0x28) *
                                               ((ushort)(((ushort)CONCAT41(uVar5,(char)((uint)uVar3
                                                                                       >> 8)) & 0xff
                                                         ) + uVar12) >> 1),
    ...
    uVar22 = pmulhw(uVar24,*(ulonglong *)
                            (&DAT_005b5d00 +
                            ((uint)*lightmap_indices +
                            ((uint)texture_indices[1] + (uint)texture_indices[0x141] >> 2)) * 2));
    sVar20 = (short)((ulonglong)uVar22 >> 0x10);
    sVar21 = (short)((ulonglong)uVar22 >> 0x20);
    sVar23 = (short)((ulonglong)uVar22 >> 0x30);
    uVar8 = (ushort)((short)uVar9 + (short)uVar22 + (short)0x0004000400040004) >> 4;
    ...
    uVar13 = (ushort)((short)uVar14 + (short)uVar22 + (short)0x000C000C000C000C) >> 4;
