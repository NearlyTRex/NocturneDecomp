...
// Convention: __cdecl
// Signature: void __cdecl core_dstrender_cpp_blendVHBilerpLightmapSharedU64toU64pAmbientPx2MMX_FUN_00464fda(undefined8 *param_1,undefined8 *param_2,byte *param_3,byte *param_4,int param_5)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __cdecl core_dstrender_cpp_blendVHBilerpLightmapSharedU64toU64pAmbientPx2MMX_FUN_00464fda(ulonglong *param_1,ulonglong *param_2,byte *param_3,byte *param_4,int param_5)

{
  ...
  do {
    ...
    uVar8 = pmulhw(CONCAT26((uVar7 >> 8) * sVar20,
                            CONCAT24((short)CONCAT21(uVar7,(char)((ulonglong)uVar13 >> 0x10)) *
                                     sVar19,CONCAT22((byte)((ulonglong)uVar13 >> 8) * uVar11,
                                                     ((ushort)uVar13 & 0xff) * uVar10))),uVar17);
    uVar13 = pmulhw(CONCAT26((uVar9 >> 8) * ((ushort)((short)(uVar24 >> 0x18) + sVar20) >> 1),
                             CONCAT24((short)CONCAT21(uVar9,(char)((ulonglong)uVar13 >> 0x30)) *
                                      ...
                                      CONCAT22((ushort)(byte)((ulonglong)uVar13 >> 0x28) *
                                               ...
                                               ((ushort)((byte)uVar2 + uVar10) >> 1)))),uVar17);
    ...
    uVar7 = (ushort)((short)uVar8 + (short)uVar21 + (short)0x0004000400040004) >> 4;
    ...
    uVar12 = (ushort)((short)uVar13 + (short)uVar21 + (short)0x000C000C000C000C) >> 4;
