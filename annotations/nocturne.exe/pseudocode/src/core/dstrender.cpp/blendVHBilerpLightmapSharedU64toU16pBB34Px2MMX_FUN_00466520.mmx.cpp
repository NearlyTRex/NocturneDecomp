...
// Convention: __cdecl
// Signature: void __cdecl core_dstrender_cpp_blendVHBilerpLightmapSharedU64toU16pBB34Px2MMX_FUN_00466520(uint *param_1,undefined8 *param_2,byte *param_3,byte *param_4,int param_5)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __cdecl core_dstrender_cpp_blendVHBilerpLightmapSharedU64toU16pBB34Px2MMX_FUN_00466520(uint *param_1,ulonglong *param_2,byte *param_3,byte *param_4,int param_5)
{
__asm {
    ...
    LAB_00466760:
        ...
        paddw MM0,MM4
        paddw MM1,MM4
        paddw MM0,qword ptr [DAT_005b47b8]
        paddw MM1,qword ptr [DAT_005b47c0]
        psrlw MM0,0x4
        psrlw MM1,0x4
        packuswb MM0,MM7
        packuswb MM1,MM7
