...
;
; XREF[1]:
;   core_dcamera.cpp_CDemonCamera_blendLightmapPixel32_FUN_00447bb0 at 00447c48
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBP                            ; 004652d0
        ;   Label: core_dstrender.cpp_blendLightmapSharedU32toU32NoBiasPx1MMX_FUN_004652d0
