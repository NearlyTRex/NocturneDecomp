// Name: core_dstrender.cpp_blendHBilerpLightmapSharedU64toU64pBB12Px2MMX_FUN_00464afc
// Address: 00464afc
...

{
  ...
  do {
    ...
    uVar3 = *(uint *)(&DAT_00b0e1fc + (uint)texture_indices[1] * 4);
                             ...
                             CONCAT24((short)CONCAT21(uVar10,(char)(uVar1 >> 0x30)) *
                                      ...
                                      CONCAT22((ushort)(byte)(uVar1 >> 0x28) *
                                               ((ushort)(((ushort)(CONCAT43(uVar5,CONCAT12((char)((
                                                  uint)uVar3 >> 8),(ushort)uVar3)) >> 0x10) & 0xff)
                                                  + uVar12) >> 1),
    ...
    uVar8 = (ushort)((short)uVar9 + (short)uVar22 + (short)DAT_005b4788) >> 4;
    ...
    uVar13 = (ushort)((short)uVar14 + (short)uVar22 + (short)0x0008000800080008) >> 4;
