...
// Convention: __cdecl
// Signature: void __cdecl core_dstrender_cpp_blendHBilerpLightmapSharedU64toU16pBB56Px2MMX_FUN_00465fc9(uint *param_1,undefined8 *param_2,byte *param_3,byte *param_4,int param_5)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __cdecl core_dstrender_cpp_blendHBilerpLightmapSharedU64toU16pBB56Px2MMX_FUN_00465fc9(uint *param_1,ulonglong *param_2,byte *param_3,byte *param_4,int param_5)

{
  ...
  do {
    ...
    uVar18 = *(ulonglong *)(&DAT_005b5d00 + ((uint)*param_4 + (uint)(param_3[1] >> 1)) * 2) ^
             _DAT_005b64f8;
    ...
    uVar12 = (ushort)((short)uVar13 + (short)uVar22 + (short)0x0040004000400040) >> 4;
