// Name: core_dstrender.cpp_blendLightmapPerPxU64toU16pAmbientPx2MMX_FUN_00466e94
// Address: 00466e94
// Address Range: [[00466e94, 004671b8]]
// Convention: __cdecl
// Signature: void __cdecl core_dstrender_cpp_blendLightmapPerPxU64toU16pAmbientPx2MMX_FUN_00466e94(uint *output_buffer,ulonglong *texture_buffer,byte *texture_indices,byte *lightmap_indices,int pixel_count)
...

{
  ...
  do {
    ...
    uVar6 = pmulhw(CONCAT26((uVar5 >> 8) * (short)(uVar12 >> 0x18),
                            CONCAT24((short)CONCAT21(uVar5,(char)(uVar7 >> 0x10)) *
                                     ...
                                     CONCAT22((ushort)(byte)(uVar7 >> 8) *
                                              ...
                                              0xff),((ushort)uVar7 & 0xff) * (ushort)(byte)uVar1))),
                   *(ulonglong *)
    ...
    uVar1 = *(uint *)(&DAT_00b0e1fc + (uint)texture_indices[1] * 4);
    ...
    *output_buffer =
         (uint)(((uVar8 & g_BlueMask32.mm) >> g_BlueBitShift.mm |
                 (uVar8 & g_GreenMask32.mm) >> g_GreenBlueDitherShift.mm |
                (uVar8 & g_RedMask32.mm) >> g_TotalDitherShift.mm) << 0x10) |
         (uint)((uVar7 & g_BlueMask32.mm) >> g_BlueBitShift.mm) |
         (uint)((uVar7 & g_GreenMask32.mm) >> g_GreenBlueDitherShift.mm) |
         (uint)((uVar7 & g_RedMask32.mm) >> g_TotalDitherShift.mm);
