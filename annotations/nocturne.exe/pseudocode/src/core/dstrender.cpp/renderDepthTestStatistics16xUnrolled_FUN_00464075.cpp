...

{
  ...
  if (iVar2 != 0 && uVar1 <= uVar8 >> 0x10) {
    ...
    if (-4 < iVar3) {
      _DAT_01b4d764 = (_DAT_01b4d764 + 1) - (uint)(uVar9 >> 8 < *puVar6);
      if (iVar3 != -3 && 0 < iVar3 + 4) {
        _DAT_01b4d764 = (_DAT_01b4d764 + 1) - (uint)(uVar9 + iVar4 >> 8 < puVar6[1]);
        if (1 < iVar3 + 3) {
          _DAT_01b4d764 = (_DAT_01b4d764 + 1) - (uint)(uVar9 + iVar4 + iVar4 >> 8 < puVar6[2]);
        }
      }
    }
  }
