...
section .text
    ...
    PUSH ECX                            ; 0046435e
    MOV EBX,dword ptr [0x01c02580]      ; 0046435f | g_CurrentTextureData
    ...
    MOV EBX,dword ptr [0x01c02580]      ; 0046463a | g_CurrentTextureData
    ...
    MOV BL,CH                           ; 00464662
    MOV BH,DH                           ; 00464664
    ADD EBX,dword ptr [0x01c02580]      ; 00464666 | g_CurrentTextureData
    ADD ECX,ESI                         ; 0046466c
    MOVZX EAX,byte ptr [EBX]            ; 0046466e
    ADD EDX,EBP                         ; 00464671
    MOV EAX,dword ptr [EAX*0x4 + 0x1c00024] ; 00464673 | g_Hardware32BitPalette
    ...
    MOV BL,CH                           ; 0046468d
    MOV BH,DH                           ; 0046468f
    ADD EBX,dword ptr [0x01c02580]      ; 00464691 | g_CurrentTextureData
    ADD ECX,ESI                         ; 00464697
    MOVZX EAX,byte ptr [EBX]            ; 00464699
    ADD EDX,EBP                         ; 0046469c
    MOV EAX,dword ptr [EAX*0x4 + 0x1c00024] ; 0046469e | g_Hardware32BitPalette
    ...
    MOV BL,CH                           ; 004646b9
    MOV BH,DH                           ; 004646bb
    ADD EBX,dword ptr [0x01c02580]      ; 004646bd | g_CurrentTextureData
    ADD ECX,ESI                         ; 004646c3
    MOVZX EAX,byte ptr [EBX]            ; 004646c5
    ADD EDX,EBP                         ; 004646c8
    MOV EAX,dword ptr [EAX*0x4 + 0x1c00024] ; 004646ca | g_Hardware32BitPalette
    ...
    MOV BL,CH                           ; 004646e5
    MOV BH,DH                           ; 004646e7
    ADD EBX,dword ptr [0x01c02580]      ; 004646e9 | g_CurrentTextureData
    ADD ECX,ESI                         ; 004646ef
    MOVZX EAX,byte ptr [EBX]            ; 004646f1
    ADD EDX,EBP                         ; 004646f4
    MOV EAX,dword ptr [EAX*0x4 + 0x1c00024] ; 004646f6 | g_Hardware32BitPalette
    ...
    MOV BL,CH                           ; 00464711
    MOV BH,DH                           ; 00464713
    ADD EBX,dword ptr [0x01c02580]      ; 00464715 | g_CurrentTextureData
    ADD ECX,ESI                         ; 0046471b
    MOVZX EAX,byte ptr [EBX]            ; 0046471d
    ADD EDX,EBP                         ; 00464720
    MOV EAX,dword ptr [EAX*0x4 + 0x1c00024] ; 00464722 | g_Hardware32BitPalette
    ...
    MOV BL,CH                           ; 0046473d
    MOV BH,DH                           ; 0046473f
    ADD EBX,dword ptr [0x01c02580]      ; 00464741 | g_CurrentTextureData
    ADD ECX,ESI                         ; 00464747
    MOVZX EAX,byte ptr [EBX]            ; 00464749
    ADD EDX,EBP                         ; 0046474c
    MOV EAX,dword ptr [EAX*0x4 + 0x1c00024] ; 0046474e | g_Hardware32BitPalette
    ...
    MOV BL,CH                           ; 00464769
    MOV BH,DH                           ; 0046476b
    ADD EBX,dword ptr [0x01c02580]      ; 0046476d | g_CurrentTextureData
    ADD ECX,ESI                         ; 00464773
    MOVZX EAX,byte ptr [EBX]            ; 00464775
    ADD EDX,EBP                         ; 00464778
    MOV EAX,dword ptr [EAX*0x4 + 0x1c00024] ; 0046477a | g_Hardware32BitPalette
    ...
    MOV BL,CH                           ; 00464795
    MOV BH,DH                           ; 00464797
    ADD EBX,dword ptr [0x01c02580]      ; 00464799 | g_CurrentTextureData
    ADD ECX,ESI                         ; 0046479f
    MOVZX EAX,byte ptr [EBX]            ; 004647a1
    ADD EDX,EBP                         ; 004647a4
    MOV EAX,dword ptr [EAX*0x4 + 0x1c00024] ; 004647a6 | g_Hardware32BitPalette
    ...
    MOV BL,CH                           ; 004647c1
    MOV BH,DH                           ; 004647c3
    ADD EBX,dword ptr [0x01c02580]      ; 004647c5 | g_CurrentTextureData
    ADD ECX,ESI                         ; 004647cb
    MOVZX EAX,byte ptr [EBX]            ; 004647cd
    ADD EDX,EBP                         ; 004647d0
    MOV EAX,dword ptr [EAX*0x4 + 0x1c00024] ; 004647d2 | g_Hardware32BitPalette
    ...
    MOV BL,CH                           ; 004647ed
    MOV BH,DH                           ; 004647ef
    ADD EBX,dword ptr [0x01c02580]      ; 004647f1 | g_CurrentTextureData
    ADD ECX,ESI                         ; 004647f7
    MOVZX EAX,byte ptr [EBX]            ; 004647f9
    ADD EDX,EBP                         ; 004647fc
    MOV EAX,dword ptr [EAX*0x4 + 0x1c00024] ; 004647fe | g_Hardware32BitPalette
    ...
    MOV BL,CH                           ; 00464819
    MOV BH,DH                           ; 0046481b
    ADD EBX,dword ptr [0x01c02580]      ; 0046481d | g_CurrentTextureData
    ADD ECX,ESI                         ; 00464823
    MOVZX EAX,byte ptr [EBX]            ; 00464825
    ADD EDX,EBP                         ; 00464828
    MOV EAX,dword ptr [EAX*0x4 + 0x1c00024] ; 0046482a | g_Hardware32BitPalette
    ...
    MOV BL,CH                           ; 00464845
    MOV BH,DH                           ; 00464847
    ADD EBX,dword ptr [0x01c02580]      ; 00464849 | g_CurrentTextureData
    ADD ECX,ESI                         ; 0046484f
    MOVZX EAX,byte ptr [EBX]            ; 00464851
    ADD EDX,EBP                         ; 00464854
    MOV EAX,dword ptr [EAX*0x4 + 0x1c00024] ; 00464856 | g_Hardware32BitPalette
    ...
    MOV BL,CH                           ; 00464871
    MOV BH,DH                           ; 00464873
    ADD EBX,dword ptr [0x01c02580]      ; 00464875 | g_CurrentTextureData
    ADD ECX,ESI                         ; 0046487b
    MOVZX EAX,byte ptr [EBX]            ; 0046487d
    ADD EDX,EBP                         ; 00464880
    MOV EAX,dword ptr [EAX*0x4 + 0x1c00024] ; 00464882 | g_Hardware32BitPalette
    ...
    MOV BL,CH                           ; 00464899
    MOV BH,DH                           ; 0046489b
    ADD EBX,dword ptr [0x01c02580]      ; 0046489d | g_CurrentTextureData
    ADD ECX,ESI                         ; 004648a3
    MOVZX EAX,byte ptr [EBX]            ; 004648a5
    ADD EDX,EBP                         ; 004648a8
    MOV EAX,dword ptr [EAX*0x4 + 0x1c00024] ; 004648aa | g_Hardware32BitPalette
    ...
    MOV BL,CH                           ; 004648c1
    MOV BH,DH                           ; 004648c3
    ADD EBX,dword ptr [0x01c02580]      ; 004648c5 | g_CurrentTextureData
    ADD ECX,ESI                         ; 004648cb
    MOVZX EAX,byte ptr [EBX]            ; 004648cd
    ADD EDX,EBP                         ; 004648d0
    MOV EAX,dword ptr [EAX*0x4 + 0x1c00024] ; 004648d2 | g_Hardware32BitPalette
    ...
    MOV BL,CH                           ; 004648e9
    MOV BH,DH                           ; 004648eb
    ADD EBX,dword ptr [0x01c02580]      ; 004648ed | g_CurrentTextureData
    ADD ECX,ESI                         ; 004648f3
    MOVZX EAX,byte ptr [EBX]            ; 004648f5
    ADD EDX,EBP                         ; 004648f8
    MOV EAX,dword ptr [EAX*0x4 + 0x1c00024] ; 004648fa | g_Hardware32BitPalette
