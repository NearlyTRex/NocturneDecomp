// Name: core_dstrender.cpp_blendLightmapShared4U64toU64pAmbientPx4MMX_FUN_0046568b
// Address: 0046568b
// Address Range: [[0046568b, 004657a6]]
// Convention: __cdecl
// Signature: void __cdecl core_dstrender_cpp_blendLightmapShared4U64toU64pAmbientPx4MMX_FUN_0046568b(ulonglong *output_buffer,ulonglong *texture_buffer,byte *texture_indices,byte *lightmap_indices,int pixel_count)
...

{
  ...
  do {
    ...
    uVar6 = (ushort)((short)uVar7 + (short)uVar20 + (short)0x0004000400040004) >> 4;
    ...
    uVar11 = (ushort)((short)uVar12 + (short)uVar20 + (short)0x000C000C000C000C) >> 4;
