// Name: core_dstrender.cpp_blendVHBilerpLightmapSharedU64toU16pBB34Px2MMX_FUN_00466520
// Address: 00466520
// Address Range: [[00466520, 00466756] [00466760, 00466885]]
// Convention: __cdecl
// Signature: void __cdecl core_dstrender_cpp_blendVHBilerpLightmapSharedU64toU16pBB34Px2MMX_FUN_00466520(uint *output_buffer,ulonglong *texture_buffer,byte *texture_indices,byte *lightmap_indices,int pixel_count)
...

{
  ...
  do {
    ...
    uVar13 = (ushort)((short)uVar14 + (short)uVar22 + (short)0x0060006000600060) >> 4;
