...
section .text
    ...
    PUSH EBX                            ; 00414930
        ;   Label: core_batman.cpp_CBatman_processDamage_FUN_00414930
    PUSH ESI                            ; 00414931
    PUSH EDI                            ; 00414932
    PUSH EBP                            ; 00414933
    ...
    PUSH EAX                            ; 004149aa
    PUSH ESI                            ; 004149ab
    CALL core_charactr.cpp_CCharacter_igniteBone_FUN_00427730 ; 004149ac
    ...
    CALL core_batman.cpp_CBatman_processDismemberment_FUN_004145f0 ; 004149b6
        ;   XREF to: 004145f0 (UNCONDITIONAL_CALL)  ; void core_batman.cpp_CBatman_processDismemberment_FUN_004145f0(CBatman * this_ptr, SDamageInfo * damage_info)
    ...
    PUSH EAX                            ; 00414a8f
    MOV EAX,[0x005b80f0]                ; 00414a90 | g_CFireEffect_PTR_005b80f0
    PUSH EAX                            ; 00414a95
    INC EBX                             ; 00414a96
