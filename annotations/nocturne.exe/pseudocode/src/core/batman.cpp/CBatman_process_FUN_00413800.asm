...
section .text
    ...
    PUSH EBX                            ; 0041381b
    CALL core_charactr.cpp_CCharacter_process_FUN_004259f0 ; 0041381c
    ...
    CALL core_charactr.cpp_CCharacter_processWalking_FUN_00428c00 ; 004138ab
    ...
    PUSH EBX                            ; 00413a31
    CALL core_charactr.cpp_CCharacter_applyGestureLookAt_FUN_0042a150 ; 00413a32
