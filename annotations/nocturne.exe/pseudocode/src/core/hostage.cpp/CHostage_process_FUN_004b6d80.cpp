...
// Convention: unknown
// Signature: void core_hostage_cpp_CHostage_process_FUN_004b6d80(CHostage *param_1,float param_2)
    ...
    if (uVar12 < 0xb) {
      if (uVar12 == 6) {
        ...
        if (pCVar20 != (CDemonActor *)0x0) {
          ...
          local_194.wielder = (CDemonActor *)param_1;
          pCVar16 = (CCharacter *)(param_1->base).base.grabbed_by;
          local_18 = local_194.damage_amount;
          (*(((pCVar16->base).vtable._uc)->_uc).processDamage)(pCVar16,&local_194);
        }
      }
      else {
        core_charactr_cpp_CCharacter_processMotion_FUN_0042add0((CCharacter *)param_1,uVar12);
      }
    }
    else if (uVar12 < 0xc) {
      local_24 = (CDoor *)0x0;
...
LAB_004b6f82:
      ...
      pCVar20 = (param_1->base).base.carry_hands[1].carry_actor;
      if (pCVar20 != (CDemonActor *)0x0) {
        (*(((param_1->base).base.base.vtable._uc)->_uc).dropCarriedObject)
                  ((CCharacter *)param_1,1,(CVector3f *)0x0);
        this_ptr = (CInventory *)(*(int *)(_DAT_01cae0e8 * 4 + 0x1cae0d8) + 0x1f5a0);
        in_stack_fffffe40 = CONCAT44(pCVar20,this_ptr);
        core_inv_cpp_CInventory_addItem_FUN_004bf360(this_ptr,pCVar20,1);
      }
    }
    else {
      core_charactr_cpp_CCharacter_processMotion_FUN_0042add0((CCharacter *)param_1,uVar12);
  ...
  if ((param_1->base).base.hit_points <= 0.0) {
    ...
    if ((local_18 <= 0.0) &&
       (local_18 = core_motion_cpp_CMotionController_getStateBlendWeight_FUN_004e18d0
                             (&(param_1->base).base.model.motion_controller,8), local_18 <= 0.0)) {
    ...
    if (iVar11 == 0) {
      ...
      case 0:
        ...
        if (iVar11 == 0) {
          ...
          local_e0 = *(float *)(iVar11 + 0x20) - (param_1->base).base.base.location.position.x;
          local_dc = *(float *)(iVar11 + 0x24) - (param_1->base).base.base.location.position.y;
          local_d8 = *(float *)(iVar11 + 0x28) - (param_1->base).base.base.location.position.z;
        ...
        break;
      case 1:
        pCVar17 = (CWayPoint *)param_1->goal_way_point;
        if ((pCVar17 != (CWayPoint *)0x0) &&
           (fVar4 = (param_1->base).base.base.location.position.x -
        ...
        if (param_1->next_way_point == (CDemonActor *)0x0) {
          iVar11 = core_hostage_cpp_CHostage_processGrabberFlee_FUN_004b81a0(param_1,param_2);
          if (iVar11 == 0) {
            iVar11 = core_charactr_cpp_FUN_0042af70((CCharacter *)param_1,param_2);
            if (iVar11 == 0) {
              ...
              param_1->follow_state = iVar11;
            }
            uVar6 = param_1->follow_state;
            pCVar2 = &(param_1->base).base.model;
            if (uVar6 < 2) {
...
LAB_004b794d:
      ...
      case 4:
        ...
        if (param_1->sit_down_way_point != (CDemonActor *)0x0) {
          fVar4 = param_2 * (float)0.5;
          pCVar20 = SUB84(__BITCAST_UINT64((double)fVar4),0);
          if ((param_1->base).base.walk_step_speed < fVar4) {
            (param_1->base).base.walk_step_speed = fVar4;
          }
          ...
          if (pCVar14 != pCVar18) {
            pCVar14->x = pCVar18->x;
            (param_1->base).base.position_delta.y = pCVar18->y;
            (param_1->base).base.position_delta.z = pCVar18->z;
          }
          pCVar14 = &(param_1->base).base.position_delta;
          local_a4 = pCVar14->x;
          ...
          if ((param_1->base).base.walk_step_speed < local_198) {
            ...
            (param_1->base).base.position_delta.y = fVar4 * local_30;
          ...
          (param_1->base).base.turn_angle_accumulator = pCVar14->y;
          if (fVar4 < 1.0) {
            ...
            (param_1->base).base.turn_angle_accumulator =
                 (1.0 - fVar4) * local_18 + (param_1->base).base.turn_angle_accumulator;
          }
          local_18 = core_actor_cpp_normalizeAngleToPi_FUN_0040df00
                               ((param_1->base).base.turn_angle_accumulator);
...
LAB_004b7672:
    ...
    pCVar14 = core_actor_cpp_CDemonActor_worldToLocalPoint_FUN_0040a290
                        ((CDemonActor *)param_1,&local_d4,&(pCVar15->location).position);
    ...
    iVar11 = (*(pCVar5->_uc).attractActorToward)(pCVar16,(CDemonActor *)param_1,pCVar14);
    if (iVar11 == 0) {
      (param_1->base).base.grabbed_by = (CDemonActor *)0x0;
LAB_004b7534:
      pCVar20 = (CDemonActor *)&(param_1->base).base.model;
      core_motion_cpp_CMotionController_setDesiredState_FUN_004e16b0
...
switchD_004b7b39_default:
  ...
  if (local_2c == 0) {
    ...
    pCVar18 = &(param_1->base).base.model.accumulated_root_motion;
    ...
    (param_1->base).base.model.accumulated_root_motion.y =
         (param_1->base).base.model.accumulated_root_motion.z;
    pCVar18->x = (param_1->base).base.model.accumulated_root_motion.y;
    ...
    if ((dVar22 * 0.59999999999999998 <=
       ...
       dVar8 = (double)(param_1->base).base.base.location.position.y - (double)local_f4,
       dVar9 = (double)(param_1->base).base.base.location.position.z - (double)local_f0,
    ...
    pCVar14 = core_actor_cpp_CDemonActor_transformVector_FUN_0040a200
                        ((CDemonActor *)param_1,local_80,&(param_1->base).base.position_delta);
    pCVar1 = &(param_1->base).base.base.location;
...
LAB_004b72a1:
  ...
  if (param_1->hostage_type == 1) {
    ...
    if (((pCVar15 != (CDemonActor *)0x0) &&
       ...
       (local_4c != 0)) {
      fVar4 = param_2 / local_48 + param_1->gun_blend_weight;
    }
    else {
      fVar4 = param_1->gun_blend_weight - param_2 / local_48;
    }
    param_1->gun_blend_weight = fVar4;
    if (0.0 < param_1->gun_blend_weight) {
      ...
      if (((1.0 <= param_1->gun_blend_weight) && (0.0 < param_1->gun_raise_progress)) &&
         (fVar4 = param_2 / local_54 + param_1->gun_raise_progress,
         param_1->gun_raise_progress = fVar4, 1.0 < fVar4)) {
  ...
  core_charactr_cpp_CCharacter_findSomethingToLookAt_FUN_00429730
            ((CCharacter *)param_1,param_2,uVar12);
