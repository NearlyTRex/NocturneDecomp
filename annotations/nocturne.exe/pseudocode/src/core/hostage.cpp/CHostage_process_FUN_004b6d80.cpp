...

{
  ...
  while (pCVar21 = (CDemonActor *)in_stack_fffffe40, 0.0 < local_1a0) {
    ...
    if (uVar13 < 0xb) {
      if (uVar13 == 6) {
        if ((this_ptr->base).base.grabbed_by != (CDemonActor *)0x0) {
          ...
          (*(((pCVar17->base).vtable._uc)->_uc).processDamage)(pCVar17,&local_194);
        }
      }
      else {
        core_charactr_cpp_CCharacter_processMotion_FUN_0042add0((CCharacter *)this_ptr,uVar13);
      }
    }
    else if (uVar13 < 0xc) {
      local_24 = (CDoor *)0x0;
      ...
      while (iVar12 < g_CDemonSet_PTR_005be368->actor_count) {
        pCVar14 = (CDoor *)core_actor_cpp_castToClassHash_FUN_0040d890
                                     (*(CDemonActor **)
                                       ((int)g_CDemonSet_PTR_005be368->actors + iVar22),
...
LAB_004b6f82:
      ...
      pCVar21 = (this_ptr->base).base.carry_hands[1].carry_actor;
      if (pCVar21 != (CDemonActor *)0x0) {
        (*(((this_ptr->base).base.base.vtable._uc)->_uc).dropCarriedObject)
                  ((CCharacter *)this_ptr,1,(CVector3f *)0x0);
        in_stack_fffffe40 = CONCAT44(pCVar21,&g_HeroActors[g_LocalHeroIndex]->inventory);
        core_inv_cpp_CInventory_addItem_FUN_004bf360
                  (&g_HeroActors[g_LocalHeroIndex]->inventory,pCVar21,1);
      }
    }
    else {
      core_charactr_cpp_CCharacter_processMotion_FUN_0042add0((CCharacter *)this_ptr,uVar13);
...
LAB_004b7170:
  ...
  pCVar16 = (this_ptr->base).base.grabbed_by;
      ...
      case 0:
        ...
        if (iVar12 == 0) {
          ...
          if (((0.0 < this_ptr->rescue_distance) &&
             ...
             pCVar11 = g_CConsole_PTR_005ad350, iVar12 == 0)) goto LAB_004b7672;
        ...
        break;
      case 1:
        pCVar18 = (CWayPoint *)this_ptr->goal_way_point;
        if ((pCVar18 != (CWayPoint *)0x0) &&
          ...
          pCVar18 = core_waypoint_cpp_CWayPoint_findNearestReachable_FUN_00552680
                              ((CWayPoint *)&(this_ptr->base).base.base.location,pCVar18);
          this_ptr->next_way_point = (CDemonActor *)pCVar18;
        }
        pCVar11 = g_CConsole_PTR_005ad350;
        if (this_ptr->next_way_point == (CDemonActor *)0x0) {
          ...
          if (iVar12 == 0) {
            ...
            if (uVar6 < 2) {
              ...
              engine_console_cpp_CConsole_printf_FUN_0043ac60(pCVar11,"%s left behind!\n");
              core_event_cpp_CEventList_executeCommands_FUN_0047ab70
...
LAB_004b794d:
      ...
      case 4:
        ...
        if (this_ptr->sit_down_way_point != (CDemonActor *)0x0) {
          ...
          pCVar21 = SUB84(__BITCAST_UINT64((double)fVar4),0);
          ...
          pCVar15 = &(this_ptr->base).base.position_delta;
          if (pCVar15 != pCVar19) {
            pCVar15->x = pCVar19->x;
          ...
          local_34 = local_198;
          pCVar15 = core_vecdir_cpp_convertDirectionVectorToEulerAngles_FUN_0054e4a0
                              (&local_14c,&(this_ptr->base).base.position_delta);
          fVar4 = local_198 * (float)2;
          (this_ptr->base).base.turn_angle_accumulator = pCVar15->y;
          if (fVar4 < 1.0) {
...
LAB_004b7672:
    ...
    pCVar15 = core_actor_cpp_CDemonActor_worldToLocalPoint_FUN_0040a290
                        ((CDemonActor *)this_ptr,&local_d4,&(pCVar16->location).position);
    pCVar15 = core_vecdir_cpp_convertDirectionVectorToEulerAngles_FUN_0054e4a0(&local_c8,pCVar15);
    local_18 = core_actor_cpp_normalizeAngleToPi_FUN_0040df00(pCVar15->y);
    local_19c = local_18;
...
LAB_004b7534:
      pCVar21 = (CDemonActor *)&(this_ptr->base).base.model;
      core_motion_cpp_CMotionController_setDesiredState_FUN_004e16b0
                ((CMotionController *)pCVar21,0,1);
    }
...
switchD_004b7b39_default:
  if (((0.0 < (this_ptr->base).base.hit_points) && (this_ptr->hostage_type == 1)) &&
     (iVar12 = core_actor_cpp_randomChance_FUN_0040dea0(delta_time * 0.2f), iVar12 != 0))
  {
    iVar12 = 0;
  ...
  if (local_2c == 0) {
    ...
    pCVar15->x = (this_ptr->base).base.position_delta.y;
    (this_ptr->base).base.model.accumulated_root_motion.z = 0.0;
    ...
    if ((dVar23 * 0.59999999999999998 <=
       ...
       dVar9 = (double)(this_ptr->base).base.base.location.position.y - (double)local_f4,
       dVar10 = (double)(this_ptr->base).base.base.location.position.z - (double)local_f0,
       SQRT(dVar10 * dVar10 + dVar9 * dVar9 + dVar8 * dVar8) <= dVar23 * 0.40000000000000002))
    goto LAB_004b72a1;
  }
  else {
    pCVar15 = core_actor_cpp_CDemonActor_transformVector_FUN_0040a200
...
LAB_004b72a1:
  ...
  if (this_ptr->hostage_type == 1) {
    local_48 = 0.5;
    local_54 = 0.75;
    pCVar16 = core_actor_cpp_castToClassHash_FUN_0040d890
  ...
  if ((1.0 <= this_ptr->gun_raise_progress) &&
     (pCVar17 = (CCharacter *)
                core_actor_cpp_castToClassHash_FUN_0040d890
                          ((this_ptr->base).base.carry_hands[1].carry_actor,
                           g_CWeaponActorType_02ddf970.name_hash), pCVar17 != (CCharacter *)0x0)) {
    fVar4 = (pCVar17->model).transformed_vertices[0x4f].z;
    (pCVar17->model).transformed_vertices[0x4f].z = 8.40779e-45;
    (*(((pCVar17->base).vtable._uc)->_uc).isGrabbable)(pCVar17,pCVar21);
    (pCVar17->model).transformed_vertices[0x4f].z = fVar4;
    core_motion_cpp_CMotionController_setDesiredState_FUN_004e16b0
  ...
  if (((this_ptr->hostage_type == 1) &&
      (pCVar21 = core_actor_cpp_castToClassHash_FUN_0040d890
                           ((this_ptr->base).base.carry_hands[1].carry_actor,
                            g_CWeaponActorType_02ddf970.name_hash), pCVar21 != (CDemonActor *)0x0))
     && (iVar12 = core_event_cpp_CEventList_evaluateCondition_FUN_0047dc30
