...

{
  ...
  FUN_0048ff40(_DAT_014b98f8,"nocfont.raw",0x136,0x1ae,0);
  FUN_00490460(_DAT_014b98f8);
  iVar2 = _DAT_014b98f8;
  *(uint *)(_DAT_014b98f8 + 0x25e8) = 8;
  FUN_00493140(iVar2,3,0x20,0x7e);
  FUN_00493140(_DAT_014b98f8,1,0xc0,0xdf);
  iVar2 = _DAT_014b98f8;
  *(uint *)(_DAT_014b98f8 + 0x317c) = 2;
  *(uint *)(iVar2 + 0x3180) = 1;
  FUN_004931a0(iVar2,1);
  iVar1 = FUN_0056497c(0x3198);
  iVar2 = 0;
  if (iVar1 != 0) {
    iVar2 = FUN_0048fe10(iVar1);
  ...
  FUN_0048ff40(_DAT_014b98fc,"nocsmall.raw",0xf8,0x158,0);
  FUN_00490460(_DAT_014b98fc);
  iVar2 = _DAT_014b98fc;
  *(uint *)(_DAT_014b98fc + 0x25e8) = 5;
  FUN_00493140(iVar2,2,0x20,0x7e);
  iVar2 = _DAT_014b98fc;
  ...
  *(uint *)(iVar2 + 0x3180) = 1;
  ...
  FUN_0048ff40(_DAT_014b9900,"menufont.raw",0xfa,0x23f,0);
  FUN_00490460(_DAT_014b9900);
  iVar2 = _DAT_014b9900;
  *(uint *)(_DAT_014b9900 + 0x25e8) = 8;
  FUN_00493140(iVar2,3,0x20,0x7e);
  FUN_00493140(_DAT_014b9900,0,0xc0,0xdf);
  FUN_00493140(_DAT_014b9900,1,0xe0,0xff);
  iVar2 = _DAT_014b9900;
  ...
  *(uint *)(iVar2 + 0x3180) = 1;
  ...
  FUN_0048ff40(_DAT_014b9904,"fnte_pfd.RAW",0x94,0xec,0);
  FUN_00490460(_DAT_014b9904);
  iVar2 = _DAT_014b9904;
  ...
  *(uint *)(iVar2 + 0x3180) = 1;
  ...
  FUN_0048ff40(_DAT_014b9908,"fnte_f.RAW",0x94,0xec,0xff);
  iVar2 = _DAT_014b9908;
  ...
  *(uint *)(iVar2 + 0x3180) = 1;
  ...
  FUN_0048ff40(_DAT_014b990c,"micro.raw",0x94,0xec,0);
  FUN_00490460(_DAT_014b990c);
  iVar2 = _DAT_014b990c;
  *(uint *)(_DAT_014b990c + 0x25e8) = 4;
  FUN_00493140(iVar2,1,0x20,0x7e);
  iVar2 = _DAT_014b990c;
  ...
  *(uint *)(iVar2 + 0x3180) = 1;
  ...
  iVar2 = 0;
  if (iVar1 != 0) {
    iVar2 = FUN_00557f50(iVar1,&DAT_005bdf50,0xe,2,2);
  }
  _DAT_014b9910 = iVar2;
  if (iVar2 == 0) {
    _DAT_01cc4800 = "..\\core\\dfont.cpp";
  ...
  *(int *)(iVar2 + 0x3194) = iVar1;
  ...
  iVar2 = 0;
  if (iVar1 != 0) {
    iVar2 = FUN_00557f50(iVar1,&DAT_005bdf50,0x12,0,0);
  }
  _DAT_014b9918 = iVar2;
  if (iVar2 == 0) {
    _DAT_01cc4800 = "..\\core\\dfont.cpp";
  ...
  *(int *)(iVar2 + 0x3194) = iVar1;
  ...
  iVar2 = 0;
  if (iVar1 != 0) {
    iVar2 = FUN_00557f50(iVar1,&DAT_005bdf50,0xc,0,0);
  }
  _DAT_014b9914 = iVar2;
  if (iVar2 == 0) {
    _DAT_01cc4800 = "..\\core\\dfont.cpp";
  ...
  *(int *)(iVar2 + 0x3194) = iVar1;
  ...
  iVar2 = 0;
  if (iVar1 != 0) {
    iVar2 = FUN_00557f50(iVar1,&DAT_005bdf50,10,0,0);
  }
  _DAT_014b991c = iVar2;
  if (iVar2 == 0) {
    _DAT_01cc4800 = "..\\core\\dfont.cpp";
