...
// Convention: unknown
// Signature: void core_shotgun_cpp_FUN_00515db0(CWeapon *param_1,undefined4 param_2,float param_3)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void core_shotgun_cpp_FUN_00515db0(CWeapon *param_1,uint param_2,float param_3)
