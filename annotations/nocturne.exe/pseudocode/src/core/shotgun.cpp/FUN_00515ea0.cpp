...

{
  ...
  if (iVar3 == 0) {
    core_sound_cpp_CSound_playActorSound_FUN_0052ea60
              (g_CSound_PTR_005bed68,&param_1->base,"shotgun-noammo.wav",&CStack_7c);
    return 0;
  }
  ...
  core_fire_cpp_CFireEffect_createMuzzleFlash_FUN_0048af20
            (g_CFireEffect_PTR_005b80f0,&CStack_a0,&(param_1->base).orient_matrix);
  core_sound_cpp_CSound_playActorSound_FUN_0052ea60
            (g_CSound_PTR_005bed68,&param_1->base,"shotgun.wav",&CStack_7c);
