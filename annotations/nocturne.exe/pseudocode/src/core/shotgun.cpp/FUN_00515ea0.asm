...
;                               FUNCTION
; *****************************************************************************
; undefined4 core_shotgun_cpp_FUN_00515ea0(int param_1)
;
; Local Variables:
...
section .text
    ...
    PUSH EBX                            ; 005163a4
    PUSH EDI                            ; 005163a5
    CALL core_trigger.cpp_FUN_005485a0  ; 005163a6
    ...
    PUSH EDI                            ; 0051658f
    CALL core_glass.cpp_FUN_004ada20    ; 00516590
    ...
    PUSH ESI                            ; 00516607
    CALL core_fire.cpp_FUN_0048ab60     ; 00516608
