...
;
; XREF[1]:
;   core_shotgun.cpp_factoryFuncShotgun_FUN_00515cf0 at 00515d03
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00515d20
        ;   Label: core_shotgun.cpp_CShotgun_ctor_FUN_00515d20
    ...
    PUSH EAX                            ; 00515d3a
    MOV dword ptr [EAX + -0x4],0x5a1af4 ; 00515d3b | g_CShotgunVTable
