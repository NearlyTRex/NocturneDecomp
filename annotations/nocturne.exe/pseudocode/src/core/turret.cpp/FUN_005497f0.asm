...
section .text
    ...
    PUSH dword ptr [EBP + 0x18]         ; 005499e2
        ;   Label: LAB_005499e2
    PUSH EBX                            ; 005499e5
    CALL FUN_0054a110                   ; 005499e6
        ;   XREF to: 0054a110 (UNCONDITIONAL_CALL)  ; undefined FUN_0054a110()
    ...
    PUSH dword ptr [EBP + 0x18]         ; 00549a9f
        ;   Label: LAB_00549a9f
    PUSH EBX                            ; 00549aa2
    CALL FUN_0054a920                   ; 00549aa3
        ;   XREF to: 0054a920 (UNCONDITIONAL_CALL)  ; undefined FUN_0054a920()
