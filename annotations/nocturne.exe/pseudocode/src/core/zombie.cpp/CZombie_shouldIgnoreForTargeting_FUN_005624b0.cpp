...
// Convention: __cdecl
// Signature: int __cdecl core_zombie_cpp_CZombie_shouldIgnoreForTargeting_FUN_005624b0(CZombie *this_ptr)
...

{
  ...
  iVar2 = core_actor_cpp_CDemonActor_shouldIgnoreForTargeting_FUN_0040d830((CDemonActor *)this_ptr);
  return iVar2;
}
