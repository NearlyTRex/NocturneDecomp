// Name: core_zombie.cpp_CZombie_dtor_FUN_00562550
// Address: 00562550
// Address Range: [[00562550, 00562608]]
// Convention: __cdecl
// Signature: CZombie * __cdecl core_zombie_cpp_CZombie_dtor_FUN_00562550(CZombie *this_ptr,uint flags)
...

{
  ...
  if ((flags & 4) != 0) {
    ptr_00 = __vec_delete(this_ptr,&g_CZombieTypeInfo_005a46a0);
