...
// Convention: __cdecl
// Signature: void __cdecl core_zombie_cpp_CZombie_process_FUN_0055ef50(CZombie *this_ptr,float delta_time)
...
LAB_0055f021:
          core_charactr_cpp_CCharacter_processMotion_FUN_0042add0((CCharacter *)this_ptr,uVar8);
        }
        goto LAB_0055efe4;
      }
      if (uVar8 < 6) {
        if ((this_ptr->base).victim != (CCharacter *)0x0) {
          ...
          if (SQRT(local_198 * local_198 + local_1a0 * local_1a0) <= 1.0) {
            ...
            iVar6 = core_setcolid_cpp_CDemonSet_testLineOcclusion_FUN_0050fa30
                              (g_CDemonSet_PTR_005be368,&local_230,&local_158);
            core_setcolid_cpp_CDemonSet_init_FUN_00511750(g_CDemonSet_PTR_005be368);
            if ((iVar6 != 0) ||
               (pCVar3 = (this_ptr->base).victim,
      ...
      if ((this_ptr->base).victim != (CCharacter *)0x0) {
        ...
        if (0.0 < local_98) {
          ...
          core_gore_cpp_CGore_spawnBloodBurst_FUN_004b0200
                    (g_CGore_PTR_005b96c4,&local_248,(CVector3f *)0x0,local_80,iVar6);
        }
        pCVar3 = (this_ptr->base).victim;
      ...
      iVar6 = core_zombie_cpp_CZombie_getPickupHandIndex_FUN_005617e0(this_ptr,2);
      if (iVar6 < 0) {
        g_CHAR_PTR_01cc4800 = "..\\core\\zombie.cpp";
        g_INT_01cc4804 = 0x1ee;
      ...
      iVar6 = core_zombie_cpp_CZombie_getPickupHandIndex_FUN_005617e0(this_ptr,3);
      if (iVar6 < 0) {
        g_CHAR_PTR_01cc4800 = "..\\core\\zombie.cpp";
        g_INT_01cc4804 = 0x205;
        core_main_c_FUN_004c8440("WTF!");
      }
      if ((this_ptr->base).base.carry_hands[iVar6].carry_actor != (CDemonActor *)0x0) {
        engine_console_cpp_CConsole_printf_FUN_0043ac60
      ...
      if (this_ptr->target_door != (CDoor *)0x0) {
        core_door_cpp_CDoor_setSwingRange_FUN_00456220(this_ptr->target_door,0.3);
      ...
      if (uVar8 < 0x66) {
        ...
        core_gore_cpp_CGore_spawnBloodBurst_FUN_004b0200
                  (g_CGore_PTR_005b96c4,&local_104,(CVector3f *)0x0,3,0);
  ...
  if (((((this_ptr->base).base.model.part_data.visibility_flags[iVar6] == 0) &&
     ...
     ((0.0 <= this_ptr->bleedout_timer &&
      (fVar26 = this_ptr->bleedout_timer + delta_time, this_ptr->bleedout_timer = fVar26,
      (float)6 <= fVar26)))) {
  ...
  local_48 = 0;
  iVar9 = core_charactr_cpp_FUN_00428c00((CCharacter *)this_ptr,delta_time);
  if (iVar9 == 0) {
    local_34 = -1.0;
    local_4c = 0.3;
    pSVar15 = core_motion_cpp_CMotionController_getCurrentMotion_FUN_004e1660
    ...
    if (uVar8 < 8) {
      if (uVar8 == 0) {
        iVar6 = core_actor_cpp_randomChance_FUN_0040dea0(delta_time * (float)0.125);
        if (iVar6 != 0) {
          iVar6 = 0;
          pcVar24 = "pickass";
          pCVar7 = core_motion_cpp_CMotionController_getMotionList_FUN_004e1890
...
LAB_0056033e:
          ...
          (this_ptr->base).base.model.accumulated_root_motion.x =
               (this_ptr->base).base.model.accumulated_root_motion.y;
          iVar6 = core_zombie_cpp_FUN_00561010(this_ptr,delta_time);
          if (iVar6 == 0) {
            local_50 = 1.3f;
            ...
            iVar6 = core_charactr_cpp_CCharacter_walkToPoint_FUN_004247f0
                              ((CCharacter *)this_ptr,
                               &(((this_ptr->base).victim)->base).location.position,pCVar16,pCVar10,
                               fVar26,fVar27);
            pCVar2 = &(this_ptr->base).base.model;
            if (iVar6 < 0) {
              engine_console_cpp_CConsole_printf_FUN_0043ac60
...
LAB_00560776:
          ...
          iVar6 = core_zombie_cpp_CZombie_getPickupHandIndex_FUN_005617e0(this_ptr,1);
          if ((((iVar6 < 0) ||
               (pCVar3 = (this_ptr->base).victim,
        ...
        else if (pCVar11 != this_ptr) goto LAB_00560776;
      }
    }
    else if (uVar8 < 9) {
      if (((this_ptr->base).pool_me == 0) &&
        ...
        core_gore_cpp_CGore_createBloodPool_FUN_004b0480(g_CGore_PTR_005b96c4,&local_1c4,0);
        ...
        if (0xd < uVar8) {
          if (uVar8 < 0xf) {
            iVar6 = core_event_cpp_CEventList_evaluateCondition_FUN_0047dc30
                              (0x01C03A10,this_ptr->rise_from_grave_condition);
            if ((iVar6 != 0) &&
               (fVar26 = this_ptr->rise_delay - delta_time, this_ptr->rise_delay = fVar26,
               fVar26 < 0.0)) {
              iVar6 = 0;
              local_28 = 0;
              this_ptr->rise_delay = this_ptr->rise_delay + 1.0;
              local_24 = pCVar1;
              for (; local_28 < g_CDemonSet_PTR_005be368->character_count; local_28 = local_28 + 1)
              {
                iVar9 = *(int *)((int)g_CDemonSet_PTR_005be368->characters + iVar6);
                iVar18 = (**(code **)(*(int *)(iVar9 + 0x14c) + 0xdc))(iVar9,this_ptr);
                if (iVar18 != 0) {
...
LAB_0055fd59:
          core_motion_cpp_CMotionController_setDesiredState_FUN_004e16b0
              ...
              (fVar26 = this_ptr->buried_timer - delta_time, this_ptr->buried_timer = fVar26,
              fVar26 <= 0.0)) {
  ...
  if (iVar6 == 0xe) {
    ...
    if (iVar6 != 0xf) {
      ...
      if (iVar9 != 0) {
        ...
        pCVar14->x = fVar26;
        core_charactr_cpp_CCharacter_moveAndCollide_FUN_00425050((CCharacter *)this_ptr,&local_284);
        if ((iVar6 == 1) &&
