...
section .text
    ...
    MOV dword ptr [0x01cc4800],EBX      ; 0044d4a0 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],ESI      ; 0044d4a6 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 0044d4ac
