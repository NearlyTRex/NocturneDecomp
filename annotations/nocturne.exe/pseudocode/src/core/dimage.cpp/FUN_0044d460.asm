...
section .text
    ...
    MOV dword ptr [0x01cc4800],EBX      ; 0044d4a0 | DAT_01cc4800
    MOV dword ptr [0x01cc4804],ESI      ; 0044d4a6 | DAT_01cc4804
    CALL FUN_004c8440                   ; 0044d4ac
