...
;
; XREF[2]:
;   core_event.cpp_CEventList_executeCommand_FUN_0047ac50 at 0047cd75
;   core_lever.cpp_CLever_process_FUN_004c6190 at 004c62e1
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004c6390
        ;   Label: core_lever.cpp_CLever_setState_FUN_004c6390
    PUSH ESI                            ; 004c6391
    PUSH EDI                            ; 004c6392
    PUSH EBP                            ; 004c6393
    ...
    MOV EAX,[0x005baf90]                ; 004c63a7 | g_CDemonMission_PTR_005baf90
    ...
    MOV EAX,[0x005be368]                ; 004c6404 | g_CDemonSet_PTR_005be368 | g_CDemonSet_01e57284
        ;   Label: LAB_004c6404
    CMP ESI,dword ptr [EAX + 0x14cd6c]  ; 004c6409 | g_CDemonSet_01e57284.actor_count
    ...
    PUSH ECX                            ; 004c6443
    CALL core_event.cpp_CEventList_executeCommands_FUN_0047ab70 ; 004c6444
    ...
    PUSH EBX                            ; 004c647d
    CALL core_event.cpp_CEventList_executeCommands_FUN_0047ab70 ; 004c647e
        ;   XREF to: 0047ab70 (UNCONDITIONAL_CALL)  ; int core_event.cpp_CEventList_executeCommands_FUN_0047ab70(CEventList * this_ptr, char * commands)
    ...
    PUSH EAX                            ; 004c64b1
        ;   Label: LAB_004c64b1
    PUSH EBP                            ; 004c64b2
    CALL core_lever.cpp_CLever_setState_FUN_004c6390 ; 004c64b3
    ...
    MOV ECX,dword ptr [0x01cc3660]      ; 004c64c0 | g_CLeverActorType_01cc3628.name_hash
        ;   Label: LAB_004c64c0
    PUSH ECX                            ; 004c64c6
    MOV EBP,dword ptr [EBX + EAX*0x1 + 0x14cd70] ; 004c64c7 | g_CDemonSet_01e57284.actors[0]
    PUSH EBP                            ; 004c64ce
    CALL core_actor.cpp_castToClassHash_FUN_0040d890 ; 004c64cf
    ...
    PUSH EAX                            ; 004c64e7
    CALL core_lever.cpp_CLever_setState_FUN_004c6390 ; 004c64e8
        ;   XREF to: 004c6390 (UNCONDITIONAL_CALL)  ; void core_lever.cpp_CLever_setState_FUN_004c6390(CLever * this_ptr, float new_state)
