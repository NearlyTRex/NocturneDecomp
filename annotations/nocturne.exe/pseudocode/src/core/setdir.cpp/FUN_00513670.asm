...
section .text
    ...
    MOV dword ptr [0x01cc4800],EDX      ; 005136a1 | PTR_01cc4800
    MOV dword ptr [0x01cc4804],ECX      ; 005136a7 | INT_01cc4804
    ...
    MOV dword ptr [0x01cc4800],EBP      ; 005136f5 | PTR_01cc4800
    MOV [0x01cc4804],EAX                ; 005136fb | INT_01cc4804
