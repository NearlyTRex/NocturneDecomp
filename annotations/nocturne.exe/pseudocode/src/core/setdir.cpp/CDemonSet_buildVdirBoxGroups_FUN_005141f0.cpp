...

{
  ...
  if (0 < this_ptr->vdir_box_count) {
    local_28 = 0;
    do {
      iVar1 = core_setdir_cpp_CDemonSet_findVdirBoxRoot_FUN_00514300(this_ptr,local_24);
      ...
      if (box_index < this_ptr->vdir_box_count) {
        ...
        do {
          ...
          if (iVar2 != iVar1) {
            ...
            iVar3 = core_setdir_cpp_testOBBIntersection_FUN_00513e80(obb_a,obb_b);
            if ((iVar3 != 0) ||
               (iVar3 = core_setdir_cpp_testOBBIntersection_FUN_00513e80(obb_b,obb_a), iVar3 != 0))
            {
