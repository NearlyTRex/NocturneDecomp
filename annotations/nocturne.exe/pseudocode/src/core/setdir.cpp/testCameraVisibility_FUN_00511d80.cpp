// Name: core_setdir.cpp_testCameraVisibility_FUN_00511d80
// Address: 00511d80
// Address Range: [[00511d80, 00512596]]
// Convention: __cdecl
// Signature: float __cdecl core_setdir_cpp_testCameraVisibility_FUN_00511d80(CDemonActor *actor,CVector3i *bbox_vertices,SMRGLHeaderPrimitive *primitives,int camera_index,C3DSCamera *camera,float radius)
...

{
  ...
  bVar15 = 0;
  if (camera->enabled != 0) {
    fVar2 = (camera->position).x - (actor->location).position.x;
    fVar4 = (camera->position).y - (actor->location).position.y;
    fVar3 = (camera->position).z - (actor->location).position.z;
    if (fVar3 * fVar3 + fVar4 * fVar4 + fVar2 * fVar2 <= 200.0f * 200.0f) {
      ...
      engine_drender_cpp_CDemonRenderer_setCameraOriginFromScaledPoint_FUN_00460700
                (g_CDemonRenderer_PTR_005ae704,&camera->position);
      engine_drender_cpp_CDemonRenderer_setProjectionScale_FUN_00460c00
                (g_CDemonRenderer_PTR_005ae704,camera->projection_scale);
      engine_drender_cpp_CDemonRenderer_setupSceneRendering_FUN_00460780
                (g_CDemonRenderer_PTR_005ae704,&camera->orientation);
      local_38 = 0x800000ff;
      local_44 = 0;
      engine_drender_cpp_CDemonRenderer_processCameraRelativeVertex_FUN_00460a00
                (g_CDemonRenderer_PTR_005ae704,&(actor->location).position);
      local_94.x = (actor->orient).vec.x;
      local_94.z = (actor->orient).vec.z;
      local_94.y = (camera->orientation).y;
        ...
        engine_special_cpp_transformAndProjectPoint_FUN_0053075c
                  ((SProjectedVertex *)
                   ((int)&(g_CDemonRenderer_PTR_005ae704->vertex_buffer_ptr->projected_vertex).
                          transformed_x + iVar6),bbox_vertices);
        iVar10 = iVar6 + 0x30;
        bbox_vertices = bbox_vertices + 1;
      ...
      if (((local_38 & 0x80000000) != 0) && ((char)local_38 != '\0')) {
        core_actor_cpp_CDemonActor_restoreRenderState_FUN_00409f60(actor);
        return 0.0;
      }
      iVar6 = 0;
      local_24 = 0;
      pSVar7 = primitives;
      do {
        *(SMRGLHeaderPrimitive **)((int)aiStack_ac + iVar6) = pSVar7;
        iVar6 = iVar6 + 4;
        local_24 = local_24 + 1;
        pSVar7 = pSVar7 + 3;
      } while (pSVar7 != primitives + 0x12);
      core_actor_cpp_CDemonActor_restoreRenderState_FUN_00409f60(actor);
      local_1c = 0;
      do {
      ...
      if (0 < _DAT_026639ec) {
        ...
        local_4c = (uint *)(&DAT_020875f8 + camera_index * 0x3000);
        local_34 = &camera->position;
        do {
      ...
      if (local_3c == 0) {
        puVar11 = &DAT_020875f8 + camera_index * 0x3000;
        iVar6 = 0;
        do {
          *(byte **)((int)g_ZBufferScanlineArray + iVar6) = puVar11;
          iVar6 = iVar6 + 4;
      ...
      if (g_CGame_PTR_005b9354->debug_toggle_flag != 0) {
        puVar9 = (uint *)(camera_index * 0x3000 + 0x23755f8);
        iVar6 = 0;
        do {
          iVar8 = iVar6 + 4;
        ...
        if (0 < local_24) {
          do {
            engine_drender_cpp_CDemonRenderer_renderSolidColorPoly_FUN_0045eee0
                      (g_CDemonRenderer_PTR_005ae704,(SMRGLPrimitivePoly *)primitives);
            iVar6 = iVar6 + 1;
            primitives = (SMRGLHeaderPrimitive *)(((SMRGLPrimitivePoly *)primitives)->vertices + 4);
