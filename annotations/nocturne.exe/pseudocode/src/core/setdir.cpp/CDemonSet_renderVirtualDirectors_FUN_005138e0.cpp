// Name: core_setdir.cpp_CDemonSet_renderVirtualDirectors_FUN_005138e0
// Address: 005138e0
// Address Range: [[005138e0, 00513cdb]]
// Convention: __cdecl
// Signature: void __cdecl core_setdir_cpp_CDemonSet_renderVirtualDirectors_FUN_005138e0(CDemonSet *this_ptr)
...

{
  ...
  local_50 = 0;
  for (iVar6 = 0; iVar6 < this_ptr->camera_count + -1; iVar6 = iVar6 + 1) {
    iVar3 = iVar6 + 1;
    if (iVar3 < this_ptr->camera_count) {
      iVar5 = iVar3 * 4;
      do {
  ...
  if (this_ptr->camera_count < 9) {
    local_5c = this_ptr->camera_count;
  }
  if (0 < local_5c) {
    local_48 = local_40 * 4;
    local_58 = local_48 + 0xc0;
    local_5c = local_5c << 2;
    local_60 = this_ptr->cameras;
    ...
    do {
      ...
      engine_2d_c_drawText_FUN_00402600(local_60[local_3c].name,iVar6,local_4c);
      local_2c = iVar6 + 0x41;
