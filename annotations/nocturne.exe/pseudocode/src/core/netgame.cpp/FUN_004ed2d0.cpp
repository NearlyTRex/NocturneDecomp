...
// Convention: unknown
// Signature: void FUN_004ed2d0(int *param_1)
...

{
  ...
  if ((*param_1 == 1) && (param_1[1] == 3)) {
    ...
    if (0 < param_1[7]) {
      do {
        FUN_004ebe10(param_1,iVar1,0x41200000);
        iVar1 = iVar1 + 1;
    ...
    if (0 < _DAT_01d09c00) {
      ...
      do {
        if (*(int *)(iVar5 + 0x1d09c04) < local_18) {
          ...
          FUN_00566170(iVar5 + 0x1d09c04,puVar10,(_DAT_01d09c00 - iVar1) * 100);
        }
        else {
          puVar10 = puVar10 + 100;
          iVar1 = iVar1 + 1;
...
LAB_004ed65e:
            ...
            FUN_004eb350(param_1,local_24,&local_90);
            local_20 = local_20 + 1;
          }
        }
