...
section .text
    ...
    CALL FUN_004eb3f0                   ; 004ea84c
        ;   XREF to: 004eb3f0 (UNCONDITIONAL_CALL)  ; undefined FUN_004eb3f0()
    ...
    PUSH EDI                            ; 004eaa17
    CALL FUN_004eb440                   ; 004eaa18
        ;   XREF to: 004eb440 (UNCONDITIONAL_CALL)  ; undefined FUN_004eb440()
    ...
    PUSH EDX                            ; 004eab18
    CALL FUN_004edab0                   ; 004eab19
        ;   XREF to: 004edab0 (UNCONDITIONAL_CALL)  ; undefined FUN_004edab0()
    ...
    PUSH EDX                            ; 004eacf9
    CALL FUN_004ec500                   ; 004eacfa
        ;   XREF to: 004ec500 (UNCONDITIONAL_CALL)  ; undefined FUN_004ec500()
    ...
    PUSH EDI                            ; 004eafe5
    CALL FUN_004ec600                   ; 004eafe6
        ;   XREF to: 004ec600 (UNCONDITIONAL_CALL)  ; undefined FUN_004ec600()
    ...
    PUSH EBX                            ; 004eb098
    PUSH EAX                            ; 004eb099
    CALL FUN_004ecc80                   ; 004eb09a
        ;   XREF to: 004ecc80 (UNCONDITIONAL_CALL)  ; undefined FUN_004ecc80()
    ADD ESP,0x8                         ; 004eb09f
    MOV EDI,dword ptr [EBP + 0x14]      ; 004eb0a2
        ;   Label: LAB_004eb0a2
    PUSH EDI                            ; 004eb0a5
    CALL FUN_004ece70                   ; 004eb0a6
        ;   XREF to: 004ece70 (UNCONDITIONAL_CALL)  ; undefined FUN_004ece70()
    ...
    PUSH EAX                            ; 004eb0f5
    CALL FUN_00548d30                   ; 004eb0f6
        ;   XREF to: 00548d30 (UNCONDITIONAL_CALL)  ; undefined FUN_00548d30()
    ADD ESP,0xc                         ; 004eb0fb
    PUSH EAX                            ; 004eb0fe
    MOV ESI,EBX                         ; 004eb0ff
    PUSH ESI                            ; 004eb101
    CALL FUN_004ec500                   ; 004eb102
        ;   XREF to: 004ec500 (UNCONDITIONAL_CALL)  ; undefined FUN_004ec500()
