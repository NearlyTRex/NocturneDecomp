...
// Convention: unknown
// Signature: void FUN_004ebfd0(int param_1,undefined4 param_2,int param_3)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_004ebfd0(int param_1,uint param_2,int param_3)

{
  ...
  *piVar6 = _DAT_01cea3f8;
  FUN_00563cc0(&DAT_01d0661c + iVar2,1,2);
  if (param_3 < 0) {
    iVar3 = 0;
    piVar4 = piVar6;
    piVar5 = piVar6;
  ...
  *(byte *)(*(int *)(param_1 + 0x114) + 8 + (int)piVar6) = 1;
  FUN_00563cc0(puVar1,0,0x100);
  FUN_00565f70(puVar1,param_2,0xff);
  FUN_004ec500(param_1,param_1 + *(int *)(param_1 + 0x114) * 0x78 + 0x3c,
