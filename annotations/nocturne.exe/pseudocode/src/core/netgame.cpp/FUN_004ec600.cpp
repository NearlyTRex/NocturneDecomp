...
// Convention: unknown
// Signature: undefined4 FUN_004ec600(int *param_1,undefined4 *param_2)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_004ec600(int *param_1,uint *param_2)
      ...
      if (iVar5 == local_113) {
        ...
        *(int *)((int)local_44 + local_44[2]) = iVar5;
        ...
        if (uVar3 == param_1[0x45]) {
          ...
          iVar11 = FUN_005649c0(local_28,pcVar7);
          if (iVar11 != 0) {
            DAT_005bdee4 = 1;
          }
...
LAB_004ecb76:
  ...
  if (0 < local_113) {
    ...
    do {
      ...
      iVar4 = FUN_004eb440(param_1,(int)local_fb + iVar11,local_10f + iVar11,
        ...
        do {
          ...
          if (*(int *)((int)local_44 + local_14 + 4) < *(int *)((int)local_44 + local_14)) {
            ...
            *piVar13 = *piVar9;
            ...
            local_a8 = piVar14[5];
            local_a4 = piVar14[6];
            FUN_004edfa0(local_a0,local_1c);
