...
section .text
    ...
    PUSH ESI                            ; 004ed7bf
    CALL FUN_004ed980                   ; 004ed7c0
        ;   XREF to: 004ed980 (UNCONDITIONAL_CALL)  ; undefined FUN_004ed980()
    ADD ESP,0x8                         ; 004ed7c5
    PUSH ESI                            ; 004ed7c8
    CALL FUN_004edaf0                   ; 004ed7c9
        ;   XREF to: 004edaf0 (UNCONDITIONAL_CALL)  ; undefined FUN_004edaf0()
