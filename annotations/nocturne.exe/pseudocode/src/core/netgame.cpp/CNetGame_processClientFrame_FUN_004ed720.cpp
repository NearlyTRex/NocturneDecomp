...
// Convention: unknown
// Signature: void core_netgame_cpp_CNetGame_processClientFrame_FUN_004ed720(int *param_1)
      ...
      if (0 < _DAT_01d09c00) {
        ...
        do {
          if (param_1[param_1[0x45] * 0x1e + 0x1a] == *(int *)(iVar1 + 0x1d09c04)) {
            if (-1 < iVar2) {
              core_netgame_cpp_CNetGame_applySimFrameHistory_FUN_004ed980(param_1,iVar1 + 0x1d09c04)
              ;
              ...
              if (0 < _DAT_01d09c00) {
                ...
                do {
                  if (*(int *)(iVar3 + 0x1d09c04) < iVar2) {
                    ...
                    memmove
                              (iVar3 + 0x1d09c04,local_18,(_DAT_01d09c00 - iVar1) * 100);
                  }
                  else {
                    iVar1 = iVar1 + 1;
