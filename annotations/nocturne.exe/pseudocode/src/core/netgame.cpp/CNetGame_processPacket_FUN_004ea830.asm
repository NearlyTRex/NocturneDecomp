...
section .text
    ...
    CALL core_netgame.cpp_CNetGame_findPlayerByAddr_FUN_004eb3f0 ; 004ea84c
        ;   XREF to: 004eb3f0 (UNCONDITIONAL_CALL)  ; int core_netgame.cpp_CNetGame_findPlayerByAddr_FUN_004eb3f0(CNetGame * this_ptr, SNetworkAddr * addr)
    ...
    CALL core_netgame.cpp_CNetGame_applyNewGameSettings_FUN_004ec600 ; 004eafe6
        ;   XREF to: 004ec600 (UNCONDITIONAL_CALL)  ; int core_netgame.cpp_CNetGame_applyNewGameSettings_FUN_004ec600(CNetGame * this_ptr, UNetPacket * packet)
    ...
    MOV [0x01cc4800],EAX                ; 004eb1ec | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EDX      ; 004eb1f1 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004eb1f7
    ...
    MOV dword ptr [0x01cc4800],ESI      ; 004eb264 | g_CurrentFilename
    MOV [0x01cc4804],EAX                ; 004eb26a | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004eb26f
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
    ...
    MOV dword ptr [0x01cc4800],ECX      ; 004eb2c8 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EDI      ; 004eb2ce | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004eb2d4
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
