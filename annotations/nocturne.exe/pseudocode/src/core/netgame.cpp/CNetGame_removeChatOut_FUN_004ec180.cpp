...
// Convention: __cdecl
// Signature: void __cdecl core_netgame_cpp_CNetGame_removeChatOut_FUN_004ec180(int param_1)
        ...
        do {
          if ((char)local_20[2] == '\0') {
            ...
            if (local_150 < local_158) {
              ...
              core_netgame_cpp_CNetGame_sendPacket_FUN_004eb3c0(param_1,local_1c,&local_14c);
