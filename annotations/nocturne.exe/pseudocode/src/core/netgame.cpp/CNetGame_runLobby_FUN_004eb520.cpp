  ...
  if (this_ptr->connection_type != CONNECTION_NONE) {
    ...
    while (this_ptr->connection_type != CONNECTION_NONE) {
      ...
      for (iStack_20 = 0; iStack_20 < *(int *)(0x01CEA280 + 0x1c); iStack_20 = iStack_20 + 1) {
        pcStack_1c = (char *)(iStack_24 + 0x01CEA280 + 0x20);
        engine_2d_c_drawText_FUN_00402600(pcStack_1c,0,iVar4);
        if (*(int *)(pcStack_1c + 0x1c) == _DAT_02dd10c4) {
          pcVar6 = "(Local)";
          puVar8 = auStack_130;
          do {
            uVar1 = *pcVar6;
          ...
          support_trisock_cpp_formatIPAddress_FUN_00548bb0(pcStack_1c + 0x1c,auStack_130);
        }
...
LAB_004eb75b:
        ...
        _sprintf(auStack_130,"%d",*(uint *)(pcStack_1c + 0x14));
        engine_2d_c_drawText_FUN_00402600((char *)auStack_130,400,iVar4);
        if (this_ptr->connection_type == CONNECTION_HOST) {
          _sprintf(auStack_130,"%d",*(uint *)(pcStack_1c + 0x34));
      ...
      pcStack_28 = (char *)(iVar7 * 0x120 + 0x1cea430);
      pcVar6 = (char *)(iVar7 * 0x120 + 0x1cea41c);
      ...
      if ((this_ptr->connection_type == CONNECTION_CLIENT) &&
         (this_ptr->network_mode == NET_MODE_SYNCING)) {
        shape_edittool_cpp_CEditorTools_displayCenteredStatusMessage_FUN_0046fff0
                  (0x01BCD074,"Loading %s",this_ptr->mission_name);
        srand(this_ptr->random_seed);
        core_actor_cpp_setRandomSeed_FUN_0040dd20(this_ptr->random_seed);
        core_mission_cpp_CDemonMission_load_FUN_004d7ee0(0x01CC9450,this_ptr->mission_name,0);
        iVar4 = core_mission_cpp_CDemonMission_createHeros_FUN_004d9a80
                          (0x01CC9450,(CCharacter *)0x0);
        if (iVar4 != 0) {
          core_mission_cpp_CDemonMission_startMission_FUN_004d9780(0x01CC9450);
      ...
      if ((this_ptr->connection_type == CONNECTION_CLIENT) && (DAT_005bdee4 != 0)) {
