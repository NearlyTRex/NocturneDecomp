...
section .text
    ...
    MOV EBP,0x58ba54                    ; 004e977d
    MOV EAX,0x12b                       ; 004e9782
    PUSH 0x58ba68                       ; 004e9787
    MOV dword ptr [0x01cc4800],EBP      ; 004e978c | DAT_01cc4800
    MOV [0x01cc4804],EAX                ; 004e9792 | DAT_01cc4804
    CALL FUN_004c8440                   ; 004e9797
