...
section .text
    ...
    PUSH EAX                            ; 004ec957
    CALL FUN_004edfa0                   ; 004ec958
        ;   XREF to: 004edfa0 (UNCONDITIONAL_CALL)  ; undefined FUN_004edfa0()
