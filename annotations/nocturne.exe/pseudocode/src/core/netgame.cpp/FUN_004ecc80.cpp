...
// Convention: unknown
// Signature: void FUN_004ecc80(int param_1,int param_2)
...

{
  ...
  *(int *)(param_1 + 0x1c) = iVar2;
  iVar6 = param_2 + 1;
  FUN_00566170(param_2 * 0x78 + param_1 + 0x20,iVar6 * 0x78 + param_1 + 0x20,
               (iVar2 - param_2) * 0x78,iVar6);
  iVar2 = 0;
  if (0 < _DAT_01d06610) {
    ...
    do {
      FUN_00566170(puVar5,puVar3,*(int *)(param_1 + 0x1c) - param_2,iVar6,puVar1);
      iVar2 = iVar2 + 1;
      puVar3 = puVar3 + 0x114;
      FUN_00566170(iVar4,puVar1,(*(int *)(param_1 + 0x1c) - param_2) * 4);
      puVar5 = puVar5 + 0x114;
      puVar1 = puVar1 + 0x114;
      iVar4 = iVar4 + 0x114;
