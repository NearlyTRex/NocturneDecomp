...
;
; XREF[1]:
;   core_set.cpp_CDemonSet_renderScene_FUN_00509a80 at 0050a1f0
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0044f9b0
        ;   Label: core_dlight.cpp_CDemonLight_renderLightGlowSprites_FUN_0044f9b0
    PUSH ESI                            ; 0044f9b1
    PUSH EDI                            ; 0044f9b2
    PUSH EBP                            ; 0044f9b3
    ...
    CALL engine_drender.cpp_CDemonRenderer_getCameraOriginFixed_FUN_00460d10 ; 0044fb30
