...
section .text
    ...
    PUSH EAX                            ; 0044eba5
    PUSH EBP                            ; 0044eba6
    CALL FUN_0044e660                   ; 0044eba7
        ;   XREF to: 0044e660 (UNCONDITIONAL_CALL)  ; undefined FUN_0044e660()
    ...
    MOV dword ptr [0x01cc4800],ESI      ; 0044ebd0 | DAT_01cc4800
    MOV dword ptr [0x01cc4804],EDI      ; 0044ebd6 | DAT_01cc4804
    CALL FUN_004c8440                   ; 0044ebdc
