...
section .text
    ...
    PUSH EBX                            ; 0044e2c0
        ;   Label: core_dlight.cpp_CDemonLight_free_FUN_0044e2c0
    PUSH ESI                            ; 0044e2c1
    PUSH EBP                            ; 0044e2c2
    ...
    PUSH ESI                            ; 0044e2e3
    CALL crt_memory.c_free_FUN_005638d0 ; 0044e2e4
    ...
    MOV ECX,dword ptr [EBX + 0x2f98]    ; 0044e304
        ;   Label: LAB_0044e304
    PUSH ECX                            ; 0044e30a
    CALL crt_memory.c_free_FUN_005638d0 ; 0044e30b
        ;   XREF to: 005638d0 (UNCONDITIONAL_CALL)  ; void crt_memory.c_free_FUN_005638d0(void * ptr)
    ...
    PUSH EBP                            ; 0044e329
        ;   Label: LAB_0044e329
    CALL crt_memory.c_free_FUN_005638d0 ; 0044e32a
        ;   XREF to: 005638d0 (UNCONDITIONAL_CALL)  ; void crt_memory.c_free_FUN_005638d0(void * ptr)
