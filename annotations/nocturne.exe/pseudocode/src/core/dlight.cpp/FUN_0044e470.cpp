...
// Convention: unknown
// Signature: void FUN_0044e470(int param_1,int param_2)
...

{
  ...
  *(uint *)(param_1 + 0x11e4) = 1;
  ...
  FUN_00460e40(DAT_005ae704,0,0,*(int *)(param_1 + 0x1cc0) + -1,*(int *)(param_1 + 0x1cc4) + -1);
  ...
  *(int *)(param_1 + 0x168) = param_2;
  FUN_00460700(uVar2,param_1 + 0x104);
  ...
  if (param_2 == 0) {
    FUN_00481980(*(int *)(param_1 + 0x1cc0) * *(int *)(param_1 + 0x1cc4) * 2);
  }
  iVar3 = 0;
  iVar4 = param_1;
