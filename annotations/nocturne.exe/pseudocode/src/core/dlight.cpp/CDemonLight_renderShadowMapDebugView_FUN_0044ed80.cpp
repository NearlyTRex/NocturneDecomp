// Name: core_dlight.cpp_CDemonLight_renderShadowMapDebugView_FUN_0044ed80
// Address: 0044ed80
// Address Range: [[0044ed80, 0044efaa]]
// Convention: __cdecl
// Signature: void __cdecl core_dlight_cpp_CDemonLight_renderShadowMapDebugView_FUN_0044ed80(CDemonLight *this_ptr,int screen_x,int screen_y,int display_size)
...
LAB_0044eea7:
      ...
      if (g_CGame_PTR_005b9354->camera_debug_enabled != 0) {
        engine_2d_c_drawTextCenteredXYColor_FUN_00402d30
                  (screen_x,screen_x + display_size,screen_y + display_size + -0xb,(char *)this_ptr)
        ;
        return;
      }
    }
