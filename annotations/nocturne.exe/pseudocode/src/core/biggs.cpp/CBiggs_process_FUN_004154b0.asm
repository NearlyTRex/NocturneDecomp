...
section .text
    ...
    PUSH EBX                            ; 004154c1
    CALL core_charactr.cpp_CCharacter_FUN_004259f0 ; 004154c2
    ...
    PUSH EBX                            ; 0041553b
    CALL core_charactr.cpp_CCharacter_FUN_00428c00 ; 0041553c
    ...
    PUSH EBX                            ; 0041569a
    CALL core_charactr.cpp_CCharacter_FUN_0042a150 ; 0041569b
