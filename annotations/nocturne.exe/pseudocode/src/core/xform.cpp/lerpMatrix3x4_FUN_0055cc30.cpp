...
// Signature: CMatrix3x4f * __stack3_esi core_xform_cpp_lerpMatrix3x4_FUN_0055cc30(CMatrix3x4f *matrix_a,CMatrix3x4f *matrix_b,float t,CMatrix3x4f *matrix_out)
...

{
  ...
  if (t <= 0.0) {
    ...
    core_xform_cpp_matrixToQuaternion_FUN_0055cf10((CMatrix3x3f *)matrix_a,&local_20);
    ...
    *puVar6 = *puVar5;
    ...
    core_xform_cpp_matrixToQuaternion_FUN_0055cf10((CMatrix3x3f *)matrix_b,&local_60);
    ...
    *puVar6 = *puVar5;
    puVar6[(uint)bVar7 * -2 + 1] = puVar5[(uint)bVar7 * -2 + 1];
    core_xform_cpp_slerpQuaternion_FUN_0055d2d0(&local_70,&local_40,t,&local_50);
