...
// Convention: unknown
// Signature: void core_xform_cpp_lerpMatrix3x4_FUN_0055cc30(undefined4 *param_1,undefined4 *param_2,float param_3)

#include "nocturne.h"

/* WARNING: Type propagation algorithm not settling */

void core_xform_cpp_lerpMatrix3x4_FUN_0055cc30(uint *param_1,uint *param_2,float param_3)
  ...
  if (param_3 <= 0.0) {
    ...
    *(uint *)((int)auStack_3c + ((uint)bVar5 * -2 + (uint)bVar5 * -2 + 1) * 4) =
    ...
    [(uint)bVar5 * -2 + 1] =
         ((uint *)((int)auStack_3c + ((uint)bVar5 * -2 + (uint)bVar5 * -2 + -7) * 4))
         [(uint)bVar5 * -2 + 1];
    core_xform_cpp_slerpQuaternion_FUN_0055d2d0(&local_70,&local_40,param_3);
    local_30 = local_50;
