...
// Convention: __cdecl
// Signature: void __cdecl core_xform_cpp_clipInterpolateTopPlane_FUN_0055d830(SRenderVertex *vertex_a,SRenderVertex *vertex_b,SRenderVertex *vertex_out)
...

{
  ...
  uVar3 = (uint)lVar1;
  vertex_out->r = (int)((ulonglong)lVar1 >> 0x20) * 2 + (uint)CARRY4(uVar3,uVar3) + vertex_a->r;
  return;
}
