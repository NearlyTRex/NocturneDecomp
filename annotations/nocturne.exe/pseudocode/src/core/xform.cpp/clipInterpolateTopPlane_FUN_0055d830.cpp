// Name: core_xform.cpp_clipInterpolateTopPlane_FUN_0055d830
// Address: 0055d830
// Address Range: [[0055d830, 0055d8e7]]
// Convention: __cdecl
// Signature: void __cdecl core_xform_cpp_clipInterpolateTopPlane_FUN_0055d830(int *param_1,int *param_2,int *param_3)
...

{
  ...
  iVar5 = (param_2[1] + param_1[2]) - (param_1[1] + param_2[2]);
  ...
  param_3[2] = iVar4;
  param_3[1] = iVar4;
  lVar1 = (longlong)(*param_2 - *param_1) * (longlong)iVar5;
  uVar3 = (uint)lVar1;
