// Name: core_xform.cpp_clipInterpolateBottomPlane_FUN_0055d8f0
// Address: 0055d8f0
// Address Range: [[0055d8f0, 0055d9a8]]
// Convention: __cdecl
// Signature: void __cdecl core_xform_cpp_clipInterpolateBottomPlane_FUN_0055d8f0(int *param_1,int *param_2,int *param_3)
...

{
  ...
  iVar5 = uVar4 - (param_2[1] + param_2[2]);
  if ((int)uVar4 < iVar5) {
    if (-iVar5 < (int)uVar4) {
  ...
  uVar4 = (uint)lVar1;
  *param_3 = (int)((ulonglong)lVar1 >> 0x20) * 2 + (uint)CARRY4(uVar4,uVar4) + *param_1;
  bVar2 = DAT_01c039a0;
  param_3[4] = -1;
  if ((bVar2 & 4) == 0) {
    return;
