// Name: core_xform.cpp_buildMatrixFromEulerAndPositionDirect_FUN_0055afb0
// Address: 0055afb0
// Address Range: [[0055afb0, 0055b0a1]]
// Convention: unknown
// Signature: void core_xform_cpp_buildMatrixFromEulerAndPositionDirect_FUN_0055afb0(float *param_1,float *param_2,float *param_3)
...

{
  ...
  param_1[2] = (float)((float10)dVar1 * (float10)dVar2);
  param_1[4] = (float)(fVar8 * (float10)dVar2);
  ...
  *param_1 = (float)((float10)dVar5 * (float10)dVar4 + fVar10 * fVar6 * (float10)dVar3);
  param_1[9] = (float)((float10)dVar3 * (float10)dVar1 + fVar11 * fVar6 * (float10)dVar4);
  param_1[1] = (float)(-(float10)dVar5 * (float10)dVar3 + fVar10 * fVar6 * (float10)dVar4);
  param_1[8] = (float)(-(float10)dVar1 * (float10)dVar4 + fVar11 * fVar6 * (float10)dVar3);
  param_1[3] = *param_2;
  param_1[7] = param_2[1];
