...
;   core_xform.cpp_transformAndClipGeometry_FUN_0055e040 at 0055e575
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0055d770
        ;   Label: core_xform.cpp_clipInterpolateLeftPlane_FUN_0055d770
    PUSH ESI                            ; 0055d771
    PUSH EDI                            ; 0055d772
    PUSH EBP                            ; 0055d773
    ...
    MOV AH,byte ptr [0x01c039a0]        ; 0055d7ef | g_RenderStateFlags
