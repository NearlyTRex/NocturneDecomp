// Name: core_beast.cpp_FUN_00415250
// Address: 00415250
// Address Range: [[00415250, 00415308]]
// Convention: unknown
// Signature: CDemonActor * core_beast_cpp_FUN_00415250(CDemonActor *param_1,byte param_2)
...

{
  ...
  if ((param_2 & 4) != 0) {
    ptr = __vec_delete(param_1,&g_CBeastTypeInfo_0059a560);
