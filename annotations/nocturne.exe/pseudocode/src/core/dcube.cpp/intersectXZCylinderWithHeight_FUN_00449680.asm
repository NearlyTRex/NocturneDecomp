...
;
; XREF[1]:
;   core_dcube.cpp_intersectTriangleWithXZCylinder_FUN_00449720 at 00449b93
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 00449680
        ;   Label: core_dcube.cpp_intersectXZCylinderWithHeight_FUN_00449680
    PUSH ESI                            ; 00449681
    PUSH EDI                            ; 00449682
    ...
    CALL core_dcube.cpp_intersectXZCylinder_FUN_004493a0 ; 004496a9
