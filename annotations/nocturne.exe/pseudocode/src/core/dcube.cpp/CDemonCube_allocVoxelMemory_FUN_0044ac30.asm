...
;
; XREF[2]:
;   core_dtrace.cpp_CDemonRaytrace_restoreShadowBitFromBuffer_FUN_0046c100 at 0046c1eb
;   core_dtrace.cpp_CDemonRaytrace_setVoxelShadowBit_FUN_0046bfe0 at 0046c0cc
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0044ac30
        ;   Label: core_dcube.cpp_CDemonCube_allocVoxelMemory_FUN_0044ac30
    PUSH EBP                            ; 0044ac31
