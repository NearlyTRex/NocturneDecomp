...
section .text
    ...
    PUSH EBX                            ; 0044adf0
        ;   Label: core_dcube.cpp_CDemonCube_FUN_0044adf0
    PUSH EDI                            ; 0044adf1
    ...
    PUSH EDI                            ; 0044ae32
    CALL crt_memory.c_free_FUN_005638d0 ; 0044ae33
    ...
    PUSH EAX                            ; 0044ae48
    CALL crt_memory.c_free_FUN_005638d0 ; 0044ae49
        ;   XREF to: 005638d0 (UNCONDITIONAL_CALL)  ; void crt_memory.c_free_FUN_005638d0(void * ptr)
    ...
    PUSH ECX                            ; 0044ae61
        ;   Label: LAB_0044ae61
    CALL crt_memory.c_free_FUN_005638d0 ; 0044ae62
        ;   XREF to: 005638d0 (UNCONDITIONAL_CALL)  ; void crt_memory.c_free_FUN_005638d0(void * ptr)
