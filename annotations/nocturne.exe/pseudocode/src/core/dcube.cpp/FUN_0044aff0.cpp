...
// Convention: unknown
// Signature: void FUN_0044aff0(int param_1,uint param_2)
...

{
  ...
  if (0 < *(int *)(param_1 + 0x28)) {
    ...
    do {
      ...
      FUN_00460f20(DAT_005ae704,local_30 & 0xff,local_2c & 0xff,local_28 & 0xff);
      iVar3 = local_18 + 0x20;
      iVar2 = local_14 + 1;
      FUN_0044ab60(*(int *)(param_1 + 0x2c) + local_18,*(uint *)(param_1 + 0x24));
      local_18 = iVar3;
      local_14 = iVar2;
