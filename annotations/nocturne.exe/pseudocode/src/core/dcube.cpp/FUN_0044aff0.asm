...
;
; XREF[2]:
;   FUN_00469390 at 0046996b
;   FUN_0046af70 at 0046afbe
;
; Referenced Globals:
...
section .text
    ...
    INC ESI                             ; 0044b1b9
    CALL FUN_0044ab60                   ; 0044b1ba
        ;   XREF to: 0044ab60 (UNCONDITIONAL_CALL)  ; undefined FUN_0044ab60()
