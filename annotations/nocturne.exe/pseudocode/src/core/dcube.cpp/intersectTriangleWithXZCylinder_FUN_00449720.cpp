// Name: core_dcube.cpp_intersectTriangleWithXZCylinder_FUN_00449720
// Address: 00449720
// Address Range: [[00449720, 00449bb5]]
// Convention: __cdecl
// Signature: uint __cdecl core_dcube_cpp_intersectTriangleWithXZCylinder_FUN_00449720(int *param_1,undefined4 *param_2)

#include "nocturne.h"

uint __cdecl core_dcube_cpp_intersectTriangleWithXZCylinder_FUN_00449720(int *param_1,uint *param_2)

{
  ...
  if (0.0 <= (float)param_1[4]) {
    ...
    if (1 < uVar7) {
      ...
      iVar8 = core_dcube_cpp_intersectXZCylinder_FUN_004493a0(param_2);
...
LAB_00449ae4:
  ...
  uVar6 = core_dcube_cpp_intersectXZCylinderWithHeight_FUN_00449680(param_2,pfVar10,pfVar11);
  uVar7 = core_dcube_cpp_intersectXZCylinderWithHeight_FUN_00449680(param_2,pfVar10,local_34);
  return uVar7 | uVar6;
}
