...
// Convention: __cdecl
// Signature: uint __cdecl core_dcube_cpp_intersectTriangleWithXZCylinder_FUN_00449720(STriangleRef *triangle,SIntersectXZCylinder *cylinder)
...

{
  ...
  if (0.0 <= (triangle->normal).y) {
    ...
    if (1 < uVar11) {
      ...
      iVar12 = core_dcube_cpp_intersectXZCylinder_FUN_004493a0(cylinder);
      if (iVar12 != 0) goto LAB_00449ae4;
    }
  }
...
LAB_00449ae4:
  ...
  uVar10 = core_dcube_cpp_intersectXZCylinderWithHeight_FUN_00449680(cylinder,pCVar14,pCVar15);
  uVar11 = core_dcube_cpp_intersectXZCylinderWithHeight_FUN_00449680(cylinder,pCVar14,local_34);
