...
// Convention: __cdecl
// Signature: undefined4 __cdecl core_dcube_cpp_intersectXZCylinderWithHeight_FUN_00449680(undefined4 *param_1,undefined4 *param_2,undefined4 *param_3)

#include "nocturne.h"

uint __cdecl core_dcube_cpp_intersectXZCylinderWithHeight_FUN_00449680(uint *param_1,uint *param_2,uint *param_3)

{
  ...
  iVar2 = core_dcube_cpp_intersectXZCylinder_FUN_004493a0(param_1);
  if (((iVar2 != 0) &&
