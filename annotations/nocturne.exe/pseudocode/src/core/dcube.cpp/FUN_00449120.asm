...
section .text
    ...
    MOV EAX,dword ptr [ESP + 0x4]       ; 00449120
        ;   Label: core_dcube.cpp_FUN_00449120
    ...
    CALL core_dcube.cpp_FUN_00448fb0    ; 00449139
        ;   XREF to: 00448fb0 (UNCONDITIONAL_CALL)  ; undefined core_dcube.cpp_FUN_00448fb0()
