...

{
  ...
  if (0 < (int)_DAT_014b879c) {
    vertex1 = CVector3f_ARRAY_014b87a0;
    do {
      uVar2 = iVar3 + 1;
      ...
      if (CVector3f_ARRAY_014b87a0[uVar2].z < param_1) {
        bVar1 = bVar1 | 2;
      }
      switch(bVar1) {
      case 0:
        if (CVector3f_ARRAY_014b8864 + _DAT_014b8860 != vertex1) {
          CVector3f_ARRAY_014b8864[_DAT_014b8860].x = vertex1->x;
          CVector3f_ARRAY_014b8864[_DAT_014b8860].y = vertex1->y;
          CVector3f_ARRAY_014b8864[_DAT_014b8860].z = vertex1->z;
        }
        break;
      case 1:
        core_dcube_cpp_clipEdgeToPlane_FUN_004484c0
                  (CVector3f_ARRAY_014b87a0 + uVar2,vertex1,CVector3f_ARRAY_014b8864 + _DAT_014b8860
      ...
      case 2:
        ...
        core_dcube_cpp_clipEdgeToPlane_FUN_004484c0
                  (vertex1,CVector3f_ARRAY_014b87a0 + uVar2,CVector3f_ARRAY_014b8864 + _DAT_014b8860
                   ,0.0,0.0,-1.0,(double)param_1);
        break;
      default:
