...
// Convention: __cdecl
// Signature: undefined4 __cdecl core_dcube_cpp_intersectXZCylinder_FUN_004493a0(float *param_1)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint __cdecl core_dcube_cpp_intersectXZCylinder_FUN_004493a0(float *param_1)

{
  ...
  if (0.0 < fVar5) {
    ...
    fVar2 = (param_1[7] * fVar3 + param_1[6] * fVar5) * _DAT_0057bb8f;
    fVar5 = fVar2 * fVar2 -
            fVar1 * _DAT_0057bb93 * ((fVar3 * fVar3 + fVar5 * fVar5) - param_1[8] * param_1[8]);
    if (0.0 <= fVar5) {
      fVar1 = (-fVar2 - SQRT(fVar5)) / (fVar1 * _DAT_0057bb97);
      param_1[0x13] = fVar1;
