...
// Convention: __cdecl
// Signature: int __cdecl core_path_cpp_CPathMap_isLineWalkable_FUN_004f0540(CPathMap *this_ptr,int start_x,int start_z,int start_height,int end_x,int end_z,int end_height)
  ...
  if (iVar3 < local_1c) {
    ...
    if (-1 < local_1c) {
      ...
      do {
        ...
        if (_DAT_01e312f4 < (int)((iVar1 - start_height ^ uVar2) - uVar2)) {
          return 0;
        }
        iVar1 = core_path_cpp_CPathMap_getCachedVoxelHeight_FUN_004f04a0
        ...
        if (_DAT_01e312f4 < (int)((local_38 - start_height ^ uVar2) - uVar2)) {
          return 0;
        }
        if (0 < local_14) {
