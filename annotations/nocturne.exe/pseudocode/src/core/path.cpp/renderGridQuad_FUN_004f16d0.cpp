...
// Convention: __cdecl
// Signature: void __cdecl core_path_cpp_renderGridQuad_FUN_004f16d0(int grid_x,int grid_y,int grid_z,int red,int green,int blue,int alpha)
