// Name: core_path.cpp_FUN_004f18c0
// Address: 004f18c0
// Address Range: [[004f18c0, 004f1c8a]]
// Convention: unknown
// Signature: void core_path_cpp_FUN_004f18c0(int param_1,int param_2,int param_3,int param_4,int param_5)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void core_path_cpp_FUN_004f18c0(int param_1,int param_2,int param_3,int param_4,int param_5)
  ...
  do {
    ...
    do {
      ...
      if ((-1000 < *(int *)(local_18 + 0x9c70)) && (*(int *)(local_18 + 0x9c70) < 1000)) {
        ...
        engine_special_cpp_transformAndProjectPoint_FUN_0053075c((int)*pfVar3 + 0x30);
        pfVar3 = DAT_005ae704;
        ...
        engine_special_cpp_transformAndProjectPoint_FUN_0053075c((int)*pfVar3 + 0x60,uVar11);
        pfVar3 = DAT_005ae704;
        local_28 = local_84;
