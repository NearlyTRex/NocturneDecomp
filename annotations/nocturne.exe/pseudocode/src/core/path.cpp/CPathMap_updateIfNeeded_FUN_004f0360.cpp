// Name: core_path.cpp_CPathMap_updateIfNeeded_FUN_004f0360
// Address: 004f0360
// Address Range: [[004f0360, 004f049b]]
// Convention: __cdecl
// Signature: void __cdecl core_path_cpp_CPathMap_updateIfNeeded_FUN_004f0360(CPathMap *this_ptr,CVector3f *source_position,int force_update)
...

{
  ...
  bVar5 = 0;
  if (force_update == 0) {
    iVar2 = this_ptr->update_timer - _DAT_01bd1d80;
    ...
    if (iVar2 < 0) {
      this_ptr->update_timer = iVar2 + 0x4000;
               ...
               (float)4) &&
             (ABS(source_position->y - (this_ptr->cached_world_position).y) < (float)4
  ...
  core_dtrace_cpp_CDemonRaytrace_worldPositionToVoxelCoords_FUN_0046b700
            (&g_CDemonRaytrace_01fba938,&this_ptr->current_position,&local_1c);
