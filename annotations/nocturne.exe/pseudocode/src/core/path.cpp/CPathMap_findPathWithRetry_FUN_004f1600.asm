...
;   core_bugs.cpp_CBugs_updateBugsBehavior_FUN_00422050 at 004221b7
...
;   core_icepick.cpp_CIcePick_processAI_FUN_004baba0 at 004bb15b
...
;
; Called Functions:
;   core_path.cpp_CPathMap_findPathToDestination_FUN_004f0c20
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 004f1600
        ;   Label: core_path.cpp_CPathMap_findPathWithRetry_FUN_004f1600
    PUSH ESI                            ; 004f1601
    PUSH EDI                            ; 004f1602
    PUSH EBP                            ; 004f1603
