...
LAB_00458f79:
  ...
  case 0:
    ...
    if ((iVar8 != 0) &&
      ...
      if (iVar10 == g_CDemonSet_PTR_005be368->enemy_count) {
        ...
        core_dracbrid_cpp_CDraculaBride_startFreakySound_FUN_0045ab40(this_ptr,local_430,1.0);
        core_motion_cpp_CMotionController_setDesiredState_FUN_004e16b0
  ...
  case 9:
    if (this_ptr->freaky_timer <= 0.0) {
      ...
      core_dracbrid_cpp_CDraculaBride_startFreakySound_FUN_0045ab40(this_ptr,local_3cc,1.0);
...
LAB_00459978:
  ...
  case 0xe:
    if (this_ptr->freaky_timer <= 0.0) {
      ...
      core_dracbrid_cpp_CDraculaBride_startFreakySound_FUN_0045ab40(this_ptr,local_368,1.0);
      iVar8 = core_actor_cpp_randomChance_FUN_0040dea0(0.2);
      if (iVar8 != 0) {
        core_dracbrid_cpp_CDraculaBride_startFreakySound_FUN_0045ab40(this_ptr,local_368,1.0);
      }
  ...
  case 0x17:
    if (this_ptr->freaky_timer <= 0.0) {
      ...
      core_dracbrid_cpp_CDraculaBride_startFreakySound_FUN_0045ab40(this_ptr,local_494,1.0);
      iVar8 = core_actor_cpp_randomChance_FUN_0040dea0(0.2);
      if (iVar8 != 0) {
        core_dracbrid_cpp_CDraculaBride_startFreakySound_FUN_0045ab40(this_ptr,local_494,1.0);
      }
