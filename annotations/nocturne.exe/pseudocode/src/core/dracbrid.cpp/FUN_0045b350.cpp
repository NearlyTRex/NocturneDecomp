...
// Convention: unknown
// Signature: int core_dracbrid_cpp_FUN_0045b350(int param_1,byte param_2)

#include "nocturne.h"

int core_dracbrid_cpp_FUN_0045b350(int param_1,byte param_2)

{
  ...
  if ((param_2 & 4) != 0) {
    uVar2 = __vec_delete(param_1,&g_CDraculaBrideTypeInfo_0059c580);
