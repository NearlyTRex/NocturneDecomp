...
;   core_dracbrid.cpp_FUN_0045ab40
...
section .text
    ...
    CALL core_dracbrid.cpp_CDraculaBride_checkHeartShot_FUN_0045a6a0 ; 0045a75e
        ;   XREF to: 0045a6a0 (UNCONDITIONAL_CALL)  ; undefined core_dracbrid.cpp_CDraculaBride_checkHeartShot_FUN_0045a6a0()
    ...
    PUSH ESI                            ; 0045a875
    CALL core_dracbrid.cpp_FUN_0045ab40 ; 0045a876
    ...
    PUSH ESI                            ; 0045a8d3
    CALL core_dracbrid.cpp_FUN_0045ab40 ; 0045a8d4
        ;   XREF to: 0045ab40 (UNCONDITIONAL_CALL)  ; undefined core_dracbrid.cpp_FUN_0045ab40()
