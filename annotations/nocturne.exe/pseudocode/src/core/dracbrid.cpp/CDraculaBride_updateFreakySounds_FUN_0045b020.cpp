...

{
  ...
  local_28 = &g_CDemonCamera_01fb8508.position.z;
  local_30 = &local_64;
  local_2c = &local_60;
  local_34 = g_SFreaky_ARRAY_01b4d280;
  local_38 = (SFreaky *)&DAT_01b4d478;
  do {
    local_20 = local_34;
    if (this_ptr == local_34->owner) {
      iVar4 = sound_sndmain_cpp_isSfxPlaying_FUN_00526c50(local_34->sfx_handle);
      pSVar3 = local_34;
      if (iVar4 == 0) {
        ...
        core_spline_cpp_computeSplineBasis_FUN_00533ce0(local_88,local_20->t,0.0);
