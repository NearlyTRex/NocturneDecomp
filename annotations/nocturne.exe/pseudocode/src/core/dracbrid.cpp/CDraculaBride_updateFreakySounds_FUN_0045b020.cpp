...
// Convention: __cdecl
// Signature: void __cdecl core_dracbrid_cpp_CDraculaBride_updateFreakySounds_FUN_0045b020(int param_1,float param_2)
        ...
        *(float *)(local_34 + 0x1c) = *(float *)(local_34 + 0x1c) + param_2;
        ...
        puVar7 = (uint *)
                 core_spline_cpp_evaluateSplinePoint3D_FUN_00533f10
                           (local_88,local_50,local_1c,pfVar3,local_20 + 0x38,local_20 + 0x44);
