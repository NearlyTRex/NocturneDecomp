...
;   core_main.c_showDeveloperToolsMenu_FUN_004c8510
...
section .text
    ...
    PUSH EBP                            ; 004d23d0
        ;   Label: core_menu.cpp_showMainGameMenu_FUN_004d23d0
    ...
    CALL core_main.c_showDeveloperToolsMenu_FUN_004c8510 ; 004d270d
        ;   XREF to: 004c8510 (UNCONDITIONAL_CALL)  ; void core_main.c_showDeveloperToolsMenu_FUN_004c8510()
