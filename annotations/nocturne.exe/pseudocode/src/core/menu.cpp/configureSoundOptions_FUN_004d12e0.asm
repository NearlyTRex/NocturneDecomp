...
section .text
    ...
    POP EDI                             ; 004d1392
        ;   Label: LAB_004d1392
    CALL sound_sndmain.cpp_isSoundMuted_FUN_00526ca0 ; 004d1393
    ...
    FMUL float ptr [0x00588c83]         ; 004d1433 | FLOAT_00588c83
    FDIV float ptr [0x005a0574]         ; 004d1439 | FLOAT_005a0574
    FADD double ptr [0x00588c8b]        ; 004d143f | DOUBLE_00588c8b
    ...
    FMUL float ptr [0x00588c83]         ; 004d1539 | FLOAT_00588c83
    FDIV float ptr [0x005a0578]         ; 004d153f | FLOAT_005a0578
    FADD double ptr [0x00588c8b]        ; 004d1545 | DOUBLE_00588c8b
    ...
    FMUL float ptr [0x00588c83]         ; 004d163d | FLOAT_00588c83
    FDIV float ptr [0x005a0570]         ; 004d1643 | FLOAT_005a0570
    FADD double ptr [0x00588c8b]        ; 004d1649 | DOUBLE_00588c8b
    ...
    CALL sound_sndmain.cpp_getCurrentSoundDevice_FUN_00528610 ; 004d1896
        ;   XREF to: 00528610 (UNCONDITIONAL_CALL)  ; int sound_sndmain.cpp_getCurrentSoundDevice_FUN_00528610()
    ...
    FLD double ptr [0x00588c93]         ; 004d1a21 | DOUBLE_00588c93
    ...
    CALL sound_sndmain.cpp_analyzeFrequencyBand_FUN_00528e60 ; 004d1a8f
        ;   XREF to: 00528e60 (UNCONDITIONAL_CALL)  ; float sound_sndmain.cpp_analyzeFrequencyBand_FUN_00528e60(int channel, float freq_start_hz, float freq_end_hz)
    ...
    JMP dword ptr [EBX*0x4 + 0x4d12b0]  ; 004d1b57 | caseD_0 | caseD_1 | caseD_2
        ;   Label: switchD
    CALL sound_sndmain.cpp_isSoundMuted_FUN_00526ca0 ; 004d1b5e
        ;   XREF to: 00526ca0 (UNCONDITIONAL_CALL)  ; int sound_sndmain.cpp_isSoundMuted_FUN_00526ca0()
        ;   Label: caseD_0
    ...
    PUSH EAX                            ; 004d1b6d
    CALL sound_sndmain.cpp_setSoundMuted_FUN_00526cb0 ; 004d1b6e
        ;   XREF to: 00526cb0 (UNCONDITIONAL_CALL)  ; int sound_sndmain.cpp_setSoundMuted_FUN_00526cb0(int enable)
    ADD ESP,0x4                         ; 004d1b73
    CALL sound_sndmain.cpp_isSoundMuted_FUN_00526ca0 ; 004d1b76
        ;   XREF to: 00526ca0 (UNCONDITIONAL_CALL)  ; int sound_sndmain.cpp_isSoundMuted_FUN_00526ca0()
    ...
    FDIV float ptr [0x005a0574]         ; 004d1c85 | FLOAT_005a0574
    ...
    FCOMP double ptr [0x00588cbb]       ; 004d1cbe | DOUBLE_00588cbb
    FNSTSW AX                           ; 004d1cc4
    SAHF                                ; 004d1cc6
    ...
    FLD float ptr [ESP + 0x24]          ; 004d1cd9
        ;   Label: LAB_004d1cd9
    FMUL float ptr [0x005a0574]         ; 004d1cdd | FLOAT_005a0574
    ...
    FCOMP double ptr [0x00588ca3]       ; 004d1d4c | DOUBLE_00588ca3
    FNSTSW AX                           ; 004d1d52
    SAHF                                ; 004d1d54
    JA 0x004d1d77                       ; 004d1d55
        ;   XREF to: 004d1d77 (CONDITIONAL_JUMP)  ; LAB_004d1d77
    FLD float ptr [ESP + 0x24]          ; 004d1d57
    FCOMP double ptr [0x00588cab]       ; 004d1d5b | DOUBLE_00588cab
    FNSTSW AX                           ; 004d1d61
    SAHF                                ; 004d1d63
    ...
    FDIV float ptr [0x005a0578]         ; 004d1dad | FLOAT_005a0578
    ...
    FCOMP double ptr [0x00588cbb]       ; 004d1de2 | DOUBLE_00588cbb
    FNSTSW AX                           ; 004d1de8
    SAHF                                ; 004d1dea
    ...
    FLD float ptr [ESP + 0x18]          ; 004d1dfe
        ;   Label: LAB_004d1dfe
    FMUL float ptr [0x005a0578]         ; 004d1e02 | FLOAT_005a0578
    ...
    FCOMP double ptr [0x00588ca3]       ; 004d1e51 | DOUBLE_00588ca3
    FNSTSW AX                           ; 004d1e57
    SAHF                                ; 004d1e59
    JA 0x004d1e75                       ; 004d1e5a
        ;   XREF to: 004d1e75 (CONDITIONAL_JUMP)  ; LAB_004d1e75
    FLD float ptr [ESP + 0x18]          ; 004d1e5c
    FCOMP double ptr [0x00588cab]       ; 004d1e60 | DOUBLE_00588cab
    FNSTSW AX                           ; 004d1e66
    SAHF                                ; 004d1e68
    ...
    FDIV float ptr [0x005a0570]         ; 004d1ead | FLOAT_005a0570
    ...
    FADD float ptr [0x00588cb3]         ; 004d1ed9 | DOUBLE_00588cb3
    FST float ptr [ESP + 0x20]          ; 004d1edf
    FCOMP double ptr [0x00588cbb]       ; 004d1ee3 | DOUBLE_00588cbb
    FNSTSW AX                           ; 004d1ee9
    SAHF                                ; 004d1eeb
    ...
    FLD float ptr [ESP + 0x20]          ; 004d1eff
        ;   Label: LAB_004d1eff
    FMUL float ptr [0x005a0570]         ; 004d1f03 | FLOAT_005a0570
    ...
    CALL sound_sndmain.cpp_initializeSoundDevice_FUN_00528500 ; 004d2141
        ;   XREF to: 00528500 (UNCONDITIONAL_CALL)  ; int sound_sndmain.cpp_initializeSoundDevice_FUN_00528500()
    ...
    CALL sound_sndmain.cpp_enableHwSoundMixing_FUN_005284a0 ; 004d2198
        ;   XREF to: 005284a0 (UNCONDITIONAL_CALL)  ; void sound_sndmain.cpp_enableHwSoundMixing_FUN_005284a0(int enable)
