...

{
  ...
  if (((*(int *)(0x01C775EC + 0xbc) != 2) || (*(int *)(0x01C775EC + 0xa4) != 0)) ||
     (iVar28 = core_menu_cpp_calibrateGamepad_FUN_004cf8d0(), iVar28 != 0)) {
    local_c = 0;
LAB_004d2d2e:
    _DAT_01cc8120 = 0;
    ...
    *(int *)(&DAT_01cc8124 + _DAT_01cc8120 * 4) = iVar28;
    ...
    _DAT_01cc8120 = _DAT_01cc8120 + 1;
    pcVar2 = (char *)support_newmsg_cpp_getLocalizedString_FUN_004ee370("Item description")
    ;
    ...
    *(int *)(&DAT_01cc8124 + _DAT_01cc8120 * 4) = iVar28;
    ...
    if (0 < _DAT_01cc8120) {
      ...
      iVar31 = 0;
      do {
        uVar3 = core_menu_cpp_getKeyDisplayName_FUN_004d2900
                          (**(uint **)(&DAT_01cc8124 + iVar31));
        _sprintf(local_d4,"%s\t%s",iVar29,uVar3);
        iVar31 = iVar31 + 4;
        iVar28 = iVar28 + 1;
        iVar29 = iVar29 + 0x28;
    ...
    local_234 = 1;
    uVar3 = support_newmsg_cpp_getLocalizedString_FUN_004ee370("Edit key settings",local_c)
    ;
    iVar28 = shape_edittool_cpp_CPickList_displayChoicesAndWaitForInput_FUN_00474d70
                       (local_244,uVar3);
    if (-1 < iVar28) {
      if (iVar28 == 0) {
...
LAB_004d3ec0:
    ...
    uVar3 = support_newmsg_cpp_getLocalizedString_FUN_004ee370("Strafe left");
    iVar5 = core_menu_cpp_isKeyCodeValidForMode_FUN_004d2b40(0x01C775EC + 0x38,uVar3);
    uVar3 = support_newmsg_cpp_getLocalizedString_FUN_004ee370("Strafe right");
    iVar6 = core_menu_cpp_isKeyCodeValidForMode_FUN_004d2b40(0x01C775EC + 0x3c,uVar3);
    uVar3 = support_newmsg_cpp_getLocalizedString_FUN_004ee370("Turn left");
    iVar7 = core_menu_cpp_isKeyCodeValidForMode_FUN_004d2b40(0x01C775EC + 0x44,uVar3);
    uVar3 = support_newmsg_cpp_getLocalizedString_FUN_004ee370("Turn right");
    iVar8 = core_menu_cpp_isKeyCodeValidForMode_FUN_004d2b40(0x01C775EC + 0x40,uVar3);
    uVar3 = support_newmsg_cpp_getLocalizedString_FUN_004ee370("Fire / Action");
    iVar9 = core_menu_cpp_isKeyCodeValidForMode_FUN_004d2b40(0x01C775EC + 0x48,uVar3);
    uVar3 = support_newmsg_cpp_getLocalizedString_FUN_004ee370("Use item");
    iVar10 = core_menu_cpp_isKeyCodeValidForMode_FUN_004d2b40(0x01C775EC + 0x4c,uVar3);
    uVar3 = support_newmsg_cpp_getLocalizedString_FUN_004ee370("Light");
    ...
    uVar3 = support_newmsg_cpp_getLocalizedString_FUN_004ee370("Select assault weapons");
    iVar18 = core_menu_cpp_isKeyCodeValidForMode_FUN_004d2b40(0x01C775EC + 0x6c,uVar3);
    uVar3 = support_newmsg_cpp_getLocalizedString_FUN_004ee370("Select flame weapons");
    iVar19 = core_menu_cpp_isKeyCodeValidForMode_FUN_004d2b40(0x01C775EC + 0x70,uVar3);
    uVar3 = support_newmsg_cpp_getLocalizedString_FUN_004ee370("Select grenade weapons");
    iVar20 = core_menu_cpp_isKeyCodeValidForMode_FUN_004d2b40(0x01C775EC + 0x74,uVar3);
    uVar3 = support_newmsg_cpp_getLocalizedString_FUN_004ee370("Select melee weapons");
    iVar21 = core_menu_cpp_isKeyCodeValidForMode_FUN_004d2b40(0x01C775EC + 0x78,uVar3);
    uVar3 = support_newmsg_cpp_getLocalizedString_FUN_004ee370("Next weapon");
    iVar22 = core_menu_cpp_isKeyCodeValidForMode_FUN_004d2b40(0x01C775EC + 0x7c,uVar3);
    uVar3 = support_newmsg_cpp_getLocalizedString_FUN_004ee370("Previous weapon");
    iVar23 = core_menu_cpp_isKeyCodeValidForMode_FUN_004d2b40(0x01C775EC + 0x80,uVar3);
    uVar3 = support_newmsg_cpp_getLocalizedString_FUN_004ee370("Next item");
    iVar24 = core_menu_cpp_isKeyCodeValidForMode_FUN_004d2b40(0x01C775EC + 0x84,uVar3);
    uVar3 = support_newmsg_cpp_getLocalizedString_FUN_004ee370("Previous item");
    iVar25 = core_menu_cpp_isKeyCodeValidForMode_FUN_004d2b40(0x01C775EC + 0x88,uVar3);
    uVar3 = support_newmsg_cpp_getLocalizedString_FUN_004ee370("Item description");
    iVar26 = core_menu_cpp_isKeyCodeValidForMode_FUN_004d2b40(0x01C775EC + 0x8c,uVar3);
    uVar3 = support_newmsg_cpp_getLocalizedString_FUN_004ee370("Next ammo");
    iVar27 = core_menu_cpp_isKeyCodeValidForMode_FUN_004d2b40(0x01C775EC + 0x90,uVar3);
