// Name: core_setutil.cpp_FUN_00515890
// Address: 00515890
// Address Range: [[00515890, 00515976]]
// Convention: unknown
// Signature: void core_setutil_cpp_FUN_00515890(void)
...

{
  ...
  local_38 = (int)ROUND((float)(fVar4 * fVar5 * fVar7) * _DAT_005a1ab0);
  local_34 = (int)ROUND((float)(fVar6 * fVar5) * _DAT_005a1ab0);
  local_30 = (int)ROUND((float)(fVar3 * fVar5 * fVar7) * _DAT_005a1ab0);
  iVar2 = in_stack_0000000c * 0x30;
  engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + iVar2,&local_38);
  piVar1 = DAT_005ae704;
