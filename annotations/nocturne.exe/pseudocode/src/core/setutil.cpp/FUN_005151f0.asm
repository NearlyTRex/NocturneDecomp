...
section .text
    ...
    PUSH ECX                            ; 00515327
    PUSH EAX                            ; 00515328
    CALL FUN_0044e110                   ; 00515329
        ;   XREF to: 0044e110 (UNCONDITIONAL_CALL)  ; undefined FUN_0044e110()
