...
section .text
    ...
    MOV dword ptr [0x01cc4800],ECX      ; 005156ca | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EDI      ; 005156d0 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 005156d6
    ...
    MOV [0x01cc4800],EAX                ; 005156ef | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EDX      ; 005156f4 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 005156fa
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
