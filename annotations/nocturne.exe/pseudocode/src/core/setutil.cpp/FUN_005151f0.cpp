...
// Convention: unknown
// Signature: char * FUN_005151f0(int param_1)
...

{
  ...
  pcVar4 = (char *)0x0;
  if (iVar2 != 0) {
    pcVar4 = (char *)FUN_0044e110(iVar2,*(uint *)(param_1 + 0x1808),
                                  *(uint *)(param_1 + 0x180c));
  }
  if (pcVar4 == (char *)0x0) {
  ...
  FUN_0044d7a0(pcVar4 + 0x110,param_1 + 0x110);
  *(uint *)(pcVar4 + 0x138) = *(uint *)(param_1 + 0x11c);
  ...
  if (0 < *(int *)(param_1 + 0x11ec)) {
    ...
    do {
      iVar2 = iVar2 + 1;
      uVar3 = FUN_0044bd20(0x014B8DE8,iVar5,*(uint *)(param_1 + 0x11f0));
