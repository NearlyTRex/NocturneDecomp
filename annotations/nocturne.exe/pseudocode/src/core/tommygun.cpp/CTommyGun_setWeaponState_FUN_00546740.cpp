...
// Convention: unknown
// Signature: void core_tommygun_cpp_CTommyGun_setWeaponState_FUN_00546740(int param_1,undefined4 param_2)

#include "nocturne.h"

void core_tommygun_cpp_CTommyGun_setWeaponState_FUN_00546740(int param_1,uint param_2)
