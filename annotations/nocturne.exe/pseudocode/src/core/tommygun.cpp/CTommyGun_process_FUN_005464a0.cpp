// Name: core_tommygun.cpp_CTommyGun_process_FUN_005464a0
// Address: 005464a0
// Address Range: [[005464a0, 00546734]]
// Convention: __cdecl
// Signature: void __cdecl core_tommygun_cpp_CTommyGun_process_FUN_005464a0(CTommyGun *this_ptr,float delta_time)
...

{
  ...
  if (this_ptr->fire_frames_remaining < 1) {
    local_20 = sound_sndmain_cpp_getSfxPlaybackPosition_FUN_00526d10(this_ptr->sfx_handles[0],2);
    ...
    if (fVar2 < 0.0) {
      ...
      iVar3 = sound_sndmain_cpp_getSfxSampleInfo_FUN_00526cd0(this_ptr->sfx_handles[0],&local_1b4);
      if (iVar3 != 0) {
