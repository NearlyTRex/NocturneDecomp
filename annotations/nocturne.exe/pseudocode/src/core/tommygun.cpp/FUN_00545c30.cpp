...
// Convention: unknown
// Signature: undefined4 core_tommygun_cpp_FUN_00545c30(int param_1)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint core_tommygun_cpp_FUN_00545c30(int param_1)
    ...
    if (iVar2 == 0) {
      if (iStack_1c == 0) {
        if (iVar4 == 0) {
          ...
          iVar2 = core_trigger_cpp_FUN_005485a0(iVar4,param_1);
          if (iVar2 != 0) {
        ...
        iVar2 = core_glass_cpp_FUN_004aded0(iStack_1c);
        if (iVar2 == 0) goto LAB_00545ebe;
        core_glass_cpp_FUN_004ada20(iStack_1c,0x01E57284 + 0x14cd50);
      }
    }
    else {
