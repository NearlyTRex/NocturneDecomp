...
// Convention: unknown
// Signature: undefined4 core_tommygun_cpp_FUN_00545c30(CCharacter *param_1)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint core_tommygun_cpp_FUN_00545c30(CCharacter *param_1)

{
  ...
  fVar1 = (param_1->model).transformed_vertices[0x1c].x;
  (param_1->model).transformed_vertices[0x50].z = 2.8026e-45;
  if (0.0 < fVar1) {
    return 0;
  }
  pCVar2 = (param_1->base).vtable._uc;
  (param_1->model).transformed_vertices[0x1c].x =
       (param_1->model).transformed_vertices[0x1c].x + 0.1f;
  pCVar3 = (CVector3f *)(*(pCVar2->_uc).canWalk)(param_1);
  core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240(&param_1->base,&CStack_98,pCVar3);
  iVar4 = core_weapon_cpp_CWeapon_fire_FUN_00554600((CWeapon *)param_1);
  if (iVar4 == 0) {
  ...
  CStack_a4.z = (param_1->model).transformed_vertices[0x1a].x;
  CStack_a4.x = 0.0;
  CStack_a4.y = 0.0;
  core_actor_cpp_CDemonActor_transformVector_FUN_0040a200(&param_1->base,&CStack_74,&CStack_a4);
  CStack_bc.x = CStack_98.x + CStack_74.x;
  CStack_bc.y = CStack_98.y + CStack_74.y;
  CStack_bc.z = CStack_98.z + CStack_74.z;
  fStack_28 = (float)2.5 / (param_1->model).transformed_vertices[0x1a].x;
...
LAB_00545ebe:
      ...
      if ((param_1->model).transformed_vertices[0x50].y != 0.0) {
        ...
        pCVar3 = core_actor_cpp_CDemonActor_transformVector_FUN_0040a200
                           (&param_1->base,aCStack_50,pCVar3);
        if (&CStack_80 != pCVar3) {
