...
section .text
    ...
    PUSH EBX                            ; 0041fe40
        ;   Label: core_bride.cpp_CBride_process_FUN_0041fe40
    PUSH ESI                            ; 0041fe41
    PUSH EDI                            ; 0041fe42
    PUSH EBP                            ; 0041fe43
    ...
    PUSH EBX                            ; 0041fe5b
    CALL core_charactr.cpp_CCharacter_process_FUN_004259f0 ; 0041fe5c
    ...
    PUSH EAX                            ; 00420018
    MOV ESI,dword ptr [0x005b96c4]      ; 00420019 | g_CGore_PTR_005b96c4
    PUSH ESI                            ; 0042001f
    ...
    PUSH EBX                            ; 00420896
    CALL core_charactr.cpp_CCharacter_applyGestureLookAt_FUN_0042a150 ; 00420897
