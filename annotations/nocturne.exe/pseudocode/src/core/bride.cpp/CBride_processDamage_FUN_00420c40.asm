...
section .text
    ...
    PUSH EAX                            ; 00420ca7
    PUSH ESI                            ; 00420ca8
    CALL core_charactr.cpp_CCharacter_igniteBone_FUN_00427730 ; 00420ca9
    ...
    CALL core_bride.cpp_CBride_processDismemberment_FUN_00420a10 ; 00420cb3
        ;   XREF to: 00420a10 (UNCONDITIONAL_CALL)  ; void core_bride.cpp_CBride_processDismemberment_FUN_00420a10(CBride * this_ptr, SDamageInfo * damage_info)
    ...
    PUSH EAX                            ; 00420daf
    MOV EAX,[0x005b80f0]                ; 00420db0 | g_CFireEffect_PTR_005b80f0
    PUSH EAX                            ; 00420db5
    INC EBX                             ; 00420db6
