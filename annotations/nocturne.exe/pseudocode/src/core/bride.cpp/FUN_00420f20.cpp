// Name: core_bride.cpp_FUN_00420f20
// Address: 00420f20
// Address Range: [[00420f20, 00420fd8]]
// Convention: unknown
// Signature: int core_bride_cpp_FUN_00420f20(int param_1,byte param_2)

#include "nocturne.h"

int core_bride_cpp_FUN_00420f20(int param_1,byte param_2)

{
  ...
  if ((param_2 & 4) != 0) {
    uVar2 = __vec_delete(param_1,&g_CBrideTypeInfo_0059ae70);
