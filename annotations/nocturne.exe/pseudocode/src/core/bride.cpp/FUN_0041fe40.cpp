...
// Convention: unknown
// Signature: void core_bride_cpp_FUN_0041fe40(int param_1,float param_2)
...

{
  ...
  if (iVar3 != 0) {
    ...
    if (uVar1 < 5) {
          ...
          *(float *)(param_1 + 0xbca0) = local_14;
          ...
          if (local_20 <= (float)3) {
            ...
            if ((local_4c < 1.0) || (2 < local_4c)) {
              ...
              if (((float)3 <= local_20) &&
                ...
                uVar5 = core_xform_cpp_transformVector3x4_FUN_0055a8b0
                                  (local_a4,&CVector3f_00764ae4,
                                   DAT_00764b30 * 0x30 + param_1 + 0xfd0,0x3ecccccd,local_140);
              ...
              local_14 = local_1f0;
              uVar5 = core_xform_cpp_transformVector3x4_FUN_0055a8b0
                                (local_e0,&CVector3f_00764ae4,param_1 + 0xfd0 + DAT_00764b34 * 0x30,
              ...
              if (*(int *)(param_1 + 0x2290 + *(int *)(param_1 + 0xbd30) * 4) != 0) {
                ...
                uVar5 = core_xform_cpp_transformVector3x4_FUN_0055a8b0
                                  (local_80,&CVector3f_00764ae4,
                                   param_1 + 0xfd0 + DAT_00764b34 * 0x30,0x3ecccccd,local_17c);
                uVar5 = core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240
              ...
              if (((((float)3 <= local_1c) && (local_5c <= 4)) ||
                ...
                uVar5 = core_xform_cpp_transformVector3x4_FUN_0055a8b0
                                  (local_98,&CVector3f_00764ae4,
                                   param_1 + 0xfd0 + DAT_00764b30 * 0x30,0x3ecccccd,local_1b8);
                uVar5 = core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240
      ...
      core_gore_cpp_FUN_004b0480(INT_005b96c4,local_d4,0);
