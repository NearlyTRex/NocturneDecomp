...
section .text
    ...
    MOV EAX,[0x005b9354]                ; 00420a88 | g_CGame_PTR_005b9354
        ;   Label: LAB_00420a88
    CMP dword ptr [EAX + 0x1e0],0x0     ; 00420a8d | g_CGame_01c775ec.gratuitous_dismemberment
    JZ 0x00420a9d                       ; 00420a94
        ;   XREF to: 00420a9d (CONDITIONAL_JUMP)  ; LAB_00420a9d
    MOV dword ptr [ESP],0x3f800000      ; 00420a96
    MOV EAX,[0x005b9354]                ; 00420a9d | g_CGame_PTR_005b9354
        ;   Label: LAB_00420a9d
    MOV EDX,dword ptr [EAX + 0x14]      ; 00420aa2 | g_CGame_01c775ec.blood_flag
