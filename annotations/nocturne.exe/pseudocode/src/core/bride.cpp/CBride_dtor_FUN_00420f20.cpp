// Name: core_bride.cpp_CBride_dtor_FUN_00420f20
// Address: 00420f20
// Address Range: [[00420f20, 00420fd8]]
// Convention: __cdecl
// Signature: CBride * __cdecl core_bride_cpp_CBride_dtor_FUN_00420f20(CBride *this_ptr,uint flags)
...

{
  ...
  if ((flags & 4) != 0) {
    ptr_00 = __vec_delete(this_ptr,&g_CBrideTypeInfo_0059ae70);
