...
section .text
    ...
    PUSH EBX                            ; 0048fc30
        ;   Label: core_flies.cpp_FUN_0048fc30
    ...
    PUSH EBX                            ; 0048fc44
    CALL core_flies.cpp_FUN_0048fce0    ; 0048fc45
        ;   XREF to: 0048fce0 (UNCONDITIONAL_CALL)  ; undefined core_flies.cpp_FUN_0048fce0()
    ...
    PUSH EAX                            ; 0048fc88
        ;   Label: LAB_0048fc88
    CALL crt_unknown.c_FUN_00564494     ; 0048fc89
