// Name: core_tvbat.cpp_FUN_0054c190
// Address: 0054c190
// Address Range: [[0054c190, 0054c248]]
// Convention: unknown
// Signature: int core_tvbat_cpp_FUN_0054c190(int param_1,byte param_2)

#include "nocturne.h"

int core_tvbat_cpp_FUN_0054c190(int param_1,byte param_2)

{
  ...
  if ((param_2 & 4) != 0) {
    uVar2 = __vec_delete(param_1,&g_CTVBatTypeInfo_005a3a40);
