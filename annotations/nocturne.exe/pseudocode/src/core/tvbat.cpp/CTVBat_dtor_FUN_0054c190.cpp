// Name: core_tvbat.cpp_CTVBat_dtor_FUN_0054c190
// Address: 0054c190
// Address Range: [[0054c190, 0054c248]]
// Convention: __cdecl
// Signature: CTVBat * __cdecl core_tvbat_cpp_CTVBat_dtor_FUN_0054c190(CTVBat *this_ptr,uint flags)
...

{
  ...
  if ((flags & 4) != 0) {
    ptr_00 = __vec_delete(this_ptr,&g_CTVBatTypeInfo_005a3a40);
