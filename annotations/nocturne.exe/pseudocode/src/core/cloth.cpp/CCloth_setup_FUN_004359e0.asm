...
;   core_mimic.cpp_CMimic_setup_FUN_004d4650 at 004d483b
;   core_svetlana.cpp_CSvetlana_setup_FUN_00541a40 at 00541c49
;   core_vampboss.cpp_CVampireBoss_setup_FUN_0054c3e0 at 0054c43c
;
; Referenced Globals:
...
;   core_cloth.cpp_CCloth_orientBoneToChild_FUN_004363e0
...
section .text
    ...
    PUSH EBX                            ; 004359e0
        ;   Label: core_cloth.cpp_CCloth_setup_FUN_004359e0
    PUSH ESI                            ; 004359e1
    PUSH EDI                            ; 004359e2
    PUSH EBP                            ; 004359e3
