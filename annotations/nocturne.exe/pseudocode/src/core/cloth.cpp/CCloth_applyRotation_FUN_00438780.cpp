...
// Convention: unknown
// Signature: void core_cloth_cpp_CCloth_applyRotation_FUN_00438780(int param_1,float *param_2)
...

{
  ...
  CStack_34.x = *param_2 - *(float *)(param_1 + 0x3ab14);
  CStack_34.y = param_2[1] - *(float *)(param_1 + 0x3ab18);
  CStack_34.z = param_2[2] - *(float *)(param_1 + 0x3ab1c);
  ...
  if (0 < *(int *)(param_1 + 0x104)) {
    ...
    do {
      ...
      puVar1 = (uint *)
               core_dirmat_cpp_CMatrix3x3f_transformVectorTranspose_FUN_0044daa0
                         (&CStack_5c,auStack_1c,iVar4 * 0x11c + param_1 + 0x398);
      if (puVar2 != puVar1) {
        *puVar2 = *puVar1;
        puVar2[1] = puVar1[1];
        puVar2[2] = puVar1[2];
