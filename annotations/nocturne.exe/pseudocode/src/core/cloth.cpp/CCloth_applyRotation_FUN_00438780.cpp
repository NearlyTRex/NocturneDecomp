...

{
  ...
  core_dirmat_cpp_CMatrix3x3f_buildRotationMatrix_FUN_0044d7a0(auStack_5c,&fStack_34);
  iVar4 = 0;
  if (0 < *(int *)(param_1 + 0x104)) {
    ...
    do {
      ...
      puVar1 = (uint *)
               core_dirmat_cpp_CMatrix3x3f_transformVectorTranspose_FUN_0044daa0
                         (auStack_5c,auStack_1c,iVar4 * 0x11c + param_1 + 0x398);
      if (puVar2 != puVar1) {
        *puVar2 = *puVar1;
        puVar2[1] = puVar1[1];
        puVar2[2] = puVar1[2];
