...
;
; XREF[1]:
;   core_cloth.cpp_CCloth_renderCollisionBones_FUN_00437a60 at 00437a8b
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00437ab0
        ;   Label: core_cloth.cpp_CCloth_renderBone_FUN_00437ab0
    PUSH ESI                            ; 00437ab1
    PUSH EDI                            ; 00437ab2
    PUSH EBP                            ; 00437ab3
    ...
    PUSH EAX                            ; 00437ae9
    MOV ECX,dword ptr [0x005ae704]      ; 00437aea | g_CDemonRenderer_PTR_005ae704
    ...
    MOV EDX,dword ptr [0x005ae704]      ; 00437b50 | g_CDemonRenderer_PTR_005ae704
    ...
    MOV EDX,dword ptr [0x005ae704]      ; 00437bae | g_CDemonRenderer_PTR_005ae704
    ...
    MOV EAX,[0x005ae704]                ; 00437c31 | g_CDemonRenderer_PTR_005ae704
        ;   Label: LAB_00437c31
    ...
    PUSH EBX                            ; 00437c4a
    PUSH ESI                            ; 00437c4b
    MOV EAX,[0x005ae704]                ; 00437c4c | g_CDemonRenderer_PTR_005ae704
    ...
    PUSH EDX                            ; 00437c5e
    PUSH ESI                            ; 00437c5f
    MOV ECX,dword ptr [0x005ae704]      ; 00437c60 | g_CDemonRenderer_PTR_005ae704
    ...
    PUSH EAX                            ; 00437c78
    MOV EDX,dword ptr [0x005ae704]      ; 00437c79 | g_CDemonRenderer_PTR_005ae704
