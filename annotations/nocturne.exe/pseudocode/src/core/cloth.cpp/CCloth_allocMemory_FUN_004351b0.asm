...
section .text
    ...
    PUSH EBX                            ; 004351b5
    CALL core_cloth.cpp_CCloth_FUN_00435210 ; 004351b6
    ...
    MOV dword ptr [0x01cc4800],ECX      ; 004351eb | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EBX      ; 004351f1 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004351f7
