...
section .text
    ...
    MOV [0x01cc4800],EAX                ; 00438730 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EDX      ; 00438735 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 0043873b
