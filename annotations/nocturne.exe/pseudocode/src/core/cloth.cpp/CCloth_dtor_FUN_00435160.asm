...
section .text
    ...
    CALL core_cloth.cpp_SClothBone_arrdtor_FUN_00438a20 ; 00435177
        ;   XREF to: 00438a20 (UNCONDITIONAL_CALL)  ; undefined core_cloth.cpp_SClothBone_arrdtor_FUN_00438a20()
    ADD ESP,0x8                         ; 0043517c
    PUSH 0x0                            ; 0043517f
    SUB EAX,0x377b8                     ; 00435181
    PUSH EAX                            ; 00435186
    CALL core_cloth.cpp_SClothVertex_arrdtor_FUN_00438a00 ; 00435187
        ;   XREF to: 00438a00 (UNCONDITIONAL_CALL)  ; undefined core_cloth.cpp_SClothVertex_arrdtor_FUN_00438a00()
    ADD ESP,0x8                         ; 0043518c
    PUSH 0x1                            ; 0043518f
    LEA EBX,[EAX + 0xfffffc68]          ; 00435191
    PUSH EBX                            ; 00435197
    CALL core_dmodel.cpp_CKeyFramedModel_dtor_FUN_00452630 ; 00435198
        ;   XREF to: 00452630 (UNCONDITIONAL_CALL)  ; undefined core_dmodel.cpp_CKeyFramedModel_dtor_FUN_00452630()
