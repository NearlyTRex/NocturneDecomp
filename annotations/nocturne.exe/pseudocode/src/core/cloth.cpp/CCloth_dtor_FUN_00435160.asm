...
;   core_mimic.cpp_CMimic_dtor_FUN_004d4540 at 004d4599
...
;   core_cloth.cpp_SClothBone_arrdtor50_FUN_00438a20
;   core_cloth.cpp_SClothVertex_arrdtor800_FUN_00438a00
...
section .text
    ...
    PUSH EBX                            ; 00435176
    CALL core_cloth.cpp_SClothBone_arrdtor50_FUN_00438a20 ; 00435177
        ;   XREF to: 00438a20 (UNCONDITIONAL_CALL)  ; SClothBone * core_cloth.cpp_SClothBone_arrdtor50_FUN_00438a20(SClothBone * this_ptr, uint flags)
    ADD ESP,0x8                         ; 0043517c
    PUSH 0x0                            ; 0043517f
    SUB EAX,0x377b8                     ; 00435181
    PUSH EAX                            ; 00435186
    CALL core_cloth.cpp_SClothVertex_arrdtor800_FUN_00438a00 ; 00435187
        ;   XREF to: 00438a00 (UNCONDITIONAL_CALL)  ; SClothVertex * core_cloth.cpp_SClothVertex_arrdtor800_FUN_00438a00(SClothVertex * this_ptr, uint flags)
