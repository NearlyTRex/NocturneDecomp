// Name: core_cloth.cpp_CCloth_renderBone_FUN_00437ab0
// Address: 00437ab0
// Address Range: [[00437ab0, 00437cbc]]
// Convention: __cdecl
// Signature: void __cdecl core_cloth_cpp_CCloth_renderBone_FUN_00437ab0(CCloth *this_ptr,int bone_index,int show_labels)
...

{
  ...
  core_dirmat_cpp_CMatrix3x3f_getEulerAngles_FUN_0044dbd0
            (&this_ptr->collide_bones[bone_index].local_matrix,(CVector3f *)&stack0xffffffa8);
  vertex_index1 = 0;
  engine_drender_cpp_CDemonRenderer_applyScaledTransform_FUN_00460aa0
            (g_CDemonRenderer_PTR_005ae704,(CVector3f *)&stack0xffffffa8,
             &this_ptr->collide_bones[bone_index].position_offset);
  local_20 = 0x270;
  local_1c = 0;
  ...
  do {
    ...
    local_40 = (float)(fVar2 * (float10)this_ptr->collide_bones[bone_index].radius1);
    local_38 = 0.0;
    local_3c = (float)(fVar1 * (float10)this_ptr->collide_bones[bone_index].radius2);
    local_14 = pCVar3;
    ...
    local_38 = this_ptr->collide_bones[bone_index].child_distance;
