...
// Convention: unknown
// Signature: void FUN_004363e0(int param_1,int param_2,int param_3)
...

{
  ...
  bVar8 = 0;
  iVar1 = FUN_0051e0a0(param_3);
  iVar4 = param_1 + 0x37b50 + param_2 * 0xac;
  local_1c = iVar1;
  uVar2 = FUN_005179d0(iVar1,iVar4,1);
  *(uint *)(iVar4 + 0x44) = 0;
  local_18 = -1;
  *(uint *)(iVar4 + 0x40) = uVar2;
  ...
  FUN_0054e4a0(local_34,local_18 * 0xc + param_3 + 0x58);
  local_28 = 0;
  local_24 = 0;
  local_20 = 0;
  FUN_0055ae80(iVar4 + 0x48,&local_28,local_34);
  FUN_0055ae80(local_94,iVar4 + 0x1c,iVar4 + 0x28);
  FUN_0055aa00(iVar4 + 0x48,local_94);
  puVar6 = local_64;
