...

{
  ...
  if (model_ptr == (CDeformableModelInstance *)0x0) {
    ...
    core_main_c_displayErrorAndQuit_FUN_004c8440("CCloth::saveJoinedLight - Can't save light with no model!");
  }
  iVar1 = model_ptr->cached_skinned_lod_index;
  if (iVar1 < 0) {
    g_CurrentFilename = "..\\core\\cloth.cpp";
    g_CurrentLineNumber = 1256;
    core_main_c_displayErrorAndQuit_FUN_004c8440("CCloth::saveJoinedLight - Model wasn't drawn");
  }
  ...
  if (0 < (int)pCVar4) {
    ...
    do {
      ...
      iVar1 = *(int *)(pcVar5 + 0x39e7c);
      pCVar3->locked_vertex_indices[600] = g_CDemonRenderer_PTR_005ae704->vertex_buffer_ptr[iVar1].r
      ;
