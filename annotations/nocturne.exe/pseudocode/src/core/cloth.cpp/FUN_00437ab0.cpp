...

{
  ...
  do {
    ...
    local_14 = iVar6;
    engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + local_1c,&local_64);
    ...
    engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + local_20,&local_4c);
    if (0 < iVar2) {
  ...
  if (param_3 != 0) {
    ...
    shape_edittool_cpp_FUN_00472de0
              (0x01BCD074,*(float *)(iVar3 + 0x14) + *(float *)(iVar3 + 0x18),uVar1);
  }
