...

{
  ...
  if (model_ptr != (CDeformableModelInstance *)0x0) {
    ...
    if (0 < this_ptr->collide_bone_count) {
      do {
        core_cloth_cpp_CCloth_computeBoneTransform_FUN_00436580(this_ptr,iVar6,model_ptr);
        iVar6 = iVar6 + 1;
  ...
  local_90 = (g_CDemonSet_PTR_005be368->active_fog).scroll.x;
  local_8c = (g_CDemonSet_PTR_005be368->active_fog).scroll.y;
  local_88 = (g_CDemonSet_PTR_005be368->active_fog).scroll.z;
  ...
  local_d8.x = (g_CDemonSet_PTR_005be368->active_fog).scroll.x * local_d8.z;
  local_d8.y = (g_CDemonSet_PTR_005be368->active_fog).scroll.y * local_d8.z;
  local_d8.z = (g_CDemonSet_PTR_005be368->active_fog).scroll.z * local_d8.z;
  ...
  if (0 < (this_ptr->model).vertex_count) {
    ...
    do {
      ...
      if (iVar6 == 0) {
        ...
        local_19c = iVar6;
        local_7c = local_1a0;
        core_cloth_cpp_CCloth_applyConstraints_FUN_004366f0(this_ptr,pSVar11);
      }
      local_58 = local_58 + 4;
      local_44 = local_44 + 1;
  ...
  if (0 < (this_ptr->model).vertex_count) {
    ...
    do {
      ...
      iVar6 = iVar6 + 1;
      *piVar8 = (int)ROUND((pSVar11->position).x * _DAT_0059b360);
      piVar8[1] = (int)ROUND((pSVar11->position).y * _DAT_0059b360);
      piVar8[2] = (int)ROUND((pSVar11->position).z * _DAT_0059b360);
      pSVar11 = pSVar11 + 1;
      iVar7 = iVar7 + 0xc;
    } while (iVar6 < (this_ptr->model).vertex_count);
  }
