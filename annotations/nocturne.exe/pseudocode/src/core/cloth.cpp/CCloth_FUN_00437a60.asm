...
;
; Called Functions:
;   core_cloth.cpp_CCloth_FUN_00437ab0
...
section .text
    ...
    PUSH EBX                            ; 00437a60
        ;   Label: core_cloth.cpp_CCloth_FUN_00437a60
    PUSH ESI                            ; 00437a61
    ...
    PUSH EBX                            ; 00437a89
    PUSH ESI                            ; 00437a8a
    CALL core_cloth.cpp_CCloth_FUN_00437ab0 ; 00437a8b
        ;   XREF to: 00437ab0 (UNCONDITIONAL_CALL)  ; void core_cloth.cpp_CCloth_FUN_00437ab0(CCloth * this_ptr, int param_2, int param_3)
    INC EBX                             ; 00437a90
