...
// Convention: unknown
// Signature: int FUN_00435240(int param_1,undefined4 param_2)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

int FUN_00435240(int param_1,uint param_2)

{
  ...
  local_30 = FUN_00456a60("models",param_2,&DAT_0057acab);
  if (local_30 == 0) {
  ...
  iVar12 = local_30;
  FUN_00564b20(local_138,0xff,local_30);
  FUN_00563350(iVar12,&DAT_0057aced,param_1 + 0x3ab20);
  ...
  iVar12 = local_30;
  FUN_00564b20(local_138,0xff,local_30);
  FUN_00563350(iVar12,&DAT_0057ad4b,auStack_238);
  FUN_00452650(param_1,auStack_238);
  FUN_00453950(param_1);
  FUN_00564b20(local_138,0xff,iVar12);
  local_38 = param_1 + 0x37b2c;
  if (*(int *)(param_1 + 0x3ab20) < 3) {
    FUN_00563350(local_30,"%f,%f,%f,%f,%f,%f\n",param_1 + 0x37b18,param_1 + 0x37b1c,
    ...
    *(uint *)(param_1 + 0x37b34) = uVar7;
    ...
    FUN_00563350(local_30,"%f,%f,%f,%f,%f,%f,%f,%f\n",param_1 + 0x37b18,param_1 + 0x37b1c,
                 param_1 + 0x37b20,param_1 + 0x37b24,param_1 + 0x37b28,local_38,param_1 + 0x37b30,
                 param_1 + 0x37b34);
  }
  iVar12 = local_30;
  FUN_00564b20(local_138,0xff,local_30);
  FUN_00563350(iVar12,&DAT_0057ad7b,param_1 + 0x37b48);
  if (*(int *)(param_1 + 0x3ab20) < 2) {
    *(uint *)(param_1 + 0x37b44) = 0;
  }
  else {
    FUN_00564b20(local_138,0xff,iVar12);
    FUN_00563350(iVar12,&DAT_0057ad7f,param_1 + 0x37b44);
  }
  iVar12 = local_30;
  FUN_00564b20(local_138,0xff,local_30);
  FUN_00563350(iVar12,&DAT_0057ad83,param_1 + 0x39ce8);
  FUN_004351b0(param_1);
  iVar11 = 0;
  FUN_00564b20(local_138,0xff,iVar12);
  if (0 < *(int *)(param_1 + 0x39ce8)) {
    ...
    do {
      iVar11 = iVar11 + 1;
      FUN_00563350(local_30,&DAT_0057ad87,iVar12);
      iVar12 = iVar12 + 4;
    } while (iVar11 < *(int *)(param_1 + 0x39ce8));
  }
  FUN_004357b0(param_1);
  iVar12 = local_30;
  FUN_00564b20(local_138,0xff,local_30);
  FUN_00563350(iVar12,&DAT_0057ad8b,param_1 + 0x37b4c);
  iVar12 = 0;
  if (0 < *(int *)(param_1 + 0x37b4c)) {
    ...
    do {
      iVar8 = iVar12 * 0xac;
      iVar12 = iVar12 + 1;
      FUN_00563350(local_30,"\"%[^\"]\",%f,%f, %f,%f,%f, %f,%f,%f, %f\n",iVar8 + local_34,iVar11,
