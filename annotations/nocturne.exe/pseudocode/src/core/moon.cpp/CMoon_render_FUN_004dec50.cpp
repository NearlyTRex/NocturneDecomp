...

{
  ...
  *(uint *)(iVar3 + 0x15aa98) = 0x280;
  core_set_cpp_CDemonSet_setFlatColor_FUN_0050e340(iVar3,0x10000,0x10000,0x10000);
  core_dmodel_cpp_CKeyFramedModel_prepareForRender_FUN_00453040(param_1 + 8,0,0,0x205);
  iVar1 = 0x01E57284;
    ...
    do {
      if (0.0 <= *(float *)(iVar3 + 0x1ccdef0)) {
        core_course_cpp_CCourse_evaluate_FUN_0043b800
                  (*(int *)(iVar3 + 0x1ccdeec) * 0xc + 0x1ccdec8,*(uint *)(iVar3 + 0x1ccdef0),
                   &local_44,local_50);
  ...
  *(uint *)(0x01E57284 + 0x15aa88) = 0;
  ...
  fVar6 = (float10)round((float10)_DAT_01ccdec4);
  local_1c = (int)ROUND(fVar6);
  if (0x1d < local_1c) {
    local_1c = 0;
  }
  engine_alphabit_cpp_CAlphaBitmap_display_FUN_0040e710(local_1c * 0x14 + 0x1ccdc64,0,0,48000);
