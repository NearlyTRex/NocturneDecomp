...
// Convention: unknown
// Signature: void core_chain_cpp_CChain_process_FUN_0042bca0(int param_1,float param_2)
...

{
  ...
  *(float *)(param_1 + 0x568) = 1.0 / param_2;
  ...
  local_5c = pfVar6[2];
  puVar1 = (uint *)
           core_chain_cpp_CChain_getTargetBoneWorldPosition_FUN_0042b890(param_1,local_ac);
  ...
  *(uint *)(param_1 + 0x290) = *(uint *)(param_1 + 0x294);
  ...
  for (local_30 = 1; local_30 < *(int *)(param_1 + 0x150) + -1; local_30 = local_30 + 1) {
    ...
    *pfVar4 = *pfVar4 + local_94;
    ...
    local_b0 = local_b8;
    core_chain_cpp_CChain_constrainSegmentDistance_FUN_0042baa0(param_1,pfVar4,local_38);
    core_chain_cpp_CChain_constrainSegmentDistance_FUN_0042baa0(param_1,pfVar4,local_34);
    pfVar6 = pfVar6 + 9;
  ...
  do {
    ...
    *local_28 = local_28[1];
    ...
    for (; local_1c < *(int *)(param_1 + 0x150) + -1; local_1c = local_1c + 1) {
      core_chain_cpp_CChain_constrainSegmentDistance_FUN_0042baa0(param_1,iVar5,local_20);
      core_chain_cpp_CChain_constrainSegmentDistance_FUN_0042baa0(param_1,iVar5,iVar7);
      iVar5 = iVar5 + 0x24;
      local_20 = local_20 + 9;
      iVar7 = iVar7 + 0x24;
    }
  ...
  if ((local_50 != 0) && (*(char *)(param_1 + 0x1ac) != '\0')) {
    sound_sndmain_cpp_killSfx_FUN_00527230(*(uint *)(param_1 + 0x278));
    iVar5 = sound_sndmain_cpp_isSfxPlaying_FUN_00526c50(*(uint *)(param_1 + 0x210));
    if (iVar5 == 0) {
      uVar3 = core_sound_cpp_CSound_playTrackedActorSound_FUN_0052ea90
                        (0x02DC9450,param_1,param_1 + 0x1ac,
  ...
  *(float *)(param_1 + 0x27c) = *(float *)(param_1 + 0x27c) - param_2;
  ...
  iVar5 = sound_sndmain_cpp_isSfxPlaying_FUN_00526c50(*(uint *)(param_1 + 0x210));
  if (iVar5 == 0) {
    iVar5 = sound_sndmain_cpp_isSfxPlaying_FUN_00526c50(*(uint *)(param_1 + 0x278));
    if (iVar5 == 0) {
      uVar3 = core_sound_cpp_CSound_playTrackedActorSound_FUN_0052ea90
                        (0x02DC9450,param_1,param_1 + 0x214,
                         (*(int *)(param_1 + 0x150) + -1) * 0x24 + param_1 + 0x284);
      *(uint *)(param_1 + 0x278) = uVar3;
    }
  }
