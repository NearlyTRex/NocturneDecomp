...
section .text
    ...
    PUSH EBX                            ; 0042cd30
        ;   Label: core_chain.cpp_FUN_0042cd30
    ...
    PUSH EBX                            ; 0042cd44
    CALL core_chain.cpp_FUN_0042cdc0    ; 0042cd45
        ;   XREF to: 0042cdc0 (UNCONDITIONAL_CALL)  ; undefined core_chain.cpp_FUN_0042cdc0()
    ...
    PUSH EAX                            ; 0042cd88
        ;   Label: LAB_0042cd88
    CALL crt_unknown.c_FUN_00564494     ; 0042cd89
