...
// Convention: __cdecl
// Signature: undefined4 __cdecl core_motion_cpp_CMotionController_advanceFrameToExitPoint_FUN_004e1bd0(int *param_1,int param_2,float param_3,float *param_4,undefined4 *param_5)
