...
section .text
    ...
    CALL FUN_00563350                   ; 004e0a4e
        ;   XREF to: 00563350 (UNCONDITIONAL_CALL)  ; undefined FUN_00563350()
    ADD ESP,0x1c                        ; 004e0a53
    PUSH ESI                            ; 004e0a56
        ;   Label: LAB_004e0a56
    CALL FUN_00564570                   ; 004e0a57
        ;   XREF to: 00564570 (UNCONDITIONAL_CALL)  ; undefined FUN_00564570()
    ...
    CALL FUN_00563350                   ; 004e0a7c
        ;   XREF to: 00563350 (UNCONDITIONAL_CALL)  ; undefined FUN_00563350()
    ADD ESP,0x14                        ; 004e0a81
    PUSH ESI                            ; 004e0a84
        ;   Label: LAB_004e0a84
    CALL FUN_00564570                   ; 004e0a85
        ;   XREF to: 00564570 (UNCONDITIONAL_CALL)  ; undefined FUN_00564570()
    ...
    CALL FUN_00563350                   ; 004e0adb
        ;   XREF to: 00563350 (UNCONDITIONAL_CALL)  ; undefined FUN_00563350()
    ADD ESP,0x10                        ; 004e0ae0
    PUSH ESI                            ; 004e0ae3
        ;   Label: LAB_004e0ae3
    CALL FUN_00564570                   ; 004e0ae4
        ;   XREF to: 00564570 (UNCONDITIONAL_CALL)  ; undefined FUN_00564570()
    ...
    MOV dword ptr [0x01cc4800],EBX      ; 004e0cc8 | DAT_01cc4800
    MOV dword ptr [0x01cc4804],ESI      ; 004e0cce | DAT_01cc4804
    CALL FUN_004c8440                   ; 004e0cd4
    ...
    MOV [0x01cc4800],EAX                ; 004e0cf3 | DAT_01cc4800
    MOV dword ptr [0x01cc4804],EDX      ; 004e0cf8 | DAT_01cc4804
    CALL FUN_004c8440                   ; 004e0cfe
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; undefined FUN_004c8440()
