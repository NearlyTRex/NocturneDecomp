...
// Convention: __cdecl
// Signature: int __cdecl core_motion_cpp_CMotionController_advance_FUN_004e11c0(int param_1,float *param_2)
  ...
  do {
    ...
    if (*(float *)(param_1 + 0x14) < 0.0) {
      iVar3 = core_motion_cpp_CMotionController_advanceFrameToExitPoint_FUN_004e1bd0
                        (param_1,*(uint *)(param_1 + 4),*(uint *)(param_1 + 8),&local_48
                         ,local_40);
      switch(local_3c) {
      case 1:
      case 2:
...
LAB_004e12bd:
      iVar3 = core_motion_cpp_CMotionController_advanceFrameAndCheckSignals_FUN_004e1a20
                        (param_1,local_20,local_28,local_48,*(uint *)(param_1 + 0x14));
    }
    if ((bVar1) &&
       (iVar4 = core_motion_cpp_CMotionController_advanceFrameAndCheckSignals_FUN_004e1a20
                          (param_1,local_1c,local_24,local_48,1.0 - *(float *)(param_1 + 0x14)),
       iVar3 == 0)) {
      iVar3 = iVar4;
    }
    if (*(int *)(param_1 + 0x20) == 0) {
