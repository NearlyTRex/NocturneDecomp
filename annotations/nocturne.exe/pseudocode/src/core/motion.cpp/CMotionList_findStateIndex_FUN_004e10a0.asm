...
section .text
    ...
    MOV dword ptr [0x01cc4800],ESI      ; 004e10f7 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EDI      ; 004e10fd | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004e1103
