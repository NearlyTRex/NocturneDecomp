...

{
  ...
  CStack_18.x = core_actor_cpp_getRandomFloatFromRange_FUN_0040dda0(CStack_30.min.x,CStack_30.max.x)
  ;
  fStack_c = CStack_18.x;
  CStack_18.y = core_actor_cpp_getRandomFloatFromRange_FUN_0040dda0(CStack_30.min.y,CStack_30.max.y)
  ;
  fStack_c = CStack_18.y;
  CStack_18.z = core_actor_cpp_getRandomFloatFromRange_FUN_0040dda0(CStack_30.min.z,CStack_30.max.z)
  ;
