...
section .text
    ...
    PUSH EBX                            ; 00479390
        ;   Label: core_emitter.cpp_CEmitter_getRandomBoundingBoxPoint_FUN_00479390
    PUSH ESI                            ; 00479391
    ...
    CALL core_actor.cpp_getRandomFloatFromRange_FUN_0040dda0 ; 004793b5
    ...
    CALL core_actor.cpp_getRandomFloatFromRange_FUN_0040dda0 ; 004793d1
        ;   XREF to: 0040dda0 (UNCONDITIONAL_CALL)  ; undefined core_actor.cpp_getRandomFloatFromRange_FUN_0040dda0()
    ...
    CALL core_actor.cpp_getRandomFloatFromRange_FUN_0040dda0 ; 004793ed
        ;   XREF to: 0040dda0 (UNCONDITIONAL_CALL)  ; undefined core_actor.cpp_getRandomFloatFromRange_FUN_0040dda0()
