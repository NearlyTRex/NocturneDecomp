...
;
; Referenced Globals:
;   TerminatedCString s_CFilmReel_00580f73
;   TerminatedCString s_CFilmProjector_00580f7d
;
; Called Functions:
...
section .text
    ...
    PUSH 0x763e48                       ; 00481bb0
        ;   Label: core_filmreel.cpp_staticInit_FUN_00481bb0
    PUSH 0x2                            ; 00481bb5
    PUSH 0x5b8018                       ; 00481bb7
    PUSH 0x481c00                       ; 00481bbc
    PUSH 0x580f73                       ; 00481bc1 | = "CFilmReel"
    ...
    PUSH 0x580f7d                       ; 00481be4 | = "CFilmProjector"
