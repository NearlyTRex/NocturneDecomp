  ...
  if (0.0 < local_2c[0]) {
    ...
    case 100:
      ...
      if ((((pCVar4 != (CCharacter *)0x0) &&
          ...
          (pCVar9 = (*(((param_1->victim->base).vtable._uc)->_uc).getGrabber)(param_1->victim),
        ...
        fVar12 = local_c8.x - (param_1->victim->base).location.position.x;
        fVar14 = local_c8.z - (param_1->victim->base).location.position.z;
        ...
        if (ABS(local_c8.y - (pCVar4->base).location.position.y) <= (float)4) {
          if ((fVar14 < fVar12) ||
             (iVar5 = (*(((pCVar4->base).vtable._uc)->_uc).getGrabbed)
                                (pCVar4,(CDemonActor *)param_1,0), iVar5 != 0)) {
            if (fVar14 < fVar12) {
      ...
      break;
    case 0x65:
      (*(((param_1->base).base.vtable._uc)->_uc).releaseVictim)(&param_1->base);
      break;
    case 0x66:
  ...
  if (iVar7 == 0) {
    ...
    case 2:
      ...
      if (param_1->victim != (CCharacter *)0x0) {
        ...
        pCVar10 = &local_98;
        local_98.y = 0.0;
        pCVar11 = (*((param_1->victim->base).vtable._ub)->getPathMap)(&param_1->victim->base);
        iVar5 = core_charactr_cpp_CCharacter_walkToPoint_FUN_004247f0
                          (&param_1->base,&(param_1->victim->base).location.position,pCVar11,pCVar10
                           ,fVar14,max_distance);
        if (-1 < iVar5) {
          ...
          if ((local_24 <= local_20) && (param_1->attack_cooldown <= 0.0)) {
            pCVar4 = param_1->victim;
            ...
            local_14 = core_actor_cpp_normalizeAngleToPi_FUN_0040df00
                                 (local_74.y - (param_1->base).base.orient.vec.y);
          ...
          if (param_1->guard_distance < local_24) {
            core_motion_cpp_CMotionController_setDesiredState_FUN_004e16b0
                      (&(param_1->base).model.motion_controller,0,1);
          }
        }
...
LAB_005062ff:
    ...
    case 3:
      ...
      core_charactr_cpp_CCharacter_walkToPoint_FUN_004247f0
                (&param_1->base,&(param_1->victim->base).location.position,pCVar11,pCVar10,fVar12,
                 fVar14);
      pCVar4 = param_1->victim;
    ...
    case 4:
      ...
      pCVar10 = core_xform_cpp_transformVector3x4_FUN_0055a8b0
                          (&local_b0,(CVector3f *)&DAT_02dd1184,
                           (param_1->base).model.bone_transform.bone_world_matrices + _DAT_01e57220)
      ;
      pCVar10 = core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240
                          ((CDemonActor *)param_1,&local_a4,pCVar10);
      ...
      pCVar10 = core_xform_cpp_transformVector3x4_FUN_0055a8b0
                          (&local_50,(CVector3f *)&DAT_02dd1184,
                           (param_1->base).model.bone_transform.bone_world_matrices + _DAT_01e57218)
      ;
      pCVar10 = core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240
    ...
    case 9:
      ...
      break;
    case 10:
      fVar12 = *(float *)(param_1[1].base.base.actor_name + 4) - param_2;
      *(float *)(param_1[1].base.base.actor_name + 4) = fVar12;
      if (fVar12 < 0.0) {
        core_motion_cpp_CMotionController_setDesiredState_FUN_004e16b0
    ...
    case 0xf:
      ...
      if (pCVar4 == (CCharacter *)0x0) {
        ...
        (param_1->base).base.orient.vec.y = local_d4.y;
      }
    }
