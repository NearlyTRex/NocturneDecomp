// Name: core_sentinel.cpp_FUN_00506a80
// Address: 00506a80
// Address Range: [[00506a80, 00506b38]]
// Convention: unknown
// Signature: CDemonActor * core_sentinel_cpp_FUN_00506a80(CDemonActor *param_1,byte param_2)
...

{
  ...
  if ((param_2 & 4) != 0) {
    ptr = __vec_delete(param_1,&g_CSentinelTypeInfo_005a18a0);
