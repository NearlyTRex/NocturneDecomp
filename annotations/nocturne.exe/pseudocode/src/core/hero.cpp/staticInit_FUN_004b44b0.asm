...
;
; Referenced Globals:
;   TerminatedCString s_CHero_00585683
;   TerminatedCString s_CHeroPlaceholder_00585689
;
; Called Functions:
...
section .text
    ...
    PUSH 0x765a60                       ; 004b44b0
        ;   Label: core_hero.cpp_staticInit_FUN_004b44b0
    PUSH 0xc                            ; 004b44b5
    PUSH 0x5ba940                       ; 004b44b7
    PUSH 0x0                            ; 004b44bc
    PUSH 0x585683                       ; 004b44be | = "CHero"
    ...
    PUSH 0x585689                       ; 004b44e1 | = "CHeroPlaceholder"
