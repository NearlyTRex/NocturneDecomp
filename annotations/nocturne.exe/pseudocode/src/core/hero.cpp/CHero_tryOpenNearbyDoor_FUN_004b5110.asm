...
;                               FUNCTION
; *****************************************************************************
; int __cdecl core_hero_cpp_CHero_tryOpenNearbyDoor_FUN_004b5110(CHero *this_ptr)
;
; Parameters:
...
;
; XREF[6]:
;   core_colonel.cpp_CColonel_process_FUN_00439f50 at 0043a316
;   core_gabriela.cpp_CGabriella_process_FUN_00495a20 at 00496b59
;   core_haystack.cpp_CHaystack_process_FUN_004b32d0 at 004b36e3
;   core_icepick.cpp_CIcePick_process_FUN_004b9fe0 at 004ba506
;   core_stranger.cpp_CStranger_handleActionButton_FUN_0053fc60 at 0053fccf
;   core_svetlana.cpp_CSvetlana_process_FUN_00541d00 at 005421ee
;
; Referenced Globals:
;   double DOUBLE_00585843 = 5
;   double DOUBLE_0058584b = 4
;   CDemonSet* g_CDemonSet_PTR_005be368 = 01e57284
;   undefined4 g_CDoorActorType_01af4e9c.name_hash
...
section .text
    ...
    PUSH EBX                            ; 004b5110
        ;   Label: core_hero.cpp_CHero_tryOpenNearbyDoor_FUN_004b5110
    PUSH ESI                            ; 004b5111
    PUSH EDI                            ; 004b5112
    PUSH EBP                            ; 004b5113
    ...
    MOV EAX,[0x005be368]                ; 004b5132 | g_CDemonSet_PTR_005be368
        ;   Label: LAB_004b5132
    CMP ESI,dword ptr [EAX + 0x14cd6c]  ; 004b5137 | g_CDemonSet_01e57284.actor_count
    ...
    MOV EDX,dword ptr [ESP + 0x1c]      ; 004b5156
        ;   Label: LAB_004b5156
    MOV EBX,dword ptr [0x01af4ed4]      ; 004b515a | g_CDoorActorType_01af4e9c.name_hash
    ADD EAX,EDX                         ; 004b5160
    PUSH EBX                            ; 004b5162
    MOV ECX,dword ptr [EAX + 0x14cd70]  ; 004b5163 | g_CDemonSet_01e57284.actors[0]
    PUSH ECX                            ; 004b5169
    ...
    FABS                                ; 004b51c7
    FCOMP double ptr [0x00585843]       ; 004b51c9 | DOUBLE_00585843
    FNSTSW AX                           ; 004b51cf
    SAHF                                ; 004b51d1
    ...
    FCOMP double ptr [0x0058584b]       ; 004b51ed | DOUBLE_0058584b
    FNSTSW AX                           ; 004b51f3
    SAHF                                ; 004b51f5
