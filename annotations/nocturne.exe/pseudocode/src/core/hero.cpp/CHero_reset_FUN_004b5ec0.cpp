...
// Convention: unknown
// Signature: void core_hero_cpp_CHero_reset_FUN_004b5ec0(int param_1)
...

{
  ...
  *(uint *)(param_1 + 0x2590) = 0;
  core_inv_cpp_CInventory_removeMatchingKeys_FUN_004c3280
            ((CInventory *)(param_1 + 0x1f5a0),0xffffffff);
