...
;   double DOUBLE_005858b3 = 6
;   double DOUBLE_005858bb = 0.5
...
section .text
    ...
    PUSH EBX                            ; 004b5950
        ;   Label: core_hero.cpp_CHero_findItemUseTarget_FUN_004b5950
    PUSH ESI                            ; 004b5951
    PUSH EDI                            ; 004b5952
    PUSH EBP                            ; 004b5953
    ...
    MOV EAX,[0x005be368]                ; 004b5976 | g_CDemonSet_PTR_005be368
        ;   Label: LAB_004b5976
    MOV EBX,dword ptr [EBP + -0x8]      ; 004b597b
    CMP EBX,dword ptr [EAX + 0x14cd6c]  ; 004b597e | g_CDemonSet_01e57284.actor_count
    JL 0x004b59c5                       ; 004b5984
        ;   XREF to: 004b59c5 (CONDITIONAL_JUMP)  ; LAB_004b59c5
    MOV EAX,dword ptr [EBP + -0x10]     ; 004b5986
    PUSH 0x5858ab                       ; 004b5989 | = "CTrap"
    MOV EAX,dword ptr [EAX + 0x334]     ; 004b598e
    PUSH EAX                            ; 004b5994
    CALL core_actor.cpp_isOfClass_FUN_0040d7e0 ; 004b5995
    ...
    MOV EBX,dword ptr [0x014b8a54]      ; 004b59c5 | g_CActorDestinationActorType_014b8a1c.name_hash
        ;   Label: LAB_004b59c5
    PUSH EBX                            ; 004b59cb
    MOV EDX,dword ptr [EDI + EAX*0x1 + 0x14cd70] ; 004b59cc | g_CDemonSet_01e57284.actors[0]
    PUSH EDX                            ; 004b59d3
    CALL core_actor.cpp_castToClassHash_FUN_0040d890 ; 004b59d4
    ...
    PUSH EAX                            ; 004b59ee
    PUSH EBX                            ; 004b59ef
    CALL core_dest.cpp_CActorDestination_acceptsActor_FUN_0044bab0 ; 004b59f0
    ...
    PUSH EAX                            ; 004b5a08
    PUSH ESI                            ; 004b5a09
    CALL core_actor.cpp_CDemonActor_worldToLocalPoint_FUN_0040a290 ; 004b5a0a
    ...
    FCOMP double ptr [0x005858b3]       ; 004b5a27 | DOUBLE_005858b3
    FNSTSW AX                           ; 004b5a2d
    SAHF                                ; 004b5a2f
    ...
    FCOMP double ptr [0x005858bb]       ; 004b5a38 | DOUBLE_005858bb
    FNSTSW AX                           ; 004b5a3e
    SAHF                                ; 004b5a40
    JC 0x004b59b9                       ; 004b5a41
        ;   XREF to: 004b59b9 (CONDITIONAL_JUMP)  ; LAB_004b59b9
    FLD double ptr [EBP + -0x18]        ; 004b5a47
    FCOMP double ptr [0x005858c3]       ; 004b5a4a | DOUBLE_005858c3
    FNSTSW AX                           ; 004b5a50
    SAHF                                ; 004b5a52
    ...
    FABS                                ; 004b5a5c
    FCOMP double ptr [0x005858c3]       ; 004b5a5e | DOUBLE_005858c3
    FNSTSW AX                           ; 004b5a64
    SAHF                                ; 004b5a66
    ...
    PUSH EAX                            ; 004b5a74
    CALL core_vecdir.cpp_convertDirectionVectorToEulerAngles_FUN_0054e4a0 ; 004b5a75
    ...
    FCOMP double ptr [0x005858cb]       ; 004b5a82 | DOUBLE_005858cb
    FNSTSW AX                           ; 004b5a88
    SAHF                                ; 004b5a8a
