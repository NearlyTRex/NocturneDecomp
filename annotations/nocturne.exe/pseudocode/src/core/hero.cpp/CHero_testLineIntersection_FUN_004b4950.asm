...
section .text
    ...
    PUSH EBP                            ; 004b4983
    PUSH EDX                            ; 004b4984
    CALL core_actor.cpp_CDemonActor_testLineIntersection_FUN_0040a420 ; 004b4985
        ;   XREF to: 0040a420 (UNCONDITIONAL_CALL)  ; int core_actor.cpp_CDemonActor_testLineIntersection_FUN_0040a420(CDemonActor * this_ptr, CVector3f * line_start, CVector3f * line_end, CVector3f * out_intersection_point)
