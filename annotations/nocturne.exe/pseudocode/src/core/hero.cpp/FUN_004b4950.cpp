...
// Convention: unknown
// Signature: int core_hero_cpp_FUN_004b4950(CDemonActor *param_1,CVector3f *param_2,CVector3f *param_3,CVector3f *param_4)
...

{
  ...
  if ((*(int *)(0x01C775EC + 0x1d0) == 0) &&
    ...
    iVar1 = core_actor_cpp_FUN_0040a420(param_1,param_2,param_3,param_4);
    return iVar1;
  }
  return 0;
}
