...

{
  ...
  core_inv_cpp_CInventory_initialize_FUN_004bef10((CInventory *)(param_1 + 0x1f5a0));
  ...
  core_inv_cpp_CInventory_addItem_FUN_004bf360((CInventory *)(param_1 + 0x1f5a0),pCVar2,1);
  core_inv_cpp_CInventory_selectWeapon_FUN_004c0850
            ((CInventory *)(param_1 + 0x1f5a0),(CDemonActor *)0x0,5,1);
