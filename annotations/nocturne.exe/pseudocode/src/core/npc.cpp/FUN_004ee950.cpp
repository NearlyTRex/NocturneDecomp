...
// Convention: unknown
// Signature: int core_npc_cpp_FUN_004ee950(undefined4 param_1)

#include "nocturne.h"

int core_npc_cpp_FUN_004ee950(uint param_1)

{
  ...
  *(byte ***)(iVar1 + -0xbb40) = &PTR_core_npc_cpp_FUN_004ee9e0_005a0eb4;
