...

{
  ...
  iVar6 = core_charactr_cpp_FUN_004259f0(this_ptr,delta_time);
  if (iVar6 == 0) {
    return;
  }
  ...
  iVar6 = (*(((this_ptr->base).base.vtable._uc)->_uc).releaseFromGrab)(&this_ptr->base);
  if ((((1 < iVar6) && ((this_ptr->base).base.lifecycle_state == ACTOR_CREATED)) &&
  ...
  iVar6 = core_charactr_cpp_FUN_00428c00(this_ptr,delta_time);
...
LAB_004eecd2:
    ...
    if (uVar3 < 3) {
      ...
      iVar6 = core_motion_cpp_CMotionList_findStateIndex_FUN_004e10a0(this_ptr_00,pcVar8,iVar6);
...
LAB_004eeb7c:
  ...
  core_charactr_cpp_FUN_0042a150(this_ptr,delta_time);
  return;
}
