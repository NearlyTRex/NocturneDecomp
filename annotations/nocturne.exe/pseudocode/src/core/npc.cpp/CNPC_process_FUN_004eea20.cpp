...

{
  ...
  iVar6 = core_charactr_cpp_FUN_004259f0(&this_ptr->base,delta_time);
  if (iVar6 == 0) {
    return;
  }
  ...
  iVar6 = core_charactr_cpp_FUN_00428c00(&this_ptr->base,delta_time);
...
LAB_004eeb7c:
  ...
  core_charactr_cpp_FUN_0042a150(&this_ptr->base,delta_time);
  return;
}
