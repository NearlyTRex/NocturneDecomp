...
section .text
    ...
    PUSH EBX                            ; 004eea32
    CALL core_charactr.cpp_CCharacter_process_FUN_004259f0 ; 004eea33
    ...
    CALL core_charactr.cpp_CCharacter_processWalking_FUN_00428c00 ; 004eeb2a
    ...
    PUSH EBX                            ; 004eec5f
    CALL core_charactr.cpp_CCharacter_applyGestureLookAt_FUN_0042a150 ; 004eec60
