// Name: core_npc.cpp_CNPC_ctor_FUN_004ee950
// Address: 004ee950
// Address Range: [[004ee950, 004ee9d9]]
// Convention: __cdecl
// Signature: CNPC * __cdecl core_npc_cpp_CNPC_ctor_FUN_004ee950(CNPC *this_ptr)
...

{
  ...
  pCVar2[-1].height_cache[0x50][0x1b] = (int)&g_CNPCVTable;
  ...
  core_skeleton_cpp_CDeformableModelInstance_init_FUN_0051e0c0
            ((CDeformableModelInstance *)(pCVar2[-1].height_cache[0x50] + 0x1c),
             "priest.dfm");
  pCVar2[-1].height_cache_tags[3][0x53] = 0;
  pCVar2[1].current_position.x = 0.0;
  pCVar2[1].current_position.y = 0.0;
  return (CNPC *)(pCVar2[-1].height_cache[0x4f] + 0x2c);
}
