...
section .text
    ...
    PUSH EBX                            ; 00511aa0
        ;   Label: core_setcolid.cpp_FUN_00511aa0
    ...
    PUSH EBX                            ; 00511af4
    PUSH 0x1fba938                      ; 00511af5 | DAT_01fba938
    CALL core_dtrace.cpp_FUN_0046bd90   ; 00511afa
        ;   XREF to: 0046bd90 (UNCONDITIONAL_CALL)  ; undefined core_dtrace.cpp_FUN_0046bd90()
