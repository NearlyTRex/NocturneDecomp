...
;
; XREF[38]:
;   core_actor.cpp_CDemonActor_cylinderGroundCheck_FUN_0040a140 at 0040a166
...
;   core_actor.cpp_CDemonActor_processMeleeHit_FUN_0040b300 at 0040b7da
;   core_boneguy.cpp_CBoneGuy_process_FUN_00418a00 at 00418ec2
...
;   core_crossbow.cpp_CCrossbow_fire_FUN_0043d1c0 at 0043d330
...
section .text
    ...
    MOV dword ptr [0x01cc4800],EDI      ; 005117c6 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EBP      ; 005117cc | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 005117d2
