...
;
; XREF[2]:
;   core_bodypart.cpp_CBodyPart_process_FUN_004168d0 at 00416ad6
;   core_boxactor.cpp_CBoxActor_process_FUN_0041e5e0 at 0041e9ef
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 00511880
        ;   Label: core_setcolid.cpp_CDemonSet_notifyDamageListeners_FUN_00511880
    PUSH ESI                            ; 00511881
    PUSH EBP                            ; 00511882
