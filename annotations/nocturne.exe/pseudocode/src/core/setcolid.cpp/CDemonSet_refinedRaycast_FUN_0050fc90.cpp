// Name: core_setcolid.cpp_CDemonSet_refinedRaycast_FUN_0050fc90
// Address: 0050fc90
// Address Range: [[0050fc90, 0050fdcc]]
// Convention: __cdecl
// Signature: float __cdecl core_setcolid_cpp_CDemonSet_refinedRaycast_FUN_0050fc90(CDemonSet *this_ptr)
...

{
  ...
  if (this_ptr->raycast_distance < this_ptr->voxel_distance) {
    ...
    if (this_ptr->raycast_distance <= 1.0) {
      ...
      if (&this_ptr->collision_impact_position != (CVector3f *)afStack_30) {
