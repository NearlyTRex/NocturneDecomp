...
;
; XREF[4]:
;   core_gabriela.cpp_CGabriella_updateClavicleCollisionAvoidance_FUN_004998c0 at 0049997b
;   core_sound.cpp_CSound_process_FUN_0052dff0 at 0052e2dc
;   core_sound.cpp_processTrainSounds_FUN_0052d790 at 0052d7e6
