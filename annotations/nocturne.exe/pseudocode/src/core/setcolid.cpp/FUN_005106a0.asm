...
;                               FUNCTION
; *****************************************************************************
; void core_setcolid_cpp_FUN_005106a0(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,undefined4 param_5)
;
; Local Variables:
...
section .text
    ...
    PUSH EBX                            ; 005106a0
        ;   Label: core_setcolid.cpp_FUN_005106a0
    PUSH ESI                            ; 005106a1
    PUSH EDI                            ; 005106a2
    PUSH EBP                            ; 005106a3
