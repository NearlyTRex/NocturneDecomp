...
;   core_fire.cpp_CFireEffect_traceLaser_FUN_0048b6f0 at 0048bd16
;   core_lightgun.cpp_CLightGun_canSeeTarget_FUN_004c70a0 at 004c7186
;   core_lightgun.cpp_CLightGun_fire_FUN_004c71a0 at 004c73d3
;
; Referenced Globals:
...
section .text
    ...
    MOV dword ptr [0x01cc4800],ECX      ; 00511714 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],ESI      ; 0051171a | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 00511720
