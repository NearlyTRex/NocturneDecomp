...
// Convention: unknown
// Signature: float core_setcolid_cpp_CDemonSet_testCylinderCollision_FUN_00510a40(CDemonSet *param_1,float param_2,float param_3,float param_4,float param_5,float param_6,float param_7,float param_8)
...

{
  ...
  *(char *)((int)(pacVar8 + 0x13) + 0x1b) = '\0';
  if (-1 < (int)fVar1) {
    ...
    local_f0.ray_query.ray_type = (int)param_1->vdir_boxes[0xeb].rotation_matrix.m[0].x;
    local_f0.ray_query.laser_type = (int)param_1->vdir_boxes[0xeb].rotation_matrix.m[0].y;
    local_f0.ray_query.laser_color.r = (int)param_1->vdir_boxes[0xeb].rotation_matrix.m[0].z;
    local_f0.ray_query.laser_color.g = (int)param_1->vdir_boxes[0xeb].rotation_matrix.m[1].x;
    local_f0.ray_query.laser_color.b = (int)param_1->vdir_boxes[0xeb].rotation_matrix.m[1].y;
    local_14 = 0;
            ...
            if ((CDeformableModelInstance *)local_f0.keyframed_model ==
              ...
              if (bounding_box_type < COLLISION_TYPE_CYLINDER) {
                if (bounding_box_type == COLLISION_TYPE_MESH) {
                  ...
                  position = &(actor->base).base.location.position;
                  ...
                  iVar11 = core_setcolid_cpp_CDemonSet_testOBBCylinderCollision_FUN_00510710
                                     (param_1,&local_14c,pCVar10,position,orientation_matrix);
                  if (iVar11 != 0) {
...
LAB_0051133f:
                ...
                afStack_74[0] = local_14c.dir_x;
                afStack_74[2] = local_14c.dir_z;
                afStack_74[1] = 0.0;
                core_actor_cpp_CDemonActor_inverseTransformVector_FUN_0040a220
                          (actor,afStack_5c,afStack_74);
                core_dtrace_cpp_initIntersectionCylinder_FUN_00468a20
                          (&SStack_1a8,CStack_80.x,CStack_80.z,afStack_5c[0],fStack_54,param_6,
                           param_7 - (actor->base).base.location.position.y,
                           param_8 - (actor->base).base.location.position.y);
                ...
                if (SStack_1a8.closest_t < local_14c.closest_t) {
                  ...
                  pfVar12 = (float *)core_actor_cpp_CDemonActor_transformVector_FUN_0040a200
                                               (actor,auStack_50,&SStack_1a8.push_normal);
                  if (&local_14c.push_normal != (CVector3f *)pfVar12) {
                    local_14c.push_normal.x = *pfVar12;
                    local_14c.push_normal.y = pfVar12[1];
                    local_14c.push_normal.z = pfVar12[2];
                  }
                  *(CWayPoint **)(param_1->lights[199].filter_names[0x13] + 0x18) = actor;
                }
              }
              ...
              core_dtrace_cpp_initIntersectionCylinder_FUN_00468a20
                        (&SStack_204,local_14c.center_x - (actor->base).base.location.position.x,
                         ...
                         ,local_14c.dir_z,param_6,param_7 - (actor->base).base.location.position.y,
                         param_8 - (actor->base).base.location.position.y);
              SStack_204.closest_t = local_14c.closest_t;
              core_dmodel_cpp_CKeyFramedModel_intersectCylinder_FUN_00453e10
                        (this_ptr,0,&SStack_204,&(actor->base).base.orient.vec);
        ...
        local_14 = local_14 + 1;
      } while (local_14 < (int)param_1->waypoints[0x6d6]);
    }
  }
  if (local_14c.closest_t <= 1.0) {
    ...
    pcVar13 = param_1->lights[199].filter_names[0x12] + 0x24;
    if ((CVector3f *)pcVar13 != &local_14c.push_normal) {
      *(float *)pcVar13 = local_14c.push_normal.x;
      *(float *)param_1->lights[199].filter_names[0x13] = local_14c.push_normal.y;
      *(float *)(param_1->lights[199].filter_names[0x13] + 4) = local_14c.push_normal.z;
