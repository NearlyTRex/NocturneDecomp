...
;
; XREF[2]:
;   core_manpuz.cpp_CMansionPuzzleCircle_customIntersectCylinderXZ_FUN_004ca240 at 004ca2cc
...
section .text
    ...
    PUSH EBX                            ; 00510710
        ;   Label: core_setcolid.cpp_CDemonSet_testOBBCylinderCollision_FUN_00510710
    PUSH ESI                            ; 00510711
    PUSH EDI                            ; 00510712
    PUSH EBP                            ; 00510713
    ...
    PUSH EAX                            ; 00510763
    PUSH EBP                            ; 00510764
    CALL core_dirmat.cpp_CMatrix3x3f_transformVector_FUN_0044da40 ; 00510765
