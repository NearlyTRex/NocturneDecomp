...
;   core_stranger.cpp_CStranger_tryPlaceObject_FUN_0053c800 at 0053cdce
...
section .text
    ...
    PUSH EBX                            ; 00510a40
        ;   Label: core_setcolid.cpp_CDemonSet_testCylinderCollision_FUN_00510a40
    PUSH ESI                            ; 00510a41
    PUSH EDI                            ; 00510a42
    PUSH EBP                            ; 00510a43
    ...
    CALL core_dtrace.cpp_initIntersectionCylinder_FUN_00468a20 ; 00510a6f
        ;   XREF to: 00468a20 (UNCONDITIONAL_CALL)  ; void core_dtrace.cpp_initIntersectionCylinder_FUN_00468a20(SIntersectXZCylinder * this_ptr, float start_x, float start_z, float dir_x, ...)
    ...
    CALL core_dmodel.cpp_CKeyFramedModel_intersectCylinder_FUN_00453e10 ; 00510e27
        ;   XREF to: 00453e10 (UNCONDITIONAL_CALL)  ; void core_dmodel.cpp_CKeyFramedModel_intersectCylinder_FUN_00453e10(CKeyFramedModel * this_ptr, int frame_index, SIntersectXZCylinder * cylinder, CVector3f * transform_vector)
