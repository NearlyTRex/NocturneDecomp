// Name: core_hotdemon.cpp_FUN_004b99d0
// Address: 004b99d0
// Address Range: [[004b99d0, 004b9a88]]
// Convention: unknown
// Signature: int core_hotdemon_cpp_FUN_004b99d0(int param_1,byte param_2)
...

{
  ...
  if ((param_2 & 4) != 0) {
    uVar2 = __vec_delete(param_1,&g_CHotDemonTypeInfo_0059f220);
