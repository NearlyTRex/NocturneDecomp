...
// Convention: __cdecl
// Signature: CHotDemon * __cdecl core_hotdemon_cpp_CHotDemon_dtor_FUN_004b99d0(CHotDemon *this_ptr,uint flags)
...

{
  ...
  if ((flags & 4) != 0) {
    ptr_00 = __vec_delete(this_ptr,&g_CHotDemonTypeInfo_0059f220);
