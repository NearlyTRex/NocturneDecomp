...
;                               FUNCTION
; *****************************************************************************
; void core_vampboss_cpp_FUN_0054dd50(int param_1,int param_2)
;
; Local Variables:
...
section .text
    ...
    PUSH EBX                            ; 0054dd50
        ;   Label: core_vampboss.cpp_FUN_0054dd50
    PUSH ESI                            ; 0054dd51
    PUSH EDI                            ; 0054dd52
    PUSH EBP                            ; 0054dd53
    ...
    MOV EAX,[0x01cc56dc]                ; 0054de88 | g_CMeleeActorType_01cc56a4.name_hash
    PUSH EAX                            ; 0054de8d
    ...
    MOV ECX,dword ptr [0x01cae124]      ; 0054dee2 | g_CHeroActorType_01cae0ec.name_hash
    PUSH ECX                            ; 0054dee8
    PUSH EDI                            ; 0054dee9
