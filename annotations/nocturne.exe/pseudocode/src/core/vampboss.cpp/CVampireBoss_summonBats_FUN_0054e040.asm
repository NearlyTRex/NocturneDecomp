...
;   core_tvbat.cpp_CTVBat_orderAttack_FUN_0054bfc0
;
; *****************************************************************************
...
section .text
    ...
    JZ 0x0054e09b                       ; 0054e090
        ;   XREF to: 0054e09b (CONDITIONAL_JUMP)  ; LAB_0054e09b
    PUSH EAX                            ; 0054e092
    CALL core_tvbat.cpp_CTVBat_orderAttack_FUN_0054bfc0 ; 0054e093
        ;   XREF to: 0054bfc0 (UNCONDITIONAL_CALL)  ; void core_tvbat.cpp_CTVBat_orderAttack_FUN_0054bfc0(CTVBat * this_ptr)
