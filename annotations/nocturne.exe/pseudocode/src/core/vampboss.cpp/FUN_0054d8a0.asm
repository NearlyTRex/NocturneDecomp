...
section .text
    ...
    PUSH EBX                            ; 0054d8a0
        ;   Label: core_vampboss.cpp_FUN_0054d8a0
    PUSH EDI                            ; 0054d8a1
    PUSH EBP                            ; 0054d8a2
    ...
    PUSH EAX                            ; 0054d951
    CALL core_xform.cpp_buildMatrixFromEulerAndPositionDirect_FUN_0055afb0 ; 0054d952
    ...
    CALL core_xform.cpp_multiplyMatrix3x4_FUN_0055aa00 ; 0054d981
