...
section .text
    ...
    PUSH EBX                            ; 0054c3e0
        ;   Label: core_vampboss.cpp_CVampireBoss_setup_FUN_0054c3e0
    PUSH ESI                            ; 0054c3e1
    PUSH EDI                            ; 0054c3e2
    PUSH EBP                            ; 0054c3e3
    ...
    PUSH EBX                            ; 0054c3eb
    CALL core_enemy.cpp_CEnemy_setup_FUN_004796b0 ; 0054c3ec
    ...
    PUSH EDI                            ; 0054c3fa
    CALL core_skeleton.cpp_CDeformableModelInstance_preCache_FUN_0051dcd0 ; 0054c3fb
    ...
    PUSH EBP                            ; 0054c409
    CALL core_skeleton.cpp_CDeformableModelInstance_preCache_FUN_0051dcd0 ; 0054c40a
        ;   XREF to: 0051dcd0 (UNCONDITIONAL_CALL)  ; void core_skeleton.cpp_CDeformableModelInstance_preCache_FUN_0051dcd0(CDeformableModelInstance * this_ptr)
    ...
    CALL core_cloth.cpp_CCloth_load_FUN_00435240 ; 0054c422
    ...
    PUSH EAX                            ; 0054c43b
    CALL core_cloth.cpp_CCloth_setup_FUN_004359e0 ; 0054c43c
    ...
    CALL core_cloth.cpp_CCloth_load_FUN_00435240 ; 0054c454
        ;   XREF to: 00435240 (UNCONDITIONAL_CALL)  ; int core_cloth.cpp_CCloth_load_FUN_00435240(CCloth * this_ptr, char * filename)
    ...
    PUSH EAX                            ; 0054c467
    CALL core_cloth.cpp_CCloth_setup_FUN_004359e0 ; 0054c468
        ;   XREF to: 004359e0 (UNCONDITIONAL_CALL)  ; void core_cloth.cpp_CCloth_setup_FUN_004359e0(CCloth * this_ptr, CVector3f * position, CVector3f * euler, CDeformableModelInstance * model_ptr)
    ...
    CALL core_cloth.cpp_CCloth_load_FUN_00435240 ; 0054c480
        ;   XREF to: 00435240 (UNCONDITIONAL_CALL)  ; int core_cloth.cpp_CCloth_load_FUN_00435240(CCloth * this_ptr, char * filename)
    ...
    PUSH ESI                            ; 0054c493
    CALL core_cloth.cpp_CCloth_setup_FUN_004359e0 ; 0054c494
        ;   XREF to: 004359e0 (UNCONDITIONAL_CALL)  ; void core_cloth.cpp_CCloth_setup_FUN_004359e0(CCloth * this_ptr, CVector3f * position, CVector3f * euler, CDeformableModelInstance * model_ptr)
    ADD ESP,0x10                        ; 0054c499
    PUSH EDI                            ; 0054c49c
    CALL core_skeleton.cpp_CDeformableModelInstance_resetToRestPose_FUN_0051b800 ; 0054c49d
    ...
    PUSH EDI                            ; 0054c4a5
    CALL core_skeleton.cpp_CDeformableModelInstance_computeBoneTransforms_FUN_0051d3c0 ; 0054c4a6
    ...
    PUSH EBP                            ; 0054c4ae
    CALL core_skeleton.cpp_CDeformableModelInstance_resetToRestPose_FUN_0051b800 ; 0054c4af
        ;   XREF to: 0051b800 (UNCONDITIONAL_CALL)  ; void core_skeleton.cpp_CDeformableModelInstance_resetToRestPose_FUN_0051b800(CDeformableModelInstance * this_ptr)
    ADD ESP,0x4                         ; 0054c4b4
    PUSH EBP                            ; 0054c4b7
    CALL core_skeleton.cpp_CDeformableModelInstance_computeBoneTransforms_FUN_0051d3c0 ; 0054c4b8
        ;   XREF to: 0051d3c0 (UNCONDITIONAL_CALL)  ; void core_skeleton.cpp_CDeformableModelInstance_computeBoneTransforms_FUN_0051d3c0(CDeformableModelInstance * this_ptr)
    ...
    CALL core_morph.cpp_CMorph_setupModelFromDeformable_FUN_004e0170 ; 0054c4d0
    ...
    PUSH 0x0                            ; 0054c4df
    PUSH ESI                            ; 0054c4e1
    CALL core_morph.cpp_CMorph_addPartFromKeyframedModel_FUN_004e02c0 ; 0054c4e2
        ;   XREF to: 004e02c0 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_CMorph_addPartFromKeyframedModel_FUN_004e02c0(CMorph * this_ptr, int model_index, CKeyFramedModel * model_ptr, int frame_index)
    ...
    CALL core_morph.cpp_CMorph_addPartFromKeyframedModel_FUN_004e02c0 ; 0054c4ff
        ;   XREF to: 004e02c0 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_CMorph_addPartFromKeyframedModel_FUN_004e02c0(CMorph * this_ptr, int model_index, CKeyFramedModel * model_ptr, int frame_index)
    ...
    CALL core_morph.cpp_CMorph_addPartFromKeyframedModel_FUN_004e02c0 ; 0054c517
        ;   XREF to: 004e02c0 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_CMorph_addPartFromKeyframedModel_FUN_004e02c0(CMorph * this_ptr, int model_index, CKeyFramedModel * model_ptr, int frame_index)
    ...
    CALL core_morph.cpp_CMorph_addPartFromKeyframedModel_FUN_004e02c0 ; 0054c533
        ;   XREF to: 004e02c0 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_CMorph_addPartFromKeyframedModel_FUN_004e02c0(CMorph * this_ptr, int model_index, CKeyFramedModel * model_ptr, int frame_index)
    ...
    CALL core_morph.cpp_CMorph_setupModelFromDeformable_FUN_004e0170 ; 0054c547
        ;   XREF to: 004e0170 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_CMorph_setupModelFromDeformable_FUN_004e0170(CMorph * this_ptr, int model_index, CDeformableModelInstance * model_ptr)
    ...
    PUSH 0x1                            ; 0054c556
    PUSH ESI                            ; 0054c558
    CALL core_morph.cpp_CMorph_addPartFromKeyframedModel_FUN_004e02c0 ; 0054c559
        ;   XREF to: 004e02c0 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_CMorph_addPartFromKeyframedModel_FUN_004e02c0(CMorph * this_ptr, int model_index, CKeyFramedModel * model_ptr, int frame_index)
    ...
    CALL core_morph.cpp_CMorph_addPartFromKeyframedModel_FUN_004e02c0 ; 0054c575
        ;   XREF to: 004e02c0 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_CMorph_addPartFromKeyframedModel_FUN_004e02c0(CMorph * this_ptr, int model_index, CKeyFramedModel * model_ptr, int frame_index)
    ADD ESP,0x10                        ; 0054c57a
    XOR EAX,EAX                         ; 0054c57d
    PUSH ESI                            ; 0054c57f
    MOV [0x01cd4314],EAX                ; 0054c580 | DAT_01cd4314
    CALL core_morph.cpp_CMorph_getReady_FUN_004e03c0 ; 0054c585
        ;   XREF to: 004e03c0 (UNCONDITIONAL_CALL)  ; void core_morph.cpp_CMorph_getReady_FUN_004e03c0(CMorph * this_ptr)
    ADD ESP,0x4                         ; 0054c58a
    PUSH EDI                            ; 0054c58d
    CALL core_skeleton.cpp_CDeformableModelInstance_updateAnimationAndTransforms_FUN_0051b880 ; 0054c58e
    ...
    PUSH EBP                            ; 0054c596
    CALL core_skeleton.cpp_CDeformableModelInstance_updateAnimationAndTransforms_FUN_0051b880 ; 0054c597
        ;   XREF to: 0051b880 (UNCONDITIONAL_CALL)  ; void core_skeleton.cpp_CDeformableModelInstance_updateAnimationAndTransforms_FUN_0051b880(CDeformableModelInstance * this_ptr)
    ADD ESP,0x4                         ; 0054c59c
    PUSH EDI                            ; 0054c59f
    MOV dword ptr [EBX + 0xfc],0x1      ; 0054c5a0
    CALL core_skeleton.cpp_CDeformableModelInstance_getSkeletonPtr_FUN_0051e0a0 ; 0054c5aa
    ...
    PUSH EAX                            ; 0054c5b9
    CALL core_skeleton.cpp_CSkeleton_findBone_FUN_005179d0 ; 0054c5ba
