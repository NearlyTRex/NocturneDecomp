...
;   undefined4 DAT_005970e5
;   undefined4 DAT_005970ed
;   undefined4 DAT_005970f5
;   undefined4 DAT_005970fd
;   undefined4 DAT_00597105
;   undefined4 DAT_0059710d
;   undefined4 DAT_00597115
;   ... and 17 more
;
; Called Functions:
;   FUN_0040a000
...
section .text
    ...
    PUSH EBX                            ; 0054c6e1
    CALL FUN_0054d9c0                   ; 0054c6e2
        ;   XREF to: 0054d9c0 (UNCONDITIONAL_CALL)  ; undefined FUN_0054d9c0()
    ADD ESP,0x8                         ; 0054c6e7
    LEA ESI,[EBX + 0xbd24]              ; 0054c6ea
    PUSH ESI                            ; 0054c6f0
    CALL FUN_0051b880                   ; 0054c6f1
    ...
    JZ 0x0054c762                       ; 0054c743
        ;   XREF to: 0054c762 (CONDITIONAL_JUMP)  ; LAB_0054c762
    PUSH EBX                            ; 0054c745
    CALL FUN_0054e230                   ; 0054c746
        ;   XREF to: 0054e230 (UNCONDITIONAL_CALL)  ; undefined FUN_0054e230()
    ...
    FCOMP double ptr [0x005970ed]       ; 0054c7c6 | DAT_005970ed
    FNSTSW AX                           ; 0054c7cc
    SAHF                                ; 0054c7ce
    ...
    FCOMP double ptr [0x005970f5]       ; 0054c7e6 | DAT_005970f5
    FNSTSW AX                           ; 0054c7ec
    SAHF                                ; 0054c7ee
    ...
    FLD float ptr [ESP]                 ; 0054c852
        ;   Label: LAB_0054c852
    FCOMP double ptr [0x005970fd]       ; 0054c855 | DAT_005970fd
    FNSTSW AX                           ; 0054c85b
    SAHF                                ; 0054c85d
    ...
    FCOMP double ptr [0x00597105]       ; 0054c8d2 | DAT_00597105
    FNSTSW AX                           ; 0054c8d8
    SAHF                                ; 0054c8da
    ...
    FADD float ptr [0x0059711d]         ; 0054c9db | DAT_0059711d
    ...
    FCOMP double ptr [0x005970e5]       ; 0054cb51 | DAT_005970e5
    FNSTSW AX                           ; 0054cb57
    SAHF                                ; 0054cb59
    ...
    PUSH EAX                            ; 0054cc3e
    CALL FUN_0051ef40                   ; 0054cc3f
        ;   XREF to: 0051ef40 (UNCONDITIONAL_CALL)  ; undefined FUN_0051ef40()
    ...
    FADDP                               ; 0054cd00
    FSQRT                               ; 0054cd02
    FCOMP double ptr [0x00597115]       ; 0054cd04 | DAT_00597115
    FNSTSW AX                           ; 0054cd0a
    SAHF                                ; 0054cd0c
    ...
    FADDP                               ; 0054cd8b
    FSQRT                               ; 0054cd8d
    FCOMP double ptr [0x0059710d]       ; 0054cd8f | DAT_0059710d
    FNSTSW AX                           ; 0054cd95
    SAHF                                ; 0054cd97
    ...
    PUSH EBX                            ; 0054cd9e
        ;   Label: LAB_0054cd9e
    CALL FUN_0054e1e0                   ; 0054cd9f
        ;   XREF to: 0054e1e0 (UNCONDITIONAL_CALL)  ; undefined FUN_0054e1e0()
    ...
    FDIV float ptr [0x005a3a7c]         ; 0054cdc7 | DAT_005a3a7c
    ...
    PUSH EAX                            ; 0054ceca
    CALL FUN_00436e50                   ; 0054cecb
        ;   XREF to: 00436e50 (UNCONDITIONAL_CALL)  ; undefined FUN_00436e50()
    ADD ESP,0x18                        ; 0054ced0
    LEA EAX,[ESP + 0xfc]                ; 0054ced3
    PUSH EAX                            ; 0054ceda
    PUSH ESI                            ; 0054cedb
    CALL FUN_0051ef40                   ; 0054cedc
        ;   XREF to: 0051ef40 (UNCONDITIONAL_CALL)  ; undefined FUN_0051ef40()
    ...
    FDIV float ptr [0x005a3a7c]         ; 0054cf75 | DAT_005a3a7c
    ...
    PUSH EBX                            ; 0054cfe6
    CALL FUN_0054d9c0                   ; 0054cfe7
        ;   XREF to: 0054d9c0 (UNCONDITIONAL_CALL)  ; undefined FUN_0054d9c0()
    ADD ESP,0x8                         ; 0054cfec
    LEA ESI,[EBX + 0xbd24]              ; 0054cfef
    PUSH ESI                            ; 0054cff5
    CALL FUN_0051b880                   ; 0054cff6
        ;   XREF to: 0051b880 (UNCONDITIONAL_CALL)  ; undefined FUN_0051b880()
    ...
    PUSH EAX                            ; 0054d0aa
    CALL FUN_00436e50                   ; 0054d0ab
        ;   XREF to: 00436e50 (UNCONDITIONAL_CALL)  ; undefined FUN_00436e50()
    ADD ESP,0x18                        ; 0054d0b0
    LEA EAX,[ESP + 0x9c]                ; 0054d0b3
    PUSH EAX                            ; 0054d0ba
    PUSH ESI                            ; 0054d0bb
    CALL FUN_0051ef40                   ; 0054d0bc
        ;   XREF to: 0051ef40 (UNCONDITIONAL_CALL)  ; undefined FUN_0051ef40()
    ...
    PUSH ESI                            ; 0054d121
    CALL FUN_0041cc00                   ; 0054d122
        ;   XREF to: 0041cc00 (UNCONDITIONAL_CALL)  ; undefined FUN_0041cc00()
    ADD ESP,0x8                         ; 0054d127
    LEA EAX,[ESP + 0x90]                ; 0054d12a
    PUSH EAX                            ; 0054d131
    PUSH ESI                            ; 0054d132
    CALL FUN_0041cc00                   ; 0054d133
        ;   XREF to: 0041cc00 (UNCONDITIONAL_CALL)  ; undefined FUN_0041cc00()
    ...
    PUSH EBX                            ; 0054d1a8
    CALL FUN_0054e0b0                   ; 0054d1a9
        ;   XREF to: 0054e0b0 (UNCONDITIONAL_CALL)  ; undefined FUN_0054e0b0()
    ...
    JMP dword ptr [EAX*0x4 + 0x54c664]  ; 0054d232 | caseD_0 | caseD_9 | caseD_2
        ;   Label: switchD
    FLD float ptr [0x005a3a84]          ; 0054d239 | DAT_005a3a84
        ;   Label: caseD_0
    ...
    PUSH EBX                            ; 0054d280
        ;   Label: LAB_0054d280
    CALL FUN_0054e1a0                   ; 0054d281
        ;   XREF to: 0054e1a0 (UNCONDITIONAL_CALL)  ; undefined FUN_0054e1a0()
    ...
    FXCH                                ; 0054d2be
    FMUL double ptr [0x0059712d]        ; 0054d2c0 | DAT_0059712d
    FXCH                                ; 0054d2c6
    ...
    PUSH EBX                            ; 0054d3b1
        ;   Label: LAB_0054d3b1
    CALL FUN_0054e040                   ; 0054d3b2
        ;   XREF to: 0054e040 (UNCONDITIONAL_CALL)  ; undefined FUN_0054e040()
    ...
    FDIV float ptr [0x005a3a88]         ; 0054d5f8 | DAT_005a3a88
    FADD float ptr [EBX + 0x2434]       ; 0054d5fe
    FST float ptr [EBX + 0x2434]        ; 0054d604
    FCOMP double ptr [0x00597125]       ; 0054d60a | DAT_00597125
    FNSTSW AX                           ; 0054d610
    SAHF                                ; 0054d612
    ...
    LEA EAX,[EBX + 0xbedc4]             ; 0054d7f3
        ;   Label: LAB_0054d7f3
    FLD float ptr [0x005a3a80]          ; 0054d7f9 | DAT_005a3a80
    PUSH EAX                            ; 0054d7ff
