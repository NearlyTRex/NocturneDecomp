...
// Convention: unknown
// Signature: void core_vampboss_cpp_FUN_0054dd50(int param_1,int param_2)
  ...
  if (*(int *)(param_1 + 0xbe168) == 0) {
    if ((*(int *)(param_2 + 0x28) == 1) &&
       (iVar2 = core_actor_cpp_castToClassHash_FUN_0040d890
                          (*(uint *)(param_2 + 0x34),g_CMeleeActorType_01cc56a4.name_hash),
       iVar2 != 0)) {
      ...
      if (iVar3 != 0) {
        ...
        iVar3 = core_actor_cpp_castToClassHash_FUN_0040d890
                          (iVar3,g_CHeroActorType_01cae0ec.name_hash);
        if (iVar3 != 0) {
