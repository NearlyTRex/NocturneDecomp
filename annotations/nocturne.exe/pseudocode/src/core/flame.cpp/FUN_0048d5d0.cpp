...
// Convention: unknown
// Signature: undefined4 core_flame_cpp_FUN_0048d5d0(int param_1)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint core_flame_cpp_FUN_0048d5d0(int param_1)

{
  ...
  if (((*(int *)(param_1 + 0x1ac) != 0) || (*(int *)(0x01CC9450 + 4) != 0)) &&
    ...
    if ((*(int *)(param_1 + 0x288) != 0) && (*(int *)(param_1 + 0x1a0) != 3)) {
      ...
      if (0 < iStack_14) {
        do {
          ...
          engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704,&iStack_6c);
          ...
          engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x60,&iStack_cc);
          fStack_38 = 0.0;
          ...
          engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x90,&iStack_48);
    ...
    if ((*(int *)(param_1 + 0x1a0) == 1) &&
      ...
      fStack_b0 = fStack_b4;
      engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704,&iStack_d8);
      fStack_b4 = -fStack_b4;
      ...
      engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x30,&iStack_78);
      fStack_b0 = -fStack_b0;
      ...
      engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x60,aiStack_a8 + 3);
      fStack_b4 = -fStack_b4;
      ...
      engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 0x90,&iStack_60);
      iStack_10 = 0;
      do {
