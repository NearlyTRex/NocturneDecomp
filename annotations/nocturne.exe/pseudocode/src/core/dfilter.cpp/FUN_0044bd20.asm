...
;
; XREF[2]:
;   FUN_005151f0 at 005152d1
;   FUN_00515710 at 005157a3
;
; Referenced Globals:
...
section .text
    ...
    PUSH EAX                            ; 0044bda3
    CALL FUN_0044beb0                   ; 0044bda4
        ;   XREF to: 0044beb0 (UNCONDITIONAL_CALL)  ; undefined FUN_0044beb0()
