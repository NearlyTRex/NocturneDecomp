...
// Convention: unknown
// Signature: void core_stranger_cpp_FUN_005384d0(int param_1)
...

{
  ...
  if ((0.0 < local_1f08) && (-1 < *(int *)(param_1 + 0x1faec))) {
    ...
    core_skeleton_cpp_CDeformableModelInstance_blendWithPoseData_FUN_0051cab0
              (param_1 + 0x150,local_1ecc,local_1f08,0xffffffff,core_skeleton_cpp_FUN_0051b650);
  }
  ...
  if (iVar3 == 0x15) {
    ...
    core_skeleton_cpp_CDeformableModelInstance_applyRotationToHierarchy_FUN_0051d7a0
              (local_18,local_380 + 8,local_1ee0,_DAT_02dc9f94,core_skeleton_cpp_FUN_0051b650);
...
LAB_00538745:
    ...
    *puVar9 = *puVar7;
    ...
    local_18 = (float)(param_1 + 0x150);
    core_skeleton_cpp_CDeformableModelInstance_applyRotationToHierarchy_FUN_0051d7a0
              (param_1 + 0x150,auStack_23c + 3,local_1ef4,_DAT_02dc9f60,
    ...
    if (iVar3 != 0x16) {
      if (iVar3 == 0x1f) {
        ...
        if (local_24 < 2.7f) {
          ...
          core_skeleton_cpp_CDeformableModelInstance_applyRotationToHierarchy_FUN_0051d7a0
                    (param_1 + 0x150,auStack_2bc + 6,local_1f08,_DAT_02dc9f60,
                     core_skeleton_cpp_FUN_0051b650);
          ...
          core_skeleton_cpp_CDeformableModelInstance_applyRotationToHierarchy_FUN_0051d7a0
                    (local_1c,auStack_1ec + 10,local_1f08,_DAT_02dc9f68,
                     core_skeleton_cpp_FUN_0051b650);
        }
        ...
        local_1c = param_1 + 0x150;
        core_skeleton_cpp_CDeformableModelInstance_applyRotationToHierarchy_FUN_0051d7a0
                  (local_1c,&uStack_3b4,local_1f08,_DAT_02dc9f60,core_skeleton_cpp_FUN_0051b650);
        ...
        local_18 = (float)(param_1 + 0x150);
        core_skeleton_cpp_CDeformableModelInstance_applyRotationToHierarchy_FUN_0051d7a0
                  (local_18,auStack_35c + 0xb,local_1ef8,_DAT_02dc9f60,
                   core_skeleton_cpp_FUN_0051b650);
        core_xform_cpp_FUN_0055d4e0(-local_38);
        pcVar12 = core_skeleton_cpp_FUN_0051b650;
        ...
        if (iVar3 != 0x18) {
          if (iVar3 == 0x19) {
            ...
            local_18 = (float)(param_1 + 0x150);
            core_skeleton_cpp_CDeformableModelInstance_applyRotationToHierarchy_FUN_0051d7a0
                      (param_1 + 0x150,auStack_23c + 0x13,local_1f0c,_DAT_02dc9f60,
                       core_skeleton_cpp_FUN_0051b650);
            core_xform_cpp_FUN_0055d4e0(-local_34);
            local_1f0 = local_220;
            ...
            core_skeleton_cpp_CDeformableModelInstance_applyRotationToHierarchy_FUN_0051d7a0
                      (iVar3,auStack_3ec + 2,local_1ef4,_DAT_02dc9f60,core_skeleton_cpp_FUN_0051b650
                      );
            core_skeleton_cpp_CDeformableModelInstance_applyRotationToHierarchy_FUN_0051d7a0
                      (local_1c,auStack_3ec + 2,local_1ef4,_DAT_02dc9f5c,
                       core_skeleton_cpp_FUN_0051b650);
            fVar11 = (float10)fpatan((float10)*(float *)(param_1 + 0x1fb18) /
                                     (float10)2.7f,(float10)1);
            ...
            ;
            core_skeleton_cpp_CDeformableModelInstance_applyRotationToHierarchy_FUN_0051d7a0
                      (iVar3,auStack_23c + 10,local_1ef4,_DAT_02dc9f60,
                       core_skeleton_cpp_FUN_0051b650);
            core_xform_cpp_FUN_0055d4e0(-local_30);
        ...
        local_1c = param_1 + 0x150;
        core_skeleton_cpp_CDeformableModelInstance_applyRotationToHierarchy_FUN_0051d7a0
                  (param_1 + 0x150,auStack_2bc + 10,local_1ee0,_DAT_02dc9f60,
                   core_skeleton_cpp_FUN_0051b650);
        core_skeleton_cpp_CDeformableModelInstance_applyRotationToHierarchy_FUN_0051d7a0
                  (local_1c,auStack_2bc + 10,local_1ee0,_DAT_02dc9f5c,core_skeleton_cpp_FUN_0051b650
                  );
        fVar11 = (float10)fpatan((float10)*(float *)(param_1 + 0x1fb18) / (float10)2.7f,
                                 (float10)1);
        local_34 = (float)fVar11;
        ...
        core_skeleton_cpp_CDeformableModelInstance_applyRotationToHierarchy_FUN_0051d7a0
                  (local_1c,auStack_1ec + 0x12,local_1ee0,_DAT_02dc9f60,
                   core_skeleton_cpp_FUN_0051b650);
        core_xform_cpp_FUN_0055d4e0(-local_34);
    ...
    local_1c = param_1 + 0x150;
    core_skeleton_cpp_CDeformableModelInstance_applyRotationToHierarchy_FUN_0051d7a0
              (param_1 + 0x150,auStack_2bc + 0xe,local_1edc,_DAT_02dc9f94,
               core_skeleton_cpp_FUN_0051b650);
...
LAB_00538751:
  if (*(int *)(0x01C775EC + 0x240) != 0) {
    ...
    core_xform_cpp_FUN_0055d610
              (local_8c,0x3f800000,_DAT_02dc9f50,core_skeleton_cpp_FUN_0051b650,pcVar12);
  ...
  core_skeleton_cpp_CDeformableModelInstance_blendMotion_FUN_0051c3d0
            (iVar3,uVar5,local_2c,*(uint *)(param_1 + 0x1faac),_DAT_02dc9f90,
             core_skeleton_cpp_FUN_0051b650);
  return;
}
