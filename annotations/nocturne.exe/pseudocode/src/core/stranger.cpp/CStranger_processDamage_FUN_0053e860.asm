...
;   core_game.cpp_CGame_resetInventoryDisplayTimer_FUN_004a3a90
...
section .text
    ...
    PUSH EBX                            ; 0053e860
        ;   Label: core_stranger.cpp_CStranger_processDamage_FUN_0053e860
    PUSH ESI                            ; 0053e861
    PUSH EDI                            ; 0053e862
    PUSH EBP                            ; 0053e863
    ...
    CALL core_game.cpp_CGame_resetInventoryDisplayTimer_FUN_004a3a90 ; 0053eb8d
        ;   XREF to: 004a3a90 (UNCONDITIONAL_CALL)  ; void core_game.cpp_CGame_resetInventoryDisplayTimer_FUN_004a3a90(CGame * this_ptr)
    ...
    JNZ 0x0053ec87                      ; 0053ec50
        ;   XREF to: 0053ec87 (CONDITIONAL_JUMP)  ; LAB_0053ec87
    MOV EDX,dword ptr [0x02dd1008]      ; 0053ec52 | g_CTommyGunActorType_02dd0fd0.name_hash
    PUSH EDX                            ; 0053ec58
