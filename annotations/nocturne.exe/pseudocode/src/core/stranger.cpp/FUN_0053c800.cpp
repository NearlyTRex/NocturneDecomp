...
// Convention: unknown
// Signature: undefined4 core_stranger_cpp_FUN_0053c800(int param_1)

#include "nocturne.h"

uint core_stranger_cpp_FUN_0053c800(int param_1)

{
  ...
  if ((((*(int *)(param_1 + 0x1fa08) == 0) && (*(int *)(param_1 + 0x24f0) != 0)) &&
    ...
    if ((iVar6 == 0) ||
      ...
      for (iStack_2c = 0; iStack_2c < *(int *)(0x01E57284 + 0x14cd6c); iStack_2c = iStack_2c + 1)
      {
        iVar9 = core_actor_cpp_castToClassHash_FUN_0040d890
                          (*(uint *)(0x01E57284 + iVar6 + 0x14cd70),
    ...
    fVar12 = (float)core_setcolid_cpp_FUN_00510a40
                              (0x01E57284,fVar5,fVar1,local_80,local_78,0x3f800000,0x3dcccccd,
                               0x40400000);
    if (fVar12 < 1.0) {
