...
// Convention: unknown
// Signature: void core_stranger_cpp_CStranger_drop_FUN_00540920(int param_1,int param_2,undefined4 param_3)

#include "nocturne.h"

void core_stranger_cpp_CStranger_drop_FUN_00540920(int param_1,int param_2,uint param_3)
