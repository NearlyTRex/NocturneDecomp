...
// Convention: unknown
// Signature: EDeathState core_stranger_cpp_CStranger_getDeathState_FUN_00540890(CCharacter *param_1)
...

{
  ...
  EVar2 = core_charactr_cpp_CCharacter_getDeathState_FUN_00428710(param_1);
  return EVar2;
}
