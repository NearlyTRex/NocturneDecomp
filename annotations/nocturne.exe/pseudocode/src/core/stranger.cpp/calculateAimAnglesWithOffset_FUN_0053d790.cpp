...
// Convention: __cdecl
// Signature: CVector3f * __cdecl core_stranger_cpp_calculateAimAnglesWithOffset_FUN_0053d790(CVector3f *out_angles,CVector3f *direction,float *offset_pair)
...

{
  ...
  core_vecdir_cpp_convertDirectionVectorToEulerAngles_FUN_0054e4a0(out_angles,direction);
  ...
  if ((float)0.01 < fVar2) {
    ...
    if ((((float)0.01 <= fVar2) &&
      ...
      *pfVar1 = fVar3;
      fVar3 = core_actor_cpp_normalizeAngleToPi_FUN_0040df00(*pfVar1);
      *pfVar1 = fVar3;
    }
    if (((0.01 <= (double)fVar2) &&
      ...
      out_angles->x = fVar2;
      fVar2 = core_actor_cpp_normalizeAngleToPi_FUN_0040df00(out_angles->x);
      out_angles->x = fVar2;
    }
  }
  return out_angles;
