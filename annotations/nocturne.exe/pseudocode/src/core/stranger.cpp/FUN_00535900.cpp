...
// Convention: unknown
// Signature: void core_stranger_cpp_FUN_00535900(int param_1,float param_2)
...

{
  ...
  *(uint *)(param_1 + 0x23a4) = *(uint *)(param_1 + 0x23a8);
  uVar4 = core_stranger_cpp_FUN_00538440(param_1,auStack_190);
  ...
  if ((*(int *)(iVar5 + 0x24) == 0x1b) &&
     (iStack_78 = core_actor_cpp_castToClassHash_FUN_0040d890
                            (*(uint *)(param_1 + 0x1fa08),
                             g_CAmmoBoxActorType_007641f8.name_hash), iStack_78 != 0)) {
...
LAB_00536144:
  ...
  *(uint *)(param_1 + 0x1fae0) = *(uint *)(param_1 + 0x1fae4);
  ...
  if (iStack_2c != 0) {
    core_stranger_cpp_FUN_0053f310(param_1,param_2);
  }
  if (*(int *)(param_1 + 0x1fa3c) == 0) {
  ...
  *(float *)(param_1 + 0x1fa80) = fVar10;
  ...
  if (fStack_14 <= 0.0) {
    ...
    if ((1.0 < fStack_14) &&
       (iVar5 = core_actor_cpp_castToClassHash_FUN_0040d890
                          (*(uint *)(param_1 + 0x1fa0c),
                           g_CBoxActorActorType_00764800.name_hash), iVar5 != 0)) {
      core_stranger_cpp_FUN_00538440(param_1,auStack_184);
      ...
      if (0.0 < *(float *)(iVar8 + 8)) {
        core_boxactor_cpp_FUN_0041ef90(iVar5,afStack_19c,&fStack_1e4);
      }
    }
  }
  core_stranger_cpp_CStranger_updateWeaponPosition_FUN_0053a660(param_1,0);
  ...
  core_stranger_cpp_FUN_0053ffe0(param_1,param_2);
