...
// Convention: __cdecl
// Signature: void __cdecl core_stranger_cpp_FUN_00535900(CStranger *this_ptr,float delta_time)
...

{
  ...
  (this_ptr->base).base.model.accumulated_root_motion.x =
       (this_ptr->base).base.model.accumulated_root_motion.y;
  pCVar16 = (CVector3f *)core_stranger_cpp_FUN_00538440(this_ptr);
  core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240
            ((CDemonActor *)this_ptr,aCStack_194,pCVar16);
  ...
  if ((this_ptr->base).ladder_to_climb == (CLadder *)0x0) {
    if (this_ptr->ladder_to_descend == (CLadder *)0x0) {
      ...
      if (pCVar8 == (CDemonActor *)0x0) {
        ...
        if (pCVar8 == (CDemonActor *)0x0) {
          if ((this_ptr->base).pushed_object == (CBoxActor *)0x0) {
            iVar21 = core_charactr_cpp_FUN_00428c00((CCharacter *)this_ptr,delta_time);
                ...
                case 5:
                  if ((this_ptr->base).base.is_on_ground != 0) {
                    ...
                    if ((this_ptr->base).player_input.action_state.use_item != 0) {
                      core_hero_cpp_FUN_004b5b00(&this_ptr->base);
                      iStack_60 = 0;
                      break;
                    }
                  }
...
LAB_00536144:
  ...
  if (bVar11) {
    core_stranger_cpp_FUN_0053fc60(this_ptr);
  }
  ...
  core_stranger_cpp_FUN_005402f0(this_ptr);
  ...
  if (fVar17 <= 0.0) {
    ...
    {
      core_stranger_cpp_FUN_00538440(this_ptr);
      core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240
                ((CDemonActor *)this_ptr,(CVector3f *)auStack_110,&CStack_17c);
      CStack_1dc.y = 0.0;
      CStack_1dc.x = (float)auStack_110._0_4_ - aCStack_194[0].x;
      CStack_1dc.z = (float)auStack_110._8_4_ - aCStack_194[0].z;
      pCVar16 = core_actor_cpp_CDemonActor_inverseTransformVector_FUN_0040a220
  ...
  core_stranger_cpp_FUN_0053ffe0(this_ptr,delta_time);
