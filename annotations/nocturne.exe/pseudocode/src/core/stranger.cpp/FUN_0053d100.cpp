...
// Convention: unknown
// Signature: undefined4 core_stranger_cpp_FUN_0053d100(int param_1)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint core_stranger_cpp_FUN_0053d100(int param_1)

{
  ...
  if (*(int *)(param_1 + 0x2290 + _DAT_02dc9fa8 * 4) != 0) {
    ...
    ;
    core_xform_cpp_multiplyMatrix3x4_FUN_0055aa00(local_16c,param_1 + 0xfd0 + _DAT_02dc9f50 * 0x30);
    puVar4 = local_22c;
    puVar5 = local_13c;
  ...
  if ((float)0.98999999999999999 < local_14) {
    ...
    if (iVar2 != 0) {
      ...
      core_setcolid_cpp_CDemonSet_ignore_FUN_00511780
                (0x01E57284,*(uint *)(param_1 + 0x1fa94));
      core_setcolid_cpp_CDemonSet_ignore_FUN_00511780
                (0x01E57284,*(uint *)(param_1 + 0x24f0));
      uVar3 = core_stranger_cpp_CStranger_getThrowDirection_FUN_0053f260(param_1,local_70);
      core_actor_cpp_CDemonActor_transformVector_FUN_0040a200(param_1,local_7c,uVar3);
      local_14 = (float)core_setcolid_cpp_CDemonSet_iterativeRaycast_FUN_0050fdd0
                                  (0x01E57284,iVar2,local_7c);
      local_18 = local_14;
      if (local_14 < 0.0) {
        local_18 = 10.0;
      }
      core_fire_cpp_CFireEffect_createLaserPath_FUN_0048b440
                (0x01C08D04,iVar2,local_7c,0x3f800000,0x3f800000,0x01E57284 + 0x14cd40,local_18,
                 0xff,0,0);
      core_setcolid_cpp_CDemonSet_init_FUN_00511750(0x01E57284);
    }
  }
  ...
  if (((*(int *)(param_1 + 0x1fa00) != 0) && (*(int *)(param_1 + 0x2290 + _DAT_02dc9fa8 * 4) != 0))
    ...
    if (*(int *)(param_1 + 0x1fa00) == 2) {
      ...
      core_xform_cpp_multiplyMatrix3x4_FUN_0055aa00
                (local_1cc,param_1 + 0xfd0 + _DAT_02dc9f50 * 0x30);
      puVar4 = local_10c;
    }
    else {
      local_28 = 0x3f94bac7;
      ...
      core_xform_cpp_multiplyMatrix3x4_FUN_0055aa00
                (local_1fc,_DAT_02dc9f88 * 0x30 + param_1 + 0xfd0);
      puVar4 = local_19c;
    }
    puVar5 = local_dc;
    for (iVar2 = 0xc; iVar2 != 0; iVar2 = iVar2 + -1) {
    ...
    core_dmodel_cpp_CKeyFramedModelInstance_prepareForRendering_FUN_004544d0
              (local_1c + 0x150,0,0xffffffff);
    engine_drender_cpp_CDemonRenderer_matrixPop_FUN_00460bf0(DAT_005ae704);
    core_actor_cpp_CDemonActor_restoreRenderState_FUN_00409f60(param_1);
  }
  if (((*(int *)(param_1 + 0x2290 + _DAT_02dc9fa8 * 4) == 0) &&
      (iVar2 = engine_drender_cpp_CDemonRenderer_getFaceCount_FUN_00461090(DAT_005ae704), iVar2 == 0
      )) && (0 < *(int *)(param_1 + 0x2a8c))) {
    core_cloth_cpp_CClothList_reset_FUN_00438320(param_1 + 0x2a8c);
  }
  return 1;
}
