...
// Convention: unknown
// Signature: undefined4 FUN_0053b630(int param_1,undefined4 param_2)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_0053b630(int param_1,uint param_2)

{
  ...
  if ((((0.0 < *(float *)(param_1 + 0x1faa8)) || (*(int *)(param_1 + 0x1fa08) != 0)) ||
      (local_14 = (float)FUN_0042a9d0(param_1,0), local_14 < (float)_DAT_00595a9f)) ||
     (((local_14 = (float)FUN_004e18d0(param_1 + 0x150,0), local_14 < 1.0 ||
    ...
    if (iVar2 == 0) {
      ...
      case 1:
        if (*(int *)(param_1 + 0x24ac) == 0) {
          FUN_0040a290(iVar7,&fStack_7c,local_24);
...
LAB_0053b782:
          pfVar3 = (float *)FUN_0040a240(param_1,auStack_94,&uStack_13c);
          ...
          pfVar4 = (float *)FUN_0040a240(iVar7,auStack_130,&fStack_58);
          ...
          if (((ABS(fStack_fc) <= (float)_DAT_00595ac7) &&
             ...
             && (iVar2 = FUN_0040d7e0(iVar7,param_2), iVar2 != 0)) {
            local_28 = fStack_20;
            uStack_30 = uStack_2c;
      ...
      case 4:
        if ((*(int *)(param_1 + 0x24f0) == 0) &&
           ((iVar2 = (**(code **)(*(int *)(iVar7 + 0x14c) + 0x7c))(iVar7,param_1), iVar2 != 4 ||
            ((FUN_0040a290(iVar7,afStack_a0,local_24), ABS(afStack_a0[0]) <= 1.0 &&
             (iVar2 = FUN_0054e4a0(auStack_88,afStack_a0),
  ...
  uVar6 = FUN_0040a240(*(uint *)(param_1 + 0x1fa08),auStack_e8,&fStack_40);
  puVar5 = (uint *)FUN_0040a290(param_1,auStack_dc,uVar6);
  ...
  switch(uStack_30) {
  case 1:
    FUN_004e16b0(param_1 + 0x150,0x1b,1);
  ...
  case 4:
    ...
    if ((iVar7 == 0) ||
      ...
      if (*(float *)(param_1 + 0x1fb04) <= (float)_DAT_00595ab7) {
        FUN_004e16b0(iVar7,0x13,1);
        uVar6 = *(uint *)(param_1 + 0x1fa08);
        pcVar8 = "Picking up %s off ground\n";
      }
      else {
        FUN_0051d2a0(iVar7,&fStack_b8,_DAT_02dc9f88);
        FUN_0051d2a0(iVar7,&fStack_ac,_DAT_02dc9f60);
        ...
        {
          FUN_0043ac60(PTR_DAT_005ad350,"%s out of reach - canceling pickup\n",
                       *(uint *)(param_1 + 0x1fa08));
          *(uint *)(param_1 + 0x1fa08) = 0;
          return 0;
        }
        FUN_004e16b0(iVar7,0x15,1);
        uVar6 = *(uint *)(param_1 + 0x1fa08);
        pcVar8 = "Picking up %s waist level\n";
      }
    }
    else {
      iVar7 = FUN_0040a290(*(uint *)(param_1 + 0x1fa08),auStack_f4,param_1 + 0x20);
      *(uint *)(param_1 + 0x1faf0) = (uint)(0.0 < *(float *)(iVar7 + 8));
      if ((float)_DAT_00595aaf < *(float *)(param_1 + 0x1fb04)) {
        FUN_004e16b0(param_1 + 0x150,0x18,1);
        puVar5 = (uint *)FUN_0040a290(param_1,auStack_118,*(int *)(param_1 + 0x1fa08) + 0x20);
        if ((uint *)(param_1 + 0x1fb00) != puVar5) {
          *(uint *)(param_1 + 0x1fb00) = *puVar5;
          *(uint *)(param_1 + 0x1fb04) = puVar5[1];
          *(uint *)(param_1 + 0x1fb08) = puVar5[2];
  ...
  FUN_0043ac60(PTR_DAT_005ad350,pcVar8,uVar6);
LAB_0053bbf0:
