...
;   core_stranger.cpp_CStranger_processFrame_FUN_00535900
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 005357d0
        ;   Label: core_stranger.cpp_CStranger_process_FUN_005357d0
    SUB ESP,0x8                         ; 005357d1
    MOV EBX,dword ptr [ESP + 0x10]      ; 005357d4
    PUSH dword ptr [ESP + 0x14]         ; 005357d8
    PUSH EBX                            ; 005357dc
    CALL core_charactr.cpp_CCharacter_process_FUN_004259f0 ; 005357dd
    ...
    PUSH EBX                            ; 00535812
    CALL core_stranger.cpp_CStranger_processFrame_FUN_00535900 ; 00535813
        ;   XREF to: 00535900 (UNCONDITIONAL_CALL)  ; void core_stranger.cpp_CStranger_processFrame_FUN_00535900(CStranger * this_ptr, float delta_time)
    ADD ESP,0x8                         ; 00535818
    PUSH dword ptr [ESP + 0x4]          ; 0053581b
    PUSH EBX                            ; 0053581f
    CALL core_stranger.cpp_CStranger_processFrame_FUN_00535900 ; 00535820
        ;   XREF to: 00535900 (UNCONDITIONAL_CALL)  ; void core_stranger.cpp_CStranger_processFrame_FUN_00535900(CStranger * this_ptr, float delta_time)
    ADD ESP,0x8                         ; 00535825
    PUSH dword ptr [ESP + 0x4]          ; 00535828
    PUSH EBX                            ; 0053582c
    CALL core_stranger.cpp_CStranger_processFrame_FUN_00535900 ; 0053582d
        ;   XREF to: 00535900 (UNCONDITIONAL_CALL)  ; void core_stranger.cpp_CStranger_processFrame_FUN_00535900(CStranger * this_ptr, float delta_time)
    ADD ESP,0x8                         ; 00535832
    PUSH dword ptr [ESP + 0x4]          ; 00535835
    PUSH EBX                            ; 00535839
        ;   Label: LAB_00535839
    CALL core_stranger.cpp_CStranger_processFrame_FUN_00535900 ; 0053583a
        ;   XREF to: 00535900 (UNCONDITIONAL_CALL)  ; void core_stranger.cpp_CStranger_processFrame_FUN_00535900(CStranger * this_ptr, float delta_time)
