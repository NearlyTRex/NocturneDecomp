...
;   core_stranger.cpp_CStranger_tryPlaceObject_FUN_0053c800
...
section .text
    ...
    PUSH EBX                            ; 0053fc60
        ;   Label: core_stranger.cpp_CStranger_handleActionButton_FUN_0053fc60
    PUSH ESI                            ; 0053fc61
    PUSH EDI                            ; 0053fc62
    ...
    PUSH EBX                            ; 0053fcce
    CALL core_hero.cpp_CHero_tryOpenNearbyDoor_FUN_004b5110 ; 0053fccf
    ...
    PUSH EBX                            ; 0053fd06
        ;   Label: LAB_0053fd06
    CALL core_stranger.cpp_CStranger_tryPlaceObject_FUN_0053c800 ; 0053fd07
        ;   XREF to: 0053c800 (UNCONDITIONAL_CALL)  ; int core_stranger.cpp_CStranger_tryPlaceObject_FUN_0053c800(CStranger * this_ptr)
