// Name: core_stranger.cpp_CStranger_FUN_00535900
// Address: 00535900
// Address Range: [[00535900, 00537ccd]]
// Convention: __cdecl
// Signature: void __cdecl core_stranger_cpp_CStranger_FUN_00535900(CStranger *this_ptr,float delta_time)
...
LAB_00536144:
  ...
  if (local_24 != 0.0) {
    core_stranger_cpp_CStranger_FUN_0053f310(this_ptr,delta_time);
  }
  if (this_ptr->guns_drawn == 0) {
