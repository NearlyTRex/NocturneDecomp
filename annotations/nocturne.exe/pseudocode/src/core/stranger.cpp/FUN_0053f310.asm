...
;
; XREF[1]:
;   core_stranger.cpp_FUN_00535900 at 00536247
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0053f310
        ;   Label: core_stranger.cpp_FUN_0053f310
    PUSH ESI                            ; 0053f311
    PUSH EDI                            ; 0053f312
    PUSH EBP                            ; 0053f313
    ...
    CALL core_dynamite.cpp_FUN_0046ed80 ; 0053f4a6
        ;   XREF to: 0046ed80 (UNCONDITIONAL_CALL)  ; undefined core_dynamite.cpp_FUN_0046ed80()
