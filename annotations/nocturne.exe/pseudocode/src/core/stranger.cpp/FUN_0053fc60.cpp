...
// Convention: unknown
// Signature: void core_stranger_cpp_FUN_0053fc60(int param_1)
...

{
  ...
  if ((((*(int *)(param_1 + 0xbca0) != 0) && (*(int *)(param_1 + 0x1faa0) == 0)) &&
    ...
    if ((float)0.99990000000000001 < fVar3 + fVar2) {
      uVar4 = core_hero_cpp_FUN_004b5110(param_1);
      switch(uVar4) {
      case 0:
        if (*(int *)(param_1 + 0x1fa04) != 0) {
          shape_edittool_cpp_FUN_0046fcd0
                    (0x01BCD074,"eDoorMoveNone returned by checkDoorOpen, but doorToOpen = %s",*(int *)(param_1 + 0x1fa04));
        }
        break;
      case 1:
        if (*(int *)(param_1 + 0x1fa04) != 0) {
    ...
    iVar1 = core_stranger_cpp_FUN_0053c800(param_1);
    if (iVar1 != 0) {
      *(uint *)(param_1 + 0xbca0) = 0;
      return;
    }
    ...
    if (iVar1 == 0) {
      ...
      if ((*(int *)(param_1 + 0x24f0) == 0) &&
         (fVar2 = (float)core_charactr_cpp_CCharacter_getLayerActionBlendWeight_FUN_0042a9d0
                                   (param_1,0), (float)0.98999999999999999 < fVar2)) {
        iVar1 = core_hero_cpp_FUN_004b52f0(param_1);
        if (iVar1 != 0) {
          *(uint *)(param_1 + 0xbca0) = 0;
