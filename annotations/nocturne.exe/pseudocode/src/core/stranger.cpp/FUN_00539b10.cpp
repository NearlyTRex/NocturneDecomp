...
// Convention: unknown
// Signature: void FUN_00539b10(int param_1)
...

{
  ...
  iVar2 = param_1 + 0x150;
  local_30 = (float)FUN_004e18d0(iVar2,0x28);
  local_18 = (float)FUN_004e18d0(iVar2,0x29);
  local_30 = local_18 + local_30;
  local_18 = (float)FUN_004e18d0(iVar2,0x24);
  local_30 = local_18 + local_30;
  local_18 = (float)FUN_004e18d0(iVar2,0x22);
  local_f8 = (1.0 - (local_18 + local_30)) * local_f8;
  if (local_f8 < 0.0) {
    local_f8 = 0.0;
  }
  if (*(int *)(param_1 + 0x2a84) != 0xe) goto LAB_00539cea;
  fVar1 = (float)FUN_004e1e60(param_1 + 0x150);
  local_1c = 1.0;
  local_18 = fVar1;
...
LAB_00539cea:
  ...
  iVar2 = param_1 + 0x150;
  uVar3 = FUN_0051e0a0(iVar2,param_1 + *(int *)(param_1 + 0x2a84) * 0x38 + 0x262c,1);
  local_20 = FUN_004e1010(uVar3);
  local_24 = (float)FUN_004e1f50(iVar2,local_20,*(uint *)(param_1 + 0x2a88));
  local_18 = local_24;
  if (((*(int *)(param_1 + 0x2a84) == 9) && (1.0 <= *(float *)(param_1 + 0x2a88))) &&
     (*(int *)(param_1 + 0x1fa9c) != 0)) {
    uVar3 = FUN_0051e0a0(iVar2,param_1 + 0x285c,1);
    uVar3 = FUN_004e1010(uVar3);
    local_20 = uVar3;
    local_18 = (float)FUN_0040dda0(0,0x3f800000);
    local_18 = (float)FUN_004e1f50(iVar2,uVar3,local_18);
  }
  local_24 = local_18;
  FUN_0051c3d0(param_1 + 0x150,local_20,local_18,local_f8,_DAT_02dc9f94,&LAB_0051b650);
  if (*(int *)(param_1 + 0x2a84) == 0) {
    local_30 = (float)(param_1 + 0x800);
    FUN_0055d2d0(_DAT_02dc9f88 * 0x10 + (int)local_30,_DAT_02dc9f68 * 0x10 + (int)local_30,
                 *(uint *)(param_1 + 0x2a88));
    ...
    *puVar5 = *(uint *)(&stack0xffffff44 + (uint)bVar7 * -8);
    ...
    (puVar5 + (uint)bVar7 * -2 + 1)[(uint)bVar7 * -2 + 1] =
         *(uint *)
          ...
          ((uint)bVar7 * -2 + 1) * 4);
    FUN_0055d2d0(_DAT_02dc9f84 * 0x10 + (int)local_30,_DAT_02dc9f64 * 0x10 + (int)local_30,
                 *(uint *)(param_1 + 0x2a88));
  ...
  if (*(int *)(param_1 + 0x2a84) == 1) {
    ...
    local_18 = (float)FUN_0042a9d0(param_1,3);
  ...
  if ((((iVar2 == 3) || (iVar2 == 4)) || ((iVar2 == 9 || ((iVar2 == 6 || (iVar2 == 7)))))) ||
    ...
    *(uint *)
    ...
    FUN_0051d7a0(fVar9,puVar10,fVar1,uVar3,puVar12);
    ...
    *(uint *)
     ((int)(&stack0xffffffb8 + (uint)bVar7 * -8 + (uint)bVar7 * -8) + ((uint)bVar7 * -2 + 1) * 4) =
         *(uint *)
          ...
          ((uint)bVar7 * -2 + 1) * 4);
    FUN_0051d7a0(local_30,&stack0xffffffb0,local_38,_DAT_02dc9f94,&LAB_00534e90);
  ...
  *(uint *)
  ...
  ;
  FUN_0051d7a0(iVar2,puVar10,uVar11,uVar3,puVar12);
  FUN_0055d4e0(-local_34);
  puVar12 = &LAB_0051b650;
  puVar10 = &stack0xffffff60;
  uVar11 = 0x3f800000;
  ...
  *(uint *)
  ...
  ;
  FUN_0051d7a0(param_1,puVar10,uVar11,uVar3,puVar12);
  return;
}
