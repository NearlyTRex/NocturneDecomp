...

{
  ...
  for (local_1c = 0; local_1c < g_CDemonSet_PTR_005be368->actor_count; local_1c = local_1c + 1) {
    pCVar8 = *(CDemonActor **)((int)g_CDemonSet_PTR_005be368->actors + local_18);
    ...
    if (pCVar3 == (CDemonActor *)0x0) {
      ...
      case 1:
        if ((this_ptr->base).base.carry_hands[0].carry_actor == (CDemonActor *)0x0) {
          core_actor_cpp_CDemonActor_worldToLocalPoint_FUN_0040a290(pCVar8,&CStack_7c,local_24);
...
LAB_0053b782:
          ...
          if (((ABS(fStack_fc) <= (float)5) &&
             ...
             && (iVar5 = core_actor_cpp_isOfClass_FUN_0040d7e0(pCVar8,class_name), iVar5 != 0)) {
            local_28 = fStack_20;
            iStack_30 = iStack_2c;
      ...
      case 4:
        if (((this_ptr->base).base.carry_hands[1].carry_actor == (CDemonActor *)0x0) &&
           ((iVar5 = (*((pCVar8->vtable)._ub)->canPickup)(pCVar8,(CDemonActor *)this_ptr),
            iVar5 != 4 ||
            ((core_actor_cpp_CDemonActor_worldToLocalPoint_FUN_0040a290(pCVar8,&CStack_a0,local_24),
             ABS(CStack_a0.x) <= 1.0 &&
  ...
  pCVar6 = (*((pCVar8->vtable)._ub)->getBoundingBox)(pCVar8,&CStack_16c);
  ...
  default:
    ...
    core_main_c_displayErrorAndQuit_FUN_004c8440("Hell froze - invalid pickUpType: %d",iStack_30);
    goto LAB_0053bbf0;
  }
  engine_console_cpp_CConsole_printf_FUN_0043ac60(g_CConsole_PTR_005ad350,format,pCVar8);
LAB_0053bbf0:
