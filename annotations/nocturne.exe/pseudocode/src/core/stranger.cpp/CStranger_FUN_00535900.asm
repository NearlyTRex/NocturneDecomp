...
section .text
    ...
    PUSH EBX                            ; 00535900
        ;   Label: core_stranger.cpp_CStranger_FUN_00535900
    PUSH ESI                            ; 00535901
    PUSH EDI                            ; 00535902
    PUSH EBP                            ; 00535903
    ...
    PUSH EBX                            ; 00536246
    CALL core_stranger.cpp_CStranger_FUN_0053f310 ; 00536247
        ;   XREF to: 0053f310 (UNCONDITIONAL_CALL)  ; void core_stranger.cpp_CStranger_FUN_0053f310(CStranger * this_ptr, float delta_time)
