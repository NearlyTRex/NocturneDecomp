// Name: core_stranger.cpp_CStranger_tryPlaceObject_FUN_0053c800
// Address: 0053c800
// Address Range: [[0053c800, 0053cf8b]]
// Convention: __cdecl
// Signature: int __cdecl core_stranger_cpp_CStranger_tryPlaceObject_FUN_0053c800(CStranger *this_ptr)
    ...
    for (local_24 = 0; local_24 < g_CDemonSet_PTR_005be368->actor_count; local_24 = local_24 + 1) {
                            ...
                            (pCVar4,(this_ptr->base).base.carry_hands[1].carry_actor), iVar6 != 0))
      {
        ...
        if ((0.0 < fStack_88) &&
          ...
          fVar9 = core_stranger_cpp_getCarriedObjectVerticalOffset_FUN_00534fc0
