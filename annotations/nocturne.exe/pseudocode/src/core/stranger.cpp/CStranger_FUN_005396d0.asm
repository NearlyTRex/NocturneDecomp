...
;
; XREF[1]:
;   core_stranger.cpp_CStranger_FUN_005384d0 at 0053857e
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 005396d0
        ;   Label: core_stranger.cpp_CStranger_FUN_005396d0
    PUSH ESI                            ; 005396d1
    PUSH EDI                            ; 005396d2
    ...
    CALL core_xform.cpp_quaternionFromAngleY_FUN_0055d4e0 ; 0053975d
