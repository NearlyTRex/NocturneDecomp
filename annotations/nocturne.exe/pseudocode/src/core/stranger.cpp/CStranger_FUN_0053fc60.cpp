// Name: core_stranger.cpp_CStranger_FUN_0053fc60
// Address: 0053fc60
// Address Range: [[0053fc60, 0053ff48]]
// Convention: __cdecl
// Signature: void __cdecl core_stranger_cpp_CStranger_FUN_0053fc60(CStranger *this_ptr)
...

{
  ...
  if (((((this_ptr->base).player_input.action_state.fire != 0) && (this_ptr->action_pending == 0))
    ...
    if ((float)0.99990000000000001 < fVar5 + fVar4) {
      iVar3 = core_hero_cpp_CHero_FUN_004b5110(&this_ptr->base);
      switch(iVar3) {
      case 0:
    ...
    iVar3 = core_stranger_cpp_CStranger_FUN_0053c800(this_ptr);
    if (iVar3 != 0) {
      (this_ptr->base).player_input.action_state.fire = 0;
      return;
    }
