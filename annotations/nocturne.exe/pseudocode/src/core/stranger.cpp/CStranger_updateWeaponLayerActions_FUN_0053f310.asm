...
;
; XREF[1]:
;   core_stranger.cpp_CStranger_processFrame_FUN_00535900 at 00536247
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0053f310
        ;   Label: core_stranger.cpp_CStranger_updateWeaponLayerActions_FUN_0053f310
    PUSH ESI                            ; 0053f311
    PUSH EDI                            ; 0053f312
    PUSH EBP                            ; 0053f313
    ...
    MOV EDX,dword ptr [0x005b9284]      ; 0053fc23 | g_CForceFeedback_PTR_005b9284
        ;   Label: LAB_0053fc23
    PUSH EDX                            ; 0053fc29
    CALL engine_force.cpp_CForceFeedback_processEvent_FUN_004940d0 ; 0053fc2a
