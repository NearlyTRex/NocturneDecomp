...

{
  ...
  if (arm_side == 0) {
    ...
    core_xform_cpp_quaternionFromAngleY_FUN_0055d4e0(1.5707964,&local_11c);
    ...
    *puVar3 = *puVar2;
    ...
    core_xform_cpp_quaternionFromAngleY_FUN_0055d4e0(-1.5707964,&local_1dc);
  ...
  *puVar4 = *puVar3;
  ...
  if (0.0 < local_1e0) {
    ...
    *puVar3 = *puVar2;
    puVar3[(uint)bVar6 * -2 + 1] = puVar2[(uint)bVar6 * -2 + 1];
    core_xform_cpp_multiplyQuaternion_FUN_0055d130(&local_17c,pCVar1,&local_ac);
    pCVar1 = &local_1cc;
    fVar8 = 0.95;
    ...
    *puVar3 = *puVar2;
    ...
    core_xform_cpp_slerpQuaternion_FUN_0055d2d0
              ((CQuaternion4f *)&DAT_005a4508,pCVar1,fVar8,&local_9c);
    pCVar1 = &local_18c;
    ...
    *puVar3 = *puVar2;
    puVar3[(uint)bVar6 * -2 + 1] = puVar2[(uint)bVar6 * -2 + 1];
    core_xform_cpp_multiplyQuaternion_FUN_0055d130(&local_15c,pCVar1,&local_bc);
    ...
    *puVar3 = *puVar2;
    puVar3[(uint)bVar6 * -2 + 1] = puVar2[(uint)bVar6 * -2 + 1];
    iVar7 = local_24 * 0x10;
    local_2c = (this_ptr->base).base.model.bone_transform.pose_data.bone_rotations + local_24;
    core_xform_cpp_slerpQuaternion_FUN_0055d2d0(local_2c,&local_14c,fVar8,&local_6c);
    local_30 = (this_ptr->base).base.base.actor_name + iVar7;
    pcVar5 = local_30 + (uint)bVar6 * -8 + 0x804;
    *(float *)(local_30 + 0x800) = local_6c.w;
    ...
    *(uint *)(pcVar5 + ((uint)bVar6 * -2 + 1) * 4 + ((uint)bVar6 * -2 + 1) * 4) =
    ...
    pCVar1 = &local_18c;
    core_xform_cpp_multiplyQuaternion_FUN_0055d130(&local_1cc,&local_1bc,&local_8c);
    ...
    *puVar3 = *puVar2;
    puVar3[(uint)bVar6 * -2 + 1] = puVar2[(uint)bVar6 * -2 + 1];
    core_xform_cpp_multiplyQuaternion_FUN_0055d130(&local_12c,pCVar1,&local_7c);
    ...
    *puVar3 = *puVar2;
    ...
    if ((float)0.0001 < this_ptr->arm_recoil_blend) {
      ...
      *puVar3 = *puVar2;
      puVar3[(uint)bVar6 * -2 + 1] = puVar2[(uint)bVar6 * -2 + 1];
      core_xform_cpp_multiplyQuaternion_FUN_0055d130(&local_15c,pCVar1,&local_dc);
      ...
      *puVar3 = *puVar2;
      ...
      pcVar5 = local_30 + (uint)bVar6 * -8 + 0x804;
      *(float *)(local_30 + 0x800) = local_cc.w;
