...

{
  ...
  while (0.0 < local_3c[0]) {
    ...
    if (uVar7 < 10) {
      ...
      pCVar8 = core_skeleton_cpp_CDeformableModelInstance_getBoneWorldPosition_FUN_0051d2a0
                         (pCVar1,&local_158,param_1->bone_indices[3]);
      core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240
                ((CDemonActor *)param_1,&local_98,pCVar8);
  ...
  (param_1->base).base.turn_speed = param_2 * fVar5 * fVar16;
  ...
  if (iVar6 == 0) {
    EVar11 = (*(((param_1->base).base.base.vtable._uc)->_uc).getDeathState)((CCharacter *)param_1);
    if ((EVar11 == DEATH_STATE_ALIVE) &&
      ...
      pSVar17 = &local_2a8;
      fVar16 = (param_1->base).base.size_scale;
      ...
      pCVar8 = core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240
                         ((CDemonActor *)param_1,&local_140,pCVar8);
      core_enemy_cpp_CEnemy_testAttackRadius_FUN_004798e0(&param_1->base,pCVar8,fVar16,pSVar17);
      local_2a8.damage_amount = core_actor_cpp_getRandomFloatFromRange_FUN_0040dda0(7.0,15.0);
      local_2a8.attacker = (CDemonActor *)param_1;
      local_2a8.wielder = (CDemonActor *)param_1;
      pSVar17 = &local_2a8;
      ...
      pCVar8 = core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240
                         ((CDemonActor *)param_1,&local_188,pCVar8);
      core_enemy_cpp_CEnemy_testAttackRadius_FUN_004798e0(&param_1->base,pCVar8,fVar16,pSVar17);
      local_2a8.damage_amount = core_actor_cpp_getRandomFloatFromRange_FUN_0040dda0(7.0,15.0);
      pSVar17 = &local_2a8;
      local_2a8.attacker = (CDemonActor *)param_1;
          ...
          if (*(CCharacter **)(_DAT_01cae0e8 * 4 + 0x1cae0d8) != (param_1->base).victim) {
            ...
            pCVar8 = core_xform_cpp_transformVector3x4_FUN_0055a8b0
                               (&local_74,(CVector3f *)&DAT_02dd1184,
                                ...
                                [param_1->bone_indices[1]].m);
            pCVar8 = core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240
                               ((CDemonActor *)param_1,&local_14c,pCVar8);
            core_enemy_cpp_CEnemy_testAttackRadius_FUN_004798e0
                      (&param_1->base,pCVar8,fVar16,pSVar17);
          }
          ...
          if ((param_1->phase == 1) || (param_1->phase == 3)) {
            ...
            if (0.0 <= pCVar8->z) {
              ...
              if (0.0 <= pCVar8->z) {
                ...
                goto LAB_00556967;
                pCVar13 = (CCharacter *)param_1->alpha2;
              }
              else {
                pCVar13 = (CCharacter *)param_1->alpha2;
              }
...
LAB_00556967:
              pCVar13 = (CCharacter *)param_1->alpha1;
            }
          }
          iVar6 = param_1->phase;
          if ((iVar6 == 1) || (iVar6 == 3)) {
          ...
          else if ((param_1->phase_timer <= 0.0) && (param_1->phase = iVar6 + 1, 3 < iVar6 + 1)) {
            param_1->phase = 0;
          }
        }
        local_1e0 = 3.0f;
        ...
        iVar6 = core_charactr_cpp_CCharacter_walkToPoint_FUN_004247f0
                          ((CCharacter *)param_1,&target_pos->position,path_map,(CVector3f *)uVar18,
        ...
        if (iVar6 < 0) {
          ...
          if (pCVar12 == (CDemonActor *)0x0) {
            local_194.x = (target_pos->position).x - (param_1->base).base.base.location.position.x;
            ...
            if (local_1c < local_28) {
              ...
              local_14 = core_actor_cpp_normalizeAngleToPi_FUN_0040df00
                                   (local_170.y - (param_1->base).base.base.orient.vec.y);
        ...
        fVar16 = param_1->howl_cooldown - param_2;
        param_1->howl_cooldown = fVar16;
        if (fVar16 < 0.0) {
          core_werewolf_cpp_CWerewolf_playHowl_FUN_00557060(param_1);
        }
        goto LAB_00555e90;
      ...
      if (local_18 < 5) {
        ...
        pCVar8 = core_xform_cpp_transformVector3x4_FUN_0055a8b0
                           (&local_11c,(CVector3f *)&DAT_02dd1184,
                            ...
                            [param_1->bone_indices[2]].m);
        pCVar8 = core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240
                           ((CDemonActor *)param_1,&local_164,pCVar8);
        core_enemy_cpp_CEnemy_testAttackRadius_FUN_004798e0(&param_1->base,pCVar8,fVar16,pSVar17);
        pCVar13 = (param_1->base).victim;
        if ((pCVar13 != (CCharacter *)0x0) &&
           (EVar11 = (*(((pCVar13->base).vtable._uc)->_uc).getDeathState)(pCVar13),
        ...
        if ((param_1->base).victim != *(CCharacter **)(_DAT_01cae0e8 * 4 + 0x1cae0d8)) {
          ...
          pCVar8 = core_xform_cpp_transformVector3x4_FUN_0055a8b0
                             (&local_1f4,(CVector3f *)&DAT_02dd1184,
                              ...
                              [param_1->bone_indices[3]].m);
          pCVar8 = core_actor_cpp_CDemonActor_localToWorldPoint_FUN_0040a240
                             ((CDemonActor *)param_1,&local_50,pCVar8);
          core_enemy_cpp_CEnemy_testAttackRadius_FUN_004798e0(&param_1->base,pCVar8,fVar16,pSVar17);
        }
        pCVar13 = (param_1->base).victim;
        if ((pCVar13 != (CCharacter *)0x0) &&
...
LAB_00556301:
  ...
  uVar4 = (param_1->base).base.is_walking;
  if (uVar4 < 2) {
    if (uVar4 == 1) {
...
LAB_00555e90:
  ...
  (param_1->base).base.collision_cylinder_radius = local_20 * (float)dVar15;
  ...
  if (((((iVar6 != 0xd) && (iVar6 != 0)) && (iVar6 != 0xe)) && (iVar6 != 0x14)) ||
    ...
    pCVar8 = &(param_1->base).base.model.accumulated_root_motion;
    local_e4 = param_2 * (param_1->base).base.velocity.z;
    pCVar2 = &(param_1->base).base.position_delta;
