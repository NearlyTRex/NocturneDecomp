...
// Convention: unknown
// Signature: void core_werewolf_cpp_CWerewolf_setup_FUN_00555b40(int param_1)
...

{
  ...
  uVar2 = core_skeleton_cpp_CSkeleton_findBone_FUN_005179d0(uVar1,"Bip01 Spine3",1);
  *(uint *)(param_1 + 0xbd28) = uVar2;
  uVar2 = core_skeleton_cpp_CSkeleton_findBone_FUN_005179d0(uVar1,"Bip01 L Finger1",1);
  *(uint *)(param_1 + 0xbd2c) = uVar2;
  uVar2 = core_skeleton_cpp_CSkeleton_findBone_FUN_005179d0(uVar1,"Bip01 R Finger1",1);
  *(uint *)(param_1 + 0xbd30) = uVar2;
  uVar2 = core_skeleton_cpp_CSkeleton_findBone_FUN_005179d0(uVar1,"Bip01jaw2",1);
  ...
  *(uint *)(param_1 + 0xbd40) = 0;
  uVar1 = core_actor_cpp_getRandomFloatFromRange_FUN_0040dda0(0x41200000,0x41f00000);
