...
// Convention: unknown
// Signature: CDemonActor * core_werewolf_cpp_CWerewolf_dtor_FUN_00557e90(CDemonActor *param_1,byte param_2)
...

{
  ...
  if ((param_2 & 4) != 0) {
    ptr = __vec_delete(param_1,&g_CWerewolfTypeInfo_005a4460);
