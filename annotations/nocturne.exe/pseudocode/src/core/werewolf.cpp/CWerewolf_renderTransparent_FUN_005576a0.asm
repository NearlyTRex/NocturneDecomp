...
section .text
    ...
    PUSH EBX                            ; 005576a0
        ;   Label: core_werewolf.cpp_CWerewolf_renderTransparent_FUN_005576a0
    PUSH EBP                            ; 005576a1
    ...
    MOV EDI,dword ptr [0x005ae704]      ; 00557755 | g_CDemonRenderer_PTR_005ae704
    ...
    PUSH EAX                            ; 0055776a
    MOV EBP,dword ptr [0x005ae704]      ; 0055776b | g_CDemonRenderer_PTR_005ae704
