// Name: core_werewolf.cpp_FUN_00557e90
// Address: 00557e90
// Address Range: [[00557e90, 00557f48]]
// Convention: unknown
// Signature: int core_werewolf_cpp_FUN_00557e90(int param_1,byte param_2)

#include "nocturne.h"

int core_werewolf_cpp_FUN_00557e90(int param_1,byte param_2)

{
  ...
  if ((param_2 & 4) != 0) {
    uVar2 = __vec_delete(param_1,&g_CWerewolfTypeInfo_005a4460);
