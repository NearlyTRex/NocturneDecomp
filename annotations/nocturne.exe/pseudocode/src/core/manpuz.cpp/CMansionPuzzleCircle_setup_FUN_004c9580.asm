...
section .text
    ...
    PUSH EBX                            ; 004c9580
        ;   Label: core_manpuz.cpp_CMansionPuzzleCircle_setup_FUN_004c9580
    PUSH ESI                            ; 004c9581
    PUSH EDI                            ; 004c9582
    PUSH EBP                            ; 004c9583
    ...
    PUSH EAX                            ; 004c95e6
    MOV ECX,dword ptr [0x005ae704]      ; 004c95e7 | g_CDemonRenderer_PTR_005ae704
    ...
    PUSH 0x5993b0                       ; 004c990e | g_CVectorTypeInfo_005993b0
        ;   Label: LAB_004c990e
    PUSH 0x4                            ; 004c9913
