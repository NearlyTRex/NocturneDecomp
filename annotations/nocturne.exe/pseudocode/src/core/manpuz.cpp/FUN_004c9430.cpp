...

{
  ...
  iVar2 = core_dmodel_cpp_CKeyFramedModelInstance_ctor_FUN_00454490(iVar2 + 0x17c);
  iVar2 = __arrinit(iVar2 + 0x1a0,0xc,&g_SPanelTypeInfo_005a0210);
  iVar2 = __arrinit(iVar2 + 0x4b0,0xc,&g_SGemTypeInfo_005a0230);
  iVar2 = __arrinit(iVar2 + 0x8a0,2,&g_SReflectorTypeInfo_005a0250);
  *(byte ***)(iVar2 + -0x11ec) = &PTR_core_manpuz_cpp_FUN_004c9580_005a0054;
  ...
  *(uint *)(iVar2 + -0xd5c) = *(uint *)(iVar2 + -0xd58);
  core_manpuz_cpp_FUN_004ca410(iVar2 + -0x1338);
  return iVar2 + -0x1338;
}
