...
// Convention: __cdecl
// Signature: void __cdecl core_manpuz_cpp_CMansionPuzzleCircle_updatePanelTransform_FUN_004ca640(CMansionPuzzleCircle *this_ptr,int panel_index)
...

{
  ...
  local_34.x = 0.0;
  local_34.y = 0.0;
  pCVar2 = core_dirmat_cpp_CMatrix3x3f_transformVector_FUN_0044da40(this_ptr_00,&local_28,&local_34)
  ;
  pCVar3 = &this_ptr->panels[panel_index].local_position;
  if (pCVar3 != pCVar2) {
    pCVar3->x = pCVar2->x;
    this_ptr->panels[panel_index].local_position.y = pCVar2->y;
    this_ptr->panels[panel_index].local_position.z = pCVar2->z;
  }
  pCVar2 = &this_ptr->panels[panel_index].world_position;
