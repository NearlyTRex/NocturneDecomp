// Name: core_manpuz.cpp_FUN_004c9cf0
// Address: 004c9cf0
// Address Range: [[004c9cf0, 004c9dfd]]
// Convention: unknown
// Signature: void core_manpuz_cpp_FUN_004c9cf0(int param_1,undefined4 param_2)

#include "nocturne.h"

void core_manpuz_cpp_FUN_004c9cf0(int param_1,uint param_2)

{
  ...
  if (iVar1 != 0) {
    ...
    iVar1 = 0;
    do {
      core_manpuz_cpp_FUN_004cb010(param_1,iVar1,param_2);
      iVar1 = iVar1 + 1;
    } while (iVar1 < 0xc);
    iVar1 = 0;
    do {
