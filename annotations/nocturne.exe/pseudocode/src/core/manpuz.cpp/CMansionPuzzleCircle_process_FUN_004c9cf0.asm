...
;   core_manpuz.cpp_CMansionPuzzleCircle_updateGem_FUN_004cb010
...
section .text
    ...
    PUSH EBX                            ; 004c9cf0
        ;   Label: core_manpuz.cpp_CMansionPuzzleCircle_process_FUN_004c9cf0
    ...
    PUSH ESI                            ; 004c9d57
    PUSH EBX                            ; 004c9d58
    CALL core_manpuz.cpp_CMansionPuzzleCircle_updateGem_FUN_004cb010 ; 004c9d59
        ;   XREF to: 004cb010 (UNCONDITIONAL_CALL)  ; void core_manpuz.cpp_CMansionPuzzleCircle_updateGem_FUN_004cb010(CMansionPuzzleCircle * this_ptr, int gem_index, float delta_time)
    INC ESI                             ; 004c9d5e
