...
section .text
    ...
    MOV EAX,[0x005b9354]                ; 004cbb7e | g_CGame_PTR_005b9354
    PUSH -0x1                           ; 004cbb83
    MOV dword ptr [EAX + 0x1f4],0x1     ; 004cbb85 | g_CGame_01c775ec.render_mode
    ...
    MOV EAX,[0x005b9354]                ; 004cbba0 | g_CGame_PTR_005b9354
    PUSH EBX                            ; 004cbba5
    MOV dword ptr [EAX + 0x1f4],0x0     ; 004cbba6 | g_CGame_01c775ec.render_mode
