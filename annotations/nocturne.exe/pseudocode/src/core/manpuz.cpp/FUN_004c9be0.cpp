// Name: core_manpuz.cpp_FUN_004c9be0
// Address: 004c9be0
// Address Range: [[004c9be0, 004c9ce5]]
// Convention: unknown
// Signature: int core_manpuz_cpp_FUN_004c9be0(int param_1)
...

{
  ...
  if (iVar2 != 0) {
    ...
    engine_special_cpp_transformAndProjectPoint_FUN_0053075c(*DAT_005ae704 + 48000,&iStack_14);
    iVar3 = 0;
    do {
      core_manpuz_cpp_FUN_004ca710(param_1,iVar3);
      core_manpuz_cpp_FUN_004ca790(param_1,iVar3);
      iVar3 = iVar3 + 1;
    } while (iVar3 < 0xc);
