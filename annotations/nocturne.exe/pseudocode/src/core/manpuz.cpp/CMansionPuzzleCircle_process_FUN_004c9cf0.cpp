...
// Convention: __cdecl
// Signature: void __cdecl core_manpuz_cpp_CMansionPuzzleCircle_process_FUN_004c9cf0(CMansionPuzzleCircle *this_ptr,float delta_time)
...

{
  ...
  iVar3 = core_hero_cpp_isAnyHeroWithinRadius_FUN_004b45b0(&(this_ptr->base).location.position,30.0)
  ;
  if (iVar3 != 0) {
    iVar3 = 0;
    do {
      core_manpuz_cpp_CMansionPuzzleCircle_processPanel_FUN_004cac90(this_ptr,iVar3,delta_time);
      iVar3 = iVar3 + 1;
    } while (iVar3 < 0xc);
    iVar3 = 0;
    do {
      core_manpuz_cpp_CMansionPuzzleCircle_updateReflector_FUN_004cb900(this_ptr,iVar3,delta_time);
      iVar3 = iVar3 + 1;
    } while (iVar3 < 2);
    iVar3 = 0;
    do {
      core_manpuz_cpp_CMansionPuzzleCircle_updateLaser_FUN_004cb2d0(this_ptr,iVar3,delta_time);
      iVar3 = iVar3 + 1;
    } while (iVar3 < 0xc);
    iVar3 = 0;
    do {
      core_manpuz_cpp_FUN_004cb010(this_ptr,iVar3,delta_time);
      iVar3 = iVar3 + 1;
    } while (iVar3 < 0xc);
    iVar3 = 0;
    do {
      core_manpuz_cpp_CMansionPuzzleCircle_updatePanelTransform_FUN_004ca640(this_ptr,iVar3);
      iVar3 = iVar3 + 1;
    } while (iVar3 < 0xc);
    iVar3 = 0;
    do {
      core_manpuz_cpp_CMansionPuzzleCircle_updateReflectorPosition_FUN_004cb980(this_ptr,iVar3);
      iVar3 = iVar3 + 1;
    } while (iVar3 < 2);
