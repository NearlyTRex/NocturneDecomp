...

{
  ...
  do {
    if (*local_2c != 0) {
      ...
      piVar3 = local_2c + 9;
      core_dirmat_cpp_CMatrix3x3f_transformVectorTranspose_FUN_0044daa0(piVar3,local_6c,&local_b4);
      core_dirmat_cpp_CMatrix3x3f_transformVectorTranspose_FUN_0044daa0(piVar3,local_3c,param_3);
    ...
    do {
      ...
      local_18 = (float)core_dtri_cpp_rayTriangleIntersection_FUN_0046c620(iVar4,param_2,param_3);
      if ((0.0 <= local_18) && (local_18 < local_1c)) {
  ...
  iVar1 = core_dmodel_cpp_CKeyFramedModelInstance_getModelPtr_FUN_00454530(param_1 + 0x448);
  ...
  do {
    if (0.0 < *(float *)(iVar1 + 0x18)) {
      ...
      iVar4 = iVar1 + 0x34;
      core_dirmat_cpp_CMatrix3x3f_transformVectorTranspose_FUN_0044daa0(iVar4,local_60,&local_9c);
      core_dirmat_cpp_CMatrix3x3f_transformVectorTranspose_FUN_0044daa0(iVar4,local_78,param_3);
      local_18 = (float)core_box_cpp_CBoundingBox3D_doesRayIntersect_FUN_0041d550
                                  (&local_cc,local_60,local_78,local_54);
      if ((0.0 <= local_18) && (local_18 < local_1c)) {
        local_1c = local_18;
        pfVar2 = (float *)core_dirmat_cpp_CMatrix3x3f_transformVector_FUN_0044da40
                                    (iVar4,local_84,local_54);
        if (param_4 != pfVar2) {
          *param_4 = *pfVar2;
          param_4[1] = pfVar2[1];
          param_4[2] = pfVar2[2];
