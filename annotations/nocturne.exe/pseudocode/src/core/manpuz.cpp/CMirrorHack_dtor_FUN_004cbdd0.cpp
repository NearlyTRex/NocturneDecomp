...
// Convention: unknown
// Signature: CDemonActor * core_manpuz_cpp_CMirrorHack_dtor_FUN_004cbdd0(CDemonActor *param_1,byte param_2)
...

{
  ...
  if ((param_2 & 4) != 0) {
    ptr = __vec_delete(param_1,&g_CMirrorHackTypeInfo_005a0270);
