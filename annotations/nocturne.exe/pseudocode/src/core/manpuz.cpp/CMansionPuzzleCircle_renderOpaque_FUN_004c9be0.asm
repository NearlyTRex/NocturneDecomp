...
section .text
    ...
    PUSH ESI                            ; 004c9be0
        ;   Label: core_manpuz.cpp_CMansionPuzzleCircle_renderOpaque_FUN_004c9be0
    PUSH EDI                            ; 004c9be1
    ...
    MOV EAX,[0x005baf90]                ; 004c9c89 | g_CDemonMission_PTR_005baf90
    ...
    CALL engine_drender.cpp_CDemonRenderer_isShadowPass_FUN_00461090 ; 004c9ccb
