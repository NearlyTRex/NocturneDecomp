...

{
  ...
  fVar2 = (float)core_motion_cpp_CMotionController_getStateBlendWeight_FUN_004e18d0(pCVar1,4);
  fVar3 = (float)core_motion_cpp_CMotionController_getStateBlendWeight_FUN_004e18d0(pCVar1,5);
  fVar4 = (float)core_motion_cpp_CMotionController_getStateBlendWeight_FUN_004e18d0(pCVar1,0xc);
  fVar5 = (float)core_motion_cpp_CMotionController_getStateBlendWeight_FUN_004e18d0(pCVar1,0xd);
  fVar6 = (float)core_motion_cpp_CMotionController_getStateBlendWeight_FUN_004e18d0(pCVar1,0xe);
  ...
  if ((float)0.0001 < local_28) {
    ...
    iVar8 = core_motion_cpp_CMotionList_findMotionIndex_FUN_004e1010
                      (&this_ptr_00->motion_list,motion_name,iVar8);
    uVar7 = core_motion_cpp_CMotionController_markerPositionToFrame_FUN_004e1f50
                      (pCVar1,iVar8,(this_ptr->base).base.layer_action_t);
    core_skeleton_cpp_CDeformableModelInstance_blendMotion_FUN_0051c3d0
              (pCVar1,iVar8,uVar7,local_28,_DAT_01e533c8,core_skeleton_cpp_FUN_0051b650);
