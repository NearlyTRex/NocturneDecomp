// Name: core_scat.cpp_CScat_FUN_004fdd00
// Address: 004fdd00
// Address Range: [[004fdd00, 004fde21]]
// Convention: __cdecl
// Signature: void __cdecl core_scat_cpp_CScat_FUN_004fdd00(CScat *this_ptr)
...

{
  ...
  if ((this_ptr->weapon_actor != (CWeapon *)0x0) && (this_ptr->weapon_actor->weapon_type != 8)) {
    ...
    core_xform_cpp_multiplyMatrix3x4_FUN_0055aa00(&local_70,&local_160,&local_100);
    pCVar3 = &local_100;
    pCVar4 = &local_a0;
    for (iVar2 = 0xc; iVar2 != 0; iVar2 = iVar2 + -1) {
      pCVar4->m[0].w = pCVar3->m[0].w;
