...
;   core_scat.cpp_CScat_blendAimBones_FUN_004fd1d0
...
section .text
    ...
    PUSH ECX                            ; 004fd1b4
        ;   Label: LAB_004fd1b4
    PUSH EBX                            ; 004fd1b5
    CALL core_scat.cpp_CScat_blendAimBones_FUN_004fd1d0 ; 004fd1b6
        ;   XREF to: 004fd1d0 (UNCONDITIONAL_CALL)  ; void core_scat.cpp_CScat_blendAimBones_FUN_004fd1d0(CScat * this_ptr, int hand_index)
