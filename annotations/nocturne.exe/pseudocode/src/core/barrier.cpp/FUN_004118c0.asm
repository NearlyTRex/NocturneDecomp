...
section .text
    ...
    PUSH EBX                            ; 004118c0
        ;   Label: core_barrier.cpp_FUN_004118c0
    ...
    PUSH 0x1                            ; 004118cc
    PUSH EBX                            ; 004118ce
    CALL core_actor.cpp_CDemonActor_dtor_FUN_00409ea0 ; 004118cf
    ...
    POP EBX                             ; 004118e4
    RET                                 ; 004118e5
    PUSH 0x599e50                       ; 004118e6 | g_CBarrierTypeInfo_00599e50
        ;   Label: LAB_004118e6
    PUSH EBX                            ; 004118eb
    CALL crt_memory.c___vec_delete_FUN_0056445f ; 004118ec
        ;   XREF to: 0056445f (UNCONDITIONAL_CALL)  ; void * crt_memory.c___vec_delete_FUN_0056445f(void * object_ptr, WatcomTypeInfo * type_info)
    ADD ESP,0x8                         ; 004118f1
    PUSH EAX                            ; 004118f4
    CALL shape_memdbg.cpp_free_FUN_00564486 ; 004118f5
    ...
    PUSH EAX                            ; 00411901
        ;   Label: LAB_00411901
    CALL crt_unknown.c_FUN_00564494     ; 00411902
