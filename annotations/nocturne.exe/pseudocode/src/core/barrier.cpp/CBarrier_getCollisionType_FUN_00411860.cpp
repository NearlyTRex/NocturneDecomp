...
// Convention: unknown
// Signature: undefined4 core_barrier_cpp_CBarrier_getCollisionType_FUN_00411860(int param_1,int *param_2)

#include "nocturne.h"

uint core_barrier_cpp_CBarrier_getCollisionType_FUN_00411860(int param_1,int *param_2)
