...
;   core_set.cpp_CDemonSet_renderScene_FUN_00509a80 at 00509dbd
;   core_set.cpp_CDemonSet_setCameraView_FUN_005088f0 at 00508bfb
;
; Referenced Globals:
;   double DOUBLE_0059759f = 3.14159265350000
;   double DOUBLE_005975a7 = 0.5
;   double DOUBLE_005975af = 2
;   double DOUBLE_005975b7 = 0.25
...
;   engine_drender.cpp_CDemonRenderer_renderDecalPoly_FUN_0045f9d0
...
section .text
    ...
    PUSH EBX                            ; 00550cb0
        ;   Label: core_water.cpp_CWater_render_FUN_00550cb0
    PUSH ESI                            ; 00550cb1
    PUSH EDI                            ; 00550cb2
    PUSH EBP                            ; 00550cb3
    ...
    MOV EAX,[0x005ae704]                ; 00550d50 | g_CDemonRenderer_PTR_005ae704
    PUSH EAX                            ; 00550d55 | DAT_01b4d738
    CALL engine_drender.cpp_CDemonRenderer_captureTexture_FUN_00461eb0 ; 00550d56
        ;   XREF to: 00461eb0 (UNCONDITIONAL_CALL)  ; void engine_drender.cpp_CDemonRenderer_captureTexture_FUN_00461eb0(CDemonRenderer * this_ptr, SMRGLTextureBasic * texture)
    MOV EAX,[0x005b9354]                ; 00550d5b | g_CGame_PTR_005b9354
    FLD float ptr [EAX + 0x264]         ; 00550d60 | g_CGame_01c775ec.delta_time_float
    FMUL double ptr [0x0059759f]        ; 00550d66 | DOUBLE_0059759f
    FMUL double ptr [0x005975a7]        ; 00550d6c | DOUBLE_005975a7
    FMUL double ptr [0x005975af]        ; 00550d72 | DOUBLE_005975af
    ...
    MOV EBX,dword ptr [0x005ae704]      ; 00550de6 | g_CDemonRenderer_PTR_005ae704
    ...
    CALL engine_drender.cpp_CDemonRenderer_processCameraRelativeVertex_FUN_00460a00 ; 00550e22
    ...
    FLD double ptr [0x0059759f]         ; 00550e5c | DOUBLE_0059759f
    FILD dword ptr [ESP + 0x5c]         ; 00550e62
    FMUL ST1                            ; 00550e66
    FMUL double ptr [0x005975a7]        ; 00550e68 | DOUBLE_005975a7
    ...
    FSIN                                ; 00550e80
    FMUL double ptr [0x005975b7]        ; 00550e82 | DOUBLE_005975b7
    FSTP float ptr [ESP + 0x8]          ; 00550e88
    LEA EBX,[ESP + 0x10]                ; 00550e8c
        ;   Label: LAB_00550e8c
    LEA EAX,[ESP + 0x4]                 ; 00550e90
    MOV EDX,dword ptr [0x005ae704]      ; 00550e94 | g_CDemonRenderer_PTR_005ae704
    ...
    PUSH EAX                            ; 00550ec3
    CALL engine_special.cpp_transformAndProjectPoint_FUN_0053075c ; 00550ec4
    ...
    PUSH EAX                            ; 00550ed7
    MOV EAX,[0x005be368]                ; 00550ed8 | g_CDemonSet_PTR_005be368
    PUSH EAX                            ; 00550edd | g_CDemonSet_01e57284
    CALL core_set.cpp_CDemonSet_computeVertexOmniLighting_FUN_0050be20 ; 00550ede
    ...
    FLD double ptr [0x0059759f]         ; 00550ef9 | DOUBLE_0059759f
    FILD dword ptr [ESP + 0x5c]         ; 00550eff
    FMUL ST1                            ; 00550f03
    LEA EAX,[EDI + 0x1]                 ; 00550f05
    FMUL double ptr [0x005975a7]        ; 00550f08 | DOUBLE_005975a7
    ...
    FSIN                                ; 00550f20
    FMUL double ptr [0x005975b7]        ; 00550f22 | DOUBLE_005975b7
    FSTP float ptr [ESP + 0x8]          ; 00550f28
    LEA EBX,[ESP + 0x1c]                ; 00550f2c
        ;   Label: LAB_00550f2c
    LEA EAX,[ESP + 0x4]                 ; 00550f30
    MOV EDX,dword ptr [0x005ae704]      ; 00550f34 | g_CDemonRenderer_PTR_005ae704
    ...
    PUSH EAX                            ; 00550f66
    CALL engine_special.cpp_transformAndProjectPoint_FUN_0053075c ; 00550f67
        ;   XREF to: 0053075c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_0053075c(SProjectedVertex * output, CVector3i * input)
    ...
    PUSH EAX                            ; 00550f7a
    MOV ECX,dword ptr [0x005be368]      ; 00550f7b | g_CDemonSet_PTR_005be368
    PUSH ECX                            ; 00550f81 | g_CDemonSet_01e57284
    CALL core_set.cpp_CDemonSet_computeVertexOmniLighting_FUN_0050be20 ; 00550f82
        ;   XREF to: 0050be20 (UNCONDITIONAL_CALL)  ; void core_set.cpp_CDemonSet_computeVertexOmniLighting_FUN_0050be20(CDemonSet * this_ptr, CVector3f * vertex_position, CVector3f * position_offset, int vertex_index)
    ...
    FLD double ptr [0x0059759f]         ; 00550f9e | DOUBLE_0059759f
    FILD dword ptr [ESP + 0x5c]         ; 00550fa4
    FMUL ST1                            ; 00550fa8
    LEA EAX,[EDI + 0x1]                 ; 00550faa
    FMUL double ptr [0x005975a7]        ; 00550fad | DOUBLE_005975a7
    ...
    FSIN                                ; 00550fc5
    FMUL double ptr [0x005975b7]        ; 00550fc7 | DOUBLE_005975b7
    FSTP float ptr [ESP + 0x8]          ; 00550fcd
    LEA EBX,[ESP + 0x28]                ; 00550fd1
        ;   Label: LAB_00550fd1
    LEA EAX,[ESP + 0x4]                 ; 00550fd5
    MOV EDX,dword ptr [0x005ae704]      ; 00550fd9 | g_CDemonRenderer_PTR_005ae704
    ...
    PUSH EAX                            ; 0055100b
    CALL engine_special.cpp_transformAndProjectPoint_FUN_0053075c ; 0055100c
        ;   XREF to: 0053075c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_0053075c(SProjectedVertex * output, CVector3i * input)
    ...
    PUSH EAX                            ; 0055101f
    MOV EAX,[0x005be368]                ; 00551020 | g_CDemonSet_PTR_005be368
    PUSH EAX                            ; 00551025 | g_CDemonSet_01e57284
    CALL core_set.cpp_CDemonSet_computeVertexOmniLighting_FUN_0050be20 ; 00551026
        ;   XREF to: 0050be20 (UNCONDITIONAL_CALL)  ; void core_set.cpp_CDemonSet_computeVertexOmniLighting_FUN_0050be20(CDemonSet * this_ptr, CVector3f * vertex_position, CVector3f * position_offset, int vertex_index)
    ...
    FLD double ptr [0x0059759f]         ; 00551041 | DOUBLE_0059759f
    FILD dword ptr [ESP + 0x5c]         ; 00551047
    FMUL ST1                            ; 0055104b
    FMUL double ptr [0x005975a7]        ; 0055104d | DOUBLE_005975a7
    ...
    FSIN                                ; 00551065
    FMUL double ptr [0x005975b7]        ; 00551067 | DOUBLE_005975b7
    FSTP float ptr [ESP + 0x8]          ; 0055106d
    LEA EBX,[ESP + 0x34]                ; 00551071
        ;   Label: LAB_00551071
    LEA EAX,[ESP + 0x4]                 ; 00551075
    MOV EDI,dword ptr [0x005ae704]      ; 00551079 | g_CDemonRenderer_PTR_005ae704
    ...
    PUSH EAX                            ; 005510ad
    CALL engine_special.cpp_transformAndProjectPoint_FUN_0053075c ; 005510ae
        ;   XREF to: 0053075c (UNCONDITIONAL_CALL)  ; void engine_special.cpp_transformAndProjectPoint_FUN_0053075c(SProjectedVertex * output, CVector3i * input)
    ...
    PUSH EAX                            ; 005510c1
    MOV EBX,dword ptr [0x005be368]      ; 005510c2 | g_CDemonSet_PTR_005be368
    PUSH EBX                            ; 005510c8 | g_CDemonSet_01e57284
    CALL core_set.cpp_CDemonSet_computeVertexOmniLighting_FUN_0050be20 ; 005510c9
        ;   XREF to: 0050be20 (UNCONDITIONAL_CALL)  ; void core_set.cpp_CDemonSet_computeVertexOmniLighting_FUN_0050be20(CDemonSet * this_ptr, CVector3f * vertex_position, CVector3f * position_offset, int vertex_index)
    ...
    MOV EDX,dword ptr [0x005ae704]      ; 005510dc | g_CDemonRenderer_PTR_005ae704
    PUSH EDX                            ; 005510e2 | DAT_01b4d738
    CALL engine_drender.cpp_CDemonRenderer_setRenderAlpha_FUN_00461010 ; 005510e3
    ...
    MOV ECX,dword ptr [0x005ae704]      ; 005510f0 | g_CDemonRenderer_PTR_005ae704
    ...
    MOV EBX,dword ptr [0x005ae704]      ; 00551151 | g_CDemonRenderer_PTR_005ae704
    PUSH EBX                            ; 00551157 | DAT_01b4d738
    CALL engine_drender.cpp_CDemonRenderer_renderAlphaBlendedPoly_FUN_0045f790 ; 00551158
    ...
    PUSH 0x1                            ; 0055115f
        ;   Label: LAB_0055115f
    MOV EDI,dword ptr [0x005ae704]      ; 00551161 | g_CDemonRenderer_PTR_005ae704
    PUSH EDI                            ; 00551167 | DAT_01b4d738
    CALL engine_drender.cpp_CDemonRenderer_setCurrentPolygonColor_FUN_00460f10 ; 00551168
    ...
    MOV EAX,[0x005ae704]                ; 00551175 | g_CDemonRenderer_PTR_005ae704
    ...
    PUSH 0x5c1374                       ; 00551185 | DAT_005c1374
        ;   Label: LAB_00551185
    MOV ECX,dword ptr [0x005ae704]      ; 0055118a | g_CDemonRenderer_PTR_005ae704
