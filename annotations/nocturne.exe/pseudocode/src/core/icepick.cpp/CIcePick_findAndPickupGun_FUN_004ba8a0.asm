...
section .text
    ...
    PUSH EBX                            ; 004ba8a0
        ;   Label: core_icepick.cpp_CIcePick_findAndPickupGun_FUN_004ba8a0
    PUSH ESI                            ; 004ba8a1
    PUSH EDI                            ; 004ba8a2
    PUSH EBP                            ; 004ba8a3
    ...
    MOV EAX,[0x005be368]                ; 004ba8f4 | g_CDemonSet_PTR_005be368
        ;   Label: LAB_004ba8f4
    CMP ESI,dword ptr [EAX + 0x14cd6c]  ; 004ba8f9 | g_CDemonSet_01e57284.actor_count
    ...
    POP EBX                             ; 004ba919
    RET                                 ; 004ba91a
    MOV EBX,dword ptr [EDI + EAX*0x1 + 0x14cd70] ; 004ba91b | g_CDemonSet_01e57284.actors[0]
        ;   Label: LAB_004ba91b
    PUSH EBX                            ; 004ba922
