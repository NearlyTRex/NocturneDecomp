...
section .text
    ...
    CALL core_charactr.cpp_CCharacter_processWalking_FUN_00428c00 ; 004ba09b
    ...
    PUSH dword ptr [EBP + 0x18]         ; 004ba2e3
        ;   Label: LAB_004ba2e3
    PUSH EBX                            ; 004ba2e6
    CALL core_icepick.cpp_CIcePick_updateShootBlend_FUN_004ba740 ; 004ba2e7
        ;   XREF to: 004ba740 (UNCONDITIONAL_CALL)  ; void core_icepick.cpp_CIcePick_updateShootBlend_FUN_004ba740(CIcePick * this_ptr, float delta_time)
    ADD ESP,0x8                         ; 004ba2ec
    PUSH dword ptr [EBP + 0x18]         ; 004ba2ef
    PUSH EBX                            ; 004ba2f2
    CALL core_charactr.cpp_CCharacter_applyGestureLookAt_FUN_0042a150 ; 004ba2f3
    ...
    PUSH dword ptr [EBP + 0x18]         ; 004ba302
        ;   Label: LAB_004ba302
    PUSH EBX                            ; 004ba305
    CALL core_icepick.cpp_CIcePick_processAI_FUN_004baba0 ; 004ba306
        ;   XREF to: 004baba0 (UNCONDITIONAL_CALL)  ; void core_icepick.cpp_CIcePick_processAI_FUN_004baba0(CIcePick * this_ptr, float delta_time)
    ...
    JNZ 0x004ba3fc                      ; 004ba4ff
        ;   XREF to: 004ba3fc (CONDITIONAL_JUMP)  ; LAB_004ba3fc
    PUSH EBX                            ; 004ba505
    CALL core_hero.cpp_CHero_tryOpenNearbyDoor_FUN_004b5110 ; 004ba506
