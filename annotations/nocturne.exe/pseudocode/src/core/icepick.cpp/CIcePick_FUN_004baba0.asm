...
section .text
    ...
    PUSH EBX                            ; 004baba0
        ;   Label: core_icepick.cpp_CIcePick_FUN_004baba0
    PUSH ESI                            ; 004baba1
    PUSH EDI                            ; 004baba2
    PUSH EBP                            ; 004baba3
    ...
    PUSH EBX                            ; 004bb08b
    CALL core_charactr.cpp_CCharacter_FUN_0042af70 ; 004bb08c
    ...
    PUSH dword ptr [EBP + 0x18]         ; 004bb22e
        ;   Label: LAB_004bb22e
    PUSH EBX                            ; 004bb231
    CALL core_charactr.cpp_CCharacter_FUN_0042af70 ; 004bb232
        ;   XREF to: 0042af70 (UNCONDITIONAL_CALL)  ; int core_charactr.cpp_CCharacter_FUN_0042af70(CCharacter * this_ptr, float delta_time)
