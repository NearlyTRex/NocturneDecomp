...
section .text
    ...
    POP EBX                             ; 0048e92b
    RET                                 ; 0048e92c
    PUSH 0x59d760                       ; 0048e92d | DAT_0059d760
        ;   Label: LAB_0048e92d
    PUSH EBX                            ; 0048e932
    CALL FUN_0056445f                   ; 0048e933
        ;   XREF to: 0056445f (UNCONDITIONAL_CALL)  ; undefined FUN_0056445f()
    ADD ESP,0x8                         ; 0048e938
    PUSH EAX                            ; 0048e93b
    CALL FUN_00564486                   ; 0048e93c
