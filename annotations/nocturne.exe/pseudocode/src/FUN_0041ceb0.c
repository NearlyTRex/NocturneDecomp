...
// Convention: unknown
// Signature: undefined4 FUN_0041ceb0(float *param_1,int param_2)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_0041ceb0(float *param_1,int param_2)

{
  ...
  if (iVar1 == 0) {
    ...
    FUN_0053075c(local_74,&local_2c);
    ...
    if (_DAT_007f7370 == 0) {
      ...
      FUN_00447670(0x1fb8508,&local_14,local_74);
      if (65000 < _DAT_01c038f4) {
        return 0;
      }
    }
  }
  else if ((param_2 == 0) && (iVar1 = FUN_0041cce0(param_1), iVar1 == 0)) {
    return 0;
  }
  return 1;
}
