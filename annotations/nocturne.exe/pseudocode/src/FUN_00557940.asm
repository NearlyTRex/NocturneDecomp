...
section .text
    ...
    PUSH EAX                            ; 00557a6d
    CALL FUN_004e16b0                   ; 00557a6e
        ;   XREF to: 004e16b0 (UNCONDITIONAL_CALL)  ; undefined FUN_004e16b0()
    ADD ESP,0xc                         ; 00557a73
    PUSH EDI                            ; 00557a76
    PUSH ESI                            ; 00557a77
    CALL FUN_00479f70                   ; 00557a78
        ;   XREF to: 00479f70 (UNCONDITIONAL_CALL)  ; undefined FUN_00479f70()
