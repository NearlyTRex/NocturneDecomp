...
;
; Referenced Globals:
;   undefined4 DAT_005777a9
;   undefined4 DAT_005777b1
;
; *****************************************************************************
...
section .text
    ...
    FCOMP double ptr [0x005777a9]       ; 0040b265 | DAT_005777a9
    FNSTSW AX                           ; 0040b26b
    SAHF                                ; 0040b26d
    JBE 0x0040b29d                      ; 0040b26e
        ;   XREF to: 0040b29d (CONDITIONAL_JUMP)  ; LAB_0040b29d
    FLD double ptr [ESP]                ; 0040b270
    FCOMP double ptr [0x005777b1]       ; 0040b273 | DAT_005777b1
    FNSTSW AX                           ; 0040b279
    SAHF                                ; 0040b27b
    ...
    FCOMP double ptr [0x005777a9]       ; 0040b2d0 | DAT_005777a9
    FNSTSW AX                           ; 0040b2d6
    SAHF                                ; 0040b2d8
