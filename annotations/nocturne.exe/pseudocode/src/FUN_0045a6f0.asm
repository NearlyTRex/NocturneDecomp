...
section .text
    ...
    PUSH EDI                            ; 0045a75c
        ;   Label: LAB_0045a75c
    PUSH ESI                            ; 0045a75d
    CALL FUN_0045a6a0                   ; 0045a75e
        ;   XREF to: 0045a6a0 (UNCONDITIONAL_CALL)  ; undefined FUN_0045a6a0()
    ...
    PUSH EAX                            ; 0045a839
    MOV ECX,dword ptr [0x005b80f0]      ; 0045a83a | DAT_005b80f0
    PUSH ECX                            ; 0045a840
    INC EBX                             ; 0045a841
    CALL FUN_0048ae90                   ; 0045a842
    ...
    LEA EAX,[ESI + 0x150]               ; 0045a8a5
        ;   Label: LAB_0045a8a5
    PUSH EAX                            ; 0045a8ab
    CALL FUN_004e16b0                   ; 0045a8ac
        ;   XREF to: 004e16b0 (UNCONDITIONAL_CALL)  ; undefined FUN_004e16b0()
    ADD ESP,0xc                         ; 0045a8b1
    PUSH 0x3ecccccd                     ; 0045a8b4
        ;   Label: LAB_0045a8b4
    CALL FUN_0040dea0                   ; 0045a8b9
        ;   XREF to: 0040dea0 (UNCONDITIONAL_CALL)  ; undefined FUN_0040dea0()
    ...
    PUSH ESI                            ; 0045a8d3
    CALL FUN_0045ab40                   ; 0045a8d4
        ;   XREF to: 0045ab40 (UNCONDITIONAL_CALL)  ; undefined FUN_0045ab40()
    ADD ESP,0xc                         ; 0045a8d9
    PUSH EDI                            ; 0045a8dc
    PUSH ESI                            ; 0045a8dd
    CALL FUN_00479f70                   ; 0045a8de
        ;   XREF to: 00479f70 (UNCONDITIONAL_CALL)  ; undefined FUN_00479f70()
