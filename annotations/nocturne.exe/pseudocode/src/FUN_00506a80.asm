...
section .text
    ...
    PUSH 0x5a18a0                       ; 00506b11 | DAT_005a18a0
        ;   Label: LAB_00506b11
    PUSH EBX                            ; 00506b16
    CALL FUN_0056445f                   ; 00506b17
        ;   XREF to: 0056445f (UNCONDITIONAL_CALL)  ; undefined FUN_0056445f()
    ADD ESP,0x8                         ; 00506b1c
    PUSH EAX                            ; 00506b1f
    CALL FUN_00564486                   ; 00506b20
