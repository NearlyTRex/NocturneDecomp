...
// Convention: unknown
// Signature: void FUN_004c59e0(int *param_1,int param_2,int param_3)
...

{
  ...
  if (param_1[3] != 0) {
    ...
    if (param_1[0x44] != 0) {
      FUN_00460e40(DAT_005ae704,param_1[0x45],param_1[0x46],param_1[0x47],param_1[0x48]);
    }
    ...
    *(uint *)(iVar3 + 0x15aa94) =
    ...
    FUN_0053075c(*DAT_005ae704 + 0x60,&local_3c);
    local_30 = -local_30;
    ...
    FUN_0053075c(*DAT_005ae704 + 0x90,&local_48);
    piVar1 = DAT_005ae704;
    ...
    *(uint *)(*piVar1 + 0xbc) = 0;
    ...
    FUN_00461eb0(DAT_005ae704,&DAT_005baca4);
    FUN_0045f3c0(DAT_005ae704,local_88,0x327);
    FUN_00461000(DAT_005ae704,0);
    FUN_00453040(0x1cc3290,0,0,0x205);
    if (param_1[0x44] != 0) {
    ...
    *param_1 = iVar3 + 1;
    ...
    if (param_1[0x44] == 0) {
      FUN_00403e60(iVar4 + -1,local_14 + -1,iVar2 + 1 + iVar4,local_14 + iVar5 + 1,0);
      if (param_2 != 0) {
        iVar3 = FUN_00492da0(local_10,param_2);
        FUN_00490980(local_10,param_2,(iVar4 + iVar2 / 2) - iVar3 / 2,
