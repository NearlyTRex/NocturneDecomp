...
;
; XREF[2]:
;   FUN_00564e98 at 00564ede
;   FUN_00564fd8 at 0056501e
;
; Referenced Globals:
;   void* PTR_FUN_005a48bc = 0056b5ad
;   void* PTR_LAB_005a48c4 = 0056b491
...
section .text
    ...
    PUSH EBX                            ; 0056b5d5
    MOV dword ptr [EBX + EAX*0x1 + 0x24],0x5a48c4 ; 0056b5d6 | PTR_LAB_005a48c4
    ...
    PUSH 0x5a4980                       ; 0056b5fd | DAT_005a4980
        ;   Label: LAB_0056b5fd
    PUSH EBX                            ; 0056b602
    CALL FUN_0056445f                   ; 0056b603
        ;   XREF to: 0056445f (UNCONDITIONAL_CALL)  ; undefined FUN_0056445f()
    ADD ESP,0x8                         ; 0056b608
    PUSH EAX                            ; 0056b60b
    CALL FUN_00564486                   ; 0056b60c
