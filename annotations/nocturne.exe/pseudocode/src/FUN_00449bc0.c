...
// Convention: unknown
// Signature: undefined4 FUN_00449bc0(float *param_1,float *param_2,float param_3,float *param_4)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_00449bc0(float *param_1,float *param_2,float param_3,float *param_4)
