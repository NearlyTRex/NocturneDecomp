...
section .text
    ...
    CALL FUN_00574540                   ; 005740cb
        ;   XREF to: 00574540 (UNCONDITIONAL_CALL)  ; undefined FUN_00574540()
    ...
    PUSH ECX                            ; 00574193
    CALL FUN_00574570                   ; 00574194
        ;   XREF to: 00574570 (UNCONDITIONAL_CALL)  ; undefined FUN_00574570()
    ADD ESP,0x8                         ; 00574199
    MOV ESI,dword ptr [ESP + 0x8]       ; 0057419c
    PUSH ESI                            ; 005741a0
    MOV EBX,EAX                         ; 005741a1
    CALL FUN_005638d0                   ; 005741a3
        ;   XREF to: 005638d0 (UNCONDITIONAL_CALL)  ; undefined FUN_005638d0()
    ADD ESP,0x4                         ; 005741a8
    PUSH EBP                            ; 005741ab
    CALL FUN_005638d0                   ; 005741ac
        ;   XREF to: 005638d0 (UNCONDITIONAL_CALL)  ; undefined FUN_005638d0()
    ...
    CALL FUN_00574680                   ; 005741ce
        ;   XREF to: 00574680 (UNCONDITIONAL_CALL)  ; undefined FUN_00574680()
    PUSH EDI                            ; 005741d3
        ;   Label: LAB_005741d3
    CALL FUN_00574264                   ; 005741d4
