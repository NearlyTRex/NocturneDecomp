...
;   crt_unknown.c_FUN_00564a88 at 00564ac7
;
; Referenced Globals:
...
section .text
    ...
    CALL dword ptr [0x005c1ad8]         ; 0056b1a8 | PTR_FUN_005c1ad8
    ...
    MOV AX,DX                           ; 0056b1c4
    PUSH EAX                            ; 0056b1c7
    CALL FUN_0056afe8                   ; 0056b1c8
        ;   XREF to: 0056afe8 (UNCONDITIONAL_CALL)  ; undefined FUN_0056afe8()
    ADD ESP,0x10                        ; 0056b1cd
    TEST EAX,EAX                        ; 0056b1d0
    JNZ 0x0056b1e1                      ; 0056b1d2
        ;   XREF to: 0056b1e1 (CONDITIONAL_JUMP)  ; LAB_0056b1e1
    CALL dword ptr [0x005c1ae0]         ; 0056b1d4 | PTR_FUN_005c1ae0
    MOV EAX,EBX                         ; 0056b1da
    ADD ESP,0x4                         ; 0056b1dc
    POP EBX                             ; 0056b1df
    RET                                 ; 0056b1e0
    CALL dword ptr [0x005c1ae0]         ; 0056b1e1 | PTR_FUN_005c1ae0
        ;   Label: LAB_0056b1e1
