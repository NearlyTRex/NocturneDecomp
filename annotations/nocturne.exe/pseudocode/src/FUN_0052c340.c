...
// Convention: unknown
// Signature: undefined4 FUN_0052c340(int *param_1)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_0052c340(int *param_1)

{
  ...
  if (0 < _DAT_02dc943c) {
    iVar2 = 0;
    do {
      FUN_00563cc0(*(uint *)(iVar2 + 0x2dc93a8),0,0x20);
  ...
  iVar3 = FUN_005286d0(((double)_DAT_02dc9434 / (double)_DAT_02dc942c) * _DAT_00594925);
  if (iVar3 != 0) {
    return 1;
  }
LAB_0052c3d6:
