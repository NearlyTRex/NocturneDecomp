...
// Convention: unknown
// Signature: undefined4 FUN_00559260(HMODULE param_1,undefined4 param_2,undefined4 param_3,int param_4)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_00559260(HMODULE param_1,uint param_2,uint param_3,int param_4)
