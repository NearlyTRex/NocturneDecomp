// Name: FUN_004470f0
// Address: 004470f0
// Address Range: [[004445f1, 004445f8] [004470f0, 004474d5]]
// Convention: unknown
// Signature: void FUN_004470f0(int param_1)
    ...
    while ((int)uVar9 < *(int *)(param_1 + 0x140) + -1) {
      ...
      if (iVar10 < _DAT_012b0664) {
        do {
          ...
          iVar4 = iVar4 + 0xc;
          iVar10 = iVar10 + 1;
          FUN_00447c60(param_1,*puVar3,*puVar1,*puVar2);
    ...
    while ((int)uVar9 < *(int *)(param_1 + 0x140) + -1) {
      ...
      if (iVar10 < _DAT_012b0664) {
        do {
          ...
          iVar4 = iVar4 + 0xc;
          iVar10 = iVar10 + 1;
          FUN_00447bb0(param_1,*puVar3,*puVar1,*puVar2);
        } while (iVar10 < _DAT_012b0664);
        uVar9 = uVar9 + 1;
      }
      else {
