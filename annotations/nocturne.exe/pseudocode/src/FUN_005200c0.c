...
// Convention: unknown
// Signature: void FUN_005200c0(int param_1,float param_2)
...

{
  ...
  *(uint *)(param_1 + 0x23a4) = *(uint *)(param_1 + 0x23a8);
  ...
  iVar2 = param_1 + 0x150;
  while (0.0 < local_28) {
    uVar3 = FUN_004e11c0(iVar2,&local_28);
    if (uVar3 < 0x66) {
      if (uVar3 == 0x65) {
        iVar4 = *(int *)(param_1 + 0xbca4);
        if (iVar4 == 0) {
          FUN_004e16b0(iVar2,1,1);
        }
        else {
  ...
  *(float *)(param_1 + 0x2430) = param_2 * fVar1 * *(float *)(param_1 + 0xbc8c);
  ...
  if (iVar5 == 0) {
    switch(iVar4) {
    case 1:
      iVar4 = FUN_0047dc30(0x01C03A10,"Capture");
      if (iVar4 == 0) {
        ...
        if (iVar4 != 0) {
          ...
          if (local_20 < 0x40200000 + 1.0) {
            FUN_0054e4a0(local_c4,&local_58);
            local_14 = (float)FUN_0040df00(local_c0 - *(float *)(param_1 + 0x34));
            if (ABS(local_14) < (float)_DAT_00592095) {
              *(uint *)(param_1 + 0xbd58) = 0;
              FUN_004e16b0(iVar2,9,1);
            }
          }
      ...
      if (iVar4 == 0) {
        ...
        if (iVar4 != 0) {
          ...
          *(uint *)(param_1 + 0x23a4) = *(uint *)(param_1 + 0x23a8);
          ...
          iVar2 = FUN_004247f0(param_1,*(int *)(param_1 + 0xbca4) + 0x20,uVar7);
          if ((-1 < iVar2) && (0 < iVar2)) {
    ...
    case 6:
      if (*(int *)(param_1 + 0xbca4) == 0) {
        ...
        FUN_00423ed0(local_190);
        local_18c = (float)FUN_0040dda0(0x40e00000,0x41700000);
        local_15c = param_1;
        local_158 = param_1;
        local_14 = local_18c;
        uVar7 = FUN_0055a8b0(local_b8,&DAT_02dd1184,_DAT_02da8a7c * 0x30 + param_1 + 0xfd0,
                             0x3f800000,local_190);
        uVar7 = FUN_0040a240(param_1,local_dc,uVar7);
        FUN_004798e0(param_1,uVar7);
      }
      break;
    case 8:
      if ((*(int *)(param_1 + 0xbc90) == 0) && (*(int *)(param_1 + 0xdc) == 0)) {
        uVar7 = FUN_0051d2a0(iVar2,local_40,0);
        FUN_0040a240(param_1,local_4c,uVar7);
        FUN_004b0480(0x01C78C7C,local_4c,0);
    ...
    case 9:
      ...
      if ((iVar4 == 0) || (*(int *)(iVar4 + 0x2590) == 0)) {
        ...
        if (iVar4 == 0) {
          FUN_00423ed0(local_154);
          local_150 = (float)FUN_0040dda0(0x40e00000,0x41700000);
          local_120 = param_1;
          local_11c = param_1;
          local_14 = local_150;
          uVar7 = FUN_0055a8b0(local_88,&DAT_02dd1184,param_1 + 0xfd0 + _DAT_02da8a7c * 0x30,
                               0x3f800000,local_154);
          uVar7 = FUN_0040a240(param_1,local_d0,uVar7);
          FUN_004798e0(param_1,uVar7);
        }
        else {
...
switchD_00520915_caseD_3:
  ...
  if (local_24 == 0xb) {
    pfVar6 = (float *)FUN_0040a200(param_1,local_70,(uint *)(param_1 + 0x23a4));
