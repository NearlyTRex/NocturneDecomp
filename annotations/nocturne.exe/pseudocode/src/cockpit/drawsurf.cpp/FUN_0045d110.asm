...
section .text
    ...
    PUSH EDI                            ; 0045d174
    INC ESI                             ; 0045d175
    CALL FUN_0045bc20                   ; 0045d176
        ;   XREF to: 0045bc20 (UNCONDITIONAL_CALL)  ; undefined FUN_0045bc20()
    ...
    MOV dword ptr [0x01cc4800],EDX      ; 0045d28d | DAT_01cc4800
    MOV dword ptr [0x01cc4804],ECX      ; 0045d293 | DAT_01cc4804
    CALL FUN_004c8440                   ; 0045d299
