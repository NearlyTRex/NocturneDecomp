...
;                               FUNCTION
; *****************************************************************************
; void cockpit_drawsurf_cpp_FUN_0045df20(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,undefined4 param_5)
;
;
; XREF[3]:
;   cockpit_drawsurf.cpp_FUN_0045df50 at 0045df6c
;   cockpit_drawsurf.cpp_FUN_0045df80 at 0045dfe3
;   cockpit_drawsurf.cpp_FUN_0045e1a0 at 0045e1b7
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 0045df20
        ;   Label: cockpit_drawsurf.cpp_FUN_0045df20
    PUSH ESI                            ; 0045df21
    PUSH EDI                            ; 0045df22
    PUSH 0x6                            ; 0045df23
