...
;
; XREF[3]:
;   cockpit_drawsurf.cpp_CDrawSurface_drawCenteredRectangleOutline_FUN_0045cb90 at 0045cbf0
;   cockpit_drawsurf.cpp_CDrawSurface_drawRectangleBetweenPoints_FUN_0045cc10 at 0045cc5c
