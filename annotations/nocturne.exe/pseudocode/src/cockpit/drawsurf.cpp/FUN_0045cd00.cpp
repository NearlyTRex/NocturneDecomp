...
// Convention: unknown
// Signature: void cockpit_drawsurf_cpp_FUN_0045cd00(undefined4 param_1,int param_2,int param_3,uint param_4,uint param_5)

#include "nocturne.h"

void cockpit_drawsurf_cpp_FUN_0045cd00(uint param_1,int param_2,int param_3,uint param_4,uint param_5)
