...
;                               FUNCTION
; *****************************************************************************
; void cockpit_drawsurf_cpp_FUN_0045dbd0(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
;
;
; XREF[2]:
;   cockpit_drawsurf.cpp_FUN_0045dc00 at 0045dc16
;   cockpit_drawsurf.cpp_FUN_0045dc30 at 0045dc8a
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 0045dbd0
        ;   Label: cockpit_drawsurf.cpp_FUN_0045dbd0
    PUSH ESI                            ; 0045dbd1
    PUSH 0x2                            ; 0045dbd2
    PUSH 0x0                            ; 0045dbd4
