...
;                               FUNCTION
; *****************************************************************************
; void cockpit_drawsurf_cpp_FUN_0045da60(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
;
;
; XREF[1]:
;   cockpit_drawsurf.cpp_FUN_0045e370 at 0045e4fb
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 0045da60
        ;   Label: cockpit_drawsurf.cpp_FUN_0045da60
    PUSH ESI                            ; 0045da61
