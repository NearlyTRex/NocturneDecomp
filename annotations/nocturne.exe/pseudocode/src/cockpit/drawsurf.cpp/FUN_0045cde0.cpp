// Name: cockpit_drawsurf.cpp_FUN_0045cde0
// Address: 0045cde0
// Address Range: [[0045cde0, 0045cfc2]]
// Convention: unknown
// Signature: void cockpit_drawsurf_cpp_FUN_0045cde0(int param_1,int param_2,int param_3,int param_4)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void cockpit_drawsurf_cpp_FUN_0045cde0(int param_1,int param_2,int param_3,int param_4)
