...
;                               FUNCTION
; *****************************************************************************
; void cockpit_drawsurf_cpp_FUN_0045dea0(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,undefined4 param_5)
;
; Local Variables:
...
;
; XREF[1]:
;   cockpit_drawsurf.cpp_FUN_0045e370 at 0045e8d1
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 0045dea0
        ;   Label: cockpit_drawsurf.cpp_FUN_0045dea0
    PUSH ESI                            ; 0045dea1
    PUSH EDI                            ; 0045dea2
    PUSH EBP                            ; 0045dea3
    ...
    CALL cockpit_drawsurf.cpp_FUN_0045de40 ; 0045df03
