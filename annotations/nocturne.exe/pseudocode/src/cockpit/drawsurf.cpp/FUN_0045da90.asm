...
;                               FUNCTION
; *****************************************************************************
; void cockpit_drawsurf_cpp_FUN_0045da90(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
;
; Local Variables:
...
;
; XREF[1]:
;   cockpit_drawsurf.cpp_FUN_0045e370 at 0045e7f0
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 0045da90
        ;   Label: cockpit_drawsurf.cpp_FUN_0045da90
    PUSH ESI                            ; 0045da91
    PUSH EDI                            ; 0045da92
