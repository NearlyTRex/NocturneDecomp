...
;                               FUNCTION
; *****************************************************************************
; void cockpit_drawsurf_cpp_FUN_0045e1f0(undefined4 param_1,undefined4 param_2,undefined4 param_3)
;
; Local Variables:
...
section .text
    ...
    PUSH EBX                            ; 0045e1f0
        ;   Label: cockpit_drawsurf.cpp_FUN_0045e1f0
    PUSH ESI                            ; 0045e1f1
    ...
    CALL cockpit_drawsurf.cpp_FUN_0045e1a0 ; 0045e241
