...
;                               FUNCTION
; *****************************************************************************
; void cockpit_drawsurf_cpp_FUN_0045cd00(undefined4 param_1,int param_2,int param_3,uint param_4,uint param_5)
;
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 0045cd00
        ;   Label: cockpit_drawsurf.cpp_FUN_0045cd00
    PUSH ESI                            ; 0045cd01
    PUSH EBP                            ; 0045cd02
    ...
    PUSH EBP                            ; 0045cd5f
    CALL cockpit_drawsurf.cpp_FUN_0045cc70 ; 0045cd60
