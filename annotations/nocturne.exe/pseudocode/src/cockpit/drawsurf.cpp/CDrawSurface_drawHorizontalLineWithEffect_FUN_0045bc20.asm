...
;
; XREF[2]:
;   cockpit_drawsurf.cpp_CDrawSurface_drawHorizontalLine_FUN_0045c730 at 0045c7c8
...
section .text
    ...
    PUSH EBX                            ; 0045bc20
        ;   Label: cockpit_drawsurf.cpp_CDrawSurface_drawHorizontalLineWithEffect_FUN_0045bc20
    PUSH ESI                            ; 0045bc21
    PUSH EDI                            ; 0045bc22
