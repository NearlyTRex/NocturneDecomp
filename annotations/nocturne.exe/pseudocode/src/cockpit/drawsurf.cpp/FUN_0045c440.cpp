...
// Convention: unknown
// Signature: undefined4 FUN_0045c440(undefined4 param_1,int *param_2,int *param_3,int *param_4,int *param_5,int param_6,int param_7,int param_8,int param_9)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_0045c440(uint param_1,int *param_2,int *param_3,int *param_4,int *param_5,int param_6,int param_7,int param_8,int param_9)

{
  ...
  if (iStack_20 == 100) {
    _DAT_01cc4800 = ">..\\cockpit\\drawsurf.cpp" + 1;
    _DAT_01cc4804 = 0x369;
