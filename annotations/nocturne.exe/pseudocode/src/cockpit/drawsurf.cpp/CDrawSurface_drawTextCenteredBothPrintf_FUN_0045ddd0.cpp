...
// Convention: __cdecl
// Signature: void __cdecl cockpit_drawsurf_cpp_CDrawSurface_drawTextCenteredBothPrintf_FUN_0045ddd0(CDrawSurface *this_ptr,int x,int y,char *format)
...

{
  ...
  local_10 = (byte *)0x0;
  cockpit_drawsurf_cpp_CDrawSurface_drawTextCenteredBoth_FUN_0045dd70(this_ptr,local_1010,x,y);
  return;
}
