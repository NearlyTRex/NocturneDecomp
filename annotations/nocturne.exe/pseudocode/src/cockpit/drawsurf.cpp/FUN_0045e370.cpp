// Name: cockpit_drawsurf.cpp_FUN_0045e370
// Address: 0045e370
// Address Range: [[0045e370, 0045ecd0]]
// Convention: unknown
// Signature: void cockpit_drawsurf_cpp_FUN_0045e370(void)
...

{
  ...
  if ((0x27f < DAT_005b761c) && (0x1df < DAT_005b7620)) {
    ...
    cockpit_drawsurf_cpp_FUN_0045d2b0(local_64);
    ...
    cockpit_drawsurf_cpp_FUN_0045bfb0(local_64,0,0,200,100);
    ...
    cockpit_drawsurf_cpp_FUN_0045be40(local_64,0,0,0x32);
    cockpit_drawsurf_cpp_FUN_0045be70(local_64,200,0,0x32);
    cockpit_drawsurf_cpp_FUN_0045bea0(local_64,0,100,0x32);
    cockpit_drawsurf_cpp_FUN_0045bed0(local_64,200,100,0x32);
    cockpit_drawsurf_cpp_CDrawSurface_setColor_FUN_0045b5f0(0xf9);
    cockpit_drawsurf_cpp_setCurrentFont_FUN_0045baa0(0);
    cockpit_drawsurf_cpp_FUN_0045da60(local_64,5,2,"Hello");
    cockpit_drawsurf_cpp_FUN_0045da60(local_64,0xfffffffb,0x11,"Hello");
    cockpit_drawsurf_cpp_FUN_0045da60(local_64,0xb9,0x11,"Hello\nworld\n...");
    cockpit_drawsurf_cpp_FUN_0045dc00(local_64,100,0x11,"+");
    cockpit_drawsurf_cpp_FUN_0045de70(local_64,0x5c,0x6c,0x20,"+");
    cockpit_drawsurf_cpp_setCurrentFont_FUN_0045baa0();
    *(uint *)(in_stack_00000004 + 0x3184) = 0;
    cockpit_drawsurf_cpp_FUN_0045da60(local_64,5,0x2a,"Hello");
    cockpit_drawsurf_cpp_FUN_0045da60(local_64,0xfffffffb,0x39,"Hello");
    cockpit_drawsurf_cpp_FUN_0045da60(local_64,0xb9,0x39,"Hello");
    *(uint *)(in_stack_00000004 + 0x3184) = 1;
    cockpit_drawsurf_cpp_FUN_0045da60(local_64,0xfffffffb,0x48,"Hello");
    cockpit_drawsurf_cpp_FUN_0045da60(local_64,0xb9,0x48,"Hello");
    cockpit_drawsurf_cpp_FUN_0045dc00(local_64,100,0x48,"+");
    cockpit_drawsurf_cpp_FUN_0045de70(local_64,0x5c,0x6c,0x57,"+");
    ...
    cockpit_drawsurf_cpp_FUN_0045d2b0(local_a4);
    ...
    cockpit_drawsurf_cpp_FUN_0045bfb0(local_a4,0xffffffeb,0xfffffff5,0x29,0x15);
    ...
    cockpit_drawsurf_cpp_FUN_0045d2b0(local_c4);
    cockpit_drawsurf_cpp_CDrawSurface_setColor_FUN_0045b5f0(0xfb);
    cockpit_drawsurf_cpp_CDrawSurface_drawSurfaceBorder_FUN_0045cb70(local_c4);
    cockpit_drawsurf_cpp_FUN_0045bfb0(local_c4,0,0,0x13,9);
    ...
    cockpit_drawsurf_cpp_CDrawSurface_setColorRGB_FUN_0045b800(0x80,0x80,0x80);
    cockpit_drawsurf_cpp_FUN_0045d2b0(auStack_44);
    cockpit_drawsurf_cpp_CDrawSurface_setColor_FUN_0045b5f0(7);
    cockpit_drawsurf_cpp_CDrawSurface_drawSurfaceBorder_FUN_0045cb70(auStack_44);
    cockpit_drawsurf_cpp_CDrawSurface_setColor_FUN_0045b5f0(0xf9);
    cockpit_drawsurf_cpp_setCurrentFont_FUN_0045baa0();
    *(uint *)(in_stack_00000004 + 0x3184) = 1;
    cockpit_drawsurf_cpp_FUN_0045da90(auStack_44,1,1,"%s",&uStack_24);
    cockpit_drawsurf_cpp_FUN_0045db60(auStack_44,199,1,"%s",&uStack_24);
    cockpit_drawsurf_cpp_FUN_0045dc30(auStack_44,100,1,"%s",&uStack_24);
    iVar2 = iVar1 + 1;
    cockpit_drawsurf_cpp_FUN_0045dd00(auStack_44,100,iVar2,"%s",&uStack_24);
    iStack_10 = iVar1 * 2;
    iStack_c = iStack_10 + 1;
    cockpit_drawsurf_cpp_FUN_0045ddd0(auStack_44,100,iStack_c,"%s",&uStack_24);
    iStack_1c = iVar1 * 3;
    iStack_20 = iVar3 + iVar1 * -3;
    cockpit_drawsurf_cpp_FUN_0045dea0(auStack_44,0x32,0x96,iStack_20,"%s",&uStack_24);
    iStack_14 = iVar3 - iStack_10;
    cockpit_drawsurf_cpp_FUN_0045df80
              (auStack_44,100,iStack_14 + -0x32,iStack_14 + 0x32,"%s",&uStack_24);
    iVar3 = iVar3 - iVar1;
    ...
    cockpit_drawsurf_cpp_CDrawSurface_setColorRGB_FUN_0045b800(0x80,0x80,0x80);
    cockpit_drawsurf_cpp_FUN_0045d2b0(auStack_84);
    cockpit_drawsurf_cpp_CDrawSurface_setColor_FUN_0045b5f0(7);
    cockpit_drawsurf_cpp_CDrawSurface_drawSurfaceBorder_FUN_0045cb70(auStack_84);
    cockpit_drawsurf_cpp_CDrawSurface_setColor_FUN_0045b5f0(0xf9);
    cockpit_drawsurf_cpp_setCurrentFont_FUN_0045baa0(0);
    *(uint *)(in_stack_00000004 + 0x3184) = 1;
    cockpit_drawsurf_cpp_FUN_0045da90(auStack_84,1,1,"%s",&uStack_24);
    cockpit_drawsurf_cpp_FUN_0045db60(auStack_84,199,1,"%s",&uStack_24);
    cockpit_drawsurf_cpp_FUN_0045dc30(auStack_84,100,1,"%s",&uStack_24);
    cockpit_drawsurf_cpp_FUN_0045dd00(auStack_84,100,iVar2,"%s",&uStack_24);
    cockpit_drawsurf_cpp_FUN_0045ddd0(auStack_84,100,iStack_c,"%s",&uStack_24);
    iStack_18 = iVar4 - iStack_1c;
    cockpit_drawsurf_cpp_FUN_0045dea0(auStack_84,0x32,0x96,iStack_18,"%s",&uStack_24);
    iVar3 = iVar4 - iStack_10;
    cockpit_drawsurf_cpp_FUN_0045df80
              (auStack_84,100,iVar3 + -0x32,iVar3 + 0x32,"%s",&uStack_24);
    iVar4 = iVar4 - iVar1;
    cockpit_drawsurf_cpp_CDrawSurface_drawTextCenteredInAreaWithWidthPrintf_FUN_0045e070
    ...
    cockpit_drawsurf_cpp_FUN_0045cfd0(auStack_84);
    return;
  }
  return;
}
