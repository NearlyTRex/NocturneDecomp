...
;                               FUNCTION
; *****************************************************************************
; void cockpit_drawsurf_cpp_FUN_0045dd70(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
;
;
; XREF[2]:
;   cockpit_drawsurf.cpp_FUN_0045dda0 at 0045ddb6
;   cockpit_drawsurf.cpp_FUN_0045ddd0 at 0045de2a
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 0045dd70
        ;   Label: cockpit_drawsurf.cpp_FUN_0045dd70
    PUSH ESI                            ; 0045dd71
    PUSH 0x4                            ; 0045dd72
    PUSH 0x0                            ; 0045dd74
