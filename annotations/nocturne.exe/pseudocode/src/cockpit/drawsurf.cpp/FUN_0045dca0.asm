...
;                               FUNCTION
; *****************************************************************************
; void cockpit_drawsurf_cpp_FUN_0045dca0(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
;
;
; XREF[2]:
;   cockpit_drawsurf.cpp_FUN_0045dcd0 at 0045dce6
;   cockpit_drawsurf.cpp_FUN_0045dd00 at 0045dd5a
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 0045dca0
        ;   Label: cockpit_drawsurf.cpp_FUN_0045dca0
    PUSH ESI                            ; 0045dca1
    PUSH 0x3                            ; 0045dca2
    PUSH 0x0                            ; 0045dca4
