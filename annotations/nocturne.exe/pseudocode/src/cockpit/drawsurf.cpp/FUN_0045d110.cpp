...
// Convention: unknown
// Signature: int FUN_0045d110(int param_1,int param_2,int param_3,int param_4,int param_5)
        ...
        if (DAT_005b7624 < 0x10) {
          if (DAT_005b7624 == 8) {
            do {
              ...
              param_3 = param_3 + 4;
              iVar4 = FUN_00563cc0(*piVar1 + param_2,_DAT_01b4d710,(param_4 - param_2) + 1);
...
LAB_0045d27e:
        ...
        do {
          iVar4 = param_3 + 1;
          param_1 = FUN_0045bc20(param_2,param_4,param_3);
          param_3 = iVar4;
        } while (iVar4 <= param_5);
      }
    }
