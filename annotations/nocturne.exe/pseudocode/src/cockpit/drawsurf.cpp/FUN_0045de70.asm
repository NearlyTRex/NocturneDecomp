...
;                               FUNCTION
; *****************************************************************************
; void cockpit_drawsurf_cpp_FUN_0045de70(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,undefined4 param_5)
;
;
; XREF[1]:
;   cockpit_drawsurf.cpp_FUN_0045e370 at 0045e558
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 0045de70
        ;   Label: cockpit_drawsurf.cpp_FUN_0045de70
    PUSH ESI                            ; 0045de71
    PUSH EDI                            ; 0045de72
    ...
    PUSH EDI                            ; 0045de8b
    CALL cockpit_drawsurf.cpp_FUN_0045de40 ; 0045de8c
