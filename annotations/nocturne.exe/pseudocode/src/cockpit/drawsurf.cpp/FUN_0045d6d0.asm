...
;                               FUNCTION
; *****************************************************************************
; void cockpit_drawsurf_cpp_FUN_0045d6d0(undefined4 param_1,int param_2,undefined4 *param_3)
;
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 0045d6d0
        ;   Label: cockpit_drawsurf.cpp_FUN_0045d6d0
    PUSH EDI                            ; 0045d6d1
    PUSH EBP                            ; 0045d6d2
    ...
    CALL cockpit_drawsurf.cpp_FUN_0045bfb0 ; 0045d700
