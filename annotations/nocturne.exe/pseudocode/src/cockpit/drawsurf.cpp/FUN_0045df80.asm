...
;                               FUNCTION
; *****************************************************************************
; void cockpit_drawsurf_cpp_FUN_0045df80(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,undefined4 param_5)
;
; Local Variables:
...
;
; XREF[1]:
;   cockpit_drawsurf.cpp_FUN_0045e370 at 0045e911
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 0045df80
        ;   Label: cockpit_drawsurf.cpp_FUN_0045df80
    PUSH ESI                            ; 0045df81
    PUSH EDI                            ; 0045df82
    PUSH EBP                            ; 0045df83
    ...
    CALL cockpit_drawsurf.cpp_FUN_0045df20 ; 0045dfe3
