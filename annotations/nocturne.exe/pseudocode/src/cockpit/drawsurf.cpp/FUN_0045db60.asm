...
;                               FUNCTION
; *****************************************************************************
; void cockpit_drawsurf_cpp_FUN_0045db60(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
;
; Local Variables:
...
;
; XREF[1]:
;   cockpit_drawsurf.cpp_FUN_0045e370 at 0045e814
;
; Called Functions:
;   cockpit_drawsurf.cpp_FUN_0045db00
...
section .text
    ...
    PUSH EBX                            ; 0045db60
        ;   Label: cockpit_drawsurf.cpp_FUN_0045db60
    PUSH ESI                            ; 0045db61
    PUSH EDI                            ; 0045db62
    ...
    CALL cockpit_drawsurf.cpp_FUN_0045db00 ; 0045dbba
        ;   XREF to: 0045db00 (UNCONDITIONAL_CALL)  ; undefined cockpit_drawsurf.cpp_FUN_0045db00()
