...
;
; XREF[1]:
;   FUN_0045cb10 at 0045cb4c
;
; Referenced Globals:
;   string s_..\\cockpit\\drawsurf.cpp_0057d9ed
;   string s_Invalid_bitsPerPixel!_0057da05
;   string s_..\\cockpit\\drawsurf.cpp_0057da1b
;   string s_Invalid_bitsPerPixel!_0057da33
