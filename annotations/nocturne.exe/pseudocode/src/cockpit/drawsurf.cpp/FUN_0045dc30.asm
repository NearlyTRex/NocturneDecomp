...
;                               FUNCTION
; *****************************************************************************
; void cockpit_drawsurf_cpp_FUN_0045dc30(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
;
; Local Variables:
...
;
; XREF[1]:
;   cockpit_drawsurf.cpp_FUN_0045e370 at 0045e835
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 0045dc30
        ;   Label: cockpit_drawsurf.cpp_FUN_0045dc30
    PUSH ESI                            ; 0045dc31
    PUSH EDI                            ; 0045dc32
    ...
    CALL cockpit_drawsurf.cpp_FUN_0045dbd0 ; 0045dc8a
