...
;                               FUNCTION
; *****************************************************************************
; void cockpit_drawsurf_cpp_FUN_0045db00(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
;
;
; XREF[2]:
;   cockpit_drawsurf.cpp_FUN_0045db30 at 0045db46
;   cockpit_drawsurf.cpp_FUN_0045db60 at 0045dbba
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 0045db00
        ;   Label: cockpit_drawsurf.cpp_FUN_0045db00
    PUSH ESI                            ; 0045db01
    PUSH 0x1                            ; 0045db02
    PUSH 0x0                            ; 0045db04
