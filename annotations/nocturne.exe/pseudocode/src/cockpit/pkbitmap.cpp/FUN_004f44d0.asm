...
;                               FUNCTION
; *****************************************************************************
; void cockpit_pkbitmap_cpp_FUN_004f44d0(int param_1,int param_2,int param_3,int param_4)
;
; Local Variables:
...
;
; XREF[1]:
;   cockpit_pkbitmap.cpp_FUN_004f45e0 at 004f461b
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 004f44d0
        ;   Label: cockpit_pkbitmap.cpp_FUN_004f44d0
    PUSH ESI                            ; 004f44d1
    PUSH EDI                            ; 004f44d2
    PUSH EBP                            ; 004f44d3
    ...
    POP EBX                             ; 004f45b4
    RET                                 ; 004f45b5
    CALL cockpit_ckptutil.c_FUN_0042d150 ; 004f45b6
