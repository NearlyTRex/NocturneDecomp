...
// Convention: unknown
// Signature: void FUN_004f47b0(int param_1,int param_2,undefined4 param_3,undefined4 param_4,uint param_5,int param_6)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_004f47b0(int param_1,int param_2,uint param_3,uint param_4,uint param_5,int param_6)

{
  ...
  *(uint *)(param_1 + 0x1c) = param_4;
  ...
  iVar1 = FUN_00564c18((*(int *)(param_1 + 0x1c) + 1) * 4);
  ...
  do {
    *(int *)(*(int *)(param_1 + 0x20) + iStack_28) = iVar1;
    if (*(int *)(param_1 + 0x1c) <= iStack_24) {
      uVar6 = FUN_00564a70(*(uint *)(param_1 + 0x14),iVar1);
      ...
      do {
        ...
        if (*pbVar2 == param_5) {
          ...
          if (iStack_18 < iStack_1c) {
            ...
            iVar4 = FUN_00564a70(*(uint *)(param_1 + 0x14),iStack_18);
            *(int *)(param_1 + 0x14) = iVar4;
            if (iVar4 == 0) {
              FUN_00563c90(auStack_154,"Out of memory packing file \"%s\" on row %u trying to get %u bytes",param_1,
                           iStack_24,iStack_18);
              _DAT_01cc4800 = "..\\cockpit\\pkbitmap.cpp";
              _DAT_01cc4804 = 0x3b5;
