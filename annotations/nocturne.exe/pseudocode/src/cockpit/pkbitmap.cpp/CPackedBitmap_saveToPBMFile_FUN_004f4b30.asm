...
section .text
    ...
    PUSH EBX                            ; 004f4b30
        ;   Label: cockpit_pkbitmap.cpp_CPackedBitmap_saveToPBMFile_FUN_004f4b30
    PUSH EBP                            ; 004f4b31
    ...
    PUSH EAX                            ; 004f4b91
    MOV dword ptr [0x01cc4800],ESI      ; 004f4b92 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EDI      ; 004f4b98 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004f4b9e
