...
;
; XREF[1]:
;   cockpit_pkbitmap.cpp_FUN_004f4410 at 004f44b5
;
; Referenced Globals:
...
;
; Called Functions:
;   cockpit_pkbitmap.cpp_FUN_004f4170
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 004f4310
        ;   Label: cockpit_pkbitmap.cpp_FUN_004f4310
    PUSH ESI                            ; 004f4311
    PUSH EDI                            ; 004f4312
    PUSH EBP                            ; 004f4313
    ...
    PUSH EBX                            ; 004f43e7
    PUSH ECX                            ; 004f43e8
    CALL cockpit_pkbitmap.cpp_FUN_004f4170 ; 004f43e9
        ;   XREF to: 004f4170 (UNCONDITIONAL_CALL)  ; undefined cockpit_pkbitmap.cpp_FUN_004f4170()
