...
section .text
    ...
    PUSH ESI                            ; 004f4eb3
    PUSH EBX                            ; 004f4eb4
    CALL FUN_004f4c80                   ; 004f4eb5
        ;   XREF to: 004f4c80 (UNCONDITIONAL_CALL)  ; undefined FUN_004f4c80()
    ADD ESP,0xc                         ; 004f4eba
    PUSH ESI                            ; 004f4ebd
    CALL FUN_00563380                   ; 004f4ebe
