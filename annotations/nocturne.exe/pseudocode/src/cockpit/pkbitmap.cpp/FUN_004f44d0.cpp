// Name: cockpit_pkbitmap.cpp_FUN_004f44d0
// Address: 004f44d0
// Address Range: [[004f44d0, 004f45d1]]
// Convention: unknown
// Signature: void cockpit_pkbitmap_cpp_FUN_004f44d0(int param_1,int param_2,int param_3,int param_4)
...

{
  ...
  if (((*(int *)(param_1 + 0x20) != 0) && (*(int *)(param_1 + 0x14) != 0)) && (param_2 != 0)) {
    local_1c = 0;
    if (param_4 == 8) {
      local_18 = (code *)cockpit_ckptutil_c_FUN_0042d150();
    }
    if (param_4 == 0x10) {
      local_18 = (code *)cockpit_ckptutil_c_FUN_0042d170();
    }
    local_20 = 0;
