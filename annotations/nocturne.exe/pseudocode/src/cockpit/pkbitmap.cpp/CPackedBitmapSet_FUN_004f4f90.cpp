// Name: cockpit_pkbitmap.cpp_CPackedBitmapSet_FUN_004f4f90
// Address: 004f4f90
// Address Range: [[004f4f90, 004f510b]]
// Convention: __cdecl
// Signature: CPackedBitmap * __cdecl cockpit_pkbitmap_cpp_CPackedBitmapSet_FUN_004f4f90(CPackedBitmapSet *bitmap_set_ptr,_FILE *file_handle,int frames_per_bitmap,int skip_data_load,int selected_bitmap_index)
...

{
  ...
  do {
    ...
    if (SVar1 == 1) {
      ...
      g_CurrentLineNumber = 1366;
      core_main_c_displayErrorAndQuit_FUN_004c8440("IO error reading PBG (possibly corrupt file).");
LAB_004f4fd1:
      g_CurrentFilename = "..\\cockpit\\pkbitmap.cpp";
      g_CurrentLineNumber = 1367;
      core_main_c_displayErrorAndQuit_FUN_004c8440("Corrupt data detected reading PBG.");
    }
    g_CurrentFilename = "..\\cockpit\\pkbitmap.cpp";
    g_CurrentLineNumber = 1368;
    core_main_c_displayErrorAndQuit_FUN_004c8440("Out of memory reading PBG");
  } while( true );
}
