...
;
; XREF[1]:
;   cockpit_pkbitmap.cpp_CPackedBitmapSet_FUN_004f5110 at 004f515f
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004f4f90
        ;   Label: cockpit_pkbitmap.cpp_CPackedBitmapSet_FUN_004f4f90
    PUSH ESI                            ; 004f4f91
    PUSH EDI                            ; 004f4f92
    PUSH EBP                            ; 004f4f93
    ...
    MOV [0x01cc4800],EAX                ; 004f4fe0 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EDX      ; 004f4fe5 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004f4feb
    ...
    MOV dword ptr [0x01cc4800],ECX      ; 004f5002 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],ESI      ; 004f5008 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004f500e
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
    ...
    MOV dword ptr [0x01cc4800],ESI      ; 004f5027 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EDI      ; 004f502d | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004f5033
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
