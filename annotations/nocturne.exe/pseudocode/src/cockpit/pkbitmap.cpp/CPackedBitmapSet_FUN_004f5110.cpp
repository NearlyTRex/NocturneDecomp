// Name: cockpit_pkbitmap.cpp_CPackedBitmapSet_FUN_004f5110
// Address: 004f5110
// Address Range: [[004f5110, 004f5258]]
// Convention: __cdecl
// Signature: CPackedBitmap * __cdecl cockpit_pkbitmap_cpp_CPackedBitmapSet_FUN_004f5110(CPackedBitmapSet *bitmap_set_ptr,char *pbg_filename,int apply_palette_flag,int frames_per_bitmap,int skip_data_load,int selected_bitmap_index)
...

{
  ...
  if (file_handle == (_FILE *)0x0) {
    ...
    g_CurrentLineNumber = 1432;
    g_CurrentFilename = "..\\cockpit\\pkbitmap.cpp";
    core_main_c_displayErrorAndQuit_FUN_004c8440(local_78);
  }
  this_ptr = cockpit_pkbitmap_cpp_CPackedBitmapSet_FUN_004f4f90
