...
// Convention: unknown
// Signature: void FUN_004f4c80(int param_1,undefined4 param_2,int param_3)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_004f4c80(int param_1,uint param_2,int param_3)

{
  ...
  do {
    iVar2 = FUN_005636d0(abStack_2c,0x1c,1,param_2);
    ...
    if (((iVar2 == 0) && (iStack_28 != 0)) && (iStack_24 != 0)) {
      ...
      *(int *)(param_1 + 0x1c) = iStack_24;
      ...
      iVar2 = FUN_00564c18((*(int *)(param_1 + 0x1c) + 1) * 4);
      *(int *)(param_1 + 0x20) = iVar2;
      if (iVar2 != 0) {
        iVar2 = FUN_005636d0(*(uint *)(param_1 + 0x20),(*(int *)(param_1 + 0x1c) + 1) * 4,1,
                             param_2);
        if (iVar2 == 1) {
          iVar2 = 0;
          ...
          if (param_3 != 0) {
            FUN_0056582c(param_2,uVar1,1);
            return;
          }
          iVar2 = FUN_005635b0(uVar1);
          *(int *)(param_1 + 0x14) = iVar2;
          if (iVar2 == 0) goto LAB_004f4ced;
          iVar2 = FUN_005636d0(iVar2,uVar1,1,param_2);
          if (iVar2 == 1) {
            return;
          }
        }
