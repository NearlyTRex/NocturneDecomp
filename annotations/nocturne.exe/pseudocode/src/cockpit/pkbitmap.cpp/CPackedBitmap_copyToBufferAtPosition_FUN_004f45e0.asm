...
section .text
    ...
    MOV ECX,dword ptr [ESP + 0x8]       ; 004f45e0
        ;   Label: cockpit_pkbitmap.cpp_CPackedBitmap_copyToBufferAtPosition_FUN_004f45e0
    ...
    PUSH EDI                            ; 004f461a
    CALL cockpit_pkbitmap.cpp_CPackedBitmap_copyNoClip_FUN_004f44d0 ; 004f461b
        ;   XREF to: 004f44d0 (UNCONDITIONAL_CALL)  ; void cockpit_pkbitmap.cpp_CPackedBitmap_copyNoClip_FUN_004f44d0(CPackedBitmap * this_ptr, uchar * dest_buffer, int bits_per_pixel, int row_stride)
