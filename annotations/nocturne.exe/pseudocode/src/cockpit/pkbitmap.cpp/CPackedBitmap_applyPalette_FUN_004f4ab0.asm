...
;   cockpit_pkbmpset.cpp_CPackedBitmapSet_applyPaletteOrReload_FUN_004f5bb0 at 004f5bce
;
; Called Functions:
...
section .text
    ...
    CALL cockpit_pkbitmap.cpp_CPackedBitmap_applyACTPalette_FUN_004f4a00 ; 004f4ab6
        ;   XREF to: 004f4a00 (UNCONDITIONAL_CALL)  ; void cockpit_pkbitmap.cpp_CPackedBitmap_applyACTPalette_FUN_004f4a00(CPackedBitmap * this_ptr, char * act_filename)
