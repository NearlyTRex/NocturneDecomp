...
;   cockpit_pkbitmap.cpp_CPackedBitmapSet_FUN_004f4f90
...
section .text
    ...
    PUSH EBX                            ; 004f5110
        ;   Label: cockpit_pkbitmap.cpp_CPackedBitmapSet_FUN_004f5110
    PUSH ESI                            ; 004f5111
    PUSH EDI                            ; 004f5112
    PUSH EBP                            ; 004f5113
    ...
    PUSH EBX                            ; 004f515d
    PUSH EDI                            ; 004f515e
    CALL cockpit_pkbitmap.cpp_CPackedBitmapSet_FUN_004f4f90 ; 004f515f
        ;   XREF to: 004f4f90 (UNCONDITIONAL_CALL)  ; CPackedBitmap * cockpit_pkbitmap.cpp_CPackedBitmapSet_FUN_004f4f90(CPackedBitmapSet * bitmap_set_ptr, _FILE * file_handle, int frames_per_bitmap, int skip_data_load, ...)
    ...
    MOV [0x01cc4804],EAX                ; 004f51de | g_CurrentLineNumber
    LEA EAX,[ESP + 0x100]               ; 004f51e3
    MOV ESI,0x58d445                    ; 004f51ea | = "..\\cockpit\\pkbitmap.cpp"
    PUSH EAX                            ; 004f51ef
    MOV dword ptr [0x01cc4800],ESI      ; 004f51f0 | g_CurrentFilename
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004f51f6
