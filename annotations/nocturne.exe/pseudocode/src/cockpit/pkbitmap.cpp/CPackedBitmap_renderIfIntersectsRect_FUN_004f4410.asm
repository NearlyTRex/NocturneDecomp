...
;
; XREF[1]:
;   cockpit_drawsurf.cpp_CDrawSurface_renderPackedBitmap_FUN_0045d2d0 at 0045d301
;
; Called Functions:
;   cockpit_pkbitmap.cpp_CPackedBitmap_renderWithGlobalClipping_FUN_004f4310
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 004f4410
        ;   Label: cockpit_pkbitmap.cpp_CPackedBitmap_renderIfIntersectsRect_FUN_004f4410
    PUSH ESI                            ; 004f4411
    PUSH EDI                            ; 004f4412
    PUSH EBP                            ; 004f4413
    ...
    PUSH EDX                            ; 004f44b3
    PUSH EAX                            ; 004f44b4
    CALL cockpit_pkbitmap.cpp_CPackedBitmap_renderWithGlobalClipping_FUN_004f4310 ; 004f44b5
        ;   XREF to: 004f4310 (UNCONDITIONAL_CALL)  ; void cockpit_pkbitmap.cpp_CPackedBitmap_renderWithGlobalClipping_FUN_004f4310(CPackedBitmap * this_ptr, int dest_x, int dest_y, int src_left, ...)
