...
;
; XREF[1]:
;   cockpit_pkbmpset.cpp_CPackedBitmapSet_loadByFilenameAndIndex_FUN_004f5a50 at 004f5b0d
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004f5740
        ;   Label: cockpit_pkbmpset.cpp_CPackedBitmapSet_reload_FUN_004f5740
    PUSH ESI                            ; 004f5741
    PUSH EDI                            ; 004f5742
    PUSH EBP                            ; 004f5743
    ...
    PUSH ESI                            ; 004f58fe
        ;   Label: LAB_004f58fe
    CALL cockpit_pkbmpset.cpp_CPackedBitmapSet_loadStoredACTFile_FUN_004f5c60 ; 004f58ff
