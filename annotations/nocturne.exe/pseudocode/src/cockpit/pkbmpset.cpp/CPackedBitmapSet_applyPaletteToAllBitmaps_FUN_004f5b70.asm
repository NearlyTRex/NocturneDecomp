...
;
; XREF[1]:
;   cockpit_pkbmpset.cpp_CPackedBitmapSet_loadACTAndApplyToBitmapSet_FUN_004f5b20 at 004f5b44
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 004f5b70
        ;   Label: cockpit_pkbmpset.cpp_CPackedBitmapSet_applyPaletteToAllBitmaps_FUN_004f5b70
    PUSH EDI                            ; 004f5b71
    PUSH EBP                            ; 004f5b72
