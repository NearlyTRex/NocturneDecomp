...
;                               FUNCTION
; *****************************************************************************
; void cockpit_pkbmpset_cpp_FUN_004f5c80(int *param_1,int param_2)
;
;
; Called Functions:
;   cockpit_pkbitmap.cpp_FUN_004f3f80
;   cockpit_pkbmpset.cpp_FUN_004f5a50
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 004f5c80
        ;   Label: cockpit_pkbmpset.cpp_FUN_004f5c80
    PUSH EDI                            ; 004f5c81
    PUSH EBP                            ; 004f5c82
    ...
    PUSH EAX                            ; 004f5cae
    INC ESI                             ; 004f5caf
    CALL cockpit_pkbitmap.cpp_FUN_004f3f80 ; 004f5cb0
        ;   XREF to: 004f3f80 (UNCONDITIONAL_CALL)  ; undefined cockpit_pkbitmap.cpp_FUN_004f3f80()
    ...
    PUSH 0x1                            ; 004f5cd5
    PUSH EDI                            ; 004f5cd7
    CALL cockpit_pkbmpset.cpp_FUN_004f5a50 ; 004f5cd8
        ;   XREF to: 004f5a50 (UNCONDITIONAL_CALL)  ; undefined cockpit_pkbmpset.cpp_FUN_004f5a50()
