...
;                               FUNCTION
; *****************************************************************************
; void cockpit_pkbmpset_cpp_FUN_004f59d0(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,undefined4 param_5)
;
;
; XREF[1]:
;   cockpit_pkbmpset.cpp_FUN_004f5a20 at 004f5a3e
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 004f59d0
        ;   Label: cockpit_pkbmpset.cpp_FUN_004f59d0
    PUSH ESI                            ; 004f59d1
    PUSH EDI                            ; 004f59d2
    ...
    CALL cockpit_pkbmpset.cpp_FUN_004f5c40 ; 004f5a04
