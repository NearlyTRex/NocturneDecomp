...
;                               FUNCTION
; *****************************************************************************
; void cockpit_pkbmpset_cpp_FUN_004f5b70(int *param_1,undefined4 param_2)
;
;
; XREF[1]:
;   cockpit_pkbmpset.cpp_FUN_004f5b20 at 004f5b44
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 004f5b70
        ;   Label: cockpit_pkbmpset.cpp_FUN_004f5b70
    PUSH EDI                            ; 004f5b71
    PUSH EBP                            ; 004f5b72
