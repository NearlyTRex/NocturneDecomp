...
;                               FUNCTION
; *****************************************************************************
; int cockpit_ckptutil_c_FUN_0042e3d0(int param_1,undefined4 param_2,int param_3,int param_4,int param_5,int param_6)
;
; Local Variables:
...
section .text
    ...
    PUSH EBX                            ; 0042e3d0
        ;   Label: cockpit_ckptutil.c_FUN_0042e3d0
    PUSH ESI                            ; 0042e3d1
    PUSH EDI                            ; 0042e3d2
    PUSH EBP                            ; 0042e3d3
