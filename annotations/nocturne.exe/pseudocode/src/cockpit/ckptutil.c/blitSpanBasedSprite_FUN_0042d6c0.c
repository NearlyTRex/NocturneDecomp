...

{
  ...
  if (sprite_data != (void *)0x0) {
    ...
    if (g_BitsPerPixel == 8) {
      iStack_1c = screen_x + (int)g_ScreenBufferArray[src_y + screen_y];
      if (screen_y < height) {
        do {
          iVar7 = 0;
          iVar9 = 0;
      ...
      pvStack_18 = (void *)((int)g_ScreenBufferArray[src_y + screen_y] + screen_x * 2);
      if (screen_y < height) {
        iStack_2c = iStack_30;
        do {
          iVar7 = 0;
          ...
          while (piVar3 = (int *)((int)span_data + iStack_2c), iVar9 < *piVar3) {
            ...
            if (((iVar4 < iVar6) && (iVar4 = iVar6, iVar5 < iVar6)) ||
              ...
              (*pCVar2)((void *)((int)pvStack_18 + src_x * -2 + iVar4 * 2),
          ...
          pvStack_18 = (void *)((int)pvStack_18 + (iVar1 / 2) * 2);
          sprite_data = (void *)((int)sprite_data + width);
