...
;                               FUNCTION
; *****************************************************************************
; void cockpit_ckptutil_c_FUN_0042f260(void)
;
; Local Variables:
...
;
; Called Functions:
;   cockpit_ckptutil.c_FUN_0042f330
;   cockpit_pkbitmap.cpp_FUN_004f3fe0
;
; *****************************************************************************
...
section .text
    ...
    PUSH ESI                            ; 0042f260
        ;   Label: cockpit_ckptutil.c_FUN_0042f260
    PUSH EBP                            ; 0042f261
    ...
    CALL cockpit_pkbitmap.cpp_FUN_004f3fe0 ; 0042f2b3
        ;   XREF to: 004f3fe0 (UNCONDITIONAL_CALL)  ; undefined cockpit_pkbitmap.cpp_FUN_004f3fe0()
    ...
    PUSH ECX                            ; 0042f2cd
    CALL cockpit_pkbitmap.cpp_FUN_004f3fe0 ; 0042f2ce
        ;   XREF to: 004f3fe0 (UNCONDITIONAL_CALL)  ; undefined cockpit_pkbitmap.cpp_FUN_004f3fe0()
    ...
    PUSH EBP                            ; 0042f306
    CALL cockpit_ckptutil.c_FUN_0042f330 ; 0042f307
        ;   XREF to: 0042f330 (UNCONDITIONAL_CALL)  ; undefined cockpit_ckptutil.c_FUN_0042f330()
