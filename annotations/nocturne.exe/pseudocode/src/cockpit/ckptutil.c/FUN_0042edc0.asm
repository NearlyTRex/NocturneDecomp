...
;                               FUNCTION
; *****************************************************************************
; void cockpit_ckptutil_c_FUN_0042edc0(void)
;
; Local Variables:
...
;
; Called Functions:
;   cockpit_ckptutil.c_FUN_0042eb90
;
; *****************************************************************************
...
section .text
    ...
    SUB ESP,0x8                         ; 0042edc0
        ;   Label: cockpit_ckptutil.c_FUN_0042edc0
    PUSH 0x1                            ; 0042edc3
    ...
    CALL cockpit_ckptutil.c_FUN_0042eb90 ; 0042edd5
        ;   XREF to: 0042eb90 (UNCONDITIONAL_CALL)  ; undefined cockpit_ckptutil.c_FUN_0042eb90()
