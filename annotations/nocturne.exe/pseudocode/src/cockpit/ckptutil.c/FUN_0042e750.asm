...
;                               FUNCTION
; *****************************************************************************
; void cockpit_ckptutil_c_FUN_0042e750(undefined4 *param_1,int param_2,int param_3,int param_4,uint param_5,int param_6)
;
; Local Variables:
...
section .text
    ...
    PUSH EBX                            ; 0042e750
        ;   Label: cockpit_ckptutil.c_FUN_0042e750
    PUSH ESI                            ; 0042e751
    PUSH EBP                            ; 0042e752
