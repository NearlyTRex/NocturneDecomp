...
// Convention: unknown
// Signature: void FUN_0042d480(char *param_1,undefined4 *param_2)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_0042d480(char *param_1,uint *param_2)
...
LAB_0042d4f3:
  ...
  iVar2 = FUN_00456a60(0x57a6ea,acStack_ac,0x57a6e7);
  if (iVar2 == 0) {
  ...
  iVar3 = FUN_005636d0(param_2,0x100,3,iVar2);
  if (iVar3 != 3) {
    FUN_00563c90(auStack_5c,"Error reading %s.",acStack_ac);
