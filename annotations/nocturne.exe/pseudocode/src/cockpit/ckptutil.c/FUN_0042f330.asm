...
;                               FUNCTION
; *****************************************************************************
; uint cockpit_ckptutil_c_FUN_0042f330(int param_1,int param_2,int param_3,uint param_4,undefined1 param_5,undefined1 param_6,int param_7)
;
; Local Variables:
...
;
; XREF[2]:
;   cockpit_ckptutil.c_FUN_0042f190 at 0042f235
;   cockpit_ckptutil.c_FUN_0042f260 at 0042f307
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0042f330
        ;   Label: cockpit_ckptutil.c_FUN_0042f330
    PUSH ESI                            ; 0042f331
    PUSH EDI                            ; 0042f332
    PUSH EBP                            ; 0042f333
