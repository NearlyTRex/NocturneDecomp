...
// Convention: unknown
// Signature: undefined4 cockpit_ckptutil_c_expandIndexedTo16Bit_FUN_0042cde0(undefined4 *param_1,byte *param_2,int param_3)

#include "nocturne.h"

uint cockpit_ckptutil_c_expandIndexedTo16Bit_FUN_0042cde0(uint *param_1,byte *param_2,int param_3)
