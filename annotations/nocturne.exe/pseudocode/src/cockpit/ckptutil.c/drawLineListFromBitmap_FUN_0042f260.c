...
// Convention: __cdecl
// Signature: void __cdecl cockpit_ckptutil_c_drawLineListFromBitmap_FUN_0042f260(CPackedBitmap *bitmap,short *line_data,int line_count,int offset_x,int offset_y)
...

{
  ...
  if ((bitmap->width != 0) && (iVar5 = 0, 0 < line_count)) {
    do {
      ...
      iVar4 = cockpit_pkbitmap_cpp_CPackedBitmap_getPixelValue_FUN_004f3fe0
