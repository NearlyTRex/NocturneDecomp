...
;
; Called Functions:
;   cockpit_ckptutil.c_drawLineAAWithBlending_FUN_0042f330
;   cockpit_pkbitmap.cpp_CPackedBitmap_getPixelValue_FUN_004f3fe0
;
; *****************************************************************************
...
section .text
    ...
    PUSH ESI                            ; 0042f260
        ;   Label: cockpit_ckptutil.c_drawLineListFromBitmap_FUN_0042f260
    PUSH EBP                            ; 0042f261
    ...
    PUSH EBP                            ; 0042f306
    CALL cockpit_ckptutil.c_drawLineAAWithBlending_FUN_0042f330 ; 0042f307
        ;   XREF to: 0042f330 (UNCONDITIONAL_CALL)  ; void cockpit_ckptutil.c_drawLineAAWithBlending_FUN_0042f330(int x0, int y0, int x1, int y1, ...)
