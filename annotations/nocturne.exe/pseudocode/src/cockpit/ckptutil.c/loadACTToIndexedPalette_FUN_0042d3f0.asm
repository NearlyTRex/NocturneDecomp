...
section .text
    ...
    CALL cockpit_ckptutil.c_loadACTPaletteFile_FUN_0042d480 ; 0042d404
        ;   XREF to: 0042d480 (UNCONDITIONAL_CALL)  ; undefined cockpit_ckptutil.c_loadACTPaletteFile_FUN_0042d480()
