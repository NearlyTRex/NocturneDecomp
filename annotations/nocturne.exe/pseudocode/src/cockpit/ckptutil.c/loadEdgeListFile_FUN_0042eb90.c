  ...
  if (0 < expected_count) {
    ...
    do {
      ...
      if (SVar1 != 1) {
        ...
        g_CurrentFilename = "..\\cockpit\\ckptutil.c";
        g_CurrentLineNumber = 1210;
        core_main_c_displayErrorAndQuit_FUN_004c8440(local_68);
      }
      if (edge_lists->edge_data != (SEdge *)0x0) {
        free(edge_lists->edge_data);
      }
