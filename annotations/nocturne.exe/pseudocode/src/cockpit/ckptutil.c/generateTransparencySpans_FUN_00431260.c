// Name: cockpit_ckptutil.c_generateTransparencySpans_FUN_00431260
// Address: 00431260
// Address Range: [[00431260, 004314ae]]
// Convention: __cdecl
// Signature: void __cdecl cockpit_ckptutil_c_generateTransparencySpans_FUN_00431260(void *bitmap_buffer,char *filename,SScanlineSpans *span_output,int width,int height,int transparent_color_index)
...

{
  ...
  if (0xff < (uint)transparent_color_index) {
    ...
    g_CurrentLineNumber = 2362;
    core_main_c_displayErrorAndQuit_FUN_004c8440(local_130);
  }
  local_20 = 0;
  if (0 < height) {
    local_30 = width + -1;
