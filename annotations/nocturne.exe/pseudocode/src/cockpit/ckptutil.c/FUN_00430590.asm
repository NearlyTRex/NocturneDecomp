...
;                               FUNCTION
; *****************************************************************************
; void cockpit_ckptutil_c_FUN_00430590(int param_1,int param_2,undefined2 param_3,undefined2 param_4,undefined2 param_5,ushort param_6,byte param_7)
;
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 00430590
        ;   Label: cockpit_ckptutil.c_FUN_00430590
    PUSH ESI                            ; 00430591
    PUSH EDI                            ; 00430592
