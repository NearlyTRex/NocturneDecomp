...
section .text
    ...
    MOV [0x01cc4800],EAX                ; 0042d288 | g_CHAR_PTR_01cc4800
    MOV EAX,ESP                         ; 0042d28d
    MOV EDX,0xdb                        ; 0042d28f
    PUSH EAX                            ; 0042d294
    MOV dword ptr [0x01cc4804],EDX      ; 0042d295 | g_INT_01cc4804
    ...
    PUSH EAX                            ; 0042d2f7
    MOV dword ptr [0x01cc4800],EDX      ; 0042d2f8 | g_CHAR_PTR_01cc4800
    MOV dword ptr [0x01cc4804],ECX      ; 0042d2fe | g_INT_01cc4804
    ...
    PUSH EAX                            ; 0042d339
    MOV dword ptr [0x01cc4804],EDI      ; 0042d33a | g_INT_01cc4804
    MOV dword ptr [0x01cc4800],ECX      ; 0042d340 | g_CHAR_PTR_01cc4800
