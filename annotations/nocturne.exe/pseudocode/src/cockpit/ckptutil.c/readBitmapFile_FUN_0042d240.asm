...
;   cockpit_ckptutil.c_loadBitmapWithPalette_FUN_0042d180 at 0042d19c
...
section .text
    ...
    MOV [0x01cc4800],EAX                ; 0042d288 | g_CurrentFilename
    MOV EAX,ESP                         ; 0042d28d
    MOV EDX,0xdb                        ; 0042d28f
    PUSH EAX                            ; 0042d294
    MOV dword ptr [0x01cc4804],EDX      ; 0042d295 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 0042d29b
    ...
    PUSH EAX                            ; 0042d2f7
    MOV dword ptr [0x01cc4800],EDX      ; 0042d2f8 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],ECX      ; 0042d2fe | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 0042d304
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
    ...
    PUSH EAX                            ; 0042d339
    MOV dword ptr [0x01cc4804],EDI      ; 0042d33a | g_CurrentLineNumber
    MOV dword ptr [0x01cc4800],ECX      ; 0042d340 | g_CurrentFilename
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 0042d346
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
