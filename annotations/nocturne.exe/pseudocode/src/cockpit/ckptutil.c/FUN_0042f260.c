// Name: cockpit_ckptutil.c_FUN_0042f260
// Address: 0042f260
// Address Range: [[0042f260, 0042f326]]
// Convention: unknown
// Signature: void cockpit_ckptutil_c_FUN_0042f260(void)
...

{
  ...
  if ((*(int *)(in_stack_00000004 + 0x18) != 0) && (iVar7 = 0, 0 < in_stack_0000000c)) {
    do {
      ...
      uVar5 = cockpit_pkbitmap_cpp_FUN_004f3fe0(in_stack_00000004,(int)sVar1,(int)sVar2);
      uVar6 = cockpit_pkbitmap_cpp_FUN_004f3fe0(in_stack_00000004,(int)sVar3,iVar4);
