...
;                               FUNCTION
; *****************************************************************************
; void cockpit_ckptutil_c_FUN_0042e220(int param_1,int param_2,undefined4 param_3,int param_4,int param_5,int param_6,int param_7,int param_8)
;
; Local Variables:
; undefined4       Stack[-0x14]:4  local_14
;
; Called Functions:
;   cockpit_ckptutil.c_FUN_0042d150
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 0042e220
        ;   Label: cockpit_ckptutil.c_FUN_0042e220
    PUSH ESI                            ; 0042e221
    PUSH EDI                            ; 0042e222
    PUSH EBP                            ; 0042e223
    ...
    POP EBX                             ; 0042e246
    RET                                 ; 0042e247
    CALL cockpit_ckptutil.c_FUN_0042d150 ; 0042e248
        ;   XREF to: 0042d150 (UNCONDITIONAL_CALL)  ; undefined cockpit_ckptutil.c_FUN_0042d150()
        ;   Label: LAB_0042e248
