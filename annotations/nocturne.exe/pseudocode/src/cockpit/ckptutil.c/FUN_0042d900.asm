...
;                               FUNCTION
; *****************************************************************************
; void cockpit_ckptutil_c_FUN_0042d900(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6,int param_7,int param_8)
;
; Local Variables:
; undefined4       Stack[-0x34]:4  local_34
;
; XREF[1]:
;   cockpit_ckptutil.c_FUN_0042e4b0 at 0042e4d9
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 0042d900
        ;   Label: cockpit_ckptutil.c_FUN_0042d900
    PUSH ESI                            ; 0042d901
    PUSH EDI                            ; 0042d902
    PUSH EBP                            ; 0042d903
    ...
    MOV ECX,dword ptr [0x01c00c60]      ; 0042d913 | DAT_01c00c60
    MOV EAX,[0x01bd2fa4]                ; 0042d919 | DAT_01bd2fa4
    MOV EBP,dword ptr [0x01bd2fa0]      ; 0042d91e | DAT_01bd2fa0
    MOV EDX,dword ptr [0x01c00c58]      ; 0042d924 | DAT_01c00c58
    ...
    MOV EAX,dword ptr [ESP + 0x50]      ; 0042da58
        ;   Label: LAB_0042da58
    MOV EDX,dword ptr [EDX + 0x1bd2fa0] ; 0042da5c | DAT_01bd2fa0
