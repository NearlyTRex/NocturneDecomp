// Name: cockpit_ckptutil.c_saveEdgeListFile_FUN_0042ee00
// Address: 0042ee00
// Address Range: [[0042ee00, 0042ef5e]]
// Convention: __cdecl
// Signature: void __cdecl cockpit_ckptutil_c_saveEdgeListFile_FUN_0042ee00(char *filename,SEdgeList *edge_lists,int edge_list_count)
...

{
  ...
  if (edge_lists == (SEdgeList *)0x0) {
    ...
    g_CurrentLineNumber = 1272;
    core_main_c_displayErrorAndQuit_FUN_004c8440("Edge list array is empty!");
  }
  file = engine_dosio_cpp_getFile_FUN_00456a60("art",filename,"wt");
  if (file == (_FILE *)0x0) {
