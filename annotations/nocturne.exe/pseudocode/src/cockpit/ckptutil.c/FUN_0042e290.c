// Name: cockpit_ckptutil.c_FUN_0042e290
// Address: 0042e290
// Address Range: [[0042e290, 0042e3ca]]
// Convention: unknown
// Signature: undefined8 cockpit_ckptutil_c_FUN_0042e290(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6,int param_7,int param_8)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

ulonglong cockpit_ckptutil_c_FUN_0042e290(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6,int param_7,int param_8)
