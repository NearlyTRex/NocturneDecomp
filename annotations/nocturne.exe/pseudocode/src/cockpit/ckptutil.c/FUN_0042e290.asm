...
;                               FUNCTION
; *****************************************************************************
; undefined8 cockpit_ckptutil_c_FUN_0042e290(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6,int param_7,int param_8)
;
; Local Variables:
...
section .text
    ...
    PUSH EBX                            ; 0042e290
        ;   Label: cockpit_ckptutil.c_FUN_0042e290
    PUSH ESI                            ; 0042e291
    PUSH EDI                            ; 0042e292
    PUSH EBP                            ; 0042e293
    ...
    MOV EAX,[0x005b761c]                ; 0042e2e8 | DAT_005b761c
