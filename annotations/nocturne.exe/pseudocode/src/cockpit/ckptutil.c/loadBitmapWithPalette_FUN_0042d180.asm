...
;   cockpit_ckptutil.c_generateTransparencySpans_FUN_00431260
...
section .text
    ...
    PUSH ESI                            ; 0042d180
        ;   Label: cockpit_ckptutil.c_loadBitmapWithPalette_FUN_0042d180
    PUSH EDI                            ; 0042d181
    PUSH EBP                            ; 0042d182
    ...
    PUSH EBP                            ; 0042d1d0
    PUSH EBX                            ; 0042d1d1
    CALL cockpit_ckptutil.c_generateTransparencySpans_FUN_00431260 ; 0042d1d2
        ;   XREF to: 00431260 (UNCONDITIONAL_CALL)  ; void cockpit_ckptutil.c_generateTransparencySpans_FUN_00431260(void * bitmap_buffer, char * filename, SScanlineSpans * span_output, int width, ...)
