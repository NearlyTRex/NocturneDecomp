// Name: cockpit_ckptutil.c_FUN_0042dcc0
// Address: 0042dcc0
// Address Range: [[0042dcc0, 0042def0]]
// Convention: unknown
// Signature: void cockpit_ckptutil_c_FUN_0042dcc0(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void cockpit_ckptutil_c_FUN_0042dcc0(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6)
