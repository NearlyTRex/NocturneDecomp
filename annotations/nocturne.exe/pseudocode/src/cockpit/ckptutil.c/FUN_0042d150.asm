...
;                               FUNCTION
; *****************************************************************************
; code * cockpit_ckptutil_c_FUN_0042d150(void)
;
;
; XREF[3]:
;   cockpit_ckptutil.c_FUN_0042d130 at 0042d139
;   cockpit_ckptutil.c_FUN_0042e220 at 0042e248
;   cockpit_pkbitmap.cpp_FUN_004f44d0 at 004f45b6
;
; Referenced Globals:
...
section .text
    ...
    CMP dword ptr [0x01c03948],0x0      ; 0042d150 | DAT_01c03948
        ;   Label: cockpit_ckptutil.c_FUN_0042d150
