...
;
; XREF[1]:
;   cockpit_ckptutil.c_loadSingleEdgeList_FUN_0042edc0 at 0042edd5
;
; Referenced Globals:
...
;   crt_stdio.c_printf_FUN_00564c30
...
section .text
    ...
    PUSH EBX                            ; 0042eb90
        ;   Label: cockpit_ckptutil.c_loadEdgeListFile_FUN_0042eb90
    PUSH ESI                            ; 0042eb91
    PUSH EDI                            ; 0042eb92
    PUSH EBP                            ; 0042eb93
    ...
    PUSH EAX                            ; 0042ebdd
    MOV dword ptr [0x01cc4800],ESI      ; 0042ebde | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EDI      ; 0042ebe4 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 0042ebea
    ...
    PUSH EAX                            ; 0042ec30
    MOV dword ptr [0x01cc4800],EDX      ; 0042ec31 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],ECX      ; 0042ec37 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 0042ec3d
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
    ...
    MOV [0x01cc4804],EAX                ; 0042ec6b | g_CurrentLineNumber
    MOV EAX,ESP                         ; 0042ec70
    MOV EBP,0x57a831                    ; 0042ec72 | = "..\\cockpit\\ckptutil.c"
    PUSH EAX                            ; 0042ec77
    MOV dword ptr [0x01cc4800],EBP      ; 0042ec78 | g_CurrentFilename
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 0042ec7e
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
    ...
    PUSH EAX                            ; 0042ecd1
    MOV dword ptr [0x01cc4800],EDX      ; 0042ecd2 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],ECX      ; 0042ecd8 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 0042ecde
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
    ...
    PUSH EBP                            ; 0042ecec
    CALL crt_memory.c_free_FUN_005638d0 ; 0042eced
    ...
    PUSH EAX                            ; 0042ed4d
    MOV dword ptr [0x01cc4800],EDX      ; 0042ed4e | g_CurrentFilename
    MOV dword ptr [0x01cc4804],ECX      ; 0042ed54 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 0042ed5a
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
    ...
    PUSH 0x57a882                       ; 0042ed8a | = "\nUnable to allocate memory for edge ..."
        ;   Label: LAB_0042ed8a
    CALL crt_stdio.c_printf_FUN_00564c30 ; 0042ed8f
        ;   XREF to: 00564c30 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_printf_FUN_00564c30(char * format)
    MOV EAX,0x57a8ad                    ; 0042ed94 | = "..\\cockpit\\ckptutil.c"
    ADD ESP,0x4                         ; 0042ed99
    MOV [0x01cc4800],EAX                ; 0042ed9c | g_CurrentFilename
    MOV EAX,ESP                         ; 0042eda1
    MOV EDX,0x4ce                       ; 0042eda3
    PUSH EAX                            ; 0042eda8
    MOV dword ptr [0x01cc4804],EDX      ; 0042eda9 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 0042edaf
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
