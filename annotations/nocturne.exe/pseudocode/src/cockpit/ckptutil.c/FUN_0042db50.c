// Name: cockpit_ckptutil.c_FUN_0042db50
// Address: 0042db50
// Address Range: [[0042db50, 0042dcb5]]
// Convention: unknown
// Signature: int cockpit_ckptutil_c_FUN_0042db50(int param_1,int param_2,int param_3,int param_4,int param_5)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

int cockpit_ckptutil_c_FUN_0042db50(int param_1,int param_2,int param_3,int param_4,int param_5)
