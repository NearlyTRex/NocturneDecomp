...
section .text
    ...
    PUSH EBX                            ; 00430630
        ;   Label: cockpit_ckptutil.c_traceConnectedEdges_FUN_00430630
    PUSH ESI                            ; 00430631
    PUSH EDI                            ; 00430632
    PUSH EBP                            ; 00430633
    ...
    MOV [0x01cc4800],EAX                ; 00430748 | g_CurrentFilename
    MOV EAX,ESP                         ; 0043074d
    MOV EDX,0x87e                       ; 0043074f
    PUSH EAX                            ; 00430754
    MOV dword ptr [0x01cc4804],EDX      ; 00430755 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 0043075b
    ...
    MOV [0x01cc4800],EAX                ; 00430cfc | g_CurrentFilename
    MOV EAX,ESP                         ; 00430d01
    MOV EDX,0x8b8                       ; 00430d03
    PUSH EAX                            ; 00430d08
    MOV dword ptr [0x01cc4804],EDX      ; 00430d09 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 00430d0f
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
    ...
    PUSH EAX                            ; 00431091
    MOV dword ptr [0x01cc4800],EDX      ; 00431092 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],ECX      ; 00431098 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 0043109e
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
