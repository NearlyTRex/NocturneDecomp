// Name: cockpit_ckptutil.c_FUN_0042e3d0
// Address: 0042e3d0
// Address Range: [[0042e3d0, 0042e4a7]]
// Convention: unknown
// Signature: int cockpit_ckptutil_c_FUN_0042e3d0(int param_1,undefined4 param_2,int param_3,int param_4,int param_5,int param_6)

#include "nocturne.h"

int cockpit_ckptutil_c_FUN_0042e3d0(int param_1,uint param_2,int param_3,int param_4,int param_5,int param_6)
