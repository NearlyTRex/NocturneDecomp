...
section .text
    ...
    LEA EAX,[ESP + 0x8]                 ; 00491651
        ;   Label: LAB_00491651
    PUSH EAX                            ; 00491655
    CALL FUN_00408c10                   ; 00491656
        ;   XREF to: 00408c10 (UNCONDITIONAL_CALL)  ; undefined FUN_00408c10()
