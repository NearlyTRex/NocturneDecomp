...
section .text
    ...
    FMULP                               ; 0046823a
    FXCH ST3                            ; 0046823c
    CALL FUN_00563a30                   ; 0046823e
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FISTP dword ptr [ESP + 0x68]        ; 00468243
    FLDZ                                ; 00468247
    FXCH ST2                            ; 00468249
    CALL FUN_00563a30                   ; 0046824b
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH ST3                            ; 00468250
    CALL FUN_00563a30                   ; 00468252
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH ST3                            ; 00468257
