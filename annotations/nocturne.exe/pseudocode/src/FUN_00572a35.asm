...
;
; XREF[1]:
;   FUN_005706dd at 005707b4
;
; Referenced Globals:
;   void* PTR_thunk_FUN_00573ffb_005c2164 = 00573650
;
; Called Functions:
;   FUN_00568e90
;   FUN_00568e9c
...
section .text
    ...
    PUSH EBX                            ; 00572a40
    CALL dword ptr [0x005c2164]         ; 00572a41 | PTR_thunk_FUN_00573ffb_005c2164
    ...
    PUSH ECX                            ; 00572a54
    CALL FUN_005729e8                   ; 00572a55
        ;   XREF to: 005729e8 (UNCONDITIONAL_CALL)  ; undefined FUN_005729e8()
    ...
    CALL FUN_00568e90                   ; 00572a64
        ;   XREF to: 00568e90 (UNCONDITIONAL_CALL)  ; undefined FUN_00568e90()
    JMP 0x00572a70                      ; 00572a69
        ;   XREF to: 00572a70 (UNCONDITIONAL_JUMP)  ; LAB_00572a70
    CALL FUN_00568e9c                   ; 00572a6b
