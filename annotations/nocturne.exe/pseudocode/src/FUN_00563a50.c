...
// Convention: unknown
// Signature: uint FUN_00563a50(undefined4 *param_1,uint param_2,int param_3,int *param_4)

#include "nocturne.h"

uint FUN_00563a50(uint *param_1,uint param_2,int param_3,int *param_4)
