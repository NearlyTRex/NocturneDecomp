...
// Convention: unknown
// Signature: int FUN_0051e120(undefined4 param_1,undefined4 param_2,undefined4 param_3,int param_4)

#include "nocturne.h"

int FUN_0051e120(uint param_1,uint param_2,uint param_3,int param_4)

{
  ...
  iVar1 = FUN_004e1890(param_1);
  local_20 = *(int *)(param_4 * 0x54c + 0x9cc + iVar1);
  iVar1 = FUN_0051e0a0(param_1);
  iVar1 = *(int *)(iVar1 + 0x28558);
  FUN_0051e350(param_1,param_2,param_3,local_1afc);
  iVar5 = 0;
  FUN_0051f1d0(local_1afc,param_1);
  local_24 = -1;
  local_1c = 1e+30;
  if (0 < local_20) {
    do {
      local_14 = iVar5;
      FUN_0051e350(param_1,param_4,(float)iVar5,local_3598);
      FUN_0051f1d0(local_3598,param_1);
      iVar3 = 0;
      local_18 = 0.0;
      if (0 < iVar1) {
        local_18 = 0.0;
