...
;   undefined1* PTR_FUN_005a4554 = 0055ec20
...
section .text
    ...
    MOV dword ptr [EAX + -0x4],0x5a4554 ; 0055eae6 | PTR_FUN_005a4554
    CALL FUN_0051e0c0                   ; 0055eaed
