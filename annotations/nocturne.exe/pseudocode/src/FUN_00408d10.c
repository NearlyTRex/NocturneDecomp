...
// Convention: unknown
// Signature: void FUN_00408d10(int param_1,uint param_2,int param_3)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_00408d10(int param_1,uint param_2,int param_3)

{
  ...
  if (iVar2 != 0) {
    ...
    if (_DAT_01c00c78 == 0) {
      FUN_004349a0(*(uint *)(param_1 + 4),&DAT_006b029c);
      return;
    }
