...
section .text
    ...
    PUSH EAX                            ; 005067f9
    CALL FUN_0040ca80                   ; 005067fa
        ;   XREF to: 0040ca80 (UNCONDITIONAL_CALL)  ; undefined FUN_0040ca80()
    MOV EDX,dword ptr [0x005be310]      ; 005067ff | DAT_005be310
