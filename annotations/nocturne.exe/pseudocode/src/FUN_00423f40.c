...
// Convention: unknown
// Signature: int FUN_00423f40(undefined4 param_1)

#include "nocturne.h"

int FUN_00423f40(uint param_1)

{
  ...
  iVar1 = FUN_0051b660(iVar1 + 0x150);
  iVar1 = FUN_00438210(iVar1 + 0x293c);
  iVar1 = FUN_005644a7(iVar1 + 0x1c8,0xf,&DAT_005993b0);
  iVar1 = FUN_005644a7(iVar1 + 0xb4,0xf,&DAT_005993b0);
  iVar1 = FUN_005644a7(iVar1 + 0x20c,0x32,&DAT_00599960);
  iVar1 = FUN_005644a7(iVar1 + 0x4b0,0x32,&DAT_00599940);
  *(byte ***)(iVar1 + -0x3278) = &PTR_FUN_0059b0a4;
  *(uint *)(iVar1 + -0xfc0) = 0;
  *(uint *)(iVar1 + -0xf9c) = 0;
