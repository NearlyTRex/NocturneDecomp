...
section .text
    ...
    PUSH EBX                            ; 005144f8
    CALL FUN_00514470                   ; 005144f9
        ;   XREF to: 00514470 (UNCONDITIONAL_CALL)  ; undefined FUN_00514470()
    ...
    PUSH EAX                            ; 005145e1
    CALL FUN_00564b20                   ; 005145e2
        ;   XREF to: 00564b20 (UNCONDITIONAL_CALL)  ; undefined FUN_00564b20()
    ADD ESP,0xc                         ; 005145e7
    LEA EAX,[EBX + 0x140]               ; 005145ea
        ;   Label: LAB_005145ea
    PUSH EAX                            ; 005145f0
    PUSH 0x590c89                       ; 005145f1 | DAT_00590c89
    PUSH ESI                            ; 005145f6
    CALL FUN_00563350                   ; 005145f7
        ;   XREF to: 00563350 (UNCONDITIONAL_CALL)  ; undefined FUN_00563350()
    ...
    PUSH EAX                            ; 0051469b
    PUSH 0x590cab                       ; 0051469c | DAT_00590cab
    PUSH ESI                            ; 005146a1
    CALL FUN_00563350                   ; 005146a2
        ;   XREF to: 00563350 (UNCONDITIONAL_CALL)  ; undefined FUN_00563350()
    ...
    PUSH EAX                            ; 005147c8
    CALL FUN_00564b20                   ; 005147c9
        ;   XREF to: 00564b20 (UNCONDITIONAL_CALL)  ; undefined FUN_00564b20()
    ADD ESP,0xc                         ; 005147ce
    ADD EBX,0x174                       ; 005147d1
    PUSH EBX                            ; 005147d7
    PUSH 0x590cc3                       ; 005147d8 | DAT_00590cc3
    PUSH ESI                            ; 005147dd
    CALL FUN_00563350                   ; 005147de
        ;   XREF to: 00563350 (UNCONDITIONAL_CALL)  ; undefined FUN_00563350()
