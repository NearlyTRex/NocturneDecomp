...
;
; XREF[1]:
;   FUN_0054c690 at 0054d1a9
;
; Referenced Globals:
;   string s_voicusummon.wav_00597229
...
section .text
    ...
    MOV EBX,dword ptr [0x005be368]      ; 0054e0ce | DAT_005be368
        ;   Label: LAB_0054e0ce
    CMP ESI,dword ptr [EBX + 0x14cd6c]  ; 0054e0d4 | DAT_01fa3ff0
