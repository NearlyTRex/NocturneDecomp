...
// Convention: unknown
// Signature: undefined4 FUN_004ba8a0(int param_1)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_004ba8a0(int param_1)

{
  ...
  *(uint *)(param_1 + 0x1fa60) = 0;
  ...
  local_24 = 0;
  local_20 = 0x40000000;
  FUN_0040a240(param_1,&local_34,&local_28);
  iVar6 = 0;
  for (iVar5 = 0; iVar5 < *(int *)(0x01E57284 + 0x14cd6c); iVar5 = iVar5 + 1) {
    ...
    if (iVar4 == 0) {
      iVar4 = FUN_0040d890(iVar1,_DAT_02dd1008);
      if (iVar4 != 0) {
  ...
  *(float *)(param_1 + 0x28) =
  ...
  FUN_004e16b0(param_1 + 0x150,0x13,1);
  return 1;
}
