...
section .text
    ...
    PUSH EAX                            ; 0043f7fc
    CALL FUN_0040c900                   ; 0043f7fd
        ;   XREF to: 0040c900 (UNCONDITIONAL_CALL)  ; undefined FUN_0040c900()
    ADD ESP,0x8                         ; 0043f802
    CMP dword ptr [0x005ad3f0],0x4      ; 0043f805 | DAT_005ad3f0
        ;   Label: LAB_0043f805
    ...
    PUSH EAX                            ; 0043f89a
    CALL FUN_0040c880                   ; 0043f89b
        ;   XREF to: 0040c880 (UNCONDITIONAL_CALL)  ; undefined FUN_0040c880()
    ADD ESP,0x8                         ; 0043f8a0
    CMP dword ptr [0x005ad3f0],0x6      ; 0043f8a3 | DAT_005ad3f0
        ;   Label: LAB_0043f8a3
