...
section .text
    ...
    PUSH EAX                            ; 0042cca1
    CALL FUN_0040c6d0                   ; 0042cca2
        ;   XREF to: 0040c6d0 (UNCONDITIONAL_CALL)  ; undefined FUN_0040c6d0()
    ADD ESP,0x8                         ; 0042cca7
    CMP dword ptr [0x005ad250],0x4      ; 0042ccaa | DAT_005ad250
        ;   Label: LAB_0042ccaa
