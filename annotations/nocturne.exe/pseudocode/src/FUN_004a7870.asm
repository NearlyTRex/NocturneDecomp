...
section .text
    ...
    PUSH EBX                            ; 004a7c65
    CALL FUN_004a7710                   ; 004a7c66
        ;   XREF to: 004a7710 (UNCONDITIONAL_CALL)  ; undefined FUN_004a7710()
