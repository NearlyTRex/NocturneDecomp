...
section .text
    ...
    JG 0x00403da0                       ; 00403d22
        ;   XREF to: 00403da0 (CONDITIONAL_JUMP)  ; LAB_00403da0
    MOV EBX,dword ptr [0x005b7624]      ; 00403d28 | g_BitsPerPixel
    ...
    JG 0x00403da0                       ; 00403d54
        ;   XREF to: 00403da0 (CONDITIONAL_JUMP)  ; LAB_00403da0
    MOV BL,byte ptr [0x01c00c70]        ; 00403d56 | g_ActiveRenderColor
    MOV ECX,dword ptr [EDX + 0x1bd2fa0] ; 00403d5c | g_ScreenBufferArray | g_ScreenBufferArray[1]
    ...
    MOV EBX,dword ptr [0x01c00c70]      ; 00403d6b | g_ActiveRenderColor
        ;   Label: LAB_00403d6b
    ...
    MOV ECX,dword ptr [EDX + 0x1bd2fa0] ; 00403d84 | g_ScreenBufferArray | g_ScreenBufferArray[1]
        ;   Label: LAB_00403d84
    ...
    POP EBX                             ; 00403da3
    RET                                 ; 00403da4
    MOV EDI,dword ptr [0x01c00c70]      ; 00403da5 | g_ActiveRenderColor
        ;   Label: LAB_00403da5
    ...
    MOV ECX,dword ptr [EDX + 0x1bd2fa0] ; 00403dc1 | g_ScreenBufferArray | g_ScreenBufferArray[1]
        ;   Label: LAB_00403dc1
