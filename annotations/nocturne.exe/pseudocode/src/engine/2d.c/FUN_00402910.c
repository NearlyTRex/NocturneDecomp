...
// Convention: unknown
// Signature: void engine_2d_c_FUN_00402910(undefined4 param_1,undefined4 param_2,char *param_3)

#include "nocturne.h"

void engine_2d_c_FUN_00402910(uint param_1,uint param_2,char *param_3)
