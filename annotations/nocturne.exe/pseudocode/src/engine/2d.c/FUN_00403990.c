...
// Convention: unknown
// Signature: void FUN_00403990(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6,int param_7,int param_8)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_00403990(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6,int param_7,int param_8)

{
  ...
  local_14 = FUN_00403900(param_1,param_2,param_5,param_6,param_7,param_8);
  local_18 = FUN_00403900(param_3,param_4,param_5,param_6,param_7,param_8);
  local_1c = 0;
  do {
    ...
    if (local_14 == 0) {
      local_18 = FUN_00403900(unaff_EBX,unaff_EDI,param_5,param_6,param_7,param_8);
      param_3 = unaff_EBX;
      param_4 = unaff_EDI;
    }
    else {
      local_14 = FUN_00403900(unaff_EBX,unaff_EDI,param_5,param_6,param_7,param_8);
      param_2 = unaff_EDI;
      param_1 = unaff_EBX;
    }
    local_1c = local_1c + 1;
  ...
  if (local_20 != 0) {
    FUN_004015a0(param_1,param_2,param_3,param_4);
    return;
  }
  return;
}
