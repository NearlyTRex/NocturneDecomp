...
;                               FUNCTION
; *****************************************************************************
; void engine_2d_c_FUN_004029f0(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
;
; Local Variables:
...
section .text
    ...
    PUSH EBX                            ; 004029f0
        ;   Label: engine_2d.c_FUN_004029f0
    PUSH ESI                            ; 004029f1
    PUSH EDI                            ; 004029f2
    ...
    PUSH EAX                            ; 00402a1b
    CALL crt_stdio.c_vsprintf_FUN_00563a08 ; 00402a1c
    ...
    CALL engine_2d.c_FUN_00402980       ; 00402a4a
