...
;   core_game.cpp_captureDebugMovieFrame_FUN_0049a320 at 0049a5fd
;   core_main.c_showDeveloperToolsMenu_FUN_004c8510 at 004c8527
...
section .text
    ...
    CMP dword ptr [0x005acaa4],0x0      ; 0040260f | INT_005acaa4
