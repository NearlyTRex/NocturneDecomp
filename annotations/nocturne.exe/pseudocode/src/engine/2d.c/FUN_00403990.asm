...
section .text
    ...
    PUSH EDX                            ; 004039b4
    CALL FUN_00403900                   ; 004039b5
        ;   XREF to: 00403900 (UNCONDITIONAL_CALL)  ; undefined FUN_00403900()
