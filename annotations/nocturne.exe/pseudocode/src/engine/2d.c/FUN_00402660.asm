...
;                               FUNCTION
; *****************************************************************************
; void engine_2d_c_FUN_00402660(byte *param_1,int param_2,undefined4 param_3)
;
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 00402660
        ;   Label: engine_2d.c_FUN_00402660
    PUSH ESI                            ; 00402661
    PUSH EDI                            ; 00402662
    PUSH EBP                            ; 00402663
    ...
    CALL engine_2d.c_drawCharacterMasked_FUN_00401f30 ; 00402697
        ;   XREF to: 00401f30 (UNCONDITIONAL_CALL)  ; undefined engine_2d.c_drawCharacterMasked_FUN_00401f30()
