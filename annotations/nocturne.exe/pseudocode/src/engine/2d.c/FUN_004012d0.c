// Name: engine_2d.c_FUN_004012d0
// Address: 004012d0
// Address Range: [[004012d0, 004013cb]]
// Convention: __cdecl
// Signature: void __cdecl engine_2d_c_FUN_004012d0(int param_1,int param_2,int param_3)
...

{
  ...
  if ((((0 < param_3) && (param_3 + 0x18 < g_WindowHeight)) && (0 < param_2)) &&
     (((param_2 + 0x17 < g_WindowWidth && (0x1f < param_1)) && (param_1 < 0x80)))) {
    iStack_14 = param_3 * 4;
    iVar1 = g_FontCharWidths[param_1];
    iVar2 = iStack_14 + 0x5c;
    puVar7 = g_FontGlyphPtrs[param_1];
    do {
