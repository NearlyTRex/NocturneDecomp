...
;
; Parameters:
; int              Stack[0x4]:4   fog_color_index
; Local Variables:
...
;
; XREF[1]:
;   engine_2d.c_loadOrBuildFogTable_FUN_00403070 at 004030e6
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00402e90
        ;   Label: engine_2d.c_buildFogTable_FUN_00402e90
    PUSH ESI                            ; 00402e91
    PUSH EDI                            ; 00402e92
    PUSH EBP                            ; 00402e93
    SUB ESP,0x34                        ; 00402e94
    MOV EAX,dword ptr [ESP + 0x48]      ; 00402e97
    MOV [0x006af634],EAX                ; 00402e9b | g_FogColorIndex
