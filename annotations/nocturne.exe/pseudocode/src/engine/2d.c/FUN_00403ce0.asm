...
;
; XREF[3]:
;   FUN_00403e10 at 00403e3d
;   FUN_00476260 at 0047629b
;   FUN_00476310 at 004763df
;
; Referenced Globals:
...
section .text
    ...
    MOV [0x01cc4800],EAX                ; 00403ded | DAT_01cc4800
    MOV dword ptr [0x01cc4804],EDX      ; 00403df2 | DAT_01cc4804
    CALL FUN_004c8440                   ; 00403df8
