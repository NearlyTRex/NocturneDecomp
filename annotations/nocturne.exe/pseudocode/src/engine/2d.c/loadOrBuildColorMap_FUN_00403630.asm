...
;
; XREF[1]:
;   engine_2d.c_initGraphicsSystem_FUN_00401010 at 00401076
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 00403630
        ;   Label: engine_2d.c_loadOrBuildColorMap_FUN_00403630
    PUSH ESI                            ; 00403631
    PUSH EDI                            ; 00403632
    ...
    MOV dword ptr [0x01cc4800],EDX      ; 00403687 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],ECX      ; 0040368d | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 00403693
    ...
    MOV dword ptr [0x01cc4800],ESI      ; 004036f7 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EDI      ; 004036fd | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 00403703
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
    ...
    PUSH 0x1                            ; 00403711
    PUSH 0x1bf7720                      ; 00403713 | g_ColorCubeLookup
    ...
    PUSH 0x1                            ; 00403736
    PUSH 0x1bf7720                      ; 00403738 | g_ColorCubeLookup
