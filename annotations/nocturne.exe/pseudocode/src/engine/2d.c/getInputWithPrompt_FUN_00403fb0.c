...
// Convention: __cdecl
// Signature: int __cdecl engine_2d_c_getInputWithPrompt_FUN_00403fb0(char *buffer,int max_length,int x,int y,char *prompt)
...

{
  ...
  *buffer = '\0';
  ...
  iVar3 = 0;
  do {
    _sprintf(local_114,"%s%s_    ");
    engine_2d_c_drawText_FUN_00402600(local_114,x,y);
