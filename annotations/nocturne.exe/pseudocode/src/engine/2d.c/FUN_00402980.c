...
// Convention: unknown
// Signature: void engine_2d_c_FUN_00402980(char *param_1,int param_2,int param_3,int param_4)
...

{
  ...
  engine_2d_c_drawText_FUN_00402600(param_1,(((param_2 + param_3) - iVar1) + 2) / 2,param_4);
  return;
}
