// Name: engine_2d.c_buildLightTable_FUN_004031a0
// Address: 004031a0
// Address Range: [[004031a0, 00403452]]
// Convention: __cdecl
// Signature: void __cdecl engine_2d_c_buildLightTable_FUN_004031a0(int base_color_index)
...

{
  ...
  iVar8 = 0;
  local_18 = 0;
  bVar1 = g_SourcePaletteData[base_color_index * 3 + 2];
  do {
