...

{
  ...
  do {
    ...
    *(float *)((int)g_PaletteLuminanceCache + iVar6) =
         SQRT((float)g_SourcePaletteData[iVar5] * (float)g_SourcePaletteData[iVar5] +
              (float)g_SourcePaletteData[iVar3] * (float)g_SourcePaletteData[iVar3] +
  ...
  do {
    ...
    do {
      ...
      do {
        puVar8 = puVar9 + 1;
        iVar5 = iVar3 + 8;
        iVar3 = engine_2d_c_findBestPaletteMatch_FUN_00401850(iVar6,iVar4,iVar3,10,0xe5);
        *puVar9 = (uchar)iVar3;
        iVar3 = iVar5;
        puVar9 = puVar8;
      } while (iVar5 < 0x100);
