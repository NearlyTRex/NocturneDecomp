...
;   engine_2d.c_buildBlendTables_FUN_00401990
;   engine_2d.c_loadLightTable_FUN_00403460
;   engine_2d.c_loadOrBuildColorMap_FUN_00403630
;   engine_2d.c_loadPaletteFile_FUN_00401bd0
;   engine_dosio.cpp_getFile_FUN_00456a60
;   engine_dosio.cpp_getFileSize_FUN_004568c0
;   wincore_wddvmem.cpp_initializeGraphicsSystem_FUN_00552b40
...
section .text
    ...
    PUSH ESI                            ; 00401011
    PUSH EBP                            ; 00401012
    MOV EBP,dword ptr [0x006afa38]      ; 00401013 | g_FontBitmapData
    MOV EDX,dword ptr [0x005b7620]      ; 00401019 | g_WindowHeight
    PUSH EDX                            ; 0040101f
    MOV ECX,dword ptr [0x005b761c]      ; 00401020 | g_WindowWidth
    PUSH ECX                            ; 00401026
    CALL wincore_wddvmem.cpp_initializeGraphicsSystem_FUN_00552b40 ; 00401027
        ;   XREF to: 00552b40 (UNCONDITIONAL_CALL)  ; int wincore_wddvmem.cpp_initializeGraphicsSystem_FUN_00552b40(int width, int height)
    ...
    PUSH EDI                            ; 00401037
        ;   Label: LAB_00401037
    MOV EAX,[0x006af628]                ; 00401038 | g_RenderingMode
    PUSH 0x8                            ; 0040103d
    MOV ECX,dword ptr [EAX*0x8 + 0x5aca6c] ; 0040103f | g_ResolutionTable
    MOV EAX,dword ptr [EAX*0x8 + 0x5aca70] ; 00401046 | g_ResolutionTable[0].height
    PUSH EAX                            ; 0040104d
    PUSH ECX                            ; 0040104e
    ...
    CALL engine_2d.c_loadPaletteFile_FUN_00401bd0 ; 0040105c
        ;   XREF to: 00401bd0 (UNCONDITIONAL_CALL)  ; void engine_2d.c_loadPaletteFile_FUN_00401bd0(char * filename)
    ADD ESP,0x4                         ; 00401061
    PUSH 0x577047                       ; 00401064 | = "vga.lte"
    CALL engine_2d.c_loadLightTable_FUN_00403460 ; 00401069
        ;   XREF to: 00403460 (UNCONDITIONAL_CALL)  ; void engine_2d.c_loadLightTable_FUN_00403460(char * filename)
    ADD ESP,0x4                         ; 0040106e
    PUSH 0x57704f                       ; 00401071 | = "vga.map"
    CALL engine_2d.c_loadOrBuildColorMap_FUN_00403630 ; 00401076
        ;   XREF to: 00403630 (UNCONDITIONAL_CALL)  ; void engine_2d.c_loadOrBuildColorMap_FUN_00403630(char * filename)
    ADD ESP,0x4                         ; 0040107b
    PUSH 0x577057                       ; 0040107e | = "vga.act"
    CALL engine_2d.c_buildBlendTables_FUN_00401990 ; 00401083
        ;   XREF to: 00401990 (UNCONDITIONAL_CALL)  ; void engine_2d.c_buildBlendTables_FUN_00401990(char * filename)
    ...
    MOV EDI,0x6afa3c                    ; 004010b1 | g_FontCharWidths
        ;   Label: LAB_004010b1
    MOV EBX,0x6afa3c                    ; 004010b6 | g_FontCharWidths
    ADD EDI,0x200                       ; 004010bb
    ADD EBX,0x80                        ; 004010c1
    PUSH EBX                            ; 004010c7 | g_FontCharWidths[32] | g_FontCharWidths[33]
        ;   Label: LAB_004010c7
    ...
    MOV [0x006afa38],EAX                ; 00401105 | g_FontBitmapData
    ...
    MOV dword ptr [0x01cc4800],EDX      ; 0040111d | g_CurrentFilename
    MOV dword ptr [0x01cc4804],ECX      ; 00401123 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 00401129
    ...
    PUSH 0x1                            ; 00401153
    PUSH ESI                            ; 00401155
    MOV EBP,dword ptr [0x006afa38]      ; 00401156 | g_FontBitmapData
    PUSH EBP                            ; 0040115c
    ...
    MOV EBP,dword ptr [0x006afa38]      ; 00401170 | g_FontBitmapData
    ADD ESP,0x4                         ; 00401176
    XOR EBX,EBX                         ; 00401179
    POP EDI                             ; 0040117b
    LEA ECX,[EBX + EBP*0x1]             ; 0040117c
        ;   Label: LAB_0040117c
    MOV EDX,dword ptr [EAX + 0x6afa3c]  ; 0040117f | g_FontCharWidths[32] | g_FontCharWidths[33]
    MOV dword ptr [EAX + 0x6afe3c],ECX  ; 00401185 | g_FontGlyphPtrs[32] | g_FontGlyphPtrs[33]
    ...
    MOV dword ptr [0x01c00c80],ECX      ; 004011a4 | g_ReciprocalLookupTable
    MOV ECX,0x4                         ; 004011aa
    MOV ESI,0xffffffff                  ; 004011af
    MOV dword ptr [0x006afa38],EBP      ; 004011b4 | g_FontBitmapData
    ...
    INC EBX                             ; 004011c3
    MOV dword ptr [ECX + 0x1c00c7c],EAX ; 004011c4 | g_ReciprocalLookupTable[1] | g_ReciprocalLookupTable[2]
    ...
    MOV EBP,dword ptr [0x006afa38]      ; 004011f3 | g_FontBitmapData
    POP EBP                             ; 004011f9
    POP ESI                             ; 004011fa
    POP EBX                             ; 004011fb
    RET                                 ; 004011fc
    ...
    MOV dword ptr [0x01cc4800],EBX      ; 0040120c | g_CurrentFilename
    MOV dword ptr [0x01cc4804],ESI      ; 00401212 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 00401218
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
    ...
    MOV dword ptr [0x01cc4800],EDI      ; 00401234 | g_CurrentFilename
    MOV [0x01cc4804],EAX                ; 0040123a | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 0040123f
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
    ...
    MOV dword ptr [0x01cc4800],EDI      ; 0040125b | g_CurrentFilename
    MOV [0x01cc4804],EAX                ; 00401261 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 00401266
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
    ...
    MOV EBP,dword ptr [0x006afa38]      ; 00401291 | g_FontBitmapData
    POP EBP                             ; 00401297
    POP ESI                             ; 00401298
    POP EBX                             ; 00401299
    RET                                 ; 0040129a
