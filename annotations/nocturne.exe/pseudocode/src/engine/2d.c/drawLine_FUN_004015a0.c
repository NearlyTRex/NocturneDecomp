// Name: engine_2d.c_drawLine_FUN_004015a0
// Address: 004015a0
// Address Range: [[004015a0, 00401673]]
// Convention: __cdecl
// Signature: void __cdecl engine_2d_c_drawLine_FUN_004015a0(int param_1,int param_2,int param_3,int param_4)
...

{
  ...
  if (iVar1 < param_3) {
    ...
    if (-1 < param_3) {
      do {
        engine_2d_c_plotPixel_FUN_00401530(iVar2,param_2);
        if (0 < iVar3) {
          param_2 = param_2 + 1;
          iVar3 = iVar3 - param_3;
        }
