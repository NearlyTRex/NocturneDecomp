...
// Convention: unknown
// Signature: void engine_2d_c_FUN_004027f0(undefined4 param_1,int param_2,undefined4 param_3)

#include "nocturne.h"

void engine_2d_c_FUN_004027f0(uint param_1,int param_2,uint param_3)
