...
; int              Stack[0x8]:4   fog_color_index
;
; Referenced Globals:
...
;   engine_2d.c_buildFogTable_FUN_00402e90
;   engine_2d.c_saveFogTable_FUN_00403130
...
section .text
    ...
    PUSH EBX                            ; 00403070
        ;   Label: engine_2d.c_loadOrBuildFogTable_FUN_00403070
    PUSH EDI                            ; 00403071
    ...
    PUSH EBX                            ; 004030e5
        ;   Label: LAB_004030e5
    CALL engine_2d.c_buildFogTable_FUN_00402e90 ; 004030e6
        ;   XREF to: 00402e90 (UNCONDITIONAL_CALL)  ; void engine_2d.c_buildFogTable_FUN_00402e90(int fog_color_index)
    ADD ESP,0x4                         ; 004030eb
    PUSH EDI                            ; 004030ee
    CALL engine_2d.c_saveFogTable_FUN_00403130 ; 004030ef
        ;   XREF to: 00403130 (UNCONDITIONAL_CALL)  ; void engine_2d.c_saveFogTable_FUN_00403130(char * filename)
