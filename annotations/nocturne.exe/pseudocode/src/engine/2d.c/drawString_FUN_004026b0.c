...
// Convention: __cdecl
// Signature: void __cdecl engine_2d_c_drawString_FUN_004026b0(char *text,int x_pos,int y_pos,int color)
  ...
  if (0 < (int)(~uVar4 - 1)) {
    do {
      ...
      if ((0x1f < bVar2) && (bVar2 < 0x100)) {
        iVar3 = engine_2d_c_drawCharacterMaskedColor_FUN_00402040((uint)bVar2,x_pos,y_pos,color);
        x_pos = x_pos + iVar3;
      }
      iVar5 = iVar5 + 1;
      text = text + 1;
