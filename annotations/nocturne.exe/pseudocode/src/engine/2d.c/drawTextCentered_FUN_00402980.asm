...
;
; XREF[2]:
;   engine_2d.c_drawTextCenteredFormatted_FUN_004029f0 at 00402a4a
;   engine_2d.c_drawTextCenteredReordered_FUN_004029c0 at 004029d6
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 00402980
        ;   Label: engine_2d.c_drawTextCentered_FUN_00402980
    PUSH ESI                            ; 00402981
