...
;
; XREF[2]:
;   engine_2d.c_drawTextCenteredAtFormatted_FUN_00402910 at 00402961
;   engine_2d.c_drawTextCenteredAtWrapper_FUN_004028f0 at 00402900
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 004028b0
        ;   Label: engine_2d.c_drawTextCenteredAt_FUN_004028b0
