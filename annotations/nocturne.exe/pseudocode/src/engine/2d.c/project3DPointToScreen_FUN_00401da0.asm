...
;
; XREF[2]:
;   engine_2d.c_draw320x200SizeDot_FUN_00403780 at 004037c9
...
section .text
    ...
    MOV EDX,dword ptr [0x01c00c48]      ; 00401daa | g_Projection
    MOV EBX,ECX                         ; 00401db0
    IMUL EDX                            ; 00401db2
    IDIV EBX                            ; 00401db4
    MOV ESI,dword ptr [0x01c00c50]      ; 00401db6 | g_Projection.center_x_fixed
    MOV EDX,dword ptr [0x01c00c4c]      ; 00401dbc | g_Projection.neg_half_height_fixed
    MOV EBX,ECX                         ; 00401dc2
    ADD ESI,EAX                         ; 00401dc4
    MOV EAX,dword ptr [ESP + 0x10]      ; 00401dc6
    IMUL EDX                            ; 00401dca
    IDIV EBX                            ; 00401dcc
    ADD EAX,dword ptr [0x01c00c54]      ; 00401dce | g_Projection.center_y_fixed
