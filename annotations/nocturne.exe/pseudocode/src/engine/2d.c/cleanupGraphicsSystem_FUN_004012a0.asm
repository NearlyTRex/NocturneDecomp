...
;   core_main.c_finalizeGameSystems_FUN_004c90e0 at 004c936b
;
; Referenced Globals:
...
;   wincore_wddvmem.cpp_cleanupGraphicsSystem_FUN_00552cb0
;
; *****************************************************************************
...
section .text
    ...
    MOV EDX,dword ptr [0x006afa38]      ; 004012a0 | g_FontBitmapData
        ;   Label: engine_2d.c_cleanupGraphicsSystem_FUN_004012a0
