// Name: engine_3d.c_FUN_00404b10
// Address: 00404b10
// Address Range: [[00404b10, 00405138]]
// Convention: unknown
// Signature: int engine_3d_c_FUN_00404b10(int param_1)
...

{
  ...
  iVar3 = g_RelativeY;
  iVar2 = g_RelativeX;
  iVar17 = g_RelativeX - *(int *)(param_1 + 0x14);
  iVar18 = g_RelativeY - *(int *)(param_1 + 0x18);
  iVar19 = g_RelativeZ - *(int *)(param_1 + 0x1c);
  iVar20 = engine_matrix_c_interpolatedSin_FUN_004cca60(*(int *)(param_1 + 8));
  iVar21 = engine_matrix_c_interpolatedCos_FUN_004ccaa0(*(int *)(param_1 + 8));
  iVar22 = engine_matrix_c_interpolatedSin_FUN_004cca60(*(int *)(param_1 + 0xc));
  iVar23 = engine_matrix_c_interpolatedCos_FUN_004ccaa0(*(int *)(param_1 + 0xc));
  iVar24 = engine_matrix_c_interpolatedSin_FUN_004cca60(*(int *)(param_1 + 0x10));
  iVar25 = engine_matrix_c_interpolatedCos_FUN_004ccaa0(*(int *)(param_1 + 0x10));
  lVar1 = (longlong)
  ...
  engine_3d_c_FUN_00408e80(param_1 + *(int *)(param_1 + 4));
