...
section .text
    ...
    CMP dword ptr [0x01c00c78],0x0      ; 004048ca | g_AdvancedClippingEnabled
    JZ 0x0040494e                       ; 004048d1
        ;   XREF to: 0040494e (CONDITIONAL_JUMP)  ; LAB_0040494e
    CMP dword ptr [0x01c03948],0x0      ; 004048d7 | g_MMXSupported
    JNZ 0x0040492d                      ; 004048de
        ;   XREF to: 0040492d (CONDITIONAL_JUMP)  ; LAB_0040492d
    CMP dword ptr [0x005b7624],0x20     ; 004048e0 | g_BitsPerPixel
    JNZ 0x00404921                      ; 004048e7
        ;   XREF to: 00404921 (CONDITIONAL_JUMP)  ; LAB_00404921
    MOV dword ptr [0x01c00c7c],0x5300ec ; 004048e9 | g_ScanlineRenderFunc
    ...
    PUSH EDX                            ; 004048fe
    MOV dword ptr [0x01c039a0],EBP      ; 004048ff | g_RenderStateFlags
    MOV [0x01c039a4],EAX                ; 00404905 | g_VertexPreprocessMode
    CALL engine_clipper.c_clipAndRasterize_FUN_00432cd0 ; 0040490a
    ...
    POP EBX                             ; 0040491f
    RET                                 ; 00404920
    MOV dword ptr [0x01c00c7c],0x530322 ; 00404921 | g_ScanlineRenderFunc
        ;   Label: LAB_00404921
    JMP 0x004048f3                      ; 0040492b
        ;   XREF to: 004048f3 (UNCONDITIONAL_JUMP)  ; LAB_004048f3
    CMP dword ptr [0x005b7624],0x20     ; 0040492d | g_BitsPerPixel
        ;   Label: LAB_0040492d
    JNZ 0x00404942                      ; 00404934
        ;   XREF to: 00404942 (CONDITIONAL_JUMP)  ; LAB_00404942
    MOV dword ptr [0x01c00c7c],0x52f031 ; 00404936 | g_ScanlineRenderFunc
    JMP 0x004048f3                      ; 00404940
        ;   XREF to: 004048f3 (UNCONDITIONAL_JUMP)  ; LAB_004048f3
    MOV dword ptr [0x01c00c7c],0x52f823 ; 00404942 | g_ScanlineRenderFunc
        ;   Label: LAB_00404942
    JMP 0x004048f3                      ; 0040494c
        ;   XREF to: 004048f3 (UNCONDITIONAL_JUMP)  ; LAB_004048f3
    CMP dword ptr [0x01c03948],0x0      ; 0040494e | g_MMXSupported
        ;   Label: LAB_0040494e
    JNZ 0x004049a4                      ; 00404955
        ;   XREF to: 004049a4 (CONDITIONAL_JUMP)  ; LAB_004049a4
    CMP dword ptr [0x005b7624],0x20     ; 00404957 | g_BitsPerPixel
    JNZ 0x00404998                      ; 0040495e
        ;   XREF to: 00404998 (CONDITIONAL_JUMP)  ; LAB_00404998
    MOV dword ptr [0x01c00c7c],0x5300ec ; 00404960 | g_ScanlineRenderFunc
    ...
    PUSH EDX                            ; 00404975
    MOV dword ptr [0x01c039a0],EBP      ; 00404976 | g_RenderStateFlags
    MOV [0x01c039a4],EAX                ; 0040497c | g_VertexPreprocessMode
    ...
    POP EBX                             ; 00404996
    RET                                 ; 00404997
    MOV dword ptr [0x01c00c7c],0x530322 ; 00404998 | g_ScanlineRenderFunc
        ;   Label: LAB_00404998
    JMP 0x0040496a                      ; 004049a2
        ;   XREF to: 0040496a (UNCONDITIONAL_JUMP)  ; LAB_0040496a
    CMP dword ptr [0x005b7624],0x20     ; 004049a4 | g_BitsPerPixel
        ;   Label: LAB_004049a4
    JNZ 0x004049b9                      ; 004049ab
        ;   XREF to: 004049b9 (CONDITIONAL_JUMP)  ; LAB_004049b9
    MOV dword ptr [0x01c00c7c],0x52f031 ; 004049ad | g_ScanlineRenderFunc
    JMP 0x0040496a                      ; 004049b7
        ;   XREF to: 0040496a (UNCONDITIONAL_JUMP)  ; LAB_0040496a
    MOV dword ptr [0x01c00c7c],0x52f823 ; 004049b9 | g_ScanlineRenderFunc
        ;   Label: LAB_004049b9
