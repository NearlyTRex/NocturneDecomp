...
section .text
    ...
    CMP dword ptr [0x01c03948],0x0      ; 00407daa | g_MMXSupported
    JNZ 0x00407e2b                      ; 00407db1
        ;   XREF to: 00407e2b (CONDITIONAL_JUMP)  ; LAB_00407e2b
    CMP dword ptr [0x005b7624],0x20     ; 00407db7 | g_BitsPerPixel
    JNZ 0x00407e1f                      ; 00407dbe
        ;   XREF to: 00407e1f (CONDITIONAL_JUMP)  ; LAB_00407e1f
    MOV dword ptr [0x01c00c7c],0x5300ec ; 00407dc0 | g_ScanlineRenderFunc
    PUSH EDI                            ; 00407dca
        ;   Label: LAB_00407dca
    ...
    MOV dword ptr [0x01c039a0],0xe3     ; 00407de4 | g_RenderStateFlags
    MOV EDX,0x1                         ; 00407dee
        ;   Label: LAB_00407dee
    PUSH EBX                            ; 00407df3
    MOV dword ptr [0x01c039a4],EDX      ; 00407df4 | g_VertexPreprocessMode
    ...
    PUSH ECX                            ; 00407e06
    CALL engine_clipper.c_clipAndRasterize_FUN_00432cd0 ; 00407e07
    ...
    POP EBX                             ; 00407e1d
    RET                                 ; 00407e1e
    MOV dword ptr [0x01c00c7c],0x530322 ; 00407e1f | g_ScanlineRenderFunc
        ;   Label: LAB_00407e1f
    JMP 0x00407dca                      ; 00407e29
        ;   XREF to: 00407dca (UNCONDITIONAL_JUMP)  ; LAB_00407dca
    CMP dword ptr [0x005b7624],0x20     ; 00407e2b | g_BitsPerPixel
        ;   Label: LAB_00407e2b
    JNZ 0x00407e40                      ; 00407e32
        ;   XREF to: 00407e40 (CONDITIONAL_JUMP)  ; LAB_00407e40
    MOV dword ptr [0x01c00c7c],0x52f031 ; 00407e34 | g_ScanlineRenderFunc
    JMP 0x00407dca                      ; 00407e3e
        ;   XREF to: 00407dca (UNCONDITIONAL_JUMP)  ; LAB_00407dca
    MOV dword ptr [0x01c00c7c],0x52f823 ; 00407e40 | g_ScanlineRenderFunc
        ;   Label: LAB_00407e40
