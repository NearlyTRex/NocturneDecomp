...
section .text
    ...
    CMP dword ptr [0x005b7624],0x20     ; 00405e45 | g_BitsPerPixel
    JNZ 0x00405ea8                      ; 00405e4c
        ;   XREF to: 00405ea8 (CONDITIONAL_JUMP)  ; LAB_00405ea8
    MOV dword ptr [0x01c00c7c],0x5300ec ; 00405e4e | g_ScanlineRenderFunc
    XOR EBX,EBX                         ; 00405e58
        ;   Label: LAB_00405e58
    MOV dword ptr [0x01c039a4],EBX      ; 00405e5a | g_VertexPreprocessMode
    MOV dword ptr [0x01c039a0],EBX      ; 00405e60 | g_RenderStateFlags
    ...
    MOV dword ptr [0x01c00c7c],0x530322 ; 00405ea8 | g_ScanlineRenderFunc
        ;   Label: LAB_00405ea8
    JMP 0x00405e58                      ; 00405eb2
        ;   XREF to: 00405e58 (UNCONDITIONAL_JUMP)  ; LAB_00405e58
    CMP dword ptr [0x005b7624],0x20     ; 00405eb4 | g_BitsPerPixel
        ;   Label: LAB_00405eb4
    JNZ 0x00405ec9                      ; 00405ebb
        ;   XREF to: 00405ec9 (CONDITIONAL_JUMP)  ; LAB_00405ec9
    MOV dword ptr [0x01c00c7c],0x52f031 ; 00405ebd | g_ScanlineRenderFunc
    JMP 0x00405e58                      ; 00405ec7
        ;   XREF to: 00405e58 (UNCONDITIONAL_JUMP)  ; LAB_00405e58
    MOV dword ptr [0x01c00c7c],0x52f823 ; 00405ec9 | g_ScanlineRenderFunc
        ;   Label: LAB_00405ec9
    ...
    CMP dword ptr [0x01c03948],0x0      ; 00405ee2 | g_MMXSupported
    JNZ 0x00405f2d                      ; 00405ee9
        ;   XREF to: 00405f2d (CONDITIONAL_JUMP)  ; LAB_00405f2d
    CMP dword ptr [0x005b7624],0x20     ; 00405eeb | g_BitsPerPixel
    JNZ 0x00405f21                      ; 00405ef2
        ;   XREF to: 00405f21 (CONDITIONAL_JUMP)  ; LAB_00405f21
    MOV dword ptr [0x01c00c7c],0x5300ec ; 00405ef4 | g_ScanlineRenderFunc
    MOV EDI,0xd1                        ; 00405efe
        ;   Label: LAB_00405efe
    MOV EAX,0x3                         ; 00405f03
    PUSH EBP                            ; 00405f08
    MOV dword ptr [0x01c039a0],EDI      ; 00405f09 | g_RenderStateFlags
    MOV [0x01c039a4],EAX                ; 00405f0f | g_VertexPreprocessMode
    ...
    MOV dword ptr [0x01c00c7c],0x530322 ; 00405f21 | g_ScanlineRenderFunc
        ;   Label: LAB_00405f21
    JMP 0x00405efe                      ; 00405f2b
        ;   XREF to: 00405efe (UNCONDITIONAL_JUMP)  ; LAB_00405efe
    CMP dword ptr [0x005b7624],0x20     ; 00405f2d | g_BitsPerPixel
        ;   Label: LAB_00405f2d
    JNZ 0x00405f42                      ; 00405f34
        ;   XREF to: 00405f42 (CONDITIONAL_JUMP)  ; LAB_00405f42
    MOV dword ptr [0x01c00c7c],0x52f031 ; 00405f36 | g_ScanlineRenderFunc
    JMP 0x00405efe                      ; 00405f40
        ;   XREF to: 00405efe (UNCONDITIONAL_JUMP)  ; LAB_00405efe
    MOV dword ptr [0x01c00c7c],0x52f823 ; 00405f42 | g_ScanlineRenderFunc
        ;   Label: LAB_00405f42
    JMP 0x00405efe                      ; 00405f4c
        ;   XREF to: 00405efe (UNCONDITIONAL_JUMP)  ; LAB_00405efe
    CMP dword ptr [0x01c03948],0x0      ; 00405f4e | g_MMXSupported
        ;   Label: LAB_00405f4e
    JNZ 0x00405fbe                      ; 00405f55
        ;   XREF to: 00405fbe (CONDITIONAL_JUMP)  ; LAB_00405fbe
    CMP dword ptr [0x005b7624],0x20     ; 00405f57 | g_BitsPerPixel
    JNZ 0x00405fb2                      ; 00405f5e
        ;   XREF to: 00405fb2 (CONDITIONAL_JUMP)  ; LAB_00405fb2
    MOV dword ptr [0x01c00c7c],0x5300ec ; 00405f60 | g_ScanlineRenderFunc
    ...
    PUSH EDI                            ; 00405f7f
    MOV [0x01c039a0],EAX                ; 00405f80 | g_RenderStateFlags
    MOV dword ptr [0x01c039a4],EDX      ; 00405f85 | g_VertexPreprocessMode
    ...
    MOV EAX,[0x01c00c74]                ; 00405f93 | g_CurrentLightingValue
    PUSH EAX                            ; 00405f98
    ...
    MOV [0x01c00c70],EAX                ; 00405fa8 | g_ActiveRenderColor
    JMP 0x00405e66                      ; 00405fad
        ;   XREF to: 00405e66 (UNCONDITIONAL_JUMP)  ; LAB_00405e66
    MOV dword ptr [0x01c00c7c],0x530322 ; 00405fb2 | g_ScanlineRenderFunc
        ;   Label: LAB_00405fb2
    JMP 0x00405f6a                      ; 00405fbc
        ;   XREF to: 00405f6a (UNCONDITIONAL_JUMP)  ; LAB_00405f6a
    CMP dword ptr [0x005b7624],0x20     ; 00405fbe | g_BitsPerPixel
        ;   Label: LAB_00405fbe
    JNZ 0x00405fd3                      ; 00405fc5
        ;   XREF to: 00405fd3 (CONDITIONAL_JUMP)  ; LAB_00405fd3
    MOV dword ptr [0x01c00c7c],0x52f031 ; 00405fc7 | g_ScanlineRenderFunc
    JMP 0x00405f6a                      ; 00405fd1
        ;   XREF to: 00405f6a (UNCONDITIONAL_JUMP)  ; LAB_00405f6a
    MOV dword ptr [0x01c00c7c],0x52f823 ; 00405fd3 | g_ScanlineRenderFunc
        ;   Label: LAB_00405fd3
    ...
    PUSH 0x6b029c                       ; 00405fdf | DAT_006b029c
        ;   Label: LAB_00405fdf
    PUSH EBX                            ; 00405fe4
    CALL engine_clipper.c_clipAndRasterize_FUN_00432cd0 ; 00405fe5
