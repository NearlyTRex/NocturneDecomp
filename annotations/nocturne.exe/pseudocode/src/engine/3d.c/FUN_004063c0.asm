...
;                               FUNCTION
; *****************************************************************************
; undefined * FUN_004063c0(undefined4 *param_1)
;
; Local Variables:
...
section .text
    ...
    PUSH EAX                            ; 004063e9
    MOV dword ptr [0x01cc4804],EBX      ; 004063ea | DAT_01cc4804
    MOV dword ptr [0x01cc4800],ECX      ; 004063f0 | DAT_01cc4800
    CALL FUN_004c8440                   ; 004063f6
