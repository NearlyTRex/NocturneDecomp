...
section .text
    ...
    CMP dword ptr [0x01c03948],0x0      ; 00406f4a | g_MMXSupported
    JNZ 0x00406fa6                      ; 00406f51
        ;   XREF to: 00406fa6 (CONDITIONAL_JUMP)  ; LAB_00406fa6
    CMP dword ptr [0x005b7624],0x20     ; 00406f53 | g_BitsPerPixel
    JNZ 0x00406f9a                      ; 00406f5a
        ;   XREF to: 00406f9a (CONDITIONAL_JUMP)  ; LAB_00406f9a
    MOV dword ptr [0x01c00c7c],0x5300ec ; 00406f5c | g_ScanlineRenderFunc
    PUSH EDI                            ; 00406f66
        ;   Label: LAB_00406f66
    ...
    PUSH EAX                            ; 00406f75
    MOV dword ptr [0x01c039a0],EDI      ; 00406f76 | g_RenderStateFlags
    MOV dword ptr [0x01c039a4],EBP      ; 00406f7c | g_VertexPreprocessMode
    CALL engine_clipper.c_clipAndRasterize_FUN_00432cd0 ; 00406f82
    ...
    POP EBX                             ; 00406f98
    RET                                 ; 00406f99
    MOV dword ptr [0x01c00c7c],0x530322 ; 00406f9a | g_ScanlineRenderFunc
        ;   Label: LAB_00406f9a
    JMP 0x00406f66                      ; 00406fa4
        ;   XREF to: 00406f66 (UNCONDITIONAL_JUMP)  ; LAB_00406f66
    CMP dword ptr [0x005b7624],0x20     ; 00406fa6 | g_BitsPerPixel
        ;   Label: LAB_00406fa6
    JNZ 0x00406fbb                      ; 00406fad
        ;   XREF to: 00406fbb (CONDITIONAL_JUMP)  ; LAB_00406fbb
    MOV dword ptr [0x01c00c7c],0x52f031 ; 00406faf | g_ScanlineRenderFunc
    JMP 0x00406f66                      ; 00406fb9
        ;   XREF to: 00406f66 (UNCONDITIONAL_JUMP)  ; LAB_00406f66
    MOV dword ptr [0x01c00c7c],0x52f823 ; 00406fbb | g_ScanlineRenderFunc
        ;   Label: LAB_00406fbb
