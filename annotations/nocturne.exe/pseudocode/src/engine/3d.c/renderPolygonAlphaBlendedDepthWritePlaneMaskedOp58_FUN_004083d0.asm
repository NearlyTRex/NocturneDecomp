...
section .text
    ...
    CMP dword ptr [0x01c02594],0x0      ; 004083d5 | g_UseExternalRenderer
    ...
    CMP dword ptr [0x01c00c78],0x0      ; 004083f6 | g_AdvancedClippingEnabled
    JZ 0x0040847c                       ; 004083fd
        ;   XREF to: 0040847c (CONDITIONAL_JUMP)  ; LAB_0040847c
    CMP dword ptr [0x01c03948],0x0      ; 00408403 | g_MMXSupported
    JNZ 0x0040845b                      ; 0040840a
        ;   XREF to: 0040845b (CONDITIONAL_JUMP)  ; LAB_0040845b
    CMP dword ptr [0x005b7624],0x20     ; 0040840c | g_BitsPerPixel
    JNZ 0x0040844f                      ; 00408413
        ;   XREF to: 0040844f (CONDITIONAL_JUMP)  ; LAB_0040844f
    MOV dword ptr [0x01c00c7c],0x5300ec ; 00408415 | g_ScanlineRenderFunc
    ...
    PUSH ECX                            ; 0040842d
    MOV [0x01c039a0],EAX                ; 0040842e | g_RenderStateFlags
    MOV dword ptr [0x01c039a4],EDX      ; 00408433 | g_VertexPreprocessMode
    CALL engine_clipper.c_clipAndRasterize_FUN_00432cd0 ; 00408439
    ...
    POP EBX                             ; 0040844d
    RET                                 ; 0040844e
    MOV dword ptr [0x01c00c7c],0x530322 ; 0040844f | g_ScanlineRenderFunc
        ;   Label: LAB_0040844f
    JMP 0x0040841f                      ; 00408459
        ;   XREF to: 0040841f (UNCONDITIONAL_JUMP)  ; LAB_0040841f
    CMP dword ptr [0x005b7624],0x20     ; 0040845b | g_BitsPerPixel
        ;   Label: LAB_0040845b
    JNZ 0x00408470                      ; 00408462
        ;   XREF to: 00408470 (CONDITIONAL_JUMP)  ; LAB_00408470
    MOV dword ptr [0x01c00c7c],0x52f031 ; 00408464 | g_ScanlineRenderFunc
    JMP 0x0040841f                      ; 0040846e
        ;   XREF to: 0040841f (UNCONDITIONAL_JUMP)  ; LAB_0040841f
    MOV dword ptr [0x01c00c7c],0x52f823 ; 00408470 | g_ScanlineRenderFunc
        ;   Label: LAB_00408470
    JMP 0x0040841f                      ; 0040847a
        ;   XREF to: 0040841f (UNCONDITIONAL_JUMP)  ; LAB_0040841f
    CMP dword ptr [0x01c03948],0x0      ; 0040847c | g_MMXSupported
        ;   Label: LAB_0040847c
    JNZ 0x004084d1                      ; 00408483
        ;   XREF to: 004084d1 (CONDITIONAL_JUMP)  ; LAB_004084d1
    CMP dword ptr [0x005b7624],0x20     ; 00408485 | g_BitsPerPixel
    JNZ 0x004084c5                      ; 0040848c
        ;   XREF to: 004084c5 (CONDITIONAL_JUMP)  ; LAB_004084c5
    MOV dword ptr [0x01c00c7c],0x5300ec ; 0040848e | g_ScanlineRenderFunc
    ...
    PUSH ECX                            ; 004084a3
    MOV [0x01c039a0],EAX                ; 004084a4 | g_RenderStateFlags
    MOV dword ptr [0x01c039a4],EDX      ; 004084a9 | g_VertexPreprocessMode
    ...
    POP EBX                             ; 004084c3
    RET                                 ; 004084c4
    MOV dword ptr [0x01c00c7c],0x530322 ; 004084c5 | g_ScanlineRenderFunc
        ;   Label: LAB_004084c5
    JMP 0x00408498                      ; 004084cf
        ;   XREF to: 00408498 (UNCONDITIONAL_JUMP)  ; LAB_00408498
    CMP dword ptr [0x005b7624],0x20     ; 004084d1 | g_BitsPerPixel
        ;   Label: LAB_004084d1
    JNZ 0x004084e6                      ; 004084d8
        ;   XREF to: 004084e6 (CONDITIONAL_JUMP)  ; LAB_004084e6
    MOV dword ptr [0x01c00c7c],0x52f031 ; 004084da | g_ScanlineRenderFunc
    JMP 0x00408498                      ; 004084e4
        ;   XREF to: 00408498 (UNCONDITIONAL_JUMP)  ; LAB_00408498
    MOV dword ptr [0x01c00c7c],0x52f823 ; 004084e6 | g_ScanlineRenderFunc
        ;   Label: LAB_004084e6
