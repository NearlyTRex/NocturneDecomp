// Name: engine_3d.c_renderPolygonFogTexturedDepthWriteOp44_FUN_00407410
// Address: 00407410
// Address Range: [[00407410, 004074a6]]
// Convention: __cdecl
// Signature: SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonFogTexturedDepthWriteOp44_FUN_00407410(SMRGLHeaderPrimitive *prim)
...

{
  ...
  if (iVar1 != 0) {
    ...
    g_RenderStateFlags.dword = (RENDER_TEX_ENABLE | RENDER_FOG_COLOR | RENDER_DEPTH_WRITE);
