...
section .text
    ...
    CMP dword ptr [0x01c03948],0x0      ; 00406afa | g_MMXSupported
    JNZ 0x00406b5f                      ; 00406b01
        ;   XREF to: 00406b5f (CONDITIONAL_JUMP)  ; LAB_00406b5f
    CMP dword ptr [0x005b7624],0x20     ; 00406b03 | g_BitsPerPixel
    JNZ 0x00406b53                      ; 00406b0a
        ;   XREF to: 00406b53 (CONDITIONAL_JUMP)  ; LAB_00406b53
    MOV dword ptr [0x01c00c7c],0x5300ec ; 00406b0c | g_ScanlineRenderFunc
    PUSH EDI                            ; 00406b16
        ;   Label: LAB_00406b16
    MOV EDI,0x9                         ; 00406b17
    MOV EBP,0x2                         ; 00406b1c
    PUSH EBX                            ; 00406b21
    MOV dword ptr [0x01c039a0],EDI      ; 00406b22 | g_RenderStateFlags
    MOV dword ptr [0x01c039a4],EBP      ; 00406b28 | g_VertexPreprocessMode
    ...
    PUSH EAX                            ; 00406b3a
    CALL engine_clipper.c_clipAndRasterize_FUN_00432cd0 ; 00406b3b
    ...
    POP EBX                             ; 00406b51
    RET                                 ; 00406b52
    MOV dword ptr [0x01c00c7c],0x530322 ; 00406b53 | g_ScanlineRenderFunc
        ;   Label: LAB_00406b53
    JMP 0x00406b16                      ; 00406b5d
        ;   XREF to: 00406b16 (UNCONDITIONAL_JUMP)  ; LAB_00406b16
    CMP dword ptr [0x005b7624],0x20     ; 00406b5f | g_BitsPerPixel
        ;   Label: LAB_00406b5f
    JNZ 0x00406b74                      ; 00406b66
        ;   XREF to: 00406b74 (CONDITIONAL_JUMP)  ; LAB_00406b74
    MOV dword ptr [0x01c00c7c],0x52f031 ; 00406b68 | g_ScanlineRenderFunc
    JMP 0x00406b16                      ; 00406b72
        ;   XREF to: 00406b16 (UNCONDITIONAL_JUMP)  ; LAB_00406b16
    MOV dword ptr [0x01c00c7c],0x52f823 ; 00406b74 | g_ScanlineRenderFunc
        ;   Label: LAB_00406b74
