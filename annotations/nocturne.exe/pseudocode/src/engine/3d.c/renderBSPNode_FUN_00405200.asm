...
section .text
    ...
    PUSH EBX                            ; 00405200
        ;   Label: engine_3d.c_renderBSPNode_FUN_00405200
    ...
    PUSH EAX                            ; 0040521a
    CALL engine_3d.c_dispatchMRGLBlockChain_FUN_00408e80 ; 0040521b
    ...
    PUSH EAX                            ; 0040522f
    CALL engine_3d.c_dispatchMRGLBlockChain_FUN_00408e80 ; 00405230
        ;   XREF to: 00408e80 (UNCONDITIONAL_CALL)  ; void engine_3d.c_dispatchMRGLBlockChain_FUN_00408e80(SMRGLHeaderExtended * chain)
