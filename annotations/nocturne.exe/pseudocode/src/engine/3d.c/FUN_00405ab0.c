// Name: engine_3d.c_FUN_00405ab0
// Address: 00405ab0
// Address Range: [[00405ab0, 00405b23]]
// Convention: unknown
// Signature: void engine_3d_c_FUN_00405ab0(int param_1,undefined4 param_2,undefined4 param_3)

#include "nocturne.h"

void engine_3d_c_FUN_00405ab0(int param_1,uint param_2,uint param_3)
  ...
  if (DAT_006b0268 < 500) {
    ...
    if (iVar1 != 0) {
      ...
      *(uint *)(&DAT_006b02e4 + iVar1) = param_3;
      engine_3d_c_FUN_004059c0(param_1);
