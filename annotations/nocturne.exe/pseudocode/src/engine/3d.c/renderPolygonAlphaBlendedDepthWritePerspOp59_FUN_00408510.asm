...
section .text
    ...
    CMP dword ptr [0x01c02594],0x0      ; 00408515 | g_UseExternalRenderer
    ...
    CMP dword ptr [0x01c00c78],0x0      ; 00408536 | g_AdvancedClippingEnabled
    JZ 0x004085bc                       ; 0040853d
        ;   XREF to: 004085bc (CONDITIONAL_JUMP)  ; LAB_004085bc
    CMP dword ptr [0x01c03948],0x0      ; 00408543 | g_MMXSupported
    JNZ 0x0040859b                      ; 0040854a
        ;   XREF to: 0040859b (CONDITIONAL_JUMP)  ; LAB_0040859b
    CMP dword ptr [0x005b7624],0x20     ; 0040854c | g_BitsPerPixel
    JNZ 0x0040858f                      ; 00408553
        ;   XREF to: 0040858f (CONDITIONAL_JUMP)  ; LAB_0040858f
    MOV dword ptr [0x01c00c7c],0x5300ec ; 00408555 | g_ScanlineRenderFunc
    ...
    PUSH ECX                            ; 0040856d
    MOV [0x01c039a0],EAX                ; 0040856e | g_RenderStateFlags
    MOV dword ptr [0x01c039a4],EDX      ; 00408573 | g_VertexPreprocessMode
    CALL engine_clipper.c_clipAndRasterize_FUN_00432cd0 ; 00408579
    ...
    POP EBX                             ; 0040858d
    RET                                 ; 0040858e
    MOV dword ptr [0x01c00c7c],0x530322 ; 0040858f | g_ScanlineRenderFunc
        ;   Label: LAB_0040858f
    JMP 0x0040855f                      ; 00408599
        ;   XREF to: 0040855f (UNCONDITIONAL_JUMP)  ; LAB_0040855f
    CMP dword ptr [0x005b7624],0x20     ; 0040859b | g_BitsPerPixel
        ;   Label: LAB_0040859b
    JNZ 0x004085b0                      ; 004085a2
        ;   XREF to: 004085b0 (CONDITIONAL_JUMP)  ; LAB_004085b0
    MOV dword ptr [0x01c00c7c],0x52f031 ; 004085a4 | g_ScanlineRenderFunc
    JMP 0x0040855f                      ; 004085ae
        ;   XREF to: 0040855f (UNCONDITIONAL_JUMP)  ; LAB_0040855f
    MOV dword ptr [0x01c00c7c],0x52f823 ; 004085b0 | g_ScanlineRenderFunc
        ;   Label: LAB_004085b0
    JMP 0x0040855f                      ; 004085ba
        ;   XREF to: 0040855f (UNCONDITIONAL_JUMP)  ; LAB_0040855f
    CMP dword ptr [0x01c03948],0x0      ; 004085bc | g_MMXSupported
        ;   Label: LAB_004085bc
    JNZ 0x00408614                      ; 004085c3
        ;   XREF to: 00408614 (CONDITIONAL_JUMP)  ; LAB_00408614
    CMP dword ptr [0x005b7624],0x20     ; 004085c5 | g_BitsPerPixel
    JNZ 0x00408608                      ; 004085cc
        ;   XREF to: 00408608 (CONDITIONAL_JUMP)  ; LAB_00408608
    MOV dword ptr [0x01c00c7c],0x5300ec ; 004085ce | g_ScanlineRenderFunc
    ...
    PUSH ECX                            ; 004085e6
    MOV [0x01c039a0],EAX                ; 004085e7 | g_RenderStateFlags
    MOV dword ptr [0x01c039a4],EDX      ; 004085ec | g_VertexPreprocessMode
    ...
    POP EBX                             ; 00408606
    RET                                 ; 00408607
    MOV dword ptr [0x01c00c7c],0x530322 ; 00408608 | g_ScanlineRenderFunc
        ;   Label: LAB_00408608
    JMP 0x004085d8                      ; 00408612
        ;   XREF to: 004085d8 (UNCONDITIONAL_JUMP)  ; LAB_004085d8
    CMP dword ptr [0x005b7624],0x20     ; 00408614 | g_BitsPerPixel
        ;   Label: LAB_00408614
    JNZ 0x00408629                      ; 0040861b
        ;   XREF to: 00408629 (CONDITIONAL_JUMP)  ; LAB_00408629
    MOV dword ptr [0x01c00c7c],0x52f031 ; 0040861d | g_ScanlineRenderFunc
    JMP 0x004085d8                      ; 00408627
        ;   XREF to: 004085d8 (UNCONDITIONAL_JUMP)  ; LAB_004085d8
    MOV dword ptr [0x01c00c7c],0x52f823 ; 00408629 | g_ScanlineRenderFunc
        ;   Label: LAB_00408629
    ...
    CALL engine_3d.c_renderPolygonAlphaBlendedPlaneMaskedPerspOp37_FUN_00406d80 ; 0040863f
        ;   XREF to: 00406d80 (UNCONDITIONAL_CALL)  ; SMRGLHeaderExtended * engine_3d.c_renderPolygonAlphaBlendedPlaneMaskedPerspOp37_FUN_00406d80(SMRGLHeaderPrimitive * prim)
