...
// Convention: unknown
// Signature: int engine_3d_c_renderPolygonTexturedUVLitPlaneMasked_FUN_00405340(SMRGLHeaderPrimitive *param_1)
...

{
  ...
  piVar3 = &DAT_006b029c;
  pSVar2 = param_1 + 1;
  for (iVar4 = 0; iVar1 = DAT_006b0264, iVar4 < (param_1->base).count * 3; iVar4 = iVar4 + 3) {
