// Name: engine_3d.c_renderPolygonFogColorOp6_FUN_004048b0
// Address: 004048b0
// Address Range: [[004048b0, 004049c4]]
// Convention: __cdecl
// Signature: SMRGLHeaderExtended * __cdecl engine_3d_c_renderPolygonFogColorOp6_FUN_004048b0(SMRGLHeaderPrimitive *prim)
...

{
  ...
  if (iVar1 != 0) {
    if (g_AdvancedClippingEnabled == 0) {
      ...
      g_RenderStateFlags.dword = (RENDER_FOG_COLOR | RENDER_COLOR_FROM_VERTEX);
    ...
    g_RenderStateFlags.dword = RENDER_FOG_COLOR;
    g_VertexPreprocessMode = 0;
