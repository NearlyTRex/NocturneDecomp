...
section .text
    ...
    PUSH EBX                            ; 00404430
        ;   Label: engine_3d.c_abortRemovedMRGLHandler_FUN_00404430
    ...
    PUSH EAX                            ; 00404459
    MOV dword ptr [0x01cc4804],EBX      ; 0040445a | g_CurrentLineNumber
    MOV dword ptr [0x01cc4800],ECX      ; 00404460 | g_CurrentFilename
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 00404466
