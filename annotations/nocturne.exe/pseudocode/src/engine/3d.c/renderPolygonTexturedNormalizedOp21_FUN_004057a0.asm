...
section .text
    ...
    MOV dword ptr [0x01c00c7c],0x5300ec ; 004057cc | DAT_01c00c7c
    PUSH EDI                            ; 004057d6
        ;   Label: LAB_004057d6
    ...
    CALL engine_clipper.c_FUN_00432cd0  ; 004057f2
    ...
    POP EBX                             ; 00405808
    RET                                 ; 00405809
    MOV dword ptr [0x01c00c7c],0x530322 ; 0040580a | DAT_01c00c7c
        ;   Label: LAB_0040580a
    ...
    MOV dword ptr [0x01c00c7c],0x52f031 ; 0040581f | DAT_01c00c7c
    JMP 0x004057d6                      ; 00405829
        ;   XREF to: 004057d6 (UNCONDITIONAL_JUMP)  ; LAB_004057d6
    MOV dword ptr [0x01c00c7c],0x52f823 ; 0040582b | DAT_01c00c7c
        ;   Label: LAB_0040582b
