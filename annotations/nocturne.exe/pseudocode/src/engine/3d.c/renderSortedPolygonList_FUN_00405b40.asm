...
;
; XREF[1]:
;   engine_3d.c_flushSortedPolygons_FUN_00405b30 at 00405b32
;
; Referenced Globals:
...
;   engine_3d.c_queueSortedPolygon_FUN_00405ab0
...
section .text
    ...
    PUSH EBX                            ; 00405b40
        ;   Label: engine_3d.c_renderSortedPolygonList_FUN_00405b40
    PUSH ESI                            ; 00405b41
    PUSH EDI                            ; 00405b42
    PUSH EBP                            ; 00405b43
    ...
    CMP dword ptr [0x005acaac],0x0      ; 00405b84 | INT_005acaac
        ;   Label: LAB_00405b84
    ...
    PUSH ESI                            ; 00405bda
    PUSH EBX                            ; 00405bdb
    CALL engine_3d.c_queueSortedPolygon_FUN_00405ab0 ; 00405bdc
        ;   XREF to: 00405ab0 (UNCONDITIONAL_CALL)  ; void engine_3d.c_queueSortedPolygon_FUN_00405ab0(SMRGLHeaderExtended * primitive, SMRGLHeaderExtended * owner_block, SMRGLHeaderExtended * chain_root)
