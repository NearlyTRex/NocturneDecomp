...
section .text
    ...
    CMP dword ptr [0x01c03948],0x0      ; 00404a8a | g_MMXSupported
    JNZ 0x00404ae6                      ; 00404a91
        ;   XREF to: 00404ae6 (CONDITIONAL_JUMP)  ; LAB_00404ae6
    CMP dword ptr [0x005b7624],0x20     ; 00404a93 | g_BitsPerPixel
    JNZ 0x00404ada                      ; 00404a9a
        ;   XREF to: 00404ada (CONDITIONAL_JUMP)  ; LAB_00404ada
    MOV dword ptr [0x01c00c7c],0x5300ec ; 00404a9c | g_ScanlineRenderFunc
    PUSH EDI                            ; 00404aa6
        ;   Label: LAB_00404aa6
    ...
    PUSH EAX                            ; 00404ab5
    MOV dword ptr [0x01c039a0],EDI      ; 00404ab6 | g_RenderStateFlags
    MOV dword ptr [0x01c039a4],EBP      ; 00404abc | g_VertexPreprocessMode
    CALL engine_clipper.c_clipAndRasterize_FUN_00432cd0 ; 00404ac2
    ...
    POP EBX                             ; 00404ad8
    RET                                 ; 00404ad9
    MOV dword ptr [0x01c00c7c],0x530322 ; 00404ada | g_ScanlineRenderFunc
        ;   Label: LAB_00404ada
    JMP 0x00404aa6                      ; 00404ae4
        ;   XREF to: 00404aa6 (UNCONDITIONAL_JUMP)  ; LAB_00404aa6
    CMP dword ptr [0x005b7624],0x20     ; 00404ae6 | g_BitsPerPixel
        ;   Label: LAB_00404ae6
    JNZ 0x00404afb                      ; 00404aed
        ;   XREF to: 00404afb (CONDITIONAL_JUMP)  ; LAB_00404afb
    MOV dword ptr [0x01c00c7c],0x52f031 ; 00404aef | g_ScanlineRenderFunc
    JMP 0x00404aa6                      ; 00404af9
        ;   XREF to: 00404aa6 (UNCONDITIONAL_JUMP)  ; LAB_00404aa6
    MOV dword ptr [0x01c00c7c],0x52f823 ; 00404afb | g_ScanlineRenderFunc
        ;   Label: LAB_00404afb
