...
section .text
    ...
    CMP dword ptr [0x01c03948],0x0      ; 00407cda | g_MMXSupported
    JNZ 0x00407d65                      ; 00407ce1
        ;   XREF to: 00407d65 (CONDITIONAL_JUMP)  ; LAB_00407d65
    CMP dword ptr [0x005b7624],0x20     ; 00407ce7 | g_BitsPerPixel
    JNZ 0x00407d59                      ; 00407cee
        ;   XREF to: 00407d59 (CONDITIONAL_JUMP)  ; LAB_00407d59
    MOV dword ptr [0x01c00c7c],0x5300ec ; 00407cf0 | g_ScanlineRenderFunc
    PUSH EDI                            ; 00407cfa
        ;   Label: LAB_00407cfa
    ...
    PUSH ECX                            ; 00407d0d
    MOV dword ptr [0x01c039a0],EDI      ; 00407d0e | g_RenderStateFlags
    MOV dword ptr [0x01c039a4],EBP      ; 00407d14 | g_VertexPreprocessMode
    ...
    PUSH EDI                            ; 00407d29
    MOV [0x01c00c74],EAX                ; 00407d2a | g_CurrentLightingValue
    ...
    PUSH EBP                            ; 00407d3b
    MOV [0x01c00c70],EAX                ; 00407d3c | g_ActiveRenderColor
    CALL engine_clipper.c_clipAndRasterize_FUN_00432cd0 ; 00407d41
    ...
    POP EBX                             ; 00407d57
    RET                                 ; 00407d58
    MOV dword ptr [0x01c00c7c],0x530322 ; 00407d59 | g_ScanlineRenderFunc
        ;   Label: LAB_00407d59
    JMP 0x00407cfa                      ; 00407d63
        ;   XREF to: 00407cfa (UNCONDITIONAL_JUMP)  ; LAB_00407cfa
    CMP dword ptr [0x005b7624],0x20     ; 00407d65 | g_BitsPerPixel
        ;   Label: LAB_00407d65
    JNZ 0x00407d7a                      ; 00407d6c
        ;   XREF to: 00407d7a (CONDITIONAL_JUMP)  ; LAB_00407d7a
    MOV dword ptr [0x01c00c7c],0x52f031 ; 00407d6e | g_ScanlineRenderFunc
    JMP 0x00407cfa                      ; 00407d78
        ;   XREF to: 00407cfa (UNCONDITIONAL_JUMP)  ; LAB_00407cfa
    MOV dword ptr [0x01c00c7c],0x52f823 ; 00407d7a | g_ScanlineRenderFunc
        ;   Label: LAB_00407d7a
