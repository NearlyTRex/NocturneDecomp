// Name: engine_3d.c_FUN_00406a00
// Address: 00406a00
// Address Range: [[00406a00, 00406ad3]]
// Convention: unknown
// Signature: int * engine_3d_c_FUN_00406a00(SMRGLHeaderPrimitive *param_1)
...

{
  ...
  *(uint *)((int)&local_28 + (uint)bVar2 * -8 + (uint)bVar2 * -8 + 8) =
  ...
  if (iVar1 != 0) {
    ...
    engine_clipper_c_clipAndRasterize_FUN_00432cd0((param_1->base).count,(int *)(param_1 + 1));
  }
