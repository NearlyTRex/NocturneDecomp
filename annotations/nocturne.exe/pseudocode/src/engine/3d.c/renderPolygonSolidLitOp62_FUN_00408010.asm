...
section .text
    ...
    CMP dword ptr [0x01c03948],0x0      ; 0040802d | g_MMXSupported
    JNZ 0x004080d0                      ; 00408034
        ;   XREF to: 004080d0 (CONDITIONAL_JUMP)  ; LAB_004080d0
    CMP dword ptr [0x005b7624],0x20     ; 0040803a | g_BitsPerPixel
    JNZ 0x004080c4                      ; 00408041
        ;   XREF to: 004080c4 (CONDITIONAL_JUMP)  ; LAB_004080c4
    MOV dword ptr [0x01c00c7c],0x5300ec ; 00408047 | g_ScanlineRenderFunc
    PUSH EDI                            ; 00408051
        ;   Label: LAB_00408051
    PUSH EBX                            ; 00408052
    MOV EBX,0x13                        ; 00408053
    PUSH EBP                            ; 00408058
    MOV dword ptr [0x01c039a0],EBX      ; 00408059 | g_RenderStateFlags
    ...
    MOV EDI,dword ptr [0x005b763c]      ; 00408064 | g_CurrentAlphaValue
    ...
    MOV [0x01c039a4],EAX                ; 00408081 | g_VertexPreprocessMode
    ...
    MOV dword ptr [0x01c00c7c],0x530322 ; 004080c4 | g_ScanlineRenderFunc
        ;   Label: LAB_004080c4
    JMP 0x00408051                      ; 004080ce
        ;   XREF to: 00408051 (UNCONDITIONAL_JUMP)  ; LAB_00408051
    CMP dword ptr [0x005b7624],0x20     ; 004080d0 | g_BitsPerPixel
        ;   Label: LAB_004080d0
    JNZ 0x004080e8                      ; 004080d7
        ;   XREF to: 004080e8 (CONDITIONAL_JUMP)  ; LAB_004080e8
    MOV dword ptr [0x01c00c7c],0x52f031 ; 004080d9 | g_ScanlineRenderFunc
    JMP 0x00408051                      ; 004080e3
        ;   XREF to: 00408051 (UNCONDITIONAL_JUMP)  ; LAB_00408051
    MOV dword ptr [0x01c00c7c],0x52f823 ; 004080e8 | g_ScanlineRenderFunc
        ;   Label: LAB_004080e8
    JMP 0x00408051                      ; 004080f2
        ;   XREF to: 00408051 (UNCONDITIONAL_JUMP)  ; LAB_00408051
    OR byte ptr [0x01c039a0],0x20       ; 004080f7 | g_RenderStateFlags
        ;   Label: LAB_004080f7
    ...
    PUSH 0x6b029c                       ; 00408103 | DAT_006b029c
        ;   Label: LAB_00408103
    PUSH EDI                            ; 00408108
    CALL engine_clipper.c_clipAndRasterize_FUN_00432cd0 ; 00408109
