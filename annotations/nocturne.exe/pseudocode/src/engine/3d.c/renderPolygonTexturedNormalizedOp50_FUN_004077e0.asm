...
section .text
    ...
    CMP dword ptr [0x01c03948],0x0      ; 004077fa | g_MMXSupported
    JNZ 0x00407856                      ; 00407801
        ;   XREF to: 00407856 (CONDITIONAL_JUMP)  ; LAB_00407856
    CMP dword ptr [0x005b7624],0x20     ; 00407803 | g_BitsPerPixel
    JNZ 0x0040784a                      ; 0040780a
        ;   XREF to: 0040784a (CONDITIONAL_JUMP)  ; LAB_0040784a
    MOV dword ptr [0x01c00c7c],0x5300ec ; 0040780c | g_ScanlineRenderFunc
    PUSH EDI                            ; 00407816
        ;   Label: LAB_00407816
    ...
    PUSH EAX                            ; 00407825
    MOV dword ptr [0x01c039a0],EDI      ; 00407826 | g_RenderStateFlags
    MOV dword ptr [0x01c039a4],EBP      ; 0040782c | g_VertexPreprocessMode
    CALL engine_clipper.c_clipAndRasterize_FUN_00432cd0 ; 00407832
    ...
    POP EBX                             ; 00407848
    RET                                 ; 00407849
    MOV dword ptr [0x01c00c7c],0x530322 ; 0040784a | g_ScanlineRenderFunc
        ;   Label: LAB_0040784a
    JMP 0x00407816                      ; 00407854
        ;   XREF to: 00407816 (UNCONDITIONAL_JUMP)  ; LAB_00407816
    CMP dword ptr [0x005b7624],0x20     ; 00407856 | g_BitsPerPixel
        ;   Label: LAB_00407856
    JNZ 0x0040786b                      ; 0040785d
        ;   XREF to: 0040786b (CONDITIONAL_JUMP)  ; LAB_0040786b
    MOV dword ptr [0x01c00c7c],0x52f031 ; 0040785f | g_ScanlineRenderFunc
    JMP 0x00407816                      ; 00407869
        ;   XREF to: 00407816 (UNCONDITIONAL_JUMP)  ; LAB_00407816
    MOV dword ptr [0x01c00c7c],0x52f823 ; 0040786b | g_ScanlineRenderFunc
        ;   Label: LAB_0040786b
