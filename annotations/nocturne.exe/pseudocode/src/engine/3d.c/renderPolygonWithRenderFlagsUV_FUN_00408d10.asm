...
section .text
    ...
    CMP dword ptr [0x01c03948],0x0      ; 00408d30 | g_MMXSupported
    JNZ 0x00408dfe                      ; 00408d37
        ;   XREF to: 00408dfe (CONDITIONAL_JUMP)  ; LAB_00408dfe
    CMP dword ptr [0x005b7624],0x20     ; 00408d3d | g_BitsPerPixel
    JNZ 0x00408def                      ; 00408d44
        ;   XREF to: 00408def (CONDITIONAL_JUMP)  ; LAB_00408def
    MOV dword ptr [0x01c00c7c],0x5300ec ; 00408d4a | g_ScanlineRenderFunc
    MOV dword ptr [0x01c039a0],EBX      ; 00408d54 | g_RenderStateFlags
        ;   Label: LAB_00408d54
    ...
    MOV [0x01c00c74],EAX                ; 00408d73 | g_CurrentLightingValue
    ...
    MOV dword ptr [0x01c039a4],0x5      ; 00408d84 | g_VertexPreprocessMode
    ...
    CMP dword ptr [0x01c00c78],0x0      ; 00408dd0 | g_AdvancedClippingEnabled
        ;   Label: LAB_00408dd0
    ...
    PUSH EAX                            ; 00408de1
    CALL engine_clipper.c_clipAndRasterize_FUN_00432cd0 ; 00408de2
    ...
    POP EBX                             ; 00408ded
    RET                                 ; 00408dee
    MOV dword ptr [0x01c00c7c],0x530322 ; 00408def | g_ScanlineRenderFunc
        ;   Label: LAB_00408def
    JMP 0x00408d54                      ; 00408df9
        ;   XREF to: 00408d54 (UNCONDITIONAL_JUMP)  ; LAB_00408d54
    CMP dword ptr [0x005b7624],0x20     ; 00408dfe | g_BitsPerPixel
        ;   Label: LAB_00408dfe
    JNZ 0x00408e16                      ; 00408e05
        ;   XREF to: 00408e16 (CONDITIONAL_JUMP)  ; LAB_00408e16
    MOV dword ptr [0x01c00c7c],0x52f031 ; 00408e07 | g_ScanlineRenderFunc
    JMP 0x00408d54                      ; 00408e11
        ;   XREF to: 00408d54 (UNCONDITIONAL_JUMP)  ; LAB_00408d54
    MOV dword ptr [0x01c00c7c],0x52f823 ; 00408e16 | g_ScanlineRenderFunc
        ;   Label: LAB_00408e16
    ...
    MOV dword ptr [0x01c039a4],0x1      ; 00408e2a | g_VertexPreprocessMode
    JMP 0x00408d8e                      ; 00408e34
        ;   XREF to: 00408d8e (UNCONDITIONAL_JUMP)  ; LAB_00408d8e
    MOV dword ptr [0x01c039a4],EDX      ; 00408e39 | g_VertexPreprocessMode
        ;   Label: LAB_00408e39
