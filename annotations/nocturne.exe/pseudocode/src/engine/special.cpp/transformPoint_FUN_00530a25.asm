...
section .text
    ...
    TEST dword ptr [0x01c03948],0xffffffff ; 00530a25 | g_MMXSupported
        ;   Label: engine_special.cpp_transformPoint_FUN_00530a25
    ...
    SUB EAX,dword ptr [0x01c039c4]      ; 00530a41 | g_CameraOriginX
    SUB ECX,dword ptr [0x01c039c8]      ; 00530a47 | g_CameraOriginY
    SUB EDX,dword ptr [0x01c039cc]      ; 00530a4d | g_CameraOriginZ
    MOVD MM0,EAX                        ; 00530a53
    MOVD MM1,ECX                        ; 00530a56
    MOVD MM2,EDX                        ; 00530a59
    IMUL dword ptr [0x01c039e8]         ; 00530a5c | g_TransformMatrix
    MOV EBX,EAX                         ; 00530a62
    MOV ECX,EDX                         ; 00530a64
    MOVD EAX,MM1                        ; 00530a66
    IMUL dword ptr [0x01c039f4]         ; 00530a69 | g_TransformMatrix.m[1].x
    ADD EBX,EAX                         ; 00530a6f
    ADC ECX,EDX                         ; 00530a71
    MOVD EAX,MM2                        ; 00530a73
    IMUL dword ptr [0x01c03a00]         ; 00530a76 | g_TransformMatrix.m[2].x
    ADD EAX,EBX                         ; 00530a7c
    ADC EDX,ECX                         ; 00530a7e
    SHRD EAX,EDX,0x10                   ; 00530a80
    MOVD MM4,EAX                        ; 00530a84
    MOVD EAX,MM0                        ; 00530a87
    IMUL dword ptr [0x01c039ec]         ; 00530a8a | g_TransformMatrix.m[0].y
    MOV EBX,EAX                         ; 00530a90
    MOV ECX,EDX                         ; 00530a92
    MOVD EAX,MM1                        ; 00530a94
    IMUL dword ptr [0x01c039f8]         ; 00530a97 | g_TransformMatrix.m[1].y
    ADD EBX,EAX                         ; 00530a9d
    ADC ECX,EDX                         ; 00530a9f
    MOVD EAX,MM2                        ; 00530aa1
    IMUL dword ptr [0x01c03a04]         ; 00530aa4 | g_TransformMatrix.m[2].y
    ADD EAX,EBX                         ; 00530aaa
    ADC EDX,ECX                         ; 00530aac
    SHRD EAX,EDX,0x10                   ; 00530aae
    MOVD MM5,EAX                        ; 00530ab2
    MOVD EAX,MM0                        ; 00530ab5
    IMUL dword ptr [0x01c039f0]         ; 00530ab8 | g_TransformMatrix.m[0].z
    MOV EBX,EAX                         ; 00530abe
    MOV ECX,EDX                         ; 00530ac0
    MOVD EAX,MM1                        ; 00530ac2
    IMUL dword ptr [0x01c039fc]         ; 00530ac5 | g_TransformMatrix.m[1].z
    ADD EBX,EAX                         ; 00530acb
    ADC ECX,EDX                         ; 00530acd
    MOVD EAX,MM2                        ; 00530acf
    IMUL dword ptr [0x01c03a08]         ; 00530ad2 | g_TransformMatrix.m[2].z
    ...
    IMUL dword ptr [0x01c00c48]         ; 00530b45 | g_Projection
    IDIV ECX                            ; 00530b4b
    ADD EAX,dword ptr [0x01c00c50]      ; 00530b4d | g_Projection.center_x_fixed
    MOV dword ptr [EBX + 0x10],EAX      ; 00530b53
    MOVD EAX,MM5                        ; 00530b56
    IMUL dword ptr [0x01c00c4c]         ; 00530b59 | g_Projection.neg_half_height_fixed
    IDIV ECX                            ; 00530b5f
    ADD EAX,dword ptr [0x01c00c54]      ; 00530b61 | g_Projection.center_y_fixed
    ...
    SUB EAX,dword ptr [0x01c039c4]      ; 00530b85 | g_CameraOriginX
    SUB EBX,dword ptr [0x01c039c8]      ; 00530b8b | g_CameraOriginY
    SUB ECX,dword ptr [0x01c039cc]      ; 00530b91 | g_CameraOriginZ
    MOV [0x005bf4d8],EAX                ; 00530b97 | g_TempX
    MOV dword ptr [0x005bf4dc],EBX      ; 00530b9c | g_TempY
    MOV dword ptr [0x005bf4e0],ECX      ; 00530ba2 | g_TempZ
    IMUL dword ptr [0x01c039e8]         ; 00530ba8 | g_TransformMatrix
    MOV EBX,EAX                         ; 00530bae
    MOV ECX,EDX                         ; 00530bb0
    MOV EAX,[0x005bf4dc]                ; 00530bb2 | g_TempY
    IMUL dword ptr [0x01c039f4]         ; 00530bb7 | g_TransformMatrix.m[1].x
    ADD EBX,EAX                         ; 00530bbd
    ADC ECX,EDX                         ; 00530bbf
    MOV EAX,[0x005bf4e0]                ; 00530bc1 | g_TempZ
    IMUL dword ptr [0x01c03a00]         ; 00530bc6 | g_TransformMatrix.m[2].x
    ADD EAX,EBX                         ; 00530bcc
    ADC EDX,ECX                         ; 00530bce
    SHRD EAX,EDX,0x10                   ; 00530bd0
    MOV [0x005bf4e8],EAX                ; 00530bd4 | g_TempTransformedX
    MOV EAX,[0x005bf4d8]                ; 00530bd9 | g_TempX
    IMUL dword ptr [0x01c039ec]         ; 00530bde | g_TransformMatrix.m[0].y
    MOV EBX,EAX                         ; 00530be4
    MOV ECX,EDX                         ; 00530be6
    MOV EAX,[0x005bf4dc]                ; 00530be8 | g_TempY
    IMUL dword ptr [0x01c039f8]         ; 00530bed | g_TransformMatrix.m[1].y
    ADD EBX,EAX                         ; 00530bf3
    ADC ECX,EDX                         ; 00530bf5
    MOV EAX,[0x005bf4e0]                ; 00530bf7 | g_TempZ
    IMUL dword ptr [0x01c03a04]         ; 00530bfc | g_TransformMatrix.m[2].y
    ADD EAX,EBX                         ; 00530c02
    ADC EDX,ECX                         ; 00530c04
    SHRD EAX,EDX,0x10                   ; 00530c06
    MOV [0x005bf4ec],EAX                ; 00530c0a | g_TempTransformedY
    MOV EAX,[0x005bf4d8]                ; 00530c0f | g_TempX
    IMUL dword ptr [0x01c039f0]         ; 00530c14 | g_TransformMatrix.m[0].z
    MOV EBX,EAX                         ; 00530c1a
    MOV ECX,EDX                         ; 00530c1c
    MOV EAX,[0x005bf4dc]                ; 00530c1e | g_TempY
    IMUL dword ptr [0x01c039fc]         ; 00530c23 | g_TransformMatrix.m[1].z
    ADD EBX,EAX                         ; 00530c29
    ADC ECX,EDX                         ; 00530c2b
    MOV EAX,[0x005bf4e0]                ; 00530c2d | g_TempZ
    IMUL dword ptr [0x01c03a08]         ; 00530c32 | g_TransformMatrix.m[2].z
    ADD EAX,EBX                         ; 00530c38
    ADC EDX,ECX                         ; 00530c3a
    SHRD EAX,EDX,0x10                   ; 00530c3c
    MOV [0x005bf4f0],EAX                ; 00530c40 | g_TempTransformedZ
    NEG EAX                             ; 00530c45
    MOV EDX,EAX                         ; 00530c47
    XOR EAX,EAX                         ; 00530c49
    MOV EBX,dword ptr [0x005bf4e8]      ; 00530c4b | g_TempTransformedX
    MOV ECX,dword ptr [0x005bf4f0]      ; 00530c51 | g_TempTransformedZ
    ...
    MOV EBX,dword ptr [0x005bf4ec]      ; 00530c69 | g_TempTransformedY
        ;   Label: LAB_00530c69
    ...
    MOV EAX,[0x005bf4e8]                ; 00530c92 | g_TempTransformedX
    ...
    MOV EAX,[0x005bf4e8]                ; 00530cab | g_TempTransformedX
    IMUL dword ptr [0x01c00c48]         ; 00530cb0 | g_Projection
    IDIV ECX                            ; 00530cb6
    ADD EAX,dword ptr [0x01c00c50]      ; 00530cb8 | g_Projection.center_x_fixed
    MOV dword ptr [EDI + 0x10],EAX      ; 00530cbe
    MOV EAX,[0x005bf4ec]                ; 00530cc1 | g_TempTransformedY
    IMUL dword ptr [0x01c00c4c]         ; 00530cc6 | g_Projection.neg_half_height_fixed
    IDIV ECX                            ; 00530ccc
    ADD EAX,dword ptr [0x01c00c54]      ; 00530cce | g_Projection.center_y_fixed
    MOV dword ptr [EDI + 0x14],EAX      ; 00530cd4
    POP EDI                             ; 00530cd7
    POP ESI                             ; 00530cd8
    RET                                 ; 00530cd9
    MOV EDX,dword ptr [0x005bf4e8]      ; 00530cda | g_TempTransformedX
        ;   Label: LAB_00530cda
