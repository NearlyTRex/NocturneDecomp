...
;   engine_3d.c_renderPolygonAlphaBlendedPlaneMaskedOp36_FUN_00406c60 at 00406cd4
;   engine_3d.c_renderPolygonAlphaBlendedPlaneMaskedPerspOp37_FUN_00406d80 at 00406df4
;   engine_3d.c_renderPolygonAlphaTexturedNormalizedLit_FUN_00406ae0 at 00406b53
;   engine_3d.c_renderPolygonBlendedLitOp63_FUN_00408270 at 004082f7
;   engine_3d.c_renderPolygonDepthWritePass_FUN_00406f30 at 00406f9a
;   ... and 41 more
;
; Referenced Globals:
...
section .text
    ...
    PUSH ESI                            ; 00530322
        ;   Label: engine_special.cpp_renderPerspectiveCorrectScanline16_FUN_00530322
    PUSH EDI                            ; 00530323
    PUSH EBP                            ; 00530324
    ...
    MOV EBP,dword ptr [EBX*0x4 + 0x1bd4260] ; 00530338 | g_ZBufferScanlineArray
    MOV EBX,dword ptr [EBX*0x4 + 0x1bd2fa0] ; 0053033f | g_ScreenBufferArray
    ...
    CMP dword ptr [0x01c039a4],0x5      ; 0053037a | g_VertexPreprocessMode
    ...
    JNZ 0x00530510                      ; 0053046f
        ;   XREF to: 00530510 (CONDITIONAL_JUMP)  ; LAB_00530510
    TEST dword ptr [0x01c039a0],0x40    ; 00530475 | g_RenderStateFlags
        ;   Label: LAB_00530475
    ...
    TEST dword ptr [0x01c039a0],0x1     ; 0053048d | g_RenderStateFlags
        ;   Label: LAB_0053048d
    ...
    POP ESI                             ; 00530512
    RET                                 ; 00530513
    MOV EAX,[0x01c00c70]                ; 00530514 | g_ActiveRenderColor
        ;   Label: LAB_00530514
