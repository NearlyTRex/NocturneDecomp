...
section .text
    ...
    PUSH EBP                            ; 005305f7
        ;   Label: engine_special.cpp_renderAlphaRow16_FUN_005305f7
    ...
    MOVZX EAX,byte ptr [ESI]            ; 00530610
        ;   Label: LAB_00530610
    MOVD MM0,dword ptr [EAX*0x4 + 0x1c00024] ; 00530613 | g_Hardware32BitPalette
    MOVZX EAX,byte ptr [EBX]            ; 0053061b
    IMUL EAX,EBP                        ; 0053061e
    CMP dword ptr [0x01c03998],0x1      ; 00530621 | g_BlendMode
    ...
    MOVQ MM1,qword ptr [EAX*0x8 + 0x5bfe70] ; 00530646 | g_AlphaTable
    MOVQ MM2,MM1                        ; 0053064e
    PXOR MM2,qword ptr [0x005c0668]     ; 00530651 | g_AlphaTable[255].red
    MOVZX EAX,word ptr [EDI]            ; 00530658
    MOVD MM3,EAX                        ; 0053065b
    PAND MM3,qword ptr [0x005bf5c8]     ; 0053065e | g_BlueMask16
    PSLLQ MM3,qword ptr [0x005bf658]    ; 00530665 | g_BlueBitShift
    MOVD MM4,EAX                        ; 0053066c
    PAND MM4,qword ptr [0x005bf5c0]     ; 0053066f | g_GreenMask16
    PSLLQ MM4,qword ptr [0x005bf638]    ; 00530676 | g_GreenBlueDitherShift
    POR MM3,MM4                         ; 0053067d
    MOVD MM5,EAX                        ; 00530680
    PAND MM5,qword ptr [0x005bf5b8]     ; 00530683 | g_RedMask16
    PSLLQ MM5,qword ptr [0x005bf618]    ; 0053068a | g_TotalDitherShift
    POR MM3,MM5                         ; 00530691
    PUNPCKLBW MM3,MM7                   ; 00530694
    CMP dword ptr [0x01c03998],0x1      ; 00530697 | g_BlendMode
    ...
    PSRLQ MM0,qword ptr [0x005bf658]    ; 005306de | g_BlueBitShift
    PSRLQ MM2,qword ptr [0x005bf638]    ; 005306e5 | g_GreenBlueDitherShift
    PSRLQ MM4,qword ptr [0x005bf618]    ; 005306ec | g_TotalDitherShift
