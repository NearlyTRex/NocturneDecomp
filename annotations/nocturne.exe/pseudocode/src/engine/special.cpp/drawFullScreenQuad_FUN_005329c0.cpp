...
// Convention: __cdecl
// Signature: undefined4 __cdecl engine_special_cpp_drawFullScreenQuad_FUN_005329c0(undefined4 param_1)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint __cdecl engine_special_cpp_drawFullScreenQuad_FUN_005329c0(uint param_1)

{
  ...
  iStack_20 = iStack_b0;
  iStack_1c = iStack_4c;
  engine_special_cpp_drawPolygon_FUN_00532620(auStack_c0,4,0x10);
  return 1;
}
