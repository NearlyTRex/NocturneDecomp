...
section .text
    ...
    PUSH ESI                            ; 0052eed4
        ;   Label: engine_special.cpp_clearZBufferNative_FUN_0052eed4
    PUSH EDI                            ; 0052eed5
    PUSHAD                              ; 0052eed6
    CLD                                 ; 0052eed7
    PUSH DS                             ; 0052eed8
    ...
    FLD double ptr [0x005bf48c]         ; 0052ef08 | g_BufferFillZeroQword
    ...
    FSTP double ptr [0x005bf494]        ; 0052ef2d | g_BufferFillFpuPopST0
    POPAD                               ; 0052ef33
    POP EDI                             ; 0052ef34
    POP ESI                             ; 0052ef35
    RET                                 ; 0052ef36
