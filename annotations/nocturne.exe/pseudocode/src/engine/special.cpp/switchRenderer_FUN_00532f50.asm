...
;
; XREF[1]:
;   engine_special.cpp_switchRenderer_FUN_00532f30 at 00532f3f
;
; Referenced Globals:
;   char[256] g_RendererDllPath
;   undefined4 g_RendererDllPath+1
;   undefined4 g_RendererDllPath+2
...
section .text
    ...
    PUSH ESI                            ; 00532f50
        ;   Label: engine_special.cpp_switchRenderer_FUN_00532f50
    PUSH EDI                            ; 00532f51
    ...
    MOV EDI,0x5c0e80                    ; 00532f5f | g_RendererDllPath
    MOV [0x02dc9d64],EAX                ; 00532f64 | g_RendererCardIndex
    PUSH EDI                            ; 00532f69 | g_RendererDllPath
    MOV AL,byte ptr [ESI]               ; 00532f6a
        ;   Label: LAB_00532f6a
    MOV byte ptr [EDI],AL               ; 00532f6c | g_RendererDllPath | g_RendererDllPath+2
    CMP AL,0x0                          ; 00532f6e
    JZ 0x00532f82                       ; 00532f70
        ;   XREF to: 00532f82 (CONDITIONAL_JUMP)  ; LAB_00532f82
    MOV AL,byte ptr [ESI + 0x1]         ; 00532f72
    ADD ESI,0x2                         ; 00532f75
    MOV byte ptr [EDI + 0x1],AL         ; 00532f78 | g_RendererDllPath+1 | s_d3d_dll_005c0e83
