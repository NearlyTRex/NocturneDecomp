// Name: engine_special.cpp_FUN_005300ec
// Address: 005300ec
// Address Range: [[005300ec, 00530321]]
// Convention: unknown
// Signature: int * engine_special_cpp_FUN_005300ec(void)
...

{
  ...
  if (iVar5 != 0 && piVar3 <= (int *)(uVar6 >> 0x10)) {
    DAT_005bf078 = *(int *)(&DAT_01bd2fa0 + unaff_EBX * 4) + (int)piVar3 * 4;
      ...
      while( true ) {
        if (((_DAT_01c039a0 & 0x40) == 0) ||
          ...
          if ((_DAT_01c039a0 & 1) != 0) {
            piVar3 = *(int **)(&DAT_01c00024 +
                              (uint)*(byte *)((uVar7 >> (DAT_005bf550 & 0x1f) & _DAT_005bf590) +
                                              _DAT_01c02580 +
                                             (uVar6 >> (DAT_005bf570 & 0x1f) & _DAT_005bf5b0)) * 4);
          }
          *(int **)(DAT_005bf078 + uVar9) = piVar3;
