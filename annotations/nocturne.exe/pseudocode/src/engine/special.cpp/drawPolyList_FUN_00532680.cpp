...
// Convention: __cdecl
// Signature: undefined4 __cdecl engine_special_cpp_drawPolyList_FUN_00532680(int param_1,int *param_2,int param_3,undefined4 param_4)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint __cdecl engine_special_cpp_drawPolyList_FUN_00532680(int param_1,int *param_2,int param_3,uint param_4)
