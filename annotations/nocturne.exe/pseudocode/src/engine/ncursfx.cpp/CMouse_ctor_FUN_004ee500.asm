...
section .text
    ...
    PUSH 0x59df00                       ; 004ee504 | g_CAlphaBitmapTypeInfo_0059df00
    PUSH 0x8                            ; 004ee509
    PUSH EAX                            ; 004ee50b
    CALL crt_memory.c___arrinit_FUN_005644a7 ; 004ee50c
        ;   XREF to: 005644a7 (UNCONDITIONAL_CALL)  ; void * crt_memory.c___arrinit_FUN_005644a7(void * array_start, int element_count, WatcomTypeInfo * type_info)
    ADD ESP,0xc                         ; 004ee511
    PUSH 0x59df00                       ; 004ee514 | g_CAlphaBitmapTypeInfo_0059df00
    PUSH 0x7                            ; 004ee519
    ...
    PUSH 0x59df00                       ; 004ee529 | g_CAlphaBitmapTypeInfo_0059df00
    PUSH 0xf                            ; 004ee52e
