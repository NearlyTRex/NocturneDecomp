...

{
  ...
  pCVar1 = engine_ncursfx_cpp_CAlphaBitmap_arrdtor15_FUN_004ee8d0(this_ptr->skulls,0);
  pCVar1 = engine_ncursfx_cpp_CAlphaBitmap_arrdtor7_FUN_004ee8b0(pCVar1 + -7,0);
  pCVar2 = (CMouse *)core_menu_cpp_CAlphaBitmap_arrdtor8_FUN_004d4370(pCVar1 + -8,0);
  return pCVar2;
}
