...
section .text
    ...
    CALL engine_ncursfx.cpp_CAlphaBitmap_arrdtor2_FUN_004ee8d0 ; 004ee56c
        ;   XREF to: 004ee8d0 (UNCONDITIONAL_CALL)  ; CAlphaBitmap * engine_ncursfx.cpp_CAlphaBitmap_arrdtor2_FUN_004ee8d0(CAlphaBitmap * objs, uint flags)
    ADD ESP,0x8                         ; 004ee571
    PUSH 0x0                            ; 004ee574
    SUB EAX,0x8c                        ; 004ee576
    PUSH EAX                            ; 004ee57b
    CALL engine_ncursfx.cpp_CAlphaBitmap_arrdtor1_FUN_004ee8b0 ; 004ee57c
        ;   XREF to: 004ee8b0 (UNCONDITIONAL_CALL)  ; CAlphaBitmap * engine_ncursfx.cpp_CAlphaBitmap_arrdtor1_FUN_004ee8b0(CAlphaBitmap * objs, uint flags)
    ADD ESP,0x8                         ; 004ee581
    PUSH 0x0                            ; 004ee584
    SUB EAX,0xa0                        ; 004ee586
    PUSH EAX                            ; 004ee58b
    CALL core_menu.cpp_CAlphaBitmap_arrdtor_FUN_004d4370 ; 004ee58c
        ;   XREF to: 004d4370 (UNCONDITIONAL_CALL)  ; CAlphaBitmap * core_menu.cpp_CAlphaBitmap_arrdtor_FUN_004d4370(CAlphaBitmap * objs, uint flags)
