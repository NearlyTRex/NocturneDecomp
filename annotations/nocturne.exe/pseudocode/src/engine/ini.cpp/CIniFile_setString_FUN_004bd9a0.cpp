...

{
  if (this_ptr->filename[0] == '\0') {
    ...
    g_CurrentLineNumber = 619;
    core_main_c_displayErrorAndQuit_FUN_004c8440("CIniFile::setString - filename not write!");
  }
  if (this_ptr->section[0] == '\0') {
    g_CurrentFilename = "..\\engine\\ini.cpp";
    g_CurrentLineNumber = 620;
    core_main_c_displayErrorAndQuit_FUN_004c8440("CIniFile::setString - section not write!");
  }
