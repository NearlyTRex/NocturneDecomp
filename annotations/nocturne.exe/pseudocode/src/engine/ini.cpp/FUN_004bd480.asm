...
section .text
    ...
    CALL FUN_004bd2b0                   ; 004bd4bb
        ;   XREF to: 004bd2b0 (UNCONDITIONAL_CALL)  ; undefined FUN_004bd2b0()
    ...
    PUSH EAX                            ; 004bd670
    CALL FUN_00566f00                   ; 004bd671
        ;   XREF to: 00566f00 (UNCONDITIONAL_CALL)  ; undefined FUN_00566f00()
