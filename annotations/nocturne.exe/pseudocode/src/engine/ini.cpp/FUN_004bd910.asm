...
;
; XREF[4]:
;   FUN_004bda20 at 004bda4f
;   FUN_004bdac0 at 004bdaf3
;   FUN_004bdb80 at 004bdc5b
;   FUN_005289f0 at 00528a29
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 004bd93b
    CALL FUN_004bd750                   ; 004bd93c
        ;   XREF to: 004bd750 (UNCONDITIONAL_CALL)  ; undefined FUN_004bd750()
    ...
    MOV dword ptr [0x01cc4800],EDX      ; 004bd956 | DAT_01cc4800
    MOV dword ptr [0x01cc4804],ECX      ; 004bd95c | DAT_01cc4804
    CALL FUN_004c8440                   ; 004bd962
    ...
    MOV dword ptr [0x01cc4800],ESI      ; 004bd97d | DAT_01cc4800
    MOV dword ptr [0x01cc4804],EDI      ; 004bd983 | DAT_01cc4804
    CALL FUN_004c8440                   ; 004bd989
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; undefined FUN_004c8440()
