...
section .text
    ...
    MOV dword ptr [0x01cc4800],ECX      ; 004bd173 | DAT_01cc4800
    MOV dword ptr [0x01cc4804],ESI      ; 004bd179 | DAT_01cc4804
    CALL FUN_004c8440                   ; 004bd17f
