// Name: engine_pod.cpp_CPodFile_FUN_004f7ae0
// Address: 004f7ae0
// Address Range: [[004f7ae0, 004f80d1]]
// Convention: __cdecl
// Signature: int __cdecl engine_pod_cpp_CPodFile_FUN_004f7ae0(CPodFile *this_ptr,char *filename)
...

{
  ...
  bVar16 = 0;
  engine_pod_cpp_CPodFile_cleanup_FUN_004f80e0(this_ptr);
  pcVar12 = this_ptr->filename;
  pcVar2 = _fullpath(pcVar12,filename,0x100);
  if (pcVar2 == (char *)0x0) {
    do {
      cVar1 = *filename;
      *pcVar12 = cVar1;
  ...
  uVar3 = engine_dosio_cpp_getFileTimestamp_FUN_00456910((char *)0x0,this_ptr->filename);
  this_ptr->timestamp = uVar3;
  ...
  if (file != (_FILE *)0x0) {
    ...
    if ((((local_110 == 'P') && (local_10f == 'O')) && (local_10e == 'D')) && (local_10d == '2')) {
      pcVar12 = local_108;
      pcVar2 = this_ptr->description;
      this_ptr->pod_format_version = 2;
      do {
        cVar1 = *pcVar12;
        *pcVar2 = cVar1;
        if (cVar1 == '\0') break;
      ...
      this_ptr->file_count = local_b8;
      this_ptr->audit_count = local_b4;
      pCVar4 = (CPodDirectoryEntry *)malloc(this_ptr->file_count * 0x14);
      this_ptr->directory_entries = pCVar4;
      if (pCVar4 != (CPodDirectoryEntry *)0x0) {
        _fread(pCVar4,this_ptr->file_count,0x14,file);
        new_size = (this_ptr->directory_entries->offset - 0x60) + this_ptr->file_count * -0x14;
        if ((this_ptr->file_count <= (int)new_size) &&
           ((int)new_size <= this_ptr->file_count * 0x100)) {
          pcVar2 = (char *)malloc(new_size);
          this_ptr->file_data_buffer = pcVar2;
          if (pcVar2 == (char *)0x0) {
            g_CurrentFilename = "..\\engine\\pod.cpp";
            g_CurrentLineNumber = 254;
            core_main_c_displayErrorAndQuit_FUN_004c8440("Out of memory!");
          }
          _fread(this_ptr->file_data_buffer,new_size,1,local_1c);
          iVar7 = this_ptr->file_count + -1;
          this_ptr->total_file_size =
               this_ptr->directory_entries[iVar7].offset + this_ptr->directory_entries[iVar7].size;
          goto LAB_004f7d60;
        }
      }
    }
      ...
      if (pCVar4 != (CPodDirectoryEntry *)0x0) {
        ...
        if (0 < this_ptr->file_count) {
          ...
          do {
            ...
            *(ulong *)((int)&this_ptr->directory_entries->name + iVar7) = new_size;
            uVar3 = 0xffffffff;
            pcVar2 = local_5c;
            do {
              if (uVar3 == 0) break;
            ...
            pcVar2 = (char *)realloc(this_ptr->file_data_buffer,new_size);
            this_ptr->file_data_buffer = pcVar2;
            if (pcVar2 == (char *)0x0) {
              g_CurrentFilename = "..\\engine\\pod.cpp";
            ...
            pcVar12 = this_ptr->file_data_buffer +
                      *(int *)((int)&this_ptr->directory_entries->name + iVar7);
            pcVar2 = local_5c;
            do {
              cVar1 = *pcVar2;
              *pcVar12 = cVar1;
            ...
            *(uint *)((int)&this_ptr->directory_entries->size + iVar7) = local_3c;
            *(uint *)((int)&this_ptr->directory_entries->offset + iVar7) = local_38;
            *(uint *)((int)&this_ptr->directory_entries->checksum + iVar7) = 0;
            local_18 = local_18 + 1;
            *(uint *)((int)&this_ptr->directory_entries->timestamp + iVar7) = this_ptr->timestamp;
            iVar7 = iVar7 + 0x14;
          } while (local_18 < this_ptr->file_count);
        }
...
LAB_004f7d60:
        ...
        if (0 < this_ptr->file_count) {
          iVar8 = 0;
          do {
            piVar5 = (int *)((int)&this_ptr->directory_entries->name + iVar8);
            if ((*piVar5 < 0) || ((int)new_size <= *piVar5)) goto LAB_004f7b75;
            *piVar5 = (int)(this_ptr->file_data_buffer + *piVar5);
            iVar7 = iVar7 + 1;
            iVar8 = iVar8 + 0x14;
          } while (iVar7 < this_ptr->file_count);
        }
        local_20 = this_ptr->file_count;
        while (local_20 = local_20 + -1, 0 < local_20) {
          if (0 < local_20) {
            ...
            do {
              iVar6 = _stricmp
                                (*(char **)((int)&this_ptr->directory_entries->name + iVar7),
                                 *(char **)((int)&this_ptr->directory_entries->name + iVar8));
              if (0 < iVar6) {
                pCVar4 = this_ptr->directory_entries;
                ...
                *puVar14 = *puVar11;
                ...
                puVar11 = (uint *)((int)&this_ptr->directory_entries->name + iVar8);
