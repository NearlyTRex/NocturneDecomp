...
;                               FUNCTION
; *****************************************************************************
; undefined4 engine_pod_cpp_FUN_004f78d0(undefined4 param_1,uint param_2)
;
; Local Variables:
...
section .text
    ...
    PUSH EBX                            ; 004f78d0
        ;   Label: engine_pod.cpp_FUN_004f78d0
    PUSH ESI                            ; 004f78d1
    PUSH EDI                            ; 004f78d2
    PUSH EBP                            ; 004f78d3
    ...
    INC ESI                             ; 004f7910
    INC EBX                             ; 004f7911
    CALL engine_pod.cpp_FUN_004f77d0    ; 004f7912
    ...
    INC EBX                             ; 004f7960
    INC ESI                             ; 004f7961
    CALL engine_pod.cpp_FUN_004f77d0    ; 004f7962
        ;   XREF to: 004f77d0 (UNCONDITIONAL_CALL)  ; undefined engine_pod.cpp_FUN_004f77d0()
