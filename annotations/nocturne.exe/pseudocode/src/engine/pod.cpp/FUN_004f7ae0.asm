...
section .text
    ...
    PUSH EBX                            ; 004f7b42
    PUSH 0x0                            ; 004f7b43
    CALL FUN_00456910                   ; 004f7b45
        ;   XREF to: 00456910 (UNCONDITIONAL_CALL)  ; undefined FUN_00456910()
