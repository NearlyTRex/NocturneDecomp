...
;
; XREF[4]:
;   engine_pod.cpp_CPod_computeAndStoreCRC_FUN_004f8eb0 at 004f8eee
...
section .text
    ...
    PUSH EBX                            ; 004f7ae0
        ;   Label: engine_pod.cpp_CPodFile_FUN_004f7ae0
    PUSH ESI                            ; 004f7ae1
    PUSH EDI                            ; 004f7ae2
    PUSH EBP                            ; 004f7ae3
    ...
    MOV dword ptr [0x01cc4800],ECX      ; 004f7ceb | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EBX      ; 004f7cf1 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004f7cf7
    ...
    MOV dword ptr [0x01cc4800],ECX      ; 004f7fdc | g_CurrentFilename
    MOV dword ptr [0x01cc4804],ESI      ; 004f7fe2 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004f7fe8
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
