...
// Convention: unknown
// Signature: int engine_pod_cpp_findFilesByExtension_FUN_004f8b90(int *param_1,char *param_2,int param_3,int param_4,int param_5)
  ...
  if (0 < *param_1) {
    ...
    do {
      ...
      for (iStack_18 = 0; iVar3 = *(int *)((int)param_1 + iStack_2c + 4),
        ...
        iVar3 = _strcmp(acStack_50,auStack_44);
        if (iVar3 == 0) {
          iVar3 = 0;
          piVar8 = param_1;
          if (0 < iStack_38) {
            do {
              iVar4 = engine_pod_cpp_CPodFile_findFileIndex_FUN_004f8150(piVar8[1],pcVar9);
              if (-1 < iVar4) break;
              iVar3 = iVar3 + 1;
              piVar8 = piVar8 + 1;
          ...
          iVar4 = iStack_1c;
          if (iVar3 == iStack_38) {
            _strncpy(iStack_1c,pcVar9,iStack_30);
