...
;                               FUNCTION
; *****************************************************************************
; undefined4 engine_pod_cpp_FUN_004f9100(void)
;
; Local Variables:
...
section .text
    ...
    PUSH EBX                            ; 004f9100
        ;   Label: engine_pod.cpp_FUN_004f9100
    ...
    PUSH EAX                            ; 004f912d
    CALL engine_pod.cpp_FUN_004f8240    ; 004f912e
        ;   XREF to: 004f8240 (UNCONDITIONAL_CALL)  ; undefined engine_pod.cpp_FUN_004f8240()
