...
// Convention: unknown
// Signature: int engine_pod_cpp_CPod_locateFile_FUN_004f9170(int *param_1,char *param_2,char *param_3,int *param_4)
...

{
  ...
  if (0 < *param_1) {
    do {
      iVar1 = engine_pod_cpp_CPodFile_findFileIndex_FUN_004f8150((CPodFile *)piVar3[1],local_224);
      if (-1 < iVar1) {
        if (param_4 != (int *)0x0) {
          *param_4 = iVar1;
        }
