...
section .text
    ...
    PUSH EBX                            ; 004f7980
        ;   Label: engine_pod.cpp_crc32ComputeFileRange_FUN_004f7980
    PUSH ESI                            ; 004f7981
    PUSH EDI                            ; 004f7982
    PUSH EBP                            ; 004f7983
    ...
    INC EBX                             ; 004f79f4
    INC ESI                             ; 004f79f5
    CALL engine_pod.cpp_crc32UpdateByte_FUN_004f77d0 ; 004f79f6
    ...
    PUSH EBP                            ; 004f7a3d
    INC EBX                             ; 004f7a3e
    CALL engine_pod.cpp_crc32UpdateByte_FUN_004f77d0 ; 004f7a3f
        ;   XREF to: 004f77d0 (UNCONDITIONAL_CALL)  ; uint engine_pod.cpp_crc32UpdateByte_FUN_004f77d0(uint current_crc, uchar data_byte)
