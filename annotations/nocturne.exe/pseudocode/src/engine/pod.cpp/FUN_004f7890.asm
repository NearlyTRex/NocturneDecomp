...
;                               FUNCTION
; *****************************************************************************
; undefined4 engine_pod_cpp_FUN_004f7890(undefined1 *param_1,uint param_2,undefined4 param_3)
;
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 004f7890
        ;   Label: engine_pod.cpp_FUN_004f7890
    PUSH ESI                            ; 004f7891
    PUSH EDI                            ; 004f7892
    ...
    INC ESI                             ; 004f78ab
    INC EBX                             ; 004f78ac
    CALL engine_pod.cpp_FUN_004f77d0    ; 004f78ad
