...
;
; XREF[1]:
;   engine_pcx.c_saveScreenshotGeneral_FUN_004f2990 at 004f2b3a
;
; Referenced Globals:
...
section .text
    ...
    MOV dword ptr [0x01cc4800],EBX      ; 004f26b3 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],ESI      ; 004f26b9 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004f26bf
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
    ADD ESP,0x4                         ; 004f26c4
    XOR EBP,EBP                         ; 004f26c7
        ;   Label: LAB_004f26c7
    MOV EAX,[0x005b7620]                ; 004f26c9 | g_WindowHeight
    ...
    MOV ESI,dword ptr [ESP + 0x58]      ; 004f26de
        ;   Label: LAB_004f26de
    MOV EBP,dword ptr [0x005b761c]      ; 004f26e2 | g_WindowWidth
    XOR EBX,EBX                         ; 004f26e8
    MOV ESI,dword ptr [ESI + 0x1bd2fa0] ; 004f26ea | g_ScreenBufferArray | g_ScreenBufferArray[1]
    ...
    MOV CL,byte ptr [0x01c00624]        ; 004f26fd | g_RedBitPosition
    MOV EDX,EAX                         ; 004f2703
    SHR EDX,CL                          ; 004f2705
    IMUL EDX,dword ptr [0x01c00628]     ; 004f2707 | g_RedScaleFactor
    AND EDX,0xff                        ; 004f270e
    MOV CL,byte ptr [0x01c00630]        ; 004f2714 | g_GreenBitPosition
    MOV dword ptr [ESP + 0x50],EDX      ; 004f271a
    MOV EDX,EAX                         ; 004f271e
    MOV EBP,dword ptr [0x01c00634]      ; 004f2720 | g_GreenScaleFactor
    SHR EDX,CL                          ; 004f2726
    IMUL EDX,EBP                        ; 004f2728
    MOV CL,byte ptr [0x01c0063c]        ; 004f272b | g_BlueBitPosition
    AND EDX,0xff                        ; 004f2731
    MOV EBP,EAX                         ; 004f2737
    MOV dword ptr [ESP + 0x54],EDX      ; 004f2739
    SHR EBP,CL                          ; 004f273d
    IMUL EBP,dword ptr [0x01c00640]     ; 004f273f | g_BlueScaleFactor
    PUSH EDI                            ; 004f2746
    ...
    CALL crt_stdio.c_fputc_FUN_00566cc0 ; 004f276e
        ;   XREF to: 00566cc0 (UNCONDITIONAL_CALL)  ; int crt_stdio.c_fputc_FUN_00566cc0(int character, _FILE * file)
    MOV EDX,dword ptr [0x005b761c]      ; 004f2773 | g_WindowWidth
    ...
    MOV EBX,dword ptr [0x005b7620]      ; 004f278c | g_WindowHeight
    ...
    MOV dword ptr [0x01cc4800],EDX      ; 004f27c6 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],ECX      ; 004f27cc | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004f27d2
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
