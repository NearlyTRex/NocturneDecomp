...
// Convention: unknown
// Signature: void FUN_004f27e0(char *param_1)
...
LAB_004f2823:
  ...
  iVar2 = FUN_0056568c(local_6c,&DAT_0058cf88);
  if (iVar2 == 0) {
    _DAT_01cc4800 = "..\\engine\\pcx.c";
    _DAT_01cc4804 = 0x9f;
    ...
    do {
      ...
      if (0 < DAT_005b761c) {
        do {
          ...
          FUN_00566cc0(_DAT_01c00628 * (*puVar3 >> (DAT_01c00624 & 0x1f)) & 0xff,iVar2);
          FUN_00566cc0(uVar4 & 0xff,iVar2);
          puVar3 = puVar3 + 1;
          iVar6 = iVar6 + 1;
          FUN_00566cc0(local_1c,iVar2);
