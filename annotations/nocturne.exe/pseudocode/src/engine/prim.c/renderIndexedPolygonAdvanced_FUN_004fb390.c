...
// Convention: __cdecl
// Signature: void __cdecl engine_prim_c_renderIndexedPolygonAdvanced_FUN_004fb390(int *param_1,int param_2)
      ...
      if (0 < iVar6) {
        do {
          ...
          iVar2 = engine_prim_c_calculateTriangleWindingOrder_FUN_004f9a10
                            (&DAT_005c5014 + *piVar3 * 0xc,&DAT_005c5014 + piVar3[1] * 0xc);
          if (iVar2 == 0) {
            iVar11 = iVar11 + 1;
          }
          iVar8 = iVar8 + 1;
  ...
  if ((_DAT_01c02594 == 0) || (DAT_006b0278 != 0)) {
    ...
    case 1:
      ...
      if (0 < param_2) {
        do {
          ...
          iVar6 = iVar6 + 1;
          engine_prim_c_prepareDepthBuffer_FUN_004f9870(&DAT_005c5014 + *piVar3 * 0xc);
          piVar3 = piVar3 + 1;
        } while (iVar6 < param_2);
      }
      break;
    case 2:
      ...
      if (0 < param_2) {
        do {
          apuStack_6c[0] = (uint *)0x1;
          engine_prim_c_normalizeTextureCoords_FUN_004f98e0(&DAT_005c5014 + *piVar3 * 0xc);
          iVar6 = iVar6 + 1;
          piVar3 = piVar3 + 1;
        } while (iVar6 < param_2);
      }
    ...
    case 3:
      ...
      if (0 < param_2) {
        do {
          apuStack_6c[0] = (uint *)0x1;
          iVar6 = iVar6 + 1;
          engine_prim_c_adjustNearPlaneTextureCoords_FUN_004f9960(&DAT_005c5014 + *piVar3 * 0xc);
          piVar3 = piVar3 + 1;
        } while (iVar6 < param_2);
      }
      break;
    ...
    case 6:
      ...
      if (0 < param_2) {
        do {
          apuStack_6c[0] = (uint *)0x1;
          iVar6 = iVar6 + 1;
          engine_prim_c_replaceWWithDepth_FUN_004f99d0(&DAT_005c5014 + *piVar3 * 0xc);
          piVar3 = piVar3 + 1;
        } while (iVar6 < param_2);
      }
    }
