// Name: engine_prim.c_renderPolygonSoftware_FUN_004f9dd0
// Address: 004f9dd0
// Address Range: [[004f9dd0, 004fa2dc]]
// Convention: __cdecl
// Signature: void __cdecl engine_prim_c_renderPolygonSoftware_FUN_004f9dd0(SRenderVertex *vertices,int vertex_count)
...

{
  ...
  if (DAT_006b0280 != 0) {
    ...
    pSVar4 = vertices + 2;
    if (vertex_count < 4) {
      iVar8 = engine_prim_c_calculateTriangleWindingOrder_FUN_004f9a10(vertices,pSVar11,pSVar4);
      if (iVar8 == 0) {
        return;
      }
    }
      ...
      if (0 < iVar8) {
        do {
          iVar3 = engine_prim_c_calculateTriangleWindingOrder_FUN_004f9a10(vertices,pSVar11,pSVar4);
          if (iVar3 == 0) {
            iVar7 = iVar7 + 1;
          }
          pSVar11 = pSVar11 + 1;
