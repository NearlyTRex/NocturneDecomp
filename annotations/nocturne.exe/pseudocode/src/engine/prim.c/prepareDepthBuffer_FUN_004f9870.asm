...
;   engine_prim.c_renderPolygonSoftware_FUN_004f9dd0 at 004f9fc4
;   engine_prim.c_renderScanlinePolygon_FUN_004fad00 at 004faff3
;   engine_zraster.c_rasterizePolygonCustom_FUN_00562de0 at 0056306b
;   engine_zraster.c_rasterizeTriangle_FUN_005628c0 at 00562bd0
;
; Referenced Globals:
;   int g_ProcessorType
;
