...
;   core_flies.cpp_CFlies_renderOpaque_FUN_0048f490 at 0048f76b
...
section .text
    ...
    MOV CL,byte ptr [0x01c0063c]        ; 00460f2a | g_BlueBitPosition
    MOV ESI,EBX                         ; 00460f30
    SHL EDX,CL                          ; 00460f32
    MOV CL,byte ptr [0x01c00630]        ; 00460f34 | g_GreenBitPosition
    MOV EAX,dword ptr [ESP + 0x10]      ; 00460f3a
    SHL ESI,CL                          ; 00460f3e
    MOV CL,byte ptr [0x01c00624]        ; 00460f40 | g_RedBitPosition
    ...
    OR ECX,EBX                          ; 00460f5a
    OR EAX,ECX                          ; 00460f5c
    CMP dword ptr [0x01c02594],0x0      ; 00460f5e | g_UseExternalRenderer
    JNZ 0x00460f86                      ; 00460f65
        ;   XREF to: 00460f86 (CONDITIONAL_JUMP)  ; LAB_00460f86
    CMP dword ptr [0x005b7624],0x20     ; 00460f67 | g_BitsPerPixel
    ...
    OR ECX,EDX                          ; 00460f7b
    MOV dword ptr [0x01c00c70],ECX      ; 00460f7d | g_ActiveRenderColor
    POP ESI                             ; 00460f83
    POP EBX                             ; 00460f84
    RET                                 ; 00460f85
    CMP dword ptr [0x005b7624],0x20     ; 00460f86 | g_BitsPerPixel
        ;   Label: LAB_00460f86
    ...
    MOV ECX,EAX                         ; 00460f91
        ;   Label: LAB_00460f91
    MOV dword ptr [0x01c00c70],ECX      ; 00460f93 | g_ActiveRenderColor
    POP ESI                             ; 00460f99
    POP EBX                             ; 00460f9a
    RET                                 ; 00460f9b
