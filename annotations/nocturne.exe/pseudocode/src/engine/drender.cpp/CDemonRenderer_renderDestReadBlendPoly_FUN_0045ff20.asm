...
;   core_set.cpp_CDemonSet_renderEnvMapTriangles_FUN_0050d910 at 0050dd4b
;
; Referenced Globals:
...
section .text
    ...
    MOV dword ptr [0x01c039a0],ESI      ; 0045ff9f | g_RenderStateFlags
    MOV dword ptr [0x01c039a4],EDI      ; 0045ffa5 | g_VertexPreprocessMode
    MOV dword ptr [0x01c00c7c],ECX      ; 0045ffab | g_ScanlineRenderFunc
    ...
    CMP dword ptr [0x005b7624],0x20     ; 0045fff7 | g_BitsPerPixel
        ;   Label: LAB_0045fff7
    JNZ 0x00460069                      ; 0045fffe
        ;   XREF to: 00460069 (CONDITIONAL_JUMP)  ; LAB_00460069
    MOV dword ptr [0x01c00c7c],0x52f031 ; 00460000 | g_ScanlineRenderFunc
    MOV EBP,0x6                         ; 0046000a
        ;   Label: LAB_0046000a
    MOV EDI,0x2e7                       ; 0046000f
    MOV EAX,dword ptr [EBX + 0x20]      ; 00460014
    MOV dword ptr [0x01c039a4],EBP      ; 00460017 | g_VertexPreprocessMode
    MOV dword ptr [0x01c039a0],EDI      ; 0046001d | g_RenderStateFlags
    ...
    MOV dword ptr [0x01c00c7c],0x52f823 ; 00460069 | g_ScanlineRenderFunc
        ;   Label: LAB_00460069
