...
// Convention: unknown
// Signature: void FUN_004614b0(int *param_1,int param_2,int param_3,int param_4,undefined4 param_5)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_004614b0(int *param_1,int param_2,int param_3,int param_4,uint param_5)

{
  ...
  if (((param_1[4] == 0) && (param_1[3] == 0)) && (DAT_006b0280 != 0)) {
    if (param_1[1] == 0) {
      ...
      if (_DAT_01c02594 == 0) {
        for (; 0 < param_3; param_3 = param_3 + -1) {
          ...
          FUN_00457a00(&local_28,*(uint *)(param_2 + 4));
        ...
        if (0 < iVar3) {
          FUN_00532680(*param_1,&DAT_005ae70c,iVar3,_DAT_01c039a0);
          return;
        }
      }
    }
    ...
    if (0 < param_3) {
      do {
        FUN_0045f460(param_1,param_2,param_5);
        iVar3 = iVar3 + 1;
        param_2 = param_2 + param_4;
      } while (iVar3 < param_3);
    }
