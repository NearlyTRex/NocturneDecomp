...
// Convention: __cdecl
// Signature: void __cdecl engine_drender_cpp_CDemonRenderer_renderQuadBatch_FUN_00461440(int param_1,int param_2,int param_3,int param_4)
...

{
  ...
  if (*(int *)(param_1 + 0x1c) == 0) {
    engine_drender_cpp_CDemonRenderer_renderFacetList_FUN_004614b0
              (param_1,param_2,param_3,0x48,param_4);
    return;
  }
  iVar1 = 0;
  if (0 < param_3) {
    do {
      iVar1 = iVar1 + 1;
      engine_drender_cpp_CDemonRenderer_processQuadPrimitive_FUN_00461ad0(param_1,param_2,param_4);
