...
section .text
    ...
    MOV dword ptr [0x01c00c7c],0x52f031 ; 004617c4 | DAT_01c00c7c | LAB_0052f031
    ...
    MOV ECX,0x463a79                    ; 004618f6 | LAB_00463a79
        ;   Label: LAB_004618f6
    ...
    POP EBX                             ; 0046194c
    RET                                 ; 0046194d
    MOV dword ptr [0x01c00c7c],0x52f823 ; 0046194e | DAT_01c00c7c | LAB_0052f823
        ;   Label: LAB_0046194e
