...
;   core_dlight.cpp_CDemonLight_renderCoronaGeometry_FUN_0044f0b0 at 0044f364
;   core_dlight.cpp_CDemonLight_renderExternalVolumetricShafts_FUN_00451350 at 004519e9
;   core_set.cpp_CDemonSet_renderPrimitiveBatch_FUN_0050ddd0 at 0050de6b
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBP                            ; 00460ed1
    MOV dword ptr [0x01c039a0],ESI      ; 00460ed2 | g_RenderStateFlags
    MOV dword ptr [0x01c039a4],EDI      ; 00460ed8 | g_VertexPreprocessMode
