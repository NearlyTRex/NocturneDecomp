// Name: engine_drender.cpp_FUN_0045f270
// Address: 0045f270
// Address Range: [[0045f270, 0045f3b5]]
// Convention: unknown
// Signature: int engine_drender_cpp_FUN_0045f270(int *param_1,int param_2)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

int engine_drender_cpp_FUN_0045f270(int *param_1,int param_2)

{
  ...
  if (((local_14 & 0x80000000) == 0) || ((local_14 & 0x1f) == 0)) {
    ...
    if (param_1[1] == 0) {
      _DAT_01c039a0 = 0xc1;
      _DAT_01c039a4 = 3;
      _DAT_01c00c7c = core_dstrender_cpp_FUN_00464200;
    }
    else {
      _DAT_01c039a0 = 0;
      _DAT_01c039a4 = 0;
