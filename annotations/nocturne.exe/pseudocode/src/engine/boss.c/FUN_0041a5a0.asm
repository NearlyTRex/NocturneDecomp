...
section .text
    ...
    MOV dword ptr [0x01cc4800],EDX      ; 0041a5bc | DAT_01cc4800
    MOV dword ptr [0x01cc4804],ECX      ; 0041a5c2 | DAT_01cc4804
    CALL FUN_004c8440                   ; 0041a5c8
