...
;
; XREF[1]:
;   engine_model.c_FUN_004dd690 at 004dd6ea
;
; Referenced Globals:
...
section .text
    ...
    MOV EDX,0x579622                    ; 0041a5e0 | = "..\\engine\\boss.c"
        ;   Label: engine_boss.c_FUN_0041a5e0
    MOV ECX,0x49                        ; 0041a5e5
    PUSH 0x579633                       ; 0041a5ea | = "modelStruct not supported"
    MOV dword ptr [0x01cc4800],EDX      ; 0041a5ef | PTR_01cc4800
    MOV dword ptr [0x01cc4804],ECX      ; 0041a5f5 | INT_01cc4804
