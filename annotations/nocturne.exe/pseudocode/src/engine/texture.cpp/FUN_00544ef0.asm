...
section .text
    ...
    MOV dword ptr [0x01cc4800],EDX      ; 00544f8c | DAT_01cc4800
    MOV dword ptr [0x01cc4804],ECX      ; 00544f92 | DAT_01cc4804
    ...
    MOV dword ptr [0x01cc4800],ECX      ; 005450c8 | DAT_01cc4800
    MOV dword ptr [0x01cc4804],ESI      ; 005450ce | DAT_01cc4804
    CALL FUN_004c8440                   ; 005450d4
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; undefined FUN_004c8440()
    ...
    PUSH EDX                            ; 00545225
    CALL FUN_005636d0                   ; 00545226
        ;   XREF to: 005636d0 (UNCONDITIONAL_CALL)  ; undefined FUN_005636d0()
    ADD ESP,0x10                        ; 0054522b
    PUSH ESI                            ; 0054522e
    CALL FUN_00563380                   ; 0054522f
        ;   XREF to: 00563380 (UNCONDITIONAL_CALL)  ; undefined FUN_00563380()
    ...
    PUSH EAX                            ; 005452af
    CALL FUN_00563c90                   ; 005452b0
        ;   XREF to: 00563c90 (UNCONDITIONAL_CALL)  ; undefined FUN_00563c90()
    MOV EAX,0xf3                        ; 005452b5
    ADD ESP,0x10                        ; 005452ba
    MOV [0x01cc4804],EAX                ; 005452bd | DAT_01cc4804
    MOV EAX,ESP                         ; 005452c2
    MOV EDI,0x59673d                    ; 005452c4 | = "..\\engine\\texture.cpp"
    PUSH EAX                            ; 005452c9
    MOV dword ptr [0x01cc4800],EDI      ; 005452ca | DAT_01cc4800
    CALL FUN_004c8440                   ; 005452d0
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; undefined FUN_004c8440()
    ...
    PUSH EDI                            ; 00545320
    CALL FUN_005636d0                   ; 00545321
        ;   XREF to: 005636d0 (UNCONDITIONAL_CALL)  ; undefined FUN_005636d0()
    ADD ESP,0x10                        ; 00545326
    PUSH ESI                            ; 00545329
    CALL FUN_00563380                   ; 0054532a
        ;   XREF to: 00563380 (UNCONDITIONAL_CALL)  ; undefined FUN_00563380()
