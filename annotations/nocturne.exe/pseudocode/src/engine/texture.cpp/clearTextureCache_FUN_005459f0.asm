...
;
; XREF[3]:
;   core_menu.cpp_showMainGameMenu_FUN_004d23d0 at 004d2472
;   core_mission.cpp_CDemonMission_freeAllAssets_FUN_004d9900 at 004d9900
...
section .text
    ...
    MOV EDX,dword ptr [0x02dd0f84]      ; 005459f0 | DAT_02dd0f84
        ;   Label: engine_texture.cpp_clearTextureCache_FUN_005459f0
    PUSH EDX                            ; 005459f6
