...
;
; XREF[1]:
;   core_game.cpp_FUN_0049cc10 at 0049d353
;
; Referenced Globals:
...
section .text
    ...
    CALL engine_texture.cpp_CTextureCache_getTextureCacheStats_FUN_00545810 ; 00545a8c
        ;   XREF to: 00545810 (UNCONDITIONAL_CALL)  ; undefined engine_texture.cpp_CTextureCache_getTextureCacheStats_FUN_00545810()
