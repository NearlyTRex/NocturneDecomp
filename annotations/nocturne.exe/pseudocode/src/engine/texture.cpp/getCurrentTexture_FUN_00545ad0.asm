...
;
; XREF[2]:
;   engine_3d.c_renderPolygonFullEffectsBufferedOp65_FUN_00408880 at 004089f5
;   engine_3d.c_renderPolygonFullEffectsDirectOp66_FUN_00408a60 at 00408b62
;
; Referenced Globals:
...
section .text
    ...
    PUSH ESI                            ; 00545ad0
        ;   Label: engine_texture.cpp_getCurrentTexture_FUN_00545ad0
    PUSH EDI                            ; 00545ad1
