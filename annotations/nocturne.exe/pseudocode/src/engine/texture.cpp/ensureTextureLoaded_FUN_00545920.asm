...
section .text
    ...
    CALL engine_texture.cpp_CTextureCache_findTexture_FUN_00545390 ; 00545955
        ;   XREF to: 00545390 (UNCONDITIONAL_CALL)  ; undefined engine_texture.cpp_CTextureCache_findTexture_FUN_00545390()
    ...
    CALL engine_texture.cpp_CTextureCache_loadTexture_FUN_00544ef0 ; 0054596f
        ;   XREF to: 00544ef0 (UNCONDITIONAL_CALL)  ; undefined engine_texture.cpp_CTextureCache_loadTexture_FUN_00544ef0()
