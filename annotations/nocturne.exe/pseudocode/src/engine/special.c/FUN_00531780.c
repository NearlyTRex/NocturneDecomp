...
// Convention: unknown
// Signature: undefined4 FUN_00531780(int param_1)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_00531780(int param_1)

{
  ...
  if (pcVar1 != (code *)0x0) {
    ...
    FUN_00532da0(auStack_3c2c);
    iVar2 = FUN_00532df0(local_1e64,auStack_3c2c);
    if (iVar2 != 0) {
      _DAT_02dc9d74 = (code *)FUN_00553d40(_DAT_02dc9e08,"APIDLLinit");
      ...
      _DAT_02dc9e04 = 1;
      FUN_00563cc0(&puStack_9c,0,0x8c);
