...

{
  ...
  if (pcVar1 != (code *)0x0) {
    ...
    wincore_windll_cpp_CExternalRenderer_ctor_FUN_00532da0(auStack_1dd0);
    iVar2 = wincore_windll_cpp_CExternalRenderer_validate_FUN_00532df0(auStack_3b98,auStack_1dd0);
    if (iVar2 != 0) {
      _DAT_02dc9d74 =
