...
// Convention: __cdecl
// Signature: void __cdecl engine_console_cpp_CConsole_scrollUp_FUN_0043ae40(CConsole *this_ptr)
...

{
  ...
  while (pcVar5 = pcVar5 + 0x50, iVar1 = this_ptr->console_height + -1, iVar6 < iVar1) {
