...
section .text
    ...
    PUSH EDI                            ; 004dcee0
        ;   Label: engine_model.c_freeMRGLData_FUN_004dcee0
    PUSH EBP                            ; 004dcee1
    ...
    PUSH EBP                            ; 004dcef9
    CALL engine_boss.c_modelStructNotSupported3_FUN_0041a570 ; 004dcefa
        ;   XREF to: 0041a570 (UNCONDITIONAL_CALL)  ; void engine_boss.c_modelStructNotSupported3_FUN_0041a570(SMRGLHeaderExtended * mrgl_data)
