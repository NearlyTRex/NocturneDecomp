...
section .text
    ...
    PUSH EBX                            ; 004dd760
        ;   Label: engine_model.c_FUN_004dd760
    ...
    PUSH ECX                            ; 004dd776
    CALL engine_model.c_FUN_004dd690    ; 004dd777
        ;   XREF to: 004dd690 (UNCONDITIONAL_CALL)  ; undefined engine_model.c_FUN_004dd690()
    ADD ESP,0x4                         ; 004dd77c
    POP EBX                             ; 004dd77f
    RET                                 ; 004dd780
    PUSH EBX                            ; 004dd781
        ;   Label: LAB_004dd781
    CALL engine_model.c_FUN_004dd690    ; 004dd782
        ;   XREF to: 004dd690 (UNCONDITIONAL_CALL)  ; undefined engine_model.c_FUN_004dd690()
