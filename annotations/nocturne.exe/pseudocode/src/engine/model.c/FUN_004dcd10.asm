...
section .text
    ...
    PUSH EAX                            ; 004dcd74
    MOV dword ptr [0x01cc4800],EDX      ; 004dcd75 | DAT_01cc4800
    MOV dword ptr [0x01cc4804],ECX      ; 004dcd7b | DAT_01cc4804
    ...
    PUSH EAX                            ; 004dcdac
    CALL FUN_00563c90                   ; 004dcdad
        ;   XREF to: 00563c90 (UNCONDITIONAL_CALL)  ; undefined FUN_00563c90()
    MOV EAX,0xf5                        ; 004dcdb2
    ADD ESP,0xc                         ; 004dcdb7
    MOV [0x01cc4804],EAX                ; 004dcdba | DAT_01cc4804
    LEA EAX,[ESP + 0x4]                 ; 004dcdbf
    MOV ESI,0x58a54c                    ; 004dcdc3 | = "..\\engine\\model.c"
    PUSH EAX                            ; 004dcdc8
    MOV dword ptr [0x01cc4800],ESI      ; 004dcdc9 | DAT_01cc4800
    CALL FUN_004c8440                   ; 004dcdcf
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; undefined FUN_004c8440()
    ADD ESP,0x4                         ; 004dcdd4
    PUSH EDI                            ; 004dcdd7
        ;   Label: LAB_004dcdd7
    CALL FUN_005635b0                   ; 004dcdd8
    ...
    PUSH EAX                            ; 004dce07
    MOV dword ptr [0x01cc4800],EDX      ; 004dce08 | DAT_01cc4800
    MOV dword ptr [0x01cc4804],ECX      ; 004dce0e | DAT_01cc4804
    CALL FUN_004c8440                   ; 004dce14
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; undefined FUN_004c8440()
    ...
    PUSH EAX                            ; 004dce37
    CALL FUN_00563c90                   ; 004dce38
        ;   XREF to: 00563c90 (UNCONDITIONAL_CALL)  ; undefined FUN_00563c90()
    MOV EAX,0x107                       ; 004dce3d
    ADD ESP,0xc                         ; 004dce42
    MOV [0x01cc4804],EAX                ; 004dce45 | DAT_01cc4804
    LEA EAX,[ESP + 0x4]                 ; 004dce4a
    MOV EDI,0x58a5a2                    ; 004dce4e | = "..\\engine\\model.c"
    PUSH EAX                            ; 004dce53
    MOV dword ptr [0x01cc4800],EDI      ; 004dce54 | DAT_01cc4800
    CALL FUN_004c8440                   ; 004dce5a
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; undefined FUN_004c8440()
    ADD ESP,0x4                         ; 004dce5f
    PUSH EBP                            ; 004dce62
        ;   Label: LAB_004dce62
    CALL FUN_00563380                   ; 004dce63
    ...
    PUSH EAX                            ; 004dce98
    MOV dword ptr [0x01cc4800],EDX      ; 004dce99 | DAT_01cc4800
    MOV dword ptr [0x01cc4804],ECX      ; 004dce9f | DAT_01cc4804
    CALL FUN_004c8440                   ; 004dcea5
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; undefined FUN_004c8440()
    ...
    PUSH EBX                            ; 004dcece
    CALL FUN_0041a540                   ; 004dcecf
        ;   XREF to: 0041a540 (UNCONDITIONAL_CALL)  ; undefined FUN_0041a540()
