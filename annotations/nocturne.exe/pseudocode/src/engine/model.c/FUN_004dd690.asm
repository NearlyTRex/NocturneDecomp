...
;
; XREF[1]:
;   engine_model.c_FUN_004dd760 at 004dd777
;
; Called Functions:
;   engine_boss.c_FUN_0041a5e0
...
section .text
    ...
    PUSH EBX                            ; 004dd690
        ;   Label: engine_model.c_FUN_004dd690
    PUSH ESI                            ; 004dd691
    PUSH EDI                            ; 004dd692
    PUSH EBP                            ; 004dd693
    ...
    PUSH EBX                            ; 004dd6e9
        ;   Label: LAB_004dd6e9
    CALL engine_boss.c_FUN_0041a5e0     ; 004dd6ea
        ;   XREF to: 0041a5e0 (UNCONDITIONAL_CALL)  ; undefined engine_boss.c_FUN_0041a5e0()
