...
;                               FUNCTION
; *****************************************************************************
; void FUN_004dcc90(undefined4 *param_1,int param_2)
;
;
; Referenced Globals:
...
section .text
    ...
    MOV dword ptr [0x01cc4800],EDX      ; 004dcce3 | DAT_01cc4800
    MOV dword ptr [0x01cc4804],ECX      ; 004dcce9 | DAT_01cc4804
    CALL FUN_004c8440                   ; 004dccef
