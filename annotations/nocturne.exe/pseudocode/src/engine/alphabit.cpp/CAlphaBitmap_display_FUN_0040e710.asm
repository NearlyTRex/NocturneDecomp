...
;   core_inv.cpp_CInventory_renderAllItems_FUN_004c2470 at 004c2b14
;   core_level.cpp_CLevelLoader_show_FUN_004c5640 at 004c5744
;   core_main.c_finalizeGameSystems_FUN_004c90e0 at 004c9173
;   core_main.c_initializeGameSystems_FUN_004c85f0 at 004c8c56
...
section .text
    ...
    CMP EDI,dword ptr [0x005b761c]      ; 0040e728 | g_WindowWidth
    ...
    CMP EAX,dword ptr [0x005b7620]      ; 0040e73f | g_WindowHeight
    ...
    LEA EBX,[EDI + EAX*0x1]             ; 0040e7b3
        ;   Label: LAB_0040e7b3
    CMP EBX,dword ptr [0x005b761c]      ; 0040e7b6 | g_WindowWidth
    JLE 0x0040e7c5                      ; 0040e7bc
        ;   XREF to: 0040e7c5 (CONDITIONAL_JUMP)  ; LAB_0040e7c5
    MOV EAX,[0x005b761c]                ; 0040e7be | g_WindowWidth
    ...
    LEA EBX,[EDI + EAX*0x1]             ; 0040e857
        ;   Label: LAB_0040e857
    CMP EBX,dword ptr [0x005b761c]      ; 0040e85a | g_WindowWidth
    JLE 0x0040e869                      ; 0040e860
        ;   XREF to: 0040e869 (CONDITIONAL_JUMP)  ; LAB_0040e869
    MOV EAX,[0x005b761c]                ; 0040e862 | g_WindowWidth
