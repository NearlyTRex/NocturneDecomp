// Name: engine_clipper.c_clipPolygonToViewFrustum_FUN_00432210
// Address: 00432210
// Address Range: [[00432210, 00432c7b]]
// Convention: __cdecl
// Signature: int __cdecl engine_clipper_c_clipPolygonToViewFrustum_FUN_00432210(int vertex_count,int *vertex_indices)
...

{
  ...
  if ((uVar13 == vertex_count) && (cVar7 != '\0')) {
    DAT_00766c70 = uVar13 ^ vertex_count;
  }
  else {
    if (uVar13 == 0) {
        ...
        if (0 < vertex_count) {
          ...
          do {
            ...
            if (((uint)plVar10 & 7) != 0) {
              ...
              *(int *)plVar10 = (int)*(longlong *)(&DAT_005c5014 + *vertex_indices * 0xc);
              iVar4 = 0x2c;
            }
            while (7 < iVar4) {
              lVar1 = *plVar19;
    ...
    if (0 < vertex_count) {
      puVar11 = auStack_d0;
      pSVar12 = (SRenderVertex *)auStack_d0[vertex_count];
      do {
        iVar4 = DAT_00767b38;
        puVar11 = puVar11 + 1;
                ...
                if (0 < (int)DAT_007672f4) {
                  ...
                  do {
                    ...
                    case 0:
                      ...
                      if (((uint)plVar19 & 7) != 0) {
                        plVar10 = (longlong *)
                                  (&DAT_00766c78 + (uint)bVar21 * -8 + DAT_00766c70 * 0x30);
