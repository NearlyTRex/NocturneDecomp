...
section .text
    ...
    PUSH EBX                            ; 00432210
        ;   Label: engine_clipper.c_clipPolygonToViewFrustum_FUN_00432210
    PUSH ESI                            ; 00432211
    PUSH EDI                            ; 00432212
    PUSH EBP                            ; 00432213
    ...
    JMP dword ptr [EAX*0x4 + 0x4321fc]  ; 00432b3b | caseD_0 | caseD_1 | caseD_2
        ;   Label: switchD
    IMUL EDI,dword ptr [0x00766c70],0x30 ; 00432b42 | DAT_00766c70
        ;   Label: caseD_0
    MOV ECX,0x30                        ; 00432b49
    ADD EDI,0x766c74                    ; 00432b4e
    MOV ESI,EBX                         ; 00432b54
    TEST EDI,0x7                        ; 00432b56
    JZ 0x00432b64                       ; 00432b5c
        ;   XREF to: 00432b64 (CONDITIONAL_JUMP)  ; LAB_00432b64
    MOVSD ES:EDI,ESI                    ; 00432b5e
    ...
    JLE 0x00432b81                      ; 00432b78
        ;   XREF to: 00432b81 (CONDITIONAL_JUMP)  ; LAB_00432b81
    MOVSD ES:EDI,ESI                    ; 00432b7a
    SUB ECX,0x4                         ; 00432b7b
    JLE 0x00432b81                      ; 00432b7e
        ;   XREF to: 00432b81 (CONDITIONAL_JUMP)  ; LAB_00432b81
    MOVSD ES:EDI,ESI                    ; 00432b80
    ...
    IMUL EDI,dword ptr [0x00766c70],0x30 ; 00432bd2 | DAT_00766c70
        ;   Label: caseD_2
    MOV ECX,0x30                        ; 00432bd9
    MOV ESI,EBX                         ; 00432bde
    ADD EDI,0x766c74                    ; 00432be0
    TEST EDI,0x7                        ; 00432be6
    JZ 0x00432bf4                       ; 00432bec
        ;   XREF to: 00432bf4 (CONDITIONAL_JUMP)  ; LAB_00432bf4
    MOVSD ES:EDI,ESI                    ; 00432bee
    ...
    JLE 0x00432c11                      ; 00432c08
        ;   XREF to: 00432c11 (CONDITIONAL_JUMP)  ; LAB_00432c11
    MOVSD ES:EDI,ESI                    ; 00432c0a
    SUB ECX,0x4                         ; 00432c0b
    JLE 0x00432c11                      ; 00432c0e
        ;   XREF to: 00432c11 (CONDITIONAL_JUMP)  ; LAB_00432c11
    MOVSD ES:EDI,ESI                    ; 00432c10
    ...
    MOV dword ptr [EAX],EBX             ; 00432c56
    JMP 0x00432751                      ; 00432c58
        ;   XREF to: 00432751 (UNCONDITIONAL_JUMP)  ; LAB_00432751
    MOV EBP,dword ptr [EAX + 0x8]       ; 00432c5d
        ;   Label: LAB_00432c5d
    MOV ECX,dword ptr [EAX + 0x4]       ; 00432c60
    CMP ECX,EBP                         ; 00432c63
    JLE 0x00432c6f                      ; 00432c65
        ;   XREF to: 00432c6f (CONDITIONAL_JUMP)  ; LAB_00432c6f
    MOV dword ptr [EAX + 0x4],EBP       ; 00432c67
