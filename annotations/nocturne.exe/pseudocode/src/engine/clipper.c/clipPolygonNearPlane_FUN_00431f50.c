// Name: engine_clipper.c_clipPolygonNearPlane_FUN_00431f50
// Address: 00431f50
// Address Range: [[00431f50, 00432148]]
// Convention: __cdecl
// Signature: void __cdecl engine_clipper_c_clipPolygonNearPlane_FUN_00431f50(void)
      ...
      if (0 < (int)DAT_007672f4) {
        ...
        do {
          ...
          case 0:
            ...
            plVar7 = plVar9;
            if (((uint)plVar9 & 7) != 0) {
              plVar7 = (longlong *)(&DAT_00766c78 + (uint)bVar10 * -8 + DAT_00766c70 * 0x30);
