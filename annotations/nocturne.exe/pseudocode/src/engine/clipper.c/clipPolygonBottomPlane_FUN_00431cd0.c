...
// Convention: __cdecl
// Signature: int __cdecl engine_clipper_c_clipPolygonBottomPlane_FUN_00431cd0(SRenderVertex **input_vertices,SRenderVertex **output_vertices,int vertex_count)
