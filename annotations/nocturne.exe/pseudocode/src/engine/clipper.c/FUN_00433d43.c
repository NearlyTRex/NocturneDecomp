// Name: engine_clipper.c_FUN_00433d43
// Address: 00433d43
// Address Range: [[00433d43, 00433d92]]
// Convention: unknown
// Signature: void engine_clipper_c_FUN_00433d43(void)
...
code_r0x00433d43:
  *(byte *)(in_ECX + 0x30) = *(byte *)(in_ECX + 0x30) ^ (byte)((uint)unaff_EBX >> 8);
  ...
  do {
    ...
    unaff_EBP = (SRenderVertex *)(&DAT_0076814c + uVar3 * 0xc);
    bVar1 = unaff_EBX[1].projected_vertex.transformed_z <= (in_EDX->projected_vertex).transformed_x;
    if ((int)(&DAT_00768154)[uVar3 * 0xc] <= (unaff_EBP->projected_vertex).transformed_x) {
      bVar1 = bVar1 | 2;
    }
    unaff_EBX = in_EDX;
    iVar7 = unaff_retaddr;
