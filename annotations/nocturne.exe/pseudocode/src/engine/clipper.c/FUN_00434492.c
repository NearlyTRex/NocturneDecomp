// Name: engine_clipper.c_FUN_00434492
// Address: 00434492
// Address Range: [[00434492, 0043453a]]
// Convention: unknown
// Signature: undefined4 engine_clipper_c_FUN_00434492(void)

#include "nocturne.h"

/* WARNING: Instruction at (ram,0x00434493) overlaps instruction at (ram,0x00434492)
uint engine_clipper_c_FUN_00434492(void)
  ...
  *(byte *)(in_ECX + 0x30) = *(byte *)(in_ECX + 0x30) ^ (byte)((uint)unaff_EBX >> 8);
  ...
  for (uVar6 = in_ECX >> 2; uVar6 != 0; uVar6 = uVar6 - 1) {
    *piVar5 = (in_EDX->projected_vertex).transformed_x;
    in_EDX = (SRenderVertex *)((int)in_EDX + (uint)bVar11 * -8 + 4);
  ...
  for (uVar6 = in_ECX & 3; uVar6 != 0; uVar6 = uVar6 - 1) {
    *(char *)piVar5 = (char)(in_EDX->projected_vertex).transformed_x;
    in_EDX = (SRenderVertex *)((int)in_EDX + (uint)bVar11 * -2 + 1);
  ...
  do {
    ...
    pSVar8 = (SRenderVertex *)(&DAT_0076814c + uVar6 * 0xc);
    bVar3 = unaff_EBX[1].projected_vertex.transformed_z <= (in_EDX->projected_vertex).transformed_x;
    if ((int)(&DAT_00768154)[uVar6 * 0xc] <= (pSVar8->projected_vertex).transformed_x) {
      bVar3 = bVar3 | 2;
    }
    unaff_EBX = in_EDX;
    ...
    case 1:
      engine_clipper_c_interpolateVertexLeftClipAdvanced_FUN_004337a0
                (pSVar8,in_EDX,(SRenderVertex *)(&DAT_00767b4c + DAT_00767b40 * 0xc));
      DAT_00767b40 = DAT_00767b40 + 1;
      break;
    case 2:
      pSVar10 = in_EDX;
      ...
      DAT_00767b40 = DAT_00767b40 + 1;
      engine_clipper_c_interpolateVertexLeftClipAdvanced_FUN_004337a0
                (in_EDX,pSVar8,(SRenderVertex *)(&DAT_00767b4c + DAT_00767b40 * 0xc));
      DAT_00767b40 = DAT_00767b40 + 1;
    }
  } while( true );
