// Name: engine_clipper.c_clipPolygonToViewFrustumAdvanced_FUN_00434210
// Address: 00434210
// Address Range: [[00434210, 00434957]]
// Convention: __cdecl
// Signature: int __cdecl engine_clipper_c_clipPolygonToViewFrustumAdvanced_FUN_00434210(int vertex_count,int *vertex_indices)
  ...
  if (iVar9 != 0) {
    ...
    if (0 < (int)DAT_00767b3c) {
      ...
      do {
        ...
        pSVar13 = (SRenderVertex *)(&DAT_0076814c + uVar5 * 0xc);
        bVar1 = (pSVar8->projected_vertex).transformed_z <= (pSVar8->projected_vertex).transformed_x
        ;
        if ((int)(&DAT_00768154)[uVar5 * 0xc] <= (pSVar13->projected_vertex).transformed_x) {
          bVar1 = bVar1 | 2;
        }
        switch(bVar1) {
        case 0:
        ...
        case 2:
          ...
          piVar3 = &DAT_00767b4c + DAT_00767b40 * 0xc;
          for (iVar7 = 0xc; iVar7 != 0; iVar7 = iVar7 + -1) {
            *piVar3 = (pSVar12->projected_vertex).transformed_x;
            pSVar12 = (SRenderVertex *)((int)pSVar12 + (uint)bVar15 * -8 + 4);
            piVar3 = piVar3 + (uint)bVar15 * -2 + 1;
          }
          for (iVar7 = 0; iVar7 != 0; iVar7 = iVar7 + -1) {
            *(char *)piVar3 = (char)(pSVar12->projected_vertex).transformed_x;
    ...
    if (2 < (int)DAT_00767b40) {
      ...
      if (0 < (int)DAT_00767b40) {
        ...
        do {
          ...
          pSVar13 = (SRenderVertex *)(&DAT_00767b4c + uVar5 * 0xc);
          bVar1 = (pSVar8->projected_vertex).transformed_x <=
                  -(pSVar8->projected_vertex).transformed_z;
          if ((pSVar13->projected_vertex).transformed_x <= (int)-(&DAT_00767b54)[uVar5 * 0xc]) {
            bVar1 = bVar1 | 2;
          }
          switch(bVar1) {
          case 0:
      ...
      if (2 < (int)DAT_00767b44) {
        ...
        if (0 < (int)DAT_00767b44) {
          ...
          do {
            ...
            if ((int)(&DAT_00768754)[uVar5 * 0xc] <= *(int *)(&DAT_00768750 + uVar5 * 0x30)) {
              bVar1 = bVar1 | 2;
            }
            switch(bVar1) {
            case 0:
            ...
            case 1:
              engine_clipper_c_interpolateVertexBottomClipAdvanced_FUN_00433a00
                        ((SRenderVertex *)(&DAT_0076874c + uVar5 * 0xc),pSVar8,
            ...
            case 2:
              ...
              DAT_00767b48 = DAT_00767b48 + 1;
              engine_clipper_c_interpolateVertexBottomClipAdvanced_FUN_00433a00
                        (pSVar8,(SRenderVertex *)(&DAT_0076874c + uVar5 * 0xc),
                         (SRenderVertex *)(&DAT_00768d4c + DAT_00767b48 * 0xc));
              DAT_00767b48 = DAT_00767b48 + 1;
            }
            local_1c = local_1c + 1;
          ...
          if (0 < (int)DAT_00767b48) {
            ...
            do {
              ...
              bVar1 = (pSVar8->projected_vertex).transformed_y <=
                      -(pSVar8->projected_vertex).transformed_z;
              if (*(int *)(&DAT_00768d50 + uVar5 * 0x30) <= (int)-(&DAT_00768d54)[uVar5 * 0xc]) {
                bVar1 = bVar1 | 2;
              }
              switch(bVar1) {
              case 0:
          ...
          if (2 < DAT_00766c70) {
            ...
            if (0 < DAT_00766c70) {
              do {
                ...
                else if (iVar9 < *piVar3) {
                  *piVar3 = iVar9;
                }
                else {
                  iVar10 = -iVar9;
                  if (-*piVar3 == iVar9 || iVar10 < *piVar3) {
                    iVar2 = piVar3[1];
                    if (piVar3[2] < iVar2) {
                      piVar3[1] = piVar3[2];
                    }
                    else if (-iVar2 != iVar9 && iVar2 <= iVar10) {
                      piVar3[1] = iVar10;
                    }
                  }
                  else {
