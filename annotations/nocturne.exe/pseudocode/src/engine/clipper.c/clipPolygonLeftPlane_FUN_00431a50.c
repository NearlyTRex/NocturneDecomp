...
// Convention: unknown
// Signature: int engine_clipper_c_clipPolygonLeftPlane_FUN_00431a50(undefined4 *param_1,int param_2,int param_3)

#include "nocturne.h"

int engine_clipper_c_clipPolygonLeftPlane_FUN_00431a50(uint *param_1,int param_2,int param_3)
