// Name: engine_clipper.c_clipPolygonHorizontalPlanes_FUN_00433ef0
// Address: 00433ef0
// Address Range: [[00433ef0, 00434017]]
// Convention: __cdecl
// Signature: void __cdecl engine_clipper_c_clipPolygonHorizontalPlanes_FUN_00433ef0(void)
...

{
  ...
  if (0 < (int)DAT_00767b44) {
    ...
    do {
      ...
      if ((int)(&DAT_00768754)[uVar2 * 0xc] <= *(int *)(&DAT_00768750 + uVar2 * 0x30)) {
        bVar1 = bVar1 | 2;
      }
      switch(bVar1) {
      case 0:
