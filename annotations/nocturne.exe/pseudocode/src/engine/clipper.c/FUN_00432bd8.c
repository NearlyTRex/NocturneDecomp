// Name: engine_clipper.c_FUN_00432bd8
// Address: 00432bd8
// Address Range: [[00432bd8, 00432c7b]]
// Convention: unknown
// Signature: undefined4 engine_clipper_c_FUN_00432bd8(void)

#include "nocturne.h"

/* WARNING: Instruction at (ram,0x00432bd9) overlaps instruction at (ram,0x00432bd8)
uint engine_clipper_c_FUN_00432bd8(void)
...
code_r0x00432bd8:
  *(byte *)(in_ECX + 0x30) = *(byte *)(in_ECX + 0x30) ^ (byte)((uint)unaff_EBX >> 8);
  plVar12 = (longlong *)((int)&DAT_00766c74 + unaff_EDI);
  iVar11 = in_ECX;
  pSVar10 = unaff_EBX;
  plVar13 = plVar12;
  if (((uint)plVar12 & 7) != 0) {
    plVar13 = (longlong *)((int)&DAT_00766c78 + (uint)bVar14 * -8 + unaff_EDI);
    pSVar10 = (SRenderVertex *)((int)unaff_EBX + (uint)bVar14 * -8 + 4);
    *(int *)plVar12 = (unaff_EBX->projected_vertex).transformed_x;
    iVar11 = in_ECX + -4;
  ...
  while (7 < iVar11) {
    ...
    *plVar13 = (longlong)ROUND((float10)lVar2);
    plVar13 = plVar13 + 1;
    iVar11 = iVar11 + -8;
  }
  if (iVar11 != 0 && -9 < iVar11 + -8) {
    *(int *)plVar13 = (pSVar10->projected_vertex).transformed_x;
    if (4 < iVar11) {
      *(uint *)((int)plVar13 + (uint)bVar14 * -8 + 4) =
...
LAB_00432c11:
  ...
  engine_clipper_c_interpolateVertexNearClip_FUN_00431930
            (unaff_EBX,in_EDX,(SRenderVertex *)(&DAT_00766c74 + DAT_00766c70 * 0xc));
  DAT_00766c70 = DAT_00766c70 + 1;
  do {
    pSVar10 = unaff_EBP;
    ...
    in_EDX = (SRenderVertex *)(&DAT_007672f8 + uVar7 * 0xc);
    bVar5 = DAT_005ad284 <= pSVar10[1].projected_vertex.transformed_z;
    ...
    case 0:
      ...
      plVar13 = plVar12;
      if (((uint)plVar12 & 7) != 0) {
        plVar13 = (longlong *)(&DAT_00766c78 + DAT_00766c70 * 0xc + (uint)bVar14 * -2);
        pSVar9 = (SRenderVertex *)((int)pSVar10 + (uint)bVar14 * -8 + 0x34);
        *(int *)plVar12 = (unaff_EBX->projected_vertex).transformed_x;
        iVar11 = 0x2c;
      }
      while (7 < iVar11) {
        ...
        *plVar13 = (longlong)ROUND((float10)lVar1);
        plVar13 = plVar13 + 1;
        iVar11 = iVar11 + -8;
      }
      if (iVar11 != 0 && -9 < iVar11 + -8) {
        *(int *)plVar13 = (pSVar9->projected_vertex).transformed_x;
        if (4 < iVar11) {
          *(uint *)((int)plVar13 + (uint)bVar14 * -8 + 4) =
    ...
    case 1:
      engine_clipper_c_interpolateVertexNearClip_FUN_00431930
                (in_EDX,unaff_EBX,(SRenderVertex *)(&DAT_00766c74 + DAT_00766c70 * 0xc));
      DAT_00766c70 = DAT_00766c70 + 1;
      break;
    case 2:
