// Name: engine_clipper.c_FUN_004347cc
// Address: 004347cc
// Address Range: [[004347cc, 00434844]]
// Convention: unknown
// Signature: undefined4 engine_clipper_c_FUN_004347cc(undefined4 param_1,undefined4 param_2,int param_3)

#include "nocturne.h"

/* WARNING: Instruction at (ram,0x004347cd) overlaps instruction at (ram,0x004347cc)
uint engine_clipper_c_FUN_004347cc(uint param_1,uint param_2,int param_3)
...
code_r0x004347cc:
  *(byte *)(in_ECX + 0x30) = *(byte *)(in_ECX + 0x30) ^ (byte)((uint)unaff_EBX >> 8);
  ...
  do {
    ...
    unaff_EBP = (SRenderVertex *)(&DAT_00767b4c + uVar5 * 0xc);
    bVar3 = (in_EDX->projected_vertex).transformed_x <= -unaff_EBX[1].projected_vertex.transformed_z
    ;
    if ((unaff_EBP->projected_vertex).transformed_x <= (int)-(&DAT_00767b54)[uVar5 * 0xc]) {
      bVar3 = bVar3 | 2;
    }
    unaff_EBX = in_EDX;
    param_3 = iVar6;
