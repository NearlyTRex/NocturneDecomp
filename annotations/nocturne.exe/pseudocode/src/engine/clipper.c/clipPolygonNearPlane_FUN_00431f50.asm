...
section .text
    ...
    PUSH EBX                            ; 00431f50
        ;   Label: engine_clipper.c_clipPolygonNearPlane_FUN_00431f50
    PUSH ESI                            ; 00431f51
    PUSH EDI                            ; 00431f52
    PUSH EBP                            ; 00431f53
    ...
    JMP dword ptr [EAX*0x4 + 0x431f40]  ; 00432049 | caseD_0 | caseD_1 | caseD_2
        ;   Label: switchD
    IMUL EDI,dword ptr [0x00766c70],0x30 ; 00432050 | DAT_00766c70
        ;   Label: caseD_0
    ...
    IMUL EDI,dword ptr [0x00766c70],0x30 ; 004320d6 | DAT_00766c70
        ;   Label: caseD_2
    MOV ECX,0x30                        ; 004320dd
    MOV ESI,EDX                         ; 004320e2
    ADD EDI,0x766c74                    ; 004320e4
    TEST EDI,0x7                        ; 004320ea
    JZ 0x004320f8                       ; 004320f0
        ;   XREF to: 004320f8 (CONDITIONAL_JUMP)  ; LAB_004320f8
    MOVSD ES:EDI,ESI                    ; 004320f2
    ...
    JLE 0x00432115                      ; 0043210c
        ;   XREF to: 00432115 (CONDITIONAL_JUMP)  ; LAB_00432115
    MOVSD ES:EDI,ESI                    ; 0043210e
    SUB ECX,0x4                         ; 0043210f
    JLE 0x00432115                      ; 00432112
        ;   XREF to: 00432115 (CONDITIONAL_JUMP)  ; LAB_00432115
    MOVSD ES:EDI,ESI                    ; 00432114
