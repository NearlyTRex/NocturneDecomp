...
// Convention: unknown
// Signature: void FUN_004c3aa0(int param_1)
...

{
  ...
  if (*(int *)(param_1 + 0x14) == 0) {
    uVar4 = FUN_004dcd10(param_1 + 0x18);
    *(uint *)(param_1 + 0x14) = uVar4;
  }
  iVar2 = FUN_004dd520(*(uint *)(param_1 + 0x14));
  iVar3 = FUN_004dd520(*(int *)(param_1 + 0x14) + iVar2);
  iVar10 = 0;
  if (0 < *(int *)(param_1 + 8)) {
    iVar11 = param_1 + 0x18;
    iVar9 = param_1;
    do {
      if (*(int *)(iVar9 + 0x118) == 0) {
        uVar4 = FUN_004dd790(iVar11,iVar2 + iVar3);
