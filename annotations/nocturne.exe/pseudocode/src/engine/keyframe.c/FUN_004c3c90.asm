...
section .text
    ...
    FXCH                                ; 004c3e5a
    CALL FUN_00563a30                   ; 004c3e5c
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FISTP dword ptr [ESP + 0x1c]        ; 004c3e61
    FXCH                                ; 004c3e65
    CALL FUN_00563a30                   ; 004c3e67
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH ST2                            ; 004c3e6c
    CALL FUN_00563a30                   ; 004c3e6e
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH                                ; 004c3e73
    CALL FUN_00563a30                   ; 004c3e75
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH ST2                            ; 004c3e7a
    ...
    PUSH EAX                            ; 004c4028
        ;   Label: LAB_004c4028
    CALL FUN_004c3aa0                   ; 004c4029
        ;   XREF to: 004c3aa0 (UNCONDITIONAL_CALL)  ; undefined FUN_004c3aa0()
