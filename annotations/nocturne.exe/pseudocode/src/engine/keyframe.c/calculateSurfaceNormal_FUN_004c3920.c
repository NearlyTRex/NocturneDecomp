// Name: engine_keyframe.c_calculateSurfaceNormal_FUN_004c3920
// Address: 004c3920
// Address Range: [[004c3920, 004c3a94]]
// Convention: __cdecl
// Signature: void __cdecl engine_keyframe_c_calculateSurfaceNormal_FUN_004c3920(CVector3i *vertex_data,SMRGLPrimitiveTriangle *texture)
...

{
  ...
  (texture->base).surface_normal.A.i = (int)ROUND(fVar6);
  (texture->base).surface_normal.B.i = (int)ROUND(fVar5);
  (texture->base).surface_normal.C.i = (int)ROUND(fVar8);
