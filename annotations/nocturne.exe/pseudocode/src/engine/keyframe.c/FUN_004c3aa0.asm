...
section .text
    ...
    PUSH EBP                            ; 004c3af6
    PUSH EDI                            ; 004c3af7
    CALL FUN_004dd790                   ; 004c3af8
        ;   XREF to: 004dd790 (UNCONDITIONAL_CALL)  ; undefined FUN_004dd790()
    ...
    ADD EAX,0x18                        ; 004c3bee
        ;   Label: LAB_004c3bee
    PUSH EAX                            ; 004c3bf1
    CALL FUN_004dcd10                   ; 004c3bf2
        ;   XREF to: 004dcd10 (UNCONDITIONAL_CALL)  ; undefined FUN_004dcd10()
