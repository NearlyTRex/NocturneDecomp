...
;   shape_edittool.cpp_CEditorTools_showDirectoryBrowser_FUN_00470730 at 004707ec
...
;   shape_edittool.cpp_CStrList_populateWithFullPaths_FUN_00474ae0 at 00474b9f
;
; Called Functions:
