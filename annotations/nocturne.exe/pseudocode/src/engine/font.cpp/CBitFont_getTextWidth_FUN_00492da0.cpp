...
// Convention: __cdecl
// Signature: int __cdecl engine_font_cpp_CBitFont_getTextWidth_FUN_00492da0(int param_1,char *param_2)
  ...
  if (*(int *)(param_1 + 0x3190) == 0) {
    while (*param_2 != '\0') {
      ...
      do {
        ...
        param_2 = param_2 + 1;
        if (cVar1 == '\n') break;
        iVar3 = engine_font_cpp_CBitFont_getCharWidth_FUN_004930b0(param_1,cVar1);
