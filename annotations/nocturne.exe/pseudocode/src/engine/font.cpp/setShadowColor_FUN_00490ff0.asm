...
section .text
    ...
    PUSH EBX                            ; 00490ff0
        ;   Label: engine_font.cpp_setShadowColor_FUN_00490ff0
    PUSH ESI                            ; 00490ff1
    PUSH EDI                            ; 00490ff2
    PUSH EBP                            ; 00490ff3
    ...
    MOV EDX,dword ptr [0x005b7624]      ; 00491003 | g_BitsPerPixel
    ...
    MOV CL,byte ptr [0x01c00624]        ; 00491024 | g_RedBitPosition
    MOV EDX,ESI                         ; 0049102a
    MOV EAX,EBX                         ; 0049102c
    SHL EDX,CL                          ; 0049102e
    MOV CL,byte ptr [0x01c00630]        ; 00491030 | g_GreenBitPosition
    SHL EAX,CL                          ; 00491036
    MOV CL,byte ptr [0x01c0063c]        ; 00491038 | g_BlueBitPosition
    OR EAX,EDX                          ; 0049103e
    ...
    MOV [0x01cc4800],EAX                ; 0049111b | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EDX      ; 00491120 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 00491126
