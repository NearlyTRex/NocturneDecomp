...
section .text
    ...
    PUSH EBX                            ; 00490470
        ;   Label: engine_font.cpp_CBitFont_parseCharacterMetrics_FUN_00490470
    PUSH ESI                            ; 00490471
    PUSH EDI                            ; 00490472
    PUSH EBP                            ; 00490473
    ...
    PUSH EAX                            ; 00490531
    MOV dword ptr [0x01cc4804],EBX      ; 00490532 | g_CurrentLineNumber
    MOV dword ptr [0x01cc4800],ECX      ; 00490538 | g_CurrentFilename
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 0049053e
    ...
    MOV dword ptr [0x01cc4800],ECX      ; 004906f0 | g_CurrentFilename
    MOV dword ptr [0x01cc4804],EDI      ; 004906f6 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004906fc
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
    ...
    MOV [0x01cc4804],EAX                ; 00490769 | g_CurrentLineNumber
    MOV EAX,ESP                         ; 0049076e
    MOV ECX,0x5818b1                    ; 00490770 | = "..\\engine\\font.cpp"
    PUSH EAX                            ; 00490775
    MOV dword ptr [0x01cc4800],ECX      ; 00490776 | g_CurrentFilename
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 0049077c
        ;   XREF to: 004c8440 (UNCONDITIONAL_CALL)  ; void core_main.c_displayErrorAndQuit_FUN_004c8440(char * format)
