...
// Convention: __cdecl
// Signature: int __cdecl engine_font_cpp_CBitFont_drawCharacter_FUN_004916c0(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6)
...

{
  ...
  if (param_6 != -1) {
    engine_font_cpp_CBitFont_drawCharacter_FUN_004916c0
              (param_1,param_2,param_3 + *(int *)(param_1 + 0x317c),
  ...
  if (*(int *)(param_1 + 0x3184) == 0) {
    ...
    iVar6 = engine_font_cpp_clipCharacter_FUN_0048fd50
                      (&local_d4,&param_3,&param_4,&local_d0,&local_cc,iVar7);
    if (iVar6 != 0) {
      return iVar3;
    }
  }
      ...
      if (param_5 == -1) {
          ...
          if (param_4 <= local_cc) {
            do {
              engine_font_cpp_drawAlphaBlendedPixels_FUN_00491160
                        (*(int *)(&DAT_01bd2fa0 + iVar7) + param_3 * 4,local_d4,iVar6,
                         (local_d0 - param_3) + 1,
        ...
        if (*(int *)(param_1 + 0x1d64) == 0) {
          ...
          if (param_4 <= local_cc) {
            do {
              engine_font_cpp_drawAlphaBlendedPixels_FUN_00491160
                        (param_3 * 4 + *(int *)(&DAT_01bd2fa0 + iVar7),local_d4,iVar6,
