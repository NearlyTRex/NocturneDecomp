...
// Convention: __cdecl
// Signature: undefined4 __cdecl engine_font_cpp_clipCharacter_FUN_0048fd50(int *param_1,int *param_2,int *param_3,int *param_4,int *param_5,int param_6)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint __cdecl engine_font_cpp_clipCharacter_FUN_0048fd50(int *param_1,int *param_2,int *param_3,int *param_4,int *param_5,int param_6)
