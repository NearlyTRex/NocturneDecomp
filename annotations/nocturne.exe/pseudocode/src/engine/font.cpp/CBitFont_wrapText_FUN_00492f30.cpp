...
// Convention: __cdecl
// Signature: int __cdecl engine_font_cpp_CBitFont_wrapText_FUN_00492f30(undefined4 param_1,char *param_2,char *param_3,int param_4,int param_5,int param_6)

#include "nocturne.h"

int __cdecl engine_font_cpp_CBitFont_wrapText_FUN_00492f30(uint param_1,char *param_2,char *param_3,int param_4,int param_5,int param_6)

{
  ...
  bVar8 = 0;
  memset(param_3,0,param_4 * param_5);
  if (param_2 == (char *)0x0) {
    return 0;
  }
  local_24 = 0;
  if (0 < param_4) {
    ...
    do {
      ...
      while( true ) {
        ...
        *pcVar6 = '\0';
        iVar2 = engine_font_cpp_CBitFont_getTextWidth_FUN_00492da0(param_1,param_2);
        *pcVar6 = cVar1;
