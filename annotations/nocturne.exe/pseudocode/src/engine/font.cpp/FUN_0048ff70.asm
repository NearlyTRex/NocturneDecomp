...
section .text
    ...
    PUSH EDX                            ; 00490097
    PUSH EBP                            ; 00490098
    CALL FUN_0042d240                   ; 00490099
        ;   XREF to: 0042d240 (UNCONDITIONAL_CALL)  ; undefined FUN_0042d240()
    ...
    CALL FUN_004931b0                   ; 0049018d
        ;   XREF to: 004931b0 (UNCONDITIONAL_CALL)  ; undefined FUN_004931b0()
