...
section .text
    ...
    MOV EDX,dword ptr [0x01c039b8]      ; 004cd0ec | g_RelativeX
    MOV EDI,dword ptr [0x01c039bc]      ; 004cd0f2 | g_RelativeY
    MOV EAX,[0x01c039c0]                ; 004cd0f8 | g_RelativeZ
