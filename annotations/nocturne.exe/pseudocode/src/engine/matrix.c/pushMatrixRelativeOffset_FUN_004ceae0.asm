...
section .text
    ...
    PUSH EBX                            ; 004ceae0
        ;   Label: engine_matrix.c_pushMatrixRelativeOffset_FUN_004ceae0
    PUSH ESI                            ; 004ceae1
    PUSH EBP                            ; 004ceae2
    MOV EAX,[0x01cc5174]                ; 004ceae3 | DAT_01cc5174
    MOV EDX,dword ptr [0x01c039b8]      ; 004ceae8 | g_RelativeX
    MOV ECX,dword ptr [0x01c039bc]      ; 004ceaee | g_RelativeY
    MOV dword ptr [EAX*0x4 + 0x1cc52e0],EDX ; 004ceaf4
    MOV EDX,dword ptr [0x01c039bc]      ; 004ceafb | g_RelativeY
    MOV EBX,dword ptr [0x01c039c0]      ; 004ceb01 | g_RelativeZ
    MOV dword ptr [EAX*0x4 + 0x1cc5308],EDX ; 004ceb07
    MOV EDX,dword ptr [0x01c039c0]      ; 004ceb0e | g_RelativeZ
    ...
    MOV EDX,dword ptr [0x01c039b8]      ; 004ceb25 | g_RelativeX
    INC ESI                             ; 004ceb2b
    ...
    MOV dword ptr [0x01c039b8],EDX      ; 004ceb3e | g_RelativeX
    SUB EBX,EAX                         ; 004ceb44
    MOV dword ptr [0x01c039bc],ECX      ; 004ceb46 | g_RelativeY
    MOV dword ptr [0x01c039c0],EBX      ; 004ceb4c | g_RelativeZ
    ...
    MOV dword ptr [0x01cc4800],EBP      ; 004ceb6a | g_CurrentFilename
    MOV [0x01cc4804],EAX                ; 004ceb70 | g_CurrentLineNumber
    CALL core_main.c_displayErrorAndQuit_FUN_004c8440 ; 004ceb75
