...

{
  ...
  *(int *)(iVar9 * 4 + 0x1cc5290) = _DAT_01c03a04;
  fVar18 = (float10)param_3;
  *(int *)(iVar9 * 4 + 0x1cc52b8) = _DAT_01c03a08;
  atan2((float10)param_1,fVar18);
  uVar24 = 0x4ce0a6;
  fVar19 = (float10)atan2((float10)param_1,fVar18);
  fVar20 = (float10)_DAT_005882b3;
  fVar21 = (float10)_DAT_005882bb;
  uVar23 = 0x4ce0d1;
  fVar19 = (float10)round(-fVar19 * fVar20 * fVar21);
  uVar22 = 0x4ce0de;
  iVar4 = (int)ROUND(fVar19);
  fVar18 = (float10)round(fVar18 * fVar20 * fVar21);
  iVar9 = (int)ROUND(fVar18);
  iVar4 = engine_matrix_c_interpolatedSin_FUN_004cca60
                    ((int)ROUND(fVar19),uVar22,uVar23,uVar24,iVar4,iVar9);
  iVar5 = engine_matrix_c_interpolatedCos_FUN_004ccaa0(uVar24);
