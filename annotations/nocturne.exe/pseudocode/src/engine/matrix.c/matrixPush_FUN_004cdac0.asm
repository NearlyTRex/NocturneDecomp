...
section .text
    ...
    MOV EDX,dword ptr [0x01c039b8]      ; 004cdac5 | g_RelativeX
    MOV dword ptr [EAX*0x4 + 0x1cc52e0],EDX ; 004cdacb
    MOV EDX,dword ptr [0x01c039bc]      ; 004cdad2 | g_RelativeY
    MOV dword ptr [EAX*0x4 + 0x1cc5308],EDX ; 004cdad8
    MOV EDX,dword ptr [0x01c039c0]      ; 004cdadf | g_RelativeZ
    ...
    MOV EDX,dword ptr [0x01c039e8]      ; 004cdb13 | g_TransformMatrix
    MOV dword ptr [EAX*0x4 + 0x1cc5178],EDX ; 004cdb19
    MOV EDX,dword ptr [0x01c039ec]      ; 004cdb20 | g_TransformMatrix.m[0].y
    MOV dword ptr [EAX*0x4 + 0x1cc51a0],EDX ; 004cdb26
    MOV EDX,dword ptr [0x01c039f0]      ; 004cdb2d | g_TransformMatrix.m[0].z
    MOV dword ptr [EAX*0x4 + 0x1cc51c8],EDX ; 004cdb33
    MOV EDX,dword ptr [0x01c039f4]      ; 004cdb3a | g_TransformMatrix.m[1].x
    MOV dword ptr [EAX*0x4 + 0x1cc51f0],EDX ; 004cdb40
    MOV EDX,dword ptr [0x01c039f8]      ; 004cdb47 | g_TransformMatrix.m[1].y
    MOV dword ptr [EAX*0x4 + 0x1cc5218],EDX ; 004cdb4d
    MOV EDX,dword ptr [0x01c039fc]      ; 004cdb54 | g_TransformMatrix.m[1].z
    MOV dword ptr [EAX*0x4 + 0x1cc5240],EDX ; 004cdb5a
    MOV EDX,dword ptr [0x01c03a00]      ; 004cdb61 | g_TransformMatrix.m[2].x
    MOV dword ptr [EAX*0x4 + 0x1cc5268],EDX ; 004cdb67
    MOV EDX,dword ptr [0x01c03a04]      ; 004cdb6e | g_TransformMatrix.m[2].y
    MOV dword ptr [EAX*0x4 + 0x1cc5290],EDX ; 004cdb74
    MOV EDX,dword ptr [0x01c03a08]      ; 004cdb7b | g_TransformMatrix.m[2].z
