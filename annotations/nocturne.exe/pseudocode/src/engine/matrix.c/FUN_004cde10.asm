...
section .text
    ...
    PUSH EBX                            ; 004cde10
        ;   Label: engine_matrix.c_FUN_004cde10
    PUSH EDI                            ; 004cde11
    PUSH EBP                            ; 004cde12
    ...
    PUSH EAX                            ; 004cde31
    CALL engine_matrix.c_FUN_004cdd30   ; 004cde32
        ;   XREF to: 004cdd30 (UNCONDITIONAL_CALL)  ; undefined engine_matrix.c_FUN_004cdd30()
