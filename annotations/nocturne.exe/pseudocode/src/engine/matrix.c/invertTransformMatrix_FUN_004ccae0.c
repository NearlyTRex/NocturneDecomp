...

{
  ...
  fVar3 = (float)_DAT_01c039e8 * (float)1.52587890625e-05;
  fVar8 = (float)_DAT_01c039ec * (float)1.52587890625e-05;
  fVar9 = (float)_DAT_01c039f0 * (float)1.52587890625e-05;
  fVar11 = (float)_DAT_01c039f4 * (float)1.52587890625e-05;
  fVar4 = (float)_DAT_01c039f8 * (float)1.52587890625e-05;
  fVar5 = (float)_DAT_01c039fc * (float)1.52587890625e-05;
  fVar12 = (float)_DAT_01c03a00 * (float)1.52587890625e-05;
  fVar7 = (float)_DAT_01c03a04 * (float)1.52587890625e-05;
  fVar6 = (float)_DAT_01c03a08 * (float)1.52587890625e-05;
