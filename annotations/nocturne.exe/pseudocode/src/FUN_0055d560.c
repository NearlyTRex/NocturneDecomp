...
// Convention: unknown
// Signature: void FUN_0055d560(float param_1,float *param_2)
...

{
  ...
  fVar4 = (float10)fsin((float10)param_1 * (float10)_DAT_0059838e);
  fVar5 = (float10)fcos((float10)param_1 * (float10)_DAT_0059838e);
  fVar1 = *param_2;
  fVar2 = param_2[1];
  fVar3 = param_2[2];
