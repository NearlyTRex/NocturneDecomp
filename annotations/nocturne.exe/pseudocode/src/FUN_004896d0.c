...
// Convention: unknown
// Signature: void FUN_004896d0(float *param_1)
...

{
  ...
  if (0.0 < param_1[6]) {
    ...
    FUN_00530a25(uVar1,&local_1c);
    iVar2 = FUN_00461f80(DAT_005ae704,uVar1);
    if (iVar2 != 0) {
      iVar2 = FUN_00461090(DAT_005ae704);
      if (iVar2 == 0) {
        FUN_00447670(_DAT_007f7370,param_1,0);
      }
      FUN_0050adc0(0x01E57284,param_1,param_1 + 0xe,&DAT_02dd1184,&DAT_02dd1184,0);
      FUN_00460a00(DAT_005ae704,param_1);
      FUN_00460aa0(DAT_005ae704,param_1 + 0xe,0);
      FUN_00453040(param_1[0x15],0,0,0xffffffff);
