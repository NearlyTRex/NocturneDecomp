...
// Convention: unknown
// Signature: void FUN_004c1850(float *param_1)
...

{
  ...
  if (fVar1 != 0.0) {
    if ((param_1[0x117] != *(float *)((int)fVar1 + 0x560)) &&
       (iVar3 = FUN_0040d890(fVar1,_DAT_01cc36c0), iVar3 == 0)) {
  ...
  if ((*(int *)(0x01C775EC + 0x244) == 0) && (*(int *)(0x01C775EC + 0x240) == 0)) {
    ...
    if (0 < (int)param_1[2]) {
      do {
        iVar4 = FUN_0040d890(pfVar5[3],DAT_007646ac);
        if (iVar4 != 0) {
  ...
  if (0 < (int)param_1[2]) {
    do {
      iVar4 = FUN_0040d890(pfVar5[3],_DAT_01cc36c0);
