...
section .text
    ...
    PUSH ESI                            ; 00459fe4
        ;   Label: LAB_00459fe4
    PUSH EDI                            ; 00459fe5
    CALL FUN_0045a1a0                   ; 00459fe6
        ;   XREF to: 0045a1a0 (UNCONDITIONAL_CALL)  ; undefined FUN_0045a1a0()
    ...
    PUSH EAX                            ; 0045a17b
    MOV EDI,dword ptr [0x005b96c4]      ; 0045a17c | DAT_005b96c4
    PUSH EDI                            ; 0045a182
    CALL FUN_004b0200                   ; 0045a183
