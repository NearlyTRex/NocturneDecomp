...
// Convention: unknown
// Signature: int FUN_00476310(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6)
  ...
  if ((param_6 == 0) || (param_6 == 1)) {
    ...
    if (param_6 == 0) {
      ...
      if (0 < iVar2) {
        do {
          iVar3 = iVar4 + 1;
          iVar2 = FUN_00403bd0(iVar5,param_5,iVar4);
          param_5 = param_5 + 1;
          iVar4 = iVar3;
          iVar5 = iVar5 + -1;
        } while (iVar3 < iVar1);
    ...
    if (param_6 == 2) {
      ...
      if (0 < iVar2) {
        do {
          iVar3 = iVar4 + 1;
          iVar2 = FUN_00403ce0(param_5,iVar5,iVar4);
          param_5 = param_5 + 1;
          iVar4 = iVar3;
          iVar5 = iVar5 + -1;
        } while (iVar3 < iVar1);
