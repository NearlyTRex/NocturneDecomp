...
// Convention: unknown
// Signature: int FUN_0054e370(int param_1,byte param_2)
...

{
  ...
  if ((param_2 & 4) != 0) {
    uVar2 = FUN_0056445f(param_1,&DAT_005a3be0);
    FUN_00564486(uVar2);
    return param_1;
  }
  iVar1 = FUN_004e0070(param_1 + 0xbe16c,0);
  iVar1 = FUN_00435160(iVar1 + -0x3ab34,0);
