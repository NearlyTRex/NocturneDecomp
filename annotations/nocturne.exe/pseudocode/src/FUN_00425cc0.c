...
// Convention: unknown
// Signature: void FUN_00425cc0(int param_1)
...

{
  ...
  local_e0 = FUN_00461090(DAT_005ae704);
  if (local_e0 != 0) {
    return;
  }
  ...
  local_d8 = local_e0;
  local_d4 = local_e0;
  FUN_00461eb0(DAT_005ae704,&DAT_007658c4);
  iVar3 = 0;
  do {
    piVar2 = DAT_005ae704;
  ...
  local_30 = 0x28000;
  do {
    FUN_00461010(DAT_005ae704,local_30 / 5);
    iVar6 = 0;
    iVar3 = local_20;
    do {
      piVar2 = DAT_005ae704;
      ...
      *(uint *)(iVar6 + 0x28 + *piVar2) = 0;
      pfVar4 = (float *)FUN_0040a290(param_1,local_90,iVar3);
      if (&local_84 != pfVar4) {
        local_84 = *pfVar4;
        local_80 = pfVar4[1];
        local_7c = pfVar4[2];
      ...
      iVar3 = iVar3 + 0xc;
      FUN_0053075c(*DAT_005ae704 + iVar6,&local_78);
      iVar6 = iVar6 + 0x30;
    } while (iVar6 != 0x90);
    FUN_0045f3c0(DAT_005ae704,local_e8,0x267);
  ...
  local_28 = 0x28000;
  do {
    FUN_00461010(DAT_005ae704,local_28 / 5);
    iVar6 = 0;
    iVar3 = local_24;
    do {
      piVar2 = DAT_005ae704;
      ...
      *(uint *)(iVar6 + 0x28 + *piVar2) = 0xffff;
      pfVar4 = (float *)FUN_0040a290(param_1,local_9c,iVar3);
      if (&local_84 != pfVar4) {
        local_84 = *pfVar4;
        local_80 = pfVar4[1];
        local_7c = pfVar4[2];
      ...
      iVar3 = iVar3 + 0xc;
      FUN_0053075c(*DAT_005ae704 + iVar6,&local_6c);
      iVar6 = iVar6 + 0x30;
    } while (iVar6 != 0x90);
    FUN_0045f3c0(DAT_005ae704,local_e8,local_2c);
  ...
  do {
    ...
    local_18 = iVar12;
    FUN_0053075c(*DAT_005ae704 + iVar6,&local_60,fVar11,iVar12);
    piVar2 = DAT_005ae704;
    ...
    *(uint *)(iVar6 + 0x28 + *piVar2) = 0;
    ...
    FUN_0053075c(*piVar2 + iVar3,&local_b4);
    piVar2 = DAT_005ae704;
  ...
  FUN_0053075c(*DAT_005ae704,&local_c0);
  piVar2 = DAT_005ae704;
  ...
  *(uint *)(*piVar2 + 0x28) = 0;
  do {
    ...
    local_18 = iVar3;
    FUN_0053075c(*DAT_005ae704 + iVar6,&local_a8);
    piVar2 = DAT_005ae704;
  ...
  FUN_00461010(DAT_005ae704,0xffff,fVar11,iVar12,iVar3);
  return;
}
