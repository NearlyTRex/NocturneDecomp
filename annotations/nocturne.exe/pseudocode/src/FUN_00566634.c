...
// Convention: unknown
// Signature: uint FUN_00566634(int param_1,uint param_2,char *param_3,undefined4 *param_4)

#include "nocturne.h"

uint FUN_00566634(int param_1,uint param_2,char *param_3,uint *param_4)
