...
// Convention: unknown
// Signature: void FUN_0049f710(int param_1,int param_2)
...

{
  ...
  if (*(int *)(param_1 + 0x27c) == 0) {
    ...
    if (*(int *)(0x01E57284 + 0x15aabc) == _DAT_01c7841c) {
      local_3c = (float)*(int *)(param_1 + 0x9c) * (float)_DAT_00582a1a * (float)_DAT_00582a22 *
                 ((float)iVar3 / (float)iVar1);
      local_40 = (float)*(int *)(param_1 + 0xa0) * (float)_DAT_00582a1a *
                 ((float)iVar4 / (float)iVar2);
      if (local_3c < (float)_DAT_00582a2a) {
        local_3c = -1.0;
      }
      if (1.0 < local_3c) {
        local_3c = 1.0;
      }
      if (local_40 < (float)_DAT_00582a2a) {
        local_40 = -1.0;
      }
      if (1.0 < local_40) {
        local_40 = 1.0;
