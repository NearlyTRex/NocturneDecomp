...
section .text
    ...
    CMP dword ptr [0x01c03948],0x0      ; 004078a0 | DAT_01c03948
    ...
    CMP dword ptr [0x005b7624],0x20     ; 0040797b | DAT_005b7624
        ;   Label: LAB_0040797b
