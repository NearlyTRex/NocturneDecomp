...
section .text
    ...
    JZ 0x0056b280                       ; 0056b25b
        ;   XREF to: 0056b280 (CONDITIONAL_JUMP)  ; LAB_0056b280
    PUSH EBX                            ; 0056b25d
    CALL FUN_0056fd26                   ; 0056b25e
        ;   XREF to: 0056fd26 (UNCONDITIONAL_CALL)  ; undefined FUN_0056fd26()
