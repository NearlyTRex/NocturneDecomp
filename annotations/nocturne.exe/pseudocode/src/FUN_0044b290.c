...
// Convention: unknown
// Signature: float FUN_0044b290(int param_1,undefined4 param_2,undefined4 param_3,float *param_4,uint *param_5)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

float FUN_0044b290(int param_1,uint param_2,uint param_3,float *param_4,uint *param_5)

{
  ...
  if (0 < *(int *)(param_1 + 0x28)) {
    iVar5 = 0;
    do {
      local_18 = (float)FUN_00449150(*(int *)(param_1 + 0x2c) + iVar5,param_2,param_3);
