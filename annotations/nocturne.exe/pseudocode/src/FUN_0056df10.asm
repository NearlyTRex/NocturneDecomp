...
section .text
    ...
    PUSH EAX                            ; 0056df50
    CALL FUN_00567458                   ; 0056df51
        ;   XREF to: 00567458 (UNCONDITIONAL_CALL)  ; undefined FUN_00567458()
    MOV EBX,dword ptr [0x005c1cf0]      ; 0056df56 | DAT_005c1cf0
    ADD EBX,0x3                         ; 0056df5c
    ADD ESP,0x8                         ; 0056df5f
    AND BL,0xfc                         ; 0056df62
    CALL FUN_00571150                   ; 0056df65
