...
// Convention: unknown
// Signature: undefined4 FUN_004f1600(int param_1,float *param_2,undefined4 *param_3,undefined4 param_4)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_004f1600(int param_1,float *param_2,uint *param_3,uint param_4)

{
  ...
  if (((*(float *)(param_1 + 0x138c0) != *param_2) || (*(float *)(param_1 + 0x138c4) != param_2[1]))
    ...
    _DAT_01e312f4 = 1;
    do {
      iVar1 = FUN_004f0c20(param_1,param_2,param_1 + 0x138cc,param_4);
