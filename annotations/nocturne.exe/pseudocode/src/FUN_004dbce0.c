...
// Convention: unknown
// Signature: undefined4 FUN_004dbce0(int param_1,float param_2)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_004dbce0(int param_1,float param_2)
        ...
        *(float *)(param_1 + 0xbd2c) = param_2;
        ...
        if (iVar7 == 0) {
          ...
          for (local_1c = 0; local_1c < *(int *)(0x01E57284 + 0x14cd6c); local_1c = local_1c + 1)
          {
            ...
            if ((iVar4 == 0) && (iVar4 = FUN_0040d7e0(iVar1,"@CTommyGun" + 1), iVar4 != 0))
            {
          ...
          *(float *)(param_1 + 0xbd2c) = fVar2;
          if ((fVar2 < 0.0) &&
            ...
            uVar5 = FUN_00417fc0(auStack_80,auStack_38,auStack_74,auStack_44,&uStack_28);
            FUN_00417f60(uVar5);
            fStack_3c = fStack_78 + (float)_DAT_0058a3d9;
            FUN_0040a240(iVar7,auStack_50,auStack_44);
            uStack_68 = 0x3fc00000;
            uStack_64 = 0;
            uStack_60 = 0;
            iVar7 = FUN_004247f0(param_1,auStack_50,0,&uStack_68,0x3e99999a,0x3d0efa35);
          }
          if (-1 < iVar7) {
            if (iVar7 < 1) {
              return 1;
