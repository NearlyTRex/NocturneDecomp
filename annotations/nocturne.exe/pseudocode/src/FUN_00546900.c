...
// Convention: unknown
// Signature: void FUN_00546900(int param_1)
...

{
  ...
  if (*(int *)(param_1 + 0x2cc) == 0) {
    ...
    for (iVar2 = 0; iVar2 < *(int *)(0x01E57284 + 0x150bf4); iVar2 = iVar2 + 1) {
      iVar1 = FUN_0040d890(*(uint *)(iVar3 + 0x150bf8 + 0x01E57284),_DAT_02de07c4);
      if ((iVar1 != 0) && (*(int *)(iVar1 + 0xbd50) == 0)) {
        FUN_00511990(auStack_5c);
        ...
        if ((*(float *)(iVar1 + 0x24) <= *(float *)(param_1 + 0x24) + fStack_24) &&
          ...
          FUN_0040a290(param_1,afStack_1c,iVar1 + 0x20);
