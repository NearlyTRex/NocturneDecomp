...
// Convention: unknown
// Signature: void FUN_00456b20(int param_1,undefined4 param_2,uint param_3,int *param_4)

#include "nocturne.h"

void FUN_00456b20(int param_1,uint param_2,uint param_3,int *param_4)
