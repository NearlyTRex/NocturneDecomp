...
// Convention: unknown
// Signature: undefined4 FUN_004b5950(int param_1)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_004b5950(int param_1)
  ...
  *(uint *)(param_1 + 0x1fa1c) = 0;
  ...
  do {
    if (*(int *)(0x01E57284 + 0x14cd6c) <= local_18) {
      iVar3 = FUN_0040d7e0(*(uint *)(local_20 + 0x334),"@CTrap" + 1);
      if (iVar3 != 0) {
        *(uint *)(param_1 + 0x1fa1c) = *(uint *)(local_20 + 0x334);
      }
      return 0;
    }
    iVar1 = FUN_0040d890(*(uint *)(iVar3 + 0x14cd70 + 0x01E57284),_DAT_014b8a54);
    local_14 = iVar1;
    if (iVar1 != 0) {
      iVar2 = FUN_0044bab0(iVar1,*(uint *)(local_20 + 0x334));
      if (iVar2 != 0) {
        local_1c = (uint *)(iVar1 + 0x20);
        FUN_0040a290(param_1,&local_3c,local_1c);
        ...
        if ((((1.0 <= local_30) && (local_30 <= ram0x005858b3)) &&
          ...
          iVar2 = FUN_0054e4a0(local_48,&local_3c);
