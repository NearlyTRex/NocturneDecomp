...
section .text
    ...
    PUSH EBX                            ; 00535812
    CALL FUN_00535900                   ; 00535813
        ;   XREF to: 00535900 (UNCONDITIONAL_CALL)  ; undefined FUN_00535900()
    ADD ESP,0x8                         ; 00535818
    PUSH dword ptr [ESP + 0x4]          ; 0053581b
    PUSH EBX                            ; 0053581f
    CALL FUN_00535900                   ; 00535820
        ;   XREF to: 00535900 (UNCONDITIONAL_CALL)  ; undefined FUN_00535900()
    ADD ESP,0x8                         ; 00535825
    PUSH dword ptr [ESP + 0x4]          ; 00535828
    PUSH EBX                            ; 0053582c
    CALL FUN_00535900                   ; 0053582d
        ;   XREF to: 00535900 (UNCONDITIONAL_CALL)  ; undefined FUN_00535900()
    ADD ESP,0x8                         ; 00535832
    PUSH dword ptr [ESP + 0x4]          ; 00535835
    PUSH EBX                            ; 00535839
        ;   Label: LAB_00535839
    CALL FUN_00535900                   ; 0053583a
        ;   XREF to: 00535900 (UNCONDITIONAL_CALL)  ; undefined FUN_00535900()
