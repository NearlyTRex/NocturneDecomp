...
section .text
    ...
    PUSH EBX                            ; 0051e99d
    PUSH ESI                            ; 0051e99e
    CALL FUN_0051e020                   ; 0051e99f
        ;   XREF to: 0051e020 (UNCONDITIONAL_CALL)  ; undefined FUN_0051e020()
    ADD ESP,0x4                         ; 0051e9a4
    PUSH EAX                            ; 0051e9a7
    CALL FUN_0051a470                   ; 0051e9a8
        ;   XREF to: 0051a470 (UNCONDITIONAL_CALL)  ; undefined FUN_0051a470()
