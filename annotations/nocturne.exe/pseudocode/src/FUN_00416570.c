...
// Convention: unknown
// Signature: int FUN_00416570(int param_1)
...

{
  ...
  FUN_0040c900(param_1 + 0x16c,"vertexCount");
  FUN_0040c900(param_1 + 0x178,"triCount");
  iVar4 = FUN_0040c900(param_1 + 0x184,"textureCount");
  if (DAT_00763e88 == 1) {
    FUN_00415ee0(param_1,*(uint *)(param_1 + 0x16c),*(uint *)(param_1 + 0x178));
    iVar4 = 0;
    if (0 < *(int *)(param_1 + 0x16c)) {
      ...
      do {
        ...
        iVar4 = iVar4 + 1;
        iVar5 = iVar5 + 0xc;
        FUN_00563350(DAT_00763e84,"%d,%d,%d\n",iVar6,iVar6 + 4,iVar6 + 8);
    ...
    if (0 < *(int *)(param_1 + 0x178)) {
      ...
      do {
        ...
        iVar4 = iVar4 + 0x3c;
        FUN_00563350(DAT_00763e84,"\t\t%d, %d,%d,%d, %d,%d,%d, %d,%d,%d\n",
    ...
    if (0 < *(int *)(param_1 + 0x184)) {
      ...
      do {
        iVar4 = iVar4 + 1;
        FUN_00563350(DAT_00763e84," \"%[^\"]\"\n",iVar5);
        iVar5 = iVar5 + 0x18;
      } while (iVar4 < *(int *)(param_1 + 0x184));
    }
    iVar4 = FUN_00416d40(param_1);
  }
  else {
    iVar5 = 0;
    if (0 < *(int *)(param_1 + 0x16c)) {
      ...
      do {
        ...
        iVar6 = iVar6 + 0xc;
        iVar5 = iVar5 + 1;
        FUN_005644f0(DAT_00763e84,"\t%d,%d,%d\n",*puVar1,*(uint *)(iVar2 + iVar3),
                     *(uint *)(iVar4 + iVar3));
    ...
    if (0 < *(int *)(param_1 + 0x178)) {
      ...
      do {
        ...
        iVar4 = FUN_005644f0(DAT_00763e84,"\t%d, %d,%d,%d, %d,%d,%d, %d,%d,%d\n",
    ...
    if (0 < *(int *)(param_1 + 0x184)) {
      ...
      do {
        iVar5 = iVar5 + 1;
        iVar4 = FUN_005644f0(DAT_00763e84,"\t\"%s\"\n",iVar6);
        iVar6 = iVar6 + 0x18;
  ...
  if (1 < 0x00000005) {
    ...
    iVar4 = FUN_0040c980(param_1 + 0xf10,"carriedByActor");
  }
  if (2 < 0x00000005) {
    FUN_0040c900(param_1 + 0xca0,"bloodType");
    FUN_0040c900(param_1 + 0xc98,"dontUseNormals");
    iVar4 = FUN_0040c900(param_1 + 0xc9c,"transparentGeometryFlag");
  }
  if (3 < 0x00000005) {
    iVar4 = FUN_0040c900(param_1 + 0x150,"renderInBackground");
  }
  if (4 < 0x00000005) {
    iVar4 = FUN_0040c900(param_1 + 0xcac,"dontPickMeUp");
    return iVar4;
  }
  return iVar4;
}
