...
// Convention: unknown
// Signature: int FUN_004b5d00(int param_1,float *param_2)
...

{
  ...
  *param_2 = 9999.9;
  ...
  for (iVar4 = 0; iVar4 < *(int *)(0x01E57284 + 0x150bf4); iVar4 = iVar4 + 1) {
    ...
    iVar2 = FUN_0040d890(iVar1,_DAT_02dd11c8);
    if (iVar2 == 0) {
      iVar2 = FUN_0040d890(iVar1,_DAT_01ccdc10);
      if ((iVar2 == 0) || (*(int *)(iVar2 + 0xbd48) == 0)) {
        iVar2 = (**(code **)(*(int *)(iVar1 + 0x14c) + 0x104))(iVar1);
        if (iVar2 == 0) {
          iVar2 = (**(code **)(*(int *)(iVar1 + 0x14c) + 0x68))(iVar1);
          if (iVar2 == 0) {
            FUN_005644a7(auStack_a8,10,&DAT_005993b0);
