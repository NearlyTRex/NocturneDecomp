...
;   undefined1* PTR_FUN_005a37b4 = 005495f0
;
; Called Functions:
;   FUN_0040a240
;   FUN_00454490
...
section .text
    ...
    PUSH EAX                            ; 005494d2
    MOV dword ptr [EBX + 0x14c],0x5a37b4 ; 005494d3 | PTR_FUN_005a37b4
    CALL FUN_00454580                   ; 005494dd
