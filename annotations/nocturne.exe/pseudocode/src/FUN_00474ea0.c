...
// Convention: unknown
// Signature: undefined4 FUN_00474ea0(int *param_1)

#include "nocturne.h"

uint FUN_00474ea0(int *param_1)

{
  ...
  if ((iVar3 != 0) && (iVar3 = FUN_00476040(param_1,param_1[0x46]), iVar3 != 0)) {
LAB_0047509f:
    param_1[0x43] = 1;
    return 0;
  }
  ...
  do {
    do {
      while( true ) {
        ...
        for (iVar8 = 0; (cVar2 != '\0' && (iVar8 < *param_1)); iVar8 = iVar8 + 1) {
          iVar5 = FUN_00565e20((char)piVar7[5]);
          if (iVar5 == iVar3) {
            param_1[0x46] = iVar8;
            FUN_00475db0(param_1);
            iVar5 = FUN_00476040(param_1,param_1[0x46]);
    ...
    uVar4 = FUN_00474080(param_1,param_1[0x46]);
    iVar3 = FUN_00564520(piVar1,uVar4);
    if (iVar3 < 1) {
      param_1[0x46] = 0;
    }
