...
// Convention: unknown
// Signature: void FUN_004d0080(void)
...

{
  ...
  iVar4 = FUN_004568c0(&DAT_0058869e,"tridx6.dll");
  bVar2 = false;
  iVar7 = FUN_004568c0(&DAT_005886ab,"tri3dfx.dll");
  if (iVar4 == iVar7) {
    bVar2 = true;
  }
  do {
    ...
    if ((0 < _DAT_01cc64a8) && (_DAT_02dc9d60 != 0)) {
      if ((*(int *)(&DAT_01cc652c + _DAT_01cc64a4 * 4) == 0x121a) &&
        ...
        *puVar3 = 0x280;
        puVar3[1] = 0x1e0;
        iVar7 = FUN_00564520(&DAT_005c0e80,"tri3dfx.dll");
        iVar4 = _DAT_01cc64a8;
        if (iVar7 != 0) {
          pcVar9 = &DAT_005886b8;
...
LAB_004d0249:
    ...
    uVar5 = FUN_004ee370(pcVar9);
    FUN_00563c90(0x1cc5b80,uVar5);
    uVar8 = 0x01C775EC[3];
    if (uVar8 == 0) {
      pcVar9 = "Flashlight halo : Off";
LAB_004d039c:
      uVar5 = FUN_004ee370(pcVar9);
      FUN_00563c90(0x1cc5c80,uVar5);
    }
    else {
      if (uVar8 < 2) {
    ...
    uVar5 = FUN_004ee370(pcVar9);
    FUN_00563c90(0x1cc5d80,uVar5);
    iVar4 = FUN_00564520(&DAT_005c0e80,"trid3d.dll");
    if (iVar4 == 0) {
      pcVar9 = "3D API : DirectX 5";
    }
    else {
      iVar4 = FUN_00564520(&DAT_005c0e80,"tridx6.dll");
      if (iVar4 == 0) {
        pcVar9 = "3D API : DirectX 6";
      }
      else {
        iVar4 = FUN_00564520(&DAT_005c0e80,"tridx7.dll");
        if (iVar4 == 0) {
          pcVar9 = "3D API : DirectX 7";
        }
        else {
          iVar4 = FUN_00564520(&DAT_005c0e80,"tri3dfx.dll");
          if (iVar4 == 0) {
            if (bVar2) {
              pcVar9 = "3D API : DirectX 6";
            }
    ...
    uVar5 = FUN_004ee370(pcVar9);
    FUN_00563c90(0x1cc5e80,uVar5);
    if (_DAT_01cc64a8 == 0) {
      uVar5 = FUN_004ee370("No 3D Hardware detected");
      FUN_00563c90(&DAT_01cc5f80,uVar5);
    }
    else {
      pcVar9 = (char *)FUN_004ee370("3D Card : ");
    ...
    pcVar9 = (char *)FUN_004ee370("Bits per pixel : ");
    ...
    FUN_00563c90(local_120,&DAT_00588902,0x01C775EC[2]);
    iVar4 = -1;
    pcVar9 = &DAT_01cc6080;
    do {
      pcVar11 = pcVar9;
    ...
    uVar5 = FUN_004ee370("Monitor calibration");
    FUN_00563c90(0x1cc6180,uVar5);
    if (0x01C775EC[4] == 0) {
    ...
    pcVar10 = (char *)FUN_004ee370(pcVar10);
    pcVar9 = &DAT_01cc6280;
    do {
      cVar1 = *pcVar10;
      *pcVar9 = cVar1;
    ...
    if (0x01C775EC[8] == 0) {
      if (0x01C775EC[6] == 0) {
        pcVar10 = (char *)FUN_004ee370("Rating: Teen");
        pcVar9 = &DAT_01cc6380;
        do {
          cVar1 = *pcVar10;
          *pcVar9 = cVar1;
        ...
        pcVar10 = (char *)FUN_004ee370("Rating: Mature");
        pcVar9 = &DAT_01cc6380;
        do {
          cVar1 = *pcVar10;
          *pcVar9 = cVar1;
    ...
    uVar6 = FUN_004ee370("Graphic Options");
    uVar5 = FUN_004cf440(0x1cc6480,uVar5,&local_20,0xfa,uVar6);
    FUN_00553910();
    iVar4 = FUN_00564520(&DAT_005c0e80,"trid3d.dll");
    puVar3 = 0x01C775EC;
    bVar13 = iVar4 != 0;
