...
section .text
    ...
    PUSH ECX                            ; 005091b4
    CALL FUN_005119b0                   ; 005091b5
        ;   XREF to: 005119b0 (UNCONDITIONAL_CALL)  ; undefined FUN_005119b0()
    ...
    PUSH EDX                            ; 0050943f
    CALL FUN_0048c160                   ; 00509440
        ;   XREF to: 0048c160 (UNCONDITIONAL_CALL)  ; undefined FUN_0048c160()
