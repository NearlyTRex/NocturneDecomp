...
// Convention: unknown
// Signature: void FUN_0042f190(int param_1,short *param_2,int param_3,int param_4,int param_5,int param_6)
...

{
  ...
  if ((param_1 != 0) && (iVar2 = 0, 0 < param_3)) {
    do {
      ...
      FUN_0042f330(*param_2 + param_4,param_2[1] + param_5,param_2[2] + param_4,iVar1 + param_5,
