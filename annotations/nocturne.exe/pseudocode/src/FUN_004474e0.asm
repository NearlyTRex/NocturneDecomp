...
;
; XREF[2]:
;   FUN_005084c0 at 0050852b
;   FUN_005088f0 at 00508ab9
;
; Referenced Globals:
...
section .text
    ...
    PUSH EAX                            ; 00447529
    CALL FUN_00532af0                   ; 0044752a
        ;   XREF to: 00532af0 (UNCONDITIONAL_CALL)  ; undefined FUN_00532af0()
    ...
    FXCH ST3                            ; 00447555
    CALL FUN_00563a30                   ; 00447557
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH ST2                            ; 0044755c
    CALL FUN_00563a30                   ; 0044755e
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH                                ; 00447563
    CALL FUN_00563a30                   ; 00447565
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH ST3                            ; 0044756a
    CALL FUN_00563a30                   ; 0044756c
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH ST4                            ; 00447571
    CALL FUN_00563a30                   ; 00447573
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH ST2                            ; 00447578
