...
// Convention: unknown
// Signature: void FUN_0046edc0(int param_1,float param_2)
    ...
    *(float *)(param_1 + 0x570) = fVar1;
    ...
    if (fVar1 < 0.0) {
      *(uint *)(param_1 + 0x570) = 0;
      FUN_0052ebb0(uVar2,*(uint *)(param_1 + 0x580));
      *(uint *)(param_1 + 0x580) = 0;
    }
    else {
      iVar3 = FUN_0040dea0((param_2 * (float)_DAT_0057e4ee * fVar1) / _DAT_0059c91c);
      if (iVar3 != 0) {
        ...
        pfVar4 = (float *)FUN_0040a240(param_1,auStack_18,&fStack_30);
        if (&fStack_30 != pfVar4) {
          fStack_30 = *pfVar4;
          fStack_2c = pfVar4[1];
          fStack_28 = pfVar4[2];
        }
        FUN_0048ae90(0x01C08D04,&fStack_30,0,0x4000,0x10000,0,0xffff);
        return;
      }
    }
  }
