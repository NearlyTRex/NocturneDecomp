...

{
  ...
  if ((*(int *)(param_1 + 0xcc) != 0) || (*(int *)(0x01CEA280 + 0x168) != 0)) {
    *(uint *)(param_1 + 0x1fc) = 0;
    FUN_004ed720(iVar4);
    FUN_004a6010(param_1);
    if (*(int *)(param_1 + 0xcc) == 0) {
      FUN_0049a8a0(param_1);
    }
    else {
      FUN_004a5f00(param_1,0x3e800000);
    }
  ...
  if (*(int *)(param_1 + 0x1fc) == 0) {
    ...
    FUN_0051f980(&local_b0);
    iVar4 = *(int *)(_DAT_01cae0e8 * 4 + 0x1cae0d8);
    (**(code **)(*(int *)(iVar4 + 0x14c) + 0x60))(iVar4,&local_b0,&local_a4);
    if ((DAT_01bd1d94 & 1) != 0) {
      FUN_004410c0(0x1fb8508,_DAT_01bd1d8c,_DAT_01bd1d90);
      ...
      FUN_004411b0(0x1fb8508,puVar14);
      local_7c = local_94;
  ...
  if (*(int *)(param_1 + 0x210) == 0) {
    uVar5 = FUN_004ee3f0(&DAT_005825f0);
    iVar4 = FUN_00566e10(uVar5);
...
LAB_0049cf70:
    ...
    if (iVar4 != 0) {
      ...
      FUN_00563c90(0x1c780c0,"demon%d.pcx",_DAT_01c780b8);
  ...
  if (_DAT_01c78ac8 != 0) {
    ...
    if ((_DAT_01c78ad0 < 1) || (_DAT_01c78ad4 < _DAT_01c78ad0)) {
      if (_DAT_01c78acc != 0) {
        FUN_00563c90(local_114,"noc%05d.raw",_DAT_01c78ad4);
        FUN_00563c90(local_1dc,"Movie recording active: movie\\%s",local_114);
        local_34 = FUN_00456a60("movie",local_114,&DAT_005823b3);
        if (local_34 != 0) {
          local_38 = 0;
          if (0 < 0x00000040) {
            do {
              ...
              if (0 < 0x00000040) {
                ...
                do {
                  ...
                  FUN_00566cc0(iVar11 / local_18,local_34);
                  FUN_00566cc0(local_1c,iVar4);
                  FUN_00566cc0(iVar10,iVar4);
                  local_30 = local_30 + 1;
          ...
          FUN_00563380(local_34);
          FUN_00402600(local_1dc,0,0);
  ...
  FUN_0049ab50(param_1);
  FUN_004a3960(param_1);
  if (*(int *)(param_1 + 0x1e4) == 0) {
    _DAT_01c71e30 = 0.0;
    _DAT_01c71e38 = 0;
  }
  else {
    FUN_00563c90(local_2dc,"Camera: \"%s\" Group %d",0x1fb8508,
                 *(uint *)(0x01E57284 + 0x14c + *(int *)(0x01E57284 + 0x15aabc) * 0x1a0));
    FUN_00402600(local_2dc,0,DAT_005b7620 + -0x16);
    _DAT_01c71e38 = _DAT_01c71e38 + 1;
    _DAT_01c71e30 = _DAT_01c71e30 + (double)*(float *)(param_1 + 0x264);
    FUN_00563c90(local_2dc,"FR: %f, AVG: %f, PC: %d",
                 1.0 / (double)*(float *)(param_1 + 0x264),(double)_DAT_01c71e38 / _DAT_01c71e30,
                 _DAT_01e52ef8);
    FUN_00402600(local_2dc,0,DAT_005b7620 + -0xb);
    iVar4 = *(int *)(_DAT_01cae0e8 * 4 + 0x1cae0d8);
    FUN_00563c90(local_2dc,"Hero : %4.2f,%4.2f,%4.2f xyz and %3.2f,%3.2f,%3.2f pbh",
    ...
    FUN_00402600(local_2dc,0,0);
    FUN_00563c90(local_2dc,"Slew : %s, Virtual Director : %s",
                 (&PTR_DAT_005b9358)[*(int *)(param_1 + 0x1fc)],
                 (&PTR_DAT_005b9358)[*(int *)(param_1 + 0x274)]);
    FUN_00402600(local_2dc,0,0xb);
    pfVar2 = *(float **)(param_1 + 0x9bc);
    if (pfVar2 != (float *)0x0) {
      FUN_00563c90(local_2dc,"Fudge: %g,%g,%g",(double)*pfVar2,(double)pfVar2[1],
                   (double)pfVar2[2]);
      FUN_00402600(local_2dc,0,DAT_005b7620 + -0x4d);
    }
    FUN_00527c70(&local_5c,&local_58,&local_54,&local_50,local_4c,&local_48);
    local_14 = local_58;
    uVar5 = FUN_005275e0(local_5c,(double)local_58 * _DAT_00582762,local_54,
                         (double)local_50 * _DAT_00582762,
                         (double)(local_58 + local_50) * _DAT_00582762,
                         (double)local_48 * _DAT_00582762);
    FUN_00563c90(local_2dc,"SFX: %d Samples: Active: %d/%.1fk Avail: %d/%.1fk Total alloc: %.1fk Free: %.1fk",uVar5);
    FUN_00402600(local_2dc,0,DAT_005b7620 + -0x42);
    FUN_00545a80(local_2dc);
    FUN_00402600(local_2dc,0,DAT_005b7620 + -0x37);
    FUN_0051f760(local_2dc);
    FUN_00402600(local_2dc,0,DAT_005b7620 + -0x2c);
    FUN_00402600(param_1 + 0xd0,0,DAT_005b7620 + -0x21);
  }
  if (_DAT_01c78ad8 != 0) {
    iVar6 = FUN_005274e0();
    iVar4 = 0x37;
    for (; iVar6 != 0; iVar6 = FUN_00527520(iVar6)) {
      FUN_00525b70(local_604);
      iVar7 = FUN_00526cd0(iVar6,local_604);
      if (iVar7 != 0) {
  ...
  if (*(int *)(param_1 + 0x1f8) != 0) {
    FUN_004736d0(0x01BCD074,local_3dc);
    FUN_00402600(local_3dc,0,DAT_005b7620 + -0x42);
  }
  iVar4 = *(int *)(_DAT_01cae0e8 * 4 + 0x1cae0d8);
  iVar4 = (**(code **)(*(int *)(iVar4 + 0x14c) + 0x104))(iVar4);
  if (iVar4 == 2) {
    pcVar8 = (char *)FUN_004ee370("You're dead.  Game over.");
    pcVar12 = local_4dc;
    do {
      cVar1 = *pcVar8;
      *pcVar12 = cVar1;
    ...
    FUN_00490de0(_DAT_014b98f8,0,DAT_005b761c,DAT_005b7620 + *(int *)(_DAT_014b98f8 + 0x316c) * -2,
                 DAT_01bff320,0,local_4dc);
  }
  if (*(int *)(param_1 + 0xac8) != 0) {
    FUN_0049b4e0(param_1);
  }
  if (*(int *)(param_1 + 0x280) != 0) {
    FUN_0043aec0(PTR_DAT_005ad350);
  }
  if (0 < _DAT_01c78424) {
    FUN_004759d0(&DAT_01c78424);
  }
  if (*(int *)(param_1 + 0x1fc) != 0) {
    FUN_004724e0(0x01BCD074,0);
  }
  FUN_00532320();
LAB_0049d5b0:
  if (local_40 == 0) {
