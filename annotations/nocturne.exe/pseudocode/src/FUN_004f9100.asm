...
section .text
    ...
    PUSH EAX                            ; 004f912d
    CALL FUN_004f8240                   ; 004f912e
        ;   XREF to: 004f8240 (UNCONDITIONAL_CALL)  ; undefined FUN_004f8240()
