...
section .text
    ...
    PUSH EDX                            ; 00547b9f
    PUSH ESI                            ; 00547ba0
    CALL FUN_005487b0                   ; 00547ba1
        ;   XREF to: 005487b0 (UNCONDITIONAL_CALL)  ; undefined FUN_005487b0()
    ...
    MOV EDI,dword ptr [0x01c7070c]      ; 00547ebc | DAT_01c7070c
