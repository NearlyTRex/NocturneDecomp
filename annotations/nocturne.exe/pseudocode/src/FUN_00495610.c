...
// Convention: unknown
// Signature: float FUN_00495610(undefined4 param_1,undefined4 param_2,float param_3,int param_4)

#include "nocturne.h"

float FUN_00495610(uint param_1,uint param_2,float param_3,int param_4)
