...
// Convention: unknown
// Signature: void FUN_00422c70(int param_1,int param_2,float param_3)
...

{
  ...
  if (*(int *)(param_2 + 0x2c) < 0) {
    ...
    FUN_0055a910(&local_6c,param_1 + 0x12968);
    iVar9 = FUN_004227b0(param_1,param_2,param_3,&local_6c);
    if (iVar9 != 0) {
    ...
    puVar6 = (uint *)FUN_0055a8b0(local_a8,&local_3c,param_1 + 0x12968);
    ...
    iVar7 = FUN_0051e020(*(uint *)(param_1 + 0x12964));
    ...
    local_e4 = local_b8;
    local_e0 = local_d0;
    puVar6 = (uint *)FUN_0044dbd0(&local_100,local_48);
