...
// Convention: unknown
// Signature: void FUN_00488430(float *param_1)
  ...
  *param_1 = fVar3 - fVar4;
  if (0.0 < fVar3 - fVar4) {
    ...
    *pfVar1 = *pfVar1 * _DAT_005813ac;
    ...
    iVar7 = FUN_0040dea0(fVar4 * fVar3);
    if (iVar7 != 0) {
      FUN_0048afe0(0x01C08D04,pfVar2,0x3f000000,0,0xffff);
    }
    if ((param_1[8] != 0.0) && (iVar7 = FUN_0040dea0(fVar4), iVar7 != 0)) {
      FUN_004880d0(param_1);
    }
