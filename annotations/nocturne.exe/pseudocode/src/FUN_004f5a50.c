...
// Convention: unknown
// Signature: void FUN_004f5a50(int *param_1,undefined4 param_2,int param_3)

#include "nocturne.h"

void FUN_004f5a50(int *param_1,uint param_2,int param_3)
...
LAB_004f5ad2:
    if (piVar3 != (int *)0x0) {
      ...
      if (iVar1 == 0) {
        FUN_004f5740(param_1,param_2,param_3);
        return;
      }
      iVar1 = _stricmp(piVar3,".pbg");
      if (iVar1 == 0) {
        FUN_004f5a20(param_1,param_2,param_3);
        return;
      }
    }
  }
