...
section .text
    ...
    POP EBX                             ; 00528eae
    RET                                 ; 00528eaf
    CALL FUN_00528620                   ; 00528eb0
        ;   XREF to: 00528620 (UNCONDITIONAL_CALL)  ; undefined FUN_00528620()
        ;   Label: LAB_00528eb0
