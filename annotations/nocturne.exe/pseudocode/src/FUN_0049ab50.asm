...
section .text
    ...
    CALL FUN_004fe710                   ; 0049abfb
        ;   XREF to: 004fe710 (UNCONDITIONAL_CALL)  ; undefined FUN_004fe710()
    ADD ESP,0x4                         ; 0049ac00
    MOV EDX,dword ptr [0x005be220]      ; 0049ac03 | DAT_005be220
    PUSH EDX                            ; 0049ac09 | DAT_01e56da0
    CALL FUN_004fe710                   ; 0049ac0a
        ;   XREF to: 004fe710 (UNCONDITIONAL_CALL)  ; undefined FUN_004fe710()
    ...
    PUSH ECX                            ; 0049ae36
    PUSH EBX                            ; 0049ae37
    CALL FUN_00403ef0                   ; 0049ae38
        ;   XREF to: 00403ef0 (UNCONDITIONAL_CALL)  ; undefined FUN_00403ef0()
