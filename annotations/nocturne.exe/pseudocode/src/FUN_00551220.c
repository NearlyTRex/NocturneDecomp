...
// Convention: unknown
// Signature: int FUN_00551220(undefined4 param_1)

#include "nocturne.h"

int FUN_00551220(uint param_1)

{
  ...
  iVar2 = FUN_005644a7(iVar2 + 0x294,1000,&DAT_005a3fd0);
  *(byte ***)(iVar2 + -0x148) = &PTR_FUN_005a3ef4;
