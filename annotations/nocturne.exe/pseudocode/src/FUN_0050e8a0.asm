...
;
; Referenced Globals:
;   undefined4 s_//_Set_state_version_00590881+1
;   undefined4 DAT_00590898
;   string s_//_Camera_count,_enabled_list_0059089b
;   undefined4 DAT_005908ba
;   undefined4 DAT_005908be
;
; Called Functions:
;   FUN_005644f0
;
...
section .text
    ...
    PUSH 0x590882                       ; 0050e8ab | s_//_Set_state_version_00590881+1
    PUSH EDI                            ; 0050e8b0
    CALL FUN_005644f0                   ; 0050e8b1
        ;   XREF to: 005644f0 (UNCONDITIONAL_CALL)  ; undefined FUN_005644f0()
    ADD ESP,0x8                         ; 0050e8b6
    PUSH 0x590898                       ; 0050e8b9 | DAT_00590898
    PUSH EDI                            ; 0050e8be
    CALL FUN_005644f0                   ; 0050e8bf
        ;   XREF to: 005644f0 (UNCONDITIONAL_CALL)  ; undefined FUN_005644f0()
    ADD ESP,0x8                         ; 0050e8c4
    PUSH 0x59089b                       ; 0050e8c7 | = "// Camera count, enabled list\n"
    PUSH EDI                            ; 0050e8cc
    CALL FUN_005644f0                   ; 0050e8cd
        ;   XREF to: 005644f0 (UNCONDITIONAL_CALL)  ; undefined FUN_005644f0()
    ADD ESP,0x8                         ; 0050e8d2
    MOV EDX,dword ptr [EBP]             ; 0050e8d5
    PUSH EDX                            ; 0050e8d8
    PUSH 0x5908ba                       ; 0050e8d9 | DAT_005908ba
    PUSH EDI                            ; 0050e8de
    XOR EBX,EBX                         ; 0050e8df
    CALL FUN_005644f0                   ; 0050e8e1
        ;   XREF to: 005644f0 (UNCONDITIONAL_CALL)  ; undefined FUN_005644f0()
    ...
    MOV EAX,dword ptr [ESI + 0x1a0]     ; 0050e8f3
        ;   Label: LAB_0050e8f3
    PUSH EAX                            ; 0050e8f9
    PUSH 0x5908be                       ; 0050e8fa | DAT_005908be
    PUSH EDI                            ; 0050e8ff
    ADD ESI,0x1a0                       ; 0050e900
    INC EBX                             ; 0050e906
    CALL FUN_005644f0                   ; 0050e907
        ;   XREF to: 005644f0 (UNCONDITIONAL_CALL)  ; undefined FUN_005644f0()
