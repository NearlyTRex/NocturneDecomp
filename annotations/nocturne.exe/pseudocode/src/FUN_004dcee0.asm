...
section .text
    ...
    PUSH EBP                            ; 004dcef9
    CALL FUN_0041a570                   ; 004dcefa
        ;   XREF to: 0041a570 (UNCONDITIONAL_CALL)  ; undefined FUN_0041a570()
