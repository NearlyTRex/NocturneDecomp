...
// Convention: unknown
// Signature: void FUN_004af730(int param_1,undefined4 *param_2,undefined4 param_3)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_004af730(int param_1,uint *param_2,uint param_3)

{
  ...
  *(uint *)(param_1 + 4) = *param_2;
  uVar2 = FUN_0050ec80(uVar2,param_2,0);
