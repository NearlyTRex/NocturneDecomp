...
section .text
    ...
    MOV EDX,dword ptr [0x005c216c]      ; 00572ec7 | PTR_FUN_005c216c
    MOV [0x005c216c],EAX                ; 00572ecd | PTR_FUN_005c216c
    ...
    MOV EDX,dword ptr [0x005c2170]      ; 00572eda | PTR_FUN_005c2170
    MOV [0x005c2170],EAX                ; 00572ee0 | PTR_FUN_005c2170
