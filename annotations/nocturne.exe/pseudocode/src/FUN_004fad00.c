...
// Convention: unknown
// Signature: void FUN_004fad00(int *param_1,int param_2)
...

{
  ...
  if (DAT_006b0280 != 0) {
    ...
    piVar8 = param_1 + 0x18;
    if (param_2 < 4) {
      iVar7 = FUN_004f9a10(param_1,piVar3,piVar8);
      if (iVar7 == 0) {
        return;
      }
    }
      ...
      if (0 < iVar7) {
        do {
          iVar2 = FUN_004f9a10(param_1,piVar3,piVar8);
          if (iVar2 == 0) {
            iVar6 = iVar6 + 1;
          }
          piVar3 = piVar3 + 0xc;
      ...
      do {
        ...
        if (piVar3[1] <= local_18) {
          *piVar3 = -1;
          ...
          if (0 < iVar7) {
            do {
              if ((local_18 == *piVar3) && (piVar3 != local_14)) goto LAB_004faf43;
              iVar6 = iVar6 + 1;
              piVar3 = piVar3 + 0x12;
...
LAB_004faf43:
        ...
        if (local_14[1] <= local_18) {
          *local_14 = -1;
          ...
          while ((local_18 != *local_14 || (local_14 == piVar3))) {
            iVar6 = iVar6 + 1;
            local_14 = local_14 + 0x12;
            if (_DAT_01e52efc <= iVar6) {
              return;
            }
          }
          if (local_14 == (int *)0x0) {
