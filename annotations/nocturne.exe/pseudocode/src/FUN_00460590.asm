...
section .text
    ...
    MOV ECX,0x463a79                    ; 00460605 | LAB_00463a79
    ...
    MOV dword ptr [0x01c00c7c],0x52f031 ; 00460660 | DAT_01c00c7c | LAB_0052f031
    ...
    MOV dword ptr [0x01c00c7c],0x52f823 ; 004606c6 | DAT_01c00c7c | LAB_0052f823
        ;   Label: LAB_004606c6
