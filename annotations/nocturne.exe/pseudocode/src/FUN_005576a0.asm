...
;
; Referenced Globals:
;   undefined4 DAT_00597e35
;   undefined4 DAT_00597e39
...
section .text
    ...
    FLD float ptr [EBX + 0xbd68]        ; 005576d6
        ;   Label: LAB_005576d6
    FCOMP double ptr [0x00597e39]       ; 005576dc | DAT_00597e39
    FNSTSW AX                           ; 005576e2
    SAHF                                ; 005576e4
    ...
    CALL FUN_00460aa0                   ; 00557772
        ;   XREF to: 00460aa0 (UNCONDITIONAL_CALL)  ; undefined FUN_00460aa0()
    ADD ESP,0xc                         ; 00557777
    PUSH 0x2de0774                      ; 0055777a
    PUSH EBX                            ; 0055777f
    CALL FUN_005570b0                   ; 00557780
        ;   XREF to: 005570b0 (UNCONDITIONAL_CALL)  ; undefined FUN_005570b0()
    ADD ESP,0x8                         ; 00557785
    PUSH 0x2de0780                      ; 00557788
    PUSH EBX                            ; 0055778d
    CALL FUN_005570b0                   ; 0055778e
        ;   XREF to: 005570b0 (UNCONDITIONAL_CALL)  ; undefined FUN_005570b0()
    ADD ESP,0x8                         ; 00557793
    PUSH EBX                            ; 00557796
    CALL FUN_00409f60                   ; 00557797
        ;   XREF to: 00409f60 (UNCONDITIONAL_CALL)  ; undefined FUN_00409f60()
    ADD ESP,0x4                         ; 0055779c
    PUSH EBX                            ; 0055779f
    CALL FUN_00409f60                   ; 005577a0
        ;   XREF to: 00409f60 (UNCONDITIONAL_CALL)  ; undefined FUN_00409f60()
    ADD ESP,0x4                         ; 005577a5
    PUSH EBX                            ; 005577a8
    CALL FUN_00409f60                   ; 005577a9
        ;   XREF to: 00409f60 (UNCONDITIONAL_CALL)  ; undefined FUN_00409f60()
