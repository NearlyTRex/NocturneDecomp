...
;
; XREF[5]:
;   FUN_0049da10 at 0049dd2b
;   FUN_0049ee30 at 0049f3b2
;   FUN_0049f930 at 0049fdfd
;   FUN_004a6010 at 004a64fc
;   FUN_004ff2c0 at 005024e5
;
; Referenced Globals:
;   undefined4 DAT_00590bd5
;   undefined4 DAT_00590bdd
;   undefined4 DAT_00590be5
;   undefined4 DAT_00590bed
;   undefined4 DAT_00590bf5
;   undefined4 DAT_00590bfd
...
section .text
    ...
    FLD float ptr [0x00590bd5]          ; 005126ed | DAT_00590bd5
    FXCH                                ; 005126f3
    FMUL ST1                            ; 005126f5
    ...
    PUSH EAX                            ; 00512805
    CALL FUN_0041dc70                   ; 00512806
        ;   XREF to: 0041dc70 (UNCONDITIONAL_CALL)  ; undefined FUN_0041dc70()
    ...
    FXCH                                ; 0051282a
    FMUL double ptr [0x00590bdd]        ; 0051282c | DAT_00590bdd
    FXCH                                ; 00512832
    FST float ptr [ESP + 0x214]         ; 00512834
    FLD float ptr [0x00590bd5]          ; 0051283b | DAT_00590bd5
    FXCH                                ; 00512841
    FMUL ST1                            ; 00512843
    ...
    PUSH EDX                            ; 005128c1
    CALL FUN_00514340                   ; 005128c2
        ;   XREF to: 00514340 (UNCONDITIONAL_CALL)  ; undefined FUN_00514340()
    ...
    FLD float ptr [0x005a1a8c]          ; 005128f7 | DAT_005a1a8c
    FMUL ST0                            ; 005128fd
    ...
    FLD float ptr [0x005a1a8c]          ; 00512935 | DAT_005a1a8c
    FMUL ST0                            ; 0051293b
    MOV EAX,dword ptr [EBP + 0x18]      ; 0051293d
    FLD float ptr [0x005a1a88]          ; 00512940 | DAT_005a1a88
    FLD ST0                             ; 00512946
    ...
    CALL thunk_FUN_004ce920             ; 005129a8
    ...
    PUSH EAX                            ; 00512d7d
    PUSH EBX                            ; 00512d7e
    CALL FUN_00514980                   ; 00512d7f
        ;   XREF to: 00514980 (UNCONDITIONAL_CALL)  ; undefined FUN_00514980()
    ...
    FMUL double ptr [0x00590be5]        ; 00512f6d | DAT_00590be5
    ...
    CALL FUN_0045f090                   ; 00513209
        ;   XREF to: 0045f090 (UNCONDITIONAL_CALL)  ; undefined FUN_0045f090()
    ...
    FLD float ptr [ESP + 0x8]           ; 0051331e
        ;   Label: LAB_0051331e
    FMUL double ptr [0x00590bed]        ; 00513322 | DAT_00590bed
    ...
    FLD ST0                             ; 0051358e
    FMUL double ptr [0x00590bf5]        ; 00513590 | DAT_00590bf5
    FSTP ST1                            ; 00513596
    ...
    FLD ST0                             ; 005135b2
    FMUL double ptr [0x00590bfd]        ; 005135b4 | DAT_00590bfd
    FSTP ST1                            ; 005135ba
