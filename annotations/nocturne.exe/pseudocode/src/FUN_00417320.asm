...
section .text
    ...
    FXCH ST4                            ; 004173e2
    CALL FUN_00563a30                   ; 004173e4
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH ST3                            ; 004173e9
    CALL FUN_00563a30                   ; 004173eb
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH ST2                            ; 004173f0
    CALL FUN_00563a30                   ; 004173f2
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH                                ; 004173f7
    CALL FUN_00563a30                   ; 004173f9
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH ST6                            ; 004173fe
    CALL FUN_00563a30                   ; 00417400
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH ST5                            ; 00417405
    CALL FUN_00563a30                   ; 00417407
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH ST4                            ; 0041740c
    CALL FUN_00563a30                   ; 0041740e
        ;   XREF to: 00563a30 (UNCONDITIONAL_CALL)  ; undefined FUN_00563a30()
    FXCH ST3                            ; 00417413
