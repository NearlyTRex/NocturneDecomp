...
// Convention: unknown
// Signature: void FUN_004c0b40(undefined4 param_1,int param_2,int param_3,int param_4,int param_5,undefined4 param_6,int param_7)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_004c0b40(uint param_1,int param_2,int param_3,int param_4,int param_5,uint param_6,int param_7)

{
  ...
  if (param_2 != 0) {
    ...
    *(uint *)(iVar8 + 0x15aa98) = 32000;
    ...
    iVar8 = FUN_004cca60(_DAT_01cc30a4);
    iVar9 = FUN_004ccaa0(_DAT_01cc30a4);
    ...
    *(uint *)(0x01E57284 + 0x15aa94) =
    ...
    FUN_00460e40(DAT_005ae704,param_3,param_4,param_5,param_5);
    uVar10 = FUN_004beb40(param_2);
    iVar8 = FUN_00454530(uVar10);
    ...
    iVar8 = FUN_0040d7e0(param_2,&DAT_005871ad);
    if ((iVar8 != 0) || (iVar8 = FUN_0040d7e0(param_2,"CKeyActor"), iVar8 != 0)) {
    ...
    local_4c = 0;
    local_18 = local_48;
    FUN_00460700(DAT_005ae704,&local_50);
    FUN_00460c00(DAT_005ae704,0x42100000);
    ...
    local_30 = 0.0;
    local_34 = param_6;
    iVar8 = FUN_0040d7e0(param_2,"CKeyActor");
    if (iVar8 != 0) {
      local_38 = local_38 + _DAT_005871ed;
    }
    iVar8 = FUN_0040d890(param_2,_DAT_01cc56dc);
    if (iVar8 != 0) {
      iVar9 = FUN_00564520(iVar8 + 0x1c8,"axe1.kfm");
      if (iVar9 == 0) {
        local_38 = local_38 + _DAT_005871f1;
        local_30 = local_30 + _DAT_005871f1;
      }
      iVar8 = FUN_00564520(iVar8 + 0x1c8,"ax.kfm");
      if (iVar8 == 0) {
        local_38 = local_38 + _DAT_005871f1;
        local_30 = local_30 + _DAT_005871f1;
      }
    }
    FUN_00460aa0(DAT_005ae704,&local_38,0);
    FUN_00460aa0(DAT_005ae704,&DAT_02dd1184,&local_5c);
    if (param_7 < 65000) {
      FUN_00461010(DAT_005ae704,param_7);
      FUN_004619f0(DAT_005ae704,1);
      FUN_004544d0(uVar10,0,0x2e7);
      FUN_00461db0(DAT_005ae704);
    }
    else {
      FUN_004544d0(uVar10,0,0xffffffff);
    }
