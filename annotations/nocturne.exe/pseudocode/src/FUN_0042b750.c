...
// Convention: unknown
// Signature: int FUN_0042b750(undefined4 param_1)

#include "nocturne.h"

int FUN_0042b750(uint param_1)

{
  ...
  iVar2 = FUN_005644a7(iVar2 + 0x284,0x14,&DAT_0059b320);
  *(byte ***)(iVar2 + -0x138) = &PTR_FUN_0059b244;
  *(uint *)(iVar2 + -0x134) = 10;
