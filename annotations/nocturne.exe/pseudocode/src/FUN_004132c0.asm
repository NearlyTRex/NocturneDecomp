...
section .text
    ...
    POP EBX                             ; 0041334f
    RET                                 ; 00413350
    PUSH 0x59a110                       ; 00413351 | DAT_0059a110
        ;   Label: LAB_00413351
    PUSH EBX                            ; 00413356
    CALL FUN_0056445f                   ; 00413357
        ;   XREF to: 0056445f (UNCONDITIONAL_CALL)  ; undefined FUN_0056445f()
    ADD ESP,0x8                         ; 0041335c
    PUSH EAX                            ; 0041335f
    CALL FUN_00564486                   ; 00413360
