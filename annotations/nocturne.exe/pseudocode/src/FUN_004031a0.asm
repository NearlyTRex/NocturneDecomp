...
;
; XREF[1]:
;   FUN_00403460 at 00403495
;
; Referenced Globals:
;   undefined4 DAT_005771f4
;   undefined4 DAT_005771f8
...
section .text
    ...
    FLD float ptr [0x005771f4]          ; 00403227 | DAT_005771f4
    FXCH                                ; 0040322d
    FMUL ST1                            ; 0040322f
