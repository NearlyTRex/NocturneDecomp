...
// Convention: unknown
// Signature: void FUN_005557d0(int *param_1,float *param_2,int *param_3)
...

{
  ...
  if (*param_1 != 0) {
    ...
    iVar3 = 0;
    do {
      local_18 = (float)FUN_0040dda0(0x40a00000,0x42480000);
      local_14 = local_18;
      local_14 = (float)FUN_0040dda0((float)param_3[1] + (float)_DAT_00597cb9,
      ...
      FUN_005117e0(0x01E57284);
      local_14 = (float)FUN_0050fb00(0x01E57284,&local_50,&local_44);
