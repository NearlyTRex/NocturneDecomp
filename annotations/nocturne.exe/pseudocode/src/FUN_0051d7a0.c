...
// Convention: unknown
// Signature: void FUN_0051d7a0(int param_1,undefined4 param_2,float param_3,int param_4,code *param_5)
...
void FUN_0051d7a0(int param_1,uint param_2,float param_3,int param_4,code *param_5)

{
  ...
  iVar2 = 0;
  local_24 = iVar1;
  FUN_0055d220(param_2,&local_28,local_34);
  if (0 < *(int *)(iVar1 + 0x28558)) {
    local_1c = param_1 + 0x6b0;
    local_20 = param_1;
    do {
      iVar1 = FUN_00517b10(local_24,iVar2,param_4);
      if (-1 < iVar1) {
        ...
        if ((float)_DAT_00591bcb < ABS(fStack_e8)) {
          ...
          *(uint *)((int)auStack_60 + ((uint)bVar5 * -2 + (uint)bVar5 * -2 + 1) * 4) =
          ...
          [(uint)bVar5 * -2 + 1] =
               ((uint *)((int)auStack_50 + ((uint)bVar5 * -2 + (uint)bVar5 * -2 + 5) * 4))
               [(uint)bVar5 * -2 + 1];
          FUN_0055d130(local_1c,&uStack_64);
  ...
  *(uint *)((int)auStack_50 + ((uint)bVar5 * -2 + (uint)bVar5 * -2 + 1) * 4) =
  ...
  FUN_0055a910(param_1 + 0x6a4,local_e4);
  return;
}
