...
// Convention: unknown
// Signature: void FUN_00565072(undefined4 *param_1,byte param_2,undefined4 param_3,uint param_4,undefined4 param_5)

#include "nocturne.h"

void FUN_00565072(uint *param_1,byte param_2,uint param_3,uint param_4,uint param_5)

{
  ...
  *(byte ***)(iVar1 + 8) = &PTR_LAB_005a47c0;
  *(byte ***)(*(int *)(*piVar2 + 4) + 0x28 + (int)piVar2) = &PTR_LAB_005a47c8;
  return;
}
