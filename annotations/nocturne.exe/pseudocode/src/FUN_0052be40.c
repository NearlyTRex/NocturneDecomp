...
// Convention: unknown
// Signature: undefined4 FUN_0052be40(int param_1,int param_2)

#include "nocturne.h"

uint FUN_0052be40(int param_1,int param_2)

{
  ...
  if ((-1 < param_1) && (param_1 < DAT_005bed40)) {
    ...
    *(uint *)(param_2 + 0x110) = *(uint *)(param_1 + 0x2dc84c4);
    FUN_00563c90(param_2,"DirectSound: %s",param_1 + 0x2dc84d8);
    return 1;
  }
  return 0;
}
