...
// Convention: unknown
// Signature: void FUN_004c1f90(int param_1,int param_2,int param_3,int param_4,undefined4 param_5)

#include "nocturne.h"

void FUN_004c1f90(int param_1,int param_2,int param_3,int param_4,uint param_5)
