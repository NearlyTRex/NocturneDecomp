...
section .text
    ...
    PUSH EAX                            ; 004b0e51
    CALL FUN_0040c880                   ; 004b0e52
        ;   XREF to: 0040c880 (UNCONDITIONAL_CALL)  ; undefined FUN_0040c880()
    MOV EDX,dword ptr [0x005ba8c8]      ; 004b0e57 | DAT_005ba8c8
    ...
    PUSH EAX                            ; 004b0e84
    CALL FUN_0040c880                   ; 004b0e85
        ;   XREF to: 0040c880 (UNCONDITIONAL_CALL)  ; undefined FUN_0040c880()
    MOV ESI,dword ptr [0x005ba8c8]      ; 004b0e8a | DAT_005ba8c8
