...
;                               FUNCTION
; *****************************************************************************
; undefined4 FUN_0052adc0(undefined4 param_1,int param_2,int param_3,int param_4,int param_5)
;
;
; Referenced Globals:
