...
// Convention: unknown
// Signature: void FUN_00472fd0(undefined4 param_1,undefined4 param_2,undefined4 param_3,float *param_4,float *param_5)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_00472fd0(uint param_1,uint param_2,uint param_3,float *param_4,float *param_5)

{
  ...
  FUN_00472de0(param_1,param_2,param_3);
