...
// Convention: unknown
// Signature: undefined4 FUN_0052b7e0(undefined4 param_1,int param_2)

#include "nocturne.h"

uint FUN_0052b7e0(uint param_1,int param_2)

{
  ...
  if ((((0 < iVar1) && (iVar1 < 0x1f)) && (*(int *)(iVar1 * 4 + 0x2dc92a8) != 0)) &&
    ...
    if (iVar1 != 0) {
      ...
      FUN_00563c90(&piStack_19c,"DirectSux: Unable to %s.  (%s)",
