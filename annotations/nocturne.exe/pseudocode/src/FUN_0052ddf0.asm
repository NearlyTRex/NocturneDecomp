...
;
; XREF[3]:
;   FUN_0049da10 at 0049e3fb
;   FUN_0049f930 at 0049fa9e
;   FUN_004a6010 at 004a64e2
;
; Referenced Globals:
...
section .text
    ...
    MOV EDX,dword ptr [0x005b7650]      ; 0052df59 | DAT_005b7650
        ;   Label: LAB_0052df59
    PUSH EDX                            ; 0052df5f
    CALL FUN_00480eb0                   ; 0052df60
        ;   XREF to: 00480eb0 (UNCONDITIONAL_CALL)  ; undefined FUN_00480eb0()
