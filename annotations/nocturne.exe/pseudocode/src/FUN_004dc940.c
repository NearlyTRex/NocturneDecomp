...
// Convention: unknown
// Signature: void FUN_004dc940(int param_1,int param_2)
  ...
  if (*(float *)(param_1 + 0xbd3c) <= 0.0) {
    ...
    do {
      ...
      *(int *)(iVar4 + 0x1ccdb94) = iVar3;
      if (((*(int *)(iVar1 + 0x1c) != 0) || (param_2 != 1)) || (iVar3 != 6)) {
        FUN_00563c90(local_80,"mobster-cheese-%c-%c-%d.wav",
                     *(byte *)(param_1 + 0xbd38),local_1c,*(uint *)(iVar4 + 0x1ccdb94));
    ...
    if (0.0 < *(float *)(param_1 + 0xbd3c)) {
      *(float *)(param_1 + 0xbd3c) = *(float *)(param_1 + 0xbd3c) + _DAT_0058a4c9;
      iVar4 = FUN_00526c50(*(uint *)(param_1 + 0xbdc4));
      if (iVar4 == 0) {
        iVar5 = 0;
        iVar4 = 0;
        local_18 = 0;
        while( true ) {
          ...
          iVar1 = FUN_0040d890(*(uint *)(0x01E57284 + local_18 + 0x150bf8),_DAT_01ccdc10);
          if (((iVar1 != 0) && (iVar1 = FUN_00526c50(*(uint *)(iVar1 + 0xbdbc)), iVar1 != 0))
             && (iVar4 = iVar4 + 1, 3 < iVar4)) break;
          local_18 = local_18 + 4;
          iVar5 = iVar5 + 1;
        }
      }
