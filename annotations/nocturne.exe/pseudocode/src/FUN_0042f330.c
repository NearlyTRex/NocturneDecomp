...
// Convention: unknown
// Signature: uint FUN_0042f330(int param_1,int param_2,int param_3,uint param_4,undefined1 param_5,undefined1 param_6,int param_7)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_0042f330(int param_1,int param_2,int param_3,uint param_4,byte param_5,byte param_6,int param_7)
    ...
    if (local_28 == 0) {
      ...
      if ((int)local_28 < (int)local_24) {
        ...
        while (local_24 = local_24 - 1, local_24 != 0) {
          ...
          uVar2 = uVar4;
          if (param_7 == 0) {
            param_4 = FUN_0042f8c0(param_1,param_2,((float)(uVar4 >> 8) + 1.0) * 0.00390625,local_18
                                  );
          }
          else {
            param_4 = FUN_0042f8c0(param_1,param_2 + 1,(float)(uVar4 >> 8 ^ 0xff) * 0.00390625,
                                   local_18);
          }
        }
      }
        ...
        while( true ) {
          ...
          uVar2 = uVar4;
          if (bVar1) {
            FUN_0042f8c0(param_1,param_2,((float)(uVar4 >> 8) + 1.0) * 0.00390625,local_1c);
          }
          else {
            FUN_0042f8c0(local_2c + param_1,param_2,(float)(uVar4 >> 8 ^ 0xff) * 0.00390625,local_1c
                        );
          }
        }
      }
