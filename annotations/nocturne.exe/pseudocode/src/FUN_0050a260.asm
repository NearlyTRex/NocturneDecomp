...
section .text
    ...
    PUSH EAX                            ; 0050a4bc
    PUSH EDI                            ; 0050a4bd
    CALL FUN_0050b5c0                   ; 0050a4be
        ;   XREF to: 0050b5c0 (UNCONDITIONAL_CALL)  ; undefined FUN_0050b5c0()
    ...
    CALL FUN_0048c8a0                   ; 0050a4dc
        ;   XREF to: 0048c8a0 (UNCONDITIONAL_CALL)  ; undefined FUN_0048c8a0()
    ...
    CALL FUN_00452110                   ; 0050a566
        ;   XREF to: 00452110 (UNCONDITIONAL_CALL)  ; undefined FUN_00452110()
