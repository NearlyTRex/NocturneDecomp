...
section .text
    ...
    PUSH EBX                            ; 004cedb5
    CALL FUN_00554170                   ; 004cedb6
        ;   XREF to: 00554170 (UNCONDITIONAL_CALL)  ; undefined FUN_00554170()
    MOV EDX,dword ptr [0x005bade4]      ; 004cedbb | DAT_005bade4
    ADD ESP,0x4                         ; 004cedc1
    CMP EDX,0x2                         ; 004cedc4
    JGE 0x004cee74                      ; 004cedc7
        ;   XREF to: 004cee74 (CONDITIONAL_JUMP)  ; LAB_004cee74
    CMP dword ptr [0x005bade4],0x3      ; 004cedcd | DAT_005bade4
        ;   Label: LAB_004cedcd
    ...
    PUSH EAX                            ; 004cee26
    CALL FUN_0040c880                   ; 004cee27
        ;   XREF to: 0040c880 (UNCONDITIONAL_CALL)  ; undefined FUN_0040c880()
    ADD ESP,0x8                         ; 004cee2c
    CMP dword ptr [0x005bade4],0x5      ; 004cee2f | DAT_005bade4
        ;   Label: LAB_004cee2f
    ...
    PUSH EAX                            ; 004cee43
    CALL FUN_0040c900                   ; 004cee44
        ;   XREF to: 0040c900 (UNCONDITIONAL_CALL)  ; undefined FUN_0040c900()
    ADD ESP,0x8                         ; 004cee49
    CMP dword ptr [0x005bade4],0x6      ; 004cee4c | DAT_005bade4
        ;   Label: LAB_004cee4c
    ...
    PUSH EAX                            ; 004cee60
    CALL FUN_0040c900                   ; 004cee61
        ;   XREF to: 0040c900 (UNCONDITIONAL_CALL)  ; undefined FUN_0040c900()
    ADD ESP,0x8                         ; 004cee66
    CMP dword ptr [0x005bade4],0x7      ; 004cee69 | DAT_005bade4
        ;   Label: LAB_004cee69
