...
// Address: 00505ba0
void CSentinel::process(int param_1,float param_2);

// Original: core_sentinel.cpp_CSentinel_attractActorToward_FUN_005066e0
// Address: 005066e0
undefined4 CSentinel::attractActorToward(int param_1,int param_2);

// Original: core_sentinel.cpp_CSentinel_archive_FUN_005067e0
// Address: 005067e0
void CSentinel::archive(int param_1);

// Original: core_sentinel.cpp_CSentinel_processDamage_FUN_00506840
// Address: 00506840
void CSentinel::processDamage(int param_1,int param_2);
