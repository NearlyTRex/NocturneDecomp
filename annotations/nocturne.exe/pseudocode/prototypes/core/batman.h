...
// Address: 004133e0
int CBatman::ctor(undefined4 param_1);

// Original: core_batman.cpp_CBatman_setup_FUN_004134a0
// Address: 004134a0
void CBatman::setup(int param_1);

// Original: core_batman.cpp_CBatman_pickRandomMovementState_FUN_00413780
// Address: 00413780
void __cdecl CBatman::pickRandomMovementState(int param_1);
...
// Address: 004145f0
void __cdecl CBatman::processDismemberment(int param_1,int *param_2);
