...
// Address: 004ca640
void CMansionPuzzleCircle::updatePanelTransform(int param_1,int param_2);
...
// Address: 004cabf0
void __cdecl CMansionPuzzleCircle::renderReflector(int param_1,int param_2);

// Original: core_manpuz.cpp_CMansionPuzzleCircle_processPanel_FUN_004cac90
// Address: 004cac90
void __cdecl CMansionPuzzleCircle::processPanel(int param_1,int param_2,float param_3);
...
// Address: 004caef0
undefined4 __cdecl updateGemHumChannel(float *param_1,float param_2,float param_3,undefined4 *param_4,undefined4 param_5,float *param_6);
...
// Address: 004cb2d0
void __cdecl CMansionPuzzleCircle::updateLaser(int param_1,int param_2,float param_3);

// Original: core_manpuz.cpp_CMansionPuzzleCircle_shiftPanelLeft_FUN_004cb5a0
// Address: 004cb5a0
void __cdecl CMansionPuzzleCircle::shiftPanelLeft(int param_1,int param_2);

// Original: core_manpuz.cpp_CMansionPuzzleCircle_shiftPanelRight_FUN_004cb740
// Address: 004cb740
void __cdecl CMansionPuzzleCircle::shiftPanelRight(int param_1,int param_2);

// Original: core_manpuz.cpp_CMansionPuzzleCircle_archive_FUN_004cb7f0
// Address: 004cb7f0
void CMansionPuzzleCircle::archive(int param_1);
...
// Address: 004cb8f0
int __cdecl CMansionPuzzleCircle::getPrevPanelIndex(undefined4 param_1,int param_2);

// Original: core_manpuz.cpp_CMansionPuzzleCircle_updateReflector_FUN_004cb900
// Address: 004cb900
void __cdecl CMansionPuzzleCircle::updateReflector(int param_1,int param_2,float param_3);
...
// Address: 004cba40
undefined4 __cdecl CMansionPuzzleCircle::panelOccupied(int param_1,int param_2);
...
// Address: 004cbb70
undefined4 CMirrorHack::renderOpaque(int param_1);

// Original: core_manpuz.cpp_CMirrorHack_process_FUN_004cbbc0
// Address: 004cbbc0
void CMirrorHack::process(int param_1,float param_2);

// Original: core_manpuz.cpp_CMirrorHack_getBoundingBox_FUN_004cbc50
// Address: 004cbc50
undefined4 * CMirrorHack::getBoundingBox(int param_1,undefined4 *param_2);
...
// Original: core_manpuz.cpp_FUN_004cbf30
// Address: 004cbf30
void FUN_004cbf30(undefined4 *param_1,undefined4 *param_2);

// Original: core_manpuz.cpp_CDemonTriangle_arrdtor_FUN_004cc000
// Address: 004cc000
void __cdecl CDemonTriangle::arrdtor(undefined4 param_1);
