...
// Address: 0054e040
void __cdecl CVampireBoss::summonBats(int param_1);
...
// Address: 0054e1a0
void __cdecl CVampireBoss::transformToBat(int param_1);

// Original: core_vampboss.cpp_CVampireBoss_transformToHuman_FUN_0054e1e0
// Address: 0054e1e0
void __cdecl CVampireBoss::transformToHuman(int param_1);

// Original: core_vampboss.cpp_CVampireBoss_chooseDestWayPoint_FUN_0054e230
// Address: 0054e230
void __cdecl CVampireBoss::chooseDestWayPoint(int param_1);

// Original: core_vampboss.cpp_CVampireBoss_getCollisionType_FUN_0054e310
// Address: 0054e310
undefined4 CVampireBoss::getCollisionType(int param_1,int *param_2);

// Original: core_vampboss.cpp_CVampireBoss_dtor_FUN_0054e370
// Address: 0054e370
int CVampireBoss::dtor(int param_1,byte param_2);
