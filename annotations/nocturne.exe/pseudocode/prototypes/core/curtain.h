...
// Address: 0043d960
int CCurtain::ctor(undefined4 param_1);
...
// Address: 0043e110
void __cdecl CCurtain::updateWorldPositions(int param_1);

// Original: core_curtain.cpp_CCurtain_updateLocalPositions_FUN_0043e1e0
// Address: 0043e1e0
void __cdecl CCurtain::updateLocalPositions(int param_1);

// Original: core_curtain.cpp_CCurtain_solveConstraints_FUN_0043e290
// Address: 0043e290
void __cdecl CCurtain::solveConstraints(int param_1,int param_2);

// Original: core_curtain.cpp_CCurtain_process_FUN_0043ebf0
// Address: 0043ebf0
void CCurtain::process(int param_1,float param_2);
...
// Address: 0043f6b0
void CCurtain::archive(int param_1);
