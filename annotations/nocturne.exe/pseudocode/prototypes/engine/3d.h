...
// Address: 00404790
int processTextureCoordinates(int param_1);

// Original: engine_3d.c_renderPolygonGrayscaleLitOp5_FUN_004047e0
// Address: 004047e0
int renderPolygonGrayscaleLitOp5(int param_1);

// Original: engine_3d.c_renderPolygonFogColorOp6_FUN_004048b0
// Address: 004048b0
int renderPolygonFogColorOp6(int param_1);

// Original: engine_3d.c_renderPolygonTexturedLitOp7_FUN_004049d0
// Address: 004049d0
int * renderPolygonTexturedLitOp7(SMRGLHeaderPrimitive *param_1);
...
// Address: 00405240
int renderPolygonTexturedNormalizedUVLitOp14(SMRGLHeaderPrimitive *param_1);

// Original: engine_3d.c_renderPolygonTexturedUVLitPlaneMasked_FUN_00405340
// Address: 00405340
int renderPolygonTexturedUVLitPlaneMasked(SMRGLHeaderPrimitive *param_1);
...
// Address: 00405540
int renderPolygonSolidLitClampedOp17(SMRGLHeaderPrimitive *param_1);
...
// Address: 004057a0
int renderPolygonTexturedNormalizedOp21(int param_1);
...
// Address: 00405900
int drawLineStrip3D(int param_1);
...
// Address: 00405c90
int renderPolygonLitAlphaPlaneMaskedUVOp24(SMRGLHeaderPrimitive *param_1);

// Original: engine_3d.c_renderPolygonAdaptivePlaneMaskedUVOp34_FUN_00405e10
// Address: 00405e10
int renderPolygonAdaptivePlaneMaskedUVOp34(SMRGLHeaderPrimitive *param_1);

// Original: engine_3d.c_renderPolygonLitNearPlaneOp35_FUN_00406010
// Address: 00406010
int * renderPolygonLitNearPlaneOp35(SMRGLHeaderPrimitive *param_1);

// Original: engine_3d.c_renderPolygonAdaptiveDepthOp25_FUN_004060b0
// Address: 004060b0
int renderPolygonAdaptiveDepthOp25(int param_1);

// Original: engine_3d.c_renderPolygonLitAlphaPlaneMaskedOp26_FUN_00406230
// Address: 00406230
int * renderPolygonLitAlphaPlaneMaskedOp26(SMRGLHeaderPrimitive *param_1);

// Original: engine_3d.c_renderPolygonFogColorDepthOp27_FUN_00406320
// Address: 00406320
int renderPolygonFogColorDepthOp27(int param_1);
...
// Address: 00406690
int updateAnimatedTexture(int param_1);

// Original: engine_3d.c_renderPolygonTexturedUVLitOp30_FUN_00406740
// Address: 00406740
int renderPolygonTexturedUVLitOp30(SMRGLHeaderPrimitive *param_1);

// Original: engine_3d.c_setVertexTextureU_FUN_00406840
// Address: 00406840
int setVertexTextureU(int param_1);
...
// Address: 00406920
int * renderPolygonTexturedUVLit(SMRGLHeaderPrimitive *param_1);
...
// Address: 00406ae0
int * renderPolygonAlphaTexturedNormalizedLit(SMRGLHeaderPrimitive *param_1);
...
// Address: 00406ea0
int renderPolygonFogTexturedPerspOp39(int param_1);
...
// Address: 00408130
int * renderPolygonFullEffectsLitOp57(SMRGLHeaderPrimitive *param_1);

// Original: engine_3d.c_renderPolygonVertexAlphaLitOp60_FUN_004081d0
// Address: 004081d0
int * renderPolygonVertexAlphaLitOp60(SMRGLHeaderPrimitive *param_1);

// Original: engine_3d.c_renderPolygonBlendedLitOp63_FUN_00408270
// Address: 00408270
int * renderPolygonBlendedLitOp63(SMRGLHeaderPrimitive *param_1);

// Original: engine_3d.c_setRenderAlphaFromBlock_FUN_00408350
// Address: 00408350
int setRenderAlphaFromBlock(int param_1);
...
// Address: 004083d0
SMRGLHeaderExtended * renderPolygonAlphaBlendedDepthWritePlaneMaskedOp58(SMRGLHeaderPrimitive *param_1);

// Original: engine_3d.c_renderPolygonAlphaBlendedDepthWritePerspOp59_FUN_00408510
// Address: 00408510
SMRGLHeaderExtended * renderPolygonAlphaBlendedDepthWritePerspOp59(SMRGLHeaderPrimitive *param_1);
...
// Address: 00408a60
int renderPolygonFullEffectsDirectOp66(int param_1);
...
// Address: 00409590
uint clipAndDrawLine3D(uint param_1,uint param_2,int param_3,undefined4 param_4,uint param_5);

// Original: engine_3d.c_addPolygonEdge_FUN_004940e0
// Address: 004940e0
void addPolygonEdge(int param_1,int param_2);

// Original: engine_3d.c_findHardwareEdgeByYMin_FUN_00494220
// Address: 00494220
int * findHardwareEdgeByYMin(int param_1,int *param_2);
...
// Address: 00562740
void addRasterizerEdgeWithDepth(int param_1,int param_2);
