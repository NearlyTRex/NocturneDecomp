...
// Points to CCryptVessel at offset 0x3c4 in CCryptVessel
...
struct CCryptVessel_ptr_964 {
    ...
    CCryptVessel* adj() const { return (CCryptVessel*)((char*)_raw - offsetof(CCryptVessel, flame.base.actor_name[8])); }
