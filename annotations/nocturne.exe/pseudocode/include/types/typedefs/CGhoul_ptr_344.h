...
struct CGhoul_ptr_344 {
    void *_raw;
    typedef CGhoul base_type;
    CGhoul_ptr_344() : _raw(0) {}
    ...
    CGhoul* adj() const { return (CGhoul*)((char*)_raw - offsetof(CGhoul, base.base.model.motion_controller.current_frame_number)); }
