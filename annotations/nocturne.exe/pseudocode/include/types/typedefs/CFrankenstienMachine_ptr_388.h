...
// Points to CFrankenstienMachine at offset 0x184 in CFrankenstienMachine
...
struct CFrankenstienMachine_ptr_388 {
    ...
    CFrankenstienMachine* adj() const { return (CFrankenstienMachine*)((char*)_raw - offsetof(CFrankenstienMachine, bed_model.part_visibility_flags[2])); }
