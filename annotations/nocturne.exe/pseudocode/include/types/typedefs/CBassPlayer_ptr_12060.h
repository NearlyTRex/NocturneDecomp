...
struct CBassPlayer_ptr_12060 {
    void *_raw;
    typedef CBassPlayer base_type;
    CBassPlayer_ptr_12060() : _raw(0) {}
    ...
    CBassPlayer* adj() const { return (CBassPlayer*)((char*)_raw - offsetof(CBassPlayer, base.base.fires[0].offset)); }
