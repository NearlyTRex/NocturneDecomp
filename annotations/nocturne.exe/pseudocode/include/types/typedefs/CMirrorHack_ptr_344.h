...
// Points to CMirrorHack at offset 0x158 in CMirrorHack
...
struct CMirrorHack_ptr_344 {
    ...
    CMirrorHack* operator->() const { return (CMirrorHack*)_raw; }
    CMirrorHack* adj() const { return (CMirrorHack*)((char*)_raw - offsetof(CMirrorHack, mirror_model.part_visibility_flags[2])); }
