...
// Points to CPickList at offset 0x1dc in CPickList
...
struct CPickList_ptr_476 {
    ...
    CPickList* adj() const { return (CPickList*)((char*)_raw - 476 /* FIXME(64bit): unresolved field path, 32-bit-only offset */); }
