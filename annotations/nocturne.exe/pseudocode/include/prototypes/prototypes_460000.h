...
void __cdecl shape_edittool_cpp_CEditorTools_showWarning_FUN_0046fb40(CEditorTools *this_ptr,char *format,...) __attribute__((format(printf, 2, 3)));
void __cdecl shape_edittool_cpp_CEditorTools_showError_FUN_0046fcd0(CEditorTools *this_ptr,char *format,...) __attribute__((format(printf, 2, 3)));
...
void __cdecl shape_edittool_cpp_CEditorTools_displayCenteredStatusMessage_FUN_0046fff0(CEditorTools *this_ptr,char *format,...) __attribute__((format(printf, 2, 3)));
