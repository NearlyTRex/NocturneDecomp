...
CBoundingBox3D * __cdecl core_barrier_cpp_CBarrier_getBoundingBox_FUN_004117a0(CBarrier *this_ptr,CBoundingBox3D *out_box);
...
void __cdecl core_battery_cpp_CBattery_process_FUN_00414e60(CBattery *this_ptr,float delta_time);
...
void __cdecl core_boxactor_cpp_CLightActor_FUN_0041f6e0(CLightActor *this_ptr);
