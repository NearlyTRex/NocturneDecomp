...
CDemonActorType * core_larva_cpp_CLarva_getActorType_FUN_004c4870(void);
...
void core_level_cpp_FUN_004c5630(int param_1);
...
undefined4 core_litecone_cpp_CLightCone_getCollisionType_FUN_004c8370(void);
...
undefined4 core_manpuz_cpp_CMansionPuzzleCircle_getCollisionType_FUN_004c9e40(void);
...
SPanel * __cdecl core_manpuz_cpp_FUN_004cc020(SPanel *objs,uint flags);
SGem * __cdecl core_manpuz_cpp_FUN_004cc040(SGem *objs,uint flags);
...
undefined4 core_marquee_cpp_CMarquee_getCollisionType_FUN_004cc8f0(void);
...
CDemonActorType * core_melee_cpp_CMelee_getActorType_FUN_004cec50(void);
