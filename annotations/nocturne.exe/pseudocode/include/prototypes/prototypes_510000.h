...
void __cdecl core_setcolid_cpp_CDemonSet_skipExactCollisions_FUN_00511740(CDemonSet *this_ptr);
...
void __cdecl core_setcolid_cpp_CDemonSet_castVoxelShadow_FUN_00511a10(CDemonSet *this_ptr,CDemonActor *actor);
...
CBoundingBox3D * __cdecl core_setdir_cpp_CBoundingBox3D_arrdtor2000_FUN_005143c0(CBoundingBox3D *this_ptr,uint flags);
...
void __cdecl core_setutil_cpp_C3DSLight_doNothing_FUN_00515410(C3DSLight *this_ptr);
...
CShotgun * __cdecl core_shotgun_cpp_factoryFuncShotgun_FUN_00515cf0(void);
...
CSkeleton * __cdecl core_skeleton_cpp_CSkeleton_arrdtor40_FUN_0051f880(CSkeleton *this_ptr,uint flags);
CDeformableModel * __cdecl core_skeleton_cpp_CDeformableModel_arrdtor64_FUN_0051f8a0(CDeformableModel *this_ptr,uint flags);
CBoundingBox3D * __cdecl core_skeleton_cpp_CBoundingBox3D_arrdtor100_FUN_0051f900(CBoundingBox3D *this_ptr,uint flags);
