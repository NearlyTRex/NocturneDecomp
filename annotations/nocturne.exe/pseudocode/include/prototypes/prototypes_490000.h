...
void __cdecl engine_font_cpp_CBitFont_printCenterF_FUN_00490f50(CBitFont *this_ptr,int y,int color_mode,int color_value,char *format,...) __attribute__((format(printf, 5, 6)));
...
CGabriella * __cdecl core_gabriela_cpp_factoryFuncGabriella_FUN_00495670(void);
