...
CDemonActorType * core_dog_cpp_FUN_00454650(void);
...
undefined4 core_dog_cpp_FUN_00454ee0(int param_1,CVector3f *param_2);
CDemonActor * core_dog_cpp_FUN_00454f30(CDemonActor *param_1,byte param_2);
...
int core_door_cpp_FUN_00455d50(CDemonActor *param_1);
void core_door_cpp_FUN_00455e10(CDemonActor *param_1,int param_2);
undefined4 * core_door_cpp_FUN_00455e90(int param_1,undefined4 *param_2);
...
undefined4 core_door_cpp_FUN_00456240(int param_1);
...
void engine_dosio_c_FUN_00456750(undefined4 param_1);
...
void core_dpart_cpp_CDemonPart_save_FUN_004570f0(void);
...
CDemonActorType * core_dracbrid_cpp_FUN_00458630(void);
...
CDemonActor * core_dracbrid_cpp_FUN_0045b350(CDemonActor *param_1,byte param_2);
...
void __cdecl cockpit_drawsurf_cpp_CDrawSurface_drawHorizontalLineWithEffect_FUN_0045bc20(int start_x,int end_x,int y);
...
void cockpit_drawsurf_cpp_FUN_0045cd80(CDrawSurface *param_1,int param_2,int param_3,int param_4,int param_5,int param_6,int param_7);
...
undefined4 cockpit_drawsurf_cpp_FUN_0045d0d0(void);
undefined4 cockpit_drawsurf_cpp_FUN_0045d0e0(void);
...
void engine_drender_cpp_CDemonRenderer_renderFullEffectsPoly_FUN_0045fce0(CDemonRenderer *param_1,int param_2);
