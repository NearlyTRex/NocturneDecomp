...
CDemonActorType * core_cow_cpp_FUN_0043bbd0(void);
...
undefined4 core_crate_cpp_FUN_0043cca0(int param_1);
undefined4 * core_crate_cpp_FUN_0043ccc0(int param_1,undefined4 *param_2);
...
CDemonActor * core_crate_cpp_FUN_0043ce60(CDemonActor *param_1,byte param_2);
