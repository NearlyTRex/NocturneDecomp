...
void __cdecl core_script_cpp_CScript_resetDialogState_FUN_00504d60(CScript *this_ptr);
int __cdecl core_script_cpp_CScript_skipCinematic_FUN_00504d90(CScript *this_ptr);
...
void __cdecl core_set_cpp_CDemonSet_FUN_005090f0(CDemonSet *this_ptr,undefined4 param_2,undefined4 param_3,int param_4);
...
void __cdecl core_set_cpp_CDemonSet_renderScene_FUN_00509a80(CDemonSet *this_ptr,int skip_prerender);
void __cdecl core_set_cpp_CDemonSet_renderGogglesView_FUN_0050a260(CDemonSet *this_ptr);
...
void __cdecl core_set_cpp_CDemonSet_renderEnvMapTriangles_FUN_0050d910(CDemonSet *this_ptr,SInputFace *face_data,int count,int alpha);
...
void __cdecl core_set_cpp_CDemonSet_renderPrimitiveBatch_FUN_0050ddd0(CDemonSet *this_ptr,SMRGLPrimitiveQuad *primitive_array,int primitive_count,int render_flags);
...
void __cdecl core_set_cpp_CDemonSet_setupMirrorRendering_FUN_0050e080(CDemonSet *this_ptr,int mirror_index,int enable_flag);
...
void __cdecl core_set_cpp_CDemonSet_cacheMirrorLighting_FUN_0050e370(CDemonSet *this_ptr,CVector3f *position);
...
CVector3f * __cdecl core_set_cpp_CVector3f_arrdtor4000_FUN_0050eae0(CVector3f *this_ptr,uint flags);
C3DSCamera * __cdecl core_set_cpp_C3DSCamera_arrdtor250_FUN_0050eb00(C3DSCamera *this_ptr,uint flags);
C3DSLight * __cdecl core_set_cpp_C3DSLight_arrdtor200_FUN_0050eb20(C3DSLight *this_ptr,uint flags);
SRoom * __cdecl core_set_cpp_SRoom_arrdtor20_FUN_0050eb40(SRoom *this_ptr,uint flags);
...
float __cdecl core_setcolid_cpp_CDemonSet_refinedRaycast_FUN_0050fc90(CDemonSet *this_ptr);
