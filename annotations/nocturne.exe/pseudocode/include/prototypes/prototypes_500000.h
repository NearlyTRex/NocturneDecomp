...
void __cdecl core_set_cpp_CDemonSet_FUN_0050e370(CDemonSet *this_ptr,CVector3f *position);
...
float __cdecl core_setcolid_cpp_CDemonSet_FUN_0050f910(CDemonSet *this_ptr,CVector3f *param_2);
...
float __cdecl core_setcolid_cpp_CDemonSet_FUN_0050fc90(CDemonSet *this_ptr);
