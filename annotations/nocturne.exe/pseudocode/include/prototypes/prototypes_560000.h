...
template<typename T_func0>
inline void crt_stdlib_c__qsort_FUN_00563db8(undefined4 *param_1,uint param_2,uint param_3,T_func0 param_4) {
    crt_stdlib_c__qsort_FUN_00563db8(param_1, param_2, param_3, (QSORT_COMPARATOR)param_4);
}
