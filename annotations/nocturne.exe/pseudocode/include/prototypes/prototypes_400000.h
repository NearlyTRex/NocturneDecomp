...
void __cdecl engine_2d_c_drawTextFormatted_FUN_00402780(int x,int y,char *format_string,...) __attribute__((format(printf, 3, 4)));
void __cdecl engine_2d_c_drawTextRightAligned_FUN_004027f0(char *text,int x,int y);
void __cdecl engine_2d_c_drawTextRightAlignedWrapper_FUN_00402820(int x,int y,char *text);
void __cdecl engine_2d_c_drawTextRightAlignedFormatted_FUN_00402840(int x,int y,char *format_string,...) __attribute__((format(printf, 3, 4)));
...
void __cdecl engine_2d_c_drawTextCenteredAtFormatted_FUN_00402910(int x,int y,char *format_string,...) __attribute__((format(printf, 3, 4)));
