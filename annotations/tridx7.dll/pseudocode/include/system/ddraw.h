...
// Structure: IDirectDraw4
typedef struct IDirectDraw4 {
    struct IDirectDraw4_vtable* vtable;
} IDirectDraw4;
...
// Function Definition: IDirectDraw4_GetSurfaceFromDC
typedef HRESULT IDirectDraw4_GetSurfaceFromDC(struct IDirectDraw4* this_ptr, void* device_context, struct IDirectDrawSurface** surface);

// Function Definition: IDirectDraw4_RestoreAllSurfaces
typedef HRESULT IDirectDraw4_RestoreAllSurfaces(struct IDirectDraw4* this_ptr);

// Function Definition: IDirectDraw4_RestoreDisplayMode
...
// Function Definition: IDirectDraw4_TestCooperativeLevel
typedef HRESULT IDirectDraw4_TestCooperativeLevel(struct IDirectDraw4* this_ptr);

// Structure: IDirectDraw4_vtable
#pragma pack(push, 1)
typedef struct IDirectDraw4_vtable {
    ...
    void* CreateClipper;
    void* CreatePalette;
    IDirectDraw4_CreateSurface* CreateSurface;
    ...
    void* Initialize;
    IDirectDraw4_RestoreDisplayMode* RestoreDisplayMode;
    IDirectDraw4_SetCooperativeLevel* SetCooperativeLevel;
    IDirectDraw4_SetDisplayMode* SetDisplayMode;
    void* WaitForVerticalBlank;
    IDirectDraw4_GetAvailableVidMem* GetAvailableVidMem;
    IDirectDraw4_GetSurfaceFromDC* GetSurfaceFromDC;
    IDirectDraw4_RestoreAllSurfaces* RestoreAllSurfaces;
    IDirectDraw4_TestCooperativeLevel* TestCooperativeLevel;
    IDirectDraw4_GetDeviceIdentifier* GetDeviceIdentifier;
} IDirectDraw4_vtable;
#pragma pack(pop)

// Structure: IDirectDrawClipper
typedef struct IDirectDrawClipper {
    struct IDirectDrawClipper_vtable* vtable;
} IDirectDrawClipper;

// Function Definition: IDirectDrawClipper_GetClipList
typedef HRESULT IDirectDrawClipper_GetClipList(struct IDirectDrawClipper* this_ptr, RECT* rect, void* clip_list, DWORD* size);

// Function Definition: IDirectDrawClipper_GetHWnd
typedef HRESULT IDirectDrawClipper_GetHWnd(struct IDirectDrawClipper* this_ptr, undefined1 window);

// Function Definition: IDirectDrawClipper_Initialize
typedef HRESULT IDirectDrawClipper_Initialize(struct IDirectDrawClipper* this_ptr, struct IDirectDraw* dd, DWORD flags);

// Function Definition: IDirectDrawClipper_IsClipListChanged
typedef HRESULT IDirectDrawClipper_IsClipListChanged(struct IDirectDrawClipper* this_ptr, BOOL* changed);

// Function Definition: IDirectDrawClipper_SetClipList
typedef HRESULT IDirectDrawClipper_SetClipList(struct IDirectDrawClipper* this_ptr, void* clip_list, DWORD flags);

// Function Definition: IDirectDrawClipper_SetHWnd
typedef HRESULT IDirectDrawClipper_SetHWnd(struct IDirectDrawClipper* this_ptr, DWORD flags, undefined1 window);

// Structure: IDirectDrawClipper_vtable
#pragma pack(push, 1)
typedef struct IDirectDrawClipper_vtable {
    IUnknown_QueryInterface* QueryInterface;
    IUnknown_AddRef* AddRef;
    IUnknown_Release* Release;
    IDirectDrawClipper_GetClipList* GetClipList;
    IDirectDrawClipper_GetHWnd* GetHWnd;
    IDirectDrawClipper_Initialize* Initialize;
    IDirectDrawClipper_IsClipListChanged* IsClipListChanged;
    IDirectDrawClipper_SetClipList* SetClipList;
    IDirectDrawClipper_SetHWnd* SetHWnd;
} IDirectDrawClipper_vtable;
#pragma pack(pop)

// Structure: IDirectDrawPalette
typedef struct IDirectDrawPalette {
    struct IDirectDrawPalette_vtable* vtable;
} IDirectDrawPalette;

// Function Definition: IDirectDrawPalette_GetCaps
typedef HRESULT IDirectDrawPalette_GetCaps(struct IDirectDrawPalette* this_ptr, DWORD* caps);

// Function Definition: IDirectDrawPalette_GetEntries
typedef HRESULT IDirectDrawPalette_GetEntries(struct IDirectDrawPalette* this_ptr, DWORD flags, DWORD start, DWORD count, struct PALETTEENTRY* entries);

// Function Definition: IDirectDrawPalette_Initialize
typedef HRESULT IDirectDrawPalette_Initialize(struct IDirectDrawPalette* this_ptr, struct IDirectDraw* dd, DWORD flags, struct PALETTEENTRY* entries);

// Function Definition: IDirectDrawPalette_SetEntries
typedef HRESULT IDirectDrawPalette_SetEntries(struct IDirectDrawPalette* this_ptr, DWORD flags, DWORD start, DWORD count, struct PALETTEENTRY* entries);

// Structure: IDirectDrawPalette_vtable
#pragma pack(push, 1)
typedef struct IDirectDrawPalette_vtable {
    IUnknown_QueryInterface* QueryInterface;
    IUnknown_AddRef* AddRef;
    IUnknown_Release* Release;
    IDirectDrawPalette_GetCaps* GetCaps;
    IDirectDrawPalette_GetEntries* GetEntries;
    IDirectDrawPalette_Initialize* Initialize;
    IDirectDrawPalette_SetEntries* SetEntries;
...
typedef HRESULT IDirectDrawSurface_GetPalette(struct IDirectDrawSurface* this_ptr, struct IDirectDrawPalette** palette);
...
typedef HRESULT IDirectDrawSurface_SetColorKey(struct IDirectDrawSurface* this_ptr, DWORD flags, struct DDCOLORKEY* color_key);
...
typedef HRESULT IDirectDrawSurface_SetPalette(struct IDirectDrawSurface* this_ptr, struct IDirectDrawPalette* palette);
...
typedef HRESULT IDirectDraw_WaitForVerticalBlank(struct IDirectDraw* this_ptr, DWORD flags, void* event);
