...
// Convention: unknown
// Signature: void FUN_10003a80(void)
...

{
  ...
  case 0x20:
    ...
    break;
  default:
    FUN_10002340("Unknown texture size");
    iVar3 = local_7c[0];
    break;
  case 0x40:
    iVar3 = 2;
  ...
  if (DAT_100141f0 == 0) {
    ...
    local_90 = (int *)(&DAT_1020de44)[DAT_10014138 * 2];
  }
  else {
    local_90 = (int *)0x0;
    local_94 = (int *)(&DAT_1020de44)[DAT_10014138 * 2];
  }
  while( true ) {
    if (DAT_100141f0 == 0) {
      local_94 = (int *)(&DAT_10139048)[iVar3 + DAT_100141e8 * 8];
    ...
    local_7c[0] = 0x7c;
    iVar2 = FUN_10002e20(local_94,local_7c);
    if (iVar2 == 0) {
      FUN_10002340("Texture load failed: Could not lock texture buffer");
    }
    if (DAT_10226a64 == 0x20) {
      FUN_10003e40();
    }
    else {
      FUN_10003d90(local_58,local_6c,local_70);
    }
    iVar2 = FUN_10002cb0(local_94);
    if (iVar2 == 0) {
      FUN_10002340("Texture load failed: Texture buffer unlock failed");
    }
    if (DAT_100141f0 == 0) {
      local_88 = 0;
      local_8c = 0;
