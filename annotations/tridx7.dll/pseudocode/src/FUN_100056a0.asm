...
section .text
    ...
    JZ 0x100056d6                       ; 100056ca
        ;   XREF to: 100056d6 (CONDITIONAL_JUMP)  ; LAB_100056d6
    PUSH 0x2                            ; 100056cc
    CALL FUN_100085b0                   ; 100056ce
        ;   XREF to: 100085b0 (UNCONDITIONAL_CALL)  ; undefined FUN_100085b0()
    ...
    JZ 0x100056ff                       ; 100056f3
        ;   XREF to: 100056ff (CONDITIONAL_JUMP)  ; LAB_100056ff
    PUSH 0x1                            ; 100056f5
    CALL FUN_100085b0                   ; 100056f7
        ;   XREF to: 100085b0 (UNCONDITIONAL_CALL)  ; undefined FUN_100085b0()
    ADD ESP,0x4                         ; 100056fc
    CALL FUN_100078f0                   ; 100056ff
        ;   XREF to: 100078f0 (UNCONDITIONAL_CALL)  ; undefined FUN_100078f0()
        ;   Label: LAB_100056ff
    ...
    CALL __mtinit                       ; 10005739
        ;   XREF to: 10007700 (UNCONDITIONAL_CALL)  ; int __mtinit()
    TEST EAX,EAX                        ; 1000573e
    JNZ 0x1000574c                      ; 10005740
        ;   XREF to: 1000574c (CONDITIONAL_JUMP)  ; LAB_1000574c
    CALL FUN_10007910                   ; 10005742
        ;   XREF to: 10007910 (UNCONDITIONAL_CALL)  ; undefined FUN_10007910()
    ...
    CALL FUN_100083e0                   ; 10005757
        ;   XREF to: 100083e0 (UNCONDITIONAL_CALL)  ; undefined FUN_100083e0()
    ...
    JZ 0x1000578f                       ; 1000576c
        ;   XREF to: 1000578f (CONDITIONAL_JUMP)  ; LAB_1000578f
    CALL FUN_10007920                   ; 1000576e
        ;   XREF to: 10007920 (UNCONDITIONAL_CALL)  ; undefined FUN_10007920()
    CALL ___initmbctable                ; 10005773
        ;   XREF to: 100081d0 (UNCONDITIONAL_CALL)  ; undefined ___initmbctable()
    CALL __setargv                      ; 10005778
        ;   XREF to: 10007c40 (UNCONDITIONAL_CALL)  ; int __setargv()
    CALL FUN_10007b60                   ; 1000577d
        ;   XREF to: 10007b60 (UNCONDITIONAL_CALL)  ; undefined FUN_10007b60()
    CALL __cinit                        ; 10005782
        ;   XREF to: 10007570 (UNCONDITIONAL_CALL)  ; int __cinit(int param_1)
    MOV EAX,0x1                         ; 10005787
    RET 0xc                             ; 1000578c
    CALL FUN_10007910                   ; 1000578f
        ;   XREF to: 10007910 (UNCONDITIONAL_CALL)  ; undefined FUN_10007910()
        ;   Label: LAB_1000578f
    ...
    CALL FUN_100075e0                   ; 100057b5
        ;   XREF to: 100075e0 (UNCONDITIONAL_CALL)  ; undefined FUN_100075e0()
    CALL __ioterm                       ; 100057ba
        ;   XREF to: 10007b00 (UNCONDITIONAL_CALL)  ; void __ioterm()
        ;   Label: LAB_100057ba
    CALL __mtterm                       ; 100057bf
        ;   XREF to: 10007760 (UNCONDITIONAL_CALL)  ; void __mtterm()
    CALL FUN_10007910                   ; 100057c4
        ;   XREF to: 10007910 (UNCONDITIONAL_CALL)  ; undefined FUN_10007910()
    ...
    PUSH 0x0                            ; 100057db
    CALL __freeptd                      ; 100057dd
        ;   XREF to: 10007820 (UNCONDITIONAL_CALL)  ; void __freeptd(_ptiddata _Ptd)
