...
;
; Parameters:
; SRenderVertex *  Stack[0x4]:4   src
; SScreenVertex *  Stack[0x8]:4   out
; uint             Stack[0xc]:4   render_flags
; int              Stack[0x10]:4   rhw_scale
; Local Variables:
; undefined4       Stack[-0x8]:4  local_8
; undefined4       Stack[-0x4]:4  local_4
;
; XREF[2]:
;   dll_dx7.cpp_APIDLLdrawPolygon2_FUN_100043c0 at 1000442f
;   dll_dx7.cpp_getOrAddVertex_FUN_10005010 at 1000506e
;
; Referenced Globals:
;   double DOUBLE_100122b8 = 1
;   double DOUBLE_100122c8 = 0.0000152587890625
;   double DOUBLE_100122d0 = 0.00156250000000000
;   double DOUBLE_100122d8 = 0.00208333333333333
...
section .text
    ...
    MOV ECX,dword ptr [ESP + 0x4]       ; 100044b0
        ;   Label: dll_dx7.cpp_buildTLVertex_FUN_100044b0
    ...
    PUSH EDI                            ; 100044c0
    FMUL double ptr [0x100122c8]        ; 100044c1 | DOUBLE_100122c8
    PUSH EBP                            ; 100044c7
    FSTP float ptr [ESI]                ; 100044c8
    FILD dword ptr [ECX + 0x14]         ; 100044ca
    FMUL double ptr [0x100122c8]        ; 100044cd | DOUBLE_100122c8
    ...
    LEA EAX,[EAX + EAX*0x2]             ; 100046a3
        ;   Label: LAB_100046a3
    MOV EBX,dword ptr [0x10215e40]      ; 100046a6 | g_ColorPalette
    ...
    FCOM double ptr [0x100122b8]        ; 10004749 | DOUBLE_100122b8
    ...
    FSUBR double ptr [0x100122b8]       ; 10004777 | DOUBLE_100122b8
    ...
    FMUL double ptr [0x100122e8]        ; 1000478a | DOUBLE_100122e8
    FSTP float ptr [ESI + 0x18]         ; 10004790
    FILD dword ptr [ESP + 0x10]         ; 10004793
    POP EBP                             ; 10004797
    POP EDI                             ; 10004798
    FMUL double ptr [0x100122e8]        ; 10004799 | DOUBLE_100122e8
