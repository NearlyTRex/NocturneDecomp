...
section .text
    ...
    CMP dword ptr [0x10014204],0x0      ; 100047b0 | g_InScene
        ;   Label: dll_dx7.cpp_flushBatch_FUN_100047b0
    PUSH ESI                            ; 100047b7
    JZ 0x100047fd                       ; 100047b8
        ;   XREF to: 100047fd (CONDITIONAL_JUMP)  ; LAB_100047fd
    MOV EAX,[0x10014228]                ; 100047ba | g_PendingVertexCount
    TEST EAX,EAX                        ; 100047bf
    JZ 0x100047fd                       ; 100047c1
        ;   XREF to: 100047fd (CONDITIONAL_JUMP)  ; LAB_100047fd
    PUSH 0x1c                           ; 100047c3
    MOV ECX,dword ptr [0x1001422c]      ; 100047c5 | g_PendingIndexCount
    PUSH ECX                            ; 100047cb
    PUSH 0x10238910                     ; 100047cc | g_IndexBuffer
    PUSH EAX                            ; 100047d1
    PUSH 0x1013b8d8                     ; 100047d2 | g_VertexBuffer
    PUSH 0x1c4                          ; 100047d7
    ...
    MOV dword ptr [0x10014228],0x0      ; 100047e9 | g_PendingVertexCount
    MOV dword ptr [0x1001422c],0x0      ; 100047f3 | g_PendingIndexCount
    POP ESI                             ; 100047fd
        ;   Label: LAB_100047fd
    RET                                 ; 100047fe
