// Name: dll_dx7.cpp_FUN_10003400
// Address: 10003400
// Address Range: [[10003400, 100035a3]]
// Convention: unknown
// Signature: undefined4 dll_dx7_cpp_FUN_10003400(void)

#include "nocturne.h"

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint dll_dx7_cpp_FUN_10003400(void)
  ...
  do {
    ...
    if (0x1f < local_80) {
      ...
      _DAT_10226a78 =
           (uint)
           (0xff / (ulonglong)
                   (local_7c.ddpfPixelFormat.dwRedYMask.dwRBitMask >> ((byte)g_HWRedShift & 0x1f)));
      g_HWGreenShift = 0;
