...
section .text
    ...
    MOV [0x100141bc],EAX                ; 100049fc | g_FogColorRed
    MOV dword ptr [0x100141c0],ECX      ; 10004a01 | g_FogColorGreen
    MOV dword ptr [0x100141c4],EDX      ; 10004a07 | g_FogColorBlue
    ...
    MOV EAX,[0x100141bc]                ; 10004a1b | g_FogColorRed
        ;   Label: LAB_10004a1b
    MOV ECX,dword ptr [0x100141c0]      ; 10004a20 | g_FogColorGreen
    SHL EAX,0x10                        ; 10004a26
    SHL ECX,0x8                         ; 10004a29
    OR EAX,ECX                          ; 10004a2c
    OR EAX,dword ptr [0x100141c4]       ; 10004a2e | g_FogColorBlue
    PUSH EAX                            ; 10004a34
    PUSH 0x22                           ; 10004a35
