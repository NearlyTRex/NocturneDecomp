...
section .text
    ...
    PUSH EAX                            ; 1000149d
    CALL dll_dx7.cpp_CDX7TextureCache_acquireSlot_FUN_10001090 ; 1000149e
    ...
    PUSH EAX                            ; 100014ae
    CALL dll_dx7.cpp_CDX7TextureCache_acquireSlot_FUN_10001090 ; 100014af
        ;   XREF to: 10001090 (UNCONDITIONAL_CALL)  ; int dll_dx7.cpp_CDX7TextureCache_acquireSlot_FUN_10001090(CDX7TextureCache * this_ptr, SMRGLTextureBasic * texture_info)
    RET                                 ; 100014b4
    ...
    PUSH EAX                            ; 100014bf
    CALL dll_dx7.cpp_CDX7TextureCache_acquireSlot_FUN_10001090 ; 100014c0
        ;   XREF to: 10001090 (UNCONDITIONAL_CALL)  ; int dll_dx7.cpp_CDX7TextureCache_acquireSlot_FUN_10001090(CDX7TextureCache * this_ptr, SMRGLTextureBasic * texture_info)
    RET                                 ; 100014c5
    ...
    PUSH EAX                            ; 100014d0
    CALL dll_dx7.cpp_CDX7TextureCache_acquireSlot_FUN_10001090 ; 100014d1
        ;   XREF to: 10001090 (UNCONDITIONAL_CALL)  ; int dll_dx7.cpp_CDX7TextureCache_acquireSlot_FUN_10001090(CDX7TextureCache * this_ptr, SMRGLTextureBasic * texture_info)
    RET                                 ; 100014d6
