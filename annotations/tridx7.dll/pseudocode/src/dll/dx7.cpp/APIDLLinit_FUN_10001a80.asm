...
;
; XREF[1]:
;   dll_dx7.cpp_APIDLLselectCard_FUN_100052c0 at 100052d5
;
; Referenced Globals:
...
section .text
    ...
    SUB ESP,0x430                       ; 10001a80
        ;   Label: dll_dx7.cpp_APIDLLinit_FUN_10001a80
    PUSH EBX                            ; 10001a86
    PUSH ESI                            ; 10001a87
    PUSH EDI                            ; 10001a88
    PUSH EBP                            ; 10001a89
    CALL dll_dx7.cpp_APIDLLkill_FUN_10002460 ; 10001a8a
    ...
    CALL dll_dx7.cpp_APIDLLkill_FUN_10002460 ; 10001c1f
        ;   XREF to: 10002460 (UNCONDITIONAL_CALL)  ; void dll_dx7.cpp_APIDLLkill_FUN_10002460() | Ordinal_20
    ...
    CALL dll_dx7.cpp_APIDLLkill_FUN_10002460 ; 10001c7b
        ;   XREF to: 10002460 (UNCONDITIONAL_CALL)  ; void dll_dx7.cpp_APIDLLkill_FUN_10002460() | Ordinal_20
