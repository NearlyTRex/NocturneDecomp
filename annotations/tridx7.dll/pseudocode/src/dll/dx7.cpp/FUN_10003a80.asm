...
;
; XREF[1]:
;   dll_dx7.cpp_FUN_100030e0 at 100030ea
;
; Referenced Globals:
...
section .text
    ...
    SUB ESP,0x94                        ; 10003a80
        ;   Label: dll_dx7.cpp_FUN_10003a80
    ...
    PUSH 0x10016ad0                     ; 10003aaa | = "Unknown texture size"
        ;   Label: caseD_21
    CALL dll_dx7.cpp_FUN_10002340       ; 10003aaf
    ...
    CALL dll_dx7.cpp_FUN_10002340       ; 10003b6d
        ;   XREF to: 10002340 (UNCONDITIONAL_CALL)  ; undefined dll_dx7.cpp_FUN_10002340()
