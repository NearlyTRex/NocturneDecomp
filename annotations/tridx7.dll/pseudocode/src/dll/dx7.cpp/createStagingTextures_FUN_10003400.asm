...
section .text
    ...
    SUB ESP,0x80                        ; 10003400
        ;   Label: dll_dx7.cpp_createStagingTextures_FUN_10003400
    PUSH EBX                            ; 10003406
    PUSH ESI                            ; 10003407
    PUSH EDI                            ; 10003408
    PUSH EBP                            ; 10003409
    CALL dll_dx7.cpp_releaseAllTextures_FUN_10002ea0 ; 1000340a
    ...
    LEA ECX,[EBP + 0x10138f30]          ; 1000348a | g_StagingTextureInterfaces
    PUSH ECX                            ; 10003490
    ...
    MOV [0x10226a78],EAX                ; 100034e9 | g_HWRedScale
    ...
    MOV [0x102268b0],EAX                ; 10003515 | g_HWGreenScale
    ...
    RET                                 ; 10003571
    MOV dword ptr [0x1013b8d0],0x0      ; 10003572 | g_HWAlphaMask
        ;   Label: LAB_10003572
    MOV dword ptr [0x10014214],0x0      ; 1000357c | g_TextureCount
        ;   Label: LAB_1000357c
    MOV EAX,dword ptr [ESP + 0x68]      ; 10003586
    MOV [0x10240628],EAX                ; 1000358a | g_HWTextureBitDepth
