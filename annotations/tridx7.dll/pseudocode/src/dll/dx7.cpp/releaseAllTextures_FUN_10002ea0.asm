...
section .text
    ...
    PUSH EBX                            ; 10002ea0
        ;   Label: dll_dx7.cpp_releaseAllTextures_FUN_10002ea0
    PUSH ESI                            ; 10002ea1
    PUSH EDI                            ; 10002ea2
    ...
    MOV EAX,dword ptr [EBX + 0x10138f30] ; 10002eac | g_StagingTextureInterfaces | g_StagingTextureInterfaces[1][0] | g_StagingTextureInterfaces[0][1]
        ;   Label: LAB_10002eac
    ...
    MOV dword ptr [EBX + 0x10138f30],0x0 ; 10002ebc | g_StagingTextureInterfaces
    ...
    ADD ESI,0x8                         ; 10002f19
        ;   Label: LAB_10002f19
    CMP ESI,0x10215e40                  ; 10002f1c | g_ColorPalette
