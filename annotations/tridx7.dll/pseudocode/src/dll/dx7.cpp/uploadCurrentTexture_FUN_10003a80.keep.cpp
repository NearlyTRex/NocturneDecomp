...

{
  ...
  while( true ) {
    ...
    if (g_TexturePixelFormat.dwBitCount.dwRGBBitCount == 0x20) {
      dll_dx7_cpp_copyMipTo32Bit_FUN_10003e40
                ((uint *)local_7c.lpSurface,local_7c.dwPitchOrLinearSize.dwLinearSize,
                 local_7c.dwWidth);
    }
    else {
      dll_dx7_cpp_convertMipTo16Bit_FUN_10003d90
                ((ushort *)local_7c.lpSurface,local_7c.dwPitchOrLinearSize.dwLinearSize,
                 local_7c.dwWidth);
    }
    ...
    if (g_DirectTextureFlag == 0) {
      ...
      HVar2 = (*local_90->vtable->GetAttachedSurface)
                        (local_90,(DDSCAPS *)&local_7c.ddsCaps,&local_90);
      dll_dx7_cpp_checkD3DResult_FUN_10001d70(HVar2);
      pIVar1 = local_90;
    }
    else {
  ...
  if ((int)(sizeof(g_StagingTextures) / sizeof(g_StagingTextures[0])) <= g_StagingSetIndex) {
    g_StagingSetIndex = 0;
  }
  return;
}
