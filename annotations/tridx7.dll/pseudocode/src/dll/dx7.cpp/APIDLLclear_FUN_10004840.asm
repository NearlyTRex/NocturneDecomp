...
section .text
    ...
    SUB ESP,0xc0                        ; 10004840
        ;   Label: dll_dx7.cpp_APIDLLclear_FUN_10004840
    XOR EDX,EDX                         ; 10004846
    CMP dword ptr [0x10014204],EDX      ; 10004848 | g_InScene
    PUSH EDI                            ; 1000484e
    ...
    PUSH EDX                            ; 100048c5
    CALL dll_dx7.cpp_APIDLLdrawPolygon_FUN_10004380 ; 100048c6
        ;   XREF to: 10004380 (UNCONDITIONAL_CALL)  ; int dll_dx7.cpp_APIDLLdrawPolygon_FUN_10004380(SRenderVertex * vertices, int vertex_count, int render_flags) | Ordinal_13
