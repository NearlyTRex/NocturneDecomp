...
section .text
    ...
    SUB ESP,0x210                       ; 10002500
        ;   Label: dll_dx7.cpp_APIDLLsetVideoMode_FUN_10002500
    ...
    MOV ECX,dword ptr [0x1001418c]      ; 10002a62 | g_PrimarySurface
    PUSH EAX                            ; 10002a68
    ...
    CALL dll_dx7.cpp_APIDLLclear_FUN_10004840 ; 10002afe
        ;   XREF to: 10004840 (UNCONDITIONAL_CALL)  ; int dll_dx7.cpp_APIDLLclear_FUN_10004840() | Ordinal_8
        ;   Label: LAB_10002afe
    CALL dll_dx7.cpp_APIDLLtoggle_FUN_100024b0 ; 10002b03
        ;   XREF to: 100024b0 (UNCONDITIONAL_CALL)  ; int dll_dx7.cpp_APIDLLtoggle_FUN_100024b0() | Ordinal_34
    DEC ESI                             ; 10002b08
