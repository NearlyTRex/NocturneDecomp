...
;   dll_dx7.cpp_FUN_10003a80 at 10003bf2
;
; Referenced Globals:
...
section .text
    ...
    MOV EAX,dword ptr [ESP + 0x4]       ; 10001d70
        ;   Label: dll_dx7.cpp_FUN_10001d70
