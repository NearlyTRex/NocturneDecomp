...
section .text
    ...
    PUSH EBP                            ; 10011082
    PUSH ESI                            ; 10011083
    CALL FUN_10011330                   ; 10011084
        ;   XREF to: 10011330 (UNCONDITIONAL_CALL)  ; undefined FUN_10011330()
