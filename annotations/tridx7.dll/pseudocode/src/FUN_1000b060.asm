...
section .text
    ...
    PUSH 0x3                            ; 1000b0a4
    PUSH EDX                            ; 1000b0a6
    CALL FUN_1000b330                   ; 1000b0a7
        ;   XREF to: 1000b330 (UNCONDITIONAL_CALL)  ; undefined FUN_1000b330()
