...
;
; XREF[1]:
;   APIDLLsetVideoMode at 10002a99
;
; Referenced Globals:
...
section .text
    ...
    PUSH EDI                            ; 10003112
    PUSH 0x0                            ; 10003113
    PUSH 0x100141e0                     ; 10003115 | DAT_100141e0
    PUSH EAX                            ; 1000311a
    ...
    LEA EAX,[ESP + 0x8]                 ; 10003135
        ;   Label: LAB_10003135
    MOV ECX,dword ptr [0x100141e0]      ; 10003139 | DAT_100141e0
    ...
    MOV EAX,[0x100141e4]                ; 10003195 | DAT_100141e4
        ;   Label: LAB_10003195
    MOV ECX,dword ptr [0x100141e0]      ; 1000319a | DAT_100141e0
    PUSH EAX                            ; 100031a0
    PUSH ECX                            ; 100031a1
    ...
    MOV EAX,[0x100141e4]                ; 1000323f | DAT_100141e4
        ;   Label: LAB_1000323f
    MOV ECX,dword ptr [0x100141e0]      ; 10003244 | DAT_100141e0
    PUSH EAX                            ; 1000324a
    PUSH ECX                            ; 1000324b
    ...
    CALL FUN_10003400                   ; 1000330b
        ;   XREF to: 10003400 (UNCONDITIONAL_CALL)  ; undefined FUN_10003400()
        ;   Label: LAB_1000330b
    ...
    RET                                 ; 1000331e
    CALL FUN_100035b0                   ; 1000331f
        ;   XREF to: 100035b0 (UNCONDITIONAL_CALL)  ; undefined FUN_100035b0()
        ;   Label: LAB_1000331f
    POP EDI                             ; 10003324
