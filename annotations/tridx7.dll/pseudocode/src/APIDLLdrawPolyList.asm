...
section .text
    ...
    SUB ESP,0xc                         ; 10004f00
        ;   Label: APIDLLdrawPolyList
    CMP dword ptr [0x10014204],0x0      ; 10004f03 | DAT_10014204
    PUSH EBX                            ; 10004f0a
    PUSH ESI                            ; 10004f0b
    PUSH EDI                            ; 10004f0c
    PUSH EBP                            ; 10004f0d
