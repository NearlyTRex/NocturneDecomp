...
; Parameters:
; int              Stack[0x4]:4   _C
; int              Stack[0x8]:4   _Type
; Local Variables:
; undefined4       Stack[-0x6]:4  local_6
; undefined1       Stack[-0x2]:1  local_2
;
; XREF[4]:
;   FUN_1000f6e0 at 1000f83c
;   FUN_1000fe60 at 1000fe7c
;   ___strgtold12 at 1000c94e
;   __tolower_lk at 10009c19
;
; Referenced Globals:
...
section .text
    ...
    PUSH EAX                            ; 10009b29
    PUSH 0x1                            ; 10009b2a
    CALL ___crtGetStringTypeA           ; 10009b2c
        ;   XREF to: 1000bfc0 (UNCONDITIONAL_CALL)  ; BOOL ___crtGetStringTypeA(_locale_t _Plocinfo, DWORD _DWInfoType, LPCSTR _LpSrcStr, int _CchSrc, ...)
