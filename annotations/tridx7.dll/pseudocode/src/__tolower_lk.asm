...
;
; XREF[2]:
;   FUN_1000ff20 at 1000ffac
;   _tolower at 10009bb6
;
; Referenced Globals:
...
section .text
    ...
    PUSH 0x100                          ; 10009c86
    PUSH EDX                            ; 10009c8b
    CALL FUN_1000c340                   ; 10009c8c
        ;   XREF to: 1000c340 (UNCONDITIONAL_CALL)  ; undefined FUN_1000c340()
