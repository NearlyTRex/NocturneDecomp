...
;                               FUNCTION
; *****************************************************************************
; undefined4 FUN_10010d30(void)
;
;
; XREF[2]:
;   FUN_10010c50 at 10010c67
;   FUN_10011360 at 100113da
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 10010d87
    CALL FUN_10011360                   ; 10010d88
        ;   XREF to: 10011360 (UNCONDITIONAL_CALL)  ; undefined FUN_10011360()
