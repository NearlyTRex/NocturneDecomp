...
;
; Parameters:
; LPCSTR           Stack[0x4]:4   lp_text
; LPCSTR           Stack[0x8]:4   lp_caption
; UINT             Stack[0xc]:4   u_type
;
; XREF[1]:
;   crt_startup.c__NMSG_WRITE_FUN_10008610 at 100087a4
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 1000a950
        ;   Label: crt_system.c__crtMessageBoxA_FUN_1000a950
    PUSH ESI                            ; 1000a951
    PUSH EDI                            ; 1000a952
