...
;
; XREF[2]:
;   crt_startup.c__FF_MSGBANNER_FUN_100085d0 at 100085ec
;   crt_startup.c__amsg_exit_FUN_100058c0 at 100058e1
;
; Referenced Globals:
...
;   crt_system.c__crtMessageBoxA_FUN_1000a950
;   GetModuleFileNameA
;   GetStdHandle
;   WriteFile
;
...
section .text
    ...
    SUB ESP,0x1a8                       ; 10008610
        ;   Label: crt_startup.c__NMSG_WRITE_FUN_10008610
    ...
    PUSH EBP                            ; 100086e6
    CALL crt_string.c__strncpy_FUN_1000a9f0 ; 100086e7
    ...
    PUSH EAX                            ; 100087a3
    CALL crt_system.c__crtMessageBoxA_FUN_1000a950 ; 100087a4
        ;   XREF to: 1000a950 (UNCONDITIONAL_CALL)  ; int crt_system.c__crtMessageBoxA_FUN_1000a950(LPCSTR lp_text, LPCSTR lp_caption, UINT u_type)
