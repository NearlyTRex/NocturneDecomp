...
; int              Stack[0x8]:4   quick
; int              Stack[0xc]:4   retcaller
;
; XREF[2]:
;   crt_startup.c__cexit_FUN_100075e0 at 100075e6
;   crt_startup.c__exit_crt_FUN_100075c0 at 100075c9
;
; Referenced Globals:
...
;   crt_startup.c__lockexit_FUN_100076c0
;   crt_startup.c__unlockexit_FUN_100076d0
;   ExitProcess
;   GetCurrentProcess
;   TerminateProcess
;
...
section .text
    ...
    PUSH EBX                            ; 10007600
        ;   Label: crt_startup.c_doexit_FUN_10007600
    PUSH ESI                            ; 10007601
    PUSH EDI                            ; 10007602
    CALL crt_startup.c__lockexit_FUN_100076c0 ; 10007603
        ;   XREF to: 100076c0 (UNCONDITIONAL_CALL)  ; void crt_startup.c__lockexit_FUN_100076c0()
    ...
    CALL crt_startup.c__initterm_FUN_100076e0 ; 10007675
    ...
    CALL crt_startup.c__initterm_FUN_100076e0 ; 10007687
        ;   XREF to: 100076e0 (UNCONDITIONAL_CALL)  ; void crt_startup.c__initterm_FUN_100076e0(char * pfbegin, char * pfend)
    ADD ESP,0x8                         ; 1000768c
    TEST EBX,EBX                        ; 1000768f
    JZ 0x1000769c                       ; 10007691
        ;   XREF to: 1000769c (CONDITIONAL_JUMP)  ; LAB_1000769c
    CALL crt_startup.c__unlockexit_FUN_100076d0 ; 10007693
        ;   XREF to: 100076d0 (UNCONDITIONAL_CALL)  ; void crt_startup.c__unlockexit_FUN_100076d0()
    POP EDI                             ; 10007698
    POP ESI                             ; 10007699
    POP EBX                             ; 1000769a
    RET                                 ; 1000769b
