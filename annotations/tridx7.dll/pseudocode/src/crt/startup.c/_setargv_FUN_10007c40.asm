...
;
; XREF[1]:
;   crt_startup.c___CRTDLL_INIT_FUN_100056a0 at 10005778
;
; Referenced Globals:
...
;   crt_stdlib.c_parse_cmdline_FUN_10007ce0
;   GetModuleFileNameA
;
; *****************************************************************************
...
section .text
    ...
    SUB ESP,0x8                         ; 10007c40
        ;   Label: crt_startup.c__setargv_FUN_10007c40
    PUSH ESI                            ; 10007c43
    PUSH EDI                            ; 10007c44
    PUSH 0x104                          ; 10007c45
    ...
    CALL crt_stdlib.c_parse_cmdline_FUN_10007ce0 ; 10007c7d
        ;   XREF to: 10007ce0 (UNCONDITIONAL_CALL)  ; void crt_stdlib.c_parse_cmdline_FUN_10007ce0(char * cmdstart, char * * argv, char * args, int * pnumargs, ...)
    MOV EAX,dword ptr [ESP + 0x1c]      ; 10007c82
    ADD ESP,0x14                        ; 10007c86
    SHL EAX,0x2                         ; 10007c89
    ADD EAX,dword ptr [ESP + 0xc]       ; 10007c8c
    PUSH EAX                            ; 10007c90
    CALL crt_heap.c_malloc_FUN_10008830 ; 10007c91
    ...
    PUSH 0x8                            ; 10007c9f
    CALL crt_startup.c__amsg_exit_FUN_100058c0 ; 10007ca1
    ...
    PUSH EDI                            ; 10007cbb
    PUSH ESI                            ; 10007cbc
    CALL crt_stdlib.c_parse_cmdline_FUN_10007ce0 ; 10007cbd
        ;   XREF to: 10007ce0 (UNCONDITIONAL_CALL)  ; void crt_stdlib.c_parse_cmdline_FUN_10007ce0(char * cmdstart, char * * argv, char * args, int * pnumargs, ...)
