...
;
; Parameters:
; uint             Stack[0x4]:4   xcpt_num
; _EXCEPTION_POINTERS * Stack[0x8]:4   pxcpt_ptrs
;
; Referenced Globals:
...
;
; Called Functions:
;   crt_signal.c__xcptlookup_FUN_1000a900
...
section .text
    ...
    PUSH EBX                            ; 1000a7b0
        ;   Label: crt_signal.c__XcptFilter_FUN_1000a7b0
    PUSH ESI                            ; 1000a7b1
    PUSH EDI                            ; 1000a7b2
    PUSH EBP                            ; 1000a7b3
    CALL crt_thread.c__getptd_FUN_100077b0 ; 1000a7b4
    ...
    PUSH EAX                            ; 1000a7c2
    PUSH ECX                            ; 1000a7c3
    CALL crt_signal.c__xcptlookup_FUN_1000a900 ; 1000a7c4
        ;   XREF to: 1000a900 (UNCONDITIONAL_CALL)  ; void * crt_signal.c__xcptlookup_FUN_1000a900(void * table, int xcpt_num)
