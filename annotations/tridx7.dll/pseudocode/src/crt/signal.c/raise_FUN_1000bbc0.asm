...
;
; Called Functions:
;   crt_signal.c_siglookup_FUN_1000bda0
...
section .text
    ...
    SUB ESP,0xc                         ; 1000bbc0
        ;   Label: crt_signal.c_raise_FUN_1000bbc0
    PUSH EBX                            ; 1000bbc3
    PUSH ESI                            ; 1000bbc4
    PUSH EDI                            ; 1000bbc5
    ...
    CALL crt_thread.c__getptd_FUN_100077b0 ; 1000bc01
    ...
    PUSH EAX                            ; 1000bc0b
    PUSH EDI                            ; 1000bc0c
    CALL crt_signal.c_siglookup_FUN_1000bda0 ; 1000bc0d
        ;   XREF to: 1000bda0 (UNCONDITIONAL_CALL)  ; _XCPT_ACTION * crt_signal.c_siglookup_FUN_1000bda0(int signum, _XCPT_ACTION * table)
    ...
    PUSH 0x1                            ; 1000bc5c
    CALL crt_thread.c__lock_FUN_100059a0 ; 1000bc5e
    ...
    PUSH 0x1                            ; 1000bc6f
    CALL crt_thread.c__unlock_FUN_10005a10 ; 1000bc71
    ...
    PUSH 0x1                            ; 1000bc8b
    CALL crt_thread.c__unlock_FUN_10005a10 ; 1000bc8d
        ;   XREF to: 10005a10 (UNCONDITIONAL_CALL)  ; void crt_thread.c__unlock_FUN_10005a10(int locknum)
    ADD ESP,0x4                         ; 1000bc92
    PUSH 0x3                            ; 1000bc95
        ;   Label: LAB_1000bc95
    CALL crt_startup.c__exit_crt_FUN_100075c0 ; 1000bc97
        ;   XREF to: 100075c0 (UNCONDITIONAL_CALL)  ; void crt_startup.c__exit_crt_FUN_100075c0(int code)
    ...
    PUSH 0x1                            ; 1000bd1a
    CALL crt_thread.c__unlock_FUN_10005a10 ; 1000bd1c
        ;   XREF to: 10005a10 (UNCONDITIONAL_CALL)  ; void crt_thread.c__unlock_FUN_10005a10(int locknum)
