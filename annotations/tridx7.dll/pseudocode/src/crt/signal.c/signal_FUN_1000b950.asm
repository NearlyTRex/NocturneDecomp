...
section .text
    ...
    SUB ESP,0x4                         ; 1000b950
        ;   Label: crt_signal.c_signal_FUN_1000b950
    PUSH EBX                            ; 1000b953
    PUSH ESI                            ; 1000b954
    PUSH EDI                            ; 1000b955
    PUSH EBP                            ; 1000b956
    ...
    JNZ 0x1000ba94                      ; 1000b9a2
        ;   XREF to: 1000ba94 (CONDITIONAL_JUMP)  ; LAB_1000ba94
    CALL crt_thread.c__getptd_FUN_100077b0 ; 1000b9a8
    ...
    PUSH EAX                            ; 1000b9bf
    CALL crt_heap.c_malloc_FUN_10008830 ; 1000b9c0
    ...
    PUSH EAX                            ; 1000b9f8
    PUSH EBX                            ; 1000b9f9
    CALL crt_signal.c_siglookup_FUN_1000bda0 ; 1000b9fa
    ...
    PUSH 0x1                            ; 1000ba2b
        ;   Label: LAB_1000ba2b
    CALL crt_thread.c__lock_FUN_100059a0 ; 1000ba2d
    ...
    JMP dword ptr [EAX*0x4 + 0x1000bafc] ; 1000ba74 | caseD_2 | caseD_14 | caseD_f
        ;   Label: switchD
    CALL crt_errno.c___doserrno_FUN_10008a30 ; 1000ba7b
    ...
    PUSH 0x1                            ; 1000bae8
        ;   Label: LAB_1000bae8
    CALL crt_thread.c__unlock_FUN_10005a10 ; 1000baea
        ;   XREF to: 10005a10 (UNCONDITIONAL_CALL)  ; void crt_thread.c__unlock_FUN_10005a10(int locknum)
