...
;
; XREF[1]:
;   crt_signal.c_signal_FUN_1000b950 at 1000ba4a
;
; Referenced Globals:
...
section .text
    ...
    PUSH ESI                            ; 1000bb30
        ;   Label: crt_signal.c_siglookup2_FUN_1000bb30
    PUSH EDI                            ; 1000bb31
    PUSH 0x1                            ; 1000bb32
    CALL crt_thread.c__lock_FUN_100059a0 ; 1000bb34
    ...
    PUSH 0x1                            ; 1000bb69
    CALL crt_thread.c__unlock_FUN_10005a10 ; 1000bb6b
    ...
    CALL crt_thread.c__unlock_FUN_10005a10 ; 1000bb87
        ;   XREF to: 10005a10 (UNCONDITIONAL_CALL)  ; void crt_thread.c__unlock_FUN_10005a10(int locknum)
    ...
    PUSH 0x1                            ; 1000bb9f
        ;   Label: LAB_1000bb9f
    CALL crt_thread.c__unlock_FUN_10005a10 ; 1000bba1
        ;   XREF to: 10005a10 (UNCONDITIONAL_CALL)  ; void crt_thread.c__unlock_FUN_10005a10(int locknum)
