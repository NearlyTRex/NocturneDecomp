...
section .text
    ...
    SUB ESP,0x8                         ; 100081e0
        ;   Label: crt_env.c___crtGetEnvironmentStringsW_FUN_100081e0
    PUSH EBX                            ; 100081e3
    PUSH ESI                            ; 100081e4
    PUSH EDI                            ; 100081e5
    ...
    PUSH EBP                            ; 10008275
    CALL crt_heap.c_malloc_FUN_10008830 ; 10008276
    ...
    PUSH EAX                            ; 10008327
    CALL crt_heap.c_malloc_FUN_10008830 ; 10008328
        ;   XREF to: 10008830 (UNCONDITIONAL_CALL)  ; void * crt_heap.c_malloc_FUN_10008830(size_t size)
    ...
    CALL crt_string.c_wcslen_FUN_1000a930 ; 10008395
    ...
    MOV EAX,dword ptr [ESP + 0x10]      ; 100083bf
        ;   Label: LAB_100083bf
    PUSH EAX                            ; 100083c3
    CALL crt_heap.c_free_FUN_10005b30   ; 100083c4
