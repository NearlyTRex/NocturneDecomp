...
;
; Parameters:
; char * *         Stack[0x4]:4   oldenviron
;
; XREF[1]:
;   crt_env.c___crtsetenv_FUN_10011360 at 100113b0
;
; Called Functions:
;   crt_heap.c_malloc_FUN_10008830
;   crt_startup.c__amsg_exit_FUN_100058c0
;   crt_string.c__strdup_FUN_100117b0
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 10011610
        ;   Label: crt_env.c_copy_environ_FUN_10011610
    ...
    LEA EAX,[EAX*0x4 + 0x4]             ; 10011630
        ;   Label: LAB_10011630
    PUSH EAX                            ; 10011637
    CALL crt_heap.c_malloc_FUN_10008830 ; 10011638
    ...
    PUSH 0x9                            ; 10011648
    CALL crt_startup.c__amsg_exit_FUN_100058c0 ; 1001164a
    ...
    CALL crt_string.c__strdup_FUN_100117b0 ; 10011662
        ;   XREF to: 100117b0 (UNCONDITIONAL_CALL)  ; char * crt_string.c__strdup_FUN_100117b0(char * s)
