...
;
; XREF[1]:
;   crt_startup.c___CRTDLL_INIT_FUN_100056a0 at 1000577d
;
; Referenced Globals:
...
section .text
    ...
    SUB ESP,0x4                         ; 10007b60
        ;   Label: crt_env.c__setenvp_FUN_10007b60
    ...
    LEA EAX,[EDX*0x4 + 0x4]             ; 10007b8f
        ;   Label: LAB_10007b8f
    PUSH EAX                            ; 10007b96
    CALL crt_heap.c_malloc_FUN_10008830 ; 10007b97
    ...
    PUSH 0x9                            ; 10007baa
    CALL crt_startup.c__amsg_exit_FUN_100058c0 ; 10007bac
    ...
    PUSH ECX                            ; 10007bd9
    CALL crt_heap.c_malloc_FUN_10008830 ; 10007bda
        ;   XREF to: 10008830 (UNCONDITIONAL_CALL)  ; void * crt_heap.c_malloc_FUN_10008830(size_t size)
    ...
    PUSH 0x9                            ; 10007be8
    CALL crt_startup.c__amsg_exit_FUN_100058c0 ; 10007bea
        ;   XREF to: 100058c0 (UNCONDITIONAL_CALL)  ; void crt_startup.c__amsg_exit_FUN_100058c0(int rterrnum)
    ...
    MOV EAX,[0x10016c64]                ; 10007c20 | DAT_10016c64
        ;   Label: LAB_10007c20
    PUSH EAX                            ; 10007c25
    CALL crt_heap.c_free_FUN_10005b30   ; 10007c26
