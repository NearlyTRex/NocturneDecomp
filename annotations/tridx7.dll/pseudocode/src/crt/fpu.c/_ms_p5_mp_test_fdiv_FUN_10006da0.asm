...
;
; Called Functions:
;   crt_math.c__ms_p5_test_fdiv_FUN_10006d50
;   GetModuleHandleA
;   GetProcAddress
;
; *****************************************************************************
...
section .text
    ...
    SUB ESP,0x14                        ; 10006da0
        ;   Label: crt_fpu.c__ms_p5_mp_test_fdiv_FUN_10006da0
    MOV dword ptr [ESP + 0x10],0x0      ; 10006da3
    PUSH EBX                            ; 10006dab
    PUSH ESI                            ; 10006dac
    PUSH EDI                            ; 10006dad
    PUSH EBP                            ; 10006dae
    CALL crt_math.c__ms_p5_test_fdiv_FUN_10006d50 ; 10006daf
        ;   XREF to: 10006d50 (UNCONDITIONAL_CALL)  ; int crt_math.c__ms_p5_test_fdiv_FUN_10006d50()
    ...
    PUSH EAX                            ; 10006e8c
    CALL EDI                            ; 10006e8d
    CALL crt_math.c__ms_p5_test_fdiv_FUN_10006d50 ; 10006e8f
        ;   XREF to: 10006d50 (UNCONDITIONAL_CALL)  ; int crt_math.c__ms_p5_test_fdiv_FUN_10006d50()
