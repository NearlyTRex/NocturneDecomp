...
;
; XREF[3]:
;   crt_heap.c__nh_malloc_FUN_10008850 at 1000887f
;   crt_heap.c_calloc_FUN_1000a750 at 1000a78c
;   crt_heap.c_realloc_FUN_10011680 at 100116d8
;
; Referenced Globals:
...
section .text
    ...
    PUSH 0x9                            ; 1000ab30
        ;   Label: crt_heap.c__callnewh_FUN_1000ab30
    CALL crt_thread.c__lock_FUN_100059a0 ; 1000ab32
    ...
    JZ 0x1000ab61                       ; 1000ab4f
        ;   XREF to: 1000ab61 (CONDITIONAL_JUMP)  ; LAB_1000ab61
    PUSH 0x9                            ; 1000ab51
    CALL crt_thread.c__unlock_FUN_10005a10 ; 1000ab53
    ...
    PUSH 0x9                            ; 1000ab61
        ;   Label: LAB_1000ab61
    CALL crt_thread.c__unlock_FUN_10005a10 ; 1000ab63
        ;   XREF to: 10005a10 (UNCONDITIONAL_CALL)  ; void crt_thread.c__unlock_FUN_10005a10(int locknum)
