...
;
; XREF[1]:
;   crt_env.c___crtsetenv_FUN_10011360 at 100114be
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 10011680
        ;   Label: crt_heap.c_realloc_FUN_10011680
    PUSH ESI                            ; 10011681
    ...
    PUSH EDI                            ; 1001168f
    CALL crt_heap.c_malloc_FUN_10008830 ; 10011690
    ...
    PUSH ESI                            ; 100116a0
    CALL crt_heap.c_free_FUN_10005b30   ; 100116a1
    ...
    JZ 0x100116eb                       ; 100116d5
        ;   XREF to: 100116eb (CONDITIONAL_JUMP)  ; LAB_100116eb
    PUSH EDI                            ; 100116d7
    CALL crt_heap.c__callnewh_FUN_1000ab30 ; 100116d8
