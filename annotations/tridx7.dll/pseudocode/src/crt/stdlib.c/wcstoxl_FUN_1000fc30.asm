...
;
; XREF[2]:
;   crt_stdlib.c_wcstol_FUN_1000fc10 at 1000fc21
;   crt_stdlib.c_wcstoul_FUN_1000fe40 at 1000fe51
;
; Called Functions:
;   crt_ctype.c_iswctype_FUN_10010870
;   crt_ctype.c_towupper_FUN_10010750
...
section .text
    ...
    MOV EAX,dword ptr [ESP + 0x4]       ; 1000fc30
        ;   Label: crt_stdlib.c_wcstoxl_FUN_1000fc30
    ...
    PUSH 0x8                            ; 1000fc43
    PUSH EDI                            ; 1000fc45
    CALL crt_ctype.c_iswctype_FUN_10010870 ; 1000fc46
    ...
    PUSH 0x8                            ; 1000fc59
    PUSH EDI                            ; 1000fc5b
    CALL crt_ctype.c_iswctype_FUN_10010870 ; 1000fc5c
        ;   XREF to: 10010870 (UNCONDITIONAL_CALL)  ; int crt_ctype.c_iswctype_FUN_10010870(wint_t c, wctype_t mask)
    ...
    PUSH 0x4                            ; 1000fd1f
        ;   Label: LAB_1000fd1f
    PUSH EDI                            ; 1000fd21
    CALL crt_ctype.c_iswctype_FUN_10010870 ; 1000fd22
        ;   XREF to: 10010870 (UNCONDITIONAL_CALL)  ; int crt_ctype.c_iswctype_FUN_10010870(wint_t c, wctype_t mask)
    ...
    PUSH 0x103                          ; 1000fd36
        ;   Label: LAB_1000fd36
    PUSH EDI                            ; 1000fd3b
    CALL crt_ctype.c_iswctype_FUN_10010870 ; 1000fd3c
        ;   XREF to: 10010870 (UNCONDITIONAL_CALL)  ; int crt_ctype.c_iswctype_FUN_10010870(wint_t c, wctype_t mask)
    ...
    PUSH EDI                            ; 1000fd48
    CALL crt_ctype.c_towupper_FUN_10010750 ; 1000fd49
        ;   XREF to: 10010750 (UNCONDITIONAL_CALL)  ; wint_t crt_ctype.c_towupper_FUN_10010750(wint_t c)
    ...
    JBE 0x1000fe00                      ; 1000fdd0
        ;   XREF to: 1000fe00 (CONDITIONAL_JUMP)  ; LAB_1000fe00
    CALL crt_errno.c__errno_FUN_10008a20 ; 1000fdd2
