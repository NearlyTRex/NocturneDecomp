...
;
; Parameters:
; char *           Stack[0x4]:4   cmdstart
; char * *         Stack[0x8]:4   argv
; char *           Stack[0xc]:4   args
; int *            Stack[0x10]:4   pnumargs
; int *            Stack[0x14]:4   pnumchars
;
; XREF[1]:
;   crt_startup.c__setargv_FUN_10007c40 at 10007c7d
;
; Referenced Globals:
...
section .text
    ...
    MOV EAX,dword ptr [ESP + 0x14]      ; 10007ce0
        ;   Label: crt_stdlib.c_parse_cmdline_FUN_10007ce0
    PUSH EBX                            ; 10007ce4
