...
;
; XREF[2]:
;   crt_stdlib.c_atoi_FUN_1000ff10 at 1000ff15
;   crt_time.c__tzset_FUN_10010050 at 1001024f
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 1000fe60
        ;   Label: crt_stdlib.c_atol_FUN_1000fe60
    PUSH ESI                            ; 1000fe61
    ...
    PUSH EAX                            ; 1000fe7b
    CALL crt_ctype.c__isctype_FUN_10009ac0 ; 1000fe7c
    ...
    PUSH 0x4                            ; 1000fec1
    PUSH EBX                            ; 1000fec3
    CALL crt_ctype.c__isctype_FUN_10009ac0 ; 1000fec4
        ;   XREF to: 10009ac0 (UNCONDITIONAL_CALL)  ; int crt_ctype.c__isctype_FUN_10009ac0(int c, int type)
