...
;
; XREF[3]:
;   crt_locale.c_GetLcidFromCountry_FUN_1000e6b0 at 1000e6d3
;   crt_locale.c_GetLcidFromLanguage_FUN_1000e650 at 1000e673
;   crt_time.c__expand_locale_picture_FUN_1000f3c0 at 1000f4a2
;
; Referenced Globals:
...
;
; Called Functions:
;   crt_ctype.c__tolower_lk_FUN_10009be0
...
section .text
    ...
    PUSH EBP                            ; 1000ff20
        ;   Label: crt_string.c__stricmp_FUN_1000ff20
    ...
    PUSH 0x13                           ; 1000ff86
        ;   Label: LAB_1000ff86
    CALL crt_thread.c__lock_FUN_100059a0 ; 1000ff88
    ...
    PUSH EAX                            ; 1000ffaa
    PUSH EBX                            ; 1000ffab
    CALL crt_ctype.c__tolower_lk_FUN_10009be0 ; 1000ffac
        ;   XREF to: 10009be0 (UNCONDITIONAL_CALL)  ; uint crt_ctype.c__tolower_lk_FUN_10009be0(uint c)
    MOV EBX,EAX                         ; 1000ffb1
    ADD ESP,0x4                         ; 1000ffb3
    CALL crt_ctype.c__tolower_lk_FUN_10009be0 ; 1000ffb6
        ;   XREF to: 10009be0 (UNCONDITIONAL_CALL)  ; uint crt_ctype.c__tolower_lk_FUN_10009be0(uint c)
    ...
    PUSH 0x13                           ; 1000ffd6
        ;   Label: LAB_1000ffd6
    CALL crt_thread.c__unlock_FUN_10005a10 ; 1000ffd8
