...
;
; Parameters:
; int              Stack[0x4]:4   trantype
; int              Stack[0x8]:4   datetype
; int              Stack[0xc]:4   year
; int              Stack[0x10]:4   month
; int              Stack[0x14]:4   week
; int              Stack[0x18]:4   weekday
; int              Stack[0x1c]:4   date
; int              Stack[0x20]:4   hour
; int              Stack[0x24]:4   min
; int              Stack[0x28]:4   sec
; int              Stack[0x2c]:4   msec
; Local Variables:
; undefined4       Stack[-0x4]:4  local_4
;
; XREF[1]:
;   crt_time.c__isindst_lk_FUN_10010360 at 10010425
;
; Referenced Globals:
...
section .text
    ...
    MOV ECX,dword ptr [ESP + 0xc]       ; 100105c0
        ;   Label: crt_time.c_cvtdate_FUN_100105c0
