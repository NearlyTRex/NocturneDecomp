...
; uint             Stack[0x8]:4   width
; char * *         Stack[0xc]:4   buf
; size_t *         Stack[0x10]:4   count
;
; XREF[1]:
;   crt_time.c__expandtime_FUN_1000ed30 at 1000edd4
;
; Referenced Globals:
;   undefined4 DAT_10018214
;
; Called Functions:
;   crt_time.c__store_number_rev_FUN_1000f360
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 1000f2d0
        ;   Label: crt_time.c__store_number_FUN_1000f2d0
    PUSH ESI                            ; 1000f2d1
    PUSH EDI                            ; 1000f2d2
    PUSH EBP                            ; 1000f2d3
    ...
    PUSH EBX                            ; 1000f2eb
    PUSH ECX                            ; 1000f2ec
    CALL crt_time.c__store_number_rev_FUN_1000f360 ; 1000f2ed
        ;   XREF to: 1000f360 (UNCONDITIONAL_CALL)  ; void crt_time.c__store_number_rev_FUN_1000f360(int value, char * * buf, size_t * count)
