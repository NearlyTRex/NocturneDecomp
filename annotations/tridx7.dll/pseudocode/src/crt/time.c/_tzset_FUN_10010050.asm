...
;
; XREF[1]:
;   crt_time.c___tzset_FUN_1000fff0 at 1001000c
;
; Referenced Globals:
...
;   crt_stdlib.c_wcstombs_FUN_10010910
...
section .text
    ...
    PUSH EBX                            ; 10010050
        ;   Label: crt_time.c__tzset_FUN_10010050
    PUSH ESI                            ; 10010051
    PUSH EDI                            ; 10010052
    XOR EBX,EBX                         ; 10010053
    PUSH EBP                            ; 10010055
    PUSH 0xc                            ; 10010056
    CALL crt_thread.c__lock_FUN_100059a0 ; 10010058
    ...
    CALL crt_env.c_getenv_FUN_10010c50  ; 1001007a
    ...
    PUSH 0xc                            ; 1001008c
    CALL crt_thread.c__unlock_FUN_10005a10 ; 1001008e
    ...
    CALL crt_stdlib.c_wcstombs_FUN_10010910 ; 10010134
        ;   XREF to: 10010910 (UNCONDITIONAL_CALL)  ; size_t crt_stdlib.c_wcstombs_FUN_10010910(char * mbstr, wchar_t * wcstr, size_t count)
    ...
    CALL crt_stdlib.c_wcstombs_FUN_10010910 ; 10010149
        ;   XREF to: 10010910 (UNCONDITIONAL_CALL)  ; size_t crt_stdlib.c_wcstombs_FUN_10010910(char * mbstr, wchar_t * wcstr, size_t count)
    ...
    PUSH EAX                            ; 100101bf
    CALL crt_heap.c_free_FUN_10005b30   ; 100101c0
    ...
    NOT ECX                             ; 100101d1
    PUSH ECX                            ; 100101d3
    CALL crt_heap.c_malloc_FUN_10008830 ; 100101d4
    ...
    PUSH 0xc                            ; 100101e5
    CALL crt_thread.c__unlock_FUN_10005a10 ; 100101e7
        ;   XREF to: 10005a10 (UNCONDITIONAL_CALL)  ; void crt_thread.c__unlock_FUN_10005a10(int locknum)
    ...
    CALL crt_thread.c__unlock_FUN_10005a10 ; 1001021b
        ;   XREF to: 10005a10 (UNCONDITIONAL_CALL)  ; void crt_thread.c__unlock_FUN_10005a10(int locknum)
    ...
    CALL crt_string.c__strncpy_FUN_1000a9f0 ; 10010230
    ...
    PUSH EBP                            ; 1001024e
        ;   Label: LAB_1001024e
    CALL crt_stdlib.c_atol_FUN_1000fe60 ; 1001024f
    ...
    INC EBP                             ; 10010280
    PUSH EBP                            ; 10010281
    CALL crt_stdlib.c_atol_FUN_1000fe60 ; 10010282
        ;   XREF to: 1000fe60 (UNCONDITIONAL_CALL)  ; long crt_stdlib.c_atol_FUN_1000fe60(char * str)
    ...
    INC EBP                             ; 100102b2
    PUSH EBP                            ; 100102b3
    CALL crt_stdlib.c_atol_FUN_1000fe60 ; 100102b4
        ;   XREF to: 1000fe60 (UNCONDITIONAL_CALL)  ; long crt_stdlib.c_atol_FUN_1000fe60(char * str)
    ...
    CALL crt_string.c__strncpy_FUN_1000a9f0 ; 100102fb
        ;   XREF to: 1000a9f0 (UNCONDITIONAL_CALL)  ; char * crt_string.c__strncpy_FUN_1000a9f0(char * dest, char * source, size_t count)
    ...
    PUSH 0xc                            ; 1001031e
        ;   Label: LAB_1001031e
    CALL crt_thread.c__unlock_FUN_10005a10 ; 10010320
        ;   XREF to: 10005a10 (UNCONDITIONAL_CALL)  ; void crt_thread.c__unlock_FUN_10005a10(int locknum)
