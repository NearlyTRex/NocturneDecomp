...
;
; XREF[1]:
;   crt_stdio.c__forcdecpt_FUN_10006ef0 at 10006efa
;
; Referenced Globals:
...
section .text
    ...
    CMP dword ptr [0x10017760],0x0      ; 10009b70 | DAT_10017760
        ;   Label: crt_ctype.c__tolower_FUN_10009b70
    PUSH ESI                            ; 10009b77
    PUSH EDI                            ; 10009b78
    ...
    CALL crt_thread.c__lock_FUN_100059a0 ; 10009b9f
    ...
    MOV EAX,dword ptr [ESP + 0xc]       ; 10009bb1
        ;   Label: LAB_10009bb1
    PUSH EAX                            ; 10009bb5
    CALL crt_ctype.c__tolower_lk_FUN_10009be0 ; 10009bb6
    ...
    PUSH 0x13                           ; 10009bc4
    CALL crt_thread.c__unlock_FUN_10005a10 ; 10009bc6
