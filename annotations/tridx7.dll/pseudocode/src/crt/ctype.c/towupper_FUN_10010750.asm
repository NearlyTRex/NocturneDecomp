...
;
; XREF[1]:
;   crt_stdlib.c_wcstoxl_FUN_1000fc30 at 1000fd49
;
; Referenced Globals:
...
;
; Called Functions:
;   crt_ctype.c__towupper_FUN_100107d0
...
section .text
    ...
    CMP dword ptr [0x10017760],0x0      ; 10010750 | DAT_10017760
        ;   Label: crt_ctype.c_towupper_FUN_10010750
    PUSH ESI                            ; 10010757
    PUSH EDI                            ; 10010758
    ...
    CALL crt_thread.c__lock_FUN_100059a0 ; 10010783
    ...
    MOV EAX,dword ptr [ESP + 0xc]       ; 10010795
        ;   Label: LAB_10010795
    PUSH EAX                            ; 10010799
    CALL crt_ctype.c__towupper_FUN_100107d0 ; 1001079a
        ;   XREF to: 100107d0 (UNCONDITIONAL_CALL)  ; wint_t crt_ctype.c__towupper_FUN_100107d0(wint_t c)
    MOV DI,AX                           ; 1001079f
    ...
    PUSH 0x13                           ; 100107a9
    CALL crt_thread.c__unlock_FUN_10005a10 ; 100107ab
