...
;
; XREF[2]:
;   crt_math.c___ld12told_FUN_1000a170 at 1000a1ae
;   crt_math.c__ld12cvt_FUN_10009f60 at 1000a005
;
; Called Functions:
;   crt_math.c__IncMan_FUN_10009d40
;   crt_math.c__ZeroTail_FUN_10009cd0
;
; *****************************************************************************
...
section .text
    ...
    SUB ESP,0x8                         ; 10009db0
        ;   Label: crt_math.c__RoundMan_FUN_10009db0
    ...
    PUSH EDI                            ; 10009e09
    PUSH EAX                            ; 10009e0a
    CALL crt_math.c__ZeroTail_FUN_10009cd0 ; 10009e0b
        ;   XREF to: 10009cd0 (UNCONDITIONAL_CALL)  ; int crt_math.c__ZeroTail_FUN_10009cd0(int man, int bit)
    ...
    PUSH EBP                            ; 10009e1b
    PUSH EAX                            ; 10009e1c
    CALL crt_math.c__IncMan_FUN_10009d40 ; 10009e1d
        ;   XREF to: 10009d40 (UNCONDITIONAL_CALL)  ; void crt_math.c__IncMan_FUN_10009d40(int man, int bit)
