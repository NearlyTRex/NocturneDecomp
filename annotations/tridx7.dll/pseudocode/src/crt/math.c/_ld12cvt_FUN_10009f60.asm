...
;
; Parameters:
; ushort *         Stack[0x4]:4   ld
; uint *           Stack[0x8]:4   result
; int *            Stack[0xc]:4   prec
; Local Variables:
...
;
; XREF[2]:
;   crt_math.c___ld12tod_FUN_1000a130 at 1000a13f
;   crt_math.c___ld12tof_FUN_1000a150 at 1000a15f
;
; Called Functions:
;   crt_math.c__CopyMan_FUN_10009e60
;   crt_math.c__FillZeroMan_FUN_10009e80
;   crt_math.c__IsZeroMan_FUN_10009e90
;   crt_math.c__RoundMan_FUN_10009db0
;   crt_math.c__ShrMan_FUN_10009eb0
;
; *****************************************************************************
...
section .text
    ...
    MOV ECX,dword ptr [ESP + 0x4]       ; 10009f60
        ;   Label: crt_math.c__ld12cvt_FUN_10009f60
    ...
    PUSH EAX                            ; 10009fb3
    CALL crt_math.c__IsZeroMan_FUN_10009e90 ; 10009fb4
        ;   XREF to: 10009e90 (UNCONDITIONAL_CALL)  ; int crt_math.c__IsZeroMan_FUN_10009e90(int * man)
    ...
    LEA EAX,[ESP + 0x10]                ; 10009fcb
        ;   Label: LAB_10009fcb
    PUSH EAX                            ; 10009fcf
    CALL crt_math.c__FillZeroMan_FUN_10009e80 ; 10009fd0
        ;   XREF to: 10009e80 (UNCONDITIONAL_CALL)  ; void crt_math.c__FillZeroMan_FUN_10009e80(int * man)
    ...
    PUSH EAX                            ; 10009fee
    PUSH ECX                            ; 10009fef
    CALL crt_math.c__CopyMan_FUN_10009e60 ; 10009ff0
        ;   XREF to: 10009e60 (UNCONDITIONAL_CALL)  ; void crt_math.c__CopyMan_FUN_10009e60(int * dst, int * src)
    ...
    PUSH ECX                            ; 1000a003
    PUSH EAX                            ; 1000a004
    CALL crt_math.c__RoundMan_FUN_10009db0 ; 1000a005
    ...
    PUSH EAX                            ; 1000a024
    CALL crt_math.c__FillZeroMan_FUN_10009e80 ; 1000a025
        ;   XREF to: 10009e80 (UNCONDITIONAL_CALL)  ; void crt_math.c__FillZeroMan_FUN_10009e80(int * man)
    ...
    PUSH EAX                            ; 1000a045
    PUSH ECX                            ; 1000a046
    CALL crt_math.c__CopyMan_FUN_10009e60 ; 1000a047
        ;   XREF to: 10009e60 (UNCONDITIONAL_CALL)  ; void crt_math.c__CopyMan_FUN_10009e60(int * dst, int * src)
    LEA ECX,[ESP + 0x18]                ; 1000a04c
    ADD ESP,0x8                         ; 1000a050
    PUSH EBP                            ; 1000a053
    PUSH ECX                            ; 1000a054
    CALL crt_math.c__ShrMan_FUN_10009eb0 ; 1000a055
        ;   XREF to: 10009eb0 (UNCONDITIONAL_CALL)  ; void crt_math.c__ShrMan_FUN_10009eb0(uint * man, int count)
    LEA EDX,[ESP + 0x18]                ; 1000a05a
    ADD ESP,0x8                         ; 1000a05e
    MOV ECX,dword ptr [EDI + 0x8]       ; 1000a061
    PUSH ECX                            ; 1000a064
    PUSH EDX                            ; 1000a065
    CALL crt_math.c__RoundMan_FUN_10009db0 ; 1000a066
        ;   XREF to: 10009db0 (UNCONDITIONAL_CALL)  ; int crt_math.c__RoundMan_FUN_10009db0(int man, int bit)
    ...
    PUSH EAX                            ; 1000a078
    PUSH ECX                            ; 1000a079
    CALL crt_math.c__ShrMan_FUN_10009eb0 ; 1000a07a
        ;   XREF to: 10009eb0 (UNCONDITIONAL_CALL)  ; void crt_math.c__ShrMan_FUN_10009eb0(uint * man, int count)
    ...
    PUSH EAX                            ; 1000a091
    CALL crt_math.c__FillZeroMan_FUN_10009e80 ; 1000a092
        ;   XREF to: 10009e80 (UNCONDITIONAL_CALL)  ; void crt_math.c__FillZeroMan_FUN_10009e80(int * man)
    ...
    PUSH EAX                            ; 1000a0a9
    PUSH ECX                            ; 1000a0aa
    CALL crt_math.c__ShrMan_FUN_10009eb0 ; 1000a0ab
        ;   XREF to: 10009eb0 (UNCONDITIONAL_CALL)  ; void crt_math.c__ShrMan_FUN_10009eb0(uint * man, int count)
    ...
    PUSH EAX                            ; 1000a0d2
    CALL crt_math.c__ShrMan_FUN_10009eb0 ; 1000a0d3
        ;   XREF to: 10009eb0 (UNCONDITIONAL_CALL)  ; void crt_math.c__ShrMan_FUN_10009eb0(uint * man, int count)
