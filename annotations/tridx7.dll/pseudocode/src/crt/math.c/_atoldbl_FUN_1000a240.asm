...
section .text
    ...
    MOV EAX,dword ptr [ESP + 0x8]       ; 1000a240
        ;   Label: crt_math.c__atoldbl_FUN_1000a240
    ...
    PUSH ECX                            ; 1000a258
    PUSH EDX                            ; 1000a259
    CALL crt_math.c__strgtold12_FUN_1000c7b0 ; 1000a25a
    ...
    PUSH ECX                            ; 1000a26a
    PUSH EDX                            ; 1000a26b
    CALL crt_math.c___ld12told_FUN_1000a170 ; 1000a26c
