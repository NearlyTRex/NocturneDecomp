...
;
; XREF[1]:
;   crt_math.c__RoundMan_FUN_10009db0 at 10009e1d
;
; Called Functions:
...
section .text
    ...
    PUSH EBX                            ; 10009d40
        ;   Label: crt_math.c__IncMan_FUN_10009d40
    PUSH ESI                            ; 10009d41
    PUSH EDI                            ; 10009d42
    ...
    PUSH EBX                            ; 10009d77
    PUSH ECX                            ; 10009d78
    CALL crt_math.c__addl_FUN_1000c5a0  ; 10009d79
    ...
    PUSH EAX                            ; 10009d93
    CALL crt_math.c__addl_FUN_1000c5a0  ; 10009d94
        ;   XREF to: 1000c5a0 (UNCONDITIONAL_CALL)  ; uint crt_math.c__addl_FUN_1000c5a0(uint a, uint b, uint * result)
