...
;
; XREF[4]:
;   crt_math.c__atodbl_FUN_1000a200 at 1000a21a
;   crt_math.c__atoflt_FUN_1000a280 at 1000a29a
;   crt_math.c__atoldbl_FUN_1000a240 at 1000a25a
;   crt_stdlib.c__atodbl_v2_FUN_1000cf00 at 1000cf1e
;
; Referenced Globals:
...
;   crt_math.c__mtold12_FUN_1000c6c0
...
section .text
    ...
    SUB ESP,0x54                        ; 1000c7b0
        ;   Label: crt_math.c__strgtold12_FUN_1000c7b0
    PUSH EBX                            ; 1000c7b3
    PUSH ESI                            ; 1000c7b4
    ...
    MOV AL,BL                           ; 1000c94b
    PUSH EAX                            ; 1000c94d
    CALL crt_ctype.c__isctype_FUN_10009ac0 ; 1000c94e
    ...
    MOV AL,BL                           ; 1000ca0a
    PUSH EAX                            ; 1000ca0c
    CALL crt_ctype.c__isctype_FUN_10009ac0 ; 1000ca0d
        ;   XREF to: 10009ac0 (UNCONDITIONAL_CALL)  ; int crt_ctype.c__isctype_FUN_10009ac0(int c, int type)
    ...
    MOV AL,BL                           ; 1000ca91
    PUSH EAX                            ; 1000ca93
    CALL crt_ctype.c__isctype_FUN_10009ac0 ; 1000ca94
        ;   XREF to: 10009ac0 (UNCONDITIONAL_CALL)  ; int crt_ctype.c__isctype_FUN_10009ac0(int c, int type)
    ...
    MOV AL,BL                           ; 1000cbaa
    PUSH EAX                            ; 1000cbac
    CALL crt_ctype.c__isctype_FUN_10009ac0 ; 1000cbad
        ;   XREF to: 10009ac0 (UNCONDITIONAL_CALL)  ; int crt_ctype.c__isctype_FUN_10009ac0(int c, int type)
    ...
    MOV AL,BL                           ; 1000cbf7
    PUSH EAX                            ; 1000cbf9
    CALL crt_ctype.c__isctype_FUN_10009ac0 ; 1000cbfa
        ;   XREF to: 10009ac0 (UNCONDITIONAL_CALL)  ; int crt_ctype.c__isctype_FUN_10009ac0(int c, int type)
    ...
    PUSH ECX                            ; 1000cccc
    PUSH EDX                            ; 1000cccd
    CALL crt_math.c__mtold12_FUN_1000c6c0 ; 1000ccce
        ;   XREF to: 1000c6c0 (UNCONDITIONAL_CALL)  ; void crt_math.c__mtold12_FUN_1000c6c0(char * manptr, int cnt, uint * ld12)
    ...
    PUSH EDI                            ; 1000cd26
    PUSH ECX                            ; 1000cd27
    CALL crt_math.c__multtenpow12_FUN_1000eba0 ; 1000cd28
