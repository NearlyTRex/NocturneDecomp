...
// Convention: __cdecl
// Signature: _FILE * __cdecl crt_stdio_c__getstream_FUN_10006c40(void)

#include "nocturne.h"

_FILE * __cdecl _getstream(void)

{
      ...
      if (pvVar1 == (void *)0x0) {
        ...
        *(void **)(DAT_1024085c + index * 4) = pvVar1;
        ...
        if (iVar2 != 0) {
          ...
          p_Var3 = *(_FILE **)(DAT_1024085c + index * 4);
        }
        break;
      }
  ...
  if (p_Var3 != (_FILE *)0x0) {
    p_Var3->_cnt = 0;
    p_Var3->_flag = 0;
    p_Var3->_base = (char *)0x0;
    p_Var3->_ptr = (char *)0x0;
    p_Var3->_tmpfname = (char *)0x0;
    p_Var3->_file = -1;
  }
  _unlock(2);
  return p_Var3;
