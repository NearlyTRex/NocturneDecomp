...
;                               FUNCTION
; *****************************************************************************
; FILE * __cdecl crt_stdio_c_fopen_FUN_10005560(char *filename,char *mode)
;
; Parameters:
...
section .text
    ...
    CALL crt_stdio.c__fsopen_FUN_10005520 ; 1000556c
        ;   XREF to: 10005520 (UNCONDITIONAL_CALL)  ; FILE * crt_stdio.c__fsopen_FUN_10005520(char * filename, char * mode, int sh_flag)
