...
;
; Parameters:
; _CRT_DOUBLE      Stack[0x4]:8   dbl
; STRFLT           Stack[0xc]:4   flt
; char *           Stack[0x10]:4   result_str
; size_t           Stack[0x14]:4   size_in_bytes
; Local Variables:
...
;
; XREF[3]:
;   crt_stdio.c__cftoe_FUN_10007030 at 1000704a
;   crt_stdio.c__cftof_FUN_100071a0 at 100071ba
;   crt_stdio.c__cftog_FUN_100072d0 at 100072ec
;
; Called Functions:
;   crt_math.c__dtold_FUN_1000a3e0
;   crt_stdio.c__i10_output_FUN_1000cf50
;
; *****************************************************************************
...
section .text
    ...
    LEA EAX,[ESP + 0x4]                 ; 1000a350
        ;   Label: crt_stdio.c__fltout2_FUN_1000a350
    ...
    PUSH EAX                            ; 1000a35e
    PUSH ECX                            ; 1000a35f
    CALL crt_math.c__dtold_FUN_1000a3e0 ; 1000a360
        ;   XREF to: 1000a3e0 (UNCONDITIONAL_CALL)  ; void crt_math.c__dtold_FUN_1000a3e0(uint * dst, uint * src)
    ...
    PUSH EAX                            ; 1000a37e
    PUSH ECX                            ; 1000a37f
    CALL crt_stdio.c__i10_output_FUN_1000cf50 ; 1000a380
        ;   XREF to: 1000cf50 (UNCONDITIONAL_CALL)  ; int crt_stdio.c__i10_output_FUN_1000cf50(int man_lo, uint man_hi, ushort exp_sign, int ndigits, ...) | _$I10_OUTPUT
