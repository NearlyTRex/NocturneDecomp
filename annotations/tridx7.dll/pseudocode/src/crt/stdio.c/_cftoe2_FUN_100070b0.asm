...
; int              Stack[0x8]:4   dec
; int              Stack[0xc]:4   caps
; int *            Stack[0x10]:4   pflt
; char             Stack[0x14]:1   is_g
;
; XREF[2]:
;   crt_stdio.c__cftoe_FUN_10007030 at 10007097
;   crt_stdio.c__cftog_FUN_100072d0 at 1000736b
;
; Referenced Globals:
...
section .text
    ...
    CMP byte ptr [ESP + 0x14],0x0       ; 100070b0
        ;   Label: crt_stdio.c__cftoe2_FUN_100070b0
    PUSH EBX                            ; 100070b5
    PUSH ESI                            ; 100070b6
    PUSH EDI                            ; 100070b7
    ...
    PUSH ECX                            ; 100070df
        ;   Label: LAB_100070df
    PUSH EAX                            ; 100070e0
    CALL crt_stdio.c__shift_FUN_100073f0 ; 100070e1
