...
;
; XREF[1]:
;   crt_stdio.c__cfltcvt_FUN_10007380 at 100073bf
;
; Called Functions:
...
section .text
    ...
    SUB ESP,0x28                        ; 100072d0
        ;   Label: crt_stdio.c__cftog_FUN_100072d0
    ...
    PUSH EDX                            ; 100072ea
    PUSH ECX                            ; 100072eb
    CALL crt_stdio.c__fltout2_FUN_1000a350 ; 100072ec
    ...
    PUSH EDI                            ; 10007317
    PUSH EBP                            ; 10007318
    CALL crt_stdio.c__fptostr_FUN_1000a2c0 ; 10007319
    ...
    PUSH EDI                            ; 1000734b
    PUSH ESI                            ; 1000734c
    CALL crt_stdio.c__cftof2_FUN_10007210 ; 1000734d
    ...
    PUSH EDI                            ; 10007369
    PUSH ESI                            ; 1000736a
    CALL crt_stdio.c__cftoe2_FUN_100070b0 ; 1000736b
