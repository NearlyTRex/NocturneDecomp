...
; uint             Stack[0x8]:4   dec
; int *            Stack[0xc]:4   pflt
; char             Stack[0x10]:1   is_g
;
; XREF[2]:
;   crt_stdio.c__cftof_FUN_100071a0 at 100071f8
;   crt_stdio.c__cftog_FUN_100072d0 at 1000734d
;
; Referenced Globals:
;   undefined1 DAT_10017694
;
; Called Functions:
;   crt_stdio.c__shift_FUN_100073f0
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 10007210
        ;   Label: crt_stdio.c__cftof2_FUN_10007210
    PUSH ESI                            ; 10007211
    ...
    PUSH EDI                            ; 10007266
    INC EDI                             ; 10007267
    CALL crt_stdio.c__shift_FUN_100073f0 ; 10007268
        ;   XREF to: 100073f0 (UNCONDITIONAL_CALL)  ; void crt_stdio.c__shift_FUN_100073f0(char * str, int dist)
    ...
    PUSH EDI                            ; 1000727e
    INC EDI                             ; 1000727f
    CALL crt_stdio.c__shift_FUN_100073f0 ; 10007280
        ;   XREF to: 100073f0 (UNCONDITIONAL_CALL)  ; void crt_stdio.c__shift_FUN_100073f0(char * str, int dist)
    ...
    PUSH ESI                            ; 100072aa
        ;   Label: LAB_100072aa
    PUSH EDI                            ; 100072ab
    CALL crt_stdio.c__shift_FUN_100073f0 ; 100072ac
        ;   XREF to: 100073f0 (UNCONDITIONAL_CALL)  ; void crt_stdio.c__shift_FUN_100073f0(char * str, int dist)
