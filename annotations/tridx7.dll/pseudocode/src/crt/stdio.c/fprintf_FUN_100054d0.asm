...
;                               FUNCTION
; *****************************************************************************
; int __cdecl crt_stdio_c_fprintf_FUN_100054d0(_FILE *file,char *format,...)
;
; Parameters:
...
section .text
    ...
    CALL crt_stdio.c__stbuf_FUN_10005e60 ; 100054e1
        ;   XREF to: 10005e60 (UNCONDITIONAL_CALL)  ; int crt_stdio.c__stbuf_FUN_10005e60(_FILE * file)
    ...
    CALL crt_stdio.c__ftbuf_FUN_10005f00 ; 10005502
        ;   XREF to: 10005f00 (UNCONDITIONAL_CALL)  ; void crt_stdio.c__ftbuf_FUN_10005f00(int flag, _FILE * file)
