...
section .text
    ...
    PUSH EBX                            ; 1000ab70
        ;   Label: crt_stdio.c___endstdio_FUN_1000ab70
    PUSH ESI                            ; 1000ab71
    PUSH EDI                            ; 1000ab72
    ...
    CALL crt_thread.c__lock_FUN_100059a0 ; 1000ab7d
    ...
    PUSH EDX                            ; 1000abd5
    CALL crt_heap.c_free_FUN_10005b30   ; 1000abd6
    ...
    PUSH 0x2                            ; 1000abf7
        ;   Label: LAB_1000abf7
    CALL crt_thread.c__unlock_FUN_10005a10 ; 1000abf9
