...
;   crt_stdio.c_write_char_FUN_10006920 at 10006946
;
; Referenced Globals:
...
;
; Called Functions:
;   crt_io.c__isatty_FUN_100091b0
;   crt_io.c__write_dup_FUN_1000a5f0
;   crt_io.c__write_FUN_10008f30
;   crt_stdio.c__getbuf_FUN_1000a700
;
; *****************************************************************************
...
section .text
    ...
    PUSH EBX                            ; 10007420
        ;   Label: crt_stdio.c__flsbuf_FUN_10007420
    PUSH ESI                            ; 10007421
    ...
    PUSH EDI                            ; 1000748e
        ;   Label: LAB_1000748e
    CALL crt_io.c__isatty_FUN_100091b0  ; 1000748f
        ;   XREF to: 100091b0 (UNCONDITIONAL_CALL)  ; int crt_io.c__isatty_FUN_100091b0(int fh)
    ...
    PUSH EAX                            ; 100074c6
    PUSH EDI                            ; 100074c7
    CALL crt_io.c__write_FUN_10008f30   ; 100074c8
    ...
    PUSH 0x0                            ; 10007511
    PUSH EDI                            ; 10007513
    CALL crt_io.c__write_dup_FUN_1000a5f0 ; 10007514
        ;   XREF to: 1000a5f0 (UNCONDITIONAL_CALL)  ; int crt_io.c__write_dup_FUN_1000a5f0(int file_handle, void * buf, uint max_char_count)
    ...
    PUSH EAX                            ; 10007531
    PUSH EDI                            ; 10007532
    CALL crt_io.c__write_FUN_10008f30   ; 10007533
        ;   XREF to: 10008f30 (UNCONDITIONAL_CALL)  ; int crt_io.c__write_FUN_10008f30(int file_handle, void * buf, uint max_char_count)
