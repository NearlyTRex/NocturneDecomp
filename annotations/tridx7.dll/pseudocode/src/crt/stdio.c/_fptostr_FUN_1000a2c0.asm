...
; size_t           Stack[0x8]:4   size_in_bytes
; int              Stack[0xc]:4   digits
; STRFLT           Stack[0x10]:4   pt_flt
;
; XREF[3]:
;   crt_stdio.c__cftoe_FUN_10007030 at 10007081
;   crt_stdio.c__cftof_FUN_100071a0 at 100071e7
;   crt_stdio.c__cftog_FUN_100072d0 at 10007319
;
; *****************************************************************************
...
section .text
    ...
    MOV ECX,dword ptr [ESP + 0xc]       ; 1000a2c0
        ;   Label: crt_stdio.c__fptostr_FUN_1000a2c0
    PUSH EBX                            ; 1000a2c4
