...
; Parameters:
; int              Stack[0x4]:4   fh
; intptr_t         Stack[0x8]:4   osfhandle
;
; XREF[2]:
;   crt_io.c__open_osfhandle_FUN_10008d20 at 10008da0
;   crt_io.c__sopen_FUN_100093f0 at 100096c7
;
; Referenced Globals:
...
section .text
    ...
    MOV ECX,dword ptr [ESP + 0x4]       ; 10008b80
        ;   Label: crt_io.c__set_osfhnd_FUN_10008b80
    PUSH EBX                            ; 10008b84
    PUSH ESI                            ; 10008b85
