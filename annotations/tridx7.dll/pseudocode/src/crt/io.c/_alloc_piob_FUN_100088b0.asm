...
section .text
    ...
    CMP dword ptr [0x10241860],0x0      ; 100088b0 | DAT_10241860
        ;   Label: crt_io.c__alloc_piob_FUN_100088b0
    PUSH ESI                            ; 100088b7
    ...
    PUSH EAX                            ; 100088e0
    CALL crt_heap.c_calloc_FUN_1000a750 ; 100088e1
    ...
    PUSH 0x4                            ; 100088fc
    PUSH 0x14                           ; 100088fe
    CALL crt_heap.c_calloc_FUN_1000a750 ; 10008900
        ;   XREF to: 1000a750 (UNCONDITIONAL_CALL)  ; void * crt_heap.c_calloc_FUN_1000a750(size_t num, size_t size)
    ...
    JNZ 0x1000891b                      ; 1000890f
        ;   XREF to: 1000891b (CONDITIONAL_JUMP)  ; LAB_1000891b
    PUSH 0x1a                           ; 10008911
    CALL crt_startup.c__amsg_exit_FUN_100058c0 ; 10008913
