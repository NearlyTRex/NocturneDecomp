...
;
; XREF[2]:
;   crt_io.c__open_osfhandle_FUN_10008d20 at 10008d70
;   crt_io.c__sopen_FUN_100093f0 at 100095fa
;
; Referenced Globals:
...
section .text
    ...
    SUB ESP,0x4                         ; 10008a40
        ;   Label: crt_io.c__alloc_osfhnd_FUN_10008a40
    PUSH EBX                            ; 10008a43
    PUSH ESI                            ; 10008a44
    PUSH EDI                            ; 10008a45
    ...
    CALL crt_thread.c__lock_FUN_100059a0 ; 10008a55
    ...
    PUSH 0x11                           ; 10008a81
    CALL crt_thread.c__lock_FUN_100059a0 ; 10008a83
        ;   XREF to: 100059a0 (UNCONDITIONAL_CALL)  ; void crt_thread.c__lock_FUN_100059a0(int file)
    ...
    PUSH 0x11                           ; 10008a9e
        ;   Label: LAB_10008a9e
    CALL crt_thread.c__unlock_FUN_10005a10 ; 10008aa0
    ...
    PUSH 0x480                          ; 10008b05
        ;   Label: LAB_10008b05
    CALL crt_heap.c_malloc_FUN_10008830 ; 10008b0a
