...
;
; XREF[2]:
;   crt_io.c__chsize_FUN_1000b4f0 at 1000b52d
;   crt_io.c__sopen_FUN_100093f0 at 1000977c
;
; Referenced Globals:
...
section .text
    ...
    MOV EAX,0x1008                      ; 1000b560
        ;   Label: crt_io.c__chsize_lk_FUN_1000b560
    CALL crt_startup.c__chkstk_FUN_10005600 ; 1000b565
    ...
    PUSH EBX                            ; 1000b579
    PUSH ESI                            ; 1000b57a
    CALL crt_io.c__lseek_lk_FUN_1000a670 ; 1000b57b
    ...
    PUSH EBX                            ; 1000b592
    PUSH ESI                            ; 1000b593
    CALL crt_io.c__lseek_lk_FUN_1000a670 ; 1000b594
        ;   XREF to: 1000a670 (UNCONDITIONAL_CALL)  ; long crt_io.c__lseek_lk_FUN_1000a670(int fh, long offset, int origin)
    ...
    PUSH ESI                            ; 1000b5c6
    CALL crt_io.c__setmode_lk_FUN_1000e880 ; 1000b5c7
    ...
    PUSH EAX                            ; 1000b5e3
    PUSH ESI                            ; 1000b5e4
    CALL crt_io.c__write_lk_FUN_10008fb0 ; 1000b5e5
    ...
    CALL crt_errno.c___doserrno_FUN_10008a30 ; 1000b5fc
    ...
    CALL crt_errno.c__errno_FUN_10008a20 ; 1000b606
    ...
    PUSH EAX                            ; 1000b617
    PUSH ESI                            ; 1000b618
    CALL crt_io.c__setmode_lk_FUN_1000e880 ; 1000b619
        ;   XREF to: 1000e880 (UNCONDITIONAL_CALL)  ; int crt_io.c__setmode_lk_FUN_1000e880(uint fh, int mode)
    ...
    PUSH ECX                            ; 1000b627
    PUSH ESI                            ; 1000b628
    CALL crt_io.c__lseek_lk_FUN_1000a670 ; 1000b629
        ;   XREF to: 1000a670 (UNCONDITIONAL_CALL)  ; long crt_io.c__lseek_lk_FUN_1000a670(int fh, long offset, int origin)
    ADD ESP,0xc                         ; 1000b62e
    PUSH ESI                            ; 1000b631
    CALL crt_io.c__get_osfhandle_FUN_10008cd0 ; 1000b632
    ...
    JNZ 0x1000b665                      ; 1000b649
        ;   XREF to: 1000b665 (CONDITIONAL_JUMP)  ; LAB_1000b665
    CALL crt_errno.c__errno_FUN_10008a20 ; 1000b64b
        ;   XREF to: 10008a20 (UNCONDITIONAL_CALL)  ; int * crt_errno.c__errno_FUN_10008a20()
    MOV dword ptr [EAX],0xd             ; 1000b650
    CALL crt_errno.c___doserrno_FUN_10008a30 ; 1000b656
        ;   XREF to: 10008a30 (UNCONDITIONAL_CALL)  ; ulong * crt_errno.c___doserrno_FUN_10008a30()
    ...
    PUSH EAX                            ; 1000b66b
    PUSH ESI                            ; 1000b66c
    CALL crt_io.c__lseek_lk_FUN_1000a670 ; 1000b66d
        ;   XREF to: 1000a670 (UNCONDITIONAL_CALL)  ; long crt_io.c__lseek_lk_FUN_1000a670(int fh, long offset, int origin)
