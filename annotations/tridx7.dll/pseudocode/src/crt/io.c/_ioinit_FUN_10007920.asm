...
;
; XREF[1]:
;   crt_startup.c___CRTDLL_INIT_FUN_100056a0 at 1000576e
;
; Referenced Globals:
...
section .text
    ...
    SUB ESP,0x44                        ; 10007920
        ;   Label: crt_io.c__ioinit_FUN_10007920
    PUSH EBX                            ; 10007923
    PUSH ESI                            ; 10007924
    PUSH EDI                            ; 10007925
    PUSH EBP                            ; 10007926
    PUSH 0x480                          ; 10007927
    CALL crt_heap.c_malloc_FUN_10008830 ; 1000792c
    ...
    PUSH 0x1b                           ; 1000793a
    CALL crt_startup.c__amsg_exit_FUN_100058c0 ; 1000793c
    ...
    PUSH 0x480                          ; 100079ce
        ;   Label: LAB_100079ce
    CALL crt_heap.c_malloc_FUN_10008830 ; 100079d3
        ;   XREF to: 10008830 (UNCONDITIONAL_CALL)  ; void * crt_heap.c_malloc_FUN_10008830(size_t size)
