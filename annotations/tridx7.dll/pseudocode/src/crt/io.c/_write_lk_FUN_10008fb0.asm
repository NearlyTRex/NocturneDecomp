...
;
; XREF[2]:
;   crt_io.c__chsize_lk_FUN_1000b560 at 1000b5e5
;   crt_io.c__write_FUN_10008f30 at 10008f72
;
; Referenced Globals:
...
section .text
    ...
    SUB ESP,0x418                       ; 10008fb0
        ;   Label: crt_io.c__write_lk_FUN_10008fb0
    PUSH EBX                            ; 10008fb6
    PUSH ESI                            ; 10008fb7
    PUSH EDI                            ; 10008fb8
    ...
    PUSH 0x0                            ; 1000900e
    PUSH EDX                            ; 10009010
    CALL crt_io.c__lseek_lk_FUN_1000a670 ; 10009011
    ...
    MOV ECX,dword ptr [ESP + 0x10]      ; 1000912d
        ;   Label: LAB_1000912d
    PUSH ECX                            ; 10009131
    CALL crt_errno.c__dosmaperr_FUN_100089a0 ; 10009132
    ...
    RET                                 ; 10009173
    CALL crt_errno.c__errno_FUN_10008a20 ; 10009174
        ;   XREF to: 10008a20 (UNCONDITIONAL_CALL)  ; int * crt_errno.c__errno_FUN_10008a20()
        ;   Label: LAB_10009174
    MOV dword ptr [EAX],0x1c            ; 10009179
    CALL crt_errno.c___doserrno_FUN_10008a30 ; 1000917f
        ;   XREF to: 10008a30 (UNCONDITIONAL_CALL)  ; ulong * crt_errno.c___doserrno_FUN_10008a30()
    POP EBP                             ; 10009184
