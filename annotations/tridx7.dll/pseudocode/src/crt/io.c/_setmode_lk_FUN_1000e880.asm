...
;
; XREF[2]:
;   crt_io.c__chsize_lk_FUN_1000b560 at 1000b5c7
;   crt_io.c__setmode_FUN_1000e810 at 1000e84d
;
; Referenced Globals:
...
section .text
    ...
    MOV ECX,dword ptr [ESP + 0x4]       ; 1000e880
        ;   Label: crt_io.c__setmode_lk_FUN_1000e880
    PUSH EBX                            ; 1000e884
    ...
    RET                                 ; 1000e8d6
    CALL crt_errno.c__errno_FUN_10008a20 ; 1000e8d7
