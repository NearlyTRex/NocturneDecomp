...
;
; XREF[2]:
;   crt_io.c__read_FUN_1000b6a0 at 1000b6e2
;   crt_io.c__sopen_FUN_100093f0 at 10009767
;
; Referenced Globals:
...
section .text
    ...
    MOV EDX,dword ptr [ESP + 0x8]       ; 1000b720
        ;   Label: crt_io.c__read_lk_FUN_1000b720
    ...
    PUSH ESI                            ; 1000b7e1
        ;   Label: LAB_1000b7e1
    CALL crt_errno.c__dosmaperr_FUN_100089a0 ; 1000b7e2
    ...
    PUSH -0x1                           ; 1000b8fd
    PUSH EAX                            ; 1000b8ff
    CALL crt_io.c__lseek_lk_FUN_1000a670 ; 1000b900
