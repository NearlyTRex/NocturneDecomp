...
; int              Stack[0xc]:4   shflag
; int              Stack[0x10]:4   pmode
; Local Variables:
...
;
; XREF[2]:
;   crt_io.c__open_FUN_100093d0 at 100093e1
;   crt_stdio.c__openfile_FUN_10006a30 at 10006b8e
;
; Referenced Globals:
...
section .text
    ...
    SUB ESP,0x1c                        ; 100093f0
        ;   Label: crt_io.c__sopen_FUN_100093f0
    ...
    JMP dword ptr [ECX*0x4 + 0x10009808] ; 100094ac | caseD_10 | caseD_3f | caseD_20
        ;   Label: switchD
    CALL crt_errno.c__errno_FUN_10008a20 ; 100094b3
        ;   XREF to: 10008a20 (UNCONDITIONAL_CALL)  ; int * crt_errno.c__errno_FUN_10008a20()
        ;   Label: caseD_11
    MOV dword ptr [EAX],0x16            ; 100094b8
    CALL crt_errno.c___doserrno_FUN_10008a30 ; 100094be
        ;   XREF to: 10008a30 (UNCONDITIONAL_CALL)  ; ulong * crt_errno.c___doserrno_FUN_10008a30()
    POP EBP                             ; 100094c3
    ...
    JZ 0x1000958f                       ; 10009542
        ;   XREF to: 1000958f (CONDITIONAL_JUMP)  ; LAB_1000958f
    CALL crt_errno.c__errno_FUN_10008a20 ; 10009544
        ;   XREF to: 10008a20 (UNCONDITIONAL_CALL)  ; int * crt_errno.c__errno_FUN_10008a20()
        ;   Label: LAB_10009544
    MOV dword ptr [EAX],0x16            ; 10009549
    CALL crt_errno.c___doserrno_FUN_10008a30 ; 1000954f
        ;   XREF to: 10008a30 (UNCONDITIONAL_CALL)  ; ulong * crt_errno.c___doserrno_FUN_10008a30()
    POP EBP                             ; 10009554
    ...
    CALL crt_io.c__alloc_osfhnd_FUN_10008a40 ; 100095fa
    ...
    CALL crt_errno.c__errno_FUN_10008a20 ; 10009606
        ;   XREF to: 10008a20 (UNCONDITIONAL_CALL)  ; int * crt_errno.c__errno_FUN_10008a20()
    MOV dword ptr [EAX],0x18            ; 1000960b
    CALL crt_errno.c___doserrno_FUN_10008a30 ; 10009611
        ;   XREF to: 10008a30 (UNCONDITIONAL_CALL)  ; ulong * crt_errno.c___doserrno_FUN_10008a30()
    POP EBP                             ; 10009616
    ...
    PUSH EAX                            ; 10009691
    CALL crt_errno.c__dosmaperr_FUN_100089a0 ; 10009692
        ;   XREF to: 100089a0 (UNCONDITIONAL_CALL)  ; void crt_errno.c__dosmaperr_FUN_100089a0(ulong oserrno)
    ADD ESP,0x4                         ; 10009697
    PUSH EDI                            ; 1000969a
    CALL crt_io.c__unlock_fhandle_FUN_10008e50 ; 1000969b
        ;   XREF to: 10008e50 (UNCONDITIONAL_CALL)  ; void crt_io.c__unlock_fhandle_FUN_10008e50(int filehandle)
    ...
    OR BL,0x1                           ; 100096c3
    PUSH EDI                            ; 100096c6
    CALL crt_io.c__set_osfhnd_FUN_10008b80 ; 100096c7
    ...
    PUSH -0x1                           ; 10009718
    PUSH EDI                            ; 1000971a
    CALL crt_io.c__lseek_lk_FUN_1000a670 ; 1000971b
    ...
    PUSH EAX                            ; 10009765
    PUSH EDI                            ; 10009766
    CALL crt_io.c__read_lk_FUN_1000b720 ; 10009767
    ...
    PUSH EBX                            ; 1000977a
    PUSH EDI                            ; 1000977b
    CALL crt_io.c__chsize_lk_FUN_1000b560 ; 1000977c
    ...
    JNZ 0x100097a8                      ; 10009787
        ;   XREF to: 100097a8 (CONDITIONAL_JUMP)  ; LAB_100097a8
    PUSH EDI                            ; 10009789
    CALL crt_io.c__close_FUN_10005b50   ; 1000978a
        ;   XREF to: 10005b50 (UNCONDITIONAL_CALL)  ; int crt_io.c__close_FUN_10005b50(int file_handle)
    ADD ESP,0x4                         ; 1000978f
    PUSH EDI                            ; 10009792
    CALL crt_io.c__unlock_fhandle_FUN_10008e50 ; 10009793
        ;   XREF to: 10008e50 (UNCONDITIONAL_CALL)  ; void crt_io.c__unlock_fhandle_FUN_10008e50(int filehandle)
    ...
    PUSH 0x0                            ; 100097aa
    PUSH EDI                            ; 100097ac
    CALL crt_io.c__lseek_lk_FUN_1000a670 ; 100097ad
        ;   XREF to: 1000a670 (UNCONDITIONAL_CALL)  ; long crt_io.c__lseek_lk_FUN_1000a670(int fh, long offset, int origin)
    ...
    JNZ 0x100097d9                      ; 100097b8
        ;   XREF to: 100097d9 (CONDITIONAL_JUMP)  ; LAB_100097d9
    PUSH EDI                            ; 100097ba
    CALL crt_io.c__close_FUN_10005b50   ; 100097bb
        ;   XREF to: 10005b50 (UNCONDITIONAL_CALL)  ; int crt_io.c__close_FUN_10005b50(int file_handle)
    ADD ESP,0x4                         ; 100097c0
    PUSH EDI                            ; 100097c3
    CALL crt_io.c__unlock_fhandle_FUN_10008e50 ; 100097c4
        ;   XREF to: 10008e50 (UNCONDITIONAL_CALL)  ; void crt_io.c__unlock_fhandle_FUN_10008e50(int filehandle)
    ...
    PUSH EDI                            ; 100097f4
        ;   Label: LAB_100097f4
    CALL crt_io.c__unlock_fhandle_FUN_10008e50 ; 100097f5
        ;   XREF to: 10008e50 (UNCONDITIONAL_CALL)  ; void crt_io.c__unlock_fhandle_FUN_10008e50(int filehandle)
