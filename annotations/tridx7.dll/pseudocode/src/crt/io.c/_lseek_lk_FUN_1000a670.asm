...
; int              Stack[0xc]:4   origin
;
; XREF[5]:
;   crt_io.c__chsize_lk_FUN_1000b560 at 1000b57b
;   crt_io.c__read_lk_FUN_1000b720 at 1000b900
;   crt_io.c__sopen_FUN_100093f0 at 1000971b
;   crt_io.c__write_dup_FUN_1000a5f0 at 1000a632
;   crt_io.c__write_lk_FUN_10008fb0 at 10009011
;
; Referenced Globals:
...
section .text
    ...
    PUSH ESI                            ; 1000a670
        ;   Label: crt_io.c__lseek_lk_FUN_1000a670
    PUSH EDI                            ; 1000a671
    MOV ESI,dword ptr [ESP + 0xc]       ; 1000a672
    PUSH ESI                            ; 1000a676
    CALL crt_io.c__get_osfhandle_FUN_10008cd0 ; 1000a677
    ...
    CALL crt_errno.c__errno_FUN_10008a20 ; 1000a684
    ...
    PUSH EAX                            ; 1000a6c0
    CALL crt_errno.c__dosmaperr_FUN_100089a0 ; 1000a6c1
