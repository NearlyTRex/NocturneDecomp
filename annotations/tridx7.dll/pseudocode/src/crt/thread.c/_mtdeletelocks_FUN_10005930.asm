...
;
; XREF[1]:
;   crt_thread.c__mtterm_FUN_10007760 at 10007760
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 10005930
        ;   Label: crt_thread.c__mtdeletelocks_FUN_10005930
    PUSH ESI                            ; 10005931
    PUSH EDI                            ; 10005932
    ...
    LEA EBX,[EDI*0x4 + 0x10016c78]      ; 1000593b | DAT_10016c78
        ;   Label: LAB_1000593b
    MOV EAX,dword ptr [EBX]             ; 10005942 | DAT_10016c78 | LPCRITICAL_SECTION_10016c7c
    ...
    PUSH EAX                            ; 10005961
    CALL crt_heap.c_free_FUN_10005b30   ; 10005962
