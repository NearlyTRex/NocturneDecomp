...
;
; XREF[1]:
;   crt_startup.c___CRTDLL_INIT_FUN_100056a0 at 10005739
;
; Referenced Globals:
...
;   crt_thread.c__mtinitlocks_FUN_10005900
;   GetCurrentThreadId
;   TlsAlloc
;   TlsSetValue
;
...
section .text
    ...
    PUSH ESI                            ; 10007700
        ;   Label: crt_thread.c__mtinit_FUN_10007700
    CALL crt_thread.c__mtinitlocks_FUN_10005900 ; 10007701
        ;   XREF to: 10005900 (UNCONDITIONAL_CALL)  ; int crt_thread.c__mtinitlocks_FUN_10005900()
    ...
    PUSH 0x74                           ; 1000771a
        ;   Label: LAB_1000771a
    PUSH 0x1                            ; 1000771c
    CALL crt_heap.c_calloc_FUN_1000a750 ; 1000771e
    ...
    JZ 0x1000775c                       ; 1000773b
        ;   XREF to: 1000775c (CONDITIONAL_JUMP)  ; LAB_1000775c
    PUSH ESI                            ; 1000773d
    CALL crt_thread.c__initptd_FUN_10007790 ; 1000773e
