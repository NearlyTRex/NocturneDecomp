...
;
; XREF[6]:
;   crt_errno.c___doserrno_FUN_10008a30 at 10008a30
;   crt_errno.c__errno_FUN_10008a20 at 10008a20
;   crt_signal.c__XcptFilter_FUN_1000a7b0 at 1000a7b4
;   crt_signal.c_raise_FUN_1000bbc0 at 1000bc01
;   crt_signal.c_signal_FUN_1000b950 at 1000b9a8
;   crt_thread.c___pxcptinfoptrs_FUN_1000bdf0 at 1000bdf0
;
; Referenced Globals:
...
;   crt_thread.c__initptd_FUN_10007790
;   GetCurrentThreadId
;   GetLastError
;   SetLastError
;   TlsGetValue
...
section .text
    ...
    PUSH ESI                            ; 100077b0
        ;   Label: crt_thread.c__getptd_FUN_100077b0
    PUSH EDI                            ; 100077b1
    ...
    PUSH 0x74                           ; 100077cc
    PUSH 0x1                            ; 100077ce
    CALL crt_heap.c_calloc_FUN_1000a750 ; 100077d0
    ...
    JZ 0x10007809                       ; 100077ed
        ;   XREF to: 10007809 (CONDITIONAL_JUMP)  ; LAB_10007809
    PUSH EDI                            ; 100077ef
    CALL crt_thread.c__initptd_FUN_10007790 ; 100077f0
        ;   XREF to: 10007790 (UNCONDITIONAL_CALL)  ; void crt_thread.c__initptd_FUN_10007790(_ptiddata ptd, pthreadlocinfo locale)
    ...
    PUSH 0x10                           ; 10007809
        ;   Label: LAB_10007809
    CALL crt_startup.c__amsg_exit_FUN_100058c0 ; 1000780b
