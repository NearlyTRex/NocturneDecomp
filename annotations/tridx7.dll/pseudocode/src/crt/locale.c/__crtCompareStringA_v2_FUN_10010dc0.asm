...
;   crt_string.c_wcsnlen_v3_FUN_10011000
;   WideCharToMultiByte
;
; *****************************************************************************
...
section .text
    ...
    SUB ESP,0x8                         ; 10010dc0
        ;   Label: crt_locale.c___crtCompareStringA_v2_FUN_10010dc0
    ...
    PUSH ESI                            ; 10010e3e
    PUSH EAX                            ; 10010e3f
    CALL crt_string.c_wcsnlen_v3_FUN_10011000 ; 10010e40
        ;   XREF to: 10011000 (UNCONDITIONAL_CALL)  ; int crt_string.c_wcsnlen_v3_FUN_10011000(wchar_t * str, int max)
    ...
    PUSH EBX                            ; 10010e56
    PUSH EAX                            ; 10010e57
    CALL crt_string.c_wcsnlen_v3_FUN_10011000 ; 10010e58
        ;   XREF to: 10011000 (UNCONDITIONAL_CALL)  ; int crt_string.c_wcsnlen_v3_FUN_10011000(wchar_t * str, int max)
    ...
    MOV EAX,dword ptr [ESP + 0x14]      ; 10010ee4
        ;   Label: LAB_10010ee4
    PUSH EAX                            ; 10010ee8
    CALL crt_heap.c_malloc_FUN_10008830 ; 10010ee9
    ...
    JZ 0x10010fb4                       ; 10010f49
        ;   XREF to: 10010fb4 (CONDITIONAL_JUMP)  ; LAB_10010fb4
    PUSH ESI                            ; 10010f4b
    CALL crt_heap.c_malloc_FUN_10008830 ; 10010f4c
        ;   XREF to: 10008830 (UNCONDITIONAL_CALL)  ; void * crt_heap.c_malloc_FUN_10008830(size_t size)
    ...
    MOV EAX,dword ptr [ESP + 0x10]      ; 10010fb4
        ;   Label: LAB_10010fb4
    PUSH EAX                            ; 10010fb8
    CALL crt_heap.c_free_FUN_10005b30   ; 10010fb9
        ;   XREF to: 10005b30 (UNCONDITIONAL_CALL)  ; void crt_heap.c_free_FUN_10005b30(void * block)
    ADD ESP,0x4                         ; 10010fbe
    PUSH EDI                            ; 10010fc1
    CALL crt_heap.c_free_FUN_10005b30   ; 10010fc2
        ;   XREF to: 10005b30 (UNCONDITIONAL_CALL)  ; void crt_heap.c_free_FUN_10005b30(void * block)
