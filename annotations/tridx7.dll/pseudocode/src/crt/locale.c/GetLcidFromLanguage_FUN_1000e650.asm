...
;
; Parameters:
; char *           Stack[0x4]:4   lang
;
; XREF[1]:
;   crt_locale.c___get_qualified_locale_FUN_1000e350 at 1000e3ab
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 1000e650
        ;   Label: crt_locale.c_GetLcidFromLanguage_FUN_1000e650
    PUSH ESI                            ; 1000e651
    PUSH EDI                            ; 1000e652
    ...
    PUSH ESI                            ; 1000e672
    CALL crt_string.c__stricmp_FUN_1000ff20 ; 1000e673
