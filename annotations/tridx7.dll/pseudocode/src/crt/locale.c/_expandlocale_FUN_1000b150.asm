...
; char *           Stack[0x8]:4   cat
; LC_ID *          Stack[0xc]:4   lc_id
; UINT *           Stack[0x10]:4   code_page
; Local Variables:
; undefined        Stack[-0x88]:1  local_88
;
; XREF[2]:
;   crt_locale.c_setlocale_FUN_1000ac10 at 1000adfc
;   crt_locale.c_setlocale_set_cat_FUN_1000aee0 at 1000af09
;
; Referenced Globals:
...
;
; Called Functions:
;   crt_locale.c___get_qualified_locale_FUN_1000e350
;   crt_locale.c__lc_strtolc_FUN_1000b380
;   crt_locale.c__setlocale_catcopy_FUN_1000b480
;
; *****************************************************************************
...
section .text
    ...
    SUB ESP,0x88                        ; 1000b150
        ;   Label: crt_locale.c__expandlocale_FUN_1000b150
    PUSH ESI                            ; 1000b156
    PUSH EDI                            ; 1000b157
    ...
    PUSH EDI                            ; 1000b227
    PUSH EAX                            ; 1000b228
    CALL crt_locale.c__lc_strtolc_FUN_1000b380 ; 1000b229
        ;   XREF to: 1000b380 (UNCONDITIONAL_CALL)  ; int crt_locale.c__lc_strtolc_FUN_1000b380(char * lc, char * locale)
    ...
    PUSH EAX                            ; 1000b24e
    CALL crt_locale.c___get_qualified_locale_FUN_1000e350 ; 1000b24f
        ;   XREF to: 1000e350 (UNCONDITIONAL_CALL)  ; int crt_locale.c___get_qualified_locale_FUN_1000e350(char * locale, void * id, void * out)
    ...
    CALL crt_locale.c__setlocale_catcopy_FUN_1000b480 ; 1000b27d
        ;   XREF to: 1000b480 (UNCONDITIONAL_CALL)  ; void crt_locale.c__setlocale_catcopy_FUN_1000b480(char * dst, char * lc)
