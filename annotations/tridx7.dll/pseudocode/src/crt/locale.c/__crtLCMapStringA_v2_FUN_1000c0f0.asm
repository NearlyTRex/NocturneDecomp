...
; LPSTR            Stack[0x14]:4   dest
; int              Stack[0x18]:4   cch_dest
; UINT             Stack[0x1c]:4   code_page
; BOOL             Stack[0x20]:4   error
;
; XREF[1]:
;   crt_ctype.c__towupper_FUN_100107d0 at 1001084e
;
; Referenced Globals:
...
;   crt_string.c_wcsnlen_FUN_1000c300
;   LCMapStringA
;   LCMapStringW
;   MultiByteToWideChar
;   WideCharToMultiByte
...
section .text
    ...
    PUSH EBX                            ; 1000c0f0
        ;   Label: crt_locale.c___crtLCMapStringA_v2_FUN_1000c0f0
    ...
    PUSH EDI                            ; 1000c163
    PUSH EAX                            ; 1000c164
    CALL crt_string.c_wcsnlen_FUN_1000c300 ; 1000c165
        ;   XREF to: 1000c300 (UNCONDITIONAL_CALL)  ; size_t crt_string.c_wcsnlen_FUN_1000c300(wchar_t * str, int max)
    ...
    PUSH EBP                            ; 1000c1e9
        ;   Label: LAB_1000c1e9
    CALL crt_heap.c_malloc_FUN_10008830 ; 1000c1ea
    ...
    JZ 0x1000c2ad                       ; 1000c23d
        ;   XREF to: 1000c2ad (CONDITIONAL_JUMP)  ; LAB_1000c2ad
    PUSH EDI                            ; 1000c23f
    CALL crt_heap.c_malloc_FUN_10008830 ; 1000c240
        ;   XREF to: 10008830 (UNCONDITIONAL_CALL)  ; void * crt_heap.c_malloc_FUN_10008830(size_t size)
    ...
    PUSH ESI                            ; 1000c282
    PUSH EAX                            ; 1000c283
    CALL crt_string.c__strncpy_FUN_1000a9f0 ; 1000c284
    ...
    PUSH EBX                            ; 1000c2e3
        ;   Label: LAB_1000c2e3
    CALL crt_heap.c_free_FUN_10005b30   ; 1000c2e4
        ;   XREF to: 10005b30 (UNCONDITIONAL_CALL)  ; void crt_heap.c_free_FUN_10005b30(void * block)
    ADD ESP,0x4                         ; 1000c2e9
    PUSH ESI                            ; 1000c2ec
    CALL crt_heap.c_free_FUN_10005b30   ; 1000c2ed
        ;   XREF to: 10005b30 (UNCONDITIONAL_CALL)  ; void crt_heap.c_free_FUN_10005b30(void * block)
