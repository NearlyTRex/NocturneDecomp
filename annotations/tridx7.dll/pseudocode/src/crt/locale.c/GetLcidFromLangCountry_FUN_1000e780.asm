...
;
; Parameters:
; ushort *         Stack[0x4]:4   plang
; ushort *         Stack[0x8]:4   pctry
;
; XREF[1]:
;   crt_locale.c___get_qualified_locale_FUN_1000e350 at 1000e4dc
;
; Referenced Globals:
...
section .text
    ...
    MOV EAX,dword ptr [ESP + 0x8]       ; 1000e780
        ;   Label: crt_locale.c_GetLcidFromLangCountry_FUN_1000e780
    PUSH EBX                            ; 1000e784
