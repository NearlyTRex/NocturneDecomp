...
;   crt_locale.c_setlocale_get_all_FUN_1000b060
;   crt_locale.c_setlocale_set_cat_FUN_1000aee0
;   crt_string.c__strncpy_FUN_1000a9f0
;   crt_string.c_strcspn_FUN_1000e290
;   crt_string.c_strncmp_FUN_1000e2d0
;   crt_string.c_strpbrk_FUN_1000e310
...
section .text
    ...
    SUB ESP,0x90                        ; 1000ac10
        ;   Label: crt_locale.c_setlocale_FUN_1000ac10
    PUSH EBX                            ; 1000ac16
    PUSH ESI                            ; 1000ac17
    ...
    JG 0x1000aec6                       ; 1000ac2c
        ;   XREF to: 1000aec6 (CONDITIONAL_JUMP)  ; LAB_1000aec6
    PUSH 0x13                           ; 1000ac32
    CALL crt_thread.c__lock_FUN_100059a0 ; 1000ac34
    ...
    PUSH ESI                            ; 1000ac6e
    PUSH EBX                            ; 1000ac6f
    CALL crt_locale.c_setlocale_set_cat_FUN_1000aee0 ; 1000ac70
        ;   XREF to: 1000aee0 (UNCONDITIONAL_CALL)  ; char * crt_locale.c_setlocale_set_cat_FUN_1000aee0(int category, char * locale)
    ...
    PUSH 0x10012758                     ; 1000acc5 | DAT_10012758
        ;   Label: LAB_1000acc5
    PUSH ESI                            ; 1000acca
    CALL crt_string.c_strpbrk_FUN_1000e310 ; 1000accb
        ;   XREF to: 1000e310 (UNCONDITIONAL_CALL)  ; char * crt_string.c_strpbrk_FUN_1000e310(char * str, char * control)
    ...
    CALL crt_string.c_strncmp_FUN_1000e2d0 ; 1000ad05
        ;   XREF to: 1000e2d0 (UNCONDITIONAL_CALL)  ; int crt_string.c_strncmp_FUN_1000e2d0(char * str1, char * str2, size_t count)
    ...
    PUSH EAX                            ; 1000ad40
    CALL crt_string.c_strcspn_FUN_1000e290 ; 1000ad41
    ...
    PUSH EAX                            ; 1000ad68
    PUSH ECX                            ; 1000ad69
    CALL crt_string.c__strncpy_FUN_1000a9f0 ; 1000ad6a
    ...
    PUSH ECX                            ; 1000ad7f
    PUSH EDX                            ; 1000ad80
    CALL crt_locale.c_setlocale_set_cat_FUN_1000aee0 ; 1000ad81
        ;   XREF to: 1000aee0 (UNCONDITIONAL_CALL)  ; char * crt_locale.c_setlocale_set_cat_FUN_1000aee0(int category, char * locale)
    ...
    PUSH 0x13                           ; 1000adb0
        ;   Label: LAB_1000adb0
    CALL crt_thread.c__unlock_FUN_10005a10 ; 1000adb2
    ...
    PUSH 0x13                           ; 1000add4
        ;   Label: LAB_1000add4
    CALL crt_thread.c__unlock_FUN_10005a10 ; 1000add6
        ;   XREF to: 10005a10 (UNCONDITIONAL_CALL)  ; void crt_thread.c__unlock_FUN_10005a10(int locknum)
    ...
    PUSH EAX                            ; 1000adfa
    PUSH ESI                            ; 1000adfb
    CALL crt_locale.c__expandlocale_FUN_1000b150 ; 1000adfc
    ...
    PUSH EAX                            ; 1000ae50
    PUSH ESI                            ; 1000ae51
    CALL crt_locale.c_setlocale_set_cat_FUN_1000aee0 ; 1000ae52
        ;   XREF to: 1000aee0 (UNCONDITIONAL_CALL)  ; char * crt_locale.c_setlocale_set_cat_FUN_1000aee0(int category, char * locale)
    ...
    CALL crt_locale.c_setlocale_get_all_FUN_1000b060 ; 1000ae76
        ;   XREF to: 1000b060 (UNCONDITIONAL_CALL)  ; char * crt_locale.c_setlocale_get_all_FUN_1000b060()
    MOV ESI,EAX                         ; 1000ae7b
    MOV EAX,[0x10017794]                ; 1000ae7d | DAT_10017794
    PUSH EAX                            ; 1000ae82
    CALL crt_heap.c_free_FUN_10005b30   ; 1000ae83
    ...
    JMP 0x1000aea9                      ; 1000aea0
        ;   XREF to: 1000aea9 (UNCONDITIONAL_JUMP)  ; LAB_1000aea9
    CALL crt_locale.c_setlocale_get_all_FUN_1000b060 ; 1000aea2
        ;   XREF to: 1000b060 (UNCONDITIONAL_CALL)  ; char * crt_locale.c_setlocale_get_all_FUN_1000b060()
        ;   Label: LAB_1000aea2
    ...
    PUSH 0x13                           ; 1000aea9
        ;   Label: LAB_1000aea9
    CALL crt_thread.c__unlock_FUN_10005a10 ; 1000aeab
        ;   XREF to: 10005a10 (UNCONDITIONAL_CALL)  ; void crt_thread.c__unlock_FUN_10005a10(int locknum)
