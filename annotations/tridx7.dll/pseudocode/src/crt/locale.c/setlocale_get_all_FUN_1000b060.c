// Name: crt_locale.c_setlocale_get_all_FUN_1000b060
// Address: 1000b060
// Address Range: [[1000b060, 1000b14f]]
// Convention: __cdecl
// Signature: char * __cdecl crt_locale_c_setlocale_get_all_FUN_1000b060(void)

#include "nocturne.h"

char * __cdecl setlocale_get_all(void)

{
  ...
  if (DAT_10017794 == (char *)0x0) {
    DAT_10017794 = malloc(0x351);
  }
  *DAT_10017794 = '\0';
  ppuVar9 = &PTR_DAT_100177a0;
  do {
    _lc_lctostr(DAT_10017794,3,ppuVar9[-1],&DAT_1001275c,*ppuVar9);
