...
; LPWSTR           Stack[0xc]:4   dest
; int              Stack[0x10]:4   cch
; UINT             Stack[0x14]:4   code_page
;
; XREF[2]:
;   crt_locale.c___get_qualified_locale_FUN_1000e350 at 1000e52d
;   crt_locale.c___getlocaleinfo_FUN_1000f6e0 at 1000f7f5
;
; Referenced Globals:
...
section .text
    ...
    PUSH EBX                            ; 1000f9a0
        ;   Label: crt_locale.c___crtGetLocaleInfoW_FUN_1000f9a0
    ...
    PUSH EBP                            ; 1000fa50
        ;   Label: LAB_1000fa50
    CALL crt_heap.c_malloc_FUN_10008830 ; 1000fa51
    ...
    PUSH ESI                            ; 1000fa96
        ;   Label: LAB_1000fa96
    CALL crt_heap.c_free_FUN_10005b30   ; 1000fa97
    ...
    PUSH ESI                            ; 1000fabe
        ;   Label: LAB_1000fabe
    CALL crt_heap.c_free_FUN_10005b30   ; 1000fabf
        ;   XREF to: 10005b30 (UNCONDITIONAL_CALL)  ; void crt_heap.c_free_FUN_10005b30(void * block)
