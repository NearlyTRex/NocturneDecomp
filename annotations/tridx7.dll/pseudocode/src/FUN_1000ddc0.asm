...
section .text
    ...
    PUSH EDI                            ; 1000de31
    PUSH 0x1                            ; 1000de32
    CALL FUN_1000f6e0                   ; 1000de34
        ;   XREF to: 1000f6e0 (UNCONDITIONAL_CALL)  ; undefined FUN_1000f6e0()
    ADD ESP,0x10                        ; 1000de39
    OR EBX,EAX                          ; 1000de3c
    MOV EAX,dword ptr [EBP]             ; 1000de3e
    PUSH EAX                            ; 1000de41
    CALL FUN_1000df10                   ; 1000de42
        ;   XREF to: 1000df10 (UNCONDITIONAL_CALL)  ; undefined FUN_1000df10()
