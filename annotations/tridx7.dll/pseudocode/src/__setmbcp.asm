...
section .text
    ...
    PUSH EBP                            ; 10007eb6
    PUSH 0x19                           ; 10007eb7
    CALL __lock                         ; 10007eb9
        ;   XREF to: 100059a0 (UNCONDITIONAL_CALL)  ; void __lock(int _File)
    MOV EAX,dword ptr [ESP + 0x30]      ; 10007ebe
    ADD ESP,0x4                         ; 10007ec2
    PUSH EAX                            ; 10007ec5
    CALL getSystemCP                    ; 10007ec6
        ;   XREF to: 100080e0 (UNCONDITIONAL_CALL)  ; undefined getSystemCP() | _getSystemCP
    ...
    CALL setSBCS                        ; 10007ef0
        ;   XREF to: 10008190 (UNCONDITIONAL_CALL)  ; undefined setSBCS() | _setSBCS
    PUSH 0x19                           ; 10007ef5
    CALL FUN_10005a10                   ; 10007ef7
        ;   XREF to: 10005a10 (UNCONDITIONAL_CALL)  ; undefined FUN_10005a10()
    ...
    CALL _CPtoLCID                      ; 10007fac
        ;   XREF to: 10008130 (UNCONDITIONAL_CALL)  ; undefined _CPtoLCID()
    ...
    CALL setSBCS                        ; 100080a3
        ;   XREF to: 10008190 (UNCONDITIONAL_CALL)  ; undefined setSBCS() | _setSBCS
    PUSH 0x19                           ; 100080a8
    CALL FUN_10005a10                   ; 100080aa
        ;   XREF to: 10005a10 (UNCONDITIONAL_CALL)  ; undefined FUN_10005a10()
