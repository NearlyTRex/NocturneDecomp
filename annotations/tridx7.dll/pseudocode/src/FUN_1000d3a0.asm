...
section .text
    ...
    PUSH EDI                            ; 1000d3ce
    PUSH 0x1                            ; 1000d3cf
    CALL FUN_1000f6e0                   ; 1000d3d1
        ;   XREF to: 1000f6e0 (UNCONDITIONAL_CALL)  ; undefined FUN_1000f6e0()
    ...
    PUSH EBX                            ; 1000d6f4
    PUSH 0x1                            ; 1000d6f5
    CALL FUN_1000f6e0                   ; 1000d6f7
        ;   XREF to: 1000f6e0 (UNCONDITIONAL_CALL)  ; undefined FUN_1000f6e0()
    ADD ESP,0x10                        ; 1000d6fc
    OR EBP,EAX                          ; 1000d6ff
    PUSH ESI                            ; 1000d701
    PUSH EBX                            ; 1000d702
    CALL FUN_1000d960                   ; 1000d703
        ;   XREF to: 1000d960 (UNCONDITIONAL_CALL)  ; undefined FUN_1000d960()
