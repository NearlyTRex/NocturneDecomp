...
section .text
    ...
    PUSH EDI                            ; 1000bf82
    PUSH ECX                            ; 1000bf83
    CALL FID_conflict:_memcpy           ; 1000bf84
