...
// Convention: __cdecl
// Signature: int __cdecl APIDLLdrawPolyList2(SRenderVertex *vertex_buffer,ushort **polygons,int polygon_count,int render_flags)
...

{
  ...
  if (0 < polygon_count) {
    ...
    do {
      ...
      uVar3 = FUN_10005010(&local_10,vertex_buffer,render_flags);
