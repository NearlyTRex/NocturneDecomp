...
section .text
    ...
    MOV EAX,[0x101386a8]                ; 10003840 | DAT_101386a8
    MOV ECX,dword ptr [0x10240620]      ; 10003845 | DAT_10240620
    MOV EDX,dword ptr [0x10226e80]      ; 1000384b | DAT_10226e80
    MOV [0x10226a4c],EAX                ; 10003851 | DAT_10226a4c
    MOV dword ptr [0x10226a54],ECX      ; 10003856 | DAT_10226a54
    MOV dword ptr [0x10139040],EDX      ; 1000385c | DAT_10139040
    JMP 0x10003882                      ; 10003862
        ;   XREF to: 10003882 (UNCONDITIONAL_JUMP)  ; LAB_10003882
    MOV dword ptr [0x10226a4c],0x10     ; 10003864 | DAT_10226a4c
        ;   Label: LAB_10003864
    MOV dword ptr [0x10226a54],0x8      ; 1000386e | DAT_10226a54
    MOV dword ptr [0x10139040],0x0      ; 10003878 | DAT_10139040
    MOV EAX,[0x10138fb0]                ; 10003882 | DAT_10138fb0
        ;   Label: LAB_10003882
    MOV ESI,0x10226a80                  ; 10003887 | DAT_10226a80
    XOR EDX,EDX                         ; 1000388c
        ;   Label: LAB_1000388c
    MOV CL,byte ptr [0x10139040]        ; 1000388e | DAT_10139040
    MOV DL,byte ptr [EAX + 0x2]         ; 10003894
    XOR EBX,EBX                         ; 10003897
    MOV BL,byte ptr [EAX + 0x1]         ; 10003899
    ADD EAX,0x3                         ; 1000389c
    SHL EDX,CL                          ; 1000389f
    MOV CL,byte ptr [0x10226a54]        ; 100038a1 | DAT_10226a54
    ADD ESI,0x4                         ; 100038a7
    SHL EBX,CL                          ; 100038aa
    OR EDX,EBX                          ; 100038ac
    MOV CL,byte ptr [0x10226a4c]        ; 100038ae | DAT_10226a4c
    XOR EBX,EBX                         ; 100038b4
    MOV BL,byte ptr [EAX + -0x3]        ; 100038b6
    SHL EBX,CL                          ; 100038b9
    OR EDX,EBX                          ; 100038bb
    CMP ESI,0x10226e80                  ; 100038bd | DAT_10226e80
    ...
    INC EAX                             ; 100038f6
    MOV EBP,dword ptr [EBX*0x4 + 0x10226a80] ; 100038f7 | DAT_10226a80
    XOR EBX,EBX                         ; 100038fe
    MOV BL,byte ptr [EAX + EDI*0x1 + -0x1] ; 10003900
    SHL EBX,0x18                        ; 10003904
    OR EBP,EBX                          ; 10003907
    CMP EAX,ESI                         ; 10003909
    MOV dword ptr [EDX + -0x4],EBP      ; 1000390b | DAT_101b88e0 | DAT_101b88e4
    ...
    MOV dword ptr [ESP + 0x14],ESI      ; 1000397a | DAT_101b88e0
    ...
    MOV EBX,dword ptr [EDI + EAX*0x4 + 0x4] ; 1000399c | DAT_101b88e4 | DAT_101b88ec
        ;   Label: LAB_1000399c
    LEA ECX,[EDI + EAX*0x4]             ; 100039a0
    MOV EBP,dword ptr [EDI]             ; 100039a3 | DAT_101b88e0 | DAT_101b88e8
    AND EBX,0xfefefeff                  ; 100039a5
    SHR EBX,0x1                         ; 100039ab
    MOV ECX,dword ptr [ECX]             ; 100039ae | DAT_101b88e0 | DAT_101b88e8
    ...
    MOV ECX,dword ptr [EDI + -0x4]      ; 100039cd | DAT_101b88e4 | DAT_101b88ec
    ...
    DEC ESI                             ; 100039ec
    MOV dword ptr [EDX + -0x4],EBX      ; 100039ed | DAT_101b88e0
