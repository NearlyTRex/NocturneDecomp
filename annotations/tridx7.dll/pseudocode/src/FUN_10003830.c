...
// Convention: unknown
// Signature: void FUN_10003830(void)
...

{
  ...
  if (DAT_1024061c == 0) {
    ...
    if (0 < iVar9) {
      do {
        iVar2 = iVar1 + 1;
        *puVar6 = (&DAT_10226a80)[*pbVar4] | (uint)*(byte *)(iVar1 + iVar3) << 0x18;
        iVar1 = iVar2;
        pbVar4 = pbVar4 + 1;
        puVar6 = puVar6 + 1;
      } while (iVar2 < iVar9);
        ...
        do {
          ...
          if (0 < iVar3) {
            do {
              puVar8 = puVar7 + 1;
              uVar10 = uVar10 - 1;
              *puVar7 = ((((puVar11[iVar3 + 1] & 0xfefefeff) >> 1) +
                          ((puVar11[iVar3] & 0xfefefeff) >> 1) & 0xfefefeff) >> 1) +
