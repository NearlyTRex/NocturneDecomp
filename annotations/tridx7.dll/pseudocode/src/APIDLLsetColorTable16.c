...

{
  ...
  local_7c[0] = 0x7c;
  iVar2 = FUN_10002e20(DAT_10014180,local_7c);
  if (iVar2 == 0) {
    FUN_10002340("Could not lock back buffer");
  }
  iVar2 = FUN_10002cb0(DAT_10014180);
  if (iVar2 == 0) {
  ...
  *g_ExternalRendererBridge.red_scale_factor =
  ...
  iVar2 = FUN_10004d10(*g_ExternalRendererBridge.red_scale_factor);
  ...
  *g_ExternalRendererBridge.green_scale_factor =
  ...
  iVar2 = FUN_10004d10(*g_ExternalRendererBridge.green_scale_factor);
  ...
  *g_ExternalRendererBridge.blue_scale_factor =
  ...
  iVar2 = FUN_10004d10(*g_ExternalRendererBridge.blue_scale_factor);
  puVar6 = DAT_10226868;
