...
// Convention: __cdecl
// Signature: int __cdecl APIDLLdrawPolyList(SRenderVertex *vertex_buffer,SMRGLPrimitiveTriangle **polygons,int polygon_count,int render_flags)
  ...
  if (0 < polygon_count) {
    ...
    do {
      ...
      if (iVar2 != 2 && -1 < iVar2 + -2) {
        ...
        do {
          uVar3 = FUN_10005010(pSVar1->vertices,vertex_buffer,render_flags);
          *(ushort *)(&DAT_10238910 + DAT_1001422c * 2) = uVar3;
          uVar3 = FUN_10005010(pSVar4,vertex_buffer,render_flags);
          *(ushort *)(&DAT_10238912 + DAT_1001422c * 2) = uVar3;
          uVar3 = FUN_10005010(pSVar4 + 1,vertex_buffer,render_flags);
          iVar2 = DAT_1001422c;
          local_c = local_c + 1;
