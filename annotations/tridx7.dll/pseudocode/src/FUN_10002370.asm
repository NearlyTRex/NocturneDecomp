...
;
; XREF[4]:
;   APIDLLinit at 10001cc5
;   APIDLLkill at 10002460
;   APIDLLrestoreVideoMode at 10002c2c
;   APIDLLsetVideoMode at 100026c4
;
; Referenced Globals:
...
section .text
    ...
    CMP dword ptr [0x100141e0],0x0      ; 100023b3 | DAT_100141e0
        ;   Label: LAB_100023b3
    JZ 0x100023d1                       ; 100023ba
        ;   XREF to: 100023d1 (CONDITIONAL_JUMP)  ; LAB_100023d1
    MOV EAX,[0x100141e0]                ; 100023bc | DAT_100141e0
    PUSH EAX                            ; 100023c1
    MOV ESI,dword ptr [EAX]             ; 100023c2
    CALL dword ptr [ESI + 0x8]          ; 100023c4
    MOV dword ptr [0x100141e0],0x0      ; 100023c7 | DAT_100141e0
    ...
    CMP dword ptr [0x1001418c],0x0      ; 1000243a | DAT_1001418c
        ;   Label: LAB_1000243a
    JZ 0x10002458                       ; 10002441
        ;   XREF to: 10002458 (CONDITIONAL_JUMP)  ; LAB_10002458
    MOV EAX,[0x1001418c]                ; 10002443 | DAT_1001418c
    PUSH EAX                            ; 10002448
    MOV ESI,dword ptr [EAX]             ; 10002449
    CALL dword ptr [ESI + 0x8]          ; 1000244b
    MOV dword ptr [0x1001418c],0x0      ; 1000244e | DAT_1001418c
    POP EDI                             ; 10002458
        ;   Label: LAB_10002458
    POP ESI                             ; 10002459
    RET                                 ; 1000245a
