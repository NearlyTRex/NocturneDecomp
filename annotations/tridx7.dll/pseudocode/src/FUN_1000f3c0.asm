...
section .text
    ...
    PUSH ECX                            ; 1000f5e9
    CALL FUN_1000ed30                   ; 1000f5ea
        ;   XREF to: 1000ed30 (UNCONDITIONAL_CALL)  ; undefined FUN_1000ed30()
