...
;
; XREF[2]:
;   APIDLLdrawPolyList at 10004f6a
;   APIDLLdrawPolyList2 at 100051a2
;
; Referenced Globals:
...
section .text
    ...
    MOV EAX,[0x10014234]                ; 10005026 | DAT_10014234
