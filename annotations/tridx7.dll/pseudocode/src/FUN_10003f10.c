...
// Convention: unknown
// Signature: void FUN_10003f10(uint param_1)
...

{
  ...
  if (iVar1 != DAT_10014220) {
    ...
    else if ((iVar1 == 1) && (FUN_100037e0(0x14,2), DAT_10014164 != 0)) {
      uVar2 = 2;
LAB_1000400f:
      FUN_100037e0(0x13,uVar2);
    }
  ...
  if (((param_1 ^ _DAT_10014218) & 1) != 0) {
    FUN_100047b0();
    if ((param_1 & 1) == 0) {
      (**(code **)(*DAT_100141e0 + 0xa0))(DAT_100141e0,0,1,1);
    }
    else {
      DAT_100141d4 = 0;
    }
  }
  if (((param_1 & 1) != 0) && ((&DAT_1020de40)[DAT_10014138 * 2] != DAT_100141d4)) {
    FUN_100047b0();
  ...
  if (DAT_10014224 != iVar1) {
    ...
    DAT_10014224 = iVar1;
    (**(code **)(*DAT_100141e0 + 0xa0))(DAT_100141e0,0,0x12,uVar2);
  }
  ...
  if (((param_1 ^ _DAT_10014218) & 4) != 0) {
    ...
    FUN_100037e0(9,uVar2);
  }
  if (((param_1 ^ _DAT_10014218) & 8) != 0) {
    FUN_100037e0(0x1c,(param_1 & 8) != 0);
  }
