...
section .text
    ...
    PUSH EAX                            ; 1000789f
    CALL FUN_10005b30                   ; 100078a0
        ;   XREF to: 10005b30 (UNCONDITIONAL_CALL)  ; undefined FUN_10005b30()
    ADD ESP,0x4                         ; 100078a5
    PUSH ESI                            ; 100078a8
        ;   Label: LAB_100078a8
    CALL FUN_10005b30                   ; 100078a9
        ;   XREF to: 10005b30 (UNCONDITIONAL_CALL)  ; undefined FUN_10005b30()
