...
section .text
    ...
    PUSH EBP                            ; 100109bb
    PUSH EDI                            ; 100109bc
    CALL FUN_10010be0                   ; 100109bd
        ;   XREF to: 10010be0 (UNCONDITIONAL_CALL)  ; undefined FUN_10010be0()
