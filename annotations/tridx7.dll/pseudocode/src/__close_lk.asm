...
section .text
    ...
    PUSH ESI                            ; 10005c0a
        ;   Label: LAB_10005c0a
    CALL FUN_10008c30                   ; 10005c0b
        ;   XREF to: 10008c30 (UNCONDITIONAL_CALL)  ; undefined FUN_10008c30()
    ADD ESP,0x4                         ; 10005c10
    TEST EDI,EDI                        ; 10005c13
    JZ 0x10005c28                       ; 10005c15
        ;   XREF to: 10005c28 (CONDITIONAL_JUMP)  ; LAB_10005c28
    PUSH EDI                            ; 10005c17
    CALL __dosmaperr                    ; 10005c18
