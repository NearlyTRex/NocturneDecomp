...
;                               FUNCTION
; *****************************************************************************
; undefined4 FUN_10010360(int *param_1)
;
;
; XREF[1]:
;   FUN_10010330 at 10010340
;
; Referenced Globals:
...
section .text
    ...
    PUSH 0x1                            ; 10010423
        ;   Label: LAB_10010423
    CALL FUN_100105c0                   ; 10010425
        ;   XREF to: 100105c0 (UNCONDITIONAL_CALL)  ; undefined FUN_100105c0()
