...
;
; XREF[2]:
;   FID_conflict:_fwprintf at 100054f6
;   _sprintf at 1000565f
;
; Referenced Globals:
...
section .text
    ...
    PUSH EAX                            ; 10006050
    CALL FUN_100069f0                   ; 10006051
        ;   XREF to: 100069f0 (UNCONDITIONAL_CALL)  ; undefined FUN_100069f0()
    ...
    CALL FUN_10006a20                   ; 100061f8
        ;   XREF to: 10006a20 (UNCONDITIONAL_CALL)  ; undefined FUN_10006a20()
    ADD ESP,0x4                         ; 100061fd
    PUSH EAX                            ; 10006200
    LEA EAX,[ESP + 0x5c]                ; 10006201
    PUSH EAX                            ; 10006205
    CALL _wctomb                        ; 10006206
        ;   XREF to: 100091e0 (UNCONDITIONAL_CALL)  ; int _wctomb(char * _MbCh, wchar_t _WCh)
    ...
    PUSH EAX                            ; 100063e3
    CALL FUN_10006a00                   ; 100063e4
        ;   XREF to: 10006a00 (UNCONDITIONAL_CALL)  ; undefined FUN_10006a00()
    ...
    PUSH ECX                            ; 10006541
    PUSH EAX                            ; 10006542
    CALL __aullrem                      ; 10006543
        ;   XREF to: 10009350 (UNCONDITIONAL_CALL)  ; undefined __aullrem()
    ...
    PUSH ECX                            ; 1000655d
    PUSH EAX                            ; 1000655e
    CALL __aulldiv                      ; 1000655f
        ;   XREF to: 100092e0 (UNCONDITIONAL_CALL)  ; undefined __aulldiv()
    ...
    PUSH ECX                            ; 10006606
    CALL dword ptr [0x10016d48]         ; 10006607 | PTR___fptrap_10016d48
    ...
    PUSH EAX                            ; 10006623
    CALL dword ptr [0x10016d54]         ; 10006624 | PTR___fptrap_10016d54
    ...
    PUSH EAX                            ; 1000663a
    CALL dword ptr [0x10016d4c]         ; 1000663b | PTR___fptrap_10016d4c
    ...
    PUSH EDX                            ; 10006721
    PUSH 0x20                           ; 10006722
    CALL write_multi_char               ; 10006724
        ;   XREF to: 10006970 (UNCONDITIONAL_CALL)  ; undefined write_multi_char() | _write_multi_char
    ...
    PUSH EDX                            ; 10006741
    PUSH EAX                            ; 10006742
    CALL write_string                   ; 10006743
        ;   XREF to: 100069b0 (UNCONDITIONAL_CALL)  ; undefined write_string() | _write_string
    ...
    PUSH EDX                            ; 1000676c
    PUSH 0x30                           ; 1000676d
    CALL write_multi_char               ; 1000676f
        ;   XREF to: 10006970 (UNCONDITIONAL_CALL)  ; undefined write_multi_char() | _write_multi_char
    ...
    PUSH EDX                            ; 100067ff
    PUSH 0x20                           ; 10006800
    CALL write_multi_char               ; 10006802
        ;   XREF to: 10006970 (UNCONDITIONAL_CALL)  ; undefined write_multi_char() | _write_multi_char
