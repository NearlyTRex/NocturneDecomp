...
section .text
    ...
    JZ 0x1000e3ca                       ; 1000e3a8
        ;   XREF to: 1000e3ca (CONDITIONAL_JUMP)  ; LAB_1000e3ca
    PUSH EBP                            ; 1000e3aa
    CALL FUN_1000e650                   ; 1000e3ab
        ;   XREF to: 1000e650 (UNCONDITIONAL_CALL)  ; undefined FUN_1000e650()
    ...
    JZ 0x1000e3f7                       ; 1000e3d5
        ;   XREF to: 1000e3f7 (CONDITIONAL_JUMP)  ; LAB_1000e3f7
    PUSH EAX                            ; 1000e3d7
    CALL FUN_1000e6b0                   ; 1000e3d8
        ;   XREF to: 1000e6b0 (UNCONDITIONAL_CALL)  ; undefined FUN_1000e6b0()
    ...
    PUSH EBP                            ; 1000e465
        ;   Label: LAB_1000e465
    CALL FUN_1000ff10                   ; 1000e466
        ;   XREF to: 1000ff10 (UNCONDITIONAL_CALL)  ; undefined FUN_1000ff10()
    ...
    MOV EAX,dword ptr [ESP + 0x12]      ; 1000e485
        ;   Label: LAB_1000e485
    PUSH EAX                            ; 1000e489
    CALL FUN_1000e710                   ; 1000e48a
        ;   XREF to: 1000e710 (UNCONDITIONAL_CALL)  ; undefined FUN_1000e710()
    ...
    PUSH EAX                            ; 1000e4da
    PUSH ECX                            ; 1000e4db
    CALL FUN_1000e780                   ; 1000e4dc
        ;   XREF to: 1000e780 (UNCONDITIONAL_CALL)  ; undefined FUN_1000e780()
    ...
    PUSH ECX                            ; 1000e52b
    PUSH EAX                            ; 1000e52c
    CALL FUN_1000f9a0                   ; 1000e52d
        ;   XREF to: 1000f9a0 (UNCONDITIONAL_CALL)  ; undefined FUN_1000f9a0()
    ...
    PUSH 0x0                            ; 1000e54c
    PUSH EAX                            ; 1000e54e
    CALL FUN_1000fc10                   ; 1000e54f
        ;   XREF to: 1000fc10 (UNCONDITIONAL_CALL)  ; undefined FUN_1000fc10()
    ...
    PUSH EAX                            ; 1000e5dc
    CALL FUN_1000fad0                   ; 1000e5dd
        ;   XREF to: 1000fad0 (UNCONDITIONAL_CALL)  ; undefined FUN_1000fad0()
    ...
    PUSH EAX                            ; 1000e636
    CALL FUN_1000f8b0                   ; 1000e637
        ;   XREF to: 1000f8b0 (UNCONDITIONAL_CALL)  ; undefined FUN_1000f8b0()
