...
section .text
    ...
    MOV ESI,0x10226a58                  ; 10002f72 | DAT_10226a58
    ...
    CMP dword ptr [0x10060670],0x0      ; 10002fb9 | DAT_10060670
    ...
    PUSH EAX                            ; 10002fce
    CALL FUN_10003090                   ; 10002fcf
        ;   XREF to: 10003090 (UNCONDITIONAL_CALL)  ; undefined FUN_10003090()
    ...
    CMP dword ptr [0x10014168],0x0      ; 10002fe8 | DAT_10014168
        ;   Label: LAB_10002fe8
    ...
    RET                                 ; 1000303e
    MOV EAX,dword ptr [EDI]             ; 1000303f | DAT_1020de44
        ;   Label: LAB_1000303f
    PUSH ESI                            ; 10003041
    MOV ESI,dword ptr [EAX]             ; 10003042
    PUSH 0x100121f8                     ; 10003044 | DAT_100121f8
    PUSH EAX                            ; 10003049
    ...
    CALL FUN_10002340                   ; 10003055
        ;   XREF to: 10002340 (UNCONDITIONAL_CALL)  ; undefined FUN_10002340()
    ADD ESP,0x4                         ; 1000305a
    MOV EAX,[0x10014214]                ; 1000305d | DAT_10014214
        ;   Label: LAB_1000305d
    MOV ESI,EAX                         ; 10003062
    INC EAX                             ; 10003064
    MOV [0x10014214],EAX                ; 10003065 | DAT_10014214
