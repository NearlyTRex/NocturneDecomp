...
section .text
    ...
    CMP dword ptr [0x10014204],0x0      ; 100043c0 | DAT_10014204
        ;   Label: APIDLLdrawPolygon2
    PUSH EBX                            ; 100043c7
    PUSH ESI                            ; 100043c8
    PUSH EDI                            ; 100043c9
    PUSH EBP                            ; 100043ca
    ...
    PUSH ECX                            ; 1000442d
    PUSH EAX                            ; 1000442e
    CALL FUN_100044b0                   ; 1000442f
        ;   XREF to: 100044b0 (UNCONDITIONAL_CALL)  ; undefined FUN_100044b0()
