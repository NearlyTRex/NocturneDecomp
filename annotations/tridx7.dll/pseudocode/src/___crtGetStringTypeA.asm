...
;
; Parameters:
; _locale_t        Stack[0x4]:4   _Plocinfo
; DWORD            Stack[0x8]:4   _DWInfoType
; LPCSTR           Stack[0xc]:4   _LpSrcStr
; int              Stack[0x10]:4   _CchSrc
; LPWORD           Stack[0x14]:4   _LpCharType
; int              Stack[0x18]:4   _Code_page
; BOOL             Stack[0x1c]:4   _BError
; Local Variables:
; undefined        Stack[-0x2]:1  local_2
;
; XREF[1]:
;   __isctype at 10009b2c
;
; Referenced Globals:
