...
section .text
    ...
    PUSH EAX                            ; 1000d172
    PUSH ECX                            ; 1000d173
    CALL FUN_1000e8f0                   ; 1000d174
        ;   XREF to: 1000e8f0 (UNCONDITIONAL_CALL)  ; undefined FUN_1000e8f0()
    ...
    LEA EAX,[ESP + 0x10]                ; 1000d1dc
        ;   Label: LAB_1000d1dc
    PUSH EAX                            ; 1000d1e0
    CALL ___shl_12                      ; 1000d1e1
        ;   XREF to: 1000c640 (UNCONDITIONAL_CALL)  ; undefined ___shl_12()
    ...
    LEA EAX,[ESP + 0x10]                ; 1000d1fa
        ;   Label: LAB_1000d1fa
    PUSH EAX                            ; 1000d1fe
    CALL ___shr_12                      ; 1000d1ff
        ;   XREF to: 1000c680 (UNCONDITIONAL_CALL)  ; undefined ___shr_12()
    ...
    PUSH ECX                            ; 1000d231
    CALL ___shl_12                      ; 1000d232
        ;   XREF to: 1000c640 (UNCONDITIONAL_CALL)  ; undefined ___shl_12()
    LEA ECX,[ESP + 0x14]                ; 1000d237
    ADD ESP,0x4                         ; 1000d23b
    PUSH ECX                            ; 1000d23e
    CALL ___shl_12                      ; 1000d23f
        ;   XREF to: 1000c640 (UNCONDITIONAL_CALL)  ; undefined ___shl_12()
    ...
    PUSH ECX                            ; 1000d24f
    PUSH EDX                            ; 1000d250
    CALL ___add_12                      ; 1000d251
        ;   XREF to: 1000c5d0 (UNCONDITIONAL_CALL)  ; undefined ___add_12()
    LEA ECX,[ESP + 0x18]                ; 1000d256
    ADD ESP,0x8                         ; 1000d25a
    PUSH ECX                            ; 1000d25d
    CALL ___shl_12                      ; 1000d25e
        ;   XREF to: 1000c640 (UNCONDITIONAL_CALL)  ; undefined ___shl_12()
