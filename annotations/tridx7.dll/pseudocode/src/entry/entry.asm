...
section .text
    ...
    PUSH EDI                            ; 10005852
    PUSH EBP                            ; 10005853
    CALL FUN_100056a0                   ; 10005854
        ;   XREF to: 100056a0 (UNCONDITIONAL_CALL)  ; undefined FUN_100056a0()
    ...
    PUSH EDI                            ; 1000586a
    PUSH EBP                            ; 1000586b
    CALL FUN_100085c0                   ; 1000586c
        ;   XREF to: 100085c0 (UNCONDITIONAL_CALL)  ; undefined FUN_100085c0()
